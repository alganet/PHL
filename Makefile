...
full_DEFINES      = -DPH7_ENABLE_MATH_FUNC -DPH7_ENABLE_THREADS -DPH7_ENABLE_NET -DPHL_ENABLE_SERVER -DPH7_ENABLE_PCRE -DPH7_ENABLE_LIBXML
full_EXTRA_CFLAGS = $(PCRE2_CFLAGS) $(LIBXML2_CFLAGS)

tiny_DEFINES      = -DPH7_OMIT_FLOATING_POINT -DPH7_DISABLE_HASH_FUNC -DPH7_DISABLE_BUILTIN_FUNC -DPH7_DISABLE_DISK_IO
tiny_EXTRA_CFLAGS =

coverage_DEFINES      = -DPH7_ENABLE_MATH_FUNC -DPH7_ENABLE_THREADS -DPH7_ENABLE_NET -DPHL_ENABLE_SERVER -DPH7_ENABLE_PCRE -DPH7_ENABLE_LIBXML
coverage_EXTRA_CFLAGS = $(PCRE2_CFLAGS) $(LIBXML2_CFLAGS)
...
OBJECTS = \
	...
	$(BUILD_DIR)/src/ph7/compile_literal$(OBJ_SUFFIX) \
	$(BUILD_DIR)/src/ph7/compile_node$(OBJ_SUFFIX) \
	...
	$(BUILD_DIR)/src/ph7/vm_builtin_lib$(OBJ_SUFFIX) \
	...
	$(BUILD_DIR)/src/ph7/vm_error$(OBJ_SUFFIX) \
