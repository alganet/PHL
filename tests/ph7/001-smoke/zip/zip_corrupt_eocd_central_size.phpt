...
--TEST--
Test open corrupted zip (end-of-central with oversized central directory size)
--SKIPIF--
<?php
/* Only run on PH7/PHL */
...
--FILE--
<?php
$fn = sys_get_temp_dir() . DIRECTORY_SEPARATOR . 'phl_test_zip_corrupt_eocd_central_size.zip';
...
/* Corrupt the central directory size in end-of-central (offset 92-95, set to 0xFFFFFFFF > 2147483647) */
$data[92] = "\xFF";
$data[93] = "\xFF";
$data[94] = "\xFF";
$data[95] = "\xFF";
