...
--TEST--
PH7 / PHP: gmdate basic functionality
--FILE--
<?php
// Test basic gmdate functionality
$result1 = gmdate("Y");
echo strlen($result1) === 4 ? "YEAR_OK\n" : "YEAR_FAIL: '$result1'\n";

// Test gmdate format
$result2 = gmdate("Y-m-d");
echo strlen($result2) === 10 ? "DATE_FORMAT_OK\n" : "DATE_FORMAT_FAIL: '$result2'\n";

// Test with timestamp
$timestamp = 1609470000; // 2021-01-01 00:00:00 UTC
$result3 = gmdate("Y-m-d", $timestamp);
echo $result3 === "2021-01-01" ? "TIMESTAMP_OK\n" : "TIMESTAMP_FAIL: '$result3'\n";

// Test UTC time format
$result4 = gmdate("H:i:s");
echo strlen($result4) === 8 ? "UTC_TIME_FORMAT_OK\n" : "UTC_TIME_FORMAT_FAIL: '$result4'\n";
