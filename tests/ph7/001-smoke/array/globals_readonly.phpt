...
--TEST--
$GLOBALS is a read-only array and insertion should emit a notice and not add the key
--SKIPIF--
<?php
...
$GLOBALS['__ph7_test__'] = 'value';
// Insertion should be forbidden
echo isset($GLOBALS['__ph7_test__']) ? '1' . PHP_EOL : '0' . PHP_EOL;
