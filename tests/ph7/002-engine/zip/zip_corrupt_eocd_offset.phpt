...
--TEST--
Test open corrupted zip (end-of-central with invalid central directory offset)
--SKIPIF--
<?php
/* Only run on PH7/PHL */
...
--FILE--
<?php
$fn = sys_get_temp_dir() . DIRECTORY_SEPARATOR . 'phl_test_zip_corrupt_eocd_offset.zip';
...
/* Corrupt the central directory offset in end-of-central (offset 96-99, set to 0xFFFFFFFF > 2147483647) */
$data[96] = "\xFF";
$data[97] = "\xFF";
$data[98] = "\xFF";
$data[99] = "\xFF";
