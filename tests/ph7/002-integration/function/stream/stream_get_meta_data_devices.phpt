 ...
 * left out of the comparison because it is whatever fd 1 actually SITS ON —
 * false down a pipe, true into a file — which is a fact about the harness, not
 * about the engine. Both engines ask the descriptor and agree either way; the
 * smoke corpus pins the answer for handles whose target is known. */
