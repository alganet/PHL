...
--TEST--
Fiber::suspend() from a nested userland call resumes INSIDE the callee (php semantics; the BYTECODE.md stage-4 acceptance test — flips cross-engine when PHL's activation-record suspend lands)
--SKIPIF--
<?php
