...
|     - |  131 | `	sxu32 nType;` |
|     - |  132 | `};` |
| 20792 |  133 | `static SyMutex * UnixMutexNew(int nType)` |
|     - |  134 |  |
...
|     - |  143 | `	SyMutex *pMutex;` |
|     - |  144 |  |
| 29426 |  145 | `	if( nType == SXMUTEX_TYPE_FAST \|\| nType == SXMUTEX_TYPE_RECURSIVE ){` |
|     - |  146 | `		pthread_mutexattr_t sRecursiveAttr;` |
|     - |  147 | `  		/* Allocate a new mutex */` |
| 17268 |  148 | `  		pMutex = (SyMutex *)malloc(sizeof(SyMutex));` |
| 17268 |  149 | `  		if( pMutex == 0 ){` |
|   ! 0 |  150 | `  			return 0;` |
|     - |  151 | `  		}` |
| 17268 |  152 | `  		if( nType == SXMUTEX_TYPE_RECURSIVE ){` |
|  6696 |  153 | `  			pthread_mutexattr_init(&sRecursiveAttr);` |
|  6696 |  154 | `  			pthread_mutexattr_settype(&sRecursiveAttr,PTHREAD_MUTEX_RECURSIVE);` |
|  3348 |  155 | `  		}` |
| 17268 |  156 | `  		pthread_mutex_init(&pMutex->sMutex,nType == SXMUTEX_TYPE_RECURSIVE ? &sRecursiveAttr : 0 );` |
| 17268 |  157 | `		if(	nType == SXMUTEX_TYPE_RECURSIVE ){` |
|  6696 |  158 | `   			pthread_mutexattr_destroy(&sRecursiveAttr);` |
|  3348 |  159 | `		}` |
|  8634 |  160 | `	}else{` |
|     - |  161 | `		/* Use a pre-allocated static mutex */` |
|  3524 |  162 | `		if( nType > SXMUTEX_TYPE_STATIC_6 ){` |
|   ! 0 |  163 | `			nType = SXMUTEX_TYPE_STATIC_6;` |
|   ! 0 |  164 | `		}` |
|  3524 |  165 | `		pMutex = &aStaticMutexes[nType - 3];` |
|     - |  166 | `	}` |
| 20792 |  167 | `  pMutex->nType = nType;` |
|     - |  168 |  |
| 20792 |  169 | `  return pMutex;` |
| 10396 |  170 |  |
|  7394 |  171 | `static void UnixMutexRelease(SyMutex *pMutex)` |
|     - |  172 |  |
|  7394 |  173 | `	if( pMutex->nType == SXMUTEX_TYPE_FAST \|\| pMutex->nType == SXMUTEX_TYPE_RECURSIVE ){` |
|  7394 |  174 | `		pthread_mutex_destroy(&pMutex->sMutex);` |
|  7394 |  175 | `		free(pMutex);` |
|  3697 |  176 | `	}` |
|  7394 |  177 |  |
| 69162 |  178 | `static void UnixMutexEnter(SyMutex *pMutex)` |
|     - |  179 |  |
| 69162 |  180 | `	pthread_mutex_lock(&pMutex->sMutex);` |
| 69162 |  181 |  |
| 69162 |  182 | `static void UnixMutexLeave(SyMutex *pMutex)` |
|     - |  183 |  |
| 69162 |  184 | `	pthread_mutex_unlock(&pMutex->sMutex);` |
| 69162 |  185 |  |
...
|     - |  195 | `};` |
|  3524 |  196 | `PH7_PRIVATE const SyMutexMethods * SyMutexExportMethods(void)` |
|     - |  197 |  |
|  3524 |  198 | `	return &sPthreadMutexMethods;` |
|     - |  199 |  |
|     - |  200 | `#else` |
