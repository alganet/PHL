...
|     - |  131 | `	sxu32 nType;` |
|     - |  132 | `};` |
| 22880 |  133 | `static SyMutex * UnixMutexNew(int nType)` |
|     - |  134 | `{` |
...
|     - |  143 | `	SyMutex *pMutex;` |
|     - |  144 |  |
| 32375 |  145 | `	if( nType == SXMUTEX_TYPE_FAST \|\| nType == SXMUTEX_TYPE_RECURSIVE ){` |
|     - |  146 | `		pthread_mutexattr_t sRecursiveAttr;` |
|     - |  147 | `  		/* Allocate a new mutex */` |
| 18990 |  148 | `  		pMutex = (SyMutex *)malloc(sizeof(SyMutex));` |
| 18990 |  149 | `  		if( pMutex == 0 ){` |
|   ! 0 |  150 | `  			return 0;` |
|     - |  151 | `  		}` |
| 18990 |  152 | `  		if( nType == SXMUTEX_TYPE_RECURSIVE ){` |
|  7320 |  153 | `  			pthread_mutexattr_init(&sRecursiveAttr);` |
|  7320 |  154 | `  			pthread_mutexattr_settype(&sRecursiveAttr,PTHREAD_MUTEX_RECURSIVE);` |
|  3660 |  155 | `  		}` |
| 18990 |  156 | `  		pthread_mutex_init(&pMutex->sMutex,nType == SXMUTEX_TYPE_RECURSIVE ? &sRecursiveAttr : 0 );` |
| 18990 |  157 | `		if(	nType == SXMUTEX_TYPE_RECURSIVE ){` |
|  7320 |  158 | `   			pthread_mutexattr_destroy(&sRecursiveAttr);` |
|  3660 |  159 | `		}` |
|  9495 |  160 | `	}else{` |
|     - |  161 | `		/* Use a pre-allocated static mutex */` |
|  3890 |  162 | `		if( nType > SXMUTEX_TYPE_STATIC_6 ){` |
|   ! 0 |  163 | `			nType = SXMUTEX_TYPE_STATIC_6;` |
|   ! 0 |  164 | `		}` |
|  3890 |  165 | `		pMutex = &aStaticMutexes[nType - 3];` |
|     - |  166 | `	}` |
| 22880 |  167 | `  pMutex->nType = nType;` |
|     - |  168 |  |
| 22880 |  169 | `  return pMutex;` |
| 11440 |  170 | `}` |
| 11672 |  171 | `static void UnixMutexRelease(SyMutex *pMutex)` |
|     - |  172 | `{` |
| 11672 |  173 | `	if( pMutex->nType == SXMUTEX_TYPE_FAST \|\| pMutex->nType == SXMUTEX_TYPE_RECURSIVE ){` |
| 11672 |  174 | `		pthread_mutex_destroy(&pMutex->sMutex);` |
| 11672 |  175 | `		free(pMutex);` |
|  5836 |  176 | `	}` |
| 11672 |  177 | `}` |
| 78794 |  178 | `static void UnixMutexEnter(SyMutex *pMutex)` |
|     - |  179 | `{` |
| 78794 |  180 | `	pthread_mutex_lock(&pMutex->sMutex);` |
| 78794 |  181 | `}` |
| 78794 |  182 | `static void UnixMutexLeave(SyMutex *pMutex)` |
|     - |  183 | `{` |
| 78794 |  184 | `	pthread_mutex_unlock(&pMutex->sMutex);` |
| 78794 |  185 | `}` |
...
|     - |  195 | `};` |
|  3890 |  196 | `PH7_PRIVATE const SyMutexMethods * SyMutexExportMethods(void)` |
|     - |  197 | `{` |
|  3890 |  198 | `	return &sPthreadMutexMethods;` |
|     - |  199 | `}` |
|     - |  200 | `#else` |
