...
|  3860 |  176 | `	}` |
|  7720 |  177 | `}` |
| 72126 |  178 | `static void UnixMutexEnter(SyMutex *pMutex)` |
|     - |  179 | `{` |
| 72126 |  180 | `	pthread_mutex_lock(&pMutex->sMutex);` |
| 72126 |  181 | `}` |
| 72126 |  182 | `static void UnixMutexLeave(SyMutex *pMutex)` |
|     - |  183 | `{` |
| 72126 |  184 | `	pthread_mutex_unlock(&pMutex->sMutex);` |
| 72126 |  185 | `}` |
