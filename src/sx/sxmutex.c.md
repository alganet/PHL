...
|     - |  131 | `	sxu32 nType;` |
|     - |  132 | `};` |
| 22856 |  133 | `static SyMutex * UnixMutexNew(int nType)` |
|     - |  134 | `{` |
...
|     - |  143 | `	SyMutex *pMutex;` |
|     - |  144 |  |
| 32341 |  145 | `	if( nType == SXMUTEX_TYPE_FAST \|\| nType == SXMUTEX_TYPE_RECURSIVE ){` |
|     - |  146 | `		pthread_mutexattr_t sRecursiveAttr;` |
|     - |  147 | `  		/* Allocate a new mutex */` |
| 18970 |  148 | `  		pMutex = (SyMutex *)malloc(sizeof(SyMutex));` |
| 18970 |  149 | `  		if( pMutex == 0 ){` |
|   ! 0 |  150 | `  			return 0;` |
|     - |  151 | `  		}` |
| 18970 |  152 | `  		if( nType == SXMUTEX_TYPE_RECURSIVE ){` |
|  7312 |  153 | `  			pthread_mutexattr_init(&sRecursiveAttr);` |
|  7312 |  154 | `  			pthread_mutexattr_settype(&sRecursiveAttr,PTHREAD_MUTEX_RECURSIVE);` |
|  3656 |  155 | `  		}` |
| 18970 |  156 | `  		pthread_mutex_init(&pMutex->sMutex,nType == SXMUTEX_TYPE_RECURSIVE ? &sRecursiveAttr : 0 );` |
| 18970 |  157 | `		if(	nType == SXMUTEX_TYPE_RECURSIVE ){` |
|  7312 |  158 | `   			pthread_mutexattr_destroy(&sRecursiveAttr);` |
|  3656 |  159 | `		}` |
|  9485 |  160 | `	}else{` |
|     - |  161 | `		/* Use a pre-allocated static mutex */` |
|  3886 |  162 | `		if( nType > SXMUTEX_TYPE_STATIC_6 ){` |
|   ! 0 |  163 | `			nType = SXMUTEX_TYPE_STATIC_6;` |
|   ! 0 |  164 | `		}` |
|  3886 |  165 | `		pMutex = &aStaticMutexes[nType - 3];` |
|     - |  166 | `	}` |
| 22856 |  167 | `  pMutex->nType = nType;` |
|     - |  168 |  |
| 22856 |  169 | `  return pMutex;` |
| 11428 |  170 | `}` |
| 11660 |  171 | `static void UnixMutexRelease(SyMutex *pMutex)` |
|     - |  172 | `{` |
| 11660 |  173 | `	if( pMutex->nType == SXMUTEX_TYPE_FAST \|\| pMutex->nType == SXMUTEX_TYPE_RECURSIVE ){` |
| 11660 |  174 | `		pthread_mutex_destroy(&pMutex->sMutex);` |
| 11660 |  175 | `		free(pMutex);` |
|  5830 |  176 | `	}` |
| 11660 |  177 | `}` |
| 78706 |  178 | `static void UnixMutexEnter(SyMutex *pMutex)` |
|     - |  179 | `{` |
| 78706 |  180 | `	pthread_mutex_lock(&pMutex->sMutex);` |
| 78706 |  181 | `}` |
| 78706 |  182 | `static void UnixMutexLeave(SyMutex *pMutex)` |
|     - |  183 | `{` |
| 78706 |  184 | `	pthread_mutex_unlock(&pMutex->sMutex);` |
| 78706 |  185 | `}` |
...
|     - |  195 | `};` |
|  3886 |  196 | `PH7_PRIVATE const SyMutexMethods * SyMutexExportMethods(void)` |
|     - |  197 | `{` |
|  3886 |  198 | `	return &sPthreadMutexMethods;` |
|     - |  199 | `}` |
|     - |  200 | `#else` |
