...
|     - |  131 | `	sxu32 nType;` |
|     - |  132 | `};` |
| 16660 |  133 | `static SyMutex * UnixMutexNew(int nType)` |
|     - |  134 |  |
...
|     - |  143 | `	SyMutex *pMutex;` |
|     - |  144 |  |
| 23578 |  145 | `	if( nType == SXMUTEX_TYPE_FAST \|\| nType == SXMUTEX_TYPE_RECURSIVE ){` |
|     - |  146 | `		pthread_mutexattr_t sRecursiveAttr;` |
|     - |  147 | `  		/* Allocate a new mutex */` |
| 13836 |  148 | `  		pMutex = (SyMutex *)malloc(sizeof(SyMutex));` |
| 13836 |  149 | `  		if( pMutex == 0 ){` |
|   ! 0 |  150 | `  			return 0;` |
|     - |  151 | `  		}` |
| 13836 |  152 | `  		if( nType == SXMUTEX_TYPE_RECURSIVE ){` |
|  5364 |  153 | `  			pthread_mutexattr_init(&sRecursiveAttr);` |
|  5364 |  154 | `  			pthread_mutexattr_settype(&sRecursiveAttr,PTHREAD_MUTEX_RECURSIVE);` |
|  2682 |  155 | `  		}` |
| 13836 |  156 | `  		pthread_mutex_init(&pMutex->sMutex,nType == SXMUTEX_TYPE_RECURSIVE ? &sRecursiveAttr : 0 );` |
| 13836 |  157 | `		if(	nType == SXMUTEX_TYPE_RECURSIVE ){` |
|  5364 |  158 | `   			pthread_mutexattr_destroy(&sRecursiveAttr);` |
|  2682 |  159 | `		}` |
|  6918 |  160 | `	}else{` |
|     - |  161 | `		/* Use a pre-allocated static mutex */` |
|  2824 |  162 | `		if( nType > SXMUTEX_TYPE_STATIC_6 ){` |
|   ! 0 |  163 | `			nType = SXMUTEX_TYPE_STATIC_6;` |
|   ! 0 |  164 | `		}` |
|  2824 |  165 | `		pMutex = &aStaticMutexes[nType - 3];` |
|     - |  166 | `	}` |
| 16660 |  167 | `  pMutex->nType = nType;` |
|     - |  168 |  |
| 16660 |  169 | `  return pMutex;` |
|  8330 |  170 |  |
|  5922 |  171 | `static void UnixMutexRelease(SyMutex *pMutex)` |
|     - |  172 |  |
|  5922 |  173 | `	if( pMutex->nType == SXMUTEX_TYPE_FAST \|\| pMutex->nType == SXMUTEX_TYPE_RECURSIVE ){` |
|  5922 |  174 | `		pthread_mutex_destroy(&pMutex->sMutex);` |
|  5922 |  175 | `		free(pMutex);` |
|  2961 |  176 | `	}` |
|  5922 |  177 |  |
| 35010 |  178 | `static void UnixMutexEnter(SyMutex *pMutex)` |
|     - |  179 |  |
| 35010 |  180 | `	pthread_mutex_lock(&pMutex->sMutex);` |
| 35010 |  181 |  |
| 35002 |  182 | `static void UnixMutexLeave(SyMutex *pMutex)` |
|     - |  183 |  |
| 35002 |  184 | `	pthread_mutex_unlock(&pMutex->sMutex);` |
| 35002 |  185 |  |
...
|     - |  195 | `};` |
|  2824 |  196 | `PH7_PRIVATE const SyMutexMethods * SyMutexExportMethods(void)` |
|     - |  197 |  |
|  2824 |  198 | `	return &sPthreadMutexMethods;` |
|     - |  199 |  |
|     - |  200 | `#else` |
