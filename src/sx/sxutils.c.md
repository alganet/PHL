...
|       1 |  166 | `}` |
| 2325485 |  167 | `PH7_PRIVATE sxi32 SyStrToInt64(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  168 | `{` |
| 2325490 |  169 | `	int isNeg = FALSE;` |
|       - |  170 | `	const char *zEnd;` |
|       - |  171 | `	sxi64 nVal;` |
...
| 2325490 |  178 | `	int bOverflow = FALSE;` |
...
|       - |  185 | `	}` |
|       - |  186 | `#endif` |
| 2325490 |  187 | `	zEnd = &zSrc[nLen];` |
| 2325512 |  188 | `	while(zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|      24 |  189 | `		zSrc++;` |
|       2 |  190 | `	}` |
| 2325490 |  191 | `	if( zSrc < zEnd && ( zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
|      33 |  192 | `		isNeg = (zSrc[0] == '-') ? TRUE :FALSE;` |
|      33 |  193 | `		zSrc++;` |
|      15 |  194 | `	}` |
|       - |  195 | `	/* Skip leading zero */` |
| 2326854 |  196 | `	while(zSrc < zEnd && zSrc[0] == '0' ){` |
|    1365 |  197 | `		zSrc++;` |
|       1 |  198 | `	}` |
| 2325490 |  199 | `	cutoff = isNeg ? ((sxu64)SXI64_HIGH + 1) : (sxu64)SXI64_HIGH;` |
| 2325490 |  200 | `	uVal = 0;` |
| 5620723 |  201 | `	while( zSrc < zEnd && (unsigned char)zSrc[0] < 0xc0 && SyisDigit(zSrc[0]) ){` |
| 3295238 |  202 | `		int d = zSrc[0] - '0';` |
| 3295238 |  203 | `		if( uVal > cutoff / 10 \|\| (uVal == cutoff / 10 && (sxu64)d > cutoff % 10) ){` |
|      33 |  204 | `			bOverflow = TRUE;` |
|      17 |  205 | `		}else{` |
| 3295206 |  206 | `			uVal = uVal * 10 + (sxu64)d;` |
|       - |  207 | `		}` |
| 3295238 |  208 | `		zSrc++;` |
|       5 |  209 | `	}` |
| 2325490 |  210 | `	if( bOverflow ){` |
|      25 |  211 | `		uVal = cutoff;` |
|      12 |  212 | `	}` |
|       - |  213 | `	/* Skip trailing spaces */` |
| 2325512 |  214 | `	while(zSrc < zEnd && SyisSpace(zSrc[0])){` |
|      24 |  215 | `		zSrc++;` |
|       2 |  216 | `	}` |
| 2325490 |  217 | `	if( zRest ){` |
|     ! 0 |  218 | `		*zRest = (char *)zSrc;` |
|     ! 0 |  219 | `	}` |
| 2325490 |  220 | `	if( pOutVal ){` |
| 2325490 |  221 | `		if( isNeg ){` |
...
|      18 |  225 | `		}else{` |
| 2325460 |  226 | `			nVal = (sxi64)uVal;` |
|       - |  227 | `		}` |
| 2325490 |  228 | `		*(sxi64 *)pOutVal = nVal;` |
| 1162742 |  229 | `	}` |
| 2325490 |  230 | `	return (zSrc >= zEnd) ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  231 | `}` |
|  324410 |  232 | `PH7_PRIVATE sxi32 SyHexToint(sxi32 c)` |
|       5 |  233 | `{` |
|  324415 |  234 | `	switch(c){` |
...
|   11763 |  244 | `	case '9': return 9;` |
|   11767 |  245 | `	case 'A': case 'a': return 10;` |
...
|       1 |  419 | `}` |
|    8854 |  420 | `PH7_PRIVATE sxi32 SyStrToReal(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  421 | `{` |
...
|       - |  434 | `	char zBuf[512];` |
|    8859 |  435 | `	const char *zEnd = &zSrc[nLen];` |
|       - |  436 | `	const char *zNum;` |
|    8859 |  437 | `	const char *zExpStart = 0;` |
|    8859 |  438 | `	sxreal Val = 0.0;` |
|    8859 |  439 | `	sxu32 nCopy = 0;` |
|    8859 |  440 | `	int bDigit = 0;` |
|       - |  441 | `#ifdef UNTRUST` |
...
|    8863 |  450 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|       5 |  451 | `		zSrc++;` |
|       1 |  452 | `	}` |
|    8859 |  453 | `	zNum = zSrc;` |
|       - |  454 | `	/* Sign (if exists) */` |
|    8859 |  455 | `	if( zSrc < zEnd && (zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
|      14 |  456 | `		zSrc++;` |
|       6 |  457 | `	}` |
|       - |  458 | `	/* Integer part */` |
|   18751 |  459 | `	while( zSrc < zEnd && SyisDigit(zSrc[0]) ){` |
|    9897 |  460 | `		bDigit = 1;` |
|    9897 |  461 | `		zSrc++;` |
|       5 |  462 | `	}` |
|       - |  463 | `	/* Fractional part */` |
|    8859 |  464 | `	if( zSrc < zEnd && ( zSrc[0] == '.' \|\| zSrc[0] == ',' ) ){` |
|    8707 |  465 | `		zSrc++;` |
|   19991 |  466 | `		while( zSrc < zEnd && SyisDigit(zSrc[0]) ){` |
|   11289 |  467 | `			bDigit = 1;` |
|   11289 |  468 | `			zSrc++;` |
|       5 |  469 | `		}` |
|    4351 |  470 | `	}` |
...
|    8859 |  473 | `	if( bDigit && zSrc < zEnd && ( zSrc[0] == 'e' \|\| zSrc[0] == 'E' ) ){` |
...
|      93 |  485 | `	}` |
|    8859 |  486 | `	if( bDigit ){` |
|    8859 |  487 | `		sxu32 i, nSpan = (sxu32)((zExpStart ? zExpStart : zSrc) - zNum);` |
|    8859 |  488 | `		sxu32 nExp = zExpStart ? (sxu32)(zSrc - zExpStart) : 0;` |
|    8859 |  489 | `		char *zDup = zBuf;` |
|    8859 |  490 | `		sxu32 nDup = sizeof(zBuf);` |
|    8859 |  491 | `		if( nSpan + nExp >= sizeof(zBuf) ){` |
...
|       1 |  497 | `		}` |
|       - |  498 | `		{` |
|    8859 |  499 | `			sxu32 nMantMax = nDup - 1 - (nExp < nDup - 1 ? nExp : 0);` |
|   38749 |  500 | `			for( i = 0 ; i < nSpan && nCopy < nMantMax ; i++ ){` |
|   29895 |  501 | `				zDup[nCopy++] = (zNum[i] == ',') ? '.' : zNum[i];` |
|   14950 |  502 | `			}` |
|       - |  503 | `			/* The exponent rides behind even a truncated mantissa: dropping` |
|       - |  504 | `			 * it would collapse "0.<hundreds of zeros>1e300" to 0.0. */` |
|    9495 |  505 | `			for( i = 0 ; i < nExp && nCopy < nDup - 1 ; i++ ){` |
|     639 |  506 | `				zDup[nCopy++] = zExpStart[i];` |
|     321 |  507 | `			}` |
|       - |  508 | `		}` |
|    8859 |  509 | `		zDup[nCopy] = 0;` |
|    8859 |  510 | `		Val = (sxreal)strtod(zDup,0);` |
|    8859 |  511 | `		if( zDup != zBuf ){` |
|       3 |  512 | `			free(zDup);` |
|       1 |  513 | `		}` |
|    4427 |  514 | `	}` |
|       - |  515 | `	/* Jump trailing spaces */` |
|    8859 |  516 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|     ! 0 |  517 | `		zSrc++;` |
|     ! 0 |  518 | `	}` |
|    8859 |  519 | `	if( zRest ){` |
|     ! 0 |  520 | `		*zRest = zSrc;` |
|     ! 0 |  521 | `	}` |
|    8859 |  522 | `	if( pOutVal ){` |
|    8859 |  523 | `		*(sxreal *)pOutVal = Val;` |
|    4427 |  524 | `	}` |
|    8859 |  525 | `	return zSrc >= zEnd ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  526 | `}` |
|       - |  527 |  |
