...
|       1 |  166 | `}` |
| 2326661 |  167 | `PH7_PRIVATE sxi32 SyStrToInt64(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  168 | `{` |
| 2326666 |  169 | `	int isNeg = FALSE;` |
|       - |  170 | `	const char *zEnd;` |
|       - |  171 | `	sxi64 nVal;` |
...
| 2326666 |  178 | `	int bOverflow = FALSE;` |
...
|       - |  185 | `	}` |
|       - |  186 | `#endif` |
| 2326666 |  187 | `	zEnd = &zSrc[nLen];` |
| 2326688 |  188 | `	while(zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|      24 |  189 | `		zSrc++;` |
|       2 |  190 | `	}` |
| 2326666 |  191 | `	if( zSrc < zEnd && ( zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
|      33 |  192 | `		isNeg = (zSrc[0] == '-') ? TRUE :FALSE;` |
|      33 |  193 | `		zSrc++;` |
|      15 |  194 | `	}` |
|       - |  195 | `	/* Skip leading zero */` |
| 2328033 |  196 | `	while(zSrc < zEnd && zSrc[0] == '0' ){` |
|    1368 |  197 | `		zSrc++;` |
|       1 |  198 | `	}` |
| 2326666 |  199 | `	cutoff = isNeg ? ((sxu64)SXI64_HIGH + 1) : (sxu64)SXI64_HIGH;` |
| 2326666 |  200 | `	uVal = 0;` |
| 5623562 |  201 | `	while( zSrc < zEnd && (unsigned char)zSrc[0] < 0xc0 && SyisDigit(zSrc[0]) ){` |
| 3296901 |  202 | `		int d = zSrc[0] - '0';` |
| 3296901 |  203 | `		if( uVal > cutoff / 10 \|\| (uVal == cutoff / 10 && (sxu64)d > cutoff % 10) ){` |
|      33 |  204 | `			bOverflow = TRUE;` |
|      17 |  205 | `		}else{` |
| 3296869 |  206 | `			uVal = uVal * 10 + (sxu64)d;` |
|       - |  207 | `		}` |
| 3296901 |  208 | `		zSrc++;` |
|       5 |  209 | `	}` |
| 2326666 |  210 | `	if( bOverflow ){` |
|      25 |  211 | `		uVal = cutoff;` |
|      12 |  212 | `	}` |
|       - |  213 | `	/* Skip trailing spaces */` |
| 2326688 |  214 | `	while(zSrc < zEnd && SyisSpace(zSrc[0])){` |
|      24 |  215 | `		zSrc++;` |
|       2 |  216 | `	}` |
| 2326666 |  217 | `	if( zRest ){` |
|     ! 0 |  218 | `		*zRest = (char *)zSrc;` |
|     ! 0 |  219 | `	}` |
| 2326666 |  220 | `	if( pOutVal ){` |
| 2326666 |  221 | `		if( isNeg ){` |
...
|      18 |  225 | `		}else{` |
| 2326636 |  226 | `			nVal = (sxi64)uVal;` |
|       - |  227 | `		}` |
| 2326666 |  228 | `		*(sxi64 *)pOutVal = nVal;` |
| 1163330 |  229 | `	}` |
| 2326666 |  230 | `	return (zSrc >= zEnd) ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  231 | `}` |
|  324576 |  232 | `PH7_PRIVATE sxi32 SyHexToint(sxi32 c)` |
|       5 |  233 | `{` |
|  324581 |  234 | `	switch(c){` |
|  132651 |  235 | `	case '0': return 0;` |
|   11751 |  236 | `	case '1': return 1;` |
|   77901 |  237 | `	case '2': return 2;` |
|    7863 |  238 | `	case '3': return 3;` |
|    3941 |  239 | `	case '4': return 4;` |
|   11703 |  240 | `	case '5': return 5;` |
|    7821 |  241 | `	case '6': return 6;` |
|    3919 |  242 | `	case '7': return 7;` |
|   19537 |  243 | `	case '8': return 8;` |
|   11769 |  244 | `	case '9': return 9;` |
|   11773 |  245 | `	case 'A': case 'a': return 10;` |
|    3929 |  246 | `	case 'B': case 'b': return 11;` |
|    4013 |  247 | `	case 'C': case 'c': return 12;` |
|    3923 |  248 | `	case 'D': case 'd': return 13;` |
|    3989 |  249 | `	case 'E': case 'e': return 14;` |
|    8171 |  250 | `	case 'F': case 'f': return 15;` |
|       - |  251 | `	}` |
|       3 |  252 | `	return -1;` |
|  162293 |  253 | `}` |
|  105168 |  254 | `PH7_PRIVATE sxi32 SyHexStrToInt64(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  255 | `{` |
|       - |  256 | `	const char *zIn,*zEnd;` |
|  105173 |  257 | `	int isNeg = FALSE;` |
|  105173 |  258 | `	sxi64 nVal = 0;` |
...
|       - |  265 | `	}` |
|       - |  266 | `#endif` |
|  105173 |  267 | `	zEnd = &zSrc[nLen];` |
|  105173 |  268 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|     ! 0 |  269 | `		zSrc++;` |
|     ! 0 |  270 | `	}` |
|  105173 |  271 | `	if( zSrc < zEnd && ( *zSrc == '-' \|\| *zSrc == '+' ) ){` |
|     ! 0 |  272 | `		isNeg = (zSrc[0] == '-') ? TRUE :FALSE;` |
|     ! 0 |  273 | `		zSrc++;` |
|     ! 0 |  274 | `	}` |
|  105173 |  275 | `	if( zSrc < &zEnd[-2] && zSrc[0] == '0' && (zSrc[1] == 'x' \|\| zSrc[1] == 'X') ){` |
|       - |  276 | `		/* Bypass hex prefix */` |
|  105173 |  277 | `		zSrc += sizeof(char) * 2;` |
|   52584 |  278 | `	}` |
|       - |  279 | `	/* Skip leading zero */` |
|  132425 |  280 | `	while(zSrc < zEnd && zSrc[0] == '0' ){` |
|   27257 |  281 | `		zSrc++;` |
|       5 |  282 | `	}` |
|  105173 |  283 | `	zIn = zSrc;` |
|   87653 |  284 | `	for(;;){` |
|  175311 |  285 | `		if(zSrc >= zEnd \|\| !SyisHex(zSrc[0]) \|\| (int)(zSrc-zIn) > 15){` |
|   37006 |  286 | `			break;` |
|       - |  287 | `		}` |
|  101309 |  288 | `		nVal = nVal * 16 + SyHexToint(zSrc[0]);` |
|  101309 |  289 | `		zSrc++;` |
|  101309 |  290 | `		if(zSrc >= zEnd \|\| !SyisHex(zSrc[0]) \|\| (int)(zSrc-zIn) > 15){` |
|    9740 |  291 | `			break;` |
|       - |  292 | `		}` |
|   81839 |  293 | `		nVal = nVal * 16 + SyHexToint(zSrc[0]);` |
|   81839 |  294 | `		zSrc++;` |
|   81839 |  295 | `		if(zSrc >= zEnd \|\| !SyisHex(zSrc[0]) \|\| (int)(zSrc-zIn) > 15){` |
|    5853 |  296 | `			break;` |
|       - |  297 | `		}` |
|   70143 |  298 | `		nVal = nVal * 16 + SyHexToint(zSrc[0]);` |
|   70143 |  299 | `		zSrc++;` |
|   70143 |  300 | `		if(zSrc >= zEnd \|\| !SyisHex(zSrc[0]) \|\| (int)(zSrc-zIn) > 15){` |
|     ! 0 |  301 | `			break;` |
|       - |  302 | `		}` |
|   70143 |  303 | `		nVal = nVal * 16 + SyHexToint(zSrc[0]);` |
|   70143 |  304 | `		zSrc++;` |
|       5 |  305 | `	}` |
|  105173 |  306 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|     ! 0 |  307 | `		zSrc++;` |
|     ! 0 |  308 | `	}` |
|  105173 |  309 | `	if( zRest ){` |
|     ! 0 |  310 | `		*zRest = zSrc;` |
|     ! 0 |  311 | `	}` |
|  105173 |  312 | `	if( pOutVal ){` |
|  105173 |  313 | `		if( isNeg == TRUE && nVal != 0 ){` |
|     ! 0 |  314 | `			nVal = -nVal;` |
|     ! 0 |  315 | `		}` |
|  105173 |  316 | `		*(sxi64 *)pOutVal = nVal;` |
|   52584 |  317 | `	}` |
|  105173 |  318 | `	return zSrc >= zEnd ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  319 | `}` |
|    3976 |  320 | `PH7_PRIVATE sxi32 SyOctalStrToInt64(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  321 | `{` |
|       - |  322 | `	const char *zIn,*zEnd;` |
|    3981 |  323 | `	int isNeg = FALSE;` |
|    3981 |  324 | `	sxi64 nVal = 0;` |
|       - |  325 | `	int c;` |
...
|       - |  332 | `	}` |
|       - |  333 | `#endif` |
|    3981 |  334 | `	zEnd = &zSrc[nLen];` |
|    3981 |  335 | `	while(zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|     ! 0 |  336 | `		zSrc++;` |
|     ! 0 |  337 | `	}` |
|    3981 |  338 | `	if( zSrc < zEnd && ( zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
|     ! 0 |  339 | `		isNeg = (zSrc[0] == '-') ? TRUE :FALSE;` |
|     ! 0 |  340 | `		zSrc++;` |
|     ! 0 |  341 | `	}` |
|       - |  342 | `	/* Skip leading zero */` |
|    7947 |  343 | `	while(zSrc < zEnd && zSrc[0] == '0' ){` |
|    3971 |  344 | `		zSrc++;` |
|       5 |  345 | `	}` |
|    3981 |  346 | `	zIn = zSrc;` |
|    1998 |  347 | `	for(;;){` |
|    4001 |  348 | `		if(zSrc >= zEnd \|\| !SyisDigit(zSrc[0])){ break; } if( (c=zSrc[0]-'0') > 7 \|\| (int)(zSrc-zIn) > 20){ break;} nVal = nVal * 8 +  c; zSrc++;` |
|    3999 |  349 | `		if(zSrc >= zEnd \|\| !SyisDigit(zSrc[0])){ break; } if( (c=zSrc[0]-'0') > 7 \|\| (int)(zSrc-zIn) > 20){ break;} nVal = nVal * 8 +  c; zSrc++;` |
|    3989 |  350 | `		if(zSrc >= zEnd \|\| !SyisDigit(zSrc[0])){ break; } if( (c=zSrc[0]-'0') > 7 \|\| (int)(zSrc-zIn) > 20){ break;} nVal = nVal * 8 +  c; zSrc++;` |
|    3967 |  351 | `		if(zSrc >= zEnd \|\| !SyisDigit(zSrc[0])){ break; } if( (c=zSrc[0]-'0') > 7 \|\| (int)(zSrc-zIn) > 20){ break;} nVal = nVal * 8 +  c; zSrc++;` |
|       1 |  352 | `	}` |
|       - |  353 | `	/* Skip trailing spaces */` |
|    3981 |  354 | `	while(zSrc < zEnd && SyisSpace(zSrc[0])){` |
|     ! 0 |  355 | `		zSrc++;` |
|     ! 0 |  356 | `	}` |
|    3981 |  357 | `	if( zRest ){` |
|     ! 0 |  358 | `		*zRest = zSrc;` |
|     ! 0 |  359 | `	}` |
|    3981 |  360 | `	if( pOutVal ){` |
|    3981 |  361 | `		if( isNeg == TRUE && nVal != 0 ){` |
|     ! 0 |  362 | `			nVal = -nVal;` |
|     ! 0 |  363 | `		}` |
|    3981 |  364 | `		*(sxi64 *)pOutVal = nVal;` |
|    1988 |  365 | `	}` |
|    3981 |  366 | `	return (zSrc >= zEnd) ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  367 | `}` |
...
|       1 |  419 | `}` |
|    8858 |  420 | `PH7_PRIVATE sxi32 SyStrToReal(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  421 | `{` |
...
|       - |  434 | `	char zBuf[512];` |
|    8863 |  435 | `	const char *zEnd = &zSrc[nLen];` |
|       - |  436 | `	const char *zNum;` |
|    8863 |  437 | `	const char *zExpStart = 0;` |
|    8863 |  438 | `	sxreal Val = 0.0;` |
|    8863 |  439 | `	sxu32 nCopy = 0;` |
|    8863 |  440 | `	int bDigit = 0;` |
|       - |  441 | `#ifdef UNTRUST` |
...
|    8867 |  450 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|       5 |  451 | `		zSrc++;` |
|       1 |  452 | `	}` |
|    8863 |  453 | `	zNum = zSrc;` |
|       - |  454 | `	/* Sign (if exists) */` |
|    8863 |  455 | `	if( zSrc < zEnd && (zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
|      14 |  456 | `		zSrc++;` |
|       6 |  457 | `	}` |
|       - |  458 | `	/* Integer part */` |
|   18759 |  459 | `	while( zSrc < zEnd && SyisDigit(zSrc[0]) ){` |
|    9901 |  460 | `		bDigit = 1;` |
|    9901 |  461 | `		zSrc++;` |
|       5 |  462 | `	}` |
|       - |  463 | `	/* Fractional part */` |
|    8863 |  464 | `	if( zSrc < zEnd && ( zSrc[0] == '.' \|\| zSrc[0] == ',' ) ){` |
|    8711 |  465 | `		zSrc++;` |
|   19999 |  466 | `		while( zSrc < zEnd && SyisDigit(zSrc[0]) ){` |
|   11293 |  467 | `			bDigit = 1;` |
|   11293 |  468 | `			zSrc++;` |
|       5 |  469 | `		}` |
|    4353 |  470 | `	}` |
...
|    8863 |  473 | `	if( bDigit && zSrc < zEnd && ( zSrc[0] == 'e' \|\| zSrc[0] == 'E' ) ){` |
...
|      93 |  485 | `	}` |
|    8863 |  486 | `	if( bDigit ){` |
|    8863 |  487 | `		sxu32 i, nSpan = (sxu32)((zExpStart ? zExpStart : zSrc) - zNum);` |
|    8863 |  488 | `		sxu32 nExp = zExpStart ? (sxu32)(zSrc - zExpStart) : 0;` |
|    8863 |  489 | `		char *zDup = zBuf;` |
|    8863 |  490 | `		sxu32 nDup = sizeof(zBuf);` |
|    8863 |  491 | `		if( nSpan + nExp >= sizeof(zBuf) ){` |
...
|       1 |  497 | `		}` |
|       - |  498 | `		{` |
|    8863 |  499 | `			sxu32 nMantMax = nDup - 1 - (nExp < nDup - 1 ? nExp : 0);` |
|   38765 |  500 | `			for( i = 0 ; i < nSpan && nCopy < nMantMax ; i++ ){` |
|   29907 |  501 | `				zDup[nCopy++] = (zNum[i] == ',') ? '.' : zNum[i];` |
|   14956 |  502 | `			}` |
...
|     321 |  507 | `			}` |
|       - |  508 | `		}` |
|    8863 |  509 | `		zDup[nCopy] = 0;` |
|    8863 |  510 | `		Val = (sxreal)strtod(zDup,0);` |
|    8863 |  511 | `		if( zDup != zBuf ){` |
|       3 |  512 | `			free(zDup);` |
|       1 |  513 | `		}` |
|    4429 |  514 | `	}` |
|       - |  515 | `	/* Jump trailing spaces */` |
|    8863 |  516 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|     ! 0 |  517 | `		zSrc++;` |
|     ! 0 |  518 | `	}` |
|    8863 |  519 | `	if( zRest ){` |
|     ! 0 |  520 | `		*zRest = zSrc;` |
|     ! 0 |  521 | `	}` |
|    8863 |  522 | `	if( pOutVal ){` |
|    8863 |  523 | `		*(sxreal *)pOutVal = Val;` |
|    4429 |  524 | `	}` |
|    8863 |  525 | `	return zSrc >= zEnd ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  526 | `}` |
|       - |  527 |  |
