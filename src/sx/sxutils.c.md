...
|       1 |  166 | `}` |
| 2033922 |  167 | `PH7_PRIVATE sxi32 SyStrToInt64(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  168 | `{` |
| 2033927 |  169 | `	int isNeg = FALSE;` |
|       - |  170 | `	const char *zEnd;` |
|       - |  171 | `	sxi64 nVal;` |
...
| 2033927 |  178 | `	int bOverflow = FALSE;` |
...
|       - |  185 | `	}` |
|       - |  186 | `#endif` |
| 2033927 |  187 | `	zEnd = &zSrc[nLen];` |
| 2033953 |  188 | `	while(zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|      28 |  189 | `		zSrc++;` |
|       2 |  190 | `	}` |
| 2033927 |  191 | `	if( zSrc < zEnd && ( zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
|      21 |  192 | `		isNeg = (zSrc[0] == '-') ? TRUE :FALSE;` |
|      21 |  193 | `		zSrc++;` |
|      10 |  194 | `	}` |
|       - |  195 | `	/* Skip leading zero */` |
| 2034047 |  196 | `	while(zSrc < zEnd && zSrc[0] == '0' ){` |
|     121 |  197 | `		zSrc++;` |
|       1 |  198 | `	}` |
| 2033927 |  199 | `	cutoff = isNeg ? ((sxu64)SXI64_HIGH + 1) : (sxu64)SXI64_HIGH;` |
| 2033927 |  200 | `	uVal = 0;` |
| 4890113 |  201 | `	while( zSrc < zEnd && (unsigned char)zSrc[0] < 0xc0 && SyisDigit(zSrc[0]) ){` |
| 2856191 |  202 | `		int d = zSrc[0] - '0';` |
| 2856191 |  203 | `		if( uVal > cutoff / 10 \|\| (uVal == cutoff / 10 && (sxu64)d > cutoff % 10) ){` |
|      33 |  204 | `			bOverflow = TRUE;` |
|      17 |  205 | `		}else{` |
| 2856159 |  206 | `			uVal = uVal * 10 + (sxu64)d;` |
|       - |  207 | `		}` |
| 2856191 |  208 | `		zSrc++;` |
|       5 |  209 | `	}` |
| 2033927 |  210 | `	if( bOverflow ){` |
|      25 |  211 | `		uVal = cutoff;` |
|      12 |  212 | `	}` |
|       - |  213 | `	/* Skip trailing spaces */` |
| 2033953 |  214 | `	while(zSrc < zEnd && SyisSpace(zSrc[0])){` |
|      28 |  215 | `		zSrc++;` |
|       2 |  216 | `	}` |
| 2033927 |  217 | `	if( zRest ){` |
|     ! 0 |  218 | `		*zRest = (char *)zSrc;` |
|     ! 0 |  219 | `	}` |
| 2033927 |  220 | `	if( pOutVal ){` |
| 2033927 |  221 | `		if( isNeg ){` |
...
|      11 |  225 | `		}else{` |
| 2033907 |  226 | `			nVal = (sxi64)uVal;` |
|       - |  227 | `		}` |
| 2033927 |  228 | `		*(sxi64 *)pOutVal = nVal;` |
| 1016961 |  229 | `	}` |
| 2033927 |  230 | `	return (zSrc >= zEnd) ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  231 | `}` |
