...
|       1 |  166 | `}` |
| 2292296 |  167 | `PH7_PRIVATE sxi32 SyStrToInt64(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  168 | `{` |
| 2292301 |  169 | `	int isNeg = FALSE;` |
|       - |  170 | `	const char *zEnd;` |
|       - |  171 | `	sxi64 nVal;` |
...
| 2292301 |  178 | `	int bOverflow = FALSE;` |
...
|       - |  185 | `	}` |
|       - |  186 | `#endif` |
| 2292301 |  187 | `	zEnd = &zSrc[nLen];` |
| 2292327 |  188 | `	while(zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|      28 |  189 | `		zSrc++;` |
|       2 |  190 | `	}` |
| 2292301 |  191 | `	if( zSrc < zEnd && ( zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
|      21 |  192 | `		isNeg = (zSrc[0] == '-') ? TRUE :FALSE;` |
|      21 |  193 | `		zSrc++;` |
|      10 |  194 | `	}` |
|       - |  195 | `	/* Skip leading zero */` |
| 2293671 |  196 | `	while(zSrc < zEnd && zSrc[0] == '0' ){` |
|    1371 |  197 | `		zSrc++;` |
|       1 |  198 | `	}` |
| 2292301 |  199 | `	cutoff = isNeg ? ((sxu64)SXI64_HIGH + 1) : (sxu64)SXI64_HIGH;` |
| 2292301 |  200 | `	uVal = 0;` |
| 5551951 |  201 | `	while( zSrc < zEnd && (unsigned char)zSrc[0] < 0xc0 && SyisDigit(zSrc[0]) ){` |
| 3259655 |  202 | `		int d = zSrc[0] - '0';` |
| 3259655 |  203 | `		if( uVal > cutoff / 10 \|\| (uVal == cutoff / 10 && (sxu64)d > cutoff % 10) ){` |
|      33 |  204 | `			bOverflow = TRUE;` |
|      17 |  205 | `		}else{` |
| 3259623 |  206 | `			uVal = uVal * 10 + (sxu64)d;` |
|       - |  207 | `		}` |
| 3259655 |  208 | `		zSrc++;` |
|       5 |  209 | `	}` |
| 2292301 |  210 | `	if( bOverflow ){` |
|      25 |  211 | `		uVal = cutoff;` |
|      12 |  212 | `	}` |
|       - |  213 | `	/* Skip trailing spaces */` |
| 2292327 |  214 | `	while(zSrc < zEnd && SyisSpace(zSrc[0])){` |
|      28 |  215 | `		zSrc++;` |
|       2 |  216 | `	}` |
| 2292301 |  217 | `	if( zRest ){` |
|     ! 0 |  218 | `		*zRest = (char *)zSrc;` |
|     ! 0 |  219 | `	}` |
| 2292301 |  220 | `	if( pOutVal ){` |
| 2292301 |  221 | `		if( isNeg ){` |
...
|      11 |  225 | `		}else{` |
| 2292281 |  226 | `			nVal = (sxi64)uVal;` |
|       - |  227 | `		}` |
| 2292301 |  228 | `		*(sxi64 *)pOutVal = nVal;` |
| 1146148 |  229 | `	}` |
| 2292301 |  230 | `	return (zSrc >= zEnd) ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  231 | `}` |
|  324088 |  232 | `PH7_PRIVATE sxi32 SyHexToint(sxi32 c)` |
|       5 |  233 | `{` |
|  324093 |  234 | `	switch(c){` |
|  132557 |  235 | `	case '0': return 0;` |
|   11745 |  236 | `	case '1': return 1;` |
|   77669 |  237 | `	case '2': return 2;` |
|    7859 |  238 | `	case '3': return 3;` |
|    3947 |  239 | `	case '4': return 4;` |
|   11683 |  240 | `	case '5': return 5;` |
|    7803 |  241 | `	case '6': return 6;` |
|    3907 |  242 | `	case '7': return 7;` |
|   19477 |  243 | `	case '8': return 8;` |
|   11735 |  244 | `	case '9': return 9;` |
|   11751 |  245 | `	case 'A': case 'a': return 10;` |
|    3927 |  246 | `	case 'B': case 'b': return 11;` |
|    4019 |  247 | `	case 'C': case 'c': return 12;` |
|    3911 |  248 | `	case 'D': case 'd': return 13;` |
|    3981 |  249 | `	case 'E': case 'e': return 14;` |
|    8195 |  250 | `	case 'F': case 'f': return 15;` |
|       - |  251 | `	}` |
|       3 |  252 | `	return -1;` |
|  162049 |  253 | `}` |
...
|       1 |  419 | `}` |
|    8844 |  420 | `PH7_PRIVATE sxi32 SyStrToReal(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  421 | `{` |
...
|       - |  434 | `	char zBuf[512];` |
|    8849 |  435 | `	const char *zEnd = &zSrc[nLen];` |
|       - |  436 | `	const char *zNum;` |
|    8849 |  437 | `	const char *zExpStart = 0;` |
|    8849 |  438 | `	sxreal Val = 0.0;` |
|    8849 |  439 | `	sxu32 nCopy = 0;` |
|    8849 |  440 | `	int bDigit = 0;` |
|       - |  441 | `#ifdef UNTRUST` |
...
|    8853 |  450 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|       5 |  451 | `		zSrc++;` |
|       1 |  452 | `	}` |
|    8849 |  453 | `	zNum = zSrc;` |
|       - |  454 | `	/* Sign (if exists) */` |
|    8849 |  455 | `	if( zSrc < zEnd && (zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
|      12 |  456 | `		zSrc++;` |
|       5 |  457 | `	}` |
|       - |  458 | `	/* Integer part */` |
|   18731 |  459 | `	while( zSrc < zEnd && SyisDigit(zSrc[0]) ){` |
|    9887 |  460 | `		bDigit = 1;` |
|    9887 |  461 | `		zSrc++;` |
|       5 |  462 | `	}` |
|       - |  463 | `	/* Fractional part */` |
|    8849 |  464 | `	if( zSrc < zEnd && ( zSrc[0] == '.' \|\| zSrc[0] == ',' ) ){` |
|    8697 |  465 | `		zSrc++;` |
|   19973 |  466 | `		while( zSrc < zEnd && SyisDigit(zSrc[0]) ){` |
|   11281 |  467 | `			bDigit = 1;` |
|   11281 |  468 | `			zSrc++;` |
|       5 |  469 | `		}` |
|    4346 |  470 | `	}` |
...
|    8849 |  473 | `	if( bDigit && zSrc < zEnd && ( zSrc[0] == 'e' \|\| zSrc[0] == 'E' ) ){` |
...
|      93 |  485 | `	}` |
|    8849 |  486 | `	if( bDigit ){` |
|    8849 |  487 | `		sxu32 i, nSpan = (sxu32)((zExpStart ? zExpStart : zSrc) - zNum);` |
|    8849 |  488 | `		sxu32 nExp = zExpStart ? (sxu32)(zSrc - zExpStart) : 0;` |
|    8849 |  489 | `		char *zDup = zBuf;` |
|    8849 |  490 | `		sxu32 nDup = sizeof(zBuf);` |
|    8849 |  491 | `		if( nSpan + nExp >= sizeof(zBuf) ){` |
...
|       1 |  497 | `		}` |
|       - |  498 | `		{` |
|    8849 |  499 | `			sxu32 nMantMax = nDup - 1 - (nExp < nDup - 1 ? nExp : 0);` |
|   38709 |  500 | `			for( i = 0 ; i < nSpan && nCopy < nMantMax ; i++ ){` |
|   29865 |  501 | `				zDup[nCopy++] = (zNum[i] == ',') ? '.' : zNum[i];` |
|   14935 |  502 | `			}` |
|       - |  503 | `			/* The exponent rides behind even a truncated mantissa: dropping` |
|       - |  504 | `			 * it would collapse "0.<hundreds of zeros>1e300" to 0.0. */` |
|    9485 |  505 | `			for( i = 0 ; i < nExp && nCopy < nDup - 1 ; i++ ){` |
|     639 |  506 | `				zDup[nCopy++] = zExpStart[i];` |
|     321 |  507 | `			}` |
|       - |  508 | `		}` |
|    8849 |  509 | `		zDup[nCopy] = 0;` |
|    8849 |  510 | `		Val = (sxreal)strtod(zDup,0);` |
|    8849 |  511 | `		if( zDup != zBuf ){` |
|       3 |  512 | `			free(zDup);` |
|       1 |  513 | `		}` |
|    4422 |  514 | `	}` |
|       - |  515 | `	/* Jump trailing spaces */` |
|    8849 |  516 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|     ! 0 |  517 | `		zSrc++;` |
|     ! 0 |  518 | `	}` |
|    8849 |  519 | `	if( zRest ){` |
|     ! 0 |  520 | `		*zRest = zSrc;` |
|     ! 0 |  521 | `	}` |
|    8849 |  522 | `	if( pOutVal ){` |
|    8849 |  523 | `		*(sxreal *)pOutVal = Val;` |
|    4422 |  524 | `	}` |
|    8849 |  525 | `	return zSrc >= zEnd ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  526 | `}` |
|       - |  527 |  |
