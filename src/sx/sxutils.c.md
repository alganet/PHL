...
|       1 |  166 | `}` |
| 1741261 |  167 | `PH7_PRIVATE sxi32 SyStrToInt64(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  168 | `{` |
| 1741266 |  169 | `	int isNeg = FALSE;` |
|       - |  170 | `	const char *zEnd;` |
|       - |  171 | `	sxi64 nVal;` |
...
| 1741266 |  178 | `	int bOverflow = FALSE;` |
...
|       - |  185 | `	}` |
|       - |  186 | `#endif` |
| 1741266 |  187 | `	zEnd = &zSrc[nLen];` |
| 1741290 |  188 | `	while(zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|      26 |  189 | `		zSrc++;` |
|       2 |  190 | `	}` |
| 1741266 |  191 | `	if( zSrc < zEnd && ( zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
|      21 |  192 | `		isNeg = (zSrc[0] == '-') ? TRUE :FALSE;` |
|      21 |  193 | `		zSrc++;` |
|      10 |  194 | `	}` |
|       - |  195 | `	/* Skip leading zero */` |
| 1741268 |  196 | `	while(zSrc < zEnd && zSrc[0] == '0' ){` |
|       2 |  197 | `		zSrc++;` |
|     ! 0 |  198 | `	}` |
| 1741266 |  199 | `	cutoff = isNeg ? ((sxu64)SXI64_HIGH + 1) : (sxu64)SXI64_HIGH;` |
| 1741266 |  200 | `	uVal = 0;` |
| 4092708 |  201 | `	while( zSrc < zEnd && (unsigned char)zSrc[0] < 0xc0 && SyisDigit(zSrc[0]) ){` |
| 2351447 |  202 | `		int d = zSrc[0] - '0';` |
| 2351447 |  203 | `		if( uVal > cutoff / 10 \|\| (uVal == cutoff / 10 && (sxu64)d > cutoff % 10) ){` |
|      33 |  204 | `			bOverflow = TRUE;` |
|      17 |  205 | `		}else{` |
| 2351415 |  206 | `			uVal = uVal * 10 + (sxu64)d;` |
|       - |  207 | `		}` |
| 2351447 |  208 | `		zSrc++;` |
|       5 |  209 | `	}` |
| 1741266 |  210 | `	if( bOverflow ){` |
|      25 |  211 | `		uVal = cutoff;` |
|      12 |  212 | `	}` |
|       - |  213 | `	/* Skip trailing spaces */` |
| 1741290 |  214 | `	while(zSrc < zEnd && SyisSpace(zSrc[0])){` |
|      26 |  215 | `		zSrc++;` |
|       2 |  216 | `	}` |
| 1741266 |  217 | `	if( zRest ){` |
|     ! 0 |  218 | `		*zRest = (char *)zSrc;` |
|     ! 0 |  219 | `	}` |
| 1741266 |  220 | `	if( pOutVal ){` |
| 1741266 |  221 | `		if( isNeg ){` |
...
|      11 |  225 | `		}else{` |
| 1741246 |  226 | `			nVal = (sxi64)uVal;` |
|       - |  227 | `		}` |
| 1741266 |  228 | `		*(sxi64 *)pOutVal = nVal;` |
|  870631 |  229 | `	}` |
| 1741266 |  230 | `	return (zSrc >= zEnd) ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  231 | `}` |
