...
|     ! 0 |  166 | `}` |
| 2309363 |  167 | `PH7_PRIVATE sxi32 SyStrToInt64(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  168 | `{` |
| 2309368 |  169 | `	int isNeg = FALSE;` |
|       - |  170 | `	const char *zEnd;` |
|       - |  171 | `	sxi64 nVal;` |
...
| 2309368 |  178 | `	int bOverflow = FALSE;` |
...
|       - |  185 | `	}` |
|       - |  186 | `#endif` |
| 2309368 |  187 | `	zEnd = &zSrc[nLen];` |
| 2309390 |  188 | `	while(zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|      24 |  189 | `		zSrc++;` |
|       2 |  190 | `	}` |
| 2309368 |  191 | `	if( zSrc < zEnd && ( zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
|      33 |  192 | `		isNeg = (zSrc[0] == '-') ? TRUE :FALSE;` |
|      33 |  193 | `		zSrc++;` |
|      15 |  194 | `	}` |
|       - |  195 | `	/* Skip leading zero */` |
| 2310736 |  196 | `	while(zSrc < zEnd && zSrc[0] == '0' ){` |
|    1369 |  197 | `		zSrc++;` |
|       1 |  198 | `	}` |
| 2309368 |  199 | `	cutoff = isNeg ? ((sxu64)SXI64_HIGH + 1) : (sxu64)SXI64_HIGH;` |
| 2309368 |  200 | `	uVal = 0;` |
| 5581937 |  201 | `	while( zSrc < zEnd && (unsigned char)zSrc[0] < 0xc0 && SyisDigit(zSrc[0]) ){` |
| 3272574 |  202 | `		int d = zSrc[0] - '0';` |
| 3272574 |  203 | `		if( uVal > cutoff / 10 \|\| (uVal == cutoff / 10 && (sxu64)d > cutoff % 10) ){` |
|      33 |  204 | `			bOverflow = TRUE;` |
|      17 |  205 | `		}else{` |
| 3272542 |  206 | `			uVal = uVal * 10 + (sxu64)d;` |
|       - |  207 | `		}` |
| 3272574 |  208 | `		zSrc++;` |
|       5 |  209 | `	}` |
| 2309368 |  210 | `	if( bOverflow ){` |
|      25 |  211 | `		uVal = cutoff;` |
|      12 |  212 | `	}` |
|       - |  213 | `	/* Skip trailing spaces */` |
| 2309390 |  214 | `	while(zSrc < zEnd && SyisSpace(zSrc[0])){` |
|      24 |  215 | `		zSrc++;` |
|       2 |  216 | `	}` |
| 2309368 |  217 | `	if( zRest ){` |
|     ! 0 |  218 | `		*zRest = (char *)zSrc;` |
|     ! 0 |  219 | `	}` |
| 2309368 |  220 | `	if( pOutVal ){` |
| 2309368 |  221 | `		if( isNeg ){` |
...
|      18 |  225 | `		}else{` |
| 2309338 |  226 | `			nVal = (sxi64)uVal;` |
|       - |  227 | `		}` |
| 2309368 |  228 | `		*(sxi64 *)pOutVal = nVal;` |
| 1154681 |  229 | `	}` |
| 2309368 |  230 | `	return (zSrc >= zEnd) ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  231 | `}` |
|  322120 |  232 | `PH7_PRIVATE sxi32 SyHexToint(sxi32 c)` |
|       5 |  233 | `{` |
|  322125 |  234 | `	switch(c){` |
|  131631 |  235 | `	case '0': return 0;` |
|   11663 |  236 | `	case '1': return 1;` |
|   77301 |  237 | `	case '2': return 2;` |
|    7807 |  238 | `	case '3': return 3;` |
|    3911 |  239 | `	case '4': return 4;` |
|   11613 |  240 | `	case '5': return 5;` |
|    7761 |  241 | `	case '6': return 6;` |
|    3889 |  242 | `	case '7': return 7;` |
|   19387 |  243 | `	case '8': return 8;` |
|   11687 |  244 | `	case '9': return 9;` |
|   11689 |  245 | `	case 'A': case 'a': return 10;` |
|    3899 |  246 | `	case 'B': case 'b': return 11;` |
|    3987 |  247 | `	case 'C': case 'c': return 12;` |
|    3893 |  248 | `	case 'D': case 'd': return 13;` |
|    3963 |  249 | `	case 'E': case 'e': return 14;` |
|    8117 |  250 | `	case 'F': case 'f': return 15;` |
|       - |  251 | `	}` |
|       3 |  252 | `	return -1;` |
|  161065 |  253 | `}` |
|  104364 |  254 | `PH7_PRIVATE sxi32 SyHexStrToInt64(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  255 | `{` |
|       - |  256 | `	const char *zIn,*zEnd;` |
|  104369 |  257 | `	int isNeg = FALSE;` |
|  104369 |  258 | `	sxi64 nVal = 0;` |
...
|       - |  265 | `	}` |
|       - |  266 | `#endif` |
|  104369 |  267 | `	zEnd = &zSrc[nLen];` |
|  104369 |  268 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|     ! 0 |  269 | `		zSrc++;` |
|     ! 0 |  270 | `	}` |
|  104369 |  271 | `	if( zSrc < zEnd && ( *zSrc == '-' \|\| *zSrc == '+' ) ){` |
|     ! 0 |  272 | `		isNeg = (zSrc[0] == '-') ? TRUE :FALSE;` |
|     ! 0 |  273 | `		zSrc++;` |
|     ! 0 |  274 | `	}` |
|  104369 |  275 | `	if( zSrc < &zEnd[-2] && zSrc[0] == '0' && (zSrc[1] == 'x' \|\| zSrc[1] == 'X') ){` |
|       - |  276 | `		/* Bypass hex prefix */` |
|  104369 |  277 | `		zSrc += sizeof(char) * 2;` |
|   52182 |  278 | `	}` |
|       - |  279 | `	/* Skip leading zero */` |
|  131411 |  280 | `	while(zSrc < zEnd && zSrc[0] == '0' ){` |
|   27047 |  281 | `		zSrc++;` |
|       5 |  282 | `	}` |
|  104369 |  283 | `	zIn = zSrc;` |
|   86981 |  284 | `	for(;;){` |
|  173967 |  285 | `		if(zSrc >= zEnd \|\| !SyisHex(zSrc[0]) \|\| (int)(zSrc-zIn) > 15){` |
|   36721 |  286 | `			break;` |
|       - |  287 | `		}` |
|  100535 |  288 | `		nVal = nVal * 16 + SyHexToint(zSrc[0]);` |
|  100535 |  289 | `		zSrc++;` |
|  100535 |  290 | `		if(zSrc >= zEnd \|\| !SyisHex(zSrc[0]) \|\| (int)(zSrc-zIn) > 15){` |
|    9666 |  291 | `			break;` |
|       - |  292 | `		}` |
|   81213 |  293 | `		nVal = nVal * 16 + SyHexToint(zSrc[0]);` |
|   81213 |  294 | `		zSrc++;` |
|   81213 |  295 | `		if(zSrc >= zEnd \|\| !SyisHex(zSrc[0]) \|\| (int)(zSrc-zIn) > 15){` |
|    5810 |  296 | `			break;` |
|       - |  297 | `		}` |
|   69603 |  298 | `		nVal = nVal * 16 + SyHexToint(zSrc[0]);` |
|   69603 |  299 | `		zSrc++;` |
|   69603 |  300 | `		if(zSrc >= zEnd \|\| !SyisHex(zSrc[0]) \|\| (int)(zSrc-zIn) > 15){` |
|     ! 0 |  301 | `			break;` |
|       - |  302 | `		}` |
|   69603 |  303 | `		nVal = nVal * 16 + SyHexToint(zSrc[0]);` |
|   69603 |  304 | `		zSrc++;` |
|       5 |  305 | `	}` |
|  104369 |  306 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|     ! 0 |  307 | `		zSrc++;` |
|     ! 0 |  308 | `	}` |
|  104369 |  309 | `	if( zRest ){` |
|     ! 0 |  310 | `		*zRest = zSrc;` |
|     ! 0 |  311 | `	}` |
|  104369 |  312 | `	if( pOutVal ){` |
|  104369 |  313 | `		if( isNeg == TRUE && nVal != 0 ){` |
|     ! 0 |  314 | `			nVal = -nVal;` |
|     ! 0 |  315 | `		}` |
|  104369 |  316 | `		*(sxi64 *)pOutVal = nVal;` |
|   52182 |  317 | `	}` |
|  104369 |  318 | `	return zSrc >= zEnd ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  319 | `}` |
...
|    3965 |  350 | `		if(zSrc >= zEnd \|\| !SyisDigit(zSrc[0])){ break; } if( (c=zSrc[0]-'0') > 7 \|\| (int)(zSrc-zIn) > 20){ break;} nVal = nVal * 8 +  c; zSrc++;` |
|    3937 |  351 | `		if(zSrc >= zEnd \|\| !SyisDigit(zSrc[0])){ break; } if( (c=zSrc[0]-'0') > 7 \|\| (int)(zSrc-zIn) > 20){ break;} nVal = nVal * 8 +  c; zSrc++;` |
|       1 |  352 | `	}` |
...
|       1 |  419 | `}` |
|    8840 |  420 | `PH7_PRIVATE sxi32 SyStrToReal(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  421 | `{` |
...
|       - |  434 | `	char zBuf[512];` |
|    8845 |  435 | `	const char *zEnd = &zSrc[nLen];` |
|       - |  436 | `	const char *zNum;` |
|    8845 |  437 | `	const char *zExpStart = 0;` |
|    8845 |  438 | `	sxreal Val = 0.0;` |
|    8845 |  439 | `	sxu32 nCopy = 0;` |
|    8845 |  440 | `	int bDigit = 0;` |
|       - |  441 | `#ifdef UNTRUST` |
...
|    8849 |  450 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|       5 |  451 | `		zSrc++;` |
|       1 |  452 | `	}` |
|    8845 |  453 | `	zNum = zSrc;` |
|       - |  454 | `	/* Sign (if exists) */` |
|    8845 |  455 | `	if( zSrc < zEnd && (zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
|      14 |  456 | `		zSrc++;` |
|       6 |  457 | `	}` |
|       - |  458 | `	/* Integer part */` |
|   18785 |  459 | `	while( zSrc < zEnd && SyisDigit(zSrc[0]) ){` |
|    9945 |  460 | `		bDigit = 1;` |
|    9945 |  461 | `		zSrc++;` |
|       5 |  462 | `	}` |
|       - |  463 | `	/* Fractional part */` |
|    8845 |  464 | `	if( zSrc < zEnd && ( zSrc[0] == '.' \|\| zSrc[0] == ',' ) ){` |
|    8685 |  465 | `		zSrc++;` |
...
|    8845 |  473 | `	if( bDigit && zSrc < zEnd && ( zSrc[0] == 'e' \|\| zSrc[0] == 'E' ) ){` |
|     203 |  474 | `		const char *zExp = &zSrc[1];` |
|     203 |  475 | `		if( zExp < zEnd && (zExp[0] == '-' \|\| zExp[0] == '+') ){` |
|      76 |  476 | `			zExp++;` |
|      37 |  477 | `		}` |
|     203 |  478 | `		if( zExp < zEnd && SyisDigit(zExp[0]) ){` |
|     203 |  479 | `			zExpStart = zSrc;` |
|     203 |  480 | `			zSrc = zExp;` |
|     603 |  481 | `			while( zSrc < zEnd && SyisDigit(zSrc[0]) ){` |
|     403 |  482 | `				zSrc++;` |
|       3 |  483 | `			}` |
|     100 |  484 | `		}` |
|     100 |  485 | `	}` |
|    8845 |  486 | `	if( bDigit ){` |
|    8845 |  487 | `		sxu32 i, nSpan = (sxu32)((zExpStart ? zExpStart : zSrc) - zNum);` |
|    8845 |  488 | `		sxu32 nExp = zExpStart ? (sxu32)(zSrc - zExpStart) : 0;` |
|    8845 |  489 | `		char *zDup = zBuf;` |
|    8845 |  490 | `		sxu32 nDup = sizeof(zBuf);` |
|    8845 |  491 | `		if( nSpan + nExp >= sizeof(zBuf) ){` |
...
|       1 |  497 | `		}` |
|       - |  498 | `		{` |
|    8845 |  499 | `			sxu32 nMantMax = nDup - 1 - (nExp < nDup - 1 ? nExp : 0);` |
|   38751 |  500 | `			for( i = 0 ; i < nSpan && nCopy < nMantMax ; i++ ){` |
|   29911 |  501 | `				zDup[nCopy++] = (zNum[i] == ',') ? '.' : zNum[i];` |
|   14958 |  502 | `			}` |
|       - |  503 | `			/* The exponent rides behind even a truncated mantissa: dropping` |
|       - |  504 | `			 * it would collapse "0.<hundreds of zeros>1e300" to 0.0. */` |
|    9519 |  505 | `			for( i = 0 ; i < nExp && nCopy < nDup - 1 ; i++ ){` |
|     677 |  506 | `				zDup[nCopy++] = zExpStart[i];` |
|     340 |  507 | `			}` |
|       - |  508 | `		}` |
|    8845 |  509 | `		zDup[nCopy] = 0;` |
|    8845 |  510 | `		Val = (sxreal)strtod(zDup,0);` |
|    8845 |  511 | `		if( zDup != zBuf ){` |
|       3 |  512 | `			free(zDup);` |
|       1 |  513 | `		}` |
|    4420 |  514 | `	}` |
|       - |  515 | `	/* Jump trailing spaces */` |
|    8845 |  516 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|     ! 0 |  517 | `		zSrc++;` |
|     ! 0 |  518 | `	}` |
|    8845 |  519 | `	if( zRest ){` |
|     ! 0 |  520 | `		*zRest = zSrc;` |
|     ! 0 |  521 | `	}` |
|    8845 |  522 | `	if( pOutVal ){` |
|    8845 |  523 | `		*(sxreal *)pOutVal = Val;` |
|    4420 |  524 | `	}` |
|    8845 |  525 | `	return zSrc >= zEnd ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  526 | `}` |
|       - |  527 |  |
