...
|     ! 0 |  166 | `}` |
| 2321139 |  167 | `PH7_PRIVATE sxi32 SyStrToInt64(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  168 | `{` |
| 2321144 |  169 | `	int isNeg = FALSE;` |
|       - |  170 | `	const char *zEnd;` |
|       - |  171 | `	sxi64 nVal;` |
...
| 2321144 |  178 | `	int bOverflow = FALSE;` |
...
|       - |  185 | `	}` |
|       - |  186 | `#endif` |
| 2321144 |  187 | `	zEnd = &zSrc[nLen];` |
| 2321166 |  188 | `	while(zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|      24 |  189 | `		zSrc++;` |
|       2 |  190 | `	}` |
| 2321144 |  191 | `	if( zSrc < zEnd && ( zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
|      33 |  192 | `		isNeg = (zSrc[0] == '-') ? TRUE :FALSE;` |
|      33 |  193 | `		zSrc++;` |
|      15 |  194 | `	}` |
|       - |  195 | `	/* Skip leading zero */` |
| 2322512 |  196 | `	while(zSrc < zEnd && zSrc[0] == '0' ){` |
|    1369 |  197 | `		zSrc++;` |
|       1 |  198 | `	}` |
| 2321144 |  199 | `	cutoff = isNeg ? ((sxu64)SXI64_HIGH + 1) : (sxu64)SXI64_HIGH;` |
| 2321144 |  200 | `	uVal = 0;` |
| 5610315 |  201 | `	while( zSrc < zEnd && (unsigned char)zSrc[0] < 0xc0 && SyisDigit(zSrc[0]) ){` |
| 3289176 |  202 | `		int d = zSrc[0] - '0';` |
| 3289176 |  203 | `		if( uVal > cutoff / 10 \|\| (uVal == cutoff / 10 && (sxu64)d > cutoff % 10) ){` |
|      33 |  204 | `			bOverflow = TRUE;` |
|      17 |  205 | `		}else{` |
| 3289144 |  206 | `			uVal = uVal * 10 + (sxu64)d;` |
|       - |  207 | `		}` |
| 3289176 |  208 | `		zSrc++;` |
|       5 |  209 | `	}` |
| 2321144 |  210 | `	if( bOverflow ){` |
|      25 |  211 | `		uVal = cutoff;` |
|      12 |  212 | `	}` |
|       - |  213 | `	/* Skip trailing spaces */` |
| 2321166 |  214 | `	while(zSrc < zEnd && SyisSpace(zSrc[0])){` |
|      24 |  215 | `		zSrc++;` |
|       2 |  216 | `	}` |
| 2321144 |  217 | `	if( zRest ){` |
|     ! 0 |  218 | `		*zRest = (char *)zSrc;` |
|     ! 0 |  219 | `	}` |
| 2321144 |  220 | `	if( pOutVal ){` |
| 2321144 |  221 | `		if( isNeg ){` |
...
|      18 |  225 | `		}else{` |
| 2321114 |  226 | `			nVal = (sxi64)uVal;` |
|       - |  227 | `		}` |
| 2321144 |  228 | `		*(sxi64 *)pOutVal = nVal;` |
| 1160569 |  229 | `	}` |
| 2321144 |  230 | `	return (zSrc >= zEnd) ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  231 | `}` |
|  323780 |  232 | `PH7_PRIVATE sxi32 SyHexToint(sxi32 c)` |
|       5 |  233 | `{` |
|  323785 |  234 | `	switch(c){` |
|  132311 |  235 | `	case '0': return 0;` |
|   11723 |  236 | `	case '1': return 1;` |
...
|   11749 |  245 | `	case 'A': case 'a': return 10;` |
...
|    8157 |  250 | `	case 'F': case 'f': return 15;` |
|       - |  251 | `	}` |
|       3 |  252 | `	return -1;` |
|  161895 |  253 | `}` |
|  104904 |  254 | `PH7_PRIVATE sxi32 SyHexStrToInt64(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  255 | `{` |
|       - |  256 | `	const char *zIn,*zEnd;` |
|  104909 |  257 | `	int isNeg = FALSE;` |
|  104909 |  258 | `	sxi64 nVal = 0;` |
...
|       - |  265 | `	}` |
|       - |  266 | `#endif` |
|  104909 |  267 | `	zEnd = &zSrc[nLen];` |
|  104909 |  268 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|     ! 0 |  269 | `		zSrc++;` |
|     ! 0 |  270 | `	}` |
|  104909 |  271 | `	if( zSrc < zEnd && ( *zSrc == '-' \|\| *zSrc == '+' ) ){` |
|     ! 0 |  272 | `		isNeg = (zSrc[0] == '-') ? TRUE :FALSE;` |
|     ! 0 |  273 | `		zSrc++;` |
|     ! 0 |  274 | `	}` |
|  104909 |  275 | `	if( zSrc < &zEnd[-2] && zSrc[0] == '0' && (zSrc[1] == 'x' \|\| zSrc[1] == 'X') ){` |
|       - |  276 | `		/* Bypass hex prefix */` |
|  104909 |  277 | `		zSrc += sizeof(char) * 2;` |
|   52452 |  278 | `	}` |
|       - |  279 | `	/* Skip leading zero */` |
|  132091 |  280 | `	while(zSrc < zEnd && zSrc[0] == '0' ){` |
|   27187 |  281 | `		zSrc++;` |
|       5 |  282 | `	}` |
|  104909 |  283 | `	zIn = zSrc;` |
|   87431 |  284 | `	for(;;){` |
|  174867 |  285 | `		if(zSrc >= zEnd \|\| !SyisHex(zSrc[0]) \|\| (int)(zSrc-zIn) > 15){` |
|   36911 |  286 | `			break;` |
|       - |  287 | `		}` |
|  101055 |  288 | `		nVal = nVal * 16 + SyHexToint(zSrc[0]);` |
|  101055 |  289 | `		zSrc++;` |
|  101055 |  290 | `		if(zSrc >= zEnd \|\| !SyisHex(zSrc[0]) \|\| (int)(zSrc-zIn) > 15){` |
|    9716 |  291 | `			break;` |
|       - |  292 | `		}` |
|   81633 |  293 | `		nVal = nVal * 16 + SyHexToint(zSrc[0]);` |
|   81633 |  294 | `		zSrc++;` |
|   81633 |  295 | `		if(zSrc >= zEnd \|\| !SyisHex(zSrc[0]) \|\| (int)(zSrc-zIn) > 15){` |
|    5840 |  296 | `			break;` |
|       - |  297 | `		}` |
...
|   69963 |  304 | `		zSrc++;` |
|       5 |  305 | `	}` |
|  104909 |  306 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|     ! 0 |  307 | `		zSrc++;` |
|     ! 0 |  308 | `	}` |
|  104909 |  309 | `	if( zRest ){` |
|     ! 0 |  310 | `		*zRest = zSrc;` |
|     ! 0 |  311 | `	}` |
|  104909 |  312 | `	if( pOutVal ){` |
|  104909 |  313 | `		if( isNeg == TRUE && nVal != 0 ){` |
|     ! 0 |  314 | `			nVal = -nVal;` |
|     ! 0 |  315 | `		}` |
|  104909 |  316 | `		*(sxi64 *)pOutVal = nVal;` |
|   52452 |  317 | `	}` |
|  104909 |  318 | `	return zSrc >= zEnd ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  319 | `}` |
...
|    8697 |  465 | `		zSrc++;` |
|   19971 |  466 | `		while( zSrc < zEnd && SyisDigit(zSrc[0]) ){` |
|   11279 |  467 | `			bDigit = 1;` |
|   11279 |  468 | `			zSrc++;` |
|       5 |  469 | `		}` |
|    4346 |  470 | `	}` |
