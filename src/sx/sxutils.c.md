...
|     ! 0 |  166 | `}` |
| 2316033 |  167 | `PH7_PRIVATE sxi32 SyStrToInt64(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  168 | `{` |
| 2316038 |  169 | `	int isNeg = FALSE;` |
|       - |  170 | `	const char *zEnd;` |
|       - |  171 | `	sxi64 nVal;` |
...
| 2316038 |  178 | `	int bOverflow = FALSE;` |
...
|       - |  185 | `	}` |
|       - |  186 | `#endif` |
| 2316038 |  187 | `	zEnd = &zSrc[nLen];` |
| 2316060 |  188 | `	while(zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|      24 |  189 | `		zSrc++;` |
|       2 |  190 | `	}` |
| 2316038 |  191 | `	if( zSrc < zEnd && ( zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
|      33 |  192 | `		isNeg = (zSrc[0] == '-') ? TRUE :FALSE;` |
|      33 |  193 | `		zSrc++;` |
|      15 |  194 | `	}` |
|       - |  195 | `	/* Skip leading zero */` |
| 2317403 |  196 | `	while(zSrc < zEnd && zSrc[0] == '0' ){` |
|    1366 |  197 | `		zSrc++;` |
|       1 |  198 | `	}` |
| 2316038 |  199 | `	cutoff = isNeg ? ((sxu64)SXI64_HIGH + 1) : (sxu64)SXI64_HIGH;` |
| 2316038 |  200 | `	uVal = 0;` |
| 5597940 |  201 | `	while( zSrc < zEnd && (unsigned char)zSrc[0] < 0xc0 && SyisDigit(zSrc[0]) ){` |
| 3281907 |  202 | `		int d = zSrc[0] - '0';` |
| 3281907 |  203 | `		if( uVal > cutoff / 10 \|\| (uVal == cutoff / 10 && (sxu64)d > cutoff % 10) ){` |
|      33 |  204 | `			bOverflow = TRUE;` |
|      17 |  205 | `		}else{` |
| 3281875 |  206 | `			uVal = uVal * 10 + (sxu64)d;` |
|       - |  207 | `		}` |
| 3281907 |  208 | `		zSrc++;` |
|       5 |  209 | `	}` |
| 2316038 |  210 | `	if( bOverflow ){` |
|      25 |  211 | `		uVal = cutoff;` |
|      12 |  212 | `	}` |
|       - |  213 | `	/* Skip trailing spaces */` |
| 2316060 |  214 | `	while(zSrc < zEnd && SyisSpace(zSrc[0])){` |
|      24 |  215 | `		zSrc++;` |
|       2 |  216 | `	}` |
| 2316038 |  217 | `	if( zRest ){` |
|     ! 0 |  218 | `		*zRest = (char *)zSrc;` |
|     ! 0 |  219 | `	}` |
| 2316038 |  220 | `	if( pOutVal ){` |
| 2316038 |  221 | `		if( isNeg ){` |
...
|      18 |  225 | `		}else{` |
| 2316008 |  226 | `			nVal = (sxi64)uVal;` |
|       - |  227 | `		}` |
| 2316038 |  228 | `		*(sxi64 *)pOutVal = nVal;` |
| 1158016 |  229 | `	}` |
| 2316038 |  230 | `	return (zSrc >= zEnd) ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  231 | `}` |
|  323082 |  232 | `PH7_PRIVATE sxi32 SyHexToint(sxi32 c)` |
|       5 |  233 | `{` |
|  323087 |  234 | `	switch(c){` |
|  132039 |  235 | `	case '0': return 0;` |
|   11697 |  236 | `	case '1': return 1;` |
|   77541 |  237 | `	case '2': return 2;` |
|    7827 |  238 | `	case '3': return 3;` |
|    3923 |  239 | `	case '4': return 4;` |
|   11649 |  240 | `	case '5': return 5;` |
|    7785 |  241 | `	case '6': return 6;` |
|    3901 |  242 | `	case '7': return 7;` |
|   19447 |  243 | `	case '8': return 8;` |
|   11715 |  244 | `	case '9': return 9;` |
|   11719 |  245 | `	case 'A': case 'a': return 10;` |
|    3911 |  246 | `	case 'B': case 'b': return 11;` |
|    3995 |  247 | `	case 'C': case 'c': return 12;` |
|    3905 |  248 | `	case 'D': case 'd': return 13;` |
|    3971 |  249 | `	case 'E': case 'e': return 14;` |
...
|       1 |  419 | `}` |
|    8822 |  420 | `PH7_PRIVATE sxi32 SyStrToReal(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  421 | `{` |
...
|       - |  434 | `	char zBuf[512];` |
|    8827 |  435 | `	const char *zEnd = &zSrc[nLen];` |
|       - |  436 | `	const char *zNum;` |
|    8827 |  437 | `	const char *zExpStart = 0;` |
|    8827 |  438 | `	sxreal Val = 0.0;` |
|    8827 |  439 | `	sxu32 nCopy = 0;` |
|    8827 |  440 | `	int bDigit = 0;` |
|       - |  441 | `#ifdef UNTRUST` |
...
|    8831 |  450 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|       5 |  451 | `		zSrc++;` |
|       1 |  452 | `	}` |
|    8827 |  453 | `	zNum = zSrc;` |
|       - |  454 | `	/* Sign (if exists) */` |
|    8827 |  455 | `	if( zSrc < zEnd && (zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
|      14 |  456 | `		zSrc++;` |
|       6 |  457 | `	}` |
|       - |  458 | `	/* Integer part */` |
|   18687 |  459 | `	while( zSrc < zEnd && SyisDigit(zSrc[0]) ){` |
|    9865 |  460 | `		bDigit = 1;` |
|    9865 |  461 | `		zSrc++;` |
|       5 |  462 | `	}` |
|       - |  463 | `	/* Fractional part */` |
|    8827 |  464 | `	if( zSrc < zEnd && ( zSrc[0] == '.' \|\| zSrc[0] == ',' ) ){` |
|    8675 |  465 | `		zSrc++;` |
|   19927 |  466 | `		while( zSrc < zEnd && SyisDigit(zSrc[0]) ){` |
|   11257 |  467 | `			bDigit = 1;` |
|   11257 |  468 | `			zSrc++;` |
|       5 |  469 | `		}` |
|    4335 |  470 | `	}` |
...
|    8827 |  473 | `	if( bDigit && zSrc < zEnd && ( zSrc[0] == 'e' \|\| zSrc[0] == 'E' ) ){` |
...
|      93 |  485 | `	}` |
|    8827 |  486 | `	if( bDigit ){` |
|    8827 |  487 | `		sxu32 i, nSpan = (sxu32)((zExpStart ? zExpStart : zSrc) - zNum);` |
|    8827 |  488 | `		sxu32 nExp = zExpStart ? (sxu32)(zSrc - zExpStart) : 0;` |
|    8827 |  489 | `		char *zDup = zBuf;` |
|    8827 |  490 | `		sxu32 nDup = sizeof(zBuf);` |
|    8827 |  491 | `		if( nSpan + nExp >= sizeof(zBuf) ){` |
...
|       1 |  497 | `		}` |
|       - |  498 | `		{` |
|    8827 |  499 | `			sxu32 nMantMax = nDup - 1 - (nExp < nDup - 1 ? nExp : 0);` |
|   38621 |  500 | `			for( i = 0 ; i < nSpan && nCopy < nMantMax ; i++ ){` |
|   29799 |  501 | `				zDup[nCopy++] = (zNum[i] == ',') ? '.' : zNum[i];` |
|   14902 |  502 | `			}` |
|       - |  503 | `			/* The exponent rides behind even a truncated mantissa: dropping` |
|       - |  504 | `			 * it would collapse "0.<hundreds of zeros>1e300" to 0.0. */` |
|    9463 |  505 | `			for( i = 0 ; i < nExp && nCopy < nDup - 1 ; i++ ){` |
|     639 |  506 | `				zDup[nCopy++] = zExpStart[i];` |
|     321 |  507 | `			}` |
|       - |  508 | `		}` |
|    8827 |  509 | `		zDup[nCopy] = 0;` |
|    8827 |  510 | `		Val = (sxreal)strtod(zDup,0);` |
|    8827 |  511 | `		if( zDup != zBuf ){` |
|       3 |  512 | `			free(zDup);` |
|       1 |  513 | `		}` |
|    4411 |  514 | `	}` |
|       - |  515 | `	/* Jump trailing spaces */` |
|    8827 |  516 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|     ! 0 |  517 | `		zSrc++;` |
|     ! 0 |  518 | `	}` |
|    8827 |  519 | `	if( zRest ){` |
|     ! 0 |  520 | `		*zRest = zSrc;` |
|     ! 0 |  521 | `	}` |
|    8827 |  522 | `	if( pOutVal ){` |
|    8827 |  523 | `		*(sxreal *)pOutVal = Val;` |
|    4411 |  524 | `	}` |
|    8827 |  525 | `	return zSrc >= zEnd ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  526 | `}` |
|       - |  527 |  |
