...
|       1 |  166 | `}` |
| 2302541 |  167 | `PH7_PRIVATE sxi32 SyStrToInt64(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  168 | `{` |
| 2302546 |  169 | `	int isNeg = FALSE;` |
|       - |  170 | `	const char *zEnd;` |
|       - |  171 | `	sxi64 nVal;` |
...
| 2302546 |  178 | `	int bOverflow = FALSE;` |
...
|       - |  185 | `	}` |
|       - |  186 | `#endif` |
| 2302546 |  187 | `	zEnd = &zSrc[nLen];` |
| 2302572 |  188 | `	while(zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|      28 |  189 | `		zSrc++;` |
|       2 |  190 | `	}` |
| 2302546 |  191 | `	if( zSrc < zEnd && ( zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
|      33 |  192 | `		isNeg = (zSrc[0] == '-') ? TRUE :FALSE;` |
|      33 |  193 | `		zSrc++;` |
|      15 |  194 | `	}` |
|       - |  195 | `	/* Skip leading zero */` |
| 2303916 |  196 | `	while(zSrc < zEnd && zSrc[0] == '0' ){` |
|    1371 |  197 | `		zSrc++;` |
|       1 |  198 | `	}` |
| 2302546 |  199 | `	cutoff = isNeg ? ((sxu64)SXI64_HIGH + 1) : (sxu64)SXI64_HIGH;` |
| 2302546 |  200 | `	uVal = 0;` |
| 5573433 |  201 | `	while( zSrc < zEnd && (unsigned char)zSrc[0] < 0xc0 && SyisDigit(zSrc[0]) ){` |
...
| 3270892 |  208 | `		zSrc++;` |
|       5 |  209 | `	}` |
| 2302546 |  210 | `	if( bOverflow ){` |
|      25 |  211 | `		uVal = cutoff;` |
|      12 |  212 | `	}` |
|       - |  213 | `	/* Skip trailing spaces */` |
| 2302572 |  214 | `	while(zSrc < zEnd && SyisSpace(zSrc[0])){` |
|      28 |  215 | `		zSrc++;` |
|       2 |  216 | `	}` |
| 2302546 |  217 | `	if( zRest ){` |
|     ! 0 |  218 | `		*zRest = (char *)zSrc;` |
|     ! 0 |  219 | `	}` |
| 2302546 |  220 | `	if( pOutVal ){` |
| 2302546 |  221 | `		if( isNeg ){` |
...
|      18 |  225 | `		}else{` |
| 2302516 |  226 | `			nVal = (sxi64)uVal;` |
|       - |  227 | `		}` |
| 2302546 |  228 | `		*(sxi64 *)pOutVal = nVal;` |
| 1151270 |  229 | `	}` |
| 2302546 |  230 | `	return (zSrc >= zEnd) ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  231 | `}` |
