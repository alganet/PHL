...
|       1 |  166 | `}` |
| 2289948 |  167 | `PH7_PRIVATE sxi32 SyStrToInt64(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  168 | `{` |
| 2289953 |  169 | `	int isNeg = FALSE;` |
|       - |  170 | `	const char *zEnd;` |
|       - |  171 | `	sxi64 nVal;` |
...
| 2289953 |  178 | `	int bOverflow = FALSE;` |
...
|       - |  185 | `	}` |
|       - |  186 | `#endif` |
| 2289953 |  187 | `	zEnd = &zSrc[nLen];` |
| 2289979 |  188 | `	while(zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|      28 |  189 | `		zSrc++;` |
|       2 |  190 | `	}` |
| 2289953 |  191 | `	if( zSrc < zEnd && ( zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
|      21 |  192 | `		isNeg = (zSrc[0] == '-') ? TRUE :FALSE;` |
|      21 |  193 | `		zSrc++;` |
|      10 |  194 | `	}` |
|       - |  195 | `	/* Skip leading zero */` |
| 2291323 |  196 | `	while(zSrc < zEnd && zSrc[0] == '0' ){` |
|    1371 |  197 | `		zSrc++;` |
|       1 |  198 | `	}` |
| 2289953 |  199 | `	cutoff = isNeg ? ((sxu64)SXI64_HIGH + 1) : (sxu64)SXI64_HIGH;` |
| 2289953 |  200 | `	uVal = 0;` |
| 5546275 |  201 | `	while( zSrc < zEnd && (unsigned char)zSrc[0] < 0xc0 && SyisDigit(zSrc[0]) ){` |
| 3256327 |  202 | `		int d = zSrc[0] - '0';` |
| 3256327 |  203 | `		if( uVal > cutoff / 10 \|\| (uVal == cutoff / 10 && (sxu64)d > cutoff % 10) ){` |
|      33 |  204 | `			bOverflow = TRUE;` |
|      17 |  205 | `		}else{` |
| 3256295 |  206 | `			uVal = uVal * 10 + (sxu64)d;` |
|       - |  207 | `		}` |
| 3256327 |  208 | `		zSrc++;` |
|       5 |  209 | `	}` |
| 2289953 |  210 | `	if( bOverflow ){` |
|      25 |  211 | `		uVal = cutoff;` |
|      12 |  212 | `	}` |
|       - |  213 | `	/* Skip trailing spaces */` |
| 2289979 |  214 | `	while(zSrc < zEnd && SyisSpace(zSrc[0])){` |
|      28 |  215 | `		zSrc++;` |
|       2 |  216 | `	}` |
| 2289953 |  217 | `	if( zRest ){` |
|     ! 0 |  218 | `		*zRest = (char *)zSrc;` |
|     ! 0 |  219 | `	}` |
| 2289953 |  220 | `	if( pOutVal ){` |
| 2289953 |  221 | `		if( isNeg ){` |
...
|      11 |  225 | `		}else{` |
| 2289933 |  226 | `			nVal = (sxi64)uVal;` |
|       - |  227 | `		}` |
| 2289953 |  228 | `		*(sxi64 *)pOutVal = nVal;` |
| 1144974 |  229 | `	}` |
| 2289953 |  230 | `	return (zSrc >= zEnd) ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  231 | `}` |
|  323756 |  232 | `PH7_PRIVATE sxi32 SyHexToint(sxi32 c)` |
|       5 |  233 | `{` |
|  323761 |  234 | `	switch(c){` |
|  132421 |  235 | `	case '0': return 0;` |
|   11733 |  236 | `	case '1': return 1;` |
|   77589 |  237 | `	case '2': return 2;` |
|    7851 |  238 | `	case '3': return 3;` |
|    3943 |  239 | `	case '4': return 4;` |
|   11671 |  240 | `	case '5': return 5;` |
|    7795 |  241 | `	case '6': return 6;` |
|    3903 |  242 | `	case '7': return 7;` |
|   19457 |  243 | `	case '8': return 8;` |
|   11723 |  244 | `	case '9': return 9;` |
|   11739 |  245 | `	case 'A': case 'a': return 10;` |
|    3923 |  246 | `	case 'B': case 'b': return 11;` |
|    4015 |  247 | `	case 'C': case 'c': return 12;` |
|    3907 |  248 | `	case 'D': case 'd': return 13;` |
|    3977 |  249 | `	case 'E': case 'e': return 14;` |
|    8187 |  250 | `	case 'F': case 'f': return 15;` |
|       - |  251 | `	}` |
|       3 |  252 | `	return -1;` |
|  161883 |  253 | `}` |
...
|    8689 |  465 | `		zSrc++;` |
|   19957 |  466 | `		while( zSrc < zEnd && SyisDigit(zSrc[0]) ){` |
|   11273 |  467 | `			bDigit = 1;` |
|   11273 |  468 | `			zSrc++;` |
|       5 |  469 | `		}` |
|    4342 |  470 | `	}` |
