...
|       - |   11 |  |
|     248 |   12 | `PH7_PRIVATE sxi32 SyStrIsNumeric(const char *zSrc,sxu32 nLen,sxu8 *pReal,const char  **pzTail)` |
|       4 |   13 | `{` |
...
|       - |   18 | `	}` |
|       - |   19 | `#endif` |
|     252 |   20 | `	zEnd = &zSrc[nLen];` |
|       - |   21 | `	/* Jump leading white spaces */` |
|     268 |   22 | `	while( zSrc < zEnd && (unsigned char)zSrc[0] < 0xc0  && SyisSpace(zSrc[0]) ){` |
|      17 |   23 | `		zSrc++;` |
|       1 |   24 | `	}` |
|     252 |   25 | `	if( zSrc < zEnd && (zSrc[0] == '+' \|\| zSrc[0] == '-') ){` |
|      11 |   26 | `		zSrc++;` |
|       5 |   27 | `	}` |
|     252 |   28 | `	zCur = zSrc;` |
|     252 |   29 | `	if( pReal ){` |
...
|     120 |   31 | `	}` |
|     124 |   32 | `	for(;;){` |
|     252 |   33 | `		if( zSrc >= zEnd \|\| (unsigned char)zSrc[0] >= 0xc0 \|\| !SyisDigit(zSrc[0]) ){` |
|      41 |   34 | `			break;` |
|       - |   35 | `		}` |
|     175 |   36 | `		zSrc++;` |
|     175 |   37 | `		if( zSrc >= zEnd \|\| (unsigned char)zSrc[0] >= 0xc0 \|\| !SyisDigit(zSrc[0]) ){` |
|      68 |   38 | `			break;` |
|       - |   39 | `		}` |
|      41 |   40 | `		zSrc++;` |
...
|      84 |   88 | `		*pzTail = zSrc;` |
|      41 |   89 | `	}` |
|     252 |   90 | `	return zSrc > zCur ? SXRET_OK /* String prefix is numeric */ : SXERR_INVALID /* Not a digit stream */;` |
|       4 |   91 | `}` |
...
|       1 |  166 | `}` |
|  922468 |  167 | `PH7_PRIVATE sxi32 SyStrToInt64(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  168 | `{` |
|  922473 |  169 | `	int isNeg = FALSE;` |
|       - |  170 | `	const char *zEnd;` |
|       - |  171 | `	sxi64 nVal;` |
...
|  922473 |  178 | `	int bOverflow = FALSE;` |
...
|       - |  185 | `	}` |
|       - |  186 | `#endif` |
|  922473 |  187 | `	zEnd = &zSrc[nLen];` |
|  922493 |  188 | `	while(zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|      22 |  189 | `		zSrc++;` |
|       2 |  190 | `	}` |
|  922473 |  191 | `	if( zSrc < zEnd && ( zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
|      21 |  192 | `		isNeg = (zSrc[0] == '-') ? TRUE :FALSE;` |
|      21 |  193 | `		zSrc++;` |
|      10 |  194 | `	}` |
|       - |  195 | `	/* Skip leading zero */` |
|  922473 |  196 | `	while(zSrc < zEnd && zSrc[0] == '0' ){` |
|     ! 0 |  197 | `		zSrc++;` |
|     ! 0 |  198 | `	}` |
|  922473 |  199 | `	cutoff = isNeg ? ((sxu64)SXI64_HIGH + 1) : (sxu64)SXI64_HIGH;` |
|  922473 |  200 | `	uVal = 0;` |
| 2327541 |  201 | `	while( zSrc < zEnd && (unsigned char)zSrc[0] < 0xc0 && SyisDigit(zSrc[0]) ){` |
| 1405073 |  202 | `		int d = zSrc[0] - '0';` |
| 1405073 |  203 | `		if( uVal > cutoff / 10 \|\| (uVal == cutoff / 10 && (sxu64)d > cutoff % 10) ){` |
|      33 |  204 | `			bOverflow = TRUE;` |
|      17 |  205 | `		}else{` |
| 1405041 |  206 | `			uVal = uVal * 10 + (sxu64)d;` |
|       - |  207 | `		}` |
| 1405073 |  208 | `		zSrc++;` |
|       5 |  209 | `	}` |
|  922473 |  210 | `	if( bOverflow ){` |
|      25 |  211 | `		uVal = cutoff;` |
|      12 |  212 | `	}` |
|       - |  213 | `	/* Skip trailing spaces */` |
|  922493 |  214 | `	while(zSrc < zEnd && SyisSpace(zSrc[0])){` |
|      22 |  215 | `		zSrc++;` |
|       2 |  216 | `	}` |
|  922473 |  217 | `	if( zRest ){` |
|     ! 0 |  218 | `		*zRest = (char *)zSrc;` |
|     ! 0 |  219 | `	}` |
|  922473 |  220 | `	if( pOutVal ){` |
|  922473 |  221 | `		if( isNeg ){` |
...
|      11 |  225 | `		}else{` |
|  922453 |  226 | `			nVal = (sxi64)uVal;` |
|       - |  227 | `		}` |
|  922473 |  228 | `		*(sxi64 *)pOutVal = nVal;` |
|  461234 |  229 | `	}` |
|  922473 |  230 | `	return (zSrc >= zEnd) ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  231 | `}` |
|    1646 |  232 | `PH7_PRIVATE sxi32 SyHexToint(sxi32 c)` |
|       2 |  233 | `{` |
|    1648 |  234 | `	switch(c){` |
|     582 |  235 | `	case '0': return 0;` |
|      80 |  236 | `	case '1': return 1;` |
...
|       1 |  319 | `}` |
|      64 |  320 | `PH7_PRIVATE sxi32 SyOctalStrToInt64(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       1 |  321 | `{` |
|       - |  322 | `	const char *zIn,*zEnd;` |
|      65 |  323 | `	int isNeg = FALSE;` |
|      65 |  324 | `	sxi64 nVal = 0;` |
|       - |  325 | `	int c;` |
...
|       - |  332 | `	}` |
|       - |  333 | `#endif` |
|      65 |  334 | `	zEnd = &zSrc[nLen];` |
|      65 |  335 | `	while(zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|     ! 0 |  336 | `		zSrc++;` |
|     ! 0 |  337 | `	}` |
|      65 |  338 | `	if( zSrc < zEnd && ( zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
|     ! 0 |  339 | `		isNeg = (zSrc[0] == '-') ? TRUE :FALSE;` |
|     ! 0 |  340 | `		zSrc++;` |
|     ! 0 |  341 | `	}` |
|       - |  342 | `	/* Skip leading zero */` |
|     135 |  343 | `	while(zSrc < zEnd && zSrc[0] == '0' ){` |
|      71 |  344 | `		zSrc++;` |
|       1 |  345 | `	}` |
|      65 |  346 | `	zIn = zSrc;` |
|      37 |  347 | `	for(;;){` |
|      75 |  348 | `		if(zSrc >= zEnd \|\| !SyisDigit(zSrc[0])){ break; } if( (c=zSrc[0]-'0') > 7 \|\| (int)(zSrc-zIn) > 20){ break;} nVal = nVal * 8 +  c; zSrc++;` |
|      75 |  349 | `		if(zSrc >= zEnd \|\| !SyisDigit(zSrc[0])){ break; } if( (c=zSrc[0]-'0') > 7 \|\| (int)(zSrc-zIn) > 20){ break;} nVal = nVal * 8 +  c; zSrc++;` |
...
|      65 |  354 | `	while(zSrc < zEnd && SyisSpace(zSrc[0])){` |
|     ! 0 |  355 | `		zSrc++;` |
|     ! 0 |  356 | `	}` |
|      65 |  357 | `	if( zRest ){` |
|     ! 0 |  358 | `		*zRest = zSrc;` |
|     ! 0 |  359 | `	}` |
|      65 |  360 | `	if( pOutVal ){` |
|      65 |  361 | `		if( isNeg == TRUE && nVal != 0 ){` |
|     ! 0 |  362 | `			nVal = -nVal;` |
|     ! 0 |  363 | `		}` |
|      65 |  364 | `		*(sxi64 *)pOutVal = nVal;` |
|      32 |  365 | `	}` |
|      65 |  366 | `	return (zSrc >= zEnd) ? SXRET_OK : SXERR_SYNTAX;` |
|       1 |  367 | `}` |
...
|       1 |  419 | `}` |
|    1002 |  420 | `PH7_PRIVATE sxi32 SyStrToReal(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       4 |  421 | `{` |
...
|       - |  434 | `	char zBuf[512];` |
|    1006 |  435 | `	const char *zEnd = &zSrc[nLen];` |
|       - |  436 | `	const char *zNum;` |
|    1006 |  437 | `	const char *zExpStart = 0;` |
|    1006 |  438 | `	sxreal Val = 0.0;` |
|    1006 |  439 | `	sxu32 nCopy = 0;` |
|    1006 |  440 | `	int bDigit = 0;` |
|       - |  441 | `#ifdef UNTRUST` |
...
|    1010 |  450 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|       5 |  451 | `		zSrc++;` |
|       1 |  452 | `	}` |
|    1006 |  453 | `	zNum = zSrc;` |
|       - |  454 | `	/* Sign (if exists) */` |
|    1006 |  455 | `	if( zSrc < zEnd && (zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
|      12 |  456 | `		zSrc++;` |
|       5 |  457 | `	}` |
|       - |  458 | `	/* Integer part */` |
|    2794 |  459 | `	while( zSrc < zEnd && SyisDigit(zSrc[0]) ){` |
|    1792 |  460 | `		bDigit = 1;` |
|    1792 |  461 | `		zSrc++;` |
|       4 |  462 | `	}` |
|       - |  463 | `	/* Fractional part */` |
|    1006 |  464 | `	if( zSrc < zEnd && ( zSrc[0] == '.' \|\| zSrc[0] == ',' ) ){` |
|     876 |  465 | `		zSrc++;` |
|    4316 |  466 | `		while( zSrc < zEnd && SyisDigit(zSrc[0]) ){` |
|    3444 |  467 | `			bDigit = 1;` |
|    3444 |  468 | `			zSrc++;` |
|       4 |  469 | `		}` |
|     436 |  470 | `	}` |
...
|    1006 |  473 | `	if( bDigit && zSrc < zEnd && ( zSrc[0] == 'e' \|\| zSrc[0] == 'E' ) ){` |
|     180 |  474 | `		const char *zExp = &zSrc[1];` |
|     180 |  475 | `		if( zExp < zEnd && (zExp[0] == '-' \|\| zExp[0] == '+') ){` |
|      65 |  476 | `			zExp++;` |
|      32 |  477 | `		}` |
|     180 |  478 | `		if( zExp < zEnd && SyisDigit(zExp[0]) ){` |
|     180 |  479 | `			zExpStart = zSrc;` |
|     180 |  480 | `			zSrc = zExp;` |
|     548 |  481 | `			while( zSrc < zEnd && SyisDigit(zSrc[0]) ){` |
|     370 |  482 | `				zSrc++;` |
|       2 |  483 | `			}` |
|      89 |  484 | `		}` |
|      89 |  485 | `	}` |
|    1006 |  486 | `	if( bDigit ){` |
|    1006 |  487 | `		sxu32 i, nSpan = (sxu32)((zExpStart ? zExpStart : zSrc) - zNum);` |
|    1006 |  488 | `		sxu32 nExp = zExpStart ? (sxu32)(zSrc - zExpStart) : 0;` |
|    1006 |  489 | `		char *zDup = zBuf;` |
|    1006 |  490 | `		sxu32 nDup = sizeof(zBuf);` |
|    1006 |  491 | `		if( nSpan + nExp >= sizeof(zBuf) ){` |
...
|       1 |  497 | `		}` |
|       - |  498 | `		{` |
|    1006 |  499 | `			sxu32 nMantMax = nDup - 1 - (nExp < nDup - 1 ? nExp : 0);` |
|    7116 |  500 | `			for( i = 0 ; i < nSpan && nCopy < nMantMax ; i++ ){` |
|    6114 |  501 | `				zDup[nCopy++] = (zNum[i] == ',') ? '.' : zNum[i];` |
|    3059 |  502 | `			}` |
|       - |  503 | `			/* The exponent rides behind even a truncated mantissa: dropping` |
|       - |  504 | `			 * it would collapse "0.<hundreds of zeros>1e300" to 0.0. */` |
|    1616 |  505 | `			for( i = 0 ; i < nExp && nCopy < nDup - 1 ; i++ ){` |
|     612 |  506 | `				zDup[nCopy++] = zExpStart[i];` |
|     307 |  507 | `			}` |
|       - |  508 | `		}` |
|    1006 |  509 | `		zDup[nCopy] = 0;` |
|    1006 |  510 | `		Val = (sxreal)strtod(zDup,0);` |
|    1006 |  511 | `		if( zDup != zBuf ){` |
|       3 |  512 | `			free(zDup);` |
|       1 |  513 | `		}` |
|     501 |  514 | `	}` |
|       - |  515 | `	/* Jump trailing spaces */` |
|    1006 |  516 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|     ! 0 |  517 | `		zSrc++;` |
|     ! 0 |  518 | `	}` |
|    1006 |  519 | `	if( zRest ){` |
|     ! 0 |  520 | `		*zRest = zSrc;` |
|     ! 0 |  521 | `	}` |
|    1006 |  522 | `	if( pOutVal ){` |
|    1006 |  523 | `		*(sxreal *)pOutVal = Val;` |
|     501 |  524 | `	}` |
|    1006 |  525 | `	return zSrc >= zEnd ? SXRET_OK : SXERR_SYNTAX;` |
|       4 |  526 | `}` |
|       - |  527 |  |
