...
|       1 |  166 | `}` |
| 2257420 |  167 | `PH7_PRIVATE sxi32 SyStrToInt64(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  168 | `{` |
| 2257425 |  169 | `	int isNeg = FALSE;` |
|       - |  170 | `	const char *zEnd;` |
|       - |  171 | `	sxi64 nVal;` |
...
| 2257425 |  178 | `	int bOverflow = FALSE;` |
...
|       - |  185 | `	}` |
|       - |  186 | `#endif` |
| 2257425 |  187 | `	zEnd = &zSrc[nLen];` |
| 2257451 |  188 | `	while(zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|      28 |  189 | `		zSrc++;` |
|       2 |  190 | `	}` |
| 2257425 |  191 | `	if( zSrc < zEnd && ( zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
|      21 |  192 | `		isNeg = (zSrc[0] == '-') ? TRUE :FALSE;` |
|      21 |  193 | `		zSrc++;` |
|      10 |  194 | `	}` |
|       - |  195 | `	/* Skip leading zero */` |
| 2258793 |  196 | `	while(zSrc < zEnd && zSrc[0] == '0' ){` |
|    1369 |  197 | `		zSrc++;` |
|       1 |  198 | `	}` |
| 2257425 |  199 | `	cutoff = isNeg ? ((sxu64)SXI64_HIGH + 1) : (sxu64)SXI64_HIGH;` |
| 2257425 |  200 | `	uVal = 0;` |
| 5469579 |  201 | `	while( zSrc < zEnd && (unsigned char)zSrc[0] < 0xc0 && SyisDigit(zSrc[0]) ){` |
| 3212159 |  202 | `		int d = zSrc[0] - '0';` |
| 3212159 |  203 | `		if( uVal > cutoff / 10 \|\| (uVal == cutoff / 10 && (sxu64)d > cutoff % 10) ){` |
|      33 |  204 | `			bOverflow = TRUE;` |
|      17 |  205 | `		}else{` |
| 3212127 |  206 | `			uVal = uVal * 10 + (sxu64)d;` |
|       - |  207 | `		}` |
| 3212159 |  208 | `		zSrc++;` |
|       5 |  209 | `	}` |
| 2257425 |  210 | `	if( bOverflow ){` |
|      25 |  211 | `		uVal = cutoff;` |
|      12 |  212 | `	}` |
|       - |  213 | `	/* Skip trailing spaces */` |
| 2257451 |  214 | `	while(zSrc < zEnd && SyisSpace(zSrc[0])){` |
|      28 |  215 | `		zSrc++;` |
|       2 |  216 | `	}` |
| 2257425 |  217 | `	if( zRest ){` |
|     ! 0 |  218 | `		*zRest = (char *)zSrc;` |
|     ! 0 |  219 | `	}` |
| 2257425 |  220 | `	if( pOutVal ){` |
| 2257425 |  221 | `		if( isNeg ){` |
...
|      11 |  225 | `		}else{` |
| 2257405 |  226 | `			nVal = (sxi64)uVal;` |
|       - |  227 | `		}` |
| 2257425 |  228 | `		*(sxi64 *)pOutVal = nVal;` |
| 1128710 |  229 | `	}` |
| 2257425 |  230 | `	return (zSrc >= zEnd) ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  231 | `}` |
|  322428 |  232 | `PH7_PRIVATE sxi32 SyHexToint(sxi32 c)` |
|       5 |  233 | `{` |
|  322433 |  234 | `	switch(c){` |
|  131877 |  235 | `	case '0': return 0;` |
|   11685 |  236 | `	case '1': return 1;` |
|   77269 |  237 | `	case '2': return 2;` |
|    7819 |  238 | `	case '3': return 3;` |
|    3927 |  239 | `	case '4': return 4;` |
|   11623 |  240 | `	case '5': return 5;` |
|    7763 |  241 | `	case '6': return 6;` |
|    3887 |  242 | `	case '7': return 7;` |
|   19377 |  243 | `	case '8': return 8;` |
|   11675 |  244 | `	case '9': return 9;` |
|   11691 |  245 | `	case 'A': case 'a': return 10;` |
|    3907 |  246 | `	case 'B': case 'b': return 11;` |
|    3999 |  247 | `	case 'C': case 'c': return 12;` |
|    3891 |  248 | `	case 'D': case 'd': return 13;` |
|    3961 |  249 | `	case 'E': case 'e': return 14;` |
|    8155 |  250 | `	case 'F': case 'f': return 15;` |
|       - |  251 | `	}` |
|       3 |  252 | `	return -1;` |
|  161219 |  253 | `}` |
|  104304 |  254 | `PH7_PRIVATE sxi32 SyHexStrToInt64(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  255 | `{` |
|       - |  256 | `	const char *zIn,*zEnd;` |
|  104309 |  257 | `	int isNeg = FALSE;` |
|  104309 |  258 | `	sxi64 nVal = 0;` |
...
|       - |  265 | `	}` |
|       - |  266 | `#endif` |
|  104309 |  267 | `	zEnd = &zSrc[nLen];` |
|  104309 |  268 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|     ! 0 |  269 | `		zSrc++;` |
|     ! 0 |  270 | `	}` |
|  104309 |  271 | `	if( zSrc < zEnd && ( *zSrc == '-' \|\| *zSrc == '+' ) ){` |
|     ! 0 |  272 | `		isNeg = (zSrc[0] == '-') ? TRUE :FALSE;` |
|     ! 0 |  273 | `		zSrc++;` |
|     ! 0 |  274 | `	}` |
|  104309 |  275 | `	if( zSrc < &zEnd[-2] && zSrc[0] == '0' && (zSrc[1] == 'x' \|\| zSrc[1] == 'X') ){` |
|       - |  276 | `		/* Bypass hex prefix */` |
|  104309 |  277 | `		zSrc += sizeof(char) * 2;` |
|   52152 |  278 | `	}` |
|       - |  279 | `	/* Skip leading zero */` |
|  131337 |  280 | `	while(zSrc < zEnd && zSrc[0] == '0' ){` |
|   27033 |  281 | `		zSrc++;` |
|       5 |  282 | `	}` |
|  104309 |  283 | `	zIn = zSrc;` |
|   86933 |  284 | `	for(;;){` |
|  173871 |  285 | `		if(zSrc >= zEnd \|\| !SyisHex(zSrc[0]) \|\| (int)(zSrc-zIn) > 15){` |
|   36702 |  286 | `			break;` |
|       - |  287 | `		}` |
|  100477 |  288 | `		nVal = nVal * 16 + SyHexToint(zSrc[0]);` |
|  100477 |  289 | `		zSrc++;` |
|  100477 |  290 | `		if(zSrc >= zEnd \|\| !SyisHex(zSrc[0]) \|\| (int)(zSrc-zIn) > 15){` |
|    9660 |  291 | `			break;` |
|       - |  292 | `		}` |
|   81167 |  293 | `		nVal = nVal * 16 + SyHexToint(zSrc[0]);` |
|   81167 |  294 | `		zSrc++;` |
|   81167 |  295 | `		if(zSrc >= zEnd \|\| !SyisHex(zSrc[0]) \|\| (int)(zSrc-zIn) > 15){` |
|    5805 |  296 | `			break;` |
|       - |  297 | `		}` |
|   69567 |  298 | `		nVal = nVal * 16 + SyHexToint(zSrc[0]);` |
|   69567 |  299 | `		zSrc++;` |
|   69567 |  300 | `		if(zSrc >= zEnd \|\| !SyisHex(zSrc[0]) \|\| (int)(zSrc-zIn) > 15){` |
|     ! 0 |  301 | `			break;` |
|       - |  302 | `		}` |
|   69567 |  303 | `		nVal = nVal * 16 + SyHexToint(zSrc[0]);` |
|   69567 |  304 | `		zSrc++;` |
|       5 |  305 | `	}` |
|  104309 |  306 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|     ! 0 |  307 | `		zSrc++;` |
|     ! 0 |  308 | `	}` |
|  104309 |  309 | `	if( zRest ){` |
|     ! 0 |  310 | `		*zRest = zSrc;` |
|     ! 0 |  311 | `	}` |
|  104309 |  312 | `	if( pOutVal ){` |
|  104309 |  313 | `		if( isNeg == TRUE && nVal != 0 ){` |
|     ! 0 |  314 | `			nVal = -nVal;` |
|     ! 0 |  315 | `		}` |
|  104309 |  316 | `		*(sxi64 *)pOutVal = nVal;` |
|   52152 |  317 | `	}` |
|  104309 |  318 | `	return zSrc >= zEnd ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  319 | `}` |
|    3944 |  320 | `PH7_PRIVATE sxi32 SyOctalStrToInt64(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  321 | `{` |
|       - |  322 | `	const char *zIn,*zEnd;` |
|    3949 |  323 | `	int isNeg = FALSE;` |
|    3949 |  324 | `	sxi64 nVal = 0;` |
|       - |  325 | `	int c;` |
...
|       - |  332 | `	}` |
|       - |  333 | `#endif` |
|    3949 |  334 | `	zEnd = &zSrc[nLen];` |
|    3949 |  335 | `	while(zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|     ! 0 |  336 | `		zSrc++;` |
|     ! 0 |  337 | `	}` |
|    3949 |  338 | `	if( zSrc < zEnd && ( zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
|     ! 0 |  339 | `		isNeg = (zSrc[0] == '-') ? TRUE :FALSE;` |
|     ! 0 |  340 | `		zSrc++;` |
|     ! 0 |  341 | `	}` |
|       - |  342 | `	/* Skip leading zero */` |
|    7883 |  343 | `	while(zSrc < zEnd && zSrc[0] == '0' ){` |
|    3939 |  344 | `		zSrc++;` |
|       5 |  345 | `	}` |
|    3949 |  346 | `	zIn = zSrc;` |
|    1982 |  347 | `	for(;;){` |
|    3969 |  348 | `		if(zSrc >= zEnd \|\| !SyisDigit(zSrc[0])){ break; } if( (c=zSrc[0]-'0') > 7 \|\| (int)(zSrc-zIn) > 20){ break;} nVal = nVal * 8 +  c; zSrc++;` |
|    3967 |  349 | `		if(zSrc >= zEnd \|\| !SyisDigit(zSrc[0])){ break; } if( (c=zSrc[0]-'0') > 7 \|\| (int)(zSrc-zIn) > 20){ break;} nVal = nVal * 8 +  c; zSrc++;` |
|    3957 |  350 | `		if(zSrc >= zEnd \|\| !SyisDigit(zSrc[0])){ break; } if( (c=zSrc[0]-'0') > 7 \|\| (int)(zSrc-zIn) > 20){ break;} nVal = nVal * 8 +  c; zSrc++;` |
|    3935 |  351 | `		if(zSrc >= zEnd \|\| !SyisDigit(zSrc[0])){ break; } if( (c=zSrc[0]-'0') > 7 \|\| (int)(zSrc-zIn) > 20){ break;} nVal = nVal * 8 +  c; zSrc++;` |
|       1 |  352 | `	}` |
|       - |  353 | `	/* Skip trailing spaces */` |
|    3949 |  354 | `	while(zSrc < zEnd && SyisSpace(zSrc[0])){` |
|     ! 0 |  355 | `		zSrc++;` |
|     ! 0 |  356 | `	}` |
|    3949 |  357 | `	if( zRest ){` |
|     ! 0 |  358 | `		*zRest = zSrc;` |
|     ! 0 |  359 | `	}` |
|    3949 |  360 | `	if( pOutVal ){` |
|    3949 |  361 | `		if( isNeg == TRUE && nVal != 0 ){` |
|     ! 0 |  362 | `			nVal = -nVal;` |
|     ! 0 |  363 | `		}` |
|    3949 |  364 | `		*(sxi64 *)pOutVal = nVal;` |
|    1972 |  365 | `	}` |
|    3949 |  366 | `	return (zSrc >= zEnd) ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  367 | `}` |
...
|       1 |  419 | `}` |
|    8804 |  420 | `PH7_PRIVATE sxi32 SyStrToReal(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  421 | `{` |
...
|       - |  434 | `	char zBuf[512];` |
|    8809 |  435 | `	const char *zEnd = &zSrc[nLen];` |
|       - |  436 | `	const char *zNum;` |
|    8809 |  437 | `	const char *zExpStart = 0;` |
|    8809 |  438 | `	sxreal Val = 0.0;` |
|    8809 |  439 | `	sxu32 nCopy = 0;` |
|    8809 |  440 | `	int bDigit = 0;` |
|       - |  441 | `#ifdef UNTRUST` |
...
|    8813 |  450 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|       5 |  451 | `		zSrc++;` |
|       1 |  452 | `	}` |
|    8809 |  453 | `	zNum = zSrc;` |
|       - |  454 | `	/* Sign (if exists) */` |
|    8809 |  455 | `	if( zSrc < zEnd && (zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
|      12 |  456 | `		zSrc++;` |
|       5 |  457 | `	}` |
|       - |  458 | `	/* Integer part */` |
|   18651 |  459 | `	while( zSrc < zEnd && SyisDigit(zSrc[0]) ){` |
|    9847 |  460 | `		bDigit = 1;` |
|    9847 |  461 | `		zSrc++;` |
|       5 |  462 | `	}` |
|       - |  463 | `	/* Fractional part */` |
|    8809 |  464 | `	if( zSrc < zEnd && ( zSrc[0] == '.' \|\| zSrc[0] == ',' ) ){` |
|    8657 |  465 | `		zSrc++;` |
|   19893 |  466 | `		while( zSrc < zEnd && SyisDigit(zSrc[0]) ){` |
|   11241 |  467 | `			bDigit = 1;` |
|   11241 |  468 | `			zSrc++;` |
|       5 |  469 | `		}` |
|    4326 |  470 | `	}` |
...
|    8809 |  473 | `	if( bDigit && zSrc < zEnd && ( zSrc[0] == 'e' \|\| zSrc[0] == 'E' ) ){` |
...
|      93 |  485 | `	}` |
|    8809 |  486 | `	if( bDigit ){` |
|    8809 |  487 | `		sxu32 i, nSpan = (sxu32)((zExpStart ? zExpStart : zSrc) - zNum);` |
|    8809 |  488 | `		sxu32 nExp = zExpStart ? (sxu32)(zSrc - zExpStart) : 0;` |
|    8809 |  489 | `		char *zDup = zBuf;` |
|    8809 |  490 | `		sxu32 nDup = sizeof(zBuf);` |
|    8809 |  491 | `		if( nSpan + nExp >= sizeof(zBuf) ){` |
...
|       1 |  497 | `		}` |
|       - |  498 | `		{` |
|    8809 |  499 | `			sxu32 nMantMax = nDup - 1 - (nExp < nDup - 1 ? nExp : 0);` |
|   38549 |  500 | `			for( i = 0 ; i < nSpan && nCopy < nMantMax ; i++ ){` |
|   29745 |  501 | `				zDup[nCopy++] = (zNum[i] == ',') ? '.' : zNum[i];` |
|   14875 |  502 | `			}` |
|       - |  503 | `			/* The exponent rides behind even a truncated mantissa: dropping` |
|       - |  504 | `			 * it would collapse "0.<hundreds of zeros>1e300" to 0.0. */` |
|    9445 |  505 | `			for( i = 0 ; i < nExp && nCopy < nDup - 1 ; i++ ){` |
|     639 |  506 | `				zDup[nCopy++] = zExpStart[i];` |
|     321 |  507 | `			}` |
|       - |  508 | `		}` |
|    8809 |  509 | `		zDup[nCopy] = 0;` |
|    8809 |  510 | `		Val = (sxreal)strtod(zDup,0);` |
|    8809 |  511 | `		if( zDup != zBuf ){` |
|       3 |  512 | `			free(zDup);` |
|       1 |  513 | `		}` |
|    4402 |  514 | `	}` |
|       - |  515 | `	/* Jump trailing spaces */` |
|    8809 |  516 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|     ! 0 |  517 | `		zSrc++;` |
|     ! 0 |  518 | `	}` |
|    8809 |  519 | `	if( zRest ){` |
|     ! 0 |  520 | `		*zRest = zSrc;` |
|     ! 0 |  521 | `	}` |
|    8809 |  522 | `	if( pOutVal ){` |
|    8809 |  523 | `		*(sxreal *)pOutVal = Val;` |
|    4402 |  524 | `	}` |
|    8809 |  525 | `	return zSrc >= zEnd ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  526 | `}` |
|       - |  527 |  |
