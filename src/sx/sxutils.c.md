...
|       - |   18 | `	}` |
|       - |   19 | `#endif` |
|     304 |   20 | `	zEnd = &zSrc[nLen];` |
|       - |   21 | `	/* Jump leading white spaces */` |
|     324 |   22 | `	while( zSrc < zEnd && (unsigned char)zSrc[0] < 0xc0  && SyisSpace(zSrc[0]) ){` |
|      22 |   23 | `		zSrc++;` |
|       2 |   24 | `	}` |
|     304 |   25 | `	if( zSrc < zEnd && (zSrc[0] == '+' \|\| zSrc[0] == '-') ){` |
|      11 |   26 | `		zSrc++;` |
|       5 |   27 | `	}` |
|     304 |   28 | `	zCur = zSrc;` |
|     304 |   29 | `	if( pReal ){` |
...
|     138 |   31 | `	}` |
|     150 |   32 | `	for(;;){` |
|     304 |   33 | `		if( zSrc >= zEnd \|\| (unsigned char)zSrc[0] >= 0xc0 \|\| !SyisDigit(zSrc[0]) ){` |
|      51 |   34 | `			break;` |
|       - |   35 | `		}` |
|     209 |   36 | `		zSrc++;` |
|     209 |   37 | `		if( zSrc >= zEnd \|\| (unsigned char)zSrc[0] >= 0xc0 \|\| !SyisDigit(zSrc[0]) ){` |
|      78 |   38 | `			break;` |
|       - |   39 | `		}` |
|      56 |   40 | `		zSrc++;` |
...
|      91 |   88 | `		*pzTail = zSrc;` |
|      44 |   89 | `	}` |
|     304 |   90 | `	return zSrc > zCur ? SXRET_OK /* String prefix is numeric */ : SXERR_INVALID /* Not a digit stream */;` |
|       4 |   91 | `}` |
...
|       1 |  166 | `}` |
| 1675582 |  167 | `PH7_PRIVATE sxi32 SyStrToInt64(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  168 | `{` |
| 1675587 |  169 | `	int isNeg = FALSE;` |
|       - |  170 | `	const char *zEnd;` |
|       - |  171 | `	sxi64 nVal;` |
...
| 1675587 |  178 | `	int bOverflow = FALSE;` |
...
|       - |  185 | `	}` |
|       - |  186 | `#endif` |
| 1675587 |  187 | `	zEnd = &zSrc[nLen];` |
| 1675611 |  188 | `	while(zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|      26 |  189 | `		zSrc++;` |
|       2 |  190 | `	}` |
| 1675587 |  191 | `	if( zSrc < zEnd && ( zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
|      21 |  192 | `		isNeg = (zSrc[0] == '-') ? TRUE :FALSE;` |
|      21 |  193 | `		zSrc++;` |
|      10 |  194 | `	}` |
|       - |  195 | `	/* Skip leading zero */` |
| 1675589 |  196 | `	while(zSrc < zEnd && zSrc[0] == '0' ){` |
|       2 |  197 | `		zSrc++;` |
|     ! 0 |  198 | `	}` |
| 1675587 |  199 | `	cutoff = isNeg ? ((sxu64)SXI64_HIGH + 1) : (sxu64)SXI64_HIGH;` |
| 1675587 |  200 | `	uVal = 0;` |
| 3938395 |  201 | `	while( zSrc < zEnd && (unsigned char)zSrc[0] < 0xc0 && SyisDigit(zSrc[0]) ){` |
| 2262813 |  202 | `		int d = zSrc[0] - '0';` |
| 2262813 |  203 | `		if( uVal > cutoff / 10 \|\| (uVal == cutoff / 10 && (sxu64)d > cutoff % 10) ){` |
|      33 |  204 | `			bOverflow = TRUE;` |
|      17 |  205 | `		}else{` |
| 2262781 |  206 | `			uVal = uVal * 10 + (sxu64)d;` |
|       - |  207 | `		}` |
| 2262813 |  208 | `		zSrc++;` |
|       5 |  209 | `	}` |
| 1675587 |  210 | `	if( bOverflow ){` |
|      25 |  211 | `		uVal = cutoff;` |
|      12 |  212 | `	}` |
|       - |  213 | `	/* Skip trailing spaces */` |
| 1675611 |  214 | `	while(zSrc < zEnd && SyisSpace(zSrc[0])){` |
|      26 |  215 | `		zSrc++;` |
|       2 |  216 | `	}` |
| 1675587 |  217 | `	if( zRest ){` |
|     ! 0 |  218 | `		*zRest = (char *)zSrc;` |
|     ! 0 |  219 | `	}` |
| 1675587 |  220 | `	if( pOutVal ){` |
| 1675587 |  221 | `		if( isNeg ){` |
...
|      11 |  225 | `		}else{` |
| 1675567 |  226 | `			nVal = (sxi64)uVal;` |
|       - |  227 | `		}` |
| 1675587 |  228 | `		*(sxi64 *)pOutVal = nVal;` |
|  837791 |  229 | `	}` |
| 1675587 |  230 | `	return (zSrc >= zEnd) ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  231 | `}` |
...
|       1 |  319 | `}` |
|     112 |  320 | `PH7_PRIVATE sxi32 SyOctalStrToInt64(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       1 |  321 | `{` |
|       - |  322 | `	const char *zIn,*zEnd;` |
|     113 |  323 | `	int isNeg = FALSE;` |
|     113 |  324 | `	sxi64 nVal = 0;` |
|       - |  325 | `	int c;` |
...
|       - |  332 | `	}` |
|       - |  333 | `#endif` |
|     113 |  334 | `	zEnd = &zSrc[nLen];` |
|     113 |  335 | `	while(zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|     ! 0 |  336 | `		zSrc++;` |
|     ! 0 |  337 | `	}` |
|     113 |  338 | `	if( zSrc < zEnd && ( zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
|     ! 0 |  339 | `		isNeg = (zSrc[0] == '-') ? TRUE :FALSE;` |
|     ! 0 |  340 | `		zSrc++;` |
|     ! 0 |  341 | `	}` |
|       - |  342 | `	/* Skip leading zero */` |
|     255 |  343 | `	while(zSrc < zEnd && zSrc[0] == '0' ){` |
|     143 |  344 | `		zSrc++;` |
|       1 |  345 | `	}` |
|     113 |  346 | `	zIn = zSrc;` |
|      61 |  347 | `	for(;;){` |
|     123 |  348 | `		if(zSrc >= zEnd \|\| !SyisDigit(zSrc[0])){ break; } if( (c=zSrc[0]-'0') > 7 \|\| (int)(zSrc-zIn) > 20){ break;} nVal = nVal * 8 +  c; zSrc++;` |
|      97 |  349 | `		if(zSrc >= zEnd \|\| !SyisDigit(zSrc[0])){ break; } if( (c=zSrc[0]-'0') > 7 \|\| (int)(zSrc-zIn) > 20){ break;} nVal = nVal * 8 +  c; zSrc++;` |
...
|     113 |  354 | `	while(zSrc < zEnd && SyisSpace(zSrc[0])){` |
|     ! 0 |  355 | `		zSrc++;` |
|     ! 0 |  356 | `	}` |
|     113 |  357 | `	if( zRest ){` |
|     ! 0 |  358 | `		*zRest = zSrc;` |
|     ! 0 |  359 | `	}` |
|     113 |  360 | `	if( pOutVal ){` |
|     113 |  361 | `		if( isNeg == TRUE && nVal != 0 ){` |
|     ! 0 |  362 | `			nVal = -nVal;` |
|     ! 0 |  363 | `		}` |
|     113 |  364 | `		*(sxi64 *)pOutVal = nVal;` |
|      56 |  365 | `	}` |
|     113 |  366 | `	return (zSrc >= zEnd) ? SXRET_OK : SXERR_SYNTAX;` |
|       1 |  367 | `}` |
...
|       5 |  457 | `	}` |
|       - |  458 | `	/* Integer part */` |
|    3057 |  459 | `	while( zSrc < zEnd && SyisDigit(zSrc[0]) ){` |
|    2033 |  460 | `		bDigit = 1;` |
|    2033 |  461 | `		zSrc++;` |
|       5 |  462 | `	}` |
|       - |  463 | `	/* Fractional part */` |
...
|     885 |  465 | `		zSrc++;` |
|    4329 |  466 | `		while( zSrc < zEnd && SyisDigit(zSrc[0]) ){` |
|    3449 |  467 | `			bDigit = 1;` |
|    3449 |  468 | `			zSrc++;` |
|       5 |  469 | `		}` |
|     440 |  470 | `	}` |
...
|    7391 |  500 | `			for( i = 0 ; i < nSpan && nCopy < nMantMax ; i++ ){` |
|    6367 |  501 | `				zDup[nCopy++] = (zNum[i] == ',') ? '.' : zNum[i];` |
|    3186 |  502 | `			}` |
