...
|       1 |  166 | `}` |
| 2263216 |  167 | `PH7_PRIVATE sxi32 SyStrToInt64(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  168 | `{` |
| 2263221 |  169 | `	int isNeg = FALSE;` |
|       - |  170 | `	const char *zEnd;` |
|       - |  171 | `	sxi64 nVal;` |
...
| 2263221 |  178 | `	int bOverflow = FALSE;` |
...
|       - |  185 | `	}` |
|       - |  186 | `#endif` |
| 2263221 |  187 | `	zEnd = &zSrc[nLen];` |
| 2263247 |  188 | `	while(zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|      28 |  189 | `		zSrc++;` |
|       2 |  190 | `	}` |
| 2263221 |  191 | `	if( zSrc < zEnd && ( zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
|      21 |  192 | `		isNeg = (zSrc[0] == '-') ? TRUE :FALSE;` |
|      21 |  193 | `		zSrc++;` |
|      10 |  194 | `	}` |
|       - |  195 | `	/* Skip leading zero */` |
| 2264589 |  196 | `	while(zSrc < zEnd && zSrc[0] == '0' ){` |
|    1369 |  197 | `		zSrc++;` |
|       1 |  198 | `	}` |
| 2263221 |  199 | `	cutoff = isNeg ? ((sxu64)SXI64_HIGH + 1) : (sxu64)SXI64_HIGH;` |
| 2263221 |  200 | `	uVal = 0;` |
| 5483603 |  201 | `	while( zSrc < zEnd && (unsigned char)zSrc[0] < 0xc0 && SyisDigit(zSrc[0]) ){` |
| 3220387 |  202 | `		int d = zSrc[0] - '0';` |
| 3220387 |  203 | `		if( uVal > cutoff / 10 \|\| (uVal == cutoff / 10 && (sxu64)d > cutoff % 10) ){` |
|      33 |  204 | `			bOverflow = TRUE;` |
|      17 |  205 | `		}else{` |
| 3220355 |  206 | `			uVal = uVal * 10 + (sxu64)d;` |
|       - |  207 | `		}` |
| 3220387 |  208 | `		zSrc++;` |
|       5 |  209 | `	}` |
| 2263221 |  210 | `	if( bOverflow ){` |
|      25 |  211 | `		uVal = cutoff;` |
|      12 |  212 | `	}` |
|       - |  213 | `	/* Skip trailing spaces */` |
| 2263247 |  214 | `	while(zSrc < zEnd && SyisSpace(zSrc[0])){` |
|      28 |  215 | `		zSrc++;` |
|       2 |  216 | `	}` |
| 2263221 |  217 | `	if( zRest ){` |
|     ! 0 |  218 | `		*zRest = (char *)zSrc;` |
|     ! 0 |  219 | `	}` |
| 2263221 |  220 | `	if( pOutVal ){` |
| 2263221 |  221 | `		if( isNeg ){` |
...
|      11 |  225 | `		}else{` |
| 2263201 |  226 | `			nVal = (sxi64)uVal;` |
|       - |  227 | `		}` |
| 2263221 |  228 | `		*(sxi64 *)pOutVal = nVal;` |
| 1131608 |  229 | `	}` |
| 2263221 |  230 | `	return (zSrc >= zEnd) ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  231 | `}` |
|  323258 |  232 | `PH7_PRIVATE sxi32 SyHexToint(sxi32 c)` |
|       5 |  233 | `{` |
|  323263 |  234 | `	switch(c){` |
|  132217 |  235 | `	case '0': return 0;` |
|   11715 |  236 | `	case '1': return 1;` |
|   77469 |  237 | `	case '2': return 2;` |
|    7839 |  238 | `	case '3': return 3;` |
|    3937 |  239 | `	case '4': return 4;` |
|   11653 |  240 | `	case '5': return 5;` |
|    7783 |  241 | `	case '6': return 6;` |
|    3897 |  242 | `	case '7': return 7;` |
|   19427 |  243 | `	case '8': return 8;` |
|   11705 |  244 | `	case '9': return 9;` |
|   11721 |  245 | `	case 'A': case 'a': return 10;` |
|    3917 |  246 | `	case 'B': case 'b': return 11;` |
|    4009 |  247 | `	case 'C': case 'c': return 12;` |
|    3901 |  248 | `	case 'D': case 'd': return 13;` |
|    3971 |  249 | `	case 'E': case 'e': return 14;` |
|    8175 |  250 | `	case 'F': case 'f': return 15;` |
|       - |  251 | `	}` |
|       3 |  252 | `	return -1;` |
|  161634 |  253 | `}` |
|  104574 |  254 | `PH7_PRIVATE sxi32 SyHexStrToInt64(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  255 | `{` |
|       - |  256 | `	const char *zIn,*zEnd;` |
|  104579 |  257 | `	int isNeg = FALSE;` |
|  104579 |  258 | `	sxi64 nVal = 0;` |
...
|       - |  265 | `	}` |
|       - |  266 | `#endif` |
|  104579 |  267 | `	zEnd = &zSrc[nLen];` |
|  104579 |  268 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|     ! 0 |  269 | `		zSrc++;` |
|     ! 0 |  270 | `	}` |
|  104579 |  271 | `	if( zSrc < zEnd && ( *zSrc == '-' \|\| *zSrc == '+' ) ){` |
|     ! 0 |  272 | `		isNeg = (zSrc[0] == '-') ? TRUE :FALSE;` |
|     ! 0 |  273 | `		zSrc++;` |
|     ! 0 |  274 | `	}` |
|  104579 |  275 | `	if( zSrc < &zEnd[-2] && zSrc[0] == '0' && (zSrc[1] == 'x' \|\| zSrc[1] == 'X') ){` |
|       - |  276 | `		/* Bypass hex prefix */` |
|  104579 |  277 | `		zSrc += sizeof(char) * 2;` |
|   52287 |  278 | `	}` |
|       - |  279 | `	/* Skip leading zero */` |
|  131677 |  280 | `	while(zSrc < zEnd && zSrc[0] == '0' ){` |
|   27103 |  281 | `		zSrc++;` |
|       5 |  282 | `	}` |
|  104579 |  283 | `	zIn = zSrc;` |
|   87158 |  284 | `	for(;;){` |
|  174321 |  285 | `		if(zSrc >= zEnd \|\| !SyisHex(zSrc[0]) \|\| (int)(zSrc-zIn) > 15){` |
|   36797 |  286 | `			break;` |
|       - |  287 | `		}` |
|  100737 |  288 | `		nVal = nVal * 16 + SyHexToint(zSrc[0]);` |
|  100737 |  289 | `		zSrc++;` |
|  100737 |  290 | `		if(zSrc >= zEnd \|\| !SyisHex(zSrc[0]) \|\| (int)(zSrc-zIn) > 15){` |
|    9685 |  291 | `			break;` |
|       - |  292 | `		}` |
|   81377 |  293 | `		nVal = nVal * 16 + SyHexToint(zSrc[0]);` |
|   81377 |  294 | `		zSrc++;` |
|   81377 |  295 | `		if(zSrc >= zEnd \|\| !SyisHex(zSrc[0]) \|\| (int)(zSrc-zIn) > 15){` |
|    5820 |  296 | `			break;` |
|       - |  297 | `		}` |
|   69747 |  298 | `		nVal = nVal * 16 + SyHexToint(zSrc[0]);` |
|   69747 |  299 | `		zSrc++;` |
|   69747 |  300 | `		if(zSrc >= zEnd \|\| !SyisHex(zSrc[0]) \|\| (int)(zSrc-zIn) > 15){` |
|     ! 0 |  301 | `			break;` |
|       - |  302 | `		}` |
|   69747 |  303 | `		nVal = nVal * 16 + SyHexToint(zSrc[0]);` |
|   69747 |  304 | `		zSrc++;` |
|       5 |  305 | `	}` |
|  104579 |  306 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|     ! 0 |  307 | `		zSrc++;` |
|     ! 0 |  308 | `	}` |
|  104579 |  309 | `	if( zRest ){` |
|     ! 0 |  310 | `		*zRest = zSrc;` |
|     ! 0 |  311 | `	}` |
|  104579 |  312 | `	if( pOutVal ){` |
|  104579 |  313 | `		if( isNeg == TRUE && nVal != 0 ){` |
|     ! 0 |  314 | `			nVal = -nVal;` |
|     ! 0 |  315 | `		}` |
|  104579 |  316 | `		*(sxi64 *)pOutVal = nVal;` |
|   52287 |  317 | `	}` |
|  104579 |  318 | `	return zSrc >= zEnd ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  319 | `}` |
|    3954 |  320 | `PH7_PRIVATE sxi32 SyOctalStrToInt64(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  321 | `{` |
|       - |  322 | `	const char *zIn,*zEnd;` |
|    3959 |  323 | `	int isNeg = FALSE;` |
|    3959 |  324 | `	sxi64 nVal = 0;` |
|       - |  325 | `	int c;` |
...
|       - |  332 | `	}` |
|       - |  333 | `#endif` |
|    3959 |  334 | `	zEnd = &zSrc[nLen];` |
|    3959 |  335 | `	while(zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|     ! 0 |  336 | `		zSrc++;` |
|     ! 0 |  337 | `	}` |
|    3959 |  338 | `	if( zSrc < zEnd && ( zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
|     ! 0 |  339 | `		isNeg = (zSrc[0] == '-') ? TRUE :FALSE;` |
|     ! 0 |  340 | `		zSrc++;` |
|     ! 0 |  341 | `	}` |
|       - |  342 | `	/* Skip leading zero */` |
|    7903 |  343 | `	while(zSrc < zEnd && zSrc[0] == '0' ){` |
|    3949 |  344 | `		zSrc++;` |
|       5 |  345 | `	}` |
|    3959 |  346 | `	zIn = zSrc;` |
|    1987 |  347 | `	for(;;){` |
|    3979 |  348 | `		if(zSrc >= zEnd \|\| !SyisDigit(zSrc[0])){ break; } if( (c=zSrc[0]-'0') > 7 \|\| (int)(zSrc-zIn) > 20){ break;} nVal = nVal * 8 +  c; zSrc++;` |
|    3977 |  349 | `		if(zSrc >= zEnd \|\| !SyisDigit(zSrc[0])){ break; } if( (c=zSrc[0]-'0') > 7 \|\| (int)(zSrc-zIn) > 20){ break;} nVal = nVal * 8 +  c; zSrc++;` |
|    3967 |  350 | `		if(zSrc >= zEnd \|\| !SyisDigit(zSrc[0])){ break; } if( (c=zSrc[0]-'0') > 7 \|\| (int)(zSrc-zIn) > 20){ break;} nVal = nVal * 8 +  c; zSrc++;` |
|    3945 |  351 | `		if(zSrc >= zEnd \|\| !SyisDigit(zSrc[0])){ break; } if( (c=zSrc[0]-'0') > 7 \|\| (int)(zSrc-zIn) > 20){ break;} nVal = nVal * 8 +  c; zSrc++;` |
|       1 |  352 | `	}` |
|       - |  353 | `	/* Skip trailing spaces */` |
|    3959 |  354 | `	while(zSrc < zEnd && SyisSpace(zSrc[0])){` |
|     ! 0 |  355 | `		zSrc++;` |
|     ! 0 |  356 | `	}` |
|    3959 |  357 | `	if( zRest ){` |
|     ! 0 |  358 | `		*zRest = zSrc;` |
|     ! 0 |  359 | `	}` |
|    3959 |  360 | `	if( pOutVal ){` |
|    3959 |  361 | `		if( isNeg == TRUE && nVal != 0 ){` |
|     ! 0 |  362 | `			nVal = -nVal;` |
|     ! 0 |  363 | `		}` |
|    3959 |  364 | `		*(sxi64 *)pOutVal = nVal;` |
|    1977 |  365 | `	}` |
|    3959 |  366 | `	return (zSrc >= zEnd) ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  367 | `}` |
...
|       1 |  419 | `}` |
|    8824 |  420 | `PH7_PRIVATE sxi32 SyStrToReal(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  421 | `{` |
...
|       - |  434 | `	char zBuf[512];` |
|    8829 |  435 | `	const char *zEnd = &zSrc[nLen];` |
|       - |  436 | `	const char *zNum;` |
|    8829 |  437 | `	const char *zExpStart = 0;` |
|    8829 |  438 | `	sxreal Val = 0.0;` |
|    8829 |  439 | `	sxu32 nCopy = 0;` |
|    8829 |  440 | `	int bDigit = 0;` |
|       - |  441 | `#ifdef UNTRUST` |
...
|    8833 |  450 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|       5 |  451 | `		zSrc++;` |
|       1 |  452 | `	}` |
|    8829 |  453 | `	zNum = zSrc;` |
|       - |  454 | `	/* Sign (if exists) */` |
|    8829 |  455 | `	if( zSrc < zEnd && (zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
|      12 |  456 | `		zSrc++;` |
|       5 |  457 | `	}` |
|       - |  458 | `	/* Integer part */` |
|   18691 |  459 | `	while( zSrc < zEnd && SyisDigit(zSrc[0]) ){` |
|    9867 |  460 | `		bDigit = 1;` |
|    9867 |  461 | `		zSrc++;` |
|       5 |  462 | `	}` |
|       - |  463 | `	/* Fractional part */` |
|    8829 |  464 | `	if( zSrc < zEnd && ( zSrc[0] == '.' \|\| zSrc[0] == ',' ) ){` |
|    8677 |  465 | `		zSrc++;` |
|   19933 |  466 | `		while( zSrc < zEnd && SyisDigit(zSrc[0]) ){` |
|   11261 |  467 | `			bDigit = 1;` |
|   11261 |  468 | `			zSrc++;` |
|       5 |  469 | `		}` |
|    4336 |  470 | `	}` |
...
|    8829 |  473 | `	if( bDigit && zSrc < zEnd && ( zSrc[0] == 'e' \|\| zSrc[0] == 'E' ) ){` |
...
|      93 |  485 | `	}` |
|    8829 |  486 | `	if( bDigit ){` |
|    8829 |  487 | `		sxu32 i, nSpan = (sxu32)((zExpStart ? zExpStart : zSrc) - zNum);` |
|    8829 |  488 | `		sxu32 nExp = zExpStart ? (sxu32)(zSrc - zExpStart) : 0;` |
|    8829 |  489 | `		char *zDup = zBuf;` |
|    8829 |  490 | `		sxu32 nDup = sizeof(zBuf);` |
|    8829 |  491 | `		if( nSpan + nExp >= sizeof(zBuf) ){` |
...
|       1 |  497 | `		}` |
|       - |  498 | `		{` |
|    8829 |  499 | `			sxu32 nMantMax = nDup - 1 - (nExp < nDup - 1 ? nExp : 0);` |
|   38629 |  500 | `			for( i = 0 ; i < nSpan && nCopy < nMantMax ; i++ ){` |
|   29805 |  501 | `				zDup[nCopy++] = (zNum[i] == ',') ? '.' : zNum[i];` |
|   14905 |  502 | `			}` |
|       - |  503 | `			/* The exponent rides behind even a truncated mantissa: dropping` |
|       - |  504 | `			 * it would collapse "0.<hundreds of zeros>1e300" to 0.0. */` |
|    9465 |  505 | `			for( i = 0 ; i < nExp && nCopy < nDup - 1 ; i++ ){` |
|     639 |  506 | `				zDup[nCopy++] = zExpStart[i];` |
|     321 |  507 | `			}` |
|       - |  508 | `		}` |
|    8829 |  509 | `		zDup[nCopy] = 0;` |
|    8829 |  510 | `		Val = (sxreal)strtod(zDup,0);` |
|    8829 |  511 | `		if( zDup != zBuf ){` |
|       3 |  512 | `			free(zDup);` |
|       1 |  513 | `		}` |
|    4412 |  514 | `	}` |
|       - |  515 | `	/* Jump trailing spaces */` |
|    8829 |  516 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|     ! 0 |  517 | `		zSrc++;` |
|     ! 0 |  518 | `	}` |
|    8829 |  519 | `	if( zRest ){` |
|     ! 0 |  520 | `		*zRest = zSrc;` |
|     ! 0 |  521 | `	}` |
|    8829 |  522 | `	if( pOutVal ){` |
|    8829 |  523 | `		*(sxreal *)pOutVal = Val;` |
|    4412 |  524 | `	}` |
|    8829 |  525 | `	return zSrc >= zEnd ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  526 | `}` |
|       - |  527 |  |
