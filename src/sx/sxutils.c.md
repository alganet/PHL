...
|     ! 0 |  166 | `}` |
| 2312917 |  167 | `PH7_PRIVATE sxi32 SyStrToInt64(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  168 | `{` |
| 2312922 |  169 | `	int isNeg = FALSE;` |
|       - |  170 | `	const char *zEnd;` |
|       - |  171 | `	sxi64 nVal;` |
...
| 2312922 |  178 | `	int bOverflow = FALSE;` |
...
|       - |  185 | `	}` |
|       - |  186 | `#endif` |
| 2312922 |  187 | `	zEnd = &zSrc[nLen];` |
| 2312944 |  188 | `	while(zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|      24 |  189 | `		zSrc++;` |
|       2 |  190 | `	}` |
| 2312922 |  191 | `	if( zSrc < zEnd && ( zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
|      33 |  192 | `		isNeg = (zSrc[0] == '-') ? TRUE :FALSE;` |
|      33 |  193 | `		zSrc++;` |
|      15 |  194 | `	}` |
|       - |  195 | `	/* Skip leading zero */` |
| 2314290 |  196 | `	while(zSrc < zEnd && zSrc[0] == '0' ){` |
|    1369 |  197 | `		zSrc++;` |
|       1 |  198 | `	}` |
| 2312922 |  199 | `	cutoff = isNeg ? ((sxu64)SXI64_HIGH + 1) : (sxu64)SXI64_HIGH;` |
| 2312922 |  200 | `	uVal = 0;` |
| 5590515 |  201 | `	while( zSrc < zEnd && (unsigned char)zSrc[0] < 0xc0 && SyisDigit(zSrc[0]) ){` |
| 3277598 |  202 | `		int d = zSrc[0] - '0';` |
| 3277598 |  203 | `		if( uVal > cutoff / 10 \|\| (uVal == cutoff / 10 && (sxu64)d > cutoff % 10) ){` |
|      33 |  204 | `			bOverflow = TRUE;` |
|      17 |  205 | `		}else{` |
| 3277566 |  206 | `			uVal = uVal * 10 + (sxu64)d;` |
|       - |  207 | `		}` |
| 3277598 |  208 | `		zSrc++;` |
|       5 |  209 | `	}` |
| 2312922 |  210 | `	if( bOverflow ){` |
|      25 |  211 | `		uVal = cutoff;` |
|      12 |  212 | `	}` |
|       - |  213 | `	/* Skip trailing spaces */` |
| 2312944 |  214 | `	while(zSrc < zEnd && SyisSpace(zSrc[0])){` |
|      24 |  215 | `		zSrc++;` |
|       2 |  216 | `	}` |
| 2312922 |  217 | `	if( zRest ){` |
|     ! 0 |  218 | `		*zRest = (char *)zSrc;` |
|     ! 0 |  219 | `	}` |
| 2312922 |  220 | `	if( pOutVal ){` |
| 2312922 |  221 | `		if( isNeg ){` |
...
|      18 |  225 | `		}else{` |
| 2312892 |  226 | `			nVal = (sxi64)uVal;` |
|       - |  227 | `		}` |
| 2312922 |  228 | `		*(sxi64 *)pOutVal = nVal;` |
| 1156458 |  229 | `	}` |
| 2312922 |  230 | `	return (zSrc >= zEnd) ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  231 | `}` |
|  322670 |  232 | `PH7_PRIVATE sxi32 SyHexToint(sxi32 c)` |
|       5 |  233 | `{` |
|  322675 |  234 | `	switch(c){` |
|  131835 |  235 | `	case '0': return 0;` |
|   11681 |  236 | `	case '1': return 1;` |
|   77425 |  237 | `	case '2': return 2;` |
|    7823 |  238 | `	case '3': return 3;` |
|    3917 |  239 | `	case '4': return 4;` |
|   11631 |  240 | `	case '5': return 5;` |
|    7773 |  241 | `	case '6': return 6;` |
|    3895 |  242 | `	case '7': return 7;` |
|   19419 |  243 | `	case '8': return 8;` |
|   11715 |  244 | `	case '9': return 9;` |
|   11715 |  245 | `	case 'A': case 'a': return 10;` |
|    3905 |  246 | `	case 'B': case 'b': return 11;` |
|    3999 |  247 | `	case 'C': case 'c': return 12;` |
|    3899 |  248 | `	case 'D': case 'd': return 13;` |
|    3981 |  249 | `	case 'E': case 'e': return 14;` |
|    8135 |  250 | `	case 'F': case 'f': return 15;` |
|       - |  251 | `	}` |
|       3 |  252 | `	return -1;` |
|  161340 |  253 | `}` |
|  104526 |  254 | `PH7_PRIVATE sxi32 SyHexStrToInt64(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  255 | `{` |
|       - |  256 | `	const char *zIn,*zEnd;` |
|  104531 |  257 | `	int isNeg = FALSE;` |
|  104531 |  258 | `	sxi64 nVal = 0;` |
...
|       - |  265 | `	}` |
|       - |  266 | `#endif` |
|  104531 |  267 | `	zEnd = &zSrc[nLen];` |
|  104531 |  268 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|     ! 0 |  269 | `		zSrc++;` |
|     ! 0 |  270 | `	}` |
|  104531 |  271 | `	if( zSrc < zEnd && ( *zSrc == '-' \|\| *zSrc == '+' ) ){` |
|     ! 0 |  272 | `		isNeg = (zSrc[0] == '-') ? TRUE :FALSE;` |
|     ! 0 |  273 | `		zSrc++;` |
|     ! 0 |  274 | `	}` |
|  104531 |  275 | `	if( zSrc < &zEnd[-2] && zSrc[0] == '0' && (zSrc[1] == 'x' \|\| zSrc[1] == 'X') ){` |
|       - |  276 | `		/* Bypass hex prefix */` |
|  104531 |  277 | `		zSrc += sizeof(char) * 2;` |
|   52263 |  278 | `	}` |
|       - |  279 | `	/* Skip leading zero */` |
|  131615 |  280 | `	while(zSrc < zEnd && zSrc[0] == '0' ){` |
|   27089 |  281 | `		zSrc++;` |
|       5 |  282 | `	}` |
|  104531 |  283 | `	zIn = zSrc;` |
|   87116 |  284 | `	for(;;){` |
|  174237 |  285 | `		if(zSrc >= zEnd \|\| !SyisHex(zSrc[0]) \|\| (int)(zSrc-zIn) > 15){` |
|   36778 |  286 | `			break;` |
|       - |  287 | `		}` |
|  100691 |  288 | `		nVal = nVal * 16 + SyHexToint(zSrc[0]);` |
|  100691 |  289 | `		zSrc++;` |
|  100691 |  290 | `		if(zSrc >= zEnd \|\| !SyisHex(zSrc[0]) \|\| (int)(zSrc-zIn) > 15){` |
|    9681 |  291 | `			break;` |
|       - |  292 | `		}` |
|   81339 |  293 | `		nVal = nVal * 16 + SyHexToint(zSrc[0]);` |
|   81339 |  294 | `		zSrc++;` |
|   81339 |  295 | `		if(zSrc >= zEnd \|\| !SyisHex(zSrc[0]) \|\| (int)(zSrc-zIn) > 15){` |
|    5819 |  296 | `			break;` |
|       - |  297 | `		}` |
|   69711 |  298 | `		nVal = nVal * 16 + SyHexToint(zSrc[0]);` |
|   69711 |  299 | `		zSrc++;` |
|   69711 |  300 | `		if(zSrc >= zEnd \|\| !SyisHex(zSrc[0]) \|\| (int)(zSrc-zIn) > 15){` |
|     ! 0 |  301 | `			break;` |
|       - |  302 | `		}` |
|   69711 |  303 | `		nVal = nVal * 16 + SyHexToint(zSrc[0]);` |
|   69711 |  304 | `		zSrc++;` |
|       5 |  305 | `	}` |
|  104531 |  306 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|     ! 0 |  307 | `		zSrc++;` |
|     ! 0 |  308 | `	}` |
|  104531 |  309 | `	if( zRest ){` |
|     ! 0 |  310 | `		*zRest = zSrc;` |
|     ! 0 |  311 | `	}` |
|  104531 |  312 | `	if( pOutVal ){` |
|  104531 |  313 | `		if( isNeg == TRUE && nVal != 0 ){` |
|     ! 0 |  314 | `			nVal = -nVal;` |
|     ! 0 |  315 | `		}` |
|  104531 |  316 | `		*(sxi64 *)pOutVal = nVal;` |
|   52263 |  317 | `	}` |
|  104531 |  318 | `	return zSrc >= zEnd ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  319 | `}` |
...
|    3943 |  351 | `		if(zSrc >= zEnd \|\| !SyisDigit(zSrc[0])){ break; } if( (c=zSrc[0]-'0') > 7 \|\| (int)(zSrc-zIn) > 20){ break;} nVal = nVal * 8 +  c; zSrc++;` |
|       1 |  352 | `	}` |
...
|       1 |  419 | `}` |
|    8852 |  420 | `PH7_PRIVATE sxi32 SyStrToReal(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  421 | `{` |
...
|       - |  434 | `	char zBuf[512];` |
|    8857 |  435 | `	const char *zEnd = &zSrc[nLen];` |
|       - |  436 | `	const char *zNum;` |
|    8857 |  437 | `	const char *zExpStart = 0;` |
|    8857 |  438 | `	sxreal Val = 0.0;` |
|    8857 |  439 | `	sxu32 nCopy = 0;` |
|    8857 |  440 | `	int bDigit = 0;` |
|       - |  441 | `#ifdef UNTRUST` |
...
|    8861 |  450 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|       5 |  451 | `		zSrc++;` |
|       1 |  452 | `	}` |
|    8857 |  453 | `	zNum = zSrc;` |
|       - |  454 | `	/* Sign (if exists) */` |
|    8857 |  455 | `	if( zSrc < zEnd && (zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
|      14 |  456 | `		zSrc++;` |
|       6 |  457 | `	}` |
|       - |  458 | `	/* Integer part */` |
|   18809 |  459 | `	while( zSrc < zEnd && SyisDigit(zSrc[0]) ){` |
|    9957 |  460 | `		bDigit = 1;` |
|    9957 |  461 | `		zSrc++;` |
|       5 |  462 | `	}` |
|       - |  463 | `	/* Fractional part */` |
|    8857 |  464 | `	if( zSrc < zEnd && ( zSrc[0] == '.' \|\| zSrc[0] == ',' ) ){` |
|    8697 |  465 | `		zSrc++;` |
...
|    8857 |  473 | `	if( bDigit && zSrc < zEnd && ( zSrc[0] == 'e' \|\| zSrc[0] == 'E' ) ){` |
...
|     100 |  485 | `	}` |
|    8857 |  486 | `	if( bDigit ){` |
|    8857 |  487 | `		sxu32 i, nSpan = (sxu32)((zExpStart ? zExpStart : zSrc) - zNum);` |
|    8857 |  488 | `		sxu32 nExp = zExpStart ? (sxu32)(zSrc - zExpStart) : 0;` |
|    8857 |  489 | `		char *zDup = zBuf;` |
|    8857 |  490 | `		sxu32 nDup = sizeof(zBuf);` |
|    8857 |  491 | `		if( nSpan + nExp >= sizeof(zBuf) ){` |
...
|       1 |  497 | `		}` |
|       - |  498 | `		{` |
|    8857 |  499 | `			sxu32 nMantMax = nDup - 1 - (nExp < nDup - 1 ? nExp : 0);` |
|   38799 |  500 | `			for( i = 0 ; i < nSpan && nCopy < nMantMax ; i++ ){` |
|   29947 |  501 | `				zDup[nCopy++] = (zNum[i] == ',') ? '.' : zNum[i];` |
|   14976 |  502 | `			}` |
|       - |  503 | `			/* The exponent rides behind even a truncated mantissa: dropping` |
|       - |  504 | `			 * it would collapse "0.<hundreds of zeros>1e300" to 0.0. */` |
|    9531 |  505 | `			for( i = 0 ; i < nExp && nCopy < nDup - 1 ; i++ ){` |
|     677 |  506 | `				zDup[nCopy++] = zExpStart[i];` |
|     340 |  507 | `			}` |
|       - |  508 | `		}` |
|    8857 |  509 | `		zDup[nCopy] = 0;` |
|    8857 |  510 | `		Val = (sxreal)strtod(zDup,0);` |
|    8857 |  511 | `		if( zDup != zBuf ){` |
|       3 |  512 | `			free(zDup);` |
|       1 |  513 | `		}` |
|    4426 |  514 | `	}` |
|       - |  515 | `	/* Jump trailing spaces */` |
|    8857 |  516 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|     ! 0 |  517 | `		zSrc++;` |
|     ! 0 |  518 | `	}` |
|    8857 |  519 | `	if( zRest ){` |
|     ! 0 |  520 | `		*zRest = zSrc;` |
|     ! 0 |  521 | `	}` |
|    8857 |  522 | `	if( pOutVal ){` |
|    8857 |  523 | `		*(sxreal *)pOutVal = Val;` |
|    4426 |  524 | `	}` |
|    8857 |  525 | `	return zSrc >= zEnd ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  526 | `}` |
|       - |  527 |  |
