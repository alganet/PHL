...
| 2317208 |  200 | `	uVal = 0;` |
| 5600727 |  201 | `	while( zSrc < zEnd && (unsigned char)zSrc[0] < 0xc0 && SyisDigit(zSrc[0]) ){` |
| 3283524 |  202 | `		int d = zSrc[0] - '0';` |
| 3283524 |  203 | `		if( uVal > cutoff / 10 \|\| (uVal == cutoff / 10 && (sxu64)d > cutoff % 10) ){` |
|      33 |  204 | `			bOverflow = TRUE;` |
|      17 |  205 | `		}else{` |
| 3283492 |  206 | `			uVal = uVal * 10 + (sxu64)d;` |
|       - |  207 | `		}` |
| 3283524 |  208 | `		zSrc++;` |
|       5 |  209 | `	}` |
