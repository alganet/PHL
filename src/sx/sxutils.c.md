...
|      - |    9 | `#include "sxstr.h"` |
|      - |   10 |  |
| 315468 |   11 | `PH7_PRIVATE sxi32 SyStrIsNumeric(const char *zSrc,sxu32 nLen,sxu8 *pReal,const char  **pzTail)` |
|      2 |   12 |  |
...
|      - |   17 | `	}` |
|      - |   18 | `#endif` |
| 315470 |   19 | `	zEnd = &zSrc[nLen];` |
|      - |   20 | `	/* Jump leading white spaces */` |
| 315474 |   21 | `	while( zSrc < zEnd && (unsigned char)zSrc[0] < 0xc0  && SyisSpace(zSrc[0]) ){` |
|      5 |   22 | `		zSrc++;` |
|      1 |   23 | `	}` |
| 315470 |   24 | `	if( zSrc < zEnd && (zSrc[0] == '+' \|\| zSrc[0] == '-') ){` |
|     82 |   25 | `		zSrc++;` |
|     40 |   26 | `	}` |
| 315470 |   27 | `	zCur = zSrc;` |
| 315470 |   28 | `	if( pReal ){` |
...
|     46 |   30 | `	}` |
| 157809 |   31 | `	for(;;){` |
| 315470 |   32 | `		if( zSrc >= zEnd \|\| (unsigned char)zSrc[0] >= 0xc0 \|\| !SyisDigit(zSrc[0]) ){` |
| 157764 |   33 | `			break;` |
|      - |   34 | `		}` |
|     96 |   35 | `		zSrc++;` |
|     96 |   36 | `		if( zSrc >= zEnd \|\| (unsigned char)zSrc[0] >= 0xc0 \|\| !SyisDigit(zSrc[0]) ){` |
|     33 |   37 | `			break;` |
|      - |   38 | `		}` |
|     34 |   39 | `		zSrc++;` |
...
|    ! 0 |   47 | `		zSrc++;` |
|    ! 0 |   48 | `	};` |
| 315470 |   49 | `	if( zSrc < zEnd && zSrc > zCur ){` |
|     24 |   50 | `		int c = zSrc[0];` |
|     24 |   51 | `		if( c == '.' ){` |
|     22 |   52 | `			zSrc++;` |
|     22 |   53 | `			if( pReal ){` |
...
|    ! 0 |   87 | `		*pzTail = zSrc;` |
|    ! 0 |   88 | `	}` |
| 315470 |   89 | `	return zSrc > zCur ? SXRET_OK /* String prefix is numeric */ : SXERR_INVALID /* Not a digit stream */;` |
|      2 |   90 |  |
...
|      1 |  167 |  |
|  51658 |  168 | `PH7_PRIVATE sxi32 SyStrToInt64(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|      2 |  169 |  |
|  51660 |  170 | `	int isNeg = FALSE;` |
|      - |  171 | `	const char *zEnd;` |
|      - |  172 | `	sxi64 nVal;` |
|      - |  173 | `	sxi16 i;` |
...
|      - |  180 | `	}` |
|      - |  181 | `#endif` |
|  51660 |  182 | `	zEnd = &zSrc[nLen];` |
|  51660 |  183 | `	while(zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|    ! 0 |  184 | `		zSrc++;` |
|    ! 0 |  185 | `	}` |
|  51660 |  186 | `	if( zSrc < zEnd && ( zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
|    ! 0 |  187 | `		isNeg = (zSrc[0] == '-') ? TRUE :FALSE;` |
|    ! 0 |  188 | `		zSrc++;` |
|    ! 0 |  189 | `	}` |
|      - |  190 | `	/* Skip leading zero */` |
|  51660 |  191 | `	while(zSrc < zEnd && zSrc[0] == '0' ){` |
|    ! 0 |  192 | `		zSrc++;` |
|    ! 0 |  193 | `	}` |
|  51660 |  194 | `	i = 19;` |
|  51660 |  195 | `	if( (sxu32)(zEnd-zSrc) >= 19 ){` |
|      5 |  196 | `		i = SyMemcmp(zSrc,isNeg ? SXINT64_MIN_STR : SXINT64_MAX_STR,19) <= 0 ? 19 : 18 ;` |
|      2 |  197 | `	}` |
|  51660 |  198 | `	nVal = 0;` |
|  25940 |  199 | `	for(;;){` |
|  51882 |  200 | `		if(zSrc >= zEnd \|\| !i \|\| !SyisDigit(zSrc[0])){ break; } nVal = nVal * 10 + ( zSrc[0] - '0' ) ; --i ; zSrc++;` |
|  51790 |  201 | `		if(zSrc >= zEnd \|\| !i \|\| !SyisDigit(zSrc[0])){ break; } nVal = nVal * 10 + ( zSrc[0] - '0' ) ; --i ; zSrc++;` |
|   6850 |  202 | `		if(zSrc >= zEnd \|\| !i \|\| !SyisDigit(zSrc[0])){ break; } nVal = nVal * 10 + ( zSrc[0] - '0' ) ; --i ; zSrc++;` |
|    706 |  203 | `		if(zSrc >= zEnd \|\| !i \|\| !SyisDigit(zSrc[0])){ break; } nVal = nVal * 10 + ( zSrc[0] - '0' ) ; --i ; zSrc++;` |
|      1 |  204 | `	}` |
|      - |  205 | `	/* Skip trailing spaces */` |
|  51660 |  206 | `	while(zSrc < zEnd && SyisSpace(zSrc[0])){` |
|    ! 0 |  207 | `		zSrc++;` |
|    ! 0 |  208 | `	}` |
|  51660 |  209 | `	if( zRest ){` |
|    ! 0 |  210 | `		*zRest = (char *)zSrc;` |
|    ! 0 |  211 | `	}` |
|  51660 |  212 | `	if( pOutVal ){` |
|  51660 |  213 | `		if( isNeg == TRUE && nVal != 0 ){` |
|    ! 0 |  214 | `			nVal = -nVal;` |
|    ! 0 |  215 | `		}` |
|  51660 |  216 | `		*(sxi64 *)pOutVal = nVal;` |
|  25829 |  217 | `	}` |
|  51660 |  218 | `	return (zSrc >= zEnd) ? SXRET_OK : SXERR_SYNTAX;` |
|      2 |  219 |  |
...
|      1 |  407 |  |
|    432 |  408 | `PH7_PRIVATE sxi32 SyStrToReal(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|      2 |  409 |  |
...
|      - |  422 | `	1.0e256` |
|      - |  423 | `	};` |
|    434 |  424 | `	sxu8 neg = FALSE;` |
|    434 |  425 | `	sxreal Val = 0.0;` |
|      - |  426 | `	const char *zEnd;` |
|      - |  427 | `	sxi32 Lim,exp;` |
|    434 |  428 | `	sxreal *p = 0;` |
|      - |  429 | `#ifdef UNTRUST` |
...
|    434 |  438 | `	zEnd = &zSrc[nLen];` |
|    434 |  439 | `	Lim = SXDBL_DIG;` |
|      - |  440 | `	/* Skip leading spaces */` |
|    438 |  441 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ) zSrc++;` |
|      - |  442 |  |
|      - |  443 | `	/* Sign (if exists) */` |
|    434 |  444 | `	if( zSrc < zEnd && (zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
...
|      - |  449 | `	/* Integer part */` |
|    216 |  450 | `	for(;;){` |
|    434 |  451 | `		if(zSrc >= zEnd \|\| !Lim \|\| !SyisDigit(zSrc[0])){` |
|    ! 0 |  452 | `			break;` |
|      - |  453 | `		}` |
|    434 |  454 | `		Val = Val * 10.0 + (zSrc[0] - '0');` |
|    434 |  455 | `		zSrc++;` |
|    434 |  456 | `		--Lim;` |
|    434 |  457 | `		if(zSrc >= zEnd \|\| !Lim \|\| !SyisDigit(zSrc[0])){` |
|    214 |  458 | `			break;` |
|      - |  459 | `		}` |
...
|    ! 0 |  474 | `		--Lim;` |
|    ! 0 |  475 | `	}` |
|    434 |  476 | `	Lim = SXDBL_DIG ;` |
|    216 |  477 | `	for(;;){` |
|    434 |  478 | `		if(zSrc >= zEnd \|\| !Lim \|\| !SyisDigit(zSrc[0])){` |
|    218 |  479 | `			break;` |
|      - |  480 | `		}` |
...
|    ! 0 |  501 | `		--Lim;` |
|    ! 0 |  502 | `	}` |
|    434 |  503 | `	if( zSrc < zEnd && ( zSrc[0] == '.' \|\| zSrc[0] == ',' ) ){` |
|    414 |  504 | `		sxreal dec = 1.0;` |
|    414 |  505 | `		zSrc++;` |
|    287 |  506 | `		for(;;){` |
|    576 |  507 | `			if(zSrc >= zEnd \|\| !Lim \|\| !SyisDigit(zSrc[0])){` |
|     24 |  508 | `				break;` |
|      - |  509 | `			}` |
|    530 |  510 | `			Val = Val * 10.0 + (zSrc[0] - '0');` |
|    530 |  511 | `			dec *= 10.0;` |
|    530 |  512 | `			zSrc++;` |
|    530 |  513 | `			--Lim;` |
|    530 |  514 | `			if(zSrc >= zEnd \|\| !Lim \|\| !SyisDigit(zSrc[0])){` |
|    117 |  515 | `				break;` |
|      - |  516 | `			}` |
|    300 |  517 | `			Val = Val * 10.0 + (zSrc[0] - '0');` |
|    300 |  518 | `			dec *= 10.0;` |
|    300 |  519 | `			zSrc++;` |
|    300 |  520 | `			--Lim;` |
|    300 |  521 | `			if(zSrc >= zEnd \|\| !Lim \|\| !SyisDigit(zSrc[0])){` |
|     32 |  522 | `				break;` |
|      - |  523 | `			}` |
...
|     14 |  549 | `	}` |
|    434 |  550 | `	neg = FALSE;` |
|    434 |  551 | `	if( zSrc < zEnd && ( zSrc[0] == 'e' \|\| zSrc[0] == 'E' ) ){` |
|     37 |  552 | `		zSrc++;` |
...
|     47 |  575 | `		}` |
|     18 |  576 | `	}` |
|    434 |  577 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|    ! 0 |  578 | `		zSrc++;` |
|    ! 0 |  579 | `	}` |
|    434 |  580 | `	if( zRest ){` |
|    ! 0 |  581 | `		*zRest = zSrc;` |
|    ! 0 |  582 | `	}` |
|    434 |  583 | `	if( pOutVal ){` |
|    434 |  584 | `		*(sxreal *)pOutVal = Val;` |
|    216 |  585 | `	}` |
|    434 |  586 | `	return zSrc >= zEnd ? SXRET_OK : SXERR_SYNTAX;` |
|      2 |  587 |  |
|      - |  588 |  |
