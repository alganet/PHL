...
|     ! 0 |  166 | `}` |
| 2315311 |  167 | `PH7_PRIVATE sxi32 SyStrToInt64(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  168 | `{` |
| 2315316 |  169 | `	int isNeg = FALSE;` |
|       - |  170 | `	const char *zEnd;` |
|       - |  171 | `	sxi64 nVal;` |
...
| 2315316 |  178 | `	int bOverflow = FALSE;` |
...
|       - |  185 | `	}` |
|       - |  186 | `#endif` |
| 2315316 |  187 | `	zEnd = &zSrc[nLen];` |
| 2315338 |  188 | `	while(zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|      24 |  189 | `		zSrc++;` |
|       2 |  190 | `	}` |
| 2315316 |  191 | `	if( zSrc < zEnd && ( zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
|      33 |  192 | `		isNeg = (zSrc[0] == '-') ? TRUE :FALSE;` |
|      33 |  193 | `		zSrc++;` |
|      15 |  194 | `	}` |
|       - |  195 | `	/* Skip leading zero */` |
| 2316684 |  196 | `	while(zSrc < zEnd && zSrc[0] == '0' ){` |
|    1369 |  197 | `		zSrc++;` |
|       1 |  198 | `	}` |
| 2315316 |  199 | `	cutoff = isNeg ? ((sxu64)SXI64_HIGH + 1) : (sxu64)SXI64_HIGH;` |
| 2315316 |  200 | `	uVal = 0;` |
| 5596283 |  201 | `	while( zSrc < zEnd && (unsigned char)zSrc[0] < 0xc0 && SyisDigit(zSrc[0]) ){` |
| 3280972 |  202 | `		int d = zSrc[0] - '0';` |
| 3280972 |  203 | `		if( uVal > cutoff / 10 \|\| (uVal == cutoff / 10 && (sxu64)d > cutoff % 10) ){` |
|      33 |  204 | `			bOverflow = TRUE;` |
|      17 |  205 | `		}else{` |
| 3280940 |  206 | `			uVal = uVal * 10 + (sxu64)d;` |
|       - |  207 | `		}` |
| 3280972 |  208 | `		zSrc++;` |
|       5 |  209 | `	}` |
| 2315316 |  210 | `	if( bOverflow ){` |
|      25 |  211 | `		uVal = cutoff;` |
|      12 |  212 | `	}` |
|       - |  213 | `	/* Skip trailing spaces */` |
| 2315338 |  214 | `	while(zSrc < zEnd && SyisSpace(zSrc[0])){` |
|      24 |  215 | `		zSrc++;` |
|       2 |  216 | `	}` |
| 2315316 |  217 | `	if( zRest ){` |
|     ! 0 |  218 | `		*zRest = (char *)zSrc;` |
|     ! 0 |  219 | `	}` |
| 2315316 |  220 | `	if( pOutVal ){` |
| 2315316 |  221 | `		if( isNeg ){` |
...
|      18 |  225 | `		}else{` |
| 2315286 |  226 | `			nVal = (sxi64)uVal;` |
|       - |  227 | `		}` |
| 2315316 |  228 | `		*(sxi64 *)pOutVal = nVal;` |
| 1157655 |  229 | `	}` |
| 2315316 |  230 | `	return (zSrc >= zEnd) ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  231 | `}` |
|  323002 |  232 | `PH7_PRIVATE sxi32 SyHexToint(sxi32 c)` |
|       5 |  233 | `{` |
|  323007 |  234 | `	switch(c){` |
|  131971 |  235 | `	case '0': return 0;` |
|   11693 |  236 | `	case '1': return 1;` |
|   77505 |  237 | `	case '2': return 2;` |
...
|   19439 |  243 | `	case '8': return 8;` |
|   11727 |  244 | `	case '9': return 9;` |
|   11727 |  245 | `	case 'A': case 'a': return 10;` |
...
|       3 |  252 | `	return -1;` |
|  161506 |  253 | `}` |
|  104634 |  254 | `PH7_PRIVATE sxi32 SyHexStrToInt64(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  255 | `{` |
|       - |  256 | `	const char *zIn,*zEnd;` |
|  104639 |  257 | `	int isNeg = FALSE;` |
|  104639 |  258 | `	sxi64 nVal = 0;` |
...
|       - |  265 | `	}` |
|       - |  266 | `#endif` |
|  104639 |  267 | `	zEnd = &zSrc[nLen];` |
|  104639 |  268 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|     ! 0 |  269 | `		zSrc++;` |
|     ! 0 |  270 | `	}` |
|  104639 |  271 | `	if( zSrc < zEnd && ( *zSrc == '-' \|\| *zSrc == '+' ) ){` |
|     ! 0 |  272 | `		isNeg = (zSrc[0] == '-') ? TRUE :FALSE;` |
|     ! 0 |  273 | `		zSrc++;` |
|     ! 0 |  274 | `	}` |
|  104639 |  275 | `	if( zSrc < &zEnd[-2] && zSrc[0] == '0' && (zSrc[1] == 'x' \|\| zSrc[1] == 'X') ){` |
|       - |  276 | `		/* Bypass hex prefix */` |
|  104639 |  277 | `		zSrc += sizeof(char) * 2;` |
|   52317 |  278 | `	}` |
|       - |  279 | `	/* Skip leading zero */` |
|  131751 |  280 | `	while(zSrc < zEnd && zSrc[0] == '0' ){` |
|   27117 |  281 | `		zSrc++;` |
|       5 |  282 | `	}` |
|  104639 |  283 | `	zIn = zSrc;` |
|   87206 |  284 | `	for(;;){` |
|  174417 |  285 | `		if(zSrc >= zEnd \|\| !SyisHex(zSrc[0]) \|\| (int)(zSrc-zIn) > 15){` |
|   36816 |  286 | `			break;` |
|       - |  287 | `		}` |
|  100795 |  288 | `		nVal = nVal * 16 + SyHexToint(zSrc[0]);` |
|  100795 |  289 | `		zSrc++;` |
|  100795 |  290 | `		if(zSrc >= zEnd \|\| !SyisHex(zSrc[0]) \|\| (int)(zSrc-zIn) > 15){` |
|    9691 |  291 | `			break;` |
|       - |  292 | `		}` |
|   81423 |  293 | `		nVal = nVal * 16 + SyHexToint(zSrc[0]);` |
|   81423 |  294 | `		zSrc++;` |
|   81423 |  295 | `		if(zSrc >= zEnd \|\| !SyisHex(zSrc[0]) \|\| (int)(zSrc-zIn) > 15){` |
|    5825 |  296 | `			break;` |
|       - |  297 | `		}` |
...
|   69783 |  304 | `		zSrc++;` |
|       5 |  305 | `	}` |
|  104639 |  306 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|     ! 0 |  307 | `		zSrc++;` |
|     ! 0 |  308 | `	}` |
|  104639 |  309 | `	if( zRest ){` |
|     ! 0 |  310 | `		*zRest = zSrc;` |
|     ! 0 |  311 | `	}` |
|  104639 |  312 | `	if( pOutVal ){` |
|  104639 |  313 | `		if( isNeg == TRUE && nVal != 0 ){` |
|     ! 0 |  314 | `			nVal = -nVal;` |
|     ! 0 |  315 | `		}` |
|  104639 |  316 | `		*(sxi64 *)pOutVal = nVal;` |
|   52317 |  317 | `	}` |
|  104639 |  318 | `	return zSrc >= zEnd ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  319 | `}` |
...
|       1 |  419 | `}` |
|    8860 |  420 | `PH7_PRIVATE sxi32 SyStrToReal(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  421 | `{` |
...
|       - |  434 | `	char zBuf[512];` |
|    8865 |  435 | `	const char *zEnd = &zSrc[nLen];` |
|       - |  436 | `	const char *zNum;` |
|    8865 |  437 | `	const char *zExpStart = 0;` |
|    8865 |  438 | `	sxreal Val = 0.0;` |
|    8865 |  439 | `	sxu32 nCopy = 0;` |
|    8865 |  440 | `	int bDigit = 0;` |
|       - |  441 | `#ifdef UNTRUST` |
...
|    8869 |  450 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|       5 |  451 | `		zSrc++;` |
|       1 |  452 | `	}` |
|    8865 |  453 | `	zNum = zSrc;` |
|       - |  454 | `	/* Sign (if exists) */` |
|    8865 |  455 | `	if( zSrc < zEnd && (zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
|      14 |  456 | `		zSrc++;` |
|       6 |  457 | `	}` |
|       - |  458 | `	/* Integer part */` |
|   18825 |  459 | `	while( zSrc < zEnd && SyisDigit(zSrc[0]) ){` |
|    9965 |  460 | `		bDigit = 1;` |
|    9965 |  461 | `		zSrc++;` |
|       5 |  462 | `	}` |
|       - |  463 | `	/* Fractional part */` |
|    8865 |  464 | `	if( zSrc < zEnd && ( zSrc[0] == '.' \|\| zSrc[0] == ',' ) ){` |
|    8705 |  465 | `		zSrc++;` |
...
|    8865 |  473 | `	if( bDigit && zSrc < zEnd && ( zSrc[0] == 'e' \|\| zSrc[0] == 'E' ) ){` |
...
|     100 |  485 | `	}` |
|    8865 |  486 | `	if( bDigit ){` |
|    8865 |  487 | `		sxu32 i, nSpan = (sxu32)((zExpStart ? zExpStart : zSrc) - zNum);` |
|    8865 |  488 | `		sxu32 nExp = zExpStart ? (sxu32)(zSrc - zExpStart) : 0;` |
|    8865 |  489 | `		char *zDup = zBuf;` |
|    8865 |  490 | `		sxu32 nDup = sizeof(zBuf);` |
|    8865 |  491 | `		if( nSpan + nExp >= sizeof(zBuf) ){` |
...
|       1 |  497 | `		}` |
|       - |  498 | `		{` |
|    8865 |  499 | `			sxu32 nMantMax = nDup - 1 - (nExp < nDup - 1 ? nExp : 0);` |
|   38831 |  500 | `			for( i = 0 ; i < nSpan && nCopy < nMantMax ; i++ ){` |
|   29971 |  501 | `				zDup[nCopy++] = (zNum[i] == ',') ? '.' : zNum[i];` |
|   14988 |  502 | `			}` |
|       - |  503 | `			/* The exponent rides behind even a truncated mantissa: dropping` |
|       - |  504 | `			 * it would collapse "0.<hundreds of zeros>1e300" to 0.0. */` |
|    9539 |  505 | `			for( i = 0 ; i < nExp && nCopy < nDup - 1 ; i++ ){` |
|     677 |  506 | `				zDup[nCopy++] = zExpStart[i];` |
|     340 |  507 | `			}` |
|       - |  508 | `		}` |
|    8865 |  509 | `		zDup[nCopy] = 0;` |
|    8865 |  510 | `		Val = (sxreal)strtod(zDup,0);` |
|    8865 |  511 | `		if( zDup != zBuf ){` |
|       3 |  512 | `			free(zDup);` |
|       1 |  513 | `		}` |
|    4430 |  514 | `	}` |
|       - |  515 | `	/* Jump trailing spaces */` |
|    8865 |  516 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|     ! 0 |  517 | `		zSrc++;` |
|     ! 0 |  518 | `	}` |
|    8865 |  519 | `	if( zRest ){` |
|     ! 0 |  520 | `		*zRest = zSrc;` |
|     ! 0 |  521 | `	}` |
|    8865 |  522 | `	if( pOutVal ){` |
|    8865 |  523 | `		*(sxreal *)pOutVal = Val;` |
|    4430 |  524 | `	}` |
|    8865 |  525 | `	return zSrc >= zEnd ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  526 | `}` |
|       - |  527 |  |
