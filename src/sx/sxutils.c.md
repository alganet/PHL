...
|     ! 0 |  166 | `}` |
| 2314119 |  167 | `PH7_PRIVATE sxi32 SyStrToInt64(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  168 | `{` |
| 2314124 |  169 | `	int isNeg = FALSE;` |
|       - |  170 | `	const char *zEnd;` |
|       - |  171 | `	sxi64 nVal;` |
...
| 2314124 |  178 | `	int bOverflow = FALSE;` |
...
|       - |  185 | `	}` |
|       - |  186 | `#endif` |
| 2314124 |  187 | `	zEnd = &zSrc[nLen];` |
| 2314146 |  188 | `	while(zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|      24 |  189 | `		zSrc++;` |
|       2 |  190 | `	}` |
| 2314124 |  191 | `	if( zSrc < zEnd && ( zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
|      33 |  192 | `		isNeg = (zSrc[0] == '-') ? TRUE :FALSE;` |
|      33 |  193 | `		zSrc++;` |
|      15 |  194 | `	}` |
|       - |  195 | `	/* Skip leading zero */` |
| 2315494 |  196 | `	while(zSrc < zEnd && zSrc[0] == '0' ){` |
|    1371 |  197 | `		zSrc++;` |
|       1 |  198 | `	}` |
| 2314124 |  199 | `	cutoff = isNeg ? ((sxu64)SXI64_HIGH + 1) : (sxu64)SXI64_HIGH;` |
| 2314124 |  200 | `	uVal = 0;` |
| 5593407 |  201 | `	while( zSrc < zEnd && (unsigned char)zSrc[0] < 0xc0 && SyisDigit(zSrc[0]) ){` |
| 3279288 |  202 | `		int d = zSrc[0] - '0';` |
| 3279288 |  203 | `		if( uVal > cutoff / 10 \|\| (uVal == cutoff / 10 && (sxu64)d > cutoff % 10) ){` |
|      33 |  204 | `			bOverflow = TRUE;` |
|      17 |  205 | `		}else{` |
| 3279256 |  206 | `			uVal = uVal * 10 + (sxu64)d;` |
|       - |  207 | `		}` |
| 3279288 |  208 | `		zSrc++;` |
|       5 |  209 | `	}` |
| 2314124 |  210 | `	if( bOverflow ){` |
|      25 |  211 | `		uVal = cutoff;` |
|      12 |  212 | `	}` |
|       - |  213 | `	/* Skip trailing spaces */` |
| 2314146 |  214 | `	while(zSrc < zEnd && SyisSpace(zSrc[0])){` |
|      24 |  215 | `		zSrc++;` |
|       2 |  216 | `	}` |
| 2314124 |  217 | `	if( zRest ){` |
|     ! 0 |  218 | `		*zRest = (char *)zSrc;` |
|     ! 0 |  219 | `	}` |
| 2314124 |  220 | `	if( pOutVal ){` |
| 2314124 |  221 | `		if( isNeg ){` |
...
|      18 |  225 | `		}else{` |
| 2314094 |  226 | `			nVal = (sxi64)uVal;` |
|       - |  227 | `		}` |
| 2314124 |  228 | `		*(sxi64 *)pOutVal = nVal;` |
| 1157059 |  229 | `	}` |
| 2314124 |  230 | `	return (zSrc >= zEnd) ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  231 | `}` |
|  322836 |  232 | `PH7_PRIVATE sxi32 SyHexToint(sxi32 c)` |
|       5 |  233 | `{` |
|  322841 |  234 | `	switch(c){` |
|  131903 |  235 | `	case '0': return 0;` |
|   11687 |  236 | `	case '1': return 1;` |
|   77465 |  237 | `	case '2': return 2;` |
|    7827 |  238 | `	case '3': return 3;` |
|    3919 |  239 | `	case '4': return 4;` |
|   11637 |  240 | `	case '5': return 5;` |
|    7777 |  241 | `	case '6': return 6;` |
|    3897 |  242 | `	case '7': return 7;` |
|   19429 |  243 | `	case '8': return 8;` |
...
|       3 |  252 | `	return -1;` |
|  161423 |  253 | `}` |
|  104580 |  254 | `PH7_PRIVATE sxi32 SyHexStrToInt64(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  255 | `{` |
|       - |  256 | `	const char *zIn,*zEnd;` |
|  104585 |  257 | `	int isNeg = FALSE;` |
|  104585 |  258 | `	sxi64 nVal = 0;` |
...
|       - |  265 | `	}` |
|       - |  266 | `#endif` |
|  104585 |  267 | `	zEnd = &zSrc[nLen];` |
|  104585 |  268 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|     ! 0 |  269 | `		zSrc++;` |
|     ! 0 |  270 | `	}` |
|  104585 |  271 | `	if( zSrc < zEnd && ( *zSrc == '-' \|\| *zSrc == '+' ) ){` |
|     ! 0 |  272 | `		isNeg = (zSrc[0] == '-') ? TRUE :FALSE;` |
|     ! 0 |  273 | `		zSrc++;` |
|     ! 0 |  274 | `	}` |
|  104585 |  275 | `	if( zSrc < &zEnd[-2] && zSrc[0] == '0' && (zSrc[1] == 'x' \|\| zSrc[1] == 'X') ){` |
|       - |  276 | `		/* Bypass hex prefix */` |
|  104585 |  277 | `		zSrc += sizeof(char) * 2;` |
|   52290 |  278 | `	}` |
|       - |  279 | `	/* Skip leading zero */` |
|  131683 |  280 | `	while(zSrc < zEnd && zSrc[0] == '0' ){` |
|   27103 |  281 | `		zSrc++;` |
|       5 |  282 | `	}` |
|  104585 |  283 | `	zIn = zSrc;` |
|   87161 |  284 | `	for(;;){` |
|  174327 |  285 | `		if(zSrc >= zEnd \|\| !SyisHex(zSrc[0]) \|\| (int)(zSrc-zIn) > 15){` |
|   36797 |  286 | `			break;` |
|       - |  287 | `		}` |
|  100743 |  288 | `		nVal = nVal * 16 + SyHexToint(zSrc[0]);` |
|  100743 |  289 | `		zSrc++;` |
|  100743 |  290 | `		if(zSrc >= zEnd \|\| !SyisHex(zSrc[0]) \|\| (int)(zSrc-zIn) > 15){` |
|    9686 |  291 | `			break;` |
|       - |  292 | `		}` |
|   81381 |  293 | `		nVal = nVal * 16 + SyHexToint(zSrc[0]);` |
|   81381 |  294 | `		zSrc++;` |
|   81381 |  295 | `		if(zSrc >= zEnd \|\| !SyisHex(zSrc[0]) \|\| (int)(zSrc-zIn) > 15){` |
|    5822 |  296 | `			break;` |
|       - |  297 | `		}` |
...
|   69747 |  304 | `		zSrc++;` |
|       5 |  305 | `	}` |
|  104585 |  306 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|     ! 0 |  307 | `		zSrc++;` |
|     ! 0 |  308 | `	}` |
|  104585 |  309 | `	if( zRest ){` |
|     ! 0 |  310 | `		*zRest = zSrc;` |
|     ! 0 |  311 | `	}` |
|  104585 |  312 | `	if( pOutVal ){` |
|  104585 |  313 | `		if( isNeg == TRUE && nVal != 0 ){` |
|     ! 0 |  314 | `			nVal = -nVal;` |
|     ! 0 |  315 | `		}` |
|  104585 |  316 | `		*(sxi64 *)pOutVal = nVal;` |
|   52290 |  317 | `	}` |
|  104585 |  318 | `	return zSrc >= zEnd ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  319 | `}` |
...
|       6 |  457 | `	}` |
|       - |  458 | `	/* Integer part */` |
|   18817 |  459 | `	while( zSrc < zEnd && SyisDigit(zSrc[0]) ){` |
|    9961 |  460 | `		bDigit = 1;` |
|    9961 |  461 | `		zSrc++;` |
|       5 |  462 | `	}` |
|       - |  463 | `	/* Fractional part */` |
