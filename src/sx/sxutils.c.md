...
|       1 |  166 | `}` |
| 2317203 |  167 | `PH7_PRIVATE sxi32 SyStrToInt64(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  168 | `{` |
| 2317208 |  169 | `	int isNeg = FALSE;` |
|       - |  170 | `	const char *zEnd;` |
|       - |  171 | `	sxi64 nVal;` |
...
| 2317208 |  178 | `	int bOverflow = FALSE;` |
...
|       - |  185 | `	}` |
|       - |  186 | `#endif` |
| 2317208 |  187 | `	zEnd = &zSrc[nLen];` |
| 2317230 |  188 | `	while(zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|      24 |  189 | `		zSrc++;` |
|       2 |  190 | `	}` |
| 2317208 |  191 | `	if( zSrc < zEnd && ( zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
|      33 |  192 | `		isNeg = (zSrc[0] == '-') ? TRUE :FALSE;` |
|      33 |  193 | `		zSrc++;` |
|      15 |  194 | `	}` |
|       - |  195 | `	/* Skip leading zero */` |
| 2318572 |  196 | `	while(zSrc < zEnd && zSrc[0] == '0' ){` |
|    1365 |  197 | `		zSrc++;` |
|       1 |  198 | `	}` |
| 2317208 |  199 | `	cutoff = isNeg ? ((sxu64)SXI64_HIGH + 1) : (sxu64)SXI64_HIGH;` |
| 2317208 |  200 | `	uVal = 0;` |
| 5600729 |  201 | `	while( zSrc < zEnd && (unsigned char)zSrc[0] < 0xc0 && SyisDigit(zSrc[0]) ){` |
| 3283526 |  202 | `		int d = zSrc[0] - '0';` |
| 3283526 |  203 | `		if( uVal > cutoff / 10 \|\| (uVal == cutoff / 10 && (sxu64)d > cutoff % 10) ){` |
|      33 |  204 | `			bOverflow = TRUE;` |
|      17 |  205 | `		}else{` |
| 3283494 |  206 | `			uVal = uVal * 10 + (sxu64)d;` |
|       - |  207 | `		}` |
| 3283526 |  208 | `		zSrc++;` |
|       5 |  209 | `	}` |
| 2317208 |  210 | `	if( bOverflow ){` |
|      25 |  211 | `		uVal = cutoff;` |
|      12 |  212 | `	}` |
|       - |  213 | `	/* Skip trailing spaces */` |
| 2317230 |  214 | `	while(zSrc < zEnd && SyisSpace(zSrc[0])){` |
|      24 |  215 | `		zSrc++;` |
|       2 |  216 | `	}` |
| 2317208 |  217 | `	if( zRest ){` |
|     ! 0 |  218 | `		*zRest = (char *)zSrc;` |
|     ! 0 |  219 | `	}` |
| 2317208 |  220 | `	if( pOutVal ){` |
| 2317208 |  221 | `		if( isNeg ){` |
...
|      18 |  225 | `		}else{` |
| 2317178 |  226 | `			nVal = (sxi64)uVal;` |
|       - |  227 | `		}` |
| 2317208 |  228 | `		*(sxi64 *)pOutVal = nVal;` |
| 1158601 |  229 | `	}` |
| 2317208 |  230 | `	return (zSrc >= zEnd) ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  231 | `}` |
|  323248 |  232 | `PH7_PRIVATE sxi32 SyHexToint(sxi32 c)` |
|       5 |  233 | `{` |
|  323253 |  234 | `	switch(c){` |
|  132107 |  235 | `	case '0': return 0;` |
|   11703 |  236 | `	case '1': return 1;` |
|   77581 |  237 | `	case '2': return 2;` |
|    7831 |  238 | `	case '3': return 3;` |
|    3925 |  239 | `	case '4': return 4;` |
|   11655 |  240 | `	case '5': return 5;` |
|    7789 |  241 | `	case '6': return 6;` |
|    3903 |  242 | `	case '7': return 7;` |
|   19457 |  243 | `	case '8': return 8;` |
|   11721 |  244 | `	case '9': return 9;` |
|   11725 |  245 | `	case 'A': case 'a': return 10;` |
|    3913 |  246 | `	case 'B': case 'b': return 11;` |
|    3997 |  247 | `	case 'C': case 'c': return 12;` |
|    3907 |  248 | `	case 'D': case 'd': return 13;` |
|    3973 |  249 | `	case 'E': case 'e': return 14;` |
|    8139 |  250 | `	case 'F': case 'f': return 15;` |
|       - |  251 | `	}` |
|       3 |  252 | `	return -1;` |
|  161629 |  253 | `}` |
|  104736 |  254 | `PH7_PRIVATE sxi32 SyHexStrToInt64(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  255 | `{` |
|       - |  256 | `	const char *zIn,*zEnd;` |
|  104741 |  257 | `	int isNeg = FALSE;` |
|  104741 |  258 | `	sxi64 nVal = 0;` |
...
|       - |  265 | `	}` |
|       - |  266 | `#endif` |
|  104741 |  267 | `	zEnd = &zSrc[nLen];` |
|  104741 |  268 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|     ! 0 |  269 | `		zSrc++;` |
|     ! 0 |  270 | `	}` |
|  104741 |  271 | `	if( zSrc < zEnd && ( *zSrc == '-' \|\| *zSrc == '+' ) ){` |
|     ! 0 |  272 | `		isNeg = (zSrc[0] == '-') ? TRUE :FALSE;` |
|     ! 0 |  273 | `		zSrc++;` |
|     ! 0 |  274 | `	}` |
|  104741 |  275 | `	if( zSrc < &zEnd[-2] && zSrc[0] == '0' && (zSrc[1] == 'x' \|\| zSrc[1] == 'X') ){` |
|       - |  276 | `		/* Bypass hex prefix */` |
|  104741 |  277 | `		zSrc += sizeof(char) * 2;` |
|   52368 |  278 | `	}` |
|       - |  279 | `	/* Skip leading zero */` |
|  131881 |  280 | `	while(zSrc < zEnd && zSrc[0] == '0' ){` |
|   27145 |  281 | `		zSrc++;` |
|       5 |  282 | `	}` |
|  104741 |  283 | `	zIn = zSrc;` |
|   87293 |  284 | `	for(;;){` |
|  174591 |  285 | `		if(zSrc >= zEnd \|\| !SyisHex(zSrc[0]) \|\| (int)(zSrc-zIn) > 15){` |
|   36854 |  286 | `			break;` |
|       - |  287 | `		}` |
|  100893 |  288 | `		nVal = nVal * 16 + SyHexToint(zSrc[0]);` |
|  100893 |  289 | `		zSrc++;` |
|  100893 |  290 | `		if(zSrc >= zEnd \|\| !SyisHex(zSrc[0]) \|\| (int)(zSrc-zIn) > 15){` |
|    9700 |  291 | `			break;` |
|       - |  292 | `		}` |
|   81503 |  293 | `		nVal = nVal * 16 + SyHexToint(zSrc[0]);` |
|   81503 |  294 | `		zSrc++;` |
|   81503 |  295 | `		if(zSrc >= zEnd \|\| !SyisHex(zSrc[0]) \|\| (int)(zSrc-zIn) > 15){` |
|    5829 |  296 | `			break;` |
|       - |  297 | `		}` |
|   69855 |  298 | `		nVal = nVal * 16 + SyHexToint(zSrc[0]);` |
|   69855 |  299 | `		zSrc++;` |
|   69855 |  300 | `		if(zSrc >= zEnd \|\| !SyisHex(zSrc[0]) \|\| (int)(zSrc-zIn) > 15){` |
|     ! 0 |  301 | `			break;` |
|       - |  302 | `		}` |
|   69855 |  303 | `		nVal = nVal * 16 + SyHexToint(zSrc[0]);` |
|   69855 |  304 | `		zSrc++;` |
|       5 |  305 | `	}` |
|  104741 |  306 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|     ! 0 |  307 | `		zSrc++;` |
|     ! 0 |  308 | `	}` |
|  104741 |  309 | `	if( zRest ){` |
|     ! 0 |  310 | `		*zRest = zSrc;` |
|     ! 0 |  311 | `	}` |
|  104741 |  312 | `	if( pOutVal ){` |
|  104741 |  313 | `		if( isNeg == TRUE && nVal != 0 ){` |
|     ! 0 |  314 | `			nVal = -nVal;` |
|     ! 0 |  315 | `		}` |
|  104741 |  316 | `		*(sxi64 *)pOutVal = nVal;` |
|   52368 |  317 | `	}` |
|  104741 |  318 | `	return zSrc >= zEnd ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  319 | `}` |
|    3960 |  320 | `PH7_PRIVATE sxi32 SyOctalStrToInt64(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  321 | `{` |
|       - |  322 | `	const char *zIn,*zEnd;` |
|    3965 |  323 | `	int isNeg = FALSE;` |
|    3965 |  324 | `	sxi64 nVal = 0;` |
|       - |  325 | `	int c;` |
...
|       - |  332 | `	}` |
|       - |  333 | `#endif` |
|    3965 |  334 | `	zEnd = &zSrc[nLen];` |
|    3965 |  335 | `	while(zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|     ! 0 |  336 | `		zSrc++;` |
|     ! 0 |  337 | `	}` |
|    3965 |  338 | `	if( zSrc < zEnd && ( zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
|     ! 0 |  339 | `		isNeg = (zSrc[0] == '-') ? TRUE :FALSE;` |
|     ! 0 |  340 | `		zSrc++;` |
|     ! 0 |  341 | `	}` |
|       - |  342 | `	/* Skip leading zero */` |
|    7915 |  343 | `	while(zSrc < zEnd && zSrc[0] == '0' ){` |
|    3955 |  344 | `		zSrc++;` |
|       5 |  345 | `	}` |
|    3965 |  346 | `	zIn = zSrc;` |
|    1990 |  347 | `	for(;;){` |
|    3985 |  348 | `		if(zSrc >= zEnd \|\| !SyisDigit(zSrc[0])){ break; } if( (c=zSrc[0]-'0') > 7 \|\| (int)(zSrc-zIn) > 20){ break;} nVal = nVal * 8 +  c; zSrc++;` |
|    3983 |  349 | `		if(zSrc >= zEnd \|\| !SyisDigit(zSrc[0])){ break; } if( (c=zSrc[0]-'0') > 7 \|\| (int)(zSrc-zIn) > 20){ break;} nVal = nVal * 8 +  c; zSrc++;` |
|    3973 |  350 | `		if(zSrc >= zEnd \|\| !SyisDigit(zSrc[0])){ break; } if( (c=zSrc[0]-'0') > 7 \|\| (int)(zSrc-zIn) > 20){ break;} nVal = nVal * 8 +  c; zSrc++;` |
|    3951 |  351 | `		if(zSrc >= zEnd \|\| !SyisDigit(zSrc[0])){ break; } if( (c=zSrc[0]-'0') > 7 \|\| (int)(zSrc-zIn) > 20){ break;} nVal = nVal * 8 +  c; zSrc++;` |
|       1 |  352 | `	}` |
|       - |  353 | `	/* Skip trailing spaces */` |
|    3965 |  354 | `	while(zSrc < zEnd && SyisSpace(zSrc[0])){` |
|     ! 0 |  355 | `		zSrc++;` |
|     ! 0 |  356 | `	}` |
|    3965 |  357 | `	if( zRest ){` |
|     ! 0 |  358 | `		*zRest = zSrc;` |
|     ! 0 |  359 | `	}` |
|    3965 |  360 | `	if( pOutVal ){` |
|    3965 |  361 | `		if( isNeg == TRUE && nVal != 0 ){` |
|     ! 0 |  362 | `			nVal = -nVal;` |
|     ! 0 |  363 | `		}` |
|    3965 |  364 | `		*(sxi64 *)pOutVal = nVal;` |
|    1980 |  365 | `	}` |
|    3965 |  366 | `	return (zSrc >= zEnd) ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  367 | `}` |
...
|       1 |  419 | `}` |
|    8826 |  420 | `PH7_PRIVATE sxi32 SyStrToReal(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|       5 |  421 | `{` |
...
|       - |  434 | `	char zBuf[512];` |
|    8831 |  435 | `	const char *zEnd = &zSrc[nLen];` |
|       - |  436 | `	const char *zNum;` |
|    8831 |  437 | `	const char *zExpStart = 0;` |
|    8831 |  438 | `	sxreal Val = 0.0;` |
|    8831 |  439 | `	sxu32 nCopy = 0;` |
|    8831 |  440 | `	int bDigit = 0;` |
|       - |  441 | `#ifdef UNTRUST` |
...
|    8835 |  450 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|       5 |  451 | `		zSrc++;` |
|       1 |  452 | `	}` |
|    8831 |  453 | `	zNum = zSrc;` |
|       - |  454 | `	/* Sign (if exists) */` |
|    8831 |  455 | `	if( zSrc < zEnd && (zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
|      14 |  456 | `		zSrc++;` |
|       6 |  457 | `	}` |
|       - |  458 | `	/* Integer part */` |
|   18695 |  459 | `	while( zSrc < zEnd && SyisDigit(zSrc[0]) ){` |
|    9869 |  460 | `		bDigit = 1;` |
|    9869 |  461 | `		zSrc++;` |
|       5 |  462 | `	}` |
|       - |  463 | `	/* Fractional part */` |
|    8831 |  464 | `	if( zSrc < zEnd && ( zSrc[0] == '.' \|\| zSrc[0] == ',' ) ){` |
|    8679 |  465 | `		zSrc++;` |
|   19935 |  466 | `		while( zSrc < zEnd && SyisDigit(zSrc[0]) ){` |
|   11261 |  467 | `			bDigit = 1;` |
|   11261 |  468 | `			zSrc++;` |
|       5 |  469 | `		}` |
|    4337 |  470 | `	}` |
...
|    8831 |  473 | `	if( bDigit && zSrc < zEnd && ( zSrc[0] == 'e' \|\| zSrc[0] == 'E' ) ){` |
...
|      93 |  485 | `	}` |
|    8831 |  486 | `	if( bDigit ){` |
|    8831 |  487 | `		sxu32 i, nSpan = (sxu32)((zExpStart ? zExpStart : zSrc) - zNum);` |
|    8831 |  488 | `		sxu32 nExp = zExpStart ? (sxu32)(zSrc - zExpStart) : 0;` |
|    8831 |  489 | `		char *zDup = zBuf;` |
|    8831 |  490 | `		sxu32 nDup = sizeof(zBuf);` |
|    8831 |  491 | `		if( nSpan + nExp >= sizeof(zBuf) ){` |
...
|       1 |  497 | `		}` |
|       - |  498 | `		{` |
|    8831 |  499 | `			sxu32 nMantMax = nDup - 1 - (nExp < nDup - 1 ? nExp : 0);` |
|   38637 |  500 | `			for( i = 0 ; i < nSpan && nCopy < nMantMax ; i++ ){` |
|   29811 |  501 | `				zDup[nCopy++] = (zNum[i] == ',') ? '.' : zNum[i];` |
|   14908 |  502 | `			}` |
|       - |  503 | `			/* The exponent rides behind even a truncated mantissa: dropping` |
|       - |  504 | `			 * it would collapse "0.<hundreds of zeros>1e300" to 0.0. */` |
|    9467 |  505 | `			for( i = 0 ; i < nExp && nCopy < nDup - 1 ; i++ ){` |
|     639 |  506 | `				zDup[nCopy++] = zExpStart[i];` |
|     321 |  507 | `			}` |
|       - |  508 | `		}` |
|    8831 |  509 | `		zDup[nCopy] = 0;` |
|    8831 |  510 | `		Val = (sxreal)strtod(zDup,0);` |
|    8831 |  511 | `		if( zDup != zBuf ){` |
|       3 |  512 | `			free(zDup);` |
|       1 |  513 | `		}` |
|    4413 |  514 | `	}` |
|       - |  515 | `	/* Jump trailing spaces */` |
|    8831 |  516 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|     ! 0 |  517 | `		zSrc++;` |
|     ! 0 |  518 | `	}` |
|    8831 |  519 | `	if( zRest ){` |
|     ! 0 |  520 | `		*zRest = zSrc;` |
|     ! 0 |  521 | `	}` |
|    8831 |  522 | `	if( pOutVal ){` |
|    8831 |  523 | `		*(sxreal *)pOutVal = Val;` |
|    4413 |  524 | `	}` |
|    8831 |  525 | `	return zSrc >= zEnd ? SXRET_OK : SXERR_SYNTAX;` |
|       5 |  526 | `}` |
|       - |  527 |  |
