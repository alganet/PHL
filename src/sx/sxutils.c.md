...
|     - |    9 | `#include "sxstr.h"` |
|     - |   10 |  |
|  1312 |   11 | `PH7_PRIVATE sxi32 SyStrIsNumeric(const char *zSrc,sxu32 nLen,sxu8 *pReal,const char  **pzTail)` |
|     1 |   12 |  |
...
|     - |   17 | `	}` |
|     - |   18 | `#endif` |
|  1313 |   19 | `	zEnd = &zSrc[nLen];` |
|     - |   20 | `	/* Jump leading white spaces */` |
|  1317 |   21 | `	while( zSrc < zEnd && (unsigned char)zSrc[0] < 0xc0  && SyisSpace(zSrc[0]) ){` |
|     5 |   22 | `		zSrc++;` |
|     1 |   23 | `	}` |
|  1313 |   24 | `	if( zSrc < zEnd && (zSrc[0] == '+' \|\| zSrc[0] == '-') ){` |
|     3 |   25 | `		zSrc++;` |
|     1 |   26 | `	}` |
|  1313 |   27 | `	zCur = zSrc;` |
|  1313 |   28 | `	if( pReal ){` |
...
|    16 |   30 | `	}` |
|   656 |   31 | `	for(;;){` |
|  1313 |   32 | `		if( zSrc >= zEnd \|\| (unsigned char)zSrc[0] >= 0xc0 \|\| !SyisDigit(zSrc[0]) ){` |
|   635 |   33 | `			break;` |
|     - |   34 | `		}` |
|    45 |   35 | `		zSrc++;` |
...
|   ! 0 |   47 | `		zSrc++;` |
|   ! 0 |   48 | `	};` |
|  1313 |   49 | `	if( zSrc < zEnd && zSrc > zCur ){` |
|     7 |   50 | `		int c = zSrc[0];` |
|     7 |   51 | `		if( c == '.' ){` |
|     5 |   52 | `			zSrc++;` |
|     5 |   53 | `			if( pReal ){` |
...
|   ! 0 |   87 | `		*pzTail = zSrc;` |
|   ! 0 |   88 | `	}` |
|  1313 |   89 | `	return zSrc > zCur ? SXRET_OK /* String prefix is numeric */ : SXERR_INVALID /* Not a digit stream */;` |
|     1 |   90 |  |
...
|     1 |  167 |  |
| 99755 |  168 | `PH7_PRIVATE sxi32 SyStrToInt64(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|     1 |  169 |  |
| 99756 |  170 | `	int isNeg = FALSE;` |
|     - |  171 | `	const char *zEnd;` |
|     - |  172 | `	sxi64 nVal;` |
|     - |  173 | `	sxi16 i;` |
...
|     - |  180 | `	}` |
|     - |  181 | `#endif` |
| 99756 |  182 | `	zEnd = &zSrc[nLen];` |
| 99756 |  183 | `	while(zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|   ! 0 |  184 | `		zSrc++;` |
|   ! 0 |  185 | `	}` |
| 99756 |  186 | `	if( zSrc < zEnd && ( zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
|   ! 0 |  187 | `		isNeg = (zSrc[0] == '-') ? TRUE :FALSE;` |
|   ! 0 |  188 | `		zSrc++;` |
|   ! 0 |  189 | `	}` |
|     - |  190 | `	/* Skip leading zero */` |
| 99756 |  191 | `	while(zSrc < zEnd && zSrc[0] == '0' ){` |
|   ! 0 |  192 | `		zSrc++;` |
|   ! 0 |  193 | `	}` |
| 99756 |  194 | `	i = 19;` |
| 99756 |  195 | `	if( (sxu32)(zEnd-zSrc) >= 19 ){` |
|     5 |  196 | `		i = SyMemcmp(zSrc,isNeg ? SXINT64_MIN_STR : SXINT64_MAX_STR,19) <= 0 ? 19 : 18 ;` |
|     2 |  197 | `	}` |
| 99756 |  198 | `	nVal = 0;` |
| 49987 |  199 | `	for(;;){` |
| 99976 |  200 | `		if(zSrc >= zEnd \|\| !i \|\| !SyisDigit(zSrc[0])){ break; } nVal = nVal * 10 + ( zSrc[0] - '0' ) ; --i ; zSrc++;` |
| 99902 |  201 | `		if(zSrc >= zEnd \|\| !i \|\| !SyisDigit(zSrc[0])){ break; } nVal = nVal * 10 + ( zSrc[0] - '0' ) ; --i ; zSrc++;` |
| 12110 |  202 | `		if(zSrc >= zEnd \|\| !i \|\| !SyisDigit(zSrc[0])){ break; } nVal = nVal * 10 + ( zSrc[0] - '0' ) ; --i ; zSrc++;` |
|   653 |  203 | `		if(zSrc >= zEnd \|\| !i \|\| !SyisDigit(zSrc[0])){ break; } nVal = nVal * 10 + ( zSrc[0] - '0' ) ; --i ; zSrc++;` |
|     1 |  204 | `	}` |
|     - |  205 | `	/* Skip trailing spaces */` |
| 99756 |  206 | `	while(zSrc < zEnd && SyisSpace(zSrc[0])){` |
|   ! 0 |  207 | `		zSrc++;` |
|   ! 0 |  208 | `	}` |
| 99756 |  209 | `	if( zRest ){` |
|   ! 0 |  210 | `		*zRest = (char *)zSrc;` |
|   ! 0 |  211 | `	}` |
| 99756 |  212 | `	if( pOutVal ){` |
| 99756 |  213 | `		if( isNeg == TRUE && nVal != 0 ){` |
|   ! 0 |  214 | `			nVal = -nVal;` |
|   ! 0 |  215 | `		}` |
| 99756 |  216 | `		*(sxi64 *)pOutVal = nVal;` |
| 49877 |  217 | `	}` |
| 99756 |  218 | `	return (zSrc >= zEnd) ? SXRET_OK : SXERR_SYNTAX;` |
|     1 |  219 |  |
...
|    33 |  508 | `				break;` |
|     - |  509 | `			}` |
|   409 |  510 | `			Val = Val * 10.0 + (zSrc[0] - '0');` |
|   409 |  511 | `			dec *= 10.0;` |
|   409 |  512 | `			zSrc++;` |
|   409 |  513 | `			--Lim;` |
|   409 |  514 | `			if(zSrc >= zEnd \|\| !Lim \|\| !SyisDigit(zSrc[0])){` |
|    77 |  515 | `				break;` |
|     - |  516 | `			}` |
|   257 |  517 | `			Val = Val * 10.0 + (zSrc[0] - '0');` |
|   257 |  518 | `			dec *= 10.0;` |
|   257 |  519 | `			zSrc++;` |
|   257 |  520 | `			--Lim;` |
|   257 |  521 | `			if(zSrc >= zEnd \|\| !Lim \|\| !SyisDigit(zSrc[0])){` |
|    31 |  522 | `				break;` |
|     - |  523 | `			}` |
|   197 |  524 | `			Val = Val * 10.0 + (zSrc[0] - '0');` |
|   197 |  525 | `			dec *= 10.0;` |
|   197 |  526 | `			zSrc++;` |
|   197 |  527 | `			--Lim;` |
|   197 |  528 | `			if(zSrc >= zEnd \|\| !Lim \|\| !SyisDigit(zSrc[0])){` |
|    18 |  529 | `				break;` |
|     - |  530 | `			}` |
