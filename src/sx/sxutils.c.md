...
|      - |    9 | `#include "sxstr.h"` |
|      - |   10 |  |
| 454732 |   11 | `PH7_PRIVATE sxi32 SyStrIsNumeric(const char *zSrc,sxu32 nLen,sxu8 *pReal,const char  **pzTail)` |
|      5 |   12 | `{` |
...
|      - |   17 | `	}` |
|      - |   18 | `#endif` |
| 454737 |   19 | `	zEnd = &zSrc[nLen];` |
|      - |   20 | `	/* Jump leading white spaces */` |
| 454753 |   21 | `	while( zSrc < zEnd && (unsigned char)zSrc[0] < 0xc0  && SyisSpace(zSrc[0]) ){` |
|     17 |   22 | `		zSrc++;` |
|      1 |   23 | `	}` |
| 454737 |   24 | `	if( zSrc < zEnd && (zSrc[0] == '+' \|\| zSrc[0] == '-') ){` |
|     89 |   25 | `		zSrc++;` |
|     42 |   26 | `	}` |
| 454737 |   27 | `	zCur = zSrc;` |
| 454737 |   28 | `	if( pReal ){` |
...
|    111 |   30 | `	}` |
| 227398 |   31 | `	for(;;){` |
| 454737 |   32 | `		if( zSrc >= zEnd \|\| (unsigned char)zSrc[0] >= 0xc0 \|\| !SyisDigit(zSrc[0]) ){` |
| 227311 |   33 | `			break;` |
|      - |   34 | `		}` |
|    185 |   35 | `		zSrc++;` |
...
|    ! 0 |   47 | `		zSrc++;` |
|    ! 0 |   48 | `	};` |
| 454737 |   49 | `	if( zSrc < zEnd && zSrc > zCur ){` |
|     53 |   50 | `		int c = zSrc[0];` |
|     53 |   51 | `		if( c == '.' ){` |
|     37 |   52 | `			zSrc++;` |
|     37 |   53 | `			if( pReal ){` |
...
|     84 |   87 | `		*pzTail = zSrc;` |
|     41 |   88 | `	}` |
| 454737 |   89 | `	return zSrc > zCur ? SXRET_OK /* String prefix is numeric */ : SXERR_INVALID /* Not a digit stream */;` |
|      5 |   90 | `}` |
...
|      1 |  167 | `}` |
|  79022 |  168 | `PH7_PRIVATE sxi32 SyStrToInt64(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|      5 |  169 | `{` |
|  79027 |  170 | `	int isNeg = FALSE;` |
|      - |  171 | `	const char *zEnd;` |
|      - |  172 | `	sxi64 nVal;` |
|      - |  173 | `	sxi16 i;` |
...
|      - |  180 | `	}` |
|      - |  181 | `#endif` |
|  79027 |  182 | `	zEnd = &zSrc[nLen];` |
|  79039 |  183 | `	while(zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|     14 |  184 | `		zSrc++;` |
|      2 |  185 | `	}` |
|  79027 |  186 | `	if( zSrc < zEnd && ( zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
|      3 |  187 | `		isNeg = (zSrc[0] == '-') ? TRUE :FALSE;` |
|      3 |  188 | `		zSrc++;` |
|      1 |  189 | `	}` |
|      - |  190 | `	/* Skip leading zero */` |
|  79027 |  191 | `	while(zSrc < zEnd && zSrc[0] == '0' ){` |
|    ! 0 |  192 | `		zSrc++;` |
|    ! 0 |  193 | `	}` |
|  79027 |  194 | `	i = 19;` |
|  79027 |  195 | `	if( (sxu32)(zEnd-zSrc) >= 19 ){` |
|     11 |  196 | `		i = SyMemcmp(zSrc,isNeg ? SXINT64_MIN_STR : SXINT64_MAX_STR,19) <= 0 ? 19 : 18 ;` |
|      5 |  197 | `	}` |
|  79027 |  198 | `	nVal = 0;` |
|  39754 |  199 | `	for(;;){` |
|  79513 |  200 | `		if(zSrc >= zEnd \|\| !i \|\| !SyisDigit(zSrc[0])){ break; } nVal = nVal * 10 + ( zSrc[0] - '0' ) ; --i ; zSrc++;` |
|  79319 |  201 | `		if(zSrc >= zEnd \|\| !i \|\| !SyisDigit(zSrc[0])){ break; } nVal = nVal * 10 + ( zSrc[0] - '0' ) ; --i ; zSrc++;` |
|  10589 |  202 | `		if(zSrc >= zEnd \|\| !i \|\| !SyisDigit(zSrc[0])){ break; } nVal = nVal * 10 + ( zSrc[0] - '0' ) ; --i ; zSrc++;` |
|   1097 |  203 | `		if(zSrc >= zEnd \|\| !i \|\| !SyisDigit(zSrc[0])){ break; } nVal = nVal * 10 + ( zSrc[0] - '0' ) ; --i ; zSrc++;` |
|      2 |  204 | `	}` |
|      - |  205 | `	/* Skip trailing spaces */` |
|  79039 |  206 | `	while(zSrc < zEnd && SyisSpace(zSrc[0])){` |
|     14 |  207 | `		zSrc++;` |
|      2 |  208 | `	}` |
|  79027 |  209 | `	if( zRest ){` |
|    ! 0 |  210 | `		*zRest = (char *)zSrc;` |
|    ! 0 |  211 | `	}` |
|  79027 |  212 | `	if( pOutVal ){` |
|  79027 |  213 | `		if( isNeg == TRUE && nVal != 0 ){` |
|      3 |  214 | `			nVal = -nVal;` |
|      1 |  215 | `		}` |
|  79027 |  216 | `		*(sxi64 *)pOutVal = nVal;` |
|  39511 |  217 | `	}` |
|  79027 |  218 | `	return (zSrc >= zEnd) ? SXRET_OK : SXERR_SYNTAX;` |
|      5 |  219 | `}` |
...
|      1 |  307 | `}` |
|     60 |  308 | `PH7_PRIVATE sxi32 SyOctalStrToInt64(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|      1 |  309 | `{` |
|      - |  310 | `	const char *zIn,*zEnd;` |
|     61 |  311 | `	int isNeg = FALSE;` |
|     61 |  312 | `	sxi64 nVal = 0;` |
|      - |  313 | `	int c;` |
...
|      - |  320 | `	}` |
|      - |  321 | `#endif` |
|     61 |  322 | `	zEnd = &zSrc[nLen];` |
|     61 |  323 | `	while(zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|    ! 0 |  324 | `		zSrc++;` |
|    ! 0 |  325 | `	}` |
|     61 |  326 | `	if( zSrc < zEnd && ( zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
|    ! 0 |  327 | `		isNeg = (zSrc[0] == '-') ? TRUE :FALSE;` |
|    ! 0 |  328 | `		zSrc++;` |
|    ! 0 |  329 | `	}` |
|      - |  330 | `	/* Skip leading zero */` |
|    121 |  331 | `	while(zSrc < zEnd && zSrc[0] == '0' ){` |
|     61 |  332 | `		zSrc++;` |
|      1 |  333 | `	}` |
|     61 |  334 | `	zIn = zSrc;` |
|     30 |  335 | `	for(;;){` |
|     61 |  336 | `		if(zSrc >= zEnd \|\| !SyisDigit(zSrc[0])){ break; } if( (c=zSrc[0]-'0') > 7 \|\| (int)(zSrc-zIn) > 20){ break;} nVal = nVal * 8 +  c; zSrc++;` |
...
|     61 |  342 | `	while(zSrc < zEnd && SyisSpace(zSrc[0])){` |
|    ! 0 |  343 | `		zSrc++;` |
|    ! 0 |  344 | `	}` |
|     61 |  345 | `	if( zRest ){` |
|    ! 0 |  346 | `		*zRest = zSrc;` |
|    ! 0 |  347 | `	}` |
|     61 |  348 | `	if( pOutVal ){` |
|     61 |  349 | `		if( isNeg == TRUE && nVal != 0 ){` |
|    ! 0 |  350 | `			nVal = -nVal;` |
|    ! 0 |  351 | `		}` |
|     61 |  352 | `		*(sxi64 *)pOutVal = nVal;` |
|     30 |  353 | `	}` |
|     61 |  354 | `	return (zSrc >= zEnd) ? SXRET_OK : SXERR_SYNTAX;` |
|      1 |  355 | `}` |
...
|      1 |  407 | `}` |
|    812 |  408 | `PH7_PRIVATE sxi32 SyStrToReal(const char *zSrc,sxu32 nLen,void * pOutVal,const char **zRest)` |
|      4 |  409 | `{` |
...
|      - |  422 | `	1.0e256` |
|      - |  423 | `	};` |
|    816 |  424 | `	sxu8 neg = FALSE;` |
|    816 |  425 | `	sxreal Val = 0.0;` |
|      - |  426 | `	const char *zEnd;` |
|      - |  427 | `	sxi32 Lim,exp;` |
|    816 |  428 | `	sxreal *p = 0;` |
|      - |  429 | `#ifdef UNTRUST` |
...
|    816 |  438 | `	zEnd = &zSrc[nLen];` |
|    816 |  439 | `	Lim = SXDBL_DIG;` |
|      - |  440 | `	/* Skip leading spaces */` |
|    820 |  441 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ) zSrc++;` |
|      - |  442 |  |
|      - |  443 | `	/* Sign (if exists) */` |
|    816 |  444 | `	if( zSrc < zEnd && (zSrc[0] == '-' \|\| zSrc[0] == '+' ) ){` |
...
|      - |  449 | `	/* Integer part */` |
|    426 |  450 | `	for(;;){` |
|    856 |  451 | `		if(zSrc >= zEnd \|\| !Lim \|\| !SyisDigit(zSrc[0])){` |
|     20 |  452 | `			break;` |
|      - |  453 | `		}` |
|    820 |  454 | `		Val = Val * 10.0 + (zSrc[0] - '0');` |
|    820 |  455 | `		zSrc++;` |
|    820 |  456 | `		--Lim;` |
|    820 |  457 | `		if(zSrc >= zEnd \|\| !Lim \|\| !SyisDigit(zSrc[0])){` |
|    380 |  458 | `			break;` |
|      - |  459 | `		}` |
...
|     41 |  474 | `		--Lim;` |
|      1 |  475 | `	}` |
|    816 |  476 | `	Lim = SXDBL_DIG ;` |
|    406 |  477 | `	for(;;){` |
|    816 |  478 | `		if(zSrc >= zEnd \|\| !Lim \|\| !SyisDigit(zSrc[0])){` |
|    410 |  479 | `			break;` |
|      - |  480 | `		}` |
...
|    ! 0 |  501 | `		--Lim;` |
|    ! 0 |  502 | `	}` |
|    816 |  503 | `	if( zSrc < zEnd && ( zSrc[0] == '.' \|\| zSrc[0] == ',' ) ){` |
|    740 |  504 | `		sxreal dec = 1.0;` |
|    740 |  505 | `		zSrc++;` |
|    464 |  506 | `		for(;;){` |
|    932 |  507 | `			if(zSrc >= zEnd \|\| !Lim \|\| !SyisDigit(zSrc[0])){` |
|     31 |  508 | `				break;` |
|      - |  509 | `			}` |
|    874 |  510 | `			Val = Val * 10.0 + (zSrc[0] - '0');` |
|    874 |  511 | `			dec *= 10.0;` |
|    874 |  512 | `			zSrc++;` |
|    874 |  513 | `			--Lim;` |
|    874 |  514 | `			if(zSrc >= zEnd \|\| !Lim \|\| !SyisDigit(zSrc[0])){` |
|    244 |  515 | `				break;` |
|      - |  516 | `			}` |
...
|     14 |  549 | `	}` |
|    816 |  550 | `	neg = FALSE;` |
|    816 |  551 | `	if( zSrc < zEnd && ( zSrc[0] == 'e' \|\| zSrc[0] == 'E' ) ){` |
|    110 |  552 | `		zSrc++;` |
|    110 |  553 | `		if( zSrc < zEnd && ( zSrc[0] == '-' \|\| zSrc[0] == '+') ){` |
|     35 |  554 | `			neg = zSrc[0] == '-' ? TRUE : FALSE ;` |
|     35 |  555 | `			zSrc++;` |
|     17 |  556 | `		}` |
|    110 |  557 | `		exp = 0;` |
|    298 |  558 | `		while( zSrc < zEnd && SyisDigit(zSrc[0]) && exp < SXDBL_MAX_EXP ){` |
|    190 |  559 | `			exp = exp * 10 + (zSrc[0] - '0');` |
|    190 |  560 | `			zSrc++;` |
|      2 |  561 | `		}` |
|    110 |  562 | `		if( neg  ){` |
|     29 |  563 | `			if( exp > SXDBL_MIN_EXP_PLUS ) exp = SXDBL_MIN_EXP_PLUS ;` |
|     95 |  564 | `		}else if ( exp > SXDBL_MAX_EXP ){` |
|      3 |  565 | `			exp = SXDBL_MAX_EXP;` |
|      1 |  566 | `		}` |
|    580 |  567 | `		for( p = (sxreal *)aTab ; exp ; exp >>= 1 , p++ ){` |
|    472 |  568 | `			if( exp & 01 ){` |
|    252 |  569 | `				if( neg ){` |
|     67 |  570 | `					Val /= *p ;` |
|     34 |  571 | `				}else{` |
...
|    237 |  575 | `		}` |
|     54 |  576 | `	}` |
|    816 |  577 | `	while( zSrc < zEnd && SyisSpace(zSrc[0]) ){` |
|    ! 0 |  578 | `		zSrc++;` |
|    ! 0 |  579 | `	}` |
|    816 |  580 | `	if( zRest ){` |
|    ! 0 |  581 | `		*zRest = zSrc;` |
|    ! 0 |  582 | `	}` |
|    816 |  583 | `	if( pOutVal ){` |
|    816 |  584 | `		*(sxreal *)pOutVal = Val;` |
|    406 |  585 | `	}` |
|    816 |  586 | `	return zSrc >= zEnd ? SXRET_OK : SXERR_SYNTAX;` |
|      4 |  587 | `}` |
|      - |  588 |  |
