...
|        - |   90 | ` */` |
|  1462044 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|        5 |   92 | `{` |
|        - |   93 | `	/*` |
...
|  1462049 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|        - |  151 | `  int rc;` |
|        - |  152 |  |
|  1462049 |  153 | `  length = 0;` |
|  1462049 |  154 | `  bufpt = 0;` |
|  5723039 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
|  5654517 |  156 | `    if( c!='%' ){` |
|        - |  157 | `      unsigned int amt;` |
|  5565967 |  158 | `      bufpt = (char *)zFormat;` |
|  5565967 |  159 | `      amt = 1;` |
|  8477267 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
|  5565967 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
|  5565967 |  162 | `	  if( rc != SXRET_OK ){` |
|      ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  164 | `	  }` |
|  5565967 |  165 | `      if( c==0 ){` |
|  1393527 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|        - |  167 | `	  }` |
|  2086220 |  168 | `    }` |
|  4260995 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|      ! 0 |  170 | `      errorflag = 1;` |
...
|  4260995 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  4260990 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  2130495 |  180 | `    do{` |
|  4261249 |  181 | `      switch( c ){` |
...
|  4260990 |  187 | `        default:                                       break;` |
|        - |  188 | `      }` |
|  4261249 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|      ! 0 |  198 | `      c = *++zFormat;` |
|      ! 0 |  199 | `    }else{` |
|  4261315 |  200 | `      while( c>='0' && c<='9' ){` |
|      322 |  201 | `        width = width*10 + c - '0';` |
|      322 |  202 | `        c = *++zFormat;` |
|        2 |  203 | `      }` |
|        - |  204 | `    }` |
|  4260995 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|      ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|      ! 0 |  207 | `    }` |
|        - |  208 | `    /* Get the precision */` |
|  4260995 |  209 | `	precision = -1;` |
|  4260995 |  210 | `    if( c=='.' ){` |
|  1388985 |  211 | `      precision = 0;` |
|  1388985 |  212 | `      c = *++zFormat;` |
|  1388985 |  213 | `      if( c=='*' ){` |
|  1388985 |  214 | `        precision = va_arg(ap,int);` |
|  1388985 |  215 | `        if( precision<0 ) precision = -precision;` |
|  1388985 |  216 | `        c = *++zFormat;` |
|   694495 |  217 | `      }else{` |
|      ! 0 |  218 | `        while( c>='0' && c<='9' ){` |
...
|  4260995 |  225 | `	flag_long = 0;` |
|  4260995 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
|    57725 |  227 | `      flag_long = (c == 'q') ? 2 : 1;` |
|    57725 |  228 | `      c = *++zFormat;` |
|    57725 |  229 | `	  if( c == 'l' ){` |
...
|  4260995 |  235 | `    infop = 0;` |
|  4260995 |  236 | `    xtype = SXFMT_ERROR;` |
| 19673121 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 19673121 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  4260995 |  239 | `        infop = &aFmt[idx];` |
|  4260995 |  240 | `		xtype = infop->type;` |
|  4260995 |  241 | `        break;` |
|        - |  242 | `      }` |
|  7706068 |  243 | `    }` |
...
|        - |  263 | `    */` |
|  4260995 |  264 | `    switch( xtype ){` |
|    31169 |  265 | `      case SXFMT_RADIX:` |
|    62343 |  266 | `        if( flag_long > 0 ){` |
|    57725 |  267 | `			if( flag_long > 1 ){` |
|        - |  268 | `				/* BSD quad: expect a 64-bit integer */` |
|    57713 |  269 | `				longvalue = va_arg(ap,sxi64);` |
|    28859 |  270 | `			}else{` |
|       13 |  271 | `				longvalue = va_arg(ap,sxlong);` |
|        - |  272 | `			}` |
|    28865 |  273 | `		}else{` |
|     4623 |  274 | `			if( infop->flags & SXFLAG_SIGNED ){` |
|     2855 |  275 | `				longvalue = va_arg(ap,sxi32);` |
|     1430 |  276 | `			}else{` |
|     1773 |  277 | `				longvalue = va_arg(ap,sxu32);` |
|        - |  278 | `			}` |
|        - |  279 | `		}` |
|        - |  280 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|    62343 |  281 | `      if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|        - |  282 | `#if 1` |
|        - |  283 | `        /* For the format %#x, the value zero is printed "0" not "0x0".` |
|        - |  284 | `        ** I think this is stupid.*/` |
|    62343 |  285 | `        if( longvalue==0 ) flag_alternateform = 0;` |
|        - |  286 | `#else` |
...
|        - |  290 | `#endif` |
|    62343 |  291 | `        if( infop->flags & SXFLAG_SIGNED ){` |
|    60521 |  292 | `          if( longvalue<0 ){` |
...
|      167 |  297 | `            prefix = '-';` |
|       85 |  298 | `          }else{` |
|    60357 |  299 | `            ulongvalue = (sxu64)longvalue;` |
|    60357 |  300 | `            if( flag_plussign )        prefix = '+';` |
|    60355 |  301 | `            else if( flag_blanksign )  prefix = ' ';` |
|    60355 |  302 | `            else                       prefix = 0;` |
|        - |  303 | `          }` |
|    30263 |  304 | `        }else{` |
|     1827 |  305 | `			ulongvalue = (sxu64)longvalue; /* print the full unsigned value as-is */` |
|     1827 |  306 | `			prefix = 0;` |
|        - |  307 | `		}` |
|    62343 |  308 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|      240 |  309 | `          precision = width-(prefix!=0);` |
|      119 |  310 | `        }` |
|    62343 |  311 | `        bufpt = &buf[SXFMT_BUFSIZ-1];` |
|        - |  312 | `        {` |
|        - |  313 | `          register char *cset;      /* Use registers for speed */` |
|        - |  314 | `          register int base;` |
|    62343 |  315 | `          cset = infop->charset;` |
|    62343 |  316 | `          base = infop->base;` |
|    31169 |  317 | `          do{                                           /* Convert to ascii */` |
|   184623 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|   184623 |  319 | `            ulongvalue = ulongvalue/base;` |
|   184623 |  320 | `          }while( ulongvalue>0 );` |
|        - |  321 | `        }` |
|    62343 |  322 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    62743 |  323 | `        for(idx=precision-length; idx>0; idx--){` |
|      402 |  324 | `          *(--bufpt) = '0';                             /* Zero pad */` |
|      202 |  325 | `        }` |
|    62343 |  326 | `        if( prefix ) *(--bufpt) = prefix;               /* Add sign */` |
|    62343 |  327 | `        if( flag_alternateform && infop->prefix ){      /* Add "0" or "0x" */` |
|        - |  328 | `          char *pre, x;` |
...
|        1 |  332 | `          }` |
|        1 |  333 | `        }` |
|    62343 |  334 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    62343 |  335 | `        break;` |
...
|      ! 0 |  496 | `        length = 1;` |
|      ! 0 |  497 | `        break;` |
|     4923 |  498 | `      case SXFMT_CHARX:` |
|     9850 |  499 | `        c = va_arg(ap,int);` |
|     9850 |  500 | `		buf[0] = (char)c;` |
|        - |  501 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|     9850 |  502 | `		if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|     9850 |  503 | `        if( precision>=0 ){` |
...
|     9850 |  509 | `        bufpt = buf;` |
|     9850 |  510 | `        break;` |
|   695733 |  511 | `      case SXFMT_STRING:` |
|  1391471 |  512 | `        bufpt = va_arg(ap,char*);` |
|  1391471 |  513 | `        if( bufpt==0 ){` |
|      ! 0 |  514 | `          bufpt = " ";` |
|      ! 0 |  515 | `		  length = (int)sizeof(" ")-1;` |
|      ! 0 |  516 | `		  break;` |
|        - |  517 | `        }` |
|  1391471 |  518 | `		length = precision;` |
|  1391471 |  519 | `		if( precision < 0 ){` |
|        - |  520 | `			/* Symisc extension */` |
|     2491 |  521 | `			length = (int)SyStrlen(bufpt);` |
|     1243 |  522 | `		}` |
|  1391471 |  523 | `        if( precision>=0 && precision<length ) length = precision;` |
|  1391471 |  524 | `        break;` |
|  1398665 |  525 | `	case SXFMT_RAWSTR:{` |
|        - |  526 | `		/* Symisc extension */` |
|  2797335 |  527 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  2797335 |  528 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|      ! 0 |  529 | `			 bufpt = " ";` |
|      ! 0 |  530 | `		     length = (int)sizeof(char);` |
|      ! 0 |  531 | `		     break;` |
|        - |  532 | `		}` |
|  2797335 |  533 | `		bufpt = (char *)pStr->zString;` |
|  2797335 |  534 | `		length = (int)pStr->nByte;` |
|  2797335 |  535 | `		break;` |
|        - |  536 | `					  }` |
...
|        - |  547 | `    ** the output.` |
|        - |  548 | `    */` |
|  4260995 |  549 | `    if( !flag_leftjustify ){` |
|        - |  550 | `      register int nspace;` |
|  4260995 |  551 | `      nspace = width-length;` |
|  4260995 |  552 | `      if( nspace>0 ){` |
...
|       18 |  566 | `      }` |
|  2130495 |  567 | `    }` |
|  4260995 |  568 | `    if( length>0 ){` |
|  4260779 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  4260779 |  570 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  572 | `		}` |
|  2130387 |  573 | `    }` |
|  4260995 |  574 | `    if( flag_leftjustify ){` |
...
|      ! 0 |  591 | `      }` |
|      ! 0 |  592 | `    }` |
|  2130500 |  593 | `  }/* End for loop over the format string */` |
|    68527 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|   731027 |  595 | `}` |
|        - |  596 | `/* SPDX-SnippetEnd */` |
|  9826772 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|        5 |  598 | `{` |
|  9826777 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
|  9826777 |  600 | `	sxi32 rc = SXERR_ABORT;` |
|  9826777 |  601 | `	switch(pConsumer->nType){` |
...
|      157 |  605 | `			break;` |
|  4913308 |  606 | `	case SXFMT_CONS_BLOB:` |
|        - |  607 | `			/* Blob consumer */` |
|  9826621 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
|  9826616 |  609 | `			break;` |
|      ! 0 |  610 | `		default:` |
...
|  9826777 |  615 | `	pConsumer->nLen += nLen;` |
|  9826777 |  616 | `	pConsumer->rc = rc;` |
|  9826777 |  617 | `	return rc;` |
|        5 |  618 | `}` |
|  1462044 |  619 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|        5 |  620 | `{` |
|        - |  621 | `	SyFmtConsumer sCons;` |
|  1462049 |  622 | `	sCons.nType = nType;` |
|  1462049 |  623 | `	sCons.rc = SXRET_OK;` |
|  1462049 |  624 | `	sCons.nLen = 0;` |
|  1462049 |  625 | `	if( pOutLen ){` |
|    71971 |  626 | `		*pOutLen = 0;` |
|    35983 |  627 | `	}` |
|  1462049 |  628 | `	switch(nType){` |
...
|       13 |  637 | `		break;` |
|   731016 |  638 | `		case SXFMT_CONS_BLOB:` |
|  1462037 |  639 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  1462037 |  640 | `			break;` |
|      ! 0 |  641 | `		default:` |
|      ! 0 |  642 | `			return SXERR_UNKNOWN;` |
|        - |  643 | `	}` |
|  1462049 |  644 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  1462049 |  645 | `	if( pOutLen ){` |
|    71971 |  646 | `		*pOutLen = sCons.nLen;` |
|    35983 |  647 | `	}` |
|  1462049 |  648 | `	return sCons.rc;` |
|   731027 |  649 | `}` |
...
|       13 |  662 | `	return rc;` |
|        1 |  663 | `}` |
|    69602 |  664 | `PH7_PRIVATE sxu32 SyBlobFormat(SyBlob *pBlob,const char *zFormat,...)` |
|        5 |  665 | `{` |
|        - |  666 | `	va_list ap;` |
|        - |  667 | `	sxu32 n;` |
...
|        - |  671 | `	}` |
|        - |  672 | `#endif` |
|    69607 |  673 | `	va_start(ap,zFormat);` |
|    69607 |  674 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    69607 |  675 | `	va_end(ap);` |
|    69607 |  676 | `	return n;` |
|        5 |  677 | `}` |
...
|     2369 |  687 | `	return n;` |
|        5 |  688 | `}` |
|  1390066 |  689 | `PH7_PRIVATE sxu32 SyBufferFormat(char *zBuf,sxu32 nLen,const char *zFormat,...)` |
|        5 |  690 | `{` |
|        - |  691 | `	SyBlob sBlob;` |
|        - |  692 | `	va_list ap;` |
|        - |  693 | `	sxu32 n;` |
...
|        - |  697 | `	}` |
|        - |  698 | `#endif` |
|  1390071 |  699 | `	if( SXRET_OK != SyBlobInitFromBuf(&sBlob,zBuf,nLen - 1) ){` |
|      ! 0 |  700 | `		return 0;` |
|        - |  701 | `	}` |
|  1390071 |  702 | `	va_start(ap,zFormat);` |
|  1390071 |  703 | `	FormatMount(SXFMT_CONS_BLOB,&sBlob,0,0,0,zFormat,ap);` |
|  1390071 |  704 | `	va_end(ap);` |
|  1390071 |  705 | `	n = SyBlobLength(&sBlob);` |
|        - |  706 | `	/* Append the null terminator */` |
|  1390071 |  707 | `	sBlob.mByte++;` |
|  1390071 |  708 | `	SyBlobAppend(&sBlob,"\0",sizeof(char));` |
|  1390071 |  709 | `	return n;` |
|   695038 |  710 | `}` |
|        - |  711 |  |
