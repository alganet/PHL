...
|       - |   90 | ` */` |
|  325980 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|       5 |   92 |  |
|       - |   93 | `	/*` |
...
|  325985 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|  325985 |  153 | `  length = 0;` |
|  325985 |  154 | `  bufpt = 0;` |
| 1185885 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
| 1119873 |  156 | `    if( c!='%' ){` |
|       - |  157 | `      unsigned int amt;` |
| 1033799 |  158 | `      bufpt = (char *)zFormat;` |
| 1033799 |  159 | `      amt = 1;` |
| 1632727 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
| 1033799 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
| 1033799 |  162 | `	  if( rc != SXRET_OK ){` |
|     ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|       - |  164 | `	  }` |
| 1033799 |  165 | `      if( c==0 ){` |
|  259973 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|       - |  167 | `	  }` |
|  386913 |  168 | `    }` |
|  859905 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|     ! 0 |  170 | `      errorflag = 1;` |
...
|  859905 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  859900 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  429950 |  180 | `    do{` |
|  860023 |  181 | `      switch( c ){` |
...
|  859900 |  187 | `        default:                                       break;` |
|       - |  188 | `      }` |
|  860023 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|     ! 0 |  198 | `      c = *++zFormat;` |
|     ! 0 |  199 | `    }else{` |
|  860065 |  200 | `      while( c>='0' && c<='9' ){` |
|     162 |  201 | `        width = width*10 + c - '0';` |
|     162 |  202 | `        c = *++zFormat;` |
|       2 |  203 | `      }` |
|       - |  204 | `    }` |
|  859905 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|     ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|     ! 0 |  207 | `    }` |
|       - |  208 | `    /* Get the precision */` |
|  859905 |  209 | `	precision = -1;` |
|  859905 |  210 | `    if( c=='.' ){` |
|  257649 |  211 | `      precision = 0;` |
|  257649 |  212 | `      c = *++zFormat;` |
|  257649 |  213 | `      if( c=='*' ){` |
|  257353 |  214 | `        precision = va_arg(ap,int);` |
|  257353 |  215 | `        if( precision<0 ) precision = -precision;` |
|  257353 |  216 | `        c = *++zFormat;` |
|  128679 |  217 | `      }else{` |
...
|  859905 |  225 | `	flag_long = 0;` |
|  859905 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
...
|  859905 |  235 | `    infop = 0;` |
|  859905 |  236 | `    xtype = SXFMT_ERROR;` |
| 3820201 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 3820201 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  859905 |  239 | `        infop = &aFmt[idx];` |
|  859905 |  240 | `		xtype = infop->type;` |
|  859905 |  241 | `        break;` |
|       - |  242 | `      }` |
| 1480153 |  243 | `    }` |
...
|  174807 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|  174807 |  319 | `            ulongvalue = ulongvalue/base;` |
|  174807 |  320 | `          }while( ulongvalue>0 );` |
|       - |  321 | `        }` |
...
|   10037 |  509 | `        bufpt = buf;` |
|   10037 |  510 | `        break;` |
|  129286 |  511 | `      case SXFMT_STRING:` |
|  258577 |  512 | `        bufpt = va_arg(ap,char*);` |
|  258577 |  513 | `        if( bufpt==0 ){` |
|     ! 0 |  514 | `          bufpt = " ";` |
|     ! 0 |  515 | `		  length = (int)sizeof(" ")-1;` |
|     ! 0 |  516 | `		  break;` |
|       - |  517 | `        }` |
|  258577 |  518 | `		length = precision;` |
|  258577 |  519 | `		if( precision < 0 ){` |
|       - |  520 | `			/* Symisc extension */` |
|    1231 |  521 | `			length = (int)SyStrlen(bufpt);` |
|     613 |  522 | `		}` |
|  258577 |  523 | `        if( precision>=0 && precision<length ) length = precision;` |
|  258577 |  524 | `        break;` |
...
|       - |  547 | `    ** the output.` |
|       - |  548 | `    */` |
|  859905 |  549 | `    if( !flag_leftjustify ){` |
|       - |  550 | `      register int nspace;` |
|  859905 |  551 | `      nspace = width-length;` |
|  859905 |  552 | `      if( nspace>0 ){` |
...
|      18 |  566 | `      }` |
|  429950 |  567 | `    }` |
|  859905 |  568 | `    if( length>0 ){` |
|  859881 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  859881 |  570 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|       - |  572 | `		}` |
|  429938 |  573 | `    }` |
|  859905 |  574 | `    if( flag_leftjustify ){` |
...
|     ! 0 |  591 | `      }` |
|     ! 0 |  592 | `    }` |
|  429955 |  593 | `  }/* End for loop over the format string */` |
|   66017 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|  162995 |  595 |  |
|       - |  596 | `/* SPDX-SnippetEnd */` |
| 1893706 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|       5 |  598 |  |
| 1893711 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 1893711 |  600 | `	sxi32 rc = SXERR_ABORT;` |
| 1893711 |  601 | `	switch(pConsumer->nType){` |
...
|     157 |  605 | `			break;` |
|  946775 |  606 | `	case SXFMT_CONS_BLOB:` |
|       - |  607 | `			/* Blob consumer */` |
| 1893555 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 1893550 |  609 | `			break;` |
|     ! 0 |  610 | `		default:` |
...
| 1893711 |  615 | `	pConsumer->nLen += nLen;` |
| 1893711 |  616 | `	pConsumer->rc = rc;` |
| 1893711 |  617 | `	return rc;` |
|       5 |  618 |  |
|  325980 |  619 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|       5 |  620 |  |
|       - |  621 | `	SyFmtConsumer sCons;` |
|  325985 |  622 | `	sCons.nType = nType;` |
|  325985 |  623 | `	sCons.rc = SXRET_OK;` |
|  325985 |  624 | `	sCons.nLen = 0;` |
|  325985 |  625 | `	if( pOutLen ){` |
|   68619 |  626 | `		*pOutLen = 0;` |
|   34307 |  627 | `	}` |
|  325985 |  628 | `	switch(nType){` |
...
|      13 |  637 | `		break;` |
|  162984 |  638 | `		case SXFMT_CONS_BLOB:` |
|  325973 |  639 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  325973 |  640 | `			break;` |
|     ! 0 |  641 | `		default:` |
|     ! 0 |  642 | `			return SXERR_UNKNOWN;` |
|       - |  643 | `	}` |
|  325985 |  644 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  325985 |  645 | `	if( pOutLen ){` |
|   68619 |  646 | `		*pOutLen = sCons.nLen;` |
|   34307 |  647 | `	}` |
|  325985 |  648 | `	return sCons.rc;` |
|  162995 |  649 |  |
