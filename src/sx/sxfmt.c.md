...
|        - |   90 | ` */` |
|  1462542 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|        5 |   92 | `{` |
|        - |   93 | `	/*` |
...
|  1462547 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|        - |  151 | `  int rc;` |
|        - |  152 |  |
|  1462547 |  153 | `  length = 0;` |
|  1462547 |  154 | `  bufpt = 0;` |
|  5724277 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
|  5655459 |  156 | `    if( c!='%' ){` |
|        - |  157 | `      unsigned int amt;` |
|  5566677 |  158 | `      bufpt = (char *)zFormat;` |
|  5566677 |  159 | `      amt = 1;` |
|  8481009 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
|  5566677 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
|  5566677 |  162 | `	  if( rc != SXRET_OK ){` |
|      ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  164 | `	  }` |
|  5566677 |  165 | `      if( c==0 ){` |
|  1393729 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|        - |  167 | `	  }` |
|  2086474 |  168 | `    }` |
|  4261735 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|      ! 0 |  170 | `      errorflag = 1;` |
...
|  4261735 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  4261730 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  2130865 |  180 | `    do{` |
|  4261989 |  181 | `      switch( c ){` |
...
|  4261730 |  187 | `        default:                                       break;` |
|        - |  188 | `      }` |
|  4261989 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|      ! 0 |  198 | `      c = *++zFormat;` |
|      ! 0 |  199 | `    }else{` |
|  4262055 |  200 | `      while( c>='0' && c<='9' ){` |
|      322 |  201 | `        width = width*10 + c - '0';` |
|      322 |  202 | `        c = *++zFormat;` |
|        2 |  203 | `      }` |
|        - |  204 | `    }` |
|  4261735 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|      ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|      ! 0 |  207 | `    }` |
|        - |  208 | `    /* Get the precision */` |
|  4261735 |  209 | `	precision = -1;` |
|  4261735 |  210 | `    if( c=='.' ){` |
|  1389101 |  211 | `      precision = 0;` |
|  1389101 |  212 | `      c = *++zFormat;` |
|  1389101 |  213 | `      if( c=='*' ){` |
|  1389101 |  214 | `        precision = va_arg(ap,int);` |
|  1389101 |  215 | `        if( precision<0 ) precision = -precision;` |
|  1389101 |  216 | `        c = *++zFormat;` |
|   694553 |  217 | `      }else{` |
|      ! 0 |  218 | `        while( c>='0' && c<='9' ){` |
...
|  4261735 |  225 | `	flag_long = 0;` |
|  4261735 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
|    57879 |  227 | `      flag_long = (c == 'q') ? 2 : 1;` |
|    57879 |  228 | `      c = *++zFormat;` |
|    57879 |  229 | `	  if( c == 'l' ){` |
...
|  4261735 |  235 | `    infop = 0;` |
|  4261735 |  236 | `    xtype = SXFMT_ERROR;` |
| 19676151 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 19676151 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  4261735 |  239 | `        infop = &aFmt[idx];` |
|  4261735 |  240 | `		xtype = infop->type;` |
|  4261735 |  241 | `        break;` |
|        - |  242 | `      }` |
|  7707213 |  243 | `    }` |
...
|        - |  263 | `    */` |
|  4261735 |  264 | `    switch( xtype ){` |
|    31291 |  265 | `      case SXFMT_RADIX:` |
|    62587 |  266 | `        if( flag_long > 0 ){` |
|    57879 |  267 | `			if( flag_long > 1 ){` |
|        - |  268 | `				/* BSD quad: expect a 64-bit integer */` |
|    57867 |  269 | `				longvalue = va_arg(ap,sxi64);` |
|    28936 |  270 | `			}else{` |
|       13 |  271 | `				longvalue = va_arg(ap,sxlong);` |
|        - |  272 | `			}` |
|    28942 |  273 | `		}else{` |
|     4713 |  274 | `			if( infop->flags & SXFLAG_SIGNED ){` |
|     2877 |  275 | `				longvalue = va_arg(ap,sxi32);` |
|     1441 |  276 | `			}else{` |
|     1841 |  277 | `				longvalue = va_arg(ap,sxu32);` |
|        - |  278 | `			}` |
|        - |  279 | `		}` |
|        - |  280 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|    62587 |  281 | `      if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|        - |  282 | `#if 1` |
|        - |  283 | `        /* For the format %#x, the value zero is printed "0" not "0x0".` |
|        - |  284 | `        ** I think this is stupid.*/` |
|    62587 |  285 | `        if( longvalue==0 ) flag_alternateform = 0;` |
|        - |  286 | `#else` |
...
|        - |  290 | `#endif` |
|    62587 |  291 | `        if( infop->flags & SXFLAG_SIGNED ){` |
|    60697 |  292 | `          if( longvalue<0 ){` |
...
|      167 |  297 | `            prefix = '-';` |
|       85 |  298 | `          }else{` |
|    60533 |  299 | `            ulongvalue = (sxu64)longvalue;` |
|    60533 |  300 | `            if( flag_plussign )        prefix = '+';` |
|    60531 |  301 | `            else if( flag_blanksign )  prefix = ' ';` |
|    60531 |  302 | `            else                       prefix = 0;` |
|        - |  303 | `          }` |
|    30351 |  304 | `        }else{` |
|     1895 |  305 | `			ulongvalue = (sxu64)longvalue; /* print the full unsigned value as-is */` |
|     1895 |  306 | `			prefix = 0;` |
|        - |  307 | `		}` |
|    62587 |  308 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|      240 |  309 | `          precision = width-(prefix!=0);` |
|      119 |  310 | `        }` |
|    62587 |  311 | `        bufpt = &buf[SXFMT_BUFSIZ-1];` |
|        - |  312 | `        {` |
|        - |  313 | `          register char *cset;      /* Use registers for speed */` |
|        - |  314 | `          register int base;` |
|    62587 |  315 | `          cset = infop->charset;` |
|    62587 |  316 | `          base = infop->base;` |
|    31291 |  317 | `          do{                                           /* Convert to ascii */` |
|   185077 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|   185077 |  319 | `            ulongvalue = ulongvalue/base;` |
|   185077 |  320 | `          }while( ulongvalue>0 );` |
|        - |  321 | `        }` |
|    62587 |  322 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    62990 |  323 | `        for(idx=precision-length; idx>0; idx--){` |
|      405 |  324 | `          *(--bufpt) = '0';                             /* Zero pad */` |
|      205 |  325 | `        }` |
|    62587 |  326 | `        if( prefix ) *(--bufpt) = prefix;               /* Add sign */` |
|    62587 |  327 | `        if( flag_alternateform && infop->prefix ){      /* Add "0" or "0x" */` |
|        - |  328 | `          char *pre, x;` |
...
|        1 |  332 | `          }` |
|        1 |  333 | `        }` |
|    62587 |  334 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    62587 |  335 | `        break;` |
...
|     9860 |  499 | `        c = va_arg(ap,int);` |
|     9860 |  500 | `		buf[0] = (char)c;` |
|        - |  501 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|     9860 |  502 | `		if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|     9860 |  503 | `        if( precision>=0 ){` |
...
|     9860 |  509 | `        bufpt = buf;` |
|     9860 |  510 | `        break;` |
|   695821 |  511 | `      case SXFMT_STRING:` |
|  1391647 |  512 | `        bufpt = va_arg(ap,char*);` |
|  1391647 |  513 | `        if( bufpt==0 ){` |
|      ! 0 |  514 | `          bufpt = " ";` |
|      ! 0 |  515 | `		  length = (int)sizeof(" ")-1;` |
|      ! 0 |  516 | `		  break;` |
|        - |  517 | `        }` |
|  1391647 |  518 | `		length = precision;` |
|  1391647 |  519 | `		if( precision < 0 ){` |
|        - |  520 | `			/* Symisc extension */` |
|     2551 |  521 | `			length = (int)SyStrlen(bufpt);` |
|     1273 |  522 | `		}` |
|  1391647 |  523 | `        if( precision>=0 && precision<length ) length = precision;` |
|  1391647 |  524 | `        break;` |
|  1398820 |  525 | `	case SXFMT_RAWSTR:{` |
|        - |  526 | `		/* Symisc extension */` |
|  2797645 |  527 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  2797645 |  528 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|      ! 0 |  529 | `			 bufpt = " ";` |
|      ! 0 |  530 | `		     length = (int)sizeof(char);` |
|      ! 0 |  531 | `		     break;` |
|        - |  532 | `		}` |
|  2797645 |  533 | `		bufpt = (char *)pStr->zString;` |
|  2797645 |  534 | `		length = (int)pStr->nByte;` |
|  2797645 |  535 | `		break;` |
|        - |  536 | `					  }` |
...
|        - |  547 | `    ** the output.` |
|        - |  548 | `    */` |
|  4261735 |  549 | `    if( !flag_leftjustify ){` |
|        - |  550 | `      register int nspace;` |
|  4261735 |  551 | `      nspace = width-length;` |
|  4261735 |  552 | `      if( nspace>0 ){` |
...
|       18 |  566 | `      }` |
|  2130865 |  567 | `    }` |
|  4261735 |  568 | `    if( length>0 ){` |
|  4261519 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  4261519 |  570 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  572 | `		}` |
|  2130757 |  573 | `    }` |
|  4261735 |  574 | `    if( flag_leftjustify ){` |
...
|      ! 0 |  591 | `      }` |
|      ! 0 |  592 | `    }` |
|  2130870 |  593 | `  }/* End for loop over the format string */` |
|    68823 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|   731276 |  595 | `}` |
|        - |  596 | `/* SPDX-SnippetEnd */` |
|  9828222 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|        5 |  598 | `{` |
|  9828227 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
|  9828227 |  600 | `	sxi32 rc = SXERR_ABORT;` |
|  9828227 |  601 | `	switch(pConsumer->nType){` |
...
|      157 |  605 | `			break;` |
|  4914033 |  606 | `	case SXFMT_CONS_BLOB:` |
|        - |  607 | `			/* Blob consumer */` |
|  9828071 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
|  9828066 |  609 | `			break;` |
|      ! 0 |  610 | `		default:` |
...
|  9828227 |  615 | `	pConsumer->nLen += nLen;` |
|  9828227 |  616 | `	pConsumer->rc = rc;` |
|  9828227 |  617 | `	return rc;` |
|        5 |  618 | `}` |
|  1462542 |  619 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|        5 |  620 | `{` |
|        - |  621 | `	SyFmtConsumer sCons;` |
|  1462547 |  622 | `	sCons.nType = nType;` |
|  1462547 |  623 | `	sCons.rc = SXRET_OK;` |
|  1462547 |  624 | `	sCons.nLen = 0;` |
|  1462547 |  625 | `	if( pOutLen ){` |
|    72239 |  626 | `		*pOutLen = 0;` |
|    36117 |  627 | `	}` |
|  1462547 |  628 | `	switch(nType){` |
...
|       13 |  637 | `		break;` |
|   731265 |  638 | `		case SXFMT_CONS_BLOB:` |
|  1462535 |  639 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  1462535 |  640 | `			break;` |
|      ! 0 |  641 | `		default:` |
|      ! 0 |  642 | `			return SXERR_UNKNOWN;` |
|        - |  643 | `	}` |
|  1462547 |  644 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  1462547 |  645 | `	if( pOutLen ){` |
|    72239 |  646 | `		*pOutLen = sCons.nLen;` |
|    36117 |  647 | `	}` |
|  1462547 |  648 | `	return sCons.rc;` |
|   731276 |  649 | `}` |
...
|       13 |  662 | `	return rc;` |
|        1 |  663 | `}` |
|    69836 |  664 | `PH7_PRIVATE sxu32 SyBlobFormat(SyBlob *pBlob,const char *zFormat,...)` |
|        5 |  665 | `{` |
|        - |  666 | `	va_list ap;` |
|        - |  667 | `	sxu32 n;` |
...
|        - |  671 | `	}` |
|        - |  672 | `#endif` |
|    69841 |  673 | `	va_start(ap,zFormat);` |
|    69841 |  674 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    69841 |  675 | `	va_end(ap);` |
|    69841 |  676 | `	return n;` |
|        5 |  677 | `}` |
...
|     2403 |  687 | `	return n;` |
|        5 |  688 | `}` |
|  1390296 |  689 | `PH7_PRIVATE sxu32 SyBufferFormat(char *zBuf,sxu32 nLen,const char *zFormat,...)` |
|        5 |  690 | `{` |
|        - |  691 | `	SyBlob sBlob;` |
|        - |  692 | `	va_list ap;` |
|        - |  693 | `	sxu32 n;` |
...
|        - |  697 | `	}` |
|        - |  698 | `#endif` |
|  1390301 |  699 | `	if( SXRET_OK != SyBlobInitFromBuf(&sBlob,zBuf,nLen - 1) ){` |
|      ! 0 |  700 | `		return 0;` |
|        - |  701 | `	}` |
|  1390301 |  702 | `	va_start(ap,zFormat);` |
|  1390301 |  703 | `	FormatMount(SXFMT_CONS_BLOB,&sBlob,0,0,0,zFormat,ap);` |
|  1390301 |  704 | `	va_end(ap);` |
|  1390301 |  705 | `	n = SyBlobLength(&sBlob);` |
|        - |  706 | `	/* Append the null terminator */` |
|  1390301 |  707 | `	sBlob.mByte++;` |
|  1390301 |  708 | `	SyBlobAppend(&sBlob,"\0",sizeof(char));` |
|  1390301 |  709 | `	return n;` |
|   695153 |  710 | `}` |
|        - |  711 |  |
