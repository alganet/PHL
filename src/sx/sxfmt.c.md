...
|        - |   90 | ` */` |
|  2521950 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|        5 |   92 | `{` |
|        - |   93 | `	/*` |
...
|  2521955 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|        - |  151 | `  int rc;` |
|        - |  152 |  |
|  2521955 |  153 | `  length = 0;` |
|  2521955 |  154 | `  bufpt = 0;` |
|  9913817 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
|  9818237 |  156 | `    if( c!='%' ){` |
|        - |  157 | `      unsigned int amt;` |
|  9684179 |  158 | `      bufpt = (char *)zFormat;` |
|  9684179 |  159 | `      amt = 1;` |
| 15331931 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
|  9684179 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
|  9684179 |  162 | `	  if( rc != SXRET_OK ){` |
|      ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  164 | `	  }` |
|  9684179 |  165 | `      if( c==0 ){` |
|  2426375 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|        - |  167 | `	  }` |
|  3628902 |  168 | `    }` |
|  7391867 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|      ! 0 |  170 | `      errorflag = 1;` |
...
|  7391867 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  7391862 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  3695931 |  180 | `    do{` |
|  7393219 |  181 | `      switch( c ){` |
...
|  7391862 |  187 | `        default:                                       break;` |
|        - |  188 | `      }` |
|  7393219 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|      ! 0 |  198 | `      c = *++zFormat;` |
|      ! 0 |  199 | `    }else{` |
|  7393263 |  200 | `      while( c>='0' && c<='9' ){` |
|     1399 |  201 | `        width = width*10 + c - '0';` |
|     1399 |  202 | `        c = *++zFormat;` |
|        3 |  203 | `      }` |
|        - |  204 | `    }` |
|  7391867 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|      ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|      ! 0 |  207 | `    }` |
|        - |  208 | `    /* Get the precision */` |
|  7391867 |  209 | `	precision = -1;` |
|  7391867 |  210 | `    if( c=='.' ){` |
|  2397479 |  211 | `      precision = 0;` |
|  2397479 |  212 | `      c = *++zFormat;` |
|  2397479 |  213 | `      if( c=='*' ){` |
|  2397467 |  214 | `        precision = va_arg(ap,int);` |
|  2397467 |  215 | `        if( precision<0 ) precision = -precision;` |
|  2397467 |  216 | `        c = *++zFormat;` |
|  1198736 |  217 | `      }else{` |
...
|  7391867 |  225 | `	flag_long = 0;` |
|  7391867 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
|    62229 |  227 | `      flag_long = (c == 'q') ? 2 : 1;` |
|    62229 |  228 | `      c = *++zFormat;` |
|    62229 |  229 | `	  if( c == 'l' ){` |
...
|  7391867 |  235 | `    infop = 0;` |
|  7391867 |  236 | `    xtype = SXFMT_ERROR;` |
| 34046221 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 34046221 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  7391867 |  239 | `        infop = &aFmt[idx];` |
|  7391867 |  240 | `		xtype = infop->type;` |
|  7391867 |  241 | `        break;` |
|        - |  242 | `      }` |
| 13327182 |  243 | `    }` |
...
|        - |  263 | `    */` |
|  7391867 |  264 | `    switch( xtype ){` |
|    35888 |  265 | `      case SXFMT_RADIX:` |
|    71781 |  266 | `        if( flag_long > 0 ){` |
|    62229 |  267 | `			if( flag_long > 1 ){` |
|        - |  268 | `				/* BSD quad: expect a 64-bit integer */` |
|    62217 |  269 | `				longvalue = va_arg(ap,sxi64);` |
|    31111 |  270 | `			}else{` |
|       13 |  271 | `				longvalue = va_arg(ap,sxlong);` |
|        - |  272 | `			}` |
|    31117 |  273 | `		}else{` |
|     9557 |  274 | `			if( infop->flags & SXFLAG_SIGNED ){` |
|     5081 |  275 | `				longvalue = va_arg(ap,sxi32);` |
|     2543 |  276 | `			}else{` |
|     4481 |  277 | `				longvalue = va_arg(ap,sxu32);` |
|        - |  278 | `			}` |
|        - |  279 | `		}` |
|        - |  280 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|    71781 |  281 | `      if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|        - |  282 | `#if 1` |
|        - |  283 | `        /* For the format %#x, the value zero is printed "0" not "0x0".` |
|        - |  284 | `        ** I think this is stupid.*/` |
|    71781 |  285 | `        if( longvalue==0 ) flag_alternateform = 0;` |
|        - |  286 | `#else` |
...
|        - |  290 | `#endif` |
|    71781 |  291 | `        if( infop->flags & SXFLAG_SIGNED ){` |
|    67247 |  292 | `          if( longvalue<0 ){` |
...
|      221 |  297 | `            prefix = '-';` |
|      112 |  298 | `          }else{` |
|    67029 |  299 | `            ulongvalue = (sxu64)longvalue;` |
|    67029 |  300 | `            if( flag_plussign )        prefix = '+';` |
|    67029 |  301 | `            else if( flag_blanksign )  prefix = ' ';` |
|    67029 |  302 | `            else                       prefix = 0;` |
|        - |  303 | `          }` |
|    33626 |  304 | `        }else{` |
|     4539 |  305 | `			ulongvalue = (sxu64)longvalue; /* print the full unsigned value as-is */` |
|     4539 |  306 | `			prefix = 0;` |
|        - |  307 | `		}` |
|    71781 |  308 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|     1340 |  309 | `          precision = width-(prefix!=0);` |
|      669 |  310 | `        }` |
|    71781 |  311 | `        bufpt = &buf[SXFMT_BUFSIZ-1];` |
|        - |  312 | `        {` |
|        - |  313 | `          register char *cset;      /* Use registers for speed */` |
|        - |  314 | `          register int base;` |
|    71781 |  315 | `          cset = infop->charset;` |
|    71781 |  316 | `          base = infop->base;` |
|    35888 |  317 | `          do{                                           /* Convert to ascii */` |
|   203521 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|   203521 |  319 | `            ulongvalue = ulongvalue/base;` |
|   203521 |  320 | `          }while( ulongvalue>0 );` |
|        - |  321 | `        }` |
|    71781 |  322 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    72885 |  323 | `        for(idx=precision-length; idx>0; idx--){` |
|     1106 |  324 | `          *(--bufpt) = '0';                             /* Zero pad */` |
|      553 |  325 | `        }` |
|    71781 |  326 | `        if( prefix ) *(--bufpt) = prefix;               /* Add sign */` |
|    71781 |  327 | `        if( flag_alternateform && infop->prefix ){      /* Add "0" or "0x" */` |
|        - |  328 | `          char *pre, x;` |
...
|        1 |  332 | `          }` |
|        1 |  333 | `        }` |
|    71781 |  334 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    71781 |  335 | `        break;` |
...
|      ! 0 |  496 | `        length = 1;` |
|      ! 0 |  497 | `        break;` |
|     4899 |  498 | `      case SXFMT_CHARX:` |
|     9803 |  499 | `        c = va_arg(ap,int);` |
|     9803 |  500 | `		buf[0] = (char)c;` |
|        - |  501 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|     9803 |  502 | `		if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|     9803 |  503 | `        if( precision>=0 ){` |
...
|     9803 |  509 | `        bufpt = buf;` |
|     9803 |  510 | `        break;` |
|  1244086 |  511 | `      case SXFMT_STRING:` |
|  2488177 |  512 | `        bufpt = va_arg(ap,char*);` |
|  2488177 |  513 | `        if( bufpt==0 ){` |
|      ! 0 |  514 | `          bufpt = " ";` |
|      ! 0 |  515 | `		  length = (int)sizeof(" ")-1;` |
|      ! 0 |  516 | `		  break;` |
|        - |  517 | `        }` |
|  2488177 |  518 | `		length = precision;` |
|  2488177 |  519 | `		if( precision < 0 ){` |
|        - |  520 | `			/* Symisc extension */` |
|    90703 |  521 | `			length = (int)SyStrlen(bufpt);` |
|    45349 |  522 | `		}` |
|  2488177 |  523 | `        if( precision>=0 && precision<length ) length = precision;` |
|  2488177 |  524 | `        break;` |
|  2411044 |  525 | `	case SXFMT_RAWSTR:{` |
|        - |  526 | `		/* Symisc extension */` |
|  4822093 |  527 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  4822093 |  528 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|      ! 0 |  529 | `			 bufpt = " ";` |
|      ! 0 |  530 | `		     length = (int)sizeof(char);` |
|      ! 0 |  531 | `		     break;` |
|        - |  532 | `		}` |
|  4822093 |  533 | `		bufpt = (char *)pStr->zString;` |
|  4822093 |  534 | `		length = (int)pStr->nByte;` |
|  4822093 |  535 | `		break;` |
|        - |  536 | `					  }` |
...
|        - |  547 | `    ** the output.` |
|        - |  548 | `    */` |
|  7391867 |  549 | `    if( !flag_leftjustify ){` |
|        - |  550 | `      register int nspace;` |
|  7391867 |  551 | `      nspace = width-length;` |
|  7391867 |  552 | `      if( nspace>0 ){` |
...
|       18 |  566 | `      }` |
|  3695931 |  567 | `    }` |
|  7391867 |  568 | `    if( length>0 ){` |
|  7391525 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  7391525 |  570 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  572 | `		}` |
|  3695760 |  573 | `    }` |
|  7391867 |  574 | `    if( flag_leftjustify ){` |
...
|      ! 0 |  591 | `      }` |
|      ! 0 |  592 | `    }` |
|  3695936 |  593 | `  }/* End for loop over the format string */` |
|    95585 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|  1260980 |  595 | `}` |
|        - |  596 | `/* SPDX-SnippetEnd */` |
| 17075730 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|        5 |  598 | `{` |
| 17075735 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 17075735 |  600 | `	sxi32 rc = SXERR_ABORT;` |
| 17075735 |  601 | `	switch(pConsumer->nType){` |
...
|      181 |  605 | `			break;` |
|  8537775 |  606 | `	case SXFMT_CONS_BLOB:` |
|        - |  607 | `			/* Blob consumer */` |
| 17075555 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 17075550 |  609 | `			break;` |
|      ! 0 |  610 | `		default:` |
...
| 17075735 |  615 | `	pConsumer->nLen += nLen;` |
| 17075735 |  616 | `	pConsumer->rc = rc;` |
| 17075735 |  617 | `	return rc;` |
|        5 |  618 | `}` |
|  2521950 |  619 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|        5 |  620 | `{` |
|        - |  621 | `	SyFmtConsumer sCons;` |
|  2521955 |  622 | `	sCons.nType = nType;` |
|  2521955 |  623 | `	sCons.rc = SXRET_OK;` |
|  2521955 |  624 | `	sCons.nLen = 0;` |
|  2521955 |  625 | `	if( pOutLen ){` |
|   119987 |  626 | `		*pOutLen = 0;` |
|    59991 |  627 | `	}` |
|  2521955 |  628 | `	switch(nType){` |
...
|       13 |  637 | `		break;` |
|  1260969 |  638 | `		case SXFMT_CONS_BLOB:` |
|  2521943 |  639 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  2521943 |  640 | `			break;` |
|      ! 0 |  641 | `		default:` |
|      ! 0 |  642 | `			return SXERR_UNKNOWN;` |
|        - |  643 | `	}` |
|  2521955 |  644 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  2521955 |  645 | `	if( pOutLen ){` |
|   119987 |  646 | `		*pOutLen = sCons.nLen;` |
|    59991 |  647 | `	}` |
|  2521955 |  648 | `	return sCons.rc;` |
|  1260980 |  649 | `}` |
...
|       13 |  662 | `	return rc;` |
|        1 |  663 | `}` |
|    96372 |  664 | `PH7_PRIVATE sxu32 SyBlobFormat(SyBlob *pBlob,const char *zFormat,...)` |
|        5 |  665 | `{` |
|        - |  666 | `	va_list ap;` |
|        - |  667 | `	sxu32 n;` |
...
|        - |  671 | `	}` |
|        - |  672 | `#endif` |
|    96377 |  673 | `	va_start(ap,zFormat);` |
|    96377 |  674 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    96377 |  675 | `	va_end(ap);` |
|    96377 |  676 | `	return n;` |
|        5 |  677 | `}` |
|    23610 |  678 | `PH7_PRIVATE sxu32 SyBlobFormatAp(SyBlob *pBlob,const char *zFormat,va_list ap)` |
|        5 |  679 | `{` |
|    23615 |  680 | `	sxu32 n = 0; /* cc warning */` |
|        - |  681 | `#if defined(UNTRUST)` |
|        - |  682 | `	if( SX_EMPTY_STR(zFormat) ){` |
|        - |  683 | `		return 0;` |
|        - |  684 | `	}` |
|        - |  685 | `#endif` |
|    23615 |  686 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    23615 |  687 | `	return n;` |
|        5 |  688 | `}` |
|  2401956 |  689 | `PH7_PRIVATE sxu32 SyBufferFormat(char *zBuf,sxu32 nLen,const char *zFormat,...)` |
|        5 |  690 | `{` |
|        - |  691 | `	SyBlob sBlob;` |
|        - |  692 | `	va_list ap;` |
|        - |  693 | `	sxu32 n;` |
...
|        - |  697 | `	}` |
|        - |  698 | `#endif` |
|  2401961 |  699 | `	if( SXRET_OK != SyBlobInitFromBuf(&sBlob,zBuf,nLen - 1) ){` |
|      ! 0 |  700 | `		return 0;` |
|        - |  701 | `	}` |
|  2401961 |  702 | `	va_start(ap,zFormat);` |
|  2401961 |  703 | `	FormatMount(SXFMT_CONS_BLOB,&sBlob,0,0,0,zFormat,ap);` |
|  2401961 |  704 | `	va_end(ap);` |
|  2401961 |  705 | `	n = SyBlobLength(&sBlob);` |
|        - |  706 | `	/* Append the null terminator */` |
|  2401961 |  707 | `	sBlob.mByte++;` |
|  2401961 |  708 | `	SyBlobAppend(&sBlob,"\0",sizeof(char));` |
|  2401961 |  709 | `	return n;` |
|  1200983 |  710 | `}` |
|        - |  711 |  |
