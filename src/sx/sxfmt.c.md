...
|        - |   90 | ` */` |
|  1446902 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|        5 |   92 | `{` |
|        - |   93 | `	/*` |
...
|  1446907 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|        - |  151 | `  int rc;` |
|        - |  152 |  |
|  1446907 |  153 | `  length = 0;` |
|  1446907 |  154 | `  bufpt = 0;` |
|  5665107 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
|  5597419 |  156 | `    if( c!='%' ){` |
|        - |  157 | `      unsigned int amt;` |
|  5509783 |  158 | `      bufpt = (char *)zFormat;` |
|  5509783 |  159 | `      amt = 1;` |
|  8384523 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
|  5509783 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
|  5509783 |  162 | `	  if( rc != SXRET_OK ){` |
|      ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  164 | `	  }` |
|  5509783 |  165 | `      if( c==0 ){` |
|  1379219 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|        - |  167 | `	  }` |
|  2065282 |  168 | `    }` |
|  4218205 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|      ! 0 |  170 | `      errorflag = 1;` |
...
|  4218205 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  4218200 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  2109100 |  180 | `    do{` |
|  4218459 |  181 | `      switch( c ){` |
...
|  4218200 |  187 | `        default:                                       break;` |
|        - |  188 | `      }` |
|  4218459 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|      ! 0 |  198 | `      c = *++zFormat;` |
|      ! 0 |  199 | `    }else{` |
|  4218525 |  200 | `      while( c>='0' && c<='9' ){` |
|      323 |  201 | `        width = width*10 + c - '0';` |
|      323 |  202 | `        c = *++zFormat;` |
|        3 |  203 | `      }` |
|        - |  204 | `    }` |
|  4218205 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|      ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|      ! 0 |  207 | `    }` |
|        - |  208 | `    /* Get the precision */` |
|  4218205 |  209 | `	precision = -1;` |
|  4218205 |  210 | `    if( c=='.' ){` |
...
|  4218205 |  225 | `	flag_long = 0;` |
|  4218205 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
|    56995 |  227 | `      flag_long = (c == 'q') ? 2 : 1;` |
|    56995 |  228 | `      c = *++zFormat;` |
|    56995 |  229 | `	  if( c == 'l' ){` |
...
|  4218205 |  235 | `    infop = 0;` |
|  4218205 |  236 | `    xtype = SXFMT_ERROR;` |
| 19477795 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 19477795 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  4218205 |  239 | `        infop = &aFmt[idx];` |
|  4218205 |  240 | `		xtype = infop->type;` |
|  4218205 |  241 | `        break;` |
|        - |  242 | `      }` |
|  7629800 |  243 | `    }` |
...
|        - |  263 | `    */` |
|  4218205 |  264 | `    switch( xtype ){` |
|    30494 |  265 | `      case SXFMT_RADIX:` |
|    60993 |  266 | `        if( flag_long > 0 ){` |
|    56995 |  267 | `			if( flag_long > 1 ){` |
|        - |  268 | `				/* BSD quad: expect a 64-bit integer */` |
|    56983 |  269 | `				longvalue = va_arg(ap,sxi64);` |
|    28494 |  270 | `			}else{` |
...
|    60993 |  281 | `      if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|        - |  282 | `#if 1` |
|        - |  283 | `        /* For the format %#x, the value zero is printed "0" not "0x0".` |
|        - |  284 | `        ** I think this is stupid.*/` |
|    60993 |  285 | `        if( longvalue==0 ) flag_alternateform = 0;` |
|        - |  286 | `#else` |
...
|        - |  290 | `#endif` |
|    60993 |  291 | `        if( infop->flags & SXFLAG_SIGNED ){` |
|    59241 |  292 | `          if( longvalue<0 ){` |
...
|      167 |  297 | `            prefix = '-';` |
|       85 |  298 | `          }else{` |
|    59077 |  299 | `            ulongvalue = (sxu64)longvalue;` |
|    59077 |  300 | `            if( flag_plussign )        prefix = '+';` |
|    59075 |  301 | `            else if( flag_blanksign )  prefix = ' ';` |
|    59075 |  302 | `            else                       prefix = 0;` |
|        - |  303 | `          }` |
|    29623 |  304 | `        }else{` |
|     1757 |  305 | `			ulongvalue = (sxu64)longvalue; /* print the full unsigned value as-is */` |
|     1757 |  306 | `			prefix = 0;` |
|        - |  307 | `		}` |
|    60993 |  308 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|      240 |  309 | `          precision = width-(prefix!=0);` |
|      119 |  310 | `        }` |
|    60993 |  311 | `        bufpt = &buf[SXFMT_BUFSIZ-1];` |
|        - |  312 | `        {` |
|        - |  313 | `          register char *cset;      /* Use registers for speed */` |
|        - |  314 | `          register int base;` |
|    60993 |  315 | `          cset = infop->charset;` |
|    60993 |  316 | `          base = infop->base;` |
|    30494 |  317 | `          do{                                           /* Convert to ascii */` |
|   182091 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|   182091 |  319 | `            ulongvalue = ulongvalue/base;` |
|   182091 |  320 | `          }while( ulongvalue>0 );` |
|        - |  321 | `        }` |
|    60993 |  322 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    61416 |  323 | `        for(idx=precision-length; idx>0; idx--){` |
|      425 |  324 | `          *(--bufpt) = '0';                             /* Zero pad */` |
|      212 |  325 | `        }` |
|    60993 |  326 | `        if( prefix ) *(--bufpt) = prefix;               /* Add sign */` |
|    60993 |  327 | `        if( flag_alternateform && infop->prefix ){      /* Add "0" or "0x" */` |
|        - |  328 | `          char *pre, x;` |
...
|        1 |  332 | `          }` |
|        1 |  333 | `        }` |
|    60993 |  334 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    60993 |  335 | `        break;` |
...
|     9795 |  509 | `        bufpt = buf;` |
|     9795 |  510 | `        break;` |
|   688851 |  511 | `      case SXFMT_STRING:` |
|  1377707 |  512 | `        bufpt = va_arg(ap,char*);` |
|  1377707 |  513 | `        if( bufpt==0 ){` |
|      ! 0 |  514 | `          bufpt = " ";` |
|      ! 0 |  515 | `		  length = (int)sizeof(" ")-1;` |
|      ! 0 |  516 | `		  break;` |
|        - |  517 | `        }` |
|  1377707 |  518 | `		length = precision;` |
|  1377707 |  519 | `		if( precision < 0 ){` |
|        - |  520 | `			/* Symisc extension */` |
|     2421 |  521 | `			length = (int)SyStrlen(bufpt);` |
|     1208 |  522 | `		}` |
|  1377707 |  523 | `        if( precision>=0 && precision<length ) length = precision;` |
|  1377707 |  524 | `        break;` |
|  1384855 |  525 | `	case SXFMT_RAWSTR:{` |
|        - |  526 | `		/* Symisc extension */` |
|  2769715 |  527 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  2769715 |  528 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|      ! 0 |  529 | `			 bufpt = " ";` |
|      ! 0 |  530 | `		     length = (int)sizeof(char);` |
|      ! 0 |  531 | `		     break;` |
|        - |  532 | `		}` |
|  2769715 |  533 | `		bufpt = (char *)pStr->zString;` |
|  2769715 |  534 | `		length = (int)pStr->nByte;` |
|  2769715 |  535 | `		break;` |
|        - |  536 | `					  }` |
...
|        - |  547 | `    ** the output.` |
|        - |  548 | `    */` |
|  4218205 |  549 | `    if( !flag_leftjustify ){` |
|        - |  550 | `      register int nspace;` |
|  4218205 |  551 | `      nspace = width-length;` |
|  4218205 |  552 | `      if( nspace>0 ){` |
...
|       18 |  566 | `      }` |
|  2109100 |  567 | `    }` |
|  4218205 |  568 | `    if( length>0 ){` |
|  4217989 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  4217989 |  570 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  572 | `		}` |
|  2108992 |  573 | `    }` |
|  4218205 |  574 | `    if( flag_leftjustify ){` |
...
|      ! 0 |  591 | `      }` |
|      ! 0 |  592 | `    }` |
|  2109105 |  593 | `  }/* End for loop over the format string */` |
|    67693 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|   723456 |  595 | `}` |
|        - |  596 | `/* SPDX-SnippetEnd */` |
|  9727798 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|        5 |  598 | `{` |
|  9727803 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
|  9727803 |  600 | `	sxi32 rc = SXERR_ABORT;` |
|  9727803 |  601 | `	switch(pConsumer->nType){` |
...
|      157 |  605 | `			break;` |
|  4863821 |  606 | `	case SXFMT_CONS_BLOB:` |
|        - |  607 | `			/* Blob consumer */` |
|  9727647 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
|  9727642 |  609 | `			break;` |
|      ! 0 |  610 | `		default:` |
...
|  9727803 |  615 | `	pConsumer->nLen += nLen;` |
|  9727803 |  616 | `	pConsumer->rc = rc;` |
|  9727803 |  617 | `	return rc;` |
|        5 |  618 | `}` |
|  1446902 |  619 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|        5 |  620 | `{` |
|        - |  621 | `	SyFmtConsumer sCons;` |
|  1446907 |  622 | `	sCons.nType = nType;` |
|  1446907 |  623 | `	sCons.rc = SXRET_OK;` |
|  1446907 |  624 | `	sCons.nLen = 0;` |
|  1446907 |  625 | `	if( pOutLen ){` |
|    71061 |  626 | `		*pOutLen = 0;` |
|    35528 |  627 | `	}` |
|  1446907 |  628 | `	switch(nType){` |
...
|       13 |  637 | `		break;` |
|   723445 |  638 | `		case SXFMT_CONS_BLOB:` |
|  1446895 |  639 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  1446895 |  640 | `			break;` |
|      ! 0 |  641 | `		default:` |
|      ! 0 |  642 | `			return SXERR_UNKNOWN;` |
|        - |  643 | `	}` |
|  1446907 |  644 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  1446907 |  645 | `	if( pOutLen ){` |
|    71061 |  646 | `		*pOutLen = sCons.nLen;` |
|    35528 |  647 | `	}` |
|  1446907 |  648 | `	return sCons.rc;` |
|   723456 |  649 | `}` |
...
|       13 |  662 | `	return rc;` |
|        1 |  663 | `}` |
|    68704 |  664 | `PH7_PRIVATE sxu32 SyBlobFormat(SyBlob *pBlob,const char *zFormat,...)` |
|        5 |  665 | `{` |
|        - |  666 | `	va_list ap;` |
|        - |  667 | `	sxu32 n;` |
...
|        - |  671 | `	}` |
|        - |  672 | `#endif` |
|    68709 |  673 | `	va_start(ap,zFormat);` |
|    68709 |  674 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    68709 |  675 | `	va_end(ap);` |
|    68709 |  676 | `	return n;` |
|        5 |  677 | `}` |
...
|     2357 |  687 | `	return n;` |
|        5 |  688 | `}` |
|  1375834 |  689 | `PH7_PRIVATE sxu32 SyBufferFormat(char *zBuf,sxu32 nLen,const char *zFormat,...)` |
|        5 |  690 | `{` |
|        - |  691 | `	SyBlob sBlob;` |
|        - |  692 | `	va_list ap;` |
|        - |  693 | `	sxu32 n;` |
...
|        - |  697 | `	}` |
|        - |  698 | `#endif` |
|  1375839 |  699 | `	if( SXRET_OK != SyBlobInitFromBuf(&sBlob,zBuf,nLen - 1) ){` |
|      ! 0 |  700 | `		return 0;` |
|        - |  701 | `	}` |
|  1375839 |  702 | `	va_start(ap,zFormat);` |
|  1375839 |  703 | `	FormatMount(SXFMT_CONS_BLOB,&sBlob,0,0,0,zFormat,ap);` |
|  1375839 |  704 | `	va_end(ap);` |
|  1375839 |  705 | `	n = SyBlobLength(&sBlob);` |
|        - |  706 | `	/* Append the null terminator */` |
|  1375839 |  707 | `	sBlob.mByte++;` |
|  1375839 |  708 | `	SyBlobAppend(&sBlob,"\0",sizeof(char));` |
|  1375839 |  709 | `	return n;` |
|   687922 |  710 | `}` |
|        - |  711 |  |
