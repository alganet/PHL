...
|        - |   90 | ` */` |
|  2527494 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|        5 |   92 | `{` |
|        - |   93 | `	/*` |
...
|  2527499 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|        - |  151 | `  int rc;` |
|        - |  152 |  |
|  2527499 |  153 | `  length = 0;` |
|  2527499 |  154 | `  bufpt = 0;` |
|  9935521 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
|  9839715 |  156 | `    if( c!='%' ){` |
|        - |  157 | `      unsigned int amt;` |
|  9705185 |  158 | `      bufpt = (char *)zFormat;` |
|  9705185 |  159 | `      amt = 1;` |
| 15365273 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
|  9705185 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
|  9705185 |  162 | `	  if( rc != SXRET_OK ){` |
|      ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  164 | `	  }` |
|  9705185 |  165 | `      if( c==0 ){` |
|  2431693 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|        - |  167 | `	  }` |
|  3636746 |  168 | `    }` |
|  7408027 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|      ! 0 |  170 | `      errorflag = 1;` |
...
|  7408027 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  7408022 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  3704011 |  180 | `    do{` |
|  7409379 |  181 | `      switch( c ){` |
...
|  7408022 |  187 | `        default:                                       break;` |
|        - |  188 | `      }` |
|  7409379 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|      ! 0 |  198 | `      c = *++zFormat;` |
|      ! 0 |  199 | `    }else{` |
|  7409423 |  200 | `      while( c>='0' && c<='9' ){` |
|     1399 |  201 | `        width = width*10 + c - '0';` |
|     1399 |  202 | `        c = *++zFormat;` |
|        3 |  203 | `      }` |
|        - |  204 | `    }` |
|  7408027 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|      ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|      ! 0 |  207 | `    }` |
|        - |  208 | `    /* Get the precision */` |
|  7408027 |  209 | `	precision = -1;` |
|  7408027 |  210 | `    if( c=='.' ){` |
|  2402583 |  211 | `      precision = 0;` |
|  2402583 |  212 | `      c = *++zFormat;` |
|  2402583 |  213 | `      if( c=='*' ){` |
|  2402571 |  214 | `        precision = va_arg(ap,int);` |
|  2402571 |  215 | `        if( precision<0 ) precision = -precision;` |
|  2402571 |  216 | `        c = *++zFormat;` |
|  1201288 |  217 | `      }else{` |
...
|  7408027 |  225 | `	flag_long = 0;` |
|  7408027 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
|    62279 |  227 | `      flag_long = (c == 'q') ? 2 : 1;` |
|    62279 |  228 | `      c = *++zFormat;` |
|    62279 |  229 | `	  if( c == 'l' ){` |
...
|  7408027 |  235 | `    infop = 0;` |
|  7408027 |  236 | `    xtype = SXFMT_ERROR;` |
| 34119871 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 34119871 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  7408027 |  239 | `        infop = &aFmt[idx];` |
|  7408027 |  240 | `		xtype = infop->type;` |
|  7408027 |  241 | `        break;` |
|        - |  242 | `      }` |
| 13355927 |  243 | `    }` |
...
|        - |  263 | `    */` |
|  7408027 |  264 | `    switch( xtype ){` |
|    35942 |  265 | `      case SXFMT_RADIX:` |
|    71889 |  266 | `        if( flag_long > 0 ){` |
|    62279 |  267 | `			if( flag_long > 1 ){` |
|        - |  268 | `				/* BSD quad: expect a 64-bit integer */` |
|    62267 |  269 | `				longvalue = va_arg(ap,sxi64);` |
|    31136 |  270 | `			}else{` |
...
|    71889 |  281 | `      if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|        - |  282 | `#if 1` |
|        - |  283 | `        /* For the format %#x, the value zero is printed "0" not "0x0".` |
|        - |  284 | `        ** I think this is stupid.*/` |
|    71889 |  285 | `        if( longvalue==0 ) flag_alternateform = 0;` |
|        - |  286 | `#else` |
...
|        - |  290 | `#endif` |
|    71889 |  291 | `        if( infop->flags & SXFLAG_SIGNED ){` |
|    67345 |  292 | `          if( longvalue<0 ){` |
...
|      221 |  297 | `            prefix = '-';` |
|      112 |  298 | `          }else{` |
|    67127 |  299 | `            ulongvalue = (sxu64)longvalue;` |
|    67127 |  300 | `            if( flag_plussign )        prefix = '+';` |
|    67127 |  301 | `            else if( flag_blanksign )  prefix = ' ';` |
|    67127 |  302 | `            else                       prefix = 0;` |
|        - |  303 | `          }` |
|    33675 |  304 | `        }else{` |
|     4549 |  305 | `			ulongvalue = (sxu64)longvalue; /* print the full unsigned value as-is */` |
|     4549 |  306 | `			prefix = 0;` |
|        - |  307 | `		}` |
|    71889 |  308 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|     1340 |  309 | `          precision = width-(prefix!=0);` |
|      669 |  310 | `        }` |
|    71889 |  311 | `        bufpt = &buf[SXFMT_BUFSIZ-1];` |
|        - |  312 | `        {` |
|        - |  313 | `          register char *cset;      /* Use registers for speed */` |
|        - |  314 | `          register int base;` |
|    71889 |  315 | `          cset = infop->charset;` |
|    71889 |  316 | `          base = infop->base;` |
|    35942 |  317 | `          do{                                           /* Convert to ascii */` |
|   203734 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|   203734 |  319 | `            ulongvalue = ulongvalue/base;` |
|   203734 |  320 | `          }while( ulongvalue>0 );` |
|        - |  321 | `        }` |
|    71889 |  322 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    72990 |  323 | `        for(idx=precision-length; idx>0; idx--){` |
|     1103 |  324 | `          *(--bufpt) = '0';                             /* Zero pad */` |
|      552 |  325 | `        }` |
|    71889 |  326 | `        if( prefix ) *(--bufpt) = prefix;               /* Add sign */` |
|    71889 |  327 | `        if( flag_alternateform && infop->prefix ){      /* Add "0" or "0x" */` |
|        - |  328 | `          char *pre, x;` |
...
|        1 |  332 | `          }` |
|        1 |  333 | `        }` |
|    71889 |  334 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    71889 |  335 | `        break;` |
...
|      ! 0 |  496 | `        length = 1;` |
|      ! 0 |  497 | `        break;` |
|     4926 |  498 | `      case SXFMT_CHARX:` |
|     9857 |  499 | `        c = va_arg(ap,int);` |
|     9857 |  500 | `		buf[0] = (char)c;` |
|        - |  501 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|     9857 |  502 | `		if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|     9857 |  503 | `        if( precision>=0 ){` |
...
|     9857 |  509 | `        bufpt = buf;` |
|     9857 |  510 | `        break;` |
|  1246922 |  511 | `      case SXFMT_STRING:` |
|  2493849 |  512 | `        bufpt = va_arg(ap,char*);` |
|  2493849 |  513 | `        if( bufpt==0 ){` |
|      ! 0 |  514 | `          bufpt = " ";` |
|      ! 0 |  515 | `		  length = (int)sizeof(" ")-1;` |
|      ! 0 |  516 | `		  break;` |
|        - |  517 | `        }` |
|  2493849 |  518 | `		length = precision;` |
|  2493849 |  519 | `		if( precision < 0 ){` |
|        - |  520 | `			/* Symisc extension */` |
|    91271 |  521 | `			length = (int)SyStrlen(bufpt);` |
|    45633 |  522 | `		}` |
|  2493849 |  523 | `        if( precision>=0 && precision<length ) length = precision;` |
|  2493849 |  524 | `        break;` |
|  2416207 |  525 | `	case SXFMT_RAWSTR:{` |
|        - |  526 | `		/* Symisc extension */` |
|  4832419 |  527 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  4832419 |  528 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|      ! 0 |  529 | `			 bufpt = " ";` |
|      ! 0 |  530 | `		     length = (int)sizeof(char);` |
|      ! 0 |  531 | `		     break;` |
|        - |  532 | `		}` |
|  4832419 |  533 | `		bufpt = (char *)pStr->zString;` |
|  4832419 |  534 | `		length = (int)pStr->nByte;` |
|  4832419 |  535 | `		break;` |
|        - |  536 | `					  }` |
...
|        - |  547 | `    ** the output.` |
|        - |  548 | `    */` |
|  7408027 |  549 | `    if( !flag_leftjustify ){` |
|        - |  550 | `      register int nspace;` |
|  7408027 |  551 | `      nspace = width-length;` |
|  7408027 |  552 | `      if( nspace>0 ){` |
...
|       18 |  566 | `      }` |
|  3704011 |  567 | `    }` |
|  7408027 |  568 | `    if( length>0 ){` |
|  7407685 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  7407685 |  570 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  572 | `		}` |
|  3703840 |  573 | `    }` |
|  7408027 |  574 | `    if( flag_leftjustify ){` |
...
|      ! 0 |  591 | `      }` |
|      ! 0 |  592 | `    }` |
|  3704016 |  593 | `  }/* End for loop over the format string */` |
|    95811 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|  1263752 |  595 | `}` |
|        - |  596 | `/* SPDX-SnippetEnd */` |
| 17112896 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|        5 |  598 | `{` |
| 17112901 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 17112901 |  600 | `	sxi32 rc = SXERR_ABORT;` |
| 17112901 |  601 | `	switch(pConsumer->nType){` |
...
|      181 |  605 | `			break;` |
|  8556358 |  606 | `	case SXFMT_CONS_BLOB:` |
|        - |  607 | `			/* Blob consumer */` |
| 17112721 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 17112716 |  609 | `			break;` |
|      ! 0 |  610 | `		default:` |
...
| 17112901 |  615 | `	pConsumer->nLen += nLen;` |
| 17112901 |  616 | `	pConsumer->rc = rc;` |
| 17112901 |  617 | `	return rc;` |
|        5 |  618 | `}` |
|  2527494 |  619 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|        5 |  620 | `{` |
|        - |  621 | `	SyFmtConsumer sCons;` |
|  2527499 |  622 | `	sCons.nType = nType;` |
|  2527499 |  623 | `	sCons.rc = SXRET_OK;` |
|  2527499 |  624 | `	sCons.nLen = 0;` |
|  2527499 |  625 | `	if( pOutLen ){` |
|   120371 |  626 | `		*pOutLen = 0;` |
|    60183 |  627 | `	}` |
|  2527499 |  628 | `	switch(nType){` |
...
|       13 |  637 | `		break;` |
|  1263741 |  638 | `		case SXFMT_CONS_BLOB:` |
|  2527487 |  639 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  2527487 |  640 | `			break;` |
|      ! 0 |  641 | `		default:` |
|      ! 0 |  642 | `			return SXERR_UNKNOWN;` |
|        - |  643 | `	}` |
|  2527499 |  644 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  2527499 |  645 | `	if( pOutLen ){` |
|   120371 |  646 | `		*pOutLen = sCons.nLen;` |
|    60183 |  647 | `	}` |
|  2527499 |  648 | `	return sCons.rc;` |
|  1263752 |  649 | `}` |
...
|       13 |  662 | `	return rc;` |
|        1 |  663 | `}` |
|    96620 |  664 | `PH7_PRIVATE sxu32 SyBlobFormat(SyBlob *pBlob,const char *zFormat,...)` |
|        5 |  665 | `{` |
|        - |  666 | `	va_list ap;` |
|        - |  667 | `	sxu32 n;` |
...
|        - |  671 | `	}` |
|        - |  672 | `#endif` |
|    96625 |  673 | `	va_start(ap,zFormat);` |
|    96625 |  674 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    96625 |  675 | `	va_end(ap);` |
|    96625 |  676 | `	return n;` |
|        5 |  677 | `}` |
|    23746 |  678 | `PH7_PRIVATE sxu32 SyBlobFormatAp(SyBlob *pBlob,const char *zFormat,va_list ap)` |
|        5 |  679 | `{` |
|    23751 |  680 | `	sxu32 n = 0; /* cc warning */` |
|        - |  681 | `#if defined(UNTRUST)` |
|        - |  682 | `	if( SX_EMPTY_STR(zFormat) ){` |
|        - |  683 | `		return 0;` |
|        - |  684 | `	}` |
|        - |  685 | `#endif` |
|    23751 |  686 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    23751 |  687 | `	return n;` |
|        5 |  688 | `}` |
|  2407116 |  689 | `PH7_PRIVATE sxu32 SyBufferFormat(char *zBuf,sxu32 nLen,const char *zFormat,...)` |
|        5 |  690 | `{` |
|        - |  691 | `	SyBlob sBlob;` |
|        - |  692 | `	va_list ap;` |
|        - |  693 | `	sxu32 n;` |
...
|        - |  697 | `	}` |
|        - |  698 | `#endif` |
|  2407121 |  699 | `	if( SXRET_OK != SyBlobInitFromBuf(&sBlob,zBuf,nLen - 1) ){` |
|      ! 0 |  700 | `		return 0;` |
|        - |  701 | `	}` |
|  2407121 |  702 | `	va_start(ap,zFormat);` |
|  2407121 |  703 | `	FormatMount(SXFMT_CONS_BLOB,&sBlob,0,0,0,zFormat,ap);` |
|  2407121 |  704 | `	va_end(ap);` |
|  2407121 |  705 | `	n = SyBlobLength(&sBlob);` |
|        - |  706 | `	/* Append the null terminator */` |
|  2407121 |  707 | `	sBlob.mByte++;` |
|  2407121 |  708 | `	SyBlobAppend(&sBlob,"\0",sizeof(char));` |
|  2407121 |  709 | `	return n;` |
|  1203563 |  710 | `}` |
|        - |  711 |  |
