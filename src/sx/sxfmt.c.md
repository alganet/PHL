...
|        - |   90 | ` */` |
|  8696972 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|        5 |   92 | `{` |
|        - |   93 | `	/*` |
...
|  8696977 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|        - |  151 | `  int rc;` |
|        - |  152 |  |
|  8696977 |  153 | `  length = 0;` |
|  8696977 |  154 | `  bufpt = 0;` |
| 30238849 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
| 26093433 |  156 | `    if( c!='%' ){` |
|        - |  157 | `      unsigned int amt;` |
| 22019729 |  158 | `      bufpt = (char *)zFormat;` |
| 22019729 |  159 | `      amt = 1;` |
| 50419397 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
| 22019729 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
| 22019729 |  162 | `	  if( rc != SXRET_OK ){` |
|      ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  164 | `	  }` |
| 22019729 |  165 | `      if( c==0 ){` |
|  4551561 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|        - |  167 | `	  }` |
|  8734084 |  168 | `    }` |
| 21541877 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|      ! 0 |  170 | `      errorflag = 1;` |
...
| 21541877 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
| 21541872 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
| 10770936 |  180 | `    do{` |
| 21544501 |  181 | `      switch( c ){` |
...
|     2618 |  186 | `        case '0':   flag_zeropad = 1;         c = 0;   break;` |
| 21541872 |  187 | `        default:                                       break;` |
|        - |  188 | `      }` |
| 21544501 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
|        - |  190 | `    /* Get the field width */` |
| 21541877 |  191 | `    width = 0;` |
| 21541877 |  192 | `    if( c=='*' ){` |
...
|      ! 0 |  198 | `      c = *++zFormat;` |
|      ! 0 |  199 | `    }else{` |
| 21544555 |  200 | `      while( c>='0' && c<='9' ){` |
|     2683 |  201 | `        width = width*10 + c - '0';` |
|     2683 |  202 | `        c = *++zFormat;` |
|        5 |  203 | `      }` |
|        - |  204 | `    }` |
| 21541877 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|      ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|      ! 0 |  207 | `    }` |
|        - |  208 | `    /* Get the precision */` |
| 21541877 |  209 | `	precision = -1;` |
| 21541877 |  210 | `    if( c=='.' ){` |
|  4268001 |  211 | `      precision = 0;` |
|  4268001 |  212 | `      c = *++zFormat;` |
|  4268001 |  213 | `      if( c=='*' ){` |
|  4267951 |  214 | `        precision = va_arg(ap,int);` |
|  4267951 |  215 | `        if( precision<0 ) precision = -precision;` |
|  4267951 |  216 | `        c = *++zFormat;` |
|  2133978 |  217 | `      }else{` |
|      103 |  218 | `        while( c>='0' && c<='9' ){` |
|       53 |  219 | `          precision = precision*10 + c - '0';` |
|       53 |  220 | `          c = *++zFormat;` |
|        3 |  221 | `        }` |
|        - |  222 | `      }` |
|  2133998 |  223 | `    }` |
|        - |  224 | `    /* Get the conversion type modifier */` |
| 21541877 |  225 | `	flag_long = 0;` |
| 21541877 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
|    80903 |  227 | `      flag_long = (c == 'q') ? 2 : 1;` |
|    80903 |  228 | `      c = *++zFormat;` |
|    80903 |  229 | `	  if( c == 'l' ){` |
...
| 21541877 |  235 | `    infop = 0;` |
| 21541877 |  236 | `    xtype = SXFMT_ERROR;` |
| 94420301 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 94420301 |  238 | `      if( c==aFmt[idx].fmttype ){` |
| 21541877 |  239 | `        infop = &aFmt[idx];` |
| 21541877 |  240 | `		xtype = infop->type;` |
| 21541877 |  241 | `        break;` |
|        - |  242 | `      }` |
| 36439217 |  243 | `    }` |
...
|        - |  263 | `    */` |
| 21541877 |  264 | `    switch( xtype ){` |
|    65435 |  265 | `      case SXFMT_RADIX:` |
|   130875 |  266 | `        if( flag_long > 0 ){` |
|    80903 |  267 | `			if( flag_long > 1 ){` |
|        - |  268 | `				/* BSD quad: expect a 64-bit integer */` |
|    80891 |  269 | `				longvalue = va_arg(ap,sxi64);` |
|    40448 |  270 | `			}else{` |
|       17 |  271 | `				longvalue = va_arg(ap,sxlong);` |
|        - |  272 | `			}` |
|    40454 |  273 | `		}else{` |
|    49977 |  274 | `			if( infop->flags & SXFLAG_SIGNED ){` |
|    26015 |  275 | `				longvalue = va_arg(ap,sxi32);` |
|    13010 |  276 | `			}else{` |
|    23967 |  277 | `				longvalue = va_arg(ap,sxu32);` |
|        - |  278 | `			}` |
|        - |  279 | `		}` |
|        - |  280 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|   130875 |  281 | `      if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|        - |  282 | `#if 1` |
|        - |  283 | `        /* For the format %#x, the value zero is printed "0" not "0x0".` |
|        - |  284 | `        ** I think this is stupid.*/` |
|   130875 |  285 | `        if( longvalue==0 ) flag_alternateform = 0;` |
|        - |  286 | `#else` |
...
|        - |  290 | `#endif` |
|   130875 |  291 | `        if( infop->flags & SXFLAG_SIGNED ){` |
|   106847 |  292 | `          if( longvalue<0 ){` |
...
|      599 |  296 | `            ulongvalue = (sxu64)0 - (sxu64)longvalue;` |
|      599 |  297 | `            prefix = '-';` |
|      302 |  298 | `          }else{` |
|   106253 |  299 | `            ulongvalue = (sxu64)longvalue;` |
|   106253 |  300 | `            if( flag_plussign )        prefix = '+';` |
|   106253 |  301 | `            else if( flag_blanksign )  prefix = ' ';` |
|   106253 |  302 | `            else                       prefix = 0;` |
|        - |  303 | `          }` |
|    53426 |  304 | `        }else{` |
|    24033 |  305 | `			ulongvalue = (sxu64)longvalue; /* print the full unsigned value as-is */` |
|    24033 |  306 | `			prefix = 0;` |
|        - |  307 | `		}` |
|   130875 |  308 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|     2618 |  309 | `          precision = width-(prefix!=0);` |
|     1307 |  310 | `        }` |
|   130875 |  311 | `        bufpt = &buf[SXFMT_BUFSIZ-1];` |
|        - |  312 | `        {` |
|        - |  313 | `          register char *cset;      /* Use registers for speed */` |
|        - |  314 | `          register int base;` |
|   130875 |  315 | `          cset = infop->charset;` |
|   130875 |  316 | `          base = infop->base;` |
|    65435 |  317 | `          do{                                           /* Convert to ascii */` |
|   312040 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|   312040 |  319 | `            ulongvalue = ulongvalue/base;` |
|   312040 |  320 | `          }while( ulongvalue>0 );` |
|        - |  321 | `        }` |
|   130875 |  322 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|   133088 |  323 | `        for(idx=precision-length; idx>0; idx--){` |
|     2217 |  324 | `          *(--bufpt) = '0';                             /* Zero pad */` |
|     1111 |  325 | `        }` |
|   130875 |  326 | `        if( prefix ) *(--bufpt) = prefix;               /* Add sign */` |
|   130875 |  327 | `        if( flag_alternateform && infop->prefix ){      /* Add "0" or "0x" */` |
|        - |  328 | `          char *pre, x;` |
...
|      ! 0 |  332 | `          }` |
|      ! 0 |  333 | `        }` |
|   130875 |  334 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|   130875 |  335 | `        break;` |
...
|      ! 0 |  496 | `        length = 1;` |
|      ! 0 |  497 | `        break;` |
|     5298 |  498 | `      case SXFMT_CHARX:` |
|    10601 |  499 | `        c = va_arg(ap,int);` |
|    10601 |  500 | `		buf[0] = (char)c;` |
|        - |  501 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|    10601 |  502 | `		if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|    10601 |  503 | `        if( precision>=0 ){` |
...
|    10601 |  509 | `        bufpt = buf;` |
|    10601 |  510 | `        break;` |
|  4292052 |  511 | `      case SXFMT_STRING:` |
|  8584109 |  512 | `        bufpt = va_arg(ap,char*);` |
|  8584109 |  513 | `        if( bufpt==0 ){` |
...
|       46 |  520 | `		  if( precision == 0 ){ length = 0; break; }` |
|      ! 0 |  521 | `          bufpt = " ";` |
|      ! 0 |  522 | `		  length = (int)sizeof(" ")-1;` |
|      ! 0 |  523 | `		  break;` |
|        - |  524 | `        }` |
|  8584067 |  525 | `		length = precision;` |
|  8584067 |  526 | `		if( precision < 0 ){` |
|        - |  527 | `			/* Symisc extension */` |
|  4316113 |  528 | `			length = (int)SyStrlen(bufpt);` |
|  2158054 |  529 | `		}` |
|  8584067 |  530 | `        if( precision>=0 && precision<length ) length = precision;` |
|  8584067 |  531 | `        break;` |
|  6408151 |  532 | `	case SXFMT_RAWSTR:{` |
|        - |  533 | `		/* Symisc extension */` |
| 12816307 |  534 | `		SyString *pStr = va_arg(ap,SyString *);` |
| 12816307 |  535 | `		if( pStr == 0 ){` |
|      ! 0 |  536 | `			 bufpt = " ";` |
|      ! 0 |  537 | `		     length = (int)sizeof(char);` |
|      ! 0 |  538 | `		     break;` |
|        - |  539 | `		}` |
| 12816307 |  540 | `		if( pStr->zString == 0 ){` |
...
|        8 |  545 | `		     break;` |
|        - |  546 | `		}` |
| 12816301 |  547 | `		bufpt = (char *)pStr->zString;` |
| 12816301 |  548 | `		length = (int)pStr->nByte;` |
| 12816301 |  549 | `		break;` |
|        - |  550 | `					  }` |
...
|        - |  561 | `    ** the output.` |
|        - |  562 | `    */` |
| 21541877 |  563 | `    if( !flag_leftjustify ){` |
|        - |  564 | `      register int nspace;` |
| 21541877 |  565 | `      nspace = width-length;` |
| 21541877 |  566 | `      if( nspace>0 ){` |
...
|       15 |  580 | `      }` |
| 10770936 |  581 | `    }` |
| 21541877 |  582 | `    if( length>0 ){` |
| 21541043 |  583 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
| 21541043 |  584 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  585 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  586 | `		}` |
| 10770519 |  587 | `    }` |
| 21541877 |  588 | `    if( flag_leftjustify ){` |
...
|      ! 0 |  605 | `      }` |
|      ! 0 |  606 | `    }` |
| 10770941 |  607 | `  }/* End for loop over the format string */` |
|  4145421 |  608 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|  4348491 |  609 | `}` |
|        - |  610 | `/* SPDX-SnippetEnd */` |
| 43560792 |  611 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|        5 |  612 | `{` |
| 43560797 |  613 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 43560797 |  614 | `	sxi32 rc = SXERR_ABORT;` |
| 43560797 |  615 | `	switch(pConsumer->nType){` |
...
|      151 |  619 | `			break;` |
| 21780321 |  620 | `	case SXFMT_CONS_BLOB:` |
|        - |  621 | `			/* Blob consumer */` |
| 43560647 |  622 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 43560642 |  623 | `			break;` |
|      ! 0 |  624 | `		default:` |
...
| 43560797 |  629 | `	pConsumer->nLen += nLen;` |
| 43560797 |  630 | `	pConsumer->rc = rc;` |
| 43560797 |  631 | `	return rc;` |
|        5 |  632 | `}` |
|  8696972 |  633 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|        5 |  634 | `{` |
|        - |  635 | `	SyFmtConsumer sCons;` |
|  8696977 |  636 | `	sCons.nType = nType;` |
|  8696977 |  637 | `	sCons.rc = SXRET_OK;` |
|  8696977 |  638 | `	sCons.nLen = 0;` |
|  8696977 |  639 | `	if( pOutLen ){` |
|   493207 |  640 | `		*pOutLen = 0;` |
|   246601 |  641 | `	}` |
|  8696977 |  642 | `	switch(nType){` |
...
|       11 |  651 | `		break;` |
|  4348481 |  652 | `		case SXFMT_CONS_BLOB:` |
|  8696967 |  653 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  8696967 |  654 | `			break;` |
|      ! 0 |  655 | `		default:` |
|      ! 0 |  656 | `			return SXERR_UNKNOWN;` |
|        - |  657 | `	}` |
|  8696977 |  658 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  8696977 |  659 | `	if( pOutLen ){` |
|   493207 |  660 | `		*pOutLen = sCons.nLen;` |
|   246601 |  661 | `	}` |
|  8696977 |  662 | `	return sCons.rc;` |
|  4348491 |  663 | `}` |
...
|       11 |  676 | `	return rc;` |
|        1 |  677 | `}` |
|   456114 |  678 | `PH7_PRIVATE sxu32 SyBlobFormat(SyBlob *pBlob,const char *zFormat,...)` |
|        5 |  679 | `{` |
|        - |  680 | `	va_list ap;` |
|        - |  681 | `	sxu32 n;` |
...
|        - |  685 | `	}` |
|        - |  686 | `#endif` |
|   456119 |  687 | `	va_start(ap,zFormat);` |
|   456119 |  688 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|   456119 |  689 | `	va_end(ap);` |
|   456119 |  690 | `	return n;` |
|        5 |  691 | `}` |
|    37088 |  692 | `PH7_PRIVATE sxu32 SyBlobFormatAp(SyBlob *pBlob,const char *zFormat,va_list ap)` |
|        5 |  693 | `{` |
|    37093 |  694 | `	sxu32 n = 0; /* cc warning */` |
|        - |  695 | `#if defined(UNTRUST)` |
|        - |  696 | `	if( SX_EMPTY_STR(zFormat) ){` |
|        - |  697 | `		return 0;` |
|        - |  698 | `	}` |
|        - |  699 | `#endif` |
|    37093 |  700 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    37093 |  701 | `	return n;` |
|        5 |  702 | `}` |
|  8203760 |  703 | `PH7_PRIVATE sxu32 SyBufferFormat(char *zBuf,sxu32 nLen,const char *zFormat,...)` |
|        5 |  704 | `{` |
|        - |  705 | `	SyBlob sBlob;` |
|        - |  706 | `	va_list ap;` |
|        - |  707 | `	sxu32 n;` |
...
|        - |  711 | `	}` |
|        - |  712 | `#endif` |
|  8203765 |  713 | `	if( SXRET_OK != SyBlobInitFromBuf(&sBlob,zBuf,nLen - 1) ){` |
|      ! 0 |  714 | `		return 0;` |
|        - |  715 | `	}` |
|  8203765 |  716 | `	va_start(ap,zFormat);` |
|  8203765 |  717 | `	FormatMount(SXFMT_CONS_BLOB,&sBlob,0,0,0,zFormat,ap);` |
|  8203765 |  718 | `	va_end(ap);` |
|  8203765 |  719 | `	n = SyBlobLength(&sBlob);` |
|        - |  720 | `	/* Append the null terminator */` |
|  8203765 |  721 | `	sBlob.mByte++;` |
|  8203765 |  722 | `	SyBlobAppend(&sBlob,"\0",sizeof(char));` |
|  8203765 |  723 | `	return n;` |
|  4101885 |  724 | `}` |
|        - |  725 |  |
