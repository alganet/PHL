...
|    4740 |   72 | `static int getdigit(sxlongreal *val,int *cnt)` |
|       4 |   73 | `{` |
|       - |   74 | `  sxlongreal d;` |
|       - |   75 | `  int digit;` |
|       - |   76 |  |
...
|     ! 0 |   78 | `	  return '0';` |
|       - |   79 | `  }` |
|    4744 |   80 | `  digit = (int)*val;` |
|    4744 |   81 | `  d = digit;` |
|    4744 |   82 | `   *val = (*val - d)*10.0;` |
|    4744 |   83 | `  return digit + '0' ;` |
|    2374 |   84 | `}` |
...
|       - |   90 | ` */` |
|  358798 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|       5 |   92 | `{` |
|       - |   93 | `	/*` |
...
|  358803 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|  358803 |  153 | `  length = 0;` |
|  358803 |  154 | `  bufpt = 0;` |
| 1315917 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
| 1249617 |  156 | `    if( c!='%' ){` |
|       - |  157 | `      unsigned int amt;` |
| 1163935 |  158 | `      bufpt = (char *)zFormat;` |
| 1163935 |  159 | `      amt = 1;` |
| 1845435 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
| 1163935 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
| 1163935 |  162 | `	  if( rc != SXRET_OK ){` |
|     ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|       - |  164 | `	  }` |
| 1163935 |  165 | `      if( c==0 ){` |
|  292503 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|       - |  167 | `	  }` |
|  435716 |  168 | `    }` |
|  957119 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|     ! 0 |  170 | `      errorflag = 1;` |
...
|  957119 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  957114 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  478557 |  180 | `    do{` |
|  957275 |  181 | `      switch( c ){` |
...
|  957114 |  187 | `        default:                                       break;` |
|       - |  188 | `      }` |
|  957275 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|     ! 0 |  198 | `      c = *++zFormat;` |
|     ! 0 |  199 | `    }else{` |
|  957319 |  200 | `      while( c>='0' && c<='9' ){` |
|     202 |  201 | `        width = width*10 + c - '0';` |
|     202 |  202 | `        c = *++zFormat;` |
|       2 |  203 | `      }` |
|       - |  204 | `    }` |
|  957119 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|     ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|     ! 0 |  207 | `    }` |
|       - |  208 | `    /* Get the precision */` |
|  957119 |  209 | `	precision = -1;` |
|  957119 |  210 | `    if( c=='.' ){` |
|  289497 |  211 | `      precision = 0;` |
|  289497 |  212 | `      c = *++zFormat;` |
|  289497 |  213 | `      if( c=='*' ){` |
|  289185 |  214 | `        precision = va_arg(ap,int);` |
|  289185 |  215 | `        if( precision<0 ) precision = -precision;` |
|  289185 |  216 | `        c = *++zFormat;` |
|  144595 |  217 | `      }else{` |
|     940 |  218 | `        while( c>='0' && c<='9' ){` |
|     628 |  219 | `          precision = precision*10 + c - '0';` |
|     628 |  220 | `          c = *++zFormat;` |
|       4 |  221 | `        }` |
|       - |  222 | `      }` |
|  144746 |  223 | `    }` |
|       - |  224 | `    /* Get the conversion type modifier */` |
|  957119 |  225 | `	flag_long = 0;` |
|  957119 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
|   55625 |  227 | `      flag_long = (c == 'q') ? 2 : 1;` |
|   55625 |  228 | `      c = *++zFormat;` |
|   55625 |  229 | `	  if( c == 'l' ){` |
...
|  957119 |  235 | `    infop = 0;` |
|  957119 |  236 | `    xtype = SXFMT_ERROR;` |
| 4268099 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 4268099 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  957119 |  239 | `        infop = &aFmt[idx];` |
|  957119 |  240 | `		xtype = infop->type;` |
|  957119 |  241 | `        break;` |
|       - |  242 | `      }` |
| 1655495 |  243 | `    }` |
...
|       - |  263 | `    */` |
|  957119 |  264 | `    switch( xtype ){` |
|   29546 |  265 | `      case SXFMT_RADIX:` |
|   59097 |  266 | `        if( flag_long > 0 ){` |
|   55625 |  267 | `			if( flag_long > 1 ){` |
|       - |  268 | `				/* BSD quad: expect a 64-bit integer */` |
|   55613 |  269 | `				longvalue = va_arg(ap,sxi64);` |
|   27809 |  270 | `			}else{` |
|      13 |  271 | `				longvalue = va_arg(ap,sxlong);` |
|       - |  272 | `			}` |
|   27815 |  273 | `		}else{` |
|    3477 |  274 | `			if( infop->flags & SXFLAG_SIGNED ){` |
|    1943 |  275 | `				longvalue = va_arg(ap,sxi32);` |
|     974 |  276 | `			}else{` |
|    1539 |  277 | `				longvalue = va_arg(ap,sxu32);` |
|       - |  278 | `			}` |
|       - |  279 | `		}` |
|       - |  280 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|   59097 |  281 | `      if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|       - |  282 | `#if 1` |
|       - |  283 | `        /* For the format %#x, the value zero is printed "0" not "0x0".` |
|       - |  284 | `        ** I think this is stupid.*/` |
|   59097 |  285 | `        if( longvalue==0 ) flag_alternateform = 0;` |
|       - |  286 | `#else` |
...
|       - |  290 | `#endif` |
|   59097 |  291 | `        if( infop->flags & SXFLAG_SIGNED ){` |
|   57563 |  292 | `          if( longvalue<0 ){` |
...
|     113 |  297 | `            prefix = '-';` |
|      58 |  298 | `          }else{` |
|   57453 |  299 | `            ulongvalue = (sxu64)longvalue;` |
|   57453 |  300 | `            if( flag_plussign )        prefix = '+';` |
|   57451 |  301 | `            else if( flag_blanksign )  prefix = ' ';` |
|   57451 |  302 | `            else                       prefix = 0;` |
|       - |  303 | `          }` |
|   28784 |  304 | `        }else{` |
|    1539 |  305 | `			ulongvalue = (sxu64)longvalue; /* print the full unsigned value as-is */` |
|    1539 |  306 | `			prefix = 0;` |
|       - |  307 | `		}` |
|   59097 |  308 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|     142 |  309 | `          precision = width-(prefix!=0);` |
|      70 |  310 | `        }` |
|   59097 |  311 | `        bufpt = &buf[SXFMT_BUFSIZ-1];` |
|       - |  312 | `        {` |
|       - |  313 | `          register char *cset;      /* Use registers for speed */` |
|       - |  314 | `          register int base;` |
|   59097 |  315 | `          cset = infop->charset;` |
|   59097 |  316 | `          base = infop->base;` |
|   29546 |  317 | `          do{                                           /* Convert to ascii */` |
|  177628 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|  177628 |  319 | `            ulongvalue = ulongvalue/base;` |
|  177628 |  320 | `          }while( ulongvalue>0 );` |
|       - |  321 | `        }` |
|   59097 |  322 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|   59427 |  323 | `        for(idx=precision-length; idx>0; idx--){` |
|     332 |  324 | `          *(--bufpt) = '0';                             /* Zero pad */` |
|     169 |  325 | `        }` |
|   59097 |  326 | `        if( prefix ) *(--bufpt) = prefix;               /* Add sign */` |
|   59097 |  327 | `        if( flag_alternateform && infop->prefix ){      /* Add "0" or "0x" */` |
|       - |  328 | `          char *pre, x;` |
...
|       1 |  332 | `          }` |
|       1 |  333 | `        }` |
|   59097 |  334 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|   59097 |  335 | `        break;` |
|     161 |  336 | `      case SXFMT_FLOAT:` |
|       - |  337 | `      case SXFMT_EXP:` |
|       - |  338 | `      case SXFMT_GENERIC:` |
|       - |  339 | `#ifndef SX_OMIT_FLOATINGPOINT` |
|     326 |  340 | `		realvalue = va_arg(ap,double);` |
|       - |  341 | `        /* handle NaN/Infinity specially before any arithmetic */` |
|     326 |  342 | `        if( PH7_IS_NAN(realvalue) ){` |
...
|       - |  349 | `        }` |
|     326 |  350 | `        if( PH7_IS_INF(realvalue) ){` |
...
|       - |  363 | `        }` |
|     326 |  364 | `        if( precision<0 ) precision = 6;         /* Set default precision */` |
|     326 |  365 | `        if( precision>SXFMT_BUFSIZ-40) precision = SXFMT_BUFSIZ-40;` |
|     326 |  366 | `        if( realvalue<0.0 ){` |
|      30 |  367 | `          realvalue = -realvalue;` |
|      30 |  368 | `          prefix = '-';` |
|      16 |  369 | `        }else{` |
|     298 |  370 | `          if( flag_plussign )          prefix = '+';` |
|     298 |  371 | `          else if( flag_blanksign )    prefix = ' ';` |
|     298 |  372 | `          else                         prefix = 0;` |
|       - |  373 | `        }` |
|     326 |  374 | `        if( infop->type==SXFMT_GENERIC && precision>0 ) precision--;` |
|     326 |  375 | `        rounder = 0.0;` |
|       - |  376 | `#if 0` |
...
|    4744 |  381 | `        for(idx=precision, rounder=0.5; idx>0; idx--, rounder*=0.1);` |
|       - |  382 | `#endif` |
|     326 |  383 | `        if( infop->type==SXFMT_FLOAT ) realvalue += rounder;` |
|       - |  384 | `        /* Normalize realvalue to within 10.0 > realvalue >= 1.0 */` |
|     326 |  385 | `        exp = 0;` |
|     326 |  386 | `        if( realvalue>0.0 ){` |
|     307 |  387 | `          while( realvalue>=1e8 && exp<=350 ){ realvalue *= 1e-8; exp+=8; }` |
|     481 |  388 | `          while( realvalue>=10.0 && exp<=350 ){ realvalue *= 0.1; exp++; }` |
|     297 |  389 | `          while( realvalue<1e-8 && exp>=-350 ){ realvalue *= 1e8; exp-=8; }` |
|     363 |  390 | `          while( realvalue<1.0 && exp>=-350 ){ realvalue *= 10.0; exp--; }` |
|     297 |  391 | `          if( exp>350 \|\| exp<-350 ){` |
...
|       - |  401 | `        */` |
|     326 |  402 | `        flag_exp = xtype==SXFMT_EXP;` |
|     326 |  403 | `        if( xtype!=SXFMT_FLOAT ){` |
|     326 |  404 | `          realvalue += rounder;` |
|     326 |  405 | `          if( realvalue>=10.0 ){ realvalue *= 0.1; exp++; }` |
|     161 |  406 | `        }` |
|     326 |  407 | `        if( xtype==SXFMT_GENERIC ){` |
|     326 |  408 | `          flag_rtz = !flag_alternateform;` |
|     326 |  409 | `          if( exp<-4 \|\| exp>precision ){` |
|     ! 0 |  410 | `            xtype = SXFMT_EXP;` |
|     ! 0 |  411 | `          }else{` |
|     326 |  412 | `            precision = precision - exp;` |
|     326 |  413 | `            xtype = SXFMT_FLOAT;` |
|       - |  414 | `          }` |
|     165 |  415 | `        }else{` |
|     ! 0 |  416 | `          flag_rtz = 0;` |
|       - |  417 | `        }` |
...
|       - |  421 | `        */` |
|     326 |  422 | `        nsd = 0;` |
|     487 |  423 | `        if( xtype==SXFMT_FLOAT && exp+precision<SXFMT_BUFSIZ-30 ){` |
|     326 |  424 | `          flag_dp = (precision>0 \|\| flag_alternateform);` |
|     326 |  425 | `          if( prefix ) *(bufpt++) = prefix;         /* Sign */` |
|     326 |  426 | `          if( exp<0 )  *(bufpt++) = '0';            /* Digits before "." */` |
|     820 |  427 | `          else for(; exp>=0; exp--) *(bufpt++) = (char)getdigit(&realvalue,&nsd);` |
|     326 |  428 | `          if( flag_dp ) *(bufpt++) = '.';           /* The decimal point */` |
|     346 |  429 | `          for(exp++; exp<0 && precision>0; precision--, exp++){` |
|      21 |  430 | `            *(bufpt++) = '0';` |
|      11 |  431 | `          }` |
|    4526 |  432 | `          while( (precision--)>0 ) *(bufpt++) = (char)getdigit(&realvalue,&nsd);` |
|     326 |  433 | `          *(bufpt--) = 0;                           /* Null terminate */` |
|     326 |  434 | `          if( flag_rtz && flag_dp ){     /* Remove trailing zeros and "." */` |
|    3586 |  435 | `            while( bufpt>=buf && *bufpt=='0' ) *(bufpt--) = 0;` |
|     326 |  436 | `            if( bufpt>=buf && *bufpt=='.' ) *(bufpt--) = 0;` |
|     161 |  437 | `          }` |
|     326 |  438 | `          bufpt++;                            /* point to next free slot */` |
|     165 |  439 | `        }else{    /* etEXP or etGENERIC */` |
...
|       3 |  496 | `        length = 1;` |
|       3 |  497 | `        break;` |
|    4764 |  498 | `      case SXFMT_CHARX:` |
|    9532 |  499 | `        c = va_arg(ap,int);` |
|    9532 |  500 | `		buf[0] = (char)c;` |
|       - |  501 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|    9532 |  502 | `		if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|    9532 |  503 | `        if( precision>=0 ){` |
...
|    9532 |  509 | `        bufpt = buf;` |
|    9532 |  510 | `        break;` |
|  145598 |  511 | `      case SXFMT_STRING:` |
|  291201 |  512 | `        bufpt = va_arg(ap,char*);` |
|  291201 |  513 | `        if( bufpt==0 ){` |
|     ! 0 |  514 | `          bufpt = " ";` |
|     ! 0 |  515 | `		  length = (int)sizeof(" ")-1;` |
|     ! 0 |  516 | `		  break;` |
|       - |  517 | `        }` |
|  291201 |  518 | `		length = precision;` |
|  291201 |  519 | `		if( precision < 0 ){` |
|       - |  520 | `			/* Symisc extension */` |
|    2021 |  521 | `			length = (int)SyStrlen(bufpt);` |
|    1008 |  522 | `		}` |
|  291201 |  523 | `        if( precision>=0 && precision<length ) length = precision;` |
|  291201 |  524 | `        break;` |
|  298487 |  525 | `	case SXFMT_RAWSTR:{` |
|       - |  526 | `		/* Symisc extension */` |
|  596979 |  527 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  596979 |  528 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|     ! 0 |  529 | `			 bufpt = " ";` |
|     ! 0 |  530 | `		     length = (int)sizeof(char);` |
|     ! 0 |  531 | `		     break;` |
|       - |  532 | `		}` |
|  596979 |  533 | `		bufpt = (char *)pStr->zString;` |
|  596979 |  534 | `		length = (int)pStr->nByte;` |
|  596979 |  535 | `		break;` |
|       - |  536 | `					  }` |
...
|       - |  547 | `    ** the output.` |
|       - |  548 | `    */` |
|  957119 |  549 | `    if( !flag_leftjustify ){` |
|       - |  550 | `      register int nspace;` |
|  957119 |  551 | `      nspace = width-length;` |
|  957119 |  552 | `      if( nspace>0 ){` |
...
|      18 |  566 | `      }` |
|  478557 |  567 | `    }` |
|  957119 |  568 | `    if( length>0 ){` |
|  956903 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  956903 |  570 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|       - |  572 | `		}` |
|  478449 |  573 | `    }` |
|  957119 |  574 | `    if( flag_leftjustify ){` |
...
|     ! 0 |  591 | `      }` |
|     ! 0 |  592 | `    }` |
|  478562 |  593 | `  }/* End for loop over the format string */` |
|   66305 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|  179404 |  595 | `}` |
|       - |  596 | `/* SPDX-SnippetEnd */` |
| 2120864 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|       5 |  598 | `{` |
| 2120869 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 2120869 |  600 | `	sxi32 rc = SXERR_ABORT;` |
| 2120869 |  601 | `	switch(pConsumer->nType){` |
...
|     157 |  605 | `			break;` |
| 1060354 |  606 | `	case SXFMT_CONS_BLOB:` |
|       - |  607 | `			/* Blob consumer */` |
| 2120713 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 2120708 |  609 | `			break;` |
|     ! 0 |  610 | `		default:` |
...
| 2120869 |  615 | `	pConsumer->nLen += nLen;` |
| 2120869 |  616 | `	pConsumer->rc = rc;` |
| 2120869 |  617 | `	return rc;` |
|       5 |  618 | `}` |
|  358798 |  619 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|       5 |  620 | `{` |
|       - |  621 | `	SyFmtConsumer sCons;` |
|  358803 |  622 | `	sCons.nType = nType;` |
|  358803 |  623 | `	sCons.rc = SXRET_OK;` |
|  358803 |  624 | `	sCons.nLen = 0;` |
|  358803 |  625 | `	if( pOutLen ){` |
|   69349 |  626 | `		*pOutLen = 0;` |
|   34672 |  627 | `	}` |
|  358803 |  628 | `	switch(nType){` |
...
|      13 |  637 | `		break;` |
|  179393 |  638 | `		case SXFMT_CONS_BLOB:` |
|  358791 |  639 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  358791 |  640 | `			break;` |
|     ! 0 |  641 | `		default:` |
|     ! 0 |  642 | `			return SXERR_UNKNOWN;` |
|       - |  643 | `	}` |
|  358803 |  644 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  358803 |  645 | `	if( pOutLen ){` |
|   69349 |  646 | `		*pOutLen = sCons.nLen;` |
|   34672 |  647 | `	}` |
|  358803 |  648 | `	return sCons.rc;` |
|  179404 |  649 | `}` |
...
|      13 |  662 | `	return rc;` |
|       1 |  663 | `}` |
|   67448 |  664 | `PH7_PRIVATE sxu32 SyBlobFormat(SyBlob *pBlob,const char *zFormat,...)` |
|       5 |  665 | `{` |
|       - |  666 | `	va_list ap;` |
|       - |  667 | `	sxu32 n;` |
...
|       - |  671 | `	}` |
|       - |  672 | `#endif` |
|   67453 |  673 | `	va_start(ap,zFormat);` |
|   67453 |  674 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|   67453 |  675 | `	va_end(ap);` |
|   67453 |  676 | `	return n;` |
|       5 |  677 | `}` |
|    1896 |  678 | `PH7_PRIVATE sxu32 SyBlobFormatAp(SyBlob *pBlob,const char *zFormat,va_list ap)` |
|       5 |  679 | `{` |
|    1901 |  680 | `	sxu32 n = 0; /* cc warning */` |
|       - |  681 | `#if defined(UNTRUST)` |
|       - |  682 | `	if( SX_EMPTY_STR(zFormat) ){` |
|       - |  683 | `		return 0;` |
|       - |  684 | `	}` |
|       - |  685 | `#endif` |
|    1901 |  686 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    1901 |  687 | `	return n;` |
|       5 |  688 | `}` |
|  289442 |  689 | `PH7_PRIVATE sxu32 SyBufferFormat(char *zBuf,sxu32 nLen,const char *zFormat,...)` |
|       5 |  690 | `{` |
|       - |  691 | `	SyBlob sBlob;` |
|       - |  692 | `	va_list ap;` |
|       - |  693 | `	sxu32 n;` |
...
|       - |  697 | `	}` |
|       - |  698 | `#endif` |
|  289447 |  699 | `	if( SXRET_OK != SyBlobInitFromBuf(&sBlob,zBuf,nLen - 1) ){` |
|     ! 0 |  700 | `		return 0;` |
|       - |  701 | `	}` |
|  289447 |  702 | `	va_start(ap,zFormat);` |
|  289447 |  703 | `	FormatMount(SXFMT_CONS_BLOB,&sBlob,0,0,0,zFormat,ap);` |
|  289447 |  704 | `	va_end(ap);` |
|  289447 |  705 | `	n = SyBlobLength(&sBlob);` |
|       - |  706 | `	/* Append the null terminator */` |
|  289447 |  707 | `	sBlob.mByte++;` |
|  289447 |  708 | `	SyBlobAppend(&sBlob,"\0",sizeof(char));` |
|  289447 |  709 | `	return n;` |
|  144726 |  710 | `}` |
|       - |  711 |  |
