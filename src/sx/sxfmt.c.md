...
|        - |   90 | ` */` |
|  2504262 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|        5 |   92 | `{` |
|        - |   93 | `	/*` |
...
|  2504267 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|        - |  151 | `  int rc;` |
|        - |  152 |  |
|  2504267 |  153 | `  length = 0;` |
|  2504267 |  154 | `  bufpt = 0;` |
|  9849749 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
|  9757661 |  156 | `    if( c!='%' ){` |
|        - |  157 | `      unsigned int amt;` |
|  9627475 |  158 | `      bufpt = (char *)zFormat;` |
|  9627475 |  159 | `      amt = 1;` |
| 15244841 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
|  9627475 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
|  9627475 |  162 | `	  if( rc != SXRET_OK ){` |
|      ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  164 | `	  }` |
|  9627475 |  165 | `      if( c==0 ){` |
|  2412179 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|        - |  167 | `	  }` |
|  3607648 |  168 | `    }` |
|  7345487 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|      ! 0 |  170 | `      errorflag = 1;` |
...
|  7345487 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  7345482 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  3672741 |  180 | `    do{` |
|  7346221 |  181 | `      switch( c ){` |
...
|  7345482 |  187 | `        default:                                       break;` |
|        - |  188 | `      }` |
|  7346221 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|      ! 0 |  198 | `      c = *++zFormat;` |
|      ! 0 |  199 | `    }else{` |
|  7346257 |  200 | `      while( c>='0' && c<='9' ){` |
|      773 |  201 | `        width = width*10 + c - '0';` |
|      773 |  202 | `        c = *++zFormat;` |
|        3 |  203 | `      }` |
|        - |  204 | `    }` |
|  7345487 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|      ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|      ! 0 |  207 | `    }` |
|        - |  208 | `    /* Get the precision */` |
|  7345487 |  209 | `	precision = -1;` |
|  7345487 |  210 | `    if( c=='.' ){` |
|  2383463 |  211 | `      precision = 0;` |
|  2383463 |  212 | `      c = *++zFormat;` |
|  2383463 |  213 | `      if( c=='*' ){` |
|  2383459 |  214 | `        precision = va_arg(ap,int);` |
|  2383459 |  215 | `        if( precision<0 ) precision = -precision;` |
|  2383459 |  216 | `        c = *++zFormat;` |
|  1191732 |  217 | `      }else{` |
|        9 |  218 | `        while( c>='0' && c<='9' ){` |
...
|  7345487 |  225 | `	flag_long = 0;` |
|  7345487 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
...
|  7345487 |  235 | `    infop = 0;` |
|  7345487 |  236 | `    xtype = SXFMT_ERROR;` |
| 33843791 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 33843791 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  7345487 |  239 | `        infop = &aFmt[idx];` |
|  7345487 |  240 | `		xtype = infop->type;` |
|  7345487 |  241 | `        break;` |
|        - |  242 | `      }` |
| 13249157 |  243 | `    }` |
...
|        - |  263 | `    */` |
|  7345487 |  264 | `    switch( xtype ){` |
|    34225 |  265 | `      case SXFMT_RADIX:` |
|    68455 |  266 | `        if( flag_long > 0 ){` |
...
|        - |  290 | `#endif` |
|    68455 |  291 | `        if( infop->flags & SXFLAG_SIGNED ){` |
|    63931 |  292 | `          if( longvalue<0 ){` |
...
|      195 |  297 | `            prefix = '-';` |
|       99 |  298 | `          }else{` |
|    63739 |  299 | `            ulongvalue = (sxu64)longvalue;` |
|    63739 |  300 | `            if( flag_plussign )        prefix = '+';` |
|    63739 |  301 | `            else if( flag_blanksign )  prefix = ' ';` |
|    63739 |  302 | `            else                       prefix = 0;` |
|        - |  303 | `          }` |
|    31968 |  304 | `        }else{` |
|     4529 |  305 | `			ulongvalue = (sxu64)longvalue; /* print the full unsigned value as-is */` |
|     4529 |  306 | `			prefix = 0;` |
|        - |  307 | `		}` |
|    68455 |  308 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|      722 |  309 | `          precision = width-(prefix!=0);` |
|      360 |  310 | `        }` |
|    68455 |  311 | `        bufpt = &buf[SXFMT_BUFSIZ-1];` |
|        - |  312 | `        {` |
|        - |  313 | `          register char *cset;      /* Use registers for speed */` |
|        - |  314 | `          register int base;` |
|    68455 |  315 | `          cset = infop->charset;` |
|    68455 |  316 | `          base = infop->base;` |
|    34225 |  317 | `          do{                                           /* Convert to ascii */` |
|   193967 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|   193967 |  319 | `            ulongvalue = ulongvalue/base;` |
|   193967 |  320 | `          }while( ulongvalue>0 );` |
|        - |  321 | `        }` |
|    68455 |  322 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    69211 |  323 | `        for(idx=precision-length; idx>0; idx--){` |
|      758 |  324 | `          *(--bufpt) = '0';                             /* Zero pad */` |
|      380 |  325 | `        }` |
|    68455 |  326 | `        if( prefix ) *(--bufpt) = prefix;               /* Add sign */` |
|    68455 |  327 | `        if( flag_alternateform && infop->prefix ){      /* Add "0" or "0x" */` |
|        - |  328 | `          char *pre, x;` |
...
|        1 |  332 | `          }` |
|        1 |  333 | `        }` |
|    68455 |  334 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    68455 |  335 | `        break;` |
...
|     9647 |  509 | `        bufpt = buf;` |
|     9647 |  510 | `        break;` |
|  1236732 |  511 | `      case SXFMT_STRING:` |
|  2473469 |  512 | `        bufpt = va_arg(ap,char*);` |
|  2473469 |  513 | `        if( bufpt==0 ){` |
|      ! 0 |  514 | `          bufpt = " ";` |
|      ! 0 |  515 | `		  length = (int)sizeof(" ")-1;` |
|      ! 0 |  516 | `		  break;` |
|        - |  517 | `        }` |
|  2473469 |  518 | `		length = precision;` |
|  2473469 |  519 | `		if( precision < 0 ){` |
|        - |  520 | `			/* Symisc extension */` |
|    90011 |  521 | `			length = (int)SyStrlen(bufpt);` |
|    45003 |  522 | `		}` |
|  2473469 |  523 | `        if( precision>=0 && precision<length ) length = precision;` |
|  2473469 |  524 | `        break;` |
|  2396949 |  525 | `	case SXFMT_RAWSTR:{` |
|        - |  526 | `		/* Symisc extension */` |
|  4793903 |  527 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  4793903 |  528 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|      ! 0 |  529 | `			 bufpt = " ";` |
|      ! 0 |  530 | `		     length = (int)sizeof(char);` |
|      ! 0 |  531 | `		     break;` |
|        - |  532 | `		}` |
|  4793903 |  533 | `		bufpt = (char *)pStr->zString;` |
|  4793903 |  534 | `		length = (int)pStr->nByte;` |
|  4793903 |  535 | `		break;` |
|        - |  536 | `					  }` |
...
|        - |  547 | `    ** the output.` |
|        - |  548 | `    */` |
|  7345487 |  549 | `    if( !flag_leftjustify ){` |
|        - |  550 | `      register int nspace;` |
|  7345487 |  551 | `      nspace = width-length;` |
|  7345487 |  552 | `      if( nspace>0 ){` |
...
|       18 |  566 | `      }` |
|  3672741 |  567 | `    }` |
|  7345487 |  568 | `    if( length>0 ){` |
|  7345145 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  7345145 |  570 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  572 | `		}` |
|  3672570 |  573 | `    }` |
|  7345487 |  574 | `    if( flag_leftjustify ){` |
...
|      ! 0 |  591 | `      }` |
|      ! 0 |  592 | `    }` |
|  3672746 |  593 | `  }/* End for loop over the format string */` |
|    92093 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|  1252136 |  595 | `}` |
|        - |  596 | `/* SPDX-SnippetEnd */` |
| 16972646 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|        5 |  598 | `{` |
| 16972651 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 16972651 |  600 | `	sxi32 rc = SXERR_ABORT;` |
| 16972651 |  601 | `	switch(pConsumer->nType){` |
...
|      181 |  605 | `			break;` |
|  8486233 |  606 | `	case SXFMT_CONS_BLOB:` |
|        - |  607 | `			/* Blob consumer */` |
| 16972471 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 16972466 |  609 | `			break;` |
|      ! 0 |  610 | `		default:` |
...
| 16972651 |  615 | `	pConsumer->nLen += nLen;` |
| 16972651 |  616 | `	pConsumer->rc = rc;` |
| 16972651 |  617 | `	return rc;` |
|        5 |  618 | `}` |
|  2504262 |  619 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|        5 |  620 | `{` |
|        - |  621 | `	SyFmtConsumer sCons;` |
|  2504267 |  622 | `	sCons.nType = nType;` |
|  2504267 |  623 | `	sCons.rc = SXRET_OK;` |
|  2504267 |  624 | `	sCons.nLen = 0;` |
|  2504267 |  625 | `	if( pOutLen ){` |
|   116305 |  626 | `		*pOutLen = 0;` |
|    58150 |  627 | `	}` |
|  2504267 |  628 | `	switch(nType){` |
...
|       13 |  637 | `		break;` |
|  1252125 |  638 | `		case SXFMT_CONS_BLOB:` |
|  2504255 |  639 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  2504255 |  640 | `			break;` |
|      ! 0 |  641 | `		default:` |
|      ! 0 |  642 | `			return SXERR_UNKNOWN;` |
|        - |  643 | `	}` |
|  2504267 |  644 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  2504267 |  645 | `	if( pOutLen ){` |
|   116305 |  646 | `		*pOutLen = sCons.nLen;` |
|    58150 |  647 | `	}` |
|  2504267 |  648 | `	return sCons.rc;` |
|  1252136 |  649 | `}` |
...
|       13 |  662 | `	return rc;` |
|        1 |  663 | `}` |
|    93490 |  664 | `PH7_PRIVATE sxu32 SyBlobFormat(SyBlob *pBlob,const char *zFormat,...)` |
|        5 |  665 | `{` |
|        - |  666 | `	va_list ap;` |
|        - |  667 | `	sxu32 n;` |
...
|        - |  671 | `	}` |
|        - |  672 | `#endif` |
|    93495 |  673 | `	va_start(ap,zFormat);` |
|    93495 |  674 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    93495 |  675 | `	va_end(ap);` |
|    93495 |  676 | `	return n;` |
|        5 |  677 | `}` |
|    22810 |  678 | `PH7_PRIVATE sxu32 SyBlobFormatAp(SyBlob *pBlob,const char *zFormat,va_list ap)` |
|        5 |  679 | `{` |
|    22815 |  680 | `	sxu32 n = 0; /* cc warning */` |
|        - |  681 | `#if defined(UNTRUST)` |
|        - |  682 | `	if( SX_EMPTY_STR(zFormat) ){` |
|        - |  683 | `		return 0;` |
|        - |  684 | `	}` |
|        - |  685 | `#endif` |
|    22815 |  686 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    22815 |  687 | `	return n;` |
|        5 |  688 | `}` |
