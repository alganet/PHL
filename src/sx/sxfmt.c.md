...
|        - |   90 | ` */` |
|  2527552 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|        5 |   92 | `{` |
|        - |   93 | `	/*` |
...
|  2527557 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|        - |  151 | `  int rc;` |
|        - |  152 |  |
|  2527557 |  153 | `  length = 0;` |
|  2527557 |  154 | `  bufpt = 0;` |
|  9935709 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
|  9839873 |  156 | `    if( c!='%' ){` |
|        - |  157 | `      unsigned int amt;` |
|  9705285 |  158 | `      bufpt = (char *)zFormat;` |
|  9705285 |  159 | `      amt = 1;` |
| 15365505 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
|  9705285 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
|  9705285 |  162 | `	  if( rc != SXRET_OK ){` |
|      ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  164 | `	  }` |
|  9705285 |  165 | `      if( c==0 ){` |
|  2431721 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|        - |  167 | `	  }` |
|  3636782 |  168 | `    }` |
|  7408157 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|      ! 0 |  170 | `      errorflag = 1;` |
...
|  7408157 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  7408152 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  3704076 |  180 | `    do{` |
|  7409509 |  181 | `      switch( c ){` |
...
|  7408152 |  187 | `        default:                                       break;` |
|        - |  188 | `      }` |
|  7409509 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|      ! 0 |  198 | `      c = *++zFormat;` |
|      ! 0 |  199 | `    }else{` |
|  7409553 |  200 | `      while( c>='0' && c<='9' ){` |
|     1399 |  201 | `        width = width*10 + c - '0';` |
|     1399 |  202 | `        c = *++zFormat;` |
|        3 |  203 | `      }` |
|        - |  204 | `    }` |
|  7408157 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|      ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|      ! 0 |  207 | `    }` |
|        - |  208 | `    /* Get the precision */` |
|  7408157 |  209 | `	precision = -1;` |
|  7408157 |  210 | `    if( c=='.' ){` |
|  2402601 |  211 | `      precision = 0;` |
|  2402601 |  212 | `      c = *++zFormat;` |
|  2402601 |  213 | `      if( c=='*' ){` |
|  2402589 |  214 | `        precision = va_arg(ap,int);` |
|  2402589 |  215 | `        if( precision<0 ) precision = -precision;` |
|  2402589 |  216 | `        c = *++zFormat;` |
|  1201297 |  217 | `      }else{` |
...
|  7408157 |  225 | `	flag_long = 0;` |
|  7408157 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
|    62289 |  227 | `      flag_long = (c == 'q') ? 2 : 1;` |
|    62289 |  228 | `      c = *++zFormat;` |
|    62289 |  229 | `	  if( c == 'l' ){` |
...
|  7408157 |  235 | `    infop = 0;` |
|  7408157 |  236 | `    xtype = SXFMT_ERROR;` |
| 34120305 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 34120305 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  7408157 |  239 | `        infop = &aFmt[idx];` |
|  7408157 |  240 | `		xtype = infop->type;` |
|  7408157 |  241 | `        break;` |
|        - |  242 | `      }` |
| 13356079 |  243 | `    }` |
...
|        - |  263 | `    */` |
|  7408157 |  264 | `    switch( xtype ){` |
|    35947 |  265 | `      case SXFMT_RADIX:` |
|    71899 |  266 | `        if( flag_long > 0 ){` |
|    62289 |  267 | `			if( flag_long > 1 ){` |
|        - |  268 | `				/* BSD quad: expect a 64-bit integer */` |
|    62277 |  269 | `				longvalue = va_arg(ap,sxi64);` |
|    31141 |  270 | `			}else{` |
...
|    71899 |  281 | `      if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|        - |  282 | `#if 1` |
|        - |  283 | `        /* For the format %#x, the value zero is printed "0" not "0x0".` |
|        - |  284 | `        ** I think this is stupid.*/` |
|    71899 |  285 | `        if( longvalue==0 ) flag_alternateform = 0;` |
|        - |  286 | `#else` |
...
|        - |  290 | `#endif` |
|    71899 |  291 | `        if( infop->flags & SXFLAG_SIGNED ){` |
|    67355 |  292 | `          if( longvalue<0 ){` |
...
|      221 |  297 | `            prefix = '-';` |
|      112 |  298 | `          }else{` |
|    67137 |  299 | `            ulongvalue = (sxu64)longvalue;` |
|    67137 |  300 | `            if( flag_plussign )        prefix = '+';` |
|    67137 |  301 | `            else if( flag_blanksign )  prefix = ' ';` |
|    67137 |  302 | `            else                       prefix = 0;` |
|        - |  303 | `          }` |
|    33680 |  304 | `        }else{` |
|     4549 |  305 | `			ulongvalue = (sxu64)longvalue; /* print the full unsigned value as-is */` |
|     4549 |  306 | `			prefix = 0;` |
|        - |  307 | `		}` |
|    71899 |  308 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|     1340 |  309 | `          precision = width-(prefix!=0);` |
|      669 |  310 | `        }` |
|    71899 |  311 | `        bufpt = &buf[SXFMT_BUFSIZ-1];` |
|        - |  312 | `        {` |
|        - |  313 | `          register char *cset;      /* Use registers for speed */` |
|        - |  314 | `          register int base;` |
|    71899 |  315 | `          cset = infop->charset;` |
|    71899 |  316 | `          base = infop->base;` |
|    35947 |  317 | `          do{                                           /* Convert to ascii */` |
|   203745 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|   203745 |  319 | `            ulongvalue = ulongvalue/base;` |
|   203745 |  320 | `          }while( ulongvalue>0 );` |
|        - |  321 | `        }` |
|    71899 |  322 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    73003 |  323 | `        for(idx=precision-length; idx>0; idx--){` |
|     1106 |  324 | `          *(--bufpt) = '0';                             /* Zero pad */` |
|      556 |  325 | `        }` |
|    71899 |  326 | `        if( prefix ) *(--bufpt) = prefix;               /* Add sign */` |
|    71899 |  327 | `        if( flag_alternateform && infop->prefix ){      /* Add "0" or "0x" */` |
|        - |  328 | `          char *pre, x;` |
...
|        1 |  332 | `          }` |
|        1 |  333 | `        }` |
|    71899 |  334 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    71899 |  335 | `        break;` |
...
|      ! 0 |  496 | `        length = 1;` |
|      ! 0 |  497 | `        break;` |
|     4930 |  498 | `      case SXFMT_CHARX:` |
|     9865 |  499 | `        c = va_arg(ap,int);` |
|     9865 |  500 | `		buf[0] = (char)c;` |
|        - |  501 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|     9865 |  502 | `		if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|     9865 |  503 | `        if( precision>=0 ){` |
...
|     9865 |  509 | `        bufpt = buf;` |
|     9865 |  510 | `        break;` |
|  1246956 |  511 | `      case SXFMT_STRING:` |
|  2493917 |  512 | `        bufpt = va_arg(ap,char*);` |
|  2493917 |  513 | `        if( bufpt==0 ){` |
|      ! 0 |  514 | `          bufpt = " ";` |
|      ! 0 |  515 | `		  length = (int)sizeof(" ")-1;` |
|      ! 0 |  516 | `		  break;` |
|        - |  517 | `        }` |
|  2493917 |  518 | `		length = precision;` |
|  2493917 |  519 | `		if( precision < 0 ){` |
|        - |  520 | `			/* Symisc extension */` |
|    91321 |  521 | `			length = (int)SyStrlen(bufpt);` |
|    45658 |  522 | `		}` |
|  2493917 |  523 | `        if( precision>=0 && precision<length ) length = precision;` |
|  2493917 |  524 | `        break;` |
|  2416229 |  525 | `	case SXFMT_RAWSTR:{` |
|        - |  526 | `		/* Symisc extension */` |
|  4832463 |  527 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  4832463 |  528 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|      ! 0 |  529 | `			 bufpt = " ";` |
|      ! 0 |  530 | `		     length = (int)sizeof(char);` |
|      ! 0 |  531 | `		     break;` |
|        - |  532 | `		}` |
|  4832463 |  533 | `		bufpt = (char *)pStr->zString;` |
|  4832463 |  534 | `		length = (int)pStr->nByte;` |
|  4832463 |  535 | `		break;` |
|        - |  536 | `					  }` |
...
|        - |  547 | `    ** the output.` |
|        - |  548 | `    */` |
|  7408157 |  549 | `    if( !flag_leftjustify ){` |
|        - |  550 | `      register int nspace;` |
|  7408157 |  551 | `      nspace = width-length;` |
|  7408157 |  552 | `      if( nspace>0 ){` |
...
|       18 |  566 | `      }` |
|  3704076 |  567 | `    }` |
|  7408157 |  568 | `    if( length>0 ){` |
|  7407815 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  7407815 |  570 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  572 | `		}` |
|  3703905 |  573 | `    }` |
|  7408157 |  574 | `    if( flag_leftjustify ){` |
...
|      ! 0 |  591 | `      }` |
|      ! 0 |  592 | `    }` |
|  3704081 |  593 | `  }/* End for loop over the format string */` |
|    95841 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|  1263781 |  595 | `}` |
|        - |  596 | `/* SPDX-SnippetEnd */` |
| 17113126 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|        5 |  598 | `{` |
| 17113131 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 17113131 |  600 | `	sxi32 rc = SXERR_ABORT;` |
| 17113131 |  601 | `	switch(pConsumer->nType){` |
...
|      181 |  605 | `			break;` |
|  8556473 |  606 | `	case SXFMT_CONS_BLOB:` |
|        - |  607 | `			/* Blob consumer */` |
| 17112951 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 17112946 |  609 | `			break;` |
|      ! 0 |  610 | `		default:` |
...
| 17113131 |  615 | `	pConsumer->nLen += nLen;` |
| 17113131 |  616 | `	pConsumer->rc = rc;` |
| 17113131 |  617 | `	return rc;` |
|        5 |  618 | `}` |
|  2527552 |  619 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|        5 |  620 | `{` |
|        - |  621 | `	SyFmtConsumer sCons;` |
|  2527557 |  622 | `	sCons.nType = nType;` |
|  2527557 |  623 | `	sCons.rc = SXRET_OK;` |
|  2527557 |  624 | `	sCons.nLen = 0;` |
|  2527557 |  625 | `	if( pOutLen ){` |
|   120413 |  626 | `		*pOutLen = 0;` |
|    60204 |  627 | `	}` |
|  2527557 |  628 | `	switch(nType){` |
...
|       13 |  637 | `		break;` |
|  1263770 |  638 | `		case SXFMT_CONS_BLOB:` |
|  2527545 |  639 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  2527545 |  640 | `			break;` |
|      ! 0 |  641 | `		default:` |
|      ! 0 |  642 | `			return SXERR_UNKNOWN;` |
|        - |  643 | `	}` |
|  2527557 |  644 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  2527557 |  645 | `	if( pOutLen ){` |
|   120413 |  646 | `		*pOutLen = sCons.nLen;` |
|    60204 |  647 | `	}` |
|  2527557 |  648 | `	return sCons.rc;` |
|  1263781 |  649 | `}` |
...
|       13 |  662 | `	return rc;` |
|        1 |  663 | `}` |
|    96650 |  664 | `PH7_PRIVATE sxu32 SyBlobFormat(SyBlob *pBlob,const char *zFormat,...)` |
|        5 |  665 | `{` |
|        - |  666 | `	va_list ap;` |
|        - |  667 | `	sxu32 n;` |
...
|        - |  671 | `	}` |
|        - |  672 | `#endif` |
|    96655 |  673 | `	va_start(ap,zFormat);` |
|    96655 |  674 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    96655 |  675 | `	va_end(ap);` |
|    96655 |  676 | `	return n;` |
|        5 |  677 | `}` |
|    23758 |  678 | `PH7_PRIVATE sxu32 SyBlobFormatAp(SyBlob *pBlob,const char *zFormat,va_list ap)` |
|        5 |  679 | `{` |
|    23763 |  680 | `	sxu32 n = 0; /* cc warning */` |
|        - |  681 | `#if defined(UNTRUST)` |
|        - |  682 | `	if( SX_EMPTY_STR(zFormat) ){` |
|        - |  683 | `		return 0;` |
|        - |  684 | `	}` |
|        - |  685 | `#endif` |
|    23763 |  686 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    23763 |  687 | `	return n;` |
|        5 |  688 | `}` |
|  2407132 |  689 | `PH7_PRIVATE sxu32 SyBufferFormat(char *zBuf,sxu32 nLen,const char *zFormat,...)` |
|        5 |  690 | `{` |
|        - |  691 | `	SyBlob sBlob;` |
|        - |  692 | `	va_list ap;` |
|        - |  693 | `	sxu32 n;` |
...
|        - |  697 | `	}` |
|        - |  698 | `#endif` |
|  2407137 |  699 | `	if( SXRET_OK != SyBlobInitFromBuf(&sBlob,zBuf,nLen - 1) ){` |
|      ! 0 |  700 | `		return 0;` |
|        - |  701 | `	}` |
|  2407137 |  702 | `	va_start(ap,zFormat);` |
|  2407137 |  703 | `	FormatMount(SXFMT_CONS_BLOB,&sBlob,0,0,0,zFormat,ap);` |
|  2407137 |  704 | `	va_end(ap);` |
|  2407137 |  705 | `	n = SyBlobLength(&sBlob);` |
|        - |  706 | `	/* Append the null terminator */` |
|  2407137 |  707 | `	sBlob.mByte++;` |
|  2407137 |  708 | `	SyBlobAppend(&sBlob,"\0",sizeof(char));` |
|  2407137 |  709 | `	return n;` |
|  1203571 |  710 | `}` |
|        - |  711 |  |
