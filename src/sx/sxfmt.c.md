...
|  358843 |  153 | `  length = 0;` |
|  358843 |  154 | `  bufpt = 0;` |
| 1316219 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
| 1249993 |  156 | `    if( c!='%' ){` |
|       - |  157 | `      unsigned int amt;` |
| 1164407 |  158 | `      bufpt = (char *)zFormat;` |
| 1164407 |  159 | `      amt = 1;` |
| 1845597 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
| 1164407 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
| 1164407 |  162 | `	  if( rc != SXRET_OK ){` |
|     ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|       - |  164 | `	  }` |
| 1164407 |  165 | `      if( c==0 ){` |
|  292617 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|       - |  167 | `	  }` |
|  435895 |  168 | `    }` |
|  957381 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|     ! 0 |  170 | `      errorflag = 1;` |
...
|  957381 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  957376 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  478688 |  180 | `    do{` |
|  957537 |  181 | `      switch( c ){` |
...
|  957376 |  187 | `        default:                                       break;` |
|       - |  188 | `      }` |
|  957537 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|     ! 0 |  198 | `      c = *++zFormat;` |
|     ! 0 |  199 | `    }else{` |
|  957581 |  200 | `      while( c>='0' && c<='9' ){` |
|     202 |  201 | `        width = width*10 + c - '0';` |
|     202 |  202 | `        c = *++zFormat;` |
|       2 |  203 | `      }` |
|       - |  204 | `    }` |
|  957381 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|     ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|     ! 0 |  207 | `    }` |
|       - |  208 | `    /* Get the precision */` |
|  957381 |  209 | `	precision = -1;` |
|  957381 |  210 | `    if( c=='.' ){` |
|  289619 |  211 | `      precision = 0;` |
|  289619 |  212 | `      c = *++zFormat;` |
|  289619 |  213 | `      if( c=='*' ){` |
|  289311 |  214 | `        precision = va_arg(ap,int);` |
|  289311 |  215 | `        if( precision<0 ) precision = -precision;` |
|  289311 |  216 | `        c = *++zFormat;` |
|  144658 |  217 | `      }else{` |
...
|  957381 |  225 | `	flag_long = 0;` |
|  957381 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
|   55569 |  227 | `      flag_long = (c == 'q') ? 2 : 1;` |
|   55569 |  228 | `      c = *++zFormat;` |
|   55569 |  229 | `	  if( c == 'l' ){` |
...
|  957381 |  235 | `    infop = 0;` |
|  957381 |  236 | `    xtype = SXFMT_ERROR;` |
| 4269507 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 4269507 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  957381 |  239 | `        infop = &aFmt[idx];` |
|  957381 |  240 | `		xtype = infop->type;` |
|  957381 |  241 | `        break;` |
|       - |  242 | `      }` |
| 1656068 |  243 | `    }` |
...
|       - |  263 | `    */` |
|  957381 |  264 | `    switch( xtype ){` |
|   29516 |  265 | `      case SXFMT_RADIX:` |
|   59037 |  266 | `        if( flag_long > 0 ){` |
|   55569 |  267 | `			if( flag_long > 1 ){` |
|       - |  268 | `				/* BSD quad: expect a 64-bit integer */` |
|   55557 |  269 | `				longvalue = va_arg(ap,sxi64);` |
|   27781 |  270 | `			}else{` |
...
|   59037 |  281 | `      if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|       - |  282 | `#if 1` |
|       - |  283 | `        /* For the format %#x, the value zero is printed "0" not "0x0".` |
|       - |  284 | `        ** I think this is stupid.*/` |
|   59037 |  285 | `        if( longvalue==0 ) flag_alternateform = 0;` |
|       - |  286 | `#else` |
...
|       - |  290 | `#endif` |
|   59037 |  291 | `        if( infop->flags & SXFLAG_SIGNED ){` |
|   57503 |  292 | `          if( longvalue<0 ){` |
...
|     113 |  297 | `            prefix = '-';` |
|      58 |  298 | `          }else{` |
|   57393 |  299 | `            ulongvalue = (sxu64)longvalue;` |
|   57393 |  300 | `            if( flag_plussign )        prefix = '+';` |
|   57391 |  301 | `            else if( flag_blanksign )  prefix = ' ';` |
|   57391 |  302 | `            else                       prefix = 0;` |
|       - |  303 | `          }` |
|   28754 |  304 | `        }else{` |
|    1539 |  305 | `			ulongvalue = (sxu64)longvalue; /* print the full unsigned value as-is */` |
|    1539 |  306 | `			prefix = 0;` |
|       - |  307 | `		}` |
|   59037 |  308 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|     142 |  309 | `          precision = width-(prefix!=0);` |
|      70 |  310 | `        }` |
|   59037 |  311 | `        bufpt = &buf[SXFMT_BUFSIZ-1];` |
|       - |  312 | `        {` |
|       - |  313 | `          register char *cset;      /* Use registers for speed */` |
|       - |  314 | `          register int base;` |
|   59037 |  315 | `          cset = infop->charset;` |
|   59037 |  316 | `          base = infop->base;` |
|   29516 |  317 | `          do{                                           /* Convert to ascii */` |
|  177536 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|  177536 |  319 | `            ulongvalue = ulongvalue/base;` |
|  177536 |  320 | `          }while( ulongvalue>0 );` |
|       - |  321 | `        }` |
|   59037 |  322 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|   59376 |  323 | `        for(idx=precision-length; idx>0; idx--){` |
|     341 |  324 | `          *(--bufpt) = '0';                             /* Zero pad */` |
|     171 |  325 | `        }` |
|   59037 |  326 | `        if( prefix ) *(--bufpt) = prefix;               /* Add sign */` |
|   59037 |  327 | `        if( flag_alternateform && infop->prefix ){      /* Add "0" or "0x" */` |
|       - |  328 | `          char *pre, x;` |
...
|       1 |  332 | `          }` |
|       1 |  333 | `        }` |
|   59037 |  334 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|   59037 |  335 | `        break;` |
...
|       3 |  496 | `        length = 1;` |
|       3 |  497 | `        break;` |
|    4758 |  498 | `      case SXFMT_CHARX:` |
|    9520 |  499 | `        c = va_arg(ap,int);` |
|    9520 |  500 | `		buf[0] = (char)c;` |
|       - |  501 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|    9520 |  502 | `		if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|    9520 |  503 | `        if( precision>=0 ){` |
...
|    9520 |  509 | `        bufpt = buf;` |
|    9520 |  510 | `        break;` |
|  145657 |  511 | `      case SXFMT_STRING:` |
|  291319 |  512 | `        bufpt = va_arg(ap,char*);` |
|  291319 |  513 | `        if( bufpt==0 ){` |
|     ! 0 |  514 | `          bufpt = " ";` |
|     ! 0 |  515 | `		  length = (int)sizeof(" ")-1;` |
|     ! 0 |  516 | `		  break;` |
|       - |  517 | `        }` |
|  291319 |  518 | `		length = precision;` |
|  291319 |  519 | `		if( precision < 0 ){` |
|       - |  520 | `			/* Symisc extension */` |
|    2013 |  521 | `			length = (int)SyStrlen(bufpt);` |
|    1004 |  522 | `		}` |
|  291319 |  523 | `        if( precision>=0 && precision<length ) length = precision;` |
|  291319 |  524 | `        break;` |
|  298597 |  525 | `	case SXFMT_RAWSTR:{` |
|       - |  526 | `		/* Symisc extension */` |
|  597199 |  527 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  597199 |  528 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|     ! 0 |  529 | `			 bufpt = " ";` |
|     ! 0 |  530 | `		     length = (int)sizeof(char);` |
|     ! 0 |  531 | `		     break;` |
|       - |  532 | `		}` |
|  597199 |  533 | `		bufpt = (char *)pStr->zString;` |
|  597199 |  534 | `		length = (int)pStr->nByte;` |
|  597199 |  535 | `		break;` |
|       - |  536 | `					  }` |
...
|       - |  547 | `    ** the output.` |
|       - |  548 | `    */` |
|  957381 |  549 | `    if( !flag_leftjustify ){` |
|       - |  550 | `      register int nspace;` |
|  957381 |  551 | `      nspace = width-length;` |
|  957381 |  552 | `      if( nspace>0 ){` |
...
|      18 |  566 | `      }` |
|  478688 |  567 | `    }` |
|  957381 |  568 | `    if( length>0 ){` |
|  957165 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  957165 |  570 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|       - |  572 | `		}` |
|  478580 |  573 | `    }` |
|  957381 |  574 | `    if( flag_leftjustify ){` |
...
|     ! 0 |  591 | `      }` |
|     ! 0 |  592 | `    }` |
|  478693 |  593 | `  }/* End for loop over the format string */` |
|   66231 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|  179424 |  595 | `}` |
|       - |  596 | `/* SPDX-SnippetEnd */` |
| 2121598 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|       5 |  598 | `{` |
| 2121603 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 2121603 |  600 | `	sxi32 rc = SXERR_ABORT;` |
| 2121603 |  601 | `	switch(pConsumer->nType){` |
...
|     157 |  605 | `			break;` |
| 1060721 |  606 | `	case SXFMT_CONS_BLOB:` |
|       - |  607 | `			/* Blob consumer */` |
| 2121447 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 2121442 |  609 | `			break;` |
|     ! 0 |  610 | `		default:` |
...
| 2121603 |  615 | `	pConsumer->nLen += nLen;` |
| 2121603 |  616 | `	pConsumer->rc = rc;` |
| 2121603 |  617 | `	return rc;` |
|       5 |  618 | `}` |
...
|      13 |  662 | `	return rc;` |
|       1 |  663 | `}` |
|   67366 |  664 | `PH7_PRIVATE sxu32 SyBlobFormat(SyBlob *pBlob,const char *zFormat,...)` |
|       5 |  665 | `{` |
|       - |  666 | `	va_list ap;` |
|       - |  667 | `	sxu32 n;` |
...
|       - |  671 | `	}` |
|       - |  672 | `#endif` |
|   67371 |  673 | `	va_start(ap,zFormat);` |
|   67371 |  674 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|   67371 |  675 | `	va_end(ap);` |
|   67371 |  676 | `	return n;` |
|       5 |  677 | `}` |
...
|    1901 |  687 | `	return n;` |
|       5 |  688 | `}` |
|  289564 |  689 | `PH7_PRIVATE sxu32 SyBufferFormat(char *zBuf,sxu32 nLen,const char *zFormat,...)` |
|       5 |  690 | `{` |
|       - |  691 | `	SyBlob sBlob;` |
|       - |  692 | `	va_list ap;` |
|       - |  693 | `	sxu32 n;` |
...
|       - |  697 | `	}` |
|       - |  698 | `#endif` |
|  289569 |  699 | `	if( SXRET_OK != SyBlobInitFromBuf(&sBlob,zBuf,nLen - 1) ){` |
|     ! 0 |  700 | `		return 0;` |
|       - |  701 | `	}` |
|  289569 |  702 | `	va_start(ap,zFormat);` |
|  289569 |  703 | `	FormatMount(SXFMT_CONS_BLOB,&sBlob,0,0,0,zFormat,ap);` |
|  289569 |  704 | `	va_end(ap);` |
|  289569 |  705 | `	n = SyBlobLength(&sBlob);` |
|       - |  706 | `	/* Append the null terminator */` |
|  289569 |  707 | `	sBlob.mByte++;` |
|  289569 |  708 | `	SyBlobAppend(&sBlob,"\0",sizeof(char));` |
|  289569 |  709 | `	return n;` |
|  144787 |  710 | `}` |
|       - |  711 |  |
