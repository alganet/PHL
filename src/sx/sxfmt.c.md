...
|  305302 |  137 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|  305302 |  152 | `  length = 0;` |
|  305302 |  153 | `  bufpt = 0;` |
| 1104814 |  154 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
| 1039660 |  155 | `    if( c!='%' ){` |
|       - |  156 | `      unsigned int amt;` |
|  955022 |  157 | `      bufpt = (char *)zFormat;` |
|  955022 |  158 | `      amt = 1;` |
| 1510636 |  159 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
|  955022 |  160 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
|  955022 |  161 | `	  if( rc != SXRET_OK ){` |
|     ! 0 |  162 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|       - |  163 | `	  }` |
|  955022 |  164 | `      if( c==0 ){` |
|  240148 |  165 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|       - |  166 | `	  }` |
|  357437 |  167 | `    }` |
|  799514 |  168 | `    if( (c=(*++zFormat))==0 ){` |
|     ! 0 |  169 | `      errorflag = 1;` |
...
|  799514 |  177 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
...
|       - |  187 | `      }` |
|  799632 |  188 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|     ! 0 |  197 | `      c = *++zFormat;` |
|     ! 0 |  198 | `    }else{` |
|  799674 |  199 | `      while( c>='0' && c<='9' ){` |
|     162 |  200 | `        width = width*10 + c - '0';` |
|     162 |  201 | `        c = *++zFormat;` |
|       2 |  202 | `      }` |
|       - |  203 | `    }` |
|  799514 |  204 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|     ! 0 |  205 | `      width = SXFMT_BUFSIZ-10;` |
|     ! 0 |  206 | `    }` |
|       - |  207 | `    /* Get the precision */` |
|  799514 |  208 | `	precision = -1;` |
|  799514 |  209 | `    if( c=='.' ){` |
|  238092 |  210 | `      precision = 0;` |
|  238092 |  211 | `      c = *++zFormat;` |
|  238092 |  212 | `      if( c=='*' ){` |
|  237832 |  213 | `        precision = va_arg(ap,int);` |
|  237832 |  214 | `        if( precision<0 ) precision = -precision;` |
|  237832 |  215 | `        c = *++zFormat;` |
|  118917 |  216 | `      }else{` |
...
|  799514 |  224 | `	flag_long = 0;` |
|  799514 |  225 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
|   54418 |  226 | `      flag_long = (c == 'q') ? 2 : 1;` |
|   54418 |  227 | `      c = *++zFormat;` |
|   54418 |  228 | `	  if( c == 'l' ){` |
...
|  799514 |  234 | `    infop = 0;` |
|  799514 |  235 | `    xtype = SXFMT_ERROR;` |
| 3539310 |  236 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 3539310 |  237 | `      if( c==aFmt[idx].fmttype ){` |
|  799514 |  238 | `        infop = &aFmt[idx];` |
|  799514 |  239 | `		xtype = infop->type;` |
|  799514 |  240 | `        break;` |
|       - |  241 | `      }` |
| 1369900 |  242 | `    }` |
...
|       - |  262 | `    */` |
|  799514 |  263 | `    switch( xtype ){` |
|   28225 |  264 | `      case SXFMT_RADIX:` |
|   56452 |  265 | `        if( flag_long > 0 ){` |
|   54418 |  266 | `			if( flag_long > 1 ){` |
|       - |  267 | `				/* BSD quad: expect a 64-bit integer */` |
|   54406 |  268 | `				longvalue = va_arg(ap,sxi64);` |
|   27204 |  269 | `			}else{` |
|      13 |  270 | `				longvalue = va_arg(ap,sxlong);` |
|       - |  271 | `			}` |
|   27210 |  272 | `		}else{` |
|    2036 |  273 | `			if( infop->flags & SXFLAG_SIGNED ){` |
|    1062 |  274 | `				longvalue = va_arg(ap,sxi32);` |
|     532 |  275 | `			}else{` |
|     976 |  276 | `				longvalue = va_arg(ap,sxu32);` |
|       - |  277 | `			}` |
|       - |  278 | `		}` |
|       - |  279 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|   56452 |  280 | `      if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|       - |  281 | `#if 1` |
|       - |  282 | `        /* For the format %#x, the value zero is printed "0" not "0x0".` |
|       - |  283 | `        ** I think this is stupid.*/` |
|   56452 |  284 | `        if( longvalue==0 ) flag_alternateform = 0;` |
|       - |  285 | `#else` |
...
|       - |  289 | `#endif` |
|   56452 |  290 | `        if( infop->flags & SXFLAG_SIGNED ){` |
|   55468 |  291 | `          if( longvalue<0 ){` |
...
|     ! 0 |  297 | `			}` |
|      96 |  298 | `            prefix = '-';` |
|   55421 |  299 | `          }else if( flag_plussign )  prefix = '+';` |
|   55372 |  300 | `          else if( flag_blanksign )  prefix = ' ';` |
|   55372 |  301 | `          else                       prefix = 0;` |
|   27735 |  302 | `        }else{` |
|     986 |  303 | `			if( longvalue<0 ){` |
...
|     986 |  311 | `			prefix = 0;` |
|       - |  312 | `		}` |
|   56452 |  313 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|     101 |  314 | `          precision = width-(prefix!=0);` |
|      50 |  315 | `        }` |
|   56452 |  316 | `        bufpt = &buf[SXFMT_BUFSIZ-1];` |
|       - |  317 | `        {` |
|       - |  318 | `          register char *cset;      /* Use registers for speed */` |
|       - |  319 | `          register int base;` |
|   56452 |  320 | `          cset = infop->charset;` |
|   56452 |  321 | `          base = infop->base;` |
|   28225 |  322 | `          do{                                           /* Convert to ascii */` |
|  173692 |  323 | `            *(--bufpt) = cset[longvalue%base];` |
|  173692 |  324 | `            longvalue = longvalue/base;` |
|  173692 |  325 | `          }while( longvalue>0 );` |
|       - |  326 | `        }` |
|   56452 |  327 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|   56513 |  328 | `        for(idx=precision-length; idx>0; idx--){` |
|      62 |  329 | `          *(--bufpt) = '0';                             /* Zero pad */` |
|      33 |  330 | `        }` |
|   56452 |  331 | `        if( prefix ) *(--bufpt) = prefix;               /* Add sign */` |
|   56452 |  332 | `        if( flag_alternateform && infop->prefix ){      /* Add "0" or "0x" */` |
|       - |  333 | `          char *pre, x;` |
...
|       2 |  337 | `          }` |
|       2 |  338 | `        }` |
|   56452 |  339 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|   56452 |  340 | `        break;` |
...
|    9700 |  504 | `        c = va_arg(ap,int);` |
|    9700 |  505 | `		buf[0] = (char)c;` |
|       - |  506 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|    9700 |  507 | `		if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|    9700 |  508 | `        if( precision>=0 ){` |
...
|  239016 |  517 | `        bufpt = va_arg(ap,char*);` |
|  239016 |  518 | `        if( bufpt==0 ){` |
|     ! 0 |  519 | `          bufpt = " ";` |
|     ! 0 |  520 | `		  length = (int)sizeof(" ")-1;` |
|     ! 0 |  521 | `		  break;` |
|       - |  522 | `        }` |
|  239016 |  523 | `		length = precision;` |
|  239016 |  524 | `		if( precision < 0 ){` |
|       - |  525 | `			/* Symisc extension */` |
|    1188 |  526 | `			length = (int)SyStrlen(bufpt);` |
|     593 |  527 | `		}` |
|  239016 |  528 | `        if( precision>=0 && precision<length ) length = precision;` |
|  239016 |  529 | `        break;` |
|  247038 |  530 | `	case SXFMT_RAWSTR:{` |
|       - |  531 | `		/* Symisc extension */` |
|  494078 |  532 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  494078 |  533 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|     ! 0 |  534 | `			 bufpt = " ";` |
|     ! 0 |  535 | `		     length = (int)sizeof(char);` |
|     ! 0 |  536 | `		     break;` |
|       - |  537 | `		}` |
|  494078 |  538 | `		bufpt = (char *)pStr->zString;` |
|  494078 |  539 | `		length = (int)pStr->nByte;` |
|  494078 |  540 | `		break;` |
|       - |  541 | `					  }` |
...
|       - |  552 | `    ** the output.` |
|       - |  553 | `    */` |
|  799514 |  554 | `    if( !flag_leftjustify ){` |
|       - |  555 | `      register int nspace;` |
|  799514 |  556 | `      nspace = width-length;` |
|  799514 |  557 | `      if( nspace>0 ){` |
...
|      18 |  571 | `      }` |
|  399756 |  572 | `    }` |
|  799514 |  573 | `    if( length>0 ){` |
|  799490 |  574 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  799490 |  575 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  576 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|       - |  577 | `		}` |
|  399744 |  578 | `    }` |
|  799514 |  579 | `    if( flag_leftjustify ){` |
...
|     ! 0 |  596 | `      }` |
|     ! 0 |  597 | `    }` |
|  399758 |  598 | `  }/* End for loop over the format string */` |
|   65156 |  599 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|  152652 |  600 |  |
|       - |  601 | `/* SPDX-SnippetEnd */` |
| 1754544 |  602 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|       2 |  603 |  |
| 1754546 |  604 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 1754546 |  605 | `	sxi32 rc = SXERR_ABORT;` |
| 1754546 |  606 | `	switch(pConsumer->nType){` |
...
|       - |  612 | `			/* Blob consumer */` |
| 1754390 |  613 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 1754388 |  614 | `			break;` |
|     ! 0 |  615 | `		default:` |
...
| 1754546 |  620 | `	pConsumer->nLen += nLen;` |
| 1754546 |  621 | `	pConsumer->rc = rc;` |
| 1754546 |  622 | `	return rc;` |
|       2 |  623 |  |
...
|  305302 |  627 | `	sCons.nType = nType;` |
|  305302 |  628 | `	sCons.rc = SXRET_OK;` |
|  305302 |  629 | `	sCons.nLen = 0;` |
|  305302 |  630 | `	if( pOutLen ){` |
|   67464 |  631 | `		*pOutLen = 0;` |
|   33731 |  632 | `	}` |
|  305302 |  633 | `	switch(nType){` |
...
|  305290 |  644 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  305290 |  645 | `			break;` |
|     ! 0 |  646 | `		default:` |
|     ! 0 |  647 | `			return SXERR_UNKNOWN;` |
|       - |  648 | `	}` |
|  305302 |  649 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  305302 |  650 | `	if( pOutLen ){` |
|   67464 |  651 | `		*pOutLen = sCons.nLen;` |
|   33731 |  652 | `	}` |
|  305302 |  653 | `	return sCons.rc;` |
|  152652 |  654 |  |
...
|       - |  676 | `	}` |
|       - |  677 | `#endif` |
|   65970 |  678 | `	va_start(ap,zFormat);` |
|   65970 |  679 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|   65970 |  680 | `	va_end(ap);` |
|   65970 |  681 | `	return n;` |
|       2 |  682 |  |
...
|       - |  702 | `	}` |
|       - |  703 | `#endif` |
|  237828 |  704 | `	if( SXRET_OK != SyBlobInitFromBuf(&sBlob,zBuf,nLen - 1) ){` |
|     ! 0 |  705 | `		return 0;` |
|       - |  706 | `	}` |
|  237828 |  707 | `	va_start(ap,zFormat);` |
|  237828 |  708 | `	FormatMount(SXFMT_CONS_BLOB,&sBlob,0,0,0,zFormat,ap);` |
|  237828 |  709 | `	va_end(ap);` |
|  237828 |  710 | `	n = SyBlobLength(&sBlob);` |
|       - |  711 | `	/* Append the null terminator */` |
|  237828 |  712 | `	sBlob.mByte++;` |
|  237828 |  713 | `	SyBlobAppend(&sBlob,"\0",sizeof(char));` |
|  237828 |  714 | `	return n;` |
|  118915 |  715 |  |
|       - |  716 |  |
