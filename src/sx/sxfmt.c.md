...
|        - |   90 | ` */` |
|  1446854 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|        5 |   92 | `{` |
|        - |   93 | `	/*` |
...
|  1446859 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|        - |  151 | `  int rc;` |
|        - |  152 |  |
|  1446859 |  153 | `  length = 0;` |
|  1446859 |  154 | `  bufpt = 0;` |
|  5664975 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
|  5597299 |  156 | `    if( c!='%' ){` |
|        - |  157 | `      unsigned int amt;` |
|  5509697 |  158 | `      bufpt = (char *)zFormat;` |
|  5509697 |  159 | `      amt = 1;` |
|  8383407 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
|  5509697 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
|  5509697 |  162 | `	  if( rc != SXRET_OK ){` |
|      ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  164 | `	  }` |
|  5509697 |  165 | `      if( c==0 ){` |
|  1379183 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|        - |  167 | `	  }` |
|  2065257 |  168 | `    }` |
|  4218121 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|      ! 0 |  170 | `      errorflag = 1;` |
...
|  4218121 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  4218116 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  2109058 |  180 | `    do{` |
|  4218375 |  181 | `      switch( c ){` |
...
|  4218116 |  187 | `        default:                                       break;` |
|        - |  188 | `      }` |
|  4218375 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|      ! 0 |  198 | `      c = *++zFormat;` |
|      ! 0 |  199 | `    }else{` |
|  4218441 |  200 | `      while( c>='0' && c<='9' ){` |
|      323 |  201 | `        width = width*10 + c - '0';` |
|      323 |  202 | `        c = *++zFormat;` |
|        3 |  203 | `      }` |
|        - |  204 | `    }` |
|  4218121 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|      ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|      ! 0 |  207 | `    }` |
|        - |  208 | `    /* Get the precision */` |
|  4218121 |  209 | `	precision = -1;` |
|  4218121 |  210 | `    if( c=='.' ){` |
...
|  4218121 |  225 | `	flag_long = 0;` |
|  4218121 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
|    56987 |  227 | `      flag_long = (c == 'q') ? 2 : 1;` |
|    56987 |  228 | `      c = *++zFormat;` |
|    56987 |  229 | `	  if( c == 'l' ){` |
...
|  4218121 |  235 | `    infop = 0;` |
|  4218121 |  236 | `    xtype = SXFMT_ERROR;` |
| 19477635 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 19477635 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  4218121 |  239 | `        infop = &aFmt[idx];` |
|  4218121 |  240 | `		xtype = infop->type;` |
|  4218121 |  241 | `        break;` |
|        - |  242 | `      }` |
|  7629762 |  243 | `    }` |
...
|        - |  263 | `    */` |
|  4218121 |  264 | `    switch( xtype ){` |
|    30472 |  265 | `      case SXFMT_RADIX:` |
|    60949 |  266 | `        if( flag_long > 0 ){` |
|    56987 |  267 | `			if( flag_long > 1 ){` |
|        - |  268 | `				/* BSD quad: expect a 64-bit integer */` |
|    56975 |  269 | `				longvalue = va_arg(ap,sxi64);` |
|    28490 |  270 | `			}else{` |
|       13 |  271 | `				longvalue = va_arg(ap,sxlong);` |
|        - |  272 | `			}` |
|    28496 |  273 | `		}else{` |
|     3967 |  274 | `			if( infop->flags & SXFLAG_SIGNED ){` |
|     2269 |  275 | `				longvalue = va_arg(ap,sxi32);` |
|     1137 |  276 | `			}else{` |
|     1703 |  277 | `				longvalue = va_arg(ap,sxu32);` |
|        - |  278 | `			}` |
|        - |  279 | `		}` |
|        - |  280 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|    60949 |  281 | `      if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|        - |  282 | `#if 1` |
|        - |  283 | `        /* For the format %#x, the value zero is printed "0" not "0x0".` |
|        - |  284 | `        ** I think this is stupid.*/` |
|    60949 |  285 | `        if( longvalue==0 ) flag_alternateform = 0;` |
|        - |  286 | `#else` |
...
|        - |  290 | `#endif` |
|    60949 |  291 | `        if( infop->flags & SXFLAG_SIGNED ){` |
|    59197 |  292 | `          if( longvalue<0 ){` |
...
|      167 |  297 | `            prefix = '-';` |
|       85 |  298 | `          }else{` |
|    59033 |  299 | `            ulongvalue = (sxu64)longvalue;` |
|    59033 |  300 | `            if( flag_plussign )        prefix = '+';` |
|    59031 |  301 | `            else if( flag_blanksign )  prefix = ' ';` |
|    59031 |  302 | `            else                       prefix = 0;` |
|        - |  303 | `          }` |
|    29601 |  304 | `        }else{` |
|     1757 |  305 | `			ulongvalue = (sxu64)longvalue; /* print the full unsigned value as-is */` |
|     1757 |  306 | `			prefix = 0;` |
|        - |  307 | `		}` |
|    60949 |  308 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|      240 |  309 | `          precision = width-(prefix!=0);` |
|      119 |  310 | `        }` |
|    60949 |  311 | `        bufpt = &buf[SXFMT_BUFSIZ-1];` |
|        - |  312 | `        {` |
|        - |  313 | `          register char *cset;      /* Use registers for speed */` |
|        - |  314 | `          register int base;` |
|    60949 |  315 | `          cset = infop->charset;` |
|    60949 |  316 | `          base = infop->base;` |
|    30472 |  317 | `          do{                                           /* Convert to ascii */` |
|   182003 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|   182003 |  319 | `            ulongvalue = ulongvalue/base;` |
|   182003 |  320 | `          }while( ulongvalue>0 );` |
|        - |  321 | `        }` |
|    60949 |  322 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    61367 |  323 | `        for(idx=precision-length; idx>0; idx--){` |
|      420 |  324 | `          *(--bufpt) = '0';                             /* Zero pad */` |
|      209 |  325 | `        }` |
|    60949 |  326 | `        if( prefix ) *(--bufpt) = prefix;               /* Add sign */` |
|    60949 |  327 | `        if( flag_alternateform && infop->prefix ){      /* Add "0" or "0x" */` |
|        - |  328 | `          char *pre, x;` |
...
|        1 |  332 | `          }` |
|        1 |  333 | `        }` |
|    60949 |  334 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    60949 |  335 | `        break;` |
...
|      ! 0 |  496 | `        length = 1;` |
|      ! 0 |  497 | `        break;` |
|     4893 |  498 | `      case SXFMT_CHARX:` |
|     9791 |  499 | `        c = va_arg(ap,int);` |
|     9791 |  500 | `		buf[0] = (char)c;` |
|        - |  501 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|     9791 |  502 | `		if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|     9791 |  503 | `        if( precision>=0 ){` |
...
|  1377679 |  524 | `        break;` |
|  1384851 |  525 | `	case SXFMT_RAWSTR:{` |
|        - |  526 | `		/* Symisc extension */` |
|  2769707 |  527 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  2769707 |  528 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|      ! 0 |  529 | `			 bufpt = " ";` |
|      ! 0 |  530 | `		     length = (int)sizeof(char);` |
|      ! 0 |  531 | `		     break;` |
|        - |  532 | `		}` |
|  2769707 |  533 | `		bufpt = (char *)pStr->zString;` |
|  2769707 |  534 | `		length = (int)pStr->nByte;` |
|  2769707 |  535 | `		break;` |
|        - |  536 | `					  }` |
...
|        - |  547 | `    ** the output.` |
|        - |  548 | `    */` |
|  4218121 |  549 | `    if( !flag_leftjustify ){` |
|        - |  550 | `      register int nspace;` |
|  4218121 |  551 | `      nspace = width-length;` |
|  4218121 |  552 | `      if( nspace>0 ){` |
...
|       18 |  566 | `      }` |
|  2109058 |  567 | `    }` |
|  4218121 |  568 | `    if( length>0 ){` |
|  4217905 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  4217905 |  570 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  572 | `		}` |
|  2108950 |  573 | `    }` |
|  4218121 |  574 | `    if( flag_leftjustify ){` |
...
|      ! 0 |  591 | `      }` |
|      ! 0 |  592 | `    }` |
|  2109063 |  593 | `  }/* End for loop over the format string */` |
|    67681 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|   723432 |  595 | `}` |
|        - |  596 | `/* SPDX-SnippetEnd */` |
|  9727628 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|        5 |  598 | `{` |
|  9727633 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
|  9727633 |  600 | `	sxi32 rc = SXERR_ABORT;` |
|  9727633 |  601 | `	switch(pConsumer->nType){` |
...
|      157 |  605 | `			break;` |
|  4863736 |  606 | `	case SXFMT_CONS_BLOB:` |
|        - |  607 | `			/* Blob consumer */` |
|  9727477 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
|  9727472 |  609 | `			break;` |
|      ! 0 |  610 | `		default:` |
...
|  9727633 |  615 | `	pConsumer->nLen += nLen;` |
|  9727633 |  616 | `	pConsumer->rc = rc;` |
|  9727633 |  617 | `	return rc;` |
|        5 |  618 | `}` |
|  1446854 |  619 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|        5 |  620 | `{` |
|        - |  621 | `	SyFmtConsumer sCons;` |
|  1446859 |  622 | `	sCons.nType = nType;` |
|  1446859 |  623 | `	sCons.rc = SXRET_OK;` |
|  1446859 |  624 | `	sCons.nLen = 0;` |
|  1446859 |  625 | `	if( pOutLen ){` |
|    71035 |  626 | `		*pOutLen = 0;` |
|    35515 |  627 | `	}` |
|  1446859 |  628 | `	switch(nType){` |
...
|       13 |  637 | `		break;` |
|   723421 |  638 | `		case SXFMT_CONS_BLOB:` |
|  1446847 |  639 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  1446847 |  640 | `			break;` |
|      ! 0 |  641 | `		default:` |
|      ! 0 |  642 | `			return SXERR_UNKNOWN;` |
|        - |  643 | `	}` |
|  1446859 |  644 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  1446859 |  645 | `	if( pOutLen ){` |
|    71035 |  646 | `		*pOutLen = sCons.nLen;` |
|    35515 |  647 | `	}` |
|  1446859 |  648 | `	return sCons.rc;` |
|   723432 |  649 | `}` |
...
|       13 |  662 | `	return rc;` |
|        1 |  663 | `}` |
|    68692 |  664 | `PH7_PRIVATE sxu32 SyBlobFormat(SyBlob *pBlob,const char *zFormat,...)` |
|        5 |  665 | `{` |
|        - |  666 | `	va_list ap;` |
|        - |  667 | `	sxu32 n;` |
...
|        - |  671 | `	}` |
|        - |  672 | `#endif` |
|    68697 |  673 | `	va_start(ap,zFormat);` |
|    68697 |  674 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    68697 |  675 | `	va_end(ap);` |
|    68697 |  676 | `	return n;` |
|        5 |  677 | `}` |
...
|     2343 |  687 | `	return n;` |
|        5 |  688 | `}` |
|  1375812 |  689 | `PH7_PRIVATE sxu32 SyBufferFormat(char *zBuf,sxu32 nLen,const char *zFormat,...)` |
|        5 |  690 | `{` |
|        - |  691 | `	SyBlob sBlob;` |
|        - |  692 | `	va_list ap;` |
|        - |  693 | `	sxu32 n;` |
...
|        - |  697 | `	}` |
|        - |  698 | `#endif` |
|  1375817 |  699 | `	if( SXRET_OK != SyBlobInitFromBuf(&sBlob,zBuf,nLen - 1) ){` |
|      ! 0 |  700 | `		return 0;` |
|        - |  701 | `	}` |
|  1375817 |  702 | `	va_start(ap,zFormat);` |
|  1375817 |  703 | `	FormatMount(SXFMT_CONS_BLOB,&sBlob,0,0,0,zFormat,ap);` |
|  1375817 |  704 | `	va_end(ap);` |
|  1375817 |  705 | `	n = SyBlobLength(&sBlob);` |
|        - |  706 | `	/* Append the null terminator */` |
|  1375817 |  707 | `	sBlob.mByte++;` |
|  1375817 |  708 | `	SyBlobAppend(&sBlob,"\0",sizeof(char));` |
|  1375817 |  709 | `	return n;` |
|   687911 |  710 | `}` |
|        - |  711 |  |
