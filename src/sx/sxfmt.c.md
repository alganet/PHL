...
|       - |   90 | ` */` |
|  358868 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|       5 |   92 | `{` |
|       - |   93 | `	/*` |
...
|  358873 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|  358873 |  153 | `  length = 0;` |
|  358873 |  154 | `  bufpt = 0;` |
| 1316295 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
| 1250047 |  156 | `    if( c!='%' ){` |
|       - |  157 | `      unsigned int amt;` |
| 1164431 |  158 | `      bufpt = (char *)zFormat;` |
| 1164431 |  159 | `      amt = 1;` |
| 1845659 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
| 1164431 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
| 1164431 |  162 | `	  if( rc != SXRET_OK ){` |
|     ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|       - |  164 | `	  }` |
| 1164431 |  165 | `      if( c==0 ){` |
|  292625 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|       - |  167 | `	  }` |
|  435903 |  168 | `    }` |
|  957427 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|     ! 0 |  170 | `      errorflag = 1;` |
...
|  957427 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  957422 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  478711 |  180 | `    do{` |
|  957583 |  181 | `      switch( c ){` |
...
|  957422 |  187 | `        default:                                       break;` |
|       - |  188 | `      }` |
|  957583 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|     ! 0 |  198 | `      c = *++zFormat;` |
|     ! 0 |  199 | `    }else{` |
|  957627 |  200 | `      while( c>='0' && c<='9' ){` |
|     202 |  201 | `        width = width*10 + c - '0';` |
|     202 |  202 | `        c = *++zFormat;` |
|       2 |  203 | `      }` |
|       - |  204 | `    }` |
|  957427 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|     ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|     ! 0 |  207 | `    }` |
|       - |  208 | `    /* Get the precision */` |
|  957427 |  209 | `	precision = -1;` |
|  957427 |  210 | `    if( c=='.' ){` |
|  289623 |  211 | `      precision = 0;` |
|  289623 |  212 | `      c = *++zFormat;` |
|  289623 |  213 | `      if( c=='*' ){` |
|  289315 |  214 | `        precision = va_arg(ap,int);` |
|  289315 |  215 | `        if( precision<0 ) precision = -precision;` |
|  289315 |  216 | `        c = *++zFormat;` |
|  144660 |  217 | `      }else{` |
...
|  957427 |  225 | `	flag_long = 0;` |
|  957427 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
...
|  957427 |  235 | `    infop = 0;` |
|  957427 |  236 | `    xtype = SXFMT_ERROR;` |
| 4269645 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 4269645 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  957427 |  239 | `        infop = &aFmt[idx];` |
|  957427 |  240 | `		xtype = infop->type;` |
|  957427 |  241 | `        break;` |
|       - |  242 | `      }` |
| 1656114 |  243 | `    }` |
...
|       - |  263 | `    */` |
|  957427 |  264 | `    switch( xtype ){` |
|   29527 |  265 | `      case SXFMT_RADIX:` |
|   59059 |  266 | `        if( flag_long > 0 ){` |
...
|   59059 |  281 | `      if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|       - |  282 | `#if 1` |
|       - |  283 | `        /* For the format %#x, the value zero is printed "0" not "0x0".` |
|       - |  284 | `        ** I think this is stupid.*/` |
|   59059 |  285 | `        if( longvalue==0 ) flag_alternateform = 0;` |
|       - |  286 | `#else` |
...
|       - |  290 | `#endif` |
|   59059 |  291 | `        if( infop->flags & SXFLAG_SIGNED ){` |
|   57525 |  292 | `          if( longvalue<0 ){` |
...
|     113 |  297 | `            prefix = '-';` |
|      58 |  298 | `          }else{` |
|   57415 |  299 | `            ulongvalue = (sxu64)longvalue;` |
|   57415 |  300 | `            if( flag_plussign )        prefix = '+';` |
|   57413 |  301 | `            else if( flag_blanksign )  prefix = ' ';` |
|   57413 |  302 | `            else                       prefix = 0;` |
|       - |  303 | `          }` |
|   28765 |  304 | `        }else{` |
|    1539 |  305 | `			ulongvalue = (sxu64)longvalue; /* print the full unsigned value as-is */` |
|    1539 |  306 | `			prefix = 0;` |
|       - |  307 | `		}` |
|   59059 |  308 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|     142 |  309 | `          precision = width-(prefix!=0);` |
|      70 |  310 | `        }` |
|   59059 |  311 | `        bufpt = &buf[SXFMT_BUFSIZ-1];` |
|       - |  312 | `        {` |
|       - |  313 | `          register char *cset;      /* Use registers for speed */` |
|       - |  314 | `          register int base;` |
|   59059 |  315 | `          cset = infop->charset;` |
|   59059 |  316 | `          base = infop->base;` |
|   29527 |  317 | `          do{                                           /* Convert to ascii */` |
|  177579 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|  177579 |  319 | `            ulongvalue = ulongvalue/base;` |
|  177579 |  320 | `          }while( ulongvalue>0 );` |
|       - |  321 | `        }` |
|   59059 |  322 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|   59385 |  323 | `        for(idx=precision-length; idx>0; idx--){` |
|     328 |  324 | `          *(--bufpt) = '0';                             /* Zero pad */` |
|     165 |  325 | `        }` |
|   59059 |  326 | `        if( prefix ) *(--bufpt) = prefix;               /* Add sign */` |
|   59059 |  327 | `        if( flag_alternateform && infop->prefix ){      /* Add "0" or "0x" */` |
|       - |  328 | `          char *pre, x;` |
...
|       1 |  332 | `          }` |
|       1 |  333 | `        }` |
|   59059 |  334 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|   59059 |  335 | `        break;` |
...
|       3 |  496 | `        length = 1;` |
|       3 |  497 | `        break;` |
|    4760 |  498 | `      case SXFMT_CHARX:` |
|    9524 |  499 | `        c = va_arg(ap,int);` |
|    9524 |  500 | `		buf[0] = (char)c;` |
|       - |  501 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|    9524 |  502 | `		if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|    9524 |  503 | `        if( precision>=0 ){` |
...
|    9524 |  509 | `        bufpt = buf;` |
|    9524 |  510 | `        break;` |
|  145659 |  511 | `      case SXFMT_STRING:` |
|  291323 |  512 | `        bufpt = va_arg(ap,char*);` |
|  291323 |  513 | `        if( bufpt==0 ){` |
|     ! 0 |  514 | `          bufpt = " ";` |
|     ! 0 |  515 | `		  length = (int)sizeof(" ")-1;` |
|     ! 0 |  516 | `		  break;` |
|       - |  517 | `        }` |
|  291323 |  518 | `		length = precision;` |
|  291323 |  519 | `		if( precision < 0 ){` |
|       - |  520 | `			/* Symisc extension */` |
|    2013 |  521 | `			length = (int)SyStrlen(bufpt);` |
|    1004 |  522 | `		}` |
|  291323 |  523 | `        if( precision>=0 && precision<length ) length = precision;` |
|  291323 |  524 | `        break;` |
|  298605 |  525 | `	case SXFMT_RAWSTR:{` |
|       - |  526 | `		/* Symisc extension */` |
|  597215 |  527 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  597215 |  528 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|     ! 0 |  529 | `			 bufpt = " ";` |
|     ! 0 |  530 | `		     length = (int)sizeof(char);` |
|     ! 0 |  531 | `		     break;` |
|       - |  532 | `		}` |
|  597215 |  533 | `		bufpt = (char *)pStr->zString;` |
|  597215 |  534 | `		length = (int)pStr->nByte;` |
|  597215 |  535 | `		break;` |
|       - |  536 | `					  }` |
...
|       - |  547 | `    ** the output.` |
|       - |  548 | `    */` |
|  957427 |  549 | `    if( !flag_leftjustify ){` |
|       - |  550 | `      register int nspace;` |
|  957427 |  551 | `      nspace = width-length;` |
|  957427 |  552 | `      if( nspace>0 ){` |
...
|      18 |  566 | `      }` |
|  478711 |  567 | `    }` |
|  957427 |  568 | `    if( length>0 ){` |
|  957211 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  957211 |  570 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|       - |  572 | `		}` |
|  478603 |  573 | `    }` |
|  957427 |  574 | `    if( flag_leftjustify ){` |
...
|     ! 0 |  591 | `      }` |
|     ! 0 |  592 | `    }` |
|  478716 |  593 | `  }/* End for loop over the format string */` |
|   66253 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|  179439 |  595 | `}` |
|       - |  596 | `/* SPDX-SnippetEnd */` |
| 2121668 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|       5 |  598 | `{` |
| 2121673 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 2121673 |  600 | `	sxi32 rc = SXERR_ABORT;` |
| 2121673 |  601 | `	switch(pConsumer->nType){` |
...
|     157 |  605 | `			break;` |
| 1060756 |  606 | `	case SXFMT_CONS_BLOB:` |
|       - |  607 | `			/* Blob consumer */` |
| 2121517 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 2121512 |  609 | `			break;` |
|     ! 0 |  610 | `		default:` |
...
| 2121673 |  615 | `	pConsumer->nLen += nLen;` |
| 2121673 |  616 | `	pConsumer->rc = rc;` |
| 2121673 |  617 | `	return rc;` |
|       5 |  618 | `}` |
|  358868 |  619 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|       5 |  620 | `{` |
|       - |  621 | `	SyFmtConsumer sCons;` |
|  358873 |  622 | `	sCons.nType = nType;` |
|  358873 |  623 | `	sCons.rc = SXRET_OK;` |
|  358873 |  624 | `	sCons.nLen = 0;` |
|  358873 |  625 | `	if( pOutLen ){` |
|   69289 |  626 | `		*pOutLen = 0;` |
|   34642 |  627 | `	}` |
|  358873 |  628 | `	switch(nType){` |
...
|      13 |  637 | `		break;` |
|  179428 |  638 | `		case SXFMT_CONS_BLOB:` |
|  358861 |  639 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  358861 |  640 | `			break;` |
|     ! 0 |  641 | `		default:` |
|     ! 0 |  642 | `			return SXERR_UNKNOWN;` |
|       - |  643 | `	}` |
|  358873 |  644 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  358873 |  645 | `	if( pOutLen ){` |
|   69289 |  646 | `		*pOutLen = sCons.nLen;` |
|   34642 |  647 | `	}` |
|  358873 |  648 | `	return sCons.rc;` |
|  179439 |  649 | `}` |
...
|    1901 |  687 | `	return n;` |
|       5 |  688 | `}` |
|  289572 |  689 | `PH7_PRIVATE sxu32 SyBufferFormat(char *zBuf,sxu32 nLen,const char *zFormat,...)` |
|       5 |  690 | `{` |
|       - |  691 | `	SyBlob sBlob;` |
|       - |  692 | `	va_list ap;` |
|       - |  693 | `	sxu32 n;` |
...
|       - |  697 | `	}` |
|       - |  698 | `#endif` |
|  289577 |  699 | `	if( SXRET_OK != SyBlobInitFromBuf(&sBlob,zBuf,nLen - 1) ){` |
|     ! 0 |  700 | `		return 0;` |
|       - |  701 | `	}` |
|  289577 |  702 | `	va_start(ap,zFormat);` |
|  289577 |  703 | `	FormatMount(SXFMT_CONS_BLOB,&sBlob,0,0,0,zFormat,ap);` |
|  289577 |  704 | `	va_end(ap);` |
|  289577 |  705 | `	n = SyBlobLength(&sBlob);` |
|       - |  706 | `	/* Append the null terminator */` |
|  289577 |  707 | `	sBlob.mByte++;` |
|  289577 |  708 | `	SyBlobAppend(&sBlob,"\0",sizeof(char));` |
|  289577 |  709 | `	return n;` |
|  144791 |  710 | `}` |
|       - |  711 |  |
