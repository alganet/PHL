...
|       - |   90 | ` */` |
|  340290 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|       5 |   92 | `{` |
|       - |   93 | `	/*` |
...
|  340295 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|  340295 |  153 | `  length = 0;` |
|  340295 |  154 | `  bufpt = 0;` |
| 1242539 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
| 1176039 |  156 | `    if( c!='%' ){` |
|       - |  157 | `      unsigned int amt;` |
| 1089175 |  158 | `      bufpt = (char *)zFormat;` |
| 1089175 |  159 | `      amt = 1;` |
| 1720345 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
| 1089175 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
| 1089175 |  162 | `	  if( rc != SXRET_OK ){` |
|     ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|       - |  164 | `	  }` |
| 1089175 |  165 | `      if( c==0 ){` |
|  273795 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|       - |  167 | `	  }` |
|  407690 |  168 | `    }` |
|  902249 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|     ! 0 |  170 | `      errorflag = 1;` |
...
|  902249 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  902244 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  451122 |  180 | `    do{` |
|  902407 |  181 | `      switch( c ){` |
...
|  902244 |  187 | `        default:                                       break;` |
|       - |  188 | `      }` |
|  902407 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|     ! 0 |  198 | `      c = *++zFormat;` |
|     ! 0 |  199 | `    }else{` |
|  902449 |  200 | `      while( c>='0' && c<='9' ){` |
|     203 |  201 | `        width = width*10 + c - '0';` |
|     203 |  202 | `        c = *++zFormat;` |
|       3 |  203 | `      }` |
|       - |  204 | `    }` |
|  902249 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|     ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|     ! 0 |  207 | `    }` |
|       - |  208 | `    /* Get the precision */` |
|  902249 |  209 | `	precision = -1;` |
|  902249 |  210 | `    if( c=='.' ){` |
|  271291 |  211 | `      precision = 0;` |
|  271291 |  212 | `      c = *++zFormat;` |
|  271291 |  213 | `      if( c=='*' ){` |
|  270991 |  214 | `        precision = va_arg(ap,int);` |
|  270991 |  215 | `        if( precision<0 ) precision = -precision;` |
|  270991 |  216 | `        c = *++zFormat;` |
|  135498 |  217 | `      }else{` |
...
|  902249 |  225 | `	flag_long = 0;` |
|  902249 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
...
|  902249 |  235 | `    infop = 0;` |
|  902249 |  236 | `    xtype = SXFMT_ERROR;` |
| 4017711 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 4017711 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  902249 |  239 | `        infop = &aFmt[idx];` |
|  902249 |  240 | `		xtype = infop->type;` |
|  902249 |  241 | `        break;` |
|       - |  242 | `      }` |
| 1557736 |  243 | `    }` |
...
|       - |  263 | `    */` |
|  902249 |  264 | `    switch( xtype ){` |
|   28965 |  265 | `      case SXFMT_RADIX:` |
|   57935 |  266 | `        if( flag_long > 0 ){` |
...
|       - |  290 | `#endif` |
|   57935 |  291 | `        if( infop->flags & SXFLAG_SIGNED ){` |
|   56445 |  292 | `          if( longvalue<0 ){` |
...
|     110 |  297 | `            prefix = '-';` |
|      56 |  298 | `          }else{` |
|   56337 |  299 | `            ulongvalue = (sxu64)longvalue;` |
|   56337 |  300 | `            if( flag_plussign )        prefix = '+';` |
|   56335 |  301 | `            else if( flag_blanksign )  prefix = ' ';` |
|   56335 |  302 | `            else                       prefix = 0;` |
|       - |  303 | `          }` |
|   28225 |  304 | `        }else{` |
|    1495 |  305 | `			ulongvalue = (sxu64)longvalue; /* print the full unsigned value as-is */` |
|    1495 |  306 | `			prefix = 0;` |
|       - |  307 | `		}` |
|   57935 |  308 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|     142 |  309 | `          precision = width-(prefix!=0);` |
|      70 |  310 | `        }` |
|   57935 |  311 | `        bufpt = &buf[SXFMT_BUFSIZ-1];` |
|       - |  312 | `        {` |
|       - |  313 | `          register char *cset;      /* Use registers for speed */` |
|       - |  314 | `          register int base;` |
|   57935 |  315 | `          cset = infop->charset;` |
|   57935 |  316 | `          base = infop->base;` |
|   28965 |  317 | `          do{                                           /* Convert to ascii */` |
|  176037 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|  176037 |  319 | `            ulongvalue = ulongvalue/base;` |
|  176037 |  320 | `          }while( ulongvalue>0 );` |
|       - |  321 | `        }` |
|   57935 |  322 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|   58289 |  323 | `        for(idx=precision-length; idx>0; idx--){` |
|     356 |  324 | `          *(--bufpt) = '0';                             /* Zero pad */` |
|     179 |  325 | `        }` |
|   57935 |  326 | `        if( prefix ) *(--bufpt) = prefix;               /* Add sign */` |
|   57935 |  327 | `        if( flag_alternateform && infop->prefix ){      /* Add "0" or "0x" */` |
|       - |  328 | `          char *pre, x;` |
...
|       2 |  332 | `          }` |
|       2 |  333 | `        }` |
|   57935 |  334 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|   57935 |  335 | `        break;` |
...
|       3 |  496 | `        length = 1;` |
|       3 |  497 | `        break;` |
|    5092 |  498 | `      case SXFMT_CHARX:` |
|   10188 |  499 | `        c = va_arg(ap,int);` |
|   10188 |  500 | `		buf[0] = (char)c;` |
|       - |  501 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|   10188 |  502 | `		if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|   10188 |  503 | `        if( precision>=0 ){` |
...
|   10188 |  509 | `        bufpt = buf;` |
|   10188 |  510 | `        break;` |
|  136165 |  511 | `      case SXFMT_STRING:` |
|  272335 |  512 | `        bufpt = va_arg(ap,char*);` |
|  272335 |  513 | `        if( bufpt==0 ){` |
|     ! 0 |  514 | `          bufpt = " ";` |
|     ! 0 |  515 | `		  length = (int)sizeof(" ")-1;` |
|     ! 0 |  516 | `		  break;` |
|       - |  517 | `        }` |
|  272335 |  518 | `		length = precision;` |
|  272335 |  519 | `		if( precision < 0 ){` |
|       - |  520 | `			/* Symisc extension */` |
|    1351 |  521 | `			length = (int)SyStrlen(bufpt);` |
|     673 |  522 | `		}` |
|  272335 |  523 | `        if( precision>=0 && precision<length ) length = precision;` |
|  272335 |  524 | `        break;` |
|  280743 |  525 | `	case SXFMT_RAWSTR:{` |
|       - |  526 | `		/* Symisc extension */` |
|  561491 |  527 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  561491 |  528 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|     ! 0 |  529 | `			 bufpt = " ";` |
|     ! 0 |  530 | `		     length = (int)sizeof(char);` |
|     ! 0 |  531 | `		     break;` |
|       - |  532 | `		}` |
|  561491 |  533 | `		bufpt = (char *)pStr->zString;` |
|  561491 |  534 | `		length = (int)pStr->nByte;` |
|  561491 |  535 | `		break;` |
|       - |  536 | `					  }` |
...
|       - |  547 | `    ** the output.` |
|       - |  548 | `    */` |
|  902249 |  549 | `    if( !flag_leftjustify ){` |
|       - |  550 | `      register int nspace;` |
|  902249 |  551 | `      nspace = width-length;` |
|  902249 |  552 | `      if( nspace>0 ){` |
...
|      18 |  566 | `      }` |
|  451122 |  567 | `    }` |
|  902249 |  568 | `    if( length>0 ){` |
|  902225 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  902225 |  570 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|       - |  572 | `		}` |
|  451110 |  573 | `    }` |
|  902249 |  574 | `    if( flag_leftjustify ){` |
...
|     ! 0 |  591 | `      }` |
|     ! 0 |  592 | `    }` |
|  451127 |  593 | `  }/* End for loop over the format string */` |
|   66505 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|  170150 |  595 | `}` |
|       - |  596 | `/* SPDX-SnippetEnd */` |
| 1991426 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|       5 |  598 | `{` |
| 1991431 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 1991431 |  600 | `	sxi32 rc = SXERR_ABORT;` |
| 1991431 |  601 | `	switch(pConsumer->nType){` |
...
|     157 |  605 | `			break;` |
|  995635 |  606 | `	case SXFMT_CONS_BLOB:` |
|       - |  607 | `			/* Blob consumer */` |
| 1991275 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 1991270 |  609 | `			break;` |
|     ! 0 |  610 | `		default:` |
...
| 1991431 |  615 | `	pConsumer->nLen += nLen;` |
| 1991431 |  616 | `	pConsumer->rc = rc;` |
| 1991431 |  617 | `	return rc;` |
|       5 |  618 | `}` |
|  340290 |  619 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|       5 |  620 | `{` |
|       - |  621 | `	SyFmtConsumer sCons;` |
|  340295 |  622 | `	sCons.nType = nType;` |
|  340295 |  623 | `	sCons.rc = SXRET_OK;` |
|  340295 |  624 | `	sCons.nLen = 0;` |
|  340295 |  625 | `	if( pOutLen ){` |
|   69135 |  626 | `		*pOutLen = 0;` |
|   34565 |  627 | `	}` |
|  340295 |  628 | `	switch(nType){` |
...
|      13 |  637 | `		break;` |
|  170139 |  638 | `		case SXFMT_CONS_BLOB:` |
|  340283 |  639 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  340283 |  640 | `			break;` |
|     ! 0 |  641 | `		default:` |
|     ! 0 |  642 | `			return SXERR_UNKNOWN;` |
|       - |  643 | `	}` |
|  340295 |  644 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  340295 |  645 | `	if( pOutLen ){` |
|   69135 |  646 | `		*pOutLen = sCons.nLen;` |
|   34565 |  647 | `	}` |
|  340295 |  648 | `	return sCons.rc;` |
|  170150 |  649 | `}` |
...
|   67583 |  676 | `	return n;` |
|       5 |  677 | `}` |
|    1552 |  678 | `PH7_PRIVATE sxu32 SyBlobFormatAp(SyBlob *pBlob,const char *zFormat,va_list ap)` |
|       5 |  679 | `{` |
|    1557 |  680 | `	sxu32 n = 0; /* cc warning */` |
|       - |  681 | `#if defined(UNTRUST)` |
|       - |  682 | `	if( SX_EMPTY_STR(zFormat) ){` |
|       - |  683 | `		return 0;` |
|       - |  684 | `	}` |
|       - |  685 | `#endif` |
|    1557 |  686 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    1557 |  687 | `	return n;` |
|       5 |  688 | `}` |
|  271148 |  689 | `PH7_PRIVATE sxu32 SyBufferFormat(char *zBuf,sxu32 nLen,const char *zFormat,...)` |
|       5 |  690 | `{` |
|       - |  691 | `	SyBlob sBlob;` |
|       - |  692 | `	va_list ap;` |
|       - |  693 | `	sxu32 n;` |
...
|       - |  697 | `	}` |
|       - |  698 | `#endif` |
|  271153 |  699 | `	if( SXRET_OK != SyBlobInitFromBuf(&sBlob,zBuf,nLen - 1) ){` |
|     ! 0 |  700 | `		return 0;` |
|       - |  701 | `	}` |
|  271153 |  702 | `	va_start(ap,zFormat);` |
|  271153 |  703 | `	FormatMount(SXFMT_CONS_BLOB,&sBlob,0,0,0,zFormat,ap);` |
|  271153 |  704 | `	va_end(ap);` |
|  271153 |  705 | `	n = SyBlobLength(&sBlob);` |
|       - |  706 | `	/* Append the null terminator */` |
|  271153 |  707 | `	sBlob.mByte++;` |
|  271153 |  708 | `	SyBlobAppend(&sBlob,"\0",sizeof(char));` |
|  271153 |  709 | `	return n;` |
|  135579 |  710 | `}` |
|       - |  711 |  |
