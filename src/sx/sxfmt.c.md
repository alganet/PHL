...
|        - |   90 | ` */` |
|  2495612 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|        5 |   92 | `{` |
|        - |   93 | `	/*` |
...
|  2495617 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|        - |  151 | `  int rc;` |
|        - |  152 |  |
|  2495617 |  153 | `  length = 0;` |
|  2495617 |  154 | `  bufpt = 0;` |
|  9816905 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
|  9725223 |  156 | `    if( c!='%' ){` |
|        - |  157 | `      unsigned int amt;` |
|  9595685 |  158 | `      bufpt = (char *)zFormat;` |
|  9595685 |  159 | `      amt = 1;` |
| 15187847 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
|  9595685 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
|  9595685 |  162 | `	  if( rc != SXRET_OK ){` |
|      ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  164 | `	  }` |
|  9595685 |  165 | `      if( c==0 ){` |
|  2403935 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|        - |  167 | `	  }` |
|  3595875 |  168 | `    }` |
|  7321293 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|      ! 0 |  170 | `      errorflag = 1;` |
...
|  7321293 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  7321288 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  3660644 |  180 | `    do{` |
|  7322027 |  181 | `      switch( c ){` |
...
|  7321288 |  187 | `        default:                                       break;` |
|        - |  188 | `      }` |
|  7322027 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|      ! 0 |  198 | `      c = *++zFormat;` |
|      ! 0 |  199 | `    }else{` |
|  7322063 |  200 | `      while( c>='0' && c<='9' ){` |
|      773 |  201 | `        width = width*10 + c - '0';` |
|      773 |  202 | `        c = *++zFormat;` |
|        3 |  203 | `      }` |
|        - |  204 | `    }` |
|  7321293 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|      ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|      ! 0 |  207 | `    }` |
|        - |  208 | `    /* Get the precision */` |
|  7321293 |  209 | `	precision = -1;` |
|  7321293 |  210 | `    if( c=='.' ){` |
|  2375871 |  211 | `      precision = 0;` |
|  2375871 |  212 | `      c = *++zFormat;` |
|  2375871 |  213 | `      if( c=='*' ){` |
|  2375867 |  214 | `        precision = va_arg(ap,int);` |
|  2375867 |  215 | `        if( precision<0 ) precision = -precision;` |
|  2375867 |  216 | `        c = *++zFormat;` |
|  1187936 |  217 | `      }else{` |
|        9 |  218 | `        while( c>='0' && c<='9' ){` |
...
|  7321293 |  225 | `	flag_long = 0;` |
|  7321293 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
...
|  7321293 |  235 | `    infop = 0;` |
|  7321293 |  236 | `    xtype = SXFMT_ERROR;` |
| 33734643 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 33734643 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  7321293 |  239 | `        infop = &aFmt[idx];` |
|  7321293 |  240 | `		xtype = infop->type;` |
|  7321293 |  241 | `        break;` |
|        - |  242 | `      }` |
| 13206680 |  243 | `    }` |
...
|        - |  263 | `    */` |
|  7321293 |  264 | `    switch( xtype ){` |
|    33805 |  265 | `      case SXFMT_RADIX:` |
|    67615 |  266 | `        if( flag_long > 0 ){` |
...
|        - |  272 | `			}` |
|    29701 |  273 | `		}else{` |
|     8223 |  274 | `			if( infop->flags & SXFLAG_SIGNED ){` |
|     3861 |  275 | `				longvalue = va_arg(ap,sxi32);` |
|     1933 |  276 | `			}else{` |
|     4367 |  277 | `				longvalue = va_arg(ap,sxu32);` |
|        - |  278 | `			}` |
|        - |  279 | `		}` |
|        - |  280 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|    67615 |  281 | `      if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|        - |  282 | `#if 1` |
|        - |  283 | `        /* For the format %#x, the value zero is printed "0" not "0x0".` |
|        - |  284 | `        ** I think this is stupid.*/` |
|    67615 |  285 | `        if( longvalue==0 ) flag_alternateform = 0;` |
|        - |  286 | `#else` |
...
|        - |  290 | `#endif` |
|    67615 |  291 | `        if( infop->flags & SXFLAG_SIGNED ){` |
|    63199 |  292 | `          if( longvalue<0 ){` |
...
|      191 |  297 | `            prefix = '-';` |
|       97 |  298 | `          }else{` |
|    63011 |  299 | `            ulongvalue = (sxu64)longvalue;` |
|    63011 |  300 | `            if( flag_plussign )        prefix = '+';` |
|    63011 |  301 | `            else if( flag_blanksign )  prefix = ' ';` |
|    63011 |  302 | `            else                       prefix = 0;` |
|        - |  303 | `          }` |
|    31602 |  304 | `        }else{` |
|     4421 |  305 | `			ulongvalue = (sxu64)longvalue; /* print the full unsigned value as-is */` |
|     4421 |  306 | `			prefix = 0;` |
|        - |  307 | `		}` |
|    67615 |  308 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|      722 |  309 | `          precision = width-(prefix!=0);` |
|      360 |  310 | `        }` |
|    67615 |  311 | `        bufpt = &buf[SXFMT_BUFSIZ-1];` |
|        - |  312 | `        {` |
|        - |  313 | `          register char *cset;      /* Use registers for speed */` |
|        - |  314 | `          register int base;` |
|    67615 |  315 | `          cset = infop->charset;` |
|    67615 |  316 | `          base = infop->base;` |
|    33805 |  317 | `          do{                                           /* Convert to ascii */` |
|   192298 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|   192298 |  319 | `            ulongvalue = ulongvalue/base;` |
|   192298 |  320 | `          }while( ulongvalue>0 );` |
|        - |  321 | `        }` |
|    67615 |  322 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    68395 |  323 | `        for(idx=precision-length; idx>0; idx--){` |
|      782 |  324 | `          *(--bufpt) = '0';                             /* Zero pad */` |
|      392 |  325 | `        }` |
|    67615 |  326 | `        if( prefix ) *(--bufpt) = prefix;               /* Add sign */` |
|    67615 |  327 | `        if( flag_alternateform && infop->prefix ){      /* Add "0" or "0x" */` |
|        - |  328 | `          char *pre, x;` |
...
|        1 |  332 | `          }` |
|        1 |  333 | `        }` |
|    67615 |  334 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    67615 |  335 | `        break;` |
...
|      ! 0 |  496 | `        length = 1;` |
|      ! 0 |  497 | `        break;` |
|     4791 |  498 | `      case SXFMT_CHARX:` |
|     9587 |  499 | `        c = va_arg(ap,int);` |
|     9587 |  500 | `		buf[0] = (char)c;` |
|        - |  501 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|     9587 |  502 | `		if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|     9587 |  503 | `        if( precision>=0 ){` |
...
|     9587 |  509 | `        bufpt = buf;` |
|     9587 |  510 | `        break;` |
|  1232670 |  511 | `      case SXFMT_STRING:` |
|  2465345 |  512 | `        bufpt = va_arg(ap,char*);` |
|  2465345 |  513 | `        if( bufpt==0 ){` |
|      ! 0 |  514 | `          bufpt = " ";` |
|      ! 0 |  515 | `		  length = (int)sizeof(" ")-1;` |
|      ! 0 |  516 | `		  break;` |
|        - |  517 | `        }` |
|  2465345 |  518 | `		length = precision;` |
|  2465345 |  519 | `		if( precision < 0 ){` |
|        - |  520 | `			/* Symisc extension */` |
|    89479 |  521 | `			length = (int)SyStrlen(bufpt);` |
|    44737 |  522 | `		}` |
|  2465345 |  523 | `        if( precision>=0 && precision<length ) length = precision;` |
|  2465345 |  524 | `        break;` |
|  2389364 |  525 | `	case SXFMT_RAWSTR:{` |
|        - |  526 | `		/* Symisc extension */` |
|  4778733 |  527 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  4778733 |  528 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|      ! 0 |  529 | `			 bufpt = " ";` |
|      ! 0 |  530 | `		     length = (int)sizeof(char);` |
|      ! 0 |  531 | `		     break;` |
|        - |  532 | `		}` |
|  4778733 |  533 | `		bufpt = (char *)pStr->zString;` |
|  4778733 |  534 | `		length = (int)pStr->nByte;` |
|  4778733 |  535 | `		break;` |
|        - |  536 | `					  }` |
...
|        - |  547 | `    ** the output.` |
|        - |  548 | `    */` |
|  7321293 |  549 | `    if( !flag_leftjustify ){` |
|        - |  550 | `      register int nspace;` |
|  7321293 |  551 | `      nspace = width-length;` |
|  7321293 |  552 | `      if( nspace>0 ){` |
...
|       18 |  566 | `      }` |
|  3660644 |  567 | `    }` |
|  7321293 |  568 | `    if( length>0 ){` |
|  7320969 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  7320969 |  570 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  572 | `		}` |
|  3660482 |  573 | `    }` |
|  7321293 |  574 | `    if( flag_leftjustify ){` |
...
|      ! 0 |  591 | `      }` |
|      ! 0 |  592 | `    }` |
|  3660649 |  593 | `  }/* End for loop over the format string */` |
|    91687 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|  1247811 |  595 | `}` |
|        - |  596 | `/* SPDX-SnippetEnd */` |
| 16916680 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|        5 |  598 | `{` |
| 16916685 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 16916685 |  600 | `	sxi32 rc = SXERR_ABORT;` |
| 16916685 |  601 | `	switch(pConsumer->nType){` |
...
|      181 |  605 | `			break;` |
|  8458250 |  606 | `	case SXFMT_CONS_BLOB:` |
|        - |  607 | `			/* Blob consumer */` |
| 16916505 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 16916500 |  609 | `			break;` |
|      ! 0 |  610 | `		default:` |
...
| 16916685 |  615 | `	pConsumer->nLen += nLen;` |
| 16916685 |  616 | `	pConsumer->rc = rc;` |
| 16916685 |  617 | `	return rc;` |
|        5 |  618 | `}` |
|  2495612 |  619 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|        5 |  620 | `{` |
|        - |  621 | `	SyFmtConsumer sCons;` |
|  2495617 |  622 | `	sCons.nType = nType;` |
|  2495617 |  623 | `	sCons.rc = SXRET_OK;` |
|  2495617 |  624 | `	sCons.nLen = 0;` |
|  2495617 |  625 | `	if( pOutLen ){` |
|   115721 |  626 | `		*pOutLen = 0;` |
|    57858 |  627 | `	}` |
|  2495617 |  628 | `	switch(nType){` |
...
|       13 |  637 | `		break;` |
|  1247800 |  638 | `		case SXFMT_CONS_BLOB:` |
|  2495605 |  639 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  2495605 |  640 | `			break;` |
|      ! 0 |  641 | `		default:` |
|      ! 0 |  642 | `			return SXERR_UNKNOWN;` |
|        - |  643 | `	}` |
|  2495617 |  644 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  2495617 |  645 | `	if( pOutLen ){` |
|   115721 |  646 | `		*pOutLen = sCons.nLen;` |
|    57858 |  647 | `	}` |
|  2495617 |  648 | `	return sCons.rc;` |
|  1247811 |  649 | `}` |
...
|       13 |  662 | `	return rc;` |
|        1 |  663 | `}` |
|    93074 |  664 | `PH7_PRIVATE sxu32 SyBlobFormat(SyBlob *pBlob,const char *zFormat,...)` |
|        5 |  665 | `{` |
|        - |  666 | `	va_list ap;` |
|        - |  667 | `	sxu32 n;` |
...
|        - |  671 | `	}` |
|        - |  672 | `#endif` |
|    93079 |  673 | `	va_start(ap,zFormat);` |
|    93079 |  674 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    93079 |  675 | `	va_end(ap);` |
|    93079 |  676 | `	return n;` |
|        5 |  677 | `}` |
|    22642 |  678 | `PH7_PRIVATE sxu32 SyBlobFormatAp(SyBlob *pBlob,const char *zFormat,va_list ap)` |
|        5 |  679 | `{` |
|    22647 |  680 | `	sxu32 n = 0; /* cc warning */` |
|        - |  681 | `#if defined(UNTRUST)` |
|        - |  682 | `	if( SX_EMPTY_STR(zFormat) ){` |
|        - |  683 | `		return 0;` |
|        - |  684 | `	}` |
|        - |  685 | `#endif` |
|    22647 |  686 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    22647 |  687 | `	return n;` |
|        5 |  688 | `}` |
|  2379884 |  689 | `PH7_PRIVATE sxu32 SyBufferFormat(char *zBuf,sxu32 nLen,const char *zFormat,...)` |
|        5 |  690 | `{` |
|        - |  691 | `	SyBlob sBlob;` |
|        - |  692 | `	va_list ap;` |
|        - |  693 | `	sxu32 n;` |
...
|        - |  697 | `	}` |
|        - |  698 | `#endif` |
|  2379889 |  699 | `	if( SXRET_OK != SyBlobInitFromBuf(&sBlob,zBuf,nLen - 1) ){` |
|      ! 0 |  700 | `		return 0;` |
|        - |  701 | `	}` |
|  2379889 |  702 | `	va_start(ap,zFormat);` |
|  2379889 |  703 | `	FormatMount(SXFMT_CONS_BLOB,&sBlob,0,0,0,zFormat,ap);` |
|  2379889 |  704 | `	va_end(ap);` |
|  2379889 |  705 | `	n = SyBlobLength(&sBlob);` |
|        - |  706 | `	/* Append the null terminator */` |
|  2379889 |  707 | `	sBlob.mByte++;` |
|  2379889 |  708 | `	SyBlobAppend(&sBlob,"\0",sizeof(char));` |
|  2379889 |  709 | `	return n;` |
|  1189947 |  710 | `}` |
|        - |  711 |  |
