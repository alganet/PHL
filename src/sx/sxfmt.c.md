...
|       - |   87 | ` */` |
|  195074 |   88 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|       2 |   89 |  |
|       - |   90 | `	/*` |
...
|  195076 |  134 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|  195076 |  149 | `  length = 0;` |
|  195076 |  150 | `  bufpt = 0;` |
|  669430 |  151 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
|  608284 |  152 | `    if( c!='%' ){` |
|       - |  153 | `      unsigned int amt;` |
|  531682 |  154 | `      bufpt = (char *)zFormat;` |
|  531682 |  155 | `      amt = 1;` |
|  855560 |  156 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
|  531682 |  157 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
|  531682 |  158 | `	  if( rc != SXRET_OK ){` |
|     ! 0 |  159 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|       - |  160 | `	  }` |
|  531682 |  161 | `      if( c==0 ){` |
|  133930 |  162 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|       - |  163 | `	  }` |
|  198876 |  164 | `    }` |
|  474356 |  165 | `    if( (c=(*++zFormat))==0 ){` |
|     ! 0 |  166 | `      errorflag = 1;` |
...
|  474356 |  174 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  474354 |  175 | `     flag_alternateform = flag_zeropad = 0;` |
|  237177 |  176 | `    do{` |
|  474468 |  177 | `      switch( c ){` |
...
|  474354 |  183 | `        default:                                       break;` |
|       - |  184 | `      }` |
|  474468 |  185 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|     ! 0 |  194 | `      c = *++zFormat;` |
|     ! 0 |  195 | `    }else{` |
|  474510 |  196 | `      while( c>='0' && c<='9' ){` |
|     156 |  197 | `        width = width*10 + c - '0';` |
|     156 |  198 | `        c = *++zFormat;` |
|       2 |  199 | `      }` |
|       - |  200 | `    }` |
|  474356 |  201 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|     ! 0 |  202 | `      width = SXFMT_BUFSIZ-10;` |
|     ! 0 |  203 | `    }` |
|       - |  204 | `    /* Get the precision */` |
|  474356 |  205 | `	precision = -1;` |
|  474356 |  206 | `    if( c=='.' ){` |
|  132544 |  207 | `      precision = 0;` |
|  132544 |  208 | `      c = *++zFormat;` |
|  132544 |  209 | `      if( c=='*' ){` |
|  132386 |  210 | `        precision = va_arg(ap,int);` |
|  132386 |  211 | `        if( precision<0 ) precision = -precision;` |
|  132386 |  212 | `        c = *++zFormat;` |
|   66194 |  213 | `      }else{` |
...
|  474356 |  221 | `	flag_long = 0;` |
|  474356 |  222 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
|   52716 |  223 | `      flag_long = (c == 'q') ? 2 : 1;` |
|   52716 |  224 | `      c = *++zFormat;` |
|   52716 |  225 | `	  if( c == 'l' ){` |
...
|  474356 |  231 | `    infop = 0;` |
|  474356 |  232 | `    xtype = SXFMT_ERROR;` |
| 2027646 |  233 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 2027646 |  234 | `      if( c==aFmt[idx].fmttype ){` |
|  474356 |  235 | `        infop = &aFmt[idx];` |
|  474356 |  236 | `		xtype = infop->type;` |
|  474356 |  237 | `        break;` |
|       - |  238 | `      }` |
|  776647 |  239 | `    }` |
...
|       - |  286 | `#endif` |
|   53988 |  287 | `        if( infop->flags & SXFLAG_SIGNED ){` |
|   53238 |  288 | `          if( longvalue<0 ){` |
...
|     ! 0 |  294 | `			}` |
|      58 |  295 | `            prefix = '-';` |
|   53210 |  296 | `          }else if( flag_plussign )  prefix = '+';` |
|   53180 |  297 | `          else if( flag_blanksign )  prefix = ' ';` |
|   53180 |  298 | `          else                       prefix = 0;` |
|   26620 |  299 | `        }else{` |
...
|     752 |  308 | `			prefix = 0;` |
|       - |  309 | `		}` |
|   53988 |  310 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|      95 |  311 | `          precision = width-(prefix!=0);` |
|      47 |  312 | `        }` |
|   53988 |  313 | `        bufpt = &buf[SXFMT_BUFSIZ-1];` |
|       - |  314 | `        {` |
|       - |  315 | `          register char *cset;      /* Use registers for speed */` |
|       - |  316 | `          register int base;` |
|   53988 |  317 | `          cset = infop->charset;` |
|   53988 |  318 | `          base = infop->base;` |
|   26993 |  319 | `          do{                                           /* Convert to ascii */` |
|  169684 |  320 | `            *(--bufpt) = cset[longvalue%base];` |
|  169684 |  321 | `            longvalue = longvalue/base;` |
|  169684 |  322 | `          }while( longvalue>0 );` |
|       - |  323 | `        }` |
|   53988 |  324 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|   54062 |  325 | `        for(idx=precision-length; idx>0; idx--){` |
|      75 |  326 | `          *(--bufpt) = '0';                             /* Zero pad */` |
|      38 |  327 | `        }` |
|   53988 |  328 | `        if( prefix ) *(--bufpt) = prefix;               /* Add sign */` |
|   53988 |  329 | `        if( flag_alternateform && infop->prefix ){      /* Add "0" or "0x" */` |
|       - |  330 | `          char *pre, x;` |
...
|       2 |  334 | `          }` |
|       2 |  335 | `        }` |
|   53988 |  336 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|   53988 |  337 | `        break;` |
...
|    7700 |  511 | `        bufpt = buf;` |
|    7700 |  512 | `        break;` |
|   66565 |  513 | `      case SXFMT_STRING:` |
|  133132 |  514 | `        bufpt = va_arg(ap,char*);` |
|  133132 |  515 | `        if( bufpt==0 ){` |
|     ! 0 |  516 | `          bufpt = " ";` |
|     ! 0 |  517 | `		  length = (int)sizeof(" ")-1;` |
|     ! 0 |  518 | `		  break;` |
|       - |  519 | `        }` |
|  133132 |  520 | `		length = precision;` |
|  133132 |  521 | `		if( precision < 0 ){` |
|       - |  522 | `			/* Symisc extension */` |
|     750 |  523 | `			length = (int)SyStrlen(bufpt);` |
|     374 |  524 | `		}` |
|  133132 |  525 | `        if( precision>=0 && precision<length ) length = precision;` |
|  133132 |  526 | `        break;` |
|  139684 |  527 | `	case SXFMT_RAWSTR:{` |
|       - |  528 | `		/* Symisc extension */` |
|  279370 |  529 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  279370 |  530 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|     ! 0 |  531 | `			 bufpt = " ";` |
|     ! 0 |  532 | `		     length = (int)sizeof(char);` |
|     ! 0 |  533 | `		     break;` |
|       - |  534 | `		}` |
|  279370 |  535 | `		bufpt = (char *)pStr->zString;` |
|  279370 |  536 | `		length = (int)pStr->nByte;` |
|  279370 |  537 | `		break;` |
|       - |  538 | `					  }` |
...
|       - |  549 | `    ** the output.` |
|       - |  550 | `    */` |
|  474356 |  551 | `    if( !flag_leftjustify ){` |
|       - |  552 | `      register int nspace;` |
|  474356 |  553 | `      nspace = width-length;` |
|  474356 |  554 | `      if( nspace>0 ){` |
...
|      18 |  568 | `      }` |
|  237177 |  569 | `    }` |
|  474356 |  570 | `    if( length>0 ){` |
|  474332 |  571 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  474332 |  572 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  573 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|       - |  574 | `		}` |
|  237165 |  575 | `    }` |
|  474356 |  576 | `    if( flag_leftjustify ){` |
...
|     ! 0 |  593 | `      }` |
|     ! 0 |  594 | `    }` |
|  237179 |  595 | `  }/* End for loop over the format string */` |
|   61148 |  596 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|   97539 |  597 |  |
| 1006046 |  598 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|       2 |  599 |  |
| 1006048 |  600 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 1006048 |  601 | `	sxi32 rc = SXERR_ABORT;` |
| 1006048 |  602 | `	switch(pConsumer->nType){` |
...
|     157 |  606 | `			break;` |
|  502945 |  607 | `	case SXFMT_CONS_BLOB:` |
|       - |  608 | `			/* Blob consumer */` |
| 1005892 |  609 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 1005890 |  610 | `			break;` |
|     ! 0 |  611 | `		default:` |
...
| 1006048 |  616 | `	pConsumer->nLen += nLen;` |
| 1006048 |  617 | `	pConsumer->rc = rc;` |
| 1006048 |  618 | `	return rc;` |
|       2 |  619 |  |
|  195074 |  620 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|       2 |  621 |  |
|       - |  622 | `	SyFmtConsumer sCons;` |
|  195076 |  623 | `	sCons.nType = nType;` |
|  195076 |  624 | `	sCons.rc = SXRET_OK;` |
|  195076 |  625 | `	sCons.nLen = 0;` |
|  195076 |  626 | `	if( pOutLen ){` |
|   62992 |  627 | `		*pOutLen = 0;` |
|   31495 |  628 | `	}` |
|  195076 |  629 | `	switch(nType){` |
...
|      13 |  638 | `		break;` |
|   97531 |  639 | `		case SXFMT_CONS_BLOB:` |
|  195064 |  640 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  195064 |  641 | `			break;` |
|     ! 0 |  642 | `		default:` |
|     ! 0 |  643 | `			return SXERR_UNKNOWN;` |
|       - |  644 | `	}` |
|  195076 |  645 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  195076 |  646 | `	if( pOutLen ){` |
|   62992 |  647 | `		*pOutLen = sCons.nLen;` |
|   31495 |  648 | `	}` |
|  195076 |  649 | `	return sCons.rc;` |
|   97539 |  650 |  |
...
|      13 |  663 | `	return rc;` |
|       1 |  664 |  |
|   61788 |  665 | `PH7_PRIVATE sxu32 SyBlobFormat(SyBlob *pBlob,const char *zFormat,...)` |
|       2 |  666 |  |
|       - |  667 | `	va_list ap;` |
|       - |  668 | `	sxu32 n;` |
...
|       - |  672 | `	}` |
|       - |  673 | `#endif` |
|   61790 |  674 | `	va_start(ap,zFormat);` |
|   61790 |  675 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|   61790 |  676 | `	va_end(ap);` |
|   61790 |  677 | `	return n;` |
|       2 |  678 |  |
...
|    1204 |  688 | `	return n;` |
|       2 |  689 |  |
|  132072 |  690 | `PH7_PRIVATE sxu32 SyBufferFormat(char *zBuf,sxu32 nLen,const char *zFormat,...)` |
|       2 |  691 |  |
|       - |  692 | `	SyBlob sBlob;` |
|       - |  693 | `	va_list ap;` |
|       - |  694 | `	sxu32 n;` |
...
|       - |  698 | `	}` |
|       - |  699 | `#endif` |
|  132074 |  700 | `	if( SXRET_OK != SyBlobInitFromBuf(&sBlob,zBuf,nLen - 1) ){` |
|     ! 0 |  701 | `		return 0;` |
|       - |  702 | `	}` |
|  132074 |  703 | `	va_start(ap,zFormat);` |
|  132074 |  704 | `	FormatMount(SXFMT_CONS_BLOB,&sBlob,0,0,0,zFormat,ap);` |
|  132074 |  705 | `	va_end(ap);` |
|  132074 |  706 | `	n = SyBlobLength(&sBlob);` |
|       - |  707 | `	/* Append the null terminator */` |
|  132074 |  708 | `	sBlob.mByte++;` |
|  132074 |  709 | `	SyBlobAppend(&sBlob,"\0",sizeof(char));` |
|  132074 |  710 | `	return n;` |
|   66038 |  711 |  |
|       - |  712 |  |
