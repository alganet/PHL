...
|        - |   90 | ` */` |
|  2527616 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|        5 |   92 | `{` |
|        - |   93 | `	/*` |
...
|  2527621 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|        - |  151 | `  int rc;` |
|        - |  152 |  |
|  2527621 |  153 | `  length = 0;` |
|  2527621 |  154 | `  bufpt = 0;` |
|  9935941 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
|  9840083 |  156 | `    if( c!='%' ){` |
|        - |  157 | `      unsigned int amt;` |
|  9705445 |  158 | `      bufpt = (char *)zFormat;` |
|  9705445 |  159 | `      amt = 1;` |
| 15366081 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
|  9705445 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
|  9705445 |  162 | `	  if( rc != SXRET_OK ){` |
|      ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  164 | `	  }` |
|  9705445 |  165 | `      if( c==0 ){` |
|  2431763 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|        - |  167 | `	  }` |
|  3636841 |  168 | `    }` |
|  7408325 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|      ! 0 |  170 | `      errorflag = 1;` |
...
|  7408325 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  7408320 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  3704160 |  180 | `    do{` |
|  7409677 |  181 | `      switch( c ){` |
...
|  7408320 |  187 | `        default:                                       break;` |
|        - |  188 | `      }` |
|  7409677 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|      ! 0 |  198 | `      c = *++zFormat;` |
|      ! 0 |  199 | `    }else{` |
|  7409721 |  200 | `      while( c>='0' && c<='9' ){` |
|     1399 |  201 | `        width = width*10 + c - '0';` |
|     1399 |  202 | `        c = *++zFormat;` |
|        3 |  203 | `      }` |
|        - |  204 | `    }` |
|  7408325 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|      ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|      ! 0 |  207 | `    }` |
|        - |  208 | `    /* Get the precision */` |
|  7408325 |  209 | `	precision = -1;` |
|  7408325 |  210 | `    if( c=='.' ){` |
|  2402629 |  211 | `      precision = 0;` |
|  2402629 |  212 | `      c = *++zFormat;` |
|  2402629 |  213 | `      if( c=='*' ){` |
|  2402617 |  214 | `        precision = va_arg(ap,int);` |
|  2402617 |  215 | `        if( precision<0 ) precision = -precision;` |
|  2402617 |  216 | `        c = *++zFormat;` |
|  1201311 |  217 | `      }else{` |
...
|  7408325 |  225 | `	flag_long = 0;` |
|  7408325 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
|    62291 |  227 | `      flag_long = (c == 'q') ? 2 : 1;` |
|    62291 |  228 | `      c = *++zFormat;` |
|    62291 |  229 | `	  if( c == 'l' ){` |
...
|  7408325 |  235 | `    infop = 0;` |
|  7408325 |  236 | `    xtype = SXFMT_ERROR;` |
| 34120959 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 34120959 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  7408325 |  239 | `        infop = &aFmt[idx];` |
|  7408325 |  240 | `		xtype = infop->type;` |
|  7408325 |  241 | `        break;` |
|        - |  242 | `      }` |
| 13356322 |  243 | `    }` |
...
|        - |  263 | `    */` |
|  7408325 |  264 | `    switch( xtype ){` |
|    35948 |  265 | `      case SXFMT_RADIX:` |
|    71901 |  266 | `        if( flag_long > 0 ){` |
|    62291 |  267 | `			if( flag_long > 1 ){` |
|        - |  268 | `				/* BSD quad: expect a 64-bit integer */` |
|    62279 |  269 | `				longvalue = va_arg(ap,sxi64);` |
|    31142 |  270 | `			}else{` |
...
|    71901 |  281 | `      if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|        - |  282 | `#if 1` |
|        - |  283 | `        /* For the format %#x, the value zero is printed "0" not "0x0".` |
|        - |  284 | `        ** I think this is stupid.*/` |
|    71901 |  285 | `        if( longvalue==0 ) flag_alternateform = 0;` |
|        - |  286 | `#else` |
...
|        - |  290 | `#endif` |
|    71901 |  291 | `        if( infop->flags & SXFLAG_SIGNED ){` |
|    67357 |  292 | `          if( longvalue<0 ){` |
...
|     4549 |  306 | `			prefix = 0;` |
|        - |  307 | `		}` |
|    71901 |  308 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|     1340 |  309 | `          precision = width-(prefix!=0);` |
|      669 |  310 | `        }` |
|    71901 |  311 | `        bufpt = &buf[SXFMT_BUFSIZ-1];` |
|        - |  312 | `        {` |
|        - |  313 | `          register char *cset;      /* Use registers for speed */` |
|        - |  314 | `          register int base;` |
|    71901 |  315 | `          cset = infop->charset;` |
|    71901 |  316 | `          base = infop->base;` |
|    35948 |  317 | `          do{                                           /* Convert to ascii */` |
|   203742 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|   203742 |  319 | `            ulongvalue = ulongvalue/base;` |
|   203742 |  320 | `          }while( ulongvalue>0 );` |
|        - |  321 | `        }` |
|    71901 |  322 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    73004 |  323 | `        for(idx=precision-length; idx>0; idx--){` |
|     1105 |  324 | `          *(--bufpt) = '0';                             /* Zero pad */` |
|      552 |  325 | `        }` |
|    71901 |  326 | `        if( prefix ) *(--bufpt) = prefix;               /* Add sign */` |
|    71901 |  327 | `        if( flag_alternateform && infop->prefix ){      /* Add "0" or "0x" */` |
|        - |  328 | `          char *pre, x;` |
...
|        1 |  332 | `          }` |
|        1 |  333 | `        }` |
|    71901 |  334 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    71901 |  335 | `        break;` |
...
|      ! 0 |  496 | `        length = 1;` |
|      ! 0 |  497 | `        break;` |
|     4934 |  498 | `      case SXFMT_CHARX:` |
|     9873 |  499 | `        c = va_arg(ap,int);` |
|     9873 |  500 | `		buf[0] = (char)c;` |
|        - |  501 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|     9873 |  502 | `		if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|     9873 |  503 | `        if( precision>=0 ){` |
...
|     9873 |  509 | `        bufpt = buf;` |
|     9873 |  510 | `        break;` |
|  1246996 |  511 | `      case SXFMT_STRING:` |
|  2493997 |  512 | `        bufpt = va_arg(ap,char*);` |
|  2493997 |  513 | `        if( bufpt==0 ){` |
|      ! 0 |  514 | `          bufpt = " ";` |
|      ! 0 |  515 | `		  length = (int)sizeof(" ")-1;` |
|      ! 0 |  516 | `		  break;` |
|        - |  517 | `        }` |
|  2493997 |  518 | `		length = precision;` |
|  2493997 |  519 | `		if( precision < 0 ){` |
|        - |  520 | `			/* Symisc extension */` |
|    91373 |  521 | `			length = (int)SyStrlen(bufpt);` |
|    45684 |  522 | `		}` |
|  2493997 |  523 | `        if( precision>=0 && precision<length ) length = precision;` |
|  2493997 |  524 | `        break;` |
|  2416268 |  525 | `	case SXFMT_RAWSTR:{` |
|        - |  526 | `		/* Symisc extension */` |
|  4832541 |  527 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  4832541 |  528 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|      ! 0 |  529 | `			 bufpt = " ";` |
|      ! 0 |  530 | `		     length = (int)sizeof(char);` |
|      ! 0 |  531 | `		     break;` |
|        - |  532 | `		}` |
|  4832541 |  533 | `		bufpt = (char *)pStr->zString;` |
|  4832541 |  534 | `		length = (int)pStr->nByte;` |
|  4832541 |  535 | `		break;` |
|        - |  536 | `					  }` |
...
|        - |  547 | `    ** the output.` |
|        - |  548 | `    */` |
|  7408325 |  549 | `    if( !flag_leftjustify ){` |
|        - |  550 | `      register int nspace;` |
|  7408325 |  551 | `      nspace = width-length;` |
|  7408325 |  552 | `      if( nspace>0 ){` |
...
|       18 |  566 | `      }` |
|  3704160 |  567 | `    }` |
|  7408325 |  568 | `    if( length>0 ){` |
|  7407983 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  7407983 |  570 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  572 | `		}` |
|  3703989 |  573 | `    }` |
|  7408325 |  574 | `    if( flag_leftjustify ){` |
...
|      ! 0 |  591 | `      }` |
|      ! 0 |  592 | `    }` |
|  3704165 |  593 | `  }/* End for loop over the format string */` |
|    95863 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|  1263813 |  595 | `}` |
|        - |  596 | `/* SPDX-SnippetEnd */` |
| 17113454 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|        5 |  598 | `{` |
| 17113459 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 17113459 |  600 | `	sxi32 rc = SXERR_ABORT;` |
| 17113459 |  601 | `	switch(pConsumer->nType){` |
...
|      181 |  605 | `			break;` |
|  8556637 |  606 | `	case SXFMT_CONS_BLOB:` |
|        - |  607 | `			/* Blob consumer */` |
| 17113279 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 17113274 |  609 | `			break;` |
|      ! 0 |  610 | `		default:` |
...
| 17113459 |  615 | `	pConsumer->nLen += nLen;` |
| 17113459 |  616 | `	pConsumer->rc = rc;` |
| 17113459 |  617 | `	return rc;` |
|        5 |  618 | `}` |
|  2527616 |  619 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|        5 |  620 | `{` |
|        - |  621 | `	SyFmtConsumer sCons;` |
|  2527621 |  622 | `	sCons.nType = nType;` |
|  2527621 |  623 | `	sCons.rc = SXRET_OK;` |
|  2527621 |  624 | `	sCons.nLen = 0;` |
|  2527621 |  625 | `	if( pOutLen ){` |
|   120447 |  626 | `		*pOutLen = 0;` |
|    60221 |  627 | `	}` |
|  2527621 |  628 | `	switch(nType){` |
...
|       13 |  637 | `		break;` |
|  1263802 |  638 | `		case SXFMT_CONS_BLOB:` |
|  2527609 |  639 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  2527609 |  640 | `			break;` |
|      ! 0 |  641 | `		default:` |
|      ! 0 |  642 | `			return SXERR_UNKNOWN;` |
|        - |  643 | `	}` |
|  2527621 |  644 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  2527621 |  645 | `	if( pOutLen ){` |
|   120447 |  646 | `		*pOutLen = sCons.nLen;` |
|    60221 |  647 | `	}` |
|  2527621 |  648 | `	return sCons.rc;` |
|  1263813 |  649 | `}` |
...
|       13 |  662 | `	return rc;` |
|        1 |  663 | `}` |
|    96672 |  664 | `PH7_PRIVATE sxu32 SyBlobFormat(SyBlob *pBlob,const char *zFormat,...)` |
|        5 |  665 | `{` |
|        - |  666 | `	va_list ap;` |
|        - |  667 | `	sxu32 n;` |
...
|        - |  671 | `	}` |
|        - |  672 | `#endif` |
|    96677 |  673 | `	va_start(ap,zFormat);` |
|    96677 |  674 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    96677 |  675 | `	va_end(ap);` |
|    96677 |  676 | `	return n;` |
|        5 |  677 | `}` |
...
|    23775 |  687 | `	return n;` |
|        5 |  688 | `}` |
|  2407162 |  689 | `PH7_PRIVATE sxu32 SyBufferFormat(char *zBuf,sxu32 nLen,const char *zFormat,...)` |
|        5 |  690 | `{` |
|        - |  691 | `	SyBlob sBlob;` |
|        - |  692 | `	va_list ap;` |
|        - |  693 | `	sxu32 n;` |
...
|        - |  697 | `	}` |
|        - |  698 | `#endif` |
|  2407167 |  699 | `	if( SXRET_OK != SyBlobInitFromBuf(&sBlob,zBuf,nLen - 1) ){` |
|      ! 0 |  700 | `		return 0;` |
|        - |  701 | `	}` |
|  2407167 |  702 | `	va_start(ap,zFormat);` |
|  2407167 |  703 | `	FormatMount(SXFMT_CONS_BLOB,&sBlob,0,0,0,zFormat,ap);` |
|  2407167 |  704 | `	va_end(ap);` |
|  2407167 |  705 | `	n = SyBlobLength(&sBlob);` |
|        - |  706 | `	/* Append the null terminator */` |
|  2407167 |  707 | `	sBlob.mByte++;` |
|  2407167 |  708 | `	SyBlobAppend(&sBlob,"\0",sizeof(char));` |
|  2407167 |  709 | `	return n;` |
|  1203586 |  710 | `}` |
|        - |  711 |  |
