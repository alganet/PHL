...
|        - |   90 | ` */` |
|  2729112 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|        5 |   92 | `{` |
|        - |   93 | `	/*` |
...
|  2729117 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|        - |  151 | `  int rc;` |
|        - |  152 |  |
|  2729117 |  153 | `  length = 0;` |
|  2729117 |  154 | `  bufpt = 0;` |
| 10741529 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
| 10645463 |  156 | `    if( c!='%' ){` |
|        - |  157 | `      unsigned int amt;` |
| 10510463 |  158 | `      bufpt = (char *)zFormat;` |
| 10510463 |  159 | `      amt = 1;` |
| 16578723 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
| 10510463 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
| 10510463 |  162 | `	  if( rc != SXRET_OK ){` |
|      ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  164 | `	  }` |
| 10510463 |  165 | `      if( c==0 ){` |
|  2633051 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|        - |  167 | `	  }` |
|  3938706 |  168 | `    }` |
|  8012417 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|      ! 0 |  170 | `      errorflag = 1;` |
...
|  8012417 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  8012412 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  4006206 |  180 | `    do{` |
|  8013769 |  181 | `      switch( c ){` |
...
|  8012412 |  187 | `        default:                                       break;` |
|        - |  188 | `      }` |
|  8013769 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|      ! 0 |  198 | `      c = *++zFormat;` |
|      ! 0 |  199 | `    }else{` |
|  8013813 |  200 | `      while( c>='0' && c<='9' ){` |
|     1398 |  201 | `        width = width*10 + c - '0';` |
|     1398 |  202 | `        c = *++zFormat;` |
|        2 |  203 | `      }` |
|        - |  204 | `    }` |
|  8012417 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|      ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|      ! 0 |  207 | `    }` |
|        - |  208 | `    /* Get the precision */` |
|  8012417 |  209 | `	precision = -1;` |
|  8012417 |  210 | `    if( c=='.' ){` |
|  2603751 |  211 | `      precision = 0;` |
|  2603751 |  212 | `      c = *++zFormat;` |
|  2603751 |  213 | `      if( c=='*' ){` |
|  2603739 |  214 | `        precision = va_arg(ap,int);` |
|  2603739 |  215 | `        if( precision<0 ) precision = -precision;` |
|  2603739 |  216 | `        c = *++zFormat;` |
|  1301872 |  217 | `      }else{` |
...
|  8012417 |  225 | `	flag_long = 0;` |
|  8012417 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
|    62367 |  227 | `      flag_long = (c == 'q') ? 2 : 1;` |
|    62367 |  228 | `      c = *++zFormat;` |
|    62367 |  229 | `	  if( c == 'l' ){` |
...
|  8012417 |  235 | `    infop = 0;` |
|  8012417 |  236 | `    xtype = SXFMT_ERROR;` |
| 36938645 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 36938645 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  8012417 |  239 | `        infop = &aFmt[idx];` |
|  8012417 |  240 | `		xtype = infop->type;` |
|  8012417 |  241 | `        break;` |
|        - |  242 | `      }` |
| 14463119 |  243 | `    }` |
...
|        - |  263 | `    */` |
|  8012417 |  264 | `    switch( xtype ){` |
|    36002 |  265 | `      case SXFMT_RADIX:` |
|    72009 |  266 | `        if( flag_long > 0 ){` |
|    62367 |  267 | `			if( flag_long > 1 ){` |
|        - |  268 | `				/* BSD quad: expect a 64-bit integer */` |
|    62355 |  269 | `				longvalue = va_arg(ap,sxi64);` |
|    31180 |  270 | `			}else{` |
|       13 |  271 | `				longvalue = va_arg(ap,sxlong);` |
|        - |  272 | `			}` |
|    31186 |  273 | `		}else{` |
|     9647 |  274 | `			if( infop->flags & SXFLAG_SIGNED ){` |
|     5149 |  275 | `				longvalue = va_arg(ap,sxi32);` |
|     2577 |  276 | `			}else{` |
|     4503 |  277 | `				longvalue = va_arg(ap,sxu32);` |
|        - |  278 | `			}` |
|        - |  279 | `		}` |
|        - |  280 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|    72009 |  281 | `      if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|        - |  282 | `#if 1` |
|        - |  283 | `        /* For the format %#x, the value zero is printed "0" not "0x0".` |
|        - |  284 | `        ** I think this is stupid.*/` |
|    72009 |  285 | `        if( longvalue==0 ) flag_alternateform = 0;` |
|        - |  286 | `#else` |
...
|        - |  290 | `#endif` |
|    72009 |  291 | `        if( infop->flags & SXFLAG_SIGNED ){` |
|    67453 |  292 | `          if( longvalue<0 ){` |
...
|      221 |  297 | `            prefix = '-';` |
|      112 |  298 | `          }else{` |
|    67235 |  299 | `            ulongvalue = (sxu64)longvalue;` |
|    67235 |  300 | `            if( flag_plussign )        prefix = '+';` |
|    67235 |  301 | `            else if( flag_blanksign )  prefix = ' ';` |
|    67235 |  302 | `            else                       prefix = 0;` |
|        - |  303 | `          }` |
|    33729 |  304 | `        }else{` |
|     4561 |  305 | `			ulongvalue = (sxu64)longvalue; /* print the full unsigned value as-is */` |
|     4561 |  306 | `			prefix = 0;` |
|        - |  307 | `		}` |
|    72009 |  308 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|     1340 |  309 | `          precision = width-(prefix!=0);` |
|      669 |  310 | `        }` |
|    72009 |  311 | `        bufpt = &buf[SXFMT_BUFSIZ-1];` |
|        - |  312 | `        {` |
|        - |  313 | `          register char *cset;      /* Use registers for speed */` |
|        - |  314 | `          register int base;` |
|    72009 |  315 | `          cset = infop->charset;` |
|    72009 |  316 | `          base = infop->base;` |
|    36002 |  317 | `          do{                                           /* Convert to ascii */` |
|   203919 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|   203919 |  319 | `            ulongvalue = ulongvalue/base;` |
|   203919 |  320 | `          }while( ulongvalue>0 );` |
|        - |  321 | `        }` |
|    72009 |  322 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    73113 |  323 | `        for(idx=precision-length; idx>0; idx--){` |
|     1106 |  324 | `          *(--bufpt) = '0';                             /* Zero pad */` |
|      552 |  325 | `        }` |
|    72009 |  326 | `        if( prefix ) *(--bufpt) = prefix;               /* Add sign */` |
|    72009 |  327 | `        if( flag_alternateform && infop->prefix ){      /* Add "0" or "0x" */` |
|        - |  328 | `          char *pre, x;` |
...
|        1 |  332 | `          }` |
|        1 |  333 | `        }` |
|    72009 |  334 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    72009 |  335 | `        break;` |
...
|     9899 |  499 | `        c = va_arg(ap,int);` |
|     9899 |  500 | `		buf[0] = (char)c;` |
|        - |  501 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|     9899 |  502 | `		if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|     9899 |  503 | `        if( precision>=0 ){` |
...
|     9899 |  509 | `        bufpt = buf;` |
|     9899 |  510 | `        break;` |
|  1347789 |  511 | `      case SXFMT_STRING:` |
|  2695583 |  512 | `        bufpt = va_arg(ap,char*);` |
|  2695583 |  513 | `        if( bufpt==0 ){` |
|      ! 0 |  514 | `          bufpt = " ";` |
|      ! 0 |  515 | `		  length = (int)sizeof(" ")-1;` |
|      ! 0 |  516 | `		  break;` |
|        - |  517 | `        }` |
|  2695583 |  518 | `		length = precision;` |
|  2695583 |  519 | `		if( precision < 0 ){` |
|        - |  520 | `			/* Symisc extension */` |
|    91837 |  521 | `			length = (int)SyStrlen(bufpt);` |
|    45916 |  522 | `		}` |
|  2695583 |  523 | `        if( precision>=0 && precision<length ) length = precision;` |
|  2695583 |  524 | `        break;` |
|  2617454 |  525 | `	case SXFMT_RAWSTR:{` |
|        - |  526 | `		/* Symisc extension */` |
|  5234913 |  527 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  5234913 |  528 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|      ! 0 |  529 | `			 bufpt = " ";` |
|      ! 0 |  530 | `		     length = (int)sizeof(char);` |
|      ! 0 |  531 | `		     break;` |
|        - |  532 | `		}` |
|  5234913 |  533 | `		bufpt = (char *)pStr->zString;` |
|  5234913 |  534 | `		length = (int)pStr->nByte;` |
|  5234913 |  535 | `		break;` |
|        - |  536 | `					  }` |
...
|        - |  547 | `    ** the output.` |
|        - |  548 | `    */` |
|  8012417 |  549 | `    if( !flag_leftjustify ){` |
|        - |  550 | `      register int nspace;` |
|  8012417 |  551 | `      nspace = width-length;` |
|  8012417 |  552 | `      if( nspace>0 ){` |
...
|       18 |  566 | `      }` |
|  4006206 |  567 | `    }` |
|  8012417 |  568 | `    if( length>0 ){` |
|  8012075 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  8012075 |  570 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  572 | `		}` |
|  4006035 |  573 | `    }` |
|  8012417 |  574 | `    if( flag_leftjustify ){` |
...
|      ! 0 |  591 | `      }` |
|      ! 0 |  592 | `    }` |
|  4006211 |  593 | `  }/* End for loop over the format string */` |
|    96071 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|  1364561 |  595 | `}` |
|        - |  596 | `/* SPDX-SnippetEnd */` |
| 18522564 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|        5 |  598 | `{` |
| 18522569 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 18522569 |  600 | `	sxi32 rc = SXERR_ABORT;` |
| 18522569 |  601 | `	switch(pConsumer->nType){` |
...
|      181 |  605 | `			break;` |
|  9261192 |  606 | `	case SXFMT_CONS_BLOB:` |
|        - |  607 | `			/* Blob consumer */` |
| 18522389 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 18522384 |  609 | `			break;` |
|      ! 0 |  610 | `		default:` |
...
| 18522569 |  615 | `	pConsumer->nLen += nLen;` |
| 18522569 |  616 | `	pConsumer->rc = rc;` |
| 18522569 |  617 | `	return rc;` |
|        5 |  618 | `}` |
|  2729112 |  619 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|        5 |  620 | `{` |
|        - |  621 | `	SyFmtConsumer sCons;` |
|  2729117 |  622 | `	sCons.nType = nType;` |
|  2729117 |  623 | `	sCons.rc = SXRET_OK;` |
|  2729117 |  624 | `	sCons.nLen = 0;` |
|  2729117 |  625 | `	if( pOutLen ){` |
|   120763 |  626 | `		*pOutLen = 0;` |
|    60379 |  627 | `	}` |
|  2729117 |  628 | `	switch(nType){` |
...
|       13 |  637 | `		break;` |
|  1364550 |  638 | `		case SXFMT_CONS_BLOB:` |
|  2729105 |  639 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  2729105 |  640 | `			break;` |
|      ! 0 |  641 | `		default:` |
|      ! 0 |  642 | `			return SXERR_UNKNOWN;` |
|        - |  643 | `	}` |
|  2729117 |  644 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  2729117 |  645 | `	if( pOutLen ){` |
|   120763 |  646 | `		*pOutLen = sCons.nLen;` |
|    60379 |  647 | `	}` |
|  2729117 |  648 | `	return sCons.rc;` |
|  1364561 |  649 | `}` |
...
|       13 |  662 | `	return rc;` |
|        1 |  663 | `}` |
|    96876 |  664 | `PH7_PRIVATE sxu32 SyBlobFormat(SyBlob *pBlob,const char *zFormat,...)` |
|        5 |  665 | `{` |
|        - |  666 | `	va_list ap;` |
|        - |  667 | `	sxu32 n;` |
...
|        - |  671 | `	}` |
|        - |  672 | `#endif` |
|    96881 |  673 | `	va_start(ap,zFormat);` |
|    96881 |  674 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    96881 |  675 | `	va_end(ap);` |
|    96881 |  676 | `	return n;` |
|        5 |  677 | `}` |
|    23882 |  678 | `PH7_PRIVATE sxu32 SyBlobFormatAp(SyBlob *pBlob,const char *zFormat,va_list ap)` |
|        5 |  679 | `{` |
|    23887 |  680 | `	sxu32 n = 0; /* cc warning */` |
|        - |  681 | `#if defined(UNTRUST)` |
|        - |  682 | `	if( SX_EMPTY_STR(zFormat) ){` |
|        - |  683 | `		return 0;` |
|        - |  684 | `	}` |
|        - |  685 | `#endif` |
|    23887 |  686 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    23887 |  687 | `	return n;` |
|        5 |  688 | `}` |
|  2608342 |  689 | `PH7_PRIVATE sxu32 SyBufferFormat(char *zBuf,sxu32 nLen,const char *zFormat,...)` |
|        5 |  690 | `{` |
|        - |  691 | `	SyBlob sBlob;` |
|        - |  692 | `	va_list ap;` |
|        - |  693 | `	sxu32 n;` |
...
|        - |  697 | `	}` |
|        - |  698 | `#endif` |
|  2608347 |  699 | `	if( SXRET_OK != SyBlobInitFromBuf(&sBlob,zBuf,nLen - 1) ){` |
|      ! 0 |  700 | `		return 0;` |
|        - |  701 | `	}` |
|  2608347 |  702 | `	va_start(ap,zFormat);` |
|  2608347 |  703 | `	FormatMount(SXFMT_CONS_BLOB,&sBlob,0,0,0,zFormat,ap);` |
|  2608347 |  704 | `	va_end(ap);` |
|  2608347 |  705 | `	n = SyBlobLength(&sBlob);` |
|        - |  706 | `	/* Append the null terminator */` |
|  2608347 |  707 | `	sBlob.mByte++;` |
|  2608347 |  708 | `	SyBlobAppend(&sBlob,"\0",sizeof(char));` |
|  2608347 |  709 | `	return n;` |
|  1304176 |  710 | `}` |
|        - |  711 |  |
