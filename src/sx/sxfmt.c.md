...
|        - |   90 | ` */` |
|  2517028 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|        5 |   92 | `{` |
|        - |   93 | `	/*` |
...
|  2517033 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|        - |  151 | `  int rc;` |
|        - |  152 |  |
|  2517033 |  153 | `  length = 0;` |
|  2517033 |  154 | `  bufpt = 0;` |
|  9898563 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
|  9805219 |  156 | `    if( c!='%' ){` |
|        - |  157 | `      unsigned int amt;` |
|  9673599 |  158 | `      bufpt = (char *)zFormat;` |
|  9673599 |  159 | `      amt = 1;` |
| 15315035 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
|  9673599 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
|  9673599 |  162 | `	  if( rc != SXRET_OK ){` |
|      ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  164 | `	  }` |
|  9673599 |  165 | `      if( c==0 ){` |
|  2423689 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|        - |  167 | `	  }` |
|  3624955 |  168 | `    }` |
|  7381535 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|      ! 0 |  170 | `      errorflag = 1;` |
...
|  7381535 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  7381530 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  3690765 |  180 | `    do{` |
|  7382887 |  181 | `      switch( c ){` |
...
|  7381530 |  187 | `        default:                                       break;` |
|        - |  188 | `      }` |
|  7382887 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|      ! 0 |  198 | `      c = *++zFormat;` |
|      ! 0 |  199 | `    }else{` |
|  7382931 |  200 | `      while( c>='0' && c<='9' ){` |
|     1399 |  201 | `        width = width*10 + c - '0';` |
|     1399 |  202 | `        c = *++zFormat;` |
|        3 |  203 | `      }` |
|        - |  204 | `    }` |
|  7381535 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|      ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|      ! 0 |  207 | `    }` |
|        - |  208 | `    /* Get the precision */` |
|  7381535 |  209 | `	precision = -1;` |
|  7381535 |  210 | `    if( c=='.' ){` |
|  2394929 |  211 | `      precision = 0;` |
|  2394929 |  212 | `      c = *++zFormat;` |
|  2394929 |  213 | `      if( c=='*' ){` |
|  2394917 |  214 | `        precision = va_arg(ap,int);` |
|  2394917 |  215 | `        if( precision<0 ) precision = -precision;` |
|  2394917 |  216 | `        c = *++zFormat;` |
|  1197461 |  217 | `      }else{` |
...
|  7381535 |  225 | `	flag_long = 0;` |
|  7381535 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
|    60121 |  227 | `      flag_long = (c == 'q') ? 2 : 1;` |
|    60121 |  228 | `      c = *++zFormat;` |
|    60121 |  229 | `	  if( c == 'l' ){` |
...
|  7381535 |  235 | `    infop = 0;` |
|  7381535 |  236 | `    xtype = SXFMT_ERROR;` |
| 34006647 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 34006647 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  7381535 |  239 | `        infop = &aFmt[idx];` |
|  7381535 |  240 | `		xtype = infop->type;` |
|  7381535 |  241 | `        break;` |
|        - |  242 | `      }` |
| 13312561 |  243 | `    }` |
...
|        - |  263 | `    */` |
|  7381535 |  264 | `    switch( xtype ){` |
|    34823 |  265 | `      case SXFMT_RADIX:` |
|    69651 |  266 | `        if( flag_long > 0 ){` |
|    60121 |  267 | `			if( flag_long > 1 ){` |
|        - |  268 | `				/* BSD quad: expect a 64-bit integer */` |
|    60109 |  269 | `				longvalue = va_arg(ap,sxi64);` |
|    30057 |  270 | `			}else{` |
|       13 |  271 | `				longvalue = va_arg(ap,sxlong);` |
|        - |  272 | `			}` |
|    30063 |  273 | `		}else{` |
|     9535 |  274 | `			if( infop->flags & SXFLAG_SIGNED ){` |
|     5069 |  275 | `				longvalue = va_arg(ap,sxi32);` |
|     2537 |  276 | `			}else{` |
|     4471 |  277 | `				longvalue = va_arg(ap,sxu32);` |
|        - |  278 | `			}` |
|        - |  279 | `		}` |
|        - |  280 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|    69651 |  281 | `      if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|        - |  282 | `#if 1` |
|        - |  283 | `        /* For the format %#x, the value zero is printed "0" not "0x0".` |
|        - |  284 | `        ** I think this is stupid.*/` |
|    69651 |  285 | `        if( longvalue==0 ) flag_alternateform = 0;` |
|        - |  286 | `#else` |
...
|        - |  290 | `#endif` |
|    69651 |  291 | `        if( infop->flags & SXFLAG_SIGNED ){` |
|    65127 |  292 | `          if( longvalue<0 ){` |
...
|      197 |  297 | `            prefix = '-';` |
|      100 |  298 | `          }else{` |
|    64933 |  299 | `            ulongvalue = (sxu64)longvalue;` |
|    64933 |  300 | `            if( flag_plussign )        prefix = '+';` |
|    64933 |  301 | `            else if( flag_blanksign )  prefix = ' ';` |
|    64933 |  302 | `            else                       prefix = 0;` |
|        - |  303 | `          }` |
|    32566 |  304 | `        }else{` |
|     4529 |  305 | `			ulongvalue = (sxu64)longvalue; /* print the full unsigned value as-is */` |
|     4529 |  306 | `			prefix = 0;` |
|        - |  307 | `		}` |
|    69651 |  308 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|     1340 |  309 | `          precision = width-(prefix!=0);` |
|      669 |  310 | `        }` |
|    69651 |  311 | `        bufpt = &buf[SXFMT_BUFSIZ-1];` |
|        - |  312 | `        {` |
|        - |  313 | `          register char *cset;      /* Use registers for speed */` |
|        - |  314 | `          register int base;` |
|    69651 |  315 | `          cset = infop->charset;` |
|    69651 |  316 | `          base = infop->base;` |
|    34823 |  317 | `          do{                                           /* Convert to ascii */` |
|   197511 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|   197511 |  319 | `            ulongvalue = ulongvalue/base;` |
|   197511 |  320 | `          }while( ulongvalue>0 );` |
|        - |  321 | `        }` |
|    69651 |  322 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    70771 |  323 | `        for(idx=precision-length; idx>0; idx--){` |
|     1122 |  324 | `          *(--bufpt) = '0';                             /* Zero pad */` |
|      562 |  325 | `        }` |
|    69651 |  326 | `        if( prefix ) *(--bufpt) = prefix;               /* Add sign */` |
|    69651 |  327 | `        if( flag_alternateform && infop->prefix ){      /* Add "0" or "0x" */` |
|        - |  328 | `          char *pre, x;` |
...
|        1 |  332 | `          }` |
|        1 |  333 | `        }` |
|    69651 |  334 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    69651 |  335 | `        break;` |
...
|     9747 |  509 | `        bufpt = buf;` |
|     9747 |  510 | `        break;` |
|  1242626 |  511 | `      case SXFMT_STRING:` |
|  2485257 |  512 | `        bufpt = va_arg(ap,char*);` |
|  2485257 |  513 | `        if( bufpt==0 ){` |
|      ! 0 |  514 | `          bufpt = " ";` |
|      ! 0 |  515 | `		  length = (int)sizeof(" ")-1;` |
|      ! 0 |  516 | `		  break;` |
|        - |  517 | `        }` |
|  2485257 |  518 | `		length = precision;` |
|  2485257 |  519 | `		if( precision < 0 ){` |
|        - |  520 | `			/* Symisc extension */` |
|    90333 |  521 | `			length = (int)SyStrlen(bufpt);` |
|    45164 |  522 | `		}` |
|  2485257 |  523 | `        if( precision>=0 && precision<length ) length = precision;` |
|  2485257 |  524 | `        break;` |
|  2408431 |  525 | `	case SXFMT_RAWSTR:{` |
|        - |  526 | `		/* Symisc extension */` |
|  4816867 |  527 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  4816867 |  528 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|      ! 0 |  529 | `			 bufpt = " ";` |
|      ! 0 |  530 | `		     length = (int)sizeof(char);` |
|      ! 0 |  531 | `		     break;` |
|        - |  532 | `		}` |
|  4816867 |  533 | `		bufpt = (char *)pStr->zString;` |
|  4816867 |  534 | `		length = (int)pStr->nByte;` |
|  4816867 |  535 | `		break;` |
|        - |  536 | `					  }` |
...
|        - |  547 | `    ** the output.` |
|        - |  548 | `    */` |
|  7381535 |  549 | `    if( !flag_leftjustify ){` |
|        - |  550 | `      register int nspace;` |
|  7381535 |  551 | `      nspace = width-length;` |
|  7381535 |  552 | `      if( nspace>0 ){` |
...
|       18 |  566 | `      }` |
|  3690765 |  567 | `    }` |
|  7381535 |  568 | `    if( length>0 ){` |
|  7381193 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  7381193 |  570 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  572 | `		}` |
|  3690594 |  573 | `    }` |
|  7381535 |  574 | `    if( flag_leftjustify ){` |
...
|      ! 0 |  591 | `      }` |
|      ! 0 |  592 | `    }` |
|  3690770 |  593 | `  }/* End for loop over the format string */` |
|    93349 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|  1258519 |  595 | `}` |
|        - |  596 | `/* SPDX-SnippetEnd */` |
| 17054818 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|        5 |  598 | `{` |
| 17054823 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 17054823 |  600 | `	sxi32 rc = SXERR_ABORT;` |
| 17054823 |  601 | `	switch(pConsumer->nType){` |
...
|      181 |  605 | `			break;` |
|  8527319 |  606 | `	case SXFMT_CONS_BLOB:` |
|        - |  607 | `			/* Blob consumer */` |
| 17054643 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 17054638 |  609 | `			break;` |
|      ! 0 |  610 | `		default:` |
...
| 17054823 |  615 | `	pConsumer->nLen += nLen;` |
| 17054823 |  616 | `	pConsumer->rc = rc;` |
| 17054823 |  617 | `	return rc;` |
|        5 |  618 | `}` |
|  2517028 |  619 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|        5 |  620 | `{` |
|        - |  621 | `	SyFmtConsumer sCons;` |
|  2517033 |  622 | `	sCons.nType = nType;` |
|  2517033 |  623 | `	sCons.rc = SXRET_OK;` |
|  2517033 |  624 | `	sCons.nLen = 0;` |
|  2517033 |  625 | `	if( pOutLen ){` |
|   117635 |  626 | `		*pOutLen = 0;` |
|    58815 |  627 | `	}` |
|  2517033 |  628 | `	switch(nType){` |
...
|       13 |  637 | `		break;` |
|  1258508 |  638 | `		case SXFMT_CONS_BLOB:` |
|  2517021 |  639 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  2517021 |  640 | `			break;` |
|      ! 0 |  641 | `		default:` |
|      ! 0 |  642 | `			return SXERR_UNKNOWN;` |
|        - |  643 | `	}` |
|  2517033 |  644 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  2517033 |  645 | `	if( pOutLen ){` |
|   117635 |  646 | `		*pOutLen = sCons.nLen;` |
|    58815 |  647 | `	}` |
|  2517033 |  648 | `	return sCons.rc;` |
|  1258519 |  649 | `}` |
...
|       13 |  662 | `	return rc;` |
|        1 |  663 | `}` |
|    94110 |  664 | `PH7_PRIVATE sxu32 SyBlobFormat(SyBlob *pBlob,const char *zFormat,...)` |
|        5 |  665 | `{` |
|        - |  666 | `	va_list ap;` |
|        - |  667 | `	sxu32 n;` |
...
|        - |  671 | `	}` |
|        - |  672 | `#endif` |
|    94115 |  673 | `	va_start(ap,zFormat);` |
|    94115 |  674 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    94115 |  675 | `	va_end(ap);` |
|    94115 |  676 | `	return n;` |
|        5 |  677 | `}` |
|    23520 |  678 | `PH7_PRIVATE sxu32 SyBlobFormatAp(SyBlob *pBlob,const char *zFormat,va_list ap)` |
|        5 |  679 | `{` |
|    23525 |  680 | `	sxu32 n = 0; /* cc warning */` |
|        - |  681 | `#if defined(UNTRUST)` |
|        - |  682 | `	if( SX_EMPTY_STR(zFormat) ){` |
|        - |  683 | `		return 0;` |
|        - |  684 | `	}` |
|        - |  685 | `#endif` |
|    23525 |  686 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    23525 |  687 | `	return n;` |
|        5 |  688 | `}` |
|  2399386 |  689 | `PH7_PRIVATE sxu32 SyBufferFormat(char *zBuf,sxu32 nLen,const char *zFormat,...)` |
|        5 |  690 | `{` |
|        - |  691 | `	SyBlob sBlob;` |
|        - |  692 | `	va_list ap;` |
|        - |  693 | `	sxu32 n;` |
...
|        - |  697 | `	}` |
|        - |  698 | `#endif` |
|  2399391 |  699 | `	if( SXRET_OK != SyBlobInitFromBuf(&sBlob,zBuf,nLen - 1) ){` |
|      ! 0 |  700 | `		return 0;` |
|        - |  701 | `	}` |
|  2399391 |  702 | `	va_start(ap,zFormat);` |
|  2399391 |  703 | `	FormatMount(SXFMT_CONS_BLOB,&sBlob,0,0,0,zFormat,ap);` |
|  2399391 |  704 | `	va_end(ap);` |
|  2399391 |  705 | `	n = SyBlobLength(&sBlob);` |
|        - |  706 | `	/* Append the null terminator */` |
|  2399391 |  707 | `	sBlob.mByte++;` |
|  2399391 |  708 | `	SyBlobAppend(&sBlob,"\0",sizeof(char));` |
|  2399391 |  709 | `	return n;` |
|  1199698 |  710 | `}` |
|        - |  711 |  |
