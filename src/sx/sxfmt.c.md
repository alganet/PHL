...
|        - |   90 | ` */` |
|  2479242 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|        5 |   92 | `{` |
|        - |   93 | `	/*` |
...
|  2479247 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|        - |  151 | `  int rc;` |
|        - |  152 |  |
|  2479247 |  153 | `  length = 0;` |
|  2479247 |  154 | `  bufpt = 0;` |
|  9794445 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
|  9723395 |  156 | `    if( c!='%' ){` |
|        - |  157 | `      unsigned int amt;` |
|  9632605 |  158 | `      bufpt = (char *)zFormat;` |
|  9632605 |  159 | `      amt = 1;` |
| 15194715 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
|  9632605 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
|  9632605 |  162 | `	  if( rc != SXRET_OK ){` |
|      ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  164 | `	  }` |
|  9632605 |  165 | `      if( c==0 ){` |
|  2408197 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|        - |  167 | `	  }` |
|  3612204 |  168 | `    }` |
|  7315203 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|      ! 0 |  170 | `      errorflag = 1;` |
...
|  7315203 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  7315198 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  3657599 |  180 | `    do{` |
|  7315937 |  181 | `      switch( c ){` |
...
|  7315198 |  187 | `        default:                                       break;` |
|        - |  188 | `      }` |
|  7315937 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|      ! 0 |  198 | `      c = *++zFormat;` |
|      ! 0 |  199 | `    }else{` |
|  7315973 |  200 | `      while( c>='0' && c<='9' ){` |
|      773 |  201 | `        width = width*10 + c - '0';` |
|      773 |  202 | `        c = *++zFormat;` |
|        3 |  203 | `      }` |
|        - |  204 | `    }` |
|  7315203 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|      ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|      ! 0 |  207 | `    }` |
|        - |  208 | `    /* Get the precision */` |
|  7315203 |  209 | `	precision = -1;` |
|  7315203 |  210 | `    if( c=='.' ){` |
|  2399527 |  211 | `      precision = 0;` |
|  2399527 |  212 | `      c = *++zFormat;` |
|  2399527 |  213 | `      if( c=='*' ){` |
|  2399523 |  214 | `        precision = va_arg(ap,int);` |
|  2399523 |  215 | `        if( precision<0 ) precision = -precision;` |
|  2399523 |  216 | `        c = *++zFormat;` |
|  1199764 |  217 | `      }else{` |
|        9 |  218 | `        while( c>='0' && c<='9' ){` |
...
|  7315203 |  225 | `	flag_long = 0;` |
|  7315203 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
|    59239 |  227 | `      flag_long = (c == 'q') ? 2 : 1;` |
|    59239 |  228 | `      c = *++zFormat;` |
|    59239 |  229 | `	  if( c == 'l' ){` |
...
|  7315203 |  235 | `    infop = 0;` |
|  7315203 |  236 | `    xtype = SXFMT_ERROR;` |
| 33907325 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 33907325 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  7315203 |  239 | `        infop = &aFmt[idx];` |
|  7315203 |  240 | `		xtype = infop->type;` |
|  7315203 |  241 | `        break;` |
|        - |  242 | `      }` |
| 13296066 |  243 | `    }` |
...
|        - |  263 | `    */` |
|  7315203 |  264 | `    switch( xtype ){` |
|    32580 |  265 | `      case SXFMT_RADIX:` |
|    65165 |  266 | `        if( flag_long > 0 ){` |
|    59239 |  267 | `			if( flag_long > 1 ){` |
|        - |  268 | `				/* BSD quad: expect a 64-bit integer */` |
|    59227 |  269 | `				longvalue = va_arg(ap,sxi64);` |
|    29616 |  270 | `			}else{` |
|       13 |  271 | `				longvalue = va_arg(ap,sxlong);` |
|        - |  272 | `			}` |
|    29622 |  273 | `		}else{` |
|     5931 |  274 | `			if( infop->flags & SXFLAG_SIGNED ){` |
|     3911 |  275 | `				longvalue = va_arg(ap,sxi32);` |
|     1958 |  276 | `			}else{` |
|     2025 |  277 | `				longvalue = va_arg(ap,sxu32);` |
|        - |  278 | `			}` |
|        - |  279 | `		}` |
|        - |  280 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|    65165 |  281 | `      if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|        - |  282 | `#if 1` |
|        - |  283 | `        /* For the format %#x, the value zero is printed "0" not "0x0".` |
|        - |  284 | `        ** I think this is stupid.*/` |
|    65165 |  285 | `        if( longvalue==0 ) flag_alternateform = 0;` |
|        - |  286 | `#else` |
...
|        - |  290 | `#endif` |
|    65165 |  291 | `        if( infop->flags & SXFLAG_SIGNED ){` |
|    63091 |  292 | `          if( longvalue<0 ){` |
...
|      179 |  297 | `            prefix = '-';` |
|       91 |  298 | `          }else{` |
|    62915 |  299 | `            ulongvalue = (sxu64)longvalue;` |
|    62915 |  300 | `            if( flag_plussign )        prefix = '+';` |
|    62915 |  301 | `            else if( flag_blanksign )  prefix = ' ';` |
|    62915 |  302 | `            else                       prefix = 0;` |
|        - |  303 | `          }` |
|    31548 |  304 | `        }else{` |
|     2079 |  305 | `			ulongvalue = (sxu64)longvalue; /* print the full unsigned value as-is */` |
|     2079 |  306 | `			prefix = 0;` |
|        - |  307 | `		}` |
|    65165 |  308 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|      722 |  309 | `          precision = width-(prefix!=0);` |
|      360 |  310 | `        }` |
|    65165 |  311 | `        bufpt = &buf[SXFMT_BUFSIZ-1];` |
|        - |  312 | `        {` |
|        - |  313 | `          register char *cset;      /* Use registers for speed */` |
|        - |  314 | `          register int base;` |
|    65165 |  315 | `          cset = infop->charset;` |
|    65165 |  316 | `          base = infop->base;` |
|    32580 |  317 | `          do{                                           /* Convert to ascii */` |
|   189179 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|   189179 |  319 | `            ulongvalue = ulongvalue/base;` |
|   189179 |  320 | `          }while( ulongvalue>0 );` |
|        - |  321 | `        }` |
|    65165 |  322 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    65921 |  323 | `        for(idx=precision-length; idx>0; idx--){` |
|      758 |  324 | `          *(--bufpt) = '0';                             /* Zero pad */` |
|      380 |  325 | `        }` |
|    65165 |  326 | `        if( prefix ) *(--bufpt) = prefix;               /* Add sign */` |
|    65165 |  327 | `        if( flag_alternateform && infop->prefix ){      /* Add "0" or "0x" */` |
|        - |  328 | `          char *pre, x;` |
...
|        1 |  332 | `          }` |
|        1 |  333 | `        }` |
|    65165 |  334 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    65165 |  335 | `        break;` |
...
|     9713 |  509 | `        bufpt = buf;` |
|     9713 |  510 | `        break;` |
|  1205654 |  511 | `      case SXFMT_STRING:` |
|  2411313 |  512 | `        bufpt = va_arg(ap,char*);` |
|  2411313 |  513 | `        if( bufpt==0 ){` |
|      ! 0 |  514 | `          bufpt = " ";` |
|      ! 0 |  515 | `		  length = (int)sizeof(" ")-1;` |
|      ! 0 |  516 | `		  break;` |
|        - |  517 | `        }` |
|  2411313 |  518 | `		length = precision;` |
|  2411313 |  519 | `		if( precision < 0 ){` |
|        - |  520 | `			/* Symisc extension */` |
|    11791 |  521 | `			length = (int)SyStrlen(bufpt);` |
|     5893 |  522 | `		}` |
|  2411313 |  523 | `        if( precision>=0 && precision<length ) length = precision;` |
|  2411313 |  524 | `        break;` |
|  2414500 |  525 | `	case SXFMT_RAWSTR:{` |
|        - |  526 | `		/* Symisc extension */` |
|  4829005 |  527 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  4829005 |  528 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|      ! 0 |  529 | `			 bufpt = " ";` |
|      ! 0 |  530 | `		     length = (int)sizeof(char);` |
|      ! 0 |  531 | `		     break;` |
|        - |  532 | `		}` |
|  4829005 |  533 | `		bufpt = (char *)pStr->zString;` |
|  4829005 |  534 | `		length = (int)pStr->nByte;` |
|  4829005 |  535 | `		break;` |
|        - |  536 | `					  }` |
...
|        - |  547 | `    ** the output.` |
|        - |  548 | `    */` |
|  7315203 |  549 | `    if( !flag_leftjustify ){` |
|        - |  550 | `      register int nspace;` |
|  7315203 |  551 | `      nspace = width-length;` |
|  7315203 |  552 | `      if( nspace>0 ){` |
...
|       18 |  566 | `      }` |
|  3657599 |  567 | `    }` |
|  7315203 |  568 | `    if( length>0 ){` |
|  7314879 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  7314879 |  570 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  572 | `		}` |
|  3657437 |  573 | `    }` |
|  7315203 |  574 | `    if( flag_leftjustify ){` |
...
|      ! 0 |  591 | `      }` |
|      ! 0 |  592 | `    }` |
|  3657604 |  593 | `  }/* End for loop over the format string */` |
|    71055 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|  1239626 |  595 | `}` |
|        - |  596 | `/* SPDX-SnippetEnd */` |
| 16947510 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|        5 |  598 | `{` |
| 16947515 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 16947515 |  600 | `	sxi32 rc = SXERR_ABORT;` |
| 16947515 |  601 | `	switch(pConsumer->nType){` |
...
|      157 |  605 | `			break;` |
|  8473677 |  606 | `	case SXFMT_CONS_BLOB:` |
|        - |  607 | `			/* Blob consumer */` |
| 16947359 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 16947354 |  609 | `			break;` |
|      ! 0 |  610 | `		default:` |
...
| 16947515 |  615 | `	pConsumer->nLen += nLen;` |
| 16947515 |  616 | `	pConsumer->rc = rc;` |
| 16947515 |  617 | `	return rc;` |
|        5 |  618 | `}` |
|  2479242 |  619 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|        5 |  620 | `{` |
|        - |  621 | `	SyFmtConsumer sCons;` |
|  2479247 |  622 | `	sCons.nType = nType;` |
|  2479247 |  623 | `	sCons.rc = SXRET_OK;` |
|  2479247 |  624 | `	sCons.nLen = 0;` |
|  2479247 |  625 | `	if( pOutLen ){` |
|    74899 |  626 | `		*pOutLen = 0;` |
|    37447 |  627 | `	}` |
|  2479247 |  628 | `	switch(nType){` |
...
|       13 |  637 | `		break;` |
|  1239615 |  638 | `		case SXFMT_CONS_BLOB:` |
|  2479235 |  639 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  2479235 |  640 | `			break;` |
|      ! 0 |  641 | `		default:` |
|      ! 0 |  642 | `			return SXERR_UNKNOWN;` |
|        - |  643 | `	}` |
|  2479247 |  644 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  2479247 |  645 | `	if( pOutLen ){` |
|    74899 |  646 | `		*pOutLen = sCons.nLen;` |
|    37447 |  647 | `	}` |
|  2479247 |  648 | `	return sCons.rc;` |
|  1239626 |  649 | `}` |
...
|       13 |  662 | `	return rc;` |
|        1 |  663 | `}` |
|    71788 |  664 | `PH7_PRIVATE sxu32 SyBlobFormat(SyBlob *pBlob,const char *zFormat,...)` |
|        5 |  665 | `{` |
|        - |  666 | `	va_list ap;` |
|        - |  667 | `	sxu32 n;` |
...
|        - |  671 | `	}` |
|        - |  672 | `#endif` |
|    71793 |  673 | `	va_start(ap,zFormat);` |
|    71793 |  674 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    71793 |  675 | `	va_end(ap);` |
|    71793 |  676 | `	return n;` |
|        5 |  677 | `}` |
|     3106 |  678 | `PH7_PRIVATE sxu32 SyBlobFormatAp(SyBlob *pBlob,const char *zFormat,va_list ap)` |
|        5 |  679 | `{` |
|     3111 |  680 | `	sxu32 n = 0; /* cc warning */` |
|        - |  681 | `#if defined(UNTRUST)` |
|        - |  682 | `	if( SX_EMPTY_STR(zFormat) ){` |
|        - |  683 | `		return 0;` |
|        - |  684 | `	}` |
|        - |  685 | `#endif` |
|     3111 |  686 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|     3111 |  687 | `	return n;` |
|        5 |  688 | `}` |
|  2404336 |  689 | `PH7_PRIVATE sxu32 SyBufferFormat(char *zBuf,sxu32 nLen,const char *zFormat,...)` |
|        5 |  690 | `{` |
|        - |  691 | `	SyBlob sBlob;` |
|        - |  692 | `	va_list ap;` |
|        - |  693 | `	sxu32 n;` |
...
|        - |  697 | `	}` |
|        - |  698 | `#endif` |
|  2404341 |  699 | `	if( SXRET_OK != SyBlobInitFromBuf(&sBlob,zBuf,nLen - 1) ){` |
|      ! 0 |  700 | `		return 0;` |
|        - |  701 | `	}` |
|  2404341 |  702 | `	va_start(ap,zFormat);` |
|  2404341 |  703 | `	FormatMount(SXFMT_CONS_BLOB,&sBlob,0,0,0,zFormat,ap);` |
|  2404341 |  704 | `	va_end(ap);` |
|  2404341 |  705 | `	n = SyBlobLength(&sBlob);` |
|        - |  706 | `	/* Append the null terminator */` |
|  2404341 |  707 | `	sBlob.mByte++;` |
|  2404341 |  708 | `	SyBlobAppend(&sBlob,"\0",sizeof(char));` |
|  2404341 |  709 | `	return n;` |
|  1202173 |  710 | `}` |
|        - |  711 |  |
