...
|        - |   90 | ` */` |
|  2527586 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|        5 |   92 | `{` |
|        - |   93 | `	/*` |
...
|  2527591 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|        - |  151 | `  int rc;` |
|        - |  152 |  |
|  2527591 |  153 | `  length = 0;` |
|  2527591 |  154 | `  bufpt = 0;` |
|  9935833 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
|  9839985 |  156 | `    if( c!='%' ){` |
|        - |  157 | `      unsigned int amt;` |
|  9705371 |  158 | `      bufpt = (char *)zFormat;` |
|  9705371 |  159 | `      amt = 1;` |
| 15365961 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
|  9705371 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
|  9705371 |  162 | `	  if( rc != SXRET_OK ){` |
|      ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  164 | `	  }` |
|  9705371 |  165 | `      if( c==0 ){` |
|  2431743 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|        - |  167 | `	  }` |
|  3636814 |  168 | `    }` |
|  7408247 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|      ! 0 |  170 | `      errorflag = 1;` |
...
|  7408247 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  7408242 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  3704121 |  180 | `    do{` |
|  7409599 |  181 | `      switch( c ){` |
...
|  7408242 |  187 | `        default:                                       break;` |
|        - |  188 | `      }` |
|  7409599 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|      ! 0 |  198 | `      c = *++zFormat;` |
|      ! 0 |  199 | `    }else{` |
|  7409643 |  200 | `      while( c>='0' && c<='9' ){` |
|     1399 |  201 | `        width = width*10 + c - '0';` |
|     1399 |  202 | `        c = *++zFormat;` |
|        3 |  203 | `      }` |
|        - |  204 | `    }` |
|  7408247 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|      ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|      ! 0 |  207 | `    }` |
|        - |  208 | `    /* Get the precision */` |
|  7408247 |  209 | `	precision = -1;` |
|  7408247 |  210 | `    if( c=='.' ){` |
|  2402615 |  211 | `      precision = 0;` |
|  2402615 |  212 | `      c = *++zFormat;` |
|  2402615 |  213 | `      if( c=='*' ){` |
|  2402603 |  214 | `        precision = va_arg(ap,int);` |
|  2402603 |  215 | `        if( precision<0 ) precision = -precision;` |
|  2402603 |  216 | `        c = *++zFormat;` |
|  1201304 |  217 | `      }else{` |
...
|  7408247 |  225 | `	flag_long = 0;` |
|  7408247 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
...
|  7408247 |  235 | `    infop = 0;` |
|  7408247 |  236 | `    xtype = SXFMT_ERROR;` |
| 34120655 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 34120655 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  7408247 |  239 | `        infop = &aFmt[idx];` |
|  7408247 |  240 | `		xtype = infop->type;` |
|  7408247 |  241 | `        break;` |
|        - |  242 | `      }` |
| 13356209 |  243 | `    }` |
...
|    73001 |  323 | `        for(idx=precision-length; idx>0; idx--){` |
...
|      ! 0 |  496 | `        length = 1;` |
|      ! 0 |  497 | `        break;` |
|     4932 |  498 | `      case SXFMT_CHARX:` |
|     9869 |  499 | `        c = va_arg(ap,int);` |
|     9869 |  500 | `		buf[0] = (char)c;` |
|        - |  501 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|     9869 |  502 | `		if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|     9869 |  503 | `        if( precision>=0 ){` |
...
|     9869 |  509 | `        bufpt = buf;` |
|     9869 |  510 | `        break;` |
|  1246977 |  511 | `      case SXFMT_STRING:` |
|  2493959 |  512 | `        bufpt = va_arg(ap,char*);` |
|  2493959 |  513 | `        if( bufpt==0 ){` |
|      ! 0 |  514 | `          bufpt = " ";` |
|      ! 0 |  515 | `		  length = (int)sizeof(" ")-1;` |
|      ! 0 |  516 | `		  break;` |
|        - |  517 | `        }` |
|  2493959 |  518 | `		length = precision;` |
|  2493959 |  519 | `		if( precision < 0 ){` |
|        - |  520 | `			/* Symisc extension */` |
|    91349 |  521 | `			length = (int)SyStrlen(bufpt);` |
|    45672 |  522 | `		}` |
|  2493959 |  523 | `        if( precision>=0 && precision<length ) length = precision;` |
|  2493959 |  524 | `        break;` |
|  2416250 |  525 | `	case SXFMT_RAWSTR:{` |
|        - |  526 | `		/* Symisc extension */` |
|  4832505 |  527 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  4832505 |  528 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|      ! 0 |  529 | `			 bufpt = " ";` |
|      ! 0 |  530 | `		     length = (int)sizeof(char);` |
|      ! 0 |  531 | `		     break;` |
|        - |  532 | `		}` |
|  4832505 |  533 | `		bufpt = (char *)pStr->zString;` |
|  4832505 |  534 | `		length = (int)pStr->nByte;` |
|  4832505 |  535 | `		break;` |
|        - |  536 | `					  }` |
...
|        - |  547 | `    ** the output.` |
|        - |  548 | `    */` |
|  7408247 |  549 | `    if( !flag_leftjustify ){` |
|        - |  550 | `      register int nspace;` |
|  7408247 |  551 | `      nspace = width-length;` |
|  7408247 |  552 | `      if( nspace>0 ){` |
...
|       18 |  566 | `      }` |
|  3704121 |  567 | `    }` |
|  7408247 |  568 | `    if( length>0 ){` |
|  7407905 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  7407905 |  570 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  572 | `		}` |
|  3703950 |  573 | `    }` |
|  7408247 |  574 | `    if( flag_leftjustify ){` |
...
|      ! 0 |  591 | `      }` |
|      ! 0 |  592 | `    }` |
|  3704126 |  593 | `  }/* End for loop over the format string */` |
|    95853 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|  1263798 |  595 | `}` |
|        - |  596 | `/* SPDX-SnippetEnd */` |
| 17113302 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|        5 |  598 | `{` |
| 17113307 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 17113307 |  600 | `	sxi32 rc = SXERR_ABORT;` |
| 17113307 |  601 | `	switch(pConsumer->nType){` |
...
|      181 |  605 | `			break;` |
|  8556561 |  606 | `	case SXFMT_CONS_BLOB:` |
|        - |  607 | `			/* Blob consumer */` |
| 17113127 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 17113122 |  609 | `			break;` |
|      ! 0 |  610 | `		default:` |
...
| 17113307 |  615 | `	pConsumer->nLen += nLen;` |
| 17113307 |  616 | `	pConsumer->rc = rc;` |
| 17113307 |  617 | `	return rc;` |
|        5 |  618 | `}` |
|  2527586 |  619 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|        5 |  620 | `{` |
|        - |  621 | `	SyFmtConsumer sCons;` |
|  2527591 |  622 | `	sCons.nType = nType;` |
|  2527591 |  623 | `	sCons.rc = SXRET_OK;` |
|  2527591 |  624 | `	sCons.nLen = 0;` |
|  2527591 |  625 | `	if( pOutLen ){` |
|   120431 |  626 | `		*pOutLen = 0;` |
|    60213 |  627 | `	}` |
|  2527591 |  628 | `	switch(nType){` |
...
|       13 |  637 | `		break;` |
|  1263787 |  638 | `		case SXFMT_CONS_BLOB:` |
|  2527579 |  639 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  2527579 |  640 | `			break;` |
|      ! 0 |  641 | `		default:` |
|      ! 0 |  642 | `			return SXERR_UNKNOWN;` |
|        - |  643 | `	}` |
|  2527591 |  644 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  2527591 |  645 | `	if( pOutLen ){` |
|   120431 |  646 | `		*pOutLen = sCons.nLen;` |
|    60213 |  647 | `	}` |
|  2527591 |  648 | `	return sCons.rc;` |
|  1263798 |  649 | `}` |
...
|       13 |  662 | `	return rc;` |
|        1 |  663 | `}` |
|    96662 |  664 | `PH7_PRIVATE sxu32 SyBlobFormat(SyBlob *pBlob,const char *zFormat,...)` |
|        5 |  665 | `{` |
|        - |  666 | `	va_list ap;` |
|        - |  667 | `	sxu32 n;` |
...
|        - |  671 | `	}` |
|        - |  672 | `#endif` |
|    96667 |  673 | `	va_start(ap,zFormat);` |
|    96667 |  674 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    96667 |  675 | `	va_end(ap);` |
|    96667 |  676 | `	return n;` |
|        5 |  677 | `}` |
|    23764 |  678 | `PH7_PRIVATE sxu32 SyBlobFormatAp(SyBlob *pBlob,const char *zFormat,va_list ap)` |
|        5 |  679 | `{` |
|    23769 |  680 | `	sxu32 n = 0; /* cc warning */` |
|        - |  681 | `#if defined(UNTRUST)` |
|        - |  682 | `	if( SX_EMPTY_STR(zFormat) ){` |
|        - |  683 | `		return 0;` |
|        - |  684 | `	}` |
|        - |  685 | `#endif` |
|    23769 |  686 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    23769 |  687 | `	return n;` |
|        5 |  688 | `}` |
|  2407148 |  689 | `PH7_PRIVATE sxu32 SyBufferFormat(char *zBuf,sxu32 nLen,const char *zFormat,...)` |
|        5 |  690 | `{` |
|        - |  691 | `	SyBlob sBlob;` |
|        - |  692 | `	va_list ap;` |
|        - |  693 | `	sxu32 n;` |
...
|        - |  697 | `	}` |
|        - |  698 | `#endif` |
|  2407153 |  699 | `	if( SXRET_OK != SyBlobInitFromBuf(&sBlob,zBuf,nLen - 1) ){` |
|      ! 0 |  700 | `		return 0;` |
|        - |  701 | `	}` |
|  2407153 |  702 | `	va_start(ap,zFormat);` |
|  2407153 |  703 | `	FormatMount(SXFMT_CONS_BLOB,&sBlob,0,0,0,zFormat,ap);` |
|  2407153 |  704 | `	va_end(ap);` |
|  2407153 |  705 | `	n = SyBlobLength(&sBlob);` |
|        - |  706 | `	/* Append the null terminator */` |
|  2407153 |  707 | `	sBlob.mByte++;` |
|  2407153 |  708 | `	SyBlobAppend(&sBlob,"\0",sizeof(char));` |
|  2407153 |  709 | `	return n;` |
|  1203579 |  710 | `}` |
|        - |  711 |  |
