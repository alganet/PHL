...
|        - |   90 | ` */` |
|  1981380 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|        5 |   92 | `{` |
|        - |   93 | `	/*` |
...
|  1981385 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|        - |  151 | `  int rc;` |
|        - |  152 |  |
|  1981385 |  153 | `  length = 0;` |
|  1981385 |  154 | `  bufpt = 0;` |
|  7803929 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
|  7733627 |  156 | `    if( c!='%' ){` |
|        - |  157 | `      unsigned int amt;` |
|  7643493 |  158 | `      bufpt = (char *)zFormat;` |
|  7643493 |  159 | `      amt = 1;` |
| 12224687 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
|  7643493 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
|  7643493 |  162 | `	  if( rc != SXRET_OK ){` |
|      ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  164 | `	  }` |
|  7643493 |  165 | `      if( c==0 ){` |
|  1911083 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|        - |  167 | `	  }` |
|  2866205 |  168 | `    }` |
|  5822549 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|      ! 0 |  170 | `      errorflag = 1;` |
...
|  5822549 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  5822544 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  2911272 |  180 | `    do{` |
|  5823267 |  181 | `      switch( c ){` |
...
|      706 |  186 | `        case '0':   flag_zeropad = 1;         c = 0;   break;` |
|  5822544 |  187 | `        default:                                       break;` |
|        - |  188 | `      }` |
|  5823267 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|      ! 0 |  198 | `      c = *++zFormat;` |
|      ! 0 |  199 | `    }else{` |
|  5823303 |  200 | `      while( c>='0' && c<='9' ){` |
|      757 |  201 | `        width = width*10 + c - '0';` |
|      757 |  202 | `        c = *++zFormat;` |
|        3 |  203 | `      }` |
|        - |  204 | `    }` |
|  5822549 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|      ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|      ! 0 |  207 | `    }` |
|        - |  208 | `    /* Get the precision */` |
|  5822549 |  209 | `	precision = -1;` |
|  5822549 |  210 | `    if( c=='.' ){` |
|  1902221 |  211 | `      precision = 0;` |
|  1902221 |  212 | `      c = *++zFormat;` |
|  1902221 |  213 | `      if( c=='*' ){` |
|  1902217 |  214 | `        precision = va_arg(ap,int);` |
|  1902217 |  215 | `        if( precision<0 ) precision = -precision;` |
|  1902217 |  216 | `        c = *++zFormat;` |
|   951111 |  217 | `      }else{` |
|        9 |  218 | `        while( c>='0' && c<='9' ){` |
...
|  5822549 |  225 | `	flag_long = 0;` |
|  5822549 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
|    58493 |  227 | `      flag_long = (c == 'q') ? 2 : 1;` |
|    58493 |  228 | `      c = *++zFormat;` |
|    58493 |  229 | `	  if( c == 'l' ){` |
...
|  5822549 |  235 | `    infop = 0;` |
|  5822549 |  236 | `    xtype = SXFMT_ERROR;` |
| 26948121 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 26948121 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  5822549 |  239 | `        infop = &aFmt[idx];` |
|  5822549 |  240 | `		xtype = infop->type;` |
|  5822549 |  241 | `        break;` |
|        - |  242 | `      }` |
| 10562791 |  243 | `    }` |
...
|        - |  263 | `    */` |
|  5822549 |  264 | `    switch( xtype ){` |
|    32029 |  265 | `      case SXFMT_RADIX:` |
|    64063 |  266 | `        if( flag_long > 0 ){` |
|    58493 |  267 | `			if( flag_long > 1 ){` |
|        - |  268 | `				/* BSD quad: expect a 64-bit integer */` |
|    58481 |  269 | `				longvalue = va_arg(ap,sxi64);` |
|    29243 |  270 | `			}else{` |
|       13 |  271 | `				longvalue = va_arg(ap,sxlong);` |
|        - |  272 | `			}` |
|    29249 |  273 | `		}else{` |
|     5575 |  274 | `			if( infop->flags & SXFLAG_SIGNED ){` |
|     3595 |  275 | `				longvalue = va_arg(ap,sxi32);` |
|     1800 |  276 | `			}else{` |
|     1985 |  277 | `				longvalue = va_arg(ap,sxu32);` |
|        - |  278 | `			}` |
|        - |  279 | `		}` |
|        - |  280 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|    64063 |  281 | `      if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|        - |  282 | `#if 1` |
|        - |  283 | `        /* For the format %#x, the value zero is printed "0" not "0x0".` |
|        - |  284 | `        ** I think this is stupid.*/` |
|    64063 |  285 | `        if( longvalue==0 ) flag_alternateform = 0;` |
|        - |  286 | `#else` |
...
|        - |  290 | `#endif` |
|    64063 |  291 | `        if( infop->flags & SXFLAG_SIGNED ){` |
|    62029 |  292 | `          if( longvalue<0 ){` |
...
|      179 |  297 | `            prefix = '-';` |
|       91 |  298 | `          }else{` |
|    61853 |  299 | `            ulongvalue = (sxu64)longvalue;` |
|    61853 |  300 | `            if( flag_plussign )        prefix = '+';` |
|    61853 |  301 | `            else if( flag_blanksign )  prefix = ' ';` |
|    61853 |  302 | `            else                       prefix = 0;` |
|        - |  303 | `          }` |
|    31017 |  304 | `        }else{` |
|     2039 |  305 | `			ulongvalue = (sxu64)longvalue; /* print the full unsigned value as-is */` |
|     2039 |  306 | `			prefix = 0;` |
|        - |  307 | `		}` |
|    64063 |  308 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|      706 |  309 | `          precision = width-(prefix!=0);` |
|      352 |  310 | `        }` |
|    64063 |  311 | `        bufpt = &buf[SXFMT_BUFSIZ-1];` |
|        - |  312 | `        {` |
|        - |  313 | `          register char *cset;      /* Use registers for speed */` |
|        - |  314 | `          register int base;` |
|    64063 |  315 | `          cset = infop->charset;` |
|    64063 |  316 | `          base = infop->base;` |
|    32029 |  317 | `          do{                                           /* Convert to ascii */` |
|   187463 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|   187463 |  319 | `            ulongvalue = ulongvalue/base;` |
|   187463 |  320 | `          }while( ulongvalue>0 );` |
|        - |  321 | `        }` |
|    64063 |  322 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    64715 |  323 | `        for(idx=precision-length; idx>0; idx--){` |
|      654 |  324 | `          *(--bufpt) = '0';                             /* Zero pad */` |
|      325 |  325 | `        }` |
|    64063 |  326 | `        if( prefix ) *(--bufpt) = prefix;               /* Add sign */` |
|    64063 |  327 | `        if( flag_alternateform && infop->prefix ){      /* Add "0" or "0x" */` |
|        - |  328 | `          char *pre, x;` |
...
|        1 |  332 | `          }` |
|        1 |  333 | `        }` |
|    64063 |  334 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    64063 |  335 | `        break;` |
...
|      ! 0 |  496 | `        length = 1;` |
|      ! 0 |  497 | `        break;` |
|     4970 |  498 | `      case SXFMT_CHARX:` |
|     9944 |  499 | `        c = va_arg(ap,int);` |
|     9944 |  500 | `		buf[0] = (char)c;` |
|        - |  501 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|     9944 |  502 | `		if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|     9944 |  503 | `        if( precision>=0 ){` |
...
|     9944 |  509 | `        bufpt = buf;` |
|     9944 |  510 | `        break;` |
|   956627 |  511 | `      case SXFMT_STRING:` |
|  1913259 |  512 | `        bufpt = va_arg(ap,char*);` |
|  1913259 |  513 | `        if( bufpt==0 ){` |
|      ! 0 |  514 | `          bufpt = " ";` |
|      ! 0 |  515 | `		  length = (int)sizeof(" ")-1;` |
|      ! 0 |  516 | `		  break;` |
|        - |  517 | `        }` |
|  1913259 |  518 | `		length = precision;` |
|  1913259 |  519 | `		if( precision < 0 ){` |
|        - |  520 | `			/* Symisc extension */` |
|    11043 |  521 | `			length = (int)SyStrlen(bufpt);` |
|     5519 |  522 | `		}` |
|  1913259 |  523 | `        if( precision>=0 && precision<length ) length = precision;` |
|  1913259 |  524 | `        break;` |
|  1917640 |  525 | `	case SXFMT_RAWSTR:{` |
|        - |  526 | `		/* Symisc extension */` |
|  3835285 |  527 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  3835285 |  528 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|      ! 0 |  529 | `			 bufpt = " ";` |
|      ! 0 |  530 | `		     length = (int)sizeof(char);` |
|      ! 0 |  531 | `		     break;` |
|        - |  532 | `		}` |
|  3835285 |  533 | `		bufpt = (char *)pStr->zString;` |
|  3835285 |  534 | `		length = (int)pStr->nByte;` |
|  3835285 |  535 | `		break;` |
|        - |  536 | `					  }` |
...
|        - |  547 | `    ** the output.` |
|        - |  548 | `    */` |
|  5822549 |  549 | `    if( !flag_leftjustify ){` |
|        - |  550 | `      register int nspace;` |
|  5822549 |  551 | `      nspace = width-length;` |
|  5822549 |  552 | `      if( nspace>0 ){` |
...
|       18 |  566 | `      }` |
|  2911272 |  567 | `    }` |
|  5822549 |  568 | `    if( length>0 ){` |
|  5822307 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  5822307 |  570 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  572 | `		}` |
|  2911151 |  573 | `    }` |
|  5822549 |  574 | `    if( flag_leftjustify ){` |
...
|      ! 0 |  591 | `      }` |
|      ! 0 |  592 | `    }` |
|  2911277 |  593 | `  }/* End for loop over the format string */` |
|    70307 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|   990695 |  595 | `}` |
|        - |  596 | `/* SPDX-SnippetEnd */` |
| 13465826 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|        5 |  598 | `{` |
| 13465831 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 13465831 |  600 | `	sxi32 rc = SXERR_ABORT;` |
| 13465831 |  601 | `	switch(pConsumer->nType){` |
...
|      157 |  605 | `			break;` |
|  6732835 |  606 | `	case SXFMT_CONS_BLOB:` |
|        - |  607 | `			/* Blob consumer */` |
| 13465675 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 13465670 |  609 | `			break;` |
|      ! 0 |  610 | `		default:` |
...
| 13465831 |  615 | `	pConsumer->nLen += nLen;` |
| 13465831 |  616 | `	pConsumer->rc = rc;` |
| 13465831 |  617 | `	return rc;` |
|        5 |  618 | `}` |
|  1981380 |  619 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|        5 |  620 | `{` |
|        - |  621 | `	SyFmtConsumer sCons;` |
|  1981385 |  622 | `	sCons.nType = nType;` |
|  1981385 |  623 | `	sCons.rc = SXRET_OK;` |
|  1981385 |  624 | `	sCons.nLen = 0;` |
|  1981385 |  625 | `	if( pOutLen ){` |
|    73933 |  626 | `		*pOutLen = 0;` |
|    36964 |  627 | `	}` |
|  1981385 |  628 | `	switch(nType){` |
...
|       13 |  637 | `		break;` |
|   990684 |  638 | `		case SXFMT_CONS_BLOB:` |
|  1981373 |  639 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  1981373 |  640 | `			break;` |
|      ! 0 |  641 | `		default:` |
|      ! 0 |  642 | `			return SXERR_UNKNOWN;` |
|        - |  643 | `	}` |
|  1981385 |  644 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  1981385 |  645 | `	if( pOutLen ){` |
|    73933 |  646 | `		*pOutLen = sCons.nLen;` |
|    36964 |  647 | `	}` |
|  1981385 |  648 | `	return sCons.rc;` |
|   990695 |  649 | `}` |
...
|       13 |  662 | `	return rc;` |
|        1 |  663 | `}` |
|    71042 |  664 | `PH7_PRIVATE sxu32 SyBlobFormat(SyBlob *pBlob,const char *zFormat,...)` |
|        5 |  665 | `{` |
|        - |  666 | `	va_list ap;` |
|        - |  667 | `	sxu32 n;` |
...
|        - |  671 | `	}` |
|        - |  672 | `#endif` |
|    71047 |  673 | `	va_start(ap,zFormat);` |
|    71047 |  674 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    71047 |  675 | `	va_end(ap);` |
|    71047 |  676 | `	return n;` |
|        5 |  677 | `}` |
|     2886 |  678 | `PH7_PRIVATE sxu32 SyBlobFormatAp(SyBlob *pBlob,const char *zFormat,va_list ap)` |
|        5 |  679 | `{` |
|     2891 |  680 | `	sxu32 n = 0; /* cc warning */` |
|        - |  681 | `#if defined(UNTRUST)` |
|        - |  682 | `	if( SX_EMPTY_STR(zFormat) ){` |
|        - |  683 | `		return 0;` |
|        - |  684 | `	}` |
|        - |  685 | `#endif` |
|     2891 |  686 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|     2891 |  687 | `	return n;` |
|        5 |  688 | `}` |
|  1907440 |  689 | `PH7_PRIVATE sxu32 SyBufferFormat(char *zBuf,sxu32 nLen,const char *zFormat,...)` |
|        5 |  690 | `{` |
|        - |  691 | `	SyBlob sBlob;` |
|        - |  692 | `	va_list ap;` |
|        - |  693 | `	sxu32 n;` |
...
|        - |  697 | `	}` |
|        - |  698 | `#endif` |
|  1907445 |  699 | `	if( SXRET_OK != SyBlobInitFromBuf(&sBlob,zBuf,nLen - 1) ){` |
|      ! 0 |  700 | `		return 0;` |
|        - |  701 | `	}` |
|  1907445 |  702 | `	va_start(ap,zFormat);` |
|  1907445 |  703 | `	FormatMount(SXFMT_CONS_BLOB,&sBlob,0,0,0,zFormat,ap);` |
|  1907445 |  704 | `	va_end(ap);` |
|  1907445 |  705 | `	n = SyBlobLength(&sBlob);` |
|        - |  706 | `	/* Append the null terminator */` |
|  1907445 |  707 | `	sBlob.mByte++;` |
|  1907445 |  708 | `	SyBlobAppend(&sBlob,"\0",sizeof(char));` |
|  1907445 |  709 | `	return n;` |
|   953725 |  710 | `}` |
|        - |  711 |  |
