...
|        - |   90 | ` */` |
|  2527528 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|        5 |   92 | `{` |
|        - |   93 | `	/*` |
...
|  2527533 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|        - |  151 | `  int rc;` |
|        - |  152 |  |
|  2527533 |  153 | `  length = 0;` |
|  2527533 |  154 | `  bufpt = 0;` |
|  9935641 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
|  9839823 |  156 | `    if( c!='%' ){` |
|        - |  157 | `      unsigned int amt;` |
|  9705267 |  158 | `      bufpt = (char *)zFormat;` |
|  9705267 |  159 | `      amt = 1;` |
| 15365469 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
|  9705267 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
|  9705267 |  162 | `	  if( rc != SXRET_OK ){` |
|      ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  164 | `	  }` |
|  9705267 |  165 | `      if( c==0 ){` |
|  2431715 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|        - |  167 | `	  }` |
|  3636776 |  168 | `    }` |
|  7408113 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|      ! 0 |  170 | `      errorflag = 1;` |
...
|  7408113 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  7408108 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  3704054 |  180 | `    do{` |
|  7409465 |  181 | `      switch( c ){` |
...
|  7408108 |  187 | `        default:                                       break;` |
|        - |  188 | `      }` |
|  7409465 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|      ! 0 |  198 | `      c = *++zFormat;` |
|      ! 0 |  199 | `    }else{` |
|  7409509 |  200 | `      while( c>='0' && c<='9' ){` |
|     1399 |  201 | `        width = width*10 + c - '0';` |
|     1399 |  202 | `        c = *++zFormat;` |
|        3 |  203 | `      }` |
|        - |  204 | `    }` |
|  7408113 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|      ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|      ! 0 |  207 | `    }` |
|        - |  208 | `    /* Get the precision */` |
|  7408113 |  209 | `	precision = -1;` |
|  7408113 |  210 | `    if( c=='.' ){` |
...
|  7408113 |  225 | `	flag_long = 0;` |
|  7408113 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
|    62281 |  227 | `      flag_long = (c == 'q') ? 2 : 1;` |
|    62281 |  228 | `      c = *++zFormat;` |
|    62281 |  229 | `	  if( c == 'l' ){` |
...
|  7408113 |  235 | `    infop = 0;` |
|  7408113 |  236 | `    xtype = SXFMT_ERROR;` |
| 34120189 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 34120189 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  7408113 |  239 | `        infop = &aFmt[idx];` |
|  7408113 |  240 | `		xtype = infop->type;` |
|  7408113 |  241 | `        break;` |
|        - |  242 | `      }` |
| 13356043 |  243 | `    }` |
...
|        - |  263 | `    */` |
|  7408113 |  264 | `    switch( xtype ){` |
|    35943 |  265 | `      case SXFMT_RADIX:` |
|    71891 |  266 | `        if( flag_long > 0 ){` |
|    62281 |  267 | `			if( flag_long > 1 ){` |
|        - |  268 | `				/* BSD quad: expect a 64-bit integer */` |
|    62269 |  269 | `				longvalue = va_arg(ap,sxi64);` |
|    31137 |  270 | `			}else{` |
...
|    71891 |  281 | `      if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|        - |  282 | `#if 1` |
|        - |  283 | `        /* For the format %#x, the value zero is printed "0" not "0x0".` |
|        - |  284 | `        ** I think this is stupid.*/` |
|    71891 |  285 | `        if( longvalue==0 ) flag_alternateform = 0;` |
|        - |  286 | `#else` |
...
|        - |  290 | `#endif` |
|    71891 |  291 | `        if( infop->flags & SXFLAG_SIGNED ){` |
|    67347 |  292 | `          if( longvalue<0 ){` |
...
|      221 |  297 | `            prefix = '-';` |
|      112 |  298 | `          }else{` |
|    67129 |  299 | `            ulongvalue = (sxu64)longvalue;` |
|    67129 |  300 | `            if( flag_plussign )        prefix = '+';` |
|    67129 |  301 | `            else if( flag_blanksign )  prefix = ' ';` |
|    67129 |  302 | `            else                       prefix = 0;` |
|        - |  303 | `          }` |
|    33676 |  304 | `        }else{` |
|     4549 |  305 | `			ulongvalue = (sxu64)longvalue; /* print the full unsigned value as-is */` |
|     4549 |  306 | `			prefix = 0;` |
|        - |  307 | `		}` |
|    71891 |  308 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|     1340 |  309 | `          precision = width-(prefix!=0);` |
|      669 |  310 | `        }` |
|    71891 |  311 | `        bufpt = &buf[SXFMT_BUFSIZ-1];` |
|        - |  312 | `        {` |
|        - |  313 | `          register char *cset;      /* Use registers for speed */` |
|        - |  314 | `          register int base;` |
|    71891 |  315 | `          cset = infop->charset;` |
|    71891 |  316 | `          base = infop->base;` |
|    35943 |  317 | `          do{                                           /* Convert to ascii */` |
|   203735 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|   203735 |  319 | `            ulongvalue = ulongvalue/base;` |
|   203735 |  320 | `          }while( ulongvalue>0 );` |
|        - |  321 | `        }` |
|    71891 |  322 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    72991 |  323 | `        for(idx=precision-length; idx>0; idx--){` |
|     1102 |  324 | `          *(--bufpt) = '0';                             /* Zero pad */` |
|      552 |  325 | `        }` |
|    71891 |  326 | `        if( prefix ) *(--bufpt) = prefix;               /* Add sign */` |
|    71891 |  327 | `        if( flag_alternateform && infop->prefix ){      /* Add "0" or "0x" */` |
|        - |  328 | `          char *pre, x;` |
...
|        1 |  332 | `          }` |
|        1 |  333 | `        }` |
|    71891 |  334 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    71891 |  335 | `        break;` |
...
|      ! 0 |  496 | `        length = 1;` |
|      ! 0 |  497 | `        break;` |
|     4928 |  498 | `      case SXFMT_CHARX:` |
|     9861 |  499 | `        c = va_arg(ap,int);` |
|     9861 |  500 | `		buf[0] = (char)c;` |
|        - |  501 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|     9861 |  502 | `		if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|     9861 |  503 | `        if( precision>=0 ){` |
...
|     9861 |  509 | `        bufpt = buf;` |
|     9861 |  510 | `        break;` |
|  1246944 |  511 | `      case SXFMT_STRING:` |
|  2493893 |  512 | `        bufpt = va_arg(ap,char*);` |
|  2493893 |  513 | `        if( bufpt==0 ){` |
|      ! 0 |  514 | `          bufpt = " ";` |
|      ! 0 |  515 | `		  length = (int)sizeof(" ")-1;` |
|      ! 0 |  516 | `		  break;` |
|        - |  517 | `        }` |
|  2493893 |  518 | `		length = precision;` |
|  2493893 |  519 | `		if( precision < 0 ){` |
|        - |  520 | `			/* Symisc extension */` |
|    91297 |  521 | `			length = (int)SyStrlen(bufpt);` |
|    45646 |  522 | `		}` |
|  2493893 |  523 | `        if( precision>=0 && precision<length ) length = precision;` |
|  2493893 |  524 | `        break;` |
|  2416225 |  525 | `	case SXFMT_RAWSTR:{` |
|        - |  526 | `		/* Symisc extension */` |
|  4832455 |  527 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  4832455 |  528 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|      ! 0 |  529 | `			 bufpt = " ";` |
|      ! 0 |  530 | `		     length = (int)sizeof(char);` |
|      ! 0 |  531 | `		     break;` |
|        - |  532 | `		}` |
|  4832455 |  533 | `		bufpt = (char *)pStr->zString;` |
|  4832455 |  534 | `		length = (int)pStr->nByte;` |
|  4832455 |  535 | `		break;` |
|        - |  536 | `					  }` |
...
|        - |  547 | `    ** the output.` |
|        - |  548 | `    */` |
|  7408113 |  549 | `    if( !flag_leftjustify ){` |
|        - |  550 | `      register int nspace;` |
|  7408113 |  551 | `      nspace = width-length;` |
|  7408113 |  552 | `      if( nspace>0 ){` |
...
|       18 |  566 | `      }` |
|  3704054 |  567 | `    }` |
|  7408113 |  568 | `    if( length>0 ){` |
|  7407771 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  7407771 |  570 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  572 | `		}` |
|  3703883 |  573 | `    }` |
|  7408113 |  574 | `    if( flag_leftjustify ){` |
...
|      ! 0 |  591 | `      }` |
|      ! 0 |  592 | `    }` |
|  3704059 |  593 | `  }/* End for loop over the format string */` |
|    95823 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|  1263769 |  595 | `}` |
|        - |  596 | `/* SPDX-SnippetEnd */` |
| 17113064 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|        5 |  598 | `{` |
| 17113069 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 17113069 |  600 | `	sxi32 rc = SXERR_ABORT;` |
| 17113069 |  601 | `	switch(pConsumer->nType){` |
...
|      181 |  605 | `			break;` |
|  8556442 |  606 | `	case SXFMT_CONS_BLOB:` |
|        - |  607 | `			/* Blob consumer */` |
| 17112889 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 17112884 |  609 | `			break;` |
|      ! 0 |  610 | `		default:` |
...
| 17113069 |  615 | `	pConsumer->nLen += nLen;` |
| 17113069 |  616 | `	pConsumer->rc = rc;` |
| 17113069 |  617 | `	return rc;` |
|        5 |  618 | `}` |
|  2527528 |  619 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|        5 |  620 | `{` |
|        - |  621 | `	SyFmtConsumer sCons;` |
|  2527533 |  622 | `	sCons.nType = nType;` |
|  2527533 |  623 | `	sCons.rc = SXRET_OK;` |
|  2527533 |  624 | `	sCons.nLen = 0;` |
|  2527533 |  625 | `	if( pOutLen ){` |
|   120389 |  626 | `		*pOutLen = 0;` |
|    60192 |  627 | `	}` |
|  2527533 |  628 | `	switch(nType){` |
...
|       13 |  637 | `		break;` |
|  1263758 |  638 | `		case SXFMT_CONS_BLOB:` |
|  2527521 |  639 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  2527521 |  640 | `			break;` |
|      ! 0 |  641 | `		default:` |
|      ! 0 |  642 | `			return SXERR_UNKNOWN;` |
|        - |  643 | `	}` |
|  2527533 |  644 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  2527533 |  645 | `	if( pOutLen ){` |
|   120389 |  646 | `		*pOutLen = sCons.nLen;` |
|    60192 |  647 | `	}` |
|  2527533 |  648 | `	return sCons.rc;` |
|  1263769 |  649 | `}` |
...
|       13 |  662 | `	return rc;` |
|        1 |  663 | `}` |
|    96632 |  664 | `PH7_PRIVATE sxu32 SyBlobFormat(SyBlob *pBlob,const char *zFormat,...)` |
|        5 |  665 | `{` |
|        - |  666 | `	va_list ap;` |
|        - |  667 | `	sxu32 n;` |
...
|        - |  671 | `	}` |
|        - |  672 | `#endif` |
|    96637 |  673 | `	va_start(ap,zFormat);` |
|    96637 |  674 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    96637 |  675 | `	va_end(ap);` |
|    96637 |  676 | `	return n;` |
|        5 |  677 | `}` |
|    23752 |  678 | `PH7_PRIVATE sxu32 SyBlobFormatAp(SyBlob *pBlob,const char *zFormat,va_list ap)` |
|        5 |  679 | `{` |
|    23757 |  680 | `	sxu32 n = 0; /* cc warning */` |
|        - |  681 | `#if defined(UNTRUST)` |
|        - |  682 | `	if( SX_EMPTY_STR(zFormat) ){` |
|        - |  683 | `		return 0;` |
|        - |  684 | `	}` |
|        - |  685 | `#endif` |
|    23757 |  686 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    23757 |  687 | `	return n;` |
|        5 |  688 | `}` |
