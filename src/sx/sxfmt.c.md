...
|        - |   90 | ` */` |
|  2524556 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|        5 |   92 | `{` |
|        - |   93 | `	/*` |
...
|  2524561 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|        - |  151 | `  int rc;` |
|        - |  152 |  |
|  2524561 |  153 | `  length = 0;` |
|  2524561 |  154 | `  bufpt = 0;` |
|  9924179 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
|  9828547 |  156 | `    if( c!='%' ){` |
|        - |  157 | `      unsigned int amt;` |
|  9694375 |  158 | `      bufpt = (char *)zFormat;` |
|  9694375 |  159 | `      amt = 1;` |
| 15347785 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
|  9694375 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
|  9694375 |  162 | `	  if( rc != SXRET_OK ){` |
|      ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  164 | `	  }` |
|  9694375 |  165 | `      if( c==0 ){` |
|  2428929 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|        - |  167 | `	  }` |
|  3632723 |  168 | `    }` |
|  7399623 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|      ! 0 |  170 | `      errorflag = 1;` |
...
|  7399623 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  7399618 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  3699809 |  180 | `    do{` |
|  7400975 |  181 | `      switch( c ){` |
...
|  7399618 |  187 | `        default:                                       break;` |
|        - |  188 | `      }` |
|  7400975 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|      ! 0 |  198 | `      c = *++zFormat;` |
|      ! 0 |  199 | `    }else{` |
|  7401019 |  200 | `      while( c>='0' && c<='9' ){` |
|     1399 |  201 | `        width = width*10 + c - '0';` |
|     1399 |  202 | `        c = *++zFormat;` |
|        3 |  203 | `      }` |
|        - |  204 | `    }` |
|  7399623 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|      ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|      ! 0 |  207 | `    }` |
|        - |  208 | `    /* Get the precision */` |
|  7399623 |  209 | `	precision = -1;` |
|  7399623 |  210 | `    if( c=='.' ){` |
|  2400001 |  211 | `      precision = 0;` |
|  2400001 |  212 | `      c = *++zFormat;` |
|  2400001 |  213 | `      if( c=='*' ){` |
|  2399989 |  214 | `        precision = va_arg(ap,int);` |
|  2399989 |  215 | `        if( precision<0 ) precision = -precision;` |
|  2399989 |  216 | `        c = *++zFormat;` |
|  1199997 |  217 | `      }else{` |
...
|  7399623 |  225 | `	flag_long = 0;` |
|  7399623 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
|    62237 |  227 | `      flag_long = (c == 'q') ? 2 : 1;` |
|    62237 |  228 | `      c = *++zFormat;` |
|    62237 |  229 | `	  if( c == 'l' ){` |
...
|  7399623 |  235 | `    infop = 0;` |
|  7399623 |  236 | `    xtype = SXFMT_ERROR;` |
| 34082071 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 34082071 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  7399623 |  239 | `        infop = &aFmt[idx];` |
|  7399623 |  240 | `		xtype = infop->type;` |
|  7399623 |  241 | `        break;` |
|        - |  242 | `      }` |
| 13341229 |  243 | `    }` |
...
|        - |  263 | `    */` |
|  7399623 |  264 | `    switch( xtype ){` |
|    35891 |  265 | `      case SXFMT_RADIX:` |
|    71787 |  266 | `        if( flag_long > 0 ){` |
|    62237 |  267 | `			if( flag_long > 1 ){` |
|        - |  268 | `				/* BSD quad: expect a 64-bit integer */` |
|    62225 |  269 | `				longvalue = va_arg(ap,sxi64);` |
|    31115 |  270 | `			}else{` |
...
|    71787 |  281 | `      if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|        - |  282 | `#if 1` |
|        - |  283 | `        /* For the format %#x, the value zero is printed "0" not "0x0".` |
|        - |  284 | `        ** I think this is stupid.*/` |
|    71787 |  285 | `        if( longvalue==0 ) flag_alternateform = 0;` |
|        - |  286 | `#else` |
...
|        - |  290 | `#endif` |
|    71787 |  291 | `        if( infop->flags & SXFLAG_SIGNED ){` |
|    67255 |  292 | `          if( longvalue<0 ){` |
...
|      221 |  297 | `            prefix = '-';` |
|      112 |  298 | `          }else{` |
|    67037 |  299 | `            ulongvalue = (sxu64)longvalue;` |
|    67037 |  300 | `            if( flag_plussign )        prefix = '+';` |
|    67037 |  301 | `            else if( flag_blanksign )  prefix = ' ';` |
|    67037 |  302 | `            else                       prefix = 0;` |
|        - |  303 | `          }` |
|    33630 |  304 | `        }else{` |
|     4537 |  305 | `			ulongvalue = (sxu64)longvalue; /* print the full unsigned value as-is */` |
|     4537 |  306 | `			prefix = 0;` |
|        - |  307 | `		}` |
|    71787 |  308 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|     1340 |  309 | `          precision = width-(prefix!=0);` |
|      669 |  310 | `        }` |
|    71787 |  311 | `        bufpt = &buf[SXFMT_BUFSIZ-1];` |
|        - |  312 | `        {` |
|        - |  313 | `          register char *cset;      /* Use registers for speed */` |
|        - |  314 | `          register int base;` |
|    71787 |  315 | `          cset = infop->charset;` |
|    71787 |  316 | `          base = infop->base;` |
|    35891 |  317 | `          do{                                           /* Convert to ascii */` |
|   203533 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|   203533 |  319 | `            ulongvalue = ulongvalue/base;` |
|   203533 |  320 | `          }while( ulongvalue>0 );` |
|        - |  321 | `        }` |
|    71787 |  322 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    72887 |  323 | `        for(idx=precision-length; idx>0; idx--){` |
|     1102 |  324 | `          *(--bufpt) = '0';                             /* Zero pad */` |
|      552 |  325 | `        }` |
|    71787 |  326 | `        if( prefix ) *(--bufpt) = prefix;               /* Add sign */` |
|    71787 |  327 | `        if( flag_alternateform && infop->prefix ){      /* Add "0" or "0x" */` |
|        - |  328 | `          char *pre, x;` |
...
|        1 |  332 | `          }` |
|        1 |  333 | `        }` |
|    71787 |  334 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    71787 |  335 | `        break;` |
...
|     9818 |  499 | `        c = va_arg(ap,int);` |
|     9818 |  500 | `		buf[0] = (char)c;` |
|        - |  501 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|     9818 |  502 | `		if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|     9818 |  503 | `        if( precision>=0 ){` |
...
|     9818 |  509 | `        bufpt = buf;` |
|     9818 |  510 | `        break;` |
|  1245410 |  511 | `      case SXFMT_STRING:` |
|  2490825 |  512 | `        bufpt = va_arg(ap,char*);` |
|  2490825 |  513 | `        if( bufpt==0 ){` |
|      ! 0 |  514 | `          bufpt = " ";` |
|      ! 0 |  515 | `		  length = (int)sizeof(" ")-1;` |
|      ! 0 |  516 | `		  break;` |
|        - |  517 | `        }` |
|  2490825 |  518 | `		length = precision;` |
|  2490825 |  519 | `		if( precision < 0 ){` |
|        - |  520 | `			/* Symisc extension */` |
|    90829 |  521 | `			length = (int)SyStrlen(bufpt);` |
|    45412 |  522 | `		}` |
|  2490825 |  523 | `        if( precision>=0 && precision<length ) length = precision;` |
|  2490825 |  524 | `        break;` |
|  2413587 |  525 | `	case SXFMT_RAWSTR:{` |
|        - |  526 | `		/* Symisc extension */` |
|  4827179 |  527 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  4827179 |  528 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|      ! 0 |  529 | `			 bufpt = " ";` |
|      ! 0 |  530 | `		     length = (int)sizeof(char);` |
|      ! 0 |  531 | `		     break;` |
|        - |  532 | `		}` |
|  4827179 |  533 | `		bufpt = (char *)pStr->zString;` |
|  4827179 |  534 | `		length = (int)pStr->nByte;` |
|  4827179 |  535 | `		break;` |
|        - |  536 | `					  }` |
...
|        - |  547 | `    ** the output.` |
|        - |  548 | `    */` |
|  7399623 |  549 | `    if( !flag_leftjustify ){` |
|        - |  550 | `      register int nspace;` |
|  7399623 |  551 | `      nspace = width-length;` |
|  7399623 |  552 | `      if( nspace>0 ){` |
...
|       18 |  566 | `      }` |
|  3699809 |  567 | `    }` |
|  7399623 |  568 | `    if( length>0 ){` |
|  7399281 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  7399281 |  570 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  572 | `		}` |
|  3699638 |  573 | `    }` |
|  7399623 |  574 | `    if( flag_leftjustify ){` |
...
|      ! 0 |  591 | `      }` |
|      ! 0 |  592 | `    }` |
|  3699814 |  593 | `  }/* End for loop over the format string */` |
|    95637 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|  1262283 |  595 | `}` |
|        - |  596 | `/* SPDX-SnippetEnd */` |
| 17093682 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|        5 |  598 | `{` |
| 17093687 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 17093687 |  600 | `	sxi32 rc = SXERR_ABORT;` |
| 17093687 |  601 | `	switch(pConsumer->nType){` |
...
|      181 |  605 | `			break;` |
|  8546751 |  606 | `	case SXFMT_CONS_BLOB:` |
|        - |  607 | `			/* Blob consumer */` |
| 17093507 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 17093502 |  609 | `			break;` |
|      ! 0 |  610 | `		default:` |
...
| 17093687 |  615 | `	pConsumer->nLen += nLen;` |
| 17093687 |  616 | `	pConsumer->rc = rc;` |
| 17093687 |  617 | `	return rc;` |
|        5 |  618 | `}` |
|  2524556 |  619 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|        5 |  620 | `{` |
|        - |  621 | `	SyFmtConsumer sCons;` |
|  2524561 |  622 | `	sCons.nType = nType;` |
|  2524561 |  623 | `	sCons.rc = SXRET_OK;` |
|  2524561 |  624 | `	sCons.nLen = 0;` |
|  2524561 |  625 | `	if( pOutLen ){` |
|   120065 |  626 | `		*pOutLen = 0;` |
|    60030 |  627 | `	}` |
|  2524561 |  628 | `	switch(nType){` |
...
|       13 |  637 | `		break;` |
|  1262272 |  638 | `		case SXFMT_CONS_BLOB:` |
|  2524549 |  639 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  2524549 |  640 | `			break;` |
|      ! 0 |  641 | `		default:` |
|      ! 0 |  642 | `			return SXERR_UNKNOWN;` |
|        - |  643 | `	}` |
|  2524561 |  644 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  2524561 |  645 | `	if( pOutLen ){` |
|   120065 |  646 | `		*pOutLen = sCons.nLen;` |
|    60030 |  647 | `	}` |
|  2524561 |  648 | `	return sCons.rc;` |
|  1262283 |  649 | `}` |
...
|       13 |  662 | `	return rc;` |
|        1 |  663 | `}` |
|    96422 |  664 | `PH7_PRIVATE sxu32 SyBlobFormat(SyBlob *pBlob,const char *zFormat,...)` |
|        5 |  665 | `{` |
|        - |  666 | `	va_list ap;` |
|        - |  667 | `	sxu32 n;` |
...
|        - |  671 | `	}` |
|        - |  672 | `#endif` |
|    96427 |  673 | `	va_start(ap,zFormat);` |
|    96427 |  674 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    96427 |  675 | `	va_end(ap);` |
|    96427 |  676 | `	return n;` |
|        5 |  677 | `}` |
|    23638 |  678 | `PH7_PRIVATE sxu32 SyBlobFormatAp(SyBlob *pBlob,const char *zFormat,va_list ap)` |
|        5 |  679 | `{` |
|    23643 |  680 | `	sxu32 n = 0; /* cc warning */` |
|        - |  681 | `#if defined(UNTRUST)` |
|        - |  682 | `	if( SX_EMPTY_STR(zFormat) ){` |
|        - |  683 | `		return 0;` |
|        - |  684 | `	}` |
|        - |  685 | `#endif` |
|    23643 |  686 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    23643 |  687 | `	return n;` |
|        5 |  688 | `}` |
|  2404484 |  689 | `PH7_PRIVATE sxu32 SyBufferFormat(char *zBuf,sxu32 nLen,const char *zFormat,...)` |
|        5 |  690 | `{` |
|        - |  691 | `	SyBlob sBlob;` |
|        - |  692 | `	va_list ap;` |
|        - |  693 | `	sxu32 n;` |
...
|        - |  697 | `	}` |
|        - |  698 | `#endif` |
|  2404489 |  699 | `	if( SXRET_OK != SyBlobInitFromBuf(&sBlob,zBuf,nLen - 1) ){` |
|      ! 0 |  700 | `		return 0;` |
|        - |  701 | `	}` |
|  2404489 |  702 | `	va_start(ap,zFormat);` |
|  2404489 |  703 | `	FormatMount(SXFMT_CONS_BLOB,&sBlob,0,0,0,zFormat,ap);` |
|  2404489 |  704 | `	va_end(ap);` |
|  2404489 |  705 | `	n = SyBlobLength(&sBlob);` |
|        - |  706 | `	/* Append the null terminator */` |
|  2404489 |  707 | `	sBlob.mByte++;` |
|  2404489 |  708 | `	SyBlobAppend(&sBlob,"\0",sizeof(char));` |
|  2404489 |  709 | `	return n;` |
|  1202247 |  710 | `}` |
|        - |  711 |  |
