...
|        - |   90 | ` */` |
|  3032918 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|        5 |   92 | `{` |
|        - |   93 | `	/*` |
...
|  3032923 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|        - |  151 | `  int rc;` |
|        - |  152 |  |
|  3032923 |  153 | `  length = 0;` |
|  3032923 |  154 | `  bufpt = 0;` |
| 11960431 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
| 11865533 |  156 | `    if( c!='%' ){` |
|        - |  157 | `      unsigned int amt;` |
| 11733501 |  158 | `      bufpt = (char *)zFormat;` |
| 11733501 |  159 | `      amt = 1;` |
| 18411007 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
| 11733501 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
| 11733501 |  162 | `	  if( rc != SXRET_OK ){` |
|      ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  164 | `	  }` |
| 11733501 |  165 | `      if( c==0 ){` |
|  2938025 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|        - |  167 | `	  }` |
|  4397738 |  168 | `    }` |
|  8927513 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|      ! 0 |  170 | `      errorflag = 1;` |
...
|  8927513 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  8927508 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  4463754 |  180 | `    do{` |
|  8928847 |  181 | `      switch( c ){` |
...
|  8927508 |  187 | `        default:                                       break;` |
|        - |  188 | `      }` |
|  8928847 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|      ! 0 |  198 | `      c = *++zFormat;` |
|      ! 0 |  199 | `    }else{` |
|  8928885 |  200 | `      while( c>='0' && c<='9' ){` |
|     1375 |  201 | `        width = width*10 + c - '0';` |
|     1375 |  202 | `        c = *++zFormat;` |
|        3 |  203 | `      }` |
|        - |  204 | `    }` |
|  8927513 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|      ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|      ! 0 |  207 | `    }` |
|        - |  208 | `    /* Get the precision */` |
|  8927513 |  209 | `	precision = -1;` |
|  8927513 |  210 | `    if( c=='.' ){` |
|  2910099 |  211 | `      precision = 0;` |
|  2910099 |  212 | `      c = *++zFormat;` |
|  2910099 |  213 | `      if( c=='*' ){` |
|  2910087 |  214 | `        precision = va_arg(ap,int);` |
|  2910087 |  215 | `        if( precision<0 ) precision = -precision;` |
|  2910087 |  216 | `        c = *++zFormat;` |
|  1455046 |  217 | `      }else{` |
...
|  8927513 |  225 | `	flag_long = 0;` |
|  8927513 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
|    62251 |  227 | `      flag_long = (c == 'q') ? 2 : 1;` |
|    62251 |  228 | `      c = *++zFormat;` |
|    62251 |  229 | `	  if( c == 'l' ){` |
...
|  8927513 |  235 | `    infop = 0;` |
|  8927513 |  236 | `    xtype = SXFMT_ERROR;` |
| 41209643 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 41209643 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  8927513 |  239 | `        infop = &aFmt[idx];` |
|  8927513 |  240 | `		xtype = infop->type;` |
|  8927513 |  241 | `        break;` |
|        - |  242 | `      }` |
| 16141070 |  243 | `    }` |
...
|        - |  263 | `    */` |
|  8927513 |  264 | `    switch( xtype ){` |
|    35630 |  265 | `      case SXFMT_RADIX:` |
|    71265 |  266 | `        if( flag_long > 0 ){` |
|    62251 |  267 | `			if( flag_long > 1 ){` |
|        - |  268 | `				/* BSD quad: expect a 64-bit integer */` |
|    62239 |  269 | `				longvalue = va_arg(ap,sxi64);` |
|    31122 |  270 | `			}else{` |
|       13 |  271 | `				longvalue = va_arg(ap,sxlong);` |
|        - |  272 | `			}` |
|    31128 |  273 | `		}else{` |
|     9019 |  274 | `			if( infop->flags & SXFLAG_SIGNED ){` |
|     5219 |  275 | `				longvalue = va_arg(ap,sxi32);` |
|     2612 |  276 | `			}else{` |
|     3805 |  277 | `				longvalue = va_arg(ap,sxu32);` |
|        - |  278 | `			}` |
|        - |  279 | `		}` |
|        - |  280 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|    71265 |  281 | `      if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|        - |  282 | `#if 1` |
|        - |  283 | `        /* For the format %#x, the value zero is printed "0" not "0x0".` |
|        - |  284 | `        ** I think this is stupid.*/` |
|    71265 |  285 | `        if( longvalue==0 ) flag_alternateform = 0;` |
|        - |  286 | `#else` |
...
|        - |  290 | `#endif` |
|    71265 |  291 | `        if( infop->flags & SXFLAG_SIGNED ){` |
|    67407 |  292 | `          if( longvalue<0 ){` |
...
|      235 |  297 | `            prefix = '-';` |
|      119 |  298 | `          }else{` |
|    67176 |  299 | `            ulongvalue = (sxu64)longvalue;` |
|    67176 |  300 | `            if( flag_plussign )        prefix = '+';` |
|    67176 |  301 | `            else if( flag_blanksign )  prefix = ' ';` |
|    67176 |  302 | `            else                       prefix = 0;` |
|        - |  303 | `          }` |
|    33706 |  304 | `        }else{` |
|     3863 |  305 | `			ulongvalue = (sxu64)longvalue; /* print the full unsigned value as-is */` |
|     3863 |  306 | `			prefix = 0;` |
|        - |  307 | `		}` |
|    71265 |  308 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|     1322 |  309 | `          precision = width-(prefix!=0);` |
|      660 |  310 | `        }` |
|    71265 |  311 | `        bufpt = &buf[SXFMT_BUFSIZ-1];` |
|        - |  312 | `        {` |
|        - |  313 | `          register char *cset;      /* Use registers for speed */` |
|        - |  314 | `          register int base;` |
|    71265 |  315 | `          cset = infop->charset;` |
|    71265 |  316 | `          base = infop->base;` |
|    35630 |  317 | `          do{                                           /* Convert to ascii */` |
|   202273 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|   202273 |  319 | `            ulongvalue = ulongvalue/base;` |
|   202273 |  320 | `          }while( ulongvalue>0 );` |
|        - |  321 | `        }` |
|    71265 |  322 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    72362 |  323 | `        for(idx=precision-length; idx>0; idx--){` |
|     1099 |  324 | `          *(--bufpt) = '0';                             /* Zero pad */` |
|      551 |  325 | `        }` |
|    71265 |  326 | `        if( prefix ) *(--bufpt) = prefix;               /* Add sign */` |
|    71265 |  327 | `        if( flag_alternateform && infop->prefix ){      /* Add "0" or "0x" */` |
|        - |  328 | `          char *pre, x;` |
...
|        1 |  332 | `          }` |
|        1 |  333 | `        }` |
|    71265 |  334 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    71265 |  335 | `        break;` |
...
|      ! 0 |  496 | `        length = 1;` |
|      ! 0 |  497 | `        break;` |
|     4680 |  498 | `      case SXFMT_CHARX:` |
|     9364 |  499 | `        c = va_arg(ap,int);` |
|     9364 |  500 | `		buf[0] = (char)c;` |
|        - |  501 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|     9364 |  502 | `		if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|     9364 |  503 | `        if( precision>=0 ){` |
...
|     9364 |  509 | `        bufpt = buf;` |
|     9364 |  510 | `        break;` |
|  1500179 |  511 | `      case SXFMT_STRING:` |
|  3000363 |  512 | `        bufpt = va_arg(ap,char*);` |
|  3000363 |  513 | `        if( bufpt==0 ){` |
|      ! 0 |  514 | `          bufpt = " ";` |
|      ! 0 |  515 | `		  length = (int)sizeof(" ")-1;` |
|      ! 0 |  516 | `		  break;` |
|        - |  517 | `        }` |
|  3000363 |  518 | `		length = precision;` |
|  3000363 |  519 | `		if( precision < 0 ){` |
|        - |  520 | `			/* Symisc extension */` |
|    90269 |  521 | `			length = (int)SyStrlen(bufpt);` |
|    45132 |  522 | `		}` |
|  3000363 |  523 | `        if( precision>=0 && precision<length ) length = precision;` |
|  3000363 |  524 | `        break;` |
|  2923265 |  525 | `	case SXFMT_RAWSTR:{` |
|        - |  526 | `		/* Symisc extension */` |
|  5846535 |  527 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  5846535 |  528 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|      ! 0 |  529 | `			 bufpt = " ";` |
|      ! 0 |  530 | `		     length = (int)sizeof(char);` |
|      ! 0 |  531 | `		     break;` |
|        - |  532 | `		}` |
|  5846535 |  533 | `		bufpt = (char *)pStr->zString;` |
|  5846535 |  534 | `		length = (int)pStr->nByte;` |
|  5846535 |  535 | `		break;` |
|        - |  536 | `					  }` |
...
|        - |  547 | `    ** the output.` |
|        - |  548 | `    */` |
|  8927513 |  549 | `    if( !flag_leftjustify ){` |
|        - |  550 | `      register int nspace;` |
|  8927513 |  551 | `      nspace = width-length;` |
|  8927513 |  552 | `      if( nspace>0 ){` |
...
|       18 |  566 | `      }` |
|  4463754 |  567 | `    }` |
|  8927513 |  568 | `    if( length>0 ){` |
|  8927183 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  8927183 |  570 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  572 | `		}` |
|  4463589 |  573 | `    }` |
|  8927513 |  574 | `    if( flag_leftjustify ){` |
...
|      ! 0 |  591 | `      }` |
|      ! 0 |  592 | `    }` |
|  4463759 |  593 | `  }/* End for loop over the format string */` |
|    94903 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|  1516464 |  595 | `}` |
|        - |  596 | `/* SPDX-SnippetEnd */` |
| 20660710 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|        5 |  598 | `{` |
| 20660715 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 20660715 |  600 | `	sxi32 rc = SXERR_ABORT;` |
| 20660715 |  601 | `	switch(pConsumer->nType){` |
...
|      181 |  605 | `			break;` |
| 10330265 |  606 | `	case SXFMT_CONS_BLOB:` |
|        - |  607 | `			/* Blob consumer */` |
| 20660535 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 20660530 |  609 | `			break;` |
|      ! 0 |  610 | `		default:` |
...
| 20660715 |  615 | `	pConsumer->nLen += nLen;` |
| 20660715 |  616 | `	pConsumer->rc = rc;` |
| 20660715 |  617 | `	return rc;` |
|        5 |  618 | `}` |
|  3032918 |  619 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|        5 |  620 | `{` |
|        - |  621 | `	SyFmtConsumer sCons;` |
|  3032923 |  622 | `	sCons.nType = nType;` |
|  3032923 |  623 | `	sCons.rc = SXRET_OK;` |
|  3032923 |  624 | `	sCons.nLen = 0;` |
|  3032923 |  625 | `	if( pOutLen ){` |
|   118451 |  626 | `		*pOutLen = 0;` |
|    59223 |  627 | `	}` |
|  3032923 |  628 | `	switch(nType){` |
...
|       13 |  637 | `		break;` |
|  1516453 |  638 | `		case SXFMT_CONS_BLOB:` |
|  3032911 |  639 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  3032911 |  640 | `			break;` |
|      ! 0 |  641 | `		default:` |
|      ! 0 |  642 | `			return SXERR_UNKNOWN;` |
|        - |  643 | `	}` |
|  3032923 |  644 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  3032923 |  645 | `	if( pOutLen ){` |
|   118451 |  646 | `		*pOutLen = sCons.nLen;` |
|    59223 |  647 | `	}` |
|  3032923 |  648 | `	return sCons.rc;` |
|  1516464 |  649 | `}` |
...
|       13 |  662 | `	return rc;` |
|        1 |  663 | `}` |
|    95148 |  664 | `PH7_PRIVATE sxu32 SyBlobFormat(SyBlob *pBlob,const char *zFormat,...)` |
|        5 |  665 | `{` |
|        - |  666 | `	va_list ap;` |
|        - |  667 | `	sxu32 n;` |
...
|        - |  671 | `	}` |
|        - |  672 | `#endif` |
|    95153 |  673 | `	va_start(ap,zFormat);` |
|    95153 |  674 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    95153 |  675 | `	va_end(ap);` |
|    95153 |  676 | `	return n;` |
|        5 |  677 | `}` |
|    23298 |  678 | `PH7_PRIVATE sxu32 SyBlobFormatAp(SyBlob *pBlob,const char *zFormat,va_list ap)` |
|        5 |  679 | `{` |
|    23303 |  680 | `	sxu32 n = 0; /* cc warning */` |
|        - |  681 | `#if defined(UNTRUST)` |
|        - |  682 | `	if( SX_EMPTY_STR(zFormat) ){` |
|        - |  683 | `		return 0;` |
|        - |  684 | `	}` |
|        - |  685 | `#endif` |
|    23303 |  686 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    23303 |  687 | `	return n;` |
|        5 |  688 | `}` |
|  2914460 |  689 | `PH7_PRIVATE sxu32 SyBufferFormat(char *zBuf,sxu32 nLen,const char *zFormat,...)` |
|        5 |  690 | `{` |
|        - |  691 | `	SyBlob sBlob;` |
|        - |  692 | `	va_list ap;` |
|        - |  693 | `	sxu32 n;` |
...
|        - |  697 | `	}` |
|        - |  698 | `#endif` |
|  2914465 |  699 | `	if( SXRET_OK != SyBlobInitFromBuf(&sBlob,zBuf,nLen - 1) ){` |
|      ! 0 |  700 | `		return 0;` |
|        - |  701 | `	}` |
|  2914465 |  702 | `	va_start(ap,zFormat);` |
|  2914465 |  703 | `	FormatMount(SXFMT_CONS_BLOB,&sBlob,0,0,0,zFormat,ap);` |
|  2914465 |  704 | `	va_end(ap);` |
|  2914465 |  705 | `	n = SyBlobLength(&sBlob);` |
|        - |  706 | `	/* Append the null terminator */` |
|  2914465 |  707 | `	sBlob.mByte++;` |
|  2914465 |  708 | `	SyBlobAppend(&sBlob,"\0",sizeof(char));` |
|  2914465 |  709 | `	return n;` |
|  1457235 |  710 | `}` |
|        - |  711 |  |
