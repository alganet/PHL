...
|        - |   90 | ` */` |
|  2505268 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|        5 |   92 | `{` |
|        - |   93 | `	/*` |
...
|  2505273 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|        - |  151 | `  int rc;` |
|        - |  152 |  |
|  2505273 |  153 | `  length = 0;` |
|  2505273 |  154 | `  bufpt = 0;` |
|  9851987 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
|  9758943 |  156 | `    if( c!='%' ){` |
|        - |  157 | `      unsigned int amt;` |
|  9627713 |  158 | `      bufpt = (char *)zFormat;` |
|  9627713 |  159 | `      amt = 1;` |
| 15246197 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
|  9627713 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
|  9627713 |  162 | `	  if( rc != SXRET_OK ){` |
|      ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  164 | `	  }` |
|  9627713 |  165 | `      if( c==0 ){` |
|  2412229 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|        - |  167 | `	  }` |
|  3607742 |  168 | `    }` |
|  7346719 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|      ! 0 |  170 | `      errorflag = 1;` |
...
|  7346719 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  7346714 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  3673357 |  180 | `    do{` |
|  7347825 |  181 | `      switch( c ){` |
...
|     1094 |  186 | `        case '0':   flag_zeropad = 1;         c = 0;   break;` |
|  7346714 |  187 | `        default:                                       break;` |
|        - |  188 | `      }` |
|  7347825 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|      ! 0 |  198 | `      c = *++zFormat;` |
|      ! 0 |  199 | `    }else{` |
|  7347861 |  200 | `      while( c>='0' && c<='9' ){` |
|     1145 |  201 | `        width = width*10 + c - '0';` |
|     1145 |  202 | `        c = *++zFormat;` |
|        3 |  203 | `      }` |
|        - |  204 | `    }` |
|  7346719 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|      ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|      ! 0 |  207 | `    }` |
|        - |  208 | `    /* Get the precision */` |
|  7346719 |  209 | `	precision = -1;` |
|  7346719 |  210 | `    if( c=='.' ){` |
...
|  7346719 |  225 | `	flag_long = 0;` |
|  7346719 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
...
|  7346719 |  235 | `    infop = 0;` |
|  7346719 |  236 | `    xtype = SXFMT_ERROR;` |
| 33845671 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 33845671 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  7346719 |  239 | `        infop = &aFmt[idx];` |
|  7346719 |  240 | `		xtype = infop->type;` |
|  7346719 |  241 | `        break;` |
|        - |  242 | `      }` |
| 13249481 |  243 | `    }` |
...
|        - |  263 | `    */` |
|  7346719 |  264 | `    switch( xtype ){` |
|    34663 |  265 | `      case SXFMT_RADIX:` |
|    69331 |  266 | `        if( flag_long > 0 ){` |
...
|        - |  290 | `#endif` |
|    69331 |  291 | `        if( infop->flags & SXFLAG_SIGNED ){` |
|    64807 |  292 | `          if( longvalue<0 ){` |
...
|      197 |  297 | `            prefix = '-';` |
|      100 |  298 | `          }else{` |
|    64613 |  299 | `            ulongvalue = (sxu64)longvalue;` |
|    64613 |  300 | `            if( flag_plussign )        prefix = '+';` |
|    64613 |  301 | `            else if( flag_blanksign )  prefix = ' ';` |
|    64613 |  302 | `            else                       prefix = 0;` |
|        - |  303 | `          }` |
|    32406 |  304 | `        }else{` |
|     4529 |  305 | `			ulongvalue = (sxu64)longvalue; /* print the full unsigned value as-is */` |
|     4529 |  306 | `			prefix = 0;` |
|        - |  307 | `		}` |
|    69331 |  308 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|     1094 |  309 | `          precision = width-(prefix!=0);` |
|      546 |  310 | `        }` |
|    69331 |  311 | `        bufpt = &buf[SXFMT_BUFSIZ-1];` |
|        - |  312 | `        {` |
|        - |  313 | `          register char *cset;      /* Use registers for speed */` |
|        - |  314 | `          register int base;` |
|    69331 |  315 | `          cset = infop->charset;` |
|    69331 |  316 | `          base = infop->base;` |
|    34663 |  317 | `          do{                                           /* Convert to ascii */` |
|   196778 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|   196778 |  319 | `            ulongvalue = ulongvalue/base;` |
|   196778 |  320 | `          }while( ulongvalue>0 );` |
|        - |  321 | `        }` |
|    69331 |  322 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    70294 |  323 | `        for(idx=precision-length; idx>0; idx--){` |
|      965 |  324 | `          *(--bufpt) = '0';                             /* Zero pad */` |
|      484 |  325 | `        }` |
|    69331 |  326 | `        if( prefix ) *(--bufpt) = prefix;               /* Add sign */` |
|    69331 |  327 | `        if( flag_alternateform && infop->prefix ){      /* Add "0" or "0x" */` |
|        - |  328 | `          char *pre, x;` |
...
|        1 |  332 | `          }` |
|        1 |  333 | `        }` |
|    69331 |  334 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    69331 |  335 | `        break;` |
...
|      ! 0 |  496 | `        length = 1;` |
|      ! 0 |  497 | `        break;` |
|     4847 |  498 | `      case SXFMT_CHARX:` |
|     9699 |  499 | `        c = va_arg(ap,int);` |
|     9699 |  500 | `		buf[0] = (char)c;` |
|        - |  501 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|     9699 |  502 | `		if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|     9699 |  503 | `        if( precision>=0 ){` |
...
|     9699 |  509 | `        bufpt = buf;` |
|     9699 |  510 | `        break;` |
|  1236854 |  511 | `      case SXFMT_STRING:` |
|  2473713 |  512 | `        bufpt = va_arg(ap,char*);` |
|  2473713 |  513 | `        if( bufpt==0 ){` |
|      ! 0 |  514 | `          bufpt = " ";` |
|      ! 0 |  515 | `		  length = (int)sizeof(" ")-1;` |
|      ! 0 |  516 | `		  break;` |
|        - |  517 | `        }` |
|  2473713 |  518 | `		length = precision;` |
|  2473713 |  519 | `		if( precision < 0 ){` |
|        - |  520 | `			/* Symisc extension */` |
|    90233 |  521 | `			length = (int)SyStrlen(bufpt);` |
|    45114 |  522 | `		}` |
|  2473713 |  523 | `        if( precision>=0 && precision<length ) length = precision;` |
|  2473713 |  524 | `        break;` |
|  2396979 |  525 | `	case SXFMT_RAWSTR:{` |
|        - |  526 | `		/* Symisc extension */` |
|  4793963 |  527 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  4793963 |  528 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|      ! 0 |  529 | `			 bufpt = " ";` |
|      ! 0 |  530 | `		     length = (int)sizeof(char);` |
|      ! 0 |  531 | `		     break;` |
|        - |  532 | `		}` |
|  4793963 |  533 | `		bufpt = (char *)pStr->zString;` |
|  4793963 |  534 | `		length = (int)pStr->nByte;` |
|  4793963 |  535 | `		break;` |
|        - |  536 | `					  }` |
...
|        - |  547 | `    ** the output.` |
|        - |  548 | `    */` |
|  7346719 |  549 | `    if( !flag_leftjustify ){` |
|        - |  550 | `      register int nspace;` |
|  7346719 |  551 | `      nspace = width-length;` |
|  7346719 |  552 | `      if( nspace>0 ){` |
...
|       18 |  566 | `      }` |
|  3673357 |  567 | `    }` |
|  7346719 |  568 | `    if( length>0 ){` |
|  7346377 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  7346377 |  570 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  572 | `		}` |
|  3673186 |  573 | `    }` |
|  7346719 |  574 | `    if( flag_leftjustify ){` |
...
|      ! 0 |  591 | `      }` |
|      ! 0 |  592 | `    }` |
|  3673362 |  593 | `  }/* End for loop over the format string */` |
|    93049 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|  1252639 |  595 | `}` |
|        - |  596 | `/* SPDX-SnippetEnd */` |
| 16974116 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|        5 |  598 | `{` |
| 16974121 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 16974121 |  600 | `	sxi32 rc = SXERR_ABORT;` |
| 16974121 |  601 | `	switch(pConsumer->nType){` |
...
|      181 |  605 | `			break;` |
|  8486968 |  606 | `	case SXFMT_CONS_BLOB:` |
|        - |  607 | `			/* Blob consumer */` |
| 16973941 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 16973936 |  609 | `			break;` |
|      ! 0 |  610 | `		default:` |
...
| 16974121 |  615 | `	pConsumer->nLen += nLen;` |
| 16974121 |  616 | `	pConsumer->rc = rc;` |
| 16974121 |  617 | `	return rc;` |
|        5 |  618 | `}` |
|  2505268 |  619 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|        5 |  620 | `{` |
|        - |  621 | `	SyFmtConsumer sCons;` |
|  2505273 |  622 | `	sCons.nType = nType;` |
|  2505273 |  623 | `	sCons.rc = SXRET_OK;` |
|  2505273 |  624 | `	sCons.nLen = 0;` |
|  2505273 |  625 | `	if( pOutLen ){` |
|   117311 |  626 | `		*pOutLen = 0;` |
|    58653 |  627 | `	}` |
|  2505273 |  628 | `	switch(nType){` |
...
|       13 |  637 | `		break;` |
|  1252628 |  638 | `		case SXFMT_CONS_BLOB:` |
|  2505261 |  639 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  2505261 |  640 | `			break;` |
|      ! 0 |  641 | `		default:` |
|      ! 0 |  642 | `			return SXERR_UNKNOWN;` |
|        - |  643 | `	}` |
|  2505273 |  644 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  2505273 |  645 | `	if( pOutLen ){` |
|   117311 |  646 | `		*pOutLen = sCons.nLen;` |
|    58653 |  647 | `	}` |
|  2505273 |  648 | `	return sCons.rc;` |
|  1252639 |  649 | `}` |
...
|       13 |  662 | `	return rc;` |
|        1 |  663 | `}` |
|    94052 |  664 | `PH7_PRIVATE sxu32 SyBlobFormat(SyBlob *pBlob,const char *zFormat,...)` |
|        5 |  665 | `{` |
|        - |  666 | `	va_list ap;` |
|        - |  667 | `	sxu32 n;` |
...
|        - |  671 | `	}` |
|        - |  672 | `#endif` |
|    94057 |  673 | `	va_start(ap,zFormat);` |
|    94057 |  674 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    94057 |  675 | `	va_end(ap);` |
|    94057 |  676 | `	return n;` |
|        5 |  677 | `}` |
|    23254 |  678 | `PH7_PRIVATE sxu32 SyBlobFormatAp(SyBlob *pBlob,const char *zFormat,va_list ap)` |
|        5 |  679 | `{` |
|    23259 |  680 | `	sxu32 n = 0; /* cc warning */` |
|        - |  681 | `#if defined(UNTRUST)` |
|        - |  682 | `	if( SX_EMPTY_STR(zFormat) ){` |
|        - |  683 | `		return 0;` |
|        - |  684 | `	}` |
|        - |  685 | `#endif` |
|    23259 |  686 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    23259 |  687 | `	return n;` |
|        5 |  688 | `}` |
