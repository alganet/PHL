...
|        - |   90 | ` */` |
|  2736046 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|        5 |   92 | `{` |
|        - |   93 | `	/*` |
...
|  2736051 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|        - |  151 | `  int rc;` |
|        - |  152 |  |
|  2736051 |  153 | `  length = 0;` |
|  2736051 |  154 | `  bufpt = 0;` |
| 10769059 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
| 10672933 |  156 | `    if( c!='%' ){` |
|        - |  157 | `      unsigned int amt;` |
| 10537833 |  158 | `      bufpt = (char *)zFormat;` |
| 10537833 |  159 | `      amt = 1;` |
| 16621679 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
| 10537833 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
| 10537833 |  162 | `	  if( rc != SXRET_OK ){` |
|      ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  164 | `	  }` |
| 10537833 |  165 | `      if( c==0 ){` |
|  2639925 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|        - |  167 | `	  }` |
|  3948954 |  168 | `    }` |
|  8033013 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|      ! 0 |  170 | `      errorflag = 1;` |
...
|  8033013 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  8033008 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  4016504 |  180 | `    do{` |
|  8034365 |  181 | `      switch( c ){` |
...
|  8033008 |  187 | `        default:                                       break;` |
|        - |  188 | `      }` |
|  8034365 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|      ! 0 |  198 | `      c = *++zFormat;` |
|      ! 0 |  199 | `    }else{` |
|  8034409 |  200 | `      while( c>='0' && c<='9' ){` |
|     1399 |  201 | `        width = width*10 + c - '0';` |
|     1399 |  202 | `        c = *++zFormat;` |
|        3 |  203 | `      }` |
|        - |  204 | `    }` |
|  8033013 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|      ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|      ! 0 |  207 | `    }` |
|        - |  208 | `    /* Get the precision */` |
|  8033013 |  209 | `	precision = -1;` |
|  8033013 |  210 | `    if( c=='.' ){` |
|  2610517 |  211 | `      precision = 0;` |
|  2610517 |  212 | `      c = *++zFormat;` |
|  2610517 |  213 | `      if( c=='*' ){` |
|  2610505 |  214 | `        precision = va_arg(ap,int);` |
|  2610505 |  215 | `        if( precision<0 ) precision = -precision;` |
|  2610505 |  216 | `        c = *++zFormat;` |
|  1305255 |  217 | `      }else{` |
...
|  8033013 |  225 | `	flag_long = 0;` |
|  8033013 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
...
|  8033013 |  235 | `    infop = 0;` |
|  8033013 |  236 | `    xtype = SXFMT_ERROR;` |
| 37034383 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 37034383 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  8033013 |  239 | `        infop = &aFmt[idx];` |
|  8033013 |  240 | `		xtype = infop->type;` |
|  8033013 |  241 | `        break;` |
|        - |  242 | `      }` |
| 14500690 |  243 | `    }` |
...
|        - |  263 | `    */` |
|  8033013 |  264 | `    switch( xtype ){` |
|    36039 |  265 | `      case SXFMT_RADIX:` |
|    72083 |  266 | `        if( flag_long > 0 ){` |
...
|        - |  290 | `#endif` |
|    72083 |  291 | `        if( infop->flags & SXFLAG_SIGNED ){` |
|    67491 |  292 | `          if( longvalue<0 ){` |
...
|      222 |  297 | `            prefix = '-';` |
|      113 |  298 | `          }else{` |
|    67273 |  299 | `            ulongvalue = (sxu64)longvalue;` |
|    67273 |  300 | `            if( flag_plussign )        prefix = '+';` |
|    67273 |  301 | `            else if( flag_blanksign )  prefix = ' ';` |
|    67273 |  302 | `            else                       prefix = 0;` |
|        - |  303 | `          }` |
|    33748 |  304 | `        }else{` |
|     4597 |  305 | `			ulongvalue = (sxu64)longvalue; /* print the full unsigned value as-is */` |
|     4597 |  306 | `			prefix = 0;` |
|        - |  307 | `		}` |
|    72083 |  308 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|     1340 |  309 | `          precision = width-(prefix!=0);` |
|      669 |  310 | `        }` |
|    72083 |  311 | `        bufpt = &buf[SXFMT_BUFSIZ-1];` |
|        - |  312 | `        {` |
|        - |  313 | `          register char *cset;      /* Use registers for speed */` |
|        - |  314 | `          register int base;` |
|    72083 |  315 | `          cset = infop->charset;` |
|    72083 |  316 | `          base = infop->base;` |
|    36039 |  317 | `          do{                                           /* Convert to ascii */` |
|   204049 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|   204049 |  319 | `            ulongvalue = ulongvalue/base;` |
|   204049 |  320 | `          }while( ulongvalue>0 );` |
|        - |  321 | `        }` |
|    72083 |  322 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    73183 |  323 | `        for(idx=precision-length; idx>0; idx--){` |
|     1102 |  324 | `          *(--bufpt) = '0';                             /* Zero pad */` |
|      552 |  325 | `        }` |
|    72083 |  326 | `        if( prefix ) *(--bufpt) = prefix;               /* Add sign */` |
|    72083 |  327 | `        if( flag_alternateform && infop->prefix ){      /* Add "0" or "0x" */` |
|        - |  328 | `          char *pre, x;` |
...
|        1 |  332 | `          }` |
|        1 |  333 | `        }` |
|    72083 |  334 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    72083 |  335 | `        break;` |
...
|      ! 0 |  496 | `        length = 1;` |
|      ! 0 |  497 | `        break;` |
|     4949 |  498 | `      case SXFMT_CHARX:` |
|     9903 |  499 | `        c = va_arg(ap,int);` |
|     9903 |  500 | `		buf[0] = (char)c;` |
|        - |  501 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|     9903 |  502 | `		if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|     9903 |  503 | `        if( precision>=0 ){` |
...
|     9903 |  509 | `        bufpt = buf;` |
|     9903 |  510 | `        break;` |
|  1351257 |  511 | `      case SXFMT_STRING:` |
|  2702519 |  512 | `        bufpt = va_arg(ap,char*);` |
|  2702519 |  513 | `        if( bufpt==0 ){` |
|      ! 0 |  514 | `          bufpt = " ";` |
|      ! 0 |  515 | `		  length = (int)sizeof(" ")-1;` |
|      ! 0 |  516 | `		  break;` |
|        - |  517 | `        }` |
|  2702519 |  518 | `		length = precision;` |
|  2702519 |  519 | `		if( precision < 0 ){` |
|        - |  520 | `			/* Symisc extension */` |
|    92007 |  521 | `			length = (int)SyStrlen(bufpt);` |
|    46001 |  522 | `		}` |
|  2702519 |  523 | `        if( precision>=0 && precision<length ) length = precision;` |
|  2702519 |  524 | `        break;` |
|  2624245 |  525 | `	case SXFMT_RAWSTR:{` |
|        - |  526 | `		/* Symisc extension */` |
|  5248495 |  527 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  5248495 |  528 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|      ! 0 |  529 | `			 bufpt = " ";` |
|      ! 0 |  530 | `		     length = (int)sizeof(char);` |
|      ! 0 |  531 | `		     break;` |
|        - |  532 | `		}` |
|  5248495 |  533 | `		bufpt = (char *)pStr->zString;` |
|  5248495 |  534 | `		length = (int)pStr->nByte;` |
|  5248495 |  535 | `		break;` |
|        - |  536 | `					  }` |
...
|        - |  547 | `    ** the output.` |
|        - |  548 | `    */` |
|  8033013 |  549 | `    if( !flag_leftjustify ){` |
|        - |  550 | `      register int nspace;` |
|  8033013 |  551 | `      nspace = width-length;` |
|  8033013 |  552 | `      if( nspace>0 ){` |
...
|       18 |  566 | `      }` |
|  4016504 |  567 | `    }` |
|  8033013 |  568 | `    if( length>0 ){` |
|  8032671 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  8032671 |  570 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  572 | `		}` |
|  4016333 |  573 | `    }` |
|  8033013 |  574 | `    if( flag_leftjustify ){` |
...
|      ! 0 |  591 | `      }` |
|      ! 0 |  592 | `    }` |
|  4016509 |  593 | `  }/* End for loop over the format string */` |
|    96131 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|  1368028 |  595 | `}` |
|        - |  596 | `/* SPDX-SnippetEnd */` |
| 18570530 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|        5 |  598 | `{` |
| 18570535 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 18570535 |  600 | `	sxi32 rc = SXERR_ABORT;` |
| 18570535 |  601 | `	switch(pConsumer->nType){` |
...
|      181 |  605 | `			break;` |
|  9285175 |  606 | `	case SXFMT_CONS_BLOB:` |
|        - |  607 | `			/* Blob consumer */` |
| 18570355 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 18570350 |  609 | `			break;` |
|      ! 0 |  610 | `		default:` |
...
| 18570535 |  615 | `	pConsumer->nLen += nLen;` |
| 18570535 |  616 | `	pConsumer->rc = rc;` |
| 18570535 |  617 | `	return rc;` |
|        5 |  618 | `}` |
|  2736046 |  619 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|        5 |  620 | `{` |
|        - |  621 | `	SyFmtConsumer sCons;` |
|  2736051 |  622 | `	sCons.nType = nType;` |
|  2736051 |  623 | `	sCons.rc = SXRET_OK;` |
|  2736051 |  624 | `	sCons.nLen = 0;` |
|  2736051 |  625 | `	if( pOutLen ){` |
|   120907 |  626 | `		*pOutLen = 0;` |
|    60451 |  627 | `	}` |
|  2736051 |  628 | `	switch(nType){` |
...
|       13 |  637 | `		break;` |
|  1368017 |  638 | `		case SXFMT_CONS_BLOB:` |
|  2736039 |  639 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  2736039 |  640 | `			break;` |
|      ! 0 |  641 | `		default:` |
|      ! 0 |  642 | `			return SXERR_UNKNOWN;` |
|        - |  643 | `	}` |
|  2736051 |  644 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  2736051 |  645 | `	if( pOutLen ){` |
|   120907 |  646 | `		*pOutLen = sCons.nLen;` |
|    60451 |  647 | `	}` |
|  2736051 |  648 | `	return sCons.rc;` |
|  1368028 |  649 | `}` |
...
|       13 |  662 | `	return rc;` |
|        1 |  663 | `}` |
|    96982 |  664 | `PH7_PRIVATE sxu32 SyBlobFormat(SyBlob *pBlob,const char *zFormat,...)` |
|        5 |  665 | `{` |
|        - |  666 | `	va_list ap;` |
|        - |  667 | `	sxu32 n;` |
...
|        - |  671 | `	}` |
|        - |  672 | `#endif` |
|    96987 |  673 | `	va_start(ap,zFormat);` |
|    96987 |  674 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    96987 |  675 | `	va_end(ap);` |
|    96987 |  676 | `	return n;` |
|        5 |  677 | `}` |
|    23920 |  678 | `PH7_PRIVATE sxu32 SyBlobFormatAp(SyBlob *pBlob,const char *zFormat,va_list ap)` |
|        5 |  679 | `{` |
|    23925 |  680 | `	sxu32 n = 0; /* cc warning */` |
|        - |  681 | `#if defined(UNTRUST)` |
|        - |  682 | `	if( SX_EMPTY_STR(zFormat) ){` |
|        - |  683 | `		return 0;` |
|        - |  684 | `	}` |
|        - |  685 | `#endif` |
|    23925 |  686 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    23925 |  687 | `	return n;` |
|        5 |  688 | `}` |
|  2615132 |  689 | `PH7_PRIVATE sxu32 SyBufferFormat(char *zBuf,sxu32 nLen,const char *zFormat,...)` |
|        5 |  690 | `{` |
|        - |  691 | `	SyBlob sBlob;` |
|        - |  692 | `	va_list ap;` |
|        - |  693 | `	sxu32 n;` |
...
|        - |  697 | `	}` |
|        - |  698 | `#endif` |
|  2615137 |  699 | `	if( SXRET_OK != SyBlobInitFromBuf(&sBlob,zBuf,nLen - 1) ){` |
|      ! 0 |  700 | `		return 0;` |
|        - |  701 | `	}` |
|  2615137 |  702 | `	va_start(ap,zFormat);` |
|  2615137 |  703 | `	FormatMount(SXFMT_CONS_BLOB,&sBlob,0,0,0,zFormat,ap);` |
|  2615137 |  704 | `	va_end(ap);` |
|  2615137 |  705 | `	n = SyBlobLength(&sBlob);` |
|        - |  706 | `	/* Append the null terminator */` |
|  2615137 |  707 | `	sBlob.mByte++;` |
|  2615137 |  708 | `	SyBlobAppend(&sBlob,"\0",sizeof(char));` |
|  2615137 |  709 | `	return n;` |
|  1307571 |  710 | `}` |
|        - |  711 |  |
