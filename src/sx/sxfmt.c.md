...
|       - |   90 | ` */` |
|  346290 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|       5 |   92 | `{` |
|       - |   93 | `	/*` |
...
|  346295 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|  346295 |  153 | `  length = 0;` |
|  346295 |  154 | `  bufpt = 0;` |
| 1266267 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
| 1199663 |  156 | `    if( c!='%' ){` |
|       - |  157 | `      unsigned int amt;` |
| 1112663 |  158 | `      bufpt = (char *)zFormat;` |
| 1112663 |  159 | `      amt = 1;` |
| 1756835 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
| 1112663 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
| 1112663 |  162 | `	  if( rc != SXRET_OK ){` |
|     ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|       - |  164 | `	  }` |
| 1112663 |  165 | `      if( c==0 ){` |
|  279691 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|       - |  167 | `	  }` |
|  416486 |  168 | `    }` |
|  919977 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|     ! 0 |  170 | `      errorflag = 1;` |
...
|  919977 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  919972 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  459986 |  180 | `    do{` |
|  920135 |  181 | `      switch( c ){` |
...
|  919972 |  187 | `        default:                                       break;` |
|       - |  188 | `      }` |
|  920135 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|     ! 0 |  198 | `      c = *++zFormat;` |
|     ! 0 |  199 | `    }else{` |
|  920177 |  200 | `      while( c>='0' && c<='9' ){` |
|     202 |  201 | `        width = width*10 + c - '0';` |
|     202 |  202 | `        c = *++zFormat;` |
|       2 |  203 | `      }` |
|       - |  204 | `    }` |
|  919977 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|     ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|     ! 0 |  207 | `    }` |
|       - |  208 | `    /* Get the precision */` |
|  919977 |  209 | `	precision = -1;` |
|  919977 |  210 | `    if( c=='.' ){` |
|  277147 |  211 | `      precision = 0;` |
|  277147 |  212 | `      c = *++zFormat;` |
|  277147 |  213 | `      if( c=='*' ){` |
|  276847 |  214 | `        precision = va_arg(ap,int);` |
|  276847 |  215 | `        if( precision<0 ) precision = -precision;` |
|  276847 |  216 | `        c = *++zFormat;` |
|  138426 |  217 | `      }else{` |
...
|  919977 |  225 | `	flag_long = 0;` |
|  919977 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
|   55277 |  227 | `      flag_long = (c == 'q') ? 2 : 1;` |
|   55277 |  228 | `      c = *++zFormat;` |
|   55277 |  229 | `	  if( c == 'l' ){` |
...
|  919977 |  235 | `    infop = 0;` |
|  919977 |  236 | `    xtype = SXFMT_ERROR;` |
| 4100047 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 4100047 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  919977 |  239 | `        infop = &aFmt[idx];` |
|  919977 |  240 | `		xtype = infop->type;` |
|  919977 |  241 | `        break;` |
|       - |  242 | `      }` |
| 1590040 |  243 | `    }` |
...
|       - |  263 | `    */` |
|  919977 |  264 | `    switch( xtype ){` |
|   29021 |  265 | `      case SXFMT_RADIX:` |
|   58047 |  266 | `        if( flag_long > 0 ){` |
|   55277 |  267 | `			if( flag_long > 1 ){` |
|       - |  268 | `				/* BSD quad: expect a 64-bit integer */` |
|   55265 |  269 | `				longvalue = va_arg(ap,sxi64);` |
|   27635 |  270 | `			}else{` |
|      13 |  271 | `				longvalue = va_arg(ap,sxlong);` |
|       - |  272 | `			}` |
|   27641 |  273 | `		}else{` |
|    2775 |  274 | `			if( infop->flags & SXFLAG_SIGNED ){` |
|    1287 |  275 | `				longvalue = va_arg(ap,sxi32);` |
|     646 |  276 | `			}else{` |
|    1493 |  277 | `				longvalue = va_arg(ap,sxu32);` |
|       - |  278 | `			}` |
|       - |  279 | `		}` |
|       - |  280 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|   58047 |  281 | `      if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|       - |  282 | `#if 1` |
|       - |  283 | `        /* For the format %#x, the value zero is printed "0" not "0x0".` |
|       - |  284 | `        ** I think this is stupid.*/` |
|   58047 |  285 | `        if( longvalue==0 ) flag_alternateform = 0;` |
|       - |  286 | `#else` |
...
|       - |  290 | `#endif` |
|   58047 |  291 | `        if( infop->flags & SXFLAG_SIGNED ){` |
|   56549 |  292 | `          if( longvalue<0 ){` |
...
|     112 |  297 | `            prefix = '-';` |
|      57 |  298 | `          }else{` |
|   56439 |  299 | `            ulongvalue = (sxu64)longvalue;` |
|   56439 |  300 | `            if( flag_plussign )        prefix = '+';` |
|   56437 |  301 | `            else if( flag_blanksign )  prefix = ' ';` |
|   56437 |  302 | `            else                       prefix = 0;` |
|       - |  303 | `          }` |
|   28277 |  304 | `        }else{` |
|    1503 |  305 | `			ulongvalue = (sxu64)longvalue; /* print the full unsigned value as-is */` |
|    1503 |  306 | `			prefix = 0;` |
|       - |  307 | `		}` |
|   58047 |  308 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|     142 |  309 | `          precision = width-(prefix!=0);` |
|      70 |  310 | `        }` |
|   58047 |  311 | `        bufpt = &buf[SXFMT_BUFSIZ-1];` |
|       - |  312 | `        {` |
|       - |  313 | `          register char *cset;      /* Use registers for speed */` |
|       - |  314 | `          register int base;` |
|   58047 |  315 | `          cset = infop->charset;` |
|   58047 |  316 | `          base = infop->base;` |
|   29021 |  317 | `          do{                                           /* Convert to ascii */` |
|  176211 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|  176211 |  319 | `            ulongvalue = ulongvalue/base;` |
|  176211 |  320 | `          }while( ulongvalue>0 );` |
|       - |  321 | `        }` |
|   58047 |  322 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|   58407 |  323 | `        for(idx=precision-length; idx>0; idx--){` |
|     362 |  324 | `          *(--bufpt) = '0';                             /* Zero pad */` |
|     180 |  325 | `        }` |
|   58047 |  326 | `        if( prefix ) *(--bufpt) = prefix;               /* Add sign */` |
|   58047 |  327 | `        if( flag_alternateform && infop->prefix ){      /* Add "0" or "0x" */` |
|       - |  328 | `          char *pre, x;` |
...
|       2 |  332 | `          }` |
|       2 |  333 | `        }` |
|   58047 |  334 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|   58047 |  335 | `        break;` |
...
|   10204 |  509 | `        bufpt = buf;` |
|   10204 |  510 | `        break;` |
|  139100 |  511 | `      case SXFMT_STRING:` |
|  278205 |  512 | `        bufpt = va_arg(ap,char*);` |
|  278205 |  513 | `        if( bufpt==0 ){` |
|     ! 0 |  514 | `          bufpt = " ";` |
|     ! 0 |  515 | `		  length = (int)sizeof(" ")-1;` |
|     ! 0 |  516 | `		  break;` |
|       - |  517 | `        }` |
|  278205 |  518 | `		length = precision;` |
|  278205 |  519 | `		if( precision < 0 ){` |
|       - |  520 | `			/* Symisc extension */` |
|    1363 |  521 | `			length = (int)SyStrlen(bufpt);` |
|     679 |  522 | `		}` |
|  278205 |  523 | `        if( precision>=0 && precision<length ) length = precision;` |
|  278205 |  524 | `        break;` |
|  286609 |  525 | `	case SXFMT_RAWSTR:{` |
|       - |  526 | `		/* Symisc extension */` |
|  573223 |  527 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  573223 |  528 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|     ! 0 |  529 | `			 bufpt = " ";` |
|     ! 0 |  530 | `		     length = (int)sizeof(char);` |
|     ! 0 |  531 | `		     break;` |
|       - |  532 | `		}` |
|  573223 |  533 | `		bufpt = (char *)pStr->zString;` |
|  573223 |  534 | `		length = (int)pStr->nByte;` |
|  573223 |  535 | `		break;` |
|       - |  536 | `					  }` |
...
|       - |  547 | `    ** the output.` |
|       - |  548 | `    */` |
|  919977 |  549 | `    if( !flag_leftjustify ){` |
|       - |  550 | `      register int nspace;` |
|  919977 |  551 | `      nspace = width-length;` |
|  919977 |  552 | `      if( nspace>0 ){` |
...
|      18 |  566 | `      }` |
|  459986 |  567 | `    }` |
|  919977 |  568 | `    if( length>0 ){` |
|  919953 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  919953 |  570 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|       - |  572 | `		}` |
|  459974 |  573 | `    }` |
|  919977 |  574 | `    if( flag_leftjustify ){` |
...
|     ! 0 |  591 | `      }` |
|     ! 0 |  592 | `    }` |
|  459991 |  593 | `  }/* End for loop over the format string */` |
|   66609 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|  173150 |  595 | `}` |
|       - |  596 | `/* SPDX-SnippetEnd */` |
| 2032642 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|       5 |  598 | `{` |
| 2032647 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 2032647 |  600 | `	sxi32 rc = SXERR_ABORT;` |
| 2032647 |  601 | `	switch(pConsumer->nType){` |
...
|     157 |  605 | `			break;` |
| 1016243 |  606 | `	case SXFMT_CONS_BLOB:` |
|       - |  607 | `			/* Blob consumer */` |
| 2032491 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 2032486 |  609 | `			break;` |
|     ! 0 |  610 | `		default:` |
...
| 2032647 |  615 | `	pConsumer->nLen += nLen;` |
| 2032647 |  616 | `	pConsumer->rc = rc;` |
| 2032647 |  617 | `	return rc;` |
|       5 |  618 | `}` |
|  346290 |  619 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|       5 |  620 | `{` |
|       - |  621 | `	SyFmtConsumer sCons;` |
|  346295 |  622 | `	sCons.nType = nType;` |
|  346295 |  623 | `	sCons.rc = SXRET_OK;` |
|  346295 |  624 | `	sCons.nLen = 0;` |
|  346295 |  625 | `	if( pOutLen ){` |
|   69267 |  626 | `		*pOutLen = 0;` |
|   34631 |  627 | `	}` |
|  346295 |  628 | `	switch(nType){` |
...
|      13 |  637 | `		break;` |
|  173139 |  638 | `		case SXFMT_CONS_BLOB:` |
|  346283 |  639 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  346283 |  640 | `			break;` |
|     ! 0 |  641 | `		default:` |
|     ! 0 |  642 | `			return SXERR_UNKNOWN;` |
|       - |  643 | `	}` |
|  346295 |  644 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  346295 |  645 | `	if( pOutLen ){` |
|   69267 |  646 | `		*pOutLen = sCons.nLen;` |
|   34631 |  647 | `	}` |
|  346295 |  648 | `	return sCons.rc;` |
|  173150 |  649 | `}` |
...
|      13 |  662 | `	return rc;` |
|       1 |  663 | `}` |
|   67692 |  664 | `PH7_PRIVATE sxu32 SyBlobFormat(SyBlob *pBlob,const char *zFormat,...)` |
|       5 |  665 | `{` |
|       - |  666 | `	va_list ap;` |
|       - |  667 | `	sxu32 n;` |
...
|       - |  671 | `	}` |
|       - |  672 | `#endif` |
|   67697 |  673 | `	va_start(ap,zFormat);` |
|   67697 |  674 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|   67697 |  675 | `	va_end(ap);` |
|   67697 |  676 | `	return n;` |
|       5 |  677 | `}` |
|    1570 |  678 | `PH7_PRIVATE sxu32 SyBlobFormatAp(SyBlob *pBlob,const char *zFormat,va_list ap)` |
|       5 |  679 | `{` |
|    1575 |  680 | `	sxu32 n = 0; /* cc warning */` |
|       - |  681 | `#if defined(UNTRUST)` |
|       - |  682 | `	if( SX_EMPTY_STR(zFormat) ){` |
|       - |  683 | `		return 0;` |
|       - |  684 | `	}` |
|       - |  685 | `#endif` |
|    1575 |  686 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    1575 |  687 | `	return n;` |
|       5 |  688 | `}` |
|  277016 |  689 | `PH7_PRIVATE sxu32 SyBufferFormat(char *zBuf,sxu32 nLen,const char *zFormat,...)` |
|       5 |  690 | `{` |
|       - |  691 | `	SyBlob sBlob;` |
|       - |  692 | `	va_list ap;` |
|       - |  693 | `	sxu32 n;` |
...
|       - |  697 | `	}` |
|       - |  698 | `#endif` |
|  277021 |  699 | `	if( SXRET_OK != SyBlobInitFromBuf(&sBlob,zBuf,nLen - 1) ){` |
|     ! 0 |  700 | `		return 0;` |
|       - |  701 | `	}` |
|  277021 |  702 | `	va_start(ap,zFormat);` |
|  277021 |  703 | `	FormatMount(SXFMT_CONS_BLOB,&sBlob,0,0,0,zFormat,ap);` |
|  277021 |  704 | `	va_end(ap);` |
|  277021 |  705 | `	n = SyBlobLength(&sBlob);` |
|       - |  706 | `	/* Append the null terminator */` |
|  277021 |  707 | `	sBlob.mByte++;` |
|  277021 |  708 | `	SyBlobAppend(&sBlob,"\0",sizeof(char));` |
|  277021 |  709 | `	return n;` |
|  138513 |  710 | `}` |
|       - |  711 |  |
