...
|        - |   90 | ` */` |
|  2504666 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|        5 |   92 | `{` |
|        - |   93 | `	/*` |
...
|  2504671 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|        - |  151 | `  int rc;` |
|        - |  152 |  |
|  2504671 |  153 | `  length = 0;` |
|  2504671 |  154 | `  bufpt = 0;` |
|  9850635 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
|  9758161 |  156 | `    if( c!='%' ){` |
|        - |  157 | `      unsigned int amt;` |
|  9627553 |  158 | `      bufpt = (char *)zFormat;` |
|  9627553 |  159 | `      amt = 1;` |
| 15245237 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
|  9627553 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
|  9627553 |  162 | `	  if( rc != SXRET_OK ){` |
|      ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  164 | `	  }` |
|  9627553 |  165 | `      if( c==0 ){` |
|  2412197 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|        - |  167 | `	  }` |
|  3607678 |  168 | `    }` |
|  7345969 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|      ! 0 |  170 | `      errorflag = 1;` |
...
|  7345969 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  7345964 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  3672982 |  180 | `    do{` |
|  7346703 |  181 | `      switch( c ){` |
...
|  7345964 |  187 | `        default:                                       break;` |
|        - |  188 | `      }` |
|  7346703 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|      ! 0 |  198 | `      c = *++zFormat;` |
|      ! 0 |  199 | `    }else{` |
|  7346739 |  200 | `      while( c>='0' && c<='9' ){` |
|      773 |  201 | `        width = width*10 + c - '0';` |
|      773 |  202 | `        c = *++zFormat;` |
|        3 |  203 | `      }` |
|        - |  204 | `    }` |
|  7345969 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|      ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|      ! 0 |  207 | `    }` |
|        - |  208 | `    /* Get the precision */` |
|  7345969 |  209 | `	precision = -1;` |
|  7345969 |  210 | `    if( c=='.' ){` |
|  2383469 |  211 | `      precision = 0;` |
|  2383469 |  212 | `      c = *++zFormat;` |
|  2383469 |  213 | `      if( c=='*' ){` |
|  2383465 |  214 | `        precision = va_arg(ap,int);` |
|  2383465 |  215 | `        if( precision<0 ) precision = -precision;` |
|  2383465 |  216 | `        c = *++zFormat;` |
|  1191735 |  217 | `      }else{` |
|        9 |  218 | `        while( c>='0' && c<='9' ){` |
...
|  7345969 |  225 | `	flag_long = 0;` |
|  7345969 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
|    59973 |  227 | `      flag_long = (c == 'q') ? 2 : 1;` |
|    59973 |  228 | `      c = *++zFormat;` |
|    59973 |  229 | `	  if( c == 'l' ){` |
...
|  7345969 |  235 | `    infop = 0;` |
|  7345969 |  236 | `    xtype = SXFMT_ERROR;` |
| 33844513 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 33844513 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  7345969 |  239 | `        infop = &aFmt[idx];` |
|  7345969 |  240 | `		xtype = infop->type;` |
|  7345969 |  241 | `        break;` |
|        - |  242 | `      }` |
| 13249277 |  243 | `    }` |
...
|        - |  263 | `    */` |
|  7345969 |  264 | `    switch( xtype ){` |
|    34403 |  265 | `      case SXFMT_RADIX:` |
|    68811 |  266 | `        if( flag_long > 0 ){` |
|    59973 |  267 | `			if( flag_long > 1 ){` |
|        - |  268 | `				/* BSD quad: expect a 64-bit integer */` |
|    59961 |  269 | `				longvalue = va_arg(ap,sxi64);` |
|    29983 |  270 | `			}else{` |
|       13 |  271 | `				longvalue = va_arg(ap,sxlong);` |
|        - |  272 | `			}` |
|    29989 |  273 | `		}else{` |
|     8843 |  274 | `			if( infop->flags & SXFLAG_SIGNED ){` |
|     4377 |  275 | `				longvalue = va_arg(ap,sxi32);` |
|     2191 |  276 | `			}else{` |
|     4471 |  277 | `				longvalue = va_arg(ap,sxu32);` |
|        - |  278 | `			}` |
|        - |  279 | `		}` |
|        - |  280 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|    68811 |  281 | `      if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|        - |  282 | `#if 1` |
|        - |  283 | `        /* For the format %#x, the value zero is printed "0" not "0x0".` |
|        - |  284 | `        ** I think this is stupid.*/` |
|    68811 |  285 | `        if( longvalue==0 ) flag_alternateform = 0;` |
|        - |  286 | `#else` |
...
|        - |  290 | `#endif` |
|    68811 |  291 | `        if( infop->flags & SXFLAG_SIGNED ){` |
|    64287 |  292 | `          if( longvalue<0 ){` |
...
|      197 |  297 | `            prefix = '-';` |
|      100 |  298 | `          }else{` |
|    64093 |  299 | `            ulongvalue = (sxu64)longvalue;` |
|    64093 |  300 | `            if( flag_plussign )        prefix = '+';` |
|    64093 |  301 | `            else if( flag_blanksign )  prefix = ' ';` |
|    64093 |  302 | `            else                       prefix = 0;` |
|        - |  303 | `          }` |
|    32146 |  304 | `        }else{` |
|     4529 |  305 | `			ulongvalue = (sxu64)longvalue; /* print the full unsigned value as-is */` |
|     4529 |  306 | `			prefix = 0;` |
|        - |  307 | `		}` |
|    68811 |  308 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|      722 |  309 | `          precision = width-(prefix!=0);` |
|      360 |  310 | `        }` |
|    68811 |  311 | `        bufpt = &buf[SXFMT_BUFSIZ-1];` |
|        - |  312 | `        {` |
|        - |  313 | `          register char *cset;      /* Use registers for speed */` |
|        - |  314 | `          register int base;` |
|    68811 |  315 | `          cset = infop->charset;` |
|    68811 |  316 | `          base = infop->base;` |
|    34403 |  317 | `          do{                                           /* Convert to ascii */` |
|   194781 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|   194781 |  319 | `            ulongvalue = ulongvalue/base;` |
|   194781 |  320 | `          }while( ulongvalue>0 );` |
|        - |  321 | `        }` |
|    68811 |  322 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    69571 |  323 | `        for(idx=precision-length; idx>0; idx--){` |
|      762 |  324 | `          *(--bufpt) = '0';                             /* Zero pad */` |
|      384 |  325 | `        }` |
|    68811 |  326 | `        if( prefix ) *(--bufpt) = prefix;               /* Add sign */` |
|    68811 |  327 | `        if( flag_alternateform && infop->prefix ){      /* Add "0" or "0x" */` |
|        - |  328 | `          char *pre, x;` |
...
|        1 |  332 | `          }` |
|        1 |  333 | `        }` |
|    68811 |  334 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    68811 |  335 | `        break;` |
...
|      ! 0 |  496 | `        length = 1;` |
|      ! 0 |  497 | `        break;` |
|     4830 |  498 | `      case SXFMT_CHARX:` |
|     9665 |  499 | `        c = va_arg(ap,int);` |
|     9665 |  500 | `		buf[0] = (char)c;` |
|        - |  501 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|     9665 |  502 | `		if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|     9665 |  503 | `        if( precision>=0 ){` |
...
|     9665 |  509 | `        bufpt = buf;` |
|     9665 |  510 | `        break;` |
|  1236774 |  511 | `      case SXFMT_STRING:` |
|  2473553 |  512 | `        bufpt = va_arg(ap,char*);` |
|  2473553 |  513 | `        if( bufpt==0 ){` |
|      ! 0 |  514 | `          bufpt = " ";` |
|      ! 0 |  515 | `		  length = (int)sizeof(" ")-1;` |
|      ! 0 |  516 | `		  break;` |
|        - |  517 | `        }` |
|  2473553 |  518 | `		length = precision;` |
|  2473553 |  519 | `		if( precision < 0 ){` |
|        - |  520 | `			/* Symisc extension */` |
|    90089 |  521 | `			length = (int)SyStrlen(bufpt);` |
|    45042 |  522 | `		}` |
|  2473553 |  523 | `        if( precision>=0 && precision<length ) length = precision;` |
|  2473553 |  524 | `        break;` |
|  2396961 |  525 | `	case SXFMT_RAWSTR:{` |
|        - |  526 | `		/* Symisc extension */` |
|  4793927 |  527 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  4793927 |  528 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|      ! 0 |  529 | `			 bufpt = " ";` |
|      ! 0 |  530 | `		     length = (int)sizeof(char);` |
|      ! 0 |  531 | `		     break;` |
|        - |  532 | `		}` |
|  4793927 |  533 | `		bufpt = (char *)pStr->zString;` |
|  4793927 |  534 | `		length = (int)pStr->nByte;` |
|  4793927 |  535 | `		break;` |
|        - |  536 | `					  }` |
...
|        - |  547 | `    ** the output.` |
|        - |  548 | `    */` |
|  7345969 |  549 | `    if( !flag_leftjustify ){` |
|        - |  550 | `      register int nspace;` |
|  7345969 |  551 | `      nspace = width-length;` |
|  7345969 |  552 | `      if( nspace>0 ){` |
...
|       18 |  566 | `      }` |
|  3672982 |  567 | `    }` |
|  7345969 |  568 | `    if( length>0 ){` |
|  7345627 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  7345627 |  570 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  572 | `		}` |
|  3672811 |  573 | `    }` |
|  7345969 |  574 | `    if( flag_leftjustify ){` |
...
|      ! 0 |  591 | `      }` |
|      ! 0 |  592 | `    }` |
|  3672987 |  593 | `  }/* End for loop over the format string */` |
|    92479 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|  1252338 |  595 | `}` |
|        - |  596 | `/* SPDX-SnippetEnd */` |
| 16973206 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|        5 |  598 | `{` |
| 16973211 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 16973211 |  600 | `	sxi32 rc = SXERR_ABORT;` |
| 16973211 |  601 | `	switch(pConsumer->nType){` |
...
|      181 |  605 | `			break;` |
|  8486513 |  606 | `	case SXFMT_CONS_BLOB:` |
|        - |  607 | `			/* Blob consumer */` |
| 16973031 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 16973026 |  609 | `			break;` |
|      ! 0 |  610 | `		default:` |
...
| 16973211 |  615 | `	pConsumer->nLen += nLen;` |
| 16973211 |  616 | `	pConsumer->rc = rc;` |
| 16973211 |  617 | `	return rc;` |
|        5 |  618 | `}` |
|  2504666 |  619 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|        5 |  620 | `{` |
|        - |  621 | `	SyFmtConsumer sCons;` |
|  2504671 |  622 | `	sCons.nType = nType;` |
|  2504671 |  623 | `	sCons.rc = SXRET_OK;` |
|  2504671 |  624 | `	sCons.nLen = 0;` |
|  2504671 |  625 | `	if( pOutLen ){` |
|   116709 |  626 | `		*pOutLen = 0;` |
|    58352 |  627 | `	}` |
|  2504671 |  628 | `	switch(nType){` |
...
|       13 |  637 | `		break;` |
|  1252327 |  638 | `		case SXFMT_CONS_BLOB:` |
|  2504659 |  639 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  2504659 |  640 | `			break;` |
|      ! 0 |  641 | `		default:` |
|      ! 0 |  642 | `			return SXERR_UNKNOWN;` |
|        - |  643 | `	}` |
|  2504671 |  644 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  2504671 |  645 | `	if( pOutLen ){` |
|   116709 |  646 | `		*pOutLen = sCons.nLen;` |
|    58352 |  647 | `	}` |
|  2504671 |  648 | `	return sCons.rc;` |
|  1252338 |  649 | `}` |
...
|       13 |  662 | `	return rc;` |
|        1 |  663 | `}` |
|    93870 |  664 | `PH7_PRIVATE sxu32 SyBlobFormat(SyBlob *pBlob,const char *zFormat,...)` |
|        5 |  665 | `{` |
|        - |  666 | `	va_list ap;` |
|        - |  667 | `	sxu32 n;` |
...
|        - |  671 | `	}` |
|        - |  672 | `#endif` |
|    93875 |  673 | `	va_start(ap,zFormat);` |
|    93875 |  674 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    93875 |  675 | `	va_end(ap);` |
|    93875 |  676 | `	return n;` |
|        5 |  677 | `}` |
|    22834 |  678 | `PH7_PRIVATE sxu32 SyBlobFormatAp(SyBlob *pBlob,const char *zFormat,va_list ap)` |
|        5 |  679 | `{` |
|    22839 |  680 | `	sxu32 n = 0; /* cc warning */` |
|        - |  681 | `#if defined(UNTRUST)` |
|        - |  682 | `	if( SX_EMPTY_STR(zFormat) ){` |
|        - |  683 | `		return 0;` |
|        - |  684 | `	}` |
|        - |  685 | `#endif` |
|    22839 |  686 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    22839 |  687 | `	return n;` |
|        5 |  688 | `}` |
