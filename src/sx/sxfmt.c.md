...
|       - |   90 | ` */` |
|  335008 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|       5 |   92 |  |
|       - |   93 | `	/*` |
...
|  335013 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|  335013 |  153 | `  length = 0;` |
|  335013 |  154 | `  bufpt = 0;` |
| 1222163 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
| 1156065 |  156 | `    if( c!='%' ){` |
|       - |  157 | `      unsigned int amt;` |
| 1069865 |  158 | `      bufpt = (char *)zFormat;` |
| 1069865 |  159 | `      amt = 1;` |
| 1688887 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
| 1069865 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
| 1069865 |  162 | `	  if( rc != SXRET_OK ){` |
|     ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|       - |  164 | `	  }` |
| 1069865 |  165 | `      if( c==0 ){` |
|  268915 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|       - |  167 | `	  }` |
|  400475 |  168 | `    }` |
|  887155 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|     ! 0 |  170 | `      errorflag = 1;` |
...
|  887155 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  887150 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  443575 |  180 | `    do{` |
|  887313 |  181 | `      switch( c ){` |
...
|  887150 |  187 | `        default:                                       break;` |
|       - |  188 | `      }` |
|  887313 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|     ! 0 |  198 | `      c = *++zFormat;` |
|     ! 0 |  199 | `    }else{` |
|  887355 |  200 | `      while( c>='0' && c<='9' ){` |
|     203 |  201 | `        width = width*10 + c - '0';` |
|     203 |  202 | `        c = *++zFormat;` |
|       3 |  203 | `      }` |
|       - |  204 | `    }` |
|  887155 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|     ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|     ! 0 |  207 | `    }` |
|       - |  208 | `    /* Get the precision */` |
|  887155 |  209 | `	precision = -1;` |
|  887155 |  210 | `    if( c=='.' ){` |
|  266561 |  211 | `      precision = 0;` |
|  266561 |  212 | `      c = *++zFormat;` |
|  266561 |  213 | `      if( c=='*' ){` |
|  266265 |  214 | `        precision = va_arg(ap,int);` |
|  266265 |  215 | `        if( precision<0 ) precision = -precision;` |
|  266265 |  216 | `        c = *++zFormat;` |
|  133135 |  217 | `      }else{` |
...
|  887155 |  225 | `	flag_long = 0;` |
|  887155 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
...
|  887155 |  235 | `    infop = 0;` |
|  887155 |  236 | `    xtype = SXFMT_ERROR;` |
| 3948363 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 3948363 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  887155 |  239 | `        infop = &aFmt[idx];` |
|  887155 |  240 | `		xtype = infop->type;` |
|  887155 |  241 | `        break;` |
|       - |  242 | `      }` |
| 1530609 |  243 | `    }` |
...
|  175413 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|  175413 |  319 | `            ulongvalue = ulongvalue/base;` |
|  175413 |  320 | `          }while( ulongvalue>0 );` |
|       - |  321 | `        }` |
|   57565 |  322 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|   57907 |  323 | `        for(idx=precision-length; idx>0; idx--){` |
...
|   10038 |  509 | `        bufpt = buf;` |
|   10038 |  510 | `        break;` |
|  133763 |  511 | `      case SXFMT_STRING:` |
|  267531 |  512 | `        bufpt = va_arg(ap,char*);` |
|  267531 |  513 | `        if( bufpt==0 ){` |
|     ! 0 |  514 | `          bufpt = " ";` |
|     ! 0 |  515 | `		  length = (int)sizeof(" ")-1;` |
|     ! 0 |  516 | `		  break;` |
|       - |  517 | `        }` |
|  267531 |  518 | `		length = precision;` |
|  267531 |  519 | `		if( precision < 0 ){` |
|       - |  520 | `			/* Symisc extension */` |
|    1273 |  521 | `			length = (int)SyStrlen(bufpt);` |
|     634 |  522 | `		}` |
|  267531 |  523 | `        if( precision>=0 && precision<length ) length = precision;` |
|  267531 |  524 | `        break;` |
|  275860 |  525 | `	case SXFMT_RAWSTR:{` |
|       - |  526 | `		/* Symisc extension */` |
|  551725 |  527 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  551725 |  528 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|     ! 0 |  529 | `			 bufpt = " ";` |
|     ! 0 |  530 | `		     length = (int)sizeof(char);` |
|     ! 0 |  531 | `		     break;` |
|       - |  532 | `		}` |
|  551725 |  533 | `		bufpt = (char *)pStr->zString;` |
|  551725 |  534 | `		length = (int)pStr->nByte;` |
|  551725 |  535 | `		break;` |
|       - |  536 | `					  }` |
...
|       - |  547 | `    ** the output.` |
|       - |  548 | `    */` |
|  887155 |  549 | `    if( !flag_leftjustify ){` |
|       - |  550 | `      register int nspace;` |
|  887155 |  551 | `      nspace = width-length;` |
|  887155 |  552 | `      if( nspace>0 ){` |
...
|      18 |  566 | `      }` |
|  443575 |  567 | `    }` |
|  887155 |  568 | `    if( length>0 ){` |
|  887131 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  887131 |  570 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|       - |  572 | `		}` |
|  443563 |  573 | `    }` |
|  887155 |  574 | `    if( flag_leftjustify ){` |
...
|     ! 0 |  591 | `      }` |
|     ! 0 |  592 | `    }` |
|  443580 |  593 | `  }/* End for loop over the format string */` |
|   66103 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|  167509 |  595 |  |
|       - |  596 | `/* SPDX-SnippetEnd */` |
| 1957022 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|       5 |  598 |  |
| 1957027 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 1957027 |  600 | `	sxi32 rc = SXERR_ABORT;` |
| 1957027 |  601 | `	switch(pConsumer->nType){` |
...
|     157 |  605 | `			break;` |
|  978433 |  606 | `	case SXFMT_CONS_BLOB:` |
|       - |  607 | `			/* Blob consumer */` |
| 1956871 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 1956866 |  609 | `			break;` |
|     ! 0 |  610 | `		default:` |
...
| 1957027 |  615 | `	pConsumer->nLen += nLen;` |
| 1957027 |  616 | `	pConsumer->rc = rc;` |
| 1957027 |  617 | `	return rc;` |
|       5 |  618 |  |
|  335008 |  619 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|       5 |  620 |  |
|       - |  621 | `	SyFmtConsumer sCons;` |
|  335013 |  622 | `	sCons.nType = nType;` |
|  335013 |  623 | `	sCons.rc = SXRET_OK;` |
|  335013 |  624 | `	sCons.nLen = 0;` |
|  335013 |  625 | `	if( pOutLen ){` |
|   68693 |  626 | `		*pOutLen = 0;` |
|   34344 |  627 | `	}` |
|  335013 |  628 | `	switch(nType){` |
...
|      13 |  637 | `		break;` |
|  167498 |  638 | `		case SXFMT_CONS_BLOB:` |
|  335001 |  639 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  335001 |  640 | `			break;` |
|     ! 0 |  641 | `		default:` |
|     ! 0 |  642 | `			return SXERR_UNKNOWN;` |
|       - |  643 | `	}` |
|  335013 |  644 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  335013 |  645 | `	if( pOutLen ){` |
|   68693 |  646 | `		*pOutLen = sCons.nLen;` |
|   34344 |  647 | `	}` |
|  335013 |  648 | `	return sCons.rc;` |
|  167509 |  649 |  |
...
|    1525 |  687 | `	return n;` |
|       5 |  688 |  |
|  266308 |  689 | `PH7_PRIVATE sxu32 SyBufferFormat(char *zBuf,sxu32 nLen,const char *zFormat,...)` |
|       5 |  690 |  |
|       - |  691 | `	SyBlob sBlob;` |
|       - |  692 | `	va_list ap;` |
|       - |  693 | `	sxu32 n;` |
...
|       - |  697 | `	}` |
|       - |  698 | `#endif` |
|  266313 |  699 | `	if( SXRET_OK != SyBlobInitFromBuf(&sBlob,zBuf,nLen - 1) ){` |
|     ! 0 |  700 | `		return 0;` |
|       - |  701 | `	}` |
|  266313 |  702 | `	va_start(ap,zFormat);` |
|  266313 |  703 | `	FormatMount(SXFMT_CONS_BLOB,&sBlob,0,0,0,zFormat,ap);` |
|  266313 |  704 | `	va_end(ap);` |
|  266313 |  705 | `	n = SyBlobLength(&sBlob);` |
|       - |  706 | `	/* Append the null terminator */` |
|  266313 |  707 | `	sBlob.mByte++;` |
|  266313 |  708 | `	SyBlobAppend(&sBlob,"\0",sizeof(char));` |
|  266313 |  709 | `	return n;` |
|  133159 |  710 |  |
|       - |  711 |  |
