...
|        - |   90 | ` */` |
|  2776234 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|        5 |   92 | `{` |
|        - |   93 | `	/*` |
...
|  2776239 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|        - |  151 | `  int rc;` |
|        - |  152 |  |
|  2776239 |  153 | `  length = 0;` |
|  2776239 |  154 | `  bufpt = 0;` |
| 10929147 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
| 10832709 |  156 | `    if( c!='%' ){` |
|        - |  157 | `      unsigned int amt;` |
| 10697027 |  158 | `      bufpt = (char *)zFormat;` |
| 10697027 |  159 | `      amt = 1;` |
| 16865363 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
| 10697027 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
| 10697027 |  162 | `	  if( rc != SXRET_OK ){` |
|      ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  164 | `	  }` |
| 10697027 |  165 | `      if( c==0 ){` |
|  2679801 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|        - |  167 | `	  }` |
|  4008613 |  168 | `    }` |
|  8152913 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|      ! 0 |  170 | `      errorflag = 1;` |
...
|  8152913 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  8152908 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  4076454 |  180 | `    do{` |
|  8154265 |  181 | `      switch( c ){` |
...
|  8152908 |  187 | `        default:                                       break;` |
|        - |  188 | `      }` |
|  8154265 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|      ! 0 |  198 | `      c = *++zFormat;` |
|      ! 0 |  199 | `    }else{` |
|  8154309 |  200 | `      while( c>='0' && c<='9' ){` |
|     1399 |  201 | `        width = width*10 + c - '0';` |
|     1399 |  202 | `        c = *++zFormat;` |
|        3 |  203 | `      }` |
|        - |  204 | `    }` |
|  8152913 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|      ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|      ! 0 |  207 | `    }` |
|        - |  208 | `    /* Get the precision */` |
|  8152913 |  209 | `	precision = -1;` |
|  8152913 |  210 | `    if( c=='.' ){` |
|  2650119 |  211 | `      precision = 0;` |
|  2650119 |  212 | `      c = *++zFormat;` |
|  2650119 |  213 | `      if( c=='*' ){` |
|  2650107 |  214 | `        precision = va_arg(ap,int);` |
|  2650107 |  215 | `        if( precision<0 ) precision = -precision;` |
|  2650107 |  216 | `        c = *++zFormat;` |
|  1325056 |  217 | `      }else{` |
...
|  8152913 |  225 | `	flag_long = 0;` |
|  8152913 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
...
|  8152913 |  235 | `    infop = 0;` |
|  8152913 |  236 | `    xtype = SXFMT_ERROR;` |
| 37591615 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 37591615 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  8152913 |  239 | `        infop = &aFmt[idx];` |
|  8152913 |  240 | `		xtype = infop->type;` |
|  8152913 |  241 | `        break;` |
|        - |  242 | `      }` |
| 14719356 |  243 | `    }` |
...
|        - |  263 | `    */` |
|  8152913 |  264 | `    switch( xtype ){` |
|    36138 |  265 | `      case SXFMT_RADIX:` |
|    72281 |  266 | `        if( flag_long > 0 ){` |
...
|        - |  272 | `			}` |
|    31246 |  273 | `		}else{` |
|     9799 |  274 | `			if( infop->flags & SXFLAG_SIGNED ){` |
...
|    72281 |  281 | `      if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|        - |  282 | `#if 1` |
|        - |  283 | `        /* For the format %#x, the value zero is printed "0" not "0x0".` |
|        - |  284 | `        ** I think this is stupid.*/` |
|    72281 |  285 | `        if( longvalue==0 ) flag_alternateform = 0;` |
|        - |  286 | `#else` |
...
|        - |  290 | `#endif` |
|    72281 |  291 | `        if( infop->flags & SXFLAG_SIGNED ){` |
|    67631 |  292 | `          if( longvalue<0 ){` |
...
|      234 |  297 | `            prefix = '-';` |
|      119 |  298 | `          }else{` |
|    67401 |  299 | `            ulongvalue = (sxu64)longvalue;` |
|    67401 |  300 | `            if( flag_plussign )        prefix = '+';` |
|    67401 |  301 | `            else if( flag_blanksign )  prefix = ' ';` |
|    67401 |  302 | `            else                       prefix = 0;` |
|        - |  303 | `          }` |
|    33818 |  304 | `        }else{` |
|     4655 |  305 | `			ulongvalue = (sxu64)longvalue; /* print the full unsigned value as-is */` |
|     4655 |  306 | `			prefix = 0;` |
|        - |  307 | `		}` |
|    72281 |  308 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|     1340 |  309 | `          precision = width-(prefix!=0);` |
|      669 |  310 | `        }` |
|    72281 |  311 | `        bufpt = &buf[SXFMT_BUFSIZ-1];` |
|        - |  312 | `        {` |
|        - |  313 | `          register char *cset;      /* Use registers for speed */` |
|        - |  314 | `          register int base;` |
|    72281 |  315 | `          cset = infop->charset;` |
|    72281 |  316 | `          base = infop->base;` |
|    36138 |  317 | `          do{                                           /* Convert to ascii */` |
|   204378 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|   204378 |  319 | `            ulongvalue = ulongvalue/base;` |
|   204378 |  320 | `          }while( ulongvalue>0 );` |
|        - |  321 | `        }` |
|    72281 |  322 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    73381 |  323 | `        for(idx=precision-length; idx>0; idx--){` |
|     1102 |  324 | `          *(--bufpt) = '0';                             /* Zero pad */` |
|      552 |  325 | `        }` |
|    72281 |  326 | `        if( prefix ) *(--bufpt) = prefix;               /* Add sign */` |
|    72281 |  327 | `        if( flag_alternateform && infop->prefix ){      /* Add "0" or "0x" */` |
|        - |  328 | `          char *pre, x;` |
...
|        1 |  332 | `          }` |
|        1 |  333 | `        }` |
|    72281 |  334 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    72281 |  335 | `        break;` |
...
|      ! 0 |  496 | `        length = 1;` |
|      ! 0 |  497 | `        break;` |
|     4972 |  498 | `      case SXFMT_CHARX:` |
|     9949 |  499 | `        c = va_arg(ap,int);` |
|     9949 |  500 | `		buf[0] = (char)c;` |
|        - |  501 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|     9949 |  502 | `		if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|     9949 |  503 | `        if( precision>=0 ){` |
...
|     9949 |  509 | `        bufpt = buf;` |
|     9949 |  510 | `        break;` |
|  1371445 |  511 | `      case SXFMT_STRING:` |
|  2742895 |  512 | `        bufpt = va_arg(ap,char*);` |
|  2742895 |  513 | `        if( bufpt==0 ){` |
|      ! 0 |  514 | `          bufpt = " ";` |
|      ! 0 |  515 | `		  length = (int)sizeof(" ")-1;` |
|      ! 0 |  516 | `		  break;` |
|        - |  517 | `        }` |
|  2742895 |  518 | `		length = precision;` |
|  2742895 |  519 | `		if( precision < 0 ){` |
|        - |  520 | `			/* Symisc extension */` |
|    92781 |  521 | `			length = (int)SyStrlen(bufpt);` |
|    46388 |  522 | `		}` |
|  2742895 |  523 | `        if( precision>=0 && precision<length ) length = precision;` |
|  2742895 |  524 | `        break;` |
|  2663885 |  525 | `	case SXFMT_RAWSTR:{` |
|        - |  526 | `		/* Symisc extension */` |
|  5327775 |  527 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  5327775 |  528 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|      ! 0 |  529 | `			 bufpt = " ";` |
|      ! 0 |  530 | `		     length = (int)sizeof(char);` |
|      ! 0 |  531 | `		     break;` |
|        - |  532 | `		}` |
|  5327775 |  533 | `		bufpt = (char *)pStr->zString;` |
|  5327775 |  534 | `		length = (int)pStr->nByte;` |
|  5327775 |  535 | `		break;` |
|        - |  536 | `					  }` |
...
|        - |  547 | `    ** the output.` |
|        - |  548 | `    */` |
|  8152913 |  549 | `    if( !flag_leftjustify ){` |
|        - |  550 | `      register int nspace;` |
|  8152913 |  551 | `      nspace = width-length;` |
|  8152913 |  552 | `      if( nspace>0 ){` |
...
|       18 |  566 | `      }` |
|  4076454 |  567 | `    }` |
|  8152913 |  568 | `    if( length>0 ){` |
|  8152571 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  8152571 |  570 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  572 | `		}` |
|  4076283 |  573 | `    }` |
|  8152913 |  574 | `    if( flag_leftjustify ){` |
...
|      ! 0 |  591 | `      }` |
|      ! 0 |  592 | `    }` |
|  4076459 |  593 | `  }/* End for loop over the format string */` |
|    96443 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|  1388122 |  595 | `}` |
|        - |  596 | `/* SPDX-SnippetEnd */` |
| 18849624 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|        5 |  598 | `{` |
| 18849629 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 18849629 |  600 | `	sxi32 rc = SXERR_ABORT;` |
| 18849629 |  601 | `	switch(pConsumer->nType){` |
...
|      181 |  605 | `			break;` |
|  9424722 |  606 | `	case SXFMT_CONS_BLOB:` |
|        - |  607 | `			/* Blob consumer */` |
| 18849449 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 18849444 |  609 | `			break;` |
|      ! 0 |  610 | `		default:` |
...
| 18849629 |  615 | `	pConsumer->nLen += nLen;` |
| 18849629 |  616 | `	pConsumer->rc = rc;` |
| 18849629 |  617 | `	return rc;` |
|        5 |  618 | `}` |
|  2776234 |  619 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|        5 |  620 | `{` |
|        - |  621 | `	SyFmtConsumer sCons;` |
|  2776239 |  622 | `	sCons.nType = nType;` |
|  2776239 |  623 | `	sCons.rc = SXRET_OK;` |
|  2776239 |  624 | `	sCons.nLen = 0;` |
|  2776239 |  625 | `	if( pOutLen ){` |
|   121423 |  626 | `		*pOutLen = 0;` |
|    60709 |  627 | `	}` |
|  2776239 |  628 | `	switch(nType){` |
...
|       13 |  637 | `		break;` |
|  1388111 |  638 | `		case SXFMT_CONS_BLOB:` |
|  2776227 |  639 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  2776227 |  640 | `			break;` |
|      ! 0 |  641 | `		default:` |
|      ! 0 |  642 | `			return SXERR_UNKNOWN;` |
|        - |  643 | `	}` |
|  2776239 |  644 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  2776239 |  645 | `	if( pOutLen ){` |
|   121423 |  646 | `		*pOutLen = sCons.nLen;` |
|    60709 |  647 | `	}` |
|  2776239 |  648 | `	return sCons.rc;` |
|  1388122 |  649 | `}` |
...
|       13 |  662 | `	return rc;` |
|        1 |  663 | `}` |
|    97316 |  664 | `PH7_PRIVATE sxu32 SyBlobFormat(SyBlob *pBlob,const char *zFormat,...)` |
|        5 |  665 | `{` |
|        - |  666 | `	va_list ap;` |
|        - |  667 | `	sxu32 n;` |
...
|        - |  671 | `	}` |
|        - |  672 | `#endif` |
|    97321 |  673 | `	va_start(ap,zFormat);` |
|    97321 |  674 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    97321 |  675 | `	va_end(ap);` |
|    97321 |  676 | `	return n;` |
|        5 |  677 | `}` |
|    24102 |  678 | `PH7_PRIVATE sxu32 SyBlobFormatAp(SyBlob *pBlob,const char *zFormat,va_list ap)` |
|        5 |  679 | `{` |
|    24107 |  680 | `	sxu32 n = 0; /* cc warning */` |
|        - |  681 | `#if defined(UNTRUST)` |
|        - |  682 | `	if( SX_EMPTY_STR(zFormat) ){` |
|        - |  683 | `		return 0;` |
|        - |  684 | `	}` |
|        - |  685 | `#endif` |
|    24107 |  686 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    24107 |  687 | `	return n;` |
|        5 |  688 | `}` |
|  2654804 |  689 | `PH7_PRIVATE sxu32 SyBufferFormat(char *zBuf,sxu32 nLen,const char *zFormat,...)` |
|        5 |  690 | `{` |
|        - |  691 | `	SyBlob sBlob;` |
|        - |  692 | `	va_list ap;` |
|        - |  693 | `	sxu32 n;` |
...
|        - |  697 | `	}` |
|        - |  698 | `#endif` |
|  2654809 |  699 | `	if( SXRET_OK != SyBlobInitFromBuf(&sBlob,zBuf,nLen - 1) ){` |
|      ! 0 |  700 | `		return 0;` |
|        - |  701 | `	}` |
|  2654809 |  702 | `	va_start(ap,zFormat);` |
|  2654809 |  703 | `	FormatMount(SXFMT_CONS_BLOB,&sBlob,0,0,0,zFormat,ap);` |
|  2654809 |  704 | `	va_end(ap);` |
|  2654809 |  705 | `	n = SyBlobLength(&sBlob);` |
|        - |  706 | `	/* Append the null terminator */` |
|  2654809 |  707 | `	sBlob.mByte++;` |
|  2654809 |  708 | `	SyBlobAppend(&sBlob,"\0",sizeof(char));` |
|  2654809 |  709 | `	return n;` |
|  1327407 |  710 | `}` |
|        - |  711 |  |
