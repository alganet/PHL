...
|        - |   90 | ` */` |
|  3022482 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|        5 |   92 | `{` |
|        - |   93 | `	/*` |
...
|  3022487 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|        - |  151 | `  int rc;` |
|        - |  152 |  |
|  3022487 |  153 | `  length = 0;` |
|  3022487 |  154 | `  bufpt = 0;` |
| 11918639 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
| 11823731 |  156 | `    if( c!='%' ){` |
|        - |  157 | `      unsigned int amt;` |
| 11691677 |  158 | `      bufpt = (char *)zFormat;` |
| 11691677 |  159 | `      amt = 1;` |
| 18345927 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
| 11691677 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
| 11691677 |  162 | `	  if( rc != SXRET_OK ){` |
|      ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  164 | `	  }` |
| 11691677 |  165 | `      if( c==0 ){` |
|  2927579 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|        - |  167 | `	  }` |
|  4382049 |  168 | `    }` |
|  8896157 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|      ! 0 |  170 | `      errorflag = 1;` |
...
|  8896157 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  8896152 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  4448076 |  180 | `    do{` |
|  8897491 |  181 | `      switch( c ){` |
...
|  8896152 |  187 | `        default:                                       break;` |
|        - |  188 | `      }` |
|  8897491 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|      ! 0 |  198 | `      c = *++zFormat;` |
|      ! 0 |  199 | `    }else{` |
|  8897529 |  200 | `      while( c>='0' && c<='9' ){` |
|     1375 |  201 | `        width = width*10 + c - '0';` |
|     1375 |  202 | `        c = *++zFormat;` |
|        3 |  203 | `      }` |
|        - |  204 | `    }` |
|  8896157 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|      ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|      ! 0 |  207 | `    }` |
|        - |  208 | `    /* Get the precision */` |
|  8896157 |  209 | `	precision = -1;` |
|  8896157 |  210 | `    if( c=='.' ){` |
...
|  8896157 |  225 | `	flag_long = 0;` |
|  8896157 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
...
|  8896157 |  235 | `    infop = 0;` |
|  8896157 |  236 | `    xtype = SXFMT_ERROR;` |
| 41063181 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 41063181 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  8896157 |  239 | `        infop = &aFmt[idx];` |
|  8896157 |  240 | `		xtype = infop->type;` |
|  8896157 |  241 | `        break;` |
|        - |  242 | `      }` |
| 16083517 |  243 | `    }` |
...
|      235 |  297 | `            prefix = '-';` |
|      119 |  298 | `          }else{` |
|    67174 |  299 | `            ulongvalue = (sxu64)longvalue;` |
|    67174 |  300 | `            if( flag_plussign )        prefix = '+';` |
|    67174 |  301 | `            else if( flag_blanksign )  prefix = ' ';` |
|    67174 |  302 | `            else                       prefix = 0;` |
|        - |  303 | `          }` |
|    33705 |  304 | `        }else{` |
...
|   202277 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|   202277 |  319 | `            ulongvalue = ulongvalue/base;` |
|   202277 |  320 | `          }while( ulongvalue>0 );` |
|        - |  321 | `        }` |
|    71261 |  322 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    72355 |  323 | `        for(idx=precision-length; idx>0; idx--){` |
|     1096 |  324 | `          *(--bufpt) = '0';                             /* Zero pad */` |
|      547 |  325 | `        }` |
...
|      ! 0 |  496 | `        length = 1;` |
|      ! 0 |  497 | `        break;` |
|     4679 |  498 | `      case SXFMT_CHARX:` |
|     9362 |  499 | `        c = va_arg(ap,int);` |
|     9362 |  500 | `		buf[0] = (char)c;` |
|        - |  501 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|     9362 |  502 | `		if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|     9362 |  503 | `        if( precision>=0 ){` |
...
|     9362 |  509 | `        bufpt = buf;` |
|     9362 |  510 | `        break;` |
|  1494971 |  511 | `      case SXFMT_STRING:` |
|  2989947 |  512 | `        bufpt = va_arg(ap,char*);` |
|  2989947 |  513 | `        if( bufpt==0 ){` |
|      ! 0 |  514 | `          bufpt = " ";` |
|      ! 0 |  515 | `		  length = (int)sizeof(" ")-1;` |
|      ! 0 |  516 | `		  break;` |
|        - |  517 | `        }` |
|  2989947 |  518 | `		length = precision;` |
|  2989947 |  519 | `		if( precision < 0 ){` |
|        - |  520 | `			/* Symisc extension */` |
|    90299 |  521 | `			length = (int)SyStrlen(bufpt);` |
|    45147 |  522 | `		}` |
|  2989947 |  523 | `        if( precision>=0 && precision<length ) length = precision;` |
|  2989947 |  524 | `        break;` |
|  2912798 |  525 | `	case SXFMT_RAWSTR:{` |
|        - |  526 | `		/* Symisc extension */` |
|  5825601 |  527 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  5825601 |  528 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|      ! 0 |  529 | `			 bufpt = " ";` |
|      ! 0 |  530 | `		     length = (int)sizeof(char);` |
|      ! 0 |  531 | `		     break;` |
|        - |  532 | `		}` |
|  5825601 |  533 | `		bufpt = (char *)pStr->zString;` |
|  5825601 |  534 | `		length = (int)pStr->nByte;` |
|  5825601 |  535 | `		break;` |
|        - |  536 | `					  }` |
...
|        - |  547 | `    ** the output.` |
|        - |  548 | `    */` |
|  8896157 |  549 | `    if( !flag_leftjustify ){` |
|        - |  550 | `      register int nspace;` |
|  8896157 |  551 | `      nspace = width-length;` |
|  8896157 |  552 | `      if( nspace>0 ){` |
...
|       18 |  566 | `      }` |
|  4448076 |  567 | `    }` |
|  8896157 |  568 | `    if( length>0 ){` |
|  8895827 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  8895827 |  570 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  572 | `		}` |
|  4447911 |  573 | `    }` |
|  8896157 |  574 | `    if( flag_leftjustify ){` |
...
|      ! 0 |  591 | `      }` |
|      ! 0 |  592 | `    }` |
|  4448081 |  593 | `  }/* End for loop over the format string */` |
|    94913 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|  1511246 |  595 | `}` |
|        - |  596 | `/* SPDX-SnippetEnd */` |
| 20587530 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|        5 |  598 | `{` |
| 20587535 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 20587535 |  600 | `	sxi32 rc = SXERR_ABORT;` |
| 20587535 |  601 | `	switch(pConsumer->nType){` |
...
|      181 |  605 | `			break;` |
| 10293675 |  606 | `	case SXFMT_CONS_BLOB:` |
|        - |  607 | `			/* Blob consumer */` |
| 20587355 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 20587350 |  609 | `			break;` |
|      ! 0 |  610 | `		default:` |
...
| 20587535 |  615 | `	pConsumer->nLen += nLen;` |
| 20587535 |  616 | `	pConsumer->rc = rc;` |
| 20587535 |  617 | `	return rc;` |
|        5 |  618 | `}` |
|  3022482 |  619 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|        5 |  620 | `{` |
|        - |  621 | `	SyFmtConsumer sCons;` |
|  3022487 |  622 | `	sCons.nType = nType;` |
|  3022487 |  623 | `	sCons.rc = SXRET_OK;` |
|  3022487 |  624 | `	sCons.nLen = 0;` |
|  3022487 |  625 | `	if( pOutLen ){` |
|   118473 |  626 | `		*pOutLen = 0;` |
|    59234 |  627 | `	}` |
|  3022487 |  628 | `	switch(nType){` |
...
|       13 |  637 | `		break;` |
|  1511235 |  638 | `		case SXFMT_CONS_BLOB:` |
|  3022475 |  639 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  3022475 |  640 | `			break;` |
|      ! 0 |  641 | `		default:` |
|      ! 0 |  642 | `			return SXERR_UNKNOWN;` |
|        - |  643 | `	}` |
|  3022487 |  644 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  3022487 |  645 | `	if( pOutLen ){` |
|   118473 |  646 | `		*pOutLen = sCons.nLen;` |
|    59234 |  647 | `	}` |
|  3022487 |  648 | `	return sCons.rc;` |
|  1511246 |  649 | `}` |
...
|    95161 |  676 | `	return n;` |
|        5 |  677 | `}` |
|    23312 |  678 | `PH7_PRIVATE sxu32 SyBlobFormatAp(SyBlob *pBlob,const char *zFormat,va_list ap)` |
|        5 |  679 | `{` |
|    23317 |  680 | `	sxu32 n = 0; /* cc warning */` |
|        - |  681 | `#if defined(UNTRUST)` |
|        - |  682 | `	if( SX_EMPTY_STR(zFormat) ){` |
|        - |  683 | `		return 0;` |
|        - |  684 | `	}` |
|        - |  685 | `#endif` |
|    23317 |  686 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    23317 |  687 | `	return n;` |
|        5 |  688 | `}` |
