...
|        - |   90 | ` */` |
|  2519684 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|        5 |   92 | `{` |
|        - |   93 | `	/*` |
...
|  2519689 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|        - |  151 | `  int rc;` |
|        - |  152 |  |
|  2519689 |  153 | `  length = 0;` |
|  2519689 |  154 | `  bufpt = 0;` |
|  9909003 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
|  9815555 |  156 | `    if( c!='%' ){` |
|        - |  157 | `      unsigned int amt;` |
|  9683769 |  158 | `      bufpt = (char *)zFormat;` |
|  9683769 |  159 | `      amt = 1;` |
| 15331043 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
|  9683769 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
|  9683769 |  162 | `	  if( rc != SXRET_OK ){` |
|      ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  164 | `	  }` |
|  9683769 |  165 | `      if( c==0 ){` |
|  2426241 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|        - |  167 | `	  }` |
|  3628764 |  168 | `    }` |
|  7389319 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|      ! 0 |  170 | `      errorflag = 1;` |
...
|  7389319 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  7389314 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  3694657 |  180 | `    do{` |
|  7390671 |  181 | `      switch( c ){` |
...
|  7389314 |  187 | `        default:                                       break;` |
|        - |  188 | `      }` |
|  7390671 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|      ! 0 |  198 | `      c = *++zFormat;` |
|      ! 0 |  199 | `    }else{` |
|  7390715 |  200 | `      while( c>='0' && c<='9' ){` |
|     1399 |  201 | `        width = width*10 + c - '0';` |
|     1399 |  202 | `        c = *++zFormat;` |
|        3 |  203 | `      }` |
|        - |  204 | `    }` |
|  7389319 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|      ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|      ! 0 |  207 | `    }` |
|        - |  208 | `    /* Get the precision */` |
|  7389319 |  209 | `	precision = -1;` |
|  7389319 |  210 | `    if( c=='.' ){` |
...
|  7389319 |  225 | `	flag_long = 0;` |
|  7389319 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
|    60179 |  227 | `      flag_long = (c == 'q') ? 2 : 1;` |
|    60179 |  228 | `      c = *++zFormat;` |
|    60179 |  229 | `	  if( c == 'l' ){` |
...
|  7389319 |  235 | `    infop = 0;` |
|  7389319 |  236 | `    xtype = SXFMT_ERROR;` |
| 34042421 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 34042421 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  7389319 |  239 | `        infop = &aFmt[idx];` |
|  7389319 |  240 | `		xtype = infop->type;` |
|  7389319 |  241 | `        break;` |
|        - |  242 | `      }` |
| 13326556 |  243 | `    }` |
...
|        - |  263 | `    */` |
|  7389319 |  264 | `    switch( xtype ){` |
|    34856 |  265 | `      case SXFMT_RADIX:` |
|    69717 |  266 | `        if( flag_long > 0 ){` |
|    60179 |  267 | `			if( flag_long > 1 ){` |
|        - |  268 | `				/* BSD quad: expect a 64-bit integer */` |
|    60167 |  269 | `				longvalue = va_arg(ap,sxi64);` |
|    30086 |  270 | `			}else{` |
...
|    69717 |  281 | `      if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|        - |  282 | `#if 1` |
|        - |  283 | `        /* For the format %#x, the value zero is printed "0" not "0x0".` |
|        - |  284 | `        ** I think this is stupid.*/` |
|    69717 |  285 | `        if( longvalue==0 ) flag_alternateform = 0;` |
|        - |  286 | `#else` |
...
|        - |  290 | `#endif` |
|    69717 |  291 | `        if( infop->flags & SXFLAG_SIGNED ){` |
|    65193 |  292 | `          if( longvalue<0 ){` |
...
|      221 |  297 | `            prefix = '-';` |
|      112 |  298 | `          }else{` |
|    64975 |  299 | `            ulongvalue = (sxu64)longvalue;` |
|    64975 |  300 | `            if( flag_plussign )        prefix = '+';` |
|    64975 |  301 | `            else if( flag_blanksign )  prefix = ' ';` |
|    64975 |  302 | `            else                       prefix = 0;` |
|        - |  303 | `          }` |
|    32599 |  304 | `        }else{` |
|     4529 |  305 | `			ulongvalue = (sxu64)longvalue; /* print the full unsigned value as-is */` |
|     4529 |  306 | `			prefix = 0;` |
|        - |  307 | `		}` |
|    69717 |  308 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|     1340 |  309 | `          precision = width-(prefix!=0);` |
|      669 |  310 | `        }` |
|    69717 |  311 | `        bufpt = &buf[SXFMT_BUFSIZ-1];` |
|        - |  312 | `        {` |
|        - |  313 | `          register char *cset;      /* Use registers for speed */` |
|        - |  314 | `          register int base;` |
|    69717 |  315 | `          cset = infop->charset;` |
|    69717 |  316 | `          base = infop->base;` |
|    34856 |  317 | `          do{                                           /* Convert to ascii */` |
|   197596 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|   197596 |  319 | `            ulongvalue = ulongvalue/base;` |
|   197596 |  320 | `          }while( ulongvalue>0 );` |
|        - |  321 | `        }` |
|    69717 |  322 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    70832 |  323 | `        for(idx=precision-length; idx>0; idx--){` |
|     1117 |  324 | `          *(--bufpt) = '0';                             /* Zero pad */` |
|      559 |  325 | `        }` |
|    69717 |  326 | `        if( prefix ) *(--bufpt) = prefix;               /* Add sign */` |
|    69717 |  327 | `        if( flag_alternateform && infop->prefix ){      /* Add "0" or "0x" */` |
|        - |  328 | `          char *pre, x;` |
...
|        1 |  332 | `          }` |
|        1 |  333 | `        }` |
|    69717 |  334 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    69717 |  335 | `        break;` |
...
|      ! 0 |  496 | `        length = 1;` |
|      ! 0 |  497 | `        break;` |
|     4879 |  498 | `      case SXFMT_CHARX:` |
|     9763 |  499 | `        c = va_arg(ap,int);` |
|     9763 |  500 | `		buf[0] = (char)c;` |
|        - |  501 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|     9763 |  502 | `		if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|     9763 |  503 | `        if( precision>=0 ){` |
...
|     9763 |  509 | `        bufpt = buf;` |
|     9763 |  510 | `        break;` |
|  1243945 |  511 | `      case SXFMT_STRING:` |
|  2487895 |  512 | `        bufpt = va_arg(ap,char*);` |
|  2487895 |  513 | `        if( bufpt==0 ){` |
|      ! 0 |  514 | `          bufpt = " ";` |
|      ! 0 |  515 | `		  length = (int)sizeof(" ")-1;` |
|      ! 0 |  516 | `		  break;` |
|        - |  517 | `        }` |
|  2487895 |  518 | `		length = precision;` |
|  2487895 |  519 | `		if( precision < 0 ){` |
|        - |  520 | `			/* Symisc extension */` |
|    90461 |  521 | `			length = (int)SyStrlen(bufpt);` |
|    45228 |  522 | `		}` |
|  2487895 |  523 | `        if( precision>=0 && precision<length ) length = precision;` |
|  2487895 |  524 | `        break;` |
|  2410963 |  525 | `	case SXFMT_RAWSTR:{` |
|        - |  526 | `		/* Symisc extension */` |
|  4821931 |  527 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  4821931 |  528 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|      ! 0 |  529 | `			 bufpt = " ";` |
|      ! 0 |  530 | `		     length = (int)sizeof(char);` |
|      ! 0 |  531 | `		     break;` |
|        - |  532 | `		}` |
|  4821931 |  533 | `		bufpt = (char *)pStr->zString;` |
|  4821931 |  534 | `		length = (int)pStr->nByte;` |
|  4821931 |  535 | `		break;` |
|        - |  536 | `					  }` |
...
|        - |  547 | `    ** the output.` |
|        - |  548 | `    */` |
|  7389319 |  549 | `    if( !flag_leftjustify ){` |
|        - |  550 | `      register int nspace;` |
|  7389319 |  551 | `      nspace = width-length;` |
|  7389319 |  552 | `      if( nspace>0 ){` |
...
|       18 |  566 | `      }` |
|  3694657 |  567 | `    }` |
|  7389319 |  568 | `    if( length>0 ){` |
|  7388977 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  7388977 |  570 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  572 | `		}` |
|  3694486 |  573 | `    }` |
|  7389319 |  574 | `    if( flag_leftjustify ){` |
...
|      ! 0 |  591 | `      }` |
|      ! 0 |  592 | `    }` |
|  3694662 |  593 | `  }/* End for loop over the format string */` |
|    93453 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|  1259847 |  595 | `}` |
|        - |  596 | `/* SPDX-SnippetEnd */` |
| 17072772 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|        5 |  598 | `{` |
| 17072777 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 17072777 |  600 | `	sxi32 rc = SXERR_ABORT;` |
| 17072777 |  601 | `	switch(pConsumer->nType){` |
...
|      181 |  605 | `			break;` |
|  8536296 |  606 | `	case SXFMT_CONS_BLOB:` |
|        - |  607 | `			/* Blob consumer */` |
| 17072597 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 17072592 |  609 | `			break;` |
|      ! 0 |  610 | `		default:` |
...
| 17072777 |  615 | `	pConsumer->nLen += nLen;` |
| 17072777 |  616 | `	pConsumer->rc = rc;` |
| 17072777 |  617 | `	return rc;` |
|        5 |  618 | `}` |
|  2519684 |  619 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|        5 |  620 | `{` |
|        - |  621 | `	SyFmtConsumer sCons;` |
|  2519689 |  622 | `	sCons.nType = nType;` |
|  2519689 |  623 | `	sCons.rc = SXRET_OK;` |
|  2519689 |  624 | `	sCons.nLen = 0;` |
|  2519689 |  625 | `	if( pOutLen ){` |
|   117769 |  626 | `		*pOutLen = 0;` |
|    58882 |  627 | `	}` |
|  2519689 |  628 | `	switch(nType){` |
...
|       13 |  637 | `		break;` |
|  1259836 |  638 | `		case SXFMT_CONS_BLOB:` |
|  2519677 |  639 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  2519677 |  640 | `			break;` |
|      ! 0 |  641 | `		default:` |
|      ! 0 |  642 | `			return SXERR_UNKNOWN;` |
|        - |  643 | `	}` |
|  2519689 |  644 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  2519689 |  645 | `	if( pOutLen ){` |
|   117769 |  646 | `		*pOutLen = sCons.nLen;` |
|    58882 |  647 | `	}` |
|  2519689 |  648 | `	return sCons.rc;` |
|  1259847 |  649 | `}` |
...
|       13 |  662 | `	return rc;` |
|        1 |  663 | `}` |
|    94214 |  664 | `PH7_PRIVATE sxu32 SyBlobFormat(SyBlob *pBlob,const char *zFormat,...)` |
|        5 |  665 | `{` |
|        - |  666 | `	va_list ap;` |
|        - |  667 | `	sxu32 n;` |
...
|        - |  671 | `	}` |
|        - |  672 | `#endif` |
|    94219 |  673 | `	va_start(ap,zFormat);` |
|    94219 |  674 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    94219 |  675 | `	va_end(ap);` |
|    94219 |  676 | `	return n;` |
|        5 |  677 | `}` |
|    23550 |  678 | `PH7_PRIVATE sxu32 SyBlobFormatAp(SyBlob *pBlob,const char *zFormat,va_list ap)` |
|        5 |  679 | `{` |
|    23555 |  680 | `	sxu32 n = 0; /* cc warning */` |
|        - |  681 | `#if defined(UNTRUST)` |
|        - |  682 | `	if( SX_EMPTY_STR(zFormat) ){` |
|        - |  683 | `		return 0;` |
|        - |  684 | `	}` |
|        - |  685 | `#endif` |
|    23555 |  686 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    23555 |  687 | `	return n;` |
|        5 |  688 | `}` |
