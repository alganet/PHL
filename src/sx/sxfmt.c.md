...
|        - |   90 | ` */` |
|  2776190 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|        5 |   92 | `{` |
|        - |   93 | `	/*` |
...
|  2776195 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|        - |  151 | `  int rc;` |
|        - |  152 |  |
|  2776195 |  153 | `  length = 0;` |
|  2776195 |  154 | `  bufpt = 0;` |
| 10929031 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
| 10832603 |  156 | `    if( c!='%' ){` |
|        - |  157 | `      unsigned int amt;` |
| 10696945 |  158 | `      bufpt = (char *)zFormat;` |
| 10696945 |  159 | `      amt = 1;` |
| 16865135 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
| 10696945 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
| 10696945 |  162 | `	  if( rc != SXRET_OK ){` |
|      ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  164 | `	  }` |
| 10696945 |  165 | `      if( c==0 ){` |
|  2679767 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|        - |  167 | `	  }` |
|  4008589 |  168 | `    }` |
|  8152841 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|      ! 0 |  170 | `      errorflag = 1;` |
...
|  8152841 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  8152836 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  4076418 |  180 | `    do{` |
|  8154193 |  181 | `      switch( c ){` |
...
|  8152836 |  187 | `        default:                                       break;` |
|        - |  188 | `      }` |
|  8154193 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|      ! 0 |  198 | `      c = *++zFormat;` |
|      ! 0 |  199 | `    }else{` |
|  8154237 |  200 | `      while( c>='0' && c<='9' ){` |
|     1399 |  201 | `        width = width*10 + c - '0';` |
|     1399 |  202 | `        c = *++zFormat;` |
|        3 |  203 | `      }` |
|        - |  204 | `    }` |
|  8152841 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|      ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|      ! 0 |  207 | `    }` |
|        - |  208 | `    /* Get the precision */` |
|  8152841 |  209 | `	precision = -1;` |
|  8152841 |  210 | `    if( c=='.' ){` |
...
|  8152841 |  225 | `	flag_long = 0;` |
|  8152841 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
|    62475 |  227 | `      flag_long = (c == 'q') ? 2 : 1;` |
|    62475 |  228 | `      c = *++zFormat;` |
|    62475 |  229 | `	  if( c == 'l' ){` |
...
|  8152841 |  235 | `    infop = 0;` |
|  8152841 |  236 | `    xtype = SXFMT_ERROR;` |
| 37591331 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 37591331 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  8152841 |  239 | `        infop = &aFmt[idx];` |
|  8152841 |  240 | `		xtype = infop->type;` |
|  8152841 |  241 | `        break;` |
|        - |  242 | `      }` |
| 14719250 |  243 | `    }` |
...
|        - |  263 | `    */` |
|  8152841 |  264 | `    switch( xtype ){` |
|    36126 |  265 | `      case SXFMT_RADIX:` |
|    72257 |  266 | `        if( flag_long > 0 ){` |
|    62475 |  267 | `			if( flag_long > 1 ){` |
|        - |  268 | `				/* BSD quad: expect a 64-bit integer */` |
|    62463 |  269 | `				longvalue = va_arg(ap,sxi64);` |
|    31234 |  270 | `			}else{` |
...
|    72257 |  281 | `      if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|        - |  282 | `#if 1` |
|        - |  283 | `        /* For the format %#x, the value zero is printed "0" not "0x0".` |
|        - |  284 | `        ** I think this is stupid.*/` |
|    72257 |  285 | `        if( longvalue==0 ) flag_alternateform = 0;` |
|        - |  286 | `#else` |
...
|        - |  290 | `#endif` |
|    72257 |  291 | `        if( infop->flags & SXFLAG_SIGNED ){` |
|    67619 |  292 | `          if( longvalue<0 ){` |
...
|      234 |  297 | `            prefix = '-';` |
|      119 |  298 | `          }else{` |
|    67389 |  299 | `            ulongvalue = (sxu64)longvalue;` |
|    67389 |  300 | `            if( flag_plussign )        prefix = '+';` |
|    67389 |  301 | `            else if( flag_blanksign )  prefix = ' ';` |
|    67389 |  302 | `            else                       prefix = 0;` |
|        - |  303 | `          }` |
|    33812 |  304 | `        }else{` |
|     4643 |  305 | `			ulongvalue = (sxu64)longvalue; /* print the full unsigned value as-is */` |
|     4643 |  306 | `			prefix = 0;` |
|        - |  307 | `		}` |
|    72257 |  308 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|     1340 |  309 | `          precision = width-(prefix!=0);` |
|      669 |  310 | `        }` |
|    72257 |  311 | `        bufpt = &buf[SXFMT_BUFSIZ-1];` |
|        - |  312 | `        {` |
|        - |  313 | `          register char *cset;      /* Use registers for speed */` |
|        - |  314 | `          register int base;` |
|    72257 |  315 | `          cset = infop->charset;` |
|    72257 |  316 | `          base = infop->base;` |
|    36126 |  317 | `          do{                                           /* Convert to ascii */` |
|   204366 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|   204366 |  319 | `            ulongvalue = ulongvalue/base;` |
|   204366 |  320 | `          }while( ulongvalue>0 );` |
|        - |  321 | `        }` |
|    72257 |  322 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    73357 |  323 | `        for(idx=precision-length; idx>0; idx--){` |
|     1102 |  324 | `          *(--bufpt) = '0';                             /* Zero pad */` |
|      552 |  325 | `        }` |
|    72257 |  326 | `        if( prefix ) *(--bufpt) = prefix;               /* Add sign */` |
|    72257 |  327 | `        if( flag_alternateform && infop->prefix ){      /* Add "0" or "0x" */` |
|        - |  328 | `          char *pre, x;` |
...
|        1 |  332 | `          }` |
|        1 |  333 | `        }` |
|    72257 |  334 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    72257 |  335 | `        break;` |
...
|     9945 |  509 | `        bufpt = buf;` |
|     9945 |  510 | `        break;` |
|  1371431 |  511 | `      case SXFMT_STRING:` |
|  2742867 |  512 | `        bufpt = va_arg(ap,char*);` |
|  2742867 |  513 | `        if( bufpt==0 ){` |
|      ! 0 |  514 | `          bufpt = " ";` |
|      ! 0 |  515 | `		  length = (int)sizeof(" ")-1;` |
|      ! 0 |  516 | `		  break;` |
|        - |  517 | `        }` |
|  2742867 |  518 | `		length = precision;` |
|  2742867 |  519 | `		if( precision < 0 ){` |
|        - |  520 | `			/* Symisc extension */` |
|    92757 |  521 | `			length = (int)SyStrlen(bufpt);` |
|    46376 |  522 | `		}` |
|  2742867 |  523 | `        if( precision>=0 && precision<length ) length = precision;` |
|  2742867 |  524 | `        break;` |
|  2663877 |  525 | `	case SXFMT_RAWSTR:{` |
|        - |  526 | `		/* Symisc extension */` |
|  5327759 |  527 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  5327759 |  528 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|      ! 0 |  529 | `			 bufpt = " ";` |
|      ! 0 |  530 | `		     length = (int)sizeof(char);` |
|      ! 0 |  531 | `		     break;` |
|        - |  532 | `		}` |
|  5327759 |  533 | `		bufpt = (char *)pStr->zString;` |
|  5327759 |  534 | `		length = (int)pStr->nByte;` |
|  5327759 |  535 | `		break;` |
|        - |  536 | `					  }` |
...
|        - |  547 | `    ** the output.` |
|        - |  548 | `    */` |
|  8152841 |  549 | `    if( !flag_leftjustify ){` |
|        - |  550 | `      register int nspace;` |
|  8152841 |  551 | `      nspace = width-length;` |
|  8152841 |  552 | `      if( nspace>0 ){` |
...
|       18 |  566 | `      }` |
|  4076418 |  567 | `    }` |
|  8152841 |  568 | `    if( length>0 ){` |
|  8152499 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  8152499 |  570 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  572 | `		}` |
|  4076247 |  573 | `    }` |
|  8152841 |  574 | `    if( flag_leftjustify ){` |
...
|      ! 0 |  591 | `      }` |
|      ! 0 |  592 | `    }` |
|  4076423 |  593 | `  }/* End for loop over the format string */` |
|    96433 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|  1388100 |  595 | `}` |
|        - |  596 | `/* SPDX-SnippetEnd */` |
| 18849470 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|        5 |  598 | `{` |
| 18849475 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 18849475 |  600 | `	sxi32 rc = SXERR_ABORT;` |
| 18849475 |  601 | `	switch(pConsumer->nType){` |
...
|      181 |  605 | `			break;` |
|  9424645 |  606 | `	case SXFMT_CONS_BLOB:` |
|        - |  607 | `			/* Blob consumer */` |
| 18849295 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 18849290 |  609 | `			break;` |
|      ! 0 |  610 | `		default:` |
...
| 18849475 |  615 | `	pConsumer->nLen += nLen;` |
| 18849475 |  616 | `	pConsumer->rc = rc;` |
| 18849475 |  617 | `	return rc;` |
|        5 |  618 | `}` |
|  2776190 |  619 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|        5 |  620 | `{` |
|        - |  621 | `	SyFmtConsumer sCons;` |
|  2776195 |  622 | `	sCons.nType = nType;` |
|  2776195 |  623 | `	sCons.rc = SXRET_OK;` |
|  2776195 |  624 | `	sCons.nLen = 0;` |
|  2776195 |  625 | `	if( pOutLen ){` |
|   121383 |  626 | `		*pOutLen = 0;` |
|    60689 |  627 | `	}` |
|  2776195 |  628 | `	switch(nType){` |
...
|       13 |  637 | `		break;` |
|  1388089 |  638 | `		case SXFMT_CONS_BLOB:` |
|  2776183 |  639 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  2776183 |  640 | `			break;` |
|      ! 0 |  641 | `		default:` |
|      ! 0 |  642 | `			return SXERR_UNKNOWN;` |
|        - |  643 | `	}` |
|  2776195 |  644 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  2776195 |  645 | `	if( pOutLen ){` |
|   121383 |  646 | `		*pOutLen = sCons.nLen;` |
|    60689 |  647 | `	}` |
|  2776195 |  648 | `	return sCons.rc;` |
|  1388100 |  649 | `}` |
...
|       13 |  662 | `	return rc;` |
|        1 |  663 | `}` |
|    97282 |  664 | `PH7_PRIVATE sxu32 SyBlobFormat(SyBlob *pBlob,const char *zFormat,...)` |
|        5 |  665 | `{` |
|        - |  666 | `	va_list ap;` |
|        - |  667 | `	sxu32 n;` |
...
|        - |  671 | `	}` |
|        - |  672 | `#endif` |
|    97287 |  673 | `	va_start(ap,zFormat);` |
|    97287 |  674 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    97287 |  675 | `	va_end(ap);` |
|    97287 |  676 | `	return n;` |
|        5 |  677 | `}` |
|    24096 |  678 | `PH7_PRIVATE sxu32 SyBlobFormatAp(SyBlob *pBlob,const char *zFormat,va_list ap)` |
|        5 |  679 | `{` |
|    24101 |  680 | `	sxu32 n = 0; /* cc warning */` |
|        - |  681 | `#if defined(UNTRUST)` |
|        - |  682 | `	if( SX_EMPTY_STR(zFormat) ){` |
|        - |  683 | `		return 0;` |
|        - |  684 | `	}` |
|        - |  685 | `#endif` |
|    24101 |  686 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    24101 |  687 | `	return n;` |
|        5 |  688 | `}` |
