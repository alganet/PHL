...
|        - |   90 | ` */` |
|  2776312 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|        5 |   92 | `{` |
|        - |   93 | `	/*` |
...
|  2776317 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|        - |  151 | `  int rc;` |
|        - |  152 |  |
|  2776317 |  153 | `  length = 0;` |
|  2776317 |  154 | `  bufpt = 0;` |
| 10929375 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
| 10832893 |  156 | `    if( c!='%' ){` |
|        - |  157 | `      unsigned int amt;` |
| 10697125 |  158 | `      bufpt = (char *)zFormat;` |
| 10697125 |  159 | `      amt = 1;` |
| 16865609 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
| 10697125 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
| 10697125 |  162 | `	  if( rc != SXRET_OK ){` |
|      ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  164 | `	  }` |
| 10697125 |  165 | `      if( c==0 ){` |
|  2679835 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|        - |  167 | `	  }` |
|  4008645 |  168 | `    }` |
|  8153063 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|      ! 0 |  170 | `      errorflag = 1;` |
...
|  8153063 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  8153058 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  4076529 |  180 | `    do{` |
|  8154415 |  181 | `      switch( c ){` |
...
|  8153058 |  187 | `        default:                                       break;` |
|        - |  188 | `      }` |
|  8154415 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|      ! 0 |  198 | `      c = *++zFormat;` |
|      ! 0 |  199 | `    }else{` |
|  8154459 |  200 | `      while( c>='0' && c<='9' ){` |
|     1399 |  201 | `        width = width*10 + c - '0';` |
|     1399 |  202 | `        c = *++zFormat;` |
|        3 |  203 | `      }` |
|        - |  204 | `    }` |
|  8153063 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|      ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|      ! 0 |  207 | `    }` |
|        - |  208 | `    /* Get the precision */` |
|  8153063 |  209 | `	precision = -1;` |
|  8153063 |  210 | `    if( c=='.' ){` |
|  2650125 |  211 | `      precision = 0;` |
|  2650125 |  212 | `      c = *++zFormat;` |
|  2650125 |  213 | `      if( c=='*' ){` |
|  2650113 |  214 | `        precision = va_arg(ap,int);` |
|  2650113 |  215 | `        if( precision<0 ) precision = -precision;` |
|  2650113 |  216 | `        c = *++zFormat;` |
|  1325059 |  217 | `      }else{` |
...
|  8153063 |  225 | `	flag_long = 0;` |
|  8153063 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
...
|  8153063 |  235 | `    infop = 0;` |
|  8153063 |  236 | `    xtype = SXFMT_ERROR;` |
| 37592047 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 37592047 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  8153063 |  239 | `        infop = &aFmt[idx];` |
|  8153063 |  240 | `		xtype = infop->type;` |
|  8153063 |  241 | `        break;` |
|        - |  242 | `      }` |
| 14719497 |  243 | `    }` |
...
|        - |  263 | `    */` |
|  8153063 |  264 | `    switch( xtype ){` |
|    36150 |  265 | `      case SXFMT_RADIX:` |
|    72305 |  266 | `        if( flag_long > 0 ){` |
...
|        - |  290 | `#endif` |
|    72305 |  291 | `        if( infop->flags & SXFLAG_SIGNED ){` |
|    67655 |  292 | `          if( longvalue<0 ){` |
...
|      234 |  297 | `            prefix = '-';` |
|      119 |  298 | `          }else{` |
|    67425 |  299 | `            ulongvalue = (sxu64)longvalue;` |
|    67425 |  300 | `            if( flag_plussign )        prefix = '+';` |
|    67425 |  301 | `            else if( flag_blanksign )  prefix = ' ';` |
|    67425 |  302 | `            else                       prefix = 0;` |
|        - |  303 | `          }` |
|    33830 |  304 | `        }else{` |
|     4655 |  305 | `			ulongvalue = (sxu64)longvalue; /* print the full unsigned value as-is */` |
|     4655 |  306 | `			prefix = 0;` |
|        - |  307 | `		}` |
|    72305 |  308 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|     1340 |  309 | `          precision = width-(prefix!=0);` |
|      669 |  310 | `        }` |
|    72305 |  311 | `        bufpt = &buf[SXFMT_BUFSIZ-1];` |
|        - |  312 | `        {` |
|        - |  313 | `          register char *cset;      /* Use registers for speed */` |
|        - |  314 | `          register int base;` |
|    72305 |  315 | `          cset = infop->charset;` |
|    72305 |  316 | `          base = infop->base;` |
|    36150 |  317 | `          do{                                           /* Convert to ascii */` |
|   204395 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|   204395 |  319 | `            ulongvalue = ulongvalue/base;` |
|   204395 |  320 | `          }while( ulongvalue>0 );` |
|        - |  321 | `        }` |
|    72305 |  322 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    73421 |  323 | `        for(idx=precision-length; idx>0; idx--){` |
|     1118 |  324 | `          *(--bufpt) = '0';                             /* Zero pad */` |
|      562 |  325 | `        }` |
|    72305 |  326 | `        if( prefix ) *(--bufpt) = prefix;               /* Add sign */` |
|    72305 |  327 | `        if( flag_alternateform && infop->prefix ){      /* Add "0" or "0x" */` |
|        - |  328 | `          char *pre, x;` |
...
|        1 |  332 | `          }` |
|        1 |  333 | `        }` |
|    72305 |  334 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    72305 |  335 | `        break;` |
...
|     9961 |  499 | `        c = va_arg(ap,int);` |
|     9961 |  500 | `		buf[0] = (char)c;` |
|        - |  501 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|     9961 |  502 | `		if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|     9961 |  503 | `        if( precision>=0 ){` |
...
|     9961 |  509 | `        bufpt = buf;` |
|     9961 |  510 | `        break;` |
|  1371484 |  511 | `      case SXFMT_STRING:` |
|  2742973 |  512 | `        bufpt = va_arg(ap,char*);` |
|  2742973 |  513 | `        if( bufpt==0 ){` |
|      ! 0 |  514 | `          bufpt = " ";` |
|      ! 0 |  515 | `		  length = (int)sizeof(" ")-1;` |
|      ! 0 |  516 | `		  break;` |
|        - |  517 | `        }` |
|  2742973 |  518 | `		length = precision;` |
|  2742973 |  519 | `		if( precision < 0 ){` |
|        - |  520 | `			/* Symisc extension */` |
|    92853 |  521 | `			length = (int)SyStrlen(bufpt);` |
|    46424 |  522 | `		}` |
|  2742973 |  523 | `        if( precision>=0 && precision<length ) length = precision;` |
|  2742973 |  524 | `        break;` |
|  2663903 |  525 | `	case SXFMT_RAWSTR:{` |
|        - |  526 | `		/* Symisc extension */` |
|  5327811 |  527 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  5327811 |  528 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|      ! 0 |  529 | `			 bufpt = " ";` |
|      ! 0 |  530 | `		     length = (int)sizeof(char);` |
|      ! 0 |  531 | `		     break;` |
|        - |  532 | `		}` |
|  5327811 |  533 | `		bufpt = (char *)pStr->zString;` |
|  5327811 |  534 | `		length = (int)pStr->nByte;` |
|  5327811 |  535 | `		break;` |
|        - |  536 | `					  }` |
...
|        - |  547 | `    ** the output.` |
|        - |  548 | `    */` |
|  8153063 |  549 | `    if( !flag_leftjustify ){` |
|        - |  550 | `      register int nspace;` |
|  8153063 |  551 | `      nspace = width-length;` |
|  8153063 |  552 | `      if( nspace>0 ){` |
...
|       18 |  566 | `      }` |
|  4076529 |  567 | `    }` |
|  8153063 |  568 | `    if( length>0 ){` |
|  8152721 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  8152721 |  570 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  572 | `		}` |
|  4076358 |  573 | `    }` |
|  8153063 |  574 | `    if( flag_leftjustify ){` |
...
|      ! 0 |  591 | `      }` |
|      ! 0 |  592 | `    }` |
|  4076534 |  593 | `  }/* End for loop over the format string */` |
|    96487 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|  1388161 |  595 | `}` |
|        - |  596 | `/* SPDX-SnippetEnd */` |
| 18849872 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|        5 |  598 | `{` |
| 18849877 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 18849877 |  600 | `	sxi32 rc = SXERR_ABORT;` |
| 18849877 |  601 | `	switch(pConsumer->nType){` |
...
|      181 |  605 | `			break;` |
|  9424846 |  606 | `	case SXFMT_CONS_BLOB:` |
|        - |  607 | `			/* Blob consumer */` |
| 18849697 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 18849692 |  609 | `			break;` |
|      ! 0 |  610 | `		default:` |
...
| 18849877 |  615 | `	pConsumer->nLen += nLen;` |
| 18849877 |  616 | `	pConsumer->rc = rc;` |
| 18849877 |  617 | `	return rc;` |
|        5 |  618 | `}` |
|  2776312 |  619 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|        5 |  620 | `{` |
|        - |  621 | `	SyFmtConsumer sCons;` |
|  2776317 |  622 | `	sCons.nType = nType;` |
|  2776317 |  623 | `	sCons.rc = SXRET_OK;` |
|  2776317 |  624 | `	sCons.nLen = 0;` |
|  2776317 |  625 | `	if( pOutLen ){` |
|   121489 |  626 | `		*pOutLen = 0;` |
|    60742 |  627 | `	}` |
|  2776317 |  628 | `	switch(nType){` |
...
|       13 |  637 | `		break;` |
|  1388150 |  638 | `		case SXFMT_CONS_BLOB:` |
|  2776305 |  639 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  2776305 |  640 | `			break;` |
|      ! 0 |  641 | `		default:` |
|      ! 0 |  642 | `			return SXERR_UNKNOWN;` |
|        - |  643 | `	}` |
|  2776317 |  644 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  2776317 |  645 | `	if( pOutLen ){` |
|   121489 |  646 | `		*pOutLen = sCons.nLen;` |
|    60742 |  647 | `	}` |
|  2776317 |  648 | `	return sCons.rc;` |
|  1388161 |  649 | `}` |
...
|       13 |  662 | `	return rc;` |
|        1 |  663 | `}` |
|    97364 |  664 | `PH7_PRIVATE sxu32 SyBlobFormat(SyBlob *pBlob,const char *zFormat,...)` |
|        5 |  665 | `{` |
|        - |  666 | `	va_list ap;` |
|        - |  667 | `	sxu32 n;` |
...
|        - |  671 | `	}` |
|        - |  672 | `#endif` |
|    97369 |  673 | `	va_start(ap,zFormat);` |
|    97369 |  674 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    97369 |  675 | `	va_end(ap);` |
|    97369 |  676 | `	return n;` |
|        5 |  677 | `}` |
|    24120 |  678 | `PH7_PRIVATE sxu32 SyBlobFormatAp(SyBlob *pBlob,const char *zFormat,va_list ap)` |
|        5 |  679 | `{` |
|    24125 |  680 | `	sxu32 n = 0; /* cc warning */` |
|        - |  681 | `#if defined(UNTRUST)` |
|        - |  682 | `	if( SX_EMPTY_STR(zFormat) ){` |
|        - |  683 | `		return 0;` |
|        - |  684 | `	}` |
|        - |  685 | `#endif` |
|    24125 |  686 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    24125 |  687 | `	return n;` |
|        5 |  688 | `}` |
|  2654816 |  689 | `PH7_PRIVATE sxu32 SyBufferFormat(char *zBuf,sxu32 nLen,const char *zFormat,...)` |
|        5 |  690 | `{` |
|        - |  691 | `	SyBlob sBlob;` |
|        - |  692 | `	va_list ap;` |
|        - |  693 | `	sxu32 n;` |
...
|        - |  697 | `	}` |
|        - |  698 | `#endif` |
|  2654821 |  699 | `	if( SXRET_OK != SyBlobInitFromBuf(&sBlob,zBuf,nLen - 1) ){` |
|      ! 0 |  700 | `		return 0;` |
|        - |  701 | `	}` |
|  2654821 |  702 | `	va_start(ap,zFormat);` |
|  2654821 |  703 | `	FormatMount(SXFMT_CONS_BLOB,&sBlob,0,0,0,zFormat,ap);` |
|  2654821 |  704 | `	va_end(ap);` |
|  2654821 |  705 | `	n = SyBlobLength(&sBlob);` |
|        - |  706 | `	/* Append the null terminator */` |
|  2654821 |  707 | `	sBlob.mByte++;` |
|  2654821 |  708 | `	SyBlobAppend(&sBlob,"\0",sizeof(char));` |
|  2654821 |  709 | `	return n;` |
|  1327413 |  710 | `}` |
|        - |  711 |  |
