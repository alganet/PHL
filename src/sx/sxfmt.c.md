...
|    1538 |   69 | `static int getdigit(sxlongreal *val,int *cnt)` |
|       1 |   70 |  |
|       - |   71 | `  sxlongreal d;` |
|       - |   72 | `  int digit;` |
|       - |   73 |  |
...
|      31 |   75 | `	  return '0';` |
|       - |   76 | `  }` |
|    1509 |   77 | `  digit = (int)*val;` |
|    1509 |   78 | `  d = digit;` |
|    1509 |   79 | `   *val = (*val - d)*10.0;` |
|    1509 |   80 | `  return digit + '0' ;` |
|     770 |   81 |  |
...
|       - |   87 | ` */` |
|  207976 |   88 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|       1 |   89 |  |
|       - |   90 | `	/*` |
...
|  207977 |  134 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|  207977 |  149 | `  length = 0;` |
|  207977 |  150 | `  bufpt = 0;` |
|  726195 |  151 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
|  674695 |  152 | `    if( c!='%' ){` |
|       - |  153 | `      unsigned int amt;` |
|  622503 |  154 | `      bufpt = (char *)zFormat;` |
|  622503 |  155 | `      amt = 1;` |
|  957127 |  156 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
|  622503 |  157 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
|  622503 |  158 | `	  if( rc != SXRET_OK ){` |
|     ! 0 |  159 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|       - |  160 | `	  }` |
|  622503 |  161 | `      if( c==0 ){` |
|  156477 |  162 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|       - |  163 | `	  }` |
|  233013 |  164 | `    }` |
|  518219 |  165 | `    if( (c=(*++zFormat))==0 ){` |
|     ! 0 |  166 | `      errorflag = 1;` |
...
|  518219 |  174 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  518218 |  175 | `     flag_alternateform = flag_zeropad = 0;` |
|  259109 |  176 | `    do{` |
|  518323 |  177 | `      switch( c ){` |
|     ! 0 |  178 | `        case '-':   flag_leftjustify = 1;     c = 0;   break;` |
|       3 |  179 | `        case '+':   flag_plussign = 1;        c = 0;   break;` |
|     ! 0 |  180 | `        case ' ':   flag_blanksign = 1;       c = 0;   break;` |
|      15 |  181 | `        case '#':   flag_alternateform = 1;   c = 0;   break;` |
|      89 |  182 | `        case '0':   flag_zeropad = 1;         c = 0;   break;` |
|  518218 |  183 | `        default:                                       break;` |
|       - |  184 | `      }` |
|  518323 |  185 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|     ! 0 |  194 | `      c = *++zFormat;` |
|     ! 0 |  195 | `    }else{` |
|  518361 |  196 | `      while( c>='0' && c<='9' ){` |
|     143 |  197 | `        width = width*10 + c - '0';` |
|     143 |  198 | `        c = *++zFormat;` |
|       1 |  199 | `      }` |
|       - |  200 | `    }` |
|  518219 |  201 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|     ! 0 |  202 | `      width = SXFMT_BUFSIZ-10;` |
|     ! 0 |  203 | `    }` |
|       - |  204 | `    /* Get the precision */` |
|  518219 |  205 | `	precision = -1;` |
|  518219 |  206 | `    if( c=='.' ){` |
|  155115 |  207 | `      precision = 0;` |
|  155115 |  208 | `      c = *++zFormat;` |
|  155115 |  209 | `      if( c=='*' ){` |
|  155017 |  210 | `        precision = va_arg(ap,int);` |
|  155017 |  211 | `        if( precision<0 ) precision = -precision;` |
|  155017 |  212 | `        c = *++zFormat;` |
|   77509 |  213 | `      }else{` |
|     295 |  214 | `        while( c>='0' && c<='9' ){` |
|     197 |  215 | `          precision = precision*10 + c - '0';` |
|     197 |  216 | `          c = *++zFormat;` |
|       1 |  217 | `        }` |
|       - |  218 | `      }` |
|   77557 |  219 | `    }` |
|       - |  220 | `    /* Get the conversion type modifier */` |
|  518219 |  221 | `	flag_long = 0;` |
|  518219 |  222 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
|   51277 |  223 | `      flag_long = (c == 'q') ? 2 : 1;` |
|   51277 |  224 | `      c = *++zFormat;` |
|   51277 |  225 | `	  if( c == 'l' ){` |
...
|  518219 |  231 | `    infop = 0;` |
|  518219 |  232 | `    xtype = SXFMT_ERROR;` |
| 2232183 |  233 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 2232183 |  234 | `      if( c==aFmt[idx].fmttype ){` |
|  518219 |  235 | `        infop = &aFmt[idx];` |
|  518219 |  236 | `		xtype = infop->type;` |
|  518219 |  237 | `        break;` |
|       - |  238 | `      }` |
|  856983 |  239 | `    }` |
...
|       - |  259 | `    */` |
|  518219 |  260 | `    switch( xtype ){` |
|   26096 |  261 | `      case SXFMT_RADIX:` |
|   52193 |  262 | `        if( flag_long > 0 ){` |
|   51277 |  263 | `			if( flag_long > 1 ){` |
|       - |  264 | `				/* BSD quad: expect a 64-bit integer */` |
|   51269 |  265 | `				longvalue = va_arg(ap,sxi64);` |
|   25635 |  266 | `			}else{` |
|       9 |  267 | `				longvalue = va_arg(ap,sxlong);` |
|       - |  268 | `			}` |
|   25639 |  269 | `		}else{` |
|     917 |  270 | `			if( infop->flags & SXFLAG_SIGNED ){` |
|     233 |  271 | `				longvalue = va_arg(ap,sxi32);` |
|     117 |  272 | `			}else{` |
|     685 |  273 | `				longvalue = va_arg(ap,sxu32);` |
|       - |  274 | `			}` |
|       - |  275 | `		}` |
|       - |  276 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|   52193 |  277 | `      if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|       - |  278 | `#if 1` |
|       - |  279 | `        /* For the format %#x, the value zero is printed "0" not "0x0".` |
|       - |  280 | `        ** I think this is stupid.*/` |
|   52193 |  281 | `        if( longvalue==0 ) flag_alternateform = 0;` |
|       - |  282 | `#else` |
...
|       - |  286 | `#endif` |
|   52193 |  287 | `        if( infop->flags & SXFLAG_SIGNED ){` |
|   51497 |  288 | `          if( longvalue<0 ){` |
...
|     ! 0 |  294 | `			}` |
|      47 |  295 | `            prefix = '-';` |
|   51474 |  296 | `          }else if( flag_plussign )  prefix = '+';` |
|   51449 |  297 | `          else if( flag_blanksign )  prefix = ' ';` |
|   51449 |  298 | `          else                       prefix = 0;` |
|   25749 |  299 | `        }else{` |
|     697 |  300 | `			if( longvalue<0 ){` |
...
|     697 |  308 | `			prefix = 0;` |
|       - |  309 | `		}` |
|   52193 |  310 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|      89 |  311 | `          precision = width-(prefix!=0);` |
|      44 |  312 | `        }` |
|   52193 |  313 | `        bufpt = &buf[SXFMT_BUFSIZ-1];` |
|       - |  314 | `        {` |
|       - |  315 | `          register char *cset;      /* Use registers for speed */` |
|       - |  316 | `          register int base;` |
|   52193 |  317 | `          cset = infop->charset;` |
|   52193 |  318 | `          base = infop->base;` |
|   26096 |  319 | `          do{                                           /* Convert to ascii */` |
|  167225 |  320 | `            *(--bufpt) = cset[longvalue%base];` |
|  167225 |  321 | `            longvalue = longvalue/base;` |
|  167225 |  322 | `          }while( longvalue>0 );` |
|       - |  323 | `        }` |
|   52193 |  324 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|   52248 |  325 | `        for(idx=precision-length; idx>0; idx--){` |
|      56 |  326 | `          *(--bufpt) = '0';                             /* Zero pad */` |
|      29 |  327 | `        }` |
|   52193 |  328 | `        if( prefix ) *(--bufpt) = prefix;               /* Add sign */` |
|   52193 |  329 | `        if( flag_alternateform && infop->prefix ){      /* Add "0" or "0x" */` |
|       - |  330 | `          char *pre, x;` |
...
|       2 |  334 | `          }` |
|       2 |  335 | `        }` |
|   52193 |  336 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|   52193 |  337 | `        break;` |
|      51 |  338 | `      case SXFMT_FLOAT:` |
|       - |  339 | `      case SXFMT_EXP:` |
|       - |  340 | `      case SXFMT_GENERIC:` |
|       - |  341 | `#ifndef SX_OMIT_FLOATINGPOINT` |
|     103 |  342 | `		realvalue = va_arg(ap,double);` |
|     103 |  343 | `        if( precision<0 ) precision = 6;         /* Set default precision */` |
|     103 |  344 | `        if( precision>SXFMT_BUFSIZ-40) precision = SXFMT_BUFSIZ-40;` |
|     103 |  345 | `        if( realvalue<0.0 ){` |
|      11 |  346 | `          realvalue = -realvalue;` |
|      11 |  347 | `          prefix = '-';` |
|       6 |  348 | `        }else{` |
|      93 |  349 | `          if( flag_plussign )          prefix = '+';` |
|      93 |  350 | `          else if( flag_blanksign )    prefix = ' ';` |
|      93 |  351 | `          else                         prefix = 0;` |
|       - |  352 | `        }` |
|     103 |  353 | `        if( infop->type==SXFMT_GENERIC && precision>0 ) precision--;` |
|     103 |  354 | `        rounder = 0.0;` |
|       - |  355 | `#if 0` |
...
|    1539 |  360 | `        for(idx=precision, rounder=0.5; idx>0; idx--, rounder*=0.1);` |
|       - |  361 | `#endif` |
|     103 |  362 | `        if( infop->type==SXFMT_FLOAT ) realvalue += rounder;` |
|       - |  363 | `        /* Normalize realvalue to within 10.0 > realvalue >= 1.0 */` |
|     103 |  364 | `        exp = 0;` |
|     103 |  365 | `        if( realvalue>0.0 ){` |
|     101 |  366 | `          while( realvalue>=1e8 && exp<=350 ){ realvalue *= 1e-8; exp+=8; }` |
|     145 |  367 | `          while( realvalue>=10.0 && exp<=350 ){ realvalue *= 0.1; exp++; }` |
|      97 |  368 | `          while( realvalue<1e-8 && exp>=-350 ){ realvalue *= 1e8; exp-=8; }` |
|     121 |  369 | `          while( realvalue<1.0 && exp>=-350 ){ realvalue *= 10.0; exp--; }` |
|      97 |  370 | `          if( exp>350 \|\| exp<-350 ){` |
|     ! 0 |  371 | `            bufpt = "NaN";` |
|     ! 0 |  372 | `            length = 3;` |
|     ! 0 |  373 | `            break;` |
|       - |  374 | `          }` |
...
|       - |  380 | `        */` |
|     103 |  381 | `        flag_exp = xtype==SXFMT_EXP;` |
|     103 |  382 | `        if( xtype!=SXFMT_FLOAT ){` |
|      99 |  383 | `          realvalue += rounder;` |
|      99 |  384 | `          if( realvalue>=10.0 ){ realvalue *= 0.1; exp++; }` |
|      49 |  385 | `        }` |
|     103 |  386 | `        if( xtype==SXFMT_GENERIC ){` |
|      99 |  387 | `          flag_rtz = !flag_alternateform;` |
|      99 |  388 | `          if( exp<-4 \|\| exp>precision ){` |
|     ! 0 |  389 | `            xtype = SXFMT_EXP;` |
|     ! 0 |  390 | `          }else{` |
|      99 |  391 | `            precision = precision - exp;` |
|      99 |  392 | `            xtype = SXFMT_FLOAT;` |
|       - |  393 | `          }` |
|      50 |  394 | `        }else{` |
|       5 |  395 | `          flag_rtz = 0;` |
|       - |  396 | `        }` |
...
|       - |  400 | `        */` |
|     103 |  401 | `        nsd = 0;` |
|     103 |  402 | `        if( xtype==SXFMT_FLOAT && exp+precision<SXFMT_BUFSIZ-30 ){` |
|     103 |  403 | `          flag_dp = (precision>0 \|\| flag_alternateform);` |
|     103 |  404 | `          if( prefix ) *(bufpt++) = prefix;         /* Sign */` |
|     103 |  405 | `          if( exp<0 )  *(bufpt++) = '0';            /* Digits before "." */` |
|     261 |  406 | `          else for(; exp>=0; exp--) *(bufpt++) = (char)getdigit(&realvalue,&nsd);` |
|     103 |  407 | `          if( flag_dp ) *(bufpt++) = '.';           /* The decimal point */` |
|     115 |  408 | `          for(exp++; exp<0 && precision>0; precision--, exp++){` |
|      13 |  409 | `            *(bufpt++) = '0';` |
|       7 |  410 | `          }` |
|    1471 |  411 | `          while( (precision--)>0 ) *(bufpt++) = (char)getdigit(&realvalue,&nsd);` |
|     103 |  412 | `          *(bufpt--) = 0;                           /* Null terminate */` |
|     103 |  413 | `          if( flag_rtz && flag_dp ){     /* Remove trailing zeros and "." */` |
|    1107 |  414 | `            while( bufpt>=buf && *bufpt=='0' ) *(bufpt--) = 0;` |
|      99 |  415 | `            if( bufpt>=buf && *bufpt=='.' ) *(bufpt--) = 0;` |
|      49 |  416 | `          }` |
|     103 |  417 | `          bufpt++;                            /* point to next free slot */` |
|      52 |  418 | `        }else{    /* etEXP or etGENERIC */` |
...
|       3 |  474 | `        length = 1;` |
|       3 |  475 | `        break;` |
|      32 |  476 | `      case SXFMT_CHARX:` |
|      65 |  477 | `        c = va_arg(ap,int);` |
|      65 |  478 | `		buf[0] = (char)c;` |
|       - |  479 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|      65 |  480 | `		if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|      65 |  481 | `        if( precision>=0 ){` |
...
|      65 |  487 | `        bufpt = buf;` |
|      65 |  488 | `        break;` |
|   77766 |  489 | `      case SXFMT_STRING:` |
|  155533 |  490 | `        bufpt = va_arg(ap,char*);` |
|  155533 |  491 | `        if( bufpt==0 ){` |
|     ! 0 |  492 | `          bufpt = " ";` |
|     ! 0 |  493 | `		  length = (int)sizeof(" ")-1;` |
|     ! 0 |  494 | `		  break;` |
|       - |  495 | `        }` |
|  155533 |  496 | `		length = precision;` |
|  155533 |  497 | `		if( precision < 0 ){` |
|       - |  498 | `			/* Symisc extension */` |
|     521 |  499 | `			length = (int)SyStrlen(bufpt);` |
|     260 |  500 | `		}` |
|  155533 |  501 | `        if( precision>=0 && precision<length ) length = precision;` |
|  155533 |  502 | `        break;` |
|  155163 |  503 | `	case SXFMT_RAWSTR:{` |
|       - |  504 | `		/* Symisc extension */` |
|  310327 |  505 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  310327 |  506 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|     ! 0 |  507 | `			 bufpt = " ";` |
|     ! 0 |  508 | `		     length = (int)sizeof(char);` |
|     ! 0 |  509 | `		     break;` |
|       - |  510 | `		}` |
|  310327 |  511 | `		bufpt = (char *)pStr->zString;` |
|  310327 |  512 | `		length = (int)pStr->nByte;` |
|  310327 |  513 | `		break;` |
|       - |  514 | `					  }` |
...
|       - |  525 | `    ** the output.` |
|       - |  526 | `    */` |
|  518219 |  527 | `    if( !flag_leftjustify ){` |
|       - |  528 | `      register int nspace;` |
|  518219 |  529 | `      nspace = width-length;` |
|  518219 |  530 | `      if( nspace>0 ){` |
...
|      15 |  544 | `      }` |
|  259109 |  545 | `    }` |
|  518219 |  546 | `    if( length>0 ){` |
|  518219 |  547 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  518219 |  548 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  549 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|       - |  550 | `		}` |
|  259109 |  551 | `    }` |
|  518219 |  552 | `    if( flag_leftjustify ){` |
...
|     ! 0 |  569 | `      }` |
|     ! 0 |  570 | `    }` |
|  259110 |  571 | `  }/* End for loop over the format string */` |
|   51501 |  572 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|  103989 |  573 |  |
| 1140750 |  574 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|       1 |  575 |  |
| 1140751 |  576 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 1140751 |  577 | `	sxi32 rc = SXERR_ABORT;` |
| 1140751 |  578 | `	switch(pConsumer->nType){` |
...
|     131 |  582 | `			break;` |
|  570310 |  583 | `	case SXFMT_CONS_BLOB:` |
|       - |  584 | `			/* Blob consumer */` |
| 1140621 |  585 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 1140620 |  586 | `			break;` |
|     ! 0 |  587 | `		default:` |
...
| 1140751 |  592 | `	pConsumer->nLen += nLen;` |
| 1140751 |  593 | `	pConsumer->rc = rc;` |
| 1140751 |  594 | `	return rc;` |
|       1 |  595 |  |
|  207976 |  596 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|       1 |  597 |  |
|       - |  598 | `	SyFmtConsumer sCons;` |
|  207977 |  599 | `	sCons.nType = nType;` |
|  207977 |  600 | `	sCons.rc = SXRET_OK;` |
|  207977 |  601 | `	sCons.nLen = 0;` |
|  207977 |  602 | `	if( pOutLen ){` |
|   52885 |  603 | `		*pOutLen = 0;` |
|   26442 |  604 | `	}` |
|  207977 |  605 | `	switch(nType){` |
...
|      11 |  614 | `		break;` |
|  103983 |  615 | `		case SXFMT_CONS_BLOB:` |
|  207967 |  616 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  207967 |  617 | `			break;` |
|     ! 0 |  618 | `		default:` |
|     ! 0 |  619 | `			return SXERR_UNKNOWN;` |
|       - |  620 | `	}` |
|  207977 |  621 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  207977 |  622 | `	if( pOutLen ){` |
|   52885 |  623 | `		*pOutLen = sCons.nLen;` |
|   26442 |  624 | `	}` |
|  207977 |  625 | `	return sCons.rc;` |
|  103989 |  626 |  |
...
|      11 |  639 | `	return rc;` |
|       1 |  640 |  |
|   52184 |  641 | `PH7_PRIVATE sxu32 SyBlobFormat(SyBlob *pBlob,const char *zFormat,...)` |
|       1 |  642 |  |
|       - |  643 | `	va_list ap;` |
|       - |  644 | `	sxu32 n;` |
...
|       - |  648 | `	}` |
|       - |  649 | `#endif` |
|   52185 |  650 | `	va_start(ap,zFormat);` |
|   52185 |  651 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|   52185 |  652 | `	va_end(ap);` |
|   52185 |  653 | `	return n;` |
|       1 |  654 |  |
|     700 |  655 | `PH7_PRIVATE sxu32 SyBlobFormatAp(SyBlob *pBlob,const char *zFormat,va_list ap)` |
|       1 |  656 |  |
|     701 |  657 | `	sxu32 n = 0; /* cc warning */` |
|       - |  658 | `#if defined(UNTRUST)` |
|       - |  659 | `	if( SX_EMPTY_STR(zFormat) ){` |
|       - |  660 | `		return 0;` |
|       - |  661 | `	}` |
|       - |  662 | `#endif` |
|     701 |  663 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|     701 |  664 | `	return n;` |
|       1 |  665 |  |
|  155082 |  666 | `PH7_PRIVATE sxu32 SyBufferFormat(char *zBuf,sxu32 nLen,const char *zFormat,...)` |
|       1 |  667 |  |
|       - |  668 | `	SyBlob sBlob;` |
|       - |  669 | `	va_list ap;` |
|       - |  670 | `	sxu32 n;` |
...
|       - |  674 | `	}` |
|       - |  675 | `#endif` |
|  155083 |  676 | `	if( SXRET_OK != SyBlobInitFromBuf(&sBlob,zBuf,nLen - 1) ){` |
|     ! 0 |  677 | `		return 0;` |
|       - |  678 | `	}` |
|  155083 |  679 | `	va_start(ap,zFormat);` |
|  155083 |  680 | `	FormatMount(SXFMT_CONS_BLOB,&sBlob,0,0,0,zFormat,ap);` |
|  155083 |  681 | `	va_end(ap);` |
|  155083 |  682 | `	n = SyBlobLength(&sBlob);` |
|       - |  683 | `	/* Append the null terminator */` |
|  155083 |  684 | `	sBlob.mByte++;` |
|  155083 |  685 | `	SyBlobAppend(&sBlob,"\0",sizeof(char));` |
|  155083 |  686 | `	return n;` |
|   77542 |  687 |  |
|       - |  688 |  |
