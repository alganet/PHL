...
|        - |   90 | ` */` |
|  2527644 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|        5 |   92 | `{` |
|        - |   93 | `	/*` |
...
|  2527649 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|        - |  151 | `  int rc;` |
|        - |  152 |  |
|  2527649 |  153 | `  length = 0;` |
|  2527649 |  154 | `  bufpt = 0;` |
|  9936041 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
|  9840173 |  156 | `    if( c!='%' ){` |
|        - |  157 | `      unsigned int amt;` |
|  9705511 |  158 | `      bufpt = (char *)zFormat;` |
|  9705511 |  159 | `      amt = 1;` |
| 15366189 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
|  9705511 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
|  9705511 |  162 | `	  if( rc != SXRET_OK ){` |
|      ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  164 | `	  }` |
|  9705511 |  165 | `      if( c==0 ){` |
|  2431781 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|        - |  167 | `	  }` |
|  3636865 |  168 | `    }` |
|  7408397 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|      ! 0 |  170 | `      errorflag = 1;` |
...
|  7408397 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  7408392 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  3704196 |  180 | `    do{` |
|  7409749 |  181 | `      switch( c ){` |
...
|  7408392 |  187 | `        default:                                       break;` |
|        - |  188 | `      }` |
|  7409749 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|      ! 0 |  198 | `      c = *++zFormat;` |
|      ! 0 |  199 | `    }else{` |
|  7409793 |  200 | `      while( c>='0' && c<='9' ){` |
|     1399 |  201 | `        width = width*10 + c - '0';` |
|     1399 |  202 | `        c = *++zFormat;` |
|        3 |  203 | `      }` |
|        - |  204 | `    }` |
|  7408397 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|      ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|      ! 0 |  207 | `    }` |
|        - |  208 | `    /* Get the precision */` |
|  7408397 |  209 | `	precision = -1;` |
|  7408397 |  210 | `    if( c=='.' ){` |
...
|  7408397 |  225 | `	flag_long = 0;` |
|  7408397 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
...
|  7408397 |  235 | `    infop = 0;` |
|  7408397 |  236 | `    xtype = SXFMT_ERROR;` |
| 34121235 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 34121235 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  7408397 |  239 | `        infop = &aFmt[idx];` |
|  7408397 |  240 | `		xtype = infop->type;` |
|  7408397 |  241 | `        break;` |
|        - |  242 | `      }` |
| 13356424 |  243 | `    }` |
...
|   203756 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|   203756 |  319 | `            ulongvalue = ulongvalue/base;` |
|   203756 |  320 | `          }while( ulongvalue>0 );` |
|        - |  321 | `        }` |
...
|      ! 0 |  496 | `        length = 1;` |
|      ! 0 |  497 | `        break;` |
|     4936 |  498 | `      case SXFMT_CHARX:` |
|     9877 |  499 | `        c = va_arg(ap,int);` |
|     9877 |  500 | `		buf[0] = (char)c;` |
|        - |  501 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|     9877 |  502 | `		if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|     9877 |  503 | `        if( precision>=0 ){` |
...
|     9877 |  509 | `        bufpt = buf;` |
|     9877 |  510 | `        break;` |
|  1247014 |  511 | `      case SXFMT_STRING:` |
|  2494033 |  512 | `        bufpt = va_arg(ap,char*);` |
|  2494033 |  513 | `        if( bufpt==0 ){` |
|      ! 0 |  514 | `          bufpt = " ";` |
|      ! 0 |  515 | `		  length = (int)sizeof(" ")-1;` |
|      ! 0 |  516 | `		  break;` |
|        - |  517 | `        }` |
|  2494033 |  518 | `		length = precision;` |
|  2494033 |  519 | `		if( precision < 0 ){` |
|        - |  520 | `			/* Symisc extension */` |
|    91397 |  521 | `			length = (int)SyStrlen(bufpt);` |
|    45696 |  522 | `		}` |
|  2494033 |  523 | `        if( precision>=0 && precision<length ) length = precision;` |
|  2494033 |  524 | `        break;` |
|  2416284 |  525 | `	case SXFMT_RAWSTR:{` |
|        - |  526 | `		/* Symisc extension */` |
|  4832573 |  527 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  4832573 |  528 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|      ! 0 |  529 | `			 bufpt = " ";` |
|      ! 0 |  530 | `		     length = (int)sizeof(char);` |
|      ! 0 |  531 | `		     break;` |
|        - |  532 | `		}` |
|  4832573 |  533 | `		bufpt = (char *)pStr->zString;` |
|  4832573 |  534 | `		length = (int)pStr->nByte;` |
|  4832573 |  535 | `		break;` |
|        - |  536 | `					  }` |
...
|        - |  547 | `    ** the output.` |
|        - |  548 | `    */` |
|  7408397 |  549 | `    if( !flag_leftjustify ){` |
|        - |  550 | `      register int nspace;` |
|  7408397 |  551 | `      nspace = width-length;` |
|  7408397 |  552 | `      if( nspace>0 ){` |
...
|       18 |  566 | `      }` |
|  3704196 |  567 | `    }` |
|  7408397 |  568 | `    if( length>0 ){` |
|  7408055 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  7408055 |  570 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  572 | `		}` |
|  3704025 |  573 | `    }` |
|  7408397 |  574 | `    if( flag_leftjustify ){` |
...
|      ! 0 |  591 | `      }` |
|      ! 0 |  592 | `    }` |
|  3704201 |  593 | `  }/* End for loop over the format string */` |
|    95873 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|  1263827 |  595 | `}` |
|        - |  596 | `/* SPDX-SnippetEnd */` |
| 17113592 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|        5 |  598 | `{` |
| 17113597 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 17113597 |  600 | `	sxi32 rc = SXERR_ABORT;` |
| 17113597 |  601 | `	switch(pConsumer->nType){` |
...
|      181 |  605 | `			break;` |
|  8556706 |  606 | `	case SXFMT_CONS_BLOB:` |
|        - |  607 | `			/* Blob consumer */` |
| 17113417 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 17113412 |  609 | `			break;` |
|      ! 0 |  610 | `		default:` |
...
| 17113597 |  615 | `	pConsumer->nLen += nLen;` |
| 17113597 |  616 | `	pConsumer->rc = rc;` |
| 17113597 |  617 | `	return rc;` |
|        5 |  618 | `}` |
|  2527644 |  619 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|        5 |  620 | `{` |
|        - |  621 | `	SyFmtConsumer sCons;` |
|  2527649 |  622 | `	sCons.nType = nType;` |
|  2527649 |  623 | `	sCons.rc = SXRET_OK;` |
|  2527649 |  624 | `	sCons.nLen = 0;` |
|  2527649 |  625 | `	if( pOutLen ){` |
|   120463 |  626 | `		*pOutLen = 0;` |
|    60229 |  627 | `	}` |
|  2527649 |  628 | `	switch(nType){` |
...
|       13 |  637 | `		break;` |
|  1263816 |  638 | `		case SXFMT_CONS_BLOB:` |
|  2527637 |  639 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  2527637 |  640 | `			break;` |
|      ! 0 |  641 | `		default:` |
|      ! 0 |  642 | `			return SXERR_UNKNOWN;` |
|        - |  643 | `	}` |
|  2527649 |  644 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  2527649 |  645 | `	if( pOutLen ){` |
|   120463 |  646 | `		*pOutLen = sCons.nLen;` |
|    60229 |  647 | `	}` |
|  2527649 |  648 | `	return sCons.rc;` |
|  1263827 |  649 | `}` |
...
|       13 |  662 | `	return rc;` |
|        1 |  663 | `}` |
|    96682 |  664 | `PH7_PRIVATE sxu32 SyBlobFormat(SyBlob *pBlob,const char *zFormat,...)` |
|        5 |  665 | `{` |
|        - |  666 | `	va_list ap;` |
|        - |  667 | `	sxu32 n;` |
...
|        - |  671 | `	}` |
|        - |  672 | `#endif` |
|    96687 |  673 | `	va_start(ap,zFormat);` |
|    96687 |  674 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    96687 |  675 | `	va_end(ap);` |
|    96687 |  676 | `	return n;` |
|        5 |  677 | `}` |
|    23776 |  678 | `PH7_PRIVATE sxu32 SyBlobFormatAp(SyBlob *pBlob,const char *zFormat,va_list ap)` |
|        5 |  679 | `{` |
|    23781 |  680 | `	sxu32 n = 0; /* cc warning */` |
|        - |  681 | `#if defined(UNTRUST)` |
|        - |  682 | `	if( SX_EMPTY_STR(zFormat) ){` |
|        - |  683 | `		return 0;` |
|        - |  684 | `	}` |
|        - |  685 | `#endif` |
|    23781 |  686 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    23781 |  687 | `	return n;` |
|        5 |  688 | `}` |
