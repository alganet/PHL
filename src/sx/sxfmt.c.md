...
|        - |   90 | ` */` |
|  1455032 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|        5 |   92 | `{` |
|        - |   93 | `	/*` |
...
|  1455037 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|        - |  151 | `  int rc;` |
|        - |  152 |  |
|  1455037 |  153 | `  length = 0;` |
|  1455037 |  154 | `  bufpt = 0;` |
|  5697223 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
|  5629329 |  156 | `    if( c!='%' ){` |
|        - |  157 | `      unsigned int amt;` |
|  5541467 |  158 | `      bufpt = (char *)zFormat;` |
|  5541467 |  159 | `      amt = 1;` |
|  8433611 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
|  5541467 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
|  5541467 |  162 | `	  if( rc != SXRET_OK ){` |
|      ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  164 | `	  }` |
|  5541467 |  165 | `      if( c==0 ){` |
|  1387143 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|        - |  167 | `	  }` |
|  2077162 |  168 | `    }` |
|  4242191 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|      ! 0 |  170 | `      errorflag = 1;` |
...
|  4242191 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  4242186 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  2121093 |  180 | `    do{` |
|  4242445 |  181 | `      switch( c ){` |
...
|  4242186 |  187 | `        default:                                       break;` |
|        - |  188 | `      }` |
|  4242445 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|      ! 0 |  198 | `      c = *++zFormat;` |
|      ! 0 |  199 | `    }else{` |
|  4242511 |  200 | `      while( c>='0' && c<='9' ){` |
|      322 |  201 | `        width = width*10 + c - '0';` |
|      322 |  202 | `        c = *++zFormat;` |
|        2 |  203 | `      }` |
|        - |  204 | `    }` |
|  4242191 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|      ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|      ! 0 |  207 | `    }` |
|        - |  208 | `    /* Get the precision */` |
|  4242191 |  209 | `	precision = -1;` |
|  4242191 |  210 | `    if( c=='.' ){` |
...
|  4242191 |  225 | `	flag_long = 0;` |
|  4242191 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
|    57161 |  227 | `      flag_long = (c == 'q') ? 2 : 1;` |
|    57161 |  228 | `      c = *++zFormat;` |
|    57161 |  229 | `	  if( c == 'l' ){` |
...
|  4242191 |  235 | `    infop = 0;` |
|  4242191 |  236 | `    xtype = SXFMT_ERROR;` |
| 19589269 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 19589269 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  4242191 |  239 | `        infop = &aFmt[idx];` |
|  4242191 |  240 | `		xtype = infop->type;` |
|  4242191 |  241 | `        break;` |
|        - |  242 | `      }` |
|  7673544 |  243 | `    }` |
...
|        - |  263 | `    */` |
|  4242191 |  264 | `    switch( xtype ){` |
|    30620 |  265 | `      case SXFMT_RADIX:` |
|    61245 |  266 | `        if( flag_long > 0 ){` |
|    57161 |  267 | `			if( flag_long > 1 ){` |
|        - |  268 | `				/* BSD quad: expect a 64-bit integer */` |
|    57149 |  269 | `				longvalue = va_arg(ap,sxi64);` |
|    28577 |  270 | `			}else{` |
|       13 |  271 | `				longvalue = va_arg(ap,sxlong);` |
|        - |  272 | `			}` |
|    28583 |  273 | `		}else{` |
|     4089 |  274 | `			if( infop->flags & SXFLAG_SIGNED ){` |
|     2335 |  275 | `				longvalue = va_arg(ap,sxi32);` |
|     1170 |  276 | `			}else{` |
|     1759 |  277 | `				longvalue = va_arg(ap,sxu32);` |
|        - |  278 | `			}` |
|        - |  279 | `		}` |
|        - |  280 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|    61245 |  281 | `      if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|        - |  282 | `#if 1` |
|        - |  283 | `        /* For the format %#x, the value zero is printed "0" not "0x0".` |
|        - |  284 | `        ** I think this is stupid.*/` |
|    61245 |  285 | `        if( longvalue==0 ) flag_alternateform = 0;` |
|        - |  286 | `#else` |
...
|        - |  290 | `#endif` |
|    61245 |  291 | `        if( infop->flags & SXFLAG_SIGNED ){` |
|    59437 |  292 | `          if( longvalue<0 ){` |
...
|      167 |  297 | `            prefix = '-';` |
|       85 |  298 | `          }else{` |
|    59273 |  299 | `            ulongvalue = (sxu64)longvalue;` |
|    59273 |  300 | `            if( flag_plussign )        prefix = '+';` |
|    59271 |  301 | `            else if( flag_blanksign )  prefix = ' ';` |
|    59271 |  302 | `            else                       prefix = 0;` |
|        - |  303 | `          }` |
|    29721 |  304 | `        }else{` |
|     1813 |  305 | `			ulongvalue = (sxu64)longvalue; /* print the full unsigned value as-is */` |
|     1813 |  306 | `			prefix = 0;` |
|        - |  307 | `		}` |
|    61245 |  308 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|      240 |  309 | `          precision = width-(prefix!=0);` |
|      119 |  310 | `        }` |
|    61245 |  311 | `        bufpt = &buf[SXFMT_BUFSIZ-1];` |
|        - |  312 | `        {` |
|        - |  313 | `          register char *cset;      /* Use registers for speed */` |
|        - |  314 | `          register int base;` |
|    61245 |  315 | `          cset = infop->charset;` |
|    61245 |  316 | `          base = infop->base;` |
|    30620 |  317 | `          do{                                           /* Convert to ascii */` |
|   182413 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|   182413 |  319 | `            ulongvalue = ulongvalue/base;` |
|   182413 |  320 | `          }while( ulongvalue>0 );` |
|        - |  321 | `        }` |
|    61245 |  322 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    61648 |  323 | `        for(idx=precision-length; idx>0; idx--){` |
|      405 |  324 | `          *(--bufpt) = '0';                             /* Zero pad */` |
|      203 |  325 | `        }` |
|    61245 |  326 | `        if( prefix ) *(--bufpt) = prefix;               /* Add sign */` |
|    61245 |  327 | `        if( flag_alternateform && infop->prefix ){      /* Add "0" or "0x" */` |
|        - |  328 | `          char *pre, x;` |
...
|        1 |  332 | `          }` |
|        1 |  333 | `        }` |
|    61245 |  334 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    61245 |  335 | `        break;` |
...
|      ! 0 |  496 | `        length = 1;` |
|      ! 0 |  497 | `        break;` |
|     4904 |  498 | `      case SXFMT_CHARX:` |
|     9812 |  499 | `        c = va_arg(ap,int);` |
|     9812 |  500 | `		buf[0] = (char)c;` |
|        - |  501 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|     9812 |  502 | `		if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|     9812 |  503 | `        if( precision>=0 ){` |
...
|  1385601 |  524 | `        break;` |
|  1392766 |  525 | `	case SXFMT_RAWSTR:{` |
|        - |  526 | `		/* Symisc extension */` |
|  2785537 |  527 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  2785537 |  528 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|      ! 0 |  529 | `			 bufpt = " ";` |
|      ! 0 |  530 | `		     length = (int)sizeof(char);` |
|      ! 0 |  531 | `		     break;` |
|        - |  532 | `		}` |
|  2785537 |  533 | `		bufpt = (char *)pStr->zString;` |
|  2785537 |  534 | `		length = (int)pStr->nByte;` |
|  2785537 |  535 | `		break;` |
|        - |  536 | `					  }` |
...
|        - |  547 | `    ** the output.` |
|        - |  548 | `    */` |
|  4242191 |  549 | `    if( !flag_leftjustify ){` |
|        - |  550 | `      register int nspace;` |
|  4242191 |  551 | `      nspace = width-length;` |
|  4242191 |  552 | `      if( nspace>0 ){` |
...
|       18 |  566 | `      }` |
|  2121093 |  567 | `    }` |
|  4242191 |  568 | `    if( length>0 ){` |
|  4241975 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  4241975 |  570 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  572 | `		}` |
|  2120985 |  573 | `    }` |
|  4242191 |  574 | `    if( flag_leftjustify ){` |
...
|      ! 0 |  591 | `      }` |
|      ! 0 |  592 | `    }` |
|  2121098 |  593 | `  }/* End for loop over the format string */` |
|    67899 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|   727521 |  595 | `}` |
|        - |  596 | `/* SPDX-SnippetEnd */` |
|  9783468 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|        5 |  598 | `{` |
|  9783473 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
|  9783473 |  600 | `	sxi32 rc = SXERR_ABORT;` |
|  9783473 |  601 | `	switch(pConsumer->nType){` |
...
|      157 |  605 | `			break;` |
|  4891656 |  606 | `	case SXFMT_CONS_BLOB:` |
|        - |  607 | `			/* Blob consumer */` |
|  9783317 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
|  9783312 |  609 | `			break;` |
|      ! 0 |  610 | `		default:` |
...
|  9783473 |  615 | `	pConsumer->nLen += nLen;` |
|  9783473 |  616 | `	pConsumer->rc = rc;` |
|  9783473 |  617 | `	return rc;` |
|        5 |  618 | `}` |
|  1455032 |  619 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|        5 |  620 | `{` |
|        - |  621 | `	SyFmtConsumer sCons;` |
|  1455037 |  622 | `	sCons.nType = nType;` |
|  1455037 |  623 | `	sCons.rc = SXRET_OK;` |
|  1455037 |  624 | `	sCons.nLen = 0;` |
|  1455037 |  625 | `	if( pOutLen ){` |
|    71321 |  626 | `		*pOutLen = 0;` |
|    35658 |  627 | `	}` |
|  1455037 |  628 | `	switch(nType){` |
...
|       13 |  637 | `		break;` |
|   727510 |  638 | `		case SXFMT_CONS_BLOB:` |
|  1455025 |  639 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  1455025 |  640 | `			break;` |
|      ! 0 |  641 | `		default:` |
|      ! 0 |  642 | `			return SXERR_UNKNOWN;` |
|        - |  643 | `	}` |
|  1455037 |  644 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  1455037 |  645 | `	if( pOutLen ){` |
|    71321 |  646 | `		*pOutLen = sCons.nLen;` |
|    35658 |  647 | `	}` |
|  1455037 |  648 | `	return sCons.rc;` |
|   727521 |  649 | `}` |
...
|       13 |  662 | `	return rc;` |
|        1 |  663 | `}` |
|    68964 |  664 | `PH7_PRIVATE sxu32 SyBlobFormat(SyBlob *pBlob,const char *zFormat,...)` |
|        5 |  665 | `{` |
|        - |  666 | `	va_list ap;` |
|        - |  667 | `	sxu32 n;` |
...
|        - |  671 | `	}` |
|        - |  672 | `#endif` |
|    68969 |  673 | `	va_start(ap,zFormat);` |
|    68969 |  674 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    68969 |  675 | `	va_end(ap);` |
|    68969 |  676 | `	return n;` |
|        5 |  677 | `}` |
...
|     2357 |  687 | `	return n;` |
|        5 |  688 | `}` |
|  1383704 |  689 | `PH7_PRIVATE sxu32 SyBufferFormat(char *zBuf,sxu32 nLen,const char *zFormat,...)` |
|        5 |  690 | `{` |
|        - |  691 | `	SyBlob sBlob;` |
|        - |  692 | `	va_list ap;` |
|        - |  693 | `	sxu32 n;` |
...
|        - |  697 | `	}` |
|        - |  698 | `#endif` |
|  1383709 |  699 | `	if( SXRET_OK != SyBlobInitFromBuf(&sBlob,zBuf,nLen - 1) ){` |
|      ! 0 |  700 | `		return 0;` |
|        - |  701 | `	}` |
|  1383709 |  702 | `	va_start(ap,zFormat);` |
|  1383709 |  703 | `	FormatMount(SXFMT_CONS_BLOB,&sBlob,0,0,0,zFormat,ap);` |
|  1383709 |  704 | `	va_end(ap);` |
|  1383709 |  705 | `	n = SyBlobLength(&sBlob);` |
|        - |  706 | `	/* Append the null terminator */` |
|  1383709 |  707 | `	sBlob.mByte++;` |
|  1383709 |  708 | `	SyBlobAppend(&sBlob,"\0",sizeof(char));` |
|  1383709 |  709 | `	return n;` |
|   691857 |  710 | `}` |
|        - |  711 |  |
