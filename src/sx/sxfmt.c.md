...
|    4022 |   72 | `static int getdigit(sxlongreal *val,int *cnt)` |
|       2 |   73 |  |
|       - |   74 | `  sxlongreal d;` |
|       - |   75 | `  int digit;` |
|       - |   76 |  |
...
|      31 |   78 | `	  return '0';` |
|       - |   79 | `  }` |
|    3994 |   80 | `  digit = (int)*val;` |
|    3994 |   81 | `  d = digit;` |
|    3994 |   82 | `   *val = (*val - d)*10.0;` |
|    3994 |   83 | `  return digit + '0' ;` |
|    2013 |   84 |  |
...
|       - |   90 | ` */` |
|  303982 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|       2 |   92 |  |
|       - |   93 | `	/*` |
...
|  303984 |  137 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|  303984 |  152 | `  length = 0;` |
|  303984 |  153 | `  bufpt = 0;` |
| 1099812 |  154 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
| 1034854 |  155 | `    if( c!='%' ){` |
|       - |  156 | `      unsigned int amt;` |
|  950586 |  157 | `      bufpt = (char *)zFormat;` |
|  950586 |  158 | `      amt = 1;` |
| 1503080 |  159 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
|  950586 |  160 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
|  950586 |  161 | `	  if( rc != SXRET_OK ){` |
|     ! 0 |  162 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|       - |  163 | `	  }` |
|  950586 |  164 | `      if( c==0 ){` |
|  239026 |  165 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|       - |  166 | `	  }` |
|  355780 |  167 | `    }` |
|  795830 |  168 | `    if( (c=(*++zFormat))==0 ){` |
|     ! 0 |  169 | `      errorflag = 1;` |
...
|  795830 |  177 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  795828 |  178 | `     flag_alternateform = flag_zeropad = 0;` |
|  397914 |  179 | `    do{` |
|  795942 |  180 | `      switch( c ){` |
...
|      95 |  185 | `        case '0':   flag_zeropad = 1;         c = 0;   break;` |
|  795828 |  186 | `        default:                                       break;` |
|       - |  187 | `      }` |
|  795942 |  188 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|     ! 0 |  197 | `      c = *++zFormat;` |
|     ! 0 |  198 | `    }else{` |
|  795984 |  199 | `      while( c>='0' && c<='9' ){` |
|     156 |  200 | `        width = width*10 + c - '0';` |
|     156 |  201 | `        c = *++zFormat;` |
|       2 |  202 | `      }` |
|       - |  203 | `    }` |
|  795830 |  204 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|     ! 0 |  205 | `      width = SXFMT_BUFSIZ-10;` |
|     ! 0 |  206 | `    }` |
|       - |  207 | `    /* Get the precision */` |
|  795830 |  208 | `	precision = -1;` |
|  795830 |  209 | `    if( c=='.' ){` |
|  237020 |  210 | `      precision = 0;` |
|  237020 |  211 | `      c = *++zFormat;` |
|  237020 |  212 | `      if( c=='*' ){` |
|  236760 |  213 | `        precision = va_arg(ap,int);` |
|  236760 |  214 | `        if( precision<0 ) precision = -precision;` |
|  236760 |  215 | `        c = *++zFormat;` |
|  118381 |  216 | `      }else{` |
|     782 |  217 | `        while( c>='0' && c<='9' ){` |
|     522 |  218 | `          precision = precision*10 + c - '0';` |
|     522 |  219 | `          c = *++zFormat;` |
|       2 |  220 | `        }` |
|       - |  221 | `      }` |
|  118509 |  222 | `    }` |
|       - |  223 | `    /* Get the conversion type modifier */` |
|  795830 |  224 | `	flag_long = 0;` |
|  795830 |  225 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
|   54310 |  226 | `      flag_long = (c == 'q') ? 2 : 1;` |
|   54310 |  227 | `      c = *++zFormat;` |
|   54310 |  228 | `	  if( c == 'l' ){` |
...
|  795830 |  234 | `    infop = 0;` |
|  795830 |  235 | `    xtype = SXFMT_ERROR;` |
| 3522584 |  236 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 3522584 |  237 | `      if( c==aFmt[idx].fmttype ){` |
|  795830 |  238 | `        infop = &aFmt[idx];` |
|  795830 |  239 | `		xtype = infop->type;` |
|  795830 |  240 | `        break;` |
|       - |  241 | `      }` |
| 1363379 |  242 | `    }` |
...
|       - |  262 | `    */` |
|  795830 |  263 | `    switch( xtype ){` |
|   28149 |  264 | `      case SXFMT_RADIX:` |
|   56300 |  265 | `        if( flag_long > 0 ){` |
|   54310 |  266 | `			if( flag_long > 1 ){` |
|       - |  267 | `				/* BSD quad: expect a 64-bit integer */` |
|   54302 |  268 | `				longvalue = va_arg(ap,sxi64);` |
|   27152 |  269 | `			}else{` |
|       9 |  270 | `				longvalue = va_arg(ap,sxlong);` |
|       - |  271 | `			}` |
|   27156 |  272 | `		}else{` |
|    1992 |  273 | `			if( infop->flags & SXFLAG_SIGNED ){` |
|    1024 |  274 | `				longvalue = va_arg(ap,sxi32);` |
|     513 |  275 | `			}else{` |
|     970 |  276 | `				longvalue = va_arg(ap,sxu32);` |
|       - |  277 | `			}` |
|       - |  278 | `		}` |
|       - |  279 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|   56300 |  280 | `      if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|       - |  281 | `#if 1` |
|       - |  282 | `        /* For the format %#x, the value zero is printed "0" not "0x0".` |
|       - |  283 | `        ** I think this is stupid.*/` |
|   56300 |  284 | `        if( longvalue==0 ) flag_alternateform = 0;` |
|       - |  285 | `#else` |
...
|       - |  289 | `#endif` |
|   56300 |  290 | `        if( infop->flags & SXFLAG_SIGNED ){` |
|   55322 |  291 | `          if( longvalue<0 ){` |
...
|     ! 0 |  297 | `			}` |
|      96 |  298 | `            prefix = '-';` |
|   55275 |  299 | `          }else if( flag_plussign )  prefix = '+';` |
|   55226 |  300 | `          else if( flag_blanksign )  prefix = ' ';` |
|   55226 |  301 | `          else                       prefix = 0;` |
|   27662 |  302 | `        }else{` |
|     980 |  303 | `			if( longvalue<0 ){` |
...
|     980 |  311 | `			prefix = 0;` |
|       - |  312 | `		}` |
|   56300 |  313 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|      95 |  314 | `          precision = width-(prefix!=0);` |
|      47 |  315 | `        }` |
|   56300 |  316 | `        bufpt = &buf[SXFMT_BUFSIZ-1];` |
|       - |  317 | `        {` |
|       - |  318 | `          register char *cset;      /* Use registers for speed */` |
|       - |  319 | `          register int base;` |
|   56300 |  320 | `          cset = infop->charset;` |
|   56300 |  321 | `          base = infop->base;` |
|   28149 |  322 | `          do{                                           /* Convert to ascii */` |
|  173419 |  323 | `            *(--bufpt) = cset[longvalue%base];` |
|  173419 |  324 | `            longvalue = longvalue/base;` |
|  173419 |  325 | `          }while( longvalue>0 );` |
|       - |  326 | `        }` |
|   56300 |  327 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|   56356 |  328 | `        for(idx=precision-length; idx>0; idx--){` |
|      57 |  329 | `          *(--bufpt) = '0';                             /* Zero pad */` |
|      29 |  330 | `        }` |
|   56300 |  331 | `        if( prefix ) *(--bufpt) = prefix;               /* Add sign */` |
|   56300 |  332 | `        if( flag_alternateform && infop->prefix ){      /* Add "0" or "0x" */` |
|       - |  333 | `          char *pre, x;` |
...
|       2 |  337 | `          }` |
|       2 |  338 | `        }` |
|   56300 |  339 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|   56300 |  340 | `        break;` |
|     136 |  341 | `      case SXFMT_FLOAT:` |
|       - |  342 | `      case SXFMT_EXP:` |
|       - |  343 | `      case SXFMT_GENERIC:` |
|       - |  344 | `#ifndef SX_OMIT_FLOATINGPOINT` |
|     274 |  345 | `		realvalue = va_arg(ap,double);` |
|       - |  346 | `        /* handle NaN/Infinity specially before any arithmetic */` |
|     274 |  347 | `        if( PH7_IS_NAN(realvalue) ){` |
...
|       - |  354 | `        }` |
|     274 |  355 | `        if( PH7_IS_INF(realvalue) ){` |
...
|       - |  368 | `        }` |
|     274 |  369 | `        if( precision<0 ) precision = 6;         /* Set default precision */` |
|     274 |  370 | `        if( precision>SXFMT_BUFSIZ-40) precision = SXFMT_BUFSIZ-40;` |
|     274 |  371 | `        if( realvalue<0.0 ){` |
|      25 |  372 | `          realvalue = -realvalue;` |
|      25 |  373 | `          prefix = '-';` |
|      13 |  374 | `        }else{` |
|     250 |  375 | `          if( flag_plussign )          prefix = '+';` |
|     250 |  376 | `          else if( flag_blanksign )    prefix = ' ';` |
|     250 |  377 | `          else                         prefix = 0;` |
|       - |  378 | `        }` |
|     274 |  379 | `        if( infop->type==SXFMT_GENERIC && precision>0 ) precision--;` |
|     274 |  380 | `        rounder = 0.0;` |
|       - |  381 | `#if 0` |
...
|    4024 |  386 | `        for(idx=precision, rounder=0.5; idx>0; idx--, rounder*=0.1);` |
|       - |  387 | `#endif` |
|     274 |  388 | `        if( infop->type==SXFMT_FLOAT ) realvalue += rounder;` |
|       - |  389 | `        /* Normalize realvalue to within 10.0 > realvalue >= 1.0 */` |
|     274 |  390 | `        exp = 0;` |
|     274 |  391 | `        if( realvalue>0.0 ){` |
|     258 |  392 | `          while( realvalue>=1e8 && exp<=350 ){ realvalue *= 1e-8; exp+=8; }` |
|     362 |  393 | `          while( realvalue>=10.0 && exp<=350 ){ realvalue *= 0.1; exp++; }` |
|     248 |  394 | `          while( realvalue<1e-8 && exp>=-350 ){ realvalue *= 1e8; exp-=8; }` |
|     302 |  395 | `          while( realvalue<1.0 && exp>=-350 ){ realvalue *= 10.0; exp--; }` |
|     248 |  396 | `          if( exp>350 \|\| exp<-350 ){` |
...
|       - |  406 | `        */` |
|     274 |  407 | `        flag_exp = xtype==SXFMT_EXP;` |
|     274 |  408 | `        if( xtype!=SXFMT_FLOAT ){` |
|     272 |  409 | `          realvalue += rounder;` |
|     272 |  410 | `          if( realvalue>=10.0 ){ realvalue *= 0.1; exp++; }` |
|     135 |  411 | `        }` |
|     274 |  412 | `        if( xtype==SXFMT_GENERIC ){` |
|     272 |  413 | `          flag_rtz = !flag_alternateform;` |
|     272 |  414 | `          if( exp<-4 \|\| exp>precision ){` |
|     ! 0 |  415 | `            xtype = SXFMT_EXP;` |
|     ! 0 |  416 | `          }else{` |
|     272 |  417 | `            precision = precision - exp;` |
|     272 |  418 | `            xtype = SXFMT_FLOAT;` |
|       - |  419 | `          }` |
|     137 |  420 | `        }else{` |
|       3 |  421 | `          flag_rtz = 0;` |
|       - |  422 | `        }` |
...
|       - |  426 | `        */` |
|     274 |  427 | `        nsd = 0;` |
|     410 |  428 | `        if( xtype==SXFMT_FLOAT && exp+precision<SXFMT_BUFSIZ-30 ){` |
|     274 |  429 | `          flag_dp = (precision>0 \|\| flag_alternateform);` |
|     274 |  430 | `          if( prefix ) *(bufpt++) = prefix;         /* Sign */` |
|     274 |  431 | `          if( exp<0 )  *(bufpt++) = '0';            /* Digits before "." */` |
|     664 |  432 | `          else for(; exp>=0; exp--) *(bufpt++) = (char)getdigit(&realvalue,&nsd);` |
|     274 |  433 | `          if( flag_dp ) *(bufpt++) = '.';           /* The decimal point */` |
|     290 |  434 | `          for(exp++; exp<0 && precision>0; precision--, exp++){` |
|      17 |  435 | `            *(bufpt++) = '0';` |
|       9 |  436 | `          }` |
|    3868 |  437 | `          while( (precision--)>0 ) *(bufpt++) = (char)getdigit(&realvalue,&nsd);` |
|     274 |  438 | `          *(bufpt--) = 0;                           /* Null terminate */` |
|     274 |  439 | `          if( flag_rtz && flag_dp ){     /* Remove trailing zeros and "." */` |
|    2890 |  440 | `            while( bufpt>=buf && *bufpt=='0' ) *(bufpt--) = 0;` |
|     272 |  441 | `            if( bufpt>=buf && *bufpt=='.' ) *(bufpt--) = 0;` |
|     135 |  442 | `          }` |
|     274 |  443 | `          bufpt++;                            /* point to next free slot */` |
|     138 |  444 | `        }else{    /* etEXP or etGENERIC */` |
...
|       3 |  501 | `        length = 1;` |
|       3 |  502 | `        break;` |
|    4806 |  503 | `      case SXFMT_CHARX:` |
|    9614 |  504 | `        c = va_arg(ap,int);` |
|    9614 |  505 | `		buf[0] = (char)c;` |
|       - |  506 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|    9614 |  507 | `		if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|    9614 |  508 | `        if( precision>=0 ){` |
...
|    9614 |  514 | `        bufpt = buf;` |
|    9614 |  515 | `        break;` |
|  118956 |  516 | `      case SXFMT_STRING:` |
|  237914 |  517 | `        bufpt = va_arg(ap,char*);` |
|  237914 |  518 | `        if( bufpt==0 ){` |
|     ! 0 |  519 | `          bufpt = " ";` |
|     ! 0 |  520 | `		  length = (int)sizeof(" ")-1;` |
|     ! 0 |  521 | `		  break;` |
|       - |  522 | `        }` |
|  237914 |  523 | `		length = precision;` |
|  237914 |  524 | `		if( precision < 0 ){` |
|       - |  525 | `			/* Symisc extension */` |
|    1158 |  526 | `			length = (int)SyStrlen(bufpt);` |
|     578 |  527 | `		}` |
|  237914 |  528 | `        if( precision>=0 && precision<length ) length = precision;` |
|  237914 |  529 | `        break;` |
|  245866 |  530 | `	case SXFMT_RAWSTR:{` |
|       - |  531 | `		/* Symisc extension */` |
|  491734 |  532 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  491734 |  533 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|     ! 0 |  534 | `			 bufpt = " ";` |
|     ! 0 |  535 | `		     length = (int)sizeof(char);` |
|     ! 0 |  536 | `		     break;` |
|       - |  537 | `		}` |
|  491734 |  538 | `		bufpt = (char *)pStr->zString;` |
|  491734 |  539 | `		length = (int)pStr->nByte;` |
|  491734 |  540 | `		break;` |
|       - |  541 | `					  }` |
...
|       - |  552 | `    ** the output.` |
|       - |  553 | `    */` |
|  795830 |  554 | `    if( !flag_leftjustify ){` |
|       - |  555 | `      register int nspace;` |
|  795830 |  556 | `      nspace = width-length;` |
|  795830 |  557 | `      if( nspace>0 ){` |
...
|      18 |  571 | `      }` |
|  397914 |  572 | `    }` |
|  795830 |  573 | `    if( length>0 ){` |
|  795806 |  574 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  795806 |  575 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  576 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|       - |  577 | `		}` |
|  397902 |  578 | `    }` |
|  795830 |  579 | `    if( flag_leftjustify ){` |
...
|     ! 0 |  596 | `      }` |
|     ! 0 |  597 | `    }` |
|  397916 |  598 | `  }/* End for loop over the format string */` |
|   64960 |  599 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|  151993 |  600 |  |
|       - |  601 | `/* SPDX-SnippetEnd */` |
| 1746424 |  602 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|       2 |  603 |  |
| 1746426 |  604 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 1746426 |  605 | `	sxi32 rc = SXERR_ABORT;` |
| 1746426 |  606 | `	switch(pConsumer->nType){` |
...
|     157 |  610 | `			break;` |
|  873134 |  611 | `	case SXFMT_CONS_BLOB:` |
|       - |  612 | `			/* Blob consumer */` |
| 1746270 |  613 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 1746268 |  614 | `			break;` |
|     ! 0 |  615 | `		default:` |
...
| 1746426 |  620 | `	pConsumer->nLen += nLen;` |
| 1746426 |  621 | `	pConsumer->rc = rc;` |
| 1746426 |  622 | `	return rc;` |
|       2 |  623 |  |
|  303982 |  624 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|       2 |  625 |  |
|       - |  626 | `	SyFmtConsumer sCons;` |
|  303984 |  627 | `	sCons.nType = nType;` |
|  303984 |  628 | `	sCons.rc = SXRET_OK;` |
|  303984 |  629 | `	sCons.nLen = 0;` |
|  303984 |  630 | `	if( pOutLen ){` |
|   67250 |  631 | `		*pOutLen = 0;` |
|   33624 |  632 | `	}` |
|  303984 |  633 | `	switch(nType){` |
...
|      13 |  642 | `		break;` |
|  151985 |  643 | `		case SXFMT_CONS_BLOB:` |
|  303972 |  644 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  303972 |  645 | `			break;` |
|     ! 0 |  646 | `		default:` |
|     ! 0 |  647 | `			return SXERR_UNKNOWN;` |
|       - |  648 | `	}` |
|  303984 |  649 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  303984 |  650 | `	if( pOutLen ){` |
|   67250 |  651 | `		*pOutLen = sCons.nLen;` |
|   33624 |  652 | `	}` |
|  303984 |  653 | `	return sCons.rc;` |
|  151993 |  654 |  |
...
|      13 |  667 | `	return rc;` |
|       1 |  668 |  |
|   65760 |  669 | `PH7_PRIVATE sxu32 SyBlobFormat(SyBlob *pBlob,const char *zFormat,...)` |
|       2 |  670 |  |
|       - |  671 | `	va_list ap;` |
|       - |  672 | `	sxu32 n;` |
...
|       - |  676 | `	}` |
|       - |  677 | `#endif` |
|   65762 |  678 | `	va_start(ap,zFormat);` |
|   65762 |  679 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|   65762 |  680 | `	va_end(ap);` |
|   65762 |  681 | `	return n;` |
|       2 |  682 |  |
|    1488 |  683 | `PH7_PRIVATE sxu32 SyBlobFormatAp(SyBlob *pBlob,const char *zFormat,va_list ap)` |
|       2 |  684 |  |
|    1490 |  685 | `	sxu32 n = 0; /* cc warning */` |
|       - |  686 | `#if defined(UNTRUST)` |
|       - |  687 | `	if( SX_EMPTY_STR(zFormat) ){` |
|       - |  688 | `		return 0;` |
|       - |  689 | `	}` |
|       - |  690 | `#endif` |
|    1490 |  691 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    1490 |  692 | `	return n;` |
|       2 |  693 |  |
|  236722 |  694 | `PH7_PRIVATE sxu32 SyBufferFormat(char *zBuf,sxu32 nLen,const char *zFormat,...)` |
|       2 |  695 |  |
|       - |  696 | `	SyBlob sBlob;` |
|       - |  697 | `	va_list ap;` |
|       - |  698 | `	sxu32 n;` |
...
|       - |  702 | `	}` |
|       - |  703 | `#endif` |
|  236724 |  704 | `	if( SXRET_OK != SyBlobInitFromBuf(&sBlob,zBuf,nLen - 1) ){` |
|     ! 0 |  705 | `		return 0;` |
|       - |  706 | `	}` |
|  236724 |  707 | `	va_start(ap,zFormat);` |
|  236724 |  708 | `	FormatMount(SXFMT_CONS_BLOB,&sBlob,0,0,0,zFormat,ap);` |
|  236724 |  709 | `	va_end(ap);` |
|  236724 |  710 | `	n = SyBlobLength(&sBlob);` |
|       - |  711 | `	/* Append the null terminator */` |
|  236724 |  712 | `	sBlob.mByte++;` |
|  236724 |  713 | `	SyBlobAppend(&sBlob,"\0",sizeof(char));` |
|  236724 |  714 | `	return n;` |
|  118363 |  715 |  |
|       - |  716 |  |
