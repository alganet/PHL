...
|       - |   90 | ` */` |
|  325926 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|       5 |   92 |  |
|       - |   93 | `	/*` |
...
|  325931 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|  325931 |  153 | `  length = 0;` |
|  325931 |  154 | `  bufpt = 0;` |
| 1185777 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
| 1119765 |  156 | `    if( c!='%' ){` |
|       - |  157 | `      unsigned int amt;` |
| 1033691 |  158 | `      bufpt = (char *)zFormat;` |
| 1033691 |  159 | `      amt = 1;` |
| 1632565 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
| 1033691 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
| 1033691 |  162 | `	  if( rc != SXRET_OK ){` |
|     ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|       - |  164 | `	  }` |
| 1033691 |  165 | `      if( c==0 ){` |
|  259919 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|       - |  167 | `	  }` |
|  386886 |  168 | `    }` |
|  859851 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|     ! 0 |  170 | `      errorflag = 1;` |
...
|  859851 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  859846 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  429923 |  180 | `    do{` |
|  859969 |  181 | `      switch( c ){` |
...
|  859846 |  187 | `        default:                                       break;` |
|       - |  188 | `      }` |
|  859969 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|     ! 0 |  198 | `      c = *++zFormat;` |
|     ! 0 |  199 | `    }else{` |
|  860011 |  200 | `      while( c>='0' && c<='9' ){` |
|     162 |  201 | `        width = width*10 + c - '0';` |
|     162 |  202 | `        c = *++zFormat;` |
|       2 |  203 | `      }` |
|       - |  204 | `    }` |
|  859851 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|     ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|     ! 0 |  207 | `    }` |
|       - |  208 | `    /* Get the precision */` |
|  859851 |  209 | `	precision = -1;` |
|  859851 |  210 | `    if( c=='.' ){` |
|  257599 |  211 | `      precision = 0;` |
|  257599 |  212 | `      c = *++zFormat;` |
|  257599 |  213 | `      if( c=='*' ){` |
|  257303 |  214 | `        precision = va_arg(ap,int);` |
|  257303 |  215 | `        if( precision<0 ) precision = -precision;` |
|  257303 |  216 | `        c = *++zFormat;` |
|  128654 |  217 | `      }else{` |
...
|  859851 |  225 | `	flag_long = 0;` |
|  859851 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
|   54939 |  227 | `      flag_long = (c == 'q') ? 2 : 1;` |
|   54939 |  228 | `      c = *++zFormat;` |
|   54939 |  229 | `	  if( c == 'l' ){` |
...
|  859851 |  235 | `    infop = 0;` |
|  859851 |  236 | `    xtype = SXFMT_ERROR;` |
| 3820093 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 3820093 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  859851 |  239 | `        infop = &aFmt[idx];` |
|  859851 |  240 | `		xtype = infop->type;` |
|  859851 |  241 | `        break;` |
|       - |  242 | `      }` |
| 1480126 |  243 | `    }` |
...
|       - |  263 | `    */` |
|  859851 |  264 | `    switch( xtype ){` |
|   28595 |  265 | `      case SXFMT_RADIX:` |
|   57195 |  266 | `        if( flag_long > 0 ){` |
|   54939 |  267 | `			if( flag_long > 1 ){` |
|       - |  268 | `				/* BSD quad: expect a 64-bit integer */` |
|   54927 |  269 | `				longvalue = va_arg(ap,sxi64);` |
|   27466 |  270 | `			}else{` |
|      13 |  271 | `				longvalue = va_arg(ap,sxlong);` |
|       - |  272 | `			}` |
|   27472 |  273 | `		}else{` |
|    2261 |  274 | `			if( infop->flags & SXFLAG_SIGNED ){` |
|    1131 |  275 | `				longvalue = va_arg(ap,sxi32);` |
|     568 |  276 | `			}else{` |
|    1135 |  277 | `				longvalue = va_arg(ap,sxu32);` |
|       - |  278 | `			}` |
|       - |  279 | `		}` |
|       - |  280 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|   57195 |  281 | `      if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|       - |  282 | `#if 1` |
|       - |  283 | `        /* For the format %#x, the value zero is printed "0" not "0x0".` |
|       - |  284 | `        ** I think this is stupid.*/` |
|   57195 |  285 | `        if( longvalue==0 ) flag_alternateform = 0;` |
|       - |  286 | `#else` |
...
|       - |  290 | `#endif` |
|   57195 |  291 | `        if( infop->flags & SXFLAG_SIGNED ){` |
|   56055 |  292 | `          if( longvalue<0 ){` |
...
|     110 |  297 | `            prefix = '-';` |
|      56 |  298 | `          }else{` |
|   55947 |  299 | `            ulongvalue = (sxu64)longvalue;` |
|   55947 |  300 | `            if( flag_plussign )        prefix = '+';` |
|   55945 |  301 | `            else if( flag_blanksign )  prefix = ' ';` |
|   55945 |  302 | `            else                       prefix = 0;` |
|       - |  303 | `          }` |
|   28030 |  304 | `        }else{` |
|    1145 |  305 | `			ulongvalue = (sxu64)longvalue; /* print the full unsigned value as-is */` |
|    1145 |  306 | `			prefix = 0;` |
|       - |  307 | `		}` |
|   57195 |  308 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|     101 |  309 | `          precision = width-(prefix!=0);` |
|      50 |  310 | `        }` |
|   57195 |  311 | `        bufpt = &buf[SXFMT_BUFSIZ-1];` |
|       - |  312 | `        {` |
|       - |  313 | `          register char *cset;      /* Use registers for speed */` |
|       - |  314 | `          register int base;` |
|   57195 |  315 | `          cset = infop->charset;` |
|   57195 |  316 | `          base = infop->base;` |
|   28595 |  317 | `          do{                                           /* Convert to ascii */` |
|  174787 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|  174787 |  319 | `            ulongvalue = ulongvalue/base;` |
|  174787 |  320 | `          }while( ulongvalue>0 );` |
|       - |  321 | `        }` |
|   57195 |  322 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|   57253 |  323 | `        for(idx=precision-length; idx>0; idx--){` |
|      59 |  324 | `          *(--bufpt) = '0';                             /* Zero pad */` |
|      30 |  325 | `        }` |
|   57195 |  326 | `        if( prefix ) *(--bufpt) = prefix;               /* Add sign */` |
|   57195 |  327 | `        if( flag_alternateform && infop->prefix ){      /* Add "0" or "0x" */` |
|       - |  328 | `          char *pre, x;` |
...
|       2 |  332 | `          }` |
|       2 |  333 | `        }` |
|   57195 |  334 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|   57195 |  335 | `        break;` |
...
|   10037 |  499 | `        c = va_arg(ap,int);` |
|   10037 |  500 | `		buf[0] = (char)c;` |
|       - |  501 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|   10037 |  502 | `		if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|   10037 |  503 | `        if( precision>=0 ){` |
...
|   10037 |  509 | `        bufpt = buf;` |
|   10037 |  510 | `        break;` |
|  129259 |  511 | `      case SXFMT_STRING:` |
|  258523 |  512 | `        bufpt = va_arg(ap,char*);` |
|  258523 |  513 | `        if( bufpt==0 ){` |
|     ! 0 |  514 | `          bufpt = " ";` |
|     ! 0 |  515 | `		  length = (int)sizeof(" ")-1;` |
|     ! 0 |  516 | `		  break;` |
|       - |  517 | `        }` |
|  258523 |  518 | `		length = precision;` |
|  258523 |  519 | `		if( precision < 0 ){` |
|       - |  520 | `			/* Symisc extension */` |
|    1227 |  521 | `			length = (int)SyStrlen(bufpt);` |
|     611 |  522 | `		}` |
|  258523 |  523 | `        if( precision>=0 && precision<length ) length = precision;` |
|  258523 |  524 | `        break;` |
|  266897 |  525 | `	case SXFMT_RAWSTR:{` |
|       - |  526 | `		/* Symisc extension */` |
|  533799 |  527 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  533799 |  528 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|     ! 0 |  529 | `			 bufpt = " ";` |
|     ! 0 |  530 | `		     length = (int)sizeof(char);` |
|     ! 0 |  531 | `		     break;` |
|       - |  532 | `		}` |
|  533799 |  533 | `		bufpt = (char *)pStr->zString;` |
|  533799 |  534 | `		length = (int)pStr->nByte;` |
|  533799 |  535 | `		break;` |
|       - |  536 | `					  }` |
...
|       - |  547 | `    ** the output.` |
|       - |  548 | `    */` |
|  859851 |  549 | `    if( !flag_leftjustify ){` |
|       - |  550 | `      register int nspace;` |
|  859851 |  551 | `      nspace = width-length;` |
|  859851 |  552 | `      if( nspace>0 ){` |
...
|      18 |  566 | `      }` |
|  429923 |  567 | `    }` |
|  859851 |  568 | `    if( length>0 ){` |
|  859827 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  859827 |  570 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|       - |  572 | `		}` |
|  429911 |  573 | `    }` |
|  859851 |  574 | `    if( flag_leftjustify ){` |
...
|     ! 0 |  591 | `      }` |
|     ! 0 |  592 | `    }` |
|  429928 |  593 | `  }/* End for loop over the format string */` |
|   66017 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|  162968 |  595 |  |
|       - |  596 | `/* SPDX-SnippetEnd */` |
| 1893544 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|       5 |  598 |  |
| 1893549 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 1893549 |  600 | `	sxi32 rc = SXERR_ABORT;` |
| 1893549 |  601 | `	switch(pConsumer->nType){` |
...
|     157 |  605 | `			break;` |
|  946694 |  606 | `	case SXFMT_CONS_BLOB:` |
|       - |  607 | `			/* Blob consumer */` |
| 1893393 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 1893388 |  609 | `			break;` |
|     ! 0 |  610 | `		default:` |
...
| 1893549 |  615 | `	pConsumer->nLen += nLen;` |
| 1893549 |  616 | `	pConsumer->rc = rc;` |
| 1893549 |  617 | `	return rc;` |
|       5 |  618 |  |
|  325926 |  619 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|       5 |  620 |  |
|       - |  621 | `	SyFmtConsumer sCons;` |
|  325931 |  622 | `	sCons.nType = nType;` |
|  325931 |  623 | `	sCons.rc = SXRET_OK;` |
|  325931 |  624 | `	sCons.nLen = 0;` |
|  325931 |  625 | `	if( pOutLen ){` |
|   68565 |  626 | `		*pOutLen = 0;` |
|   34280 |  627 | `	}` |
|  325931 |  628 | `	switch(nType){` |
...
|      13 |  637 | `		break;` |
|  162957 |  638 | `		case SXFMT_CONS_BLOB:` |
|  325919 |  639 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  325919 |  640 | `			break;` |
|     ! 0 |  641 | `		default:` |
|     ! 0 |  642 | `			return SXERR_UNKNOWN;` |
|       - |  643 | `	}` |
|  325931 |  644 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  325931 |  645 | `	if( pOutLen ){` |
|   68565 |  646 | `		*pOutLen = sCons.nLen;` |
|   34280 |  647 | `	}` |
|  325931 |  648 | `	return sCons.rc;` |
|  162968 |  649 |  |
...
|      13 |  662 | `	return rc;` |
|       1 |  663 |  |
|   67068 |  664 | `PH7_PRIVATE sxu32 SyBlobFormat(SyBlob *pBlob,const char *zFormat,...)` |
|       5 |  665 |  |
|       - |  666 | `	va_list ap;` |
|       - |  667 | `	sxu32 n;` |
...
|       - |  671 | `	}` |
|       - |  672 | `#endif` |
|   67073 |  673 | `	va_start(ap,zFormat);` |
|   67073 |  674 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|   67073 |  675 | `	va_end(ap);` |
|   67073 |  676 | `	return n;` |
|       5 |  677 |  |
|    1492 |  678 | `PH7_PRIVATE sxu32 SyBlobFormatAp(SyBlob *pBlob,const char *zFormat,va_list ap)` |
|       5 |  679 |  |
|    1497 |  680 | `	sxu32 n = 0; /* cc warning */` |
|       - |  681 | `#if defined(UNTRUST)` |
|       - |  682 | `	if( SX_EMPTY_STR(zFormat) ){` |
|       - |  683 | `		return 0;` |
|       - |  684 | `	}` |
|       - |  685 | `#endif` |
|    1497 |  686 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    1497 |  687 | `	return n;` |
|       5 |  688 |  |
|  257354 |  689 | `PH7_PRIVATE sxu32 SyBufferFormat(char *zBuf,sxu32 nLen,const char *zFormat,...)` |
|       5 |  690 |  |
|       - |  691 | `	SyBlob sBlob;` |
|       - |  692 | `	va_list ap;` |
|       - |  693 | `	sxu32 n;` |
...
|       - |  697 | `	}` |
|       - |  698 | `#endif` |
|  257359 |  699 | `	if( SXRET_OK != SyBlobInitFromBuf(&sBlob,zBuf,nLen - 1) ){` |
|     ! 0 |  700 | `		return 0;` |
|       - |  701 | `	}` |
|  257359 |  702 | `	va_start(ap,zFormat);` |
|  257359 |  703 | `	FormatMount(SXFMT_CONS_BLOB,&sBlob,0,0,0,zFormat,ap);` |
|  257359 |  704 | `	va_end(ap);` |
|  257359 |  705 | `	n = SyBlobLength(&sBlob);` |
|       - |  706 | `	/* Append the null terminator */` |
|  257359 |  707 | `	sBlob.mByte++;` |
|  257359 |  708 | `	SyBlobAppend(&sBlob,"\0",sizeof(char));` |
|  257359 |  709 | `	return n;` |
|  128682 |  710 |  |
|       - |  711 |  |
