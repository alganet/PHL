...
|       - |   90 | ` */` |
|  331916 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|       5 |   92 |  |
|       - |   93 | `	/*` |
...
|  331921 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|  331921 |  153 | `  length = 0;` |
|  331921 |  154 | `  bufpt = 0;` |
| 1209823 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
| 1143745 |  156 | `    if( c!='%' ){` |
|       - |  157 | `      unsigned int amt;` |
| 1057567 |  158 | `      bufpt = (char *)zFormat;` |
| 1057567 |  159 | `      amt = 1;` |
| 1669755 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
| 1057567 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
| 1057567 |  162 | `	  if( rc != SXRET_OK ){` |
|     ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|       - |  164 | `	  }` |
| 1057567 |  165 | `      if( c==0 ){` |
|  265843 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|       - |  167 | `	  }` |
|  395862 |  168 | `    }` |
|  877907 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|     ! 0 |  170 | `      errorflag = 1;` |
...
|  877907 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  877902 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  438951 |  180 | `    do{` |
|  878065 |  181 | `      switch( c ){` |
...
|  877902 |  187 | `        default:                                       break;` |
|       - |  188 | `      }` |
|  878065 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|     ! 0 |  198 | `      c = *++zFormat;` |
|     ! 0 |  199 | `    }else{` |
|  878107 |  200 | `      while( c>='0' && c<='9' ){` |
|     203 |  201 | `        width = width*10 + c - '0';` |
|     203 |  202 | `        c = *++zFormat;` |
|       3 |  203 | `      }` |
|       - |  204 | `    }` |
|  877907 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|     ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|     ! 0 |  207 | `    }` |
|       - |  208 | `    /* Get the precision */` |
|  877907 |  209 | `	precision = -1;` |
|  877907 |  210 | `    if( c=='.' ){` |
|  263497 |  211 | `      precision = 0;` |
|  263497 |  212 | `      c = *++zFormat;` |
|  263497 |  213 | `      if( c=='*' ){` |
|  263201 |  214 | `        precision = va_arg(ap,int);` |
|  263201 |  215 | `        if( precision<0 ) precision = -precision;` |
|  263201 |  216 | `        c = *++zFormat;` |
|  131603 |  217 | `      }else{` |
...
|  877907 |  225 | `	flag_long = 0;` |
|  877907 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
|   54977 |  227 | `      flag_long = (c == 'q') ? 2 : 1;` |
|   54977 |  228 | `      c = *++zFormat;` |
|   54977 |  229 | `	  if( c == 'l' ){` |
...
|  877907 |  235 | `    infop = 0;` |
|  877907 |  236 | `    xtype = SXFMT_ERROR;` |
| 3905255 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 3905255 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  877907 |  239 | `        infop = &aFmt[idx];` |
|  877907 |  240 | `		xtype = infop->type;` |
|  877907 |  241 | `        break;` |
|       - |  242 | `      }` |
| 1513679 |  243 | `    }` |
...
|       - |  263 | `    */` |
|  877907 |  264 | `    switch( xtype ){` |
|   28774 |  265 | `      case SXFMT_RADIX:` |
|   57553 |  266 | `        if( flag_long > 0 ){` |
|   54977 |  267 | `			if( flag_long > 1 ){` |
|       - |  268 | `				/* BSD quad: expect a 64-bit integer */` |
|   54965 |  269 | `				longvalue = va_arg(ap,sxi64);` |
|   27485 |  270 | `			}else{` |
|      13 |  271 | `				longvalue = va_arg(ap,sxlong);` |
|       - |  272 | `			}` |
|   27491 |  273 | `		}else{` |
|    2581 |  274 | `			if( infop->flags & SXFLAG_SIGNED ){` |
|    1139 |  275 | `				longvalue = va_arg(ap,sxi32);` |
|     572 |  276 | `			}else{` |
|    1447 |  277 | `				longvalue = va_arg(ap,sxu32);` |
|       - |  278 | `			}` |
|       - |  279 | `		}` |
|       - |  280 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|   57553 |  281 | `      if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|       - |  282 | `#if 1` |
|       - |  283 | `        /* For the format %#x, the value zero is printed "0" not "0x0".` |
|       - |  284 | `        ** I think this is stupid.*/` |
|   57553 |  285 | `        if( longvalue==0 ) flag_alternateform = 0;` |
|       - |  286 | `#else` |
...
|       - |  290 | `#endif` |
|   57553 |  291 | `        if( infop->flags & SXFLAG_SIGNED ){` |
|   56101 |  292 | `          if( longvalue<0 ){` |
...
|     110 |  297 | `            prefix = '-';` |
|      56 |  298 | `          }else{` |
|   55993 |  299 | `            ulongvalue = (sxu64)longvalue;` |
|   55993 |  300 | `            if( flag_plussign )        prefix = '+';` |
|   55991 |  301 | `            else if( flag_blanksign )  prefix = ' ';` |
|   55991 |  302 | `            else                       prefix = 0;` |
|       - |  303 | `          }` |
|   28053 |  304 | `        }else{` |
|    1457 |  305 | `			ulongvalue = (sxu64)longvalue; /* print the full unsigned value as-is */` |
|    1457 |  306 | `			prefix = 0;` |
|       - |  307 | `		}` |
|   57553 |  308 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|     142 |  309 | `          precision = width-(prefix!=0);` |
|      70 |  310 | `        }` |
|   57553 |  311 | `        bufpt = &buf[SXFMT_BUFSIZ-1];` |
|       - |  312 | `        {` |
|       - |  313 | `          register char *cset;      /* Use registers for speed */` |
|       - |  314 | `          register int base;` |
|   57553 |  315 | `          cset = infop->charset;` |
|   57553 |  316 | `          base = infop->base;` |
|   28774 |  317 | `          do{                                           /* Convert to ascii */` |
|  175405 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|  175405 |  319 | `            ulongvalue = ulongvalue/base;` |
|  175405 |  320 | `          }while( ulongvalue>0 );` |
|       - |  321 | `        }` |
|   57553 |  322 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|   57891 |  323 | `        for(idx=precision-length; idx>0; idx--){` |
|     340 |  324 | `          *(--bufpt) = '0';                             /* Zero pad */` |
|     171 |  325 | `        }` |
|   57553 |  326 | `        if( prefix ) *(--bufpt) = prefix;               /* Add sign */` |
|   57553 |  327 | `        if( flag_alternateform && infop->prefix ){      /* Add "0" or "0x" */` |
|       - |  328 | `          char *pre, x;` |
...
|       2 |  332 | `          }` |
|       2 |  333 | `        }` |
|   57553 |  334 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|   57553 |  335 | `        break;` |
...
|   10038 |  509 | `        bufpt = buf;` |
|   10038 |  510 | `        break;` |
|  132219 |  511 | `      case SXFMT_STRING:` |
|  264443 |  512 | `        bufpt = va_arg(ap,char*);` |
|  264443 |  513 | `        if( bufpt==0 ){` |
|     ! 0 |  514 | `          bufpt = " ";` |
|     ! 0 |  515 | `		  length = (int)sizeof(" ")-1;` |
|     ! 0 |  516 | `		  break;` |
|       - |  517 | `        }` |
|  264443 |  518 | `		length = precision;` |
|  264443 |  519 | `		if( precision < 0 ){` |
|       - |  520 | `			/* Symisc extension */` |
|    1249 |  521 | `			length = (int)SyStrlen(bufpt);` |
|     622 |  522 | `		}` |
|  264443 |  523 | `        if( precision>=0 && precision<length ) length = precision;` |
|  264443 |  524 | `        break;` |
|  272786 |  525 | `	case SXFMT_RAWSTR:{` |
|       - |  526 | `		/* Symisc extension */` |
|  545577 |  527 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  545577 |  528 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|     ! 0 |  529 | `			 bufpt = " ";` |
|     ! 0 |  530 | `		     length = (int)sizeof(char);` |
|     ! 0 |  531 | `		     break;` |
|       - |  532 | `		}` |
|  545577 |  533 | `		bufpt = (char *)pStr->zString;` |
|  545577 |  534 | `		length = (int)pStr->nByte;` |
|  545577 |  535 | `		break;` |
|       - |  536 | `					  }` |
...
|       - |  547 | `    ** the output.` |
|       - |  548 | `    */` |
|  877907 |  549 | `    if( !flag_leftjustify ){` |
|       - |  550 | `      register int nspace;` |
|  877907 |  551 | `      nspace = width-length;` |
|  877907 |  552 | `      if( nspace>0 ){` |
...
|      18 |  566 | `      }` |
|  438951 |  567 | `    }` |
|  877907 |  568 | `    if( length>0 ){` |
|  877883 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  877883 |  570 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|       - |  572 | `		}` |
|  438939 |  573 | `    }` |
|  877907 |  574 | `    if( flag_leftjustify ){` |
...
|     ! 0 |  591 | `      }` |
|     ! 0 |  592 | `    }` |
|  438956 |  593 | `  }/* End for loop over the format string */` |
|   66083 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|  165963 |  595 |  |
|       - |  596 | `/* SPDX-SnippetEnd */` |
| 1935476 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|       5 |  598 |  |
| 1935481 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 1935481 |  600 | `	sxi32 rc = SXERR_ABORT;` |
| 1935481 |  601 | `	switch(pConsumer->nType){` |
...
|     157 |  605 | `			break;` |
|  967660 |  606 | `	case SXFMT_CONS_BLOB:` |
|       - |  607 | `			/* Blob consumer */` |
| 1935325 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 1935320 |  609 | `			break;` |
|     ! 0 |  610 | `		default:` |
...
| 1935481 |  615 | `	pConsumer->nLen += nLen;` |
| 1935481 |  616 | `	pConsumer->rc = rc;` |
| 1935481 |  617 | `	return rc;` |
|       5 |  618 |  |
|  331916 |  619 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|       5 |  620 |  |
|       - |  621 | `	SyFmtConsumer sCons;` |
|  331921 |  622 | `	sCons.nType = nType;` |
|  331921 |  623 | `	sCons.rc = SXRET_OK;` |
|  331921 |  624 | `	sCons.nLen = 0;` |
|  331921 |  625 | `	if( pOutLen ){` |
|   68663 |  626 | `		*pOutLen = 0;` |
|   34329 |  627 | `	}` |
|  331921 |  628 | `	switch(nType){` |
...
|      13 |  637 | `		break;` |
|  165952 |  638 | `		case SXFMT_CONS_BLOB:` |
|  331909 |  639 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  331909 |  640 | `			break;` |
|     ! 0 |  641 | `		default:` |
|     ! 0 |  642 | `			return SXERR_UNKNOWN;` |
|       - |  643 | `	}` |
|  331921 |  644 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  331921 |  645 | `	if( pOutLen ){` |
|   68663 |  646 | `		*pOutLen = sCons.nLen;` |
|   34329 |  647 | `	}` |
|  331921 |  648 | `	return sCons.rc;` |
|  165963 |  649 |  |
...
|      13 |  662 | `	return rc;` |
|       1 |  663 |  |
|   67142 |  664 | `PH7_PRIVATE sxu32 SyBlobFormat(SyBlob *pBlob,const char *zFormat,...)` |
|       5 |  665 |  |
|       - |  666 | `	va_list ap;` |
|       - |  667 | `	sxu32 n;` |
...
|       - |  671 | `	}` |
|       - |  672 | `#endif` |
|   67147 |  673 | `	va_start(ap,zFormat);` |
|   67147 |  674 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|   67147 |  675 | `	va_end(ap);` |
|   67147 |  676 | `	return n;` |
|       5 |  677 |  |
...
|    1521 |  687 | `	return n;` |
|       5 |  688 |  |
|  263246 |  689 | `PH7_PRIVATE sxu32 SyBufferFormat(char *zBuf,sxu32 nLen,const char *zFormat,...)` |
|       5 |  690 |  |
|       - |  691 | `	SyBlob sBlob;` |
|       - |  692 | `	va_list ap;` |
|       - |  693 | `	sxu32 n;` |
...
|       - |  697 | `	}` |
|       - |  698 | `#endif` |
|  263251 |  699 | `	if( SXRET_OK != SyBlobInitFromBuf(&sBlob,zBuf,nLen - 1) ){` |
|     ! 0 |  700 | `		return 0;` |
|       - |  701 | `	}` |
|  263251 |  702 | `	va_start(ap,zFormat);` |
|  263251 |  703 | `	FormatMount(SXFMT_CONS_BLOB,&sBlob,0,0,0,zFormat,ap);` |
|  263251 |  704 | `	va_end(ap);` |
|  263251 |  705 | `	n = SyBlobLength(&sBlob);` |
|       - |  706 | `	/* Append the null terminator */` |
|  263251 |  707 | `	sBlob.mByte++;` |
|  263251 |  708 | `	SyBlobAppend(&sBlob,"\0",sizeof(char));` |
|  263251 |  709 | `	return n;` |
|  131628 |  710 |  |
|       - |  711 |  |
