...
|        - |   90 | ` */` |
|  2527678 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|        5 |   92 | `{` |
|        - |   93 | `	/*` |
...
|  2527683 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|        - |  151 | `  int rc;` |
|        - |  152 |  |
|  2527683 |  153 | `  length = 0;` |
|  2527683 |  154 | `  bufpt = 0;` |
|  9936129 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
|  9840235 |  156 | `    if( c!='%' ){` |
|        - |  157 | `      unsigned int amt;` |
|  9705535 |  158 | `      bufpt = (char *)zFormat;` |
|  9705535 |  159 | `      amt = 1;` |
| 15366237 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
|  9705535 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
|  9705535 |  162 | `	  if( rc != SXRET_OK ){` |
|      ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  164 | `	  }` |
|  9705535 |  165 | `      if( c==0 ){` |
|  2431789 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|        - |  167 | `	  }` |
|  3636873 |  168 | `    }` |
|  7408451 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|      ! 0 |  170 | `      errorflag = 1;` |
...
|  7408451 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  7408446 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  3704223 |  180 | `    do{` |
|  7409803 |  181 | `      switch( c ){` |
...
|  7408446 |  187 | `        default:                                       break;` |
|        - |  188 | `      }` |
|  7409803 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|      ! 0 |  198 | `      c = *++zFormat;` |
|      ! 0 |  199 | `    }else{` |
|  7409847 |  200 | `      while( c>='0' && c<='9' ){` |
|     1399 |  201 | `        width = width*10 + c - '0';` |
|     1399 |  202 | `        c = *++zFormat;` |
|        3 |  203 | `      }` |
|        - |  204 | `    }` |
|  7408451 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|      ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|      ! 0 |  207 | `    }` |
|        - |  208 | `    /* Get the precision */` |
|  7408451 |  209 | `	precision = -1;` |
|  7408451 |  210 | `    if( c=='.' ){` |
|  2402641 |  211 | `      precision = 0;` |
|  2402641 |  212 | `      c = *++zFormat;` |
|  2402641 |  213 | `      if( c=='*' ){` |
|  2402629 |  214 | `        precision = va_arg(ap,int);` |
|  2402629 |  215 | `        if( precision<0 ) precision = -precision;` |
|  2402629 |  216 | `        c = *++zFormat;` |
|  1201317 |  217 | `      }else{` |
...
|  7408451 |  225 | `	flag_long = 0;` |
|  7408451 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
|    62307 |  227 | `      flag_long = (c == 'q') ? 2 : 1;` |
|    62307 |  228 | `      c = *++zFormat;` |
|    62307 |  229 | `	  if( c == 'l' ){` |
...
|  7408451 |  235 | `    infop = 0;` |
|  7408451 |  236 | `    xtype = SXFMT_ERROR;` |
| 34121345 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 34121345 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  7408451 |  239 | `        infop = &aFmt[idx];` |
|  7408451 |  240 | `		xtype = infop->type;` |
|  7408451 |  241 | `        break;` |
|        - |  242 | `      }` |
| 13356452 |  243 | `    }` |
...
|        - |  263 | `    */` |
|  7408451 |  264 | `    switch( xtype ){` |
|    35956 |  265 | `      case SXFMT_RADIX:` |
|    71917 |  266 | `        if( flag_long > 0 ){` |
|    62307 |  267 | `			if( flag_long > 1 ){` |
|        - |  268 | `				/* BSD quad: expect a 64-bit integer */` |
|    62295 |  269 | `				longvalue = va_arg(ap,sxi64);` |
|    31150 |  270 | `			}else{` |
|       13 |  271 | `				longvalue = va_arg(ap,sxlong);` |
|        - |  272 | `			}` |
|    31156 |  273 | `		}else{` |
|     9615 |  274 | `			if( infop->flags & SXFLAG_SIGNED ){` |
|     5129 |  275 | `				longvalue = va_arg(ap,sxi32);` |
|     2567 |  276 | `			}else{` |
|     4491 |  277 | `				longvalue = va_arg(ap,sxu32);` |
|        - |  278 | `			}` |
|        - |  279 | `		}` |
|        - |  280 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|    71917 |  281 | `      if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|        - |  282 | `#if 1` |
|        - |  283 | `        /* For the format %#x, the value zero is printed "0" not "0x0".` |
|        - |  284 | `        ** I think this is stupid.*/` |
|    71917 |  285 | `        if( longvalue==0 ) flag_alternateform = 0;` |
|        - |  286 | `#else` |
...
|        - |  290 | `#endif` |
|    71917 |  291 | `        if( infop->flags & SXFLAG_SIGNED ){` |
|    67373 |  292 | `          if( longvalue<0 ){` |
...
|      221 |  297 | `            prefix = '-';` |
|      112 |  298 | `          }else{` |
|    67155 |  299 | `            ulongvalue = (sxu64)longvalue;` |
|    67155 |  300 | `            if( flag_plussign )        prefix = '+';` |
|    67155 |  301 | `            else if( flag_blanksign )  prefix = ' ';` |
|    67155 |  302 | `            else                       prefix = 0;` |
|        - |  303 | `          }` |
|    33689 |  304 | `        }else{` |
|     4549 |  305 | `			ulongvalue = (sxu64)longvalue; /* print the full unsigned value as-is */` |
|     4549 |  306 | `			prefix = 0;` |
|        - |  307 | `		}` |
|    71917 |  308 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|     1340 |  309 | `          precision = width-(prefix!=0);` |
|      669 |  310 | `        }` |
|    71917 |  311 | `        bufpt = &buf[SXFMT_BUFSIZ-1];` |
|        - |  312 | `        {` |
|        - |  313 | `          register char *cset;      /* Use registers for speed */` |
|        - |  314 | `          register int base;` |
|    71917 |  315 | `          cset = infop->charset;` |
|    71917 |  316 | `          base = infop->base;` |
|    35956 |  317 | `          do{                                           /* Convert to ascii */` |
|   203748 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|   203748 |  319 | `            ulongvalue = ulongvalue/base;` |
|   203748 |  320 | `          }while( ulongvalue>0 );` |
|        - |  321 | `        }` |
|    71917 |  322 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    73030 |  323 | `        for(idx=precision-length; idx>0; idx--){` |
|     1115 |  324 | `          *(--bufpt) = '0';                             /* Zero pad */` |
|      559 |  325 | `        }` |
|    71917 |  326 | `        if( prefix ) *(--bufpt) = prefix;               /* Add sign */` |
|    71917 |  327 | `        if( flag_alternateform && infop->prefix ){      /* Add "0" or "0x" */` |
|        - |  328 | `          char *pre, x;` |
...
|        1 |  332 | `          }` |
|        1 |  333 | `        }` |
|    71917 |  334 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    71917 |  335 | `        break;` |
...
|      ! 0 |  496 | `        length = 1;` |
|      ! 0 |  497 | `        break;` |
|     4937 |  498 | `      case SXFMT_CHARX:` |
|     9879 |  499 | `        c = va_arg(ap,int);` |
|     9879 |  500 | `		buf[0] = (char)c;` |
|        - |  501 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|     9879 |  502 | `		if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|     9879 |  503 | `        if( precision>=0 ){` |
...
|     9879 |  509 | `        bufpt = buf;` |
|     9879 |  510 | `        break;` |
|  1247030 |  511 | `      case SXFMT_STRING:` |
|  2494065 |  512 | `        bufpt = va_arg(ap,char*);` |
|  2494065 |  513 | `        if( bufpt==0 ){` |
|      ! 0 |  514 | `          bufpt = " ";` |
|      ! 0 |  515 | `		  length = (int)sizeof(" ")-1;` |
|      ! 0 |  516 | `		  break;` |
|        - |  517 | `        }` |
|  2494065 |  518 | `		length = precision;` |
|  2494065 |  519 | `		if( precision < 0 ){` |
|        - |  520 | `			/* Symisc extension */` |
|    91429 |  521 | `			length = (int)SyStrlen(bufpt);` |
|    45712 |  522 | `		}` |
|  2494065 |  523 | `        if( precision>=0 && precision<length ) length = precision;` |
|  2494065 |  524 | `        break;` |
|  2416286 |  525 | `	case SXFMT_RAWSTR:{` |
|        - |  526 | `		/* Symisc extension */` |
|  4832577 |  527 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  4832577 |  528 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|      ! 0 |  529 | `			 bufpt = " ";` |
|      ! 0 |  530 | `		     length = (int)sizeof(char);` |
|      ! 0 |  531 | `		     break;` |
|        - |  532 | `		}` |
|  4832577 |  533 | `		bufpt = (char *)pStr->zString;` |
|  4832577 |  534 | `		length = (int)pStr->nByte;` |
|  4832577 |  535 | `		break;` |
|        - |  536 | `					  }` |
...
|        - |  547 | `    ** the output.` |
|        - |  548 | `    */` |
|  7408451 |  549 | `    if( !flag_leftjustify ){` |
|        - |  550 | `      register int nspace;` |
|  7408451 |  551 | `      nspace = width-length;` |
|  7408451 |  552 | `      if( nspace>0 ){` |
...
|       18 |  566 | `      }` |
|  3704223 |  567 | `    }` |
|  7408451 |  568 | `    if( length>0 ){` |
|  7408109 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  7408109 |  570 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  572 | `		}` |
|  3704052 |  573 | `    }` |
|  7408451 |  574 | `    if( flag_leftjustify ){` |
...
|      ! 0 |  591 | `      }` |
|      ! 0 |  592 | `    }` |
|  3704228 |  593 | `  }/* End for loop over the format string */` |
|    95899 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|  1263844 |  595 | `}` |
|        - |  596 | `/* SPDX-SnippetEnd */` |
| 17113670 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|        5 |  598 | `{` |
| 17113675 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 17113675 |  600 | `	sxi32 rc = SXERR_ABORT;` |
| 17113675 |  601 | `	switch(pConsumer->nType){` |
...
|      181 |  605 | `			break;` |
|  8556745 |  606 | `	case SXFMT_CONS_BLOB:` |
|        - |  607 | `			/* Blob consumer */` |
| 17113495 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 17113490 |  609 | `			break;` |
|      ! 0 |  610 | `		default:` |
...
| 17113675 |  615 | `	pConsumer->nLen += nLen;` |
| 17113675 |  616 | `	pConsumer->rc = rc;` |
| 17113675 |  617 | `	return rc;` |
|        5 |  618 | `}` |
|  2527678 |  619 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|        5 |  620 | `{` |
|        - |  621 | `	SyFmtConsumer sCons;` |
|  2527683 |  622 | `	sCons.nType = nType;` |
|  2527683 |  623 | `	sCons.rc = SXRET_OK;` |
|  2527683 |  624 | `	sCons.nLen = 0;` |
|  2527683 |  625 | `	if( pOutLen ){` |
|   120497 |  626 | `		*pOutLen = 0;` |
|    60246 |  627 | `	}` |
|  2527683 |  628 | `	switch(nType){` |
...
|       13 |  637 | `		break;` |
|  1263833 |  638 | `		case SXFMT_CONS_BLOB:` |
|  2527671 |  639 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  2527671 |  640 | `			break;` |
|      ! 0 |  641 | `		default:` |
|      ! 0 |  642 | `			return SXERR_UNKNOWN;` |
|        - |  643 | `	}` |
|  2527683 |  644 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  2527683 |  645 | `	if( pOutLen ){` |
|   120497 |  646 | `		*pOutLen = sCons.nLen;` |
|    60246 |  647 | `	}` |
|  2527683 |  648 | `	return sCons.rc;` |
|  1263844 |  649 | `}` |
...
|       13 |  662 | `	return rc;` |
|        1 |  663 | `}` |
|    96708 |  664 | `PH7_PRIVATE sxu32 SyBlobFormat(SyBlob *pBlob,const char *zFormat,...)` |
|        5 |  665 | `{` |
|        - |  666 | `	va_list ap;` |
|        - |  667 | `	sxu32 n;` |
...
|        - |  671 | `	}` |
|        - |  672 | `#endif` |
|    96713 |  673 | `	va_start(ap,zFormat);` |
|    96713 |  674 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    96713 |  675 | `	va_end(ap);` |
|    96713 |  676 | `	return n;` |
|        5 |  677 | `}` |
|    23784 |  678 | `PH7_PRIVATE sxu32 SyBlobFormatAp(SyBlob *pBlob,const char *zFormat,va_list ap)` |
|        5 |  679 | `{` |
|    23789 |  680 | `	sxu32 n = 0; /* cc warning */` |
|        - |  681 | `#if defined(UNTRUST)` |
|        - |  682 | `	if( SX_EMPTY_STR(zFormat) ){` |
|        - |  683 | `		return 0;` |
|        - |  684 | `	}` |
|        - |  685 | `#endif` |
|    23789 |  686 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    23789 |  687 | `	return n;` |
|        5 |  688 | `}` |
|  2407174 |  689 | `PH7_PRIVATE sxu32 SyBufferFormat(char *zBuf,sxu32 nLen,const char *zFormat,...)` |
|        5 |  690 | `{` |
|        - |  691 | `	SyBlob sBlob;` |
|        - |  692 | `	va_list ap;` |
|        - |  693 | `	sxu32 n;` |
...
|        - |  697 | `	}` |
|        - |  698 | `#endif` |
|  2407179 |  699 | `	if( SXRET_OK != SyBlobInitFromBuf(&sBlob,zBuf,nLen - 1) ){` |
|      ! 0 |  700 | `		return 0;` |
|        - |  701 | `	}` |
|  2407179 |  702 | `	va_start(ap,zFormat);` |
|  2407179 |  703 | `	FormatMount(SXFMT_CONS_BLOB,&sBlob,0,0,0,zFormat,ap);` |
|  2407179 |  704 | `	va_end(ap);` |
|  2407179 |  705 | `	n = SyBlobLength(&sBlob);` |
|        - |  706 | `	/* Append the null terminator */` |
|  2407179 |  707 | `	sBlob.mByte++;` |
|  2407179 |  708 | `	SyBlobAppend(&sBlob,"\0",sizeof(char));` |
|  2407179 |  709 | `	return n;` |
|  1203592 |  710 | `}` |
|        - |  711 |  |
