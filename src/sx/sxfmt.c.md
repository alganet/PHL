...
|        - |   90 | ` */` |
|  3029940 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|        5 |   92 | `{` |
|        - |   93 | `	/*` |
...
|  3029945 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|        - |  151 | `  int rc;` |
|        - |  152 |  |
|  3029945 |  153 | `  length = 0;` |
|  3029945 |  154 | `  bufpt = 0;` |
| 11948499 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
| 11853597 |  156 | `    if( c!='%' ){` |
|        - |  157 | `      unsigned int amt;` |
| 11721559 |  158 | `      bufpt = (char *)zFormat;` |
| 11721559 |  159 | `      amt = 1;` |
| 18392467 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
| 11721559 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
| 11721559 |  162 | `	  if( rc != SXRET_OK ){` |
|      ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  164 | `	  }` |
| 11721559 |  165 | `      if( c==0 ){` |
|  2935043 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|        - |  167 | `	  }` |
|  4393258 |  168 | `    }` |
|  8918559 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|      ! 0 |  170 | `      errorflag = 1;` |
...
|  8918559 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  8918554 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  4459277 |  180 | `    do{` |
|  8919893 |  181 | `      switch( c ){` |
...
|  8918554 |  187 | `        default:                                       break;` |
|        - |  188 | `      }` |
|  8919893 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|      ! 0 |  198 | `      c = *++zFormat;` |
|      ! 0 |  199 | `    }else{` |
|  8919931 |  200 | `      while( c>='0' && c<='9' ){` |
|     1375 |  201 | `        width = width*10 + c - '0';` |
|     1375 |  202 | `        c = *++zFormat;` |
|        3 |  203 | `      }` |
|        - |  204 | `    }` |
|  8918559 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|      ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|      ! 0 |  207 | `    }` |
|        - |  208 | `    /* Get the precision */` |
|  8918559 |  209 | `	precision = -1;` |
|  8918559 |  210 | `    if( c=='.' ){` |
|  2907115 |  211 | `      precision = 0;` |
|  2907115 |  212 | `      c = *++zFormat;` |
|  2907115 |  213 | `      if( c=='*' ){` |
|  2907103 |  214 | `        precision = va_arg(ap,int);` |
|  2907103 |  215 | `        if( precision<0 ) precision = -precision;` |
|  2907103 |  216 | `        c = *++zFormat;` |
|  1453554 |  217 | `      }else{` |
...
|  8918559 |  225 | `	flag_long = 0;` |
|  8918559 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
...
|  8918559 |  235 | `    infop = 0;` |
|  8918559 |  236 | `    xtype = SXFMT_ERROR;` |
| 41167797 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 41167797 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  8918559 |  239 | `        infop = &aFmt[idx];` |
|  8918559 |  240 | `		xtype = infop->type;` |
|  8918559 |  241 | `        break;` |
|        - |  242 | `      }` |
| 16124624 |  243 | `    }` |
...
|   202285 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|   202285 |  319 | `            ulongvalue = ulongvalue/base;` |
|   202285 |  320 | `          }while( ulongvalue>0 );` |
|        - |  321 | `        }` |
...
|     9362 |  509 | `        bufpt = buf;` |
|     9362 |  510 | `        break;` |
|  1498695 |  511 | `      case SXFMT_STRING:` |
|  2997395 |  512 | `        bufpt = va_arg(ap,char*);` |
|  2997395 |  513 | `        if( bufpt==0 ){` |
|      ! 0 |  514 | `          bufpt = " ";` |
|      ! 0 |  515 | `		  length = (int)sizeof(" ")-1;` |
|      ! 0 |  516 | `		  break;` |
|        - |  517 | `        }` |
|  2997395 |  518 | `		length = precision;` |
|  2997395 |  519 | `		if( precision < 0 ){` |
|        - |  520 | `			/* Symisc extension */` |
|    90285 |  521 | `			length = (int)SyStrlen(bufpt);` |
|    45140 |  522 | `		}` |
|  2997395 |  523 | `        if( precision>=0 && precision<length ) length = precision;` |
|  2997395 |  524 | `        break;` |
|  2920273 |  525 | `	case SXFMT_RAWSTR:{` |
|        - |  526 | `		/* Symisc extension */` |
|  5840551 |  527 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  5840551 |  528 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|      ! 0 |  529 | `			 bufpt = " ";` |
|      ! 0 |  530 | `		     length = (int)sizeof(char);` |
|      ! 0 |  531 | `		     break;` |
|        - |  532 | `		}` |
|  5840551 |  533 | `		bufpt = (char *)pStr->zString;` |
|  5840551 |  534 | `		length = (int)pStr->nByte;` |
|  5840551 |  535 | `		break;` |
|        - |  536 | `					  }` |
...
|        - |  547 | `    ** the output.` |
|        - |  548 | `    */` |
|  8918559 |  549 | `    if( !flag_leftjustify ){` |
|        - |  550 | `      register int nspace;` |
|  8918559 |  551 | `      nspace = width-length;` |
|  8918559 |  552 | `      if( nspace>0 ){` |
...
|       18 |  566 | `      }` |
|  4459277 |  567 | `    }` |
|  8918559 |  568 | `    if( length>0 ){` |
|  8918229 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  8918229 |  570 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  572 | `		}` |
|  4459112 |  573 | `    }` |
|  8918559 |  574 | `    if( flag_leftjustify ){` |
...
|      ! 0 |  591 | `      }` |
|      ! 0 |  592 | `    }` |
|  4459282 |  593 | `  }/* End for loop over the format string */` |
|    94907 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|  1514975 |  595 | `}` |
|        - |  596 | `/* SPDX-SnippetEnd */` |
| 20639814 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|        5 |  598 | `{` |
| 20639819 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 20639819 |  600 | `	sxi32 rc = SXERR_ABORT;` |
| 20639819 |  601 | `	switch(pConsumer->nType){` |
...
|      181 |  605 | `			break;` |
| 10319817 |  606 | `	case SXFMT_CONS_BLOB:` |
|        - |  607 | `			/* Blob consumer */` |
| 20639639 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 20639634 |  609 | `			break;` |
|      ! 0 |  610 | `		default:` |
...
| 20639819 |  615 | `	pConsumer->nLen += nLen;` |
| 20639819 |  616 | `	pConsumer->rc = rc;` |
| 20639819 |  617 | `	return rc;` |
|        5 |  618 | `}` |
|  3029940 |  619 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|        5 |  620 | `{` |
|        - |  621 | `	SyFmtConsumer sCons;` |
|  3029945 |  622 | `	sCons.nType = nType;` |
|  3029945 |  623 | `	sCons.rc = SXRET_OK;` |
|  3029945 |  624 | `	sCons.nLen = 0;` |
|  3029945 |  625 | `	if( pOutLen ){` |
|   118461 |  626 | `		*pOutLen = 0;` |
|    59228 |  627 | `	}` |
|  3029945 |  628 | `	switch(nType){` |
...
|       13 |  637 | `		break;` |
|  1514964 |  638 | `		case SXFMT_CONS_BLOB:` |
|  3029933 |  639 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  3029933 |  640 | `			break;` |
|      ! 0 |  641 | `		default:` |
|      ! 0 |  642 | `			return SXERR_UNKNOWN;` |
|        - |  643 | `	}` |
|  3029945 |  644 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  3029945 |  645 | `	if( pOutLen ){` |
|   118461 |  646 | `		*pOutLen = sCons.nLen;` |
|    59228 |  647 | `	}` |
|  3029945 |  648 | `	return sCons.rc;` |
|  1514975 |  649 | `}` |
...
|       13 |  662 | `	return rc;` |
|        1 |  663 | `}` |
|    95152 |  664 | `PH7_PRIVATE sxu32 SyBlobFormat(SyBlob *pBlob,const char *zFormat,...)` |
|        5 |  665 | `{` |
|        - |  666 | `	va_list ap;` |
|        - |  667 | `	sxu32 n;` |
...
|        - |  671 | `	}` |
|        - |  672 | `#endif` |
|    95157 |  673 | `	va_start(ap,zFormat);` |
|    95157 |  674 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    95157 |  675 | `	va_end(ap);` |
|    95157 |  676 | `	return n;` |
|        5 |  677 | `}` |
|    23304 |  678 | `PH7_PRIVATE sxu32 SyBlobFormatAp(SyBlob *pBlob,const char *zFormat,va_list ap)` |
|        5 |  679 | `{` |
|    23309 |  680 | `	sxu32 n = 0; /* cc warning */` |
|        - |  681 | `#if defined(UNTRUST)` |
|        - |  682 | `	if( SX_EMPTY_STR(zFormat) ){` |
|        - |  683 | `		return 0;` |
|        - |  684 | `	}` |
|        - |  685 | `#endif` |
|    23309 |  686 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    23309 |  687 | `	return n;` |
|        5 |  688 | `}` |
|  2911472 |  689 | `PH7_PRIVATE sxu32 SyBufferFormat(char *zBuf,sxu32 nLen,const char *zFormat,...)` |
|        5 |  690 | `{` |
|        - |  691 | `	SyBlob sBlob;` |
|        - |  692 | `	va_list ap;` |
|        - |  693 | `	sxu32 n;` |
...
|        - |  697 | `	}` |
|        - |  698 | `#endif` |
|  2911477 |  699 | `	if( SXRET_OK != SyBlobInitFromBuf(&sBlob,zBuf,nLen - 1) ){` |
|      ! 0 |  700 | `		return 0;` |
|        - |  701 | `	}` |
|  2911477 |  702 | `	va_start(ap,zFormat);` |
|  2911477 |  703 | `	FormatMount(SXFMT_CONS_BLOB,&sBlob,0,0,0,zFormat,ap);` |
|  2911477 |  704 | `	va_end(ap);` |
|  2911477 |  705 | `	n = SyBlobLength(&sBlob);` |
|        - |  706 | `	/* Append the null terminator */` |
|  2911477 |  707 | `	sBlob.mByte++;` |
|  2911477 |  708 | `	SyBlobAppend(&sBlob,"\0",sizeof(char));` |
|  2911477 |  709 | `	return n;` |
|  1455741 |  710 | `}` |
|        - |  711 |  |
