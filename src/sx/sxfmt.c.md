...
|        - |   90 | ` */` |
|  2520776 |   91 | `static sxi32 InternFormat(ProcConsumer xConsumer,void *pUserData,const char *zFormat,va_list ap)` |
|        5 |   92 | `{` |
|        - |   93 | `	/*` |
...
|  2520781 |  138 | `  sxu8 errorflag = 0;      /* True if an error is encountered */` |
...
|        - |  151 | `  int rc;` |
|        - |  152 |  |
|  2520781 |  153 | `  length = 0;` |
|  2520781 |  154 | `  bufpt = 0;` |
|  9909063 |  155 | `  for(; (c=(*zFormat))!=0; ++zFormat){` |
|  9813439 |  156 | `    if( c!='%' ){` |
|        - |  157 | `      unsigned int amt;` |
|  9679279 |  158 | `      bufpt = (char *)zFormat;` |
|  9679279 |  159 | `      amt = 1;` |
| 15324181 |  160 | `      while( (c=(*++zFormat))!='%' && c!=0 ) amt++;` |
|  9679279 |  161 | `	  rc = xConsumer((const void *)bufpt,amt,pUserData);` |
|  9679279 |  162 | `	  if( rc != SXRET_OK ){` |
|      ! 0 |  163 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  164 | `	  }` |
|  9679279 |  165 | `      if( c==0 ){` |
|  2425157 |  166 | `		  return errorflag > 0 ? SXERR_FORMAT : SXRET_OK;` |
|        - |  167 | `	  }` |
|  3627061 |  168 | `    }` |
|  7388287 |  169 | `    if( (c=(*++zFormat))==0 ){` |
|      ! 0 |  170 | `      errorflag = 1;` |
...
|  7388287 |  178 | `    flag_leftjustify = flag_plussign = flag_blanksign =` |
|  7388282 |  179 | `     flag_alternateform = flag_zeropad = 0;` |
|  3694141 |  180 | `    do{` |
|  7389639 |  181 | `      switch( c ){` |
...
|  7388282 |  187 | `        default:                                       break;` |
|        - |  188 | `      }` |
|  7389639 |  189 | `    }while( c==0 && (c=(*++zFormat))!=0 );` |
...
|      ! 0 |  198 | `      c = *++zFormat;` |
|      ! 0 |  199 | `    }else{` |
|  7389683 |  200 | `      while( c>='0' && c<='9' ){` |
|     1399 |  201 | `        width = width*10 + c - '0';` |
|     1399 |  202 | `        c = *++zFormat;` |
|        3 |  203 | `      }` |
|        - |  204 | `    }` |
|  7388287 |  205 | `    if( width > SXFMT_BUFSIZ-10 ){` |
|      ! 0 |  206 | `      width = SXFMT_BUFSIZ-10;` |
|      ! 0 |  207 | `    }` |
|        - |  208 | `    /* Get the precision */` |
|  7388287 |  209 | `	precision = -1;` |
|  7388287 |  210 | `    if( c=='.' ){` |
|  2396239 |  211 | `      precision = 0;` |
|  2396239 |  212 | `      c = *++zFormat;` |
|  2396239 |  213 | `      if( c=='*' ){` |
|  2396227 |  214 | `        precision = va_arg(ap,int);` |
|  2396227 |  215 | `        if( precision<0 ) precision = -precision;` |
|  2396227 |  216 | `        c = *++zFormat;` |
|  1198116 |  217 | `      }else{` |
...
|  7388287 |  225 | `	flag_long = 0;` |
|  7388287 |  226 | `    if( c=='l' \|\| c == 'q' /* BSD quad (expect a 64-bit integer) */ ){` |
...
|  7388287 |  235 | `    infop = 0;` |
|  7388287 |  236 | `    xtype = SXFMT_ERROR;` |
| 34029235 |  237 | `	for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
| 34029235 |  238 | `      if( c==aFmt[idx].fmttype ){` |
|  7388287 |  239 | `        infop = &aFmt[idx];` |
|  7388287 |  240 | `		xtype = infop->type;` |
|  7388287 |  241 | `        break;` |
|        - |  242 | `      }` |
| 13320479 |  243 | `    }` |
...
|   203525 |  318 | `            *(--bufpt) = cset[ulongvalue%base];` |
|   203525 |  319 | `            ulongvalue = ulongvalue/base;` |
|   203525 |  320 | `          }while( ulongvalue>0 );` |
|        - |  321 | `        }` |
|    71783 |  322 | `        length = (int)(&buf[SXFMT_BUFSIZ-1]-bufpt);` |
|    72883 |  323 | `        for(idx=precision-length; idx>0; idx--){` |
...
|      ! 0 |  496 | `        length = 1;` |
|      ! 0 |  497 | `        break;` |
|     4907 |  498 | `      case SXFMT_CHARX:` |
|     9819 |  499 | `        c = va_arg(ap,int);` |
|     9819 |  500 | `		buf[0] = (char)c;` |
|        - |  501 | `		/* Limit the precision to prevent overflowing buf[] during conversion */` |
|     9819 |  502 | `		if( precision>SXFMT_BUFSIZ-40 ) precision = SXFMT_BUFSIZ-40;` |
|     9819 |  503 | `        if( precision>=0 ){` |
...
|     9819 |  509 | `        bufpt = buf;` |
|     9819 |  510 | `        break;` |
|  1243515 |  511 | `      case SXFMT_STRING:` |
|  2487035 |  512 | `        bufpt = va_arg(ap,char*);` |
|  2487035 |  513 | `        if( bufpt==0 ){` |
|      ! 0 |  514 | `          bufpt = " ";` |
|      ! 0 |  515 | `		  length = (int)sizeof(" ")-1;` |
|      ! 0 |  516 | `		  break;` |
|        - |  517 | `        }` |
|  2487035 |  518 | `		length = precision;` |
|  2487035 |  519 | `		if( precision < 0 ){` |
|        - |  520 | `			/* Symisc extension */` |
|    90801 |  521 | `			length = (int)SyStrlen(bufpt);` |
|    45398 |  522 | `		}` |
|  2487035 |  523 | `        if( precision>=0 && precision<length ) length = precision;` |
|  2487035 |  524 | `        break;` |
|  2409816 |  525 | `	case SXFMT_RAWSTR:{` |
|        - |  526 | `		/* Symisc extension */` |
|  4819637 |  527 | `		SyString *pStr = va_arg(ap,SyString *);` |
|  4819637 |  528 | `		if( pStr == 0 \|\| pStr->zString == 0 ){` |
|      ! 0 |  529 | `			 bufpt = " ";` |
|      ! 0 |  530 | `		     length = (int)sizeof(char);` |
|      ! 0 |  531 | `		     break;` |
|        - |  532 | `		}` |
|  4819637 |  533 | `		bufpt = (char *)pStr->zString;` |
|  4819637 |  534 | `		length = (int)pStr->nByte;` |
|  4819637 |  535 | `		break;` |
|        - |  536 | `					  }` |
...
|        - |  547 | `    ** the output.` |
|        - |  548 | `    */` |
|  7388287 |  549 | `    if( !flag_leftjustify ){` |
|        - |  550 | `      register int nspace;` |
|  7388287 |  551 | `      nspace = width-length;` |
|  7388287 |  552 | `      if( nspace>0 ){` |
...
|       18 |  566 | `      }` |
|  3694141 |  567 | `    }` |
|  7388287 |  568 | `    if( length>0 ){` |
|  7387945 |  569 | `		rc = xConsumer(bufpt,(unsigned int)length,pUserData);` |
|  7387945 |  570 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  571 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|        - |  572 | `		}` |
|  3693970 |  573 | `    }` |
|  7388287 |  574 | `    if( flag_leftjustify ){` |
...
|      ! 0 |  591 | `      }` |
|      ! 0 |  592 | `    }` |
|  3694146 |  593 | `  }/* End for loop over the format string */` |
|    95629 |  594 | `  return errorflag ? SXERR_FORMAT : SXRET_OK;` |
|  1260393 |  595 | `}` |
|        - |  596 | `/* SPDX-SnippetEnd */` |
| 17067250 |  597 | `static sxi32 FormatConsumer(const void *pSrc,unsigned int nLen,void *pData)` |
|        5 |  598 | `{` |
| 17067255 |  599 | `	SyFmtConsumer *pConsumer = (SyFmtConsumer *)pData;` |
| 17067255 |  600 | `	sxi32 rc = SXERR_ABORT;` |
| 17067255 |  601 | `	switch(pConsumer->nType){` |
...
|      181 |  605 | `			break;` |
|  8533535 |  606 | `	case SXFMT_CONS_BLOB:` |
|        - |  607 | `			/* Blob consumer */` |
| 17067075 |  608 | `			rc = SyBlobAppend(pConsumer->uConsumer.pBlob,pSrc,(sxu32)nLen);` |
| 17067070 |  609 | `			break;` |
|      ! 0 |  610 | `		default:` |
...
| 17067255 |  615 | `	pConsumer->nLen += nLen;` |
| 17067255 |  616 | `	pConsumer->rc = rc;` |
| 17067255 |  617 | `	return rc;` |
|        5 |  618 | `}` |
|  2520776 |  619 | `static sxi32 FormatMount(sxi32 nType,void *pConsumer,ProcConsumer xUserCons,void *pUserData,sxu32 *pOutLen,const char *zFormat,va_list ap)` |
|        5 |  620 | `{` |
|        - |  621 | `	SyFmtConsumer sCons;` |
|  2520781 |  622 | `	sCons.nType = nType;` |
|  2520781 |  623 | `	sCons.rc = SXRET_OK;` |
|  2520781 |  624 | `	sCons.nLen = 0;` |
|  2520781 |  625 | `	if( pOutLen ){` |
|   120053 |  626 | `		*pOutLen = 0;` |
|    60024 |  627 | `	}` |
|  2520781 |  628 | `	switch(nType){` |
...
|       13 |  637 | `		break;` |
|  1260382 |  638 | `		case SXFMT_CONS_BLOB:` |
|  2520769 |  639 | `			sCons.uConsumer.pBlob = (SyBlob *)pConsumer;` |
|  2520769 |  640 | `			break;` |
|      ! 0 |  641 | `		default:` |
|      ! 0 |  642 | `			return SXERR_UNKNOWN;` |
|        - |  643 | `	}` |
|  2520781 |  644 | `	InternFormat(FormatConsumer,&sCons,zFormat,ap);` |
|  2520781 |  645 | `	if( pOutLen ){` |
|   120053 |  646 | `		*pOutLen = sCons.nLen;` |
|    60024 |  647 | `	}` |
|  2520781 |  648 | `	return sCons.rc;` |
|  1260393 |  649 | `}` |
...
|       13 |  662 | `	return rc;` |
|        1 |  663 | `}` |
|    96414 |  664 | `PH7_PRIVATE sxu32 SyBlobFormat(SyBlob *pBlob,const char *zFormat,...)` |
|        5 |  665 | `{` |
|        - |  666 | `	va_list ap;` |
|        - |  667 | `	sxu32 n;` |
...
|        - |  671 | `	}` |
|        - |  672 | `#endif` |
|    96419 |  673 | `	va_start(ap,zFormat);` |
|    96419 |  674 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    96419 |  675 | `	va_end(ap);` |
|    96419 |  676 | `	return n;` |
|        5 |  677 | `}` |
|    23634 |  678 | `PH7_PRIVATE sxu32 SyBlobFormatAp(SyBlob *pBlob,const char *zFormat,va_list ap)` |
|        5 |  679 | `{` |
|    23639 |  680 | `	sxu32 n = 0; /* cc warning */` |
|        - |  681 | `#if defined(UNTRUST)` |
|        - |  682 | `	if( SX_EMPTY_STR(zFormat) ){` |
|        - |  683 | `		return 0;` |
|        - |  684 | `	}` |
|        - |  685 | `#endif` |
|    23639 |  686 | `	FormatMount(SXFMT_CONS_BLOB,&(*pBlob),0,0,&n,zFormat,ap);` |
|    23639 |  687 | `	return n;` |
|        5 |  688 | `}` |
|  2400716 |  689 | `PH7_PRIVATE sxu32 SyBufferFormat(char *zBuf,sxu32 nLen,const char *zFormat,...)` |
|        5 |  690 | `{` |
|        - |  691 | `	SyBlob sBlob;` |
|        - |  692 | `	va_list ap;` |
|        - |  693 | `	sxu32 n;` |
...
|        - |  697 | `	}` |
|        - |  698 | `#endif` |
|  2400721 |  699 | `	if( SXRET_OK != SyBlobInitFromBuf(&sBlob,zBuf,nLen - 1) ){` |
|      ! 0 |  700 | `		return 0;` |
|        - |  701 | `	}` |
|  2400721 |  702 | `	va_start(ap,zFormat);` |
|  2400721 |  703 | `	FormatMount(SXFMT_CONS_BLOB,&sBlob,0,0,0,zFormat,ap);` |
|  2400721 |  704 | `	va_end(ap);` |
|  2400721 |  705 | `	n = SyBlobLength(&sBlob);` |
|        - |  706 | `	/* Append the null terminator */` |
|  2400721 |  707 | `	sBlob.mByte++;` |
|  2400721 |  708 | `	SyBlobAppend(&sBlob,"\0",sizeof(char));` |
|  2400721 |  709 | `	return n;` |
|  1200363 |  710 | `}` |
|        - |  711 |  |
