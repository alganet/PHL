...
|     - |   89 | ` */` |
| 20829 |   90 | `SX_STATIC_INLINE int PH7_IS_NAN_DOUBLE(double v){` |
|     - |   91 | `    union { double d; sxu64 u; } u;` |
| 20829 |   92 | `    u.d = v;` |
| 21209 |   93 | `    return ((u.u & 0x7ff0000000000000ULL) == 0x7ff0000000000000ULL)` |
| 20824 |   94 | `           && ((u.u & 0x000fffffffffffffULL) != 0);` |
|     5 |   95 | `}` |
|  1553 |   96 | `SX_STATIC_INLINE int PH7_IS_INF_DOUBLE(double v){` |
|     - |   97 | `    union { double d; sxu64 u; } u;` |
|     - |   98 | `    sxu64 abs;` |
|  1553 |   99 | `    u.d = v;` |
|  1553 |  100 | `    abs = u.u & 0x7fffffffffffffffULL;` |
|  1553 |  101 | `    return abs == 0x7ff0000000000000ULL;` |
|     5 |  102 | `}` |
|     - |  103 |  |
...
|     - |  117 | ` */` |
|   184 |  118 | `SX_STATIC_INLINE double PH7_NAN_VALUE(void){` |
...
|   184 |  127 | `    return u.d;` |
|     4 |  128 | `}` |
|   190 |  129 | `SX_STATIC_INLINE double PH7_INF_VALUE(void){` |
