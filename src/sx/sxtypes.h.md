...
|    - |   89 | ` */` |
| 2476 |   90 | `SX_STATIC_INLINE int PH7_IS_NAN_DOUBLE(double v){` |
|    - |   91 | `    union { double d; sxu64 u; } u;` |
| 2476 |   92 | `    u.d = v;` |
| 2629 |   93 | `    return ((u.u & 0x7ff0000000000000ULL) == 0x7ff0000000000000ULL)` |
| 2472 |   94 | `           && ((u.u & 0x000fffffffffffffULL) != 0);` |
|    4 |   95 | `}` |
| 1082 |   96 | `SX_STATIC_INLINE int PH7_IS_INF_DOUBLE(double v){` |
|    - |   97 | `    union { double d; sxu64 u; } u;` |
|    - |   98 | `    sxu64 abs;` |
| 1082 |   99 | `    u.d = v;` |
| 1082 |  100 | `    abs = u.u & 0x7fffffffffffffffULL;` |
| 1082 |  101 | `    return abs == 0x7ff0000000000000ULL;` |
|    4 |  102 | `}` |
|    - |  103 |  |
...
|    - |  117 | ` */` |
|   98 |  118 | `SX_STATIC_INLINE double PH7_NAN_VALUE(void){` |
...
|   98 |  127 | `    return u.d;` |
|    2 |  128 | `}` |
|   94 |  129 | `SX_STATIC_INLINE double PH7_INF_VALUE(void){` |
