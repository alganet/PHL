...
|    - |   87 | ` */` |
| 2211 |   88 | `SX_STATIC_INLINE int PH7_IS_NAN_DOUBLE(double v){` |
|    - |   89 | `    union { double d; sxu64 u; } u;` |
| 2211 |   90 | `    u.d = v;` |
| 2331 |   91 | `    return ((u.u & 0x7ff0000000000000ULL) == 0x7ff0000000000000ULL)` |
| 2208 |   92 | `           && ((u.u & 0x000fffffffffffffULL) != 0);` |
|    3 |   93 | `}` |
|  985 |   94 | `SX_STATIC_INLINE int PH7_IS_INF_DOUBLE(double v){` |
|    - |   95 | `    union { double d; sxu64 u; } u;` |
|    - |   96 | `    sxu64 abs;` |
|  985 |   97 | `    u.d = v;` |
|  985 |   98 | `    abs = u.u & 0x7fffffffffffffffULL;` |
|  985 |   99 | `    return abs == 0x7ff0000000000000ULL;` |
|    3 |  100 | `}` |
|    - |  101 |  |
