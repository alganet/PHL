...
|    - |   87 | ` */` |
| 2021 |   88 | `SX_STATIC_INLINE int PH7_IS_NAN_DOUBLE(double v){` |
|    - |   89 | `    union { double d; sxu64 u; } u;` |
| 2021 |   90 | `    u.d = v;` |
| 2104 |   91 | `    return ((u.u & 0x7ff0000000000000ULL) == 0x7ff0000000000000ULL)` |
| 2016 |   92 | `           && ((u.u & 0x000fffffffffffffULL) != 0);` |
|    5 |   93 | `}` |
|  989 |   94 | `SX_STATIC_INLINE int PH7_IS_INF_DOUBLE(double v){` |
|    - |   95 | `    union { double d; sxu64 u; } u;` |
|    - |   96 | `    sxu64 abs;` |
|  989 |   97 | `    u.d = v;` |
|  989 |   98 | `    abs = u.u & 0x7fffffffffffffffULL;` |
|  989 |   99 | `    return abs == 0x7ff0000000000000ULL;` |
|    5 |  100 | `}` |
|    - |  101 |  |
