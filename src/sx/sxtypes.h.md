...
|    - |   87 | ` */` |
| 1410 |   88 | `SX_STATIC_INLINE int PH7_IS_NAN_DOUBLE(double v){` |
|    - |   89 | `    union { double d; sxu64 u; } u;` |
| 1410 |   90 | `    u.d = v;` |
| 1485 |   91 | `    return ((u.u & 0x7ff0000000000000ULL) == 0x7ff0000000000000ULL)` |
| 1408 |   92 | `           && ((u.u & 0x000fffffffffffffULL) != 0);` |
|    2 |   93 |  |
|  590 |   94 | `SX_STATIC_INLINE int PH7_IS_INF_DOUBLE(double v){` |
|    - |   95 | `    union { double d; sxu64 u; } u;` |
|    - |   96 | `    sxu64 abs;` |
|  590 |   97 | `    u.d = v;` |
|  590 |   98 | `    abs = u.u & 0x7fffffffffffffffULL;` |
|  590 |   99 | `    return abs == 0x7ff0000000000000ULL;` |
|    2 |  100 |  |
|    - |  101 |  |
