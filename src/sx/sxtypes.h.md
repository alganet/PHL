...
|    - |   87 | ` */` |
| 2003 |   88 | `SX_STATIC_INLINE int PH7_IS_NAN_DOUBLE(double v){` |
|    - |   89 | `    union { double d; sxu64 u; } u;` |
| 2003 |   90 | `    u.d = v;` |
| 2086 |   91 | `    return ((u.u & 0x7ff0000000000000ULL) == 0x7ff0000000000000ULL)` |
| 2000 |   92 | `           && ((u.u & 0x000fffffffffffffULL) != 0);` |
|    3 |   93 | `}` |
|  971 |   94 | `SX_STATIC_INLINE int PH7_IS_INF_DOUBLE(double v){` |
|    - |   95 | `    union { double d; sxu64 u; } u;` |
|    - |   96 | `    sxu64 abs;` |
|  971 |   97 | `    u.d = v;` |
|  971 |   98 | `    abs = u.u & 0x7fffffffffffffffULL;` |
|  971 |   99 | `    return abs == 0x7ff0000000000000ULL;` |
|    3 |  100 | `}` |
|    - |  101 |  |
...
|    - |  115 | ` */` |
|   61 |  116 | `SX_STATIC_INLINE double PH7_NAN_VALUE(void){` |
...
|   61 |  125 | `    return u.d;` |
|    1 |  126 | `}` |
|   29 |  127 | `SX_STATIC_INLINE double PH7_INF_VALUE(void){` |
