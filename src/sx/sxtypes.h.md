...
|    - |   87 | ` */` |
| 2004 |   88 | `SX_STATIC_INLINE int PH7_IS_NAN_DOUBLE(double v){` |
|    - |   89 | `    union { double d; sxu64 u; } u;` |
| 2004 |   90 | `    u.d = v;` |
| 2087 |   91 | `    return ((u.u & 0x7ff0000000000000ULL) == 0x7ff0000000000000ULL)` |
| 2000 |   92 | `           && ((u.u & 0x000fffffffffffffULL) != 0);` |
|    4 |   93 | `}` |
|  972 |   94 | `SX_STATIC_INLINE int PH7_IS_INF_DOUBLE(double v){` |
|    - |   95 | `    union { double d; sxu64 u; } u;` |
|    - |   96 | `    sxu64 abs;` |
|  972 |   97 | `    u.d = v;` |
|  972 |   98 | `    abs = u.u & 0x7fffffffffffffffULL;` |
|  972 |   99 | `    return abs == 0x7ff0000000000000ULL;` |
|    4 |  100 | `}` |
|    - |  101 |  |
