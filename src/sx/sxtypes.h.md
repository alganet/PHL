...
|    - |   87 | ` */` |
| 2005 |   88 | `SX_STATIC_INLINE int PH7_IS_NAN_DOUBLE(double v){` |
|    - |   89 | `    union { double d; sxu64 u; } u;` |
| 2005 |   90 | `    u.d = v;` |
| 2088 |   91 | `    return ((u.u & 0x7ff0000000000000ULL) == 0x7ff0000000000000ULL)` |
| 2000 |   92 | `           && ((u.u & 0x000fffffffffffffULL) != 0);` |
|    5 |   93 | `}` |
|  973 |   94 | `SX_STATIC_INLINE int PH7_IS_INF_DOUBLE(double v){` |
|    - |   95 | `    union { double d; sxu64 u; } u;` |
|    - |   96 | `    sxu64 abs;` |
|  973 |   97 | `    u.d = v;` |
|  973 |   98 | `    abs = u.u & 0x7fffffffffffffffULL;` |
|  973 |   99 | `    return abs == 0x7ff0000000000000ULL;` |
|    5 |  100 | `}` |
|    - |  101 |  |
