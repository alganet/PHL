...
|    - |   87 | ` */` |
| 1038 |   88 | `SX_STATIC_INLINE int PH7_IS_NAN_DOUBLE(double v){` |
|    - |   89 | `    union { double d; sxu64 u; } u;` |
| 1038 |   90 | `    u.d = v;` |
| 1104 |   91 | `    return ((u.u & 0x7ff0000000000000ULL) == 0x7ff0000000000000ULL)` |
| 1036 |   92 | `           && ((u.u & 0x000fffffffffffffULL) != 0);` |
|    2 |   93 |  |
|  378 |   94 | `SX_STATIC_INLINE int PH7_IS_INF_DOUBLE(double v){` |
|    - |   95 | `    union { double d; sxu64 u; } u;` |
|    - |   96 | `    sxu64 abs;` |
|  378 |   97 | `    u.d = v;` |
|  378 |   98 | `    abs = u.u & 0x7fffffffffffffffULL;` |
|  378 |   99 | `    return abs == 0x7ff0000000000000ULL;` |
|    2 |  100 |  |
|    - |  101 |  |
...
|    - |  115 | ` */` |
|   50 |  116 | `SX_STATIC_INLINE double PH7_NAN_VALUE(void){` |
...
|   50 |  125 | `    return u.d;` |
|    2 |  126 |  |
|   22 |  127 | `SX_STATIC_INLINE double PH7_INF_VALUE(void){` |
