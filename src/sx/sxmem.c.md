...
|          - |   16 | `#endif` |
|          - |   17 |  |
|   69833326 |   18 | `static void * SyOSHeapAlloc(sxu32 nByte)` |
|          5 |   19 | `{` |
|          - |   20 | `	void *pNew;` |
|          - |   21 | `#if defined(__WINNT__)` |
|          5 |   22 | `	pNew = HeapAlloc(GetProcessHeap(),0,nByte);` |
|          - |   23 | `#else` |
|   69833326 |   24 | `	pNew = malloc((size_t)nByte);` |
|          - |   25 | `#endif` |
|   69833331 |   26 | `	return pNew;` |
|          5 |   27 | `}` |
|    4663560 |   28 | `static void * SyOSHeapRealloc(void *pOld,sxu32 nByte)` |
|          5 |   29 | `{` |
|          - |   30 | `	void *pNew;` |
|          - |   31 | `#if defined(__WINNT__)` |
|          5 |   32 | `	pNew = HeapReAlloc(GetProcessHeap(),0,pOld,nByte);` |
|          - |   33 | `#else` |
|    4663560 |   34 | `	pNew = realloc(pOld,(size_t)nByte);` |
|          - |   35 | `#endif` |
|    4663565 |   36 | `	return pNew;` |
|          5 |   37 | `}` |
|   69829916 |   38 | `static void SyOSHeapFree(void *pPtr)` |
|          5 |   39 | `{` |
|          - |   40 | `#if defined(__WINNT__)` |
|          5 |   41 | `	HeapFree(GetProcessHeap(),0,pPtr);` |
|          - |   42 | `#else` |
|   69829916 |   43 | `	free(pPtr);` |
|          - |   44 | `#endif` |
|   69829921 |   45 | `}` |
|          - |   46 |  |
|          - |   47 |  |
|  189396663 |   48 | `PH7_PRIVATE void SyZero(void *pSrc,sxu32 nSize)` |
|          5 |   49 | `{` |
|  189396668 |   50 | `	register unsigned char *zSrc = (unsigned char *)pSrc;` |
...
|          - |   55 | `	}` |
|          - |   56 | `#endif` |
|  189396668 |   57 | `	zEnd = &zSrc[nSize];` |
| 2878232749 |   58 | `	for(;;){` |
| 5754855864 |   59 | `		if( zSrc >= zEnd ){break;} zSrc[0] = 0; zSrc++;` |
| 5565459651 |   60 | `		if( zSrc >= zEnd ){break;} zSrc[0] = 0; zSrc++;` |
| 5565459475 |   61 | `		if( zSrc >= zEnd ){break;} zSrc[0] = 0; zSrc++;` |
| 5565459265 |   62 | `		if( zSrc >= zEnd ){break;} zSrc[0] = 0; zSrc++;` |
|          5 |   63 | `	}` |
|  189396668 |   64 | `}` |
|  387192769 |   65 | `PH7_PRIVATE sxi32 SyMemcmp(const void *pB1,const void *pB2,sxu32 nSize)` |
|          5 |   66 | `{` |
|          - |   67 | `	sxi32 rc;` |
|  387192774 |   68 | `	if( nSize <= 0 ){` |
|      15341 |   69 | `		return 0;` |
|          - |   70 | `	}` |
|  387177438 |   71 | `	if( pB1 == 0 \|\| pB2 == 0 ){` |
|        ! 0 |   72 | `		return pB1 != 0 ? 1 : (pB2 == 0 ? 0 : -1);` |
|          - |   73 | `	}` |
|  494693812 |   74 | `	SX_MACRO_FAST_CMP(pB1,pB2,nSize,rc);` |
|  387177438 |   75 | `	return rc;` |
|  193600020 |   76 | `}` |
|   15014198 |   77 | `PH7_PRIVATE sxu32 SyMemcpy(const void *pSrc,void *pDest,sxu32 nLen)` |
|          5 |   78 | `{` |
...
|          - |   82 | `	}` |
|          - |   83 | `#endif` |
|   15014203 |   84 | `	if( pSrc == (const void *)pDest ){` |
|        ! 0 |   85 | `		return nLen;` |
|          - |   86 | `	}` |
|  137079864 |   87 | `	SX_MACRO_FAST_MEMCPY(pSrc,pDest,nLen);` |
|   15014203 |   88 | `	return nLen;` |
|    7511134 |   89 | `}` |
...
|          - |   97 | `	void *pAlign;` |
|          - |   98 | `};` |
|   69833326 |   99 | `static void * MemOSAlloc(sxu32 nBytes)` |
|          5 |  100 | `{` |
|          - |  101 | `	MemOSHeader *pChunk;` |
|   69833331 |  102 | `	pChunk = (MemOSHeader *)SyOSHeapAlloc(nBytes + sizeof(MemOSHeader));` |
|   69833331 |  103 | `	if( pChunk == 0 ){` |
|        ! 0 |  104 | `		return 0;` |
|          - |  105 | `	}` |
|   69833331 |  106 | `	pChunk->nBytes = nBytes;` |
|   69833331 |  107 | `	return (void *)&pChunk[1];` |
|   34918761 |  108 | `}` |
|    4663560 |  109 | `static void * MemOSRealloc(void *pOld,sxu32 nBytes)` |
|          5 |  110 | `{` |
|          - |  111 | `	MemOSHeader *pOldChunk;` |
|          - |  112 | `	MemOSHeader *pChunk;` |
|    4663565 |  113 | `	pOldChunk = (MemOSHeader *)(((char *)pOld)-sizeof(MemOSHeader));` |
|    4663565 |  114 | `	if( pOldChunk->nBytes >= nBytes ){` |
|        ! 0 |  115 | `		return pOld;` |
|          - |  116 | `	}` |
|    4663565 |  117 | `	pChunk = (MemOSHeader *)SyOSHeapRealloc(pOldChunk,nBytes + sizeof(MemOSHeader));` |
|    4663565 |  118 | `	if( pChunk == 0 ){` |
|        ! 0 |  119 | `		return 0;` |
|          - |  120 | `	}` |
|    4663565 |  121 | `	pChunk->nBytes = nBytes;` |
|    4663565 |  122 | `	return (void *)&pChunk[1];` |
|    2332986 |  123 | `}` |
|   69829916 |  124 | `static void MemOSFree(void *pBlock)` |
|          5 |  125 | `{` |
|          - |  126 | `	void *pChunk;` |
|   69829921 |  127 | `	pChunk = (void *)(((char *)pBlock)-sizeof(MemOSHeader));` |
|   69829921 |  128 | `	SyOSHeapFree(pChunk);` |
|   69829921 |  129 | `}` |
...
|          - |  144 | `	0` |
|          - |  145 | `};` |
|   69833326 |  146 | `static void * MemBackendAlloc(SyMemBackend *pBackend,sxu32 nByte)` |
|          5 |  147 | `{` |
|          - |  148 | `	SyMemBlock *pBlock;` |
|   69833331 |  149 | `	sxi32 nRetry = 0;` |
|          - |  150 |  |
|          - |  151 | `	/* Append an extra block so we can tracks allocated chunks and avoid memory` |
|          - |  152 | `	 * leaks.` |
|          - |  153 | `	 */` |
|   69833331 |  154 | `	nByte += sizeof(SyMemBlock);` |
|          - |  155 | `	/* Enforce the optional per-allocation cap (0 = unlimited). A capped failure` |
|          - |  156 | `	 * returns NULL just like a genuine OS failure, driving the normal SXERR_MEM` |
|          - |  157 | `	 * propagation; the retry callback is intentionally skipped (hard limit). */` |
|   69833331 |  158 | `	if( pBackend->nMaxRequest && nByte > pBackend->nMaxRequest ){` |
|        ! 0 |  159 | `		return 0;` |
|          - |  160 | `	}` |
|   34918756 |  161 | `	for(;;){` |
|   34918761 |  162 | `		pBlock = (SyMemBlock *)pBackend->pMethods->xAlloc(nByte);` |
|   69833326 |  163 | `		if( pBlock != 0 \|\| pBackend->xMemError == 0 \|\| nRetry > SXMEM_BACKEND_RETRY` |
|          5 |  164 | `			\|\| SXERR_RETRY != pBackend->xMemError(pBackend->pUserData) ){` |
|   34918761 |  165 | `				break;` |
|          - |  166 | `		}` |
|        ! 0 |  167 | `		nRetry++;` |
|        ! 0 |  168 | `	}` |
|   69833331 |  169 | `	if( pBlock  == 0 ){` |
|        ! 0 |  170 | `		return 0;` |
|          - |  171 | `	}` |
|   69833331 |  172 | `	pBlock->pNext = pBlock->pPrev = 0;` |
|          - |  173 | `	/* Link to the list of already tracked blocks */` |
|   69833331 |  174 | `	MACRO_LD_PUSH(pBackend->pBlocks,pBlock);` |
|          - |  175 | `#if defined(UNTRUST)` |
|          - |  176 | `	pBlock->nGuard = SXMEM_BACKEND_MAGIC;` |
|          - |  177 | `#endif` |
|   69833331 |  178 | `	pBlock->nSize = nByte;` |
|   69833331 |  179 | `	pBackend->nMemUsed += nByte;` |
|   69833331 |  180 | `	if( pBackend->nMemUsed > pBackend->nMemPeak ){` |
|   32418188 |  181 | `		pBackend->nMemPeak = pBackend->nMemUsed;` |
|   16209047 |  182 | `	}` |
|   69833331 |  183 | `	pBackend->nBlock++;` |
|   69833331 |  184 | `	return (void *)&pBlock[1];` |
|   34918761 |  185 | `}` |
|   37395814 |  186 | `PH7_PRIVATE void * SyMemBackendAlloc(SyMemBackend *pBackend,sxu32 nByte)` |
|          5 |  187 | `{` |
|          - |  188 | `	void *pChunk;` |
...
|          - |  192 | `	}` |
|          - |  193 | `#endif` |
|   37395819 |  194 | `	if( pBackend->pMutexMethods ){` |
|        ! 0 |  195 | `		SyMutexEnter(pBackend->pMutexMethods,pBackend->pMutex);` |
|        ! 0 |  196 | `	}` |
|   37395819 |  197 | `	pChunk = MemBackendAlloc(&(*pBackend),nByte);` |
|   37395819 |  198 | `	if( pBackend->pMutexMethods ){` |
|        ! 0 |  199 | `		SyMutexLeave(pBackend->pMutexMethods,pBackend->pMutex);` |
|        ! 0 |  200 | `	}` |
|   37395819 |  201 | `	return pChunk;` |
|          5 |  202 | `}` |
|   36847764 |  203 | `static void * MemBackendRealloc(SyMemBackend *pBackend,void * pOld,sxu32 nByte)` |
|          5 |  204 | `{` |
|          - |  205 | `	SyMemBlock *pBlock,*pNew,*pPrev,*pNext;` |
|   36847769 |  206 | `	sxu32 nRetry = 0;` |
|          - |  207 |  |
|   36847769 |  208 | `	if( pOld == 0 ){` |
|   32184209 |  209 | `		return MemBackendAlloc(&(*pBackend),nByte);` |
|          - |  210 | `	}` |
|    4663565 |  211 | `	pBlock = (SyMemBlock *)(((char *)pOld) - sizeof(SyMemBlock));` |
|          - |  212 | `#if defined(UNTRUST)` |
|          - |  213 | `	if( pBlock->nGuard != SXMEM_BACKEND_MAGIC ){` |
|          - |  214 | `		return 0;` |
|          - |  215 | `	}` |
|          - |  216 | `#endif` |
|    4663565 |  217 | `	nByte += sizeof(SyMemBlock);` |
|          - |  218 | `	/* Enforce the optional per-allocation cap (0 = unlimited); see MemBackendAlloc. */` |
|    4663565 |  219 | `	if( pBackend->nMaxRequest && nByte > pBackend->nMaxRequest ){` |
|        ! 0 |  220 | `		return 0;` |
|          - |  221 | `	}` |
|    4663565 |  222 | `	pPrev = pBlock->pPrev;` |
|    4663565 |  223 | `	pNext = pBlock->pNext;` |
|          - |  224 | `	{` |
...
|    4663565 |  227 | `		sxu32 nOld = pBlock->nSize;` |
|    2332981 |  228 | `	for(;;){` |
|    2332986 |  229 | `		pNew = (SyMemBlock *)pBackend->pMethods->xRealloc(pBlock,nByte);` |
|    4663565 |  230 | `		if( pNew != 0 \|\| pBackend->xMemError == 0 \|\| nRetry > SXMEM_BACKEND_RETRY \|\|` |
|        ! 0 |  231 | `			SXERR_RETRY != pBackend->xMemError(pBackend->pUserData) ){` |
|    2332986 |  232 | `				break;` |
|          - |  233 | `		}` |
|        ! 0 |  234 | `		nRetry++;` |
|        ! 0 |  235 | `	}` |
|    4663565 |  236 | `	if( pNew == 0 ){` |
|        ! 0 |  237 | `		return 0;` |
|          - |  238 | `	}` |
|    4663565 |  239 | `	if( pNew != pBlock ){` |
|    4056716 |  240 | `		if( pPrev == 0 ){` |
|    1546250 |  241 | `			pBackend->pBlocks = pNew;` |
|     830760 |  242 | `		}else{` |
|    2510471 |  243 | `			pPrev->pNext = pNew;` |
|          - |  244 | `		}` |
|    4056716 |  245 | `		if( pNext ){` |
|    4056704 |  246 | `			pNext->pPrev = pNew;` |
|    2311644 |  247 | `		}` |
...
|    4663565 |  253 | `	pBackend->nMemUsed = (pBackend->nMemUsed >= nOld) ? (pBackend->nMemUsed - nOld) : 0;` |
|    4663565 |  254 | `	pBackend->nMemUsed += nByte;` |
|    4663565 |  255 | `	if( pBackend->nMemUsed > pBackend->nMemPeak ){` |
|    2482761 |  256 | `		pBackend->nMemPeak = pBackend->nMemUsed;` |
|    1241387 |  257 | `	}` |
|    4663565 |  258 | `	pNew->nSize = nByte;` |
|    4663565 |  259 | `	return (void *)&pNew[1];` |
|          - |  260 | `	}` |
|   18426672 |  261 | `}` |
|   36847764 |  262 | `PH7_PRIVATE void * SyMemBackendRealloc(SyMemBackend *pBackend,void * pOld,sxu32 nByte)` |
|          5 |  263 | `{` |
|          - |  264 | `	void *pChunk;` |
...
|          - |  268 | `	}` |
|          - |  269 | `#endif` |
|   36847769 |  270 | `	if( pBackend->pMutexMethods ){` |
|        ! 0 |  271 | `		SyMutexEnter(pBackend->pMutexMethods,pBackend->pMutex);` |
|        ! 0 |  272 | `	}` |
|   36847769 |  273 | `	pChunk = MemBackendRealloc(&(*pBackend),pOld,nByte);` |
|   36847769 |  274 | `	if( pBackend->pMutexMethods ){` |
|        ! 0 |  275 | `		SyMutexLeave(pBackend->pMutexMethods,pBackend->pMutex);` |
|        ! 0 |  276 | `	}` |
|   36847769 |  277 | `	return pChunk;` |
|          5 |  278 | `}` |
|   42656028 |  279 | `static sxi32 MemBackendFree(SyMemBackend *pBackend,void * pChunk)` |
|          5 |  280 | `{` |
|          - |  281 | `	SyMemBlock *pBlock;` |
|   42656033 |  282 | `	pBlock = (SyMemBlock *)(((char *)pChunk) - sizeof(SyMemBlock));` |
...
|   42656033 |  289 | `	if( pBackend->nBlock > 0 ){` |
|          - |  290 | `		/* Release the block */` |
|          - |  291 | `#if defined(UNTRUST)` |
|          - |  292 | `		/* Mark as stale block */` |
|          - |  293 | `		pBlock->nGuard = 0x635B;` |
|          - |  294 | `#endif` |
|   42656033 |  295 | `		MACRO_LD_REMOVE(pBackend->pBlocks,pBlock);` |
|   42656033 |  296 | `		pBackend->nBlock--;` |
|   63981954 |  297 | `		pBackend->nMemUsed = (pBackend->nMemUsed >= pBlock->nSize)` |
|   42656028 |  298 | `			? (pBackend->nMemUsed - pBlock->nSize) : 0;` |
|   42656033 |  299 | `		pBackend->pMethods->xFree(pBlock);` |
|   21330107 |  300 | `	}` |
|   42656033 |  301 | `	return SXRET_OK;` |
|          5 |  302 | `}` |
|   42656028 |  303 | `PH7_PRIVATE sxi32 SyMemBackendFree(SyMemBackend *pBackend,void * pChunk)` |
|          5 |  304 | `{` |
|          - |  305 | `	sxi32 rc;` |
...
|          - |  309 | `	}` |
|          - |  310 | `#endif` |
|   42656033 |  311 | `	if( pChunk == 0 ){` |
|        ! 0 |  312 | `		return SXRET_OK;` |
|          - |  313 | `	}` |
|   42656033 |  314 | `	if( pBackend->pMutexMethods ){` |
|        ! 0 |  315 | `		SyMutexEnter(pBackend->pMutexMethods,pBackend->pMutex);` |
|        ! 0 |  316 | `	}` |
|   42656033 |  317 | `	rc = MemBackendFree(&(*pBackend),pChunk);` |
|   42656033 |  318 | `	if( pBackend->pMutexMethods ){` |
|        ! 0 |  319 | `		SyMutexLeave(pBackend->pMutexMethods,pBackend->pMutex);` |
|        ! 0 |  320 | `	}` |
|   42656033 |  321 | `	return rc;` |
|   21330112 |  322 | `}` |
...
|     126659 |  402 | `}` |
|  142898249 |  403 | `static void * MemBackendPoolAlloc(SyMemBackend *pBackend,sxu32 nByte)` |
|          5 |  404 | `{` |
...
|  142898254 |  413 | `	if( SXMEM_POOL_BYPASS_ACTIVE \|\| nByte + sizeof(SyMemHeader) >= SXMEM_POOL_MAXALLOC ){` |
...
|  142898254 |  424 | `	nBucket = 0;` |
|  142898254 |  425 | `	nBucketSize = SXMEM_POOL_MINALLOC;` |
|  736557372 |  426 | `	while( nByte + sizeof(SyMemHeader) > nBucketSize  ){` |
|  593659123 |  427 | `		nBucketSize <<= 1;` |
|  593659123 |  428 | `		nBucket++;` |
|          5 |  429 | `	}` |
|  142898254 |  430 | `	pBucket = pBackend->apPool[nBucket];` |
|  142898254 |  431 | `	if( pBucket == 0 ){` |
|          - |  432 | `		sxi32 rc;` |
...
|  142898254 |  440 | `	pNext = pBucket->pNext;` |
|  142898254 |  441 | `	pBackend->apPool[nBucket] = pNext;` |
|          - |  442 | `	/* Record bucket&magic number */` |
|  142898254 |  443 | `	pBucket->nBucket = (((sxu32)SXMEM_POOL_MAGIC << 16) \| nBucket);` |
|  142898254 |  444 | `	return (void *)&pBucket[1];` |
|   71450454 |  445 | `}` |
|  142898249 |  446 | `PH7_PRIVATE void * SyMemBackendPoolAlloc(SyMemBackend *pBackend,sxu32 nByte)` |
|          5 |  447 | `{` |
|          - |  448 | `	void *pChunk;` |
...
|          - |  452 | `	}` |
|          - |  453 | `#endif` |
|  142898254 |  454 | `	if( pBackend->pMutexMethods ){` |
|       3883 |  455 | `		SyMutexEnter(pBackend->pMutexMethods,pBackend->pMutex);` |
|       1939 |  456 | `	}` |
|  142898254 |  457 | `	pChunk = MemBackendPoolAlloc(&(*pBackend),nByte);` |
|  142898254 |  458 | `	if( pBackend->pMutexMethods ){` |
|       3883 |  459 | `		SyMutexLeave(pBackend->pMutexMethods,pBackend->pMutex);` |
|       1939 |  460 | `	}` |
|  142898254 |  461 | `	return pChunk;` |
|          5 |  462 | `}` |
|   98867571 |  463 | `static sxi32 MemBackendPoolFree(SyMemBackend *pBackend,void * pChunk)` |
|          5 |  464 | `{` |
|          - |  465 | `	SyMemHeader *pHeader;` |
|          - |  466 | `	sxu32 nBucket;` |
|          - |  467 | `	/* Get the corresponding bucket */` |
|   98867576 |  468 | `	pHeader = (SyMemHeader *)(((char *)pChunk) - sizeof(SyMemHeader));` |
|          - |  469 | `	/* Sanity check to avoid misuse */` |
|   98867576 |  470 | `	if( (pHeader->nBucket >> 16) != SXMEM_POOL_MAGIC ){` |
|          3 |  471 | `		return SXERR_CORRUPT;` |
|          - |  472 | `	}` |
|   98867574 |  473 | `	nBucket = pHeader->nBucket & 0xFFFF;` |
|   98867574 |  474 | `	if( nBucket == SXU16_HIGH ){` |
|          - |  475 | `		/* Free the big block */` |
|        ! 0 |  476 | `		MemBackendFree(&(*pBackend),pHeader);` |
|   98867574 |  477 | `	}else if( nBucket >= SXMEM_POOL_NBUCKETS + SXMEM_POOL_INCR ){` |
|          - |  478 | `		/* Corrupted or misused bucket index */` |
|        ! 0 |  479 | `		return SXERR_CORRUPT;` |
|        ! 0 |  480 | `	}else{` |
|          - |  481 | `		/* Return to the free list */` |
|   98867574 |  482 | `		pHeader->pNext = pBackend->apPool[nBucket];` |
|   98867574 |  483 | `		pBackend->apPool[nBucket] = pHeader;` |
|          - |  484 | `	}` |
|   98867574 |  485 | `	return SXRET_OK;` |
|   49435115 |  486 | `}` |
|   98867571 |  487 | `PH7_PRIVATE sxi32 SyMemBackendPoolFree(SyMemBackend *pBackend,void * pChunk)` |
|          5 |  488 | `{` |
|          - |  489 | `	sxi32 rc;` |
...
|          - |  493 | `	}` |
|          - |  494 | `#endif` |
|   98867576 |  495 | `	if( pBackend->pMutexMethods ){` |
|       3421 |  496 | `		SyMutexEnter(pBackend->pMutexMethods,pBackend->pMutex);` |
|       1708 |  497 | `	}` |
|   98867576 |  498 | `	rc = MemBackendPoolFree(&(*pBackend),pChunk);` |
|   98867576 |  499 | `	if( pBackend->pMutexMethods ){` |
|       3421 |  500 | `		SyMutexLeave(pBackend->pMutexMethods,pBackend->pMutex);` |
|       1708 |  501 | `	}` |
|   98867576 |  502 | `	return rc;` |
|          5 |  503 | `}` |
|          - |  504 | `#if 0` |
...
|    3399617 |  646 | `	for(;;){` |
|    6799239 |  647 | `		if( pBackend->nBlock == 0 ){` |
|        616 |  648 | `			break;` |
|          - |  649 | `		}` |
|    6798627 |  650 | `		pNext  = pBlock->pNext;` |
|    6798627 |  651 | `		pBackend->pMethods->xFree(pBlock);` |
|    6798627 |  652 | `		pBlock = pNext;` |
|    6798627 |  653 | `		pBackend->nBlock--;` |
|          - |  654 | `		/* LOOP ONE */` |
|    6798627 |  655 | `		if( pBackend->nBlock == 0 ){` |
|       6213 |  656 | `			break;` |
|          - |  657 | `		}` |
|    6792419 |  658 | `		pNext  = pBlock->pNext;` |
|    6792419 |  659 | `		pBackend->pMethods->xFree(pBlock);` |
|    6792419 |  660 | `		pBlock = pNext;` |
|    6792419 |  661 | `		pBackend->nBlock--;` |
|          - |  662 | `		/* LOOP TWO */` |
|    6792419 |  663 | `		if( pBackend->nBlock == 0 ){` |
|        573 |  664 | `			break;` |
|          - |  665 | `		}` |
|    6791851 |  666 | `		pNext  = pBlock->pNext;` |
|    6791851 |  667 | `		pBackend->pMethods->xFree(pBlock);` |
|    6791851 |  668 | `		pBlock = pNext;` |
|    6791851 |  669 | `		pBackend->nBlock--;` |
|          - |  670 | `		/* LOOP THREE */` |
|    6791851 |  671 | `		if( pBackend->nBlock == 0 ){` |
|        844 |  672 | `			break;` |
|          - |  673 | `		}` |
|    6791011 |  674 | `		pNext  = pBlock->pNext;` |
|    6791011 |  675 | `		pBackend->pMethods->xFree(pBlock);` |
|    6791011 |  676 | `		pBlock = pNext;` |
|    6791011 |  677 | `		pBackend->nBlock--;` |
|          - |  678 | `		/* LOOP FOUR */` |
|          5 |  679 | `	}` |
...
|          5 |  706 | `}` |
|     912136 |  707 | `PH7_PRIVATE void * SyMemBackendDup(SyMemBackend *pBackend,const void *pSrc,sxu32 nSize)` |
|          5 |  708 | `{` |
|          - |  709 | `	void *pNew;` |
...
|          - |  713 | `	}` |
|          - |  714 | `#endif` |
|     912141 |  715 | `	pNew = SyMemBackendAlloc(&(*pBackend),nSize);` |
|     912141 |  716 | `	if( pNew ){` |
|     912141 |  717 | `		SyMemcpy(pSrc,pNew,nSize);` |
|     456374 |  718 | `	}` |
|     912141 |  719 | `	return pNew;` |
|          5 |  720 | `}` |
|    9840104 |  721 | `PH7_PRIVATE char * SyMemBackendStrDup(SyMemBackend *pBackend,const char *zSrc,sxu32 nSize)` |
|          5 |  722 | `{` |
|          - |  723 | `	char *zDest;` |
|    9840109 |  724 | `	zDest = (char *)SyMemBackendAlloc(&(*pBackend),nSize + 1);` |
|    9840109 |  725 | `	if( zDest ){` |
|    9840109 |  726 | `		Systrcpy(zDest,nSize+1,zSrc,nSize);` |
|    4920052 |  727 | `	}` |
|    9840109 |  728 | `	return zDest;` |
|          5 |  729 | `}` |
...
|          5 |  743 | `}` |
|   43710118 |  744 | `PH7_PRIVATE sxi32 SyBlobInit(SyBlob *pBlob,SyMemBackend *pAllocator)` |
|          5 |  745 | `{` |
...
|          - |  749 | `	}` |
|          - |  750 | `#endif` |
|   43710123 |  751 | `	pBlob->pBlob = 0;` |
|   43710123 |  752 | `	pBlob->mByte = pBlob->nByte	= 0;` |
|   43710123 |  753 | `	pBlob->pAllocator = &(*pAllocator);` |
|   43710123 |  754 | `	pBlob->nFlags = 0;` |
|   43710123 |  755 | `	return SXRET_OK;` |
|          5 |  756 | `}` |
|    4331442 |  757 | `PH7_PRIVATE sxi32 SyBlobReadOnly(SyBlob *pBlob,const void *pData,sxu32 nByte)` |
|          5 |  758 | `{` |
...
|          - |  762 | `	}` |
|          - |  763 | `#endif` |
|    4331447 |  764 | `	pBlob->pBlob = (void *)pData;` |
|    4331447 |  765 | `	pBlob->nByte = nByte;` |
|    4331447 |  766 | `	pBlob->mByte = 0;` |
|    4331447 |  767 | `	pBlob->nFlags \|= SXBLOB_RDONLY;` |
|    4331447 |  768 | `	return SXRET_OK;` |
|          5 |  769 | `}` |
|          - |  770 | `#ifndef SXBLOB_MIN_GROWTH` |
|          - |  771 | `#define SXBLOB_MIN_GROWTH 16` |
|          - |  772 | `#endif` |
|   38225691 |  773 | `static sxi32 BlobPrepareGrow(SyBlob *pBlob,sxu32 *pByte)` |
|          5 |  774 | `{` |
|          - |  775 | `	sxu32 nByte;` |
|          - |  776 | `	void *pNew;` |
|   38225696 |  777 | `	nByte = *pByte;` |
|   38225696 |  778 | `	if( pBlob->nFlags & (SXBLOB_LOCKED\|SXBLOB_STATIC) ){` |
...
|          - |  786 | `	}` |
|   15015936 |  787 | `	if( pBlob->nFlags & SXBLOB_RDONLY ){` |
|          - |  788 | `		/* Make a copy of the read-only item */` |
|     912123 |  789 | `		if( pBlob->nByte > 0 ){` |
|     912123 |  790 | `			pNew = SyMemBackendDup(pBlob->pAllocator,pBlob->pBlob,pBlob->nByte);` |
|     912123 |  791 | `			if( pNew == 0 ){` |
|        ! 0 |  792 | `				return SXERR_MEM;` |
|          - |  793 | `			}` |
|     912123 |  794 | `			pBlob->pBlob = pNew;` |
|     912123 |  795 | `			pBlob->mByte = pBlob->nByte;` |
|     456370 |  796 | `		}else{` |
|        ! 0 |  797 | `			pBlob->pBlob = 0;` |
|        ! 0 |  798 | `			pBlob->mByte = 0;` |
|          - |  799 | `		}` |
|          - |  800 | `		/* Remove the read-only flag */` |
|     912123 |  801 | `		pBlob->nFlags &= ~SXBLOB_RDONLY;` |
|     456365 |  802 | `	}` |
|   15015936 |  803 | `	if( SyBlobFreeSpace(pBlob) >= nByte ){` |
|    2273951 |  804 | `		return SXRET_OK;` |
|          - |  805 | `	}` |
|   12741990 |  806 | `	if( pBlob->mByte > 0 ){` |
|    1105297 |  807 | `		nByte = nByte + pBlob->mByte * 2 + SXBLOB_MIN_GROWTH;` |
|   12190545 |  808 | `	}else if ( nByte < SXBLOB_MIN_GROWTH ){` |
|    8572191 |  809 | `		nByte = SXBLOB_MIN_GROWTH;` |
|    4286341 |  810 | `	}` |
|   12741990 |  811 | `	pNew = SyMemBackendRealloc(pBlob->pAllocator,pBlob->pBlob,nByte);` |
|   12741990 |  812 | `	if( pNew == 0 ){` |
|        ! 0 |  813 | `		return SXERR_MEM;` |
|          - |  814 | `	}` |
|   12741990 |  815 | `	pBlob->pBlob = pNew;` |
|   12741990 |  816 | `	pBlob->mByte = nByte;` |
|   12741990 |  817 | `	return SXRET_OK;` |
|   19113979 |  818 | `}` |
|   38302907 |  819 | `PH7_PRIVATE sxi32 SyBlobAppend(SyBlob *pBlob,const void *pData,sxu32 nSize)` |
|          5 |  820 | `{` |
|          - |  821 | `	sxu8 *zBlob;` |
|          - |  822 | `	sxi32 rc;` |
|   38302912 |  823 | `	if( nSize < 1 ){` |
|      77221 |  824 | `		return SXRET_OK;` |
|          - |  825 | `	}` |
|   38225696 |  826 | `	rc = BlobPrepareGrow(&(*pBlob),&nSize);` |
|   38225696 |  827 | `	if( SXRET_OK != rc ){` |
|        ! 0 |  828 | `		return rc;` |
|          - |  829 | `	}` |
|   38225696 |  830 | `	if( pData ){` |
|   38225622 |  831 | `		zBlob = (sxu8 *)pBlob->pBlob ;` |
|   38225622 |  832 | `		zBlob = &zBlob[pBlob->nByte];` |
|   38225622 |  833 | `		pBlob->nByte += nSize;` |
|  136952356 |  834 | `		SX_MACRO_FAST_MEMCPY(pData,zBlob,nSize);` |
|   19113937 |  835 | `	}` |
|   38225696 |  836 | `	return SXRET_OK;` |
|   19152587 |  837 | `}` |
|     872341 |  838 | `PH7_PRIVATE sxi32 SyBlobNullAppend(SyBlob *pBlob)` |
|          5 |  839 | `{` |
|          - |  840 | `	sxi32 rc;` |
|          - |  841 | `	sxu32 n;` |
|     872346 |  842 | `	n = pBlob->nByte;` |
|     872346 |  843 | `	rc = SyBlobAppend(&(*pBlob),(const void *)"\0",sizeof(char));` |
|     872346 |  844 | `	if (rc == SXRET_OK ){` |
|     872346 |  845 | `		pBlob->nByte = n;` |
|     436532 |  846 | `	}` |
|     872346 |  847 | `	return rc;` |
|          5 |  848 | `}` |
|    4446426 |  849 | `PH7_PRIVATE sxi32 SyBlobDup(SyBlob *pSrc,SyBlob *pDest)` |
|          5 |  850 | `{` |
|    4446431 |  851 | `	sxi32 rc = SXRET_OK;` |
|          - |  852 | `#ifdef UNTRUST` |
|          - |  853 | `	if( pSrc == 0 \|\| pDest == 0 ){` |
|          - |  854 | `		return SXERR_EMPTY;` |
|          - |  855 | `	}` |
|          - |  856 | `#endif` |
|    4446431 |  857 | `	if( pSrc->nByte > 0 ){` |
|    4265183 |  858 | `		rc = SyBlobAppend(&(*pDest),pSrc->pBlob,pSrc->nByte);` |
|    2132895 |  859 | `	}` |
|    4446431 |  860 | `	return rc;` |
|          5 |  861 | `}` |
...
|        ! 0 |  879 | `	return rc;` |
|        ! 0 |  880 | `}` |
|   11249125 |  881 | `PH7_PRIVATE sxi32 SyBlobReset(SyBlob *pBlob)` |
|          5 |  882 | `{` |
|   11249130 |  883 | `	pBlob->nByte = 0;` |
|   11249130 |  884 | `	if( pBlob->nFlags & SXBLOB_RDONLY ){` |
|       5669 |  885 | `		pBlob->pBlob = 0;` |
|       5669 |  886 | `		pBlob->mByte = 0;` |
|       5669 |  887 | `		pBlob->nFlags &= ~SXBLOB_RDONLY;` |
|       2832 |  888 | `	}` |
|   11249130 |  889 | `	return SXRET_OK;` |
|          5 |  890 | `}` |
|   22721076 |  891 | `PH7_PRIVATE sxi32 SyBlobRelease(SyBlob *pBlob)` |
|          5 |  892 | `{` |
|   22721081 |  893 | `	if( (pBlob->nFlags & (SXBLOB_STATIC\|SXBLOB_RDONLY)) == 0 && pBlob->mByte > 0 ){` |
|    7609258 |  894 | `		SyMemBackendFree(pBlob->pAllocator,pBlob->pBlob);` |
|    3805599 |  895 | `	}` |
|   22721081 |  896 | `	pBlob->pBlob = 0;` |
|   22721081 |  897 | `	pBlob->nByte = pBlob->mByte = 0;` |
|   22721081 |  898 | `	pBlob->nFlags = 0;` |
|   22721081 |  899 | `	return SXRET_OK;` |
|          5 |  900 | `}` |
...
|    1755298 |  911 | `	for(;;){` |
|    3508328 |  912 | `		if( zIn > zEnd ){break;} SX_MACRO_FAST_CMP(zIn,pPattern,pLen,rc); if( rc == 0 ){ if( pOfft ){ *pOfft = (sxu32)(zIn - (const char *)pBlob);} return SXRET_OK; } zIn++;` |
|    3462194 |  913 | `		if( zIn > zEnd ){break;} SX_MACRO_FAST_CMP(zIn,pPattern,pLen,rc); if( rc == 0 ){ if( pOfft ){ *pOfft = (sxu32)(zIn - (const char *)pBlob);} return SXRET_OK; } zIn++;` |
|    3394779 |  914 | `		if( zIn > zEnd ){break;} SX_MACRO_FAST_CMP(zIn,pPattern,pLen,rc); if( rc == 0 ){ if( pOfft ){ *pOfft = (sxu32)(zIn - (const char *)pBlob);} return SXRET_OK; } zIn++;` |
|    3354801 |  915 | `		if( zIn > zEnd ){break;} SX_MACRO_FAST_CMP(zIn,pPattern,pLen,rc); if( rc == 0 ){ if( pOfft ){ *pOfft = (sxu32)(zIn - (const char *)pBlob);} return SXRET_OK; } zIn++;` |
|          5 |  916 | `	}` |
