...
|         - |   16 | `#endif` |
|         - |   17 |  |
|  16870637 |   18 | `static void * SyOSHeapAlloc(sxu32 nByte)` |
|         5 |   19 | `{` |
|         - |   20 | `	void *pNew;` |
|         - |   21 | `#if defined(__WINNT__)` |
|         5 |   22 | `	pNew = HeapAlloc(GetProcessHeap(),0,nByte);` |
|         - |   23 | `#else` |
|  16870637 |   24 | `	pNew = malloc((size_t)nByte);` |
|         - |   25 | `#endif` |
|  16870642 |   26 | `	return pNew;` |
|         5 |   27 | `}` |
|   1024034 |   28 | `static void * SyOSHeapRealloc(void *pOld,sxu32 nByte)` |
|         5 |   29 | `{` |
|         - |   30 | `	void *pNew;` |
|         - |   31 | `#if defined(__WINNT__)` |
|         5 |   32 | `	pNew = HeapReAlloc(GetProcessHeap(),0,pOld,nByte);` |
|         - |   33 | `#else` |
|   1024034 |   34 | `	pNew = realloc(pOld,(size_t)nByte);` |
|         - |   35 | `#endif` |
|   1024039 |   36 | `	return pNew;` |
|         5 |   37 | `}` |
|  16867175 |   38 | `static void SyOSHeapFree(void *pPtr)` |
|         5 |   39 | `{` |
|         - |   40 | `#if defined(__WINNT__)` |
|         5 |   41 | `	HeapFree(GetProcessHeap(),0,pPtr);` |
|         - |   42 | `#else` |
|  16867175 |   43 | `	free(pPtr);` |
|         - |   44 | `#endif` |
|  16867180 |   45 | `}` |
|         - |   46 |  |
|         - |   47 |  |
|  30552179 |   48 | `PH7_PRIVATE void SyZero(void *pSrc,sxu32 nSize)` |
|         5 |   49 | `{` |
|  30552184 |   50 | `	register unsigned char *zSrc = (unsigned char *)pSrc;` |
...
|         - |   55 | `	}` |
|         - |   56 | `#endif` |
|  30552184 |   57 | `	zEnd = &zSrc[nSize];` |
| 415231009 |   58 | `	for(;;){` |
| 830457824 |   59 | `		if( zSrc >= zEnd ){break;} zSrc[0] = 0; zSrc++;` |
| 799905981 |   60 | `		if( zSrc >= zEnd ){break;} zSrc[0] = 0; zSrc++;` |
| 799905873 |   61 | `		if( zSrc >= zEnd ){break;} zSrc[0] = 0; zSrc++;` |
| 799905683 |   62 | `		if( zSrc >= zEnd ){break;} zSrc[0] = 0; zSrc++;` |
|         5 |   63 | `	}` |
|  30552184 |   64 | `}` |
|  32553056 |   65 | `PH7_PRIVATE sxi32 SyMemcmp(const void *pB1,const void *pB2,sxu32 nSize)` |
|         5 |   66 | `{` |
|         - |   67 | `	sxi32 rc;` |
|  32553061 |   68 | `	if( nSize <= 0 ){` |
|        68 |   69 | `		return 0;` |
|         - |   70 | `	}` |
|  32552997 |   71 | `	if( pB1 == 0 \|\| pB2 == 0 ){` |
|       ! 0 |   72 | `		return pB1 != 0 ? 1 : (pB2 == 0 ? 0 : -1);` |
|         - |   73 | `	}` |
|  69749330 |   74 | `	SX_MACRO_FAST_CMP(pB1,pB2,nSize,rc);` |
|  32552997 |   75 | `	return rc;` |
|  16277279 |   76 | `}` |
|  11941349 |   77 | `PH7_PRIVATE sxu32 SyMemcpy(const void *pSrc,void *pDest,sxu32 nLen)` |
|         5 |   78 | `{` |
...
|         - |   82 | `	}` |
|         - |   83 | `#endif` |
|  11941354 |   84 | `	if( pSrc == (const void *)pDest ){` |
|       ! 0 |   85 | `		return nLen;` |
|         - |   86 | `	}` |
|  98265314 |   87 | `	SX_MACRO_FAST_MEMCPY(pSrc,pDest,nLen);` |
|  11941354 |   88 | `	return nLen;` |
|   5971044 |   89 | `}` |
...
|         - |   97 | `	void *pAlign;` |
|         - |   98 | `};` |
|  16870637 |   99 | `static void * MemOSAlloc(sxu32 nBytes)` |
|         5 |  100 | `{` |
|         - |  101 | `	MemOSHeader *pChunk;` |
|  16870642 |  102 | `	pChunk = (MemOSHeader *)SyOSHeapAlloc(nBytes + sizeof(MemOSHeader));` |
|  16870642 |  103 | `	if( pChunk == 0 ){` |
|       ! 0 |  104 | `		return 0;` |
|         - |  105 | `	}` |
|  16870642 |  106 | `	pChunk->nBytes = nBytes;` |
|  16870642 |  107 | `	return (void *)&pChunk[1];` |
|   8435366 |  108 | `}` |
|   1024034 |  109 | `static void * MemOSRealloc(void *pOld,sxu32 nBytes)` |
|         5 |  110 | `{` |
|         - |  111 | `	MemOSHeader *pOldChunk;` |
|         - |  112 | `	MemOSHeader *pChunk;` |
|   1024039 |  113 | `	pOldChunk = (MemOSHeader *)(((char *)pOld)-sizeof(MemOSHeader));` |
|   1024039 |  114 | `	if( pOldChunk->nBytes >= nBytes ){` |
|       ! 0 |  115 | `		return pOld;` |
|         - |  116 | `	}` |
|   1024039 |  117 | `	pChunk = (MemOSHeader *)SyOSHeapRealloc(pOldChunk,nBytes + sizeof(MemOSHeader));` |
|   1024039 |  118 | `	if( pChunk == 0 ){` |
|       ! 0 |  119 | `		return 0;` |
|         - |  120 | `	}` |
|   1024039 |  121 | `	pChunk->nBytes = nBytes;` |
|   1024039 |  122 | `	return (void *)&pChunk[1];` |
|    512965 |  123 | `}` |
|  16867175 |  124 | `static void MemOSFree(void *pBlock)` |
|         5 |  125 | `{` |
|         - |  126 | `	void *pChunk;` |
|  16867180 |  127 | `	pChunk = (void *)(((char *)pBlock)-sizeof(MemOSHeader));` |
|  16867180 |  128 | `	SyOSHeapFree(pChunk);` |
|  16867180 |  129 | `}` |
...
|         - |  144 |  |
|         - |  145 | `};` |
|  16870637 |  146 | `static void * MemBackendAlloc(SyMemBackend *pBackend,sxu32 nByte)` |
|         5 |  147 | `{` |
|         - |  148 | `	SyMemBlock *pBlock;` |
|  16870642 |  149 | `	sxi32 nRetry = 0;` |
|         - |  150 |  |
|         - |  151 | `	/* Append an extra block so we can tracks allocated chunks and avoid memory` |
|         - |  152 | `	 * leaks.` |
|         - |  153 | `	 */` |
|  16870642 |  154 | `	nByte += sizeof(SyMemBlock);` |
|         - |  155 | `	/* Enforce the optional per-allocation cap (0 = unlimited). A capped failure` |
|         - |  156 | `	 * returns NULL just like a genuine OS failure, driving the normal SXERR_MEM` |
|         - |  157 | `	 * propagation; the retry callback is intentionally skipped (hard limit). */` |
|  16870642 |  158 | `	if( pBackend->nMaxRequest && nByte > pBackend->nMaxRequest ){` |
|       ! 0 |  159 | `		return 0;` |
|         - |  160 | `	}` |
|   8435361 |  161 | `	for(;;){` |
|   8435366 |  162 | `		pBlock = (SyMemBlock *)pBackend->pMethods->xAlloc(nByte);` |
|  16870637 |  163 | `		if( pBlock != 0 \|\| pBackend->xMemError == 0 \|\| nRetry > SXMEM_BACKEND_RETRY` |
|         5 |  164 | `			\|\| SXERR_RETRY != pBackend->xMemError(pBackend->pUserData) ){` |
|   8435366 |  165 | `				break;` |
|         - |  166 | `		}` |
|       ! 0 |  167 | `		nRetry++;` |
|       ! 0 |  168 | `	}` |
|  16870642 |  169 | `	if( pBlock  == 0 ){` |
|       ! 0 |  170 | `		return 0;` |
|         - |  171 | `	}` |
|  16870642 |  172 | `	pBlock->pNext = pBlock->pPrev = 0;` |
|         - |  173 | `	/* Link to the list of already tracked blocks */` |
|  16870642 |  174 | `	MACRO_LD_PUSH(pBackend->pBlocks,pBlock);` |
|         - |  175 | `#if defined(UNTRUST)` |
|         - |  176 | `	pBlock->nGuard = SXMEM_BACKEND_MAGIC;` |
|         - |  177 | `#endif` |
|  16870642 |  178 | `	pBackend->nBlock++;` |
|  16870642 |  179 | `	return (void *)&pBlock[1];` |
|   8435366 |  180 | `}` |
|   6771186 |  181 | `PH7_PRIVATE void * SyMemBackendAlloc(SyMemBackend *pBackend,sxu32 nByte)` |
|         5 |  182 | `{` |
|         - |  183 | `	void *pChunk;` |
...
|         - |  187 | `	}` |
|         - |  188 | `#endif` |
|   6771191 |  189 | `	if( pBackend->pMutexMethods ){` |
|       ! 0 |  190 | `		SyMutexEnter(pBackend->pMutexMethods,pBackend->pMutex);` |
|       ! 0 |  191 | `	}` |
|   6771191 |  192 | `	pChunk = MemBackendAlloc(&(*pBackend),nByte);` |
|   6771191 |  193 | `	if( pBackend->pMutexMethods ){` |
|       ! 0 |  194 | `		SyMutexLeave(pBackend->pMutexMethods,pBackend->pMutex);` |
|       ! 0 |  195 | `	}` |
|   6771191 |  196 | `	return pChunk;` |
|         5 |  197 | `}` |
|  11046759 |  198 | `static void * MemBackendRealloc(SyMemBackend *pBackend,void * pOld,sxu32 nByte)` |
|         5 |  199 | `{` |
|         - |  200 | `	SyMemBlock *pBlock,*pNew,*pPrev,*pNext;` |
|  11046764 |  201 | `	sxu32 nRetry = 0;` |
|         - |  202 |  |
|  11046764 |  203 | `	if( pOld == 0 ){` |
|  10022730 |  204 | `		return MemBackendAlloc(&(*pBackend),nByte);` |
|         - |  205 | `	}` |
|   1024039 |  206 | `	pBlock = (SyMemBlock *)(((char *)pOld) - sizeof(SyMemBlock));` |
|         - |  207 | `#if defined(UNTRUST)` |
|         - |  208 | `	if( pBlock->nGuard != SXMEM_BACKEND_MAGIC ){` |
|         - |  209 | `		return 0;` |
|         - |  210 | `	}` |
|         - |  211 | `#endif` |
|   1024039 |  212 | `	nByte += sizeof(SyMemBlock);` |
|         - |  213 | `	/* Enforce the optional per-allocation cap (0 = unlimited); see MemBackendAlloc. */` |
|   1024039 |  214 | `	if( pBackend->nMaxRequest && nByte > pBackend->nMaxRequest ){` |
|       ! 0 |  215 | `		return 0;` |
|         - |  216 | `	}` |
|   1024039 |  217 | `	pPrev = pBlock->pPrev;` |
|   1024039 |  218 | `	pNext = pBlock->pNext;` |
|    512960 |  219 | `	for(;;){` |
|    512965 |  220 | `		pNew = (SyMemBlock *)pBackend->pMethods->xRealloc(pBlock,nByte);` |
|   1024039 |  221 | `		if( pNew != 0 \|\| pBackend->xMemError == 0 \|\| nRetry > SXMEM_BACKEND_RETRY \|\|` |
|       ! 0 |  222 | `			SXERR_RETRY != pBackend->xMemError(pBackend->pUserData) ){` |
|    512965 |  223 | `				break;` |
|         - |  224 | `		}` |
|       ! 0 |  225 | `		nRetry++;` |
|       ! 0 |  226 | `	}` |
|   1024039 |  227 | `	if( pNew == 0 ){` |
|       ! 0 |  228 | `		return 0;` |
|         - |  229 | `	}` |
|   1024039 |  230 | `	if( pNew != pBlock ){` |
|    904598 |  231 | `		if( pPrev == 0 ){` |
|    671090 |  232 | `			pBackend->pBlocks = pNew;` |
|    385741 |  233 | `		}else{` |
|    233513 |  234 | `			pPrev->pNext = pNew;` |
|         - |  235 | `		}` |
|    904598 |  236 | `		if( pNext ){` |
|    904584 |  237 | `			pNext->pPrev = pNew;` |
|    511024 |  238 | `		}` |
|         - |  239 | `#if defined(UNTRUST)` |
|         - |  240 | `		pNew->nGuard = SXMEM_BACKEND_MAGIC;` |
|         - |  241 | `#endif` |
|    511031 |  242 | `	}` |
|   1024039 |  243 | `	return (void *)&pNew[1];` |
|   5524370 |  244 | `}` |
|  11046759 |  245 | `PH7_PRIVATE void * SyMemBackendRealloc(SyMemBackend *pBackend,void * pOld,sxu32 nByte)` |
|         5 |  246 | `{` |
|         - |  247 | `	void *pChunk;` |
...
|         - |  251 | `	}` |
|         - |  252 | `#endif` |
|  11046764 |  253 | `	if( pBackend->pMutexMethods ){` |
|       ! 0 |  254 | `		SyMutexEnter(pBackend->pMutexMethods,pBackend->pMutex);` |
|       ! 0 |  255 | `	}` |
|  11046764 |  256 | `	pChunk = MemBackendRealloc(&(*pBackend),pOld,nByte);` |
|  11046764 |  257 | `	if( pBackend->pMutexMethods ){` |
|       ! 0 |  258 | `		SyMutexLeave(pBackend->pMutexMethods,pBackend->pMutex);` |
|       ! 0 |  259 | `	}` |
|  11046764 |  260 | `	return pChunk;` |
|         5 |  261 | `}` |
|  11138167 |  262 | `static sxi32 MemBackendFree(SyMemBackend *pBackend,void * pChunk)` |
|         5 |  263 | `{` |
|         - |  264 | `	SyMemBlock *pBlock;` |
|  11138172 |  265 | `	pBlock = (SyMemBlock *)(((char *)pChunk) - sizeof(SyMemBlock));` |
...
|  11138172 |  272 | `	if( pBackend->nBlock > 0 ){` |
|         - |  273 | `		/* Release the block */` |
|         - |  274 | `#if defined(UNTRUST)` |
|         - |  275 | `		/* Mark as stale block */` |
|         - |  276 | `		pBlock->nGuard = 0x635B;` |
|         - |  277 | `#endif` |
|  11138172 |  278 | `		MACRO_LD_REMOVE(pBackend->pBlocks,pBlock);` |
|  11138172 |  279 | `		pBackend->nBlock--;` |
|  11138172 |  280 | `		pBackend->pMethods->xFree(pBlock);` |
|   5569126 |  281 | `	}` |
|  11138172 |  282 | `	return SXRET_OK;` |
|         5 |  283 | `}` |
|  11138167 |  284 | `PH7_PRIVATE sxi32 SyMemBackendFree(SyMemBackend *pBackend,void * pChunk)` |
|         5 |  285 | `{` |
|         - |  286 | `	sxi32 rc;` |
...
|         - |  290 | `	}` |
|         - |  291 | `#endif` |
|  11138172 |  292 | `	if( pChunk == 0 ){` |
|       ! 0 |  293 | `		return SXRET_OK;` |
|         - |  294 | `	}` |
|  11138172 |  295 | `	if( pBackend->pMutexMethods ){` |
|       ! 0 |  296 | `		SyMutexEnter(pBackend->pMutexMethods,pBackend->pMutex);` |
|       ! 0 |  297 | `	}` |
|  11138172 |  298 | `	rc = MemBackendFree(&(*pBackend),pChunk);` |
|  11138172 |  299 | `	if( pBackend->pMutexMethods ){` |
|       ! 0 |  300 | `		SyMutexLeave(pBackend->pMutexMethods,pBackend->pMutex);` |
|       ! 0 |  301 | `	}` |
|  11138172 |  302 | `	return rc;` |
|   5569131 |  303 | `}` |
...
|     38368 |  383 | `}` |
|  21185170 |  384 | `static void * MemBackendPoolAlloc(SyMemBackend *pBackend,sxu32 nByte)` |
|         5 |  385 | `{` |
...
|  21185175 |  394 | `	if( SXMEM_POOL_BYPASS_ACTIVE \|\| nByte + sizeof(SyMemHeader) >= SXMEM_POOL_MAXALLOC ){` |
...
|  21185175 |  405 | `	nBucket = 0;` |
|  21185175 |  406 | `	nBucketSize = SXMEM_POOL_MINALLOC;` |
| 106129369 |  407 | `	while( nByte + sizeof(SyMemHeader) > nBucketSize  ){` |
|  84944199 |  408 | `		nBucketSize <<= 1;` |
|  84944199 |  409 | `		nBucket++;` |
|         5 |  410 | `	}` |
|  21185175 |  411 | `	pBucket = pBackend->apPool[nBucket];` |
|  21185175 |  412 | `	if( pBucket == 0 ){` |
|         - |  413 | `		sxi32 rc;` |
...
|  21185175 |  421 | `	pNext = pBucket->pNext;` |
|  21185175 |  422 | `	pBackend->apPool[nBucket] = pNext;` |
|         - |  423 | `	/* Record bucket&magic number */` |
|  21185175 |  424 | `	pBucket->nBucket = (((sxu32)SXMEM_POOL_MAGIC << 16) \| nBucket);` |
|  21185175 |  425 | `	return (void *)&pBucket[1];` |
|  10592590 |  426 | `}` |
|  21185170 |  427 | `PH7_PRIVATE void * SyMemBackendPoolAlloc(SyMemBackend *pBackend,sxu32 nByte)` |
|         5 |  428 | `{` |
|         - |  429 | `	void *pChunk;` |
...
|         - |  433 | `	}` |
|         - |  434 | `#endif` |
|  21185175 |  435 | `	if( pBackend->pMutexMethods ){` |
|      3839 |  436 | `		SyMutexEnter(pBackend->pMutexMethods,pBackend->pMutex);` |
|      1917 |  437 | `	}` |
|  21185175 |  438 | `	pChunk = MemBackendPoolAlloc(&(*pBackend),nByte);` |
|  21185175 |  439 | `	if( pBackend->pMutexMethods ){` |
|      3839 |  440 | `		SyMutexLeave(pBackend->pMutexMethods,pBackend->pMutex);` |
|      1917 |  441 | `	}` |
|  21185175 |  442 | `	return pChunk;` |
|         5 |  443 | `}` |
|  11655326 |  444 | `static sxi32 MemBackendPoolFree(SyMemBackend *pBackend,void * pChunk)` |
|         5 |  445 | `{` |
|         - |  446 | `	SyMemHeader *pHeader;` |
|         - |  447 | `	sxu32 nBucket;` |
|         - |  448 | `	/* Get the corresponding bucket */` |
|  11655331 |  449 | `	pHeader = (SyMemHeader *)(((char *)pChunk) - sizeof(SyMemHeader));` |
|         - |  450 | `	/* Sanity check to avoid misuse */` |
|  11655331 |  451 | `	if( (pHeader->nBucket >> 16) != SXMEM_POOL_MAGIC ){` |
|         3 |  452 | `		return SXERR_CORRUPT;` |
|         - |  453 | `	}` |
|  11655329 |  454 | `	nBucket = pHeader->nBucket & 0xFFFF;` |
|  11655329 |  455 | `	if( nBucket == SXU16_HIGH ){` |
|         - |  456 | `		/* Free the big block */` |
|       ! 0 |  457 | `		MemBackendFree(&(*pBackend),pHeader);` |
|  11655329 |  458 | `	}else if( nBucket >= SXMEM_POOL_NBUCKETS + SXMEM_POOL_INCR ){` |
|         - |  459 | `		/* Corrupted or misused bucket index */` |
|       ! 0 |  460 | `		return SXERR_CORRUPT;` |
|       ! 0 |  461 | `	}else{` |
|         - |  462 | `		/* Return to the free list */` |
|  11655329 |  463 | `		pHeader->pNext = pBackend->apPool[nBucket];` |
|  11655329 |  464 | `		pBackend->apPool[nBucket] = pHeader;` |
|         - |  465 | `	}` |
|  11655329 |  466 | `	return SXRET_OK;` |
|   5827668 |  467 | `}` |
|  11655326 |  468 | `PH7_PRIVATE sxi32 SyMemBackendPoolFree(SyMemBackend *pBackend,void * pChunk)` |
|         5 |  469 | `{` |
|         - |  470 | `	sxi32 rc;` |
...
|         - |  474 | `	}` |
|         - |  475 | `#endif` |
|  11655331 |  476 | `	if( pBackend->pMutexMethods ){` |
|      3467 |  477 | `		SyMutexEnter(pBackend->pMutexMethods,pBackend->pMutex);` |
|      1731 |  478 | `	}` |
|  11655331 |  479 | `	rc = MemBackendPoolFree(&(*pBackend),pChunk);` |
|  11655331 |  480 | `	if( pBackend->pMutexMethods ){` |
|      3467 |  481 | `		SyMutexLeave(pBackend->pMutexMethods,pBackend->pMutex);` |
|      1731 |  482 | `	}` |
|  11655331 |  483 | `	return rc;` |
|         5 |  484 | `}` |
|         - |  485 | `#if 0` |
...
|         5 |  687 | `}` |
|    719632 |  688 | `PH7_PRIVATE void * SyMemBackendDup(SyMemBackend *pBackend,const void *pSrc,sxu32 nSize)` |
|         5 |  689 | `{` |
|         - |  690 | `	void *pNew;` |
...
|         - |  694 | `	}` |
|         - |  695 | `#endif` |
|    719637 |  696 | `	pNew = SyMemBackendAlloc(&(*pBackend),nSize);` |
|    719637 |  697 | `	if( pNew ){` |
|    719637 |  698 | `		SyMemcpy(pSrc,pNew,nSize);` |
|    359816 |  699 | `	}` |
|    719637 |  700 | `	return pNew;` |
|         5 |  701 | `}` |
|   3450314 |  702 | `PH7_PRIVATE char * SyMemBackendStrDup(SyMemBackend *pBackend,const char *zSrc,sxu32 nSize)` |
|         5 |  703 | `{` |
|         - |  704 | `	char *zDest;` |
|   3450319 |  705 | `	zDest = (char *)SyMemBackendAlloc(&(*pBackend),nSize + 1);` |
|   3450319 |  706 | `	if( zDest ){` |
|   3450319 |  707 | `		Systrcpy(zDest,nSize+1,zSrc,nSize);` |
|   1725157 |  708 | `	}` |
|   3450319 |  709 | `	return zDest;` |
|         5 |  710 | `}` |
...
|         5 |  724 | `}` |
|   9797281 |  725 | `PH7_PRIVATE sxi32 SyBlobInit(SyBlob *pBlob,SyMemBackend *pAllocator)` |
|         5 |  726 | `{` |
...
|         - |  730 | `	}` |
|         - |  731 | `#endif` |
|   9797286 |  732 | `	pBlob->pBlob = 0;` |
|   9797286 |  733 | `	pBlob->mByte = pBlob->nByte	= 0;` |
|   9797286 |  734 | `	pBlob->pAllocator = &(*pAllocator);` |
|   9797286 |  735 | `	pBlob->nFlags = 0;` |
|   9797286 |  736 | `	return SXRET_OK;` |
|         5 |  737 | `}` |
|   3507552 |  738 | `PH7_PRIVATE sxi32 SyBlobReadOnly(SyBlob *pBlob,const void *pData,sxu32 nByte)` |
|         5 |  739 | `{` |
...
|         - |  743 | `	}` |
|         - |  744 | `#endif` |
|   3507557 |  745 | `	pBlob->pBlob = (void *)pData;` |
|   3507557 |  746 | `	pBlob->nByte = nByte;` |
|   3507557 |  747 | `	pBlob->mByte = 0;` |
|   3507557 |  748 | `	pBlob->nFlags \|= SXBLOB_RDONLY;` |
|   3507557 |  749 | `	return SXRET_OK;` |
|         5 |  750 | `}` |
|         - |  751 | `#ifndef SXBLOB_MIN_GROWTH` |
|         - |  752 | `#define SXBLOB_MIN_GROWTH 16` |
|         - |  753 | `#endif` |
|  10237960 |  754 | `static sxi32 BlobPrepareGrow(SyBlob *pBlob,sxu32 *pByte)` |
|         5 |  755 | `{` |
|         - |  756 | `	sxu32 nByte;` |
|         - |  757 | `	void *pNew;` |
|  10237965 |  758 | `	nByte = *pByte;` |
|  10237965 |  759 | `	if( pBlob->nFlags & (SXBLOB_LOCKED\|SXBLOB_STATIC) ){` |
...
|         - |  767 | `	}` |
|   7926151 |  768 | `	if( pBlob->nFlags & SXBLOB_RDONLY ){` |
|         - |  769 | `		/* Make a copy of the read-only item */` |
|    719637 |  770 | `		if( pBlob->nByte > 0 ){` |
|    719637 |  771 | `			pNew = SyMemBackendDup(pBlob->pAllocator,pBlob->pBlob,pBlob->nByte);` |
|    719637 |  772 | `			if( pNew == 0 ){` |
|       ! 0 |  773 | `				return SXERR_MEM;` |
|         - |  774 | `			}` |
|    719637 |  775 | `			pBlob->pBlob = pNew;` |
|    719637 |  776 | `			pBlob->mByte = pBlob->nByte;` |
|    359821 |  777 | `		}else{` |
|       ! 0 |  778 | `			pBlob->pBlob = 0;` |
|       ! 0 |  779 | `			pBlob->mByte = 0;` |
|         - |  780 | `		}` |
|         - |  781 | `		/* Remove the read-only flag */` |
|    719637 |  782 | `		pBlob->nFlags &= ~SXBLOB_RDONLY;` |
|    359816 |  783 | `	}` |
|   7926151 |  784 | `	if( SyBlobFreeSpace(pBlob) >= nByte ){` |
|   1738760 |  785 | `		return SXRET_OK;` |
|         - |  786 | `	}` |
|   6187396 |  787 | `	if( pBlob->mByte > 0 ){` |
|    853201 |  788 | `		nByte = nByte + pBlob->mByte * 2 + SXBLOB_MIN_GROWTH;` |
|   5761741 |  789 | `	}else if ( nByte < SXBLOB_MIN_GROWTH ){` |
|   4126400 |  790 | `		nByte = SXBLOB_MIN_GROWTH;` |
|   2063104 |  791 | `	}` |
|   6187396 |  792 | `	pNew = SyMemBackendRealloc(pBlob->pAllocator,pBlob->pBlob,nByte);` |
|   6187396 |  793 | `	if( pNew == 0 ){` |
|       ! 0 |  794 | `		return SXERR_MEM;` |
|         - |  795 | `	}` |
|   6187396 |  796 | `	pBlob->pBlob = pNew;` |
|   6187396 |  797 | `	pBlob->mByte = nByte;` |
|   6187396 |  798 | `	return SXRET_OK;` |
|   5119070 |  799 | `}` |
|  10300560 |  800 | `PH7_PRIVATE sxi32 SyBlobAppend(SyBlob *pBlob,const void *pData,sxu32 nSize)` |
|         5 |  801 | `{` |
|         - |  802 | `	sxu8 *zBlob;` |
|         - |  803 | `	sxi32 rc;` |
|  10300565 |  804 | `	if( nSize < 1 ){` |
|     62605 |  805 | `		return SXRET_OK;` |
|         - |  806 | `	}` |
|  10237965 |  807 | `	rc = BlobPrepareGrow(&(*pBlob),&nSize);` |
|  10237965 |  808 | `	if( SXRET_OK != rc ){` |
|       ! 0 |  809 | `		return rc;` |
|         - |  810 | `	}` |
|  10237965 |  811 | `	if( pData ){` |
|  10237933 |  812 | `		zBlob = (sxu8 *)pBlob->pBlob ;` |
|  10237933 |  813 | `		zBlob = &zBlob[pBlob->nByte];` |
|  10237933 |  814 | `		pBlob->nByte += nSize;` |
|  45751261 |  815 | `		SX_MACRO_FAST_MEMCPY(pData,zBlob,nSize);` |
|   5119049 |  816 | `	}` |
|  10237965 |  817 | `	return SXRET_OK;` |
|   5150370 |  818 | `}` |
|    728951 |  819 | `PH7_PRIVATE sxi32 SyBlobNullAppend(SyBlob *pBlob)` |
|         5 |  820 | `{` |
|         - |  821 | `	sxi32 rc;` |
|         - |  822 | `	sxu32 n;` |
|    728956 |  823 | `	n = pBlob->nByte;` |
|    728956 |  824 | `	rc = SyBlobAppend(&(*pBlob),(const void *)"\0",sizeof(char));` |
|    728956 |  825 | `	if (rc == SXRET_OK ){` |
|    728956 |  826 | `		pBlob->nByte = n;` |
|    364518 |  827 | `	}` |
|    728956 |  828 | `	return rc;` |
|         5 |  829 | `}` |
|   3931396 |  830 | `PH7_PRIVATE sxi32 SyBlobDup(SyBlob *pSrc,SyBlob *pDest)` |
|         5 |  831 | `{` |
|   3931401 |  832 | `	sxi32 rc = SXRET_OK;` |
|         - |  833 | `#ifdef UNTRUST` |
|         - |  834 | `	if( pSrc == 0 \|\| pDest == 0 ){` |
|         - |  835 | `		return SXERR_EMPTY;` |
|         - |  836 | `	}` |
|         - |  837 | `#endif` |
|   3931401 |  838 | `	if( pSrc->nByte > 0 ){` |
|   3897049 |  839 | `		rc = SyBlobAppend(&(*pDest),pSrc->pBlob,pSrc->nByte);` |
|   1948522 |  840 | `	}` |
|   3931401 |  841 | `	return rc;` |
|         5 |  842 | `}` |
...
|         9 |  860 | `	return rc;` |
|         5 |  861 | `}` |
|   4691528 |  862 | `PH7_PRIVATE sxi32 SyBlobReset(SyBlob *pBlob)` |
|         5 |  863 | `{` |
|   4691533 |  864 | `	pBlob->nByte = 0;` |
|   4691533 |  865 | `	if( pBlob->nFlags & SXBLOB_RDONLY ){` |
|      4891 |  866 | `		pBlob->pBlob = 0;` |
|      4891 |  867 | `		pBlob->mByte = 0;` |
|      4891 |  868 | `		pBlob->nFlags &= ~SXBLOB_RDONLY;` |
|      2443 |  869 | `	}` |
|   4691533 |  870 | `	return SXRET_OK;` |
|         5 |  871 | `}` |
|  13013511 |  872 | `PH7_PRIVATE sxi32 SyBlobRelease(SyBlob *pBlob)` |
|         5 |  873 | `{` |
|  13013516 |  874 | `	if( (pBlob->nFlags & (SXBLOB_STATIC\|SXBLOB_RDONLY)) == 0 && pBlob->mByte > 0 ){` |
|   5495224 |  875 | `		SyMemBackendFree(pBlob->pAllocator,pBlob->pBlob);` |
|   2747652 |  876 | `	}` |
|  13013516 |  877 | `	pBlob->pBlob = 0;` |
|  13013516 |  878 | `	pBlob->nByte = pBlob->mByte = 0;` |
|  13013516 |  879 | `	pBlob->nFlags = 0;` |
|  13013516 |  880 | `	return SXRET_OK;` |
|         5 |  881 | `}` |
|         - |  882 | `#ifndef PH7_DISABLE_BUILTIN_FUNC` |
|    173296 |  883 | `PH7_PRIVATE sxi32 SyBlobSearch(const void *pBlob,sxu32 nLen,const void *pPattern,sxu32 pLen,sxu32 *pOfft)` |
|         5 |  884 | `{` |
|    173301 |  885 | `	const char *zIn = (const char *)pBlob;` |
|         - |  886 | `	const char *zEnd;` |
|         - |  887 | `	sxi32 rc;` |
|    173301 |  888 | `	if( pLen > nLen ){` |
|      6309 |  889 | `		return SXERR_NOTFOUND;` |
|         - |  890 | `	}` |
|    166997 |  891 | `	zEnd = &zIn[nLen-pLen];` |
|   1443971 |  892 | `	for(;;){` |
|   2885995 |  893 | `		if( zIn > zEnd ){break;} SX_MACRO_FAST_CMP(zIn,pPattern,pLen,rc); if( rc == 0 ){ if( pOfft ){ *pOfft = (sxu32)(zIn - (const char *)pBlob);} return SXRET_OK; } zIn++;` |
|   2845892 |  894 | `		if( zIn > zEnd ){break;} SX_MACRO_FAST_CMP(zIn,pPattern,pLen,rc); if( rc == 0 ){ if( pOfft ){ *pOfft = (sxu32)(zIn - (const char *)pBlob);} return SXRET_OK; } zIn++;` |
|   2786045 |  895 | `		if( zIn > zEnd ){break;} SX_MACRO_FAST_CMP(zIn,pPattern,pLen,rc); if( rc == 0 ){ if( pOfft ){ *pOfft = (sxu32)(zIn - (const char *)pBlob);} return SXRET_OK; } zIn++;` |
|   2749990 |  896 | `		if( zIn > zEnd ){break;} SX_MACRO_FAST_CMP(zIn,pPattern,pLen,rc); if( rc == 0 ){ if( pOfft ){ *pOfft = (sxu32)(zIn - (const char *)pBlob);} return SXRET_OK; } zIn++;` |
|         5 |  897 | `	}` |
