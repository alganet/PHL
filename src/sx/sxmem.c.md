...
|          - |   16 | `#endif` |
|          - |   17 |  |
|   59362563 |   18 | `static void * SyOSHeapAlloc(sxu32 nByte)` |
|          5 |   19 | `{` |
|          - |   20 | `	void *pNew;` |
|          - |   21 | `#if defined(__WINNT__)` |
|          5 |   22 | `	pNew = HeapAlloc(GetProcessHeap(),0,nByte);` |
|          - |   23 | `#else` |
|   59362563 |   24 | `	pNew = malloc((size_t)nByte);` |
|          - |   25 | `#endif` |
|   59362568 |   26 | `	return pNew;` |
|          5 |   27 | `}` |
|    4105385 |   28 | `static void * SyOSHeapRealloc(void *pOld,sxu32 nByte)` |
|          5 |   29 | `{` |
|          - |   30 | `	void *pNew;` |
|          - |   31 | `#if defined(__WINNT__)` |
|          5 |   32 | `	pNew = HeapReAlloc(GetProcessHeap(),0,pOld,nByte);` |
|          - |   33 | `#else` |
|    4105385 |   34 | `	pNew = realloc(pOld,(size_t)nByte);` |
|          - |   35 | `#endif` |
|    4105390 |   36 | `	return pNew;` |
|          5 |   37 | `}` |
|   59359205 |   38 | `static void SyOSHeapFree(void *pPtr)` |
|          5 |   39 | `{` |
|          - |   40 | `#if defined(__WINNT__)` |
|          5 |   41 | `	HeapFree(GetProcessHeap(),0,pPtr);` |
|          - |   42 | `#else` |
|   59359205 |   43 | `	free(pPtr);` |
|          - |   44 | `#endif` |
|   59359210 |   45 | `}` |
|          - |   46 |  |
|          - |   47 |  |
|  160237025 |   48 | `PH7_PRIVATE void SyZero(void *pSrc,sxu32 nSize)` |
|          5 |   49 | `{` |
|  160237030 |   50 | `	register unsigned char *zSrc = (unsigned char *)pSrc;` |
...
|          - |   55 | `	}` |
|          - |   56 | `#endif` |
|  160237030 |   57 | `	zEnd = &zSrc[nSize];` |
| 2435571282 |   58 | `	for(;;){` |
| 4871144222 |   59 | `		if( zSrc >= zEnd ){break;} zSrc[0] = 0; zSrc++;` |
| 4710907623 |   60 | `		if( zSrc >= zEnd ){break;} zSrc[0] = 0; zSrc++;` |
| 4710907469 |   61 | `		if( zSrc >= zEnd ){break;} zSrc[0] = 0; zSrc++;` |
| 4710907261 |   62 | `		if( zSrc >= zEnd ){break;} zSrc[0] = 0; zSrc++;` |
|          5 |   63 | `	}` |
|  160237030 |   64 | `}` |
|  331946571 |   65 | `PH7_PRIVATE sxi32 SyMemcmp(const void *pB1,const void *pB2,sxu32 nSize)` |
|          5 |   66 | `{` |
|          - |   67 | `	sxi32 rc;` |
|  331946576 |   68 | `	if( nSize <= 0 ){` |
|      13779 |   69 | `		return 0;` |
|          - |   70 | `	}` |
|  331932802 |   71 | `	if( pB1 == 0 \|\| pB2 == 0 ){` |
|        ! 0 |   72 | `		return pB1 != 0 ? 1 : (pB2 == 0 ? 0 : -1);` |
|          - |   73 | `	}` |
|  425580635 |   74 | `	SX_MACRO_FAST_CMP(pB1,pB2,nSize,rc);` |
|  331932802 |   75 | `	return rc;` |
|  165973913 |   76 | `}` |
|   14761873 |   77 | `PH7_PRIVATE sxu32 SyMemcpy(const void *pSrc,void *pDest,sxu32 nLen)` |
|          5 |   78 | `{` |
...
|          - |   82 | `	}` |
|          - |   83 | `#endif` |
|   14761878 |   84 | `	if( pSrc == (const void *)pDest ){` |
|        ! 0 |   85 | `		return nLen;` |
|          - |   86 | `	}` |
|  131771020 |   87 | `	SX_MACRO_FAST_MEMCPY(pSrc,pDest,nLen);` |
|   14761878 |   88 | `	return nLen;` |
|    7381038 |   89 | `}` |
...
|          - |   97 | `	void *pAlign;` |
|          - |   98 | `};` |
|   59362563 |   99 | `static void * MemOSAlloc(sxu32 nBytes)` |
|          5 |  100 | `{` |
|          - |  101 | `	MemOSHeader *pChunk;` |
|   59362568 |  102 | `	pChunk = (MemOSHeader *)SyOSHeapAlloc(nBytes + sizeof(MemOSHeader));` |
|   59362568 |  103 | `	if( pChunk == 0 ){` |
|        ! 0 |  104 | `		return 0;` |
|          - |  105 | `	}` |
|   59362568 |  106 | `	pChunk->nBytes = nBytes;` |
|   59362568 |  107 | `	return (void *)&pChunk[1];` |
|   29681310 |  108 | `}` |
|    4105385 |  109 | `static void * MemOSRealloc(void *pOld,sxu32 nBytes)` |
|          5 |  110 | `{` |
|          - |  111 | `	MemOSHeader *pOldChunk;` |
|          - |  112 | `	MemOSHeader *pChunk;` |
|    4105390 |  113 | `	pOldChunk = (MemOSHeader *)(((char *)pOld)-sizeof(MemOSHeader));` |
|    4105390 |  114 | `	if( pOldChunk->nBytes >= nBytes ){` |
|        ! 0 |  115 | `		return pOld;` |
|          - |  116 | `	}` |
|    4105390 |  117 | `	pChunk = (MemOSHeader *)SyOSHeapRealloc(pOldChunk,nBytes + sizeof(MemOSHeader));` |
|    4105390 |  118 | `	if( pChunk == 0 ){` |
|        ! 0 |  119 | `		return 0;` |
|          - |  120 | `	}` |
|    4105390 |  121 | `	pChunk->nBytes = nBytes;` |
|    4105390 |  122 | `	return (void *)&pChunk[1];` |
|    2053614 |  123 | `}` |
|   59359205 |  124 | `static void MemOSFree(void *pBlock)` |
|          5 |  125 | `{` |
|          - |  126 | `	void *pChunk;` |
|   59359210 |  127 | `	pChunk = (void *)(((char *)pBlock)-sizeof(MemOSHeader));` |
|   59359210 |  128 | `	SyOSHeapFree(pChunk);` |
|   59359210 |  129 | `}` |
...
|          - |  144 | `	0` |
|          - |  145 | `};` |
|   59362563 |  146 | `static void * MemBackendAlloc(SyMemBackend *pBackend,sxu32 nByte)` |
|          5 |  147 | `{` |
|          - |  148 | `	SyMemBlock *pBlock;` |
|   59362568 |  149 | `	sxi32 nRetry = 0;` |
|          - |  150 |  |
|          - |  151 | `	/* Append an extra block so we can tracks allocated chunks and avoid memory` |
|          - |  152 | `	 * leaks.` |
|          - |  153 | `	 */` |
|   59362568 |  154 | `	nByte += sizeof(SyMemBlock);` |
|          - |  155 | `	/* Enforce the optional per-allocation cap (0 = unlimited). A capped failure` |
|          - |  156 | `	 * returns NULL just like a genuine OS failure, driving the normal SXERR_MEM` |
|          - |  157 | `	 * propagation; the retry callback is intentionally skipped (hard limit). */` |
|   59362568 |  158 | `	if( pBackend->nMaxRequest && nByte > pBackend->nMaxRequest ){` |
|        ! 0 |  159 | `		return 0;` |
|          - |  160 | `	}` |
|   29681305 |  161 | `	for(;;){` |
|   29681310 |  162 | `		pBlock = (SyMemBlock *)pBackend->pMethods->xAlloc(nByte);` |
|   59362563 |  163 | `		if( pBlock != 0 \|\| pBackend->xMemError == 0 \|\| nRetry > SXMEM_BACKEND_RETRY` |
|          5 |  164 | `			\|\| SXERR_RETRY != pBackend->xMemError(pBackend->pUserData) ){` |
|   29681310 |  165 | `				break;` |
|          - |  166 | `		}` |
|        ! 0 |  167 | `		nRetry++;` |
|        ! 0 |  168 | `	}` |
|   59362568 |  169 | `	if( pBlock  == 0 ){` |
|        ! 0 |  170 | `		return 0;` |
|          - |  171 | `	}` |
|   59362568 |  172 | `	pBlock->pNext = pBlock->pPrev = 0;` |
|          - |  173 | `	/* Link to the list of already tracked blocks */` |
|   59362568 |  174 | `	MACRO_LD_PUSH(pBackend->pBlocks,pBlock);` |
|          - |  175 | `#if defined(UNTRUST)` |
|          - |  176 | `	pBlock->nGuard = SXMEM_BACKEND_MAGIC;` |
|          - |  177 | `#endif` |
|   59362568 |  178 | `	pBackend->nBlock++;` |
|   59362568 |  179 | `	return (void *)&pBlock[1];` |
|   29681310 |  180 | `}` |
|   31167054 |  181 | `PH7_PRIVATE void * SyMemBackendAlloc(SyMemBackend *pBackend,sxu32 nByte)` |
|          5 |  182 | `{` |
|          - |  183 | `	void *pChunk;` |
...
|          - |  187 | `	}` |
|          - |  188 | `#endif` |
|   31167059 |  189 | `	if( pBackend->pMutexMethods ){` |
|        ! 0 |  190 | `		SyMutexEnter(pBackend->pMutexMethods,pBackend->pMutex);` |
|        ! 0 |  191 | `	}` |
|   31167059 |  192 | `	pChunk = MemBackendAlloc(&(*pBackend),nByte);` |
|   31167059 |  193 | `	if( pBackend->pMutexMethods ){` |
|        ! 0 |  194 | `		SyMutexLeave(pBackend->pMutexMethods,pBackend->pMutex);` |
|        ! 0 |  195 | `	}` |
|   31167059 |  196 | `	return pChunk;` |
|          5 |  197 | `}` |
|   32085030 |  198 | `static void * MemBackendRealloc(SyMemBackend *pBackend,void * pOld,sxu32 nByte)` |
|          5 |  199 | `{` |
|          - |  200 | `	SyMemBlock *pBlock,*pNew,*pPrev,*pNext;` |
|   32085035 |  201 | `	sxu32 nRetry = 0;` |
|          - |  202 |  |
|   32085035 |  203 | `	if( pOld == 0 ){` |
|   27979650 |  204 | `		return MemBackendAlloc(&(*pBackend),nByte);` |
|          - |  205 | `	}` |
|    4105390 |  206 | `	pBlock = (SyMemBlock *)(((char *)pOld) - sizeof(SyMemBlock));` |
|          - |  207 | `#if defined(UNTRUST)` |
|          - |  208 | `	if( pBlock->nGuard != SXMEM_BACKEND_MAGIC ){` |
|          - |  209 | `		return 0;` |
|          - |  210 | `	}` |
|          - |  211 | `#endif` |
|    4105390 |  212 | `	nByte += sizeof(SyMemBlock);` |
|          - |  213 | `	/* Enforce the optional per-allocation cap (0 = unlimited); see MemBackendAlloc. */` |
|    4105390 |  214 | `	if( pBackend->nMaxRequest && nByte > pBackend->nMaxRequest ){` |
|        ! 0 |  215 | `		return 0;` |
|          - |  216 | `	}` |
|    4105390 |  217 | `	pPrev = pBlock->pPrev;` |
|    4105390 |  218 | `	pNext = pBlock->pNext;` |
|    2053609 |  219 | `	for(;;){` |
|    2053614 |  220 | `		pNew = (SyMemBlock *)pBackend->pMethods->xRealloc(pBlock,nByte);` |
|    4105390 |  221 | `		if( pNew != 0 \|\| pBackend->xMemError == 0 \|\| nRetry > SXMEM_BACKEND_RETRY \|\|` |
|        ! 0 |  222 | `			SXERR_RETRY != pBackend->xMemError(pBackend->pUserData) ){` |
|    2053614 |  223 | `				break;` |
|          - |  224 | `		}` |
|        ! 0 |  225 | `		nRetry++;` |
|        ! 0 |  226 | `	}` |
|    4105390 |  227 | `	if( pNew == 0 ){` |
|        ! 0 |  228 | `		return 0;` |
|          - |  229 | `	}` |
|    4105390 |  230 | `	if( pNew != pBlock ){` |
|    3544140 |  231 | `		if( pPrev == 0 ){` |
|    1382446 |  232 | `			pBackend->pBlocks = pNew;` |
|     765611 |  233 | `		}else{` |
|    2161699 |  234 | `			pPrev->pNext = pNew;` |
|          - |  235 | `		}` |
|    3544140 |  236 | `		if( pNext ){` |
|    3544126 |  237 | `			pNext->pPrev = pNew;` |
|    2034529 |  238 | `		}` |
|          - |  239 | `#if defined(UNTRUST)` |
|          - |  240 | `		pNew->nGuard = SXMEM_BACKEND_MAGIC;` |
|          - |  241 | `#endif` |
|    2034536 |  242 | `	}` |
|    4105390 |  243 | `	return (void *)&pNew[1];` |
|   16043460 |  244 | `}` |
|   32085030 |  245 | `PH7_PRIVATE void * SyMemBackendRealloc(SyMemBackend *pBackend,void * pOld,sxu32 nByte)` |
|          5 |  246 | `{` |
|          - |  247 | `	void *pChunk;` |
...
|          - |  251 | `	}` |
|          - |  252 | `#endif` |
|   32085035 |  253 | `	if( pBackend->pMutexMethods ){` |
|        ! 0 |  254 | `		SyMutexEnter(pBackend->pMutexMethods,pBackend->pMutex);` |
|        ! 0 |  255 | `	}` |
|   32085035 |  256 | `	pChunk = MemBackendRealloc(&(*pBackend),pOld,nByte);` |
|   32085035 |  257 | `	if( pBackend->pMutexMethods ){` |
|        ! 0 |  258 | `		SyMutexLeave(pBackend->pMutexMethods,pBackend->pMutex);` |
|        ! 0 |  259 | `	}` |
|   32085035 |  260 | `	return pChunk;` |
|          5 |  261 | `}` |
|   37333623 |  262 | `static sxi32 MemBackendFree(SyMemBackend *pBackend,void * pChunk)` |
|          5 |  263 | `{` |
|          - |  264 | `	SyMemBlock *pBlock;` |
|   37333628 |  265 | `	pBlock = (SyMemBlock *)(((char *)pChunk) - sizeof(SyMemBlock));` |
...
|   37333628 |  272 | `	if( pBackend->nBlock > 0 ){` |
|          - |  273 | `		/* Release the block */` |
|          - |  274 | `#if defined(UNTRUST)` |
|          - |  275 | `		/* Mark as stale block */` |
|          - |  276 | `		pBlock->nGuard = 0x635B;` |
|          - |  277 | `#endif` |
|   37333628 |  278 | `		MACRO_LD_REMOVE(pBackend->pBlocks,pBlock);` |
|   37333628 |  279 | `		pBackend->nBlock--;` |
|   37333628 |  280 | `		pBackend->pMethods->xFree(pBlock);` |
|   18666835 |  281 | `	}` |
|   37333628 |  282 | `	return SXRET_OK;` |
|          5 |  283 | `}` |
|   37333623 |  284 | `PH7_PRIVATE sxi32 SyMemBackendFree(SyMemBackend *pBackend,void * pChunk)` |
|          5 |  285 | `{` |
|          - |  286 | `	sxi32 rc;` |
...
|          - |  290 | `	}` |
|          - |  291 | `#endif` |
|   37333628 |  292 | `	if( pChunk == 0 ){` |
|        ! 0 |  293 | `		return SXRET_OK;` |
|          - |  294 | `	}` |
|   37333628 |  295 | `	if( pBackend->pMutexMethods ){` |
|        ! 0 |  296 | `		SyMutexEnter(pBackend->pMutexMethods,pBackend->pMutex);` |
|        ! 0 |  297 | `	}` |
|   37333628 |  298 | `	rc = MemBackendFree(&(*pBackend),pChunk);` |
|   37333628 |  299 | `	if( pBackend->pMutexMethods ){` |
|        ! 0 |  300 | `		SyMutexLeave(pBackend->pMutexMethods,pBackend->pMutex);` |
|        ! 0 |  301 | `	}` |
|   37333628 |  302 | `	return rc;` |
|   18666840 |  303 | `}` |
...
|     107937 |  383 | `}` |
|  121136034 |  384 | `static void * MemBackendPoolAlloc(SyMemBackend *pBackend,sxu32 nByte)` |
|          5 |  385 | `{` |
...
|  121136039 |  394 | `	if( SXMEM_POOL_BYPASS_ACTIVE \|\| nByte + sizeof(SyMemHeader) >= SXMEM_POOL_MAXALLOC ){` |
...
|  121136039 |  405 | `	nBucket = 0;` |
|  121136039 |  406 | `	nBucketSize = SXMEM_POOL_MINALLOC;` |
|  624323603 |  407 | `	while( nByte + sizeof(SyMemHeader) > nBucketSize  ){` |
|  503187569 |  408 | `		nBucketSize <<= 1;` |
|  503187569 |  409 | `		nBucket++;` |
|          5 |  410 | `	}` |
|  121136039 |  411 | `	pBucket = pBackend->apPool[nBucket];` |
|  121136039 |  412 | `	if( pBucket == 0 ){` |
|          - |  413 | `		sxi32 rc;` |
...
|  121136039 |  421 | `	pNext = pBucket->pNext;` |
|  121136039 |  422 | `	pBackend->apPool[nBucket] = pNext;` |
|          - |  423 | `	/* Record bucket&magic number */` |
|  121136039 |  424 | `	pBucket->nBucket = (((sxu32)SXMEM_POOL_MAGIC << 16) \| nBucket);` |
|  121136039 |  425 | `	return (void *)&pBucket[1];` |
|   60568022 |  426 | `}` |
|  121136034 |  427 | `PH7_PRIVATE void * SyMemBackendPoolAlloc(SyMemBackend *pBackend,sxu32 nByte)` |
|          5 |  428 | `{` |
|          - |  429 | `	void *pChunk;` |
...
|          - |  433 | `	}` |
|          - |  434 | `#endif` |
|  121136039 |  435 | `	if( pBackend->pMutexMethods ){` |
|       3819 |  436 | `		SyMutexEnter(pBackend->pMutexMethods,pBackend->pMutex);` |
|       1907 |  437 | `	}` |
|  121136039 |  438 | `	pChunk = MemBackendPoolAlloc(&(*pBackend),nByte);` |
|  121136039 |  439 | `	if( pBackend->pMutexMethods ){` |
|       3819 |  440 | `		SyMutexLeave(pBackend->pMutexMethods,pBackend->pMutex);` |
|       1907 |  441 | `	}` |
|  121136039 |  442 | `	return pChunk;` |
|          5 |  443 | `}` |
|   85048126 |  444 | `static sxi32 MemBackendPoolFree(SyMemBackend *pBackend,void * pChunk)` |
|          5 |  445 | `{` |
|          - |  446 | `	SyMemHeader *pHeader;` |
|          - |  447 | `	sxu32 nBucket;` |
|          - |  448 | `	/* Get the corresponding bucket */` |
|   85048131 |  449 | `	pHeader = (SyMemHeader *)(((char *)pChunk) - sizeof(SyMemHeader));` |
|          - |  450 | `	/* Sanity check to avoid misuse */` |
|   85048131 |  451 | `	if( (pHeader->nBucket >> 16) != SXMEM_POOL_MAGIC ){` |
|          3 |  452 | `		return SXERR_CORRUPT;` |
|          - |  453 | `	}` |
|   85048129 |  454 | `	nBucket = pHeader->nBucket & 0xFFFF;` |
|   85048129 |  455 | `	if( nBucket == SXU16_HIGH ){` |
|          - |  456 | `		/* Free the big block */` |
|        ! 0 |  457 | `		MemBackendFree(&(*pBackend),pHeader);` |
|   85048129 |  458 | `	}else if( nBucket >= SXMEM_POOL_NBUCKETS + SXMEM_POOL_INCR ){` |
|          - |  459 | `		/* Corrupted or misused bucket index */` |
|        ! 0 |  460 | `		return SXERR_CORRUPT;` |
|        ! 0 |  461 | `	}else{` |
|          - |  462 | `		/* Return to the free list */` |
|   85048129 |  463 | `		pHeader->pNext = pBackend->apPool[nBucket];` |
|   85048129 |  464 | `		pBackend->apPool[nBucket] = pHeader;` |
|          - |  465 | `	}` |
|   85048129 |  466 | `	return SXRET_OK;` |
|   42524068 |  467 | `}` |
|   85048126 |  468 | `PH7_PRIVATE sxi32 SyMemBackendPoolFree(SyMemBackend *pBackend,void * pChunk)` |
|          5 |  469 | `{` |
|          - |  470 | `	sxi32 rc;` |
...
|          - |  474 | `	}` |
|          - |  475 | `#endif` |
|   85048131 |  476 | `	if( pBackend->pMutexMethods ){` |
|       3369 |  477 | `		SyMutexEnter(pBackend->pMutexMethods,pBackend->pMutex);` |
|       1682 |  478 | `	}` |
|   85048131 |  479 | `	rc = MemBackendPoolFree(&(*pBackend),pChunk);` |
|   85048131 |  480 | `	if( pBackend->pMutexMethods ){` |
|       3369 |  481 | `		SyMutexLeave(pBackend->pMutexMethods,pBackend->pMutex);` |
|       1682 |  482 | `	}` |
|   85048131 |  483 | `	return rc;` |
|          5 |  484 | `}` |
|          - |  485 | `#if 0` |
...
|    2756027 |  627 | `	for(;;){` |
|    5512059 |  628 | `		if( pBackend->nBlock == 0 ){` |
|       1052 |  629 | `			break;` |
|          - |  630 | `		}` |
|    5511011 |  631 | `		pNext  = pBlock->pNext;` |
|    5511011 |  632 | `		pBackend->pMethods->xFree(pBlock);` |
|    5511011 |  633 | `		pBlock = pNext;` |
|    5511011 |  634 | `		pBackend->nBlock--;` |
|          - |  635 | `		/* LOOP ONE */` |
|    5511011 |  636 | `		if( pBackend->nBlock == 0 ){` |
|       4831 |  637 | `			break;` |
|          - |  638 | `		}` |
|    5506185 |  639 | `		pNext  = pBlock->pNext;` |
|    5506185 |  640 | `		pBackend->pMethods->xFree(pBlock);` |
|    5506185 |  641 | `		pBlock = pNext;` |
|    5506185 |  642 | `		pBackend->nBlock--;` |
|          - |  643 | `		/* LOOP TWO */` |
|    5506185 |  644 | `		if( pBackend->nBlock == 0 ){` |
|       1754 |  645 | `			break;` |
|          - |  646 | `		}` |
|    5504435 |  647 | `		pNext  = pBlock->pNext;` |
|    5504435 |  648 | `		pBackend->pMethods->xFree(pBlock);` |
|    5504435 |  649 | `		pBlock = pNext;` |
|    5504435 |  650 | `		pBackend->nBlock--;` |
|          - |  651 | `		/* LOOP THREE */` |
|    5504435 |  652 | `		if( pBackend->nBlock == 0 ){` |
|        469 |  653 | `			break;` |
|          - |  654 | `		}` |
|    5503971 |  655 | `		pNext  = pBlock->pNext;` |
|    5503971 |  656 | `		pBackend->pMethods->xFree(pBlock);` |
|    5503971 |  657 | `		pBlock = pNext;` |
|    5503971 |  658 | `		pBackend->nBlock--;` |
|          - |  659 | `		/* LOOP FOUR */` |
|          5 |  660 | `	}` |
...
|          5 |  687 | `}` |
|     874254 |  688 | `PH7_PRIVATE void * SyMemBackendDup(SyMemBackend *pBackend,const void *pSrc,sxu32 nSize)` |
|          5 |  689 | `{` |
|          - |  690 | `	void *pNew;` |
...
|          - |  694 | `	}` |
|          - |  695 | `#endif` |
|     874259 |  696 | `	pNew = SyMemBackendAlloc(&(*pBackend),nSize);` |
|     874259 |  697 | `	if( pNew ){` |
|     874259 |  698 | `		SyMemcpy(pSrc,pNew,nSize);` |
|     437127 |  699 | `	}` |
|     874259 |  700 | `	return pNew;` |
|          5 |  701 | `}` |
|    7929650 |  702 | `PH7_PRIVATE char * SyMemBackendStrDup(SyMemBackend *pBackend,const char *zSrc,sxu32 nSize)` |
|          5 |  703 | `{` |
|          - |  704 | `	char *zDest;` |
|    7929655 |  705 | `	zDest = (char *)SyMemBackendAlloc(&(*pBackend),nSize + 1);` |
|    7929655 |  706 | `	if( zDest ){` |
|    7929655 |  707 | `		Systrcpy(zDest,nSize+1,zSrc,nSize);` |
|    3964825 |  708 | `	}` |
|    7929655 |  709 | `	return zDest;` |
|          5 |  710 | `}` |
...
|          5 |  724 | `}` |
|   36568371 |  725 | `PH7_PRIVATE sxi32 SyBlobInit(SyBlob *pBlob,SyMemBackend *pAllocator)` |
|          5 |  726 | `{` |
...
|          - |  730 | `	}` |
|          - |  731 | `#endif` |
|   36568376 |  732 | `	pBlob->pBlob = 0;` |
|   36568376 |  733 | `	pBlob->mByte = pBlob->nByte	= 0;` |
|   36568376 |  734 | `	pBlob->pAllocator = &(*pAllocator);` |
|   36568376 |  735 | `	pBlob->nFlags = 0;` |
|   36568376 |  736 | `	return SXRET_OK;` |
|          5 |  737 | `}` |
|    4356948 |  738 | `PH7_PRIVATE sxi32 SyBlobReadOnly(SyBlob *pBlob,const void *pData,sxu32 nByte)` |
|          5 |  739 | `{` |
...
|          - |  743 | `	}` |
|          - |  744 | `#endif` |
|    4356953 |  745 | `	pBlob->pBlob = (void *)pData;` |
|    4356953 |  746 | `	pBlob->nByte = nByte;` |
|    4356953 |  747 | `	pBlob->mByte = 0;` |
|    4356953 |  748 | `	pBlob->nFlags \|= SXBLOB_RDONLY;` |
|    4356953 |  749 | `	return SXRET_OK;` |
|          5 |  750 | `}` |
|          - |  751 | `#ifndef SXBLOB_MIN_GROWTH` |
|          - |  752 | `#define SXBLOB_MIN_GROWTH 16` |
|          - |  753 | `#endif` |
|   32854923 |  754 | `static sxi32 BlobPrepareGrow(SyBlob *pBlob,sxu32 *pByte)` |
|          5 |  755 | `{` |
|          - |  756 | `	sxu32 nByte;` |
|          - |  757 | `	void *pNew;` |
|   32854928 |  758 | `	nByte = *pByte;` |
|   32854928 |  759 | `	if( pBlob->nFlags & (SXBLOB_LOCKED\|SXBLOB_STATIC) ){` |
...
|          - |  767 | `	}` |
|   13750686 |  768 | `	if( pBlob->nFlags & SXBLOB_RDONLY ){` |
|          - |  769 | `		/* Make a copy of the read-only item */` |
|     874259 |  770 | `		if( pBlob->nByte > 0 ){` |
|     874259 |  771 | `			pNew = SyMemBackendDup(pBlob->pAllocator,pBlob->pBlob,pBlob->nByte);` |
|     874259 |  772 | `			if( pNew == 0 ){` |
|        ! 0 |  773 | `				return SXERR_MEM;` |
|          - |  774 | `			}` |
|     874259 |  775 | `			pBlob->pBlob = pNew;` |
|     874259 |  776 | `			pBlob->mByte = pBlob->nByte;` |
|     437132 |  777 | `		}else{` |
|        ! 0 |  778 | `			pBlob->pBlob = 0;` |
|        ! 0 |  779 | `			pBlob->mByte = 0;` |
|          - |  780 | `		}` |
|          - |  781 | `		/* Remove the read-only flag */` |
|     874259 |  782 | `		pBlob->nFlags &= ~SXBLOB_RDONLY;` |
|     437127 |  783 | `	}` |
|   13750686 |  784 | `	if( SyBlobFreeSpace(pBlob) >= nByte ){` |
|    2238100 |  785 | `		return SXRET_OK;` |
|          - |  786 | `	}` |
|   11512591 |  787 | `	if( pBlob->mByte > 0 ){` |
|    1064386 |  788 | `		nByte = nByte + pBlob->mByte * 2 + SXBLOB_MIN_GROWTH;` |
|   10981317 |  789 | `	}else if ( nByte < SXBLOB_MIN_GROWTH ){` |
|    7801354 |  790 | `		nByte = SXBLOB_MIN_GROWTH;` |
|    3900514 |  791 | `	}` |
|   11512591 |  792 | `	pNew = SyMemBackendRealloc(pBlob->pAllocator,pBlob->pBlob,nByte);` |
|   11512591 |  793 | `	if( pNew == 0 ){` |
|        ! 0 |  794 | `		return SXERR_MEM;` |
|          - |  795 | `	}` |
|   11512591 |  796 | `	pBlob->pBlob = pNew;` |
|   11512591 |  797 | `	pBlob->mByte = nByte;` |
|   11512591 |  798 | `	return SXRET_OK;` |
|   16427512 |  799 | `}` |
|   32933561 |  800 | `PH7_PRIVATE sxi32 SyBlobAppend(SyBlob *pBlob,const void *pData,sxu32 nSize)` |
|          5 |  801 | `{` |
|          - |  802 | `	sxu8 *zBlob;` |
|          - |  803 | `	sxi32 rc;` |
|   32933566 |  804 | `	if( nSize < 1 ){` |
|      78643 |  805 | `		return SXRET_OK;` |
|          - |  806 | `	}` |
|   32854928 |  807 | `	rc = BlobPrepareGrow(&(*pBlob),&nSize);` |
|   32854928 |  808 | `	if( SXRET_OK != rc ){` |
|        ! 0 |  809 | `		return rc;` |
|          - |  810 | `	}` |
|   32854928 |  811 | `	if( pData ){` |
|   32854882 |  812 | `		zBlob = (sxu8 *)pBlob->pBlob ;` |
|   32854882 |  813 | `		zBlob = &zBlob[pBlob->nByte];` |
|   32854882 |  814 | `		pBlob->nByte += nSize;` |
|  119940401 |  815 | `		SX_MACRO_FAST_MEMCPY(pData,zBlob,nSize);` |
|   16427484 |  816 | `	}` |
|   32854928 |  817 | `	return SXRET_OK;` |
|   16466831 |  818 | `}` |
|     887159 |  819 | `PH7_PRIVATE sxi32 SyBlobNullAppend(SyBlob *pBlob)` |
|          5 |  820 | `{` |
|          - |  821 | `	sxi32 rc;` |
|          - |  822 | `	sxu32 n;` |
|     887164 |  823 | `	n = pBlob->nByte;` |
|     887164 |  824 | `	rc = SyBlobAppend(&(*pBlob),(const void *)"\0",sizeof(char));` |
|     887164 |  825 | `	if (rc == SXRET_OK ){` |
|     887164 |  826 | `		pBlob->nByte = n;` |
|     443603 |  827 | `	}` |
|     887164 |  828 | `	return rc;` |
|          5 |  829 | `}` |
|    4324748 |  830 | `PH7_PRIVATE sxi32 SyBlobDup(SyBlob *pSrc,SyBlob *pDest)` |
|          5 |  831 | `{` |
|    4324753 |  832 | `	sxi32 rc = SXRET_OK;` |
|          - |  833 | `#ifdef UNTRUST` |
|          - |  834 | `	if( pSrc == 0 \|\| pDest == 0 ){` |
|          - |  835 | `		return SXERR_EMPTY;` |
|          - |  836 | `	}` |
|          - |  837 | `#endif` |
|    4324753 |  838 | `	if( pSrc->nByte > 0 ){` |
|    4191317 |  839 | `		rc = SyBlobAppend(&(*pDest),pSrc->pBlob,pSrc->nByte);` |
|    2095656 |  840 | `	}` |
|    4324753 |  841 | `	return rc;` |
|          5 |  842 | `}` |
...
|        ! 0 |  860 | `	return rc;` |
|        ! 0 |  861 | `}` |
|   10170526 |  862 | `PH7_PRIVATE sxi32 SyBlobReset(SyBlob *pBlob)` |
|          5 |  863 | `{` |
|   10170531 |  864 | `	pBlob->nByte = 0;` |
|   10170531 |  865 | `	if( pBlob->nFlags & SXBLOB_RDONLY ){` |
|       5387 |  866 | `		pBlob->pBlob = 0;` |
|       5387 |  867 | `		pBlob->mByte = 0;` |
|       5387 |  868 | `		pBlob->nFlags &= ~SXBLOB_RDONLY;` |
|       2691 |  869 | `	}` |
|   10170531 |  870 | `	return SXRET_OK;` |
|          5 |  871 | `}` |
|   21514189 |  872 | `PH7_PRIVATE sxi32 SyBlobRelease(SyBlob *pBlob)` |
|          5 |  873 | `{` |
|   21514194 |  874 | `	if( (pBlob->nFlags & (SXBLOB_STATIC\|SXBLOB_RDONLY)) == 0 && pBlob->mByte > 0 ){` |
|    7331624 |  875 | `		SyMemBackendFree(pBlob->pAllocator,pBlob->pBlob);` |
|    3665833 |  876 | `	}` |
|   21514194 |  877 | `	pBlob->pBlob = 0;` |
|   21514194 |  878 | `	pBlob->nByte = pBlob->mByte = 0;` |
|   21514194 |  879 | `	pBlob->nFlags = 0;` |
|   21514194 |  880 | `	return SXRET_OK;` |
|          5 |  881 | `}` |
|          - |  882 | `#ifndef PH7_DISABLE_BUILTIN_FUNC` |
|     194022 |  883 | `PH7_PRIVATE sxi32 SyBlobSearch(const void *pBlob,sxu32 nLen,const void *pPattern,sxu32 pLen,sxu32 *pOfft)` |
|          5 |  884 | `{` |
|     194027 |  885 | `	const char *zIn = (const char *)pBlob;` |
|          - |  886 | `	const char *zEnd;` |
|          - |  887 | `	sxi32 rc;` |
|     194027 |  888 | `	if( pLen > nLen ){` |
|       6671 |  889 | `		return SXERR_NOTFOUND;` |
|          - |  890 | `	}` |
|     187361 |  891 | `	zEnd = &zIn[nLen-pLen];` |
|    1727176 |  892 | `	for(;;){` |
|    3452593 |  893 | `		if( zIn > zEnd ){break;} SX_MACRO_FAST_CMP(zIn,pPattern,pLen,rc); if( rc == 0 ){ if( pOfft ){ *pOfft = (sxu32)(zIn - (const char *)pBlob);} return SXRET_OK; } zIn++;` |
|    3406883 |  894 | `		if( zIn > zEnd ){break;} SX_MACRO_FAST_CMP(zIn,pPattern,pLen,rc); if( rc == 0 ){ if( pOfft ){ *pOfft = (sxu32)(zIn - (const char *)pBlob);} return SXRET_OK; } zIn++;` |
|    3340238 |  895 | `		if( zIn > zEnd ){break;} SX_MACRO_FAST_CMP(zIn,pPattern,pLen,rc); if( rc == 0 ){ if( pOfft ){ *pOfft = (sxu32)(zIn - (const char *)pBlob);} return SXRET_OK; } zIn++;` |
|    3300844 |  896 | `		if( zIn > zEnd ){break;} SX_MACRO_FAST_CMP(zIn,pPattern,pLen,rc); if( rc == 0 ){ if( pOfft ){ *pOfft = (sxu32)(zIn - (const char *)pBlob);} return SXRET_OK; } zIn++;` |
|          5 |  897 | `	}` |
|      30963 |  898 | `	return SXERR_NOTFOUND;` |
|      97016 |  899 | `}` |
