...
|    1 |  746 | `}` |
|  256 |  747 | `PH7_PRIVATE sxi32 SyBinToHexConsumer(const void *pIn,sxu32 nLen,ProcConsumer xConsumer,void *pConsumerData)` |
|    3 |  748 | `{` |
...
|    - |  756 | `	}` |
|    - |  757 | `#endif` |
|  259 |  758 | `	zIn   = (const unsigned char *)pIn;` |
|  259 |  759 | `	zEnd  = &zIn[nLen];` |
| 1862 |  760 | `	for(;;){` |
| 3727 |  761 | `		if( zIn >= zEnd  ){` |
|  235 |  762 | `			break;` |
|    - |  763 | `		}` |
| 3495 |  764 | `		zOut[0] = zHexTab[zIn[0] >> 4];  zOut[1] = zHexTab[zIn[0] & 0x0F];` |
| 3495 |  765 | `		rc = xConsumer((const void *)zOut,sizeof(char)*2,pConsumerData);` |
| 3495 |  766 | `		if( rc != SXRET_OK ){` |
|   25 |  767 | `			return rc;` |
|    - |  768 | `		}` |
| 3471 |  769 | `		zIn++;` |
|    3 |  770 | `	}` |
|  235 |  771 | `        return SXRET_OK;` |
|  131 |  772 | `}` |
|    - |  773 |  |
