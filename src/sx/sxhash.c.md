...
|    - |   32 | ` */` |
|   74 |   33 | `static void byteReverse (unsigned char *buf, unsigned longs)` |
|    3 |   34 | `{` |
|    - |   35 | `	sxu32 t;` |
|   37 |   36 | `        do {` |
| 1191 |   37 | `                t = (sxu32)((unsigned)buf[3]<<8 \| buf[2]) << 16 \|` |
|  792 |   38 | `                            ((unsigned)buf[1]<<8 \| buf[0]);` |
|  795 |   39 | `                *(sxu32*)buf = t;` |
|  795 |   40 | `                buf += 4;` |
|  795 |   41 | `        } while (--longs);` |
|   77 |   42 | `}` |
...
|    - |   72 | ` */` |
|   46 |   73 | `static void MD5Transform(sxu32 buf[4], const sxu32 in[16])` |
|    3 |   74 | `{` |
...
|   49 |   80 | `        d = buf[3];` |
|    - |   81 |  |
|   49 |   82 | `        SX_MD5STEP(F1, a, b, c, d, in[ 0]+0xd76aa478,  7);` |
|   49 |   83 | `        SX_MD5STEP(F1, d, a, b, c, in[ 1]+0xe8c7b756, 12);` |
|   49 |   84 | `        SX_MD5STEP(F1, c, d, a, b, in[ 2]+0x242070db, 17);` |
|   49 |   85 | `        SX_MD5STEP(F1, b, c, d, a, in[ 3]+0xc1bdceee, 22);` |
|   49 |   86 | `        SX_MD5STEP(F1, a, b, c, d, in[ 4]+0xf57c0faf,  7);` |
|   49 |   87 | `        SX_MD5STEP(F1, d, a, b, c, in[ 5]+0x4787c62a, 12);` |
|   49 |   88 | `        SX_MD5STEP(F1, c, d, a, b, in[ 6]+0xa8304613, 17);` |
|   49 |   89 | `        SX_MD5STEP(F1, b, c, d, a, in[ 7]+0xfd469501, 22);` |
|   49 |   90 | `        SX_MD5STEP(F1, a, b, c, d, in[ 8]+0x698098d8,  7);` |
|   49 |   91 | `        SX_MD5STEP(F1, d, a, b, c, in[ 9]+0x8b44f7af, 12);` |
|   49 |   92 | `        SX_MD5STEP(F1, c, d, a, b, in[10]+0xffff5bb1, 17);` |
|   49 |   93 | `        SX_MD5STEP(F1, b, c, d, a, in[11]+0x895cd7be, 22);` |
|   49 |   94 | `        SX_MD5STEP(F1, a, b, c, d, in[12]+0x6b901122,  7);` |
|   49 |   95 | `        SX_MD5STEP(F1, d, a, b, c, in[13]+0xfd987193, 12);` |
|   49 |   96 | `        SX_MD5STEP(F1, c, d, a, b, in[14]+0xa679438e, 17);` |
|   49 |   97 | `        SX_MD5STEP(F1, b, c, d, a, in[15]+0x49b40821, 22);` |
|    - |   98 |  |
|   49 |   99 | `        SX_MD5STEP(F2, a, b, c, d, in[ 1]+0xf61e2562,  5);` |
|   49 |  100 | `        SX_MD5STEP(F2, d, a, b, c, in[ 6]+0xc040b340,  9);` |
|   49 |  101 | `        SX_MD5STEP(F2, c, d, a, b, in[11]+0x265e5a51, 14);` |
|   49 |  102 | `        SX_MD5STEP(F2, b, c, d, a, in[ 0]+0xe9b6c7aa, 20);` |
|   49 |  103 | `        SX_MD5STEP(F2, a, b, c, d, in[ 5]+0xd62f105d,  5);` |
|   49 |  104 | `        SX_MD5STEP(F2, d, a, b, c, in[10]+0x02441453,  9);` |
|   49 |  105 | `        SX_MD5STEP(F2, c, d, a, b, in[15]+0xd8a1e681, 14);` |
|   49 |  106 | `        SX_MD5STEP(F2, b, c, d, a, in[ 4]+0xe7d3fbc8, 20);` |
|   49 |  107 | `        SX_MD5STEP(F2, a, b, c, d, in[ 9]+0x21e1cde6,  5);` |
|   49 |  108 | `        SX_MD5STEP(F2, d, a, b, c, in[14]+0xc33707d6,  9);` |
|   49 |  109 | `        SX_MD5STEP(F2, c, d, a, b, in[ 3]+0xf4d50d87, 14);` |
|   49 |  110 | `        SX_MD5STEP(F2, b, c, d, a, in[ 8]+0x455a14ed, 20);` |
|   49 |  111 | `        SX_MD5STEP(F2, a, b, c, d, in[13]+0xa9e3e905,  5);` |
|   49 |  112 | `        SX_MD5STEP(F2, d, a, b, c, in[ 2]+0xfcefa3f8,  9);` |
|   49 |  113 | `        SX_MD5STEP(F2, c, d, a, b, in[ 7]+0x676f02d9, 14);` |
|   49 |  114 | `        SX_MD5STEP(F2, b, c, d, a, in[12]+0x8d2a4c8a, 20);` |
|    - |  115 |  |
|   49 |  116 | `        SX_MD5STEP(F3, a, b, c, d, in[ 5]+0xfffa3942,  4);` |
|   49 |  117 | `        SX_MD5STEP(F3, d, a, b, c, in[ 8]+0x8771f681, 11);` |
|   49 |  118 | `        SX_MD5STEP(F3, c, d, a, b, in[11]+0x6d9d6122, 16);` |
|   49 |  119 | `        SX_MD5STEP(F3, b, c, d, a, in[14]+0xfde5380c, 23);` |
|   49 |  120 | `        SX_MD5STEP(F3, a, b, c, d, in[ 1]+0xa4beea44,  4);` |
|   49 |  121 | `        SX_MD5STEP(F3, d, a, b, c, in[ 4]+0x4bdecfa9, 11);` |
|   49 |  122 | `        SX_MD5STEP(F3, c, d, a, b, in[ 7]+0xf6bb4b60, 16);` |
|   49 |  123 | `        SX_MD5STEP(F3, b, c, d, a, in[10]+0xbebfbc70, 23);` |
|   49 |  124 | `        SX_MD5STEP(F3, a, b, c, d, in[13]+0x289b7ec6,  4);` |
|   49 |  125 | `        SX_MD5STEP(F3, d, a, b, c, in[ 0]+0xeaa127fa, 11);` |
|   49 |  126 | `        SX_MD5STEP(F3, c, d, a, b, in[ 3]+0xd4ef3085, 16);` |
|   49 |  127 | `        SX_MD5STEP(F3, b, c, d, a, in[ 6]+0x04881d05, 23);` |
|   49 |  128 | `        SX_MD5STEP(F3, a, b, c, d, in[ 9]+0xd9d4d039,  4);` |
|   49 |  129 | `        SX_MD5STEP(F3, d, a, b, c, in[12]+0xe6db99e5, 11);` |
|   49 |  130 | `        SX_MD5STEP(F3, c, d, a, b, in[15]+0x1fa27cf8, 16);` |
|   49 |  131 | `        SX_MD5STEP(F3, b, c, d, a, in[ 2]+0xc4ac5665, 23);` |
|    - |  132 |  |
|   49 |  133 | `        SX_MD5STEP(F4, a, b, c, d, in[ 0]+0xf4292244,  6);` |
|   49 |  134 | `        SX_MD5STEP(F4, d, a, b, c, in[ 7]+0x432aff97, 10);` |
|   49 |  135 | `        SX_MD5STEP(F4, c, d, a, b, in[14]+0xab9423a7, 15);` |
|   49 |  136 | `        SX_MD5STEP(F4, b, c, d, a, in[ 5]+0xfc93a039, 21);` |
|   49 |  137 | `        SX_MD5STEP(F4, a, b, c, d, in[12]+0x655b59c3,  6);` |
|   49 |  138 | `        SX_MD5STEP(F4, d, a, b, c, in[ 3]+0x8f0ccc92, 10);` |
|   49 |  139 | `        SX_MD5STEP(F4, c, d, a, b, in[10]+0xffeff47d, 15);` |
|   49 |  140 | `        SX_MD5STEP(F4, b, c, d, a, in[ 1]+0x85845dd1, 21);` |
|   49 |  141 | `        SX_MD5STEP(F4, a, b, c, d, in[ 8]+0x6fa87e4f,  6);` |
|   49 |  142 | `        SX_MD5STEP(F4, d, a, b, c, in[15]+0xfe2ce6e0, 10);` |
|   49 |  143 | `        SX_MD5STEP(F4, c, d, a, b, in[ 6]+0xa3014314, 15);` |
|   49 |  144 | `        SX_MD5STEP(F4, b, c, d, a, in[13]+0x4e0811a1, 21);` |
|   49 |  145 | `        SX_MD5STEP(F4, a, b, c, d, in[ 4]+0xf7537e82,  6);` |
|   49 |  146 | `        SX_MD5STEP(F4, d, a, b, c, in[11]+0xbd3af235, 10);` |
|   49 |  147 | `        SX_MD5STEP(F4, c, d, a, b, in[ 2]+0x2ad7d2bb, 15);` |
|   49 |  148 | `        SX_MD5STEP(F4, b, c, d, a, in[ 9]+0xeb86d391, 21);` |
|    - |  149 |  |
|   49 |  150 | `        buf[0] += a;` |
|   49 |  151 | `        buf[1] += b;` |
|   49 |  152 | `        buf[2] += c;` |
...
|    - |  157 | ` * of bytes.` |
|    - |  158 | ` */` |
|   32 |  159 | `PH7_PRIVATE void MD5Update(MD5Context *ctx, const unsigned char *buf, unsigned int len)` |
|    3 |  160 | `{` |
|    - |  161 | `	sxu32 t;` |
|    - |  162 |  |
|    - |  163 | `        /* Update bitcount */` |
|   35 |  164 | `        t = ctx->bits[0];` |
|   35 |  165 | `        if ((ctx->bits[0] = t + ((sxu32)len << 3)) < t)` |
|  ! 0 |  166 | `                ctx->bits[1]++; /* Carry from low to high */` |
|   35 |  167 | `        ctx->bits[1] += len >> 29;` |
|   35 |  168 | `        t = (t >> 3) & 0x3f;    /* Bytes already in shsInfo->data */` |
...
|   31 |  225 | `                SyZero(p,count-8);` |
|    - |  226 | `        }` |
|   31 |  227 | `        byteReverse(ctx->in, 14);` |
|    - |  228 |  |
|    - |  229 | `        /* Append length in bits and transform */` |
|   31 |  230 | `        ((sxu32*)ctx->in)[ 14 ] = ctx->bits[0];` |
|   31 |  231 | `        ((sxu32*)ctx->in)[ 15 ] = ctx->bits[1];` |
|    - |  232 |  |
|   31 |  233 | `        MD5Transform(ctx->buf, (sxu32*)ctx->in);` |
|   31 |  234 | `        byteReverse((unsigned char *)ctx->buf, 4);` |
|   31 |  235 | `        SyMemcpy(ctx->buf,digest,0x10);` |
|   31 |  236 | `        SyZero(ctx,sizeof(ctx));    /* In case it's sensitive */` |
|   31 |  237 | `}` |
|    - |  238 | `#undef F1` |
|    - |  239 | `#undef F2` |
|    - |  240 | `#undef F3` |
|    - |  241 | `#undef F4` |
|   28 |  242 | `PH7_PRIVATE sxi32 MD5Init(MD5Context *pCtx)` |
|    3 |  243 | `{` |
|   31 |  244 | `	pCtx->buf[0] = 0x67452301;` |
|   31 |  245 | `    pCtx->buf[1] = 0xefcdab89;` |
|   31 |  246 | `    pCtx->buf[2] = 0x98badcfe;` |
|   31 |  247 | `    pCtx->buf[3] = 0x10325476;` |
|   31 |  248 | `    pCtx->bits[0] = 0;` |
|   31 |  249 | `    pCtx->bits[1] = 0;` |
|    - |  250 |  |
|   31 |  251 | `   return SXRET_OK;` |
|    3 |  252 | `}` |
|   16 |  253 | `PH7_PRIVATE sxi32 SyMD5Compute(const void *pIn,sxu32 nLen,unsigned char zDigest[16])` |
|    3 |  254 | `{` |
|    - |  255 | `	MD5Context sCtx;` |
|   19 |  256 | `	MD5Init(&sCtx);` |
|   19 |  257 | `	MD5Update(&sCtx,(const unsigned char *)pIn,nLen);` |
|   19 |  258 | `	MD5Final(zDigest,&sCtx);` |
|   19 |  259 | `	return SXRET_OK;` |
|    3 |  260 | `}` |
|    - |  261 | `/*` |
|    - |  262 | ` * SHA-1 in C` |
...
|    1 |  746 | `}` |
|  884 |  747 | `PH7_PRIVATE sxi32 SyBinToHexConsumer(const void *pIn,sxu32 nLen,ProcConsumer xConsumer,void *pConsumerData)` |
|    4 |  748 | `{` |
...
|    - |  756 | `	}` |
|    - |  757 | `#endif` |
|  888 |  758 | `	zIn   = (const unsigned char *)pIn;` |
|  888 |  759 | `	zEnd  = &zIn[nLen];` |
| 3418 |  760 | `	for(;;){` |
| 6840 |  761 | `		if( zIn >= zEnd  ){` |
|  864 |  762 | `			break;` |
|    - |  763 | `		}` |
| 5980 |  764 | `		zOut[0] = zHexTab[zIn[0] >> 4];  zOut[1] = zHexTab[zIn[0] & 0x0F];` |
| 5980 |  765 | `		rc = xConsumer((const void *)zOut,sizeof(char)*2,pConsumerData);` |
| 5980 |  766 | `		if( rc != SXRET_OK ){` |
|   25 |  767 | `			return rc;` |
|    - |  768 | `		}` |
| 5956 |  769 | `		zIn++;` |
|    4 |  770 | `	}` |
|  864 |  771 | `        return SXRET_OK;` |
|  446 |  772 | `}` |
|    - |  773 |  |
