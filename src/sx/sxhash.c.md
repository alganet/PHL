...
|    1 |  746 | `}` |
|  276 |  747 | `PH7_PRIVATE sxi32 SyBinToHexConsumer(const void *pIn,sxu32 nLen,ProcConsumer xConsumer,void *pConsumerData)` |
|    3 |  748 | `{` |
...
|    - |  756 | `	}` |
|    - |  757 | `#endif` |
|  279 |  758 | `	zIn   = (const unsigned char *)pIn;` |
|  279 |  759 | `	zEnd  = &zIn[nLen];` |
| 1896 |  760 | `	for(;;){` |
| 3795 |  761 | `		if( zIn >= zEnd  ){` |
|  255 |  762 | `			break;` |
|    - |  763 | `		}` |
| 3543 |  764 | `		zOut[0] = zHexTab[zIn[0] >> 4];  zOut[1] = zHexTab[zIn[0] & 0x0F];` |
| 3543 |  765 | `		rc = xConsumer((const void *)zOut,sizeof(char)*2,pConsumerData);` |
| 3543 |  766 | `		if( rc != SXRET_OK ){` |
|   25 |  767 | `			return rc;` |
|    - |  768 | `		}` |
| 3519 |  769 | `		zIn++;` |
|    3 |  770 | `	}` |
|  255 |  771 | `        return SXRET_OK;` |
|  141 |  772 | `}` |
|    - |  773 |  |
