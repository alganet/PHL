...
|   1857060 |  138 | `}` |
|  14111361 |  139 | `PH7_PRIVATE void * SySetAt(SySet *pSet,sxu32 nIdx)` |
|         5 |  140 | `{` |
|         - |  141 | `	const char *zBase;` |
|  14111366 |  142 | `	if( nIdx >= pSet->nUsed ){` |
|         - |  143 | `		/* Out of range */` |
|       ! 0 |  144 | `		return 0;` |
|         - |  145 | `	}` |
|  14111366 |  146 | `	zBase = (const char *)pSet->pBase;` |
|  14111366 |  147 | `	return (void *)&zBase[nIdx * pSet->eSize];` |
|   7056042 |  148 | `}` |
...
|  17139482 |  218 | `	for(;;){` |
|  34349637 |  219 | `		if( pEntry == 0 ){` |
|  10147969 |  220 | `			break;` |
|         - |  221 | `		}` |
|  28639596 |  222 | `		if( pEntry->nHash == nHash && pEntry->nKeyLen == nKeyLen &&` |
|   8876368 |  223 | `			pHash->xCmp(pEntry->pKey,pKey,nKeyLen) == 0 ){` |
|   8876363 |  224 | `				return pEntry;` |
|         - |  225 | `		}` |
|  15325315 |  226 | `		pEntry = pEntry->pNextCollide;` |
|         5 |  227 | `	}` |
|         - |  228 | `	/* Entry not found */` |
...
|   1976938 |  374 | `			apNew[iBucket]->pPrevCollide = pEntry;` |
|    988463 |  375 | `		}` |
...
|   3112433 |  392 | `		pHash->apBucket[iBucket]->pPrevCollide = pEntry;` |
|   1556191 |  393 | `	}` |
