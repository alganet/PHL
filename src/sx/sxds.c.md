...
|   1857066 |  138 | `}` |
|  14111450 |  139 | `PH7_PRIVATE void * SySetAt(SySet *pSet,sxu32 nIdx)` |
|         5 |  140 | `{` |
|         - |  141 | `	const char *zBase;` |
|  14111455 |  142 | `	if( nIdx >= pSet->nUsed ){` |
|         - |  143 | `		/* Out of range */` |
|       ! 0 |  144 | `		return 0;` |
|         - |  145 | `	}` |
|  14111455 |  146 | `	zBase = (const char *)pSet->pBase;` |
|  14111455 |  147 | `	return (void *)&zBase[nIdx * pSet->eSize];` |
|   7056081 |  148 | `}` |
