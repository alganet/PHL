...
|         - |   12 | `#include "sxstr.h"` |
|         - |   13 |  |
|  20680682 |   14 | `PH7_PRIVATE sxi32 SySetInit(SySet *pSet,SyMemBackend *pAllocator,sxu32 ElemSize)` |
|         5 |   15 | `{` |
|  20680687 |   16 | `	pSet->nSize = 0 ;` |
|  20680687 |   17 | `	pSet->nUsed = 0;` |
|  20680687 |   18 | `	pSet->nCursor = 0;` |
|  20680687 |   19 | `	pSet->eSize = ElemSize;` |
|  20680687 |   20 | `	pSet->pAllocator = pAllocator;` |
|  20680687 |   21 | `	pSet->pBase =  0;` |
|  20680687 |   22 | `	pSet->pUserData = 0;` |
|  20680687 |   23 | `	return SXRET_OK;` |
|         5 |   24 | `}` |
|  34276805 |   25 | `PH7_PRIVATE sxi32 SySetPut(SySet *pSet,const void *pItem)` |
|         5 |   26 | `{` |
|         - |   27 | `	unsigned char *zbase;` |
|  34276810 |   28 | `	if( pSet->nUsed >= pSet->nSize ){` |
|         - |   29 | `		void *pNew;` |
...
|   2421361 |   42 | `	}` |
|  34276810 |   43 | `	zbase = (unsigned char *)pSet->pBase;` |
| 256277794 |   44 | `	SX_MACRO_FAST_MEMCPY(pItem,&zbase[pSet->nUsed * pSet->eSize],pSet->eSize);` |
|  34276810 |   45 | `	pSet->nUsed++;` |
|  34276810 |   46 | `	return SXRET_OK;` |
|  17138450 |   47 | `}` |
...
|    713545 |   62 | `}` |
|   2304475 |   63 | `PH7_PRIVATE sxi32 SySetReset(SySet *pSet)` |
|         5 |   64 | `{` |
|   2304480 |   65 | `	pSet->nUsed   = 0;` |
|   2304480 |   66 | `	pSet->nCursor = 0;` |
|   2304480 |   67 | `	return SXRET_OK;` |
|         5 |   68 | `}` |
...
|   1857060 |  138 | `}` |
|  14111351 |  139 | `PH7_PRIVATE void * SySetAt(SySet *pSet,sxu32 nIdx)` |
|         5 |  140 | `{` |
|         - |  141 | `	const char *zBase;` |
|  14111356 |  142 | `	if( nIdx >= pSet->nUsed ){` |
|         - |  143 | `		/* Out of range */` |
|       ! 0 |  144 | `		return 0;` |
|         - |  145 | `	}` |
|  14111356 |  146 | `	zBase = (const char *)pSet->pBase;` |
|  14111356 |  147 | `	return (void *)&zBase[nIdx * pSet->eSize];` |
|   7056030 |  148 | `}` |
...
|         5 |  210 | `}` |
|  19024298 |  211 | `static SyHashEntry_Pr * HashGetEntry(SyHash *pHash,const void *pKey,sxu32 nKeyLen)` |
|         5 |  212 | `{` |
|         - |  213 | `	SyHashEntry_Pr *pEntry;` |
|         - |  214 | `	sxu32 nHash;` |
|         - |  215 |  |
|  19024303 |  216 | `	nHash = pHash->xHash(pKey,nKeyLen);` |
|  19024303 |  217 | `	pEntry = pHash->apBucket[nHash & (pHash->nBucketSize - 1)];` |
|  17249426 |  218 | `	for(;;){` |
|  34489702 |  219 | `		if( pEntry == 0 ){` |
|  10147957 |  220 | `			break;` |
|         - |  221 | `		}` |
|  28779673 |  222 | `		if( pEntry->nHash == nHash && pEntry->nKeyLen == nKeyLen &&` |
|   8876356 |  223 | `			pHash->xCmp(pEntry->pKey,pKey,nKeyLen) == 0 ){` |
|   8876351 |  224 | `				return pEntry;` |
|         - |  225 | `		}` |
|  15465404 |  226 | `		pEntry = pEntry->pNextCollide;` |
|         5 |  227 | `	}` |
|         - |  228 | `	/* Entry not found */` |
|  10147957 |  229 | `	return 0;` |
|   9512664 |  230 | `}` |
|  19989792 |  231 | `PH7_PRIVATE SyHashEntry * SyHashGet(SyHash *pHash,const void *pKey,sxu32 nKeyLen)` |
|         5 |  232 | `{` |
...
|         - |  237 | `	}` |
|         - |  238 | `#endif` |
|  19989797 |  239 | `	if( pHash->nEntry < 1 \|\| nKeyLen < 1 ){` |
|         - |  240 | `		/* Don't bother hashing,return immediately */` |
|    965723 |  241 | `		return 0;` |
|         - |  242 | `	}` |
|  19024079 |  243 | `	pEntry = HashGetEntry(&(*pHash),pKey,nKeyLen);` |
|  19024079 |  244 | `	if( pEntry == 0 ){` |
|  10147957 |  245 | `		return 0;` |
|         - |  246 | `	}` |
|   8876127 |  247 | `	return (SyHashEntry *)pEntry;` |
|   9995411 |  248 | `}` |
...
|   1977083 |  374 | `			apNew[iBucket]->pPrevCollide = pEntry;` |
|    988430 |  375 | `		}` |
...
|   3112723 |  392 | `		pHash->apBucket[iBucket]->pPrevCollide = pEntry;` |
|   1556448 |  393 | `	}` |
