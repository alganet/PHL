...
|        - |  129 | ` */` |
| 13845116 |  130 | `static sxu8 randomByte(SyPRNGCtx *pCtx)` |
|        5 |  131 | `{` |
|        - |  132 | `  sxu8 t;` |
|        - |  133 |  |
|        - |  134 | `  /* Generate and return single random byte */` |
| 13845121 |  135 | `  pCtx->i++;` |
| 13845121 |  136 | `  t = pCtx->s[pCtx->i];` |
| 13845121 |  137 | `  pCtx->j += t;` |
| 13845121 |  138 | `  pCtx->s[pCtx->i] = pCtx->s[pCtx->j];` |
| 13845121 |  139 | `  pCtx->s[pCtx->j] = t;` |
| 13845121 |  140 | `  t += pCtx->s[pCtx->i];` |
| 13845121 |  141 | `  return pCtx->s[t];` |
|        5 |  142 | `}` |
|  1387612 |  143 | `PH7_PRIVATE sxi32 SyRandomness(SyPRNGCtx *pCtx,void *pBuf,sxu32 nLen)` |
|        5 |  144 | `{` |
|  1387617 |  145 | `	unsigned char *zBuf = (unsigned char *)pBuf;` |
|  1387617 |  146 | `	unsigned char *zEnd = &zBuf[nLen];` |
|        - |  147 | `#if defined(UNTRUST)` |
|        - |  148 | `	if( pCtx == 0 \|\| pBuf == 0 \|\| nLen <= 0 ){` |
|        - |  149 | `		return SXERR_EMPTY;` |
|        - |  150 | `	}` |
|        - |  151 | `#endif` |
|  1387617 |  152 | `	if(pCtx->nMagic != SXPRNG_MAGIC ){` |
|      ! 0 |  153 | `		return SXERR_CORRUPT;` |
|        - |  154 | `	}` |
|  2078865 |  155 | `	for(;;){` |
|  4157743 |  156 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  4152425 |  157 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  4152425 |  158 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  2770155 |  159 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|        5 |  160 | `	}` |
|  1387617 |  161 | `	return SXRET_OK;` |
|   693809 |  162 | `}` |
|        - |  163 | `/* SPDX-SnippetEnd */` |
...
|        - |  187 | `}` |
|        - |  188 | `#endif` |
|      346 |  189 | `PH7_PRIVATE sxi32 SyOSCSPRNG(void *pBuf,sxu32 nLen)` |
|        1 |  190 | `{` |
|      347 |  191 | `	unsigned char *zBuf = (unsigned char *)pBuf;` |
