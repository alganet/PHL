...
|        - |  129 | ` */` |
| 28987204 |  130 | `static sxu8 randomByte(SyPRNGCtx *pCtx)` |
|        5 |  131 | `{` |
|        - |  132 | `  sxu8 t;` |
|        - |  133 |  |
|        - |  134 | `  /* Generate and return single random byte */` |
| 28987209 |  135 | `  pCtx->i++;` |
| 28987209 |  136 | `  t = pCtx->s[pCtx->i];` |
| 28987209 |  137 | `  pCtx->j += t;` |
| 28987209 |  138 | `  pCtx->s[pCtx->i] = pCtx->s[pCtx->j];` |
| 28987209 |  139 | `  pCtx->s[pCtx->j] = t;` |
| 28987209 |  140 | `  t += pCtx->s[pCtx->i];` |
| 28987209 |  141 | `  return pCtx->s[t];` |
|        5 |  142 | `}` |
|  2901770 |  143 | `PH7_PRIVATE sxi32 SyRandomness(SyPRNGCtx *pCtx,void *pBuf,sxu32 nLen)` |
|        5 |  144 | `{` |
|  2901775 |  145 | `	unsigned char *zBuf = (unsigned char *)pBuf;` |
|  2901775 |  146 | `	unsigned char *zEnd = &zBuf[nLen];` |
|        - |  147 | `#if defined(UNTRUST)` |
|        - |  148 | `	if( pCtx == 0 \|\| pBuf == 0 \|\| nLen <= 0 ){` |
|        - |  149 | `		return SXERR_EMPTY;` |
|        - |  150 | `	}` |
|        - |  151 | `#endif` |
|  2901775 |  152 | `	if(pCtx->nMagic != SXPRNG_MAGIC ){` |
|      ! 0 |  153 | `		return SXERR_CORRUPT;` |
|        - |  154 | `	}` |
|  4350155 |  155 | `	for(;;){` |
|  8700307 |  156 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  8695063 |  157 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  8695063 |  158 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  5798561 |  159 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|        5 |  160 | `	}` |
|  2901775 |  161 | `	return SXRET_OK;` |
|  1450892 |  162 | `}` |
|        - |  163 | `/* SPDX-SnippetEnd */` |
