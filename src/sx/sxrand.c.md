...
|       - |  129 | ` */` |
| 2542116 |  130 | `static sxu8 randomByte(SyPRNGCtx *pCtx)` |
|       5 |  131 |  |
|       - |  132 | `  sxu8 t;` |
|       - |  133 |  |
|       - |  134 | `  /* Generate and return single random byte */` |
| 2542121 |  135 | `  pCtx->i++;` |
| 2542121 |  136 | `  t = pCtx->s[pCtx->i];` |
| 2542121 |  137 | `  pCtx->j += t;` |
| 2542121 |  138 | `  pCtx->s[pCtx->i] = pCtx->s[pCtx->j];` |
| 2542121 |  139 | `  pCtx->s[pCtx->j] = t;` |
| 2542121 |  140 | `  t += pCtx->s[pCtx->i];` |
| 2542121 |  141 | `  return pCtx->s[t];` |
|       5 |  142 |  |
|  256160 |  143 | `PH7_PRIVATE sxi32 SyRandomness(SyPRNGCtx *pCtx,void *pBuf,sxu32 nLen)` |
|       5 |  144 |  |
|  256165 |  145 | `	unsigned char *zBuf = (unsigned char *)pBuf;` |
|  256165 |  146 | `	unsigned char *zEnd = &zBuf[nLen];` |
|       - |  147 | `#if defined(UNTRUST)` |
|       - |  148 | `	if( pCtx == 0 \|\| pBuf == 0 \|\| nLen <= 0 ){` |
|       - |  149 | `		return SXERR_EMPTY;` |
|       - |  150 | `	}` |
|       - |  151 | `#endif` |
|  256165 |  152 | `	if(pCtx->nMagic != SXPRNG_MAGIC ){` |
|     ! 0 |  153 | `		return SXERR_CORRUPT;` |
|       - |  154 | `	}` |
|  382649 |  155 | `	for(;;){` |
|  765307 |  156 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  761909 |  157 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  761909 |  158 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  509171 |  159 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|       5 |  160 | `	}` |
|  256165 |  161 | `	return SXRET_OK;` |
|  128084 |  162 |  |
|       - |  163 | `/* SPDX-SnippetEnd */` |
