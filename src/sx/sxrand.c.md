...
|        - |  129 | ` */` |
| 13903408 |  130 | `static sxu8 randomByte(SyPRNGCtx *pCtx)` |
|        5 |  131 | `{` |
|        - |  132 | `  sxu8 t;` |
|        - |  133 |  |
|        - |  134 | `  /* Generate and return single random byte */` |
| 13903413 |  135 | `  pCtx->i++;` |
| 13903413 |  136 | `  t = pCtx->s[pCtx->i];` |
| 13903413 |  137 | `  pCtx->j += t;` |
| 13903413 |  138 | `  pCtx->s[pCtx->i] = pCtx->s[pCtx->j];` |
| 13903413 |  139 | `  pCtx->s[pCtx->j] = t;` |
| 13903413 |  140 | `  t += pCtx->s[pCtx->i];` |
| 13903413 |  141 | `  return pCtx->s[t];` |
|        5 |  142 | `}` |
|  1393446 |  143 | `PH7_PRIVATE sxi32 SyRandomness(SyPRNGCtx *pCtx,void *pBuf,sxu32 nLen)` |
|        5 |  144 | `{` |
|  1393451 |  145 | `	unsigned char *zBuf = (unsigned char *)pBuf;` |
|  1393451 |  146 | `	unsigned char *zEnd = &zBuf[nLen];` |
|        - |  147 | `#if defined(UNTRUST)` |
|        - |  148 | `	if( pCtx == 0 \|\| pBuf == 0 \|\| nLen <= 0 ){` |
|        - |  149 | `		return SXERR_EMPTY;` |
|        - |  150 | `	}` |
|        - |  151 | `#endif` |
|  1393451 |  152 | `	if(pCtx->nMagic != SXPRNG_MAGIC ){` |
|      ! 0 |  153 | `		return SXERR_CORRUPT;` |
|        - |  154 | `	}` |
|  2087616 |  155 | `	for(;;){` |
|  4175237 |  156 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  4169911 |  157 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  4169911 |  158 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  2781815 |  159 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|        5 |  160 | `	}` |
|  1393451 |  161 | `	return SXRET_OK;` |
|   696728 |  162 | `}` |
|        - |  163 | `/* SPDX-SnippetEnd */` |
...
|        - |  187 | `}` |
|        - |  188 | `#endif` |
|      395 |  189 | `PH7_PRIVATE sxi32 SyOSCSPRNG(void *pBuf,sxu32 nLen)` |
|        1 |  190 | `{` |
