...
|        - |  129 | ` */` |
| 29091688 |  130 | `static sxu8 randomByte(SyPRNGCtx *pCtx)` |
|        5 |  131 | `{` |
|        - |  132 | `  sxu8 t;` |
|        - |  133 |  |
|        - |  134 | `  /* Generate and return single random byte */` |
| 29091693 |  135 | `  pCtx->i++;` |
| 29091693 |  136 | `  t = pCtx->s[pCtx->i];` |
| 29091693 |  137 | `  pCtx->j += t;` |
| 29091693 |  138 | `  pCtx->s[pCtx->i] = pCtx->s[pCtx->j];` |
| 29091693 |  139 | `  pCtx->s[pCtx->j] = t;` |
| 29091693 |  140 | `  t += pCtx->s[pCtx->i];` |
| 29091693 |  141 | `  return pCtx->s[t];` |
|        5 |  142 | `}` |
|  2912225 |  143 | `PH7_PRIVATE sxi32 SyRandomness(SyPRNGCtx *pCtx,void *pBuf,sxu32 nLen)` |
|        5 |  144 | `{` |
|  2912230 |  145 | `	unsigned char *zBuf = (unsigned char *)pBuf;` |
|  2912230 |  146 | `	unsigned char *zEnd = &zBuf[nLen];` |
|        - |  147 | `#if defined(UNTRUST)` |
|        - |  148 | `	if( pCtx == 0 \|\| pBuf == 0 \|\| nLen <= 0 ){` |
|        - |  149 | `		return SXERR_EMPTY;` |
|        - |  150 | `	}` |
|        - |  151 | `#endif` |
|  2912230 |  152 | `	if(pCtx->nMagic != SXPRNG_MAGIC ){` |
|      ! 0 |  153 | `		return SXERR_CORRUPT;` |
|        - |  154 | `	}` |
|  4365827 |  155 | `	for(;;){` |
|  8731661 |  156 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  8726406 |  157 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  8726406 |  158 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  5819460 |  159 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|        5 |  160 | `	}` |
|  2912230 |  161 | `	return SXRET_OK;` |
|  1456117 |  162 | `}` |
|        - |  163 | `/* SPDX-SnippetEnd */` |
