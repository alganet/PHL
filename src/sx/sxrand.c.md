...
|        - |  187 | `}` |
|        - |  188 | `#endif` |
|      357 |  189 | `PH7_PRIVATE sxi32 SyOSCSPRNG(void *pBuf,sxu32 nLen)` |
|        2 |  190 | `{` |
|      359 |  191 | `	unsigned char *zBuf = (unsigned char *)pBuf;` |
...
|        - |  206 | `	{` |
|      180 |  207 | `		sxu32 nDone = 0;` |
|      360 |  208 | `		while( nDone < nLen ){` |
|      180 |  209 | `			ssize_t n = getrandom(&zBuf[nDone],nLen - nDone,0);` |
|      180 |  210 | `			if( n > 0 ){` |
|      180 |  211 | `				nDone += (sxu32)n;` |
|      180 |  212 | `				continue;` |
|        - |  213 | `			}` |
