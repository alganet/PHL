...
|       - |  129 | ` */` |
| 2715956 |  130 | `static sxu8 randomByte(SyPRNGCtx *pCtx)` |
|       5 |  131 |  |
|       - |  132 | `  sxu8 t;` |
|       - |  133 |  |
|       - |  134 | `  /* Generate and return single random byte */` |
| 2715961 |  135 | `  pCtx->i++;` |
| 2715961 |  136 | `  t = pCtx->s[pCtx->i];` |
| 2715961 |  137 | `  pCtx->j += t;` |
| 2715961 |  138 | `  pCtx->s[pCtx->i] = pCtx->s[pCtx->j];` |
| 2715961 |  139 | `  pCtx->s[pCtx->j] = t;` |
| 2715961 |  140 | `  t += pCtx->s[pCtx->i];` |
| 2715961 |  141 | `  return pCtx->s[t];` |
|       5 |  142 |  |
|  273541 |  143 | `PH7_PRIVATE sxi32 SyRandomness(SyPRNGCtx *pCtx,void *pBuf,sxu32 nLen)` |
|       5 |  144 |  |
|  273546 |  145 | `	unsigned char *zBuf = (unsigned char *)pBuf;` |
|  273546 |  146 | `	unsigned char *zEnd = &zBuf[nLen];` |
|       - |  147 | `#if defined(UNTRUST)` |
|       - |  148 | `	if( pCtx == 0 \|\| pBuf == 0 \|\| nLen <= 0 ){` |
|       - |  149 | `		return SXERR_EMPTY;` |
|       - |  150 | `	}` |
|       - |  151 | `#endif` |
|  273546 |  152 | `	if(pCtx->nMagic != SXPRNG_MAGIC ){` |
|     ! 0 |  153 | `		return SXERR_CORRUPT;` |
|       - |  154 | `	}` |
|  408724 |  155 | `	for(;;){` |
|  817455 |  156 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  814062 |  157 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  814062 |  158 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  543938 |  159 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|       5 |  160 | `	}` |
|  273546 |  161 | `	return SXRET_OK;` |
|  136775 |  162 |  |
|       - |  163 | `/* SPDX-SnippetEnd */` |
