...
|        - |  129 | ` */` |
| 29046908 |  130 | `static sxu8 randomByte(SyPRNGCtx *pCtx)` |
|        5 |  131 | `{` |
|        - |  132 | `  sxu8 t;` |
|        - |  133 |  |
|        - |  134 | `  /* Generate and return single random byte */` |
| 29046913 |  135 | `  pCtx->i++;` |
| 29046913 |  136 | `  t = pCtx->s[pCtx->i];` |
| 29046913 |  137 | `  pCtx->j += t;` |
| 29046913 |  138 | `  pCtx->s[pCtx->i] = pCtx->s[pCtx->j];` |
| 29046913 |  139 | `  pCtx->s[pCtx->j] = t;` |
| 29046913 |  140 | `  t += pCtx->s[pCtx->i];` |
| 29046913 |  141 | `  return pCtx->s[t];` |
|        5 |  142 | `}` |
|  2907744 |  143 | `PH7_PRIVATE sxi32 SyRandomness(SyPRNGCtx *pCtx,void *pBuf,sxu32 nLen)` |
|        5 |  144 | `{` |
|  2907749 |  145 | `	unsigned char *zBuf = (unsigned char *)pBuf;` |
|  2907749 |  146 | `	unsigned char *zEnd = &zBuf[nLen];` |
|        - |  147 | `#if defined(UNTRUST)` |
|        - |  148 | `	if( pCtx == 0 \|\| pBuf == 0 \|\| nLen <= 0 ){` |
|        - |  149 | `		return SXERR_EMPTY;` |
|        - |  150 | `	}` |
|        - |  151 | `#endif` |
|  2907749 |  152 | `	if(pCtx->nMagic != SXPRNG_MAGIC ){` |
|      ! 0 |  153 | `		return SXERR_CORRUPT;` |
|        - |  154 | `	}` |
|  4359111 |  155 | `	for(;;){` |
|  8718223 |  156 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  8712973 |  157 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  8712973 |  158 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  5810503 |  159 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|        5 |  160 | `	}` |
|  2907749 |  161 | `	return SXRET_OK;` |
|  1453878 |  162 | `}` |
|        - |  163 | `/* SPDX-SnippetEnd */` |
