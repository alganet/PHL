...
|        - |  129 | ` */` |
| 13845072 |  130 | `static sxu8 randomByte(SyPRNGCtx *pCtx)` |
|        5 |  131 | `{` |
|        - |  132 | `  sxu8 t;` |
|        - |  133 |  |
|        - |  134 | `  /* Generate and return single random byte */` |
| 13845077 |  135 | `  pCtx->i++;` |
| 13845077 |  136 | `  t = pCtx->s[pCtx->i];` |
| 13845077 |  137 | `  pCtx->j += t;` |
| 13845077 |  138 | `  pCtx->s[pCtx->i] = pCtx->s[pCtx->j];` |
| 13845077 |  139 | `  pCtx->s[pCtx->j] = t;` |
| 13845077 |  140 | `  t += pCtx->s[pCtx->i];` |
| 13845077 |  141 | `  return pCtx->s[t];` |
|        5 |  142 | `}` |
|  1387607 |  143 | `PH7_PRIVATE sxi32 SyRandomness(SyPRNGCtx *pCtx,void *pBuf,sxu32 nLen)` |
|        5 |  144 | `{` |
|  1387612 |  145 | `	unsigned char *zBuf = (unsigned char *)pBuf;` |
|  1387612 |  146 | `	unsigned char *zEnd = &zBuf[nLen];` |
|        - |  147 | `#if defined(UNTRUST)` |
|        - |  148 | `	if( pCtx == 0 \|\| pBuf == 0 \|\| nLen <= 0 ){` |
|        - |  149 | `		return SXERR_EMPTY;` |
|        - |  150 | `	}` |
|        - |  151 | `#endif` |
|  1387612 |  152 | `	if(pCtx->nMagic != SXPRNG_MAGIC ){` |
|      ! 0 |  153 | `		return SXERR_CORRUPT;` |
|        - |  154 | `	}` |
|  2078865 |  155 | `	for(;;){` |
|  4157729 |  156 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  4152412 |  157 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  4152412 |  158 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  2770146 |  159 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|        5 |  160 | `	}` |
|  1387612 |  161 | `	return SXRET_OK;` |
|   693810 |  162 | `}` |
|        - |  163 | `/* SPDX-SnippetEnd */` |
