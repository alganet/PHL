...
|        - |  129 | ` */` |
| 29002100 |  130 | `static sxu8 randomByte(SyPRNGCtx *pCtx)` |
|        5 |  131 | `{` |
|        - |  132 | `  sxu8 t;` |
|        - |  133 |  |
|        - |  134 | `  /* Generate and return single random byte */` |
| 29002105 |  135 | `  pCtx->i++;` |
| 29002105 |  136 | `  t = pCtx->s[pCtx->i];` |
| 29002105 |  137 | `  pCtx->j += t;` |
| 29002105 |  138 | `  pCtx->s[pCtx->i] = pCtx->s[pCtx->j];` |
| 29002105 |  139 | `  pCtx->s[pCtx->j] = t;` |
| 29002105 |  140 | `  t += pCtx->s[pCtx->i];` |
| 29002105 |  141 | `  return pCtx->s[t];` |
|        5 |  142 | `}` |
...
|        - |  154 | `	}` |
|  4352382 |  155 | `	for(;;){` |
|  8704775 |  156 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  8699532 |  157 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  8699532 |  158 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  5801540 |  159 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|        5 |  160 | `	}` |
