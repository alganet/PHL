...
|       - |  129 | ` */` |
| 2382884 |  130 | `static sxu8 randomByte(SyPRNGCtx *pCtx)` |
|       5 |  131 |  |
|       - |  132 | `  sxu8 t;` |
|       - |  133 |  |
|       - |  134 | `  /* Generate and return single random byte */` |
| 2382889 |  135 | `  pCtx->i++;` |
| 2382889 |  136 | `  t = pCtx->s[pCtx->i];` |
| 2382889 |  137 | `  pCtx->j += t;` |
| 2382889 |  138 | `  pCtx->s[pCtx->i] = pCtx->s[pCtx->j];` |
| 2382889 |  139 | `  pCtx->s[pCtx->j] = t;` |
| 2382889 |  140 | `  t += pCtx->s[pCtx->i];` |
| 2382889 |  141 | `  return pCtx->s[t];` |
|       5 |  142 |  |
|  240020 |  143 | `PH7_PRIVATE sxi32 SyRandomness(SyPRNGCtx *pCtx,void *pBuf,sxu32 nLen)` |
|       5 |  144 |  |
|  240025 |  145 | `	unsigned char *zBuf = (unsigned char *)pBuf;` |
|  240025 |  146 | `	unsigned char *zEnd = &zBuf[nLen];` |
|       - |  147 | `#if defined(UNTRUST)` |
|       - |  148 | `	if( pCtx == 0 \|\| pBuf == 0 \|\| nLen <= 0 ){` |
|       - |  149 | `		return SXERR_EMPTY;` |
|       - |  150 | `	}` |
|       - |  151 | `#endif` |
|  240025 |  152 | `	if(pCtx->nMagic != SXPRNG_MAGIC ){` |
|     ! 0 |  153 | `		return SXERR_CORRUPT;` |
|       - |  154 | `	}` |
|  358623 |  155 | `	for(;;){` |
|  717247 |  156 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  714213 |  157 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  714213 |  158 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  477251 |  159 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|       5 |  160 | `	}` |
|  240025 |  161 | `	return SXRET_OK;` |
|  120016 |  162 |  |
|       - |  163 | `/* SPDX-SnippetEnd */` |
