...
|       - |  111 | ` */` |
| 1252180 |  112 | `static sxu8 randomByte(SyPRNGCtx *pCtx)` |
|       2 |  113 |  |
|       - |  114 | `  sxu8 t;` |
|       - |  115 |  |
|       - |  116 | `  /* Generate and return single random byte */` |
| 1252182 |  117 | `  pCtx->i++;` |
| 1252182 |  118 | `  t = pCtx->s[pCtx->i];` |
| 1252182 |  119 | `  pCtx->j += t;` |
| 1252182 |  120 | `  pCtx->s[pCtx->i] = pCtx->s[pCtx->j];` |
| 1252182 |  121 | `  pCtx->s[pCtx->j] = t;` |
| 1252182 |  122 | `  t += pCtx->s[pCtx->i];` |
| 1252182 |  123 | `  return pCtx->s[t];` |
|       2 |  124 |  |
|  126634 |  125 | `PH7_PRIVATE sxi32 SyRandomness(SyPRNGCtx *pCtx,void *pBuf,sxu32 nLen)` |
|       2 |  126 |  |
|  126636 |  127 | `	unsigned char *zBuf = (unsigned char *)pBuf;` |
|  126636 |  128 | `	unsigned char *zEnd = &zBuf[nLen];` |
|       - |  129 | `#if defined(UNTRUST)` |
|       - |  130 | `	if( pCtx == 0 \|\| pBuf == 0 \|\| nLen <= 0 ){` |
|       - |  131 | `		return SXERR_EMPTY;` |
|       - |  132 | `	}` |
|       - |  133 | `#endif` |
|  126636 |  134 | `	if(pCtx->nMagic != SXPRNG_MAGIC ){` |
|     ! 0 |  135 | `		return SXERR_CORRUPT;` |
|       - |  136 | `	}` |
|  188803 |  137 | `	for(;;){` |
|  377612 |  138 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  375104 |  139 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  375104 |  140 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  251002 |  141 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|       2 |  142 | `	}` |
|  126636 |  143 | `	return SXRET_OK;` |
|   63318 |  144 |  |
|       - |  145 |  |
