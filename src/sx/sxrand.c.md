...
|       - |  187 | `}` |
|       - |  188 | `#endif` |
|     356 |  189 | `PH7_PRIVATE sxi32 SyOSCSPRNG(void *pBuf,sxu32 nLen)` |
|       1 |  190 | `{` |
|     357 |  191 | `	unsigned char *zBuf = (unsigned char *)pBuf;` |
...
|     166 |  203 | `	arc4random_buf(zBuf,(size_t)nLen);` |
|     166 |  204 | `	return SXRET_OK;` |
