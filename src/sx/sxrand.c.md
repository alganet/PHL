...
|       - |  129 | ` */` |
| 2900008 |  130 | `static sxu8 randomByte(SyPRNGCtx *pCtx)` |
|       5 |  131 | `{` |
|       - |  132 | `  sxu8 t;` |
|       - |  133 |  |
|       - |  134 | `  /* Generate and return single random byte */` |
| 2900013 |  135 | `  pCtx->i++;` |
| 2900013 |  136 | `  t = pCtx->s[pCtx->i];` |
| 2900013 |  137 | `  pCtx->j += t;` |
| 2900013 |  138 | `  pCtx->s[pCtx->i] = pCtx->s[pCtx->j];` |
| 2900013 |  139 | `  pCtx->s[pCtx->j] = t;` |
| 2900013 |  140 | `  t += pCtx->s[pCtx->i];` |
| 2900013 |  141 | `  return pCtx->s[t];` |
|       5 |  142 | `}` |
|  292104 |  143 | `PH7_PRIVATE sxi32 SyRandomness(SyPRNGCtx *pCtx,void *pBuf,sxu32 nLen)` |
|       5 |  144 | `{` |
|  292109 |  145 | `	unsigned char *zBuf = (unsigned char *)pBuf;` |
|  292109 |  146 | `	unsigned char *zEnd = &zBuf[nLen];` |
|       - |  147 | `#if defined(UNTRUST)` |
|       - |  148 | `	if( pCtx == 0 \|\| pBuf == 0 \|\| nLen <= 0 ){` |
|       - |  149 | `		return SXERR_EMPTY;` |
|       - |  150 | `	}` |
|       - |  151 | `#endif` |
|  292109 |  152 | `	if(pCtx->nMagic != SXPRNG_MAGIC ){` |
|     ! 0 |  153 | `		return SXERR_CORRUPT;` |
|       - |  154 | `	}` |
|  436440 |  155 | `	for(;;){` |
|  872881 |  156 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  869225 |  157 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  869225 |  158 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  580801 |  159 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|       5 |  160 | `	}` |
|  292109 |  161 | `	return SXRET_OK;` |
|  146058 |  162 | `}` |
|       - |  163 | `/* SPDX-SnippetEnd */` |
...
|       - |  187 | `}` |
|       - |  188 | `#endif` |
|     407 |  189 | `PH7_PRIVATE sxi32 SyOSCSPRNG(void *pBuf,sxu32 nLen)` |
|       1 |  190 | `{` |
|     408 |  191 | `	unsigned char *zBuf = (unsigned char *)pBuf;` |
