...
|       - |  129 | ` */` |
| 2683984 |  130 | `static sxu8 randomByte(SyPRNGCtx *pCtx)` |
|       5 |  131 |  |
|       - |  132 | `  sxu8 t;` |
|       - |  133 |  |
|       - |  134 | `  /* Generate and return single random byte */` |
| 2683989 |  135 | `  pCtx->i++;` |
| 2683989 |  136 | `  t = pCtx->s[pCtx->i];` |
| 2683989 |  137 | `  pCtx->j += t;` |
| 2683989 |  138 | `  pCtx->s[pCtx->i] = pCtx->s[pCtx->j];` |
| 2683989 |  139 | `  pCtx->s[pCtx->j] = t;` |
| 2683989 |  140 | `  t += pCtx->s[pCtx->i];` |
| 2683989 |  141 | `  return pCtx->s[t];` |
|       5 |  142 |  |
|  270345 |  143 | `PH7_PRIVATE sxi32 SyRandomness(SyPRNGCtx *pCtx,void *pBuf,sxu32 nLen)` |
|       5 |  144 |  |
|  270350 |  145 | `	unsigned char *zBuf = (unsigned char *)pBuf;` |
|  270350 |  146 | `	unsigned char *zEnd = &zBuf[nLen];` |
|       - |  147 | `#if defined(UNTRUST)` |
|       - |  148 | `	if( pCtx == 0 \|\| pBuf == 0 \|\| nLen <= 0 ){` |
|       - |  149 | `		return SXERR_EMPTY;` |
|       - |  150 | `	}` |
|       - |  151 | `#endif` |
|  270350 |  152 | `	if(pCtx->nMagic != SXPRNG_MAGIC ){` |
|     ! 0 |  153 | `		return SXERR_CORRUPT;` |
|       - |  154 | `	}` |
|  403929 |  155 | `	for(;;){` |
|  807865 |  156 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  804470 |  157 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  804470 |  158 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  537544 |  159 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|       5 |  160 | `	}` |
|  270350 |  161 | `	return SXRET_OK;` |
|  135177 |  162 |  |
|       - |  163 | `/* SPDX-SnippetEnd */` |
