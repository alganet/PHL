...
|        - |  129 | ` */` |
| 23966308 |  130 | `static sxu8 randomByte(SyPRNGCtx *pCtx)` |
|        5 |  131 | `{` |
|        - |  132 | `  sxu8 t;` |
|        - |  133 |  |
|        - |  134 | `  /* Generate and return single random byte */` |
| 23966313 |  135 | `  pCtx->i++;` |
| 23966313 |  136 | `  t = pCtx->s[pCtx->i];` |
| 23966313 |  137 | `  pCtx->j += t;` |
| 23966313 |  138 | `  pCtx->s[pCtx->i] = pCtx->s[pCtx->j];` |
| 23966313 |  139 | `  pCtx->s[pCtx->j] = t;` |
| 23966313 |  140 | `  t += pCtx->s[pCtx->i];` |
| 23966313 |  141 | `  return pCtx->s[t];` |
|        5 |  142 | `}` |
|  2399649 |  143 | `PH7_PRIVATE sxi32 SyRandomness(SyPRNGCtx *pCtx,void *pBuf,sxu32 nLen)` |
|        5 |  144 | `{` |
|  2399654 |  145 | `	unsigned char *zBuf = (unsigned char *)pBuf;` |
|  2399654 |  146 | `	unsigned char *zEnd = &zBuf[nLen];` |
|        - |  147 | `#if defined(UNTRUST)` |
|        - |  148 | `	if( pCtx == 0 \|\| pBuf == 0 \|\| nLen <= 0 ){` |
|        - |  149 | `		return SXERR_EMPTY;` |
|        - |  150 | `	}` |
|        - |  151 | `#endif` |
|  2399654 |  152 | `	if(pCtx->nMagic != SXPRNG_MAGIC ){` |
|      ! 0 |  153 | `		return SXERR_CORRUPT;` |
|        - |  154 | `	}` |
|  3596994 |  155 | `	for(;;){` |
|  7193999 |  156 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  7188802 |  157 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  7188802 |  158 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  4794374 |  159 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|        5 |  160 | `	}` |
|  2399654 |  161 | `	return SXRET_OK;` |
|  1199828 |  162 | `}` |
|        - |  163 | `/* SPDX-SnippetEnd */` |
...
|        - |  187 | `}` |
|        - |  188 | `#endif` |
|      391 |  189 | `PH7_PRIVATE sxi32 SyOSCSPRNG(void *pBuf,sxu32 nLen)` |
|        2 |  190 | `{` |
|      393 |  191 | `	unsigned char *zBuf = (unsigned char *)pBuf;` |
...
|        - |  206 | `	{` |
|      196 |  207 | `		sxu32 nDone = 0;` |
|      392 |  208 | `		while( nDone < nLen ){` |
|      196 |  209 | `			ssize_t n = getrandom(&zBuf[nDone],nLen - nDone,0);` |
|      196 |  210 | `			if( n > 0 ){` |
|      196 |  211 | `				nDone += (sxu32)n;` |
|      196 |  212 | `				continue;` |
|        - |  213 | `			}` |
