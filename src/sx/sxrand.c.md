...
|        - |  129 | ` */` |
| 13766400 |  130 | `static sxu8 randomByte(SyPRNGCtx *pCtx)` |
|        5 |  131 | `{` |
|        - |  132 | `  sxu8 t;` |
|        - |  133 |  |
|        - |  134 | `  /* Generate and return single random byte */` |
| 13766405 |  135 | `  pCtx->i++;` |
| 13766405 |  136 | `  t = pCtx->s[pCtx->i];` |
| 13766405 |  137 | `  pCtx->j += t;` |
| 13766405 |  138 | `  pCtx->s[pCtx->i] = pCtx->s[pCtx->j];` |
| 13766405 |  139 | `  pCtx->s[pCtx->j] = t;` |
| 13766405 |  140 | `  t += pCtx->s[pCtx->i];` |
| 13766405 |  141 | `  return pCtx->s[t];` |
|        5 |  142 | `}` |
|  1379726 |  143 | `PH7_PRIVATE sxi32 SyRandomness(SyPRNGCtx *pCtx,void *pBuf,sxu32 nLen)` |
|        5 |  144 | `{` |
|  1379731 |  145 | `	unsigned char *zBuf = (unsigned char *)pBuf;` |
|  1379731 |  146 | `	unsigned char *zEnd = &zBuf[nLen];` |
|        - |  147 | `#if defined(UNTRUST)` |
|        - |  148 | `	if( pCtx == 0 \|\| pBuf == 0 \|\| nLen <= 0 ){` |
|        - |  149 | `		return SXERR_EMPTY;` |
|        - |  150 | `	}` |
|        - |  151 | `#endif` |
|  1379731 |  152 | `	if(pCtx->nMagic != SXPRNG_MAGIC ){` |
|      ! 0 |  153 | `		return SXERR_CORRUPT;` |
|        - |  154 | `	}` |
|  2067054 |  155 | `	for(;;){` |
|  4134109 |  156 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  4128815 |  157 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  4128815 |  158 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  2754407 |  159 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|        5 |  160 | `	}` |
|  1379731 |  161 | `	return SXRET_OK;` |
|   689869 |  162 | `}` |
|        - |  163 | `/* SPDX-SnippetEnd */` |
