...
|       - |  129 | ` */` |
| 2693120 |  130 | `static sxu8 randomByte(SyPRNGCtx *pCtx)` |
|       5 |  131 |  |
|       - |  132 | `  sxu8 t;` |
|       - |  133 |  |
|       - |  134 | `  /* Generate and return single random byte */` |
| 2693125 |  135 | `  pCtx->i++;` |
| 2693125 |  136 | `  t = pCtx->s[pCtx->i];` |
| 2693125 |  137 | `  pCtx->j += t;` |
| 2693125 |  138 | `  pCtx->s[pCtx->i] = pCtx->s[pCtx->j];` |
| 2693125 |  139 | `  pCtx->s[pCtx->j] = t;` |
| 2693125 |  140 | `  t += pCtx->s[pCtx->i];` |
| 2693125 |  141 | `  return pCtx->s[t];` |
|       5 |  142 |  |
|  271267 |  143 | `PH7_PRIVATE sxi32 SyRandomness(SyPRNGCtx *pCtx,void *pBuf,sxu32 nLen)` |
|       5 |  144 |  |
|  271272 |  145 | `	unsigned char *zBuf = (unsigned char *)pBuf;` |
|  271272 |  146 | `	unsigned char *zEnd = &zBuf[nLen];` |
|       - |  147 | `#if defined(UNTRUST)` |
|       - |  148 | `	if( pCtx == 0 \|\| pBuf == 0 \|\| nLen <= 0 ){` |
|       - |  149 | `		return SXERR_EMPTY;` |
|       - |  150 | `	}` |
|       - |  151 | `#endif` |
|  271272 |  152 | `	if(pCtx->nMagic != SXPRNG_MAGIC ){` |
|     ! 0 |  153 | `		return SXERR_CORRUPT;` |
|       - |  154 | `	}` |
|  405305 |  155 | `	for(;;){` |
|  810617 |  156 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  807208 |  157 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  807208 |  158 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  539374 |  159 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|       5 |  160 | `	}` |
|  271272 |  161 | `	return SXRET_OK;` |
|  135638 |  162 |  |
|       - |  163 | `/* SPDX-SnippetEnd */` |
