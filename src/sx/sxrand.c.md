...
|        - |  129 | ` */` |
| 29017244 |  130 | `static sxu8 randomByte(SyPRNGCtx *pCtx)` |
|        5 |  131 | `{` |
|        - |  132 | `  sxu8 t;` |
|        - |  133 |  |
|        - |  134 | `  /* Generate and return single random byte */` |
| 29017249 |  135 | `  pCtx->i++;` |
| 29017249 |  136 | `  t = pCtx->s[pCtx->i];` |
| 29017249 |  137 | `  pCtx->j += t;` |
| 29017249 |  138 | `  pCtx->s[pCtx->i] = pCtx->s[pCtx->j];` |
| 29017249 |  139 | `  pCtx->s[pCtx->j] = t;` |
| 29017249 |  140 | `  t += pCtx->s[pCtx->i];` |
| 29017249 |  141 | `  return pCtx->s[t];` |
|        5 |  142 | `}` |
|  2904781 |  143 | `PH7_PRIVATE sxi32 SyRandomness(SyPRNGCtx *pCtx,void *pBuf,sxu32 nLen)` |
|        5 |  144 | `{` |
|  2904786 |  145 | `	unsigned char *zBuf = (unsigned char *)pBuf;` |
|  2904786 |  146 | `	unsigned char *zEnd = &zBuf[nLen];` |
|        - |  147 | `#if defined(UNTRUST)` |
|        - |  148 | `	if( pCtx == 0 \|\| pBuf == 0 \|\| nLen <= 0 ){` |
|        - |  149 | `		return SXERR_EMPTY;` |
|        - |  150 | `	}` |
|        - |  151 | `#endif` |
|  2904786 |  152 | `	if(pCtx->nMagic != SXPRNG_MAGIC ){` |
|      ! 0 |  153 | `		return SXERR_CORRUPT;` |
|        - |  154 | `	}` |
|  4354662 |  155 | `	for(;;){` |
|  8709335 |  156 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  8704066 |  157 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  8704066 |  158 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  5804578 |  159 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|        5 |  160 | `	}` |
|  2904786 |  161 | `	return SXRET_OK;` |
|  1452394 |  162 | `}` |
|        - |  163 | `/* SPDX-SnippetEnd */` |
