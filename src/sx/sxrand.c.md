...
|       - |  129 | ` */` |
| 2372084 |  130 | `static sxu8 randomByte(SyPRNGCtx *pCtx)` |
|       2 |  131 |  |
|       - |  132 | `  sxu8 t;` |
|       - |  133 |  |
|       - |  134 | `  /* Generate and return single random byte */` |
| 2372086 |  135 | `  pCtx->i++;` |
| 2372086 |  136 | `  t = pCtx->s[pCtx->i];` |
| 2372086 |  137 | `  pCtx->j += t;` |
| 2372086 |  138 | `  pCtx->s[pCtx->i] = pCtx->s[pCtx->j];` |
| 2372086 |  139 | `  pCtx->s[pCtx->j] = t;` |
| 2372086 |  140 | `  t += pCtx->s[pCtx->i];` |
| 2372086 |  141 | `  return pCtx->s[t];` |
|       2 |  142 |  |
|  238928 |  143 | `PH7_PRIVATE sxi32 SyRandomness(SyPRNGCtx *pCtx,void *pBuf,sxu32 nLen)` |
|       2 |  144 |  |
|  238930 |  145 | `	unsigned char *zBuf = (unsigned char *)pBuf;` |
|  238930 |  146 | `	unsigned char *zEnd = &zBuf[nLen];` |
|       - |  147 | `#if defined(UNTRUST)` |
|       - |  148 | `	if( pCtx == 0 \|\| pBuf == 0 \|\| nLen <= 0 ){` |
|       - |  149 | `		return SXERR_EMPTY;` |
|       - |  150 | `	}` |
|       - |  151 | `#endif` |
|  238930 |  152 | `	if(pCtx->nMagic != SXPRNG_MAGIC ){` |
|     ! 0 |  153 | `		return SXERR_CORRUPT;` |
|       - |  154 | `	}` |
|  356991 |  155 | `	for(;;){` |
|  713988 |  156 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  710974 |  157 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  710974 |  158 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  475084 |  159 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|       2 |  160 | `	}` |
|  238930 |  161 | `	return SXRET_OK;` |
|  119465 |  162 |  |
|       - |  163 | `/* SPDX-SnippetEnd */` |
