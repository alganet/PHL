...
|      - |  111 | ` */` |
| 443344 |  112 | `static sxu8 randomByte(SyPRNGCtx *pCtx)` |
|      2 |  113 |  |
|      - |  114 | `  sxu8 t;` |
|      - |  115 |  |
|      - |  116 | `  /* Generate and return single random byte */` |
| 443346 |  117 | `  pCtx->i++;` |
| 443346 |  118 | `  t = pCtx->s[pCtx->i];` |
| 443346 |  119 | `  pCtx->j += t;` |
| 443346 |  120 | `  pCtx->s[pCtx->i] = pCtx->s[pCtx->j];` |
| 443346 |  121 | `  pCtx->s[pCtx->j] = t;` |
| 443346 |  122 | `  t += pCtx->s[pCtx->i];` |
| 443346 |  123 | `  return pCtx->s[t];` |
|      2 |  124 |  |
|  45106 |  125 | `PH7_PRIVATE sxi32 SyRandomness(SyPRNGCtx *pCtx,void *pBuf,sxu32 nLen)` |
|      2 |  126 |  |
|  45108 |  127 | `	unsigned char *zBuf = (unsigned char *)pBuf;` |
|  45108 |  128 | `	unsigned char *zEnd = &zBuf[nLen];` |
