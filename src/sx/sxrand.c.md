...
|       - |  126 | ` */` |
| 2331624 |  127 | `static sxu8 randomByte(SyPRNGCtx *pCtx)` |
|       2 |  128 |  |
|       - |  129 | `  sxu8 t;` |
|       - |  130 |  |
|       - |  131 | `  /* Generate and return single random byte */` |
| 2331626 |  132 | `  pCtx->i++;` |
| 2331626 |  133 | `  t = pCtx->s[pCtx->i];` |
| 2331626 |  134 | `  pCtx->j += t;` |
| 2331626 |  135 | `  pCtx->s[pCtx->i] = pCtx->s[pCtx->j];` |
| 2331626 |  136 | `  pCtx->s[pCtx->j] = t;` |
| 2331626 |  137 | `  t += pCtx->s[pCtx->i];` |
| 2331626 |  138 | `  return pCtx->s[t];` |
|       2 |  139 |  |
|  234873 |  140 | `PH7_PRIVATE sxi32 SyRandomness(SyPRNGCtx *pCtx,void *pBuf,sxu32 nLen)` |
|       2 |  141 |  |
|  234875 |  142 | `	unsigned char *zBuf = (unsigned char *)pBuf;` |
|  234875 |  143 | `	unsigned char *zEnd = &zBuf[nLen];` |
|       - |  144 | `#if defined(UNTRUST)` |
|       - |  145 | `	if( pCtx == 0 \|\| pBuf == 0 \|\| nLen <= 0 ){` |
|       - |  146 | `		return SXERR_EMPTY;` |
|       - |  147 | `	}` |
|       - |  148 | `#endif` |
|  234875 |  149 | `	if(pCtx->nMagic != SXPRNG_MAGIC ){` |
|     ! 0 |  150 | `		return SXERR_CORRUPT;` |
|       - |  151 | `	}` |
|  350919 |  152 | `	for(;;){` |
|  701838 |  153 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  698839 |  154 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  698839 |  155 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  466989 |  156 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|       2 |  157 | `	}` |
|  234875 |  158 | `	return SXRET_OK;` |
|  117439 |  159 |  |
...
|       - |  183 |  |
|       - |  184 | `#endif` |
|     338 |  185 | `PH7_PRIVATE sxi32 SyOSCSPRNG(void *pBuf,sxu32 nLen)` |
|       1 |  186 |  |
|     339 |  187 | `	unsigned char *zBuf = (unsigned char *)pBuf;` |
...
|     181 |  199 | `	arc4random_buf(zBuf,(size_t)nLen);` |
|     181 |  200 | `	return SXRET_OK;` |
|       - |  201 | `#elif defined(SX_HAVE_GETRANDOM)` |
|       - |  202 | `	{` |
|     157 |  203 | `		sxu32 nDone = 0;` |
|     314 |  204 | `		while( nDone < nLen ){` |
|     157 |  205 | `			ssize_t n = getrandom(&zBuf[nDone],nLen - nDone,0);` |
|     157 |  206 | `			if( n > 0 ){` |
|     157 |  207 | `				nDone += (sxu32)n;` |
|     157 |  208 | `				continue;` |
|       - |  209 | `			}` |
