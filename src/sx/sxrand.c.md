...
|       - |  126 | ` */` |
| 1963596 |  127 | `static sxu8 randomByte(SyPRNGCtx *pCtx)` |
|       2 |  128 |  |
|       - |  129 | `  sxu8 t;` |
|       - |  130 |  |
|       - |  131 | `  /* Generate and return single random byte */` |
| 1963598 |  132 | `  pCtx->i++;` |
| 1963598 |  133 | `  t = pCtx->s[pCtx->i];` |
| 1963598 |  134 | `  pCtx->j += t;` |
| 1963598 |  135 | `  pCtx->s[pCtx->i] = pCtx->s[pCtx->j];` |
| 1963598 |  136 | `  pCtx->s[pCtx->j] = t;` |
| 1963598 |  137 | `  t += pCtx->s[pCtx->i];` |
| 1963598 |  138 | `  return pCtx->s[t];` |
|       2 |  139 |  |
|  197994 |  140 | `PH7_PRIVATE sxi32 SyRandomness(SyPRNGCtx *pCtx,void *pBuf,sxu32 nLen)` |
|       2 |  141 |  |
|  197996 |  142 | `	unsigned char *zBuf = (unsigned char *)pBuf;` |
|  197996 |  143 | `	unsigned char *zEnd = &zBuf[nLen];` |
|       - |  144 | `#if defined(UNTRUST)` |
|       - |  145 | `	if( pCtx == 0 \|\| pBuf == 0 \|\| nLen <= 0 ){` |
|       - |  146 | `		return SXERR_EMPTY;` |
|       - |  147 | `	}` |
|       - |  148 | `#endif` |
|  197996 |  149 | `	if(pCtx->nMagic != SXPRNG_MAGIC ){` |
|     ! 0 |  150 | `		return SXERR_CORRUPT;` |
|       - |  151 | `	}` |
|  295663 |  152 | `	for(;;){` |
|  591328 |  153 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  588456 |  154 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  588456 |  155 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  393358 |  156 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|       2 |  157 | `	}` |
|  197996 |  158 | `	return SXRET_OK;` |
|   98999 |  159 |  |
...
|     180 |  199 | `	arc4random_buf(zBuf,(size_t)nLen);` |
|     180 |  200 | `	return SXRET_OK;` |
