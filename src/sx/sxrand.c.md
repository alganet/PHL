...
|       - |  129 | ` */` |
| 2537736 |  130 | `static sxu8 randomByte(SyPRNGCtx *pCtx)` |
|       5 |  131 |  |
|       - |  132 | `  sxu8 t;` |
|       - |  133 |  |
|       - |  134 | `  /* Generate and return single random byte */` |
| 2537741 |  135 | `  pCtx->i++;` |
| 2537741 |  136 | `  t = pCtx->s[pCtx->i];` |
| 2537741 |  137 | `  pCtx->j += t;` |
| 2537741 |  138 | `  pCtx->s[pCtx->i] = pCtx->s[pCtx->j];` |
| 2537741 |  139 | `  pCtx->s[pCtx->j] = t;` |
| 2537741 |  140 | `  t += pCtx->s[pCtx->i];` |
| 2537741 |  141 | `  return pCtx->s[t];` |
|       5 |  142 |  |
|  255716 |  143 | `PH7_PRIVATE sxi32 SyRandomness(SyPRNGCtx *pCtx,void *pBuf,sxu32 nLen)` |
|       5 |  144 |  |
|  255721 |  145 | `	unsigned char *zBuf = (unsigned char *)pBuf;` |
|  255721 |  146 | `	unsigned char *zEnd = &zBuf[nLen];` |
|       - |  147 | `#if defined(UNTRUST)` |
|       - |  148 | `	if( pCtx == 0 \|\| pBuf == 0 \|\| nLen <= 0 ){` |
|       - |  149 | `		return SXERR_EMPTY;` |
|       - |  150 | `	}` |
|       - |  151 | `#endif` |
|  255721 |  152 | `	if(pCtx->nMagic != SXPRNG_MAGIC ){` |
|     ! 0 |  153 | `		return SXERR_CORRUPT;` |
|       - |  154 | `	}` |
|  381990 |  155 | `	for(;;){` |
|  763985 |  156 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  760597 |  157 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  760597 |  158 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|  508293 |  159 | `		if( zBuf >= zEnd ){break;}	zBuf[0] = randomByte(pCtx);	zBuf++;` |
|       5 |  160 | `	}` |
|  255721 |  161 | `	return SXRET_OK;` |
|  127863 |  162 |  |
|       - |  163 | `/* SPDX-SnippetEnd */` |
