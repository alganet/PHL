...
|        2 |  190 | `{` |
|      378 |  191 | `	unsigned char *zBuf = (unsigned char *)pBuf;` |
...
|        - |  206 | `	{` |
|      199 |  207 | `		sxu32 nDone = 0;` |
|      398 |  208 | `		while( nDone < nLen ){` |
|      199 |  209 | `			ssize_t n = getrandom(&zBuf[nDone],nLen - nDone,0);` |
|      199 |  210 | `			if( n > 0 ){` |
|      199 |  211 | `				nDone += (sxu32)n;` |
|      199 |  212 | `				continue;` |
|        - |  213 | `			}` |
