...
|         - |   15 | `#include "sxstr.h"` |
|         - |   16 |  |
|  83615353 |   17 | `PH7_PRIVATE sxu32 SyBinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   18 | `{` |
|  83615358 |   19 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   20 | `	unsigned char *zEnd;` |
|  83615358 |   21 | `	sxu32 nH = 5381;` |
|  83615358 |   22 | `	zEnd = &zIn[nLen];` |
| 140766551 |   23 | `	for(;;){` |
| 281531597 |   24 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 259076150 |   25 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 235466884 |   26 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 216676992 |   27 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|         5 |   28 | `	}` |
|  83615358 |   29 | `	return nH;` |
|         5 |   30 | `}` |
...
|     81918 |  144 | `PH7_PRIVATE sxi32 SyLexInit(SyLex *pLex,SySet *pSet,ProcTokenizer xTokenizer,void *pUserData)` |
|         5 |  145 | `{` |
...
|         - |  150 | `	}` |
|         - |  151 | `#endif` |
|     81923 |  152 | `	pLex->pTokenSet = 0;` |
|         - |  153 | `	/* Initialize lexer fields */` |
|     81923 |  154 | `	if( pSet ){` |
|     81923 |  155 | `		if ( SySetElemSize(pSet) != sizeof(SyToken) ){` |
|       ! 0 |  156 | `			return SXERR_INVALID;` |
|         - |  157 | `		}` |
|     81923 |  158 | `		pLex->pTokenSet = pSet;` |
|     40959 |  159 | `	}` |
|     81923 |  160 | `	pStream = &pLex->sStream;` |
|     81923 |  161 | `	pLex->xTokenizer = xTokenizer;` |
|     81923 |  162 | `	pLex->pUserData = pUserData;` |
|         - |  163 |  |
|     81923 |  164 | `	pStream->nLine = 1;` |
|     81923 |  165 | `	pStream->nIgn  = 0;` |
|     81923 |  166 | `	pStream->zText = pStream->zEnd = 0;` |
|     81923 |  167 | `	pStream->pSet  = pSet;` |
|     81923 |  168 | `	return SXRET_OK;` |
|     40964 |  169 | `}` |
|     81908 |  170 | `PH7_PRIVATE sxi32 SyLexTokenizeInput(SyLex *pLex,const char *zInput,sxu32 nLen,void *pCtxData,ProcSort xSort,ProcCmp xCmp)` |
|         5 |  171 | `{` |
...
|         - |  179 | `	}` |
|         - |  180 | `#endif` |
|     81913 |  181 | `	pStream = &pLex->sStream;` |
|         - |  182 | `	/* Point to the head of the input */` |
|     81913 |  183 | `	pStream->zText = pStream->zInput = (const unsigned char *)zInput;` |
|         - |  184 | `	/* Point to the end of the input */` |
|     81913 |  185 | `	pStream->zEnd = &pStream->zInput[nLen];` |
|  81235664 |  186 | `	for(;;){` |
| 162471333 |  187 | `		if( pStream->zText >= pStream->zEnd ){` |
|         - |  188 | `			/* End of the input reached */` |
|     81879 |  189 | `			break;` |
|         - |  190 | `		}` |
| 162389459 |  191 | `		zCur = pStream->zText;` |
|         - |  192 | `		/* Call the tokenizer callback */` |
| 162389459 |  193 | `		rc = pLex->xTokenizer(pStream,&sToken,pLex->pUserData,pCtxData);` |
| 162389459 |  194 | `		if( rc != SXRET_OK && rc != SXERR_CONTINUE ){` |
...
|       ! 0 |  199 | `			break;` |
|         - |  200 | `		}` |
| 162389425 |  201 | `		if( rc == SXERR_CONTINUE ){` |
|         - |  202 | `			/* Request to ignore this token */` |
|    213391 |  203 | `			pStream->nIgn++;` |
| 162282732 |  204 | `		}else if( pLex->pTokenSet  ){` |
|         - |  205 | `			/* Put the token in the set */` |
| 162176039 |  206 | `			rc = SySetPut(pLex->pTokenSet,(const void *)&sToken);` |
| 162176039 |  207 | `			if( rc != SXRET_OK ){` |
|       ! 0 |  208 | `				break;` |
|         - |  209 | `			}` |
|  81088017 |  210 | `		}` |
| 162389425 |  211 | `		if( zCur >= pStream->zText ){` |
|         - |  212 | `			/* Automatic advance of the stream cursor */` |
|       ! 0 |  213 | `			pStream->zText = &zCur[1];` |
|       ! 0 |  214 | `		}` |
|         5 |  215 | `	}` |
|     81879 |  216 | `	if( xSort &&  pLex->pTokenSet ){` |
...
|       ! 0 |  224 | `	}` |
|     81879 |  225 | `	return SXRET_OK;` |
|     40959 |  226 | `}` |
|     81918 |  227 | `PH7_PRIVATE sxi32 SyLexRelease(SyLex *pLex)` |
|         5 |  228 | `{` |
|     81923 |  229 | `	sxi32 rc = SXRET_OK;` |
|         - |  230 | `#if defined (UNTRUST)` |
|         - |  231 | `	if ( INVALID_LEXER(pLex) ){` |
|         - |  232 | `		return SXERR_CORRUPT;` |
|         - |  233 | `	}` |
|         - |  234 | `#else` |
|     40959 |  235 | `	SXUNUSED(pLex); /* Prevent compiler warning */` |
|         - |  236 | `#endif` |
|     81923 |  237 | `	return rc;` |
|         5 |  238 | `}` |
