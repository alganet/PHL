...
|        - |   15 | `#include "sxstr.h"` |
|        - |   16 |  |
| 23076178 |   17 | `PH7_PRIVATE sxu32 SyBinHash(const void *pSrc,sxu32 nLen)` |
|        5 |   18 | `{` |
| 23076183 |   19 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|        - |   20 | `	unsigned char *zEnd;` |
| 23076183 |   21 | `	sxu32 nH = 5381;` |
| 23076183 |   22 | `	zEnd = &zIn[nLen];` |
| 41199571 |   23 | `	for(;;){` |
| 82396427 |   24 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 76134297 |   25 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 70731357 |   26 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 64666339 |   27 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|        5 |   28 | `	}` |
| 23076183 |   29 | `	return nH;` |
|        5 |   30 | `}` |
...
|    20620 |  144 | `PH7_PRIVATE sxi32 SyLexInit(SyLex *pLex,SySet *pSet,ProcTokenizer xTokenizer,void *pUserData)` |
|        5 |  145 | `{` |
...
|        - |  150 | `	}` |
|        - |  151 | `#endif` |
|    20625 |  152 | `	pLex->pTokenSet = 0;` |
|        - |  153 | `	/* Initialize lexer fields */` |
|    20625 |  154 | `	if( pSet ){` |
|    20625 |  155 | `		if ( SySetElemSize(pSet) != sizeof(SyToken) ){` |
|      ! 0 |  156 | `			return SXERR_INVALID;` |
|        - |  157 | `		}` |
|    20625 |  158 | `		pLex->pTokenSet = pSet;` |
|    10310 |  159 | `	}` |
|    20625 |  160 | `	pStream = &pLex->sStream;` |
|    20625 |  161 | `	pLex->xTokenizer = xTokenizer;` |
|    20625 |  162 | `	pLex->pUserData = pUserData;` |
|        - |  163 |  |
|    20625 |  164 | `	pStream->nLine = 1;` |
|    20625 |  165 | `	pStream->nIgn  = 0;` |
|    20625 |  166 | `	pStream->zText = pStream->zEnd = 0;` |
|    20625 |  167 | `	pStream->pSet  = pSet;` |
|    20625 |  168 | `	return SXRET_OK;` |
|    10315 |  169 | `}` |
|    20610 |  170 | `PH7_PRIVATE sxi32 SyLexTokenizeInput(SyLex *pLex,const char *zInput,sxu32 nLen,void *pCtxData,ProcSort xSort,ProcCmp xCmp)` |
|        5 |  171 | `{` |
...
|        - |  179 | `	}` |
|        - |  180 | `#endif` |
|    20615 |  181 | `	pStream = &pLex->sStream;` |
|        - |  182 | `	/* Point to the head of the input */` |
|    20615 |  183 | `	pStream->zText = pStream->zInput = (const unsigned char *)zInput;` |
|        - |  184 | `	/* Point to the end of the input */` |
|    20615 |  185 | `	pStream->zEnd = &pStream->zInput[nLen];` |
|  5812804 |  186 | `	for(;;){` |
| 11625613 |  187 | `		if( pStream->zText >= pStream->zEnd ){` |
|        - |  188 | `			/* End of the input reached */` |
|    20583 |  189 | `			break;` |
|        - |  190 | `		}` |
| 11605035 |  191 | `		zCur = pStream->zText;` |
|        - |  192 | `		/* Call the tokenizer callback */` |
| 11605035 |  193 | `		rc = pLex->xTokenizer(pStream,&sToken,pLex->pUserData,pCtxData);` |
| 11605035 |  194 | `		if( rc != SXRET_OK && rc != SXERR_CONTINUE ){` |
...
|      ! 0 |  199 | `			break;` |
|        - |  200 | `		}` |
| 11605003 |  201 | `		if( rc == SXERR_CONTINUE ){` |
|        - |  202 | `			/* Request to ignore this token */` |
|    93527 |  203 | `			pStream->nIgn++;` |
| 11558242 |  204 | `		}else if( pLex->pTokenSet  ){` |
|        - |  205 | `			/* Put the token in the set */` |
| 11511481 |  206 | `			rc = SySetPut(pLex->pTokenSet,(const void *)&sToken);` |
| 11511481 |  207 | `			if( rc != SXRET_OK ){` |
|      ! 0 |  208 | `				break;` |
|        - |  209 | `			}` |
|  5755738 |  210 | `		}` |
| 11605003 |  211 | `		if( zCur >= pStream->zText ){` |
|        - |  212 | `			/* Automatic advance of the stream cursor */` |
|      ! 0 |  213 | `			pStream->zText = &zCur[1];` |
|      ! 0 |  214 | `		}` |
|        5 |  215 | `	}` |
|    20583 |  216 | `	if( xSort &&  pLex->pTokenSet ){` |
...
|      ! 0 |  224 | `	}` |
|    20583 |  225 | `	return SXRET_OK;` |
|    10310 |  226 | `}` |
|    20620 |  227 | `PH7_PRIVATE sxi32 SyLexRelease(SyLex *pLex)` |
|        5 |  228 | `{` |
|    20625 |  229 | `	sxi32 rc = SXRET_OK;` |
|        - |  230 | `#if defined (UNTRUST)` |
|        - |  231 | `	if ( INVALID_LEXER(pLex) ){` |
|        - |  232 | `		return SXERR_CORRUPT;` |
|        - |  233 | `	}` |
|        - |  234 | `#else` |
|    10310 |  235 | `	SXUNUSED(pLex); /* Prevent compiler warning */` |
|        - |  236 | `#endif` |
|    20625 |  237 | `	return rc;` |
|        5 |  238 | `}` |
