...
|        - |   15 | `#include "sxstr.h"` |
|        - |   16 |  |
|  7696712 |   17 | `PH7_PRIVATE sxu32 SyBinHash(const void *pSrc,sxu32 nLen)` |
|        2 |   18 |  |
|  7696714 |   19 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|        - |   20 | `	unsigned char *zEnd;` |
|  7696714 |   21 | `	sxu32 nH = 5381;` |
|  7696714 |   22 | `	zEnd = &zIn[nLen];` |
| 12260284 |   23 | `	for(;;){` |
| 24519162 |   24 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 22817716 |   25 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 20659970 |   26 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 18403186 |   27 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|        2 |   28 | `	}` |
|  7696714 |   29 | `	return nH;` |
|        2 |   30 |  |
|    35602 |   31 | `PH7_PRIVATE sxu32 SyStrHash(const void *pSrc,sxu32 nLen)` |
|        2 |   32 |  |
|    35604 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|        - |   34 | `	unsigned char *zEnd;` |
|    35604 |   35 | `	sxu32 nH = 5381;` |
|    35604 |   36 | `	zEnd = &zIn[nLen];` |
|    58869 |   37 | `	for(;;){` |
|   117740 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + SyToLower(zIn[0]); zIn++;` |
|   109330 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + SyToLower(zIn[0]); zIn++;` |
|    90386 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + SyToLower(zIn[0]); zIn++;` |
|    82298 |   41 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + SyToLower(zIn[0]); zIn++;` |
|        2 |   42 | `	}` |
|    35604 |   43 | `	return nH;` |
|        2 |   44 |  |
...
|     9378 |  144 | `PH7_PRIVATE sxi32 SyLexInit(SyLex *pLex,SySet *pSet,ProcTokenizer xTokenizer,void *pUserData)` |
|        2 |  145 |  |
...
|        - |  150 | `	}` |
|        - |  151 | `#endif` |
|     9380 |  152 | `	pLex->pTokenSet = 0;` |
|        - |  153 | `	/* Initialize lexer fields */` |
|     9380 |  154 | `	if( pSet ){` |
|     9380 |  155 | `		if ( SySetElemSize(pSet) != sizeof(SyToken) ){` |
|      ! 0 |  156 | `			return SXERR_INVALID;` |
|        - |  157 | `		}` |
|     9380 |  158 | `		pLex->pTokenSet = pSet;` |
|     4689 |  159 | `	}` |
|     9380 |  160 | `	pStream = &pLex->sStream;` |
|     9380 |  161 | `	pLex->xTokenizer = xTokenizer;` |
|     9380 |  162 | `	pLex->pUserData = pUserData;` |
|        - |  163 |  |
|     9380 |  164 | `	pStream->nLine = 1;` |
|     9380 |  165 | `	pStream->nIgn  = 0;` |
|     9380 |  166 | `	pStream->zText = pStream->zEnd = 0;` |
|     9380 |  167 | `	pStream->pSet  = pSet;` |
|     9380 |  168 | `	return SXRET_OK;` |
|     4691 |  169 |  |
|     9368 |  170 | `PH7_PRIVATE sxi32 SyLexTokenizeInput(SyLex *pLex,const char *zInput,sxu32 nLen,void *pCtxData,ProcSort xSort,ProcCmp xCmp)` |
|        2 |  171 |  |
...
|        - |  179 | `	}` |
|        - |  180 | `#endif` |
|     9370 |  181 | `	pStream = &pLex->sStream;` |
|        - |  182 | `	/* Point to the head of the input */` |
|     9370 |  183 | `	pStream->zText = pStream->zInput = (const unsigned char *)zInput;` |
|        - |  184 | `	/* Point to the end of the input */` |
|     9370 |  185 | `	pStream->zEnd = &pStream->zInput[nLen];` |
|  1424707 |  186 | `	for(;;){` |
|  2849416 |  187 | `		if( pStream->zText >= pStream->zEnd ){` |
|        - |  188 | `			/* End of the input reached */` |
|     9344 |  189 | `			break;` |
|        - |  190 | `		}` |
|  2840074 |  191 | `		zCur = pStream->zText;` |
|        - |  192 | `		/* Call the tokenizer callback */` |
|  2840074 |  193 | `		rc = pLex->xTokenizer(pStream,&sToken,pLex->pUserData,pCtxData);` |
|  2840074 |  194 | `		if( rc != SXRET_OK && rc != SXERR_CONTINUE ){` |
...
|      ! 0 |  199 | `			break;` |
|        - |  200 | `		}` |
|  2840048 |  201 | `		if( rc == SXERR_CONTINUE ){` |
|        - |  202 | `			/* Request to ignore this token */` |
|    36836 |  203 | `			pStream->nIgn++;` |
|  2821631 |  204 | `		}else if( pLex->pTokenSet  ){` |
|        - |  205 | `			/* Put the token in the set */` |
|  2803214 |  206 | `			rc = SySetPut(pLex->pTokenSet,(const void *)&sToken);` |
|  2803214 |  207 | `			if( rc != SXRET_OK ){` |
|      ! 0 |  208 | `				break;` |
|        - |  209 | `			}` |
|  1401606 |  210 | `		}` |
|  2840048 |  211 | `		if( zCur >= pStream->zText ){` |
|        - |  212 | `			/* Automatic advance of the stream cursor */` |
|      ! 0 |  213 | `			pStream->zText = &zCur[1];` |
|      ! 0 |  214 | `		}` |
|        2 |  215 | `	}` |
|     9344 |  216 | `	if( xSort &&  pLex->pTokenSet ){` |
...
|      ! 0 |  224 | `	}` |
|     9344 |  225 | `	return SXRET_OK;` |
|     4686 |  226 |  |
|     9378 |  227 | `PH7_PRIVATE sxi32 SyLexRelease(SyLex *pLex)` |
|        2 |  228 |  |
|     9380 |  229 | `	sxi32 rc = SXRET_OK;` |
|        - |  230 | `#if defined (UNTRUST)` |
|        - |  231 | `	if ( INVALID_LEXER(pLex) ){` |
|        - |  232 | `		return SXERR_CORRUPT;` |
|        - |  233 | `	}` |
|        - |  234 | `#else` |
|     4689 |  235 | `	SXUNUSED(pLex); /* Prevent compiler warning */` |
|        - |  236 | `#endif` |
|     9380 |  237 | `	return rc;` |
|        2 |  238 |  |
