...
|        - |   15 | `#include "sxstr.h"` |
|        - |   16 |  |
| 17570770 |   17 | `PH7_PRIVATE sxu32 SyBinHash(const void *pSrc,sxu32 nLen)` |
|        2 |   18 |  |
| 17570772 |   19 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|        - |   20 | `	unsigned char *zEnd;` |
| 17570772 |   21 | `	sxu32 nH = 5381;` |
| 17570772 |   22 | `	zEnd = &zIn[nLen];` |
| 29447917 |   23 | `	for(;;){` |
| 58894428 |   24 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 54526420 |   25 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 50116160 |   26 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 45157682 |   27 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|        2 |   28 | `	}` |
| 17570772 |   29 | `	return nH;` |
|        2 |   30 |  |
...
|    15378 |  144 | `PH7_PRIVATE sxi32 SyLexInit(SyLex *pLex,SySet *pSet,ProcTokenizer xTokenizer,void *pUserData)` |
|        2 |  145 |  |
...
|        - |  150 | `	}` |
|        - |  151 | `#endif` |
|    15380 |  152 | `	pLex->pTokenSet = 0;` |
|        - |  153 | `	/* Initialize lexer fields */` |
|    15380 |  154 | `	if( pSet ){` |
|    15380 |  155 | `		if ( SySetElemSize(pSet) != sizeof(SyToken) ){` |
|      ! 0 |  156 | `			return SXERR_INVALID;` |
|        - |  157 | `		}` |
|    15380 |  158 | `		pLex->pTokenSet = pSet;` |
|     7689 |  159 | `	}` |
|    15380 |  160 | `	pStream = &pLex->sStream;` |
|    15380 |  161 | `	pLex->xTokenizer = xTokenizer;` |
|    15380 |  162 | `	pLex->pUserData = pUserData;` |
|        - |  163 |  |
|    15380 |  164 | `	pStream->nLine = 1;` |
|    15380 |  165 | `	pStream->nIgn  = 0;` |
|    15380 |  166 | `	pStream->zText = pStream->zEnd = 0;` |
|    15380 |  167 | `	pStream->pSet  = pSet;` |
|    15380 |  168 | `	return SXRET_OK;` |
|     7691 |  169 |  |
|    15368 |  170 | `PH7_PRIVATE sxi32 SyLexTokenizeInput(SyLex *pLex,const char *zInput,sxu32 nLen,void *pCtxData,ProcSort xSort,ProcCmp xCmp)` |
|        2 |  171 |  |
...
|        - |  179 | `	}` |
|        - |  180 | `#endif` |
|    15370 |  181 | `	pStream = &pLex->sStream;` |
|        - |  182 | `	/* Point to the head of the input */` |
|    15370 |  183 | `	pStream->zText = pStream->zInput = (const unsigned char *)zInput;` |
|        - |  184 | `	/* Point to the end of the input */` |
|    15370 |  185 | `	pStream->zEnd = &pStream->zInput[nLen];` |
|  4700158 |  186 | `	for(;;){` |
|  9400318 |  187 | `		if( pStream->zText >= pStream->zEnd ){` |
|        - |  188 | `			/* End of the input reached */` |
|    15338 |  189 | `			break;` |
|        - |  190 | `		}` |
|  9384982 |  191 | `		zCur = pStream->zText;` |
|        - |  192 | `		/* Call the tokenizer callback */` |
|  9384982 |  193 | `		rc = pLex->xTokenizer(pStream,&sToken,pLex->pUserData,pCtxData);` |
|  9384982 |  194 | `		if( rc != SXRET_OK && rc != SXERR_CONTINUE ){` |
...
|      ! 0 |  199 | `			break;` |
|        - |  200 | `		}` |
|  9384950 |  201 | `		if( rc == SXERR_CONTINUE ){` |
|        - |  202 | `			/* Request to ignore this token */` |
|    79606 |  203 | `			pStream->nIgn++;` |
|  9345148 |  204 | `		}else if( pLex->pTokenSet  ){` |
|        - |  205 | `			/* Put the token in the set */` |
|  9305346 |  206 | `			rc = SySetPut(pLex->pTokenSet,(const void *)&sToken);` |
|  9305346 |  207 | `			if( rc != SXRET_OK ){` |
|      ! 0 |  208 | `				break;` |
|        - |  209 | `			}` |
|  4652672 |  210 | `		}` |
|  9384950 |  211 | `		if( zCur >= pStream->zText ){` |
|        - |  212 | `			/* Automatic advance of the stream cursor */` |
|      ! 0 |  213 | `			pStream->zText = &zCur[1];` |
|      ! 0 |  214 | `		}` |
|        2 |  215 | `	}` |
|    15338 |  216 | `	if( xSort &&  pLex->pTokenSet ){` |
...
|      ! 0 |  224 | `	}` |
|    15338 |  225 | `	return SXRET_OK;` |
|     7686 |  226 |  |
|    15378 |  227 | `PH7_PRIVATE sxi32 SyLexRelease(SyLex *pLex)` |
|        2 |  228 |  |
|    15380 |  229 | `	sxi32 rc = SXRET_OK;` |
|        - |  230 | `#if defined (UNTRUST)` |
|        - |  231 | `	if ( INVALID_LEXER(pLex) ){` |
|        - |  232 | `		return SXERR_CORRUPT;` |
|        - |  233 | `	}` |
|        - |  234 | `#else` |
|     7689 |  235 | `	SXUNUSED(pLex); /* Prevent compiler warning */` |
|        - |  236 | `#endif` |
|    15380 |  237 | `	return rc;` |
|        2 |  238 |  |
