...
|         5 |   32 | `{` |
|    924379 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   34 | `	unsigned char *zEnd;` |
|    924379 |   35 | `	sxu32 nH = 5381;` |
|    924379 |   36 | `	zEnd = &zIn[nLen];` |
|   1814471 |   37 | `	for(;;){` |
|   3628947 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + SyToLower(zIn[0]); zIn++;` |
|   3486301 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + SyToLower(zIn[0]); zIn++;` |
|   3297629 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + SyToLower(zIn[0]); zIn++;` |
|   2898295 |   41 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + SyToLower(zIn[0]); zIn++;` |
|         5 |   42 | `	}` |
|    924379 |   43 | `	return nH;` |
|         5 |   44 | `}` |
...
|     63962 |  144 | `PH7_PRIVATE sxi32 SyLexInit(SyLex *pLex,SySet *pSet,ProcTokenizer xTokenizer,void *pUserData)` |
|         5 |  145 | `{` |
...
|         - |  150 | `	}` |
|         - |  151 | `#endif` |
|     63967 |  152 | `	pLex->pTokenSet = 0;` |
|         - |  153 | `	/* Initialize lexer fields */` |
|     63967 |  154 | `	if( pSet ){` |
|     63967 |  155 | `		if ( SySetElemSize(pSet) != sizeof(SyToken) ){` |
|       ! 0 |  156 | `			return SXERR_INVALID;` |
|         - |  157 | `		}` |
|     63967 |  158 | `		pLex->pTokenSet = pSet;` |
|     31981 |  159 | `	}` |
|     63967 |  160 | `	pStream = &pLex->sStream;` |
|     63967 |  161 | `	pLex->xTokenizer = xTokenizer;` |
|     63967 |  162 | `	pLex->pUserData = pUserData;` |
|         - |  163 |  |
|     63967 |  164 | `	pStream->nLine = 1;` |
|     63967 |  165 | `	pStream->nIgn  = 0;` |
|     63967 |  166 | `	pStream->zText = pStream->zEnd = 0;` |
|     63967 |  167 | `	pStream->pSet  = pSet;` |
|     63967 |  168 | `	return SXRET_OK;` |
|     31986 |  169 | `}` |
|     63952 |  170 | `PH7_PRIVATE sxi32 SyLexTokenizeInput(SyLex *pLex,const char *zInput,sxu32 nLen,void *pCtxData,ProcSort xSort,ProcCmp xCmp)` |
|         5 |  171 | `{` |
...
|         - |  179 | `	}` |
|         - |  180 | `#endif` |
|     63957 |  181 | `	pStream = &pLex->sStream;` |
|         - |  182 | `	/* Point to the head of the input */` |
|     63957 |  183 | `	pStream->zText = pStream->zInput = (const unsigned char *)zInput;` |
|         - |  184 | `	/* Point to the end of the input */` |
|     63957 |  185 | `	pStream->zEnd = &pStream->zInput[nLen];` |
|  38992345 |  186 | `	for(;;){` |
|  77984695 |  187 | `		if( pStream->zText >= pStream->zEnd ){` |
|         - |  188 | `			/* End of the input reached */` |
|     63923 |  189 | `			break;` |
|         - |  190 | `		}` |
|  77920777 |  191 | `		zCur = pStream->zText;` |
|         - |  192 | `		/* Call the tokenizer callback */` |
|  77920777 |  193 | `		rc = pLex->xTokenizer(pStream,&sToken,pLex->pUserData,pCtxData);` |
|  77920777 |  194 | `		if( rc != SXRET_OK && rc != SXERR_CONTINUE ){` |
...
|       ! 0 |  199 | `			break;` |
|         - |  200 | `		}` |
|  77920743 |  201 | `		if( rc == SXERR_CONTINUE ){` |
|         - |  202 | `			/* Request to ignore this token */` |
|    107779 |  203 | `			pStream->nIgn++;` |
|  77866856 |  204 | `		}else if( pLex->pTokenSet  ){` |
|         - |  205 | `			/* Put the token in the set */` |
|  77812969 |  206 | `			rc = SySetPut(pLex->pTokenSet,(const void *)&sToken);` |
|  77812969 |  207 | `			if( rc != SXRET_OK ){` |
|       ! 0 |  208 | `				break;` |
|         - |  209 | `			}` |
|  38906482 |  210 | `		}` |
|  77920743 |  211 | `		if( zCur >= pStream->zText ){` |
|         - |  212 | `			/* Automatic advance of the stream cursor */` |
|       ! 0 |  213 | `			pStream->zText = &zCur[1];` |
|       ! 0 |  214 | `		}` |
|         5 |  215 | `	}` |
|     63923 |  216 | `	if( xSort &&  pLex->pTokenSet ){` |
...
|       ! 0 |  224 | `	}` |
|     63923 |  225 | `	return SXRET_OK;` |
|     31981 |  226 | `}` |
|     63962 |  227 | `PH7_PRIVATE sxi32 SyLexRelease(SyLex *pLex)` |
|         5 |  228 | `{` |
|     63967 |  229 | `	sxi32 rc = SXRET_OK;` |
|         - |  230 | `#if defined (UNTRUST)` |
|         - |  231 | `	if ( INVALID_LEXER(pLex) ){` |
|         - |  232 | `		return SXERR_CORRUPT;` |
|         - |  233 | `	}` |
|         - |  234 | `#else` |
|     31981 |  235 | `	SXUNUSED(pLex); /* Prevent compiler warning */` |
|         - |  236 | `#endif` |
|     63967 |  237 | `	return rc;` |
|         5 |  238 | `}` |
