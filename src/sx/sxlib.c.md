...
|        - |   15 | `#include "sxstr.h"` |
|        - |   16 |  |
| 25516750 |   17 | `PH7_PRIVATE sxu32 SyBinHash(const void *pSrc,sxu32 nLen)` |
|        5 |   18 | `{` |
| 25516755 |   19 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|        - |   20 | `	unsigned char *zEnd;` |
| 25516755 |   21 | `	sxu32 nH = 5381;` |
| 25516755 |   22 | `	zEnd = &zIn[nLen];` |
| 45421575 |   23 | `	for(;;){` |
| 90840435 |   24 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 83991547 |   25 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 77911455 |   26 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 71301829 |   27 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|        5 |   28 | `	}` |
| 25516755 |   29 | `	return nH;` |
|        5 |   30 | `}` |
...
|    20708 |  144 | `PH7_PRIVATE sxi32 SyLexInit(SyLex *pLex,SySet *pSet,ProcTokenizer xTokenizer,void *pUserData)` |
|        5 |  145 | `{` |
...
|        - |  150 | `	}` |
|        - |  151 | `#endif` |
|    20713 |  152 | `	pLex->pTokenSet = 0;` |
|        - |  153 | `	/* Initialize lexer fields */` |
|    20713 |  154 | `	if( pSet ){` |
|    20713 |  155 | `		if ( SySetElemSize(pSet) != sizeof(SyToken) ){` |
|      ! 0 |  156 | `			return SXERR_INVALID;` |
|        - |  157 | `		}` |
|    20713 |  158 | `		pLex->pTokenSet = pSet;` |
|    10354 |  159 | `	}` |
|    20713 |  160 | `	pStream = &pLex->sStream;` |
|    20713 |  161 | `	pLex->xTokenizer = xTokenizer;` |
|    20713 |  162 | `	pLex->pUserData = pUserData;` |
|        - |  163 |  |
|    20713 |  164 | `	pStream->nLine = 1;` |
|    20713 |  165 | `	pStream->nIgn  = 0;` |
|    20713 |  166 | `	pStream->zText = pStream->zEnd = 0;` |
|    20713 |  167 | `	pStream->pSet  = pSet;` |
|    20713 |  168 | `	return SXRET_OK;` |
|    10359 |  169 | `}` |
|    20698 |  170 | `PH7_PRIVATE sxi32 SyLexTokenizeInput(SyLex *pLex,const char *zInput,sxu32 nLen,void *pCtxData,ProcSort xSort,ProcCmp xCmp)` |
|        5 |  171 | `{` |
...
|        - |  179 | `	}` |
|        - |  180 | `#endif` |
|    20703 |  181 | `	pStream = &pLex->sStream;` |
...
|  6387681 |  186 | `	for(;;){` |
| 12775367 |  187 | `		if( pStream->zText >= pStream->zEnd ){` |
|        - |  188 | `			/* End of the input reached */` |
|    20669 |  189 | `			break;` |
|        - |  190 | `		}` |
| 12754703 |  191 | `		zCur = pStream->zText;` |
|        - |  192 | `		/* Call the tokenizer callback */` |
| 12754703 |  193 | `		rc = pLex->xTokenizer(pStream,&sToken,pLex->pUserData,pCtxData);` |
| 12754703 |  194 | `		if( rc != SXRET_OK && rc != SXERR_CONTINUE ){` |
...
|      ! 0 |  199 | `			break;` |
|        - |  200 | `		}` |
| 12754669 |  201 | `		if( rc == SXERR_CONTINUE ){` |
|        - |  202 | `			/* Request to ignore this token */` |
|    98211 |  203 | `			pStream->nIgn++;` |
| 12705566 |  204 | `		}else if( pLex->pTokenSet  ){` |
|        - |  205 | `			/* Put the token in the set */` |
| 12656463 |  206 | `			rc = SySetPut(pLex->pTokenSet,(const void *)&sToken);` |
| 12656463 |  207 | `			if( rc != SXRET_OK ){` |
|      ! 0 |  208 | `				break;` |
|        - |  209 | `			}` |
|  6328229 |  210 | `		}` |
| 12754669 |  211 | `		if( zCur >= pStream->zText ){` |
|        - |  212 | `			/* Automatic advance of the stream cursor */` |
|      ! 0 |  213 | `			pStream->zText = &zCur[1];` |
|      ! 0 |  214 | `		}` |
|        5 |  215 | `	}` |
|    20669 |  216 | `	if( xSort &&  pLex->pTokenSet ){` |
...
|      ! 0 |  224 | `	}` |
|    20669 |  225 | `	return SXRET_OK;` |
|    10354 |  226 | `}` |
|    20708 |  227 | `PH7_PRIVATE sxi32 SyLexRelease(SyLex *pLex)` |
|        5 |  228 | `{` |
|    20713 |  229 | `	sxi32 rc = SXRET_OK;` |
|        - |  230 | `#if defined (UNTRUST)` |
|        - |  231 | `	if ( INVALID_LEXER(pLex) ){` |
|        - |  232 | `		return SXERR_CORRUPT;` |
|        - |  233 | `	}` |
|        - |  234 | `#else` |
|    10354 |  235 | `	SXUNUSED(pLex); /* Prevent compiler warning */` |
|        - |  236 | `#endif` |
|    20713 |  237 | `	return rc;` |
|        5 |  238 | `}` |
