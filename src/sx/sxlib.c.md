...
|        - |   15 | `#include "sxstr.h"` |
|        - |   16 |  |
| 25053744 |   17 | `PH7_PRIVATE sxu32 SyBinHash(const void *pSrc,sxu32 nLen)` |
|        5 |   18 | `{` |
| 25053749 |   19 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|        - |   20 | `	unsigned char *zEnd;` |
| 25053749 |   21 | `	sxu32 nH = 5381;` |
| 25053749 |   22 | `	zEnd = &zIn[nLen];` |
| 44552797 |   23 | `	for(;;){` |
| 89102879 |   24 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 82302481 |   25 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 76407497 |   26 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 69935647 |   27 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|        5 |   28 | `	}` |
| 25053749 |   29 | `	return nH;` |
|        5 |   30 | `}` |
...
|    20642 |  144 | `PH7_PRIVATE sxi32 SyLexInit(SyLex *pLex,SySet *pSet,ProcTokenizer xTokenizer,void *pUserData)` |
|        5 |  145 | `{` |
...
|        - |  150 | `	}` |
|        - |  151 | `#endif` |
|    20647 |  152 | `	pLex->pTokenSet = 0;` |
|        - |  153 | `	/* Initialize lexer fields */` |
|    20647 |  154 | `	if( pSet ){` |
|    20647 |  155 | `		if ( SySetElemSize(pSet) != sizeof(SyToken) ){` |
|      ! 0 |  156 | `			return SXERR_INVALID;` |
|        - |  157 | `		}` |
|    20647 |  158 | `		pLex->pTokenSet = pSet;` |
|    10321 |  159 | `	}` |
|    20647 |  160 | `	pStream = &pLex->sStream;` |
|    20647 |  161 | `	pLex->xTokenizer = xTokenizer;` |
|    20647 |  162 | `	pLex->pUserData = pUserData;` |
|        - |  163 |  |
|    20647 |  164 | `	pStream->nLine = 1;` |
|    20647 |  165 | `	pStream->nIgn  = 0;` |
|    20647 |  166 | `	pStream->zText = pStream->zEnd = 0;` |
|    20647 |  167 | `	pStream->pSet  = pSet;` |
|    20647 |  168 | `	return SXRET_OK;` |
|    10326 |  169 | `}` |
|    20632 |  170 | `PH7_PRIVATE sxi32 SyLexTokenizeInput(SyLex *pLex,const char *zInput,sxu32 nLen,void *pCtxData,ProcSort xSort,ProcCmp xCmp)` |
|        5 |  171 | `{` |
...
|        - |  179 | `	}` |
|        - |  180 | `#endif` |
|    20637 |  181 | `	pStream = &pLex->sStream;` |
|        - |  182 | `	/* Point to the head of the input */` |
|    20637 |  183 | `	pStream->zText = pStream->zInput = (const unsigned char *)zInput;` |
|        - |  184 | `	/* Point to the end of the input */` |
|    20637 |  185 | `	pStream->zEnd = &pStream->zInput[nLen];` |
|  6055159 |  186 | `	for(;;){` |
| 12110323 |  187 | `		if( pStream->zText >= pStream->zEnd ){` |
|        - |  188 | `			/* End of the input reached */` |
|    20605 |  189 | `			break;` |
|        - |  190 | `		}` |
| 12089723 |  191 | `		zCur = pStream->zText;` |
|        - |  192 | `		/* Call the tokenizer callback */` |
| 12089723 |  193 | `		rc = pLex->xTokenizer(pStream,&sToken,pLex->pUserData,pCtxData);` |
| 12089723 |  194 | `		if( rc != SXRET_OK && rc != SXERR_CONTINUE ){` |
...
|      ! 0 |  199 | `			break;` |
|        - |  200 | `		}` |
| 12089691 |  201 | `		if( rc == SXERR_CONTINUE ){` |
|        - |  202 | `			/* Request to ignore this token */` |
|    97577 |  203 | `			pStream->nIgn++;` |
| 12040905 |  204 | `		}else if( pLex->pTokenSet  ){` |
|        - |  205 | `			/* Put the token in the set */` |
| 11992119 |  206 | `			rc = SySetPut(pLex->pTokenSet,(const void *)&sToken);` |
| 11992119 |  207 | `			if( rc != SXRET_OK ){` |
|      ! 0 |  208 | `				break;` |
|        - |  209 | `			}` |
|  5996057 |  210 | `		}` |
| 12089691 |  211 | `		if( zCur >= pStream->zText ){` |
|        - |  212 | `			/* Automatic advance of the stream cursor */` |
|      ! 0 |  213 | `			pStream->zText = &zCur[1];` |
|      ! 0 |  214 | `		}` |
|        5 |  215 | `	}` |
|    20605 |  216 | `	if( xSort &&  pLex->pTokenSet ){` |
...
|      ! 0 |  224 | `	}` |
|    20605 |  225 | `	return SXRET_OK;` |
|    10321 |  226 | `}` |
|    20642 |  227 | `PH7_PRIVATE sxi32 SyLexRelease(SyLex *pLex)` |
|        5 |  228 | `{` |
|    20647 |  229 | `	sxi32 rc = SXRET_OK;` |
|        - |  230 | `#if defined (UNTRUST)` |
|        - |  231 | `	if ( INVALID_LEXER(pLex) ){` |
|        - |  232 | `		return SXERR_CORRUPT;` |
|        - |  233 | `	}` |
|        - |  234 | `#else` |
|    10321 |  235 | `	SXUNUSED(pLex); /* Prevent compiler warning */` |
|        - |  236 | `#endif` |
|    20647 |  237 | `	return rc;` |
|        5 |  238 | `}` |
