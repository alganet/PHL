...
|         - |   15 | `#include "sxstr.h"` |
|         - |   16 |  |
|  82590424 |   17 | `PH7_PRIVATE sxu32 SyBinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   18 | `{` |
|  82590429 |   19 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   20 | `	unsigned char *zEnd;` |
|  82590429 |   21 | `	sxu32 nH = 5381;` |
|  82590429 |   22 | `	zEnd = &zIn[nLen];` |
| 142572105 |   23 | `	for(;;){` |
| 285103319 |   24 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 262510391 |   25 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 237569359 |   26 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 219187085 |   27 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|         5 |   28 | `	}` |
|  82590429 |   29 | `	return nH;` |
|         5 |   30 | `}` |
|  19412962 |   31 | `PH7_PRIVATE sxu32 SyStrHash(const void *pSrc,sxu32 nLen)` |
|         5 |   32 | `{` |
|  19412967 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   34 | `	unsigned char *zEnd;` |
|  19412967 |   35 | `	sxu32 nH = 5381;` |
|  19412967 |   36 | `	zEnd = &zIn[nLen];` |
|  30166028 |   37 | `	for(;;){` |
|  60332061 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + SyToLower(zIn[0]); zIn++;` |
|  55988383 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + SyToLower(zIn[0]); zIn++;` |
|  52537173 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + SyToLower(zIn[0]); zIn++;` |
|  47574127 |   41 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + SyToLower(zIn[0]); zIn++;` |
|         5 |   42 | `	}` |
|  19412967 |   43 | `	return nH;` |
|         5 |   44 | `}` |
...
|    105692 |  144 | `PH7_PRIVATE sxi32 SyLexInit(SyLex *pLex,SySet *pSet,ProcTokenizer xTokenizer,void *pUserData)` |
|         5 |  145 | `{` |
...
|         - |  150 | `	}` |
|         - |  151 | `#endif` |
|    105697 |  152 | `	pLex->pTokenSet = 0;` |
|         - |  153 | `	/* Initialize lexer fields */` |
|    105697 |  154 | `	if( pSet ){` |
|    105697 |  155 | `		if ( SySetElemSize(pSet) != sizeof(SyToken) ){` |
|       ! 0 |  156 | `			return SXERR_INVALID;` |
|         - |  157 | `		}` |
|    105697 |  158 | `		pLex->pTokenSet = pSet;` |
|     52846 |  159 | `	}` |
|    105697 |  160 | `	pStream = &pLex->sStream;` |
|    105697 |  161 | `	pLex->xTokenizer = xTokenizer;` |
|    105697 |  162 | `	pLex->pUserData = pUserData;` |
|         - |  163 |  |
|    105697 |  164 | `	pStream->nLine = 1;` |
|    105697 |  165 | `	pStream->nIgn  = 0;` |
|    105697 |  166 | `	pStream->zText = pStream->zEnd = 0;` |
|    105697 |  167 | `	pStream->pSet  = pSet;` |
|    105697 |  168 | `	return SXRET_OK;` |
|     52851 |  169 | `}` |
|    105692 |  170 | `PH7_PRIVATE sxi32 SyLexTokenizeInput(SyLex *pLex,const char *zInput,sxu32 nLen,void *pCtxData,ProcSort xSort,ProcCmp xCmp)` |
|         5 |  171 | `{` |
...
|         - |  179 | `	}` |
|         - |  180 | `#endif` |
|    105697 |  181 | `	pStream = &pLex->sStream;` |
|         - |  182 | `	/* Point to the head of the input */` |
|    105697 |  183 | `	pStream->zText = pStream->zInput = (const unsigned char *)zInput;` |
|         - |  184 | `	/* Point to the end of the input */` |
|    105697 |  185 | `	pStream->zEnd = &pStream->zInput[nLen];` |
|  93220646 |  186 | `	for(;;){` |
| 186441297 |  187 | `		if( pStream->zText >= pStream->zEnd ){` |
|         - |  188 | `			/* End of the input reached */` |
|    105677 |  189 | `			break;` |
|         - |  190 | `		}` |
| 186335625 |  191 | `		zCur = pStream->zText;` |
|         - |  192 | `		/* Call the tokenizer callback */` |
| 186335625 |  193 | `		rc = pLex->xTokenizer(pStream,&sToken,pLex->pUserData,pCtxData);` |
| 186335625 |  194 | `		if( rc != SXRET_OK && rc != SXERR_CONTINUE ){` |
...
|         3 |  199 | `			break;` |
|         - |  200 | `		}` |
| 186335605 |  201 | `		if( rc == SXERR_CONTINUE ){` |
|         - |  202 | `			/* Request to ignore this token */` |
|    233339 |  203 | `			pStream->nIgn++;` |
| 186218938 |  204 | `		}else if( pLex->pTokenSet  ){` |
|         - |  205 | `			/* Put the token in the set */` |
| 186102271 |  206 | `			rc = SySetPut(pLex->pTokenSet,(const void *)&sToken);` |
| 186102271 |  207 | `			if( rc != SXRET_OK ){` |
|       ! 0 |  208 | `				break;` |
|         - |  209 | `			}` |
|  93051133 |  210 | `		}` |
| 186335605 |  211 | `		if( zCur >= pStream->zText ){` |
|         - |  212 | `			/* Automatic advance of the stream cursor */` |
|       ! 0 |  213 | `			pStream->zText = &zCur[1];` |
|       ! 0 |  214 | `		}` |
|         5 |  215 | `	}` |
|    105679 |  216 | `	if( xSort &&  pLex->pTokenSet ){` |
...
|       ! 0 |  224 | `	}` |
|    105679 |  225 | `	return SXRET_OK;` |
|     52851 |  226 | `}` |
|    105692 |  227 | `PH7_PRIVATE sxi32 SyLexRelease(SyLex *pLex)` |
|         5 |  228 | `{` |
|    105697 |  229 | `	sxi32 rc = SXRET_OK;` |
|         - |  230 | `#if defined (UNTRUST)` |
|         - |  231 | `	if ( INVALID_LEXER(pLex) ){` |
|         - |  232 | `		return SXERR_CORRUPT;` |
|         - |  233 | `	}` |
|         - |  234 | `#else` |
|     52846 |  235 | `	SXUNUSED(pLex); /* Prevent compiler warning */` |
|         - |  236 | `#endif` |
|    105697 |  237 | `	return rc;` |
|         5 |  238 | `}` |
