...
|         - |   15 | `#include "sxstr.h"` |
|         - |   16 |  |
|  51683001 |   17 | `PH7_PRIVATE sxu32 SyBinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   18 | `{` |
|  51683006 |   19 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   20 | `	unsigned char *zEnd;` |
|  51683006 |   21 | `	sxu32 nH = 5381;` |
|  51683006 |   22 | `	zEnd = &zIn[nLen];` |
|  92379665 |   23 | `	for(;;){` |
| 184756609 |   24 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 170438442 |   25 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 156167744 |   26 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 144180008 |   27 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|         5 |   28 | `	}` |
|  51683006 |   29 | `	return nH;` |
|         5 |   30 | `}` |
|    940442 |   31 | `PH7_PRIVATE sxu32 SyStrHash(const void *pSrc,sxu32 nLen)` |
|         5 |   32 | `{` |
|    940447 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   34 | `	unsigned char *zEnd;` |
|    940447 |   35 | `	sxu32 nH = 5381;` |
|    940447 |   36 | `	zEnd = &zIn[nLen];` |
|   1846068 |   37 | `	for(;;){` |
|   3692141 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + SyToLower(zIn[0]); zIn++;` |
|   3537647 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + SyToLower(zIn[0]); zIn++;` |
|   3348845 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + SyToLower(zIn[0]); zIn++;` |
|   2945613 |   41 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + SyToLower(zIn[0]); zIn++;` |
|         5 |   42 | `	}` |
|    940447 |   43 | `	return nH;` |
|         5 |   44 | `}` |
...
|     67860 |  144 | `PH7_PRIVATE sxi32 SyLexInit(SyLex *pLex,SySet *pSet,ProcTokenizer xTokenizer,void *pUserData)` |
|         5 |  145 | `{` |
...
|         - |  150 | `	}` |
|         - |  151 | `#endif` |
|     67865 |  152 | `	pLex->pTokenSet = 0;` |
|         - |  153 | `	/* Initialize lexer fields */` |
|     67865 |  154 | `	if( pSet ){` |
|     67865 |  155 | `		if ( SySetElemSize(pSet) != sizeof(SyToken) ){` |
|       ! 0 |  156 | `			return SXERR_INVALID;` |
|         - |  157 | `		}` |
|     67865 |  158 | `		pLex->pTokenSet = pSet;` |
|     33930 |  159 | `	}` |
|     67865 |  160 | `	pStream = &pLex->sStream;` |
|     67865 |  161 | `	pLex->xTokenizer = xTokenizer;` |
|     67865 |  162 | `	pLex->pUserData = pUserData;` |
|         - |  163 |  |
|     67865 |  164 | `	pStream->nLine = 1;` |
|     67865 |  165 | `	pStream->nIgn  = 0;` |
|     67865 |  166 | `	pStream->zText = pStream->zEnd = 0;` |
|     67865 |  167 | `	pStream->pSet  = pSet;` |
|     67865 |  168 | `	return SXRET_OK;` |
|     33935 |  169 | `}` |
|     67850 |  170 | `PH7_PRIVATE sxi32 SyLexTokenizeInput(SyLex *pLex,const char *zInput,sxu32 nLen,void *pCtxData,ProcSort xSort,ProcCmp xCmp)` |
|         5 |  171 | `{` |
...
|         - |  179 | `	}` |
|         - |  180 | `#endif` |
|     67855 |  181 | `	pStream = &pLex->sStream;` |
|         - |  182 | `	/* Point to the head of the input */` |
|     67855 |  183 | `	pStream->zText = pStream->zInput = (const unsigned char *)zInput;` |
|         - |  184 | `	/* Point to the end of the input */` |
|     67855 |  185 | `	pStream->zEnd = &pStream->zInput[nLen];` |
|  39775193 |  186 | `	for(;;){` |
|  79550391 |  187 | `		if( pStream->zText >= pStream->zEnd ){` |
|         - |  188 | `			/* End of the input reached */` |
|     67821 |  189 | `			break;` |
|         - |  190 | `		}` |
|  79482575 |  191 | `		zCur = pStream->zText;` |
|         - |  192 | `		/* Call the tokenizer callback */` |
|  79482575 |  193 | `		rc = pLex->xTokenizer(pStream,&sToken,pLex->pUserData,pCtxData);` |
|  79482575 |  194 | `		if( rc != SXRET_OK && rc != SXERR_CONTINUE ){` |
...
|       ! 0 |  199 | `			break;` |
|         - |  200 | `		}` |
|  79482541 |  201 | `		if( rc == SXERR_CONTINUE ){` |
|         - |  202 | `			/* Request to ignore this token */` |
|    107879 |  203 | `			pStream->nIgn++;` |
|  79428604 |  204 | `		}else if( pLex->pTokenSet  ){` |
|         - |  205 | `			/* Put the token in the set */` |
|  79374667 |  206 | `			rc = SySetPut(pLex->pTokenSet,(const void *)&sToken);` |
|  79374667 |  207 | `			if( rc != SXRET_OK ){` |
|       ! 0 |  208 | `				break;` |
|         - |  209 | `			}` |
|  39687331 |  210 | `		}` |
|  79482541 |  211 | `		if( zCur >= pStream->zText ){` |
|         - |  212 | `			/* Automatic advance of the stream cursor */` |
|       ! 0 |  213 | `			pStream->zText = &zCur[1];` |
|       ! 0 |  214 | `		}` |
|         5 |  215 | `	}` |
|     67821 |  216 | `	if( xSort &&  pLex->pTokenSet ){` |
...
|       ! 0 |  224 | `	}` |
|     67821 |  225 | `	return SXRET_OK;` |
|     33930 |  226 | `}` |
|     67860 |  227 | `PH7_PRIVATE sxi32 SyLexRelease(SyLex *pLex)` |
|         5 |  228 | `{` |
|     67865 |  229 | `	sxi32 rc = SXRET_OK;` |
|         - |  230 | `#if defined (UNTRUST)` |
|         - |  231 | `	if ( INVALID_LEXER(pLex) ){` |
|         - |  232 | `		return SXERR_CORRUPT;` |
|         - |  233 | `	}` |
|         - |  234 | `#else` |
|     33930 |  235 | `	SXUNUSED(pLex); /* Prevent compiler warning */` |
|         - |  236 | `#endif` |
|     67865 |  237 | `	return rc;` |
|         5 |  238 | `}` |
