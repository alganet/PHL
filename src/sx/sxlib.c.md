...
|        - |   15 | `#include "sxstr.h"` |
|        - |   16 |  |
| 24043442 |   17 | `PH7_PRIVATE sxu32 SyBinHash(const void *pSrc,sxu32 nLen)` |
|        5 |   18 | `{` |
| 24043447 |   19 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|        - |   20 | `	unsigned char *zEnd;` |
| 24043447 |   21 | `	sxu32 nH = 5381;` |
| 24043447 |   22 | `	zEnd = &zIn[nLen];` |
| 42970020 |   23 | `	for(;;){` |
| 85937325 |   24 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 79357849 |   25 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 73724207 |   26 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 67480491 |   27 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|        5 |   28 | `	}` |
| 24043447 |   29 | `	return nH;` |
|        5 |   30 | `}` |
