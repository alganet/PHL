...
|         - |   15 | `#include "sxstr.h"` |
|         - |   16 |  |
|  82218155 |   17 | `PH7_PRIVATE sxu32 SyBinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   18 | `{` |
|  82218160 |   19 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   20 | `	unsigned char *zEnd;` |
|  82218160 |   21 | `	sxu32 nH = 5381;` |
|  82218160 |   22 | `	zEnd = &zIn[nLen];` |
| 139372753 |   23 | `	for(;;){` |
| 278744001 |   24 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 256503822 |   25 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 233306260 |   26 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 215005614 |   27 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|         5 |   28 | `	}` |
|  82218160 |   29 | `	return nH;` |
|         5 |   30 | `}` |
...
|     81808 |  144 | `PH7_PRIVATE sxi32 SyLexInit(SyLex *pLex,SySet *pSet,ProcTokenizer xTokenizer,void *pUserData)` |
|         5 |  145 | `{` |
...
|         - |  150 | `	}` |
|         - |  151 | `#endif` |
|     81813 |  152 | `	pLex->pTokenSet = 0;` |
|         - |  153 | `	/* Initialize lexer fields */` |
|     81813 |  154 | `	if( pSet ){` |
|     81813 |  155 | `		if ( SySetElemSize(pSet) != sizeof(SyToken) ){` |
|       ! 0 |  156 | `			return SXERR_INVALID;` |
|         - |  157 | `		}` |
|     81813 |  158 | `		pLex->pTokenSet = pSet;` |
|     40904 |  159 | `	}` |
|     81813 |  160 | `	pStream = &pLex->sStream;` |
|     81813 |  161 | `	pLex->xTokenizer = xTokenizer;` |
|     81813 |  162 | `	pLex->pUserData = pUserData;` |
|         - |  163 |  |
|     81813 |  164 | `	pStream->nLine = 1;` |
|     81813 |  165 | `	pStream->nIgn  = 0;` |
|     81813 |  166 | `	pStream->zText = pStream->zEnd = 0;` |
|     81813 |  167 | `	pStream->pSet  = pSet;` |
|     81813 |  168 | `	return SXRET_OK;` |
|     40909 |  169 | `}` |
|     81798 |  170 | `PH7_PRIVATE sxi32 SyLexTokenizeInput(SyLex *pLex,const char *zInput,sxu32 nLen,void *pCtxData,ProcSort xSort,ProcCmp xCmp)` |
|         5 |  171 | `{` |
...
|         - |  179 | `	}` |
|         - |  180 | `#endif` |
|     81803 |  181 | `	pStream = &pLex->sStream;` |
|         - |  182 | `	/* Point to the head of the input */` |
|     81803 |  183 | `	pStream->zText = pStream->zInput = (const unsigned char *)zInput;` |
|         - |  184 | `	/* Point to the end of the input */` |
|     81803 |  185 | `	pStream->zEnd = &pStream->zInput[nLen];` |
|  79203026 |  186 | `	for(;;){` |
| 158406057 |  187 | `		if( pStream->zText >= pStream->zEnd ){` |
|         - |  188 | `			/* End of the input reached */` |
|     81769 |  189 | `			break;` |
|         - |  190 | `		}` |
| 158324293 |  191 | `		zCur = pStream->zText;` |
|         - |  192 | `		/* Call the tokenizer callback */` |
| 158324293 |  193 | `		rc = pLex->xTokenizer(pStream,&sToken,pLex->pUserData,pCtxData);` |
| 158324293 |  194 | `		if( rc != SXRET_OK && rc != SXERR_CONTINUE ){` |
...
|       ! 0 |  199 | `			break;` |
|         - |  200 | `		}` |
| 158324259 |  201 | `		if( rc == SXERR_CONTINUE ){` |
|         - |  202 | `			/* Request to ignore this token */` |
|    205535 |  203 | `			pStream->nIgn++;` |
| 158221494 |  204 | `		}else if( pLex->pTokenSet  ){` |
|         - |  205 | `			/* Put the token in the set */` |
| 158118729 |  206 | `			rc = SySetPut(pLex->pTokenSet,(const void *)&sToken);` |
| 158118729 |  207 | `			if( rc != SXRET_OK ){` |
|       ! 0 |  208 | `				break;` |
|         - |  209 | `			}` |
|  79059362 |  210 | `		}` |
| 158324259 |  211 | `		if( zCur >= pStream->zText ){` |
|         - |  212 | `			/* Automatic advance of the stream cursor */` |
|       ! 0 |  213 | `			pStream->zText = &zCur[1];` |
|       ! 0 |  214 | `		}` |
|         5 |  215 | `	}` |
|     81769 |  216 | `	if( xSort &&  pLex->pTokenSet ){` |
...
|       ! 0 |  224 | `	}` |
|     81769 |  225 | `	return SXRET_OK;` |
|     40904 |  226 | `}` |
|     81808 |  227 | `PH7_PRIVATE sxi32 SyLexRelease(SyLex *pLex)` |
|         5 |  228 | `{` |
|     81813 |  229 | `	sxi32 rc = SXRET_OK;` |
|         - |  230 | `#if defined (UNTRUST)` |
|         - |  231 | `	if ( INVALID_LEXER(pLex) ){` |
|         - |  232 | `		return SXERR_CORRUPT;` |
|         - |  233 | `	}` |
|         - |  234 | `#else` |
|     40904 |  235 | `	SXUNUSED(pLex); /* Prevent compiler warning */` |
|         - |  236 | `#endif` |
|     81813 |  237 | `	return rc;` |
|         5 |  238 | `}` |
...
|         - |  408 | `};` |
|        58 |  409 | `static const char * GetDay(sxi32 i)` |
|         1 |  410 | `{` |
|        59 |  411 | `	return zEngDay[ i % 7 ];` |
|         1 |  412 | `}` |
|        12 |  413 | `static const char * GetMonth(sxi32 i)` |
|         1 |  414 | `{` |
|        13 |  415 | `	return zEngMonth[ i % 12 ];` |
|         1 |  416 | `}` |
|        58 |  417 | `PH7_PRIVATE const char * SyTimeGetDay(sxi32 iDay)` |
|         1 |  418 | `{` |
|        59 |  419 | `	return GetDay(iDay);` |
|         1 |  420 | `}` |
