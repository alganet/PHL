...
|        - |   15 | `#include "sxstr.h"` |
|        - |   16 |  |
| 23179590 |   17 | `PH7_PRIVATE sxu32 SyBinHash(const void *pSrc,sxu32 nLen)` |
|        5 |   18 | `{` |
| 23179595 |   19 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|        - |   20 | `	unsigned char *zEnd;` |
| 23179595 |   21 | `	sxu32 nH = 5381;` |
| 23179595 |   22 | `	zEnd = &zIn[nLen];` |
| 41446921 |   23 | `	for(;;){` |
| 82891063 |   24 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 76606523 |   25 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 71193629 |   26 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 65083187 |   27 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|        5 |   28 | `	}` |
| 23179595 |   29 | `	return nH;` |
|        5 |   30 | `}` |
|   525034 |   31 | `PH7_PRIVATE sxu32 SyStrHash(const void *pSrc,sxu32 nLen)` |
|        5 |   32 | `{` |
|   525039 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|        - |   34 | `	unsigned char *zEnd;` |
|   525039 |   35 | `	sxu32 nH = 5381;` |
|   525039 |   36 | `	zEnd = &zIn[nLen];` |
|   970254 |   37 | `	for(;;){` |
|  1940513 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + SyToLower(zIn[0]); zIn++;` |
|  1828117 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + SyToLower(zIn[0]); zIn++;` |
|  1698847 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + SyToLower(zIn[0]); zIn++;` |
|  1498077 |   41 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + SyToLower(zIn[0]); zIn++;` |
|        5 |   42 | `	}` |
|   525039 |   43 | `	return nH;` |
|        5 |   44 | `}` |
...
|    20540 |  144 | `PH7_PRIVATE sxi32 SyLexInit(SyLex *pLex,SySet *pSet,ProcTokenizer xTokenizer,void *pUserData)` |
|        5 |  145 | `{` |
...
|        - |  150 | `	}` |
|        - |  151 | `#endif` |
|    20545 |  152 | `	pLex->pTokenSet = 0;` |
|        - |  153 | `	/* Initialize lexer fields */` |
|    20545 |  154 | `	if( pSet ){` |
|    20545 |  155 | `		if ( SySetElemSize(pSet) != sizeof(SyToken) ){` |
|      ! 0 |  156 | `			return SXERR_INVALID;` |
|        - |  157 | `		}` |
|    20545 |  158 | `		pLex->pTokenSet = pSet;` |
|    10270 |  159 | `	}` |
|    20545 |  160 | `	pStream = &pLex->sStream;` |
|    20545 |  161 | `	pLex->xTokenizer = xTokenizer;` |
|    20545 |  162 | `	pLex->pUserData = pUserData;` |
|        - |  163 |  |
|    20545 |  164 | `	pStream->nLine = 1;` |
|    20545 |  165 | `	pStream->nIgn  = 0;` |
|    20545 |  166 | `	pStream->zText = pStream->zEnd = 0;` |
|    20545 |  167 | `	pStream->pSet  = pSet;` |
|    20545 |  168 | `	return SXRET_OK;` |
|    10275 |  169 | `}` |
|    20530 |  170 | `PH7_PRIVATE sxi32 SyLexTokenizeInput(SyLex *pLex,const char *zInput,sxu32 nLen,void *pCtxData,ProcSort xSort,ProcCmp xCmp)` |
|        5 |  171 | `{` |
...
|        - |  179 | `	}` |
|        - |  180 | `#endif` |
|    20535 |  181 | `	pStream = &pLex->sStream;` |
|        - |  182 | `	/* Point to the head of the input */` |
|    20535 |  183 | `	pStream->zText = pStream->zInput = (const unsigned char *)zInput;` |
|        - |  184 | `	/* Point to the end of the input */` |
|    20535 |  185 | `	pStream->zEnd = &pStream->zInput[nLen];` |
|  5837123 |  186 | `	for(;;){` |
| 11674251 |  187 | `		if( pStream->zText >= pStream->zEnd ){` |
|        - |  188 | `			/* End of the input reached */` |
|    20503 |  189 | `			break;` |
|        - |  190 | `		}` |
| 11653753 |  191 | `		zCur = pStream->zText;` |
|        - |  192 | `		/* Call the tokenizer callback */` |
| 11653753 |  193 | `		rc = pLex->xTokenizer(pStream,&sToken,pLex->pUserData,pCtxData);` |
| 11653753 |  194 | `		if( rc != SXRET_OK && rc != SXERR_CONTINUE ){` |
...
|      ! 0 |  199 | `			break;` |
|        - |  200 | `		}` |
| 11653721 |  201 | `		if( rc == SXERR_CONTINUE ){` |
|        - |  202 | `			/* Request to ignore this token */` |
|    93975 |  203 | `			pStream->nIgn++;` |
| 11606736 |  204 | `		}else if( pLex->pTokenSet  ){` |
|        - |  205 | `			/* Put the token in the set */` |
| 11559751 |  206 | `			rc = SySetPut(pLex->pTokenSet,(const void *)&sToken);` |
| 11559751 |  207 | `			if( rc != SXRET_OK ){` |
|      ! 0 |  208 | `				break;` |
|        - |  209 | `			}` |
|  5779873 |  210 | `		}` |
| 11653721 |  211 | `		if( zCur >= pStream->zText ){` |
|        - |  212 | `			/* Automatic advance of the stream cursor */` |
|      ! 0 |  213 | `			pStream->zText = &zCur[1];` |
|      ! 0 |  214 | `		}` |
|        5 |  215 | `	}` |
|    20503 |  216 | `	if( xSort &&  pLex->pTokenSet ){` |
...
|      ! 0 |  224 | `	}` |
|    20503 |  225 | `	return SXRET_OK;` |
|    10270 |  226 | `}` |
|    20540 |  227 | `PH7_PRIVATE sxi32 SyLexRelease(SyLex *pLex)` |
|        5 |  228 | `{` |
|    20545 |  229 | `	sxi32 rc = SXRET_OK;` |
|        - |  230 | `#if defined (UNTRUST)` |
|        - |  231 | `	if ( INVALID_LEXER(pLex) ){` |
|        - |  232 | `		return SXERR_CORRUPT;` |
|        - |  233 | `	}` |
|        - |  234 | `#else` |
|    10270 |  235 | `	SXUNUSED(pLex); /* Prevent compiler warning */` |
|        - |  236 | `#endif` |
|    20545 |  237 | `	return rc;` |
|        5 |  238 | `}` |
