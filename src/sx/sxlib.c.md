...
|         - |   15 | `#include "sxstr.h"` |
|         - |   16 |  |
|  82875558 |   17 | `PH7_PRIVATE sxu32 SyBinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   18 | `{` |
|  82875563 |   19 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   20 | `	unsigned char *zEnd;` |
|  82875563 |   21 | `	sxu32 nH = 5381;` |
|  82875563 |   22 | `	zEnd = &zIn[nLen];` |
| 143096206 |   23 | `	for(;;){` |
| 286151309 |   24 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 263475652 |   25 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 238445329 |   26 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 220011205 |   27 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|         5 |   28 | `	}` |
|  82875563 |   29 | `	return nH;` |
|         5 |   30 | `}` |
...
|  93603749 |  186 | `	for(;;){` |
| 187207503 |  187 | `		if( pStream->zText >= pStream->zEnd ){` |
|         - |  188 | `			/* End of the input reached */` |
|    106075 |  189 | `			break;` |
|         - |  190 | `		}` |
| 187101433 |  191 | `		zCur = pStream->zText;` |
|         - |  192 | `		/* Call the tokenizer callback */` |
| 187101433 |  193 | `		rc = pLex->xTokenizer(pStream,&sToken,pLex->pUserData,pCtxData);` |
| 187101433 |  194 | `		if( rc != SXRET_OK && rc != SXERR_CONTINUE ){` |
...
|         3 |  199 | `			break;` |
|         - |  200 | `		}` |
| 187101413 |  201 | `		if( rc == SXERR_CONTINUE ){` |
|         - |  202 | `			/* Request to ignore this token */` |
|    234245 |  203 | `			pStream->nIgn++;` |
| 186984293 |  204 | `		}else if( pLex->pTokenSet  ){` |
|         - |  205 | `			/* Put the token in the set */` |
| 186867173 |  206 | `			rc = SySetPut(pLex->pTokenSet,(const void *)&sToken);` |
| 186867173 |  207 | `			if( rc != SXRET_OK ){` |
|       ! 0 |  208 | `				break;` |
|         - |  209 | `			}` |
|  93433584 |  210 | `		}` |
| 187101413 |  211 | `		if( zCur >= pStream->zText ){` |
