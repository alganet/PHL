...
|         - |   15 | `#include "sxstr.h"` |
|         - |   16 |  |
|  95703320 |   17 | `PH7_PRIVATE sxu32 SyBinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   18 | `{` |
|  95703325 |   19 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   20 | `	unsigned char *zEnd;` |
|  95703325 |   21 | `	sxu32 nH = 5381;` |
|  95703325 |   22 | `	zEnd = &zIn[nLen];` |
| 162623436 |   23 | `	for(;;){` |
| 325206521 |   24 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 299829298 |   25 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 272828961 |   26 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 251073661 |   27 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|         5 |   28 | `	}` |
|  95703325 |   29 | `	return nH;` |
|         5 |   30 | `}` |
...
|    105538 |  144 | `PH7_PRIVATE sxi32 SyLexInit(SyLex *pLex,SySet *pSet,ProcTokenizer xTokenizer,void *pUserData)` |
|         5 |  145 | `{` |
...
|         - |  150 | `	}` |
|         - |  151 | `#endif` |
|    105543 |  152 | `	pLex->pTokenSet = 0;` |
|         - |  153 | `	/* Initialize lexer fields */` |
|    105543 |  154 | `	if( pSet ){` |
|    105543 |  155 | `		if ( SySetElemSize(pSet) != sizeof(SyToken) ){` |
|       ! 0 |  156 | `			return SXERR_INVALID;` |
|         - |  157 | `		}` |
|    105543 |  158 | `		pLex->pTokenSet = pSet;` |
|     52769 |  159 | `	}` |
|    105543 |  160 | `	pStream = &pLex->sStream;` |
|    105543 |  161 | `	pLex->xTokenizer = xTokenizer;` |
|    105543 |  162 | `	pLex->pUserData = pUserData;` |
|         - |  163 |  |
|    105543 |  164 | `	pStream->nLine = 1;` |
|    105543 |  165 | `	pStream->nIgn  = 0;` |
|    105543 |  166 | `	pStream->zText = pStream->zEnd = 0;` |
|    105543 |  167 | `	pStream->pSet  = pSet;` |
|    105543 |  168 | `	return SXRET_OK;` |
|     52774 |  169 | `}` |
|    105538 |  170 | `PH7_PRIVATE sxi32 SyLexTokenizeInput(SyLex *pLex,const char *zInput,sxu32 nLen,void *pCtxData,ProcSort xSort,ProcCmp xCmp)` |
|         5 |  171 | `{` |
...
|         - |  179 | `	}` |
|         - |  180 | `#endif` |
|    105543 |  181 | `	pStream = &pLex->sStream;` |
|         - |  182 | `	/* Point to the head of the input */` |
|    105543 |  183 | `	pStream->zText = pStream->zInput = (const unsigned char *)zInput;` |
|         - |  184 | `	/* Point to the end of the input */` |
|    105543 |  185 | `	pStream->zEnd = &pStream->zInput[nLen];` |
|  93027296 |  186 | `	for(;;){` |
| 186054597 |  187 | `		if( pStream->zText >= pStream->zEnd ){` |
|         - |  188 | `			/* End of the input reached */` |
|    105523 |  189 | `			break;` |
|         - |  190 | `		}` |
| 185949079 |  191 | `		zCur = pStream->zText;` |
|         - |  192 | `		/* Call the tokenizer callback */` |
| 185949079 |  193 | `		rc = pLex->xTokenizer(pStream,&sToken,pLex->pUserData,pCtxData);` |
| 185949079 |  194 | `		if( rc != SXRET_OK && rc != SXERR_CONTINUE ){` |
...
|         3 |  199 | `			break;` |
|         - |  200 | `		}` |
| 185949059 |  201 | `		if( rc == SXERR_CONTINUE ){` |
|         - |  202 | `			/* Request to ignore this token */` |
|    232443 |  203 | `			pStream->nIgn++;` |
| 185832840 |  204 | `		}else if( pLex->pTokenSet  ){` |
|         - |  205 | `			/* Put the token in the set */` |
| 185716621 |  206 | `			rc = SySetPut(pLex->pTokenSet,(const void *)&sToken);` |
| 185716621 |  207 | `			if( rc != SXRET_OK ){` |
|       ! 0 |  208 | `				break;` |
|         - |  209 | `			}` |
|  92858308 |  210 | `		}` |
| 185949059 |  211 | `		if( zCur >= pStream->zText ){` |
|         - |  212 | `			/* Automatic advance of the stream cursor */` |
|       ! 0 |  213 | `			pStream->zText = &zCur[1];` |
|       ! 0 |  214 | `		}` |
|         5 |  215 | `	}` |
|    105525 |  216 | `	if( xSort &&  pLex->pTokenSet ){` |
...
|       ! 0 |  224 | `	}` |
|    105525 |  225 | `	return SXRET_OK;` |
|     52774 |  226 | `}` |
|    105538 |  227 | `PH7_PRIVATE sxi32 SyLexRelease(SyLex *pLex)` |
|         5 |  228 | `{` |
|    105543 |  229 | `	sxi32 rc = SXRET_OK;` |
|         - |  230 | `#if defined (UNTRUST)` |
|         - |  231 | `	if ( INVALID_LEXER(pLex) ){` |
|         - |  232 | `		return SXERR_CORRUPT;` |
|         - |  233 | `	}` |
|         - |  234 | `#else` |
|     52769 |  235 | `	SXUNUSED(pLex); /* Prevent compiler warning */` |
|         - |  236 | `#endif` |
|    105543 |  237 | `	return rc;` |
|         5 |  238 | `}` |
