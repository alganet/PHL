...
|        - |   15 | `#include "sxstr.h"` |
|        - |   16 |  |
| 20916636 |   17 | `PH7_PRIVATE sxu32 SyBinHash(const void *pSrc,sxu32 nLen)` |
|        5 |   18 |  |
| 20916641 |   19 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|        - |   20 | `	unsigned char *zEnd;` |
| 20916641 |   21 | `	sxu32 nH = 5381;` |
| 20916641 |   22 | `	zEnd = &zIn[nLen];` |
| 37087401 |   23 | `	for(;;){` |
| 74172087 |   24 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 68572595 |   25 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 63629865 |   26 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 58045803 |   27 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|        5 |   28 | `	}` |
| 20916641 |   29 | `	return nH;` |
|        5 |   30 |  |
|   445982 |   31 | `PH7_PRIVATE sxu32 SyStrHash(const void *pSrc,sxu32 nLen)` |
|        5 |   32 |  |
|   445987 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|        - |   34 | `	unsigned char *zEnd;` |
|   445987 |   35 | `	sxu32 nH = 5381;` |
|   445987 |   36 | `	zEnd = &zIn[nLen];` |
|   827987 |   37 | `	for(;;){` |
|  1655979 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + SyToLower(zIn[0]); zIn++;` |
|  1558847 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + SyToLower(zIn[0]); zIn++;` |
|  1447111 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + SyToLower(zIn[0]); zIn++;` |
|  1273901 |   41 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + SyToLower(zIn[0]); zIn++;` |
|        5 |   42 | `	}` |
|   445987 |   43 | `	return nH;` |
|        5 |   44 |  |
...
|    16012 |  144 | `PH7_PRIVATE sxi32 SyLexInit(SyLex *pLex,SySet *pSet,ProcTokenizer xTokenizer,void *pUserData)` |
|        5 |  145 |  |
...
|        - |  150 | `	}` |
|        - |  151 | `#endif` |
|    16017 |  152 | `	pLex->pTokenSet = 0;` |
|        - |  153 | `	/* Initialize lexer fields */` |
|    16017 |  154 | `	if( pSet ){` |
|    16017 |  155 | `		if ( SySetElemSize(pSet) != sizeof(SyToken) ){` |
|      ! 0 |  156 | `			return SXERR_INVALID;` |
|        - |  157 | `		}` |
|    16017 |  158 | `		pLex->pTokenSet = pSet;` |
|     8006 |  159 | `	}` |
|    16017 |  160 | `	pStream = &pLex->sStream;` |
|    16017 |  161 | `	pLex->xTokenizer = xTokenizer;` |
|    16017 |  162 | `	pLex->pUserData = pUserData;` |
|        - |  163 |  |
|    16017 |  164 | `	pStream->nLine = 1;` |
|    16017 |  165 | `	pStream->nIgn  = 0;` |
|    16017 |  166 | `	pStream->zText = pStream->zEnd = 0;` |
|    16017 |  167 | `	pStream->pSet  = pSet;` |
|    16017 |  168 | `	return SXRET_OK;` |
|     8011 |  169 |  |
|    16002 |  170 | `PH7_PRIVATE sxi32 SyLexTokenizeInput(SyLex *pLex,const char *zInput,sxu32 nLen,void *pCtxData,ProcSort xSort,ProcCmp xCmp)` |
|        5 |  171 |  |
...
|        - |  179 | `	}` |
|        - |  180 | `#endif` |
|    16007 |  181 | `	pStream = &pLex->sStream;` |
|        - |  182 | `	/* Point to the head of the input */` |
|    16007 |  183 | `	pStream->zText = pStream->zInput = (const unsigned char *)zInput;` |
|        - |  184 | `	/* Point to the end of the input */` |
|    16007 |  185 | `	pStream->zEnd = &pStream->zInput[nLen];` |
|  5108277 |  186 | `	for(;;){` |
| 10216559 |  187 | `		if( pStream->zText >= pStream->zEnd ){` |
|        - |  188 | `			/* End of the input reached */` |
|    15975 |  189 | `			break;` |
|        - |  190 | `		}` |
| 10200589 |  191 | `		zCur = pStream->zText;` |
|        - |  192 | `		/* Call the tokenizer callback */` |
| 10200589 |  193 | `		rc = pLex->xTokenizer(pStream,&sToken,pLex->pUserData,pCtxData);` |
| 10200589 |  194 | `		if( rc != SXRET_OK && rc != SXERR_CONTINUE ){` |
...
|      ! 0 |  199 | `			break;` |
|        - |  200 | `		}` |
| 10200557 |  201 | `		if( rc == SXERR_CONTINUE ){` |
|        - |  202 | `			/* Request to ignore this token */` |
|    87263 |  203 | `			pStream->nIgn++;` |
| 10156928 |  204 | `		}else if( pLex->pTokenSet  ){` |
|        - |  205 | `			/* Put the token in the set */` |
| 10113299 |  206 | `			rc = SySetPut(pLex->pTokenSet,(const void *)&sToken);` |
| 10113299 |  207 | `			if( rc != SXRET_OK ){` |
|      ! 0 |  208 | `				break;` |
|        - |  209 | `			}` |
|  5056647 |  210 | `		}` |
| 10200557 |  211 | `		if( zCur >= pStream->zText ){` |
|        - |  212 | `			/* Automatic advance of the stream cursor */` |
|      ! 0 |  213 | `			pStream->zText = &zCur[1];` |
|      ! 0 |  214 | `		}` |
|        5 |  215 | `	}` |
|    15975 |  216 | `	if( xSort &&  pLex->pTokenSet ){` |
...
|      ! 0 |  224 | `	}` |
|    15975 |  225 | `	return SXRET_OK;` |
|     8006 |  226 |  |
|    16012 |  227 | `PH7_PRIVATE sxi32 SyLexRelease(SyLex *pLex)` |
|        5 |  228 |  |
|    16017 |  229 | `	sxi32 rc = SXRET_OK;` |
|        - |  230 | `#if defined (UNTRUST)` |
|        - |  231 | `	if ( INVALID_LEXER(pLex) ){` |
|        - |  232 | `		return SXERR_CORRUPT;` |
|        - |  233 | `	}` |
|        - |  234 | `#else` |
|     8006 |  235 | `	SXUNUSED(pLex); /* Prevent compiler warning */` |
|        - |  236 | `#endif` |
|    16017 |  237 | `	return rc;` |
|        5 |  238 |  |
