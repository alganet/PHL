...
|        - |   15 | `#include "sxstr.h"` |
|        - |   16 |  |
| 17580908 |   17 | `PH7_PRIVATE sxu32 SyBinHash(const void *pSrc,sxu32 nLen)` |
|        2 |   18 |  |
| 17580910 |   19 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|        - |   20 | `	unsigned char *zEnd;` |
| 17580910 |   21 | `	sxu32 nH = 5381;` |
| 17580910 |   22 | `	zEnd = &zIn[nLen];` |
| 29466653 |   23 | `	for(;;){` |
| 58931900 |   24 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 54562278 |   25 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 50145894 |   26 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 45185732 |   27 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|        2 |   28 | `	}` |
| 17580910 |   29 | `	return nH;` |
|        2 |   30 |  |
...
|    15388 |  144 | `PH7_PRIVATE sxi32 SyLexInit(SyLex *pLex,SySet *pSet,ProcTokenizer xTokenizer,void *pUserData)` |
|        2 |  145 |  |
...
|        - |  150 | `	}` |
|        - |  151 | `#endif` |
|    15390 |  152 | `	pLex->pTokenSet = 0;` |
|        - |  153 | `	/* Initialize lexer fields */` |
|    15390 |  154 | `	if( pSet ){` |
|    15390 |  155 | `		if ( SySetElemSize(pSet) != sizeof(SyToken) ){` |
|      ! 0 |  156 | `			return SXERR_INVALID;` |
|        - |  157 | `		}` |
|    15390 |  158 | `		pLex->pTokenSet = pSet;` |
|     7694 |  159 | `	}` |
|    15390 |  160 | `	pStream = &pLex->sStream;` |
|    15390 |  161 | `	pLex->xTokenizer = xTokenizer;` |
|    15390 |  162 | `	pLex->pUserData = pUserData;` |
|        - |  163 |  |
|    15390 |  164 | `	pStream->nLine = 1;` |
|    15390 |  165 | `	pStream->nIgn  = 0;` |
|    15390 |  166 | `	pStream->zText = pStream->zEnd = 0;` |
|    15390 |  167 | `	pStream->pSet  = pSet;` |
|    15390 |  168 | `	return SXRET_OK;` |
|     7696 |  169 |  |
|    15378 |  170 | `PH7_PRIVATE sxi32 SyLexTokenizeInput(SyLex *pLex,const char *zInput,sxu32 nLen,void *pCtxData,ProcSort xSort,ProcCmp xCmp)` |
|        2 |  171 |  |
...
|        - |  179 | `	}` |
|        - |  180 | `#endif` |
|    15380 |  181 | `	pStream = &pLex->sStream;` |
|        - |  182 | `	/* Point to the head of the input */` |
|    15380 |  183 | `	pStream->zText = pStream->zInput = (const unsigned char *)zInput;` |
|        - |  184 | `	/* Point to the end of the input */` |
|    15380 |  185 | `	pStream->zEnd = &pStream->zInput[nLen];` |
|  4716343 |  186 | `	for(;;){` |
|  9432688 |  187 | `		if( pStream->zText >= pStream->zEnd ){` |
|        - |  188 | `			/* End of the input reached */` |
|    15348 |  189 | `			break;` |
|        - |  190 | `		}` |
|  9417342 |  191 | `		zCur = pStream->zText;` |
|        - |  192 | `		/* Call the tokenizer callback */` |
|  9417342 |  193 | `		rc = pLex->xTokenizer(pStream,&sToken,pLex->pUserData,pCtxData);` |
|  9417342 |  194 | `		if( rc != SXRET_OK && rc != SXERR_CONTINUE ){` |
...
|      ! 0 |  199 | `			break;` |
|        - |  200 | `		}` |
|  9417310 |  201 | `		if( rc == SXERR_CONTINUE ){` |
|        - |  202 | `			/* Request to ignore this token */` |
|    79618 |  203 | `			pStream->nIgn++;` |
|  9377502 |  204 | `		}else if( pLex->pTokenSet  ){` |
|        - |  205 | `			/* Put the token in the set */` |
|  9337694 |  206 | `			rc = SySetPut(pLex->pTokenSet,(const void *)&sToken);` |
|  9337694 |  207 | `			if( rc != SXRET_OK ){` |
|      ! 0 |  208 | `				break;` |
|        - |  209 | `			}` |
|  4668846 |  210 | `		}` |
|  9417310 |  211 | `		if( zCur >= pStream->zText ){` |
|        - |  212 | `			/* Automatic advance of the stream cursor */` |
|      ! 0 |  213 | `			pStream->zText = &zCur[1];` |
|      ! 0 |  214 | `		}` |
|        2 |  215 | `	}` |
|    15348 |  216 | `	if( xSort &&  pLex->pTokenSet ){` |
...
|      ! 0 |  224 | `	}` |
|    15348 |  225 | `	return SXRET_OK;` |
|     7691 |  226 |  |
|    15388 |  227 | `PH7_PRIVATE sxi32 SyLexRelease(SyLex *pLex)` |
|        2 |  228 |  |
|    15390 |  229 | `	sxi32 rc = SXRET_OK;` |
|        - |  230 | `#if defined (UNTRUST)` |
|        - |  231 | `	if ( INVALID_LEXER(pLex) ){` |
|        - |  232 | `		return SXERR_CORRUPT;` |
|        - |  233 | `	}` |
|        - |  234 | `#else` |
|     7694 |  235 | `	SXUNUSED(pLex); /* Prevent compiler warning */` |
|        - |  236 | `#endif` |
|    15390 |  237 | `	return rc;` |
|        2 |  238 |  |
