...
|        - |   15 | `#include "sxstr.h"` |
|        - |   16 |  |
|  8913294 |   17 | `PH7_PRIVATE sxu32 SyBinHash(const void *pSrc,sxu32 nLen)` |
|        2 |   18 |  |
|  8913296 |   19 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|        - |   20 | `	unsigned char *zEnd;` |
|  8913296 |   21 | `	sxu32 nH = 5381;` |
|  8913296 |   22 | `	zEnd = &zIn[nLen];` |
| 14178260 |   23 | `	for(;;){` |
| 28355114 |   24 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 26370664 |   25 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 24020226 |   26 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 21318372 |   27 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|        2 |   28 | `	}` |
|  8913296 |   29 | `	return nH;` |
|        2 |   30 |  |
|    41384 |   31 | `PH7_PRIVATE sxu32 SyStrHash(const void *pSrc,sxu32 nLen)` |
|        2 |   32 |  |
|    41386 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|        - |   34 | `	unsigned char *zEnd;` |
|    41386 |   35 | `	sxu32 nH = 5381;` |
|    41386 |   36 | `	zEnd = &zIn[nLen];` |
|    68444 |   37 | `	for(;;){` |
|   136890 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + SyToLower(zIn[0]); zIn++;` |
|   127172 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + SyToLower(zIn[0]); zIn++;` |
|   105110 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + SyToLower(zIn[0]); zIn++;` |
|    95666 |   41 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + SyToLower(zIn[0]); zIn++;` |
|        2 |   42 | `	}` |
|    41386 |   43 | `	return nH;` |
|        2 |   44 |  |
...
|     9968 |  144 | `PH7_PRIVATE sxi32 SyLexInit(SyLex *pLex,SySet *pSet,ProcTokenizer xTokenizer,void *pUserData)` |
|        2 |  145 |  |
...
|        - |  150 | `	}` |
|        - |  151 | `#endif` |
|     9970 |  152 | `	pLex->pTokenSet = 0;` |
|        - |  153 | `	/* Initialize lexer fields */` |
|     9970 |  154 | `	if( pSet ){` |
|     9970 |  155 | `		if ( SySetElemSize(pSet) != sizeof(SyToken) ){` |
|      ! 0 |  156 | `			return SXERR_INVALID;` |
|        - |  157 | `		}` |
|     9970 |  158 | `		pLex->pTokenSet = pSet;` |
|     4984 |  159 | `	}` |
|     9970 |  160 | `	pStream = &pLex->sStream;` |
|     9970 |  161 | `	pLex->xTokenizer = xTokenizer;` |
|     9970 |  162 | `	pLex->pUserData = pUserData;` |
|        - |  163 |  |
|     9970 |  164 | `	pStream->nLine = 1;` |
|     9970 |  165 | `	pStream->nIgn  = 0;` |
|     9970 |  166 | `	pStream->zText = pStream->zEnd = 0;` |
|     9970 |  167 | `	pStream->pSet  = pSet;` |
|     9970 |  168 | `	return SXRET_OK;` |
|     4986 |  169 |  |
|     9958 |  170 | `PH7_PRIVATE sxi32 SyLexTokenizeInput(SyLex *pLex,const char *zInput,sxu32 nLen,void *pCtxData,ProcSort xSort,ProcCmp xCmp)` |
|        2 |  171 |  |
...
|        - |  179 | `	}` |
|        - |  180 | `#endif` |
|     9960 |  181 | `	pStream = &pLex->sStream;` |
|        - |  182 | `	/* Point to the head of the input */` |
|     9960 |  183 | `	pStream->zText = pStream->zInput = (const unsigned char *)zInput;` |
|        - |  184 | `	/* Point to the end of the input */` |
|     9960 |  185 | `	pStream->zEnd = &pStream->zInput[nLen];` |
|  1646571 |  186 | `	for(;;){` |
|  3293144 |  187 | `		if( pStream->zText >= pStream->zEnd ){` |
|        - |  188 | `			/* End of the input reached */` |
|     9934 |  189 | `			break;` |
|        - |  190 | `		}` |
|  3283212 |  191 | `		zCur = pStream->zText;` |
|        - |  192 | `		/* Call the tokenizer callback */` |
|  3283212 |  193 | `		rc = pLex->xTokenizer(pStream,&sToken,pLex->pUserData,pCtxData);` |
|  3283212 |  194 | `		if( rc != SXRET_OK && rc != SXERR_CONTINUE ){` |
...
|      ! 0 |  199 | `			break;` |
|        - |  200 | `		}` |
|  3283186 |  201 | `		if( rc == SXERR_CONTINUE ){` |
|        - |  202 | `			/* Request to ignore this token */` |
|    42272 |  203 | `			pStream->nIgn++;` |
|  3262051 |  204 | `		}else if( pLex->pTokenSet  ){` |
|        - |  205 | `			/* Put the token in the set */` |
|  3240916 |  206 | `			rc = SySetPut(pLex->pTokenSet,(const void *)&sToken);` |
|  3240916 |  207 | `			if( rc != SXRET_OK ){` |
|      ! 0 |  208 | `				break;` |
|        - |  209 | `			}` |
|  1620457 |  210 | `		}` |
|  3283186 |  211 | `		if( zCur >= pStream->zText ){` |
|        - |  212 | `			/* Automatic advance of the stream cursor */` |
|      ! 0 |  213 | `			pStream->zText = &zCur[1];` |
|      ! 0 |  214 | `		}` |
|        2 |  215 | `	}` |
|     9934 |  216 | `	if( xSort &&  pLex->pTokenSet ){` |
...
|      ! 0 |  224 | `	}` |
|     9934 |  225 | `	return SXRET_OK;` |
|     4981 |  226 |  |
|     9968 |  227 | `PH7_PRIVATE sxi32 SyLexRelease(SyLex *pLex)` |
|        2 |  228 |  |
|     9970 |  229 | `	sxi32 rc = SXRET_OK;` |
|        - |  230 | `#if defined (UNTRUST)` |
|        - |  231 | `	if ( INVALID_LEXER(pLex) ){` |
|        - |  232 | `		return SXERR_CORRUPT;` |
|        - |  233 | `	}` |
|        - |  234 | `#else` |
|     4984 |  235 | `	SXUNUSED(pLex); /* Prevent compiler warning */` |
|        - |  236 | `#endif` |
|     9970 |  237 | `	return rc;` |
|        2 |  238 |  |
