...
|        - |   15 | `#include "sxstr.h"` |
|        - |   16 |  |
| 14624414 |   17 | `PH7_PRIVATE sxu32 SyBinHash(const void *pSrc,sxu32 nLen)` |
|        2 |   18 |  |
| 14624416 |   19 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|        - |   20 | `	unsigned char *zEnd;` |
| 14624416 |   21 | `	sxu32 nH = 5381;` |
| 14624416 |   22 | `	zEnd = &zIn[nLen];` |
| 24492815 |   23 | `	for(;;){` |
| 48984224 |   24 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 45417694 |   25 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 41718872 |   26 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 37563834 |   27 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|        2 |   28 | `	}` |
| 14624416 |   29 | `	return nH;` |
|        2 |   30 |  |
...
|    13202 |  144 | `PH7_PRIVATE sxi32 SyLexInit(SyLex *pLex,SySet *pSet,ProcTokenizer xTokenizer,void *pUserData)` |
|        2 |  145 |  |
...
|        - |  150 | `	}` |
|        - |  151 | `#endif` |
|    13204 |  152 | `	pLex->pTokenSet = 0;` |
|        - |  153 | `	/* Initialize lexer fields */` |
|    13204 |  154 | `	if( pSet ){` |
|    13204 |  155 | `		if ( SySetElemSize(pSet) != sizeof(SyToken) ){` |
|      ! 0 |  156 | `			return SXERR_INVALID;` |
|        - |  157 | `		}` |
|    13204 |  158 | `		pLex->pTokenSet = pSet;` |
|     6601 |  159 | `	}` |
|    13204 |  160 | `	pStream = &pLex->sStream;` |
|    13204 |  161 | `	pLex->xTokenizer = xTokenizer;` |
|    13204 |  162 | `	pLex->pUserData = pUserData;` |
|        - |  163 |  |
|    13204 |  164 | `	pStream->nLine = 1;` |
|    13204 |  165 | `	pStream->nIgn  = 0;` |
|    13204 |  166 | `	pStream->zText = pStream->zEnd = 0;` |
|    13204 |  167 | `	pStream->pSet  = pSet;` |
|    13204 |  168 | `	return SXRET_OK;` |
|     6603 |  169 |  |
|    13192 |  170 | `PH7_PRIVATE sxi32 SyLexTokenizeInput(SyLex *pLex,const char *zInput,sxu32 nLen,void *pCtxData,ProcSort xSort,ProcCmp xCmp)` |
|        2 |  171 |  |
...
|        - |  179 | `	}` |
|        - |  180 | `#endif` |
|    13194 |  181 | `	pStream = &pLex->sStream;` |
|        - |  182 | `	/* Point to the head of the input */` |
|    13194 |  183 | `	pStream->zText = pStream->zInput = (const unsigned char *)zInput;` |
|        - |  184 | `	/* Point to the end of the input */` |
|    13194 |  185 | `	pStream->zEnd = &pStream->zInput[nLen];` |
|  3682674 |  186 | `	for(;;){` |
|  7365350 |  187 | `		if( pStream->zText >= pStream->zEnd ){` |
|        - |  188 | `			/* End of the input reached */` |
|    13168 |  189 | `			break;` |
|        - |  190 | `		}` |
|  7352184 |  191 | `		zCur = pStream->zText;` |
|        - |  192 | `		/* Call the tokenizer callback */` |
|  7352184 |  193 | `		rc = pLex->xTokenizer(pStream,&sToken,pLex->pUserData,pCtxData);` |
|  7352184 |  194 | `		if( rc != SXRET_OK && rc != SXERR_CONTINUE ){` |
...
|      ! 0 |  199 | `			break;` |
|        - |  200 | `		}` |
|  7352158 |  201 | `		if( rc == SXERR_CONTINUE ){` |
|        - |  202 | `			/* Request to ignore this token */` |
|    72502 |  203 | `			pStream->nIgn++;` |
|  7315908 |  204 | `		}else if( pLex->pTokenSet  ){` |
|        - |  205 | `			/* Put the token in the set */` |
|  7279658 |  206 | `			rc = SySetPut(pLex->pTokenSet,(const void *)&sToken);` |
|  7279658 |  207 | `			if( rc != SXRET_OK ){` |
|      ! 0 |  208 | `				break;` |
|        - |  209 | `			}` |
|  3639828 |  210 | `		}` |
|  7352158 |  211 | `		if( zCur >= pStream->zText ){` |
|        - |  212 | `			/* Automatic advance of the stream cursor */` |
|      ! 0 |  213 | `			pStream->zText = &zCur[1];` |
|      ! 0 |  214 | `		}` |
|        2 |  215 | `	}` |
|    13168 |  216 | `	if( xSort &&  pLex->pTokenSet ){` |
...
|      ! 0 |  224 | `	}` |
|    13168 |  225 | `	return SXRET_OK;` |
|     6598 |  226 |  |
|    13202 |  227 | `PH7_PRIVATE sxi32 SyLexRelease(SyLex *pLex)` |
|        2 |  228 |  |
|    13204 |  229 | `	sxi32 rc = SXRET_OK;` |
|        - |  230 | `#if defined (UNTRUST)` |
|        - |  231 | `	if ( INVALID_LEXER(pLex) ){` |
|        - |  232 | `		return SXERR_CORRUPT;` |
|        - |  233 | `	}` |
|        - |  234 | `#else` |
|     6601 |  235 | `	SXUNUSED(pLex); /* Prevent compiler warning */` |
|        - |  236 | `#endif` |
|    13204 |  237 | `	return rc;` |
|        2 |  238 |  |
