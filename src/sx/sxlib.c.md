...
|        - |   15 | `#include "sxstr.h"` |
|        - |   16 |  |
| 23776162 |   17 | `PH7_PRIVATE sxu32 SyBinHash(const void *pSrc,sxu32 nLen)` |
|        5 |   18 | `{` |
| 23776167 |   19 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|        - |   20 | `	unsigned char *zEnd;` |
| 23776167 |   21 | `	sxu32 nH = 5381;` |
| 23776167 |   22 | `	zEnd = &zIn[nLen];` |
| 42488954 |   23 | `	for(;;){` |
| 84975129 |   24 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 78526385 |   25 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 72942683 |   26 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 66713751 |   27 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|        5 |   28 | `	}` |
| 23776167 |   29 | `	return nH;` |
|        5 |   30 | `}` |
|   541772 |   31 | `PH7_PRIVATE sxu32 SyStrHash(const void *pSrc,sxu32 nLen)` |
|        5 |   32 | `{` |
|   541777 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|        - |   34 | `	unsigned char *zEnd;` |
|   541777 |   35 | `	sxu32 nH = 5381;` |
|   541777 |   36 | `	zEnd = &zIn[nLen];` |
|  1000604 |   37 | `	for(;;){` |
|  2001213 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + SyToLower(zIn[0]); zIn++;` |
|  1885221 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + SyToLower(zIn[0]); zIn++;` |
|  1751351 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + SyToLower(zIn[0]); zIn++;` |
|  1544519 |   41 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + SyToLower(zIn[0]); zIn++;` |
|        5 |   42 | `	}` |
|   541777 |   43 | `	return nH;` |
|        5 |   44 | `}` |
...
|    20842 |  144 | `PH7_PRIVATE sxi32 SyLexInit(SyLex *pLex,SySet *pSet,ProcTokenizer xTokenizer,void *pUserData)` |
|        5 |  145 | `{` |
...
|        - |  150 | `	}` |
|        - |  151 | `#endif` |
|    20847 |  152 | `	pLex->pTokenSet = 0;` |
|        - |  153 | `	/* Initialize lexer fields */` |
|    20847 |  154 | `	if( pSet ){` |
|    20847 |  155 | `		if ( SySetElemSize(pSet) != sizeof(SyToken) ){` |
|      ! 0 |  156 | `			return SXERR_INVALID;` |
|        - |  157 | `		}` |
|    20847 |  158 | `		pLex->pTokenSet = pSet;` |
|    10421 |  159 | `	}` |
|    20847 |  160 | `	pStream = &pLex->sStream;` |
|    20847 |  161 | `	pLex->xTokenizer = xTokenizer;` |
|    20847 |  162 | `	pLex->pUserData = pUserData;` |
|        - |  163 |  |
|    20847 |  164 | `	pStream->nLine = 1;` |
|    20847 |  165 | `	pStream->nIgn  = 0;` |
|    20847 |  166 | `	pStream->zText = pStream->zEnd = 0;` |
|    20847 |  167 | `	pStream->pSet  = pSet;` |
|    20847 |  168 | `	return SXRET_OK;` |
|    10426 |  169 | `}` |
|    20832 |  170 | `PH7_PRIVATE sxi32 SyLexTokenizeInput(SyLex *pLex,const char *zInput,sxu32 nLen,void *pCtxData,ProcSort xSort,ProcCmp xCmp)` |
|        5 |  171 | `{` |
...
|        - |  179 | `	}` |
|        - |  180 | `#endif` |
|    20837 |  181 | `	pStream = &pLex->sStream;` |
|        - |  182 | `	/* Point to the head of the input */` |
|    20837 |  183 | `	pStream->zText = pStream->zInput = (const unsigned char *)zInput;` |
|        - |  184 | `	/* Point to the end of the input */` |
|    20837 |  185 | `	pStream->zEnd = &pStream->zInput[nLen];` |
|  6011215 |  186 | `	for(;;){` |
| 12022435 |  187 | `		if( pStream->zText >= pStream->zEnd ){` |
|        - |  188 | `			/* End of the input reached */` |
|    20805 |  189 | `			break;` |
|        - |  190 | `		}` |
| 12001635 |  191 | `		zCur = pStream->zText;` |
|        - |  192 | `		/* Call the tokenizer callback */` |
| 12001635 |  193 | `		rc = pLex->xTokenizer(pStream,&sToken,pLex->pUserData,pCtxData);` |
| 12001635 |  194 | `		if( rc != SXRET_OK && rc != SXERR_CONTINUE ){` |
|        - |  195 | `			/* Tokenizer callback request an operation abort */` |
|       34 |  196 | `			if( rc == SXERR_ABORT ){` |
|       34 |  197 | `				return SXERR_ABORT;` |
|        - |  198 | `			}` |
|      ! 0 |  199 | `			break;` |
|        - |  200 | `		}` |
| 12001603 |  201 | `		if( rc == SXERR_CONTINUE ){` |
|        - |  202 | `			/* Request to ignore this token */` |
|    96673 |  203 | `			pStream->nIgn++;` |
| 11953269 |  204 | `		}else if( pLex->pTokenSet  ){` |
|        - |  205 | `			/* Put the token in the set */` |
| 11904935 |  206 | `			rc = SySetPut(pLex->pTokenSet,(const void *)&sToken);` |
| 11904935 |  207 | `			if( rc != SXRET_OK ){` |
|      ! 0 |  208 | `				break;` |
|        - |  209 | `			}` |
|  5952465 |  210 | `		}` |
| 12001603 |  211 | `		if( zCur >= pStream->zText ){` |
|        - |  212 | `			/* Automatic advance of the stream cursor */` |
|      ! 0 |  213 | `			pStream->zText = &zCur[1];` |
|      ! 0 |  214 | `		}` |
|        5 |  215 | `	}` |
|    20805 |  216 | `	if( xSort &&  pLex->pTokenSet ){` |
...
|      ! 0 |  224 | `	}` |
|    20805 |  225 | `	return SXRET_OK;` |
|    10421 |  226 | `}` |
|    20842 |  227 | `PH7_PRIVATE sxi32 SyLexRelease(SyLex *pLex)` |
|        5 |  228 | `{` |
|    20847 |  229 | `	sxi32 rc = SXRET_OK;` |
|        - |  230 | `#if defined (UNTRUST)` |
|        - |  231 | `	if ( INVALID_LEXER(pLex) ){` |
|        - |  232 | `		return SXERR_CORRUPT;` |
|        - |  233 | `	}` |
|        - |  234 | `#else` |
|    10421 |  235 | `	SXUNUSED(pLex); /* Prevent compiler warning */` |
|        - |  236 | `#endif` |
|    20847 |  237 | `	return rc;` |
|        5 |  238 | `}` |
...
|        - |  325 | `#endif` |
|       23 |  326 | `	rc = SXRET_OK;` |
|       23 |  327 | `	zEnd = &zSrc[nLen];` |
|       23 |  328 | `	zCur = zIn;` |
|       14 |  329 | `	for(;;){` |
|       63 |  330 | `		while(zCur < zEnd && zCur[0] != '%' && zCur[0] != '+' ){` |
|       35 |  331 | `			zCur++;` |
|        1 |  332 | `		}` |
|       29 |  333 | `		if( zCur != zIn ){` |
|        - |  334 | `			/* Consume input */` |
|       23 |  335 | `			rc = xConsumer(zIn,(unsigned int)(zCur-zIn),pUserData);` |
|       23 |  336 | `			if( rc != SXRET_OK ){` |
