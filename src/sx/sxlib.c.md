...
|         - |   15 | `#include "sxstr.h"` |
|         - |   16 |  |
|  95687744 |   17 | `PH7_PRIVATE sxu32 SyBinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   18 | `{` |
|  95687749 |   19 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   20 | `	unsigned char *zEnd;` |
|  95687749 |   21 | `	sxu32 nH = 5381;` |
|  95687749 |   22 | `	zEnd = &zIn[nLen];` |
| 162593196 |   23 | `	for(;;){` |
| 325145801 |   24 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 299768909 |   25 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 272769349 |   26 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
| 251014621 |   27 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|         5 |   28 | `	}` |
|  95687749 |   29 | `	return nH;` |
|         5 |   30 | `}` |
...
|    105520 |  144 | `PH7_PRIVATE sxi32 SyLexInit(SyLex *pLex,SySet *pSet,ProcTokenizer xTokenizer,void *pUserData)` |
|         5 |  145 | `{` |
...
|         - |  150 | `	}` |
|         - |  151 | `#endif` |
|    105525 |  152 | `	pLex->pTokenSet = 0;` |
|         - |  153 | `	/* Initialize lexer fields */` |
|    105525 |  154 | `	if( pSet ){` |
|    105525 |  155 | `		if ( SySetElemSize(pSet) != sizeof(SyToken) ){` |
|       ! 0 |  156 | `			return SXERR_INVALID;` |
|         - |  157 | `		}` |
|    105525 |  158 | `		pLex->pTokenSet = pSet;` |
|     52760 |  159 | `	}` |
|    105525 |  160 | `	pStream = &pLex->sStream;` |
|    105525 |  161 | `	pLex->xTokenizer = xTokenizer;` |
|    105525 |  162 | `	pLex->pUserData = pUserData;` |
|         - |  163 |  |
|    105525 |  164 | `	pStream->nLine = 1;` |
|    105525 |  165 | `	pStream->nIgn  = 0;` |
|    105525 |  166 | `	pStream->zText = pStream->zEnd = 0;` |
|    105525 |  167 | `	pStream->pSet  = pSet;` |
|    105525 |  168 | `	return SXRET_OK;` |
|     52765 |  169 | `}` |
|    105520 |  170 | `PH7_PRIVATE sxi32 SyLexTokenizeInput(SyLex *pLex,const char *zInput,sxu32 nLen,void *pCtxData,ProcSort xSort,ProcCmp xCmp)` |
|         5 |  171 | `{` |
...
|         - |  179 | `	}` |
|         - |  180 | `#endif` |
|    105525 |  181 | `	pStream = &pLex->sStream;` |
|         - |  182 | `	/* Point to the head of the input */` |
|    105525 |  183 | `	pStream->zText = pStream->zInput = (const unsigned char *)zInput;` |
|         - |  184 | `	/* Point to the end of the input */` |
|    105525 |  185 | `	pStream->zEnd = &pStream->zInput[nLen];` |
|  93027090 |  186 | `	for(;;){` |
| 186054185 |  187 | `		if( pStream->zText >= pStream->zEnd ){` |
|         - |  188 | `			/* End of the input reached */` |
|    105505 |  189 | `			break;` |
|         - |  190 | `		}` |
| 185948685 |  191 | `		zCur = pStream->zText;` |
|         - |  192 | `		/* Call the tokenizer callback */` |
| 185948685 |  193 | `		rc = pLex->xTokenizer(pStream,&sToken,pLex->pUserData,pCtxData);` |
| 185948685 |  194 | `		if( rc != SXRET_OK && rc != SXERR_CONTINUE ){` |
...
|         3 |  199 | `			break;` |
|         - |  200 | `		}` |
| 185948665 |  201 | `		if( rc == SXERR_CONTINUE ){` |
|         - |  202 | `			/* Request to ignore this token */` |
|    232449 |  203 | `			pStream->nIgn++;` |
| 185832443 |  204 | `		}else if( pLex->pTokenSet  ){` |
|         - |  205 | `			/* Put the token in the set */` |
| 185716221 |  206 | `			rc = SySetPut(pLex->pTokenSet,(const void *)&sToken);` |
| 185716221 |  207 | `			if( rc != SXRET_OK ){` |
|       ! 0 |  208 | `				break;` |
|         - |  209 | `			}` |
|  92858108 |  210 | `		}` |
| 185948665 |  211 | `		if( zCur >= pStream->zText ){` |
|         - |  212 | `			/* Automatic advance of the stream cursor */` |
|       ! 0 |  213 | `			pStream->zText = &zCur[1];` |
|       ! 0 |  214 | `		}` |
|         5 |  215 | `	}` |
|    105507 |  216 | `	if( xSort &&  pLex->pTokenSet ){` |
...
|       ! 0 |  224 | `	}` |
|    105507 |  225 | `	return SXRET_OK;` |
|     52765 |  226 | `}` |
|    105520 |  227 | `PH7_PRIVATE sxi32 SyLexRelease(SyLex *pLex)` |
|         5 |  228 | `{` |
|    105525 |  229 | `	sxi32 rc = SXRET_OK;` |
|         - |  230 | `#if defined (UNTRUST)` |
|         - |  231 | `	if ( INVALID_LEXER(pLex) ){` |
|         - |  232 | `		return SXERR_CORRUPT;` |
|         - |  233 | `	}` |
|         - |  234 | `#else` |
|     52760 |  235 | `	SXUNUSED(pLex); /* Prevent compiler warning */` |
|         - |  236 | `#endif` |
|    105525 |  237 | `	return rc;` |
|         5 |  238 | `}` |
