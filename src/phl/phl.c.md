...
|     - |  185 | ` */` |
| 13060 |  186 | `static int Output_Consumer(const void *pOutput,unsigned int nOutputLen,void *pUserData /* Unused */)` |
|     5 |  187 | `{` |
|  6530 |  188 | `	(void)pUserData;` |
|     - |  189 | `#ifdef __WINNT__` |
|     - |  190 | `	BOOL rc;` |
...
|     - |  196 | `#else` |
|     - |  197 | `	ssize_t nWr;` |
| 13060 |  198 | `	nWr = write(STDOUT_FILENO,pOutput,nOutputLen);` |
| 13060 |  199 | `	if( nWr < 0 ){` |
...
|  4187 |  383 | `	for(n = 1 ; n < argc ; ++n ){` |
|     - |  384 | `		int c;` |
|  3933 |  385 | `		if( argv[n][0] != '-' ){` |
