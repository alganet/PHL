...
|     - |  185 | ` */` |
| 13086 |  186 | `static int Output_Consumer(const void *pOutput,unsigned int nOutputLen,void *pUserData /* Unused */)` |
|     5 |  187 | `{` |
|  6543 |  188 | `	(void)pUserData;` |
|     - |  189 | `#ifdef __WINNT__` |
|     - |  190 | `	BOOL rc;` |
...
|     - |  196 | `#else` |
|     - |  197 | `	ssize_t nWr;` |
| 13086 |  198 | `	nWr = write(STDOUT_FILENO,pOutput,nOutputLen);` |
| 13086 |  199 | `	if( nWr < 0 ){` |
