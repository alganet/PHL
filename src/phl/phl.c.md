...
|    - |   93 | ` */` |
| 6760 |   94 | `static int Output_Consumer(const void *pOutput,unsigned int nOutputLen,void *pUserData /* Unused */)` |
|    2 |   95 |  |
| 3380 |   96 | `	(void)pUserData;` |
|    - |   97 | `#ifdef __WINNT__` |
|    - |   98 | `	BOOL rc;` |
...
|    - |  104 | `#else` |
|    - |  105 | `	ssize_t nWr;` |
| 6760 |  106 | `	nWr = write(STDOUT_FILENO,pOutput,nOutputLen);` |
| 6760 |  107 | `	if( nWr < 0 ){` |
