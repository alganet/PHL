...
|    - |   40 | ` */` |
|  260 |   41 | `static void Fatal(const char *zMsg)` |
|    1 |   42 |  |
|  261 |   43 | `	puts(zMsg);` |
|    - |   44 | `	/* Shutdown the library */` |
|  261 |   45 | `	ph7_lib_shutdown();` |
|    - |   46 | `	/* Exit immediately */` |
|  261 |   47 | `	exit(0);` |
|  ! 0 |   48 |  |
|    - |   49 | `/*` |
...
|    - |   93 | ` */` |
| 4040 |   94 | `static int Output_Consumer(const void *pOutput,unsigned int nOutputLen,void *pUserData /* Unused */)` |
|    2 |   95 |  |
| 2020 |   96 | `	(void)pUserData;` |
|    - |   97 | `#ifdef __WINNT__` |
|    - |   98 | `	BOOL rc;` |
...
|    - |  104 | `#else` |
|    - |  105 | `	ssize_t nWr;` |
| 4040 |  106 | `	nWr = write(STDOUT_FILENO,pOutput,nOutputLen);` |
| 4040 |  107 | `	if( nWr < 0 ){` |
...
| 4042 |  113 | `	return PH7_OK;` |
| 2022 |  114 |  |
|    - |  115 | `/*` |
|    - |  116 | ` * Main program: Compile and execute the PHP file.` |
|    - |  117 | ` */` |
| 1330 |  118 | `int main(int argc,char **argv)` |
|    2 |  119 |  |
|    - |  120 | `	ph7 *pEngine; /* PH7 engine */` |
|    - |  121 | `	ph7_vm *pVm;  /* Compiled PHP program */` |
| 1332 |  122 | `	int dump_vm = 0;    /* Dump VM instructions if TRUE */` |
| 1332 |  123 | `	int run_code = 0;    /* Run inline code if TRUE */` |
| 1332 |  124 | `	const char *zRunCode = 0; /* Inline code string */` |
|    - |  125 | `	int n;              /* Script arguments */` |
|    - |  126 | `	int rc;` |
|    - |  127 | `	/* Process interpreter arguments first*/` |
| 1344 |  128 | `	for(n = 1 ; n < argc ; ++n ){` |
|    - |  129 | `		int c;` |
| 1214 |  130 | `		if( argv[n][0] != '-' ){` |
...
| 1076 |  176 | `	rc = ph7_init(&pEngine);` |
| 1076 |  177 | `	if( rc != PH7_OK ){` |
|    - |  178 | `		/*` |
...
|  ! 0 |  208 | `		}` |
|    5 |  209 | `	}else{` |
| 1068 |  210 | `		rc = ph7_compile_file(` |
|  468 |  211 | `			pEngine, /* PH7 Engine */` |
| 1066 |  212 | `			argv[n], /* Path to the PHP file to compile */` |
|    - |  213 | `			&pVm,    /* OUT: Compiled PHP program */` |
|    - |  214 | `			0        /* IN: Compile flags */` |
|    - |  215 | `			);` |
| 1068 |  216 | `		if( rc != PH7_OK ){ /* Compile error */` |
|  261 |  217 | `			if( rc == PH7_IO_ERR ){` |
|  ! 0 |  218 | `				Fatal("IO error while opening the target file");` |
|  261 |  219 | `			}else if( rc == PH7_VM_ERR ){` |
|  ! 0 |  220 | `				Fatal("VM initialization error");` |
|  ! 0 |  221 | `			}else{` |
|    - |  222 | `				/* Compile-time error, your output (STDOUT) should display the error messages */` |
|  261 |  223 | `				Fatal("Compile error");` |
|    - |  224 | `			}` |
|  130 |  225 | `		}` |
|    - |  226 | `	}` |
|    - |  227 | `	/*` |
...
|    1 |  248 | `		}` |
|    5 |  249 | `	}else{` |
|  950 |  250 | `		for( n = n + 1; n < argc ; ++n ){` |
|   14 |  251 | `			ph7_vm_config(pVm,PH7_VM_CONFIG_ARGV_ENTRY,argv[n]/* Argument value */);` |
|    8 |  252 | `		}` |
|    - |  253 | `	}` |
|    - |  254 | `	/* Report script run-time errors (now default behavior) */` |
|  946 |  255 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_ERR_REPORT);` |
|  946 |  256 | `	if( dump_vm ){` |
...
|    - |  266 | `	 */` |
|  946 |  267 | `	ph7_vm_exec(pVm,0);` |
|    - |  268 | `	/* All done, cleanup the mess left behind.` |
|    - |  269 | `	*/` |
|  942 |  270 | `	ph7_vm_release(pVm);` |
|  942 |  271 | `	ph7_release(pEngine);` |
|  942 |  272 | `	return 0;` |
|    2 |  273 |  |
|    - |  274 |  |
