...
|    - |   40 | ` */` |
|  242 |   41 | `static void Fatal(const char *zMsg)` |
|    1 |   42 |  |
|  243 |   43 | `	puts(zMsg);` |
|    - |   44 | `	/* Shutdown the library */` |
|  243 |   45 | `	ph7_lib_shutdown();` |
|    - |   46 | `	/* Exit immediately */` |
|  243 |   47 | `	exit(0);` |
|  ! 0 |   48 |  |
|    - |   49 | `/*` |
...
|    - |   93 | ` */` |
| 7472 |   94 | `static int Output_Consumer(const void *pOutput,unsigned int nOutputLen,void *pUserData /* Unused */)` |
|    1 |   95 |  |
| 3736 |   96 | `	(void)pUserData;` |
|    - |   97 | `#ifdef __WINNT__` |
|    - |   98 | `	BOOL rc;` |
|    1 |   99 | `	rc = WriteFile(GetStdHandle(STD_OUTPUT_HANDLE),pOutput,(DWORD)nOutputLen,0,0);` |
|    1 |  100 | `	if( !rc ){` |
...
|    - |  104 | `#else` |
|    - |  105 | `	ssize_t nWr;` |
| 7472 |  106 | `	nWr = write(STDOUT_FILENO,pOutput,nOutputLen);` |
| 7472 |  107 | `	if( nWr < 0 ){` |
...
| 7473 |  113 | `	return PH7_OK;` |
| 3737 |  114 |  |
|    - |  115 | `/*` |
|    - |  116 | ` * Main program: Compile and execute the PHP file.` |
|    - |  117 | ` */` |
| 5451 |  118 | `int main(int argc,char **argv)` |
|    1 |  119 |  |
|    - |  120 | `	ph7 *pEngine; /* PH7 engine */` |
|    - |  121 | `	ph7_vm *pVm;  /* Compiled PHP program */` |
| 5452 |  122 | `	int dump_vm = 0;    /* Dump VM instructions if TRUE */` |
| 5452 |  123 | `	int run_code = 0;    /* Run inline code if TRUE */` |
| 5452 |  124 | `	const char *zRunCode = 0; /* Inline code string */` |
|    - |  125 | `	int n;              /* Script arguments */` |
|    - |  126 | `	int rc;` |
|    - |  127 | `	/* Process interpreter arguments first*/` |
| 5464 |  128 | `	for(n = 1 ; n < argc ; ++n ){` |
|    - |  129 | `		int c;` |
| 5343 |  130 | `		if( argv[n][0] != '-' ){` |
...
|    1 |  173 | `	CreateMiniDumpOnUnHandledException();` |
|    - |  174 | `#endif` |
|    - |  175 | `	/* Allocate a new PH7 engine instance */` |
| 5214 |  176 | `	rc = ph7_init(&pEngine);` |
| 5214 |  177 | `	if( rc != PH7_OK ){` |
|    - |  178 | `		/*` |
...
|    - |  186 | `	 */` |
| 5214 |  187 | `	ph7_config(pEngine,PH7_CONFIG_ERR_OUTPUT,` |
|    - |  188 | `		Output_Consumer, /* Error log consumer */` |
|    - |  189 | `		0 /* NULL: Callback Private data */` |
|    - |  190 | `		);` |
|    - |  191 | `	/* Now,it's time to compile our PHP file */` |
| 5214 |  192 | `	if( run_code ){` |
...
|  ! 0 |  208 | `		}` |
|    5 |  209 | `	}else{` |
| 5206 |  210 | `		rc = ph7_compile_file(` |
| 2542 |  211 | `			pEngine, /* PH7 Engine */` |
| 5205 |  212 | `			argv[n], /* Path to the PHP file to compile */` |
|    - |  213 | `			&pVm,    /* OUT: Compiled PHP program */` |
|    - |  214 | `			0        /* IN: Compile flags */` |
|    - |  215 | `			);` |
| 5206 |  216 | `		if( rc != PH7_OK ){ /* Compile error */` |
|  243 |  217 | `			if( rc == PH7_IO_ERR ){` |
|  ! 0 |  218 | `				Fatal("IO error while opening the target file");` |
|  243 |  219 | `			}else if( rc == PH7_VM_ERR ){` |
|  ! 0 |  220 | `				Fatal("VM initialization error");` |
|  ! 0 |  221 | `			}else{` |
|    - |  222 | `				/* Compile-time error, your output (STDOUT) should display the error messages */` |
|  243 |  223 | `				Fatal("Compile error");` |
|    - |  224 | `			}` |
|  121 |  225 | `		}` |
|    - |  226 | `	}` |
|    - |  227 | `	/*` |
...
|    - |  231 | `	 */` |
| 5093 |  232 | `	rc = ph7_vm_config(pVm,` |
|    - |  233 | `		PH7_VM_CONFIG_OUTPUT,` |
|    - |  234 | `		Output_Consumer,    /* Output Consumer callback */` |
|    - |  235 | `		0                   /* Callback private data */` |
|    - |  236 | `		);` |
| 5093 |  237 | `	if( rc != PH7_OK ){` |
...
|    - |  244 | `	 */` |
| 5093 |  245 | `	if( run_code ){` |
|   11 |  246 | `		for( ; n < argc ; ++n ){` |
|    2 |  247 | `			ph7_vm_config(pVm,PH7_VM_CONFIG_ARGV_ENTRY,argv[n]/* Argument value */);` |
|    1 |  248 | `		}` |
|    5 |  249 | `	}else{` |
| 5085 |  250 | `		for( n = n + 1; n < argc ; ++n ){` |
|  ! 0 |  251 | `			ph7_vm_config(pVm,PH7_VM_CONFIG_ARGV_ENTRY,argv[n]/* Argument value */);` |
|  ! 0 |  252 | `		}` |
|    - |  253 | `	}` |
|    - |  254 | `	/* Report script run-time errors (now default behavior) */` |
| 5093 |  255 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_ERR_REPORT);` |
| 5093 |  256 | `	if( dump_vm ){` |
...
|    - |  266 | `	 */` |
| 5093 |  267 | `	ph7_vm_exec(pVm,0);` |
|    - |  268 | `	/* All done, cleanup the mess left behind.` |
|    - |  269 | `	*/` |
| 5089 |  270 | `	ph7_vm_release(pVm);` |
| 5089 |  271 | `	ph7_release(pEngine);` |
| 5089 |  272 | `	return 0;` |
|    1 |  273 |  |
|    - |  274 |  |
