...
|     - |  185 | ` */` |
| 12998 |  186 | `static int Output_Consumer(const void *pOutput,unsigned int nOutputLen,void *pUserData /* Unused */)` |
|     5 |  187 | `{` |
|  6499 |  188 | `	(void)pUserData;` |
|     - |  189 | `#ifdef __WINNT__` |
|     - |  190 | `	BOOL rc;` |
...
|     - |  196 | `#else` |
|     - |  197 | `	ssize_t nWr;` |
| 12998 |  198 | `	nWr = write(STDOUT_FILENO,pOutput,nOutputLen);` |
| 12998 |  199 | `	if( nWr < 0 ){` |
...
|     - |  359 | ` */` |
|  4065 |  360 | `int main(int argc,char **argv)` |
|     5 |  361 | `{` |
|     - |  362 | `	ph7 *pEngine; /* PH7 engine */` |
|     - |  363 | `	ph7_vm *pVm;  /* Compiled PHP program */` |
|  4070 |  364 | `	int dump_vm = 0;    /* Dump VM instructions if TRUE */` |
|  4070 |  365 | `	int run_code = 0;    /* Run inline code if TRUE */` |
|  4070 |  366 | `	int lint_mode = 0;   /* Syntax-check only (-l) if TRUE */` |
|  4070 |  367 | `	const char *zRunCode = 0; /* Inline code string */` |
|  4070 |  368 | `	int stdin_code = 0;       /* Execute a script read from stdin if TRUE */` |
|  4070 |  369 | `	char *zStdinCode = 0;     /* Script slurped from stdin */` |
|  4070 |  370 | `	int nStdinCode = 0;       /* Length of the stdin script */` |
|  4070 |  371 | ``	int dash_dash = 0;        /* Saw `--`: read from stdin, rest are script args */`` |
|     - |  372 | `#ifdef PHL_ENABLE_SERVER` |
|  4070 |  373 | `	int server_mode = 0;        /* Start built-in server if TRUE */` |
|  4070 |  374 | `	const char *zServerAddr = 0; /* host:port string */` |
|  4070 |  375 | `	const char *zDocRoot = ".";  /* Document root */` |
|     - |  376 | `#endif` |
|     - |  377 | `	int n;              /* Script arguments */` |
|     - |  378 | `	int rc;` |
|     - |  379 | `	const char *azIniDefine[64]; /* -d name=value directives, in order */` |
|  4070 |  380 | `	int nIniDefine = 0;` |
|  4070 |  381 | `	const char *zIniFile = 0;    /* -c php.ini path */` |
|     - |  382 | `	/* Process interpreter arguments first*/` |
|  4173 |  383 | `	for(n = 1 ; n < argc ; ++n ){` |
|     - |  384 | `		int c;` |
|  3919 |  385 | `		if( argv[n][0] != '-' ){` |
...
|     - |  550 | `	}` |
|     - |  551 | `#endif` |
|  4039 |  552 | `	if( (n >= argc \|\| dash_dash) && !run_code ){` |
...
|   ! 0 |  666 | `		}` |
|     6 |  667 | `	}else{` |
|  3575 |  668 | `		rc = ph7_compile_file(` |
|  1671 |  669 | `			pEngine, /* PH7 Engine */` |
|  3570 |  670 | `			argv[n], /* Path to the PHP file to compile */` |
|     - |  671 | `			&pVm,    /* OUT: Compiled PHP program */` |
|     - |  672 | `			0        /* IN: Compile flags */` |
|     - |  673 | `			);` |
|  3575 |  674 | `		if( rc != PH7_OK ){ /* Compile error */` |
...
|     - |  777 | `	{` |
|     - |  778 | `		int i;` |
|  3395 |  779 | `		for( i = 0 ; i < nIniDefine ; i++ ){` |
