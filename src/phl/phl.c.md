...
|    - |   93 | ` */` |
| 4102 |   94 | `static int Output_Consumer(const void *pOutput,unsigned int nOutputLen,void *pUserData /* Unused */)` |
|    2 |   95 |  |
| 2051 |   96 | `	(void)pUserData;` |
|    - |   97 | `#ifdef __WINNT__` |
|    - |   98 | `	BOOL rc;` |
...
|    - |  104 | `#else` |
|    - |  105 | `	ssize_t nWr;` |
| 4102 |  106 | `	nWr = write(STDOUT_FILENO,pOutput,nOutputLen);` |
| 4102 |  107 | `	if( nWr < 0 ){` |
...
| 4104 |  113 | `	return PH7_OK;` |
| 2053 |  114 |  |
|    - |  115 | `/*` |
|    - |  116 | ` * Main program: Compile and execute the PHP file.` |
|    - |  117 | ` */` |
| 1417 |  118 | `int main(int argc,char **argv)` |
|    2 |  119 |  |
|    - |  120 | `	ph7 *pEngine; /* PH7 engine */` |
|    - |  121 | `	ph7_vm *pVm;  /* Compiled PHP program */` |
| 1419 |  122 | `	int dump_vm = 0;    /* Dump VM instructions if TRUE */` |
| 1419 |  123 | `	int run_code = 0;    /* Run inline code if TRUE */` |
| 1419 |  124 | `	const char *zRunCode = 0; /* Inline code string */` |
|    - |  125 | `	int n;              /* Script arguments */` |
|    - |  126 | `	int rc;` |
|    - |  127 | `	/* Process interpreter arguments first*/` |
| 1431 |  128 | `	for(n = 1 ; n < argc ; ++n ){` |
|    - |  129 | `		int c;` |
| 1302 |  130 | `		if( argv[n][0] != '-' ){` |
...
| 1165 |  176 | `	rc = ph7_init(&pEngine);` |
| 1165 |  177 | `	if( rc != PH7_OK ){` |
|    - |  178 | `		/*` |
...
|  ! 0 |  208 | `		}` |
|    5 |  209 | `	}else{` |
| 1157 |  210 | `		rc = ph7_compile_file(` |
|  513 |  211 | `			pEngine, /* PH7 Engine */` |
| 1155 |  212 | `			argv[n], /* Path to the PHP file to compile */` |
|    - |  213 | `			&pVm,    /* OUT: Compiled PHP program */` |
|    - |  214 |  |
|    - |  215 | `			);` |
| 1157 |  216 | `		if( rc != PH7_OK ){ /* Compile error */` |
...
| 1036 |  255 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_ERR_REPORT);` |
| 1036 |  256 | `	if( dump_vm ){` |
...
|    - |  266 | `	 */` |
| 1036 |  267 | `	ph7_vm_exec(pVm,0);` |
|    - |  268 | `	/* All done, cleanup the mess left behind.` |
|    - |  269 | `	*/` |
| 1032 |  270 | `	ph7_vm_release(pVm);` |
| 1032 |  271 | `	ph7_release(pEngine);` |
| 1032 |  272 | `	return 0;` |
|    2 |  273 |  |
|    - |  274 |  |
