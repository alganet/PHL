...
|     - |   67 | ` */` |
|   456 |   68 | `static void FatalSilent(void)` |
|     4 |   69 | `{` |
|   460 |   70 | `	ph7_lib_shutdown();` |
|   460 |   71 | `	exit(255);` |
|   ! 0 |   72 | `}` |
|     - |   73 | `/*` |
...
|     - |  159 | ` */` |
|  3368 |  160 | `static const char * PHL_ResolveBinaryPath(const char *zArgv0)` |
|     5 |  161 | `{` |
|     - |  162 | `#ifdef __WINNT__` |
...
|     - |  166 | `	}` |
|     - |  167 | `#else` |
|  3368 |  168 | `	if( realpath(zArgv0,zPhlBinaryPath) != 0 ){` |
|  3368 |  169 | `		return zPhlBinaryPath;` |
|     - |  170 | `	}` |
|     - |  171 | `#endif` |
|   ! 0 |  172 | `	return zArgv0;` |
|  1689 |  173 | `}` |
...
|     - |  182 | ` */` |
| 12896 |  183 | `static int Output_Consumer(const void *pOutput,unsigned int nOutputLen,void *pUserData /* Unused */)` |
|     5 |  184 | `{` |
|  6448 |  185 | `	(void)pUserData;` |
|     - |  186 | `#ifdef __WINNT__` |
|     - |  187 | `	BOOL rc;` |
...
|     - |  193 | `#else` |
|     - |  194 | `	ssize_t nWr;` |
| 12896 |  195 | `	nWr = write(STDOUT_FILENO,pOutput,nOutputLen);` |
| 12896 |  196 | `	if( nWr < 0 ){` |
...
|     - |  212 | ` */` |
| 14288 |  213 | `static int PHL_EnvULong(const char *zName,unsigned long uFloor,unsigned long uCeil,unsigned long *pOut)` |
|     5 |  214 | `{` |
| 14293 |  215 | `	const char *zVal = getenv(zName);` |
| 14293 |  216 | `	char *zEnd = 0;` |
|     - |  217 | `	unsigned long uMax;` |
| 14293 |  218 | `	if( zVal == 0 \|\| zVal[0] == 0 ){` |
| 14279 |  219 | `		return 0;` |
|     - |  220 | `	}` |
...
|    16 |  223 | `	if( zVal[0] == '-' \|\| zVal[0] == '+' ){` |
|   ! 0 |  224 | `		return 0;` |
|     - |  225 | `	}` |
|    16 |  226 | `	errno = 0;` |
|    16 |  227 | `	uMax = strtoul(zVal,&zEnd,10);` |
|    16 |  228 | `	if( errno != 0 \|\| zEnd == zVal \|\| *zEnd != 0 \|\| uMax == 0 ){` |
|   ! 0 |  229 | `		return 0; /* non-numeric, trailing junk, overflow, or zero */` |
|     - |  230 | `	}` |
|    16 |  231 | `	if( uMax < uFloor ){` |
|   ! 0 |  232 | `		uMax = uFloor;` |
|   ! 0 |  233 | `	}` |
|    16 |  234 | `	if( uMax > uCeil ){` |
|   ! 0 |  235 | `		uMax = uCeil;` |
|   ! 0 |  236 | `	}` |
|    16 |  237 | `	*pOut = uMax;` |
|    16 |  238 | `	return 1;` |
...
|     - |  244 | ` */` |
|    22 |  245 | `static void PHL_ApplyIniPair(ph7_vm *pVm,const char *zPair)` |
|     1 |  246 | `{` |
|     - |  247 | `	char zName[128];` |
|     - |  248 | `	char zValue[512];` |
|    23 |  249 | `	const char *zEq = strchr(zPair,'=');` |
|     - |  250 | `	const char *zEnd;` |
|     - |  251 | `	size_t n;` |
|    23 |  252 | `	if( zEq == 0 ){` |
...
|     1 |  255 | `	}` |
|     - |  256 | `	/* name: trim */` |
|    23 |  257 | `	while( *zPair == ' ' \|\| *zPair == '\t' ){ zPair++; }` |
|    23 |  258 | `	zEnd = zEq;` |
|    42 |  259 | `	while( zEnd > zPair && (zEnd[-1] == ' ' \|\| zEnd[-1] == '\t') ){ zEnd--; }` |
|    23 |  260 | `	n = (size_t)(zEnd - zPair);` |
|    23 |  261 | `	if( n == 0 \|\| n >= sizeof(zName) ){` |
|   ! 0 |  262 | `		return;` |
|     - |  263 | `	}` |
|    23 |  264 | `	memcpy(zName,zPair,n);` |
|    23 |  265 | `	zName[n] = 0;` |
|     - |  266 | `	/* value: trim + unquote */` |
|    23 |  267 | `	if( *zEq == '=' ){` |
|    21 |  268 | `		const char *zV = zEq + 1;` |
|     - |  269 | `		const char *zVEnd;` |
|    29 |  270 | `		while( *zV == ' ' \|\| *zV == '\t' ){ zV++; }` |
|    21 |  271 | `		zVEnd = zV + strlen(zV);` |
|    39 |  272 | `		while( zVEnd > zV && (zVEnd[-1] == ' ' \|\| zVEnd[-1] == '\t'` |
|    32 |  273 | `		    \|\| zVEnd[-1] == '\r' \|\| zVEnd[-1] == '\n') ){ zVEnd--; }` |
|    21 |  274 | `		if( zVEnd - zV >= 2 && (zV[0] == '"' \|\| zV[0] == '\'') && zVEnd[-1] == zV[0] ){` |
|     4 |  275 | `			zV++;` |
|     4 |  276 | `			zVEnd--;` |
|     2 |  277 | `		}` |
|    21 |  278 | `		n = (size_t)(zVEnd - zV);` |
|    21 |  279 | `		if( n >= sizeof(zValue) ){` |
|   ! 0 |  280 | `			n = sizeof(zValue) - 1;` |
|   ! 0 |  281 | `		}` |
|    21 |  282 | `		memcpy(zValue,zV,n);` |
|    21 |  283 | `		zValue[n] = 0;` |
|    11 |  284 | `	}else{` |
...
|     2 |  287 | `		zValue[1] = 0;` |
|     - |  288 | `	}` |
|    23 |  289 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_INI_ENTRY,zName,zValue);` |
|    12 |  290 | `}` |
|     - |  291 | `/*` |
...
|     - |  316 | ` */` |
|  4039 |  317 | `int main(int argc,char **argv)` |
|     5 |  318 | `{` |
|     - |  319 | `	ph7 *pEngine; /* PH7 engine */` |
|     - |  320 | `	ph7_vm *pVm;  /* Compiled PHP program */` |
|  4044 |  321 | `	int dump_vm = 0;    /* Dump VM instructions if TRUE */` |
|  4044 |  322 | `	int run_code = 0;    /* Run inline code if TRUE */` |
|  4044 |  323 | `	int lint_mode = 0;   /* Syntax-check only (-l) if TRUE */` |
|  4044 |  324 | `	const char *zRunCode = 0; /* Inline code string */` |
|     - |  325 | `#ifdef PHL_ENABLE_SERVER` |
|  4044 |  326 | `	int server_mode = 0;        /* Start built-in server if TRUE */` |
|  4044 |  327 | `	const char *zServerAddr = 0; /* host:port string */` |
|  4044 |  328 | `	const char *zDocRoot = ".";  /* Document root */` |
|     - |  329 | `#endif` |
|     - |  330 | `	int n;              /* Script arguments */` |
|     - |  331 | `	int rc;` |
|     - |  332 | `	const char *azIniDefine[64]; /* -d name=value directives, in order */` |
|  4044 |  333 | `	int nIniDefine = 0;` |
|  4044 |  334 | `	const char *zIniFile = 0;    /* -c php.ini path */` |
|     - |  335 | `	/* Process interpreter arguments first*/` |
|  4147 |  336 | `	for(n = 1 ; n < argc ; ++n ){` |
|     - |  337 | `		int c;` |
|  3895 |  338 | `		if( argv[n][0] != '-' ){` |
...
|   ! 0 |  446 | `			}` |
|    15 |  447 | `			if( nIniDefine < (int)(sizeof(azIniDefine)/sizeof(azIniDefine[0])) ){` |
|    15 |  448 | `				azIniDefine[nIniDefine++] = argv[++n];` |
|     8 |  449 | `			}else{` |
...
|  4013 |  502 | `	rc = ph7_init(&pEngine);` |
|  4013 |  503 | `	if( rc != PH7_OK ){` |
|     - |  504 | `		/*` |
...
|     - |  512 | `	 */` |
|  4013 |  513 | `	ph7_config(pEngine,PH7_CONFIG_ERR_OUTPUT,` |
...
|  4013 |  524 | `		if( PHL_EnvULong("PHL_MAX_ALLOC",65536UL,0xFFFFFFFFUL,&uMax) ){` |
...
|  4013 |  532 | `		if( PHL_EnvULong("PHL_MAX_INPUT",1UL,0xFFFFFFFFUL,&uMax) ){` |
...
|   ! 0 |  579 | `		}` |
|   220 |  580 | `	}else{` |
|  3781 |  581 | `		rc = ph7_compile_file(` |
|  1888 |  582 | `			pEngine, /* PH7 Engine */` |
|  3776 |  583 | `			argv[n], /* Path to the PHP file to compile */` |
|     - |  584 | `			&pVm,    /* OUT: Compiled PHP program */` |
|     - |  585 | `			0        /* IN: Compile flags */` |
|     - |  586 | `			);` |
|  3781 |  587 | `		if( rc != PH7_OK ){ /* Compile error */` |
|   460 |  588 | `			if( rc == PH7_IO_ERR ){` |
|   ! 0 |  589 | `				FatalCode("IO error while opening the target file",1);` |
|   460 |  590 | `			}else if( rc == PH7_VM_ERR ){` |
...
|  3347 |  622 | `		if( PHL_EnvULong("PHL_MAX_RECURSION",1UL,0x7FFFFFFFUL,&uMax) ){` |
|     5 |  623 | `			ph7_vm_config(pVm,PH7_VM_CONFIG_RECURSION_DEPTH,(int)uMax);` |
|     2 |  624 | `		}` |
|  3347 |  625 | `		if( PHL_EnvULong("PHL_MAX_NATIVE_DEPTH",2UL,0x7FFFFFFFUL,&uMax) ){` |
|    11 |  626 | `			ph7_vm_config(pVm,PH7_VM_CONFIG_NATIVE_DEPTH,(int)uMax);` |
|     5 |  627 | `		}` |
|     - |  628 | `	}` |
|     - |  629 | `	/* Define PHP_BINARY: absolute path of this interpreter */` |
|  5018 |  630 | `	ph7_create_constant(pVm,"PHP_BINARY",PHL_PhpBinaryConst,` |
|  3342 |  631 | `		(void *)PHL_ResolveBinaryPath(argv[0]));` |
...
|     - |  636 | `	 */` |
|     - |  637 | `	{` |
|  3347 |  638 | `		const char *zScriptName = run_code ? "Standard input code" : argv[n];` |
|  3347 |  639 | `		int argv_count = 0;` |
|     - |  640 | `		ph7_value *pArgc;` |
...
|  3347 |  644 | `		if( ph7_vm_config(pVm,PH7_VM_CONFIG_ARGV_ENTRY,zScriptName) == PH7_OK ){` |
|  3347 |  645 | `			argv_count++;` |
|  1671 |  646 | `		}` |
...
|  3377 |  649 | `		for( n = run_code ? n : n + 1; n < argc ; ++n ){` |
|    35 |  650 | `			if( ph7_vm_config(pVm,PH7_VM_CONFIG_ARGV_ENTRY,argv[n]) == PH7_OK ){` |
|    33 |  651 | `				argv_count++;` |
|    14 |  652 | `			}` |
|    20 |  653 | `		}` |
|     - |  654 | `		/* $argc: a plain integer global equal to count($argv). */` |
|  3347 |  655 | `		pArgc = ph7_new_scalar(pVm);` |
|  3347 |  656 | `		if( pArgc ){` |
|  3347 |  657 | `			ph7_value_int(pArgc,argv_count);` |
|  3347 |  658 | `			ph7_vm_config(pVm,PH7_VM_CONFIG_CREATE_VAR,"argc",pArgc);` |
|  3347 |  659 | `			ph7_release_value(pVm,pArgc);` |
|  1671 |  660 | `		}` |
|     - |  661 | `		/* Mirror $argv/$argc into $_SERVER['argv']/$_SERVER['argc'] (php CLI). */` |
|  3347 |  662 | `		ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ARGV);` |
...
|  3347 |  665 | `		ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ATTR,"SCRIPT_NAME",zScriptName,-1);` |
|  3347 |  666 | `		ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ATTR,"PHP_SELF",zScriptName,-1);` |
|  3347 |  667 | `		ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ATTR,"DOCUMENT_ROOT","",0);` |
|     - |  668 | `		{` |
|     - |  669 | `			char zTime[32];` |
|  3347 |  670 | `			snprintf(zTime,sizeof(zTime),"%ld",(long)time(0));` |
|  3347 |  671 | `			ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ATTR,"REQUEST_TIME",zTime,-1);` |
|     - |  672 | `		}` |
|     - |  673 | `#ifndef __WINNT__` |
|     - |  674 | `		{` |
|     - |  675 | `			char zCwd[PATH_MAX];` |
|  3342 |  676 | `			if( getcwd(zCwd,sizeof(zCwd)) ){` |
|  3342 |  677 | `				ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ATTR,"PWD",zCwd,-1);` |
|  1671 |  678 | `			}` |
|     - |  679 | `		}` |
|     - |  680 | `#endif` |
|     - |  681 | `	}` |
|     - |  682 | `	/* Report script run-time errors (now default behavior) */` |
|  3347 |  683 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_ERR_REPORT);` |
...
|  3347 |  687 | `	if( zIniFile ){` |
|     4 |  688 | `		PHL_LoadIniFile(pVm,zIniFile);` |
|     2 |  689 | `	}` |
|     - |  690 | `	{` |
|     - |  691 | `		int i;` |
|  3361 |  692 | `		for( i = 0 ; i < nIniDefine ; i++ ){` |
|    15 |  693 | `			PHL_ApplyIniPair(pVm,azIniDefine[i]);` |
|     8 |  694 | `		}` |
|     - |  695 | `	}` |
|  3347 |  696 | `	if( dump_vm ){` |
...
|     - |  706 | `	 */` |
|     - |  707 | `	{` |
|  3347 |  708 | `		int iExitStatus = 0;` |
|  3347 |  709 | `		ph7_vm_exec(pVm,&iExitStatus);` |
|     - |  710 | `		/* All done, cleanup the mess left behind.` |
|     - |  711 | `		*/` |
|  3347 |  712 | `		ph7_vm_release(pVm);` |
|  3347 |  713 | `		ph7_release(pEngine);` |
|     - |  714 | `		/* Propagate the script exit status (set via exit()/die()) */` |
|  3347 |  715 | `		return iExitStatus;` |
|     - |  716 | `	}` |
|  1691 |  717 | `}` |
|     - |  718 |  |
