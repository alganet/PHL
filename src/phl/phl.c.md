...
|    - |   43 | ` */` |
|  280 |   44 | `static void Fatal(const char *zMsg)` |
|    1 |   45 |  |
|  281 |   46 | `	puts(zMsg);` |
|    - |   47 | `	/* Shutdown the library */` |
|  281 |   48 | `	ph7_lib_shutdown();` |
|    - |   49 | `	/* Exit immediately */` |
|  281 |   50 | `	exit(0);` |
|  ! 0 |   51 |  |
|    - |   52 | `/*` |
...
|    - |  103 | ` */` |
| 7508 |  104 | `static int Output_Consumer(const void *pOutput,unsigned int nOutputLen,void *pUserData /* Unused */)` |
|    2 |  105 |  |
| 3754 |  106 | `	(void)pUserData;` |
|    - |  107 | `#ifdef __WINNT__` |
|    - |  108 | `	BOOL rc;` |
...
|    - |  114 | `#else` |
|    - |  115 | `	ssize_t nWr;` |
| 7508 |  116 | `	nWr = write(STDOUT_FILENO,pOutput,nOutputLen);` |
| 7508 |  117 | `	if( nWr < 0 ){` |
...
| 7510 |  123 | `	return PH7_OK;` |
| 3756 |  124 |  |
|    - |  125 | `/*` |
|    - |  126 | ` * Main program: Compile and execute the PHP file.` |
|    - |  127 | ` */` |
| 2922 |  128 | `int main(int argc,char **argv)` |
|    2 |  129 |  |
|    - |  130 | `	ph7 *pEngine; /* PH7 engine */` |
|    - |  131 | `	ph7_vm *pVm;  /* Compiled PHP program */` |
| 2924 |  132 | `	int dump_vm = 0;    /* Dump VM instructions if TRUE */` |
| 2924 |  133 | `	int run_code = 0;    /* Run inline code if TRUE */` |
| 2924 |  134 | `	const char *zRunCode = 0; /* Inline code string */` |
|    - |  135 | `#ifdef PHL_ENABLE_SERVER` |
| 2924 |  136 | `	int server_mode = 0;        /* Start built-in server if TRUE */` |
| 2924 |  137 | `	const char *zServerAddr = 0; /* host:port string */` |
| 2924 |  138 | `	const char *zDocRoot = ".";  /* Document root */` |
|    - |  139 | `#endif` |
|    - |  140 | `	int n;              /* Script arguments */` |
|    - |  141 | `	int rc;` |
|    - |  142 | `	/* Process interpreter arguments first*/` |
| 2972 |  143 | `	for(n = 1 ; n < argc ; ++n ){` |
|    - |  144 | `		int c;` |
| 2832 |  145 | `		if( argv[n][0] != '-' ){` |
...
| 2648 |  240 | `	rc = ph7_init(&pEngine);` |
| 2648 |  241 | `	if( rc != PH7_OK ){` |
|    - |  242 | `		/*` |
...
|  ! 0 |  272 | `		}` |
|    5 |  273 | `	}else{` |
| 2640 |  274 | `		rc = ph7_compile_file(` |
| 1249 |  275 | `			pEngine, /* PH7 Engine */` |
| 2638 |  276 | `			argv[n], /* Path to the PHP file to compile */` |
|    - |  277 | `			&pVm,    /* OUT: Compiled PHP program */` |
|    - |  278 |  |
|    - |  279 | `			);` |
| 2640 |  280 | `		if( rc != PH7_OK ){ /* Compile error */` |
|  281 |  281 | `			if( rc == PH7_IO_ERR ){` |
|  ! 0 |  282 | `				Fatal("IO error while opening the target file");` |
|  281 |  283 | `			}else if( rc == PH7_VM_ERR ){` |
|  ! 0 |  284 | `				Fatal("VM initialization error");` |
|  ! 0 |  285 | `			}else{` |
|    - |  286 | `				/* Compile-time error, your output (STDOUT) should display the error messages */` |
|  281 |  287 | `				Fatal("Compile error");` |
|    - |  288 | `			}` |
|  140 |  289 | `		}` |
|    - |  290 | `	}` |
|    - |  291 | `	/*` |
...
| 2508 |  319 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_ERR_REPORT);` |
| 2508 |  320 | `	if( dump_vm ){` |
...
|    - |  330 | `	 */` |
| 2508 |  331 | `	ph7_vm_exec(pVm,0);` |
|    - |  332 | `	/* All done, cleanup the mess left behind.` |
|    - |  333 | `	*/` |
| 2504 |  334 | `	ph7_vm_release(pVm);` |
| 2504 |  335 | `	ph7_release(pEngine);` |
| 2504 |  336 | `	return 0;` |
| 1264 |  337 |  |
|    - |  338 |  |
