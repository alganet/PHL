...
|     - |  215 | ` */` |
| 14524 |  216 | `static int PHL_EnvULong(const char *zName,unsigned long uFloor,unsigned long uCeil,unsigned long *pOut)` |
|     5 |  217 | `{` |
| 14529 |  218 | `	const char *zVal = getenv(zName);` |
| 14529 |  219 | `	char *zEnd = 0;` |
|     - |  220 | `	unsigned long uMax;` |
| 14529 |  221 | `	if( zVal == 0 \|\| zVal[0] == 0 ){` |
| 14515 |  222 | `		return 0;` |
|     - |  223 | `	}` |
...
|     - |  359 | ` */` |
|  4110 |  360 | `int main(int argc,char **argv)` |
|     5 |  361 | `{` |
|     - |  362 | `	ph7 *pEngine; /* PH7 engine */` |
|     - |  363 | `	ph7_vm *pVm;  /* Compiled PHP program */` |
|  4115 |  364 | `	int dump_vm = 0;    /* Dump VM instructions if TRUE */` |
|  4115 |  365 | `	int run_code = 0;    /* Run inline code if TRUE */` |
|  4115 |  366 | `	int lint_mode = 0;   /* Syntax-check only (-l) if TRUE */` |
|  4115 |  367 | `	const char *zRunCode = 0; /* Inline code string */` |
|  4115 |  368 | `	int stdin_code = 0;       /* Execute a script read from stdin if TRUE */` |
|  4115 |  369 | `	char *zStdinCode = 0;     /* Script slurped from stdin */` |
|  4115 |  370 | `	int nStdinCode = 0;       /* Length of the stdin script */` |
|  4115 |  371 | ``	int dash_dash = 0;        /* Saw `--`: read from stdin, rest are script args */`` |
|     - |  372 | `#ifdef PHL_ENABLE_SERVER` |
|  4115 |  373 | `	int server_mode = 0;        /* Start built-in server if TRUE */` |
|  4115 |  374 | `	const char *zServerAddr = 0; /* host:port string */` |
|  4115 |  375 | `	const char *zDocRoot = ".";  /* Document root */` |
|     - |  376 | `#endif` |
|     - |  377 | `	int n;              /* Script arguments */` |
|     - |  378 | `	int rc;` |
|     - |  379 | `	const char *azIniDefine[64]; /* -d name=value directives, in order */` |
|  4115 |  380 | `	int nIniDefine = 0;` |
|  4115 |  381 | `	const char *zIniFile = 0;    /* -c php.ini path */` |
|     - |  382 | `	/* Process interpreter arguments first*/` |
|  4256 |  383 | `	for(n = 1 ; n < argc ; ++n ){` |
|     - |  384 | `		int c;` |
|  3991 |  385 | `		if( argv[n][0] != '-' ){` |
...
|     - |  550 | `	}` |
|     - |  551 | `#endif` |
|  4084 |  552 | `	if( (n >= argc \|\| dash_dash) && !run_code ){` |
...
|  3638 |  573 | `	rc = ph7_init(&pEngine);` |
|  3638 |  574 | `	if( rc != PH7_OK ){` |
|     - |  575 | `		/*` |
...
|     - |  583 | `	 */` |
|  3638 |  584 | `	ph7_config(pEngine,PH7_CONFIG_ERR_OUTPUT,` |
...
|  3638 |  595 | `		if( PHL_EnvULong("PHL_MAX_ALLOC",65536UL,0xFFFFFFFFUL,&uMax) ){` |
...
|  3638 |  603 | `		if( PHL_EnvULong("PHL_MAX_INPUT",1UL,0xFFFFFFFFUL,&uMax) ){` |
...
|   ! 0 |  666 | `		}` |
|     6 |  667 | `	}else{` |
|  3598 |  668 | `		rc = ph7_compile_file(` |
|  1677 |  669 | `			pEngine, /* PH7 Engine */` |
|  3593 |  670 | `			argv[n], /* Path to the PHP file to compile */` |
|     - |  671 | `			&pVm,    /* OUT: Compiled PHP program */` |
|     - |  672 | `			0        /* IN: Compile flags */` |
|     - |  673 | `			);` |
|  3598 |  674 | `		if( rc != PH7_OK ){ /* Compile error */` |
