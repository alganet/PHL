...
|     - |  185 | ` */` |
| 13152 |  186 | `static int Output_Consumer(const void *pOutput,unsigned int nOutputLen,void *pUserData /* Unused */)` |
|     5 |  187 | `{` |
|  6576 |  188 | `	(void)pUserData;` |
|     - |  189 | `#ifdef __WINNT__` |
|     - |  190 | `	BOOL rc;` |
...
|     - |  196 | `#else` |
|     - |  197 | `	ssize_t nWr;` |
| 13152 |  198 | `	nWr = write(STDOUT_FILENO,pOutput,nOutputLen);` |
| 13152 |  199 | `	if( nWr < 0 ){` |
...
|     - |  215 | ` */` |
| 14468 |  216 | `static int PHL_EnvULong(const char *zName,unsigned long uFloor,unsigned long uCeil,unsigned long *pOut)` |
|     5 |  217 | `{` |
| 14473 |  218 | `	const char *zVal = getenv(zName);` |
| 14473 |  219 | `	char *zEnd = 0;` |
|     - |  220 | `	unsigned long uMax;` |
| 14473 |  221 | `	if( zVal == 0 \|\| zVal[0] == 0 ){` |
| 14459 |  222 | `		return 0;` |
|     - |  223 | `	}` |
...
|     - |  359 | ` */` |
|  4088 |  360 | `int main(int argc,char **argv)` |
|     5 |  361 | `{` |
|     - |  362 | `	ph7 *pEngine; /* PH7 engine */` |
|     - |  363 | `	ph7_vm *pVm;  /* Compiled PHP program */` |
|  4093 |  364 | `	int dump_vm = 0;    /* Dump VM instructions if TRUE */` |
|  4093 |  365 | `	int run_code = 0;    /* Run inline code if TRUE */` |
|  4093 |  366 | `	int lint_mode = 0;   /* Syntax-check only (-l) if TRUE */` |
|  4093 |  367 | `	const char *zRunCode = 0; /* Inline code string */` |
|  4093 |  368 | `	int stdin_code = 0;       /* Execute a script read from stdin if TRUE */` |
|  4093 |  369 | `	char *zStdinCode = 0;     /* Script slurped from stdin */` |
|  4093 |  370 | `	int nStdinCode = 0;       /* Length of the stdin script */` |
|  4093 |  371 | ``	int dash_dash = 0;        /* Saw `--`: read from stdin, rest are script args */`` |
|     - |  372 | `#ifdef PHL_ENABLE_SERVER` |
|  4093 |  373 | `	int server_mode = 0;        /* Start built-in server if TRUE */` |
|  4093 |  374 | `	const char *zServerAddr = 0; /* host:port string */` |
|  4093 |  375 | `	const char *zDocRoot = ".";  /* Document root */` |
|     - |  376 | `#endif` |
|     - |  377 | `	int n;              /* Script arguments */` |
|     - |  378 | `	int rc;` |
|     - |  379 | `	const char *azIniDefine[64]; /* -d name=value directives, in order */` |
|  4093 |  380 | `	int nIniDefine = 0;` |
|  4093 |  381 | `	const char *zIniFile = 0;    /* -c php.ini path */` |
|     - |  382 | `	/* Process interpreter arguments first*/` |
|  4234 |  383 | `	for(n = 1 ; n < argc ; ++n ){` |
|     - |  384 | `		int c;` |
|  3973 |  385 | `		if( argv[n][0] != '-' ){` |
...
|     - |  550 | `	}` |
|     - |  551 | `#endif` |
|  4062 |  552 | `	if( (n >= argc \|\| dash_dash) && !run_code ){` |
...
|  3624 |  573 | `	rc = ph7_init(&pEngine);` |
|  3624 |  574 | `	if( rc != PH7_OK ){` |
|     - |  575 | `		/*` |
...
|     - |  583 | `	 */` |
|  3624 |  584 | `	ph7_config(pEngine,PH7_CONFIG_ERR_OUTPUT,` |
...
|  3624 |  595 | `		if( PHL_EnvULong("PHL_MAX_ALLOC",65536UL,0xFFFFFFFFUL,&uMax) ){` |
...
|  3624 |  603 | `		if( PHL_EnvULong("PHL_MAX_INPUT",1UL,0xFFFFFFFFUL,&uMax) ){` |
...
|   ! 0 |  666 | `		}` |
|     6 |  667 | `	}else{` |
|  3584 |  668 | `		rc = ph7_compile_file(` |
|  1672 |  669 | `			pEngine, /* PH7 Engine */` |
|  3579 |  670 | `			argv[n], /* Path to the PHP file to compile */` |
|     - |  671 | `			&pVm,    /* OUT: Compiled PHP program */` |
|     - |  672 | `			0        /* IN: Compile flags */` |
|     - |  673 | `			);` |
|  3584 |  674 | `		if( rc != PH7_OK ){ /* Compile error */` |
