...
|     - |  162 | ` */` |
|  3390 |  163 | `static const char * PHL_ResolveBinaryPath(const char *zArgv0)` |
|     5 |  164 | `{` |
|     - |  165 | `#ifdef __WINNT__` |
...
|     - |  169 | `	}` |
|     - |  170 | `#else` |
|  3390 |  171 | `	if( realpath(zArgv0,zPhlBinaryPath) != 0 ){` |
|  3390 |  172 | `		return zPhlBinaryPath;` |
|     - |  173 | `	}` |
|     - |  174 | `#endif` |
|   ! 0 |  175 | `	return zArgv0;` |
|  1700 |  176 | `}` |
...
|     - |  185 | ` */` |
| 13882 |  186 | `static int Output_Consumer(const void *pOutput,unsigned int nOutputLen,void *pUserData /* Unused */)` |
|     5 |  187 | `{` |
|  6941 |  188 | `	(void)pUserData;` |
|     - |  189 | `#ifdef __WINNT__` |
|     - |  190 | `	BOOL rc;` |
...
|     - |  196 | `#else` |
|     - |  197 | `	ssize_t nWr;` |
| 13882 |  198 | `	nWr = write(STDOUT_FILENO,pOutput,nOutputLen);` |
| 13882 |  199 | `	if( nWr < 0 ){` |
...
|     - |  215 | ` */` |
| 14424 |  216 | `static int PHL_EnvULong(const char *zName,unsigned long uFloor,unsigned long uCeil,unsigned long *pOut)` |
|     5 |  217 | `{` |
| 14429 |  218 | `	const char *zVal = getenv(zName);` |
| 14429 |  219 | `	char *zEnd = 0;` |
|     - |  220 | `	unsigned long uMax;` |
| 14429 |  221 | `	if( zVal == 0 \|\| zVal[0] == 0 ){` |
| 14415 |  222 | `		return 0;` |
|     - |  223 | `	}` |
...
|     - |  359 | ` */` |
|  4087 |  360 | `int main(int argc,char **argv)` |
|     5 |  361 | `{` |
|     - |  362 | `	ph7 *pEngine; /* PH7 engine */` |
|     - |  363 | `	ph7_vm *pVm;  /* Compiled PHP program */` |
|  4092 |  364 | `	int dump_vm = 0;    /* Dump VM instructions if TRUE */` |
|  4092 |  365 | `	int run_code = 0;    /* Run inline code if TRUE */` |
|  4092 |  366 | `	int lint_mode = 0;   /* Syntax-check only (-l) if TRUE */` |
|  4092 |  367 | `	const char *zRunCode = 0; /* Inline code string */` |
|  4092 |  368 | `	int stdin_code = 0;       /* Execute a script read from stdin if TRUE */` |
|  4092 |  369 | `	char *zStdinCode = 0;     /* Script slurped from stdin */` |
|  4092 |  370 | `	int nStdinCode = 0;       /* Length of the stdin script */` |
|  4092 |  371 | ``	int dash_dash = 0;        /* Saw `--`: read from stdin, rest are script args */`` |
|     - |  372 | `#ifdef PHL_ENABLE_SERVER` |
|  4092 |  373 | `	int server_mode = 0;        /* Start built-in server if TRUE */` |
|  4092 |  374 | `	const char *zServerAddr = 0; /* host:port string */` |
|  4092 |  375 | `	const char *zDocRoot = ".";  /* Document root */` |
|     - |  376 | `#endif` |
|     - |  377 | `	int n;              /* Script arguments */` |
|     - |  378 | `	int rc;` |
|     - |  379 | `	const char *azIniDefine[64]; /* -d name=value directives, in order */` |
|  4092 |  380 | `	int nIniDefine = 0;` |
|  4092 |  381 | `	const char *zIniFile = 0;    /* -c php.ini path */` |
|     - |  382 | `	/* Process interpreter arguments first*/` |
|  4233 |  383 | `	for(n = 1 ; n < argc ; ++n ){` |
|     - |  384 | `		int c;` |
...
|     - |  550 | `	}` |
|     - |  551 | `#endif` |
|  4061 |  552 | `	if( (n >= argc \|\| dash_dash) && !run_code ){` |
...
|  3613 |  573 | `	rc = ph7_init(&pEngine);` |
|  3613 |  574 | `	if( rc != PH7_OK ){` |
|     - |  575 | `		/*` |
...
|     - |  583 | `	 */` |
|  3613 |  584 | `	ph7_config(pEngine,PH7_CONFIG_ERR_OUTPUT,` |
...
|  3613 |  595 | `		if( PHL_EnvULong("PHL_MAX_ALLOC",65536UL,0xFFFFFFFFUL,&uMax) ){` |
...
|  3613 |  603 | `		if( PHL_EnvULong("PHL_MAX_INPUT",1UL,0xFFFFFFFFUL,&uMax) ){` |
...
|   ! 0 |  666 | `		}` |
|     6 |  667 | `	}else{` |
|  3573 |  668 | `		rc = ph7_compile_file(` |
|  1664 |  669 | `			pEngine, /* PH7 Engine */` |
|  3568 |  670 | `			argv[n], /* Path to the PHP file to compile */` |
|     - |  671 | `			&pVm,    /* OUT: Compiled PHP program */` |
|     - |  672 | `			0        /* IN: Compile flags */` |
|     - |  673 | `			);` |
|  3573 |  674 | `		if( rc != PH7_OK ){ /* Compile error */` |
...
|  3369 |  709 | `		if( PHL_EnvULong("PHL_MAX_RECURSION",1UL,0x7FFFFFFFUL,&uMax) ){` |
|     5 |  710 | `			ph7_vm_config(pVm,PH7_VM_CONFIG_RECURSION_DEPTH,(int)uMax);` |
|     2 |  711 | `		}` |
|  3369 |  712 | `		if( PHL_EnvULong("PHL_MAX_NATIVE_DEPTH",2UL,0x7FFFFFFFUL,&uMax) ){` |
|    12 |  713 | `			ph7_vm_config(pVm,PH7_VM_CONFIG_NATIVE_DEPTH,(int)uMax);` |
|     5 |  714 | `		}` |
|     - |  715 | `	}` |
|     - |  716 | `	/* Define PHP_BINARY: absolute path of this interpreter */` |
|  5051 |  717 | `	ph7_create_constant(pVm,"PHP_BINARY",PHL_PhpBinaryConst,` |
|  3364 |  718 | `		(void *)PHL_ResolveBinaryPath(argv[0]));` |
...
|     - |  723 | `	 */` |
|     - |  724 | `	{` |
|  3369 |  725 | `		const char *zScriptName = (run_code \|\| stdin_code) ? "Standard input code" : argv[n];` |
|  3369 |  726 | `		int argv_count = 0;` |
|     - |  727 | `		ph7_value *pArgc;` |
...
|  3369 |  731 | `		if( ph7_vm_config(pVm,PH7_VM_CONFIG_ARGV_ENTRY,zScriptName) == PH7_OK ){` |
|  3369 |  732 | `			argv_count++;` |
|  1682 |  733 | `		}` |
...
|  3403 |  736 | `		for( n = (run_code \|\| stdin_code) ? n : n + 1; n < argc ; ++n ){` |
|    39 |  737 | `			if( ph7_vm_config(pVm,PH7_VM_CONFIG_ARGV_ENTRY,argv[n]) == PH7_OK ){` |
|    37 |  738 | `				argv_count++;` |
|    16 |  739 | `			}` |
|    22 |  740 | `		}` |
|     - |  741 | `		/* $argc: a plain integer global equal to count($argv). */` |
|  3369 |  742 | `		pArgc = ph7_new_scalar(pVm);` |
|  3369 |  743 | `		if( pArgc ){` |
|  3369 |  744 | `			ph7_value_int(pArgc,argv_count);` |
|  3369 |  745 | `			ph7_vm_config(pVm,PH7_VM_CONFIG_CREATE_VAR,"argc",pArgc);` |
|  3369 |  746 | `			ph7_release_value(pVm,pArgc);` |
|  1682 |  747 | `		}` |
|     - |  748 | `		/* Mirror $argv/$argc into $_SERVER['argv']/$_SERVER['argc'] (php CLI). */` |
|  3369 |  749 | `		ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ARGV);` |
...
|  3369 |  752 | `		ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ATTR,"SCRIPT_NAME",zScriptName,-1);` |
|  3369 |  753 | `		ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ATTR,"PHP_SELF",zScriptName,-1);` |
|  3369 |  754 | `		ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ATTR,"DOCUMENT_ROOT","",0);` |
|     - |  755 | `		{` |
|     - |  756 | `			char zTime[32];` |
|  3369 |  757 | `			snprintf(zTime,sizeof(zTime),"%ld",(long)time(0));` |
|  3369 |  758 | `			ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ATTR,"REQUEST_TIME",zTime,-1);` |
|     - |  759 | `		}` |
|     - |  760 | `#ifndef __WINNT__` |
|     - |  761 | `		{` |
|     - |  762 | `			char zCwd[PATH_MAX];` |
|  3364 |  763 | `			if( getcwd(zCwd,sizeof(zCwd)) ){` |
|  3364 |  764 | `				ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ATTR,"PWD",zCwd,-1);` |
|  1682 |  765 | `			}` |
|     - |  766 | `		}` |
|     - |  767 | `#endif` |
|     - |  768 | `	}` |
|     - |  769 | `	/* Report script run-time errors (now default behavior) */` |
|  3369 |  770 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_ERR_REPORT);` |
...
|  3369 |  774 | `	if( zIniFile ){` |
|     4 |  775 | `		PHL_LoadIniFile(pVm,zIniFile);` |
|     2 |  776 | `	}` |
|     - |  777 | `	{` |
|     - |  778 | `		int i;` |
|  3419 |  779 | `		for( i = 0 ; i < nIniDefine ; i++ ){` |
...
|     - |  793 | `	 */` |
|     - |  794 | `	{` |
|  3369 |  795 | `		int iExitStatus = 0;` |
|  3369 |  796 | `		ph7_vm_exec(pVm,&iExitStatus);` |
|     - |  797 | `		/* All done, cleanup the mess left behind.` |
|     - |  798 | `		*/` |
|  3369 |  799 | `		ph7_vm_release(pVm);` |
|  3369 |  800 | `		ph7_release(pEngine);` |
|     - |  801 | `		/* Propagate the script exit status (set via exit()/die()) */` |
|  3369 |  802 | `		return iExitStatus;` |
|     - |  803 | `	}` |
|  1702 |  804 | `}` |
|     - |  805 |  |
