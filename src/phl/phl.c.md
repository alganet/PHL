...
|     - |  159 | ` */` |
|  3350 |  160 | `static const char * PHL_ResolveBinaryPath(const char *zArgv0)` |
|     5 |  161 | `{` |
|     - |  162 | `#ifdef __WINNT__` |
...
|     - |  166 | `	}` |
|     - |  167 | `#else` |
|  3350 |  168 | `	if( realpath(zArgv0,zPhlBinaryPath) != 0 ){` |
|  3350 |  169 | `		return zPhlBinaryPath;` |
|     - |  170 | `	}` |
|     - |  171 | `#endif` |
|   ! 0 |  172 | `	return zArgv0;` |
|  1680 |  173 | `}` |
...
|     - |  182 | ` */` |
| 12666 |  183 | `static int Output_Consumer(const void *pOutput,unsigned int nOutputLen,void *pUserData /* Unused */)` |
|     5 |  184 | `{` |
|  6333 |  185 | `	(void)pUserData;` |
|     - |  186 | `#ifdef __WINNT__` |
|     - |  187 | `	BOOL rc;` |
...
|     - |  193 | `#else` |
|     - |  194 | `	ssize_t nWr;` |
| 12666 |  195 | `	nWr = write(STDOUT_FILENO,pOutput,nOutputLen);` |
| 12666 |  196 | `	if( nWr < 0 ){` |
...
|     - |  212 | ` */` |
| 14216 |  213 | `static int PHL_EnvULong(const char *zName,unsigned long uFloor,unsigned long uCeil,unsigned long *pOut)` |
|     5 |  214 | `{` |
| 14221 |  215 | `	const char *zVal = getenv(zName);` |
| 14221 |  216 | `	char *zEnd = 0;` |
|     - |  217 | `	unsigned long uMax;` |
| 14221 |  218 | `	if( zVal == 0 \|\| zVal[0] == 0 ){` |
| 14207 |  219 | `		return 0;` |
|     - |  220 | `	}` |
...
|     - |  316 | ` */` |
|  4021 |  317 | `int main(int argc,char **argv)` |
|     5 |  318 | `{` |
|     - |  319 | `	ph7 *pEngine; /* PH7 engine */` |
|     - |  320 | `	ph7_vm *pVm;  /* Compiled PHP program */` |
|  4026 |  321 | `	int dump_vm = 0;    /* Dump VM instructions if TRUE */` |
|  4026 |  322 | `	int run_code = 0;    /* Run inline code if TRUE */` |
|  4026 |  323 | `	int lint_mode = 0;   /* Syntax-check only (-l) if TRUE */` |
|  4026 |  324 | `	const char *zRunCode = 0; /* Inline code string */` |
|     - |  325 | `#ifdef PHL_ENABLE_SERVER` |
|  4026 |  326 | `	int server_mode = 0;        /* Start built-in server if TRUE */` |
|  4026 |  327 | `	const char *zServerAddr = 0; /* host:port string */` |
|  4026 |  328 | `	const char *zDocRoot = ".";  /* Document root */` |
|     - |  329 | `#endif` |
|     - |  330 | `	int n;              /* Script arguments */` |
|     - |  331 | `	int rc;` |
|     - |  332 | `	const char *azIniDefine[64]; /* -d name=value directives, in order */` |
|  4026 |  333 | `	int nIniDefine = 0;` |
|  4026 |  334 | `	const char *zIniFile = 0;    /* -c php.ini path */` |
|     - |  335 | `	/* Process interpreter arguments first*/` |
|  4123 |  336 | `	for(n = 1 ; n < argc ; ++n ){` |
|     - |  337 | `		int c;` |
|  3871 |  338 | `		if( argv[n][0] != '-' ){` |
...
|  3995 |  502 | `	rc = ph7_init(&pEngine);` |
|  3995 |  503 | `	if( rc != PH7_OK ){` |
|     - |  504 | `		/*` |
...
|     - |  512 | `	 */` |
|  3995 |  513 | `	ph7_config(pEngine,PH7_CONFIG_ERR_OUTPUT,` |
...
|  3995 |  524 | `		if( PHL_EnvULong("PHL_MAX_ALLOC",65536UL,0xFFFFFFFFUL,&uMax) ){` |
...
|  3995 |  532 | `		if( PHL_EnvULong("PHL_MAX_INPUT",1UL,0xFFFFFFFFUL,&uMax) ){` |
...
|   ! 0 |  579 | `		}` |
|   220 |  580 | `	}else{` |
|  3763 |  581 | `		rc = ph7_compile_file(` |
|  1879 |  582 | `			pEngine, /* PH7 Engine */` |
|  3758 |  583 | `			argv[n], /* Path to the PHP file to compile */` |
|     - |  584 | `			&pVm,    /* OUT: Compiled PHP program */` |
|     - |  585 | `			0        /* IN: Compile flags */` |
|     - |  586 | `			);` |
|  3763 |  587 | `		if( rc != PH7_OK ){ /* Compile error */` |
...
|  3329 |  622 | `		if( PHL_EnvULong("PHL_MAX_RECURSION",1UL,0x7FFFFFFFUL,&uMax) ){` |
|     5 |  623 | `			ph7_vm_config(pVm,PH7_VM_CONFIG_RECURSION_DEPTH,(int)uMax);` |
|     2 |  624 | `		}` |
|  3329 |  625 | `		if( PHL_EnvULong("PHL_MAX_NATIVE_DEPTH",2UL,0x7FFFFFFFUL,&uMax) ){` |
|    12 |  626 | `			ph7_vm_config(pVm,PH7_VM_CONFIG_NATIVE_DEPTH,(int)uMax);` |
|     5 |  627 | `		}` |
|     - |  628 | `	}` |
|     - |  629 | `	/* Define PHP_BINARY: absolute path of this interpreter */` |
|  4991 |  630 | `	ph7_create_constant(pVm,"PHP_BINARY",PHL_PhpBinaryConst,` |
|  3324 |  631 | `		(void *)PHL_ResolveBinaryPath(argv[0]));` |
...
|     - |  636 | `	 */` |
|     - |  637 | `	{` |
|  3329 |  638 | `		const char *zScriptName = run_code ? "Standard input code" : argv[n];` |
|  3329 |  639 | `		int argv_count = 0;` |
|     - |  640 | `		ph7_value *pArgc;` |
...
|  3329 |  644 | `		if( ph7_vm_config(pVm,PH7_VM_CONFIG_ARGV_ENTRY,zScriptName) == PH7_OK ){` |
|  3329 |  645 | `			argv_count++;` |
|  1662 |  646 | `		}` |
...
|  3359 |  649 | `		for( n = run_code ? n : n + 1; n < argc ; ++n ){` |
|    35 |  650 | `			if( ph7_vm_config(pVm,PH7_VM_CONFIG_ARGV_ENTRY,argv[n]) == PH7_OK ){` |
|    33 |  651 | `				argv_count++;` |
|    14 |  652 | `			}` |
|    20 |  653 | `		}` |
|     - |  654 | `		/* $argc: a plain integer global equal to count($argv). */` |
|  3329 |  655 | `		pArgc = ph7_new_scalar(pVm);` |
|  3329 |  656 | `		if( pArgc ){` |
|  3329 |  657 | `			ph7_value_int(pArgc,argv_count);` |
|  3329 |  658 | `			ph7_vm_config(pVm,PH7_VM_CONFIG_CREATE_VAR,"argc",pArgc);` |
|  3329 |  659 | `			ph7_release_value(pVm,pArgc);` |
|  1662 |  660 | `		}` |
...
|  3329 |  663 | `		ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ATTR,"SCRIPT_NAME",zScriptName,-1);` |
|  3329 |  664 | `		ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ATTR,"PHP_SELF",zScriptName,-1);` |
|  3329 |  665 | `		ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ATTR,"DOCUMENT_ROOT","",0);` |
|     - |  666 | `		{` |
|     - |  667 | `			char zTime[32];` |
|  3329 |  668 | `			snprintf(zTime,sizeof(zTime),"%ld",(long)time(0));` |
|  3329 |  669 | `			ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ATTR,"REQUEST_TIME",zTime,-1);` |
|     - |  670 | `		}` |
|     - |  671 | `#ifndef __WINNT__` |
|     - |  672 | `		{` |
|     - |  673 | `			char zCwd[PATH_MAX];` |
|  3324 |  674 | `			if( getcwd(zCwd,sizeof(zCwd)) ){` |
|  3324 |  675 | `				ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ATTR,"PWD",zCwd,-1);` |
|  1662 |  676 | `			}` |
|     - |  677 | `		}` |
|     - |  678 | `#endif` |
|     - |  679 | `	}` |
|     - |  680 | `	/* Report script run-time errors (now default behavior) */` |
|  3329 |  681 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_ERR_REPORT);` |
...
|  3329 |  685 | `	if( zIniFile ){` |
|     4 |  686 | `		PHL_LoadIniFile(pVm,zIniFile);` |
|     2 |  687 | `	}` |
|     - |  688 | `	{` |
|     - |  689 | `		int i;` |
|  3337 |  690 | `		for( i = 0 ; i < nIniDefine ; i++ ){` |
...
|     - |  704 | `	 */` |
|     - |  705 | `	{` |
|  3329 |  706 | `		int iExitStatus = 0;` |
|  3329 |  707 | `		ph7_vm_exec(pVm,&iExitStatus);` |
|     - |  708 | `		/* All done, cleanup the mess left behind.` |
|     - |  709 | `		*/` |
|  3329 |  710 | `		ph7_vm_release(pVm);` |
|  3329 |  711 | `		ph7_release(pEngine);` |
|     - |  712 | `		/* Propagate the script exit status (set via exit()/die()) */` |
|  3329 |  713 | `		return iExitStatus;` |
|     - |  714 | `	}` |
|  1682 |  715 | `}` |
|     - |  716 |  |
