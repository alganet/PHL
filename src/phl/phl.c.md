...
|     - |   70 | ` */` |
|   480 |   71 | `static void FatalSilent(void)` |
|     4 |   72 | `{` |
|   484 |   73 | `	ph7_lib_shutdown();` |
|   484 |   74 | `	exit(255);` |
|   ! 0 |   75 | `}` |
|     - |   76 | `/*` |
...
|     - |  162 | ` */` |
|  3400 |  163 | `static const char * PHL_ResolveBinaryPath(const char *zArgv0)` |
|     5 |  164 | `{` |
|     - |  165 | `#ifdef __WINNT__` |
...
|     - |  169 | `	}` |
|     - |  170 | `#else` |
|  3400 |  171 | `	if( realpath(zArgv0,zPhlBinaryPath) != 0 ){` |
|  3400 |  172 | `		return zPhlBinaryPath;` |
|     - |  173 | `	}` |
|     - |  174 | `#endif` |
|   ! 0 |  175 | `	return zArgv0;` |
|  1705 |  176 | `}` |
...
|     - |  185 | ` */` |
| 13642 |  186 | `static int Output_Consumer(const void *pOutput,unsigned int nOutputLen,void *pUserData /* Unused */)` |
|     5 |  187 | `{` |
|  6821 |  188 | `	(void)pUserData;` |
|     - |  189 | `#ifdef __WINNT__` |
|     - |  190 | `	BOOL rc;` |
...
|     - |  196 | `#else` |
|     - |  197 | `	ssize_t nWr;` |
| 13642 |  198 | `	nWr = write(STDOUT_FILENO,pOutput,nOutputLen);` |
| 13642 |  199 | `	if( nWr < 0 ){` |
...
|     - |  215 | ` */` |
| 14464 |  216 | `static int PHL_EnvULong(const char *zName,unsigned long uFloor,unsigned long uCeil,unsigned long *pOut)` |
|     5 |  217 | `{` |
| 14469 |  218 | `	const char *zVal = getenv(zName);` |
| 14469 |  219 | `	char *zEnd = 0;` |
|     - |  220 | `	unsigned long uMax;` |
| 14469 |  221 | `	if( zVal == 0 \|\| zVal[0] == 0 ){` |
| 14455 |  222 | `		return 0;` |
|     - |  223 | `	}` |
...
|    17 |  226 | `	if( zVal[0] == '-' \|\| zVal[0] == '+' ){` |
|   ! 0 |  227 | `		return 0;` |
|     - |  228 | `	}` |
|    17 |  229 | `	errno = 0;` |
|    17 |  230 | `	uMax = strtoul(zVal,&zEnd,10);` |
|    17 |  231 | `	if( errno != 0 \|\| zEnd == zVal \|\| *zEnd != 0 \|\| uMax == 0 ){` |
|   ! 0 |  232 | `		return 0; /* non-numeric, trailing junk, overflow, or zero */` |
|     - |  233 | `	}` |
|    17 |  234 | `	if( uMax < uFloor ){` |
|   ! 0 |  235 | `		uMax = uFloor;` |
|   ! 0 |  236 | `	}` |
|    17 |  237 | `	if( uMax > uCeil ){` |
|   ! 0 |  238 | `		uMax = uCeil;` |
|   ! 0 |  239 | `	}` |
|    17 |  240 | `	*pOut = uMax;` |
|    17 |  241 | `	return 1;` |
...
|     - |  247 | ` */` |
|    58 |  248 | `static void PHL_ApplyIniPair(ph7_vm *pVm,const char *zPair)` |
|     4 |  249 | `{` |
|     - |  250 | `	char zName[128];` |
|     - |  251 | `	char zValue[512];` |
|    62 |  252 | `	const char *zEq = strchr(zPair,'=');` |
|     - |  253 | `	const char *zEnd;` |
|     - |  254 | `	size_t n;` |
|    62 |  255 | `	if( zEq == 0 ){` |
...
|     1 |  258 | `	}` |
|     - |  259 | `	/* name: trim */` |
|    62 |  260 | `	while( *zPair == ' ' \|\| *zPair == '\t' ){ zPair++; }` |
|    62 |  261 | `	zEnd = zEq;` |
|    99 |  262 | `	while( zEnd > zPair && (zEnd[-1] == ' ' \|\| zEnd[-1] == '\t') ){ zEnd--; }` |
|    62 |  263 | `	n = (size_t)(zEnd - zPair);` |
|    62 |  264 | `	if( n == 0 \|\| n >= sizeof(zName) ){` |
|   ! 0 |  265 | `		return;` |
|     - |  266 | `	}` |
|    62 |  267 | `	memcpy(zName,zPair,n);` |
|    62 |  268 | `	zName[n] = 0;` |
|     - |  269 | `	/* value: trim + unquote */` |
|    62 |  270 | `	if( *zEq == '=' ){` |
|    60 |  271 | `		const char *zV = zEq + 1;` |
|     - |  272 | `		const char *zVEnd;` |
|    68 |  273 | `		while( *zV == ' ' \|\| *zV == '\t' ){ zV++; }` |
|    60 |  274 | `		zVEnd = zV + strlen(zV);` |
|    96 |  275 | `		while( zVEnd > zV && (zVEnd[-1] == ' ' \|\| zVEnd[-1] == '\t'` |
|    68 |  276 | `		    \|\| zVEnd[-1] == '\r' \|\| zVEnd[-1] == '\n') ){ zVEnd--; }` |
|    60 |  277 | `		if( zVEnd - zV >= 2 && (zV[0] == '"' \|\| zV[0] == '\'') && zVEnd[-1] == zV[0] ){` |
|     4 |  278 | `			zV++;` |
|     4 |  279 | `			zVEnd--;` |
|     2 |  280 | `		}` |
|    60 |  281 | `		n = (size_t)(zVEnd - zV);` |
|    60 |  282 | `		if( n >= sizeof(zValue) ){` |
|   ! 0 |  283 | `			n = sizeof(zValue) - 1;` |
|   ! 0 |  284 | `		}` |
|    60 |  285 | `		memcpy(zValue,zV,n);` |
|    60 |  286 | `		zValue[n] = 0;` |
|    32 |  287 | `	}else{` |
...
|     2 |  290 | `		zValue[1] = 0;` |
|     - |  291 | `	}` |
|    62 |  292 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_INI_ENTRY,zName,zValue);` |
|    33 |  293 | `}` |
|     - |  294 | `/*` |
...
|     - |  359 | ` */` |
|  4097 |  360 | `int main(int argc,char **argv)` |
|     5 |  361 | `{` |
|     - |  362 | `	ph7 *pEngine; /* PH7 engine */` |
|     - |  363 | `	ph7_vm *pVm;  /* Compiled PHP program */` |
|  4102 |  364 | `	int dump_vm = 0;    /* Dump VM instructions if TRUE */` |
|  4102 |  365 | `	int run_code = 0;    /* Run inline code if TRUE */` |
|  4102 |  366 | `	int lint_mode = 0;   /* Syntax-check only (-l) if TRUE */` |
|  4102 |  367 | `	const char *zRunCode = 0; /* Inline code string */` |
|  4102 |  368 | `	int stdin_code = 0;       /* Execute a script read from stdin if TRUE */` |
|  4102 |  369 | `	char *zStdinCode = 0;     /* Script slurped from stdin */` |
|  4102 |  370 | `	int nStdinCode = 0;       /* Length of the stdin script */` |
|  4102 |  371 | ``	int dash_dash = 0;        /* Saw `--`: read from stdin, rest are script args */`` |
|     - |  372 | `#ifdef PHL_ENABLE_SERVER` |
|  4102 |  373 | `	int server_mode = 0;        /* Start built-in server if TRUE */` |
|  4102 |  374 | `	const char *zServerAddr = 0; /* host:port string */` |
|  4102 |  375 | `	const char *zDocRoot = ".";  /* Document root */` |
|     - |  376 | `#endif` |
|     - |  377 | `	int n;              /* Script arguments */` |
|     - |  378 | `	int rc;` |
|     - |  379 | `	const char *azIniDefine[64]; /* -d name=value directives, in order */` |
|  4102 |  380 | `	int nIniDefine = 0;` |
|  4102 |  381 | `	const char *zIniFile = 0;    /* -c php.ini path */` |
|     - |  382 | `	/* Process interpreter arguments first*/` |
|  4243 |  383 | `	for(n = 1 ; n < argc ; ++n ){` |
|     - |  384 | `		int c;` |
|  3977 |  385 | `		if( argv[n][0] != '-' ){` |
...
|   ! 0 |  506 | `			}` |
|    54 |  507 | `			if( nIniDefine < (int)(sizeof(azIniDefine)/sizeof(azIniDefine[0])) ){` |
|    54 |  508 | `				azIniDefine[nIniDefine++] = argv[++n];` |
|    29 |  509 | `			}else{` |
...
|     - |  550 | `	}` |
|     - |  551 | `#endif` |
|  4071 |  552 | `	if( (n >= argc \|\| dash_dash) && !run_code ){` |
...
|  3623 |  573 | `	rc = ph7_init(&pEngine);` |
|  3623 |  574 | `	if( rc != PH7_OK ){` |
|     - |  575 | `		/*` |
...
|     - |  583 | `	 */` |
|  3623 |  584 | `	ph7_config(pEngine,PH7_CONFIG_ERR_OUTPUT,` |
...
|  3623 |  595 | `		if( PHL_EnvULong("PHL_MAX_ALLOC",65536UL,0xFFFFFFFFUL,&uMax) ){` |
...
|  3623 |  603 | `		if( PHL_EnvULong("PHL_MAX_INPUT",1UL,0xFFFFFFFFUL,&uMax) ){` |
...
|   ! 0 |  666 | `		}` |
|     6 |  667 | `	}else{` |
|  3583 |  668 | `		rc = ph7_compile_file(` |
|  1669 |  669 | `			pEngine, /* PH7 Engine */` |
|  3578 |  670 | `			argv[n], /* Path to the PHP file to compile */` |
|     - |  671 | `			&pVm,    /* OUT: Compiled PHP program */` |
|     - |  672 | `			0        /* IN: Compile flags */` |
|     - |  673 | `			);` |
|  3583 |  674 | `		if( rc != PH7_OK ){ /* Compile error */` |
|   484 |  675 | `			if( rc == PH7_IO_ERR ){` |
|   ! 0 |  676 | `				FatalCode("IO error while opening the target file",1);` |
|   484 |  677 | `			}else if( rc == PH7_VM_ERR ){` |
...
|  3379 |  709 | `		if( PHL_EnvULong("PHL_MAX_RECURSION",1UL,0x7FFFFFFFUL,&uMax) ){` |
|     5 |  710 | `			ph7_vm_config(pVm,PH7_VM_CONFIG_RECURSION_DEPTH,(int)uMax);` |
|     2 |  711 | `		}` |
|  3379 |  712 | `		if( PHL_EnvULong("PHL_MAX_NATIVE_DEPTH",2UL,0x7FFFFFFFUL,&uMax) ){` |
|    12 |  713 | `			ph7_vm_config(pVm,PH7_VM_CONFIG_NATIVE_DEPTH,(int)uMax);` |
|     5 |  714 | `		}` |
|     - |  715 | `	}` |
|     - |  716 | `	/* Define PHP_BINARY: absolute path of this interpreter */` |
|  5066 |  717 | `	ph7_create_constant(pVm,"PHP_BINARY",PHL_PhpBinaryConst,` |
|  3374 |  718 | `		(void *)PHL_ResolveBinaryPath(argv[0]));` |
...
|     - |  723 | `	 */` |
|     - |  724 | `	{` |
|  3379 |  725 | `		const char *zScriptName = (run_code \|\| stdin_code) ? "Standard input code" : argv[n];` |
|  3379 |  726 | `		int argv_count = 0;` |
|     - |  727 | `		ph7_value *pArgc;` |
...
|  3379 |  731 | `		if( ph7_vm_config(pVm,PH7_VM_CONFIG_ARGV_ENTRY,zScriptName) == PH7_OK ){` |
|  3379 |  732 | `			argv_count++;` |
|  1687 |  733 | `		}` |
...
|  3413 |  736 | `		for( n = (run_code \|\| stdin_code) ? n : n + 1; n < argc ; ++n ){` |
|    39 |  737 | `			if( ph7_vm_config(pVm,PH7_VM_CONFIG_ARGV_ENTRY,argv[n]) == PH7_OK ){` |
|    37 |  738 | `				argv_count++;` |
|    16 |  739 | `			}` |
|    22 |  740 | `		}` |
|     - |  741 | `		/* $argc: a plain integer global equal to count($argv). */` |
|  3379 |  742 | `		pArgc = ph7_new_scalar(pVm);` |
|  3379 |  743 | `		if( pArgc ){` |
|  3379 |  744 | `			ph7_value_int(pArgc,argv_count);` |
|  3379 |  745 | `			ph7_vm_config(pVm,PH7_VM_CONFIG_CREATE_VAR,"argc",pArgc);` |
|  3379 |  746 | `			ph7_release_value(pVm,pArgc);` |
|  1687 |  747 | `		}` |
|     - |  748 | `		/* Mirror $argv/$argc into $_SERVER['argv']/$_SERVER['argc'] (php CLI). */` |
|  3379 |  749 | `		ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ARGV);` |
...
|  3379 |  752 | `		ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ATTR,"SCRIPT_NAME",zScriptName,-1);` |
|  3379 |  753 | `		ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ATTR,"PHP_SELF",zScriptName,-1);` |
|  3379 |  754 | `		ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ATTR,"DOCUMENT_ROOT","",0);` |
|     - |  755 | `		{` |
|     - |  756 | `			char zTime[32];` |
|  3379 |  757 | `			snprintf(zTime,sizeof(zTime),"%ld",(long)time(0));` |
|  3379 |  758 | `			ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ATTR,"REQUEST_TIME",zTime,-1);` |
|     - |  759 | `		}` |
|     - |  760 | `#ifndef __WINNT__` |
|     - |  761 | `		{` |
|     - |  762 | `			char zCwd[PATH_MAX];` |
|  3374 |  763 | `			if( getcwd(zCwd,sizeof(zCwd)) ){` |
|  3374 |  764 | `				ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ATTR,"PWD",zCwd,-1);` |
|  1687 |  765 | `			}` |
|     - |  766 | `		}` |
|     - |  767 | `#endif` |
|     - |  768 | `	}` |
|     - |  769 | `	/* Report script run-time errors (now default behavior) */` |
|  3379 |  770 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_ERR_REPORT);` |
...
|  3379 |  774 | `	if( zIniFile ){` |
|     4 |  775 | `		PHL_LoadIniFile(pVm,zIniFile);` |
|     2 |  776 | `	}` |
|     - |  777 | `	{` |
|     - |  778 | `		int i;` |
|  3429 |  779 | `		for( i = 0 ; i < nIniDefine ; i++ ){` |
|    54 |  780 | `			PHL_ApplyIniPair(pVm,azIniDefine[i]);` |
|    29 |  781 | `		}` |
|     - |  782 | `	}` |
|  3379 |  783 | `	if( dump_vm ){` |
...
|     - |  793 | `	 */` |
|     - |  794 | `	{` |
|  3379 |  795 | `		int iExitStatus = 0;` |
|  3379 |  796 | `		ph7_vm_exec(pVm,&iExitStatus);` |
|     - |  797 | `		/* All done, cleanup the mess left behind.` |
|     - |  798 | `		*/` |
|  3379 |  799 | `		ph7_vm_release(pVm);` |
|  3379 |  800 | `		ph7_release(pEngine);` |
|     - |  801 | `		/* Propagate the script exit status (set via exit()/die()) */` |
|  3379 |  802 | `		return iExitStatus;` |
|     - |  803 | `	}` |
|  1707 |  804 | `}` |
|     - |  805 |  |
