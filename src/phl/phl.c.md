...
|    - |  103 | ` */` |
| 8816 |  104 | `static int Output_Consumer(const void *pOutput,unsigned int nOutputLen,void *pUserData /* Unused */)` |
|    2 |  105 |  |
| 4408 |  106 | `	(void)pUserData;` |
|    - |  107 | `#ifdef __WINNT__` |
|    - |  108 | `	BOOL rc;` |
...
|    - |  114 | `#else` |
|    - |  115 | `	ssize_t nWr;` |
| 8816 |  116 | `	nWr = write(STDOUT_FILENO,pOutput,nOutputLen);` |
| 8816 |  117 | `	if( nWr < 0 ){` |
