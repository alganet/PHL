...
|     - |  185 | ` */` |
| 12956 |  186 | `static int Output_Consumer(const void *pOutput,unsigned int nOutputLen,void *pUserData /* Unused */)` |
|     5 |  187 | `{` |
|  6478 |  188 | `	(void)pUserData;` |
|     - |  189 | `#ifdef __WINNT__` |
|     - |  190 | `	BOOL rc;` |
...
|     - |  196 | `#else` |
|     - |  197 | `	ssize_t nWr;` |
| 12956 |  198 | `	nWr = write(STDOUT_FILENO,pOutput,nOutputLen);` |
| 12956 |  199 | `	if( nWr < 0 ){` |
...
|     - |  359 | ` */` |
|  4059 |  360 | `int main(int argc,char **argv)` |
|     5 |  361 | `{` |
|     - |  362 | `	ph7 *pEngine; /* PH7 engine */` |
|     - |  363 | `	ph7_vm *pVm;  /* Compiled PHP program */` |
|  4064 |  364 | `	int dump_vm = 0;    /* Dump VM instructions if TRUE */` |
|  4064 |  365 | `	int run_code = 0;    /* Run inline code if TRUE */` |
|  4064 |  366 | `	int lint_mode = 0;   /* Syntax-check only (-l) if TRUE */` |
|  4064 |  367 | `	const char *zRunCode = 0; /* Inline code string */` |
|  4064 |  368 | `	int stdin_code = 0;       /* Execute a script read from stdin if TRUE */` |
|  4064 |  369 | `	char *zStdinCode = 0;     /* Script slurped from stdin */` |
|  4064 |  370 | `	int nStdinCode = 0;       /* Length of the stdin script */` |
|  4064 |  371 | ``	int dash_dash = 0;        /* Saw `--`: read from stdin, rest are script args */`` |
|     - |  372 | `#ifdef PHL_ENABLE_SERVER` |
|  4064 |  373 | `	int server_mode = 0;        /* Start built-in server if TRUE */` |
|  4064 |  374 | `	const char *zServerAddr = 0; /* host:port string */` |
|  4064 |  375 | `	const char *zDocRoot = ".";  /* Document root */` |
|     - |  376 | `#endif` |
|     - |  377 | `	int n;              /* Script arguments */` |
|     - |  378 | `	int rc;` |
|     - |  379 | `	const char *azIniDefine[64]; /* -d name=value directives, in order */` |
|  4064 |  380 | `	int nIniDefine = 0;` |
|  4064 |  381 | `	const char *zIniFile = 0;    /* -c php.ini path */` |
|     - |  382 | `	/* Process interpreter arguments first*/` |
|  4167 |  383 | `	for(n = 1 ; n < argc ; ++n ){` |
|     - |  384 | `		int c;` |
|  3913 |  385 | `		if( argv[n][0] != '-' ){` |
...
|     - |  550 | `	}` |
|     - |  551 | `#endif` |
|  4033 |  552 | `	if( (n >= argc \|\| dash_dash) && !run_code ){` |
...
|     - |  777 | `	{` |
|     - |  778 | `		int i;` |
|  3389 |  779 | `		for( i = 0 ; i < nIniDefine ; i++ ){` |
