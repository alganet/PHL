...
|    - |  103 | ` */` |
| 8792 |  104 | `static int Output_Consumer(const void *pOutput,unsigned int nOutputLen,void *pUserData /* Unused */)` |
|    2 |  105 |  |
| 4396 |  106 | `	(void)pUserData;` |
|    - |  107 | `#ifdef __WINNT__` |
|    - |  108 | `	BOOL rc;` |
...
|    - |  114 | `#else` |
|    - |  115 | `	ssize_t nWr;` |
| 8792 |  116 | `	nWr = write(STDOUT_FILENO,pOutput,nOutputLen);` |
| 8792 |  117 | `	if( nWr < 0 ){` |
