...
|     - |   70 | ` */` |
|   478 |   71 | `static void FatalSilent(void)` |
|     4 |   72 | `{` |
|   482 |   73 | `	ph7_lib_shutdown();` |
|   482 |   74 | `	exit(255);` |
|   ! 0 |   75 | `}` |
|     - |   76 | `/*` |
...
|     - |  185 | ` */` |
| 13612 |  186 | `static int Output_Consumer(const void *pOutput,unsigned int nOutputLen,void *pUserData /* Unused */)` |
|     5 |  187 | `{` |
|  6806 |  188 | `	(void)pUserData;` |
|     - |  189 | `#ifdef __WINNT__` |
|     - |  190 | `	BOOL rc;` |
...
|     - |  196 | `#else` |
|     - |  197 | `	ssize_t nWr;` |
| 13612 |  198 | `	nWr = write(STDOUT_FILENO,pOutput,nOutputLen);` |
| 13612 |  199 | `	if( nWr < 0 ){` |
...
|     - |  215 | ` */` |
| 14484 |  216 | `static int PHL_EnvULong(const char *zName,unsigned long uFloor,unsigned long uCeil,unsigned long *pOut)` |
|     5 |  217 | `{` |
| 14489 |  218 | `	const char *zVal = getenv(zName);` |
| 14489 |  219 | `	char *zEnd = 0;` |
|     - |  220 | `	unsigned long uMax;` |
| 14489 |  221 | `	if( zVal == 0 \|\| zVal[0] == 0 ){` |
| 14475 |  222 | `		return 0;` |
|     - |  223 | `	}` |
...
|     - |  359 | ` */` |
|  4100 |  360 | `int main(int argc,char **argv)` |
|     5 |  361 | `{` |
|     - |  362 | `	ph7 *pEngine; /* PH7 engine */` |
|     - |  363 | `	ph7_vm *pVm;  /* Compiled PHP program */` |
|  4105 |  364 | `	int dump_vm = 0;    /* Dump VM instructions if TRUE */` |
|  4105 |  365 | `	int run_code = 0;    /* Run inline code if TRUE */` |
|  4105 |  366 | `	int lint_mode = 0;   /* Syntax-check only (-l) if TRUE */` |
|  4105 |  367 | `	const char *zRunCode = 0; /* Inline code string */` |
|  4105 |  368 | `	int stdin_code = 0;       /* Execute a script read from stdin if TRUE */` |
|  4105 |  369 | `	char *zStdinCode = 0;     /* Script slurped from stdin */` |
|  4105 |  370 | `	int nStdinCode = 0;       /* Length of the stdin script */` |
|  4105 |  371 | ``	int dash_dash = 0;        /* Saw `--`: read from stdin, rest are script args */`` |
|     - |  372 | `#ifdef PHL_ENABLE_SERVER` |
|  4105 |  373 | `	int server_mode = 0;        /* Start built-in server if TRUE */` |
|  4105 |  374 | `	const char *zServerAddr = 0; /* host:port string */` |
|  4105 |  375 | `	const char *zDocRoot = ".";  /* Document root */` |
|     - |  376 | `#endif` |
|     - |  377 | `	int n;              /* Script arguments */` |
|     - |  378 | `	int rc;` |
|     - |  379 | `	const char *azIniDefine[64]; /* -d name=value directives, in order */` |
|  4105 |  380 | `	int nIniDefine = 0;` |
|  4105 |  381 | `	const char *zIniFile = 0;    /* -c php.ini path */` |
|     - |  382 | `	/* Process interpreter arguments first*/` |
|  4246 |  383 | `	for(n = 1 ; n < argc ; ++n ){` |
|     - |  384 | `		int c;` |
...
|     - |  550 | `	}` |
|     - |  551 | `#endif` |
|  4074 |  552 | `	if( (n >= argc \|\| dash_dash) && !run_code ){` |
...
|  3628 |  573 | `	rc = ph7_init(&pEngine);` |
|  3628 |  574 | `	if( rc != PH7_OK ){` |
|     - |  575 | `		/*` |
...
|     - |  583 | `	 */` |
|  3628 |  584 | `	ph7_config(pEngine,PH7_CONFIG_ERR_OUTPUT,` |
...
|  3628 |  595 | `		if( PHL_EnvULong("PHL_MAX_ALLOC",65536UL,0xFFFFFFFFUL,&uMax) ){` |
...
|  3628 |  603 | `		if( PHL_EnvULong("PHL_MAX_INPUT",1UL,0xFFFFFFFFUL,&uMax) ){` |
...
|   ! 0 |  666 | `		}` |
|     6 |  667 | `	}else{` |
|  3588 |  668 | `		rc = ph7_compile_file(` |
|  1672 |  669 | `			pEngine, /* PH7 Engine */` |
|  3583 |  670 | `			argv[n], /* Path to the PHP file to compile */` |
|     - |  671 | `			&pVm,    /* OUT: Compiled PHP program */` |
|     - |  672 | `			0        /* IN: Compile flags */` |
|     - |  673 | `			);` |
|  3588 |  674 | `		if( rc != PH7_OK ){ /* Compile error */` |
|   482 |  675 | `			if( rc == PH7_IO_ERR ){` |
|   ! 0 |  676 | `				FatalCode("IO error while opening the target file",1);` |
|   482 |  677 | `			}else if( rc == PH7_VM_ERR ){` |
