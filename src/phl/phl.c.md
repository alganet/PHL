...
|    - |   93 | ` */` |
| 3572 |   94 | `static int Output_Consumer(const void *pOutput,unsigned int nOutputLen,void *pUserData /* Unused */)` |
|    2 |   95 |  |
| 1786 |   96 | `	(void)pUserData;` |
|    - |   97 | `#ifdef __WINNT__` |
|    - |   98 | `	BOOL rc;` |
...
|    - |  104 | `#else` |
|    - |  105 | `	ssize_t nWr;` |
| 3572 |  106 | `	nWr = write(STDOUT_FILENO,pOutput,nOutputLen);` |
| 3572 |  107 | `	if( nWr < 0 ){` |
...
| 3574 |  113 | `	return PH7_OK;` |
| 1788 |  114 |  |
|    - |  115 | `/*` |
|    - |  116 | ` * Main program: Compile and execute the PHP file.` |
|    - |  117 | ` */` |
| 1310 |  118 | `int main(int argc,char **argv)` |
|    2 |  119 |  |
|    - |  120 | `	ph7 *pEngine; /* PH7 engine */` |
|    - |  121 | `	ph7_vm *pVm;  /* Compiled PHP program */` |
| 1312 |  122 | `	int dump_vm = 0;    /* Dump VM instructions if TRUE */` |
| 1312 |  123 | `	int run_code = 0;    /* Run inline code if TRUE */` |
| 1312 |  124 | `	const char *zRunCode = 0; /* Inline code string */` |
|    - |  125 | `	int n;              /* Script arguments */` |
|    - |  126 | `	int rc;` |
|    - |  127 | `	/* Process interpreter arguments first*/` |
| 1324 |  128 | `	for(n = 1 ; n < argc ; ++n ){` |
|    - |  129 | `		int c;` |
| 1194 |  130 | `		if( argv[n][0] != '-' ){` |
...
| 1056 |  176 | `	rc = ph7_init(&pEngine);` |
| 1056 |  177 | `	if( rc != PH7_OK ){` |
|    - |  178 | `		/*` |
...
|  ! 0 |  208 | `		}` |
|    5 |  209 | `	}else{` |
| 1048 |  210 | `		rc = ph7_compile_file(` |
|  458 |  211 | `			pEngine, /* PH7 Engine */` |
| 1046 |  212 | `			argv[n], /* Path to the PHP file to compile */` |
|    - |  213 | `			&pVm,    /* OUT: Compiled PHP program */` |
|    - |  214 | `			0        /* IN: Compile flags */` |
|    - |  215 | `			);` |
| 1048 |  216 | `		if( rc != PH7_OK ){ /* Compile error */` |
...
|    1 |  248 | `		}` |
|    5 |  249 | `	}else{` |
|  922 |  250 | `		for( n = n + 1; n < argc ; ++n ){` |
|    5 |  251 | `			ph7_vm_config(pVm,PH7_VM_CONFIG_ARGV_ENTRY,argv[n]/* Argument value */);` |
|    3 |  252 | `		}` |
|    - |  253 | `	}` |
|    - |  254 | `	/* Report script run-time errors (now default behavior) */` |
|  926 |  255 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_ERR_REPORT);` |
|  926 |  256 | `	if( dump_vm ){` |
...
|    - |  266 | `	 */` |
|  926 |  267 | `	ph7_vm_exec(pVm,0);` |
|    - |  268 | `	/* All done, cleanup the mess left behind.` |
|    - |  269 | `	*/` |
|  922 |  270 | `	ph7_vm_release(pVm);` |
|  922 |  271 | `	ph7_release(pEngine);` |
|  922 |  272 | `	return 0;` |
|    2 |  273 |  |
|    - |  274 |  |
