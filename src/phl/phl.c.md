...
|     - |  182 | ` */` |
| 12752 |  183 | `static int Output_Consumer(const void *pOutput,unsigned int nOutputLen,void *pUserData /* Unused */)` |
|     5 |  184 | `{` |
|  6376 |  185 | `	(void)pUserData;` |
|     - |  186 | `#ifdef __WINNT__` |
|     - |  187 | `	BOOL rc;` |
...
|     - |  193 | `#else` |
|     - |  194 | `	ssize_t nWr;` |
| 12752 |  195 | `	nWr = write(STDOUT_FILENO,pOutput,nOutputLen);` |
| 12752 |  196 | `	if( nWr < 0 ){` |
