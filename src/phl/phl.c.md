...
|    - |  117 | ` */` |
| 1481 |  118 | `int main(int argc,char **argv)` |
|    2 |  119 |  |
|    - |  120 | `	ph7 *pEngine; /* PH7 engine */` |
|    - |  121 | `	ph7_vm *pVm;  /* Compiled PHP program */` |
| 1483 |  122 | `	int dump_vm = 0;    /* Dump VM instructions if TRUE */` |
| 1483 |  123 | `	int run_code = 0;    /* Run inline code if TRUE */` |
| 1483 |  124 | `	const char *zRunCode = 0; /* Inline code string */` |
|    - |  125 | `	int n;              /* Script arguments */` |
|    - |  126 | `	int rc;` |
|    - |  127 | `	/* Process interpreter arguments first*/` |
| 1495 |  128 | `	for(n = 1 ; n < argc ; ++n ){` |
|    - |  129 | `		int c;` |
| 1366 |  130 | `		if( argv[n][0] != '-' ){` |
...
| 1229 |  176 | `	rc = ph7_init(&pEngine);` |
| 1229 |  177 | `	if( rc != PH7_OK ){` |
|    - |  178 | `		/*` |
...
|  ! 0 |  208 | `		}` |
|    5 |  209 | `	}else{` |
| 1221 |  210 | `		rc = ph7_compile_file(` |
|  545 |  211 | `			pEngine, /* PH7 Engine */` |
| 1219 |  212 | `			argv[n], /* Path to the PHP file to compile */` |
|    - |  213 | `			&pVm,    /* OUT: Compiled PHP program */` |
|    - |  214 |  |
|    - |  215 | `			);` |
| 1221 |  216 | `		if( rc != PH7_OK ){ /* Compile error */` |
...
| 1100 |  255 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_ERR_REPORT);` |
| 1100 |  256 | `	if( dump_vm ){` |
...
|    - |  266 | `	 */` |
| 1100 |  267 | `	ph7_vm_exec(pVm,0);` |
|    - |  268 | `	/* All done, cleanup the mess left behind.` |
|    - |  269 | `	*/` |
| 1096 |  270 | `	ph7_vm_release(pVm);` |
| 1096 |  271 | `	ph7_release(pEngine);` |
| 1096 |  272 | `	return 0;` |
|    2 |  273 |  |
|    - |  274 |  |
