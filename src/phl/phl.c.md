...
|    - |  135 | ` */` |
| 8874 |  136 | `static int Output_Consumer(const void *pOutput,unsigned int nOutputLen,void *pUserData /* Unused */)` |
|    2 |  137 |  |
| 4437 |  138 | `	(void)pUserData;` |
|    - |  139 | `#ifdef __WINNT__` |
|    - |  140 | `	BOOL rc;` |
...
|    - |  146 | `#else` |
|    - |  147 | `	ssize_t nWr;` |
| 8874 |  148 | `	nWr = write(STDOUT_FILENO,pOutput,nOutputLen);` |
| 8874 |  149 | `	if( nWr < 0 ){` |
