...
|     - |  162 | ` */` |
| 10078 |  163 | `static int Output_Consumer(const void *pOutput,unsigned int nOutputLen,void *pUserData /* Unused */)` |
|     5 |  164 |  |
|  5039 |  165 | `	(void)pUserData;` |
|     - |  166 | `#ifdef __WINNT__` |
|     - |  167 | `	BOOL rc;` |
...
|     - |  173 | `#else` |
|     - |  174 | `	ssize_t nWr;` |
| 10078 |  175 | `	nWr = write(STDOUT_FILENO,pOutput,nOutputLen);` |
| 10078 |  176 | `	if( nWr < 0 ){` |
