...
|     - |  172 | ` */` |
| 11930 |  173 | `static int Output_Consumer(const void *pOutput,unsigned int nOutputLen,void *pUserData /* Unused */)` |
|     5 |  174 | `{` |
|  5965 |  175 | `	(void)pUserData;` |
|     - |  176 | `#ifdef __WINNT__` |
|     - |  177 | `	BOOL rc;` |
...
|     - |  183 | `#else` |
|     - |  184 | `	ssize_t nWr;` |
| 11930 |  185 | `	nWr = write(STDOUT_FILENO,pOutput,nOutputLen);` |
| 11930 |  186 | `	if( nWr < 0 ){` |
