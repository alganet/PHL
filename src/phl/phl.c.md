...
|     - |  162 | ` */` |
|  3416 |  163 | `static const char * PHL_ResolveBinaryPath(const char *zArgv0)` |
|     5 |  164 | `{` |
|     - |  165 | `#ifdef __WINNT__` |
...
|     - |  169 | `	}` |
|     - |  170 | `#else` |
|  3416 |  171 | `	if( realpath(zArgv0,zPhlBinaryPath) != 0 ){` |
|  3416 |  172 | `		return zPhlBinaryPath;` |
|     - |  173 | `	}` |
|     - |  174 | `#endif` |
|   ! 0 |  175 | `	return zArgv0;` |
|  1713 |  176 | `}` |
...
|     - |  185 | ` */` |
| 13270 |  186 | `static int Output_Consumer(const void *pOutput,unsigned int nOutputLen,void *pUserData /* Unused */)` |
|     5 |  187 | `{` |
|  6635 |  188 | `	(void)pUserData;` |
|     - |  189 | `#ifdef __WINNT__` |
|     - |  190 | `	BOOL rc;` |
...
|     - |  196 | `#else` |
|     - |  197 | `	ssize_t nWr;` |
| 13270 |  198 | `	nWr = write(STDOUT_FILENO,pOutput,nOutputLen);` |
| 13270 |  199 | `	if( nWr < 0 ){` |
...
|     - |  215 | ` */` |
| 14504 |  216 | `static int PHL_EnvULong(const char *zName,unsigned long uFloor,unsigned long uCeil,unsigned long *pOut)` |
|     5 |  217 | `{` |
| 14509 |  218 | `	const char *zVal = getenv(zName);` |
| 14509 |  219 | `	char *zEnd = 0;` |
|     - |  220 | `	unsigned long uMax;` |
| 14509 |  221 | `	if( zVal == 0 \|\| zVal[0] == 0 ){` |
| 14495 |  222 | `		return 0;` |
|     - |  223 | `	}` |
...
|     - |  359 | ` */` |
|  4095 |  360 | `int main(int argc,char **argv)` |
|     5 |  361 | `{` |
|     - |  362 | `	ph7 *pEngine; /* PH7 engine */` |
|     - |  363 | `	ph7_vm *pVm;  /* Compiled PHP program */` |
|  4100 |  364 | `	int dump_vm = 0;    /* Dump VM instructions if TRUE */` |
|  4100 |  365 | `	int run_code = 0;    /* Run inline code if TRUE */` |
|  4100 |  366 | `	int lint_mode = 0;   /* Syntax-check only (-l) if TRUE */` |
|  4100 |  367 | `	const char *zRunCode = 0; /* Inline code string */` |
|  4100 |  368 | `	int stdin_code = 0;       /* Execute a script read from stdin if TRUE */` |
|  4100 |  369 | `	char *zStdinCode = 0;     /* Script slurped from stdin */` |
|  4100 |  370 | `	int nStdinCode = 0;       /* Length of the stdin script */` |
|  4100 |  371 | ``	int dash_dash = 0;        /* Saw `--`: read from stdin, rest are script args */`` |
|     - |  372 | `#ifdef PHL_ENABLE_SERVER` |
|  4100 |  373 | `	int server_mode = 0;        /* Start built-in server if TRUE */` |
|  4100 |  374 | `	const char *zServerAddr = 0; /* host:port string */` |
|  4100 |  375 | `	const char *zDocRoot = ".";  /* Document root */` |
|     - |  376 | `#endif` |
|     - |  377 | `	int n;              /* Script arguments */` |
|     - |  378 | `	int rc;` |
|     - |  379 | `	const char *azIniDefine[64]; /* -d name=value directives, in order */` |
|  4100 |  380 | `	int nIniDefine = 0;` |
|  4100 |  381 | `	const char *zIniFile = 0;    /* -c php.ini path */` |
|     - |  382 | `	/* Process interpreter arguments first*/` |
|  4241 |  383 | `	for(n = 1 ; n < argc ; ++n ){` |
|     - |  384 | `		int c;` |
|  3981 |  385 | `		if( argv[n][0] != '-' ){` |
...
|     - |  550 | `	}` |
|     - |  551 | `#endif` |
|  4069 |  552 | `	if( (n >= argc \|\| dash_dash) && !run_code ){` |
...
|  3633 |  573 | `	rc = ph7_init(&pEngine);` |
|  3633 |  574 | `	if( rc != PH7_OK ){` |
|     - |  575 | `		/*` |
...
|     - |  583 | `	 */` |
|  3633 |  584 | `	ph7_config(pEngine,PH7_CONFIG_ERR_OUTPUT,` |
...
|  3633 |  595 | `		if( PHL_EnvULong("PHL_MAX_ALLOC",65536UL,0xFFFFFFFFUL,&uMax) ){` |
...
|  3633 |  603 | `		if( PHL_EnvULong("PHL_MAX_INPUT",1UL,0xFFFFFFFFUL,&uMax) ){` |
...
|   ! 0 |  666 | `		}` |
|     6 |  667 | `	}else{` |
|  3593 |  668 | `		rc = ph7_compile_file(` |
|  1677 |  669 | `			pEngine, /* PH7 Engine */` |
|  3588 |  670 | `			argv[n], /* Path to the PHP file to compile */` |
|     - |  671 | `			&pVm,    /* OUT: Compiled PHP program */` |
|     - |  672 | `			0        /* IN: Compile flags */` |
|     - |  673 | `			);` |
|  3593 |  674 | `		if( rc != PH7_OK ){ /* Compile error */` |
...
|  3395 |  709 | `		if( PHL_EnvULong("PHL_MAX_RECURSION",1UL,0x7FFFFFFFUL,&uMax) ){` |
|     5 |  710 | `			ph7_vm_config(pVm,PH7_VM_CONFIG_RECURSION_DEPTH,(int)uMax);` |
|     2 |  711 | `		}` |
|  3395 |  712 | `		if( PHL_EnvULong("PHL_MAX_NATIVE_DEPTH",2UL,0x7FFFFFFFUL,&uMax) ){` |
|    12 |  713 | `			ph7_vm_config(pVm,PH7_VM_CONFIG_NATIVE_DEPTH,(int)uMax);` |
|     5 |  714 | `		}` |
|     - |  715 | `	}` |
|     - |  716 | `	/* Define PHP_BINARY: absolute path of this interpreter */` |
|  5090 |  717 | `	ph7_create_constant(pVm,"PHP_BINARY",PHL_PhpBinaryConst,` |
|  3390 |  718 | `		(void *)PHL_ResolveBinaryPath(argv[0]));` |
...
|     - |  723 | `	 */` |
|     - |  724 | `	{` |
|  3395 |  725 | `		const char *zScriptName = (run_code \|\| stdin_code) ? "Standard input code" : argv[n];` |
|  3395 |  726 | `		int argv_count = 0;` |
|     - |  727 | `		ph7_value *pArgc;` |
...
|  3395 |  731 | `		if( ph7_vm_config(pVm,PH7_VM_CONFIG_ARGV_ENTRY,zScriptName) == PH7_OK ){` |
|  3395 |  732 | `			argv_count++;` |
|  1695 |  733 | `		}` |
...
|  3429 |  736 | `		for( n = (run_code \|\| stdin_code) ? n : n + 1; n < argc ; ++n ){` |
|    39 |  737 | `			if( ph7_vm_config(pVm,PH7_VM_CONFIG_ARGV_ENTRY,argv[n]) == PH7_OK ){` |
|    37 |  738 | `				argv_count++;` |
|    16 |  739 | `			}` |
|    22 |  740 | `		}` |
|     - |  741 | `		/* $argc: a plain integer global equal to count($argv). */` |
|  3395 |  742 | `		pArgc = ph7_new_scalar(pVm);` |
|  3395 |  743 | `		if( pArgc ){` |
|  3395 |  744 | `			ph7_value_int(pArgc,argv_count);` |
|  3395 |  745 | `			ph7_vm_config(pVm,PH7_VM_CONFIG_CREATE_VAR,"argc",pArgc);` |
|  3395 |  746 | `			ph7_release_value(pVm,pArgc);` |
|  1695 |  747 | `		}` |
|     - |  748 | `		/* Mirror $argv/$argc into $_SERVER['argv']/$_SERVER['argc'] (php CLI). */` |
|  3395 |  749 | `		ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ARGV);` |
...
|  3395 |  752 | `		ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ATTR,"SCRIPT_NAME",zScriptName,-1);` |
|  3395 |  753 | `		ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ATTR,"PHP_SELF",zScriptName,-1);` |
|  3395 |  754 | `		ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ATTR,"DOCUMENT_ROOT","",0);` |
|     - |  755 | `		{` |
|     - |  756 | `			char zTime[32];` |
|  3395 |  757 | `			snprintf(zTime,sizeof(zTime),"%ld",(long)time(0));` |
|  3395 |  758 | `			ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ATTR,"REQUEST_TIME",zTime,-1);` |
|     - |  759 | `		}` |
|     - |  760 | `#ifndef __WINNT__` |
|     - |  761 | `		{` |
|     - |  762 | `			char zCwd[PATH_MAX];` |
|  3390 |  763 | `			if( getcwd(zCwd,sizeof(zCwd)) ){` |
|  3390 |  764 | `				ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ATTR,"PWD",zCwd,-1);` |
|  1695 |  765 | `			}` |
|     - |  766 | `		}` |
|     - |  767 | `#endif` |
|     - |  768 | `	}` |
|     - |  769 | `	/* Report script run-time errors (now default behavior) */` |
|  3395 |  770 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_ERR_REPORT);` |
...
|  3395 |  774 | `	if( zIniFile ){` |
|     4 |  775 | `		PHL_LoadIniFile(pVm,zIniFile);` |
|     2 |  776 | `	}` |
|     - |  777 | `	{` |
|     - |  778 | `		int i;` |
|  3445 |  779 | `		for( i = 0 ; i < nIniDefine ; i++ ){` |
...
|     - |  793 | `	 */` |
|     - |  794 | `	{` |
|  3395 |  795 | `		int iExitStatus = 0;` |
|  3395 |  796 | `		ph7_vm_exec(pVm,&iExitStatus);` |
|     - |  797 | `		/* All done, cleanup the mess left behind.` |
|     - |  798 | `		*/` |
|  3395 |  799 | `		ph7_vm_release(pVm);` |
|  3395 |  800 | `		ph7_release(pEngine);` |
|     - |  801 | `		/* Propagate the script exit status (set via exit()/die()) */` |
|  3395 |  802 | `		return iExitStatus;` |
|     - |  803 | `	}` |
|  1715 |  804 | `}` |
|     - |  805 |  |
