...
|     - |  182 | ` */` |
| 12854 |  183 | `static int Output_Consumer(const void *pOutput,unsigned int nOutputLen,void *pUserData /* Unused */)` |
|     5 |  184 | `{` |
|  6427 |  185 | `	(void)pUserData;` |
|     - |  186 | `#ifdef __WINNT__` |
|     - |  187 | `	BOOL rc;` |
...
|     - |  193 | `#else` |
|     - |  194 | `	ssize_t nWr;` |
| 12854 |  195 | `	nWr = write(STDOUT_FILENO,pOutput,nOutputLen);` |
| 12854 |  196 | `	if( nWr < 0 ){` |
