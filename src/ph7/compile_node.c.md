...
|        - |  972 | ` */` |
| 21611460 |  973 | `PH7_PRIVATE sxi32 PH7_CompileVariable(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |  974 | `{` |
| 21611465 |  975 | `	sxu32 nLineLocal = pGen->pIn->nLine;` |
|        - |  976 | `	sxi32 iVv;` |
|        - |  977 | `	sxi32 iP1;` |
| 21611465 |  978 | `	sxi32 iP2 = 0; /* 1 = quiet read (isset/empty): a missing variable must not warn */` |
|        - |  979 | `	void *p3;` |
|        - |  980 | `	sxi32 rc;` |
| 21611465 |  981 | `	iVv = -1; /* Variable variable counter */` |
| 43222937 |  982 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) ){` |
| 21611477 |  983 | `		pGen->pIn++;` |
| 21611477 |  984 | `		iVv++;` |
|        5 |  985 | `	}` |
| 21611465 |  986 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_OCB/*'{'*/)) == 0 ){` |
...
|        - |  994 | `	}` |
| 21611465 |  995 | `	p3  = 0;` |
| 21611465 |  996 | `	if( pGen->pIn->nType & PH7_TK_OCB/*'{'*/ ){` |
...
|        - | 1021 | `		SyString *pName;` |
| 21611449 | 1022 | `		char *zName = 0;` |
|        - | 1023 | `		/* Extract variable name */` |
| 21611449 | 1024 | `		pName = &pGen->pIn->sData;` |
|        - | 1025 | `		/* Advance the stream cursor */` |
| 21611449 | 1026 | `		pGen->pIn++;` |
| 21611449 | 1027 | `		pEntry = SyHashGet(&pGen->hVar,(const void *)pName->zString,pName->nByte);` |
| 21611449 | 1028 | `		if( pEntry == 0 ){` |
|        - | 1029 | `			/* Duplicate name */` |
|  1295011 | 1030 | `			zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|  1295011 | 1031 | `			if( zName == 0 ){` |
...
|  1295011 | 1036 | `			SyHashInsert(&pGen->hVar,zName,pName->nByte,zName);` |
|   647508 | 1037 | `		}else{` |
|        - | 1038 | `			/* Name already available */` |
| 20316443 | 1039 | `			zName = (char *)pEntry->pUserData;` |
|        - | 1040 | `		}` |
| 21611449 | 1041 | `		p3 = (void *)zName;` |
|        - | 1042 | `	}` |
| 21611461 | 1043 | `	iP1 = 0;` |
| 21611461 | 1044 | `	if( iCompileFlag & EXPR_FLAG_RDONLY_LOAD ){` |
| 17055237 | 1045 | `		if( (iCompileFlag & EXPR_FLAG_LOAD_IDX_STORE) == 0 ){` |
...
| 21611461 | 1057 | `	if( iCompileFlag & (EXPR_FLAG_LOAD_IDX_ISSET\|EXPR_FLAG_LOAD_IDX_EMPTY\|EXPR_FLAG_QUIET_VAR) ){` |
|   384823 | 1058 | `		iP2 = 1;` |
| 21419052 | 1059 | `	}else if( iCompileFlag & EXPR_FLAG_RMW_LOAD ){` |
...
| 21611461 | 1065 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,iP2,p3,0);` |
| 21611473 | 1066 | `	while( iVv > 0 ){` |
|       13 | 1067 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,iP2,0,0);` |
|       13 | 1068 | `		iVv--;` |
|        1 | 1069 | `	}` |
|        - | 1070 | `	/* Node successfully compiled */` |
| 21611461 | 1071 | `	return SXRET_OK;` |
| 10805735 | 1072 | `}` |
|        - | 1073 | `/*` |
|        - | 1074 | ` * Load a literal.` |
|        - | 1075 | ` */` |
| 14097912 | 1076 | `static sxi32 GenStateLoadLiteral(ph7_gen_state *pGen)` |
|        5 | 1077 | `{` |
| 14097917 | 1078 | `	SyToken *pToken = pGen->pIn;` |
|        - | 1079 | `	ph7_value *pObj;` |
|        - | 1080 | `	SyString *pStr;` |
|        - | 1081 | `	sxu32 nIdx;` |
|        - | 1082 | `	/* Extract token value */` |
| 14097917 | 1083 | `	pStr = &pToken->sData;` |
...
| 14097917 | 1088 | `	if( pToken->nType & PH7_TK_MEMBER_NAME ){` |
|        - | 1089 | `		/* fall through to the plain-string literal path */` |
| 11222690 | 1090 | `	}else if( pStr->nByte == sizeof("NULL") - 1 ){` |
|  1687397 | 1091 | `		if( SyStrnicmp(pStr->zString,"null",sizeof("NULL")-1) == 0 ){` |
|        - | 1092 | `			/* NULL constant are always indexed at 0 */` |
|  1157191 | 1093 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,0,0,0);` |
|  1157191 | 1094 | `			return SXRET_OK;` |
|   530211 | 1095 | `		}else if( SyStrnicmp(pStr->zString,"true",sizeof("TRUE")-1) == 0 ){` |
|        - | 1096 | `			/* TRUE constant are always indexed at 1 */` |
|   358175 | 1097 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,1,0,0);` |
|   358175 | 1098 | `			return SXRET_OK;` |
|        5 | 1099 | `		}` |
|  7539477 | 1100 | `	}else if (pStr->nByte == sizeof("FALSE") - 1 &&` |
|  1586776 | 1101 | `		SyStrnicmp(pStr->zString,"false",sizeof("FALSE")-1) == 0 ){` |
|        - | 1102 | `			/* FALSE constant are always indexed at 2 */` |
|   796107 | 1103 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,2,0,0);` |
|   796107 | 1104 | `			return SXRET_OK;` |
|  6010459 | 1105 | `	}else if(pStr->nByte == sizeof("__LINE__") - 1 &&` |
|   292980 | 1106 | `		SyMemcmp(pStr->zString,"__LINE__",sizeof("__LINE__")-1) == 0 ){` |
|        - | 1107 | `			/* TICKET 1433-004: __LINE__ constant must be resolved at compile time,not run time */` |
|     3893 | 1108 | `			pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|     3893 | 1109 | `			if( pObj == 0 ){` |
|      ! 0 | 1110 | `				PH7_GenCompileError(pGen,E_ERROR,pToken->nLine,"Fatal, PH7 engine is running out of memory");` |
|      ! 0 | 1111 | `				return SXERR_ABORT;` |
|        - | 1112 | `			}` |
|     3893 | 1113 | `			PH7_MemObjInitFromInt(pGen->pVm,pObj,pToken->nLine);` |
|        - | 1114 | `			/* Emit the load constant instruction */` |
|     3893 | 1115 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|     3893 | 1116 | `			return SXRET_OK;` |
|  6004622 | 1117 | `	}else if( (pStr->nByte == sizeof("__FILE__") - 1 &&` |
|   513854 | 1118 | `		SyMemcmp(pStr->zString,"__FILE__",sizeof("__FILE__")-1) == 0) \|\|` |
|  6080877 | 1119 | `		(pStr->nByte == sizeof("__DIR__") - 1 &&` |
|   449514 | 1120 | `		SyMemcmp(pStr->zString,"__DIR__",sizeof("__DIR__")-1) == 0) ){` |
...
|     3987 | 1127 | `			int bDir = (pStr->zString[2] == 'D'); /* __DIR__ vs __FILE__ */` |
|     3987 | 1128 | `			SyString *pFile = (SyString *)SySetPeek(&pGen->pVm->aFiles);` |
|     3987 | 1129 | `			pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|     3987 | 1130 | `			if( pObj == 0 ){` |
|      ! 0 | 1131 | `				PH7_GenCompileError(pGen,E_ERROR,pToken->nLine,"Fatal, PH7 engine is running out of memory");` |
|      ! 0 | 1132 | `				return SXERR_ABORT;` |
|        - | 1133 | `			}` |
|     3987 | 1134 | `			if( pFile && pFile->nByte > 0 ){` |
|      107 | 1135 | `				if( bDir ){` |
...
|       56 | 1145 | `			}else{` |
|        - | 1146 | `				SyString sMem;` |
|     3885 | 1147 | `				SyStringInitFromBuf(&sMem,":MEMORY:",sizeof(":MEMORY:")-1);` |
|     3885 | 1148 | `				PH7_MemObjInitFromString(pGen->pVm,pObj,&sMem);` |
|        - | 1149 | `			}` |
|     3987 | 1150 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|     3987 | 1151 | `			return SXRET_OK;` |
|  5976711 | 1152 | `	}else if( pStr->nByte == sizeof("__NAMESPACE__") - 1 &&` |
|   241224 | 1153 | `		SyMemcmp(pStr->zString,"__NAMESPACE__",sizeof("__NAMESPACE__")-1) == 0 ){` |
...
|  5988578 | 1169 | `	}else if( (pStr->nByte == sizeof("__FUNCTION__") - 1 &&` |
|   428955 | 1170 | `		SyMemcmp(pStr->zString,"__FUNCTION__",sizeof("__FUNCTION__")-1) == 0) \|\|` |
|  6020051 | 1171 | `		(pStr->nByte == sizeof("__METHOD__") - 1 &&` |
|   327940 | 1172 | `		SyMemcmp(pStr->zString,"__METHOD__",sizeof("__METHOD__")-1) == 0) ){` |
...
| 11778573 | 1215 | `	if( SXRET_OK != GenStateFindLiteral(&(*pGen),&pToken->sData,&nIdx) ){` |
|        - | 1216 | `		ph7_value *pLitObj;` |
|        - | 1217 | `		/* Unknown literal,install it in the literal table */` |
|  2427823 | 1218 | `		pLitObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  2427823 | 1219 | `		if( pLitObj == 0 ){` |
|      ! 0 | 1220 | `			PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|      ! 0 | 1221 | `			return SXERR_ABORT;` |
|        - | 1222 | `		}` |
|  2427823 | 1223 | `		PH7_MemObjInitFromString(pGen->pVm,pLitObj,&pToken->sData);` |
|  2427823 | 1224 | `		GenStateInstallLiteral(&(*pGen),pLitObj,nIdx);` |
|  1213909 | 1225 | `	}` |
|        - | 1226 | `	/* Emit the load constant instruction */` |
| 11778573 | 1227 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,1,nIdx,0,0);` |
| 11778573 | 1228 | `	return SXRET_OK;` |
|  7048961 | 1229 | `}` |
|        - | 1230 | `/*` |
...
|        - | 1235 | ` */` |
| 14101882 | 1236 | `static sxi32 GenStateResolveNamespaceLiteral(ph7_gen_state *pGen)` |
|        5 | 1237 | `{` |
|        - | 1238 | `	sxi32 rc;` |
| 14101887 | 1239 | `	if( pGen->pIn >= pGen->pEnd ){` |
|      ! 0 | 1240 | `		return SXRET_OK;` |
|        - | 1241 | `	}` |
|        - | 1242 | `	/* Check if this is a multi-token namespace path */` |
| 14101887 | 1243 | `	if( pGen->pIn < &pGen->pEnd[-1] ){` |
|        - | 1244 | `		/* Multiple tokens: assemble the full path into sWorker */` |
|     3975 | 1245 | `		SyBlob *pWorker = &pGen->sWorker;` |
|     3975 | 1246 | `		int isAbsolute = 0;` |
|     3975 | 1247 | `		SyBlobReset(pWorker);` |
|        - | 1248 | `		/* Check for leading backslash (absolute path) */` |
|     3975 | 1249 | `		if( pGen->pIn->nType & PH7_TK_NSSEP ){` |
|     3953 | 1250 | `			isAbsolute = 1;` |
|     3953 | 1251 | `			pGen->pIn++; /* Skip leading backslash */` |
|     1974 | 1252 | `		}` |
...
|        - | 1258 | `		{` |
|        - | 1259 | `			SyBlob sRaw;` |
|     3975 | 1260 | `			SyBlobInit(&sRaw,&pGen->pVm->sAllocator);` |
|     4139 | 1261 | `			while( pGen->pIn <= &pGen->pEnd[-1] ){` |
|     4139 | 1262 | `				if( pGen->pIn->nType & PH7_TK_NSSEP ){` |
|       86 | 1263 | `					SyBlobAppend(&sRaw,"\\",1);` |
|       45 | 1264 | `				}else{` |
|     4057 | 1265 | `					SyBlobAppend(&sRaw,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|        - | 1266 | `				}` |
|     4139 | 1267 | `				if( pGen->pIn == &pGen->pEnd[-1] ){` |
|     3975 | 1268 | `					pGen->pIn++;` |
|     3975 | 1269 | `					break;` |
|        - | 1270 | `				}` |
|      168 | 1271 | `				pGen->pIn++;` |
|        4 | 1272 | `			}` |
|     3975 | 1273 | `			if( isAbsolute ){` |
|     3953 | 1274 | `				SyBlobAppend(pWorker,SyBlobData(&sRaw),SyBlobLength(&sRaw)); /* FQN as written */` |
|     1979 | 1275 | `			}else{` |
...
|        - | 1293 | `				}` |
|        - | 1294 | `			}` |
|     3975 | 1295 | `			SyBlobRelease(&sRaw);` |
|        - | 1296 | `		}` |
|     3975 | 1297 | `		if( SyBlobLength(pWorker) > 0 ){` |
|        - | 1298 | `			ph7_value *pObj;` |
|        - | 1299 | `			SyString sPath;` |
|        - | 1300 | `			sxu32 nIdx;` |
|     3975 | 1301 | `			SyStringInitFromBuf(&sPath,(const char *)SyBlobData(pWorker),SyBlobLength(pWorker));` |
|        - | 1302 | `			/* Install in the literal table */` |
|     3975 | 1303 | `			if( SXRET_OK != GenStateFindLiteral(&(*pGen),&sPath,&nIdx) ){` |
|     3923 | 1304 | `				pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|     3923 | 1305 | `				if( pObj == 0 ){` |
|      ! 0 | 1306 | `					PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|      ! 0 | 1307 | `					return SXERR_ABORT;` |
|        - | 1308 | `				}` |
|     3923 | 1309 | `				PH7_MemObjInitFromString(pGen->pVm,pObj,&sPath);` |
|     3923 | 1310 | `				GenStateInstallLiteral(&(*pGen),pObj,nIdx);` |
|     1959 | 1311 | `			}` |
...
|     5960 | 1315 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,` |
|     1985 | 1316 | `				isAbsolute ? (PH7_LOADC_EXPAND\|PH7_LOADC_ABSOLUTE) : PH7_LOADC_EXPAND,` |
|     1985 | 1317 | `				nIdx,0,0);` |
|     3975 | 1318 | `			return SXRET_OK;` |
|        - | 1319 | `		}` |
|      ! 0 | 1320 | `	}` |
|        - | 1321 | `	/* Single-token literal: load directly */` |
| 14097917 | 1322 | `	rc = GenStateLoadLiteral(&(*pGen));` |
| 14097917 | 1323 | `	return rc;` |
|  7050946 | 1324 | `}` |
|        - | 1325 | `/*` |
...
|      ! 0 | 1340 | `}` |
| 14101882 | 1341 | `PH7_PRIVATE sxi32 PH7_CompileLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 | 1342 | `{` |
|        - | 1343 | `	sxi32 rc;` |
| 14101887 | 1344 | `	rc = GenStateResolveNamespaceLiteral(&(*pGen));` |
| 14101887 | 1345 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 1346 | `		SXUNUSED(iCompileFlag); /* cc warning */` |
|      ! 0 | 1347 | `		return rc;` |
|        - | 1348 | `	}` |
|        - | 1349 | `	/* Node successfully compiled */` |
| 14101887 | 1350 | `	return SXRET_OK;` |
|  7050946 | 1351 | `}` |
|        - | 1352 |  |
