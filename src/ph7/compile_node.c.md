...
|        - |   35 | ` */` |
|      582 |   36 | `PH7_PRIVATE sxi32 PH7_CompileAnnonFunc(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |   37 | `{` |
|      587 |   38 | `	ph7_vm_func *pAnnonFunc = 0; /* Annonymous function body */` |
...
|        - |   42 | `						      */` |
|        - |   43 | `	SyString sName;` |
|      587 |   44 | ``	SyToken *pTokKw = pGen->pIn; /* Attribute-sidecar key: `$f = #[A] function…` trivia`` |
|        - |   45 | `	                              * is keyed to this ['static'] 'function' token */` |
|        - |   46 | `	sxu32 nKwLine;` |
|      587 |   47 | `	sxi32 iFlags = 0;` |
|        - |   48 | `	sxu32 nLen;` |
|        - |   49 | `	sxi32 rc;` |
|      291 |   50 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|        - |   51 |  |
|      587 |   52 | `	nKwLine = pGen->pIn->nLine; /* Line of the 'function' keyword (Reflection getStartLine) */` |
|      582 |   53 | `	if( (pGen->pIn->nType & PH7_TK_KEYWORD)` |
|      587 |   54 | `		&& SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_STATIC ){` |
|        - |   55 | `		/* Static closure: no $this auto-capture, bind refused */` |
|       23 |   56 | `		iFlags \|= VM_FUNC_STATIC_CL;` |
|       23 |   57 | `		pGen->pIn++; /* Jump the 'static' keyword */` |
|       11 |   58 | `	}` |
|      587 |   59 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|      587 |   60 | `	if( pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD) ){` |
|      ! 0 |   61 | `		pGen->pIn++;` |
|      ! 0 |   62 | `	}` |
|        - |   63 | `	/* Generate a unique name */` |
|      587 |   64 | `	nLen = SyBufferFormat(zName,sizeof(zName),"[lambda_%d]",iCnt++);` |
|        - |   65 | `	/* Make sure the generated name is unique */` |
|      587 |   66 | `	while( SyHashGet(&pGen->pVm->hFunction,zName,nLen) != 0 && nLen < sizeof(zName) - 2 ){` |
|      ! 0 |   67 | `		nLen = SyBufferFormat(zName,sizeof(zName),"[lambda_%d]",iCnt++);` |
|      ! 0 |   68 | `	}` |
|      587 |   69 | `	SyStringInitFromBuf(&sName,zName,nLen);` |
|        - |   70 | `	/* Compile the lambda body */` |
|      587 |   71 | `	rc = GenStateCompileFunc(&(*pGen),&sName,iFlags,TRUE,&pAnnonFunc);` |
|      587 |   72 | `	if( rc == SXERR_ABORT ){` |
|      ! 0 |   73 | `		return SXERR_ABORT;` |
|        - |   74 | `	}` |
|      587 |   75 | `	if( pAnnonFunc ){` |
|      587 |   76 | `		pAnnonFunc->nLine = nKwLine;` |
|        - |   77 | ``		/* Expression-position attributes (`$f = #[A] function () {}`): the trivia`` |
|        - |   78 | `		 * sidecar keys them to the closure's first keyword token. */` |
|      587 |   79 | `		if( GenStateCollectParamAttrs(&(*pGen),pTokKw,&pAnnonFunc->aAttrs) == SXERR_ABORT ){` |
...
|      587 |   86 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_CLOSURE,0,0,pAnnonFunc,0);` |
|        - |   87 | `	/* Node successfully compiled */` |
|      587 |   88 | `	return SXRET_OK;` |
|      296 |   89 | `}` |
|        - |   90 | `/*` |
...
|      148 |  111 | `		&& SyMemcmp(zName,"this",sizeof("this")-1) == 0 ){` |
|        9 |  112 | `		return SXRET_OK;` |
|        - |  113 | `	}` |
|      334 |  114 | `	for( n = 0 ; n < nShadow ; n++ ){` |
|      254 |  115 | `		if( SyStringLength(&aShadow[n]) == nByte` |
|      246 |  116 | `			&& SyMemcmp(SyStringData(&aShadow[n]),zName,nByte) == 0 ){` |
|      190 |  117 | `			return SXRET_OK;` |
|        - |  118 | `		}` |
|       36 |  119 | `	}` |
...
|        - |  214 | `	sxu32 nShadow)` |
|        5 |  215 | `{` |
|      573 |  216 | `	SyToken *pScan = pStart;` |
|        - |  217 | `	sxi32 rc;` |
|     3853 |  218 | `	while( pScan < pEnd ){` |
|     3285 |  219 | `		if( pScan->nType & (PH7_TK_DSTR\|PH7_TK_HEREDOC) ){` |
...
|      125 |  228 | `			continue;` |
|        - |  229 | `		}` |
|     3163 |  230 | `		if( pScan->nType & PH7_TK_KEYWORD ){` |
...
|        - |  380 | `			}` |
|        7 |  381 | `		}` |
|     3139 |  382 | `		if( (pScan->nType & PH7_TK_DOLLAR) == 0 ){` |
|     2893 |  383 | `			pScan++;` |
|     2893 |  384 | `			continue;` |
|        - |  385 | `		}` |
|        - |  386 | `		{` |
|        - |  387 | `			/* Walk past variable-variable chains ($$x) to the base name. */` |
|      250 |  388 | `			SyToken *pDollar = pScan;` |
|      369 |  389 | `			while( &pDollar[1] < pEnd` |
|      250 |  390 | `				&& (pDollar[1].nType & PH7_TK_DOLLAR) ){` |
|      ! 0 |  391 | `				pDollar++;` |
|      ! 0 |  392 | `			}` |
|      250 |  393 | `			if( &pDollar[1] >= pEnd ){` |
|      ! 0 |  394 | `				break;` |
|        - |  395 | `			}` |
|      250 |  396 | `			if( (pDollar[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|      ! 0 |  397 | `				pScan = pDollar + 1;` |
|      ! 0 |  398 | `				continue;` |
|        - |  399 | `			}` |
|      373 |  400 | `			rc = GenStateArrowAddCapture(pGen,pFunc,` |
|      246 |  401 | `				pDollar[1].sData.zString,pDollar[1].sData.nByte,` |
|      123 |  402 | `				aShadow,nShadow);` |
|      250 |  403 | `			if( rc == SXERR_ABORT ){` |
|      ! 0 |  404 | `				return SXERR_ABORT;` |
|        - |  405 | `			}` |
|      250 |  406 | `			pScan = pDollar + 2;` |
|        - |  407 | `		}` |
|        4 |  408 | `	}` |
|      573 |  409 | `	return SXRET_OK;` |
|      289 |  410 | `}` |
|        - |  411 | `/*` |
...
|        - |  475 | `	}` |
|      547 |  476 | `	pGen->pIn++; /* Jump '(' */` |
|        - |  477 | `	/* Delimit the parameter list */` |
|      547 |  478 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN,PH7_TK_RPAREN,&pSigEnd);` |
|      547 |  479 | `	if( pSigEnd >= pGen->pEnd ){` |
...
|      545 |  485 | `	pFunc = (ph7_vm_func *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_vm_func));` |
|      545 |  486 | `	if( pFunc == 0 ){` |
...
|      545 |  492 | `	nLen = SyBufferFormat(zName,sizeof(zName),"[lambda_%d]",iCnt++);` |
|      547 |  493 | `	while( SyHashGet(&pGen->pVm->hFunction,zName,nLen) != 0 && nLen < sizeof(zName) - 2 ){` |
|        3 |  494 | `		nLen = SyBufferFormat(zName,sizeof(zName),"[lambda_%d]",iCnt++);` |
|        1 |  495 | `	}` |
|      545 |  496 | `	zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,zName,nLen);` |
|      545 |  497 | `	if( zDup == 0 ){` |
|      ! 0 |  498 | `		PH7_GenCompileError(&(*pGen),E_ERROR,nLine,` |
|        - |  499 | `			"Fatal, PH7 engine is running out of memory");` |
|      ! 0 |  500 | `		return SXERR_ABORT;` |
|        - |  501 | `	}` |
|      545 |  502 | `	PH7_VmInitFuncState(pGen->pVm,pFunc,zDup,nLen,iFlags,0);` |
|        - |  503 | `	/* Reflection getStartLine(): line of the ['static'] 'fn' keyword */` |
|      545 |  504 | `	pFunc->nLine = nLine;` |
|        - |  505 | ``	/* Expression-position attributes (`$f = #[A] fn () => …`) */`` |
|      545 |  506 | `	if( GenStateCollectParamAttrs(&(*pGen),pTokKw,&pFunc->aAttrs) == SXERR_ABORT ){` |
|      ! 0 |  507 | `		return SXERR_ABORT;` |
|        - |  508 | `	}` |
|        - |  509 | `	/* Collect function arguments */` |
|      545 |  510 | `	if( pGen->pIn < pSigEnd ){` |
|      154 |  511 | `		rc = GenStateCollectFuncArgs(pFunc,&(*pGen),pSigEnd,0,0);` |
|      154 |  512 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 |  513 | `			return SXERR_ABORT;` |
|        - |  514 | `		}` |
|       75 |  515 | `	}` |
|        - |  516 | `	/* Point past ')' and parse optional return type */` |
|      545 |  517 | `	pGen->pIn = &pSigEnd[1];` |
|      545 |  518 | `	rc = GenStateParseReturnType(pGen,pFunc);` |
|      545 |  519 | `	if( rc == SXERR_ABORT ){` |
|      ! 0 |  520 | `		return SXERR_ABORT;` |
|      545 |  521 | `	}else if( rc == SXERR_SYNTAX ){` |
|      ! 0 |  522 | `		return SXERR_SYNTAX;` |
|        - |  523 | `	}` |
|        - |  524 | `	/* Expect '=>' */` |
|      545 |  525 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ARRAY_OP) == 0 ){` |
...
|        - |  535 | `	}` |
|      543 |  536 | `	pGen->pIn++; /* Jump '=>' */` |
|      543 |  537 | `	pBodyStart = pGen->pIn;` |
|      543 |  538 | `	pBodyEnd = pGen->pEnd;` |
...
|      543 |  543 | `	aArgs = (ph7_vm_func_arg *)SySetBasePtr(&pFunc->aArgs);` |
|        - |  544 | `	{` |
|      543 |  545 | `		SyString *aShadow = 0;` |
|      543 |  546 | `		sxu32 nShadow = SySetUsed(&pFunc->aArgs);` |
|      543 |  547 | `		if( nShadow > 0 ){` |
|      152 |  548 | `			aShadow = (SyString *)SyMemBackendPoolAlloc(` |
|      148 |  549 | `				&pGen->pVm->sAllocator,sizeof(SyString) * nShadow);` |
|      152 |  550 | `			if( aShadow == 0 ){` |
|      ! 0 |  551 | `				PH7_GenCompileError(&(*pGen),E_ERROR,nLine,` |
|        - |  552 | `					"Fatal, PH7 engine is running out of memory");` |
|      ! 0 |  553 | `				return SXERR_ABORT;` |
|        - |  554 | `			}` |
|      344 |  555 | `			for( n = 0 ; n < nShadow ; n++ ){` |
|      196 |  556 | `				aShadow[n] = aArgs[n].sName;` |
|      100 |  557 | `			}` |
|       74 |  558 | `		}` |
|      812 |  559 | `		rc = GenStateArrowCaptureScan(pGen,pFunc,pBodyStart,pBodyEnd,` |
|      269 |  560 | `			aShadow,nShadow);` |
|      543 |  561 | `		if( rc == SXERR_ABORT ){` |
...
|      543 |  569 | `	if( !bStatic ){` |
|        - |  570 | `		char *zThisDup;` |
|      535 |  571 | `		zThisDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,"this",sizeof("this")-1);` |
|      535 |  572 | `		if( zThisDup == 0 ){` |
|      ! 0 |  573 | `			PH7_GenCompileError(&(*pGen),E_ERROR,nLine,` |
|        - |  574 | `				"Fatal, PH7 engine is running out of memory");` |
|      ! 0 |  575 | `			return SXERR_ABORT;` |
|        - |  576 | `		}` |
|      535 |  577 | `		SyZero(&sEnv,sizeof(ph7_vm_func_closure_env));` |
|      535 |  578 | `		sEnv.iFlags = VM_FUNC_ARG_IGNORE;` |
|      535 |  579 | `		sEnv.nIdx = SXU32_HIGH;` |
|      535 |  580 | `		PH7_MemObjInit(pGen->pVm,&sEnv.sValue);` |
|      535 |  581 | `		SyStringInitFromBuf(&sEnv.sName,zThisDup,sizeof("this")-1);` |
|      535 |  582 | `		SySetPut(&pFunc->aClosureEnv,(const void *)&sEnv);` |
|      265 |  583 | `	}` |
|        - |  584 | `	/* Arrow functions are always closures */` |
|      543 |  585 | `	pFunc->iFlags \|= VM_FUNC_CLOSURE;` |
|        - |  586 | `	/* Compile the body expression as an implicit return */` |
|      812 |  587 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC,` |
|      269 |  588 | `		PH7_VmInstrLength(pGen->pVm),pFunc,&pBlock);` |
|      543 |  589 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  590 | `		PH7_GenCompileError(&(*pGen),E_ERROR,nLine,` |
|        - |  591 | `			"PH7 engine is running out-of-memory");` |
|      ! 0 |  592 | `		return SXERR_ABORT;` |
|        - |  593 | `	}` |
|      543 |  594 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|      543 |  595 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pFunc->aByteCode);` |
|      543 |  596 | `	pSavedEnd = pGen->pEnd;` |
|      543 |  597 | `	pGen->pIn = pBodyStart;` |
|      543 |  598 | `	pGen->pEnd = pBodyEnd;` |
|      543 |  599 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|      543 |  600 | `	if( rc == SXERR_ABORT ){` |
|      ! 0 |  601 | `		return SXERR_ABORT;` |
|        - |  602 | `	}` |
|        - |  603 | `	/* The cursor stopped just past the body expression */` |
|      543 |  604 | `	pFunc->nEndLine = (pGen->pIn > pBodyStart) ? pGen->pIn[-1].nLine : nLine;` |
...
|      543 |  609 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,(rc != SXERR_EMPTY ? 1 : 0),0,0,0);` |
|      543 |  610 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|      543 |  611 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|      543 |  612 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|      543 |  613 | `	GenStateLeaveBlock(&(*pGen),0);` |
|        - |  614 | `	/* Restore cursors; caller will re-synchronize via the node's pEnd */` |
|      543 |  615 | `	pGen->pIn = pBodyEnd;` |
|      543 |  616 | `	pGen->pEnd = pSavedEnd;` |
|        - |  617 | `	/* Emit the load-closure instruction */` |
|      543 |  618 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_CLOSURE,0,0,pFunc,0);` |
|      543 |  619 | `	return SXRET_OK;` |
|      277 |  620 | `}` |
|        - |  621 | `/*` |
...
|        - |  972 | ` */` |
| 21666972 |  973 | `PH7_PRIVATE sxi32 PH7_CompileVariable(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |  974 | `{` |
| 21666977 |  975 | `	sxu32 nLineLocal = pGen->pIn->nLine;` |
|        - |  976 | `	sxi32 iVv;` |
|        - |  977 | `	sxi32 iP1;` |
| 21666977 |  978 | `	sxi32 iP2 = 0; /* 1 = quiet read (isset/empty): a missing variable must not warn */` |
|        - |  979 | `	void *p3;` |
|        - |  980 | `	sxi32 rc;` |
| 21666977 |  981 | `	iVv = -1; /* Variable variable counter */` |
| 43333961 |  982 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) ){` |
| 21666989 |  983 | `		pGen->pIn++;` |
| 21666989 |  984 | `		iVv++;` |
|        5 |  985 | `	}` |
| 21666977 |  986 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_OCB/*'{'*/)) == 0 ){` |
|        - |  987 | `		/* Invalid variable name */` |
|      ! 0 |  988 | `		rc = PH7_GenSyntaxError(pGen,pGen->pIn < pGen->pEnd ? pGen->pIn : 0,"variable or \"{\" or \"$\"");` |
|      ! 0 |  989 | `		if( rc == SXERR_ABORT ){` |
|        - |  990 | `			/* Error count limit reached,abort immediately */` |
|      ! 0 |  991 | `			return SXERR_ABORT;` |
|        - |  992 | `		}` |
|      ! 0 |  993 | `		return SXRET_OK;` |
|        - |  994 | `	}` |
| 21666977 |  995 | `	p3  = 0;` |
| 21666977 |  996 | `	if( pGen->pIn->nType & PH7_TK_OCB/*'{'*/ ){` |
|        - |  997 | `		/* Dynamic variable creation */` |
|       19 |  998 | `		pGen->pIn++;  /* Jump the open curly */` |
|       19 |  999 | `		pGen->pEnd--; /* Ignore the trailing curly */` |
|       19 | 1000 | `		if( pGen->pIn >= pGen->pEnd ){` |
|        - | 1001 | `			/* Empty expression */` |
|        - | 1002 | `			{` |
|        - | 1003 | `			/* php names the offending token and, for an empty "${}", stops there:` |
|        - | 1004 | `			 * the "expecting" tail only appears when something could still follow. */` |
|        3 | 1005 | `			SyToken *pBad = pGen->pIn < pGen->pEnd ? pGen->pIn : 0;` |
|        3 | 1006 | `			PH7_GenSyntaxError(&(*pGen),pBad,` |
|        1 | 1007 | `				(pBad && (pBad->nType & PH7_TK_CCB)) ? 0 : "variable or \"{\" or \"$\"");` |
|        - | 1008 | `			}` |
|        3 | 1009 | `			return SXRET_OK;` |
|        - | 1010 | `		}` |
|        - | 1011 | `		/* Compile the expression holding the variable name */` |
|       16 | 1012 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|       16 | 1013 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 | 1014 | `			return SXERR_ABORT;` |
|       16 | 1015 | `		}else if( rc == SXERR_EMPTY ){` |
|        3 | 1016 | `			PH7_GenSyntaxError(&(*pGen),pGen->pIn < pGen->pEnd ? pGen->pIn : 0,0);` |
|        3 | 1017 | `			return SXRET_OK;` |
|        - | 1018 | `		}` |
|        7 | 1019 | `	}else{` |
|        - | 1020 | `		SyHashEntry *pEntry;` |
|        - | 1021 | `		SyString *pName;` |
| 21666961 | 1022 | `		char *zName = 0;` |
|        - | 1023 | `		/* Extract variable name */` |
| 21666961 | 1024 | `		pName = &pGen->pIn->sData;` |
|        - | 1025 | `		/* Advance the stream cursor */` |
| 21666961 | 1026 | `		pGen->pIn++;` |
| 21666961 | 1027 | `		pEntry = SyHashGet(&pGen->hVar,(const void *)pName->zString,pName->nByte);` |
| 21666961 | 1028 | `		if( pEntry == 0 ){` |
|        - | 1029 | `			/* Duplicate name */` |
|  1298333 | 1030 | `			zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|  1298333 | 1031 | `			if( zName == 0 ){` |
|      ! 0 | 1032 | `				PH7_GenCompileError(pGen,E_ERROR,nLineLocal,"Fatal, PH7 engine is running out of memory");` |
|      ! 0 | 1033 | `				return SXERR_ABORT;` |
|        - | 1034 | `			}` |
|        - | 1035 | `			/* Install in the hashtable */` |
|  1298333 | 1036 | `			SyHashInsert(&pGen->hVar,zName,pName->nByte,zName);` |
|   649169 | 1037 | `		}else{` |
|        - | 1038 | `			/* Name already available */` |
| 20368633 | 1039 | `			zName = (char *)pEntry->pUserData;` |
|        - | 1040 | `		}` |
| 21666961 | 1041 | `		p3 = (void *)zName;` |
|        - | 1042 | `	}` |
| 21666973 | 1043 | `	iP1 = 0;` |
| 21666973 | 1044 | `	if( iCompileFlag & EXPR_FLAG_RDONLY_LOAD ){` |
| 17099057 | 1045 | `		if( (iCompileFlag & EXPR_FLAG_LOAD_IDX_STORE) == 0 ){` |
|        - | 1046 | `			/* Read-only load.In other words do not create the variable if inexistant */` |
| 11648279 | 1047 | `			iP1 = 1;` |
|  5824137 | 1048 | `		}` |
|  8549526 | 1049 | `	}` |
|        - | 1050 | ``	/* iP2 marks a QUIET read: `isset($x)` / `empty($x)` inspect a variable`` |
|        - | 1051 | `	 * without reading it, so an undefined one must not warn (php stays silent` |
|        - | 1052 | `	 * for both). Every other read of a missing variable warns — see OP_LOAD.` |
|        - | 1053 | `	 * The two flags are cleared before recursing into a subscript's index` |
|        - | 1054 | ``	 * expression, so `isset($a[$i])` still warns for an undefined $i, as php`` |
|        - | 1055 | ``	 * does. Contexts that VIVIFY (assignment targets, `??`, appends) already`` |
|        - | 1056 | `	 * emit iP1 = 0 and never reach the warning. */` |
| 21666973 | 1057 | `	if( iCompileFlag & (EXPR_FLAG_LOAD_IDX_ISSET\|EXPR_FLAG_LOAD_IDX_EMPTY\|EXPR_FLAG_QUIET_VAR) ){` |
|   385791 | 1058 | `		iP2 = 1;` |
| 21474080 | 1059 | `	}else if( iCompileFlag & EXPR_FLAG_RMW_LOAD ){` |
|        - | 1060 | ``		/* Warn-then-create: the read half of `$x++` / `$x .= ...` still needs a`` |
|        - | 1061 | `		 * writable slot, so it cannot use the read-only load above. */` |
|   669875 | 1062 | `		iP2 = 2;` |
|   334935 | 1063 | `	}` |
|        - | 1064 | `	/* Emit the load instruction */` |
| 21666973 | 1065 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,iP2,p3,0);` |
| 21666985 | 1066 | `	while( iVv > 0 ){` |
|       13 | 1067 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,iP2,0,0);` |
|       13 | 1068 | `		iVv--;` |
|        1 | 1069 | `	}` |
|        - | 1070 | `	/* Node successfully compiled */` |
| 21666973 | 1071 | `	return SXRET_OK;` |
| 10833491 | 1072 | `}` |
|        - | 1073 | `/*` |
|        - | 1074 | ` * Load a literal.` |
|        - | 1075 | ` */` |
| 14134100 | 1076 | `static sxi32 GenStateLoadLiteral(ph7_gen_state *pGen)` |
|        5 | 1077 | `{` |
| 14134105 | 1078 | `	SyToken *pToken = pGen->pIn;` |
|        - | 1079 | `	ph7_value *pObj;` |
|        - | 1080 | `	SyString *pStr;` |
|        - | 1081 | `	sxu32 nIdx;` |
|        - | 1082 | `	/* Extract token value */` |
| 14134105 | 1083 | `	pStr = &pToken->sData;` |
|        - | 1084 | `	/* Deal with the reserved literals [i.e: null,false,true,...] first. A reserved` |
|        - | 1085 | `	 * word used as a member NAME (Enum::Null, C::Array, $o->list()) is a plain` |
|        - | 1086 | `	 * identifier — the parser flagged its token so the whole value-folding chain is` |
|        - | 1087 | `	 * skipped and it falls through to the ordinary string-literal emit below. */` |
| 14134105 | 1088 | `	if( pToken->nType & PH7_TK_MEMBER_NAME ){` |
|        - | 1089 | `		/* fall through to the plain-string literal path */` |
| 11251479 | 1090 | `	}else if( pStr->nByte == sizeof("NULL") - 1 ){` |
|  1691735 | 1091 | `		if( SyStrnicmp(pStr->zString,"null",sizeof("NULL")-1) == 0 ){` |
|        - | 1092 | `			/* NULL constant are always indexed at 0 */` |
|  1160171 | 1093 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,0,0,0);` |
|  1160171 | 1094 | `			return SXRET_OK;` |
|   531569 | 1095 | `		}else if( SyStrnicmp(pStr->zString,"true",sizeof("TRUE")-1) == 0 ){` |
|        - | 1096 | `			/* TRUE constant are always indexed at 1 */` |
|   359093 | 1097 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,1,0,0);` |
|   359093 | 1098 | `			return SXRET_OK;` |
|        5 | 1099 | `		}` |
|  7558786 | 1100 | `	}else if (pStr->nByte == sizeof("FALSE") - 1 &&` |
|  1590850 | 1101 | `		SyStrnicmp(pStr->zString,"false",sizeof("FALSE")-1) == 0 ){` |
|        - | 1102 | `			/* FALSE constant are always indexed at 2 */` |
|   798157 | 1103 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,2,0,0);` |
|   798157 | 1104 | `			return SXRET_OK;` |
|  6025830 | 1105 | `	}else if(pStr->nByte == sizeof("__LINE__") - 1 &&` |
|   293718 | 1106 | `		SyMemcmp(pStr->zString,"__LINE__",sizeof("__LINE__")-1) == 0 ){` |
|        - | 1107 | `			/* TICKET 1433-004: __LINE__ constant must be resolved at compile time,not run time */` |
|     3903 | 1108 | `			pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|     3903 | 1109 | `			if( pObj == 0 ){` |
|      ! 0 | 1110 | `				PH7_GenCompileError(pGen,E_ERROR,pToken->nLine,"Fatal, PH7 engine is running out of memory");` |
|      ! 0 | 1111 | `				return SXERR_ABORT;` |
|        - | 1112 | `			}` |
|     3903 | 1113 | `			PH7_MemObjInitFromInt(pGen->pVm,pObj,pToken->nLine);` |
|        - | 1114 | `			/* Emit the load constant instruction */` |
|     3903 | 1115 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|     3903 | 1116 | `			return SXRET_OK;` |
|  6019978 | 1117 | `	}else if( (pStr->nByte == sizeof("__FILE__") - 1 &&` |
|   515153 | 1118 | `		SyMemcmp(pStr->zString,"__FILE__",sizeof("__FILE__")-1) == 0) \|\|` |
|  6096430 | 1119 | `		(pStr->nByte == sizeof("__DIR__") - 1 &&` |
|   450656 | 1120 | `		SyMemcmp(pStr->zString,"__DIR__",sizeof("__DIR__")-1) == 0) ){` |
|        - | 1121 | `			/* __FILE__ / __DIR__ are magic constants resolved at COMPILE time to the` |
|        - | 1122 | `			 * file being compiled (where the token is written), NOT the runtime` |
|        - | 1123 | `			 * execution file. A function defined in a.php reporting __FILE__ must say` |
|        - | 1124 | `			 * a.php even when called from b.php — php semantics, and what Composer's` |
|        - | 1125 | ``			 * autoloader (loadClassLoader's `require __DIR__ . '/ClassLoader.php'`)`` |
|        - | 1126 | `			 * relies on. The runtime-constant path returned the caller's file. */` |
|     3997 | 1127 | `			int bDir = (pStr->zString[2] == 'D'); /* __DIR__ vs __FILE__ */` |
|     3997 | 1128 | `			SyString *pFile = (SyString *)SySetPeek(&pGen->pVm->aFiles);` |
|     3997 | 1129 | `			pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|     3997 | 1130 | `			if( pObj == 0 ){` |
|      ! 0 | 1131 | `				PH7_GenCompileError(pGen,E_ERROR,pToken->nLine,"Fatal, PH7 engine is running out of memory");` |
|      ! 0 | 1132 | `				return SXERR_ABORT;` |
|        - | 1133 | `			}` |
|     3997 | 1134 | `			if( pFile && pFile->nByte > 0 ){` |
|      107 | 1135 | `				if( bDir ){` |
|        - | 1136 | `					const char *zDir;` |
|        - | 1137 | `					int nLen;` |
|        - | 1138 | `					SyString sDir;` |
|       56 | 1139 | `					zDir = PH7_ExtractDirName(pFile->zString,(int)pFile->nByte,&nLen);` |
|       56 | 1140 | `					SyStringInitFromBuf(&sDir,zDir,nLen);` |
|       56 | 1141 | `					PH7_MemObjInitFromString(pGen->pVm,pObj,&sDir);` |
|       30 | 1142 | `				}else{` |
|       55 | 1143 | `					PH7_MemObjInitFromString(pGen->pVm,pObj,pFile);` |
|        - | 1144 | `				}` |
|       56 | 1145 | `			}else{` |
|        - | 1146 | `				SyString sMem;` |
|     3895 | 1147 | `				SyStringInitFromBuf(&sMem,":MEMORY:",sizeof(":MEMORY:")-1);` |
|     3895 | 1148 | `				PH7_MemObjInitFromString(pGen->pVm,pObj,&sMem);` |
|        - | 1149 | `			}` |
|     3997 | 1150 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|     3997 | 1151 | `			return SXRET_OK;` |
|  5992003 | 1152 | `	}else if( pStr->nByte == sizeof("__NAMESPACE__") - 1 &&` |
|   241844 | 1153 | `		SyMemcmp(pStr->zString,"__NAMESPACE__",sizeof("__NAMESPACE__")-1) == 0 ){` |
|        - | 1154 | `			/* __NAMESPACE__ magic constant: resolved at compile time */` |
|        8 | 1155 | `			pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|        8 | 1156 | `			if( pObj == 0 ){` |
|      ! 0 | 1157 | `				PH7_GenCompileError(pGen,E_ERROR,pToken->nLine,"Fatal, PH7 engine is running out of memory");` |
|      ! 0 | 1158 | `				return SXERR_ABORT;` |
|        - | 1159 | `			}` |
|        8 | 1160 | `			if( SyBlobLength(&pGen->sNamespace) > 0 ){` |
|        - | 1161 | `				SyString sNs;` |
|        8 | 1162 | `				SyStringInitFromBuf(&sNs,(const char *)SyBlobData(&pGen->sNamespace),SyBlobLength(&pGen->sNamespace));` |
|        8 | 1163 | `				PH7_MemObjInitFromString(pGen->pVm,pObj,&sNs);` |
|        5 | 1164 | `			}else{` |
|      ! 0 | 1165 | `				PH7_MemObjInitFromString(pGen->pVm,pObj,0);` |
|        - | 1166 | `			}` |
|        8 | 1167 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|        8 | 1168 | `			return SXRET_OK;` |
|  6003900 | 1169 | `	}else if( (pStr->nByte == sizeof("__FUNCTION__") - 1 &&` |
|   430052 | 1170 | `		SyMemcmp(pStr->zString,"__FUNCTION__",sizeof("__FUNCTION__")-1) == 0) \|\|` |
|  6035450 | 1171 | `		(pStr->nByte == sizeof("__METHOD__") - 1 &&` |
|   328774 | 1172 | `		SyMemcmp(pStr->zString,"__METHOD__",sizeof("__METHOD__")-1) == 0) ){` |
|       11 | 1173 | `			GenBlock *pBlock = pGen->pCurrent;` |
|        - | 1174 | `			/* TICKET 1433-004: __FUNCTION__/__METHOD__ constants must be resolved at compile time,not run time */` |
|       21 | 1175 | `			while( pBlock && (pBlock->iFlags & GEN_BLOCK_FUNC) == 0 ){` |
|        - | 1176 | `				/* Point to the upper block */` |
|       11 | 1177 | `				pBlock = pBlock->pParent;` |
|        1 | 1178 | `			}` |
|       11 | 1179 | `			if( pBlock == 0 ){` |
|        - | 1180 | `				/* Called in the global scope,load NULL */` |
|        5 | 1181 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,0,0,0);` |
|        3 | 1182 | `			}else{` |
|        - | 1183 | `				/* Extract the target function/method */` |
|        7 | 1184 | `				ph7_vm_func *pFunc = (ph7_vm_func *)pBlock->pUserData;` |
|        7 | 1185 | `				int bMethod = (pStr->zString[2] == 'M'); /* __METHOD__ vs __FUNCTION__ */` |
|        7 | 1186 | `				pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|        7 | 1187 | `				if( pObj == 0 ){` |
|      ! 0 | 1188 | `					PH7_GenCompileError(pGen,E_ERROR,pToken->nLine,"Fatal, PH7 engine is running out of memory");` |
|      ! 0 | 1189 | `					return SXERR_ABORT;` |
|        - | 1190 | `				}` |
|        - | 1191 | `				/*` |
|        - | 1192 | `				 * __METHOD__ is the QUALIFIED name: "C::m" inside a method, and the plain` |
|        - | 1193 | `				 * function name inside a plain function (php does not answer "" there —` |
|        - | 1194 | `				 * PH7 loaded NULL, so __METHOD__ was empty in every free function and` |
|        - | 1195 | `				 * unqualified in every method).` |
|        - | 1196 | `				 */` |
|        8 | 1197 | `				if( bMethod && (pFunc->iFlags & VM_FUNC_CLASS_METHOD) && pFunc->pUserData ){` |
|        3 | 1198 | `					SyString *pCls = &((ph7_class *)pFunc->pUserData)->sName;` |
|        - | 1199 | `					SyBlob sQual;` |
|        - | 1200 | `					SyString sOut;` |
|        3 | 1201 | `					SyBlobInit(&sQual,&pGen->pVm->sAllocator);` |
|        3 | 1202 | `					SyBlobFormat(&sQual,"%z::%z",pCls,&pFunc->sName);` |
|        3 | 1203 | `					SyStringInitFromBuf(&sOut,SyBlobData(&sQual),SyBlobLength(&sQual));` |
|        3 | 1204 | `					PH7_MemObjInitFromString(pGen->pVm,pObj,&sOut);` |
|        3 | 1205 | `					SyBlobRelease(&sQual);` |
|        2 | 1206 | `				}else{` |
|        5 | 1207 | `					PH7_MemObjInitFromString(pGen->pVm,pObj,&pFunc->sName);` |
|        - | 1208 | `				}` |
|        - | 1209 | `				/* Emit the load constant instruction */` |
|        7 | 1210 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|        - | 1211 | `			}` |
|       11 | 1212 | `			return SXRET_OK;` |
|        - | 1213 | `	}` |
|        - | 1214 | `	/* Query literal table */` |
| 11808793 | 1215 | `	if( SXRET_OK != GenStateFindLiteral(&(*pGen),&pToken->sData,&nIdx) ){` |
|        - | 1216 | `		ph7_value *pLitObj;` |
|        - | 1217 | `		/* Unknown literal,install it in the literal table */` |
|  2434047 | 1218 | `		pLitObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  2434047 | 1219 | `		if( pLitObj == 0 ){` |
|      ! 0 | 1220 | `			PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|      ! 0 | 1221 | `			return SXERR_ABORT;` |
|        - | 1222 | `		}` |
|  2434047 | 1223 | `		PH7_MemObjInitFromString(pGen->pVm,pLitObj,&pToken->sData);` |
|  2434047 | 1224 | `		GenStateInstallLiteral(&(*pGen),pLitObj,nIdx);` |
|  1217021 | 1225 | `	}` |
|        - | 1226 | `	/* Emit the load constant instruction */` |
| 11808793 | 1227 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,1,nIdx,0,0);` |
| 11808793 | 1228 | `	return SXRET_OK;` |
|  7067055 | 1229 | `}` |
|        - | 1230 | `/*` |
|        - | 1231 | ` * Resolve a namespace path or simply load a literal.` |
|        - | 1232 | ` * If the token stream contains namespace separators (backslashes),` |
|        - | 1233 | ` * assemble them into a single literal string (e.g. "Foo\Bar\Baz").` |
|        - | 1234 | ` * Otherwise, load the simple literal directly.` |
|        - | 1235 | ` */` |
| 14138080 | 1236 | `static sxi32 GenStateResolveNamespaceLiteral(ph7_gen_state *pGen)` |
|        5 | 1237 | `{` |
|        - | 1238 | `	sxi32 rc;` |
| 14138085 | 1239 | `	if( pGen->pIn >= pGen->pEnd ){` |
|      ! 0 | 1240 | `		return SXRET_OK;` |
|        - | 1241 | `	}` |
|        - | 1242 | `	/* Check if this is a multi-token namespace path */` |
| 14138085 | 1243 | `	if( pGen->pIn < &pGen->pEnd[-1] ){` |
|        - | 1244 | `		/* Multiple tokens: assemble the full path into sWorker */` |
|     3985 | 1245 | `		SyBlob *pWorker = &pGen->sWorker;` |
|     3985 | 1246 | `		int isAbsolute = 0;` |
|     3985 | 1247 | `		SyBlobReset(pWorker);` |
|        - | 1248 | `		/* Check for leading backslash (absolute path) */` |
|     3985 | 1249 | `		if( pGen->pIn->nType & PH7_TK_NSSEP ){` |
|     3963 | 1250 | `			isAbsolute = 1;` |
|     3963 | 1251 | `			pGen->pIn++; /* Skip leading backslash */` |
|     1979 | 1252 | `		}` |
|        - | 1253 | `		/* Collect the raw path (no prefix yet) so its FIRST segment can be resolved` |
|        - | 1254 | ``		 * against use-imports below — php resolves `A\B\C` by mapping the leading`` |
|        - | 1255 | ``		 * `A` through the imports (`use X\A;` makes it `X\A\B\C`), and only prepends`` |
|        - | 1256 | ``		 * the current namespace when `A` matches no import. Blindly prefixing the`` |
|        - | 1257 | ``		 * namespace here produced e.g. `Ns\Ev\Bus` for `use ...\Event as Ev; Ev\Bus`. */`` |
|        - | 1258 | `		{` |
|        - | 1259 | `			SyBlob sRaw;` |
|     3985 | 1260 | `			SyBlobInit(&sRaw,&pGen->pVm->sAllocator);` |
|     4149 | 1261 | `			while( pGen->pIn <= &pGen->pEnd[-1] ){` |
|     4149 | 1262 | `				if( pGen->pIn->nType & PH7_TK_NSSEP ){` |
|       86 | 1263 | `					SyBlobAppend(&sRaw,"\\",1);` |
|       45 | 1264 | `				}else{` |
|     4067 | 1265 | `					SyBlobAppend(&sRaw,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|        - | 1266 | `				}` |
|     4149 | 1267 | `				if( pGen->pIn == &pGen->pEnd[-1] ){` |
|     3985 | 1268 | `					pGen->pIn++;` |
|     3985 | 1269 | `					break;` |
|        - | 1270 | `				}` |
|      168 | 1271 | `				pGen->pIn++;` |
|        4 | 1272 | `			}` |
|     3985 | 1273 | `			if( isAbsolute ){` |
|     3963 | 1274 | `				SyBlobAppend(pWorker,SyBlobData(&sRaw),SyBlobLength(&sRaw)); /* FQN as written */` |
|     1984 | 1275 | `			}else{` |
|       24 | 1276 | `				const char *zRaw = (const char *)SyBlobData(&sRaw);` |
|       24 | 1277 | `				sxu32 nRaw = SyBlobLength(&sRaw);` |
|       24 | 1278 | `				sxu32 nFirst = 0;` |
|        - | 1279 | `				SyHashEntry *pNsImp;` |
|      108 | 1280 | `				while( nFirst < nRaw && zRaw[nFirst] != '\\' ){ nFirst++; }` |
|       24 | 1281 | `				pNsImp = SyHashGet(&pGen->hUseImports,(const void *)zRaw,nFirst);` |
|       24 | 1282 | `				if( pNsImp ){` |
|        - | 1283 | `					/* Leading segment is an imported alias: substitute its FQN. */` |
|       21 | 1284 | `					const char *zFQN = (const char *)pNsImp->pUserData;` |
|       21 | 1285 | `					SyBlobAppend(pWorker,zFQN,SyStrlen(zFQN));` |
|       21 | 1286 | `					SyBlobAppend(pWorker,zRaw + nFirst,nRaw - nFirst);` |
|       13 | 1287 | `				}else if( SyBlobLength(&pGen->sNamespace) > 0 ){` |
|        3 | 1288 | `					SyBlobAppend(pWorker,SyBlobData(&pGen->sNamespace),SyBlobLength(&pGen->sNamespace));` |
|        3 | 1289 | `					SyBlobAppend(pWorker,"\\",1);` |
|        3 | 1290 | `					SyBlobAppend(pWorker,zRaw,nRaw);` |
|        2 | 1291 | `				}else{` |
|      ! 0 | 1292 | `					SyBlobAppend(pWorker,zRaw,nRaw); /* global scope, no import */` |
|        - | 1293 | `				}` |
|        - | 1294 | `			}` |
|     3985 | 1295 | `			SyBlobRelease(&sRaw);` |
|        - | 1296 | `		}` |
|     3985 | 1297 | `		if( SyBlobLength(pWorker) > 0 ){` |
|        - | 1298 | `			ph7_value *pObj;` |
|        - | 1299 | `			SyString sPath;` |
|        - | 1300 | `			sxu32 nIdx;` |
|     3985 | 1301 | `			SyStringInitFromBuf(&sPath,(const char *)SyBlobData(pWorker),SyBlobLength(pWorker));` |
|        - | 1302 | `			/* Install in the literal table */` |
|     3985 | 1303 | `			if( SXRET_OK != GenStateFindLiteral(&(*pGen),&sPath,&nIdx) ){` |
|     3933 | 1304 | `				pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|     3933 | 1305 | `				if( pObj == 0 ){` |
|      ! 0 | 1306 | `					PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|      ! 0 | 1307 | `					return SXERR_ABORT;` |
|        - | 1308 | `				}` |
|     3933 | 1309 | `				PH7_MemObjInitFromString(pGen->pVm,pObj,&sPath);` |
|     3933 | 1310 | `				GenStateInstallLiteral(&(*pGen),pObj,nIdx);` |
|     1964 | 1311 | `			}` |
|        - | 1312 | `			/* Emit the load constant instruction.` |
|        - | 1313 | `			 * iP1 bit 0 (PH7_LOADC_EXPAND): candidate for constant/function/class expansion.` |
|        - | 1314 | `			 * iP1 bit 1 (PH7_LOADC_ABSOLUTE): fully-qualified; skip namespace prefixing. */` |
|     5975 | 1315 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,` |
|     1990 | 1316 | `				isAbsolute ? (PH7_LOADC_EXPAND\|PH7_LOADC_ABSOLUTE) : PH7_LOADC_EXPAND,` |
|     1990 | 1317 | `				nIdx,0,0);` |
|     3985 | 1318 | `			return SXRET_OK;` |
|        - | 1319 | `		}` |
|      ! 0 | 1320 | `	}` |
|        - | 1321 | `	/* Single-token literal: load directly */` |
| 14134105 | 1322 | `	rc = GenStateLoadLiteral(&(*pGen));` |
| 14134105 | 1323 | `	return rc;` |
|  7069045 | 1324 | `}` |
|        - | 1325 | `/*` |
|        - | 1326 | ` * Compile a literal which is an identifier(name) for a simple value.` |
|        - | 1327 | ` */` |
|        - | 1328 | `/*` |
|        - | 1329 | `` * Compile a first-class-callable marker node `...` (the lone-ellipsis argument list of`` |
|        - | 1330 | `` * `f(...)`). The function-call code generator detects EXPR_NODE_FCC on its single argument`` |
|        - | 1331 | ``  * and emits OP_LOAD_FCC instead of compiling this node, so reaching here means the `...` `` |
|        - | 1332 | ` * appeared outside a call argument list — a syntax error (PHP rejects it likewise).` |
|        - | 1333 | ` */` |
|      ! 0 | 1334 | `PH7_PRIVATE sxi32 PH7_CompileFccMarker(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|      ! 0 | 1335 | `{` |
|      ! 0 | 1336 | `	SXUNUSED(iCompileFlag);` |
|      ! 0 | 1337 | `	PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn ? pGen->pIn->nLine : 0,` |
|        - | 1338 | `		"Cannot use the first-class callable syntax '...' here");` |
|      ! 0 | 1339 | `	return SXERR_SYNTAX;` |
|      ! 0 | 1340 | `}` |
| 14138080 | 1341 | `PH7_PRIVATE sxi32 PH7_CompileLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 | 1342 | `{` |
|        - | 1343 | `	sxi32 rc;` |
| 14138085 | 1344 | `	rc = GenStateResolveNamespaceLiteral(&(*pGen));` |
| 14138085 | 1345 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 1346 | `		SXUNUSED(iCompileFlag); /* cc warning */` |
|      ! 0 | 1347 | `		return rc;` |
|        - | 1348 | `	}` |
|        - | 1349 | `	/* Node successfully compiled */` |
| 14138085 | 1350 | `	return SXRET_OK;` |
|  7069045 | 1351 | `}` |
|        - | 1352 |  |
