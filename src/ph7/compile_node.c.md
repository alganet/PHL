...
|        - |  977 | ` */` |
| 21689586 |  978 | `PH7_PRIVATE sxi32 PH7_CompileVariable(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |  979 | `{` |
| 21689591 |  980 | `	sxu32 nLineLocal = pGen->pIn->nLine;` |
|        - |  981 | `	sxi32 iVv;` |
|        - |  982 | `	sxi32 iP1;` |
| 21689591 |  983 | `	sxi32 iP2 = 0; /* 1 = quiet read (isset/empty): a missing variable must not warn */` |
|        - |  984 | `	void *p3;` |
|        - |  985 | `	sxi32 rc;` |
| 21689591 |  986 | `	iVv = -1; /* Variable variable counter */` |
| 43379189 |  987 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) ){` |
| 21689603 |  988 | `		pGen->pIn++;` |
| 21689603 |  989 | `		iVv++;` |
|        5 |  990 | `	}` |
| 21689591 |  991 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_OCB/*'{'*/)) == 0 ){` |
...
|        - |  999 | `	}` |
| 21689591 | 1000 | `	p3  = 0;` |
| 21689591 | 1001 | `	if( pGen->pIn->nType & PH7_TK_OCB/*'{'*/ ){` |
...
|        - | 1026 | `		SyString *pName;` |
| 21689575 | 1027 | `		char *zName = 0;` |
|        - | 1028 | `		/* Extract variable name */` |
| 21689575 | 1029 | `		pName = &pGen->pIn->sData;` |
|        - | 1030 | `		/* Advance the stream cursor */` |
| 21689575 | 1031 | `		pGen->pIn++;` |
| 21689575 | 1032 | `		pEntry = SyHashGet(&pGen->hVar,(const void *)pName->zString,pName->nByte);` |
| 21689575 | 1033 | `		if( pEntry == 0 ){` |
|        - | 1034 | `			/* Duplicate name */` |
|  1299699 | 1035 | `			zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|  1299699 | 1036 | `			if( zName == 0 ){` |
...
|  1299699 | 1041 | `			SyHashInsert(&pGen->hVar,zName,pName->nByte,zName);` |
|   649852 | 1042 | `		}else{` |
|        - | 1043 | `			/* Name already available */` |
| 20389881 | 1044 | `			zName = (char *)pEntry->pUserData;` |
|        - | 1045 | `		}` |
| 21689575 | 1046 | `		p3 = (void *)zName;` |
|        - | 1047 | `	}` |
| 21689587 | 1048 | `	iP1 = 0;` |
| 21689587 | 1049 | `	if( iCompileFlag & EXPR_FLAG_RDONLY_LOAD ){` |
| 17116823 | 1050 | `		if( (iCompileFlag & EXPR_FLAG_LOAD_IDX_STORE) == 0 ){` |
...
| 21689587 | 1062 | `	if( iCompileFlag & (EXPR_FLAG_LOAD_IDX_ISSET\|EXPR_FLAG_LOAD_IDX_EMPTY\|EXPR_FLAG_QUIET_VAR) ){` |
|   386241 | 1063 | `		iP2 = 1;` |
| 21496469 | 1064 | `	}else if( iCompileFlag & EXPR_FLAG_RMW_LOAD ){` |
...
| 21689587 | 1070 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,iP2,p3,0);` |
| 21689599 | 1071 | `	while( iVv > 0 ){` |
|       13 | 1072 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,iP2,0,0);` |
|       13 | 1073 | `		iVv--;` |
|        1 | 1074 | `	}` |
|        - | 1075 | `	/* Node successfully compiled */` |
| 21689587 | 1076 | `	return SXRET_OK;` |
| 10844798 | 1077 | `}` |
|        - | 1078 | `/*` |
|        - | 1079 | ` * Load a literal.` |
|        - | 1080 | ` */` |
| 14149174 | 1081 | `static sxi32 GenStateLoadLiteral(ph7_gen_state *pGen)` |
|        5 | 1082 | `{` |
| 14149179 | 1083 | `	SyToken *pToken = pGen->pIn;` |
|        - | 1084 | `	ph7_value *pObj;` |
|        - | 1085 | `	SyString *pStr;` |
|        - | 1086 | `	sxu32 nIdx;` |
|        - | 1087 | `	/* Extract token value */` |
| 14149179 | 1088 | `	pStr = &pToken->sData;` |
...
| 14149179 | 1093 | `	if( pToken->nType & PH7_TK_MEMBER_NAME ){` |
|        - | 1094 | `		/* fall through to the plain-string literal path */` |
| 11263557 | 1095 | `	}else if( pStr->nByte == sizeof("NULL") - 1 ){` |
|  1693577 | 1096 | `		if( SyStrnicmp(pStr->zString,"null",sizeof("NULL")-1) == 0 ){` |
|        - | 1097 | `			/* NULL constant are always indexed at 0 */` |
|  1161385 | 1098 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,0,0,0);` |
|  1161385 | 1099 | `			return SXRET_OK;` |
|   532197 | 1100 | `		}else if( SyStrnicmp(pStr->zString,"true",sizeof("TRUE")-1) == 0 ){` |
|        - | 1101 | `			/* TRUE constant are always indexed at 1 */` |
|   359531 | 1102 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,1,0,0);` |
|   359531 | 1103 | `			return SXRET_OK;` |
|        5 | 1104 | `		}` |
|  7566934 | 1105 | `	}else if (pStr->nByte == sizeof("FALSE") - 1 &&` |
|  1592476 | 1106 | `		SyStrnicmp(pStr->zString,"false",sizeof("FALSE")-1) == 0 ){` |
|        - | 1107 | `			/* FALSE constant are always indexed at 2 */` |
|   798939 | 1108 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,2,0,0);` |
|   798939 | 1109 | `			return SXRET_OK;` |
|  6032526 | 1110 | `	}else if(pStr->nByte == sizeof("__LINE__") - 1 &&` |
|   294194 | 1111 | `		SyMemcmp(pStr->zString,"__LINE__",sizeof("__LINE__")-1) == 0 ){` |
|        - | 1112 | `			/* TICKET 1433-004: __LINE__ constant must be resolved at compile time,not run time */` |
|     3907 | 1113 | `			pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|     3907 | 1114 | `			if( pObj == 0 ){` |
|      ! 0 | 1115 | `				PH7_GenCompileError(pGen,E_ERROR,pToken->nLine,"Fatal, PH7 engine is running out of memory");` |
|      ! 0 | 1116 | `				return SXERR_ABORT;` |
|        - | 1117 | `			}` |
|     3907 | 1118 | `			PH7_MemObjInitFromInt(pGen->pVm,pObj,pToken->nLine);` |
|        - | 1119 | `			/* Emit the load constant instruction */` |
|     3907 | 1120 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|     3907 | 1121 | `			return SXRET_OK;` |
|  6026668 | 1122 | `	}else if( (pStr->nByte == sizeof("__FILE__") - 1 &&` |
|   515878 | 1123 | `		SyMemcmp(pStr->zString,"__FILE__",sizeof("__FILE__")-1) == 0) \|\|` |
|  6103131 | 1124 | `		(pStr->nByte == sizeof("__DIR__") - 1 &&` |
|   451162 | 1125 | `		SyMemcmp(pStr->zString,"__DIR__",sizeof("__DIR__")-1) == 0) ){` |
...
|     4003 | 1132 | `			int bDir = (pStr->zString[2] == 'D'); /* __DIR__ vs __FILE__ */` |
|     4003 | 1133 | `			SyString *pFile = (SyString *)SySetPeek(&pGen->pVm->aFiles);` |
|     4003 | 1134 | `			pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|     4003 | 1135 | `			if( pObj == 0 ){` |
|      ! 0 | 1136 | `				PH7_GenCompileError(pGen,E_ERROR,pToken->nLine,"Fatal, PH7 engine is running out of memory");` |
|      ! 0 | 1137 | `				return SXERR_ABORT;` |
|        - | 1138 | `			}` |
|     4003 | 1139 | `			if( pFile && pFile->nByte > 0 ){` |
|      109 | 1140 | `				if( bDir ){` |
...
|       57 | 1150 | `			}else{` |
|        - | 1151 | `				SyString sMem;` |
|     3899 | 1152 | `				SyStringInitFromBuf(&sMem,":MEMORY:",sizeof(":MEMORY:")-1);` |
|     3899 | 1153 | `				PH7_MemObjInitFromString(pGen->pVm,pObj,&sMem);` |
|        - | 1154 | `			}` |
|     4003 | 1155 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|     4003 | 1156 | `			return SXRET_OK;` |
|  5998583 | 1157 | `	}else if( pStr->nByte == sizeof("__NAMESPACE__") - 1 &&` |
|   242108 | 1158 | `		SyMemcmp(pStr->zString,"__NAMESPACE__",sizeof("__NAMESPACE__")-1) == 0 ){` |
...
|  6010498 | 1174 | `	}else if( (pStr->nByte == sizeof("__FUNCTION__") - 1 &&` |
|   430552 | 1175 | `		SyMemcmp(pStr->zString,"__FUNCTION__",sizeof("__FUNCTION__")-1) == 0) \|\|` |
|  6042098 | 1176 | `		(pStr->nByte == sizeof("__METHOD__") - 1 &&` |
|   329174 | 1177 | `		SyMemcmp(pStr->zString,"__METHOD__",sizeof("__METHOD__")-1) == 0) ){` |
...
| 11821423 | 1220 | `	if( SXRET_OK != GenStateFindLiteral(&(*pGen),&pToken->sData,&nIdx) ){` |
|        - | 1221 | `		ph7_value *pLitObj;` |
|        - | 1222 | `		/* Unknown literal,install it in the literal table */` |
|  2436649 | 1223 | `		pLitObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  2436649 | 1224 | `		if( pLitObj == 0 ){` |
|      ! 0 | 1225 | `			PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|      ! 0 | 1226 | `			return SXERR_ABORT;` |
|        - | 1227 | `		}` |
|  2436649 | 1228 | `		PH7_MemObjInitFromString(pGen->pVm,pLitObj,&pToken->sData);` |
|  2436649 | 1229 | `		GenStateInstallLiteral(&(*pGen),pLitObj,nIdx);` |
|  1218322 | 1230 | `	}` |
|        - | 1231 | `	/* Emit the load constant instruction */` |
| 11821423 | 1232 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,1,nIdx,0,0);` |
| 11821423 | 1233 | `	return SXRET_OK;` |
|  7074592 | 1234 | `}` |
|        - | 1235 | `/*` |
...
|        - | 1240 | ` */` |
| 14153158 | 1241 | `static sxi32 GenStateResolveNamespaceLiteral(ph7_gen_state *pGen)` |
|        5 | 1242 | `{` |
|        - | 1243 | `	sxi32 rc;` |
| 14153163 | 1244 | `	if( pGen->pIn >= pGen->pEnd ){` |
|      ! 0 | 1245 | `		return SXRET_OK;` |
|        - | 1246 | `	}` |
|        - | 1247 | `	/* Check if this is a multi-token namespace path */` |
| 14153163 | 1248 | `	if( pGen->pIn < &pGen->pEnd[-1] ){` |
|        - | 1249 | `		/* Multiple tokens: assemble the full path into sWorker */` |
|     3989 | 1250 | `		SyBlob *pWorker = &pGen->sWorker;` |
|     3989 | 1251 | `		int isAbsolute = 0;` |
|     3989 | 1252 | `		SyBlobReset(pWorker);` |
|        - | 1253 | `		/* Check for leading backslash (absolute path) */` |
|     3989 | 1254 | `		if( pGen->pIn->nType & PH7_TK_NSSEP ){` |
|     3967 | 1255 | `			isAbsolute = 1;` |
|     3967 | 1256 | `			pGen->pIn++; /* Skip leading backslash */` |
|     1981 | 1257 | `		}` |
...
|        - | 1263 | `		{` |
|        - | 1264 | `			SyBlob sRaw;` |
|     3989 | 1265 | `			SyBlobInit(&sRaw,&pGen->pVm->sAllocator);` |
|     4153 | 1266 | `			while( pGen->pIn <= &pGen->pEnd[-1] ){` |
|     4153 | 1267 | `				if( pGen->pIn->nType & PH7_TK_NSSEP ){` |
|       87 | 1268 | `					SyBlobAppend(&sRaw,"\\",1);` |
|       46 | 1269 | `				}else{` |
|     4071 | 1270 | `					SyBlobAppend(&sRaw,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|        - | 1271 | `				}` |
|     4153 | 1272 | `				if( pGen->pIn == &pGen->pEnd[-1] ){` |
|     3989 | 1273 | `					pGen->pIn++;` |
|     3989 | 1274 | `					break;` |
|        - | 1275 | `				}` |
|      169 | 1276 | `				pGen->pIn++;` |
|        5 | 1277 | `			}` |
|     3989 | 1278 | `			if( isAbsolute ){` |
|     3967 | 1279 | `				SyBlobAppend(pWorker,SyBlobData(&sRaw),SyBlobLength(&sRaw)); /* FQN as written */` |
|     1986 | 1280 | `			}else{` |
...
|        - | 1298 | `				}` |
|        - | 1299 | `			}` |
|     3989 | 1300 | `			SyBlobRelease(&sRaw);` |
|        - | 1301 | `		}` |
|     3989 | 1302 | `		if( SyBlobLength(pWorker) > 0 ){` |
|        - | 1303 | `			ph7_value *pObj;` |
|        - | 1304 | `			SyString sPath;` |
|        - | 1305 | `			sxu32 nIdx;` |
|     3989 | 1306 | `			SyStringInitFromBuf(&sPath,(const char *)SyBlobData(pWorker),SyBlobLength(pWorker));` |
|        - | 1307 | `			/* Install in the literal table */` |
|     3989 | 1308 | `			if( SXRET_OK != GenStateFindLiteral(&(*pGen),&sPath,&nIdx) ){` |
|     3937 | 1309 | `				pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|     3937 | 1310 | `				if( pObj == 0 ){` |
|      ! 0 | 1311 | `					PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|      ! 0 | 1312 | `					return SXERR_ABORT;` |
|        - | 1313 | `				}` |
|     3937 | 1314 | `				PH7_MemObjInitFromString(pGen->pVm,pObj,&sPath);` |
|     3937 | 1315 | `				GenStateInstallLiteral(&(*pGen),pObj,nIdx);` |
|     1966 | 1316 | `			}` |
...
|     5981 | 1320 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,` |
|     1992 | 1321 | `				isAbsolute ? (PH7_LOADC_EXPAND\|PH7_LOADC_ABSOLUTE) : PH7_LOADC_EXPAND,` |
|     1992 | 1322 | `				nIdx,0,0);` |
|     3989 | 1323 | `			return SXRET_OK;` |
|        - | 1324 | `		}` |
|      ! 0 | 1325 | `	}` |
|        - | 1326 | `	/* Single-token literal: load directly */` |
| 14149179 | 1327 | `	rc = GenStateLoadLiteral(&(*pGen));` |
| 14149179 | 1328 | `	return rc;` |
|  7076584 | 1329 | `}` |
|        - | 1330 | `/*` |
...
|      ! 0 | 1345 | `}` |
| 14153158 | 1346 | `PH7_PRIVATE sxi32 PH7_CompileLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 | 1347 | `{` |
|        - | 1348 | `	sxi32 rc;` |
| 14153163 | 1349 | `	rc = GenStateResolveNamespaceLiteral(&(*pGen));` |
| 14153163 | 1350 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 1351 | `		SXUNUSED(iCompileFlag); /* cc warning */` |
|      ! 0 | 1352 | `		return rc;` |
|        - | 1353 | `	}` |
|        - | 1354 | `	/* Node successfully compiled */` |
| 14153163 | 1355 | `	return SXRET_OK;` |
|  7076584 | 1356 | `}` |
|        - | 1357 |  |
