...
|        - |  972 | ` */` |
| 21611456 |  973 | `PH7_PRIVATE sxi32 PH7_CompileVariable(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |  974 | `{` |
| 21611461 |  975 | `	sxu32 nLineLocal = pGen->pIn->nLine;` |
|        - |  976 | `	sxi32 iVv;` |
|        - |  977 | `	sxi32 iP1;` |
| 21611461 |  978 | `	sxi32 iP2 = 0; /* 1 = quiet read (isset/empty): a missing variable must not warn */` |
|        - |  979 | `	void *p3;` |
|        - |  980 | `	sxi32 rc;` |
| 21611461 |  981 | `	iVv = -1; /* Variable variable counter */` |
| 43222929 |  982 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) ){` |
| 21611473 |  983 | `		pGen->pIn++;` |
| 21611473 |  984 | `		iVv++;` |
|        5 |  985 | `	}` |
| 21611461 |  986 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_OCB/*'{'*/)) == 0 ){` |
...
|        - |  994 | `	}` |
| 21611461 |  995 | `	p3  = 0;` |
| 21611461 |  996 | `	if( pGen->pIn->nType & PH7_TK_OCB/*'{'*/ ){` |
...
|        - | 1021 | `		SyString *pName;` |
| 21611445 | 1022 | `		char *zName = 0;` |
|        - | 1023 | `		/* Extract variable name */` |
| 21611445 | 1024 | `		pName = &pGen->pIn->sData;` |
|        - | 1025 | `		/* Advance the stream cursor */` |
| 21611445 | 1026 | `		pGen->pIn++;` |
| 21611445 | 1027 | `		pEntry = SyHashGet(&pGen->hVar,(const void *)pName->zString,pName->nByte);` |
| 21611445 | 1028 | `		if( pEntry == 0 ){` |
|        - | 1029 | `			/* Duplicate name */` |
...
| 20316439 | 1039 | `			zName = (char *)pEntry->pUserData;` |
|        - | 1040 | `		}` |
| 21611445 | 1041 | `		p3 = (void *)zName;` |
|        - | 1042 | `	}` |
| 21611457 | 1043 | `	iP1 = 0;` |
| 21611457 | 1044 | `	if( iCompileFlag & EXPR_FLAG_RDONLY_LOAD ){` |
| 17055235 | 1045 | `		if( (iCompileFlag & EXPR_FLAG_LOAD_IDX_STORE) == 0 ){` |
...
| 21611457 | 1057 | `	if( iCompileFlag & (EXPR_FLAG_LOAD_IDX_ISSET\|EXPR_FLAG_LOAD_IDX_EMPTY\|EXPR_FLAG_QUIET_VAR) ){` |
|   384823 | 1058 | `		iP2 = 1;` |
| 21419048 | 1059 | `	}else if( iCompileFlag & EXPR_FLAG_RMW_LOAD ){` |
...
| 21611457 | 1065 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,iP2,p3,0);` |
| 21611469 | 1066 | `	while( iVv > 0 ){` |
|       13 | 1067 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,iP2,0,0);` |
|       13 | 1068 | `		iVv--;` |
|        1 | 1069 | `	}` |
|        - | 1070 | `	/* Node successfully compiled */` |
| 21611457 | 1071 | `	return SXRET_OK;` |
| 10805733 | 1072 | `}` |
|        - | 1073 | `/*` |
|        - | 1074 | ` * Load a literal.` |
|        - | 1075 | ` */` |
| 14097910 | 1076 | `static sxi32 GenStateLoadLiteral(ph7_gen_state *pGen)` |
|        5 | 1077 | `{` |
| 14097915 | 1078 | `	SyToken *pToken = pGen->pIn;` |
|        - | 1079 | `	ph7_value *pObj;` |
|        - | 1080 | `	SyString *pStr;` |
|        - | 1081 | `	sxu32 nIdx;` |
|        - | 1082 | `	/* Extract token value */` |
| 14097915 | 1083 | `	pStr = &pToken->sData;` |
...
| 14097915 | 1088 | `	if( pToken->nType & PH7_TK_MEMBER_NAME ){` |
|        - | 1089 | `		/* fall through to the plain-string literal path */` |
| 11222689 | 1090 | `	}else if( pStr->nByte == sizeof("NULL") - 1 ){` |
...
| 11778571 | 1215 | `	if( SXRET_OK != GenStateFindLiteral(&(*pGen),&pToken->sData,&nIdx) ){` |
...
| 11778571 | 1227 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,1,nIdx,0,0);` |
| 11778571 | 1228 | `	return SXRET_OK;` |
|  7048960 | 1229 | `}` |
|        - | 1230 | `/*` |
...
|        - | 1235 | ` */` |
| 14101880 | 1236 | `static sxi32 GenStateResolveNamespaceLiteral(ph7_gen_state *pGen)` |
|        5 | 1237 | `{` |
|        - | 1238 | `	sxi32 rc;` |
| 14101885 | 1239 | `	if( pGen->pIn >= pGen->pEnd ){` |
|      ! 0 | 1240 | `		return SXRET_OK;` |
|        - | 1241 | `	}` |
|        - | 1242 | `	/* Check if this is a multi-token namespace path */` |
| 14101885 | 1243 | `	if( pGen->pIn < &pGen->pEnd[-1] ){` |
...
| 14097915 | 1322 | `	rc = GenStateLoadLiteral(&(*pGen));` |
| 14097915 | 1323 | `	return rc;` |
|  7050945 | 1324 | `}` |
|        - | 1325 | `/*` |
...
|      ! 0 | 1340 | `}` |
| 14101880 | 1341 | `PH7_PRIVATE sxi32 PH7_CompileLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 | 1342 | `{` |
|        - | 1343 | `	sxi32 rc;` |
| 14101885 | 1344 | `	rc = GenStateResolveNamespaceLiteral(&(*pGen));` |
| 14101885 | 1345 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 1346 | `		SXUNUSED(iCompileFlag); /* cc warning */` |
|      ! 0 | 1347 | `		return rc;` |
|        - | 1348 | `	}` |
|        - | 1349 | `	/* Node successfully compiled */` |
| 14101885 | 1350 | `	return SXRET_OK;` |
|  7050945 | 1351 | `}` |
|        - | 1352 |  |
