...
|        - |  972 | ` */` |
| 21589232 |  973 | `PH7_PRIVATE sxi32 PH7_CompileVariable(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |  974 | `{` |
| 21589237 |  975 | `	sxu32 nLineLocal = pGen->pIn->nLine;` |
|        - |  976 | `	sxi32 iVv;` |
|        - |  977 | `	sxi32 iP1;` |
| 21589237 |  978 | `	sxi32 iP2 = 0; /* 1 = quiet read (isset/empty): a missing variable must not warn */` |
|        - |  979 | `	void *p3;` |
|        - |  980 | `	sxi32 rc;` |
| 21589237 |  981 | `	iVv = -1; /* Variable variable counter */` |
| 43178481 |  982 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) ){` |
| 21589249 |  983 | `		pGen->pIn++;` |
| 21589249 |  984 | `		iVv++;` |
|        5 |  985 | `	}` |
| 21589237 |  986 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_OCB/*'{'*/)) == 0 ){` |
...
|        - |  994 | `	}` |
| 21589237 |  995 | `	p3  = 0;` |
| 21589237 |  996 | `	if( pGen->pIn->nType & PH7_TK_OCB/*'{'*/ ){` |
...
|        - | 1021 | `		SyString *pName;` |
| 21589221 | 1022 | `		char *zName = 0;` |
|        - | 1023 | `		/* Extract variable name */` |
| 21589221 | 1024 | `		pName = &pGen->pIn->sData;` |
|        - | 1025 | `		/* Advance the stream cursor */` |
| 21589221 | 1026 | `		pGen->pIn++;` |
| 21589221 | 1027 | `		pEntry = SyHashGet(&pGen->hVar,(const void *)pName->zString,pName->nByte);` |
| 21589221 | 1028 | `		if( pEntry == 0 ){` |
|        - | 1029 | `			/* Duplicate name */` |
...
| 20295547 | 1039 | `			zName = (char *)pEntry->pUserData;` |
|        - | 1040 | `		}` |
| 21589221 | 1041 | `		p3 = (void *)zName;` |
|        - | 1042 | `	}` |
| 21589233 | 1043 | `	iP1 = 0;` |
| 21589233 | 1044 | `	if( iCompileFlag & EXPR_FLAG_RDONLY_LOAD ){` |
| 17037685 | 1045 | `		if( (iCompileFlag & EXPR_FLAG_LOAD_IDX_STORE) == 0 ){` |
...
| 21589233 | 1057 | `	if( iCompileFlag & (EXPR_FLAG_LOAD_IDX_ISSET\|EXPR_FLAG_LOAD_IDX_EMPTY\|EXPR_FLAG_QUIET_VAR) ){` |
|   384427 | 1058 | `		iP2 = 1;` |
| 21397022 | 1059 | `	}else if( iCompileFlag & EXPR_FLAG_RMW_LOAD ){` |
...
| 21589233 | 1065 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,iP2,p3,0);` |
| 21589245 | 1066 | `	while( iVv > 0 ){` |
|       13 | 1067 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,iP2,0,0);` |
|       13 | 1068 | `		iVv--;` |
|        1 | 1069 | `	}` |
|        - | 1070 | `	/* Node successfully compiled */` |
| 21589233 | 1071 | `	return SXRET_OK;` |
| 10794621 | 1072 | `}` |
|        - | 1073 | `/*` |
|        - | 1074 | ` * Load a literal.` |
|        - | 1075 | ` */` |
| 14083470 | 1076 | `static sxi32 GenStateLoadLiteral(ph7_gen_state *pGen)` |
|        5 | 1077 | `{` |
| 14083475 | 1078 | `	SyToken *pToken = pGen->pIn;` |
|        - | 1079 | `	ph7_value *pObj;` |
|        - | 1080 | `	SyString *pStr;` |
|        - | 1081 | `	sxu32 nIdx;` |
|        - | 1082 | `	/* Extract token value */` |
| 14083475 | 1083 | `	pStr = &pToken->sData;` |
...
| 14083475 | 1088 | `	if( pToken->nType & PH7_TK_MEMBER_NAME ){` |
|        - | 1089 | `		/* fall through to the plain-string literal path */` |
| 11211201 | 1090 | `	}else if( pStr->nByte == sizeof("NULL") - 1 ){` |
|  1685667 | 1091 | `		if( SyStrnicmp(pStr->zString,"null",sizeof("NULL")-1) == 0 ){` |
|        - | 1092 | `			/* NULL constant are always indexed at 0 */` |
|  1155995 | 1093 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,0,0,0);` |
|  1155995 | 1094 | `			return SXRET_OK;` |
|   529677 | 1095 | `		}else if( SyStrnicmp(pStr->zString,"true",sizeof("TRUE")-1) == 0 ){` |
...
|        5 | 1099 | `		}` |
|  7531771 | 1100 | `	}else if (pStr->nByte == sizeof("FALSE") - 1 &&` |
|  1585144 | 1101 | `		SyStrnicmp(pStr->zString,"false",sizeof("FALSE")-1) == 0 ){` |
|        - | 1102 | `			/* FALSE constant are always indexed at 2 */` |
|   795285 | 1103 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,2,0,0);` |
|   795285 | 1104 | `			return SXRET_OK;` |
|  6004330 | 1105 | `	}else if(pStr->nByte == sizeof("__LINE__") - 1 &&` |
|   292690 | 1106 | `		SyMemcmp(pStr->zString,"__LINE__",sizeof("__LINE__")-1) == 0 ){` |
...
|  5998499 | 1117 | `	}else if( (pStr->nByte == sizeof("__FILE__") - 1 &&` |
|   513339 | 1118 | `		SyMemcmp(pStr->zString,"__FILE__",sizeof("__FILE__")-1) == 0) \|\|` |
|  6074672 | 1119 | `		(pStr->nByte == sizeof("__DIR__") - 1 &&` |
...
|  5970615 | 1152 | `	}else if( pStr->nByte == sizeof("__NAMESPACE__") - 1 &&` |
...
|  5982469 | 1169 | `	}else if( (pStr->nByte == sizeof("__FUNCTION__") - 1 &&` |
|   428521 | 1170 | `		SyMemcmp(pStr->zString,"__FUNCTION__",sizeof("__FUNCTION__")-1) == 0) \|\|` |
|  6013907 | 1171 | `		(pStr->nByte == sizeof("__METHOD__") - 1 &&` |
...
| 11766523 | 1215 | `	if( SXRET_OK != GenStateFindLiteral(&(*pGen),&pToken->sData,&nIdx) ){` |
|        - | 1216 | `		ph7_value *pLitObj;` |
|        - | 1217 | `		/* Unknown literal,install it in the literal table */` |
|  2425335 | 1218 | `		pLitObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  2425335 | 1219 | `		if( pLitObj == 0 ){` |
|      ! 0 | 1220 | `			PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|      ! 0 | 1221 | `			return SXERR_ABORT;` |
|        - | 1222 | `		}` |
|  2425335 | 1223 | `		PH7_MemObjInitFromString(pGen->pVm,pLitObj,&pToken->sData);` |
|  2425335 | 1224 | `		GenStateInstallLiteral(&(*pGen),pLitObj,nIdx);` |
|  1212665 | 1225 | `	}` |
|        - | 1226 | `	/* Emit the load constant instruction */` |
| 11766523 | 1227 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,1,nIdx,0,0);` |
| 11766523 | 1228 | `	return SXRET_OK;` |
|  7041740 | 1229 | `}` |
|        - | 1230 | `/*` |
...
|        - | 1235 | ` */` |
| 14087436 | 1236 | `static sxi32 GenStateResolveNamespaceLiteral(ph7_gen_state *pGen)` |
|        5 | 1237 | `{` |
|        - | 1238 | `	sxi32 rc;` |
| 14087441 | 1239 | `	if( pGen->pIn >= pGen->pEnd ){` |
|      ! 0 | 1240 | `		return SXRET_OK;` |
|        - | 1241 | `	}` |
|        - | 1242 | `	/* Check if this is a multi-token namespace path */` |
| 14087441 | 1243 | `	if( pGen->pIn < &pGen->pEnd[-1] ){` |
...
| 14083475 | 1322 | `	rc = GenStateLoadLiteral(&(*pGen));` |
| 14083475 | 1323 | `	return rc;` |
|  7043723 | 1324 | `}` |
|        - | 1325 | `/*` |
...
|      ! 0 | 1340 | `}` |
| 14087436 | 1341 | `PH7_PRIVATE sxi32 PH7_CompileLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 | 1342 | `{` |
|        - | 1343 | `	sxi32 rc;` |
| 14087441 | 1344 | `	rc = GenStateResolveNamespaceLiteral(&(*pGen));` |
| 14087441 | 1345 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 1346 | `		SXUNUSED(iCompileFlag); /* cc warning */` |
|      ! 0 | 1347 | `		return rc;` |
|        - | 1348 | `	}` |
|        - | 1349 | `	/* Node successfully compiled */` |
| 14087441 | 1350 | `	return SXRET_OK;` |
|  7043723 | 1351 | `}` |
|        - | 1352 |  |
