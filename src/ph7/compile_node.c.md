...
|        - |  972 | ` */` |
| 21589236 |  973 | `PH7_PRIVATE sxi32 PH7_CompileVariable(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |  974 | `{` |
| 21589241 |  975 | `	sxu32 nLineLocal = pGen->pIn->nLine;` |
|        - |  976 | `	sxi32 iVv;` |
|        - |  977 | `	sxi32 iP1;` |
| 21589241 |  978 | `	sxi32 iP2 = 0; /* 1 = quiet read (isset/empty): a missing variable must not warn */` |
|        - |  979 | `	void *p3;` |
|        - |  980 | `	sxi32 rc;` |
| 21589241 |  981 | `	iVv = -1; /* Variable variable counter */` |
| 43178489 |  982 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) ){` |
| 21589253 |  983 | `		pGen->pIn++;` |
| 21589253 |  984 | `		iVv++;` |
|        5 |  985 | `	}` |
| 21589241 |  986 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_OCB/*'{'*/)) == 0 ){` |
...
|        - |  994 | `	}` |
| 21589241 |  995 | `	p3  = 0;` |
| 21589241 |  996 | `	if( pGen->pIn->nType & PH7_TK_OCB/*'{'*/ ){` |
...
|        - | 1021 | `		SyString *pName;` |
| 21589225 | 1022 | `		char *zName = 0;` |
|        - | 1023 | `		/* Extract variable name */` |
| 21589225 | 1024 | `		pName = &pGen->pIn->sData;` |
|        - | 1025 | `		/* Advance the stream cursor */` |
| 21589225 | 1026 | `		pGen->pIn++;` |
| 21589225 | 1027 | `		pEntry = SyHashGet(&pGen->hVar,(const void *)pName->zString,pName->nByte);` |
| 21589225 | 1028 | `		if( pEntry == 0 ){` |
|        - | 1029 | `			/* Duplicate name */` |
|  1293679 | 1030 | `			zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|  1293679 | 1031 | `			if( zName == 0 ){` |
...
|  1293679 | 1036 | `			SyHashInsert(&pGen->hVar,zName,pName->nByte,zName);` |
|   646842 | 1037 | `		}else{` |
|        - | 1038 | `			/* Name already available */` |
| 20295551 | 1039 | `			zName = (char *)pEntry->pUserData;` |
|        - | 1040 | `		}` |
| 21589225 | 1041 | `		p3 = (void *)zName;` |
|        - | 1042 | `	}` |
| 21589237 | 1043 | `	iP1 = 0;` |
| 21589237 | 1044 | `	if( iCompileFlag & EXPR_FLAG_RDONLY_LOAD ){` |
| 17037693 | 1045 | `		if( (iCompileFlag & EXPR_FLAG_LOAD_IDX_STORE) == 0 ){` |
...
| 21589237 | 1057 | `	if( iCompileFlag & (EXPR_FLAG_LOAD_IDX_ISSET\|EXPR_FLAG_LOAD_IDX_EMPTY\|EXPR_FLAG_QUIET_VAR) ){` |
|   384427 | 1058 | `		iP2 = 1;` |
| 21397026 | 1059 | `	}else if( iCompileFlag & EXPR_FLAG_RMW_LOAD ){` |
...
| 21589237 | 1065 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,iP2,p3,0);` |
| 21589249 | 1066 | `	while( iVv > 0 ){` |
|       13 | 1067 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,iP2,0,0);` |
|       13 | 1068 | `		iVv--;` |
|        1 | 1069 | `	}` |
|        - | 1070 | `	/* Node successfully compiled */` |
| 21589237 | 1071 | `	return SXRET_OK;` |
| 10794623 | 1072 | `}` |
|        - | 1073 | `/*` |
|        - | 1074 | ` * Load a literal.` |
|        - | 1075 | ` */` |
| 14083448 | 1076 | `static sxi32 GenStateLoadLiteral(ph7_gen_state *pGen)` |
|        5 | 1077 | `{` |
| 14083453 | 1078 | `	SyToken *pToken = pGen->pIn;` |
|        - | 1079 | `	ph7_value *pObj;` |
|        - | 1080 | `	SyString *pStr;` |
|        - | 1081 | `	sxu32 nIdx;` |
|        - | 1082 | `	/* Extract token value */` |
| 14083453 | 1083 | `	pStr = &pToken->sData;` |
...
| 14083453 | 1088 | `	if( pToken->nType & PH7_TK_MEMBER_NAME ){` |
|        - | 1089 | `		/* fall through to the plain-string literal path */` |
| 11211182 | 1090 | `	}else if( pStr->nByte == sizeof("NULL") - 1 ){` |
|  1685663 | 1091 | `		if( SyStrnicmp(pStr->zString,"null",sizeof("NULL")-1) == 0 ){` |
|        - | 1092 | `			/* NULL constant are always indexed at 0 */` |
|  1155999 | 1093 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,0,0,0);` |
|  1155999 | 1094 | `			return SXRET_OK;` |
|   529669 | 1095 | `		}else if( SyStrnicmp(pStr->zString,"true",sizeof("TRUE")-1) == 0 ){` |
|        - | 1096 | `			/* TRUE constant are always indexed at 1 */` |
|   357807 | 1097 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,1,0,0);` |
|   357807 | 1098 | `			return SXRET_OK;` |
|        5 | 1099 | `		}` |
|  7531757 | 1100 | `	}else if (pStr->nByte == sizeof("FALSE") - 1 &&` |
|  1585146 | 1101 | `		SyStrnicmp(pStr->zString,"false",sizeof("FALSE")-1) == 0 ){` |
|        - | 1102 | `			/* FALSE constant are always indexed at 2 */` |
|   795287 | 1103 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,2,0,0);` |
|   795287 | 1104 | `			return SXRET_OK;` |
|  6004311 | 1105 | `	}else if(pStr->nByte == sizeof("__LINE__") - 1 &&` |
...
|  5998480 | 1117 | `	}else if( (pStr->nByte == sizeof("__FILE__") - 1 &&` |
|   513329 | 1118 | `		SyMemcmp(pStr->zString,"__FILE__",sizeof("__FILE__")-1) == 0) \|\|` |
|  6074658 | 1119 | `		(pStr->nByte == sizeof("__DIR__") - 1 &&` |
|   449056 | 1120 | `		SyMemcmp(pStr->zString,"__DIR__",sizeof("__DIR__")-1) == 0) ){` |
...
|  5970601 | 1152 | `	}else if( pStr->nByte == sizeof("__NAMESPACE__") - 1 &&` |
...
|  5982454 | 1169 | `	}else if( (pStr->nByte == sizeof("__FUNCTION__") - 1 &&` |
|   428519 | 1170 | `		SyMemcmp(pStr->zString,"__FUNCTION__",sizeof("__FUNCTION__")-1) == 0) \|\|` |
|  6013893 | 1171 | `		(pStr->nByte == sizeof("__METHOD__") - 1 &&` |
|   327604 | 1172 | `		SyMemcmp(pStr->zString,"__METHOD__",sizeof("__METHOD__")-1) == 0) ){` |
...
| 11766497 | 1215 | `	if( SXRET_OK != GenStateFindLiteral(&(*pGen),&pToken->sData,&nIdx) ){` |
...
| 11766497 | 1227 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,1,nIdx,0,0);` |
| 11766497 | 1228 | `	return SXRET_OK;` |
|  7041729 | 1229 | `}` |
|        - | 1230 | `/*` |
...
|        - | 1235 | ` */` |
| 14087414 | 1236 | `static sxi32 GenStateResolveNamespaceLiteral(ph7_gen_state *pGen)` |
|        5 | 1237 | `{` |
|        - | 1238 | `	sxi32 rc;` |
| 14087419 | 1239 | `	if( pGen->pIn >= pGen->pEnd ){` |
|      ! 0 | 1240 | `		return SXRET_OK;` |
|        - | 1241 | `	}` |
|        - | 1242 | `	/* Check if this is a multi-token namespace path */` |
| 14087419 | 1243 | `	if( pGen->pIn < &pGen->pEnd[-1] ){` |
...
| 14083453 | 1322 | `	rc = GenStateLoadLiteral(&(*pGen));` |
| 14083453 | 1323 | `	return rc;` |
|  7043712 | 1324 | `}` |
|        - | 1325 | `/*` |
...
|      ! 0 | 1340 | `}` |
| 14087414 | 1341 | `PH7_PRIVATE sxi32 PH7_CompileLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 | 1342 | `{` |
|        - | 1343 | `	sxi32 rc;` |
| 14087419 | 1344 | `	rc = GenStateResolveNamespaceLiteral(&(*pGen));` |
| 14087419 | 1345 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 1346 | `		SXUNUSED(iCompileFlag); /* cc warning */` |
|      ! 0 | 1347 | `		return rc;` |
|        - | 1348 | `	}` |
|        - | 1349 | `	/* Node successfully compiled */` |
| 14087419 | 1350 | `	return SXRET_OK;` |
|  7043712 | 1351 | `}` |
|        - | 1352 |  |
