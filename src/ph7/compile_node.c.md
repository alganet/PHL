...
|        - |  972 | ` */` |
| 21667056 |  973 | `PH7_PRIVATE sxi32 PH7_CompileVariable(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |  974 | `{` |
| 21667061 |  975 | `	sxu32 nLineLocal = pGen->pIn->nLine;` |
|        - |  976 | `	sxi32 iVv;` |
|        - |  977 | `	sxi32 iP1;` |
| 21667061 |  978 | `	sxi32 iP2 = 0; /* 1 = quiet read (isset/empty): a missing variable must not warn */` |
|        - |  979 | `	void *p3;` |
|        - |  980 | `	sxi32 rc;` |
| 21667061 |  981 | `	iVv = -1; /* Variable variable counter */` |
| 43334129 |  982 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) ){` |
| 21667073 |  983 | `		pGen->pIn++;` |
| 21667073 |  984 | `		iVv++;` |
|        5 |  985 | `	}` |
| 21667061 |  986 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_OCB/*'{'*/)) == 0 ){` |
...
|        - |  994 | `	}` |
| 21667061 |  995 | `	p3  = 0;` |
| 21667061 |  996 | `	if( pGen->pIn->nType & PH7_TK_OCB/*'{'*/ ){` |
...
|        - | 1021 | `		SyString *pName;` |
| 21667045 | 1022 | `		char *zName = 0;` |
|        - | 1023 | `		/* Extract variable name */` |
| 21667045 | 1024 | `		pName = &pGen->pIn->sData;` |
|        - | 1025 | `		/* Advance the stream cursor */` |
| 21667045 | 1026 | `		pGen->pIn++;` |
| 21667045 | 1027 | `		pEntry = SyHashGet(&pGen->hVar,(const void *)pName->zString,pName->nByte);` |
| 21667045 | 1028 | `		if( pEntry == 0 ){` |
|        - | 1029 | `			/* Duplicate name */` |
|  1298341 | 1030 | `			zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|  1298341 | 1031 | `			if( zName == 0 ){` |
...
|  1298341 | 1036 | `			SyHashInsert(&pGen->hVar,zName,pName->nByte,zName);` |
|   649173 | 1037 | `		}else{` |
|        - | 1038 | `			/* Name already available */` |
| 20368709 | 1039 | `			zName = (char *)pEntry->pUserData;` |
|        - | 1040 | `		}` |
| 21667045 | 1041 | `		p3 = (void *)zName;` |
|        - | 1042 | `	}` |
| 21667057 | 1043 | `	iP1 = 0;` |
| 21667057 | 1044 | `	if( iCompileFlag & EXPR_FLAG_RDONLY_LOAD ){` |
| 17099115 | 1045 | `		if( (iCompileFlag & EXPR_FLAG_LOAD_IDX_STORE) == 0 ){` |
...
| 21667057 | 1057 | `	if( iCompileFlag & (EXPR_FLAG_LOAD_IDX_ISSET\|EXPR_FLAG_LOAD_IDX_EMPTY\|EXPR_FLAG_QUIET_VAR) ){` |
|   385813 | 1058 | `		iP2 = 1;` |
| 21474153 | 1059 | `	}else if( iCompileFlag & EXPR_FLAG_RMW_LOAD ){` |
...
| 21667057 | 1065 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,iP2,p3,0);` |
| 21667069 | 1066 | `	while( iVv > 0 ){` |
|       13 | 1067 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,iP2,0,0);` |
|       13 | 1068 | `		iVv--;` |
|        1 | 1069 | `	}` |
|        - | 1070 | `	/* Node successfully compiled */` |
| 21667057 | 1071 | `	return SXRET_OK;` |
| 10833533 | 1072 | `}` |
|        - | 1073 | `/*` |
|        - | 1074 | ` * Load a literal.` |
|        - | 1075 | ` */` |
| 14134156 | 1076 | `static sxi32 GenStateLoadLiteral(ph7_gen_state *pGen)` |
|        5 | 1077 | `{` |
| 14134161 | 1078 | `	SyToken *pToken = pGen->pIn;` |
|        - | 1079 | `	ph7_value *pObj;` |
|        - | 1080 | `	SyString *pStr;` |
|        - | 1081 | `	sxu32 nIdx;` |
|        - | 1082 | `	/* Extract token value */` |
| 14134161 | 1083 | `	pStr = &pToken->sData;` |
...
| 14134161 | 1088 | `	if( pToken->nType & PH7_TK_MEMBER_NAME ){` |
|        - | 1089 | `		/* fall through to the plain-string literal path */` |
| 11251535 | 1090 | `	}else if( pStr->nByte == sizeof("NULL") - 1 ){` |
|  1691737 | 1091 | `		if( SyStrnicmp(pStr->zString,"null",sizeof("NULL")-1) == 0 ){` |
...
|   531571 | 1095 | `		}else if( SyStrnicmp(pStr->zString,"true",sizeof("TRUE")-1) == 0 ){` |
|        - | 1096 | `			/* TRUE constant are always indexed at 1 */` |
|   359095 | 1097 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,1,0,0);` |
|   359095 | 1098 | `			return SXRET_OK;` |
|        5 | 1099 | `		}` |
|  7558843 | 1100 | `	}else if (pStr->nByte == sizeof("FALSE") - 1 &&` |
|  1590856 | 1101 | `		SyStrnicmp(pStr->zString,"false",sizeof("FALSE")-1) == 0 ){` |
...
|  6025890 | 1105 | `	}else if(pStr->nByte == sizeof("__LINE__") - 1 &&` |
|   293730 | 1106 | `		SyMemcmp(pStr->zString,"__LINE__",sizeof("__LINE__")-1) == 0 ){` |
...
|  6020038 | 1117 | `	}else if( (pStr->nByte == sizeof("__FILE__") - 1 &&` |
|   515169 | 1118 | `		SyMemcmp(pStr->zString,"__FILE__",sizeof("__FILE__")-1) == 0) \|\|` |
|  6096488 | 1119 | `		(pStr->nByte == sizeof("__DIR__") - 1 &&` |
|   450664 | 1120 | `		SyMemcmp(pStr->zString,"__DIR__",sizeof("__DIR__")-1) == 0) ){` |
...
|  5992057 | 1152 | `	}else if( pStr->nByte == sizeof("__NAMESPACE__") - 1 &&` |
...
|  6003954 | 1169 | `	}else if( (pStr->nByte == sizeof("__FUNCTION__") - 1 &&` |
|   430055 | 1170 | `		SyMemcmp(pStr->zString,"__FUNCTION__",sizeof("__FUNCTION__")-1) == 0) \|\|` |
|  6035507 | 1171 | `		(pStr->nByte == sizeof("__METHOD__") - 1 &&` |
|   328780 | 1172 | `		SyMemcmp(pStr->zString,"__METHOD__",sizeof("__METHOD__")-1) == 0) ){` |
...
| 11808847 | 1215 | `	if( SXRET_OK != GenStateFindLiteral(&(*pGen),&pToken->sData,&nIdx) ){` |
|        - | 1216 | `		ph7_value *pLitObj;` |
|        - | 1217 | `		/* Unknown literal,install it in the literal table */` |
|  2434063 | 1218 | `		pLitObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  2434063 | 1219 | `		if( pLitObj == 0 ){` |
|      ! 0 | 1220 | `			PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|      ! 0 | 1221 | `			return SXERR_ABORT;` |
|        - | 1222 | `		}` |
|  2434063 | 1223 | `		PH7_MemObjInitFromString(pGen->pVm,pLitObj,&pToken->sData);` |
|  2434063 | 1224 | `		GenStateInstallLiteral(&(*pGen),pLitObj,nIdx);` |
|  1217029 | 1225 | `	}` |
|        - | 1226 | `	/* Emit the load constant instruction */` |
| 11808847 | 1227 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,1,nIdx,0,0);` |
| 11808847 | 1228 | `	return SXRET_OK;` |
|  7067083 | 1229 | `}` |
|        - | 1230 | `/*` |
...
|        - | 1235 | ` */` |
| 14138136 | 1236 | `static sxi32 GenStateResolveNamespaceLiteral(ph7_gen_state *pGen)` |
|        5 | 1237 | `{` |
|        - | 1238 | `	sxi32 rc;` |
| 14138141 | 1239 | `	if( pGen->pIn >= pGen->pEnd ){` |
|      ! 0 | 1240 | `		return SXRET_OK;` |
|        - | 1241 | `	}` |
|        - | 1242 | `	/* Check if this is a multi-token namespace path */` |
| 14138141 | 1243 | `	if( pGen->pIn < &pGen->pEnd[-1] ){` |
...
| 14134161 | 1322 | `	rc = GenStateLoadLiteral(&(*pGen));` |
| 14134161 | 1323 | `	return rc;` |
|  7069073 | 1324 | `}` |
|        - | 1325 | `/*` |
...
|      ! 0 | 1340 | `}` |
| 14138136 | 1341 | `PH7_PRIVATE sxi32 PH7_CompileLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 | 1342 | `{` |
|        - | 1343 | `	sxi32 rc;` |
| 14138141 | 1344 | `	rc = GenStateResolveNamespaceLiteral(&(*pGen));` |
| 14138141 | 1345 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 1346 | `		SXUNUSED(iCompileFlag); /* cc warning */` |
|      ! 0 | 1347 | `		return rc;` |
|        - | 1348 | `	}` |
|        - | 1349 | `	/* Node successfully compiled */` |
| 14138141 | 1350 | `	return SXRET_OK;` |
|  7069073 | 1351 | `}` |
|        - | 1352 |  |
