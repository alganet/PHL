...
|        - |  162 | ` */` |
|   161190 |  163 | `static sxi32 VmExecFinalize(ph7_vm *pVm,VmExecState *pState,SySet *pArg,ph7_value *pTos,sxi32 rcTerm)` |
|        5 |  164 | `{` |
|    80595 |  165 | `	SXUNUSED(pVm);` |
|   161195 |  166 | `	if( rcTerm != PH7_SUSPEND && !pState->bReturnPropagates ){` |
|   157517 |  167 | `		VmClearFrameReturn(pState->pEntryFrame);` |
|    78756 |  168 | `	}` |
|   161195 |  169 | `	SySetRelease(pArg);` |
|   161195 |  170 | `	if( rcTerm == PH7_ABORT \|\| rcTerm == PH7_EXCEPTION ){` |
|     2841 |  171 | `		while( pTos >= pState->pStack ){` |
|     1789 |  172 | `			PH7_MemObjRelease(pTos);` |
|     1789 |  173 | `			pTos--;` |
|        5 |  174 | `		}` |
|      526 |  175 | `	}` |
|   161195 |  176 | `	return rcTerm;` |
|        5 |  177 | `}` |
|        - |  178 | `/*` |
...
|        - |  189 | ` */` |
|   104432 |  190 | `static sxi32 VmCallFinish(ph7_vm *pVm,VmExecState *pCaller,VmCallRecord *pCallee,sxi32 rc)` |
|        5 |  191 | `{` |
|        - |  192 | `	ph7_value *pObj;` |
|        - |  193 | `	/* Decrement nesting level */` |
|   104437 |  194 | `	pVm->nRecursionDepth--;` |
|   104437 |  195 | `	if( pCallee->bSelfPushed ){` |
|        - |  196 | `		/* Pop class name */` |
|    25489 |  197 | `		(void)SySetPop(&pVm->aSelf);` |
|    12742 |  198 | `	}` |
|   104437 |  199 | `	if( (pCallee->pVmFunc->iFlags & VM_FUNC_REF_RETURN) && rc == SXRET_OK ){` |
...
|       25 |  225 | `	}` |
|   104437 |  226 | `	if( rc != PH7_ABORT && ((pCallee->pFrame->iFlags & VM_FRAME_THROW) \|\| rc == PH7_EXCEPTION) ){` |
...
|   104437 |  272 | `	if( rc != PH7_SUSPEND && pCallee->pFrameStack ){` |
...
|   104303 |  276 | `		VmOperandStackRecycle(pVm,pCallee->pFrameStack,pCallee->nStackCap);` |
|    52252 |  277 | `	}` |
|        - |  278 | `	/* Leave the frame */` |
|   104437 |  279 | `	VmLeaveFrame(&(*pVm));` |
|   104437 |  280 | `	if( rc == PH7_ABORT ){` |
|      336 |  281 | `		return PH7_ABORT;` |
|        - |  282 | `	}` |
|   104105 |  283 | `	if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|        - |  291 | `	}` |
|   104105 |  292 | `	if( rc == PH7_EXCEPTION ){` |
|      469 |  293 | `		return PH7_EXCEPTION;` |
|        - |  294 | `	}` |
|   103641 |  295 | `	return PH7_OK;` |
|    52324 |  296 | `}` |
|        - |  297 | `/*` |
...
|        - |  330 | ` * nesting.` |
|        - |  331 | ` */` |
|   161548 |  332 | `PH7_PRIVATE sxi32 VmByteCodeExec(` |
...
|   161553 |  352 | `	if( VmNativeNestingExceeded(pVm) ){` |
...
|   161549 |  362 | `	nSavedBrc = pVm->nBoundaryRc;` |
|   161549 |  363 | `	pVm->nBoundaryRc = 0;` |
...
|   161549 |  370 | `	nSavedLine = pVm->nCurLine;` |
|   161549 |  371 | `	pVm->nVmExecDepth++;` |
|   242321 |  372 | `	rc = VmByteCodeExecBody(&(*pVm),aInstr,pStack,nTos,pResult,pLastRef,is_callback,nPc,` |
|    80772 |  373 | `		pEnforceRetFunc,bReturnPropagates,pAdoptSegment,ppBaseOwner,pnBaseCap,nStackOrig);` |
|   161549 |  374 | `	pVm->nVmExecDepth--;` |
|   161549 |  375 | `	pVm->nCurLine = nSavedLine;` |
|   161549 |  376 | `	if( nSavedBrc != 0 && (nSavedBrc == PH7_ABORT \|\| pVm->nBoundaryRc == 0) ){` |
|       15 |  377 | `		pVm->nBoundaryRc = nSavedBrc;` |
|        6 |  378 | `	}` |
|   161549 |  379 | `	return rc;` |
|    80779 |  380 | `}` |
|   161544 |  381 | `static sxi32 VmByteCodeExecBody(` |
...
|        - |  399 | `	ph7_value *pTos;` |
|        - |  400 | `	SySet aArg;` |
|   161549 |  401 | `	VmCallFrame *pCallTop = 0; /* Top of this invocation's in-loop call-record` |
...
|        - |  409 | `	sxi32 pc;` |
|        - |  410 | `	sxi32 rc;` |
|   161549 |  411 | `	sState.aInstr = aInstr;` |
|   161549 |  412 | `	sState.pStack = pStack;` |
|   161549 |  413 | `	sState.nStackCap = pnBaseCap ? *pnBaseCap : 0; /* CURRENT capacity (grown on a coroutine resume) */` |
|   161549 |  414 | `	sState.nStackOrig = nStackOrig;                /* ORIGINAL capacity — fixed headroom reference */` |
|   161549 |  415 | `	sState.pResult = pResult;` |
|   161549 |  416 | `	sState.pLastRef = pLastRef;` |
|   161549 |  417 | `	sState.pEnforceRetFunc = pEnforceRetFunc;` |
|   161549 |  418 | `	sState.is_callback = (sxu8)(is_callback ? 1 : 0);` |
|   161549 |  419 | `	sState.bReturnPropagates = (sxu8)(bReturnPropagates ? 1 : 0);` |
|        - |  420 | `	/* Argument container */` |
|   161549 |  421 | `	SySetInit(&aArg,&pVm->sAllocator,sizeof(ph7_value *));` |
|   161549 |  422 | `	if( nTos < 0 ){` |
|   145783 |  423 | `		pTos = &pStack[-1];` |
|    72894 |  424 | `	}else{` |
|    15771 |  425 | `		pTos = &pStack[nTos];` |
|        - |  426 | `	}` |
|   161549 |  427 | `	sState.pTos = pTos;` |
|   161549 |  428 | `	sState.pc = nPc;` |
...
|   161544 |  446 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->pFrame == pVm->pFrame` |
|     2816 |  447 | `	 && pStack == pVm->pActiveCtx->pStack ){` |
|     1805 |  448 | `		sState.nExceptionBase = pVm->pActiveCtx->nExceptionBase;` |
|      905 |  449 | `	}else{` |
|   159749 |  450 | `		sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|        - |  451 | `	}` |
|   161549 |  452 | `	sState.pEntryFrame = pVm->pFrame;` |
|   161549 |  453 | `	pc = nPc;` |
...
|   161544 |  506 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->pInjected` |
...
|   161534 |  567 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->bClosing` |
...
| 16988372 |  603 | `		if( pVm->nBoundaryRc != 0 \|\| SySetUsed(&pVm->aHookRmw) > 0 ){` |
...
| 16988286 |  658 | `		pInstr = &aInstr[pc];` |
| 16988286 |  659 | `		if( pInstr->nLine ){` |
...
| 16775530 |  663 | `			pVm->nCurLine = pInstr->nLine;` |
|  8394130 |  664 | `		}` |
| 16988286 |  665 | `		rc = SXRET_OK;` |
|        - |  666 | `/*` |
...
|        - |  672 | ` */` |
| 16988286 |  673 | `		switch(pInstr->iOp){` |
|        - |  674 | `/*` |
|        - |  675 | ` * DONE: P1 * *` |
|        - |  676 | ` *` |
...
|        - |  679 | ` */` |
|   130742 |  680 | `case PH7_OP_DONE:` |
|   261695 |  681 | `	if( pInstr->iP2 && sState.bReturnPropagates ){` |
...
|   261506 |  711 | `	if( sState.pEnforceRetFunc && VmFuncHasReturnType(sState.pEnforceRetFunc)` |
...
|     4591 |  736 | `	}` |
|   261487 |  737 | `	if( pInstr->iP1 && pTos >= pStack ){` |
|   157003 |  738 | `		if( sState.pLastRef ){` |
|    93985 |  739 | `			*sState.pLastRef = pTos->nIdx;` |
|    47093 |  740 | `		}` |
|   157003 |  741 | `		if( sState.pResult ){` |
|        - |  742 | `			/* Execution result */` |
|   149945 |  743 | `			PH7_MemObjStore(pTos,sState.pResult);` |
|    75073 |  744 | `		}` |
|   157003 |  745 | `		VmPopOperand(&pTos,1);` |
|   183091 |  746 | `	}else if( sState.pLastRef ){` |
...
|        - |  762 | `	 */` |
|   261487 |  763 | `	rc = VmDrainFinally(&(*pVm),sState.nExceptionBase);` |
|   261487 |  764 | `	if( rc == SXERR_ABORT ){` |
|      ! 0 |  765 | `		goto Abort;` |
|        - |  766 | `	}` |
|   261487 |  767 | `	if( rc == PH7_EXCEPTION ){` |
...
|        - |  778 | `	}` |
|   261483 |  779 | `	if( sState.pEntryFrame->bHasRet && !sState.bReturnPropagates ){` |
...
|        - |  835 | ` */` |
|   278475 |  836 | `case PH7_OP_JMP:` |
|   557162 |  837 | `	pc = pInstr->iP2 - 1;` |
|   557162 |  838 | `	break;` |
|        - |  839 | `/*` |
|        - |  840 | ` * JZ: P1 P2 *` |
|        - |  841 | ` *` |
...
|  1627021 |  852 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     1001 |  853 | `		PH7_MemObjToBool(pTos);` |
|      499 |  854 | `	}` |
|  1627021 |  855 | `	if( !pTos->x.iVal ){` |
|        - |  856 | `		/* Take the jump */` |
|   922605 |  857 | `		pc = pInstr->iP2 - 1;` |
|   461562 |  858 | `	}` |
|  1627021 |  859 | `	if( !pInstr->iP1 ){` |
|  1384782 |  860 | `		VmPopOperand(&pTos,1);` |
|   692960 |  861 | `	}` |
|  1627021 |  862 | `	break;` |
|        - |  863 | `/*` |
|        - |  864 | ` * JNZ: P1 P2 *` |
...
|   183025 |  876 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      ! 0 |  877 | `		PH7_MemObjToBool(pTos);` |
|      ! 0 |  878 | `	}` |
|   183025 |  879 | `	if( pTos->x.iVal ){` |
|        - |  880 | `		/* Take the jump */` |
|     9559 |  881 | `		pc = pInstr->iP2 - 1;` |
|     4777 |  882 | `	}` |
|   183025 |  883 | `	if( !pInstr->iP1 ){` |
...
|        - |  899 | ` */` |
|   680990 |  900 | `case PH7_OP_POP: {` |
|  1363016 |  901 | `	sxi32 n = pInstr->iP1;` |
|  1363016 |  902 | `	if( &pTos[-n+1] < pStack ){` |
|        - |  903 | `		/* TICKET 1433-51 Stack underflow must be handled at run-time */` |
|       79 |  904 | `		n = (sxi32)(pTos - pStack);` |
|       38 |  905 | `	}` |
|  1363016 |  906 | `	VmPopOperand(&pTos,n);` |
|  1363016 |  907 | `	break;` |
|        - |  908 | `				 }` |
|        - |  909 | `/*` |
|        - |  910 | ` * DUP: * * *` |
...
|        - |  929 | ` */` |
|    48970 |  930 | `case PH7_OP_NSSWITCH:` |
|    97945 |  931 | `	SyBlobReset(&pVm->sNamespace);` |
|    97945 |  932 | `	if( pInstr->p3 ){` |
...
|    97945 |  937 | `	SyHashRelease(&pVm->hUseConstImports);` |
|    97945 |  938 | `	SyHashInit(&pVm->hUseConstImports,&pVm->sAllocator,0,0);` |
|    97945 |  939 | `	break;` |
...
|        - | 1076 | ` */` |
|     3359 | 1077 | `case PH7_OP_UNSET_VAR: {` |
|        - | 1078 | `	VmOpRc rcOp;` |
|     6723 | 1079 | `	sState.pTos = pTos;` |
|     6723 | 1080 | `	sState.pc = pc;` |
|     6723 | 1081 | `	rcOp = VmExecOpUnsetVar(&(*pVm),&sState,pInstr);` |
|     6723 | 1082 | `	pTos = sState.pTos;` |
|     6723 | 1083 | `	pc = sState.pc;` |
|     6723 | 1084 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 1085 | `		goto Abort;` |
|     6721 | 1086 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
|      ! 0 | 1087 | `		goto Exception;` |
|        - | 1088 | `	}` |
|     6721 | 1089 | `	break;` |
|        - | 1090 | `					  }` |
|    33127 | 1091 | `case PH7_OP_ERR_CTRL:` |
|        - | 1092 | `	/*` |
...
|        - | 1101 | `	 */` |
|    66259 | 1102 | `	if( pInstr->iP1 ){` |
|    33133 | 1103 | `		pVm->nErrSuppress++;` |
|    49695 | 1104 | `	}else if( pVm->nErrSuppress > 0 ){` |
|    33131 | 1105 | `		pVm->nErrSuppress--;` |
|    16563 | 1106 | `	}` |
|    66259 | 1107 | `	break;` |
|        - | 1108 | `/*` |
|        - | 1109 | ` * IS_A * * *` |
...
|        - | 1163 | ` */` |
|  1553304 | 1164 | `case PH7_OP_LOADC: {` |
|        - | 1165 | `	ph7_value *pObj;` |
|        - | 1166 | `	/* Reserve a room */` |
|  3108486 | 1167 | `	pTos++;` |
|  3108486 | 1168 | `	if( pInstr->iP1 & PH7_LOADC_NOKEY ){` |
...
|    19403 | 1174 | `		break;` |
|        - | 1175 | `	}` |
|  3089088 | 1176 | `	if( (pObj = (ph7_value *)SySetAt(&pVm->aLitObj,pInstr->iP2)) != 0 ){` |
|  3089088 | 1177 | `		if( (pInstr->iP1 & PH7_LOADC_EXPAND) && SyBlobLength(&pObj->sBlob) <= 64 ){` |
|        - | 1178 | `			SyHashEntry *pEntry;` |
|        - | 1179 | `			/* Check use const imports first — imports take precedence */` |
|        - | 1180 | `			{` |
|        - | 1181 | `				SyHashEntry *pConstImport;` |
|    34835 | 1182 | `				pConstImport = SyHashGet(&pVm->hUseConstImports,` |
|    23220 | 1183 | `					SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|    23225 | 1184 | `				if( pConstImport ){` |
...
|    23215 | 1199 | `			pEntry = SyHashGet(&pVm->hConstant,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|    23215 | 1200 | `			if( pEntry ){` |
|    23205 | 1201 | `				ph7_constant *pCons = (ph7_constant *)pEntry->pUserData;` |
|        - | 1202 | `				/* Set a NULL default value */` |
|    23205 | 1203 | `				MemObjSetType(pTos,MEMOBJ_NULL);` |
|    23205 | 1204 | `				SyBlobReset(&pTos->sBlob);` |
|        - | 1205 | `				/* Invoke the callback and deal with the expanded value */` |
|    23205 | 1206 | `				VmExpandConstantWithNotice(&(*pVm),pCons,pTos);` |
|        - | 1207 | `				/* Mark as constant */` |
|    23205 | 1208 | `				pTos->nIdx = SXU32_HIGH;` |
|    23205 | 1209 | `				break;` |
|        - | 1210 | `			}` |
...
|        - | 1283 | ` */` |
|  2205589 | 1284 | `case PH7_OP_LOAD:{` |
|        - | 1285 | `	ph7_value *pObj;` |
|        - | 1286 | `	SyString sName;` |
|  4415120 | 1287 | `	if( pInstr->p3 == 0 ){` |
...
|        9 | 1299 | `	}else{` |
|  4415104 | 1300 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1301 | `		/* Reserve a room for the target object */` |
|  4415104 | 1302 | `		pTos++;` |
|        - | 1303 | `	}` |
|  4415120 | 1304 | `	if( pInstr->iP2 == 2 ){` |
...
|   394246 | 1310 | `		if( VmExtractMemObj(&(*pVm),&sName,FALSE,FALSE) == 0 ){` |
|        7 | 1311 | `			VmErrorFormat(&(*pVm),PH7_CTX_WARNING,"Undefined variable $%z",&sName);` |
|        3 | 1312 | `		}` |
|   197224 | 1313 | `	}` |
|        - | 1314 | `	/* Extract the requested memory object */` |
|  4415120 | 1315 | `	pObj = VmExtractMemObj(&(*pVm),&sName,pInstr->p3 ? FALSE : TRUE,pInstr->iP1 != 1);` |
|  4415120 | 1316 | `	if( pObj == 0 ){` |
...
|  4415058 | 1341 | `	PH7_MemObjLoad(pObj,pTos);` |
|  4415058 | 1342 | `	pTos->nIdx = pObj->nIdx;` |
|  4415058 | 1343 | `	break;` |
|        - | 1344 | `				   }` |
|        - | 1345 | `/*` |
|        - | 1346 | ` * LOAD_MAP P1 * *` |
...
|        - | 1351 | ` */` |
|    36908 | 1352 | `case PH7_OP_LOAD_MAP: {` |
|        - | 1353 | `	VmOpRc rcOp;` |
|    73821 | 1354 | `	sState.pTos = pTos;` |
|    73821 | 1355 | `	sState.pc = pc;` |
|    73821 | 1356 | `	rcOp = VmExecOpLoadMap(&(*pVm),&sState,pInstr);` |
|    73821 | 1357 | `	pTos = sState.pTos;` |
|    73821 | 1358 | `	pc = sState.pc;` |
|    73821 | 1359 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1360 | `		goto Abort;` |
|    73821 | 1361 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1394 | ` * instead.` |
|        - | 1395 | ` */` |
|   330214 | 1396 | `case PH7_OP_LOAD_IDX: {` |
|        - | 1397 | `	VmOpRc rcOp;` |
|   661164 | 1398 | `	sState.pTos = pTos;` |
|   661164 | 1399 | `	sState.pc = pc;` |
|   661164 | 1400 | `	rcOp = VmExecOpLoadIdx(&(*pVm),&sState,pInstr);` |
|   661164 | 1401 | `	pTos = sState.pTos;` |
|   661164 | 1402 | `	pc = sState.pc;` |
|   661164 | 1403 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1404 | `		goto Abort;` |
|   661164 | 1405 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1582 | `		}` |
|    11735 | 1583 | `		break;` |
|   620171 | 1584 | `	}else if( pInstr->p3 == 0 ){` |
...
|        - | 1596 | `#endif` |
|        5 | 1597 | `	}else{` |
|   620163 | 1598 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1599 | `	}` |
|   620166 | 1600 | `	if( sName.nByte == sizeof("GLOBALS")-1` |
|   311834 | 1601 | `	 && SyMemcmp((const void *)sName.zString,(const void *)"GLOBALS",sName.nByte) == 0 ){` |
|        6 | 1602 | `		if( pInstr->p3 ){` |
...
|        - | 1639 | ` */` |
|   120578 | 1640 | `case PH7_OP_STORE_IDX:` |
|        - | 1641 | `case PH7_OP_STORE_IDX_REF: {` |
|        - | 1642 | `	VmOpRc rcOp;` |
|   241161 | 1643 | `	sState.pTos = pTos;` |
|   241161 | 1644 | `	sState.pc = pc;` |
|   241161 | 1645 | `	rcOp = VmExecOpStoreIdxRef(&(*pVm),&sState,pInstr);` |
|   241161 | 1646 | `	pTos = sState.pTos;` |
|   241161 | 1647 | `	pc = sState.pc;` |
|   241161 | 1648 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 1649 | `		goto Abort;` |
|   241159 | 1650 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|   364514 | 1671 | `	PH7_ENFORCE_READONLY_MUTATE(pTos->nIdx);` |
...
|   364503 | 1676 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) != 0` |
...
|        - | 1694 | `		}` |
|      ! 0 | 1695 | `	}` |
|   364506 | 1696 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) == 0 ){` |
|   364506 | 1697 | `		if( pTos->nIdx != SXU32_HIGH ){` |
|        - | 1698 | `			ph7_value *pObj;` |
|   364506 | 1699 | `			if( (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pTos->nIdx)) != 0 ){` |
|   364506 | 1700 | `				if( VmStringWantsPerlIncr(pObj) ){` |
...
|   364504 | 1719 | `					if( pInstr->iP1 == 0 && (pTos->iFlags & MEMOBJ_STRING) ){` |
|        9 | 1720 | `						SyBlobNullAppend(&pTos->sBlob);` |
|        3 | 1721 | `					}` |
|        - | 1722 | `					/* Force a numeric cast on the variable */` |
|   364504 | 1723 | `					PH7_MemObjToNumeric(pObj);` |
|   364504 | 1724 | `					if( pObj->iFlags & MEMOBJ_REAL ){` |
|        5 | 1725 | `						pObj->rVal++;` |
...
|        - | 1734 | `						sxi64 r;` |
|   364500 | 1735 | `						if( PH7_ADD_OVERFLOW64(pObj->x.iVal,1,&r) ){` |
...
|        - | 1741 | `#endif` |
|        3 | 1742 | `						}else{` |
|   364496 | 1743 | `							pObj->x.iVal = r;` |
|        - | 1744 | `						}` |
|        - | 1745 | `					}` |
|   364504 | 1746 | `					if( pInstr->iP1 ){` |
...
|        - | 1785 | `		}` |
|   182353 | 1786 | `	}` |
|   364504 | 1787 | `	PH7_HOOK_RMW_WRITEBACK(pTos->nIdx,pTos);` |
|   364504 | 1788 | `	break;` |
|        - | 1789 | `/*` |
|        - | 1790 | ` * DECR: P1 * *` |
|        - | 1791 | ` *` |
...
|    70591 | 1938 | `	PH7_MemObjToNumeric(pTos);` |
|    70591 | 1939 | `	if( pTos->iFlags & MEMOBJ_REAL ){` |
|      108 | 1940 | `		pTos->rVal = -pTos->rVal;` |
|       53 | 1941 | `	}` |
|    70591 | 1942 | `	if( pTos->iFlags & MEMOBJ_INT ){` |
|    70505 | 1943 | `		if( pTos->x.iVal == SMALLEST_INT64 ){` |
...
|        - | 1958 | `#endif` |
|        3 | 1959 | `		}else{` |
|    70501 | 1960 | `			pTos->x.iVal = -pTos->x.iVal;` |
|        - | 1961 | `		}` |
|    35250 | 1962 | `	}` |
|    70591 | 1963 | `	break;` |
|        - | 1964 | `/*` |
...
|    50759 | 1997 | `	if( (pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      147 | 1998 | `		PH7_MemObjToBool(pTos);` |
|       71 | 1999 | `	}` |
|    50759 | 2000 | `	pTos->x.iVal = !pTos->x.iVal;` |
|    50759 | 2001 | `	break;` |
|        - | 2002 | `/*` |
|        - | 2003 | ` * OP_BITNOT: * * *` |
|        - | 2004 | ` *` |
...
|        - | 2171 | `	VmOpRc rcOp;` |
|    24287 | 2172 | `	sState.pTos = pTos;` |
|    24287 | 2173 | `	sState.pc = pc;` |
|    24287 | 2174 | `	rcOp = VmExecOpSub(&(*pVm),&sState,pInstr);` |
|    24287 | 2175 | `	pTos = sState.pTos;` |
|    24287 | 2176 | `	pc = sState.pc;` |
|    24287 | 2177 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2178 | `		goto Abort;` |
|    24287 | 2179 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2526 | ` * back.` |
|        - | 2527 | ` */` |
|    86497 | 2528 | `case PH7_OP_CAT:{` |
|        - | 2529 | `	ph7_value *pNos,*pCur;` |
|   172999 | 2530 | `	if( pInstr->iP1 < 1 ){` |
|   144545 | 2531 | `		pNos = &pTos[-1];` |
|    72275 | 2532 | `	}else{` |
|    28459 | 2533 | `		pNos = &pTos[-pInstr->iP1+1];` |
|        - | 2534 | `	}` |
|        - | 2535 | `#ifdef UNTRUST` |
|        - | 2536 | `	if( pNos < pStack ){` |
|        - | 2537 | `		goto Abort;` |
...
|   172999 | 2541 | `	if( (pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|     1921 | 2542 | `		PH7_MemObjToString(pNos);` |
|      958 | 2543 | `	}` |
|   172999 | 2544 | `	pCur = &pNos[1];` |
|   349531 | 2545 | `	while( pCur <= pTos ){` |
|   176537 | 2546 | `		if( (pCur->iFlags & MEMOBJ_STRING) == 0 ){` |
|    52213 | 2547 | `			PH7_MemObjToString(pCur);` |
|    26104 | 2548 | `		}` |
|        - | 2549 | `		/* Perform the concatenation */` |
|   176537 | 2550 | `		if( SyBlobLength(&pCur->sBlob) > 0 ){` |
|   176389 | 2551 | `			if( PH7_MemObjStringAppend(pNos,(const char *)SyBlobData(&pCur->sBlob),SyBlobLength(&pCur->sBlob)) != SXRET_OK ){` |
|        - | 2552 | `				/* Allocation failure: raise a fatal instead of a truncated concat */` |
|      ! 0 | 2553 | `				PH7_VmMemoryError(&(*pVm));` |
|      ! 0 | 2554 | `				goto Abort;` |
|        - | 2555 | `			}` |
|    88192 | 2556 | `		}` |
|   176537 | 2557 | `		SyBlobRelease(&pCur->sBlob);` |
|   176537 | 2558 | `		pCur++;` |
|        5 | 2559 | `	}` |
|   172999 | 2560 | `	pTos = pNos;` |
|   172999 | 2561 | `	break;` |
|        - | 2562 | `				}` |
|        - | 2563 | `/*  CAT_STORE: * * *` |
|        - | 2564 | ` *` |
...
|        - | 2668 | ` * stack.` |
|        - | 2669 | ` */` |
|   113454 | 2670 | `case PH7_OP_LAND:` |
|        - | 2671 | `case PH7_OP_LOR: {` |
|        - | 2672 | `	VmOpRc rcOp;` |
|   227120 | 2673 | `	sState.pTos = pTos;` |
|   227120 | 2674 | `	sState.pc = pc;` |
|   227120 | 2675 | `	rcOp = VmExecOpLor(&(*pVm),&sState,pInstr);` |
|   227120 | 2676 | `	pTos = sState.pTos;` |
|   227120 | 2677 | `	pc = sState.pc;` |
|   227120 | 2678 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2679 | `		goto Abort;` |
|   227120 | 2680 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2895 | ` */` |
|     5443 | 2896 | `case PH7_OP_EQ:` |
|        - | 2897 | `case PH7_OP_NEQ: {` |
|        - | 2898 | `	VmOpRc rcOp;` |
|    10891 | 2899 | `	sState.pTos = pTos;` |
|    10891 | 2900 | `	sState.pc = pc;` |
|    10891 | 2901 | `	rcOp = VmExecOpNeq(&(*pVm),&sState,pInstr);` |
|    10891 | 2902 | `	pTos = sState.pTos;` |
|    10891 | 2903 | `	pc = sState.pc;` |
|    10891 | 2904 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2905 | `		goto Abort;` |
|    10891 | 2906 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2917 | ` */` |
|   227706 | 2918 | `case PH7_OP_TEQ: {` |
|        - | 2919 | `	VmOpRc rcOp;` |
|   455623 | 2920 | `	sState.pTos = pTos;` |
|   455623 | 2921 | `	sState.pc = pc;` |
|   455623 | 2922 | `	rcOp = VmExecOpTeq(&(*pVm),&sState,pInstr);` |
|   455623 | 2923 | `	pTos = sState.pTos;` |
|   455623 | 2924 | `	pc = sState.pc;` |
|   455623 | 2925 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2926 | `		goto Abort;` |
|   455623 | 2927 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2939 | ` *` |
|        - | 2940 | ` */` |
|   189530 | 2941 | `case PH7_OP_TNE: {` |
|        - | 2942 | `	VmOpRc rcOp;` |
|   379271 | 2943 | `	sState.pTos = pTos;` |
|   379271 | 2944 | `	sState.pc = pc;` |
|   379271 | 2945 | `	rcOp = VmExecOpTne(&(*pVm),&sState,pInstr);` |
|   379271 | 2946 | `	pTos = sState.pTos;` |
|   379271 | 2947 | `	pc = sState.pc;` |
|   379271 | 2948 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2949 | `		goto Abort;` |
|   379271 | 2950 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2974 | `case PH7_OP_LE: {` |
|        - | 2975 | `	VmOpRc rcOp;` |
|   290732 | 2976 | `	sState.pTos = pTos;` |
|   290732 | 2977 | `	sState.pc = pc;` |
|   290732 | 2978 | `	rcOp = VmExecOpLe(&(*pVm),&sState,pInstr);` |
|   290732 | 2979 | `	pTos = sState.pTos;` |
|   290732 | 2980 | `	pc = sState.pc;` |
|   290732 | 2981 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2982 | `		goto Abort;` |
|   290732 | 2983 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3007 | `case PH7_OP_GE: {` |
|        - | 3008 | `	VmOpRc rcOp;` |
|   170831 | 3009 | `	sState.pTos = pTos;` |
|   170831 | 3010 | `	sState.pc = pc;` |
|   170831 | 3011 | `	rcOp = VmExecOpGe(&(*pVm),&sState,pInstr);` |
|   170831 | 3012 | `	pTos = sState.pTos;` |
|   170831 | 3013 | `	pc = sState.pc;` |
|   170831 | 3014 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 3015 | `		goto Abort;` |
|   170831 | 3016 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3390 | ` */` |
|    12030 | 3391 | `case PH7_OP_FOREACH_INIT: {` |
|        - | 3392 | `	VmOpRc rcOp;` |
|    24065 | 3393 | `	sState.pTos = pTos;` |
|    24065 | 3394 | `	sState.pc = pc;` |
|    24065 | 3395 | `	rcOp = VmExecOpForeachInit(&(*pVm),&sState,pInstr);` |
|    24065 | 3396 | `	pTos = sState.pTos;` |
|    24065 | 3397 | `	pc = sState.pc;` |
|    24065 | 3398 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 3399 | `		goto Abort;` |
|    24065 | 3400 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3408 | ` */` |
|   120851 | 3409 | `case PH7_OP_FOREACH_STEP: {` |
|        - | 3410 | `	VmOpRc rcOp;` |
|   241707 | 3411 | `	sState.pTos = pTos;` |
|   241707 | 3412 | `	sState.pc = pc;` |
|   241707 | 3413 | `	rcOp = VmExecOpForeachStep(&(*pVm),&sState,pInstr);` |
|   241707 | 3414 | `	pTos = sState.pTos;` |
|   241707 | 3415 | `	pc = sState.pc;` |
|   241707 | 3416 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 3417 | `		goto Abort;` |
|   241705 | 3418 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|  1040316 | 3831 | `	sxi32 nCallArgs = pInstr->iP1 + (pInstr->iP2 ? VmSpreadOwnExtra(pVm,pInstr->iP1,pTos) : 0);` |
|        - | 3832 | `	ph7_value *pArg;` |
|  1040316 | 3833 | `	pArg = &pTos[-nCallArgs];` |
...
|  1040316 | 3842 | `	VmCallArgMap *pEffCallMap = (VmCallArgMap *)pInstr->p3;` |
...
|  1040316 | 3849 | `	if( VmValueIsClosure(pVm,pTos) ){` |
...
|  1040316 | 3859 | `	if( (pTos->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|      142 | 4054 | `		break;` |
|        - | 4055 | `	}` |
|  1040156 | 4056 | `	SyStringInitFromBuf(&sName,SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
...
|  1040156 | 4060 | `	if( sName.nByte > 0 && sName.zString[0] == '\\' ){` |
...
|  1040156 | 4067 | `	pEntry = SyHashGet(&pVm->hFunction,(const void *)sName.zString,sName.nByte);` |
...
|        - | 4073 | `	{` |
|  1040156 | 4074 | `	VmCallArgMap *pCallMap = pEffCallMap;` |
|  1040156 | 4075 | `	if( pEntry == 0 && pCallMap && pCallMap->bIsNamespaced ){` |
...
|        - | 4106 | `		VmSlot sArg;` |
|        - | 4107 | `		sxu32 n;` |
|   105199 | 4108 | `		int bClosureThis = 0;` |
|   105199 | 4109 | `		ph7_class *pClosureScope = 0;` |
|        - | 4110 | `		/* initialize fields */` |
|   105199 | 4111 | `		pVmFunc = (ph7_vm_func *)pEntry->pUserData;` |
|   105199 | 4112 | `		pThis = 0;` |
|   105199 | 4113 | `		pSelf = 0;` |
...
|       14 | 4128 | `		}` |
|   105199 | 4129 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
...
|   157899 | 4236 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   105194 | 4237 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
...
|   105199 | 4244 | `		if( VmRecursionExceeded(pVm) ){` |
...
|        3 | 4248 | `			goto Abort;` |
|        - | 4249 | `		}` |
|   105197 | 4250 | `		if( pVmFunc->pNextName ){` |
...
|   105197 | 4262 | `		pSelfHint = pSelf;` |
|   105197 | 4263 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
...
|    12307 | 4267 | `			}` |
|    12820 | 4268 | `		}` |
|   105197 | 4269 | `		if( pSelf == 0 && (pVmFunc->iFlags & VM_FUNC_CLOSURE) ){` |
...
|       29 | 4280 | `			}` |
|      887 | 4281 | `		}` |
|   105197 | 4282 | `		if( SySetUsed(&pVmFunc->aAttrs) > 0 ){` |
...
|       56 | 4287 | `		}` |
|   105197 | 4288 | `		if( pVmFunc->iFlags & VM_FUNC_GENERATOR ){` |
...
|   104857 | 4520 | `		aFormalArg = (ph7_vm_func_arg *)SySetBasePtr(&pVmFunc->aArgs);` |
|        - | 4521 | `		/* Create a new VM frame  */` |
|   104857 | 4522 | `		rc = VmEnterFrame(&(*pVm),pVmFunc,pThis,&pFrame);` |
|   104857 | 4523 | `		if( rc != SXRET_OK ){` |
...
|   104857 | 4551 | `		pFrame->nActualArgs = (int)(pTos - pArg);` |
|   104857 | 4552 | `		if( pThis && ((pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) \|\| bClosureThis) ){` |
...
|    12394 | 4560 | `			}` |
|    12394 | 4561 | `		}` |
|   104857 | 4562 | `		if( SySetUsed(&pVmFunc->aStatic) > 0 ){` |
...
|        - | 4589 | `		{` |
|   104857 | 4590 | `		VmCallArgMap *pCallMap3 = pEffCallMap;` |
|        - | 4591 | `		/* Caller file's strict_types mode — governs parameter coercion` |
|        - | 4592 | `		 * (but NOT return coercion, which uses the callee's file). */` |
|   104857 | 4593 | `		int bCallIsStrict = (pCallMap3 && pCallMap3->bStrict) ? 1 : 0;` |
|   104857 | 4594 | `		if( pCallMap3 && pCallMap3->bHasNamed ){` |
|        - | 4595 | `			/* ============================================================` |
...
|        - | 4980 | `		 * ============================================================ */` |
|   104589 | 4981 | `		n = 0;` |
|   268811 | 4982 | `		while( pArg < pTos ){` |
|   164527 | 4983 | `			if( n < SySetUsed(&pVmFunc->aArgs) && (aFormalArg[n].iFlags & VM_FUNC_ARG_VARIADIC) ){` |
...
|        - | 5083 | `			}` |
|   164327 | 5084 | `			if( n < SySetUsed(&pVmFunc->aArgs) ){` |
...
|   163821 | 5091 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_UNION ){` |
...
|   163734 | 5124 | `				if( aFormalArg[n].nType > 0` |
...
|       13 | 5201 | `					}` |
|     6967 | 5202 | `				}` |
|   163723 | 5203 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_BY_REF ){` |
...
|   163483 | 5255 | `					pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|        - | 5256 | `				}` |
|    82069 | 5257 | `			}else{` |
|        - | 5258 | `				char zName[32];` |
...
|        - | 5265 | `			}` |
|   164227 | 5266 | `			if( pObj ){` |
|   163991 | 5267 | `				PH7_MemObjStore(pArg,pObj);` |
|        - | 5268 | `				/* Insert argument index  */` |
|   163991 | 5269 | `				sArg.nIdx = pObj->nIdx;` |
|   163991 | 5270 | `				sArg.pUserData = 0;` |
|   163991 | 5271 | `				SySetPut(&pFrame->sArg,(const void *)&sArg);` |
|    82199 | 5272 | `			}` |
|   164227 | 5273 | `			PH7_MemObjRelease(pArg);` |
|   164227 | 5274 | `			pArg++;` |
|   164227 | 5275 | `			++n;` |
|        5 | 5276 | `		}` |
|        - | 5277 | `		} /* end named vs positional branch */` |
|        - | 5278 | `		/* Set up closure environment */` |
|   104735 | 5279 | `		if( pVmFunc->iFlags & VM_FUNC_CLOSURE ){` |
...
|   104730 | 5327 | `		if( n < SySetUsed(&pVmFunc->aArgs)` |
...
|   116751 | 5351 | `		while( n < SySetUsed(&pVmFunc->aArgs) ){` |
...
|        - | 5394 | `		 */` |
|   104713 | 5395 | `		PH7_MemObjRelease(pTos);` |
|   104713 | 5396 | `		pTos = &pTos[-nCallArgs];` |
...
|        - | 5408 | `		 * per function. */` |
|        - | 5409 | `		{` |
|   104713 | 5410 | `			sxu32 nSlots = pVmFunc->nMaxStack;` |
|   104713 | 5411 | `			if( nSlots == 0 ){` |
...
|     4125 | 5418 | `			}` |
|   104713 | 5419 | `			pFrameStack = VmOperandStackAlloc(&(*pVm),nSlots);` |
|        - | 5420 | `		}` |
|   104713 | 5421 | `		if( pFrameStack == 0 ){` |
...
|      ! 0 | 5428 | `			break;` |
|        - | 5429 | `		}` |
|    52251 | 5430 | `SkipFuncBody:` |
|   104847 | 5431 | `		if( pSelf ){` |
|        - | 5432 | `			/* Push class name */` |
|    25699 | 5433 | `			SySetPut(&pVm->aSelf,(const void *)&pSelf);` |
|    12847 | 5434 | `		}` |
|        - | 5435 | `		/* Increment nesting level */` |
|   104847 | 5436 | `		pVm->nRecursionDepth++;` |
|   104847 | 5437 | `		if( rc == PH7_EXCEPTION ){` |
...
|   104713 | 5466 | `			VmCallFrame *pRec = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   104713 | 5467 | `			if( pRec ){` |
|   102077 | 5468 | `				pVm->pIdleCallFrames = (void *)pRec->pPrev;` |
|    51144 | 5469 | `			}else{` |
|     2641 | 5470 | `				pRec = (VmCallFrame *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmCallFrame));` |
|        - | 5471 | `			}` |
|   104713 | 5472 | `			if( pRec == 0 ){` |
...
|      ! 0 | 5483 | `				goto Abort;` |
|        - | 5484 | `			}` |
|   104713 | 5485 | `			sState.pTos = pTos;` |
|   104713 | 5486 | `			sState.pc = pc;` |
|   104713 | 5487 | `			pRec->sCaller = sState;` |
|   104713 | 5488 | `			pRec->sCall.pVmFunc = pVmFunc;` |
|   104713 | 5489 | `			pRec->sCall.pFrame = pFrame;` |
|   104713 | 5490 | `			pRec->sCall.pFrameStack = pFrameStack;` |
|   104713 | 5491 | `			pRec->sCall.nStackCap = pVmFunc->nMaxStack + VM_STACK_GUARD;` |
|   104713 | 5492 | `			pRec->sCall.nLastRef = SXU32_HIGH;` |
|   104713 | 5493 | `			pRec->sCall.bSelfPushed = (sxu8)(pSelf ? 1 : 0);` |
|   104713 | 5494 | `			pRec->pPrev = pCallTop;` |
|   104713 | 5495 | `			pCallTop = pRec;` |
|        - | 5496 | `			/* Switch to the callee activation (what the recursive` |
|        - | 5497 | `			 * VmByteCodeExec entry used to set up). */` |
|   104713 | 5498 | `			aInstr = (VmInstr *)SySetBasePtr(&pVmFunc->aByteCode);` |
|   104713 | 5499 | `			pStack = pFrameStack;` |
|   104713 | 5500 | `			pTos = &pStack[-1];` |
|   104713 | 5501 | `			pc = 0;` |
|   104713 | 5502 | `			sState.aInstr = aInstr;` |
|   104713 | 5503 | `			sState.pStack = pStack;` |
|   104713 | 5504 | `			sState.nStackCap = pRec->sCall.nStackCap; /* callee's operand-stack capacity for OP_SPREAD growth */` |
|   104713 | 5505 | `			sState.nStackOrig = pRec->sCall.nStackCap; /* fixed headroom reference (never grows) */` |
|   104713 | 5506 | `			sState.pTos = pTos;` |
|   104713 | 5507 | `			sState.pc = 0;` |
|   104713 | 5508 | `			sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|   104713 | 5509 | `			sState.pEntryFrame = pVm->pFrame;` |
|   104713 | 5510 | `			sState.pResult = pRec->sCaller.pTos;` |
|   104713 | 5511 | `			sState.pLastRef = &pRec->sCall.nLastRef;` |
|   104713 | 5512 | `			sState.pEnforceRetFunc = VmFuncHasReturnType(pVmFunc) ? pVmFunc : 0;` |
|   104713 | 5513 | `			sState.is_callback = 0;` |
|   104713 | 5514 | `			sState.bReturnPropagates = 0;` |
|   104713 | 5515 | `			goto VmLoopFetch;` |
|        - | 5516 | `		}` |
|       57 | 5517 | `	}else{` |
...
|   934962 | 5526 | `		pEntry = SyHashGet(&pVm->hHostFunction,(const void *)sName.zString,sName.nByte);` |
|        - | 5527 | `		{` |
|   934962 | 5528 | `		VmCallArgMap *pCallMap2 = pEffCallMap;` |
|   934962 | 5529 | `		if( pEntry == 0 && pCallMap2 && pCallMap2->bIsNamespaced ){` |
...
|        - | 5634 | `			}` |
|        - | 5635 | `		}` |
|   934946 | 5636 | `		pFunc = (ph7_user_func *)pEntry->pUserData;` |
...
|  1402782 | 5641 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   934941 | 5642 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
|        - | 5643 | `		/* Start collecting function arguments */` |
|   934946 | 5644 | `		SySetReset(&aArg);` |
|  2526989 | 5645 | `		while( pArg < pTos ){` |
|  1592048 | 5646 | `			SySetPut(&aArg,(const void *)&pArg);` |
|  1592048 | 5647 | `			pArg++;` |
|        5 | 5648 | `		}` |
|        - | 5649 | `		/* Assume a null return value */` |
|   934946 | 5650 | `		PH7_MemObjInit(&(*pVm),&sRet);` |
|        - | 5651 | `		/* Init the call context */` |
|   934946 | 5652 | `		VmInitCallContext(&sCtx,&(*pVm),pFunc,&sRet,0);` |
...
|   934946 | 5659 | `		sCtx.pArgMap = pEffCallMap;` |
|        - | 5660 | `		{` |
|   934946 | 5661 | `		int nGiven = (int)SySetUsed(&aArg);` |
...
|   934946 | 5667 | `		if( pFunc->nMinArg > 0 && nGiven < pFunc->nMinArg ){` |
...
|      232 | 5674 | `				nGiven);` |
|   934714 | 5675 | `		}else if( pFunc->bHasMaxArg && nGiven > (int)pFunc->nMaxArg ){` |
...
|       40 | 5688 | `				nGiven);` |
|  1402006 | 5689 | `		}else if( SXRET_OK != (rc = VmEnforceBuiltinArgTypes(&sCtx,pFunc,nGiven,` |
|   934397 | 5690 | `			(ph7_value **)SySetBasePtr(&aArg))) ){` |
|        - | 5691 | `			/* TypeError thrown: rc carries the caught/uncaught status */` |
|      112 | 5692 | `		}else{` |
|        - | 5693 | `			/* Call the foreign function */` |
|   934188 | 5694 | `			rc = pFunc->xFunc(&sCtx,nGiven,(ph7_value **)SySetBasePtr(&aArg));` |
|        - | 5695 | `		}` |
|        - | 5696 | `		}` |
|        - | 5697 | `		/* Release the call context */` |
|   934946 | 5698 | `		VmReleaseCallContext(&sCtx);` |
|   934946 | 5699 | `		if( rc == PH7_ABORT ){` |
...
|      578 | 5704 | `			goto Abort;` |
|        - | 5705 | `		}` |
|   934372 | 5706 | `		if( rc != PH7_SUSPEND && pVm->pInlineInstr == (void *)aInstr ){` |
...
|      ! 0 | 5719 | `		}` |
|   934368 | 5720 | `		if( rc == PH7_EXCEPTION ){` |
...
|      839 | 5740 | `			break;` |
|        - | 5741 | `		}` |
|   933336 | 5742 | `		if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|   912006 | 5766 | `			VmPopOperand(&pTos,nCallArgs);` |
|   456366 | 5767 | `		}` |
|        - | 5768 | `		/* Save foreign function return value into the (now top) function-name slot */` |
|   932982 | 5769 | `		PH7_MemObjStore(&sRet,pTos);` |
|   932982 | 5770 | `		PH7_MemObjRelease(&sRet);` |
|        - | 5771 | `	}` |
|   933086 | 5772 | `	break;` |
|        - | 5773 | `				  }` |
|        - | 5774 | `/*` |
...
|        - | 5777 | ` */` |
|    25925 | 5778 | `case PH7_OP_CONSUME: {` |
|        - | 5779 | `	VmOpRc rcOp;` |
|    51855 | 5780 | `	sState.pTos = pTos;` |
|    51855 | 5781 | `	sState.pc = pc;` |
|    51855 | 5782 | `	rcOp = VmExecOpConsume(&(*pVm),&sState,pInstr);` |
|    51855 | 5783 | `	pTos = sState.pTos;` |
|    51855 | 5784 | `	pc = sState.pc;` |
|    51855 | 5785 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 5786 | `		goto Abort;` |
|    51855 | 5787 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 5792 |  |
|        - | 5793 | `		} /* Switch() */` |
| 16618616 | 5794 | `		pc++; /* Next instruction in the stream */` |
|        5 | 5795 | `	} /* For(;;) */` |
|   130842 | 5796 | `Done:` |
...
|   261895 | 5800 | `	rc = SXRET_OK;` |
|   261895 | 5801 | `	goto Unwind;` |
|      823 | 5802 | `Suspend:` |
...
|   132847 | 5860 | `	for(;;){` |
|   265493 | 5861 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|      ! 0 | 5869 | `			}` |
|     1153 | 5870 | `		}` |
|   265493 | 5871 | `		if( pCallTop == 0 ){` |
|   161195 | 5872 | `			return VmExecFinalize(&(*pVm),&sState,&aArg,pTos,rc);` |
|        - | 5873 | `		}` |
|   104303 | 5874 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|      627 | 5880 | `		}` |
|        - | 5881 | `		{` |
|   104303 | 5882 | `			VmCallFrame *pRec = pCallTop;` |
|   104303 | 5883 | `			sState = pRec->sCaller;` |
|   104303 | 5884 | `			rc = VmCallFinish(&(*pVm),&sState,&pRec->sCall,rc);` |
|   104303 | 5885 | `			pCallTop = pRec->pPrev;` |
|   104303 | 5886 | `			pRec->pPrev = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   104303 | 5887 | `			pVm->pIdleCallFrames = (void *)pRec;` |
|   104303 | 5888 | `			aInstr = sState.aInstr;` |
|   104303 | 5889 | `			pStack = sState.pStack;` |
|   104303 | 5890 | `			pTos = sState.pTos;` |
|   104303 | 5891 | `			pc = sState.pc;` |
|        - | 5892 | `		}` |
|   104303 | 5893 | `		if( rc == PH7_OK ){` |
|   103537 | 5894 | `			pc++; /* the loop-bottom increment this OP_CALL missed */` |
|   103537 | 5895 | `			goto VmLoopFetch;` |
|        - | 5896 | `		}` |
|        5 | 5897 | `	}` |
|    80777 | 5898 | `}` |
|        - | 5899 |  |
