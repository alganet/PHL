...
|        - |  162 | ` */` |
|   157040 |  163 | `static sxi32 VmExecFinalize(ph7_vm *pVm,VmExecState *pState,SySet *pArg,ph7_value *pTos,sxi32 rcTerm)` |
|        5 |  164 | `{` |
|    78520 |  165 | `	SXUNUSED(pVm);` |
|   157045 |  166 | `	if( rcTerm != PH7_SUSPEND && !pState->bReturnPropagates ){` |
|   153405 |  167 | `		VmClearFrameReturn(pState->pEntryFrame);` |
|    76700 |  168 | `	}` |
|   157045 |  169 | `	SySetRelease(pArg);` |
|   157045 |  170 | `	if( rcTerm == PH7_ABORT \|\| rcTerm == PH7_EXCEPTION ){` |
|     2835 |  171 | `		while( pTos >= pState->pStack ){` |
|     1785 |  172 | `			PH7_MemObjRelease(pTos);` |
|     1785 |  173 | `			pTos--;` |
|        5 |  174 | `		}` |
|      525 |  175 | `	}` |
|   157045 |  176 | `	return rcTerm;` |
|        5 |  177 | `}` |
|        - |  178 | `/*` |
...
|        - |  189 | ` */` |
|   104486 |  190 | `static sxi32 VmCallFinish(ph7_vm *pVm,VmExecState *pCaller,VmCallRecord *pCallee,sxi32 rc)` |
|        5 |  191 | `{` |
|        - |  192 | `	ph7_value *pObj;` |
|        - |  193 | `	/* Decrement nesting level */` |
|   104491 |  194 | `	pVm->nRecursionDepth--;` |
|   104491 |  195 | `	if( pCallee->bSelfPushed ){` |
|        - |  196 | `		/* Pop class name */` |
|    25405 |  197 | `		(void)SySetPop(&pVm->aSelf);` |
|    12700 |  198 | `	}` |
|   104491 |  199 | `	if( (pCallee->pVmFunc->iFlags & VM_FUNC_REF_RETURN) && rc == SXRET_OK ){` |
...
|       25 |  225 | `	}` |
|   104491 |  226 | `	if( rc != PH7_ABORT && ((pCallee->pFrame->iFlags & VM_FRAME_THROW) \|\| rc == PH7_EXCEPTION) ){` |
...
|   104491 |  272 | `	if( rc != PH7_SUSPEND && pCallee->pFrameStack ){` |
...
|   104357 |  276 | `		VmOperandStackRecycle(pVm,pCallee->pFrameStack,pCallee->nStackCap);` |
|    52279 |  277 | `	}` |
|        - |  278 | `	/* Leave the frame */` |
|   104491 |  279 | `	VmLeaveFrame(&(*pVm));` |
|   104491 |  280 | `	if( rc == PH7_ABORT ){` |
|      336 |  281 | `		return PH7_ABORT;` |
|        - |  282 | `	}` |
|   104159 |  283 | `	if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|        - |  291 | `	}` |
|   104159 |  292 | `	if( rc == PH7_EXCEPTION ){` |
|      469 |  293 | `		return PH7_EXCEPTION;` |
|        - |  294 | `	}` |
|   103695 |  295 | `	return PH7_OK;` |
|    52351 |  296 | `}` |
|        - |  297 | `/*` |
...
|        - |  330 | ` * nesting.` |
|        - |  331 | ` */` |
|   157398 |  332 | `PH7_PRIVATE sxi32 VmByteCodeExec(` |
...
|   157403 |  352 | `	if( VmNativeNestingExceeded(pVm) ){` |
...
|   157399 |  362 | `	nSavedBrc = pVm->nBoundaryRc;` |
|   157399 |  363 | `	pVm->nBoundaryRc = 0;` |
...
|   157399 |  370 | `	nSavedLine = pVm->nCurLine;` |
|   157399 |  371 | `	pVm->nVmExecDepth++;` |
|   236096 |  372 | `	rc = VmByteCodeExecBody(&(*pVm),aInstr,pStack,nTos,pResult,pLastRef,is_callback,nPc,` |
|    78697 |  373 | `		pEnforceRetFunc,bReturnPropagates,pAdoptSegment,ppBaseOwner,pnBaseCap,nStackOrig);` |
|   157399 |  374 | `	pVm->nVmExecDepth--;` |
|   157399 |  375 | `	pVm->nCurLine = nSavedLine;` |
|   157399 |  376 | `	if( nSavedBrc != 0 && (nSavedBrc == PH7_ABORT \|\| pVm->nBoundaryRc == 0) ){` |
|       15 |  377 | `		pVm->nBoundaryRc = nSavedBrc;` |
|        6 |  378 | `	}` |
|   157399 |  379 | `	return rc;` |
|    78704 |  380 | `}` |
|   157394 |  381 | `static sxi32 VmByteCodeExecBody(` |
...
|        - |  399 | `	ph7_value *pTos;` |
|        - |  400 | `	SySet aArg;` |
|   157399 |  401 | `	VmCallFrame *pCallTop = 0; /* Top of this invocation's in-loop call-record` |
...
|        - |  409 | `	sxi32 pc;` |
|        - |  410 | `	sxi32 rc;` |
|   157399 |  411 | `	sState.aInstr = aInstr;` |
|   157399 |  412 | `	sState.pStack = pStack;` |
|   157399 |  413 | `	sState.nStackCap = pnBaseCap ? *pnBaseCap : 0; /* CURRENT capacity (grown on a coroutine resume) */` |
|   157399 |  414 | `	sState.nStackOrig = nStackOrig;                /* ORIGINAL capacity — fixed headroom reference */` |
|   157399 |  415 | `	sState.pResult = pResult;` |
|   157399 |  416 | `	sState.pLastRef = pLastRef;` |
|   157399 |  417 | `	sState.pEnforceRetFunc = pEnforceRetFunc;` |
|   157399 |  418 | `	sState.is_callback = (sxu8)(is_callback ? 1 : 0);` |
|   157399 |  419 | `	sState.bReturnPropagates = (sxu8)(bReturnPropagates ? 1 : 0);` |
|        - |  420 | `	/* Argument container */` |
|   157399 |  421 | `	SySetInit(&aArg,&pVm->sAllocator,sizeof(ph7_value *));` |
|   157399 |  422 | `	if( nTos < 0 ){` |
|   141679 |  423 | `		pTos = &pStack[-1];` |
|    70842 |  424 | `	}else{` |
|    15725 |  425 | `		pTos = &pStack[nTos];` |
|        - |  426 | `	}` |
|   157399 |  427 | `	sState.pTos = pTos;` |
|   157399 |  428 | `	sState.pc = nPc;` |
...
|   157394 |  446 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->pFrame == pVm->pFrame` |
|     2816 |  447 | `	 && pStack == pVm->pActiveCtx->pStack ){` |
|     1805 |  448 | `		sState.nExceptionBase = pVm->pActiveCtx->nExceptionBase;` |
|      905 |  449 | `	}else{` |
|   155599 |  450 | `		sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|        - |  451 | `	}` |
|   157399 |  452 | `	sState.pEntryFrame = pVm->pFrame;` |
|   157399 |  453 | `	pc = nPc;` |
...
|   157394 |  506 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->pInjected` |
...
|   157384 |  567 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->bClosing` |
...
| 16817932 |  603 | `		if( pVm->nBoundaryRc != 0 \|\| SySetUsed(&pVm->aHookRmw) > 0 ){` |
...
| 16817846 |  658 | `		pInstr = &aInstr[pc];` |
| 16817846 |  659 | `		if( pInstr->nLine ){` |
...
| 16604902 |  663 | `			pVm->nCurLine = pInstr->nLine;` |
|  8308821 |  664 | `		}` |
| 16817846 |  665 | `		rc = SXRET_OK;` |
|        - |  666 | `/*` |
...
|        - |  672 | ` */` |
| 16817846 |  673 | `		switch(pInstr->iOp){` |
|        - |  674 | `/*` |
|        - |  675 | ` * DONE: P1 * *` |
|        - |  676 | ` *` |
...
|        - |  679 | ` */` |
|   128695 |  680 | `case PH7_OP_DONE:` |
|   257601 |  681 | `	if( pInstr->iP2 && sState.bReturnPropagates ){` |
...
|   257412 |  711 | `	if( sState.pEnforceRetFunc && VmFuncHasReturnType(sState.pEnforceRetFunc)` |
...
|     4591 |  736 | `	}` |
|   257393 |  737 | `	if( pInstr->iP1 && pTos >= pStack ){` |
|   152917 |  738 | `		if( sState.pLastRef ){` |
|    94079 |  739 | `			*sState.pLastRef = pTos->nIdx;` |
|    47140 |  740 | `		}` |
|   152917 |  741 | `		if( sState.pResult ){` |
|        - |  742 | `			/* Execution result */` |
|   145899 |  743 | `			PH7_MemObjStore(pTos,sState.pResult);` |
|    73050 |  744 | `		}` |
|   152917 |  745 | `		VmPopOperand(&pTos,1);` |
|   181040 |  746 | `	}else if( sState.pLastRef ){` |
...
|     8877 |  752 | `		*sState.pLastRef = SXU32_HIGH;` |
|     4436 |  753 | `	}` |
...
|        - |  762 | `	 */` |
|   257393 |  763 | `	rc = VmDrainFinally(&(*pVm),sState.nExceptionBase);` |
|   257393 |  764 | `	if( rc == SXERR_ABORT ){` |
|      ! 0 |  765 | `		goto Abort;` |
|        - |  766 | `	}` |
|   257393 |  767 | `	if( rc == PH7_EXCEPTION ){` |
...
|        - |  778 | `	}` |
|   257389 |  779 | `	if( sState.pEntryFrame->bHasRet && !sState.bReturnPropagates ){` |
...
|        - |  835 | ` */` |
|   288626 |  836 | `case PH7_OP_JMP:` |
|   577464 |  837 | `	pc = pInstr->iP2 - 1;` |
|   577464 |  838 | `	break;` |
|        - |  839 | `/*` |
|        - |  840 | ` * JZ: P1 P2 *` |
|        - |  841 | ` *` |
...
|  1606230 |  852 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     1003 |  853 | `		PH7_MemObjToBool(pTos);` |
|      500 |  854 | `	}` |
|  1606230 |  855 | `	if( !pTos->x.iVal ){` |
|        - |  856 | `		/* Take the jump */` |
|   900290 |  857 | `		pc = pInstr->iP2 - 1;` |
|   450405 |  858 | `	}` |
|  1606230 |  859 | `	if( !pInstr->iP1 ){` |
|  1357843 |  860 | `		VmPopOperand(&pTos,1);` |
|   679491 |  861 | `	}` |
|  1606230 |  862 | `	break;` |
|        - |  863 | `/*` |
|        - |  864 | ` * JNZ: P1 P2 *` |
...
|   184479 |  876 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      ! 0 |  877 | `		PH7_MemObjToBool(pTos);` |
|      ! 0 |  878 | `	}` |
|   184479 |  879 | `	if( pTos->x.iVal ){` |
|        - |  880 | `		/* Take the jump */` |
|     9549 |  881 | `		pc = pInstr->iP2 - 1;` |
|     4772 |  882 | `	}` |
|   184479 |  883 | `	if( !pInstr->iP1 ){` |
...
|        - |  899 | ` */` |
|   662253 |  900 | `case PH7_OP_POP: {` |
|  1325542 |  901 | `	sxi32 n = pInstr->iP1;` |
|  1325542 |  902 | `	if( &pTos[-n+1] < pStack ){` |
|        - |  903 | `		/* TICKET 1433-51 Stack underflow must be handled at run-time */` |
|       79 |  904 | `		n = (sxi32)(pTos - pStack);` |
|       38 |  905 | `	}` |
|  1325542 |  906 | `	VmPopOperand(&pTos,n);` |
|  1325542 |  907 | `	break;` |
|        - |  908 | `				 }` |
|        - |  909 | `/*` |
|        - |  910 | ` * DUP: * * *` |
...
|        - |  929 | ` */` |
|    49005 |  930 | `case PH7_OP_NSSWITCH:` |
|    98015 |  931 | `	SyBlobReset(&pVm->sNamespace);` |
|    98015 |  932 | `	if( pInstr->p3 ){` |
...
|    98015 |  937 | `	SyHashRelease(&pVm->hUseConstImports);` |
|    98015 |  938 | `	SyHashInit(&pVm->hUseConstImports,&pVm->sAllocator,0,0);` |
|    98015 |  939 | `	break;` |
...
|        - | 1076 | ` */` |
|     3366 | 1077 | `case PH7_OP_UNSET_VAR: {` |
|        - | 1078 | `	VmOpRc rcOp;` |
|     6737 | 1079 | `	sState.pTos = pTos;` |
|     6737 | 1080 | `	sState.pc = pc;` |
|     6737 | 1081 | `	rcOp = VmExecOpUnsetVar(&(*pVm),&sState,pInstr);` |
|     6737 | 1082 | `	pTos = sState.pTos;` |
|     6737 | 1083 | `	pc = sState.pc;` |
|     6737 | 1084 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 1085 | `		goto Abort;` |
|     6735 | 1086 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1163 | ` */` |
|  1511765 | 1164 | `case PH7_OP_LOADC: {` |
|        - | 1165 | `	ph7_value *pObj;` |
|        - | 1166 | `	/* Reserve a room */` |
|  3025410 | 1167 | `	pTos++;` |
|  3025410 | 1168 | `	if( pInstr->iP1 & PH7_LOADC_NOKEY ){` |
|        - | 1169 | `		/* Absent array-literal key: mark it so LOAD_MAP auto-indexes without a diagnostic */` |
|    19105 | 1170 | `		MemObjSetType(pTos,MEMOBJ_NULL);` |
|    19105 | 1171 | `		SyBlobReset(&pTos->sBlob);` |
|    19105 | 1172 | `		pTos->iFlags \|= MEMOBJ_AUX_NOKEY;` |
|    19105 | 1173 | `		pTos->nIdx = SXU32_HIGH;` |
|    19105 | 1174 | `		break;` |
|        - | 1175 | `	}` |
|  3006310 | 1176 | `	if( (pObj = (ph7_value *)SySetAt(&pVm->aLitObj,pInstr->iP2)) != 0 ){` |
|  3006310 | 1177 | `		if( (pInstr->iP1 & PH7_LOADC_EXPAND) && SyBlobLength(&pObj->sBlob) <= 64 ){` |
...
|        - | 1283 | ` */` |
|  2197647 | 1284 | `case PH7_OP_LOAD:{` |
|        - | 1285 | `	ph7_value *pObj;` |
|        - | 1286 | `	SyString sName;` |
|  4399238 | 1287 | `	if( pInstr->p3 == 0 ){` |
...
|        9 | 1299 | `	}else{` |
|  4399222 | 1300 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1301 | `		/* Reserve a room for the target object */` |
|  4399222 | 1302 | `		pTos++;` |
|        - | 1303 | `	}` |
|  4399238 | 1304 | `	if( pInstr->iP2 == 2 ){` |
...
|   393260 | 1310 | `		if( VmExtractMemObj(&(*pVm),&sName,FALSE,FALSE) == 0 ){` |
|        7 | 1311 | `			VmErrorFormat(&(*pVm),PH7_CTX_WARNING,"Undefined variable $%z",&sName);` |
|        3 | 1312 | `		}` |
|   196731 | 1313 | `	}` |
|        - | 1314 | `	/* Extract the requested memory object */` |
|  4399238 | 1315 | `	pObj = VmExtractMemObj(&(*pVm),&sName,pInstr->p3 ? FALSE : TRUE,pInstr->iP1 != 1);` |
|  4399238 | 1316 | `	if( pObj == 0 ){` |
...
|  4399176 | 1341 | `	PH7_MemObjLoad(pObj,pTos);` |
|  4399176 | 1342 | `	pTos->nIdx = pObj->nIdx;` |
|  4399176 | 1343 | `	break;` |
|        - | 1344 | `				   }` |
|        - | 1345 | `/*` |
|        - | 1346 | ` * LOAD_MAP P1 * *` |
...
|        - | 1351 | ` */` |
|    36844 | 1352 | `case PH7_OP_LOAD_MAP: {` |
|        - | 1353 | `	VmOpRc rcOp;` |
|    73693 | 1354 | `	sState.pTos = pTos;` |
|    73693 | 1355 | `	sState.pc = pc;` |
|    73693 | 1356 | `	rcOp = VmExecOpLoadMap(&(*pVm),&sState,pInstr);` |
|    73693 | 1357 | `	pTos = sState.pTos;` |
|    73693 | 1358 | `	pc = sState.pc;` |
|    73693 | 1359 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1360 | `		goto Abort;` |
|    73693 | 1361 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1394 | ` * instead.` |
|        - | 1395 | ` */` |
|   332428 | 1396 | `case PH7_OP_LOAD_IDX: {` |
|        - | 1397 | `	VmOpRc rcOp;` |
|   665593 | 1398 | `	sState.pTos = pTos;` |
|   665593 | 1399 | `	sState.pc = pc;` |
|   665593 | 1400 | `	rcOp = VmExecOpLoadIdx(&(*pVm),&sState,pInstr);` |
|   665593 | 1401 | `	pTos = sState.pTos;` |
|   665593 | 1402 | `	pc = sState.pc;` |
|   665593 | 1403 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1404 | `		goto Abort;` |
|   665593 | 1405 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1507 | `	}` |
|        - | 1508 | `#endif` |
|   595833 | 1509 | `	if( pInstr->iP2 ){` |
|        - | 1510 | `		sxu32 nIdx;` |
|        - | 1511 | `		sxi32 rcT;` |
|        - | 1512 | `		/* Member store operation */` |
|    11773 | 1513 | `		nIdx = pTos->nIdx;` |
|    11773 | 1514 | `		VmPopOperand(&pTos,1);` |
|    11773 | 1515 | `		if( pVm->pMagicSetThis ){` |
...
|       11 | 1528 | `			break;` |
|        - | 1529 | `		}` |
|    11763 | 1530 | `		if( pVm->pHookSetThis ){` |
...
|    11731 | 1558 | `			rcT = VmEnforcePropertyTypeOnStore(&(*pVm),nIdx,pTos,0);` |
|    11731 | 1559 | `			if( rcT == PH7_ABORT ){` |
|       13 | 1560 | `				goto Abort;` |
|        - | 1561 | `			}` |
|    11721 | 1562 | `			if( rcT == PH7_EXCEPTION ){` |
...
|    11653 | 1577 | `			pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|    11653 | 1578 | `			if( pObj ){` |
|        - | 1579 | `				/* Perform the store operation */` |
|    11653 | 1580 | `				PH7_MemObjStore(pTos,pObj);` |
|     5824 | 1581 | `			}` |
|        - | 1582 | `		}` |
|    11655 | 1583 | `		break;` |
|   584065 | 1584 | `	}else if( pInstr->p3 == 0 ){` |
...
|        - | 1596 | `#endif` |
|        5 | 1597 | `	}else{` |
|   584057 | 1598 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1599 | `	}` |
|   584060 | 1600 | `	if( sName.nByte == sizeof("GLOBALS")-1` |
|   293784 | 1601 | `	 && SyMemcmp((const void *)sName.zString,(const void *)"GLOBALS",sName.nByte) == 0 ){` |
|        6 | 1602 | `		if( pInstr->p3 ){` |
...
|        - | 1639 | ` */` |
|   120396 | 1640 | `case PH7_OP_STORE_IDX:` |
|        - | 1641 | `case PH7_OP_STORE_IDX_REF: {` |
|        - | 1642 | `	VmOpRc rcOp;` |
|   240797 | 1643 | `	sState.pTos = pTos;` |
|   240797 | 1644 | `	sState.pc = pc;` |
|   240797 | 1645 | `	rcOp = VmExecOpStoreIdxRef(&(*pVm),&sState,pInstr);` |
|   240797 | 1646 | `	pTos = sState.pTos;` |
|   240797 | 1647 | `	pc = sState.pc;` |
|   240797 | 1648 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 1649 | `		goto Abort;` |
|   240795 | 1650 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|   367330 | 1671 | `	PH7_ENFORCE_READONLY_MUTATE(pTos->nIdx);` |
...
|   367319 | 1676 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) != 0` |
|   183769 | 1677 | `	 && SySetUsed(&pVm->aHookRmw) > 0 ){` |
...
|        - | 1694 | `		}` |
|      ! 0 | 1695 | `	}` |
|   367322 | 1696 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) == 0 ){` |
|   367322 | 1697 | `		if( pTos->nIdx != SXU32_HIGH ){` |
|        - | 1698 | `			ph7_value *pObj;` |
|   367322 | 1699 | `			if( (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pTos->nIdx)) != 0 ){` |
|   367322 | 1700 | `				if( VmStringWantsPerlIncr(pObj) ){` |
...
|   367320 | 1719 | `					if( pInstr->iP1 == 0 && (pTos->iFlags & MEMOBJ_STRING) ){` |
|        9 | 1720 | `						SyBlobNullAppend(&pTos->sBlob);` |
|        3 | 1721 | `					}` |
|        - | 1722 | `					/* Force a numeric cast on the variable */` |
|   367320 | 1723 | `					PH7_MemObjToNumeric(pObj);` |
|   367320 | 1724 | `					if( pObj->iFlags & MEMOBJ_REAL ){` |
|        5 | 1725 | `						pObj->rVal++;` |
...
|        - | 1734 | `						sxi64 r;` |
|   367316 | 1735 | `						if( PH7_ADD_OVERFLOW64(pObj->x.iVal,1,&r) ){` |
...
|        - | 1741 | `#endif` |
|        3 | 1742 | `						}else{` |
|   367312 | 1743 | `							pObj->x.iVal = r;` |
|        - | 1744 | `						}` |
|        - | 1745 | `					}` |
|   367320 | 1746 | `					if( pInstr->iP1 ){` |
...
|        - | 1785 | `		}` |
|   183761 | 1786 | `	}` |
|   367320 | 1787 | `	PH7_HOOK_RMW_WRITEBACK(pTos->nIdx,pTos);` |
|   367320 | 1788 | `	break;` |
|        - | 1789 | `/*` |
|        - | 1790 | ` * DECR: P1 * *` |
|        - | 1791 | ` *` |
...
|    70575 | 1938 | `	PH7_MemObjToNumeric(pTos);` |
|    70575 | 1939 | `	if( pTos->iFlags & MEMOBJ_REAL ){` |
|      108 | 1940 | `		pTos->rVal = -pTos->rVal;` |
|       53 | 1941 | `	}` |
|    70575 | 1942 | `	if( pTos->iFlags & MEMOBJ_INT ){` |
|    70489 | 1943 | `		if( pTos->x.iVal == SMALLEST_INT64 ){` |
...
|        - | 1958 | `#endif` |
|        3 | 1959 | `		}else{` |
|    70485 | 1960 | `			pTos->x.iVal = -pTos->x.iVal;` |
|        - | 1961 | `		}` |
|    35242 | 1962 | `	}` |
|    70575 | 1963 | `	break;` |
|        - | 1964 | `/*` |
...
|    50845 | 1997 | `	if( (pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      119 | 1998 | `		PH7_MemObjToBool(pTos);` |
|       57 | 1999 | `	}` |
|    50845 | 2000 | `	pTos->x.iVal = !pTos->x.iVal;` |
|    50845 | 2001 | `	break;` |
|        - | 2002 | `/*` |
|        - | 2003 | ` * OP_BITNOT: * * *` |
|        - | 2004 | ` *` |
...
|        - | 2070 | ` */` |
|     6358 | 2071 | `case PH7_OP_ADD:{` |
|    12721 | 2072 | `	ph7_value *pNos = &pTos[-1];` |
|        - | 2073 | `#ifdef UNTRUST` |
|        - | 2074 | `	if( pNos < pStack ){` |
|        - | 2075 | `		goto Abort;` |
|        - | 2076 | `	}` |
...
|        - | 2082 | `		SyBlob sArMsg;` |
|    12721 | 2083 | `		SyBlobInit(&sArMsg,&pVm->sAllocator);` |
|    12721 | 2084 | `		if( VmArithOperandCheck(&(*pVm),pNos,pTos,"+",&sArMsg) != SXRET_OK ){` |
|        - | 2085 | `			sxi32 rcAr;` |
...
|        - | 2096 | `		}` |
|    12713 | 2097 | `		SyBlobRelease(&sArMsg);` |
|        - | 2098 | `	}` |
|        - | 2099 | `	/* Perform the addition */` |
|    12713 | 2100 | `	PH7_MemObjAdd(pNos,pTos,FALSE);` |
|    12713 | 2101 | `	VmPopOperand(&pTos,1);` |
|    12713 | 2102 | `	break;` |
|        - | 2103 | `				}` |
|        - | 2104 | `/*` |
|        - | 2105 | ` * OP_ADD_STORE * * *` |
...
|        - | 2169 | ` */` |
|    12159 | 2170 | `case PH7_OP_SUB: {` |
|        - | 2171 | `	VmOpRc rcOp;` |
|    24436 | 2172 | `	sState.pTos = pTos;` |
|    24436 | 2173 | `	sState.pc = pc;` |
|    24436 | 2174 | `	rcOp = VmExecOpSub(&(*pVm),&sState,pInstr);` |
|    24436 | 2175 | `	pTos = sState.pTos;` |
|    24436 | 2176 | `	pc = sState.pc;` |
|    24436 | 2177 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2178 | `		goto Abort;` |
|    24436 | 2179 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2526 | ` * back.` |
|        - | 2527 | ` */` |
|    86348 | 2528 | `case PH7_OP_CAT:{` |
|        - | 2529 | `	ph7_value *pNos,*pCur;` |
|   172701 | 2530 | `	if( pInstr->iP1 < 1 ){` |
|   144475 | 2531 | `		pNos = &pTos[-1];` |
|    72240 | 2532 | `	}else{` |
|    28231 | 2533 | `		pNos = &pTos[-pInstr->iP1+1];` |
|        - | 2534 | `	}` |
|        - | 2535 | `#ifdef UNTRUST` |
|        - | 2536 | `	if( pNos < pStack ){` |
|        - | 2537 | `		goto Abort;` |
...
|   172701 | 2541 | `	if( (pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|     1931 | 2542 | `		PH7_MemObjToString(pNos);` |
|      963 | 2543 | `	}` |
|   172701 | 2544 | `	pCur = &pNos[1];` |
|   348803 | 2545 | `	while( pCur <= pTos ){` |
|   176107 | 2546 | `		if( (pCur->iFlags & MEMOBJ_STRING) == 0 ){` |
|    52229 | 2547 | `			PH7_MemObjToString(pCur);` |
|    26112 | 2548 | `		}` |
|        - | 2549 | `		/* Perform the concatenation */` |
|   176107 | 2550 | `		if( SyBlobLength(&pCur->sBlob) > 0 ){` |
|   175959 | 2551 | `			if( PH7_MemObjStringAppend(pNos,(const char *)SyBlobData(&pCur->sBlob),SyBlobLength(&pCur->sBlob)) != SXRET_OK ){` |
|        - | 2552 | `				/* Allocation failure: raise a fatal instead of a truncated concat */` |
|      ! 0 | 2553 | `				PH7_VmMemoryError(&(*pVm));` |
|      ! 0 | 2554 | `				goto Abort;` |
|        - | 2555 | `			}` |
|    87977 | 2556 | `		}` |
|   176107 | 2557 | `		SyBlobRelease(&pCur->sBlob);` |
|   176107 | 2558 | `		pCur++;` |
|        5 | 2559 | `	}` |
|   172701 | 2560 | `	pTos = pNos;` |
|   172701 | 2561 | `	break;` |
|        - | 2562 | `				}` |
|        - | 2563 | `/*  CAT_STORE: * * *` |
|        - | 2564 | ` *` |
...
|        - | 2672 | `	VmOpRc rcOp;` |
|   228634 | 2673 | `	sState.pTos = pTos;` |
|   228634 | 2674 | `	sState.pc = pc;` |
|   228634 | 2675 | `	rcOp = VmExecOpLor(&(*pVm),&sState,pInstr);` |
|   228634 | 2676 | `	pTos = sState.pTos;` |
|   228634 | 2677 | `	pc = sState.pc;` |
|   228634 | 2678 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2679 | `		goto Abort;` |
|   228634 | 2680 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2917 | ` */` |
|   228255 | 2918 | `case PH7_OP_TEQ: {` |
|        - | 2919 | `	VmOpRc rcOp;` |
|   456721 | 2920 | `	sState.pTos = pTos;` |
|   456721 | 2921 | `	sState.pc = pc;` |
|   456721 | 2922 | `	rcOp = VmExecOpTeq(&(*pVm),&sState,pInstr);` |
|   456721 | 2923 | `	pTos = sState.pTos;` |
|   456721 | 2924 | `	pc = sState.pc;` |
|   456721 | 2925 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2926 | `		goto Abort;` |
|   456721 | 2927 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2939 | ` *` |
|        - | 2940 | ` */` |
|   174628 | 2941 | `case PH7_OP_TNE: {` |
|        - | 2942 | `	VmOpRc rcOp;` |
|   349467 | 2943 | `	sState.pTos = pTos;` |
|   349467 | 2944 | `	sState.pc = pc;` |
|   349467 | 2945 | `	rcOp = VmExecOpTne(&(*pVm),&sState,pInstr);` |
|   349467 | 2946 | `	pTos = sState.pTos;` |
|   349467 | 2947 | `	pc = sState.pc;` |
|   349467 | 2948 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2949 | `		goto Abort;` |
|   349467 | 2950 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2971 | ` *` |
|        - | 2972 | ` */` |
|   146003 | 2973 | `case PH7_OP_LT:` |
|        - | 2974 | `case PH7_OP_LE: {` |
|        - | 2975 | `	VmOpRc rcOp;` |
|   292424 | 2976 | `	sState.pTos = pTos;` |
|   292424 | 2977 | `	sState.pc = pc;` |
|   292424 | 2978 | `	rcOp = VmExecOpLe(&(*pVm),&sState,pInstr);` |
|   292424 | 2979 | `	pTos = sState.pTos;` |
|   292424 | 2980 | `	pc = sState.pc;` |
|   292424 | 2981 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2982 | `		goto Abort;` |
|   292424 | 2983 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3004 | ` *` |
|        - | 3005 | ` */` |
|    86062 | 3006 | `case PH7_OP_GT:` |
|        - | 3007 | `case PH7_OP_GE: {` |
|        - | 3008 | `	VmOpRc rcOp;` |
|   172335 | 3009 | `	sState.pTos = pTos;` |
|   172335 | 3010 | `	sState.pc = pc;` |
|   172335 | 3011 | `	rcOp = VmExecOpGe(&(*pVm),&sState,pInstr);` |
|   172335 | 3012 | `	pTos = sState.pTos;` |
|   172335 | 3013 | `	pc = sState.pc;` |
|   172335 | 3014 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 3015 | `		goto Abort;` |
|   172335 | 3016 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3113 | ` */` |
|     1359 | 3114 | `case PH7_OP_LOAD_EXCEPTION: {` |
|        - | 3115 | `	VmOpRc rcOp;` |
|     2723 | 3116 | `	sState.pTos = pTos;` |
|     2723 | 3117 | `	sState.pc = pc;` |
|     2723 | 3118 | `	rcOp = VmExecOpLoadException(&(*pVm),&sState,pInstr);` |
|     2723 | 3119 | `	pTos = sState.pTos;` |
|     2723 | 3120 | `	pc = sState.pc;` |
|     2723 | 3121 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 3122 | `		goto Abort;` |
|     2723 | 3123 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3131 | ` */` |
|     1192 | 3132 | `case PH7_OP_POP_EXCEPTION: {` |
|     2389 | 3133 | `	ph7_exception *pCompiledExc = (ph7_exception *)pInstr->p3;` |
...
|     2389 | 3138 | `	ph7_exception *pException = 0;` |
|     2389 | 3139 | `	if( SySetUsed(&pVm->aException) > 0 ){` |
...
|      193 | 3153 | `		}` |
|      200 | 3154 | `	}` |
|     2389 | 3155 | `	if( pCompiledExc->iInlined ){` |
...
|     2235 | 3182 | `	if( pVm->pFrame->iFlags & VM_FRAME_EXCEPTION ){` |
|     1625 | 3183 | `		VmLeaveFrame(&(*pVm));` |
|      810 | 3184 | `	}` |
...
|     2235 | 3188 | `	if( pException && pCompiledExc->iHasFinally && !pException->iFinallyDone ){` |
...
|        - | 3206 | `		}` |
|       12 | 3207 | `	}` |
|     2231 | 3208 | `	VmExcRelease(&(*pVm),pException); /* no-finally / already-done paths (may be NULL) */` |
|     2231 | 3209 | `	if( VmSkipExceptionFrames(pVm->pFrame)->bHasRet ){` |
...
|        - | 3408 | ` */` |
|   130193 | 3409 | `case PH7_OP_FOREACH_STEP: {` |
|        - | 3410 | `	VmOpRc rcOp;` |
|   260391 | 3411 | `	sState.pTos = pTos;` |
|   260391 | 3412 | `	sState.pc = pc;` |
|   260391 | 3413 | `	rcOp = VmExecOpForeachStep(&(*pVm),&sState,pInstr);` |
|   260391 | 3414 | `	pTos = sState.pTos;` |
|   260391 | 3415 | `	pc = sState.pc;` |
|   260391 | 3416 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 3417 | `		goto Abort;` |
|   260389 | 3418 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3426 | ` */` |
|    22409 | 3427 | `case PH7_OP_MEMBER: {` |
|        - | 3428 | `	VmOpRc rcOp;` |
|    44823 | 3429 | `	sState.pTos = pTos;` |
|    44823 | 3430 | `	sState.pc = pc;` |
|    44823 | 3431 | `	rcOp = VmExecOpMember(&(*pVm),&sState,pInstr);` |
|    44823 | 3432 | `	pTos = sState.pTos;` |
|    44823 | 3433 | `	pc = sState.pc;` |
|    44823 | 3434 | `	if( rcOp == VM_OP_ABORT ){` |
|        8 | 3435 | `		goto Abort;` |
|    44817 | 3436 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|  1039867 | 3831 | `	sxi32 nCallArgs = pInstr->iP1 + (pInstr->iP2 ? VmSpreadOwnExtra(pVm,pInstr->iP1,pTos) : 0);` |
|        - | 3832 | `	ph7_value *pArg;` |
|  1039867 | 3833 | `	pArg = &pTos[-nCallArgs];` |
...
|  1039867 | 3842 | `	VmCallArgMap *pEffCallMap = (VmCallArgMap *)pInstr->p3;` |
...
|  1039867 | 3849 | `	if( VmValueIsClosure(pVm,pTos) ){` |
...
|  1039867 | 3859 | `	if( (pTos->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|      142 | 4054 | `		break;` |
|        - | 4055 | `	}` |
|  1039707 | 4056 | `	SyStringInitFromBuf(&sName,SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
...
|  1039707 | 4060 | `	if( sName.nByte > 0 && sName.zString[0] == '\\' ){` |
...
|  1039707 | 4067 | `	pEntry = SyHashGet(&pVm->hFunction,(const void *)sName.zString,sName.nByte);` |
...
|        - | 4073 | `	{` |
|  1039707 | 4074 | `	VmCallArgMap *pCallMap = pEffCallMap;` |
|  1039707 | 4075 | `	if( pEntry == 0 && pCallMap && pCallMap->bIsNamespaced ){` |
...
|        - | 4106 | `		VmSlot sArg;` |
|        - | 4107 | `		sxu32 n;` |
|   105253 | 4108 | `		int bClosureThis = 0;` |
|   105253 | 4109 | `		ph7_class *pClosureScope = 0;` |
|        - | 4110 | `		/* initialize fields */` |
|   105253 | 4111 | `		pVmFunc = (ph7_vm_func *)pEntry->pUserData;` |
|   105253 | 4112 | `		pThis = 0;` |
|   105253 | 4113 | `		pSelf = 0;` |
...
|       14 | 4128 | `		}` |
|   105253 | 4129 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
|        - | 4130 | `			ph7_class_method *pMeth;` |
|        - | 4131 | `			/* Class method call */` |
|    25561 | 4132 | `			ph7_value *pTarget = &pTos[-1];` |
|    25561 | 4133 | `			if( pTarget >= pStack && (pTarget->iFlags & (MEMOBJ_STRING\|MEMOBJ_OBJ\|MEMOBJ_NULL)) ){` |
|        - | 4134 | `				/* Extract the 'this' pointer */` |
|    25561 | 4135 | `				if(pTarget->iFlags & MEMOBJ_OBJ ){` |
|        - | 4136 | `					/* Instance already loaded */` |
|    24525 | 4137 | `					pThis = (ph7_class_instance *)pTarget->x.pOther;` |
|    24525 | 4138 | `					pThis->iRef++;` |
|    24525 | 4139 | `					pSelf = pThis->pClass;` |
|    12260 | 4140 | `				}` |
|    25561 | 4141 | `				if( pSelf == 0 ){` |
...
|      353 | 4160 | `					}` |
|      518 | 4161 | `				}` |
|    25561 | 4162 | `				VmPopOperand(&pTos,1);` |
|    25561 | 4163 | `				PH7_MemObjRelease(pTos);` |
...
|    25561 | 4170 | `				nCallArgs = pInstr->iP1 + (pInstr->iP2 ? VmSpreadOwnExtra(&(*pVm),pInstr->iP1,pTos) : 0);` |
|    25561 | 4171 | `				pArg = &pTos[-nCallArgs];` |
...
|        - | 4176 | `				 */` |
|    25561 | 4177 | `				while( pArg < pStack ){` |
|      ! 0 | 4178 | `					pArg++;` |
|      ! 0 | 4179 | `				}` |
|    25561 | 4180 | `				if( pSelf && pVm->bReflectBypass ){` |
...
|        6 | 4185 | `				}else` |
|    25551 | 4186 | `				if( pSelf ){ /* Paranoid edition */` |
...
|    25551 | 4194 | `					ph7_class *pDeclClass = pVmFunc->pUserData ? (ph7_class *)pVmFunc->pUserData : pSelf;` |
|    25551 | 4195 | `					pMeth = PH7_ClassExtractMethod(pDeclClass,pVmFunc->sName.zString,pVmFunc->sName.nByte);` |
|    25551 | 4196 | `					if( pMeth == 0 && pDeclClass != pSelf ){` |
|      ! 0 | 4197 | `						pMeth = PH7_ClassExtractMethod(pSelf,pVmFunc->sName.zString,pVmFunc->sName.nByte);` |
|      ! 0 | 4198 | `					}` |
|    25551 | 4199 | `					if( pMeth && pMeth->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|   157980 | 4236 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   105248 | 4237 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
...
|   105253 | 4244 | `		if( VmRecursionExceeded(pVm) ){` |
...
|        3 | 4248 | `			goto Abort;` |
|        - | 4249 | `		}` |
|   105251 | 4250 | `		if( pVmFunc->pNextName ){` |
...
|   105251 | 4262 | `		pSelfHint = pSelf;` |
|   105251 | 4263 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
|    25561 | 4264 | `			ph7_class *pDecl = (ph7_class *)pVmFunc->pUserData;` |
|    25561 | 4265 | `			if( pDecl && (pDecl->iFlags & PH7_CLASS_TRAIT) == 0 ){` |
|    24535 | 4266 | `				pSelfHint = pDecl;` |
|    12265 | 4267 | `			}` |
|    12778 | 4268 | `		}` |
|   105251 | 4269 | `		if( pSelf == 0 && (pVmFunc->iFlags & VM_FUNC_CLOSURE) ){` |
...
|       29 | 4280 | `			}` |
|      887 | 4281 | `		}` |
|   105251 | 4282 | `		if( SySetUsed(&pVmFunc->aAttrs) > 0 ){` |
...
|       56 | 4287 | `		}` |
|   105251 | 4288 | `		if( pVmFunc->iFlags & VM_FUNC_GENERATOR ){` |
...
|   104911 | 4520 | `		aFormalArg = (ph7_vm_func_arg *)SySetBasePtr(&pVmFunc->aArgs);` |
|        - | 4521 | `		/* Create a new VM frame  */` |
|   104911 | 4522 | `		rc = VmEnterFrame(&(*pVm),pVmFunc,pThis,&pFrame);` |
|   104911 | 4523 | `		if( rc != SXRET_OK ){` |
...
|   104911 | 4551 | `		pFrame->nActualArgs = (int)(pTos - pArg);` |
|   104911 | 4552 | `		if( pThis && ((pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) \|\| bClosureThis) ){` |
...
|    24709 | 4555 | `			pObj = VmExtractMemObj(&(*pVm),&sThis,FALSE,TRUE);` |
|    24709 | 4556 | `			if( pObj ){` |
|        - | 4557 | `				/* Reflect the change */` |
|    24709 | 4558 | `				pObj->x.pOther = pThis;` |
|    24709 | 4559 | `				MemObjSetType(pObj,MEMOBJ_OBJ);` |
|    12352 | 4560 | `			}` |
|    12352 | 4561 | `		}` |
|   104911 | 4562 | `		if( SySetUsed(&pVmFunc->aStatic) > 0 ){` |
...
|        - | 4589 | `		{` |
|   104911 | 4590 | `		VmCallArgMap *pCallMap3 = pEffCallMap;` |
|        - | 4591 | `		/* Caller file's strict_types mode — governs parameter coercion` |
|        - | 4592 | `		 * (but NOT return coercion, which uses the callee's file). */` |
|   104911 | 4593 | `		int bCallIsStrict = (pCallMap3 && pCallMap3->bStrict) ? 1 : 0;` |
|   104911 | 4594 | `		if( pCallMap3 && pCallMap3->bHasNamed ){` |
|        - | 4595 | `			/* ============================================================` |
...
|    87412 | 5125 | `					&& !((aFormalArg[n].iFlags & VM_FUNC_ARG_NULLABLE) && (pArg->iFlags & MEMOBJ_NULL)) ){` |
...
|   104789 | 5279 | `		if( pVmFunc->iFlags & VM_FUNC_CLOSURE ){` |
...
|   104784 | 5327 | `		if( n < SySetUsed(&pVmFunc->aArgs)` |
|    55066 | 5328 | `		 && (pVmFunc->iFlags & (VM_FUNC_INTERNAL\|VM_FUNC_CLASS_METHOD)) != VM_FUNC_INTERNAL ){` |
|        - | 5329 | `			sxu32 nNonVar,nReq;` |
|     3887 | 5330 | `			nReq = VmFuncRequiredArgCount(pVmFunc,&nNonVar);` |
|     3887 | 5331 | `			if( n < nReq ){` |
...
|   112741 | 5351 | `		while( n < SySetUsed(&pVmFunc->aArgs) ){` |
|     8223 | 5352 | `			if( aFormalArg[n].iFlags & VM_FUNC_ARG_VARIADIC ){` |
...
|        - | 5363 | `			}` |
|     7979 | 5364 | `			if( SySetUsed(&aFormalArg[n].aByteCode) > 0 ){` |
|     7977 | 5365 | `				pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|     7977 | 5366 | `				if( pObj ){` |
|        - | 5367 | `					/* Evaluate the default value and extract it's result */` |
|     7977 | 5368 | `					rc = VmLocalExec(&(*pVm),&aFormalArg[n].aByteCode,pObj,FALSE);` |
|     7977 | 5369 | `					if( rc == PH7_ABORT ){` |
|      ! 0 | 5370 | `						goto Abort;` |
|        - | 5371 | `					}` |
|        - | 5372 | `					/* Insert argument index */` |
|     7977 | 5373 | `					sArg.nIdx = pObj->nIdx;` |
|     7977 | 5374 | `					sArg.pUserData = 0;` |
|     7977 | 5375 | `					SySetPut(&pFrame->sArg,(const void *)&sArg);` |
...
|     7972 | 5380 | `					if( aFormalArg[n].nType > 0 && aFormalArg[n].nType != MEMOBJ_OBJ` |
|     3898 | 5381 | `						&& ((pObj->iFlags & aFormalArg[n].nType) == 0)` |
|     1955 | 5382 | `						&& !((aFormalArg[n].iFlags & VM_FUNC_ARG_NULLABLE) && (pObj->iFlags & MEMOBJ_NULL)) ){` |
...
|        - | 5394 | `		 */` |
|   104767 | 5395 | `		PH7_MemObjRelease(pTos);` |
|   104767 | 5396 | `		pTos = &pTos[-nCallArgs];` |
...
|        - | 5408 | `		 * per function. */` |
|        - | 5409 | `		{` |
|   104767 | 5410 | `			sxu32 nSlots = pVmFunc->nMaxStack;` |
|   104767 | 5411 | `			if( nSlots == 0 ){` |
...
|     4118 | 5418 | `			}` |
|   104767 | 5419 | `			pFrameStack = VmOperandStackAlloc(&(*pVm),nSlots);` |
|        - | 5420 | `		}` |
|   104767 | 5421 | `		if( pFrameStack == 0 ){` |
...
|      ! 0 | 5428 | `			break;` |
|        - | 5429 | `		}` |
|    52278 | 5430 | `SkipFuncBody:` |
|   104901 | 5431 | `		if( pSelf ){` |
|        - | 5432 | `			/* Push class name */` |
|    25615 | 5433 | `			SySetPut(&pVm->aSelf,(const void *)&pSelf);` |
|    12805 | 5434 | `		}` |
|        - | 5435 | `		/* Increment nesting level */` |
|   104901 | 5436 | `		pVm->nRecursionDepth++;` |
|   104901 | 5437 | `		if( rc == PH7_EXCEPTION ){` |
...
|   104767 | 5466 | `			VmCallFrame *pRec = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   104767 | 5467 | `			if( pRec ){` |
|   102135 | 5468 | `				pVm->pIdleCallFrames = (void *)pRec->pPrev;` |
|    51173 | 5469 | `			}else{` |
|     2637 | 5470 | `				pRec = (VmCallFrame *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmCallFrame));` |
|        - | 5471 | `			}` |
|   104767 | 5472 | `			if( pRec == 0 ){` |
...
|      ! 0 | 5483 | `				goto Abort;` |
|        - | 5484 | `			}` |
|   104767 | 5485 | `			sState.pTos = pTos;` |
|   104767 | 5486 | `			sState.pc = pc;` |
|   104767 | 5487 | `			pRec->sCaller = sState;` |
|   104767 | 5488 | `			pRec->sCall.pVmFunc = pVmFunc;` |
|   104767 | 5489 | `			pRec->sCall.pFrame = pFrame;` |
|   104767 | 5490 | `			pRec->sCall.pFrameStack = pFrameStack;` |
|   104767 | 5491 | `			pRec->sCall.nStackCap = pVmFunc->nMaxStack + VM_STACK_GUARD;` |
|   104767 | 5492 | `			pRec->sCall.nLastRef = SXU32_HIGH;` |
|   104767 | 5493 | `			pRec->sCall.bSelfPushed = (sxu8)(pSelf ? 1 : 0);` |
|   104767 | 5494 | `			pRec->pPrev = pCallTop;` |
|   104767 | 5495 | `			pCallTop = pRec;` |
|        - | 5496 | `			/* Switch to the callee activation (what the recursive` |
|        - | 5497 | `			 * VmByteCodeExec entry used to set up). */` |
|   104767 | 5498 | `			aInstr = (VmInstr *)SySetBasePtr(&pVmFunc->aByteCode);` |
|   104767 | 5499 | `			pStack = pFrameStack;` |
|   104767 | 5500 | `			pTos = &pStack[-1];` |
|   104767 | 5501 | `			pc = 0;` |
|   104767 | 5502 | `			sState.aInstr = aInstr;` |
|   104767 | 5503 | `			sState.pStack = pStack;` |
|   104767 | 5504 | `			sState.nStackCap = pRec->sCall.nStackCap; /* callee's operand-stack capacity for OP_SPREAD growth */` |
|   104767 | 5505 | `			sState.nStackOrig = pRec->sCall.nStackCap; /* fixed headroom reference (never grows) */` |
|   104767 | 5506 | `			sState.pTos = pTos;` |
|   104767 | 5507 | `			sState.pc = 0;` |
|   104767 | 5508 | `			sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|   104767 | 5509 | `			sState.pEntryFrame = pVm->pFrame;` |
|   104767 | 5510 | `			sState.pResult = pRec->sCaller.pTos;` |
|   104767 | 5511 | `			sState.pLastRef = &pRec->sCall.nLastRef;` |
|   104767 | 5512 | `			sState.pEnforceRetFunc = VmFuncHasReturnType(pVmFunc) ? pVmFunc : 0;` |
|   104767 | 5513 | `			sState.is_callback = 0;` |
|   104767 | 5514 | `			sState.bReturnPropagates = 0;` |
|   104767 | 5515 | `			goto VmLoopFetch;` |
|        - | 5516 | `		}` |
|       57 | 5517 | `	}else{` |
...
|   934459 | 5526 | `		pEntry = SyHashGet(&pVm->hHostFunction,(const void *)sName.zString,sName.nByte);` |
|        - | 5527 | `		{` |
|   934459 | 5528 | `		VmCallArgMap *pCallMap2 = pEffCallMap;` |
|   934459 | 5529 | `		if( pEntry == 0 && pCallMap2 && pCallMap2->bIsNamespaced ){` |
...
|        - | 5634 | `			}` |
|        - | 5635 | `		}` |
|   934443 | 5636 | `		pFunc = (ph7_user_func *)pEntry->pUserData;` |
...
|  1402028 | 5641 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   934438 | 5642 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
|        - | 5643 | `		/* Start collecting function arguments */` |
|   934443 | 5644 | `		SySetReset(&aArg);` |
|  2524947 | 5645 | `		while( pArg < pTos ){` |
|  1590509 | 5646 | `			SySetPut(&aArg,(const void *)&pArg);` |
|  1590509 | 5647 | `			pArg++;` |
|        5 | 5648 | `		}` |
|        - | 5649 | `		/* Assume a null return value */` |
|   934443 | 5650 | `		PH7_MemObjInit(&(*pVm),&sRet);` |
|        - | 5651 | `		/* Init the call context */` |
|   934443 | 5652 | `		VmInitCallContext(&sCtx,&(*pVm),pFunc,&sRet,0);` |
...
|   934443 | 5659 | `		sCtx.pArgMap = pEffCallMap;` |
|        - | 5660 | `		{` |
|   934443 | 5661 | `		int nGiven = (int)SySetUsed(&aArg);` |
...
|   934443 | 5667 | `		if( pFunc->nMinArg > 0 && nGiven < pFunc->nMinArg ){` |
...
|      232 | 5674 | `				nGiven);` |
|   934211 | 5675 | `		}else if( pFunc->bHasMaxArg && nGiven > (int)pFunc->nMaxArg ){` |
...
|       40 | 5688 | `				nGiven);` |
|  1401252 | 5689 | `		}else if( SXRET_OK != (rc = VmEnforceBuiltinArgTypes(&sCtx,pFunc,nGiven,` |
|   933894 | 5690 | `			(ph7_value **)SySetBasePtr(&aArg))) ){` |
|        - | 5691 | `			/* TypeError thrown: rc carries the caught/uncaught status */` |
|       91 | 5692 | `		}else{` |
|        - | 5693 | `			/* Call the foreign function */` |
|   933727 | 5694 | `			rc = pFunc->xFunc(&sCtx,nGiven,(ph7_value **)SySetBasePtr(&aArg));` |
|        - | 5695 | `		}` |
|        - | 5696 | `		}` |
|        - | 5697 | `		/* Release the call context */` |
|   934443 | 5698 | `		VmReleaseCallContext(&sCtx);` |
|   934443 | 5699 | `		if( rc == PH7_ABORT ){` |
...
|      576 | 5703 | `			PH7_MemObjRelease(&sRet);` |
|      576 | 5704 | `			goto Abort;` |
|        - | 5705 | `		}` |
|   933871 | 5706 | `		if( rc != PH7_SUSPEND && pVm->pInlineInstr == (void *)aInstr ){` |
...
|      ! 0 | 5719 | `		}` |
|   933867 | 5720 | `		if( rc == PH7_EXCEPTION ){` |
...
|      991 | 5728 | `			if( !VmRecordedResume(pVm,&iResumePc,sState.pEntryFrame,aInstr) ){` |
...
|      792 | 5734 | `			PH7_MemObjRelease(&sRet);` |
|      792 | 5735 | `			if( nCallArgs > 0 ){` |
|      502 | 5736 | `				VmPopOperand(&pTos,nCallArgs); /* spread-adjusted; see the normal-return path */` |
|      249 | 5737 | `			}` |
|      792 | 5738 | `			VmPopOperand(&pTos,1);` |
|      792 | 5739 | `			pc = iResumePc;` |
|      792 | 5740 | `			break;` |
|        - | 5741 | `		}` |
|   932881 | 5742 | `		if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|   911533 | 5766 | `			VmPopOperand(&pTos,nCallArgs);` |
|   456130 | 5767 | `		}` |
|        - | 5768 | `		/* Save foreign function return value into the (now top) function-name slot */` |
|   932527 | 5769 | `		PH7_MemObjStore(&sRet,pTos);` |
|   932527 | 5770 | `		PH7_MemObjRelease(&sRet);` |
|        - | 5771 | `	}` |
|   932631 | 5772 | `	break;` |
|        - | 5773 | `				  }` |
|        - | 5774 | `/*` |
...
|        - | 5777 | ` */` |
|    25550 | 5778 | `case PH7_OP_CONSUME: {` |
|        - | 5779 | `	VmOpRc rcOp;` |
|    51105 | 5780 | `	sState.pTos = pTos;` |
|    51105 | 5781 | `	sState.pc = pc;` |
|    51105 | 5782 | `	rcOp = VmExecOpConsume(&(*pVm),&sState,pInstr);` |
|    51105 | 5783 | `	pTos = sState.pTos;` |
|    51105 | 5784 | `	pc = sState.pc;` |
|    51105 | 5785 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 5786 | `		goto Abort;` |
|    51105 | 5787 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 5792 |  |
|        - | 5793 | `		} /* Switch() */` |
| 16452218 | 5794 | `		pc++; /* Next instruction in the stream */` |
|        5 | 5795 | `	} /* For(;;) */` |
|   128795 | 5796 | `Done:` |
...
|   257801 | 5800 | `	rc = SXRET_OK;` |
|   257801 | 5801 | `	goto Unwind;` |
|      823 | 5802 | `Suspend:` |
...
|      374 | 5843 | `Abort:` |
|      752 | 5844 | `	rc = PH7_ABORT;` |
|      752 | 5845 | `	goto Unwind;` |
|      395 | 5846 | `Exception:` |
|      795 | 5847 | `	rc = PH7_EXCEPTION;` |
|      790 | 5848 | `	goto Unwind;` |
|   130210 | 5849 | `Unwind:` |
...
|   130799 | 5860 | `	for(;;){` |
|   261397 | 5861 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|     2308 | 5866 | `			while( SySetUsed(&pVm->aHookRmw) > 0` |
|     2309 | 5867 | `			 && ((VmHookRmw *)SySetPeek(&pVm->aHookRmw))->pOwnerStack == (void *)pStack ){` |
|      ! 0 | 5868 | `				VmHookRmwDropTop(&(*pVm));` |
|      ! 0 | 5869 | `			}` |
|     1152 | 5870 | `		}` |
|   261397 | 5871 | `		if( pCallTop == 0 ){` |
|   157045 | 5872 | `			return VmExecFinalize(&(*pVm),&sState,&aArg,pTos,rc);` |
|        - | 5873 | `		}` |
|   104357 | 5874 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
|     1259 | 5875 | `			VmClearFrameReturn(sState.pEntryFrame);` |
|     2555 | 5876 | `			while( pTos >= pStack ){` |
|     1301 | 5877 | `				PH7_MemObjRelease(pTos);` |
|     1301 | 5878 | `				pTos--;` |
|        5 | 5879 | `			}` |
|      627 | 5880 | `		}` |
|        - | 5881 | `		{` |
|   104357 | 5882 | `			VmCallFrame *pRec = pCallTop;` |
|   104357 | 5883 | `			sState = pRec->sCaller;` |
|   104357 | 5884 | `			rc = VmCallFinish(&(*pVm),&sState,&pRec->sCall,rc);` |
|   104357 | 5885 | `			pCallTop = pRec->pPrev;` |
|   104357 | 5886 | `			pRec->pPrev = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   104357 | 5887 | `			pVm->pIdleCallFrames = (void *)pRec;` |
|   104357 | 5888 | `			aInstr = sState.aInstr;` |
|   104357 | 5889 | `			pStack = sState.pStack;` |
|   104357 | 5890 | `			pTos = sState.pTos;` |
|   104357 | 5891 | `			pc = sState.pc;` |
|        - | 5892 | `		}` |
|   104357 | 5893 | `		if( rc == PH7_OK ){` |
|   103591 | 5894 | `			pc++; /* the loop-bottom increment this OP_CALL missed */` |
|   103591 | 5895 | `			goto VmLoopFetch;` |
|        - | 5896 | `		}` |
|        5 | 5897 | `	}` |
|    78702 | 5898 | `}` |
|        - | 5899 |  |
