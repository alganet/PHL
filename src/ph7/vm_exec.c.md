...
|        - |  162 | ` */` |
|   157036 |  163 | `static sxi32 VmExecFinalize(ph7_vm *pVm,VmExecState *pState,SySet *pArg,ph7_value *pTos,sxi32 rcTerm)` |
|        5 |  164 | `{` |
|    78518 |  165 | `	SXUNUSED(pVm);` |
|   157041 |  166 | `	if( rcTerm != PH7_SUSPEND && !pState->bReturnPropagates ){` |
|   153401 |  167 | `		VmClearFrameReturn(pState->pEntryFrame);` |
|    76698 |  168 | `	}` |
|   157041 |  169 | `	SySetRelease(pArg);` |
|   157041 |  170 | `	if( rcTerm == PH7_ABORT \|\| rcTerm == PH7_EXCEPTION ){` |
|     2835 |  171 | `		while( pTos >= pState->pStack ){` |
|     1785 |  172 | `			PH7_MemObjRelease(pTos);` |
|     1785 |  173 | `			pTos--;` |
|        5 |  174 | `		}` |
|      525 |  175 | `	}` |
|   157041 |  176 | `	return rcTerm;` |
|        5 |  177 | `}` |
|        - |  178 | `/*` |
...
|        - |  189 | ` */` |
|   104483 |  190 | `static sxi32 VmCallFinish(ph7_vm *pVm,VmExecState *pCaller,VmCallRecord *pCallee,sxi32 rc)` |
|        5 |  191 | `{` |
|        - |  192 | `	ph7_value *pObj;` |
|        - |  193 | `	/* Decrement nesting level */` |
|   104488 |  194 | `	pVm->nRecursionDepth--;` |
|   104488 |  195 | `	if( pCallee->bSelfPushed ){` |
|        - |  196 | `		/* Pop class name */` |
|    25405 |  197 | `		(void)SySetPop(&pVm->aSelf);` |
|    12700 |  198 | `	}` |
|   104488 |  199 | `	if( (pCallee->pVmFunc->iFlags & VM_FUNC_REF_RETURN) && rc == SXRET_OK ){` |
...
|       25 |  225 | `	}` |
|   104488 |  226 | `	if( rc != PH7_ABORT && ((pCallee->pFrame->iFlags & VM_FRAME_THROW) \|\| rc == PH7_EXCEPTION) ){` |
...
|   104488 |  272 | `	if( rc != PH7_SUSPEND && pCallee->pFrameStack ){` |
...
|   104354 |  276 | `		VmOperandStackRecycle(pVm,pCallee->pFrameStack,pCallee->nStackCap);` |
|    52277 |  277 | `	}` |
|        - |  278 | `	/* Leave the frame */` |
|   104488 |  279 | `	VmLeaveFrame(&(*pVm));` |
|   104488 |  280 | `	if( rc == PH7_ABORT ){` |
|      336 |  281 | `		return PH7_ABORT;` |
|        - |  282 | `	}` |
|   104156 |  283 | `	if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|        - |  291 | `	}` |
|   104156 |  292 | `	if( rc == PH7_EXCEPTION ){` |
|      469 |  293 | `		return PH7_EXCEPTION;` |
|        - |  294 | `	}` |
|   103692 |  295 | `	return PH7_OK;` |
|    52349 |  296 | `}` |
|        - |  297 | `/*` |
...
|        - |  330 | ` * nesting.` |
|        - |  331 | ` */` |
|   157394 |  332 | `PH7_PRIVATE sxi32 VmByteCodeExec(` |
...
|   157399 |  352 | `	if( VmNativeNestingExceeded(pVm) ){` |
...
|   157395 |  362 | `	nSavedBrc = pVm->nBoundaryRc;` |
|   157395 |  363 | `	pVm->nBoundaryRc = 0;` |
...
|   157395 |  370 | `	nSavedLine = pVm->nCurLine;` |
|   157395 |  371 | `	pVm->nVmExecDepth++;` |
|   236090 |  372 | `	rc = VmByteCodeExecBody(&(*pVm),aInstr,pStack,nTos,pResult,pLastRef,is_callback,nPc,` |
|    78695 |  373 | `		pEnforceRetFunc,bReturnPropagates,pAdoptSegment,ppBaseOwner,pnBaseCap,nStackOrig);` |
|   157395 |  374 | `	pVm->nVmExecDepth--;` |
|   157395 |  375 | `	pVm->nCurLine = nSavedLine;` |
|   157395 |  376 | `	if( nSavedBrc != 0 && (nSavedBrc == PH7_ABORT \|\| pVm->nBoundaryRc == 0) ){` |
|       15 |  377 | `		pVm->nBoundaryRc = nSavedBrc;` |
|        6 |  378 | `	}` |
|   157395 |  379 | `	return rc;` |
|    78702 |  380 | `}` |
|   157390 |  381 | `static sxi32 VmByteCodeExecBody(` |
...
|        - |  399 | `	ph7_value *pTos;` |
|        - |  400 | `	SySet aArg;` |
|   157395 |  401 | `	VmCallFrame *pCallTop = 0; /* Top of this invocation's in-loop call-record` |
...
|        - |  409 | `	sxi32 pc;` |
|        - |  410 | `	sxi32 rc;` |
|   157395 |  411 | `	sState.aInstr = aInstr;` |
|   157395 |  412 | `	sState.pStack = pStack;` |
|   157395 |  413 | `	sState.nStackCap = pnBaseCap ? *pnBaseCap : 0; /* CURRENT capacity (grown on a coroutine resume) */` |
|   157395 |  414 | `	sState.nStackOrig = nStackOrig;                /* ORIGINAL capacity — fixed headroom reference */` |
|   157395 |  415 | `	sState.pResult = pResult;` |
|   157395 |  416 | `	sState.pLastRef = pLastRef;` |
|   157395 |  417 | `	sState.pEnforceRetFunc = pEnforceRetFunc;` |
|   157395 |  418 | `	sState.is_callback = (sxu8)(is_callback ? 1 : 0);` |
|   157395 |  419 | `	sState.bReturnPropagates = (sxu8)(bReturnPropagates ? 1 : 0);` |
|        - |  420 | `	/* Argument container */` |
|   157395 |  421 | `	SySetInit(&aArg,&pVm->sAllocator,sizeof(ph7_value *));` |
|   157395 |  422 | `	if( nTos < 0 ){` |
|   141675 |  423 | `		pTos = &pStack[-1];` |
|    70840 |  424 | `	}else{` |
|    15725 |  425 | `		pTos = &pStack[nTos];` |
|        - |  426 | `	}` |
|   157395 |  427 | `	sState.pTos = pTos;` |
|   157395 |  428 | `	sState.pc = nPc;` |
...
|   157390 |  446 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->pFrame == pVm->pFrame` |
|     2816 |  447 | `	 && pStack == pVm->pActiveCtx->pStack ){` |
|     1805 |  448 | `		sState.nExceptionBase = pVm->pActiveCtx->nExceptionBase;` |
|      905 |  449 | `	}else{` |
|   155595 |  450 | `		sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|        - |  451 | `	}` |
|   157395 |  452 | `	sState.pEntryFrame = pVm->pFrame;` |
|   157395 |  453 | `	pc = nPc;` |
...
|   157390 |  506 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->pInjected` |
...
|   157380 |  567 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->bClosing` |
...
| 16802648 |  603 | `		if( pVm->nBoundaryRc != 0 \|\| SySetUsed(&pVm->aHookRmw) > 0 ){` |
...
| 16802562 |  658 | `		pInstr = &aInstr[pc];` |
| 16802562 |  659 | `		if( pInstr->nLine ){` |
...
| 16589634 |  663 | `			pVm->nCurLine = pInstr->nLine;` |
|  8301147 |  664 | `		}` |
| 16802562 |  665 | `		rc = SXRET_OK;` |
|        - |  666 | `/*` |
...
|        - |  672 | ` */` |
| 16802562 |  673 | `		switch(pInstr->iOp){` |
|        - |  674 | `/*` |
|        - |  675 | ` * DONE: P1 * *` |
|        - |  676 | ` *` |
...
|        - |  679 | ` */` |
|   128692 |  680 | `case PH7_OP_DONE:` |
|   257594 |  681 | `	if( pInstr->iP2 && sState.bReturnPropagates ){` |
...
|   257405 |  711 | `	if( sState.pEnforceRetFunc && VmFuncHasReturnType(sState.pEnforceRetFunc)` |
...
|     4591 |  736 | `	}` |
|   257386 |  737 | `	if( pInstr->iP1 && pTos >= pStack ){` |
|   152914 |  738 | `		if( sState.pLastRef ){` |
|    94076 |  739 | `			*sState.pLastRef = pTos->nIdx;` |
|    47138 |  740 | `		}` |
|   152914 |  741 | `		if( sState.pResult ){` |
|        - |  742 | `			/* Execution result */` |
|   145896 |  743 | `			PH7_MemObjStore(pTos,sState.pResult);` |
|    73048 |  744 | `		}` |
|   152914 |  745 | `		VmPopOperand(&pTos,1);` |
|   181034 |  746 | `	}else if( sState.pLastRef ){` |
...
|        - |  762 | `	 */` |
|   257386 |  763 | `	rc = VmDrainFinally(&(*pVm),sState.nExceptionBase);` |
|   257386 |  764 | `	if( rc == SXERR_ABORT ){` |
|      ! 0 |  765 | `		goto Abort;` |
|        - |  766 | `	}` |
|   257386 |  767 | `	if( rc == PH7_EXCEPTION ){` |
...
|        - |  778 | `	}` |
|   257382 |  779 | `	if( sState.pEntryFrame->bHasRet && !sState.bReturnPropagates ){` |
...
|        - |  835 | ` */` |
|   288407 |  836 | `case PH7_OP_JMP:` |
|   577024 |  837 | `	pc = pInstr->iP2 - 1;` |
|   577024 |  838 | `	break;` |
|        - |  839 | `/*` |
|        - |  840 | ` * JZ: P1 P2 *` |
|        - |  841 | ` *` |
...
|  1604364 |  852 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     1003 |  853 | `		PH7_MemObjToBool(pTos);` |
|      500 |  854 | `	}` |
|  1604364 |  855 | `	if( !pTos->x.iVal ){` |
|        - |  856 | `		/* Take the jump */` |
|   899101 |  857 | `		pc = pInstr->iP2 - 1;` |
|   449809 |  858 | `	}` |
|  1604364 |  859 | `	if( !pInstr->iP1 ){` |
|  1356088 |  860 | `		VmPopOperand(&pTos,1);` |
|   678610 |  861 | `	}` |
|  1604364 |  862 | `	break;` |
|        - |  863 | `/*` |
|        - |  864 | ` * JNZ: P1 P2 *` |
...
|   183968 |  876 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      ! 0 |  877 | `		PH7_MemObjToBool(pTos);` |
|      ! 0 |  878 | `	}` |
|   183968 |  879 | `	if( pTos->x.iVal ){` |
|        - |  880 | `		/* Take the jump */` |
|     9549 |  881 | `		pc = pInstr->iP2 - 1;` |
|     4772 |  882 | `	}` |
|   183968 |  883 | `	if( !pInstr->iP1 ){` |
...
|        - |  899 | ` */` |
|   661665 |  900 | `case PH7_OP_POP: {` |
|  1324360 |  901 | `	sxi32 n = pInstr->iP1;` |
|  1324360 |  902 | `	if( &pTos[-n+1] < pStack ){` |
|        - |  903 | `		/* TICKET 1433-51 Stack underflow must be handled at run-time */` |
|       79 |  904 | `		n = (sxi32)(pTos - pStack);` |
|       38 |  905 | `	}` |
|  1324360 |  906 | `	VmPopOperand(&pTos,n);` |
|  1324360 |  907 | `	break;` |
|        - |  908 | `				 }` |
|        - |  909 | `/*` |
|        - |  910 | ` * DUP: * * *` |
...
|        - |  929 | ` */` |
|    49003 |  930 | `case PH7_OP_NSSWITCH:` |
|    98011 |  931 | `	SyBlobReset(&pVm->sNamespace);` |
|    98011 |  932 | `	if( pInstr->p3 ){` |
...
|    98011 |  937 | `	SyHashRelease(&pVm->hUseConstImports);` |
|    98011 |  938 | `	SyHashInit(&pVm->hUseConstImports,&pVm->sAllocator,0,0);` |
|    98011 |  939 | `	break;` |
...
|        - | 1076 | ` */` |
|     3353 | 1077 | `case PH7_OP_UNSET_VAR: {` |
|        - | 1078 | `	VmOpRc rcOp;` |
|     6711 | 1079 | `	sState.pTos = pTos;` |
|     6711 | 1080 | `	sState.pc = pc;` |
|     6711 | 1081 | `	rcOp = VmExecOpUnsetVar(&(*pVm),&sState,pInstr);` |
|     6711 | 1082 | `	pTos = sState.pTos;` |
|     6711 | 1083 | `	pc = sState.pc;` |
|     6711 | 1084 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 1085 | `		goto Abort;` |
|     6709 | 1086 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1163 | ` */` |
|  1511686 | 1164 | `case PH7_OP_LOADC: {` |
|        - | 1165 | `	ph7_value *pObj;` |
|        - | 1166 | `	/* Reserve a room */` |
|  3025241 | 1167 | `	pTos++;` |
|  3025241 | 1168 | `	if( pInstr->iP1 & PH7_LOADC_NOKEY ){` |
|        - | 1169 | `		/* Absent array-literal key: mark it so LOAD_MAP auto-indexes without a diagnostic */` |
|    19297 | 1170 | `		MemObjSetType(pTos,MEMOBJ_NULL);` |
|    19297 | 1171 | `		SyBlobReset(&pTos->sBlob);` |
|    19297 | 1172 | `		pTos->iFlags \|= MEMOBJ_AUX_NOKEY;` |
|    19297 | 1173 | `		pTos->nIdx = SXU32_HIGH;` |
|    19297 | 1174 | `		break;` |
|        - | 1175 | `	}` |
|  3005949 | 1176 | `	if( (pObj = (ph7_value *)SySetAt(&pVm->aLitObj,pInstr->iP2)) != 0 ){` |
|  3005949 | 1177 | `		if( (pInstr->iP1 & PH7_LOADC_EXPAND) && SyBlobLength(&pObj->sBlob) <= 64 ){` |
...
|        - | 1283 | ` */` |
|  2194574 | 1284 | `case PH7_OP_LOAD:{` |
|        - | 1285 | `	ph7_value *pObj;` |
|        - | 1286 | `	SyString sName;` |
|  4393067 | 1287 | `	if( pInstr->p3 == 0 ){` |
...
|        9 | 1299 | `	}else{` |
|  4393051 | 1300 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1301 | `		/* Reserve a room for the target object */` |
|  4393051 | 1302 | `		pTos++;` |
|        - | 1303 | `	}` |
|  4393067 | 1304 | `	if( pInstr->iP2 == 2 ){` |
...
|   392220 | 1310 | `		if( VmExtractMemObj(&(*pVm),&sName,FALSE,FALSE) == 0 ){` |
|        7 | 1311 | `			VmErrorFormat(&(*pVm),PH7_CTX_WARNING,"Undefined variable $%z",&sName);` |
|        3 | 1312 | `		}` |
|   196210 | 1313 | `	}` |
|        - | 1314 | `	/* Extract the requested memory object */` |
|  4393067 | 1315 | `	pObj = VmExtractMemObj(&(*pVm),&sName,pInstr->p3 ? FALSE : TRUE,pInstr->iP1 != 1);` |
|  4393067 | 1316 | `	if( pObj == 0 ){` |
...
|  4393005 | 1341 | `	PH7_MemObjLoad(pObj,pTos);` |
|  4393005 | 1342 | `	pTos->nIdx = pObj->nIdx;` |
|  4393005 | 1343 | `	break;` |
|        - | 1344 | `				   }` |
|        - | 1345 | `/*` |
|        - | 1346 | ` * LOAD_MAP P1 * *` |
...
|        - | 1351 | ` */` |
|    36848 | 1352 | `case PH7_OP_LOAD_MAP: {` |
|        - | 1353 | `	VmOpRc rcOp;` |
|    73701 | 1354 | `	sState.pTos = pTos;` |
|    73701 | 1355 | `	sState.pc = pc;` |
|    73701 | 1356 | `	rcOp = VmExecOpLoadMap(&(*pVm),&sState,pInstr);` |
|    73701 | 1357 | `	pTos = sState.pTos;` |
|    73701 | 1358 | `	pc = sState.pc;` |
|    73701 | 1359 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1360 | `		goto Abort;` |
|    73701 | 1361 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1394 | ` * instead.` |
|        - | 1395 | ` */` |
|   331640 | 1396 | `case PH7_OP_LOAD_IDX: {` |
|        - | 1397 | `	VmOpRc rcOp;` |
|   664012 | 1398 | `	sState.pTos = pTos;` |
|   664012 | 1399 | `	sState.pc = pc;` |
|   664012 | 1400 | `	rcOp = VmExecOpLoadIdx(&(*pVm),&sState,pInstr);` |
|   664012 | 1401 | `	pTos = sState.pTos;` |
|   664012 | 1402 | `	pc = sState.pc;` |
|   664012 | 1403 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1404 | `		goto Abort;` |
|   664012 | 1405 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1582 | `		}` |
|    11655 | 1583 | `		break;` |
|   584023 | 1584 | `	}else if( pInstr->p3 == 0 ){` |
...
|        - | 1596 | `#endif` |
|        5 | 1597 | `	}else{` |
|   584015 | 1598 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1599 | `	}` |
|   584018 | 1600 | `	if( sName.nByte == sizeof("GLOBALS")-1` |
|   293760 | 1601 | `	 && SyMemcmp((const void *)sName.zString,(const void *)"GLOBALS",sName.nByte) == 0 ){` |
|        6 | 1602 | `		if( pInstr->p3 ){` |
...
|        - | 1639 | ` */` |
|   120357 | 1640 | `case PH7_OP_STORE_IDX:` |
|        - | 1641 | `case PH7_OP_STORE_IDX_REF: {` |
|        - | 1642 | `	VmOpRc rcOp;` |
|   240719 | 1643 | `	sState.pTos = pTos;` |
|   240719 | 1644 | `	sState.pc = pc;` |
|   240719 | 1645 | `	rcOp = VmExecOpStoreIdxRef(&(*pVm),&sState,pInstr);` |
|   240719 | 1646 | `	pTos = sState.pTos;` |
|   240719 | 1647 | `	pc = sState.pc;` |
|   240719 | 1648 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 1649 | `		goto Abort;` |
|   240717 | 1650 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|   366290 | 1671 | `	PH7_ENFORCE_READONLY_MUTATE(pTos->nIdx);` |
...
|   366279 | 1676 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) != 0` |
|   183248 | 1677 | `	 && SySetUsed(&pVm->aHookRmw) > 0 ){` |
...
|        - | 1694 | `		}` |
|      ! 0 | 1695 | `	}` |
|   366282 | 1696 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) == 0 ){` |
|   366282 | 1697 | `		if( pTos->nIdx != SXU32_HIGH ){` |
|        - | 1698 | `			ph7_value *pObj;` |
|   366282 | 1699 | `			if( (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pTos->nIdx)) != 0 ){` |
|   366282 | 1700 | `				if( VmStringWantsPerlIncr(pObj) ){` |
...
|   366280 | 1719 | `					if( pInstr->iP1 == 0 && (pTos->iFlags & MEMOBJ_STRING) ){` |
|        9 | 1720 | `						SyBlobNullAppend(&pTos->sBlob);` |
|        3 | 1721 | `					}` |
|        - | 1722 | `					/* Force a numeric cast on the variable */` |
|   366280 | 1723 | `					PH7_MemObjToNumeric(pObj);` |
|   366280 | 1724 | `					if( pObj->iFlags & MEMOBJ_REAL ){` |
|        5 | 1725 | `						pObj->rVal++;` |
...
|        - | 1734 | `						sxi64 r;` |
|   366276 | 1735 | `						if( PH7_ADD_OVERFLOW64(pObj->x.iVal,1,&r) ){` |
...
|        - | 1741 | `#endif` |
|        3 | 1742 | `						}else{` |
|   366272 | 1743 | `							pObj->x.iVal = r;` |
|        - | 1744 | `						}` |
|        - | 1745 | `					}` |
|   366280 | 1746 | `					if( pInstr->iP1 ){` |
...
|        - | 1785 | `		}` |
|   183240 | 1786 | `	}` |
|   366280 | 1787 | `	PH7_HOOK_RMW_WRITEBACK(pTos->nIdx,pTos);` |
|   366280 | 1788 | `	break;` |
|        - | 1789 | `/*` |
|        - | 1790 | ` * DECR: P1 * *` |
|        - | 1791 | ` *` |
...
|    70567 | 1938 | `	PH7_MemObjToNumeric(pTos);` |
|    70567 | 1939 | `	if( pTos->iFlags & MEMOBJ_REAL ){` |
|      108 | 1940 | `		pTos->rVal = -pTos->rVal;` |
|       53 | 1941 | `	}` |
|    70567 | 1942 | `	if( pTos->iFlags & MEMOBJ_INT ){` |
|    70481 | 1943 | `		if( pTos->x.iVal == SMALLEST_INT64 ){` |
...
|        - | 1958 | `#endif` |
|        3 | 1959 | `		}else{` |
|    70477 | 1960 | `			pTos->x.iVal = -pTos->x.iVal;` |
|        - | 1961 | `		}` |
|    35238 | 1962 | `	}` |
|    70567 | 1963 | `	break;` |
|        - | 1964 | `/*` |
...
|    50825 | 1997 | `	if( (pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      119 | 1998 | `		PH7_MemObjToBool(pTos);` |
|       57 | 1999 | `	}` |
|    50825 | 2000 | `	pTos->x.iVal = !pTos->x.iVal;` |
|    50825 | 2001 | `	break;` |
|        - | 2002 | `/*` |
|        - | 2003 | ` * OP_BITNOT: * * *` |
|        - | 2004 | ` *` |
...
|        - | 2171 | `	VmOpRc rcOp;` |
|    24435 | 2172 | `	sState.pTos = pTos;` |
|    24435 | 2173 | `	sState.pc = pc;` |
|    24435 | 2174 | `	rcOp = VmExecOpSub(&(*pVm),&sState,pInstr);` |
|    24435 | 2175 | `	pTos = sState.pTos;` |
|    24435 | 2176 | `	pc = sState.pc;` |
|    24435 | 2177 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2178 | `		goto Abort;` |
|    24435 | 2179 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2526 | ` * back.` |
|        - | 2527 | ` */` |
|    86404 | 2528 | `case PH7_OP_CAT:{` |
|        - | 2529 | `	ph7_value *pNos,*pCur;` |
|   172813 | 2530 | `	if( pInstr->iP1 < 1 ){` |
|   144439 | 2531 | `		pNos = &pTos[-1];` |
|    72222 | 2532 | `	}else{` |
|    28379 | 2533 | `		pNos = &pTos[-pInstr->iP1+1];` |
|        - | 2534 | `	}` |
|        - | 2535 | `#ifdef UNTRUST` |
|        - | 2536 | `	if( pNos < pStack ){` |
|        - | 2537 | `		goto Abort;` |
...
|   172813 | 2541 | `	if( (pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|     1931 | 2542 | `		PH7_MemObjToString(pNos);` |
|      963 | 2543 | `	}` |
|   172813 | 2544 | `	pCur = &pNos[1];` |
|   349175 | 2545 | `	while( pCur <= pTos ){` |
|   176367 | 2546 | `		if( (pCur->iFlags & MEMOBJ_STRING) == 0 ){` |
|    52217 | 2547 | `			PH7_MemObjToString(pCur);` |
|    26106 | 2548 | `		}` |
|        - | 2549 | `		/* Perform the concatenation */` |
|   176367 | 2550 | `		if( SyBlobLength(&pCur->sBlob) > 0 ){` |
|   176219 | 2551 | `			if( PH7_MemObjStringAppend(pNos,(const char *)SyBlobData(&pCur->sBlob),SyBlobLength(&pCur->sBlob)) != SXRET_OK ){` |
|        - | 2552 | `				/* Allocation failure: raise a fatal instead of a truncated concat */` |
|      ! 0 | 2553 | `				PH7_VmMemoryError(&(*pVm));` |
|      ! 0 | 2554 | `				goto Abort;` |
|        - | 2555 | `			}` |
|    88107 | 2556 | `		}` |
|   176367 | 2557 | `		SyBlobRelease(&pCur->sBlob);` |
|   176367 | 2558 | `		pCur++;` |
|        5 | 2559 | `	}` |
|   172813 | 2560 | `	pTos = pNos;` |
|   172813 | 2561 | `	break;` |
|        - | 2562 | `				}` |
|        - | 2563 | `/*  CAT_STORE: * * *` |
|        - | 2564 | ` *` |
...
|        - | 2668 | ` * stack.` |
|        - | 2669 | ` */` |
|   113938 | 2670 | `case PH7_OP_LAND:` |
|        - | 2671 | `case PH7_OP_LOR: {` |
|        - | 2672 | `	VmOpRc rcOp;` |
|   228086 | 2673 | `	sState.pTos = pTos;` |
|   228086 | 2674 | `	sState.pc = pc;` |
|   228086 | 2675 | `	rcOp = VmExecOpLor(&(*pVm),&sState,pInstr);` |
|   228086 | 2676 | `	pTos = sState.pTos;` |
|   228086 | 2677 | `	pc = sState.pc;` |
|   228086 | 2678 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2679 | `		goto Abort;` |
|   228086 | 2680 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2917 | ` */` |
|   227960 | 2918 | `case PH7_OP_TEQ: {` |
|        - | 2919 | `	VmOpRc rcOp;` |
|   456130 | 2920 | `	sState.pTos = pTos;` |
|   456130 | 2921 | `	sState.pc = pc;` |
|   456130 | 2922 | `	rcOp = VmExecOpTeq(&(*pVm),&sState,pInstr);` |
|   456130 | 2923 | `	pTos = sState.pTos;` |
|   456130 | 2924 | `	pc = sState.pc;` |
|   456130 | 2925 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2926 | `		goto Abort;` |
|   456130 | 2927 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2939 | ` *` |
|        - | 2940 | ` */` |
|   174340 | 2941 | `case PH7_OP_TNE: {` |
|        - | 2942 | `	VmOpRc rcOp;` |
|   348890 | 2943 | `	sState.pTos = pTos;` |
|   348890 | 2944 | `	sState.pc = pc;` |
|   348890 | 2945 | `	rcOp = VmExecOpTne(&(*pVm),&sState,pInstr);` |
|   348890 | 2946 | `	pTos = sState.pTos;` |
|   348890 | 2947 | `	pc = sState.pc;` |
|   348890 | 2948 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2949 | `		goto Abort;` |
|   348890 | 2950 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2971 | ` *` |
|        - | 2972 | ` */` |
|   145732 | 2973 | `case PH7_OP_LT:` |
|        - | 2974 | `case PH7_OP_LE: {` |
|        - | 2975 | `	VmOpRc rcOp;` |
|   291879 | 2976 | `	sState.pTos = pTos;` |
|   291879 | 2977 | `	sState.pc = pc;` |
|   291879 | 2978 | `	rcOp = VmExecOpLe(&(*pVm),&sState,pInstr);` |
|   291879 | 2979 | `	pTos = sState.pTos;` |
|   291879 | 2980 | `	pc = sState.pc;` |
|   291879 | 2981 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2982 | `		goto Abort;` |
|   291879 | 2983 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3004 | ` *` |
|        - | 3005 | ` */` |
|    85800 | 3006 | `case PH7_OP_GT:` |
|        - | 3007 | `case PH7_OP_GE: {` |
|        - | 3008 | `	VmOpRc rcOp;` |
|   171810 | 3009 | `	sState.pTos = pTos;` |
|   171810 | 3010 | `	sState.pc = pc;` |
|   171810 | 3011 | `	rcOp = VmExecOpGe(&(*pVm),&sState,pInstr);` |
|   171810 | 3012 | `	pTos = sState.pTos;` |
|   171810 | 3013 | `	pc = sState.pc;` |
|   171810 | 3014 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 3015 | `		goto Abort;` |
|   171810 | 3016 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3390 | ` */` |
|    12000 | 3391 | `case PH7_OP_FOREACH_INIT: {` |
|        - | 3392 | `	VmOpRc rcOp;` |
|    24005 | 3393 | `	sState.pTos = pTos;` |
|    24005 | 3394 | `	sState.pc = pc;` |
|    24005 | 3395 | `	rcOp = VmExecOpForeachInit(&(*pVm),&sState,pInstr);` |
|    24005 | 3396 | `	pTos = sState.pTos;` |
|    24005 | 3397 | `	pc = sState.pc;` |
|    24005 | 3398 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 3399 | `		goto Abort;` |
|    24005 | 3400 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3408 | ` */` |
|   130256 | 3409 | `case PH7_OP_FOREACH_STEP: {` |
|        - | 3410 | `	VmOpRc rcOp;` |
|   260517 | 3411 | `	sState.pTos = pTos;` |
|   260517 | 3412 | `	sState.pc = pc;` |
|   260517 | 3413 | `	rcOp = VmExecOpForeachStep(&(*pVm),&sState,pInstr);` |
|   260517 | 3414 | `	pTos = sState.pTos;` |
|   260517 | 3415 | `	pc = sState.pc;` |
|   260517 | 3416 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 3417 | `		goto Abort;` |
|   260515 | 3418 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|  1039861 | 3831 | `	sxi32 nCallArgs = pInstr->iP1 + (pInstr->iP2 ? VmSpreadOwnExtra(pVm,pInstr->iP1,pTos) : 0);` |
|        - | 3832 | `	ph7_value *pArg;` |
|  1039861 | 3833 | `	pArg = &pTos[-nCallArgs];` |
...
|  1039861 | 3842 | `	VmCallArgMap *pEffCallMap = (VmCallArgMap *)pInstr->p3;` |
...
|  1039861 | 3849 | `	if( VmValueIsClosure(pVm,pTos) ){` |
...
|  1039861 | 3859 | `	if( (pTos->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|      142 | 4054 | `		break;` |
|        - | 4055 | `	}` |
|  1039701 | 4056 | `	SyStringInitFromBuf(&sName,SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
...
|  1039701 | 4060 | `	if( sName.nByte > 0 && sName.zString[0] == '\\' ){` |
...
|  1039701 | 4067 | `	pEntry = SyHashGet(&pVm->hFunction,(const void *)sName.zString,sName.nByte);` |
...
|        - | 4073 | `	{` |
|  1039701 | 4074 | `	VmCallArgMap *pCallMap = pEffCallMap;` |
|  1039701 | 4075 | `	if( pEntry == 0 && pCallMap && pCallMap->bIsNamespaced ){` |
...
|        - | 4106 | `		VmSlot sArg;` |
|        - | 4107 | `		sxu32 n;` |
|   105250 | 4108 | `		int bClosureThis = 0;` |
|   105250 | 4109 | `		ph7_class *pClosureScope = 0;` |
|        - | 4110 | `		/* initialize fields */` |
|   105250 | 4111 | `		pVmFunc = (ph7_vm_func *)pEntry->pUserData;` |
|   105250 | 4112 | `		pThis = 0;` |
|   105250 | 4113 | `		pSelf = 0;` |
...
|       14 | 4128 | `		}` |
|   105250 | 4129 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
...
|   157975 | 4236 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   105245 | 4237 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
...
|   105250 | 4244 | `		if( VmRecursionExceeded(pVm) ){` |
...
|        3 | 4248 | `			goto Abort;` |
|        - | 4249 | `		}` |
|   105248 | 4250 | `		if( pVmFunc->pNextName ){` |
...
|   105248 | 4262 | `		pSelfHint = pSelf;` |
|   105248 | 4263 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
...
|    12265 | 4267 | `			}` |
|    12778 | 4268 | `		}` |
|   105248 | 4269 | `		if( pSelf == 0 && (pVmFunc->iFlags & VM_FUNC_CLOSURE) ){` |
...
|       29 | 4280 | `			}` |
|      887 | 4281 | `		}` |
|   105248 | 4282 | `		if( SySetUsed(&pVmFunc->aAttrs) > 0 ){` |
...
|       56 | 4287 | `		}` |
|   105248 | 4288 | `		if( pVmFunc->iFlags & VM_FUNC_GENERATOR ){` |
...
|   104908 | 4520 | `		aFormalArg = (ph7_vm_func_arg *)SySetBasePtr(&pVmFunc->aArgs);` |
|        - | 4521 | `		/* Create a new VM frame  */` |
|   104908 | 4522 | `		rc = VmEnterFrame(&(*pVm),pVmFunc,pThis,&pFrame);` |
|   104908 | 4523 | `		if( rc != SXRET_OK ){` |
...
|   104908 | 4551 | `		pFrame->nActualArgs = (int)(pTos - pArg);` |
|   104908 | 4552 | `		if( pThis && ((pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) \|\| bClosureThis) ){` |
...
|    12352 | 4560 | `			}` |
|    12352 | 4561 | `		}` |
|   104908 | 4562 | `		if( SySetUsed(&pVmFunc->aStatic) > 0 ){` |
...
|        - | 4589 | `		{` |
|   104908 | 4590 | `		VmCallArgMap *pCallMap3 = pEffCallMap;` |
|        - | 4591 | `		/* Caller file's strict_types mode — governs parameter coercion` |
|        - | 4592 | `		 * (but NOT return coercion, which uses the callee's file). */` |
|   104908 | 4593 | `		int bCallIsStrict = (pCallMap3 && pCallMap3->bStrict) ? 1 : 0;` |
|   104908 | 4594 | `		if( pCallMap3 && pCallMap3->bHasNamed ){` |
|        - | 4595 | `			/* ============================================================` |
...
|        - | 4980 | `		 * ============================================================ */` |
|   104640 | 4981 | `		n = 0;` |
|   265480 | 4982 | `		while( pArg < pTos ){` |
|   161145 | 4983 | `			if( n < SySetUsed(&pVmFunc->aArgs) && (aFormalArg[n].iFlags & VM_FUNC_ARG_VARIADIC) ){` |
...
|        - | 5083 | `			}` |
|   160945 | 5084 | `			if( n < SySetUsed(&pVmFunc->aArgs) ){` |
...
|   160439 | 5091 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_UNION ){` |
...
|   160352 | 5124 | `				if( aFormalArg[n].nType > 0` |
|    87408 | 5125 | `					&& !((aFormalArg[n].iFlags & VM_FUNC_ARG_NULLABLE) && (pArg->iFlags & MEMOBJ_NULL)) ){` |
...
|       13 | 5201 | `					}` |
|     6967 | 5202 | `				}` |
|   160341 | 5203 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_BY_REF ){` |
...
|   160101 | 5255 | `					pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|        - | 5256 | `				}` |
|    80377 | 5257 | `			}else{` |
|        - | 5258 | `				char zName[32];` |
...
|        - | 5265 | `			}` |
|   160845 | 5266 | `			if( pObj ){` |
|   160609 | 5267 | `				PH7_MemObjStore(pArg,pObj);` |
|        - | 5268 | `				/* Insert argument index  */` |
|   160609 | 5269 | `				sArg.nIdx = pObj->nIdx;` |
|   160609 | 5270 | `				sArg.pUserData = 0;` |
|   160609 | 5271 | `				SySetPut(&pFrame->sArg,(const void *)&sArg);` |
|    80507 | 5272 | `			}` |
|   160845 | 5273 | `			PH7_MemObjRelease(pArg);` |
|   160845 | 5274 | `			pArg++;` |
|   160845 | 5275 | `			++n;` |
|        5 | 5276 | `		}` |
|        - | 5277 | `		} /* end named vs positional branch */` |
|        - | 5278 | `		/* Set up closure environment */` |
|   104786 | 5279 | `		if( pVmFunc->iFlags & VM_FUNC_CLOSURE ){` |
...
|   104781 | 5327 | `		if( n < SySetUsed(&pVmFunc->aArgs)` |
|    55064 | 5328 | `		 && (pVmFunc->iFlags & (VM_FUNC_INTERNAL\|VM_FUNC_CLASS_METHOD)) != VM_FUNC_INTERNAL ){` |
...
|   112738 | 5351 | `		while( n < SySetUsed(&pVmFunc->aArgs) ){` |
...
|        - | 5394 | `		 */` |
|   104764 | 5395 | `		PH7_MemObjRelease(pTos);` |
|   104764 | 5396 | `		pTos = &pTos[-nCallArgs];` |
...
|        - | 5408 | `		 * per function. */` |
|        - | 5409 | `		{` |
|   104764 | 5410 | `			sxu32 nSlots = pVmFunc->nMaxStack;` |
|   104764 | 5411 | `			if( nSlots == 0 ){` |
...
|     4118 | 5418 | `			}` |
|   104764 | 5419 | `			pFrameStack = VmOperandStackAlloc(&(*pVm),nSlots);` |
|        - | 5420 | `		}` |
|   104764 | 5421 | `		if( pFrameStack == 0 ){` |
...
|      ! 0 | 5428 | `			break;` |
|        - | 5429 | `		}` |
|    52277 | 5430 | `SkipFuncBody:` |
|   104898 | 5431 | `		if( pSelf ){` |
|        - | 5432 | `			/* Push class name */` |
|    25615 | 5433 | `			SySetPut(&pVm->aSelf,(const void *)&pSelf);` |
|    12805 | 5434 | `		}` |
|        - | 5435 | `		/* Increment nesting level */` |
|   104898 | 5436 | `		pVm->nRecursionDepth++;` |
|   104898 | 5437 | `		if( rc == PH7_EXCEPTION ){` |
...
|   104764 | 5466 | `			VmCallFrame *pRec = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   104764 | 5467 | `			if( pRec ){` |
|   102132 | 5468 | `				pVm->pIdleCallFrames = (void *)pRec->pPrev;` |
|    51171 | 5469 | `			}else{` |
|     2637 | 5470 | `				pRec = (VmCallFrame *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmCallFrame));` |
|        - | 5471 | `			}` |
|   104764 | 5472 | `			if( pRec == 0 ){` |
...
|      ! 0 | 5483 | `				goto Abort;` |
|        - | 5484 | `			}` |
|   104764 | 5485 | `			sState.pTos = pTos;` |
|   104764 | 5486 | `			sState.pc = pc;` |
|   104764 | 5487 | `			pRec->sCaller = sState;` |
|   104764 | 5488 | `			pRec->sCall.pVmFunc = pVmFunc;` |
|   104764 | 5489 | `			pRec->sCall.pFrame = pFrame;` |
|   104764 | 5490 | `			pRec->sCall.pFrameStack = pFrameStack;` |
|   104764 | 5491 | `			pRec->sCall.nStackCap = pVmFunc->nMaxStack + VM_STACK_GUARD;` |
|   104764 | 5492 | `			pRec->sCall.nLastRef = SXU32_HIGH;` |
|   104764 | 5493 | `			pRec->sCall.bSelfPushed = (sxu8)(pSelf ? 1 : 0);` |
|   104764 | 5494 | `			pRec->pPrev = pCallTop;` |
|   104764 | 5495 | `			pCallTop = pRec;` |
|        - | 5496 | `			/* Switch to the callee activation (what the recursive` |
|        - | 5497 | `			 * VmByteCodeExec entry used to set up). */` |
|   104764 | 5498 | `			aInstr = (VmInstr *)SySetBasePtr(&pVmFunc->aByteCode);` |
|   104764 | 5499 | `			pStack = pFrameStack;` |
|   104764 | 5500 | `			pTos = &pStack[-1];` |
|   104764 | 5501 | `			pc = 0;` |
|   104764 | 5502 | `			sState.aInstr = aInstr;` |
|   104764 | 5503 | `			sState.pStack = pStack;` |
|   104764 | 5504 | `			sState.nStackCap = pRec->sCall.nStackCap; /* callee's operand-stack capacity for OP_SPREAD growth */` |
|   104764 | 5505 | `			sState.nStackOrig = pRec->sCall.nStackCap; /* fixed headroom reference (never grows) */` |
|   104764 | 5506 | `			sState.pTos = pTos;` |
|   104764 | 5507 | `			sState.pc = 0;` |
|   104764 | 5508 | `			sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|   104764 | 5509 | `			sState.pEntryFrame = pVm->pFrame;` |
|   104764 | 5510 | `			sState.pResult = pRec->sCaller.pTos;` |
|   104764 | 5511 | `			sState.pLastRef = &pRec->sCall.nLastRef;` |
|   104764 | 5512 | `			sState.pEnforceRetFunc = VmFuncHasReturnType(pVmFunc) ? pVmFunc : 0;` |
|   104764 | 5513 | `			sState.is_callback = 0;` |
|   104764 | 5514 | `			sState.bReturnPropagates = 0;` |
|   104764 | 5515 | `			goto VmLoopFetch;` |
|        - | 5516 | `		}` |
|       57 | 5517 | `	}else{` |
...
|   934456 | 5526 | `		pEntry = SyHashGet(&pVm->hHostFunction,(const void *)sName.zString,sName.nByte);` |
|        - | 5527 | `		{` |
|   934456 | 5528 | `		VmCallArgMap *pCallMap2 = pEffCallMap;` |
|   934456 | 5529 | `		if( pEntry == 0 && pCallMap2 && pCallMap2->bIsNamespaced ){` |
...
|        - | 5634 | `			}` |
|        - | 5635 | `		}` |
|   934440 | 5636 | `		pFunc = (ph7_user_func *)pEntry->pUserData;` |
...
|  1402021 | 5641 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   934435 | 5642 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
|        - | 5643 | `		/* Start collecting function arguments */` |
|   934440 | 5644 | `		SySetReset(&aArg);` |
|  2524956 | 5645 | `		while( pArg < pTos ){` |
|  1590521 | 5646 | `			SySetPut(&aArg,(const void *)&pArg);` |
|  1590521 | 5647 | `			pArg++;` |
|        5 | 5648 | `		}` |
|        - | 5649 | `		/* Assume a null return value */` |
|   934440 | 5650 | `		PH7_MemObjInit(&(*pVm),&sRet);` |
|        - | 5651 | `		/* Init the call context */` |
|   934440 | 5652 | `		VmInitCallContext(&sCtx,&(*pVm),pFunc,&sRet,0);` |
...
|   934440 | 5659 | `		sCtx.pArgMap = pEffCallMap;` |
|        - | 5660 | `		{` |
|   934440 | 5661 | `		int nGiven = (int)SySetUsed(&aArg);` |
...
|   934440 | 5667 | `		if( pFunc->nMinArg > 0 && nGiven < pFunc->nMinArg ){` |
...
|      232 | 5674 | `				nGiven);` |
|   934208 | 5675 | `		}else if( pFunc->bHasMaxArg && nGiven > (int)pFunc->nMaxArg ){` |
...
|       40 | 5688 | `				nGiven);` |
|  1401245 | 5689 | `		}else if( SXRET_OK != (rc = VmEnforceBuiltinArgTypes(&sCtx,pFunc,nGiven,` |
|   933891 | 5690 | `			(ph7_value **)SySetBasePtr(&aArg))) ){` |
|        - | 5691 | `			/* TypeError thrown: rc carries the caught/uncaught status */` |
|       91 | 5692 | `		}else{` |
|        - | 5693 | `			/* Call the foreign function */` |
|   933724 | 5694 | `			rc = pFunc->xFunc(&sCtx,nGiven,(ph7_value **)SySetBasePtr(&aArg));` |
|        - | 5695 | `		}` |
|        - | 5696 | `		}` |
|        - | 5697 | `		/* Release the call context */` |
|   934440 | 5698 | `		VmReleaseCallContext(&sCtx);` |
|   934440 | 5699 | `		if( rc == PH7_ABORT ){` |
...
|      576 | 5704 | `			goto Abort;` |
|        - | 5705 | `		}` |
|   933868 | 5706 | `		if( rc != PH7_SUSPEND && pVm->pInlineInstr == (void *)aInstr ){` |
...
|      ! 0 | 5719 | `		}` |
|   933864 | 5720 | `		if( rc == PH7_EXCEPTION ){` |
...
|      792 | 5740 | `			break;` |
|        - | 5741 | `		}` |
|   932878 | 5742 | `		if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|   911538 | 5766 | `			VmPopOperand(&pTos,nCallArgs);` |
|   456130 | 5767 | `		}` |
|        - | 5768 | `		/* Save foreign function return value into the (now top) function-name slot */` |
|   932524 | 5769 | `		PH7_MemObjStore(&sRet,pTos);` |
|   932524 | 5770 | `		PH7_MemObjRelease(&sRet);` |
|        - | 5771 | `	}` |
|   932628 | 5772 | `	break;` |
|        - | 5773 | `				  }` |
|        - | 5774 | `/*` |
...
|        - | 5777 | ` */` |
|    25749 | 5778 | `case PH7_OP_CONSUME: {` |
|        - | 5779 | `	VmOpRc rcOp;` |
|    51503 | 5780 | `	sState.pTos = pTos;` |
|    51503 | 5781 | `	sState.pc = pc;` |
|    51503 | 5782 | `	rcOp = VmExecOpConsume(&(*pVm),&sState,pInstr);` |
|    51503 | 5783 | `	pTos = sState.pTos;` |
|    51503 | 5784 | `	pc = sState.pc;` |
|    51503 | 5785 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 5786 | `		goto Abort;` |
|    51503 | 5787 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 5792 |  |
|        - | 5793 | `		} /* Switch() */` |
| 16436944 | 5794 | `		pc++; /* Next instruction in the stream */` |
|        5 | 5795 | `	} /* For(;;) */` |
|   128792 | 5796 | `Done:` |
...
|   257794 | 5800 | `	rc = SXRET_OK;` |
|   257794 | 5801 | `	goto Unwind;` |
|      823 | 5802 | `Suspend:` |
...
|   130795 | 5860 | `	for(;;){` |
|   261390 | 5861 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|      ! 0 | 5869 | `			}` |
|     1152 | 5870 | `		}` |
|   261390 | 5871 | `		if( pCallTop == 0 ){` |
|   157041 | 5872 | `			return VmExecFinalize(&(*pVm),&sState,&aArg,pTos,rc);` |
|        - | 5873 | `		}` |
|   104354 | 5874 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|      627 | 5880 | `		}` |
|        - | 5881 | `		{` |
|   104354 | 5882 | `			VmCallFrame *pRec = pCallTop;` |
|   104354 | 5883 | `			sState = pRec->sCaller;` |
|   104354 | 5884 | `			rc = VmCallFinish(&(*pVm),&sState,&pRec->sCall,rc);` |
|   104354 | 5885 | `			pCallTop = pRec->pPrev;` |
|   104354 | 5886 | `			pRec->pPrev = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   104354 | 5887 | `			pVm->pIdleCallFrames = (void *)pRec;` |
|   104354 | 5888 | `			aInstr = sState.aInstr;` |
|   104354 | 5889 | `			pStack = sState.pStack;` |
|   104354 | 5890 | `			pTos = sState.pTos;` |
|   104354 | 5891 | `			pc = sState.pc;` |
|        - | 5892 | `		}` |
|   104354 | 5893 | `		if( rc == PH7_OK ){` |
|   103588 | 5894 | `			pc++; /* the loop-bottom increment this OP_CALL missed */` |
|   103588 | 5895 | `			goto VmLoopFetch;` |
|        - | 5896 | `		}` |
|        5 | 5897 | `	}` |
|    78700 | 5898 | `}` |
|        - | 5899 |  |
