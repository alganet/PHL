...
|        - |  162 | ` */` |
|   156986 |  163 | `static sxi32 VmExecFinalize(ph7_vm *pVm,VmExecState *pState,SySet *pArg,ph7_value *pTos,sxi32 rcTerm)` |
|        5 |  164 | `{` |
|    78493 |  165 | `	SXUNUSED(pVm);` |
|   156991 |  166 | `	if( rcTerm != PH7_SUSPEND && !pState->bReturnPropagates ){` |
|   153363 |  167 | `		VmClearFrameReturn(pState->pEntryFrame);` |
|    76679 |  168 | `	}` |
|   156991 |  169 | `	SySetRelease(pArg);` |
|   156991 |  170 | `	if( rcTerm == PH7_ABORT \|\| rcTerm == PH7_EXCEPTION ){` |
|     2835 |  171 | `		while( pTos >= pState->pStack ){` |
|     1785 |  172 | `			PH7_MemObjRelease(pTos);` |
|     1785 |  173 | `			pTos--;` |
|        5 |  174 | `		}` |
|      525 |  175 | `	}` |
|   156991 |  176 | `	return rcTerm;` |
|        5 |  177 | `}` |
|        - |  178 | `/*` |
...
|        - |  189 | ` */` |
|   104261 |  190 | `static sxi32 VmCallFinish(ph7_vm *pVm,VmExecState *pCaller,VmCallRecord *pCallee,sxi32 rc)` |
|        5 |  191 | `{` |
|        - |  192 | `	ph7_value *pObj;` |
|        - |  193 | `	/* Decrement nesting level */` |
|   104266 |  194 | `	pVm->nRecursionDepth--;` |
|   104266 |  195 | `	if( pCallee->bSelfPushed ){` |
|        - |  196 | `		/* Pop class name */` |
|    25383 |  197 | `		(void)SySetPop(&pVm->aSelf);` |
|    12689 |  198 | `	}` |
|   104266 |  199 | `	if( (pCallee->pVmFunc->iFlags & VM_FUNC_REF_RETURN) && rc == SXRET_OK ){` |
...
|       25 |  225 | `	}` |
|   104266 |  226 | `	if( rc != PH7_ABORT && ((pCallee->pFrame->iFlags & VM_FRAME_THROW) \|\| rc == PH7_EXCEPTION) ){` |
...
|   104266 |  272 | `	if( rc != PH7_SUSPEND && pCallee->pFrameStack ){` |
...
|   104132 |  276 | `		VmOperandStackRecycle(pVm,pCallee->pFrameStack,pCallee->nStackCap);` |
|    52166 |  277 | `	}` |
|        - |  278 | `	/* Leave the frame */` |
|   104266 |  279 | `	VmLeaveFrame(&(*pVm));` |
|   104266 |  280 | `	if( rc == PH7_ABORT ){` |
|      336 |  281 | `		return PH7_ABORT;` |
|        - |  282 | `	}` |
|   103934 |  283 | `	if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|        - |  291 | `	}` |
|   103934 |  292 | `	if( rc == PH7_EXCEPTION ){` |
|      469 |  293 | `		return PH7_EXCEPTION;` |
|        - |  294 | `	}` |
|   103470 |  295 | `	return PH7_OK;` |
|    52238 |  296 | `}` |
|        - |  297 | `/*` |
...
|        - |  330 | ` * nesting.` |
|        - |  331 | ` */` |
|   157344 |  332 | `PH7_PRIVATE sxi32 VmByteCodeExec(` |
...
|   157349 |  352 | `	if( VmNativeNestingExceeded(pVm) ){` |
...
|   157345 |  362 | `	nSavedBrc = pVm->nBoundaryRc;` |
|   157345 |  363 | `	pVm->nBoundaryRc = 0;` |
...
|   157345 |  370 | `	nSavedLine = pVm->nCurLine;` |
|   157345 |  371 | `	pVm->nVmExecDepth++;` |
|   236015 |  372 | `	rc = VmByteCodeExecBody(&(*pVm),aInstr,pStack,nTos,pResult,pLastRef,is_callback,nPc,` |
|    78670 |  373 | `		pEnforceRetFunc,bReturnPropagates,pAdoptSegment,ppBaseOwner,pnBaseCap,nStackOrig);` |
|   157345 |  374 | `	pVm->nVmExecDepth--;` |
|   157345 |  375 | `	pVm->nCurLine = nSavedLine;` |
|   157345 |  376 | `	if( nSavedBrc != 0 && (nSavedBrc == PH7_ABORT \|\| pVm->nBoundaryRc == 0) ){` |
|       15 |  377 | `		pVm->nBoundaryRc = nSavedBrc;` |
|        6 |  378 | `	}` |
|   157345 |  379 | `	return rc;` |
|    78677 |  380 | `}` |
|   157340 |  381 | `static sxi32 VmByteCodeExecBody(` |
...
|        - |  399 | `	ph7_value *pTos;` |
|        - |  400 | `	SySet aArg;` |
|   157345 |  401 | `	VmCallFrame *pCallTop = 0; /* Top of this invocation's in-loop call-record` |
...
|        - |  409 | `	sxi32 pc;` |
|        - |  410 | `	sxi32 rc;` |
|   157345 |  411 | `	sState.aInstr = aInstr;` |
|   157345 |  412 | `	sState.pStack = pStack;` |
|   157345 |  413 | `	sState.nStackCap = pnBaseCap ? *pnBaseCap : 0; /* CURRENT capacity (grown on a coroutine resume) */` |
|   157345 |  414 | `	sState.nStackOrig = nStackOrig;                /* ORIGINAL capacity — fixed headroom reference */` |
|   157345 |  415 | `	sState.pResult = pResult;` |
|   157345 |  416 | `	sState.pLastRef = pLastRef;` |
|   157345 |  417 | `	sState.pEnforceRetFunc = pEnforceRetFunc;` |
|   157345 |  418 | `	sState.is_callback = (sxu8)(is_callback ? 1 : 0);` |
|   157345 |  419 | `	sState.bReturnPropagates = (sxu8)(bReturnPropagates ? 1 : 0);` |
|        - |  420 | `	/* Argument container */` |
|   157345 |  421 | `	SySetInit(&aArg,&pVm->sAllocator,sizeof(ph7_value *));` |
|   157345 |  422 | `	if( nTos < 0 ){` |
|   141639 |  423 | `		pTos = &pStack[-1];` |
|    70822 |  424 | `	}else{` |
|    15711 |  425 | `		pTos = &pStack[nTos];` |
|        - |  426 | `	}` |
|   157345 |  427 | `	sState.pTos = pTos;` |
|   157345 |  428 | `	sState.pc = nPc;` |
...
|   157340 |  446 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->pFrame == pVm->pFrame` |
|     2816 |  447 | `	 && pStack == pVm->pActiveCtx->pStack ){` |
|     1805 |  448 | `		sState.nExceptionBase = pVm->pActiveCtx->nExceptionBase;` |
|      905 |  449 | `	}else{` |
|   155545 |  450 | `		sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|        - |  451 | `	}` |
|   157345 |  452 | `	sState.pEntryFrame = pVm->pFrame;` |
|   157345 |  453 | `	pc = nPc;` |
...
|   157340 |  506 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->pInjected` |
...
|   157330 |  567 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->bClosing` |
...
| 16802922 |  603 | `		if( pVm->nBoundaryRc != 0 \|\| SySetUsed(&pVm->aHookRmw) > 0 ){` |
...
| 16802836 |  658 | `		pInstr = &aInstr[pc];` |
| 16802836 |  659 | `		if( pInstr->nLine ){` |
...
| 16589798 |  663 | `			pVm->nCurLine = pInstr->nLine;` |
|  8301223 |  664 | `		}` |
| 16802836 |  665 | `		rc = SXRET_OK;` |
|        - |  666 | `/*` |
...
|        - |  672 | ` */` |
| 16802836 |  673 | `		switch(pInstr->iOp){` |
|        - |  674 | `/*` |
|        - |  675 | ` * DONE: P1 * *` |
|        - |  676 | ` *` |
...
|        - |  679 | ` */` |
|   128556 |  680 | `case PH7_OP_DONE:` |
|   257322 |  681 | `	if( pInstr->iP2 && sState.bReturnPropagates ){` |
...
|   257133 |  711 | `	if( sState.pEnforceRetFunc && VmFuncHasReturnType(sState.pEnforceRetFunc)` |
...
|     4591 |  736 | `	}` |
|   257114 |  737 | `	if( pInstr->iP1 && pTos >= pStack ){` |
|   152640 |  738 | `		if( sState.pLastRef ){` |
|    93866 |  739 | `			*sState.pLastRef = pTos->nIdx;` |
|    47033 |  740 | `		}` |
|   152640 |  741 | `		if( sState.pResult ){` |
|        - |  742 | `			/* Execution result */` |
|   145634 |  743 | `			PH7_MemObjStore(pTos,sState.pResult);` |
|    72917 |  744 | `		}` |
|   152640 |  745 | `		VmPopOperand(&pTos,1);` |
|   180899 |  746 | `	}else if( sState.pLastRef ){` |
...
|     8865 |  752 | `		*sState.pLastRef = SXU32_HIGH;` |
|     4430 |  753 | `	}` |
...
|        - |  762 | `	 */` |
|   257114 |  763 | `	rc = VmDrainFinally(&(*pVm),sState.nExceptionBase);` |
|   257114 |  764 | `	if( rc == SXERR_ABORT ){` |
|      ! 0 |  765 | `		goto Abort;` |
|        - |  766 | `	}` |
|   257114 |  767 | `	if( rc == PH7_EXCEPTION ){` |
...
|        - |  778 | `	}` |
|   257110 |  779 | `	if( sState.pEntryFrame->bHasRet && !sState.bReturnPropagates ){` |
...
|        - |  835 | ` */` |
|   288515 |  836 | `case PH7_OP_JMP:` |
|   577240 |  837 | `	pc = pInstr->iP2 - 1;` |
|   577240 |  838 | `	break;` |
|        - |  839 | `/*` |
|        - |  840 | ` * JZ: P1 P2 *` |
|        - |  841 | ` *` |
...
|  1604813 |  852 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     1003 |  853 | `		PH7_MemObjToBool(pTos);` |
|      500 |  854 | `	}` |
|  1604813 |  855 | `	if( !pTos->x.iVal ){` |
|        - |  856 | `		/* Take the jump */` |
|   899450 |  857 | `		pc = pInstr->iP2 - 1;` |
|   449983 |  858 | `	}` |
|  1604813 |  859 | `	if( !pInstr->iP1 ){` |
|  1356407 |  860 | `		VmPopOperand(&pTos,1);` |
|   678769 |  861 | `	}` |
|  1604813 |  862 | `	break;` |
|        - |  863 | `/*` |
|        - |  864 | ` * JNZ: P1 P2 *` |
...
|        - |  899 | ` */` |
|   661736 |  900 | `case PH7_OP_POP: {` |
|  1324502 |  901 | `	sxi32 n = pInstr->iP1;` |
|  1324502 |  902 | `	if( &pTos[-n+1] < pStack ){` |
|        - |  903 | `		/* TICKET 1433-51 Stack underflow must be handled at run-time */` |
|       79 |  904 | `		n = (sxi32)(pTos - pStack);` |
|       38 |  905 | `	}` |
|  1324502 |  906 | `	VmPopOperand(&pTos,n);` |
|  1324502 |  907 | `	break;` |
|        - |  908 | `				 }` |
|        - |  909 | `/*` |
|        - |  910 | ` * DUP: * * *` |
...
|        - |  929 | ` */` |
|    49015 |  930 | `case PH7_OP_NSSWITCH:` |
|    98035 |  931 | `	SyBlobReset(&pVm->sNamespace);` |
|    98035 |  932 | `	if( pInstr->p3 ){` |
...
|    98035 |  937 | `	SyHashRelease(&pVm->hUseConstImports);` |
|    98035 |  938 | `	SyHashInit(&pVm->hUseConstImports,&pVm->sAllocator,0,0);` |
|    98035 |  939 | `	break;` |
...
|        - | 1076 | ` */` |
|     3391 | 1077 | `case PH7_OP_UNSET_VAR: {` |
|        - | 1078 | `	VmOpRc rcOp;` |
|     6787 | 1079 | `	sState.pTos = pTos;` |
|     6787 | 1080 | `	sState.pc = pc;` |
|     6787 | 1081 | `	rcOp = VmExecOpUnsetVar(&(*pVm),&sState,pInstr);` |
|     6787 | 1082 | `	pTos = sState.pTos;` |
|     6787 | 1083 | `	pc = sState.pc;` |
|     6787 | 1084 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 1085 | `		goto Abort;` |
|     6785 | 1086 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1163 | ` */` |
|  1510915 | 1164 | `case PH7_OP_LOADC: {` |
|        - | 1165 | `	ph7_value *pObj;` |
|        - | 1166 | `	/* Reserve a room */` |
|  3023697 | 1167 | `	pTos++;` |
|  3023697 | 1168 | `	if( pInstr->iP1 & PH7_LOADC_NOKEY ){` |
...
|    19089 | 1174 | `		break;` |
|        - | 1175 | `	}` |
|  3004613 | 1176 | `	if( (pObj = (ph7_value *)SySetAt(&pVm->aLitObj,pInstr->iP2)) != 0 ){` |
|  3004613 | 1177 | `		if( (pInstr->iP1 & PH7_LOADC_EXPAND) && SyBlobLength(&pObj->sBlob) <= 64 ){` |
...
|        - | 1283 | ` */` |
|  2195040 | 1284 | `case PH7_OP_LOAD:{` |
|        - | 1285 | `	ph7_value *pObj;` |
|        - | 1286 | `	SyString sName;` |
|  4393997 | 1287 | `	if( pInstr->p3 == 0 ){` |
...
|        9 | 1299 | `	}else{` |
|  4393981 | 1300 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1301 | `		/* Reserve a room for the target object */` |
|  4393981 | 1302 | `		pTos++;` |
|        - | 1303 | `	}` |
|  4393997 | 1304 | `	if( pInstr->iP2 == 2 ){` |
...
|  4393997 | 1315 | `	pObj = VmExtractMemObj(&(*pVm),&sName,pInstr->p3 ? FALSE : TRUE,pInstr->iP1 != 1);` |
|  4393997 | 1316 | `	if( pObj == 0 ){` |
...
|  4393935 | 1341 | `	PH7_MemObjLoad(pObj,pTos);` |
|  4393935 | 1342 | `	pTos->nIdx = pObj->nIdx;` |
|  4393935 | 1343 | `	break;` |
|        - | 1344 | `				   }` |
|        - | 1345 | `/*` |
|        - | 1346 | ` * LOAD_MAP P1 * *` |
...
|        - | 1351 | ` */` |
|    36851 | 1352 | `case PH7_OP_LOAD_MAP: {` |
|        - | 1353 | `	VmOpRc rcOp;` |
|    73707 | 1354 | `	sState.pTos = pTos;` |
|    73707 | 1355 | `	sState.pc = pc;` |
|    73707 | 1356 | `	rcOp = VmExecOpLoadMap(&(*pVm),&sState,pInstr);` |
|    73707 | 1357 | `	pTos = sState.pTos;` |
|    73707 | 1358 | `	pc = sState.pc;` |
|    73707 | 1359 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1360 | `		goto Abort;` |
|    73707 | 1361 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1394 | ` * instead.` |
|        - | 1395 | ` */` |
|   331850 | 1396 | `case PH7_OP_LOAD_IDX: {` |
|        - | 1397 | `	VmOpRc rcOp;` |
|   664431 | 1398 | `	sState.pTos = pTos;` |
|   664431 | 1399 | `	sState.pc = pc;` |
|   664431 | 1400 | `	rcOp = VmExecOpLoadIdx(&(*pVm),&sState,pInstr);` |
|   664431 | 1401 | `	pTos = sState.pTos;` |
|   664431 | 1402 | `	pc = sState.pc;` |
|   664431 | 1403 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1404 | `		goto Abort;` |
|   664431 | 1405 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1507 | `	}` |
|        - | 1508 | `#endif` |
|   595197 | 1509 | `	if( pInstr->iP2 ){` |
|        - | 1510 | `		sxu32 nIdx;` |
|        - | 1511 | `		sxi32 rcT;` |
|        - | 1512 | `		/* Member store operation */` |
|    11749 | 1513 | `		nIdx = pTos->nIdx;` |
|    11749 | 1514 | `		VmPopOperand(&pTos,1);` |
|    11749 | 1515 | `		if( pVm->pMagicSetThis ){` |
...
|       11 | 1528 | `			break;` |
|        - | 1529 | `		}` |
|    11739 | 1530 | `		if( pVm->pHookSetThis ){` |
...
|    11707 | 1558 | `			rcT = VmEnforcePropertyTypeOnStore(&(*pVm),nIdx,pTos,0);` |
|    11707 | 1559 | `			if( rcT == PH7_ABORT ){` |
|       13 | 1560 | `				goto Abort;` |
|        - | 1561 | `			}` |
|    11697 | 1562 | `			if( rcT == PH7_EXCEPTION ){` |
...
|    11629 | 1577 | `			pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|    11629 | 1578 | `			if( pObj ){` |
|        - | 1579 | `				/* Perform the store operation */` |
|    11629 | 1580 | `				PH7_MemObjStore(pTos,pObj);` |
|     5812 | 1581 | `			}` |
|        - | 1582 | `		}` |
|    11631 | 1583 | `		break;` |
|   583453 | 1584 | `	}else if( pInstr->p3 == 0 ){` |
...
|        - | 1596 | `#endif` |
|        5 | 1597 | `	}else{` |
|   583445 | 1598 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1599 | `	}` |
|   583448 | 1600 | `	if( sName.nByte == sizeof("GLOBALS")-1` |
|   293498 | 1601 | `	 && SyMemcmp((const void *)sName.zString,(const void *)"GLOBALS",sName.nByte) == 0 ){` |
|        6 | 1602 | `		if( pInstr->p3 ){` |
...
|        - | 1639 | ` */` |
|   120408 | 1640 | `case PH7_OP_STORE_IDX:` |
|        - | 1641 | `case PH7_OP_STORE_IDX_REF: {` |
|        - | 1642 | `	VmOpRc rcOp;` |
|   240821 | 1643 | `	sState.pTos = pTos;` |
|   240821 | 1644 | `	sState.pc = pc;` |
|   240821 | 1645 | `	rcOp = VmExecOpStoreIdxRef(&(*pVm),&sState,pInstr);` |
|   240821 | 1646 | `	pTos = sState.pTos;` |
|   240821 | 1647 | `	pc = sState.pc;` |
|   240821 | 1648 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 1649 | `		goto Abort;` |
|   240819 | 1650 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|    50891 | 1997 | `	if( (pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      119 | 1998 | `		PH7_MemObjToBool(pTos);` |
|       57 | 1999 | `	}` |
|    50891 | 2000 | `	pTos->x.iVal = !pTos->x.iVal;` |
|    50891 | 2001 | `	break;` |
|        - | 2002 | `/*` |
|        - | 2003 | ` * OP_BITNOT: * * *` |
|        - | 2004 | ` *` |
...
|        - | 2526 | ` * back.` |
|        - | 2527 | ` */` |
|    86371 | 2528 | `case PH7_OP_CAT:{` |
|        - | 2529 | `	ph7_value *pNos,*pCur;` |
|   172747 | 2530 | `	if( pInstr->iP1 < 1 ){` |
|   144523 | 2531 | `		pNos = &pTos[-1];` |
|    72264 | 2532 | `	}else{` |
...
|   172747 | 2541 | `	if( (pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|     1931 | 2542 | `		PH7_MemObjToString(pNos);` |
|      963 | 2543 | `	}` |
|   172747 | 2544 | `	pCur = &pNos[1];` |
|   348881 | 2545 | `	while( pCur <= pTos ){` |
|   176139 | 2546 | `		if( (pCur->iFlags & MEMOBJ_STRING) == 0 ){` |
|    52225 | 2547 | `			PH7_MemObjToString(pCur);` |
|    26110 | 2548 | `		}` |
|        - | 2549 | `		/* Perform the concatenation */` |
|   176139 | 2550 | `		if( SyBlobLength(&pCur->sBlob) > 0 ){` |
|   175991 | 2551 | `			if( PH7_MemObjStringAppend(pNos,(const char *)SyBlobData(&pCur->sBlob),SyBlobLength(&pCur->sBlob)) != SXRET_OK ){` |
|        - | 2552 | `				/* Allocation failure: raise a fatal instead of a truncated concat */` |
|      ! 0 | 2553 | `				PH7_VmMemoryError(&(*pVm));` |
|      ! 0 | 2554 | `				goto Abort;` |
|        - | 2555 | `			}` |
|    87993 | 2556 | `		}` |
|   176139 | 2557 | `		SyBlobRelease(&pCur->sBlob);` |
|   176139 | 2558 | `		pCur++;` |
|        5 | 2559 | `	}` |
|   172747 | 2560 | `	pTos = pNos;` |
|   172747 | 2561 | `	break;` |
|        - | 2562 | `				}` |
|        - | 2563 | `/*  CAT_STORE: * * *` |
|        - | 2564 | ` *` |
...
|        - | 2668 | ` * stack.` |
|        - | 2669 | ` */` |
|   114056 | 2670 | `case PH7_OP_LAND:` |
|        - | 2671 | `case PH7_OP_LOR: {` |
|        - | 2672 | `	VmOpRc rcOp;` |
|   228322 | 2673 | `	sState.pTos = pTos;` |
|   228322 | 2674 | `	sState.pc = pc;` |
|   228322 | 2675 | `	rcOp = VmExecOpLor(&(*pVm),&sState,pInstr);` |
|   228322 | 2676 | `	pTos = sState.pTos;` |
|   228322 | 2677 | `	pc = sState.pc;` |
|   228322 | 2678 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2679 | `		goto Abort;` |
|   228322 | 2680 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2917 | ` */` |
|   228133 | 2918 | `case PH7_OP_TEQ: {` |
|        - | 2919 | `	VmOpRc rcOp;` |
|   456476 | 2920 | `	sState.pTos = pTos;` |
|   456476 | 2921 | `	sState.pc = pc;` |
|   456476 | 2922 | `	rcOp = VmExecOpTeq(&(*pVm),&sState,pInstr);` |
|   456476 | 2923 | `	pTos = sState.pTos;` |
|   456476 | 2924 | `	pc = sState.pc;` |
|   456476 | 2925 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2926 | `		goto Abort;` |
|   456476 | 2927 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2939 | ` *` |
|        - | 2940 | ` */` |
|   174476 | 2941 | `case PH7_OP_TNE: {` |
|        - | 2942 | `	VmOpRc rcOp;` |
|   349162 | 2943 | `	sState.pTos = pTos;` |
|   349162 | 2944 | `	sState.pc = pc;` |
|   349162 | 2945 | `	rcOp = VmExecOpTne(&(*pVm),&sState,pInstr);` |
|   349162 | 2946 | `	pTos = sState.pTos;` |
|   349162 | 2947 | `	pc = sState.pc;` |
|   349162 | 2948 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2949 | `		goto Abort;` |
|   349162 | 2950 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3113 | ` */` |
|     1353 | 3114 | `case PH7_OP_LOAD_EXCEPTION: {` |
|        - | 3115 | `	VmOpRc rcOp;` |
|     2711 | 3116 | `	sState.pTos = pTos;` |
|     2711 | 3117 | `	sState.pc = pc;` |
|     2711 | 3118 | `	rcOp = VmExecOpLoadException(&(*pVm),&sState,pInstr);` |
|     2711 | 3119 | `	pTos = sState.pTos;` |
|     2711 | 3120 | `	pc = sState.pc;` |
|     2711 | 3121 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 3122 | `		goto Abort;` |
|     2711 | 3123 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3131 | ` */` |
|     1186 | 3132 | `case PH7_OP_POP_EXCEPTION: {` |
|     2377 | 3133 | `	ph7_exception *pCompiledExc = (ph7_exception *)pInstr->p3;` |
...
|     2377 | 3138 | `	ph7_exception *pException = 0;` |
|     2377 | 3139 | `	if( SySetUsed(&pVm->aException) > 0 ){` |
...
|      193 | 3153 | `		}` |
|      200 | 3154 | `	}` |
|     2377 | 3155 | `	if( pCompiledExc->iInlined ){` |
...
|     2223 | 3182 | `	if( pVm->pFrame->iFlags & VM_FRAME_EXCEPTION ){` |
|     1613 | 3183 | `		VmLeaveFrame(&(*pVm));` |
|      804 | 3184 | `	}` |
...
|     2223 | 3188 | `	if( pException && pCompiledExc->iHasFinally && !pException->iFinallyDone ){` |
...
|        - | 3206 | `		}` |
|       12 | 3207 | `	}` |
|     2219 | 3208 | `	VmExcRelease(&(*pVm),pException); /* no-finally / already-done paths (may be NULL) */` |
|     2219 | 3209 | `	if( VmSkipExceptionFrames(pVm->pFrame)->bHasRet ){` |
...
|        - | 3426 | ` */` |
|    22387 | 3427 | `case PH7_OP_MEMBER: {` |
|        - | 3428 | `	VmOpRc rcOp;` |
|    44779 | 3429 | `	sState.pTos = pTos;` |
|    44779 | 3430 | `	sState.pc = pc;` |
|    44779 | 3431 | `	rcOp = VmExecOpMember(&(*pVm),&sState,pInstr);` |
|    44779 | 3432 | `	pTos = sState.pTos;` |
|    44779 | 3433 | `	pc = sState.pc;` |
|    44779 | 3434 | `	if( rcOp == VM_OP_ABORT ){` |
|        8 | 3435 | `		goto Abort;` |
|    44773 | 3436 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|  1039052 | 3831 | `	sxi32 nCallArgs = pInstr->iP1 + (pInstr->iP2 ? VmSpreadOwnExtra(pVm,pInstr->iP1,pTos) : 0);` |
|        - | 3832 | `	ph7_value *pArg;` |
|  1039052 | 3833 | `	pArg = &pTos[-nCallArgs];` |
...
|  1039052 | 3842 | `	VmCallArgMap *pEffCallMap = (VmCallArgMap *)pInstr->p3;` |
...
|  1039052 | 3849 | `	if( VmValueIsClosure(pVm,pTos) ){` |
...
|  1039052 | 3859 | `	if( (pTos->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|      142 | 4054 | `		break;` |
|        - | 4055 | `	}` |
|  1038892 | 4056 | `	SyStringInitFromBuf(&sName,SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
...
|  1038892 | 4060 | `	if( sName.nByte > 0 && sName.zString[0] == '\\' ){` |
...
|  1038892 | 4067 | `	pEntry = SyHashGet(&pVm->hFunction,(const void *)sName.zString,sName.nByte);` |
...
|        - | 4073 | `	{` |
|  1038892 | 4074 | `	VmCallArgMap *pCallMap = pEffCallMap;` |
|  1038892 | 4075 | `	if( pEntry == 0 && pCallMap && pCallMap->bIsNamespaced ){` |
...
|        - | 4106 | `		VmSlot sArg;` |
|        - | 4107 | `		sxu32 n;` |
|   105028 | 4108 | `		int bClosureThis = 0;` |
|   105028 | 4109 | `		ph7_class *pClosureScope = 0;` |
|        - | 4110 | `		/* initialize fields */` |
|   105028 | 4111 | `		pVmFunc = (ph7_vm_func *)pEntry->pUserData;` |
|   105028 | 4112 | `		pThis = 0;` |
|   105028 | 4113 | `		pSelf = 0;` |
...
|       14 | 4128 | `		}` |
|   105028 | 4129 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
|        - | 4130 | `			ph7_class_method *pMeth;` |
|        - | 4131 | `			/* Class method call */` |
|    25539 | 4132 | `			ph7_value *pTarget = &pTos[-1];` |
|    25539 | 4133 | `			if( pTarget >= pStack && (pTarget->iFlags & (MEMOBJ_STRING\|MEMOBJ_OBJ\|MEMOBJ_NULL)) ){` |
|        - | 4134 | `				/* Extract the 'this' pointer */` |
|    25539 | 4135 | `				if(pTarget->iFlags & MEMOBJ_OBJ ){` |
|        - | 4136 | `					/* Instance already loaded */` |
|    24503 | 4137 | `					pThis = (ph7_class_instance *)pTarget->x.pOther;` |
|    24503 | 4138 | `					pThis->iRef++;` |
|    24503 | 4139 | `					pSelf = pThis->pClass;` |
|    12249 | 4140 | `				}` |
|    25539 | 4141 | `				if( pSelf == 0 ){` |
...
|      353 | 4160 | `					}` |
|      518 | 4161 | `				}` |
|    25539 | 4162 | `				VmPopOperand(&pTos,1);` |
|    25539 | 4163 | `				PH7_MemObjRelease(pTos);` |
...
|    25539 | 4170 | `				nCallArgs = pInstr->iP1 + (pInstr->iP2 ? VmSpreadOwnExtra(&(*pVm),pInstr->iP1,pTos) : 0);` |
|    25539 | 4171 | `				pArg = &pTos[-nCallArgs];` |
...
|        - | 4176 | `				 */` |
|    25539 | 4177 | `				while( pArg < pStack ){` |
|      ! 0 | 4178 | `					pArg++;` |
|      ! 0 | 4179 | `				}` |
|    25539 | 4180 | `				if( pSelf && pVm->bReflectBypass ){` |
...
|        6 | 4185 | `				}else` |
|    25529 | 4186 | `				if( pSelf ){ /* Paranoid edition */` |
...
|    25529 | 4194 | `					ph7_class *pDeclClass = pVmFunc->pUserData ? (ph7_class *)pVmFunc->pUserData : pSelf;` |
|    25529 | 4195 | `					pMeth = PH7_ClassExtractMethod(pDeclClass,pVmFunc->sName.zString,pVmFunc->sName.nByte);` |
|    25529 | 4196 | `					if( pMeth == 0 && pDeclClass != pSelf ){` |
|      ! 0 | 4197 | `						pMeth = PH7_ClassExtractMethod(pSelf,pVmFunc->sName.zString,pVmFunc->sName.nByte);` |
|      ! 0 | 4198 | `					}` |
|    25529 | 4199 | `					if( pMeth && pMeth->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|   157642 | 4236 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   105023 | 4237 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
...
|   105028 | 4244 | `		if( VmRecursionExceeded(pVm) ){` |
...
|        3 | 4248 | `			goto Abort;` |
|        - | 4249 | `		}` |
|   105026 | 4250 | `		if( pVmFunc->pNextName ){` |
...
|   105026 | 4262 | `		pSelfHint = pSelf;` |
|   105026 | 4263 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
|    25539 | 4264 | `			ph7_class *pDecl = (ph7_class *)pVmFunc->pUserData;` |
|    25539 | 4265 | `			if( pDecl && (pDecl->iFlags & PH7_CLASS_TRAIT) == 0 ){` |
|    24513 | 4266 | `				pSelfHint = pDecl;` |
|    12254 | 4267 | `			}` |
|    12767 | 4268 | `		}` |
|   105026 | 4269 | `		if( pSelf == 0 && (pVmFunc->iFlags & VM_FUNC_CLOSURE) ){` |
...
|       29 | 4280 | `			}` |
|      887 | 4281 | `		}` |
|   105026 | 4282 | `		if( SySetUsed(&pVmFunc->aAttrs) > 0 ){` |
...
|       56 | 4287 | `		}` |
|   105026 | 4288 | `		if( pVmFunc->iFlags & VM_FUNC_GENERATOR ){` |
...
|   104686 | 4520 | `		aFormalArg = (ph7_vm_func_arg *)SySetBasePtr(&pVmFunc->aArgs);` |
|        - | 4521 | `		/* Create a new VM frame  */` |
|   104686 | 4522 | `		rc = VmEnterFrame(&(*pVm),pVmFunc,pThis,&pFrame);` |
|   104686 | 4523 | `		if( rc != SXRET_OK ){` |
...
|   104686 | 4551 | `		pFrame->nActualArgs = (int)(pTos - pArg);` |
|   104686 | 4552 | `		if( pThis && ((pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) \|\| bClosureThis) ){` |
...
|    24687 | 4555 | `			pObj = VmExtractMemObj(&(*pVm),&sThis,FALSE,TRUE);` |
|    24687 | 4556 | `			if( pObj ){` |
|        - | 4557 | `				/* Reflect the change */` |
|    24687 | 4558 | `				pObj->x.pOther = pThis;` |
|    24687 | 4559 | `				MemObjSetType(pObj,MEMOBJ_OBJ);` |
|    12341 | 4560 | `			}` |
|    12341 | 4561 | `		}` |
|   104686 | 4562 | `		if( SySetUsed(&pVmFunc->aStatic) > 0 ){` |
...
|        - | 4589 | `		{` |
|   104686 | 4590 | `		VmCallArgMap *pCallMap3 = pEffCallMap;` |
|        - | 4591 | `		/* Caller file's strict_types mode — governs parameter coercion` |
|        - | 4592 | `		 * (but NOT return coercion, which uses the callee's file). */` |
|   104686 | 4593 | `		int bCallIsStrict = (pCallMap3 && pCallMap3->bStrict) ? 1 : 0;` |
|   104686 | 4594 | `		if( pCallMap3 && pCallMap3->bHasNamed ){` |
|        - | 4595 | `			/* ============================================================` |
...
|        - | 4980 | `		 * ============================================================ */` |
|   104418 | 4981 | `		n = 0;` |
|   264842 | 4982 | `		while( pArg < pTos ){` |
|   160729 | 4983 | `			if( n < SySetUsed(&pVmFunc->aArgs) && (aFormalArg[n].iFlags & VM_FUNC_ARG_VARIADIC) ){` |
...
|        - | 5083 | `			}` |
|   160529 | 5084 | `			if( n < SySetUsed(&pVmFunc->aArgs) ){` |
...
|   160023 | 5091 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_UNION ){` |
...
|   159936 | 5124 | `				if( aFormalArg[n].nType > 0` |
|    87200 | 5125 | `					&& !((aFormalArg[n].iFlags & VM_FUNC_ARG_NULLABLE) && (pArg->iFlags & MEMOBJ_NULL)) ){` |
...
|       13 | 5201 | `					}` |
|     6967 | 5202 | `				}` |
|   159925 | 5203 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_BY_REF ){` |
...
|   159685 | 5255 | `					pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|        - | 5256 | `				}` |
|    80169 | 5257 | `			}else{` |
|        - | 5258 | `				char zName[32];` |
...
|        - | 5265 | `			}` |
|   160429 | 5266 | `			if( pObj ){` |
|   160193 | 5267 | `				PH7_MemObjStore(pArg,pObj);` |
|        - | 5268 | `				/* Insert argument index  */` |
|   160193 | 5269 | `				sArg.nIdx = pObj->nIdx;` |
|   160193 | 5270 | `				sArg.pUserData = 0;` |
|   160193 | 5271 | `				SySetPut(&pFrame->sArg,(const void *)&sArg);` |
|    80299 | 5272 | `			}` |
|   160429 | 5273 | `			PH7_MemObjRelease(pArg);` |
|   160429 | 5274 | `			pArg++;` |
|   160429 | 5275 | `			++n;` |
|        5 | 5276 | `		}` |
|        - | 5277 | `		} /* end named vs positional branch */` |
|        - | 5278 | `		/* Set up closure environment */` |
|   104564 | 5279 | `		if( pVmFunc->iFlags & VM_FUNC_CLOSURE ){` |
...
|   104559 | 5327 | `		if( n < SySetUsed(&pVmFunc->aArgs)` |
|    54947 | 5328 | `		 && (pVmFunc->iFlags & (VM_FUNC_INTERNAL\|VM_FUNC_CLASS_METHOD)) != VM_FUNC_INTERNAL ){` |
|        - | 5329 | `			sxu32 nNonVar,nReq;` |
|     3875 | 5330 | `			nReq = VmFuncRequiredArgCount(pVmFunc,&nNonVar);` |
|     3875 | 5331 | `			if( n < nReq ){` |
...
|   112492 | 5351 | `		while( n < SySetUsed(&pVmFunc->aArgs) ){` |
|     8199 | 5352 | `			if( aFormalArg[n].iFlags & VM_FUNC_ARG_VARIADIC ){` |
...
|        - | 5363 | `			}` |
|     7955 | 5364 | `			if( SySetUsed(&aFormalArg[n].aByteCode) > 0 ){` |
|     7953 | 5365 | `				pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|     7953 | 5366 | `				if( pObj ){` |
|        - | 5367 | `					/* Evaluate the default value and extract it's result */` |
|     7953 | 5368 | `					rc = VmLocalExec(&(*pVm),&aFormalArg[n].aByteCode,pObj,FALSE);` |
|     7953 | 5369 | `					if( rc == PH7_ABORT ){` |
|      ! 0 | 5370 | `						goto Abort;` |
|        - | 5371 | `					}` |
|        - | 5372 | `					/* Insert argument index */` |
|     7953 | 5373 | `					sArg.nIdx = pObj->nIdx;` |
|     7953 | 5374 | `					sArg.pUserData = 0;` |
|     7953 | 5375 | `					SySetPut(&pFrame->sArg,(const void *)&sArg);` |
...
|     7948 | 5380 | `					if( aFormalArg[n].nType > 0 && aFormalArg[n].nType != MEMOBJ_OBJ` |
|     3886 | 5381 | `						&& ((pObj->iFlags & aFormalArg[n].nType) == 0)` |
|     1949 | 5382 | `						&& !((aFormalArg[n].iFlags & VM_FUNC_ARG_NULLABLE) && (pObj->iFlags & MEMOBJ_NULL)) ){` |
...
|        - | 5394 | `		 */` |
|   104542 | 5395 | `		PH7_MemObjRelease(pTos);` |
|   104542 | 5396 | `		pTos = &pTos[-nCallArgs];` |
...
|        - | 5408 | `		 * per function. */` |
|        - | 5409 | `		{` |
|   104542 | 5410 | `			sxu32 nSlots = pVmFunc->nMaxStack;` |
|   104542 | 5411 | `			if( nSlots == 0 ){` |
...
|     4118 | 5418 | `			}` |
|   104542 | 5419 | `			pFrameStack = VmOperandStackAlloc(&(*pVm),nSlots);` |
|        - | 5420 | `		}` |
|   104542 | 5421 | `		if( pFrameStack == 0 ){` |
...
|      ! 0 | 5428 | `			break;` |
|        - | 5429 | `		}` |
|    52166 | 5430 | `SkipFuncBody:` |
|   104676 | 5431 | `		if( pSelf ){` |
|        - | 5432 | `			/* Push class name */` |
|    25593 | 5433 | `			SySetPut(&pVm->aSelf,(const void *)&pSelf);` |
|    12794 | 5434 | `		}` |
|        - | 5435 | `		/* Increment nesting level */` |
|   104676 | 5436 | `		pVm->nRecursionDepth++;` |
|   104676 | 5437 | `		if( rc == PH7_EXCEPTION ){` |
...
|   104542 | 5466 | `			VmCallFrame *pRec = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   104542 | 5467 | `			if( pRec ){` |
|   101910 | 5468 | `				pVm->pIdleCallFrames = (void *)pRec->pPrev;` |
|    51060 | 5469 | `			}else{` |
|     2637 | 5470 | `				pRec = (VmCallFrame *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmCallFrame));` |
|        - | 5471 | `			}` |
|   104542 | 5472 | `			if( pRec == 0 ){` |
...
|      ! 0 | 5483 | `				goto Abort;` |
|        - | 5484 | `			}` |
|   104542 | 5485 | `			sState.pTos = pTos;` |
|   104542 | 5486 | `			sState.pc = pc;` |
|   104542 | 5487 | `			pRec->sCaller = sState;` |
|   104542 | 5488 | `			pRec->sCall.pVmFunc = pVmFunc;` |
|   104542 | 5489 | `			pRec->sCall.pFrame = pFrame;` |
|   104542 | 5490 | `			pRec->sCall.pFrameStack = pFrameStack;` |
|   104542 | 5491 | `			pRec->sCall.nStackCap = pVmFunc->nMaxStack + VM_STACK_GUARD;` |
|   104542 | 5492 | `			pRec->sCall.nLastRef = SXU32_HIGH;` |
|   104542 | 5493 | `			pRec->sCall.bSelfPushed = (sxu8)(pSelf ? 1 : 0);` |
|   104542 | 5494 | `			pRec->pPrev = pCallTop;` |
|   104542 | 5495 | `			pCallTop = pRec;` |
|        - | 5496 | `			/* Switch to the callee activation (what the recursive` |
|        - | 5497 | `			 * VmByteCodeExec entry used to set up). */` |
|   104542 | 5498 | `			aInstr = (VmInstr *)SySetBasePtr(&pVmFunc->aByteCode);` |
|   104542 | 5499 | `			pStack = pFrameStack;` |
|   104542 | 5500 | `			pTos = &pStack[-1];` |
|   104542 | 5501 | `			pc = 0;` |
|   104542 | 5502 | `			sState.aInstr = aInstr;` |
|   104542 | 5503 | `			sState.pStack = pStack;` |
|   104542 | 5504 | `			sState.nStackCap = pRec->sCall.nStackCap; /* callee's operand-stack capacity for OP_SPREAD growth */` |
|   104542 | 5505 | `			sState.nStackOrig = pRec->sCall.nStackCap; /* fixed headroom reference (never grows) */` |
|   104542 | 5506 | `			sState.pTos = pTos;` |
|   104542 | 5507 | `			sState.pc = 0;` |
|   104542 | 5508 | `			sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|   104542 | 5509 | `			sState.pEntryFrame = pVm->pFrame;` |
|   104542 | 5510 | `			sState.pResult = pRec->sCaller.pTos;` |
|   104542 | 5511 | `			sState.pLastRef = &pRec->sCall.nLastRef;` |
|   104542 | 5512 | `			sState.pEnforceRetFunc = VmFuncHasReturnType(pVmFunc) ? pVmFunc : 0;` |
|   104542 | 5513 | `			sState.is_callback = 0;` |
|   104542 | 5514 | `			sState.bReturnPropagates = 0;` |
|   104542 | 5515 | `			goto VmLoopFetch;` |
|        - | 5516 | `		}` |
|       57 | 5517 | `	}else{` |
...
|   933869 | 5526 | `		pEntry = SyHashGet(&pVm->hHostFunction,(const void *)sName.zString,sName.nByte);` |
|        - | 5527 | `		{` |
|   933869 | 5528 | `		VmCallArgMap *pCallMap2 = pEffCallMap;` |
|   933869 | 5529 | `		if( pEntry == 0 && pCallMap2 && pCallMap2->bIsNamespaced ){` |
...
|        - | 5634 | `			}` |
|        - | 5635 | `		}` |
|   933853 | 5636 | `		pFunc = (ph7_user_func *)pEntry->pUserData;` |
...
|  1401140 | 5641 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   933848 | 5642 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
|        - | 5643 | `		/* Start collecting function arguments */` |
|   933853 | 5644 | `		SySetReset(&aArg);` |
|  2523628 | 5645 | `		while( pArg < pTos ){` |
|  1589780 | 5646 | `			SySetPut(&aArg,(const void *)&pArg);` |
|  1589780 | 5647 | `			pArg++;` |
|        5 | 5648 | `		}` |
|        - | 5649 | `		/* Assume a null return value */` |
|   933853 | 5650 | `		PH7_MemObjInit(&(*pVm),&sRet);` |
|        - | 5651 | `		/* Init the call context */` |
|   933853 | 5652 | `		VmInitCallContext(&sCtx,&(*pVm),pFunc,&sRet,0);` |
...
|   933853 | 5659 | `		sCtx.pArgMap = pEffCallMap;` |
|        - | 5660 | `		{` |
|   933853 | 5661 | `		int nGiven = (int)SySetUsed(&aArg);` |
...
|   933853 | 5667 | `		if( pFunc->nMinArg > 0 && nGiven < pFunc->nMinArg ){` |
...
|      232 | 5674 | `				nGiven);` |
|   933621 | 5675 | `		}else if( pFunc->bHasMaxArg && nGiven > (int)pFunc->nMaxArg ){` |
...
|       40 | 5688 | `				nGiven);` |
|  1400364 | 5689 | `		}else if( SXRET_OK != (rc = VmEnforceBuiltinArgTypes(&sCtx,pFunc,nGiven,` |
|   933304 | 5690 | `			(ph7_value **)SySetBasePtr(&aArg))) ){` |
|        - | 5691 | `			/* TypeError thrown: rc carries the caught/uncaught status */` |
|       91 | 5692 | `		}else{` |
|        - | 5693 | `			/* Call the foreign function */` |
|   933137 | 5694 | `			rc = pFunc->xFunc(&sCtx,nGiven,(ph7_value **)SySetBasePtr(&aArg));` |
|        - | 5695 | `		}` |
|        - | 5696 | `		}` |
|        - | 5697 | `		/* Release the call context */` |
|   933853 | 5698 | `		VmReleaseCallContext(&sCtx);` |
|   933853 | 5699 | `		if( rc == PH7_ABORT ){` |
...
|      576 | 5704 | `			goto Abort;` |
|        - | 5705 | `		}` |
|   933281 | 5706 | `		if( rc != PH7_SUSPEND && pVm->pInlineInstr == (void *)aInstr ){` |
...
|      ! 0 | 5719 | `		}` |
|   933277 | 5720 | `		if( rc == PH7_EXCEPTION ){` |
...
|      979 | 5728 | `			if( !VmRecordedResume(pVm,&iResumePc,sState.pEntryFrame,aInstr) ){` |
...
|      780 | 5734 | `			PH7_MemObjRelease(&sRet);` |
|      780 | 5735 | `			if( nCallArgs > 0 ){` |
|      490 | 5736 | `				VmPopOperand(&pTos,nCallArgs); /* spread-adjusted; see the normal-return path */` |
|      243 | 5737 | `			}` |
|      780 | 5738 | `			VmPopOperand(&pTos,1);` |
|      780 | 5739 | `			pc = iResumePc;` |
|      780 | 5740 | `			break;` |
|        - | 5741 | `		}` |
|   932303 | 5742 | `		if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|   910907 | 5766 | `			VmPopOperand(&pTos,nCallArgs);` |
|   455814 | 5767 | `		}` |
|        - | 5768 | `		/* Save foreign function return value into the (now top) function-name slot */` |
|   931949 | 5769 | `		PH7_MemObjStore(&sRet,pTos);` |
|   931949 | 5770 | `		PH7_MemObjRelease(&sRet);` |
|        - | 5771 | `	}` |
|   932053 | 5772 | `	break;` |
|        - | 5773 | `				  }` |
|        - | 5774 | `/*` |
...
|        - | 5777 | ` */` |
|    25572 | 5778 | `case PH7_OP_CONSUME: {` |
|        - | 5779 | `	VmOpRc rcOp;` |
|    51149 | 5780 | `	sState.pTos = pTos;` |
|    51149 | 5781 | `	sState.pc = pc;` |
|    51149 | 5782 | `	rcOp = VmExecOpConsume(&(*pVm),&sState,pInstr);` |
|    51149 | 5783 | `	pTos = sState.pTos;` |
|    51149 | 5784 | `	pc = sState.pc;` |
|    51149 | 5785 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 5786 | `		goto Abort;` |
|    51149 | 5787 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 5792 |  |
|        - | 5793 | `		} /* Switch() */` |
| 16437712 | 5794 | `		pc++; /* Next instruction in the stream */` |
|        5 | 5795 | `	} /* For(;;) */` |
|   128656 | 5796 | `Done:` |
...
|   257522 | 5800 | `	rc = SXRET_OK;` |
|   257522 | 5801 | `	goto Unwind;` |
|      823 | 5802 | `Suspend:` |
...
|   130659 | 5860 | `	for(;;){` |
|   261118 | 5861 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|      ! 0 | 5869 | `			}` |
|     1152 | 5870 | `		}` |
|   261118 | 5871 | `		if( pCallTop == 0 ){` |
|   156991 | 5872 | `			return VmExecFinalize(&(*pVm),&sState,&aArg,pTos,rc);` |
|        - | 5873 | `		}` |
|   104132 | 5874 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|      627 | 5880 | `		}` |
|        - | 5881 | `		{` |
|   104132 | 5882 | `			VmCallFrame *pRec = pCallTop;` |
|   104132 | 5883 | `			sState = pRec->sCaller;` |
|   104132 | 5884 | `			rc = VmCallFinish(&(*pVm),&sState,&pRec->sCall,rc);` |
|   104132 | 5885 | `			pCallTop = pRec->pPrev;` |
|   104132 | 5886 | `			pRec->pPrev = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   104132 | 5887 | `			pVm->pIdleCallFrames = (void *)pRec;` |
|   104132 | 5888 | `			aInstr = sState.aInstr;` |
|   104132 | 5889 | `			pStack = sState.pStack;` |
|   104132 | 5890 | `			pTos = sState.pTos;` |
|   104132 | 5891 | `			pc = sState.pc;` |
|        - | 5892 | `		}` |
|   104132 | 5893 | `		if( rc == PH7_OK ){` |
|   103366 | 5894 | `			pc++; /* the loop-bottom increment this OP_CALL missed */` |
|   103366 | 5895 | `			goto VmLoopFetch;` |
|        - | 5896 | `		}` |
|        5 | 5897 | `	}` |
|    78675 | 5898 | `}` |
|        - | 5899 |  |
