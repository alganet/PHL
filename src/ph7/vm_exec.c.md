...
|        - |  162 | ` */` |
|   161902 |  163 | `static sxi32 VmExecFinalize(ph7_vm *pVm,VmExecState *pState,SySet *pArg,ph7_value *pTos,sxi32 rcTerm)` |
|        5 |  164 | `{` |
|    80951 |  165 | `	SXUNUSED(pVm);` |
|   161907 |  166 | `	if( rcTerm != PH7_SUSPEND && !pState->bReturnPropagates ){` |
|   158211 |  167 | `		VmClearFrameReturn(pState->pEntryFrame);` |
|    79103 |  168 | `	}` |
|   161907 |  169 | `	SySetRelease(pArg);` |
|   161907 |  170 | `	if( rcTerm == PH7_ABORT \|\| rcTerm == PH7_EXCEPTION ){` |
|     2841 |  171 | `		while( pTos >= pState->pStack ){` |
|     1789 |  172 | `			PH7_MemObjRelease(pTos);` |
|     1789 |  173 | `			pTos--;` |
|        5 |  174 | `		}` |
|      526 |  175 | `	}` |
|   161907 |  176 | `	return rcTerm;` |
|        5 |  177 | `}` |
|        - |  178 | `/*` |
...
|        - |  189 | ` */` |
|   104685 |  190 | `static sxi32 VmCallFinish(ph7_vm *pVm,VmExecState *pCaller,VmCallRecord *pCallee,sxi32 rc)` |
|        5 |  191 | `{` |
|        - |  192 | `	ph7_value *pObj;` |
|        - |  193 | `	/* Decrement nesting level */` |
|   104690 |  194 | `	pVm->nRecursionDepth--;` |
|   104690 |  195 | `	if( pCallee->bSelfPushed ){` |
|        - |  196 | `		/* Pop class name */` |
|    25527 |  197 | `		(void)SySetPop(&pVm->aSelf);` |
|    12761 |  198 | `	}` |
|   104690 |  199 | `	if( (pCallee->pVmFunc->iFlags & VM_FUNC_REF_RETURN) && rc == SXRET_OK ){` |
...
|       25 |  225 | `	}` |
|   104690 |  226 | `	if( rc != PH7_ABORT && ((pCallee->pFrame->iFlags & VM_FRAME_THROW) \|\| rc == PH7_EXCEPTION) ){` |
...
|   104690 |  272 | `	if( rc != PH7_SUSPEND && pCallee->pFrameStack ){` |
...
|   104556 |  276 | `		VmOperandStackRecycle(pVm,pCallee->pFrameStack,pCallee->nStackCap);` |
|    52378 |  277 | `	}` |
|        - |  278 | `	/* Leave the frame */` |
|   104690 |  279 | `	VmLeaveFrame(&(*pVm));` |
|   104690 |  280 | `	if( rc == PH7_ABORT ){` |
|      336 |  281 | `		return PH7_ABORT;` |
|        - |  282 | `	}` |
|   104358 |  283 | `	if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|        - |  291 | `	}` |
|   104358 |  292 | `	if( rc == PH7_EXCEPTION ){` |
|      469 |  293 | `		return PH7_EXCEPTION;` |
|        - |  294 | `	}` |
|   103894 |  295 | `	return PH7_OK;` |
|    52450 |  296 | `}` |
|        - |  297 | `/*` |
...
|        - |  330 | ` * nesting.` |
|        - |  331 | ` */` |
|   162260 |  332 | `PH7_PRIVATE sxi32 VmByteCodeExec(` |
...
|   162265 |  352 | `	if( VmNativeNestingExceeded(pVm) ){` |
...
|   162261 |  362 | `	nSavedBrc = pVm->nBoundaryRc;` |
|   162261 |  363 | `	pVm->nBoundaryRc = 0;` |
...
|   162261 |  370 | `	nSavedLine = pVm->nCurLine;` |
|   162261 |  371 | `	pVm->nVmExecDepth++;` |
|   243389 |  372 | `	rc = VmByteCodeExecBody(&(*pVm),aInstr,pStack,nTos,pResult,pLastRef,is_callback,nPc,` |
|    81128 |  373 | `		pEnforceRetFunc,bReturnPropagates,pAdoptSegment,ppBaseOwner,pnBaseCap,nStackOrig);` |
|   162261 |  374 | `	pVm->nVmExecDepth--;` |
|   162261 |  375 | `	pVm->nCurLine = nSavedLine;` |
|   162261 |  376 | `	if( nSavedBrc != 0 && (nSavedBrc == PH7_ABORT \|\| pVm->nBoundaryRc == 0) ){` |
|       15 |  377 | `		pVm->nBoundaryRc = nSavedBrc;` |
|        6 |  378 | `	}` |
|   162261 |  379 | `	return rc;` |
|    81135 |  380 | `}` |
|   162256 |  381 | `static sxi32 VmByteCodeExecBody(` |
...
|        - |  399 | `	ph7_value *pTos;` |
|        - |  400 | `	SySet aArg;` |
|   162261 |  401 | `	VmCallFrame *pCallTop = 0; /* Top of this invocation's in-loop call-record` |
...
|        - |  409 | `	sxi32 pc;` |
|        - |  410 | `	sxi32 rc;` |
|   162261 |  411 | `	sState.aInstr = aInstr;` |
|   162261 |  412 | `	sState.pStack = pStack;` |
|   162261 |  413 | `	sState.nStackCap = pnBaseCap ? *pnBaseCap : 0; /* CURRENT capacity (grown on a coroutine resume) */` |
|   162261 |  414 | `	sState.nStackOrig = nStackOrig;                /* ORIGINAL capacity — fixed headroom reference */` |
|   162261 |  415 | `	sState.pResult = pResult;` |
|   162261 |  416 | `	sState.pLastRef = pLastRef;` |
|   162261 |  417 | `	sState.pEnforceRetFunc = pEnforceRetFunc;` |
|   162261 |  418 | `	sState.is_callback = (sxu8)(is_callback ? 1 : 0);` |
|   162261 |  419 | `	sState.bReturnPropagates = (sxu8)(bReturnPropagates ? 1 : 0);` |
|        - |  420 | `	/* Argument container */` |
|   162261 |  421 | `	SySetInit(&aArg,&pVm->sAllocator,sizeof(ph7_value *));` |
|   162261 |  422 | `	if( nTos < 0 ){` |
|   146473 |  423 | `		pTos = &pStack[-1];` |
|    73239 |  424 | `	}else{` |
|    15793 |  425 | `		pTos = &pStack[nTos];` |
|        - |  426 | `	}` |
|   162261 |  427 | `	sState.pTos = pTos;` |
|   162261 |  428 | `	sState.pc = nPc;` |
...
|   162256 |  446 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->pFrame == pVm->pFrame` |
|     2816 |  447 | `	 && pStack == pVm->pActiveCtx->pStack ){` |
|     1805 |  448 | `		sState.nExceptionBase = pVm->pActiveCtx->nExceptionBase;` |
|      905 |  449 | `	}else{` |
|   160461 |  450 | `		sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|        - |  451 | `	}` |
|   162261 |  452 | `	sState.pEntryFrame = pVm->pFrame;` |
|   162261 |  453 | `	pc = nPc;` |
...
|   162256 |  506 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->pInjected` |
...
|   162246 |  567 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->bClosing` |
...
| 17070884 |  603 | `		if( pVm->nBoundaryRc != 0 \|\| SySetUsed(&pVm->aHookRmw) > 0 ){` |
...
| 17070784 |  658 | `		pInstr = &aInstr[pc];` |
| 17070784 |  659 | `		if( pInstr->nLine ){` |
...
| 16857147 |  663 | `			pVm->nCurLine = pInstr->nLine;` |
|  8434893 |  664 | `		}` |
| 17070784 |  665 | `		rc = SXRET_OK;` |
|        - |  666 | `/*` |
...
|        - |  672 | ` */` |
| 17070784 |  673 | `		switch(pInstr->iOp){` |
|        - |  674 | `/*` |
|        - |  675 | ` * DONE: P1 * *` |
|        - |  676 | ` *` |
...
|        - |  679 | ` */` |
|   131216 |  680 | `case PH7_OP_DONE:` |
|   262642 |  681 | `	if( pInstr->iP2 && sState.bReturnPropagates ){` |
...
|   262453 |  711 | `	if( sState.pEnforceRetFunc && VmFuncHasReturnType(sState.pEnforceRetFunc)` |
...
|     4591 |  736 | `	}` |
|   262434 |  737 | `	if( pInstr->iP1 && pTos >= pStack ){` |
|   157442 |  738 | `		if( sState.pLastRef ){` |
|    94184 |  739 | `			*sState.pLastRef = pTos->nIdx;` |
|    47192 |  740 | `		}` |
|   157442 |  741 | `		if( sState.pResult ){` |
|        - |  742 | `			/* Execution result */` |
|   150366 |  743 | `			PH7_MemObjStore(pTos,sState.pResult);` |
|    75283 |  744 | `		}` |
|   157442 |  745 | `		VmPopOperand(&pTos,1);` |
|   183818 |  746 | `	}else if( sState.pLastRef ){` |
...
|        - |  762 | `	 */` |
|   262434 |  763 | `	rc = VmDrainFinally(&(*pVm),sState.nExceptionBase);` |
|   262434 |  764 | `	if( rc == SXERR_ABORT ){` |
|      ! 0 |  765 | `		goto Abort;` |
|        - |  766 | `	}` |
|   262434 |  767 | `	if( rc == PH7_EXCEPTION ){` |
...
|        - |  778 | `	}` |
|   262430 |  779 | `	if( sState.pEntryFrame->bHasRet && !sState.bReturnPropagates ){` |
...
|        - |  835 | ` */` |
|   279771 |  836 | `case PH7_OP_JMP:` |
|   559752 |  837 | `	pc = pInstr->iP2 - 1;` |
|   559752 |  838 | `	break;` |
|        - |  839 | `/*` |
|        - |  840 | ` * JZ: P1 P2 *` |
|        - |  841 | ` *` |
...
|  1635065 |  852 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     1001 |  853 | `		PH7_MemObjToBool(pTos);` |
|      499 |  854 | `	}` |
|  1635065 |  855 | `	if( !pTos->x.iVal ){` |
|        - |  856 | `		/* Take the jump */` |
|   927756 |  857 | `		pc = pInstr->iP2 - 1;` |
|   464136 |  858 | `	}` |
|  1635065 |  859 | `	if( !pInstr->iP1 ){` |
|  1392399 |  860 | `		VmPopOperand(&pTos,1);` |
|   696765 |  861 | `	}` |
|  1635065 |  862 | `	break;` |
|        - |  863 | `/*` |
|        - |  864 | ` * JNZ: P1 P2 *` |
...
|   185058 |  876 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      ! 0 |  877 | `		PH7_MemObjToBool(pTos);` |
|      ! 0 |  878 | `	}` |
|   185058 |  879 | `	if( pTos->x.iVal ){` |
|        - |  880 | `		/* Take the jump */` |
|     9565 |  881 | `		pc = pInstr->iP2 - 1;` |
|     4780 |  882 | `	}` |
|   185058 |  883 | `	if( !pInstr->iP1 ){` |
...
|        - |  899 | ` */` |
|   683824 |  900 | `case PH7_OP_POP: {` |
|  1368678 |  901 | `	sxi32 n = pInstr->iP1;` |
|  1368678 |  902 | `	if( &pTos[-n+1] < pStack ){` |
|        - |  903 | `		/* TICKET 1433-51 Stack underflow must be handled at run-time */` |
|       79 |  904 | `		n = (sxi32)(pTos - pStack);` |
|       38 |  905 | `	}` |
|  1368678 |  906 | `	VmPopOperand(&pTos,n);` |
|  1368678 |  907 | `	break;` |
|        - |  908 | `				 }` |
|        - |  909 | `/*` |
|        - |  910 | ` * DUP: * * *` |
...
|        - |  929 | ` */` |
|    49208 |  930 | `case PH7_OP_NSSWITCH:` |
|    98421 |  931 | `	SyBlobReset(&pVm->sNamespace);` |
|    98421 |  932 | `	if( pInstr->p3 ){` |
|     4019 |  933 | `		const char *zNs = (const char *)pInstr->p3;` |
|     4019 |  934 | `		SyBlobAppend(&pVm->sNamespace,zNs,SyStrlen(zNs));` |
|     2007 |  935 | `	}` |
|        - |  936 | `	/* Clear namespace-scoped use-const imports */` |
|    98421 |  937 | `	SyHashRelease(&pVm->hUseConstImports);` |
|    98421 |  938 | `	SyHashInit(&pVm->hUseConstImports,&pVm->sAllocator,0,0);` |
|    98421 |  939 | `	break;` |
...
|     6731 | 1089 | `	break;` |
|        - | 1090 | `					  }` |
|    33167 | 1091 | `case PH7_OP_ERR_CTRL:` |
|        - | 1092 | `	/*` |
...
|        - | 1101 | `	 */` |
|    66339 | 1102 | `	if( pInstr->iP1 ){` |
|    33173 | 1103 | `		pVm->nErrSuppress++;` |
|    49755 | 1104 | `	}else if( pVm->nErrSuppress > 0 ){` |
|    33171 | 1105 | `		pVm->nErrSuppress--;` |
|    16583 | 1106 | `	}` |
|    66339 | 1107 | `	break;` |
|        - | 1108 | `/*` |
|        - | 1109 | ` * IS_A * * *` |
...
|        - | 1163 | ` */` |
|  1556896 | 1164 | `case PH7_OP_LOADC: {` |
|        - | 1165 | `	ph7_value *pObj;` |
|        - | 1166 | `	/* Reserve a room */` |
|  3115659 | 1167 | `	pTos++;` |
|  3115659 | 1168 | `	if( pInstr->iP1 & PH7_LOADC_NOKEY ){` |
|        - | 1169 | `		/* Absent array-literal key: mark it so LOAD_MAP auto-indexes without a diagnostic */` |
|    19469 | 1170 | `		MemObjSetType(pTos,MEMOBJ_NULL);` |
|    19469 | 1171 | `		SyBlobReset(&pTos->sBlob);` |
|    19469 | 1172 | `		pTos->iFlags \|= MEMOBJ_AUX_NOKEY;` |
|    19469 | 1173 | `		pTos->nIdx = SXU32_HIGH;` |
|    19469 | 1174 | `		break;` |
|        - | 1175 | `	}` |
|  3096195 | 1176 | `	if( (pObj = (ph7_value *)SySetAt(&pVm->aLitObj,pInstr->iP2)) != 0 ){` |
|  3096195 | 1177 | `		if( (pInstr->iP1 & PH7_LOADC_EXPAND) && SyBlobLength(&pObj->sBlob) <= 64 ){` |
|        - | 1178 | `			SyHashEntry *pEntry;` |
|        - | 1179 | `			/* Check use const imports first — imports take precedence */` |
|        - | 1180 | `			{` |
|        - | 1181 | `				SyHashEntry *pConstImport;` |
|    34919 | 1182 | `				pConstImport = SyHashGet(&pVm->hUseConstImports,` |
|    23276 | 1183 | `					SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|    23281 | 1184 | `				if( pConstImport ){` |
...
|    23271 | 1199 | `			pEntry = SyHashGet(&pVm->hConstant,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|    23271 | 1200 | `			if( pEntry ){` |
|    23261 | 1201 | `				ph7_constant *pCons = (ph7_constant *)pEntry->pUserData;` |
|        - | 1202 | `				/* Set a NULL default value */` |
|    23261 | 1203 | `				MemObjSetType(pTos,MEMOBJ_NULL);` |
|    23261 | 1204 | `				SyBlobReset(&pTos->sBlob);` |
|        - | 1205 | `				/* Invoke the callback and deal with the expanded value */` |
|    23261 | 1206 | `				VmExpandConstantWithNotice(&(*pVm),pCons,pTos);` |
|        - | 1207 | `				/* Mark as constant */` |
|    23261 | 1208 | `				pTos->nIdx = SXU32_HIGH;` |
|    23261 | 1209 | `				break;` |
|        - | 1210 | `			}` |
...
|        - | 1283 | ` */` |
|  2219954 | 1284 | `case PH7_OP_LOAD:{` |
|        - | 1285 | `	ph7_value *pObj;` |
|        - | 1286 | `	SyString sName;` |
|  4443825 | 1287 | `	if( pInstr->p3 == 0 ){` |
...
|        9 | 1299 | `	}else{` |
|  4443809 | 1300 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1301 | `		/* Reserve a room for the target object */` |
|  4443809 | 1302 | `		pTos++;` |
|        - | 1303 | `	}` |
|  4443825 | 1304 | `	if( pInstr->iP2 == 2 ){` |
...
|   398422 | 1310 | `		if( VmExtractMemObj(&(*pVm),&sName,FALSE,FALSE) == 0 ){` |
|        7 | 1311 | `			VmErrorFormat(&(*pVm),PH7_CTX_WARNING,"Undefined variable $%z",&sName);` |
|        3 | 1312 | `		}` |
|   199311 | 1313 | `	}` |
|        - | 1314 | `	/* Extract the requested memory object */` |
|  4443825 | 1315 | `	pObj = VmExtractMemObj(&(*pVm),&sName,pInstr->p3 ? FALSE : TRUE,pInstr->iP1 != 1);` |
|  4443825 | 1316 | `	if( pObj == 0 ){` |
...
|  4443763 | 1341 | `	PH7_MemObjLoad(pObj,pTos);` |
|  4443763 | 1342 | `	pTos->nIdx = pObj->nIdx;` |
|  4443763 | 1343 | `	break;` |
|        - | 1344 | `				   }` |
|        - | 1345 | `/*` |
|        - | 1346 | ` * LOAD_MAP P1 * *` |
...
|        - | 1351 | ` */` |
|    36965 | 1352 | `case PH7_OP_LOAD_MAP: {` |
|        - | 1353 | `	VmOpRc rcOp;` |
|    73935 | 1354 | `	sState.pTos = pTos;` |
|    73935 | 1355 | `	sState.pc = pc;` |
|    73935 | 1356 | `	rcOp = VmExecOpLoadMap(&(*pVm),&sState,pInstr);` |
|    73935 | 1357 | `	pTos = sState.pTos;` |
|    73935 | 1358 | `	pc = sState.pc;` |
|    73935 | 1359 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1360 | `		goto Abort;` |
|    73935 | 1361 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1394 | ` * instead.` |
|        - | 1395 | ` */` |
|   333383 | 1396 | `case PH7_OP_LOAD_IDX: {` |
|        - | 1397 | `	VmOpRc rcOp;` |
|   667497 | 1398 | `	sState.pTos = pTos;` |
|   667497 | 1399 | `	sState.pc = pc;` |
|   667497 | 1400 | `	rcOp = VmExecOpLoadIdx(&(*pVm),&sState,pInstr);` |
|   667497 | 1401 | `	pTos = sState.pTos;` |
|   667497 | 1402 | `	pc = sState.pc;` |
|   667497 | 1403 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1404 | `		goto Abort;` |
|   667497 | 1405 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1415 | ` */` |
|      586 | 1416 | `case PH7_OP_LOAD_CLOSURE: {` |
|        - | 1417 | `	VmOpRc rcOp;` |
|     1177 | 1418 | `	sState.pTos = pTos;` |
|     1177 | 1419 | `	sState.pc = pc;` |
|     1177 | 1420 | `	rcOp = VmExecOpLoadClosure(&(*pVm),&sState,pInstr);` |
|     1177 | 1421 | `	pTos = sState.pTos;` |
|     1177 | 1422 | `	pc = sState.pc;` |
|     1177 | 1423 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1424 | `		goto Abort;` |
|     1177 | 1425 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1582 | `		}` |
|    11771 | 1583 | `		break;` |
|   621259 | 1584 | `	}else if( pInstr->p3 == 0 ){` |
...
|        - | 1596 | `#endif` |
|        5 | 1597 | `	}else{` |
|   621251 | 1598 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1599 | `	}` |
|   621254 | 1600 | `	if( sName.nByte == sizeof("GLOBALS")-1` |
|   312371 | 1601 | `	 && SyMemcmp((const void *)sName.zString,(const void *)"GLOBALS",sName.nByte) == 0 ){` |
|        6 | 1602 | `		if( pInstr->p3 ){` |
...
|        - | 1639 | ` */` |
|   120759 | 1640 | `case PH7_OP_STORE_IDX:` |
|        - | 1641 | `case PH7_OP_STORE_IDX_REF: {` |
|        - | 1642 | `	VmOpRc rcOp;` |
|   241523 | 1643 | `	sState.pTos = pTos;` |
|   241523 | 1644 | `	sState.pc = pc;` |
|   241523 | 1645 | `	rcOp = VmExecOpStoreIdxRef(&(*pVm),&sState,pInstr);` |
|   241523 | 1646 | `	pTos = sState.pTos;` |
|   241523 | 1647 | `	pc = sState.pc;` |
|   241523 | 1648 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 1649 | `		goto Abort;` |
|   241521 | 1650 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|   368560 | 1671 | `	PH7_ENFORCE_READONLY_MUTATE(pTos->nIdx);` |
...
|   368549 | 1676 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) != 0` |
|   184383 | 1677 | `	 && SySetUsed(&pVm->aHookRmw) > 0 ){` |
...
|        - | 1694 | `		}` |
|      ! 0 | 1695 | `	}` |
|   368552 | 1696 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) == 0 ){` |
|   368552 | 1697 | `		if( pTos->nIdx != SXU32_HIGH ){` |
|        - | 1698 | `			ph7_value *pObj;` |
|   368552 | 1699 | `			if( (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pTos->nIdx)) != 0 ){` |
|   368552 | 1700 | `				if( VmStringWantsPerlIncr(pObj) ){` |
...
|   368550 | 1719 | `					if( pInstr->iP1 == 0 && (pTos->iFlags & MEMOBJ_STRING) ){` |
|        9 | 1720 | `						SyBlobNullAppend(&pTos->sBlob);` |
|        3 | 1721 | `					}` |
|        - | 1722 | `					/* Force a numeric cast on the variable */` |
|   368550 | 1723 | `					PH7_MemObjToNumeric(pObj);` |
|   368550 | 1724 | `					if( pObj->iFlags & MEMOBJ_REAL ){` |
|        5 | 1725 | `						pObj->rVal++;` |
...
|        - | 1734 | `						sxi64 r;` |
|   368546 | 1735 | `						if( PH7_ADD_OVERFLOW64(pObj->x.iVal,1,&r) ){` |
...
|        - | 1741 | `#endif` |
|        3 | 1742 | `						}else{` |
|   368542 | 1743 | `							pObj->x.iVal = r;` |
|        - | 1744 | `						}` |
|        - | 1745 | `					}` |
|   368550 | 1746 | `					if( pInstr->iP1 ){` |
...
|        - | 1785 | `		}` |
|   184375 | 1786 | `	}` |
|   368550 | 1787 | `	PH7_HOOK_RMW_WRITEBACK(pTos->nIdx,pTos);` |
|   368550 | 1788 | `	break;` |
|        - | 1789 | `/*` |
|        - | 1790 | ` * DECR: P1 * *` |
|        - | 1791 | ` *` |
...
|    50835 | 1997 | `	if( (pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      145 | 1998 | `		PH7_MemObjToBool(pTos);` |
|       70 | 1999 | `	}` |
|    50835 | 2000 | `	pTos->x.iVal = !pTos->x.iVal;` |
|    50835 | 2001 | `	break;` |
|        - | 2002 | `/*` |
|        - | 2003 | ` * OP_BITNOT: * * *` |
|        - | 2004 | ` *` |
...
|        - | 2027 | ` */` |
|     1436 | 2028 | `case PH7_OP_MUL:` |
|        - | 2029 | `case PH7_OP_MUL_STORE: {` |
|        - | 2030 | `	VmOpRc rcOp;` |
|     2877 | 2031 | `	sState.pTos = pTos;` |
|     2877 | 2032 | `	sState.pc = pc;` |
|     2877 | 2033 | `	rcOp = VmExecOpMulStore(&(*pVm),&sState,pInstr);` |
|     2877 | 2034 | `	pTos = sState.pTos;` |
|     2877 | 2035 | `	pc = sState.pc;` |
|     2877 | 2036 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2037 | `		goto Abort;` |
|     2877 | 2038 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2070 | ` */` |
|     6371 | 2071 | `case PH7_OP_ADD:{` |
|    12747 | 2072 | `	ph7_value *pNos = &pTos[-1];` |
|        - | 2073 | `#ifdef UNTRUST` |
|        - | 2074 | `	if( pNos < pStack ){` |
|        - | 2075 | `		goto Abort;` |
|        - | 2076 | `	}` |
...
|        - | 2082 | `		SyBlob sArMsg;` |
|    12747 | 2083 | `		SyBlobInit(&sArMsg,&pVm->sAllocator);` |
|    12747 | 2084 | `		if( VmArithOperandCheck(&(*pVm),pNos,pTos,"+",&sArMsg) != SXRET_OK ){` |
|        - | 2085 | `			sxi32 rcAr;` |
...
|        - | 2096 | `		}` |
|    12739 | 2097 | `		SyBlobRelease(&sArMsg);` |
|        - | 2098 | `	}` |
|        - | 2099 | `	/* Perform the addition */` |
|    12739 | 2100 | `	PH7_MemObjAdd(pNos,pTos,FALSE);` |
|    12739 | 2101 | `	VmPopOperand(&pTos,1);` |
|    12739 | 2102 | `	break;` |
|        - | 2103 | `				}` |
|        - | 2104 | `/*` |
|        - | 2105 | ` * OP_ADD_STORE * * *` |
...
|        - | 2526 | ` * back.` |
|        - | 2527 | ` */` |
|    86630 | 2528 | `case PH7_OP_CAT:{` |
|        - | 2529 | `	ph7_value *pNos,*pCur;` |
|   173265 | 2530 | `	if( pInstr->iP1 < 1 ){` |
|   144803 | 2531 | `		pNos = &pTos[-1];` |
|    72404 | 2532 | `	}else{` |
...
|   173265 | 2541 | `	if( (pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|     1917 | 2542 | `		PH7_MemObjToString(pNos);` |
|      956 | 2543 | `	}` |
|   173265 | 2544 | `	pCur = &pNos[1];` |
|   350063 | 2545 | `	while( pCur <= pTos ){` |
|   176803 | 2546 | `		if( (pCur->iFlags & MEMOBJ_STRING) == 0 ){` |
|    52221 | 2547 | `			PH7_MemObjToString(pCur);` |
|    26108 | 2548 | `		}` |
|        - | 2549 | `		/* Perform the concatenation */` |
|   176803 | 2550 | `		if( SyBlobLength(&pCur->sBlob) > 0 ){` |
|   176655 | 2551 | `			if( PH7_MemObjStringAppend(pNos,(const char *)SyBlobData(&pCur->sBlob),SyBlobLength(&pCur->sBlob)) != SXRET_OK ){` |
|        - | 2552 | `				/* Allocation failure: raise a fatal instead of a truncated concat */` |
|      ! 0 | 2553 | `				PH7_VmMemoryError(&(*pVm));` |
|      ! 0 | 2554 | `				goto Abort;` |
|        - | 2555 | `			}` |
|    88325 | 2556 | `		}` |
|   176803 | 2557 | `		SyBlobRelease(&pCur->sBlob);` |
|   176803 | 2558 | `		pCur++;` |
|        5 | 2559 | `	}` |
|   173265 | 2560 | `	pTos = pNos;` |
|   173265 | 2561 | `	break;` |
|        - | 2562 | `				}` |
|        - | 2563 | `/*  CAT_STORE: * * *` |
|        - | 2564 | ` *` |
...
|        - | 2566 | ` * back.` |
|        - | 2567 | ` */` |
|    13782 | 2568 | `case PH7_OP_CAT_STORE:{` |
|    27569 | 2569 | `	ph7_value *pNos = &pTos[-1];` |
|        - | 2570 | `	ph7_value *pObj;` |
|        - | 2571 | `	sxu32 nIdx;` |
|        - | 2572 | `#ifdef UNTRUST` |
|        - | 2573 | `	if( pNos < pStack ){` |
...
|    27569 | 2578 | `	if((pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|       59 | 2579 | `		PH7_MemObjToString(pNos);` |
|       29 | 2580 | `	}` |
|    27569 | 2581 | `	nIdx = pTos->nIdx;` |
...
|    27564 | 2593 | `	if( nIdx != SXU32_HIGH` |
|    27564 | 2594 | `	 && nIdx != pNos->nIdx` |
|    27560 | 2595 | `	 && (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx)) != 0` |
|    27561 | 2596 | `	 && (SyHashTotalEntry(&pVm->hTypedSlot) == 0` |
|    16378 | 2597 | `	     \|\| SyHashGet(&pVm->hTypedSlot,(const void *)&nIdx,sizeof(sxu32)) == 0) ){` |
|    27555 | 2598 | `		if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - | 2599 | `			/* e.g. $x = 5; $x .= "a";  ->  "5a" */` |
|        6 | 2600 | `			PH7_MemObjToString(pObj);` |
|        2 | 2601 | `		}` |
|    27555 | 2602 | `		if( SyBlobLength(&pNos->sBlob) > 0 ){` |
|    27551 | 2603 | `			if( PH7_MemObjStringAppend(pObj,(const char *)SyBlobData(&pNos->sBlob),SyBlobLength(&pNos->sBlob)) != SXRET_OK ){` |
...
|    27555 | 2622 | `		if( (pInstr+1)->iOp != PH7_OP_POP ){` |
...
|    27555 | 2627 | `		PH7_HOOK_RMW_WRITEBACK(nIdx,0);` |
|    27555 | 2628 | `		pNos->nIdx = SXU32_HIGH;` |
|    27555 | 2629 | `		VmPopOperand(&pTos,1);` |
|    27562 | 2630 | `		break;` |
|        - | 2631 | `	}` |
...
|        - | 2668 | ` * stack.` |
|        - | 2669 | ` */` |
|   114493 | 2670 | `case PH7_OP_LAND:` |
|        - | 2671 | `case PH7_OP_LOR: {` |
|        - | 2672 | `	VmOpRc rcOp;` |
|   229196 | 2673 | `	sState.pTos = pTos;` |
|   229196 | 2674 | `	sState.pc = pc;` |
|   229196 | 2675 | `	rcOp = VmExecOpLor(&(*pVm),&sState,pInstr);` |
|   229196 | 2676 | `	pTos = sState.pTos;` |
|   229196 | 2677 | `	pc = sState.pc;` |
|   229196 | 2678 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2679 | `		goto Abort;` |
|   229196 | 2680 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2917 | ` */` |
|   229009 | 2918 | `case PH7_OP_TEQ: {` |
|        - | 2919 | `	VmOpRc rcOp;` |
|   458228 | 2920 | `	sState.pTos = pTos;` |
|   458228 | 2921 | `	sState.pc = pc;` |
|   458228 | 2922 | `	rcOp = VmExecOpTeq(&(*pVm),&sState,pInstr);` |
|   458228 | 2923 | `	pTos = sState.pTos;` |
|   458228 | 2924 | `	pc = sState.pc;` |
|   458228 | 2925 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2926 | `		goto Abort;` |
|   458228 | 2927 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2939 | ` *` |
|        - | 2940 | ` */` |
|   190762 | 2941 | `case PH7_OP_TNE: {` |
|        - | 2942 | `	VmOpRc rcOp;` |
|   381734 | 2943 | `	sState.pTos = pTos;` |
|   381734 | 2944 | `	sState.pc = pc;` |
|   381734 | 2945 | `	rcOp = VmExecOpTne(&(*pVm),&sState,pInstr);` |
|   381734 | 2946 | `	pTos = sState.pTos;` |
|   381734 | 2947 | `	pc = sState.pc;` |
|   381734 | 2948 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2949 | `		goto Abort;` |
|   381734 | 2950 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2971 | ` *` |
|        - | 2972 | ` */` |
|   146249 | 2973 | `case PH7_OP_LT:` |
|        - | 2974 | `case PH7_OP_LE: {` |
|        - | 2975 | `	VmOpRc rcOp;` |
|   292913 | 2976 | `	sState.pTos = pTos;` |
|   292913 | 2977 | `	sState.pc = pc;` |
|   292913 | 2978 | `	rcOp = VmExecOpLe(&(*pVm),&sState,pInstr);` |
|   292913 | 2979 | `	pTos = sState.pTos;` |
|   292913 | 2980 | `	pc = sState.pc;` |
|   292913 | 2981 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2982 | `		goto Abort;` |
|   292913 | 2983 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3004 | ` *` |
|        - | 3005 | ` */` |
|    86342 | 3006 | `case PH7_OP_GT:` |
|        - | 3007 | `case PH7_OP_GE: {` |
|        - | 3008 | `	VmOpRc rcOp;` |
|   172894 | 3009 | `	sState.pTos = pTos;` |
|   172894 | 3010 | `	sState.pc = pc;` |
|   172894 | 3011 | `	rcOp = VmExecOpGe(&(*pVm),&sState,pInstr);` |
|   172894 | 3012 | `	pTos = sState.pTos;` |
|   172894 | 3013 | `	pc = sState.pc;` |
|   172894 | 3014 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 3015 | `		goto Abort;` |
|   172894 | 3016 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3390 | ` */` |
|    12060 | 3391 | `case PH7_OP_FOREACH_INIT: {` |
|        - | 3392 | `	VmOpRc rcOp;` |
|    24125 | 3393 | `	sState.pTos = pTos;` |
|    24125 | 3394 | `	sState.pc = pc;` |
|    24125 | 3395 | `	rcOp = VmExecOpForeachInit(&(*pVm),&sState,pInstr);` |
|    24125 | 3396 | `	pTos = sState.pTos;` |
|    24125 | 3397 | `	pc = sState.pc;` |
|    24125 | 3398 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 3399 | `		goto Abort;` |
|    24125 | 3400 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3408 | ` */` |
|   121089 | 3409 | `case PH7_OP_FOREACH_STEP: {` |
|        - | 3410 | `	VmOpRc rcOp;` |
|   242183 | 3411 | `	sState.pTos = pTos;` |
|   242183 | 3412 | `	sState.pc = pc;` |
|   242183 | 3413 | `	rcOp = VmExecOpForeachStep(&(*pVm),&sState,pInstr);` |
|   242183 | 3414 | `	pTos = sState.pTos;` |
|   242183 | 3415 | `	pc = sState.pc;` |
|   242183 | 3416 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 3417 | `		goto Abort;` |
|   242181 | 3418 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3426 | ` */` |
|    22540 | 3427 | `case PH7_OP_MEMBER: {` |
|        - | 3428 | `	VmOpRc rcOp;` |
|    45085 | 3429 | `	sState.pTos = pTos;` |
|    45085 | 3430 | `	sState.pc = pc;` |
|    45085 | 3431 | `	rcOp = VmExecOpMember(&(*pVm),&sState,pInstr);` |
|    45085 | 3432 | `	pTos = sState.pTos;` |
|    45085 | 3433 | `	pc = sState.pc;` |
|    45085 | 3434 | `	if( rcOp == VM_OP_ABORT ){` |
|        8 | 3435 | `		goto Abort;` |
|    45079 | 3436 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3444 | ` */` |
|     2392 | 3445 | `case PH7_OP_NEW: {` |
|        - | 3446 | `	VmOpRc rcOp;` |
|     4789 | 3447 | `	sState.pTos = pTos;` |
|     4789 | 3448 | `	sState.pc = pc;` |
|     4789 | 3449 | `	rcOp = VmExecOpNew(&(*pVm),&sState,pInstr);` |
|     4789 | 3450 | `	pTos = sState.pTos;` |
|     4789 | 3451 | `	pc = sState.pc;` |
|     4789 | 3452 | `	if( rcOp == VM_OP_ABORT ){` |
|        5 | 3453 | `		goto Abort;` |
|     4785 | 3454 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|  1041930 | 3831 | `	sxi32 nCallArgs = pInstr->iP1 + (pInstr->iP2 ? VmSpreadOwnExtra(pVm,pInstr->iP1,pTos) : 0);` |
|        - | 3832 | `	ph7_value *pArg;` |
|  1041930 | 3833 | `	pArg = &pTos[-nCallArgs];` |
...
|  1041930 | 3842 | `	VmCallArgMap *pEffCallMap = (VmCallArgMap *)pInstr->p3;` |
...
|  1041930 | 3849 | `	if( VmValueIsClosure(pVm,pTos) ){` |
...
|  1041930 | 3859 | `	if( (pTos->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|      142 | 4054 | `		break;` |
|        - | 4055 | `	}` |
|  1041770 | 4056 | `	SyStringInitFromBuf(&sName,SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
...
|  1041770 | 4060 | `	if( sName.nByte > 0 && sName.zString[0] == '\\' ){` |
...
|  1041770 | 4067 | `	pEntry = SyHashGet(&pVm->hFunction,(const void *)sName.zString,sName.nByte);` |
...
|        - | 4073 | `	{` |
|  1041770 | 4074 | `	VmCallArgMap *pCallMap = pEffCallMap;` |
|  1041770 | 4075 | `	if( pEntry == 0 && pCallMap && pCallMap->bIsNamespaced ){` |
...
|        - | 4106 | `		VmSlot sArg;` |
|        - | 4107 | `		sxu32 n;` |
|   105452 | 4108 | `		int bClosureThis = 0;` |
|   105452 | 4109 | `		ph7_class *pClosureScope = 0;` |
|        - | 4110 | `		/* initialize fields */` |
|   105452 | 4111 | `		pVmFunc = (ph7_vm_func *)pEntry->pUserData;` |
|   105452 | 4112 | `		pThis = 0;` |
|   105452 | 4113 | `		pSelf = 0;` |
...
|       14 | 4128 | `		}` |
|   105452 | 4129 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
...
|   105447 | 4237 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
...
|   105452 | 4244 | `		if( VmRecursionExceeded(pVm) ){` |
...
|        3 | 4248 | `			goto Abort;` |
|        - | 4249 | `		}` |
|   105450 | 4250 | `		if( pVmFunc->pNextName ){` |
...
|   105450 | 4262 | `		pSelfHint = pSelf;` |
|   105450 | 4263 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
...
|    12325 | 4267 | `			}` |
|    12838 | 4268 | `		}` |
|   105450 | 4269 | `		if( pSelf == 0 && (pVmFunc->iFlags & VM_FUNC_CLOSURE) ){` |
...
|     1807 | 4276 | `			if( pClosureScope ){` |
|       29 | 4277 | `				pSelf = pClosureScope;` |
|     1793 | 4278 | `			}else if( pVmFunc->pLsbClass ){` |
|       64 | 4279 | `				pSelf = (ph7_class *)pVmFunc->pLsbClass;` |
|       30 | 4280 | `			}` |
|      901 | 4281 | `		}` |
|   105450 | 4282 | `		if( SySetUsed(&pVmFunc->aAttrs) > 0 ){` |
...
|       56 | 4287 | `		}` |
|   105450 | 4288 | `		if( pVmFunc->iFlags & VM_FUNC_GENERATOR ){` |
...
|   105110 | 4520 | `		aFormalArg = (ph7_vm_func_arg *)SySetBasePtr(&pVmFunc->aArgs);` |
|        - | 4521 | `		/* Create a new VM frame  */` |
|   105110 | 4522 | `		rc = VmEnterFrame(&(*pVm),pVmFunc,pThis,&pFrame);` |
|   105110 | 4523 | `		if( rc != SXRET_OK ){` |
...
|   105110 | 4551 | `		pFrame->nActualArgs = (int)(pTos - pArg);` |
|   105110 | 4552 | `		if( pThis && ((pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) \|\| bClosureThis) ){` |
...
|    12412 | 4560 | `			}` |
|    12412 | 4561 | `		}` |
|   105110 | 4562 | `		if( SySetUsed(&pVmFunc->aStatic) > 0 ){` |
...
|        - | 4589 | `		{` |
|   105110 | 4590 | `		VmCallArgMap *pCallMap3 = pEffCallMap;` |
|        - | 4591 | `		/* Caller file's strict_types mode — governs parameter coercion` |
|        - | 4592 | `		 * (but NOT return coercion, which uses the callee's file). */` |
|   105110 | 4593 | `		int bCallIsStrict = (pCallMap3 && pCallMap3->bStrict) ? 1 : 0;` |
|   105110 | 4594 | `		if( pCallMap3 && pCallMap3->bHasNamed ){` |
|        - | 4595 | `			/* ============================================================` |
...
|        - | 4980 | `		 * ============================================================ */` |
|   104842 | 4981 | `		n = 0;` |
|   269518 | 4982 | `		while( pArg < pTos ){` |
|   164981 | 4983 | `			if( n < SySetUsed(&pVmFunc->aArgs) && (aFormalArg[n].iFlags & VM_FUNC_ARG_VARIADIC) ){` |
...
|        - | 5083 | `			}` |
|   164781 | 5084 | `			if( n < SySetUsed(&pVmFunc->aArgs) ){` |
...
|   164267 | 5091 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_UNION ){` |
...
|   164180 | 5124 | `				if( aFormalArg[n].nType > 0` |
|    89330 | 5125 | `					&& !((aFormalArg[n].iFlags & VM_FUNC_ARG_NULLABLE) && (pArg->iFlags & MEMOBJ_NULL)) ){` |
...
|       13 | 5201 | `					}` |
|     6975 | 5202 | `				}` |
|   164169 | 5203 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_BY_REF ){` |
...
|   163929 | 5255 | `					pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|        - | 5256 | `				}` |
|    82291 | 5257 | `			}else{` |
|        - | 5258 | `				char zName[32];` |
...
|        - | 5265 | `			}` |
|   164681 | 5266 | `			if( pObj ){` |
|   164445 | 5267 | `				PH7_MemObjStore(pArg,pObj);` |
|        - | 5268 | `				/* Insert argument index  */` |
|   164445 | 5269 | `				sArg.nIdx = pObj->nIdx;` |
|   164445 | 5270 | `				sArg.pUserData = 0;` |
|   164445 | 5271 | `				SySetPut(&pFrame->sArg,(const void *)&sArg);` |
|    82425 | 5272 | `			}` |
|   164681 | 5273 | `			PH7_MemObjRelease(pArg);` |
|   164681 | 5274 | `			pArg++;` |
|   164681 | 5275 | `			++n;` |
|        5 | 5276 | `		}` |
|        - | 5277 | `		} /* end named vs positional branch */` |
|        - | 5278 | `		/* Set up closure environment */` |
|   104988 | 5279 | `		if( pVmFunc->iFlags & VM_FUNC_CLOSURE ){` |
|        - | 5280 | `			ph7_vm_func_closure_env *aEnv,*pEnv;` |
|        - | 5281 | `			ph7_value *pValue;` |
|        - | 5282 | `			sxu32 iEnv;` |
|     1789 | 5283 | `			aEnv = (ph7_vm_func_closure_env *)SySetBasePtr(&pVmFunc->aClosureEnv);` |
|     3915 | 5284 | `			for(iEnv = 0 ; iEnv < SySetUsed(&pVmFunc->aClosureEnv) ; ++iEnv ){` |
...
|   104983 | 5327 | `		if( n < SySetUsed(&pVmFunc->aArgs)` |
|    56195 | 5328 | `		 && (pVmFunc->iFlags & (VM_FUNC_INTERNAL\|VM_FUNC_CLASS_METHOD)) != VM_FUNC_INTERNAL ){` |
|        - | 5329 | `			sxu32 nNonVar,nReq;` |
|     5949 | 5330 | `			nReq = VmFuncRequiredArgCount(pVmFunc,&nNonVar);` |
|     5949 | 5331 | `			if( n < nReq ){` |
...
|   117064 | 5351 | `		while( n < SySetUsed(&pVmFunc->aArgs) ){` |
|    12347 | 5352 | `			if( aFormalArg[n].iFlags & VM_FUNC_ARG_VARIADIC ){` |
...
|        - | 5363 | `			}` |
|    12103 | 5364 | `			if( SySetUsed(&aFormalArg[n].aByteCode) > 0 ){` |
|    12101 | 5365 | `				pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|    12101 | 5366 | `				if( pObj ){` |
|        - | 5367 | `					/* Evaluate the default value and extract it's result */` |
|    12101 | 5368 | `					rc = VmLocalExec(&(*pVm),&aFormalArg[n].aByteCode,pObj,FALSE);` |
|    12101 | 5369 | `					if( rc == PH7_ABORT ){` |
|      ! 0 | 5370 | `						goto Abort;` |
|        - | 5371 | `					}` |
|        - | 5372 | `					/* Insert argument index */` |
|    12101 | 5373 | `					sArg.nIdx = pObj->nIdx;` |
|    12101 | 5374 | `					sArg.pUserData = 0;` |
|    12101 | 5375 | `					SySetPut(&pFrame->sArg,(const void *)&sArg);` |
...
|    12096 | 5380 | `					if( aFormalArg[n].nType > 0 && aFormalArg[n].nType != MEMOBJ_OBJ` |
...
|        - | 5394 | `		 */` |
|   104966 | 5395 | `		PH7_MemObjRelease(pTos);` |
|   104966 | 5396 | `		pTos = &pTos[-nCallArgs];` |
...
|        - | 5408 | `		 * per function. */` |
|        - | 5409 | `		{` |
|   104966 | 5410 | `			sxu32 nSlots = pVmFunc->nMaxStack;` |
|   104966 | 5411 | `			if( nSlots == 0 ){` |
|     8289 | 5412 | `				sxu32 nInstr = SySetUsed(&pVmFunc->aByteCode);` |
|    12431 | 5413 | `				sxu32 nTight = VmComputeMaxStack(&(*pVm),` |
|     8284 | 5414 | `					(VmInstr *)SySetBasePtr(&pVmFunc->aByteCode),nInstr);` |
|     8289 | 5415 | `				nSlots = ( nTight == VM_STACK_UNMODELED ) ? nInstr : nTight;` |
|     8289 | 5416 | `				if( nSlots == 0 ){ nSlots = 1; } /* a 0-depth body still needs a valid, nonzero cache marker */` |
|     8289 | 5417 | `				pVmFunc->nMaxStack = nSlots;` |
|     4142 | 5418 | `			}` |
|   104966 | 5419 | `			pFrameStack = VmOperandStackAlloc(&(*pVm),nSlots);` |
|        - | 5420 | `		}` |
|   104966 | 5421 | `		if( pFrameStack == 0 ){` |
...
|      ! 0 | 5428 | `			break;` |
|        - | 5429 | `		}` |
|    52378 | 5430 | `SkipFuncBody:` |
|   105100 | 5431 | `		if( pSelf ){` |
|        - | 5432 | `			/* Push class name */` |
|    25737 | 5433 | `			SySetPut(&pVm->aSelf,(const void *)&pSelf);` |
|    12866 | 5434 | `		}` |
|        - | 5435 | `		/* Increment nesting level */` |
|   105100 | 5436 | `		pVm->nRecursionDepth++;` |
|   105100 | 5437 | `		if( rc == PH7_EXCEPTION ){` |
...
|   104966 | 5466 | `			VmCallFrame *pRec = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   104966 | 5467 | `			if( pRec ){` |
|   102322 | 5468 | `				pVm->pIdleCallFrames = (void *)pRec->pPrev;` |
|    51266 | 5469 | `			}else{` |
|     2649 | 5470 | `				pRec = (VmCallFrame *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmCallFrame));` |
|        - | 5471 | `			}` |
|   104966 | 5472 | `			if( pRec == 0 ){` |
...
|      ! 0 | 5483 | `				goto Abort;` |
|        - | 5484 | `			}` |
|   104966 | 5485 | `			sState.pTos = pTos;` |
|   104966 | 5486 | `			sState.pc = pc;` |
|   104966 | 5487 | `			pRec->sCaller = sState;` |
|   104966 | 5488 | `			pRec->sCall.pVmFunc = pVmFunc;` |
|   104966 | 5489 | `			pRec->sCall.pFrame = pFrame;` |
|   104966 | 5490 | `			pRec->sCall.pFrameStack = pFrameStack;` |
|   104966 | 5491 | `			pRec->sCall.nStackCap = pVmFunc->nMaxStack + VM_STACK_GUARD;` |
|   104966 | 5492 | `			pRec->sCall.nLastRef = SXU32_HIGH;` |
|   104966 | 5493 | `			pRec->sCall.bSelfPushed = (sxu8)(pSelf ? 1 : 0);` |
|   104966 | 5494 | `			pRec->pPrev = pCallTop;` |
|   104966 | 5495 | `			pCallTop = pRec;` |
|        - | 5496 | `			/* Switch to the callee activation (what the recursive` |
|        - | 5497 | `			 * VmByteCodeExec entry used to set up). */` |
|   104966 | 5498 | `			aInstr = (VmInstr *)SySetBasePtr(&pVmFunc->aByteCode);` |
|   104966 | 5499 | `			pStack = pFrameStack;` |
|   104966 | 5500 | `			pTos = &pStack[-1];` |
|   104966 | 5501 | `			pc = 0;` |
|   104966 | 5502 | `			sState.aInstr = aInstr;` |
|   104966 | 5503 | `			sState.pStack = pStack;` |
|   104966 | 5504 | `			sState.nStackCap = pRec->sCall.nStackCap; /* callee's operand-stack capacity for OP_SPREAD growth */` |
|   104966 | 5505 | `			sState.nStackOrig = pRec->sCall.nStackCap; /* fixed headroom reference (never grows) */` |
|   104966 | 5506 | `			sState.pTos = pTos;` |
|   104966 | 5507 | `			sState.pc = 0;` |
|   104966 | 5508 | `			sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|   104966 | 5509 | `			sState.pEntryFrame = pVm->pFrame;` |
|   104966 | 5510 | `			sState.pResult = pRec->sCaller.pTos;` |
|   104966 | 5511 | `			sState.pLastRef = &pRec->sCall.nLastRef;` |
|   104966 | 5512 | `			sState.pEnforceRetFunc = VmFuncHasReturnType(pVmFunc) ? pVmFunc : 0;` |
|   104966 | 5513 | `			sState.is_callback = 0;` |
|   104966 | 5514 | `			sState.bReturnPropagates = 0;` |
|   104966 | 5515 | `			goto VmLoopFetch;` |
|        - | 5516 | `		}` |
|       57 | 5517 | `	}else{` |
...
|   936323 | 5526 | `		pEntry = SyHashGet(&pVm->hHostFunction,(const void *)sName.zString,sName.nByte);` |
|        - | 5527 | `		{` |
|   936323 | 5528 | `		VmCallArgMap *pCallMap2 = pEffCallMap;` |
|   936323 | 5529 | `		if( pEntry == 0 && pCallMap2 && pCallMap2->bIsNamespaced ){` |
...
|        - | 5634 | `			}` |
|        - | 5635 | `		}` |
|   936307 | 5636 | `		pFunc = (ph7_user_func *)pEntry->pUserData;` |
...
|  1404821 | 5641 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   936302 | 5642 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
|        - | 5643 | `		/* Start collecting function arguments */` |
|   936307 | 5644 | `		SySetReset(&aArg);` |
|  2530946 | 5645 | `		while( pArg < pTos ){` |
|  1594644 | 5646 | `			SySetPut(&aArg,(const void *)&pArg);` |
|  1594644 | 5647 | `			pArg++;` |
|        5 | 5648 | `		}` |
|        - | 5649 | `		/* Assume a null return value */` |
|   936307 | 5650 | `		PH7_MemObjInit(&(*pVm),&sRet);` |
|        - | 5651 | `		/* Init the call context */` |
|   936307 | 5652 | `		VmInitCallContext(&sCtx,&(*pVm),pFunc,&sRet,0);` |
...
|   936307 | 5659 | `		sCtx.pArgMap = pEffCallMap;` |
|        - | 5660 | `		{` |
|   936307 | 5661 | `		int nGiven = (int)SySetUsed(&aArg);` |
...
|   936307 | 5667 | `		if( pFunc->nMinArg > 0 && nGiven < pFunc->nMinArg ){` |
...
|      232 | 5674 | `				nGiven);` |
|   936075 | 5675 | `		}else if( pFunc->bHasMaxArg && nGiven > (int)pFunc->nMaxArg ){` |
...
|       40 | 5688 | `				nGiven);` |
|  1404045 | 5689 | `		}else if( SXRET_OK != (rc = VmEnforceBuiltinArgTypes(&sCtx,pFunc,nGiven,` |
|   935758 | 5690 | `			(ph7_value **)SySetBasePtr(&aArg))) ){` |
|        - | 5691 | `			/* TypeError thrown: rc carries the caught/uncaught status */` |
|      112 | 5692 | `		}else{` |
|        - | 5693 | `			/* Call the foreign function */` |
|   935549 | 5694 | `			rc = pFunc->xFunc(&sCtx,nGiven,(ph7_value **)SySetBasePtr(&aArg));` |
|        - | 5695 | `		}` |
|        - | 5696 | `		}` |
|        - | 5697 | `		/* Release the call context */` |
|   936307 | 5698 | `		VmReleaseCallContext(&sCtx);` |
|   936307 | 5699 | `		if( rc == PH7_ABORT ){` |
...
|      578 | 5704 | `			goto Abort;` |
|        - | 5705 | `		}` |
|   935733 | 5706 | `		if( rc != PH7_SUSPEND && pVm->pInlineInstr == (void *)aInstr ){` |
...
|      ! 0 | 5719 | `		}` |
|   935729 | 5720 | `		if( rc == PH7_EXCEPTION ){` |
...
|      839 | 5740 | `			break;` |
|        - | 5741 | `		}` |
|   934697 | 5742 | `		if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|   913409 | 5766 | `			VmPopOperand(&pTos,nCallArgs);` |
|   457065 | 5767 | `		}` |
|        - | 5768 | `		/* Save foreign function return value into the (now top) function-name slot */` |
|   934343 | 5769 | `		PH7_MemObjStore(&sRet,pTos);` |
|   934343 | 5770 | `		PH7_MemObjRelease(&sRet);` |
|        - | 5771 | `	}` |
|   934447 | 5772 | `	break;` |
|        - | 5773 | `				  }` |
|        - | 5774 | `/*` |
...
|        - | 5777 | ` */` |
|    26083 | 5778 | `case PH7_OP_CONSUME: {` |
|        - | 5779 | `	VmOpRc rcOp;` |
|    52171 | 5780 | `	sState.pTos = pTos;` |
|    52171 | 5781 | `	sState.pc = pc;` |
|    52171 | 5782 | `	rcOp = VmExecOpConsume(&(*pVm),&sState,pInstr);` |
|    52171 | 5783 | `	pTos = sState.pTos;` |
|    52171 | 5784 | `	pc = sState.pc;` |
|    52171 | 5785 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 5786 | `		goto Abort;` |
|    52171 | 5787 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 5792 |  |
|        - | 5793 | `		} /* Switch() */` |
| 16699910 | 5794 | `		pc++; /* Next instruction in the stream */` |
|        5 | 5795 | `	} /* For(;;) */` |
|   131316 | 5796 | `Done:` |
...
|   262842 | 5800 | `	rc = SXRET_OK;` |
|   262842 | 5801 | `	goto Unwind;` |
|      823 | 5802 | `Suspend:` |
...
|   133329 | 5860 | `	for(;;){` |
|   266458 | 5861 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|      ! 0 | 5869 | `			}` |
|     1162 | 5870 | `		}` |
|   266458 | 5871 | `		if( pCallTop == 0 ){` |
|   161907 | 5872 | `			return VmExecFinalize(&(*pVm),&sState,&aArg,pTos,rc);` |
|        - | 5873 | `		}` |
|   104556 | 5874 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|      636 | 5880 | `		}` |
|        - | 5881 | `		{` |
|   104556 | 5882 | `			VmCallFrame *pRec = pCallTop;` |
|   104556 | 5883 | `			sState = pRec->sCaller;` |
|   104556 | 5884 | `			rc = VmCallFinish(&(*pVm),&sState,&pRec->sCall,rc);` |
|   104556 | 5885 | `			pCallTop = pRec->pPrev;` |
|   104556 | 5886 | `			pRec->pPrev = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   104556 | 5887 | `			pVm->pIdleCallFrames = (void *)pRec;` |
|   104556 | 5888 | `			aInstr = sState.aInstr;` |
|   104556 | 5889 | `			pStack = sState.pStack;` |
|   104556 | 5890 | `			pTos = sState.pTos;` |
|   104556 | 5891 | `			pc = sState.pc;` |
|        - | 5892 | `		}` |
|   104556 | 5893 | `		if( rc == PH7_OK ){` |
|   103790 | 5894 | `			pc++; /* the loop-bottom increment this OP_CALL missed */` |
|   103790 | 5895 | `			goto VmLoopFetch;` |
|        - | 5896 | `		}` |
|        5 | 5897 | `	}` |
|    81133 | 5898 | `}` |
|        - | 5899 |  |
