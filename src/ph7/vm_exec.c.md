...
|        - |  162 | ` */` |
|   157006 |  163 | `static sxi32 VmExecFinalize(ph7_vm *pVm,VmExecState *pState,SySet *pArg,ph7_value *pTos,sxi32 rcTerm)` |
|        5 |  164 | `{` |
|    78503 |  165 | `	SXUNUSED(pVm);` |
|   157011 |  166 | `	if( rcTerm != PH7_SUSPEND && !pState->bReturnPropagates ){` |
|   153379 |  167 | `		VmClearFrameReturn(pState->pEntryFrame);` |
|    76687 |  168 | `	}` |
|   157011 |  169 | `	SySetRelease(pArg);` |
|   157011 |  170 | `	if( rcTerm == PH7_ABORT \|\| rcTerm == PH7_EXCEPTION ){` |
|     2835 |  171 | `		while( pTos >= pState->pStack ){` |
|     1785 |  172 | `			PH7_MemObjRelease(pTos);` |
|     1785 |  173 | `			pTos--;` |
|        5 |  174 | `		}` |
|      525 |  175 | `	}` |
|   157011 |  176 | `	return rcTerm;` |
|        5 |  177 | `}` |
|        - |  178 | `/*` |
...
|        - |  189 | ` */` |
|   104268 |  190 | `static sxi32 VmCallFinish(ph7_vm *pVm,VmExecState *pCaller,VmCallRecord *pCallee,sxi32 rc)` |
|        5 |  191 | `{` |
|        - |  192 | `	ph7_value *pObj;` |
|        - |  193 | `	/* Decrement nesting level */` |
|   104273 |  194 | `	pVm->nRecursionDepth--;` |
|   104273 |  195 | `	if( pCallee->bSelfPushed ){` |
|        - |  196 | `		/* Pop class name */` |
|    25389 |  197 | `		(void)SySetPop(&pVm->aSelf);` |
|    12692 |  198 | `	}` |
|   104273 |  199 | `	if( (pCallee->pVmFunc->iFlags & VM_FUNC_REF_RETURN) && rc == SXRET_OK ){` |
...
|       25 |  225 | `	}` |
|   104273 |  226 | `	if( rc != PH7_ABORT && ((pCallee->pFrame->iFlags & VM_FRAME_THROW) \|\| rc == PH7_EXCEPTION) ){` |
...
|   104273 |  272 | `	if( rc != PH7_SUSPEND && pCallee->pFrameStack ){` |
...
|   104139 |  276 | `		VmOperandStackRecycle(pVm,pCallee->pFrameStack,pCallee->nStackCap);` |
|    52169 |  277 | `	}` |
|        - |  278 | `	/* Leave the frame */` |
|   104273 |  279 | `	VmLeaveFrame(&(*pVm));` |
|   104273 |  280 | `	if( rc == PH7_ABORT ){` |
|      336 |  281 | `		return PH7_ABORT;` |
|        - |  282 | `	}` |
|   103941 |  283 | `	if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|        - |  291 | `	}` |
|   103941 |  292 | `	if( rc == PH7_EXCEPTION ){` |
|      469 |  293 | `		return PH7_EXCEPTION;` |
|        - |  294 | `	}` |
|   103477 |  295 | `	return PH7_OK;` |
|    52241 |  296 | `}` |
|        - |  297 | `/*` |
...
|        - |  330 | ` * nesting.` |
|        - |  331 | ` */` |
|   157364 |  332 | `PH7_PRIVATE sxi32 VmByteCodeExec(` |
...
|   157369 |  352 | `	if( VmNativeNestingExceeded(pVm) ){` |
...
|   157365 |  362 | `	nSavedBrc = pVm->nBoundaryRc;` |
|   157365 |  363 | `	pVm->nBoundaryRc = 0;` |
...
|   157365 |  370 | `	nSavedLine = pVm->nCurLine;` |
|   157365 |  371 | `	pVm->nVmExecDepth++;` |
|   236045 |  372 | `	rc = VmByteCodeExecBody(&(*pVm),aInstr,pStack,nTos,pResult,pLastRef,is_callback,nPc,` |
|    78680 |  373 | `		pEnforceRetFunc,bReturnPropagates,pAdoptSegment,ppBaseOwner,pnBaseCap,nStackOrig);` |
|   157365 |  374 | `	pVm->nVmExecDepth--;` |
|   157365 |  375 | `	pVm->nCurLine = nSavedLine;` |
|   157365 |  376 | `	if( nSavedBrc != 0 && (nSavedBrc == PH7_ABORT \|\| pVm->nBoundaryRc == 0) ){` |
|       15 |  377 | `		pVm->nBoundaryRc = nSavedBrc;` |
|        6 |  378 | `	}` |
|   157365 |  379 | `	return rc;` |
|    78687 |  380 | `}` |
|   157360 |  381 | `static sxi32 VmByteCodeExecBody(` |
...
|        - |  399 | `	ph7_value *pTos;` |
|        - |  400 | `	SySet aArg;` |
|   157365 |  401 | `	VmCallFrame *pCallTop = 0; /* Top of this invocation's in-loop call-record` |
...
|        - |  409 | `	sxi32 pc;` |
|        - |  410 | `	sxi32 rc;` |
|   157365 |  411 | `	sState.aInstr = aInstr;` |
|   157365 |  412 | `	sState.pStack = pStack;` |
|   157365 |  413 | `	sState.nStackCap = pnBaseCap ? *pnBaseCap : 0; /* CURRENT capacity (grown on a coroutine resume) */` |
|   157365 |  414 | `	sState.nStackOrig = nStackOrig;                /* ORIGINAL capacity — fixed headroom reference */` |
|   157365 |  415 | `	sState.pResult = pResult;` |
|   157365 |  416 | `	sState.pLastRef = pLastRef;` |
|   157365 |  417 | `	sState.pEnforceRetFunc = pEnforceRetFunc;` |
|   157365 |  418 | `	sState.is_callback = (sxu8)(is_callback ? 1 : 0);` |
|   157365 |  419 | `	sState.bReturnPropagates = (sxu8)(bReturnPropagates ? 1 : 0);` |
|        - |  420 | `	/* Argument container */` |
|   157365 |  421 | `	SySetInit(&aArg,&pVm->sAllocator,sizeof(ph7_value *));` |
|   157365 |  422 | `	if( nTos < 0 ){` |
|   141655 |  423 | `		pTos = &pStack[-1];` |
|    70830 |  424 | `	}else{` |
|    15715 |  425 | `		pTos = &pStack[nTos];` |
|        - |  426 | `	}` |
|   157365 |  427 | `	sState.pTos = pTos;` |
|   157365 |  428 | `	sState.pc = nPc;` |
...
|   157360 |  446 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->pFrame == pVm->pFrame` |
|     2816 |  447 | `	 && pStack == pVm->pActiveCtx->pStack ){` |
|     1805 |  448 | `		sState.nExceptionBase = pVm->pActiveCtx->nExceptionBase;` |
|      905 |  449 | `	}else{` |
|   155565 |  450 | `		sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|        - |  451 | `	}` |
|   157365 |  452 | `	sState.pEntryFrame = pVm->pFrame;` |
|   157365 |  453 | `	pc = nPc;` |
...
|   157360 |  506 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->pInjected` |
...
|   157350 |  567 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->bClosing` |
...
| 16802877 |  603 | `		if( pVm->nBoundaryRc != 0 \|\| SySetUsed(&pVm->aHookRmw) > 0 ){` |
...
| 16802791 |  658 | `		pInstr = &aInstr[pc];` |
| 16802791 |  659 | `		if( pInstr->nLine ){` |
...
| 16589785 |  663 | `			pVm->nCurLine = pInstr->nLine;` |
|  8301191 |  664 | `		}` |
| 16802791 |  665 | `		rc = SXRET_OK;` |
|        - |  666 | `/*` |
...
|        - |  672 | ` */` |
| 16802791 |  673 | `		switch(pInstr->iOp){` |
|        - |  674 | `/*` |
|        - |  675 | ` * DONE: P1 * *` |
|        - |  676 | ` *` |
...
|        - |  679 | ` */` |
|   128570 |  680 | `case PH7_OP_DONE:` |
|   257349 |  681 | `	if( pInstr->iP2 && sState.bReturnPropagates ){` |
...
|   257160 |  711 | `	if( sState.pEnforceRetFunc && VmFuncHasReturnType(sState.pEnforceRetFunc)` |
...
|     4591 |  736 | `	}` |
|   257141 |  737 | `	if( pInstr->iP1 && pTos >= pStack ){` |
|   152665 |  738 | `		if( sState.pLastRef ){` |
|    93869 |  739 | `			*sState.pLastRef = pTos->nIdx;` |
|    47034 |  740 | `		}` |
|   152665 |  741 | `		if( sState.pResult ){` |
|        - |  742 | `			/* Execution result */` |
|   145655 |  743 | `			PH7_MemObjStore(pTos,sState.pResult);` |
|    72927 |  744 | `		}` |
|   152665 |  745 | `		VmPopOperand(&pTos,1);` |
|   180913 |  746 | `	}else if( sState.pLastRef ){` |
...
|     8869 |  752 | `		*sState.pLastRef = SXU32_HIGH;` |
|     4432 |  753 | `	}` |
...
|        - |  762 | `	 */` |
|   257141 |  763 | `	rc = VmDrainFinally(&(*pVm),sState.nExceptionBase);` |
|   257141 |  764 | `	if( rc == SXERR_ABORT ){` |
|      ! 0 |  765 | `		goto Abort;` |
|        - |  766 | `	}` |
|   257141 |  767 | `	if( rc == PH7_EXCEPTION ){` |
...
|        - |  778 | `	}` |
|   257137 |  779 | `	if( sState.pEntryFrame->bHasRet && !sState.bReturnPropagates ){` |
...
|        - |  835 | ` */` |
|   288516 |  836 | `case PH7_OP_JMP:` |
|   577241 |  837 | `	pc = pInstr->iP2 - 1;` |
|   577241 |  838 | `	break;` |
|        - |  839 | `/*` |
|        - |  840 | ` * JZ: P1 P2 *` |
|        - |  841 | ` *` |
...
|  1604842 |  852 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     1003 |  853 | `		PH7_MemObjToBool(pTos);` |
|      500 |  854 | `	}` |
|  1604842 |  855 | `	if( !pTos->x.iVal ){` |
|        - |  856 | `		/* Take the jump */` |
|   899496 |  857 | `		pc = pInstr->iP2 - 1;` |
|   450005 |  858 | `	}` |
|  1604842 |  859 | `	if( !pInstr->iP1 ){` |
|  1356422 |  860 | `		VmPopOperand(&pTos,1);` |
|   678774 |  861 | `	}` |
|  1604842 |  862 | `	break;` |
|        - |  863 | `/*` |
|        - |  864 | ` * JNZ: P1 P2 *` |
...
|   184155 |  876 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      ! 0 |  877 | `		PH7_MemObjToBool(pTos);` |
|      ! 0 |  878 | `	}` |
|   184155 |  879 | `	if( pTos->x.iVal ){` |
|        - |  880 | `		/* Take the jump */` |
|     9555 |  881 | `		pc = pInstr->iP2 - 1;` |
|     4775 |  882 | `	}` |
|   184155 |  883 | `	if( !pInstr->iP1 ){` |
...
|        - |  899 | ` */` |
|   661714 |  900 | `case PH7_OP_POP: {` |
|  1324453 |  901 | `	sxi32 n = pInstr->iP1;` |
|  1324453 |  902 | `	if( &pTos[-n+1] < pStack ){` |
|        - |  903 | `		/* TICKET 1433-51 Stack underflow must be handled at run-time */` |
|       79 |  904 | `		n = (sxi32)(pTos - pStack);` |
|       38 |  905 | `	}` |
|  1324453 |  906 | `	VmPopOperand(&pTos,n);` |
|  1324453 |  907 | `	break;` |
|        - |  908 | `				 }` |
|        - |  909 | `/*` |
|        - |  910 | ` * DUP: * * *` |
...
|        - |  929 | ` */` |
|    49013 |  930 | `case PH7_OP_NSSWITCH:` |
|    98031 |  931 | `	SyBlobReset(&pVm->sNamespace);` |
|    98031 |  932 | `	if( pInstr->p3 ){` |
...
|    98031 |  937 | `	SyHashRelease(&pVm->hUseConstImports);` |
|    98031 |  938 | `	SyHashInit(&pVm->hUseConstImports,&pVm->sAllocator,0,0);` |
|    98031 |  939 | `	break;` |
...
|        - | 1076 | ` */` |
|     3389 | 1077 | `case PH7_OP_UNSET_VAR: {` |
|        - | 1078 | `	VmOpRc rcOp;` |
|     6783 | 1079 | `	sState.pTos = pTos;` |
|     6783 | 1080 | `	sState.pc = pc;` |
|     6783 | 1081 | `	rcOp = VmExecOpUnsetVar(&(*pVm),&sState,pInstr);` |
|     6783 | 1082 | `	pTos = sState.pTos;` |
|     6783 | 1083 | `	pc = sState.pc;` |
|     6783 | 1084 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 1085 | `		goto Abort;` |
|     6781 | 1086 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1163 | ` */` |
|  1510916 | 1164 | `case PH7_OP_LOADC: {` |
|        - | 1165 | `	ph7_value *pObj;` |
|        - | 1166 | `	/* Reserve a room */` |
|  3023691 | 1167 | `	pTos++;` |
|  3023691 | 1168 | `	if( pInstr->iP1 & PH7_LOADC_NOKEY ){` |
...
|    19089 | 1174 | `		break;` |
|        - | 1175 | `	}` |
|  3004607 | 1176 | `	if( (pObj = (ph7_value *)SySetAt(&pVm->aLitObj,pInstr->iP2)) != 0 ){` |
|  3004607 | 1177 | `		if( (pInstr->iP1 & PH7_LOADC_EXPAND) && SyBlobLength(&pObj->sBlob) <= 64 ){` |
...
|        - | 1283 | ` */` |
|  2195053 | 1284 | `case PH7_OP_LOAD:{` |
|        - | 1285 | `	ph7_value *pObj;` |
|        - | 1286 | `	SyString sName;` |
|  4394005 | 1287 | `	if( pInstr->p3 == 0 ){` |
...
|        9 | 1299 | `	}else{` |
|  4393989 | 1300 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1301 | `		/* Reserve a room for the target object */` |
|  4393989 | 1302 | `		pTos++;` |
|        - | 1303 | `	}` |
|  4394005 | 1304 | `	if( pInstr->iP2 == 2 ){` |
...
|   392783 | 1310 | `		if( VmExtractMemObj(&(*pVm),&sName,FALSE,FALSE) == 0 ){` |
|        7 | 1311 | `			VmErrorFormat(&(*pVm),PH7_CTX_WARNING,"Undefined variable $%z",&sName);` |
|        3 | 1312 | `		}` |
|   196491 | 1313 | `	}` |
|        - | 1314 | `	/* Extract the requested memory object */` |
|  4394005 | 1315 | `	pObj = VmExtractMemObj(&(*pVm),&sName,pInstr->p3 ? FALSE : TRUE,pInstr->iP1 != 1);` |
|  4394005 | 1316 | `	if( pObj == 0 ){` |
...
|  4393943 | 1341 | `	PH7_MemObjLoad(pObj,pTos);` |
|  4393943 | 1342 | `	pTos->nIdx = pObj->nIdx;` |
|  4393943 | 1343 | `	break;` |
|        - | 1344 | `				   }` |
|        - | 1345 | `/*` |
|        - | 1346 | ` * LOAD_MAP P1 * *` |
...
|        - | 1351 | ` */` |
|    36849 | 1352 | `case PH7_OP_LOAD_MAP: {` |
|        - | 1353 | `	VmOpRc rcOp;` |
|    73703 | 1354 | `	sState.pTos = pTos;` |
|    73703 | 1355 | `	sState.pc = pc;` |
|    73703 | 1356 | `	rcOp = VmExecOpLoadMap(&(*pVm),&sState,pInstr);` |
|    73703 | 1357 | `	pTos = sState.pTos;` |
|    73703 | 1358 | `	pc = sState.pc;` |
|    73703 | 1359 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1360 | `		goto Abort;` |
|    73703 | 1361 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1394 | ` * instead.` |
|        - | 1395 | ` */` |
|   331849 | 1396 | `case PH7_OP_LOAD_IDX: {` |
|        - | 1397 | `	VmOpRc rcOp;` |
|   664426 | 1398 | `	sState.pTos = pTos;` |
|   664426 | 1399 | `	sState.pc = pc;` |
|   664426 | 1400 | `	rcOp = VmExecOpLoadIdx(&(*pVm),&sState,pInstr);` |
|   664426 | 1401 | `	pTos = sState.pTos;` |
|   664426 | 1402 | `	pc = sState.pc;` |
|   664426 | 1403 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1404 | `		goto Abort;` |
|   664426 | 1405 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1507 | `	}` |
|        - | 1508 | `#endif` |
|   595167 | 1509 | `	if( pInstr->iP2 ){` |
|        - | 1510 | `		sxu32 nIdx;` |
|        - | 1511 | `		sxi32 rcT;` |
|        - | 1512 | `		/* Member store operation */` |
|    11757 | 1513 | `		nIdx = pTos->nIdx;` |
|    11757 | 1514 | `		VmPopOperand(&pTos,1);` |
|    11757 | 1515 | `		if( pVm->pMagicSetThis ){` |
...
|       11 | 1528 | `			break;` |
|        - | 1529 | `		}` |
|    11747 | 1530 | `		if( pVm->pHookSetThis ){` |
...
|    11715 | 1558 | `			rcT = VmEnforcePropertyTypeOnStore(&(*pVm),nIdx,pTos,0);` |
|    11715 | 1559 | `			if( rcT == PH7_ABORT ){` |
|       13 | 1560 | `				goto Abort;` |
|        - | 1561 | `			}` |
|    11705 | 1562 | `			if( rcT == PH7_EXCEPTION ){` |
...
|    11637 | 1577 | `			pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|    11637 | 1578 | `			if( pObj ){` |
|        - | 1579 | `				/* Perform the store operation */` |
|    11637 | 1580 | `				PH7_MemObjStore(pTos,pObj);` |
|     5816 | 1581 | `			}` |
|        - | 1582 | `		}` |
|    11639 | 1583 | `		break;` |
|   583415 | 1584 | `	}else if( pInstr->p3 == 0 ){` |
...
|        - | 1596 | `#endif` |
|        5 | 1597 | `	}else{` |
|   583407 | 1598 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1599 | `	}` |
|   583410 | 1600 | `	if( sName.nByte == sizeof("GLOBALS")-1` |
|   293477 | 1601 | `	 && SyMemcmp((const void *)sName.zString,(const void *)"GLOBALS",sName.nByte) == 0 ){` |
|        6 | 1602 | `		if( pInstr->p3 ){` |
...
|   366853 | 1671 | `	PH7_ENFORCE_READONLY_MUTATE(pTos->nIdx);` |
...
|   366842 | 1676 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) != 0` |
...
|        - | 1694 | `		}` |
|      ! 0 | 1695 | `	}` |
|   366845 | 1696 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) == 0 ){` |
|   366845 | 1697 | `		if( pTos->nIdx != SXU32_HIGH ){` |
|        - | 1698 | `			ph7_value *pObj;` |
|   366845 | 1699 | `			if( (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pTos->nIdx)) != 0 ){` |
|   366845 | 1700 | `				if( VmStringWantsPerlIncr(pObj) ){` |
...
|   366843 | 1719 | `					if( pInstr->iP1 == 0 && (pTos->iFlags & MEMOBJ_STRING) ){` |
|        9 | 1720 | `						SyBlobNullAppend(&pTos->sBlob);` |
|        3 | 1721 | `					}` |
|        - | 1722 | `					/* Force a numeric cast on the variable */` |
|   366843 | 1723 | `					PH7_MemObjToNumeric(pObj);` |
|   366843 | 1724 | `					if( pObj->iFlags & MEMOBJ_REAL ){` |
|        5 | 1725 | `						pObj->rVal++;` |
...
|        - | 1734 | `						sxi64 r;` |
|   366839 | 1735 | `						if( PH7_ADD_OVERFLOW64(pObj->x.iVal,1,&r) ){` |
...
|        - | 1741 | `#endif` |
|        3 | 1742 | `						}else{` |
|   366835 | 1743 | `							pObj->x.iVal = r;` |
|        - | 1744 | `						}` |
|        - | 1745 | `					}` |
|   366843 | 1746 | `					if( pInstr->iP1 ){` |
...
|        - | 1785 | `		}` |
|   183521 | 1786 | `	}` |
|   366843 | 1787 | `	PH7_HOOK_RMW_WRITEBACK(pTos->nIdx,pTos);` |
|   366843 | 1788 | `	break;` |
|        - | 1789 | `/*` |
|        - | 1790 | ` * DECR: P1 * *` |
|        - | 1791 | ` *` |
...
|    70603 | 1938 | `	PH7_MemObjToNumeric(pTos);` |
|    70603 | 1939 | `	if( pTos->iFlags & MEMOBJ_REAL ){` |
|      108 | 1940 | `		pTos->rVal = -pTos->rVal;` |
|       53 | 1941 | `	}` |
|    70603 | 1942 | `	if( pTos->iFlags & MEMOBJ_INT ){` |
|    70517 | 1943 | `		if( pTos->x.iVal == SMALLEST_INT64 ){` |
...
|        - | 1958 | `#endif` |
|        3 | 1959 | `		}else{` |
|    70513 | 1960 | `			pTos->x.iVal = -pTos->x.iVal;` |
|        - | 1961 | `		}` |
|    35256 | 1962 | `	}` |
|    70603 | 1963 | `	break;` |
|        - | 1964 | `/*` |
...
|    50875 | 1997 | `	if( (pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      119 | 1998 | `		PH7_MemObjToBool(pTos);` |
|       57 | 1999 | `	}` |
|    50875 | 2000 | `	pTos->x.iVal = !pTos->x.iVal;` |
|    50875 | 2001 | `	break;` |
|        - | 2002 | `/*` |
|        - | 2003 | ` * OP_BITNOT: * * *` |
|        - | 2004 | ` *` |
...
|        - | 2526 | ` * back.` |
|        - | 2527 | ` */` |
|    86363 | 2528 | `case PH7_OP_CAT:{` |
|        - | 2529 | `	ph7_value *pNos,*pCur;` |
|   172731 | 2530 | `	if( pInstr->iP1 < 1 ){` |
|   144507 | 2531 | `		pNos = &pTos[-1];` |
|    72256 | 2532 | `	}else{` |
...
|   172731 | 2541 | `	if( (pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|     1931 | 2542 | `		PH7_MemObjToString(pNos);` |
|      963 | 2543 | `	}` |
|   172731 | 2544 | `	pCur = &pNos[1];` |
|   348849 | 2545 | `	while( pCur <= pTos ){` |
|   176123 | 2546 | `		if( (pCur->iFlags & MEMOBJ_STRING) == 0 ){` |
|    52225 | 2547 | `			PH7_MemObjToString(pCur);` |
|    26110 | 2548 | `		}` |
|        - | 2549 | `		/* Perform the concatenation */` |
|   176123 | 2550 | `		if( SyBlobLength(&pCur->sBlob) > 0 ){` |
|   175975 | 2551 | `			if( PH7_MemObjStringAppend(pNos,(const char *)SyBlobData(&pCur->sBlob),SyBlobLength(&pCur->sBlob)) != SXRET_OK ){` |
|        - | 2552 | `				/* Allocation failure: raise a fatal instead of a truncated concat */` |
|      ! 0 | 2553 | `				PH7_VmMemoryError(&(*pVm));` |
|      ! 0 | 2554 | `				goto Abort;` |
|        - | 2555 | `			}` |
|    87985 | 2556 | `		}` |
|   176123 | 2557 | `		SyBlobRelease(&pCur->sBlob);` |
|   176123 | 2558 | `		pCur++;` |
|        5 | 2559 | `	}` |
|   172731 | 2560 | `	pTos = pNos;` |
|   172731 | 2561 | `	break;` |
|        - | 2562 | `				}` |
|        - | 2563 | `/*  CAT_STORE: * * *` |
|        - | 2564 | ` *` |
...
|        - | 2668 | ` * stack.` |
|        - | 2669 | ` */` |
|   114053 | 2670 | `case PH7_OP_LAND:` |
|        - | 2671 | `case PH7_OP_LOR: {` |
|        - | 2672 | `	VmOpRc rcOp;` |
|   228315 | 2673 | `	sState.pTos = pTos;` |
|   228315 | 2674 | `	sState.pc = pc;` |
|   228315 | 2675 | `	rcOp = VmExecOpLor(&(*pVm),&sState,pInstr);` |
|   228315 | 2676 | `	pTos = sState.pTos;` |
|   228315 | 2677 | `	pc = sState.pc;` |
|   228315 | 2678 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2679 | `		goto Abort;` |
|   228315 | 2680 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2917 | ` */` |
|   228134 | 2918 | `case PH7_OP_TEQ: {` |
|        - | 2919 | `	VmOpRc rcOp;` |
|   456477 | 2920 | `	sState.pTos = pTos;` |
|   456477 | 2921 | `	sState.pc = pc;` |
|   456477 | 2922 | `	rcOp = VmExecOpTeq(&(*pVm),&sState,pInstr);` |
|   456477 | 2923 | `	pTos = sState.pTos;` |
|   456477 | 2924 | `	pc = sState.pc;` |
|   456477 | 2925 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2926 | `		goto Abort;` |
|   456477 | 2927 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2939 | ` *` |
|        - | 2940 | ` */` |
|   174484 | 2941 | `case PH7_OP_TNE: {` |
|        - | 2942 | `	VmOpRc rcOp;` |
|   349177 | 2943 | `	sState.pTos = pTos;` |
|   349177 | 2944 | `	sState.pc = pc;` |
|   349177 | 2945 | `	rcOp = VmExecOpTne(&(*pVm),&sState,pInstr);` |
|   349177 | 2946 | `	pTos = sState.pTos;` |
|   349177 | 2947 | `	pc = sState.pc;` |
|   349177 | 2948 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2949 | `		goto Abort;` |
|   349177 | 2950 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2971 | ` *` |
|        - | 2972 | ` */` |
|   145736 | 2973 | `case PH7_OP_LT:` |
|        - | 2974 | `case PH7_OP_LE: {` |
|        - | 2975 | `	VmOpRc rcOp;` |
|   291885 | 2976 | `	sState.pTos = pTos;` |
|   291885 | 2977 | `	sState.pc = pc;` |
|   291885 | 2978 | `	rcOp = VmExecOpLe(&(*pVm),&sState,pInstr);` |
|   291885 | 2979 | `	pTos = sState.pTos;` |
|   291885 | 2980 | `	pc = sState.pc;` |
|   291885 | 2981 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2982 | `		goto Abort;` |
|   291885 | 2983 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3004 | ` *` |
|        - | 3005 | ` */` |
|    85895 | 3006 | `case PH7_OP_GT:` |
|        - | 3007 | `case PH7_OP_GE: {` |
|        - | 3008 | `	VmOpRc rcOp;` |
|   171999 | 3009 | `	sState.pTos = pTos;` |
|   171999 | 3010 | `	sState.pc = pc;` |
|   171999 | 3011 | `	rcOp = VmExecOpGe(&(*pVm),&sState,pInstr);` |
|   171999 | 3012 | `	pTos = sState.pTos;` |
|   171999 | 3013 | `	pc = sState.pc;` |
|   171999 | 3014 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 3015 | `		goto Abort;` |
|   171999 | 3016 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3113 | ` */` |
|     1355 | 3114 | `case PH7_OP_LOAD_EXCEPTION: {` |
|        - | 3115 | `	VmOpRc rcOp;` |
|     2715 | 3116 | `	sState.pTos = pTos;` |
|     2715 | 3117 | `	sState.pc = pc;` |
|     2715 | 3118 | `	rcOp = VmExecOpLoadException(&(*pVm),&sState,pInstr);` |
|     2715 | 3119 | `	pTos = sState.pTos;` |
|     2715 | 3120 | `	pc = sState.pc;` |
|     2715 | 3121 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 3122 | `		goto Abort;` |
|     2715 | 3123 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3131 | ` */` |
|     1188 | 3132 | `case PH7_OP_POP_EXCEPTION: {` |
|     2381 | 3133 | `	ph7_exception *pCompiledExc = (ph7_exception *)pInstr->p3;` |
...
|     2381 | 3138 | `	ph7_exception *pException = 0;` |
|     2381 | 3139 | `	if( SySetUsed(&pVm->aException) > 0 ){` |
...
|      193 | 3153 | `		}` |
|      200 | 3154 | `	}` |
|     2381 | 3155 | `	if( pCompiledExc->iInlined ){` |
...
|     2227 | 3182 | `	if( pVm->pFrame->iFlags & VM_FRAME_EXCEPTION ){` |
|     1617 | 3183 | `		VmLeaveFrame(&(*pVm));` |
|      806 | 3184 | `	}` |
...
|     2227 | 3188 | `	if( pException && pCompiledExc->iHasFinally && !pException->iFinallyDone ){` |
...
|        - | 3206 | `		}` |
|       12 | 3207 | `	}` |
|     2223 | 3208 | `	VmExcRelease(&(*pVm),pException); /* no-finally / already-done paths (may be NULL) */` |
|     2223 | 3209 | `	if( VmSkipExceptionFrames(pVm->pFrame)->bHasRet ){` |
...
|        - | 3426 | ` */` |
|    22393 | 3427 | `case PH7_OP_MEMBER: {` |
|        - | 3428 | `	VmOpRc rcOp;` |
|    44791 | 3429 | `	sState.pTos = pTos;` |
|    44791 | 3430 | `	sState.pc = pc;` |
|    44791 | 3431 | `	rcOp = VmExecOpMember(&(*pVm),&sState,pInstr);` |
|    44791 | 3432 | `	pTos = sState.pTos;` |
|    44791 | 3433 | `	pc = sState.pc;` |
|    44791 | 3434 | `	if( rcOp == VM_OP_ABORT ){` |
|        8 | 3435 | `		goto Abort;` |
|    44785 | 3436 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|  1039022 | 3831 | `	sxi32 nCallArgs = pInstr->iP1 + (pInstr->iP2 ? VmSpreadOwnExtra(pVm,pInstr->iP1,pTos) : 0);` |
|        - | 3832 | `	ph7_value *pArg;` |
|  1039022 | 3833 | `	pArg = &pTos[-nCallArgs];` |
...
|  1039022 | 3842 | `	VmCallArgMap *pEffCallMap = (VmCallArgMap *)pInstr->p3;` |
...
|  1039022 | 3849 | `	if( VmValueIsClosure(pVm,pTos) ){` |
...
|  1039022 | 3859 | `	if( (pTos->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|      142 | 4054 | `		break;` |
|        - | 4055 | `	}` |
|  1038862 | 4056 | `	SyStringInitFromBuf(&sName,SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
...
|  1038862 | 4060 | `	if( sName.nByte > 0 && sName.zString[0] == '\\' ){` |
...
|  1038862 | 4067 | `	pEntry = SyHashGet(&pVm->hFunction,(const void *)sName.zString,sName.nByte);` |
...
|        - | 4073 | `	{` |
|  1038862 | 4074 | `	VmCallArgMap *pCallMap = pEffCallMap;` |
|  1038862 | 4075 | `	if( pEntry == 0 && pCallMap && pCallMap->bIsNamespaced ){` |
...
|        - | 4106 | `		VmSlot sArg;` |
|        - | 4107 | `		sxu32 n;` |
|   105035 | 4108 | `		int bClosureThis = 0;` |
|   105035 | 4109 | `		ph7_class *pClosureScope = 0;` |
|        - | 4110 | `		/* initialize fields */` |
|   105035 | 4111 | `		pVmFunc = (ph7_vm_func *)pEntry->pUserData;` |
|   105035 | 4112 | `		pThis = 0;` |
|   105035 | 4113 | `		pSelf = 0;` |
...
|       14 | 4128 | `		}` |
|   105035 | 4129 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
|        - | 4130 | `			ph7_class_method *pMeth;` |
|        - | 4131 | `			/* Class method call */` |
|    25545 | 4132 | `			ph7_value *pTarget = &pTos[-1];` |
|    25545 | 4133 | `			if( pTarget >= pStack && (pTarget->iFlags & (MEMOBJ_STRING\|MEMOBJ_OBJ\|MEMOBJ_NULL)) ){` |
|        - | 4134 | `				/* Extract the 'this' pointer */` |
|    25545 | 4135 | `				if(pTarget->iFlags & MEMOBJ_OBJ ){` |
|        - | 4136 | `					/* Instance already loaded */` |
|    24509 | 4137 | `					pThis = (ph7_class_instance *)pTarget->x.pOther;` |
|    24509 | 4138 | `					pThis->iRef++;` |
|    24509 | 4139 | `					pSelf = pThis->pClass;` |
|    12252 | 4140 | `				}` |
|    25545 | 4141 | `				if( pSelf == 0 ){` |
...
|      353 | 4160 | `					}` |
|      518 | 4161 | `				}` |
|    25545 | 4162 | `				VmPopOperand(&pTos,1);` |
|    25545 | 4163 | `				PH7_MemObjRelease(pTos);` |
...
|    25545 | 4170 | `				nCallArgs = pInstr->iP1 + (pInstr->iP2 ? VmSpreadOwnExtra(&(*pVm),pInstr->iP1,pTos) : 0);` |
|    25545 | 4171 | `				pArg = &pTos[-nCallArgs];` |
...
|        - | 4176 | `				 */` |
|    25545 | 4177 | `				while( pArg < pStack ){` |
|      ! 0 | 4178 | `					pArg++;` |
|      ! 0 | 4179 | `				}` |
|    25545 | 4180 | `				if( pSelf && pVm->bReflectBypass ){` |
...
|        6 | 4185 | `				}else` |
|    25535 | 4186 | `				if( pSelf ){ /* Paranoid edition */` |
...
|    25535 | 4194 | `					ph7_class *pDeclClass = pVmFunc->pUserData ? (ph7_class *)pVmFunc->pUserData : pSelf;` |
|    25535 | 4195 | `					pMeth = PH7_ClassExtractMethod(pDeclClass,pVmFunc->sName.zString,pVmFunc->sName.nByte);` |
|    25535 | 4196 | `					if( pMeth == 0 && pDeclClass != pSelf ){` |
|      ! 0 | 4197 | `						pMeth = PH7_ClassExtractMethod(pSelf,pVmFunc->sName.zString,pVmFunc->sName.nByte);` |
|      ! 0 | 4198 | `					}` |
|    25535 | 4199 | `					if( pMeth && pMeth->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|   157652 | 4236 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   105030 | 4237 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
...
|   105035 | 4244 | `		if( VmRecursionExceeded(pVm) ){` |
...
|        3 | 4248 | `			goto Abort;` |
|        - | 4249 | `		}` |
|   105033 | 4250 | `		if( pVmFunc->pNextName ){` |
...
|   105033 | 4262 | `		pSelfHint = pSelf;` |
|   105033 | 4263 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
|    25545 | 4264 | `			ph7_class *pDecl = (ph7_class *)pVmFunc->pUserData;` |
|    25545 | 4265 | `			if( pDecl && (pDecl->iFlags & PH7_CLASS_TRAIT) == 0 ){` |
|    24519 | 4266 | `				pSelfHint = pDecl;` |
|    12257 | 4267 | `			}` |
|    12770 | 4268 | `		}` |
|   105033 | 4269 | `		if( pSelf == 0 && (pVmFunc->iFlags & VM_FUNC_CLOSURE) ){` |
...
|       29 | 4280 | `			}` |
|      887 | 4281 | `		}` |
|   105033 | 4282 | `		if( SySetUsed(&pVmFunc->aAttrs) > 0 ){` |
...
|       56 | 4287 | `		}` |
|   105033 | 4288 | `		if( pVmFunc->iFlags & VM_FUNC_GENERATOR ){` |
...
|   104693 | 4520 | `		aFormalArg = (ph7_vm_func_arg *)SySetBasePtr(&pVmFunc->aArgs);` |
|        - | 4521 | `		/* Create a new VM frame  */` |
|   104693 | 4522 | `		rc = VmEnterFrame(&(*pVm),pVmFunc,pThis,&pFrame);` |
|   104693 | 4523 | `		if( rc != SXRET_OK ){` |
...
|   104693 | 4551 | `		pFrame->nActualArgs = (int)(pTos - pArg);` |
|   104693 | 4552 | `		if( pThis && ((pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) \|\| bClosureThis) ){` |
...
|    24693 | 4555 | `			pObj = VmExtractMemObj(&(*pVm),&sThis,FALSE,TRUE);` |
|    24693 | 4556 | `			if( pObj ){` |
|        - | 4557 | `				/* Reflect the change */` |
|    24693 | 4558 | `				pObj->x.pOther = pThis;` |
|    24693 | 4559 | `				MemObjSetType(pObj,MEMOBJ_OBJ);` |
|    12344 | 4560 | `			}` |
|    12344 | 4561 | `		}` |
|   104693 | 4562 | `		if( SySetUsed(&pVmFunc->aStatic) > 0 ){` |
...
|        - | 4589 | `		{` |
|   104693 | 4590 | `		VmCallArgMap *pCallMap3 = pEffCallMap;` |
|        - | 4591 | `		/* Caller file's strict_types mode — governs parameter coercion` |
|        - | 4592 | `		 * (but NOT return coercion, which uses the callee's file). */` |
|   104693 | 4593 | `		int bCallIsStrict = (pCallMap3 && pCallMap3->bStrict) ? 1 : 0;` |
|   104693 | 4594 | `		if( pCallMap3 && pCallMap3->bHasNamed ){` |
|        - | 4595 | `			/* ============================================================` |
...
|        - | 4980 | `		 * ============================================================ */` |
|   104425 | 4981 | `		n = 0;` |
|   264855 | 4982 | `		while( pArg < pTos ){` |
|   160735 | 4983 | `			if( n < SySetUsed(&pVmFunc->aArgs) && (aFormalArg[n].iFlags & VM_FUNC_ARG_VARIADIC) ){` |
...
|        - | 5083 | `			}` |
|   160535 | 5084 | `			if( n < SySetUsed(&pVmFunc->aArgs) ){` |
...
|   160029 | 5091 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_UNION ){` |
...
|   159942 | 5124 | `				if( aFormalArg[n].nType > 0` |
|    87202 | 5125 | `					&& !((aFormalArg[n].iFlags & VM_FUNC_ARG_NULLABLE) && (pArg->iFlags & MEMOBJ_NULL)) ){` |
...
|       13 | 5201 | `					}` |
|     6967 | 5202 | `				}` |
|   159931 | 5203 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_BY_REF ){` |
...
|   159691 | 5255 | `					pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|        - | 5256 | `				}` |
|    80171 | 5257 | `			}else{` |
|        - | 5258 | `				char zName[32];` |
...
|        - | 5265 | `			}` |
|   160435 | 5266 | `			if( pObj ){` |
|   160199 | 5267 | `				PH7_MemObjStore(pArg,pObj);` |
|        - | 5268 | `				/* Insert argument index  */` |
|   160199 | 5269 | `				sArg.nIdx = pObj->nIdx;` |
|   160199 | 5270 | `				sArg.pUserData = 0;` |
|   160199 | 5271 | `				SySetPut(&pFrame->sArg,(const void *)&sArg);` |
|    80301 | 5272 | `			}` |
|   160435 | 5273 | `			PH7_MemObjRelease(pArg);` |
|   160435 | 5274 | `			pArg++;` |
|   160435 | 5275 | `			++n;` |
|        5 | 5276 | `		}` |
|        - | 5277 | `		} /* end named vs positional branch */` |
|        - | 5278 | `		/* Set up closure environment */` |
|   104571 | 5279 | `		if( pVmFunc->iFlags & VM_FUNC_CLOSURE ){` |
...
|   104566 | 5327 | `		if( n < SySetUsed(&pVmFunc->aArgs)` |
|    54952 | 5328 | `		 && (pVmFunc->iFlags & (VM_FUNC_INTERNAL\|VM_FUNC_CLASS_METHOD)) != VM_FUNC_INTERNAL ){` |
|        - | 5329 | `			sxu32 nNonVar,nReq;` |
|     3879 | 5330 | `			nReq = VmFuncRequiredArgCount(pVmFunc,&nNonVar);` |
|     3879 | 5331 | `			if( n < nReq ){` |
...
|   112507 | 5351 | `		while( n < SySetUsed(&pVmFunc->aArgs) ){` |
|     8207 | 5352 | `			if( aFormalArg[n].iFlags & VM_FUNC_ARG_VARIADIC ){` |
...
|        - | 5363 | `			}` |
|     7963 | 5364 | `			if( SySetUsed(&aFormalArg[n].aByteCode) > 0 ){` |
|     7961 | 5365 | `				pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|     7961 | 5366 | `				if( pObj ){` |
|        - | 5367 | `					/* Evaluate the default value and extract it's result */` |
|     7961 | 5368 | `					rc = VmLocalExec(&(*pVm),&aFormalArg[n].aByteCode,pObj,FALSE);` |
|     7961 | 5369 | `					if( rc == PH7_ABORT ){` |
|      ! 0 | 5370 | `						goto Abort;` |
|        - | 5371 | `					}` |
|        - | 5372 | `					/* Insert argument index */` |
|     7961 | 5373 | `					sArg.nIdx = pObj->nIdx;` |
|     7961 | 5374 | `					sArg.pUserData = 0;` |
|     7961 | 5375 | `					SySetPut(&pFrame->sArg,(const void *)&sArg);` |
...
|     7956 | 5380 | `					if( aFormalArg[n].nType > 0 && aFormalArg[n].nType != MEMOBJ_OBJ` |
|     3890 | 5381 | `						&& ((pObj->iFlags & aFormalArg[n].nType) == 0)` |
|     1951 | 5382 | `						&& !((aFormalArg[n].iFlags & VM_FUNC_ARG_NULLABLE) && (pObj->iFlags & MEMOBJ_NULL)) ){` |
...
|        - | 5394 | `		 */` |
|   104549 | 5395 | `		PH7_MemObjRelease(pTos);` |
|   104549 | 5396 | `		pTos = &pTos[-nCallArgs];` |
...
|        - | 5408 | `		 * per function. */` |
|        - | 5409 | `		{` |
|   104549 | 5410 | `			sxu32 nSlots = pVmFunc->nMaxStack;` |
|   104549 | 5411 | `			if( nSlots == 0 ){` |
...
|     4118 | 5418 | `			}` |
|   104549 | 5419 | `			pFrameStack = VmOperandStackAlloc(&(*pVm),nSlots);` |
|        - | 5420 | `		}` |
|   104549 | 5421 | `		if( pFrameStack == 0 ){` |
...
|      ! 0 | 5428 | `			break;` |
|        - | 5429 | `		}` |
|    52170 | 5430 | `SkipFuncBody:` |
|   104683 | 5431 | `		if( pSelf ){` |
|        - | 5432 | `			/* Push class name */` |
|    25599 | 5433 | `			SySetPut(&pVm->aSelf,(const void *)&pSelf);` |
|    12797 | 5434 | `		}` |
|        - | 5435 | `		/* Increment nesting level */` |
|   104683 | 5436 | `		pVm->nRecursionDepth++;` |
|   104683 | 5437 | `		if( rc == PH7_EXCEPTION ){` |
...
|   104549 | 5466 | `			VmCallFrame *pRec = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   104549 | 5467 | `			if( pRec ){` |
|   101917 | 5468 | `				pVm->pIdleCallFrames = (void *)pRec->pPrev;` |
|    51063 | 5469 | `			}else{` |
|     2637 | 5470 | `				pRec = (VmCallFrame *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmCallFrame));` |
|        - | 5471 | `			}` |
|   104549 | 5472 | `			if( pRec == 0 ){` |
...
|      ! 0 | 5483 | `				goto Abort;` |
|        - | 5484 | `			}` |
|   104549 | 5485 | `			sState.pTos = pTos;` |
|   104549 | 5486 | `			sState.pc = pc;` |
|   104549 | 5487 | `			pRec->sCaller = sState;` |
|   104549 | 5488 | `			pRec->sCall.pVmFunc = pVmFunc;` |
|   104549 | 5489 | `			pRec->sCall.pFrame = pFrame;` |
|   104549 | 5490 | `			pRec->sCall.pFrameStack = pFrameStack;` |
|   104549 | 5491 | `			pRec->sCall.nStackCap = pVmFunc->nMaxStack + VM_STACK_GUARD;` |
|   104549 | 5492 | `			pRec->sCall.nLastRef = SXU32_HIGH;` |
|   104549 | 5493 | `			pRec->sCall.bSelfPushed = (sxu8)(pSelf ? 1 : 0);` |
|   104549 | 5494 | `			pRec->pPrev = pCallTop;` |
|   104549 | 5495 | `			pCallTop = pRec;` |
|        - | 5496 | `			/* Switch to the callee activation (what the recursive` |
|        - | 5497 | `			 * VmByteCodeExec entry used to set up). */` |
|   104549 | 5498 | `			aInstr = (VmInstr *)SySetBasePtr(&pVmFunc->aByteCode);` |
|   104549 | 5499 | `			pStack = pFrameStack;` |
|   104549 | 5500 | `			pTos = &pStack[-1];` |
|   104549 | 5501 | `			pc = 0;` |
|   104549 | 5502 | `			sState.aInstr = aInstr;` |
|   104549 | 5503 | `			sState.pStack = pStack;` |
|   104549 | 5504 | `			sState.nStackCap = pRec->sCall.nStackCap; /* callee's operand-stack capacity for OP_SPREAD growth */` |
|   104549 | 5505 | `			sState.nStackOrig = pRec->sCall.nStackCap; /* fixed headroom reference (never grows) */` |
|   104549 | 5506 | `			sState.pTos = pTos;` |
|   104549 | 5507 | `			sState.pc = 0;` |
|   104549 | 5508 | `			sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|   104549 | 5509 | `			sState.pEntryFrame = pVm->pFrame;` |
|   104549 | 5510 | `			sState.pResult = pRec->sCaller.pTos;` |
|   104549 | 5511 | `			sState.pLastRef = &pRec->sCall.nLastRef;` |
|   104549 | 5512 | `			sState.pEnforceRetFunc = VmFuncHasReturnType(pVmFunc) ? pVmFunc : 0;` |
|   104549 | 5513 | `			sState.is_callback = 0;` |
|   104549 | 5514 | `			sState.bReturnPropagates = 0;` |
|   104549 | 5515 | `			goto VmLoopFetch;` |
|        - | 5516 | `		}` |
|       57 | 5517 | `	}else{` |
...
|   933832 | 5526 | `		pEntry = SyHashGet(&pVm->hHostFunction,(const void *)sName.zString,sName.nByte);` |
|        - | 5527 | `		{` |
|   933832 | 5528 | `		VmCallArgMap *pCallMap2 = pEffCallMap;` |
|   933832 | 5529 | `		if( pEntry == 0 && pCallMap2 && pCallMap2->bIsNamespaced ){` |
...
|        - | 5634 | `			}` |
|        - | 5635 | `		}` |
|   933816 | 5636 | `		pFunc = (ph7_user_func *)pEntry->pUserData;` |
...
|  1401083 | 5641 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   933811 | 5642 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
|        - | 5643 | `		/* Start collecting function arguments */` |
|   933816 | 5644 | `		SySetReset(&aArg);` |
|  2523575 | 5645 | `		while( pArg < pTos ){` |
|  1589764 | 5646 | `			SySetPut(&aArg,(const void *)&pArg);` |
|  1589764 | 5647 | `			pArg++;` |
|        5 | 5648 | `		}` |
|        - | 5649 | `		/* Assume a null return value */` |
|   933816 | 5650 | `		PH7_MemObjInit(&(*pVm),&sRet);` |
|        - | 5651 | `		/* Init the call context */` |
|   933816 | 5652 | `		VmInitCallContext(&sCtx,&(*pVm),pFunc,&sRet,0);` |
...
|   933816 | 5659 | `		sCtx.pArgMap = pEffCallMap;` |
|        - | 5660 | `		{` |
|   933816 | 5661 | `		int nGiven = (int)SySetUsed(&aArg);` |
...
|   933816 | 5667 | `		if( pFunc->nMinArg > 0 && nGiven < pFunc->nMinArg ){` |
...
|      232 | 5674 | `				nGiven);` |
|   933584 | 5675 | `		}else if( pFunc->bHasMaxArg && nGiven > (int)pFunc->nMaxArg ){` |
...
|       40 | 5688 | `				nGiven);` |
|  1400307 | 5689 | `		}else if( SXRET_OK != (rc = VmEnforceBuiltinArgTypes(&sCtx,pFunc,nGiven,` |
|   933267 | 5690 | `			(ph7_value **)SySetBasePtr(&aArg))) ){` |
|        - | 5691 | `			/* TypeError thrown: rc carries the caught/uncaught status */` |
|       91 | 5692 | `		}else{` |
|        - | 5693 | `			/* Call the foreign function */` |
|   933100 | 5694 | `			rc = pFunc->xFunc(&sCtx,nGiven,(ph7_value **)SySetBasePtr(&aArg));` |
|        - | 5695 | `		}` |
|        - | 5696 | `		}` |
|        - | 5697 | `		/* Release the call context */` |
|   933816 | 5698 | `		VmReleaseCallContext(&sCtx);` |
|   933816 | 5699 | `		if( rc == PH7_ABORT ){` |
...
|      576 | 5704 | `			goto Abort;` |
|        - | 5705 | `		}` |
|   933244 | 5706 | `		if( rc != PH7_SUSPEND && pVm->pInlineInstr == (void *)aInstr ){` |
...
|      ! 0 | 5719 | `		}` |
|   933240 | 5720 | `		if( rc == PH7_EXCEPTION ){` |
...
|      983 | 5728 | `			if( !VmRecordedResume(pVm,&iResumePc,sState.pEntryFrame,aInstr) ){` |
...
|      784 | 5734 | `			PH7_MemObjRelease(&sRet);` |
|      784 | 5735 | `			if( nCallArgs > 0 ){` |
|      494 | 5736 | `				VmPopOperand(&pTos,nCallArgs); /* spread-adjusted; see the normal-return path */` |
|      245 | 5737 | `			}` |
|      784 | 5738 | `			VmPopOperand(&pTos,1);` |
|      784 | 5739 | `			pc = iResumePc;` |
|      784 | 5740 | `			break;` |
|        - | 5741 | `		}` |
|   932262 | 5742 | `		if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|   910882 | 5766 | `			VmPopOperand(&pTos,nCallArgs);` |
|   455800 | 5767 | `		}` |
|        - | 5768 | `		/* Save foreign function return value into the (now top) function-name slot */` |
|   931908 | 5769 | `		PH7_MemObjStore(&sRet,pTos);` |
|   931908 | 5770 | `		PH7_MemObjRelease(&sRet);` |
|        - | 5771 | `	}` |
|   932012 | 5772 | `	break;` |
|        - | 5773 | `				  }` |
|        - | 5774 | `/*` |
...
|        - | 5792 |  |
|        - | 5793 | `		} /* Switch() */` |
| 16437633 | 5794 | `		pc++; /* Next instruction in the stream */` |
|        5 | 5795 | `	} /* For(;;) */` |
|   128670 | 5796 | `Done:` |
...
|   257549 | 5800 | `	rc = SXRET_OK;` |
|   257549 | 5801 | `	goto Unwind;` |
|      823 | 5802 | `Suspend:` |
...
|   130672 | 5860 | `	for(;;){` |
|   261145 | 5861 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|      ! 0 | 5869 | `			}` |
|     1152 | 5870 | `		}` |
|   261145 | 5871 | `		if( pCallTop == 0 ){` |
|   157011 | 5872 | `			return VmExecFinalize(&(*pVm),&sState,&aArg,pTos,rc);` |
|        - | 5873 | `		}` |
|   104139 | 5874 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|      627 | 5880 | `		}` |
|        - | 5881 | `		{` |
|   104139 | 5882 | `			VmCallFrame *pRec = pCallTop;` |
|   104139 | 5883 | `			sState = pRec->sCaller;` |
|   104139 | 5884 | `			rc = VmCallFinish(&(*pVm),&sState,&pRec->sCall,rc);` |
|   104139 | 5885 | `			pCallTop = pRec->pPrev;` |
|   104139 | 5886 | `			pRec->pPrev = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   104139 | 5887 | `			pVm->pIdleCallFrames = (void *)pRec;` |
|   104139 | 5888 | `			aInstr = sState.aInstr;` |
|   104139 | 5889 | `			pStack = sState.pStack;` |
|   104139 | 5890 | `			pTos = sState.pTos;` |
|   104139 | 5891 | `			pc = sState.pc;` |
|        - | 5892 | `		}` |
|   104139 | 5893 | `		if( rc == PH7_OK ){` |
|   103373 | 5894 | `			pc++; /* the loop-bottom increment this OP_CALL missed */` |
|   103373 | 5895 | `			goto VmLoopFetch;` |
|        - | 5896 | `		}` |
|        5 | 5897 | `	}` |
|    78685 | 5898 | `}` |
|        - | 5899 |  |
