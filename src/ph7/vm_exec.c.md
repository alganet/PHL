...
|        - |  162 | ` */` |
|   157436 |  163 | `static sxi32 VmExecFinalize(ph7_vm *pVm,VmExecState *pState,SySet *pArg,ph7_value *pTos,sxi32 rcTerm)` |
|        5 |  164 | `{` |
|    78718 |  165 | `	SXUNUSED(pVm);` |
|   157441 |  166 | `	if( rcTerm != PH7_SUSPEND && !pState->bReturnPropagates ){` |
|   153827 |  167 | `		VmClearFrameReturn(pState->pEntryFrame);` |
|    76911 |  168 | `	}` |
|   157441 |  169 | `	SySetRelease(pArg);` |
|   157441 |  170 | `	if( rcTerm == PH7_ABORT \|\| rcTerm == PH7_EXCEPTION ){` |
|     2835 |  171 | `		while( pTos >= pState->pStack ){` |
|     1785 |  172 | `			PH7_MemObjRelease(pTos);` |
|     1785 |  173 | `			pTos--;` |
|        5 |  174 | `		}` |
|      525 |  175 | `	}` |
|   157441 |  176 | `	return rcTerm;` |
|        5 |  177 | `}` |
|        - |  178 | `/*` |
...
|        - |  189 | ` */` |
|   104265 |  190 | `static sxi32 VmCallFinish(ph7_vm *pVm,VmExecState *pCaller,VmCallRecord *pCallee,sxi32 rc)` |
|        5 |  191 | `{` |
|        - |  192 | `	ph7_value *pObj;` |
|        - |  193 | `	/* Decrement nesting level */` |
|   104270 |  194 | `	pVm->nRecursionDepth--;` |
|   104270 |  195 | `	if( pCallee->bSelfPushed ){` |
|        - |  196 | `		/* Pop class name */` |
|    25355 |  197 | `		(void)SySetPop(&pVm->aSelf);` |
|    12675 |  198 | `	}` |
|   104270 |  199 | `	if( (pCallee->pVmFunc->iFlags & VM_FUNC_REF_RETURN) && rc == SXRET_OK ){` |
...
|       25 |  225 | `	}` |
|   104270 |  226 | `	if( rc != PH7_ABORT && ((pCallee->pFrame->iFlags & VM_FRAME_THROW) \|\| rc == PH7_EXCEPTION) ){` |
...
|   104270 |  272 | `	if( rc != PH7_SUSPEND && pCallee->pFrameStack ){` |
...
|   104136 |  276 | `		VmOperandStackRecycle(pVm,pCallee->pFrameStack,pCallee->nStackCap);` |
|    52169 |  277 | `	}` |
|        - |  278 | `	/* Leave the frame */` |
|   104270 |  279 | `	VmLeaveFrame(&(*pVm));` |
|   104270 |  280 | `	if( rc == PH7_ABORT ){` |
|      336 |  281 | `		return PH7_ABORT;` |
|        - |  282 | `	}` |
|   103938 |  283 | `	if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|        - |  291 | `	}` |
|   103938 |  292 | `	if( rc == PH7_EXCEPTION ){` |
|      469 |  293 | `		return PH7_EXCEPTION;` |
|        - |  294 | `	}` |
|   103474 |  295 | `	return PH7_OK;` |
|    52241 |  296 | `}` |
|        - |  297 | `/*` |
...
|        - |  330 | ` * nesting.` |
|        - |  331 | ` */` |
|   157794 |  332 | `PH7_PRIVATE sxi32 VmByteCodeExec(` |
...
|   157799 |  352 | `	if( VmNativeNestingExceeded(pVm) ){` |
...
|   157795 |  362 | `	nSavedBrc = pVm->nBoundaryRc;` |
|   157795 |  363 | `	pVm->nBoundaryRc = 0;` |
...
|   157795 |  370 | `	nSavedLine = pVm->nCurLine;` |
|   157795 |  371 | `	pVm->nVmExecDepth++;` |
|   236690 |  372 | `	rc = VmByteCodeExecBody(&(*pVm),aInstr,pStack,nTos,pResult,pLastRef,is_callback,nPc,` |
|    78895 |  373 | `		pEnforceRetFunc,bReturnPropagates,pAdoptSegment,ppBaseOwner,pnBaseCap,nStackOrig);` |
|   157795 |  374 | `	pVm->nVmExecDepth--;` |
|   157795 |  375 | `	pVm->nCurLine = nSavedLine;` |
|   157795 |  376 | `	if( nSavedBrc != 0 && (nSavedBrc == PH7_ABORT \|\| pVm->nBoundaryRc == 0) ){` |
|       15 |  377 | `		pVm->nBoundaryRc = nSavedBrc;` |
|        6 |  378 | `	}` |
|   157795 |  379 | `	return rc;` |
|    78902 |  380 | `}` |
|   157790 |  381 | `static sxi32 VmByteCodeExecBody(` |
...
|        - |  399 | `	ph7_value *pTos;` |
|        - |  400 | `	SySet aArg;` |
|   157795 |  401 | `	VmCallFrame *pCallTop = 0; /* Top of this invocation's in-loop call-record` |
...
|        - |  409 | `	sxi32 pc;` |
|        - |  410 | `	sxi32 rc;` |
|   157795 |  411 | `	sState.aInstr = aInstr;` |
|   157795 |  412 | `	sState.pStack = pStack;` |
|   157795 |  413 | `	sState.nStackCap = pnBaseCap ? *pnBaseCap : 0; /* CURRENT capacity (grown on a coroutine resume) */` |
|   157795 |  414 | `	sState.nStackOrig = nStackOrig;                /* ORIGINAL capacity — fixed headroom reference */` |
|   157795 |  415 | `	sState.pResult = pResult;` |
|   157795 |  416 | `	sState.pLastRef = pLastRef;` |
|   157795 |  417 | `	sState.pEnforceRetFunc = pEnforceRetFunc;` |
|   157795 |  418 | `	sState.is_callback = (sxu8)(is_callback ? 1 : 0);` |
|   157795 |  419 | `	sState.bReturnPropagates = (sxu8)(bReturnPropagates ? 1 : 0);` |
|        - |  420 | `	/* Argument container */` |
|   157795 |  421 | `	SySetInit(&aArg,&pVm->sAllocator,sizeof(ph7_value *));` |
|   157795 |  422 | `	if( nTos < 0 ){` |
|   142103 |  423 | `		pTos = &pStack[-1];` |
|    71054 |  424 | `	}else{` |
|    15697 |  425 | `		pTos = &pStack[nTos];` |
|        - |  426 | `	}` |
|   157795 |  427 | `	sState.pTos = pTos;` |
|   157795 |  428 | `	sState.pc = nPc;` |
...
|   157790 |  446 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->pFrame == pVm->pFrame` |
|     2816 |  447 | `	 && pStack == pVm->pActiveCtx->pStack ){` |
|     1805 |  448 | `		sState.nExceptionBase = pVm->pActiveCtx->nExceptionBase;` |
|      905 |  449 | `	}else{` |
|   155995 |  450 | `		sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|        - |  451 | `	}` |
|   157795 |  452 | `	sState.pEntryFrame = pVm->pFrame;` |
|   157795 |  453 | `	pc = nPc;` |
...
|   157790 |  506 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->pInjected` |
...
|   157780 |  567 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->bClosing` |
...
| 16816920 |  603 | `		if( pVm->nBoundaryRc != 0 \|\| SySetUsed(&pVm->aHookRmw) > 0 ){` |
|      746 |  604 | `			if( pVm->nBoundaryRc != 0 ){` |
|      178 |  605 | `				sxi32 rcBr = pVm->nBoundaryRc;` |
|      178 |  606 | `				pVm->nBoundaryRc = 0;` |
|      178 |  607 | `				if( rcBr == PH7_ABORT ){` |
|       68 |  608 | `					goto Abort;` |
|        - |  609 | `				}` |
|      111 |  610 | `				if( pVm->pInlineInstr == (void *)aInstr ){` |
...
|        2 |  619 | `				}else{` |
|        - |  620 | `					sxi32 iBrPc;` |
|      109 |  621 | `					if( VmRecordedResume(pVm,&iBrPc,sState.pEntryFrame,aInstr) ){` |
...
| 16816834 |  658 | `		pInstr = &aInstr[pc];` |
| 16816834 |  659 | `		if( pInstr->nLine ){` |
...
| 16602929 |  663 | `			pVm->nCurLine = pInstr->nLine;` |
|  8307850 |  664 | `		}` |
| 16816834 |  665 | `		rc = SXRET_OK;` |
|        - |  666 | `/*` |
...
|        - |  672 | ` */` |
| 16816834 |  673 | `		switch(pInstr->iOp){` |
|        - |  674 | `/*` |
|        - |  675 | ` * DONE: P1 * *` |
|        - |  676 | ` *` |
...
|        - |  679 | ` */` |
|   128783 |  680 | `case PH7_OP_DONE:` |
|   257778 |  681 | `	if( pInstr->iP2 && sState.bReturnPropagates ){` |
...
|   257589 |  711 | `	if( sState.pEnforceRetFunc && VmFuncHasReturnType(sState.pEnforceRetFunc)` |
...
|     4591 |  736 | `	}` |
|   257570 |  737 | `	if( pInstr->iP1 && pTos >= pStack ){` |
|   152716 |  738 | `		if( sState.pLastRef ){` |
|    93886 |  739 | `			*sState.pLastRef = pTos->nIdx;` |
|    47044 |  740 | `		}` |
|   152716 |  741 | `		if( sState.pResult ){` |
|        - |  742 | `			/* Execution result */` |
|   145724 |  743 | `			PH7_MemObjStore(pTos,sState.pResult);` |
|    72963 |  744 | `		}` |
|   152716 |  745 | `		VmPopOperand(&pTos,1);` |
|   181318 |  746 | `	}else if( sState.pLastRef ){` |
...
|     8851 |  752 | `		*sState.pLastRef = SXU32_HIGH;` |
|     4423 |  753 | `	}` |
...
|        - |  762 | `	 */` |
|   257570 |  763 | `	rc = VmDrainFinally(&(*pVm),sState.nExceptionBase);` |
|   257570 |  764 | `	if( rc == SXERR_ABORT ){` |
|      ! 0 |  765 | `		goto Abort;` |
|        - |  766 | `	}` |
|   257570 |  767 | `	if( rc == PH7_EXCEPTION ){` |
...
|        - |  778 | `	}` |
|   257566 |  779 | `	if( sState.pEntryFrame->bHasRet && !sState.bReturnPropagates ){` |
...
|        - |  835 | ` */` |
|   288713 |  836 | `case PH7_OP_JMP:` |
|   577638 |  837 | `	pc = pInstr->iP2 - 1;` |
|   577638 |  838 | `	break;` |
|        - |  839 | `/*` |
|        - |  840 | ` * JZ: P1 P2 *` |
|        - |  841 | ` *` |
...
|  1605957 |  852 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     1003 |  853 | `		PH7_MemObjToBool(pTos);` |
|      500 |  854 | `	}` |
|  1605957 |  855 | `	if( !pTos->x.iVal ){` |
|        - |  856 | `		/* Take the jump */` |
|   900150 |  857 | `		pc = pInstr->iP2 - 1;` |
|   450335 |  858 | `	}` |
|  1605957 |  859 | `	if( !pInstr->iP1 ){` |
|  1357531 |  860 | `		VmPopOperand(&pTos,1);` |
|   679336 |  861 | `	}` |
|  1605957 |  862 | `	break;` |
|        - |  863 | `/*` |
|        - |  864 | ` * JNZ: P1 P2 *` |
...
|   184454 |  876 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      ! 0 |  877 | `		PH7_MemObjToBool(pTos);` |
|      ! 0 |  878 | `	}` |
|   184454 |  879 | `	if( pTos->x.iVal ){` |
|        - |  880 | `		/* Take the jump */` |
|     9555 |  881 | `		pc = pInstr->iP2 - 1;` |
|     4775 |  882 | `	}` |
|   184454 |  883 | `	if( !pInstr->iP1 ){` |
...
|        - |  899 | ` */` |
|   662244 |  900 | `case PH7_OP_POP: {` |
|  1325528 |  901 | `	sxi32 n = pInstr->iP1;` |
|  1325528 |  902 | `	if( &pTos[-n+1] < pStack ){` |
|        - |  903 | `		/* TICKET 1433-51 Stack underflow must be handled at run-time */` |
|       79 |  904 | `		n = (sxi32)(pTos - pStack);` |
|       38 |  905 | `	}` |
|  1325528 |  906 | `	VmPopOperand(&pTos,n);` |
|  1325528 |  907 | `	break;` |
|        - |  908 | `				 }` |
|        - |  909 | `/*` |
|        - |  910 | ` * DUP: * * *` |
...
|        - |  929 | ` */` |
|    49228 |  930 | `case PH7_OP_NSSWITCH:` |
|    98461 |  931 | `	SyBlobReset(&pVm->sNamespace);` |
|    98461 |  932 | `	if( pInstr->p3 ){` |
|     4017 |  933 | `		const char *zNs = (const char *)pInstr->p3;` |
|     4017 |  934 | `		SyBlobAppend(&pVm->sNamespace,zNs,SyStrlen(zNs));` |
|     2006 |  935 | `	}` |
|        - |  936 | `	/* Clear namespace-scoped use-const imports */` |
|    98461 |  937 | `	SyHashRelease(&pVm->hUseConstImports);` |
|    98461 |  938 | `	SyHashInit(&pVm->hUseConstImports,&pVm->sAllocator,0,0);` |
|    98461 |  939 | `	break;` |
...
|     2449 |  998 | `		PH7_MemObjToString(pTos);` |
|     1222 |  999 | `	}` |
|     5465 | 1000 | `	break;` |
|        - | 1001 | `/*` |
|        - | 1002 | ` * CVT_BOOL: * * *` |
...
|       37 | 1049 | `	rc = PH7_MemObjToHashmap(pTos);` |
|       37 | 1050 | `	if( rc != SXRET_OK ){` |
...
|     6791 | 1089 | `	break;` |
|        - | 1090 | `					  }` |
|    37747 | 1091 | `case PH7_OP_ERR_CTRL:` |
|        - | 1092 | `	/*` |
...
|        - | 1101 | `	 */` |
|    75499 | 1102 | `	if( pInstr->iP1 ){` |
|    37753 | 1103 | `		pVm->nErrSuppress++;` |
|    56625 | 1104 | `	}else if( pVm->nErrSuppress > 0 ){` |
|    37751 | 1105 | `		pVm->nErrSuppress--;` |
|    18873 | 1106 | `	}` |
|    75499 | 1107 | `	break;` |
|        - | 1108 | `/*` |
|        - | 1109 | ` * IS_A * * *` |
...
|        - | 1163 | ` */` |
|  1511607 | 1164 | `case PH7_OP_LOADC: {` |
|        - | 1165 | `	ph7_value *pObj;` |
|        - | 1166 | `	/* Reserve a room */` |
|  3025097 | 1167 | `	pTos++;` |
|  3025097 | 1168 | `	if( pInstr->iP1 & PH7_LOADC_NOKEY ){` |
|        - | 1169 | `		/* Absent array-literal key: mark it so LOAD_MAP auto-indexes without a diagnostic */` |
|    19089 | 1170 | `		MemObjSetType(pTos,MEMOBJ_NULL);` |
|    19089 | 1171 | `		SyBlobReset(&pTos->sBlob);` |
|    19089 | 1172 | `		pTos->iFlags \|= MEMOBJ_AUX_NOKEY;` |
|    19089 | 1173 | `		pTos->nIdx = SXU32_HIGH;` |
|    19089 | 1174 | `		break;` |
|        - | 1175 | `	}` |
|  3006013 | 1176 | `	if( (pObj = (ph7_value *)SySetAt(&pVm->aLitObj,pInstr->iP2)) != 0 ){` |
|  3006013 | 1177 | `		if( (pInstr->iP1 & PH7_LOADC_EXPAND) && SyBlobLength(&pObj->sBlob) <= 64 ){` |
|        - | 1178 | `			SyHashEntry *pEntry;` |
|        - | 1179 | `			/* Check use const imports first — imports take precedence */` |
|        - | 1180 | `			{` |
|        - | 1181 | `				SyHashEntry *pConstImport;` |
|    34781 | 1182 | `				pConstImport = SyHashGet(&pVm->hUseConstImports,` |
|    23184 | 1183 | `					SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|    23189 | 1184 | `				if( pConstImport ){` |
...
|    23179 | 1199 | `			pEntry = SyHashGet(&pVm->hConstant,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|    23179 | 1200 | `			if( pEntry ){` |
|    23169 | 1201 | `				ph7_constant *pCons = (ph7_constant *)pEntry->pUserData;` |
|        - | 1202 | `				/* Set a NULL default value */` |
|    23169 | 1203 | `				MemObjSetType(pTos,MEMOBJ_NULL);` |
|    23169 | 1204 | `				SyBlobReset(&pTos->sBlob);` |
|        - | 1205 | `				/* Invoke the callback and deal with the expanded value */` |
|    23169 | 1206 | `				VmExpandConstantWithNotice(&(*pVm),pCons,pTos);` |
|        - | 1207 | `				/* Mark as constant */` |
|    23169 | 1208 | `				pTos->nIdx = SXU32_HIGH;` |
|    23169 | 1209 | `				break;` |
|        - | 1210 | `			}` |
...
|        - | 1283 | ` */` |
|  2197247 | 1284 | `case PH7_OP_LOAD:{` |
|        - | 1285 | `	ph7_value *pObj;` |
|        - | 1286 | `	SyString sName;` |
|  4398447 | 1287 | `	if( pInstr->p3 == 0 ){` |
...
|        9 | 1299 | `	}else{` |
|  4398431 | 1300 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1301 | `		/* Reserve a room for the target object */` |
|  4398431 | 1302 | `		pTos++;` |
|        - | 1303 | `	}` |
|  4398447 | 1304 | `	if( pInstr->iP2 == 2 ){` |
...
|   393432 | 1310 | `		if( VmExtractMemObj(&(*pVm),&sName,FALSE,FALSE) == 0 ){` |
|        7 | 1311 | `			VmErrorFormat(&(*pVm),PH7_CTX_WARNING,"Undefined variable $%z",&sName);` |
|        3 | 1312 | `		}` |
|   196817 | 1313 | `	}` |
|        - | 1314 | `	/* Extract the requested memory object */` |
|  4398447 | 1315 | `	pObj = VmExtractMemObj(&(*pVm),&sName,pInstr->p3 ? FALSE : TRUE,pInstr->iP1 != 1);` |
|  4398447 | 1316 | `	if( pObj == 0 ){` |
...
|  4398385 | 1341 | `	PH7_MemObjLoad(pObj,pTos);` |
|  4398385 | 1342 | `	pTos->nIdx = pObj->nIdx;` |
|  4398385 | 1343 | `	break;` |
|        - | 1344 | `				   }` |
|        - | 1345 | `/*` |
|        - | 1346 | ` * LOAD_MAP P1 * *` |
...
|        - | 1351 | ` */` |
|    36870 | 1352 | `case PH7_OP_LOAD_MAP: {` |
|        - | 1353 | `	VmOpRc rcOp;` |
|    73745 | 1354 | `	sState.pTos = pTos;` |
|    73745 | 1355 | `	sState.pc = pc;` |
|    73745 | 1356 | `	rcOp = VmExecOpLoadMap(&(*pVm),&sState,pInstr);` |
|    73745 | 1357 | `	pTos = sState.pTos;` |
|    73745 | 1358 | `	pc = sState.pc;` |
|    73745 | 1359 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1360 | `		goto Abort;` |
|    73745 | 1361 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1394 | ` * instead.` |
|        - | 1395 | ` */` |
|   332352 | 1396 | `case PH7_OP_LOAD_IDX: {` |
|        - | 1397 | `	VmOpRc rcOp;` |
|   665441 | 1398 | `	sState.pTos = pTos;` |
|   665441 | 1399 | `	sState.pc = pc;` |
|   665441 | 1400 | `	rcOp = VmExecOpLoadIdx(&(*pVm),&sState,pInstr);` |
|   665441 | 1401 | `	pTos = sState.pTos;` |
|   665441 | 1402 | `	pc = sState.pc;` |
|   665441 | 1403 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1404 | `		goto Abort;` |
|   665441 | 1405 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1415 | ` */` |
|      573 | 1416 | `case PH7_OP_LOAD_CLOSURE: {` |
|        - | 1417 | `	VmOpRc rcOp;` |
|     1151 | 1418 | `	sState.pTos = pTos;` |
|     1151 | 1419 | `	sState.pc = pc;` |
|     1151 | 1420 | `	rcOp = VmExecOpLoadClosure(&(*pVm),&sState,pInstr);` |
|     1151 | 1421 | `	pTos = sState.pTos;` |
|     1151 | 1422 | `	pc = sState.pc;` |
|     1151 | 1423 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1424 | `		goto Abort;` |
|     1151 | 1425 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1507 | `	}` |
|        - | 1508 | `#endif` |
|   595435 | 1509 | `	if( pInstr->iP2 ){` |
|        - | 1510 | `		sxu32 nIdx;` |
|        - | 1511 | `		sxi32 rcT;` |
|        - | 1512 | `		/* Member store operation */` |
|    11721 | 1513 | `		nIdx = pTos->nIdx;` |
|    11721 | 1514 | `		VmPopOperand(&pTos,1);` |
|    11721 | 1515 | `		if( pVm->pMagicSetThis ){` |
...
|       11 | 1528 | `			break;` |
|        - | 1529 | `		}` |
|    11711 | 1530 | `		if( pVm->pHookSetThis ){` |
...
|    11679 | 1558 | `			rcT = VmEnforcePropertyTypeOnStore(&(*pVm),nIdx,pTos,0);` |
|    11679 | 1559 | `			if( rcT == PH7_ABORT ){` |
|       13 | 1560 | `				goto Abort;` |
|        - | 1561 | `			}` |
|    11669 | 1562 | `			if( rcT == PH7_EXCEPTION ){` |
...
|    11601 | 1577 | `			pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|    11601 | 1578 | `			if( pObj ){` |
|        - | 1579 | `				/* Perform the store operation */` |
|    11601 | 1580 | `				PH7_MemObjStore(pTos,pObj);` |
|     5798 | 1581 | `			}` |
|        - | 1582 | `		}` |
|    11603 | 1583 | `		break;` |
|   583719 | 1584 | `	}else if( pInstr->p3 == 0 ){` |
...
|        - | 1596 | `#endif` |
|        5 | 1597 | `	}else{` |
|   583711 | 1598 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1599 | `	}` |
|   583714 | 1600 | `	if( sName.nByte == sizeof("GLOBALS")-1` |
|   293636 | 1601 | `	 && SyMemcmp((const void *)sName.zString,(const void *)"GLOBALS",sName.nByte) == 0 ){` |
|        6 | 1602 | `		if( pInstr->p3 ){` |
...
|        - | 1639 | ` */` |
|   120414 | 1640 | `case PH7_OP_STORE_IDX:` |
|        - | 1641 | `case PH7_OP_STORE_IDX_REF: {` |
|        - | 1642 | `	VmOpRc rcOp;` |
|   240833 | 1643 | `	sState.pTos = pTos;` |
|   240833 | 1644 | `	sState.pc = pc;` |
|   240833 | 1645 | `	rcOp = VmExecOpStoreIdxRef(&(*pVm),&sState,pInstr);` |
|   240833 | 1646 | `	pTos = sState.pTos;` |
|   240833 | 1647 | `	pc = sState.pc;` |
|   240833 | 1648 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 1649 | `		goto Abort;` |
|   240831 | 1650 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|   367454 | 1671 | `	PH7_ENFORCE_READONLY_MUTATE(pTos->nIdx);` |
...
|   367443 | 1676 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) != 0` |
|   183831 | 1677 | `	 && SySetUsed(&pVm->aHookRmw) > 0 ){` |
...
|        - | 1694 | `		}` |
|      ! 0 | 1695 | `	}` |
|   367446 | 1696 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) == 0 ){` |
|   367446 | 1697 | `		if( pTos->nIdx != SXU32_HIGH ){` |
|        - | 1698 | `			ph7_value *pObj;` |
|   367446 | 1699 | `			if( (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pTos->nIdx)) != 0 ){` |
|   367446 | 1700 | `				if( VmStringWantsPerlIncr(pObj) ){` |
...
|   367444 | 1719 | `					if( pInstr->iP1 == 0 && (pTos->iFlags & MEMOBJ_STRING) ){` |
|        9 | 1720 | `						SyBlobNullAppend(&pTos->sBlob);` |
|        3 | 1721 | `					}` |
|        - | 1722 | `					/* Force a numeric cast on the variable */` |
|   367444 | 1723 | `					PH7_MemObjToNumeric(pObj);` |
|   367444 | 1724 | `					if( pObj->iFlags & MEMOBJ_REAL ){` |
|        5 | 1725 | `						pObj->rVal++;` |
...
|        - | 1734 | `						sxi64 r;` |
|   367440 | 1735 | `						if( PH7_ADD_OVERFLOW64(pObj->x.iVal,1,&r) ){` |
...
|        - | 1741 | `#endif` |
|        3 | 1742 | `						}else{` |
|   367436 | 1743 | `							pObj->x.iVal = r;` |
|        - | 1744 | `						}` |
|        - | 1745 | `					}` |
|   367444 | 1746 | `					if( pInstr->iP1 ){` |
...
|        - | 1785 | `		}` |
|   183823 | 1786 | `	}` |
|   367444 | 1787 | `	PH7_HOOK_RMW_WRITEBACK(pTos->nIdx,pTos);` |
|   367444 | 1788 | `	break;` |
|        - | 1789 | `/*` |
|        - | 1790 | ` * DECR: P1 * *` |
|        - | 1791 | ` *` |
...
|      208 | 1806 | `	PH7_ENFORCE_READONLY_MUTATE(pTos->nIdx);` |
...
|    70651 | 1938 | `	PH7_MemObjToNumeric(pTos);` |
|    70651 | 1939 | `	if( pTos->iFlags & MEMOBJ_REAL ){` |
|      108 | 1940 | `		pTos->rVal = -pTos->rVal;` |
|       53 | 1941 | `	}` |
|    70651 | 1942 | `	if( pTos->iFlags & MEMOBJ_INT ){` |
|    70565 | 1943 | `		if( pTos->x.iVal == SMALLEST_INT64 ){` |
...
|        - | 1958 | `#endif` |
|        3 | 1959 | `		}else{` |
|    70561 | 1960 | `			pTos->x.iVal = -pTos->x.iVal;` |
|        - | 1961 | `		}` |
|    35280 | 1962 | `	}` |
|    70651 | 1963 | `	break;` |
|        - | 1964 | `/*` |
...
|    50957 | 1997 | `	if( (pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      119 | 1998 | `		PH7_MemObjToBool(pTos);` |
|       57 | 1999 | `	}` |
|    50957 | 2000 | `	pTos->x.iVal = !pTos->x.iVal;` |
|    50957 | 2001 | `	break;` |
|        - | 2002 | `/*` |
|        - | 2003 | ` * OP_BITNOT: * * *` |
|        - | 2004 | ` *` |
...
|        - | 2030 | `	VmOpRc rcOp;` |
|     2872 | 2031 | `	sState.pTos = pTos;` |
|     2872 | 2032 | `	sState.pc = pc;` |
|     2872 | 2033 | `	rcOp = VmExecOpMulStore(&(*pVm),&sState,pInstr);` |
|     2872 | 2034 | `	pTos = sState.pTos;` |
|     2872 | 2035 | `	pc = sState.pc;` |
|     2872 | 2036 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2037 | `		goto Abort;` |
|     2872 | 2038 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2070 | ` */` |
|     6370 | 2071 | `case PH7_OP_ADD:{` |
|    12745 | 2072 | `	ph7_value *pNos = &pTos[-1];` |
|        - | 2073 | `#ifdef UNTRUST` |
|        - | 2074 | `	if( pNos < pStack ){` |
|        - | 2075 | `		goto Abort;` |
|        - | 2076 | `	}` |
...
|        - | 2082 | `		SyBlob sArMsg;` |
|    12745 | 2083 | `		SyBlobInit(&sArMsg,&pVm->sAllocator);` |
|    12745 | 2084 | `		if( VmArithOperandCheck(&(*pVm),pNos,pTos,"+",&sArMsg) != SXRET_OK ){` |
|        - | 2085 | `			sxi32 rcAr;` |
...
|        - | 2096 | `		}` |
|    12737 | 2097 | `		SyBlobRelease(&sArMsg);` |
|        - | 2098 | `	}` |
|        - | 2099 | `	/* Perform the addition */` |
|    12737 | 2100 | `	PH7_MemObjAdd(pNos,pTos,FALSE);` |
|    12737 | 2101 | `	VmPopOperand(&pTos,1);` |
|    12737 | 2102 | `	break;` |
|        - | 2103 | `				}` |
|        - | 2104 | `/*` |
|        - | 2105 | ` * OP_ADD_STORE * * *` |
...
|      925 | 2364 | `	ph7_value *pNos = &pTos[-1];` |
|        - | 2365 | `	sxi64 a,b,r;` |
|        - | 2366 | `#ifdef UNTRUST` |
|        - | 2367 | `	if( pNos < pStack ){` |
|        - | 2368 | `		goto Abort;` |
...
|      925 | 2372 | `	rc = VmRejectFloatOperand(&(*pVm),pNos);` |
|      925 | 2373 | `	PH7_DISPATCH_ENFORCE_RC(rc)` |
|      925 | 2374 | `	rc = VmRejectFloatOperand(&(*pVm),pTos);` |
|      925 | 2375 | `	PH7_DISPATCH_ENFORCE_RC(rc)` |
|      925 | 2376 | `	if( (pTos->iFlags & MEMOBJ_INT) == 0 ){` |
|      ! 0 | 2377 | `		PH7_MemObjToInteger(pTos);` |
|      ! 0 | 2378 | `	}` |
|      925 | 2379 | `	if( (pNos->iFlags & MEMOBJ_INT) == 0 ){` |
|      ! 0 | 2380 | `		PH7_MemObjToInteger(pNos);` |
|      ! 0 | 2381 | `	}` |
|        - | 2382 | `	/* Perform the requested operation */` |
|      925 | 2383 | `	a = pNos->x.iVal;` |
|      925 | 2384 | `	b = pTos->x.iVal;` |
|      925 | 2385 | `	switch(pInstr->iOp){` |
...
|      827 | 2392 | `	default:          r = a&b; break;` |
|        - | 2393 | `	}` |
|        - | 2394 | `	/* Push the result */` |
|      925 | 2395 | `	pNos->x.iVal = r;` |
|      925 | 2396 | `	MemObjSetType(pNos,MEMOBJ_INT);` |
|      925 | 2397 | `	VmPopOperand(&pTos,1);` |
|      925 | 2398 | `	break;` |
|        - | 2399 | `				 }` |
|        - | 2400 | `/* OP_BAND_STORE * * *` |
|        - | 2401 | ` *` |
...
|        - | 2526 | ` * back.` |
|        - | 2527 | ` */` |
|    86482 | 2528 | `case PH7_OP_CAT:{` |
|        - | 2529 | `	ph7_value *pNos,*pCur;` |
|   172969 | 2530 | `	if( pInstr->iP1 < 1 ){` |
|   144745 | 2531 | `		pNos = &pTos[-1];` |
|    72375 | 2532 | `	}else{` |
|    28229 | 2533 | `		pNos = &pTos[-pInstr->iP1+1];` |
|        - | 2534 | `	}` |
|        - | 2535 | `#ifdef UNTRUST` |
|        - | 2536 | `	if( pNos < pStack ){` |
|        - | 2537 | `		goto Abort;` |
...
|   172969 | 2541 | `	if( (pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|     1929 | 2542 | `		PH7_MemObjToString(pNos);` |
|      962 | 2543 | `	}` |
|   172969 | 2544 | `	pCur = &pNos[1];` |
|   349325 | 2545 | `	while( pCur <= pTos ){` |
|   176361 | 2546 | `		if( (pCur->iFlags & MEMOBJ_STRING) == 0 ){` |
|    52223 | 2547 | `			PH7_MemObjToString(pCur);` |
|    26109 | 2548 | `		}` |
|        - | 2549 | `		/* Perform the concatenation */` |
|   176361 | 2550 | `		if( SyBlobLength(&pCur->sBlob) > 0 ){` |
|   176215 | 2551 | `			if( PH7_MemObjStringAppend(pNos,(const char *)SyBlobData(&pCur->sBlob),SyBlobLength(&pCur->sBlob)) != SXRET_OK ){` |
|        - | 2552 | `				/* Allocation failure: raise a fatal instead of a truncated concat */` |
|      ! 0 | 2553 | `				PH7_VmMemoryError(&(*pVm));` |
|      ! 0 | 2554 | `				goto Abort;` |
|        - | 2555 | `			}` |
|    88105 | 2556 | `		}` |
|   176361 | 2557 | `		SyBlobRelease(&pCur->sBlob);` |
|   176361 | 2558 | `		pCur++;` |
|        5 | 2559 | `	}` |
|   172969 | 2560 | `	pTos = pNos;` |
|   172969 | 2561 | `	break;` |
|        - | 2562 | `				}` |
|        - | 2563 | `/*  CAT_STORE: * * *` |
|        - | 2564 | ` *` |
...
|        - | 2566 | ` * back.` |
|        - | 2567 | ` */` |
|    11840 | 2568 | `case PH7_OP_CAT_STORE:{` |
|    23685 | 2569 | `	ph7_value *pNos = &pTos[-1];` |
|        - | 2570 | `	ph7_value *pObj;` |
|        - | 2571 | `	sxu32 nIdx;` |
|        - | 2572 | `#ifdef UNTRUST` |
|        - | 2573 | `	if( pNos < pStack ){` |
...
|    23685 | 2578 | `	if((pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|       59 | 2579 | `		PH7_MemObjToString(pNos);` |
|       29 | 2580 | `	}` |
|    23685 | 2581 | `	nIdx = pTos->nIdx;` |
...
|    23680 | 2593 | `	if( nIdx != SXU32_HIGH` |
|    23680 | 2594 | `	 && nIdx != pNos->nIdx` |
|    23676 | 2595 | `	 && (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx)) != 0` |
|    23677 | 2596 | `	 && (SyHashTotalEntry(&pVm->hTypedSlot) == 0` |
|    14436 | 2597 | `	     \|\| SyHashGet(&pVm->hTypedSlot,(const void *)&nIdx,sizeof(sxu32)) == 0) ){` |
|    23671 | 2598 | `		if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - | 2599 | `			/* e.g. $x = 5; $x .= "a";  ->  "5a" */` |
|        6 | 2600 | `			PH7_MemObjToString(pObj);` |
|        2 | 2601 | `		}` |
|    23671 | 2602 | `		if( SyBlobLength(&pNos->sBlob) > 0 ){` |
|    23667 | 2603 | `			if( PH7_MemObjStringAppend(pObj,(const char *)SyBlobData(&pNos->sBlob),SyBlobLength(&pNos->sBlob)) != SXRET_OK ){` |
...
|    23671 | 2622 | `		if( (pInstr+1)->iOp != PH7_OP_POP ){` |
...
|    23671 | 2627 | `		PH7_HOOK_RMW_WRITEBACK(nIdx,0);` |
|    23671 | 2628 | `		pNos->nIdx = SXU32_HIGH;` |
|    23671 | 2629 | `		VmPopOperand(&pTos,1);` |
|    23678 | 2630 | `		break;` |
|        - | 2631 | `	}` |
...
|        - | 2668 | ` * stack.` |
|        - | 2669 | ` */` |
|   114223 | 2670 | `case PH7_OP_LAND:` |
|        - | 2671 | `case PH7_OP_LOR: {` |
|        - | 2672 | `	VmOpRc rcOp;` |
|   228658 | 2673 | `	sState.pTos = pTos;` |
|   228658 | 2674 | `	sState.pc = pc;` |
|   228658 | 2675 | `	rcOp = VmExecOpLor(&(*pVm),&sState,pInstr);` |
|   228658 | 2676 | `	pTos = sState.pTos;` |
|   228658 | 2677 | `	pc = sState.pc;` |
|   228658 | 2678 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2679 | `		goto Abort;` |
|   228658 | 2680 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2895 | ` */` |
|     5439 | 2896 | `case PH7_OP_EQ:` |
|        - | 2897 | `case PH7_OP_NEQ: {` |
|        - | 2898 | `	VmOpRc rcOp;` |
|    10883 | 2899 | `	sState.pTos = pTos;` |
|    10883 | 2900 | `	sState.pc = pc;` |
|    10883 | 2901 | `	rcOp = VmExecOpNeq(&(*pVm),&sState,pInstr);` |
|    10883 | 2902 | `	pTos = sState.pTos;` |
|    10883 | 2903 | `	pc = sState.pc;` |
|    10883 | 2904 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2905 | `		goto Abort;` |
|    10883 | 2906 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2917 | ` */` |
|   228335 | 2918 | `case PH7_OP_TEQ: {` |
|        - | 2919 | `	VmOpRc rcOp;` |
|   456882 | 2920 | `	sState.pTos = pTos;` |
|   456882 | 2921 | `	sState.pc = pc;` |
|   456882 | 2922 | `	rcOp = VmExecOpTeq(&(*pVm),&sState,pInstr);` |
|   456882 | 2923 | `	pTos = sState.pTos;` |
|   456882 | 2924 | `	pc = sState.pc;` |
|   456882 | 2925 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2926 | `		goto Abort;` |
|   456882 | 2927 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2939 | ` *` |
|        - | 2940 | ` */` |
|   174629 | 2941 | `case PH7_OP_TNE: {` |
|        - | 2942 | `	VmOpRc rcOp;` |
|   349470 | 2943 | `	sState.pTos = pTos;` |
|   349470 | 2944 | `	sState.pc = pc;` |
|   349470 | 2945 | `	rcOp = VmExecOpTne(&(*pVm),&sState,pInstr);` |
|   349470 | 2946 | `	pTos = sState.pTos;` |
|   349470 | 2947 | `	pc = sState.pc;` |
|   349470 | 2948 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2949 | `		goto Abort;` |
|   349470 | 2950 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2971 | ` *` |
|        - | 2972 | ` */` |
|   145885 | 2973 | `case PH7_OP_LT:` |
|        - | 2974 | `case PH7_OP_LE: {` |
|        - | 2975 | `	VmOpRc rcOp;` |
|   292189 | 2976 | `	sState.pTos = pTos;` |
|   292189 | 2977 | `	sState.pc = pc;` |
|   292189 | 2978 | `	rcOp = VmExecOpLe(&(*pVm),&sState,pInstr);` |
|   292189 | 2979 | `	pTos = sState.pTos;` |
|   292189 | 2980 | `	pc = sState.pc;` |
|   292189 | 2981 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2982 | `		goto Abort;` |
|   292189 | 2983 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3004 | ` *` |
|        - | 3005 | ` */` |
|    86044 | 3006 | `case PH7_OP_GT:` |
|        - | 3007 | `case PH7_OP_GE: {` |
|        - | 3008 | `	VmOpRc rcOp;` |
|   172300 | 3009 | `	sState.pTos = pTos;` |
|   172300 | 3010 | `	sState.pc = pc;` |
|   172300 | 3011 | `	rcOp = VmExecOpGe(&(*pVm),&sState,pInstr);` |
|   172300 | 3012 | `	pTos = sState.pTos;` |
|   172300 | 3013 | `	pc = sState.pc;` |
|   172300 | 3014 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 3015 | `		goto Abort;` |
|   172300 | 3016 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3390 | ` */` |
|    12012 | 3391 | `case PH7_OP_FOREACH_INIT: {` |
|        - | 3392 | `	VmOpRc rcOp;` |
|    24029 | 3393 | `	sState.pTos = pTos;` |
|    24029 | 3394 | `	sState.pc = pc;` |
|    24029 | 3395 | `	rcOp = VmExecOpForeachInit(&(*pVm),&sState,pInstr);` |
|    24029 | 3396 | `	pTos = sState.pTos;` |
|    24029 | 3397 | `	pc = sState.pc;` |
|    24029 | 3398 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 3399 | `		goto Abort;` |
|    24029 | 3400 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3408 | ` */` |
|   130238 | 3409 | `case PH7_OP_FOREACH_STEP: {` |
|        - | 3410 | `	VmOpRc rcOp;` |
|   260481 | 3411 | `	sState.pTos = pTos;` |
|   260481 | 3412 | `	sState.pc = pc;` |
|   260481 | 3413 | `	rcOp = VmExecOpForeachStep(&(*pVm),&sState,pInstr);` |
|   260481 | 3414 | `	pTos = sState.pTos;` |
|   260481 | 3415 | `	pc = sState.pc;` |
|   260481 | 3416 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 3417 | `		goto Abort;` |
|   260479 | 3418 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3426 | ` */` |
|    22359 | 3427 | `case PH7_OP_MEMBER: {` |
|        - | 3428 | `	VmOpRc rcOp;` |
|    44723 | 3429 | `	sState.pTos = pTos;` |
|    44723 | 3430 | `	sState.pc = pc;` |
|    44723 | 3431 | `	rcOp = VmExecOpMember(&(*pVm),&sState,pInstr);` |
|    44723 | 3432 | `	pTos = sState.pTos;` |
|    44723 | 3433 | `	pc = sState.pc;` |
|    44723 | 3434 | `	if( rcOp == VM_OP_ABORT ){` |
|        8 | 3435 | `		goto Abort;` |
|    44717 | 3436 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3444 | ` */` |
|     2390 | 3445 | `case PH7_OP_NEW: {` |
|        - | 3446 | `	VmOpRc rcOp;` |
|     4785 | 3447 | `	sState.pTos = pTos;` |
|     4785 | 3448 | `	sState.pc = pc;` |
|     4785 | 3449 | `	rcOp = VmExecOpNew(&(*pVm),&sState,pInstr);` |
|     4785 | 3450 | `	pTos = sState.pTos;` |
|     4785 | 3451 | `	pc = sState.pc;` |
|     4785 | 3452 | `	if( rcOp == VM_OP_ABORT ){` |
|        5 | 3453 | `		goto Abort;` |
|     4781 | 3454 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|  1039438 | 3831 | `	sxi32 nCallArgs = pInstr->iP1 + (pInstr->iP2 ? VmSpreadOwnExtra(pVm,pInstr->iP1,pTos) : 0);` |
|        - | 3832 | `	ph7_value *pArg;` |
|  1039438 | 3833 | `	pArg = &pTos[-nCallArgs];` |
...
|  1039438 | 3842 | `	VmCallArgMap *pEffCallMap = (VmCallArgMap *)pInstr->p3;` |
...
|  1039438 | 3849 | `	if( VmValueIsClosure(pVm,pTos) ){` |
...
|  1039438 | 3859 | `	if( (pTos->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|      142 | 4054 | `		break;` |
|        - | 4055 | `	}` |
|  1039278 | 4056 | `	SyStringInitFromBuf(&sName,SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
...
|  1039278 | 4060 | `	if( sName.nByte > 0 && sName.zString[0] == '\\' ){` |
...
|  1039278 | 4067 | `	pEntry = SyHashGet(&pVm->hFunction,(const void *)sName.zString,sName.nByte);` |
...
|        - | 4073 | `	{` |
|  1039278 | 4074 | `	VmCallArgMap *pCallMap = pEffCallMap;` |
|  1039278 | 4075 | `	if( pEntry == 0 && pCallMap && pCallMap->bIsNamespaced ){` |
...
|        - | 4106 | `		VmSlot sArg;` |
|        - | 4107 | `		sxu32 n;` |
|   105032 | 4108 | `		int bClosureThis = 0;` |
|   105032 | 4109 | `		ph7_class *pClosureScope = 0;` |
|        - | 4110 | `		/* initialize fields */` |
|   105032 | 4111 | `		pVmFunc = (ph7_vm_func *)pEntry->pUserData;` |
|   105032 | 4112 | `		pThis = 0;` |
|   105032 | 4113 | `		pSelf = 0;` |
...
|       14 | 4128 | `		}` |
|   105032 | 4129 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
|        - | 4130 | `			ph7_class_method *pMeth;` |
|        - | 4131 | `			/* Class method call */` |
|    25511 | 4132 | `			ph7_value *pTarget = &pTos[-1];` |
|    25511 | 4133 | `			if( pTarget >= pStack && (pTarget->iFlags & (MEMOBJ_STRING\|MEMOBJ_OBJ\|MEMOBJ_NULL)) ){` |
|        - | 4134 | `				/* Extract the 'this' pointer */` |
|    25511 | 4135 | `				if(pTarget->iFlags & MEMOBJ_OBJ ){` |
|        - | 4136 | `					/* Instance already loaded */` |
|    24475 | 4137 | `					pThis = (ph7_class_instance *)pTarget->x.pOther;` |
|    24475 | 4138 | `					pThis->iRef++;` |
|    24475 | 4139 | `					pSelf = pThis->pClass;` |
|    12235 | 4140 | `				}` |
|    25511 | 4141 | `				if( pSelf == 0 ){` |
...
|      353 | 4160 | `					}` |
|      518 | 4161 | `				}` |
|    25511 | 4162 | `				VmPopOperand(&pTos,1);` |
|    25511 | 4163 | `				PH7_MemObjRelease(pTos);` |
...
|    25511 | 4170 | `				nCallArgs = pInstr->iP1 + (pInstr->iP2 ? VmSpreadOwnExtra(&(*pVm),pInstr->iP1,pTos) : 0);` |
|    25511 | 4171 | `				pArg = &pTos[-nCallArgs];` |
...
|        - | 4176 | `				 */` |
|    25511 | 4177 | `				while( pArg < pStack ){` |
|      ! 0 | 4178 | `					pArg++;` |
|      ! 0 | 4179 | `				}` |
|    25511 | 4180 | `				if( pSelf && pVm->bReflectBypass ){` |
...
|        6 | 4185 | `				}else` |
|    25501 | 4186 | `				if( pSelf ){ /* Paranoid edition */` |
...
|    25501 | 4194 | `					ph7_class *pDeclClass = pVmFunc->pUserData ? (ph7_class *)pVmFunc->pUserData : pSelf;` |
|    25501 | 4195 | `					pMeth = PH7_ClassExtractMethod(pDeclClass,pVmFunc->sName.zString,pVmFunc->sName.nByte);` |
|    25501 | 4196 | `					if( pMeth == 0 && pDeclClass != pSelf ){` |
|      ! 0 | 4197 | `						pMeth = PH7_ClassExtractMethod(pSelf,pVmFunc->sName.zString,pVmFunc->sName.nByte);` |
|      ! 0 | 4198 | `					}` |
|    25501 | 4199 | `					if( pMeth && pMeth->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
|     2605 | 4200 | `						if( !PH7_VmClassMemberAccess(&(*pVm),pDeclClass,&pVmFunc->sName,pMeth->iProtection,FALSE) ){` |
...
|   157649 | 4236 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   105027 | 4237 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
...
|   105032 | 4244 | `		if( VmRecursionExceeded(pVm) ){` |
...
|        3 | 4248 | `			goto Abort;` |
|        - | 4249 | `		}` |
|   105030 | 4250 | `		if( pVmFunc->pNextName ){` |
|        - | 4251 | `			/* Function is candidate for overloading,select the appropriate function to call */` |
|      245 | 4252 | `			pVmFunc = VmOverload(&(*pVm),pVmFunc,pArg,(int)(pTos-pArg));` |
|      121 | 4253 | `		}` |
...
|   105030 | 4262 | `		pSelfHint = pSelf;` |
|   105030 | 4263 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
|    25511 | 4264 | `			ph7_class *pDecl = (ph7_class *)pVmFunc->pUserData;` |
|    25511 | 4265 | `			if( pDecl && (pDecl->iFlags & PH7_CLASS_TRAIT) == 0 ){` |
|    24485 | 4266 | `				pSelfHint = pDecl;` |
|    12240 | 4267 | `			}` |
|    12753 | 4268 | `		}` |
|   105030 | 4269 | `		if( pSelf == 0 && (pVmFunc->iFlags & VM_FUNC_CLOSURE) ){` |
...
|     1779 | 4276 | `			if( pClosureScope ){` |
|       29 | 4277 | `				pSelf = pClosureScope;` |
|     1765 | 4278 | `			}else if( pVmFunc->pLsbClass ){` |
|       61 | 4279 | `				pSelf = (ph7_class *)pVmFunc->pLsbClass;` |
|       29 | 4280 | `			}` |
|      887 | 4281 | `		}` |
|   105030 | 4282 | `		if( SySetUsed(&pVmFunc->aAttrs) > 0 ){` |
...
|       56 | 4287 | `		}` |
|   105030 | 4288 | `		if( pVmFunc->iFlags & VM_FUNC_GENERATOR ){` |
...
|   104690 | 4520 | `		aFormalArg = (ph7_vm_func_arg *)SySetBasePtr(&pVmFunc->aArgs);` |
|        - | 4521 | `		/* Create a new VM frame  */` |
|   104690 | 4522 | `		rc = VmEnterFrame(&(*pVm),pVmFunc,pThis,&pFrame);` |
|   104690 | 4523 | `		if( rc != SXRET_OK ){` |
...
|   104690 | 4551 | `		pFrame->nActualArgs = (int)(pTos - pArg);` |
|   104690 | 4552 | `		if( pThis && ((pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) \|\| bClosureThis) ){` |
...
|    24659 | 4555 | `			pObj = VmExtractMemObj(&(*pVm),&sThis,FALSE,TRUE);` |
|    24659 | 4556 | `			if( pObj ){` |
|        - | 4557 | `				/* Reflect the change */` |
|    24659 | 4558 | `				pObj->x.pOther = pThis;` |
|    24659 | 4559 | `				MemObjSetType(pObj,MEMOBJ_OBJ);` |
|    12327 | 4560 | `			}` |
|    12327 | 4561 | `		}` |
|   104690 | 4562 | `		if( SySetUsed(&pVmFunc->aStatic) > 0 ){` |
...
|        - | 4589 | `		{` |
|   104690 | 4590 | `		VmCallArgMap *pCallMap3 = pEffCallMap;` |
|        - | 4591 | `		/* Caller file's strict_types mode — governs parameter coercion` |
|        - | 4592 | `		 * (but NOT return coercion, which uses the callee's file). */` |
|   104690 | 4593 | `		int bCallIsStrict = (pCallMap3 && pCallMap3->bStrict) ? 1 : 0;` |
|   104690 | 4594 | `		if( pCallMap3 && pCallMap3->bHasNamed ){` |
|        - | 4595 | `			/* ============================================================` |
...
|        - | 4980 | `		 * ============================================================ */` |
|   104422 | 4981 | `		n = 0;` |
|   264918 | 4982 | `		while( pArg < pTos ){` |
|   160801 | 4983 | `			if( n < SySetUsed(&pVmFunc->aArgs) && (aFormalArg[n].iFlags & VM_FUNC_ARG_VARIADIC) ){` |
...
|        - | 5083 | `			}` |
|   160601 | 5084 | `			if( n < SySetUsed(&pVmFunc->aArgs) ){` |
...
|   160095 | 5091 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_UNION ){` |
...
|   160008 | 5124 | `				if( aFormalArg[n].nType > 0` |
|    87238 | 5125 | `					&& !((aFormalArg[n].iFlags & VM_FUNC_ARG_NULLABLE) && (pArg->iFlags & MEMOBJ_NULL)) ){` |
...
|       13 | 5201 | `					}` |
|     6967 | 5202 | `				}` |
|   159997 | 5203 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_BY_REF ){` |
...
|   159757 | 5255 | `					pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|        - | 5256 | `				}` |
|    80207 | 5257 | `			}else{` |
|        - | 5258 | `				char zName[32];` |
|        - | 5259 | `				SyString sArgName;` |
|        - | 5260 | `				/* Set a dummy name */` |
|      510 | 5261 | `				sArgName.nByte = SyBufferFormat(zName,sizeof(zName),"[%u]apArg",n);` |
|      510 | 5262 | `				sArgName.zString = zName;` |
|        - | 5263 | `				/* Annonymous argument */` |
|      510 | 5264 | `				pObj = VmExtractMemObj(&(*pVm),&sArgName,TRUE,TRUE);` |
|        - | 5265 | `			}` |
|   160501 | 5266 | `			if( pObj ){` |
|   160265 | 5267 | `				PH7_MemObjStore(pArg,pObj);` |
|        - | 5268 | `				/* Insert argument index  */` |
|   160265 | 5269 | `				sArg.nIdx = pObj->nIdx;` |
|   160265 | 5270 | `				sArg.pUserData = 0;` |
|   160265 | 5271 | `				SySetPut(&pFrame->sArg,(const void *)&sArg);` |
|    80337 | 5272 | `			}` |
|   160501 | 5273 | `			PH7_MemObjRelease(pArg);` |
|   160501 | 5274 | `			pArg++;` |
|   160501 | 5275 | `			++n;` |
|        5 | 5276 | `		}` |
|        - | 5277 | `		} /* end named vs positional branch */` |
|        - | 5278 | `		/* Set up closure environment */` |
|   104568 | 5279 | `		if( pVmFunc->iFlags & VM_FUNC_CLOSURE ){` |
|        - | 5280 | `			ph7_vm_func_closure_env *aEnv,*pEnv;` |
|        - | 5281 | `			ph7_value *pValue;` |
|        - | 5282 | `			sxu32 iEnv;` |
|     1761 | 5283 | `			aEnv = (ph7_vm_func_closure_env *)SySetBasePtr(&pVmFunc->aClosureEnv);` |
|     3823 | 5284 | `			for(iEnv = 0 ; iEnv < SySetUsed(&pVmFunc->aClosureEnv) ; ++iEnv ){` |
|     2067 | 5285 | `				pEnv = &aEnv[iEnv];` |
|     2067 | 5286 | `				if( (pEnv->iFlags & VM_FUNC_ARG_IGNORE) && (pEnv->sValue.iFlags & MEMOBJ_NULL) ){` |
...
|   104563 | 5327 | `		if( n < SySetUsed(&pVmFunc->aArgs)` |
|    54943 | 5328 | `		 && (pVmFunc->iFlags & (VM_FUNC_INTERNAL\|VM_FUNC_CLASS_METHOD)) != VM_FUNC_INTERNAL ){` |
|        - | 5329 | `			sxu32 nNonVar,nReq;` |
|     3861 | 5330 | `			nReq = VmFuncRequiredArgCount(pVmFunc,&nNonVar);` |
|     3861 | 5331 | `			if( n < nReq ){` |
...
|   112468 | 5351 | `		while( n < SySetUsed(&pVmFunc->aArgs) ){` |
|     8171 | 5352 | `			if( aFormalArg[n].iFlags & VM_FUNC_ARG_VARIADIC ){` |
...
|        - | 5363 | `			}` |
|     7927 | 5364 | `			if( SySetUsed(&aFormalArg[n].aByteCode) > 0 ){` |
|     7925 | 5365 | `				pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|     7925 | 5366 | `				if( pObj ){` |
|        - | 5367 | `					/* Evaluate the default value and extract it's result */` |
|     7925 | 5368 | `					rc = VmLocalExec(&(*pVm),&aFormalArg[n].aByteCode,pObj,FALSE);` |
|     7925 | 5369 | `					if( rc == PH7_ABORT ){` |
|      ! 0 | 5370 | `						goto Abort;` |
|        - | 5371 | `					}` |
|        - | 5372 | `					/* Insert argument index */` |
|     7925 | 5373 | `					sArg.nIdx = pObj->nIdx;` |
|     7925 | 5374 | `					sArg.pUserData = 0;` |
|     7925 | 5375 | `					SySetPut(&pFrame->sArg,(const void *)&sArg);` |
...
|     7920 | 5380 | `					if( aFormalArg[n].nType > 0 && aFormalArg[n].nType != MEMOBJ_OBJ` |
...
|        - | 5394 | `		 */` |
|   104546 | 5395 | `		PH7_MemObjRelease(pTos);` |
|   104546 | 5396 | `		pTos = &pTos[-nCallArgs];` |
...
|        - | 5408 | `		 * per function. */` |
|        - | 5409 | `		{` |
|   104546 | 5410 | `			sxu32 nSlots = pVmFunc->nMaxStack;` |
|   104546 | 5411 | `			if( nSlots == 0 ){` |
|     8233 | 5412 | `				sxu32 nInstr = SySetUsed(&pVmFunc->aByteCode);` |
|    12347 | 5413 | `				sxu32 nTight = VmComputeMaxStack(&(*pVm),` |
|     8228 | 5414 | `					(VmInstr *)SySetBasePtr(&pVmFunc->aByteCode),nInstr);` |
|     8233 | 5415 | `				nSlots = ( nTight == VM_STACK_UNMODELED ) ? nInstr : nTight;` |
|     8233 | 5416 | `				if( nSlots == 0 ){ nSlots = 1; } /* a 0-depth body still needs a valid, nonzero cache marker */` |
|     8233 | 5417 | `				pVmFunc->nMaxStack = nSlots;` |
|     4114 | 5418 | `			}` |
|   104546 | 5419 | `			pFrameStack = VmOperandStackAlloc(&(*pVm),nSlots);` |
|        - | 5420 | `		}` |
|   104546 | 5421 | `		if( pFrameStack == 0 ){` |
...
|      ! 0 | 5428 | `			break;` |
|        - | 5429 | `		}` |
|    52167 | 5430 | `SkipFuncBody:` |
|   104680 | 5431 | `		if( pSelf ){` |
|        - | 5432 | `			/* Push class name */` |
|    25565 | 5433 | `			SySetPut(&pVm->aSelf,(const void *)&pSelf);` |
|    12780 | 5434 | `		}` |
|        - | 5435 | `		/* Increment nesting level */` |
|   104680 | 5436 | `		pVm->nRecursionDepth++;` |
|   104680 | 5437 | `		if( rc == PH7_EXCEPTION ){` |
...
|   104546 | 5466 | `			VmCallFrame *pRec = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   104546 | 5467 | `			if( pRec ){` |
|   101918 | 5468 | `				pVm->pIdleCallFrames = (void *)pRec->pPrev;` |
|    51065 | 5469 | `			}else{` |
|     2633 | 5470 | `				pRec = (VmCallFrame *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmCallFrame));` |
|        - | 5471 | `			}` |
|   104546 | 5472 | `			if( pRec == 0 ){` |
...
|      ! 0 | 5483 | `				goto Abort;` |
|        - | 5484 | `			}` |
|   104546 | 5485 | `			sState.pTos = pTos;` |
|   104546 | 5486 | `			sState.pc = pc;` |
|   104546 | 5487 | `			pRec->sCaller = sState;` |
|   104546 | 5488 | `			pRec->sCall.pVmFunc = pVmFunc;` |
|   104546 | 5489 | `			pRec->sCall.pFrame = pFrame;` |
|   104546 | 5490 | `			pRec->sCall.pFrameStack = pFrameStack;` |
|   104546 | 5491 | `			pRec->sCall.nStackCap = pVmFunc->nMaxStack + VM_STACK_GUARD;` |
|   104546 | 5492 | `			pRec->sCall.nLastRef = SXU32_HIGH;` |
|   104546 | 5493 | `			pRec->sCall.bSelfPushed = (sxu8)(pSelf ? 1 : 0);` |
|   104546 | 5494 | `			pRec->pPrev = pCallTop;` |
|   104546 | 5495 | `			pCallTop = pRec;` |
|        - | 5496 | `			/* Switch to the callee activation (what the recursive` |
|        - | 5497 | `			 * VmByteCodeExec entry used to set up). */` |
|   104546 | 5498 | `			aInstr = (VmInstr *)SySetBasePtr(&pVmFunc->aByteCode);` |
|   104546 | 5499 | `			pStack = pFrameStack;` |
|   104546 | 5500 | `			pTos = &pStack[-1];` |
|   104546 | 5501 | `			pc = 0;` |
|   104546 | 5502 | `			sState.aInstr = aInstr;` |
|   104546 | 5503 | `			sState.pStack = pStack;` |
|   104546 | 5504 | `			sState.nStackCap = pRec->sCall.nStackCap; /* callee's operand-stack capacity for OP_SPREAD growth */` |
|   104546 | 5505 | `			sState.nStackOrig = pRec->sCall.nStackCap; /* fixed headroom reference (never grows) */` |
|   104546 | 5506 | `			sState.pTos = pTos;` |
|   104546 | 5507 | `			sState.pc = 0;` |
|   104546 | 5508 | `			sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|   104546 | 5509 | `			sState.pEntryFrame = pVm->pFrame;` |
|   104546 | 5510 | `			sState.pResult = pRec->sCaller.pTos;` |
|   104546 | 5511 | `			sState.pLastRef = &pRec->sCall.nLastRef;` |
|   104546 | 5512 | `			sState.pEnforceRetFunc = VmFuncHasReturnType(pVmFunc) ? pVmFunc : 0;` |
|   104546 | 5513 | `			sState.is_callback = 0;` |
|   104546 | 5514 | `			sState.bReturnPropagates = 0;` |
|   104546 | 5515 | `			goto VmLoopFetch;` |
|        - | 5516 | `		}` |
|       57 | 5517 | `	}else{` |
...
|   934251 | 5526 | `		pEntry = SyHashGet(&pVm->hHostFunction,(const void *)sName.zString,sName.nByte);` |
|        - | 5527 | `		{` |
|   934251 | 5528 | `		VmCallArgMap *pCallMap2 = pEffCallMap;` |
|   934251 | 5529 | `		if( pEntry == 0 && pCallMap2 && pCallMap2->bIsNamespaced ){` |
...
|        - | 5634 | `			}` |
|        - | 5635 | `		}` |
|   934235 | 5636 | `		pFunc = (ph7_user_func *)pEntry->pUserData;` |
...
|  1401716 | 5641 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   934230 | 5642 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
|        - | 5643 | `		/* Start collecting function arguments */` |
|   934235 | 5644 | `		SySetReset(&aArg);` |
|  2524576 | 5645 | `		while( pArg < pTos ){` |
|  1590346 | 5646 | `			SySetPut(&aArg,(const void *)&pArg);` |
|  1590346 | 5647 | `			pArg++;` |
|        5 | 5648 | `		}` |
|        - | 5649 | `		/* Assume a null return value */` |
|   934235 | 5650 | `		PH7_MemObjInit(&(*pVm),&sRet);` |
|        - | 5651 | `		/* Init the call context */` |
|   934235 | 5652 | `		VmInitCallContext(&sCtx,&(*pVm),pFunc,&sRet,0);` |
...
|   934235 | 5659 | `		sCtx.pArgMap = pEffCallMap;` |
|        - | 5660 | `		{` |
|   934235 | 5661 | `		int nGiven = (int)SySetUsed(&aArg);` |
...
|   934235 | 5667 | `		if( pFunc->nMinArg > 0 && nGiven < pFunc->nMinArg ){` |
...
|      232 | 5674 | `				nGiven);` |
|  1401252 | 5675 | `		}else if( SXRET_OK != (rc = VmEnforceBuiltinArgTypes(&sCtx,pFunc,nGiven,` |
|   933766 | 5676 | `			(ph7_value **)SySetBasePtr(&aArg))) ){` |
|        - | 5677 | `			/* TypeError thrown: rc carries the caught/uncaught status */` |
|       91 | 5678 | `		}else{` |
|        - | 5679 | `			/* Call the foreign function */` |
|   933599 | 5680 | `			rc = pFunc->xFunc(&sCtx,nGiven,(ph7_value **)SySetBasePtr(&aArg));` |
|        - | 5681 | `		}` |
|        - | 5682 | `		}` |
|        - | 5683 | `		/* Release the call context */` |
|   934235 | 5684 | `		VmReleaseCallContext(&sCtx);` |
|   934235 | 5685 | `		if( rc == PH7_ABORT ){` |
...
|      576 | 5690 | `			goto Abort;` |
|        - | 5691 | `		}` |
|   933663 | 5692 | `		if( rc != PH7_SUSPEND && pVm->pInlineInstr == (void *)aInstr ){` |
...
|      ! 0 | 5705 | `		}` |
|   933659 | 5706 | `		if( rc == PH7_EXCEPTION ){` |
...
|      770 | 5720 | `			PH7_MemObjRelease(&sRet);` |
|      770 | 5721 | `			if( nCallArgs > 0 ){` |
|      484 | 5722 | `				VmPopOperand(&pTos,nCallArgs); /* spread-adjusted; see the normal-return path */` |
|      240 | 5723 | `			}` |
|      770 | 5724 | `			VmPopOperand(&pTos,1);` |
|      770 | 5725 | `			pc = iResumePc;` |
|      770 | 5726 | `			break;` |
|        - | 5727 | `		}` |
|   932697 | 5728 | `		if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|   911281 | 5752 | `			VmPopOperand(&pTos,nCallArgs);` |
|   456004 | 5753 | `		}` |
|        - | 5754 | `		/* Save foreign function return value into the (now top) function-name slot */` |
|   932343 | 5755 | `		PH7_MemObjStore(&sRet,pTos);` |
|   932343 | 5756 | `		PH7_MemObjRelease(&sRet);` |
|        - | 5757 | `	}` |
|   932447 | 5758 | `	break;` |
|        - | 5759 | `				  }` |
|        - | 5760 | `/*` |
...
|        - | 5763 | ` */` |
|    25557 | 5764 | `case PH7_OP_CONSUME: {` |
|        - | 5765 | `	VmOpRc rcOp;` |
|    51119 | 5766 | `	sState.pTos = pTos;` |
|    51119 | 5767 | `	sState.pc = pc;` |
|    51119 | 5768 | `	rcOp = VmExecOpConsume(&(*pVm),&sState,pInstr);` |
|    51119 | 5769 | `	pTos = sState.pTos;` |
|    51119 | 5770 | `	pc = sState.pc;` |
|    51119 | 5771 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 5772 | `		goto Abort;` |
|    51119 | 5773 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 5778 |  |
|        - | 5779 | `		} /* Switch() */` |
| 16451252 | 5780 | `		pc++; /* Next instruction in the stream */` |
|        5 | 5781 | `	} /* For(;;) */` |
|   128883 | 5782 | `Done:` |
...
|   257978 | 5786 | `	rc = SXRET_OK;` |
|   257978 | 5787 | `	goto Unwind;` |
|      823 | 5788 | `Suspend:` |
...
|   130887 | 5846 | `	for(;;){` |
|   261572 | 5847 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|      ! 0 | 5855 | `			}` |
|     1151 | 5856 | `		}` |
|   261572 | 5857 | `		if( pCallTop == 0 ){` |
|   157441 | 5858 | `			return VmExecFinalize(&(*pVm),&sState,&aArg,pTos,rc);` |
|        - | 5859 | `		}` |
|   104136 | 5860 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|      626 | 5866 | `		}` |
|        - | 5867 | `		{` |
|   104136 | 5868 | `			VmCallFrame *pRec = pCallTop;` |
|   104136 | 5869 | `			sState = pRec->sCaller;` |
|   104136 | 5870 | `			rc = VmCallFinish(&(*pVm),&sState,&pRec->sCall,rc);` |
|   104136 | 5871 | `			pCallTop = pRec->pPrev;` |
|   104136 | 5872 | `			pRec->pPrev = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   104136 | 5873 | `			pVm->pIdleCallFrames = (void *)pRec;` |
|   104136 | 5874 | `			aInstr = sState.aInstr;` |
|   104136 | 5875 | `			pStack = sState.pStack;` |
|   104136 | 5876 | `			pTos = sState.pTos;` |
|   104136 | 5877 | `			pc = sState.pc;` |
|        - | 5878 | `		}` |
|   104136 | 5879 | `		if( rc == PH7_OK ){` |
|   103370 | 5880 | `			pc++; /* the loop-bottom increment this OP_CALL missed */` |
|   103370 | 5881 | `			goto VmLoopFetch;` |
|        - | 5882 | `		}` |
|        5 | 5883 | `	}` |
|    78900 | 5884 | `}` |
|        - | 5885 |  |
