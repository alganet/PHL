...
|   153453 |  167 | `		VmClearFrameReturn(pState->pEntryFrame);` |
|    76724 |  168 | `	}` |
...
|        - |  189 | ` */` |
|   104198 |  190 | `static sxi32 VmCallFinish(ph7_vm *pVm,VmExecState *pCaller,VmCallRecord *pCallee,sxi32 rc)` |
|        5 |  191 | `{` |
|        - |  192 | `	ph7_value *pObj;` |
|        - |  193 | `	/* Decrement nesting level */` |
|   104203 |  194 | `	pVm->nRecursionDepth--;` |
|   104203 |  195 | `	if( pCallee->bSelfPushed ){` |
|        - |  196 | `		/* Pop class name */` |
|    25341 |  197 | `		(void)SySetPop(&pVm->aSelf);` |
|    12668 |  198 | `	}` |
|   104203 |  199 | `	if( (pCallee->pVmFunc->iFlags & VM_FUNC_REF_RETURN) && rc == SXRET_OK ){` |
...
|       25 |  225 | `	}` |
|   104203 |  226 | `	if( rc != PH7_ABORT && ((pCallee->pFrame->iFlags & VM_FRAME_THROW) \|\| rc == PH7_EXCEPTION) ){` |
...
|   104203 |  272 | `	if( rc != PH7_SUSPEND && pCallee->pFrameStack ){` |
...
|   104069 |  276 | `		VmOperandStackRecycle(pVm,pCallee->pFrameStack,pCallee->nStackCap);` |
|    52134 |  277 | `	}` |
|        - |  278 | `	/* Leave the frame */` |
|   104203 |  279 | `	VmLeaveFrame(&(*pVm));` |
|   104203 |  280 | `	if( rc == PH7_ABORT ){` |
|      336 |  281 | `		return PH7_ABORT;` |
|        - |  282 | `	}` |
|   103871 |  283 | `	if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|        - |  291 | `	}` |
|   103871 |  292 | `	if( rc == PH7_EXCEPTION ){` |
|      469 |  293 | `		return PH7_EXCEPTION;` |
|        - |  294 | `	}` |
|   103407 |  295 | `	return PH7_OK;` |
|    52206 |  296 | `}` |
|        - |  297 | `/*` |
...
| 16800397 |  603 | `		if( pVm->nBoundaryRc != 0 \|\| SySetUsed(&pVm->aHookRmw) > 0 ){` |
...
| 16800311 |  658 | `		pInstr = &aInstr[pc];` |
| 16800311 |  659 | `		if( pInstr->nLine ){` |
...
| 16586760 |  663 | `			pVm->nCurLine = pInstr->nLine;` |
|  8299674 |  664 | `		}` |
| 16800311 |  665 | `		rc = SXRET_OK;` |
|        - |  666 | `/*` |
...
|        - |  672 | ` */` |
| 16800311 |  673 | `		switch(pInstr->iOp){` |
|        - |  674 | `/*` |
|        - |  675 | ` * DONE: P1 * *` |
|        - |  676 | ` *` |
...
|        - |  679 | ` */` |
|   128564 |  680 | `case PH7_OP_DONE:` |
|   257337 |  681 | `	if( pInstr->iP2 && sState.bReturnPropagates ){` |
...
|   257148 |  711 | `	if( sState.pEnforceRetFunc && VmFuncHasReturnType(sState.pEnforceRetFunc)` |
...
|     4588 |  736 | `	}` |
|   257129 |  737 | `	if( pInstr->iP1 && pTos >= pStack ){` |
|   152453 |  738 | `		if( sState.pLastRef ){` |
|    93823 |  739 | `			*sState.pLastRef = pTos->nIdx;` |
|    47011 |  740 | `		}` |
|   152453 |  741 | `		if( sState.pResult ){` |
|        - |  742 | `			/* Execution result */` |
|   145463 |  743 | `			PH7_MemObjStore(pTos,sState.pResult);` |
|    72831 |  744 | `		}` |
|   152453 |  745 | `		VmPopOperand(&pTos,1);` |
|   181007 |  746 | `	}else if( sState.pLastRef ){` |
...
|        - |  762 | `	 */` |
|   257129 |  763 | `	rc = VmDrainFinally(&(*pVm),sState.nExceptionBase);` |
|   257129 |  764 | `	if( rc == SXERR_ABORT ){` |
|      ! 0 |  765 | `		goto Abort;` |
|        - |  766 | `	}` |
|   257129 |  767 | `	if( rc == PH7_EXCEPTION ){` |
...
|        - |  778 | `	}` |
|   257125 |  779 | `	if( sState.pEntryFrame->bHasRet && !sState.bReturnPropagates ){` |
...
|        - |  835 | ` */` |
|   288366 |  836 | `case PH7_OP_JMP:` |
|   576941 |  837 | `	pc = pInstr->iP2 - 1;` |
|   576941 |  838 | `	break;` |
|        - |  839 | `/*` |
|        - |  840 | ` * JZ: P1 P2 *` |
|        - |  841 | ` *` |
...
|  1604216 |  852 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     1003 |  853 | `		PH7_MemObjToBool(pTos);` |
|      500 |  854 | `	}` |
|  1604216 |  855 | `	if( !pTos->x.iVal ){` |
|        - |  856 | `		/* Take the jump */` |
|   899072 |  857 | `		pc = pInstr->iP2 - 1;` |
|   449793 |  858 | `	}` |
|  1604216 |  859 | `	if( !pInstr->iP1 ){` |
|  1356264 |  860 | `		VmPopOperand(&pTos,1);` |
|   678695 |  861 | `	}` |
|  1604216 |  862 | `	break;` |
|        - |  863 | `/*` |
|        - |  864 | ` * JNZ: P1 P2 *` |
...
|   184441 |  876 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      ! 0 |  877 | `		PH7_MemObjToBool(pTos);` |
|      ! 0 |  878 | `	}` |
|   184441 |  879 | `	if( pTos->x.iVal ){` |
|        - |  880 | `		/* Take the jump */` |
|     9547 |  881 | `		pc = pInstr->iP2 - 1;` |
|     4771 |  882 | `	}` |
|   184441 |  883 | `	if( !pInstr->iP1 ){` |
...
|        - |  899 | ` */` |
|   661679 |  900 | `case PH7_OP_POP: {` |
|  1324383 |  901 | `	sxi32 n = pInstr->iP1;` |
|  1324383 |  902 | `	if( &pTos[-n+1] < pStack ){` |
|        - |  903 | `		/* TICKET 1433-51 Stack underflow must be handled at run-time */` |
|       79 |  904 | `		n = (sxi32)(pTos - pStack);` |
|       38 |  905 | `	}` |
|  1324383 |  906 | `	VmPopOperand(&pTos,n);` |
|  1324383 |  907 | `	break;` |
|        - |  908 | `				 }` |
|        - |  909 | `/*` |
|        - |  910 | ` * DUP: * * *` |
...
|        - |  929 | ` */` |
|    49137 |  930 | `case PH7_OP_NSSWITCH:` |
|    98279 |  931 | `	SyBlobReset(&pVm->sNamespace);` |
|    98279 |  932 | `	if( pInstr->p3 ){` |
|     4009 |  933 | `		const char *zNs = (const char *)pInstr->p3;` |
|     4009 |  934 | `		SyBlobAppend(&pVm->sNamespace,zNs,SyStrlen(zNs));` |
|     2002 |  935 | `	}` |
|        - |  936 | `	/* Clear namespace-scoped use-const imports */` |
|    98279 |  937 | `	SyHashRelease(&pVm->hUseConstImports);` |
|    98279 |  938 | `	SyHashInit(&pVm->hUseConstImports,&pVm->sAllocator,0,0);` |
|    98279 |  939 | `	break;` |
...
|     6789 | 1089 | `	break;` |
|        - | 1090 | `					  }` |
|    37707 | 1091 | `case PH7_OP_ERR_CTRL:` |
|        - | 1092 | `	/*` |
...
|        - | 1101 | `	 */` |
|    75419 | 1102 | `	if( pInstr->iP1 ){` |
|    37713 | 1103 | `		pVm->nErrSuppress++;` |
|    56565 | 1104 | `	}else if( pVm->nErrSuppress > 0 ){` |
|    37711 | 1105 | `		pVm->nErrSuppress--;` |
|    18853 | 1106 | `	}` |
|    75419 | 1107 | `	break;` |
|        - | 1108 | `/*` |
|        - | 1109 | ` * IS_A * * *` |
...
|        - | 1163 | ` */` |
|  1509565 | 1164 | `case PH7_OP_LOADC: {` |
|        - | 1165 | `	ph7_value *pObj;` |
|        - | 1166 | `	/* Reserve a room */` |
|  3020989 | 1167 | `	pTos++;` |
|  3020989 | 1168 | `	if( pInstr->iP1 & PH7_LOADC_NOKEY ){` |
|        - | 1169 | `		/* Absent array-literal key: mark it so LOAD_MAP auto-indexes without a diagnostic */` |
|    19075 | 1170 | `		MemObjSetType(pTos,MEMOBJ_NULL);` |
|    19075 | 1171 | `		SyBlobReset(&pTos->sBlob);` |
|    19075 | 1172 | `		pTos->iFlags \|= MEMOBJ_AUX_NOKEY;` |
|    19075 | 1173 | `		pTos->nIdx = SXU32_HIGH;` |
|    19075 | 1174 | `		break;` |
|        - | 1175 | `	}` |
|  3001919 | 1176 | `	if( (pObj = (ph7_value *)SySetAt(&pVm->aLitObj,pInstr->iP2)) != 0 ){` |
|  3001919 | 1177 | `		if( (pInstr->iP1 & PH7_LOADC_EXPAND) && SyBlobLength(&pObj->sBlob) <= 64 ){` |
|        - | 1178 | `			SyHashEntry *pEntry;` |
|        - | 1179 | `			/* Check use const imports first — imports take precedence */` |
|        - | 1180 | `			{` |
|        - | 1181 | `				SyHashEntry *pConstImport;` |
|    34745 | 1182 | `				pConstImport = SyHashGet(&pVm->hUseConstImports,` |
|    23160 | 1183 | `					SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|    23165 | 1184 | `				if( pConstImport ){` |
...
|    23155 | 1199 | `			pEntry = SyHashGet(&pVm->hConstant,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|    23155 | 1200 | `			if( pEntry ){` |
|    23145 | 1201 | `				ph7_constant *pCons = (ph7_constant *)pEntry->pUserData;` |
|        - | 1202 | `				/* Set a NULL default value */` |
|    23145 | 1203 | `				MemObjSetType(pTos,MEMOBJ_NULL);` |
|    23145 | 1204 | `				SyBlobReset(&pTos->sBlob);` |
|        - | 1205 | `				/* Invoke the callback and deal with the expanded value */` |
|    23145 | 1206 | `				VmExpandConstantWithNotice(&(*pVm),pCons,pTos);` |
|        - | 1207 | `				/* Mark as constant */` |
|    23145 | 1208 | `				pTos->nIdx = SXU32_HIGH;` |
|    23145 | 1209 | `				break;` |
|        - | 1210 | `			}` |
...
|        - | 1283 | ` */` |
|  2195662 | 1284 | `case PH7_OP_LOAD:{` |
|        - | 1285 | `	ph7_value *pObj;` |
|        - | 1286 | `	SyString sName;` |
|  4395223 | 1287 | `	if( pInstr->p3 == 0 ){` |
...
|        9 | 1299 | `	}else{` |
|  4395207 | 1300 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1301 | `		/* Reserve a room for the target object */` |
|  4395207 | 1302 | `		pTos++;` |
|        - | 1303 | `	}` |
|        - | 1304 | `	/* Extract the requested memory object */` |
|  4395223 | 1305 | `	pObj = VmExtractMemObj(&(*pVm),&sName,pInstr->p3 ? FALSE : TRUE,pInstr->iP1 != 1);` |
|  4395223 | 1306 | `	if( pObj == 0 ){` |
...
|  4395193 | 1323 | `	PH7_MemObjLoad(pObj,pTos);` |
|  4395193 | 1324 | `	pTos->nIdx = pObj->nIdx;` |
|  4395193 | 1325 | `	break;` |
|        - | 1326 | `				   }` |
|        - | 1327 | `/*` |
|        - | 1328 | ` * LOAD_MAP P1 * *` |
...
|        - | 1333 | ` */` |
|    36821 | 1334 | `case PH7_OP_LOAD_MAP: {` |
|        - | 1335 | `	VmOpRc rcOp;` |
|    73647 | 1336 | `	sState.pTos = pTos;` |
|    73647 | 1337 | `	sState.pc = pc;` |
|    73647 | 1338 | `	rcOp = VmExecOpLoadMap(&(*pVm),&sState,pInstr);` |
|    73647 | 1339 | `	pTos = sState.pTos;` |
|    73647 | 1340 | `	pc = sState.pc;` |
|    73647 | 1341 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1342 | `		goto Abort;` |
|    73647 | 1343 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1376 | ` * instead.` |
|        - | 1377 | ` */` |
|   332272 | 1378 | `case PH7_OP_LOAD_IDX: {` |
|        - | 1379 | `	VmOpRc rcOp;` |
|   665272 | 1380 | `	sState.pTos = pTos;` |
|   665272 | 1381 | `	sState.pc = pc;` |
|   665272 | 1382 | `	rcOp = VmExecOpLoadIdx(&(*pVm),&sState,pInstr);` |
|   665272 | 1383 | `	pTos = sState.pTos;` |
|   665272 | 1384 | `	pc = sState.pc;` |
|   665272 | 1385 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1386 | `		goto Abort;` |
|   665272 | 1387 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1564 | `		}` |
|    11599 | 1565 | `		break;` |
|   583195 | 1566 | `	}else if( pInstr->p3 == 0 ){` |
...
|        - | 1578 | `#endif` |
|        5 | 1579 | `	}else{` |
|   583187 | 1580 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1581 | `	}` |
|   583190 | 1582 | `	if( sName.nByte == sizeof("GLOBALS")-1` |
|   293368 | 1583 | `	 && SyMemcmp((const void *)sName.zString,(const void *)"GLOBALS",sName.nByte) == 0 ){` |
|        6 | 1584 | `		if( pInstr->p3 ){` |
...
|        - | 1621 | ` */` |
|   120208 | 1622 | `case PH7_OP_STORE_IDX:` |
|        - | 1623 | `case PH7_OP_STORE_IDX_REF: {` |
|        - | 1624 | `	VmOpRc rcOp;` |
|   240421 | 1625 | `	sState.pTos = pTos;` |
|   240421 | 1626 | `	sState.pc = pc;` |
|   240421 | 1627 | `	rcOp = VmExecOpStoreIdxRef(&(*pVm),&sState,pInstr);` |
|   240421 | 1628 | `	pTos = sState.pTos;` |
|   240421 | 1629 | `	pc = sState.pc;` |
|   240421 | 1630 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 1631 | `		goto Abort;` |
|   240419 | 1632 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|   367439 | 1653 | `	PH7_ENFORCE_READONLY_MUTATE(pTos->nIdx);` |
...
|   367428 | 1658 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) != 0` |
|   183822 | 1659 | `	 && SySetUsed(&pVm->aHookRmw) > 0 ){` |
...
|        - | 1676 | `		}` |
|      ! 0 | 1677 | `	}` |
|   367431 | 1678 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) == 0 ){` |
|   367431 | 1679 | `		if( pTos->nIdx != SXU32_HIGH ){` |
|        - | 1680 | `			ph7_value *pObj;` |
|   367431 | 1681 | `			if( (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pTos->nIdx)) != 0 ){` |
|   367431 | 1682 | `				if( VmStringWantsPerlIncr(pObj) ){` |
...
|   367429 | 1701 | `					if( pInstr->iP1 == 0 && (pTos->iFlags & MEMOBJ_STRING) ){` |
|        9 | 1702 | `						SyBlobNullAppend(&pTos->sBlob);` |
|        3 | 1703 | `					}` |
|        - | 1704 | `					/* Force a numeric cast on the variable */` |
|   367429 | 1705 | `					PH7_MemObjToNumeric(pObj);` |
|   367429 | 1706 | `					if( pObj->iFlags & MEMOBJ_REAL ){` |
|        5 | 1707 | `						pObj->rVal++;` |
...
|        - | 1716 | `						sxi64 r;` |
|   367425 | 1717 | `						if( PH7_ADD_OVERFLOW64(pObj->x.iVal,1,&r) ){` |
...
|        - | 1723 | `#endif` |
|        3 | 1724 | `						}else{` |
|   367421 | 1725 | `							pObj->x.iVal = r;` |
|        - | 1726 | `						}` |
|        - | 1727 | `					}` |
|   367429 | 1728 | `					if( pInstr->iP1 ){` |
...
|        - | 1767 | `		}` |
|   183814 | 1768 | `	}` |
|   367429 | 1769 | `	PH7_HOOK_RMW_WRITEBACK(pTos->nIdx,pTos);` |
|   367429 | 1770 | `	break;` |
|        - | 1771 | `/*` |
|        - | 1772 | ` * DECR: P1 * *` |
|        - | 1773 | ` *` |
...
|      208 | 1788 | `	PH7_ENFORCE_READONLY_MUTATE(pTos->nIdx);` |
...
|    70571 | 1920 | `	PH7_MemObjToNumeric(pTos);` |
|    70571 | 1921 | `	if( pTos->iFlags & MEMOBJ_REAL ){` |
|      108 | 1922 | `		pTos->rVal = -pTos->rVal;` |
|       53 | 1923 | `	}` |
|    70571 | 1924 | `	if( pTos->iFlags & MEMOBJ_INT ){` |
|    70485 | 1925 | `		if( pTos->x.iVal == SMALLEST_INT64 ){` |
...
|        - | 1940 | `#endif` |
|        3 | 1941 | `		}else{` |
|    70481 | 1942 | `			pTos->x.iVal = -pTos->x.iVal;` |
|        - | 1943 | `		}` |
|    35240 | 1944 | `	}` |
|    70571 | 1945 | `	break;` |
|        - | 1946 | `/*` |
...
|    50825 | 1979 | `	if( (pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      119 | 1980 | `		PH7_MemObjToBool(pTos);` |
|       57 | 1981 | `	}` |
|    50825 | 1982 | `	pTos->x.iVal = !pTos->x.iVal;` |
|    50825 | 1983 | `	break;` |
|        - | 1984 | `/*` |
|        - | 1985 | ` * OP_BITNOT: * * *` |
|        - | 1986 | ` *` |
...
|        - | 2052 | ` */` |
|     6366 | 2053 | `case PH7_OP_ADD:{` |
|    12737 | 2054 | `	ph7_value *pNos = &pTos[-1];` |
|        - | 2055 | `#ifdef UNTRUST` |
|        - | 2056 | `	if( pNos < pStack ){` |
|        - | 2057 | `		goto Abort;` |
|        - | 2058 | `	}` |
...
|        - | 2064 | `		SyBlob sArMsg;` |
|    12737 | 2065 | `		SyBlobInit(&sArMsg,&pVm->sAllocator);` |
|    12737 | 2066 | `		if( VmArithOperandCheck(&(*pVm),pNos,pTos,"+",&sArMsg) != SXRET_OK ){` |
|        - | 2067 | `			sxi32 rcAr;` |
...
|        - | 2078 | `		}` |
|    12729 | 2079 | `		SyBlobRelease(&sArMsg);` |
|        - | 2080 | `	}` |
|        - | 2081 | `	/* Perform the addition */` |
|    12729 | 2082 | `	PH7_MemObjAdd(pNos,pTos,FALSE);` |
|    12729 | 2083 | `	VmPopOperand(&pTos,1);` |
|    12729 | 2084 | `	break;` |
|        - | 2085 | `				}` |
|        - | 2086 | `/*` |
|        - | 2087 | ` * OP_ADD_STORE * * *` |
...
|        - | 2508 | ` * back.` |
|        - | 2509 | ` */` |
|    86401 | 2510 | `case PH7_OP_CAT:{` |
|        - | 2511 | `	ph7_value *pNos,*pCur;` |
|   172807 | 2512 | `	if( pInstr->iP1 < 1 ){` |
|   144603 | 2513 | `		pNos = &pTos[-1];` |
|    72304 | 2514 | `	}else{` |
...
|   172807 | 2523 | `	if( (pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|     1929 | 2524 | `		PH7_MemObjToString(pNos);` |
|      962 | 2525 | `	}` |
|   172807 | 2526 | `	pCur = &pNos[1];` |
|   348947 | 2527 | `	while( pCur <= pTos ){` |
|   176145 | 2528 | `		if( (pCur->iFlags & MEMOBJ_STRING) == 0 ){` |
|    52201 | 2529 | `			PH7_MemObjToString(pCur);` |
|    26098 | 2530 | `		}` |
|        - | 2531 | `		/* Perform the concatenation */` |
|   176145 | 2532 | `		if( SyBlobLength(&pCur->sBlob) > 0 ){` |
|   176003 | 2533 | `			if( PH7_MemObjStringAppend(pNos,(const char *)SyBlobData(&pCur->sBlob),SyBlobLength(&pCur->sBlob)) != SXRET_OK ){` |
|        - | 2534 | `				/* Allocation failure: raise a fatal instead of a truncated concat */` |
|      ! 0 | 2535 | `				PH7_VmMemoryError(&(*pVm));` |
|      ! 0 | 2536 | `				goto Abort;` |
|        - | 2537 | `			}` |
|    87999 | 2538 | `		}` |
|   176145 | 2539 | `		SyBlobRelease(&pCur->sBlob);` |
|   176145 | 2540 | `		pCur++;` |
|        5 | 2541 | `	}` |
|   172807 | 2542 | `	pTos = pNos;` |
|   172807 | 2543 | `	break;` |
|        - | 2544 | `				}` |
|        - | 2545 | `/*  CAT_STORE: * * *` |
|        - | 2546 | ` *` |
...
|        - | 2548 | ` * back.` |
|        - | 2549 | ` */` |
|    11779 | 2550 | `case PH7_OP_CAT_STORE:{` |
|    23563 | 2551 | `	ph7_value *pNos = &pTos[-1];` |
|        - | 2552 | `	ph7_value *pObj;` |
|        - | 2553 | `	sxu32 nIdx;` |
|        - | 2554 | `#ifdef UNTRUST` |
|        - | 2555 | `	if( pNos < pStack ){` |
...
|    23563 | 2560 | `	if((pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|       59 | 2561 | `		PH7_MemObjToString(pNos);` |
|       29 | 2562 | `	}` |
|    23563 | 2563 | `	nIdx = pTos->nIdx;` |
...
|    23558 | 2575 | `	if( nIdx != SXU32_HIGH` |
|    23558 | 2576 | `	 && nIdx != pNos->nIdx` |
|    23554 | 2577 | `	 && (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx)) != 0` |
|    23555 | 2578 | `	 && (SyHashTotalEntry(&pVm->hTypedSlot) == 0` |
|    14375 | 2579 | `	     \|\| SyHashGet(&pVm->hTypedSlot,(const void *)&nIdx,sizeof(sxu32)) == 0) ){` |
|    23549 | 2580 | `		if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - | 2581 | `			/* e.g. $x = 5; $x .= "a";  ->  "5a" */` |
|        3 | 2582 | `			PH7_MemObjToString(pObj);` |
|        1 | 2583 | `		}` |
|    23549 | 2584 | `		if( SyBlobLength(&pNos->sBlob) > 0 ){` |
|    23545 | 2585 | `			if( PH7_MemObjStringAppend(pObj,(const char *)SyBlobData(&pNos->sBlob),SyBlobLength(&pNos->sBlob)) != SXRET_OK ){` |
...
|    23549 | 2604 | `		if( (pInstr+1)->iOp != PH7_OP_POP ){` |
...
|    23549 | 2609 | `		PH7_HOOK_RMW_WRITEBACK(nIdx,0);` |
|    23549 | 2610 | `		pNos->nIdx = SXU32_HIGH;` |
|    23549 | 2611 | `		VmPopOperand(&pTos,1);` |
|    23556 | 2612 | `		break;` |
|        - | 2613 | `	}` |
...
|        - | 2650 | ` * stack.` |
|        - | 2651 | ` */` |
|   114198 | 2652 | `case PH7_OP_LAND:` |
|        - | 2653 | `case PH7_OP_LOR: {` |
|        - | 2654 | `	VmOpRc rcOp;` |
|   228605 | 2655 | `	sState.pTos = pTos;` |
|   228605 | 2656 | `	sState.pc = pc;` |
|   228605 | 2657 | `	rcOp = VmExecOpLor(&(*pVm),&sState,pInstr);` |
|   228605 | 2658 | `	pTos = sState.pTos;` |
|   228605 | 2659 | `	pc = sState.pc;` |
|   228605 | 2660 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2661 | `		goto Abort;` |
|   228605 | 2662 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2877 | ` */` |
|     5435 | 2878 | `case PH7_OP_EQ:` |
|        - | 2879 | `case PH7_OP_NEQ: {` |
|        - | 2880 | `	VmOpRc rcOp;` |
|    10875 | 2881 | `	sState.pTos = pTos;` |
|    10875 | 2882 | `	sState.pc = pc;` |
|    10875 | 2883 | `	rcOp = VmExecOpNeq(&(*pVm),&sState,pInstr);` |
|    10875 | 2884 | `	pTos = sState.pTos;` |
|    10875 | 2885 | `	pc = sState.pc;` |
|    10875 | 2886 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2887 | `		goto Abort;` |
|    10875 | 2888 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2899 | ` */` |
|   228045 | 2900 | `case PH7_OP_TEQ: {` |
|        - | 2901 | `	VmOpRc rcOp;` |
|   456299 | 2902 | `	sState.pTos = pTos;` |
|   456299 | 2903 | `	sState.pc = pc;` |
|   456299 | 2904 | `	rcOp = VmExecOpTeq(&(*pVm),&sState,pInstr);` |
|   456299 | 2905 | `	pTos = sState.pTos;` |
|   456299 | 2906 | `	pc = sState.pc;` |
|   456299 | 2907 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2908 | `		goto Abort;` |
|   456299 | 2909 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2921 | ` *` |
|        - | 2922 | ` */` |
|   174430 | 2923 | `case PH7_OP_TNE: {` |
|        - | 2924 | `	VmOpRc rcOp;` |
|   349069 | 2925 | `	sState.pTos = pTos;` |
|   349069 | 2926 | `	sState.pc = pc;` |
|   349069 | 2927 | `	rcOp = VmExecOpTne(&(*pVm),&sState,pInstr);` |
|   349069 | 2928 | `	pTos = sState.pTos;` |
|   349069 | 2929 | `	pc = sState.pc;` |
|   349069 | 2930 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2931 | `		goto Abort;` |
|   349069 | 2932 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2953 | ` *` |
|        - | 2954 | ` */` |
|   145891 | 2955 | `case PH7_OP_LT:` |
|        - | 2956 | `case PH7_OP_LE: {` |
|        - | 2957 | `	VmOpRc rcOp;` |
|   292195 | 2958 | `	sState.pTos = pTos;` |
|   292195 | 2959 | `	sState.pc = pc;` |
|   292195 | 2960 | `	rcOp = VmExecOpLe(&(*pVm),&sState,pInstr);` |
|   292195 | 2961 | `	pTos = sState.pTos;` |
|   292195 | 2962 | `	pc = sState.pc;` |
|   292195 | 2963 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2964 | `		goto Abort;` |
|   292195 | 2965 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2986 | ` *` |
|        - | 2987 | ` */` |
|    86047 | 2988 | `case PH7_OP_GT:` |
|        - | 2989 | `case PH7_OP_GE: {` |
|        - | 2990 | `	VmOpRc rcOp;` |
|   172303 | 2991 | `	sState.pTos = pTos;` |
|   172303 | 2992 | `	sState.pc = pc;` |
|   172303 | 2993 | `	rcOp = VmExecOpGe(&(*pVm),&sState,pInstr);` |
|   172303 | 2994 | `	pTos = sState.pTos;` |
|   172303 | 2995 | `	pc = sState.pc;` |
|   172303 | 2996 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2997 | `		goto Abort;` |
|   172303 | 2998 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3372 | ` */` |
|    11992 | 3373 | `case PH7_OP_FOREACH_INIT: {` |
|        - | 3374 | `	VmOpRc rcOp;` |
|    23989 | 3375 | `	sState.pTos = pTos;` |
|    23989 | 3376 | `	sState.pc = pc;` |
|    23989 | 3377 | `	rcOp = VmExecOpForeachInit(&(*pVm),&sState,pInstr);` |
|    23989 | 3378 | `	pTos = sState.pTos;` |
|    23989 | 3379 | `	pc = sState.pc;` |
|    23989 | 3380 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 3381 | `		goto Abort;` |
|    23989 | 3382 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3390 | ` */` |
|   129973 | 3391 | `case PH7_OP_FOREACH_STEP: {` |
|        - | 3392 | `	VmOpRc rcOp;` |
|   259951 | 3393 | `	sState.pTos = pTos;` |
|   259951 | 3394 | `	sState.pc = pc;` |
|   259951 | 3395 | `	rcOp = VmExecOpForeachStep(&(*pVm),&sState,pInstr);` |
|   259951 | 3396 | `	pTos = sState.pTos;` |
|   259951 | 3397 | `	pc = sState.pc;` |
|   259951 | 3398 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 3399 | `		goto Abort;` |
|   259949 | 3400 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3408 | ` */` |
|    22350 | 3409 | `case PH7_OP_MEMBER: {` |
|        - | 3410 | `	VmOpRc rcOp;` |
|    44705 | 3411 | `	sState.pTos = pTos;` |
|    44705 | 3412 | `	sState.pc = pc;` |
|    44705 | 3413 | `	rcOp = VmExecOpMember(&(*pVm),&sState,pInstr);` |
|    44705 | 3414 | `	pTos = sState.pTos;` |
|    44705 | 3415 | `	pc = sState.pc;` |
|    44705 | 3416 | `	if( rcOp == VM_OP_ABORT ){` |
|        8 | 3417 | `		goto Abort;` |
|    44699 | 3418 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3426 | ` */` |
|     2375 | 3427 | `case PH7_OP_NEW: {` |
|        - | 3428 | `	VmOpRc rcOp;` |
|     4755 | 3429 | `	sState.pTos = pTos;` |
|     4755 | 3430 | `	sState.pc = pc;` |
|     4755 | 3431 | `	rcOp = VmExecOpNew(&(*pVm),&sState,pInstr);` |
|     4755 | 3432 | `	pTos = sState.pTos;` |
|     4755 | 3433 | `	pc = sState.pc;` |
|     4755 | 3434 | `	if( rcOp == VM_OP_ABORT ){` |
|        5 | 3435 | `		goto Abort;` |
|     4751 | 3436 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|  1038116 | 3813 | `	sxi32 nCallArgs = pInstr->iP1 + (pInstr->iP2 ? VmSpreadOwnExtra(pVm,pInstr->iP1,pTos) : 0);` |
|        - | 3814 | `	ph7_value *pArg;` |
|  1038116 | 3815 | `	pArg = &pTos[-nCallArgs];` |
...
|  1038116 | 3824 | `	VmCallArgMap *pEffCallMap = (VmCallArgMap *)pInstr->p3;` |
...
|  1038116 | 3831 | `	if( VmValueIsClosure(pVm,pTos) ){` |
...
|  1038116 | 3841 | `	if( (pTos->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|      142 | 4036 | `		break;` |
|        - | 4037 | `	}` |
|  1037956 | 4038 | `	SyStringInitFromBuf(&sName,SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
...
|  1037956 | 4042 | `	if( sName.nByte > 0 && sName.zString[0] == '\\' ){` |
...
|  1037956 | 4049 | `	pEntry = SyHashGet(&pVm->hFunction,(const void *)sName.zString,sName.nByte);` |
...
|        - | 4055 | `	{` |
|  1037956 | 4056 | `	VmCallArgMap *pCallMap = pEffCallMap;` |
|  1037956 | 4057 | `	if( pEntry == 0 && pCallMap && pCallMap->bIsNamespaced ){` |
...
|        - | 4088 | `		VmSlot sArg;` |
|        - | 4089 | `		sxu32 n;` |
|   104965 | 4090 | `		int bClosureThis = 0;` |
|   104965 | 4091 | `		ph7_class *pClosureScope = 0;` |
|        - | 4092 | `		/* initialize fields */` |
|   104965 | 4093 | `		pVmFunc = (ph7_vm_func *)pEntry->pUserData;` |
|   104965 | 4094 | `		pThis = 0;` |
|   104965 | 4095 | `		pSelf = 0;` |
...
|       14 | 4110 | `		}` |
|   104965 | 4111 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
...
|   157547 | 4218 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   104960 | 4219 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
...
|   104965 | 4226 | `		if( VmRecursionExceeded(pVm) ){` |
...
|        3 | 4230 | `			goto Abort;` |
|        - | 4231 | `		}` |
|   104963 | 4232 | `		if( pVmFunc->pNextName ){` |
...
|   104963 | 4244 | `		pSelfHint = pSelf;` |
|   104963 | 4245 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
...
|    12237 | 4249 | `			}` |
|    12746 | 4250 | `		}` |
|   104963 | 4251 | `		if( pSelf == 0 && (pVmFunc->iFlags & VM_FUNC_CLOSURE) ){` |
...
|       29 | 4262 | `			}` |
|      871 | 4263 | `		}` |
|   104963 | 4264 | `		if( SySetUsed(&pVmFunc->aAttrs) > 0 ){` |
...
|       57 | 4269 | `		}` |
|   104963 | 4270 | `		if( pVmFunc->iFlags & VM_FUNC_GENERATOR ){` |
...
|   104623 | 4502 | `		aFormalArg = (ph7_vm_func_arg *)SySetBasePtr(&pVmFunc->aArgs);` |
|        - | 4503 | `		/* Create a new VM frame  */` |
|   104623 | 4504 | `		rc = VmEnterFrame(&(*pVm),pVmFunc,pThis,&pFrame);` |
|   104623 | 4505 | `		if( rc != SXRET_OK ){` |
...
|   104623 | 4533 | `		pFrame->nActualArgs = (int)(pTos - pArg);` |
|   104623 | 4534 | `		if( pThis && ((pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) \|\| bClosureThis) ){` |
...
|    12320 | 4542 | `			}` |
|    12320 | 4543 | `		}` |
|   104623 | 4544 | `		if( SySetUsed(&pVmFunc->aStatic) > 0 ){` |
...
|        - | 4571 | `		{` |
|   104623 | 4572 | `		VmCallArgMap *pCallMap3 = pEffCallMap;` |
|        - | 4573 | `		/* Caller file's strict_types mode — governs parameter coercion` |
|        - | 4574 | `		 * (but NOT return coercion, which uses the callee's file). */` |
|   104623 | 4575 | `		int bCallIsStrict = (pCallMap3 && pCallMap3->bStrict) ? 1 : 0;` |
|   104623 | 4576 | `		if( pCallMap3 && pCallMap3->bHasNamed ){` |
|        - | 4577 | `			/* ============================================================` |
...
|        - | 4962 | `		 * ============================================================ */` |
|   104355 | 4963 | `		n = 0;` |
|   264697 | 4964 | `		while( pArg < pTos ){` |
|   160647 | 4965 | `			if( n < SySetUsed(&pVmFunc->aArgs) && (aFormalArg[n].iFlags & VM_FUNC_ARG_VARIADIC) ){` |
...
|        - | 5065 | `			}` |
|   160447 | 5066 | `			if( n < SySetUsed(&pVmFunc->aArgs) ){` |
...
|   159977 | 5073 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_UNION ){` |
...
|   159890 | 5106 | `				if( aFormalArg[n].nType > 0` |
|    87176 | 5107 | `					&& !((aFormalArg[n].iFlags & VM_FUNC_ARG_NULLABLE) && (pArg->iFlags & MEMOBJ_NULL)) ){` |
...
|       13 | 5183 | `					}` |
|     6967 | 5184 | `				}` |
|   159879 | 5185 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_BY_REF ){` |
...
|   159639 | 5237 | `					pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|        - | 5238 | `				}` |
|    80145 | 5239 | `			}else{` |
|        - | 5240 | `				char zName[32];` |
...
|        - | 5247 | `			}` |
|   160347 | 5248 | `			if( pObj ){` |
|   160111 | 5249 | `				PH7_MemObjStore(pArg,pObj);` |
|        - | 5250 | `				/* Insert argument index  */` |
|   160111 | 5251 | `				sArg.nIdx = pObj->nIdx;` |
|   160111 | 5252 | `				sArg.pUserData = 0;` |
|   160111 | 5253 | `				SySetPut(&pFrame->sArg,(const void *)&sArg);` |
|    80257 | 5254 | `			}` |
|   160347 | 5255 | `			PH7_MemObjRelease(pArg);` |
|   160347 | 5256 | `			pArg++;` |
|   160347 | 5257 | `			++n;` |
|        5 | 5258 | `		}` |
|        - | 5259 | `		} /* end named vs positional branch */` |
|        - | 5260 | `		/* Set up closure environment */` |
|   104501 | 5261 | `		if( pVmFunc->iFlags & VM_FUNC_CLOSURE ){` |
...
|   104496 | 5309 | `		if( n < SySetUsed(&pVmFunc->aArgs)` |
|    54907 | 5310 | `		 && (pVmFunc->iFlags & (VM_FUNC_INTERNAL\|VM_FUNC_CLASS_METHOD)) != VM_FUNC_INTERNAL ){` |
...
|   112397 | 5333 | `		while( n < SySetUsed(&pVmFunc->aArgs) ){` |
...
|        - | 5376 | `		 */` |
|   104479 | 5377 | `		PH7_MemObjRelease(pTos);` |
|   104479 | 5378 | `		pTos = &pTos[-nCallArgs];` |
...
|        - | 5390 | `		 * per function. */` |
|        - | 5391 | `		{` |
|   104479 | 5392 | `			sxu32 nSlots = pVmFunc->nMaxStack;` |
|   104479 | 5393 | `			if( nSlots == 0 ){` |
...
|     4106 | 5400 | `			}` |
|   104479 | 5401 | `			pFrameStack = VmOperandStackAlloc(&(*pVm),nSlots);` |
|        - | 5402 | `		}` |
|   104479 | 5403 | `		if( pFrameStack == 0 ){` |
...
|      ! 0 | 5410 | `			break;` |
|        - | 5411 | `		}` |
|    52135 | 5412 | `SkipFuncBody:` |
|   104613 | 5413 | `		if( pSelf ){` |
|        - | 5414 | `			/* Push class name */` |
|    25551 | 5415 | `			SySetPut(&pVm->aSelf,(const void *)&pSelf);` |
|    12773 | 5416 | `		}` |
|        - | 5417 | `		/* Increment nesting level */` |
|   104613 | 5418 | `		pVm->nRecursionDepth++;` |
|   104613 | 5419 | `		if( rc == PH7_EXCEPTION ){` |
...
|   104479 | 5448 | `			VmCallFrame *pRec = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   104479 | 5449 | `			if( pRec ){` |
|   101859 | 5450 | `				pVm->pIdleCallFrames = (void *)pRec->pPrev;` |
|    51034 | 5451 | `			}else{` |
|     2625 | 5452 | `				pRec = (VmCallFrame *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmCallFrame));` |
|        - | 5453 | `			}` |
|   104479 | 5454 | `			if( pRec == 0 ){` |
...
|      ! 0 | 5465 | `				goto Abort;` |
|        - | 5466 | `			}` |
|   104479 | 5467 | `			sState.pTos = pTos;` |
|   104479 | 5468 | `			sState.pc = pc;` |
|   104479 | 5469 | `			pRec->sCaller = sState;` |
|   104479 | 5470 | `			pRec->sCall.pVmFunc = pVmFunc;` |
|   104479 | 5471 | `			pRec->sCall.pFrame = pFrame;` |
|   104479 | 5472 | `			pRec->sCall.pFrameStack = pFrameStack;` |
|   104479 | 5473 | `			pRec->sCall.nStackCap = pVmFunc->nMaxStack + VM_STACK_GUARD;` |
|   104479 | 5474 | `			pRec->sCall.nLastRef = SXU32_HIGH;` |
|   104479 | 5475 | `			pRec->sCall.bSelfPushed = (sxu8)(pSelf ? 1 : 0);` |
|   104479 | 5476 | `			pRec->pPrev = pCallTop;` |
|   104479 | 5477 | `			pCallTop = pRec;` |
|        - | 5478 | `			/* Switch to the callee activation (what the recursive` |
|        - | 5479 | `			 * VmByteCodeExec entry used to set up). */` |
|   104479 | 5480 | `			aInstr = (VmInstr *)SySetBasePtr(&pVmFunc->aByteCode);` |
|   104479 | 5481 | `			pStack = pFrameStack;` |
|   104479 | 5482 | `			pTos = &pStack[-1];` |
|   104479 | 5483 | `			pc = 0;` |
|   104479 | 5484 | `			sState.aInstr = aInstr;` |
|   104479 | 5485 | `			sState.pStack = pStack;` |
|   104479 | 5486 | `			sState.nStackCap = pRec->sCall.nStackCap; /* callee's operand-stack capacity for OP_SPREAD growth */` |
|   104479 | 5487 | `			sState.nStackOrig = pRec->sCall.nStackCap; /* fixed headroom reference (never grows) */` |
|   104479 | 5488 | `			sState.pTos = pTos;` |
|   104479 | 5489 | `			sState.pc = 0;` |
|   104479 | 5490 | `			sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|   104479 | 5491 | `			sState.pEntryFrame = pVm->pFrame;` |
|   104479 | 5492 | `			sState.pResult = pRec->sCaller.pTos;` |
|   104479 | 5493 | `			sState.pLastRef = &pRec->sCall.nLastRef;` |
|   104479 | 5494 | `			sState.pEnforceRetFunc = VmFuncHasReturnType(pVmFunc) ? pVmFunc : 0;` |
|   104479 | 5495 | `			sState.is_callback = 0;` |
|   104479 | 5496 | `			sState.bReturnPropagates = 0;` |
|   104479 | 5497 | `			goto VmLoopFetch;` |
|        - | 5498 | `		}` |
|       57 | 5499 | `	}else{` |
...
|   932996 | 5508 | `		pEntry = SyHashGet(&pVm->hHostFunction,(const void *)sName.zString,sName.nByte);` |
|        - | 5509 | `		{` |
|   932996 | 5510 | `		VmCallArgMap *pCallMap2 = pEffCallMap;` |
|   932996 | 5511 | `		if( pEntry == 0 && pCallMap2 && pCallMap2->bIsNamespaced ){` |
...
|        - | 5616 | `			}` |
|        - | 5617 | `		}` |
|   932980 | 5618 | `		pFunc = (ph7_user_func *)pEntry->pUserData;` |
...
|  1399829 | 5623 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   932975 | 5624 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
|        - | 5625 | `		/* Start collecting function arguments */` |
|   932980 | 5626 | `		SySetReset(&aArg);` |
|  2520865 | 5627 | `		while( pArg < pTos ){` |
|  1587890 | 5628 | `			SySetPut(&aArg,(const void *)&pArg);` |
|  1587890 | 5629 | `			pArg++;` |
|        5 | 5630 | `		}` |
|        - | 5631 | `		/* Assume a null return value */` |
|   932980 | 5632 | `		PH7_MemObjInit(&(*pVm),&sRet);` |
|        - | 5633 | `		/* Init the call context */` |
|   932980 | 5634 | `		VmInitCallContext(&sCtx,&(*pVm),pFunc,&sRet,0);` |
...
|   932980 | 5641 | `		sCtx.pArgMap = pEffCallMap;` |
|        - | 5642 | `		{` |
|   932980 | 5643 | `		int nGiven = (int)SySetUsed(&aArg);` |
...
|   932980 | 5649 | `		if( pFunc->nMinArg > 0 && nGiven < pFunc->nMinArg ){` |
...
|      232 | 5656 | `				nGiven);` |
|  1399365 | 5657 | `		}else if( SXRET_OK != (rc = VmEnforceBuiltinArgTypes(&sCtx,pFunc,nGiven,` |
|   932511 | 5658 | `			(ph7_value **)SySetBasePtr(&aArg))) ){` |
|        - | 5659 | `			/* TypeError thrown: rc carries the caught/uncaught status */` |
|       91 | 5660 | `		}else{` |
|        - | 5661 | `			/* Call the foreign function */` |
|   932344 | 5662 | `			rc = pFunc->xFunc(&sCtx,nGiven,(ph7_value **)SySetBasePtr(&aArg));` |
|        - | 5663 | `		}` |
|        - | 5664 | `		}` |
|        - | 5665 | `		/* Release the call context */` |
|   932980 | 5666 | `		VmReleaseCallContext(&sCtx);` |
|   932980 | 5667 | `		if( rc == PH7_ABORT ){` |
...
|      576 | 5672 | `			goto Abort;` |
|        - | 5673 | `		}` |
|   932408 | 5674 | `		if( rc != PH7_SUSPEND && pVm->pInlineInstr == (void *)aInstr ){` |
...
|      ! 0 | 5687 | `		}` |
|   932404 | 5688 | `		if( rc == PH7_EXCEPTION ){` |
...
|      771 | 5708 | `			break;` |
|        - | 5709 | `		}` |
|   931442 | 5710 | `		if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|   910022 | 5734 | `			VmPopOperand(&pTos,nCallArgs);` |
|   455370 | 5735 | `		}` |
|        - | 5736 | `		/* Save foreign function return value into the (now top) function-name slot */` |
|   931088 | 5737 | `		PH7_MemObjStore(&sRet,pTos);` |
|   931088 | 5738 | `		PH7_MemObjRelease(&sRet);` |
|        - | 5739 | `	}` |
|   931192 | 5740 | `	break;` |
|        - | 5741 | `				  }` |
|        - | 5742 | `/*` |
...
|        - | 5745 | ` */` |
|    25481 | 5746 | `case PH7_OP_CONSUME: {` |
|        - | 5747 | `	VmOpRc rcOp;` |
|    50967 | 5748 | `	sState.pTos = pTos;` |
|    50967 | 5749 | `	sState.pc = pc;` |
|    50967 | 5750 | `	rcOp = VmExecOpConsume(&(*pVm),&sState,pInstr);` |
|    50967 | 5751 | `	pTos = sState.pTos;` |
|    50967 | 5752 | `	pc = sState.pc;` |
|    50967 | 5753 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 5754 | `		goto Abort;` |
|    50967 | 5755 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 5760 |  |
|        - | 5761 | `		} /* Switch() */` |
| 16435237 | 5762 | `		pc++; /* Next instruction in the stream */` |
|        5 | 5763 | `	} /* For(;;) */` |
|   128664 | 5764 | `Done:` |
...
|   257537 | 5768 | `	rc = SXRET_OK;` |
|   257537 | 5769 | `	goto Unwind;` |
|      823 | 5770 | `Suspend:` |
...
|   130665 | 5828 | `	for(;;){` |
|   261131 | 5829 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|      ! 0 | 5837 | `			}` |
|     1151 | 5838 | `		}` |
|   261131 | 5839 | `		if( pCallTop == 0 ){` |
|   157067 | 5840 | `			return VmExecFinalize(&(*pVm),&sState,&aArg,pTos,rc);` |
|        - | 5841 | `		}` |
|   104069 | 5842 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|      626 | 5848 | `		}` |
|        - | 5849 | `		{` |
|   104069 | 5850 | `			VmCallFrame *pRec = pCallTop;` |
|   104069 | 5851 | `			sState = pRec->sCaller;` |
|   104069 | 5852 | `			rc = VmCallFinish(&(*pVm),&sState,&pRec->sCall,rc);` |
|   104069 | 5853 | `			pCallTop = pRec->pPrev;` |
|   104069 | 5854 | `			pRec->pPrev = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   104069 | 5855 | `			pVm->pIdleCallFrames = (void *)pRec;` |
|   104069 | 5856 | `			aInstr = sState.aInstr;` |
|   104069 | 5857 | `			pStack = sState.pStack;` |
|   104069 | 5858 | `			pTos = sState.pTos;` |
|   104069 | 5859 | `			pc = sState.pc;` |
|        - | 5860 | `		}` |
|   104069 | 5861 | `		if( rc == PH7_OK ){` |
|   103303 | 5862 | `			pc++; /* the loop-bottom increment this OP_CALL missed */` |
|   103303 | 5863 | `			goto VmLoopFetch;` |
|        - | 5864 | `		}` |
|        5 | 5865 | `	}` |
|    78713 | 5866 | `}` |
|        - | 5867 |  |
