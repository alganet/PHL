...
|        - |  162 | ` */` |
|   156352 |  163 | `static sxi32 VmExecFinalize(ph7_vm *pVm,VmExecState *pState,SySet *pArg,ph7_value *pTos,sxi32 rcTerm)` |
|        5 |  164 | `{` |
|    78176 |  165 | `	SXUNUSED(pVm);` |
|   156357 |  166 | `	if( rcTerm != PH7_SUSPEND && !pState->bReturnPropagates ){` |
|   152743 |  167 | `		VmClearFrameReturn(pState->pEntryFrame);` |
|    76369 |  168 | `	}` |
|   156357 |  169 | `	SySetRelease(pArg);` |
|   156357 |  170 | `	if( rcTerm == PH7_ABORT \|\| rcTerm == PH7_EXCEPTION ){` |
|     2827 |  171 | `		while( pTos >= pState->pStack ){` |
|     1781 |  172 | `			PH7_MemObjRelease(pTos);` |
|     1781 |  173 | `			pTos--;` |
|        5 |  174 | `		}` |
|      523 |  175 | `	}` |
|   156357 |  176 | `	return rcTerm;` |
|        5 |  177 | `}` |
|        - |  178 | `/*` |
...
|        - |  189 | ` */` |
|   103305 |  190 | `static sxi32 VmCallFinish(ph7_vm *pVm,VmExecState *pCaller,VmCallRecord *pCallee,sxi32 rc)` |
|        5 |  191 | `{` |
|        - |  192 | `	ph7_value *pObj;` |
|        - |  193 | `	/* Decrement nesting level */` |
|   103310 |  194 | `	pVm->nRecursionDepth--;` |
|   103310 |  195 | `	if( pCallee->bSelfPushed ){` |
|        - |  196 | `		/* Pop class name */` |
|    24763 |  197 | `		(void)SySetPop(&pVm->aSelf);` |
|    12379 |  198 | `	}` |
|   103310 |  199 | `	if( (pCallee->pVmFunc->iFlags & VM_FUNC_REF_RETURN) && rc == SXRET_OK ){` |
...
|       25 |  225 | `	}` |
|   103310 |  226 | `	if( rc != PH7_ABORT && ((pCallee->pFrame->iFlags & VM_FRAME_THROW) \|\| rc == PH7_EXCEPTION) ){` |
...
|   103310 |  272 | `	if( rc != PH7_SUSPEND && pCallee->pFrameStack ){` |
...
|   103176 |  276 | `		VmOperandStackRecycle(pVm,pCallee->pFrameStack,pCallee->nStackCap);` |
|    51687 |  277 | `	}` |
|        - |  278 | `	/* Leave the frame */` |
|   103310 |  279 | `	VmLeaveFrame(&(*pVm));` |
|   103310 |  280 | `	if( rc == PH7_ABORT ){` |
|      332 |  281 | `		return PH7_ABORT;` |
|        - |  282 | `	}` |
|   102982 |  283 | `	if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|        - |  291 | `	}` |
|   102982 |  292 | `	if( rc == PH7_EXCEPTION ){` |
|      469 |  293 | `		return PH7_EXCEPTION;` |
|        - |  294 | `	}` |
|   102518 |  295 | `	return PH7_OK;` |
|    51759 |  296 | `}` |
|        - |  297 | `/*` |
...
|        - |  330 | ` * nesting.` |
|        - |  331 | ` */` |
|   156710 |  332 | `PH7_PRIVATE sxi32 VmByteCodeExec(` |
...
|   156715 |  352 | `	if( VmNativeNestingExceeded(pVm) ){` |
...
|   156711 |  362 | `	nSavedBrc = pVm->nBoundaryRc;` |
|   156711 |  363 | `	pVm->nBoundaryRc = 0;` |
...
|   156711 |  370 | `	nSavedLine = pVm->nCurLine;` |
|   156711 |  371 | `	pVm->nVmExecDepth++;` |
|   235064 |  372 | `	rc = VmByteCodeExecBody(&(*pVm),aInstr,pStack,nTos,pResult,pLastRef,is_callback,nPc,` |
|    78353 |  373 | `		pEnforceRetFunc,bReturnPropagates,pAdoptSegment,ppBaseOwner,pnBaseCap,nStackOrig);` |
|   156711 |  374 | `	pVm->nVmExecDepth--;` |
|   156711 |  375 | `	pVm->nCurLine = nSavedLine;` |
|   156711 |  376 | `	if( nSavedBrc != 0 && (nSavedBrc == PH7_ABORT \|\| pVm->nBoundaryRc == 0) ){` |
|       15 |  377 | `		pVm->nBoundaryRc = nSavedBrc;` |
|        6 |  378 | `	}` |
|   156711 |  379 | `	return rc;` |
|    78360 |  380 | `}` |
|   156706 |  381 | `static sxi32 VmByteCodeExecBody(` |
...
|        - |  399 | `	ph7_value *pTos;` |
|        - |  400 | `	SySet aArg;` |
|   156711 |  401 | `	VmCallFrame *pCallTop = 0; /* Top of this invocation's in-loop call-record` |
...
|        - |  409 | `	sxi32 pc;` |
|        - |  410 | `	sxi32 rc;` |
|   156711 |  411 | `	sState.aInstr = aInstr;` |
|   156711 |  412 | `	sState.pStack = pStack;` |
|   156711 |  413 | `	sState.nStackCap = pnBaseCap ? *pnBaseCap : 0; /* CURRENT capacity (grown on a coroutine resume) */` |
|   156711 |  414 | `	sState.nStackOrig = nStackOrig;                /* ORIGINAL capacity — fixed headroom reference */` |
|   156711 |  415 | `	sState.pResult = pResult;` |
|   156711 |  416 | `	sState.pLastRef = pLastRef;` |
|   156711 |  417 | `	sState.pEnforceRetFunc = pEnforceRetFunc;` |
|   156711 |  418 | `	sState.is_callback = (sxu8)(is_callback ? 1 : 0);` |
|   156711 |  419 | `	sState.bReturnPropagates = (sxu8)(bReturnPropagates ? 1 : 0);` |
|        - |  420 | `	/* Argument container */` |
|   156711 |  421 | `	SySetInit(&aArg,&pVm->sAllocator,sizeof(ph7_value *));` |
|   156711 |  422 | `	if( nTos < 0 ){` |
|   141641 |  423 | `		pTos = &pStack[-1];` |
|    70823 |  424 | `	}else{` |
|    15075 |  425 | `		pTos = &pStack[nTos];` |
|        - |  426 | `	}` |
|   156711 |  427 | `	sState.pTos = pTos;` |
|   156711 |  428 | `	sState.pc = nPc;` |
...
|   156706 |  446 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->pFrame == pVm->pFrame` |
|     2814 |  447 | `	 && pStack == pVm->pActiveCtx->pStack ){` |
|     1805 |  448 | `		sState.nExceptionBase = pVm->pActiveCtx->nExceptionBase;` |
|      905 |  449 | `	}else{` |
|   154911 |  450 | `		sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|        - |  451 | `	}` |
|   156711 |  452 | `	sState.pEntryFrame = pVm->pFrame;` |
|   156711 |  453 | `	pc = nPc;` |
...
|   156706 |  506 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->pInjected` |
...
|   156696 |  567 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->bClosing` |
...
| 16748084 |  603 | `		if( pVm->nBoundaryRc != 0 \|\| SySetUsed(&pVm->aHookRmw) > 0 ){` |
...
| 16747998 |  658 | `		pInstr = &aInstr[pc];` |
| 16747998 |  659 | `		if( pInstr->nLine ){` |
...
| 16534635 |  663 | `			pVm->nCurLine = pInstr->nLine;` |
|  8273563 |  664 | `		}` |
| 16747998 |  665 | `		rc = SXRET_OK;` |
|        - |  666 | `/*` |
...
|        - |  672 | ` */` |
| 16747998 |  673 | `		switch(pInstr->iOp){` |
|        - |  674 | `/*` |
|        - |  675 | ` * DONE: P1 * *` |
|        - |  676 | ` *` |
...
|        - |  679 | ` */` |
|   127767 |  680 | `case PH7_OP_DONE:` |
|   255742 |  681 | `	if( pInstr->iP2 && sState.bReturnPropagates ){` |
...
|   255553 |  711 | `	if( sState.pEnforceRetFunc && VmFuncHasReturnType(sState.pEnforceRetFunc)` |
...
|     4588 |  736 | `	}` |
|   255534 |  737 | `	if( pInstr->iP1 && pTos >= pStack ){` |
|   150946 |  738 | `		if( sState.pLastRef ){` |
|    92938 |  739 | `			*sState.pLastRef = pTos->nIdx;` |
|    46568 |  740 | `		}` |
|   150946 |  741 | `		if( sState.pResult ){` |
|        - |  742 | `			/* Execution result */` |
|   143960 |  743 | `			PH7_MemObjStore(pTos,sState.pResult);` |
|    72079 |  744 | `		}` |
|   150946 |  745 | `		VmPopOperand(&pTos,1);` |
|   180165 |  746 | `	}else if( sState.pLastRef ){` |
...
|     8843 |  752 | `		*sState.pLastRef = SXU32_HIGH;` |
|     4419 |  753 | `	}` |
...
|        - |  762 | `	 */` |
|   255534 |  763 | `	rc = VmDrainFinally(&(*pVm),sState.nExceptionBase);` |
|   255534 |  764 | `	if( rc == SXERR_ABORT ){` |
|      ! 0 |  765 | `		goto Abort;` |
|        - |  766 | `	}` |
|   255534 |  767 | `	if( rc == PH7_EXCEPTION ){` |
...
|        - |  778 | `	}` |
|   255530 |  779 | `	if( sState.pEntryFrame->bHasRet && !sState.bReturnPropagates ){` |
...
|  1600097 |  852 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     1003 |  853 | `		PH7_MemObjToBool(pTos);` |
|      500 |  854 | `	}` |
|  1600097 |  855 | `	if( !pTos->x.iVal ){` |
|        - |  856 | `		/* Take the jump */` |
|   896582 |  857 | `		pc = pInstr->iP2 - 1;` |
|   448544 |  858 | `	}` |
|  1600097 |  859 | `	if( !pInstr->iP1 ){` |
|  1352311 |  860 | `		VmPopOperand(&pTos,1);` |
|   676713 |  861 | `	}` |
|  1600097 |  862 | `	break;` |
|        - |  863 | `/*` |
|        - |  864 | ` * JNZ: P1 P2 *` |
...
|   183704 |  876 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      ! 0 |  877 | `		PH7_MemObjToBool(pTos);` |
|      ! 0 |  878 | `	}` |
|   183704 |  879 | `	if( pTos->x.iVal ){` |
|        - |  880 | `		/* Take the jump */` |
|     9543 |  881 | `		pc = pInstr->iP2 - 1;` |
|     4769 |  882 | `	}` |
|   183704 |  883 | `	if( !pInstr->iP1 ){` |
...
|        - |  899 | ` */` |
|   660163 |  900 | `case PH7_OP_POP: {` |
|  1321346 |  901 | `	sxi32 n = pInstr->iP1;` |
|  1321346 |  902 | `	if( &pTos[-n+1] < pStack ){` |
|        - |  903 | `		/* TICKET 1433-51 Stack underflow must be handled at run-time */` |
|       79 |  904 | `		n = (sxi32)(pTos - pStack);` |
|       38 |  905 | `	}` |
|  1321346 |  906 | `	VmPopOperand(&pTos,n);` |
|  1321346 |  907 | `	break;` |
|        - |  908 | `				 }` |
|        - |  909 | `/*` |
|        - |  910 | ` * DUP: * * *` |
...
|        - |  929 | ` */` |
|    49091 |  930 | `case PH7_OP_NSSWITCH:` |
|    98187 |  931 | `	SyBlobReset(&pVm->sNamespace);` |
|    98187 |  932 | `	if( pInstr->p3 ){` |
...
|    98187 |  937 | `	SyHashRelease(&pVm->hUseConstImports);` |
|    98187 |  938 | `	SyHashInit(&pVm->hUseConstImports,&pVm->sAllocator,0,0);` |
|    98187 |  939 | `	break;` |
...
|     6789 | 1089 | `	break;` |
|        - | 1090 | `					  }` |
|    37687 | 1091 | `case PH7_OP_ERR_CTRL:` |
|        - | 1092 | `	/*` |
...
|        - | 1101 | `	 */` |
|    75379 | 1102 | `	if( pInstr->iP1 ){` |
|    37693 | 1103 | `		pVm->nErrSuppress++;` |
|    56535 | 1104 | `	}else if( pVm->nErrSuppress > 0 ){` |
|    37691 | 1105 | `		pVm->nErrSuppress--;` |
|    18843 | 1106 | `	}` |
|    75379 | 1107 | `	break;` |
|        - | 1108 | `/*` |
|        - | 1109 | ` * IS_A * * *` |
...
|        - | 1163 | ` */` |
|  1504909 | 1164 | `case PH7_OP_LOADC: {` |
|        - | 1165 | `	ph7_value *pObj;` |
|        - | 1166 | `	/* Reserve a room */` |
|  3011657 | 1167 | `	pTos++;` |
|  3011657 | 1168 | `	if( pInstr->iP1 & PH7_LOADC_NOKEY ){` |
...
|    19075 | 1174 | `		break;` |
|        - | 1175 | `	}` |
|  2992587 | 1176 | `	if( (pObj = (ph7_value *)SySetAt(&pVm->aLitObj,pInstr->iP2)) != 0 ){` |
|  2992587 | 1177 | `		if( (pInstr->iP1 & PH7_LOADC_EXPAND) && SyBlobLength(&pObj->sBlob) <= 64 ){` |
|        - | 1178 | `			SyHashEntry *pEntry;` |
|        - | 1179 | `			/* Check use const imports first — imports take precedence */` |
|        - | 1180 | `			{` |
|        - | 1181 | `				SyHashEntry *pConstImport;` |
|    34727 | 1182 | `				pConstImport = SyHashGet(&pVm->hUseConstImports,` |
|    23148 | 1183 | `					SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|    23153 | 1184 | `				if( pConstImport ){` |
...
|    23143 | 1199 | `			pEntry = SyHashGet(&pVm->hConstant,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|    23143 | 1200 | `			if( pEntry ){` |
|    23133 | 1201 | `				ph7_constant *pCons = (ph7_constant *)pEntry->pUserData;` |
|        - | 1202 | `				/* Set a NULL default value */` |
|    23133 | 1203 | `				MemObjSetType(pTos,MEMOBJ_NULL);` |
|    23133 | 1204 | `				SyBlobReset(&pTos->sBlob);` |
|        - | 1205 | `				/* Invoke the callback and deal with the expanded value */` |
|    23133 | 1206 | `				VmExpandConstantWithNotice(&(*pVm),pCons,pTos);` |
|        - | 1207 | `				/* Mark as constant */` |
|    23133 | 1208 | `				pTos->nIdx = SXU32_HIGH;` |
|    23133 | 1209 | `				break;` |
|        - | 1210 | `			}` |
...
|        - | 1283 | ` */` |
|  2188646 | 1284 | `case PH7_OP_LOAD:{` |
|        - | 1285 | `	ph7_value *pObj;` |
|        - | 1286 | `	SyString sName;` |
|  4381161 | 1287 | `	if( pInstr->p3 == 0 ){` |
...
|        9 | 1299 | `	}else{` |
|  4381145 | 1300 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1301 | `		/* Reserve a room for the target object */` |
|  4381145 | 1302 | `		pTos++;` |
|        - | 1303 | `	}` |
|        - | 1304 | `	/* Extract the requested memory object */` |
|  4381161 | 1305 | `	pObj = VmExtractMemObj(&(*pVm),&sName,pInstr->p3 ? FALSE : TRUE,pInstr->iP1 != 1);` |
|  4381161 | 1306 | `	if( pObj == 0 ){` |
...
|  4381131 | 1323 | `	PH7_MemObjLoad(pObj,pTos);` |
|  4381131 | 1324 | `	pTos->nIdx = pObj->nIdx;` |
|  4381131 | 1325 | `	break;` |
|        - | 1326 | `				   }` |
|        - | 1327 | `/*` |
|        - | 1328 | ` * LOAD_MAP P1 * *` |
...
|        - | 1333 | ` */` |
|    36782 | 1334 | `case PH7_OP_LOAD_MAP: {` |
|        - | 1335 | `	VmOpRc rcOp;` |
|    73569 | 1336 | `	sState.pTos = pTos;` |
|    73569 | 1337 | `	sState.pc = pc;` |
|    73569 | 1338 | `	rcOp = VmExecOpLoadMap(&(*pVm),&sState,pInstr);` |
|    73569 | 1339 | `	pTos = sState.pTos;` |
|    73569 | 1340 | `	pc = sState.pc;` |
|    73569 | 1341 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1342 | `		goto Abort;` |
|    73569 | 1343 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1376 | ` * instead.` |
|        - | 1377 | ` */` |
|   330453 | 1378 | `case PH7_OP_LOAD_IDX: {` |
|        - | 1379 | `	VmOpRc rcOp;` |
|   661625 | 1380 | `	sState.pTos = pTos;` |
|   661625 | 1381 | `	sState.pc = pc;` |
|   661625 | 1382 | `	rcOp = VmExecOpLoadIdx(&(*pVm),&sState,pInstr);` |
|   661625 | 1383 | `	pTos = sState.pTos;` |
|   661625 | 1384 | `	pc = sState.pc;` |
|   661625 | 1385 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1386 | `		goto Abort;` |
|   661625 | 1387 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1489 | `	}` |
|        - | 1490 | `#endif` |
|   592799 | 1491 | `	if( pInstr->iP2 ){` |
|        - | 1492 | `		sxu32 nIdx;` |
|        - | 1493 | `		sxi32 rcT;` |
|        - | 1494 | `		/* Member store operation */` |
|    11709 | 1495 | `		nIdx = pTos->nIdx;` |
|    11709 | 1496 | `		VmPopOperand(&pTos,1);` |
|    11709 | 1497 | `		if( pVm->pMagicSetThis ){` |
...
|       11 | 1510 | `			break;` |
|        - | 1511 | `		}` |
|    11699 | 1512 | `		if( pVm->pHookSetThis ){` |
...
|    11667 | 1540 | `			rcT = VmEnforcePropertyTypeOnStore(&(*pVm),nIdx,pTos,0);` |
|    11667 | 1541 | `			if( rcT == PH7_ABORT ){` |
|       13 | 1542 | `				goto Abort;` |
|        - | 1543 | `			}` |
|    11657 | 1544 | `			if( rcT == PH7_EXCEPTION ){` |
...
|    11589 | 1559 | `			pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|    11589 | 1560 | `			if( pObj ){` |
|        - | 1561 | `				/* Perform the store operation */` |
|    11589 | 1562 | `				PH7_MemObjStore(pTos,pObj);` |
|     5792 | 1563 | `			}` |
|        - | 1564 | `		}` |
|    11591 | 1565 | `		break;` |
|   581095 | 1566 | `	}else if( pInstr->p3 == 0 ){` |
...
|        - | 1578 | `#endif` |
|        5 | 1579 | `	}else{` |
|   581087 | 1580 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1581 | `	}` |
|   581090 | 1582 | `	if( sName.nByte == sizeof("GLOBALS")-1` |
|   292316 | 1583 | `	 && SyMemcmp((const void *)sName.zString,(const void *)"GLOBALS",sName.nByte) == 0 ){` |
|        6 | 1584 | `		if( pInstr->p3 ){` |
...
|        - | 1621 | ` */` |
|   120162 | 1622 | `case PH7_OP_STORE_IDX:` |
|        - | 1623 | `case PH7_OP_STORE_IDX_REF: {` |
|        - | 1624 | `	VmOpRc rcOp;` |
|   240329 | 1625 | `	sState.pTos = pTos;` |
|   240329 | 1626 | `	sState.pc = pc;` |
|   240329 | 1627 | `	rcOp = VmExecOpStoreIdxRef(&(*pVm),&sState,pInstr);` |
|   240329 | 1628 | `	pTos = sState.pTos;` |
|   240329 | 1629 | `	pc = sState.pc;` |
|   240329 | 1630 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 1631 | `		goto Abort;` |
|   240327 | 1632 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|   366170 | 1653 | `	PH7_ENFORCE_READONLY_MUTATE(pTos->nIdx);` |
...
|   366159 | 1658 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) != 0` |
|   183187 | 1659 | `	 && SySetUsed(&pVm->aHookRmw) > 0 ){` |
...
|        - | 1676 | `		}` |
|      ! 0 | 1677 | `	}` |
|   366162 | 1678 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) == 0 ){` |
|   366162 | 1679 | `		if( pTos->nIdx != SXU32_HIGH ){` |
|        - | 1680 | `			ph7_value *pObj;` |
|   366162 | 1681 | `			if( (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pTos->nIdx)) != 0 ){` |
|   366162 | 1682 | `				if( VmStringWantsPerlIncr(pObj) ){` |
...
|   366160 | 1701 | `					if( pInstr->iP1 == 0 && (pTos->iFlags & MEMOBJ_STRING) ){` |
|        9 | 1702 | `						SyBlobNullAppend(&pTos->sBlob);` |
|        3 | 1703 | `					}` |
|        - | 1704 | `					/* Force a numeric cast on the variable */` |
|   366160 | 1705 | `					PH7_MemObjToNumeric(pObj);` |
|   366160 | 1706 | `					if( pObj->iFlags & MEMOBJ_REAL ){` |
|        5 | 1707 | `						pObj->rVal++;` |
...
|        - | 1716 | `						sxi64 r;` |
|   366156 | 1717 | `						if( PH7_ADD_OVERFLOW64(pObj->x.iVal,1,&r) ){` |
...
|        - | 1723 | `#endif` |
|        3 | 1724 | `						}else{` |
|   366152 | 1725 | `							pObj->x.iVal = r;` |
|        - | 1726 | `						}` |
|        - | 1727 | `					}` |
|   366160 | 1728 | `					if( pInstr->iP1 ){` |
...
|        - | 1767 | `		}` |
|   183179 | 1768 | `	}` |
|   366160 | 1769 | `	PH7_HOOK_RMW_WRITEBACK(pTos->nIdx,pTos);` |
|   366160 | 1770 | `	break;` |
|        - | 1771 | `/*` |
|        - | 1772 | ` * DECR: P1 * *` |
|        - | 1773 | ` *` |
...
|    70531 | 1920 | `	PH7_MemObjToNumeric(pTos);` |
|    70531 | 1921 | `	if( pTos->iFlags & MEMOBJ_REAL ){` |
|      108 | 1922 | `		pTos->rVal = -pTos->rVal;` |
|       53 | 1923 | `	}` |
|    70531 | 1924 | `	if( pTos->iFlags & MEMOBJ_INT ){` |
|    70445 | 1925 | `		if( pTos->x.iVal == SMALLEST_INT64 ){` |
...
|        - | 1940 | `#endif` |
|        3 | 1941 | `		}else{` |
|    70441 | 1942 | `			pTos->x.iVal = -pTos->x.iVal;` |
|        - | 1943 | `		}` |
|    35220 | 1944 | `	}` |
|    70531 | 1945 | `	break;` |
|        - | 1946 | `/*` |
...
|    51315 | 1979 | `	if( (pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      119 | 1980 | `		PH7_MemObjToBool(pTos);` |
|       57 | 1981 | `	}` |
|    51315 | 1982 | `	pTos->x.iVal = !pTos->x.iVal;` |
|    51315 | 1983 | `	break;` |
|        - | 1984 | `/*` |
|        - | 1985 | ` * OP_BITNOT: * * *` |
|        - | 1986 | ` *` |
...
|        - | 2052 | ` */` |
|     6358 | 2053 | `case PH7_OP_ADD:{` |
|    12721 | 2054 | `	ph7_value *pNos = &pTos[-1];` |
|        - | 2055 | `#ifdef UNTRUST` |
|        - | 2056 | `	if( pNos < pStack ){` |
|        - | 2057 | `		goto Abort;` |
|        - | 2058 | `	}` |
...
|        - | 2064 | `		SyBlob sArMsg;` |
|    12721 | 2065 | `		SyBlobInit(&sArMsg,&pVm->sAllocator);` |
|    12721 | 2066 | `		if( VmArithOperandCheck(&(*pVm),pNos,pTos,"+",&sArMsg) != SXRET_OK ){` |
|        - | 2067 | `			sxi32 rcAr;` |
...
|        - | 2078 | `		}` |
|    12713 | 2079 | `		SyBlobRelease(&sArMsg);` |
|        - | 2080 | `	}` |
|        - | 2081 | `	/* Perform the addition */` |
|    12713 | 2082 | `	PH7_MemObjAdd(pNos,pTos,FALSE);` |
|    12713 | 2083 | `	VmPopOperand(&pTos,1);` |
|    12713 | 2084 | `	break;` |
|        - | 2085 | `				}` |
|        - | 2086 | `/*` |
|        - | 2087 | ` * OP_ADD_STORE * * *` |
...
|        - | 2151 | ` */` |
|    11548 | 2152 | `case PH7_OP_SUB: {` |
|        - | 2153 | `	VmOpRc rcOp;` |
|    23206 | 2154 | `	sState.pTos = pTos;` |
|    23206 | 2155 | `	sState.pc = pc;` |
|    23206 | 2156 | `	rcOp = VmExecOpSub(&(*pVm),&sState,pInstr);` |
|    23206 | 2157 | `	pTos = sState.pTos;` |
|    23206 | 2158 | `	pc = sState.pc;` |
|    23206 | 2159 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2160 | `		goto Abort;` |
|    23206 | 2161 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2508 | ` * back.` |
|        - | 2509 | ` */` |
|    85302 | 2510 | `case PH7_OP_CAT:{` |
|        - | 2511 | `	ph7_value *pNos,*pCur;` |
|   170609 | 2512 | `	if( pInstr->iP1 < 1 ){` |
|   142405 | 2513 | `		pNos = &pTos[-1];` |
|    71205 | 2514 | `	}else{` |
...
|   170609 | 2523 | `	if( (pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|     1929 | 2524 | `		PH7_MemObjToString(pNos);` |
|      962 | 2525 | `	}` |
|   170609 | 2526 | `	pCur = &pNos[1];` |
|   344551 | 2527 | `	while( pCur <= pTos ){` |
|   173947 | 2528 | `		if( (pCur->iFlags & MEMOBJ_STRING) == 0 ){` |
|    51559 | 2529 | `			PH7_MemObjToString(pCur);` |
|    25777 | 2530 | `		}` |
|        - | 2531 | `		/* Perform the concatenation */` |
|   173947 | 2532 | `		if( SyBlobLength(&pCur->sBlob) > 0 ){` |
|   173871 | 2533 | `			if( PH7_MemObjStringAppend(pNos,(const char *)SyBlobData(&pCur->sBlob),SyBlobLength(&pCur->sBlob)) != SXRET_OK ){` |
|        - | 2534 | `				/* Allocation failure: raise a fatal instead of a truncated concat */` |
|      ! 0 | 2535 | `				PH7_VmMemoryError(&(*pVm));` |
|      ! 0 | 2536 | `				goto Abort;` |
|        - | 2537 | `			}` |
|    86933 | 2538 | `		}` |
|   173947 | 2539 | `		SyBlobRelease(&pCur->sBlob);` |
|   173947 | 2540 | `		pCur++;` |
|        5 | 2541 | `	}` |
|   170609 | 2542 | `	pTos = pNos;` |
|   170609 | 2543 | `	break;` |
|        - | 2544 | `				}` |
|        - | 2545 | `/*  CAT_STORE: * * *` |
|        - | 2546 | ` *` |
...
|        - | 2548 | ` * back.` |
|        - | 2549 | ` */` |
|    12009 | 2550 | `case PH7_OP_CAT_STORE:{` |
|    24023 | 2551 | `	ph7_value *pNos = &pTos[-1];` |
|        - | 2552 | `	ph7_value *pObj;` |
|        - | 2553 | `	sxu32 nIdx;` |
|        - | 2554 | `#ifdef UNTRUST` |
|        - | 2555 | `	if( pNos < pStack ){` |
...
|    24023 | 2560 | `	if((pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|       59 | 2561 | `		PH7_MemObjToString(pNos);` |
|       29 | 2562 | `	}` |
|    24023 | 2563 | `	nIdx = pTos->nIdx;` |
...
|    24018 | 2575 | `	if( nIdx != SXU32_HIGH` |
|    24018 | 2576 | `	 && nIdx != pNos->nIdx` |
|    24014 | 2577 | `	 && (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx)) != 0` |
|    24015 | 2578 | `	 && (SyHashTotalEntry(&pVm->hTypedSlot) == 0` |
|    14602 | 2579 | `	     \|\| SyHashGet(&pVm->hTypedSlot,(const void *)&nIdx,sizeof(sxu32)) == 0) ){` |
|    24009 | 2580 | `		if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - | 2581 | `			/* e.g. $x = 5; $x .= "a";  ->  "5a" */` |
|        3 | 2582 | `			PH7_MemObjToString(pObj);` |
|        1 | 2583 | `		}` |
|    24009 | 2584 | `		if( SyBlobLength(&pNos->sBlob) > 0 ){` |
|    24005 | 2585 | `			if( PH7_MemObjStringAppend(pObj,(const char *)SyBlobData(&pNos->sBlob),SyBlobLength(&pNos->sBlob)) != SXRET_OK ){` |
...
|    24009 | 2604 | `		if( (pInstr+1)->iOp != PH7_OP_POP ){` |
...
|    24009 | 2609 | `		PH7_HOOK_RMW_WRITEBACK(nIdx,0);` |
|    24009 | 2610 | `		pNos->nIdx = SXU32_HIGH;` |
|    24009 | 2611 | `		VmPopOperand(&pTos,1);` |
|    24016 | 2612 | `		break;` |
|        - | 2613 | `	}` |
...
|        - | 2650 | ` * stack.` |
|        - | 2651 | ` */` |
|   113820 | 2652 | `case PH7_OP_LAND:` |
|        - | 2653 | `case PH7_OP_LOR: {` |
|        - | 2654 | `	VmOpRc rcOp;` |
|   227848 | 2655 | `	sState.pTos = pTos;` |
|   227848 | 2656 | `	sState.pc = pc;` |
|   227848 | 2657 | `	rcOp = VmExecOpLor(&(*pVm),&sState,pInstr);` |
|   227848 | 2658 | `	pTos = sState.pTos;` |
|   227848 | 2659 | `	pc = sState.pc;` |
|   227848 | 2660 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2661 | `		goto Abort;` |
|   227848 | 2662 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2877 | ` */` |
|     5433 | 2878 | `case PH7_OP_EQ:` |
|        - | 2879 | `case PH7_OP_NEQ: {` |
|        - | 2880 | `	VmOpRc rcOp;` |
|    10871 | 2881 | `	sState.pTos = pTos;` |
|    10871 | 2882 | `	sState.pc = pc;` |
|    10871 | 2883 | `	rcOp = VmExecOpNeq(&(*pVm),&sState,pInstr);` |
|    10871 | 2884 | `	pTos = sState.pTos;` |
|    10871 | 2885 | `	pc = sState.pc;` |
|    10871 | 2886 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2887 | `		goto Abort;` |
|    10871 | 2888 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2899 | ` */` |
|   227838 | 2900 | `case PH7_OP_TEQ: {` |
|        - | 2901 | `	VmOpRc rcOp;` |
|   455884 | 2902 | `	sState.pTos = pTos;` |
|   455884 | 2903 | `	sState.pc = pc;` |
|   455884 | 2904 | `	rcOp = VmExecOpTeq(&(*pVm),&sState,pInstr);` |
|   455884 | 2905 | `	pTos = sState.pTos;` |
|   455884 | 2906 | `	pc = sState.pc;` |
|   455884 | 2907 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2908 | `		goto Abort;` |
|   455884 | 2909 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2921 | ` *` |
|        - | 2922 | ` */` |
|   174020 | 2923 | `case PH7_OP_TNE: {` |
|        - | 2924 | `	VmOpRc rcOp;` |
|   348248 | 2925 | `	sState.pTos = pTos;` |
|   348248 | 2926 | `	sState.pc = pc;` |
|   348248 | 2927 | `	rcOp = VmExecOpTne(&(*pVm),&sState,pInstr);` |
|   348248 | 2928 | `	pTos = sState.pTos;` |
|   348248 | 2929 | `	pc = sState.pc;` |
|   348248 | 2930 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2931 | `		goto Abort;` |
|   348248 | 2932 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2953 | ` *` |
|        - | 2954 | ` */` |
|   145368 | 2955 | `case PH7_OP_LT:` |
|        - | 2956 | `case PH7_OP_LE: {` |
|        - | 2957 | `	VmOpRc rcOp;` |
|   291147 | 2958 | `	sState.pTos = pTos;` |
|   291147 | 2959 | `	sState.pc = pc;` |
|   291147 | 2960 | `	rcOp = VmExecOpLe(&(*pVm),&sState,pInstr);` |
|   291147 | 2961 | `	pTos = sState.pTos;` |
|   291147 | 2962 | `	pc = sState.pc;` |
|   291147 | 2963 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2964 | `		goto Abort;` |
|   291147 | 2965 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2986 | ` *` |
|        - | 2987 | ` */` |
|    85673 | 2988 | `case PH7_OP_GT:` |
|        - | 2989 | `case PH7_OP_GE: {` |
|        - | 2990 | `	VmOpRc rcOp;` |
|   171554 | 2991 | `	sState.pTos = pTos;` |
|   171554 | 2992 | `	sState.pc = pc;` |
|   171554 | 2993 | `	rcOp = VmExecOpGe(&(*pVm),&sState,pInstr);` |
|   171554 | 2994 | `	pTos = sState.pTos;` |
|   171554 | 2995 | `	pc = sState.pc;` |
|   171554 | 2996 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2997 | `		goto Abort;` |
|   171554 | 2998 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3354 | ` */` |
|      375 | 3355 | `case PH7_OP_THROW: {` |
|        - | 3356 | `	VmOpRc rcOp;` |
|      755 | 3357 | `	sState.pTos = pTos;` |
|      755 | 3358 | `	sState.pc = pc;` |
|      755 | 3359 | `	rcOp = VmExecOpThrow(&(*pVm),&sState,pInstr);` |
|      755 | 3360 | `	pTos = sState.pTos;` |
|      755 | 3361 | `	pc = sState.pc;` |
|      755 | 3362 | `	if( rcOp == VM_OP_ABORT ){` |
|       28 | 3363 | `		goto Abort;` |
...
|        - | 3372 | ` */` |
|    11701 | 3373 | `case PH7_OP_FOREACH_INIT: {` |
|        - | 3374 | `	VmOpRc rcOp;` |
|    23407 | 3375 | `	sState.pTos = pTos;` |
|    23407 | 3376 | `	sState.pc = pc;` |
|    23407 | 3377 | `	rcOp = VmExecOpForeachInit(&(*pVm),&sState,pInstr);` |
|    23407 | 3378 | `	pTos = sState.pTos;` |
|    23407 | 3379 | `	pc = sState.pc;` |
|    23407 | 3380 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 3381 | `		goto Abort;` |
|    23407 | 3382 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3390 | ` */` |
|   129601 | 3391 | `case PH7_OP_FOREACH_STEP: {` |
|        - | 3392 | `	VmOpRc rcOp;` |
|   259207 | 3393 | `	sState.pTos = pTos;` |
|   259207 | 3394 | `	sState.pc = pc;` |
|   259207 | 3395 | `	rcOp = VmExecOpForeachStep(&(*pVm),&sState,pInstr);` |
|   259207 | 3396 | `	pTos = sState.pTos;` |
|   259207 | 3397 | `	pc = sState.pc;` |
|   259207 | 3398 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 3399 | `		goto Abort;` |
|   259205 | 3400 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3408 | ` */` |
|    21776 | 3409 | `case PH7_OP_MEMBER: {` |
|        - | 3410 | `	VmOpRc rcOp;` |
|    43557 | 3411 | `	sState.pTos = pTos;` |
|    43557 | 3412 | `	sState.pc = pc;` |
|    43557 | 3413 | `	rcOp = VmExecOpMember(&(*pVm),&sState,pInstr);` |
|    43557 | 3414 | `	pTos = sState.pTos;` |
|    43557 | 3415 | `	pc = sState.pc;` |
|    43557 | 3416 | `	if( rcOp == VM_OP_ABORT ){` |
|        8 | 3417 | `		goto Abort;` |
|    43551 | 3418 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3426 | ` */` |
|     2373 | 3427 | `case PH7_OP_NEW: {` |
|        - | 3428 | `	VmOpRc rcOp;` |
|     4751 | 3429 | `	sState.pTos = pTos;` |
|     4751 | 3430 | `	sState.pc = pc;` |
|     4751 | 3431 | `	rcOp = VmExecOpNew(&(*pVm),&sState,pInstr);` |
|     4751 | 3432 | `	pTos = sState.pTos;` |
|     4751 | 3433 | `	pc = sState.pc;` |
|     4751 | 3434 | `	if( rcOp == VM_OP_ABORT ){` |
|        5 | 3435 | `		goto Abort;` |
|     4747 | 3436 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|  1035164 | 3813 | `	sxi32 nCallArgs = pInstr->iP1 + (pInstr->iP2 ? VmSpreadOwnExtra(pVm,pInstr->iP1,pTos) : 0);` |
|        - | 3814 | `	ph7_value *pArg;` |
|  1035164 | 3815 | `	pArg = &pTos[-nCallArgs];` |
...
|  1035164 | 3824 | `	VmCallArgMap *pEffCallMap = (VmCallArgMap *)pInstr->p3;` |
...
|  1035164 | 3831 | `	if( VmValueIsClosure(pVm,pTos) ){` |
...
|  1035164 | 3841 | `	if( (pTos->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|      142 | 4036 | `		break;` |
|        - | 4037 | `	}` |
|  1035004 | 4038 | `	SyStringInitFromBuf(&sName,SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
...
|  1035004 | 4042 | `	if( sName.nByte > 0 && sName.zString[0] == '\\' ){` |
...
|  1035004 | 4049 | `	pEntry = SyHashGet(&pVm->hFunction,(const void *)sName.zString,sName.nByte);` |
...
|        - | 4055 | `	{` |
|  1035004 | 4056 | `	VmCallArgMap *pCallMap = pEffCallMap;` |
|  1035004 | 4057 | `	if( pEntry == 0 && pCallMap && pCallMap->bIsNamespaced ){` |
...
|        - | 4088 | `		VmSlot sArg;` |
|        - | 4089 | `		sxu32 n;` |
|   104072 | 4090 | `		int bClosureThis = 0;` |
|   104072 | 4091 | `		ph7_class *pClosureScope = 0;` |
|        - | 4092 | `		/* initialize fields */` |
|   104072 | 4093 | `		pVmFunc = (ph7_vm_func *)pEntry->pUserData;` |
|   104072 | 4094 | `		pThis = 0;` |
|   104072 | 4095 | `		pSelf = 0;` |
...
|       14 | 4110 | `		}` |
|   104072 | 4111 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
|        - | 4112 | `			ph7_class_method *pMeth;` |
|        - | 4113 | `			/* Class method call */` |
|    24919 | 4114 | `			ph7_value *pTarget = &pTos[-1];` |
|    24919 | 4115 | `			if( pTarget >= pStack && (pTarget->iFlags & (MEMOBJ_STRING\|MEMOBJ_OBJ\|MEMOBJ_NULL)) ){` |
|        - | 4116 | `				/* Extract the 'this' pointer */` |
|    24919 | 4117 | `				if(pTarget->iFlags & MEMOBJ_OBJ ){` |
|        - | 4118 | `					/* Instance already loaded */` |
|    23883 | 4119 | `					pThis = (ph7_class_instance *)pTarget->x.pOther;` |
|    23883 | 4120 | `					pThis->iRef++;` |
|    23883 | 4121 | `					pSelf = pThis->pClass;` |
|    11939 | 4122 | `				}` |
|    24919 | 4123 | `				if( pSelf == 0 ){` |
...
|      353 | 4142 | `					}` |
|      518 | 4143 | `				}` |
|    24919 | 4144 | `				VmPopOperand(&pTos,1);` |
|    24919 | 4145 | `				PH7_MemObjRelease(pTos);` |
...
|    24919 | 4152 | `				nCallArgs = pInstr->iP1 + (pInstr->iP2 ? VmSpreadOwnExtra(&(*pVm),pInstr->iP1,pTos) : 0);` |
|    24919 | 4153 | `				pArg = &pTos[-nCallArgs];` |
...
|        - | 4158 | `				 */` |
|    24919 | 4159 | `				while( pArg < pStack ){` |
|      ! 0 | 4160 | `					pArg++;` |
|      ! 0 | 4161 | `				}` |
|    24919 | 4162 | `				if( pSelf && pVm->bReflectBypass ){` |
...
|        6 | 4167 | `				}else` |
|    24909 | 4168 | `				if( pSelf ){ /* Paranoid edition */` |
...
|    24909 | 4176 | `					ph7_class *pDeclClass = pVmFunc->pUserData ? (ph7_class *)pVmFunc->pUserData : pSelf;` |
|    24909 | 4177 | `					pMeth = PH7_ClassExtractMethod(pDeclClass,pVmFunc->sName.zString,pVmFunc->sName.nByte);` |
|    24909 | 4178 | `					if( pMeth == 0 && pDeclClass != pSelf ){` |
|      ! 0 | 4179 | `						pMeth = PH7_ClassExtractMethod(pSelf,pVmFunc->sName.zString,pVmFunc->sName.nByte);` |
|      ! 0 | 4180 | `					}` |
|    24909 | 4181 | `					if( pMeth && pMeth->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|   156207 | 4218 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   104067 | 4219 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
...
|   104072 | 4226 | `		if( VmRecursionExceeded(pVm) ){` |
...
|        3 | 4230 | `			goto Abort;` |
|        - | 4231 | `		}` |
|   104070 | 4232 | `		if( pVmFunc->pNextName ){` |
...
|   104070 | 4244 | `		pSelfHint = pSelf;` |
|   104070 | 4245 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
|    24919 | 4246 | `			ph7_class *pDecl = (ph7_class *)pVmFunc->pUserData;` |
|    24919 | 4247 | `			if( pDecl && (pDecl->iFlags & PH7_CLASS_TRAIT) == 0 ){` |
|    23901 | 4248 | `				pSelfHint = pDecl;` |
|    11948 | 4249 | `			}` |
|    12457 | 4250 | `		}` |
|   104070 | 4251 | `		if( pSelf == 0 && (pVmFunc->iFlags & VM_FUNC_CLOSURE) ){` |
...
|       29 | 4262 | `			}` |
|      871 | 4263 | `		}` |
|   104070 | 4264 | `		if( SySetUsed(&pVmFunc->aAttrs) > 0 ){` |
...
|       57 | 4269 | `		}` |
|   104070 | 4270 | `		if( pVmFunc->iFlags & VM_FUNC_GENERATOR ){` |
...
|   103730 | 4502 | `		aFormalArg = (ph7_vm_func_arg *)SySetBasePtr(&pVmFunc->aArgs);` |
|        - | 4503 | `		/* Create a new VM frame  */` |
|   103730 | 4504 | `		rc = VmEnterFrame(&(*pVm),pVmFunc,pThis,&pFrame);` |
|   103730 | 4505 | `		if( rc != SXRET_OK ){` |
...
|   103730 | 4533 | `		pFrame->nActualArgs = (int)(pTos - pArg);` |
|   103730 | 4534 | `		if( pThis && ((pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) \|\| bClosureThis) ){` |
...
|    24067 | 4537 | `			pObj = VmExtractMemObj(&(*pVm),&sThis,FALSE,TRUE);` |
|    24067 | 4538 | `			if( pObj ){` |
|        - | 4539 | `				/* Reflect the change */` |
|    24067 | 4540 | `				pObj->x.pOther = pThis;` |
|    24067 | 4541 | `				MemObjSetType(pObj,MEMOBJ_OBJ);` |
|    12031 | 4542 | `			}` |
|    12031 | 4543 | `		}` |
|   103730 | 4544 | `		if( SySetUsed(&pVmFunc->aStatic) > 0 ){` |
|        - | 4545 | `			ph7_vm_func_static_var *pStatic,*aStatic;` |
|        - | 4546 | `			/* Install static variables */` |
|     1103 | 4547 | `			aStatic = (ph7_vm_func_static_var *)SySetBasePtr(&pVmFunc->aStatic);` |
|     2201 | 4548 | `			for( n = 0 ; n < SySetUsed(&pVmFunc->aStatic) ; ++n ){` |
|     1103 | 4549 | `				pStatic = &aStatic[n];` |
|     1103 | 4550 | `				if( pStatic->nIdx == SXU32_HIGH ){` |
|        - | 4551 | `					/* Initialize the static variables */` |
|       31 | 4552 | `					pObj = VmReserveMemObj(&(*pVm),&pStatic->nIdx);` |
|       31 | 4553 | `					if( pObj ){` |
|        - | 4554 | `						/* Assume a NULL initialization value */` |
|       31 | 4555 | `						PH7_MemObjInit(&(*pVm),pObj);` |
|       31 | 4556 | `						if( SySetUsed(&pStatic->aByteCode) > 0 ){` |
|        - | 4557 | `							/* Evaluate initialization expression (Any complex expression) */` |
|       31 | 4558 | `							VmLocalExec(&(*pVm),&pStatic->aByteCode,pObj,FALSE);` |
|       13 | 4559 | `						}` |
|       31 | 4560 | `						pObj->nIdx = pStatic->nIdx;` |
|       18 | 4561 | `					}else{` |
|      ! 0 | 4562 | `						continue;` |
|        - | 4563 | `					}` |
|       13 | 4564 | `				}` |
|        - | 4565 | `				/* Install in the current frame */` |
|     1652 | 4566 | `				SyHashInsert(&pFrame->hVar,SyStringData(&pStatic->sName),SyStringLength(&pStatic->sName),` |
|     1098 | 4567 | `					SX_INT_TO_PTR(pStatic->nIdx));` |
|      554 | 4568 | `			}` |
|      549 | 4569 | `		}` |
|        - | 4570 | `		/* Push arguments in the local frame */` |
|        - | 4571 | `		{` |
|   103730 | 4572 | `		VmCallArgMap *pCallMap3 = pEffCallMap;` |
|        - | 4573 | `		/* Caller file's strict_types mode — governs parameter coercion` |
|        - | 4574 | `		 * (but NOT return coercion, which uses the callee's file). */` |
|   103730 | 4575 | `		int bCallIsStrict = (pCallMap3 && pCallMap3->bStrict) ? 1 : 0;` |
|   103730 | 4576 | `		if( pCallMap3 && pCallMap3->bHasNamed ){` |
|        - | 4577 | `			/* ============================================================` |
...
|        - | 4962 | `		 * ============================================================ */` |
|   103462 | 4963 | `		n = 0;` |
|   263174 | 4964 | `		while( pArg < pTos ){` |
|   160017 | 4965 | `			if( n < SySetUsed(&pVmFunc->aArgs) && (aFormalArg[n].iFlags & VM_FUNC_ARG_VARIADIC) ){` |
...
|        - | 5065 | `			}` |
|   159817 | 5066 | `			if( n < SySetUsed(&pVmFunc->aArgs) ){` |
...
|   159347 | 5073 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_UNION ){` |
...
|   159260 | 5106 | `				if( aFormalArg[n].nType > 0` |
|    86860 | 5107 | `					&& !((aFormalArg[n].iFlags & VM_FUNC_ARG_NULLABLE) && (pArg->iFlags & MEMOBJ_NULL)) ){` |
...
|       13 | 5183 | `					}` |
|     6967 | 5184 | `				}` |
|   159249 | 5185 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_BY_REF ){` |
...
|   159009 | 5237 | `					pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|        - | 5238 | `				}` |
|    79829 | 5239 | `			}else{` |
|        - | 5240 | `				char zName[32];` |
...
|        - | 5247 | `			}` |
|   159717 | 5248 | `			if( pObj ){` |
|   159481 | 5249 | `				PH7_MemObjStore(pArg,pObj);` |
|        - | 5250 | `				/* Insert argument index  */` |
|   159481 | 5251 | `				sArg.nIdx = pObj->nIdx;` |
|   159481 | 5252 | `				sArg.pUserData = 0;` |
|   159481 | 5253 | `				SySetPut(&pFrame->sArg,(const void *)&sArg);` |
|    79941 | 5254 | `			}` |
|   159717 | 5255 | `			PH7_MemObjRelease(pArg);` |
|   159717 | 5256 | `			pArg++;` |
|   159717 | 5257 | `			++n;` |
|        5 | 5258 | `		}` |
|        - | 5259 | `		} /* end named vs positional branch */` |
|        - | 5260 | `		/* Set up closure environment */` |
|   103608 | 5261 | `		if( pVmFunc->iFlags & VM_FUNC_CLOSURE ){` |
...
|      138 | 5286 | `					continue;` |
|        - | 5287 | `				}` |
|      229 | 5288 | `				pValue = VmExtractMemObj(pVm,&pEnv->sName,FALSE,TRUE);` |
|      229 | 5289 | `				if( pValue == 0 ){` |
|      ! 0 | 5290 | `					continue;` |
|        - | 5291 | `				}` |
|        - | 5292 | `				/* Invalidate any prior representation */` |
|      229 | 5293 | `				PH7_MemObjRelease(pValue);` |
|        - | 5294 | `				/* Duplicate bound variable value */` |
|      229 | 5295 | `				PH7_MemObjStore(&pEnv->sValue,pValue);` |
|      116 | 5296 | `			}` |
|      862 | 5297 | `		}` |
...
|   103603 | 5309 | `		if( n < SySetUsed(&pVmFunc->aArgs)` |
|    54458 | 5310 | `		 && (pVmFunc->iFlags & (VM_FUNC_INTERNAL\|VM_FUNC_CLASS_METHOD)) != VM_FUNC_INTERNAL ){` |
|        - | 5311 | `			sxu32 nNonVar,nReq;` |
|     3855 | 5312 | `			nReq = VmFuncRequiredArgCount(pVmFunc,&nNonVar);` |
|     3855 | 5313 | `			if( n < nReq ){` |
...
|   111496 | 5333 | `		while( n < SySetUsed(&pVmFunc->aArgs) ){` |
|     8159 | 5334 | `			if( aFormalArg[n].iFlags & VM_FUNC_ARG_VARIADIC ){` |
...
|        - | 5345 | `			}` |
|     7915 | 5346 | `			if( SySetUsed(&aFormalArg[n].aByteCode) > 0 ){` |
|     7913 | 5347 | `				pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|     7913 | 5348 | `				if( pObj ){` |
|        - | 5349 | `					/* Evaluate the default value and extract it's result */` |
|     7913 | 5350 | `					rc = VmLocalExec(&(*pVm),&aFormalArg[n].aByteCode,pObj,FALSE);` |
|     7913 | 5351 | `					if( rc == PH7_ABORT ){` |
|      ! 0 | 5352 | `						goto Abort;` |
|        - | 5353 | `					}` |
|        - | 5354 | `					/* Insert argument index */` |
|     7913 | 5355 | `					sArg.nIdx = pObj->nIdx;` |
|     7913 | 5356 | `					sArg.pUserData = 0;` |
|     7913 | 5357 | `					SySetPut(&pFrame->sArg,(const void *)&sArg);` |
...
|     7908 | 5362 | `					if( aFormalArg[n].nType > 0 && aFormalArg[n].nType != MEMOBJ_OBJ` |
|     3868 | 5363 | `						&& ((pObj->iFlags & aFormalArg[n].nType) == 0)` |
|     1940 | 5364 | `						&& !((aFormalArg[n].iFlags & VM_FUNC_ARG_NULLABLE) && (pObj->iFlags & MEMOBJ_NULL)) ){` |
...
|        - | 5376 | `		 */` |
|   103586 | 5377 | `		PH7_MemObjRelease(pTos);` |
|   103586 | 5378 | `		pTos = &pTos[-nCallArgs];` |
...
|        - | 5390 | `		 * per function. */` |
|        - | 5391 | `		{` |
|   103586 | 5392 | `			sxu32 nSlots = pVmFunc->nMaxStack;` |
|   103586 | 5393 | `			if( nSlots == 0 ){` |
|     7641 | 5394 | `				sxu32 nInstr = SySetUsed(&pVmFunc->aByteCode);` |
|    11459 | 5395 | `				sxu32 nTight = VmComputeMaxStack(&(*pVm),` |
|     7636 | 5396 | `					(VmInstr *)SySetBasePtr(&pVmFunc->aByteCode),nInstr);` |
|     7641 | 5397 | `				nSlots = ( nTight == VM_STACK_UNMODELED ) ? nInstr : nTight;` |
|     7641 | 5398 | `				if( nSlots == 0 ){ nSlots = 1; } /* a 0-depth body still needs a valid, nonzero cache marker */` |
|     7641 | 5399 | `				pVmFunc->nMaxStack = nSlots;` |
|     3818 | 5400 | `			}` |
|   103586 | 5401 | `			pFrameStack = VmOperandStackAlloc(&(*pVm),nSlots);` |
|        - | 5402 | `		}` |
|   103586 | 5403 | `		if( pFrameStack == 0 ){` |
...
|      ! 0 | 5410 | `			break;` |
|        - | 5411 | `		}` |
|    51689 | 5412 | `SkipFuncBody:` |
|   103720 | 5413 | `		if( pSelf ){` |
|        - | 5414 | `			/* Push class name */` |
|    24973 | 5415 | `			SySetPut(&pVm->aSelf,(const void *)&pSelf);` |
|    12484 | 5416 | `		}` |
|        - | 5417 | `		/* Increment nesting level */` |
|   103720 | 5418 | `		pVm->nRecursionDepth++;` |
|   103720 | 5419 | `		if( rc == PH7_EXCEPTION ){` |
...
|   103586 | 5448 | `			VmCallFrame *pRec = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   103586 | 5449 | `			if( pRec ){` |
|   100974 | 5450 | `				pVm->pIdleCallFrames = (void *)pRec->pPrev;` |
|    50591 | 5451 | `			}else{` |
|     2617 | 5452 | `				pRec = (VmCallFrame *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmCallFrame));` |
|        - | 5453 | `			}` |
|   103586 | 5454 | `			if( pRec == 0 ){` |
...
|      ! 0 | 5465 | `				goto Abort;` |
|        - | 5466 | `			}` |
|   103586 | 5467 | `			sState.pTos = pTos;` |
|   103586 | 5468 | `			sState.pc = pc;` |
|   103586 | 5469 | `			pRec->sCaller = sState;` |
|   103586 | 5470 | `			pRec->sCall.pVmFunc = pVmFunc;` |
|   103586 | 5471 | `			pRec->sCall.pFrame = pFrame;` |
|   103586 | 5472 | `			pRec->sCall.pFrameStack = pFrameStack;` |
|   103586 | 5473 | `			pRec->sCall.nStackCap = pVmFunc->nMaxStack + VM_STACK_GUARD;` |
|   103586 | 5474 | `			pRec->sCall.nLastRef = SXU32_HIGH;` |
|   103586 | 5475 | `			pRec->sCall.bSelfPushed = (sxu8)(pSelf ? 1 : 0);` |
|   103586 | 5476 | `			pRec->pPrev = pCallTop;` |
|   103586 | 5477 | `			pCallTop = pRec;` |
|        - | 5478 | `			/* Switch to the callee activation (what the recursive` |
|        - | 5479 | `			 * VmByteCodeExec entry used to set up). */` |
|   103586 | 5480 | `			aInstr = (VmInstr *)SySetBasePtr(&pVmFunc->aByteCode);` |
|   103586 | 5481 | `			pStack = pFrameStack;` |
|   103586 | 5482 | `			pTos = &pStack[-1];` |
|   103586 | 5483 | `			pc = 0;` |
|   103586 | 5484 | `			sState.aInstr = aInstr;` |
|   103586 | 5485 | `			sState.pStack = pStack;` |
|   103586 | 5486 | `			sState.nStackCap = pRec->sCall.nStackCap; /* callee's operand-stack capacity for OP_SPREAD growth */` |
|   103586 | 5487 | `			sState.nStackOrig = pRec->sCall.nStackCap; /* fixed headroom reference (never grows) */` |
|   103586 | 5488 | `			sState.pTos = pTos;` |
|   103586 | 5489 | `			sState.pc = 0;` |
|   103586 | 5490 | `			sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|   103586 | 5491 | `			sState.pEntryFrame = pVm->pFrame;` |
|   103586 | 5492 | `			sState.pResult = pRec->sCaller.pTos;` |
|   103586 | 5493 | `			sState.pLastRef = &pRec->sCall.nLastRef;` |
|   103586 | 5494 | `			sState.pEnforceRetFunc = VmFuncHasReturnType(pVmFunc) ? pVmFunc : 0;` |
|   103586 | 5495 | `			sState.is_callback = 0;` |
|   103586 | 5496 | `			sState.bReturnPropagates = 0;` |
|   103586 | 5497 | `			goto VmLoopFetch;` |
|        - | 5498 | `		}` |
|       57 | 5499 | `	}else{` |
...
|   930937 | 5508 | `		pEntry = SyHashGet(&pVm->hHostFunction,(const void *)sName.zString,sName.nByte);` |
|        - | 5509 | `		{` |
|   930937 | 5510 | `		VmCallArgMap *pCallMap2 = pEffCallMap;` |
|   930937 | 5511 | `		if( pEntry == 0 && pCallMap2 && pCallMap2->bIsNamespaced ){` |
...
|        - | 5616 | `			}` |
|        - | 5617 | `		}` |
|   930921 | 5618 | `		pFunc = (ph7_user_func *)pEntry->pUserData;` |
...
|  1396736 | 5623 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   930916 | 5624 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
|        - | 5625 | `		/* Start collecting function arguments */` |
|   930921 | 5626 | `		SySetReset(&aArg);` |
|  2516066 | 5627 | `		while( pArg < pTos ){` |
|  1585150 | 5628 | `			SySetPut(&aArg,(const void *)&pArg);` |
|  1585150 | 5629 | `			pArg++;` |
|        5 | 5630 | `		}` |
|        - | 5631 | `		/* Assume a null return value */` |
|   930921 | 5632 | `		PH7_MemObjInit(&(*pVm),&sRet);` |
|        - | 5633 | `		/* Init the call context */` |
|   930921 | 5634 | `		VmInitCallContext(&sCtx,&(*pVm),pFunc,&sRet,0);` |
...
|   930921 | 5641 | `		sCtx.pArgMap = pEffCallMap;` |
|        - | 5642 | `		{` |
|   930921 | 5643 | `		int nGiven = (int)SySetUsed(&aArg);` |
...
|   930921 | 5649 | `		if( pFunc->nMinArg > 0 && nGiven < pFunc->nMinArg ){` |
...
|      232 | 5656 | `				nGiven);` |
|  1396272 | 5657 | `		}else if( SXRET_OK != (rc = VmEnforceBuiltinArgTypes(&sCtx,pFunc,nGiven,` |
|   930452 | 5658 | `			(ph7_value **)SySetBasePtr(&aArg))) ){` |
|        - | 5659 | `			/* TypeError thrown: rc carries the caught/uncaught status */` |
|       91 | 5660 | `		}else{` |
|        - | 5661 | `			/* Call the foreign function */` |
|   930285 | 5662 | `			rc = pFunc->xFunc(&sCtx,nGiven,(ph7_value **)SySetBasePtr(&aArg));` |
|        - | 5663 | `		}` |
|        - | 5664 | `		}` |
|        - | 5665 | `		/* Release the call context */` |
|   930921 | 5666 | `		VmReleaseCallContext(&sCtx);` |
|   930921 | 5667 | `		if( rc == PH7_ABORT ){` |
...
|      576 | 5672 | `			goto Abort;` |
|        - | 5673 | `		}` |
|   930349 | 5674 | `		if( rc != PH7_SUSPEND && pVm->pInlineInstr == (void *)aInstr ){` |
...
|      ! 0 | 5687 | `		}` |
|   930345 | 5688 | `		if( rc == PH7_EXCEPTION ){` |
...
|      771 | 5708 | `			break;` |
|        - | 5709 | `		}` |
|   929383 | 5710 | `		if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|   907963 | 5734 | `			VmPopOperand(&pTos,nCallArgs);` |
|   454336 | 5735 | `		}` |
|        - | 5736 | `		/* Save foreign function return value into the (now top) function-name slot */` |
|   929029 | 5737 | `		PH7_MemObjStore(&sRet,pTos);` |
|   929029 | 5738 | `		PH7_MemObjRelease(&sRet);` |
|        - | 5739 | `	}` |
|   929133 | 5740 | `	break;` |
|        - | 5741 | `				  }` |
|        - | 5742 | `/*` |
...
|        - | 5745 | ` */` |
|    25477 | 5746 | `case PH7_OP_CONSUME: {` |
|        - | 5747 | `	VmOpRc rcOp;` |
|    50959 | 5748 | `	sState.pTos = pTos;` |
|    50959 | 5749 | `	sState.pc = pc;` |
|    50959 | 5750 | `	rcOp = VmExecOpConsume(&(*pVm),&sState,pInstr);` |
|    50959 | 5751 | `	pTos = sState.pTos;` |
|    50959 | 5752 | `	pc = sState.pc;` |
|    50959 | 5753 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 5754 | `		goto Abort;` |
|    50959 | 5755 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 5760 |  |
|        - | 5761 | `		} /* Switch() */` |
| 16385416 | 5762 | `		pc++; /* Next instruction in the stream */` |
|        5 | 5763 | `	} /* For(;;) */` |
|   127867 | 5764 | `Done:` |
...
|   255942 | 5768 | `	rc = SXRET_OK;` |
|   255942 | 5769 | `	goto Unwind;` |
|      823 | 5770 | `Suspend:` |
...
|   129863 | 5828 | `	for(;;){` |
|   259528 | 5829 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|      ! 0 | 5837 | `			}` |
|     1147 | 5838 | `		}` |
|   259528 | 5839 | `		if( pCallTop == 0 ){` |
|   156357 | 5840 | `			return VmExecFinalize(&(*pVm),&sState,&aArg,pTos,rc);` |
|        - | 5841 | `		}` |
|   103176 | 5842 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|      624 | 5848 | `		}` |
|        - | 5849 | `		{` |
|   103176 | 5850 | `			VmCallFrame *pRec = pCallTop;` |
|   103176 | 5851 | `			sState = pRec->sCaller;` |
|   103176 | 5852 | `			rc = VmCallFinish(&(*pVm),&sState,&pRec->sCall,rc);` |
|   103176 | 5853 | `			pCallTop = pRec->pPrev;` |
|   103176 | 5854 | `			pRec->pPrev = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   103176 | 5855 | `			pVm->pIdleCallFrames = (void *)pRec;` |
|   103176 | 5856 | `			aInstr = sState.aInstr;` |
|   103176 | 5857 | `			pStack = sState.pStack;` |
|   103176 | 5858 | `			pTos = sState.pTos;` |
|   103176 | 5859 | `			pc = sState.pc;` |
|        - | 5860 | `		}` |
|   103176 | 5861 | `		if( rc == PH7_OK ){` |
|   102414 | 5862 | `			pc++; /* the loop-bottom increment this OP_CALL missed */` |
|   102414 | 5863 | `			goto VmLoopFetch;` |
|        - | 5864 | `		}` |
|        5 | 5865 | `	}` |
|    78358 | 5866 | `}` |
|        - | 5867 |  |
