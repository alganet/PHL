...
|        - |  162 | ` */` |
|   161592 |  163 | `static sxi32 VmExecFinalize(ph7_vm *pVm,VmExecState *pState,SySet *pArg,ph7_value *pTos,sxi32 rcTerm)` |
|        5 |  164 | `{` |
|    80796 |  165 | `	SXUNUSED(pVm);` |
|   161597 |  166 | `	if( rcTerm != PH7_SUSPEND && !pState->bReturnPropagates ){` |
|   157901 |  167 | `		VmClearFrameReturn(pState->pEntryFrame);` |
|    78948 |  168 | `	}` |
|   161597 |  169 | `	SySetRelease(pArg);` |
|   161597 |  170 | `	if( rcTerm == PH7_ABORT \|\| rcTerm == PH7_EXCEPTION ){` |
|     2841 |  171 | `		while( pTos >= pState->pStack ){` |
|     1789 |  172 | `			PH7_MemObjRelease(pTos);` |
|     1789 |  173 | `			pTos--;` |
|        5 |  174 | `		}` |
|      526 |  175 | `	}` |
|   161597 |  176 | `	return rcTerm;` |
|        5 |  177 | `}` |
|        - |  178 | `/*` |
...
|        - |  189 | ` */` |
|   104749 |  190 | `static sxi32 VmCallFinish(ph7_vm *pVm,VmExecState *pCaller,VmCallRecord *pCallee,sxi32 rc)` |
|        5 |  191 | `{` |
|        - |  192 | `	ph7_value *pObj;` |
|        - |  193 | `	/* Decrement nesting level */` |
|   104754 |  194 | `	pVm->nRecursionDepth--;` |
|   104754 |  195 | `	if( pCallee->bSelfPushed ){` |
|        - |  196 | `		/* Pop class name */` |
|    25527 |  197 | `		(void)SySetPop(&pVm->aSelf);` |
|    12761 |  198 | `	}` |
|   104754 |  199 | `	if( (pCallee->pVmFunc->iFlags & VM_FUNC_REF_RETURN) && rc == SXRET_OK ){` |
...
|       25 |  225 | `	}` |
|   104754 |  226 | `	if( rc != PH7_ABORT && ((pCallee->pFrame->iFlags & VM_FRAME_THROW) \|\| rc == PH7_EXCEPTION) ){` |
...
|   104754 |  272 | `	if( rc != PH7_SUSPEND && pCallee->pFrameStack ){` |
...
|   104620 |  276 | `		VmOperandStackRecycle(pVm,pCallee->pFrameStack,pCallee->nStackCap);` |
|    52410 |  277 | `	}` |
|        - |  278 | `	/* Leave the frame */` |
|   104754 |  279 | `	VmLeaveFrame(&(*pVm));` |
|   104754 |  280 | `	if( rc == PH7_ABORT ){` |
|      336 |  281 | `		return PH7_ABORT;` |
|        - |  282 | `	}` |
|   104422 |  283 | `	if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|        - |  291 | `	}` |
|   104422 |  292 | `	if( rc == PH7_EXCEPTION ){` |
|      469 |  293 | `		return PH7_EXCEPTION;` |
|        - |  294 | `	}` |
|   103958 |  295 | `	return PH7_OK;` |
|    52482 |  296 | `}` |
|        - |  297 | `/*` |
...
|        - |  330 | ` * nesting.` |
|        - |  331 | ` */` |
|   161950 |  332 | `PH7_PRIVATE sxi32 VmByteCodeExec(` |
...
|   161955 |  352 | `	if( VmNativeNestingExceeded(pVm) ){` |
...
|   161951 |  362 | `	nSavedBrc = pVm->nBoundaryRc;` |
|   161951 |  363 | `	pVm->nBoundaryRc = 0;` |
...
|   161951 |  370 | `	nSavedLine = pVm->nCurLine;` |
|   161951 |  371 | `	pVm->nVmExecDepth++;` |
|   242924 |  372 | `	rc = VmByteCodeExecBody(&(*pVm),aInstr,pStack,nTos,pResult,pLastRef,is_callback,nPc,` |
|    80973 |  373 | `		pEnforceRetFunc,bReturnPropagates,pAdoptSegment,ppBaseOwner,pnBaseCap,nStackOrig);` |
|   161951 |  374 | `	pVm->nVmExecDepth--;` |
|   161951 |  375 | `	pVm->nCurLine = nSavedLine;` |
|   161951 |  376 | `	if( nSavedBrc != 0 && (nSavedBrc == PH7_ABORT \|\| pVm->nBoundaryRc == 0) ){` |
|       15 |  377 | `		pVm->nBoundaryRc = nSavedBrc;` |
|        6 |  378 | `	}` |
|   161951 |  379 | `	return rc;` |
|    80980 |  380 | `}` |
|   161946 |  381 | `static sxi32 VmByteCodeExecBody(` |
...
|        - |  399 | `	ph7_value *pTos;` |
|        - |  400 | `	SySet aArg;` |
|   161951 |  401 | `	VmCallFrame *pCallTop = 0; /* Top of this invocation's in-loop call-record` |
...
|        - |  409 | `	sxi32 pc;` |
|        - |  410 | `	sxi32 rc;` |
|   161951 |  411 | `	sState.aInstr = aInstr;` |
|   161951 |  412 | `	sState.pStack = pStack;` |
|   161951 |  413 | `	sState.nStackCap = pnBaseCap ? *pnBaseCap : 0; /* CURRENT capacity (grown on a coroutine resume) */` |
|   161951 |  414 | `	sState.nStackOrig = nStackOrig;                /* ORIGINAL capacity — fixed headroom reference */` |
|   161951 |  415 | `	sState.pResult = pResult;` |
|   161951 |  416 | `	sState.pLastRef = pLastRef;` |
|   161951 |  417 | `	sState.pEnforceRetFunc = pEnforceRetFunc;` |
|   161951 |  418 | `	sState.is_callback = (sxu8)(is_callback ? 1 : 0);` |
|   161951 |  419 | `	sState.bReturnPropagates = (sxu8)(bReturnPropagates ? 1 : 0);` |
|        - |  420 | `	/* Argument container */` |
|   161951 |  421 | `	SySetInit(&aArg,&pVm->sAllocator,sizeof(ph7_value *));` |
|   161951 |  422 | `	if( nTos < 0 ){` |
|   146163 |  423 | `		pTos = &pStack[-1];` |
|    73084 |  424 | `	}else{` |
|    15793 |  425 | `		pTos = &pStack[nTos];` |
|        - |  426 | `	}` |
|   161951 |  427 | `	sState.pTos = pTos;` |
|   161951 |  428 | `	sState.pc = nPc;` |
...
|   161946 |  446 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->pFrame == pVm->pFrame` |
|     2816 |  447 | `	 && pStack == pVm->pActiveCtx->pStack ){` |
|     1805 |  448 | `		sState.nExceptionBase = pVm->pActiveCtx->nExceptionBase;` |
|      905 |  449 | `	}else{` |
|   160151 |  450 | `		sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|        - |  451 | `	}` |
|   161951 |  452 | `	sState.pEntryFrame = pVm->pFrame;` |
|   161951 |  453 | `	pc = nPc;` |
...
|   161946 |  506 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->pInjected` |
...
|   161936 |  567 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->bClosing` |
...
| 17073181 |  603 | `		if( pVm->nBoundaryRc != 0 \|\| SySetUsed(&pVm->aHookRmw) > 0 ){` |
...
| 17073081 |  658 | `		pInstr = &aInstr[pc];` |
| 17073081 |  659 | `		if( pInstr->nLine ){` |
...
| 16859904 |  663 | `			pVm->nCurLine = pInstr->nLine;` |
|  8436278 |  664 | `		}` |
| 17073081 |  665 | `		rc = SXRET_OK;` |
|        - |  666 | `/*` |
...
|        - |  672 | ` */` |
| 17073081 |  673 | `		switch(pInstr->iOp){` |
|        - |  674 | `/*` |
|        - |  675 | ` * DONE: P1 * *` |
|        - |  676 | ` *` |
...
|        - |  679 | ` */` |
|   131093 |  680 | `case PH7_OP_DONE:` |
|   262396 |  681 | `	if( pInstr->iP2 && sState.bReturnPropagates ){` |
...
|   262207 |  711 | `	if( sState.pEnforceRetFunc && VmFuncHasReturnType(sState.pEnforceRetFunc)` |
...
|     4591 |  736 | `	}` |
|   262188 |  737 | `	if( pInstr->iP1 && pTos >= pStack ){` |
|   157416 |  738 | `		if( sState.pLastRef ){` |
|    94248 |  739 | `			*sState.pLastRef = pTos->nIdx;` |
|    47224 |  740 | `		}` |
|   157416 |  741 | `		if( sState.pResult ){` |
|        - |  742 | `			/* Execution result */` |
|   150340 |  743 | `			PH7_MemObjStore(pTos,sState.pResult);` |
|    75270 |  744 | `		}` |
|   157416 |  745 | `		VmPopOperand(&pTos,1);` |
|   183585 |  746 | `	}else if( sState.pLastRef ){` |
...
|        - |  762 | `	 */` |
|   262188 |  763 | `	rc = VmDrainFinally(&(*pVm),sState.nExceptionBase);` |
|   262188 |  764 | `	if( rc == SXERR_ABORT ){` |
|      ! 0 |  765 | `		goto Abort;` |
|        - |  766 | `	}` |
|   262188 |  767 | `	if( rc == PH7_EXCEPTION ){` |
...
|        - |  778 | `	}` |
|   262184 |  779 | `	if( sState.pEntryFrame->bHasRet && !sState.bReturnPropagates ){` |
...
|        - |  835 | ` */` |
|   279800 |  836 | `case PH7_OP_JMP:` |
|   559811 |  837 | `	pc = pInstr->iP2 - 1;` |
|   559811 |  838 | `	break;` |
|        - |  839 | `/*` |
|        - |  840 | ` * JZ: P1 P2 *` |
|        - |  841 | ` *` |
...
|  1635354 |  852 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     1001 |  853 | `		PH7_MemObjToBool(pTos);` |
|      499 |  854 | `	}` |
|  1635354 |  855 | `	if( !pTos->x.iVal ){` |
|        - |  856 | `		/* Take the jump */` |
|   927818 |  857 | `		pc = pInstr->iP2 - 1;` |
|   464167 |  858 | `	}` |
|  1635354 |  859 | `	if( !pInstr->iP1 ){` |
|  1392698 |  860 | `		VmPopOperand(&pTos,1);` |
|   696915 |  861 | `	}` |
|  1635354 |  862 | `	break;` |
|        - |  863 | `/*` |
|        - |  864 | ` * JNZ: P1 P2 *` |
...
|   185162 |  876 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      ! 0 |  877 | `		PH7_MemObjToBool(pTos);` |
|      ! 0 |  878 | `	}` |
|   185162 |  879 | `	if( pTos->x.iVal ){` |
|        - |  880 | `		/* Take the jump */` |
|     9565 |  881 | `		pc = pInstr->iP2 - 1;` |
|     4780 |  882 | `	}` |
|   185162 |  883 | `	if( !pInstr->iP1 ){` |
...
|        - |  899 | ` */` |
|   683962 |  900 | `case PH7_OP_POP: {` |
|  1368955 |  901 | `	sxi32 n = pInstr->iP1;` |
|  1368955 |  902 | `	if( &pTos[-n+1] < pStack ){` |
|        - |  903 | `		/* TICKET 1433-51 Stack underflow must be handled at run-time */` |
|       79 |  904 | `		n = (sxi32)(pTos - pStack);` |
|       38 |  905 | `	}` |
|  1368955 |  906 | `	VmPopOperand(&pTos,n);` |
|  1368955 |  907 | `	break;` |
|        - |  908 | `				 }` |
|        - |  909 | `/*` |
|        - |  910 | ` * DUP: * * *` |
...
|        - |  929 | ` */` |
|    49093 |  930 | `case PH7_OP_NSSWITCH:` |
|    98191 |  931 | `	SyBlobReset(&pVm->sNamespace);` |
|    98191 |  932 | `	if( pInstr->p3 ){` |
...
|    98191 |  937 | `	SyHashRelease(&pVm->hUseConstImports);` |
|    98191 |  938 | `	SyHashInit(&pVm->hUseConstImports,&pVm->sAllocator,0,0);` |
|    98191 |  939 | `	break;` |
...
|        - | 1163 | ` */` |
|  1556871 | 1164 | `case PH7_OP_LOADC: {` |
|        - | 1165 | `	ph7_value *pObj;` |
|        - | 1166 | `	/* Reserve a room */` |
|  3115612 | 1167 | `	pTos++;` |
|  3115612 | 1168 | `	if( pInstr->iP1 & PH7_LOADC_NOKEY ){` |
...
|    19469 | 1174 | `		break;` |
|        - | 1175 | `	}` |
|  3096148 | 1176 | `	if( (pObj = (ph7_value *)SySetAt(&pVm->aLitObj,pInstr->iP2)) != 0 ){` |
|  3096148 | 1177 | `		if( (pInstr->iP1 & PH7_LOADC_EXPAND) && SyBlobLength(&pObj->sBlob) <= 64 ){` |
|        - | 1178 | `			SyHashEntry *pEntry;` |
|        - | 1179 | `			/* Check use const imports first — imports take precedence */` |
|        - | 1180 | `			{` |
|        - | 1181 | `				SyHashEntry *pConstImport;` |
|    34904 | 1182 | `				pConstImport = SyHashGet(&pVm->hUseConstImports,` |
|    23266 | 1183 | `					SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|    23271 | 1184 | `				if( pConstImport ){` |
...
|    23261 | 1199 | `			pEntry = SyHashGet(&pVm->hConstant,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|    23261 | 1200 | `			if( pEntry ){` |
|    23251 | 1201 | `				ph7_constant *pCons = (ph7_constant *)pEntry->pUserData;` |
|        - | 1202 | `				/* Set a NULL default value */` |
|    23251 | 1203 | `				MemObjSetType(pTos,MEMOBJ_NULL);` |
|    23251 | 1204 | `				SyBlobReset(&pTos->sBlob);` |
|        - | 1205 | `				/* Invoke the callback and deal with the expanded value */` |
|    23251 | 1206 | `				VmExpandConstantWithNotice(&(*pVm),pCons,pTos);` |
|        - | 1207 | `				/* Mark as constant */` |
|    23251 | 1208 | `				pTos->nIdx = SXU32_HIGH;` |
|    23251 | 1209 | `				break;` |
|        - | 1210 | `			}` |
...
|        - | 1283 | ` */` |
|  2220570 | 1284 | `case PH7_OP_LOAD:{` |
|        - | 1285 | `	ph7_value *pObj;` |
|        - | 1286 | `	SyString sName;` |
|  4445060 | 1287 | `	if( pInstr->p3 == 0 ){` |
...
|        9 | 1299 | `	}else{` |
|  4445044 | 1300 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1301 | `		/* Reserve a room for the target object */` |
|  4445044 | 1302 | `		pTos++;` |
|        - | 1303 | `	}` |
|  4445060 | 1304 | `	if( pInstr->iP2 == 2 ){` |
...
|   398525 | 1310 | `		if( VmExtractMemObj(&(*pVm),&sName,FALSE,FALSE) == 0 ){` |
|        7 | 1311 | `			VmErrorFormat(&(*pVm),PH7_CTX_WARNING,"Undefined variable $%z",&sName);` |
|        3 | 1312 | `		}` |
|   199363 | 1313 | `	}` |
|        - | 1314 | `	/* Extract the requested memory object */` |
|  4445060 | 1315 | `	pObj = VmExtractMemObj(&(*pVm),&sName,pInstr->p3 ? FALSE : TRUE,pInstr->iP1 != 1);` |
|  4445060 | 1316 | `	if( pObj == 0 ){` |
...
|  4444998 | 1341 | `	PH7_MemObjLoad(pObj,pTos);` |
|  4444998 | 1342 | `	pTos->nIdx = pObj->nIdx;` |
|  4444998 | 1343 | `	break;` |
|        - | 1344 | `				   }` |
|        - | 1345 | `/*` |
|        - | 1346 | ` * LOAD_MAP P1 * *` |
...
|        - | 1351 | ` */` |
|    36956 | 1352 | `case PH7_OP_LOAD_MAP: {` |
|        - | 1353 | `	VmOpRc rcOp;` |
|    73917 | 1354 | `	sState.pTos = pTos;` |
|    73917 | 1355 | `	sState.pc = pc;` |
|    73917 | 1356 | `	rcOp = VmExecOpLoadMap(&(*pVm),&sState,pInstr);` |
|    73917 | 1357 | `	pTos = sState.pTos;` |
|    73917 | 1358 | `	pc = sState.pc;` |
|    73917 | 1359 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1360 | `		goto Abort;` |
|    73917 | 1361 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1394 | ` * instead.` |
|        - | 1395 | ` */` |
|   333501 | 1396 | `case PH7_OP_LOAD_IDX: {` |
|        - | 1397 | `	VmOpRc rcOp;` |
|   667733 | 1398 | `	sState.pTos = pTos;` |
|   667733 | 1399 | `	sState.pc = pc;` |
|   667733 | 1400 | `	rcOp = VmExecOpLoadIdx(&(*pVm),&sState,pInstr);` |
|   667733 | 1401 | `	pTos = sState.pTos;` |
|   667733 | 1402 | `	pc = sState.pc;` |
|   667733 | 1403 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1404 | `		goto Abort;` |
|   667733 | 1405 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1582 | `		}` |
|    11771 | 1583 | `		break;` |
|   621473 | 1584 | `	}else if( pInstr->p3 == 0 ){` |
...
|        - | 1596 | `#endif` |
|        5 | 1597 | `	}else{` |
|   621465 | 1598 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1599 | `	}` |
|   621468 | 1600 | `	if( sName.nByte == sizeof("GLOBALS")-1` |
|   312478 | 1601 | `	 && SyMemcmp((const void *)sName.zString,(const void *)"GLOBALS",sName.nByte) == 0 ){` |
|        6 | 1602 | `		if( pInstr->p3 ){` |
...
|        - | 1639 | ` */` |
|   120754 | 1640 | `case PH7_OP_STORE_IDX:` |
|        - | 1641 | `case PH7_OP_STORE_IDX_REF: {` |
|        - | 1642 | `	VmOpRc rcOp;` |
|   241513 | 1643 | `	sState.pTos = pTos;` |
|   241513 | 1644 | `	sState.pc = pc;` |
|   241513 | 1645 | `	rcOp = VmExecOpStoreIdxRef(&(*pVm),&sState,pInstr);` |
|   241513 | 1646 | `	pTos = sState.pTos;` |
|   241513 | 1647 | `	pc = sState.pc;` |
|   241513 | 1648 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 1649 | `		goto Abort;` |
|   241511 | 1650 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|   368702 | 1671 | `	PH7_ENFORCE_READONLY_MUTATE(pTos->nIdx);` |
...
|   368691 | 1676 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) != 0` |
|   184454 | 1677 | `	 && SySetUsed(&pVm->aHookRmw) > 0 ){` |
...
|        - | 1694 | `		}` |
|      ! 0 | 1695 | `	}` |
|   368694 | 1696 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) == 0 ){` |
|   368694 | 1697 | `		if( pTos->nIdx != SXU32_HIGH ){` |
|        - | 1698 | `			ph7_value *pObj;` |
|   368694 | 1699 | `			if( (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pTos->nIdx)) != 0 ){` |
|   368694 | 1700 | `				if( VmStringWantsPerlIncr(pObj) ){` |
...
|   368692 | 1719 | `					if( pInstr->iP1 == 0 && (pTos->iFlags & MEMOBJ_STRING) ){` |
|        9 | 1720 | `						SyBlobNullAppend(&pTos->sBlob);` |
|        3 | 1721 | `					}` |
|        - | 1722 | `					/* Force a numeric cast on the variable */` |
|   368692 | 1723 | `					PH7_MemObjToNumeric(pObj);` |
|   368692 | 1724 | `					if( pObj->iFlags & MEMOBJ_REAL ){` |
|        5 | 1725 | `						pObj->rVal++;` |
...
|        - | 1734 | `						sxi64 r;` |
|   368688 | 1735 | `						if( PH7_ADD_OVERFLOW64(pObj->x.iVal,1,&r) ){` |
...
|        - | 1741 | `#endif` |
|        3 | 1742 | `						}else{` |
|   368684 | 1743 | `							pObj->x.iVal = r;` |
|        - | 1744 | `						}` |
|        - | 1745 | `					}` |
|   368692 | 1746 | `					if( pInstr->iP1 ){` |
...
|        - | 1785 | `		}` |
|   184446 | 1786 | `	}` |
|   368692 | 1787 | `	PH7_HOOK_RMW_WRITEBACK(pTos->nIdx,pTos);` |
|   368692 | 1788 | `	break;` |
|        - | 1789 | `/*` |
|        - | 1790 | ` * DECR: P1 * *` |
|        - | 1791 | ` *` |
...
|    50806 | 1997 | `	if( (pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      145 | 1998 | `		PH7_MemObjToBool(pTos);` |
|       70 | 1999 | `	}` |
|    50806 | 2000 | `	pTos->x.iVal = !pTos->x.iVal;` |
|    50806 | 2001 | `	break;` |
|        - | 2002 | `/*` |
|        - | 2003 | ` * OP_BITNOT: * * *` |
|        - | 2004 | ` *` |
...
|        - | 2169 | ` */` |
|    12062 | 2170 | `case PH7_OP_SUB: {` |
|        - | 2171 | `	VmOpRc rcOp;` |
|    24240 | 2172 | `	sState.pTos = pTos;` |
|    24240 | 2173 | `	sState.pc = pc;` |
|    24240 | 2174 | `	rcOp = VmExecOpSub(&(*pVm),&sState,pInstr);` |
|    24240 | 2175 | `	pTos = sState.pTos;` |
|    24240 | 2176 | `	pc = sState.pc;` |
|    24240 | 2177 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2178 | `		goto Abort;` |
|    24240 | 2179 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2526 | ` * back.` |
|        - | 2527 | ` */` |
|    86575 | 2528 | `case PH7_OP_CAT:{` |
|        - | 2529 | `	ph7_value *pNos,*pCur;` |
|   173155 | 2530 | `	if( pInstr->iP1 < 1 ){` |
|   144693 | 2531 | `		pNos = &pTos[-1];` |
|    72349 | 2532 | `	}else{` |
...
|   173155 | 2541 | `	if( (pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|     1917 | 2542 | `		PH7_MemObjToString(pNos);` |
|      956 | 2543 | `	}` |
|   173155 | 2544 | `	pCur = &pNos[1];` |
|   349843 | 2545 | `	while( pCur <= pTos ){` |
|   176693 | 2546 | `		if( (pCur->iFlags & MEMOBJ_STRING) == 0 ){` |
|    52221 | 2547 | `			PH7_MemObjToString(pCur);` |
|    26108 | 2548 | `		}` |
|        - | 2549 | `		/* Perform the concatenation */` |
|   176693 | 2550 | `		if( SyBlobLength(&pCur->sBlob) > 0 ){` |
|   176545 | 2551 | `			if( PH7_MemObjStringAppend(pNos,(const char *)SyBlobData(&pCur->sBlob),SyBlobLength(&pCur->sBlob)) != SXRET_OK ){` |
|        - | 2552 | `				/* Allocation failure: raise a fatal instead of a truncated concat */` |
|      ! 0 | 2553 | `				PH7_VmMemoryError(&(*pVm));` |
|      ! 0 | 2554 | `				goto Abort;` |
|        - | 2555 | `			}` |
|    88270 | 2556 | `		}` |
|   176693 | 2557 | `		SyBlobRelease(&pCur->sBlob);` |
|   176693 | 2558 | `		pCur++;` |
|        5 | 2559 | `	}` |
|   173155 | 2560 | `	pTos = pNos;` |
|   173155 | 2561 | `	break;` |
|        - | 2562 | `				}` |
|        - | 2563 | `/*  CAT_STORE: * * *` |
|        - | 2564 | ` *` |
...
|        - | 2566 | ` * back.` |
|        - | 2567 | ` */` |
|    13762 | 2568 | `case PH7_OP_CAT_STORE:{` |
|    27530 | 2569 | `	ph7_value *pNos = &pTos[-1];` |
|        - | 2570 | `	ph7_value *pObj;` |
|        - | 2571 | `	sxu32 nIdx;` |
|        - | 2572 | `#ifdef UNTRUST` |
|        - | 2573 | `	if( pNos < pStack ){` |
...
|    27530 | 2578 | `	if((pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|       59 | 2579 | `		PH7_MemObjToString(pNos);` |
|       29 | 2580 | `	}` |
|    27530 | 2581 | `	nIdx = pTos->nIdx;` |
...
|    27525 | 2593 | `	if( nIdx != SXU32_HIGH` |
|    27525 | 2594 | `	 && nIdx != pNos->nIdx` |
|    27521 | 2595 | `	 && (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx)) != 0` |
|    27522 | 2596 | `	 && (SyHashTotalEntry(&pVm->hTypedSlot) == 0` |
|    16359 | 2597 | `	     \|\| SyHashGet(&pVm->hTypedSlot,(const void *)&nIdx,sizeof(sxu32)) == 0) ){` |
|    27516 | 2598 | `		if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - | 2599 | `			/* e.g. $x = 5; $x .= "a";  ->  "5a" */` |
|        6 | 2600 | `			PH7_MemObjToString(pObj);` |
|        2 | 2601 | `		}` |
|    27516 | 2602 | `		if( SyBlobLength(&pNos->sBlob) > 0 ){` |
|    27512 | 2603 | `			if( PH7_MemObjStringAppend(pObj,(const char *)SyBlobData(&pNos->sBlob),SyBlobLength(&pNos->sBlob)) != SXRET_OK ){` |
...
|    27516 | 2622 | `		if( (pInstr+1)->iOp != PH7_OP_POP ){` |
...
|    27516 | 2627 | `		PH7_HOOK_RMW_WRITEBACK(nIdx,0);` |
|    27516 | 2628 | `		pNos->nIdx = SXU32_HIGH;` |
|    27516 | 2629 | `		VmPopOperand(&pTos,1);` |
|    27523 | 2630 | `		break;` |
|        - | 2631 | `	}` |
...
|        - | 2668 | ` * stack.` |
|        - | 2669 | ` */` |
|   114541 | 2670 | `case PH7_OP_LAND:` |
|        - | 2671 | `case PH7_OP_LOR: {` |
|        - | 2672 | `	VmOpRc rcOp;` |
|   229292 | 2673 | `	sState.pTos = pTos;` |
|   229292 | 2674 | `	sState.pc = pc;` |
|   229292 | 2675 | `	rcOp = VmExecOpLor(&(*pVm),&sState,pInstr);` |
|   229292 | 2676 | `	pTos = sState.pTos;` |
|   229292 | 2677 | `	pc = sState.pc;` |
|   229292 | 2678 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2679 | `		goto Abort;` |
|   229292 | 2680 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2917 | ` */` |
|   229027 | 2918 | `case PH7_OP_TEQ: {` |
|        - | 2919 | `	VmOpRc rcOp;` |
|   458264 | 2920 | `	sState.pTos = pTos;` |
|   458264 | 2921 | `	sState.pc = pc;` |
|   458264 | 2922 | `	rcOp = VmExecOpTeq(&(*pVm),&sState,pInstr);` |
|   458264 | 2923 | `	pTos = sState.pTos;` |
|   458264 | 2924 | `	pc = sState.pc;` |
|   458264 | 2925 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2926 | `		goto Abort;` |
|   458264 | 2927 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2939 | ` *` |
|        - | 2940 | ` */` |
|   190794 | 2941 | `case PH7_OP_TNE: {` |
|        - | 2942 | `	VmOpRc rcOp;` |
|   381798 | 2943 | `	sState.pTos = pTos;` |
|   381798 | 2944 | `	sState.pc = pc;` |
|   381798 | 2945 | `	rcOp = VmExecOpTne(&(*pVm),&sState,pInstr);` |
|   381798 | 2946 | `	pTos = sState.pTos;` |
|   381798 | 2947 | `	pc = sState.pc;` |
|   381798 | 2948 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2949 | `		goto Abort;` |
|   381798 | 2950 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2971 | ` *` |
|        - | 2972 | ` */` |
|   146346 | 2973 | `case PH7_OP_LT:` |
|        - | 2974 | `case PH7_OP_LE: {` |
|        - | 2975 | `	VmOpRc rcOp;` |
|   293107 | 2976 | `	sState.pTos = pTos;` |
|   293107 | 2977 | `	sState.pc = pc;` |
|   293107 | 2978 | `	rcOp = VmExecOpLe(&(*pVm),&sState,pInstr);` |
|   293107 | 2979 | `	pTos = sState.pTos;` |
|   293107 | 2980 | `	pc = sState.pc;` |
|   293107 | 2981 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2982 | `		goto Abort;` |
|   293107 | 2983 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3004 | ` *` |
|        - | 3005 | ` */` |
|    86397 | 3006 | `case PH7_OP_GT:` |
|        - | 3007 | `case PH7_OP_GE: {` |
|        - | 3008 | `	VmOpRc rcOp;` |
|   173004 | 3009 | `	sState.pTos = pTos;` |
|   173004 | 3010 | `	sState.pc = pc;` |
|   173004 | 3011 | `	rcOp = VmExecOpGe(&(*pVm),&sState,pInstr);` |
|   173004 | 3012 | `	pTos = sState.pTos;` |
|   173004 | 3013 | `	pc = sState.pc;` |
|   173004 | 3014 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 3015 | `		goto Abort;` |
|   173004 | 3016 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3408 | ` */` |
|   121069 | 3409 | `case PH7_OP_FOREACH_STEP: {` |
|        - | 3410 | `	VmOpRc rcOp;` |
|   242143 | 3411 | `	sState.pTos = pTos;` |
|   242143 | 3412 | `	sState.pc = pc;` |
|   242143 | 3413 | `	rcOp = VmExecOpForeachStep(&(*pVm),&sState,pInstr);` |
|   242143 | 3414 | `	pTos = sState.pTos;` |
|   242143 | 3415 | `	pc = sState.pc;` |
|   242143 | 3416 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 3417 | `		goto Abort;` |
|   242141 | 3418 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|  1042058 | 3831 | `	sxi32 nCallArgs = pInstr->iP1 + (pInstr->iP2 ? VmSpreadOwnExtra(pVm,pInstr->iP1,pTos) : 0);` |
|        - | 3832 | `	ph7_value *pArg;` |
|  1042058 | 3833 | `	pArg = &pTos[-nCallArgs];` |
...
|  1042058 | 3842 | `	VmCallArgMap *pEffCallMap = (VmCallArgMap *)pInstr->p3;` |
...
|  1042058 | 3849 | `	if( VmValueIsClosure(pVm,pTos) ){` |
...
|  1042058 | 3859 | `	if( (pTos->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|      142 | 4054 | `		break;` |
|        - | 4055 | `	}` |
|  1041898 | 4056 | `	SyStringInitFromBuf(&sName,SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
...
|  1041898 | 4060 | `	if( sName.nByte > 0 && sName.zString[0] == '\\' ){` |
...
|  1041898 | 4067 | `	pEntry = SyHashGet(&pVm->hFunction,(const void *)sName.zString,sName.nByte);` |
...
|        - | 4073 | `	{` |
|  1041898 | 4074 | `	VmCallArgMap *pCallMap = pEffCallMap;` |
|  1041898 | 4075 | `	if( pEntry == 0 && pCallMap && pCallMap->bIsNamespaced ){` |
...
|        - | 4106 | `		VmSlot sArg;` |
|        - | 4107 | `		sxu32 n;` |
|   105516 | 4108 | `		int bClosureThis = 0;` |
|   105516 | 4109 | `		ph7_class *pClosureScope = 0;` |
|        - | 4110 | `		/* initialize fields */` |
|   105516 | 4111 | `		pVmFunc = (ph7_vm_func *)pEntry->pUserData;` |
|   105516 | 4112 | `		pThis = 0;` |
|   105516 | 4113 | `		pSelf = 0;` |
...
|       14 | 4128 | `		}` |
|   105516 | 4129 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
...
|   158374 | 4236 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   105511 | 4237 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
...
|   105516 | 4244 | `		if( VmRecursionExceeded(pVm) ){` |
...
|        3 | 4248 | `			goto Abort;` |
|        - | 4249 | `		}` |
|   105514 | 4250 | `		if( pVmFunc->pNextName ){` |
...
|   105514 | 4262 | `		pSelfHint = pSelf;` |
|   105514 | 4263 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
...
|    12325 | 4267 | `			}` |
|    12838 | 4268 | `		}` |
|   105514 | 4269 | `		if( pSelf == 0 && (pVmFunc->iFlags & VM_FUNC_CLOSURE) ){` |
...
|       30 | 4280 | `			}` |
|      901 | 4281 | `		}` |
|   105514 | 4282 | `		if( SySetUsed(&pVmFunc->aAttrs) > 0 ){` |
...
|       56 | 4287 | `		}` |
|   105514 | 4288 | `		if( pVmFunc->iFlags & VM_FUNC_GENERATOR ){` |
...
|   105174 | 4520 | `		aFormalArg = (ph7_vm_func_arg *)SySetBasePtr(&pVmFunc->aArgs);` |
|        - | 4521 | `		/* Create a new VM frame  */` |
|   105174 | 4522 | `		rc = VmEnterFrame(&(*pVm),pVmFunc,pThis,&pFrame);` |
|   105174 | 4523 | `		if( rc != SXRET_OK ){` |
...
|   105174 | 4551 | `		pFrame->nActualArgs = (int)(pTos - pArg);` |
|   105174 | 4552 | `		if( pThis && ((pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) \|\| bClosureThis) ){` |
...
|    12412 | 4560 | `			}` |
|    12412 | 4561 | `		}` |
|   105174 | 4562 | `		if( SySetUsed(&pVmFunc->aStatic) > 0 ){` |
...
|        - | 4589 | `		{` |
|   105174 | 4590 | `		VmCallArgMap *pCallMap3 = pEffCallMap;` |
|        - | 4591 | `		/* Caller file's strict_types mode — governs parameter coercion` |
|        - | 4592 | `		 * (but NOT return coercion, which uses the callee's file). */` |
|   105174 | 4593 | `		int bCallIsStrict = (pCallMap3 && pCallMap3->bStrict) ? 1 : 0;` |
|   105174 | 4594 | `		if( pCallMap3 && pCallMap3->bHasNamed ){` |
|        - | 4595 | `			/* ============================================================` |
...
|        - | 4980 | `		 * ============================================================ */` |
|   104906 | 4981 | `		n = 0;` |
|   269700 | 4982 | `		while( pArg < pTos ){` |
|   165099 | 4983 | `			if( n < SySetUsed(&pVmFunc->aArgs) && (aFormalArg[n].iFlags & VM_FUNC_ARG_VARIADIC) ){` |
...
|        - | 5083 | `			}` |
|   164899 | 5084 | `			if( n < SySetUsed(&pVmFunc->aArgs) ){` |
...
|   164385 | 5091 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_UNION ){` |
...
|   164298 | 5124 | `				if( aFormalArg[n].nType > 0` |
|    89389 | 5125 | `					&& !((aFormalArg[n].iFlags & VM_FUNC_ARG_NULLABLE) && (pArg->iFlags & MEMOBJ_NULL)) ){` |
...
|       13 | 5201 | `					}` |
|     6975 | 5202 | `				}` |
|   164287 | 5203 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_BY_REF ){` |
...
|   164047 | 5255 | `					pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|        - | 5256 | `				}` |
|    82350 | 5257 | `			}else{` |
|        - | 5258 | `				char zName[32];` |
...
|        - | 5265 | `			}` |
|   164799 | 5266 | `			if( pObj ){` |
|   164563 | 5267 | `				PH7_MemObjStore(pArg,pObj);` |
|        - | 5268 | `				/* Insert argument index  */` |
|   164563 | 5269 | `				sArg.nIdx = pObj->nIdx;` |
|   164563 | 5270 | `				sArg.pUserData = 0;` |
|   164563 | 5271 | `				SySetPut(&pFrame->sArg,(const void *)&sArg);` |
|    82484 | 5272 | `			}` |
|   164799 | 5273 | `			PH7_MemObjRelease(pArg);` |
|   164799 | 5274 | `			pArg++;` |
|   164799 | 5275 | `			++n;` |
|        5 | 5276 | `		}` |
|        - | 5277 | `		} /* end named vs positional branch */` |
|        - | 5278 | `		/* Set up closure environment */` |
|   105052 | 5279 | `		if( pVmFunc->iFlags & VM_FUNC_CLOSURE ){` |
...
|   105047 | 5327 | `		if( n < SySetUsed(&pVmFunc->aArgs)` |
|    56222 | 5328 | `		 && (pVmFunc->iFlags & (VM_FUNC_INTERNAL\|VM_FUNC_CLASS_METHOD)) != VM_FUNC_INTERNAL ){` |
|        - | 5329 | `			sxu32 nNonVar,nReq;` |
|     5939 | 5330 | `			nReq = VmFuncRequiredArgCount(pVmFunc,&nNonVar);` |
|     5939 | 5331 | `			if( n < nReq ){` |
...
|   117108 | 5351 | `		while( n < SySetUsed(&pVmFunc->aArgs) ){` |
|    12327 | 5352 | `			if( aFormalArg[n].iFlags & VM_FUNC_ARG_VARIADIC ){` |
...
|        - | 5363 | `			}` |
|    12083 | 5364 | `			if( SySetUsed(&aFormalArg[n].aByteCode) > 0 ){` |
|    12081 | 5365 | `				pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|    12081 | 5366 | `				if( pObj ){` |
|        - | 5367 | `					/* Evaluate the default value and extract it's result */` |
|    12081 | 5368 | `					rc = VmLocalExec(&(*pVm),&aFormalArg[n].aByteCode,pObj,FALSE);` |
|    12081 | 5369 | `					if( rc == PH7_ABORT ){` |
|      ! 0 | 5370 | `						goto Abort;` |
|        - | 5371 | `					}` |
|        - | 5372 | `					/* Insert argument index */` |
|    12081 | 5373 | `					sArg.nIdx = pObj->nIdx;` |
|    12081 | 5374 | `					sArg.pUserData = 0;` |
|    12081 | 5375 | `					SySetPut(&pFrame->sArg,(const void *)&sArg);` |
...
|    12076 | 5380 | `					if( aFormalArg[n].nType > 0 && aFormalArg[n].nType != MEMOBJ_OBJ` |
...
|        - | 5394 | `		 */` |
|   105030 | 5395 | `		PH7_MemObjRelease(pTos);` |
|   105030 | 5396 | `		pTos = &pTos[-nCallArgs];` |
...
|        - | 5408 | `		 * per function. */` |
|        - | 5409 | `		{` |
|   105030 | 5410 | `			sxu32 nSlots = pVmFunc->nMaxStack;` |
|   105030 | 5411 | `			if( nSlots == 0 ){` |
...
|     4142 | 5418 | `			}` |
|   105030 | 5419 | `			pFrameStack = VmOperandStackAlloc(&(*pVm),nSlots);` |
|        - | 5420 | `		}` |
|   105030 | 5421 | `		if( pFrameStack == 0 ){` |
...
|      ! 0 | 5428 | `			break;` |
|        - | 5429 | `		}` |
|    52410 | 5430 | `SkipFuncBody:` |
|   105164 | 5431 | `		if( pSelf ){` |
|        - | 5432 | `			/* Push class name */` |
|    25737 | 5433 | `			SySetPut(&pVm->aSelf,(const void *)&pSelf);` |
|    12866 | 5434 | `		}` |
|        - | 5435 | `		/* Increment nesting level */` |
|   105164 | 5436 | `		pVm->nRecursionDepth++;` |
|   105164 | 5437 | `		if( rc == PH7_EXCEPTION ){` |
...
|   105030 | 5466 | `			VmCallFrame *pRec = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   105030 | 5467 | `			if( pRec ){` |
|   102386 | 5468 | `				pVm->pIdleCallFrames = (void *)pRec->pPrev;` |
|    51298 | 5469 | `			}else{` |
|     2649 | 5470 | `				pRec = (VmCallFrame *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmCallFrame));` |
|        - | 5471 | `			}` |
|   105030 | 5472 | `			if( pRec == 0 ){` |
...
|      ! 0 | 5483 | `				goto Abort;` |
|        - | 5484 | `			}` |
|   105030 | 5485 | `			sState.pTos = pTos;` |
|   105030 | 5486 | `			sState.pc = pc;` |
|   105030 | 5487 | `			pRec->sCaller = sState;` |
|   105030 | 5488 | `			pRec->sCall.pVmFunc = pVmFunc;` |
|   105030 | 5489 | `			pRec->sCall.pFrame = pFrame;` |
|   105030 | 5490 | `			pRec->sCall.pFrameStack = pFrameStack;` |
|   105030 | 5491 | `			pRec->sCall.nStackCap = pVmFunc->nMaxStack + VM_STACK_GUARD;` |
|   105030 | 5492 | `			pRec->sCall.nLastRef = SXU32_HIGH;` |
|   105030 | 5493 | `			pRec->sCall.bSelfPushed = (sxu8)(pSelf ? 1 : 0);` |
|   105030 | 5494 | `			pRec->pPrev = pCallTop;` |
|   105030 | 5495 | `			pCallTop = pRec;` |
|        - | 5496 | `			/* Switch to the callee activation (what the recursive` |
|        - | 5497 | `			 * VmByteCodeExec entry used to set up). */` |
|   105030 | 5498 | `			aInstr = (VmInstr *)SySetBasePtr(&pVmFunc->aByteCode);` |
|   105030 | 5499 | `			pStack = pFrameStack;` |
|   105030 | 5500 | `			pTos = &pStack[-1];` |
|   105030 | 5501 | `			pc = 0;` |
|   105030 | 5502 | `			sState.aInstr = aInstr;` |
|   105030 | 5503 | `			sState.pStack = pStack;` |
|   105030 | 5504 | `			sState.nStackCap = pRec->sCall.nStackCap; /* callee's operand-stack capacity for OP_SPREAD growth */` |
|   105030 | 5505 | `			sState.nStackOrig = pRec->sCall.nStackCap; /* fixed headroom reference (never grows) */` |
|   105030 | 5506 | `			sState.pTos = pTos;` |
|   105030 | 5507 | `			sState.pc = 0;` |
|   105030 | 5508 | `			sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|   105030 | 5509 | `			sState.pEntryFrame = pVm->pFrame;` |
|   105030 | 5510 | `			sState.pResult = pRec->sCaller.pTos;` |
|   105030 | 5511 | `			sState.pLastRef = &pRec->sCall.nLastRef;` |
|   105030 | 5512 | `			sState.pEnforceRetFunc = VmFuncHasReturnType(pVmFunc) ? pVmFunc : 0;` |
|   105030 | 5513 | `			sState.is_callback = 0;` |
|   105030 | 5514 | `			sState.bReturnPropagates = 0;` |
|   105030 | 5515 | `			goto VmLoopFetch;` |
|        - | 5516 | `		}` |
|       57 | 5517 | `	}else{` |
...
|   936387 | 5526 | `		pEntry = SyHashGet(&pVm->hHostFunction,(const void *)sName.zString,sName.nByte);` |
|        - | 5527 | `		{` |
|   936387 | 5528 | `		VmCallArgMap *pCallMap2 = pEffCallMap;` |
|   936387 | 5529 | `		if( pEntry == 0 && pCallMap2 && pCallMap2->bIsNamespaced ){` |
...
|        - | 5634 | `			}` |
|        - | 5635 | `		}` |
|   936371 | 5636 | `		pFunc = (ph7_user_func *)pEntry->pUserData;` |
...
|  1404918 | 5641 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   936366 | 5642 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
|        - | 5643 | `		/* Start collecting function arguments */` |
|   936371 | 5644 | `		SySetReset(&aArg);` |
|  2531065 | 5645 | `		while( pArg < pTos ){` |
|  1594699 | 5646 | `			SySetPut(&aArg,(const void *)&pArg);` |
|  1594699 | 5647 | `			pArg++;` |
|        5 | 5648 | `		}` |
|        - | 5649 | `		/* Assume a null return value */` |
|   936371 | 5650 | `		PH7_MemObjInit(&(*pVm),&sRet);` |
|        - | 5651 | `		/* Init the call context */` |
|   936371 | 5652 | `		VmInitCallContext(&sCtx,&(*pVm),pFunc,&sRet,0);` |
...
|   936371 | 5659 | `		sCtx.pArgMap = pEffCallMap;` |
|        - | 5660 | `		{` |
|   936371 | 5661 | `		int nGiven = (int)SySetUsed(&aArg);` |
...
|   936371 | 5667 | `		if( pFunc->nMinArg > 0 && nGiven < pFunc->nMinArg ){` |
...
|      232 | 5674 | `				nGiven);` |
|   936139 | 5675 | `		}else if( pFunc->bHasMaxArg && nGiven > (int)pFunc->nMaxArg ){` |
...
|       40 | 5688 | `				nGiven);` |
|  1404142 | 5689 | `		}else if( SXRET_OK != (rc = VmEnforceBuiltinArgTypes(&sCtx,pFunc,nGiven,` |
|   935822 | 5690 | `			(ph7_value **)SySetBasePtr(&aArg))) ){` |
|        - | 5691 | `			/* TypeError thrown: rc carries the caught/uncaught status */` |
|      112 | 5692 | `		}else{` |
|        - | 5693 | `			/* Call the foreign function */` |
|   935613 | 5694 | `			rc = pFunc->xFunc(&sCtx,nGiven,(ph7_value **)SySetBasePtr(&aArg));` |
|        - | 5695 | `		}` |
|        - | 5696 | `		}` |
|        - | 5697 | `		/* Release the call context */` |
|   936371 | 5698 | `		VmReleaseCallContext(&sCtx);` |
|   936371 | 5699 | `		if( rc == PH7_ABORT ){` |
...
|      578 | 5704 | `			goto Abort;` |
|        - | 5705 | `		}` |
|   935797 | 5706 | `		if( rc != PH7_SUSPEND && pVm->pInlineInstr == (void *)aInstr ){` |
...
|      ! 0 | 5719 | `		}` |
|   935793 | 5720 | `		if( rc == PH7_EXCEPTION ){` |
...
|      839 | 5740 | `			break;` |
|        - | 5741 | `		}` |
|   934761 | 5742 | `		if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|   913473 | 5766 | `			VmPopOperand(&pTos,nCallArgs);` |
|   457098 | 5767 | `		}` |
|        - | 5768 | `		/* Save foreign function return value into the (now top) function-name slot */` |
|   934407 | 5769 | `		PH7_MemObjStore(&sRet,pTos);` |
|   934407 | 5770 | `		PH7_MemObjRelease(&sRet);` |
|        - | 5771 | `	}` |
|   934511 | 5772 | `	break;` |
|        - | 5773 | `				  }` |
|        - | 5774 | `/*` |
...
|        - | 5777 | ` */` |
|    26078 | 5778 | `case PH7_OP_CONSUME: {` |
|        - | 5779 | `	VmOpRc rcOp;` |
|    52161 | 5780 | `	sState.pTos = pTos;` |
|    52161 | 5781 | `	sState.pc = pc;` |
|    52161 | 5782 | `	rcOp = VmExecOpConsume(&(*pVm),&sState,pInstr);` |
|    52161 | 5783 | `	pTos = sState.pTos;` |
|    52161 | 5784 | `	pc = sState.pc;` |
|    52161 | 5785 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 5786 | `		goto Abort;` |
|    52161 | 5787 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 5792 |  |
|        - | 5793 | `		} /* Switch() */` |
| 16702389 | 5794 | `		pc++; /* Next instruction in the stream */` |
|        5 | 5795 | `	} /* For(;;) */` |
|   131193 | 5796 | `Done:` |
...
|   262596 | 5800 | `	rc = SXRET_OK;` |
|   262596 | 5801 | `	goto Unwind;` |
|      823 | 5802 | `Suspend:` |
...
|   133206 | 5860 | `	for(;;){` |
|   266212 | 5861 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|      ! 0 | 5869 | `			}` |
|     1162 | 5870 | `		}` |
|   266212 | 5871 | `		if( pCallTop == 0 ){` |
|   161597 | 5872 | `			return VmExecFinalize(&(*pVm),&sState,&aArg,pTos,rc);` |
|        - | 5873 | `		}` |
|   104620 | 5874 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|      636 | 5880 | `		}` |
|        - | 5881 | `		{` |
|   104620 | 5882 | `			VmCallFrame *pRec = pCallTop;` |
|   104620 | 5883 | `			sState = pRec->sCaller;` |
|   104620 | 5884 | `			rc = VmCallFinish(&(*pVm),&sState,&pRec->sCall,rc);` |
|   104620 | 5885 | `			pCallTop = pRec->pPrev;` |
|   104620 | 5886 | `			pRec->pPrev = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   104620 | 5887 | `			pVm->pIdleCallFrames = (void *)pRec;` |
|   104620 | 5888 | `			aInstr = sState.aInstr;` |
|   104620 | 5889 | `			pStack = sState.pStack;` |
|   104620 | 5890 | `			pTos = sState.pTos;` |
|   104620 | 5891 | `			pc = sState.pc;` |
|        - | 5892 | `		}` |
|   104620 | 5893 | `		if( rc == PH7_OK ){` |
|   103854 | 5894 | `			pc++; /* the loop-bottom increment this OP_CALL missed */` |
|   103854 | 5895 | `			goto VmLoopFetch;` |
|        - | 5896 | `		}` |
|        5 | 5897 | `	}` |
|    80978 | 5898 | `}` |
|        - | 5899 |  |
