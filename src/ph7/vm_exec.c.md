...
|        - |  162 | ` */` |
|   161654 |  163 | `static sxi32 VmExecFinalize(ph7_vm *pVm,VmExecState *pState,SySet *pArg,ph7_value *pTos,sxi32 rcTerm)` |
|        5 |  164 | `{` |
|    80827 |  165 | `	SXUNUSED(pVm);` |
|   161659 |  166 | `	if( rcTerm != PH7_SUSPEND && !pState->bReturnPropagates ){` |
|   157963 |  167 | `		VmClearFrameReturn(pState->pEntryFrame);` |
|    78979 |  168 | `	}` |
|   161659 |  169 | `	SySetRelease(pArg);` |
|   161659 |  170 | `	if( rcTerm == PH7_ABORT \|\| rcTerm == PH7_EXCEPTION ){` |
|     2841 |  171 | `		while( pTos >= pState->pStack ){` |
|     1789 |  172 | `			PH7_MemObjRelease(pTos);` |
|     1789 |  173 | `			pTos--;` |
|        5 |  174 | `		}` |
|      526 |  175 | `	}` |
|   161659 |  176 | `	return rcTerm;` |
|        5 |  177 | `}` |
|        - |  178 | `/*` |
...
|        - |  189 | ` */` |
|   104622 |  190 | `static sxi32 VmCallFinish(ph7_vm *pVm,VmExecState *pCaller,VmCallRecord *pCallee,sxi32 rc)` |
|        5 |  191 | `{` |
|        - |  192 | `	ph7_value *pObj;` |
|        - |  193 | `	/* Decrement nesting level */` |
|   104627 |  194 | `	pVm->nRecursionDepth--;` |
|   104627 |  195 | `	if( pCallee->bSelfPushed ){` |
|        - |  196 | `		/* Pop class name */` |
|    25525 |  197 | `		(void)SySetPop(&pVm->aSelf);` |
|    12760 |  198 | `	}` |
|   104627 |  199 | `	if( (pCallee->pVmFunc->iFlags & VM_FUNC_REF_RETURN) && rc == SXRET_OK ){` |
...
|       25 |  225 | `	}` |
|   104627 |  226 | `	if( rc != PH7_ABORT && ((pCallee->pFrame->iFlags & VM_FRAME_THROW) \|\| rc == PH7_EXCEPTION) ){` |
...
|   104627 |  272 | `	if( rc != PH7_SUSPEND && pCallee->pFrameStack ){` |
...
|   104493 |  276 | `		VmOperandStackRecycle(pVm,pCallee->pFrameStack,pCallee->nStackCap);` |
|    52346 |  277 | `	}` |
|        - |  278 | `	/* Leave the frame */` |
|   104627 |  279 | `	VmLeaveFrame(&(*pVm));` |
|   104627 |  280 | `	if( rc == PH7_ABORT ){` |
|      336 |  281 | `		return PH7_ABORT;` |
|        - |  282 | `	}` |
|   104295 |  283 | `	if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|        - |  291 | `	}` |
|   104295 |  292 | `	if( rc == PH7_EXCEPTION ){` |
|      469 |  293 | `		return PH7_EXCEPTION;` |
|        - |  294 | `	}` |
|   103831 |  295 | `	return PH7_OK;` |
|    52418 |  296 | `}` |
|        - |  297 | `/*` |
...
|        - |  330 | ` * nesting.` |
|        - |  331 | ` */` |
|   162012 |  332 | `PH7_PRIVATE sxi32 VmByteCodeExec(` |
...
|   162017 |  352 | `	if( VmNativeNestingExceeded(pVm) ){` |
...
|   162013 |  362 | `	nSavedBrc = pVm->nBoundaryRc;` |
|   162013 |  363 | `	pVm->nBoundaryRc = 0;` |
...
|   162013 |  370 | `	nSavedLine = pVm->nCurLine;` |
|   162013 |  371 | `	pVm->nVmExecDepth++;` |
|   243017 |  372 | `	rc = VmByteCodeExecBody(&(*pVm),aInstr,pStack,nTos,pResult,pLastRef,is_callback,nPc,` |
|    81004 |  373 | `		pEnforceRetFunc,bReturnPropagates,pAdoptSegment,ppBaseOwner,pnBaseCap,nStackOrig);` |
|   162013 |  374 | `	pVm->nVmExecDepth--;` |
|   162013 |  375 | `	pVm->nCurLine = nSavedLine;` |
|   162013 |  376 | `	if( nSavedBrc != 0 && (nSavedBrc == PH7_ABORT \|\| pVm->nBoundaryRc == 0) ){` |
|       15 |  377 | `		pVm->nBoundaryRc = nSavedBrc;` |
|        6 |  378 | `	}` |
|   162013 |  379 | `	return rc;` |
|    81011 |  380 | `}` |
|   162008 |  381 | `static sxi32 VmByteCodeExecBody(` |
...
|        - |  399 | `	ph7_value *pTos;` |
|        - |  400 | `	SySet aArg;` |
|   162013 |  401 | `	VmCallFrame *pCallTop = 0; /* Top of this invocation's in-loop call-record` |
...
|        - |  409 | `	sxi32 pc;` |
|        - |  410 | `	sxi32 rc;` |
|   162013 |  411 | `	sState.aInstr = aInstr;` |
|   162013 |  412 | `	sState.pStack = pStack;` |
|   162013 |  413 | `	sState.nStackCap = pnBaseCap ? *pnBaseCap : 0; /* CURRENT capacity (grown on a coroutine resume) */` |
|   162013 |  414 | `	sState.nStackOrig = nStackOrig;                /* ORIGINAL capacity — fixed headroom reference */` |
|   162013 |  415 | `	sState.pResult = pResult;` |
|   162013 |  416 | `	sState.pLastRef = pLastRef;` |
|   162013 |  417 | `	sState.pEnforceRetFunc = pEnforceRetFunc;` |
|   162013 |  418 | `	sState.is_callback = (sxu8)(is_callback ? 1 : 0);` |
|   162013 |  419 | `	sState.bReturnPropagates = (sxu8)(bReturnPropagates ? 1 : 0);` |
|        - |  420 | `	/* Argument container */` |
|   162013 |  421 | `	SySetInit(&aArg,&pVm->sAllocator,sizeof(ph7_value *));` |
|   162013 |  422 | `	if( nTos < 0 ){` |
|   146225 |  423 | `		pTos = &pStack[-1];` |
|    73115 |  424 | `	}else{` |
|    15793 |  425 | `		pTos = &pStack[nTos];` |
|        - |  426 | `	}` |
|   162013 |  427 | `	sState.pTos = pTos;` |
|   162013 |  428 | `	sState.pc = nPc;` |
...
|   162008 |  446 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->pFrame == pVm->pFrame` |
|     2816 |  447 | `	 && pStack == pVm->pActiveCtx->pStack ){` |
|     1805 |  448 | `		sState.nExceptionBase = pVm->pActiveCtx->nExceptionBase;` |
|      905 |  449 | `	}else{` |
|   160213 |  450 | `		sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|        - |  451 | `	}` |
|   162013 |  452 | `	sState.pEntryFrame = pVm->pFrame;` |
|   162013 |  453 | `	pc = nPc;` |
...
|   162008 |  506 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->pInjected` |
...
|   161998 |  567 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->bClosing` |
...
| 17061291 |  603 | `		if( pVm->nBoundaryRc != 0 \|\| SySetUsed(&pVm->aHookRmw) > 0 ){` |
...
| 17061191 |  658 | `		pInstr = &aInstr[pc];` |
| 17061191 |  659 | `		if( pInstr->nLine ){` |
...
| 16847882 |  663 | `			pVm->nCurLine = pInstr->nLine;` |
|  8430232 |  664 | `		}` |
| 17061191 |  665 | `		rc = SXRET_OK;` |
|        - |  666 | `/*` |
...
|        - |  672 | ` */` |
| 17061191 |  673 | `		switch(pInstr->iOp){` |
|        - |  674 | `/*` |
|        - |  675 | ` * DONE: P1 * *` |
|        - |  676 | ` *` |
...
|        - |  679 | ` */` |
|   131061 |  680 | `case PH7_OP_DONE:` |
|   262331 |  681 | `	if( pInstr->iP2 && sState.bReturnPropagates ){` |
...
|   262142 |  711 | `	if( sState.pEnforceRetFunc && VmFuncHasReturnType(sState.pEnforceRetFunc)` |
...
|     4591 |  736 | `	}` |
|   262123 |  737 | `	if( pInstr->iP1 && pTos >= pStack ){` |
|   157297 |  738 | `		if( sState.pLastRef ){` |
|    94121 |  739 | `			*sState.pLastRef = pTos->nIdx;` |
|    47160 |  740 | `		}` |
|   157297 |  741 | `		if( sState.pResult ){` |
|        - |  742 | `			/* Execution result */` |
|   150221 |  743 | `			PH7_MemObjStore(pTos,sState.pResult);` |
|    75210 |  744 | `		}` |
|   157297 |  745 | `		VmPopOperand(&pTos,1);` |
|   183579 |  746 | `	}else if( sState.pLastRef ){` |
...
|        - |  762 | `	 */` |
|   262123 |  763 | `	rc = VmDrainFinally(&(*pVm),sState.nExceptionBase);` |
|   262123 |  764 | `	if( rc == SXERR_ABORT ){` |
|      ! 0 |  765 | `		goto Abort;` |
|        - |  766 | `	}` |
|   262123 |  767 | `	if( rc == PH7_EXCEPTION ){` |
...
|        - |  778 | `	}` |
|   262119 |  779 | `	if( sState.pEntryFrame->bHasRet && !sState.bReturnPropagates ){` |
...
|        - |  835 | ` */` |
|   279631 |  836 | `case PH7_OP_JMP:` |
|   559471 |  837 | `	pc = pInstr->iP2 - 1;` |
|   559471 |  838 | `	break;` |
|        - |  839 | `/*` |
|        - |  840 | ` * JZ: P1 P2 *` |
|        - |  841 | ` *` |
...
|  1634154 |  852 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     1001 |  853 | `		PH7_MemObjToBool(pTos);` |
|      499 |  854 | `	}` |
|  1634154 |  855 | `	if( !pTos->x.iVal ){` |
|        - |  856 | `		/* Take the jump */` |
|   927208 |  857 | `		pc = pInstr->iP2 - 1;` |
|   463861 |  858 | `	}` |
|  1634154 |  859 | `	if( !pInstr->iP1 ){` |
|  1391594 |  860 | `		VmPopOperand(&pTos,1);` |
|   696360 |  861 | `	}` |
|  1634154 |  862 | `	break;` |
|        - |  863 | `/*` |
|        - |  864 | ` * JNZ: P1 P2 *` |
...
|   184925 |  876 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      ! 0 |  877 | `		PH7_MemObjToBool(pTos);` |
|      ! 0 |  878 | `	}` |
|   184925 |  879 | `	if( pTos->x.iVal ){` |
|        - |  880 | `		/* Take the jump */` |
|     9563 |  881 | `		pc = pInstr->iP2 - 1;` |
|     4779 |  882 | `	}` |
|   184925 |  883 | `	if( !pInstr->iP1 ){` |
...
|        - |  899 | ` */` |
|   683487 |  900 | `case PH7_OP_POP: {` |
|  1367999 |  901 | `	sxi32 n = pInstr->iP1;` |
|  1367999 |  902 | `	if( &pTos[-n+1] < pStack ){` |
|        - |  903 | `		/* TICKET 1433-51 Stack underflow must be handled at run-time */` |
|       79 |  904 | `		n = (sxi32)(pTos - pStack);` |
|       38 |  905 | `	}` |
|  1367999 |  906 | `	VmPopOperand(&pTos,n);` |
|  1367999 |  907 | `	break;` |
|        - |  908 | `				 }` |
|        - |  909 | `/*` |
|        - |  910 | ` * DUP: * * *` |
...
|        - |  929 | ` */` |
|    49121 |  930 | `case PH7_OP_NSSWITCH:` |
|    98247 |  931 | `	SyBlobReset(&pVm->sNamespace);` |
|    98247 |  932 | `	if( pInstr->p3 ){` |
...
|    98247 |  937 | `	SyHashRelease(&pVm->hUseConstImports);` |
|    98247 |  938 | `	SyHashInit(&pVm->hUseConstImports,&pVm->sAllocator,0,0);` |
|    98247 |  939 | `	break;` |
...
|        - | 1076 | ` */` |
|     3364 | 1077 | `case PH7_OP_UNSET_VAR: {` |
|        - | 1078 | `	VmOpRc rcOp;` |
|     6733 | 1079 | `	sState.pTos = pTos;` |
|     6733 | 1080 | `	sState.pc = pc;` |
|     6733 | 1081 | `	rcOp = VmExecOpUnsetVar(&(*pVm),&sState,pInstr);` |
|     6733 | 1082 | `	pTos = sState.pTos;` |
|     6733 | 1083 | `	pc = sState.pc;` |
|     6733 | 1084 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 1085 | `		goto Abort;` |
|     6731 | 1086 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
|      ! 0 | 1087 | `		goto Exception;` |
|        - | 1088 | `	}` |
|     6731 | 1089 | `	break;` |
|        - | 1090 | `					  }` |
|    33157 | 1091 | `case PH7_OP_ERR_CTRL:` |
|        - | 1092 | `	/*` |
...
|        - | 1101 | `	 */` |
|    66319 | 1102 | `	if( pInstr->iP1 ){` |
|    33163 | 1103 | `		pVm->nErrSuppress++;` |
|    49740 | 1104 | `	}else if( pVm->nErrSuppress > 0 ){` |
|    33161 | 1105 | `		pVm->nErrSuppress--;` |
|    16578 | 1106 | `	}` |
|    66319 | 1107 | `	break;` |
|        - | 1108 | `/*` |
|        - | 1109 | ` * IS_A * * *` |
...
|        - | 1163 | ` */` |
|  1556145 | 1164 | `case PH7_OP_LOADC: {` |
|        - | 1165 | `	ph7_value *pObj;` |
|        - | 1166 | `	/* Reserve a room */` |
|  3114149 | 1167 | `	pTos++;` |
|  3114149 | 1168 | `	if( pInstr->iP1 & PH7_LOADC_NOKEY ){` |
|        - | 1169 | `		/* Absent array-literal key: mark it so LOAD_MAP auto-indexes without a diagnostic */` |
|    19451 | 1170 | `		MemObjSetType(pTos,MEMOBJ_NULL);` |
|    19451 | 1171 | `		SyBlobReset(&pTos->sBlob);` |
|    19451 | 1172 | `		pTos->iFlags \|= MEMOBJ_AUX_NOKEY;` |
|    19451 | 1173 | `		pTos->nIdx = SXU32_HIGH;` |
|    19451 | 1174 | `		break;` |
|        - | 1175 | `	}` |
|  3094703 | 1176 | `	if( (pObj = (ph7_value *)SySetAt(&pVm->aLitObj,pInstr->iP2)) != 0 ){` |
|  3094703 | 1177 | `		if( (pInstr->iP1 & PH7_LOADC_EXPAND) && SyBlobLength(&pObj->sBlob) <= 64 ){` |
|        - | 1178 | `			SyHashEntry *pEntry;` |
|        - | 1179 | `			/* Check use const imports first — imports take precedence */` |
|        - | 1180 | `			{` |
|        - | 1181 | `				SyHashEntry *pConstImport;` |
|    34883 | 1182 | `				pConstImport = SyHashGet(&pVm->hUseConstImports,` |
|    23252 | 1183 | `					SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|    23257 | 1184 | `				if( pConstImport ){` |
...
|    23247 | 1199 | `			pEntry = SyHashGet(&pVm->hConstant,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|    23247 | 1200 | `			if( pEntry ){` |
|    23237 | 1201 | `				ph7_constant *pCons = (ph7_constant *)pEntry->pUserData;` |
|        - | 1202 | `				/* Set a NULL default value */` |
|    23237 | 1203 | `				MemObjSetType(pTos,MEMOBJ_NULL);` |
|    23237 | 1204 | `				SyBlobReset(&pTos->sBlob);` |
|        - | 1205 | `				/* Invoke the callback and deal with the expanded value */` |
|    23237 | 1206 | `				VmExpandConstantWithNotice(&(*pVm),pCons,pTos);` |
|        - | 1207 | `				/* Mark as constant */` |
|    23237 | 1208 | `				pTos->nIdx = SXU32_HIGH;` |
|    23237 | 1209 | `				break;` |
|        - | 1210 | `			}` |
...
|        - | 1283 | ` */` |
|  2218627 | 1284 | `case PH7_OP_LOAD:{` |
|        - | 1285 | `	ph7_value *pObj;` |
|        - | 1286 | `	SyString sName;` |
|  4441153 | 1287 | `	if( pInstr->p3 == 0 ){` |
...
|        9 | 1299 | `	}else{` |
|  4441137 | 1300 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1301 | `		/* Reserve a room for the target object */` |
|  4441137 | 1302 | `		pTos++;` |
|        - | 1303 | `	}` |
|  4441153 | 1304 | `	if( pInstr->iP2 == 2 ){` |
...
|   398141 | 1310 | `		if( VmExtractMemObj(&(*pVm),&sName,FALSE,FALSE) == 0 ){` |
|        7 | 1311 | `			VmErrorFormat(&(*pVm),PH7_CTX_WARNING,"Undefined variable $%z",&sName);` |
|        3 | 1312 | `		}` |
|   199170 | 1313 | `	}` |
|        - | 1314 | `	/* Extract the requested memory object */` |
|  4441153 | 1315 | `	pObj = VmExtractMemObj(&(*pVm),&sName,pInstr->p3 ? FALSE : TRUE,pInstr->iP1 != 1);` |
|  4441153 | 1316 | `	if( pObj == 0 ){` |
...
|  4441091 | 1341 | `	PH7_MemObjLoad(pObj,pTos);` |
|  4441091 | 1342 | `	pTos->nIdx = pObj->nIdx;` |
|  4441091 | 1343 | `	break;` |
|        - | 1344 | `				   }` |
|        - | 1345 | `/*` |
|        - | 1346 | ` * LOAD_MAP P1 * *` |
...
|        - | 1351 | ` */` |
|    36950 | 1352 | `case PH7_OP_LOAD_MAP: {` |
|        - | 1353 | `	VmOpRc rcOp;` |
|    73905 | 1354 | `	sState.pTos = pTos;` |
|    73905 | 1355 | `	sState.pc = pc;` |
|    73905 | 1356 | `	rcOp = VmExecOpLoadMap(&(*pVm),&sState,pInstr);` |
|    73905 | 1357 | `	pTos = sState.pTos;` |
|    73905 | 1358 | `	pc = sState.pc;` |
|    73905 | 1359 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1360 | `		goto Abort;` |
|    73905 | 1361 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1394 | ` * instead.` |
|        - | 1395 | ` */` |
|   333166 | 1396 | `case PH7_OP_LOAD_IDX: {` |
|        - | 1397 | `	VmOpRc rcOp;` |
|   667060 | 1398 | `	sState.pTos = pTos;` |
|   667060 | 1399 | `	sState.pc = pc;` |
|   667060 | 1400 | `	rcOp = VmExecOpLoadIdx(&(*pVm),&sState,pInstr);` |
|   667060 | 1401 | `	pTos = sState.pTos;` |
|   667060 | 1402 | `	pc = sState.pc;` |
|   667060 | 1403 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1404 | `		goto Abort;` |
|   667060 | 1405 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1415 | ` */` |
|      585 | 1416 | `case PH7_OP_LOAD_CLOSURE: {` |
|        - | 1417 | `	VmOpRc rcOp;` |
|     1175 | 1418 | `	sState.pTos = pTos;` |
|     1175 | 1419 | `	sState.pc = pc;` |
|     1175 | 1420 | `	rcOp = VmExecOpLoadClosure(&(*pVm),&sState,pInstr);` |
|     1175 | 1421 | `	pTos = sState.pTos;` |
|     1175 | 1422 | `	pc = sState.pc;` |
|     1175 | 1423 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1424 | `		goto Abort;` |
|     1175 | 1425 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1582 | `		}` |
|    11771 | 1583 | `		break;` |
|   620935 | 1584 | `	}else if( pInstr->p3 == 0 ){` |
...
|        - | 1596 | `#endif` |
|        5 | 1597 | `	}else{` |
|   620927 | 1598 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1599 | `	}` |
|   620930 | 1600 | `	if( sName.nByte == sizeof("GLOBALS")-1` |
|   312207 | 1601 | `	 && SyMemcmp((const void *)sName.zString,(const void *)"GLOBALS",sName.nByte) == 0 ){` |
|        6 | 1602 | `		if( pInstr->p3 ){` |
...
|        - | 1639 | ` */` |
|   120714 | 1640 | `case PH7_OP_STORE_IDX:` |
|        - | 1641 | `case PH7_OP_STORE_IDX_REF: {` |
|        - | 1642 | `	VmOpRc rcOp;` |
|   241433 | 1643 | `	sState.pTos = pTos;` |
|   241433 | 1644 | `	sState.pc = pc;` |
|   241433 | 1645 | `	rcOp = VmExecOpStoreIdxRef(&(*pVm),&sState,pInstr);` |
|   241433 | 1646 | `	pTos = sState.pTos;` |
|   241433 | 1647 | `	pc = sState.pc;` |
|   241433 | 1648 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 1649 | `		goto Abort;` |
|   241431 | 1650 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|   368325 | 1671 | `	PH7_ENFORCE_READONLY_MUTATE(pTos->nIdx);` |
...
|   368314 | 1676 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) != 0` |
|   184265 | 1677 | `	 && SySetUsed(&pVm->aHookRmw) > 0 ){` |
...
|        - | 1694 | `		}` |
|      ! 0 | 1695 | `	}` |
|   368317 | 1696 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) == 0 ){` |
|   368317 | 1697 | `		if( pTos->nIdx != SXU32_HIGH ){` |
|        - | 1698 | `			ph7_value *pObj;` |
|   368317 | 1699 | `			if( (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pTos->nIdx)) != 0 ){` |
|   368317 | 1700 | `				if( VmStringWantsPerlIncr(pObj) ){` |
...
|   368315 | 1719 | `					if( pInstr->iP1 == 0 && (pTos->iFlags & MEMOBJ_STRING) ){` |
|        9 | 1720 | `						SyBlobNullAppend(&pTos->sBlob);` |
|        3 | 1721 | `					}` |
|        - | 1722 | `					/* Force a numeric cast on the variable */` |
|   368315 | 1723 | `					PH7_MemObjToNumeric(pObj);` |
|   368315 | 1724 | `					if( pObj->iFlags & MEMOBJ_REAL ){` |
|        5 | 1725 | `						pObj->rVal++;` |
...
|        - | 1734 | `						sxi64 r;` |
|   368311 | 1735 | `						if( PH7_ADD_OVERFLOW64(pObj->x.iVal,1,&r) ){` |
...
|        - | 1741 | `#endif` |
|        3 | 1742 | `						}else{` |
|   368307 | 1743 | `							pObj->x.iVal = r;` |
|        - | 1744 | `						}` |
|        - | 1745 | `					}` |
|   368315 | 1746 | `					if( pInstr->iP1 ){` |
...
|        - | 1785 | `		}` |
|   184257 | 1786 | `	}` |
|   368315 | 1787 | `	PH7_HOOK_RMW_WRITEBACK(pTos->nIdx,pTos);` |
|   368315 | 1788 | `	break;` |
|        - | 1789 | `/*` |
|        - | 1790 | ` * DECR: P1 * *` |
|        - | 1791 | ` *` |
...
|    70635 | 1938 | `	PH7_MemObjToNumeric(pTos);` |
|    70635 | 1939 | `	if( pTos->iFlags & MEMOBJ_REAL ){` |
|      108 | 1940 | `		pTos->rVal = -pTos->rVal;` |
|       53 | 1941 | `	}` |
|    70635 | 1942 | `	if( pTos->iFlags & MEMOBJ_INT ){` |
|    70549 | 1943 | `		if( pTos->x.iVal == SMALLEST_INT64 ){` |
...
|        - | 1958 | `#endif` |
|        3 | 1959 | `		}else{` |
|    70545 | 1960 | `			pTos->x.iVal = -pTos->x.iVal;` |
|        - | 1961 | `		}` |
|    35272 | 1962 | `	}` |
|    70635 | 1963 | `	break;` |
|        - | 1964 | `/*` |
...
|    50811 | 1997 | `	if( (pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      145 | 1998 | `		PH7_MemObjToBool(pTos);` |
|       70 | 1999 | `	}` |
|    50811 | 2000 | `	pTos->x.iVal = !pTos->x.iVal;` |
|    50811 | 2001 | `	break;` |
|        - | 2002 | `/*` |
|        - | 2003 | ` * OP_BITNOT: * * *` |
|        - | 2004 | ` *` |
...
|        - | 2070 | ` */` |
|     6363 | 2071 | `case PH7_OP_ADD:{` |
|    12731 | 2072 | `	ph7_value *pNos = &pTos[-1];` |
|        - | 2073 | `#ifdef UNTRUST` |
|        - | 2074 | `	if( pNos < pStack ){` |
|        - | 2075 | `		goto Abort;` |
|        - | 2076 | `	}` |
...
|        - | 2082 | `		SyBlob sArMsg;` |
|    12731 | 2083 | `		SyBlobInit(&sArMsg,&pVm->sAllocator);` |
|    12731 | 2084 | `		if( VmArithOperandCheck(&(*pVm),pNos,pTos,"+",&sArMsg) != SXRET_OK ){` |
|        - | 2085 | `			sxi32 rcAr;` |
...
|        - | 2096 | `		}` |
|    12723 | 2097 | `		SyBlobRelease(&sArMsg);` |
|        - | 2098 | `	}` |
|        - | 2099 | `	/* Perform the addition */` |
|    12723 | 2100 | `	PH7_MemObjAdd(pNos,pTos,FALSE);` |
|    12723 | 2101 | `	VmPopOperand(&pTos,1);` |
|    12723 | 2102 | `	break;` |
|        - | 2103 | `				}` |
|        - | 2104 | `/*` |
|        - | 2105 | ` * OP_ADD_STORE * * *` |
...
|        - | 2526 | ` * back.` |
|        - | 2527 | ` */` |
|    86589 | 2528 | `case PH7_OP_CAT:{` |
|        - | 2529 | `	ph7_value *pNos,*pCur;` |
|   173183 | 2530 | `	if( pInstr->iP1 < 1 ){` |
|   144721 | 2531 | `		pNos = &pTos[-1];` |
|    72363 | 2532 | `	}else{` |
...
|   173183 | 2541 | `	if( (pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|     1919 | 2542 | `		PH7_MemObjToString(pNos);` |
|      957 | 2543 | `	}` |
|   173183 | 2544 | `	pCur = &pNos[1];` |
|   349899 | 2545 | `	while( pCur <= pTos ){` |
|   176721 | 2546 | `		if( (pCur->iFlags & MEMOBJ_STRING) == 0 ){` |
|    52221 | 2547 | `			PH7_MemObjToString(pCur);` |
|    26108 | 2548 | `		}` |
|        - | 2549 | `		/* Perform the concatenation */` |
|   176721 | 2550 | `		if( SyBlobLength(&pCur->sBlob) > 0 ){` |
|   176573 | 2551 | `			if( PH7_MemObjStringAppend(pNos,(const char *)SyBlobData(&pCur->sBlob),SyBlobLength(&pCur->sBlob)) != SXRET_OK ){` |
|        - | 2552 | `				/* Allocation failure: raise a fatal instead of a truncated concat */` |
|      ! 0 | 2553 | `				PH7_VmMemoryError(&(*pVm));` |
|      ! 0 | 2554 | `				goto Abort;` |
|        - | 2555 | `			}` |
|    88284 | 2556 | `		}` |
|   176721 | 2557 | `		SyBlobRelease(&pCur->sBlob);` |
|   176721 | 2558 | `		pCur++;` |
|        5 | 2559 | `	}` |
|   173183 | 2560 | `	pTos = pNos;` |
|   173183 | 2561 | `	break;` |
|        - | 2562 | `				}` |
|        - | 2563 | `/*  CAT_STORE: * * *` |
|        - | 2564 | ` *` |
...
|        - | 2566 | ` * back.` |
|        - | 2567 | ` */` |
|    13759 | 2568 | `case PH7_OP_CAT_STORE:{` |
|    27523 | 2569 | `	ph7_value *pNos = &pTos[-1];` |
|        - | 2570 | `	ph7_value *pObj;` |
|        - | 2571 | `	sxu32 nIdx;` |
|        - | 2572 | `#ifdef UNTRUST` |
|        - | 2573 | `	if( pNos < pStack ){` |
...
|    27523 | 2578 | `	if((pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|       59 | 2579 | `		PH7_MemObjToString(pNos);` |
|       29 | 2580 | `	}` |
|    27523 | 2581 | `	nIdx = pTos->nIdx;` |
...
|    27518 | 2593 | `	if( nIdx != SXU32_HIGH` |
|    27518 | 2594 | `	 && nIdx != pNos->nIdx` |
|    27514 | 2595 | `	 && (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx)) != 0` |
|    27515 | 2596 | `	 && (SyHashTotalEntry(&pVm->hTypedSlot) == 0` |
|    16355 | 2597 | `	     \|\| SyHashGet(&pVm->hTypedSlot,(const void *)&nIdx,sizeof(sxu32)) == 0) ){` |
|    27509 | 2598 | `		if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - | 2599 | `			/* e.g. $x = 5; $x .= "a";  ->  "5a" */` |
|        6 | 2600 | `			PH7_MemObjToString(pObj);` |
|        2 | 2601 | `		}` |
|    27509 | 2602 | `		if( SyBlobLength(&pNos->sBlob) > 0 ){` |
|    27505 | 2603 | `			if( PH7_MemObjStringAppend(pObj,(const char *)SyBlobData(&pNos->sBlob),SyBlobLength(&pNos->sBlob)) != SXRET_OK ){` |
...
|    27509 | 2622 | `		if( (pInstr+1)->iOp != PH7_OP_POP ){` |
...
|    27509 | 2627 | `		PH7_HOOK_RMW_WRITEBACK(nIdx,0);` |
|    27509 | 2628 | `		pNos->nIdx = SXU32_HIGH;` |
|    27509 | 2629 | `		VmPopOperand(&pTos,1);` |
|    27516 | 2630 | `		break;` |
|        - | 2631 | `	}` |
...
|        - | 2668 | ` * stack.` |
|        - | 2669 | ` */` |
|   114423 | 2670 | `case PH7_OP_LAND:` |
|        - | 2671 | `case PH7_OP_LOR: {` |
|        - | 2672 | `	VmOpRc rcOp;` |
|   229055 | 2673 | `	sState.pTos = pTos;` |
|   229055 | 2674 | `	sState.pc = pc;` |
|   229055 | 2675 | `	rcOp = VmExecOpLor(&(*pVm),&sState,pInstr);` |
|   229055 | 2676 | `	pTos = sState.pTos;` |
|   229055 | 2677 | `	pc = sState.pc;` |
|   229055 | 2678 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2679 | `		goto Abort;` |
|   229055 | 2680 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2895 | ` */` |
|     5444 | 2896 | `case PH7_OP_EQ:` |
|        - | 2897 | `case PH7_OP_NEQ: {` |
|        - | 2898 | `	VmOpRc rcOp;` |
|    10893 | 2899 | `	sState.pTos = pTos;` |
|    10893 | 2900 | `	sState.pc = pc;` |
|    10893 | 2901 | `	rcOp = VmExecOpNeq(&(*pVm),&sState,pInstr);` |
|    10893 | 2902 | `	pTos = sState.pTos;` |
|    10893 | 2903 | `	pc = sState.pc;` |
|    10893 | 2904 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2905 | `		goto Abort;` |
|    10893 | 2906 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2917 | ` */` |
|   228871 | 2918 | `case PH7_OP_TEQ: {` |
|        - | 2919 | `	VmOpRc rcOp;` |
|   457951 | 2920 | `	sState.pTos = pTos;` |
|   457951 | 2921 | `	sState.pc = pc;` |
|   457951 | 2922 | `	rcOp = VmExecOpTeq(&(*pVm),&sState,pInstr);` |
|   457951 | 2923 | `	pTos = sState.pTos;` |
|   457951 | 2924 | `	pc = sState.pc;` |
|   457951 | 2925 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2926 | `		goto Abort;` |
|   457951 | 2927 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2939 | ` *` |
|        - | 2940 | ` */` |
|   190638 | 2941 | `case PH7_OP_TNE: {` |
|        - | 2942 | `	VmOpRc rcOp;` |
|   381485 | 2943 | `	sState.pTos = pTos;` |
|   381485 | 2944 | `	sState.pc = pc;` |
|   381485 | 2945 | `	rcOp = VmExecOpTne(&(*pVm),&sState,pInstr);` |
|   381485 | 2946 | `	pTos = sState.pTos;` |
|   381485 | 2947 | `	pc = sState.pc;` |
|   381485 | 2948 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2949 | `		goto Abort;` |
|   381485 | 2950 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2971 | ` *` |
|        - | 2972 | ` */` |
|   146163 | 2973 | `case PH7_OP_LT:` |
|        - | 2974 | `case PH7_OP_LE: {` |
|        - | 2975 | `	VmOpRc rcOp;` |
|   292739 | 2976 | `	sState.pTos = pTos;` |
|   292739 | 2977 | `	sState.pc = pc;` |
|   292739 | 2978 | `	rcOp = VmExecOpLe(&(*pVm),&sState,pInstr);` |
|   292739 | 2979 | `	pTos = sState.pTos;` |
|   292739 | 2980 | `	pc = sState.pc;` |
|   292739 | 2981 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2982 | `		goto Abort;` |
|   292739 | 2983 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3004 | ` *` |
|        - | 3005 | ` */` |
|    86274 | 3006 | `case PH7_OP_GT:` |
|        - | 3007 | `case PH7_OP_GE: {` |
|        - | 3008 | `	VmOpRc rcOp;` |
|   172757 | 3009 | `	sState.pTos = pTos;` |
|   172757 | 3010 | `	sState.pc = pc;` |
|   172757 | 3011 | `	rcOp = VmExecOpGe(&(*pVm),&sState,pInstr);` |
|   172757 | 3012 | `	pTos = sState.pTos;` |
|   172757 | 3013 | `	pc = sState.pc;` |
|   172757 | 3014 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 3015 | `		goto Abort;` |
|   172757 | 3016 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3390 | ` */` |
|    12050 | 3391 | `case PH7_OP_FOREACH_INIT: {` |
|        - | 3392 | `	VmOpRc rcOp;` |
|    24105 | 3393 | `	sState.pTos = pTos;` |
|    24105 | 3394 | `	sState.pc = pc;` |
|    24105 | 3395 | `	rcOp = VmExecOpForeachInit(&(*pVm),&sState,pInstr);` |
|    24105 | 3396 | `	pTos = sState.pTos;` |
|    24105 | 3397 | `	pc = sState.pc;` |
|    24105 | 3398 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 3399 | `		goto Abort;` |
|    24105 | 3400 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3408 | ` */` |
|   121026 | 3409 | `case PH7_OP_FOREACH_STEP: {` |
|        - | 3410 | `	VmOpRc rcOp;` |
|   242057 | 3411 | `	sState.pTos = pTos;` |
|   242057 | 3412 | `	sState.pc = pc;` |
|   242057 | 3413 | `	rcOp = VmExecOpForeachStep(&(*pVm),&sState,pInstr);` |
|   242057 | 3414 | `	pTos = sState.pTos;` |
|   242057 | 3415 | `	pc = sState.pc;` |
|   242057 | 3416 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 3417 | `		goto Abort;` |
|   242055 | 3418 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3426 | ` */` |
|    22530 | 3427 | `case PH7_OP_MEMBER: {` |
|        - | 3428 | `	VmOpRc rcOp;` |
|    45065 | 3429 | `	sState.pTos = pTos;` |
|    45065 | 3430 | `	sState.pc = pc;` |
|    45065 | 3431 | `	rcOp = VmExecOpMember(&(*pVm),&sState,pInstr);` |
|    45065 | 3432 | `	pTos = sState.pTos;` |
|    45065 | 3433 | `	pc = sState.pc;` |
|    45065 | 3434 | `	if( rcOp == VM_OP_ABORT ){` |
|        8 | 3435 | `		goto Abort;` |
|    45059 | 3436 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|  1041536 | 3831 | `	sxi32 nCallArgs = pInstr->iP1 + (pInstr->iP2 ? VmSpreadOwnExtra(pVm,pInstr->iP1,pTos) : 0);` |
|        - | 3832 | `	ph7_value *pArg;` |
|  1041536 | 3833 | `	pArg = &pTos[-nCallArgs];` |
...
|  1041536 | 3842 | `	VmCallArgMap *pEffCallMap = (VmCallArgMap *)pInstr->p3;` |
...
|  1041536 | 3849 | `	if( VmValueIsClosure(pVm,pTos) ){` |
|        - | 3850 | `		ph7_value sCallable;` |
|     1153 | 3851 | `		PH7_MemObjInit(pVm,&sCallable);` |
|     1153 | 3852 | `		if( VmClosureUnwrap(pVm,pTos,&sCallable) == SXRET_OK ){` |
|     1153 | 3853 | `			PH7_MemObjRelease(pTos);` |
|     1153 | 3854 | `			PH7_MemObjStore(&sCallable,pTos);` |
|      574 | 3855 | `		}` |
|     1153 | 3856 | `		PH7_MemObjRelease(&sCallable);` |
|      574 | 3857 | `	}` |
|        - | 3858 | `	/* Extract function name */` |
|  1041536 | 3859 | `	if( (pTos->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|      142 | 4054 | `		break;` |
|        - | 4055 | `	}` |
|  1041376 | 4056 | `	SyStringInitFromBuf(&sName,SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
...
|  1041376 | 4060 | `	if( sName.nByte > 0 && sName.zString[0] == '\\' ){` |
...
|  1041376 | 4067 | `	pEntry = SyHashGet(&pVm->hFunction,(const void *)sName.zString,sName.nByte);` |
...
|        - | 4073 | `	{` |
|  1041376 | 4074 | `	VmCallArgMap *pCallMap = pEffCallMap;` |
|  1041376 | 4075 | `	if( pEntry == 0 && pCallMap && pCallMap->bIsNamespaced ){` |
...
|        - | 4106 | `		VmSlot sArg;` |
|        - | 4107 | `		sxu32 n;` |
|   105389 | 4108 | `		int bClosureThis = 0;` |
|   105389 | 4109 | `		ph7_class *pClosureScope = 0;` |
|        - | 4110 | `		/* initialize fields */` |
|   105389 | 4111 | `		pVmFunc = (ph7_vm_func *)pEntry->pUserData;` |
|   105389 | 4112 | `		pThis = 0;` |
|   105389 | 4113 | `		pSelf = 0;` |
...
|       14 | 4128 | `		}` |
|   105389 | 4129 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
...
|   158183 | 4236 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   105384 | 4237 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
...
|   105389 | 4244 | `		if( VmRecursionExceeded(pVm) ){` |
...
|        3 | 4248 | `			goto Abort;` |
|        - | 4249 | `		}` |
|   105387 | 4250 | `		if( pVmFunc->pNextName ){` |
...
|   105387 | 4262 | `		pSelfHint = pSelf;` |
|   105387 | 4263 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
...
|    12325 | 4267 | `			}` |
|    12838 | 4268 | `		}` |
|   105387 | 4269 | `		if( pSelf == 0 && (pVmFunc->iFlags & VM_FUNC_CLOSURE) ){` |
...
|     1805 | 4276 | `			if( pClosureScope ){` |
|       29 | 4277 | `				pSelf = pClosureScope;` |
|     1791 | 4278 | `			}else if( pVmFunc->pLsbClass ){` |
|       61 | 4279 | `				pSelf = (ph7_class *)pVmFunc->pLsbClass;` |
|       29 | 4280 | `			}` |
|      900 | 4281 | `		}` |
|   105387 | 4282 | `		if( SySetUsed(&pVmFunc->aAttrs) > 0 ){` |
...
|       56 | 4287 | `		}` |
|   105387 | 4288 | `		if( pVmFunc->iFlags & VM_FUNC_GENERATOR ){` |
...
|   105047 | 4520 | `		aFormalArg = (ph7_vm_func_arg *)SySetBasePtr(&pVmFunc->aArgs);` |
|        - | 4521 | `		/* Create a new VM frame  */` |
|   105047 | 4522 | `		rc = VmEnterFrame(&(*pVm),pVmFunc,pThis,&pFrame);` |
|   105047 | 4523 | `		if( rc != SXRET_OK ){` |
...
|   105047 | 4551 | `		pFrame->nActualArgs = (int)(pTos - pArg);` |
|   105047 | 4552 | `		if( pThis && ((pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) \|\| bClosureThis) ){` |
...
|    12412 | 4560 | `			}` |
|    12412 | 4561 | `		}` |
|   105047 | 4562 | `		if( SySetUsed(&pVmFunc->aStatic) > 0 ){` |
...
|        - | 4589 | `		{` |
|   105047 | 4590 | `		VmCallArgMap *pCallMap3 = pEffCallMap;` |
|        - | 4591 | `		/* Caller file's strict_types mode — governs parameter coercion` |
|        - | 4592 | `		 * (but NOT return coercion, which uses the callee's file). */` |
|   105047 | 4593 | `		int bCallIsStrict = (pCallMap3 && pCallMap3->bStrict) ? 1 : 0;` |
|   105047 | 4594 | `		if( pCallMap3 && pCallMap3->bHasNamed ){` |
|        - | 4595 | `			/* ============================================================` |
...
|        - | 4980 | `		 * ============================================================ */` |
|   104779 | 4981 | `		n = 0;` |
|   269321 | 4982 | `		while( pArg < pTos ){` |
|   164847 | 4983 | `			if( n < SySetUsed(&pVmFunc->aArgs) && (aFormalArg[n].iFlags & VM_FUNC_ARG_VARIADIC) ){` |
...
|        - | 5083 | `			}` |
|   164647 | 5084 | `			if( n < SySetUsed(&pVmFunc->aArgs) ){` |
...
|   164133 | 5091 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_UNION ){` |
...
|   164046 | 5124 | `				if( aFormalArg[n].nType > 0` |
|    89262 | 5125 | `					&& !((aFormalArg[n].iFlags & VM_FUNC_ARG_NULLABLE) && (pArg->iFlags & MEMOBJ_NULL)) ){` |
...
|       13 | 5201 | `					}` |
|     6975 | 5202 | `				}` |
|   164035 | 5203 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_BY_REF ){` |
...
|   163795 | 5255 | `					pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|        - | 5256 | `				}` |
|    82223 | 5257 | `			}else{` |
|        - | 5258 | `				char zName[32];` |
...
|        - | 5265 | `			}` |
|   164547 | 5266 | `			if( pObj ){` |
|   164311 | 5267 | `				PH7_MemObjStore(pArg,pObj);` |
|        - | 5268 | `				/* Insert argument index  */` |
|   164311 | 5269 | `				sArg.nIdx = pObj->nIdx;` |
|   164311 | 5270 | `				sArg.pUserData = 0;` |
|   164311 | 5271 | `				SySetPut(&pFrame->sArg,(const void *)&sArg);` |
|    82357 | 5272 | `			}` |
|   164547 | 5273 | `			PH7_MemObjRelease(pArg);` |
|   164547 | 5274 | `			pArg++;` |
|   164547 | 5275 | `			++n;` |
|        5 | 5276 | `		}` |
|        - | 5277 | `		} /* end named vs positional branch */` |
|        - | 5278 | `		/* Set up closure environment */` |
|   104925 | 5279 | `		if( pVmFunc->iFlags & VM_FUNC_CLOSURE ){` |
|        - | 5280 | `			ph7_vm_func_closure_env *aEnv,*pEnv;` |
|        - | 5281 | `			ph7_value *pValue;` |
|        - | 5282 | `			sxu32 iEnv;` |
|     1787 | 5283 | `			aEnv = (ph7_vm_func_closure_env *)SySetBasePtr(&pVmFunc->aClosureEnv);` |
|     3913 | 5284 | `			for(iEnv = 0 ; iEnv < SySetUsed(&pVmFunc->aClosureEnv) ; ++iEnv ){` |
|     2131 | 5285 | `				pEnv = &aEnv[iEnv];` |
|     2131 | 5286 | `				if( (pEnv->iFlags & VM_FUNC_ARG_IGNORE) && (pEnv->sValue.iFlags & MEMOBJ_NULL) ){` |
...
|   104920 | 5327 | `		if( n < SySetUsed(&pVmFunc->aArgs)` |
|    56160 | 5328 | `		 && (pVmFunc->iFlags & (VM_FUNC_INTERNAL\|VM_FUNC_CLASS_METHOD)) != VM_FUNC_INTERNAL ){` |
|        - | 5329 | `			sxu32 nNonVar,nReq;` |
|     5943 | 5330 | `			nReq = VmFuncRequiredArgCount(pVmFunc,&nNonVar);` |
|     5943 | 5331 | `			if( n < nReq ){` |
...
|   116987 | 5351 | `		while( n < SySetUsed(&pVmFunc->aArgs) ){` |
|    12333 | 5352 | `			if( aFormalArg[n].iFlags & VM_FUNC_ARG_VARIADIC ){` |
...
|        - | 5363 | `			}` |
|    12089 | 5364 | `			if( SySetUsed(&aFormalArg[n].aByteCode) > 0 ){` |
|    12087 | 5365 | `				pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|    12087 | 5366 | `				if( pObj ){` |
|        - | 5367 | `					/* Evaluate the default value and extract it's result */` |
|    12087 | 5368 | `					rc = VmLocalExec(&(*pVm),&aFormalArg[n].aByteCode,pObj,FALSE);` |
|    12087 | 5369 | `					if( rc == PH7_ABORT ){` |
|      ! 0 | 5370 | `						goto Abort;` |
|        - | 5371 | `					}` |
|        - | 5372 | `					/* Insert argument index */` |
|    12087 | 5373 | `					sArg.nIdx = pObj->nIdx;` |
|    12087 | 5374 | `					sArg.pUserData = 0;` |
|    12087 | 5375 | `					SySetPut(&pFrame->sArg,(const void *)&sArg);` |
...
|    12082 | 5380 | `					if( aFormalArg[n].nType > 0 && aFormalArg[n].nType != MEMOBJ_OBJ` |
|     3954 | 5381 | `						&& ((pObj->iFlags & aFormalArg[n].nType) == 0)` |
|     1983 | 5382 | `						&& !((aFormalArg[n].iFlags & VM_FUNC_ARG_NULLABLE) && (pObj->iFlags & MEMOBJ_NULL)) ){` |
...
|        - | 5394 | `		 */` |
|   104903 | 5395 | `		PH7_MemObjRelease(pTos);` |
|   104903 | 5396 | `		pTos = &pTos[-nCallArgs];` |
...
|        - | 5408 | `		 * per function. */` |
|        - | 5409 | `		{` |
|   104903 | 5410 | `			sxu32 nSlots = pVmFunc->nMaxStack;` |
|   104903 | 5411 | `			if( nSlots == 0 ){` |
|     8285 | 5412 | `				sxu32 nInstr = SySetUsed(&pVmFunc->aByteCode);` |
|    12425 | 5413 | `				sxu32 nTight = VmComputeMaxStack(&(*pVm),` |
|     8280 | 5414 | `					(VmInstr *)SySetBasePtr(&pVmFunc->aByteCode),nInstr);` |
|     8285 | 5415 | `				nSlots = ( nTight == VM_STACK_UNMODELED ) ? nInstr : nTight;` |
|     8285 | 5416 | `				if( nSlots == 0 ){ nSlots = 1; } /* a 0-depth body still needs a valid, nonzero cache marker */` |
|     8285 | 5417 | `				pVmFunc->nMaxStack = nSlots;` |
|     4140 | 5418 | `			}` |
|   104903 | 5419 | `			pFrameStack = VmOperandStackAlloc(&(*pVm),nSlots);` |
|        - | 5420 | `		}` |
|   104903 | 5421 | `		if( pFrameStack == 0 ){` |
...
|      ! 0 | 5428 | `			break;` |
|        - | 5429 | `		}` |
|    52347 | 5430 | `SkipFuncBody:` |
|   105037 | 5431 | `		if( pSelf ){` |
|        - | 5432 | `			/* Push class name */` |
|    25735 | 5433 | `			SySetPut(&pVm->aSelf,(const void *)&pSelf);` |
|    12865 | 5434 | `		}` |
|        - | 5435 | `		/* Increment nesting level */` |
|   105037 | 5436 | `		pVm->nRecursionDepth++;` |
|   105037 | 5437 | `		if( rc == PH7_EXCEPTION ){` |
...
|   104903 | 5466 | `			VmCallFrame *pRec = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   104903 | 5467 | `			if( pRec ){` |
|   102261 | 5468 | `				pVm->pIdleCallFrames = (void *)pRec->pPrev;` |
|    51235 | 5469 | `			}else{` |
|     2647 | 5470 | `				pRec = (VmCallFrame *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmCallFrame));` |
|        - | 5471 | `			}` |
|   104903 | 5472 | `			if( pRec == 0 ){` |
...
|      ! 0 | 5483 | `				goto Abort;` |
|        - | 5484 | `			}` |
|   104903 | 5485 | `			sState.pTos = pTos;` |
|   104903 | 5486 | `			sState.pc = pc;` |
|   104903 | 5487 | `			pRec->sCaller = sState;` |
|   104903 | 5488 | `			pRec->sCall.pVmFunc = pVmFunc;` |
|   104903 | 5489 | `			pRec->sCall.pFrame = pFrame;` |
|   104903 | 5490 | `			pRec->sCall.pFrameStack = pFrameStack;` |
|   104903 | 5491 | `			pRec->sCall.nStackCap = pVmFunc->nMaxStack + VM_STACK_GUARD;` |
|   104903 | 5492 | `			pRec->sCall.nLastRef = SXU32_HIGH;` |
|   104903 | 5493 | `			pRec->sCall.bSelfPushed = (sxu8)(pSelf ? 1 : 0);` |
|   104903 | 5494 | `			pRec->pPrev = pCallTop;` |
|   104903 | 5495 | `			pCallTop = pRec;` |
|        - | 5496 | `			/* Switch to the callee activation (what the recursive` |
|        - | 5497 | `			 * VmByteCodeExec entry used to set up). */` |
|   104903 | 5498 | `			aInstr = (VmInstr *)SySetBasePtr(&pVmFunc->aByteCode);` |
|   104903 | 5499 | `			pStack = pFrameStack;` |
|   104903 | 5500 | `			pTos = &pStack[-1];` |
|   104903 | 5501 | `			pc = 0;` |
|   104903 | 5502 | `			sState.aInstr = aInstr;` |
|   104903 | 5503 | `			sState.pStack = pStack;` |
|   104903 | 5504 | `			sState.nStackCap = pRec->sCall.nStackCap; /* callee's operand-stack capacity for OP_SPREAD growth */` |
|   104903 | 5505 | `			sState.nStackOrig = pRec->sCall.nStackCap; /* fixed headroom reference (never grows) */` |
|   104903 | 5506 | `			sState.pTos = pTos;` |
|   104903 | 5507 | `			sState.pc = 0;` |
|   104903 | 5508 | `			sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|   104903 | 5509 | `			sState.pEntryFrame = pVm->pFrame;` |
|   104903 | 5510 | `			sState.pResult = pRec->sCaller.pTos;` |
|   104903 | 5511 | `			sState.pLastRef = &pRec->sCall.nLastRef;` |
|   104903 | 5512 | `			sState.pEnforceRetFunc = VmFuncHasReturnType(pVmFunc) ? pVmFunc : 0;` |
|   104903 | 5513 | `			sState.is_callback = 0;` |
|   104903 | 5514 | `			sState.bReturnPropagates = 0;` |
|   104903 | 5515 | `			goto VmLoopFetch;` |
|        - | 5516 | `		}` |
|       57 | 5517 | `	}else{` |
...
|   935992 | 5526 | `		pEntry = SyHashGet(&pVm->hHostFunction,(const void *)sName.zString,sName.nByte);` |
|        - | 5527 | `		{` |
|   935992 | 5528 | `		VmCallArgMap *pCallMap2 = pEffCallMap;` |
|   935992 | 5529 | `		if( pEntry == 0 && pCallMap2 && pCallMap2->bIsNamespaced ){` |
...
|        - | 5634 | `			}` |
|        - | 5635 | `		}` |
|   935976 | 5636 | `		pFunc = (ph7_user_func *)pEntry->pUserData;` |
...
|  1404323 | 5641 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   935971 | 5642 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
|        - | 5643 | `		/* Start collecting function arguments */` |
|   935976 | 5644 | `		SySetReset(&aArg);` |
|  2529973 | 5645 | `		while( pArg < pTos ){` |
|  1594002 | 5646 | `			SySetPut(&aArg,(const void *)&pArg);` |
|  1594002 | 5647 | `			pArg++;` |
|        5 | 5648 | `		}` |
|        - | 5649 | `		/* Assume a null return value */` |
|   935976 | 5650 | `		PH7_MemObjInit(&(*pVm),&sRet);` |
|        - | 5651 | `		/* Init the call context */` |
|   935976 | 5652 | `		VmInitCallContext(&sCtx,&(*pVm),pFunc,&sRet,0);` |
...
|   935976 | 5659 | `		sCtx.pArgMap = pEffCallMap;` |
|        - | 5660 | `		{` |
|   935976 | 5661 | `		int nGiven = (int)SySetUsed(&aArg);` |
...
|   935976 | 5667 | `		if( pFunc->nMinArg > 0 && nGiven < pFunc->nMinArg ){` |
...
|      232 | 5674 | `				nGiven);` |
|   935744 | 5675 | `		}else if( pFunc->bHasMaxArg && nGiven > (int)pFunc->nMaxArg ){` |
...
|       40 | 5688 | `				nGiven);` |
|  1403547 | 5689 | `		}else if( SXRET_OK != (rc = VmEnforceBuiltinArgTypes(&sCtx,pFunc,nGiven,` |
|   935427 | 5690 | `			(ph7_value **)SySetBasePtr(&aArg))) ){` |
|        - | 5691 | `			/* TypeError thrown: rc carries the caught/uncaught status */` |
|      112 | 5692 | `		}else{` |
|        - | 5693 | `			/* Call the foreign function */` |
|   935218 | 5694 | `			rc = pFunc->xFunc(&sCtx,nGiven,(ph7_value **)SySetBasePtr(&aArg));` |
|        - | 5695 | `		}` |
|        - | 5696 | `		}` |
|        - | 5697 | `		/* Release the call context */` |
|   935976 | 5698 | `		VmReleaseCallContext(&sCtx);` |
|   935976 | 5699 | `		if( rc == PH7_ABORT ){` |
...
|      578 | 5704 | `			goto Abort;` |
|        - | 5705 | `		}` |
|   935402 | 5706 | `		if( rc != PH7_SUSPEND && pVm->pInlineInstr == (void *)aInstr ){` |
...
|      ! 0 | 5719 | `		}` |
|   935398 | 5720 | `		if( rc == PH7_EXCEPTION ){` |
...
|      839 | 5740 | `			break;` |
|        - | 5741 | `		}` |
|   934366 | 5742 | `		if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|   913062 | 5766 | `			VmPopOperand(&pTos,nCallArgs);` |
|   456890 | 5767 | `		}` |
|        - | 5768 | `		/* Save foreign function return value into the (now top) function-name slot */` |
|   934012 | 5769 | `		PH7_MemObjStore(&sRet,pTos);` |
|   934012 | 5770 | `		PH7_MemObjRelease(&sRet);` |
|        - | 5771 | `	}` |
|   934116 | 5772 | `	break;` |
|        - | 5773 | `				  }` |
|        - | 5774 | `/*` |
...
|        - | 5777 | ` */` |
|    26055 | 5778 | `case PH7_OP_CONSUME: {` |
|        - | 5779 | `	VmOpRc rcOp;` |
|    52115 | 5780 | `	sState.pTos = pTos;` |
|    52115 | 5781 | `	sState.pc = pc;` |
|    52115 | 5782 | `	rcOp = VmExecOpConsume(&(*pVm),&sState,pInstr);` |
|    52115 | 5783 | `	pTos = sState.pTos;` |
|    52115 | 5784 | `	pc = sState.pc;` |
|    52115 | 5785 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 5786 | `		goto Abort;` |
|    52115 | 5787 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 5792 |  |
|        - | 5793 | `		} /* Switch() */` |
| 16690691 | 5794 | `		pc++; /* Next instruction in the stream */` |
|        5 | 5795 | `	} /* For(;;) */` |
|   131161 | 5796 | `Done:` |
...
|   262531 | 5800 | `	rc = SXRET_OK;` |
|   262531 | 5801 | `	goto Unwind;` |
|      823 | 5802 | `Suspend:` |
...
|   133173 | 5860 | `	for(;;){` |
|   266147 | 5861 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|      ! 0 | 5869 | `			}` |
|     1162 | 5870 | `		}` |
|   266147 | 5871 | `		if( pCallTop == 0 ){` |
|   161659 | 5872 | `			return VmExecFinalize(&(*pVm),&sState,&aArg,pTos,rc);` |
|        - | 5873 | `		}` |
|   104493 | 5874 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|      636 | 5880 | `		}` |
|        - | 5881 | `		{` |
|   104493 | 5882 | `			VmCallFrame *pRec = pCallTop;` |
|   104493 | 5883 | `			sState = pRec->sCaller;` |
|   104493 | 5884 | `			rc = VmCallFinish(&(*pVm),&sState,&pRec->sCall,rc);` |
|   104493 | 5885 | `			pCallTop = pRec->pPrev;` |
|   104493 | 5886 | `			pRec->pPrev = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   104493 | 5887 | `			pVm->pIdleCallFrames = (void *)pRec;` |
|   104493 | 5888 | `			aInstr = sState.aInstr;` |
|   104493 | 5889 | `			pStack = sState.pStack;` |
|   104493 | 5890 | `			pTos = sState.pTos;` |
|   104493 | 5891 | `			pc = sState.pc;` |
|        - | 5892 | `		}` |
|   104493 | 5893 | `		if( rc == PH7_OK ){` |
|   103727 | 5894 | `			pc++; /* the loop-bottom increment this OP_CALL missed */` |
|   103727 | 5895 | `			goto VmLoopFetch;` |
|        - | 5896 | `		}` |
|        5 | 5897 | `	}` |
|    81009 | 5898 | `}` |
|        - | 5899 |  |
