...
|        - |  162 | ` */` |
|   161000 |  163 | `static sxi32 VmExecFinalize(ph7_vm *pVm,VmExecState *pState,SySet *pArg,ph7_value *pTos,sxi32 rcTerm)` |
|        5 |  164 | `{` |
|    80500 |  165 | `	SXUNUSED(pVm);` |
|   161005 |  166 | `	if( rcTerm != PH7_SUSPEND && !pState->bReturnPropagates ){` |
|   157295 |  167 | `		VmClearFrameReturn(pState->pEntryFrame);` |
|    78645 |  168 | `	}` |
|   161005 |  169 | `	SySetRelease(pArg);` |
|   161005 |  170 | `	if( rcTerm == PH7_ABORT \|\| rcTerm == PH7_EXCEPTION ){` |
|     2841 |  171 | `		while( pTos >= pState->pStack ){` |
|     1789 |  172 | `			PH7_MemObjRelease(pTos);` |
|     1789 |  173 | `			pTos--;` |
|        5 |  174 | `		}` |
|      526 |  175 | `	}` |
|   161005 |  176 | `	return rcTerm;` |
|        5 |  177 | `}` |
|        - |  178 | `/*` |
...
|        - |  189 | ` */` |
|   105944 |  190 | `static sxi32 VmCallFinish(ph7_vm *pVm,VmExecState *pCaller,VmCallRecord *pCallee,sxi32 rc)` |
|        5 |  191 | `{` |
|        - |  192 | `	ph7_value *pObj;` |
|        - |  193 | `	/* Decrement nesting level */` |
|   105949 |  194 | `	pVm->nRecursionDepth--;` |
|   105949 |  195 | `	if( pCallee->bSelfPushed ){` |
|        - |  196 | `		/* Pop class name */` |
|    25549 |  197 | `		(void)SySetPop(&pVm->aSelf);` |
|    12772 |  198 | `	}` |
|   105949 |  199 | `	if( (pCallee->pVmFunc->iFlags & VM_FUNC_REF_RETURN) && rc == SXRET_OK ){` |
...
|       25 |  225 | `	}` |
|   105949 |  226 | `	if( rc != PH7_ABORT && ((pCallee->pFrame->iFlags & VM_FRAME_THROW) \|\| rc == PH7_EXCEPTION) ){` |
...
|   105949 |  272 | `	if( rc != PH7_SUSPEND && pCallee->pFrameStack ){` |
...
|   105815 |  276 | `		VmOperandStackRecycle(pVm,pCallee->pFrameStack,pCallee->nStackCap);` |
|    53010 |  277 | `	}` |
|        - |  278 | `	/* Leave the frame */` |
|   105949 |  279 | `	VmLeaveFrame(&(*pVm));` |
|   105949 |  280 | `	if( rc == PH7_ABORT ){` |
|      336 |  281 | `		return PH7_ABORT;` |
|        - |  282 | `	}` |
|   105617 |  283 | `	if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|        - |  291 | `	}` |
|   105617 |  292 | `	if( rc == PH7_EXCEPTION ){` |
|      469 |  293 | `		return PH7_EXCEPTION;` |
|        - |  294 | `	}` |
|   105153 |  295 | `	return PH7_OK;` |
|    53082 |  296 | `}` |
|        - |  297 | `/*` |
...
|        - |  330 | ` * nesting.` |
|        - |  331 | ` */` |
|   161358 |  332 | `PH7_PRIVATE sxi32 VmByteCodeExec(` |
...
|   161363 |  352 | `	if( VmNativeNestingExceeded(pVm) ){` |
...
|   161359 |  362 | `	nSavedBrc = pVm->nBoundaryRc;` |
|   161359 |  363 | `	pVm->nBoundaryRc = 0;` |
...
|   161359 |  370 | `	nSavedLine = pVm->nCurLine;` |
|   161359 |  371 | `	pVm->nVmExecDepth++;` |
|   242036 |  372 | `	rc = VmByteCodeExecBody(&(*pVm),aInstr,pStack,nTos,pResult,pLastRef,is_callback,nPc,` |
|    80677 |  373 | `		pEnforceRetFunc,bReturnPropagates,pAdoptSegment,ppBaseOwner,pnBaseCap,nStackOrig);` |
|   161359 |  374 | `	pVm->nVmExecDepth--;` |
|   161359 |  375 | `	pVm->nCurLine = nSavedLine;` |
|   161359 |  376 | `	if( nSavedBrc != 0 && (nSavedBrc == PH7_ABORT \|\| pVm->nBoundaryRc == 0) ){` |
|       15 |  377 | `		pVm->nBoundaryRc = nSavedBrc;` |
|        6 |  378 | `	}` |
|   161359 |  379 | `	return rc;` |
|    80684 |  380 | `}` |
|   161354 |  381 | `static sxi32 VmByteCodeExecBody(` |
...
|        - |  399 | `	ph7_value *pTos;` |
|        - |  400 | `	SySet aArg;` |
|   161359 |  401 | `	VmCallFrame *pCallTop = 0; /* Top of this invocation's in-loop call-record` |
...
|        - |  409 | `	sxi32 pc;` |
|        - |  410 | `	sxi32 rc;` |
|   161359 |  411 | `	sState.aInstr = aInstr;` |
|   161359 |  412 | `	sState.pStack = pStack;` |
|   161359 |  413 | `	sState.nStackCap = pnBaseCap ? *pnBaseCap : 0; /* CURRENT capacity (grown on a coroutine resume) */` |
|   161359 |  414 | `	sState.nStackOrig = nStackOrig;                /* ORIGINAL capacity — fixed headroom reference */` |
|   161359 |  415 | `	sState.pResult = pResult;` |
|   161359 |  416 | `	sState.pLastRef = pLastRef;` |
|   161359 |  417 | `	sState.pEnforceRetFunc = pEnforceRetFunc;` |
|   161359 |  418 | `	sState.is_callback = (sxu8)(is_callback ? 1 : 0);` |
|   161359 |  419 | `	sState.bReturnPropagates = (sxu8)(bReturnPropagates ? 1 : 0);` |
|        - |  420 | `	/* Argument container */` |
|   161359 |  421 | `	SySetInit(&aArg,&pVm->sAllocator,sizeof(ph7_value *));` |
|   161359 |  422 | `	if( nTos < 0 ){` |
|   145533 |  423 | `		pTos = &pStack[-1];` |
|    72769 |  424 | `	}else{` |
|    15831 |  425 | `		pTos = &pStack[nTos];` |
|        - |  426 | `	}` |
|   161359 |  427 | `	sState.pTos = pTos;` |
|   161359 |  428 | `	sState.pc = nPc;` |
...
|   161354 |  446 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->pFrame == pVm->pFrame` |
|     2816 |  447 | `	 && pStack == pVm->pActiveCtx->pStack ){` |
|     1805 |  448 | `		sState.nExceptionBase = pVm->pActiveCtx->nExceptionBase;` |
|      905 |  449 | `	}else{` |
|   159559 |  450 | `		sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|        - |  451 | `	}` |
|   161359 |  452 | `	sState.pEntryFrame = pVm->pFrame;` |
|   161359 |  453 | `	pc = nPc;` |
...
|   161354 |  506 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->pInjected` |
...
|   161344 |  567 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->bClosing` |
...
| 17246580 |  603 | `		if( pVm->nBoundaryRc != 0 \|\| SySetUsed(&pVm->aHookRmw) > 0 ){` |
|      761 |  604 | `			if( pVm->nBoundaryRc != 0 ){` |
|      193 |  605 | `				sxi32 rcBr = pVm->nBoundaryRc;` |
|      193 |  606 | `				pVm->nBoundaryRc = 0;` |
|      193 |  607 | `				if( rcBr == PH7_ABORT ){` |
|       68 |  608 | `					goto Abort;` |
|        - |  609 | `				}` |
|      126 |  610 | `				if( pVm->pInlineInstr == (void *)aInstr ){` |
...
|        2 |  619 | `				}else{` |
|        - |  620 | `					sxi32 iBrPc;` |
|      124 |  621 | `					if( VmRecordedResume(pVm,&iBrPc,sState.pEntryFrame,aInstr) ){` |
...
| 17246480 |  658 | `		pInstr = &aInstr[pc];` |
| 17246480 |  659 | `		if( pInstr->nLine ){` |
...
| 17034338 |  663 | `			pVm->nCurLine = pInstr->nLine;` |
|  8523522 |  664 | `		}` |
| 17246480 |  665 | `		rc = SXRET_OK;` |
|        - |  666 | `/*` |
...
|        - |  672 | ` */` |
| 17246480 |  673 | `		switch(pInstr->iOp){` |
|        - |  674 | `/*` |
|        - |  675 | ` * DONE: P1 * *` |
|        - |  676 | ` *` |
...
|        - |  679 | ` */` |
|   131392 |  680 | `case PH7_OP_DONE:` |
|   262999 |  681 | `	if( pInstr->iP2 && sState.bReturnPropagates ){` |
...
|   262810 |  711 | `	if( sState.pEnforceRetFunc && VmFuncHasReturnType(sState.pEnforceRetFunc)` |
...
|     4591 |  736 | `	}` |
|   262791 |  737 | `	if( pInstr->iP1 && pTos >= pStack ){` |
|   158471 |  738 | `		if( sState.pLastRef ){` |
|    95419 |  739 | `			*sState.pLastRef = pTos->nIdx;` |
|    47812 |  740 | `		}` |
|   158471 |  741 | `		if( sState.pResult ){` |
|        - |  742 | `			/* Execution result */` |
|   151375 |  743 | `			PH7_MemObjStore(pTos,sState.pResult);` |
|    75790 |  744 | `		}` |
|   158471 |  745 | `		VmPopOperand(&pTos,1);` |
|   183663 |  746 | `	}else if( sState.pLastRef ){` |
...
|     8977 |  752 | `		*sState.pLastRef = SXU32_HIGH;` |
|     4486 |  753 | `	}` |
...
|        - |  762 | `	 */` |
|   262791 |  763 | `	rc = VmDrainFinally(&(*pVm),sState.nExceptionBase);` |
|   262791 |  764 | `	if( rc == SXERR_ABORT ){` |
|      ! 0 |  765 | `		goto Abort;` |
|        - |  766 | `	}` |
|   262791 |  767 | `	if( rc == PH7_EXCEPTION ){` |
...
|        - |  778 | `	}` |
|   262787 |  779 | `	if( sState.pEntryFrame->bHasRet && !sState.bReturnPropagates ){` |
...
|        - |  835 | ` */` |
|   282428 |  836 | `case PH7_OP_JMP:` |
|   565072 |  837 | `	pc = pInstr->iP2 - 1;` |
|   565072 |  838 | `	break;` |
|        - |  839 | `/*` |
|        - |  840 | ` * JZ: P1 P2 *` |
|        - |  841 | ` *` |
...
|  1653612 |  852 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     1003 |  853 | `		PH7_MemObjToBool(pTos);` |
|      500 |  854 | `	}` |
|  1653612 |  855 | `	if( !pTos->x.iVal ){` |
|        - |  856 | `		/* Take the jump */` |
|   938650 |  857 | `		pc = pInstr->iP2 - 1;` |
|   469590 |  858 | `	}` |
|  1653612 |  859 | `	if( !pInstr->iP1 ){` |
|  1409587 |  860 | `		VmPopOperand(&pTos,1);` |
|   705374 |  861 | `	}` |
|  1653612 |  862 | `	break;` |
|        - |  863 | `/*` |
|        - |  864 | ` * JNZ: P1 P2 *` |
...
|   188807 |  876 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      ! 0 |  877 | `		PH7_MemObjToBool(pTos);` |
|      ! 0 |  878 | `	}` |
|   188807 |  879 | `	if( pTos->x.iVal ){` |
|        - |  880 | `		/* Take the jump */` |
|     9585 |  881 | `		pc = pInstr->iP2 - 1;` |
|     4790 |  882 | `	}` |
|   188807 |  883 | `	if( !pInstr->iP1 ){` |
...
|        - |  899 | ` */` |
|   690230 |  900 | `case PH7_OP_POP: {` |
|  1381516 |  901 | `	sxi32 n = pInstr->iP1;` |
|  1381516 |  902 | `	if( &pTos[-n+1] < pStack ){` |
|        - |  903 | `		/* TICKET 1433-51 Stack underflow must be handled at run-time */` |
|       79 |  904 | `		n = (sxi32)(pTos - pStack);` |
|       38 |  905 | `	}` |
|  1381516 |  906 | `	VmPopOperand(&pTos,n);` |
|  1381516 |  907 | `	break;` |
|        - |  908 | `				 }` |
|        - |  909 | `/*` |
|        - |  910 | ` * DUP: * * *` |
...
|        - |  929 | ` */` |
|    48839 |  930 | `case PH7_OP_NSSWITCH:` |
|    97683 |  931 | `	SyBlobReset(&pVm->sNamespace);` |
|    97683 |  932 | `	if( pInstr->p3 ){` |
|     3991 |  933 | `		const char *zNs = (const char *)pInstr->p3;` |
|     3991 |  934 | `		SyBlobAppend(&pVm->sNamespace,zNs,SyStrlen(zNs));` |
|     1993 |  935 | `	}` |
|        - |  936 | `	/* Clear namespace-scoped use-const imports */` |
|    97683 |  937 | `	SyHashRelease(&pVm->hUseConstImports);` |
|    97683 |  938 | `	SyHashInit(&pVm->hUseConstImports,&pVm->sAllocator,0,0);` |
|    97683 |  939 | `	break;` |
...
|        - | 1076 | ` */` |
|     3377 | 1077 | `case PH7_OP_UNSET_VAR: {` |
|        - | 1078 | `	VmOpRc rcOp;` |
|     6759 | 1079 | `	sState.pTos = pTos;` |
|     6759 | 1080 | `	sState.pc = pc;` |
|     6759 | 1081 | `	rcOp = VmExecOpUnsetVar(&(*pVm),&sState,pInstr);` |
|     6759 | 1082 | `	pTos = sState.pTos;` |
|     6759 | 1083 | `	pc = sState.pc;` |
|     6759 | 1084 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 1085 | `		goto Abort;` |
|     6757 | 1086 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
|      ! 0 | 1087 | `		goto Exception;` |
|        - | 1088 | `	}` |
|     6757 | 1089 | `	break;` |
|        - | 1090 | `					  }` |
|    33263 | 1091 | `case PH7_OP_ERR_CTRL:` |
|        - | 1092 | `	/*` |
...
|        - | 1101 | `	 */` |
|    66531 | 1102 | `	if( pInstr->iP1 ){` |
|    33269 | 1103 | `		pVm->nErrSuppress++;` |
|    49899 | 1104 | `	}else if( pVm->nErrSuppress > 0 ){` |
|    33267 | 1105 | `		pVm->nErrSuppress--;` |
|    16631 | 1106 | `	}` |
|    66531 | 1107 | `	break;` |
|        - | 1108 | `/*` |
|        - | 1109 | ` * IS_A * * *` |
...
|        - | 1115 | ` */` |
|      388 | 1116 | `case PH7_OP_IS_A:{` |
|      781 | 1117 | `	ph7_value *pNos = &pTos[-1];` |
|      781 | 1118 | `	sxi32 iRes = 0; /* assume false by default */` |
|        - | 1119 | `#ifdef UNTRUST` |
|        - | 1120 | `	if( pNos < pStack ){` |
|        - | 1121 | `		goto Abort;` |
|        - | 1122 | `	}` |
|        - | 1123 | `#endif` |
|      781 | 1124 | `	if( pNos->iFlags& MEMOBJ_OBJ ){` |
|      623 | 1125 | `		ph7_class_instance *pThis = (ph7_class_instance *)pNos->x.pOther;` |
|      623 | 1126 | `		ph7_class *pClass = 0;` |
|        - | 1127 | `		/* Extract the target class */` |
|      623 | 1128 | `		if( pTos->iFlags & MEMOBJ_OBJ ){` |
|        - | 1129 | `			/* Instance already loaded */` |
|      ! 0 | 1130 | `			pClass = ((ph7_class_instance *)pTos->x.pOther)->pClass;` |
|      623 | 1131 | `		}else if( pTos->iFlags & MEMOBJ_STRING && SyBlobLength(&pTos->sBlob) > 0 ){` |
|      623 | 1132 | `			const char *zCls = (const char *)SyBlobData(&pTos->sBlob);` |
|      623 | 1133 | `			sxu32 nCls = (sxu32)SyBlobLength(&pTos->sBlob);` |
|        - | 1134 | `			/* Handle self/static/parent keywords */` |
|      623 | 1135 | `			if( nCls == 4 && SyMemcmp(zCls,"self",4) == 0 ){` |
|        6 | 1136 | `				pClass = PH7_VmPeekDeclaringClass(&(*pVm));` |
|      621 | 1137 | `			}else if( nCls == 6 && SyMemcmp(zCls,"static",6) == 0 ){` |
|        3 | 1138 | `				pClass = PH7_VmPeekTopClass(&(*pVm));` |
|      618 | 1139 | `			}else if( nCls == 6 && SyMemcmp(zCls,"parent",6) == 0 ){` |
|        6 | 1140 | `				pClass = PH7_VmResolveParentClass(&(*pVm));` |
|        4 | 1141 | `			}else{` |
|      613 | 1142 | `				pClass = PH7_VmExtractClass(&(*pVm),zCls,nCls,FALSE,0);` |
|        - | 1143 | `			}` |
|      309 | 1144 | `		}` |
|      623 | 1145 | `		if( pClass ){` |
|        - | 1146 | `			/* Perform the query */` |
|      623 | 1147 | `			iRes = PH7_VmInstanceOf(pThis->pClass,pClass);` |
|      309 | 1148 | `		}` |
|      309 | 1149 | `	}` |
|        - | 1150 | `	/* Push result */` |
|      781 | 1151 | `	VmPopOperand(&pTos,1);` |
|      781 | 1152 | `	PH7_MemObjRelease(pTos);` |
|      781 | 1153 | `	pTos->x.iVal = iRes;` |
|      781 | 1154 | `	MemObjSetType(pTos,MEMOBJ_BOOL);` |
|      781 | 1155 | `	break;` |
|        - | 1156 | `				 }` |
|        - | 1157 |  |
|        - | 1158 | `/*` |
...
|        - | 1163 | ` */` |
|  1566677 | 1164 | `case PH7_OP_LOADC: {` |
|        - | 1165 | `	ph7_value *pObj;` |
|        - | 1166 | `	/* Reserve a room */` |
|  3135270 | 1167 | `	pTos++;` |
|  3135270 | 1168 | `	if( pInstr->iP1 & PH7_LOADC_NOKEY ){` |
|        - | 1169 | `		/* Absent array-literal key: mark it so LOAD_MAP auto-indexes without a diagnostic */` |
|    19519 | 1170 | `		MemObjSetType(pTos,MEMOBJ_NULL);` |
|    19519 | 1171 | `		SyBlobReset(&pTos->sBlob);` |
|    19519 | 1172 | `		pTos->iFlags \|= MEMOBJ_AUX_NOKEY;` |
|    19519 | 1173 | `		pTos->nIdx = SXU32_HIGH;` |
|    19519 | 1174 | `		break;` |
|        - | 1175 | `	}` |
|  3115756 | 1176 | `	if( (pObj = (ph7_value *)SySetAt(&pVm->aLitObj,pInstr->iP2)) != 0 ){` |
|  3115756 | 1177 | `		if( (pInstr->iP1 & PH7_LOADC_EXPAND) && SyBlobLength(&pObj->sBlob) <= 64 ){` |
|        - | 1178 | `			SyHashEntry *pEntry;` |
|        - | 1179 | `			/* Check use const imports first — imports take precedence */` |
|        - | 1180 | `			{` |
|        - | 1181 | `				SyHashEntry *pConstImport;` |
|    34961 | 1182 | `				pConstImport = SyHashGet(&pVm->hUseConstImports,` |
|    23304 | 1183 | `					SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|    23309 | 1184 | `				if( pConstImport ){` |
...
|    23299 | 1199 | `			pEntry = SyHashGet(&pVm->hConstant,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|    23299 | 1200 | `			if( pEntry ){` |
|    23289 | 1201 | `				ph7_constant *pCons = (ph7_constant *)pEntry->pUserData;` |
|        - | 1202 | `				/* Set a NULL default value */` |
|    23289 | 1203 | `				MemObjSetType(pTos,MEMOBJ_NULL);` |
|    23289 | 1204 | `				SyBlobReset(&pTos->sBlob);` |
|        - | 1205 | `				/* Invoke the callback and deal with the expanded value */` |
|    23289 | 1206 | `				VmExpandConstantWithNotice(&(*pVm),pCons,pTos);` |
|        - | 1207 | `				/* Mark as constant */` |
|    23289 | 1208 | `				pTos->nIdx = SXU32_HIGH;` |
|    23289 | 1209 | `				break;` |
|        - | 1210 | `			}` |
...
|        - | 1283 | ` */` |
|  2249787 | 1284 | `case PH7_OP_LOAD:{` |
|        - | 1285 | `	ph7_value *pObj;` |
|        - | 1286 | `	SyString sName;` |
|  4503594 | 1287 | `	if( pInstr->p3 == 0 ){` |
...
|        9 | 1299 | `	}else{` |
|  4503578 | 1300 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1301 | `		/* Reserve a room for the target object */` |
|  4503578 | 1302 | `		pTos++;` |
|        - | 1303 | `	}` |
|  4503594 | 1304 | `	if( pInstr->iP2 == 2 ){` |
...
|   405186 | 1310 | `		if( VmExtractMemObj(&(*pVm),&sName,FALSE,FALSE) == 0 ){` |
|        7 | 1311 | `			VmErrorFormat(&(*pVm),PH7_CTX_WARNING,"Undefined variable $%z",&sName);` |
|        3 | 1312 | `		}` |
|   202696 | 1313 | `	}` |
|        - | 1314 | `	/* Extract the requested memory object */` |
|  4503594 | 1315 | `	pObj = VmExtractMemObj(&(*pVm),&sName,pInstr->p3 ? FALSE : TRUE,pInstr->iP1 != 1);` |
|  4503594 | 1316 | `	if( pObj == 0 ){` |
...
|  4503532 | 1341 | `	PH7_MemObjLoad(pObj,pTos);` |
|  4503532 | 1342 | `	pTos->nIdx = pObj->nIdx;` |
|  4503532 | 1343 | `	break;` |
|        - | 1344 | `				   }` |
|        - | 1345 | `/*` |
|        - | 1346 | ` * LOAD_MAP P1 * *` |
...
|        - | 1351 | ` */` |
|    36975 | 1352 | `case PH7_OP_LOAD_MAP: {` |
|        - | 1353 | `	VmOpRc rcOp;` |
|    73955 | 1354 | `	sState.pTos = pTos;` |
|    73955 | 1355 | `	sState.pc = pc;` |
|    73955 | 1356 | `	rcOp = VmExecOpLoadMap(&(*pVm),&sState,pInstr);` |
|    73955 | 1357 | `	pTos = sState.pTos;` |
|    73955 | 1358 | `	pc = sState.pc;` |
|    73955 | 1359 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1360 | `		goto Abort;` |
|    73955 | 1361 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1394 | ` * instead.` |
|        - | 1395 | ` */` |
|   339334 | 1396 | `case PH7_OP_LOAD_IDX: {` |
|        - | 1397 | `	VmOpRc rcOp;` |
|   679419 | 1398 | `	sState.pTos = pTos;` |
|   679419 | 1399 | `	sState.pc = pc;` |
|   679419 | 1400 | `	rcOp = VmExecOpLoadIdx(&(*pVm),&sState,pInstr);` |
|   679419 | 1401 | `	pTos = sState.pTos;` |
|   679419 | 1402 | `	pc = sState.pc;` |
|   679419 | 1403 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1404 | `		goto Abort;` |
|   679419 | 1405 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1415 | ` */` |
|      590 | 1416 | `case PH7_OP_LOAD_CLOSURE: {` |
|        - | 1417 | `	VmOpRc rcOp;` |
|     1185 | 1418 | `	sState.pTos = pTos;` |
|     1185 | 1419 | `	sState.pc = pc;` |
|     1185 | 1420 | `	rcOp = VmExecOpLoadClosure(&(*pVm),&sState,pInstr);` |
|     1185 | 1421 | `	pTos = sState.pTos;` |
|     1185 | 1422 | `	pc = sState.pc;` |
|     1185 | 1423 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1424 | `		goto Abort;` |
|     1185 | 1425 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1507 | `	}` |
|        - | 1508 | `#endif` |
|   638167 | 1509 | `	if( pInstr->iP2 ){` |
|        - | 1510 | `		sxu32 nIdx;` |
|        - | 1511 | `		sxi32 rcT;` |
|        - | 1512 | `		/* Member store operation */` |
|    11917 | 1513 | `		nIdx = pTos->nIdx;` |
|    11917 | 1514 | `		VmPopOperand(&pTos,1);` |
|    11917 | 1515 | `		if( pVm->pMagicSetThis ){` |
...
|       11 | 1528 | `			break;` |
|        - | 1529 | `		}` |
|    11907 | 1530 | `		if( pVm->pHookSetThis ){` |
...
|    11875 | 1558 | `			rcT = VmEnforcePropertyTypeOnStore(&(*pVm),nIdx,pTos,0);` |
|    11875 | 1559 | `			if( rcT == PH7_ABORT ){` |
|       13 | 1560 | `				goto Abort;` |
|        - | 1561 | `			}` |
|    11865 | 1562 | `			if( rcT == PH7_EXCEPTION ){` |
...
|    11797 | 1577 | `			pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|    11797 | 1578 | `			if( pObj ){` |
|        - | 1579 | `				/* Perform the store operation */` |
|    11797 | 1580 | `				PH7_MemObjStore(pTos,pObj);` |
|     5896 | 1581 | `			}` |
|        - | 1582 | `		}` |
|    11799 | 1583 | `		break;` |
|   626255 | 1584 | `	}else if( pInstr->p3 == 0 ){` |
...
|        - | 1596 | `#endif` |
|        5 | 1597 | `	}else{` |
|   626247 | 1598 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1599 | `	}` |
|   626250 | 1600 | `	if( sName.nByte == sizeof("GLOBALS")-1` |
|   314882 | 1601 | `	 && SyMemcmp((const void *)sName.zString,(const void *)"GLOBALS",sName.nByte) == 0 ){` |
|        6 | 1602 | `		if( pInstr->p3 ){` |
...
|        - | 1639 | ` */` |
|   121461 | 1640 | `case PH7_OP_STORE_IDX:` |
|        - | 1641 | `case PH7_OP_STORE_IDX_REF: {` |
|        - | 1642 | `	VmOpRc rcOp;` |
|   242927 | 1643 | `	sState.pTos = pTos;` |
|   242927 | 1644 | `	sState.pc = pc;` |
|   242927 | 1645 | `	rcOp = VmExecOpStoreIdxRef(&(*pVm),&sState,pInstr);` |
|   242927 | 1646 | `	pTos = sState.pTos;` |
|   242927 | 1647 | `	pc = sState.pc;` |
|   242927 | 1648 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 1649 | `		goto Abort;` |
|   242925 | 1650 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|   375294 | 1671 | `	PH7_ENFORCE_READONLY_MUTATE(pTos->nIdx);` |
...
|   375283 | 1676 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) != 0` |
|   187753 | 1677 | `	 && SySetUsed(&pVm->aHookRmw) > 0 ){` |
...
|        - | 1694 | `		}` |
|      ! 0 | 1695 | `	}` |
|   375286 | 1696 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) == 0 ){` |
|   375286 | 1697 | `		if( pTos->nIdx != SXU32_HIGH ){` |
|        - | 1698 | `			ph7_value *pObj;` |
|   375286 | 1699 | `			if( (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pTos->nIdx)) != 0 ){` |
|   375286 | 1700 | `				if( VmStringWantsPerlIncr(pObj) ){` |
...
|   375284 | 1719 | `					if( pInstr->iP1 == 0 && (pTos->iFlags & MEMOBJ_STRING) ){` |
|        9 | 1720 | `						SyBlobNullAppend(&pTos->sBlob);` |
|        3 | 1721 | `					}` |
|        - | 1722 | `					/* Force a numeric cast on the variable */` |
|   375284 | 1723 | `					PH7_MemObjToNumeric(pObj);` |
|   375284 | 1724 | `					if( pObj->iFlags & MEMOBJ_REAL ){` |
|        5 | 1725 | `						pObj->rVal++;` |
...
|        - | 1734 | `						sxi64 r;` |
|   375280 | 1735 | `						if( PH7_ADD_OVERFLOW64(pObj->x.iVal,1,&r) ){` |
...
|        - | 1741 | `#endif` |
|        3 | 1742 | `						}else{` |
|   375276 | 1743 | `							pObj->x.iVal = r;` |
|        - | 1744 | `						}` |
|        - | 1745 | `					}` |
|   375284 | 1746 | `					if( pInstr->iP1 ){` |
...
|        - | 1785 | `		}` |
|   187745 | 1786 | `	}` |
|   375284 | 1787 | `	PH7_HOOK_RMW_WRITEBACK(pTos->nIdx,pTos);` |
|   375284 | 1788 | `	break;` |
|        - | 1789 | `/*` |
|        - | 1790 | ` * DECR: P1 * *` |
|        - | 1791 | ` *` |
...
|    70515 | 1938 | `	PH7_MemObjToNumeric(pTos);` |
|    70515 | 1939 | `	if( pTos->iFlags & MEMOBJ_REAL ){` |
|      112 | 1940 | `		pTos->rVal = -pTos->rVal;` |
|       55 | 1941 | `	}` |
|    70515 | 1942 | `	if( pTos->iFlags & MEMOBJ_INT ){` |
|    70429 | 1943 | `		if( pTos->x.iVal == SMALLEST_INT64 ){` |
...
|        - | 1958 | `#endif` |
|        3 | 1959 | `		}else{` |
|    70425 | 1960 | `			pTos->x.iVal = -pTos->x.iVal;` |
|        - | 1961 | `		}` |
|    35212 | 1962 | `	}` |
|    70515 | 1963 | `	break;` |
|        - | 1964 | `/*` |
...
|    50619 | 1997 | `	if( (pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      159 | 1998 | `		PH7_MemObjToBool(pTos);` |
|       77 | 1999 | `	}` |
|    50619 | 2000 | `	pTos->x.iVal = !pTos->x.iVal;` |
|    50619 | 2001 | `	break;` |
|        - | 2002 | `/*` |
|        - | 2003 | ` * OP_BITNOT: * * *` |
|        - | 2004 | ` *` |
...
|        - | 2070 | ` */` |
|     6340 | 2071 | `case PH7_OP_ADD:{` |
|    12685 | 2072 | `	ph7_value *pNos = &pTos[-1];` |
|        - | 2073 | `#ifdef UNTRUST` |
|        - | 2074 | `	if( pNos < pStack ){` |
|        - | 2075 | `		goto Abort;` |
|        - | 2076 | `	}` |
...
|        - | 2082 | `		SyBlob sArMsg;` |
|    12685 | 2083 | `		SyBlobInit(&sArMsg,&pVm->sAllocator);` |
|    12685 | 2084 | `		if( VmArithOperandCheck(&(*pVm),pNos,pTos,"+",&sArMsg) != SXRET_OK ){` |
|        - | 2085 | `			sxi32 rcAr;` |
...
|        - | 2096 | `		}` |
|    12677 | 2097 | `		SyBlobRelease(&sArMsg);` |
|        - | 2098 | `	}` |
|        - | 2099 | `	/* Perform the addition */` |
|    12677 | 2100 | `	PH7_MemObjAdd(pNos,pTos,FALSE);` |
|    12677 | 2101 | `	VmPopOperand(&pTos,1);` |
|    12677 | 2102 | `	break;` |
|        - | 2103 | `				}` |
|        - | 2104 | `/*` |
|        - | 2105 | ` * OP_ADD_STORE * * *` |
...
|        - | 2171 | `	VmOpRc rcOp;` |
|    24724 | 2172 | `	sState.pTos = pTos;` |
|    24724 | 2173 | `	sState.pc = pc;` |
|    24724 | 2174 | `	rcOp = VmExecOpSub(&(*pVm),&sState,pInstr);` |
|    24724 | 2175 | `	pTos = sState.pTos;` |
|    24724 | 2176 | `	pc = sState.pc;` |
|    24724 | 2177 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2178 | `		goto Abort;` |
|    24724 | 2179 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2260 | `	VmOpRc rcOp;` |
|       99 | 2261 | `	sState.pTos = pTos;` |
|       99 | 2262 | `	sState.pc = pc;` |
|       99 | 2263 | `	rcOp = VmExecOpDiv(&(*pVm),&sState,pInstr);` |
|       99 | 2264 | `	pTos = sState.pTos;` |
|       99 | 2265 | `	pc = sState.pc;` |
|       99 | 2266 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2267 | `		goto Abort;` |
|       99 | 2268 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2526 | ` * back.` |
|        - | 2527 | ` */` |
|    86566 | 2528 | `case PH7_OP_CAT:{` |
|        - | 2529 | `	ph7_value *pNos,*pCur;` |
|   173137 | 2530 | `	if( pInstr->iP1 < 1 ){` |
|   144465 | 2531 | `		pNos = &pTos[-1];` |
|    72235 | 2532 | `	}else{` |
|    28677 | 2533 | `		pNos = &pTos[-pInstr->iP1+1];` |
|        - | 2534 | `	}` |
|        - | 2535 | `#ifdef UNTRUST` |
|        - | 2536 | `	if( pNos < pStack ){` |
|        - | 2537 | `		goto Abort;` |
...
|   173137 | 2541 | `	if( (pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|     1909 | 2542 | `		PH7_MemObjToString(pNos);` |
|      952 | 2543 | `	}` |
|   173137 | 2544 | `	pCur = &pNos[1];` |
|   349857 | 2545 | `	while( pCur <= pTos ){` |
|   176725 | 2546 | `		if( (pCur->iFlags & MEMOBJ_STRING) == 0 ){` |
|    52445 | 2547 | `			PH7_MemObjToString(pCur);` |
|    26220 | 2548 | `		}` |
|        - | 2549 | `		/* Perform the concatenation */` |
|   176725 | 2550 | `		if( SyBlobLength(&pCur->sBlob) > 0 ){` |
...
|        - | 2555 | `			}` |
|    88284 | 2556 | `		}` |
|   176725 | 2557 | `		SyBlobRelease(&pCur->sBlob);` |
|   176725 | 2558 | `		pCur++;` |
|        5 | 2559 | `	}` |
|   173137 | 2560 | `	pTos = pNos;` |
|   173137 | 2561 | `	break;` |
|        - | 2562 | `				}` |
|        - | 2563 | `/*  CAT_STORE: * * *` |
|        - | 2564 | ` *` |
...
|        - | 2566 | ` * back.` |
|        - | 2567 | ` */` |
|    13797 | 2568 | `case PH7_OP_CAT_STORE:{` |
|    27599 | 2569 | `	ph7_value *pNos = &pTos[-1];` |
|        - | 2570 | `	ph7_value *pObj;` |
|        - | 2571 | `	sxu32 nIdx;` |
|        - | 2572 | `#ifdef UNTRUST` |
|        - | 2573 | `	if( pNos < pStack ){` |
...
|    27599 | 2578 | `	if((pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|       59 | 2579 | `		PH7_MemObjToString(pNos);` |
|       29 | 2580 | `	}` |
|    27599 | 2581 | `	nIdx = pTos->nIdx;` |
...
|    27594 | 2593 | `	if( nIdx != SXU32_HIGH` |
|    27594 | 2594 | `	 && nIdx != pNos->nIdx` |
|    27590 | 2595 | `	 && (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx)) != 0` |
|    27591 | 2596 | `	 && (SyHashTotalEntry(&pVm->hTypedSlot) == 0` |
|    16393 | 2597 | `	     \|\| SyHashGet(&pVm->hTypedSlot,(const void *)&nIdx,sizeof(sxu32)) == 0) ){` |
|    27585 | 2598 | `		if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - | 2599 | `			/* e.g. $x = 5; $x .= "a";  ->  "5a" */` |
|        6 | 2600 | `			PH7_MemObjToString(pObj);` |
|        2 | 2601 | `		}` |
|    27585 | 2602 | `		if( SyBlobLength(&pNos->sBlob) > 0 ){` |
|    27581 | 2603 | `			if( PH7_MemObjStringAppend(pObj,(const char *)SyBlobData(&pNos->sBlob),SyBlobLength(&pNos->sBlob)) != SXRET_OK ){` |
...
|    27585 | 2622 | `		if( (pInstr+1)->iOp != PH7_OP_POP ){` |
...
|    27585 | 2627 | `		PH7_HOOK_RMW_WRITEBACK(nIdx,0);` |
|    27585 | 2628 | `		pNos->nIdx = SXU32_HIGH;` |
|    27585 | 2629 | `		VmPopOperand(&pTos,1);` |
|    27592 | 2630 | `		break;` |
|        - | 2631 | `	}` |
...
|        - | 2668 | ` * stack.` |
|        - | 2669 | ` */` |
|   116339 | 2670 | `case PH7_OP_LAND:` |
|        - | 2671 | `case PH7_OP_LOR: {` |
|        - | 2672 | `	VmOpRc rcOp;` |
|   232894 | 2673 | `	sState.pTos = pTos;` |
|   232894 | 2674 | `	sState.pc = pc;` |
|   232894 | 2675 | `	rcOp = VmExecOpLor(&(*pVm),&sState,pInstr);` |
|   232894 | 2676 | `	pTos = sState.pTos;` |
|   232894 | 2677 | `	pc = sState.pc;` |
|   232894 | 2678 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2679 | `		goto Abort;` |
|   232894 | 2680 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2895 | ` */` |
|     5457 | 2896 | `case PH7_OP_EQ:` |
|        - | 2897 | `case PH7_OP_NEQ: {` |
|        - | 2898 | `	VmOpRc rcOp;` |
|    10919 | 2899 | `	sState.pTos = pTos;` |
|    10919 | 2900 | `	sState.pc = pc;` |
|    10919 | 2901 | `	rcOp = VmExecOpNeq(&(*pVm),&sState,pInstr);` |
|    10919 | 2902 | `	pTos = sState.pTos;` |
|    10919 | 2903 | `	pc = sState.pc;` |
|    10919 | 2904 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2905 | `		goto Abort;` |
|    10919 | 2906 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2917 | ` */` |
|   231523 | 2918 | `case PH7_OP_TEQ: {` |
|        - | 2919 | `	VmOpRc rcOp;` |
|   463261 | 2920 | `	sState.pTos = pTos;` |
|   463261 | 2921 | `	sState.pc = pc;` |
|   463261 | 2922 | `	rcOp = VmExecOpTeq(&(*pVm),&sState,pInstr);` |
|   463261 | 2923 | `	pTos = sState.pTos;` |
|   463261 | 2924 | `	pc = sState.pc;` |
|   463261 | 2925 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2926 | `		goto Abort;` |
|   463261 | 2927 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2939 | ` *` |
|        - | 2940 | ` */` |
|   193200 | 2941 | `case PH7_OP_TNE: {` |
|        - | 2942 | `	VmOpRc rcOp;` |
|   386615 | 2943 | `	sState.pTos = pTos;` |
|   386615 | 2944 | `	sState.pc = pc;` |
|   386615 | 2945 | `	rcOp = VmExecOpTne(&(*pVm),&sState,pInstr);` |
|   386615 | 2946 | `	pTos = sState.pTos;` |
|   386615 | 2947 | `	pc = sState.pc;` |
|   386615 | 2948 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2949 | `		goto Abort;` |
|   386615 | 2950 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2971 | ` *` |
|        - | 2972 | ` */` |
|   148915 | 2973 | `case PH7_OP_LT:` |
|        - | 2974 | `case PH7_OP_LE: {` |
|        - | 2975 | `	VmOpRc rcOp;` |
|   298256 | 2976 | `	sState.pTos = pTos;` |
|   298256 | 2977 | `	sState.pc = pc;` |
|   298256 | 2978 | `	rcOp = VmExecOpLe(&(*pVm),&sState,pInstr);` |
|   298256 | 2979 | `	pTos = sState.pTos;` |
|   298256 | 2980 | `	pc = sState.pc;` |
|   298256 | 2981 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2982 | `		goto Abort;` |
|   298256 | 2983 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3007 | `case PH7_OP_GE: {` |
|        - | 3008 | `	VmOpRc rcOp;` |
|   176695 | 3009 | `	sState.pTos = pTos;` |
|   176695 | 3010 | `	sState.pc = pc;` |
|   176695 | 3011 | `	rcOp = VmExecOpGe(&(*pVm),&sState,pInstr);` |
|   176695 | 3012 | `	pTos = sState.pTos;` |
|   176695 | 3013 | `	pc = sState.pc;` |
|   176695 | 3014 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 3015 | `		goto Abort;` |
|   176695 | 3016 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3113 | ` */` |
|     1395 | 3114 | `case PH7_OP_LOAD_EXCEPTION: {` |
|        - | 3115 | `	VmOpRc rcOp;` |
|     2795 | 3116 | `	sState.pTos = pTos;` |
|     2795 | 3117 | `	sState.pc = pc;` |
|     2795 | 3118 | `	rcOp = VmExecOpLoadException(&(*pVm),&sState,pInstr);` |
|     2795 | 3119 | `	pTos = sState.pTos;` |
|     2795 | 3120 | `	pc = sState.pc;` |
|     2795 | 3121 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 3122 | `		goto Abort;` |
|     2795 | 3123 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3131 | ` */` |
|     1228 | 3132 | `case PH7_OP_POP_EXCEPTION: {` |
|     2461 | 3133 | `	ph7_exception *pCompiledExc = (ph7_exception *)pInstr->p3;` |
...
|     2461 | 3138 | `	ph7_exception *pException = 0;` |
|     2461 | 3139 | `	if( SySetUsed(&pVm->aException) > 0 ){` |
...
|      194 | 3153 | `		}` |
|      201 | 3154 | `	}` |
|     2461 | 3155 | `	if( pCompiledExc->iInlined ){` |
...
|     2307 | 3182 | `	if( pVm->pFrame->iFlags & VM_FRAME_EXCEPTION ){` |
...
|     2307 | 3188 | `	if( pException && pCompiledExc->iHasFinally && !pException->iFinallyDone ){` |
...
|        - | 3206 | `		}` |
|       12 | 3207 | `	}` |
|     2303 | 3208 | `	VmExcRelease(&(*pVm),pException); /* no-finally / already-done paths (may be NULL) */` |
|     2303 | 3209 | `	if( VmSkipExceptionFrames(pVm->pFrame)->bHasRet ){` |
...
|        - | 3390 | ` */` |
|    12055 | 3391 | `case PH7_OP_FOREACH_INIT: {` |
|        - | 3392 | `	VmOpRc rcOp;` |
|    24115 | 3393 | `	sState.pTos = pTos;` |
|    24115 | 3394 | `	sState.pc = pc;` |
|    24115 | 3395 | `	rcOp = VmExecOpForeachInit(&(*pVm),&sState,pInstr);` |
|    24115 | 3396 | `	pTos = sState.pTos;` |
|    24115 | 3397 | `	pc = sState.pc;` |
|    24115 | 3398 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 3399 | `		goto Abort;` |
|    24115 | 3400 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3408 | ` */` |
|   121705 | 3409 | `case PH7_OP_FOREACH_STEP: {` |
|        - | 3410 | `	VmOpRc rcOp;` |
|   243415 | 3411 | `	sState.pTos = pTos;` |
|   243415 | 3412 | `	sState.pc = pc;` |
|   243415 | 3413 | `	rcOp = VmExecOpForeachStep(&(*pVm),&sState,pInstr);` |
|   243415 | 3414 | `	pTos = sState.pTos;` |
|   243415 | 3415 | `	pc = sState.pc;` |
|   243415 | 3416 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 3417 | `		goto Abort;` |
|   243413 | 3418 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3426 | ` */` |
|    22565 | 3427 | `case PH7_OP_MEMBER: {` |
|        - | 3428 | `	VmOpRc rcOp;` |
|    45135 | 3429 | `	sState.pTos = pTos;` |
|    45135 | 3430 | `	sState.pc = pc;` |
|    45135 | 3431 | `	rcOp = VmExecOpMember(&(*pVm),&sState,pInstr);` |
|    45135 | 3432 | `	pTos = sState.pTos;` |
|    45135 | 3433 | `	pc = sState.pc;` |
|    45135 | 3434 | `	if( rcOp == VM_OP_ABORT ){` |
|        7 | 3435 | `		goto Abort;` |
|    45129 | 3436 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3444 | ` */` |
|     2407 | 3445 | `case PH7_OP_NEW: {` |
|        - | 3446 | `	VmOpRc rcOp;` |
|     4819 | 3447 | `	sState.pTos = pTos;` |
|     4819 | 3448 | `	sState.pc = pc;` |
|     4819 | 3449 | `	rcOp = VmExecOpNew(&(*pVm),&sState,pInstr);` |
|     4819 | 3450 | `	pTos = sState.pTos;` |
|     4819 | 3451 | `	pc = sState.pc;` |
|     4819 | 3452 | `	if( rcOp == VM_OP_ABORT ){` |
|        5 | 3453 | `		goto Abort;` |
|     4815 | 3454 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|  1048365 | 3831 | `	sxi32 nCallArgs = pInstr->iP1 + (pInstr->iP2 ? VmSpreadOwnExtra(pVm,pInstr->iP1,pTos) : 0);` |
|        - | 3832 | `	ph7_value *pArg;` |
|  1048365 | 3833 | `	pArg = &pTos[-nCallArgs];` |
...
|  1048365 | 3842 | `	VmCallArgMap *pEffCallMap = (VmCallArgMap *)pInstr->p3;` |
...
|  1048365 | 3849 | `	if( VmValueIsClosure(pVm,pTos) ){` |
...
|  1048365 | 3859 | `	if( (pTos->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|      142 | 4054 | `		break;` |
|        - | 4055 | `	}` |
|  1048205 | 4056 | `	SyStringInitFromBuf(&sName,SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
...
|  1048205 | 4060 | `	if( sName.nByte > 0 && sName.zString[0] == '\\' ){` |
...
|  1048205 | 4067 | `	pEntry = SyHashGet(&pVm->hFunction,(const void *)sName.zString,sName.nByte);` |
...
|        - | 4073 | `	{` |
|  1048205 | 4074 | `	VmCallArgMap *pCallMap = pEffCallMap;` |
|  1048205 | 4075 | `	if( pEntry == 0 && pCallMap && pCallMap->bIsNamespaced ){` |
...
|        - | 4106 | `		VmSlot sArg;` |
|        - | 4107 | `		sxu32 n;` |
|   106711 | 4108 | `		int bClosureThis = 0;` |
|   106711 | 4109 | `		ph7_class *pClosureScope = 0;` |
|        - | 4110 | `		/* initialize fields */` |
|   106711 | 4111 | `		pVmFunc = (ph7_vm_func *)pEntry->pUserData;` |
|   106711 | 4112 | `		pThis = 0;` |
|   106711 | 4113 | `		pSelf = 0;` |
...
|       14 | 4128 | `		}` |
|   106711 | 4129 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
|        - | 4130 | `			ph7_class_method *pMeth;` |
|        - | 4131 | `			/* Class method call */` |
|    25703 | 4132 | `			ph7_value *pTarget = &pTos[-1];` |
|    25703 | 4133 | `			if( pTarget >= pStack && (pTarget->iFlags & (MEMOBJ_STRING\|MEMOBJ_OBJ\|MEMOBJ_NULL)) ){` |
|        - | 4134 | `				/* Extract the 'this' pointer */` |
|    25703 | 4135 | `				if(pTarget->iFlags & MEMOBJ_OBJ ){` |
|        - | 4136 | `					/* Instance already loaded */` |
|    24665 | 4137 | `					pThis = (ph7_class_instance *)pTarget->x.pOther;` |
|    24665 | 4138 | `					pThis->iRef++;` |
|    24665 | 4139 | `					pSelf = pThis->pClass;` |
|    12330 | 4140 | `				}` |
|    25703 | 4141 | `				if( pSelf == 0 ){` |
...
|      353 | 4160 | `					}` |
|      519 | 4161 | `				}` |
|    25703 | 4162 | `				VmPopOperand(&pTos,1);` |
|    25703 | 4163 | `				PH7_MemObjRelease(pTos);` |
...
|    25703 | 4170 | `				nCallArgs = pInstr->iP1 + (pInstr->iP2 ? VmSpreadOwnExtra(&(*pVm),pInstr->iP1,pTos) : 0);` |
|    25703 | 4171 | `				pArg = &pTos[-nCallArgs];` |
...
|        - | 4176 | `				 */` |
|    25703 | 4177 | `				while( pArg < pStack ){` |
|      ! 0 | 4178 | `					pArg++;` |
|      ! 0 | 4179 | `				}` |
|    25703 | 4180 | `				if( pSelf && pVm->bReflectBypass ){` |
...
|        6 | 4185 | `				}else` |
|    25693 | 4186 | `				if( pSelf ){ /* Paranoid edition */` |
...
|    25693 | 4194 | `					ph7_class *pDeclClass = pVmFunc->pUserData ? (ph7_class *)pVmFunc->pUserData : pSelf;` |
|    25693 | 4195 | `					pMeth = PH7_ClassExtractMethod(pDeclClass,pVmFunc->sName.zString,pVmFunc->sName.nByte);` |
|    25693 | 4196 | `					if( pMeth == 0 && pDeclClass != pSelf ){` |
|      ! 0 | 4197 | `						pMeth = PH7_ClassExtractMethod(pSelf,pVmFunc->sName.zString,pVmFunc->sName.nByte);` |
|      ! 0 | 4198 | `					}` |
|    25693 | 4199 | `					if( pMeth && pMeth->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|   160169 | 4236 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   106706 | 4237 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
...
|   106711 | 4244 | `		if( VmRecursionExceeded(pVm) ){` |
...
|        3 | 4248 | `			goto Abort;` |
|        - | 4249 | `		}` |
|   106709 | 4250 | `		if( pVmFunc->pNextName ){` |
...
|   106709 | 4262 | `		pSelfHint = pSelf;` |
|   106709 | 4263 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
|    25703 | 4264 | `			ph7_class *pDecl = (ph7_class *)pVmFunc->pUserData;` |
|    25703 | 4265 | `			if( pDecl && (pDecl->iFlags & PH7_CLASS_TRAIT) == 0 ){` |
|    24677 | 4266 | `				pSelfHint = pDecl;` |
|    12336 | 4267 | `			}` |
|    12849 | 4268 | `		}` |
|   106709 | 4269 | `		if( pSelf == 0 && (pVmFunc->iFlags & VM_FUNC_CLOSURE) ){` |
...
|     1815 | 4276 | `			if( pClosureScope ){` |
|       29 | 4277 | `				pSelf = pClosureScope;` |
|     1801 | 4278 | `			}else if( pVmFunc->pLsbClass ){` |
|       64 | 4279 | `				pSelf = (ph7_class *)pVmFunc->pLsbClass;` |
|       30 | 4280 | `			}` |
|      905 | 4281 | `		}` |
|   106709 | 4282 | `		if( SySetUsed(&pVmFunc->aAttrs) > 0 ){` |
...
|       56 | 4287 | `		}` |
|   106709 | 4288 | `		if( pVmFunc->iFlags & VM_FUNC_GENERATOR ){` |
...
|   106369 | 4520 | `		aFormalArg = (ph7_vm_func_arg *)SySetBasePtr(&pVmFunc->aArgs);` |
|        - | 4521 | `		/* Create a new VM frame  */` |
|   106369 | 4522 | `		rc = VmEnterFrame(&(*pVm),pVmFunc,pThis,&pFrame);` |
|   106369 | 4523 | `		if( rc != SXRET_OK ){` |
...
|   106369 | 4551 | `		pFrame->nActualArgs = (int)(pTos - pArg);` |
|   106369 | 4552 | `		if( pThis && ((pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) \|\| bClosureThis) ){` |
...
|    24849 | 4555 | `			pObj = VmExtractMemObj(&(*pVm),&sThis,FALSE,TRUE);` |
|    24849 | 4556 | `			if( pObj ){` |
|        - | 4557 | `				/* Reflect the change */` |
|    24849 | 4558 | `				pObj->x.pOther = pThis;` |
|    24849 | 4559 | `				MemObjSetType(pObj,MEMOBJ_OBJ);` |
|    12422 | 4560 | `			}` |
|    12422 | 4561 | `		}` |
|   106369 | 4562 | `		if( SySetUsed(&pVmFunc->aStatic) > 0 ){` |
...
|        - | 4589 | `		{` |
|   106369 | 4590 | `		VmCallArgMap *pCallMap3 = pEffCallMap;` |
|        - | 4591 | `		/* Caller file's strict_types mode — governs parameter coercion` |
|        - | 4592 | `		 * (but NOT return coercion, which uses the callee's file). */` |
|   106369 | 4593 | `		int bCallIsStrict = (pCallMap3 && pCallMap3->bStrict) ? 1 : 0;` |
|   106369 | 4594 | `		if( pCallMap3 && pCallMap3->bHasNamed ){` |
|        - | 4595 | `			/* ============================================================` |
...
|        - | 4980 | `		 * ============================================================ */` |
|   106101 | 4981 | `		n = 0;` |
|   273301 | 4982 | `		while( pArg < pTos ){` |
|   167505 | 4983 | `			if( n < SySetUsed(&pVmFunc->aArgs) && (aFormalArg[n].iFlags & VM_FUNC_ARG_VARIADIC) ){` |
...
|        - | 5083 | `			}` |
|   167305 | 5084 | `			if( n < SySetUsed(&pVmFunc->aArgs) ){` |
...
|   166783 | 5091 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_UNION ){` |
...
|   166696 | 5124 | `				if( aFormalArg[n].nType > 0` |
|    90594 | 5125 | `					&& !((aFormalArg[n].iFlags & VM_FUNC_ARG_NULLABLE) && (pArg->iFlags & MEMOBJ_NULL)) ){` |
...
|       13 | 5201 | `					}` |
|     6976 | 5202 | `				}` |
|   166685 | 5203 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_BY_REF ){` |
|        - | 5204 | `					/* Pass by reference */` |
|      242 | 5205 | `					if( pArg->nIdx == pVm->nGlobalIdx && pArg->nIdx != SXU32_HIGH ){` |
...
|        - | 5221 | `					}` |
|      240 | 5222 | `					if( pArg->nIdx == SXU32_HIGH ){` |
...
|      238 | 5243 | `						pRefEntry = SyHashGet(&pFrame->hVar,SyStringData(&aFormalArg[n].sName),SyStringLength(&aFormalArg[n].sName));` |
|      238 | 5244 | `						if( pRefEntry == 0 ){` |
|      356 | 5245 | `							SyHashInsert(&pFrame->hVar,SyStringData(&aFormalArg[n].sName),` |
|      236 | 5246 | `								SyStringLength(&aFormalArg[n].sName),SX_INT_TO_PTR(pArg->nIdx));` |
|      238 | 5247 | `							sArg.nIdx = pArg->nIdx;` |
|      238 | 5248 | `							sArg.pUserData = 0;` |
|      238 | 5249 | `							SySetPut(&pFrame->sArg,(const void *)&sArg);` |
|      118 | 5250 | `						}` |
|      238 | 5251 | `						pObj = 0;` |
|        - | 5252 | `					}` |
|      121 | 5253 | `				}else{` |
|        - | 5254 | `					/* Pass by value,make a copy of the given argument */` |
|   166445 | 5255 | `					pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|        - | 5256 | `				}` |
|    83554 | 5257 | `			}else{` |
|        - | 5258 | `				char zName[32];` |
...
|        - | 5265 | `			}` |
|   167205 | 5266 | `			if( pObj ){` |
|   166969 | 5267 | `				PH7_MemObjStore(pArg,pObj);` |
|        - | 5268 | `				/* Insert argument index  */` |
|   166969 | 5269 | `				sArg.nIdx = pObj->nIdx;` |
|   166969 | 5270 | `				sArg.pUserData = 0;` |
|   166969 | 5271 | `				SySetPut(&pFrame->sArg,(const void *)&sArg);` |
|    83692 | 5272 | `			}` |
|   167205 | 5273 | `			PH7_MemObjRelease(pArg);` |
|   167205 | 5274 | `			pArg++;` |
|   167205 | 5275 | `			++n;` |
|        5 | 5276 | `		}` |
|        - | 5277 | `		} /* end named vs positional branch */` |
|        - | 5278 | `		/* Set up closure environment */` |
|   106247 | 5279 | `		if( pVmFunc->iFlags & VM_FUNC_CLOSURE ){` |
|        - | 5280 | `			ph7_vm_func_closure_env *aEnv,*pEnv;` |
|        - | 5281 | `			ph7_value *pValue;` |
|        - | 5282 | `			sxu32 iEnv;` |
|     1797 | 5283 | `			aEnv = (ph7_vm_func_closure_env *)SySetBasePtr(&pVmFunc->aClosureEnv);` |
|     3935 | 5284 | `			for(iEnv = 0 ; iEnv < SySetUsed(&pVmFunc->aClosureEnv) ; ++iEnv ){` |
|     2143 | 5285 | `				pEnv = &aEnv[iEnv];` |
|     2143 | 5286 | `				if( (pEnv->iFlags & VM_FUNC_ARG_IGNORE) && (pEnv->sValue.iFlags & MEMOBJ_NULL) ){` |
...
|        5 | 5295 | `					continue;` |
|        - | 5296 | `				}` |
|      408 | 5297 | `				if( (pEnv->iFlags & VM_FUNC_ARG_BY_REF) && pEnv->nIdx != SXU32_HIGH ){` |
...
|   106242 | 5327 | `		if( n < SySetUsed(&pVmFunc->aArgs)` |
|    56812 | 5328 | `		 && (pVmFunc->iFlags & (VM_FUNC_INTERNAL\|VM_FUNC_CLASS_METHOD)) != VM_FUNC_INTERNAL ){` |
|        - | 5329 | `			sxu32 nNonVar,nReq;` |
|     5917 | 5330 | `			nReq = VmFuncRequiredArgCount(pVmFunc,&nNonVar);` |
|     5917 | 5331 | `			if( n < nReq ){` |
...
|   118261 | 5351 | `		while( n < SySetUsed(&pVmFunc->aArgs) ){` |
|    12285 | 5352 | `			if( aFormalArg[n].iFlags & VM_FUNC_ARG_VARIADIC ){` |
...
|        - | 5363 | `			}` |
|    12041 | 5364 | `			if( SySetUsed(&aFormalArg[n].aByteCode) > 0 ){` |
|    12039 | 5365 | `				pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|    12039 | 5366 | `				if( pObj ){` |
|        - | 5367 | `					/* Evaluate the default value and extract it's result */` |
|    12039 | 5368 | `					rc = VmLocalExec(&(*pVm),&aFormalArg[n].aByteCode,pObj,FALSE);` |
|    12039 | 5369 | `					if( rc == PH7_ABORT ){` |
|      ! 0 | 5370 | `						goto Abort;` |
|        - | 5371 | `					}` |
|        - | 5372 | `					/* Insert argument index */` |
|    12039 | 5373 | `					sArg.nIdx = pObj->nIdx;` |
|    12039 | 5374 | `					sArg.pUserData = 0;` |
|    12039 | 5375 | `					SySetPut(&pFrame->sArg,(const void *)&sArg);` |
...
|    12034 | 5380 | `					if( aFormalArg[n].nType > 0 && aFormalArg[n].nType != MEMOBJ_OBJ` |
|     3970 | 5381 | `						&& ((pObj->iFlags & aFormalArg[n].nType) == 0)` |
|     1991 | 5382 | `						&& !((aFormalArg[n].iFlags & VM_FUNC_ARG_NULLABLE) && (pObj->iFlags & MEMOBJ_NULL)) ){` |
...
|        - | 5394 | `		 */` |
|   106225 | 5395 | `		PH7_MemObjRelease(pTos);` |
|   106225 | 5396 | `		pTos = &pTos[-nCallArgs];` |
...
|        - | 5408 | `		 * per function. */` |
|        - | 5409 | `		{` |
|   106225 | 5410 | `			sxu32 nSlots = pVmFunc->nMaxStack;` |
|   106225 | 5411 | `			if( nSlots == 0 ){` |
|     8303 | 5412 | `				sxu32 nInstr = SySetUsed(&pVmFunc->aByteCode);` |
|    12452 | 5413 | `				sxu32 nTight = VmComputeMaxStack(&(*pVm),` |
|     8298 | 5414 | `					(VmInstr *)SySetBasePtr(&pVmFunc->aByteCode),nInstr);` |
|     8303 | 5415 | `				nSlots = ( nTight == VM_STACK_UNMODELED ) ? nInstr : nTight;` |
|     8303 | 5416 | `				if( nSlots == 0 ){ nSlots = 1; } /* a 0-depth body still needs a valid, nonzero cache marker */` |
|     8303 | 5417 | `				pVmFunc->nMaxStack = nSlots;` |
|     4149 | 5418 | `			}` |
|   106225 | 5419 | `			pFrameStack = VmOperandStackAlloc(&(*pVm),nSlots);` |
|        - | 5420 | `		}` |
|   106225 | 5421 | `		if( pFrameStack == 0 ){` |
...
|      ! 0 | 5428 | `			break;` |
|        - | 5429 | `		}` |
|    53005 | 5430 | `SkipFuncBody:` |
|   106359 | 5431 | `		if( pSelf ){` |
|        - | 5432 | `			/* Push class name */` |
|    25759 | 5433 | `			SySetPut(&pVm->aSelf,(const void *)&pSelf);` |
|    12877 | 5434 | `		}` |
|        - | 5435 | `		/* Increment nesting level */` |
|   106359 | 5436 | `		pVm->nRecursionDepth++;` |
|   106359 | 5437 | `		if( rc == PH7_EXCEPTION ){` |
...
|   106225 | 5466 | `			VmCallFrame *pRec = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   106225 | 5467 | `			if( pRec ){` |
|   103577 | 5468 | `				pVm->pIdleCallFrames = (void *)pRec->pPrev;` |
|    51896 | 5469 | `			}else{` |
|     2653 | 5470 | `				pRec = (VmCallFrame *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmCallFrame));` |
|        - | 5471 | `			}` |
|   106225 | 5472 | `			if( pRec == 0 ){` |
...
|      ! 0 | 5483 | `				goto Abort;` |
|        - | 5484 | `			}` |
|   106225 | 5485 | `			sState.pTos = pTos;` |
|   106225 | 5486 | `			sState.pc = pc;` |
|   106225 | 5487 | `			pRec->sCaller = sState;` |
|   106225 | 5488 | `			pRec->sCall.pVmFunc = pVmFunc;` |
|   106225 | 5489 | `			pRec->sCall.pFrame = pFrame;` |
|   106225 | 5490 | `			pRec->sCall.pFrameStack = pFrameStack;` |
|   106225 | 5491 | `			pRec->sCall.nStackCap = pVmFunc->nMaxStack + VM_STACK_GUARD;` |
|   106225 | 5492 | `			pRec->sCall.nLastRef = SXU32_HIGH;` |
|   106225 | 5493 | `			pRec->sCall.bSelfPushed = (sxu8)(pSelf ? 1 : 0);` |
|   106225 | 5494 | `			pRec->pPrev = pCallTop;` |
|   106225 | 5495 | `			pCallTop = pRec;` |
|        - | 5496 | `			/* Switch to the callee activation (what the recursive` |
|        - | 5497 | `			 * VmByteCodeExec entry used to set up). */` |
|   106225 | 5498 | `			aInstr = (VmInstr *)SySetBasePtr(&pVmFunc->aByteCode);` |
|   106225 | 5499 | `			pStack = pFrameStack;` |
|   106225 | 5500 | `			pTos = &pStack[-1];` |
|   106225 | 5501 | `			pc = 0;` |
|   106225 | 5502 | `			sState.aInstr = aInstr;` |
|   106225 | 5503 | `			sState.pStack = pStack;` |
|   106225 | 5504 | `			sState.nStackCap = pRec->sCall.nStackCap; /* callee's operand-stack capacity for OP_SPREAD growth */` |
|   106225 | 5505 | `			sState.nStackOrig = pRec->sCall.nStackCap; /* fixed headroom reference (never grows) */` |
|   106225 | 5506 | `			sState.pTos = pTos;` |
|   106225 | 5507 | `			sState.pc = 0;` |
|   106225 | 5508 | `			sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|   106225 | 5509 | `			sState.pEntryFrame = pVm->pFrame;` |
|   106225 | 5510 | `			sState.pResult = pRec->sCaller.pTos;` |
|   106225 | 5511 | `			sState.pLastRef = &pRec->sCall.nLastRef;` |
|   106225 | 5512 | `			sState.pEnforceRetFunc = VmFuncHasReturnType(pVmFunc) ? pVmFunc : 0;` |
|   106225 | 5513 | `			sState.is_callback = 0;` |
|   106225 | 5514 | `			sState.bReturnPropagates = 0;` |
|   106225 | 5515 | `			goto VmLoopFetch;` |
|        - | 5516 | `		}` |
|       57 | 5517 | `	}else{` |
...
|   941499 | 5526 | `		pEntry = SyHashGet(&pVm->hHostFunction,(const void *)sName.zString,sName.nByte);` |
|        - | 5527 | `		{` |
|   941499 | 5528 | `		VmCallArgMap *pCallMap2 = pEffCallMap;` |
|   941499 | 5529 | `		if( pEntry == 0 && pCallMap2 && pCallMap2->bIsNamespaced ){` |
...
|        - | 5634 | `			}` |
|        - | 5635 | `		}` |
|   941483 | 5636 | `		pFunc = (ph7_user_func *)pEntry->pUserData;` |
...
|  1412595 | 5641 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   941478 | 5642 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
|        - | 5643 | `		/* Start collecting function arguments */` |
|   941483 | 5644 | `		SySetReset(&aArg);` |
|  2544929 | 5645 | `		while( pArg < pTos ){` |
|  1603451 | 5646 | `			SySetPut(&aArg,(const void *)&pArg);` |
|  1603451 | 5647 | `			pArg++;` |
|        5 | 5648 | `		}` |
|        - | 5649 | `		/* Assume a null return value */` |
|   941483 | 5650 | `		PH7_MemObjInit(&(*pVm),&sRet);` |
|        - | 5651 | `		/* Init the call context */` |
|   941483 | 5652 | `		VmInitCallContext(&sCtx,&(*pVm),pFunc,&sRet,0);` |
...
|   941483 | 5659 | `		sCtx.pArgMap = pEffCallMap;` |
|        - | 5660 | `		{` |
|   941483 | 5661 | `		int nGiven = (int)SySetUsed(&aArg);` |
...
|   941483 | 5667 | `		if( pFunc->nMinArg > 0 && nGiven < pFunc->nMinArg ){` |
...
|      232 | 5674 | `				nGiven);` |
|   941251 | 5675 | `		}else if( pFunc->bHasMaxArg && nGiven > (int)pFunc->nMaxArg ){` |
...
|       40 | 5688 | `				nGiven);` |
|  1411819 | 5689 | `		}else if( SXRET_OK != (rc = VmEnforceBuiltinArgTypes(&sCtx,pFunc,nGiven,` |
|   940934 | 5690 | `			(ph7_value **)SySetBasePtr(&aArg))) ){` |
|        - | 5691 | `			/* TypeError thrown: rc carries the caught/uncaught status */` |
|      112 | 5692 | `		}else{` |
|        - | 5693 | `			/* Call the foreign function */` |
|   940725 | 5694 | `			rc = pFunc->xFunc(&sCtx,nGiven,(ph7_value **)SySetBasePtr(&aArg));` |
|        - | 5695 | `		}` |
|        - | 5696 | `		}` |
|        - | 5697 | `		/* Release the call context */` |
|   941483 | 5698 | `		VmReleaseCallContext(&sCtx);` |
|   941483 | 5699 | `		if( rc == PH7_ABORT ){` |
...
|      578 | 5704 | `			goto Abort;` |
|        - | 5705 | `		}` |
|   940909 | 5706 | `		if( rc != PH7_SUSPEND && pVm->pInlineInstr == (void *)aInstr ){` |
...
|      ! 0 | 5719 | `		}` |
|   940905 | 5720 | `		if( rc == PH7_EXCEPTION ){` |
...
|      851 | 5740 | `			break;` |
|        - | 5741 | `		}` |
|   939861 | 5742 | `		if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|   918695 | 5766 | `			VmPopOperand(&pTos,nCallArgs);` |
|   459718 | 5767 | `		}` |
|        - | 5768 | `		/* Save foreign function return value into the (now top) function-name slot */` |
|   939507 | 5769 | `		PH7_MemObjStore(&sRet,pTos);` |
|   939507 | 5770 | `		PH7_MemObjRelease(&sRet);` |
|        - | 5771 | `	}` |
|   939611 | 5772 | `	break;` |
|        - | 5773 | `				  }` |
|        - | 5774 | `/*` |
...
|        - | 5777 | ` */` |
|    26186 | 5778 | `case PH7_OP_CONSUME: {` |
|        - | 5779 | `	VmOpRc rcOp;` |
|    52377 | 5780 | `	sState.pTos = pTos;` |
|    52377 | 5781 | `	sState.pc = pc;` |
|    52377 | 5782 | `	rcOp = VmExecOpConsume(&(*pVm),&sState,pInstr);` |
|    52377 | 5783 | `	pTos = sState.pTos;` |
|    52377 | 5784 | `	pc = sState.pc;` |
|    52377 | 5785 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 5786 | `		goto Abort;` |
|    52377 | 5787 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 5792 |  |
|        - | 5793 | `		} /* Switch() */` |
| 16873990 | 5794 | `		pc++; /* Next instruction in the stream */` |
|        5 | 5795 | `	} /* For(;;) */` |
|   131492 | 5796 | `Done:` |
...
|   263199 | 5800 | `	rc = SXRET_OK;` |
|   263199 | 5801 | `	goto Unwind;` |
|      823 | 5802 | `Suspend:` |
...
|   133510 | 5860 | `	for(;;){` |
|   266815 | 5861 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|      ! 0 | 5869 | `			}` |
|     1162 | 5870 | `		}` |
|   266815 | 5871 | `		if( pCallTop == 0 ){` |
|   161005 | 5872 | `			return VmExecFinalize(&(*pVm),&sState,&aArg,pTos,rc);` |
|        - | 5873 | `		}` |
|   105815 | 5874 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|      636 | 5880 | `		}` |
|        - | 5881 | `		{` |
|   105815 | 5882 | `			VmCallFrame *pRec = pCallTop;` |
|   105815 | 5883 | `			sState = pRec->sCaller;` |
|   105815 | 5884 | `			rc = VmCallFinish(&(*pVm),&sState,&pRec->sCall,rc);` |
|   105815 | 5885 | `			pCallTop = pRec->pPrev;` |
|   105815 | 5886 | `			pRec->pPrev = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   105815 | 5887 | `			pVm->pIdleCallFrames = (void *)pRec;` |
|   105815 | 5888 | `			aInstr = sState.aInstr;` |
|   105815 | 5889 | `			pStack = sState.pStack;` |
|   105815 | 5890 | `			pTos = sState.pTos;` |
|   105815 | 5891 | `			pc = sState.pc;` |
|        - | 5892 | `		}` |
|   105815 | 5893 | `		if( rc == PH7_OK ){` |
|   105049 | 5894 | `			pc++; /* the loop-bottom increment this OP_CALL missed */` |
|   105049 | 5895 | `			goto VmLoopFetch;` |
|        - | 5896 | `		}` |
|        5 | 5897 | `	}` |
|    80682 | 5898 | `}` |
|        - | 5899 |  |
