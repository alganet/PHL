...
|        - |  162 | ` */` |
|   157072 |  163 | `static sxi32 VmExecFinalize(ph7_vm *pVm,VmExecState *pState,SySet *pArg,ph7_value *pTos,sxi32 rcTerm)` |
|        5 |  164 | `{` |
|    78536 |  165 | `	SXUNUSED(pVm);` |
|   157077 |  166 | `	if( rcTerm != PH7_SUSPEND && !pState->bReturnPropagates ){` |
|   153431 |  167 | `		VmClearFrameReturn(pState->pEntryFrame);` |
|    76713 |  168 | `	}` |
|   157077 |  169 | `	SySetRelease(pArg);` |
|   157077 |  170 | `	if( rcTerm == PH7_ABORT \|\| rcTerm == PH7_EXCEPTION ){` |
|     2835 |  171 | `		while( pTos >= pState->pStack ){` |
|     1785 |  172 | `			PH7_MemObjRelease(pTos);` |
|     1785 |  173 | `			pTos--;` |
|        5 |  174 | `		}` |
|      525 |  175 | `	}` |
|   157077 |  176 | `	return rcTerm;` |
|        5 |  177 | `}` |
|        - |  178 | `/*` |
...
|        - |  189 | ` */` |
|   104684 |  190 | `static sxi32 VmCallFinish(ph7_vm *pVm,VmExecState *pCaller,VmCallRecord *pCallee,sxi32 rc)` |
|        5 |  191 | `{` |
|        - |  192 | `	ph7_value *pObj;` |
|        - |  193 | `	/* Decrement nesting level */` |
|   104689 |  194 | `	pVm->nRecursionDepth--;` |
|   104689 |  195 | `	if( pCallee->bSelfPushed ){` |
|        - |  196 | `		/* Pop class name */` |
|    25417 |  197 | `		(void)SySetPop(&pVm->aSelf);` |
|    12706 |  198 | `	}` |
|   104689 |  199 | `	if( (pCallee->pVmFunc->iFlags & VM_FUNC_REF_RETURN) && rc == SXRET_OK ){` |
...
|       25 |  225 | `	}` |
|   104689 |  226 | `	if( rc != PH7_ABORT && ((pCallee->pFrame->iFlags & VM_FRAME_THROW) \|\| rc == PH7_EXCEPTION) ){` |
...
|   104689 |  272 | `	if( rc != PH7_SUSPEND && pCallee->pFrameStack ){` |
...
|   104555 |  276 | `		VmOperandStackRecycle(pVm,pCallee->pFrameStack,pCallee->nStackCap);` |
|    52379 |  277 | `	}` |
|        - |  278 | `	/* Leave the frame */` |
|   104689 |  279 | `	VmLeaveFrame(&(*pVm));` |
|   104689 |  280 | `	if( rc == PH7_ABORT ){` |
|      336 |  281 | `		return PH7_ABORT;` |
|        - |  282 | `	}` |
|   104357 |  283 | `	if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|        - |  291 | `	}` |
|   104357 |  292 | `	if( rc == PH7_EXCEPTION ){` |
|      469 |  293 | `		return PH7_EXCEPTION;` |
|        - |  294 | `	}` |
|   103893 |  295 | `	return PH7_OK;` |
|    52451 |  296 | `}` |
|        - |  297 | `/*` |
...
|        - |  330 | ` * nesting.` |
|        - |  331 | ` */` |
|   157430 |  332 | `PH7_PRIVATE sxi32 VmByteCodeExec(` |
...
|   157435 |  352 | `	if( VmNativeNestingExceeded(pVm) ){` |
...
|   157431 |  362 | `	nSavedBrc = pVm->nBoundaryRc;` |
|   157431 |  363 | `	pVm->nBoundaryRc = 0;` |
...
|   157431 |  370 | `	nSavedLine = pVm->nCurLine;` |
|   157431 |  371 | `	pVm->nVmExecDepth++;` |
|   236144 |  372 | `	rc = VmByteCodeExecBody(&(*pVm),aInstr,pStack,nTos,pResult,pLastRef,is_callback,nPc,` |
|    78713 |  373 | `		pEnforceRetFunc,bReturnPropagates,pAdoptSegment,ppBaseOwner,pnBaseCap,nStackOrig);` |
|   157431 |  374 | `	pVm->nVmExecDepth--;` |
|   157431 |  375 | `	pVm->nCurLine = nSavedLine;` |
|   157431 |  376 | `	if( nSavedBrc != 0 && (nSavedBrc == PH7_ABORT \|\| pVm->nBoundaryRc == 0) ){` |
|       15 |  377 | `		pVm->nBoundaryRc = nSavedBrc;` |
|        6 |  378 | `	}` |
|   157431 |  379 | `	return rc;` |
|    78720 |  380 | `}` |
|   157426 |  381 | `static sxi32 VmByteCodeExecBody(` |
...
|        - |  399 | `	ph7_value *pTos;` |
|        - |  400 | `	SySet aArg;` |
|   157431 |  401 | `	VmCallFrame *pCallTop = 0; /* Top of this invocation's in-loop call-record` |
...
|        - |  409 | `	sxi32 pc;` |
|        - |  410 | `	sxi32 rc;` |
|   157431 |  411 | `	sState.aInstr = aInstr;` |
|   157431 |  412 | `	sState.pStack = pStack;` |
|   157431 |  413 | `	sState.nStackCap = pnBaseCap ? *pnBaseCap : 0; /* CURRENT capacity (grown on a coroutine resume) */` |
|   157431 |  414 | `	sState.nStackOrig = nStackOrig;                /* ORIGINAL capacity — fixed headroom reference */` |
|   157431 |  415 | `	sState.pResult = pResult;` |
|   157431 |  416 | `	sState.pLastRef = pLastRef;` |
|   157431 |  417 | `	sState.pEnforceRetFunc = pEnforceRetFunc;` |
|   157431 |  418 | `	sState.is_callback = (sxu8)(is_callback ? 1 : 0);` |
|   157431 |  419 | `	sState.bReturnPropagates = (sxu8)(bReturnPropagates ? 1 : 0);` |
|        - |  420 | `	/* Argument container */` |
|   157431 |  421 | `	SySetInit(&aArg,&pVm->sAllocator,sizeof(ph7_value *));` |
|   157431 |  422 | `	if( nTos < 0 ){` |
|   141701 |  423 | `		pTos = &pStack[-1];` |
|    70853 |  424 | `	}else{` |
|    15735 |  425 | `		pTos = &pStack[nTos];` |
|        - |  426 | `	}` |
|   157431 |  427 | `	sState.pTos = pTos;` |
|   157431 |  428 | `	sState.pc = nPc;` |
...
|   157426 |  446 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->pFrame == pVm->pFrame` |
|     2816 |  447 | `	 && pStack == pVm->pActiveCtx->pStack ){` |
|     1805 |  448 | `		sState.nExceptionBase = pVm->pActiveCtx->nExceptionBase;` |
|      905 |  449 | `	}else{` |
|   155631 |  450 | `		sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|        - |  451 | `	}` |
|   157431 |  452 | `	sState.pEntryFrame = pVm->pFrame;` |
|   157431 |  453 | `	pc = nPc;` |
...
|   157426 |  506 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->pInjected` |
...
|   157416 |  567 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->bClosing` |
...
| 16810157 |  603 | `		if( pVm->nBoundaryRc != 0 \|\| SySetUsed(&pVm->aHookRmw) > 0 ){` |
...
| 16810071 |  658 | `		pInstr = &aInstr[pc];` |
| 16810071 |  659 | `		if( pInstr->nLine ){` |
...
| 16597157 |  663 | `			pVm->nCurLine = pInstr->nLine;` |
|  8304997 |  664 | `		}` |
| 16810071 |  665 | `		rc = SXRET_OK;` |
|        - |  666 | `/*` |
...
|        - |  672 | ` */` |
| 16810071 |  673 | `		switch(pInstr->iOp){` |
|        - |  674 | `/*` |
|        - |  675 | ` * DONE: P1 * *` |
|        - |  676 | ` *` |
...
|        - |  679 | ` */` |
|   128809 |  680 | `case PH7_OP_DONE:` |
|   257831 |  681 | `	if( pInstr->iP2 && sState.bReturnPropagates ){` |
...
|   257642 |  711 | `	if( sState.pEnforceRetFunc && VmFuncHasReturnType(sState.pEnforceRetFunc)` |
...
|     4591 |  736 | `	}` |
|   257623 |  737 | `	if( pInstr->iP1 && pTos >= pStack ){` |
|   153143 |  738 | `		if( sState.pLastRef ){` |
|    94271 |  739 | `			*sState.pLastRef = pTos->nIdx;` |
|    47237 |  740 | `		}` |
|   153143 |  741 | `		if( sState.pResult ){` |
|        - |  742 | `			/* Execution result */` |
|   146119 |  743 | `			PH7_MemObjStore(pTos,sState.pResult);` |
|    73161 |  744 | `		}` |
|   153143 |  745 | `		VmPopOperand(&pTos,1);` |
|   181158 |  746 | `	}else if( sState.pLastRef ){` |
...
|     8883 |  752 | `		*sState.pLastRef = SXU32_HIGH;` |
|     4439 |  753 | `	}` |
...
|        - |  762 | `	 */` |
|   257623 |  763 | `	rc = VmDrainFinally(&(*pVm),sState.nExceptionBase);` |
|   257623 |  764 | `	if( rc == SXERR_ABORT ){` |
|      ! 0 |  765 | `		goto Abort;` |
|        - |  766 | `	}` |
|   257623 |  767 | `	if( rc == PH7_EXCEPTION ){` |
...
|        - |  778 | `	}` |
|   257619 |  779 | `	if( sState.pEntryFrame->bHasRet && !sState.bReturnPropagates ){` |
...
|        - |  835 | ` */` |
|   288587 |  836 | `case PH7_OP_JMP:` |
|   577387 |  837 | `	pc = pInstr->iP2 - 1;` |
|   577387 |  838 | `	break;` |
|        - |  839 | `/*` |
|        - |  840 | ` * JZ: P1 P2 *` |
|        - |  841 | ` *` |
...
|  1605838 |  852 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     1003 |  853 | `		PH7_MemObjToBool(pTos);` |
|      500 |  854 | `	}` |
|  1605838 |  855 | `	if( !pTos->x.iVal ){` |
|        - |  856 | `		/* Take the jump */` |
|   899918 |  857 | `		pc = pInstr->iP2 - 1;` |
|   450221 |  858 | `	}` |
|  1605838 |  859 | `	if( !pInstr->iP1 ){` |
|  1357470 |  860 | `		VmPopOperand(&pTos,1);` |
|   679309 |  861 | `	}` |
|  1605838 |  862 | `	break;` |
|        - |  863 | `/*` |
|        - |  864 | ` * JNZ: P1 P2 *` |
...
|   184147 |  876 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      ! 0 |  877 | `		PH7_MemObjToBool(pTos);` |
|      ! 0 |  878 | `	}` |
|   184147 |  879 | `	if( pTos->x.iVal ){` |
|        - |  880 | `		/* Take the jump */` |
|     9549 |  881 | `		pc = pInstr->iP2 - 1;` |
|     4772 |  882 | `	}` |
|   184147 |  883 | `	if( !pInstr->iP1 ){` |
...
|        - |  899 | ` */` |
|   662256 |  900 | `case PH7_OP_POP: {` |
|  1325557 |  901 | `	sxi32 n = pInstr->iP1;` |
|  1325557 |  902 | `	if( &pTos[-n+1] < pStack ){` |
|        - |  903 | `		/* TICKET 1433-51 Stack underflow must be handled at run-time */` |
|       79 |  904 | `		n = (sxi32)(pTos - pStack);` |
|       38 |  905 | `	}` |
|  1325557 |  906 | `	VmPopOperand(&pTos,n);` |
|  1325557 |  907 | `	break;` |
|        - |  908 | `				 }` |
|        - |  909 | `/*` |
|        - |  910 | ` * DUP: * * *` |
...
|        - |  929 | ` */` |
|    49001 |  930 | `case PH7_OP_NSSWITCH:` |
|    98007 |  931 | `	SyBlobReset(&pVm->sNamespace);` |
|    98007 |  932 | `	if( pInstr->p3 ){` |
...
|    98007 |  937 | `	SyHashRelease(&pVm->hUseConstImports);` |
|    98007 |  938 | `	SyHashInit(&pVm->hUseConstImports,&pVm->sAllocator,0,0);` |
|    98007 |  939 | `	break;` |
...
|        - | 1076 | ` */` |
|     3351 | 1077 | `case PH7_OP_UNSET_VAR: {` |
|        - | 1078 | `	VmOpRc rcOp;` |
|     6707 | 1079 | `	sState.pTos = pTos;` |
|     6707 | 1080 | `	sState.pc = pc;` |
|     6707 | 1081 | `	rcOp = VmExecOpUnsetVar(&(*pVm),&sState,pInstr);` |
|     6707 | 1082 | `	pTos = sState.pTos;` |
|     6707 | 1083 | `	pc = sState.pc;` |
|     6707 | 1084 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 1085 | `		goto Abort;` |
|     6705 | 1086 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
|      ! 0 | 1087 | `		goto Exception;` |
|        - | 1088 | `	}` |
|     6705 | 1089 | `	break;` |
|        - | 1090 | `					  }` |
|    33075 | 1091 | `case PH7_OP_ERR_CTRL:` |
|        - | 1092 | `	/*` |
...
|        - | 1101 | `	 */` |
|    66155 | 1102 | `	if( pInstr->iP1 ){` |
|    33081 | 1103 | `		pVm->nErrSuppress++;` |
|    49617 | 1104 | `	}else if( pVm->nErrSuppress > 0 ){` |
|    33079 | 1105 | `		pVm->nErrSuppress--;` |
|    16537 | 1106 | `	}` |
|    66155 | 1107 | `	break;` |
|        - | 1108 | `/*` |
|        - | 1109 | ` * IS_A * * *` |
...
|        - | 1163 | ` */` |
|  1513360 | 1164 | `case PH7_OP_LOADC: {` |
|        - | 1165 | `	ph7_value *pObj;` |
|        - | 1166 | `	/* Reserve a room */` |
|  3028615 | 1167 | `	pTos++;` |
|  3028615 | 1168 | `	if( pInstr->iP1 & PH7_LOADC_NOKEY ){` |
|        - | 1169 | `		/* Absent array-literal key: mark it so LOAD_MAP auto-indexes without a diagnostic */` |
|    19347 | 1170 | `		MemObjSetType(pTos,MEMOBJ_NULL);` |
|    19347 | 1171 | `		SyBlobReset(&pTos->sBlob);` |
|    19347 | 1172 | `		pTos->iFlags \|= MEMOBJ_AUX_NOKEY;` |
|    19347 | 1173 | `		pTos->nIdx = SXU32_HIGH;` |
|    19347 | 1174 | `		break;` |
|        - | 1175 | `	}` |
|  3009273 | 1176 | `	if( (pObj = (ph7_value *)SySetAt(&pVm->aLitObj,pInstr->iP2)) != 0 ){` |
|  3009273 | 1177 | `		if( (pInstr->iP1 & PH7_LOADC_EXPAND) && SyBlobLength(&pObj->sBlob) <= 64 ){` |
|        - | 1178 | `			SyHashEntry *pEntry;` |
|        - | 1179 | `			/* Check use const imports first — imports take precedence */` |
|        - | 1180 | `			{` |
|        - | 1181 | `				SyHashEntry *pConstImport;` |
|    34811 | 1182 | `				pConstImport = SyHashGet(&pVm->hUseConstImports,` |
|    23204 | 1183 | `					SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|    23209 | 1184 | `				if( pConstImport ){` |
...
|    23199 | 1199 | `			pEntry = SyHashGet(&pVm->hConstant,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|    23199 | 1200 | `			if( pEntry ){` |
|    23189 | 1201 | `				ph7_constant *pCons = (ph7_constant *)pEntry->pUserData;` |
|        - | 1202 | `				/* Set a NULL default value */` |
|    23189 | 1203 | `				MemObjSetType(pTos,MEMOBJ_NULL);` |
|    23189 | 1204 | `				SyBlobReset(&pTos->sBlob);` |
|        - | 1205 | `				/* Invoke the callback and deal with the expanded value */` |
|    23189 | 1206 | `				VmExpandConstantWithNotice(&(*pVm),pCons,pTos);` |
|        - | 1207 | `				/* Mark as constant */` |
|    23189 | 1208 | `				pTos->nIdx = SXU32_HIGH;` |
|    23189 | 1209 | `				break;` |
|        - | 1210 | `			}` |
...
|        - | 1283 | ` */` |
|  2196808 | 1284 | `case PH7_OP_LOAD:{` |
|        - | 1285 | `	ph7_value *pObj;` |
|        - | 1286 | `	SyString sName;` |
|  4397591 | 1287 | `	if( pInstr->p3 == 0 ){` |
...
|        9 | 1299 | `	}else{` |
|  4397575 | 1300 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1301 | `		/* Reserve a room for the target object */` |
|  4397575 | 1302 | `		pTos++;` |
|        - | 1303 | `	}` |
|  4397591 | 1304 | `	if( pInstr->iP2 == 2 ){` |
...
|   392379 | 1310 | `		if( VmExtractMemObj(&(*pVm),&sName,FALSE,FALSE) == 0 ){` |
|        7 | 1311 | `			VmErrorFormat(&(*pVm),PH7_CTX_WARNING,"Undefined variable $%z",&sName);` |
|        3 | 1312 | `		}` |
|   196291 | 1313 | `	}` |
|        - | 1314 | `	/* Extract the requested memory object */` |
|  4397591 | 1315 | `	pObj = VmExtractMemObj(&(*pVm),&sName,pInstr->p3 ? FALSE : TRUE,pInstr->iP1 != 1);` |
|  4397591 | 1316 | `	if( pObj == 0 ){` |
...
|  4397529 | 1341 | `	PH7_MemObjLoad(pObj,pTos);` |
|  4397529 | 1342 | `	pTos->nIdx = pObj->nIdx;` |
|  4397529 | 1343 | `	break;` |
|        - | 1344 | `				   }` |
|        - | 1345 | `/*` |
|        - | 1346 | ` * LOAD_MAP P1 * *` |
...
|        - | 1351 | ` */` |
|    36866 | 1352 | `case PH7_OP_LOAD_MAP: {` |
|        - | 1353 | `	VmOpRc rcOp;` |
|    73737 | 1354 | `	sState.pTos = pTos;` |
|    73737 | 1355 | `	sState.pc = pc;` |
|    73737 | 1356 | `	rcOp = VmExecOpLoadMap(&(*pVm),&sState,pInstr);` |
|    73737 | 1357 | `	pTos = sState.pTos;` |
|    73737 | 1358 | `	pc = sState.pc;` |
|    73737 | 1359 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1360 | `		goto Abort;` |
|    73737 | 1361 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1394 | ` * instead.` |
|        - | 1395 | ` */` |
|   331984 | 1396 | `case PH7_OP_LOAD_IDX: {` |
|        - | 1397 | `	VmOpRc rcOp;` |
|   664710 | 1398 | `	sState.pTos = pTos;` |
|   664710 | 1399 | `	sState.pc = pc;` |
|   664710 | 1400 | `	rcOp = VmExecOpLoadIdx(&(*pVm),&sState,pInstr);` |
|   664710 | 1401 | `	pTos = sState.pTos;` |
|   664710 | 1402 | `	pc = sState.pc;` |
|   664710 | 1403 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1404 | `		goto Abort;` |
|   664710 | 1405 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1507 | `	}` |
|        - | 1508 | `#endif` |
|   596609 | 1509 | `	if( pInstr->iP2 ){` |
|        - | 1510 | `		sxu32 nIdx;` |
|        - | 1511 | `		sxi32 rcT;` |
|        - | 1512 | `		/* Member store operation */` |
|    11785 | 1513 | `		nIdx = pTos->nIdx;` |
|    11785 | 1514 | `		VmPopOperand(&pTos,1);` |
|    11785 | 1515 | `		if( pVm->pMagicSetThis ){` |
...
|       11 | 1528 | `			break;` |
|        - | 1529 | `		}` |
|    11775 | 1530 | `		if( pVm->pHookSetThis ){` |
...
|    11743 | 1558 | `			rcT = VmEnforcePropertyTypeOnStore(&(*pVm),nIdx,pTos,0);` |
|    11743 | 1559 | `			if( rcT == PH7_ABORT ){` |
|       13 | 1560 | `				goto Abort;` |
|        - | 1561 | `			}` |
|    11733 | 1562 | `			if( rcT == PH7_EXCEPTION ){` |
...
|    11665 | 1577 | `			pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|    11665 | 1578 | `			if( pObj ){` |
|        - | 1579 | `				/* Perform the store operation */` |
|    11665 | 1580 | `				PH7_MemObjStore(pTos,pObj);` |
|     5830 | 1581 | `			}` |
|        - | 1582 | `		}` |
|    11667 | 1583 | `		break;` |
|   584829 | 1584 | `	}else if( pInstr->p3 == 0 ){` |
...
|        - | 1596 | `#endif` |
|        5 | 1597 | `	}else{` |
|   584821 | 1598 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1599 | `	}` |
|   584824 | 1600 | `	if( sName.nByte == sizeof("GLOBALS")-1` |
|   294168 | 1601 | `	 && SyMemcmp((const void *)sName.zString,(const void *)"GLOBALS",sName.nByte) == 0 ){` |
|        6 | 1602 | `		if( pInstr->p3 ){` |
...
|        - | 1639 | ` */` |
|   120455 | 1640 | `case PH7_OP_STORE_IDX:` |
|        - | 1641 | `case PH7_OP_STORE_IDX_REF: {` |
|        - | 1642 | `	VmOpRc rcOp;` |
|   240915 | 1643 | `	sState.pTos = pTos;` |
|   240915 | 1644 | `	sState.pc = pc;` |
|   240915 | 1645 | `	rcOp = VmExecOpStoreIdxRef(&(*pVm),&sState,pInstr);` |
|   240915 | 1646 | `	pTos = sState.pTos;` |
|   240915 | 1647 | `	pc = sState.pc;` |
|   240915 | 1648 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 1649 | `		goto Abort;` |
|   240913 | 1650 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|   366447 | 1671 | `	PH7_ENFORCE_READONLY_MUTATE(pTos->nIdx);` |
...
|   366436 | 1676 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) != 0` |
|   183328 | 1677 | `	 && SySetUsed(&pVm->aHookRmw) > 0 ){` |
...
|        - | 1694 | `		}` |
|      ! 0 | 1695 | `	}` |
|   366439 | 1696 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) == 0 ){` |
|   366439 | 1697 | `		if( pTos->nIdx != SXU32_HIGH ){` |
|        - | 1698 | `			ph7_value *pObj;` |
|   366439 | 1699 | `			if( (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pTos->nIdx)) != 0 ){` |
|   366439 | 1700 | `				if( VmStringWantsPerlIncr(pObj) ){` |
...
|   366437 | 1719 | `					if( pInstr->iP1 == 0 && (pTos->iFlags & MEMOBJ_STRING) ){` |
|        9 | 1720 | `						SyBlobNullAppend(&pTos->sBlob);` |
|        3 | 1721 | `					}` |
|        - | 1722 | `					/* Force a numeric cast on the variable */` |
|   366437 | 1723 | `					PH7_MemObjToNumeric(pObj);` |
|   366437 | 1724 | `					if( pObj->iFlags & MEMOBJ_REAL ){` |
|        5 | 1725 | `						pObj->rVal++;` |
...
|        - | 1734 | `						sxi64 r;` |
|   366433 | 1735 | `						if( PH7_ADD_OVERFLOW64(pObj->x.iVal,1,&r) ){` |
...
|        - | 1741 | `#endif` |
|        3 | 1742 | `						}else{` |
|   366429 | 1743 | `							pObj->x.iVal = r;` |
|        - | 1744 | `						}` |
|        - | 1745 | `					}` |
|   366437 | 1746 | `					if( pInstr->iP1 ){` |
...
|        - | 1785 | `		}` |
|   183320 | 1786 | `	}` |
|   366437 | 1787 | `	PH7_HOOK_RMW_WRITEBACK(pTos->nIdx,pTos);` |
|   366437 | 1788 | `	break;` |
|        - | 1789 | `/*` |
|        - | 1790 | ` * DECR: P1 * *` |
|        - | 1791 | ` *` |
...
|    70559 | 1938 | `	PH7_MemObjToNumeric(pTos);` |
|    70559 | 1939 | `	if( pTos->iFlags & MEMOBJ_REAL ){` |
|      108 | 1940 | `		pTos->rVal = -pTos->rVal;` |
|       53 | 1941 | `	}` |
|    70559 | 1942 | `	if( pTos->iFlags & MEMOBJ_INT ){` |
|    70473 | 1943 | `		if( pTos->x.iVal == SMALLEST_INT64 ){` |
...
|        - | 1958 | `#endif` |
|        3 | 1959 | `		}else{` |
|    70469 | 1960 | `			pTos->x.iVal = -pTos->x.iVal;` |
|        - | 1961 | `		}` |
|    35234 | 1962 | `	}` |
|    70559 | 1963 | `	break;` |
|        - | 1964 | `/*` |
...
|    50837 | 1997 | `	if( (pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      151 | 1998 | `		PH7_MemObjToBool(pTos);` |
|       73 | 1999 | `	}` |
|    50837 | 2000 | `	pTos->x.iVal = !pTos->x.iVal;` |
|    50837 | 2001 | `	break;` |
|        - | 2002 | `/*` |
|        - | 2003 | ` * OP_BITNOT: * * *` |
|        - | 2004 | ` *` |
...
|        - | 2027 | ` */` |
|     1433 | 2028 | `case PH7_OP_MUL:` |
|        - | 2029 | `case PH7_OP_MUL_STORE: {` |
|        - | 2030 | `	VmOpRc rcOp;` |
|     2870 | 2031 | `	sState.pTos = pTos;` |
|     2870 | 2032 | `	sState.pc = pc;` |
|     2870 | 2033 | `	rcOp = VmExecOpMulStore(&(*pVm),&sState,pInstr);` |
|     2870 | 2034 | `	pTos = sState.pTos;` |
|     2870 | 2035 | `	pc = sState.pc;` |
|     2870 | 2036 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2037 | `		goto Abort;` |
|     2870 | 2038 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2070 | ` */` |
|     6359 | 2071 | `case PH7_OP_ADD:{` |
|    12723 | 2072 | `	ph7_value *pNos = &pTos[-1];` |
|        - | 2073 | `#ifdef UNTRUST` |
|        - | 2074 | `	if( pNos < pStack ){` |
|        - | 2075 | `		goto Abort;` |
|        - | 2076 | `	}` |
...
|        - | 2082 | `		SyBlob sArMsg;` |
|    12723 | 2083 | `		SyBlobInit(&sArMsg,&pVm->sAllocator);` |
|    12723 | 2084 | `		if( VmArithOperandCheck(&(*pVm),pNos,pTos,"+",&sArMsg) != SXRET_OK ){` |
|        - | 2085 | `			sxi32 rcAr;` |
...
|        - | 2096 | `		}` |
|    12715 | 2097 | `		SyBlobRelease(&sArMsg);` |
|        - | 2098 | `	}` |
|        - | 2099 | `	/* Perform the addition */` |
|    12715 | 2100 | `	PH7_MemObjAdd(pNos,pTos,FALSE);` |
|    12715 | 2101 | `	VmPopOperand(&pTos,1);` |
|    12715 | 2102 | `	break;` |
|        - | 2103 | `				}` |
|        - | 2104 | `/*` |
|        - | 2105 | ` * OP_ADD_STORE * * *` |
...
|        - | 2169 | ` */` |
|    12247 | 2170 | `case PH7_OP_SUB: {` |
|        - | 2171 | `	VmOpRc rcOp;` |
|    24612 | 2172 | `	sState.pTos = pTos;` |
|    24612 | 2173 | `	sState.pc = pc;` |
|    24612 | 2174 | `	rcOp = VmExecOpSub(&(*pVm),&sState,pInstr);` |
|    24612 | 2175 | `	pTos = sState.pTos;` |
|    24612 | 2176 | `	pc = sState.pc;` |
|    24612 | 2177 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2178 | `		goto Abort;` |
|    24612 | 2179 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2359 | ` * two elements.` |
|        - | 2360 | ` */` |
|      476 | 2361 | `case PH7_OP_BAND:` |
|        - | 2362 | `case PH7_OP_BOR:` |
|        - | 2363 | `case PH7_OP_BXOR:{` |
|      957 | 2364 | `	ph7_value *pNos = &pTos[-1];` |
|        - | 2365 | `	sxi64 a,b,r;` |
|        - | 2366 | `#ifdef UNTRUST` |
|        - | 2367 | `	if( pNos < pStack ){` |
|        - | 2368 | `		goto Abort;` |
...
|      957 | 2372 | `	rc = VmRejectFloatOperand(&(*pVm),pNos);` |
|      957 | 2373 | `	PH7_DISPATCH_ENFORCE_RC(rc)` |
|      957 | 2374 | `	rc = VmRejectFloatOperand(&(*pVm),pTos);` |
|      957 | 2375 | `	PH7_DISPATCH_ENFORCE_RC(rc)` |
|      957 | 2376 | `	if( (pTos->iFlags & MEMOBJ_INT) == 0 ){` |
|      ! 0 | 2377 | `		PH7_MemObjToInteger(pTos);` |
|      ! 0 | 2378 | `	}` |
|      957 | 2379 | `	if( (pNos->iFlags & MEMOBJ_INT) == 0 ){` |
|      ! 0 | 2380 | `		PH7_MemObjToInteger(pNos);` |
|      ! 0 | 2381 | `	}` |
|        - | 2382 | `	/* Perform the requested operation */` |
|      957 | 2383 | `	a = pNos->x.iVal;` |
|      957 | 2384 | `	b = pTos->x.iVal;` |
|      957 | 2385 | `	switch(pInstr->iOp){` |
...
|      427 | 2390 | `	case PH7_OP_BAND_STORE:` |
|      427 | 2391 | `	case PH7_OP_BAND:` |
|      859 | 2392 | `	default:          r = a&b; break;` |
|        - | 2393 | `	}` |
|        - | 2394 | `	/* Push the result */` |
|      957 | 2395 | `	pNos->x.iVal = r;` |
|      957 | 2396 | `	MemObjSetType(pNos,MEMOBJ_INT);` |
|      957 | 2397 | `	VmPopOperand(&pTos,1);` |
|      957 | 2398 | `	break;` |
|        - | 2399 | `				 }` |
|        - | 2400 | `/* OP_BAND_STORE * * *` |
|        - | 2401 | ` *` |
...
|        - | 2526 | ` * back.` |
|        - | 2527 | ` */` |
|    86462 | 2528 | `case PH7_OP_CAT:{` |
|        - | 2529 | `	ph7_value *pNos,*pCur;` |
|   172929 | 2530 | `	if( pInstr->iP1 < 1 ){` |
|   144479 | 2531 | `		pNos = &pTos[-1];` |
|    72242 | 2532 | `	}else{` |
|    28455 | 2533 | `		pNos = &pTos[-pInstr->iP1+1];` |
|        - | 2534 | `	}` |
|        - | 2535 | `#ifdef UNTRUST` |
|        - | 2536 | `	if( pNos < pStack ){` |
|        - | 2537 | `		goto Abort;` |
...
|   172929 | 2541 | `	if( (pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|     1925 | 2542 | `		PH7_MemObjToString(pNos);` |
|      960 | 2543 | `	}` |
|   172929 | 2544 | `	pCur = &pNos[1];` |
|   349421 | 2545 | `	while( pCur <= pTos ){` |
|   176497 | 2546 | `		if( (pCur->iFlags & MEMOBJ_STRING) == 0 ){` |
|    52211 | 2547 | `			PH7_MemObjToString(pCur);` |
|    26103 | 2548 | `		}` |
|        - | 2549 | `		/* Perform the concatenation */` |
|   176497 | 2550 | `		if( SyBlobLength(&pCur->sBlob) > 0 ){` |
|   176349 | 2551 | `			if( PH7_MemObjStringAppend(pNos,(const char *)SyBlobData(&pCur->sBlob),SyBlobLength(&pCur->sBlob)) != SXRET_OK ){` |
|        - | 2552 | `				/* Allocation failure: raise a fatal instead of a truncated concat */` |
|      ! 0 | 2553 | `				PH7_VmMemoryError(&(*pVm));` |
|      ! 0 | 2554 | `				goto Abort;` |
|        - | 2555 | `			}` |
|    88172 | 2556 | `		}` |
|   176497 | 2557 | `		SyBlobRelease(&pCur->sBlob);` |
|   176497 | 2558 | `		pCur++;` |
|        5 | 2559 | `	}` |
|   172929 | 2560 | `	pTos = pNos;` |
|   172929 | 2561 | `	break;` |
|        - | 2562 | `				}` |
|        - | 2563 | `/*  CAT_STORE: * * *` |
|        - | 2564 | ` *` |
...
|        - | 2566 | ` * back.` |
|        - | 2567 | ` */` |
|    11817 | 2568 | `case PH7_OP_CAT_STORE:{` |
|    23639 | 2569 | `	ph7_value *pNos = &pTos[-1];` |
|        - | 2570 | `	ph7_value *pObj;` |
|        - | 2571 | `	sxu32 nIdx;` |
|        - | 2572 | `#ifdef UNTRUST` |
|        - | 2573 | `	if( pNos < pStack ){` |
...
|    23639 | 2578 | `	if((pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|       59 | 2579 | `		PH7_MemObjToString(pNos);` |
|       29 | 2580 | `	}` |
|    23639 | 2581 | `	nIdx = pTos->nIdx;` |
...
|    23634 | 2593 | `	if( nIdx != SXU32_HIGH` |
|    23634 | 2594 | `	 && nIdx != pNos->nIdx` |
|    23630 | 2595 | `	 && (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx)) != 0` |
|    23631 | 2596 | `	 && (SyHashTotalEntry(&pVm->hTypedSlot) == 0` |
|    14413 | 2597 | `	     \|\| SyHashGet(&pVm->hTypedSlot,(const void *)&nIdx,sizeof(sxu32)) == 0) ){` |
|    23625 | 2598 | `		if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - | 2599 | `			/* e.g. $x = 5; $x .= "a";  ->  "5a" */` |
|        6 | 2600 | `			PH7_MemObjToString(pObj);` |
|        2 | 2601 | `		}` |
|    23625 | 2602 | `		if( SyBlobLength(&pNos->sBlob) > 0 ){` |
|    23621 | 2603 | `			if( PH7_MemObjStringAppend(pObj,(const char *)SyBlobData(&pNos->sBlob),SyBlobLength(&pNos->sBlob)) != SXRET_OK ){` |
...
|    23625 | 2622 | `		if( (pInstr+1)->iOp != PH7_OP_POP ){` |
...
|    23625 | 2627 | `		PH7_HOOK_RMW_WRITEBACK(nIdx,0);` |
|    23625 | 2628 | `		pNos->nIdx = SXU32_HIGH;` |
|    23625 | 2629 | `		VmPopOperand(&pTos,1);` |
|    23632 | 2630 | `		break;` |
|        - | 2631 | `	}` |
...
|        - | 2668 | ` * stack.` |
|        - | 2669 | ` */` |
|   114017 | 2670 | `case PH7_OP_LAND:` |
|        - | 2671 | `case PH7_OP_LOR: {` |
|        - | 2672 | `	VmOpRc rcOp;` |
|   228247 | 2673 | `	sState.pTos = pTos;` |
|   228247 | 2674 | `	sState.pc = pc;` |
|   228247 | 2675 | `	rcOp = VmExecOpLor(&(*pVm),&sState,pInstr);` |
|   228247 | 2676 | `	pTos = sState.pTos;` |
|   228247 | 2677 | `	pc = sState.pc;` |
|   228247 | 2678 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2679 | `		goto Abort;` |
|   228247 | 2680 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2917 | ` */` |
|   228131 | 2918 | `case PH7_OP_TEQ: {` |
|        - | 2919 | `	VmOpRc rcOp;` |
|   456475 | 2920 | `	sState.pTos = pTos;` |
|   456475 | 2921 | `	sState.pc = pc;` |
|   456475 | 2922 | `	rcOp = VmExecOpTeq(&(*pVm),&sState,pInstr);` |
|   456475 | 2923 | `	pTos = sState.pTos;` |
|   456475 | 2924 | `	pc = sState.pc;` |
|   456475 | 2925 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2926 | `		goto Abort;` |
|   456475 | 2927 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2939 | ` *` |
|        - | 2940 | ` */` |
|   174496 | 2941 | `case PH7_OP_TNE: {` |
|        - | 2942 | `	VmOpRc rcOp;` |
|   349205 | 2943 | `	sState.pTos = pTos;` |
|   349205 | 2944 | `	sState.pc = pc;` |
|   349205 | 2945 | `	rcOp = VmExecOpTne(&(*pVm),&sState,pInstr);` |
|   349205 | 2946 | `	pTos = sState.pTos;` |
|   349205 | 2947 | `	pc = sState.pc;` |
|   349205 | 2948 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2949 | `		goto Abort;` |
|   349205 | 2950 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2971 | ` *` |
|        - | 2972 | ` */` |
|   145899 | 2973 | `case PH7_OP_LT:` |
|        - | 2974 | `case PH7_OP_LE: {` |
|        - | 2975 | `	VmOpRc rcOp;` |
|   292219 | 2976 | `	sState.pTos = pTos;` |
|   292219 | 2977 | `	sState.pc = pc;` |
|   292219 | 2978 | `	rcOp = VmExecOpLe(&(*pVm),&sState,pInstr);` |
|   292219 | 2979 | `	pTos = sState.pTos;` |
|   292219 | 2980 | `	pc = sState.pc;` |
|   292219 | 2981 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2982 | `		goto Abort;` |
|   292219 | 2983 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3004 | ` *` |
|        - | 3005 | ` */` |
|    85883 | 3006 | `case PH7_OP_GT:` |
|        - | 3007 | `case PH7_OP_GE: {` |
|        - | 3008 | `	VmOpRc rcOp;` |
|   171979 | 3009 | `	sState.pTos = pTos;` |
|   171979 | 3010 | `	sState.pc = pc;` |
|   171979 | 3011 | `	rcOp = VmExecOpGe(&(*pVm),&sState,pInstr);` |
|   171979 | 3012 | `	pTos = sState.pTos;` |
|   171979 | 3013 | `	pc = sState.pc;` |
|   171979 | 3014 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 3015 | `		goto Abort;` |
|   171979 | 3016 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3113 | ` */` |
|     1362 | 3114 | `case PH7_OP_LOAD_EXCEPTION: {` |
|        - | 3115 | `	VmOpRc rcOp;` |
|     2729 | 3116 | `	sState.pTos = pTos;` |
|     2729 | 3117 | `	sState.pc = pc;` |
|     2729 | 3118 | `	rcOp = VmExecOpLoadException(&(*pVm),&sState,pInstr);` |
|     2729 | 3119 | `	pTos = sState.pTos;` |
|     2729 | 3120 | `	pc = sState.pc;` |
|     2729 | 3121 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 3122 | `		goto Abort;` |
|     2729 | 3123 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3131 | ` */` |
|     1195 | 3132 | `case PH7_OP_POP_EXCEPTION: {` |
|     2395 | 3133 | `	ph7_exception *pCompiledExc = (ph7_exception *)pInstr->p3;` |
...
|     2395 | 3138 | `	ph7_exception *pException = 0;` |
|     2395 | 3139 | `	if( SySetUsed(&pVm->aException) > 0 ){` |
...
|      193 | 3153 | `		}` |
|      200 | 3154 | `	}` |
|     2395 | 3155 | `	if( pCompiledExc->iInlined ){` |
...
|     2241 | 3182 | `	if( pVm->pFrame->iFlags & VM_FRAME_EXCEPTION ){` |
|     1631 | 3183 | `		VmLeaveFrame(&(*pVm));` |
|      813 | 3184 | `	}` |
...
|     2241 | 3188 | `	if( pException && pCompiledExc->iHasFinally && !pException->iFinallyDone ){` |
...
|        - | 3206 | `		}` |
|       12 | 3207 | `	}` |
|     2237 | 3208 | `	VmExcRelease(&(*pVm),pException); /* no-finally / already-done paths (may be NULL) */` |
|     2237 | 3209 | `	if( VmSkipExceptionFrames(pVm->pFrame)->bHasRet ){` |
...
|        - | 3390 | ` */` |
|    12020 | 3391 | `case PH7_OP_FOREACH_INIT: {` |
|        - | 3392 | `	VmOpRc rcOp;` |
|    24045 | 3393 | `	sState.pTos = pTos;` |
|    24045 | 3394 | `	sState.pc = pc;` |
|    24045 | 3395 | `	rcOp = VmExecOpForeachInit(&(*pVm),&sState,pInstr);` |
|    24045 | 3396 | `	pTos = sState.pTos;` |
|    24045 | 3397 | `	pc = sState.pc;` |
|    24045 | 3398 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 3399 | `		goto Abort;` |
|    24045 | 3400 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3408 | ` */` |
|   130399 | 3409 | `case PH7_OP_FOREACH_STEP: {` |
|        - | 3410 | `	VmOpRc rcOp;` |
|   260803 | 3411 | `	sState.pTos = pTos;` |
|   260803 | 3412 | `	sState.pc = pc;` |
|   260803 | 3413 | `	rcOp = VmExecOpForeachStep(&(*pVm),&sState,pInstr);` |
|   260803 | 3414 | `	pTos = sState.pTos;` |
|   260803 | 3415 | `	pc = sState.pc;` |
|   260803 | 3416 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 3417 | `		goto Abort;` |
|   260801 | 3418 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3426 | ` */` |
|    22421 | 3427 | `case PH7_OP_MEMBER: {` |
|        - | 3428 | `	VmOpRc rcOp;` |
|    44847 | 3429 | `	sState.pTos = pTos;` |
|    44847 | 3430 | `	sState.pc = pc;` |
|    44847 | 3431 | `	rcOp = VmExecOpMember(&(*pVm),&sState,pInstr);` |
|    44847 | 3432 | `	pTos = sState.pTos;` |
|    44847 | 3433 | `	pc = sState.pc;` |
|    44847 | 3434 | `	if( rcOp == VM_OP_ABORT ){` |
|        8 | 3435 | `		goto Abort;` |
|    44841 | 3436 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|  1041232 | 3831 | `	sxi32 nCallArgs = pInstr->iP1 + (pInstr->iP2 ? VmSpreadOwnExtra(pVm,pInstr->iP1,pTos) : 0);` |
|        - | 3832 | `	ph7_value *pArg;` |
|  1041232 | 3833 | `	pArg = &pTos[-nCallArgs];` |
...
|  1041232 | 3842 | `	VmCallArgMap *pEffCallMap = (VmCallArgMap *)pInstr->p3;` |
...
|  1041232 | 3849 | `	if( VmValueIsClosure(pVm,pTos) ){` |
...
|  1041232 | 3859 | `	if( (pTos->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|      142 | 4054 | `		break;` |
|        - | 4055 | `	}` |
|  1041072 | 4056 | `	SyStringInitFromBuf(&sName,SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
...
|  1041072 | 4060 | `	if( sName.nByte > 0 && sName.zString[0] == '\\' ){` |
...
|  1041072 | 4067 | `	pEntry = SyHashGet(&pVm->hFunction,(const void *)sName.zString,sName.nByte);` |
...
|        - | 4073 | `	{` |
|  1041072 | 4074 | `	VmCallArgMap *pCallMap = pEffCallMap;` |
|  1041072 | 4075 | `	if( pEntry == 0 && pCallMap && pCallMap->bIsNamespaced ){` |
...
|        - | 4106 | `		VmSlot sArg;` |
|        - | 4107 | `		sxu32 n;` |
|   105451 | 4108 | `		int bClosureThis = 0;` |
|   105451 | 4109 | `		ph7_class *pClosureScope = 0;` |
|        - | 4110 | `		/* initialize fields */` |
|   105451 | 4111 | `		pVmFunc = (ph7_vm_func *)pEntry->pUserData;` |
|   105451 | 4112 | `		pThis = 0;` |
|   105451 | 4113 | `		pSelf = 0;` |
...
|       14 | 4128 | `		}` |
|   105451 | 4129 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
|        - | 4130 | `			ph7_class_method *pMeth;` |
|        - | 4131 | `			/* Class method call */` |
|    25573 | 4132 | `			ph7_value *pTarget = &pTos[-1];` |
|    25573 | 4133 | `			if( pTarget >= pStack && (pTarget->iFlags & (MEMOBJ_STRING\|MEMOBJ_OBJ\|MEMOBJ_NULL)) ){` |
|        - | 4134 | `				/* Extract the 'this' pointer */` |
|    25573 | 4135 | `				if(pTarget->iFlags & MEMOBJ_OBJ ){` |
|        - | 4136 | `					/* Instance already loaded */` |
|    24537 | 4137 | `					pThis = (ph7_class_instance *)pTarget->x.pOther;` |
|    24537 | 4138 | `					pThis->iRef++;` |
|    24537 | 4139 | `					pSelf = pThis->pClass;` |
|    12266 | 4140 | `				}` |
|    25573 | 4141 | `				if( pSelf == 0 ){` |
...
|      353 | 4160 | `					}` |
|      518 | 4161 | `				}` |
|    25573 | 4162 | `				VmPopOperand(&pTos,1);` |
|    25573 | 4163 | `				PH7_MemObjRelease(pTos);` |
...
|    25573 | 4170 | `				nCallArgs = pInstr->iP1 + (pInstr->iP2 ? VmSpreadOwnExtra(&(*pVm),pInstr->iP1,pTos) : 0);` |
|    25573 | 4171 | `				pArg = &pTos[-nCallArgs];` |
...
|        - | 4176 | `				 */` |
|    25573 | 4177 | `				while( pArg < pStack ){` |
|      ! 0 | 4178 | `					pArg++;` |
|      ! 0 | 4179 | `				}` |
|    25573 | 4180 | `				if( pSelf && pVm->bReflectBypass ){` |
...
|        6 | 4185 | `				}else` |
|    25563 | 4186 | `				if( pSelf ){ /* Paranoid edition */` |
...
|    25563 | 4194 | `					ph7_class *pDeclClass = pVmFunc->pUserData ? (ph7_class *)pVmFunc->pUserData : pSelf;` |
|    25563 | 4195 | `					pMeth = PH7_ClassExtractMethod(pDeclClass,pVmFunc->sName.zString,pVmFunc->sName.nByte);` |
|    25563 | 4196 | `					if( pMeth == 0 && pDeclClass != pSelf ){` |
|      ! 0 | 4197 | `						pMeth = PH7_ClassExtractMethod(pSelf,pVmFunc->sName.zString,pVmFunc->sName.nByte);` |
|      ! 0 | 4198 | `					}` |
|    25563 | 4199 | `					if( pMeth && pMeth->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|   158278 | 4236 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   105446 | 4237 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
...
|   105451 | 4244 | `		if( VmRecursionExceeded(pVm) ){` |
...
|        3 | 4248 | `			goto Abort;` |
|        - | 4249 | `		}` |
|   105449 | 4250 | `		if( pVmFunc->pNextName ){` |
...
|   105449 | 4262 | `		pSelfHint = pSelf;` |
|   105449 | 4263 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
|    25573 | 4264 | `			ph7_class *pDecl = (ph7_class *)pVmFunc->pUserData;` |
|    25573 | 4265 | `			if( pDecl && (pDecl->iFlags & PH7_CLASS_TRAIT) == 0 ){` |
|    24547 | 4266 | `				pSelfHint = pDecl;` |
|    12271 | 4267 | `			}` |
|    12784 | 4268 | `		}` |
|   105449 | 4269 | `		if( pSelf == 0 && (pVmFunc->iFlags & VM_FUNC_CLOSURE) ){` |
...
|       29 | 4280 | `			}` |
|      887 | 4281 | `		}` |
|   105449 | 4282 | `		if( SySetUsed(&pVmFunc->aAttrs) > 0 ){` |
...
|       56 | 4287 | `		}` |
|   105449 | 4288 | `		if( pVmFunc->iFlags & VM_FUNC_GENERATOR ){` |
...
|   105109 | 4520 | `		aFormalArg = (ph7_vm_func_arg *)SySetBasePtr(&pVmFunc->aArgs);` |
|        - | 4521 | `		/* Create a new VM frame  */` |
|   105109 | 4522 | `		rc = VmEnterFrame(&(*pVm),pVmFunc,pThis,&pFrame);` |
|   105109 | 4523 | `		if( rc != SXRET_OK ){` |
...
|   105109 | 4551 | `		pFrame->nActualArgs = (int)(pTos - pArg);` |
|   105109 | 4552 | `		if( pThis && ((pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) \|\| bClosureThis) ){` |
...
|    24721 | 4555 | `			pObj = VmExtractMemObj(&(*pVm),&sThis,FALSE,TRUE);` |
|    24721 | 4556 | `			if( pObj ){` |
|        - | 4557 | `				/* Reflect the change */` |
|    24721 | 4558 | `				pObj->x.pOther = pThis;` |
|    24721 | 4559 | `				MemObjSetType(pObj,MEMOBJ_OBJ);` |
|    12358 | 4560 | `			}` |
|    12358 | 4561 | `		}` |
|   105109 | 4562 | `		if( SySetUsed(&pVmFunc->aStatic) > 0 ){` |
...
|        - | 4589 | `		{` |
|   105109 | 4590 | `		VmCallArgMap *pCallMap3 = pEffCallMap;` |
|        - | 4591 | `		/* Caller file's strict_types mode — governs parameter coercion` |
|        - | 4592 | `		 * (but NOT return coercion, which uses the callee's file). */` |
|   105109 | 4593 | `		int bCallIsStrict = (pCallMap3 && pCallMap3->bStrict) ? 1 : 0;` |
|   105109 | 4594 | `		if( pCallMap3 && pCallMap3->bHasNamed ){` |
|        - | 4595 | `			/* ============================================================` |
...
|        - | 4980 | `		 * ============================================================ */` |
|   104841 | 4981 | `		n = 0;` |
|   266073 | 4982 | `		while( pArg < pTos ){` |
|   161537 | 4983 | `			if( n < SySetUsed(&pVmFunc->aArgs) && (aFormalArg[n].iFlags & VM_FUNC_ARG_VARIADIC) ){` |
...
|        - | 5083 | `			}` |
|   161337 | 5084 | `			if( n < SySetUsed(&pVmFunc->aArgs) ){` |
...
|   160831 | 5091 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_UNION ){` |
...
|   160744 | 5124 | `				if( aFormalArg[n].nType > 0` |
|    87607 | 5125 | `					&& !((aFormalArg[n].iFlags & VM_FUNC_ARG_NULLABLE) && (pArg->iFlags & MEMOBJ_NULL)) ){` |
...
|       13 | 5201 | `					}` |
|     6967 | 5202 | `				}` |
|   160733 | 5203 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_BY_REF ){` |
...
|   160493 | 5255 | `					pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|        - | 5256 | `				}` |
|    80576 | 5257 | `			}else{` |
|        - | 5258 | `				char zName[32];` |
...
|        - | 5265 | `			}` |
|   161237 | 5266 | `			if( pObj ){` |
|   161001 | 5267 | `				PH7_MemObjStore(pArg,pObj);` |
|        - | 5268 | `				/* Insert argument index  */` |
|   161001 | 5269 | `				sArg.nIdx = pObj->nIdx;` |
|   161001 | 5270 | `				sArg.pUserData = 0;` |
|   161001 | 5271 | `				SySetPut(&pFrame->sArg,(const void *)&sArg);` |
|    80706 | 5272 | `			}` |
|   161237 | 5273 | `			PH7_MemObjRelease(pArg);` |
|   161237 | 5274 | `			pArg++;` |
|   161237 | 5275 | `			++n;` |
|        5 | 5276 | `		}` |
|        - | 5277 | `		} /* end named vs positional branch */` |
|        - | 5278 | `		/* Set up closure environment */` |
|   104987 | 5279 | `		if( pVmFunc->iFlags & VM_FUNC_CLOSURE ){` |
...
|   104982 | 5327 | `		if( n < SySetUsed(&pVmFunc->aArgs)` |
|    55169 | 5328 | `		 && (pVmFunc->iFlags & (VM_FUNC_INTERNAL\|VM_FUNC_CLASS_METHOD)) != VM_FUNC_INTERNAL ){` |
|        - | 5329 | `			sxu32 nNonVar,nReq;` |
|     3893 | 5330 | `			nReq = VmFuncRequiredArgCount(pVmFunc,&nNonVar);` |
|     3893 | 5331 | `			if( n < nReq ){` |
...
|   112951 | 5351 | `		while( n < SySetUsed(&pVmFunc->aArgs) ){` |
|     8235 | 5352 | `			if( aFormalArg[n].iFlags & VM_FUNC_ARG_VARIADIC ){` |
...
|        - | 5363 | `			}` |
|     7991 | 5364 | `			if( SySetUsed(&aFormalArg[n].aByteCode) > 0 ){` |
|     7989 | 5365 | `				pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|     7989 | 5366 | `				if( pObj ){` |
|        - | 5367 | `					/* Evaluate the default value and extract it's result */` |
|     7989 | 5368 | `					rc = VmLocalExec(&(*pVm),&aFormalArg[n].aByteCode,pObj,FALSE);` |
|     7989 | 5369 | `					if( rc == PH7_ABORT ){` |
|      ! 0 | 5370 | `						goto Abort;` |
|        - | 5371 | `					}` |
|        - | 5372 | `					/* Insert argument index */` |
|     7989 | 5373 | `					sArg.nIdx = pObj->nIdx;` |
|     7989 | 5374 | `					sArg.pUserData = 0;` |
|     7989 | 5375 | `					SySetPut(&pFrame->sArg,(const void *)&sArg);` |
...
|     7984 | 5380 | `					if( aFormalArg[n].nType > 0 && aFormalArg[n].nType != MEMOBJ_OBJ` |
|     3904 | 5381 | `						&& ((pObj->iFlags & aFormalArg[n].nType) == 0)` |
|     1958 | 5382 | `						&& !((aFormalArg[n].iFlags & VM_FUNC_ARG_NULLABLE) && (pObj->iFlags & MEMOBJ_NULL)) ){` |
...
|        - | 5394 | `		 */` |
|   104965 | 5395 | `		PH7_MemObjRelease(pTos);` |
|   104965 | 5396 | `		pTos = &pTos[-nCallArgs];` |
...
|        - | 5408 | `		 * per function. */` |
|        - | 5409 | `		{` |
|   104965 | 5410 | `			sxu32 nSlots = pVmFunc->nMaxStack;` |
|   104965 | 5411 | `			if( nSlots == 0 ){` |
...
|     4118 | 5418 | `			}` |
|   104965 | 5419 | `			pFrameStack = VmOperandStackAlloc(&(*pVm),nSlots);` |
|        - | 5420 | `		}` |
|   104965 | 5421 | `		if( pFrameStack == 0 ){` |
...
|      ! 0 | 5428 | `			break;` |
|        - | 5429 | `		}` |
|    52376 | 5430 | `SkipFuncBody:` |
|   105099 | 5431 | `		if( pSelf ){` |
|        - | 5432 | `			/* Push class name */` |
|    25627 | 5433 | `			SySetPut(&pVm->aSelf,(const void *)&pSelf);` |
|    12811 | 5434 | `		}` |
|        - | 5435 | `		/* Increment nesting level */` |
|   105099 | 5436 | `		pVm->nRecursionDepth++;` |
|   105099 | 5437 | `		if( rc == PH7_EXCEPTION ){` |
...
|   104965 | 5466 | `			VmCallFrame *pRec = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   104965 | 5467 | `			if( pRec ){` |
|   102333 | 5468 | `				pVm->pIdleCallFrames = (void *)pRec->pPrev;` |
|    51273 | 5469 | `			}else{` |
|     2637 | 5470 | `				pRec = (VmCallFrame *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmCallFrame));` |
|        - | 5471 | `			}` |
|   104965 | 5472 | `			if( pRec == 0 ){` |
...
|      ! 0 | 5483 | `				goto Abort;` |
|        - | 5484 | `			}` |
|   104965 | 5485 | `			sState.pTos = pTos;` |
|   104965 | 5486 | `			sState.pc = pc;` |
|   104965 | 5487 | `			pRec->sCaller = sState;` |
|   104965 | 5488 | `			pRec->sCall.pVmFunc = pVmFunc;` |
|   104965 | 5489 | `			pRec->sCall.pFrame = pFrame;` |
|   104965 | 5490 | `			pRec->sCall.pFrameStack = pFrameStack;` |
|   104965 | 5491 | `			pRec->sCall.nStackCap = pVmFunc->nMaxStack + VM_STACK_GUARD;` |
|   104965 | 5492 | `			pRec->sCall.nLastRef = SXU32_HIGH;` |
|   104965 | 5493 | `			pRec->sCall.bSelfPushed = (sxu8)(pSelf ? 1 : 0);` |
|   104965 | 5494 | `			pRec->pPrev = pCallTop;` |
|   104965 | 5495 | `			pCallTop = pRec;` |
|        - | 5496 | `			/* Switch to the callee activation (what the recursive` |
|        - | 5497 | `			 * VmByteCodeExec entry used to set up). */` |
|   104965 | 5498 | `			aInstr = (VmInstr *)SySetBasePtr(&pVmFunc->aByteCode);` |
|   104965 | 5499 | `			pStack = pFrameStack;` |
|   104965 | 5500 | `			pTos = &pStack[-1];` |
|   104965 | 5501 | `			pc = 0;` |
|   104965 | 5502 | `			sState.aInstr = aInstr;` |
|   104965 | 5503 | `			sState.pStack = pStack;` |
|   104965 | 5504 | `			sState.nStackCap = pRec->sCall.nStackCap; /* callee's operand-stack capacity for OP_SPREAD growth */` |
|   104965 | 5505 | `			sState.nStackOrig = pRec->sCall.nStackCap; /* fixed headroom reference (never grows) */` |
|   104965 | 5506 | `			sState.pTos = pTos;` |
|   104965 | 5507 | `			sState.pc = 0;` |
|   104965 | 5508 | `			sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|   104965 | 5509 | `			sState.pEntryFrame = pVm->pFrame;` |
|   104965 | 5510 | `			sState.pResult = pRec->sCaller.pTos;` |
|   104965 | 5511 | `			sState.pLastRef = &pRec->sCall.nLastRef;` |
|   104965 | 5512 | `			sState.pEnforceRetFunc = VmFuncHasReturnType(pVmFunc) ? pVmFunc : 0;` |
|   104965 | 5513 | `			sState.is_callback = 0;` |
|   104965 | 5514 | `			sState.bReturnPropagates = 0;` |
|   104965 | 5515 | `			goto VmLoopFetch;` |
|        - | 5516 | `		}` |
|       57 | 5517 | `	}else{` |
...
|   935626 | 5526 | `		pEntry = SyHashGet(&pVm->hHostFunction,(const void *)sName.zString,sName.nByte);` |
|        - | 5527 | `		{` |
|   935626 | 5528 | `		VmCallArgMap *pCallMap2 = pEffCallMap;` |
|   935626 | 5529 | `		if( pEntry == 0 && pCallMap2 && pCallMap2->bIsNamespaced ){` |
...
|        - | 5634 | `			}` |
|        - | 5635 | `		}` |
|   935610 | 5636 | `		pFunc = (ph7_user_func *)pEntry->pUserData;` |
...
|  1403781 | 5641 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   935605 | 5642 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
|        - | 5643 | `		/* Start collecting function arguments */` |
|   935610 | 5644 | `		SySetReset(&aArg);` |
|  2527935 | 5645 | `		while( pArg < pTos ){` |
|  1592330 | 5646 | `			SySetPut(&aArg,(const void *)&pArg);` |
|  1592330 | 5647 | `			pArg++;` |
|        5 | 5648 | `		}` |
|        - | 5649 | `		/* Assume a null return value */` |
|   935610 | 5650 | `		PH7_MemObjInit(&(*pVm),&sRet);` |
|        - | 5651 | `		/* Init the call context */` |
|   935610 | 5652 | `		VmInitCallContext(&sCtx,&(*pVm),pFunc,&sRet,0);` |
...
|   935610 | 5659 | `		sCtx.pArgMap = pEffCallMap;` |
|        - | 5660 | `		{` |
|   935610 | 5661 | `		int nGiven = (int)SySetUsed(&aArg);` |
...
|   935610 | 5667 | `		if( pFunc->nMinArg > 0 && nGiven < pFunc->nMinArg ){` |
...
|      232 | 5674 | `				nGiven);` |
|   935378 | 5675 | `		}else if( pFunc->bHasMaxArg && nGiven > (int)pFunc->nMaxArg ){` |
...
|       40 | 5688 | `				nGiven);` |
|  1403005 | 5689 | `		}else if( SXRET_OK != (rc = VmEnforceBuiltinArgTypes(&sCtx,pFunc,nGiven,` |
|   935061 | 5690 | `			(ph7_value **)SySetBasePtr(&aArg))) ){` |
|        - | 5691 | `			/* TypeError thrown: rc carries the caught/uncaught status */` |
|       91 | 5692 | `		}else{` |
|        - | 5693 | `			/* Call the foreign function */` |
|   934894 | 5694 | `			rc = pFunc->xFunc(&sCtx,nGiven,(ph7_value **)SySetBasePtr(&aArg));` |
|        - | 5695 | `		}` |
|        - | 5696 | `		}` |
|        - | 5697 | `		/* Release the call context */` |
|   935610 | 5698 | `		VmReleaseCallContext(&sCtx);` |
|   935610 | 5699 | `		if( rc == PH7_ABORT ){` |
...
|      576 | 5704 | `			goto Abort;` |
|        - | 5705 | `		}` |
|   935038 | 5706 | `		if( rc != PH7_SUSPEND && pVm->pInlineInstr == (void *)aInstr ){` |
...
|      ! 0 | 5719 | `		}` |
|   935034 | 5720 | `		if( rc == PH7_EXCEPTION ){` |
...
|      997 | 5728 | `			if( !VmRecordedResume(pVm,&iResumePc,sState.pEntryFrame,aInstr) ){` |
...
|      798 | 5734 | `			PH7_MemObjRelease(&sRet);` |
|      798 | 5735 | `			if( nCallArgs > 0 ){` |
|      508 | 5736 | `				VmPopOperand(&pTos,nCallArgs); /* spread-adjusted; see the normal-return path */` |
|      252 | 5737 | `			}` |
|      798 | 5738 | `			VmPopOperand(&pTos,1);` |
|      798 | 5739 | `			pc = iResumePc;` |
|      798 | 5740 | `			break;` |
|        - | 5741 | `		}` |
|   934042 | 5742 | `		if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|   912678 | 5766 | `			VmPopOperand(&pTos,nCallArgs);` |
|   456705 | 5767 | `		}` |
|        - | 5768 | `		/* Save foreign function return value into the (now top) function-name slot */` |
|   933688 | 5769 | `		PH7_MemObjStore(&sRet,pTos);` |
|   933688 | 5770 | `		PH7_MemObjRelease(&sRet);` |
|        - | 5771 | `	}` |
|   933792 | 5772 | `	break;` |
|        - | 5773 | `				  }` |
|        - | 5774 | `/*` |
...
|        - | 5777 | ` */` |
|    25856 | 5778 | `case PH7_OP_CONSUME: {` |
|        - | 5779 | `	VmOpRc rcOp;` |
|    51717 | 5780 | `	sState.pTos = pTos;` |
|    51717 | 5781 | `	sState.pc = pc;` |
|    51717 | 5782 | `	rcOp = VmExecOpConsume(&(*pVm),&sState,pInstr);` |
|    51717 | 5783 | `	pTos = sState.pTos;` |
|    51717 | 5784 | `	pc = sState.pc;` |
|    51717 | 5785 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 5786 | `		goto Abort;` |
|    51717 | 5787 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 5792 |  |
|        - | 5793 | `		} /* Switch() */` |
| 16444015 | 5794 | `		pc++; /* Next instruction in the stream */` |
|        5 | 5795 | `	} /* For(;;) */` |
|   128909 | 5796 | `Done:` |
...
|   258031 | 5800 | `	rc = SXRET_OK;` |
|   258031 | 5801 | `	goto Unwind;` |
|      823 | 5802 | `Suspend:` |
...
|   130915 | 5860 | `	for(;;){` |
|   261627 | 5861 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|      ! 0 | 5869 | `			}` |
|     1152 | 5870 | `		}` |
|   261627 | 5871 | `		if( pCallTop == 0 ){` |
|   157077 | 5872 | `			return VmExecFinalize(&(*pVm),&sState,&aArg,pTos,rc);` |
|        - | 5873 | `		}` |
|   104555 | 5874 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|      627 | 5880 | `		}` |
|        - | 5881 | `		{` |
|   104555 | 5882 | `			VmCallFrame *pRec = pCallTop;` |
|   104555 | 5883 | `			sState = pRec->sCaller;` |
|   104555 | 5884 | `			rc = VmCallFinish(&(*pVm),&sState,&pRec->sCall,rc);` |
|   104555 | 5885 | `			pCallTop = pRec->pPrev;` |
|   104555 | 5886 | `			pRec->pPrev = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   104555 | 5887 | `			pVm->pIdleCallFrames = (void *)pRec;` |
|   104555 | 5888 | `			aInstr = sState.aInstr;` |
|   104555 | 5889 | `			pStack = sState.pStack;` |
|   104555 | 5890 | `			pTos = sState.pTos;` |
|   104555 | 5891 | `			pc = sState.pc;` |
|        - | 5892 | `		}` |
|   104555 | 5893 | `		if( rc == PH7_OK ){` |
|   103789 | 5894 | `			pc++; /* the loop-bottom increment this OP_CALL missed */` |
|   103789 | 5895 | `			goto VmLoopFetch;` |
|        - | 5896 | `		}` |
|        5 | 5897 | `	}` |
|    78718 | 5898 | `}` |
|        - | 5899 |  |
