...
|        - |  162 | ` */` |
|   161070 |  163 | `static sxi32 VmExecFinalize(ph7_vm *pVm,VmExecState *pState,SySet *pArg,ph7_value *pTos,sxi32 rcTerm)` |
|        5 |  164 | `{` |
|    80535 |  165 | `	SXUNUSED(pVm);` |
|   161075 |  166 | `	if( rcTerm != PH7_SUSPEND && !pState->bReturnPropagates ){` |
|   157365 |  167 | `		VmClearFrameReturn(pState->pEntryFrame);` |
|    78680 |  168 | `	}` |
|   161075 |  169 | `	SySetRelease(pArg);` |
|   161075 |  170 | `	if( rcTerm == PH7_ABORT \|\| rcTerm == PH7_EXCEPTION ){` |
|     2841 |  171 | `		while( pTos >= pState->pStack ){` |
|     1789 |  172 | `			PH7_MemObjRelease(pTos);` |
|     1789 |  173 | `			pTos--;` |
|        5 |  174 | `		}` |
|      526 |  175 | `	}` |
|   161075 |  176 | `	return rcTerm;` |
|        5 |  177 | `}` |
|        - |  178 | `/*` |
...
|        - |  189 | ` */` |
|   105965 |  190 | `static sxi32 VmCallFinish(ph7_vm *pVm,VmExecState *pCaller,VmCallRecord *pCallee,sxi32 rc)` |
|        5 |  191 | `{` |
|        - |  192 | `	ph7_value *pObj;` |
|        - |  193 | `	/* Decrement nesting level */` |
|   105970 |  194 | `	pVm->nRecursionDepth--;` |
|   105970 |  195 | `	if( pCallee->bSelfPushed ){` |
|        - |  196 | `		/* Pop class name */` |
|    25553 |  197 | `		(void)SySetPop(&pVm->aSelf);` |
|    12774 |  198 | `	}` |
|   105970 |  199 | `	if( (pCallee->pVmFunc->iFlags & VM_FUNC_REF_RETURN) && rc == SXRET_OK ){` |
...
|       25 |  225 | `	}` |
|   105970 |  226 | `	if( rc != PH7_ABORT && ((pCallee->pFrame->iFlags & VM_FRAME_THROW) \|\| rc == PH7_EXCEPTION) ){` |
...
|   105970 |  272 | `	if( rc != PH7_SUSPEND && pCallee->pFrameStack ){` |
...
|   105836 |  276 | `		VmOperandStackRecycle(pVm,pCallee->pFrameStack,pCallee->nStackCap);` |
|    53020 |  277 | `	}` |
|        - |  278 | `	/* Leave the frame */` |
|   105970 |  279 | `	VmLeaveFrame(&(*pVm));` |
|   105970 |  280 | `	if( rc == PH7_ABORT ){` |
|      336 |  281 | `		return PH7_ABORT;` |
|        - |  282 | `	}` |
|   105638 |  283 | `	if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|        - |  291 | `	}` |
|   105638 |  292 | `	if( rc == PH7_EXCEPTION ){` |
|      469 |  293 | `		return PH7_EXCEPTION;` |
|        - |  294 | `	}` |
|   105174 |  295 | `	return PH7_OK;` |
|    53092 |  296 | `}` |
|        - |  297 | `/*` |
...
|        - |  330 | ` * nesting.` |
|        - |  331 | ` */` |
|   161428 |  332 | `PH7_PRIVATE sxi32 VmByteCodeExec(` |
...
|   161433 |  352 | `	if( VmNativeNestingExceeded(pVm) ){` |
...
|   161429 |  362 | `	nSavedBrc = pVm->nBoundaryRc;` |
|   161429 |  363 | `	pVm->nBoundaryRc = 0;` |
...
|   161429 |  370 | `	nSavedLine = pVm->nCurLine;` |
|   161429 |  371 | `	pVm->nVmExecDepth++;` |
|   242141 |  372 | `	rc = VmByteCodeExecBody(&(*pVm),aInstr,pStack,nTos,pResult,pLastRef,is_callback,nPc,` |
|    80712 |  373 | `		pEnforceRetFunc,bReturnPropagates,pAdoptSegment,ppBaseOwner,pnBaseCap,nStackOrig);` |
|   161429 |  374 | `	pVm->nVmExecDepth--;` |
|   161429 |  375 | `	pVm->nCurLine = nSavedLine;` |
|   161429 |  376 | `	if( nSavedBrc != 0 && (nSavedBrc == PH7_ABORT \|\| pVm->nBoundaryRc == 0) ){` |
|       15 |  377 | `		pVm->nBoundaryRc = nSavedBrc;` |
|        6 |  378 | `	}` |
|   161429 |  379 | `	return rc;` |
|    80719 |  380 | `}` |
|   161424 |  381 | `static sxi32 VmByteCodeExecBody(` |
...
|        - |  399 | `	ph7_value *pTos;` |
|        - |  400 | `	SySet aArg;` |
|   161429 |  401 | `	VmCallFrame *pCallTop = 0; /* Top of this invocation's in-loop call-record` |
...
|        - |  409 | `	sxi32 pc;` |
|        - |  410 | `	sxi32 rc;` |
|   161429 |  411 | `	sState.aInstr = aInstr;` |
|   161429 |  412 | `	sState.pStack = pStack;` |
|   161429 |  413 | `	sState.nStackCap = pnBaseCap ? *pnBaseCap : 0; /* CURRENT capacity (grown on a coroutine resume) */` |
|   161429 |  414 | `	sState.nStackOrig = nStackOrig;                /* ORIGINAL capacity — fixed headroom reference */` |
|   161429 |  415 | `	sState.pResult = pResult;` |
|   161429 |  416 | `	sState.pLastRef = pLastRef;` |
|   161429 |  417 | `	sState.pEnforceRetFunc = pEnforceRetFunc;` |
|   161429 |  418 | `	sState.is_callback = (sxu8)(is_callback ? 1 : 0);` |
|   161429 |  419 | `	sState.bReturnPropagates = (sxu8)(bReturnPropagates ? 1 : 0);` |
|        - |  420 | `	/* Argument container */` |
|   161429 |  421 | `	SySetInit(&aArg,&pVm->sAllocator,sizeof(ph7_value *));` |
|   161429 |  422 | `	if( nTos < 0 ){` |
|   145593 |  423 | `		pTos = &pStack[-1];` |
|    72799 |  424 | `	}else{` |
|    15841 |  425 | `		pTos = &pStack[nTos];` |
|        - |  426 | `	}` |
|   161429 |  427 | `	sState.pTos = pTos;` |
|   161429 |  428 | `	sState.pc = nPc;` |
...
|   161424 |  446 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->pFrame == pVm->pFrame` |
|     2816 |  447 | `	 && pStack == pVm->pActiveCtx->pStack ){` |
|     1805 |  448 | `		sState.nExceptionBase = pVm->pActiveCtx->nExceptionBase;` |
|      905 |  449 | `	}else{` |
|   159629 |  450 | `		sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|        - |  451 | `	}` |
|   161429 |  452 | `	sState.pEntryFrame = pVm->pFrame;` |
|   161429 |  453 | `	pc = nPc;` |
...
|   161424 |  506 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->pInjected` |
...
|   161414 |  567 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->bClosing` |
...
| 17252604 |  603 | `		if( pVm->nBoundaryRc != 0 \|\| SySetUsed(&pVm->aHookRmw) > 0 ){` |
...
| 17252504 |  658 | `		pInstr = &aInstr[pc];` |
| 17252504 |  659 | `		if( pInstr->nLine ){` |
...
| 17040270 |  663 | `			pVm->nCurLine = pInstr->nLine;` |
|  8526448 |  664 | `		}` |
| 17252504 |  665 | `		rc = SXRET_OK;` |
|        - |  666 | `/*` |
...
|        - |  672 | ` */` |
| 17252504 |  673 | `		switch(pInstr->iOp){` |
|        - |  674 | `/*` |
|        - |  675 | ` * DONE: P1 * *` |
|        - |  676 | ` *` |
...
|        - |  679 | ` */` |
|   131438 |  680 | `case PH7_OP_DONE:` |
|   263090 |  681 | `	if( pInstr->iP2 && sState.bReturnPropagates ){` |
...
|   262901 |  711 | `	if( sState.pEnforceRetFunc && VmFuncHasReturnType(sState.pEnforceRetFunc)` |
...
|     4591 |  736 | `	}` |
|   262882 |  737 | `	if( pInstr->iP1 && pTos >= pStack ){` |
|   158518 |  738 | `		if( sState.pLastRef ){` |
|    95440 |  739 | `			*sState.pLastRef = pTos->nIdx;` |
|    47822 |  740 | `		}` |
|   158518 |  741 | `		if( sState.pResult ){` |
|        - |  742 | `			/* Execution result */` |
|   151422 |  743 | `			PH7_MemObjStore(pTos,sState.pResult);` |
|    75813 |  744 | `		}` |
|   158518 |  745 | `		VmPopOperand(&pTos,1);` |
|   183730 |  746 | `	}else if( sState.pLastRef ){` |
...
|        - |  762 | `	 */` |
|   262882 |  763 | `	rc = VmDrainFinally(&(*pVm),sState.nExceptionBase);` |
|   262882 |  764 | `	if( rc == SXERR_ABORT ){` |
|      ! 0 |  765 | `		goto Abort;` |
|        - |  766 | `	}` |
|   262882 |  767 | `	if( rc == PH7_EXCEPTION ){` |
...
|        - |  778 | `	}` |
|   262878 |  779 | `	if( sState.pEntryFrame->bHasRet && !sState.bReturnPropagates ){` |
...
|        - |  835 | ` */` |
|   282560 |  836 | `case PH7_OP_JMP:` |
|   565334 |  837 | `	pc = pInstr->iP2 - 1;` |
|   565334 |  838 | `	break;` |
|        - |  839 | `/*` |
|        - |  840 | ` * JZ: P1 P2 *` |
|        - |  841 | ` *` |
...
|  1654338 |  852 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     1003 |  853 | `		PH7_MemObjToBool(pTos);` |
|      500 |  854 | `	}` |
|  1654338 |  855 | `	if( !pTos->x.iVal ){` |
|        - |  856 | `		/* Take the jump */` |
|   939111 |  857 | `		pc = pInstr->iP2 - 1;` |
|   469819 |  858 | `	}` |
|  1654338 |  859 | `	if( !pInstr->iP1 ){` |
|  1410116 |  860 | `		VmPopOperand(&pTos,1);` |
|   705635 |  861 | `	}` |
|  1654338 |  862 | `	break;` |
|        - |  863 | `/*` |
|        - |  864 | ` * JNZ: P1 P2 *` |
...
|   188810 |  876 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      ! 0 |  877 | `		PH7_MemObjToBool(pTos);` |
|      ! 0 |  878 | `	}` |
|   188810 |  879 | `	if( pTos->x.iVal ){` |
|        - |  880 | `		/* Take the jump */` |
|     9587 |  881 | `		pc = pInstr->iP2 - 1;` |
|     4791 |  882 | `	}` |
|   188810 |  883 | `	if( !pInstr->iP1 ){` |
...
|        - |  899 | ` */` |
|   690448 |  900 | `case PH7_OP_POP: {` |
|  1381946 |  901 | `	sxi32 n = pInstr->iP1;` |
|  1381946 |  902 | `	if( &pTos[-n+1] < pStack ){` |
|        - |  903 | `		/* TICKET 1433-51 Stack underflow must be handled at run-time */` |
|       79 |  904 | `		n = (sxi32)(pTos - pStack);` |
|       38 |  905 | `	}` |
|  1381946 |  906 | `	VmPopOperand(&pTos,n);` |
|  1381946 |  907 | `	break;` |
|        - |  908 | `				 }` |
|        - |  909 | `/*` |
|        - |  910 | ` * DUP: * * *` |
...
|        - |  929 | ` */` |
|    48862 |  930 | `case PH7_OP_NSSWITCH:` |
|    97729 |  931 | `	SyBlobReset(&pVm->sNamespace);` |
|    97729 |  932 | `	if( pInstr->p3 ){` |
|     3993 |  933 | `		const char *zNs = (const char *)pInstr->p3;` |
|     3993 |  934 | `		SyBlobAppend(&pVm->sNamespace,zNs,SyStrlen(zNs));` |
|     1994 |  935 | `	}` |
|        - |  936 | `	/* Clear namespace-scoped use-const imports */` |
|    97729 |  937 | `	SyHashRelease(&pVm->hUseConstImports);` |
|    97729 |  938 | `	SyHashInit(&pVm->hUseConstImports,&pVm->sAllocator,0,0);` |
|    97729 |  939 | `	break;` |
...
|     6757 | 1089 | `	break;` |
|        - | 1090 | `					  }` |
|    33273 | 1091 | `case PH7_OP_ERR_CTRL:` |
|        - | 1092 | `	/*` |
...
|        - | 1101 | `	 */` |
|    66551 | 1102 | `	if( pInstr->iP1 ){` |
|    33279 | 1103 | `		pVm->nErrSuppress++;` |
|    49914 | 1104 | `	}else if( pVm->nErrSuppress > 0 ){` |
|    33277 | 1105 | `		pVm->nErrSuppress--;` |
|    16636 | 1106 | `	}` |
|    66551 | 1107 | `	break;` |
|        - | 1108 | `/*` |
|        - | 1109 | ` * IS_A * * *` |
...
|        - | 1163 | ` */` |
|  1567420 | 1164 | `case PH7_OP_LOADC: {` |
|        - | 1165 | `	ph7_value *pObj;` |
|        - | 1166 | `	/* Reserve a room */` |
|  3136745 | 1167 | `	pTos++;` |
|  3136745 | 1168 | `	if( pInstr->iP1 & PH7_LOADC_NOKEY ){` |
...
|    19519 | 1174 | `		break;` |
|        - | 1175 | `	}` |
|  3117231 | 1176 | `	if( (pObj = (ph7_value *)SySetAt(&pVm->aLitObj,pInstr->iP2)) != 0 ){` |
|  3117231 | 1177 | `		if( (pInstr->iP1 & PH7_LOADC_EXPAND) && SyBlobLength(&pObj->sBlob) <= 64 ){` |
|        - | 1178 | `			SyHashEntry *pEntry;` |
|        - | 1179 | `			/* Check use const imports first — imports take precedence */` |
|        - | 1180 | `			{` |
|        - | 1181 | `				SyHashEntry *pConstImport;` |
|    34970 | 1182 | `				pConstImport = SyHashGet(&pVm->hUseConstImports,` |
|    23310 | 1183 | `					SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|    23315 | 1184 | `				if( pConstImport ){` |
...
|    23305 | 1199 | `			pEntry = SyHashGet(&pVm->hConstant,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|    23305 | 1200 | `			if( pEntry ){` |
|    23295 | 1201 | `				ph7_constant *pCons = (ph7_constant *)pEntry->pUserData;` |
|        - | 1202 | `				/* Set a NULL default value */` |
|    23295 | 1203 | `				MemObjSetType(pTos,MEMOBJ_NULL);` |
|    23295 | 1204 | `				SyBlobReset(&pTos->sBlob);` |
|        - | 1205 | `				/* Invoke the callback and deal with the expanded value */` |
|    23295 | 1206 | `				VmExpandConstantWithNotice(&(*pVm),pCons,pTos);` |
|        - | 1207 | `				/* Mark as constant */` |
|    23295 | 1208 | `				pTos->nIdx = SXU32_HIGH;` |
|    23295 | 1209 | `				break;` |
|        - | 1210 | `			}` |
...
|        - | 1283 | ` */` |
|  2250413 | 1284 | `case PH7_OP_LOAD:{` |
|        - | 1285 | `	ph7_value *pObj;` |
|        - | 1286 | `	SyString sName;` |
|  4504821 | 1287 | `	if( pInstr->p3 == 0 ){` |
...
|        9 | 1299 | `	}else{` |
|  4504805 | 1300 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1301 | `		/* Reserve a room for the target object */` |
|  4504805 | 1302 | `		pTos++;` |
|        - | 1303 | `	}` |
|  4504821 | 1304 | `	if( pInstr->iP2 == 2 ){` |
...
|   405240 | 1310 | `		if( VmExtractMemObj(&(*pVm),&sName,FALSE,FALSE) == 0 ){` |
|        7 | 1311 | `			VmErrorFormat(&(*pVm),PH7_CTX_WARNING,"Undefined variable $%z",&sName);` |
|        3 | 1312 | `		}` |
|   202722 | 1313 | `	}` |
|        - | 1314 | `	/* Extract the requested memory object */` |
|  4504821 | 1315 | `	pObj = VmExtractMemObj(&(*pVm),&sName,pInstr->p3 ? FALSE : TRUE,pInstr->iP1 != 1);` |
|  4504821 | 1316 | `	if( pObj == 0 ){` |
...
|  4504759 | 1341 | `	PH7_MemObjLoad(pObj,pTos);` |
|  4504759 | 1342 | `	pTos->nIdx = pObj->nIdx;` |
|  4504759 | 1343 | `	break;` |
|        - | 1344 | `				   }` |
|        - | 1345 | `/*` |
|        - | 1346 | ` * LOAD_MAP P1 * *` |
...
|        - | 1351 | ` */` |
|    36985 | 1352 | `case PH7_OP_LOAD_MAP: {` |
|        - | 1353 | `	VmOpRc rcOp;` |
|    73975 | 1354 | `	sState.pTos = pTos;` |
|    73975 | 1355 | `	sState.pc = pc;` |
|    73975 | 1356 | `	rcOp = VmExecOpLoadMap(&(*pVm),&sState,pInstr);` |
|    73975 | 1357 | `	pTos = sState.pTos;` |
|    73975 | 1358 | `	pc = sState.pc;` |
|    73975 | 1359 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1360 | `		goto Abort;` |
|    73975 | 1361 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1394 | ` * instead.` |
|        - | 1395 | ` */` |
|   339352 | 1396 | `case PH7_OP_LOAD_IDX: {` |
|        - | 1397 | `	VmOpRc rcOp;` |
|   679450 | 1398 | `	sState.pTos = pTos;` |
|   679450 | 1399 | `	sState.pc = pc;` |
|   679450 | 1400 | `	rcOp = VmExecOpLoadIdx(&(*pVm),&sState,pInstr);` |
|   679450 | 1401 | `	pTos = sState.pTos;` |
|   679450 | 1402 | `	pc = sState.pc;` |
|   679450 | 1403 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1404 | `		goto Abort;` |
|   679450 | 1405 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1415 | ` */` |
|      599 | 1416 | `case PH7_OP_LOAD_CLOSURE: {` |
|        - | 1417 | `	VmOpRc rcOp;` |
|     1203 | 1418 | `	sState.pTos = pTos;` |
|     1203 | 1419 | `	sState.pc = pc;` |
|     1203 | 1420 | `	rcOp = VmExecOpLoadClosure(&(*pVm),&sState,pInstr);` |
|     1203 | 1421 | `	pTos = sState.pTos;` |
|     1203 | 1422 | `	pc = sState.pc;` |
|     1203 | 1423 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1424 | `		goto Abort;` |
|     1203 | 1425 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1582 | `		}` |
|    11799 | 1583 | `		break;` |
|   626433 | 1584 | `	}else if( pInstr->p3 == 0 ){` |
...
|        - | 1596 | `#endif` |
|        5 | 1597 | `	}else{` |
|   626425 | 1598 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1599 | `	}` |
|   626428 | 1600 | `	if( sName.nByte == sizeof("GLOBALS")-1` |
|   314970 | 1601 | `	 && SyMemcmp((const void *)sName.zString,(const void *)"GLOBALS",sName.nByte) == 0 ){` |
|        6 | 1602 | `		if( pInstr->p3 ){` |
...
|        - | 1639 | ` */` |
|   121552 | 1640 | `case PH7_OP_STORE_IDX:` |
|        - | 1641 | `case PH7_OP_STORE_IDX_REF: {` |
|        - | 1642 | `	VmOpRc rcOp;` |
|   243109 | 1643 | `	sState.pTos = pTos;` |
|   243109 | 1644 | `	sState.pc = pc;` |
|   243109 | 1645 | `	rcOp = VmExecOpStoreIdxRef(&(*pVm),&sState,pInstr);` |
|   243109 | 1646 | `	pTos = sState.pTos;` |
|   243109 | 1647 | `	pc = sState.pc;` |
|   243109 | 1648 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 1649 | `		goto Abort;` |
|   243107 | 1650 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|    70535 | 1938 | `	PH7_MemObjToNumeric(pTos);` |
|    70535 | 1939 | `	if( pTos->iFlags & MEMOBJ_REAL ){` |
|      112 | 1940 | `		pTos->rVal = -pTos->rVal;` |
|       55 | 1941 | `	}` |
|    70535 | 1942 | `	if( pTos->iFlags & MEMOBJ_INT ){` |
|    70449 | 1943 | `		if( pTos->x.iVal == SMALLEST_INT64 ){` |
...
|        - | 1958 | `#endif` |
|        3 | 1959 | `		}else{` |
|    70445 | 1960 | `			pTos->x.iVal = -pTos->x.iVal;` |
|        - | 1961 | `		}` |
|    35222 | 1962 | `	}` |
|    70535 | 1963 | `	break;` |
|        - | 1964 | `/*` |
...
|    50673 | 1997 | `	if( (pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      159 | 1998 | `		PH7_MemObjToBool(pTos);` |
|       77 | 1999 | `	}` |
|    50673 | 2000 | `	pTos->x.iVal = !pTos->x.iVal;` |
|    50673 | 2001 | `	break;` |
|        - | 2002 | `/*` |
|        - | 2003 | ` * OP_BITNOT: * * *` |
|        - | 2004 | ` *` |
...
|        - | 2070 | ` */` |
|     6341 | 2071 | `case PH7_OP_ADD:{` |
|    12687 | 2072 | `	ph7_value *pNos = &pTos[-1];` |
|        - | 2073 | `#ifdef UNTRUST` |
|        - | 2074 | `	if( pNos < pStack ){` |
|        - | 2075 | `		goto Abort;` |
|        - | 2076 | `	}` |
...
|        - | 2082 | `		SyBlob sArMsg;` |
|    12687 | 2083 | `		SyBlobInit(&sArMsg,&pVm->sAllocator);` |
|    12687 | 2084 | `		if( VmArithOperandCheck(&(*pVm),pNos,pTos,"+",&sArMsg) != SXRET_OK ){` |
|        - | 2085 | `			sxi32 rcAr;` |
...
|        - | 2096 | `		}` |
|    12679 | 2097 | `		SyBlobRelease(&sArMsg);` |
|        - | 2098 | `	}` |
|        - | 2099 | `	/* Perform the addition */` |
|    12679 | 2100 | `	PH7_MemObjAdd(pNos,pTos,FALSE);` |
|    12679 | 2101 | `	VmPopOperand(&pTos,1);` |
|    12679 | 2102 | `	break;` |
|        - | 2103 | `				}` |
|        - | 2104 | `/*` |
|        - | 2105 | ` * OP_ADD_STORE * * *` |
...
|   144501 | 2531 | `		pNos = &pTos[-1];` |
|    72253 | 2532 | `	}else{` |
|    28687 | 2533 | `		pNos = &pTos[-pInstr->iP1+1];` |
|        - | 2534 | `	}` |
|        - | 2535 | `#ifdef UNTRUST` |
|        - | 2536 | `	if( pNos < pStack ){` |
|        - | 2537 | `		goto Abort;` |
...
|   349999 | 2545 | `	while( pCur <= pTos ){` |
|   176821 | 2546 | `		if( (pCur->iFlags & MEMOBJ_STRING) == 0 ){` |
|    52465 | 2547 | `			PH7_MemObjToString(pCur);` |
|    26230 | 2548 | `		}` |
|        - | 2549 | `		/* Perform the concatenation */` |
|   176821 | 2550 | `		if( SyBlobLength(&pCur->sBlob) > 0 ){` |
|   176669 | 2551 | `			if( PH7_MemObjStringAppend(pNos,(const char *)SyBlobData(&pCur->sBlob),SyBlobLength(&pCur->sBlob)) != SXRET_OK ){` |
|        - | 2552 | `				/* Allocation failure: raise a fatal instead of a truncated concat */` |
|      ! 0 | 2553 | `				PH7_VmMemoryError(&(*pVm));` |
|      ! 0 | 2554 | `				goto Abort;` |
|        - | 2555 | `			}` |
|    88332 | 2556 | `		}` |
|   176821 | 2557 | `		SyBlobRelease(&pCur->sBlob);` |
|   176821 | 2558 | `		pCur++;` |
|        5 | 2559 | `	}` |
...
|        - | 2566 | ` * back.` |
|        - | 2567 | ` */` |
|    13823 | 2568 | `case PH7_OP_CAT_STORE:{` |
|    27651 | 2569 | `	ph7_value *pNos = &pTos[-1];` |
|        - | 2570 | `	ph7_value *pObj;` |
|        - | 2571 | `	sxu32 nIdx;` |
|        - | 2572 | `#ifdef UNTRUST` |
|        - | 2573 | `	if( pNos < pStack ){` |
...
|    27651 | 2578 | `	if((pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|       59 | 2579 | `		PH7_MemObjToString(pNos);` |
|       29 | 2580 | `	}` |
|    27651 | 2581 | `	nIdx = pTos->nIdx;` |
...
|    27646 | 2593 | `	if( nIdx != SXU32_HIGH` |
|    27646 | 2594 | `	 && nIdx != pNos->nIdx` |
|    27642 | 2595 | `	 && (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx)) != 0` |
|    27643 | 2596 | `	 && (SyHashTotalEntry(&pVm->hTypedSlot) == 0` |
|    16419 | 2597 | `	     \|\| SyHashGet(&pVm->hTypedSlot,(const void *)&nIdx,sizeof(sxu32)) == 0) ){` |
|    27637 | 2598 | `		if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - | 2599 | `			/* e.g. $x = 5; $x .= "a";  ->  "5a" */` |
|        6 | 2600 | `			PH7_MemObjToString(pObj);` |
|        2 | 2601 | `		}` |
|    27637 | 2602 | `		if( SyBlobLength(&pNos->sBlob) > 0 ){` |
|    27633 | 2603 | `			if( PH7_MemObjStringAppend(pObj,(const char *)SyBlobData(&pNos->sBlob),SyBlobLength(&pNos->sBlob)) != SXRET_OK ){` |
...
|    27637 | 2622 | `		if( (pInstr+1)->iOp != PH7_OP_POP ){` |
...
|    27637 | 2627 | `		PH7_HOOK_RMW_WRITEBACK(nIdx,0);` |
|    27637 | 2628 | `		pNos->nIdx = SXU32_HIGH;` |
|    27637 | 2629 | `		VmPopOperand(&pTos,1);` |
|    27644 | 2630 | `		break;` |
|        - | 2631 | `	}` |
...
|        - | 2668 | ` * stack.` |
|        - | 2669 | ` */` |
|   116346 | 2670 | `case PH7_OP_LAND:` |
|        - | 2671 | `case PH7_OP_LOR: {` |
|        - | 2672 | `	VmOpRc rcOp;` |
|   232906 | 2673 | `	sState.pTos = pTos;` |
|   232906 | 2674 | `	sState.pc = pc;` |
|   232906 | 2675 | `	rcOp = VmExecOpLor(&(*pVm),&sState,pInstr);` |
|   232906 | 2676 | `	pTos = sState.pTos;` |
|   232906 | 2677 | `	pc = sState.pc;` |
|   232906 | 2678 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2679 | `		goto Abort;` |
|   232906 | 2680 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2895 | ` */` |
|     5458 | 2896 | `case PH7_OP_EQ:` |
|        - | 2897 | `case PH7_OP_NEQ: {` |
|        - | 2898 | `	VmOpRc rcOp;` |
|    10921 | 2899 | `	sState.pTos = pTos;` |
|    10921 | 2900 | `	sState.pc = pc;` |
|    10921 | 2901 | `	rcOp = VmExecOpNeq(&(*pVm),&sState,pInstr);` |
|    10921 | 2902 | `	pTos = sState.pTos;` |
|    10921 | 2903 | `	pc = sState.pc;` |
|    10921 | 2904 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2905 | `		goto Abort;` |
|    10921 | 2906 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2917 | ` */` |
|   231647 | 2918 | `case PH7_OP_TEQ: {` |
|        - | 2919 | `	VmOpRc rcOp;` |
|   463508 | 2920 | `	sState.pTos = pTos;` |
|   463508 | 2921 | `	sState.pc = pc;` |
|   463508 | 2922 | `	rcOp = VmExecOpTeq(&(*pVm),&sState,pInstr);` |
|   463508 | 2923 | `	pTos = sState.pTos;` |
|   463508 | 2924 | `	pc = sState.pc;` |
|   463508 | 2925 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2926 | `		goto Abort;` |
|   463508 | 2927 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2939 | ` *` |
|        - | 2940 | ` */` |
|   193297 | 2941 | `case PH7_OP_TNE: {` |
|        - | 2942 | `	VmOpRc rcOp;` |
|   386808 | 2943 | `	sState.pTos = pTos;` |
|   386808 | 2944 | `	sState.pc = pc;` |
|   386808 | 2945 | `	rcOp = VmExecOpTne(&(*pVm),&sState,pInstr);` |
|   386808 | 2946 | `	pTos = sState.pTos;` |
|   386808 | 2947 | `	pc = sState.pc;` |
|   386808 | 2948 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2949 | `		goto Abort;` |
|   386808 | 2950 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2974 | `case PH7_OP_LE: {` |
|        - | 2975 | `	VmOpRc rcOp;` |
|   298253 | 2976 | `	sState.pTos = pTos;` |
|   298253 | 2977 | `	sState.pc = pc;` |
|   298253 | 2978 | `	rcOp = VmExecOpLe(&(*pVm),&sState,pInstr);` |
|   298253 | 2979 | `	pTos = sState.pTos;` |
|   298253 | 2980 | `	pc = sState.pc;` |
|   298253 | 2981 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2982 | `		goto Abort;` |
|   298253 | 2983 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3390 | ` */` |
|    12059 | 3391 | `case PH7_OP_FOREACH_INIT: {` |
|        - | 3392 | `	VmOpRc rcOp;` |
|    24123 | 3393 | `	sState.pTos = pTos;` |
|    24123 | 3394 | `	sState.pc = pc;` |
|    24123 | 3395 | `	rcOp = VmExecOpForeachInit(&(*pVm),&sState,pInstr);` |
|    24123 | 3396 | `	pTos = sState.pTos;` |
|    24123 | 3397 | `	pc = sState.pc;` |
|    24123 | 3398 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 3399 | `		goto Abort;` |
|    24123 | 3400 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3408 | ` */` |
|   121805 | 3409 | `case PH7_OP_FOREACH_STEP: {` |
|        - | 3410 | `	VmOpRc rcOp;` |
|   243615 | 3411 | `	sState.pTos = pTos;` |
|   243615 | 3412 | `	sState.pc = pc;` |
|   243615 | 3413 | `	rcOp = VmExecOpForeachStep(&(*pVm),&sState,pInstr);` |
|   243615 | 3414 | `	pTos = sState.pTos;` |
|   243615 | 3415 | `	pc = sState.pc;` |
|   243615 | 3416 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 3417 | `		goto Abort;` |
|   243613 | 3418 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3426 | ` */` |
|    22567 | 3427 | `case PH7_OP_MEMBER: {` |
|        - | 3428 | `	VmOpRc rcOp;` |
|    45139 | 3429 | `	sState.pTos = pTos;` |
|    45139 | 3430 | `	sState.pc = pc;` |
|    45139 | 3431 | `	rcOp = VmExecOpMember(&(*pVm),&sState,pInstr);` |
|    45139 | 3432 | `	pTos = sState.pTos;` |
|    45139 | 3433 | `	pc = sState.pc;` |
|    45139 | 3434 | `	if( rcOp == VM_OP_ABORT ){` |
|        7 | 3435 | `		goto Abort;` |
|    45133 | 3436 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3444 | ` */` |
|     2408 | 3445 | `case PH7_OP_NEW: {` |
|        - | 3446 | `	VmOpRc rcOp;` |
|     4821 | 3447 | `	sState.pTos = pTos;` |
|     4821 | 3448 | `	sState.pc = pc;` |
|     4821 | 3449 | `	rcOp = VmExecOpNew(&(*pVm),&sState,pInstr);` |
|     4821 | 3450 | `	pTos = sState.pTos;` |
|     4821 | 3451 | `	pc = sState.pc;` |
|     4821 | 3452 | `	if( rcOp == VM_OP_ABORT ){` |
|        5 | 3453 | `		goto Abort;` |
|     4817 | 3454 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|  1048789 | 3831 | `	sxi32 nCallArgs = pInstr->iP1 + (pInstr->iP2 ? VmSpreadOwnExtra(pVm,pInstr->iP1,pTos) : 0);` |
|        - | 3832 | `	ph7_value *pArg;` |
|  1048789 | 3833 | `	pArg = &pTos[-nCallArgs];` |
...
|  1048789 | 3842 | `	VmCallArgMap *pEffCallMap = (VmCallArgMap *)pInstr->p3;` |
...
|  1048789 | 3849 | `	if( VmValueIsClosure(pVm,pTos) ){` |
|        - | 3850 | `		ph7_value sCallable;` |
|     1161 | 3851 | `		PH7_MemObjInit(pVm,&sCallable);` |
|     1161 | 3852 | `		if( VmClosureUnwrap(pVm,pTos,&sCallable) == SXRET_OK ){` |
|     1161 | 3853 | `			PH7_MemObjRelease(pTos);` |
|     1161 | 3854 | `			PH7_MemObjStore(&sCallable,pTos);` |
|      578 | 3855 | `		}` |
|     1161 | 3856 | `		PH7_MemObjRelease(&sCallable);` |
|      578 | 3857 | `	}` |
|        - | 3858 | `	/* Extract function name */` |
|  1048789 | 3859 | `	if( (pTos->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|      142 | 4054 | `		break;` |
|        - | 4055 | `	}` |
|  1048629 | 4056 | `	SyStringInitFromBuf(&sName,SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
...
|  1048629 | 4060 | `	if( sName.nByte > 0 && sName.zString[0] == '\\' ){` |
...
|  1048629 | 4067 | `	pEntry = SyHashGet(&pVm->hFunction,(const void *)sName.zString,sName.nByte);` |
...
|        - | 4073 | `	{` |
|  1048629 | 4074 | `	VmCallArgMap *pCallMap = pEffCallMap;` |
|  1048629 | 4075 | `	if( pEntry == 0 && pCallMap && pCallMap->bIsNamespaced ){` |
...
|        - | 4106 | `		VmSlot sArg;` |
|        - | 4107 | `		sxu32 n;` |
|   106732 | 4108 | `		int bClosureThis = 0;` |
|   106732 | 4109 | `		ph7_class *pClosureScope = 0;` |
|        - | 4110 | `		/* initialize fields */` |
|   106732 | 4111 | `		pVmFunc = (ph7_vm_func *)pEntry->pUserData;` |
|   106732 | 4112 | `		pThis = 0;` |
|   106732 | 4113 | `		pSelf = 0;` |
...
|       14 | 4128 | `		}` |
|   106732 | 4129 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
|        - | 4130 | `			ph7_class_method *pMeth;` |
|        - | 4131 | `			/* Class method call */` |
|    25705 | 4132 | `			ph7_value *pTarget = &pTos[-1];` |
|    25705 | 4133 | `			if( pTarget >= pStack && (pTarget->iFlags & (MEMOBJ_STRING\|MEMOBJ_OBJ\|MEMOBJ_NULL)) ){` |
|        - | 4134 | `				/* Extract the 'this' pointer */` |
|    25705 | 4135 | `				if(pTarget->iFlags & MEMOBJ_OBJ ){` |
|        - | 4136 | `					/* Instance already loaded */` |
|    24667 | 4137 | `					pThis = (ph7_class_instance *)pTarget->x.pOther;` |
|    24667 | 4138 | `					pThis->iRef++;` |
|    24667 | 4139 | `					pSelf = pThis->pClass;` |
|    12331 | 4140 | `				}` |
|    25705 | 4141 | `				if( pSelf == 0 ){` |
...
|      353 | 4160 | `					}` |
|      519 | 4161 | `				}` |
|    25705 | 4162 | `				VmPopOperand(&pTos,1);` |
|    25705 | 4163 | `				PH7_MemObjRelease(pTos);` |
...
|    25705 | 4170 | `				nCallArgs = pInstr->iP1 + (pInstr->iP2 ? VmSpreadOwnExtra(&(*pVm),pInstr->iP1,pTos) : 0);` |
|    25705 | 4171 | `				pArg = &pTos[-nCallArgs];` |
...
|        - | 4176 | `				 */` |
|    25705 | 4177 | `				while( pArg < pStack ){` |
|      ! 0 | 4178 | `					pArg++;` |
|      ! 0 | 4179 | `				}` |
|    25705 | 4180 | `				if( pSelf && pVm->bReflectBypass ){` |
...
|        6 | 4185 | `				}else` |
|    25695 | 4186 | `				if( pSelf ){ /* Paranoid edition */` |
...
|    25695 | 4194 | `					ph7_class *pDeclClass = pVmFunc->pUserData ? (ph7_class *)pVmFunc->pUserData : pSelf;` |
|    25695 | 4195 | `					pMeth = PH7_ClassExtractMethod(pDeclClass,pVmFunc->sName.zString,pVmFunc->sName.nByte);` |
|    25695 | 4196 | `					if( pMeth == 0 && pDeclClass != pSelf ){` |
|      ! 0 | 4197 | `						pMeth = PH7_ClassExtractMethod(pSelf,pVmFunc->sName.zString,pVmFunc->sName.nByte);` |
|      ! 0 | 4198 | `					}` |
|    25695 | 4199 | `					if( pMeth && pMeth->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|   160200 | 4236 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   106727 | 4237 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
...
|   106732 | 4244 | `		if( VmRecursionExceeded(pVm) ){` |
...
|        3 | 4248 | `			goto Abort;` |
|        - | 4249 | `		}` |
|   106730 | 4250 | `		if( pVmFunc->pNextName ){` |
...
|   106730 | 4262 | `		pSelfHint = pSelf;` |
|   106730 | 4263 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
|    25705 | 4264 | `			ph7_class *pDecl = (ph7_class *)pVmFunc->pUserData;` |
|    25705 | 4265 | `			if( pDecl && (pDecl->iFlags & PH7_CLASS_TRAIT) == 0 ){` |
|    24679 | 4266 | `				pSelfHint = pDecl;` |
|    12337 | 4267 | `			}` |
|    12850 | 4268 | `		}` |
|   106730 | 4269 | `		if( pSelf == 0 && (pVmFunc->iFlags & VM_FUNC_CLOSURE) ){` |
...
|     1829 | 4276 | `			if( pClosureScope ){` |
|       29 | 4277 | `				pSelf = pClosureScope;` |
|     1815 | 4278 | `			}else if( pVmFunc->pLsbClass ){` |
|       66 | 4279 | `				pSelf = (ph7_class *)pVmFunc->pLsbClass;` |
|       31 | 4280 | `			}` |
|      912 | 4281 | `		}` |
|   106730 | 4282 | `		if( SySetUsed(&pVmFunc->aAttrs) > 0 ){` |
...
|       56 | 4287 | `		}` |
|   106730 | 4288 | `		if( pVmFunc->iFlags & VM_FUNC_GENERATOR ){` |
...
|   106390 | 4520 | `		aFormalArg = (ph7_vm_func_arg *)SySetBasePtr(&pVmFunc->aArgs);` |
|        - | 4521 | `		/* Create a new VM frame  */` |
|   106390 | 4522 | `		rc = VmEnterFrame(&(*pVm),pVmFunc,pThis,&pFrame);` |
|   106390 | 4523 | `		if( rc != SXRET_OK ){` |
...
|   106390 | 4551 | `		pFrame->nActualArgs = (int)(pTos - pArg);` |
|   106390 | 4552 | `		if( pThis && ((pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) \|\| bClosureThis) ){` |
...
|    24851 | 4555 | `			pObj = VmExtractMemObj(&(*pVm),&sThis,FALSE,TRUE);` |
|    24851 | 4556 | `			if( pObj ){` |
|        - | 4557 | `				/* Reflect the change */` |
|    24851 | 4558 | `				pObj->x.pOther = pThis;` |
|    24851 | 4559 | `				MemObjSetType(pObj,MEMOBJ_OBJ);` |
|    12423 | 4560 | `			}` |
|    12423 | 4561 | `		}` |
|   106390 | 4562 | `		if( SySetUsed(&pVmFunc->aStatic) > 0 ){` |
...
|        - | 4589 | `		{` |
|   106390 | 4590 | `		VmCallArgMap *pCallMap3 = pEffCallMap;` |
|        - | 4591 | `		/* Caller file's strict_types mode — governs parameter coercion` |
|        - | 4592 | `		 * (but NOT return coercion, which uses the callee's file). */` |
|   106390 | 4593 | `		int bCallIsStrict = (pCallMap3 && pCallMap3->bStrict) ? 1 : 0;` |
|   106390 | 4594 | `		if( pCallMap3 && pCallMap3->bHasNamed ){` |
|        - | 4595 | `			/* ============================================================` |
...
|        - | 4980 | `		 * ============================================================ */` |
|   106122 | 4981 | `		n = 0;` |
|   273378 | 4982 | `		while( pArg < pTos ){` |
|   167561 | 4983 | `			if( n < SySetUsed(&pVmFunc->aArgs) && (aFormalArg[n].iFlags & VM_FUNC_ARG_VARIADIC) ){` |
...
|        - | 5083 | `			}` |
|   167361 | 5084 | `			if( n < SySetUsed(&pVmFunc->aArgs) ){` |
...
|   166839 | 5091 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_UNION ){` |
...
|   166752 | 5124 | `				if( aFormalArg[n].nType > 0` |
|    90621 | 5125 | `					&& !((aFormalArg[n].iFlags & VM_FUNC_ARG_NULLABLE) && (pArg->iFlags & MEMOBJ_NULL)) ){` |
...
|       13 | 5201 | `					}` |
|     6976 | 5202 | `				}` |
|   166741 | 5203 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_BY_REF ){` |
...
|   166501 | 5255 | `					pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|        - | 5256 | `				}` |
|    83581 | 5257 | `			}else{` |
|        - | 5258 | `				char zName[32];` |
...
|        - | 5265 | `			}` |
|   167261 | 5266 | `			if( pObj ){` |
|   167025 | 5267 | `				PH7_MemObjStore(pArg,pObj);` |
|        - | 5268 | `				/* Insert argument index  */` |
|   167025 | 5269 | `				sArg.nIdx = pObj->nIdx;` |
|   167025 | 5270 | `				sArg.pUserData = 0;` |
|   167025 | 5271 | `				SySetPut(&pFrame->sArg,(const void *)&sArg);` |
|    83719 | 5272 | `			}` |
|   167261 | 5273 | `			PH7_MemObjRelease(pArg);` |
|   167261 | 5274 | `			pArg++;` |
|   167261 | 5275 | `			++n;` |
|        5 | 5276 | `		}` |
|        - | 5277 | `		} /* end named vs positional branch */` |
|        - | 5278 | `		/* Set up closure environment */` |
|   106268 | 5279 | `		if( pVmFunc->iFlags & VM_FUNC_CLOSURE ){` |
|        - | 5280 | `			ph7_vm_func_closure_env *aEnv,*pEnv;` |
|        - | 5281 | `			ph7_value *pValue;` |
|        - | 5282 | `			sxu32 iEnv;` |
|     1811 | 5283 | `			aEnv = (ph7_vm_func_closure_env *)SySetBasePtr(&pVmFunc->aClosureEnv);` |
|     3965 | 5284 | `			for(iEnv = 0 ; iEnv < SySetUsed(&pVmFunc->aClosureEnv) ; ++iEnv ){` |
|     2159 | 5285 | `				pEnv = &aEnv[iEnv];` |
|     2159 | 5286 | `				if( (pEnv->iFlags & VM_FUNC_ARG_IGNORE) && (pEnv->sValue.iFlags & MEMOBJ_NULL) ){` |
...
|   106263 | 5327 | `		if( n < SySetUsed(&pVmFunc->aArgs)` |
|    56822 | 5328 | `		 && (pVmFunc->iFlags & (VM_FUNC_INTERNAL\|VM_FUNC_CLASS_METHOD)) != VM_FUNC_INTERNAL ){` |
...
|   118282 | 5351 | `		while( n < SySetUsed(&pVmFunc->aArgs) ){` |
...
|        - | 5394 | `		 */` |
|   106246 | 5395 | `		PH7_MemObjRelease(pTos);` |
|   106246 | 5396 | `		pTos = &pTos[-nCallArgs];` |
...
|        - | 5408 | `		 * per function. */` |
|        - | 5409 | `		{` |
|   106246 | 5410 | `			sxu32 nSlots = pVmFunc->nMaxStack;` |
|   106246 | 5411 | `			if( nSlots == 0 ){` |
|     8311 | 5412 | `				sxu32 nInstr = SySetUsed(&pVmFunc->aByteCode);` |
|    12464 | 5413 | `				sxu32 nTight = VmComputeMaxStack(&(*pVm),` |
|     8306 | 5414 | `					(VmInstr *)SySetBasePtr(&pVmFunc->aByteCode),nInstr);` |
|     8311 | 5415 | `				nSlots = ( nTight == VM_STACK_UNMODELED ) ? nInstr : nTight;` |
|     8311 | 5416 | `				if( nSlots == 0 ){ nSlots = 1; } /* a 0-depth body still needs a valid, nonzero cache marker */` |
|     8311 | 5417 | `				pVmFunc->nMaxStack = nSlots;` |
|     4153 | 5418 | `			}` |
|   106246 | 5419 | `			pFrameStack = VmOperandStackAlloc(&(*pVm),nSlots);` |
|        - | 5420 | `		}` |
|   106246 | 5421 | `		if( pFrameStack == 0 ){` |
...
|      ! 0 | 5428 | `			break;` |
|        - | 5429 | `		}` |
|    53016 | 5430 | `SkipFuncBody:` |
|   106380 | 5431 | `		if( pSelf ){` |
|        - | 5432 | `			/* Push class name */` |
|    25763 | 5433 | `			SySetPut(&pVm->aSelf,(const void *)&pSelf);` |
|    12879 | 5434 | `		}` |
|        - | 5435 | `		/* Increment nesting level */` |
|   106380 | 5436 | `		pVm->nRecursionDepth++;` |
|   106380 | 5437 | `		if( rc == PH7_EXCEPTION ){` |
...
|   106246 | 5466 | `			VmCallFrame *pRec = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   106246 | 5467 | `			if( pRec ){` |
|   103596 | 5468 | `				pVm->pIdleCallFrames = (void *)pRec->pPrev;` |
|    51905 | 5469 | `			}else{` |
|     2655 | 5470 | `				pRec = (VmCallFrame *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmCallFrame));` |
|        - | 5471 | `			}` |
|   106246 | 5472 | `			if( pRec == 0 ){` |
...
|      ! 0 | 5483 | `				goto Abort;` |
|        - | 5484 | `			}` |
|   106246 | 5485 | `			sState.pTos = pTos;` |
|   106246 | 5486 | `			sState.pc = pc;` |
|   106246 | 5487 | `			pRec->sCaller = sState;` |
|   106246 | 5488 | `			pRec->sCall.pVmFunc = pVmFunc;` |
|   106246 | 5489 | `			pRec->sCall.pFrame = pFrame;` |
|   106246 | 5490 | `			pRec->sCall.pFrameStack = pFrameStack;` |
|   106246 | 5491 | `			pRec->sCall.nStackCap = pVmFunc->nMaxStack + VM_STACK_GUARD;` |
|   106246 | 5492 | `			pRec->sCall.nLastRef = SXU32_HIGH;` |
|   106246 | 5493 | `			pRec->sCall.bSelfPushed = (sxu8)(pSelf ? 1 : 0);` |
|   106246 | 5494 | `			pRec->pPrev = pCallTop;` |
|   106246 | 5495 | `			pCallTop = pRec;` |
|        - | 5496 | `			/* Switch to the callee activation (what the recursive` |
|        - | 5497 | `			 * VmByteCodeExec entry used to set up). */` |
|   106246 | 5498 | `			aInstr = (VmInstr *)SySetBasePtr(&pVmFunc->aByteCode);` |
|   106246 | 5499 | `			pStack = pFrameStack;` |
|   106246 | 5500 | `			pTos = &pStack[-1];` |
|   106246 | 5501 | `			pc = 0;` |
|   106246 | 5502 | `			sState.aInstr = aInstr;` |
|   106246 | 5503 | `			sState.pStack = pStack;` |
|   106246 | 5504 | `			sState.nStackCap = pRec->sCall.nStackCap; /* callee's operand-stack capacity for OP_SPREAD growth */` |
|   106246 | 5505 | `			sState.nStackOrig = pRec->sCall.nStackCap; /* fixed headroom reference (never grows) */` |
|   106246 | 5506 | `			sState.pTos = pTos;` |
|   106246 | 5507 | `			sState.pc = 0;` |
|   106246 | 5508 | `			sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|   106246 | 5509 | `			sState.pEntryFrame = pVm->pFrame;` |
|   106246 | 5510 | `			sState.pResult = pRec->sCaller.pTos;` |
|   106246 | 5511 | `			sState.pLastRef = &pRec->sCall.nLastRef;` |
|   106246 | 5512 | `			sState.pEnforceRetFunc = VmFuncHasReturnType(pVmFunc) ? pVmFunc : 0;` |
|   106246 | 5513 | `			sState.is_callback = 0;` |
|   106246 | 5514 | `			sState.bReturnPropagates = 0;` |
|   106246 | 5515 | `			goto VmLoopFetch;` |
|        - | 5516 | `		}` |
|       57 | 5517 | `	}else{` |
...
|   941902 | 5526 | `		pEntry = SyHashGet(&pVm->hHostFunction,(const void *)sName.zString,sName.nByte);` |
|        - | 5527 | `		{` |
|   941902 | 5528 | `		VmCallArgMap *pCallMap2 = pEffCallMap;` |
|   941902 | 5529 | `		if( pEntry == 0 && pCallMap2 && pCallMap2->bIsNamespaced ){` |
...
|        - | 5634 | `			}` |
|        - | 5635 | `		}` |
|   941886 | 5636 | `		pFunc = (ph7_user_func *)pEntry->pUserData;` |
...
|  1413197 | 5641 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   941881 | 5642 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
|        - | 5643 | `		/* Start collecting function arguments */` |
|   941886 | 5644 | `		SySetReset(&aArg);` |
|  2546170 | 5645 | `		while( pArg < pTos ){` |
|  1604289 | 5646 | `			SySetPut(&aArg,(const void *)&pArg);` |
|  1604289 | 5647 | `			pArg++;` |
|        5 | 5648 | `		}` |
|        - | 5649 | `		/* Assume a null return value */` |
|   941886 | 5650 | `		PH7_MemObjInit(&(*pVm),&sRet);` |
|        - | 5651 | `		/* Init the call context */` |
|   941886 | 5652 | `		VmInitCallContext(&sCtx,&(*pVm),pFunc,&sRet,0);` |
...
|   941886 | 5659 | `		sCtx.pArgMap = pEffCallMap;` |
|        - | 5660 | `		{` |
|   941886 | 5661 | `		int nGiven = (int)SySetUsed(&aArg);` |
...
|   941886 | 5667 | `		if( pFunc->nMinArg > 0 && nGiven < pFunc->nMinArg ){` |
...
|      232 | 5674 | `				nGiven);` |
|   941654 | 5675 | `		}else if( pFunc->bHasMaxArg && nGiven > (int)pFunc->nMaxArg ){` |
...
|       40 | 5688 | `				nGiven);` |
|  1412421 | 5689 | `		}else if( SXRET_OK != (rc = VmEnforceBuiltinArgTypes(&sCtx,pFunc,nGiven,` |
|   941337 | 5690 | `			(ph7_value **)SySetBasePtr(&aArg))) ){` |
|        - | 5691 | `			/* TypeError thrown: rc carries the caught/uncaught status */` |
|      112 | 5692 | `		}else{` |
|        - | 5693 | `			/* Call the foreign function */` |
|   941128 | 5694 | `			rc = pFunc->xFunc(&sCtx,nGiven,(ph7_value **)SySetBasePtr(&aArg));` |
|        - | 5695 | `		}` |
|        - | 5696 | `		}` |
|        - | 5697 | `		/* Release the call context */` |
|   941886 | 5698 | `		VmReleaseCallContext(&sCtx);` |
|   941886 | 5699 | `		if( rc == PH7_ABORT ){` |
...
|      578 | 5704 | `			goto Abort;` |
|        - | 5705 | `		}` |
|   941312 | 5706 | `		if( rc != PH7_SUSPEND && pVm->pInlineInstr == (void *)aInstr ){` |
...
|      ! 0 | 5719 | `		}` |
|   941308 | 5720 | `		if( rc == PH7_EXCEPTION ){` |
...
|      851 | 5740 | `			break;` |
|        - | 5741 | `		}` |
|   940264 | 5742 | `		if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|   919098 | 5766 | `			VmPopOperand(&pTos,nCallArgs);` |
|   459917 | 5767 | `		}` |
|        - | 5768 | `		/* Save foreign function return value into the (now top) function-name slot */` |
|   939910 | 5769 | `		PH7_MemObjStore(&sRet,pTos);` |
|   939910 | 5770 | `		PH7_MemObjRelease(&sRet);` |
|        - | 5771 | `	}` |
|   940014 | 5772 | `	break;` |
|        - | 5773 | `				  }` |
|        - | 5774 | `/*` |
...
|        - | 5777 | ` */` |
|    26212 | 5778 | `case PH7_OP_CONSUME: {` |
|        - | 5779 | `	VmOpRc rcOp;` |
|    52429 | 5780 | `	sState.pTos = pTos;` |
|    52429 | 5781 | `	sState.pc = pc;` |
|    52429 | 5782 | `	rcOp = VmExecOpConsume(&(*pVm),&sState,pInstr);` |
|    52429 | 5783 | `	pTos = sState.pTos;` |
|    52429 | 5784 | `	pc = sState.pc;` |
|    52429 | 5785 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 5786 | `		goto Abort;` |
|    52429 | 5787 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 5792 |  |
|        - | 5793 | `		} /* Switch() */` |
| 16879902 | 5794 | `		pc++; /* Next instruction in the stream */` |
|        5 | 5795 | `	} /* For(;;) */` |
|   131538 | 5796 | `Done:` |
...
|   263290 | 5800 | `	rc = SXRET_OK;` |
|   263290 | 5801 | `	goto Unwind;` |
|      823 | 5802 | `Suspend:` |
...
|   133555 | 5860 | `	for(;;){` |
|   266906 | 5861 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|      ! 0 | 5869 | `			}` |
|     1162 | 5870 | `		}` |
|   266906 | 5871 | `		if( pCallTop == 0 ){` |
|   161075 | 5872 | `			return VmExecFinalize(&(*pVm),&sState,&aArg,pTos,rc);` |
|        - | 5873 | `		}` |
|   105836 | 5874 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|      636 | 5880 | `		}` |
|        - | 5881 | `		{` |
|   105836 | 5882 | `			VmCallFrame *pRec = pCallTop;` |
|   105836 | 5883 | `			sState = pRec->sCaller;` |
|   105836 | 5884 | `			rc = VmCallFinish(&(*pVm),&sState,&pRec->sCall,rc);` |
|   105836 | 5885 | `			pCallTop = pRec->pPrev;` |
|   105836 | 5886 | `			pRec->pPrev = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   105836 | 5887 | `			pVm->pIdleCallFrames = (void *)pRec;` |
|   105836 | 5888 | `			aInstr = sState.aInstr;` |
|   105836 | 5889 | `			pStack = sState.pStack;` |
|   105836 | 5890 | `			pTos = sState.pTos;` |
|   105836 | 5891 | `			pc = sState.pc;` |
|        - | 5892 | `		}` |
|   105836 | 5893 | `		if( rc == PH7_OK ){` |
|   105070 | 5894 | `			pc++; /* the loop-bottom increment this OP_CALL missed */` |
|   105070 | 5895 | `			goto VmLoopFetch;` |
|        - | 5896 | `		}` |
|        5 | 5897 | `	}` |
|    80717 | 5898 | `}` |
|        - | 5899 |  |
