...
|        - |  162 | ` */` |
|   160794 |  163 | `static sxi32 VmExecFinalize(ph7_vm *pVm,VmExecState *pState,SySet *pArg,ph7_value *pTos,sxi32 rcTerm)` |
|        5 |  164 | `{` |
|    80397 |  165 | `	SXUNUSED(pVm);` |
|   160799 |  166 | `	if( rcTerm != PH7_SUSPEND && !pState->bReturnPropagates ){` |
|   157095 |  167 | `		VmClearFrameReturn(pState->pEntryFrame);` |
|    78545 |  168 | `	}` |
|   160799 |  169 | `	SySetRelease(pArg);` |
|   160799 |  170 | `	if( rcTerm == PH7_ABORT \|\| rcTerm == PH7_EXCEPTION ){` |
|     2841 |  171 | `		while( pTos >= pState->pStack ){` |
|     1789 |  172 | `			PH7_MemObjRelease(pTos);` |
|     1789 |  173 | `			pTos--;` |
|        5 |  174 | `		}` |
|      526 |  175 | `	}` |
|   160799 |  176 | `	return rcTerm;` |
|        5 |  177 | `}` |
|        - |  178 | `/*` |
...
|        - |  189 | ` */` |
|   105906 |  190 | `static sxi32 VmCallFinish(ph7_vm *pVm,VmExecState *pCaller,VmCallRecord *pCallee,sxi32 rc)` |
|        5 |  191 | `{` |
|        - |  192 | `	ph7_value *pObj;` |
|        - |  193 | `	/* Decrement nesting level */` |
|   105911 |  194 | `	pVm->nRecursionDepth--;` |
|   105911 |  195 | `	if( pCallee->bSelfPushed ){` |
|        - |  196 | `		/* Pop class name */` |
|    25537 |  197 | `		(void)SySetPop(&pVm->aSelf);` |
|    12766 |  198 | `	}` |
|   105911 |  199 | `	if( (pCallee->pVmFunc->iFlags & VM_FUNC_REF_RETURN) && rc == SXRET_OK ){` |
...
|       25 |  225 | `	}` |
|   105911 |  226 | `	if( rc != PH7_ABORT && ((pCallee->pFrame->iFlags & VM_FRAME_THROW) \|\| rc == PH7_EXCEPTION) ){` |
...
|   105911 |  272 | `	if( rc != PH7_SUSPEND && pCallee->pFrameStack ){` |
...
|   105777 |  276 | `		VmOperandStackRecycle(pVm,pCallee->pFrameStack,pCallee->nStackCap);` |
|    52991 |  277 | `	}` |
|        - |  278 | `	/* Leave the frame */` |
|   105911 |  279 | `	VmLeaveFrame(&(*pVm));` |
|   105911 |  280 | `	if( rc == PH7_ABORT ){` |
|      336 |  281 | `		return PH7_ABORT;` |
|        - |  282 | `	}` |
|   105579 |  283 | `	if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|        - |  291 | `	}` |
|   105579 |  292 | `	if( rc == PH7_EXCEPTION ){` |
|      469 |  293 | `		return PH7_EXCEPTION;` |
|        - |  294 | `	}` |
|   105115 |  295 | `	return PH7_OK;` |
|    53063 |  296 | `}` |
|        - |  297 | `/*` |
...
|        - |  330 | ` * nesting.` |
|        - |  331 | ` */` |
|   161152 |  332 | `PH7_PRIVATE sxi32 VmByteCodeExec(` |
...
|   161157 |  352 | `	if( VmNativeNestingExceeded(pVm) ){` |
...
|   161153 |  362 | `	nSavedBrc = pVm->nBoundaryRc;` |
|   161153 |  363 | `	pVm->nBoundaryRc = 0;` |
...
|   161153 |  370 | `	nSavedLine = pVm->nCurLine;` |
|   161153 |  371 | `	pVm->nVmExecDepth++;` |
|   241727 |  372 | `	rc = VmByteCodeExecBody(&(*pVm),aInstr,pStack,nTos,pResult,pLastRef,is_callback,nPc,` |
|    80574 |  373 | `		pEnforceRetFunc,bReturnPropagates,pAdoptSegment,ppBaseOwner,pnBaseCap,nStackOrig);` |
|   161153 |  374 | `	pVm->nVmExecDepth--;` |
|   161153 |  375 | `	pVm->nCurLine = nSavedLine;` |
|   161153 |  376 | `	if( nSavedBrc != 0 && (nSavedBrc == PH7_ABORT \|\| pVm->nBoundaryRc == 0) ){` |
|       15 |  377 | `		pVm->nBoundaryRc = nSavedBrc;` |
|        6 |  378 | `	}` |
|   161153 |  379 | `	return rc;` |
|    80581 |  380 | `}` |
|   161148 |  381 | `static sxi32 VmByteCodeExecBody(` |
...
|        - |  399 | `	ph7_value *pTos;` |
|        - |  400 | `	SySet aArg;` |
|   161153 |  401 | `	VmCallFrame *pCallTop = 0; /* Top of this invocation's in-loop call-record` |
...
|        - |  409 | `	sxi32 pc;` |
|        - |  410 | `	sxi32 rc;` |
|   161153 |  411 | `	sState.aInstr = aInstr;` |
|   161153 |  412 | `	sState.pStack = pStack;` |
|   161153 |  413 | `	sState.nStackCap = pnBaseCap ? *pnBaseCap : 0; /* CURRENT capacity (grown on a coroutine resume) */` |
|   161153 |  414 | `	sState.nStackOrig = nStackOrig;                /* ORIGINAL capacity — fixed headroom reference */` |
|   161153 |  415 | `	sState.pResult = pResult;` |
|   161153 |  416 | `	sState.pLastRef = pLastRef;` |
|   161153 |  417 | `	sState.pEnforceRetFunc = pEnforceRetFunc;` |
|   161153 |  418 | `	sState.is_callback = (sxu8)(is_callback ? 1 : 0);` |
|   161153 |  419 | `	sState.bReturnPropagates = (sxu8)(bReturnPropagates ? 1 : 0);` |
|        - |  420 | `	/* Argument container */` |
|   161153 |  421 | `	SySetInit(&aArg,&pVm->sAllocator,sizeof(ph7_value *));` |
|   161153 |  422 | `	if( nTos < 0 ){` |
|   145337 |  423 | `		pTos = &pStack[-1];` |
|    72671 |  424 | `	}else{` |
|    15821 |  425 | `		pTos = &pStack[nTos];` |
|        - |  426 | `	}` |
|   161153 |  427 | `	sState.pTos = pTos;` |
|   161153 |  428 | `	sState.pc = nPc;` |
...
|   161148 |  446 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->pFrame == pVm->pFrame` |
|     2816 |  447 | `	 && pStack == pVm->pActiveCtx->pStack ){` |
|     1805 |  448 | `		sState.nExceptionBase = pVm->pActiveCtx->nExceptionBase;` |
|      905 |  449 | `	}else{` |
|   159353 |  450 | `		sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|        - |  451 | `	}` |
|   161153 |  452 | `	sState.pEntryFrame = pVm->pFrame;` |
|   161153 |  453 | `	pc = nPc;` |
...
|   161148 |  506 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->pInjected` |
...
|   161138 |  567 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->bClosing` |
...
| 17232622 |  603 | `		if( pVm->nBoundaryRc != 0 \|\| SySetUsed(&pVm->aHookRmw) > 0 ){` |
...
| 17232522 |  658 | `		pInstr = &aInstr[pc];` |
| 17232522 |  659 | `		if( pInstr->nLine ){` |
...
| 17020570 |  663 | `			pVm->nCurLine = pInstr->nLine;` |
|  8516645 |  664 | `		}` |
| 17232522 |  665 | `		rc = SXRET_OK;` |
|        - |  666 | `/*` |
...
|        - |  672 | ` */` |
| 17232522 |  673 | `		switch(pInstr->iOp){` |
|        - |  674 | `/*` |
|        - |  675 | ` * DONE: P1 * *` |
|        - |  676 | ` *` |
...
|        - |  679 | ` */` |
|   131270 |  680 | `case PH7_OP_DONE:` |
|   262755 |  681 | `	if( pInstr->iP2 && sState.bReturnPropagates ){` |
...
|   262566 |  711 | `	if( sState.pEnforceRetFunc && VmFuncHasReturnType(sState.pEnforceRetFunc)` |
...
|     4591 |  736 | `	}` |
|   262547 |  737 | `	if( pInstr->iP1 && pTos >= pStack ){` |
|   158365 |  738 | `		if( sState.pLastRef ){` |
|    95391 |  739 | `			*sState.pLastRef = pTos->nIdx;` |
|    47798 |  740 | `		}` |
|   158365 |  741 | `		if( sState.pResult ){` |
|        - |  742 | `			/* Execution result */` |
|   151275 |  743 | `			PH7_MemObjStore(pTos,sState.pResult);` |
|    75740 |  744 | `		}` |
|   158365 |  745 | `		VmPopOperand(&pTos,1);` |
|   183472 |  746 | `	}else if( sState.pLastRef ){` |
...
|        - |  762 | `	 */` |
|   262547 |  763 | `	rc = VmDrainFinally(&(*pVm),sState.nExceptionBase);` |
|   262547 |  764 | `	if( rc == SXERR_ABORT ){` |
|      ! 0 |  765 | `		goto Abort;` |
|        - |  766 | `	}` |
|   262547 |  767 | `	if( rc == PH7_EXCEPTION ){` |
...
|        - |  778 | `	}` |
|   262543 |  779 | `	if( sState.pEntryFrame->bHasRet && !sState.bReturnPropagates ){` |
...
|        - |  835 | ` */` |
|   282136 |  836 | `case PH7_OP_JMP:` |
|   564486 |  837 | `	pc = pInstr->iP2 - 1;` |
|   564486 |  838 | `	break;` |
|        - |  839 | `/*` |
|        - |  840 | ` * JZ: P1 P2 *` |
|        - |  841 | ` *` |
...
|  1651932 |  852 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     1003 |  853 | `		PH7_MemObjToBool(pTos);` |
|      500 |  854 | `	}` |
|  1651932 |  855 | `	if( !pTos->x.iVal ){` |
|        - |  856 | `		/* Take the jump */` |
|   937545 |  857 | `		pc = pInstr->iP2 - 1;` |
|   469037 |  858 | `	}` |
|  1651932 |  859 | `	if( !pInstr->iP1 ){` |
|  1408350 |  860 | `		VmPopOperand(&pTos,1);` |
|   704754 |  861 | `	}` |
|  1651932 |  862 | `	break;` |
|        - |  863 | `/*` |
|        - |  864 | ` * JNZ: P1 P2 *` |
...
|   188791 |  876 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      ! 0 |  877 | `		PH7_MemObjToBool(pTos);` |
|      ! 0 |  878 | `	}` |
|   188791 |  879 | `	if( pTos->x.iVal ){` |
|        - |  880 | `		/* Take the jump */` |
|     9579 |  881 | `		pc = pInstr->iP2 - 1;` |
|     4787 |  882 | `	}` |
|   188791 |  883 | `	if( !pInstr->iP1 ){` |
...
|        - |  899 | ` */` |
|   689751 |  900 | `case PH7_OP_POP: {` |
|  1380556 |  901 | `	sxi32 n = pInstr->iP1;` |
|  1380556 |  902 | `	if( &pTos[-n+1] < pStack ){` |
|        - |  903 | `		/* TICKET 1433-51 Stack underflow must be handled at run-time */` |
|       79 |  904 | `		n = (sxi32)(pTos - pStack);` |
|       38 |  905 | `	}` |
|  1380556 |  906 | `	VmPopOperand(&pTos,n);` |
|  1380556 |  907 | `	break;` |
|        - |  908 | `				 }` |
|        - |  909 | `/*` |
|        - |  910 | ` * DUP: * * *` |
...
|        - |  929 | ` */` |
|    48775 |  930 | `case PH7_OP_NSSWITCH:` |
|    97555 |  931 | `	SyBlobReset(&pVm->sNamespace);` |
|    97555 |  932 | `	if( pInstr->p3 ){` |
...
|    97555 |  937 | `	SyHashRelease(&pVm->hUseConstImports);` |
|    97555 |  938 | `	SyHashInit(&pVm->hUseConstImports,&pVm->sAllocator,0,0);` |
|    97555 |  939 | `	break;` |
...
|     6769 | 1089 | `	break;` |
|        - | 1090 | `					  }` |
|    33245 | 1091 | `case PH7_OP_ERR_CTRL:` |
|        - | 1092 | `	/*` |
...
|        - | 1101 | `	 */` |
|    66495 | 1102 | `	if( pInstr->iP1 ){` |
|    33251 | 1103 | `		pVm->nErrSuppress++;` |
|    49872 | 1104 | `	}else if( pVm->nErrSuppress > 0 ){` |
|    33249 | 1105 | `		pVm->nErrSuppress--;` |
|    16622 | 1106 | `	}` |
|    66495 | 1107 | `	break;` |
|        - | 1108 | `/*` |
|        - | 1109 | ` * IS_A * * *` |
...
|        - | 1163 | ` */` |
|  1564887 | 1164 | `case PH7_OP_LOADC: {` |
|        - | 1165 | `	ph7_value *pObj;` |
|        - | 1166 | `	/* Reserve a room */` |
|  3131684 | 1167 | `	pTos++;` |
|  3131684 | 1168 | `	if( pInstr->iP1 & PH7_LOADC_NOKEY ){` |
|        - | 1169 | `		/* Absent array-literal key: mark it so LOAD_MAP auto-indexes without a diagnostic */` |
|    19517 | 1170 | `		MemObjSetType(pTos,MEMOBJ_NULL);` |
|    19517 | 1171 | `		SyBlobReset(&pTos->sBlob);` |
|    19517 | 1172 | `		pTos->iFlags \|= MEMOBJ_AUX_NOKEY;` |
|    19517 | 1173 | `		pTos->nIdx = SXU32_HIGH;` |
|    19517 | 1174 | `		break;` |
|        - | 1175 | `	}` |
|  3112172 | 1176 | `	if( (pObj = (ph7_value *)SySetAt(&pVm->aLitObj,pInstr->iP2)) != 0 ){` |
|  3112172 | 1177 | `		if( (pInstr->iP1 & PH7_LOADC_EXPAND) && SyBlobLength(&pObj->sBlob) <= 64 ){` |
|        - | 1178 | `			SyHashEntry *pEntry;` |
|        - | 1179 | `			/* Check use const imports first — imports take precedence */` |
|        - | 1180 | `			{` |
|        - | 1181 | `				SyHashEntry *pConstImport;` |
|    34934 | 1182 | `				pConstImport = SyHashGet(&pVm->hUseConstImports,` |
|    23286 | 1183 | `					SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|    23291 | 1184 | `				if( pConstImport ){` |
...
|    23281 | 1199 | `			pEntry = SyHashGet(&pVm->hConstant,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|    23281 | 1200 | `			if( pEntry ){` |
|    23271 | 1201 | `				ph7_constant *pCons = (ph7_constant *)pEntry->pUserData;` |
|        - | 1202 | `				/* Set a NULL default value */` |
|    23271 | 1203 | `				MemObjSetType(pTos,MEMOBJ_NULL);` |
|    23271 | 1204 | `				SyBlobReset(&pTos->sBlob);` |
|        - | 1205 | `				/* Invoke the callback and deal with the expanded value */` |
|    23271 | 1206 | `				VmExpandConstantWithNotice(&(*pVm),pCons,pTos);` |
|        - | 1207 | `				/* Mark as constant */` |
|    23271 | 1208 | `				pTos->nIdx = SXU32_HIGH;` |
|    23271 | 1209 | `				break;` |
|        - | 1210 | `			}` |
...
|        - | 1283 | ` */` |
|  2248403 | 1284 | `case PH7_OP_LOAD:{` |
|        - | 1285 | `	ph7_value *pObj;` |
|        - | 1286 | `	SyString sName;` |
|  4500816 | 1287 | `	if( pInstr->p3 == 0 ){` |
...
|        9 | 1299 | `	}else{` |
|  4500800 | 1300 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1301 | `		/* Reserve a room for the target object */` |
|  4500800 | 1302 | `		pTos++;` |
|        - | 1303 | `	}` |
|  4500816 | 1304 | `	if( pInstr->iP2 == 2 ){` |
...
|   405044 | 1310 | `		if( VmExtractMemObj(&(*pVm),&sName,FALSE,FALSE) == 0 ){` |
|        7 | 1311 | `			VmErrorFormat(&(*pVm),PH7_CTX_WARNING,"Undefined variable $%z",&sName);` |
|        3 | 1312 | `		}` |
|   202624 | 1313 | `	}` |
|        - | 1314 | `	/* Extract the requested memory object */` |
|  4500816 | 1315 | `	pObj = VmExtractMemObj(&(*pVm),&sName,pInstr->p3 ? FALSE : TRUE,pInstr->iP1 != 1);` |
|  4500816 | 1316 | `	if( pObj == 0 ){` |
...
|  4500754 | 1341 | `	PH7_MemObjLoad(pObj,pTos);` |
|  4500754 | 1342 | `	pTos->nIdx = pObj->nIdx;` |
|  4500754 | 1343 | `	break;` |
|        - | 1344 | `				   }` |
|        - | 1345 | `/*` |
|        - | 1346 | ` * LOAD_MAP P1 * *` |
...
|        - | 1394 | ` * instead.` |
|        - | 1395 | ` */` |
|   339299 | 1396 | `case PH7_OP_LOAD_IDX: {` |
|        - | 1397 | `	VmOpRc rcOp;` |
|   679347 | 1398 | `	sState.pTos = pTos;` |
|   679347 | 1399 | `	sState.pc = pc;` |
|   679347 | 1400 | `	rcOp = VmExecOpLoadIdx(&(*pVm),&sState,pInstr);` |
|   679347 | 1401 | `	pTos = sState.pTos;` |
|   679347 | 1402 | `	pc = sState.pc;` |
|   679347 | 1403 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1404 | `		goto Abort;` |
|   679347 | 1405 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|    11905 | 1513 | `		nIdx = pTos->nIdx;` |
|    11905 | 1514 | `		VmPopOperand(&pTos,1);` |
|    11905 | 1515 | `		if( pVm->pMagicSetThis ){` |
...
|       11 | 1528 | `			break;` |
|        - | 1529 | `		}` |
|    11895 | 1530 | `		if( pVm->pHookSetThis ){` |
...
|    11863 | 1558 | `			rcT = VmEnforcePropertyTypeOnStore(&(*pVm),nIdx,pTos,0);` |
|    11863 | 1559 | `			if( rcT == PH7_ABORT ){` |
|       13 | 1560 | `				goto Abort;` |
|        - | 1561 | `			}` |
|    11853 | 1562 | `			if( rcT == PH7_EXCEPTION ){` |
...
|    11785 | 1577 | `			pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|    11785 | 1578 | `			if( pObj ){` |
|        - | 1579 | `				/* Perform the store operation */` |
|    11785 | 1580 | `				PH7_MemObjStore(pTos,pObj);` |
|     5890 | 1581 | `			}` |
|        - | 1582 | `		}` |
|    11787 | 1583 | `		break;` |
|   625943 | 1584 | `	}else if( pInstr->p3 == 0 ){` |
...
|        - | 1596 | `#endif` |
|        5 | 1597 | `	}else{` |
|   625935 | 1598 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1599 | `	}` |
|   625938 | 1600 | `	if( sName.nByte == sizeof("GLOBALS")-1` |
|   314725 | 1601 | `	 && SyMemcmp((const void *)sName.zString,(const void *)"GLOBALS",sName.nByte) == 0 ){` |
|        6 | 1602 | `		if( pInstr->p3 ){` |
...
|        - | 1639 | ` */` |
|   121253 | 1640 | `case PH7_OP_STORE_IDX:` |
|        - | 1641 | `case PH7_OP_STORE_IDX_REF: {` |
|        - | 1642 | `	VmOpRc rcOp;` |
|   242511 | 1643 | `	sState.pTos = pTos;` |
|   242511 | 1644 | `	sState.pc = pc;` |
|   242511 | 1645 | `	rcOp = VmExecOpStoreIdxRef(&(*pVm),&sState,pInstr);` |
|   242511 | 1646 | `	pTos = sState.pTos;` |
|   242511 | 1647 | `	pc = sState.pc;` |
|   242511 | 1648 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 1649 | `		goto Abort;` |
|   242509 | 1650 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|   375283 | 1671 | `	PH7_ENFORCE_READONLY_MUTATE(pTos->nIdx);` |
...
|   375272 | 1676 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) != 0` |
...
|        - | 1694 | `		}` |
|      ! 0 | 1695 | `	}` |
|   375275 | 1696 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) == 0 ){` |
|   375275 | 1697 | `		if( pTos->nIdx != SXU32_HIGH ){` |
|        - | 1698 | `			ph7_value *pObj;` |
|   375275 | 1699 | `			if( (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pTos->nIdx)) != 0 ){` |
|   375275 | 1700 | `				if( VmStringWantsPerlIncr(pObj) ){` |
...
|   375273 | 1719 | `					if( pInstr->iP1 == 0 && (pTos->iFlags & MEMOBJ_STRING) ){` |
|        9 | 1720 | `						SyBlobNullAppend(&pTos->sBlob);` |
|        3 | 1721 | `					}` |
|        - | 1722 | `					/* Force a numeric cast on the variable */` |
|   375273 | 1723 | `					PH7_MemObjToNumeric(pObj);` |
|   375273 | 1724 | `					if( pObj->iFlags & MEMOBJ_REAL ){` |
|        5 | 1725 | `						pObj->rVal++;` |
...
|        - | 1734 | `						sxi64 r;` |
|   375269 | 1735 | `						if( PH7_ADD_OVERFLOW64(pObj->x.iVal,1,&r) ){` |
...
|        - | 1741 | `#endif` |
|        3 | 1742 | `						}else{` |
|   375265 | 1743 | `							pObj->x.iVal = r;` |
|        - | 1744 | `						}` |
|        - | 1745 | `					}` |
|   375273 | 1746 | `					if( pInstr->iP1 ){` |
...
|        - | 1785 | `		}` |
|   187739 | 1786 | `	}` |
|   375273 | 1787 | `	PH7_HOOK_RMW_WRITEBACK(pTos->nIdx,pTos);` |
|   375273 | 1788 | `	break;` |
|        - | 1789 | `/*` |
|        - | 1790 | ` * DECR: P1 * *` |
|        - | 1791 | ` *` |
...
|    50500 | 1997 | `	if( (pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      159 | 1998 | `		PH7_MemObjToBool(pTos);` |
|       77 | 1999 | `	}` |
|    50500 | 2000 | `	pTos->x.iVal = !pTos->x.iVal;` |
|    50500 | 2001 | `	break;` |
|        - | 2002 | `/*` |
|        - | 2003 | ` * OP_BITNOT: * * *` |
|        - | 2004 | ` *` |
...
|        - | 2526 | ` * back.` |
|        - | 2527 | ` */` |
|    86525 | 2528 | `case PH7_OP_CAT:{` |
|        - | 2529 | `	ph7_value *pNos,*pCur;` |
|   173055 | 2530 | `	if( pInstr->iP1 < 1 ){` |
|   144387 | 2531 | `		pNos = &pTos[-1];` |
|    72196 | 2532 | `	}else{` |
...
|   173055 | 2541 | `	if( (pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|     1909 | 2542 | `		PH7_MemObjToString(pNos);` |
|      952 | 2543 | `	}` |
|   173055 | 2544 | `	pCur = &pNos[1];` |
|   349689 | 2545 | `	while( pCur <= pTos ){` |
|   176639 | 2546 | `		if( (pCur->iFlags & MEMOBJ_STRING) == 0 ){` |
|    52445 | 2547 | `			PH7_MemObjToString(pCur);` |
|    26220 | 2548 | `		}` |
|        - | 2549 | `		/* Perform the concatenation */` |
|   176639 | 2550 | `		if( SyBlobLength(&pCur->sBlob) > 0 ){` |
|   176491 | 2551 | `			if( PH7_MemObjStringAppend(pNos,(const char *)SyBlobData(&pCur->sBlob),SyBlobLength(&pCur->sBlob)) != SXRET_OK ){` |
|        - | 2552 | `				/* Allocation failure: raise a fatal instead of a truncated concat */` |
|      ! 0 | 2553 | `				PH7_VmMemoryError(&(*pVm));` |
|      ! 0 | 2554 | `				goto Abort;` |
|        - | 2555 | `			}` |
|    88243 | 2556 | `		}` |
|   176639 | 2557 | `		SyBlobRelease(&pCur->sBlob);` |
|   176639 | 2558 | `		pCur++;` |
|        5 | 2559 | `	}` |
|   173055 | 2560 | `	pTos = pNos;` |
|   173055 | 2561 | `	break;` |
|        - | 2562 | `				}` |
|        - | 2563 | `/*  CAT_STORE: * * *` |
|        - | 2564 | ` *` |
...
|        - | 2566 | ` * back.` |
|        - | 2567 | ` */` |
|    13732 | 2568 | `case PH7_OP_CAT_STORE:{` |
|    27468 | 2569 | `	ph7_value *pNos = &pTos[-1];` |
|        - | 2570 | `	ph7_value *pObj;` |
|        - | 2571 | `	sxu32 nIdx;` |
|        - | 2572 | `#ifdef UNTRUST` |
|        - | 2573 | `	if( pNos < pStack ){` |
...
|    27468 | 2578 | `	if((pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|       59 | 2579 | `		PH7_MemObjToString(pNos);` |
|       29 | 2580 | `	}` |
|    27468 | 2581 | `	nIdx = pTos->nIdx;` |
...
|    27463 | 2593 | `	if( nIdx != SXU32_HIGH` |
|    27463 | 2594 | `	 && nIdx != pNos->nIdx` |
|    27459 | 2595 | `	 && (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx)) != 0` |
|    27460 | 2596 | `	 && (SyHashTotalEntry(&pVm->hTypedSlot) == 0` |
|    16327 | 2597 | `	     \|\| SyHashGet(&pVm->hTypedSlot,(const void *)&nIdx,sizeof(sxu32)) == 0) ){` |
|    27454 | 2598 | `		if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - | 2599 | `			/* e.g. $x = 5; $x .= "a";  ->  "5a" */` |
|        6 | 2600 | `			PH7_MemObjToString(pObj);` |
|        2 | 2601 | `		}` |
|    27454 | 2602 | `		if( SyBlobLength(&pNos->sBlob) > 0 ){` |
|    27450 | 2603 | `			if( PH7_MemObjStringAppend(pObj,(const char *)SyBlobData(&pNos->sBlob),SyBlobLength(&pNos->sBlob)) != SXRET_OK ){` |
...
|    27454 | 2622 | `		if( (pInstr+1)->iOp != PH7_OP_POP ){` |
...
|    27454 | 2627 | `		PH7_HOOK_RMW_WRITEBACK(nIdx,0);` |
|    27454 | 2628 | `		pNos->nIdx = SXU32_HIGH;` |
|    27454 | 2629 | `		VmPopOperand(&pTos,1);` |
|    27461 | 2630 | `		break;` |
|        - | 2631 | `	}` |
...
|        - | 2895 | ` */` |
|     5452 | 2896 | `case PH7_OP_EQ:` |
|        - | 2897 | `case PH7_OP_NEQ: {` |
|        - | 2898 | `	VmOpRc rcOp;` |
|    10909 | 2899 | `	sState.pTos = pTos;` |
|    10909 | 2900 | `	sState.pc = pc;` |
|    10909 | 2901 | `	rcOp = VmExecOpNeq(&(*pVm),&sState,pInstr);` |
|    10909 | 2902 | `	pTos = sState.pTos;` |
|    10909 | 2903 | `	pc = sState.pc;` |
|    10909 | 2904 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2905 | `		goto Abort;` |
|    10909 | 2906 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2917 | ` */` |
|   231242 | 2918 | `case PH7_OP_TEQ: {` |
|        - | 2919 | `	VmOpRc rcOp;` |
|   462699 | 2920 | `	sState.pTos = pTos;` |
|   462699 | 2921 | `	sState.pc = pc;` |
|   462699 | 2922 | `	rcOp = VmExecOpTeq(&(*pVm),&sState,pInstr);` |
|   462699 | 2923 | `	pTos = sState.pTos;` |
|   462699 | 2924 | `	pc = sState.pc;` |
|   462699 | 2925 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2926 | `		goto Abort;` |
|   462699 | 2927 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2939 | ` *` |
|        - | 2940 | ` */` |
|   192975 | 2941 | `case PH7_OP_TNE: {` |
|        - | 2942 | `	VmOpRc rcOp;` |
|   386165 | 2943 | `	sState.pTos = pTos;` |
|   386165 | 2944 | `	sState.pc = pc;` |
|   386165 | 2945 | `	rcOp = VmExecOpTne(&(*pVm),&sState,pInstr);` |
|   386165 | 2946 | `	pTos = sState.pTos;` |
|   386165 | 2947 | `	pc = sState.pc;` |
|   386165 | 2948 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2949 | `		goto Abort;` |
|   386165 | 2950 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3390 | ` */` |
|    12044 | 3391 | `case PH7_OP_FOREACH_INIT: {` |
|        - | 3392 | `	VmOpRc rcOp;` |
|    24093 | 3393 | `	sState.pTos = pTos;` |
|    24093 | 3394 | `	sState.pc = pc;` |
|    24093 | 3395 | `	rcOp = VmExecOpForeachInit(&(*pVm),&sState,pInstr);` |
|    24093 | 3396 | `	pTos = sState.pTos;` |
|    24093 | 3397 | `	pc = sState.pc;` |
|    24093 | 3398 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 3399 | `		goto Abort;` |
|    24093 | 3400 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3408 | ` */` |
|   121475 | 3409 | `case PH7_OP_FOREACH_STEP: {` |
|        - | 3410 | `	VmOpRc rcOp;` |
|   242955 | 3411 | `	sState.pTos = pTos;` |
|   242955 | 3412 | `	sState.pc = pc;` |
|   242955 | 3413 | `	rcOp = VmExecOpForeachStep(&(*pVm),&sState,pInstr);` |
|   242955 | 3414 | `	pTos = sState.pTos;` |
|   242955 | 3415 | `	pc = sState.pc;` |
|   242955 | 3416 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 3417 | `		goto Abort;` |
|   242953 | 3418 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3426 | ` */` |
|    22553 | 3427 | `case PH7_OP_MEMBER: {` |
|        - | 3428 | `	VmOpRc rcOp;` |
|    45111 | 3429 | `	sState.pTos = pTos;` |
|    45111 | 3430 | `	sState.pc = pc;` |
|    45111 | 3431 | `	rcOp = VmExecOpMember(&(*pVm),&sState,pInstr);` |
|    45111 | 3432 | `	pTos = sState.pTos;` |
|    45111 | 3433 | `	pc = sState.pc;` |
|    45111 | 3434 | `	if( rcOp == VM_OP_ABORT ){` |
|        7 | 3435 | `		goto Abort;` |
|    45105 | 3436 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|  1047275 | 3831 | `	sxi32 nCallArgs = pInstr->iP1 + (pInstr->iP2 ? VmSpreadOwnExtra(pVm,pInstr->iP1,pTos) : 0);` |
|        - | 3832 | `	ph7_value *pArg;` |
|  1047275 | 3833 | `	pArg = &pTos[-nCallArgs];` |
...
|  1047275 | 3842 | `	VmCallArgMap *pEffCallMap = (VmCallArgMap *)pInstr->p3;` |
...
|  1047275 | 3849 | `	if( VmValueIsClosure(pVm,pTos) ){` |
...
|  1047275 | 3859 | `	if( (pTos->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|      142 | 4054 | `		break;` |
|        - | 4055 | `	}` |
|  1047115 | 4056 | `	SyStringInitFromBuf(&sName,SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
...
|  1047115 | 4060 | `	if( sName.nByte > 0 && sName.zString[0] == '\\' ){` |
...
|  1047115 | 4067 | `	pEntry = SyHashGet(&pVm->hFunction,(const void *)sName.zString,sName.nByte);` |
...
|        - | 4073 | `	{` |
|  1047115 | 4074 | `	VmCallArgMap *pCallMap = pEffCallMap;` |
|  1047115 | 4075 | `	if( pEntry == 0 && pCallMap && pCallMap->bIsNamespaced ){` |
...
|        - | 4106 | `		VmSlot sArg;` |
|        - | 4107 | `		sxu32 n;` |
|   106673 | 4108 | `		int bClosureThis = 0;` |
|   106673 | 4109 | `		ph7_class *pClosureScope = 0;` |
|        - | 4110 | `		/* initialize fields */` |
|   106673 | 4111 | `		pVmFunc = (ph7_vm_func *)pEntry->pUserData;` |
|   106673 | 4112 | `		pThis = 0;` |
|   106673 | 4113 | `		pSelf = 0;` |
...
|       14 | 4128 | `		}` |
|   106673 | 4129 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
|        - | 4130 | `			ph7_class_method *pMeth;` |
|        - | 4131 | `			/* Class method call */` |
|    25691 | 4132 | `			ph7_value *pTarget = &pTos[-1];` |
|    25691 | 4133 | `			if( pTarget >= pStack && (pTarget->iFlags & (MEMOBJ_STRING\|MEMOBJ_OBJ\|MEMOBJ_NULL)) ){` |
|        - | 4134 | `				/* Extract the 'this' pointer */` |
|    25691 | 4135 | `				if(pTarget->iFlags & MEMOBJ_OBJ ){` |
|        - | 4136 | `					/* Instance already loaded */` |
|    24653 | 4137 | `					pThis = (ph7_class_instance *)pTarget->x.pOther;` |
|    24653 | 4138 | `					pThis->iRef++;` |
|    24653 | 4139 | `					pSelf = pThis->pClass;` |
|    12324 | 4140 | `				}` |
|    25691 | 4141 | `				if( pSelf == 0 ){` |
...
|      353 | 4160 | `					}` |
|      519 | 4161 | `				}` |
|    25691 | 4162 | `				VmPopOperand(&pTos,1);` |
|    25691 | 4163 | `				PH7_MemObjRelease(pTos);` |
...
|    25691 | 4170 | `				nCallArgs = pInstr->iP1 + (pInstr->iP2 ? VmSpreadOwnExtra(&(*pVm),pInstr->iP1,pTos) : 0);` |
|    25691 | 4171 | `				pArg = &pTos[-nCallArgs];` |
...
|        - | 4176 | `				 */` |
|    25691 | 4177 | `				while( pArg < pStack ){` |
|      ! 0 | 4178 | `					pArg++;` |
|      ! 0 | 4179 | `				}` |
|    25691 | 4180 | `				if( pSelf && pVm->bReflectBypass ){` |
...
|        6 | 4185 | `				}else` |
|    25681 | 4186 | `				if( pSelf ){ /* Paranoid edition */` |
...
|    25681 | 4194 | `					ph7_class *pDeclClass = pVmFunc->pUserData ? (ph7_class *)pVmFunc->pUserData : pSelf;` |
|    25681 | 4195 | `					pMeth = PH7_ClassExtractMethod(pDeclClass,pVmFunc->sName.zString,pVmFunc->sName.nByte);` |
|    25681 | 4196 | `					if( pMeth == 0 && pDeclClass != pSelf ){` |
|      ! 0 | 4197 | `						pMeth = PH7_ClassExtractMethod(pSelf,pVmFunc->sName.zString,pVmFunc->sName.nByte);` |
|      ! 0 | 4198 | `					}` |
|    25681 | 4199 | `					if( pMeth && pMeth->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|   160112 | 4236 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   106668 | 4237 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
...
|   106673 | 4244 | `		if( VmRecursionExceeded(pVm) ){` |
...
|        3 | 4248 | `			goto Abort;` |
|        - | 4249 | `		}` |
|   106671 | 4250 | `		if( pVmFunc->pNextName ){` |
...
|   106671 | 4262 | `		pSelfHint = pSelf;` |
|   106671 | 4263 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
|    25691 | 4264 | `			ph7_class *pDecl = (ph7_class *)pVmFunc->pUserData;` |
|    25691 | 4265 | `			if( pDecl && (pDecl->iFlags & PH7_CLASS_TRAIT) == 0 ){` |
|    24665 | 4266 | `				pSelfHint = pDecl;` |
|    12330 | 4267 | `			}` |
|    12843 | 4268 | `		}` |
|   106671 | 4269 | `		if( pSelf == 0 && (pVmFunc->iFlags & VM_FUNC_CLOSURE) ){` |
...
|       30 | 4280 | `			}` |
|      903 | 4281 | `		}` |
|   106671 | 4282 | `		if( SySetUsed(&pVmFunc->aAttrs) > 0 ){` |
...
|       56 | 4287 | `		}` |
|   106671 | 4288 | `		if( pVmFunc->iFlags & VM_FUNC_GENERATOR ){` |
...
|   106331 | 4520 | `		aFormalArg = (ph7_vm_func_arg *)SySetBasePtr(&pVmFunc->aArgs);` |
|        - | 4521 | `		/* Create a new VM frame  */` |
|   106331 | 4522 | `		rc = VmEnterFrame(&(*pVm),pVmFunc,pThis,&pFrame);` |
|   106331 | 4523 | `		if( rc != SXRET_OK ){` |
...
|   106331 | 4551 | `		pFrame->nActualArgs = (int)(pTos - pArg);` |
|   106331 | 4552 | `		if( pThis && ((pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) \|\| bClosureThis) ){` |
...
|    24837 | 4555 | `			pObj = VmExtractMemObj(&(*pVm),&sThis,FALSE,TRUE);` |
|    24837 | 4556 | `			if( pObj ){` |
|        - | 4557 | `				/* Reflect the change */` |
|    24837 | 4558 | `				pObj->x.pOther = pThis;` |
|    24837 | 4559 | `				MemObjSetType(pObj,MEMOBJ_OBJ);` |
|    12416 | 4560 | `			}` |
|    12416 | 4561 | `		}` |
|   106331 | 4562 | `		if( SySetUsed(&pVmFunc->aStatic) > 0 ){` |
...
|        - | 4589 | `		{` |
|   106331 | 4590 | `		VmCallArgMap *pCallMap3 = pEffCallMap;` |
|        - | 4591 | `		/* Caller file's strict_types mode — governs parameter coercion` |
|        - | 4592 | `		 * (but NOT return coercion, which uses the callee's file). */` |
|   106331 | 4593 | `		int bCallIsStrict = (pCallMap3 && pCallMap3->bStrict) ? 1 : 0;` |
|   106331 | 4594 | `		if( pCallMap3 && pCallMap3->bHasNamed ){` |
|        - | 4595 | `			/* ============================================================` |
...
|        - | 4980 | `		 * ============================================================ */` |
|   106063 | 4981 | `		n = 0;` |
|   273191 | 4982 | `		while( pArg < pTos ){` |
|   167433 | 4983 | `			if( n < SySetUsed(&pVmFunc->aArgs) && (aFormalArg[n].iFlags & VM_FUNC_ARG_VARIADIC) ){` |
...
|        - | 5083 | `			}` |
|   167233 | 5084 | `			if( n < SySetUsed(&pVmFunc->aArgs) ){` |
...
|   166711 | 5091 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_UNION ){` |
...
|   166624 | 5124 | `				if( aFormalArg[n].nType > 0` |
|    90557 | 5125 | `					&& !((aFormalArg[n].iFlags & VM_FUNC_ARG_NULLABLE) && (pArg->iFlags & MEMOBJ_NULL)) ){` |
...
|       13 | 5201 | `					}` |
|     6975 | 5202 | `				}` |
|   166613 | 5203 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_BY_REF ){` |
...
|   166373 | 5255 | `					pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|        - | 5256 | `				}` |
|    83518 | 5257 | `			}else{` |
|        - | 5258 | `				char zName[32];` |
...
|        - | 5265 | `			}` |
|   167133 | 5266 | `			if( pObj ){` |
|   166897 | 5267 | `				PH7_MemObjStore(pArg,pObj);` |
|        - | 5268 | `				/* Insert argument index  */` |
|   166897 | 5269 | `				sArg.nIdx = pObj->nIdx;` |
|   166897 | 5270 | `				sArg.pUserData = 0;` |
|   166897 | 5271 | `				SySetPut(&pFrame->sArg,(const void *)&sArg);` |
|    83656 | 5272 | `			}` |
|   167133 | 5273 | `			PH7_MemObjRelease(pArg);` |
|   167133 | 5274 | `			pArg++;` |
|   167133 | 5275 | `			++n;` |
|        5 | 5276 | `		}` |
|        - | 5277 | `		} /* end named vs positional branch */` |
|        - | 5278 | `		/* Set up closure environment */` |
|   106209 | 5279 | `		if( pVmFunc->iFlags & VM_FUNC_CLOSURE ){` |
...
|   106204 | 5327 | `		if( n < SySetUsed(&pVmFunc->aArgs)` |
|    56789 | 5328 | `		 && (pVmFunc->iFlags & (VM_FUNC_INTERNAL\|VM_FUNC_CLASS_METHOD)) != VM_FUNC_INTERNAL ){` |
|        - | 5329 | `			sxu32 nNonVar,nReq;` |
|     5911 | 5330 | `			nReq = VmFuncRequiredArgCount(pVmFunc,&nNonVar);` |
|     5911 | 5331 | `			if( n < nReq ){` |
...
|   118209 | 5351 | `		while( n < SySetUsed(&pVmFunc->aArgs) ){` |
|    12271 | 5352 | `			if( aFormalArg[n].iFlags & VM_FUNC_ARG_VARIADIC ){` |
...
|        - | 5363 | `			}` |
|    12027 | 5364 | `			if( SySetUsed(&aFormalArg[n].aByteCode) > 0 ){` |
|    12025 | 5365 | `				pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|    12025 | 5366 | `				if( pObj ){` |
|        - | 5367 | `					/* Evaluate the default value and extract it's result */` |
|    12025 | 5368 | `					rc = VmLocalExec(&(*pVm),&aFormalArg[n].aByteCode,pObj,FALSE);` |
|    12025 | 5369 | `					if( rc == PH7_ABORT ){` |
|      ! 0 | 5370 | `						goto Abort;` |
|        - | 5371 | `					}` |
|        - | 5372 | `					/* Insert argument index */` |
|    12025 | 5373 | `					sArg.nIdx = pObj->nIdx;` |
|    12025 | 5374 | `					sArg.pUserData = 0;` |
|    12025 | 5375 | `					SySetPut(&pFrame->sArg,(const void *)&sArg);` |
...
|    12020 | 5380 | `					if( aFormalArg[n].nType > 0 && aFormalArg[n].nType != MEMOBJ_OBJ` |
|     3962 | 5381 | `						&& ((pObj->iFlags & aFormalArg[n].nType) == 0)` |
|     1987 | 5382 | `						&& !((aFormalArg[n].iFlags & VM_FUNC_ARG_NULLABLE) && (pObj->iFlags & MEMOBJ_NULL)) ){` |
...
|        - | 5394 | `		 */` |
|   106187 | 5395 | `		PH7_MemObjRelease(pTos);` |
|   106187 | 5396 | `		pTos = &pTos[-nCallArgs];` |
...
|        - | 5408 | `		 * per function. */` |
|        - | 5409 | `		{` |
|   106187 | 5410 | `			sxu32 nSlots = pVmFunc->nMaxStack;` |
|   106187 | 5411 | `			if( nSlots == 0 ){` |
...
|     4146 | 5418 | `			}` |
|   106187 | 5419 | `			pFrameStack = VmOperandStackAlloc(&(*pVm),nSlots);` |
|        - | 5420 | `		}` |
|   106187 | 5421 | `		if( pFrameStack == 0 ){` |
...
|      ! 0 | 5428 | `			break;` |
|        - | 5429 | `		}` |
|    52986 | 5430 | `SkipFuncBody:` |
|   106321 | 5431 | `		if( pSelf ){` |
|        - | 5432 | `			/* Push class name */` |
|    25747 | 5433 | `			SySetPut(&pVm->aSelf,(const void *)&pSelf);` |
|    12871 | 5434 | `		}` |
|        - | 5435 | `		/* Increment nesting level */` |
|   106321 | 5436 | `		pVm->nRecursionDepth++;` |
|   106321 | 5437 | `		if( rc == PH7_EXCEPTION ){` |
...
|   106187 | 5466 | `			VmCallFrame *pRec = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   106187 | 5467 | `			if( pRec ){` |
|   103541 | 5468 | `				pVm->pIdleCallFrames = (void *)pRec->pPrev;` |
|    51878 | 5469 | `			}else{` |
|     2651 | 5470 | `				pRec = (VmCallFrame *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmCallFrame));` |
|        - | 5471 | `			}` |
|   106187 | 5472 | `			if( pRec == 0 ){` |
...
|      ! 0 | 5483 | `				goto Abort;` |
|        - | 5484 | `			}` |
|   106187 | 5485 | `			sState.pTos = pTos;` |
|   106187 | 5486 | `			sState.pc = pc;` |
|   106187 | 5487 | `			pRec->sCaller = sState;` |
|   106187 | 5488 | `			pRec->sCall.pVmFunc = pVmFunc;` |
|   106187 | 5489 | `			pRec->sCall.pFrame = pFrame;` |
|   106187 | 5490 | `			pRec->sCall.pFrameStack = pFrameStack;` |
|   106187 | 5491 | `			pRec->sCall.nStackCap = pVmFunc->nMaxStack + VM_STACK_GUARD;` |
|   106187 | 5492 | `			pRec->sCall.nLastRef = SXU32_HIGH;` |
|   106187 | 5493 | `			pRec->sCall.bSelfPushed = (sxu8)(pSelf ? 1 : 0);` |
|   106187 | 5494 | `			pRec->pPrev = pCallTop;` |
|   106187 | 5495 | `			pCallTop = pRec;` |
|        - | 5496 | `			/* Switch to the callee activation (what the recursive` |
|        - | 5497 | `			 * VmByteCodeExec entry used to set up). */` |
|   106187 | 5498 | `			aInstr = (VmInstr *)SySetBasePtr(&pVmFunc->aByteCode);` |
|   106187 | 5499 | `			pStack = pFrameStack;` |
|   106187 | 5500 | `			pTos = &pStack[-1];` |
|   106187 | 5501 | `			pc = 0;` |
|   106187 | 5502 | `			sState.aInstr = aInstr;` |
|   106187 | 5503 | `			sState.pStack = pStack;` |
|   106187 | 5504 | `			sState.nStackCap = pRec->sCall.nStackCap; /* callee's operand-stack capacity for OP_SPREAD growth */` |
|   106187 | 5505 | `			sState.nStackOrig = pRec->sCall.nStackCap; /* fixed headroom reference (never grows) */` |
|   106187 | 5506 | `			sState.pTos = pTos;` |
|   106187 | 5507 | `			sState.pc = 0;` |
|   106187 | 5508 | `			sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|   106187 | 5509 | `			sState.pEntryFrame = pVm->pFrame;` |
|   106187 | 5510 | `			sState.pResult = pRec->sCaller.pTos;` |
|   106187 | 5511 | `			sState.pLastRef = &pRec->sCall.nLastRef;` |
|   106187 | 5512 | `			sState.pEnforceRetFunc = VmFuncHasReturnType(pVmFunc) ? pVmFunc : 0;` |
|   106187 | 5513 | `			sState.is_callback = 0;` |
|   106187 | 5514 | `			sState.bReturnPropagates = 0;` |
|   106187 | 5515 | `			goto VmLoopFetch;` |
|        - | 5516 | `		}` |
|       57 | 5517 | `	}else{` |
...
|   940447 | 5526 | `		pEntry = SyHashGet(&pVm->hHostFunction,(const void *)sName.zString,sName.nByte);` |
|        - | 5527 | `		{` |
|   940447 | 5528 | `		VmCallArgMap *pCallMap2 = pEffCallMap;` |
|   940447 | 5529 | `		if( pEntry == 0 && pCallMap2 && pCallMap2->bIsNamespaced ){` |
...
|        - | 5634 | `			}` |
|        - | 5635 | `		}` |
|   940431 | 5636 | `		pFunc = (ph7_user_func *)pEntry->pUserData;` |
...
|  1411015 | 5641 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   940426 | 5642 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
|        - | 5643 | `		/* Start collecting function arguments */` |
|   940431 | 5644 | `		SySetReset(&aArg);` |
|  2541740 | 5645 | `		while( pArg < pTos ){` |
|  1601314 | 5646 | `			SySetPut(&aArg,(const void *)&pArg);` |
|  1601314 | 5647 | `			pArg++;` |
|        5 | 5648 | `		}` |
|        - | 5649 | `		/* Assume a null return value */` |
|   940431 | 5650 | `		PH7_MemObjInit(&(*pVm),&sRet);` |
|        - | 5651 | `		/* Init the call context */` |
|   940431 | 5652 | `		VmInitCallContext(&sCtx,&(*pVm),pFunc,&sRet,0);` |
...
|   940431 | 5659 | `		sCtx.pArgMap = pEffCallMap;` |
|        - | 5660 | `		{` |
|   940431 | 5661 | `		int nGiven = (int)SySetUsed(&aArg);` |
...
|   940431 | 5667 | `		if( pFunc->nMinArg > 0 && nGiven < pFunc->nMinArg ){` |
...
|      232 | 5674 | `				nGiven);` |
|   940199 | 5675 | `		}else if( pFunc->bHasMaxArg && nGiven > (int)pFunc->nMaxArg ){` |
...
|       40 | 5688 | `				nGiven);` |
|  1410239 | 5689 | `		}else if( SXRET_OK != (rc = VmEnforceBuiltinArgTypes(&sCtx,pFunc,nGiven,` |
|   939882 | 5690 | `			(ph7_value **)SySetBasePtr(&aArg))) ){` |
|        - | 5691 | `			/* TypeError thrown: rc carries the caught/uncaught status */` |
|      112 | 5692 | `		}else{` |
|        - | 5693 | `			/* Call the foreign function */` |
|   939673 | 5694 | `			rc = pFunc->xFunc(&sCtx,nGiven,(ph7_value **)SySetBasePtr(&aArg));` |
|        - | 5695 | `		}` |
|        - | 5696 | `		}` |
|        - | 5697 | `		/* Release the call context */` |
|   940431 | 5698 | `		VmReleaseCallContext(&sCtx);` |
|   940431 | 5699 | `		if( rc == PH7_ABORT ){` |
...
|      578 | 5704 | `			goto Abort;` |
|        - | 5705 | `		}` |
|   939857 | 5706 | `		if( rc != PH7_SUSPEND && pVm->pInlineInstr == (void *)aInstr ){` |
...
|      ! 0 | 5719 | `		}` |
|   939853 | 5720 | `		if( rc == PH7_EXCEPTION ){` |
...
|     1045 | 5728 | `			if( !VmRecordedResume(pVm,&iResumePc,sState.pEntryFrame,aInstr) ){` |
...
|      847 | 5734 | `			PH7_MemObjRelease(&sRet);` |
|      847 | 5735 | `			if( nCallArgs > 0 ){` |
|      557 | 5736 | `				VmPopOperand(&pTos,nCallArgs); /* spread-adjusted; see the normal-return path */` |
|      276 | 5737 | `			}` |
|      847 | 5738 | `			VmPopOperand(&pTos,1);` |
|      847 | 5739 | `			pc = iResumePc;` |
|      847 | 5740 | `			break;` |
|        - | 5741 | `		}` |
|   938813 | 5742 | `		if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|   917627 | 5766 | `			VmPopOperand(&pTos,nCallArgs);` |
|   459182 | 5767 | `		}` |
|        - | 5768 | `		/* Save foreign function return value into the (now top) function-name slot */` |
|   938459 | 5769 | `		PH7_MemObjStore(&sRet,pTos);` |
|   938459 | 5770 | `		PH7_MemObjRelease(&sRet);` |
|        - | 5771 | `	}` |
|   938563 | 5772 | `	break;` |
|        - | 5773 | `				  }` |
|        - | 5774 | `/*` |
...
|        - | 5777 | ` */` |
|    26159 | 5778 | `case PH7_OP_CONSUME: {` |
|        - | 5779 | `	VmOpRc rcOp;` |
|    52323 | 5780 | `	sState.pTos = pTos;` |
|    52323 | 5781 | `	sState.pc = pc;` |
|    52323 | 5782 | `	rcOp = VmExecOpConsume(&(*pVm),&sState,pInstr);` |
|    52323 | 5783 | `	pTos = sState.pTos;` |
|    52323 | 5784 | `	pc = sState.pc;` |
|    52323 | 5785 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 5786 | `		goto Abort;` |
|    52323 | 5787 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 5792 |  |
|        - | 5793 | `		} /* Switch() */` |
| 16860314 | 5794 | `		pc++; /* Next instruction in the stream */` |
|        5 | 5795 | `	} /* For(;;) */` |
|   131370 | 5796 | `Done:` |
...
|   262955 | 5800 | `	rc = SXRET_OK;` |
|   262955 | 5801 | `	goto Unwind;` |
|      823 | 5802 | `Suspend:` |
...
|   133388 | 5860 | `	for(;;){` |
|   266571 | 5861 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|      ! 0 | 5869 | `			}` |
|     1162 | 5870 | `		}` |
|   266571 | 5871 | `		if( pCallTop == 0 ){` |
|   160799 | 5872 | `			return VmExecFinalize(&(*pVm),&sState,&aArg,pTos,rc);` |
|        - | 5873 | `		}` |
|   105777 | 5874 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|      636 | 5880 | `		}` |
|        - | 5881 | `		{` |
|   105777 | 5882 | `			VmCallFrame *pRec = pCallTop;` |
|   105777 | 5883 | `			sState = pRec->sCaller;` |
|   105777 | 5884 | `			rc = VmCallFinish(&(*pVm),&sState,&pRec->sCall,rc);` |
|   105777 | 5885 | `			pCallTop = pRec->pPrev;` |
|   105777 | 5886 | `			pRec->pPrev = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   105777 | 5887 | `			pVm->pIdleCallFrames = (void *)pRec;` |
|   105777 | 5888 | `			aInstr = sState.aInstr;` |
|   105777 | 5889 | `			pStack = sState.pStack;` |
|   105777 | 5890 | `			pTos = sState.pTos;` |
|   105777 | 5891 | `			pc = sState.pc;` |
|        - | 5892 | `		}` |
|   105777 | 5893 | `		if( rc == PH7_OK ){` |
|   105011 | 5894 | `			pc++; /* the loop-bottom increment this OP_CALL missed */` |
|   105011 | 5895 | `			goto VmLoopFetch;` |
|        - | 5896 | `		}` |
|        5 | 5897 | `	}` |
|    80579 | 5898 | `}` |
|        - | 5899 |  |
