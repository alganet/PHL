...
|        - |  162 | ` */` |
|   157206 |  163 | `static sxi32 VmExecFinalize(ph7_vm *pVm,VmExecState *pState,SySet *pArg,ph7_value *pTos,sxi32 rcTerm)` |
|        5 |  164 | `{` |
|    78603 |  165 | `	SXUNUSED(pVm);` |
|   157211 |  166 | `	if( rcTerm != PH7_SUSPEND && !pState->bReturnPropagates ){` |
|   153533 |  167 | `		VmClearFrameReturn(pState->pEntryFrame);` |
|    76764 |  168 | `	}` |
|   157211 |  169 | `	SySetRelease(pArg);` |
|   157211 |  170 | `	if( rcTerm == PH7_ABORT \|\| rcTerm == PH7_EXCEPTION ){` |
|     2841 |  171 | `		while( pTos >= pState->pStack ){` |
|     1789 |  172 | `			PH7_MemObjRelease(pTos);` |
|     1789 |  173 | `			pTos--;` |
|        5 |  174 | `		}` |
|      526 |  175 | `	}` |
|   157211 |  176 | `	return rcTerm;` |
|        5 |  177 | `}` |
|        - |  178 | `/*` |
...
|        - |  189 | ` */` |
|   104431 |  190 | `static sxi32 VmCallFinish(ph7_vm *pVm,VmExecState *pCaller,VmCallRecord *pCallee,sxi32 rc)` |
|        5 |  191 | `{` |
|        - |  192 | `	ph7_value *pObj;` |
|        - |  193 | `	/* Decrement nesting level */` |
|   104436 |  194 | `	pVm->nRecursionDepth--;` |
|   104436 |  195 | `	if( pCallee->bSelfPushed ){` |
|        - |  196 | `		/* Pop class name */` |
|    25489 |  197 | `		(void)SySetPop(&pVm->aSelf);` |
|    12742 |  198 | `	}` |
|   104436 |  199 | `	if( (pCallee->pVmFunc->iFlags & VM_FUNC_REF_RETURN) && rc == SXRET_OK ){` |
...
|       25 |  225 | `	}` |
|   104436 |  226 | `	if( rc != PH7_ABORT && ((pCallee->pFrame->iFlags & VM_FRAME_THROW) \|\| rc == PH7_EXCEPTION) ){` |
...
|   104436 |  272 | `	if( rc != PH7_SUSPEND && pCallee->pFrameStack ){` |
...
|   104302 |  276 | `		VmOperandStackRecycle(pVm,pCallee->pFrameStack,pCallee->nStackCap);` |
|    52251 |  277 | `	}` |
|        - |  278 | `	/* Leave the frame */` |
|   104436 |  279 | `	VmLeaveFrame(&(*pVm));` |
|   104436 |  280 | `	if( rc == PH7_ABORT ){` |
|      336 |  281 | `		return PH7_ABORT;` |
|        - |  282 | `	}` |
|   104104 |  283 | `	if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|        - |  291 | `	}` |
|   104104 |  292 | `	if( rc == PH7_EXCEPTION ){` |
|      469 |  293 | `		return PH7_EXCEPTION;` |
|        - |  294 | `	}` |
|   103640 |  295 | `	return PH7_OK;` |
|    52323 |  296 | `}` |
|        - |  297 | `/*` |
...
|        - |  330 | ` * nesting.` |
|        - |  331 | ` */` |
|   157564 |  332 | `PH7_PRIVATE sxi32 VmByteCodeExec(` |
...
|   157569 |  352 | `	if( VmNativeNestingExceeded(pVm) ){` |
...
|   157565 |  362 | `	nSavedBrc = pVm->nBoundaryRc;` |
|   157565 |  363 | `	pVm->nBoundaryRc = 0;` |
...
|   157565 |  370 | `	nSavedLine = pVm->nCurLine;` |
|   157565 |  371 | `	pVm->nVmExecDepth++;` |
|   236345 |  372 | `	rc = VmByteCodeExecBody(&(*pVm),aInstr,pStack,nTos,pResult,pLastRef,is_callback,nPc,` |
|    78780 |  373 | `		pEnforceRetFunc,bReturnPropagates,pAdoptSegment,ppBaseOwner,pnBaseCap,nStackOrig);` |
|   157565 |  374 | `	pVm->nVmExecDepth--;` |
|   157565 |  375 | `	pVm->nCurLine = nSavedLine;` |
|   157565 |  376 | `	if( nSavedBrc != 0 && (nSavedBrc == PH7_ABORT \|\| pVm->nBoundaryRc == 0) ){` |
|       15 |  377 | `		pVm->nBoundaryRc = nSavedBrc;` |
|        6 |  378 | `	}` |
|   157565 |  379 | `	return rc;` |
|    78787 |  380 | `}` |
|   157560 |  381 | `static sxi32 VmByteCodeExecBody(` |
...
|        - |  399 | `	ph7_value *pTos;` |
|        - |  400 | `	SySet aArg;` |
|   157565 |  401 | `	VmCallFrame *pCallTop = 0; /* Top of this invocation's in-loop call-record` |
...
|        - |  409 | `	sxi32 pc;` |
|        - |  410 | `	sxi32 rc;` |
|   157565 |  411 | `	sState.aInstr = aInstr;` |
|   157565 |  412 | `	sState.pStack = pStack;` |
|   157565 |  413 | `	sState.nStackCap = pnBaseCap ? *pnBaseCap : 0; /* CURRENT capacity (grown on a coroutine resume) */` |
|   157565 |  414 | `	sState.nStackOrig = nStackOrig;                /* ORIGINAL capacity — fixed headroom reference */` |
|   157565 |  415 | `	sState.pResult = pResult;` |
|   157565 |  416 | `	sState.pLastRef = pLastRef;` |
|   157565 |  417 | `	sState.pEnforceRetFunc = pEnforceRetFunc;` |
|   157565 |  418 | `	sState.is_callback = (sxu8)(is_callback ? 1 : 0);` |
|   157565 |  419 | `	sState.bReturnPropagates = (sxu8)(bReturnPropagates ? 1 : 0);` |
|        - |  420 | `	/* Argument container */` |
|   157565 |  421 | `	SySetInit(&aArg,&pVm->sAllocator,sizeof(ph7_value *));` |
|   157565 |  422 | `	if( nTos < 0 ){` |
|   141799 |  423 | `		pTos = &pStack[-1];` |
|    70902 |  424 | `	}else{` |
|    15771 |  425 | `		pTos = &pStack[nTos];` |
|        - |  426 | `	}` |
|   157565 |  427 | `	sState.pTos = pTos;` |
|   157565 |  428 | `	sState.pc = nPc;` |
...
|   157560 |  446 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->pFrame == pVm->pFrame` |
|     2816 |  447 | `	 && pStack == pVm->pActiveCtx->pStack ){` |
|     1805 |  448 | `		sState.nExceptionBase = pVm->pActiveCtx->nExceptionBase;` |
|      905 |  449 | `	}else{` |
|   155765 |  450 | `		sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|        - |  451 | `	}` |
|   157565 |  452 | `	sState.pEntryFrame = pVm->pFrame;` |
|   157565 |  453 | `	pc = nPc;` |
...
|   157560 |  506 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->pInjected` |
...
|   157550 |  567 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->bClosing` |
...
| 16772952 |  603 | `		if( pVm->nBoundaryRc != 0 \|\| SySetUsed(&pVm->aHookRmw) > 0 ){` |
...
| 16772866 |  658 | `		pInstr = &aInstr[pc];` |
| 16772866 |  659 | `		if( pInstr->nLine ){` |
...
| 16560110 |  663 | `			pVm->nCurLine = pInstr->nLine;` |
|  8286380 |  664 | `		}` |
| 16772866 |  665 | `		rc = SXRET_OK;` |
|        - |  666 | `/*` |
...
|        - |  672 | ` */` |
| 16772866 |  673 | `		switch(pInstr->iOp){` |
|        - |  674 | `/*` |
|        - |  675 | ` * DONE: P1 * *` |
|        - |  676 | ` *` |
...
|        - |  679 | ` */` |
|   128750 |  680 | `case PH7_OP_DONE:` |
|   257710 |  681 | `	if( pInstr->iP2 && sState.bReturnPropagates ){` |
...
|   257521 |  711 | `	if( sState.pEnforceRetFunc && VmFuncHasReturnType(sState.pEnforceRetFunc)` |
...
|     4591 |  736 | `	}` |
|   257502 |  737 | `	if( pInstr->iP1 && pTos >= pStack ){` |
|   153018 |  738 | `		if( sState.pLastRef ){` |
|    93984 |  739 | `			*sState.pLastRef = pTos->nIdx;` |
|    47092 |  740 | `		}` |
|   153018 |  741 | `		if( sState.pResult ){` |
|        - |  742 | `			/* Execution result */` |
|   145960 |  743 | `			PH7_MemObjStore(pTos,sState.pResult);` |
|    73080 |  744 | `		}` |
|   153018 |  745 | `		VmPopOperand(&pTos,1);` |
|   181098 |  746 | `	}else if( sState.pLastRef ){` |
...
|        - |  762 | `	 */` |
|   257502 |  763 | `	rc = VmDrainFinally(&(*pVm),sState.nExceptionBase);` |
|   257502 |  764 | `	if( rc == SXERR_ABORT ){` |
|      ! 0 |  765 | `		goto Abort;` |
|        - |  766 | `	}` |
|   257502 |  767 | `	if( rc == PH7_EXCEPTION ){` |
...
|        - |  778 | `	}` |
|   257498 |  779 | `	if( sState.pEntryFrame->bHasRet && !sState.bReturnPropagates ){` |
...
|        - |  835 | ` */` |
|   288190 |  836 | `case PH7_OP_JMP:` |
|   576590 |  837 | `	pc = pInstr->iP2 - 1;` |
|   576590 |  838 | `	break;` |
|        - |  839 | `/*` |
|        - |  840 | ` * JZ: P1 P2 *` |
|        - |  841 | ` *` |
...
|  1602363 |  852 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     1001 |  853 | `		PH7_MemObjToBool(pTos);` |
|      499 |  854 | `	}` |
|  1602363 |  855 | `	if( !pTos->x.iVal ){` |
|        - |  856 | `		/* Take the jump */` |
|   897962 |  857 | `		pc = pInstr->iP2 - 1;` |
|   449239 |  858 | `	}` |
|  1602363 |  859 | `	if( !pInstr->iP1 ){` |
|  1353715 |  860 | `		VmPopOperand(&pTos,1);` |
|   677423 |  861 | `	}` |
|  1602363 |  862 | `	break;` |
|        - |  863 | `/*` |
|        - |  864 | ` * JNZ: P1 P2 *` |
...
|   183024 |  876 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      ! 0 |  877 | `		PH7_MemObjToBool(pTos);` |
|      ! 0 |  878 | `	}` |
|   183024 |  879 | `	if( pTos->x.iVal ){` |
|        - |  880 | `		/* Take the jump */` |
|     9559 |  881 | `		pc = pInstr->iP2 - 1;` |
|     4777 |  882 | `	}` |
|   183024 |  883 | `	if( !pInstr->iP1 ){` |
...
|        - |  899 | ` */` |
|   660870 |  900 | `case PH7_OP_POP: {` |
|  1322770 |  901 | `	sxi32 n = pInstr->iP1;` |
|  1322770 |  902 | `	if( &pTos[-n+1] < pStack ){` |
|        - |  903 | `		/* TICKET 1433-51 Stack underflow must be handled at run-time */` |
|       79 |  904 | `		n = (sxi32)(pTos - pStack);` |
|       38 |  905 | `	}` |
|  1322770 |  906 | `	VmPopOperand(&pTos,n);` |
|  1322770 |  907 | `	break;` |
|        - |  908 | `				 }` |
|        - |  909 | `/*` |
|        - |  910 | ` * DUP: * * *` |
...
|        - | 1163 | ` */` |
|  1512409 | 1164 | `case PH7_OP_LOADC: {` |
|        - | 1165 | `	ph7_value *pObj;` |
|        - | 1166 | `	/* Reserve a room */` |
|  3026685 | 1167 | `	pTos++;` |
|  3026685 | 1168 | `	if( pInstr->iP1 & PH7_LOADC_NOKEY ){` |
|        - | 1169 | `		/* Absent array-literal key: mark it so LOAD_MAP auto-indexes without a diagnostic */` |
|    19415 | 1170 | `		MemObjSetType(pTos,MEMOBJ_NULL);` |
|    19415 | 1171 | `		SyBlobReset(&pTos->sBlob);` |
|    19415 | 1172 | `		pTos->iFlags \|= MEMOBJ_AUX_NOKEY;` |
|    19415 | 1173 | `		pTos->nIdx = SXU32_HIGH;` |
|    19415 | 1174 | `		break;` |
|        - | 1175 | `	}` |
|  3007275 | 1176 | `	if( (pObj = (ph7_value *)SySetAt(&pVm->aLitObj,pInstr->iP2)) != 0 ){` |
|  3007275 | 1177 | `		if( (pInstr->iP1 & PH7_LOADC_EXPAND) && SyBlobLength(&pObj->sBlob) <= 64 ){` |
...
|        - | 1283 | ` */` |
|  2189531 | 1284 | `case PH7_OP_LOAD:{` |
|        - | 1285 | `	ph7_value *pObj;` |
|        - | 1286 | `	SyString sName;` |
|  4382979 | 1287 | `	if( pInstr->p3 == 0 ){` |
...
|        9 | 1299 | `	}else{` |
|  4382963 | 1300 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1301 | `		/* Reserve a room for the target object */` |
|  4382963 | 1302 | `		pTos++;` |
|        - | 1303 | `	}` |
|  4382979 | 1304 | `	if( pInstr->iP2 == 2 ){` |
...
|  4382979 | 1315 | `	pObj = VmExtractMemObj(&(*pVm),&sName,pInstr->p3 ? FALSE : TRUE,pInstr->iP1 != 1);` |
|  4382979 | 1316 | `	if( pObj == 0 ){` |
...
|  4382917 | 1341 | `	PH7_MemObjLoad(pObj,pTos);` |
|  4382917 | 1342 | `	pTos->nIdx = pObj->nIdx;` |
|  4382917 | 1343 | `	break;` |
|        - | 1344 | `				   }` |
|        - | 1345 | `/*` |
|        - | 1346 | ` * LOAD_MAP P1 * *` |
...
|        - | 1394 | ` * instead.` |
|        - | 1395 | ` */` |
|   330169 | 1396 | `case PH7_OP_LOAD_IDX: {` |
|        - | 1397 | `	VmOpRc rcOp;` |
|   661069 | 1398 | `	sState.pTos = pTos;` |
|   661069 | 1399 | `	sState.pc = pc;` |
|   661069 | 1400 | `	rcOp = VmExecOpLoadIdx(&(*pVm),&sState,pInstr);` |
|   661069 | 1401 | `	pTos = sState.pTos;` |
|   661069 | 1402 | `	pc = sState.pc;` |
|   661069 | 1403 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1404 | `		goto Abort;` |
|   661069 | 1405 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1582 | `		}` |
|    11735 | 1583 | `		break;` |
|   583757 | 1584 | `	}else if( pInstr->p3 == 0 ){` |
...
|        - | 1596 | `#endif` |
|        5 | 1597 | `	}else{` |
|   583749 | 1598 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1599 | `	}` |
|   583752 | 1600 | `	if( sName.nByte == sizeof("GLOBALS")-1` |
|   293625 | 1601 | `	 && SyMemcmp((const void *)sName.zString,(const void *)"GLOBALS",sName.nByte) == 0 ){` |
|        6 | 1602 | `		if( pInstr->p3 ){` |
...
|        - | 1639 | ` */` |
|   120573 | 1640 | `case PH7_OP_STORE_IDX:` |
|        - | 1641 | `case PH7_OP_STORE_IDX_REF: {` |
|        - | 1642 | `	VmOpRc rcOp;` |
|   241151 | 1643 | `	sState.pTos = pTos;` |
|   241151 | 1644 | `	sState.pc = pc;` |
|   241151 | 1645 | `	rcOp = VmExecOpStoreIdxRef(&(*pVm),&sState,pInstr);` |
|   241151 | 1646 | `	pTos = sState.pTos;` |
|   241151 | 1647 | `	pc = sState.pc;` |
|   241151 | 1648 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 1649 | `		goto Abort;` |
|   241149 | 1650 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2526 | ` * back.` |
|        - | 2527 | ` */` |
|    86492 | 2528 | `case PH7_OP_CAT:{` |
|        - | 2529 | `	ph7_value *pNos,*pCur;` |
|   172989 | 2530 | `	if( pInstr->iP1 < 1 ){` |
|   144545 | 2531 | `		pNos = &pTos[-1];` |
|    72275 | 2532 | `	}else{` |
|    28449 | 2533 | `		pNos = &pTos[-pInstr->iP1+1];` |
|        - | 2534 | `	}` |
|        - | 2535 | `#ifdef UNTRUST` |
|        - | 2536 | `	if( pNos < pStack ){` |
|        - | 2537 | `		goto Abort;` |
...
|   172989 | 2541 | `	if( (pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|     1921 | 2542 | `		PH7_MemObjToString(pNos);` |
|      958 | 2543 | `	}` |
|   172989 | 2544 | `	pCur = &pNos[1];` |
|   349511 | 2545 | `	while( pCur <= pTos ){` |
|   176527 | 2546 | `		if( (pCur->iFlags & MEMOBJ_STRING) == 0 ){` |
|    52203 | 2547 | `			PH7_MemObjToString(pCur);` |
|    26099 | 2548 | `		}` |
|        - | 2549 | `		/* Perform the concatenation */` |
|   176527 | 2550 | `		if( SyBlobLength(&pCur->sBlob) > 0 ){` |
|   176379 | 2551 | `			if( PH7_MemObjStringAppend(pNos,(const char *)SyBlobData(&pCur->sBlob),SyBlobLength(&pCur->sBlob)) != SXRET_OK ){` |
|        - | 2552 | `				/* Allocation failure: raise a fatal instead of a truncated concat */` |
|      ! 0 | 2553 | `				PH7_VmMemoryError(&(*pVm));` |
|      ! 0 | 2554 | `				goto Abort;` |
|        - | 2555 | `			}` |
|    88187 | 2556 | `		}` |
|   176527 | 2557 | `		SyBlobRelease(&pCur->sBlob);` |
|   176527 | 2558 | `		pCur++;` |
|        5 | 2559 | `	}` |
|   172989 | 2560 | `	pTos = pNos;` |
|   172989 | 2561 | `	break;` |
|        - | 2562 | `				}` |
|        - | 2563 | `/*  CAT_STORE: * * *` |
|        - | 2564 | ` *` |
...
|        - | 2672 | `	VmOpRc rcOp;` |
|   227118 | 2673 | `	sState.pTos = pTos;` |
|   227118 | 2674 | `	sState.pc = pc;` |
|   227118 | 2675 | `	rcOp = VmExecOpLor(&(*pVm),&sState,pInstr);` |
|   227118 | 2676 | `	pTos = sState.pTos;` |
|   227118 | 2677 | `	pc = sState.pc;` |
|   227118 | 2678 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2679 | `		goto Abort;` |
|   227118 | 2680 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2917 | ` */` |
|   227691 | 2918 | `case PH7_OP_TEQ: {` |
|        - | 2919 | `	VmOpRc rcOp;` |
|   455592 | 2920 | `	sState.pTos = pTos;` |
|   455592 | 2921 | `	sState.pc = pc;` |
|   455592 | 2922 | `	rcOp = VmExecOpTeq(&(*pVm),&sState,pInstr);` |
|   455592 | 2923 | `	pTos = sState.pTos;` |
|   455592 | 2924 | `	pc = sState.pc;` |
|   455592 | 2925 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2926 | `		goto Abort;` |
|   455592 | 2927 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2939 | ` *` |
|        - | 2940 | ` */` |
|   174055 | 2941 | `case PH7_OP_TNE: {` |
|        - | 2942 | `	VmOpRc rcOp;` |
|   348320 | 2943 | `	sState.pTos = pTos;` |
|   348320 | 2944 | `	sState.pc = pc;` |
|   348320 | 2945 | `	rcOp = VmExecOpTne(&(*pVm),&sState,pInstr);` |
|   348320 | 2946 | `	pTos = sState.pTos;` |
|   348320 | 2947 | `	pc = sState.pc;` |
|   348320 | 2948 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2949 | `		goto Abort;` |
|   348320 | 2950 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3408 | ` */` |
|   130566 | 3409 | `case PH7_OP_FOREACH_STEP: {` |
|        - | 3410 | `	VmOpRc rcOp;` |
|   261137 | 3411 | `	sState.pTos = pTos;` |
|   261137 | 3412 | `	sState.pc = pc;` |
|   261137 | 3413 | `	rcOp = VmExecOpForeachStep(&(*pVm),&sState,pInstr);` |
|   261137 | 3414 | `	pTos = sState.pTos;` |
|   261137 | 3415 | `	pc = sState.pc;` |
|   261137 | 3416 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 3417 | `		goto Abort;` |
|   261135 | 3418 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|  1040200 | 3831 | `	sxi32 nCallArgs = pInstr->iP1 + (pInstr->iP2 ? VmSpreadOwnExtra(pVm,pInstr->iP1,pTos) : 0);` |
|        - | 3832 | `	ph7_value *pArg;` |
|  1040200 | 3833 | `	pArg = &pTos[-nCallArgs];` |
...
|  1040200 | 3842 | `	VmCallArgMap *pEffCallMap = (VmCallArgMap *)pInstr->p3;` |
...
|  1040200 | 3849 | `	if( VmValueIsClosure(pVm,pTos) ){` |
...
|  1040200 | 3859 | `	if( (pTos->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|      142 | 4054 | `		break;` |
|        - | 4055 | `	}` |
|  1040040 | 4056 | `	SyStringInitFromBuf(&sName,SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
...
|  1040040 | 4060 | `	if( sName.nByte > 0 && sName.zString[0] == '\\' ){` |
...
|  1040040 | 4067 | `	pEntry = SyHashGet(&pVm->hFunction,(const void *)sName.zString,sName.nByte);` |
...
|        - | 4073 | `	{` |
|  1040040 | 4074 | `	VmCallArgMap *pCallMap = pEffCallMap;` |
|  1040040 | 4075 | `	if( pEntry == 0 && pCallMap && pCallMap->bIsNamespaced ){` |
...
|        - | 4106 | `		VmSlot sArg;` |
|        - | 4107 | `		sxu32 n;` |
|   105198 | 4108 | `		int bClosureThis = 0;` |
|   105198 | 4109 | `		ph7_class *pClosureScope = 0;` |
|        - | 4110 | `		/* initialize fields */` |
|   105198 | 4111 | `		pVmFunc = (ph7_vm_func *)pEntry->pUserData;` |
|   105198 | 4112 | `		pThis = 0;` |
|   105198 | 4113 | `		pSelf = 0;` |
...
|       14 | 4128 | `		}` |
|   105198 | 4129 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
...
|   157897 | 4236 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   105193 | 4237 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
...
|   105198 | 4244 | `		if( VmRecursionExceeded(pVm) ){` |
...
|        3 | 4248 | `			goto Abort;` |
|        - | 4249 | `		}` |
|   105196 | 4250 | `		if( pVmFunc->pNextName ){` |
...
|   105196 | 4262 | `		pSelfHint = pSelf;` |
|   105196 | 4263 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
...
|    12307 | 4267 | `			}` |
|    12820 | 4268 | `		}` |
|   105196 | 4269 | `		if( pSelf == 0 && (pVmFunc->iFlags & VM_FUNC_CLOSURE) ){` |
...
|       29 | 4280 | `			}` |
|      887 | 4281 | `		}` |
|   105196 | 4282 | `		if( SySetUsed(&pVmFunc->aAttrs) > 0 ){` |
...
|       56 | 4287 | `		}` |
|   105196 | 4288 | `		if( pVmFunc->iFlags & VM_FUNC_GENERATOR ){` |
...
|   104856 | 4520 | `		aFormalArg = (ph7_vm_func_arg *)SySetBasePtr(&pVmFunc->aArgs);` |
|        - | 4521 | `		/* Create a new VM frame  */` |
|   104856 | 4522 | `		rc = VmEnterFrame(&(*pVm),pVmFunc,pThis,&pFrame);` |
|   104856 | 4523 | `		if( rc != SXRET_OK ){` |
...
|   104856 | 4551 | `		pFrame->nActualArgs = (int)(pTos - pArg);` |
|   104856 | 4552 | `		if( pThis && ((pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) \|\| bClosureThis) ){` |
...
|    12394 | 4560 | `			}` |
|    12394 | 4561 | `		}` |
|   104856 | 4562 | `		if( SySetUsed(&pVmFunc->aStatic) > 0 ){` |
...
|        - | 4589 | `		{` |
|   104856 | 4590 | `		VmCallArgMap *pCallMap3 = pEffCallMap;` |
|        - | 4591 | `		/* Caller file's strict_types mode — governs parameter coercion` |
|        - | 4592 | `		 * (but NOT return coercion, which uses the callee's file). */` |
|   104856 | 4593 | `		int bCallIsStrict = (pCallMap3 && pCallMap3->bStrict) ? 1 : 0;` |
|   104856 | 4594 | `		if( pCallMap3 && pCallMap3->bHasNamed ){` |
|        - | 4595 | `			/* ============================================================` |
...
|        - | 4980 | `		 * ============================================================ */` |
|   104588 | 4981 | `		n = 0;` |
|   265192 | 4982 | `		while( pArg < pTos ){` |
|   160909 | 4983 | `			if( n < SySetUsed(&pVmFunc->aArgs) && (aFormalArg[n].iFlags & VM_FUNC_ARG_VARIADIC) ){` |
...
|        - | 5083 | `			}` |
|   160709 | 5084 | `			if( n < SySetUsed(&pVmFunc->aArgs) ){` |
...
|   160203 | 5091 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_UNION ){` |
...
|   160116 | 5124 | `				if( aFormalArg[n].nType > 0` |
|    87290 | 5125 | `					&& !((aFormalArg[n].iFlags & VM_FUNC_ARG_NULLABLE) && (pArg->iFlags & MEMOBJ_NULL)) ){` |
...
|       13 | 5201 | `					}` |
|     6967 | 5202 | `				}` |
|   160105 | 5203 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_BY_REF ){` |
...
|   159865 | 5255 | `					pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|        - | 5256 | `				}` |
|    80259 | 5257 | `			}else{` |
|        - | 5258 | `				char zName[32];` |
...
|        - | 5265 | `			}` |
|   160609 | 5266 | `			if( pObj ){` |
|   160373 | 5267 | `				PH7_MemObjStore(pArg,pObj);` |
|        - | 5268 | `				/* Insert argument index  */` |
|   160373 | 5269 | `				sArg.nIdx = pObj->nIdx;` |
|   160373 | 5270 | `				sArg.pUserData = 0;` |
|   160373 | 5271 | `				SySetPut(&pFrame->sArg,(const void *)&sArg);` |
|    80389 | 5272 | `			}` |
|   160609 | 5273 | `			PH7_MemObjRelease(pArg);` |
|   160609 | 5274 | `			pArg++;` |
|   160609 | 5275 | `			++n;` |
|        5 | 5276 | `		}` |
|        - | 5277 | `		} /* end named vs positional branch */` |
|        - | 5278 | `		/* Set up closure environment */` |
|   104734 | 5279 | `		if( pVmFunc->iFlags & VM_FUNC_CLOSURE ){` |
...
|   104729 | 5327 | `		if( n < SySetUsed(&pVmFunc->aArgs)` |
|    55058 | 5328 | `		 && (pVmFunc->iFlags & (VM_FUNC_INTERNAL\|VM_FUNC_CLASS_METHOD)) != VM_FUNC_INTERNAL ){` |
|        - | 5329 | `			sxu32 nNonVar,nReq;` |
|     3927 | 5330 | `			nReq = VmFuncRequiredArgCount(pVmFunc,&nNonVar);` |
|     3927 | 5331 | `			if( n < nReq ){` |
...
|   112766 | 5351 | `		while( n < SySetUsed(&pVmFunc->aArgs) ){` |
|     8303 | 5352 | `			if( aFormalArg[n].iFlags & VM_FUNC_ARG_VARIADIC ){` |
...
|        - | 5363 | `			}` |
|     8059 | 5364 | `			if( SySetUsed(&aFormalArg[n].aByteCode) > 0 ){` |
|     8057 | 5365 | `				pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|     8057 | 5366 | `				if( pObj ){` |
|        - | 5367 | `					/* Evaluate the default value and extract it's result */` |
|     8057 | 5368 | `					rc = VmLocalExec(&(*pVm),&aFormalArg[n].aByteCode,pObj,FALSE);` |
|     8057 | 5369 | `					if( rc == PH7_ABORT ){` |
|      ! 0 | 5370 | `						goto Abort;` |
|        - | 5371 | `					}` |
|        - | 5372 | `					/* Insert argument index */` |
|     8057 | 5373 | `					sArg.nIdx = pObj->nIdx;` |
|     8057 | 5374 | `					sArg.pUserData = 0;` |
|     8057 | 5375 | `					SySetPut(&pFrame->sArg,(const void *)&sArg);` |
...
|     8052 | 5380 | `					if( aFormalArg[n].nType > 0 && aFormalArg[n].nType != MEMOBJ_OBJ` |
...
|        - | 5394 | `		 */` |
|   104712 | 5395 | `		PH7_MemObjRelease(pTos);` |
|   104712 | 5396 | `		pTos = &pTos[-nCallArgs];` |
...
|        - | 5408 | `		 * per function. */` |
|        - | 5409 | `		{` |
|   104712 | 5410 | `			sxu32 nSlots = pVmFunc->nMaxStack;` |
|   104712 | 5411 | `			if( nSlots == 0 ){` |
...
|     4125 | 5418 | `			}` |
|   104712 | 5419 | `			pFrameStack = VmOperandStackAlloc(&(*pVm),nSlots);` |
|        - | 5420 | `		}` |
|   104712 | 5421 | `		if( pFrameStack == 0 ){` |
...
|   104712 | 5466 | `			VmCallFrame *pRec = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   104712 | 5467 | `			if( pRec ){` |
|   102076 | 5468 | `				pVm->pIdleCallFrames = (void *)pRec->pPrev;` |
|    51143 | 5469 | `			}else{` |
|     2641 | 5470 | `				pRec = (VmCallFrame *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmCallFrame));` |
|        - | 5471 | `			}` |
|   104712 | 5472 | `			if( pRec == 0 ){` |
...
|      ! 0 | 5483 | `				goto Abort;` |
|        - | 5484 | `			}` |
|   104712 | 5485 | `			sState.pTos = pTos;` |
|   104712 | 5486 | `			sState.pc = pc;` |
|   104712 | 5487 | `			pRec->sCaller = sState;` |
|   104712 | 5488 | `			pRec->sCall.pVmFunc = pVmFunc;` |
|   104712 | 5489 | `			pRec->sCall.pFrame = pFrame;` |
|   104712 | 5490 | `			pRec->sCall.pFrameStack = pFrameStack;` |
|   104712 | 5491 | `			pRec->sCall.nStackCap = pVmFunc->nMaxStack + VM_STACK_GUARD;` |
|   104712 | 5492 | `			pRec->sCall.nLastRef = SXU32_HIGH;` |
|   104712 | 5493 | `			pRec->sCall.bSelfPushed = (sxu8)(pSelf ? 1 : 0);` |
|   104712 | 5494 | `			pRec->pPrev = pCallTop;` |
|   104712 | 5495 | `			pCallTop = pRec;` |
|        - | 5496 | `			/* Switch to the callee activation (what the recursive` |
|        - | 5497 | `			 * VmByteCodeExec entry used to set up). */` |
|   104712 | 5498 | `			aInstr = (VmInstr *)SySetBasePtr(&pVmFunc->aByteCode);` |
|   104712 | 5499 | `			pStack = pFrameStack;` |
|   104712 | 5500 | `			pTos = &pStack[-1];` |
|   104712 | 5501 | `			pc = 0;` |
|   104712 | 5502 | `			sState.aInstr = aInstr;` |
|   104712 | 5503 | `			sState.pStack = pStack;` |
|   104712 | 5504 | `			sState.nStackCap = pRec->sCall.nStackCap; /* callee's operand-stack capacity for OP_SPREAD growth */` |
|   104712 | 5505 | `			sState.nStackOrig = pRec->sCall.nStackCap; /* fixed headroom reference (never grows) */` |
|   104712 | 5506 | `			sState.pTos = pTos;` |
|   104712 | 5507 | `			sState.pc = 0;` |
|   104712 | 5508 | `			sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|   104712 | 5509 | `			sState.pEntryFrame = pVm->pFrame;` |
|   104712 | 5510 | `			sState.pResult = pRec->sCaller.pTos;` |
|   104712 | 5511 | `			sState.pLastRef = &pRec->sCall.nLastRef;` |
|   104712 | 5512 | `			sState.pEnforceRetFunc = VmFuncHasReturnType(pVmFunc) ? pVmFunc : 0;` |
|   104712 | 5513 | `			sState.is_callback = 0;` |
|   104712 | 5514 | `			sState.bReturnPropagates = 0;` |
|   104712 | 5515 | `			goto VmLoopFetch;` |
|        - | 5516 | `		}` |
|       57 | 5517 | `	}else{` |
...
|   934847 | 5526 | `		pEntry = SyHashGet(&pVm->hHostFunction,(const void *)sName.zString,sName.nByte);` |
|        - | 5527 | `		{` |
|   934847 | 5528 | `		VmCallArgMap *pCallMap2 = pEffCallMap;` |
|   934847 | 5529 | `		if( pEntry == 0 && pCallMap2 && pCallMap2->bIsNamespaced ){` |
...
|        - | 5634 | `			}` |
|        - | 5635 | `		}` |
|   934831 | 5636 | `		pFunc = (ph7_user_func *)pEntry->pUserData;` |
...
|  1402607 | 5641 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   934826 | 5642 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
|        - | 5643 | `		/* Start collecting function arguments */` |
|   934831 | 5644 | `		SySetReset(&aArg);` |
|  2526738 | 5645 | `		while( pArg < pTos ){` |
|  1591912 | 5646 | `			SySetPut(&aArg,(const void *)&pArg);` |
|  1591912 | 5647 | `			pArg++;` |
|        5 | 5648 | `		}` |
|        - | 5649 | `		/* Assume a null return value */` |
|   934831 | 5650 | `		PH7_MemObjInit(&(*pVm),&sRet);` |
|        - | 5651 | `		/* Init the call context */` |
|   934831 | 5652 | `		VmInitCallContext(&sCtx,&(*pVm),pFunc,&sRet,0);` |
...
|   934831 | 5659 | `		sCtx.pArgMap = pEffCallMap;` |
|        - | 5660 | `		{` |
|   934831 | 5661 | `		int nGiven = (int)SySetUsed(&aArg);` |
...
|   934831 | 5667 | `		if( pFunc->nMinArg > 0 && nGiven < pFunc->nMinArg ){` |
...
|      232 | 5674 | `				nGiven);` |
|   934599 | 5675 | `		}else if( pFunc->bHasMaxArg && nGiven > (int)pFunc->nMaxArg ){` |
...
|       40 | 5688 | `				nGiven);` |
|  1401831 | 5689 | `		}else if( SXRET_OK != (rc = VmEnforceBuiltinArgTypes(&sCtx,pFunc,nGiven,` |
|   934282 | 5690 | `			(ph7_value **)SySetBasePtr(&aArg))) ){` |
|        - | 5691 | `			/* TypeError thrown: rc carries the caught/uncaught status */` |
|      112 | 5692 | `		}else{` |
|        - | 5693 | `			/* Call the foreign function */` |
|   934073 | 5694 | `			rc = pFunc->xFunc(&sCtx,nGiven,(ph7_value **)SySetBasePtr(&aArg));` |
|        - | 5695 | `		}` |
|        - | 5696 | `		}` |
|        - | 5697 | `		/* Release the call context */` |
|   934831 | 5698 | `		VmReleaseCallContext(&sCtx);` |
|   934831 | 5699 | `		if( rc == PH7_ABORT ){` |
...
|      578 | 5704 | `			goto Abort;` |
|        - | 5705 | `		}` |
|   934257 | 5706 | `		if( rc != PH7_SUSPEND && pVm->pInlineInstr == (void *)aInstr ){` |
...
|      ! 0 | 5719 | `		}` |
|   934253 | 5720 | `		if( rc == PH7_EXCEPTION ){` |
...
|      839 | 5740 | `			break;` |
|        - | 5741 | `		}` |
|   933221 | 5742 | `		if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|   911891 | 5766 | `			VmPopOperand(&pTos,nCallArgs);` |
|   456306 | 5767 | `		}` |
|        - | 5768 | `		/* Save foreign function return value into the (now top) function-name slot */` |
|   932867 | 5769 | `		PH7_MemObjStore(&sRet,pTos);` |
|   932867 | 5770 | `		PH7_MemObjRelease(&sRet);` |
|        - | 5771 | `	}` |
|   932971 | 5772 | `	break;` |
|        - | 5773 | `				  }` |
|        - | 5774 | `/*` |
...
|        - | 5792 |  |
|        - | 5793 | `		} /* Switch() */` |
| 16407182 | 5794 | `		pc++; /* Next instruction in the stream */` |
|        5 | 5795 | `	} /* For(;;) */` |
|   128850 | 5796 | `Done:` |
...
|   257910 | 5800 | `	rc = SXRET_OK;` |
|   257910 | 5801 | `	goto Unwind;` |
|      823 | 5802 | `Suspend:` |
...
|   130854 | 5860 | `	for(;;){` |
|   261508 | 5861 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|      ! 0 | 5869 | `			}` |
|     1153 | 5870 | `		}` |
|   261508 | 5871 | `		if( pCallTop == 0 ){` |
|   157211 | 5872 | `			return VmExecFinalize(&(*pVm),&sState,&aArg,pTos,rc);` |
|        - | 5873 | `		}` |
|   104302 | 5874 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|      627 | 5880 | `		}` |
|        - | 5881 | `		{` |
|   104302 | 5882 | `			VmCallFrame *pRec = pCallTop;` |
|   104302 | 5883 | `			sState = pRec->sCaller;` |
|   104302 | 5884 | `			rc = VmCallFinish(&(*pVm),&sState,&pRec->sCall,rc);` |
|   104302 | 5885 | `			pCallTop = pRec->pPrev;` |
|   104302 | 5886 | `			pRec->pPrev = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   104302 | 5887 | `			pVm->pIdleCallFrames = (void *)pRec;` |
|   104302 | 5888 | `			aInstr = sState.aInstr;` |
|   104302 | 5889 | `			pStack = sState.pStack;` |
|   104302 | 5890 | `			pTos = sState.pTos;` |
|   104302 | 5891 | `			pc = sState.pc;` |
|        - | 5892 | `		}` |
|   104302 | 5893 | `		if( rc == PH7_OK ){` |
|   103536 | 5894 | `			pc++; /* the loop-bottom increment this OP_CALL missed */` |
|   103536 | 5895 | `			goto VmLoopFetch;` |
|        - | 5896 | `		}` |
|        5 | 5897 | `	}` |
|    78785 | 5898 | `}` |
|        - | 5899 |  |
