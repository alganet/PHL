...
|        - |  162 | ` */` |
|   161840 |  163 | `static sxi32 VmExecFinalize(ph7_vm *pVm,VmExecState *pState,SySet *pArg,ph7_value *pTos,sxi32 rcTerm)` |
|        5 |  164 | `{` |
|    80920 |  165 | `	SXUNUSED(pVm);` |
|   161845 |  166 | `	if( rcTerm != PH7_SUSPEND && !pState->bReturnPropagates ){` |
|   158149 |  167 | `		VmClearFrameReturn(pState->pEntryFrame);` |
|    79072 |  168 | `	}` |
|   161845 |  169 | `	SySetRelease(pArg);` |
|   161845 |  170 | `	if( rcTerm == PH7_ABORT \|\| rcTerm == PH7_EXCEPTION ){` |
|     2841 |  171 | `		while( pTos >= pState->pStack ){` |
|     1789 |  172 | `			PH7_MemObjRelease(pTos);` |
|     1789 |  173 | `			pTos--;` |
|        5 |  174 | `		}` |
|      526 |  175 | `	}` |
|   161845 |  176 | `	return rcTerm;` |
|        5 |  177 | `}` |
|        - |  178 | `/*` |
...
|        - |  189 | ` */` |
|   104682 |  190 | `static sxi32 VmCallFinish(ph7_vm *pVm,VmExecState *pCaller,VmCallRecord *pCallee,sxi32 rc)` |
|        5 |  191 | `{` |
|        - |  192 | `	ph7_value *pObj;` |
|        - |  193 | `	/* Decrement nesting level */` |
|   104687 |  194 | `	pVm->nRecursionDepth--;` |
|   104687 |  195 | `	if( pCallee->bSelfPushed ){` |
|        - |  196 | `		/* Pop class name */` |
|    25527 |  197 | `		(void)SySetPop(&pVm->aSelf);` |
|    12761 |  198 | `	}` |
|   104687 |  199 | `	if( (pCallee->pVmFunc->iFlags & VM_FUNC_REF_RETURN) && rc == SXRET_OK ){` |
...
|       25 |  225 | `	}` |
|   104687 |  226 | `	if( rc != PH7_ABORT && ((pCallee->pFrame->iFlags & VM_FRAME_THROW) \|\| rc == PH7_EXCEPTION) ){` |
...
|   104687 |  272 | `	if( rc != PH7_SUSPEND && pCallee->pFrameStack ){` |
...
|   104553 |  276 | `		VmOperandStackRecycle(pVm,pCallee->pFrameStack,pCallee->nStackCap);` |
|    52377 |  277 | `	}` |
|        - |  278 | `	/* Leave the frame */` |
|   104687 |  279 | `	VmLeaveFrame(&(*pVm));` |
|   104687 |  280 | `	if( rc == PH7_ABORT ){` |
|      336 |  281 | `		return PH7_ABORT;` |
|        - |  282 | `	}` |
|   104355 |  283 | `	if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|        - |  291 | `	}` |
|   104355 |  292 | `	if( rc == PH7_EXCEPTION ){` |
|      469 |  293 | `		return PH7_EXCEPTION;` |
|        - |  294 | `	}` |
|   103891 |  295 | `	return PH7_OK;` |
|    52449 |  296 | `}` |
|        - |  297 | `/*` |
...
|        - |  330 | ` * nesting.` |
|        - |  331 | ` */` |
|   162198 |  332 | `PH7_PRIVATE sxi32 VmByteCodeExec(` |
...
|   162203 |  352 | `	if( VmNativeNestingExceeded(pVm) ){` |
...
|   162199 |  362 | `	nSavedBrc = pVm->nBoundaryRc;` |
|   162199 |  363 | `	pVm->nBoundaryRc = 0;` |
...
|   162199 |  370 | `	nSavedLine = pVm->nCurLine;` |
|   162199 |  371 | `	pVm->nVmExecDepth++;` |
|   243296 |  372 | `	rc = VmByteCodeExecBody(&(*pVm),aInstr,pStack,nTos,pResult,pLastRef,is_callback,nPc,` |
|    81097 |  373 | `		pEnforceRetFunc,bReturnPropagates,pAdoptSegment,ppBaseOwner,pnBaseCap,nStackOrig);` |
|   162199 |  374 | `	pVm->nVmExecDepth--;` |
|   162199 |  375 | `	pVm->nCurLine = nSavedLine;` |
|   162199 |  376 | `	if( nSavedBrc != 0 && (nSavedBrc == PH7_ABORT \|\| pVm->nBoundaryRc == 0) ){` |
|       15 |  377 | `		pVm->nBoundaryRc = nSavedBrc;` |
|        6 |  378 | `	}` |
|   162199 |  379 | `	return rc;` |
|    81104 |  380 | `}` |
|   162194 |  381 | `static sxi32 VmByteCodeExecBody(` |
...
|        - |  399 | `	ph7_value *pTos;` |
|        - |  400 | `	SySet aArg;` |
|   162199 |  401 | `	VmCallFrame *pCallTop = 0; /* Top of this invocation's in-loop call-record` |
...
|        - |  409 | `	sxi32 pc;` |
|        - |  410 | `	sxi32 rc;` |
|   162199 |  411 | `	sState.aInstr = aInstr;` |
|   162199 |  412 | `	sState.pStack = pStack;` |
|   162199 |  413 | `	sState.nStackCap = pnBaseCap ? *pnBaseCap : 0; /* CURRENT capacity (grown on a coroutine resume) */` |
|   162199 |  414 | `	sState.nStackOrig = nStackOrig;                /* ORIGINAL capacity — fixed headroom reference */` |
|   162199 |  415 | `	sState.pResult = pResult;` |
|   162199 |  416 | `	sState.pLastRef = pLastRef;` |
|   162199 |  417 | `	sState.pEnforceRetFunc = pEnforceRetFunc;` |
|   162199 |  418 | `	sState.is_callback = (sxu8)(is_callback ? 1 : 0);` |
|   162199 |  419 | `	sState.bReturnPropagates = (sxu8)(bReturnPropagates ? 1 : 0);` |
|        - |  420 | `	/* Argument container */` |
|   162199 |  421 | `	SySetInit(&aArg,&pVm->sAllocator,sizeof(ph7_value *));` |
|   162199 |  422 | `	if( nTos < 0 ){` |
|   146411 |  423 | `		pTos = &pStack[-1];` |
|    73208 |  424 | `	}else{` |
|    15793 |  425 | `		pTos = &pStack[nTos];` |
|        - |  426 | `	}` |
|   162199 |  427 | `	sState.pTos = pTos;` |
|   162199 |  428 | `	sState.pc = nPc;` |
...
|   162194 |  446 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->pFrame == pVm->pFrame` |
|     2816 |  447 | `	 && pStack == pVm->pActiveCtx->pStack ){` |
|     1805 |  448 | `		sState.nExceptionBase = pVm->pActiveCtx->nExceptionBase;` |
|      905 |  449 | `	}else{` |
|   160399 |  450 | `		sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|        - |  451 | `	}` |
|   162199 |  452 | `	sState.pEntryFrame = pVm->pFrame;` |
|   162199 |  453 | `	pc = nPc;` |
...
|   162194 |  506 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->pInjected` |
...
|   162184 |  567 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->bClosing` |
...
| 17070424 |  603 | `		if( pVm->nBoundaryRc != 0 \|\| SySetUsed(&pVm->aHookRmw) > 0 ){` |
...
| 17070324 |  658 | `		pInstr = &aInstr[pc];` |
| 17070324 |  659 | `		if( pInstr->nLine ){` |
...
| 16856779 |  663 | `			pVm->nCurLine = pInstr->nLine;` |
|  8434749 |  664 | `		}` |
| 17070324 |  665 | `		rc = SXRET_OK;` |
|        - |  666 | `/*` |
...
|        - |  672 | ` */` |
| 17070324 |  673 | `		switch(pInstr->iOp){` |
|        - |  674 | `/*` |
|        - |  675 | ` * DONE: P1 * *` |
|        - |  676 | ` *` |
...
|        - |  679 | ` */` |
|   131183 |  680 | `case PH7_OP_DONE:` |
|   262577 |  681 | `	if( pInstr->iP2 && sState.bReturnPropagates ){` |
...
|   262388 |  711 | `	if( sState.pEnforceRetFunc && VmFuncHasReturnType(sState.pEnforceRetFunc)` |
...
|     4591 |  736 | `	}` |
|   262369 |  737 | `	if( pInstr->iP1 && pTos >= pStack ){` |
|   157421 |  738 | `		if( sState.pLastRef ){` |
|    94181 |  739 | `			*sState.pLastRef = pTos->nIdx;` |
|    47191 |  740 | `		}` |
|   157421 |  741 | `		if( sState.pResult ){` |
|        - |  742 | `			/* Execution result */` |
|   150345 |  743 | `			PH7_MemObjStore(pTos,sState.pResult);` |
|    75273 |  744 | `		}` |
|   157421 |  745 | `		VmPopOperand(&pTos,1);` |
|   183764 |  746 | `	}else if( sState.pLastRef ){` |
...
|        - |  762 | `	 */` |
|   262369 |  763 | `	rc = VmDrainFinally(&(*pVm),sState.nExceptionBase);` |
|   262369 |  764 | `	if( rc == SXERR_ABORT ){` |
|      ! 0 |  765 | `		goto Abort;` |
|        - |  766 | `	}` |
|   262369 |  767 | `	if( rc == PH7_EXCEPTION ){` |
...
|        - |  778 | `	}` |
|   262365 |  779 | `	if( sState.pEntryFrame->bHasRet && !sState.bReturnPropagates ){` |
...
|        - |  835 | ` */` |
|   279766 |  836 | `case PH7_OP_JMP:` |
|   559744 |  837 | `	pc = pInstr->iP2 - 1;` |
|   559744 |  838 | `	break;` |
|        - |  839 | `/*` |
|        - |  840 | ` * JZ: P1 P2 *` |
|        - |  841 | ` *` |
...
|  1635045 |  852 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     1001 |  853 | `		PH7_MemObjToBool(pTos);` |
|      499 |  854 | `	}` |
|  1635045 |  855 | `	if( !pTos->x.iVal ){` |
|        - |  856 | `		/* Take the jump */` |
|   927745 |  857 | `		pc = pInstr->iP2 - 1;` |
|   464132 |  858 | `	}` |
|  1635045 |  859 | `	if( !pInstr->iP1 ){` |
|  1392382 |  860 | `		VmPopOperand(&pTos,1);` |
|   696760 |  861 | `	}` |
|  1635045 |  862 | `	break;` |
|        - |  863 | `/*` |
|        - |  864 | ` * JNZ: P1 P2 *` |
...
|   185061 |  876 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      ! 0 |  877 | `		PH7_MemObjToBool(pTos);` |
|      ! 0 |  878 | `	}` |
|   185061 |  879 | `	if( pTos->x.iVal ){` |
|        - |  880 | `		/* Take the jump */` |
|     9565 |  881 | `		pc = pInstr->iP2 - 1;` |
|     4780 |  882 | `	}` |
|   185061 |  883 | `	if( !pInstr->iP1 ){` |
...
|        - |  899 | ` */` |
|   683803 |  900 | `case PH7_OP_POP: {` |
|  1368642 |  901 | `	sxi32 n = pInstr->iP1;` |
|  1368642 |  902 | `	if( &pTos[-n+1] < pStack ){` |
|        - |  903 | `		/* TICKET 1433-51 Stack underflow must be handled at run-time */` |
|       79 |  904 | `		n = (sxi32)(pTos - pStack);` |
|       38 |  905 | `	}` |
|  1368642 |  906 | `	VmPopOperand(&pTos,n);` |
|  1368642 |  907 | `	break;` |
|        - |  908 | `				 }` |
|        - |  909 | `/*` |
|        - |  910 | ` * DUP: * * *` |
...
|        - |  929 | ` */` |
|    49185 |  930 | `case PH7_OP_NSSWITCH:` |
|    98375 |  931 | `	SyBlobReset(&pVm->sNamespace);` |
|    98375 |  932 | `	if( pInstr->p3 ){` |
...
|    98375 |  937 | `	SyHashRelease(&pVm->hUseConstImports);` |
|    98375 |  938 | `	SyHashInit(&pVm->hUseConstImports,&pVm->sAllocator,0,0);` |
|    98375 |  939 | `	break;` |
...
|        - | 1163 | ` */` |
|  1556828 | 1164 | `case PH7_OP_LOADC: {` |
|        - | 1165 | `	ph7_value *pObj;` |
|        - | 1166 | `	/* Reserve a room */` |
|  3115534 | 1167 | `	pTos++;` |
|  3115534 | 1168 | `	if( pInstr->iP1 & PH7_LOADC_NOKEY ){` |
...
|    19469 | 1174 | `		break;` |
|        - | 1175 | `	}` |
|  3096070 | 1176 | `	if( (pObj = (ph7_value *)SySetAt(&pVm->aLitObj,pInstr->iP2)) != 0 ){` |
|  3096070 | 1177 | `		if( (pInstr->iP1 & PH7_LOADC_EXPAND) && SyBlobLength(&pObj->sBlob) <= 64 ){` |
|        - | 1178 | `			SyHashEntry *pEntry;` |
|        - | 1179 | `			/* Check use const imports first — imports take precedence */` |
|        - | 1180 | `			{` |
|        - | 1181 | `				SyHashEntry *pConstImport;` |
|    34916 | 1182 | `				pConstImport = SyHashGet(&pVm->hUseConstImports,` |
|    23274 | 1183 | `					SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|    23279 | 1184 | `				if( pConstImport ){` |
...
|    23269 | 1199 | `			pEntry = SyHashGet(&pVm->hConstant,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|    23269 | 1200 | `			if( pEntry ){` |
|    23259 | 1201 | `				ph7_constant *pCons = (ph7_constant *)pEntry->pUserData;` |
|        - | 1202 | `				/* Set a NULL default value */` |
|    23259 | 1203 | `				MemObjSetType(pTos,MEMOBJ_NULL);` |
|    23259 | 1204 | `				SyBlobReset(&pTos->sBlob);` |
|        - | 1205 | `				/* Invoke the callback and deal with the expanded value */` |
|    23259 | 1206 | `				VmExpandConstantWithNotice(&(*pVm),pCons,pTos);` |
|        - | 1207 | `				/* Mark as constant */` |
|    23259 | 1208 | `				pTos->nIdx = SXU32_HIGH;` |
|    23259 | 1209 | `				break;` |
|        - | 1210 | `			}` |
...
|        - | 1283 | ` */` |
|  2219916 | 1284 | `case PH7_OP_LOAD:{` |
|        - | 1285 | `	ph7_value *pObj;` |
|        - | 1286 | `	SyString sName;` |
|  4443774 | 1287 | `	if( pInstr->p3 == 0 ){` |
...
|        9 | 1299 | `	}else{` |
|  4443758 | 1300 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1301 | `		/* Reserve a room for the target object */` |
|  4443758 | 1302 | `		pTos++;` |
|        - | 1303 | `	}` |
|  4443774 | 1304 | `	if( pInstr->iP2 == 2 ){` |
...
|   398420 | 1310 | `		if( VmExtractMemObj(&(*pVm),&sName,FALSE,FALSE) == 0 ){` |
|        7 | 1311 | `			VmErrorFormat(&(*pVm),PH7_CTX_WARNING,"Undefined variable $%z",&sName);` |
|        3 | 1312 | `		}` |
|   199311 | 1313 | `	}` |
|        - | 1314 | `	/* Extract the requested memory object */` |
|  4443774 | 1315 | `	pObj = VmExtractMemObj(&(*pVm),&sName,pInstr->p3 ? FALSE : TRUE,pInstr->iP1 != 1);` |
|  4443774 | 1316 | `	if( pObj == 0 ){` |
...
|  4443712 | 1341 | `	PH7_MemObjLoad(pObj,pTos);` |
|  4443712 | 1342 | `	pTos->nIdx = pObj->nIdx;` |
|  4443712 | 1343 | `	break;` |
|        - | 1344 | `				   }` |
|        - | 1345 | `/*` |
|        - | 1346 | ` * LOAD_MAP P1 * *` |
...
|        - | 1351 | ` */` |
|    36963 | 1352 | `case PH7_OP_LOAD_MAP: {` |
|        - | 1353 | `	VmOpRc rcOp;` |
|    73931 | 1354 | `	sState.pTos = pTos;` |
|    73931 | 1355 | `	sState.pc = pc;` |
|    73931 | 1356 | `	rcOp = VmExecOpLoadMap(&(*pVm),&sState,pInstr);` |
|    73931 | 1357 | `	pTos = sState.pTos;` |
|    73931 | 1358 | `	pc = sState.pc;` |
|    73931 | 1359 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1360 | `		goto Abort;` |
|    73931 | 1361 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1394 | ` * instead.` |
|        - | 1395 | ` */` |
|   333385 | 1396 | `case PH7_OP_LOAD_IDX: {` |
|        - | 1397 | `	VmOpRc rcOp;` |
|   667506 | 1398 | `	sState.pTos = pTos;` |
|   667506 | 1399 | `	sState.pc = pc;` |
|   667506 | 1400 | `	rcOp = VmExecOpLoadIdx(&(*pVm),&sState,pInstr);` |
|   667506 | 1401 | `	pTos = sState.pTos;` |
|   667506 | 1402 | `	pc = sState.pc;` |
|   667506 | 1403 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1404 | `		goto Abort;` |
|   667506 | 1405 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1582 | `		}` |
|    11771 | 1583 | `		break;` |
|   621235 | 1584 | `	}else if( pInstr->p3 == 0 ){` |
...
|        - | 1596 | `#endif` |
|        5 | 1597 | `	}else{` |
|   621227 | 1598 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1599 | `	}` |
|   621230 | 1600 | `	if( sName.nByte == sizeof("GLOBALS")-1` |
|   312361 | 1601 | `	 && SyMemcmp((const void *)sName.zString,(const void *)"GLOBALS",sName.nByte) == 0 ){` |
|        6 | 1602 | `		if( pInstr->p3 ){` |
...
|        - | 1639 | ` */` |
|   120757 | 1640 | `case PH7_OP_STORE_IDX:` |
|        - | 1641 | `case PH7_OP_STORE_IDX_REF: {` |
|        - | 1642 | `	VmOpRc rcOp;` |
|   241519 | 1643 | `	sState.pTos = pTos;` |
|   241519 | 1644 | `	sState.pc = pc;` |
|   241519 | 1645 | `	rcOp = VmExecOpStoreIdxRef(&(*pVm),&sState,pInstr);` |
|   241519 | 1646 | `	pTos = sState.pTos;` |
|   241519 | 1647 | `	pc = sState.pc;` |
|   241519 | 1648 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 1649 | `		goto Abort;` |
|   241517 | 1650 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|   368566 | 1671 | `	PH7_ENFORCE_READONLY_MUTATE(pTos->nIdx);` |
...
|   368555 | 1676 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) != 0` |
|   184387 | 1677 | `	 && SySetUsed(&pVm->aHookRmw) > 0 ){` |
...
|        - | 1694 | `		}` |
|      ! 0 | 1695 | `	}` |
|   368558 | 1696 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) == 0 ){` |
|   368558 | 1697 | `		if( pTos->nIdx != SXU32_HIGH ){` |
|        - | 1698 | `			ph7_value *pObj;` |
|   368558 | 1699 | `			if( (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pTos->nIdx)) != 0 ){` |
|   368558 | 1700 | `				if( VmStringWantsPerlIncr(pObj) ){` |
...
|   368556 | 1719 | `					if( pInstr->iP1 == 0 && (pTos->iFlags & MEMOBJ_STRING) ){` |
|        9 | 1720 | `						SyBlobNullAppend(&pTos->sBlob);` |
|        3 | 1721 | `					}` |
|        - | 1722 | `					/* Force a numeric cast on the variable */` |
|   368556 | 1723 | `					PH7_MemObjToNumeric(pObj);` |
|   368556 | 1724 | `					if( pObj->iFlags & MEMOBJ_REAL ){` |
|        5 | 1725 | `						pObj->rVal++;` |
...
|        - | 1734 | `						sxi64 r;` |
|   368552 | 1735 | `						if( PH7_ADD_OVERFLOW64(pObj->x.iVal,1,&r) ){` |
...
|        - | 1741 | `#endif` |
|        3 | 1742 | `						}else{` |
|   368548 | 1743 | `							pObj->x.iVal = r;` |
|        - | 1744 | `						}` |
|        - | 1745 | `					}` |
|   368556 | 1746 | `					if( pInstr->iP1 ){` |
...
|        - | 1785 | `		}` |
|   184379 | 1786 | `	}` |
|   368556 | 1787 | `	PH7_HOOK_RMW_WRITEBACK(pTos->nIdx,pTos);` |
|   368556 | 1788 | `	break;` |
|        - | 1789 | `/*` |
|        - | 1790 | ` * DECR: P1 * *` |
|        - | 1791 | ` *` |
...
|    70643 | 1938 | `	PH7_MemObjToNumeric(pTos);` |
|    70643 | 1939 | `	if( pTos->iFlags & MEMOBJ_REAL ){` |
|      108 | 1940 | `		pTos->rVal = -pTos->rVal;` |
|       53 | 1941 | `	}` |
|    70643 | 1942 | `	if( pTos->iFlags & MEMOBJ_INT ){` |
|    70557 | 1943 | `		if( pTos->x.iVal == SMALLEST_INT64 ){` |
...
|        - | 1958 | `#endif` |
|        3 | 1959 | `		}else{` |
|    70553 | 1960 | `			pTos->x.iVal = -pTos->x.iVal;` |
|        - | 1961 | `		}` |
|    35276 | 1962 | `	}` |
|    70643 | 1963 | `	break;` |
|        - | 1964 | `/*` |
...
|    50829 | 1997 | `	if( (pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      145 | 1998 | `		PH7_MemObjToBool(pTos);` |
|       70 | 1999 | `	}` |
|    50829 | 2000 | `	pTos->x.iVal = !pTos->x.iVal;` |
|    50829 | 2001 | `	break;` |
|        - | 2002 | `/*` |
|        - | 2003 | ` * OP_BITNOT: * * *` |
|        - | 2004 | ` *` |
...
|        - | 2526 | ` * back.` |
|        - | 2527 | ` */` |
|    86619 | 2528 | `case PH7_OP_CAT:{` |
|        - | 2529 | `	ph7_value *pNos,*pCur;` |
|   173243 | 2530 | `	if( pInstr->iP1 < 1 ){` |
|   144781 | 2531 | `		pNos = &pTos[-1];` |
|    72393 | 2532 | `	}else{` |
...
|   173243 | 2541 | `	if( (pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|     1917 | 2542 | `		PH7_MemObjToString(pNos);` |
|      956 | 2543 | `	}` |
|   173243 | 2544 | `	pCur = &pNos[1];` |
|   350019 | 2545 | `	while( pCur <= pTos ){` |
|   176781 | 2546 | `		if( (pCur->iFlags & MEMOBJ_STRING) == 0 ){` |
|    52221 | 2547 | `			PH7_MemObjToString(pCur);` |
|    26108 | 2548 | `		}` |
|        - | 2549 | `		/* Perform the concatenation */` |
|   176781 | 2550 | `		if( SyBlobLength(&pCur->sBlob) > 0 ){` |
|   176633 | 2551 | `			if( PH7_MemObjStringAppend(pNos,(const char *)SyBlobData(&pCur->sBlob),SyBlobLength(&pCur->sBlob)) != SXRET_OK ){` |
|        - | 2552 | `				/* Allocation failure: raise a fatal instead of a truncated concat */` |
|      ! 0 | 2553 | `				PH7_VmMemoryError(&(*pVm));` |
|      ! 0 | 2554 | `				goto Abort;` |
|        - | 2555 | `			}` |
|    88314 | 2556 | `		}` |
|   176781 | 2557 | `		SyBlobRelease(&pCur->sBlob);` |
|   176781 | 2558 | `		pCur++;` |
|        5 | 2559 | `	}` |
|   173243 | 2560 | `	pTos = pNos;` |
|   173243 | 2561 | `	break;` |
|        - | 2562 | `				}` |
|        - | 2563 | `/*  CAT_STORE: * * *` |
|        - | 2564 | ` *` |
...
|        - | 2566 | ` * back.` |
|        - | 2567 | ` */` |
|    13778 | 2568 | `case PH7_OP_CAT_STORE:{` |
|    27561 | 2569 | `	ph7_value *pNos = &pTos[-1];` |
|        - | 2570 | `	ph7_value *pObj;` |
|        - | 2571 | `	sxu32 nIdx;` |
|        - | 2572 | `#ifdef UNTRUST` |
|        - | 2573 | `	if( pNos < pStack ){` |
...
|    27561 | 2578 | `	if((pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|       59 | 2579 | `		PH7_MemObjToString(pNos);` |
|       29 | 2580 | `	}` |
|    27561 | 2581 | `	nIdx = pTos->nIdx;` |
...
|    27556 | 2593 | `	if( nIdx != SXU32_HIGH` |
|    27556 | 2594 | `	 && nIdx != pNos->nIdx` |
|    27552 | 2595 | `	 && (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx)) != 0` |
|    27553 | 2596 | `	 && (SyHashTotalEntry(&pVm->hTypedSlot) == 0` |
|    16374 | 2597 | `	     \|\| SyHashGet(&pVm->hTypedSlot,(const void *)&nIdx,sizeof(sxu32)) == 0) ){` |
|    27547 | 2598 | `		if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - | 2599 | `			/* e.g. $x = 5; $x .= "a";  ->  "5a" */` |
|        6 | 2600 | `			PH7_MemObjToString(pObj);` |
|        2 | 2601 | `		}` |
|    27547 | 2602 | `		if( SyBlobLength(&pNos->sBlob) > 0 ){` |
|    27543 | 2603 | `			if( PH7_MemObjStringAppend(pObj,(const char *)SyBlobData(&pNos->sBlob),SyBlobLength(&pNos->sBlob)) != SXRET_OK ){` |
...
|    27547 | 2622 | `		if( (pInstr+1)->iOp != PH7_OP_POP ){` |
...
|    27547 | 2627 | `		PH7_HOOK_RMW_WRITEBACK(nIdx,0);` |
|    27547 | 2628 | `		pNos->nIdx = SXU32_HIGH;` |
|    27547 | 2629 | `		VmPopOperand(&pTos,1);` |
|    27554 | 2630 | `		break;` |
|        - | 2631 | `	}` |
...
|        - | 2672 | `	VmOpRc rcOp;` |
|   229198 | 2673 | `	sState.pTos = pTos;` |
|   229198 | 2674 | `	sState.pc = pc;` |
|   229198 | 2675 | `	rcOp = VmExecOpLor(&(*pVm),&sState,pInstr);` |
|   229198 | 2676 | `	pTos = sState.pTos;` |
|   229198 | 2677 | `	pc = sState.pc;` |
|   229198 | 2678 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2679 | `		goto Abort;` |
|   229198 | 2680 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2917 | ` */` |
|   229004 | 2918 | `case PH7_OP_TEQ: {` |
|        - | 2919 | `	VmOpRc rcOp;` |
|   458219 | 2920 | `	sState.pTos = pTos;` |
|   458219 | 2921 | `	sState.pc = pc;` |
|   458219 | 2922 | `	rcOp = VmExecOpTeq(&(*pVm),&sState,pInstr);` |
|   458219 | 2923 | `	pTos = sState.pTos;` |
|   458219 | 2924 | `	pc = sState.pc;` |
|   458219 | 2925 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2926 | `		goto Abort;` |
|   458219 | 2927 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2939 | ` *` |
|        - | 2940 | ` */` |
|   190758 | 2941 | `case PH7_OP_TNE: {` |
|        - | 2942 | `	VmOpRc rcOp;` |
|   381727 | 2943 | `	sState.pTos = pTos;` |
|   381727 | 2944 | `	sState.pc = pc;` |
|   381727 | 2945 | `	rcOp = VmExecOpTne(&(*pVm),&sState,pInstr);` |
|   381727 | 2946 | `	pTos = sState.pTos;` |
|   381727 | 2947 | `	pc = sState.pc;` |
|   381727 | 2948 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2949 | `		goto Abort;` |
|   381727 | 2950 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2971 | ` *` |
|        - | 2972 | ` */` |
|   146250 | 2973 | `case PH7_OP_LT:` |
|        - | 2974 | `case PH7_OP_LE: {` |
|        - | 2975 | `	VmOpRc rcOp;` |
|   292918 | 2976 | `	sState.pTos = pTos;` |
|   292918 | 2977 | `	sState.pc = pc;` |
|   292918 | 2978 | `	rcOp = VmExecOpLe(&(*pVm),&sState,pInstr);` |
|   292918 | 2979 | `	pTos = sState.pTos;` |
|   292918 | 2980 | `	pc = sState.pc;` |
|   292918 | 2981 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2982 | `		goto Abort;` |
|   292918 | 2983 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3004 | ` *` |
|        - | 3005 | ` */` |
|    86343 | 3006 | `case PH7_OP_GT:` |
|        - | 3007 | `case PH7_OP_GE: {` |
|        - | 3008 | `	VmOpRc rcOp;` |
|   172897 | 3009 | `	sState.pTos = pTos;` |
|   172897 | 3010 | `	sState.pc = pc;` |
|   172897 | 3011 | `	rcOp = VmExecOpGe(&(*pVm),&sState,pInstr);` |
|   172897 | 3012 | `	pTos = sState.pTos;` |
|   172897 | 3013 | `	pc = sState.pc;` |
|   172897 | 3014 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 3015 | `		goto Abort;` |
|   172897 | 3016 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3390 | ` */` |
|    12058 | 3391 | `case PH7_OP_FOREACH_INIT: {` |
|        - | 3392 | `	VmOpRc rcOp;` |
|    24121 | 3393 | `	sState.pTos = pTos;` |
|    24121 | 3394 | `	sState.pc = pc;` |
|    24121 | 3395 | `	rcOp = VmExecOpForeachInit(&(*pVm),&sState,pInstr);` |
|    24121 | 3396 | `	pTos = sState.pTos;` |
|    24121 | 3397 | `	pc = sState.pc;` |
|    24121 | 3398 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 3399 | `		goto Abort;` |
|    24121 | 3400 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3408 | ` */` |
|   121084 | 3409 | `case PH7_OP_FOREACH_STEP: {` |
|        - | 3410 | `	VmOpRc rcOp;` |
|   242173 | 3411 | `	sState.pTos = pTos;` |
|   242173 | 3412 | `	sState.pc = pc;` |
|   242173 | 3413 | `	rcOp = VmExecOpForeachStep(&(*pVm),&sState,pInstr);` |
|   242173 | 3414 | `	pTos = sState.pTos;` |
|   242173 | 3415 | `	pc = sState.pc;` |
|   242173 | 3416 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 3417 | `		goto Abort;` |
|   242171 | 3418 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|  1041898 | 3831 | `	sxi32 nCallArgs = pInstr->iP1 + (pInstr->iP2 ? VmSpreadOwnExtra(pVm,pInstr->iP1,pTos) : 0);` |
|        - | 3832 | `	ph7_value *pArg;` |
|  1041898 | 3833 | `	pArg = &pTos[-nCallArgs];` |
...
|  1041898 | 3842 | `	VmCallArgMap *pEffCallMap = (VmCallArgMap *)pInstr->p3;` |
...
|  1041898 | 3849 | `	if( VmValueIsClosure(pVm,pTos) ){` |
...
|  1041898 | 3859 | `	if( (pTos->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|      142 | 4054 | `		break;` |
|        - | 4055 | `	}` |
|  1041738 | 4056 | `	SyStringInitFromBuf(&sName,SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
...
|  1041738 | 4060 | `	if( sName.nByte > 0 && sName.zString[0] == '\\' ){` |
...
|  1041738 | 4067 | `	pEntry = SyHashGet(&pVm->hFunction,(const void *)sName.zString,sName.nByte);` |
...
|        - | 4073 | `	{` |
|  1041738 | 4074 | `	VmCallArgMap *pCallMap = pEffCallMap;` |
|  1041738 | 4075 | `	if( pEntry == 0 && pCallMap && pCallMap->bIsNamespaced ){` |
...
|        - | 4106 | `		VmSlot sArg;` |
|        - | 4107 | `		sxu32 n;` |
|   105449 | 4108 | `		int bClosureThis = 0;` |
|   105449 | 4109 | `		ph7_class *pClosureScope = 0;` |
|        - | 4110 | `		/* initialize fields */` |
|   105449 | 4111 | `		pVmFunc = (ph7_vm_func *)pEntry->pUserData;` |
|   105449 | 4112 | `		pThis = 0;` |
|   105449 | 4113 | `		pSelf = 0;` |
...
|       14 | 4128 | `		}` |
|   105449 | 4129 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
...
|   158274 | 4236 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   105444 | 4237 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
...
|   105449 | 4244 | `		if( VmRecursionExceeded(pVm) ){` |
...
|        3 | 4248 | `			goto Abort;` |
|        - | 4249 | `		}` |
|   105447 | 4250 | `		if( pVmFunc->pNextName ){` |
...
|   105447 | 4262 | `		pSelfHint = pSelf;` |
|   105447 | 4263 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
...
|    12325 | 4267 | `			}` |
|    12838 | 4268 | `		}` |
|   105447 | 4269 | `		if( pSelf == 0 && (pVmFunc->iFlags & VM_FUNC_CLOSURE) ){` |
...
|       30 | 4280 | `			}` |
|      901 | 4281 | `		}` |
|   105447 | 4282 | `		if( SySetUsed(&pVmFunc->aAttrs) > 0 ){` |
...
|       56 | 4287 | `		}` |
|   105447 | 4288 | `		if( pVmFunc->iFlags & VM_FUNC_GENERATOR ){` |
...
|   105107 | 4520 | `		aFormalArg = (ph7_vm_func_arg *)SySetBasePtr(&pVmFunc->aArgs);` |
|        - | 4521 | `		/* Create a new VM frame  */` |
|   105107 | 4522 | `		rc = VmEnterFrame(&(*pVm),pVmFunc,pThis,&pFrame);` |
|   105107 | 4523 | `		if( rc != SXRET_OK ){` |
...
|   105107 | 4551 | `		pFrame->nActualArgs = (int)(pTos - pArg);` |
|   105107 | 4552 | `		if( pThis && ((pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) \|\| bClosureThis) ){` |
...
|    12412 | 4560 | `			}` |
|    12412 | 4561 | `		}` |
|   105107 | 4562 | `		if( SySetUsed(&pVmFunc->aStatic) > 0 ){` |
...
|        - | 4589 | `		{` |
|   105107 | 4590 | `		VmCallArgMap *pCallMap3 = pEffCallMap;` |
|        - | 4591 | `		/* Caller file's strict_types mode — governs parameter coercion` |
|        - | 4592 | `		 * (but NOT return coercion, which uses the callee's file). */` |
|   105107 | 4593 | `		int bCallIsStrict = (pCallMap3 && pCallMap3->bStrict) ? 1 : 0;` |
|   105107 | 4594 | `		if( pCallMap3 && pCallMap3->bHasNamed ){` |
|        - | 4595 | `			/* ============================================================` |
...
|        - | 4980 | `		 * ============================================================ */` |
|   104839 | 4981 | `		n = 0;` |
|   269507 | 4982 | `		while( pArg < pTos ){` |
|   164973 | 4983 | `			if( n < SySetUsed(&pVmFunc->aArgs) && (aFormalArg[n].iFlags & VM_FUNC_ARG_VARIADIC) ){` |
...
|        - | 5083 | `			}` |
|   164773 | 5084 | `			if( n < SySetUsed(&pVmFunc->aArgs) ){` |
...
|   164259 | 5091 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_UNION ){` |
...
|   164172 | 5124 | `				if( aFormalArg[n].nType > 0` |
|    89327 | 5125 | `					&& !((aFormalArg[n].iFlags & VM_FUNC_ARG_NULLABLE) && (pArg->iFlags & MEMOBJ_NULL)) ){` |
...
|       13 | 5201 | `					}` |
|     6975 | 5202 | `				}` |
|   164161 | 5203 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_BY_REF ){` |
...
|   163921 | 5255 | `					pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|        - | 5256 | `				}` |
|    82288 | 5257 | `			}else{` |
|        - | 5258 | `				char zName[32];` |
...
|        - | 5265 | `			}` |
|   164673 | 5266 | `			if( pObj ){` |
|   164437 | 5267 | `				PH7_MemObjStore(pArg,pObj);` |
|        - | 5268 | `				/* Insert argument index  */` |
|   164437 | 5269 | `				sArg.nIdx = pObj->nIdx;` |
|   164437 | 5270 | `				sArg.pUserData = 0;` |
|   164437 | 5271 | `				SySetPut(&pFrame->sArg,(const void *)&sArg);` |
|    82422 | 5272 | `			}` |
|   164673 | 5273 | `			PH7_MemObjRelease(pArg);` |
|   164673 | 5274 | `			pArg++;` |
|   164673 | 5275 | `			++n;` |
|        5 | 5276 | `		}` |
|        - | 5277 | `		} /* end named vs positional branch */` |
|        - | 5278 | `		/* Set up closure environment */` |
|   104985 | 5279 | `		if( pVmFunc->iFlags & VM_FUNC_CLOSURE ){` |
...
|   104980 | 5327 | `		if( n < SySetUsed(&pVmFunc->aArgs)` |
|    56193 | 5328 | `		 && (pVmFunc->iFlags & (VM_FUNC_INTERNAL\|VM_FUNC_CLASS_METHOD)) != VM_FUNC_INTERNAL ){` |
|        - | 5329 | `			sxu32 nNonVar,nReq;` |
|     5947 | 5330 | `			nReq = VmFuncRequiredArgCount(pVmFunc,&nNonVar);` |
|     5947 | 5331 | `			if( n < nReq ){` |
...
|   117057 | 5351 | `		while( n < SySetUsed(&pVmFunc->aArgs) ){` |
|    12343 | 5352 | `			if( aFormalArg[n].iFlags & VM_FUNC_ARG_VARIADIC ){` |
...
|        - | 5363 | `			}` |
|    12099 | 5364 | `			if( SySetUsed(&aFormalArg[n].aByteCode) > 0 ){` |
|    12097 | 5365 | `				pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|    12097 | 5366 | `				if( pObj ){` |
|        - | 5367 | `					/* Evaluate the default value and extract it's result */` |
|    12097 | 5368 | `					rc = VmLocalExec(&(*pVm),&aFormalArg[n].aByteCode,pObj,FALSE);` |
|    12097 | 5369 | `					if( rc == PH7_ABORT ){` |
|      ! 0 | 5370 | `						goto Abort;` |
|        - | 5371 | `					}` |
|        - | 5372 | `					/* Insert argument index */` |
|    12097 | 5373 | `					sArg.nIdx = pObj->nIdx;` |
|    12097 | 5374 | `					sArg.pUserData = 0;` |
|    12097 | 5375 | `					SySetPut(&pFrame->sArg,(const void *)&sArg);` |
...
|    12092 | 5380 | `					if( aFormalArg[n].nType > 0 && aFormalArg[n].nType != MEMOBJ_OBJ` |
...
|        - | 5394 | `		 */` |
|   104963 | 5395 | `		PH7_MemObjRelease(pTos);` |
|   104963 | 5396 | `		pTos = &pTos[-nCallArgs];` |
...
|        - | 5408 | `		 * per function. */` |
|        - | 5409 | `		{` |
|   104963 | 5410 | `			sxu32 nSlots = pVmFunc->nMaxStack;` |
|   104963 | 5411 | `			if( nSlots == 0 ){` |
...
|     4142 | 5418 | `			}` |
|   104963 | 5419 | `			pFrameStack = VmOperandStackAlloc(&(*pVm),nSlots);` |
|        - | 5420 | `		}` |
|   104963 | 5421 | `		if( pFrameStack == 0 ){` |
...
|   104963 | 5466 | `			VmCallFrame *pRec = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   104963 | 5467 | `			if( pRec ){` |
|   102319 | 5468 | `				pVm->pIdleCallFrames = (void *)pRec->pPrev;` |
|    51265 | 5469 | `			}else{` |
|     2649 | 5470 | `				pRec = (VmCallFrame *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmCallFrame));` |
|        - | 5471 | `			}` |
|   104963 | 5472 | `			if( pRec == 0 ){` |
...
|      ! 0 | 5483 | `				goto Abort;` |
|        - | 5484 | `			}` |
|   104963 | 5485 | `			sState.pTos = pTos;` |
|   104963 | 5486 | `			sState.pc = pc;` |
|   104963 | 5487 | `			pRec->sCaller = sState;` |
|   104963 | 5488 | `			pRec->sCall.pVmFunc = pVmFunc;` |
|   104963 | 5489 | `			pRec->sCall.pFrame = pFrame;` |
|   104963 | 5490 | `			pRec->sCall.pFrameStack = pFrameStack;` |
|   104963 | 5491 | `			pRec->sCall.nStackCap = pVmFunc->nMaxStack + VM_STACK_GUARD;` |
|   104963 | 5492 | `			pRec->sCall.nLastRef = SXU32_HIGH;` |
|   104963 | 5493 | `			pRec->sCall.bSelfPushed = (sxu8)(pSelf ? 1 : 0);` |
|   104963 | 5494 | `			pRec->pPrev = pCallTop;` |
|   104963 | 5495 | `			pCallTop = pRec;` |
|        - | 5496 | `			/* Switch to the callee activation (what the recursive` |
|        - | 5497 | `			 * VmByteCodeExec entry used to set up). */` |
|   104963 | 5498 | `			aInstr = (VmInstr *)SySetBasePtr(&pVmFunc->aByteCode);` |
|   104963 | 5499 | `			pStack = pFrameStack;` |
|   104963 | 5500 | `			pTos = &pStack[-1];` |
|   104963 | 5501 | `			pc = 0;` |
|   104963 | 5502 | `			sState.aInstr = aInstr;` |
|   104963 | 5503 | `			sState.pStack = pStack;` |
|   104963 | 5504 | `			sState.nStackCap = pRec->sCall.nStackCap; /* callee's operand-stack capacity for OP_SPREAD growth */` |
|   104963 | 5505 | `			sState.nStackOrig = pRec->sCall.nStackCap; /* fixed headroom reference (never grows) */` |
|   104963 | 5506 | `			sState.pTos = pTos;` |
|   104963 | 5507 | `			sState.pc = 0;` |
|   104963 | 5508 | `			sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|   104963 | 5509 | `			sState.pEntryFrame = pVm->pFrame;` |
|   104963 | 5510 | `			sState.pResult = pRec->sCaller.pTos;` |
|   104963 | 5511 | `			sState.pLastRef = &pRec->sCall.nLastRef;` |
|   104963 | 5512 | `			sState.pEnforceRetFunc = VmFuncHasReturnType(pVmFunc) ? pVmFunc : 0;` |
|   104963 | 5513 | `			sState.is_callback = 0;` |
|   104963 | 5514 | `			sState.bReturnPropagates = 0;` |
|   104963 | 5515 | `			goto VmLoopFetch;` |
|        - | 5516 | `		}` |
|       57 | 5517 | `	}else{` |
...
|   936294 | 5526 | `		pEntry = SyHashGet(&pVm->hHostFunction,(const void *)sName.zString,sName.nByte);` |
|        - | 5527 | `		{` |
|   936294 | 5528 | `		VmCallArgMap *pCallMap2 = pEffCallMap;` |
|   936294 | 5529 | `		if( pEntry == 0 && pCallMap2 && pCallMap2->bIsNamespaced ){` |
...
|        - | 5634 | `			}` |
|        - | 5635 | `		}` |
|   936278 | 5636 | `		pFunc = (ph7_user_func *)pEntry->pUserData;` |
...
|  1404780 | 5641 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   936273 | 5642 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
|        - | 5643 | `		/* Start collecting function arguments */` |
|   936278 | 5644 | `		SySetReset(&aArg);` |
|  2530863 | 5645 | `		while( pArg < pTos ){` |
|  1594590 | 5646 | `			SySetPut(&aArg,(const void *)&pArg);` |
|  1594590 | 5647 | `			pArg++;` |
|        5 | 5648 | `		}` |
|        - | 5649 | `		/* Assume a null return value */` |
|   936278 | 5650 | `		PH7_MemObjInit(&(*pVm),&sRet);` |
|        - | 5651 | `		/* Init the call context */` |
|   936278 | 5652 | `		VmInitCallContext(&sCtx,&(*pVm),pFunc,&sRet,0);` |
...
|   936278 | 5659 | `		sCtx.pArgMap = pEffCallMap;` |
|        - | 5660 | `		{` |
|   936278 | 5661 | `		int nGiven = (int)SySetUsed(&aArg);` |
...
|   936278 | 5667 | `		if( pFunc->nMinArg > 0 && nGiven < pFunc->nMinArg ){` |
...
|      232 | 5674 | `				nGiven);` |
|   936046 | 5675 | `		}else if( pFunc->bHasMaxArg && nGiven > (int)pFunc->nMaxArg ){` |
...
|       40 | 5688 | `				nGiven);` |
|  1404004 | 5689 | `		}else if( SXRET_OK != (rc = VmEnforceBuiltinArgTypes(&sCtx,pFunc,nGiven,` |
|   935729 | 5690 | `			(ph7_value **)SySetBasePtr(&aArg))) ){` |
|        - | 5691 | `			/* TypeError thrown: rc carries the caught/uncaught status */` |
|      112 | 5692 | `		}else{` |
|        - | 5693 | `			/* Call the foreign function */` |
|   935520 | 5694 | `			rc = pFunc->xFunc(&sCtx,nGiven,(ph7_value **)SySetBasePtr(&aArg));` |
|        - | 5695 | `		}` |
|        - | 5696 | `		}` |
|        - | 5697 | `		/* Release the call context */` |
|   936278 | 5698 | `		VmReleaseCallContext(&sCtx);` |
|   936278 | 5699 | `		if( rc == PH7_ABORT ){` |
...
|      578 | 5704 | `			goto Abort;` |
|        - | 5705 | `		}` |
|   935704 | 5706 | `		if( rc != PH7_SUSPEND && pVm->pInlineInstr == (void *)aInstr ){` |
...
|      ! 0 | 5719 | `		}` |
|   935700 | 5720 | `		if( rc == PH7_EXCEPTION ){` |
...
|      839 | 5740 | `			break;` |
|        - | 5741 | `		}` |
|   934668 | 5742 | `		if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|   913380 | 5766 | `			VmPopOperand(&pTos,nCallArgs);` |
|   457053 | 5767 | `		}` |
|        - | 5768 | `		/* Save foreign function return value into the (now top) function-name slot */` |
|   934314 | 5769 | `		PH7_MemObjStore(&sRet,pTos);` |
|   934314 | 5770 | `		PH7_MemObjRelease(&sRet);` |
|        - | 5771 | `	}` |
|   934418 | 5772 | `	break;` |
|        - | 5773 | `				  }` |
|        - | 5774 | `/*` |
...
|        - | 5777 | ` */` |
|    26082 | 5778 | `case PH7_OP_CONSUME: {` |
|        - | 5779 | `	VmOpRc rcOp;` |
|    52169 | 5780 | `	sState.pTos = pTos;` |
|    52169 | 5781 | `	sState.pc = pc;` |
|    52169 | 5782 | `	rcOp = VmExecOpConsume(&(*pVm),&sState,pInstr);` |
|    52169 | 5783 | `	pTos = sState.pTos;` |
|    52169 | 5784 | `	pc = sState.pc;` |
|    52169 | 5785 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 5786 | `		goto Abort;` |
|    52169 | 5787 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 5792 |  |
|        - | 5793 | `		} /* Switch() */` |
| 16699518 | 5794 | `		pc++; /* Next instruction in the stream */` |
|        5 | 5795 | `	} /* For(;;) */` |
|   131283 | 5796 | `Done:` |
...
|   262777 | 5800 | `	rc = SXRET_OK;` |
|   262777 | 5801 | `	goto Unwind;` |
|      823 | 5802 | `Suspend:` |
...
|   133297 | 5860 | `	for(;;){` |
|   266393 | 5861 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|      ! 0 | 5869 | `			}` |
|     1162 | 5870 | `		}` |
|   266393 | 5871 | `		if( pCallTop == 0 ){` |
|   161845 | 5872 | `			return VmExecFinalize(&(*pVm),&sState,&aArg,pTos,rc);` |
|        - | 5873 | `		}` |
|   104553 | 5874 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|      636 | 5880 | `		}` |
|        - | 5881 | `		{` |
|   104553 | 5882 | `			VmCallFrame *pRec = pCallTop;` |
|   104553 | 5883 | `			sState = pRec->sCaller;` |
|   104553 | 5884 | `			rc = VmCallFinish(&(*pVm),&sState,&pRec->sCall,rc);` |
|   104553 | 5885 | `			pCallTop = pRec->pPrev;` |
|   104553 | 5886 | `			pRec->pPrev = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   104553 | 5887 | `			pVm->pIdleCallFrames = (void *)pRec;` |
|   104553 | 5888 | `			aInstr = sState.aInstr;` |
|   104553 | 5889 | `			pStack = sState.pStack;` |
|   104553 | 5890 | `			pTos = sState.pTos;` |
|   104553 | 5891 | `			pc = sState.pc;` |
|        - | 5892 | `		}` |
|   104553 | 5893 | `		if( rc == PH7_OK ){` |
|   103787 | 5894 | `			pc++; /* the loop-bottom increment this OP_CALL missed */` |
|   103787 | 5895 | `			goto VmLoopFetch;` |
|        - | 5896 | `		}` |
|        5 | 5897 | `	}` |
|    81102 | 5898 | `}` |
|        - | 5899 |  |
