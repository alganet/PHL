...
|        - |  162 | ` */` |
|   161404 |  163 | `static sxi32 VmExecFinalize(ph7_vm *pVm,VmExecState *pState,SySet *pArg,ph7_value *pTos,sxi32 rcTerm)` |
|        5 |  164 | `{` |
|    80702 |  165 | `	SXUNUSED(pVm);` |
|   161409 |  166 | `	if( rcTerm != PH7_SUSPEND && !pState->bReturnPropagates ){` |
|   157713 |  167 | `		VmClearFrameReturn(pState->pEntryFrame);` |
|    78854 |  168 | `	}` |
|   161409 |  169 | `	SySetRelease(pArg);` |
|   161409 |  170 | `	if( rcTerm == PH7_ABORT \|\| rcTerm == PH7_EXCEPTION ){` |
|     2841 |  171 | `		while( pTos >= pState->pStack ){` |
|     1789 |  172 | `			PH7_MemObjRelease(pTos);` |
|     1789 |  173 | `			pTos--;` |
|        5 |  174 | `		}` |
|      526 |  175 | `	}` |
|   161409 |  176 | `	return rcTerm;` |
|        5 |  177 | `}` |
|        - |  178 | `/*` |
...
|        - |  189 | ` */` |
|   105298 |  190 | `static sxi32 VmCallFinish(ph7_vm *pVm,VmExecState *pCaller,VmCallRecord *pCallee,sxi32 rc)` |
|        5 |  191 | `{` |
|        - |  192 | `	ph7_value *pObj;` |
|        - |  193 | `	/* Decrement nesting level */` |
|   105303 |  194 | `	pVm->nRecursionDepth--;` |
|   105303 |  195 | `	if( pCallee->bSelfPushed ){` |
|        - |  196 | `		/* Pop class name */` |
|    25521 |  197 | `		(void)SySetPop(&pVm->aSelf);` |
|    12758 |  198 | `	}` |
|   105303 |  199 | `	if( (pCallee->pVmFunc->iFlags & VM_FUNC_REF_RETURN) && rc == SXRET_OK ){` |
...
|       25 |  225 | `	}` |
|   105303 |  226 | `	if( rc != PH7_ABORT && ((pCallee->pFrame->iFlags & VM_FRAME_THROW) \|\| rc == PH7_EXCEPTION) ){` |
...
|   105303 |  272 | `	if( rc != PH7_SUSPEND && pCallee->pFrameStack ){` |
...
|   105169 |  276 | `		VmOperandStackRecycle(pVm,pCallee->pFrameStack,pCallee->nStackCap);` |
|    52686 |  277 | `	}` |
|        - |  278 | `	/* Leave the frame */` |
|   105303 |  279 | `	VmLeaveFrame(&(*pVm));` |
|   105303 |  280 | `	if( rc == PH7_ABORT ){` |
|      336 |  281 | `		return PH7_ABORT;` |
|        - |  282 | `	}` |
|   104971 |  283 | `	if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|        - |  291 | `	}` |
|   104971 |  292 | `	if( rc == PH7_EXCEPTION ){` |
|      469 |  293 | `		return PH7_EXCEPTION;` |
|        - |  294 | `	}` |
|   104507 |  295 | `	return PH7_OK;` |
|    52758 |  296 | `}` |
|        - |  297 | `/*` |
...
|        - |  330 | ` * nesting.` |
|        - |  331 | ` */` |
|   161762 |  332 | `PH7_PRIVATE sxi32 VmByteCodeExec(` |
...
|   161767 |  352 | `	if( VmNativeNestingExceeded(pVm) ){` |
...
|   161763 |  362 | `	nSavedBrc = pVm->nBoundaryRc;` |
|   161763 |  363 | `	pVm->nBoundaryRc = 0;` |
...
|   161763 |  370 | `	nSavedLine = pVm->nCurLine;` |
|   161763 |  371 | `	pVm->nVmExecDepth++;` |
|   242642 |  372 | `	rc = VmByteCodeExecBody(&(*pVm),aInstr,pStack,nTos,pResult,pLastRef,is_callback,nPc,` |
|    80879 |  373 | `		pEnforceRetFunc,bReturnPropagates,pAdoptSegment,ppBaseOwner,pnBaseCap,nStackOrig);` |
|   161763 |  374 | `	pVm->nVmExecDepth--;` |
|   161763 |  375 | `	pVm->nCurLine = nSavedLine;` |
|   161763 |  376 | `	if( nSavedBrc != 0 && (nSavedBrc == PH7_ABORT \|\| pVm->nBoundaryRc == 0) ){` |
|       15 |  377 | `		pVm->nBoundaryRc = nSavedBrc;` |
|        6 |  378 | `	}` |
|   161763 |  379 | `	return rc;` |
|    80886 |  380 | `}` |
|   161758 |  381 | `static sxi32 VmByteCodeExecBody(` |
...
|        - |  399 | `	ph7_value *pTos;` |
|        - |  400 | `	SySet aArg;` |
|   161763 |  401 | `	VmCallFrame *pCallTop = 0; /* Top of this invocation's in-loop call-record` |
...
|        - |  409 | `	sxi32 pc;` |
|        - |  410 | `	sxi32 rc;` |
|   161763 |  411 | `	sState.aInstr = aInstr;` |
|   161763 |  412 | `	sState.pStack = pStack;` |
|   161763 |  413 | `	sState.nStackCap = pnBaseCap ? *pnBaseCap : 0; /* CURRENT capacity (grown on a coroutine resume) */` |
|   161763 |  414 | `	sState.nStackOrig = nStackOrig;                /* ORIGINAL capacity — fixed headroom reference */` |
|   161763 |  415 | `	sState.pResult = pResult;` |
|   161763 |  416 | `	sState.pLastRef = pLastRef;` |
|   161763 |  417 | `	sState.pEnforceRetFunc = pEnforceRetFunc;` |
|   161763 |  418 | `	sState.is_callback = (sxu8)(is_callback ? 1 : 0);` |
|   161763 |  419 | `	sState.bReturnPropagates = (sxu8)(bReturnPropagates ? 1 : 0);` |
|        - |  420 | `	/* Argument container */` |
|   161763 |  421 | `	SySetInit(&aArg,&pVm->sAllocator,sizeof(ph7_value *));` |
|   161763 |  422 | `	if( nTos < 0 ){` |
|   145965 |  423 | `		pTos = &pStack[-1];` |
|    72985 |  424 | `	}else{` |
|    15803 |  425 | `		pTos = &pStack[nTos];` |
|        - |  426 | `	}` |
|   161763 |  427 | `	sState.pTos = pTos;` |
|   161763 |  428 | `	sState.pc = nPc;` |
...
|   161758 |  446 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->pFrame == pVm->pFrame` |
|     2816 |  447 | `	 && pStack == pVm->pActiveCtx->pStack ){` |
|     1805 |  448 | `		sState.nExceptionBase = pVm->pActiveCtx->nExceptionBase;` |
|      905 |  449 | `	}else{` |
|   159963 |  450 | `		sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|        - |  451 | `	}` |
|   161763 |  452 | `	sState.pEntryFrame = pVm->pFrame;` |
|   161763 |  453 | `	pc = nPc;` |
...
|   161758 |  506 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->pInjected` |
...
|   161748 |  567 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->bClosing` |
...
| 17185378 |  603 | `		if( pVm->nBoundaryRc != 0 \|\| SySetUsed(&pVm->aHookRmw) > 0 ){` |
...
| 17185278 |  658 | `		pInstr = &aInstr[pc];` |
| 17185278 |  659 | `		if( pInstr->nLine ){` |
...
| 16972407 |  663 | `			pVm->nCurLine = pInstr->nLine;` |
|  8492623 |  664 | `		}` |
| 17185278 |  665 | `		rc = SXRET_OK;` |
|        - |  666 | `/*` |
...
|        - |  672 | ` */` |
| 17185278 |  673 | `		switch(pInstr->iOp){` |
|        - |  674 | `/*` |
|        - |  675 | ` * DONE: P1 * *` |
|        - |  676 | ` *` |
...
|        - |  679 | ` */` |
|   131272 |  680 | `case PH7_OP_DONE:` |
|   262757 |  681 | `	if( pInstr->iP2 && sState.bReturnPropagates ){` |
...
|   262568 |  711 | `	if( sState.pEnforceRetFunc && VmFuncHasReturnType(sState.pEnforceRetFunc)` |
...
|     4591 |  736 | `	}` |
|   262549 |  737 | `	if( pInstr->iP1 && pTos >= pStack ){` |
|   157879 |  738 | `		if( sState.pLastRef ){` |
|    94791 |  739 | `			*sState.pLastRef = pTos->nIdx;` |
|    47497 |  740 | `		}` |
|   157879 |  741 | `		if( sState.pResult ){` |
|        - |  742 | `			/* Execution result */` |
|   150797 |  743 | `			PH7_MemObjStore(pTos,sState.pResult);` |
|    75500 |  744 | `		}` |
|   157879 |  745 | `		VmPopOperand(&pTos,1);` |
|   183716 |  746 | `	}else if( sState.pLastRef ){` |
...
|        - |  762 | `	 */` |
|   262549 |  763 | `	rc = VmDrainFinally(&(*pVm),sState.nExceptionBase);` |
|   262549 |  764 | `	if( rc == SXERR_ABORT ){` |
|      ! 0 |  765 | `		goto Abort;` |
|        - |  766 | `	}` |
|   262549 |  767 | `	if( rc == PH7_EXCEPTION ){` |
...
|        - |  778 | `	}` |
|   262545 |  779 | `	if( sState.pEntryFrame->bHasRet && !sState.bReturnPropagates ){` |
...
|        - |  835 | ` */` |
|   281594 |  836 | `case PH7_OP_JMP:` |
|   563400 |  837 | `	pc = pInstr->iP2 - 1;` |
|   563400 |  838 | `	break;` |
|        - |  839 | `/*` |
|        - |  840 | ` * JZ: P1 P2 *` |
|        - |  841 | ` *` |
...
|  1646801 |  852 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     1003 |  853 | `		PH7_MemObjToBool(pTos);` |
|      500 |  854 | `	}` |
|  1646801 |  855 | `	if( !pTos->x.iVal ){` |
|        - |  856 | `		/* Take the jump */` |
|   934566 |  857 | `		pc = pInstr->iP2 - 1;` |
|   467544 |  858 | `	}` |
|  1646801 |  859 | `	if( !pInstr->iP1 ){` |
|  1403421 |  860 | `		VmPopOperand(&pTos,1);` |
|   702283 |  861 | `	}` |
|  1646801 |  862 | `	break;` |
|        - |  863 | `/*` |
|        - |  864 | ` * JNZ: P1 P2 *` |
...
|   187823 |  876 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      ! 0 |  877 | `		PH7_MemObjToBool(pTos);` |
|      ! 0 |  878 | `	}` |
|   187823 |  879 | `	if( pTos->x.iVal ){` |
|        - |  880 | `		/* Take the jump */` |
|     9571 |  881 | `		pc = pInstr->iP2 - 1;` |
|     4783 |  882 | `	}` |
|   187823 |  883 | `	if( !pInstr->iP1 ){` |
...
|        - |  899 | ` */` |
|   688093 |  900 | `case PH7_OP_POP: {` |
|  1377230 |  901 | `	sxi32 n = pInstr->iP1;` |
|  1377230 |  902 | `	if( &pTos[-n+1] < pStack ){` |
|        - |  903 | `		/* TICKET 1433-51 Stack underflow must be handled at run-time */` |
|       79 |  904 | `		n = (sxi32)(pTos - pStack);` |
|       38 |  905 | `	}` |
|  1377230 |  906 | `	VmPopOperand(&pTos,n);` |
|  1377230 |  907 | `	break;` |
|        - |  908 | `				 }` |
|        - |  909 | `/*` |
|        - |  910 | ` * DUP: * * *` |
...
|        - |  929 | ` */` |
|    49037 |  930 | `case PH7_OP_NSSWITCH:` |
|    98079 |  931 | `	SyBlobReset(&pVm->sNamespace);` |
|    98079 |  932 | `	if( pInstr->p3 ){` |
...
|    98079 |  937 | `	SyHashRelease(&pVm->hUseConstImports);` |
|    98079 |  938 | `	SyHashInit(&pVm->hUseConstImports,&pVm->sAllocator,0,0);` |
|    98079 |  939 | `	break;` |
...
|        - | 1163 | ` */` |
|  1562211 | 1164 | `case PH7_OP_LOADC: {` |
|        - | 1165 | `	ph7_value *pObj;` |
|        - | 1166 | `	/* Reserve a room */` |
|  3126310 | 1167 | `	pTos++;` |
|  3126310 | 1168 | `	if( pInstr->iP1 & PH7_LOADC_NOKEY ){` |
...
|    19495 | 1174 | `		break;` |
|        - | 1175 | `	}` |
|  3106820 | 1176 | `	if( (pObj = (ph7_value *)SySetAt(&pVm->aLitObj,pInstr->iP2)) != 0 ){` |
|  3106820 | 1177 | `		if( (pInstr->iP1 & PH7_LOADC_EXPAND) && SyBlobLength(&pObj->sBlob) <= 64 ){` |
|        - | 1178 | `			SyHashEntry *pEntry;` |
|        - | 1179 | `			/* Check use const imports first — imports take precedence */` |
|        - | 1180 | `			{` |
|        - | 1181 | `				SyHashEntry *pConstImport;` |
|    34937 | 1182 | `				pConstImport = SyHashGet(&pVm->hUseConstImports,` |
|    23288 | 1183 | `					SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|    23293 | 1184 | `				if( pConstImport ){` |
...
|    23283 | 1199 | `			pEntry = SyHashGet(&pVm->hConstant,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|    23283 | 1200 | `			if( pEntry ){` |
|    23273 | 1201 | `				ph7_constant *pCons = (ph7_constant *)pEntry->pUserData;` |
|        - | 1202 | `				/* Set a NULL default value */` |
|    23273 | 1203 | `				MemObjSetType(pTos,MEMOBJ_NULL);` |
|    23273 | 1204 | `				SyBlobReset(&pTos->sBlob);` |
|        - | 1205 | `				/* Invoke the callback and deal with the expanded value */` |
|    23273 | 1206 | `				VmExpandConstantWithNotice(&(*pVm),pCons,pTos);` |
|        - | 1207 | `				/* Mark as constant */` |
|    23273 | 1208 | `				pTos->nIdx = SXU32_HIGH;` |
|    23273 | 1209 | `				break;` |
|        - | 1210 | `			}` |
...
|        - | 1283 | ` */` |
|  2240189 | 1284 | `case PH7_OP_LOAD:{` |
|        - | 1285 | `	ph7_value *pObj;` |
|        - | 1286 | `	SyString sName;` |
|  4484346 | 1287 | `	if( pInstr->p3 == 0 ){` |
...
|        9 | 1299 | `	}else{` |
|  4484330 | 1300 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1301 | `		/* Reserve a room for the target object */` |
|  4484330 | 1302 | `		pTos++;` |
|        - | 1303 | `	}` |
|  4484346 | 1304 | `	if( pInstr->iP2 == 2 ){` |
...
|   403606 | 1310 | `		if( VmExtractMemObj(&(*pVm),&sName,FALSE,FALSE) == 0 ){` |
|        7 | 1311 | `			VmErrorFormat(&(*pVm),PH7_CTX_WARNING,"Undefined variable $%z",&sName);` |
|        3 | 1312 | `		}` |
|   201904 | 1313 | `	}` |
|        - | 1314 | `	/* Extract the requested memory object */` |
|  4484346 | 1315 | `	pObj = VmExtractMemObj(&(*pVm),&sName,pInstr->p3 ? FALSE : TRUE,pInstr->iP1 != 1);` |
|  4484346 | 1316 | `	if( pObj == 0 ){` |
...
|  4484284 | 1341 | `	PH7_MemObjLoad(pObj,pTos);` |
|  4484284 | 1342 | `	pTos->nIdx = pObj->nIdx;` |
|  4484284 | 1343 | `	break;` |
|        - | 1344 | `				   }` |
|        - | 1345 | `/*` |
|        - | 1346 | ` * LOAD_MAP P1 * *` |
...
|        - | 1351 | ` */` |
|    36979 | 1352 | `case PH7_OP_LOAD_MAP: {` |
|        - | 1353 | `	VmOpRc rcOp;` |
|    73963 | 1354 | `	sState.pTos = pTos;` |
|    73963 | 1355 | `	sState.pc = pc;` |
|    73963 | 1356 | `	rcOp = VmExecOpLoadMap(&(*pVm),&sState,pInstr);` |
|    73963 | 1357 | `	pTos = sState.pTos;` |
|    73963 | 1358 | `	pc = sState.pc;` |
|    73963 | 1359 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1360 | `		goto Abort;` |
|    73963 | 1361 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1394 | ` * instead.` |
|        - | 1395 | ` */` |
|   337515 | 1396 | `case PH7_OP_LOAD_IDX: {` |
|        - | 1397 | `	VmOpRc rcOp;` |
|   675770 | 1398 | `	sState.pTos = pTos;` |
|   675770 | 1399 | `	sState.pc = pc;` |
|   675770 | 1400 | `	rcOp = VmExecOpLoadIdx(&(*pVm),&sState,pInstr);` |
|   675770 | 1401 | `	pTos = sState.pTos;` |
|   675770 | 1402 | `	pc = sState.pc;` |
|   675770 | 1403 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1404 | `		goto Abort;` |
|   675770 | 1405 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1582 | `		}` |
|    11771 | 1583 | `		break;` |
|   623805 | 1584 | `	}else if( pInstr->p3 == 0 ){` |
...
|        - | 1596 | `#endif` |
|        5 | 1597 | `	}else{` |
|   623797 | 1598 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1599 | `	}` |
|   623800 | 1600 | `	if( sName.nByte == sizeof("GLOBALS")-1` |
|   313652 | 1601 | `	 && SyMemcmp((const void *)sName.zString,(const void *)"GLOBALS",sName.nByte) == 0 ){` |
|        6 | 1602 | `		if( pInstr->p3 ){` |
...
|        - | 1639 | ` */` |
|   121190 | 1640 | `case PH7_OP_STORE_IDX:` |
|        - | 1641 | `case PH7_OP_STORE_IDX_REF: {` |
|        - | 1642 | `	VmOpRc rcOp;` |
|   242385 | 1643 | `	sState.pTos = pTos;` |
|   242385 | 1644 | `	sState.pc = pc;` |
|   242385 | 1645 | `	rcOp = VmExecOpStoreIdxRef(&(*pVm),&sState,pInstr);` |
|   242385 | 1646 | `	pTos = sState.pTos;` |
|   242385 | 1647 | `	pc = sState.pc;` |
|   242385 | 1648 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 1649 | `		goto Abort;` |
|   242383 | 1650 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|   373789 | 1671 | `	PH7_ENFORCE_READONLY_MUTATE(pTos->nIdx);` |
...
|   373778 | 1676 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) != 0` |
|   186999 | 1677 | `	 && SySetUsed(&pVm->aHookRmw) > 0 ){` |
...
|        - | 1694 | `		}` |
|      ! 0 | 1695 | `	}` |
|   373781 | 1696 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) == 0 ){` |
|   373781 | 1697 | `		if( pTos->nIdx != SXU32_HIGH ){` |
|        - | 1698 | `			ph7_value *pObj;` |
|   373781 | 1699 | `			if( (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pTos->nIdx)) != 0 ){` |
|   373781 | 1700 | `				if( VmStringWantsPerlIncr(pObj) ){` |
...
|   373779 | 1719 | `					if( pInstr->iP1 == 0 && (pTos->iFlags & MEMOBJ_STRING) ){` |
|        9 | 1720 | `						SyBlobNullAppend(&pTos->sBlob);` |
|        3 | 1721 | `					}` |
|        - | 1722 | `					/* Force a numeric cast on the variable */` |
|   373779 | 1723 | `					PH7_MemObjToNumeric(pObj);` |
|   373779 | 1724 | `					if( pObj->iFlags & MEMOBJ_REAL ){` |
|        5 | 1725 | `						pObj->rVal++;` |
...
|        - | 1734 | `						sxi64 r;` |
|   373775 | 1735 | `						if( PH7_ADD_OVERFLOW64(pObj->x.iVal,1,&r) ){` |
...
|        - | 1741 | `#endif` |
|        3 | 1742 | `						}else{` |
|   373771 | 1743 | `							pObj->x.iVal = r;` |
|        - | 1744 | `						}` |
|        - | 1745 | `					}` |
|   373779 | 1746 | `					if( pInstr->iP1 ){` |
...
|        - | 1785 | `		}` |
|   186991 | 1786 | `	}` |
|   373779 | 1787 | `	PH7_HOOK_RMW_WRITEBACK(pTos->nIdx,pTos);` |
|   373779 | 1788 | `	break;` |
|        - | 1789 | `/*` |
|        - | 1790 | ` * DECR: P1 * *` |
|        - | 1791 | ` *` |
...
|    50790 | 1997 | `	if( (pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      159 | 1998 | `		PH7_MemObjToBool(pTos);` |
|       77 | 1999 | `	}` |
|    50790 | 2000 | `	pTos->x.iVal = !pTos->x.iVal;` |
|    50790 | 2001 | `	break;` |
|        - | 2002 | `/*` |
|        - | 2003 | ` * OP_BITNOT: * * *` |
|        - | 2004 | ` *` |
...
|        - | 2169 | ` */` |
|    12042 | 2170 | `case PH7_OP_SUB: {` |
|        - | 2171 | `	VmOpRc rcOp;` |
|    24200 | 2172 | `	sState.pTos = pTos;` |
|    24200 | 2173 | `	sState.pc = pc;` |
|    24200 | 2174 | `	rcOp = VmExecOpSub(&(*pVm),&sState,pInstr);` |
|    24200 | 2175 | `	pTos = sState.pTos;` |
|    24200 | 2176 | `	pc = sState.pc;` |
|    24200 | 2177 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2178 | `		goto Abort;` |
|    24200 | 2179 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2526 | ` * back.` |
|        - | 2527 | ` */` |
|    86681 | 2528 | `case PH7_OP_CAT:{` |
|        - | 2529 | `	ph7_value *pNos,*pCur;` |
|   173367 | 2530 | `	if( pInstr->iP1 < 1 ){` |
|   144695 | 2531 | `		pNos = &pTos[-1];` |
|    72350 | 2532 | `	}else{` |
...
|   173367 | 2541 | `	if( (pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|     1909 | 2542 | `		PH7_MemObjToString(pNos);` |
|      952 | 2543 | `	}` |
|   173367 | 2544 | `	pCur = &pNos[1];` |
|   350313 | 2545 | `	while( pCur <= pTos ){` |
|   176951 | 2546 | `		if( (pCur->iFlags & MEMOBJ_STRING) == 0 ){` |
|    52449 | 2547 | `			PH7_MemObjToString(pCur);` |
|    26222 | 2548 | `		}` |
|        - | 2549 | `		/* Perform the concatenation */` |
|   176951 | 2550 | `		if( SyBlobLength(&pCur->sBlob) > 0 ){` |
|   176803 | 2551 | `			if( PH7_MemObjStringAppend(pNos,(const char *)SyBlobData(&pCur->sBlob),SyBlobLength(&pCur->sBlob)) != SXRET_OK ){` |
|        - | 2552 | `				/* Allocation failure: raise a fatal instead of a truncated concat */` |
|      ! 0 | 2553 | `				PH7_VmMemoryError(&(*pVm));` |
|      ! 0 | 2554 | `				goto Abort;` |
|        - | 2555 | `			}` |
|    88399 | 2556 | `		}` |
|   176951 | 2557 | `		SyBlobRelease(&pCur->sBlob);` |
|   176951 | 2558 | `		pCur++;` |
|        5 | 2559 | `	}` |
|   173367 | 2560 | `	pTos = pNos;` |
|   173367 | 2561 | `	break;` |
|        - | 2562 | `				}` |
|        - | 2563 | `/*  CAT_STORE: * * *` |
|        - | 2564 | ` *` |
...
|        - | 2566 | ` * back.` |
|        - | 2567 | ` */` |
|    13760 | 2568 | `case PH7_OP_CAT_STORE:{` |
|    27524 | 2569 | `	ph7_value *pNos = &pTos[-1];` |
|        - | 2570 | `	ph7_value *pObj;` |
|        - | 2571 | `	sxu32 nIdx;` |
|        - | 2572 | `#ifdef UNTRUST` |
|        - | 2573 | `	if( pNos < pStack ){` |
...
|    27524 | 2578 | `	if((pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|       59 | 2579 | `		PH7_MemObjToString(pNos);` |
|       29 | 2580 | `	}` |
|    27524 | 2581 | `	nIdx = pTos->nIdx;` |
...
|    27519 | 2593 | `	if( nIdx != SXU32_HIGH` |
|    27519 | 2594 | `	 && nIdx != pNos->nIdx` |
|    27515 | 2595 | `	 && (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx)) != 0` |
|    27516 | 2596 | `	 && (SyHashTotalEntry(&pVm->hTypedSlot) == 0` |
|    16355 | 2597 | `	     \|\| SyHashGet(&pVm->hTypedSlot,(const void *)&nIdx,sizeof(sxu32)) == 0) ){` |
|    27510 | 2598 | `		if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - | 2599 | `			/* e.g. $x = 5; $x .= "a";  ->  "5a" */` |
|        6 | 2600 | `			PH7_MemObjToString(pObj);` |
|        2 | 2601 | `		}` |
|    27510 | 2602 | `		if( SyBlobLength(&pNos->sBlob) > 0 ){` |
|    27506 | 2603 | `			if( PH7_MemObjStringAppend(pObj,(const char *)SyBlobData(&pNos->sBlob),SyBlobLength(&pNos->sBlob)) != SXRET_OK ){` |
...
|    27510 | 2622 | `		if( (pInstr+1)->iOp != PH7_OP_POP ){` |
...
|    27510 | 2627 | `		PH7_HOOK_RMW_WRITEBACK(nIdx,0);` |
|    27510 | 2628 | `		pNos->nIdx = SXU32_HIGH;` |
|    27510 | 2629 | `		VmPopOperand(&pTos,1);` |
|    27517 | 2630 | `		break;` |
|        - | 2631 | `	}` |
...
|        - | 2668 | ` * stack.` |
|        - | 2669 | ` */` |
|   115875 | 2670 | `case PH7_OP_LAND:` |
|        - | 2671 | `case PH7_OP_LOR: {` |
|        - | 2672 | `	VmOpRc rcOp;` |
|   231963 | 2673 | `	sState.pTos = pTos;` |
|   231963 | 2674 | `	sState.pc = pc;` |
|   231963 | 2675 | `	rcOp = VmExecOpLor(&(*pVm),&sState,pInstr);` |
|   231963 | 2676 | `	pTos = sState.pTos;` |
|   231963 | 2677 | `	pc = sState.pc;` |
|   231963 | 2678 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2679 | `		goto Abort;` |
|   231963 | 2680 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2917 | ` */` |
|   230714 | 2918 | `case PH7_OP_TEQ: {` |
|        - | 2919 | `	VmOpRc rcOp;` |
|   461641 | 2920 | `	sState.pTos = pTos;` |
|   461641 | 2921 | `	sState.pc = pc;` |
|   461641 | 2922 | `	rcOp = VmExecOpTeq(&(*pVm),&sState,pInstr);` |
|   461641 | 2923 | `	pTos = sState.pTos;` |
|   461641 | 2924 | `	pc = sState.pc;` |
|   461641 | 2925 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2926 | `		goto Abort;` |
|   461641 | 2927 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2939 | ` *` |
|        - | 2940 | ` */` |
|   192455 | 2941 | `case PH7_OP_TNE: {` |
|        - | 2942 | `	VmOpRc rcOp;` |
|   385123 | 2943 | `	sState.pTos = pTos;` |
|   385123 | 2944 | `	sState.pc = pc;` |
|   385123 | 2945 | `	rcOp = VmExecOpTne(&(*pVm),&sState,pInstr);` |
|   385123 | 2946 | `	pTos = sState.pTos;` |
|   385123 | 2947 | `	pc = sState.pc;` |
|   385123 | 2948 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2949 | `		goto Abort;` |
|   385123 | 2950 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2971 | ` *` |
|        - | 2972 | ` */` |
|   148054 | 2973 | `case PH7_OP_LT:` |
|        - | 2974 | `case PH7_OP_LE: {` |
|        - | 2975 | `	VmOpRc rcOp;` |
|   296529 | 2976 | `	sState.pTos = pTos;` |
|   296529 | 2977 | `	sState.pc = pc;` |
|   296529 | 2978 | `	rcOp = VmExecOpLe(&(*pVm),&sState,pInstr);` |
|   296529 | 2979 | `	pTos = sState.pTos;` |
|   296529 | 2980 | `	pc = sState.pc;` |
|   296529 | 2981 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2982 | `		goto Abort;` |
|   296529 | 2983 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3004 | ` *` |
|        - | 3005 | ` */` |
|    87738 | 3006 | `case PH7_OP_GT:` |
|        - | 3007 | `case PH7_OP_GE: {` |
|        - | 3008 | `	VmOpRc rcOp;` |
|   175689 | 3009 | `	sState.pTos = pTos;` |
|   175689 | 3010 | `	sState.pc = pc;` |
|   175689 | 3011 | `	rcOp = VmExecOpGe(&(*pVm),&sState,pInstr);` |
|   175689 | 3012 | `	pTos = sState.pTos;` |
|   175689 | 3013 | `	pc = sState.pc;` |
|   175689 | 3014 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 3015 | `		goto Abort;` |
|   175689 | 3016 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3390 | ` */` |
|    12053 | 3391 | `case PH7_OP_FOREACH_INIT: {` |
|        - | 3392 | `	VmOpRc rcOp;` |
|    24111 | 3393 | `	sState.pTos = pTos;` |
|    24111 | 3394 | `	sState.pc = pc;` |
|    24111 | 3395 | `	rcOp = VmExecOpForeachInit(&(*pVm),&sState,pInstr);` |
|    24111 | 3396 | `	pTos = sState.pTos;` |
|    24111 | 3397 | `	pc = sState.pc;` |
|    24111 | 3398 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 3399 | `		goto Abort;` |
|    24111 | 3400 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3408 | ` */` |
|   121420 | 3409 | `case PH7_OP_FOREACH_STEP: {` |
|        - | 3410 | `	VmOpRc rcOp;` |
|   242845 | 3411 | `	sState.pTos = pTos;` |
|   242845 | 3412 | `	sState.pc = pc;` |
|   242845 | 3413 | `	rcOp = VmExecOpForeachStep(&(*pVm),&sState,pInstr);` |
|   242845 | 3414 | `	pTos = sState.pTos;` |
|   242845 | 3415 | `	pc = sState.pc;` |
|   242845 | 3416 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 3417 | `		goto Abort;` |
|   242843 | 3418 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|  1044988 | 3831 | `	sxi32 nCallArgs = pInstr->iP1 + (pInstr->iP2 ? VmSpreadOwnExtra(pVm,pInstr->iP1,pTos) : 0);` |
|        - | 3832 | `	ph7_value *pArg;` |
|  1044988 | 3833 | `	pArg = &pTos[-nCallArgs];` |
...
|  1044988 | 3842 | `	VmCallArgMap *pEffCallMap = (VmCallArgMap *)pInstr->p3;` |
...
|  1044988 | 3849 | `	if( VmValueIsClosure(pVm,pTos) ){` |
...
|  1044988 | 3859 | `	if( (pTos->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|      142 | 4054 | `		break;` |
|        - | 4055 | `	}` |
|  1044828 | 4056 | `	SyStringInitFromBuf(&sName,SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
...
|  1044828 | 4060 | `	if( sName.nByte > 0 && sName.zString[0] == '\\' ){` |
...
|  1044828 | 4067 | `	pEntry = SyHashGet(&pVm->hFunction,(const void *)sName.zString,sName.nByte);` |
...
|        - | 4073 | `	{` |
|  1044828 | 4074 | `	VmCallArgMap *pCallMap = pEffCallMap;` |
|  1044828 | 4075 | `	if( pEntry == 0 && pCallMap && pCallMap->bIsNamespaced ){` |
...
|        - | 4106 | `		VmSlot sArg;` |
|        - | 4107 | `		sxu32 n;` |
|   106065 | 4108 | `		int bClosureThis = 0;` |
|   106065 | 4109 | `		ph7_class *pClosureScope = 0;` |
|        - | 4110 | `		/* initialize fields */` |
|   106065 | 4111 | `		pVmFunc = (ph7_vm_func *)pEntry->pUserData;` |
|   106065 | 4112 | `		pThis = 0;` |
|   106065 | 4113 | `		pSelf = 0;` |
...
|       14 | 4128 | `		}` |
|   106065 | 4129 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
...
|   159199 | 4236 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   106060 | 4237 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
...
|   106065 | 4244 | `		if( VmRecursionExceeded(pVm) ){` |
...
|        3 | 4248 | `			goto Abort;` |
|        - | 4249 | `		}` |
|   106063 | 4250 | `		if( pVmFunc->pNextName ){` |
...
|   106063 | 4262 | `		pSelfHint = pSelf;` |
|   106063 | 4263 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
...
|    12322 | 4267 | `			}` |
|    12835 | 4268 | `		}` |
|   106063 | 4269 | `		if( pSelf == 0 && (pVmFunc->iFlags & VM_FUNC_CLOSURE) ){` |
...
|       30 | 4280 | `			}` |
|      903 | 4281 | `		}` |
|   106063 | 4282 | `		if( SySetUsed(&pVmFunc->aAttrs) > 0 ){` |
...
|       56 | 4287 | `		}` |
|   106063 | 4288 | `		if( pVmFunc->iFlags & VM_FUNC_GENERATOR ){` |
...
|   105723 | 4520 | `		aFormalArg = (ph7_vm_func_arg *)SySetBasePtr(&pVmFunc->aArgs);` |
|        - | 4521 | `		/* Create a new VM frame  */` |
|   105723 | 4522 | `		rc = VmEnterFrame(&(*pVm),pVmFunc,pThis,&pFrame);` |
|   105723 | 4523 | `		if( rc != SXRET_OK ){` |
...
|   105723 | 4551 | `		pFrame->nActualArgs = (int)(pTos - pArg);` |
|   105723 | 4552 | `		if( pThis && ((pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) \|\| bClosureThis) ){` |
...
|    12408 | 4560 | `			}` |
|    12408 | 4561 | `		}` |
|   105723 | 4562 | `		if( SySetUsed(&pVmFunc->aStatic) > 0 ){` |
...
|        - | 4589 | `		{` |
|   105723 | 4590 | `		VmCallArgMap *pCallMap3 = pEffCallMap;` |
|        - | 4591 | `		/* Caller file's strict_types mode — governs parameter coercion` |
|        - | 4592 | `		 * (but NOT return coercion, which uses the callee's file). */` |
|   105723 | 4593 | `		int bCallIsStrict = (pCallMap3 && pCallMap3->bStrict) ? 1 : 0;` |
|   105723 | 4594 | `		if( pCallMap3 && pCallMap3->bHasNamed ){` |
|        - | 4595 | `			/* ============================================================` |
...
|        - | 4980 | `		 * ============================================================ */` |
|   105455 | 4981 | `		n = 0;` |
|   271399 | 4982 | `		while( pArg < pTos ){` |
|   166249 | 4983 | `			if( n < SySetUsed(&pVmFunc->aArgs) && (aFormalArg[n].iFlags & VM_FUNC_ARG_VARIADIC) ){` |
...
|        - | 5083 | `			}` |
|   166049 | 5084 | `			if( n < SySetUsed(&pVmFunc->aArgs) ){` |
...
|   165527 | 5091 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_UNION ){` |
...
|   165440 | 5124 | `				if( aFormalArg[n].nType > 0` |
|    89963 | 5125 | `					&& !((aFormalArg[n].iFlags & VM_FUNC_ARG_NULLABLE) && (pArg->iFlags & MEMOBJ_NULL)) ){` |
...
|       13 | 5201 | `					}` |
|     6975 | 5202 | `				}` |
|   165429 | 5203 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_BY_REF ){` |
...
|   165189 | 5255 | `					pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|        - | 5256 | `				}` |
|    82924 | 5257 | `			}else{` |
|        - | 5258 | `				char zName[32];` |
...
|        - | 5265 | `			}` |
|   165949 | 5266 | `			if( pObj ){` |
|   165713 | 5267 | `				PH7_MemObjStore(pArg,pObj);` |
|        - | 5268 | `				/* Insert argument index  */` |
|   165713 | 5269 | `				sArg.nIdx = pObj->nIdx;` |
|   165713 | 5270 | `				sArg.pUserData = 0;` |
|   165713 | 5271 | `				SySetPut(&pFrame->sArg,(const void *)&sArg);` |
|    83062 | 5272 | `			}` |
|   165949 | 5273 | `			PH7_MemObjRelease(pArg);` |
|   165949 | 5274 | `			pArg++;` |
|   165949 | 5275 | `			++n;` |
|        5 | 5276 | `		}` |
|        - | 5277 | `		} /* end named vs positional branch */` |
|        - | 5278 | `		/* Set up closure environment */` |
|   105601 | 5279 | `		if( pVmFunc->iFlags & VM_FUNC_CLOSURE ){` |
...
|   105596 | 5327 | `		if( n < SySetUsed(&pVmFunc->aArgs)` |
|    56493 | 5328 | `		 && (pVmFunc->iFlags & (VM_FUNC_INTERNAL\|VM_FUNC_CLASS_METHOD)) != VM_FUNC_INTERNAL ){` |
|        - | 5329 | `			sxu32 nNonVar,nReq;` |
|     5929 | 5330 | `			nReq = VmFuncRequiredArgCount(pVmFunc,&nNonVar);` |
|     5929 | 5331 | `			if( n < nReq ){` |
...
|   117637 | 5351 | `		while( n < SySetUsed(&pVmFunc->aArgs) ){` |
|    12307 | 5352 | `			if( aFormalArg[n].iFlags & VM_FUNC_ARG_VARIADIC ){` |
...
|        - | 5363 | `			}` |
|    12063 | 5364 | `			if( SySetUsed(&aFormalArg[n].aByteCode) > 0 ){` |
|    12061 | 5365 | `				pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|    12061 | 5366 | `				if( pObj ){` |
|        - | 5367 | `					/* Evaluate the default value and extract it's result */` |
|    12061 | 5368 | `					rc = VmLocalExec(&(*pVm),&aFormalArg[n].aByteCode,pObj,FALSE);` |
|    12061 | 5369 | `					if( rc == PH7_ABORT ){` |
|      ! 0 | 5370 | `						goto Abort;` |
|        - | 5371 | `					}` |
|        - | 5372 | `					/* Insert argument index */` |
|    12061 | 5373 | `					sArg.nIdx = pObj->nIdx;` |
|    12061 | 5374 | `					sArg.pUserData = 0;` |
|    12061 | 5375 | `					SySetPut(&pFrame->sArg,(const void *)&sArg);` |
...
|    12056 | 5380 | `					if( aFormalArg[n].nType > 0 && aFormalArg[n].nType != MEMOBJ_OBJ` |
...
|        - | 5394 | `		 */` |
|   105579 | 5395 | `		PH7_MemObjRelease(pTos);` |
|   105579 | 5396 | `		pTos = &pTos[-nCallArgs];` |
...
|        - | 5408 | `		 * per function. */` |
|        - | 5409 | `		{` |
|   105579 | 5410 | `			sxu32 nSlots = pVmFunc->nMaxStack;` |
|   105579 | 5411 | `			if( nSlots == 0 ){` |
...
|     4144 | 5418 | `			}` |
|   105579 | 5419 | `			pFrameStack = VmOperandStackAlloc(&(*pVm),nSlots);` |
|        - | 5420 | `		}` |
|   105579 | 5421 | `		if( pFrameStack == 0 ){` |
...
|      ! 0 | 5428 | `			break;` |
|        - | 5429 | `		}` |
|    52683 | 5430 | `SkipFuncBody:` |
|   105713 | 5431 | `		if( pSelf ){` |
|        - | 5432 | `			/* Push class name */` |
|    25731 | 5433 | `			SySetPut(&pVm->aSelf,(const void *)&pSelf);` |
|    12863 | 5434 | `		}` |
|        - | 5435 | `		/* Increment nesting level */` |
|   105713 | 5436 | `		pVm->nRecursionDepth++;` |
|   105713 | 5437 | `		if( rc == PH7_EXCEPTION ){` |
...
|   105579 | 5466 | `			VmCallFrame *pRec = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   105579 | 5467 | `			if( pRec ){` |
|   102935 | 5468 | `				pVm->pIdleCallFrames = (void *)pRec->pPrev;` |
|    51574 | 5469 | `			}else{` |
|     2649 | 5470 | `				pRec = (VmCallFrame *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmCallFrame));` |
|        - | 5471 | `			}` |
|   105579 | 5472 | `			if( pRec == 0 ){` |
...
|      ! 0 | 5483 | `				goto Abort;` |
|        - | 5484 | `			}` |
|   105579 | 5485 | `			sState.pTos = pTos;` |
|   105579 | 5486 | `			sState.pc = pc;` |
|   105579 | 5487 | `			pRec->sCaller = sState;` |
|   105579 | 5488 | `			pRec->sCall.pVmFunc = pVmFunc;` |
|   105579 | 5489 | `			pRec->sCall.pFrame = pFrame;` |
|   105579 | 5490 | `			pRec->sCall.pFrameStack = pFrameStack;` |
|   105579 | 5491 | `			pRec->sCall.nStackCap = pVmFunc->nMaxStack + VM_STACK_GUARD;` |
|   105579 | 5492 | `			pRec->sCall.nLastRef = SXU32_HIGH;` |
|   105579 | 5493 | `			pRec->sCall.bSelfPushed = (sxu8)(pSelf ? 1 : 0);` |
|   105579 | 5494 | `			pRec->pPrev = pCallTop;` |
|   105579 | 5495 | `			pCallTop = pRec;` |
|        - | 5496 | `			/* Switch to the callee activation (what the recursive` |
|        - | 5497 | `			 * VmByteCodeExec entry used to set up). */` |
|   105579 | 5498 | `			aInstr = (VmInstr *)SySetBasePtr(&pVmFunc->aByteCode);` |
|   105579 | 5499 | `			pStack = pFrameStack;` |
|   105579 | 5500 | `			pTos = &pStack[-1];` |
|   105579 | 5501 | `			pc = 0;` |
|   105579 | 5502 | `			sState.aInstr = aInstr;` |
|   105579 | 5503 | `			sState.pStack = pStack;` |
|   105579 | 5504 | `			sState.nStackCap = pRec->sCall.nStackCap; /* callee's operand-stack capacity for OP_SPREAD growth */` |
|   105579 | 5505 | `			sState.nStackOrig = pRec->sCall.nStackCap; /* fixed headroom reference (never grows) */` |
|   105579 | 5506 | `			sState.pTos = pTos;` |
|   105579 | 5507 | `			sState.pc = 0;` |
|   105579 | 5508 | `			sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|   105579 | 5509 | `			sState.pEntryFrame = pVm->pFrame;` |
|   105579 | 5510 | `			sState.pResult = pRec->sCaller.pTos;` |
|   105579 | 5511 | `			sState.pLastRef = &pRec->sCall.nLastRef;` |
|   105579 | 5512 | `			sState.pEnforceRetFunc = VmFuncHasReturnType(pVmFunc) ? pVmFunc : 0;` |
|   105579 | 5513 | `			sState.is_callback = 0;` |
|   105579 | 5514 | `			sState.bReturnPropagates = 0;` |
|   105579 | 5515 | `			goto VmLoopFetch;` |
|        - | 5516 | `		}` |
|       57 | 5517 | `	}else{` |
...
|   938768 | 5526 | `		pEntry = SyHashGet(&pVm->hHostFunction,(const void *)sName.zString,sName.nByte);` |
|        - | 5527 | `		{` |
|   938768 | 5528 | `		VmCallArgMap *pCallMap2 = pEffCallMap;` |
|   938768 | 5529 | `		if( pEntry == 0 && pCallMap2 && pCallMap2->bIsNamespaced ){` |
...
|        - | 5634 | `			}` |
|        - | 5635 | `		}` |
|   938752 | 5636 | `		pFunc = (ph7_user_func *)pEntry->pUserData;` |
...
|  1408492 | 5641 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   938747 | 5642 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
|        - | 5643 | `		/* Start collecting function arguments */` |
|   938752 | 5644 | `		SySetReset(&aArg);` |
|  2537812 | 5645 | `		while( pArg < pTos ){` |
|  1599065 | 5646 | `			SySetPut(&aArg,(const void *)&pArg);` |
|  1599065 | 5647 | `			pArg++;` |
|        5 | 5648 | `		}` |
|        - | 5649 | `		/* Assume a null return value */` |
|   938752 | 5650 | `		PH7_MemObjInit(&(*pVm),&sRet);` |
|        - | 5651 | `		/* Init the call context */` |
|   938752 | 5652 | `		VmInitCallContext(&sCtx,&(*pVm),pFunc,&sRet,0);` |
...
|   938752 | 5659 | `		sCtx.pArgMap = pEffCallMap;` |
|        - | 5660 | `		{` |
|   938752 | 5661 | `		int nGiven = (int)SySetUsed(&aArg);` |
...
|   938752 | 5667 | `		if( pFunc->nMinArg > 0 && nGiven < pFunc->nMinArg ){` |
...
|      232 | 5674 | `				nGiven);` |
|   938520 | 5675 | `		}else if( pFunc->bHasMaxArg && nGiven > (int)pFunc->nMaxArg ){` |
...
|       40 | 5688 | `				nGiven);` |
|  1407716 | 5689 | `		}else if( SXRET_OK != (rc = VmEnforceBuiltinArgTypes(&sCtx,pFunc,nGiven,` |
|   938203 | 5690 | `			(ph7_value **)SySetBasePtr(&aArg))) ){` |
|        - | 5691 | `			/* TypeError thrown: rc carries the caught/uncaught status */` |
|      112 | 5692 | `		}else{` |
|        - | 5693 | `			/* Call the foreign function */` |
|   937994 | 5694 | `			rc = pFunc->xFunc(&sCtx,nGiven,(ph7_value **)SySetBasePtr(&aArg));` |
|        - | 5695 | `		}` |
|        - | 5696 | `		}` |
|        - | 5697 | `		/* Release the call context */` |
|   938752 | 5698 | `		VmReleaseCallContext(&sCtx);` |
|   938752 | 5699 | `		if( rc == PH7_ABORT ){` |
...
|      578 | 5704 | `			goto Abort;` |
|        - | 5705 | `		}` |
|   938178 | 5706 | `		if( rc != PH7_SUSPEND && pVm->pInlineInstr == (void *)aInstr ){` |
...
|      ! 0 | 5719 | `		}` |
|   938174 | 5720 | `		if( rc == PH7_EXCEPTION ){` |
...
|      839 | 5740 | `			break;` |
|        - | 5741 | `		}` |
|   937142 | 5742 | `		if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|   915862 | 5766 | `			VmPopOperand(&pTos,nCallArgs);` |
|   458295 | 5767 | `		}` |
|        - | 5768 | `		/* Save foreign function return value into the (now top) function-name slot */` |
|   936788 | 5769 | `		PH7_MemObjStore(&sRet,pTos);` |
|   936788 | 5770 | `		PH7_MemObjRelease(&sRet);` |
|        - | 5771 | `	}` |
|   936892 | 5772 | `	break;` |
|        - | 5773 | `				  }` |
|        - | 5774 | `/*` |
...
|        - | 5777 | ` */` |
|    26096 | 5778 | `case PH7_OP_CONSUME: {` |
|        - | 5779 | `	VmOpRc rcOp;` |
|    52197 | 5780 | `	sState.pTos = pTos;` |
|    52197 | 5781 | `	sState.pc = pc;` |
|    52197 | 5782 | `	rcOp = VmExecOpConsume(&(*pVm),&sState,pInstr);` |
|    52197 | 5783 | `	pTos = sState.pTos;` |
|    52197 | 5784 | `	pc = sState.pc;` |
|    52197 | 5785 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 5786 | `		goto Abort;` |
|    52197 | 5787 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 5792 |  |
|        - | 5793 | `		} /* Switch() */` |
| 16813676 | 5794 | `		pc++; /* Next instruction in the stream */` |
|        5 | 5795 | `	} /* For(;;) */` |
|   131372 | 5796 | `Done:` |
...
|   262957 | 5800 | `	rc = SXRET_OK;` |
|   262957 | 5801 | `	goto Unwind;` |
|      823 | 5802 | `Suspend:` |
...
|   133388 | 5860 | `	for(;;){` |
|   266573 | 5861 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|      ! 0 | 5869 | `			}` |
|     1162 | 5870 | `		}` |
|   266573 | 5871 | `		if( pCallTop == 0 ){` |
|   161409 | 5872 | `			return VmExecFinalize(&(*pVm),&sState,&aArg,pTos,rc);` |
|        - | 5873 | `		}` |
|   105169 | 5874 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|      636 | 5880 | `		}` |
|        - | 5881 | `		{` |
|   105169 | 5882 | `			VmCallFrame *pRec = pCallTop;` |
|   105169 | 5883 | `			sState = pRec->sCaller;` |
|   105169 | 5884 | `			rc = VmCallFinish(&(*pVm),&sState,&pRec->sCall,rc);` |
|   105169 | 5885 | `			pCallTop = pRec->pPrev;` |
|   105169 | 5886 | `			pRec->pPrev = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   105169 | 5887 | `			pVm->pIdleCallFrames = (void *)pRec;` |
|   105169 | 5888 | `			aInstr = sState.aInstr;` |
|   105169 | 5889 | `			pStack = sState.pStack;` |
|   105169 | 5890 | `			pTos = sState.pTos;` |
|   105169 | 5891 | `			pc = sState.pc;` |
|        - | 5892 | `		}` |
|   105169 | 5893 | `		if( rc == PH7_OK ){` |
|   104403 | 5894 | `			pc++; /* the loop-bottom increment this OP_CALL missed */` |
|   104403 | 5895 | `			goto VmLoopFetch;` |
|        - | 5896 | `		}` |
|        5 | 5897 | `	}` |
|    80884 | 5898 | `}` |
|        - | 5899 |  |
