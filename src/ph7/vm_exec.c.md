...
|        - |  162 | ` */` |
|   157178 |  163 | `static sxi32 VmExecFinalize(ph7_vm *pVm,VmExecState *pState,SySet *pArg,ph7_value *pTos,sxi32 rcTerm)` |
|        5 |  164 | `{` |
|    78589 |  165 | `	SXUNUSED(pVm);` |
|   157183 |  166 | `	if( rcTerm != PH7_SUSPEND && !pState->bReturnPropagates ){` |
|   153569 |  167 | `		VmClearFrameReturn(pState->pEntryFrame);` |
|    76782 |  168 | `	}` |
|   157183 |  169 | `	SySetRelease(pArg);` |
|   157183 |  170 | `	if( rcTerm == PH7_ABORT \|\| rcTerm == PH7_EXCEPTION ){` |
|     2835 |  171 | `		while( pTos >= pState->pStack ){` |
|     1785 |  172 | `			PH7_MemObjRelease(pTos);` |
|     1785 |  173 | `			pTos--;` |
|        5 |  174 | `		}` |
|      525 |  175 | `	}` |
|   157183 |  176 | `	return rcTerm;` |
|        5 |  177 | `}` |
|        - |  178 | `/*` |
...
|        - |  189 | ` */` |
|   104202 |  190 | `static sxi32 VmCallFinish(ph7_vm *pVm,VmExecState *pCaller,VmCallRecord *pCallee,sxi32 rc)` |
|        5 |  191 | `{` |
|        - |  192 | `	ph7_value *pObj;` |
|        - |  193 | `	/* Decrement nesting level */` |
|   104207 |  194 | `	pVm->nRecursionDepth--;` |
|   104207 |  195 | `	if( pCallee->bSelfPushed ){` |
|        - |  196 | `		/* Pop class name */` |
|    25341 |  197 | `		(void)SySetPop(&pVm->aSelf);` |
|    12668 |  198 | `	}` |
|   104207 |  199 | `	if( (pCallee->pVmFunc->iFlags & VM_FUNC_REF_RETURN) && rc == SXRET_OK ){` |
...
|       25 |  225 | `	}` |
|   104207 |  226 | `	if( rc != PH7_ABORT && ((pCallee->pFrame->iFlags & VM_FRAME_THROW) \|\| rc == PH7_EXCEPTION) ){` |
...
|   104207 |  272 | `	if( rc != PH7_SUSPEND && pCallee->pFrameStack ){` |
...
|   104073 |  276 | `		VmOperandStackRecycle(pVm,pCallee->pFrameStack,pCallee->nStackCap);` |
|    52137 |  277 | `	}` |
|        - |  278 | `	/* Leave the frame */` |
|   104207 |  279 | `	VmLeaveFrame(&(*pVm));` |
|   104207 |  280 | `	if( rc == PH7_ABORT ){` |
|      336 |  281 | `		return PH7_ABORT;` |
|        - |  282 | `	}` |
|   103875 |  283 | `	if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|        - |  291 | `	}` |
|   103875 |  292 | `	if( rc == PH7_EXCEPTION ){` |
|      469 |  293 | `		return PH7_EXCEPTION;` |
|        - |  294 | `	}` |
|   103411 |  295 | `	return PH7_OK;` |
|    52209 |  296 | `}` |
|        - |  297 | `/*` |
...
|        - |  330 | ` * nesting.` |
|        - |  331 | ` */` |
|   157536 |  332 | `PH7_PRIVATE sxi32 VmByteCodeExec(` |
...
|   157541 |  352 | `	if( VmNativeNestingExceeded(pVm) ){` |
...
|   157537 |  362 | `	nSavedBrc = pVm->nBoundaryRc;` |
|   157537 |  363 | `	pVm->nBoundaryRc = 0;` |
...
|   157537 |  370 | `	nSavedLine = pVm->nCurLine;` |
|   157537 |  371 | `	pVm->nVmExecDepth++;` |
|   236303 |  372 | `	rc = VmByteCodeExecBody(&(*pVm),aInstr,pStack,nTos,pResult,pLastRef,is_callback,nPc,` |
|    78766 |  373 | `		pEnforceRetFunc,bReturnPropagates,pAdoptSegment,ppBaseOwner,pnBaseCap,nStackOrig);` |
|   157537 |  374 | `	pVm->nVmExecDepth--;` |
|   157537 |  375 | `	pVm->nCurLine = nSavedLine;` |
|   157537 |  376 | `	if( nSavedBrc != 0 && (nSavedBrc == PH7_ABORT \|\| pVm->nBoundaryRc == 0) ){` |
|       15 |  377 | `		pVm->nBoundaryRc = nSavedBrc;` |
|        6 |  378 | `	}` |
|   157537 |  379 | `	return rc;` |
|    78773 |  380 | `}` |
|   157532 |  381 | `static sxi32 VmByteCodeExecBody(` |
...
|        - |  399 | `	ph7_value *pTos;` |
|        - |  400 | `	SySet aArg;` |
|   157537 |  401 | `	VmCallFrame *pCallTop = 0; /* Top of this invocation's in-loop call-record` |
...
|        - |  409 | `	sxi32 pc;` |
|        - |  410 | `	sxi32 rc;` |
|   157537 |  411 | `	sState.aInstr = aInstr;` |
|   157537 |  412 | `	sState.pStack = pStack;` |
|   157537 |  413 | `	sState.nStackCap = pnBaseCap ? *pnBaseCap : 0; /* CURRENT capacity (grown on a coroutine resume) */` |
|   157537 |  414 | `	sState.nStackOrig = nStackOrig;                /* ORIGINAL capacity — fixed headroom reference */` |
|   157537 |  415 | `	sState.pResult = pResult;` |
|   157537 |  416 | `	sState.pLastRef = pLastRef;` |
|   157537 |  417 | `	sState.pEnforceRetFunc = pEnforceRetFunc;` |
|   157537 |  418 | `	sState.is_callback = (sxu8)(is_callback ? 1 : 0);` |
|   157537 |  419 | `	sState.bReturnPropagates = (sxu8)(bReturnPropagates ? 1 : 0);` |
|        - |  420 | `	/* Argument container */` |
|   157537 |  421 | `	SySetInit(&aArg,&pVm->sAllocator,sizeof(ph7_value *));` |
|   157537 |  422 | `	if( nTos < 0 ){` |
|   141889 |  423 | `		pTos = &pStack[-1];` |
|    70947 |  424 | `	}else{` |
|    15653 |  425 | `		pTos = &pStack[nTos];` |
|        - |  426 | `	}` |
|   157537 |  427 | `	sState.pTos = pTos;` |
|   157537 |  428 | `	sState.pc = nPc;` |
...
|   157532 |  446 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->pFrame == pVm->pFrame` |
|     2816 |  447 | `	 && pStack == pVm->pActiveCtx->pStack ){` |
|     1805 |  448 | `		sState.nExceptionBase = pVm->pActiveCtx->nExceptionBase;` |
|      905 |  449 | `	}else{` |
|   155737 |  450 | `		sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|        - |  451 | `	}` |
|   157537 |  452 | `	sState.pEntryFrame = pVm->pFrame;` |
|   157537 |  453 | `	pc = nPc;` |
...
|   157532 |  506 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->pInjected` |
...
|   157522 |  567 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->bClosing` |
...
| 16804327 |  603 | `		if( pVm->nBoundaryRc != 0 \|\| SySetUsed(&pVm->aHookRmw) > 0 ){` |
...
| 16804241 |  658 | `		pInstr = &aInstr[pc];` |
| 16804241 |  659 | `		if( pInstr->nLine ){` |
...
| 16590598 |  663 | `			pVm->nCurLine = pInstr->nLine;` |
|  8301650 |  664 | `		}` |
| 16804241 |  665 | `		rc = SXRET_OK;` |
|        - |  666 | `/*` |
...
|        - |  672 | ` */` |
| 16804241 |  673 | `		switch(pInstr->iOp){` |
|        - |  674 | `/*` |
|        - |  675 | ` * DONE: P1 * *` |
|        - |  676 | ` *` |
...
|        - |  679 | ` */` |
|   128623 |  680 | `case PH7_OP_DONE:` |
|   257457 |  681 | `	if( pInstr->iP2 && sState.bReturnPropagates ){` |
...
|   257268 |  711 | `	if( sState.pEnforceRetFunc && VmFuncHasReturnType(sState.pEnforceRetFunc)` |
...
|     4588 |  736 | `	}` |
|   257249 |  737 | `	if( pInstr->iP1 && pTos >= pStack ){` |
|   152529 |  738 | `		if( sState.pLastRef ){` |
|    93827 |  739 | `			*sState.pLastRef = pTos->nIdx;` |
|    47014 |  740 | `		}` |
|   152529 |  741 | `		if( sState.pResult ){` |
|        - |  742 | `			/* Execution result */` |
|   145539 |  743 | `			PH7_MemObjStore(pTos,sState.pResult);` |
|    72870 |  744 | `		}` |
|   152529 |  745 | `		VmPopOperand(&pTos,1);` |
|   181090 |  746 | `	}else if( sState.pLastRef ){` |
...
|        - |  762 | `	 */` |
|   257249 |  763 | `	rc = VmDrainFinally(&(*pVm),sState.nExceptionBase);` |
|   257249 |  764 | `	if( rc == SXERR_ABORT ){` |
|      ! 0 |  765 | `		goto Abort;` |
|        - |  766 | `	}` |
|   257249 |  767 | `	if( rc == PH7_EXCEPTION ){` |
...
|        - |  778 | `	}` |
|   257245 |  779 | `	if( sState.pEntryFrame->bHasRet && !sState.bReturnPropagates ){` |
...
|        - |  835 | ` */` |
|   288451 |  836 | `case PH7_OP_JMP:` |
|   577113 |  837 | `	pc = pInstr->iP2 - 1;` |
|   577113 |  838 | `	break;` |
|        - |  839 | `/*` |
|        - |  840 | ` * JZ: P1 P2 *` |
|        - |  841 | ` *` |
...
|  1604620 |  852 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     1003 |  853 | `		PH7_MemObjToBool(pTos);` |
|      500 |  854 | `	}` |
|  1604620 |  855 | `	if( !pTos->x.iVal ){` |
|        - |  856 | `		/* Take the jump */` |
|   899324 |  857 | `		pc = pInstr->iP2 - 1;` |
|   449921 |  858 | `	}` |
|  1604620 |  859 | `	if( !pInstr->iP1 ){` |
|  1356554 |  860 | `		VmPopOperand(&pTos,1);` |
|   678845 |  861 | `	}` |
|  1604620 |  862 | `	break;` |
|        - |  863 | `/*` |
|        - |  864 | ` * JNZ: P1 P2 *` |
...
|   184443 |  876 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      ! 0 |  877 | `		PH7_MemObjToBool(pTos);` |
|      ! 0 |  878 | `	}` |
|   184443 |  879 | `	if( pTos->x.iVal ){` |
|        - |  880 | `		/* Take the jump */` |
|     9549 |  881 | `		pc = pInstr->iP2 - 1;` |
|     4772 |  882 | `	}` |
|   184443 |  883 | `	if( !pInstr->iP1 ){` |
...
|        - |  899 | ` */` |
|   661803 |  900 | `case PH7_OP_POP: {` |
|  1324641 |  901 | `	sxi32 n = pInstr->iP1;` |
|  1324641 |  902 | `	if( &pTos[-n+1] < pStack ){` |
|        - |  903 | `		/* TICKET 1433-51 Stack underflow must be handled at run-time */` |
|       79 |  904 | `		n = (sxi32)(pTos - pStack);` |
|       38 |  905 | `	}` |
|  1324641 |  906 | `	VmPopOperand(&pTos,n);` |
|  1324641 |  907 | `	break;` |
|        - |  908 | `				 }` |
|        - |  909 | `/*` |
|        - |  910 | ` * DUP: * * *` |
...
|        - |  929 | ` */` |
|    49160 |  930 | `case PH7_OP_NSSWITCH:` |
|    98325 |  931 | `	SyBlobReset(&pVm->sNamespace);` |
|    98325 |  932 | `	if( pInstr->p3 ){` |
|     4011 |  933 | `		const char *zNs = (const char *)pInstr->p3;` |
|     4011 |  934 | `		SyBlobAppend(&pVm->sNamespace,zNs,SyStrlen(zNs));` |
|     2003 |  935 | `	}` |
|        - |  936 | `	/* Clear namespace-scoped use-const imports */` |
|    98325 |  937 | `	SyHashRelease(&pVm->hUseConstImports);` |
|    98325 |  938 | `	SyHashInit(&pVm->hUseConstImports,&pVm->sAllocator,0,0);` |
|    98325 |  939 | `	break;` |
...
|     6789 | 1089 | `	break;` |
|        - | 1090 | `					  }` |
|    37717 | 1091 | `case PH7_OP_ERR_CTRL:` |
|        - | 1092 | `	/*` |
...
|        - | 1101 | `	 */` |
|    75439 | 1102 | `	if( pInstr->iP1 ){` |
|    37723 | 1103 | `		pVm->nErrSuppress++;` |
|    56580 | 1104 | `	}else if( pVm->nErrSuppress > 0 ){` |
|    37721 | 1105 | `		pVm->nErrSuppress--;` |
|    18858 | 1106 | `	}` |
|    75439 | 1107 | `	break;` |
|        - | 1108 | `/*` |
|        - | 1109 | ` * IS_A * * *` |
...
|        - | 1163 | ` */` |
|  1510067 | 1164 | `case PH7_OP_LOADC: {` |
|        - | 1165 | `	ph7_value *pObj;` |
|        - | 1166 | `	/* Reserve a room */` |
|  3022009 | 1167 | `	pTos++;` |
|  3022009 | 1168 | `	if( pInstr->iP1 & PH7_LOADC_NOKEY ){` |
...
|    19085 | 1174 | `		break;` |
|        - | 1175 | `	}` |
|  3002929 | 1176 | `	if( (pObj = (ph7_value *)SySetAt(&pVm->aLitObj,pInstr->iP2)) != 0 ){` |
|  3002929 | 1177 | `		if( (pInstr->iP1 & PH7_LOADC_EXPAND) && SyBlobLength(&pObj->sBlob) <= 64 ){` |
...
|        - | 1283 | ` */` |
|  2196005 | 1284 | `case PH7_OP_LOAD:{` |
|        - | 1285 | `	ph7_value *pObj;` |
|        - | 1286 | `	SyString sName;` |
|  4395945 | 1287 | `	if( pInstr->p3 == 0 ){` |
...
|        9 | 1299 | `	}else{` |
|  4395929 | 1300 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1301 | `		/* Reserve a room for the target object */` |
|  4395929 | 1302 | `		pTos++;` |
|        - | 1303 | `	}` |
|        - | 1304 | `	/* Extract the requested memory object */` |
|  4395945 | 1305 | `	pObj = VmExtractMemObj(&(*pVm),&sName,pInstr->p3 ? FALSE : TRUE,pInstr->iP1 != 1);` |
|  4395945 | 1306 | `	if( pObj == 0 ){` |
...
|  4395915 | 1323 | `	PH7_MemObjLoad(pObj,pTos);` |
|  4395915 | 1324 | `	pTos->nIdx = pObj->nIdx;` |
|  4395915 | 1325 | `	break;` |
|        - | 1326 | `				   }` |
|        - | 1327 | `/*` |
|        - | 1328 | ` * LOAD_MAP P1 * *` |
...
|        - | 1333 | ` */` |
|    36833 | 1334 | `case PH7_OP_LOAD_MAP: {` |
|        - | 1335 | `	VmOpRc rcOp;` |
|    73671 | 1336 | `	sState.pTos = pTos;` |
|    73671 | 1337 | `	sState.pc = pc;` |
|    73671 | 1338 | `	rcOp = VmExecOpLoadMap(&(*pVm),&sState,pInstr);` |
|    73671 | 1339 | `	pTos = sState.pTos;` |
|    73671 | 1340 | `	pc = sState.pc;` |
|    73671 | 1341 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1342 | `		goto Abort;` |
|    73671 | 1343 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1376 | ` * instead.` |
|        - | 1377 | ` */` |
|   332284 | 1378 | `case PH7_OP_LOAD_IDX: {` |
|        - | 1379 | `	VmOpRc rcOp;` |
|   665302 | 1380 | `	sState.pTos = pTos;` |
|   665302 | 1381 | `	sState.pc = pc;` |
|   665302 | 1382 | `	rcOp = VmExecOpLoadIdx(&(*pVm),&sState,pInstr);` |
|   665302 | 1383 | `	pTos = sState.pTos;` |
|   665302 | 1384 | `	pc = sState.pc;` |
|   665302 | 1385 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1386 | `		goto Abort;` |
|   665302 | 1387 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1397 | ` */` |
|      570 | 1398 | `case PH7_OP_LOAD_CLOSURE: {` |
|        - | 1399 | `	VmOpRc rcOp;` |
|     1145 | 1400 | `	sState.pTos = pTos;` |
|     1145 | 1401 | `	sState.pc = pc;` |
|     1145 | 1402 | `	rcOp = VmExecOpLoadClosure(&(*pVm),&sState,pInstr);` |
|     1145 | 1403 | `	pTos = sState.pTos;` |
|     1145 | 1404 | `	pc = sState.pc;` |
|     1145 | 1405 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1406 | `		goto Abort;` |
|     1145 | 1407 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1489 | `	}` |
|        - | 1490 | `#endif` |
|   595023 | 1491 | `	if( pInstr->iP2 ){` |
|        - | 1492 | `		sxu32 nIdx;` |
|        - | 1493 | `		sxi32 rcT;` |
|        - | 1494 | `		/* Member store operation */` |
|    11717 | 1495 | `		nIdx = pTos->nIdx;` |
|    11717 | 1496 | `		VmPopOperand(&pTos,1);` |
|    11717 | 1497 | `		if( pVm->pMagicSetThis ){` |
...
|       11 | 1510 | `			break;` |
|        - | 1511 | `		}` |
|    11707 | 1512 | `		if( pVm->pHookSetThis ){` |
...
|    11675 | 1540 | `			rcT = VmEnforcePropertyTypeOnStore(&(*pVm),nIdx,pTos,0);` |
|    11675 | 1541 | `			if( rcT == PH7_ABORT ){` |
|       13 | 1542 | `				goto Abort;` |
|        - | 1543 | `			}` |
|    11665 | 1544 | `			if( rcT == PH7_EXCEPTION ){` |
...
|    11597 | 1559 | `			pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|    11597 | 1560 | `			if( pObj ){` |
|        - | 1561 | `				/* Perform the store operation */` |
|    11597 | 1562 | `				PH7_MemObjStore(pTos,pObj);` |
|     5796 | 1563 | `			}` |
|        - | 1564 | `		}` |
|    11599 | 1565 | `		break;` |
|   583311 | 1566 | `	}else if( pInstr->p3 == 0 ){` |
...
|        - | 1578 | `#endif` |
|        5 | 1579 | `	}else{` |
|   583303 | 1580 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1581 | `	}` |
|   583306 | 1582 | `	if( sName.nByte == sizeof("GLOBALS")-1` |
|   293430 | 1583 | `	 && SyMemcmp((const void *)sName.zString,(const void *)"GLOBALS",sName.nByte) == 0 ){` |
|        6 | 1584 | `		if( pInstr->p3 ){` |
...
|        - | 1621 | ` */` |
|   120259 | 1622 | `case PH7_OP_STORE_IDX:` |
|        - | 1623 | `case PH7_OP_STORE_IDX_REF: {` |
|        - | 1624 | `	VmOpRc rcOp;` |
|   240523 | 1625 | `	sState.pTos = pTos;` |
|   240523 | 1626 | `	sState.pc = pc;` |
|   240523 | 1627 | `	rcOp = VmExecOpStoreIdxRef(&(*pVm),&sState,pInstr);` |
|   240523 | 1628 | `	pTos = sState.pTos;` |
|   240523 | 1629 | `	pc = sState.pc;` |
|   240523 | 1630 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 1631 | `		goto Abort;` |
|   240521 | 1632 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|   367441 | 1653 | `	PH7_ENFORCE_READONLY_MUTATE(pTos->nIdx);` |
...
|   367430 | 1658 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) != 0` |
|   183824 | 1659 | `	 && SySetUsed(&pVm->aHookRmw) > 0 ){` |
...
|        - | 1676 | `		}` |
|      ! 0 | 1677 | `	}` |
|   367433 | 1678 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) == 0 ){` |
|   367433 | 1679 | `		if( pTos->nIdx != SXU32_HIGH ){` |
|        - | 1680 | `			ph7_value *pObj;` |
|   367433 | 1681 | `			if( (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pTos->nIdx)) != 0 ){` |
|   367433 | 1682 | `				if( VmStringWantsPerlIncr(pObj) ){` |
...
|   367431 | 1701 | `					if( pInstr->iP1 == 0 && (pTos->iFlags & MEMOBJ_STRING) ){` |
|        9 | 1702 | `						SyBlobNullAppend(&pTos->sBlob);` |
|        3 | 1703 | `					}` |
|        - | 1704 | `					/* Force a numeric cast on the variable */` |
|   367431 | 1705 | `					PH7_MemObjToNumeric(pObj);` |
|   367431 | 1706 | `					if( pObj->iFlags & MEMOBJ_REAL ){` |
|        5 | 1707 | `						pObj->rVal++;` |
...
|        - | 1716 | `						sxi64 r;` |
|   367427 | 1717 | `						if( PH7_ADD_OVERFLOW64(pObj->x.iVal,1,&r) ){` |
...
|        - | 1723 | `#endif` |
|        3 | 1724 | `						}else{` |
|   367423 | 1725 | `							pObj->x.iVal = r;` |
|        - | 1726 | `						}` |
|        - | 1727 | `					}` |
|   367431 | 1728 | `					if( pInstr->iP1 ){` |
...
|        - | 1767 | `		}` |
|   183816 | 1768 | `	}` |
|   367431 | 1769 | `	PH7_HOOK_RMW_WRITEBACK(pTos->nIdx,pTos);` |
|   367431 | 1770 | `	break;` |
|        - | 1771 | `/*` |
|        - | 1772 | ` * DECR: P1 * *` |
|        - | 1773 | ` *` |
...
|    70591 | 1920 | `	PH7_MemObjToNumeric(pTos);` |
|    70591 | 1921 | `	if( pTos->iFlags & MEMOBJ_REAL ){` |
|      108 | 1922 | `		pTos->rVal = -pTos->rVal;` |
|       53 | 1923 | `	}` |
|    70591 | 1924 | `	if( pTos->iFlags & MEMOBJ_INT ){` |
|    70505 | 1925 | `		if( pTos->x.iVal == SMALLEST_INT64 ){` |
...
|        - | 1940 | `#endif` |
|        3 | 1941 | `		}else{` |
|    70501 | 1942 | `			pTos->x.iVal = -pTos->x.iVal;` |
|        - | 1943 | `		}` |
|    35250 | 1944 | `	}` |
|    70591 | 1945 | `	break;` |
|        - | 1946 | `/*` |
...
|    50853 | 1979 | `	if( (pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      119 | 1980 | `		PH7_MemObjToBool(pTos);` |
|       57 | 1981 | `	}` |
|    50853 | 1982 | `	pTos->x.iVal = !pTos->x.iVal;` |
|    50853 | 1983 | `	break;` |
|        - | 1984 | `/*` |
|        - | 1985 | ` * OP_BITNOT: * * *` |
|        - | 1986 | ` *` |
...
|        - | 2052 | ` */` |
|     6367 | 2053 | `case PH7_OP_ADD:{` |
|    12739 | 2054 | `	ph7_value *pNos = &pTos[-1];` |
|        - | 2055 | `#ifdef UNTRUST` |
|        - | 2056 | `	if( pNos < pStack ){` |
|        - | 2057 | `		goto Abort;` |
|        - | 2058 | `	}` |
...
|        - | 2064 | `		SyBlob sArMsg;` |
|    12739 | 2065 | `		SyBlobInit(&sArMsg,&pVm->sAllocator);` |
|    12739 | 2066 | `		if( VmArithOperandCheck(&(*pVm),pNos,pTos,"+",&sArMsg) != SXRET_OK ){` |
|        - | 2067 | `			sxi32 rcAr;` |
...
|        - | 2078 | `		}` |
|    12731 | 2079 | `		SyBlobRelease(&sArMsg);` |
|        - | 2080 | `	}` |
|        - | 2081 | `	/* Perform the addition */` |
|    12731 | 2082 | `	PH7_MemObjAdd(pNos,pTos,FALSE);` |
|    12731 | 2083 | `	VmPopOperand(&pTos,1);` |
|    12731 | 2084 | `	break;` |
|        - | 2085 | `				}` |
|        - | 2086 | `/*` |
|        - | 2087 | ` * OP_ADD_STORE * * *` |
...
|        - | 2151 | ` */` |
|    12102 | 2152 | `case PH7_OP_SUB: {` |
|        - | 2153 | `	VmOpRc rcOp;` |
|    24320 | 2154 | `	sState.pTos = pTos;` |
|    24320 | 2155 | `	sState.pc = pc;` |
|    24320 | 2156 | `	rcOp = VmExecOpSub(&(*pVm),&sState,pInstr);` |
|    24320 | 2157 | `	pTos = sState.pTos;` |
|    24320 | 2158 | `	pc = sState.pc;` |
|    24320 | 2159 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2160 | `		goto Abort;` |
|    24320 | 2161 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|      924 | 2346 | `	ph7_value *pNos = &pTos[-1];` |
|        - | 2347 | `	sxi64 a,b,r;` |
|        - | 2348 | `#ifdef UNTRUST` |
|        - | 2349 | `	if( pNos < pStack ){` |
|        - | 2350 | `		goto Abort;` |
...
|      924 | 2354 | `	rc = VmRejectFloatOperand(&(*pVm),pNos);` |
|      924 | 2355 | `	PH7_DISPATCH_ENFORCE_RC(rc)` |
|      924 | 2356 | `	rc = VmRejectFloatOperand(&(*pVm),pTos);` |
|      924 | 2357 | `	PH7_DISPATCH_ENFORCE_RC(rc)` |
|      924 | 2358 | `	if( (pTos->iFlags & MEMOBJ_INT) == 0 ){` |
|      ! 0 | 2359 | `		PH7_MemObjToInteger(pTos);` |
|      ! 0 | 2360 | `	}` |
|      924 | 2361 | `	if( (pNos->iFlags & MEMOBJ_INT) == 0 ){` |
|      ! 0 | 2362 | `		PH7_MemObjToInteger(pNos);` |
|      ! 0 | 2363 | `	}` |
|        - | 2364 | `	/* Perform the requested operation */` |
|      924 | 2365 | `	a = pNos->x.iVal;` |
|      924 | 2366 | `	b = pTos->x.iVal;` |
|      924 | 2367 | `	switch(pInstr->iOp){` |
...
|      826 | 2374 | `	default:          r = a&b; break;` |
|        - | 2375 | `	}` |
|        - | 2376 | `	/* Push the result */` |
|      924 | 2377 | `	pNos->x.iVal = r;` |
|      924 | 2378 | `	MemObjSetType(pNos,MEMOBJ_INT);` |
|      924 | 2379 | `	VmPopOperand(&pTos,1);` |
|      924 | 2380 | `	break;` |
|        - | 2381 | `				 }` |
|        - | 2382 | `/* OP_BAND_STORE * * *` |
|        - | 2383 | ` *` |
...
|        - | 2508 | ` * back.` |
|        - | 2509 | ` */` |
|    86419 | 2510 | `case PH7_OP_CAT:{` |
|        - | 2511 | `	ph7_value *pNos,*pCur;` |
|   172843 | 2512 | `	if( pInstr->iP1 < 1 ){` |
|   144639 | 2513 | `		pNos = &pTos[-1];` |
|    72322 | 2514 | `	}else{` |
...
|   172843 | 2523 | `	if( (pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|     1929 | 2524 | `		PH7_MemObjToString(pNos);` |
|      962 | 2525 | `	}` |
|   172843 | 2526 | `	pCur = &pNos[1];` |
|   349019 | 2527 | `	while( pCur <= pTos ){` |
|   176181 | 2528 | `		if( (pCur->iFlags & MEMOBJ_STRING) == 0 ){` |
|    52201 | 2529 | `			PH7_MemObjToString(pCur);` |
|    26098 | 2530 | `		}` |
|        - | 2531 | `		/* Perform the concatenation */` |
|   176181 | 2532 | `		if( SyBlobLength(&pCur->sBlob) > 0 ){` |
|   176039 | 2533 | `			if( PH7_MemObjStringAppend(pNos,(const char *)SyBlobData(&pCur->sBlob),SyBlobLength(&pCur->sBlob)) != SXRET_OK ){` |
|        - | 2534 | `				/* Allocation failure: raise a fatal instead of a truncated concat */` |
|      ! 0 | 2535 | `				PH7_VmMemoryError(&(*pVm));` |
|      ! 0 | 2536 | `				goto Abort;` |
|        - | 2537 | `			}` |
|    88017 | 2538 | `		}` |
|   176181 | 2539 | `		SyBlobRelease(&pCur->sBlob);` |
|   176181 | 2540 | `		pCur++;` |
|        5 | 2541 | `	}` |
|   172843 | 2542 | `	pTos = pNos;` |
|   172843 | 2543 | `	break;` |
|        - | 2544 | `				}` |
|        - | 2545 | `/*  CAT_STORE: * * *` |
|        - | 2546 | ` *` |
...
|        - | 2548 | ` * back.` |
|        - | 2549 | ` */` |
|    11791 | 2550 | `case PH7_OP_CAT_STORE:{` |
|    23587 | 2551 | `	ph7_value *pNos = &pTos[-1];` |
|        - | 2552 | `	ph7_value *pObj;` |
|        - | 2553 | `	sxu32 nIdx;` |
|        - | 2554 | `#ifdef UNTRUST` |
|        - | 2555 | `	if( pNos < pStack ){` |
...
|    23587 | 2560 | `	if((pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|       59 | 2561 | `		PH7_MemObjToString(pNos);` |
|       29 | 2562 | `	}` |
|    23587 | 2563 | `	nIdx = pTos->nIdx;` |
...
|    23582 | 2575 | `	if( nIdx != SXU32_HIGH` |
|    23582 | 2576 | `	 && nIdx != pNos->nIdx` |
|    23578 | 2577 | `	 && (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx)) != 0` |
|    23579 | 2578 | `	 && (SyHashTotalEntry(&pVm->hTypedSlot) == 0` |
|    14387 | 2579 | `	     \|\| SyHashGet(&pVm->hTypedSlot,(const void *)&nIdx,sizeof(sxu32)) == 0) ){` |
|    23573 | 2580 | `		if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - | 2581 | `			/* e.g. $x = 5; $x .= "a";  ->  "5a" */` |
|        3 | 2582 | `			PH7_MemObjToString(pObj);` |
|        1 | 2583 | `		}` |
|    23573 | 2584 | `		if( SyBlobLength(&pNos->sBlob) > 0 ){` |
|    23569 | 2585 | `			if( PH7_MemObjStringAppend(pObj,(const char *)SyBlobData(&pNos->sBlob),SyBlobLength(&pNos->sBlob)) != SXRET_OK ){` |
...
|    23573 | 2604 | `		if( (pInstr+1)->iOp != PH7_OP_POP ){` |
...
|    23573 | 2609 | `		PH7_HOOK_RMW_WRITEBACK(nIdx,0);` |
|    23573 | 2610 | `		pNos->nIdx = SXU32_HIGH;` |
|    23573 | 2611 | `		VmPopOperand(&pTos,1);` |
|    23580 | 2612 | `		break;` |
|        - | 2613 | `	}` |
...
|        - | 2650 | ` * stack.` |
|        - | 2651 | ` */` |
|   114203 | 2652 | `case PH7_OP_LAND:` |
|        - | 2653 | `case PH7_OP_LOR: {` |
|        - | 2654 | `	VmOpRc rcOp;` |
|   228617 | 2655 | `	sState.pTos = pTos;` |
|   228617 | 2656 | `	sState.pc = pc;` |
|   228617 | 2657 | `	rcOp = VmExecOpLor(&(*pVm),&sState,pInstr);` |
|   228617 | 2658 | `	pTos = sState.pTos;` |
|   228617 | 2659 | `	pc = sState.pc;` |
|   228617 | 2660 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2661 | `		goto Abort;` |
|   228617 | 2662 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2734 | `	}` |
|        - | 2735 | `#endif` |
|      108 | 2736 | `	if( (pTos->iFlags & MEMOBJ_NULL) \|\| pTos->iFlags == 0 ){` |
...
|        - | 2827 | `	}` |
|        - | 2828 | `#endif` |
|      682 | 2829 | `	pTos->iFlags \|= MEMOBJ_AUX_SPREAD;` |
|      682 | 2830 | `	break;` |
|        - | 2831 | `}` |
|        - | 2832 | `/* OP_LXOR: * * *` |
|        - | 2833 | ` *` |
...
|        - | 2877 | ` */` |
|     5436 | 2878 | `case PH7_OP_EQ:` |
|        - | 2879 | `case PH7_OP_NEQ: {` |
|        - | 2880 | `	VmOpRc rcOp;` |
|    10877 | 2881 | `	sState.pTos = pTos;` |
|    10877 | 2882 | `	sState.pc = pc;` |
|    10877 | 2883 | `	rcOp = VmExecOpNeq(&(*pVm),&sState,pInstr);` |
|    10877 | 2884 | `	pTos = sState.pTos;` |
|    10877 | 2885 | `	pc = sState.pc;` |
|    10877 | 2886 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2887 | `		goto Abort;` |
|    10877 | 2888 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2899 | ` */` |
|   228111 | 2900 | `case PH7_OP_TEQ: {` |
|        - | 2901 | `	VmOpRc rcOp;` |
|   456433 | 2902 | `	sState.pTos = pTos;` |
|   456433 | 2903 | `	sState.pc = pc;` |
|   456433 | 2904 | `	rcOp = VmExecOpTeq(&(*pVm),&sState,pInstr);` |
|   456433 | 2905 | `	pTos = sState.pTos;` |
|   456433 | 2906 | `	pc = sState.pc;` |
|   456433 | 2907 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2908 | `		goto Abort;` |
|   456433 | 2909 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2921 | ` *` |
|        - | 2922 | ` */` |
|   174476 | 2923 | `case PH7_OP_TNE: {` |
|        - | 2924 | `	VmOpRc rcOp;` |
|   349163 | 2925 | `	sState.pTos = pTos;` |
|   349163 | 2926 | `	sState.pc = pc;` |
|   349163 | 2927 | `	rcOp = VmExecOpTne(&(*pVm),&sState,pInstr);` |
|   349163 | 2928 | `	pTos = sState.pTos;` |
|   349163 | 2929 | `	pc = sState.pc;` |
|   349163 | 2930 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2931 | `		goto Abort;` |
|   349163 | 2932 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2953 | ` *` |
|        - | 2954 | ` */` |
|   145887 | 2955 | `case PH7_OP_LT:` |
|        - | 2956 | `case PH7_OP_LE: {` |
|        - | 2957 | `	VmOpRc rcOp;` |
|   292191 | 2958 | `	sState.pTos = pTos;` |
|   292191 | 2959 | `	sState.pc = pc;` |
|   292191 | 2960 | `	rcOp = VmExecOpLe(&(*pVm),&sState,pInstr);` |
|   292191 | 2961 | `	pTos = sState.pTos;` |
|   292191 | 2962 | `	pc = sState.pc;` |
|   292191 | 2963 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2964 | `		goto Abort;` |
|   292191 | 2965 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2986 | ` *` |
|        - | 2987 | ` */` |
|    86045 | 2988 | `case PH7_OP_GT:` |
|        - | 2989 | `case PH7_OP_GE: {` |
|        - | 2990 | `	VmOpRc rcOp;` |
|   172301 | 2991 | `	sState.pTos = pTos;` |
|   172301 | 2992 | `	sState.pc = pc;` |
|   172301 | 2993 | `	rcOp = VmExecOpGe(&(*pVm),&sState,pInstr);` |
|   172301 | 2994 | `	pTos = sState.pTos;` |
|   172301 | 2995 | `	pc = sState.pc;` |
|   172301 | 2996 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2997 | `		goto Abort;` |
|   172301 | 2998 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3053 | `	VmOpRc rcOp;` |
|       56 | 3054 | `	sState.pTos = pTos;` |
|       56 | 3055 | `	sState.pc = pc;` |
|       56 | 3056 | `	rcOp = VmExecOpStoreRef(&(*pVm),&sState,pInstr);` |
|       56 | 3057 | `	pTos = sState.pTos;` |
|       56 | 3058 | `	pc = sState.pc;` |
|       56 | 3059 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 3060 | `		goto Abort;` |
...
|        - | 3095 | ` */` |
|     1346 | 3096 | `case PH7_OP_LOAD_EXCEPTION: {` |
|        - | 3097 | `	VmOpRc rcOp;` |
|     2697 | 3098 | `	sState.pTos = pTos;` |
|     2697 | 3099 | `	sState.pc = pc;` |
|     2697 | 3100 | `	rcOp = VmExecOpLoadException(&(*pVm),&sState,pInstr);` |
|     2697 | 3101 | `	pTos = sState.pTos;` |
|     2697 | 3102 | `	pc = sState.pc;` |
|     2697 | 3103 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 3104 | `		goto Abort;` |
|     2697 | 3105 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3113 | ` */` |
|     1179 | 3114 | `case PH7_OP_POP_EXCEPTION: {` |
|     2363 | 3115 | `	ph7_exception *pCompiledExc = (ph7_exception *)pInstr->p3;` |
...
|     2363 | 3120 | `	ph7_exception *pException = 0;` |
|     2363 | 3121 | `	if( SySetUsed(&pVm->aException) > 0 ){` |
...
|      193 | 3135 | `		}` |
|      200 | 3136 | `	}` |
|     2363 | 3137 | `	if( pCompiledExc->iInlined ){` |
...
|     2209 | 3164 | `	if( pVm->pFrame->iFlags & VM_FRAME_EXCEPTION ){` |
|     1601 | 3165 | `		VmLeaveFrame(&(*pVm));` |
|      798 | 3166 | `	}` |
...
|     2209 | 3170 | `	if( pException && pCompiledExc->iHasFinally && !pException->iFinallyDone ){` |
...
|        - | 3188 | `		}` |
|       12 | 3189 | `	}` |
|     2205 | 3190 | `	VmExcRelease(&(*pVm),pException); /* no-finally / already-done paths (may be NULL) */` |
|     2205 | 3191 | `	if( VmSkipExceptionFrames(pVm->pFrame)->bHasRet ){` |
...
|       34 | 3305 | `	sxu32 iFpc = 0;` |
|       34 | 3306 | `	int nCross = -1; /* a return crosses every enclosing finally in this function */` |
|       34 | 3307 | `	SyZero(&sAct,sizeof(sAct));` |
|       34 | 3308 | `	sAct.eKind = PH7_FA_RETURN;` |
|       34 | 3309 | `	sAct.pTargetBody = (void *)VmSkipExceptionFrames(pVm->pFrame);` |
|       34 | 3310 | `	PH7_MemObjInit(pVm,&sAct.sRet);` |
|       34 | 3311 | `	if( pInstr->iP1 && pTos >= pStack ){` |
|       30 | 3312 | `		PH7_MemObjStore(pTos,&sAct.sRet);` |
|       30 | 3313 | `		sAct.bHasRetVal = 1;` |
|       30 | 3314 | `		VmPopOperand(&pTos,1);` |
|       13 | 3315 | `	}` |
|       34 | 3316 | `	if( VmFinallyAdvance(&(*pVm),aInstr,&nCross,&iFpc) ){` |
...
|       28 | 3323 | `	if( sAct.bHasRetVal && sState.pResult ){` |
|       26 | 3324 | `		PH7_MemObjStore(&sAct.sRet,sState.pResult);` |
|       11 | 3325 | `	}` |
|       28 | 3326 | `	PH7_MemObjRelease(&sAct.sRet);` |
|       28 | 3327 | `	goto Done;` |
|        - | 3328 | `						 }` |
|        - | 3329 | `/*` |
...
|        - | 3354 | ` */` |
|      377 | 3355 | `case PH7_OP_THROW: {` |
|        - | 3356 | `	VmOpRc rcOp;` |
|      759 | 3357 | `	sState.pTos = pTos;` |
|      759 | 3358 | `	sState.pc = pc;` |
|      759 | 3359 | `	rcOp = VmExecOpThrow(&(*pVm),&sState,pInstr);` |
|      759 | 3360 | `	pTos = sState.pTos;` |
|      759 | 3361 | `	pc = sState.pc;` |
|      759 | 3362 | `	if( rcOp == VM_OP_ABORT ){` |
|       32 | 3363 | `		goto Abort;` |
|      731 | 3364 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3372 | ` */` |
|    11998 | 3373 | `case PH7_OP_FOREACH_INIT: {` |
|        - | 3374 | `	VmOpRc rcOp;` |
|    24001 | 3375 | `	sState.pTos = pTos;` |
|    24001 | 3376 | `	sState.pc = pc;` |
|    24001 | 3377 | `	rcOp = VmExecOpForeachInit(&(*pVm),&sState,pInstr);` |
|    24001 | 3378 | `	pTos = sState.pTos;` |
|    24001 | 3379 | `	pc = sState.pc;` |
|    24001 | 3380 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 3381 | `		goto Abort;` |
|    24001 | 3382 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3390 | ` */` |
|   130043 | 3391 | `case PH7_OP_FOREACH_STEP: {` |
|        - | 3392 | `	VmOpRc rcOp;` |
|   260091 | 3393 | `	sState.pTos = pTos;` |
|   260091 | 3394 | `	sState.pc = pc;` |
|   260091 | 3395 | `	rcOp = VmExecOpForeachStep(&(*pVm),&sState,pInstr);` |
|   260091 | 3396 | `	pTos = sState.pTos;` |
|   260091 | 3397 | `	pc = sState.pc;` |
|   260091 | 3398 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 3399 | `		goto Abort;` |
|   260089 | 3400 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3408 | ` */` |
|    22351 | 3409 | `case PH7_OP_MEMBER: {` |
|        - | 3410 | `	VmOpRc rcOp;` |
|    44707 | 3411 | `	sState.pTos = pTos;` |
|    44707 | 3412 | `	sState.pc = pc;` |
|    44707 | 3413 | `	rcOp = VmExecOpMember(&(*pVm),&sState,pInstr);` |
|    44707 | 3414 | `	pTos = sState.pTos;` |
|    44707 | 3415 | `	pc = sState.pc;` |
|    44707 | 3416 | `	if( rcOp == VM_OP_ABORT ){` |
|        8 | 3417 | `		goto Abort;` |
|    44701 | 3418 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3426 | ` */` |
|     2384 | 3427 | `case PH7_OP_NEW: {` |
|        - | 3428 | `	VmOpRc rcOp;` |
|     4773 | 3429 | `	sState.pTos = pTos;` |
|     4773 | 3430 | `	sState.pc = pc;` |
|     4773 | 3431 | `	rcOp = VmExecOpNew(&(*pVm),&sState,pInstr);` |
|     4773 | 3432 | `	pTos = sState.pTos;` |
|     4773 | 3433 | `	pc = sState.pc;` |
|     4773 | 3434 | `	if( rcOp == VM_OP_ABORT ){` |
|        5 | 3435 | `		goto Abort;` |
|     4769 | 3436 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3446 | `	VmOpRc rcOp;` |
|      218 | 3447 | `	sState.pTos = pTos;` |
|      218 | 3448 | `	sState.pc = pc;` |
|      218 | 3449 | `	rcOp = VmExecOpClone(&(*pVm),&sState,pInstr);` |
|      218 | 3450 | `	pTos = sState.pTos;` |
|      218 | 3451 | `	pc = sState.pc;` |
|      218 | 3452 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 3453 | `		goto Abort;` |
|      218 | 3454 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|       68 | 3692 | `			ph7_generator *pInner = VmGeneratorExtractCtx(&(*pVm),&pCtxFrom->sDelegate);` |
...
|       68 | 3697 | `			ph7_class_instance *pInjFwd = pCtxFrom->pInjected;` |
|       68 | 3698 | `			pCtxFrom->pInjected = 0;` |
|       68 | 3699 | `			if( pInner && pInner->pCtx && pInner->pCtx->iState == PH7_CTX_STATE_SUSPENDED ){` |
|       68 | 3700 | `				if( pInjFwd ){` |
...
|        3 | 3706 | `				}else{` |
|       64 | 3707 | `					rcm = VmResumeCtx(&(*pVm),pInner->pCtx,pTos,0);` |
|        4 | 3708 | `				}` |
...
|      ! 0 | 3715 | `			}` |
|       68 | 3716 | `			PH7_MemObjRelease(pTos);` |
|       68 | 3717 | `			pTos--;` |
|       68 | 3718 | `			if( rcm == PH7_ABORT \|\| rcm == PH7_EXCEPTION ){ goto yf_propagate; }` |
|       32 | 3719 | `		}else{` |
...
|       18 | 3794 | `	PH7_MemObjRelease(&sKey);` |
|       18 | 3795 | `	PH7_MemObjRelease(&sVal);` |
|       18 | 3796 | `	PH7_MemObjRelease(&pCtxFrom->sDelegate);` |
|       18 | 3797 | `	pCtxFrom->pDelegateNode = 0;` |
|       18 | 3798 | `	pCtxFrom->iDelegateState = 0;` |
|       18 | 3799 | `	PH7_DISPATCH_ENFORCE_RC(rcm)` |
...
|  1038430 | 3813 | `	sxi32 nCallArgs = pInstr->iP1 + (pInstr->iP2 ? VmSpreadOwnExtra(pVm,pInstr->iP1,pTos) : 0);` |
|        - | 3814 | `	ph7_value *pArg;` |
|  1038430 | 3815 | `	pArg = &pTos[-nCallArgs];` |
...
|  1038430 | 3824 | `	VmCallArgMap *pEffCallMap = (VmCallArgMap *)pInstr->p3;` |
...
|  1038430 | 3831 | `	if( VmValueIsClosure(pVm,pTos) ){` |
|        - | 3832 | `		ph7_value sCallable;` |
|     1131 | 3833 | `		PH7_MemObjInit(pVm,&sCallable);` |
|     1131 | 3834 | `		if( VmClosureUnwrap(pVm,pTos,&sCallable) == SXRET_OK ){` |
|     1131 | 3835 | `			PH7_MemObjRelease(pTos);` |
|     1131 | 3836 | `			PH7_MemObjStore(&sCallable,pTos);` |
|      563 | 3837 | `		}` |
|     1131 | 3838 | `		PH7_MemObjRelease(&sCallable);` |
|      563 | 3839 | `	}` |
|        - | 3840 | `	/* Extract function name */` |
|  1038430 | 3841 | `	if( (pTos->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|      142 | 4036 | `		break;` |
|        - | 4037 | `	}` |
|  1038270 | 4038 | `	SyStringInitFromBuf(&sName,SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
...
|  1038270 | 4042 | `	if( sName.nByte > 0 && sName.zString[0] == '\\' ){` |
...
|  1038270 | 4049 | `	pEntry = SyHashGet(&pVm->hFunction,(const void *)sName.zString,sName.nByte);` |
...
|        - | 4055 | `	{` |
|  1038270 | 4056 | `	VmCallArgMap *pCallMap = pEffCallMap;` |
|  1038270 | 4057 | `	if( pEntry == 0 && pCallMap && pCallMap->bIsNamespaced ){` |
...
|        - | 4088 | `		VmSlot sArg;` |
|        - | 4089 | `		sxu32 n;` |
|   104969 | 4090 | `		int bClosureThis = 0;` |
|   104969 | 4091 | `		ph7_class *pClosureScope = 0;` |
|        - | 4092 | `		/* initialize fields */` |
|   104969 | 4093 | `		pVmFunc = (ph7_vm_func *)pEntry->pUserData;` |
|   104969 | 4094 | `		pThis = 0;` |
|   104969 | 4095 | `		pSelf = 0;` |
...
|       14 | 4110 | `		}` |
|   104969 | 4111 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
|        - | 4112 | `			ph7_class_method *pMeth;` |
|        - | 4113 | `			/* Class method call */` |
|    25497 | 4114 | `			ph7_value *pTarget = &pTos[-1];` |
|    25497 | 4115 | `			if( pTarget >= pStack && (pTarget->iFlags & (MEMOBJ_STRING\|MEMOBJ_OBJ\|MEMOBJ_NULL)) ){` |
|        - | 4116 | `				/* Extract the 'this' pointer */` |
|    25497 | 4117 | `				if(pTarget->iFlags & MEMOBJ_OBJ ){` |
|        - | 4118 | `					/* Instance already loaded */` |
|    24461 | 4119 | `					pThis = (ph7_class_instance *)pTarget->x.pOther;` |
|    24461 | 4120 | `					pThis->iRef++;` |
|    24461 | 4121 | `					pSelf = pThis->pClass;` |
|    12228 | 4122 | `				}` |
|    25497 | 4123 | `				if( pSelf == 0 ){` |
...
|      353 | 4142 | `					}` |
|      518 | 4143 | `				}` |
|    25497 | 4144 | `				VmPopOperand(&pTos,1);` |
|    25497 | 4145 | `				PH7_MemObjRelease(pTos);` |
...
|    25497 | 4152 | `				nCallArgs = pInstr->iP1 + (pInstr->iP2 ? VmSpreadOwnExtra(&(*pVm),pInstr->iP1,pTos) : 0);` |
|    25497 | 4153 | `				pArg = &pTos[-nCallArgs];` |
...
|        - | 4158 | `				 */` |
|    25497 | 4159 | `				while( pArg < pStack ){` |
|      ! 0 | 4160 | `					pArg++;` |
|      ! 0 | 4161 | `				}` |
|    25497 | 4162 | `				if( pSelf && pVm->bReflectBypass ){` |
...
|        6 | 4167 | `				}else` |
|    25487 | 4168 | `				if( pSelf ){ /* Paranoid edition */` |
...
|    25487 | 4176 | `					ph7_class *pDeclClass = pVmFunc->pUserData ? (ph7_class *)pVmFunc->pUserData : pSelf;` |
|    25487 | 4177 | `					pMeth = PH7_ClassExtractMethod(pDeclClass,pVmFunc->sName.zString,pVmFunc->sName.nByte);` |
|    25487 | 4178 | `					if( pMeth == 0 && pDeclClass != pSelf ){` |
|      ! 0 | 4179 | `						pMeth = PH7_ClassExtractMethod(pSelf,pVmFunc->sName.zString,pVmFunc->sName.nByte);` |
|      ! 0 | 4180 | `					}` |
|    25487 | 4181 | `					if( pMeth && pMeth->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|   157554 | 4218 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   104964 | 4219 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
...
|   104969 | 4226 | `		if( VmRecursionExceeded(pVm) ){` |
...
|        3 | 4230 | `			goto Abort;` |
|        - | 4231 | `		}` |
|   104967 | 4232 | `		if( pVmFunc->pNextName ){` |
|        - | 4233 | `			/* Function is candidate for overloading,select the appropriate function to call */` |
|      244 | 4234 | `			pVmFunc = VmOverload(&(*pVm),pVmFunc,pArg,(int)(pTos-pArg));` |
|      121 | 4235 | `		}` |
...
|   104967 | 4244 | `		pSelfHint = pSelf;` |
|   104967 | 4245 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
|    25497 | 4246 | `			ph7_class *pDecl = (ph7_class *)pVmFunc->pUserData;` |
|    25497 | 4247 | `			if( pDecl && (pDecl->iFlags & PH7_CLASS_TRAIT) == 0 ){` |
|    24479 | 4248 | `				pSelfHint = pDecl;` |
|    12237 | 4249 | `			}` |
|    12746 | 4250 | `		}` |
|   104967 | 4251 | `		if( pSelf == 0 && (pVmFunc->iFlags & VM_FUNC_CLOSURE) ){` |
...
|     1747 | 4258 | `			if( pClosureScope ){` |
|       29 | 4259 | `				pSelf = pClosureScope;` |
|     1733 | 4260 | `			}else if( pVmFunc->pLsbClass ){` |
|       61 | 4261 | `				pSelf = (ph7_class *)pVmFunc->pLsbClass;` |
|       29 | 4262 | `			}` |
|      871 | 4263 | `		}` |
|   104967 | 4264 | `		if( SySetUsed(&pVmFunc->aAttrs) > 0 ){` |
...
|       57 | 4269 | `		}` |
|   104967 | 4270 | `		if( pVmFunc->iFlags & VM_FUNC_GENERATOR ){` |
...
|   104627 | 4502 | `		aFormalArg = (ph7_vm_func_arg *)SySetBasePtr(&pVmFunc->aArgs);` |
|        - | 4503 | `		/* Create a new VM frame  */` |
|   104627 | 4504 | `		rc = VmEnterFrame(&(*pVm),pVmFunc,pThis,&pFrame);` |
|   104627 | 4505 | `		if( rc != SXRET_OK ){` |
...
|   104627 | 4533 | `		pFrame->nActualArgs = (int)(pTos - pArg);` |
|   104627 | 4534 | `		if( pThis && ((pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) \|\| bClosureThis) ){` |
...
|    24645 | 4537 | `			pObj = VmExtractMemObj(&(*pVm),&sThis,FALSE,TRUE);` |
|    24645 | 4538 | `			if( pObj ){` |
|        - | 4539 | `				/* Reflect the change */` |
|    24645 | 4540 | `				pObj->x.pOther = pThis;` |
|    24645 | 4541 | `				MemObjSetType(pObj,MEMOBJ_OBJ);` |
|    12320 | 4542 | `			}` |
|    12320 | 4543 | `		}` |
|   104627 | 4544 | `		if( SySetUsed(&pVmFunc->aStatic) > 0 ){` |
...
|        - | 4571 | `		{` |
|   104627 | 4572 | `		VmCallArgMap *pCallMap3 = pEffCallMap;` |
|        - | 4573 | `		/* Caller file's strict_types mode — governs parameter coercion` |
|        - | 4574 | `		 * (but NOT return coercion, which uses the callee's file). */` |
|   104627 | 4575 | `		int bCallIsStrict = (pCallMap3 && pCallMap3->bStrict) ? 1 : 0;` |
|   104627 | 4576 | `		if( pCallMap3 && pCallMap3->bHasNamed ){` |
|        - | 4577 | `			/* ============================================================` |
...
|        - | 4962 | `		 * ============================================================ */` |
|   104359 | 4963 | `		n = 0;` |
|   264711 | 4964 | `		while( pArg < pTos ){` |
|   160657 | 4965 | `			if( n < SySetUsed(&pVmFunc->aArgs) && (aFormalArg[n].iFlags & VM_FUNC_ARG_VARIADIC) ){` |
...
|        - | 5065 | `			}` |
|   160457 | 5066 | `			if( n < SySetUsed(&pVmFunc->aArgs) ){` |
...
|   159987 | 5073 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_UNION ){` |
...
|       14 | 5083 | `							zGiven = VmFormatValueClassName(pArg,zBuf,sizeof(zBuf));` |
...
|   159900 | 5106 | `				if( aFormalArg[n].nType > 0` |
|    87183 | 5107 | `					&& !((aFormalArg[n].iFlags & VM_FUNC_ARG_NULLABLE) && (pArg->iFlags & MEMOBJ_NULL)) ){` |
|    14015 | 5108 | `					if ( aFormalArg[n].nType == SXU32_HIGH ){` |
...
|        - | 5152 | `							}` |
|      100 | 5153 | `						}` |
|    13794 | 5154 | `					}else if( ((pArg->iFlags & aFormalArg[n].nType) == 0) ){` |
|       74 | 5155 | `						if( aFormalArg[n].nType == MEMOBJ_OBJ ){` |
...
|       64 | 5168 | `						}else if( VmEnforceScalarType(pArg, aFormalArg[n].nType, bCallIsStrict) != SXRET_OK ){` |
|        - | 5169 | `							char zTypeBuf[128];` |
|       55 | 5170 | `							rc = VmThrowTypeErrorForArg(&(*pVm),pSelfHint,pVmFunc,n+1,` |
|       34 | 5171 | `								&aFormalArg[n].sName,` |
|       34 | 5172 | `								VmScalarTypeName(aFormalArg[n].nType, &aFormalArg[n].sTypeName, zTypeBuf, sizeof(zTypeBuf)),` |
|       17 | 5173 | `								ph7_type_name(pArg));` |
|       38 | 5174 | `							if( rc == PH7_ABORT ){` |
|        6 | 5175 | `								goto Abort;` |
|        - | 5176 | `							}` |
|       33 | 5177 | `							PH7_MemObjRelease(pTos);` |
|       33 | 5178 | `							pTos = &pTos[-nCallArgs];` |
|       33 | 5179 | `							pFrameStack = 0;` |
|       33 | 5180 | `							rc = PH7_EXCEPTION;` |
|       33 | 5181 | `							goto SkipFuncBody;` |
|        - | 5182 | `						}` |
|       13 | 5183 | `					}` |
|     6967 | 5184 | `				}` |
|   159889 | 5185 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_BY_REF ){` |
|        - | 5186 | `					/* Pass by reference */` |
|      243 | 5187 | `					if( pArg->nIdx == pVm->nGlobalIdx && pArg->nIdx != SXU32_HIGH ){` |
...
|        - | 5203 | `					}` |
|      241 | 5204 | `					if( pArg->nIdx == SXU32_HIGH ){` |
...
|      239 | 5225 | `						pRefEntry = SyHashGet(&pFrame->hVar,SyStringData(&aFormalArg[n].sName),SyStringLength(&aFormalArg[n].sName));` |
|      239 | 5226 | `						if( pRefEntry == 0 ){` |
|      357 | 5227 | `							SyHashInsert(&pFrame->hVar,SyStringData(&aFormalArg[n].sName),` |
|      236 | 5228 | `								SyStringLength(&aFormalArg[n].sName),SX_INT_TO_PTR(pArg->nIdx));` |
|      239 | 5229 | `							sArg.nIdx = pArg->nIdx;` |
|      239 | 5230 | `							sArg.pUserData = 0;` |
|      239 | 5231 | `							SySetPut(&pFrame->sArg,(const void *)&sArg);` |
|      118 | 5232 | `						}` |
|      239 | 5233 | `						pObj = 0;` |
|        - | 5234 | `					}` |
|      122 | 5235 | `				}else{` |
|        - | 5236 | `					/* Pass by value,make a copy of the given argument */` |
|   159649 | 5237 | `					pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|        - | 5238 | `				}` |
|    80152 | 5239 | `			}else{` |
|        - | 5240 | `				char zName[32];` |
|        - | 5241 | `				SyString sArgName;` |
|        - | 5242 | `				/* Set a dummy name */` |
|      473 | 5243 | `				sArgName.nByte = SyBufferFormat(zName,sizeof(zName),"[%u]apArg",n);` |
|      473 | 5244 | `				sArgName.zString = zName;` |
|        - | 5245 | `				/* Annonymous argument */` |
|      473 | 5246 | `				pObj = VmExtractMemObj(&(*pVm),&sArgName,TRUE,TRUE);` |
|        - | 5247 | `			}` |
|   160357 | 5248 | `			if( pObj ){` |
|   160121 | 5249 | `				PH7_MemObjStore(pArg,pObj);` |
|        - | 5250 | `				/* Insert argument index  */` |
|   160121 | 5251 | `				sArg.nIdx = pObj->nIdx;` |
|   160121 | 5252 | `				sArg.pUserData = 0;` |
|   160121 | 5253 | `				SySetPut(&pFrame->sArg,(const void *)&sArg);` |
|    80264 | 5254 | `			}` |
|   160357 | 5255 | `			PH7_MemObjRelease(pArg);` |
|   160357 | 5256 | `			pArg++;` |
|   160357 | 5257 | `			++n;` |
|        5 | 5258 | `		}` |
|        - | 5259 | `		} /* end named vs positional branch */` |
|        - | 5260 | `		/* Set up closure environment */` |
|   104505 | 5261 | `		if( pVmFunc->iFlags & VM_FUNC_CLOSURE ){` |
...
|       11 | 5273 | `				 && SyMemcmp(SyStringData(&pEnv->sName),"this",sizeof("this")-1) == 0 ){` |
...
|        5 | 5277 | `					continue;` |
|        - | 5278 | `				}` |
|      367 | 5279 | `				if( (pEnv->iFlags & VM_FUNC_ARG_BY_REF) && pEnv->nIdx != SXU32_HIGH ){` |
...
|      138 | 5286 | `					continue;` |
|        - | 5287 | `				}` |
|      230 | 5288 | `				pValue = VmExtractMemObj(pVm,&pEnv->sName,FALSE,TRUE);` |
|      230 | 5289 | `				if( pValue == 0 ){` |
|      ! 0 | 5290 | `					continue;` |
|        - | 5291 | `				}` |
|        - | 5292 | `				/* Invalidate any prior representation */` |
|      230 | 5293 | `				PH7_MemObjRelease(pValue);` |
|        - | 5294 | `				/* Duplicate bound variable value */` |
|      230 | 5295 | `				PH7_MemObjStore(&pEnv->sValue,pValue);` |
|      117 | 5296 | `			}` |
|      862 | 5297 | `		}` |
...
|   104500 | 5309 | `		if( n < SySetUsed(&pVmFunc->aArgs)` |
|    54910 | 5310 | `		 && (pVmFunc->iFlags & (VM_FUNC_INTERNAL\|VM_FUNC_CLASS_METHOD)) != VM_FUNC_INTERNAL ){` |
|        - | 5311 | `			sxu32 nNonVar,nReq;` |
|     3859 | 5312 | `			nReq = VmFuncRequiredArgCount(pVmFunc,&nNonVar);` |
|     3859 | 5313 | `			if( n < nReq ){` |
...
|   112401 | 5333 | `		while( n < SySetUsed(&pVmFunc->aArgs) ){` |
|     8167 | 5334 | `			if( aFormalArg[n].iFlags & VM_FUNC_ARG_VARIADIC ){` |
...
|        - | 5345 | `			}` |
|     7923 | 5346 | `			if( SySetUsed(&aFormalArg[n].aByteCode) > 0 ){` |
|     7921 | 5347 | `				pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|     7921 | 5348 | `				if( pObj ){` |
|        - | 5349 | `					/* Evaluate the default value and extract it's result */` |
|     7921 | 5350 | `					rc = VmLocalExec(&(*pVm),&aFormalArg[n].aByteCode,pObj,FALSE);` |
|     7921 | 5351 | `					if( rc == PH7_ABORT ){` |
|      ! 0 | 5352 | `						goto Abort;` |
|        - | 5353 | `					}` |
|        - | 5354 | `					/* Insert argument index */` |
|     7921 | 5355 | `					sArg.nIdx = pObj->nIdx;` |
|     7921 | 5356 | `					sArg.pUserData = 0;` |
|     7921 | 5357 | `					SySetPut(&pFrame->sArg,(const void *)&sArg);` |
...
|     7916 | 5362 | `					if( aFormalArg[n].nType > 0 && aFormalArg[n].nType != MEMOBJ_OBJ` |
|     3872 | 5363 | `						&& ((pObj->iFlags & aFormalArg[n].nType) == 0)` |
|     1942 | 5364 | `						&& !((aFormalArg[n].iFlags & VM_FUNC_ARG_NULLABLE) && (pObj->iFlags & MEMOBJ_NULL)) ){` |
...
|        - | 5376 | `		 */` |
|   104483 | 5377 | `		PH7_MemObjRelease(pTos);` |
|   104483 | 5378 | `		pTos = &pTos[-nCallArgs];` |
...
|        - | 5390 | `		 * per function. */` |
|        - | 5391 | `		{` |
|   104483 | 5392 | `			sxu32 nSlots = pVmFunc->nMaxStack;` |
|   104483 | 5393 | `			if( nSlots == 0 ){` |
|     8217 | 5394 | `				sxu32 nInstr = SySetUsed(&pVmFunc->aByteCode);` |
|    12323 | 5395 | `				sxu32 nTight = VmComputeMaxStack(&(*pVm),` |
|     8212 | 5396 | `					(VmInstr *)SySetBasePtr(&pVmFunc->aByteCode),nInstr);` |
|     8217 | 5397 | `				nSlots = ( nTight == VM_STACK_UNMODELED ) ? nInstr : nTight;` |
|     8217 | 5398 | `				if( nSlots == 0 ){ nSlots = 1; } /* a 0-depth body still needs a valid, nonzero cache marker */` |
|     8217 | 5399 | `				pVmFunc->nMaxStack = nSlots;` |
|     4106 | 5400 | `			}` |
|   104483 | 5401 | `			pFrameStack = VmOperandStackAlloc(&(*pVm),nSlots);` |
|        - | 5402 | `		}` |
|   104483 | 5403 | `		if( pFrameStack == 0 ){` |
...
|      ! 0 | 5410 | `			break;` |
|        - | 5411 | `		}` |
|    52136 | 5412 | `SkipFuncBody:` |
|   104617 | 5413 | `		if( pSelf ){` |
|        - | 5414 | `			/* Push class name */` |
|    25551 | 5415 | `			SySetPut(&pVm->aSelf,(const void *)&pSelf);` |
|    12773 | 5416 | `		}` |
|        - | 5417 | `		/* Increment nesting level */` |
|   104617 | 5418 | `		pVm->nRecursionDepth++;` |
|   104617 | 5419 | `		if( rc == PH7_EXCEPTION ){` |
...
|      139 | 5423 | `			sCallee.pVmFunc = pVmFunc;` |
|      139 | 5424 | `			sCallee.pFrame = pFrame;` |
|      139 | 5425 | `			sCallee.pFrameStack = pFrameStack;` |
|      139 | 5426 | `			sCallee.nStackCap = pVmFunc->nMaxStack + VM_STACK_GUARD;` |
|      139 | 5427 | `			sCallee.nLastRef = SXU32_HIGH;` |
|      139 | 5428 | `			sCallee.bSelfPushed = (sxu8)(pSelf ? 1 : 0);` |
|      139 | 5429 | `			sState.pTos = pTos;` |
|      139 | 5430 | `			sState.pc = pc;` |
|      139 | 5431 | `			rc = VmCallFinish(&(*pVm),&sState,&sCallee,rc);` |
|      139 | 5432 | `			pTos = sState.pTos;` |
|      139 | 5433 | `			pc = sState.pc;` |
|      139 | 5434 | `			if( rc == PH7_ABORT ){` |
|        - | 5435 | `				/* Abort processing immeditaley */` |
|      ! 0 | 5436 | `				goto Abort;` |
|      139 | 5437 | `			}else if( rc == PH7_SUSPEND ){` |
|      ! 0 | 5438 | `				goto Suspend;` |
|      139 | 5439 | `			}else if( rc == PH7_EXCEPTION ){` |
...
|   104483 | 5448 | `			VmCallFrame *pRec = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   104483 | 5449 | `			if( pRec ){` |
|   101863 | 5450 | `				pVm->pIdleCallFrames = (void *)pRec->pPrev;` |
|    51037 | 5451 | `			}else{` |
|     2625 | 5452 | `				pRec = (VmCallFrame *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmCallFrame));` |
|        - | 5453 | `			}` |
|   104483 | 5454 | `			if( pRec == 0 ){` |
...
|      ! 0 | 5465 | `				goto Abort;` |
|        - | 5466 | `			}` |
|   104483 | 5467 | `			sState.pTos = pTos;` |
|   104483 | 5468 | `			sState.pc = pc;` |
|   104483 | 5469 | `			pRec->sCaller = sState;` |
|   104483 | 5470 | `			pRec->sCall.pVmFunc = pVmFunc;` |
|   104483 | 5471 | `			pRec->sCall.pFrame = pFrame;` |
|   104483 | 5472 | `			pRec->sCall.pFrameStack = pFrameStack;` |
|   104483 | 5473 | `			pRec->sCall.nStackCap = pVmFunc->nMaxStack + VM_STACK_GUARD;` |
|   104483 | 5474 | `			pRec->sCall.nLastRef = SXU32_HIGH;` |
|   104483 | 5475 | `			pRec->sCall.bSelfPushed = (sxu8)(pSelf ? 1 : 0);` |
|   104483 | 5476 | `			pRec->pPrev = pCallTop;` |
|   104483 | 5477 | `			pCallTop = pRec;` |
|        - | 5478 | `			/* Switch to the callee activation (what the recursive` |
|        - | 5479 | `			 * VmByteCodeExec entry used to set up). */` |
|   104483 | 5480 | `			aInstr = (VmInstr *)SySetBasePtr(&pVmFunc->aByteCode);` |
|   104483 | 5481 | `			pStack = pFrameStack;` |
|   104483 | 5482 | `			pTos = &pStack[-1];` |
|   104483 | 5483 | `			pc = 0;` |
|   104483 | 5484 | `			sState.aInstr = aInstr;` |
|   104483 | 5485 | `			sState.pStack = pStack;` |
|   104483 | 5486 | `			sState.nStackCap = pRec->sCall.nStackCap; /* callee's operand-stack capacity for OP_SPREAD growth */` |
|   104483 | 5487 | `			sState.nStackOrig = pRec->sCall.nStackCap; /* fixed headroom reference (never grows) */` |
|   104483 | 5488 | `			sState.pTos = pTos;` |
|   104483 | 5489 | `			sState.pc = 0;` |
|   104483 | 5490 | `			sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|   104483 | 5491 | `			sState.pEntryFrame = pVm->pFrame;` |
|   104483 | 5492 | `			sState.pResult = pRec->sCaller.pTos;` |
|   104483 | 5493 | `			sState.pLastRef = &pRec->sCall.nLastRef;` |
|   104483 | 5494 | `			sState.pEnforceRetFunc = VmFuncHasReturnType(pVmFunc) ? pVmFunc : 0;` |
|   104483 | 5495 | `			sState.is_callback = 0;` |
|   104483 | 5496 | `			sState.bReturnPropagates = 0;` |
|   104483 | 5497 | `			goto VmLoopFetch;` |
|        - | 5498 | `		}` |
|       57 | 5499 | `	}else{` |
...
|   933306 | 5508 | `		pEntry = SyHashGet(&pVm->hHostFunction,(const void *)sName.zString,sName.nByte);` |
|        - | 5509 | `		{` |
|   933306 | 5510 | `		VmCallArgMap *pCallMap2 = pEffCallMap;` |
|   933306 | 5511 | `		if( pEntry == 0 && pCallMap2 && pCallMap2->bIsNamespaced ){` |
...
|        - | 5616 | `			}` |
|        - | 5617 | `		}` |
|   933290 | 5618 | `		pFunc = (ph7_user_func *)pEntry->pUserData;` |
...
|  1400297 | 5623 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   933285 | 5624 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
|        - | 5625 | `		/* Start collecting function arguments */` |
|   933290 | 5626 | `		SySetReset(&aArg);` |
|  2521771 | 5627 | `		while( pArg < pTos ){` |
|  1588486 | 5628 | `			SySetPut(&aArg,(const void *)&pArg);` |
|  1588486 | 5629 | `			pArg++;` |
|        5 | 5630 | `		}` |
|        - | 5631 | `		/* Assume a null return value */` |
|   933290 | 5632 | `		PH7_MemObjInit(&(*pVm),&sRet);` |
|        - | 5633 | `		/* Init the call context */` |
|   933290 | 5634 | `		VmInitCallContext(&sCtx,&(*pVm),pFunc,&sRet,0);` |
...
|   933290 | 5641 | `		sCtx.pArgMap = pEffCallMap;` |
|        - | 5642 | `		{` |
|   933290 | 5643 | `		int nGiven = (int)SySetUsed(&aArg);` |
...
|   933290 | 5649 | `		if( pFunc->nMinArg > 0 && nGiven < pFunc->nMinArg ){` |
|      701 | 5650 | `			rc = PH7_VmThrowException(&sCtx,"ArgumentCountError",` |
|        - | 5651 | `				"%z() expects %s %d argument%s, %d given",` |
|      232 | 5652 | `				&pFunc->sName,` |
|      464 | 5653 | `				pFunc->bAtLeast ? "at least" : "exactly",` |
|      464 | 5654 | `				(int)pFunc->nMinArg,` |
|      464 | 5655 | `				pFunc->nMinArg == 1 ? "" : "s",` |
|      232 | 5656 | `				nGiven);` |
|  1399833 | 5657 | `		}else if( SXRET_OK != (rc = VmEnforceBuiltinArgTypes(&sCtx,pFunc,nGiven,` |
|   932821 | 5658 | `			(ph7_value **)SySetBasePtr(&aArg))) ){` |
|        - | 5659 | `			/* TypeError thrown: rc carries the caught/uncaught status */` |
|       91 | 5660 | `		}else{` |
|        - | 5661 | `			/* Call the foreign function */` |
|   932654 | 5662 | `			rc = pFunc->xFunc(&sCtx,nGiven,(ph7_value **)SySetBasePtr(&aArg));` |
|        - | 5663 | `		}` |
|        - | 5664 | `		}` |
|        - | 5665 | `		/* Release the call context */` |
|   933290 | 5666 | `		VmReleaseCallContext(&sCtx);` |
|   933290 | 5667 | `		if( rc == PH7_ABORT ){` |
...
|      576 | 5672 | `			goto Abort;` |
|        - | 5673 | `		}` |
|   932718 | 5674 | `		if( rc != PH7_SUSPEND && pVm->pInlineInstr == (void *)aInstr ){` |
...
|      ! 0 | 5687 | `		}` |
|   932714 | 5688 | `		if( rc == PH7_EXCEPTION ){` |
...
|      967 | 5696 | `			if( !VmRecordedResume(pVm,&iResumePc,sState.pEntryFrame,aInstr) ){` |
...
|      771 | 5702 | `			PH7_MemObjRelease(&sRet);` |
|      771 | 5703 | `			if( nCallArgs > 0 ){` |
|      485 | 5704 | `				VmPopOperand(&pTos,nCallArgs); /* spread-adjusted; see the normal-return path */` |
|      240 | 5705 | `			}` |
|      771 | 5706 | `			VmPopOperand(&pTos,1);` |
|      771 | 5707 | `			pc = iResumePc;` |
|      771 | 5708 | `			break;` |
|        - | 5709 | `		}` |
|   931752 | 5710 | `		if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|   910332 | 5734 | `			VmPopOperand(&pTos,nCallArgs);` |
|   455528 | 5735 | `		}` |
|        - | 5736 | `		/* Save foreign function return value into the (now top) function-name slot */` |
|   931398 | 5737 | `		PH7_MemObjStore(&sRet,pTos);` |
|   931398 | 5738 | `		PH7_MemObjRelease(&sRet);` |
|        - | 5739 | `	}` |
|   931502 | 5740 | `	break;` |
|        - | 5741 | `				  }` |
|        - | 5742 | `/*` |
...
|        - | 5745 | ` */` |
|    25510 | 5746 | `case PH7_OP_CONSUME: {` |
|        - | 5747 | `	VmOpRc rcOp;` |
|    51025 | 5748 | `	sState.pTos = pTos;` |
|    51025 | 5749 | `	sState.pc = pc;` |
|    51025 | 5750 | `	rcOp = VmExecOpConsume(&(*pVm),&sState,pInstr);` |
|    51025 | 5751 | `	pTos = sState.pTos;` |
|    51025 | 5752 | `	pc = sState.pc;` |
|    51025 | 5753 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 5754 | `		goto Abort;` |
|    51025 | 5755 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 5760 |  |
|        - | 5761 | `		} /* Switch() */` |
| 16439043 | 5762 | `		pc++; /* Next instruction in the stream */` |
|        5 | 5763 | `	} /* For(;;) */` |
|   128723 | 5764 | `Done:` |
...
|   257657 | 5768 | `	rc = SXRET_OK;` |
|   257657 | 5769 | `	goto Unwind;` |
|      823 | 5770 | `Suspend:` |
...
|      374 | 5811 | `Abort:` |
|      752 | 5812 | `	rc = PH7_ABORT;` |
|      752 | 5813 | `	goto Unwind;` |
|      394 | 5814 | `Exception:` |
...
|   130726 | 5828 | `	for(;;){` |
|   261251 | 5829 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|     2306 | 5834 | `			while( SySetUsed(&pVm->aHookRmw) > 0` |
|     2307 | 5835 | `			 && ((VmHookRmw *)SySetPeek(&pVm->aHookRmw))->pOwnerStack == (void *)pStack ){` |
|      ! 0 | 5836 | `				VmHookRmwDropTop(&(*pVm));` |
|      ! 0 | 5837 | `			}` |
|     1151 | 5838 | `		}` |
|   261251 | 5839 | `		if( pCallTop == 0 ){` |
|   157183 | 5840 | `			return VmExecFinalize(&(*pVm),&sState,&aArg,pTos,rc);` |
|        - | 5841 | `		}` |
|   104073 | 5842 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
|     1257 | 5843 | `			VmClearFrameReturn(sState.pEntryFrame);` |
|     2549 | 5844 | `			while( pTos >= pStack ){` |
|     1297 | 5845 | `				PH7_MemObjRelease(pTos);` |
|     1297 | 5846 | `				pTos--;` |
|        5 | 5847 | `			}` |
|      626 | 5848 | `		}` |
|        - | 5849 | `		{` |
|   104073 | 5850 | `			VmCallFrame *pRec = pCallTop;` |
|   104073 | 5851 | `			sState = pRec->sCaller;` |
|   104073 | 5852 | `			rc = VmCallFinish(&(*pVm),&sState,&pRec->sCall,rc);` |
|   104073 | 5853 | `			pCallTop = pRec->pPrev;` |
|   104073 | 5854 | `			pRec->pPrev = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   104073 | 5855 | `			pVm->pIdleCallFrames = (void *)pRec;` |
|   104073 | 5856 | `			aInstr = sState.aInstr;` |
|   104073 | 5857 | `			pStack = sState.pStack;` |
|   104073 | 5858 | `			pTos = sState.pTos;` |
|   104073 | 5859 | `			pc = sState.pc;` |
|        - | 5860 | `		}` |
|   104073 | 5861 | `		if( rc == PH7_OK ){` |
|   103307 | 5862 | `			pc++; /* the loop-bottom increment this OP_CALL missed */` |
|   103307 | 5863 | `			goto VmLoopFetch;` |
|        - | 5864 | `		}` |
|        5 | 5865 | `	}` |
|    78771 | 5866 | `}` |
|        - | 5867 |  |
