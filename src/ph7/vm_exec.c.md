...
|        - |  162 | ` */` |
|   160940 |  163 | `static sxi32 VmExecFinalize(ph7_vm *pVm,VmExecState *pState,SySet *pArg,ph7_value *pTos,sxi32 rcTerm)` |
|        5 |  164 | `{` |
|    80470 |  165 | `	SXUNUSED(pVm);` |
|   160945 |  166 | `	if( rcTerm != PH7_SUSPEND && !pState->bReturnPropagates ){` |
|   157235 |  167 | `		VmClearFrameReturn(pState->pEntryFrame);` |
|    78615 |  168 | `	}` |
|   160945 |  169 | `	SySetRelease(pArg);` |
|   160945 |  170 | `	if( rcTerm == PH7_ABORT \|\| rcTerm == PH7_EXCEPTION ){` |
|     2841 |  171 | `		while( pTos >= pState->pStack ){` |
|     1789 |  172 | `			PH7_MemObjRelease(pTos);` |
|     1789 |  173 | `			pTos--;` |
|        5 |  174 | `		}` |
|      526 |  175 | `	}` |
|   160945 |  176 | `	return rcTerm;` |
|        5 |  177 | `}` |
|        - |  178 | `/*` |
...
|        - |  189 | ` */` |
|   105932 |  190 | `static sxi32 VmCallFinish(ph7_vm *pVm,VmExecState *pCaller,VmCallRecord *pCallee,sxi32 rc)` |
|        5 |  191 | `{` |
|        - |  192 | `	ph7_value *pObj;` |
|        - |  193 | `	/* Decrement nesting level */` |
|   105937 |  194 | `	pVm->nRecursionDepth--;` |
|   105937 |  195 | `	if( pCallee->bSelfPushed ){` |
|        - |  196 | `		/* Pop class name */` |
|    25549 |  197 | `		(void)SySetPop(&pVm->aSelf);` |
|    12772 |  198 | `	}` |
|   105937 |  199 | `	if( (pCallee->pVmFunc->iFlags & VM_FUNC_REF_RETURN) && rc == SXRET_OK ){` |
...
|       25 |  225 | `	}` |
|   105937 |  226 | `	if( rc != PH7_ABORT && ((pCallee->pFrame->iFlags & VM_FRAME_THROW) \|\| rc == PH7_EXCEPTION) ){` |
...
|   105937 |  272 | `	if( rc != PH7_SUSPEND && pCallee->pFrameStack ){` |
...
|   105803 |  276 | `		VmOperandStackRecycle(pVm,pCallee->pFrameStack,pCallee->nStackCap);` |
|    53004 |  277 | `	}` |
|        - |  278 | `	/* Leave the frame */` |
|   105937 |  279 | `	VmLeaveFrame(&(*pVm));` |
|   105937 |  280 | `	if( rc == PH7_ABORT ){` |
|      336 |  281 | `		return PH7_ABORT;` |
|        - |  282 | `	}` |
|   105605 |  283 | `	if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|        - |  291 | `	}` |
|   105605 |  292 | `	if( rc == PH7_EXCEPTION ){` |
|      469 |  293 | `		return PH7_EXCEPTION;` |
|        - |  294 | `	}` |
|   105141 |  295 | `	return PH7_OK;` |
|    53076 |  296 | `}` |
|        - |  297 | `/*` |
...
|        - |  330 | ` * nesting.` |
|        - |  331 | ` */` |
|   161298 |  332 | `PH7_PRIVATE sxi32 VmByteCodeExec(` |
...
|   161303 |  352 | `	if( VmNativeNestingExceeded(pVm) ){` |
...
|   161299 |  362 | `	nSavedBrc = pVm->nBoundaryRc;` |
|   161299 |  363 | `	pVm->nBoundaryRc = 0;` |
...
|   161299 |  370 | `	nSavedLine = pVm->nCurLine;` |
|   161299 |  371 | `	pVm->nVmExecDepth++;` |
|   241946 |  372 | `	rc = VmByteCodeExecBody(&(*pVm),aInstr,pStack,nTos,pResult,pLastRef,is_callback,nPc,` |
|    80647 |  373 | `		pEnforceRetFunc,bReturnPropagates,pAdoptSegment,ppBaseOwner,pnBaseCap,nStackOrig);` |
|   161299 |  374 | `	pVm->nVmExecDepth--;` |
|   161299 |  375 | `	pVm->nCurLine = nSavedLine;` |
|   161299 |  376 | `	if( nSavedBrc != 0 && (nSavedBrc == PH7_ABORT \|\| pVm->nBoundaryRc == 0) ){` |
|       15 |  377 | `		pVm->nBoundaryRc = nSavedBrc;` |
|        6 |  378 | `	}` |
|   161299 |  379 | `	return rc;` |
|    80654 |  380 | `}` |
|   161294 |  381 | `static sxi32 VmByteCodeExecBody(` |
...
|        - |  399 | `	ph7_value *pTos;` |
|        - |  400 | `	SySet aArg;` |
|   161299 |  401 | `	VmCallFrame *pCallTop = 0; /* Top of this invocation's in-loop call-record` |
...
|        - |  409 | `	sxi32 pc;` |
|        - |  410 | `	sxi32 rc;` |
|   161299 |  411 | `	sState.aInstr = aInstr;` |
|   161299 |  412 | `	sState.pStack = pStack;` |
|   161299 |  413 | `	sState.nStackCap = pnBaseCap ? *pnBaseCap : 0; /* CURRENT capacity (grown on a coroutine resume) */` |
|   161299 |  414 | `	sState.nStackOrig = nStackOrig;                /* ORIGINAL capacity — fixed headroom reference */` |
|   161299 |  415 | `	sState.pResult = pResult;` |
|   161299 |  416 | `	sState.pLastRef = pLastRef;` |
|   161299 |  417 | `	sState.pEnforceRetFunc = pEnforceRetFunc;` |
|   161299 |  418 | `	sState.is_callback = (sxu8)(is_callback ? 1 : 0);` |
|   161299 |  419 | `	sState.bReturnPropagates = (sxu8)(bReturnPropagates ? 1 : 0);` |
|        - |  420 | `	/* Argument container */` |
|   161299 |  421 | `	SySetInit(&aArg,&pVm->sAllocator,sizeof(ph7_value *));` |
|   161299 |  422 | `	if( nTos < 0 ){` |
|   145473 |  423 | `		pTos = &pStack[-1];` |
|    72739 |  424 | `	}else{` |
|    15831 |  425 | `		pTos = &pStack[nTos];` |
|        - |  426 | `	}` |
|   161299 |  427 | `	sState.pTos = pTos;` |
|   161299 |  428 | `	sState.pc = nPc;` |
...
|   161294 |  446 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->pFrame == pVm->pFrame` |
|     2816 |  447 | `	 && pStack == pVm->pActiveCtx->pStack ){` |
|     1805 |  448 | `		sState.nExceptionBase = pVm->pActiveCtx->nExceptionBase;` |
|      905 |  449 | `	}else{` |
|   159499 |  450 | `		sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|        - |  451 | `	}` |
|   161299 |  452 | `	sState.pEntryFrame = pVm->pFrame;` |
|   161299 |  453 | `	pc = nPc;` |
...
|   161294 |  506 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->pInjected` |
...
|   161284 |  567 | `	if( pVm->pActiveCtx && pVm->pActiveCtx->bClosing` |
...
| 17241135 |  603 | `		if( pVm->nBoundaryRc != 0 \|\| SySetUsed(&pVm->aHookRmw) > 0 ){` |
...
| 17241035 |  658 | `		pInstr = &aInstr[pc];` |
| 17241035 |  659 | `		if( pInstr->nLine ){` |
...
| 17028985 |  663 | `			pVm->nCurLine = pInstr->nLine;` |
|  8520834 |  664 | `		}` |
| 17241035 |  665 | `		rc = SXRET_OK;` |
|        - |  666 | `/*` |
...
|        - |  672 | ` */` |
| 17241035 |  673 | `		switch(pInstr->iOp){` |
|        - |  674 | `/*` |
|        - |  675 | ` * DONE: P1 * *` |
|        - |  676 | ` *` |
...
|        - |  679 | ` */` |
|   131356 |  680 | `case PH7_OP_DONE:` |
|   262927 |  681 | `	if( pInstr->iP2 && sState.bReturnPropagates ){` |
...
|   262738 |  711 | `	if( sState.pEnforceRetFunc && VmFuncHasReturnType(sState.pEnforceRetFunc)` |
...
|     4591 |  736 | `	}` |
|   262719 |  737 | `	if( pInstr->iP1 && pTos >= pStack ){` |
|   158443 |  738 | `		if( sState.pLastRef ){` |
|    95407 |  739 | `			*sState.pLastRef = pTos->nIdx;` |
|    47806 |  740 | `		}` |
|   158443 |  741 | `		if( sState.pResult ){` |
|        - |  742 | `			/* Execution result */` |
|   151347 |  743 | `			PH7_MemObjStore(pTos,sState.pResult);` |
|    75776 |  744 | `		}` |
|   158443 |  745 | `		VmPopOperand(&pTos,1);` |
|   183605 |  746 | `	}else if( sState.pLastRef ){` |
...
|        - |  762 | `	 */` |
|   262719 |  763 | `	rc = VmDrainFinally(&(*pVm),sState.nExceptionBase);` |
|   262719 |  764 | `	if( rc == SXERR_ABORT ){` |
|      ! 0 |  765 | `		goto Abort;` |
|        - |  766 | `	}` |
|   262719 |  767 | `	if( rc == PH7_EXCEPTION ){` |
...
|        - |  778 | `	}` |
|   262715 |  779 | `	if( sState.pEntryFrame->bHasRet && !sState.bReturnPropagates ){` |
...
|       10 |  814 | `			}` |
|       22 |  815 | `		}else if(pTos->iFlags & MEMOBJ_INT ){` |
|        - |  816 | `			/* Record exit status */` |
|       16 |  817 | `			pVm->iExitStatus = (sxi32)pTos->x.iVal;` |
|        6 |  818 | `		}` |
...
|        - |  835 | ` */` |
|   282316 |  836 | `case PH7_OP_JMP:` |
|   564847 |  837 | `	pc = pInstr->iP2 - 1;` |
|   564847 |  838 | `	break;` |
|        - |  839 | `/*` |
|        - |  840 | ` * JZ: P1 P2 *` |
|        - |  841 | ` *` |
...
|  1652987 |  852 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     1003 |  853 | `		PH7_MemObjToBool(pTos);` |
|      500 |  854 | `	}` |
|  1652987 |  855 | `	if( !pTos->x.iVal ){` |
|        - |  856 | `		/* Take the jump */` |
|   938259 |  857 | `		pc = pInstr->iP2 - 1;` |
|   469394 |  858 | `	}` |
|  1652987 |  859 | `	if( !pInstr->iP1 ){` |
|  1409117 |  860 | `		VmPopOperand(&pTos,1);` |
|   705138 |  861 | `	}` |
|  1652987 |  862 | `	break;` |
|        - |  863 | `/*` |
|        - |  864 | ` * JNZ: P1 P2 *` |
...
|   188795 |  876 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      ! 0 |  877 | `		PH7_MemObjToBool(pTos);` |
|      ! 0 |  878 | `	}` |
|   188795 |  879 | `	if( pTos->x.iVal ){` |
|        - |  880 | `		/* Take the jump */` |
|     9581 |  881 | `		pc = pInstr->iP2 - 1;` |
|     4788 |  882 | `	}` |
|   188795 |  883 | `	if( !pInstr->iP1 ){` |
...
|        - |  899 | ` */` |
|   690024 |  900 | `case PH7_OP_POP: {` |
|  1381103 |  901 | `	sxi32 n = pInstr->iP1;` |
|  1381103 |  902 | `	if( &pTos[-n+1] < pStack ){` |
|        - |  903 | `		/* TICKET 1433-51 Stack underflow must be handled at run-time */` |
|       79 |  904 | `		n = (sxi32)(pTos - pStack);` |
|       38 |  905 | `	}` |
|  1381103 |  906 | `	VmPopOperand(&pTos,n);` |
|  1381103 |  907 | `	break;` |
|        - |  908 | `				 }` |
|        - |  909 | `/*` |
|        - |  910 | ` * DUP: * * *` |
...
|        - |  919 | `#endif` |
|      126 |  920 | `	pTos++;` |
|      126 |  921 | `	PH7_MemObjInit(pVm,pTos);` |
|      126 |  922 | `	PH7_MemObjStore(pTos - 1,pTos);` |
|      126 |  923 | `	break;` |
|        - |  924 | `/*` |
|        - |  925 | ` * NSSWITCH: * * P3` |
|        - |  926 | ` *` |
...
|        - |  929 | ` */` |
|    48816 |  930 | `case PH7_OP_NSSWITCH:` |
|    97637 |  931 | `	SyBlobReset(&pVm->sNamespace);` |
|    97637 |  932 | `	if( pInstr->p3 ){` |
|     3989 |  933 | `		const char *zNs = (const char *)pInstr->p3;` |
|     3989 |  934 | `		SyBlobAppend(&pVm->sNamespace,zNs,SyStrlen(zNs));` |
|     1992 |  935 | `	}` |
|        - |  936 | `	/* Clear namespace-scoped use-const imports */` |
|    97637 |  937 | `	SyHashRelease(&pVm->hUseConstImports);` |
|    97637 |  938 | `	SyHashInit(&pVm->hUseConstImports,&pVm->sAllocator,0,0);` |
|    97637 |  939 | `	break;` |
...
|     6757 | 1089 | `	break;` |
|        - | 1090 | `					  }` |
|    33253 | 1091 | `case PH7_OP_ERR_CTRL:` |
|        - | 1092 | `	/*` |
...
|        - | 1101 | `	 */` |
|    66511 | 1102 | `	if( pInstr->iP1 ){` |
|    33259 | 1103 | `		pVm->nErrSuppress++;` |
|    49884 | 1104 | `	}else if( pVm->nErrSuppress > 0 ){` |
|    33257 | 1105 | `		pVm->nErrSuppress--;` |
|    16626 | 1106 | `	}` |
|    66511 | 1107 | `	break;` |
|        - | 1108 | `/*` |
|        - | 1109 | ` * IS_A * * *` |
...
|        - | 1163 | ` */` |
|  1566001 | 1164 | `case PH7_OP_LOADC: {` |
|        - | 1165 | `	ph7_value *pObj;` |
|        - | 1166 | `	/* Reserve a room */` |
|  3133915 | 1167 | `	pTos++;` |
|  3133915 | 1168 | `	if( pInstr->iP1 & PH7_LOADC_NOKEY ){` |
...
|    19519 | 1174 | `		break;` |
|        - | 1175 | `	}` |
|  3114401 | 1176 | `	if( (pObj = (ph7_value *)SySetAt(&pVm->aLitObj,pInstr->iP2)) != 0 ){` |
|  3114401 | 1177 | `		if( (pInstr->iP1 & PH7_LOADC_EXPAND) && SyBlobLength(&pObj->sBlob) <= 64 ){` |
|        - | 1178 | `			SyHashEntry *pEntry;` |
|        - | 1179 | `			/* Check use const imports first — imports take precedence */` |
|        - | 1180 | `			{` |
|        - | 1181 | `				SyHashEntry *pConstImport;` |
|    34943 | 1182 | `				pConstImport = SyHashGet(&pVm->hUseConstImports,` |
|    23292 | 1183 | `					SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|    23297 | 1184 | `				if( pConstImport ){` |
...
|    23287 | 1199 | `			pEntry = SyHashGet(&pVm->hConstant,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|    23287 | 1200 | `			if( pEntry ){` |
|    23277 | 1201 | `				ph7_constant *pCons = (ph7_constant *)pEntry->pUserData;` |
|        - | 1202 | `				/* Set a NULL default value */` |
|    23277 | 1203 | `				MemObjSetType(pTos,MEMOBJ_NULL);` |
|    23277 | 1204 | `				SyBlobReset(&pTos->sBlob);` |
|        - | 1205 | `				/* Invoke the callback and deal with the expanded value */` |
|    23277 | 1206 | `				VmExpandConstantWithNotice(&(*pVm),pCons,pTos);` |
|        - | 1207 | `				/* Mark as constant */` |
|    23277 | 1208 | `				pTos->nIdx = SXU32_HIGH;` |
|    23277 | 1209 | `				break;` |
|        - | 1210 | `			}` |
...
|        - | 1283 | ` */` |
|  2249243 | 1284 | `case PH7_OP_LOAD:{` |
|        - | 1285 | `	ph7_value *pObj;` |
|        - | 1286 | `	SyString sName;` |
|  4502499 | 1287 | `	if( pInstr->p3 == 0 ){` |
...
|        9 | 1299 | `	}else{` |
|  4502483 | 1300 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1301 | `		/* Reserve a room for the target object */` |
|  4502483 | 1302 | `		pTos++;` |
|        - | 1303 | `	}` |
|  4502499 | 1304 | `	if( pInstr->iP2 == 2 ){` |
...
|   405135 | 1310 | `		if( VmExtractMemObj(&(*pVm),&sName,FALSE,FALSE) == 0 ){` |
|        7 | 1311 | `			VmErrorFormat(&(*pVm),PH7_CTX_WARNING,"Undefined variable $%z",&sName);` |
|        3 | 1312 | `		}` |
|   202670 | 1313 | `	}` |
|        - | 1314 | `	/* Extract the requested memory object */` |
|  4502499 | 1315 | `	pObj = VmExtractMemObj(&(*pVm),&sName,pInstr->p3 ? FALSE : TRUE,pInstr->iP1 != 1);` |
|  4502499 | 1316 | `	if( pObj == 0 ){` |
...
|  4502437 | 1341 | `	PH7_MemObjLoad(pObj,pTos);` |
|  4502437 | 1342 | `	pTos->nIdx = pObj->nIdx;` |
|  4502437 | 1343 | `	break;` |
|        - | 1344 | `				   }` |
|        - | 1345 | `/*` |
|        - | 1346 | ` * LOAD_MAP P1 * *` |
...
|        - | 1351 | ` */` |
|    36964 | 1352 | `case PH7_OP_LOAD_MAP: {` |
|        - | 1353 | `	VmOpRc rcOp;` |
|    73933 | 1354 | `	sState.pTos = pTos;` |
|    73933 | 1355 | `	sState.pc = pc;` |
|    73933 | 1356 | `	rcOp = VmExecOpLoadMap(&(*pVm),&sState,pInstr);` |
|    73933 | 1357 | `	pTos = sState.pTos;` |
|    73933 | 1358 | `	pc = sState.pc;` |
|    73933 | 1359 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1360 | `		goto Abort;` |
|    73933 | 1361 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1394 | ` * instead.` |
|        - | 1395 | ` */` |
|   339313 | 1396 | `case PH7_OP_LOAD_IDX: {` |
|        - | 1397 | `	VmOpRc rcOp;` |
|   679375 | 1398 | `	sState.pTos = pTos;` |
|   679375 | 1399 | `	sState.pc = pc;` |
|   679375 | 1400 | `	rcOp = VmExecOpLoadIdx(&(*pVm),&sState,pInstr);` |
|   679375 | 1401 | `	pTos = sState.pTos;` |
|   679375 | 1402 | `	pc = sState.pc;` |
|   679375 | 1403 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1404 | `		goto Abort;` |
|   679375 | 1405 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1582 | `		}` |
|    11799 | 1583 | `		break;` |
|   626083 | 1584 | `	}else if( pInstr->p3 == 0 ){` |
...
|        - | 1596 | `#endif` |
|        5 | 1597 | `	}else{` |
|   626075 | 1598 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1599 | `	}` |
|   626078 | 1600 | `	if( sName.nByte == sizeof("GLOBALS")-1` |
|   314795 | 1601 | `	 && SyMemcmp((const void *)sName.zString,(const void *)"GLOBALS",sName.nByte) == 0 ){` |
|        6 | 1602 | `		if( pInstr->p3 ){` |
...
|        - | 1639 | ` */` |
|   121389 | 1640 | `case PH7_OP_STORE_IDX:` |
|        - | 1641 | `case PH7_OP_STORE_IDX_REF: {` |
|        - | 1642 | `	VmOpRc rcOp;` |
|   242783 | 1643 | `	sState.pTos = pTos;` |
|   242783 | 1644 | `	sState.pc = pc;` |
|   242783 | 1645 | `	rcOp = VmExecOpStoreIdxRef(&(*pVm),&sState,pInstr);` |
|   242783 | 1646 | `	pTos = sState.pTos;` |
|   242783 | 1647 | `	pc = sState.pc;` |
|   242783 | 1648 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 1649 | `		goto Abort;` |
|   242781 | 1650 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|   375287 | 1671 | `	PH7_ENFORCE_READONLY_MUTATE(pTos->nIdx);` |
...
|   375276 | 1676 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) != 0` |
|   187749 | 1677 | `	 && SySetUsed(&pVm->aHookRmw) > 0 ){` |
...
|        - | 1694 | `		}` |
|      ! 0 | 1695 | `	}` |
|   375279 | 1696 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) == 0 ){` |
|   375279 | 1697 | `		if( pTos->nIdx != SXU32_HIGH ){` |
|        - | 1698 | `			ph7_value *pObj;` |
|   375279 | 1699 | `			if( (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pTos->nIdx)) != 0 ){` |
|   375279 | 1700 | `				if( VmStringWantsPerlIncr(pObj) ){` |
...
|   375277 | 1719 | `					if( pInstr->iP1 == 0 && (pTos->iFlags & MEMOBJ_STRING) ){` |
|        9 | 1720 | `						SyBlobNullAppend(&pTos->sBlob);` |
|        3 | 1721 | `					}` |
|        - | 1722 | `					/* Force a numeric cast on the variable */` |
|   375277 | 1723 | `					PH7_MemObjToNumeric(pObj);` |
|   375277 | 1724 | `					if( pObj->iFlags & MEMOBJ_REAL ){` |
|        5 | 1725 | `						pObj->rVal++;` |
...
|        - | 1734 | `						sxi64 r;` |
|   375273 | 1735 | `						if( PH7_ADD_OVERFLOW64(pObj->x.iVal,1,&r) ){` |
...
|        - | 1741 | `#endif` |
|        3 | 1742 | `						}else{` |
|   375269 | 1743 | `							pObj->x.iVal = r;` |
|        - | 1744 | `						}` |
|        - | 1745 | `					}` |
|   375277 | 1746 | `					if( pInstr->iP1 ){` |
...
|        - | 1785 | `		}` |
|   187741 | 1786 | `	}` |
|   375277 | 1787 | `	PH7_HOOK_RMW_WRITEBACK(pTos->nIdx,pTos);` |
|   375277 | 1788 | `	break;` |
|        - | 1789 | `/*` |
|        - | 1790 | ` * DECR: P1 * *` |
|        - | 1791 | ` *` |
...
|    70499 | 1938 | `	PH7_MemObjToNumeric(pTos);` |
|    70499 | 1939 | `	if( pTos->iFlags & MEMOBJ_REAL ){` |
|      112 | 1940 | `		pTos->rVal = -pTos->rVal;` |
|       55 | 1941 | `	}` |
|    70499 | 1942 | `	if( pTos->iFlags & MEMOBJ_INT ){` |
|    70413 | 1943 | `		if( pTos->x.iVal == SMALLEST_INT64 ){` |
...
|        - | 1958 | `#endif` |
|        3 | 1959 | `		}else{` |
|    70409 | 1960 | `			pTos->x.iVal = -pTos->x.iVal;` |
|        - | 1961 | `		}` |
|    35204 | 1962 | `	}` |
|    70499 | 1963 | `	break;` |
|        - | 1964 | `/*` |
...
|    50571 | 1997 | `	if( (pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      159 | 1998 | `		PH7_MemObjToBool(pTos);` |
|       77 | 1999 | `	}` |
|    50571 | 2000 | `	pTos->x.iVal = !pTos->x.iVal;` |
|    50571 | 2001 | `	break;` |
|        - | 2002 | `/*` |
|        - | 2003 | ` * OP_BITNOT: * * *` |
|        - | 2004 | ` *` |
...
|        - | 2070 | ` */` |
|     6339 | 2071 | `case PH7_OP_ADD:{` |
|    12683 | 2072 | `	ph7_value *pNos = &pTos[-1];` |
|        - | 2073 | `#ifdef UNTRUST` |
|        - | 2074 | `	if( pNos < pStack ){` |
|        - | 2075 | `		goto Abort;` |
|        - | 2076 | `	}` |
...
|        - | 2082 | `		SyBlob sArMsg;` |
|    12683 | 2083 | `		SyBlobInit(&sArMsg,&pVm->sAllocator);` |
|    12683 | 2084 | `		if( VmArithOperandCheck(&(*pVm),pNos,pTos,"+",&sArMsg) != SXRET_OK ){` |
|        - | 2085 | `			sxi32 rcAr;` |
...
|        - | 2096 | `		}` |
|    12675 | 2097 | `		SyBlobRelease(&sArMsg);` |
|        - | 2098 | `	}` |
|        - | 2099 | `	/* Perform the addition */` |
|    12675 | 2100 | `	PH7_MemObjAdd(pNos,pTos,FALSE);` |
|    12675 | 2101 | `	VmPopOperand(&pTos,1);` |
|    12675 | 2102 | `	break;` |
|        - | 2103 | `				}` |
|        - | 2104 | `/*` |
|        - | 2105 | ` * OP_ADD_STORE * * *` |
...
|      970 | 2364 | `	ph7_value *pNos = &pTos[-1];` |
|        - | 2365 | `	sxi64 a,b,r;` |
|        - | 2366 | `#ifdef UNTRUST` |
|        - | 2367 | `	if( pNos < pStack ){` |
|        - | 2368 | `		goto Abort;` |
...
|      970 | 2372 | `	rc = VmRejectFloatOperand(&(*pVm),pNos);` |
|      970 | 2373 | `	PH7_DISPATCH_ENFORCE_RC(rc)` |
|      970 | 2374 | `	rc = VmRejectFloatOperand(&(*pVm),pTos);` |
|      970 | 2375 | `	PH7_DISPATCH_ENFORCE_RC(rc)` |
|      970 | 2376 | `	if( (pTos->iFlags & MEMOBJ_INT) == 0 ){` |
|      ! 0 | 2377 | `		PH7_MemObjToInteger(pTos);` |
|      ! 0 | 2378 | `	}` |
|      970 | 2379 | `	if( (pNos->iFlags & MEMOBJ_INT) == 0 ){` |
|      ! 0 | 2380 | `		PH7_MemObjToInteger(pNos);` |
|      ! 0 | 2381 | `	}` |
|        - | 2382 | `	/* Perform the requested operation */` |
|      970 | 2383 | `	a = pNos->x.iVal;` |
|      970 | 2384 | `	b = pTos->x.iVal;` |
|      970 | 2385 | `	switch(pInstr->iOp){` |
...
|      872 | 2392 | `	default:          r = a&b; break;` |
|        - | 2393 | `	}` |
|        - | 2394 | `	/* Push the result */` |
|      970 | 2395 | `	pNos->x.iVal = r;` |
|      970 | 2396 | `	MemObjSetType(pNos,MEMOBJ_INT);` |
|      970 | 2397 | `	VmPopOperand(&pTos,1);` |
|      970 | 2398 | `	break;` |
|        - | 2399 | `				 }` |
|        - | 2400 | `/* OP_BAND_STORE * * *` |
|        - | 2401 | ` *` |
...
|        - | 2526 | ` * back.` |
|        - | 2527 | ` */` |
|    86546 | 2528 | `case PH7_OP_CAT:{` |
|        - | 2529 | `	ph7_value *pNos,*pCur;` |
|   173097 | 2530 | `	if( pInstr->iP1 < 1 ){` |
|   144425 | 2531 | `		pNos = &pTos[-1];` |
|    72215 | 2532 | `	}else{` |
...
|   173097 | 2541 | `	if( (pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|     1909 | 2542 | `		PH7_MemObjToString(pNos);` |
|      952 | 2543 | `	}` |
|   173097 | 2544 | `	pCur = &pNos[1];` |
|   349777 | 2545 | `	while( pCur <= pTos ){` |
|   176685 | 2546 | `		if( (pCur->iFlags & MEMOBJ_STRING) == 0 ){` |
|    52445 | 2547 | `			PH7_MemObjToString(pCur);` |
|    26220 | 2548 | `		}` |
|        - | 2549 | `		/* Perform the concatenation */` |
|   176685 | 2550 | `		if( SyBlobLength(&pCur->sBlob) > 0 ){` |
|   176533 | 2551 | `			if( PH7_MemObjStringAppend(pNos,(const char *)SyBlobData(&pCur->sBlob),SyBlobLength(&pCur->sBlob)) != SXRET_OK ){` |
|        - | 2552 | `				/* Allocation failure: raise a fatal instead of a truncated concat */` |
|      ! 0 | 2553 | `				PH7_VmMemoryError(&(*pVm));` |
|      ! 0 | 2554 | `				goto Abort;` |
|        - | 2555 | `			}` |
|    88264 | 2556 | `		}` |
|   176685 | 2557 | `		SyBlobRelease(&pCur->sBlob);` |
|   176685 | 2558 | `		pCur++;` |
|        5 | 2559 | `	}` |
|   173097 | 2560 | `	pTos = pNos;` |
|   173097 | 2561 | `	break;` |
|        - | 2562 | `				}` |
|        - | 2563 | `/*  CAT_STORE: * * *` |
|        - | 2564 | ` *` |
...
|        - | 2566 | ` * back.` |
|        - | 2567 | ` */` |
|    13775 | 2568 | `case PH7_OP_CAT_STORE:{` |
|    27555 | 2569 | `	ph7_value *pNos = &pTos[-1];` |
|        - | 2570 | `	ph7_value *pObj;` |
|        - | 2571 | `	sxu32 nIdx;` |
|        - | 2572 | `#ifdef UNTRUST` |
|        - | 2573 | `	if( pNos < pStack ){` |
...
|    27555 | 2578 | `	if((pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|       59 | 2579 | `		PH7_MemObjToString(pNos);` |
|       29 | 2580 | `	}` |
|    27555 | 2581 | `	nIdx = pTos->nIdx;` |
...
|    27550 | 2593 | `	if( nIdx != SXU32_HIGH` |
|    27550 | 2594 | `	 && nIdx != pNos->nIdx` |
|    27546 | 2595 | `	 && (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx)) != 0` |
|    27547 | 2596 | `	 && (SyHashTotalEntry(&pVm->hTypedSlot) == 0` |
|    16371 | 2597 | `	     \|\| SyHashGet(&pVm->hTypedSlot,(const void *)&nIdx,sizeof(sxu32)) == 0) ){` |
|    27541 | 2598 | `		if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - | 2599 | `			/* e.g. $x = 5; $x .= "a";  ->  "5a" */` |
|        6 | 2600 | `			PH7_MemObjToString(pObj);` |
|        2 | 2601 | `		}` |
|    27541 | 2602 | `		if( SyBlobLength(&pNos->sBlob) > 0 ){` |
|    27537 | 2603 | `			if( PH7_MemObjStringAppend(pObj,(const char *)SyBlobData(&pNos->sBlob),SyBlobLength(&pNos->sBlob)) != SXRET_OK ){` |
...
|    27541 | 2622 | `		if( (pInstr+1)->iOp != PH7_OP_POP ){` |
...
|    27541 | 2627 | `		PH7_HOOK_RMW_WRITEBACK(nIdx,0);` |
|    27541 | 2628 | `		pNos->nIdx = SXU32_HIGH;` |
|    27541 | 2629 | `		VmPopOperand(&pTos,1);` |
|    27548 | 2630 | `		break;` |
|        - | 2631 | `	}` |
...
|        - | 2668 | ` * stack.` |
|        - | 2669 | ` */` |
|   116330 | 2670 | `case PH7_OP_LAND:` |
|        - | 2671 | `case PH7_OP_LOR: {` |
|        - | 2672 | `	VmOpRc rcOp;` |
|   232875 | 2673 | `	sState.pTos = pTos;` |
|   232875 | 2674 | `	sState.pc = pc;` |
|   232875 | 2675 | `	rcOp = VmExecOpLor(&(*pVm),&sState,pInstr);` |
|   232875 | 2676 | `	pTos = sState.pTos;` |
|   232875 | 2677 | `	pc = sState.pc;` |
|   232875 | 2678 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2679 | `		goto Abort;` |
|   232875 | 2680 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2895 | ` */` |
|     5453 | 2896 | `case PH7_OP_EQ:` |
|        - | 2897 | `case PH7_OP_NEQ: {` |
|        - | 2898 | `	VmOpRc rcOp;` |
|    10911 | 2899 | `	sState.pTos = pTos;` |
|    10911 | 2900 | `	sState.pc = pc;` |
|    10911 | 2901 | `	rcOp = VmExecOpNeq(&(*pVm),&sState,pInstr);` |
|    10911 | 2902 | `	pTos = sState.pTos;` |
|    10911 | 2903 | `	pc = sState.pc;` |
|    10911 | 2904 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2905 | `		goto Abort;` |
|    10911 | 2906 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2917 | ` */` |
|   231419 | 2918 | `case PH7_OP_TEQ: {` |
|        - | 2919 | `	VmOpRc rcOp;` |
|   463053 | 2920 | `	sState.pTos = pTos;` |
|   463053 | 2921 | `	sState.pc = pc;` |
|   463053 | 2922 | `	rcOp = VmExecOpTeq(&(*pVm),&sState,pInstr);` |
|   463053 | 2923 | `	pTos = sState.pTos;` |
|   463053 | 2924 | `	pc = sState.pc;` |
|   463053 | 2925 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2926 | `		goto Abort;` |
|   463053 | 2927 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2939 | ` *` |
|        - | 2940 | ` */` |
|   193120 | 2941 | `case PH7_OP_TNE: {` |
|        - | 2942 | `	VmOpRc rcOp;` |
|   386455 | 2943 | `	sState.pTos = pTos;` |
|   386455 | 2944 | `	sState.pc = pc;` |
|   386455 | 2945 | `	rcOp = VmExecOpTne(&(*pVm),&sState,pInstr);` |
|   386455 | 2946 | `	pTos = sState.pTos;` |
|   386455 | 2947 | `	pc = sState.pc;` |
|   386455 | 2948 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2949 | `		goto Abort;` |
|   386455 | 2950 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3004 | ` *` |
|        - | 3005 | ` */` |
|    88239 | 3006 | `case PH7_OP_GT:` |
|        - | 3007 | `case PH7_OP_GE: {` |
|        - | 3008 | `	VmOpRc rcOp;` |
|   176693 | 3009 | `	sState.pTos = pTos;` |
|   176693 | 3010 | `	sState.pc = pc;` |
|   176693 | 3011 | `	rcOp = VmExecOpGe(&(*pVm),&sState,pInstr);` |
|   176693 | 3012 | `	pTos = sState.pTos;` |
|   176693 | 3013 | `	pc = sState.pc;` |
|   176693 | 3014 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 3015 | `		goto Abort;` |
|   176693 | 3016 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3408 | ` */` |
|   121623 | 3409 | `case PH7_OP_FOREACH_STEP: {` |
|        - | 3410 | `	VmOpRc rcOp;` |
|   243251 | 3411 | `	sState.pTos = pTos;` |
|   243251 | 3412 | `	sState.pc = pc;` |
|   243251 | 3413 | `	rcOp = VmExecOpForeachStep(&(*pVm),&sState,pInstr);` |
|   243251 | 3414 | `	pTos = sState.pTos;` |
|   243251 | 3415 | `	pc = sState.pc;` |
|   243251 | 3416 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 3417 | `		goto Abort;` |
|   243249 | 3418 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3444 | ` */` |
|     2402 | 3445 | `case PH7_OP_NEW: {` |
|        - | 3446 | `	VmOpRc rcOp;` |
|     4809 | 3447 | `	sState.pTos = pTos;` |
|     4809 | 3448 | `	sState.pc = pc;` |
|     4809 | 3449 | `	rcOp = VmExecOpNew(&(*pVm),&sState,pInstr);` |
|     4809 | 3450 | `	pTos = sState.pTos;` |
|     4809 | 3451 | `	pc = sState.pc;` |
|     4809 | 3452 | `	if( rcOp == VM_OP_ABORT ){` |
|        5 | 3453 | `		goto Abort;` |
|     4805 | 3454 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|  1047915 | 3831 | `	sxi32 nCallArgs = pInstr->iP1 + (pInstr->iP2 ? VmSpreadOwnExtra(pVm,pInstr->iP1,pTos) : 0);` |
|        - | 3832 | `	ph7_value *pArg;` |
|  1047915 | 3833 | `	pArg = &pTos[-nCallArgs];` |
...
|  1047915 | 3842 | `	VmCallArgMap *pEffCallMap = (VmCallArgMap *)pInstr->p3;` |
...
|  1047915 | 3849 | `	if( VmValueIsClosure(pVm,pTos) ){` |
...
|  1047915 | 3859 | `	if( (pTos->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|      142 | 4054 | `		break;` |
|        - | 4055 | `	}` |
|  1047755 | 4056 | `	SyStringInitFromBuf(&sName,SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
...
|  1047755 | 4060 | `	if( sName.nByte > 0 && sName.zString[0] == '\\' ){` |
...
|  1047755 | 4067 | `	pEntry = SyHashGet(&pVm->hFunction,(const void *)sName.zString,sName.nByte);` |
...
|        - | 4073 | `	{` |
|  1047755 | 4074 | `	VmCallArgMap *pCallMap = pEffCallMap;` |
|  1047755 | 4075 | `	if( pEntry == 0 && pCallMap && pCallMap->bIsNamespaced ){` |
...
|        - | 4106 | `		VmSlot sArg;` |
|        - | 4107 | `		sxu32 n;` |
|   106699 | 4108 | `		int bClosureThis = 0;` |
|   106699 | 4109 | `		ph7_class *pClosureScope = 0;` |
|        - | 4110 | `		/* initialize fields */` |
|   106699 | 4111 | `		pVmFunc = (ph7_vm_func *)pEntry->pUserData;` |
|   106699 | 4112 | `		pThis = 0;` |
|   106699 | 4113 | `		pSelf = 0;` |
...
|       14 | 4128 | `		}` |
|   106699 | 4129 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
...
|   160151 | 4236 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   106694 | 4237 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
...
|   106699 | 4244 | `		if( VmRecursionExceeded(pVm) ){` |
...
|        3 | 4248 | `			goto Abort;` |
|        - | 4249 | `		}` |
|   106697 | 4250 | `		if( pVmFunc->pNextName ){` |
...
|   106697 | 4262 | `		pSelfHint = pSelf;` |
|   106697 | 4263 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
...
|    12336 | 4267 | `			}` |
|    12849 | 4268 | `		}` |
|   106697 | 4269 | `		if( pSelf == 0 && (pVmFunc->iFlags & VM_FUNC_CLOSURE) ){` |
...
|       30 | 4280 | `			}` |
|      905 | 4281 | `		}` |
|   106697 | 4282 | `		if( SySetUsed(&pVmFunc->aAttrs) > 0 ){` |
...
|       56 | 4287 | `		}` |
|   106697 | 4288 | `		if( pVmFunc->iFlags & VM_FUNC_GENERATOR ){` |
...
|   106357 | 4520 | `		aFormalArg = (ph7_vm_func_arg *)SySetBasePtr(&pVmFunc->aArgs);` |
|        - | 4521 | `		/* Create a new VM frame  */` |
|   106357 | 4522 | `		rc = VmEnterFrame(&(*pVm),pVmFunc,pThis,&pFrame);` |
|   106357 | 4523 | `		if( rc != SXRET_OK ){` |
...
|   106357 | 4551 | `		pFrame->nActualArgs = (int)(pTos - pArg);` |
|   106357 | 4552 | `		if( pThis && ((pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) \|\| bClosureThis) ){` |
...
|    12422 | 4560 | `			}` |
|    12422 | 4561 | `		}` |
|   106357 | 4562 | `		if( SySetUsed(&pVmFunc->aStatic) > 0 ){` |
...
|        - | 4589 | `		{` |
|   106357 | 4590 | `		VmCallArgMap *pCallMap3 = pEffCallMap;` |
|        - | 4591 | `		/* Caller file's strict_types mode — governs parameter coercion` |
|        - | 4592 | `		 * (but NOT return coercion, which uses the callee's file). */` |
|   106357 | 4593 | `		int bCallIsStrict = (pCallMap3 && pCallMap3->bStrict) ? 1 : 0;` |
|   106357 | 4594 | `		if( pCallMap3 && pCallMap3->bHasNamed ){` |
|        - | 4595 | `			/* ============================================================` |
...
|        - | 4980 | `		 * ============================================================ */` |
|   106089 | 4981 | `		n = 0;` |
|   273259 | 4982 | `		while( pArg < pTos ){` |
|   167475 | 4983 | `			if( n < SySetUsed(&pVmFunc->aArgs) && (aFormalArg[n].iFlags & VM_FUNC_ARG_VARIADIC) ){` |
...
|        - | 5083 | `			}` |
|   167275 | 5084 | `			if( n < SySetUsed(&pVmFunc->aArgs) ){` |
...
|   166753 | 5091 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_UNION ){` |
...
|   166666 | 5124 | `				if( aFormalArg[n].nType > 0` |
|    90578 | 5125 | `					&& !((aFormalArg[n].iFlags & VM_FUNC_ARG_NULLABLE) && (pArg->iFlags & MEMOBJ_NULL)) ){` |
...
|       13 | 5201 | `					}` |
|     6975 | 5202 | `				}` |
|   166655 | 5203 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_BY_REF ){` |
...
|   166415 | 5255 | `					pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|        - | 5256 | `				}` |
|    83539 | 5257 | `			}else{` |
|        - | 5258 | `				char zName[32];` |
...
|        - | 5265 | `			}` |
|   167175 | 5266 | `			if( pObj ){` |
|   166939 | 5267 | `				PH7_MemObjStore(pArg,pObj);` |
|        - | 5268 | `				/* Insert argument index  */` |
|   166939 | 5269 | `				sArg.nIdx = pObj->nIdx;` |
|   166939 | 5270 | `				sArg.pUserData = 0;` |
|   166939 | 5271 | `				SySetPut(&pFrame->sArg,(const void *)&sArg);` |
|    83677 | 5272 | `			}` |
|   167175 | 5273 | `			PH7_MemObjRelease(pArg);` |
|   167175 | 5274 | `			pArg++;` |
|   167175 | 5275 | `			++n;` |
|        5 | 5276 | `		}` |
|        - | 5277 | `		} /* end named vs positional branch */` |
|        - | 5278 | `		/* Set up closure environment */` |
|   106235 | 5279 | `		if( pVmFunc->iFlags & VM_FUNC_CLOSURE ){` |
...
|      163 | 5304 | `					continue;` |
|        - | 5305 | `				}` |
|      247 | 5306 | `				pValue = VmExtractMemObj(pVm,&pEnv->sName,FALSE,TRUE);` |
|      247 | 5307 | `				if( pValue == 0 ){` |
|      ! 0 | 5308 | `					continue;` |
|        - | 5309 | `				}` |
|        - | 5310 | `				/* Invalidate any prior representation */` |
|      247 | 5311 | `				PH7_MemObjRelease(pValue);` |
|        - | 5312 | `				/* Duplicate bound variable value */` |
|      247 | 5313 | `				PH7_MemObjStore(&pEnv->sValue,pValue);` |
|      125 | 5314 | `			}` |
|      896 | 5315 | `		}` |
...
|   106230 | 5327 | `		if( n < SySetUsed(&pVmFunc->aArgs)` |
|    56805 | 5328 | `		 && (pVmFunc->iFlags & (VM_FUNC_INTERNAL\|VM_FUNC_CLASS_METHOD)) != VM_FUNC_INTERNAL ){` |
...
|   118247 | 5351 | `		while( n < SySetUsed(&pVmFunc->aArgs) ){` |
|    12283 | 5352 | `			if( aFormalArg[n].iFlags & VM_FUNC_ARG_VARIADIC ){` |
...
|        - | 5363 | `			}` |
|    12039 | 5364 | `			if( SySetUsed(&aFormalArg[n].aByteCode) > 0 ){` |
|    12037 | 5365 | `				pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|    12037 | 5366 | `				if( pObj ){` |
|        - | 5367 | `					/* Evaluate the default value and extract it's result */` |
|    12037 | 5368 | `					rc = VmLocalExec(&(*pVm),&aFormalArg[n].aByteCode,pObj,FALSE);` |
|    12037 | 5369 | `					if( rc == PH7_ABORT ){` |
|      ! 0 | 5370 | `						goto Abort;` |
|        - | 5371 | `					}` |
|        - | 5372 | `					/* Insert argument index */` |
|    12037 | 5373 | `					sArg.nIdx = pObj->nIdx;` |
|    12037 | 5374 | `					sArg.pUserData = 0;` |
|    12037 | 5375 | `					SySetPut(&pFrame->sArg,(const void *)&sArg);` |
...
|    12032 | 5380 | `					if( aFormalArg[n].nType > 0 && aFormalArg[n].nType != MEMOBJ_OBJ` |
|     3968 | 5381 | `						&& ((pObj->iFlags & aFormalArg[n].nType) == 0)` |
|     1990 | 5382 | `						&& !((aFormalArg[n].iFlags & VM_FUNC_ARG_NULLABLE) && (pObj->iFlags & MEMOBJ_NULL)) ){` |
...
|        - | 5394 | `		 */` |
|   106213 | 5395 | `		PH7_MemObjRelease(pTos);` |
|   106213 | 5396 | `		pTos = &pTos[-nCallArgs];` |
...
|        - | 5408 | `		 * per function. */` |
|        - | 5409 | `		{` |
|   106213 | 5410 | `			sxu32 nSlots = pVmFunc->nMaxStack;` |
|   106213 | 5411 | `			if( nSlots == 0 ){` |
...
|     4149 | 5418 | `			}` |
|   106213 | 5419 | `			pFrameStack = VmOperandStackAlloc(&(*pVm),nSlots);` |
|        - | 5420 | `		}` |
|   106213 | 5421 | `		if( pFrameStack == 0 ){` |
...
|      ! 0 | 5428 | `			break;` |
|        - | 5429 | `		}` |
|    52999 | 5430 | `SkipFuncBody:` |
|   106347 | 5431 | `		if( pSelf ){` |
|        - | 5432 | `			/* Push class name */` |
|    25759 | 5433 | `			SySetPut(&pVm->aSelf,(const void *)&pSelf);` |
|    12877 | 5434 | `		}` |
|        - | 5435 | `		/* Increment nesting level */` |
|   106347 | 5436 | `		pVm->nRecursionDepth++;` |
|   106347 | 5437 | `		if( rc == PH7_EXCEPTION ){` |
...
|   106213 | 5466 | `			VmCallFrame *pRec = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   106213 | 5467 | `			if( pRec ){` |
|   103565 | 5468 | `				pVm->pIdleCallFrames = (void *)pRec->pPrev;` |
|    51890 | 5469 | `			}else{` |
|     2653 | 5470 | `				pRec = (VmCallFrame *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmCallFrame));` |
|        - | 5471 | `			}` |
|   106213 | 5472 | `			if( pRec == 0 ){` |
...
|      ! 0 | 5483 | `				goto Abort;` |
|        - | 5484 | `			}` |
|   106213 | 5485 | `			sState.pTos = pTos;` |
|   106213 | 5486 | `			sState.pc = pc;` |
|   106213 | 5487 | `			pRec->sCaller = sState;` |
|   106213 | 5488 | `			pRec->sCall.pVmFunc = pVmFunc;` |
|   106213 | 5489 | `			pRec->sCall.pFrame = pFrame;` |
|   106213 | 5490 | `			pRec->sCall.pFrameStack = pFrameStack;` |
|   106213 | 5491 | `			pRec->sCall.nStackCap = pVmFunc->nMaxStack + VM_STACK_GUARD;` |
|   106213 | 5492 | `			pRec->sCall.nLastRef = SXU32_HIGH;` |
|   106213 | 5493 | `			pRec->sCall.bSelfPushed = (sxu8)(pSelf ? 1 : 0);` |
|   106213 | 5494 | `			pRec->pPrev = pCallTop;` |
|   106213 | 5495 | `			pCallTop = pRec;` |
|        - | 5496 | `			/* Switch to the callee activation (what the recursive` |
|        - | 5497 | `			 * VmByteCodeExec entry used to set up). */` |
|   106213 | 5498 | `			aInstr = (VmInstr *)SySetBasePtr(&pVmFunc->aByteCode);` |
|   106213 | 5499 | `			pStack = pFrameStack;` |
|   106213 | 5500 | `			pTos = &pStack[-1];` |
|   106213 | 5501 | `			pc = 0;` |
|   106213 | 5502 | `			sState.aInstr = aInstr;` |
|   106213 | 5503 | `			sState.pStack = pStack;` |
|   106213 | 5504 | `			sState.nStackCap = pRec->sCall.nStackCap; /* callee's operand-stack capacity for OP_SPREAD growth */` |
|   106213 | 5505 | `			sState.nStackOrig = pRec->sCall.nStackCap; /* fixed headroom reference (never grows) */` |
|   106213 | 5506 | `			sState.pTos = pTos;` |
|   106213 | 5507 | `			sState.pc = 0;` |
|   106213 | 5508 | `			sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|   106213 | 5509 | `			sState.pEntryFrame = pVm->pFrame;` |
|   106213 | 5510 | `			sState.pResult = pRec->sCaller.pTos;` |
|   106213 | 5511 | `			sState.pLastRef = &pRec->sCall.nLastRef;` |
|   106213 | 5512 | `			sState.pEnforceRetFunc = VmFuncHasReturnType(pVmFunc) ? pVmFunc : 0;` |
|   106213 | 5513 | `			sState.is_callback = 0;` |
|   106213 | 5514 | `			sState.bReturnPropagates = 0;` |
|   106213 | 5515 | `			goto VmLoopFetch;` |
|        - | 5516 | `		}` |
|       57 | 5517 | `	}else{` |
...
|   941061 | 5526 | `		pEntry = SyHashGet(&pVm->hHostFunction,(const void *)sName.zString,sName.nByte);` |
|        - | 5527 | `		{` |
|   941061 | 5528 | `		VmCallArgMap *pCallMap2 = pEffCallMap;` |
|   941061 | 5529 | `		if( pEntry == 0 && pCallMap2 && pCallMap2->bIsNamespaced ){` |
...
|        - | 5634 | `			}` |
|        - | 5635 | `		}` |
|   941045 | 5636 | `		pFunc = (ph7_user_func *)pEntry->pUserData;` |
...
|  1411937 | 5641 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   941040 | 5642 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
|        - | 5643 | `		/* Start collecting function arguments */` |
|   941045 | 5644 | `		SySetReset(&aArg);` |
|  2543665 | 5645 | `		while( pArg < pTos ){` |
|  1602625 | 5646 | `			SySetPut(&aArg,(const void *)&pArg);` |
|  1602625 | 5647 | `			pArg++;` |
|        5 | 5648 | `		}` |
|        - | 5649 | `		/* Assume a null return value */` |
|   941045 | 5650 | `		PH7_MemObjInit(&(*pVm),&sRet);` |
|        - | 5651 | `		/* Init the call context */` |
|   941045 | 5652 | `		VmInitCallContext(&sCtx,&(*pVm),pFunc,&sRet,0);` |
...
|   941045 | 5659 | `		sCtx.pArgMap = pEffCallMap;` |
|        - | 5660 | `		{` |
|   941045 | 5661 | `		int nGiven = (int)SySetUsed(&aArg);` |
...
|   941045 | 5667 | `		if( pFunc->nMinArg > 0 && nGiven < pFunc->nMinArg ){` |
...
|      232 | 5674 | `				nGiven);` |
|   940813 | 5675 | `		}else if( pFunc->bHasMaxArg && nGiven > (int)pFunc->nMaxArg ){` |
...
|       40 | 5688 | `				nGiven);` |
|  1411161 | 5689 | `		}else if( SXRET_OK != (rc = VmEnforceBuiltinArgTypes(&sCtx,pFunc,nGiven,` |
|   940496 | 5690 | `			(ph7_value **)SySetBasePtr(&aArg))) ){` |
|        - | 5691 | `			/* TypeError thrown: rc carries the caught/uncaught status */` |
|      112 | 5692 | `		}else{` |
|        - | 5693 | `			/* Call the foreign function */` |
|   940287 | 5694 | `			rc = pFunc->xFunc(&sCtx,nGiven,(ph7_value **)SySetBasePtr(&aArg));` |
|        - | 5695 | `		}` |
|        - | 5696 | `		}` |
|        - | 5697 | `		/* Release the call context */` |
|   941045 | 5698 | `		VmReleaseCallContext(&sCtx);` |
|   941045 | 5699 | `		if( rc == PH7_ABORT ){` |
...
|      578 | 5704 | `			goto Abort;` |
|        - | 5705 | `		}` |
|   940471 | 5706 | `		if( rc != PH7_SUSPEND && pVm->pInlineInstr == (void *)aInstr ){` |
...
|      ! 0 | 5719 | `		}` |
|   940467 | 5720 | `		if( rc == PH7_EXCEPTION ){` |
...
|      851 | 5740 | `			break;` |
|        - | 5741 | `		}` |
|   939423 | 5742 | `		if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|   918259 | 5766 | `			VmPopOperand(&pTos,nCallArgs);` |
|   459499 | 5767 | `		}` |
|        - | 5768 | `		/* Save foreign function return value into the (now top) function-name slot */` |
|   939069 | 5769 | `		PH7_MemObjStore(&sRet,pTos);` |
|   939069 | 5770 | `		PH7_MemObjRelease(&sRet);` |
|        - | 5771 | `	}` |
|   939173 | 5772 | `	break;` |
|        - | 5773 | `				  }` |
|        - | 5774 | `/*` |
...
|        - | 5777 | ` */` |
|    26184 | 5778 | `case PH7_OP_CONSUME: {` |
|        - | 5779 | `	VmOpRc rcOp;` |
|    52373 | 5780 | `	sState.pTos = pTos;` |
|    52373 | 5781 | `	sState.pc = pc;` |
|    52373 | 5782 | `	rcOp = VmExecOpConsume(&(*pVm),&sState,pInstr);` |
|    52373 | 5783 | `	pTos = sState.pTos;` |
|    52373 | 5784 | `	pc = sState.pc;` |
|    52373 | 5785 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 5786 | `		goto Abort;` |
|    52373 | 5787 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 5792 |  |
|        - | 5793 | `		} /* Switch() */` |
| 16868629 | 5794 | `		pc++; /* Next instruction in the stream */` |
|        5 | 5795 | `	} /* For(;;) */` |
|   131456 | 5796 | `Done:` |
...
|   263127 | 5800 | `	rc = SXRET_OK;` |
|   263127 | 5801 | `	goto Unwind;` |
|      823 | 5802 | `Suspend:` |
...
|   133474 | 5860 | `	for(;;){` |
|   266743 | 5861 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|      ! 0 | 5869 | `			}` |
|     1162 | 5870 | `		}` |
|   266743 | 5871 | `		if( pCallTop == 0 ){` |
|   160945 | 5872 | `			return VmExecFinalize(&(*pVm),&sState,&aArg,pTos,rc);` |
|        - | 5873 | `		}` |
|   105803 | 5874 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|      636 | 5880 | `		}` |
|        - | 5881 | `		{` |
|   105803 | 5882 | `			VmCallFrame *pRec = pCallTop;` |
|   105803 | 5883 | `			sState = pRec->sCaller;` |
|   105803 | 5884 | `			rc = VmCallFinish(&(*pVm),&sState,&pRec->sCall,rc);` |
|   105803 | 5885 | `			pCallTop = pRec->pPrev;` |
|   105803 | 5886 | `			pRec->pPrev = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   105803 | 5887 | `			pVm->pIdleCallFrames = (void *)pRec;` |
|   105803 | 5888 | `			aInstr = sState.aInstr;` |
|   105803 | 5889 | `			pStack = sState.pStack;` |
|   105803 | 5890 | `			pTos = sState.pTos;` |
|   105803 | 5891 | `			pc = sState.pc;` |
|        - | 5892 | `		}` |
|   105803 | 5893 | `		if( rc == PH7_OK ){` |
|   105037 | 5894 | `			pc++; /* the loop-bottom increment this OP_CALL missed */` |
|   105037 | 5895 | `			goto VmLoopFetch;` |
|        - | 5896 | `		}` |
|        5 | 5897 | `	}` |
|    80652 | 5898 | `}` |
|        - | 5899 |  |
