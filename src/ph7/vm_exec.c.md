...
|        - |  189 | ` */` |
|   104841 |  190 | `static sxi32 VmCallFinish(ph7_vm *pVm,VmExecState *pCaller,VmCallRecord *pCallee,sxi32 rc)` |
|        5 |  191 | `{` |
|        - |  192 | `	ph7_value *pObj;` |
|        - |  193 | `	/* Decrement nesting level */` |
|   104846 |  194 | `	pVm->nRecursionDepth--;` |
|   104846 |  195 | `	if( pCallee->bSelfPushed ){` |
|        - |  196 | `		/* Pop class name */` |
|    25521 |  197 | `		(void)SySetPop(&pVm->aSelf);` |
|    12758 |  198 | `	}` |
|   104846 |  199 | `	if( (pCallee->pVmFunc->iFlags & VM_FUNC_REF_RETURN) && rc == SXRET_OK ){` |
...
|       25 |  225 | `	}` |
|   104846 |  226 | `	if( rc != PH7_ABORT && ((pCallee->pFrame->iFlags & VM_FRAME_THROW) \|\| rc == PH7_EXCEPTION) ){` |
...
|   104846 |  272 | `	if( rc != PH7_SUSPEND && pCallee->pFrameStack ){` |
...
|   104712 |  276 | `		VmOperandStackRecycle(pVm,pCallee->pFrameStack,pCallee->nStackCap);` |
|    52456 |  277 | `	}` |
|        - |  278 | `	/* Leave the frame */` |
|   104846 |  279 | `	VmLeaveFrame(&(*pVm));` |
|   104846 |  280 | `	if( rc == PH7_ABORT ){` |
|      336 |  281 | `		return PH7_ABORT;` |
|        - |  282 | `	}` |
|   104514 |  283 | `	if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|        - |  291 | `	}` |
|   104514 |  292 | `	if( rc == PH7_EXCEPTION ){` |
|      469 |  293 | `		return PH7_EXCEPTION;` |
|        - |  294 | `	}` |
|   104050 |  295 | `	return PH7_OK;` |
|    52528 |  296 | `}` |
|        - |  297 | `/*` |
...
| 17095953 |  603 | `		if( pVm->nBoundaryRc != 0 \|\| SySetUsed(&pVm->aHookRmw) > 0 ){` |
...
| 17095853 |  658 | `		pInstr = &aInstr[pc];` |
| 17095853 |  659 | `		if( pInstr->nLine ){` |
...
| 16882249 |  663 | `			pVm->nCurLine = pInstr->nLine;` |
|  8447473 |  664 | `		}` |
| 17095853 |  665 | `		rc = SXRET_OK;` |
|        - |  666 | `/*` |
...
|        - |  672 | ` */` |
| 17095853 |  673 | `		switch(pInstr->iOp){` |
|        - |  674 | `/*` |
|        - |  675 | ` * DONE: P1 * *` |
|        - |  676 | ` *` |
...
|   262786 |  681 | `	if( pInstr->iP2 && sState.bReturnPropagates ){` |
...
|   262597 |  711 | `	if( sState.pEnforceRetFunc && VmFuncHasReturnType(sState.pEnforceRetFunc)` |
...
|     4591 |  736 | `	}` |
|   262578 |  737 | `	if( pInstr->iP1 && pTos >= pStack ){` |
|   157562 |  738 | `		if( sState.pLastRef ){` |
|    94340 |  739 | `			*sState.pLastRef = pTos->nIdx;` |
|    47270 |  740 | `		}` |
|   157562 |  741 | `		if( sState.pResult ){` |
|        - |  742 | `			/* Execution result */` |
|   150486 |  743 | `			PH7_MemObjStore(pTos,sState.pResult);` |
|    75343 |  744 | `		}` |
|   157562 |  745 | `		VmPopOperand(&pTos,1);` |
|   183902 |  746 | `	}else if( sState.pLastRef ){` |
...
|        - |  762 | `	 */` |
|   262578 |  763 | `	rc = VmDrainFinally(&(*pVm),sState.nExceptionBase);` |
|   262578 |  764 | `	if( rc == SXERR_ABORT ){` |
|      ! 0 |  765 | `		goto Abort;` |
|        - |  766 | `	}` |
|   262578 |  767 | `	if( rc == PH7_EXCEPTION ){` |
...
|        - |  778 | `	}` |
|   262574 |  779 | `	if( sState.pEntryFrame->bHasRet && !sState.bReturnPropagates ){` |
...
|        - |  835 | ` */` |
|   280152 |  836 | `case PH7_OP_JMP:` |
|   560515 |  837 | `	pc = pInstr->iP2 - 1;` |
|   560515 |  838 | `	break;` |
|        - |  839 | `/*` |
|        - |  840 | ` * JZ: P1 P2 *` |
|        - |  841 | ` *` |
...
|  1637604 |  852 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     1003 |  853 | `		PH7_MemObjToBool(pTos);` |
|      500 |  854 | `	}` |
|  1637604 |  855 | `	if( !pTos->x.iVal ){` |
|        - |  856 | `		/* Take the jump */` |
|   929206 |  857 | `		pc = pInstr->iP2 - 1;` |
|   464861 |  858 | `	}` |
|  1637604 |  859 | `	if( !pInstr->iP1 ){` |
|  1394752 |  860 | `		VmPopOperand(&pTos,1);` |
|   697942 |  861 | `	}` |
|  1637604 |  862 | `	break;` |
|        - |  863 | `/*` |
|        - |  864 | ` * JNZ: P1 P2 *` |
...
|   185614 |  876 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      ! 0 |  877 | `		PH7_MemObjToBool(pTos);` |
|      ! 0 |  878 | `	}` |
|   185614 |  879 | `	if( pTos->x.iVal ){` |
|        - |  880 | `		/* Take the jump */` |
|     9569 |  881 | `		pc = pInstr->iP2 - 1;` |
|     4782 |  882 | `	}` |
|   185614 |  883 | `	if( !pInstr->iP1 ){` |
...
|        - |  899 | ` */` |
|   684796 |  900 | `case PH7_OP_POP: {` |
|  1370623 |  901 | `	sxi32 n = pInstr->iP1;` |
|  1370623 |  902 | `	if( &pTos[-n+1] < pStack ){` |
|        - |  903 | `		/* TICKET 1433-51 Stack underflow must be handled at run-time */` |
|       79 |  904 | `		n = (sxi32)(pTos - pStack);` |
|       38 |  905 | `	}` |
|  1370623 |  906 | `	VmPopOperand(&pTos,n);` |
|  1370623 |  907 | `	break;` |
|        - |  908 | `				 }` |
|        - |  909 | `/*` |
|        - |  910 | ` * DUP: * * *` |
...
|        - | 1163 | ` */` |
|  1558153 | 1164 | `case PH7_OP_LOADC: {` |
|        - | 1165 | `	ph7_value *pObj;` |
|        - | 1166 | `	/* Reserve a room */` |
|  3118176 | 1167 | `	pTos++;` |
|  3118176 | 1168 | `	if( pInstr->iP1 & PH7_LOADC_NOKEY ){` |
...
|    19473 | 1174 | `		break;` |
|        - | 1175 | `	}` |
|  3098708 | 1176 | `	if( (pObj = (ph7_value *)SySetAt(&pVm->aLitObj,pInstr->iP2)) != 0 ){` |
|  3098708 | 1177 | `		if( (pInstr->iP1 & PH7_LOADC_EXPAND) && SyBlobLength(&pObj->sBlob) <= 64 ){` |
...
|        - | 1283 | ` */` |
|  2224224 | 1284 | `case PH7_OP_LOAD:{` |
|        - | 1285 | `	ph7_value *pObj;` |
|        - | 1286 | `	SyString sName;` |
|  4452368 | 1287 | `	if( pInstr->p3 == 0 ){` |
...
|        9 | 1299 | `	}else{` |
|  4452352 | 1300 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1301 | `		/* Reserve a room for the target object */` |
|  4452352 | 1302 | `		pTos++;` |
|        - | 1303 | `	}` |
|  4452368 | 1304 | `	if( pInstr->iP2 == 2 ){` |
...
|   399479 | 1310 | `		if( VmExtractMemObj(&(*pVm),&sName,FALSE,FALSE) == 0 ){` |
|        7 | 1311 | `			VmErrorFormat(&(*pVm),PH7_CTX_WARNING,"Undefined variable $%z",&sName);` |
|        3 | 1312 | `		}` |
|   199840 | 1313 | `	}` |
|        - | 1314 | `	/* Extract the requested memory object */` |
|  4452368 | 1315 | `	pObj = VmExtractMemObj(&(*pVm),&sName,pInstr->p3 ? FALSE : TRUE,pInstr->iP1 != 1);` |
|  4452368 | 1316 | `	if( pObj == 0 ){` |
...
|  4452306 | 1341 | `	PH7_MemObjLoad(pObj,pTos);` |
|  4452306 | 1342 | `	pTos->nIdx = pObj->nIdx;` |
|  4452306 | 1343 | `	break;` |
|        - | 1344 | `				   }` |
|        - | 1345 | `/*` |
|        - | 1346 | ` * LOAD_MAP P1 * *` |
...
|        - | 1397 | `	VmOpRc rcOp;` |
|   669171 | 1398 | `	sState.pTos = pTos;` |
|   669171 | 1399 | `	sState.pc = pc;` |
|   669171 | 1400 | `	rcOp = VmExecOpLoadIdx(&(*pVm),&sState,pInstr);` |
|   669171 | 1401 | `	pTos = sState.pTos;` |
|   669171 | 1402 | `	pc = sState.pc;` |
|   669171 | 1403 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 1404 | `		goto Abort;` |
|   669171 | 1405 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 1582 | `		}` |
|    11771 | 1583 | `		break;` |
|   621999 | 1584 | `	}else if( pInstr->p3 == 0 ){` |
...
|        - | 1596 | `#endif` |
|        5 | 1597 | `	}else{` |
|   621991 | 1598 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - | 1599 | `	}` |
|   621994 | 1600 | `	if( sName.nByte == sizeof("GLOBALS")-1` |
|   312741 | 1601 | `	 && SyMemcmp((const void *)sName.zString,(const void *)"GLOBALS",sName.nByte) == 0 ){` |
|        6 | 1602 | `		if( pInstr->p3 ){` |
...
|        - | 1639 | ` */` |
|   120838 | 1640 | `case PH7_OP_STORE_IDX:` |
|        - | 1641 | `case PH7_OP_STORE_IDX_REF: {` |
|        - | 1642 | `	VmOpRc rcOp;` |
|   241681 | 1643 | `	sState.pTos = pTos;` |
|   241681 | 1644 | `	sState.pc = pc;` |
|   241681 | 1645 | `	rcOp = VmExecOpStoreIdxRef(&(*pVm),&sState,pInstr);` |
|   241681 | 1646 | `	pTos = sState.pTos;` |
|   241681 | 1647 | `	pc = sState.pc;` |
|   241681 | 1648 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 1649 | `		goto Abort;` |
|   241679 | 1650 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|   369598 | 1671 | `	PH7_ENFORCE_READONLY_MUTATE(pTos->nIdx);` |
...
|   369587 | 1676 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) != 0` |
|   184902 | 1677 | `	 && SySetUsed(&pVm->aHookRmw) > 0 ){` |
...
|        - | 1694 | `		}` |
|      ! 0 | 1695 | `	}` |
|   369590 | 1696 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) == 0 ){` |
|   369590 | 1697 | `		if( pTos->nIdx != SXU32_HIGH ){` |
|        - | 1698 | `			ph7_value *pObj;` |
|   369590 | 1699 | `			if( (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pTos->nIdx)) != 0 ){` |
|   369590 | 1700 | `				if( VmStringWantsPerlIncr(pObj) ){` |
...
|   369588 | 1719 | `					if( pInstr->iP1 == 0 && (pTos->iFlags & MEMOBJ_STRING) ){` |
|        9 | 1720 | `						SyBlobNullAppend(&pTos->sBlob);` |
|        3 | 1721 | `					}` |
|        - | 1722 | `					/* Force a numeric cast on the variable */` |
|   369588 | 1723 | `					PH7_MemObjToNumeric(pObj);` |
|   369588 | 1724 | `					if( pObj->iFlags & MEMOBJ_REAL ){` |
|        5 | 1725 | `						pObj->rVal++;` |
...
|        - | 1734 | `						sxi64 r;` |
|   369584 | 1735 | `						if( PH7_ADD_OVERFLOW64(pObj->x.iVal,1,&r) ){` |
...
|        - | 1741 | `#endif` |
|        3 | 1742 | `						}else{` |
|   369580 | 1743 | `							pObj->x.iVal = r;` |
|        - | 1744 | `						}` |
|        - | 1745 | `					}` |
|   369588 | 1746 | `					if( pInstr->iP1 ){` |
...
|        - | 1785 | `		}` |
|   184894 | 1786 | `	}` |
|   369588 | 1787 | `	PH7_HOOK_RMW_WRITEBACK(pTos->nIdx,pTos);` |
|   369588 | 1788 | `	break;` |
|        - | 1789 | `/*` |
|        - | 1790 | ` * DECR: P1 * *` |
|        - | 1791 | ` *` |
...
|    50836 | 1997 | `	if( (pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      155 | 1998 | `		PH7_MemObjToBool(pTos);` |
|       75 | 1999 | `	}` |
|    50836 | 2000 | `	pTos->x.iVal = !pTos->x.iVal;` |
|    50836 | 2001 | `	break;` |
|        - | 2002 | `/*` |
|        - | 2003 | ` * OP_BITNOT: * * *` |
|        - | 2004 | ` *` |
...
|    27588 | 2569 | `	ph7_value *pNos = &pTos[-1];` |
|        - | 2570 | `	ph7_value *pObj;` |
|        - | 2571 | `	sxu32 nIdx;` |
|        - | 2572 | `#ifdef UNTRUST` |
|        - | 2573 | `	if( pNos < pStack ){` |
...
|    27588 | 2578 | `	if((pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|       59 | 2579 | `		PH7_MemObjToString(pNos);` |
|       29 | 2580 | `	}` |
|    27588 | 2581 | `	nIdx = pTos->nIdx;` |
...
|    27583 | 2593 | `	if( nIdx != SXU32_HIGH` |
|    27583 | 2594 | `	 && nIdx != pNos->nIdx` |
|    27579 | 2595 | `	 && (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx)) != 0` |
|    27580 | 2596 | `	 && (SyHashTotalEntry(&pVm->hTypedSlot) == 0` |
|    16388 | 2597 | `	     \|\| SyHashGet(&pVm->hTypedSlot,(const void *)&nIdx,sizeof(sxu32)) == 0) ){` |
|    27574 | 2598 | `		if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - | 2599 | `			/* e.g. $x = 5; $x .= "a";  ->  "5a" */` |
|        6 | 2600 | `			PH7_MemObjToString(pObj);` |
|        2 | 2601 | `		}` |
|    27574 | 2602 | `		if( SyBlobLength(&pNos->sBlob) > 0 ){` |
|    27570 | 2603 | `			if( PH7_MemObjStringAppend(pObj,(const char *)SyBlobData(&pNos->sBlob),SyBlobLength(&pNos->sBlob)) != SXRET_OK ){` |
...
|    27574 | 2622 | `		if( (pInstr+1)->iOp != PH7_OP_POP ){` |
...
|    27574 | 2627 | `		PH7_HOOK_RMW_WRITEBACK(nIdx,0);` |
|    27574 | 2628 | `		pNos->nIdx = SXU32_HIGH;` |
|    27574 | 2629 | `		VmPopOperand(&pTos,1);` |
|    27581 | 2630 | `		break;` |
|        - | 2631 | `	}` |
...
|        - | 2672 | `	VmOpRc rcOp;` |
|   229764 | 2673 | `	sState.pTos = pTos;` |
|   229764 | 2674 | `	sState.pc = pc;` |
|   229764 | 2675 | `	rcOp = VmExecOpLor(&(*pVm),&sState,pInstr);` |
|   229764 | 2676 | `	pTos = sState.pTos;` |
|   229764 | 2677 | `	pc = sState.pc;` |
|   229764 | 2678 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2679 | `		goto Abort;` |
|   229764 | 2680 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2917 | ` */` |
|   229390 | 2918 | `case PH7_OP_TEQ: {` |
|        - | 2919 | `	VmOpRc rcOp;` |
|   458990 | 2920 | `	sState.pTos = pTos;` |
|   458990 | 2921 | `	sState.pc = pc;` |
|   458990 | 2922 | `	rcOp = VmExecOpTeq(&(*pVm),&sState,pInstr);` |
|   458990 | 2923 | `	pTos = sState.pTos;` |
|   458990 | 2924 | `	pc = sState.pc;` |
|   458990 | 2925 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2926 | `		goto Abort;` |
|   458990 | 2927 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2939 | ` *` |
|        - | 2940 | ` */` |
|   191122 | 2941 | `case PH7_OP_TNE: {` |
|        - | 2942 | `	VmOpRc rcOp;` |
|   382454 | 2943 | `	sState.pTos = pTos;` |
|   382454 | 2944 | `	sState.pc = pc;` |
|   382454 | 2945 | `	rcOp = VmExecOpTne(&(*pVm),&sState,pInstr);` |
|   382454 | 2946 | `	pTos = sState.pTos;` |
|   382454 | 2947 | `	pc = sState.pc;` |
|   382454 | 2948 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2949 | `		goto Abort;` |
|   382454 | 2950 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 2974 | `case PH7_OP_LE: {` |
|        - | 2975 | `	VmOpRc rcOp;` |
|   293627 | 2976 | `	sState.pTos = pTos;` |
|   293627 | 2977 | `	sState.pc = pc;` |
|   293627 | 2978 | `	rcOp = VmExecOpLe(&(*pVm),&sState,pInstr);` |
|   293627 | 2979 | `	pTos = sState.pTos;` |
|   293627 | 2980 | `	pc = sState.pc;` |
|   293627 | 2981 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 2982 | `		goto Abort;` |
|   293627 | 2983 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3007 | `case PH7_OP_GE: {` |
|        - | 3008 | `	VmOpRc rcOp;` |
|   173466 | 3009 | `	sState.pTos = pTos;` |
|   173466 | 3010 | `	sState.pc = pc;` |
|   173466 | 3011 | `	rcOp = VmExecOpGe(&(*pVm),&sState,pInstr);` |
|   173466 | 3012 | `	pTos = sState.pTos;` |
|   173466 | 3013 | `	pc = sState.pc;` |
|   173466 | 3014 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 3015 | `		goto Abort;` |
|   173466 | 3016 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 3408 | ` */` |
|   121181 | 3409 | `case PH7_OP_FOREACH_STEP: {` |
|        - | 3410 | `	VmOpRc rcOp;` |
|   242367 | 3411 | `	sState.pTos = pTos;` |
|   242367 | 3412 | `	sState.pc = pc;` |
|   242367 | 3413 | `	rcOp = VmExecOpForeachStep(&(*pVm),&sState,pInstr);` |
|   242367 | 3414 | `	pTos = sState.pTos;` |
|   242367 | 3415 | `	pc = sState.pc;` |
|   242367 | 3416 | `	if( rcOp == VM_OP_ABORT ){` |
|        3 | 3417 | `		goto Abort;` |
|   242365 | 3418 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|  1042740 | 3831 | `	sxi32 nCallArgs = pInstr->iP1 + (pInstr->iP2 ? VmSpreadOwnExtra(pVm,pInstr->iP1,pTos) : 0);` |
|        - | 3832 | `	ph7_value *pArg;` |
|  1042740 | 3833 | `	pArg = &pTos[-nCallArgs];` |
...
|  1042740 | 3842 | `	VmCallArgMap *pEffCallMap = (VmCallArgMap *)pInstr->p3;` |
...
|  1042740 | 3849 | `	if( VmValueIsClosure(pVm,pTos) ){` |
...
|  1042740 | 3859 | `	if( (pTos->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|      142 | 4054 | `		break;` |
|        - | 4055 | `	}` |
|  1042580 | 4056 | `	SyStringInitFromBuf(&sName,SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
...
|  1042580 | 4060 | `	if( sName.nByte > 0 && sName.zString[0] == '\\' ){` |
...
|  1042580 | 4067 | `	pEntry = SyHashGet(&pVm->hFunction,(const void *)sName.zString,sName.nByte);` |
...
|        - | 4073 | `	{` |
|  1042580 | 4074 | `	VmCallArgMap *pCallMap = pEffCallMap;` |
|  1042580 | 4075 | `	if( pEntry == 0 && pCallMap && pCallMap->bIsNamespaced ){` |
...
|        - | 4106 | `		VmSlot sArg;` |
|        - | 4107 | `		sxu32 n;` |
|   105608 | 4108 | `		int bClosureThis = 0;` |
|   105608 | 4109 | `		ph7_class *pClosureScope = 0;` |
|        - | 4110 | `		/* initialize fields */` |
|   105608 | 4111 | `		pVmFunc = (ph7_vm_func *)pEntry->pUserData;` |
|   105608 | 4112 | `		pThis = 0;` |
|   105608 | 4113 | `		pSelf = 0;` |
...
|       14 | 4128 | `		}` |
|   105608 | 4129 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
...
|   158512 | 4236 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   105603 | 4237 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
...
|   105608 | 4244 | `		if( VmRecursionExceeded(pVm) ){` |
...
|        3 | 4248 | `			goto Abort;` |
|        - | 4249 | `		}` |
|   105606 | 4250 | `		if( pVmFunc->pNextName ){` |
...
|   105606 | 4262 | `		pSelfHint = pSelf;` |
|   105606 | 4263 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
...
|    12322 | 4267 | `			}` |
|    12835 | 4268 | `		}` |
|   105606 | 4269 | `		if( pSelf == 0 && (pVmFunc->iFlags & VM_FUNC_CLOSURE) ){` |
...
|       30 | 4280 | `			}` |
|      903 | 4281 | `		}` |
|   105606 | 4282 | `		if( SySetUsed(&pVmFunc->aAttrs) > 0 ){` |
...
|       56 | 4287 | `		}` |
|   105606 | 4288 | `		if( pVmFunc->iFlags & VM_FUNC_GENERATOR ){` |
...
|   105266 | 4520 | `		aFormalArg = (ph7_vm_func_arg *)SySetBasePtr(&pVmFunc->aArgs);` |
|        - | 4521 | `		/* Create a new VM frame  */` |
|   105266 | 4522 | `		rc = VmEnterFrame(&(*pVm),pVmFunc,pThis,&pFrame);` |
|   105266 | 4523 | `		if( rc != SXRET_OK ){` |
...
|   105266 | 4551 | `		pFrame->nActualArgs = (int)(pTos - pArg);` |
|   105266 | 4552 | `		if( pThis && ((pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) \|\| bClosureThis) ){` |
...
|    12408 | 4560 | `			}` |
|    12408 | 4561 | `		}` |
|   105266 | 4562 | `		if( SySetUsed(&pVmFunc->aStatic) > 0 ){` |
...
|        - | 4589 | `		{` |
|   105266 | 4590 | `		VmCallArgMap *pCallMap3 = pEffCallMap;` |
|        - | 4591 | `		/* Caller file's strict_types mode — governs parameter coercion` |
|        - | 4592 | `		 * (but NOT return coercion, which uses the callee's file). */` |
|   105266 | 4593 | `		int bCallIsStrict = (pCallMap3 && pCallMap3->bStrict) ? 1 : 0;` |
|   105266 | 4594 | `		if( pCallMap3 && pCallMap3->bHasNamed ){` |
|        - | 4595 | `			/* ============================================================` |
...
|        - | 4980 | `		 * ============================================================ */` |
|   104998 | 4981 | `		n = 0;` |
|   270036 | 4982 | `		while( pArg < pTos ){` |
|   165343 | 4983 | `			if( n < SySetUsed(&pVmFunc->aArgs) && (aFormalArg[n].iFlags & VM_FUNC_ARG_VARIADIC) ){` |
...
|        - | 5083 | `			}` |
|   165143 | 5084 | `			if( n < SySetUsed(&pVmFunc->aArgs) ){` |
...
|   164621 | 5091 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_UNION ){` |
...
|   164534 | 5124 | `				if( aFormalArg[n].nType > 0` |
|    89507 | 5125 | `					&& !((aFormalArg[n].iFlags & VM_FUNC_ARG_NULLABLE) && (pArg->iFlags & MEMOBJ_NULL)) ){` |
...
|       13 | 5201 | `					}` |
|     6975 | 5202 | `				}` |
|   164523 | 5203 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_BY_REF ){` |
...
|   164283 | 5255 | `					pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|        - | 5256 | `				}` |
|    82468 | 5257 | `			}else{` |
|        - | 5258 | `				char zName[32];` |
...
|        - | 5265 | `			}` |
|   165043 | 5266 | `			if( pObj ){` |
|   164807 | 5267 | `				PH7_MemObjStore(pArg,pObj);` |
|        - | 5268 | `				/* Insert argument index  */` |
|   164807 | 5269 | `				sArg.nIdx = pObj->nIdx;` |
|   164807 | 5270 | `				sArg.pUserData = 0;` |
|   164807 | 5271 | `				SySetPut(&pFrame->sArg,(const void *)&sArg);` |
|    82606 | 5272 | `			}` |
|   165043 | 5273 | `			PH7_MemObjRelease(pArg);` |
|   165043 | 5274 | `			pArg++;` |
|   165043 | 5275 | `			++n;` |
|        5 | 5276 | `		}` |
|        - | 5277 | `		} /* end named vs positional branch */` |
|        - | 5278 | `		/* Set up closure environment */` |
|   105144 | 5279 | `		if( pVmFunc->iFlags & VM_FUNC_CLOSURE ){` |
...
|   105139 | 5327 | `		if( n < SySetUsed(&pVmFunc->aArgs)` |
|    56271 | 5328 | `		 && (pVmFunc->iFlags & (VM_FUNC_INTERNAL\|VM_FUNC_CLASS_METHOD)) != VM_FUNC_INTERNAL ){` |
...
|   117212 | 5351 | `		while( n < SySetUsed(&pVmFunc->aArgs) ){` |
...
|        - | 5394 | `		 */` |
|   105122 | 5395 | `		PH7_MemObjRelease(pTos);` |
|   105122 | 5396 | `		pTos = &pTos[-nCallArgs];` |
...
|        - | 5408 | `		 * per function. */` |
|        - | 5409 | `		{` |
|   105122 | 5410 | `			sxu32 nSlots = pVmFunc->nMaxStack;` |
|   105122 | 5411 | `			if( nSlots == 0 ){` |
...
|     4143 | 5418 | `			}` |
|   105122 | 5419 | `			pFrameStack = VmOperandStackAlloc(&(*pVm),nSlots);` |
|        - | 5420 | `		}` |
|   105122 | 5421 | `		if( pFrameStack == 0 ){` |
...
|   105122 | 5466 | `			VmCallFrame *pRec = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   105122 | 5467 | `			if( pRec ){` |
|   102478 | 5468 | `				pVm->pIdleCallFrames = (void *)pRec->pPrev;` |
|    51344 | 5469 | `			}else{` |
|     2649 | 5470 | `				pRec = (VmCallFrame *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmCallFrame));` |
|        - | 5471 | `			}` |
|   105122 | 5472 | `			if( pRec == 0 ){` |
...
|      ! 0 | 5483 | `				goto Abort;` |
|        - | 5484 | `			}` |
|   105122 | 5485 | `			sState.pTos = pTos;` |
|   105122 | 5486 | `			sState.pc = pc;` |
|   105122 | 5487 | `			pRec->sCaller = sState;` |
|   105122 | 5488 | `			pRec->sCall.pVmFunc = pVmFunc;` |
|   105122 | 5489 | `			pRec->sCall.pFrame = pFrame;` |
|   105122 | 5490 | `			pRec->sCall.pFrameStack = pFrameStack;` |
|   105122 | 5491 | `			pRec->sCall.nStackCap = pVmFunc->nMaxStack + VM_STACK_GUARD;` |
|   105122 | 5492 | `			pRec->sCall.nLastRef = SXU32_HIGH;` |
|   105122 | 5493 | `			pRec->sCall.bSelfPushed = (sxu8)(pSelf ? 1 : 0);` |
|   105122 | 5494 | `			pRec->pPrev = pCallTop;` |
|   105122 | 5495 | `			pCallTop = pRec;` |
|        - | 5496 | `			/* Switch to the callee activation (what the recursive` |
|        - | 5497 | `			 * VmByteCodeExec entry used to set up). */` |
|   105122 | 5498 | `			aInstr = (VmInstr *)SySetBasePtr(&pVmFunc->aByteCode);` |
|   105122 | 5499 | `			pStack = pFrameStack;` |
|   105122 | 5500 | `			pTos = &pStack[-1];` |
|   105122 | 5501 | `			pc = 0;` |
|   105122 | 5502 | `			sState.aInstr = aInstr;` |
|   105122 | 5503 | `			sState.pStack = pStack;` |
|   105122 | 5504 | `			sState.nStackCap = pRec->sCall.nStackCap; /* callee's operand-stack capacity for OP_SPREAD growth */` |
|   105122 | 5505 | `			sState.nStackOrig = pRec->sCall.nStackCap; /* fixed headroom reference (never grows) */` |
|   105122 | 5506 | `			sState.pTos = pTos;` |
|   105122 | 5507 | `			sState.pc = 0;` |
|   105122 | 5508 | `			sState.nExceptionBase = SySetUsed(&pVm->aException);` |
|   105122 | 5509 | `			sState.pEntryFrame = pVm->pFrame;` |
|   105122 | 5510 | `			sState.pResult = pRec->sCaller.pTos;` |
|   105122 | 5511 | `			sState.pLastRef = &pRec->sCall.nLastRef;` |
|   105122 | 5512 | `			sState.pEnforceRetFunc = VmFuncHasReturnType(pVmFunc) ? pVmFunc : 0;` |
|   105122 | 5513 | `			sState.is_callback = 0;` |
|   105122 | 5514 | `			sState.bReturnPropagates = 0;` |
|   105122 | 5515 | `			goto VmLoopFetch;` |
|        - | 5516 | `		}` |
|       57 | 5517 | `	}else{` |
...
|   936977 | 5526 | `		pEntry = SyHashGet(&pVm->hHostFunction,(const void *)sName.zString,sName.nByte);` |
|        - | 5527 | `		{` |
|   936977 | 5528 | `		VmCallArgMap *pCallMap2 = pEffCallMap;` |
|   936977 | 5529 | `		if( pEntry == 0 && pCallMap2 && pCallMap2->bIsNamespaced ){` |
...
|        - | 5634 | `			}` |
|        - | 5635 | `		}` |
|   936961 | 5636 | `		pFunc = (ph7_user_func *)pEntry->pUserData;` |
...
|  1405803 | 5641 | `		pEffCallMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|   936956 | 5642 | `			nCallArgs > 0 ? (sxu32)nCallArgs : 0,&sEffMap);` |
|        - | 5643 | `		/* Start collecting function arguments */` |
|   936961 | 5644 | `		SySetReset(&aArg);` |
|  2532793 | 5645 | `		while( pArg < pTos ){` |
|  1595837 | 5646 | `			SySetPut(&aArg,(const void *)&pArg);` |
|  1595837 | 5647 | `			pArg++;` |
|        5 | 5648 | `		}` |
|        - | 5649 | `		/* Assume a null return value */` |
|   936961 | 5650 | `		PH7_MemObjInit(&(*pVm),&sRet);` |
|        - | 5651 | `		/* Init the call context */` |
|   936961 | 5652 | `		VmInitCallContext(&sCtx,&(*pVm),pFunc,&sRet,0);` |
...
|   936961 | 5659 | `		sCtx.pArgMap = pEffCallMap;` |
|        - | 5660 | `		{` |
|   936961 | 5661 | `		int nGiven = (int)SySetUsed(&aArg);` |
...
|   936961 | 5667 | `		if( pFunc->nMinArg > 0 && nGiven < pFunc->nMinArg ){` |
...
|      232 | 5674 | `				nGiven);` |
|   936729 | 5675 | `		}else if( pFunc->bHasMaxArg && nGiven > (int)pFunc->nMaxArg ){` |
...
|       40 | 5688 | `				nGiven);` |
|  1405027 | 5689 | `		}else if( SXRET_OK != (rc = VmEnforceBuiltinArgTypes(&sCtx,pFunc,nGiven,` |
|   936412 | 5690 | `			(ph7_value **)SySetBasePtr(&aArg))) ){` |
|        - | 5691 | `			/* TypeError thrown: rc carries the caught/uncaught status */` |
|      112 | 5692 | `		}else{` |
|        - | 5693 | `			/* Call the foreign function */` |
|   936203 | 5694 | `			rc = pFunc->xFunc(&sCtx,nGiven,(ph7_value **)SySetBasePtr(&aArg));` |
|        - | 5695 | `		}` |
|        - | 5696 | `		}` |
|        - | 5697 | `		/* Release the call context */` |
|   936961 | 5698 | `		VmReleaseCallContext(&sCtx);` |
|   936961 | 5699 | `		if( rc == PH7_ABORT ){` |
...
|      578 | 5704 | `			goto Abort;` |
|        - | 5705 | `		}` |
|   936387 | 5706 | `		if( rc != PH7_SUSPEND && pVm->pInlineInstr == (void *)aInstr ){` |
...
|      ! 0 | 5719 | `		}` |
|   936383 | 5720 | `		if( rc == PH7_EXCEPTION ){` |
...
|      839 | 5740 | `			break;` |
|        - | 5741 | `		}` |
|   935351 | 5742 | `		if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|   914075 | 5766 | `			VmPopOperand(&pTos,nCallArgs);` |
|   457399 | 5767 | `		}` |
|        - | 5768 | `		/* Save foreign function return value into the (now top) function-name slot */` |
|   934997 | 5769 | `		PH7_MemObjStore(&sRet,pTos);` |
|   934997 | 5770 | `		PH7_MemObjRelease(&sRet);` |
|        - | 5771 | `	}` |
|   935101 | 5772 | `	break;` |
|        - | 5773 | `				  }` |
|        - | 5774 | `/*` |
...
|        - | 5777 | ` */` |
|    26079 | 5778 | `case PH7_OP_CONSUME: {` |
|        - | 5779 | `	VmOpRc rcOp;` |
|    52163 | 5780 | `	sState.pTos = pTos;` |
|    52163 | 5781 | `	sState.pc = pc;` |
|    52163 | 5782 | `	rcOp = VmExecOpConsume(&(*pVm),&sState,pInstr);` |
|    52163 | 5783 | `	pTos = sState.pTos;` |
|    52163 | 5784 | `	pc = sState.pc;` |
|    52163 | 5785 | `	if( rcOp == VM_OP_ABORT ){` |
|      ! 0 | 5786 | `		goto Abort;` |
|    52163 | 5787 | `	}else if( rcOp == VM_OP_EXCEPTION ){` |
...
|        - | 5792 |  |
|        - | 5793 | `		} /* Switch() */` |
| 16724679 | 5794 | `		pc++; /* Next instruction in the stream */` |
|        5 | 5795 | `	} /* For(;;) */` |
|   131388 | 5796 | `Done:` |
...
|   262986 | 5800 | `	rc = SXRET_OK;` |
|   262986 | 5801 | `	goto Unwind;` |
|      823 | 5802 | `Suspend:` |
...
|   133401 | 5860 | `	for(;;){` |
|   266602 | 5861 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|      ! 0 | 5869 | `			}` |
|     1162 | 5870 | `		}` |
|   266602 | 5871 | `		if( pCallTop == 0 ){` |
|   161895 | 5872 | `			return VmExecFinalize(&(*pVm),&sState,&aArg,pTos,rc);` |
|        - | 5873 | `		}` |
|   104712 | 5874 | `		if( rc == PH7_ABORT \|\| rc == PH7_EXCEPTION ){` |
...
|      636 | 5880 | `		}` |
|        - | 5881 | `		{` |
|   104712 | 5882 | `			VmCallFrame *pRec = pCallTop;` |
|   104712 | 5883 | `			sState = pRec->sCaller;` |
|   104712 | 5884 | `			rc = VmCallFinish(&(*pVm),&sState,&pRec->sCall,rc);` |
|   104712 | 5885 | `			pCallTop = pRec->pPrev;` |
|   104712 | 5886 | `			pRec->pPrev = (VmCallFrame *)pVm->pIdleCallFrames;` |
|   104712 | 5887 | `			pVm->pIdleCallFrames = (void *)pRec;` |
|   104712 | 5888 | `			aInstr = sState.aInstr;` |
|   104712 | 5889 | `			pStack = sState.pStack;` |
|   104712 | 5890 | `			pTos = sState.pTos;` |
|   104712 | 5891 | `			pc = sState.pc;` |
|        - | 5892 | `		}` |
|   104712 | 5893 | `		if( rc == PH7_OK ){` |
|   103946 | 5894 | `			pc++; /* the loop-bottom increment this OP_CALL missed */` |
|   103946 | 5895 | `			goto VmLoopFetch;` |
|        - | 5896 | `		}` |
|        5 | 5897 | `	}` |
|    81127 | 5898 | `}` |
|        - | 5899 |  |
