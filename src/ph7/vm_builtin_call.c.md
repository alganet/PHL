...
|     - |  715 | ` */` |
| 14346 |  716 | `PH7_PRIVATE void VmBoundaryPark(ph7_vm *pVm,sxi32 rc)` |
|     5 |  717 | `{` |
| 14351 |  718 | `	if( (rc == PH7_EXCEPTION \|\| rc == PH7_ABORT) && pVm->nBoundaryRc != PH7_ABORT ){` |
...
|     2 | 1059 | `	}` |
|    36 | 1060 | `}` |
|  2386 | 1061 | `PH7_PRIVATE sxi32 PH7_VmCallUserFunctionWithMap(` |
...
|     - | 1072 | `	int i;` |
|  2391 | 1073 | `	if( VmValueIsClosure(pVm,pFunc) ){` |
...
|   ! 0 | 1097 | `	}` |
|  1661 | 1098 | `	if( pFunc->iFlags & MEMOBJ_OBJ ){` |
...
|     - | 1106 | `	}` |
|  1567 | 1107 | `	if((pFunc->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP)) == 0 ){` |
...
|     - | 1218 | ` */` |
|  1540 | 1219 | `PH7_PRIVATE sxi32 PH7_VmCallUserFunction(` |
...
|     - | 1225 | `	)` |
|     5 | 1226 | `{` |
|  1545 | 1227 | `	return PH7_VmCallUserFunctionWithMap(&(*pVm),pFunc,nArg,apArg,pResult,0);` |
|     5 | 1228 | `}` |
|     - | 1229 | `/*` |
