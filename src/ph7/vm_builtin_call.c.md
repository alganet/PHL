...
|     - |  342 | ` */` |
| 59464 |  343 | `PH7_PRIVATE int PH7_VmIsCallable(ph7_vm *pVm,ph7_value *pValue,int CallInvoke)` |
|     5 |  344 | `{` |
| 59469 |  345 | `	int res = 0;` |
| 59469 |  346 | `	if( pValue->iFlags & MEMOBJ_OBJ ){` |
...
| 59201 |  359 | `	}else if( pValue->iFlags & MEMOBJ_HASHMAP ){` |
