...
|     2 | 1063 | `	}` |
|    36 | 1064 | `}` |
|  2478 | 1065 | `PH7_PRIVATE sxi32 PH7_VmCallUserFunctionWithMap(` |
...
|     - | 1076 | `	int i;` |
|  2483 | 1077 | `	if( VmValueIsClosure(pVm,pFunc) ){` |
...
|   ! 0 | 1101 | `	}` |
|  1713 | 1102 | `	if( pFunc->iFlags & MEMOBJ_OBJ ){` |
...
|     - | 1110 | `	}` |
|  1619 | 1111 | `	if((pFunc->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP)) == 0 ){` |
...
|     - | 1118 | `	}` |
|  1053 | 1119 | `	if( pFunc->iFlags & MEMOBJ_HASHMAP ){` |
|     - | 1120 | `		/* Class method */` |
...
|   941 | 1172 | `	aStack = VmNewOperandStack(&(*pVm),1+nArg);` |
|   941 | 1173 | `	if( aStack == 0 ){` |
...
|  2849 | 1183 | `	for( i = 0 ; i < nArg ; i++ ){` |
|  1913 | 1184 | `		PH7_MemObjLoad(apArg[i],&aStack[i]);` |
|     - | 1185 | `		/*` |
|     - | 1186 | `		 * Symisc eXtension:` |
|     - | 1187 | `		 *  Parameters to [call_user_func()] can be passed by reference.` |
|     - | 1188 | `		 */` |
|  1913 | 1189 | `		aStack[i].nIdx = apArg[i]->nIdx;` |
|   959 | 1190 | `	}` |
|     - | 1191 | `	/* Push the function name */` |
|   941 | 1192 | `	PH7_MemObjLoad(pFunc,&aStack[i]);` |
|   941 | 1193 | `	aStack[i].nIdx = SXU32_HIGH; /* Mark as constant */` |
|     - | 1194 | `	/* Emit the CALL istruction */` |
|   941 | 1195 | `	aInstr[0].iOp = PH7_OP_CALL;` |
|   941 | 1196 | `	aInstr[0].iP1 = nArg; /* Total number of given arguments */` |
|   941 | 1197 | `	aInstr[0].iP2 = 0;` |
|   941 | 1198 | `	aInstr[0].p3  = (void *)pArgMap; /* Named-arg map (0 for positional callers) */` |
|     - | 1199 | `	/* Emit the DONE instruction */` |
|   941 | 1200 | `	aInstr[1].iOp = PH7_OP_DONE;` |
|   941 | 1201 | `	aInstr[1].iP1 = 1;   /* Extract function return value if available */` |
|   941 | 1202 | `	aInstr[1].iP2 = 0;` |
|   941 | 1203 | `	aInstr[1].p3  = 0;` |
|     - | 1204 | `	/* Execute the function body (if available) */` |
|     - | 1205 | `	{` |
|     - | 1206 | `		sxi32 rcExec;` |
|   941 | 1207 | `		sxu32 nStkCap = (sxu32)(1+nArg) + VM_STACK_GUARD; /* what VmNewOperandStack handed out */` |
|   941 | 1208 | `		rcExec = VmByteCodeExec(&(*pVm),aInstr,aStack,nArg,pResult,0,TRUE,0,0,FALSE,0,&aStack,&nStkCap,nStkCap);` |
|     - | 1209 | `		/* Clean up the mess left behind */` |
|   941 | 1210 | `		SyMemBackendFree(&pVm->sAllocator,aStack);` |
...
|   941 | 1213 | `		VmBoundaryPark(&(*pVm),rcExec);` |
|   941 | 1214 | `		return rcExec;` |
|     - | 1215 | `	}` |
|  1244 | 1216 | `}` |
|     - | 1217 | `/*` |
...
|     - | 1222 | ` */` |
|  1592 | 1223 | `PH7_PRIVATE sxi32 PH7_VmCallUserFunction(` |
...
|     - | 1229 | `	)` |
|     5 | 1230 | `{` |
|  1597 | 1231 | `	return PH7_VmCallUserFunctionWithMap(&(*pVm),pFunc,nArg,apArg,pResult,0);` |
|     5 | 1232 | `}` |
|     - | 1233 | `/*` |
