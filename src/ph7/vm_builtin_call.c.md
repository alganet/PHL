...
|     - |  342 | ` */` |
| 60496 |  343 | `PH7_PRIVATE int PH7_VmIsCallable(ph7_vm *pVm,ph7_value *pValue,int CallInvoke)` |
|     5 |  344 | `{` |
| 60501 |  345 | `	int res = 0;` |
| 60501 |  346 | `	if( pValue->iFlags & MEMOBJ_OBJ ){` |
...
| 60230 |  359 | `	}else if( pValue->iFlags & MEMOBJ_HASHMAP ){` |
...
|    26 |  381 | `			}` |
|    30 |  382 | `		}` |
| 59924 |  383 | `	}else if( pValue->iFlags & MEMOBJ_STRING ){` |
