...
|     - |  305 | ` */` |
|   638 |  306 | `PH7_PRIVATE int vm_builtin_func_exists(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 |  307 | `{` |
...
|   643 |  318 | `	pVm = pCtx->pVm;` |
|     - |  319 | `	/* Extract the function name */` |
|   643 |  320 | `	zName = ph7_value_to_string(apArg[0],&nLen);` |
|     - |  321 | `	/* php: a leading '\' anchors the name to the global namespace; strip it. */` |
|   643 |  322 | `	if( nLen > 0 && zName[0] == '\\' ){ zName++; nLen--; }` |
|     - |  323 | `	/* Assume the function is not defined */` |
|   643 |  324 | `	res = 0;` |
|     - |  325 | `	/* Perform the lookup */` |
|   944 |  326 | `	if( SyHashGet(&pVm->hFunction,(const void *)zName,(sxu32)nLen) != 0 \|\|` |
|   602 |  327 | `		SyHashGet(&pVm->hHostFunction,(const void *)zName,(sxu32)nLen) != 0 ){` |
|     - |  328 | `			/* Function is defined */` |
|   231 |  329 | `			res = 1;` |
|   113 |  330 | `	}` |
|   643 |  331 | `	ph7_result_bool(pCtx,res);` |
|   643 |  332 | `	return SXRET_OK;` |
|   324 |  333 | `}` |
|     - |  334 | `/*` |
...
|     - |  338 | ` */` |
| 59292 |  339 | `PH7_PRIVATE int PH7_VmIsCallable(ph7_vm *pVm,ph7_value *pValue,int CallInvoke)` |
|     5 |  340 | `{` |
| 59297 |  341 | `	int res = 0;` |
| 59297 |  342 | `	if( pValue->iFlags & MEMOBJ_OBJ ){` |
...
|   515 |  347 | `		ph7_class_instance *pThis = (ph7_class_instance *)pValue->x.pOther;` |
|   515 |  348 | `		if( VmValueIsClosure(pVm,pValue) ){` |
|     - |  349 | `			/* A Closure (incl. a first-class callable) is always callable. */` |
|   473 |  350 | `			res = 1;` |
|   279 |  351 | `		}else if( PH7_ClassExtractMethod(pThis->pClass,"__invoke",sizeof("__invoke")-1) ){` |
|    41 |  352 | `			res = 1;` |
|    24 |  353 | `		}` |
|   255 |  354 | `		(void)CallInvoke;` |
| 59042 |  355 | `	}else if( pValue->iFlags & MEMOBJ_HASHMAP ){` |
...
|     - |  598 | ` */` |
|  2130 |  599 | `PH7_PRIVATE ph7_class * PH7_VmPeekTopClass(ph7_vm *pVm)` |
|     5 |  600 | `{` |
|  2135 |  601 | `	SySet *pSet = &pVm->aSelf;` |
|     - |  602 | `	ph7_class **apClass;` |
|  2135 |  603 | `	if( SySetUsed(pSet) <= 0 ){` |
|     - |  604 | `		/* Empty stack: fall back to the initializer-eval class (see` |
|     - |  605 | `		 * pConstEvalClass) so static:: degrades to self:: there. */` |
|  1101 |  606 | `		return pVm->pConstEvalClass;` |
|     - |  607 | `	}` |
|     - |  608 | `	/* Peek the last entry */` |
|  1038 |  609 | `	apClass = (ph7_class **)SySetBasePtr(pSet);` |
|  1038 |  610 | `	return apClass[pSet->nUsed - 1];` |
|  1070 |  611 | `}` |
|     - |  612 | `/*` |
...
|     - |  629 | ` *   declaring class.` |
|     - |  630 | ` */` |
|  2066 |  631 | `PH7_PRIVATE ph7_class * PH7_VmPeekDeclaringClass(ph7_vm *pVm)` |
|     5 |  632 | `{` |
|  2071 |  633 | `	VmFrame *pFrame = pVm->pFrame;` |
|     - |  634 | `	ph7_vm_func *pVmFunc;` |
|     - |  635 |  |
|     - |  636 | `	/* Skip exception frames to find the actual method frame */` |
|  2071 |  637 | `	pFrame = VmSkipExceptionFrames(pFrame);` |
|     - |  638 |  |
...
|  2071 |  646 | `	if( pVm->pConstEvalClass && pVm->pConstEvalFrame == (void *)pFrame ){` |
|    21 |  647 | `		return pVm->pConstEvalClass;` |
|     - |  648 | `	}` |
|     - |  649 |  |
|     - |  650 | `	/* Check if we're in a method context */` |
|  2051 |  651 | `	if( pFrame->pParent ){` |
|  1034 |  652 | `		if( pFrame->pBoundScope ){` |
...
|     - |  656 | `		}` |
|  1032 |  657 | `		pVmFunc = (ph7_vm_func *)pFrame->pUserData;` |
|  1032 |  658 | `		if( pVmFunc && (pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) ){` |
|     - |  659 | `			/* Return the declaring class */` |
|   944 |  660 | `			return (ph7_class *)pVmFunc->pUserData;` |
|     - |  661 | `		}` |
...
|  1099 |  672 | `	return pVm->pConstEvalClass;` |
|  1038 |  673 | `}` |
|     - |  674 | `/*` |
...
|     - |  715 | ` */` |
| 13746 |  716 | `PH7_PRIVATE void VmBoundaryPark(ph7_vm *pVm,sxi32 rc)` |
|     5 |  717 | `{` |
| 13751 |  718 | `	if( (rc == PH7_EXCEPTION \|\| rc == PH7_ABORT) && pVm->nBoundaryRc != PH7_ABORT ){` |
...
|     - |  727 | ` */` |
| 12792 |  728 | `PH7_PRIVATE sxi32 VmCallClassMethodWithMap(` |
|     - |  729 | `	ph7_vm *pVm,` |
...
|     - |  741 | `	int i;` |
|     - |  742 | `	sxi32 rc;` |
| 12797 |  743 | `	aStack = VmNewOperandStack(&(*pVm),2+nArg);` |
| 12797 |  744 | `	if( aStack == 0 ){` |
...
|     - |  748 | `	}` |
| 19679 |  749 | `	for( i = 0 ; i < nArg ; i++ ){` |
|  6887 |  750 | `		PH7_MemObjLoad(apArg[i],&aStack[i]);` |
|  6887 |  751 | `		aStack[i].nIdx = apArg[i]->nIdx;` |
|  3446 |  752 | `	}` |
| 12797 |  753 | `	iCursor = nArg + 1;` |
| 12797 |  754 | `	if( pThis ){` |
| 12739 |  755 | `		pThis->iRef++;` |
| 12739 |  756 | `		aStack[i].x.pOther = pThis;` |
| 12739 |  757 | `		aStack[i].iFlags = MEMOBJ_OBJ;` |
|  6367 |  758 | `	}` |
| 12797 |  759 | `	aStack[i].nIdx = SXU32_HIGH;` |
| 12797 |  760 | `	i++;` |
| 12797 |  761 | `	SyBlobReset(&aStack[i].sBlob);` |
| 12797 |  762 | `	SyBlobAppend(&aStack[i].sBlob,(const void *)SyStringData(&pMethod->sVmName),SyStringLength(&pMethod->sVmName));` |
| 12797 |  763 | `	aStack[i].iFlags = MEMOBJ_STRING;` |
| 12797 |  764 | `	aStack[i].nIdx = SXU32_HIGH;` |
| 12797 |  765 | `	aInstr[0].iOp = PH7_OP_CALL;` |
| 12797 |  766 | `	aInstr[0].iP1 = nArg;` |
| 12797 |  767 | `	aInstr[0].iP2 = 0;` |
| 12797 |  768 | `	aInstr[0].p3  = (void *)pMap; /* forward named-arg metadata */` |
| 12797 |  769 | `	aInstr[1].iOp = PH7_OP_DONE;` |
| 12797 |  770 | `	aInstr[1].iP1 = 1;` |
| 12797 |  771 | `	aInstr[1].iP2 = 0;` |
| 12797 |  772 | `	aInstr[1].p3  = 0;` |
|     - |  773 | `	{` |
| 12797 |  774 | `		sxu32 nStkCap = (sxu32)(2+nArg) + VM_STACK_GUARD; /* what VmNewOperandStack handed out */` |
| 12797 |  775 | `		rc = VmByteCodeExec(&(*pVm),aInstr,aStack,iCursor,pResult,0,TRUE,0,0,FALSE,0,&aStack,&nStkCap,nStkCap);` |
|     - |  776 | `	}` |
| 12797 |  777 | `	SyMemBackendFree(&pVm->sAllocator,aStack);` |
...
| 12797 |  782 | `	VmBoundaryPark(&(*pVm),rc);` |
| 12797 |  783 | `	return rc;` |
|  6401 |  784 | `}` |
|  9594 |  785 | `PH7_PRIVATE sxi32 PH7_VmCallClassMethod(` |
...
|     - |  792 | `	)` |
|     5 |  793 | `{` |
|  9599 |  794 | `	return VmCallClassMethodWithMap(pVm,pThis,pMethod,pResult,nArg,apArg,0);` |
|     5 |  795 | `}` |
|     - |  796 | `/*` |
...
|     2 | 1059 | `	}` |
|    36 | 1060 | `}` |
|  2382 | 1061 | `PH7_PRIVATE sxi32 PH7_VmCallUserFunctionWithMap(` |
...
|     - | 1072 | `	int i;` |
|  2387 | 1073 | `	if( VmValueIsClosure(pVm,pFunc) ){` |
...
|     - | 1078 | `		sxi32 rcClo;` |
|   735 | 1079 | `		PH7_MemObjInit(pVm,&sCallable);` |
|   735 | 1080 | `		if( VmClosureUnwrap(pVm,pFunc,&sCallable) == SXRET_OK ){` |
|   735 | 1081 | `			rcClo = PH7_VmCallUserFunctionWithMap(pVm,&sCallable,nArg,apArg,pResult,pArgMap);` |
...
|   735 | 1092 | `			pVm->pClosureScope = 0;` |
|   735 | 1093 | `			PH7_MemObjRelease(&sCallable);` |
|   735 | 1094 | `			return rcClo;` |
|     - | 1095 | `		}` |
|   ! 0 | 1096 | `		PH7_MemObjRelease(&sCallable);` |
|   ! 0 | 1097 | `	}` |
|  1657 | 1098 | `	if( pFunc->iFlags & MEMOBJ_OBJ ){` |
...
|     - | 1106 | `	}` |
|  1563 | 1107 | `	if((pFunc->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP)) == 0 ){` |
|     - | 1108 | `		/* Don't bother processing,it's invalid anyway */` |
|   565 | 1109 | `		if( pResult ){` |
|     - | 1110 | `			/* Assume a null return value */` |
|     5 | 1111 | `			PH7_MemObjRelease(pResult);` |
|     2 | 1112 | `		}` |
|   565 | 1113 | `		return SXERR_INVALID;` |
|     - | 1114 | `	}` |
|  1003 | 1115 | `	if( pFunc->iFlags & MEMOBJ_HASHMAP ){` |
|     - | 1116 | `		/* Class method */` |
...
|   891 | 1168 | `	aStack = VmNewOperandStack(&(*pVm),1+nArg);` |
|   891 | 1169 | `	if( aStack == 0 ){` |
...
|  2641 | 1179 | `	for( i = 0 ; i < nArg ; i++ ){` |
|  1755 | 1180 | `		PH7_MemObjLoad(apArg[i],&aStack[i]);` |
|     - | 1181 | `		/*` |
|     - | 1182 | `		 * Symisc eXtension:` |
|     - | 1183 | `		 *  Parameters to [call_user_func()] can be passed by reference.` |
|     - | 1184 | `		 */` |
|  1755 | 1185 | `		aStack[i].nIdx = apArg[i]->nIdx;` |
|   880 | 1186 | `	}` |
|     - | 1187 | `	/* Push the function name */` |
|   891 | 1188 | `	PH7_MemObjLoad(pFunc,&aStack[i]);` |
|   891 | 1189 | `	aStack[i].nIdx = SXU32_HIGH; /* Mark as constant */` |
|     - | 1190 | `	/* Emit the CALL istruction */` |
|   891 | 1191 | `	aInstr[0].iOp = PH7_OP_CALL;` |
|   891 | 1192 | `	aInstr[0].iP1 = nArg; /* Total number of given arguments */` |
|   891 | 1193 | `	aInstr[0].iP2 = 0;` |
|   891 | 1194 | `	aInstr[0].p3  = (void *)pArgMap; /* Named-arg map (0 for positional callers) */` |
|     - | 1195 | `	/* Emit the DONE instruction */` |
|   891 | 1196 | `	aInstr[1].iOp = PH7_OP_DONE;` |
|   891 | 1197 | `	aInstr[1].iP1 = 1;   /* Extract function return value if available */` |
|   891 | 1198 | `	aInstr[1].iP2 = 0;` |
|   891 | 1199 | `	aInstr[1].p3  = 0;` |
|     - | 1200 | `	/* Execute the function body (if available) */` |
|     - | 1201 | `	{` |
|     - | 1202 | `		sxi32 rcExec;` |
|   891 | 1203 | `		sxu32 nStkCap = (sxu32)(1+nArg) + VM_STACK_GUARD; /* what VmNewOperandStack handed out */` |
|   891 | 1204 | `		rcExec = VmByteCodeExec(&(*pVm),aInstr,aStack,nArg,pResult,0,TRUE,0,0,FALSE,0,&aStack,&nStkCap,nStkCap);` |
|     - | 1205 | `		/* Clean up the mess left behind */` |
|   891 | 1206 | `		SyMemBackendFree(&pVm->sAllocator,aStack);` |
...
|   891 | 1209 | `		VmBoundaryPark(&(*pVm),rcExec);` |
|   891 | 1210 | `		return rcExec;` |
|     - | 1211 | `	}` |
|  1196 | 1212 | `}` |
|     - | 1213 | `/*` |
...
|     - | 1218 | ` */` |
|  1536 | 1219 | `PH7_PRIVATE sxi32 PH7_VmCallUserFunction(` |
...
|     - | 1225 | `	)` |
|     5 | 1226 | `{` |
|  1541 | 1227 | `	return PH7_VmCallUserFunctionWithMap(&(*pVm),pFunc,nArg,apArg,pResult,0);` |
|     5 | 1228 | `}` |
|     - | 1229 | `/*` |
