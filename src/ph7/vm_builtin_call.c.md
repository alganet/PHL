...
|     - |  338 | ` */` |
| 59278 |  339 | `PH7_PRIVATE int PH7_VmIsCallable(ph7_vm *pVm,ph7_value *pValue,int CallInvoke)` |
|     5 |  340 | `{` |
| 59283 |  341 | `	int res = 0;` |
| 59283 |  342 | `	if( pValue->iFlags & MEMOBJ_OBJ ){` |
...
| 59028 |  355 | `	}else if( pValue->iFlags & MEMOBJ_HASHMAP ){` |
...
|    26 |  377 | `			}` |
|    30 |  378 | `		}` |
| 58738 |  379 | `	}else if( pValue->iFlags & MEMOBJ_STRING ){` |
...
|     - |  715 | ` */` |
| 13698 |  716 | `PH7_PRIVATE void VmBoundaryPark(ph7_vm *pVm,sxi32 rc)` |
|     5 |  717 | `{` |
| 13703 |  718 | `	if( (rc == PH7_EXCEPTION \|\| rc == PH7_ABORT) && pVm->nBoundaryRc != PH7_ABORT ){` |
...
|     - |  727 | ` */` |
| 12744 |  728 | `PH7_PRIVATE sxi32 VmCallClassMethodWithMap(` |
|     - |  729 | `	ph7_vm *pVm,` |
...
|     - |  741 | `	int i;` |
|     - |  742 | `	sxi32 rc;` |
| 12749 |  743 | `	aStack = VmNewOperandStack(&(*pVm),2+nArg);` |
| 12749 |  744 | `	if( aStack == 0 ){` |
...
|     - |  748 | `	}` |
| 19615 |  749 | `	for( i = 0 ; i < nArg ; i++ ){` |
|  6871 |  750 | `		PH7_MemObjLoad(apArg[i],&aStack[i]);` |
|  6871 |  751 | `		aStack[i].nIdx = apArg[i]->nIdx;` |
|  3438 |  752 | `	}` |
| 12749 |  753 | `	iCursor = nArg + 1;` |
| 12749 |  754 | `	if( pThis ){` |
| 12691 |  755 | `		pThis->iRef++;` |
| 12691 |  756 | `		aStack[i].x.pOther = pThis;` |
| 12691 |  757 | `		aStack[i].iFlags = MEMOBJ_OBJ;` |
|  6343 |  758 | `	}` |
| 12749 |  759 | `	aStack[i].nIdx = SXU32_HIGH;` |
| 12749 |  760 | `	i++;` |
| 12749 |  761 | `	SyBlobReset(&aStack[i].sBlob);` |
| 12749 |  762 | `	SyBlobAppend(&aStack[i].sBlob,(const void *)SyStringData(&pMethod->sVmName),SyStringLength(&pMethod->sVmName));` |
| 12749 |  763 | `	aStack[i].iFlags = MEMOBJ_STRING;` |
| 12749 |  764 | `	aStack[i].nIdx = SXU32_HIGH;` |
| 12749 |  765 | `	aInstr[0].iOp = PH7_OP_CALL;` |
| 12749 |  766 | `	aInstr[0].iP1 = nArg;` |
| 12749 |  767 | `	aInstr[0].iP2 = 0;` |
| 12749 |  768 | `	aInstr[0].p3  = (void *)pMap; /* forward named-arg metadata */` |
| 12749 |  769 | `	aInstr[1].iOp = PH7_OP_DONE;` |
| 12749 |  770 | `	aInstr[1].iP1 = 1;` |
| 12749 |  771 | `	aInstr[1].iP2 = 0;` |
| 12749 |  772 | `	aInstr[1].p3  = 0;` |
|     - |  773 | `	{` |
| 12749 |  774 | `		sxu32 nStkCap = (sxu32)(2+nArg) + VM_STACK_GUARD; /* what VmNewOperandStack handed out */` |
| 12749 |  775 | `		rc = VmByteCodeExec(&(*pVm),aInstr,aStack,iCursor,pResult,0,TRUE,0,0,FALSE,0,&aStack,&nStkCap,nStkCap);` |
|     - |  776 | `	}` |
| 12749 |  777 | `	SyMemBackendFree(&pVm->sAllocator,aStack);` |
...
| 12749 |  782 | `	VmBoundaryPark(&(*pVm),rc);` |
| 12749 |  783 | `	return rc;` |
|  6377 |  784 | `}` |
|  9546 |  785 | `PH7_PRIVATE sxi32 PH7_VmCallClassMethod(` |
...
|     - |  792 | `	)` |
|     5 |  793 | `{` |
|  9551 |  794 | `	return VmCallClassMethodWithMap(pVm,pThis,pMethod,pResult,nArg,apArg,0);` |
|     5 |  795 | `}` |
|     - |  796 | `/*` |
...
|     2 | 1059 | `	}` |
|    36 | 1060 | `}` |
|  2372 | 1061 | `PH7_PRIVATE sxi32 PH7_VmCallUserFunctionWithMap(` |
...
|     - | 1072 | `	int i;` |
|  2377 | 1073 | `	if( VmValueIsClosure(pVm,pFunc) ){` |
...
|   ! 0 | 1097 | `	}` |
|  1647 | 1098 | `	if( pFunc->iFlags & MEMOBJ_OBJ ){` |
...
|     - | 1218 | ` */` |
|  1526 | 1219 | `PH7_PRIVATE sxi32 PH7_VmCallUserFunction(` |
...
|     - | 1225 | `	)` |
|     5 | 1226 | `{` |
|  1531 | 1227 | `	return PH7_VmCallUserFunctionWithMap(&(*pVm),pFunc,nArg,apArg,pResult,0);` |
|     5 | 1228 | `}` |
|     - | 1229 | `/*` |
