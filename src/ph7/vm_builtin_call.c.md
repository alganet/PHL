...
|     - |  309 | ` */` |
|   620 |  310 | `PH7_PRIVATE int vm_builtin_func_exists(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 |  311 | `{` |
...
|   625 |  322 | `	pVm = pCtx->pVm;` |
|     - |  323 | `	/* Extract the function name */` |
|   625 |  324 | `	zName = ph7_value_to_string(apArg[0],&nLen);` |
|     - |  325 | `	/* php: a leading '\' anchors the name to the global namespace; strip it. */` |
|   625 |  326 | `	if( nLen > 0 && zName[0] == '\\' ){ zName++; nLen--; }` |
|     - |  327 | `	/* Assume the function is not defined */` |
|   625 |  328 | `	res = 0;` |
|     - |  329 | `	/* Perform the lookup */` |
|   917 |  330 | `	if( SyHashGet(&pVm->hFunction,(const void *)zName,(sxu32)nLen) != 0 \|\|` |
|   584 |  331 | `		SyHashGet(&pVm->hHostFunction,(const void *)zName,(sxu32)nLen) != 0 ){` |
|     - |  332 | `			/* Function is defined */` |
|   231 |  333 | `			res = 1;` |
|   113 |  334 | `	}` |
|   625 |  335 | `	ph7_result_bool(pCtx,res);` |
|   625 |  336 | `	return SXRET_OK;` |
|   315 |  337 | `}` |
|     - |  338 | `/*` |
...
|     - |  342 | ` */` |
| 59388 |  343 | `PH7_PRIVATE int PH7_VmIsCallable(ph7_vm *pVm,ph7_value *pValue,int CallInvoke)` |
|     5 |  344 | `{` |
| 59393 |  345 | `	int res = 0;` |
| 59393 |  346 | `	if( pValue->iFlags & MEMOBJ_OBJ ){` |
...
| 59125 |  359 | `	}else if( pValue->iFlags & MEMOBJ_HASHMAP ){` |
...
|     - |  719 | ` */` |
| 14402 |  720 | `PH7_PRIVATE void VmBoundaryPark(ph7_vm *pVm,sxi32 rc)` |
|     5 |  721 | `{` |
| 14407 |  722 | `	if( (rc == PH7_EXCEPTION \|\| rc == PH7_ABORT) && pVm->nBoundaryRc != PH7_ABORT ){` |
...
|     - |  731 | ` */` |
| 13414 |  732 | `PH7_PRIVATE sxi32 VmCallClassMethodWithMap(` |
|     - |  733 | `	ph7_vm *pVm,` |
...
|     - |  745 | `	int i;` |
|     - |  746 | `	sxi32 rc;` |
| 13419 |  747 | `	aStack = VmNewOperandStack(&(*pVm),2+nArg);` |
| 13419 |  748 | `	if( aStack == 0 ){` |
...
|     - |  752 | `	}` |
| 20349 |  753 | `	for( i = 0 ; i < nArg ; i++ ){` |
|  6935 |  754 | `		PH7_MemObjLoad(apArg[i],&aStack[i]);` |
|  6935 |  755 | `		aStack[i].nIdx = apArg[i]->nIdx;` |
|  3470 |  756 | `	}` |
| 13419 |  757 | `	iCursor = nArg + 1;` |
| 13419 |  758 | `	if( pThis ){` |
| 13361 |  759 | `		pThis->iRef++;` |
| 13361 |  760 | `		aStack[i].x.pOther = pThis;` |
| 13361 |  761 | `		aStack[i].iFlags = MEMOBJ_OBJ;` |
|  6678 |  762 | `	}` |
| 13419 |  763 | `	aStack[i].nIdx = SXU32_HIGH;` |
| 13419 |  764 | `	i++;` |
| 13419 |  765 | `	SyBlobReset(&aStack[i].sBlob);` |
| 13419 |  766 | `	SyBlobAppend(&aStack[i].sBlob,(const void *)SyStringData(&pMethod->sVmName),SyStringLength(&pMethod->sVmName));` |
| 13419 |  767 | `	aStack[i].iFlags = MEMOBJ_STRING;` |
| 13419 |  768 | `	aStack[i].nIdx = SXU32_HIGH;` |
| 13419 |  769 | `	aInstr[0].iOp = PH7_OP_CALL;` |
| 13419 |  770 | `	aInstr[0].iP1 = nArg;` |
| 13419 |  771 | `	aInstr[0].iP2 = 0;` |
| 13419 |  772 | `	aInstr[0].p3  = (void *)pMap; /* forward named-arg metadata */` |
| 13419 |  773 | `	aInstr[1].iOp = PH7_OP_DONE;` |
| 13419 |  774 | `	aInstr[1].iP1 = 1;` |
| 13419 |  775 | `	aInstr[1].iP2 = 0;` |
| 13419 |  776 | `	aInstr[1].p3  = 0;` |
|     - |  777 | `	{` |
| 13419 |  778 | `		sxu32 nStkCap = (sxu32)(2+nArg) + VM_STACK_GUARD; /* what VmNewOperandStack handed out */` |
| 13419 |  779 | `		rc = VmByteCodeExec(&(*pVm),aInstr,aStack,iCursor,pResult,0,TRUE,0,0,FALSE,0,&aStack,&nStkCap,nStkCap);` |
|     - |  780 | `	}` |
| 13419 |  781 | `	SyMemBackendFree(&pVm->sAllocator,aStack);` |
...
| 13419 |  786 | `	VmBoundaryPark(&(*pVm),rc);` |
| 13419 |  787 | `	return rc;` |
|  6712 |  788 | `}` |
| 10208 |  789 | `PH7_PRIVATE sxi32 PH7_VmCallClassMethod(` |
...
|     - |  796 | `	)` |
|     5 |  797 | `{` |
| 10213 |  798 | `	return VmCallClassMethodWithMap(pVm,pThis,pMethod,pResult,nArg,apArg,0);` |
|     5 |  799 | `}` |
|     - |  800 | `/*` |
