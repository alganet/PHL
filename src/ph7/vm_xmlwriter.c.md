...
|     - |   47 | ` * down.` |
|     - |   48 | ` */` |
|  3960 |   49 | `PH7_PRIVATE void PH7_XmlWriterVmSweep(ph7_vm *pVm)` |
|     5 |   50 | `{` |
|  3965 |   51 | `	phl_xmlwriter *pXw = (phl_xmlwriter *)pVm->pXmlWriters;` |
|  3971 |   52 | `	while( pXw ){` |
...
|     - |  323 | ` */` |
|  4528 |  324 | `PH7_PRIVATE sxi32 PH7_VmInstallXmlWriter(ph7_vm *pVm)` |
|     5 |  325 | `{` |
...
|     - |  346 | `	};` |
|     - |  347 | `	sxu32 n;` |
| 76981 |  348 | `	for( n = 0 ; n < sizeof(aFunc)/sizeof(aFunc[0]) ; n++ ){` |
| 72453 |  349 | `		ph7_create_function(&(*pVm),aFunc[n].zName,aFunc[n].xFunc,0);` |
| 36229 |  350 | `	}` |
|  4533 |  351 | `	return PH7_VmEvalBuiltinChunk(&(*pVm),zXmlWriterLib,sizeof(zXmlWriterLib)-1);` |
|     5 |  352 | `}` |
|     - |  353 |  |
|     - |  354 | `#else` |
