...
|       84 | 1248 | `}` |
|    20018 | 1249 | `PH7_PRIVATE void PH7_VmThrowWarningFmt(ph7_vm *pVm,const char *zFmt,...)` |
|        5 | 1250 | `{` |
|        - | 1251 | `	va_list ap;` |
|    20023 | 1252 | `	va_start(ap,zFmt);` |
|    20023 | 1253 | `	PH7_VmThrowErrorAp(pVm,0,PH7_CTX_WARNING,zFmt,ap);` |
|    20023 | 1254 | `	va_end(ap);` |
|    20023 | 1255 | `}` |
|        - | 1256 | `/*` |
