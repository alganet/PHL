...
|        - |  867 | ` */` |
|  1444655 |  868 | `static int VmSigTypeHas(const char *zType,int nType,const char *zTok)` |
|        5 |  869 | `{` |
|  1444660 |  870 | `	int nTok = (int)SyStrlen(zTok);` |
|  1444660 |  871 | `	int i = 0;` |
|  1444660 |  872 | `	if( zType[0] == '?' ){` |
|   273945 |  873 | `		zType++;` |
|   273945 |  874 | `		nType--;` |
|   136970 |  875 | `	}` |
|  2876608 |  876 | `	while( i < nType ){` |
|  1578626 |  877 | `		int j = i;` |
|  9176090 |  878 | `		while( j < nType && zType[j] != '\|' ){` |
|  7597469 |  879 | `			j++;` |
|        5 |  880 | `		}` |
|  1578626 |  881 | `		if( j - i == nTok && SyMemcmp(&zType[i],zTok,(sxu32)nTok) == 0 ){` |
|   146678 |  882 | `			return 1;` |
|        - |  883 | `		}` |
|  1431953 |  884 | `		i = j + 1;` |
|        5 |  885 | `	}` |
|  1297987 |  886 | `	return 0;` |
|   722791 |  887 | `}` |
|        - |  888 | `/*` |
...
|        - |  949 | ` */` |
|   930180 |  950 | `PH7_PRIVATE sxi32 VmEnforceBuiltinArgTypes(` |
...
|   930185 |  965 | `	const char *zSig = pFunc->zSig;` |
|        - |  966 | `	const char *zCur, *zEnd;` |
|   930185 |  967 | `	int iArg = 0;` |
|   930185 |  968 | `	if( zSig == 0 ){` |
|   174553 |  969 | `		return SXRET_OK;` |
|        - |  970 | `	}` |
|  1511265 |  971 | `	for( iArg = 0 ; iArg < (int)SX_ARRAYSIZE(azSelfChecked) ; ++iArg ){` |
|  1133805 |  972 | `		if( SyStrncmp(pFunc->sName.zString,azSelfChecked[iArg],` |
|  1133805 |  973 | `			(sxu32)SyStrlen(azSelfChecked[iArg])) == 0` |
|   378180 |  974 | `		 && pFunc->sName.nByte == SyStrlen(azSelfChecked[iArg]) ){` |
|        5 |  975 | `			return SXRET_OK;` |
|        - |  976 | `		}` |
|   378176 |  977 | `	}` |
|   755633 |  978 | `	iArg = 0;` |
|   755633 |  979 | `	zCur = zSig;` |
|   755633 |  980 | `	zEnd = &zSig[SyStrlen(zSig)];` |
|  2157380 |  981 | `	while( zCur < zEnd && iArg < nGiven ){` |
...
|  2072519 |  987 | `		while( zCur < zEnd && zCur[0] == ' ' ){` |
|   668694 |  988 | `			zCur++;` |
|        5 |  989 | `		}` |
|  1403830 |  990 | `		zStop = zCur;` |
| 22304732 |  991 | `		while( zStop < zEnd && zStop[0] != ',' ){` |
| 20900907 |  992 | `			zStop++;` |
|        5 |  993 | `		}` |
|  1403830 |  994 | `		zName = zCur;` |
| 10332529 |  995 | `		while( zName < zStop && zName[0] != '$' ){` |
|  8928704 |  996 | `			zName++;` |
|        5 |  997 | `		}` |
|  1403830 |  998 | `		if( zName >= zStop ){` |
|        7 |  999 | `			break; /* malformed / no parameter name — stop screening */` |
|        - | 1000 | `		}` |
|  1403824 | 1001 | `		if( zName >= zCur + 3 && SyMemcmp(zName - 3,"...",3) == 0 ){` |
|     1905 | 1002 | `			break; /* variadic tail: stop (its type applies to the rest) */` |
|        - | 1003 | `		}` |
|  1401924 | 1004 | `		zType = zCur;` |
|  1401924 | 1005 | `		nType = (int)(zName - zCur);` |
|        - | 1006 | `		/* Trim the trailing spaces and the by-ref marker of "array &$array" */` |
|  3473739 | 1007 | `		while( nType > 0 && (zType[nType-1] == ' ' \|\| zType[nType-1] == '&') ){` |
|  1370402 | 1008 | `			nType--;` |
|        5 | 1009 | `		}` |
|  1401924 | 1010 | `		zName++; /* skip '$' */` |
|  1401924 | 1011 | `		nName = 0;` |
| 10154062 | 1012 | `		while( &zName[nName] < zStop && zName[nName] != ' ' && zName[nName] != '=' ){` |
|  8752143 | 1013 | `			nName++;` |
|        5 | 1014 | `		}` |
|  1401924 | 1015 | `		pArg = apArg[iArg];` |
|  1401924 | 1016 | `		if( nType > 0 && !VmSigTypeHas(zType,nType,"mixed") ){` |
|  1296211 | 1017 | `			const char *zGiven = 0;` |
|  1296211 | 1018 | `			if( (pArg->iFlags & MEMOBJ_HASHMAP) != 0 ){` |
|    73874 | 1019 | `				if( !VmSigTypeHas(zType,nType,"array")` |
|    37012 | 1020 | `				 && !VmSigTypeHas(zType,nType,"iterable")` |
|      155 | 1021 | `				 && !VmSigTypeHas(zType,nType,"callable") ){` |
|      119 | 1022 | `					zGiven = "array";` |
|       62 | 1023 | `				}` |
|  1259274 | 1024 | `			}else if( (pArg->iFlags & MEMOBJ_OBJ) != 0 ){` |
...
|       28 | 1037 | `					}` |
|       57 | 1038 | `				}` |
|  1221593 | 1039 | `			}else if( (pArg->iFlags & MEMOBJ_RES) != 0 ){` |
...
|        - | 1055 | `			}` |
|   648423 | 1056 | `		}` |
|  1401752 | 1057 | `		zCur = (zStop < zEnd) ? zStop + 1 : zEnd;` |
|  1401752 | 1058 | `		iArg++;` |
|        5 | 1059 | `	}` |
|   755461 | 1060 | `	return SXRET_OK;` |
|   465452 | 1061 | `}` |
...
|        - | 1240 | ` */` |
|    23140 | 1241 | `PH7_PRIVATE void VmExpandConstantWithNotice(ph7_vm *pVm,ph7_constant *pCons,ph7_value *pOut)` |
|        5 | 1242 | `{` |
|    23145 | 1243 | `	if( SySetUsed(&pCons->aAttrs) > 0 ){` |
|        7 | 1244 | `		VmDeprecatedAttrNoticeSubject(pVm,&pCons->aAttrs,"Constant",0,&pCons->sName);` |
|        3 | 1245 | `	}` |
|    23145 | 1246 | `	pCons->xExpand(pOut,pCons->pUserData);` |
|    23145 | 1247 | `}` |
|        - | 1248 | `/*` |
