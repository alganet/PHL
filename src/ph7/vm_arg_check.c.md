...
|        - |  330 | ` */` |
|     3408 |  331 | `PH7_PRIVATE void VmSetBuiltinArity(ph7_vm *pVm)` |
|        5 |  332 | `{` |
|        - |  333 | `	sxu32 n;` |
|   920165 |  334 | `	for( n = 0 ; n < SX_ARRAYSIZE(aBuiltinArity) ; ++n ){` |
|   916757 |  335 | `		const struct VmBuiltinArity *p = &aBuiltinArity[n];` |
|  1833509 |  336 | `		SyHashEntry *pEntry = SyHashGet(&pVm->hHostFunction,` |
|   916752 |  337 | `			(const void *)p->zName,SyStrlen(p->zName));` |
|   916757 |  338 | `		if( pEntry ){` |
|   916757 |  339 | `			ph7_user_func *pFunc = (ph7_user_func *)pEntry->pUserData;` |
|   916757 |  340 | `			pFunc->nMinArg  = p->nMin;` |
|   916757 |  341 | `			pFunc->bAtLeast = p->bAtLeast;` |
|   458376 |  342 | `		}` |
|   458381 |  343 | `	}` |
|     3413 |  344 | `}` |
|        - |  345 | `/*` |
...
|        - |  833 | ` */` |
|  1519968 |  834 | `static void VmDeriveArityFromSig(const char *zSig,sxi16 *pnMin,sxu8 *pbAtLeast,sxi16 *pnMax,sxu8 *pbHasMax)` |
|        5 |  835 | `{` |
|  1519973 |  836 | `	const char *zCur = zSig;` |
|  1519973 |  837 | `	int nMin = 0, bAtLeast = 0, bSeen = 0, bOptional = 0;` |
|  1519973 |  838 | `	int nTotal = 0, bVariadic = 0;` |
| 23358432 |  839 | `	for(;;){` |
| 48073253 |  840 | `		if( zCur[0] == '\0' \|\| zCur[0] == ',' ){` |
|  2876357 |  841 | `			if( bSeen ){` |
|  2705957 |  842 | `				nTotal++;` |
|  2705957 |  843 | `				if( bOptional ){` |
|  1063301 |  844 | `					bAtLeast = 1;` |
|   531653 |  845 | `				}else{` |
|  1642661 |  846 | `					nMin++;` |
|        - |  847 | `				}` |
|  1352976 |  848 | `			}` |
|  2876357 |  849 | `			if( zCur[0] == '\0' ){` |
|  1519973 |  850 | `				break;` |
|        - |  851 | `			}` |
|  1356389 |  852 | `			bSeen = bOptional = 0;` |
|  1356389 |  853 | `			zCur++;` |
|  1356389 |  854 | `			continue;` |
|        - |  855 | `		}` |
| 45196901 |  856 | `		if( zCur[0] != ' ' ){` |
| 39243125 |  857 | `			bSeen = 1;` |
| 19621560 |  858 | `		}` |
| 45196901 |  859 | `		if( zCur[0] == '=' \|\| (zCur[0] == '.' && zCur[1] == '.' && zCur[2] == '.') ){` |
|  1134869 |  860 | `			bOptional = 1;` |
|   567432 |  861 | `		}` |
| 45196901 |  862 | `		if( zCur[0] == '.' && zCur[1] == '.' && zCur[2] == '.' ){` |
|    71573 |  863 | `			bVariadic = 1;` |
|    35784 |  864 | `		}` |
| 45196901 |  865 | `		zCur++;` |
|        5 |  866 | `	}` |
|  1519973 |  867 | `	*pnMin = (sxi16)nMin;` |
|  1519973 |  868 | `	*pbAtLeast = (sxu8)bAtLeast;` |
...
|  1519973 |  872 | `	*pnMax = (sxi16)nTotal;` |
|  1519973 |  873 | `	*pbHasMax = (sxu8)(bVariadic ? 0 : 1);` |
|  1519973 |  874 | `}` |
|        - |  875 | `/*` |
...
|        - |  879 | ` */` |
|  1454726 |  880 | `static int VmSigTypeHas(const char *zType,int nType,const char *zTok)` |
|        5 |  881 | `{` |
|  1454731 |  882 | `	int nTok = (int)SyStrlen(zTok);` |
|  1454731 |  883 | `	int i = 0;` |
|  1454731 |  884 | `	if( zType[0] == '?' ){` |
|   275403 |  885 | `		zType++;` |
|   275403 |  886 | `		nType--;` |
|   137699 |  887 | `	}` |
|  2895166 |  888 | `	while( i < nType ){` |
|  1589331 |  889 | `		int j = i;` |
|  9237584 |  890 | `		while( j < nType && zType[j] != '\|' ){` |
|  7648258 |  891 | `			j++;` |
|        5 |  892 | `		}` |
|  1589331 |  893 | `		if( j - i == nTok && SyMemcmp(&zType[i],zTok,(sxu32)nTok) == 0 ){` |
|   148896 |  894 | `			return 1;` |
|        - |  895 | `		}` |
|  1440440 |  896 | `		i = j + 1;` |
|        5 |  897 | `	}` |
|  1305840 |  898 | `	return 0;` |
|   727834 |  899 | `}` |
|        - |  900 | `/*` |
...
|        - |  961 | ` */` |
|   935822 |  962 | `PH7_PRIVATE sxi32 VmEnforceBuiltinArgTypes(` |
...
|   935827 |  977 | `	const char *zSig = pFunc->zSig;` |
|        - |  978 | `	const char *zCur, *zEnd;` |
|   935827 |  979 | `	int iArg = 0;` |
|   935827 |  980 | `	if( zSig == 0 ){` |
|   175311 |  981 | `		return SXRET_OK;` |
|        - |  982 | `	}` |
|  1521033 |  983 | `	for( iArg = 0 ; iArg < (int)SX_ARRAYSIZE(azSelfChecked) ; ++iArg ){` |
|  1141138 |  984 | `		if( SyStrncmp(pFunc->sName.zString,azSelfChecked[iArg],` |
|  1141138 |  985 | `			(sxu32)SyStrlen(azSelfChecked[iArg])) == 0` |
|   380629 |  986 | `		 && pFunc->sName.nByte == SyStrlen(azSelfChecked[iArg]) ){` |
|        5 |  987 | `			return SXRET_OK;` |
|        - |  988 | `		}` |
|   380625 |  989 | `	}` |
|   760517 |  990 | `	iArg = 0;` |
|   760517 |  991 | `	zCur = zSig;` |
|   760517 |  992 | `	zEnd = &zSig[SyStrlen(zSig)];` |
|  2171239 |  993 | `	while( zCur < zEnd && iArg < nGiven ){` |
...
|  2085605 |  999 | `		while( zCur < zEnd && zCur[0] == ' ' ){` |
|   672731 | 1000 | `			zCur++;` |
|        5 | 1001 | `		}` |
|  1412879 | 1002 | `		zStop = zCur;` |
| 22447900 | 1003 | `		while( zStop < zEnd && zStop[0] != ',' ){` |
| 21035026 | 1004 | `			zStop++;` |
|        5 | 1005 | `		}` |
|  1412879 | 1006 | `		zName = zCur;` |
| 10401664 | 1007 | `		while( zName < zStop && zName[0] != '$' ){` |
|  8988790 | 1008 | `			zName++;` |
|        5 | 1009 | `		}` |
|  1412879 | 1010 | `		if( zName >= zStop ){` |
|        7 | 1011 | `			break; /* malformed / no parameter name — stop screening */` |
|        - | 1012 | `		}` |
|  1412873 | 1013 | `		if( zName >= zCur + 3 && SyMemcmp(zName - 3,"...",3) == 0 ){` |
|     1937 | 1014 | `			break; /* variadic tail: stop (its type applies to the rest) */` |
|        - | 1015 | `		}` |
|  1410941 | 1016 | `		zType = zCur;` |
|  1410941 | 1017 | `		nType = (int)(zName - zCur);` |
|        - | 1018 | `		/* Trim the trailing spaces and the by-ref marker of "array &$array" */` |
|  3496900 | 1019 | `		while( nType > 0 && (zType[nType-1] == ' ' \|\| zType[nType-1] == '&') ){` |
|  1380029 | 1020 | `			nType--;` |
|        5 | 1021 | `		}` |
|  1410941 | 1022 | `		zName++; /* skip '$' */` |
|  1410941 | 1023 | `		nName = 0;` |
| 10215283 | 1024 | `		while( &zName[nName] < zStop && zName[nName] != ' ' && zName[nName] != '=' ){` |
|  8804347 | 1025 | `			nName++;` |
|        5 | 1026 | `		}` |
|  1410941 | 1027 | `		pArg = apArg[iArg];` |
|  1410941 | 1028 | `		if( nType > 0 && !VmSigTypeHas(zType,nType,"mixed") ){` |
|  1303966 | 1029 | `			const char *zGiven = 0;` |
|  1303966 | 1030 | `			if( (pArg->iFlags & MEMOBJ_HASHMAP) != 0 ){` |
|    74108 | 1031 | `				if( !VmSigTypeHas(zType,nType,"array")` |
|    37129 | 1032 | `				 && !VmSigTypeHas(zType,nType,"iterable")` |
|      155 | 1033 | `				 && !VmSigTypeHas(zType,nType,"callable") ){` |
|      119 | 1034 | `					zGiven = "array";` |
|       62 | 1035 | `				}` |
|  1266912 | 1036 | `			}else if( (pArg->iFlags & MEMOBJ_OBJ) != 0 ){` |
...
|       28 | 1049 | `					}` |
|       57 | 1050 | `				}` |
|  1229068 | 1051 | `			}else if( (pArg->iFlags & MEMOBJ_NULL) != 0 ){` |
...
|     4990 | 1058 | `				if( zType[0] != '?'` |
|     2521 | 1059 | `				 && !VmSigTypeHas(zType,nType,"null")` |
|       55 | 1060 | `				 && !VmSigTypeHas(zType,nType,"callable") ){` |
|       46 | 1061 | `					zGiven = "null";` |
|       26 | 1062 | `				}` |
|  1225783 | 1063 | `			}else if( (pArg->iFlags & MEMOBJ_RES) != 0 ){` |
...
|        - | 1079 | `			}` |
|   652284 | 1080 | `		}` |
|  1410727 | 1081 | `		zCur = (zStop < zEnd) ? zStop + 1 : zEnd;` |
|  1410727 | 1082 | `		iArg++;` |
|        5 | 1083 | `	}` |
|   760303 | 1084 | `	return SXRET_OK;` |
|   468280 | 1085 | `}` |
|        - | 1086 | `/*` |
...
|        - | 1093 | ` */` |
|  1519968 | 1094 | `static int VmBuiltinSelfValidatesArity(const char *zName)` |
|        5 | 1095 | `{` |
|        - | 1096 | `	static const char *const azSelf[] = { "rand", "mt_rand" };` |
|        - | 1097 | `	sxu32 i;` |
|  4549685 | 1098 | `	for( i = 0 ; i < SX_ARRAYSIZE(azSelf) ; i++ ){` |
|  3036533 | 1099 | `		sxu32 nSelf = SyStrlen(azSelf[i]);` |
|  3036533 | 1100 | `		if( SyStrlen(zName) == nSelf && SyStrncmp(zName,azSelf[i],nSelf) == 0 ){` |
|     6821 | 1101 | `			return 1;` |
|        - | 1102 | `		}` |
|  1514861 | 1103 | `	}` |
|  1513157 | 1104 | `	return 0;` |
|   759989 | 1105 | `}` |
|     3408 | 1106 | `PH7_PRIVATE void VmSetBuiltinSignatures(ph7_vm *pVm)` |
|        5 | 1107 | `{` |
|        - | 1108 | `	sxu32 n;` |
|  1564277 | 1109 | `	for( n = 0 ; n < SX_ARRAYSIZE(aBuiltinSig) ; n++ ){` |
|  2341301 | 1110 | `		SyHashEntry *pEntry = SyHashGet(&pVm->hHostFunction,` |
|  1560864 | 1111 | `			(const void *)aBuiltinSig[n].zName,(sxu32)SyStrlen(aBuiltinSig[n].zName));` |
|  1560869 | 1112 | `		if( pEntry ){` |
|  1519973 | 1113 | `			ph7_user_func *pFunc = (ph7_user_func *)pEntry->pUserData;` |
|  1519973 | 1114 | `			sxi16 nMin = 0, nMax = 0;` |
|  1519973 | 1115 | `			sxu8 bAtLeast = 0, bHasMax = 0;` |
|  1519973 | 1116 | `			pFunc->zSig = aBuiltinSig[n].zSig;` |
|  1519973 | 1117 | `			pFunc->zRet = aBuiltinSig[n].zRet[0] ? aBuiltinSig[n].zRet : 0;` |
|  1519973 | 1118 | `			VmDeriveArityFromSig(pFunc->zSig,&nMin,&bAtLeast,&nMax,&bHasMax);` |
...
|  1519973 | 1121 | `			pFunc->nMaxArg = nMax;` |
|  1519973 | 1122 | `			pFunc->bHasMaxArg = (sxu8)(VmBuiltinSelfValidatesArity(aBuiltinSig[n].zName) ? 0 : bHasMax);` |
|  1519973 | 1123 | `			if( pFunc->nMinArg < 1 ){` |
...
|   637301 | 1126 | `				pFunc->nMinArg = nMin;` |
|   637301 | 1127 | `				pFunc->bAtLeast = bAtLeast;` |
|   318648 | 1128 | `			}` |
|   759984 | 1129 | `		}` |
|   780437 | 1130 | `	}` |
|     3413 | 1131 | `}` |
...
|       84 | 1248 | `}` |
|    19830 | 1249 | `PH7_PRIVATE void PH7_VmThrowWarningFmt(ph7_vm *pVm,const char *zFmt,...)` |
|        5 | 1250 | `{` |
|        - | 1251 | `	va_list ap;` |
|    19835 | 1252 | `	va_start(ap,zFmt);` |
|    19835 | 1253 | `	PH7_VmThrowErrorAp(pVm,0,PH7_CTX_WARNING,zFmt,ap);` |
|    19835 | 1254 | `	va_end(ap);` |
|    19835 | 1255 | `}` |
|        - | 1256 | `/*` |
...
|        - | 1292 | ` */` |
|    23264 | 1293 | `PH7_PRIVATE void VmExpandConstantWithNotice(ph7_vm *pVm,ph7_constant *pCons,ph7_value *pOut)` |
|        5 | 1294 | `{` |
|    23269 | 1295 | `	if( SySetUsed(&pCons->aAttrs) > 0 ){` |
|        7 | 1296 | `		VmDeprecatedAttrNoticeSubject(pVm,&pCons->aAttrs,"Constant",0,&pCons->sName);` |
|        3 | 1297 | `	}` |
|    23269 | 1298 | `	pCons->xExpand(pOut,pCons->pUserData);` |
|    23269 | 1299 | `}` |
|        - | 1300 | `/*` |
