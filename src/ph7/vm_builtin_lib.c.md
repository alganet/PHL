...
|    - | 1017 | `    "}"` |
|    - | 1018 |  |
| 3894 | 1019 | `PH7_PRIVATE sxi32 PH7_VmInstallBuiltinLib(ph7_vm *pVm)` |
|    5 | 1020 | `{` |
|    - | 1021 | `	SyString sBuiltin;` |
|    - | 1022 | `	SyString sRandom;` |
| 3899 | 1023 | `	SyStringInitFromBuf(&sBuiltin,PH7_BUILTIN_LIB,sizeof(PH7_BUILTIN_LIB)-1);` |
|    - | 1024 | `	/* Compile the built-in library */` |
| 3899 | 1025 | `	VmEvalChunk(&(*pVm),0,&sBuiltin,PH7_PHP_ONLY,FALSE);` |
...
| 3899 | 1037 | `		SyStringInitFromBuf(&sRandom,zRandomLib,sizeof(zRandomLib)-1);` |
| 3899 | 1038 | `		VmEvalChunk(&(*pVm),0,&sRandom,PH7_PHP_ONLY,FALSE);` |
|    - | 1039 | `	}` |
| 3899 | 1040 | `	return SXRET_OK;` |
|    5 | 1041 | `}` |
|    - | 1042 |  |
