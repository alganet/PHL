...
|     - |   54 |  |
|   242 |   55 | `static pcre2_code *PcreCache_Find(const char *zPattern, sxu32 nLen, sxu32 *pCaptureCount)` |
|     5 |   56 | `{` |
|     - |   57 | `	sxu32 i;` |
|  1747 |   58 | `	for( i = 0; i < nCacheUsed; i++ ){` |
...
|   126 |   68 | `}` |
|     - |   69 |  |
|    70 |   70 | `static void PcreCache_Insert(const char *zPattern, sxu32 nLen, pcre2_code *pCode, sxu32 nCaptureCount)` |
|     5 |   71 | `{` |
|     - |   72 | `	PcreCacheEntry *pEntry;` |
|     - |   73 | `	char *zCopy;` |
|     - |   74 | `	/* Allocate the pattern copy first, before touching the cache */` |
|    75 |   75 | `	zCopy = (char *)malloc(nLen + 1);` |
|    75 |   76 | `	if( zCopy == 0 ){` |
|     - |   77 | `		/* OOM — pCode is not cached; it leaks but remains usable by the caller */` |
|   ! 0 |   78 | `		return;` |
|     - |   79 | `	}` |
|    75 |   80 | `	SyMemcpy(zPattern, zCopy, nLen);` |
|    75 |   81 | `	zCopy[nLen] = 0;` |
|    75 |   82 | `	if( nCacheUsed < PCRE_CACHE_SIZE ){` |
...
|     - |   98 | `	}` |
|    75 |   99 | `	pEntry->zPattern = zCopy;` |
|    75 |  100 | `	pEntry->nLen = nLen;` |
|    75 |  101 | `	pEntry->pCode = pCode;` |
|    75 |  102 | `	pEntry->nCaptureCount = nCaptureCount;` |
|    75 |  103 | `	pEntry->iLastUsed = ++iCacheClock;` |
|    40 |  104 | `}` |
|     - |  105 |  |
...
|    75 |  131 | `	if( SyisAlphaNum(cOpen) \|\| cOpen == '\\' \|\| (unsigned char)cOpen <= 0x20 ){` |
...
|    75 |  140 | `		default:  cClose = cOpen; break;` |
|     - |  141 | `	}` |
|    75 |  142 | `	z++; /* Skip opening delimiter */` |
|    75 |  143 | `	pStart = z;` |
|     - |  144 | `	/* Scan for closing delimiter, respecting backslash escapes */` |
|  1019 |  145 | `	while( z < zEnd ){` |
|  1019 |  146 | `		if( *z == '\\' && z + 1 < zEnd ){` |
...
|     - |  157 | `	}` |
|    75 |  158 | `	*pPattern = pStart;` |
|    75 |  159 | `	*pnPatternLen = (int)(z - pStart);` |
|    75 |  160 | `	z++; /* Skip closing delimiter */` |
|    75 |  161 | `	*pFlags = z;` |
|    75 |  162 | `	*pnFlagLen = (int)(zEnd - z);` |
|    75 |  163 | `	return PH7_OK;` |
|    40 |  164 | `}` |
|     - |  165 |  |
|     - |  166 | `/* ===== Flag mapper ===== */` |
|    70 |  167 | `static sxi32 PcreMapFlags(` |
|     - |  168 | `	const char *zFlags, int nFlagLen,` |
|     - |  169 | `	uint32_t *pCompileOpts)` |
|     5 |  170 | `{` |
|     - |  171 | `	int i;` |
|    75 |  172 | `	*pCompileOpts = 0;` |
|    91 |  173 | `	for( i = 0; i < nFlagLen; i++ ){` |
...
|     - |  186 | `		}` |
|     9 |  187 | `	}` |
|    75 |  188 | `	return PH7_OK;` |
|     5 |  189 | `}` |
|     - |  190 |  |
|     - |  191 | `/* ===== Compile helper ===== */` |
|   242 |  192 | `static pcre2_code *PcreCompile(` |
...
|   247 |  207 | `	pCode = PcreCache_Find(zFullPattern, (sxu32)nLen, pCaptureCount);` |
|   247 |  208 | `	if( pCode ){` |
|   173 |  209 | `		return pCode;` |
|     - |  210 | `	}` |
|     - |  211 | `	/* Parse delimiter */` |
|    75 |  212 | `	parseRc = PcreParsePattern(zFullPattern, nLen, &zPat, &nPatLen, &zFlags, &nFlagLen);` |
|    75 |  213 | `	if( parseRc != PCRE_PARSE_OK ){` |
|     - |  214 | `		const char *zMsg;` |
...
|     - |  223 | `	}` |
|     - |  224 | `	/* Map flags */` |
|    75 |  225 | `	PcreMapFlags(zFlags, nFlagLen, &compileOpts);` |
|     - |  226 | `	/* Compile */` |
|    75 |  227 | `	pCode = pcre2_compile(` |
|    35 |  228 | `		(PCRE2_SPTR)zPat, (PCRE2_SIZE)nPatLen,` |
|    35 |  229 | `		compileOpts, &errcode, &erroffset, NULL);` |
|    75 |  230 | `	if( pCode == 0 ){` |
...
|    75 |  239 | `	nCapture = 0;` |
|    75 |  240 | `	pcre2_pattern_info(pCode, PCRE2_INFO_CAPTURECOUNT, &nCapture);` |
|    75 |  241 | `	if( pCaptureCount ){` |
|    75 |  242 | `		*pCaptureCount = nCapture;` |
|    35 |  243 | `	}` |
|     - |  244 | `	/* Cache it */` |
|    75 |  245 | `	PcreCache_Insert(zFullPattern, (sxu32)nLen, pCode, nCapture);` |
|    75 |  246 | `	pCtx->pVm->iPcreLastError = PHP_PREG_NO_ERROR;` |
|    75 |  247 | `	return pCode;` |
|   126 |  248 | `}` |
|     - |  249 |  |
...
|     - | 1313 | `};` |
|     - | 1314 |  |
|  3538 | 1315 | `PH7_PRIVATE void PH7_RegisterPcreFunctions(ph7_vm *pVm)` |
|     5 | 1316 | `{` |
|     - | 1317 | `	sxu32 n;` |
| 31847 | 1318 | `	for( n = 0; n < SX_ARRAYSIZE(aPcreFunc); n++ ){` |
| 28309 | 1319 | `		ph7_create_function(&(*pVm), aPcreFunc[n].zName, aPcreFunc[n].xFunc, 0);` |
| 14157 | 1320 | `	}` |
|  3543 | 1321 | `}` |
|     - | 1322 |  |
...
|     - | 1343 |  |
|  3538 | 1344 | `PH7_PRIVATE void PH7_RegisterPcreConstants(ph7_vm *pVm)` |
|     5 | 1345 | `{` |
|  3543 | 1346 | `	ph7_create_constant(&(*pVm), "PREG_PATTERN_ORDER",        PcreConst_PREG_PATTERN_ORDER, 0);` |
|  3543 | 1347 | `	ph7_create_constant(&(*pVm), "PREG_SET_ORDER",            PcreConst_PREG_SET_ORDER, 0);` |
|  3543 | 1348 | `	ph7_create_constant(&(*pVm), "PREG_OFFSET_CAPTURE",       PcreConst_PREG_OFFSET_CAPTURE, 0);` |
|  3543 | 1349 | `	ph7_create_constant(&(*pVm), "PREG_UNMATCHED_AS_NULL",    PcreConst_PREG_UNMATCHED_AS_NULL, 0);` |
|  3543 | 1350 | `	ph7_create_constant(&(*pVm), "PREG_SPLIT_NO_EMPTY",       PcreConst_PREG_SPLIT_NO_EMPTY, 0);` |
|  3543 | 1351 | `	ph7_create_constant(&(*pVm), "PREG_SPLIT_DELIM_CAPTURE",  PcreConst_PREG_SPLIT_DELIM_CAPTURE, 0);` |
|  3543 | 1352 | `	ph7_create_constant(&(*pVm), "PREG_SPLIT_OFFSET_CAPTURE", PcreConst_PREG_SPLIT_OFFSET_CAPTURE, 0);` |
|  3543 | 1353 | `	ph7_create_constant(&(*pVm), "PREG_NO_ERROR",             PcreConst_PREG_NO_ERROR, 0);` |
|  3543 | 1354 | `	ph7_create_constant(&(*pVm), "PREG_INTERNAL_ERROR",       PcreConst_PREG_INTERNAL_ERROR, 0);` |
|  3543 | 1355 | `	ph7_create_constant(&(*pVm), "PREG_BACKTRACK_LIMIT_ERROR", PcreConst_PREG_BACKTRACK_LIMIT_ERROR, 0);` |
|  3543 | 1356 | `	ph7_create_constant(&(*pVm), "PREG_RECURSION_LIMIT_ERROR", PcreConst_PREG_RECURSION_LIMIT_ERROR, 0);` |
|  3543 | 1357 | `	ph7_create_constant(&(*pVm), "PREG_BAD_UTF8_ERROR",       PcreConst_PREG_BAD_UTF8_ERROR, 0);` |
|  3543 | 1358 | `	ph7_create_constant(&(*pVm), "PREG_BAD_UTF8_OFFSET_ERROR",PcreConst_PREG_BAD_UTF8_OFFSET_ERROR, 0);` |
|  3543 | 1359 | `	ph7_create_constant(&(*pVm), "PREG_JIT_STACKLIMIT_ERROR", PcreConst_PREG_JIT_STACKLIMIT_ERROR, 0);` |
|  3543 | 1360 | `}` |
|     - | 1361 |  |
|     - | 1362 | `#else` |
