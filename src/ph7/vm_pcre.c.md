...
|    16 | 1041 | `		PH7_VmCallUserFunction(pCtx->pVm, apArg[1], 1, apCbArg, &sResult);` |
|     - | 1042 | `		/* Get replacement string from callback result */` |
|    16 | 1043 | `		zReplacement = ph7_value_to_string(&sResult, &nReplLen);` |
|    16 | 1044 | `		SyBlobAppend(&sOut, zReplacement, (sxu32)nReplLen);` |
|    16 | 1045 | `		PH7_MemObjRelease(&sResult);` |
|    16 | 1046 | `		ph7_context_release_value(pCtx, pMatchArr);` |
|    16 | 1047 | `		count++;` |
|     - | 1048 | `		/* Advance */` |
|    16 | 1049 | `		if( ovector[1] == ovector[0] ){` |
|   ! 0 | 1050 | `			if( startOffset < (PCRE2_SIZE)nSubLen ){` |
|   ! 0 | 1051 | `				SyBlobAppend(&sOut, &zSubject[startOffset], 1);` |
|   ! 0 | 1052 | `			}` |
|   ! 0 | 1053 | `			startOffset = ovector[0] + 1;` |
|   ! 0 | 1054 | `		}else{` |
|    16 | 1055 | `			startOffset = ovector[1];` |
|     - | 1056 | `		}` |
|     2 | 1057 | `	}` |
|     - | 1058 | `	/* Copy remainder */` |
|     8 | 1059 | `	if( startOffset < (PCRE2_SIZE)nSubLen ){` |
|   ! 0 | 1060 | `		SyBlobAppend(&sOut, &zSubject[startOffset], (sxu32)(nSubLen - startOffset));` |
|   ! 0 | 1061 | `	}` |
|     8 | 1062 | `	ph7_result_string(pCtx, (const char *)SyBlobData(&sOut), (int)SyBlobLength(&sOut));` |
|     8 | 1063 | `	SyBlobRelease(&sOut);` |
|     8 | 1064 | `	pcre2_match_data_free(pMatchData);` |
...
|     - | 1157 | `};` |
|     - | 1158 |  |
|  2692 | 1159 | `PH7_PRIVATE void PH7_RegisterPcreFunctions(ph7_vm *pVm)` |
|     2 | 1160 |  |
|     - | 1161 | `	sxu32 n;` |
| 24230 | 1162 | `	for( n = 0; n < SX_ARRAYSIZE(aPcreFunc); n++ ){` |
| 21538 | 1163 | `		ph7_create_function(&(*pVm), aPcreFunc[n].zName, aPcreFunc[n].xFunc, 0);` |
| 10770 | 1164 | `	}` |
|  2694 | 1165 |  |
|     - | 1166 |  |
...
|     - | 1187 |  |
|  2692 | 1188 | `PH7_PRIVATE void PH7_RegisterPcreConstants(ph7_vm *pVm)` |
|     2 | 1189 |  |
|  2694 | 1190 | `	ph7_create_constant(&(*pVm), "PREG_PATTERN_ORDER",        PcreConst_PREG_PATTERN_ORDER, 0);` |
|  2694 | 1191 | `	ph7_create_constant(&(*pVm), "PREG_SET_ORDER",            PcreConst_PREG_SET_ORDER, 0);` |
|  2694 | 1192 | `	ph7_create_constant(&(*pVm), "PREG_OFFSET_CAPTURE",       PcreConst_PREG_OFFSET_CAPTURE, 0);` |
|  2694 | 1193 | `	ph7_create_constant(&(*pVm), "PREG_UNMATCHED_AS_NULL",    PcreConst_PREG_UNMATCHED_AS_NULL, 0);` |
|  2694 | 1194 | `	ph7_create_constant(&(*pVm), "PREG_SPLIT_NO_EMPTY",       PcreConst_PREG_SPLIT_NO_EMPTY, 0);` |
|  2694 | 1195 | `	ph7_create_constant(&(*pVm), "PREG_SPLIT_DELIM_CAPTURE",  PcreConst_PREG_SPLIT_DELIM_CAPTURE, 0);` |
|  2694 | 1196 | `	ph7_create_constant(&(*pVm), "PREG_SPLIT_OFFSET_CAPTURE", PcreConst_PREG_SPLIT_OFFSET_CAPTURE, 0);` |
|  2694 | 1197 | `	ph7_create_constant(&(*pVm), "PREG_NO_ERROR",             PcreConst_PREG_NO_ERROR, 0);` |
|  2694 | 1198 | `	ph7_create_constant(&(*pVm), "PREG_INTERNAL_ERROR",       PcreConst_PREG_INTERNAL_ERROR, 0);` |
|  2694 | 1199 | `	ph7_create_constant(&(*pVm), "PREG_BACKTRACK_LIMIT_ERROR", PcreConst_PREG_BACKTRACK_LIMIT_ERROR, 0);` |
|  2694 | 1200 | `	ph7_create_constant(&(*pVm), "PREG_RECURSION_LIMIT_ERROR", PcreConst_PREG_RECURSION_LIMIT_ERROR, 0);` |
|  2694 | 1201 | `	ph7_create_constant(&(*pVm), "PREG_BAD_UTF8_ERROR",       PcreConst_PREG_BAD_UTF8_ERROR, 0);` |
|  2694 | 1202 | `	ph7_create_constant(&(*pVm), "PREG_BAD_UTF8_OFFSET_ERROR",PcreConst_PREG_BAD_UTF8_OFFSET_ERROR, 0);` |
|  2694 | 1203 | `	ph7_create_constant(&(*pVm), "PREG_JIT_STACKLIMIT_ERROR", PcreConst_PREG_JIT_STACKLIMIT_ERROR, 0);` |
|  2694 | 1204 |  |
|     - | 1205 |  |
|     - | 1206 | `#else` |
