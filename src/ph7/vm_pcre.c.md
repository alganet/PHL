...
|     - |   54 |  |
|    32 |   55 | `static pcre2_code *PcreCache_Find(const char *zPattern, sxu32 nLen, sxu32 *pCaptureCount)` |
|     2 |   56 |  |
|     - |   57 | `	sxu32 i;` |
|   178 |   58 | `	for( i = 0; i < nCacheUsed; i++ ){` |
|   152 |   59 | `		if( aCache[i].nLen == nLen && SyMemcmp(aCache[i].zPattern, zPattern, nLen) == 0 ){` |
...
|    18 |   68 |  |
|     - |   69 |  |
|    26 |   70 | `static void PcreCache_Insert(const char *zPattern, sxu32 nLen, pcre2_code *pCode, sxu32 nCaptureCount)` |
|     2 |   71 |  |
|     - |   72 | `	PcreCacheEntry *pEntry;` |
|     - |   73 | `	char *zCopy;` |
|     - |   74 | `	/* Allocate the pattern copy first, before touching the cache */` |
|    28 |   75 | `	zCopy = (char *)malloc(nLen + 1);` |
|    28 |   76 | `	if( zCopy == 0 ){` |
|     - |   77 | `		/* OOM — pCode is not cached; it leaks but remains usable by the caller */` |
|   ! 0 |   78 | `		return;` |
|     - |   79 | `	}` |
|    28 |   80 | `	SyMemcpy(zPattern, zCopy, nLen);` |
|    28 |   81 | `	zCopy[nLen] = 0;` |
|    28 |   82 | `	if( nCacheUsed < PCRE_CACHE_SIZE ){` |
|    28 |   83 | `		pEntry = &aCache[nCacheUsed++];` |
|    15 |   84 | `	}else{` |
|     - |   85 | `		/* Evict LRU */` |
...
|     - |   98 | `	}` |
|    28 |   99 | `	pEntry->zPattern = zCopy;` |
|    28 |  100 | `	pEntry->nLen = nLen;` |
|    28 |  101 | `	pEntry->pCode = pCode;` |
|    28 |  102 | `	pEntry->nCaptureCount = nCaptureCount;` |
|    28 |  103 | `	pEntry->iLastUsed = ++iCacheClock;` |
|    15 |  104 |  |
|     - |  105 |  |
...
|    28 |  131 | `	if( SyisAlphaNum(cOpen) \|\| cOpen == '\\' \|\| (unsigned char)cOpen <= 0x20 ){` |
...
|    28 |  140 | `		default:  cClose = cOpen; break;` |
|     - |  141 | `	}` |
|    28 |  142 | `	z++; /* Skip opening delimiter */` |
|    28 |  143 | `	pStart = z;` |
|     - |  144 | `	/* Scan for closing delimiter, respecting backslash escapes */` |
|   218 |  145 | `	while( z < zEnd ){` |
|   218 |  146 | `		if( *z == '\\' && z + 1 < zEnd ){` |
...
|     - |  157 | `	}` |
|    28 |  158 | `	*pPattern = pStart;` |
|    28 |  159 | `	*pnPatternLen = (int)(z - pStart);` |
|    28 |  160 | `	z++; /* Skip closing delimiter */` |
|    28 |  161 | `	*pFlags = z;` |
|    28 |  162 | `	*pnFlagLen = (int)(zEnd - z);` |
|    28 |  163 | `	return PH7_OK;` |
|    15 |  164 |  |
|     - |  165 |  |
|     - |  166 | `/* ===== Flag mapper ===== */` |
|    26 |  167 | `static sxi32 PcreMapFlags(` |
|     - |  168 | `	const char *zFlags, int nFlagLen,` |
|     - |  169 | `	uint32_t *pCompileOpts)` |
|     2 |  170 |  |
|     - |  171 | `	int i;` |
|    28 |  172 | `	*pCompileOpts = 0;` |
|    40 |  173 | `	for( i = 0; i < nFlagLen; i++ ){` |
...
|     - |  186 | `		}` |
|     7 |  187 | `	}` |
|    28 |  188 | `	return PH7_OK;` |
|     2 |  189 |  |
|     - |  190 |  |
|     - |  191 | `/* ===== Compile helper ===== */` |
|    32 |  192 | `static pcre2_code *PcreCompile(` |
...
|    34 |  207 | `	pCode = PcreCache_Find(zFullPattern, (sxu32)nLen, pCaptureCount);` |
|    34 |  208 | `	if( pCode ){` |
|     7 |  209 | `		return pCode;` |
|     - |  210 | `	}` |
|     - |  211 | `	/* Parse delimiter */` |
|    28 |  212 | `	parseRc = PcreParsePattern(zFullPattern, nLen, &zPat, &nPatLen, &zFlags, &nFlagLen);` |
|    28 |  213 | `	if( parseRc != PCRE_PARSE_OK ){` |
|     - |  214 | `		const char *zMsg;` |
...
|     - |  223 | `	}` |
|     - |  224 | `	/* Map flags */` |
|    28 |  225 | `	PcreMapFlags(zFlags, nFlagLen, &compileOpts);` |
|     - |  226 | `	/* Compile */` |
|    28 |  227 | `	pCode = pcre2_compile(` |
|    13 |  228 | `		(PCRE2_SPTR)zPat, (PCRE2_SIZE)nPatLen,` |
|    13 |  229 | `		compileOpts, &errcode, &erroffset, NULL);` |
|    28 |  230 | `	if( pCode == 0 ){` |
...
|    28 |  239 | `	nCapture = 0;` |
|    28 |  240 | `	pcre2_pattern_info(pCode, PCRE2_INFO_CAPTURECOUNT, &nCapture);` |
|    28 |  241 | `	if( pCaptureCount ){` |
|    28 |  242 | `		*pCaptureCount = nCapture;` |
|    13 |  243 | `	}` |
|     - |  244 | `	/* Cache it */` |
|    28 |  245 | `	PcreCache_Insert(zFullPattern, (sxu32)nLen, pCode, nCapture);` |
|    28 |  246 | `	pCtx->pVm->iPcreLastError = PHP_PREG_NO_ERROR;` |
|    28 |  247 | `	return pCode;` |
|    18 |  248 |  |
|     - |  249 |  |
|     - |  250 | `/*` |
...
|     - | 1164 | `};` |
|     - | 1165 |  |
|  2808 | 1166 | `PH7_PRIVATE void PH7_RegisterPcreFunctions(ph7_vm *pVm)` |
|     2 | 1167 |  |
|     - | 1168 | `	sxu32 n;` |
| 25274 | 1169 | `	for( n = 0; n < SX_ARRAYSIZE(aPcreFunc); n++ ){` |
| 22466 | 1170 | `		ph7_create_function(&(*pVm), aPcreFunc[n].zName, aPcreFunc[n].xFunc, 0);` |
| 11234 | 1171 | `	}` |
|  2810 | 1172 |  |
|     - | 1173 |  |
...
|     - | 1194 |  |
|  2808 | 1195 | `PH7_PRIVATE void PH7_RegisterPcreConstants(ph7_vm *pVm)` |
|     2 | 1196 |  |
|  2810 | 1197 | `	ph7_create_constant(&(*pVm), "PREG_PATTERN_ORDER",        PcreConst_PREG_PATTERN_ORDER, 0);` |
|  2810 | 1198 | `	ph7_create_constant(&(*pVm), "PREG_SET_ORDER",            PcreConst_PREG_SET_ORDER, 0);` |
|  2810 | 1199 | `	ph7_create_constant(&(*pVm), "PREG_OFFSET_CAPTURE",       PcreConst_PREG_OFFSET_CAPTURE, 0);` |
|  2810 | 1200 | `	ph7_create_constant(&(*pVm), "PREG_UNMATCHED_AS_NULL",    PcreConst_PREG_UNMATCHED_AS_NULL, 0);` |
|  2810 | 1201 | `	ph7_create_constant(&(*pVm), "PREG_SPLIT_NO_EMPTY",       PcreConst_PREG_SPLIT_NO_EMPTY, 0);` |
|  2810 | 1202 | `	ph7_create_constant(&(*pVm), "PREG_SPLIT_DELIM_CAPTURE",  PcreConst_PREG_SPLIT_DELIM_CAPTURE, 0);` |
|  2810 | 1203 | `	ph7_create_constant(&(*pVm), "PREG_SPLIT_OFFSET_CAPTURE", PcreConst_PREG_SPLIT_OFFSET_CAPTURE, 0);` |
|  2810 | 1204 | `	ph7_create_constant(&(*pVm), "PREG_NO_ERROR",             PcreConst_PREG_NO_ERROR, 0);` |
|  2810 | 1205 | `	ph7_create_constant(&(*pVm), "PREG_INTERNAL_ERROR",       PcreConst_PREG_INTERNAL_ERROR, 0);` |
|  2810 | 1206 | `	ph7_create_constant(&(*pVm), "PREG_BACKTRACK_LIMIT_ERROR", PcreConst_PREG_BACKTRACK_LIMIT_ERROR, 0);` |
|  2810 | 1207 | `	ph7_create_constant(&(*pVm), "PREG_RECURSION_LIMIT_ERROR", PcreConst_PREG_RECURSION_LIMIT_ERROR, 0);` |
|  2810 | 1208 | `	ph7_create_constant(&(*pVm), "PREG_BAD_UTF8_ERROR",       PcreConst_PREG_BAD_UTF8_ERROR, 0);` |
|  2810 | 1209 | `	ph7_create_constant(&(*pVm), "PREG_BAD_UTF8_OFFSET_ERROR",PcreConst_PREG_BAD_UTF8_OFFSET_ERROR, 0);` |
|  2810 | 1210 | `	ph7_create_constant(&(*pVm), "PREG_JIT_STACKLIMIT_ERROR", PcreConst_PREG_JIT_STACKLIMIT_ERROR, 0);` |
|  2810 | 1211 |  |
|     - | 1212 |  |
|     - | 1213 | `#else` |
