...
|     1 |   56 |  |
|     - |   57 | `	sxu32 i;` |
|    41 |   58 | `	for( i = 0; i < nCacheUsed; i++ ){` |
|    15 |   59 | `		if( aCache[i].nLen == nLen && SyMemcmp(aCache[i].zPattern, zPattern, nLen) == 0 ){` |
|     3 |   60 | `			aCache[i].iLastUsed = ++iCacheClock;` |
|     3 |   61 | `			if( pCaptureCount ){` |
|     3 |   62 | `				*pCaptureCount = aCache[i].nCaptureCount;` |
|     1 |   63 | `			}` |
|     3 |   64 | `			return aCache[i].pCode;` |
|     - |   65 | `		}` |
|     7 |   66 | `	}` |
|    27 |   67 | `	return 0;` |
|    15 |   68 |  |
...
|    27 |   75 | `	zCopy = (char *)malloc(nLen + 1);` |
|    27 |   76 | `	if( zCopy == 0 ){` |
|     - |   77 | `		/* OOM — pCode is not cached; it leaks but remains usable by the caller */` |
|   ! 0 |   78 | `		return;` |
|     - |   79 | `	}` |
|    27 |   80 | `	SyMemcpy(zPattern, zCopy, nLen);` |
|    27 |   81 | `	zCopy[nLen] = 0;` |
|    27 |   82 | `	if( nCacheUsed < PCRE_CACHE_SIZE ){` |
|    27 |   83 | `		pEntry = &aCache[nCacheUsed++];` |
|    14 |   84 | `	}else{` |
|     - |   85 | `		/* Evict LRU */` |
...
|     - |   98 | `	}` |
|    27 |   99 | `	pEntry->zPattern = zCopy;` |
|    27 |  100 | `	pEntry->nLen = nLen;` |
|    27 |  101 | `	pEntry->pCode = pCode;` |
|    27 |  102 | `	pEntry->nCaptureCount = nCaptureCount;` |
|    27 |  103 | `	pEntry->iLastUsed = ++iCacheClock;` |
|    14 |  104 |  |
|     - |  105 |  |
...
|     1 |  116 |  |
|    27 |  117 | `	const char *zEnd = &zInput[nInputLen];` |
|    27 |  118 | `	const char *z = zInput;` |
|     - |  119 | `	char cOpen, cClose;` |
|     - |  120 | `	const char *pStart;` |
|     - |  121 |  |
|     - |  122 | `	/* Skip leading whitespace */` |
|    27 |  123 | `	while( z < zEnd && (unsigned char)*z <= 0x20 ){` |
|   ! 0 |  124 | `		z++;` |
|   ! 0 |  125 | `	}` |
|    27 |  126 | `	if( z >= zEnd ){` |
...
|    27 |  131 | `	if( SyisAlphaNum(cOpen) \|\| cOpen == '\\' \|\| (unsigned char)cOpen <= 0x20 ){` |
...
|    27 |  140 | `		default:  cClose = cOpen; break;` |
|     - |  141 | `	}` |
|    27 |  142 | `	z++; /* Skip opening delimiter */` |
|    27 |  143 | `	pStart = z;` |
|     - |  144 | `	/* Scan for closing delimiter, respecting backslash escapes */` |
|   225 |  145 | `	while( z < zEnd ){` |
|   225 |  146 | `		if( *z == '\\' && z + 1 < zEnd ){` |
...
|     - |  157 | `	}` |
|    27 |  158 | `	*pPattern = pStart;` |
|    27 |  159 | `	*pnPatternLen = (int)(z - pStart);` |
|    27 |  160 | `	z++; /* Skip closing delimiter */` |
|    27 |  161 | `	*pFlags = z;` |
|    27 |  162 | `	*pnFlagLen = (int)(zEnd - z);` |
|    27 |  163 | `	return PH7_OK;` |
|    14 |  164 |  |
|     - |  165 |  |
|     - |  166 | `/* ===== Flag mapper ===== */` |
...
|     1 |  170 |  |
|     - |  171 | `	int i;` |
|    27 |  172 | `	*pCompileOpts = 0;` |
|    39 |  173 | `	for( i = 0; i < nFlagLen; i++ ){` |
...
|     - |  210 | `	}` |
|     - |  211 | `	/* Parse delimiter */` |
|    27 |  212 | `	parseRc = PcreParsePattern(zFullPattern, nLen, &zPat, &nPatLen, &zFlags, &nFlagLen);` |
|    27 |  213 | `	if( parseRc != PCRE_PARSE_OK ){` |
|     - |  214 | `		const char *zMsg;` |
...
|     - |  223 | `	}` |
|     - |  224 | `	/* Map flags */` |
|    27 |  225 | `	PcreMapFlags(zFlags, nFlagLen, &compileOpts);` |
|     - |  226 | `	/* Compile */` |
|    27 |  227 | `	pCode = pcre2_compile(` |
...
|    27 |  239 | `	nCapture = 0;` |
|    27 |  240 | `	pcre2_pattern_info(pCode, PCRE2_INFO_CAPTURECOUNT, &nCapture);` |
|    27 |  241 | `	if( pCaptureCount ){` |
|    27 |  242 | `		*pCaptureCount = nCapture;` |
|    13 |  243 | `	}` |
|     - |  244 | `	/* Cache it */` |
|    27 |  245 | `	PcreCache_Insert(zFullPattern, (sxu32)nLen, pCode, nCapture);` |
|    27 |  246 | `	pCtx->pVm->iPcreLastError = PHP_PREG_NO_ERROR;` |
|    27 |  247 | `	return pCode;` |
|    15 |  248 |  |
|     - |  249 |  |
|     - |  250 | `/*` |
...
|     - | 1157 | `};` |
|     - | 1158 |  |
|  2536 | 1159 | `PH7_PRIVATE void PH7_RegisterPcreFunctions(ph7_vm *pVm)` |
|     2 | 1160 |  |
|     - | 1161 | `	sxu32 n;` |
| 22826 | 1162 | `	for( n = 0; n < SX_ARRAYSIZE(aPcreFunc); n++ ){` |
| 20290 | 1163 | `		ph7_create_function(&(*pVm), aPcreFunc[n].zName, aPcreFunc[n].xFunc, 0);` |
| 10146 | 1164 | `	}` |
|  2538 | 1165 |  |
|     - | 1166 |  |
...
|     - | 1187 |  |
|  2536 | 1188 | `PH7_PRIVATE void PH7_RegisterPcreConstants(ph7_vm *pVm)` |
|     2 | 1189 |  |
|  2538 | 1190 | `	ph7_create_constant(&(*pVm), "PREG_PATTERN_ORDER",        PcreConst_PREG_PATTERN_ORDER, 0);` |
|  2538 | 1191 | `	ph7_create_constant(&(*pVm), "PREG_SET_ORDER",            PcreConst_PREG_SET_ORDER, 0);` |
|  2538 | 1192 | `	ph7_create_constant(&(*pVm), "PREG_OFFSET_CAPTURE",       PcreConst_PREG_OFFSET_CAPTURE, 0);` |
|  2538 | 1193 | `	ph7_create_constant(&(*pVm), "PREG_UNMATCHED_AS_NULL",    PcreConst_PREG_UNMATCHED_AS_NULL, 0);` |
|  2538 | 1194 | `	ph7_create_constant(&(*pVm), "PREG_SPLIT_NO_EMPTY",       PcreConst_PREG_SPLIT_NO_EMPTY, 0);` |
|  2538 | 1195 | `	ph7_create_constant(&(*pVm), "PREG_SPLIT_DELIM_CAPTURE",  PcreConst_PREG_SPLIT_DELIM_CAPTURE, 0);` |
|  2538 | 1196 | `	ph7_create_constant(&(*pVm), "PREG_SPLIT_OFFSET_CAPTURE", PcreConst_PREG_SPLIT_OFFSET_CAPTURE, 0);` |
|  2538 | 1197 | `	ph7_create_constant(&(*pVm), "PREG_NO_ERROR",             PcreConst_PREG_NO_ERROR, 0);` |
|  2538 | 1198 | `	ph7_create_constant(&(*pVm), "PREG_INTERNAL_ERROR",       PcreConst_PREG_INTERNAL_ERROR, 0);` |
|  2538 | 1199 | `	ph7_create_constant(&(*pVm), "PREG_BACKTRACK_LIMIT_ERROR", PcreConst_PREG_BACKTRACK_LIMIT_ERROR, 0);` |
|  2538 | 1200 | `	ph7_create_constant(&(*pVm), "PREG_RECURSION_LIMIT_ERROR", PcreConst_PREG_RECURSION_LIMIT_ERROR, 0);` |
|  2538 | 1201 | `	ph7_create_constant(&(*pVm), "PREG_BAD_UTF8_ERROR",       PcreConst_PREG_BAD_UTF8_ERROR, 0);` |
|  2538 | 1202 | `	ph7_create_constant(&(*pVm), "PREG_BAD_UTF8_OFFSET_ERROR",PcreConst_PREG_BAD_UTF8_OFFSET_ERROR, 0);` |
|  2538 | 1203 | `	ph7_create_constant(&(*pVm), "PREG_JIT_STACKLIMIT_ERROR", PcreConst_PREG_JIT_STACKLIMIT_ERROR, 0);` |
|  2538 | 1204 |  |
|     - | 1205 |  |
|     - | 1206 | `#else` |
