...
|     - |   54 |  |
|    34 |   55 | `static pcre2_code *PcreCache_Find(const char *zPattern, sxu32 nLen, sxu32 *pCaptureCount)` |
|     2 |   56 |  |
|     - |   57 | `	sxu32 i;` |
|   208 |   58 | `	for( i = 0; i < nCacheUsed; i++ ){` |
|   180 |   59 | `		if( aCache[i].nLen == nLen && SyMemcmp(aCache[i].zPattern, zPattern, nLen) == 0 ){` |
...
|    19 |   68 |  |
|     - |   69 |  |
|    28 |   70 | `static void PcreCache_Insert(const char *zPattern, sxu32 nLen, pcre2_code *pCode, sxu32 nCaptureCount)` |
|     2 |   71 |  |
|     - |   72 | `	PcreCacheEntry *pEntry;` |
|     - |   73 | `	char *zCopy;` |
|     - |   74 | `	/* Allocate the pattern copy first, before touching the cache */` |
|    30 |   75 | `	zCopy = (char *)malloc(nLen + 1);` |
|    30 |   76 | `	if( zCopy == 0 ){` |
|     - |   77 | `		/* OOM — pCode is not cached; it leaks but remains usable by the caller */` |
|   ! 0 |   78 | `		return;` |
|     - |   79 | `	}` |
|    30 |   80 | `	SyMemcpy(zPattern, zCopy, nLen);` |
|    30 |   81 | `	zCopy[nLen] = 0;` |
|    30 |   82 | `	if( nCacheUsed < PCRE_CACHE_SIZE ){` |
|    30 |   83 | `		pEntry = &aCache[nCacheUsed++];` |
|    16 |   84 | `	}else{` |
|     - |   85 | `		/* Evict LRU */` |
...
|     - |   98 | `	}` |
|    30 |   99 | `	pEntry->zPattern = zCopy;` |
|    30 |  100 | `	pEntry->nLen = nLen;` |
|    30 |  101 | `	pEntry->pCode = pCode;` |
|    30 |  102 | `	pEntry->nCaptureCount = nCaptureCount;` |
|    30 |  103 | `	pEntry->iLastUsed = ++iCacheClock;` |
|    16 |  104 |  |
|     - |  105 |  |
...
|    30 |  131 | `	if( SyisAlphaNum(cOpen) \|\| cOpen == '\\' \|\| (unsigned char)cOpen <= 0x20 ){` |
...
|    30 |  140 | `		default:  cClose = cOpen; break;` |
|     - |  141 | `	}` |
|    30 |  142 | `	z++; /* Skip opening delimiter */` |
|    30 |  143 | `	pStart = z;` |
|     - |  144 | `	/* Scan for closing delimiter, respecting backslash escapes */` |
|   238 |  145 | `	while( z < zEnd ){` |
|   238 |  146 | `		if( *z == '\\' && z + 1 < zEnd ){` |
|    33 |  147 | `			z += 2; /* Skip escaped char */` |
|    33 |  148 | `			continue;` |
|     - |  149 | `		}` |
|   206 |  150 | `		if( *z == cClose ){` |
|    30 |  151 | `			break;` |
...
|     - |  157 | `	}` |
|    30 |  158 | `	*pPattern = pStart;` |
|    30 |  159 | `	*pnPatternLen = (int)(z - pStart);` |
|    30 |  160 | `	z++; /* Skip closing delimiter */` |
|    30 |  161 | `	*pFlags = z;` |
|    30 |  162 | `	*pnFlagLen = (int)(zEnd - z);` |
|    30 |  163 | `	return PH7_OK;` |
|    16 |  164 |  |
|     - |  165 |  |
|     - |  166 | `/* ===== Flag mapper ===== */` |
|    28 |  167 | `static sxi32 PcreMapFlags(` |
|     - |  168 | `	const char *zFlags, int nFlagLen,` |
|     - |  169 | `	uint32_t *pCompileOpts)` |
|     2 |  170 |  |
|     - |  171 | `	int i;` |
|    30 |  172 | `	*pCompileOpts = 0;` |
|    42 |  173 | `	for( i = 0; i < nFlagLen; i++ ){` |
...
|     - |  186 | `		}` |
|     7 |  187 | `	}` |
|    30 |  188 | `	return PH7_OK;` |
|     2 |  189 |  |
|     - |  190 |  |
|     - |  191 | `/* ===== Compile helper ===== */` |
|    34 |  192 | `static pcre2_code *PcreCompile(` |
...
|    36 |  207 | `	pCode = PcreCache_Find(zFullPattern, (sxu32)nLen, pCaptureCount);` |
|    36 |  208 | `	if( pCode ){` |
|     7 |  209 | `		return pCode;` |
|     - |  210 | `	}` |
|     - |  211 | `	/* Parse delimiter */` |
|    30 |  212 | `	parseRc = PcreParsePattern(zFullPattern, nLen, &zPat, &nPatLen, &zFlags, &nFlagLen);` |
|    30 |  213 | `	if( parseRc != PCRE_PARSE_OK ){` |
|     - |  214 | `		const char *zMsg;` |
...
|     - |  223 | `	}` |
|     - |  224 | `	/* Map flags */` |
|    30 |  225 | `	PcreMapFlags(zFlags, nFlagLen, &compileOpts);` |
|     - |  226 | `	/* Compile */` |
|    30 |  227 | `	pCode = pcre2_compile(` |
|    14 |  228 | `		(PCRE2_SPTR)zPat, (PCRE2_SIZE)nPatLen,` |
|    14 |  229 | `		compileOpts, &errcode, &erroffset, NULL);` |
|    30 |  230 | `	if( pCode == 0 ){` |
...
|    30 |  239 | `	nCapture = 0;` |
|    30 |  240 | `	pcre2_pattern_info(pCode, PCRE2_INFO_CAPTURECOUNT, &nCapture);` |
|    30 |  241 | `	if( pCaptureCount ){` |
|    30 |  242 | `		*pCaptureCount = nCapture;` |
|    14 |  243 | `	}` |
|     - |  244 | `	/* Cache it */` |
|    30 |  245 | `	PcreCache_Insert(zFullPattern, (sxu32)nLen, pCode, nCapture);` |
|    30 |  246 | `	pCtx->pVm->iPcreLastError = PHP_PREG_NO_ERROR;` |
|    30 |  247 | `	return pCode;` |
|    19 |  248 |  |
|     - |  249 |  |
|     - |  250 | `/*` |
...
|    22 |  298 | `static void PcrePopulateMatches(` |
...
|     2 |  306 |  |
|    24 |  307 | `	ph7_value *pVal = ph7_context_new_scalar(pCtx);` |
|    24 |  308 | `	ph7_value *pSub = 0;` |
|    24 |  309 | `	uint32_t namecount = 0, nameentrysize = 0;` |
|    24 |  310 | `	PCRE2_SPTR nametable = 0;` |
|     - |  311 | `	int i;` |
|     - |  312 |  |
|    24 |  313 | `	if( iFlags & PHP_PREG_OFFSET_CAPTURE ){` |
|   ! 0 |  314 | `		pSub = ph7_context_new_array(pCtx);` |
|   ! 0 |  315 | `	}` |
|    62 |  316 | `	for( i = 0; i < nGroups; i++ ){` |
|    40 |  317 | `		PCRE2_SIZE start = ovector[2 * i];` |
|    40 |  318 | `		PCRE2_SIZE end   = ovector[2 * i + 1];` |
|    40 |  319 | `		if( start == PCRE2_UNSET ){` |
...
|     - |  337 | `			}` |
|   ! 0 |  338 | `		}else{` |
|    40 |  339 | `			ph7_value_string(pVal, &zSubject[start], (int)(end - start));` |
|    40 |  340 | `			if( iFlags & PHP_PREG_OFFSET_CAPTURE ){` |
...
|   ! 0 |  349 | `			}else{` |
|    40 |  350 | `				ph7_array_add_intkey_elem(pArray, i, pVal);` |
|     - |  351 | `			}` |
|     - |  352 | `		}` |
|    40 |  353 | `		ph7_value_reset_string_cursor(pVal);` |
|    21 |  354 | `	}` |
|     - |  355 | `	/* Named groups */` |
|    24 |  356 | `	pcre2_pattern_info(pCode, PCRE2_INFO_NAMECOUNT, &namecount);` |
|    24 |  357 | `	if( namecount > 0 ){` |
...
|     3 |  390 | `		}` |
|     1 |  391 | `	}` |
|    24 |  392 | `	ph7_context_release_value(pCtx, pVal);` |
|    24 |  393 | `	if( pSub ){` |
...
|     - |  400 | ` * ====================================================================== */` |
|    14 |  401 | `static int PH7_builtin_preg_match(ph7_context *pCtx, int nArg, ph7_value **apArg)` |
|     1 |  402 |  |
...
|     - |  408 | `	sxu32 nCapture;` |
|    15 |  409 | `	PCRE2_SIZE startOffset = 0;` |
|    15 |  410 | `	int iFlags = 0;` |
|     - |  411 | `	int rc;` |
|     - |  412 |  |
|    15 |  413 | `	if( nArg < 2 ){` |
...
|   ! 0 |  417 | `		return PH7_OK;` |
|     - |  418 | `	}` |
|    15 |  419 | `	zPattern = ph7_value_to_string(apArg[0], &nPatLen);` |
|    15 |  420 | `	zSubject = ph7_value_to_string(apArg[1], &nSubLen);` |
|    15 |  421 | `	if( nArg >= 4 ){` |
...
|   ! 0 |  426 | `	}` |
|    15 |  427 | `	pCode = PcreCompile(pCtx, zPattern, nPatLen, &nCapture);` |
|    15 |  428 | `	if( pCode == 0 ){` |
|   ! 0 |  429 | `		ph7_result_bool(pCtx, 0);` |
|   ! 0 |  430 | `		return PH7_OK;` |
|     - |  431 | `	}` |
|    15 |  432 | `	pMatchData = pcre2_match_data_create_from_pattern(pCode, NULL);` |
|    15 |  433 | `	if( pMatchData == 0 ){` |
|   ! 0 |  434 | `		ph7_result_bool(pCtx, 0);` |
|   ! 0 |  435 | `		return PH7_OK;` |
|     - |  436 | `	}` |
|    22 |  437 | `	rc = pcre2_match(pCode, (PCRE2_SPTR)zSubject, (PCRE2_SIZE)nSubLen,` |
|     7 |  438 | `		startOffset, 0, pMatchData, NULL);` |
|    15 |  439 | `	if( rc < 0 ){` |
...
|     3 |  451 | `		return PH7_OK;` |
|     - |  452 | `	}` |
|    13 |  453 | `	pCtx->pVm->iPcreLastError = PHP_PREG_NO_ERROR;` |
|    13 |  454 | `	if( nArg >= 3 ){` |
...
|     2 |  462 | `	}` |
|    13 |  463 | `	pcre2_match_data_free(pMatchData);` |
|    13 |  464 | `	ph7_result_int(pCtx, 1);` |
|    13 |  465 | `	return PH7_OK;` |
|     8 |  466 |  |
|     - |  467 |  |
|     - |  468 | `/* ======================================================================` |
...
|     - |  969 | ` * ====================================================================== */` |
|     6 |  970 | `static int PH7_builtin_preg_replace_callback(ph7_context *pCtx, int nArg, ph7_value **apArg)` |
|     2 |  971 |  |
...
|     - |  976 | `	sxu32 nCapture;` |
|     - |  977 | `	SyBlob sOut;` |
|     8 |  978 | `	PCRE2_SIZE startOffset = 0;` |
|     8 |  979 | `	int limit = -1;` |
|     8 |  980 | `	int count = 0;` |
|     - |  981 | `	int rc;` |
|     - |  982 |  |
...
|   ! 0 |  987 | `		return PH7_OK;` |
|     - |  988 | `	}` |
|     8 |  989 | `	zPattern = ph7_value_to_string(apArg[0], &nPatLen);` |
|     8 |  990 | `	zSubject = ph7_value_to_string(apArg[2], &nSubLen);` |
|     8 |  991 | `	if( nArg >= 4 ){` |
|   ! 0 |  992 | `		limit = ph7_value_to_int(apArg[3]);` |
|   ! 0 |  993 | `	}` |
|     8 |  994 | `	if( !ph7_value_is_callable(apArg[1]) ){` |
...
|   ! 0 |  998 | `		return PH7_OK;` |
|     - |  999 | `	}` |
|     8 | 1000 | `	pCode = PcreCompile(pCtx, zPattern, nPatLen, &nCapture);` |
|     8 | 1001 | `	if( pCode == 0 ){` |
|   ! 0 | 1002 | `		ph7_result_null(pCtx);` |
|   ! 0 | 1003 | `		return PH7_OK;` |
|     - | 1004 | `	}` |
|     8 | 1005 | `	pMatchData = pcre2_match_data_create_from_pattern(pCode, NULL);` |
|     8 | 1006 | `	if( pMatchData == 0 ){` |
|   ! 0 | 1007 | `		ph7_result_null(pCtx);` |
|   ! 0 | 1008 | `		return PH7_OK;` |
|     - | 1009 | `	}` |
|     8 | 1010 | `	SyBlobInit(&sOut, &pCtx->pVm->sAllocator);` |
|     8 | 1011 | `	pCtx->pVm->iPcreLastError = PHP_PREG_NO_ERROR;` |
|     - | 1012 |  |
|    22 | 1013 | `	while( startOffset <= (PCRE2_SIZE)nSubLen ){` |
...
|     - | 1019 | `		int nReplLen;` |
|     - | 1020 |  |
|    25 | 1021 | `		if( limit >= 0 && count >= limit ) break;` |
|    32 | 1022 | `		rc = pcre2_match(pCode, (PCRE2_SPTR)zSubject, (PCRE2_SIZE)nSubLen,` |
|    10 | 1023 | `			startOffset, 0, pMatchData, NULL);` |
|    22 | 1024 | `		if( rc < 0 ){` |
|     8 | 1025 | `			if( rc != PCRE2_ERROR_NOMATCH ){` |
|   ! 0 | 1026 | `				PcreSetMatchError(pCtx->pVm, rc);` |
|   ! 0 | 1027 | `			}` |
|     8 | 1028 | `			break;` |
|     - | 1029 | `		}` |
|    16 | 1030 | `		ovector = pcre2_get_ovector_pointer(pMatchData);` |
|     - | 1031 | `		/* Copy text before match */` |
|    16 | 1032 | `		if( ovector[0] > startOffset ){` |
|    12 | 1033 | `			SyBlobAppend(&sOut, &zSubject[startOffset], (sxu32)(ovector[0] - startOffset));` |
|     5 | 1034 | `		}` |
|     - | 1035 | `		/* Build matches array for callback */` |
|    16 | 1036 | `		pMatchArr = ph7_context_new_array(pCtx);` |
|    16 | 1037 | `		PcrePopulateMatches(pCtx, pMatchArr, zSubject, ovector, rc, pCode, 0);` |
|     - | 1038 | `		/* Call the callback */` |
|    16 | 1039 | `		PH7_MemObjInit(pCtx->pVm, &sResult);` |
|    16 | 1040 | `		apCbArg[0] = pMatchArr;` |
|    16 | 1041 | `		if( PH7_VmCallUserFunction(pCtx->pVm, apArg[1], 1, apCbArg, &sResult) == PH7_EXCEPTION ){` |
|     - | 1042 | `			/* The callback raised: propagate so the dispatcher unwinds. */` |
|   ! 0 | 1043 | `			PH7_MemObjRelease(&sResult);` |
|   ! 0 | 1044 | `			ph7_context_release_value(pCtx, pMatchArr);` |
|   ! 0 | 1045 | `			SyBlobRelease(&sOut);` |
|   ! 0 | 1046 | `			pcre2_match_data_free(pMatchData);` |
|   ! 0 | 1047 | `			return PH7_EXCEPTION;` |
|     - | 1048 | `		}` |
|     - | 1049 | `		/* Get replacement string from callback result */` |
|    16 | 1050 | `		zReplacement = ph7_value_to_string(&sResult, &nReplLen);` |
|    16 | 1051 | `		SyBlobAppend(&sOut, zReplacement, (sxu32)nReplLen);` |
|    16 | 1052 | `		PH7_MemObjRelease(&sResult);` |
|    16 | 1053 | `		ph7_context_release_value(pCtx, pMatchArr);` |
|    16 | 1054 | `		count++;` |
|     - | 1055 | `		/* Advance */` |
|    16 | 1056 | `		if( ovector[1] == ovector[0] ){` |
|   ! 0 | 1057 | `			if( startOffset < (PCRE2_SIZE)nSubLen ){` |
|   ! 0 | 1058 | `				SyBlobAppend(&sOut, &zSubject[startOffset], 1);` |
|   ! 0 | 1059 | `			}` |
|   ! 0 | 1060 | `			startOffset = ovector[0] + 1;` |
|   ! 0 | 1061 | `		}else{` |
|    16 | 1062 | `			startOffset = ovector[1];` |
|     - | 1063 | `		}` |
|     2 | 1064 | `	}` |
|     - | 1065 | `	/* Copy remainder */` |
|     8 | 1066 | `	if( startOffset < (PCRE2_SIZE)nSubLen ){` |
|   ! 0 | 1067 | `		SyBlobAppend(&sOut, &zSubject[startOffset], (sxu32)(nSubLen - startOffset));` |
|   ! 0 | 1068 | `	}` |
|     8 | 1069 | `	ph7_result_string(pCtx, (const char *)SyBlobData(&sOut), (int)SyBlobLength(&sOut));` |
|     8 | 1070 | `	SyBlobRelease(&sOut);` |
|     8 | 1071 | `	pcre2_match_data_free(pMatchData);` |
|     - | 1072 | `	/* Set &$count if provided */` |
|     8 | 1073 | `	if( nArg >= 5 ){` |
|     - | 1074 | `		ph7_value sCount;` |
|   ! 0 | 1075 | `		PH7_MemObjInitFromInt(pCtx->pVm, &sCount, count);` |
|   ! 0 | 1076 | `		PcreStoreByRef(pCtx->pVm, apArg[4], &sCount);` |
|   ! 0 | 1077 | `		PH7_MemObjRelease(&sCount);` |
|   ! 0 | 1078 | `	}` |
|     8 | 1079 | `	return PH7_OK;` |
|     5 | 1080 |  |
|     - | 1081 |  |
|     - | 1082 | `/* ======================================================================` |
|     - | 1083 | ` * preg_quote(str [, delimiter])` |
|     - | 1084 | ` * ====================================================================== */` |
|     6 | 1085 | `static int PH7_builtin_preg_quote(ph7_context *pCtx, int nArg, ph7_value **apArg)` |
|     1 | 1086 |  |
|     7 | 1087 | `	const char *zStr, *zDelim = 0;` |
|     7 | 1088 | `	int nLen, nDelimLen = 0;` |
|     - | 1089 | `	const char *z, *zEnd;` |
|     - | 1090 |  |
|     7 | 1091 | `	if( nArg < 1 ){` |
|   ! 0 | 1092 | `		ph7_result_null(pCtx);` |
|   ! 0 | 1093 | `		return PH7_OK;` |
|     - | 1094 | `	}` |
|     7 | 1095 | `	zStr = ph7_value_to_string(apArg[0], &nLen);` |
|     7 | 1096 | `	if( nArg >= 2 ){` |
|     3 | 1097 | `		zDelim = ph7_value_to_string(apArg[1], &nDelimLen);` |
|     1 | 1098 | `	}` |
|     7 | 1099 | `	z = zStr;` |
|     7 | 1100 | `	zEnd = &zStr[nLen];` |
|    71 | 1101 | `	while( z < zEnd ){` |
|    65 | 1102 | `		char c = *z;` |
|    65 | 1103 | `		switch( c ){` |
|     4 | 1104 | `			case '.': case '\\': case '+': case '*': case '?':` |
|     - | 1105 | `			case '[': case '^': case ']': case '$': case '(':` |
|     - | 1106 | `			case ')': case '{': case '}': case '=': case '!':` |
|     - | 1107 | `			case '<': case '>': case '\|': case ':': case '-':` |
|     - | 1108 | `			case '#':` |
|     9 | 1109 | `				ph7_result_string(pCtx, "\\", 1);` |
|     9 | 1110 | `				break;` |
|    28 | 1111 | `			default:` |
|    57 | 1112 | `				if( nDelimLen > 0 && c == zDelim[0] ){` |
|     3 | 1113 | `					ph7_result_string(pCtx, "\\", 1);` |
|     1 | 1114 | `				}` |
|    56 | 1115 | `				break;` |
|     - | 1116 | `		}` |
|    65 | 1117 | `		ph7_result_string(pCtx, z, 1);` |
|    65 | 1118 | `		z++;` |
|     1 | 1119 | `	}` |
|     7 | 1120 | `	return PH7_OK;` |
|     4 | 1121 |  |
|     - | 1122 |  |
|     - | 1123 | `/* ======================================================================` |
|     - | 1124 | ` * preg_last_error()` |
|     - | 1125 | ` * ====================================================================== */` |
|   ! 0 | 1126 | `static int PH7_builtin_preg_last_error(ph7_context *pCtx, int nArg, ph7_value **apArg)` |
|   ! 0 | 1127 |  |
|   ! 0 | 1128 | `	SXUNUSED(nArg); SXUNUSED(apArg);` |
|   ! 0 | 1129 | `	ph7_result_int(pCtx, pCtx->pVm->iPcreLastError);` |
|   ! 0 | 1130 | `	return PH7_OK;` |
|   ! 0 | 1131 |  |
|     - | 1132 |  |
|     - | 1133 | `/* ======================================================================` |
|     - | 1134 | ` * preg_last_error_msg()` |
|     - | 1135 | ` * ====================================================================== */` |
|   ! 0 | 1136 | `static int PH7_builtin_preg_last_error_msg(ph7_context *pCtx, int nArg, ph7_value **apArg)` |
|   ! 0 | 1137 |  |
|     - | 1138 | `	const char *zMsg;` |
|   ! 0 | 1139 | `	SXUNUSED(nArg); SXUNUSED(apArg);` |
|   ! 0 | 1140 | `	switch( pCtx->pVm->iPcreLastError ){` |
|   ! 0 | 1141 | `		case PHP_PREG_NO_ERROR:               zMsg = "No error"; break;` |
|   ! 0 | 1142 | `		case PHP_PREG_INTERNAL_ERROR:         zMsg = "Internal error"; break;` |
|   ! 0 | 1143 | `		case PHP_PREG_BACKTRACK_LIMIT_ERROR:  zMsg = "Backtrack limit exhausted"; break;` |
|   ! 0 | 1144 | `		case PHP_PREG_RECURSION_LIMIT_ERROR:  zMsg = "Recursion limit exhausted"; break;` |
|   ! 0 | 1145 | `		case PHP_PREG_BAD_UTF8_ERROR:         zMsg = "Malformed UTF-8 characters, possibly incorrectly encoded"; break;` |
|   ! 0 | 1146 | `		case PHP_PREG_BAD_UTF8_OFFSET_ERROR:  zMsg = "The offset did not correspond to the beginning of a valid UTF-8 code point"; break;` |
|   ! 0 | 1147 | `		case PHP_PREG_JIT_STACKLIMIT_ERROR:   zMsg = "JIT stack limit exhausted"; break;` |
|   ! 0 | 1148 | `		default: zMsg = "Unknown error"; break;` |
|     - | 1149 | `	}` |
|   ! 0 | 1150 | `	ph7_result_string(pCtx, zMsg, -1);` |
|   ! 0 | 1151 | `	return PH7_OK;` |
|   ! 0 | 1152 |  |
|     - | 1153 |  |
|     - | 1154 | `/* ===== Function registration table ===== */` |
|     - | 1155 | `static const ph7_builtin_func aPcreFunc[] = {` |
|     - | 1156 | `	{ "preg_match",              PH7_builtin_preg_match },` |
|     - | 1157 | `	{ "preg_match_all",          PH7_builtin_preg_match_all },` |
|     - | 1158 | `	{ "preg_replace",            PH7_builtin_preg_replace },` |
|     - | 1159 | `	{ "preg_replace_callback",   PH7_builtin_preg_replace_callback },` |
|     - | 1160 | `	{ "preg_split",              PH7_builtin_preg_split },` |
|     - | 1161 | `	{ "preg_quote",              PH7_builtin_preg_quote },` |
|     - | 1162 | `	{ "preg_last_error",         PH7_builtin_preg_last_error },` |
|     - | 1163 | `	{ "preg_last_error_msg",     PH7_builtin_preg_last_error_msg },` |
|     - | 1164 | `};` |
|     - | 1165 |  |
|  2820 | 1166 | `PH7_PRIVATE void PH7_RegisterPcreFunctions(ph7_vm *pVm)` |
|     2 | 1167 |  |
|     - | 1168 | `	sxu32 n;` |
| 25382 | 1169 | `	for( n = 0; n < SX_ARRAYSIZE(aPcreFunc); n++ ){` |
| 22562 | 1170 | `		ph7_create_function(&(*pVm), aPcreFunc[n].zName, aPcreFunc[n].xFunc, 0);` |
| 11282 | 1171 | `	}` |
|  2822 | 1172 |  |
|     - | 1173 |  |
|     - | 1174 | `/* ===== Constant registration ===== */` |
|     - | 1175 | `#define PCRE_CONST_INT(name, val) \` |
|     - | 1176 | `	static void PcreConst_##name(ph7_value *pVal, void *pUnused){ \` |
|     - | 1177 | `		SXUNUSED(pUnused); ph7_value_int(pVal, val); \` |
|     - | 1178 | `	}` |
|     - | 1179 |  |
|   ! 0 | 1180 | `PCRE_CONST_INT(PREG_PATTERN_ORDER,       PHP_PREG_PATTERN_ORDER)` |
|     3 | 1181 | `PCRE_CONST_INT(PREG_SET_ORDER,           PHP_PREG_SET_ORDER)` |
|   ! 0 | 1182 | `PCRE_CONST_INT(PREG_OFFSET_CAPTURE,      PHP_PREG_OFFSET_CAPTURE)` |
|   ! 0 | 1183 | `PCRE_CONST_INT(PREG_UNMATCHED_AS_NULL,   PHP_PREG_UNMATCHED_AS_NULL)` |
|   ! 0 | 1184 | `PCRE_CONST_INT(PREG_SPLIT_NO_EMPTY,      PHP_PREG_SPLIT_NO_EMPTY)` |
|   ! 0 | 1185 | `PCRE_CONST_INT(PREG_SPLIT_DELIM_CAPTURE, PHP_PREG_SPLIT_DELIM_CAPTURE)` |
|   ! 0 | 1186 | `PCRE_CONST_INT(PREG_SPLIT_OFFSET_CAPTURE,PHP_PREG_SPLIT_OFFSET_CAPTURE)` |
|   ! 0 | 1187 | `PCRE_CONST_INT(PREG_NO_ERROR,            PHP_PREG_NO_ERROR)` |
|   ! 0 | 1188 | `PCRE_CONST_INT(PREG_INTERNAL_ERROR,      PHP_PREG_INTERNAL_ERROR)` |
|   ! 0 | 1189 | `PCRE_CONST_INT(PREG_BACKTRACK_LIMIT_ERROR,PHP_PREG_BACKTRACK_LIMIT_ERROR)` |
|   ! 0 | 1190 | `PCRE_CONST_INT(PREG_RECURSION_LIMIT_ERROR,PHP_PREG_RECURSION_LIMIT_ERROR)` |
|   ! 0 | 1191 | `PCRE_CONST_INT(PREG_BAD_UTF8_ERROR,      PHP_PREG_BAD_UTF8_ERROR)` |
|   ! 0 | 1192 | `PCRE_CONST_INT(PREG_BAD_UTF8_OFFSET_ERROR,PHP_PREG_BAD_UTF8_OFFSET_ERROR)` |
|   ! 0 | 1193 | `PCRE_CONST_INT(PREG_JIT_STACKLIMIT_ERROR,PHP_PREG_JIT_STACKLIMIT_ERROR)` |
|     - | 1194 |  |
|  2820 | 1195 | `PH7_PRIVATE void PH7_RegisterPcreConstants(ph7_vm *pVm)` |
|     2 | 1196 |  |
|  2822 | 1197 | `	ph7_create_constant(&(*pVm), "PREG_PATTERN_ORDER",        PcreConst_PREG_PATTERN_ORDER, 0);` |
|  2822 | 1198 | `	ph7_create_constant(&(*pVm), "PREG_SET_ORDER",            PcreConst_PREG_SET_ORDER, 0);` |
|  2822 | 1199 | `	ph7_create_constant(&(*pVm), "PREG_OFFSET_CAPTURE",       PcreConst_PREG_OFFSET_CAPTURE, 0);` |
|  2822 | 1200 | `	ph7_create_constant(&(*pVm), "PREG_UNMATCHED_AS_NULL",    PcreConst_PREG_UNMATCHED_AS_NULL, 0);` |
|  2822 | 1201 | `	ph7_create_constant(&(*pVm), "PREG_SPLIT_NO_EMPTY",       PcreConst_PREG_SPLIT_NO_EMPTY, 0);` |
|  2822 | 1202 | `	ph7_create_constant(&(*pVm), "PREG_SPLIT_DELIM_CAPTURE",  PcreConst_PREG_SPLIT_DELIM_CAPTURE, 0);` |
|  2822 | 1203 | `	ph7_create_constant(&(*pVm), "PREG_SPLIT_OFFSET_CAPTURE", PcreConst_PREG_SPLIT_OFFSET_CAPTURE, 0);` |
|  2822 | 1204 | `	ph7_create_constant(&(*pVm), "PREG_NO_ERROR",             PcreConst_PREG_NO_ERROR, 0);` |
|  2822 | 1205 | `	ph7_create_constant(&(*pVm), "PREG_INTERNAL_ERROR",       PcreConst_PREG_INTERNAL_ERROR, 0);` |
|  2822 | 1206 | `	ph7_create_constant(&(*pVm), "PREG_BACKTRACK_LIMIT_ERROR", PcreConst_PREG_BACKTRACK_LIMIT_ERROR, 0);` |
|  2822 | 1207 | `	ph7_create_constant(&(*pVm), "PREG_RECURSION_LIMIT_ERROR", PcreConst_PREG_RECURSION_LIMIT_ERROR, 0);` |
|  2822 | 1208 | `	ph7_create_constant(&(*pVm), "PREG_BAD_UTF8_ERROR",       PcreConst_PREG_BAD_UTF8_ERROR, 0);` |
|  2822 | 1209 | `	ph7_create_constant(&(*pVm), "PREG_BAD_UTF8_OFFSET_ERROR",PcreConst_PREG_BAD_UTF8_OFFSET_ERROR, 0);` |
|  2822 | 1210 | `	ph7_create_constant(&(*pVm), "PREG_JIT_STACKLIMIT_ERROR", PcreConst_PREG_JIT_STACKLIMIT_ERROR, 0);` |
|  2822 | 1211 |  |
|     - | 1212 |  |
|     - | 1213 | `#else` |
|     - | 1214 | `/* Ensure non-empty translation unit when PCRE is disabled (MSVC C4206) */` |
|     - | 1215 | `typedef int vm_pcre_unused;` |
|     - | 1216 | `#endif /* PH7_ENABLE_PCRE */` |
|     - | 1217 |  |
