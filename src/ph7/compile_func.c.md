...
|         - |   67 | ` */` |
|    703062 |   68 | `static sxi32 GenStateProcessArgValue(ph7_gen_state *pGen,ph7_vm_func_arg *pArg,SyToken *pIn,SyToken *pEnd)` |
|         5 |   69 | `{` |
|         - |   70 | `	SyToken *pTmpIn,*pTmpEnd;` |
|         - |   71 | `	SySet *pInstrContainer;` |
|         - |   72 | `	sxi32 rc;` |
|         - |   73 | `	/* Swap token stream */` |
|    703067 |   74 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|    703067 |   75 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|    703067 |   76 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pArg->aByteCode);` |
|         - |   77 | `	/* Compile the expression holding the argument value */` |
|    703067 |   78 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|         - |   79 | `	/* Emit the done instruction */` |
|    703067 |   80 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,(rc != SXERR_EMPTY ? 1 : 0),0,0,0);` |
|    703067 |   81 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|    703067 |   82 | `	RE_SWAP_DELIMITER(pGen);` |
|    703067 |   83 | `	if( rc == SXERR_ABORT ){` |
|       ! 0 |   84 | `		return SXERR_ABORT;` |
|         - |   85 | `	}` |
|    703067 |   86 | `	return SXRET_OK;` |
|    351536 |   87 | `}` |
|         - |   88 | `/*` |
...
|         - |  124 | ` */` |
|   1550566 |  125 | `PH7_PRIVATE sxi32 GenStateCollectFuncArgs(ph7_vm_func *pFunc,ph7_gen_state *pGen,SyToken *pEnd,int bCtorCtx,int bAbstractCtx)` |
|         5 |  126 | `{` |
...
|         - |  131 | `	sxi32 rc;` |
|         - |  132 |  |
|   1550571 |  133 | `	pIn = pGen->pIn;` |
|   1550571 |  134 | `	SyBlobInit(&sSig,&pGen->pVm->sAllocator);` |
|         - |  135 | `	/* Process arguments one after one */` |
|   1997002 |  136 | `	for(;;){` |
|   3994009 |  137 | `		if( pIn >= pEnd ){` |
|         - |  138 | `			/* No more arguments to process */` |
|   1550553 |  139 | `			break;` |
|         - |  140 | `		}` |
|   2443461 |  141 | `		SyZero(&sArg,sizeof(ph7_vm_func_arg));` |
|   2443461 |  142 | `		SySetInit(&sArg.aByteCode,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|   2443461 |  143 | `		SySetInit(&sArg.aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|   2443461 |  144 | `		SySetInit(&sArg.aAttrs,&pGen->pVm->sAllocator,sizeof(ph7_attribute));` |
|   2443461 |  145 | `		SyStringInitFromBuf(&sArg.sTypeName,0,0);` |
|         - |  146 | `		/* Parameter #[...] attributes: the group precedes the parameter's` |
|         - |  147 | `		 * first token inside the main token stream */` |
|   2443461 |  148 | `		if( GenStateCollectParamAttrs(&(*pGen),pIn,&sArg.aAttrs) == SXERR_ABORT ){` |
...
|         - |  156 | `		{` |
|   2443461 |  157 | `			int bReadonly = 0, bVisSeen = 0;` |
|   2443461 |  158 | `			sxi32 iVis = PH7_CLASS_PROT_PUBLIC;` |
|   2443461 |  159 | `			sxi32 iSetVisFlag = 0;` |
|         - |  160 | `			int nSetTok;` |
|         - |  161 | `			sxi32 nSetVis;` |
|   2443461 |  162 | `			if( pIn < pEnd && GenStateIsReadonly(pIn) ){` |
|         3 |  163 | `				bReadonly = 1;` |
|         3 |  164 | `				pIn++;` |
|         1 |  165 | `			}` |
|   2443461 |  166 | `			nSetVis = GenStatePeekSetVisibility(pIn,pEnd,&nSetTok);` |
|   2443461 |  167 | `			if( nSetVis ){` |
...
|       ! 0 |  174 | `					pIn++;` |
|         1 |  175 | `				}` |
|   2443460 |  176 | `			}else if( pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD) ){` |
|    108579 |  177 | `				sxu32 nKw = (sxu32)SX_PTR_TO_INT(pIn->pUserData);` |
|    108579 |  178 | `				if( nKw == PH7_TKWRD_PUBLIC \|\| nKw == PH7_TKWRD_PROTECTED \|\| nKw == PH7_TKWRD_PRIVATE ){` |
|        91 |  179 | `					bVisSeen = 1;` |
...
|        43 |  194 | `				}` |
|     54287 |  195 | `			}` |
|   2443461 |  196 | `			if( iSetVisFlag == PH7_CLASS_ATTR_PRIVATE_SET ){` |
|         5 |  197 | `				sArg.iFlags \|= VM_FUNC_ARG_PRIV_SET;` |
|   2443459 |  198 | `			}else if( iSetVisFlag == PH7_CLASS_ATTR_PROTECTED_SET ){` |
|       ! 0 |  199 | `				sArg.iFlags \|= VM_FUNC_ARG_PROT_SET;` |
|       ! 0 |  200 | `			}` |
|   2443461 |  201 | `			if( bVisSeen \|\| bReadonly ){` |
|        95 |  202 | `				if( !bCtorCtx ){` |
...
|   2443452 |  223 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_DOLLAR) == 0` |
|   1316705 |  224 | `			&& (pIn->nType & PH7_TK_AMPER) == 0` |
|    178353 |  225 | `			&& (pIn->nType & PH7_TK_ELLIPSIS) == 0 ){` |
|    143483 |  226 | `			sxu32 nLineLocal = pIn->nLine;` |
|    143483 |  227 | `			sxi32 iTFlags = 0;` |
|    143483 |  228 | `			pGen->pIn = pIn;` |
|    143483 |  229 | `			rc = GenStateParseUnionTypeDecl(` |
|     71739 |  230 | `				pGen, &sArg.nType, &sArg.sClass, &sArg.aUnionAlts,` |
|     71739 |  231 | `				&iTFlags, &sArg.sTypeName,` |
|         - |  232 | `				VM_FUNC_ARG_NULLABLE, VM_FUNC_ARG_UNION,` |
|         - |  233 | `				/* bAllowVoid */ 0,` |
|     71739 |  234 | `						nLineLocal);` |
|    143483 |  235 | `			pIn = pGen->pIn;` |
|    143483 |  236 | `			if( rc == SXERR_ABORT ){` |
|       ! 0 |  237 | `				return SXERR_ABORT;` |
|    143483 |  238 | `			}else if( rc == SXERR_CORRUPT ){` |
|         - |  239 | `				/* Error already reported by GenStateParseUnionTypeDecl */` |
|         3 |  240 | `				return SXERR_SYNTAX;` |
|    143481 |  241 | `			}else if( rc == SXERR_SYNTAX ){` |
|        10 |  242 | `				if( pIn < pEnd ){` |
...
|         - |  251 | `			}` |
|    143473 |  252 | `			sArg.iFlags \|= iTFlags;` |
|     71734 |  253 | `		}` |
|   2443447 |  254 | `		if( pIn >= pEnd ){` |
|       ! 0 |  255 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Missing argument name");` |
|       ! 0 |  256 | `			return rc;` |
|         - |  257 | `		}` |
|   2443447 |  258 | `		if( pIn->nType & PH7_TK_AMPER ){` |
|         - |  259 | `			/* Pass by reference,record that */` |
|     23233 |  260 | `			sArg.iFlags \|= VM_FUNC_ARG_BY_REF;` |
|     23233 |  261 | `			pIn++;` |
|     11614 |  262 | `		}` |
|   2443447 |  263 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_ELLIPSIS) ){` |
|         - |  264 | `			/* Variadic parameter: ...$args */` |
|     23289 |  265 | `			sArg.iFlags \|= VM_FUNC_ARG_VARIADIC;` |
|     23289 |  266 | `			pIn++;` |
|     11642 |  267 | `		}` |
|   2443447 |  268 | `		if( pIn >= pEnd \|\| (pIn->nType & PH7_TK_DOLLAR) == 0 \|\| &pIn[1] >= pEnd \|\| (pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|         - |  269 | `			/* Invalid argument */` |
|       ! 0 |  270 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Invalid argument name");` |
|       ! 0 |  271 | `			return rc;` |
|         - |  272 | `		}` |
|   2443447 |  273 | `		pIn++; /* Jump the dollar sign */` |
|         - |  274 | `		/* Copy argument name */` |
|   2443447 |  275 | `		zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,SyStringData(&pIn->sData),SyStringLength(&pIn->sData));` |
|   2443447 |  276 | `		if( zDup == 0 ){` |
|       ! 0 |  277 | `			PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"PH7 engine is running out of memory");` |
|       ! 0 |  278 | `			return SXERR_ABORT;` |
|         - |  279 | `		}` |
|   2443447 |  280 | `		SyStringInitFromBuf(&sArg.sName,zDup,SyStringLength(&pIn->sData));` |
|   2443447 |  281 | `		pIn++;` |
|   2443447 |  282 | `		if( pIn < pEnd ){` |
|   1352593 |  283 | `			if( pIn->nType & PH7_TK_EQUAL ){` |
|         - |  284 | `				SyToken *pDefend;` |
|    703069 |  285 | `				sxi32 iNest = 0;` |
|    703069 |  286 | `				pIn++; /* Jump the equal sign */` |
|    703069 |  287 | `				pDefend = pIn;` |
|         - |  288 | `				/* Process the default value associated with this argument */` |
|   1471833 |  289 | `				while( pDefend < pEnd ){` |
|   1012141 |  290 | `					if( (pDefend->nType & PH7_TK_COMMA) && iNest <= 0 ){` |
|    243377 |  291 | `						break;` |
|         - |  292 | `					}` |
|    768769 |  293 | `					if( pDefend->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*[*/) ){` |
|         - |  294 | `						/* Increment nesting level */` |
|     27053 |  295 | `						iNest++;` |
|    755245 |  296 | `					}else if( pDefend->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CCB/*'}'*/\|PH7_TK_CSB/*]*/) ){` |
|         - |  297 | `						/* Decrement nesting level */` |
|     27053 |  298 | `						iNest--;` |
|     13524 |  299 | `					}` |
|    768769 |  300 | `					pDefend++;` |
|         5 |  301 | `				}` |
|    703069 |  302 | `				if( pIn >= pDefend ){` |
|         3 |  303 | `					rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Missing argument default value");` |
|         3 |  304 | `					return rc;` |
|         - |  305 | `				}` |
|         - |  306 | `				/* Process default value */` |
|    703067 |  307 | `				rc = GenStateProcessArgValue(&(*pGen),&sArg,pIn,pDefend);` |
|    703067 |  308 | `				if( rc != SXRET_OK ){` |
|       ! 0 |  309 | `					return rc;` |
|         - |  310 | `				}` |
...
|    703062 |  316 | `				if( (sArg.nType > 0 \|\| (sArg.iFlags & VM_FUNC_ARG_UNION))` |
|    382450 |  317 | `					&& (sArg.iFlags & VM_FUNC_ARG_NULLABLE) == 0` |
|    374723 |  318 | `					&& &pIn[1] == pDefend` |
|     38659 |  319 | `					&& pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)` |
|     21262 |  320 | `					&& pIn->sData.nByte == sizeof("null")-1` |
|      5802 |  321 | `					&& SyStrnicmp(SyStringData(&pIn->sData),"null",sizeof("null")-1) == 0 ){` |
...
|    703065 |  344 | `				pIn = pDefend;` |
|    351530 |  345 | `			}` |
|   1352589 |  346 | `			if( pIn < pEnd && (pIn->nType & PH7_TK_COMMA) == 0 ){` |
|       ! 0 |  347 | `				rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Unexpected token '%z'",&pIn->sData);` |
|       ! 0 |  348 | `				return rc;` |
|         - |  349 | `			}` |
|   1352589 |  350 | `			pIn++; /* Jump the trailing comma */` |
|    676292 |  351 | `		}` |
|         - |  352 | `		/* Append argument signature */` |
|   2443443 |  353 | `		if( sArg.nType > 0 ){` |
|    143411 |  354 | `			if( SyStringLength(&sArg.sClass) > 0 ){` |
|         - |  355 | `				/* Class name — prefix with 'o' so generic object hint is a prefix match */` |
|     31013 |  356 | `				int marker = 'o';` |
|     31013 |  357 | `				SyBlobAppend(&sSig,(const void *)&marker,sizeof(char));` |
|     31013 |  358 | `				SyBlobAppend(&sSig,SyStringData(&sArg.sClass),SyStringLength(&sArg.sClass));` |
|     15509 |  359 | `			}else{` |
|         - |  360 | `				int c;` |
|    112403 |  361 | `				c = 'n'; /* cc warning */` |
|         - |  362 | `				/* Type leading character */` |
|    112403 |  363 | `				switch(sArg.nType){` |
|      5801 |  364 | `				case MEMOBJ_HASHMAP:` |
|         - |  365 | `					/* Hashmap aka 'array' */` |
|     11607 |  366 | `					c = 'h';` |
|     11607 |  367 | `					break;` |
|     17513 |  368 | `				case MEMOBJ_INT:` |
|         - |  369 | `					/* Integer */` |
|     35031 |  370 | `					c = 'i';` |
|     35031 |  371 | `					break;` |
...
|         2 |  389 | `					break;` |
|         - |  390 | `				}` |
|    112403 |  391 | `				SyBlobAppend(&sSig,(const void *)&c,sizeof(char));` |
|         - |  392 | `			}` |
|     71708 |  393 | `		}else{` |
|         - |  394 | `			/* No type is associated with this parameter which mean` |
|         - |  395 | `			 * that this function is not condidate for overloading.` |
|         - |  396 | `			 */` |
|   2300037 |  397 | `			SyBlobRelease(&sSig);` |
|         - |  398 | `		}` |
|         - |  399 | `		/* Save in the argument set */` |
|   2443443 |  400 | `		SySetPut(&pFunc->aArgs,(const void *)&sArg);` |
|         5 |  401 | `	}` |
|   1550553 |  402 | `	if( SyBlobLength(&sSig) > 0 ){` |
|         - |  403 | `		/* Save function signature */` |
|     96977 |  404 | `		SyStringInitFromBuf(&pFunc->sSignature,SyBlobData(&sSig),SyBlobLength(&sSig));` |
|     48486 |  405 | `	}` |
|   1550553 |  406 | `	return SXRET_OK;` |
|    775288 |  407 | `}` |
|         - |  408 | `/*` |
...
|         - |  412 | ` */` |
|     34816 |  413 | `static SyToken * GenStateSkipNestedFunc(SyToken *pIn, SyToken *pEnd)` |
|         5 |  414 | `{` |
|     34821 |  415 | `	sxi32 iParen = 0;` |
|     34821 |  416 | `	pIn++; /* past 'function'/'fn' */` |
...
|    154777 |  420 | `	while( pIn < pEnd ){` |
|    154777 |  421 | `		sxu32 t = pIn->nType;` |
|    154777 |  422 | `		if( t & PH7_TK_LPAREN ){ iParen++; }` |
|    150845 |  423 | `		else if( t & PH7_TK_RPAREN ){ iParen--; }` |
|    104431 |  424 | `		else if( (t & PH7_TK_OCB) && iParen <= 0 ){ break; }` |
|     85063 |  425 | `		else if( (t & PH7_TK_SEMI) && iParen <= 0 ){ return pIn; }` |
|    119961 |  426 | `		pIn++;` |
|         5 |  427 | `	}` |
|     19373 |  428 | `	if( pIn >= pEnd ){ return pIn; }` |
|         - |  429 | `	/* pIn at the body '{' — skip the balanced brace block. */` |
|         - |  430 | `	{` |
|     19373 |  431 | `		sxi32 d = 0;` |
|    769201 |  432 | `		while( pIn < pEnd ){` |
|    769201 |  433 | `			sxu32 t = pIn->nType;` |
|    769201 |  434 | `			if( t & PH7_TK_OCB ){ d++; }` |
|    738239 |  435 | `			else if( t & PH7_TK_CCB ){ d--; if( d <= 0 ){ pIn++; break; } }` |
|    749833 |  436 | `			pIn++;` |
|         5 |  437 | `		}` |
|         - |  438 | `	}` |
|     19373 |  439 | `	return pIn;` |
|     17413 |  440 | `}` |
|         - |  441 | `/*` |
...
|         - |  452 | ` * mixed, object.` |
|         - |  453 | ` */` |
|     11610 |  454 | `static int GenStateGenRetNameOk(const char *zName,sxu32 nName)` |
|         5 |  455 | `{` |
...
|         - |  459 | `	};` |
|         - |  460 | `	sxu32 i;` |
|     11615 |  461 | `	if( nName > 0 && zName[0] == '\\' ){` |
|       ! 0 |  462 | `		zName++;` |
|       ! 0 |  463 | `		nName--;` |
|       ! 0 |  464 | `	}` |
|     11623 |  465 | `	for( i = 0; i < SX_ARRAYSIZE(aOk); i++ ){` |
|     11623 |  466 | `		if( nName == aOk[i].nLen && SyStrnicmp(zName,aOk[i].zName,nName) == 0 ){` |
|     11615 |  467 | `			return 1;` |
|         - |  468 | `		}` |
|         5 |  469 | `	}` |
|       ! 0 |  470 | `	return 0;` |
...
|         - |  483 | ` */` |
|     11612 |  484 | `static int GenStateGenRetAtomOk(ph7_gen_state *pGen,sxu32 nType,const SyString *pName)` |
|         5 |  485 | `{` |
|     11617 |  486 | `	if( nType == MEMOBJ_OBJ ){` |
|       ! 0 |  487 | ``		return 1; /* bare `object` */`` |
|         - |  488 | `	}` |
|     11617 |  489 | `	if( nType != SXU32_HIGH ){` |
|         3 |  490 | `		return 0; /* scalar/array/void/never/null/... */` |
|         - |  491 | `	}` |
|     11615 |  492 | `	if( GenStateGenRetNameOk(pName->zString,pName->nByte) ){` |
|     11615 |  493 | `		return 1;` |
|         - |  494 | `	}` |
...
|         - |  518 | ` */` |
|     11854 |  519 | `static sxi32 GenStateValidateGeneratorReturnType(ph7_gen_state *pGen,ph7_vm_func *pFunc)` |
|         5 |  520 | `{` |
|     11859 |  521 | `	int bOk = 0;` |
|         - |  522 | `	sxu32 nLine;` |
|         - |  523 | `	sxi32 rc;` |
|     11859 |  524 | `	if( pFunc->nReturnType < 1 && SySetUsed(&pFunc->aReturnUnion) < 1 ){` |
|       247 |  525 | `		return SXRET_OK; /* untyped: nothing to validate */` |
|         - |  526 | `	}` |
|     11617 |  527 | `	if( SySetUsed(&pFunc->aReturnUnion) > 0 ){` |
...
|       ! 0 |  544 | `		}` |
|       ! 0 |  545 | `	}else{` |
|     11617 |  546 | `		bOk = GenStateGenRetAtomOk(&(*pGen),pFunc->nReturnType,&pFunc->sReturnClass);` |
|         - |  547 | `	}` |
|     11617 |  548 | `	if( bOk ){` |
|     11615 |  549 | `		return SXRET_OK;` |
|         - |  550 | `	}` |
...
|      5932 |  575 | `}` |
|   3263412 |  576 | `static int GenStateFuncBodyHasYield(ph7_gen_state *pGen)` |
|         5 |  577 | `{` |
|   3263417 |  578 | `	SyToken *pIn = pGen->pIn;   /* expected at the body's opening '{' */` |
|   3263417 |  579 | `	SyToken *pEnd = pGen->pEnd;` |
|   3263417 |  580 | `	sxi32 iDepth = 0;` |
|   3263417 |  581 | `	int bStarted = 0;` |
| 149487473 |  582 | `	while( pIn < pEnd ){` |
| 149487473 |  583 | `		sxu32 t = pIn->nType;` |
| 149487473 |  584 | `		if( t & PH7_TK_OCB ){ iDepth++; bStarted = 1; pIn++; continue; }` |
| 142754943 |  585 | `		if( t & PH7_TK_CCB ){ iDepth--; pIn++; if( bStarted && iDepth <= 0 ){ break; } continue; }` |
| 136057555 |  586 | `		if( t & PH7_TK_KEYWORD ){` |
|  10162913 |  587 | `			int kw = SX_PTR_TO_INT(pIn->pUserData);` |
|  10162913 |  588 | `			if( kw == PH7_TKWRD_YIELD ){ return TRUE; }` |
|  10151059 |  589 | `			if( kw == PH7_TKWRD_FUNCTION ){ pIn = GenStateSkipNestedFunc(pIn,pEnd); continue; }` |
|         - |  590 | ``			/* `fn` arrow bodies are single expressions and cannot contain a valid yield. */`` |
|   5058119 |  591 | `		}` |
| 136010885 |  592 | `		pIn++;` |
|         5 |  593 | `	}` |
|   3251563 |  594 | `	return FALSE;` |
|   1631711 |  595 | `}` |
|         - |  596 | `/*` |
...
|         - |  600 | ` */` |
|   3263412 |  601 | `PH7_PRIVATE sxi32 GenStateCompileFuncBody(` |
...
|   3263417 |  611 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC,PH7_VmInstrLength(pGen->pVm),pFunc,&pBlock);` |
|   3263417 |  612 | `	if( rc != SXRET_OK ){` |
...
|         - |  616 | `	}` |
|   3263417 |  617 | `	nGotoOfft = SySetUsed(&pGen->aGoto);` |
|         - |  618 | `	/* Swap bytecode containers */` |
|   3263417 |  619 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   3263417 |  620 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pFunc->aByteCode);` |
...
|         - |  625 | `	{` |
|   3263417 |  626 | `		sxu32 nArg = SySetUsed(&pFunc->aArgs);` |
|         - |  627 | `		sxu32 i;` |
|   5652611 |  628 | `		for( i = 0; i < nArg; i++ ){` |
|   2389199 |  629 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pFunc->aArgs,i);` |
|         - |  630 | `			char *zSrc;` |
|         - |  631 | `			sxu32 nSrc,nName;` |
|         - |  632 | `			SySet sToken;` |
|         - |  633 | `			SyToken *pTmpIn,*pTmpEnd;` |
|         - |  634 | `			sxi32 rcPromote;` |
|   2389199 |  635 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|   2389123 |  636 | `				continue;` |
|         - |  637 | `			}` |
...
|         - |  687 | `	{` |
|   3263417 |  688 | `		sxi8 bSavedGen = pGen->bInGenerator;` |
|   3263417 |  689 | `		pGen->bInGenerator = (sxi8)GenStateFuncBodyHasYield(&(*pGen));` |
|         - |  690 | `		/* Compile the body */` |
|   3263417 |  691 | `		PH7_CompileBlock(&(*pGen),0);` |
|   3263417 |  692 | `		pGen->bInGenerator = bSavedGen;` |
|         - |  693 | `	}` |
|         - |  694 | `	/* Fix exception jumps now the destination is resolved */` |
|   3263417 |  695 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|         - |  696 | `	/* Emit the final return if not yet done */` |
|   3263417 |  697 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|         - |  698 | `	/* Fix gotos jumps now the destination is resolved */` |
|   3263417 |  699 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),nGotoOfft) ){` |
|       ! 0 |  700 | `		rc = SXERR_ABORT;` |
|       ! 0 |  701 | `	}` |
|   3263417 |  702 | `	SySetTruncate(&pGen->aGoto,nGotoOfft);` |
|         - |  703 | `	/* Restore the default container */` |
|   3263417 |  704 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|         - |  705 | `	/* Leave function block */` |
|   3263417 |  706 | `	GenStateLeaveBlock(&(*pGen),0);` |
|   3263417 |  707 | `	if( rc == SXERR_ABORT ){` |
...
|         - |  712 | `	{` |
|   3263417 |  713 | `		VmInstr *aInstr = (VmInstr *)SySetBasePtr(&pFunc->aByteCode);` |
|         - |  714 | `		sxu32 i;` |
|  91562331 |  715 | `		for( i = 0; i < SySetUsed(&pFunc->aByteCode); i++ ){` |
|  88310773 |  716 | `			if( aInstr[i].iOp == PH7_OP_YIELD \|\| aInstr[i].iOp == PH7_OP_YIELD_FROM ){` |
|     11859 |  717 | `				pFunc->iFlags \|= VM_FUNC_GENERATOR;` |
|     11859 |  718 | `				break;` |
|         - |  719 | `			}` |
|  44149462 |  720 | `		}` |
|         - |  721 | `	}` |
|   3263417 |  722 | `	if( pFunc->iFlags & VM_FUNC_GENERATOR ){` |
|         - |  723 | `		/* php-exact definition-time check; see the helper's block comment. */` |
|     11859 |  724 | `		if( SXERR_ABORT == GenStateValidateGeneratorReturnType(&(*pGen),pFunc) ){` |
|       ! 0 |  725 | `			return SXERR_ABORT;` |
|         - |  726 | `		}` |
|      5927 |  727 | `	}` |
|         - |  728 | `	/* All done, function body compiled */` |
|   3263417 |  729 | `	return SXRET_OK;` |
|   1631711 |  730 | `}` |
|         - |  731 | `/*` |
...
|         - |  800 | ` */` |
|     42832 |  801 | `static int GenStateIsReservedTypeWord(const SyString *pName)` |
|         5 |  802 | `{` |
...
|         - |  807 | `	};` |
|         - |  808 | `	sxu32 i;` |
|    897367 |  809 | `	for( i = 0 ; i < SX_ARRAYSIZE(azWords) ; i++ ){` |
|    854655 |  810 | `		sxu32 n = (sxu32)SyStrlen(azWords[i]);` |
|    854655 |  811 | `		if( pName->nByte == n && SyStrnicmp(pName->zString,azWords[i],n) == 0 ){` |
|       125 |  812 | `			return 1;` |
|         - |  813 | `		}` |
|    427270 |  814 | `	}` |
|     42717 |  815 | `	return 0;` |
|     21421 |  816 | `}` |
|    191214 |  817 | `static sxi32 GenStateParseOneTypeAtom(ph7_gen_state *pGen, PhlTypeAtom *pOut)` |
|         5 |  818 | `{` |
|    191219 |  819 | `	SyToken *pIn = pGen->pIn;` |
|    191219 |  820 | `	int bAbsolute = 0;` |
|    191219 |  821 | `	SyZero(pOut, sizeof(*pOut));` |
|    191219 |  822 | `	SyStringInitFromBuf(&pOut->sClass, 0, 0);` |
|    191219 |  823 | `	if( pIn >= pGen->pEnd ){` |
|       ! 0 |  824 | `		return SXERR_SYNTAX;` |
|         - |  825 | `	}` |
|         - |  826 | `	/* Optional leading namespace separator '\' on FQN class types */` |
|    191219 |  827 | `	if( pIn->nType & PH7_TK_NSSEP ){` |
...
|         - |  832 | `		}` |
|         4 |  833 | `	}` |
|    191219 |  834 | `	if( (pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|       ! 0 |  835 | `		return SXERR_SYNTAX;` |
|         - |  836 | `	}` |
|    191219 |  837 | `	if( pIn->nType & PH7_TK_KEYWORD ){` |
|    148151 |  838 | `		sxu32 nKey = (sxu32)(SX_PTR_TO_INT(pIn->pUserData));` |
|    148151 |  839 | `		if( nKey & PH7_TKWRD_ARRAY ){` |
|     15537 |  840 | `			pOut->nType = MEMOBJ_HASHMAP; pOut->zCanon = "array"; pOut->nCanon = 5;` |
|    140385 |  841 | `		}else if( nKey & PH7_TKWRD_BOOL ){` |
|      7811 |  842 | `			pOut->nType = MEMOBJ_BOOL; pOut->zCanon = "bool"; pOut->nCanon = 4;` |
|    128716 |  843 | `		}else if( nKey & PH7_TKWRD_INT ){` |
|     47051 |  844 | `			pOut->nType = MEMOBJ_INT; pOut->zCanon = "int"; pOut->nCanon = 3;` |
|    101290 |  845 | `		}else if( nKey & PH7_TKWRD_STRING ){` |
|     77671 |  846 | `			pOut->nType = MEMOBJ_STRING; pOut->zCanon = "string"; pOut->nCanon = 6;` |
|     38934 |  847 | `		}else if( nKey & PH7_TKWRD_FLOAT ){` |
...
|     43073 |  862 | `		SyString *pT = &pIn->sData;` |
|     43073 |  863 | `		if( pT->nByte == 4 && SyMemcmpNoCase(pT->zString, "null", 4) == 0 ){` |
|        34 |  864 | `			pOut->nType = UTA_NULL_FLAG; pOut->zCanon = "null"; pOut->nCanon = 4;` |
|        34 |  865 | `			pIn++;` |
|     43058 |  866 | `		}else if( pT->nByte == 4 && SyMemcmpNoCase(pT->zString, "void", 4) == 0 ){` |
|       181 |  867 | `			pOut->nType = UTA_VOID_FLAG; pOut->zCanon = "void"; pOut->nCanon = 4;` |
|       181 |  868 | `			pIn++;` |
|     42955 |  869 | `		}else if( pT->nByte == 5 && SyMemcmpNoCase(pT->zString, "never", 5) == 0 ){` |
|        27 |  870 | `			pOut->nType = UTA_NEVER_FLAG; pOut->zCanon = "never"; pOut->nCanon = 5;` |
|        27 |  871 | `			pIn++;` |
|        16 |  872 | `		}else{` |
|         - |  873 | `			/* Class / interface name; consume namespace path a\b\c */` |
|     42845 |  874 | `			SyToken *pFirst = pIn;` |
|     42845 |  875 | `			SyToken *pLast = pIn;` |
|     42845 |  876 | `			pOut->nType = SXU32_HIGH;` |
|     42845 |  877 | `			pOut->sClass = pIn->sData;` |
|     42845 |  878 | `			pIn++;` |
|     64263 |  879 | `			while( pIn + 1 < pGen->pEnd && (pIn->nType & PH7_TK_NSSEP)` |
|     42848 |  880 | `				&& (pIn[1].nType & PH7_TK_ID) ){` |
|         3 |  881 | `				pLast = &pIn[1];` |
|         3 |  882 | `				pIn += 2;` |
|         1 |  883 | `			}` |
|     42845 |  884 | `			if( pLast != pFirst ){` |
...
|     42845 |  898 | `			if( !bAbsolute && pLast == pFirst && !GenStateIsReservedTypeWord(&pOut->sClass) ){` |
|         - |  899 | `				SyBlob sFqn;` |
|     42717 |  900 | `				SyBlobInit(&sFqn,&pGen->pVm->sAllocator);` |
|     42717 |  901 | `				GenStateResolveName(pGen,&pOut->sClass,&sFqn);` |
|     42712 |  902 | `				if( SyBlobLength(&sFqn) != pOut->sClass.nByte` |
|     42712 |  903 | `				 \|\| SyMemcmp(SyBlobData(&sFqn),(const void *)pOut->sClass.zString,pOut->sClass.nByte) != 0 ){` |
...
|         5 |  908 | `					}` |
|         5 |  909 | `				}` |
|     42717 |  910 | `				SyBlobRelease(&sFqn);` |
|     21356 |  911 | `			}` |
|         - |  912 | `		}` |
|         - |  913 | `	}` |
|    191217 |  914 | `	pGen->pIn = pIn;` |
|    191217 |  915 | `	return SXRET_OK;` |
|     95612 |  916 | `}` |
|         - |  917 |  |
|         - |  918 | `/*` |
...
|         - |  924 | ` */` |
|    191038 |  925 | `static void GenBuildUnionTypeText(SyBlob *pBlob, PhlTypeAtom *aAtoms, int nAtoms, int bNullable)` |
|         5 |  926 | `{` |
|         - |  927 | `	int i;` |
|    191043 |  928 | `	int nNonNull = 0;` |
|    191043 |  929 | `	int bAnyIntersection = 0;` |
|         - |  930 | `	sxu32 aGroupCount[PHL_UNION_MAX_ALTS];` |
|    191043 |  931 | `	sxu32 nMaxGroup = 0;` |
|   6304259 |  932 | `	for( i = 0; i < PHL_UNION_MAX_ALTS; i++ ) aGroupCount[i] = 0;` |
|    382231 |  933 | `	for( i = 0; i < nAtoms; i++ ){` |
|    191193 |  934 | `		if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|    191163 |  935 | `			nNonNull++;` |
|    191163 |  936 | `			if( aAtoms[i].nGroup < PHL_UNION_MAX_ALTS ){` |
|    191163 |  937 | `				aGroupCount[aAtoms[i].nGroup]++;` |
|    191163 |  938 | `				if( aAtoms[i].nGroup > nMaxGroup ) nMaxGroup = aAtoms[i].nGroup;` |
|     95579 |  939 | `			}` |
|     95579 |  940 | `		}` |
|     95599 |  941 | `	}` |
|    382179 |  942 | `	for( i = 0; i < nAtoms; i++ ){` |
|    191165 |  943 | `		if( aAtoms[i].nType != UTA_NULL_FLAG && aGroupCount[aAtoms[i].nGroup] >= 2 ){` |
|        29 |  944 | `			bAnyIntersection = 1;` |
|        29 |  945 | `			break;` |
|         - |  946 | `		}` |
|     95573 |  947 | `	}` |
|    191043 |  948 | `	if( bAnyIntersection ){` |
...
|      9742 |  983 | `		return;` |
|         - |  984 | `	}` |
|    191019 |  985 | `	if( nNonNull == 1 && bNullable ){` |
|         - |  986 | `		/* Shorthand: ?T */` |
|     19431 |  987 | `		for( i = 0; i < nAtoms; i++ ){` |
|     19431 |  988 | `			if( aAtoms[i].nType == UTA_NULL_FLAG ) continue;` |
|     19431 |  989 | `			SyBlobAppend(pBlob, "?", 1);` |
|     19431 |  990 | `			if( aAtoms[i].nType == SXU32_HIGH ){` |
|     11617 |  991 | `				SyBlobAppend(pBlob, aAtoms[i].sClass.zString, aAtoms[i].sClass.nByte);` |
|      5811 |  992 | `			}else{` |
|      7819 |  993 | `				SyBlobAppend(pBlob, aAtoms[i].zCanon, aAtoms[i].nCanon);` |
|         - |  994 | `			}` |
|     19431 |  995 | `			return;` |
|       ! 0 |  996 | `		}` |
|       ! 0 |  997 | `	}` |
|         - |  998 | `	{` |
|    171593 |  999 | `		int bFirst = 1;` |
|         - | 1000 | `		/* 1) Classes in declaration order */` |
|    343287 | 1001 | `		for( i = 0; i < nAtoms; i++ ){` |
|    171699 | 1002 | `			if( aAtoms[i].nType == SXU32_HIGH ){` |
|     31215 | 1003 | `				if( !bFirst ) SyBlobAppend(pBlob, "\|", 1);` |
|     31215 | 1004 | `				SyBlobAppend(pBlob, aAtoms[i].sClass.zString, aAtoms[i].sClass.nByte);` |
|     31215 | 1005 | `				bFirst = 0;` |
|     15605 | 1006 | `			}` |
|     85852 | 1007 | `		}` |
...
|         - | 1012 | `			int k;` |
|   1201121 | 1013 | `			for( k = 0; k < (int)(sizeof(aOrder)/sizeof(aOrder[0])); k++ ){` |
|   1919307 | 1014 | `				for( i = 0; i < nAtoms; i++ ){` |
|   1030057 | 1015 | `					if( aAtoms[i].nType == aOrder[k] ){` |
|    140283 | 1016 | `						if( !bFirst ) SyBlobAppend(pBlob, "\|", 1);` |
|    140283 | 1017 | `						SyBlobAppend(pBlob, aAtoms[i].zCanon, aAtoms[i].nCanon);` |
|    140283 | 1018 | `						bFirst = 0;` |
|    140283 | 1019 | `						break;` |
|         - | 1020 | `					}` |
|    444892 | 1021 | `				}` |
|    514769 | 1022 | `			}` |
...
|         - | 1045 | ` */` |
|    191188 | 1046 | `static sxi32 GenStateParsePart(` |
|         - | 1047 | `	ph7_gen_state *pGen, PhlTypeAtom *aAtoms, int *pnAtoms, sxu32 iGroup,` |
|         - | 1048 | `	int *pnMembers, int *pbParen, sxu32 nLine)` |
|         5 | 1049 | `{` |
|         - | 1050 | `	sxi32 rc;` |
|    191193 | 1051 | `	int nMembers = 0;` |
|    191193 | 1052 | `	int bParen = 0;` |
|    191193 | 1053 | `	*pnMembers = 0;` |
|    191193 | 1054 | `	*pbParen = 0;` |
|    191193 | 1055 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_LPAREN) ){` |
|         9 | 1056 | `		bParen = 1;` |
|         9 | 1057 | `		pGen->pIn++; /* skip '(' */` |
|         3 | 1058 | `	}` |
|     95594 | 1059 | `	for(;;){` |
|    191219 | 1060 | `		if( *pnAtoms >= PHL_UNION_MAX_ALTS ){` |
...
|         - | 1064 | `		}` |
|    191219 | 1065 | `		rc = GenStateParseOneTypeAtom(pGen, &aAtoms[*pnAtoms]);` |
|    191219 | 1066 | `		if( rc != SXRET_OK ){` |
|         3 | 1067 | `			return rc;` |
|         - | 1068 | `		}` |
|    191217 | 1069 | `		aAtoms[*pnAtoms].nGroup = iGroup;` |
|    191217 | 1070 | `		(*pnAtoms)++;` |
|    191217 | 1071 | `		nMembers++;` |
|         - | 1072 | ``		/* Continue the intersection while `&` is followed by another type atom. */`` |
|    191217 | 1073 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
...
|         - | 1094 | `		}` |
|         3 | 1095 | `	}` |
|    191191 | 1096 | `	*pnMembers = nMembers;` |
|    191191 | 1097 | `	*pbParen = bParen;` |
|    191191 | 1098 | `	return SXRET_OK;` |
|     95599 | 1099 | `}` |
|         - | 1100 |  |
|         - | 1101 | `/*` |
...
|         - | 1118 | ` */` |
|    191054 | 1119 | `PH7_PRIVATE sxi32 GenStateParseUnionTypeDecl(` |
...
|    191059 | 1132 | `	int nAtoms = 0;` |
|    191059 | 1133 | `	int bShortNullable = 0;` |
|    191059 | 1134 | `	int bExplicitNull = 0;` |
|         - | 1135 | `	sxi32 rc;` |
|    191059 | 1136 | `	*pnType = 0;` |
|    191059 | 1137 | `	if( pClass ) SyStringInitFromBuf(pClass, 0, 0);` |
|    191059 | 1138 | `	*piTypeFlags = 0;` |
|    191059 | 1139 | `	if( pTypeText ) SyStringInitFromBuf(pTypeText, 0, 0);` |
|         - | 1140 |  |
|    191059 | 1141 | `	if( pGen->pIn >= pGen->pEnd ){` |
|       ! 0 | 1142 | `		return SXRET_OK;` |
|         - | 1143 | `	}` |
|         - | 1144 | ``	/* Optional `?` shorthand prefix */`` |
|    191054 | 1145 | `	if( (pGen->pIn->nType & PH7_TK_OP) && pGen->pIn->sData.nByte == 1` |
|     19419 | 1146 | `	 && pGen->pIn->sData.zString[0] == '?' ){` |
|     19419 | 1147 | `		bShortNullable = 1;` |
|     19419 | 1148 | `		pGen->pIn++;` |
|     19419 | 1149 | `		if( pGen->pIn >= pGen->pEnd ){` |
...
|    191059 | 1158 | `		sxu32 iGroup = 0;` |
|    191059 | 1159 | `		rc = GenStateParsePart(pGen, aAtoms, &nAtoms, iGroup, &nMembers, &bParen, nLine);` |
|    191059 | 1160 | `		if( rc != SXRET_OK ){` |
|         4 | 1161 | `			return rc;` |
|         - | 1162 | `		}` |
...
|    286784 | 1168 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OP)` |
|    191263 | 1169 | `			&& pGen->pIn->sData.nByte == 1 && pGen->pIn->sData.zString[0] == '\|' ){` |
...
|         - | 1187 | `			}` |
|         5 | 1188 | `		}` |
|    191055 | 1189 | `		if( iGroup > 0 && nMembers >= 2 && !bParen ){` |
...
|         - | 1201 | `	{` |
|         - | 1202 | `		int i, j;` |
|    191055 | 1203 | `		int bHasNonNull = 0;` |
|    191055 | 1204 | `		int bAnyIntersection = 0;` |
...
|   6304655 | 1208 | `		for( i = 0; i < PHL_UNION_MAX_ALTS; i++ ) aGroupCount[i] = 0;` |
|    382265 | 1209 | `		for( i = 0; i < nAtoms; i++ ){` |
|    191215 | 1210 | `			if( aAtoms[i].nGroup < PHL_UNION_MAX_ALTS ) aGroupCount[aAtoms[i].nGroup]++;` |
|     95610 | 1211 | `		}` |
|    382209 | 1212 | `		for( i = 0; i < nAtoms; i++ ){` |
|    191185 | 1213 | `			if( aGroupCount[aAtoms[i].nGroup] >= 2 ){ bAnyIntersection = 1; break; }` |
|     95582 | 1214 | `		}` |
...
|    191055 | 1217 | `		if( bShortNullable && bAnyIntersection ){` |
...
|         - | 1221 | `		}` |
|    382251 | 1222 | `		for( i = 0; i < nAtoms; i++ ){` |
...
|    191213 | 1226 | `			if( aGroupCount[aAtoms[i].nGroup] >= 2 ){` |
...
|         - | 1248 | `				}` |
|        24 | 1249 | `			}` |
|    191211 | 1250 | `			if( aAtoms[i].nType == UTA_VOID_FLAG ){` |
...
|         - | 1265 | `				}` |
|        87 | 1266 | `			}` |
|    191209 | 1267 | `			if( aAtoms[i].nType == UTA_NEVER_FLAG ){` |
...
|         - | 1284 | `				}` |
|         8 | 1285 | `			}` |
|    191203 | 1286 | `			if( aAtoms[i].nType == UTA_NULL_FLAG ){` |
|        34 | 1287 | `				bExplicitNull = 1;` |
|        19 | 1288 | `			}else{` |
|    191173 | 1289 | `				bHasNonNull = 1;` |
|         - | 1290 | `			}` |
...
|        98 | 1328 | `			}` |
|     95603 | 1329 | `		}` |
|    191043 | 1330 | `		if( !bHasNonNull && bExplicitNull ){` |
...
|    191043 | 1345 | `	if( bShortNullable \|\| bExplicitNull ){` |
|     19447 | 1346 | `		*piTypeFlags \|= iNullableFlag;` |
|      9721 | 1347 | `	}` |
|         - | 1348 | `	/* Build canonical type text */` |
|    191043 | 1349 | `	if( pTypeText ){` |
|         - | 1350 | `		SyBlob sBlob;` |
|    191043 | 1351 | `		SyBlobInit(&sBlob, &pGen->pVm->sAllocator);` |
|    276856 | 1352 | `		GenBuildUnionTypeText(&sBlob, aAtoms, nAtoms,` |
|     95519 | 1353 | `			(bShortNullable \|\| bExplicitNull) ? 1 : 0);` |
|    191043 | 1354 | `		if( SyBlobLength(&sBlob) > 0 ){` |
|    286277 | 1355 | `			char *zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|    190848 | 1356 | `				(const char *)SyBlobData(&sBlob), SyBlobLength(&sBlob));` |
|    190853 | 1357 | `			if( zDup ){` |
|    190853 | 1358 | `				SyStringInitFromBuf(pTypeText, zDup, SyBlobLength(&sBlob));` |
|     95424 | 1359 | `			}` |
|     95424 | 1360 | `		}` |
|    191043 | 1361 | `		SyBlobRelease(&sBlob);` |
|     95519 | 1362 | `	}` |
...
|         - | 1366 | `	{` |
|    191043 | 1367 | `		int nNonNull = 0;` |
|    191043 | 1368 | `		int iNonNullIdx = -1;` |
|         - | 1369 | `		int i;` |
|    382231 | 1370 | `		for( i = 0; i < nAtoms; i++ ){` |
|    191193 | 1371 | `			if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|    191163 | 1372 | `				nNonNull++;` |
|    191163 | 1373 | `				iNonNullIdx = i;` |
|     95579 | 1374 | `			}` |
|     95599 | 1375 | `		}` |
|    191043 | 1376 | `		if( nNonNull <= 1 ){` |
|         - | 1377 | `			/* Fast path: store as single type. */` |
|    190939 | 1378 | `			if( iNonNullIdx >= 0 ){` |
|    190933 | 1379 | `				PhlTypeAtom *pA = &aAtoms[iNonNullIdx];` |
|    190933 | 1380 | `				if( pA->nType == SXU32_HIGH ){` |
|     64178 | 1381 | `					char *zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|     21391 | 1382 | `						pA->sClass.zString, pA->sClass.nByte);` |
|     42787 | 1383 | `					if( zDup == 0 ) return SXERR_ABORT;` |
|     42787 | 1384 | `					*pnType = SXU32_HIGH;` |
|     42787 | 1385 | `					if( pClass ) SyStringInitFromBuf(pClass, zDup, pA->sClass.nByte);` |
|    169542 | 1386 | `				}else if( pA->nType == UTA_VOID_FLAG ){` |
|       179 | 1387 | `					*pnType = MEMOBJ_VOID;` |
|    148064 | 1388 | `				}else if( pA->nType == UTA_NEVER_FLAG ){` |
|        18 | 1389 | `					*pnType = MEMOBJ_NEVER;` |
|        10 | 1390 | `				}else{` |
|    147961 | 1391 | `					*pnType = pA->nType;` |
|         - | 1392 | `				}` |
|     95464 | 1393 | `			}` |
|     95472 | 1394 | `		}else{` |
...
|         - | 1426 | ` */` |
|   3403016 | 1427 | `PH7_PRIVATE sxi32 GenStateParseReturnType(ph7_gen_state *pGen, ph7_vm_func *pFunc)` |
|         5 | 1428 | `{` |
|   3403021 | 1429 | `	sxi32 iFlags = 0;` |
|         - | 1430 | `	sxi32 rc;` |
|         - | 1431 | `	sxu32 nLine;` |
|   3403021 | 1432 | `	pFunc->nReturnType = 0;` |
|   3403021 | 1433 | `	SyStringInitFromBuf(&pFunc->sReturnClass, 0, 0);` |
|   3403021 | 1434 | `	SyStringInitFromBuf(&pFunc->sReturnTypeName, 0, 0);` |
...
|   3403021 | 1440 | `	SySetReset(&pFunc->aReturnUnion);` |
|   3403021 | 1441 | `	pFunc->iFlags &= ~VM_FUNC_RETURN_NULLABLE;` |
|   3403021 | 1442 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COLON) == 0 ){` |
|   3371297 | 1443 | `		return SXRET_OK;` |
|         - | 1444 | `	}` |
|     31729 | 1445 | `	pGen->pIn++; /* Skip ':' */` |
|     31729 | 1446 | `	if( pGen->pIn >= pGen->pEnd ){` |
|       ! 0 | 1447 | `		return SXRET_OK;` |
|         - | 1448 | `	}` |
|     31729 | 1449 | `	nLine = pGen->pIn->nLine;` |
|     31729 | 1450 | `	rc = GenStateParseUnionTypeDecl(` |
|     15862 | 1451 | `		pGen,` |
|     15862 | 1452 | `		&pFunc->nReturnType,` |
|     15862 | 1453 | `		&pFunc->sReturnClass,` |
|     15862 | 1454 | `		&pFunc->aReturnUnion,` |
|         - | 1455 | `		&iFlags,` |
|     15862 | 1456 | `		&pFunc->sReturnTypeName,` |
...
|         - | 1460 | `		/* bAllowVoid */ 1,` |
|     15862 | 1461 | `		nLine);` |
|     31729 | 1462 | `	if( rc == SXERR_ABORT ){` |
|       ! 0 | 1463 | `		return SXERR_ABORT;` |
|         - | 1464 | `	}` |
|     31729 | 1465 | `	if( rc == SXERR_CORRUPT ){` |
|         - | 1466 | `		/* Error already reported */` |
|       ! 0 | 1467 | `		return SXERR_SYNTAX;` |
|         - | 1468 | `	}` |
|     31729 | 1469 | `	if( rc == SXERR_SYNTAX ){` |
...
|         - | 1479 | `	}` |
|     31723 | 1480 | `	pFunc->iFlags \|= (iFlags & VM_FUNC_RETURN_NULLABLE);` |
|     31723 | 1481 | `	return SXRET_OK;` |
|   1701513 | 1482 | `}` |
|         - | 1483 |  |
|    519538 | 1484 | `PH7_PRIVATE sxi32 GenStateCompileFunc(` |
...
|    519543 | 1498 | `	nLine = pGen->pIn->nLine;` |
|         - | 1499 | `	/* Jump the left parenthesis '(' */` |
|    519543 | 1500 | `	pGen->pIn++;` |
|         - | 1501 | `	/* Delimit the function signature */` |
|    519543 | 1502 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|    519543 | 1503 | `	if( pEnd >= pGen->pEnd ){` |
|         - | 1504 | `		/* Syntax error */` |
...
|    519535 | 1515 | `	pFunc = (ph7_vm_func *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_vm_func));` |
|    519535 | 1516 | `	if( pFunc == 0 ){` |
|       ! 0 | 1517 | `		goto OutOfMem;` |
|         - | 1518 | `	}` |
|         - | 1519 | `	/* Build the function name, prepending namespace if active */` |
|    519543 | 1520 | `	if( SyBlobLength(&pGen->sNamespace) > 0 && !bHandleClosure ){` |
|         - | 1521 | `		SyBlob sFQN;` |
|         - | 1522 | `		sxu32 nLen;` |
...
|        10 | 1534 | `	}else{` |
|    519519 | 1535 | `		zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|    519519 | 1536 | `		if( zName == 0 ){` |
|       ! 0 | 1537 | `			goto OutOfMem;` |
|         - | 1538 | `		}` |
|    519519 | 1539 | `		PH7_VmInitFuncState(pGen->pVm,pFunc,zName,pName->nByte,iFlags,0);` |
|         - | 1540 | `	}` |
...
|    519535 | 1543 | `	pFunc->nLine = nLine;` |
|    519535 | 1544 | `	GenStateConsumeDoc(&(*pGen),&pFunc->sDoc);` |
|    519535 | 1545 | `	if( GenStateConsumeAttrs(&(*pGen),&pFunc->aAttrs) == SXERR_ABORT ){` |
|       ! 0 | 1546 | `		return SXERR_ABORT;` |
|         - | 1547 | `	}` |
|    519535 | 1548 | `	if( pGen->pIn < pEnd ){` |
|         - | 1549 | `		/* Collect function arguments */` |
|    441269 | 1550 | `		rc = GenStateCollectFuncArgs(pFunc,&(*pGen),pEnd,0,0);` |
|    441269 | 1551 | `		if( rc == SXERR_ABORT ){` |
...
|    519533 | 1557 | `	pGen->pIn = &pEnd[1];` |
|         - | 1558 | `	{` |
|    519533 | 1559 | `		sxi32 rcRt = GenStateParseReturnType(pGen, pFunc);` |
|    519533 | 1560 | `		if( rcRt == SXERR_ABORT ){` |
|       ! 0 | 1561 | `			return SXERR_ABORT;` |
|    519533 | 1562 | `		}else if( rcRt == SXERR_SYNTAX ){` |
|         9 | 1563 | `			return SXERR_SYNTAX;` |
|         - | 1564 | `		}` |
|         - | 1565 | `	}` |
|    519527 | 1566 | `	if( bHandleClosure ){` |
...
|    519527 | 1676 | `	rc = GenStateCompileFuncBody(&(*pGen),pFunc);` |
|    519527 | 1677 | `	if( rc == SXERR_ABORT ){` |
|       ! 0 | 1678 | `		return SXERR_ABORT;` |
|         - | 1679 | `	}` |
|         - | 1680 | `	/* The cursor sits just past the body's closing brace */` |
|    519527 | 1681 | `	pFunc->nEndLine = pGen->pIn[-1].nLine;` |
|    519527 | 1682 | `	if( ppFunc ){` |
|    519527 | 1683 | `		*ppFunc = pFunc;` |
|    259761 | 1684 | `	}` |
|    519527 | 1685 | `	rc = SXRET_OK;` |
|    519527 | 1686 | `	if( (pFunc->iFlags & VM_FUNC_CLOSURE) == 0 ){` |
|         - | 1687 | `		/* Reject a php-fatal redeclaration before hoisting the function */` |
|    518933 | 1688 | `		if( GenStateGuardFuncRedeclaration(pGen,pFunc) == SXERR_ABORT ){` |
|         6 | 1689 | `			return SXERR_ABORT;` |
|         - | 1690 | `		}` |
|         - | 1691 | `		/* Finally register the function */` |
|    518929 | 1692 | `		rc = PH7_VmInstallUserFunction(pGen->pVm,pFunc,0);` |
|    259462 | 1693 | `	}` |
|    519523 | 1694 | `	if( rc == SXRET_OK ){` |
|    519523 | 1695 | `		return SXRET_OK;` |
|         - | 1696 | `	}` |
...
|         - | 1708 | ` */` |
|    518930 | 1709 | `PH7_PRIVATE sxi32 PH7_CompileFunction(ph7_gen_state *pGen)` |
|         5 | 1710 | `{` |
|         - | 1711 | `	SyString *pName;` |
|         - | 1712 | `	sxi32 iFlags;` |
|         - | 1713 | `	sxu32 nKwLine;` |
...
|         - | 1715 | `	sxi32 rc;` |
|         - | 1716 |  |
|    518935 | 1717 | `	nLine = pGen->pIn->nLine;` |
|    518935 | 1718 | `	nKwLine = nLine; /* Line of the 'function' keyword (Reflection getStartLine) */` |
|    518935 | 1719 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|    518935 | 1720 | `	iFlags = 0;` |
|    518935 | 1721 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|         - | 1722 | `		/* Return by reference,remember that */` |
|        12 | 1723 | `		iFlags \|= VM_FUNC_REF_RETURN;` |
|         - | 1724 | `		/* Jump the '&' token */` |
|        12 | 1725 | `		pGen->pIn++;` |
|         5 | 1726 | `	}` |
|    518935 | 1727 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|         - | 1738 | `	}` |
|    518929 | 1739 | `	pName = &pGen->pIn->sData;` |
|    518929 | 1740 | `	nLine = pGen->pIn->nLine;` |
|         - | 1741 | `	/* Jump the function name */` |
|    518929 | 1742 | `	pGen->pIn++;` |
|    518929 | 1743 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|         - | 1744 | `		/* Syntax error */` |
...
|         - | 1757 | `	{` |
|    518927 | 1758 | `		ph7_vm_func *pFuncState = 0;` |
|    518927 | 1759 | `		rc = GenStateCompileFunc(&(*pGen),pName,iFlags,FALSE,&pFuncState);` |
|    518927 | 1760 | `		if( pFuncState ){` |
|         - | 1761 | `			/* Reflection getStartLine(): line of the 'function' keyword */` |
|    518911 | 1762 | `			pFuncState->nLine = nKwLine;` |
|    259453 | 1763 | `		}` |
|         - | 1764 | `	}` |
|    518927 | 1765 | `	return rc;` |
|    259470 | 1766 | `}` |
|         - | 1767 |  |
