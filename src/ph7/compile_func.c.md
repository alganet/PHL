...
|         - |   67 | ` */` |
|    705232 |   68 | `static sxi32 GenStateProcessArgValue(ph7_gen_state *pGen,ph7_vm_func_arg *pArg,SyToken *pIn,SyToken *pEnd)` |
|         5 |   69 | `{` |
|         - |   70 | `	SyToken *pTmpIn,*pTmpEnd;` |
|         - |   71 | `	SySet *pInstrContainer;` |
|         - |   72 | `	sxi32 rc;` |
|         - |   73 | `	/* Swap token stream */` |
|    705237 |   74 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|    705237 |   75 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|    705237 |   76 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pArg->aByteCode);` |
|         - |   77 | `	/* Compile the expression holding the argument value */` |
|    705237 |   78 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|         - |   79 | `	/* Emit the done instruction */` |
|    705237 |   80 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,(rc != SXERR_EMPTY ? 1 : 0),0,0,0);` |
|    705237 |   81 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|    705237 |   82 | `	RE_SWAP_DELIMITER(pGen);` |
|    705237 |   83 | `	if( rc == SXERR_ABORT ){` |
|       ! 0 |   84 | `		return SXERR_ABORT;` |
|         - |   85 | `	}` |
|    705237 |   86 | `	return SXRET_OK;` |
|    352621 |   87 | `}` |
|         - |   88 | `/*` |
...
|         - |  124 | ` */` |
|   1555366 |  125 | `PH7_PRIVATE sxi32 GenStateCollectFuncArgs(ph7_vm_func *pFunc,ph7_gen_state *pGen,SyToken *pEnd,int bCtorCtx,int bAbstractCtx)` |
|         5 |  126 | `{` |
...
|         - |  131 | `	sxi32 rc;` |
|         - |  132 |  |
|   1555371 |  133 | `	pIn = pGen->pIn;` |
|   1555371 |  134 | `	SyBlobInit(&sSig,&pGen->pVm->sAllocator);` |
|         - |  135 | `	/* Process arguments one after one */` |
|   2003177 |  136 | `	for(;;){` |
|   4006359 |  137 | `		if( pIn >= pEnd ){` |
|         - |  138 | `			/* No more arguments to process */` |
|   1555353 |  139 | `			break;` |
|         - |  140 | `		}` |
|   2451011 |  141 | `		SyZero(&sArg,sizeof(ph7_vm_func_arg));` |
|   2451011 |  142 | `		SySetInit(&sArg.aByteCode,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|   2451011 |  143 | `		SySetInit(&sArg.aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|   2451011 |  144 | `		SySetInit(&sArg.aAttrs,&pGen->pVm->sAllocator,sizeof(ph7_attribute));` |
|   2451011 |  145 | `		SyStringInitFromBuf(&sArg.sTypeName,0,0);` |
|         - |  146 | `		/* Parameter #[...] attributes: the group precedes the parameter's` |
|         - |  147 | `		 * first token inside the main token stream */` |
|   2451011 |  148 | `		if( GenStateCollectParamAttrs(&(*pGen),pIn,&sArg.aAttrs) == SXERR_ABORT ){` |
...
|         - |  156 | `		{` |
|   2451011 |  157 | `			int bReadonly = 0, bVisSeen = 0;` |
|   2451011 |  158 | `			sxi32 iVis = PH7_CLASS_PROT_PUBLIC;` |
|   2451011 |  159 | `			sxi32 iSetVisFlag = 0;` |
|         - |  160 | `			int nSetTok;` |
|         - |  161 | `			sxi32 nSetVis;` |
|   2451011 |  162 | `			if( pIn < pEnd && GenStateIsReadonly(pIn) ){` |
|         3 |  163 | `				bReadonly = 1;` |
|         3 |  164 | `				pIn++;` |
|         1 |  165 | `			}` |
|   2451011 |  166 | `			nSetVis = GenStatePeekSetVisibility(pIn,pEnd,&nSetTok);` |
|   2451011 |  167 | `			if( nSetVis ){` |
...
|       ! 0 |  174 | `					pIn++;` |
|         1 |  175 | `				}` |
|   2451010 |  176 | `			}else if( pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD) ){` |
|    108915 |  177 | `				sxu32 nKw = (sxu32)SX_PTR_TO_INT(pIn->pUserData);` |
|    108915 |  178 | `				if( nKw == PH7_TKWRD_PUBLIC \|\| nKw == PH7_TKWRD_PROTECTED \|\| nKw == PH7_TKWRD_PRIVATE ){` |
|        91 |  179 | `					bVisSeen = 1;` |
...
|        43 |  194 | `				}` |
|     54455 |  195 | `			}` |
|   2451011 |  196 | `			if( iSetVisFlag == PH7_CLASS_ATTR_PRIVATE_SET ){` |
|         5 |  197 | `				sArg.iFlags \|= VM_FUNC_ARG_PRIV_SET;` |
|   2451009 |  198 | `			}else if( iSetVisFlag == PH7_CLASS_ATTR_PROTECTED_SET ){` |
|       ! 0 |  199 | `				sArg.iFlags \|= VM_FUNC_ARG_PROT_SET;` |
|       ! 0 |  200 | `			}` |
|   2451011 |  201 | `			if( bVisSeen \|\| bReadonly ){` |
|        95 |  202 | `				if( !bCtorCtx ){` |
...
|   2451002 |  223 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_DOLLAR) == 0` |
|   1320773 |  224 | `			&& (pIn->nType & PH7_TK_AMPER) == 0` |
|    178903 |  225 | `			&& (pIn->nType & PH7_TK_ELLIPSIS) == 0 ){` |
|    143925 |  226 | `			sxu32 nLineLocal = pIn->nLine;` |
|    143925 |  227 | `			sxi32 iTFlags = 0;` |
|    143925 |  228 | `			pGen->pIn = pIn;` |
|    143925 |  229 | `			rc = GenStateParseUnionTypeDecl(` |
|     71960 |  230 | `				pGen, &sArg.nType, &sArg.sClass, &sArg.aUnionAlts,` |
|     71960 |  231 | `				&iTFlags, &sArg.sTypeName,` |
|         - |  232 | `				VM_FUNC_ARG_NULLABLE, VM_FUNC_ARG_UNION,` |
|         - |  233 | `				/* bAllowVoid */ 0,` |
|     71960 |  234 | `						nLineLocal);` |
|    143925 |  235 | `			pIn = pGen->pIn;` |
|    143925 |  236 | `			if( rc == SXERR_ABORT ){` |
|       ! 0 |  237 | `				return SXERR_ABORT;` |
|    143925 |  238 | `			}else if( rc == SXERR_CORRUPT ){` |
|         - |  239 | `				/* Error already reported by GenStateParseUnionTypeDecl */` |
|         3 |  240 | `				return SXERR_SYNTAX;` |
|    143923 |  241 | `			}else if( rc == SXERR_SYNTAX ){` |
|         9 |  242 | `				if( pIn < pEnd ){` |
...
|         - |  251 | `			}` |
|    143915 |  252 | `			sArg.iFlags \|= iTFlags;` |
|     71955 |  253 | `		}` |
|   2450997 |  254 | `		if( pIn >= pEnd ){` |
|       ! 0 |  255 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Missing argument name");` |
|       ! 0 |  256 | `			return rc;` |
|         - |  257 | `		}` |
|   2450997 |  258 | `		if( pIn->nType & PH7_TK_AMPER ){` |
|         - |  259 | `			/* Pass by reference,record that */` |
|     23305 |  260 | `			sArg.iFlags \|= VM_FUNC_ARG_BY_REF;` |
|     23305 |  261 | `			pIn++;` |
|     11650 |  262 | `		}` |
|   2450997 |  263 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_ELLIPSIS) ){` |
|         - |  264 | `			/* Variadic parameter: ...$args */` |
|     23361 |  265 | `			sArg.iFlags \|= VM_FUNC_ARG_VARIADIC;` |
|     23361 |  266 | `			pIn++;` |
|     11678 |  267 | `		}` |
|   2450997 |  268 | `		if( pIn >= pEnd \|\| (pIn->nType & PH7_TK_DOLLAR) == 0 \|\| &pIn[1] >= pEnd \|\| (pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|         - |  269 | `			/* Invalid argument */` |
|       ! 0 |  270 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Invalid argument name");` |
|       ! 0 |  271 | `			return rc;` |
|         - |  272 | `		}` |
|   2450997 |  273 | `		pIn++; /* Jump the dollar sign */` |
|         - |  274 | `		/* Copy argument name */` |
|   2450997 |  275 | `		zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,SyStringData(&pIn->sData),SyStringLength(&pIn->sData));` |
|   2450997 |  276 | `		if( zDup == 0 ){` |
|       ! 0 |  277 | `			PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"PH7 engine is running out of memory");` |
|       ! 0 |  278 | `			return SXERR_ABORT;` |
|         - |  279 | `		}` |
|   2450997 |  280 | `		SyStringInitFromBuf(&sArg.sName,zDup,SyStringLength(&pIn->sData));` |
|   2450997 |  281 | `		pIn++;` |
|   2450997 |  282 | `		if( pIn < pEnd ){` |
|   1356769 |  283 | `			if( pIn->nType & PH7_TK_EQUAL ){` |
|         - |  284 | `				SyToken *pDefend;` |
|    705239 |  285 | `				sxi32 iNest = 0;` |
|    705239 |  286 | `				pIn++; /* Jump the equal sign */` |
|    705239 |  287 | `				pDefend = pIn;` |
|         - |  288 | `				/* Process the default value associated with this argument */` |
|   1476365 |  289 | `				while( pDefend < pEnd ){` |
|   1015247 |  290 | `					if( (pDefend->nType & PH7_TK_COMMA) && iNest <= 0 ){` |
|    244121 |  291 | `						break;` |
|         - |  292 | `					}` |
|    771131 |  293 | `					if( pDefend->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*[*/) ){` |
|         - |  294 | `						/* Increment nesting level */` |
|     27135 |  295 | `						iNest++;` |
|    757566 |  296 | `					}else if( pDefend->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CCB/*'}'*/\|PH7_TK_CSB/*]*/) ){` |
|         - |  297 | `						/* Decrement nesting level */` |
|     27135 |  298 | `						iNest--;` |
|     13565 |  299 | `					}` |
|    771131 |  300 | `					pDefend++;` |
|         5 |  301 | `				}` |
|    705239 |  302 | `				if( pIn >= pDefend ){` |
|         3 |  303 | `					rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Missing argument default value");` |
|         3 |  304 | `					return rc;` |
|         - |  305 | `				}` |
|         - |  306 | `				/* Process default value */` |
|    705237 |  307 | `				rc = GenStateProcessArgValue(&(*pGen),&sArg,pIn,pDefend);` |
|    705237 |  308 | `				if( rc != SXRET_OK ){` |
|       ! 0 |  309 | `					return rc;` |
|         - |  310 | `				}` |
...
|    705232 |  316 | `				if( (sArg.nType > 0 \|\| (sArg.iFlags & VM_FUNC_ARG_UNION))` |
|    383631 |  317 | `					&& (sArg.iFlags & VM_FUNC_ARG_NULLABLE) == 0` |
|    375880 |  318 | `					&& &pIn[1] == pDefend` |
|     38779 |  319 | `					&& pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)` |
|     21328 |  320 | `					&& pIn->sData.nByte == sizeof("null")-1` |
|      5820 |  321 | `					&& SyStrnicmp(SyStringData(&pIn->sData),"null",sizeof("null")-1) == 0 ){` |
...
|    705235 |  344 | `				pIn = pDefend;` |
|    352615 |  345 | `			}` |
|   1356765 |  346 | `			if( pIn < pEnd && (pIn->nType & PH7_TK_COMMA) == 0 ){` |
|       ! 0 |  347 | `				rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Unexpected token '%z'",&pIn->sData);` |
|       ! 0 |  348 | `				return rc;` |
|         - |  349 | `			}` |
|   1356765 |  350 | `			pIn++; /* Jump the trailing comma */` |
|    678380 |  351 | `		}` |
|         - |  352 | `		/* Append argument signature */` |
|   2450993 |  353 | `		if( sArg.nType > 0 ){` |
|    143853 |  354 | `			if( SyStringLength(&sArg.sClass) > 0 ){` |
|         - |  355 | `				/* Class name — prefix with 'o' so generic object hint is a prefix match */` |
|     31107 |  356 | `				int marker = 'o';` |
|     31107 |  357 | `				SyBlobAppend(&sSig,(const void *)&marker,sizeof(char));` |
|     31107 |  358 | `				SyBlobAppend(&sSig,SyStringData(&sArg.sClass),SyStringLength(&sArg.sClass));` |
|     15556 |  359 | `			}else{` |
|         - |  360 | `				int c;` |
|    112751 |  361 | `				c = 'n'; /* cc warning */` |
|         - |  362 | `				/* Type leading character */` |
|    112751 |  363 | `				switch(sArg.nType){` |
|      5819 |  364 | `				case MEMOBJ_HASHMAP:` |
|         - |  365 | `					/* Hashmap aka 'array' */` |
|     11643 |  366 | `					c = 'h';` |
|     11643 |  367 | `					break;` |
|     17567 |  368 | `				case MEMOBJ_INT:` |
|         - |  369 | `					/* Integer */` |
|     35139 |  370 | `					c = 'i';` |
|     35139 |  371 | `					break;` |
...
|         2 |  389 | `					break;` |
|         - |  390 | `				}` |
|    112751 |  391 | `				SyBlobAppend(&sSig,(const void *)&c,sizeof(char));` |
|         - |  392 | `			}` |
|     71929 |  393 | `		}else{` |
|         - |  394 | `			/* No type is associated with this parameter which mean` |
|         - |  395 | `			 * that this function is not condidate for overloading.` |
|         - |  396 | `			 */` |
|   2307145 |  397 | `			SyBlobRelease(&sSig);` |
|         - |  398 | `		}` |
|         - |  399 | `		/* Save in the argument set */` |
|   2450993 |  400 | `		SySetPut(&pFunc->aArgs,(const void *)&sArg);` |
|         5 |  401 | `	}` |
|   1555353 |  402 | `	if( SyBlobLength(&sSig) > 0 ){` |
|         - |  403 | `		/* Save function signature */` |
|     97275 |  404 | `		SyStringInitFromBuf(&pFunc->sSignature,SyBlobData(&sSig),SyBlobLength(&sSig));` |
|     48635 |  405 | `	}` |
|   1555353 |  406 | `	return SXRET_OK;` |
|    777688 |  407 | `}` |
|         - |  408 | `/*` |
...
|         - |  412 | ` */` |
|     34924 |  413 | `static SyToken * GenStateSkipNestedFunc(SyToken *pIn, SyToken *pEnd)` |
|         5 |  414 | `{` |
|     34929 |  415 | `	sxi32 iParen = 0;` |
|     34929 |  416 | `	pIn++; /* past 'function'/'fn' */` |
...
|    155257 |  420 | `	while( pIn < pEnd ){` |
|    155257 |  421 | `		sxu32 t = pIn->nType;` |
|    155257 |  422 | `		if( t & PH7_TK_LPAREN ){ iParen++; }` |
|    151313 |  423 | `		else if( t & PH7_TK_RPAREN ){ iParen--; }` |
|    104755 |  424 | `		else if( (t & PH7_TK_OCB) && iParen <= 0 ){ break; }` |
|     85327 |  425 | `		else if( (t & PH7_TK_SEMI) && iParen <= 0 ){ return pIn; }` |
|    120333 |  426 | `		pIn++;` |
|         5 |  427 | `	}` |
|     19433 |  428 | `	if( pIn >= pEnd ){ return pIn; }` |
|         - |  429 | `	/* pIn at the body '{' — skip the balanced brace block. */` |
|         - |  430 | `	{` |
|     19433 |  431 | `		sxi32 d = 0;` |
|    771589 |  432 | `		while( pIn < pEnd ){` |
|    771589 |  433 | `			sxu32 t = pIn->nType;` |
|    771589 |  434 | `			if( t & PH7_TK_OCB ){ d++; }` |
|    740531 |  435 | `			else if( t & PH7_TK_CCB ){ d--; if( d <= 0 ){ pIn++; break; } }` |
|    752161 |  436 | `			pIn++;` |
|         5 |  437 | `		}` |
|         - |  438 | `	}` |
|     19433 |  439 | `	return pIn;` |
|     17467 |  440 | `}` |
|         - |  441 | `/*` |
...
|         - |  452 | ` * mixed, object.` |
|         - |  453 | ` */` |
|     11646 |  454 | `static int GenStateGenRetNameOk(const char *zName,sxu32 nName)` |
|         5 |  455 | `{` |
...
|         - |  459 | `	};` |
|         - |  460 | `	sxu32 i;` |
|     11651 |  461 | `	if( nName > 0 && zName[0] == '\\' ){` |
|       ! 0 |  462 | `		zName++;` |
|       ! 0 |  463 | `		nName--;` |
|       ! 0 |  464 | `	}` |
|     11659 |  465 | `	for( i = 0; i < SX_ARRAYSIZE(aOk); i++ ){` |
|     11659 |  466 | `		if( nName == aOk[i].nLen && SyStrnicmp(zName,aOk[i].zName,nName) == 0 ){` |
|     11651 |  467 | `			return 1;` |
|         - |  468 | `		}` |
|         5 |  469 | `	}` |
|       ! 0 |  470 | `	return 0;` |
...
|         - |  483 | ` */` |
|     11648 |  484 | `static int GenStateGenRetAtomOk(ph7_gen_state *pGen,sxu32 nType,const SyString *pName)` |
|         5 |  485 | `{` |
|     11653 |  486 | `	if( nType == MEMOBJ_OBJ ){` |
|       ! 0 |  487 | ``		return 1; /* bare `object` */`` |
|         - |  488 | `	}` |
|     11653 |  489 | `	if( nType != SXU32_HIGH ){` |
|         3 |  490 | `		return 0; /* scalar/array/void/never/null/... */` |
|         - |  491 | `	}` |
|     11651 |  492 | `	if( GenStateGenRetNameOk(pName->zString,pName->nByte) ){` |
|     11651 |  493 | `		return 1;` |
|         - |  494 | `	}` |
...
|         - |  518 | ` */` |
|     11890 |  519 | `static sxi32 GenStateValidateGeneratorReturnType(ph7_gen_state *pGen,ph7_vm_func *pFunc)` |
|         5 |  520 | `{` |
|     11895 |  521 | `	int bOk = 0;` |
|         - |  522 | `	sxu32 nLine;` |
|         - |  523 | `	sxi32 rc;` |
|     11895 |  524 | `	if( pFunc->nReturnType < 1 && SySetUsed(&pFunc->aReturnUnion) < 1 ){` |
|       247 |  525 | `		return SXRET_OK; /* untyped: nothing to validate */` |
|         - |  526 | `	}` |
|     11653 |  527 | `	if( SySetUsed(&pFunc->aReturnUnion) > 0 ){` |
...
|       ! 0 |  544 | `		}` |
|       ! 0 |  545 | `	}else{` |
|     11653 |  546 | `		bOk = GenStateGenRetAtomOk(&(*pGen),pFunc->nReturnType,&pFunc->sReturnClass);` |
|         - |  547 | `	}` |
|     11653 |  548 | `	if( bOk ){` |
|     11651 |  549 | `		return SXRET_OK;` |
|         - |  550 | `	}` |
...
|      5950 |  575 | `}` |
|   3273492 |  576 | `static int GenStateFuncBodyHasYield(ph7_gen_state *pGen)` |
|         5 |  577 | `{` |
|   3273497 |  578 | `	SyToken *pIn = pGen->pIn;   /* expected at the body's opening '{' */` |
|   3273497 |  579 | `	SyToken *pEnd = pGen->pEnd;` |
|   3273497 |  580 | `	sxi32 iDepth = 0;` |
|   3273497 |  581 | `	int bStarted = 0;` |
| 149950789 |  582 | `	while( pIn < pEnd ){` |
| 149950789 |  583 | `		sxu32 t = pIn->nType;` |
| 149950789 |  584 | `		if( t & PH7_TK_OCB ){ iDepth++; bStarted = 1; pIn++; continue; }` |
| 143197423 |  585 | `		if( t & PH7_TK_CCB ){ iDepth--; pIn++; if( bStarted && iDepth <= 0 ){ break; } continue; }` |
| 136479307 |  586 | `		if( t & PH7_TK_KEYWORD ){` |
|  10194397 |  587 | `			int kw = SX_PTR_TO_INT(pIn->pUserData);` |
|  10194397 |  588 | `			if( kw == PH7_TKWRD_YIELD ){ return TRUE; }` |
|  10182507 |  589 | `			if( kw == PH7_TKWRD_FUNCTION ){ pIn = GenStateSkipNestedFunc(pIn,pEnd); continue; }` |
|         - |  590 | ``			/* `fn` arrow bodies are single expressions and cannot contain a valid yield. */`` |
|   5073789 |  591 | `		}` |
| 136432493 |  592 | `		pIn++;` |
|         5 |  593 | `	}` |
|   3261607 |  594 | `	return FALSE;` |
|   1636751 |  595 | `}` |
|         - |  596 | `/*` |
...
|         - |  600 | ` */` |
|   3273492 |  601 | `PH7_PRIVATE sxi32 GenStateCompileFuncBody(` |
...
|   3273497 |  611 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC,PH7_VmInstrLength(pGen->pVm),pFunc,&pBlock);` |
|   3273497 |  612 | `	if( rc != SXRET_OK ){` |
...
|         - |  616 | `	}` |
|   3273497 |  617 | `	nGotoOfft = SySetUsed(&pGen->aGoto);` |
|         - |  618 | `	/* Swap bytecode containers */` |
|   3273497 |  619 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   3273497 |  620 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pFunc->aByteCode);` |
...
|         - |  625 | `	{` |
|   3273497 |  626 | `		sxu32 nArg = SySetUsed(&pFunc->aArgs);` |
|         - |  627 | `		sxu32 i;` |
|   5670073 |  628 | `		for( i = 0; i < nArg; i++ ){` |
|   2396581 |  629 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pFunc->aArgs,i);` |
|         - |  630 | `			char *zSrc;` |
|         - |  631 | `			sxu32 nSrc,nName;` |
|         - |  632 | `			SySet sToken;` |
|         - |  633 | `			SyToken *pTmpIn,*pTmpEnd;` |
|         - |  634 | `			sxi32 rcPromote;` |
|   2396581 |  635 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|   2396505 |  636 | `				continue;` |
|         - |  637 | `			}` |
...
|         - |  687 | `	{` |
|   3273497 |  688 | `		sxi8 bSavedGen = pGen->bInGenerator;` |
|   3273497 |  689 | `		pGen->bInGenerator = (sxi8)GenStateFuncBodyHasYield(&(*pGen));` |
|         - |  690 | `		/* Compile the body */` |
|   3273497 |  691 | `		PH7_CompileBlock(&(*pGen),0);` |
|   3273497 |  692 | `		pGen->bInGenerator = bSavedGen;` |
|         - |  693 | `	}` |
|         - |  694 | `	/* Fix exception jumps now the destination is resolved */` |
|   3273497 |  695 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|         - |  696 | `	/* Emit the final return if not yet done */` |
|   3273497 |  697 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|         - |  698 | `	/* Fix gotos jumps now the destination is resolved */` |
|   3273497 |  699 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),nGotoOfft) ){` |
|       ! 0 |  700 | `		rc = SXERR_ABORT;` |
|       ! 0 |  701 | `	}` |
|   3273497 |  702 | `	SySetTruncate(&pGen->aGoto,nGotoOfft);` |
|         - |  703 | `	/* Restore the default container */` |
|   3273497 |  704 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|         - |  705 | `	/* Leave function block */` |
|   3273497 |  706 | `	GenStateLeaveBlock(&(*pGen),0);` |
|   3273497 |  707 | `	if( rc == SXERR_ABORT ){` |
...
|         - |  712 | `	{` |
|   3273497 |  713 | `		VmInstr *aInstr = (VmInstr *)SySetBasePtr(&pFunc->aByteCode);` |
|         - |  714 | `		sxu32 i;` |
|  91846099 |  715 | `		for( i = 0; i < SySetUsed(&pFunc->aByteCode); i++ ){` |
|  88584497 |  716 | `			if( aInstr[i].iOp == PH7_OP_YIELD \|\| aInstr[i].iOp == PH7_OP_YIELD_FROM ){` |
|     11895 |  717 | `				pFunc->iFlags \|= VM_FUNC_GENERATOR;` |
|     11895 |  718 | `				break;` |
|         - |  719 | `			}` |
|  44286306 |  720 | `		}` |
|         - |  721 | `	}` |
|   3273497 |  722 | `	if( pFunc->iFlags & VM_FUNC_GENERATOR ){` |
|         - |  723 | `		/* php-exact definition-time check; see the helper's block comment. */` |
|     11895 |  724 | `		if( SXERR_ABORT == GenStateValidateGeneratorReturnType(&(*pGen),pFunc) ){` |
|       ! 0 |  725 | `			return SXERR_ABORT;` |
|         - |  726 | `		}` |
|      5945 |  727 | `	}` |
|         - |  728 | `	/* All done, function body compiled */` |
|   3273497 |  729 | `	return SXRET_OK;` |
|   1636751 |  730 | `}` |
|         - |  731 | `/*` |
...
|         - |  800 | ` */` |
|     42962 |  801 | `static int GenStateIsReservedTypeWord(const SyString *pName)` |
|         5 |  802 | `{` |
...
|         - |  807 | `	};` |
|         - |  808 | `	sxu32 i;` |
|    900129 |  809 | `	for( i = 0 ; i < SX_ARRAYSIZE(azWords) ; i++ ){` |
|    857285 |  810 | `		sxu32 n = (sxu32)SyStrlen(azWords[i]);` |
|    857285 |  811 | `		if( pName->nByte == n && SyStrnicmp(pName->zString,azWords[i],n) == 0 ){` |
|       123 |  812 | `			return 1;` |
|         - |  813 | `		}` |
|    428586 |  814 | `	}` |
|     42849 |  815 | `	return 0;` |
|     21486 |  816 | `}` |
|    191800 |  817 | `static sxi32 GenStateParseOneTypeAtom(ph7_gen_state *pGen, PhlTypeAtom *pOut)` |
|         5 |  818 | `{` |
|    191805 |  819 | `	SyToken *pIn = pGen->pIn;` |
|    191805 |  820 | `	int bAbsolute = 0;` |
|    191805 |  821 | `	SyZero(pOut, sizeof(*pOut));` |
|    191805 |  822 | `	SyStringInitFromBuf(&pOut->sClass, 0, 0);` |
|    191805 |  823 | `	if( pIn >= pGen->pEnd ){` |
|       ! 0 |  824 | `		return SXERR_SYNTAX;` |
|         - |  825 | `	}` |
|         - |  826 | `	/* Optional leading namespace separator '\' on FQN class types */` |
|    191805 |  827 | `	if( pIn->nType & PH7_TK_NSSEP ){` |
...
|         - |  832 | `		}` |
|         4 |  833 | `	}` |
|    191805 |  834 | `	if( (pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|       ! 0 |  835 | `		return SXERR_SYNTAX;` |
|         - |  836 | `	}` |
|    191805 |  837 | `	if( pIn->nType & PH7_TK_KEYWORD ){` |
|    148607 |  838 | `		sxu32 nKey = (sxu32)(SX_PTR_TO_INT(pIn->pUserData));` |
|    148607 |  839 | `		if( nKey & PH7_TKWRD_ARRAY ){` |
|     15585 |  840 | `			pOut->nType = MEMOBJ_HASHMAP; pOut->zCanon = "array"; pOut->nCanon = 5;` |
|    140817 |  841 | `		}else if( nKey & PH7_TKWRD_BOOL ){` |
|      7835 |  842 | `			pOut->nType = MEMOBJ_BOOL; pOut->zCanon = "bool"; pOut->nCanon = 4;` |
|    129112 |  843 | `		}else if( nKey & PH7_TKWRD_INT ){` |
|     47195 |  844 | `			pOut->nType = MEMOBJ_INT; pOut->zCanon = "int"; pOut->nCanon = 3;` |
|    101602 |  845 | `		}else if( nKey & PH7_TKWRD_STRING ){` |
|     77911 |  846 | `			pOut->nType = MEMOBJ_STRING; pOut->zCanon = "string"; pOut->nCanon = 6;` |
|     39054 |  847 | `		}else if( nKey & PH7_TKWRD_FLOAT ){` |
...
|     43203 |  862 | `		SyString *pT = &pIn->sData;` |
|     43203 |  863 | `		if( pT->nByte == 4 && SyMemcmpNoCase(pT->zString, "null", 4) == 0 ){` |
|        34 |  864 | `			pOut->nType = UTA_NULL_FLAG; pOut->zCanon = "null"; pOut->nCanon = 4;` |
|        34 |  865 | `			pIn++;` |
|     43188 |  866 | `		}else if( pT->nByte == 4 && SyMemcmpNoCase(pT->zString, "void", 4) == 0 ){` |
|       181 |  867 | `			pOut->nType = UTA_VOID_FLAG; pOut->zCanon = "void"; pOut->nCanon = 4;` |
|       181 |  868 | `			pIn++;` |
|     43085 |  869 | `		}else if( pT->nByte == 5 && SyMemcmpNoCase(pT->zString, "never", 5) == 0 ){` |
|        27 |  870 | `			pOut->nType = UTA_NEVER_FLAG; pOut->zCanon = "never"; pOut->nCanon = 5;` |
|        27 |  871 | `			pIn++;` |
|        16 |  872 | `		}else{` |
|         - |  873 | `			/* Class / interface name; consume namespace path a\b\c */` |
|     42975 |  874 | `			SyToken *pFirst = pIn;` |
|     42975 |  875 | `			SyToken *pLast = pIn;` |
|     42975 |  876 | `			pOut->nType = SXU32_HIGH;` |
|     42975 |  877 | `			pOut->sClass = pIn->sData;` |
|     42975 |  878 | `			pIn++;` |
|     64458 |  879 | `			while( pIn + 1 < pGen->pEnd && (pIn->nType & PH7_TK_NSSEP)` |
|     42978 |  880 | `				&& (pIn[1].nType & PH7_TK_ID) ){` |
|         3 |  881 | `				pLast = &pIn[1];` |
|         3 |  882 | `				pIn += 2;` |
|         1 |  883 | `			}` |
|     42975 |  884 | `			if( pLast != pFirst ){` |
...
|     42975 |  898 | `			if( !bAbsolute && pLast == pFirst && !GenStateIsReservedTypeWord(&pOut->sClass) ){` |
|         - |  899 | `				SyBlob sFqn;` |
|     42849 |  900 | `				SyBlobInit(&sFqn,&pGen->pVm->sAllocator);` |
|     42849 |  901 | `				GenStateResolveName(pGen,&pOut->sClass,&sFqn);` |
|     42844 |  902 | `				if( SyBlobLength(&sFqn) != pOut->sClass.nByte` |
|     42844 |  903 | `				 \|\| SyMemcmp(SyBlobData(&sFqn),(const void *)pOut->sClass.zString,pOut->sClass.nByte) != 0 ){` |
...
|         5 |  908 | `					}` |
|         5 |  909 | `				}` |
|     42849 |  910 | `				SyBlobRelease(&sFqn);` |
|     21422 |  911 | `			}` |
|         - |  912 | `		}` |
|         - |  913 | `	}` |
|    191803 |  914 | `	pGen->pIn = pIn;` |
|    191803 |  915 | `	return SXRET_OK;` |
|     95905 |  916 | `}` |
|         - |  917 |  |
|         - |  918 | `/*` |
...
|         - |  924 | ` */` |
|    191624 |  925 | `static void GenBuildUnionTypeText(SyBlob *pBlob, PhlTypeAtom *aAtoms, int nAtoms, int bNullable)` |
|         5 |  926 | `{` |
|         - |  927 | `	int i;` |
|    191629 |  928 | `	int nNonNull = 0;` |
|    191629 |  929 | `	int bAnyIntersection = 0;` |
|         - |  930 | `	sxu32 aGroupCount[PHL_UNION_MAX_ALTS];` |
|    191629 |  931 | `	sxu32 nMaxGroup = 0;` |
|   6323597 |  932 | `	for( i = 0; i < PHL_UNION_MAX_ALTS; i++ ) aGroupCount[i] = 0;` |
|    383403 |  933 | `	for( i = 0; i < nAtoms; i++ ){` |
|    191779 |  934 | `		if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|    191749 |  935 | `			nNonNull++;` |
|    191749 |  936 | `			if( aAtoms[i].nGroup < PHL_UNION_MAX_ALTS ){` |
|    191749 |  937 | `				aGroupCount[aAtoms[i].nGroup]++;` |
|    191749 |  938 | `				if( aAtoms[i].nGroup > nMaxGroup ) nMaxGroup = aAtoms[i].nGroup;` |
|     95872 |  939 | `			}` |
|     95872 |  940 | `		}` |
|     95892 |  941 | `	}` |
|    383351 |  942 | `	for( i = 0; i < nAtoms; i++ ){` |
|    191751 |  943 | `		if( aAtoms[i].nType != UTA_NULL_FLAG && aGroupCount[aAtoms[i].nGroup] >= 2 ){` |
|        29 |  944 | `			bAnyIntersection = 1;` |
|        29 |  945 | `			break;` |
|         - |  946 | `		}` |
|     95866 |  947 | `	}` |
|    191629 |  948 | `	if( bAnyIntersection ){` |
...
|      9772 |  983 | `		return;` |
|         - |  984 | `	}` |
|    191605 |  985 | `	if( nNonNull == 1 && bNullable ){` |
|         - |  986 | `		/* Shorthand: ?T */` |
|     19491 |  987 | `		for( i = 0; i < nAtoms; i++ ){` |
|     19491 |  988 | `			if( aAtoms[i].nType == UTA_NULL_FLAG ) continue;` |
|     19491 |  989 | `			SyBlobAppend(pBlob, "?", 1);` |
|     19491 |  990 | `			if( aAtoms[i].nType == SXU32_HIGH ){` |
|     11653 |  991 | `				SyBlobAppend(pBlob, aAtoms[i].sClass.zString, aAtoms[i].sClass.nByte);` |
|      5829 |  992 | `			}else{` |
|      7843 |  993 | `				SyBlobAppend(pBlob, aAtoms[i].zCanon, aAtoms[i].nCanon);` |
|         - |  994 | `			}` |
|     19491 |  995 | `			return;` |
|       ! 0 |  996 | `		}` |
|       ! 0 |  997 | `	}` |
|         - |  998 | `	{` |
|    172119 |  999 | `		int bFirst = 1;` |
|         - | 1000 | `		/* 1) Classes in declaration order */` |
|    344339 | 1001 | `		for( i = 0; i < nAtoms; i++ ){` |
|    172225 | 1002 | `			if( aAtoms[i].nType == SXU32_HIGH ){` |
|     31309 | 1003 | `				if( !bFirst ) SyBlobAppend(pBlob, "\|", 1);` |
|     31309 | 1004 | `				SyBlobAppend(pBlob, aAtoms[i].sClass.zString, aAtoms[i].sClass.nByte);` |
|     31309 | 1005 | `				bFirst = 0;` |
|     15652 | 1006 | `			}` |
|     86115 | 1007 | `		}` |
...
|         - | 1012 | `			int k;` |
|   1204803 | 1013 | `			for( k = 0; k < (int)(sizeof(aOrder)/sizeof(aOrder[0])); k++ ){` |
|   1925187 | 1014 | `				for( i = 0; i < nAtoms; i++ ){` |
|   1033213 | 1015 | `					if( aAtoms[i].nType == aOrder[k] ){` |
|    140715 | 1016 | `						if( !bFirst ) SyBlobAppend(pBlob, "\|", 1);` |
|    140715 | 1017 | `						SyBlobAppend(pBlob, aAtoms[i].zCanon, aAtoms[i].nCanon);` |
|    140715 | 1018 | `						bFirst = 0;` |
|    140715 | 1019 | `						break;` |
|         - | 1020 | `					}` |
|    446254 | 1021 | `				}` |
|    516347 | 1022 | `			}` |
...
|         - | 1045 | ` */` |
|    191774 | 1046 | `static sxi32 GenStateParsePart(` |
|         - | 1047 | `	ph7_gen_state *pGen, PhlTypeAtom *aAtoms, int *pnAtoms, sxu32 iGroup,` |
|         - | 1048 | `	int *pnMembers, int *pbParen, sxu32 nLine)` |
|         5 | 1049 | `{` |
|         - | 1050 | `	sxi32 rc;` |
|    191779 | 1051 | `	int nMembers = 0;` |
|    191779 | 1052 | `	int bParen = 0;` |
|    191779 | 1053 | `	*pnMembers = 0;` |
|    191779 | 1054 | `	*pbParen = 0;` |
|    191779 | 1055 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_LPAREN) ){` |
|         9 | 1056 | `		bParen = 1;` |
|         9 | 1057 | `		pGen->pIn++; /* skip '(' */` |
|         3 | 1058 | `	}` |
|     95887 | 1059 | `	for(;;){` |
|    191805 | 1060 | `		if( *pnAtoms >= PHL_UNION_MAX_ALTS ){` |
...
|         - | 1064 | `		}` |
|    191805 | 1065 | `		rc = GenStateParseOneTypeAtom(pGen, &aAtoms[*pnAtoms]);` |
|    191805 | 1066 | `		if( rc != SXRET_OK ){` |
|         3 | 1067 | `			return rc;` |
|         - | 1068 | `		}` |
|    191803 | 1069 | `		aAtoms[*pnAtoms].nGroup = iGroup;` |
|    191803 | 1070 | `		(*pnAtoms)++;` |
|    191803 | 1071 | `		nMembers++;` |
|         - | 1072 | ``		/* Continue the intersection while `&` is followed by another type atom. */`` |
|    191803 | 1073 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
...
|         - | 1094 | `		}` |
|         3 | 1095 | `	}` |
|    191777 | 1096 | `	*pnMembers = nMembers;` |
|    191777 | 1097 | `	*pbParen = bParen;` |
|    191777 | 1098 | `	return SXRET_OK;` |
|     95892 | 1099 | `}` |
|         - | 1100 |  |
|         - | 1101 | `/*` |
...
|         - | 1118 | ` */` |
|    191640 | 1119 | `PH7_PRIVATE sxi32 GenStateParseUnionTypeDecl(` |
...
|    191645 | 1132 | `	int nAtoms = 0;` |
|    191645 | 1133 | `	int bShortNullable = 0;` |
|    191645 | 1134 | `	int bExplicitNull = 0;` |
|         - | 1135 | `	sxi32 rc;` |
|    191645 | 1136 | `	*pnType = 0;` |
|    191645 | 1137 | `	if( pClass ) SyStringInitFromBuf(pClass, 0, 0);` |
|    191645 | 1138 | `	*piTypeFlags = 0;` |
|    191645 | 1139 | `	if( pTypeText ) SyStringInitFromBuf(pTypeText, 0, 0);` |
|         - | 1140 |  |
|    191645 | 1141 | `	if( pGen->pIn >= pGen->pEnd ){` |
|       ! 0 | 1142 | `		return SXRET_OK;` |
|         - | 1143 | `	}` |
|         - | 1144 | ``	/* Optional `?` shorthand prefix */`` |
|    191640 | 1145 | `	if( (pGen->pIn->nType & PH7_TK_OP) && pGen->pIn->sData.nByte == 1` |
|     19479 | 1146 | `	 && pGen->pIn->sData.zString[0] == '?' ){` |
|     19479 | 1147 | `		bShortNullable = 1;` |
|     19479 | 1148 | `		pGen->pIn++;` |
|     19479 | 1149 | `		if( pGen->pIn >= pGen->pEnd ){` |
...
|    191645 | 1158 | `		sxu32 iGroup = 0;` |
|    191645 | 1159 | `		rc = GenStateParsePart(pGen, aAtoms, &nAtoms, iGroup, &nMembers, &bParen, nLine);` |
|    191645 | 1160 | `		if( rc != SXRET_OK ){` |
|         4 | 1161 | `			return rc;` |
|         - | 1162 | `		}` |
...
|    287663 | 1168 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OP)` |
|    191849 | 1169 | `			&& pGen->pIn->sData.nByte == 1 && pGen->pIn->sData.zString[0] == '\|' ){` |
...
|         - | 1187 | `			}` |
|         5 | 1188 | `		}` |
|    191641 | 1189 | `		if( iGroup > 0 && nMembers >= 2 && !bParen ){` |
...
|         - | 1201 | `	{` |
|         - | 1202 | `		int i, j;` |
|    191641 | 1203 | `		int bHasNonNull = 0;` |
|    191641 | 1204 | `		int bAnyIntersection = 0;` |
...
|   6323993 | 1208 | `		for( i = 0; i < PHL_UNION_MAX_ALTS; i++ ) aGroupCount[i] = 0;` |
|    383437 | 1209 | `		for( i = 0; i < nAtoms; i++ ){` |
|    191801 | 1210 | `			if( aAtoms[i].nGroup < PHL_UNION_MAX_ALTS ) aGroupCount[aAtoms[i].nGroup]++;` |
|     95903 | 1211 | `		}` |
|    383381 | 1212 | `		for( i = 0; i < nAtoms; i++ ){` |
|    191771 | 1213 | `			if( aGroupCount[aAtoms[i].nGroup] >= 2 ){ bAnyIntersection = 1; break; }` |
|     95875 | 1214 | `		}` |
...
|    191641 | 1217 | `		if( bShortNullable && bAnyIntersection ){` |
...
|         - | 1221 | `		}` |
|    383423 | 1222 | `		for( i = 0; i < nAtoms; i++ ){` |
...
|    191799 | 1226 | `			if( aGroupCount[aAtoms[i].nGroup] >= 2 ){` |
...
|         - | 1248 | `				}` |
|        24 | 1249 | `			}` |
|    191797 | 1250 | `			if( aAtoms[i].nType == UTA_VOID_FLAG ){` |
...
|         - | 1265 | `				}` |
|        87 | 1266 | `			}` |
|    191795 | 1267 | `			if( aAtoms[i].nType == UTA_NEVER_FLAG ){` |
...
|         - | 1284 | `				}` |
|         8 | 1285 | `			}` |
|    191789 | 1286 | `			if( aAtoms[i].nType == UTA_NULL_FLAG ){` |
|        34 | 1287 | `				bExplicitNull = 1;` |
|        19 | 1288 | `			}else{` |
|    191759 | 1289 | `				bHasNonNull = 1;` |
|         - | 1290 | `			}` |
...
|        98 | 1328 | `			}` |
|     95896 | 1329 | `		}` |
|    191629 | 1330 | `		if( !bHasNonNull && bExplicitNull ){` |
...
|    191629 | 1345 | `	if( bShortNullable \|\| bExplicitNull ){` |
|     19507 | 1346 | `		*piTypeFlags \|= iNullableFlag;` |
|      9751 | 1347 | `	}` |
|         - | 1348 | `	/* Build canonical type text */` |
|    191629 | 1349 | `	if( pTypeText ){` |
|         - | 1350 | `		SyBlob sBlob;` |
|    191629 | 1351 | `		SyBlobInit(&sBlob, &pGen->pVm->sAllocator);` |
|    277705 | 1352 | `		GenBuildUnionTypeText(&sBlob, aAtoms, nAtoms,` |
|     95812 | 1353 | `			(bShortNullable \|\| bExplicitNull) ? 1 : 0);` |
|    191629 | 1354 | `		if( SyBlobLength(&sBlob) > 0 ){` |
|    287156 | 1355 | `			char *zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|    191434 | 1356 | `				(const char *)SyBlobData(&sBlob), SyBlobLength(&sBlob));` |
|    191439 | 1357 | `			if( zDup ){` |
|    191439 | 1358 | `				SyStringInitFromBuf(pTypeText, zDup, SyBlobLength(&sBlob));` |
|     95717 | 1359 | `			}` |
|     95717 | 1360 | `		}` |
|    191629 | 1361 | `		SyBlobRelease(&sBlob);` |
|     95812 | 1362 | `	}` |
...
|         - | 1366 | `	{` |
|    191629 | 1367 | `		int nNonNull = 0;` |
|    191629 | 1368 | `		int iNonNullIdx = -1;` |
|         - | 1369 | `		int i;` |
|    383403 | 1370 | `		for( i = 0; i < nAtoms; i++ ){` |
|    191779 | 1371 | `			if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|    191749 | 1372 | `				nNonNull++;` |
|    191749 | 1373 | `				iNonNullIdx = i;` |
|     95872 | 1374 | `			}` |
|     95892 | 1375 | `		}` |
|    191629 | 1376 | `		if( nNonNull <= 1 ){` |
|         - | 1377 | `			/* Fast path: store as single type. */` |
|    191525 | 1378 | `			if( iNonNullIdx >= 0 ){` |
|    191519 | 1379 | `				PhlTypeAtom *pA = &aAtoms[iNonNullIdx];` |
|    191519 | 1380 | `				if( pA->nType == SXU32_HIGH ){` |
|     64373 | 1381 | `					char *zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|     21456 | 1382 | `						pA->sClass.zString, pA->sClass.nByte);` |
|     42917 | 1383 | `					if( zDup == 0 ) return SXERR_ABORT;` |
|     42917 | 1384 | `					*pnType = SXU32_HIGH;` |
|     42917 | 1385 | `					if( pClass ) SyStringInitFromBuf(pClass, zDup, pA->sClass.nByte);` |
|    170063 | 1386 | `				}else if( pA->nType == UTA_VOID_FLAG ){` |
|       179 | 1387 | `					*pnType = MEMOBJ_VOID;` |
|    148520 | 1388 | `				}else if( pA->nType == UTA_NEVER_FLAG ){` |
|        18 | 1389 | `					*pnType = MEMOBJ_NEVER;` |
|        10 | 1390 | `				}else{` |
|    148417 | 1391 | `					*pnType = pA->nType;` |
|         - | 1392 | `				}` |
|     95757 | 1393 | `			}` |
|     95765 | 1394 | `		}else{` |
...
|         - | 1426 | ` */` |
|   3413528 | 1427 | `PH7_PRIVATE sxi32 GenStateParseReturnType(ph7_gen_state *pGen, ph7_vm_func *pFunc)` |
|         5 | 1428 | `{` |
|   3413533 | 1429 | `	sxi32 iFlags = 0;` |
|         - | 1430 | `	sxi32 rc;` |
|         - | 1431 | `	sxu32 nLine;` |
|   3413533 | 1432 | `	pFunc->nReturnType = 0;` |
|   3413533 | 1433 | `	SyStringInitFromBuf(&pFunc->sReturnClass, 0, 0);` |
|   3413533 | 1434 | `	SyStringInitFromBuf(&pFunc->sReturnTypeName, 0, 0);` |
...
|   3413533 | 1440 | `	SySetReset(&pFunc->aReturnUnion);` |
|   3413533 | 1441 | `	pFunc->iFlags &= ~VM_FUNC_RETURN_NULLABLE;` |
|   3413533 | 1442 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COLON) == 0 ){` |
|   3381713 | 1443 | `		return SXRET_OK;` |
|         - | 1444 | `	}` |
|     31825 | 1445 | `	pGen->pIn++; /* Skip ':' */` |
|     31825 | 1446 | `	if( pGen->pIn >= pGen->pEnd ){` |
|       ! 0 | 1447 | `		return SXRET_OK;` |
|         - | 1448 | `	}` |
|     31825 | 1449 | `	nLine = pGen->pIn->nLine;` |
|     31825 | 1450 | `	rc = GenStateParseUnionTypeDecl(` |
|     15910 | 1451 | `		pGen,` |
|     15910 | 1452 | `		&pFunc->nReturnType,` |
|     15910 | 1453 | `		&pFunc->sReturnClass,` |
|     15910 | 1454 | `		&pFunc->aReturnUnion,` |
|         - | 1455 | `		&iFlags,` |
|     15910 | 1456 | `		&pFunc->sReturnTypeName,` |
...
|         - | 1460 | `		/* bAllowVoid */ 1,` |
|     15910 | 1461 | `		nLine);` |
|     31825 | 1462 | `	if( rc == SXERR_ABORT ){` |
|       ! 0 | 1463 | `		return SXERR_ABORT;` |
|         - | 1464 | `	}` |
|     31825 | 1465 | `	if( rc == SXERR_CORRUPT ){` |
|         - | 1466 | `		/* Error already reported */` |
|       ! 0 | 1467 | `		return SXERR_SYNTAX;` |
|         - | 1468 | `	}` |
|     31825 | 1469 | `	if( rc == SXERR_SYNTAX ){` |
...
|         - | 1479 | `	}` |
|     31819 | 1480 | `	pFunc->iFlags \|= (iFlags & VM_FUNC_RETURN_NULLABLE);` |
|     31819 | 1481 | `	return SXRET_OK;` |
|   1706769 | 1482 | `}` |
|         - | 1483 |  |
|    521108 | 1484 | `PH7_PRIVATE sxi32 GenStateCompileFunc(` |
...
|    521113 | 1498 | `	nLine = pGen->pIn->nLine;` |
|         - | 1499 | `	/* Jump the left parenthesis '(' */` |
|    521113 | 1500 | `	pGen->pIn++;` |
|         - | 1501 | `	/* Delimit the function signature */` |
|    521113 | 1502 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|    521113 | 1503 | `	if( pEnd >= pGen->pEnd ){` |
|         - | 1504 | `		/* Syntax error */` |
...
|    521105 | 1515 | `	pFunc = (ph7_vm_func *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_vm_func));` |
|    521105 | 1516 | `	if( pFunc == 0 ){` |
|       ! 0 | 1517 | `		goto OutOfMem;` |
|         - | 1518 | `	}` |
|         - | 1519 | `	/* Build the function name, prepending namespace if active */` |
|    521113 | 1520 | `	if( SyBlobLength(&pGen->sNamespace) > 0 && !bHandleClosure ){` |
|         - | 1521 | `		SyBlob sFQN;` |
|         - | 1522 | `		sxu32 nLen;` |
...
|        10 | 1534 | `	}else{` |
|    521089 | 1535 | `		zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|    521089 | 1536 | `		if( zName == 0 ){` |
|       ! 0 | 1537 | `			goto OutOfMem;` |
|         - | 1538 | `		}` |
|    521089 | 1539 | `		PH7_VmInitFuncState(pGen->pVm,pFunc,zName,pName->nByte,iFlags,0);` |
|         - | 1540 | `	}` |
...
|    521105 | 1543 | `	pFunc->nLine = nLine;` |
|    521105 | 1544 | `	GenStateConsumeDoc(&(*pGen),&pFunc->sDoc);` |
|    521105 | 1545 | `	if( GenStateConsumeAttrs(&(*pGen),&pFunc->aAttrs) == SXERR_ABORT ){` |
|       ! 0 | 1546 | `		return SXERR_ABORT;` |
|         - | 1547 | `	}` |
|    521105 | 1548 | `	if( pGen->pIn < pEnd ){` |
|         - | 1549 | `		/* Collect function arguments */` |
|    442625 | 1550 | `		rc = GenStateCollectFuncArgs(pFunc,&(*pGen),pEnd,0,0);` |
|    442625 | 1551 | `		if( rc == SXERR_ABORT ){` |
...
|    521103 | 1557 | `	pGen->pIn = &pEnd[1];` |
|         - | 1558 | `	{` |
|    521103 | 1559 | `		sxi32 rcRt = GenStateParseReturnType(pGen, pFunc);` |
|    521103 | 1560 | `		if( rcRt == SXERR_ABORT ){` |
|       ! 0 | 1561 | `			return SXERR_ABORT;` |
|    521103 | 1562 | `		}else if( rcRt == SXERR_SYNTAX ){` |
|         9 | 1563 | `			return SXERR_SYNTAX;` |
|         - | 1564 | `		}` |
|         - | 1565 | `	}` |
|    521097 | 1566 | `	if( bHandleClosure ){` |
...
|    521097 | 1676 | `	rc = GenStateCompileFuncBody(&(*pGen),pFunc);` |
|    521097 | 1677 | `	if( rc == SXERR_ABORT ){` |
|       ! 0 | 1678 | `		return SXERR_ABORT;` |
|         - | 1679 | `	}` |
|         - | 1680 | `	/* The cursor sits just past the body's closing brace */` |
|    521097 | 1681 | `	pFunc->nEndLine = pGen->pIn[-1].nLine;` |
|    521097 | 1682 | `	if( ppFunc ){` |
|    521097 | 1683 | `		*ppFunc = pFunc;` |
|    260546 | 1684 | `	}` |
|    521097 | 1685 | `	rc = SXRET_OK;` |
|    521097 | 1686 | `	if( (pFunc->iFlags & VM_FUNC_CLOSURE) == 0 ){` |
|         - | 1687 | `		/* Reject a php-fatal redeclaration before hoisting the function */` |
|    520533 | 1688 | `		if( GenStateGuardFuncRedeclaration(pGen,pFunc) == SXERR_ABORT ){` |
|         6 | 1689 | `			return SXERR_ABORT;` |
|         - | 1690 | `		}` |
|         - | 1691 | `		/* Finally register the function */` |
|    520529 | 1692 | `		rc = PH7_VmInstallUserFunction(pGen->pVm,pFunc,0);` |
|    260262 | 1693 | `	}` |
|    521093 | 1694 | `	if( rc == SXRET_OK ){` |
|    521093 | 1695 | `		return SXRET_OK;` |
|         - | 1696 | `	}` |
...
|         - | 1708 | ` */` |
|    520532 | 1709 | `PH7_PRIVATE sxi32 PH7_CompileFunction(ph7_gen_state *pGen)` |
|         5 | 1710 | `{` |
|         - | 1711 | `	SyString *pName;` |
|         - | 1712 | `	sxi32 iFlags;` |
|         - | 1713 | `	sxu32 nKwLine;` |
...
|         - | 1715 | `	sxi32 rc;` |
|         - | 1716 |  |
|    520537 | 1717 | `	nLine = pGen->pIn->nLine;` |
|    520537 | 1718 | `	nKwLine = nLine; /* Line of the 'function' keyword (Reflection getStartLine) */` |
|    520537 | 1719 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|    520537 | 1720 | `	iFlags = 0;` |
|    520537 | 1721 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|         - | 1722 | `		/* Return by reference,remember that */` |
|        12 | 1723 | `		iFlags \|= VM_FUNC_REF_RETURN;` |
|         - | 1724 | `		/* Jump the '&' token */` |
|        12 | 1725 | `		pGen->pIn++;` |
|         5 | 1726 | `	}` |
|    520537 | 1727 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|         - | 1738 | `	}` |
|    520531 | 1739 | `	pName = &pGen->pIn->sData;` |
|    520531 | 1740 | `	nLine = pGen->pIn->nLine;` |
|         - | 1741 | `	/* Jump the function name */` |
|    520531 | 1742 | `	pGen->pIn++;` |
|    520531 | 1743 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|         - | 1744 | `		/* Syntax error */` |
...
|         - | 1757 | `	{` |
|    520529 | 1758 | `		ph7_vm_func *pFuncState = 0;` |
|    520529 | 1759 | `		rc = GenStateCompileFunc(&(*pGen),pName,iFlags,FALSE,&pFuncState);` |
|    520529 | 1760 | `		if( pFuncState ){` |
|         - | 1761 | `			/* Reflection getStartLine(): line of the 'function' keyword */` |
|    520513 | 1762 | `			pFuncState->nLine = nKwLine;` |
|    260254 | 1763 | `		}` |
|         - | 1764 | `	}` |
|    520529 | 1765 | `	return rc;` |
|    260271 | 1766 | `}` |
|         - | 1767 |  |
