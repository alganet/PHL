...
|         - |  124 | ` */` |
|   1557768 |  125 | `PH7_PRIVATE sxi32 GenStateCollectFuncArgs(ph7_vm_func *pFunc,ph7_gen_state *pGen,SyToken *pEnd,int bCtorCtx,int bAbstractCtx)` |
|         5 |  126 | `{` |
...
|         - |  131 | `	sxi32 rc;` |
|         - |  132 |  |
|   1557773 |  133 | `	pIn = pGen->pIn;` |
|   1557773 |  134 | `	SyBlobInit(&sSig,&pGen->pVm->sAllocator);` |
|         - |  135 | `	/* Process arguments one after one */` |
|   2006271 |  136 | `	for(;;){` |
|   4012547 |  137 | `		if( pIn >= pEnd ){` |
|         - |  138 | `			/* No more arguments to process */` |
|   1557755 |  139 | `			break;` |
|         - |  140 | `		}` |
|   2454797 |  141 | `		SyZero(&sArg,sizeof(ph7_vm_func_arg));` |
|   2454797 |  142 | `		SySetInit(&sArg.aByteCode,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|   2454797 |  143 | `		SySetInit(&sArg.aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|   2454797 |  144 | `		SySetInit(&sArg.aAttrs,&pGen->pVm->sAllocator,sizeof(ph7_attribute));` |
|   2454797 |  145 | `		SyStringInitFromBuf(&sArg.sTypeName,0,0);` |
|         - |  146 | `		/* Parameter #[...] attributes: the group precedes the parameter's` |
|         - |  147 | `		 * first token inside the main token stream */` |
|   2454797 |  148 | `		if( GenStateCollectParamAttrs(&(*pGen),pIn,&sArg.aAttrs) == SXERR_ABORT ){` |
...
|         - |  156 | `		{` |
|   2454797 |  157 | `			int bReadonly = 0, bVisSeen = 0;` |
|   2454797 |  158 | `			sxi32 iVis = PH7_CLASS_PROT_PUBLIC;` |
|   2454797 |  159 | `			sxi32 iSetVisFlag = 0;` |
|         - |  160 | `			int nSetTok;` |
|         - |  161 | `			sxi32 nSetVis;` |
|   2454797 |  162 | `			if( pIn < pEnd && GenStateIsReadonly(pIn) ){` |
|         3 |  163 | `				bReadonly = 1;` |
|         3 |  164 | `				pIn++;` |
|         1 |  165 | `			}` |
|   2454797 |  166 | `			nSetVis = GenStatePeekSetVisibility(pIn,pEnd,&nSetTok);` |
|   2454797 |  167 | `			if( nSetVis ){` |
...
|       ! 0 |  174 | `					pIn++;` |
|         1 |  175 | `				}` |
|   2454796 |  176 | `			}else if( pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD) ){` |
...
|        43 |  194 | `				}` |
|     54539 |  195 | `			}` |
|   2454797 |  196 | `			if( iSetVisFlag == PH7_CLASS_ATTR_PRIVATE_SET ){` |
|         5 |  197 | `				sArg.iFlags \|= VM_FUNC_ARG_PRIV_SET;` |
|   2454795 |  198 | `			}else if( iSetVisFlag == PH7_CLASS_ATTR_PROTECTED_SET ){` |
|       ! 0 |  199 | `				sArg.iFlags \|= VM_FUNC_ARG_PROT_SET;` |
|       ! 0 |  200 | `			}` |
|   2454797 |  201 | `			if( bVisSeen \|\| bReadonly ){` |
|        95 |  202 | `				if( !bCtorCtx ){` |
...
|   2454788 |  223 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_DOLLAR) == 0` |
|   1322813 |  224 | `			&& (pIn->nType & PH7_TK_AMPER) == 0` |
...
|     72066 |  253 | `		}` |
|   2454783 |  254 | `		if( pIn >= pEnd ){` |
|       ! 0 |  255 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Missing argument name");` |
|       ! 0 |  256 | `			return rc;` |
|         - |  257 | `		}` |
|   2454783 |  258 | `		if( pIn->nType & PH7_TK_AMPER ){` |
|         - |  259 | `			/* Pass by reference,record that */` |
|     23341 |  260 | `			sArg.iFlags \|= VM_FUNC_ARG_BY_REF;` |
|     23341 |  261 | `			pIn++;` |
|     11668 |  262 | `		}` |
|   2454783 |  263 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_ELLIPSIS) ){` |
|         - |  264 | `			/* Variadic parameter: ...$args */` |
|     23397 |  265 | `			sArg.iFlags \|= VM_FUNC_ARG_VARIADIC;` |
|     23397 |  266 | `			pIn++;` |
|     11696 |  267 | `		}` |
|   2454783 |  268 | `		if( pIn >= pEnd \|\| (pIn->nType & PH7_TK_DOLLAR) == 0 \|\| &pIn[1] >= pEnd \|\| (pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|         - |  269 | `			/* Invalid argument */` |
|       ! 0 |  270 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Invalid argument name");` |
|       ! 0 |  271 | `			return rc;` |
|         - |  272 | `		}` |
|   2454783 |  273 | `		pIn++; /* Jump the dollar sign */` |
|         - |  274 | `		/* Copy argument name */` |
|   2454783 |  275 | `		zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,SyStringData(&pIn->sData),SyStringLength(&pIn->sData));` |
|   2454783 |  276 | `		if( zDup == 0 ){` |
|       ! 0 |  277 | `			PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"PH7 engine is running out of memory");` |
|       ! 0 |  278 | `			return SXERR_ABORT;` |
|         - |  279 | `		}` |
|   2454783 |  280 | `		SyStringInitFromBuf(&sArg.sName,zDup,SyStringLength(&pIn->sData));` |
|   2454783 |  281 | `		pIn++;` |
|   2454783 |  282 | `		if( pIn < pEnd ){` |
|   1358867 |  283 | `			if( pIn->nType & PH7_TK_EQUAL ){` |
|         - |  284 | `				SyToken *pDefend;` |
...
|    353161 |  345 | `			}` |
|   1358863 |  346 | `			if( pIn < pEnd && (pIn->nType & PH7_TK_COMMA) == 0 ){` |
|       ! 0 |  347 | `				rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Unexpected token '%z'",&pIn->sData);` |
|       ! 0 |  348 | `				return rc;` |
|         - |  349 | `			}` |
|   1358863 |  350 | `			pIn++; /* Jump the trailing comma */` |
|    679429 |  351 | `		}` |
|         - |  352 | `		/* Append argument signature */` |
|   2454779 |  353 | `		if( sArg.nType > 0 ){` |
...
|         - |  396 | `			 */` |
|   2310709 |  397 | `			SyBlobRelease(&sSig);` |
|         - |  398 | `		}` |
|         - |  399 | `		/* Save in the argument set */` |
|   2454779 |  400 | `		SySetPut(&pFunc->aArgs,(const void *)&sArg);` |
|         5 |  401 | `	}` |
|   1557755 |  402 | `	if( SyBlobLength(&sSig) > 0 ){` |
|         - |  403 | `		/* Save function signature */` |
|     97425 |  404 | `		SyStringInitFromBuf(&pFunc->sSignature,SyBlobData(&sSig),SyBlobLength(&sSig));` |
|     48710 |  405 | `	}` |
|   1557755 |  406 | `	return SXRET_OK;` |
|    778889 |  407 | `}` |
|         - |  408 | `/*` |
...
|      5959 |  575 | `}` |
|   3278550 |  576 | `static int GenStateFuncBodyHasYield(ph7_gen_state *pGen)` |
|         5 |  577 | `{` |
|   3278555 |  578 | `	SyToken *pIn = pGen->pIn;   /* expected at the body's opening '{' */` |
|   3278555 |  579 | `	SyToken *pEnd = pGen->pEnd;` |
|   3278555 |  580 | `	sxi32 iDepth = 0;` |
|   3278555 |  581 | `	int bStarted = 0;` |
| 150182797 |  582 | `	while( pIn < pEnd ){` |
| 150182797 |  583 | `		sxu32 t = pIn->nType;` |
| 150182797 |  584 | `		if( t & PH7_TK_OCB ){ iDepth++; bStarted = 1; pIn++; continue; }` |
| 143418989 |  585 | `		if( t & PH7_TK_CCB ){ iDepth--; pIn++; if( bStarted && iDepth <= 0 ){ break; } continue; }` |
| 136690485 |  586 | `		if( t & PH7_TK_KEYWORD ){` |
|  10210163 |  587 | `			int kw = SX_PTR_TO_INT(pIn->pUserData);` |
|  10210163 |  588 | `			if( kw == PH7_TKWRD_YIELD ){ return TRUE; }` |
|  10198255 |  589 | `			if( kw == PH7_TKWRD_FUNCTION ){ pIn = GenStateSkipNestedFunc(pIn,pEnd); continue; }` |
|         - |  590 | ``			/* `fn` arrow bodies are single expressions and cannot contain a valid yield. */`` |
|   5081636 |  591 | `		}` |
| 136643599 |  592 | `		pIn++;` |
|         5 |  593 | `	}` |
|   3266647 |  594 | `	return FALSE;` |
|   1639280 |  595 | `}` |
|         - |  596 | `/*` |
...
|         - |  600 | ` */` |
|   3278550 |  601 | `PH7_PRIVATE sxi32 GenStateCompileFuncBody(` |
...
|   3278555 |  611 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC,PH7_VmInstrLength(pGen->pVm),pFunc,&pBlock);` |
|   3278555 |  612 | `	if( rc != SXRET_OK ){` |
...
|         - |  616 | `	}` |
|   3278555 |  617 | `	nGotoOfft = SySetUsed(&pGen->aGoto);` |
|         - |  618 | `	/* Swap bytecode containers */` |
|   3278555 |  619 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   3278555 |  620 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pFunc->aByteCode);` |
...
|         - |  625 | `	{` |
|   3278555 |  626 | `		sxu32 nArg = SySetUsed(&pFunc->aArgs);` |
|         - |  627 | `		sxu32 i;` |
|   5678833 |  628 | `		for( i = 0; i < nArg; i++ ){` |
|   2400283 |  629 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pFunc->aArgs,i);` |
|         - |  630 | `			char *zSrc;` |
|         - |  631 | `			sxu32 nSrc,nName;` |
|         - |  632 | `			SySet sToken;` |
|         - |  633 | `			SyToken *pTmpIn,*pTmpEnd;` |
|         - |  634 | `			sxi32 rcPromote;` |
|   2400283 |  635 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|   2400207 |  636 | `				continue;` |
|         - |  637 | `			}` |
...
|         - |  687 | `	{` |
|   3278555 |  688 | `		sxi8 bSavedGen = pGen->bInGenerator;` |
|   3278555 |  689 | `		pGen->bInGenerator = (sxi8)GenStateFuncBodyHasYield(&(*pGen));` |
|         - |  690 | `		/* Compile the body */` |
|   3278555 |  691 | `		PH7_CompileBlock(&(*pGen),0);` |
|   3278555 |  692 | `		pGen->bInGenerator = bSavedGen;` |
|         - |  693 | `	}` |
|         - |  694 | `	/* Fix exception jumps now the destination is resolved */` |
|   3278555 |  695 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|         - |  696 | `	/* Emit the final return if not yet done */` |
|   3278555 |  697 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|         - |  698 | `	/* Fix gotos jumps now the destination is resolved */` |
|   3278555 |  699 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),nGotoOfft) ){` |
|       ! 0 |  700 | `		rc = SXERR_ABORT;` |
|       ! 0 |  701 | `	}` |
|   3278555 |  702 | `	SySetTruncate(&pGen->aGoto,nGotoOfft);` |
|         - |  703 | `	/* Restore the default container */` |
|   3278555 |  704 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|         - |  705 | `	/* Leave function block */` |
|   3278555 |  706 | `	GenStateLeaveBlock(&(*pGen),0);` |
|   3278555 |  707 | `	if( rc == SXERR_ABORT ){` |
...
|         - |  712 | `	{` |
|   3278555 |  713 | `		VmInstr *aInstr = (VmInstr *)SySetBasePtr(&pFunc->aByteCode);` |
|         - |  714 | `		sxu32 i;` |
|  91988199 |  715 | `		for( i = 0; i < SySetUsed(&pFunc->aByteCode); i++ ){` |
|  88721557 |  716 | `			if( aInstr[i].iOp == PH7_OP_YIELD \|\| aInstr[i].iOp == PH7_OP_YIELD_FROM ){` |
|     11913 |  717 | `				pFunc->iFlags \|= VM_FUNC_GENERATOR;` |
|     11913 |  718 | `				break;` |
|         - |  719 | `			}` |
|  44354827 |  720 | `		}` |
|         - |  721 | `	}` |
|   3278555 |  722 | `	if( pFunc->iFlags & VM_FUNC_GENERATOR ){` |
...
|         - | 1426 | ` */` |
|   3418802 | 1427 | `PH7_PRIVATE sxi32 GenStateParseReturnType(ph7_gen_state *pGen, ph7_vm_func *pFunc)` |
|         5 | 1428 | `{` |
|   3418807 | 1429 | `	sxi32 iFlags = 0;` |
|         - | 1430 | `	sxi32 rc;` |
|         - | 1431 | `	sxu32 nLine;` |
|   3418807 | 1432 | `	pFunc->nReturnType = 0;` |
|   3418807 | 1433 | `	SyStringInitFromBuf(&pFunc->sReturnClass, 0, 0);` |
|   3418807 | 1434 | `	SyStringInitFromBuf(&pFunc->sReturnTypeName, 0, 0);` |
...
|   3418807 | 1440 | `	SySetReset(&pFunc->aReturnUnion);` |
|   3418807 | 1441 | `	pFunc->iFlags &= ~VM_FUNC_RETURN_NULLABLE;` |
|   3418807 | 1442 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COLON) == 0 ){` |
|   3386939 | 1443 | `		return SXRET_OK;` |
|         - | 1444 | `	}` |
...
|   1709406 | 1482 | `}` |
|         - | 1483 |  |
|    521904 | 1484 | `PH7_PRIVATE sxi32 GenStateCompileFunc(` |
...
|    521909 | 1498 | `	nLine = pGen->pIn->nLine;` |
|         - | 1499 | `	/* Jump the left parenthesis '(' */` |
|    521909 | 1500 | `	pGen->pIn++;` |
|         - | 1501 | `	/* Delimit the function signature */` |
|    521909 | 1502 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|    521909 | 1503 | `	if( pEnd >= pGen->pEnd ){` |
|         - | 1504 | `		/* Syntax error */` |
...
|    521903 | 1515 | `	pFunc = (ph7_vm_func *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_vm_func));` |
|    521903 | 1516 | `	if( pFunc == 0 ){` |
|       ! 0 | 1517 | `		goto OutOfMem;` |
|         - | 1518 | `	}` |
|         - | 1519 | `	/* Build the function name, prepending namespace if active */` |
|    521911 | 1520 | `	if( SyBlobLength(&pGen->sNamespace) > 0 && !bHandleClosure ){` |
|         - | 1521 | `		SyBlob sFQN;` |
|         - | 1522 | `		sxu32 nLen;` |
...
|        10 | 1534 | `	}else{` |
|    521887 | 1535 | `		zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|    521887 | 1536 | `		if( zName == 0 ){` |
|       ! 0 | 1537 | `			goto OutOfMem;` |
|         - | 1538 | `		}` |
|    521887 | 1539 | `		PH7_VmInitFuncState(pGen->pVm,pFunc,zName,pName->nByte,iFlags,0);` |
|         - | 1540 | `	}` |
...
|    521903 | 1543 | `	pFunc->nLine = nLine;` |
|    521903 | 1544 | `	GenStateConsumeDoc(&(*pGen),&pFunc->sDoc);` |
|    521903 | 1545 | `	if( GenStateConsumeAttrs(&(*pGen),&pFunc->aAttrs) == SXERR_ABORT ){` |
|       ! 0 | 1546 | `		return SXERR_ABORT;` |
|         - | 1547 | `	}` |
|    521903 | 1548 | `	if( pGen->pIn < pEnd ){` |
|         - | 1549 | `		/* Collect function arguments */` |
|    443305 | 1550 | `		rc = GenStateCollectFuncArgs(pFunc,&(*pGen),pEnd,0,0);` |
|    443305 | 1551 | `		if( rc == SXERR_ABORT ){` |
...
|    521901 | 1557 | `	pGen->pIn = &pEnd[1];` |
|         - | 1558 | `	{` |
|    521901 | 1559 | `		sxi32 rcRt = GenStateParseReturnType(pGen, pFunc);` |
|    521901 | 1560 | `		if( rcRt == SXERR_ABORT ){` |
|       ! 0 | 1561 | `			return SXERR_ABORT;` |
|    521901 | 1562 | `		}else if( rcRt == SXERR_SYNTAX ){` |
|         9 | 1563 | `			return SXERR_SYNTAX;` |
|         - | 1564 | `		}` |
|         - | 1565 | `	}` |
|    521895 | 1566 | `	if( bHandleClosure ){` |
...
|    521895 | 1676 | `	rc = GenStateCompileFuncBody(&(*pGen),pFunc);` |
|    521895 | 1677 | `	if( rc == SXERR_ABORT ){` |
|       ! 0 | 1678 | `		return SXERR_ABORT;` |
|         - | 1679 | `	}` |
|         - | 1680 | `	/* The cursor sits just past the body's closing brace */` |
|    521895 | 1681 | `	pFunc->nEndLine = pGen->pIn[-1].nLine;` |
|    521895 | 1682 | `	if( ppFunc ){` |
|    521895 | 1683 | `		*ppFunc = pFunc;` |
|    260945 | 1684 | `	}` |
|    521895 | 1685 | `	rc = SXRET_OK;` |
|    521895 | 1686 | `	if( (pFunc->iFlags & VM_FUNC_CLOSURE) == 0 ){` |
|         - | 1687 | `		/* Reject a php-fatal redeclaration before hoisting the function */` |
|    521331 | 1688 | `		if( GenStateGuardFuncRedeclaration(pGen,pFunc) == SXERR_ABORT ){` |
|         6 | 1689 | `			return SXERR_ABORT;` |
|         - | 1690 | `		}` |
|         - | 1691 | `		/* Finally register the function */` |
|    521327 | 1692 | `		rc = PH7_VmInstallUserFunction(pGen->pVm,pFunc,0);` |
|    260661 | 1693 | `	}` |
|    521891 | 1694 | `	if( rc == SXRET_OK ){` |
|    521891 | 1695 | `		return SXRET_OK;` |
|         - | 1696 | `	}` |
...
|         - | 1708 | ` */` |
|    521328 | 1709 | `PH7_PRIVATE sxi32 PH7_CompileFunction(ph7_gen_state *pGen)` |
|         5 | 1710 | `{` |
|         - | 1711 | `	SyString *pName;` |
|         - | 1712 | `	sxi32 iFlags;` |
|         - | 1713 | `	sxu32 nKwLine;` |
...
|         - | 1715 | `	sxi32 rc;` |
|         - | 1716 |  |
|    521333 | 1717 | `	nLine = pGen->pIn->nLine;` |
|    521333 | 1718 | `	nKwLine = nLine; /* Line of the 'function' keyword (Reflection getStartLine) */` |
|    521333 | 1719 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|    521333 | 1720 | `	iFlags = 0;` |
|    521333 | 1721 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|         - | 1722 | `		/* Return by reference,remember that */` |
|        12 | 1723 | `		iFlags \|= VM_FUNC_REF_RETURN;` |
|         - | 1724 | `		/* Jump the '&' token */` |
|        12 | 1725 | `		pGen->pIn++;` |
|         5 | 1726 | `	}` |
|    521333 | 1727 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|         - | 1738 | `	}` |
|    521327 | 1739 | `	pName = &pGen->pIn->sData;` |
|    521327 | 1740 | `	nLine = pGen->pIn->nLine;` |
|         - | 1741 | `	/* Jump the function name */` |
|    521327 | 1742 | `	pGen->pIn++;` |
|    521327 | 1743 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|         - | 1744 | `		/* Syntax error */` |
...
|         - | 1757 | `	{` |
|    521325 | 1758 | `		ph7_vm_func *pFuncState = 0;` |
|    521325 | 1759 | `		rc = GenStateCompileFunc(&(*pGen),pName,iFlags,FALSE,&pFuncState);` |
|    521325 | 1760 | `		if( pFuncState ){` |
|         - | 1761 | `			/* Reflection getStartLine(): line of the 'function' keyword */` |
|    521311 | 1762 | `			pFuncState->nLine = nKwLine;` |
|    260653 | 1763 | `		}` |
|         - | 1764 | `	}` |
|    521325 | 1765 | `	return rc;` |
|    260669 | 1766 | `}` |
|         - | 1767 |  |
