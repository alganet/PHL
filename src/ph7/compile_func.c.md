...
|         - |   67 | ` */` |
|    709614 |   68 | `static sxi32 GenStateProcessArgValue(ph7_gen_state *pGen,ph7_vm_func_arg *pArg,SyToken *pIn,SyToken *pEnd)` |
|         5 |   69 | `{` |
|         - |   70 | `	SyToken *pTmpIn,*pTmpEnd;` |
|         - |   71 | `	SySet *pInstrContainer;` |
|         - |   72 | `	sxi32 rc;` |
|         - |   73 | `	/* Swap token stream */` |
|    709619 |   74 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|    709619 |   75 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|    709619 |   76 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pArg->aByteCode);` |
|         - |   77 | `	/* Compile the expression holding the argument value */` |
|    709619 |   78 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|         - |   79 | `	/* Emit the done instruction */` |
|    709619 |   80 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,(rc != SXERR_EMPTY ? 1 : 0),0,0,0);` |
|    709619 |   81 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|    709619 |   82 | `	RE_SWAP_DELIMITER(pGen);` |
|    709619 |   83 | `	if( rc == SXERR_ABORT ){` |
|       ! 0 |   84 | `		return SXERR_ABORT;` |
|         - |   85 | `	}` |
|    709619 |   86 | `	return SXRET_OK;` |
|    354812 |   87 | `}` |
|         - |   88 | `/*` |
...
|         - |  124 | ` */` |
|   1565000 |  125 | `PH7_PRIVATE sxi32 GenStateCollectFuncArgs(ph7_vm_func *pFunc,ph7_gen_state *pGen,SyToken *pEnd,int bCtorCtx,int bAbstractCtx)` |
|         5 |  126 | `{` |
...
|         - |  131 | `	sxi32 rc;` |
|         - |  132 |  |
|   1565005 |  133 | `	pIn = pGen->pIn;` |
|   1565005 |  134 | `	SyBlobInit(&sSig,&pGen->pVm->sAllocator);` |
|         - |  135 | `	/* Process arguments one after one */` |
|   2015593 |  136 | `	for(;;){` |
|   4031191 |  137 | `		if( pIn >= pEnd ){` |
|         - |  138 | `			/* No more arguments to process */` |
|   1564987 |  139 | `			break;` |
|         - |  140 | `		}` |
|   2466209 |  141 | `		SyZero(&sArg,sizeof(ph7_vm_func_arg));` |
|   2466209 |  142 | `		SySetInit(&sArg.aByteCode,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|   2466209 |  143 | `		SySetInit(&sArg.aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|   2466209 |  144 | `		SySetInit(&sArg.aAttrs,&pGen->pVm->sAllocator,sizeof(ph7_attribute));` |
|   2466209 |  145 | `		SyStringInitFromBuf(&sArg.sTypeName,0,0);` |
|         - |  146 | `		/* Parameter #[...] attributes: the group precedes the parameter's` |
|         - |  147 | `		 * first token inside the main token stream */` |
|   2466209 |  148 | `		if( GenStateCollectParamAttrs(&(*pGen),pIn,&sArg.aAttrs) == SXERR_ABORT ){` |
...
|         - |  156 | `		{` |
|   2466209 |  157 | `			int bReadonly = 0, bVisSeen = 0;` |
|   2466209 |  158 | `			sxi32 iVis = PH7_CLASS_PROT_PUBLIC;` |
|   2466209 |  159 | `			sxi32 iSetVisFlag = 0;` |
|         - |  160 | `			int nSetTok;` |
|         - |  161 | `			sxi32 nSetVis;` |
|   2466209 |  162 | `			if( pIn < pEnd && GenStateIsReadonly(pIn) ){` |
|         3 |  163 | `				bReadonly = 1;` |
|         3 |  164 | `				pIn++;` |
|         1 |  165 | `			}` |
|   2466209 |  166 | `			nSetVis = GenStatePeekSetVisibility(pIn,pEnd,&nSetTok);` |
|   2466209 |  167 | `			if( nSetVis ){` |
...
|       ! 0 |  174 | `					pIn++;` |
|         1 |  175 | `				}` |
|   2466208 |  176 | `			}else if( pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD) ){` |
|    109587 |  177 | `				sxu32 nKw = (sxu32)SX_PTR_TO_INT(pIn->pUserData);` |
|    109587 |  178 | `				if( nKw == PH7_TKWRD_PUBLIC \|\| nKw == PH7_TKWRD_PROTECTED \|\| nKw == PH7_TKWRD_PRIVATE ){` |
|        91 |  179 | `					bVisSeen = 1;` |
...
|        43 |  194 | `				}` |
|     54791 |  195 | `			}` |
|   2466209 |  196 | `			if( iSetVisFlag == PH7_CLASS_ATTR_PRIVATE_SET ){` |
|         5 |  197 | `				sArg.iFlags \|= VM_FUNC_ARG_PRIV_SET;` |
|   2466207 |  198 | `			}else if( iSetVisFlag == PH7_CLASS_ATTR_PROTECTED_SET ){` |
|       ! 0 |  199 | `				sArg.iFlags \|= VM_FUNC_ARG_PROT_SET;` |
|       ! 0 |  200 | `			}` |
|   2466209 |  201 | `			if( bVisSeen \|\| bReadonly ){` |
|        95 |  202 | `				if( !bCtorCtx ){` |
...
|   2466200 |  223 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_DOLLAR) == 0` |
|   1328961 |  224 | `			&& (pIn->nType & PH7_TK_AMPER) == 0` |
|    180009 |  225 | `			&& (pIn->nType & PH7_TK_ELLIPSIS) == 0 ){` |
|    144815 |  226 | `			sxu32 nLineLocal = pIn->nLine;` |
|    144815 |  227 | `			sxi32 iTFlags = 0;` |
|    144815 |  228 | `			pGen->pIn = pIn;` |
|    144815 |  229 | `			rc = GenStateParseUnionTypeDecl(` |
|     72405 |  230 | `				pGen, &sArg.nType, &sArg.sClass, &sArg.aUnionAlts,` |
|     72405 |  231 | `				&iTFlags, &sArg.sTypeName,` |
|         - |  232 | `				VM_FUNC_ARG_NULLABLE, VM_FUNC_ARG_UNION,` |
|         - |  233 | `				/* bAllowVoid */ 0,` |
|     72405 |  234 | `						nLineLocal);` |
|    144815 |  235 | `			pIn = pGen->pIn;` |
|    144815 |  236 | `			if( rc == SXERR_ABORT ){` |
|       ! 0 |  237 | `				return SXERR_ABORT;` |
|    144815 |  238 | `			}else if( rc == SXERR_CORRUPT ){` |
|         - |  239 | `				/* Error already reported by GenStateParseUnionTypeDecl */` |
|         3 |  240 | `				return SXERR_SYNTAX;` |
|    144813 |  241 | `			}else if( rc == SXERR_SYNTAX ){` |
|         9 |  242 | `				if( pIn < pEnd ){` |
...
|         - |  251 | `			}` |
|    144805 |  252 | `			sArg.iFlags \|= iTFlags;` |
|     72400 |  253 | `		}` |
|   2466195 |  254 | `		if( pIn >= pEnd ){` |
|       ! 0 |  255 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Missing argument name");` |
|       ! 0 |  256 | `			return rc;` |
|         - |  257 | `		}` |
|   2466195 |  258 | `		if( pIn->nType & PH7_TK_AMPER ){` |
|         - |  259 | `			/* Pass by reference,record that */` |
|     23449 |  260 | `			sArg.iFlags \|= VM_FUNC_ARG_BY_REF;` |
|     23449 |  261 | `			pIn++;` |
|     11722 |  262 | `		}` |
|   2466195 |  263 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_ELLIPSIS) ){` |
|         - |  264 | `			/* Variadic parameter: ...$args */` |
|     23505 |  265 | `			sArg.iFlags \|= VM_FUNC_ARG_VARIADIC;` |
|     23505 |  266 | `			pIn++;` |
|     11750 |  267 | `		}` |
|   2466195 |  268 | `		if( pIn >= pEnd \|\| (pIn->nType & PH7_TK_DOLLAR) == 0 \|\| &pIn[1] >= pEnd \|\| (pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|         - |  269 | `			/* Invalid argument */` |
|       ! 0 |  270 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Invalid argument name");` |
|       ! 0 |  271 | `			return rc;` |
|         - |  272 | `		}` |
|   2466195 |  273 | `		pIn++; /* Jump the dollar sign */` |
|         - |  274 | `		/* Copy argument name */` |
|   2466195 |  275 | `		zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,SyStringData(&pIn->sData),SyStringLength(&pIn->sData));` |
|   2466195 |  276 | `		if( zDup == 0 ){` |
|       ! 0 |  277 | `			PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"PH7 engine is running out of memory");` |
|       ! 0 |  278 | `			return SXERR_ABORT;` |
|         - |  279 | `		}` |
|   2466195 |  280 | `		SyStringInitFromBuf(&sArg.sName,zDup,SyStringLength(&pIn->sData));` |
|   2466195 |  281 | `		pIn++;` |
|   2466195 |  282 | `		if( pIn < pEnd ){` |
|   1365191 |  283 | `			if( pIn->nType & PH7_TK_EQUAL ){` |
|         - |  284 | `				SyToken *pDefend;` |
|    709621 |  285 | `				sxi32 iNest = 0;` |
|    709621 |  286 | `				pIn++; /* Jump the equal sign */` |
|    709621 |  287 | `				pDefend = pIn;` |
|         - |  288 | `				/* Process the default value associated with this argument */` |
|   1485549 |  289 | `				while( pDefend < pEnd ){` |
|   1021573 |  290 | `					if( (pDefend->nType & PH7_TK_COMMA) && iNest <= 0 ){` |
|    245645 |  291 | `						break;` |
|         - |  292 | `					}` |
|    775933 |  293 | `					if( pDefend->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*[*/) ){` |
|         - |  294 | `						/* Increment nesting level */` |
|     27305 |  295 | `						iNest++;` |
|    762283 |  296 | `					}else if( pDefend->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CCB/*'}'*/\|PH7_TK_CSB/*]*/) ){` |
|         - |  297 | `						/* Decrement nesting level */` |
|     27305 |  298 | `						iNest--;` |
|     13650 |  299 | `					}` |
|    775933 |  300 | `					pDefend++;` |
|         5 |  301 | `				}` |
|    709621 |  302 | `				if( pIn >= pDefend ){` |
|         3 |  303 | `					rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Missing argument default value");` |
|         3 |  304 | `					return rc;` |
|         - |  305 | `				}` |
|         - |  306 | `				/* Process default value */` |
|    709619 |  307 | `				rc = GenStateProcessArgValue(&(*pGen),&sArg,pIn,pDefend);` |
|    709619 |  308 | `				if( rc != SXRET_OK ){` |
|       ! 0 |  309 | `					return rc;` |
|         - |  310 | `				}` |
...
|    709614 |  316 | `				if( (sArg.nType > 0 \|\| (sArg.iFlags & VM_FUNC_ARG_UNION))` |
|    386014 |  317 | `					&& (sArg.iFlags & VM_FUNC_ARG_NULLABLE) == 0` |
|    378215 |  318 | `					&& &pIn[1] == pDefend` |
|     39019 |  319 | `					&& pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)` |
|     21460 |  320 | `					&& pIn->sData.nByte == sizeof("null")-1` |
|      5856 |  321 | `					&& SyStrnicmp(SyStringData(&pIn->sData),"null",sizeof("null")-1) == 0 ){` |
...
|    709617 |  344 | `				pIn = pDefend;` |
|    354806 |  345 | `			}` |
|   1365187 |  346 | `			if( pIn < pEnd && (pIn->nType & PH7_TK_COMMA) == 0 ){` |
|       ! 0 |  347 | `				rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Unexpected token '%z'",&pIn->sData);` |
|       ! 0 |  348 | `				return rc;` |
|         - |  349 | `			}` |
|   1365187 |  350 | `			pIn++; /* Jump the trailing comma */` |
|    682591 |  351 | `		}` |
|         - |  352 | `		/* Append argument signature */` |
|   2466191 |  353 | `		if( sArg.nType > 0 ){` |
|    144743 |  354 | `			if( SyStringLength(&sArg.sClass) > 0 ){` |
|         - |  355 | `				/* Class name — prefix with 'o' so generic object hint is a prefix match */` |
|     31301 |  356 | `				int marker = 'o';` |
|     31301 |  357 | `				SyBlobAppend(&sSig,(const void *)&marker,sizeof(char));` |
|     31301 |  358 | `				SyBlobAppend(&sSig,SyStringData(&sArg.sClass),SyStringLength(&sArg.sClass));` |
|     15653 |  359 | `			}else{` |
|         - |  360 | `				int c;` |
|    113447 |  361 | `				c = 'n'; /* cc warning */` |
|         - |  362 | `				/* Type leading character */` |
|    113447 |  363 | `				switch(sArg.nType){` |
|      5855 |  364 | `				case MEMOBJ_HASHMAP:` |
|         - |  365 | `					/* Hashmap aka 'array' */` |
|     11715 |  366 | `					c = 'h';` |
|     11715 |  367 | `					break;` |
|     17675 |  368 | `				case MEMOBJ_INT:` |
|         - |  369 | `					/* Integer */` |
|     35355 |  370 | `					c = 'i';` |
|     35355 |  371 | `					break;` |
...
|         2 |  389 | `					break;` |
|         - |  390 | `				}` |
|    113447 |  391 | `				SyBlobAppend(&sSig,(const void *)&c,sizeof(char));` |
|         - |  392 | `			}` |
|     72374 |  393 | `		}else{` |
|         - |  394 | `			/* No type is associated with this parameter which mean` |
|         - |  395 | `			 * that this function is not condidate for overloading.` |
|         - |  396 | `			 */` |
|   2321453 |  397 | `			SyBlobRelease(&sSig);` |
|         - |  398 | `		}` |
|         - |  399 | `		/* Save in the argument set */` |
|   2466191 |  400 | `		SySetPut(&pFunc->aArgs,(const void *)&sArg);` |
|         5 |  401 | `	}` |
|   1564987 |  402 | `	if( SyBlobLength(&sSig) > 0 ){` |
|         - |  403 | `		/* Save function signature */` |
|     97877 |  404 | `		SyStringInitFromBuf(&pFunc->sSignature,SyBlobData(&sSig),SyBlobLength(&sSig));` |
|     48936 |  405 | `	}` |
|   1564987 |  406 | `	return SXRET_OK;` |
|    782505 |  407 | `}` |
|         - |  408 | `/*` |
...
|         - |  412 | ` */` |
|     35140 |  413 | `static SyToken * GenStateSkipNestedFunc(SyToken *pIn, SyToken *pEnd)` |
|         5 |  414 | `{` |
|     35145 |  415 | `	sxi32 iParen = 0;` |
|     35145 |  416 | `	pIn++; /* past 'function'/'fn' */` |
...
|    156217 |  420 | `	while( pIn < pEnd ){` |
|    156217 |  421 | `		sxu32 t = pIn->nType;` |
|    156217 |  422 | `		if( t & PH7_TK_LPAREN ){ iParen++; }` |
|    152249 |  423 | `		else if( t & PH7_TK_RPAREN ){ iParen--; }` |
|    105403 |  424 | `		else if( (t & PH7_TK_OCB) && iParen <= 0 ){ break; }` |
|     85855 |  425 | `		else if( (t & PH7_TK_SEMI) && iParen <= 0 ){ return pIn; }` |
|    121077 |  426 | `		pIn++;` |
|         5 |  427 | `	}` |
|     19553 |  428 | `	if( pIn >= pEnd ){ return pIn; }` |
|         - |  429 | `	/* pIn at the body '{' — skip the balanced brace block. */` |
|         - |  430 | `	{` |
|     19553 |  431 | `		sxi32 d = 0;` |
|    776365 |  432 | `		while( pIn < pEnd ){` |
|    776365 |  433 | `			sxu32 t = pIn->nType;` |
|    776365 |  434 | `			if( t & PH7_TK_OCB ){ d++; }` |
|    745115 |  435 | `			else if( t & PH7_TK_CCB ){ d--; if( d <= 0 ){ pIn++; break; } }` |
|    756817 |  436 | `			pIn++;` |
|         5 |  437 | `		}` |
|         - |  438 | `	}` |
|     19553 |  439 | `	return pIn;` |
|     17575 |  440 | `}` |
|         - |  441 | `/*` |
...
|         - |  452 | ` * mixed, object.` |
|         - |  453 | ` */` |
|     11718 |  454 | `static int GenStateGenRetNameOk(const char *zName,sxu32 nName)` |
|         5 |  455 | `{` |
...
|         - |  459 | `	};` |
|         - |  460 | `	sxu32 i;` |
|     11723 |  461 | `	if( nName > 0 && zName[0] == '\\' ){` |
|       ! 0 |  462 | `		zName++;` |
|       ! 0 |  463 | `		nName--;` |
|       ! 0 |  464 | `	}` |
|     11731 |  465 | `	for( i = 0; i < SX_ARRAYSIZE(aOk); i++ ){` |
|     11731 |  466 | `		if( nName == aOk[i].nLen && SyStrnicmp(zName,aOk[i].zName,nName) == 0 ){` |
|     11723 |  467 | `			return 1;` |
|         - |  468 | `		}` |
|         5 |  469 | `	}` |
|       ! 0 |  470 | `	return 0;` |
...
|         - |  483 | ` */` |
|     11720 |  484 | `static int GenStateGenRetAtomOk(ph7_gen_state *pGen,sxu32 nType,const SyString *pName)` |
|         5 |  485 | `{` |
|     11725 |  486 | `	if( nType == MEMOBJ_OBJ ){` |
|       ! 0 |  487 | ``		return 1; /* bare `object` */`` |
|         - |  488 | `	}` |
|     11725 |  489 | `	if( nType != SXU32_HIGH ){` |
|         3 |  490 | `		return 0; /* scalar/array/void/never/null/... */` |
|         - |  491 | `	}` |
|     11723 |  492 | `	if( GenStateGenRetNameOk(pName->zString,pName->nByte) ){` |
|     11723 |  493 | `		return 1;` |
|         - |  494 | `	}` |
...
|         - |  518 | ` */` |
|     11962 |  519 | `static sxi32 GenStateValidateGeneratorReturnType(ph7_gen_state *pGen,ph7_vm_func *pFunc)` |
|         5 |  520 | `{` |
|     11967 |  521 | `	int bOk = 0;` |
|         - |  522 | `	sxu32 nLine;` |
|         - |  523 | `	sxi32 rc;` |
|     11967 |  524 | `	if( pFunc->nReturnType < 1 && SySetUsed(&pFunc->aReturnUnion) < 1 ){` |
|       247 |  525 | `		return SXRET_OK; /* untyped: nothing to validate */` |
|         - |  526 | `	}` |
|     11725 |  527 | `	if( SySetUsed(&pFunc->aReturnUnion) > 0 ){` |
...
|       ! 0 |  544 | `		}` |
|       ! 0 |  545 | `	}else{` |
|     11725 |  546 | `		bOk = GenStateGenRetAtomOk(&(*pGen),pFunc->nReturnType,&pFunc->sReturnClass);` |
|         - |  547 | `	}` |
|     11725 |  548 | `	if( bOk ){` |
|     11723 |  549 | `		return SXRET_OK;` |
|         - |  550 | `	}` |
...
|      5986 |  575 | `}` |
|   3293794 |  576 | `static int GenStateFuncBodyHasYield(ph7_gen_state *pGen)` |
|         5 |  577 | `{` |
|   3293799 |  578 | `	SyToken *pIn = pGen->pIn;   /* expected at the body's opening '{' */` |
|   3293799 |  579 | `	SyToken *pEnd = pGen->pEnd;` |
|   3293799 |  580 | `	sxi32 iDepth = 0;` |
|   3293799 |  581 | `	int bStarted = 0;` |
| 150880411 |  582 | `	while( pIn < pEnd ){` |
| 150880411 |  583 | `		sxu32 t = pIn->nType;` |
| 150880411 |  584 | `		if( t & PH7_TK_OCB ){ iDepth++; bStarted = 1; pIn++; continue; }` |
| 144085171 |  585 | `		if( t & PH7_TK_CCB ){ iDepth--; pIn++; if( bStarted && iDepth <= 0 ){ break; } continue; }` |
| 137325397 |  586 | `		if( t & PH7_TK_KEYWORD ){` |
|  10257591 |  587 | `			int kw = SX_PTR_TO_INT(pIn->pUserData);` |
|  10257591 |  588 | `			if( kw == PH7_TKWRD_YIELD ){ return TRUE; }` |
|  10245629 |  589 | `			if( kw == PH7_TKWRD_FUNCTION ){ pIn = GenStateSkipNestedFunc(pIn,pEnd); continue; }` |
|         - |  590 | ``			/* `fn` arrow bodies are single expressions and cannot contain a valid yield. */`` |
|   5105242 |  591 | `		}` |
| 137278295 |  592 | `		pIn++;` |
|         5 |  593 | `	}` |
|   3281837 |  594 | `	return FALSE;` |
|   1646902 |  595 | `}` |
|         - |  596 | `/*` |
...
|         - |  600 | ` */` |
|   3293794 |  601 | `PH7_PRIVATE sxi32 GenStateCompileFuncBody(` |
...
|   3293799 |  611 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC,PH7_VmInstrLength(pGen->pVm),pFunc,&pBlock);` |
|   3293799 |  612 | `	if( rc != SXRET_OK ){` |
...
|         - |  616 | `	}` |
|   3293799 |  617 | `	nGotoOfft = SySetUsed(&pGen->aGoto);` |
|         - |  618 | `	/* Swap bytecode containers */` |
|   3293799 |  619 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   3293799 |  620 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pFunc->aByteCode);` |
...
|         - |  625 | `	{` |
|   3293799 |  626 | `		sxu32 nArg = SySetUsed(&pFunc->aArgs);` |
|         - |  627 | `		sxu32 i;` |
|   5705237 |  628 | `		for( i = 0; i < nArg; i++ ){` |
|   2411443 |  629 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pFunc->aArgs,i);` |
|         - |  630 | `			char *zSrc;` |
|         - |  631 | `			sxu32 nSrc,nName;` |
|         - |  632 | `			SySet sToken;` |
|         - |  633 | `			SyToken *pTmpIn,*pTmpEnd;` |
|         - |  634 | `			sxi32 rcPromote;` |
|   2411443 |  635 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|   2411367 |  636 | `				continue;` |
|         - |  637 | `			}` |
...
|         - |  687 | `	{` |
|   3293799 |  688 | `		sxi8 bSavedGen = pGen->bInGenerator;` |
|   3293799 |  689 | `		pGen->bInGenerator = (sxi8)GenStateFuncBodyHasYield(&(*pGen));` |
|         - |  690 | `		/* Compile the body */` |
|   3293799 |  691 | `		PH7_CompileBlock(&(*pGen),0);` |
|   3293799 |  692 | `		pGen->bInGenerator = bSavedGen;` |
|         - |  693 | `	}` |
|         - |  694 | `	/* Fix exception jumps now the destination is resolved */` |
|   3293799 |  695 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|         - |  696 | `	/* Emit the final return if not yet done */` |
|   3293799 |  697 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|         - |  698 | `	/* Fix gotos jumps now the destination is resolved */` |
|   3293799 |  699 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),nGotoOfft) ){` |
|       ! 0 |  700 | `		rc = SXERR_ABORT;` |
|       ! 0 |  701 | `	}` |
|   3293799 |  702 | `	SySetTruncate(&pGen->aGoto,nGotoOfft);` |
|         - |  703 | `	/* Restore the default container */` |
|   3293799 |  704 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|         - |  705 | `	/* Leave function block */` |
|   3293799 |  706 | `	GenStateLeaveBlock(&(*pGen),0);` |
|   3293799 |  707 | `	if( rc == SXERR_ABORT ){` |
...
|         - |  712 | `	{` |
|   3293799 |  713 | `		VmInstr *aInstr = (VmInstr *)SySetBasePtr(&pFunc->aByteCode);` |
|         - |  714 | `		sxu32 i;` |
|  92415477 |  715 | `		for( i = 0; i < SySetUsed(&pFunc->aByteCode); i++ ){` |
|  89133645 |  716 | `			if( aInstr[i].iOp == PH7_OP_YIELD \|\| aInstr[i].iOp == PH7_OP_YIELD_FROM ){` |
|     11967 |  717 | `				pFunc->iFlags \|= VM_FUNC_GENERATOR;` |
|     11967 |  718 | `				break;` |
|         - |  719 | `			}` |
|  44560844 |  720 | `		}` |
|         - |  721 | `	}` |
|   3293799 |  722 | `	if( pFunc->iFlags & VM_FUNC_GENERATOR ){` |
|         - |  723 | `		/* php-exact definition-time check; see the helper's block comment. */` |
|     11967 |  724 | `		if( SXERR_ABORT == GenStateValidateGeneratorReturnType(&(*pGen),pFunc) ){` |
|       ! 0 |  725 | `			return SXERR_ABORT;` |
|         - |  726 | `		}` |
|      5981 |  727 | `	}` |
|         - |  728 | `	/* All done, function body compiled */` |
|   3293799 |  729 | `	return SXRET_OK;` |
|   1646902 |  730 | `}` |
|         - |  731 | `/*` |
...
|         - |  800 | ` */` |
|     43228 |  801 | `static int GenStateIsReservedTypeWord(const SyString *pName)` |
|         5 |  802 | `{` |
...
|         - |  807 | `	};` |
|         - |  808 | `	sxu32 i;` |
|    905683 |  809 | `	for( i = 0 ; i < SX_ARRAYSIZE(azWords) ; i++ ){` |
|    862575 |  810 | `		sxu32 n = (sxu32)SyStrlen(azWords[i]);` |
|    862575 |  811 | `		if( pName->nByte == n && SyStrnicmp(pName->zString,azWords[i],n) == 0 ){` |
|       125 |  812 | `			return 1;` |
|         - |  813 | `		}` |
|    431230 |  814 | `	}` |
|     43113 |  815 | `	return 0;` |
|     21619 |  816 | `}` |
|    192978 |  817 | `static sxi32 GenStateParseOneTypeAtom(ph7_gen_state *pGen, PhlTypeAtom *pOut)` |
|         5 |  818 | `{` |
|    192983 |  819 | `	SyToken *pIn = pGen->pIn;` |
|    192983 |  820 | `	int bAbsolute = 0;` |
|    192983 |  821 | `	SyZero(pOut, sizeof(*pOut));` |
|    192983 |  822 | `	SyStringInitFromBuf(&pOut->sClass, 0, 0);` |
|    192983 |  823 | `	if( pIn >= pGen->pEnd ){` |
|       ! 0 |  824 | `		return SXERR_SYNTAX;` |
|         - |  825 | `	}` |
|         - |  826 | `	/* Optional leading namespace separator '\' on FQN class types */` |
|    192983 |  827 | `	if( pIn->nType & PH7_TK_NSSEP ){` |
...
|         - |  832 | `		}` |
|         4 |  833 | `	}` |
|    192983 |  834 | `	if( (pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|       ! 0 |  835 | `		return SXERR_SYNTAX;` |
|         - |  836 | `	}` |
|    192983 |  837 | `	if( pIn->nType & PH7_TK_KEYWORD ){` |
|    149519 |  838 | `		sxu32 nKey = (sxu32)(SX_PTR_TO_INT(pIn->pUserData));` |
|    149519 |  839 | `		if( nKey & PH7_TKWRD_ARRAY ){` |
|     15681 |  840 | `			pOut->nType = MEMOBJ_HASHMAP; pOut->zCanon = "array"; pOut->nCanon = 5;` |
|    141681 |  841 | `		}else if( nKey & PH7_TKWRD_BOOL ){` |
|      7883 |  842 | `			pOut->nType = MEMOBJ_BOOL; pOut->zCanon = "bool"; pOut->nCanon = 4;` |
|    129904 |  843 | `		}else if( nKey & PH7_TKWRD_INT ){` |
|     47483 |  844 | `			pOut->nType = MEMOBJ_INT; pOut->zCanon = "int"; pOut->nCanon = 3;` |
|    102226 |  845 | `		}else if( nKey & PH7_TKWRD_STRING ){` |
|     78391 |  846 | `			pOut->nType = MEMOBJ_STRING; pOut->zCanon = "string"; pOut->nCanon = 6;` |
|     39294 |  847 | `		}else if( nKey & PH7_TKWRD_FLOAT ){` |
...
|     43469 |  862 | `		SyString *pT = &pIn->sData;` |
|     43469 |  863 | `		if( pT->nByte == 4 && SyMemcmpNoCase(pT->zString, "null", 4) == 0 ){` |
|        34 |  864 | `			pOut->nType = UTA_NULL_FLAG; pOut->zCanon = "null"; pOut->nCanon = 4;` |
|        34 |  865 | `			pIn++;` |
|     43454 |  866 | `		}else if( pT->nByte == 4 && SyMemcmpNoCase(pT->zString, "void", 4) == 0 ){` |
|       181 |  867 | `			pOut->nType = UTA_VOID_FLAG; pOut->zCanon = "void"; pOut->nCanon = 4;` |
|       181 |  868 | `			pIn++;` |
|     43351 |  869 | `		}else if( pT->nByte == 5 && SyMemcmpNoCase(pT->zString, "never", 5) == 0 ){` |
|        27 |  870 | `			pOut->nType = UTA_NEVER_FLAG; pOut->zCanon = "never"; pOut->nCanon = 5;` |
|        27 |  871 | `			pIn++;` |
|        16 |  872 | `		}else{` |
|         - |  873 | `			/* Class / interface name; consume namespace path a\b\c */` |
|     43241 |  874 | `			SyToken *pFirst = pIn;` |
|     43241 |  875 | `			SyToken *pLast = pIn;` |
|     43241 |  876 | `			pOut->nType = SXU32_HIGH;` |
|     43241 |  877 | `			pOut->sClass = pIn->sData;` |
|     43241 |  878 | `			pIn++;` |
|     64857 |  879 | `			while( pIn + 1 < pGen->pEnd && (pIn->nType & PH7_TK_NSSEP)` |
|     43244 |  880 | `				&& (pIn[1].nType & PH7_TK_ID) ){` |
|         3 |  881 | `				pLast = &pIn[1];` |
|         3 |  882 | `				pIn += 2;` |
|         1 |  883 | `			}` |
|     43241 |  884 | `			if( pLast != pFirst ){` |
...
|     43241 |  898 | `			if( !bAbsolute && pLast == pFirst && !GenStateIsReservedTypeWord(&pOut->sClass) ){` |
|         - |  899 | `				SyBlob sFqn;` |
|     43113 |  900 | `				SyBlobInit(&sFqn,&pGen->pVm->sAllocator);` |
|     43113 |  901 | `				GenStateResolveName(pGen,&pOut->sClass,&sFqn);` |
|     43108 |  902 | `				if( SyBlobLength(&sFqn) != pOut->sClass.nByte` |
|     43108 |  903 | `				 \|\| SyMemcmp(SyBlobData(&sFqn),(const void *)pOut->sClass.zString,pOut->sClass.nByte) != 0 ){` |
...
|         5 |  908 | `					}` |
|         5 |  909 | `				}` |
|     43113 |  910 | `				SyBlobRelease(&sFqn);` |
|     21554 |  911 | `			}` |
|         - |  912 | `		}` |
|         - |  913 | `	}` |
|    192981 |  914 | `	pGen->pIn = pIn;` |
|    192981 |  915 | `	return SXRET_OK;` |
|     96494 |  916 | `}` |
|         - |  917 |  |
|         - |  918 | `/*` |
...
|         - |  924 | ` */` |
|    192802 |  925 | `static void GenBuildUnionTypeText(SyBlob *pBlob, PhlTypeAtom *aAtoms, int nAtoms, int bNullable)` |
|         5 |  926 | `{` |
|         - |  927 | `	int i;` |
|    192807 |  928 | `	int nNonNull = 0;` |
|    192807 |  929 | `	int bAnyIntersection = 0;` |
|         - |  930 | `	sxu32 aGroupCount[PHL_UNION_MAX_ALTS];` |
|    192807 |  931 | `	sxu32 nMaxGroup = 0;` |
|   6362471 |  932 | `	for( i = 0; i < PHL_UNION_MAX_ALTS; i++ ) aGroupCount[i] = 0;` |
|    385759 |  933 | `	for( i = 0; i < nAtoms; i++ ){` |
|    192957 |  934 | `		if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|    192927 |  935 | `			nNonNull++;` |
|    192927 |  936 | `			if( aAtoms[i].nGroup < PHL_UNION_MAX_ALTS ){` |
|    192927 |  937 | `				aGroupCount[aAtoms[i].nGroup]++;` |
|    192927 |  938 | `				if( aAtoms[i].nGroup > nMaxGroup ) nMaxGroup = aAtoms[i].nGroup;` |
|     96461 |  939 | `			}` |
|     96461 |  940 | `		}` |
|     96481 |  941 | `	}` |
|    385707 |  942 | `	for( i = 0; i < nAtoms; i++ ){` |
|    192929 |  943 | `		if( aAtoms[i].nType != UTA_NULL_FLAG && aGroupCount[aAtoms[i].nGroup] >= 2 ){` |
|        29 |  944 | `			bAnyIntersection = 1;` |
|        29 |  945 | `			break;` |
|         - |  946 | `		}` |
|     96455 |  947 | `	}` |
|    192807 |  948 | `	if( bAnyIntersection ){` |
...
|      9832 |  983 | `		return;` |
|         - |  984 | `	}` |
|    192783 |  985 | `	if( nNonNull == 1 && bNullable ){` |
|         - |  986 | `		/* Shorthand: ?T */` |
|     19611 |  987 | `		for( i = 0; i < nAtoms; i++ ){` |
|     19611 |  988 | `			if( aAtoms[i].nType == UTA_NULL_FLAG ) continue;` |
|     19611 |  989 | `			SyBlobAppend(pBlob, "?", 1);` |
|     19611 |  990 | `			if( aAtoms[i].nType == SXU32_HIGH ){` |
|     11725 |  991 | `				SyBlobAppend(pBlob, aAtoms[i].sClass.zString, aAtoms[i].sClass.nByte);` |
|      5865 |  992 | `			}else{` |
|      7891 |  993 | `				SyBlobAppend(pBlob, aAtoms[i].zCanon, aAtoms[i].nCanon);` |
|         - |  994 | `			}` |
|     19611 |  995 | `			return;` |
|       ! 0 |  996 | `		}` |
|       ! 0 |  997 | `	}` |
|         - |  998 | `	{` |
|    173177 |  999 | `		int bFirst = 1;` |
|         - | 1000 | `		/* 1) Classes in declaration order */` |
|    346455 | 1001 | `		for( i = 0; i < nAtoms; i++ ){` |
|    173283 | 1002 | `			if( aAtoms[i].nType == SXU32_HIGH ){` |
|     31503 | 1003 | `				if( !bFirst ) SyBlobAppend(pBlob, "\|", 1);` |
|     31503 | 1004 | `				SyBlobAppend(pBlob, aAtoms[i].sClass.zString, aAtoms[i].sClass.nByte);` |
|     31503 | 1005 | `				bFirst = 0;` |
|     15749 | 1006 | `			}` |
|     86644 | 1007 | `		}` |
...
|         - | 1012 | `			int k;` |
|   1212209 | 1013 | `			for( k = 0; k < (int)(sizeof(aOrder)/sizeof(aOrder[0])); k++ ){` |
|   1937019 | 1014 | `				for( i = 0; i < nAtoms; i++ ){` |
|   1039561 | 1015 | `					if( aAtoms[i].nType == aOrder[k] ){` |
|    141579 | 1016 | `						if( !bFirst ) SyBlobAppend(pBlob, "\|", 1);` |
|    141579 | 1017 | `						SyBlobAppend(pBlob, aAtoms[i].zCanon, aAtoms[i].nCanon);` |
|    141579 | 1018 | `						bFirst = 0;` |
|    141579 | 1019 | `						break;` |
|         - | 1020 | `					}` |
|    448996 | 1021 | `				}` |
|    519521 | 1022 | `			}` |
...
|         - | 1045 | ` */` |
|    192952 | 1046 | `static sxi32 GenStateParsePart(` |
|         - | 1047 | `	ph7_gen_state *pGen, PhlTypeAtom *aAtoms, int *pnAtoms, sxu32 iGroup,` |
|         - | 1048 | `	int *pnMembers, int *pbParen, sxu32 nLine)` |
|         5 | 1049 | `{` |
|         - | 1050 | `	sxi32 rc;` |
|    192957 | 1051 | `	int nMembers = 0;` |
|    192957 | 1052 | `	int bParen = 0;` |
|    192957 | 1053 | `	*pnMembers = 0;` |
|    192957 | 1054 | `	*pbParen = 0;` |
|    192957 | 1055 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_LPAREN) ){` |
|         9 | 1056 | `		bParen = 1;` |
|         9 | 1057 | `		pGen->pIn++; /* skip '(' */` |
|         3 | 1058 | `	}` |
|     96476 | 1059 | `	for(;;){` |
|    192983 | 1060 | `		if( *pnAtoms >= PHL_UNION_MAX_ALTS ){` |
...
|         - | 1064 | `		}` |
|    192983 | 1065 | `		rc = GenStateParseOneTypeAtom(pGen, &aAtoms[*pnAtoms]);` |
|    192983 | 1066 | `		if( rc != SXRET_OK ){` |
|         3 | 1067 | `			return rc;` |
|         - | 1068 | `		}` |
|    192981 | 1069 | `		aAtoms[*pnAtoms].nGroup = iGroup;` |
|    192981 | 1070 | `		(*pnAtoms)++;` |
|    192981 | 1071 | `		nMembers++;` |
|         - | 1072 | ``		/* Continue the intersection while `&` is followed by another type atom. */`` |
|    192981 | 1073 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
...
|         - | 1094 | `		}` |
|         3 | 1095 | `	}` |
|    192955 | 1096 | `	*pnMembers = nMembers;` |
|    192955 | 1097 | `	*pbParen = bParen;` |
|    192955 | 1098 | `	return SXRET_OK;` |
|     96481 | 1099 | `}` |
|         - | 1100 |  |
|         - | 1101 | `/*` |
...
|         - | 1118 | ` */` |
|    192818 | 1119 | `PH7_PRIVATE sxi32 GenStateParseUnionTypeDecl(` |
...
|    192823 | 1132 | `	int nAtoms = 0;` |
|    192823 | 1133 | `	int bShortNullable = 0;` |
|    192823 | 1134 | `	int bExplicitNull = 0;` |
|         - | 1135 | `	sxi32 rc;` |
|    192823 | 1136 | `	*pnType = 0;` |
|    192823 | 1137 | `	if( pClass ) SyStringInitFromBuf(pClass, 0, 0);` |
|    192823 | 1138 | `	*piTypeFlags = 0;` |
|    192823 | 1139 | `	if( pTypeText ) SyStringInitFromBuf(pTypeText, 0, 0);` |
|         - | 1140 |  |
|    192823 | 1141 | `	if( pGen->pIn >= pGen->pEnd ){` |
|       ! 0 | 1142 | `		return SXRET_OK;` |
|         - | 1143 | `	}` |
|         - | 1144 | ``	/* Optional `?` shorthand prefix */`` |
|    192818 | 1145 | `	if( (pGen->pIn->nType & PH7_TK_OP) && pGen->pIn->sData.nByte == 1` |
|     19599 | 1146 | `	 && pGen->pIn->sData.zString[0] == '?' ){` |
|     19599 | 1147 | `		bShortNullable = 1;` |
|     19599 | 1148 | `		pGen->pIn++;` |
|     19599 | 1149 | `		if( pGen->pIn >= pGen->pEnd ){` |
...
|    192823 | 1158 | `		sxu32 iGroup = 0;` |
|    192823 | 1159 | `		rc = GenStateParsePart(pGen, aAtoms, &nAtoms, iGroup, &nMembers, &bParen, nLine);` |
|    192823 | 1160 | `		if( rc != SXRET_OK ){` |
|         4 | 1161 | `			return rc;` |
|         - | 1162 | `		}` |
...
|    289430 | 1168 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OP)` |
|    193027 | 1169 | `			&& pGen->pIn->sData.nByte == 1 && pGen->pIn->sData.zString[0] == '\|' ){` |
...
|         - | 1187 | `			}` |
|         5 | 1188 | `		}` |
|    192819 | 1189 | `		if( iGroup > 0 && nMembers >= 2 && !bParen ){` |
...
|         - | 1201 | `	{` |
|         - | 1202 | `		int i, j;` |
|    192819 | 1203 | `		int bHasNonNull = 0;` |
|    192819 | 1204 | `		int bAnyIntersection = 0;` |
...
|   6362867 | 1208 | `		for( i = 0; i < PHL_UNION_MAX_ALTS; i++ ) aGroupCount[i] = 0;` |
|    385793 | 1209 | `		for( i = 0; i < nAtoms; i++ ){` |
|    192979 | 1210 | `			if( aAtoms[i].nGroup < PHL_UNION_MAX_ALTS ) aGroupCount[aAtoms[i].nGroup]++;` |
|     96492 | 1211 | `		}` |
|    385737 | 1212 | `		for( i = 0; i < nAtoms; i++ ){` |
|    192949 | 1213 | `			if( aGroupCount[aAtoms[i].nGroup] >= 2 ){ bAnyIntersection = 1; break; }` |
|     96464 | 1214 | `		}` |
...
|    192819 | 1217 | `		if( bShortNullable && bAnyIntersection ){` |
...
|         - | 1221 | `		}` |
|    385779 | 1222 | `		for( i = 0; i < nAtoms; i++ ){` |
...
|    192977 | 1226 | `			if( aGroupCount[aAtoms[i].nGroup] >= 2 ){` |
...
|         - | 1248 | `				}` |
|        24 | 1249 | `			}` |
|    192975 | 1250 | `			if( aAtoms[i].nType == UTA_VOID_FLAG ){` |
...
|         - | 1265 | `				}` |
|        87 | 1266 | `			}` |
|    192973 | 1267 | `			if( aAtoms[i].nType == UTA_NEVER_FLAG ){` |
...
|         - | 1284 | `				}` |
|         8 | 1285 | `			}` |
|    192967 | 1286 | `			if( aAtoms[i].nType == UTA_NULL_FLAG ){` |
|        34 | 1287 | `				bExplicitNull = 1;` |
|        19 | 1288 | `			}else{` |
|    192937 | 1289 | `				bHasNonNull = 1;` |
|         - | 1290 | `			}` |
...
|        98 | 1328 | `			}` |
|     96485 | 1329 | `		}` |
|    192807 | 1330 | `		if( !bHasNonNull && bExplicitNull ){` |
...
|    192807 | 1345 | `	if( bShortNullable \|\| bExplicitNull ){` |
|     19627 | 1346 | `		*piTypeFlags \|= iNullableFlag;` |
|      9811 | 1347 | `	}` |
|         - | 1348 | `	/* Build canonical type text */` |
|    192807 | 1349 | `	if( pTypeText ){` |
|         - | 1350 | `		SyBlob sBlob;` |
|    192807 | 1351 | `		SyBlobInit(&sBlob, &pGen->pVm->sAllocator);` |
|    279412 | 1352 | `		GenBuildUnionTypeText(&sBlob, aAtoms, nAtoms,` |
|     96401 | 1353 | `			(bShortNullable \|\| bExplicitNull) ? 1 : 0);` |
|    192807 | 1354 | `		if( SyBlobLength(&sBlob) > 0 ){` |
|    288923 | 1355 | `			char *zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|    192612 | 1356 | `				(const char *)SyBlobData(&sBlob), SyBlobLength(&sBlob));` |
|    192617 | 1357 | `			if( zDup ){` |
|    192617 | 1358 | `				SyStringInitFromBuf(pTypeText, zDup, SyBlobLength(&sBlob));` |
|     96306 | 1359 | `			}` |
|     96306 | 1360 | `		}` |
|    192807 | 1361 | `		SyBlobRelease(&sBlob);` |
|     96401 | 1362 | `	}` |
...
|         - | 1366 | `	{` |
|    192807 | 1367 | `		int nNonNull = 0;` |
|    192807 | 1368 | `		int iNonNullIdx = -1;` |
|         - | 1369 | `		int i;` |
|    385759 | 1370 | `		for( i = 0; i < nAtoms; i++ ){` |
|    192957 | 1371 | `			if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|    192927 | 1372 | `				nNonNull++;` |
|    192927 | 1373 | `				iNonNullIdx = i;` |
|     96461 | 1374 | `			}` |
|     96481 | 1375 | `		}` |
|    192807 | 1376 | `		if( nNonNull <= 1 ){` |
|         - | 1377 | `			/* Fast path: store as single type. */` |
|    192703 | 1378 | `			if( iNonNullIdx >= 0 ){` |
|    192697 | 1379 | `				PhlTypeAtom *pA = &aAtoms[iNonNullIdx];` |
|    192697 | 1380 | `				if( pA->nType == SXU32_HIGH ){` |
|     64772 | 1381 | `					char *zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|     21589 | 1382 | `						pA->sClass.zString, pA->sClass.nByte);` |
|     43183 | 1383 | `					if( zDup == 0 ) return SXERR_ABORT;` |
|     43183 | 1384 | `					*pnType = SXU32_HIGH;` |
|     43183 | 1385 | `					if( pClass ) SyStringInitFromBuf(pClass, zDup, pA->sClass.nByte);` |
|    171108 | 1386 | `				}else if( pA->nType == UTA_VOID_FLAG ){` |
|       179 | 1387 | `					*pnType = MEMOBJ_VOID;` |
|    149432 | 1388 | `				}else if( pA->nType == UTA_NEVER_FLAG ){` |
|        18 | 1389 | `					*pnType = MEMOBJ_NEVER;` |
|        10 | 1390 | `				}else{` |
|    149329 | 1391 | `					*pnType = pA->nType;` |
|         - | 1392 | `				}` |
|     96346 | 1393 | `			}` |
|     96354 | 1394 | `		}else{` |
...
|         - | 1426 | ` */` |
|   3434694 | 1427 | `PH7_PRIVATE sxi32 GenStateParseReturnType(ph7_gen_state *pGen, ph7_vm_func *pFunc)` |
|         5 | 1428 | `{` |
|   3434699 | 1429 | `	sxi32 iFlags = 0;` |
|         - | 1430 | `	sxi32 rc;` |
|         - | 1431 | `	sxu32 nLine;` |
|   3434699 | 1432 | `	pFunc->nReturnType = 0;` |
|   3434699 | 1433 | `	SyStringInitFromBuf(&pFunc->sReturnClass, 0, 0);` |
|   3434699 | 1434 | `	SyStringInitFromBuf(&pFunc->sReturnTypeName, 0, 0);` |
...
|   3434699 | 1440 | `	SySetReset(&pFunc->aReturnUnion);` |
|   3434699 | 1441 | `	pFunc->iFlags &= ~VM_FUNC_RETURN_NULLABLE;` |
|   3434699 | 1442 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COLON) == 0 ){` |
|   3402687 | 1443 | `		return SXRET_OK;` |
|         - | 1444 | `	}` |
|     32017 | 1445 | `	pGen->pIn++; /* Skip ':' */` |
|     32017 | 1446 | `	if( pGen->pIn >= pGen->pEnd ){` |
|       ! 0 | 1447 | `		return SXRET_OK;` |
|         - | 1448 | `	}` |
|     32017 | 1449 | `	nLine = pGen->pIn->nLine;` |
|     32017 | 1450 | `	rc = GenStateParseUnionTypeDecl(` |
|     16006 | 1451 | `		pGen,` |
|     16006 | 1452 | `		&pFunc->nReturnType,` |
|     16006 | 1453 | `		&pFunc->sReturnClass,` |
|     16006 | 1454 | `		&pFunc->aReturnUnion,` |
|         - | 1455 | `		&iFlags,` |
|     16006 | 1456 | `		&pFunc->sReturnTypeName,` |
...
|         - | 1460 | `		/* bAllowVoid */ 1,` |
|     16006 | 1461 | `		nLine);` |
|     32017 | 1462 | `	if( rc == SXERR_ABORT ){` |
|       ! 0 | 1463 | `		return SXERR_ABORT;` |
|         - | 1464 | `	}` |
|     32017 | 1465 | `	if( rc == SXERR_CORRUPT ){` |
|         - | 1466 | `		/* Error already reported */` |
|       ! 0 | 1467 | `		return SXERR_SYNTAX;` |
|         - | 1468 | `	}` |
|     32017 | 1469 | `	if( rc == SXERR_SYNTAX ){` |
...
|         - | 1479 | `	}` |
|     32011 | 1480 | `	pFunc->iFlags \|= (iFlags & VM_FUNC_RETURN_NULLABLE);` |
|     32011 | 1481 | `	return SXRET_OK;` |
|   1717352 | 1482 | `}` |
|         - | 1483 |  |
|    524360 | 1484 | `PH7_PRIVATE sxi32 GenStateCompileFunc(` |
...
|    524365 | 1498 | `	nLine = pGen->pIn->nLine;` |
|         - | 1499 | `	/* Jump the left parenthesis '(' */` |
|    524365 | 1500 | `	pGen->pIn++;` |
|         - | 1501 | `	/* Delimit the function signature */` |
|    524365 | 1502 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|    524365 | 1503 | `	if( pEnd >= pGen->pEnd ){` |
|         - | 1504 | `		/* Syntax error */` |
...
|    524357 | 1515 | `	pFunc = (ph7_vm_func *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_vm_func));` |
|    524357 | 1516 | `	if( pFunc == 0 ){` |
|       ! 0 | 1517 | `		goto OutOfMem;` |
|         - | 1518 | `	}` |
|         - | 1519 | `	/* Build the function name, prepending namespace if active */` |
|    524365 | 1520 | `	if( SyBlobLength(&pGen->sNamespace) > 0 && !bHandleClosure ){` |
|         - | 1521 | `		SyBlob sFQN;` |
|         - | 1522 | `		sxu32 nLen;` |
...
|        10 | 1534 | `	}else{` |
|    524341 | 1535 | `		zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|    524341 | 1536 | `		if( zName == 0 ){` |
|       ! 0 | 1537 | `			goto OutOfMem;` |
|         - | 1538 | `		}` |
|    524341 | 1539 | `		PH7_VmInitFuncState(pGen->pVm,pFunc,zName,pName->nByte,iFlags,0);` |
|         - | 1540 | `	}` |
...
|    524357 | 1543 | `	pFunc->nLine = nLine;` |
|    524357 | 1544 | `	GenStateConsumeDoc(&(*pGen),&pFunc->sDoc);` |
|    524357 | 1545 | `	if( GenStateConsumeAttrs(&(*pGen),&pFunc->aAttrs) == SXERR_ABORT ){` |
|       ! 0 | 1546 | `		return SXERR_ABORT;` |
|         - | 1547 | `	}` |
|    524357 | 1548 | `	if( pGen->pIn < pEnd ){` |
|         - | 1549 | `		/* Collect function arguments */` |
|    445371 | 1550 | `		rc = GenStateCollectFuncArgs(pFunc,&(*pGen),pEnd,0,0);` |
|    445371 | 1551 | `		if( rc == SXERR_ABORT ){` |
...
|    524355 | 1557 | `	pGen->pIn = &pEnd[1];` |
|         - | 1558 | `	{` |
|    524355 | 1559 | `		sxi32 rcRt = GenStateParseReturnType(pGen, pFunc);` |
|    524355 | 1560 | `		if( rcRt == SXERR_ABORT ){` |
|       ! 0 | 1561 | `			return SXERR_ABORT;` |
|    524355 | 1562 | `		}else if( rcRt == SXERR_SYNTAX ){` |
|         9 | 1563 | `			return SXERR_SYNTAX;` |
|         - | 1564 | `		}` |
|         - | 1565 | `	}` |
|    524349 | 1566 | `	if( bHandleClosure ){` |
...
|    524349 | 1676 | `	rc = GenStateCompileFuncBody(&(*pGen),pFunc);` |
|    524349 | 1677 | `	if( rc == SXERR_ABORT ){` |
|       ! 0 | 1678 | `		return SXERR_ABORT;` |
|         - | 1679 | `	}` |
|         - | 1680 | `	/* The cursor sits just past the body's closing brace */` |
|    524349 | 1681 | `	pFunc->nEndLine = pGen->pIn[-1].nLine;` |
|    524349 | 1682 | `	if( ppFunc ){` |
|    524349 | 1683 | `		*ppFunc = pFunc;` |
|    262172 | 1684 | `	}` |
|    524349 | 1685 | `	rc = SXRET_OK;` |
|    524349 | 1686 | `	if( (pFunc->iFlags & VM_FUNC_CLOSURE) == 0 ){` |
|         - | 1687 | `		/* Reject a php-fatal redeclaration before hoisting the function */` |
|    523755 | 1688 | `		if( GenStateGuardFuncRedeclaration(pGen,pFunc) == SXERR_ABORT ){` |
|         6 | 1689 | `			return SXERR_ABORT;` |
|         - | 1690 | `		}` |
|         - | 1691 | `		/* Finally register the function */` |
|    523751 | 1692 | `		rc = PH7_VmInstallUserFunction(pGen->pVm,pFunc,0);` |
|    261873 | 1693 | `	}` |
|    524345 | 1694 | `	if( rc == SXRET_OK ){` |
|    524345 | 1695 | `		return SXRET_OK;` |
|         - | 1696 | `	}` |
...
|         - | 1708 | ` */` |
|    523752 | 1709 | `PH7_PRIVATE sxi32 PH7_CompileFunction(ph7_gen_state *pGen)` |
|         5 | 1710 | `{` |
|         - | 1711 | `	SyString *pName;` |
|         - | 1712 | `	sxi32 iFlags;` |
|         - | 1713 | `	sxu32 nKwLine;` |
...
|         - | 1715 | `	sxi32 rc;` |
|         - | 1716 |  |
|    523757 | 1717 | `	nLine = pGen->pIn->nLine;` |
|    523757 | 1718 | `	nKwLine = nLine; /* Line of the 'function' keyword (Reflection getStartLine) */` |
|    523757 | 1719 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|    523757 | 1720 | `	iFlags = 0;` |
|    523757 | 1721 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|         - | 1722 | `		/* Return by reference,remember that */` |
|        12 | 1723 | `		iFlags \|= VM_FUNC_REF_RETURN;` |
|         - | 1724 | `		/* Jump the '&' token */` |
|        12 | 1725 | `		pGen->pIn++;` |
|         5 | 1726 | `	}` |
|    523757 | 1727 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|         - | 1738 | `	}` |
|    523751 | 1739 | `	pName = &pGen->pIn->sData;` |
|    523751 | 1740 | `	nLine = pGen->pIn->nLine;` |
|         - | 1741 | `	/* Jump the function name */` |
|    523751 | 1742 | `	pGen->pIn++;` |
|    523751 | 1743 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|         - | 1744 | `		/* Syntax error */` |
...
|         - | 1757 | `	{` |
|    523749 | 1758 | `		ph7_vm_func *pFuncState = 0;` |
|    523749 | 1759 | `		rc = GenStateCompileFunc(&(*pGen),pName,iFlags,FALSE,&pFuncState);` |
|    523749 | 1760 | `		if( pFuncState ){` |
|         - | 1761 | `			/* Reflection getStartLine(): line of the 'function' keyword */` |
|    523733 | 1762 | `			pFuncState->nLine = nKwLine;` |
|    261864 | 1763 | `		}` |
|         - | 1764 | `	}` |
|    523749 | 1765 | `	return rc;` |
|    261881 | 1766 | `}` |
|         - | 1767 |  |
