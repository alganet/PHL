...
|         - |   67 | ` */` |
|    708144 |   68 | `static sxi32 GenStateProcessArgValue(ph7_gen_state *pGen,ph7_vm_func_arg *pArg,SyToken *pIn,SyToken *pEnd)` |
|         5 |   69 | `{` |
|         - |   70 | `	SyToken *pTmpIn,*pTmpEnd;` |
|         - |   71 | `	SySet *pInstrContainer;` |
|         - |   72 | `	sxi32 rc;` |
|         - |   73 | `	/* Swap token stream */` |
|    708149 |   74 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|    708149 |   75 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|    708149 |   76 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pArg->aByteCode);` |
|         - |   77 | `	/* Compile the expression holding the argument value */` |
|    708149 |   78 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|         - |   79 | `	/* Emit the done instruction */` |
|    708149 |   80 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,(rc != SXERR_EMPTY ? 1 : 0),0,0,0);` |
|    708149 |   81 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|    708149 |   82 | `	RE_SWAP_DELIMITER(pGen);` |
|    708149 |   83 | `	if( rc == SXERR_ABORT ){` |
|       ! 0 |   84 | `		return SXERR_ABORT;` |
|         - |   85 | `	}` |
|    708149 |   86 | `	return SXRET_OK;` |
|    354077 |   87 | `}` |
|         - |   88 | `/*` |
...
|         - |  124 | ` */` |
|   1561774 |  125 | `PH7_PRIVATE sxi32 GenStateCollectFuncArgs(ph7_vm_func *pFunc,ph7_gen_state *pGen,SyToken *pEnd,int bCtorCtx,int bAbstractCtx)` |
|         5 |  126 | `{` |
...
|         - |  131 | `	sxi32 rc;` |
|         - |  132 |  |
|   1561779 |  133 | `	pIn = pGen->pIn;` |
|   1561779 |  134 | `	SyBlobInit(&sSig,&pGen->pVm->sAllocator);` |
|         - |  135 | `	/* Process arguments one after one */` |
|   2011431 |  136 | `	for(;;){` |
|   4022867 |  137 | `		if( pIn >= pEnd ){` |
|         - |  138 | `			/* No more arguments to process */` |
|   1561761 |  139 | `			break;` |
|         - |  140 | `		}` |
|   2461111 |  141 | `		SyZero(&sArg,sizeof(ph7_vm_func_arg));` |
|   2461111 |  142 | `		SySetInit(&sArg.aByteCode,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|   2461111 |  143 | `		SySetInit(&sArg.aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|   2461111 |  144 | `		SySetInit(&sArg.aAttrs,&pGen->pVm->sAllocator,sizeof(ph7_attribute));` |
|   2461111 |  145 | `		SyStringInitFromBuf(&sArg.sTypeName,0,0);` |
|         - |  146 | `		/* Parameter #[...] attributes: the group precedes the parameter's` |
|         - |  147 | `		 * first token inside the main token stream */` |
|   2461111 |  148 | `		if( GenStateCollectParamAttrs(&(*pGen),pIn,&sArg.aAttrs) == SXERR_ABORT ){` |
...
|         - |  156 | `		{` |
|   2461111 |  157 | `			int bReadonly = 0, bVisSeen = 0;` |
|   2461111 |  158 | `			sxi32 iVis = PH7_CLASS_PROT_PUBLIC;` |
|   2461111 |  159 | `			sxi32 iSetVisFlag = 0;` |
|         - |  160 | `			int nSetTok;` |
|         - |  161 | `			sxi32 nSetVis;` |
|   2461111 |  162 | `			if( pIn < pEnd && GenStateIsReadonly(pIn) ){` |
|         3 |  163 | `				bReadonly = 1;` |
|         3 |  164 | `				pIn++;` |
|         1 |  165 | `			}` |
|   2461111 |  166 | `			nSetVis = GenStatePeekSetVisibility(pIn,pEnd,&nSetTok);` |
|   2461111 |  167 | `			if( nSetVis ){` |
...
|       ! 0 |  174 | `					pIn++;` |
|         1 |  175 | `				}` |
|   2461110 |  176 | `			}else if( pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD) ){` |
...
|        43 |  194 | `				}` |
|     54679 |  195 | `			}` |
|   2461111 |  196 | `			if( iSetVisFlag == PH7_CLASS_ATTR_PRIVATE_SET ){` |
|         5 |  197 | `				sArg.iFlags \|= VM_FUNC_ARG_PRIV_SET;` |
|   2461109 |  198 | `			}else if( iSetVisFlag == PH7_CLASS_ATTR_PROTECTED_SET ){` |
|       ! 0 |  199 | `				sArg.iFlags \|= VM_FUNC_ARG_PROT_SET;` |
|       ! 0 |  200 | `			}` |
|   2461111 |  201 | `			if( bVisSeen \|\| bReadonly ){` |
|        95 |  202 | `				if( !bCtorCtx ){` |
...
|   2461102 |  223 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_DOLLAR) == 0` |
|   1326215 |  224 | `			&& (pIn->nType & PH7_TK_AMPER) == 0` |
|    179639 |  225 | `			&& (pIn->nType & PH7_TK_ELLIPSIS) == 0 ){` |
|    144517 |  226 | `			sxu32 nLineLocal = pIn->nLine;` |
|    144517 |  227 | `			sxi32 iTFlags = 0;` |
|    144517 |  228 | `			pGen->pIn = pIn;` |
|    144517 |  229 | `			rc = GenStateParseUnionTypeDecl(` |
|     72256 |  230 | `				pGen, &sArg.nType, &sArg.sClass, &sArg.aUnionAlts,` |
|     72256 |  231 | `				&iTFlags, &sArg.sTypeName,` |
|         - |  232 | `				VM_FUNC_ARG_NULLABLE, VM_FUNC_ARG_UNION,` |
|         - |  233 | `				/* bAllowVoid */ 0,` |
|     72256 |  234 | `						nLineLocal);` |
|    144517 |  235 | `			pIn = pGen->pIn;` |
|    144517 |  236 | `			if( rc == SXERR_ABORT ){` |
|       ! 0 |  237 | `				return SXERR_ABORT;` |
|    144517 |  238 | `			}else if( rc == SXERR_CORRUPT ){` |
|         - |  239 | `				/* Error already reported by GenStateParseUnionTypeDecl */` |
|         3 |  240 | `				return SXERR_SYNTAX;` |
|    144515 |  241 | `			}else if( rc == SXERR_SYNTAX ){` |
|         9 |  242 | `				if( pIn < pEnd ){` |
...
|         - |  251 | `			}` |
|    144507 |  252 | `			sArg.iFlags \|= iTFlags;` |
|     72251 |  253 | `		}` |
|   2461097 |  254 | `		if( pIn >= pEnd ){` |
|       ! 0 |  255 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Missing argument name");` |
|       ! 0 |  256 | `			return rc;` |
|         - |  257 | `		}` |
|   2461097 |  258 | `		if( pIn->nType & PH7_TK_AMPER ){` |
|         - |  259 | `			/* Pass by reference,record that */` |
|     23401 |  260 | `			sArg.iFlags \|= VM_FUNC_ARG_BY_REF;` |
|     23401 |  261 | `			pIn++;` |
|     11698 |  262 | `		}` |
|   2461097 |  263 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_ELLIPSIS) ){` |
|         - |  264 | `			/* Variadic parameter: ...$args */` |
|     23457 |  265 | `			sArg.iFlags \|= VM_FUNC_ARG_VARIADIC;` |
|     23457 |  266 | `			pIn++;` |
|     11726 |  267 | `		}` |
|   2461097 |  268 | `		if( pIn >= pEnd \|\| (pIn->nType & PH7_TK_DOLLAR) == 0 \|\| &pIn[1] >= pEnd \|\| (pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|         - |  269 | `			/* Invalid argument */` |
|       ! 0 |  270 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Invalid argument name");` |
|       ! 0 |  271 | `			return rc;` |
|         - |  272 | `		}` |
|   2461097 |  273 | `		pIn++; /* Jump the dollar sign */` |
|         - |  274 | `		/* Copy argument name */` |
|   2461097 |  275 | `		zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,SyStringData(&pIn->sData),SyStringLength(&pIn->sData));` |
|   2461097 |  276 | `		if( zDup == 0 ){` |
|       ! 0 |  277 | `			PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"PH7 engine is running out of memory");` |
|       ! 0 |  278 | `			return SXERR_ABORT;` |
|         - |  279 | `		}` |
|   2461097 |  280 | `		SyStringInitFromBuf(&sArg.sName,zDup,SyStringLength(&pIn->sData));` |
|   2461097 |  281 | `		pIn++;` |
|   2461097 |  282 | `		if( pIn < pEnd ){` |
|   1362365 |  283 | `			if( pIn->nType & PH7_TK_EQUAL ){` |
|         - |  284 | `				SyToken *pDefend;` |
|    708151 |  285 | `				sxi32 iNest = 0;` |
|    708151 |  286 | `				pIn++; /* Jump the equal sign */` |
|    708151 |  287 | `				pDefend = pIn;` |
|         - |  288 | `				/* Process the default value associated with this argument */` |
|   1482461 |  289 | `				while( pDefend < pEnd ){` |
|   1019439 |  290 | `					if( (pDefend->nType & PH7_TK_COMMA) && iNest <= 0 ){` |
|    245129 |  291 | `						break;` |
|         - |  292 | `					}` |
|    774315 |  293 | `					if( pDefend->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*[*/) ){` |
|         - |  294 | `						/* Increment nesting level */` |
|     27247 |  295 | `						iNest++;` |
|    760694 |  296 | `					}else if( pDefend->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CCB/*'}'*/\|PH7_TK_CSB/*]*/) ){` |
|         - |  297 | `						/* Decrement nesting level */` |
|     27247 |  298 | `						iNest--;` |
|     13621 |  299 | `					}` |
|    774315 |  300 | `					pDefend++;` |
|         5 |  301 | `				}` |
|    708151 |  302 | `				if( pIn >= pDefend ){` |
|         3 |  303 | `					rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Missing argument default value");` |
|         3 |  304 | `					return rc;` |
|         - |  305 | `				}` |
|         - |  306 | `				/* Process default value */` |
|    708149 |  307 | `				rc = GenStateProcessArgValue(&(*pGen),&sArg,pIn,pDefend);` |
|    708149 |  308 | `				if( rc != SXRET_OK ){` |
|       ! 0 |  309 | `					return rc;` |
|         - |  310 | `				}` |
...
|    708144 |  316 | `				if( (sArg.nType > 0 \|\| (sArg.iFlags & VM_FUNC_ARG_UNION))` |
|    385215 |  317 | `					&& (sArg.iFlags & VM_FUNC_ARG_NULLABLE) == 0` |
|    377432 |  318 | `					&& &pIn[1] == pDefend` |
...
|    708147 |  344 | `				pIn = pDefend;` |
|    354071 |  345 | `			}` |
|   1362361 |  346 | `			if( pIn < pEnd && (pIn->nType & PH7_TK_COMMA) == 0 ){` |
|       ! 0 |  347 | `				rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Unexpected token '%z'",&pIn->sData);` |
|       ! 0 |  348 | `				return rc;` |
|         - |  349 | `			}` |
|   1362361 |  350 | `			pIn++; /* Jump the trailing comma */` |
|    681178 |  351 | `		}` |
|         - |  352 | `		/* Append argument signature */` |
|   2461093 |  353 | `		if( sArg.nType > 0 ){` |
|    144445 |  354 | `			if( SyStringLength(&sArg.sClass) > 0 ){` |
|         - |  355 | `				/* Class name — prefix with 'o' so generic object hint is a prefix match */` |
|     31235 |  356 | `				int marker = 'o';` |
|     31235 |  357 | `				SyBlobAppend(&sSig,(const void *)&marker,sizeof(char));` |
|     31235 |  358 | `				SyBlobAppend(&sSig,SyStringData(&sArg.sClass),SyStringLength(&sArg.sClass));` |
|     15620 |  359 | `			}else{` |
|         - |  360 | `				int c;` |
...
|         - |  396 | `			 */` |
|   2316653 |  397 | `			SyBlobRelease(&sSig);` |
|         - |  398 | `		}` |
|         - |  399 | `		/* Save in the argument set */` |
|   2461093 |  400 | `		SySetPut(&pFunc->aArgs,(const void *)&sArg);` |
|         5 |  401 | `	}` |
|   1561761 |  402 | `	if( SyBlobLength(&sSig) > 0 ){` |
|         - |  403 | `		/* Save function signature */` |
|     97675 |  404 | `		SyStringInitFromBuf(&pFunc->sSignature,SyBlobData(&sSig),SyBlobLength(&sSig));` |
|     48835 |  405 | `	}` |
|   1561761 |  406 | `	return SXRET_OK;` |
|    780892 |  407 | `}` |
|         - |  408 | `/*` |
...
|      5974 |  575 | `}` |
|   3286988 |  576 | `static int GenStateFuncBodyHasYield(ph7_gen_state *pGen)` |
|         5 |  577 | `{` |
|   3286993 |  578 | `	SyToken *pIn = pGen->pIn;   /* expected at the body's opening '{' */` |
|   3286993 |  579 | `	SyToken *pEnd = pGen->pEnd;` |
|   3286993 |  580 | `	sxi32 iDepth = 0;` |
|   3286993 |  581 | `	int bStarted = 0;` |
| 150569711 |  582 | `	while( pIn < pEnd ){` |
| 150569711 |  583 | `		sxu32 t = pIn->nType;` |
| 150569711 |  584 | `		if( t & PH7_TK_OCB ){ iDepth++; bStarted = 1; pIn++; continue; }` |
| 143788485 |  585 | `		if( t & PH7_TK_CCB ){ iDepth--; pIn++; if( bStarted && iDepth <= 0 ){ break; } continue; }` |
| 137042653 |  586 | `		if( t & PH7_TK_KEYWORD ){` |
|  10236459 |  587 | `			int kw = SX_PTR_TO_INT(pIn->pUserData);` |
|  10236459 |  588 | `			if( kw == PH7_TKWRD_YIELD ){ return TRUE; }` |
|  10224521 |  589 | `			if( kw == PH7_TKWRD_FUNCTION ){ pIn = GenStateSkipNestedFunc(pIn,pEnd); continue; }` |
|         - |  590 | ``			/* `fn` arrow bodies are single expressions and cannot contain a valid yield. */`` |
|   5094724 |  591 | `		}` |
| 136995647 |  592 | `		pIn++;` |
|         5 |  593 | `	}` |
|   3275055 |  594 | `	return FALSE;` |
|   1643499 |  595 | `}` |
|         - |  596 | `/*` |
...
|         - |  600 | ` */` |
|   3286988 |  601 | `PH7_PRIVATE sxi32 GenStateCompileFuncBody(` |
...
|   3286993 |  611 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC,PH7_VmInstrLength(pGen->pVm),pFunc,&pBlock);` |
|   3286993 |  612 | `	if( rc != SXRET_OK ){` |
...
|         - |  616 | `	}` |
|   3286993 |  617 | `	nGotoOfft = SySetUsed(&pGen->aGoto);` |
|         - |  618 | `	/* Swap bytecode containers */` |
|   3286993 |  619 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   3286993 |  620 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pFunc->aByteCode);` |
...
|         - |  625 | `	{` |
|   3286993 |  626 | `		sxu32 nArg = SySetUsed(&pFunc->aArgs);` |
|         - |  627 | `		sxu32 i;` |
|   5693447 |  628 | `		for( i = 0; i < nArg; i++ ){` |
|   2406459 |  629 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pFunc->aArgs,i);` |
|         - |  630 | `			char *zSrc;` |
|         - |  631 | `			sxu32 nSrc,nName;` |
|         - |  632 | `			SySet sToken;` |
|         - |  633 | `			SyToken *pTmpIn,*pTmpEnd;` |
|         - |  634 | `			sxi32 rcPromote;` |
|   2406459 |  635 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|   2406383 |  636 | `				continue;` |
|         - |  637 | `			}` |
...
|        80 |  643 | `			nName = SyStringLength(&pArg->sName);` |
|        80 |  644 | `			nSrc = (sizeof("$this->") - 1) + nName + (sizeof(" = $") - 1) + nName;` |
|        80 |  645 | `			zSrc = (char *)SyMemBackendAlloc(&pGen->pVm->sAllocator,nSrc + 1);` |
|        80 |  646 | `			if( zSrc == 0 ){` |
...
|         - |  652 | `			{` |
|        80 |  653 | `				char *z = zSrc;` |
|        80 |  654 | `				SyMemcpy("$this->",z,sizeof("$this->")-1);` |
|        80 |  655 | `				z += sizeof("$this->")-1;` |
|        80 |  656 | `				SyMemcpy(SyStringData(&pArg->sName),z,nName);` |
|        80 |  657 | `				z += nName;` |
|        80 |  658 | `				SyMemcpy(" = $",z,sizeof(" = $")-1);` |
|        80 |  659 | `				z += sizeof(" = $")-1;` |
|        80 |  660 | `				SyMemcpy(SyStringData(&pArg->sName),z,nName);` |
|        80 |  661 | `				z += nName;` |
|        80 |  662 | `				*z = 0;` |
|         - |  663 | `			}` |
|        80 |  664 | `			SySetInit(&sToken,&pGen->pVm->sAllocator,sizeof(SyToken));` |
|        80 |  665 | `			PH7_TokenizePHP(zSrc,nSrc,1,&sToken,0);` |
|        80 |  666 | `			pTmpIn = pGen->pIn;` |
|        80 |  667 | `			pTmpEnd = pGen->pEnd;` |
|        80 |  668 | `			pGen->pIn = (SyToken *)SySetBasePtr(&sToken);` |
|        80 |  669 | `			pGen->pEnd = &pGen->pIn[SySetUsed(&sToken)];` |
|        80 |  670 | `			rcPromote = PH7_CompileExpr(&(*pGen),0,0);` |
|        80 |  671 | `			pGen->pIn = pTmpIn;` |
|        80 |  672 | `			pGen->pEnd = pTmpEnd;` |
|        80 |  673 | `			SySetRelease(&sToken);` |
|        80 |  674 | `			if( rcPromote == SXERR_ABORT ){` |
...
|        80 |  680 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|        42 |  681 | `		}` |
|         - |  682 | `	}` |
...
|         - |  687 | `	{` |
|   3286993 |  688 | `		sxi8 bSavedGen = pGen->bInGenerator;` |
|   3286993 |  689 | `		pGen->bInGenerator = (sxi8)GenStateFuncBodyHasYield(&(*pGen));` |
|         - |  690 | `		/* Compile the body */` |
|   3286993 |  691 | `		PH7_CompileBlock(&(*pGen),0);` |
|   3286993 |  692 | `		pGen->bInGenerator = bSavedGen;` |
|         - |  693 | `	}` |
|         - |  694 | `	/* Fix exception jumps now the destination is resolved */` |
|   3286993 |  695 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|         - |  696 | `	/* Emit the final return if not yet done */` |
|   3286993 |  697 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|         - |  698 | `	/* Fix gotos jumps now the destination is resolved */` |
|   3286993 |  699 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),nGotoOfft) ){` |
|       ! 0 |  700 | `		rc = SXERR_ABORT;` |
|       ! 0 |  701 | `	}` |
|   3286993 |  702 | `	SySetTruncate(&pGen->aGoto,nGotoOfft);` |
|         - |  703 | `	/* Restore the default container */` |
|   3286993 |  704 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|         - |  705 | `	/* Leave function block */` |
|   3286993 |  706 | `	GenStateLeaveBlock(&(*pGen),0);` |
|   3286993 |  707 | `	if( rc == SXERR_ABORT ){` |
...
|         - |  712 | `	{` |
|   3286993 |  713 | `		VmInstr *aInstr = (VmInstr *)SySetBasePtr(&pFunc->aByteCode);` |
|         - |  714 | `		sxu32 i;` |
|  92225167 |  715 | `		for( i = 0; i < SySetUsed(&pFunc->aByteCode); i++ ){` |
|  88950117 |  716 | `			if( aInstr[i].iOp == PH7_OP_YIELD \|\| aInstr[i].iOp == PH7_OP_YIELD_FROM ){` |
|     11943 |  717 | `				pFunc->iFlags \|= VM_FUNC_GENERATOR;` |
|     11943 |  718 | `				break;` |
|         - |  719 | `			}` |
|  44469092 |  720 | `		}` |
|         - |  721 | `	}` |
|   3286993 |  722 | `	if( pFunc->iFlags & VM_FUNC_GENERATOR ){` |
...
|         - |  800 | ` */` |
|     43138 |  801 | `static int GenStateIsReservedTypeWord(const SyString *pName)` |
|         5 |  802 | `{` |
...
|         - |  807 | `	};` |
|         - |  808 | `	sxu32 i;` |
|    903825 |  809 | `	for( i = 0 ; i < SX_ARRAYSIZE(azWords) ; i++ ){` |
|    860805 |  810 | `		sxu32 n = (sxu32)SyStrlen(azWords[i]);` |
|    860805 |  811 | `		if( pName->nByte == n && SyStrnicmp(pName->zString,azWords[i],n) == 0 ){` |
|       123 |  812 | `			return 1;` |
|         - |  813 | `		}` |
|    430346 |  814 | `	}` |
|     43025 |  815 | `	return 0;` |
|     21574 |  816 | `}` |
|    192584 |  817 | `static sxi32 GenStateParseOneTypeAtom(ph7_gen_state *pGen, PhlTypeAtom *pOut)` |
|         5 |  818 | `{` |
|    192589 |  819 | `	SyToken *pIn = pGen->pIn;` |
|    192589 |  820 | `	int bAbsolute = 0;` |
|    192589 |  821 | `	SyZero(pOut, sizeof(*pOut));` |
|    192589 |  822 | `	SyStringInitFromBuf(&pOut->sClass, 0, 0);` |
|    192589 |  823 | `	if( pIn >= pGen->pEnd ){` |
|       ! 0 |  824 | `		return SXERR_SYNTAX;` |
|         - |  825 | `	}` |
|         - |  826 | `	/* Optional leading namespace separator '\' on FQN class types */` |
|    192589 |  827 | `	if( pIn->nType & PH7_TK_NSSEP ){` |
...
|         - |  832 | `		}` |
|         4 |  833 | `	}` |
|    192589 |  834 | `	if( (pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|       ! 0 |  835 | `		return SXERR_SYNTAX;` |
|         - |  836 | `	}` |
|    192589 |  837 | `	if( pIn->nType & PH7_TK_KEYWORD ){` |
...
|     43379 |  862 | `		SyString *pT = &pIn->sData;` |
|     43379 |  863 | `		if( pT->nByte == 4 && SyMemcmpNoCase(pT->zString, "null", 4) == 0 ){` |
|        34 |  864 | `			pOut->nType = UTA_NULL_FLAG; pOut->zCanon = "null"; pOut->nCanon = 4;` |
|        34 |  865 | `			pIn++;` |
|     43364 |  866 | `		}else if( pT->nByte == 4 && SyMemcmpNoCase(pT->zString, "void", 4) == 0 ){` |
|       181 |  867 | `			pOut->nType = UTA_VOID_FLAG; pOut->zCanon = "void"; pOut->nCanon = 4;` |
|       181 |  868 | `			pIn++;` |
|     43261 |  869 | `		}else if( pT->nByte == 5 && SyMemcmpNoCase(pT->zString, "never", 5) == 0 ){` |
|        27 |  870 | `			pOut->nType = UTA_NEVER_FLAG; pOut->zCanon = "never"; pOut->nCanon = 5;` |
|        27 |  871 | `			pIn++;` |
|        16 |  872 | `		}else{` |
|         - |  873 | `			/* Class / interface name; consume namespace path a\b\c */` |
|     43151 |  874 | `			SyToken *pFirst = pIn;` |
|     43151 |  875 | `			SyToken *pLast = pIn;` |
|     43151 |  876 | `			pOut->nType = SXU32_HIGH;` |
|     43151 |  877 | `			pOut->sClass = pIn->sData;` |
|     43151 |  878 | `			pIn++;` |
|     64722 |  879 | `			while( pIn + 1 < pGen->pEnd && (pIn->nType & PH7_TK_NSSEP)` |
|     43154 |  880 | `				&& (pIn[1].nType & PH7_TK_ID) ){` |
|         3 |  881 | `				pLast = &pIn[1];` |
|         3 |  882 | `				pIn += 2;` |
|         1 |  883 | `			}` |
|     43151 |  884 | `			if( pLast != pFirst ){` |
...
|     43151 |  898 | `			if( !bAbsolute && pLast == pFirst && !GenStateIsReservedTypeWord(&pOut->sClass) ){` |
|         - |  899 | `				SyBlob sFqn;` |
...
|         - |  912 | `		}` |
|         - |  913 | `	}` |
|    192587 |  914 | `	pGen->pIn = pIn;` |
|    192587 |  915 | `	return SXRET_OK;` |
|     96297 |  916 | `}` |
|         - |  917 |  |
|         - |  918 | `/*` |
...
|         - |  924 | ` */` |
|    192408 |  925 | `static void GenBuildUnionTypeText(SyBlob *pBlob, PhlTypeAtom *aAtoms, int nAtoms, int bNullable)` |
|         5 |  926 | `{` |
|         - |  927 | `	int i;` |
|    192413 |  928 | `	int nNonNull = 0;` |
|    192413 |  929 | `	int bAnyIntersection = 0;` |
|         - |  930 | `	sxu32 aGroupCount[PHL_UNION_MAX_ALTS];` |
|    192413 |  931 | `	sxu32 nMaxGroup = 0;` |
|   6349469 |  932 | `	for( i = 0; i < PHL_UNION_MAX_ALTS; i++ ) aGroupCount[i] = 0;` |
|    384971 |  933 | `	for( i = 0; i < nAtoms; i++ ){` |
|    192563 |  934 | `		if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|    192533 |  935 | `			nNonNull++;` |
|    192533 |  936 | `			if( aAtoms[i].nGroup < PHL_UNION_MAX_ALTS ){` |
|    192533 |  937 | `				aGroupCount[aAtoms[i].nGroup]++;` |
|    192533 |  938 | `				if( aAtoms[i].nGroup > nMaxGroup ) nMaxGroup = aAtoms[i].nGroup;` |
|     96264 |  939 | `			}` |
|     96264 |  940 | `		}` |
|     96284 |  941 | `	}` |
|    384919 |  942 | `	for( i = 0; i < nAtoms; i++ ){` |
|    192535 |  943 | `		if( aAtoms[i].nType != UTA_NULL_FLAG && aGroupCount[aAtoms[i].nGroup] >= 2 ){` |
|        29 |  944 | `			bAnyIntersection = 1;` |
|        29 |  945 | `			break;` |
|         - |  946 | `		}` |
|     96258 |  947 | `	}` |
|    192413 |  948 | `	if( bAnyIntersection ){` |
...
|      9812 |  983 | `		return;` |
|         - |  984 | `	}` |
|    192389 |  985 | `	if( nNonNull == 1 && bNullable ){` |
|         - |  986 | `		/* Shorthand: ?T */` |
...
|       ! 0 |  997 | `	}` |
|         - |  998 | `	{` |
|    172823 |  999 | `		int bFirst = 1;` |
|         - | 1000 | `		/* 1) Classes in declaration order */` |
|    345747 | 1001 | `		for( i = 0; i < nAtoms; i++ ){` |
|    172929 | 1002 | `			if( aAtoms[i].nType == SXU32_HIGH ){` |
|     31437 | 1003 | `				if( !bFirst ) SyBlobAppend(pBlob, "\|", 1);` |
|     31437 | 1004 | `				SyBlobAppend(pBlob, aAtoms[i].sClass.zString, aAtoms[i].sClass.nByte);` |
|     31437 | 1005 | `				bFirst = 0;` |
|     15716 | 1006 | `			}` |
|     86467 | 1007 | `		}` |
...
|         - | 1012 | `			int k;` |
|   1209731 | 1013 | `			for( k = 0; k < (int)(sizeof(aOrder)/sizeof(aOrder[0])); k++ ){` |
|   1933059 | 1014 | `				for( i = 0; i < nAtoms; i++ ){` |
|   1037437 | 1015 | `					if( aAtoms[i].nType == aOrder[k] ){` |
...
|         - | 1045 | ` */` |
|    192558 | 1046 | `static sxi32 GenStateParsePart(` |
|         - | 1047 | `	ph7_gen_state *pGen, PhlTypeAtom *aAtoms, int *pnAtoms, sxu32 iGroup,` |
|         - | 1048 | `	int *pnMembers, int *pbParen, sxu32 nLine)` |
|         5 | 1049 | `{` |
|         - | 1050 | `	sxi32 rc;` |
|    192563 | 1051 | `	int nMembers = 0;` |
|    192563 | 1052 | `	int bParen = 0;` |
|    192563 | 1053 | `	*pnMembers = 0;` |
|    192563 | 1054 | `	*pbParen = 0;` |
|    192563 | 1055 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_LPAREN) ){` |
|         9 | 1056 | `		bParen = 1;` |
|         9 | 1057 | `		pGen->pIn++; /* skip '(' */` |
|         3 | 1058 | `	}` |
|     96279 | 1059 | `	for(;;){` |
|    192589 | 1060 | `		if( *pnAtoms >= PHL_UNION_MAX_ALTS ){` |
...
|         - | 1064 | `		}` |
|    192589 | 1065 | `		rc = GenStateParseOneTypeAtom(pGen, &aAtoms[*pnAtoms]);` |
|    192589 | 1066 | `		if( rc != SXRET_OK ){` |
|         3 | 1067 | `			return rc;` |
|         - | 1068 | `		}` |
|    192587 | 1069 | `		aAtoms[*pnAtoms].nGroup = iGroup;` |
|    192587 | 1070 | `		(*pnAtoms)++;` |
|    192587 | 1071 | `		nMembers++;` |
|         - | 1072 | ``		/* Continue the intersection while `&` is followed by another type atom. */`` |
|    192587 | 1073 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
...
|         - | 1094 | `		}` |
|         3 | 1095 | `	}` |
|    192561 | 1096 | `	*pnMembers = nMembers;` |
|    192561 | 1097 | `	*pbParen = bParen;` |
|    192561 | 1098 | `	return SXRET_OK;` |
|     96284 | 1099 | `}` |
|         - | 1100 |  |
|         - | 1101 | `/*` |
...
|         - | 1118 | ` */` |
|    192424 | 1119 | `PH7_PRIVATE sxi32 GenStateParseUnionTypeDecl(` |
...
|    192429 | 1132 | `	int nAtoms = 0;` |
|    192429 | 1133 | `	int bShortNullable = 0;` |
|    192429 | 1134 | `	int bExplicitNull = 0;` |
|         - | 1135 | `	sxi32 rc;` |
|    192429 | 1136 | `	*pnType = 0;` |
|    192429 | 1137 | `	if( pClass ) SyStringInitFromBuf(pClass, 0, 0);` |
|    192429 | 1138 | `	*piTypeFlags = 0;` |
|    192429 | 1139 | `	if( pTypeText ) SyStringInitFromBuf(pTypeText, 0, 0);` |
|         - | 1140 |  |
|    192429 | 1141 | `	if( pGen->pIn >= pGen->pEnd ){` |
|       ! 0 | 1142 | `		return SXRET_OK;` |
|         - | 1143 | `	}` |
|         - | 1144 | ``	/* Optional `?` shorthand prefix */`` |
|    192424 | 1145 | `	if( (pGen->pIn->nType & PH7_TK_OP) && pGen->pIn->sData.nByte == 1` |
...
|    192429 | 1158 | `		sxu32 iGroup = 0;` |
|    192429 | 1159 | `		rc = GenStateParsePart(pGen, aAtoms, &nAtoms, iGroup, &nMembers, &bParen, nLine);` |
|    192429 | 1160 | `		if( rc != SXRET_OK ){` |
|         4 | 1161 | `			return rc;` |
|         - | 1162 | `		}` |
...
|    288839 | 1168 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OP)` |
|    192633 | 1169 | `			&& pGen->pIn->sData.nByte == 1 && pGen->pIn->sData.zString[0] == '\|' ){` |
...
|         - | 1187 | `			}` |
|         5 | 1188 | `		}` |
|    192425 | 1189 | `		if( iGroup > 0 && nMembers >= 2 && !bParen ){` |
...
|         - | 1201 | `	{` |
|         - | 1202 | `		int i, j;` |
|    192425 | 1203 | `		int bHasNonNull = 0;` |
|    192425 | 1204 | `		int bAnyIntersection = 0;` |
...
|   6349865 | 1208 | `		for( i = 0; i < PHL_UNION_MAX_ALTS; i++ ) aGroupCount[i] = 0;` |
|    385005 | 1209 | `		for( i = 0; i < nAtoms; i++ ){` |
|    192585 | 1210 | `			if( aAtoms[i].nGroup < PHL_UNION_MAX_ALTS ) aGroupCount[aAtoms[i].nGroup]++;` |
|     96295 | 1211 | `		}` |
|    384949 | 1212 | `		for( i = 0; i < nAtoms; i++ ){` |
|    192555 | 1213 | `			if( aGroupCount[aAtoms[i].nGroup] >= 2 ){ bAnyIntersection = 1; break; }` |
|     96267 | 1214 | `		}` |
...
|    192425 | 1217 | `		if( bShortNullable && bAnyIntersection ){` |
...
|         - | 1221 | `		}` |
|    384991 | 1222 | `		for( i = 0; i < nAtoms; i++ ){` |
...
|    192583 | 1226 | `			if( aGroupCount[aAtoms[i].nGroup] >= 2 ){` |
...
|         - | 1248 | `				}` |
|        24 | 1249 | `			}` |
|    192581 | 1250 | `			if( aAtoms[i].nType == UTA_VOID_FLAG ){` |
...
|         - | 1265 | `				}` |
|        87 | 1266 | `			}` |
|    192579 | 1267 | `			if( aAtoms[i].nType == UTA_NEVER_FLAG ){` |
...
|         - | 1284 | `				}` |
|         8 | 1285 | `			}` |
|    192573 | 1286 | `			if( aAtoms[i].nType == UTA_NULL_FLAG ){` |
|        34 | 1287 | `				bExplicitNull = 1;` |
|        19 | 1288 | `			}else{` |
|    192543 | 1289 | `				bHasNonNull = 1;` |
|         - | 1290 | `			}` |
...
|        98 | 1328 | `			}` |
|     96288 | 1329 | `		}` |
|    192413 | 1330 | `		if( !bHasNonNull && bExplicitNull ){` |
...
|    192413 | 1345 | `	if( bShortNullable \|\| bExplicitNull ){` |
|     19587 | 1346 | `		*piTypeFlags \|= iNullableFlag;` |
|      9791 | 1347 | `	}` |
|         - | 1348 | `	/* Build canonical type text */` |
|    192413 | 1349 | `	if( pTypeText ){` |
|         - | 1350 | `		SyBlob sBlob;` |
|    192413 | 1351 | `		SyBlobInit(&sBlob, &pGen->pVm->sAllocator);` |
|    278841 | 1352 | `		GenBuildUnionTypeText(&sBlob, aAtoms, nAtoms,` |
|     96204 | 1353 | `			(bShortNullable \|\| bExplicitNull) ? 1 : 0);` |
|    192413 | 1354 | `		if( SyBlobLength(&sBlob) > 0 ){` |
|    288332 | 1355 | `			char *zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|    192218 | 1356 | `				(const char *)SyBlobData(&sBlob), SyBlobLength(&sBlob));` |
|    192223 | 1357 | `			if( zDup ){` |
|    192223 | 1358 | `				SyStringInitFromBuf(pTypeText, zDup, SyBlobLength(&sBlob));` |
|     96109 | 1359 | `			}` |
|     96109 | 1360 | `		}` |
|    192413 | 1361 | `		SyBlobRelease(&sBlob);` |
|     96204 | 1362 | `	}` |
...
|         - | 1366 | `	{` |
|    192413 | 1367 | `		int nNonNull = 0;` |
|    192413 | 1368 | `		int iNonNullIdx = -1;` |
|         - | 1369 | `		int i;` |
|    384971 | 1370 | `		for( i = 0; i < nAtoms; i++ ){` |
|    192563 | 1371 | `			if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|    192533 | 1372 | `				nNonNull++;` |
|    192533 | 1373 | `				iNonNullIdx = i;` |
|     96264 | 1374 | `			}` |
|     96284 | 1375 | `		}` |
|    192413 | 1376 | `		if( nNonNull <= 1 ){` |
|         - | 1377 | `			/* Fast path: store as single type. */` |
|    192309 | 1378 | `			if( iNonNullIdx >= 0 ){` |
|    192303 | 1379 | `				PhlTypeAtom *pA = &aAtoms[iNonNullIdx];` |
|    192303 | 1380 | `				if( pA->nType == SXU32_HIGH ){` |
|     64637 | 1381 | `					char *zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|     21544 | 1382 | `						pA->sClass.zString, pA->sClass.nByte);` |
|     43093 | 1383 | `					if( zDup == 0 ) return SXERR_ABORT;` |
|     43093 | 1384 | `					*pnType = SXU32_HIGH;` |
|     43093 | 1385 | `					if( pClass ) SyStringInitFromBuf(pClass, zDup, pA->sClass.nByte);` |
|    170759 | 1386 | `				}else if( pA->nType == UTA_VOID_FLAG ){` |
...
|         - | 1426 | ` */` |
|   3427598 | 1427 | `PH7_PRIVATE sxi32 GenStateParseReturnType(ph7_gen_state *pGen, ph7_vm_func *pFunc)` |
|         5 | 1428 | `{` |
|   3427603 | 1429 | `	sxi32 iFlags = 0;` |
|         - | 1430 | `	sxi32 rc;` |
|         - | 1431 | `	sxu32 nLine;` |
|   3427603 | 1432 | `	pFunc->nReturnType = 0;` |
|   3427603 | 1433 | `	SyStringInitFromBuf(&pFunc->sReturnClass, 0, 0);` |
|   3427603 | 1434 | `	SyStringInitFromBuf(&pFunc->sReturnTypeName, 0, 0);` |
...
|   3427603 | 1440 | `	SySetReset(&pFunc->aReturnUnion);` |
|   3427603 | 1441 | `	pFunc->iFlags &= ~VM_FUNC_RETURN_NULLABLE;` |
|   3427603 | 1442 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COLON) == 0 ){` |
|   3395655 | 1443 | `		return SXRET_OK;` |
|         - | 1444 | `	}` |
...
|   1713804 | 1482 | `}` |
|         - | 1483 |  |
|    523242 | 1484 | `PH7_PRIVATE sxi32 GenStateCompileFunc(` |
...
|    523247 | 1498 | `	nLine = pGen->pIn->nLine;` |
|         - | 1499 | `	/* Jump the left parenthesis '(' */` |
|    523247 | 1500 | `	pGen->pIn++;` |
|         - | 1501 | `	/* Delimit the function signature */` |
|    523247 | 1502 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|    523247 | 1503 | `	if( pEnd >= pGen->pEnd ){` |
|         - | 1504 | `		/* Syntax error */` |
|         8 | 1505 | `		rc = PH7_GenSyntaxError(pGen,pGen->pIn < pGen->pEnd ? pGen->pIn : 0,"variable");` |
|         3 | 1506 | `		(void)pName;` |
|         8 | 1507 | `		if( rc == SXERR_ABORT ){` |
|         - | 1508 | `			/* Error count limit reached,abort immediately */` |
|       ! 0 | 1509 | `			return SXERR_ABORT;` |
|         - | 1510 | `		}` |
|         8 | 1511 | `		pGen->pIn = pGen->pEnd;` |
|         8 | 1512 | `		return SXRET_OK;` |
|         - | 1513 | `	}` |
|         - | 1514 | `	/* Create the function state */` |
|    523241 | 1515 | `	pFunc = (ph7_vm_func *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_vm_func));` |
|    523241 | 1516 | `	if( pFunc == 0 ){` |
|       ! 0 | 1517 | `		goto OutOfMem;` |
|         - | 1518 | `	}` |
|         - | 1519 | `	/* Build the function name, prepending namespace if active */` |
|    523249 | 1520 | `	if( SyBlobLength(&pGen->sNamespace) > 0 && !bHandleClosure ){` |
|         - | 1521 | `		SyBlob sFQN;` |
|         - | 1522 | `		sxu32 nLen;` |
...
|        10 | 1534 | `	}else{` |
|    523225 | 1535 | `		zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|    523225 | 1536 | `		if( zName == 0 ){` |
|       ! 0 | 1537 | `			goto OutOfMem;` |
|         - | 1538 | `		}` |
|    523225 | 1539 | `		PH7_VmInitFuncState(pGen->pVm,pFunc,zName,pName->nByte,iFlags,0);` |
|         - | 1540 | `	}` |
...
|    523241 | 1543 | `	pFunc->nLine = nLine;` |
|    523241 | 1544 | `	GenStateConsumeDoc(&(*pGen),&pFunc->sDoc);` |
|    523241 | 1545 | `	if( GenStateConsumeAttrs(&(*pGen),&pFunc->aAttrs) == SXERR_ABORT ){` |
|       ! 0 | 1546 | `		return SXERR_ABORT;` |
|         - | 1547 | `	}` |
|    523241 | 1548 | `	if( pGen->pIn < pEnd ){` |
|         - | 1549 | `		/* Collect function arguments */` |
|    444443 | 1550 | `		rc = GenStateCollectFuncArgs(pFunc,&(*pGen),pEnd,0,0);` |
|    444443 | 1551 | `		if( rc == SXERR_ABORT ){` |
...
|    523239 | 1557 | `	pGen->pIn = &pEnd[1];` |
|         - | 1558 | `	{` |
|    523239 | 1559 | `		sxi32 rcRt = GenStateParseReturnType(pGen, pFunc);` |
|    523239 | 1560 | `		if( rcRt == SXERR_ABORT ){` |
|       ! 0 | 1561 | `			return SXERR_ABORT;` |
|    523239 | 1562 | `		}else if( rcRt == SXERR_SYNTAX ){` |
|         9 | 1563 | `			return SXERR_SYNTAX;` |
|         - | 1564 | `		}` |
|         - | 1565 | `	}` |
|    523233 | 1566 | `	if( bHandleClosure ){` |
|         - | 1567 | `		ph7_vm_func_closure_env sEnv;` |
|       587 | 1568 | `		int got_this = 0; /* TRUE if $this have been seen */` |
|       582 | 1569 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD)` |
|       342 | 1570 | `			&& SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_USE ){` |
...
|         3 | 1653 | `				}` |
|        46 | 1654 | `		}` |
|       587 | 1655 | `		if( !got_this && (iFlags & VM_FUNC_STATIC_CL) == 0 ){` |
...
|       565 | 1663 | `			SyZero(&sEnv,sizeof(ph7_vm_func_closure_env));` |
|       565 | 1664 | `			sEnv.iFlags = VM_FUNC_ARG_IGNORE; /* Do not install if NULL */` |
|       565 | 1665 | `			sEnv.nIdx = SXU32_HIGH;` |
|       565 | 1666 | `			PH7_MemObjInit(pGen->pVm,&sEnv.sValue);` |
|       565 | 1667 | `			SyStringInitFromBuf(&sEnv.sName,"this",sizeof("this")-1);` |
|       565 | 1668 | `			SySetPut(&pFunc->aClosureEnv,(const void *)&sEnv);` |
|       280 | 1669 | `		}` |
|       587 | 1670 | `		if( SySetUsed(&pFunc->aClosureEnv) > 0 ){` |
|         - | 1671 | `			/* Mark as closure */` |
|       567 | 1672 | `			pFunc->iFlags \|= VM_FUNC_CLOSURE;` |
|       281 | 1673 | `		}` |
|       291 | 1674 | `	}` |
|         - | 1675 | `	/* Compile the body */` |
|    523233 | 1676 | `	rc = GenStateCompileFuncBody(&(*pGen),pFunc);` |
|    523233 | 1677 | `	if( rc == SXERR_ABORT ){` |
|       ! 0 | 1678 | `		return SXERR_ABORT;` |
|         - | 1679 | `	}` |
|         - | 1680 | `	/* The cursor sits just past the body's closing brace */` |
|    523233 | 1681 | `	pFunc->nEndLine = pGen->pIn[-1].nLine;` |
|    523233 | 1682 | `	if( ppFunc ){` |
|    523233 | 1683 | `		*ppFunc = pFunc;` |
|    261614 | 1684 | `	}` |
|    523233 | 1685 | `	rc = SXRET_OK;` |
|    523233 | 1686 | `	if( (pFunc->iFlags & VM_FUNC_CLOSURE) == 0 ){` |
|         - | 1687 | `		/* Reject a php-fatal redeclaration before hoisting the function */` |
|    522671 | 1688 | `		if( GenStateGuardFuncRedeclaration(pGen,pFunc) == SXERR_ABORT ){` |
|         6 | 1689 | `			return SXERR_ABORT;` |
|         - | 1690 | `		}` |
|         - | 1691 | `		/* Finally register the function */` |
|    522667 | 1692 | `		rc = PH7_VmInstallUserFunction(pGen->pVm,pFunc,0);` |
|    261331 | 1693 | `	}` |
|    523229 | 1694 | `	if( rc == SXRET_OK ){` |
|    523229 | 1695 | `		return SXRET_OK;` |
|         - | 1696 | `	}` |
...
|         - | 1708 | ` */` |
|    522668 | 1709 | `PH7_PRIVATE sxi32 PH7_CompileFunction(ph7_gen_state *pGen)` |
|         5 | 1710 | `{` |
|         - | 1711 | `	SyString *pName;` |
|         - | 1712 | `	sxi32 iFlags;` |
|         - | 1713 | `	sxu32 nKwLine;` |
...
|         - | 1715 | `	sxi32 rc;` |
|         - | 1716 |  |
|    522673 | 1717 | `	nLine = pGen->pIn->nLine;` |
|    522673 | 1718 | `	nKwLine = nLine; /* Line of the 'function' keyword (Reflection getStartLine) */` |
|    522673 | 1719 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|    522673 | 1720 | `	iFlags = 0;` |
|    522673 | 1721 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|         - | 1722 | `		/* Return by reference,remember that */` |
|        12 | 1723 | `		iFlags \|= VM_FUNC_REF_RETURN;` |
|         - | 1724 | `		/* Jump the '&' token */` |
|        12 | 1725 | `		pGen->pIn++;` |
|         5 | 1726 | `	}` |
|    522673 | 1727 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|         - | 1738 | `	}` |
|    522667 | 1739 | `	pName = &pGen->pIn->sData;` |
|    522667 | 1740 | `	nLine = pGen->pIn->nLine;` |
|         - | 1741 | `	/* Jump the function name */` |
|    522667 | 1742 | `	pGen->pIn++;` |
|    522667 | 1743 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|         - | 1744 | `		/* Syntax error */` |
...
|         - | 1757 | `	{` |
|    522665 | 1758 | `		ph7_vm_func *pFuncState = 0;` |
|    522665 | 1759 | `		rc = GenStateCompileFunc(&(*pGen),pName,iFlags,FALSE,&pFuncState);` |
|    522665 | 1760 | `		if( pFuncState ){` |
|         - | 1761 | `			/* Reflection getStartLine(): line of the 'function' keyword */` |
|    522651 | 1762 | `			pFuncState->nLine = nKwLine;` |
|    261323 | 1763 | `		}` |
|         - | 1764 | `	}` |
|    522665 | 1765 | `	return rc;` |
|    261339 | 1766 | `}` |
|         - | 1767 |  |
