...
|         - |  124 | ` */` |
|   1558558 |  125 | `PH7_PRIVATE sxi32 GenStateCollectFuncArgs(ph7_vm_func *pFunc,ph7_gen_state *pGen,SyToken *pEnd,int bCtorCtx,int bAbstractCtx)` |
|         5 |  126 | `{` |
...
|         - |  131 | `	sxi32 rc;` |
|         - |  132 |  |
|   1558563 |  133 | `	pIn = pGen->pIn;` |
|   1558563 |  134 | `	SyBlobInit(&sSig,&pGen->pVm->sAllocator);` |
|         - |  135 | `	/* Process arguments one after one */` |
|   2007290 |  136 | `	for(;;){` |
|   4014585 |  137 | `		if( pIn >= pEnd ){` |
|         - |  138 | `			/* No more arguments to process */` |
|   1558545 |  139 | `			break;` |
|         - |  140 | `		}` |
|   2456045 |  141 | `		SyZero(&sArg,sizeof(ph7_vm_func_arg));` |
|   2456045 |  142 | `		SySetInit(&sArg.aByteCode,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|   2456045 |  143 | `		SySetInit(&sArg.aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|   2456045 |  144 | `		SySetInit(&sArg.aAttrs,&pGen->pVm->sAllocator,sizeof(ph7_attribute));` |
|   2456045 |  145 | `		SyStringInitFromBuf(&sArg.sTypeName,0,0);` |
|         - |  146 | `		/* Parameter #[...] attributes: the group precedes the parameter's` |
|         - |  147 | `		 * first token inside the main token stream */` |
|   2456045 |  148 | `		if( GenStateCollectParamAttrs(&(*pGen),pIn,&sArg.aAttrs) == SXERR_ABORT ){` |
...
|         - |  156 | `		{` |
|   2456045 |  157 | `			int bReadonly = 0, bVisSeen = 0;` |
|   2456045 |  158 | `			sxi32 iVis = PH7_CLASS_PROT_PUBLIC;` |
|   2456045 |  159 | `			sxi32 iSetVisFlag = 0;` |
|         - |  160 | `			int nSetTok;` |
|         - |  161 | `			sxi32 nSetVis;` |
|   2456045 |  162 | `			if( pIn < pEnd && GenStateIsReadonly(pIn) ){` |
|         3 |  163 | `				bReadonly = 1;` |
|         3 |  164 | `				pIn++;` |
|         1 |  165 | `			}` |
|   2456045 |  166 | `			nSetVis = GenStatePeekSetVisibility(pIn,pEnd,&nSetTok);` |
|   2456045 |  167 | `			if( nSetVis ){` |
...
|       ! 0 |  174 | `					pIn++;` |
|         1 |  175 | `				}` |
|   2456044 |  176 | `			}else if( pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD) ){` |
|    109133 |  177 | `				sxu32 nKw = (sxu32)SX_PTR_TO_INT(pIn->pUserData);` |
|    109133 |  178 | `				if( nKw == PH7_TKWRD_PUBLIC \|\| nKw == PH7_TKWRD_PROTECTED \|\| nKw == PH7_TKWRD_PRIVATE ){` |
|        91 |  179 | `					bVisSeen = 1;` |
...
|        43 |  194 | `				}` |
|     54564 |  195 | `			}` |
|   2456045 |  196 | `			if( iSetVisFlag == PH7_CLASS_ATTR_PRIVATE_SET ){` |
|         5 |  197 | `				sArg.iFlags \|= VM_FUNC_ARG_PRIV_SET;` |
|   2456043 |  198 | `			}else if( iSetVisFlag == PH7_CLASS_ATTR_PROTECTED_SET ){` |
|       ! 0 |  199 | `				sArg.iFlags \|= VM_FUNC_ARG_PROT_SET;` |
|       ! 0 |  200 | `			}` |
|   2456045 |  201 | `			if( bVisSeen \|\| bReadonly ){` |
|        95 |  202 | `				if( !bCtorCtx ){` |
...
|   2456036 |  223 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_DOLLAR) == 0` |
|   1323483 |  224 | `			&& (pIn->nType & PH7_TK_AMPER) == 0` |
|    179265 |  225 | `			&& (pIn->nType & PH7_TK_ELLIPSIS) == 0 ){` |
|    144215 |  226 | `			sxu32 nLineLocal = pIn->nLine;` |
|    144215 |  227 | `			sxi32 iTFlags = 0;` |
|    144215 |  228 | `			pGen->pIn = pIn;` |
|    144215 |  229 | `			rc = GenStateParseUnionTypeDecl(` |
|     72105 |  230 | `				pGen, &sArg.nType, &sArg.sClass, &sArg.aUnionAlts,` |
|     72105 |  231 | `				&iTFlags, &sArg.sTypeName,` |
|         - |  232 | `				VM_FUNC_ARG_NULLABLE, VM_FUNC_ARG_UNION,` |
|         - |  233 | `				/* bAllowVoid */ 0,` |
|     72105 |  234 | `						nLineLocal);` |
|    144215 |  235 | `			pIn = pGen->pIn;` |
|    144215 |  236 | `			if( rc == SXERR_ABORT ){` |
|       ! 0 |  237 | `				return SXERR_ABORT;` |
|    144215 |  238 | `			}else if( rc == SXERR_CORRUPT ){` |
|         - |  239 | `				/* Error already reported by GenStateParseUnionTypeDecl */` |
|         3 |  240 | `				return SXERR_SYNTAX;` |
|    144213 |  241 | `			}else if( rc == SXERR_SYNTAX ){` |
|        11 |  242 | `				if( pIn < pEnd ){` |
...
|         - |  251 | `			}` |
|    144205 |  252 | `			sArg.iFlags \|= iTFlags;` |
|     72100 |  253 | `		}` |
|   2456031 |  254 | `		if( pIn >= pEnd ){` |
|       ! 0 |  255 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Missing argument name");` |
|       ! 0 |  256 | `			return rc;` |
|         - |  257 | `		}` |
|   2456031 |  258 | `		if( pIn->nType & PH7_TK_AMPER ){` |
|         - |  259 | `			/* Pass by reference,record that */` |
|     23353 |  260 | `			sArg.iFlags \|= VM_FUNC_ARG_BY_REF;` |
|     23353 |  261 | `			pIn++;` |
|     11674 |  262 | `		}` |
|   2456031 |  263 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_ELLIPSIS) ){` |
|         - |  264 | `			/* Variadic parameter: ...$args */` |
|     23409 |  265 | `			sArg.iFlags \|= VM_FUNC_ARG_VARIADIC;` |
|     23409 |  266 | `			pIn++;` |
|     11702 |  267 | `		}` |
|   2456031 |  268 | `		if( pIn >= pEnd \|\| (pIn->nType & PH7_TK_DOLLAR) == 0 \|\| &pIn[1] >= pEnd \|\| (pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|         - |  269 | `			/* Invalid argument */` |
|       ! 0 |  270 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Invalid argument name");` |
|       ! 0 |  271 | `			return rc;` |
|         - |  272 | `		}` |
|   2456031 |  273 | `		pIn++; /* Jump the dollar sign */` |
|         - |  274 | `		/* Copy argument name */` |
|   2456031 |  275 | `		zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,SyStringData(&pIn->sData),SyStringLength(&pIn->sData));` |
|   2456031 |  276 | `		if( zDup == 0 ){` |
|       ! 0 |  277 | `			PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"PH7 engine is running out of memory");` |
|       ! 0 |  278 | `			return SXERR_ABORT;` |
|         - |  279 | `		}` |
|   2456031 |  280 | `		SyStringInitFromBuf(&sArg.sName,zDup,SyStringLength(&pIn->sData));` |
|   2456031 |  281 | `		pIn++;` |
|   2456031 |  282 | `		if( pIn < pEnd ){` |
...
|   2456027 |  353 | `		if( sArg.nType > 0 ){` |
|    144143 |  354 | `			if( SyStringLength(&sArg.sClass) > 0 ){` |
...
|     15588 |  359 | `			}else{` |
|         - |  360 | `				int c;` |
|    112977 |  361 | `				c = 'n'; /* cc warning */` |
|         - |  362 | `				/* Type leading character */` |
|    112977 |  363 | `				switch(sArg.nType){` |
|      5831 |  364 | `				case MEMOBJ_HASHMAP:` |
|         - |  365 | `					/* Hashmap aka 'array' */` |
|     11667 |  366 | `					c = 'h';` |
|     11667 |  367 | `					break;` |
|     17600 |  368 | `				case MEMOBJ_INT:` |
|         - |  369 | `					/* Integer */` |
|     35205 |  370 | `					c = 'i';` |
|     35205 |  371 | `					break;` |
...
|         2 |  389 | `					break;` |
|         - |  390 | `				}` |
|    112977 |  391 | `				SyBlobAppend(&sSig,(const void *)&c,sizeof(char));` |
|         - |  392 | `			}` |
|     72074 |  393 | `		}else{` |
...
|   2456027 |  400 | `		SySetPut(&pFunc->aArgs,(const void *)&sArg);` |
|         5 |  401 | `	}` |
|   1558545 |  402 | `	if( SyBlobLength(&sSig) > 0 ){` |
|         - |  403 | `		/* Save function signature */` |
|     97469 |  404 | `		SyStringInitFromBuf(&pFunc->sSignature,SyBlobData(&sSig),SyBlobLength(&sSig));` |
|     48732 |  405 | `	}` |
|   1558545 |  406 | `	return SXRET_OK;` |
|    779284 |  407 | `}` |
|         - |  408 | `/*` |
...
|      5962 |  575 | `}` |
|   3280224 |  576 | `static int GenStateFuncBodyHasYield(ph7_gen_state *pGen)` |
|         5 |  577 | `{` |
|   3280229 |  578 | `	SyToken *pIn = pGen->pIn;   /* expected at the body's opening '{' */` |
|   3280229 |  579 | `	SyToken *pEnd = pGen->pEnd;` |
|   3280229 |  580 | `	sxi32 iDepth = 0;` |
|   3280229 |  581 | `	int bStarted = 0;` |
| 150259977 |  582 | `	while( pIn < pEnd ){` |
| 150259977 |  583 | `		sxu32 t = pIn->nType;` |
| 150259977 |  584 | `		if( t & PH7_TK_OCB ){ iDepth++; bStarted = 1; pIn++; continue; }` |
| 143492703 |  585 | `		if( t & PH7_TK_CCB ){ iDepth--; pIn++; if( bStarted && iDepth <= 0 ){ break; } continue; }` |
| 136760751 |  586 | `		if( t & PH7_TK_KEYWORD ){` |
|  10215401 |  587 | `			int kw = SX_PTR_TO_INT(pIn->pUserData);` |
|  10215401 |  588 | `			if( kw == PH7_TKWRD_YIELD ){ return TRUE; }` |
|  10203487 |  589 | `			if( kw == PH7_TKWRD_FUNCTION ){ pIn = GenStateSkipNestedFunc(pIn,pEnd); continue; }` |
|         - |  590 | ``			/* `fn` arrow bodies are single expressions and cannot contain a valid yield. */`` |
|   5084243 |  591 | `		}` |
| 136713841 |  592 | `		pIn++;` |
|         5 |  593 | `	}` |
|   3268315 |  594 | `	return FALSE;` |
|   1640117 |  595 | `}` |
|         - |  596 | `/*` |
...
|         - |  600 | ` */` |
|   3280224 |  601 | `PH7_PRIVATE sxi32 GenStateCompileFuncBody(` |
...
|   3280229 |  611 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC,PH7_VmInstrLength(pGen->pVm),pFunc,&pBlock);` |
|   3280229 |  612 | `	if( rc != SXRET_OK ){` |
...
|         - |  616 | `	}` |
|   3280229 |  617 | `	nGotoOfft = SySetUsed(&pGen->aGoto);` |
|         - |  618 | `	/* Swap bytecode containers */` |
|   3280229 |  619 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   3280229 |  620 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pFunc->aByteCode);` |
...
|         - |  625 | `	{` |
|   3280229 |  626 | `		sxu32 nArg = SySetUsed(&pFunc->aArgs);` |
|         - |  627 | `		sxu32 i;` |
|   5681729 |  628 | `		for( i = 0; i < nArg; i++ ){` |
|   2401505 |  629 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pFunc->aArgs,i);` |
|         - |  630 | `			char *zSrc;` |
|         - |  631 | `			sxu32 nSrc,nName;` |
|         - |  632 | `			SySet sToken;` |
|         - |  633 | `			SyToken *pTmpIn,*pTmpEnd;` |
|         - |  634 | `			sxi32 rcPromote;` |
|   2401505 |  635 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|   2401429 |  636 | `				continue;` |
|         - |  637 | `			}` |
...
|         - |  687 | `	{` |
|   3280229 |  688 | `		sxi8 bSavedGen = pGen->bInGenerator;` |
|   3280229 |  689 | `		pGen->bInGenerator = (sxi8)GenStateFuncBodyHasYield(&(*pGen));` |
|         - |  690 | `		/* Compile the body */` |
|   3280229 |  691 | `		PH7_CompileBlock(&(*pGen),0);` |
|   3280229 |  692 | `		pGen->bInGenerator = bSavedGen;` |
|         - |  693 | `	}` |
|         - |  694 | `	/* Fix exception jumps now the destination is resolved */` |
|   3280229 |  695 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|         - |  696 | `	/* Emit the final return if not yet done */` |
|   3280229 |  697 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|         - |  698 | `	/* Fix gotos jumps now the destination is resolved */` |
|   3280229 |  699 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),nGotoOfft) ){` |
|       ! 0 |  700 | `		rc = SXERR_ABORT;` |
|       ! 0 |  701 | `	}` |
|   3280229 |  702 | `	SySetTruncate(&pGen->aGoto,nGotoOfft);` |
|         - |  703 | `	/* Restore the default container */` |
|   3280229 |  704 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|         - |  705 | `	/* Leave function block */` |
|   3280229 |  706 | `	GenStateLeaveBlock(&(*pGen),0);` |
|   3280229 |  707 | `	if( rc == SXERR_ABORT ){` |
...
|         - |  712 | `	{` |
|   3280229 |  713 | `		VmInstr *aInstr = (VmInstr *)SySetBasePtr(&pFunc->aByteCode);` |
|         - |  714 | `		sxu32 i;` |
|  92035463 |  715 | `		for( i = 0; i < SySetUsed(&pFunc->aByteCode); i++ ){` |
|  88767153 |  716 | `			if( aInstr[i].iOp == PH7_OP_YIELD \|\| aInstr[i].iOp == PH7_OP_YIELD_FROM ){` |
|     11919 |  717 | `				pFunc->iFlags \|= VM_FUNC_GENERATOR;` |
|     11919 |  718 | `				break;` |
|         - |  719 | `			}` |
|  44377622 |  720 | `		}` |
|         - |  721 | `	}` |
|   3280229 |  722 | `	if( pFunc->iFlags & VM_FUNC_GENERATOR ){` |
...
|     42937 |  815 | `	return 0;` |
|     21530 |  816 | `}` |
|    192186 |  817 | `static sxi32 GenStateParseOneTypeAtom(ph7_gen_state *pGen, PhlTypeAtom *pOut)` |
|         5 |  818 | `{` |
|    192191 |  819 | `	SyToken *pIn = pGen->pIn;` |
|    192191 |  820 | `	int bAbsolute = 0;` |
|    192191 |  821 | `	SyZero(pOut, sizeof(*pOut));` |
|    192191 |  822 | `	SyStringInitFromBuf(&pOut->sClass, 0, 0);` |
|    192191 |  823 | `	if( pIn >= pGen->pEnd ){` |
|       ! 0 |  824 | `		return SXERR_SYNTAX;` |
|         - |  825 | `	}` |
|         - |  826 | `	/* Optional leading namespace separator '\' on FQN class types */` |
|    192191 |  827 | `	if( pIn->nType & PH7_TK_NSSEP ){` |
...
|         - |  832 | `		}` |
|         4 |  833 | `	}` |
|    192191 |  834 | `	if( (pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|       ! 0 |  835 | `		return SXERR_SYNTAX;` |
|         - |  836 | `	}` |
|    192191 |  837 | `	if( pIn->nType & PH7_TK_KEYWORD ){` |
|    148905 |  838 | `		sxu32 nKey = (sxu32)(SX_PTR_TO_INT(pIn->pUserData));` |
|    148905 |  839 | `		if( nKey & PH7_TKWRD_ARRAY ){` |
|     15617 |  840 | `			pOut->nType = MEMOBJ_HASHMAP; pOut->zCanon = "array"; pOut->nCanon = 5;` |
|    141099 |  841 | `		}else if( nKey & PH7_TKWRD_BOOL ){` |
|      7851 |  842 | `			pOut->nType = MEMOBJ_BOOL; pOut->zCanon = "bool"; pOut->nCanon = 4;` |
|    129370 |  843 | `		}else if( nKey & PH7_TKWRD_INT ){` |
|     47285 |  844 | `			pOut->nType = MEMOBJ_INT; pOut->zCanon = "int"; pOut->nCanon = 3;` |
|    101807 |  845 | `		}else if( nKey & PH7_TKWRD_STRING ){` |
...
|         - |  912 | `		}` |
|         - |  913 | `	}` |
|    192189 |  914 | `	pGen->pIn = pIn;` |
|    192189 |  915 | `	return SXRET_OK;` |
|     96098 |  916 | `}` |
|         - |  917 |  |
|         - |  918 | `/*` |
...
|         - |  924 | ` */` |
|    192010 |  925 | `static void GenBuildUnionTypeText(SyBlob *pBlob, PhlTypeAtom *aAtoms, int nAtoms, int bNullable)` |
|         5 |  926 | `{` |
|         - |  927 | `	int i;` |
|    192015 |  928 | `	int nNonNull = 0;` |
|    192015 |  929 | `	int bAnyIntersection = 0;` |
|         - |  930 | `	sxu32 aGroupCount[PHL_UNION_MAX_ALTS];` |
|    192015 |  931 | `	sxu32 nMaxGroup = 0;` |
|   6336335 |  932 | `	for( i = 0; i < PHL_UNION_MAX_ALTS; i++ ) aGroupCount[i] = 0;` |
|    384175 |  933 | `	for( i = 0; i < nAtoms; i++ ){` |
|    192165 |  934 | `		if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|    192135 |  935 | `			nNonNull++;` |
|    192135 |  936 | `			if( aAtoms[i].nGroup < PHL_UNION_MAX_ALTS ){` |
|    192135 |  937 | `				aGroupCount[aAtoms[i].nGroup]++;` |
|    192135 |  938 | `				if( aAtoms[i].nGroup > nMaxGroup ) nMaxGroup = aAtoms[i].nGroup;` |
|     96065 |  939 | `			}` |
|     96065 |  940 | `		}` |
|     96085 |  941 | `	}` |
|    384123 |  942 | `	for( i = 0; i < nAtoms; i++ ){` |
|    192137 |  943 | `		if( aAtoms[i].nType != UTA_NULL_FLAG && aGroupCount[aAtoms[i].nGroup] >= 2 ){` |
|        29 |  944 | `			bAnyIntersection = 1;` |
|        29 |  945 | `			break;` |
|         - |  946 | `		}` |
|     96059 |  947 | `	}` |
|    192015 |  948 | `	if( bAnyIntersection ){` |
...
|      9792 |  983 | `		return;` |
|         - |  984 | `	}` |
|    191991 |  985 | `	if( nNonNull == 1 && bNullable ){` |
|         - |  986 | `		/* Shorthand: ?T */` |
...
|       ! 0 |  997 | `	}` |
|         - |  998 | `	{` |
|    172465 |  999 | `		int bFirst = 1;` |
|         - | 1000 | `		/* 1) Classes in declaration order */` |
|    345031 | 1001 | `		for( i = 0; i < nAtoms; i++ ){` |
|    172571 | 1002 | `			if( aAtoms[i].nType == SXU32_HIGH ){` |
...
|         - | 1012 | `			int k;` |
|   1207225 | 1013 | `			for( k = 0; k < (int)(sizeof(aOrder)/sizeof(aOrder[0])); k++ ){` |
|   1929057 | 1014 | `				for( i = 0; i < nAtoms; i++ ){` |
|   1035289 | 1015 | `					if( aAtoms[i].nType == aOrder[k] ){` |
|    140997 | 1016 | `						if( !bFirst ) SyBlobAppend(pBlob, "\|", 1);` |
|    140997 | 1017 | `						SyBlobAppend(pBlob, aAtoms[i].zCanon, aAtoms[i].nCanon);` |
|    140997 | 1018 | `						bFirst = 0;` |
|    140997 | 1019 | `						break;` |
|         - | 1020 | `					}` |
|    447151 | 1021 | `				}` |
|    517385 | 1022 | `			}` |
...
|         - | 1045 | ` */` |
|    192160 | 1046 | `static sxi32 GenStateParsePart(` |
|         - | 1047 | `	ph7_gen_state *pGen, PhlTypeAtom *aAtoms, int *pnAtoms, sxu32 iGroup,` |
|         - | 1048 | `	int *pnMembers, int *pbParen, sxu32 nLine)` |
|         5 | 1049 | `{` |
|         - | 1050 | `	sxi32 rc;` |
|    192165 | 1051 | `	int nMembers = 0;` |
|    192165 | 1052 | `	int bParen = 0;` |
|    192165 | 1053 | `	*pnMembers = 0;` |
|    192165 | 1054 | `	*pbParen = 0;` |
|    192165 | 1055 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_LPAREN) ){` |
|         9 | 1056 | `		bParen = 1;` |
|         9 | 1057 | `		pGen->pIn++; /* skip '(' */` |
|         3 | 1058 | `	}` |
|     96080 | 1059 | `	for(;;){` |
|    192191 | 1060 | `		if( *pnAtoms >= PHL_UNION_MAX_ALTS ){` |
...
|         - | 1064 | `		}` |
|    192191 | 1065 | `		rc = GenStateParseOneTypeAtom(pGen, &aAtoms[*pnAtoms]);` |
|    192191 | 1066 | `		if( rc != SXRET_OK ){` |
|         3 | 1067 | `			return rc;` |
|         - | 1068 | `		}` |
|    192189 | 1069 | `		aAtoms[*pnAtoms].nGroup = iGroup;` |
|    192189 | 1070 | `		(*pnAtoms)++;` |
|    192189 | 1071 | `		nMembers++;` |
|         - | 1072 | ``		/* Continue the intersection while `&` is followed by another type atom. */`` |
|    192189 | 1073 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
...
|         - | 1094 | `		}` |
|         3 | 1095 | `	}` |
|    192163 | 1096 | `	*pnMembers = nMembers;` |
|    192163 | 1097 | `	*pbParen = bParen;` |
|    192163 | 1098 | `	return SXRET_OK;` |
|     96085 | 1099 | `}` |
|         - | 1100 |  |
|         - | 1101 | `/*` |
...
|         - | 1118 | ` */` |
|    192026 | 1119 | `PH7_PRIVATE sxi32 GenStateParseUnionTypeDecl(` |
...
|    192031 | 1132 | `	int nAtoms = 0;` |
|    192031 | 1133 | `	int bShortNullable = 0;` |
|    192031 | 1134 | `	int bExplicitNull = 0;` |
|         - | 1135 | `	sxi32 rc;` |
|    192031 | 1136 | `	*pnType = 0;` |
|    192031 | 1137 | `	if( pClass ) SyStringInitFromBuf(pClass, 0, 0);` |
|    192031 | 1138 | `	*piTypeFlags = 0;` |
|    192031 | 1139 | `	if( pTypeText ) SyStringInitFromBuf(pTypeText, 0, 0);` |
|         - | 1140 |  |
|    192031 | 1141 | `	if( pGen->pIn >= pGen->pEnd ){` |
|       ! 0 | 1142 | `		return SXRET_OK;` |
|         - | 1143 | `	}` |
|         - | 1144 | ``	/* Optional `?` shorthand prefix */`` |
|    192026 | 1145 | `	if( (pGen->pIn->nType & PH7_TK_OP) && pGen->pIn->sData.nByte == 1` |
...
|    192031 | 1158 | `		sxu32 iGroup = 0;` |
|    192031 | 1159 | `		rc = GenStateParsePart(pGen, aAtoms, &nAtoms, iGroup, &nMembers, &bParen, nLine);` |
|    192031 | 1160 | `		if( rc != SXRET_OK ){` |
|         4 | 1161 | `			return rc;` |
|         - | 1162 | `		}` |
...
|    288242 | 1168 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OP)` |
|    192235 | 1169 | `			&& pGen->pIn->sData.nByte == 1 && pGen->pIn->sData.zString[0] == '\|' ){` |
...
|         - | 1187 | `			}` |
|         5 | 1188 | `		}` |
|    192027 | 1189 | `		if( iGroup > 0 && nMembers >= 2 && !bParen ){` |
...
|         - | 1201 | `	{` |
|         - | 1202 | `		int i, j;` |
|    192027 | 1203 | `		int bHasNonNull = 0;` |
|    192027 | 1204 | `		int bAnyIntersection = 0;` |
...
|   6336731 | 1208 | `		for( i = 0; i < PHL_UNION_MAX_ALTS; i++ ) aGroupCount[i] = 0;` |
|    384209 | 1209 | `		for( i = 0; i < nAtoms; i++ ){` |
|    192187 | 1210 | `			if( aAtoms[i].nGroup < PHL_UNION_MAX_ALTS ) aGroupCount[aAtoms[i].nGroup]++;` |
|     96096 | 1211 | `		}` |
|    384153 | 1212 | `		for( i = 0; i < nAtoms; i++ ){` |
|    192157 | 1213 | `			if( aGroupCount[aAtoms[i].nGroup] >= 2 ){ bAnyIntersection = 1; break; }` |
|     96068 | 1214 | `		}` |
...
|    192027 | 1217 | `		if( bShortNullable && bAnyIntersection ){` |
...
|         - | 1221 | `		}` |
|    384195 | 1222 | `		for( i = 0; i < nAtoms; i++ ){` |
...
|    192185 | 1226 | `			if( aGroupCount[aAtoms[i].nGroup] >= 2 ){` |
...
|         - | 1248 | `				}` |
|        24 | 1249 | `			}` |
|    192183 | 1250 | `			if( aAtoms[i].nType == UTA_VOID_FLAG ){` |
...
|         - | 1265 | `				}` |
|        87 | 1266 | `			}` |
|    192181 | 1267 | `			if( aAtoms[i].nType == UTA_NEVER_FLAG ){` |
...
|         - | 1284 | `				}` |
|         8 | 1285 | `			}` |
|    192175 | 1286 | `			if( aAtoms[i].nType == UTA_NULL_FLAG ){` |
|        34 | 1287 | `				bExplicitNull = 1;` |
|        19 | 1288 | `			}else{` |
|    192145 | 1289 | `				bHasNonNull = 1;` |
|         - | 1290 | `			}` |
...
|        98 | 1328 | `			}` |
|     96089 | 1329 | `		}` |
|    192015 | 1330 | `		if( !bHasNonNull && bExplicitNull ){` |
...
|    192015 | 1345 | `	if( bShortNullable \|\| bExplicitNull ){` |
|     19547 | 1346 | `		*piTypeFlags \|= iNullableFlag;` |
|      9771 | 1347 | `	}` |
|         - | 1348 | `	/* Build canonical type text */` |
|    192015 | 1349 | `	if( pTypeText ){` |
|         - | 1350 | `		SyBlob sBlob;` |
|    192015 | 1351 | `		SyBlobInit(&sBlob, &pGen->pVm->sAllocator);` |
|    278264 | 1352 | `		GenBuildUnionTypeText(&sBlob, aAtoms, nAtoms,` |
|     96005 | 1353 | `			(bShortNullable \|\| bExplicitNull) ? 1 : 0);` |
|    192015 | 1354 | `		if( SyBlobLength(&sBlob) > 0 ){` |
|    287735 | 1355 | `			char *zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|    191820 | 1356 | `				(const char *)SyBlobData(&sBlob), SyBlobLength(&sBlob));` |
|    191825 | 1357 | `			if( zDup ){` |
|    191825 | 1358 | `				SyStringInitFromBuf(pTypeText, zDup, SyBlobLength(&sBlob));` |
|     95910 | 1359 | `			}` |
|     95910 | 1360 | `		}` |
|    192015 | 1361 | `		SyBlobRelease(&sBlob);` |
|     96005 | 1362 | `	}` |
...
|         - | 1366 | `	{` |
|    192015 | 1367 | `		int nNonNull = 0;` |
|    192015 | 1368 | `		int iNonNullIdx = -1;` |
|         - | 1369 | `		int i;` |
|    384175 | 1370 | `		for( i = 0; i < nAtoms; i++ ){` |
|    192165 | 1371 | `			if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|    192135 | 1372 | `				nNonNull++;` |
|    192135 | 1373 | `				iNonNullIdx = i;` |
|     96065 | 1374 | `			}` |
|     96085 | 1375 | `		}` |
|    192015 | 1376 | `		if( nNonNull <= 1 ){` |
|         - | 1377 | `			/* Fast path: store as single type. */` |
|    191911 | 1378 | `			if( iNonNullIdx >= 0 ){` |
|    191905 | 1379 | `				PhlTypeAtom *pA = &aAtoms[iNonNullIdx];` |
|    191905 | 1380 | `				if( pA->nType == SXU32_HIGH ){` |
...
|    170405 | 1386 | `				}else if( pA->nType == UTA_VOID_FLAG ){` |
|       179 | 1387 | `					*pnType = MEMOBJ_VOID;` |
|    148818 | 1388 | `				}else if( pA->nType == UTA_NEVER_FLAG ){` |
|        18 | 1389 | `					*pnType = MEMOBJ_NEVER;` |
|        10 | 1390 | `				}else{` |
|    148715 | 1391 | `					*pnType = pA->nType;` |
|         - | 1392 | `				}` |
|     95950 | 1393 | `			}` |
|     95958 | 1394 | `		}else{` |
...
|         - | 1426 | ` */` |
|   3420546 | 1427 | `PH7_PRIVATE sxi32 GenStateParseReturnType(ph7_gen_state *pGen, ph7_vm_func *pFunc)` |
|         5 | 1428 | `{` |
|   3420551 | 1429 | `	sxi32 iFlags = 0;` |
|         - | 1430 | `	sxi32 rc;` |
|         - | 1431 | `	sxu32 nLine;` |
|   3420551 | 1432 | `	pFunc->nReturnType = 0;` |
|   3420551 | 1433 | `	SyStringInitFromBuf(&pFunc->sReturnClass, 0, 0);` |
|   3420551 | 1434 | `	SyStringInitFromBuf(&pFunc->sReturnTypeName, 0, 0);` |
...
|   3420551 | 1440 | `	SySetReset(&pFunc->aReturnUnion);` |
|   3420551 | 1441 | `	pFunc->iFlags &= ~VM_FUNC_RETURN_NULLABLE;` |
|   3420551 | 1442 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COLON) == 0 ){` |
|   3388667 | 1443 | `		return SXRET_OK;` |
|         - | 1444 | `	}` |
...
|   1710278 | 1482 | `}` |
|         - | 1483 |  |
|    522160 | 1484 | `PH7_PRIVATE sxi32 GenStateCompileFunc(` |
...
|    522165 | 1498 | `	nLine = pGen->pIn->nLine;` |
|         - | 1499 | `	/* Jump the left parenthesis '(' */` |
|    522165 | 1500 | `	pGen->pIn++;` |
|         - | 1501 | `	/* Delimit the function signature */` |
|    522165 | 1502 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|    522165 | 1503 | `	if( pEnd >= pGen->pEnd ){` |
|         - | 1504 | `		/* Syntax error */` |
...
|    522159 | 1515 | `	pFunc = (ph7_vm_func *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_vm_func));` |
|    522159 | 1516 | `	if( pFunc == 0 ){` |
|       ! 0 | 1517 | `		goto OutOfMem;` |
|         - | 1518 | `	}` |
|         - | 1519 | `	/* Build the function name, prepending namespace if active */` |
|    522167 | 1520 | `	if( SyBlobLength(&pGen->sNamespace) > 0 && !bHandleClosure ){` |
|         - | 1521 | `		SyBlob sFQN;` |
|         - | 1522 | `		sxu32 nLen;` |
...
|        10 | 1534 | `	}else{` |
|    522143 | 1535 | `		zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|    522143 | 1536 | `		if( zName == 0 ){` |
|       ! 0 | 1537 | `			goto OutOfMem;` |
|         - | 1538 | `		}` |
|    522143 | 1539 | `		PH7_VmInitFuncState(pGen->pVm,pFunc,zName,pName->nByte,iFlags,0);` |
|         - | 1540 | `	}` |
...
|    522159 | 1543 | `	pFunc->nLine = nLine;` |
|    522159 | 1544 | `	GenStateConsumeDoc(&(*pGen),&pFunc->sDoc);` |
|    522159 | 1545 | `	if( GenStateConsumeAttrs(&(*pGen),&pFunc->aAttrs) == SXERR_ABORT ){` |
|       ! 0 | 1546 | `		return SXERR_ABORT;` |
|         - | 1547 | `	}` |
|    522159 | 1548 | `	if( pGen->pIn < pEnd ){` |
|         - | 1549 | `		/* Collect function arguments */` |
|    443525 | 1550 | `		rc = GenStateCollectFuncArgs(pFunc,&(*pGen),pEnd,0,0);` |
|    443525 | 1551 | `		if( rc == SXERR_ABORT ){` |
...
|    522157 | 1557 | `	pGen->pIn = &pEnd[1];` |
|         - | 1558 | `	{` |
|    522157 | 1559 | `		sxi32 rcRt = GenStateParseReturnType(pGen, pFunc);` |
|    522157 | 1560 | `		if( rcRt == SXERR_ABORT ){` |
|       ! 0 | 1561 | `			return SXERR_ABORT;` |
|    522157 | 1562 | `		}else if( rcRt == SXERR_SYNTAX ){` |
|         8 | 1563 | `			return SXERR_SYNTAX;` |
|         - | 1564 | `		}` |
|         - | 1565 | `	}` |
|    522151 | 1566 | `	if( bHandleClosure ){` |
...
|    522151 | 1676 | `	rc = GenStateCompileFuncBody(&(*pGen),pFunc);` |
|    522151 | 1677 | `	if( rc == SXERR_ABORT ){` |
|       ! 0 | 1678 | `		return SXERR_ABORT;` |
|         - | 1679 | `	}` |
|         - | 1680 | `	/* The cursor sits just past the body's closing brace */` |
|    522151 | 1681 | `	pFunc->nEndLine = pGen->pIn[-1].nLine;` |
|    522151 | 1682 | `	if( ppFunc ){` |
|    522151 | 1683 | `		*ppFunc = pFunc;` |
|    261073 | 1684 | `	}` |
|    522151 | 1685 | `	rc = SXRET_OK;` |
|    522151 | 1686 | `	if( (pFunc->iFlags & VM_FUNC_CLOSURE) == 0 ){` |
|         - | 1687 | `		/* Reject a php-fatal redeclaration before hoisting the function */` |
|    521593 | 1688 | `		if( GenStateGuardFuncRedeclaration(pGen,pFunc) == SXERR_ABORT ){` |
|         6 | 1689 | `			return SXERR_ABORT;` |
|         - | 1690 | `		}` |
|         - | 1691 | `		/* Finally register the function */` |
|    521589 | 1692 | `		rc = PH7_VmInstallUserFunction(pGen->pVm,pFunc,0);` |
|    260792 | 1693 | `	}` |
|    522147 | 1694 | `	if( rc == SXRET_OK ){` |
|    522147 | 1695 | `		return SXRET_OK;` |
|         - | 1696 | `	}` |
...
|         - | 1708 | ` */` |
|    521590 | 1709 | `PH7_PRIVATE sxi32 PH7_CompileFunction(ph7_gen_state *pGen)` |
|         5 | 1710 | `{` |
|         - | 1711 | `	SyString *pName;` |
|         - | 1712 | `	sxi32 iFlags;` |
|         - | 1713 | `	sxu32 nKwLine;` |
...
|         - | 1715 | `	sxi32 rc;` |
|         - | 1716 |  |
|    521595 | 1717 | `	nLine = pGen->pIn->nLine;` |
|    521595 | 1718 | `	nKwLine = nLine; /* Line of the 'function' keyword (Reflection getStartLine) */` |
|    521595 | 1719 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|    521595 | 1720 | `	iFlags = 0;` |
|    521595 | 1721 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|         - | 1722 | `		/* Return by reference,remember that */` |
|        12 | 1723 | `		iFlags \|= VM_FUNC_REF_RETURN;` |
|         - | 1724 | `		/* Jump the '&' token */` |
|        12 | 1725 | `		pGen->pIn++;` |
|         5 | 1726 | `	}` |
|    521595 | 1727 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|         - | 1738 | `	}` |
|    521589 | 1739 | `	pName = &pGen->pIn->sData;` |
|    521589 | 1740 | `	nLine = pGen->pIn->nLine;` |
|         - | 1741 | `	/* Jump the function name */` |
|    521589 | 1742 | `	pGen->pIn++;` |
|    521589 | 1743 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|         - | 1744 | `		/* Syntax error */` |
...
|         - | 1757 | `	{` |
|    521587 | 1758 | `		ph7_vm_func *pFuncState = 0;` |
|    521587 | 1759 | `		rc = GenStateCompileFunc(&(*pGen),pName,iFlags,FALSE,&pFuncState);` |
|    521587 | 1760 | `		if( pFuncState ){` |
|         - | 1761 | `			/* Reflection getStartLine(): line of the 'function' keyword */` |
|    521573 | 1762 | `			pFuncState->nLine = nKwLine;` |
|    260784 | 1763 | `		}` |
|         - | 1764 | `	}` |
|    521587 | 1765 | `	return rc;` |
|    260800 | 1766 | `}` |
|         - | 1767 |  |
