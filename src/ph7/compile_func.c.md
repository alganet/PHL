...
|         - |   67 | ` */` |
|    707788 |   68 | `static sxi32 GenStateProcessArgValue(ph7_gen_state *pGen,ph7_vm_func_arg *pArg,SyToken *pIn,SyToken *pEnd)` |
|         5 |   69 | `{` |
|         - |   70 | `	SyToken *pTmpIn,*pTmpEnd;` |
|         - |   71 | `	SySet *pInstrContainer;` |
|         - |   72 | `	sxi32 rc;` |
|         - |   73 | `	/* Swap token stream */` |
|    707793 |   74 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|    707793 |   75 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|    707793 |   76 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pArg->aByteCode);` |
|         - |   77 | `	/* Compile the expression holding the argument value */` |
|    707793 |   78 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|         - |   79 | `	/* Emit the done instruction */` |
|    707793 |   80 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,(rc != SXERR_EMPTY ? 1 : 0),0,0,0);` |
|    707793 |   81 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|    707793 |   82 | `	RE_SWAP_DELIMITER(pGen);` |
|    707793 |   83 | `	if( rc == SXERR_ABORT ){` |
|       ! 0 |   84 | `		return SXERR_ABORT;` |
|         - |   85 | `	}` |
|    707793 |   86 | `	return SXRET_OK;` |
|    353899 |   87 | `}` |
|         - |   88 | `/*` |
...
|         - |  124 | ` */` |
|   1560984 |  125 | `PH7_PRIVATE sxi32 GenStateCollectFuncArgs(ph7_vm_func *pFunc,ph7_gen_state *pGen,SyToken *pEnd,int bCtorCtx,int bAbstractCtx)` |
|         5 |  126 | `{` |
...
|         - |  131 | `	sxi32 rc;` |
|         - |  132 |  |
|   1560989 |  133 | `	pIn = pGen->pIn;` |
|   1560989 |  134 | `	SyBlobInit(&sSig,&pGen->pVm->sAllocator);` |
|         - |  135 | `	/* Process arguments one after one */` |
|   2010418 |  136 | `	for(;;){` |
|   4020841 |  137 | `		if( pIn >= pEnd ){` |
|         - |  138 | `			/* No more arguments to process */` |
|   1560971 |  139 | `			break;` |
|         - |  140 | `		}` |
|   2459875 |  141 | `		SyZero(&sArg,sizeof(ph7_vm_func_arg));` |
|   2459875 |  142 | `		SySetInit(&sArg.aByteCode,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|   2459875 |  143 | `		SySetInit(&sArg.aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|   2459875 |  144 | `		SySetInit(&sArg.aAttrs,&pGen->pVm->sAllocator,sizeof(ph7_attribute));` |
|   2459875 |  145 | `		SyStringInitFromBuf(&sArg.sTypeName,0,0);` |
|         - |  146 | `		/* Parameter #[...] attributes: the group precedes the parameter's` |
|         - |  147 | `		 * first token inside the main token stream */` |
|   2459875 |  148 | `		if( GenStateCollectParamAttrs(&(*pGen),pIn,&sArg.aAttrs) == SXERR_ABORT ){` |
...
|         - |  156 | `		{` |
|   2459875 |  157 | `			int bReadonly = 0, bVisSeen = 0;` |
|   2459875 |  158 | `			sxi32 iVis = PH7_CLASS_PROT_PUBLIC;` |
|   2459875 |  159 | `			sxi32 iSetVisFlag = 0;` |
|         - |  160 | `			int nSetTok;` |
|         - |  161 | `			sxi32 nSetVis;` |
|   2459875 |  162 | `			if( pIn < pEnd && GenStateIsReadonly(pIn) ){` |
|         3 |  163 | `				bReadonly = 1;` |
|         3 |  164 | `				pIn++;` |
|         1 |  165 | `			}` |
|   2459875 |  166 | `			nSetVis = GenStatePeekSetVisibility(pIn,pEnd,&nSetTok);` |
|   2459875 |  167 | `			if( nSetVis ){` |
...
|       ! 0 |  174 | `					pIn++;` |
|         1 |  175 | `				}` |
|   2459874 |  176 | `			}else if( pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD) ){` |
...
|        43 |  194 | `				}` |
|     54651 |  195 | `			}` |
|   2459875 |  196 | `			if( iSetVisFlag == PH7_CLASS_ATTR_PRIVATE_SET ){` |
|         5 |  197 | `				sArg.iFlags \|= VM_FUNC_ARG_PRIV_SET;` |
|   2459873 |  198 | `			}else if( iSetVisFlag == PH7_CLASS_ATTR_PROTECTED_SET ){` |
|       ! 0 |  199 | `				sArg.iFlags \|= VM_FUNC_ARG_PROT_SET;` |
|       ! 0 |  200 | `			}` |
|   2459875 |  201 | `			if( bVisSeen \|\| bReadonly ){` |
|        95 |  202 | `				if( !bCtorCtx ){` |
...
|   2459866 |  223 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_DOLLAR) == 0` |
|   1325549 |  224 | `			&& (pIn->nType & PH7_TK_AMPER) == 0` |
...
|     72215 |  253 | `		}` |
|   2459861 |  254 | `		if( pIn >= pEnd ){` |
|       ! 0 |  255 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Missing argument name");` |
|       ! 0 |  256 | `			return rc;` |
|         - |  257 | `		}` |
|   2459861 |  258 | `		if( pIn->nType & PH7_TK_AMPER ){` |
|         - |  259 | `			/* Pass by reference,record that */` |
|     23389 |  260 | `			sArg.iFlags \|= VM_FUNC_ARG_BY_REF;` |
|     23389 |  261 | `			pIn++;` |
|     11692 |  262 | `		}` |
|   2459861 |  263 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_ELLIPSIS) ){` |
|         - |  264 | `			/* Variadic parameter: ...$args */` |
|     23445 |  265 | `			sArg.iFlags \|= VM_FUNC_ARG_VARIADIC;` |
|     23445 |  266 | `			pIn++;` |
|     11720 |  267 | `		}` |
|   2459861 |  268 | `		if( pIn >= pEnd \|\| (pIn->nType & PH7_TK_DOLLAR) == 0 \|\| &pIn[1] >= pEnd \|\| (pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|         - |  269 | `			/* Invalid argument */` |
|       ! 0 |  270 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Invalid argument name");` |
|       ! 0 |  271 | `			return rc;` |
|         - |  272 | `		}` |
|   2459861 |  273 | `		pIn++; /* Jump the dollar sign */` |
|         - |  274 | `		/* Copy argument name */` |
|   2459861 |  275 | `		zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,SyStringData(&pIn->sData),SyStringLength(&pIn->sData));` |
|   2459861 |  276 | `		if( zDup == 0 ){` |
|       ! 0 |  277 | `			PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"PH7 engine is running out of memory");` |
|       ! 0 |  278 | `			return SXERR_ABORT;` |
|         - |  279 | `		}` |
|   2459861 |  280 | `		SyStringInitFromBuf(&sArg.sName,zDup,SyStringLength(&pIn->sData));` |
|   2459861 |  281 | `		pIn++;` |
|   2459861 |  282 | `		if( pIn < pEnd ){` |
|   1361681 |  283 | `			if( pIn->nType & PH7_TK_EQUAL ){` |
|         - |  284 | `				SyToken *pDefend;` |
|    707795 |  285 | `				sxi32 iNest = 0;` |
|    707795 |  286 | `				pIn++; /* Jump the equal sign */` |
|    707795 |  287 | `				pDefend = pIn;` |
|         - |  288 | `				/* Process the default value associated with this argument */` |
|   1481715 |  289 | `				while( pDefend < pEnd ){` |
|   1018931 |  290 | `					if( (pDefend->nType & PH7_TK_COMMA) && iNest <= 0 ){` |
|    245011 |  291 | `						break;` |
|         - |  292 | `					}` |
|    773925 |  293 | `					if( pDefend->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*[*/) ){` |
|         - |  294 | `						/* Increment nesting level */` |
|     27233 |  295 | `						iNest++;` |
|    760311 |  296 | `					}else if( pDefend->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CCB/*'}'*/\|PH7_TK_CSB/*]*/) ){` |
|         - |  297 | `						/* Decrement nesting level */` |
|     27233 |  298 | `						iNest--;` |
|     13614 |  299 | `					}` |
|    773925 |  300 | `					pDefend++;` |
|         5 |  301 | `				}` |
|    707795 |  302 | `				if( pIn >= pDefend ){` |
|         3 |  303 | `					rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Missing argument default value");` |
|         3 |  304 | `					return rc;` |
|         - |  305 | `				}` |
|         - |  306 | `				/* Process default value */` |
|    707793 |  307 | `				rc = GenStateProcessArgValue(&(*pGen),&sArg,pIn,pDefend);` |
|    707793 |  308 | `				if( rc != SXRET_OK ){` |
|       ! 0 |  309 | `					return rc;` |
|         - |  310 | `				}` |
...
|    707788 |  316 | `				if( (sArg.nType > 0 \|\| (sArg.iFlags & VM_FUNC_ARG_UNION))` |
|    385021 |  317 | `					&& (sArg.iFlags & VM_FUNC_ARG_NULLABLE) == 0` |
|    377242 |  318 | `					&& &pIn[1] == pDefend` |
...
|    707791 |  344 | `				pIn = pDefend;` |
|    353893 |  345 | `			}` |
|   1361677 |  346 | `			if( pIn < pEnd && (pIn->nType & PH7_TK_COMMA) == 0 ){` |
|       ! 0 |  347 | `				rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Unexpected token '%z'",&pIn->sData);` |
|       ! 0 |  348 | `				return rc;` |
|         - |  349 | `			}` |
|   1361677 |  350 | `			pIn++; /* Jump the trailing comma */` |
|    680836 |  351 | `		}` |
|         - |  352 | `		/* Append argument signature */` |
|   2459857 |  353 | `		if( sArg.nType > 0 ){` |
...
|         - |  396 | `			 */` |
|   2315489 |  397 | `			SyBlobRelease(&sSig);` |
|         - |  398 | `		}` |
|         - |  399 | `		/* Save in the argument set */` |
|   2459857 |  400 | `		SySetPut(&pFunc->aArgs,(const void *)&sArg);` |
|         5 |  401 | `	}` |
|   1560971 |  402 | `	if( SyBlobLength(&sSig) > 0 ){` |
|         - |  403 | `		/* Save function signature */` |
|     97627 |  404 | `		SyStringInitFromBuf(&pFunc->sSignature,SyBlobData(&sSig),SyBlobLength(&sSig));` |
|     48811 |  405 | `	}` |
|   1560971 |  406 | `	return SXRET_OK;` |
|    780497 |  407 | `}` |
|         - |  408 | `/*` |
...
|      5971 |  575 | `}` |
|   3285334 |  576 | `static int GenStateFuncBodyHasYield(ph7_gen_state *pGen)` |
|         5 |  577 | `{` |
|   3285339 |  578 | `	SyToken *pIn = pGen->pIn;   /* expected at the body's opening '{' */` |
|   3285339 |  579 | `	SyToken *pEnd = pGen->pEnd;` |
|   3285339 |  580 | `	sxi32 iDepth = 0;` |
|   3285339 |  581 | `	int bStarted = 0;` |
| 150493327 |  582 | `	while( pIn < pEnd ){` |
| 150493327 |  583 | `		sxu32 t = pIn->nType;` |
| 150493327 |  584 | `		if( t & PH7_TK_OCB ){ iDepth++; bStarted = 1; pIn++; continue; }` |
| 143715527 |  585 | `		if( t & PH7_TK_CCB ){ iDepth--; pIn++; if( bStarted && iDepth <= 0 ){ break; } continue; }` |
| 136973103 |  586 | `		if( t & PH7_TK_KEYWORD ){` |
|  10231275 |  587 | `			int kw = SX_PTR_TO_INT(pIn->pUserData);` |
|  10231275 |  588 | `			if( kw == PH7_TKWRD_YIELD ){ return TRUE; }` |
|  10219343 |  589 | `			if( kw == PH7_TKWRD_FUNCTION ){ pIn = GenStateSkipNestedFunc(pIn,pEnd); continue; }` |
|         - |  590 | ``			/* `fn` arrow bodies are single expressions and cannot contain a valid yield. */`` |
|   5092144 |  591 | `		}` |
| 136926121 |  592 | `		pIn++;` |
|         5 |  593 | `	}` |
|   3273407 |  594 | `	return FALSE;` |
|   1642672 |  595 | `}` |
|         - |  596 | `/*` |
...
|         - |  600 | ` */` |
|   3285334 |  601 | `PH7_PRIVATE sxi32 GenStateCompileFuncBody(` |
...
|   3285339 |  611 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC,PH7_VmInstrLength(pGen->pVm),pFunc,&pBlock);` |
|   3285339 |  612 | `	if( rc != SXRET_OK ){` |
...
|         - |  616 | `	}` |
|   3285339 |  617 | `	nGotoOfft = SySetUsed(&pGen->aGoto);` |
|         - |  618 | `	/* Swap bytecode containers */` |
|   3285339 |  619 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   3285339 |  620 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pFunc->aByteCode);` |
...
|         - |  625 | `	{` |
|   3285339 |  626 | `		sxu32 nArg = SySetUsed(&pFunc->aArgs);` |
|         - |  627 | `		sxu32 i;` |
|   5690583 |  628 | `		for( i = 0; i < nArg; i++ ){` |
|   2405249 |  629 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pFunc->aArgs,i);` |
|         - |  630 | `			char *zSrc;` |
|         - |  631 | `			sxu32 nSrc,nName;` |
|         - |  632 | `			SySet sToken;` |
|         - |  633 | `			SyToken *pTmpIn,*pTmpEnd;` |
|         - |  634 | `			sxi32 rcPromote;` |
|   2405249 |  635 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|   2405173 |  636 | `				continue;` |
|         - |  637 | `			}` |
...
|         - |  687 | `	{` |
|   3285339 |  688 | `		sxi8 bSavedGen = pGen->bInGenerator;` |
|   3285339 |  689 | `		pGen->bInGenerator = (sxi8)GenStateFuncBodyHasYield(&(*pGen));` |
|         - |  690 | `		/* Compile the body */` |
|   3285339 |  691 | `		PH7_CompileBlock(&(*pGen),0);` |
|   3285339 |  692 | `		pGen->bInGenerator = bSavedGen;` |
|         - |  693 | `	}` |
|         - |  694 | `	/* Fix exception jumps now the destination is resolved */` |
|   3285339 |  695 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|         - |  696 | `	/* Emit the final return if not yet done */` |
|   3285339 |  697 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|         - |  698 | `	/* Fix gotos jumps now the destination is resolved */` |
|   3285339 |  699 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),nGotoOfft) ){` |
|       ! 0 |  700 | `		rc = SXERR_ABORT;` |
|       ! 0 |  701 | `	}` |
|   3285339 |  702 | `	SySetTruncate(&pGen->aGoto,nGotoOfft);` |
|         - |  703 | `	/* Restore the default container */` |
|   3285339 |  704 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|         - |  705 | `	/* Leave function block */` |
|   3285339 |  706 | `	GenStateLeaveBlock(&(*pGen),0);` |
|   3285339 |  707 | `	if( rc == SXERR_ABORT ){` |
...
|         - |  712 | `	{` |
|   3285339 |  713 | `		VmInstr *aInstr = (VmInstr *)SySetBasePtr(&pFunc->aByteCode);` |
|         - |  714 | `		sxu32 i;` |
|  92178377 |  715 | `		for( i = 0; i < SySetUsed(&pFunc->aByteCode); i++ ){` |
|  88904975 |  716 | `			if( aInstr[i].iOp == PH7_OP_YIELD \|\| aInstr[i].iOp == PH7_OP_YIELD_FROM ){` |
|     11937 |  717 | `				pFunc->iFlags \|= VM_FUNC_GENERATOR;` |
|     11937 |  718 | `				break;` |
|         - |  719 | `			}` |
|  44446524 |  720 | `		}` |
|         - |  721 | `	}` |
|   3285339 |  722 | `	if( pFunc->iFlags & VM_FUNC_GENERATOR ){` |
...
|         - | 1426 | ` */` |
|   3425874 | 1427 | `PH7_PRIVATE sxi32 GenStateParseReturnType(ph7_gen_state *pGen, ph7_vm_func *pFunc)` |
|         5 | 1428 | `{` |
|   3425879 | 1429 | `	sxi32 iFlags = 0;` |
|         - | 1430 | `	sxi32 rc;` |
|         - | 1431 | `	sxu32 nLine;` |
|   3425879 | 1432 | `	pFunc->nReturnType = 0;` |
|   3425879 | 1433 | `	SyStringInitFromBuf(&pFunc->sReturnClass, 0, 0);` |
|   3425879 | 1434 | `	SyStringInitFromBuf(&pFunc->sReturnTypeName, 0, 0);` |
...
|   3425879 | 1440 | `	SySetReset(&pFunc->aReturnUnion);` |
|   3425879 | 1441 | `	pFunc->iFlags &= ~VM_FUNC_RETURN_NULLABLE;` |
|   3425879 | 1442 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COLON) == 0 ){` |
|   3393947 | 1443 | `		return SXRET_OK;` |
|         - | 1444 | `	}` |
...
|   1712942 | 1482 | `}` |
|         - | 1483 |  |
|    523010 | 1484 | `PH7_PRIVATE sxi32 GenStateCompileFunc(` |
...
|    523015 | 1498 | `	nLine = pGen->pIn->nLine;` |
|         - | 1499 | `	/* Jump the left parenthesis '(' */` |
|    523015 | 1500 | `	pGen->pIn++;` |
|         - | 1501 | `	/* Delimit the function signature */` |
|    523015 | 1502 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|    523015 | 1503 | `	if( pEnd >= pGen->pEnd ){` |
|         - | 1504 | `		/* Syntax error */` |
...
|    523007 | 1515 | `	pFunc = (ph7_vm_func *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_vm_func));` |
|    523007 | 1516 | `	if( pFunc == 0 ){` |
|       ! 0 | 1517 | `		goto OutOfMem;` |
|         - | 1518 | `	}` |
|         - | 1519 | `	/* Build the function name, prepending namespace if active */` |
|    523015 | 1520 | `	if( SyBlobLength(&pGen->sNamespace) > 0 && !bHandleClosure ){` |
|         - | 1521 | `		SyBlob sFQN;` |
|         - | 1522 | `		sxu32 nLen;` |
...
|        10 | 1534 | `	}else{` |
|    522991 | 1535 | `		zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|    522991 | 1536 | `		if( zName == 0 ){` |
|       ! 0 | 1537 | `			goto OutOfMem;` |
|         - | 1538 | `		}` |
|    522991 | 1539 | `		PH7_VmInitFuncState(pGen->pVm,pFunc,zName,pName->nByte,iFlags,0);` |
|         - | 1540 | `	}` |
...
|    523007 | 1543 | `	pFunc->nLine = nLine;` |
|    523007 | 1544 | `	GenStateConsumeDoc(&(*pGen),&pFunc->sDoc);` |
|    523007 | 1545 | `	if( GenStateConsumeAttrs(&(*pGen),&pFunc->aAttrs) == SXERR_ABORT ){` |
|       ! 0 | 1546 | `		return SXERR_ABORT;` |
|         - | 1547 | `	}` |
|    523007 | 1548 | `	if( pGen->pIn < pEnd ){` |
|         - | 1549 | `		/* Collect function arguments */` |
|    444225 | 1550 | `		rc = GenStateCollectFuncArgs(pFunc,&(*pGen),pEnd,0,0);` |
|    444225 | 1551 | `		if( rc == SXERR_ABORT ){` |
...
|    523005 | 1557 | `	pGen->pIn = &pEnd[1];` |
|         - | 1558 | `	{` |
|    523005 | 1559 | `		sxi32 rcRt = GenStateParseReturnType(pGen, pFunc);` |
|    523005 | 1560 | `		if( rcRt == SXERR_ABORT ){` |
|       ! 0 | 1561 | `			return SXERR_ABORT;` |
|    523005 | 1562 | `		}else if( rcRt == SXERR_SYNTAX ){` |
|         9 | 1563 | `			return SXERR_SYNTAX;` |
|         - | 1564 | `		}` |
|         - | 1565 | `	}` |
|    522999 | 1566 | `	if( bHandleClosure ){` |
|         - | 1567 | `		ph7_vm_func_closure_env sEnv;` |
|       613 | 1568 | `		int got_this = 0; /* TRUE if $this have been seen */` |
|       608 | 1569 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD)` |
|       365 | 1570 | `			&& SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_USE ){` |
|       117 | 1571 | `				sxu32 nLineLocal = pGen->pIn->nLine;` |
|         - | 1572 | `				/* Closure,record environment variable */` |
|       117 | 1573 | `				pGen->pIn++;` |
|       117 | 1574 | `				if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
...
|         - | 1578 | `					}` |
|       ! 0 | 1579 | `				}` |
|       117 | 1580 | `				pGen->pIn++; /* Jump the left parenthesis or any other unexpected token */` |
|         - | 1581 | `				/* Compile until we hit the first closing parenthesis */` |
|       255 | 1582 | `				while( pGen->pIn < pGen->pEnd ){` |
|       255 | 1583 | `					int iFlagsLocal = 0;` |
|       255 | 1584 | `					if( pGen->pIn->nType & PH7_TK_RPAREN ){` |
|       117 | 1585 | `						pGen->pIn++; /* Jump the closing parenthesis */` |
|       117 | 1586 | `						break;` |
|         - | 1587 | `					}` |
|       143 | 1588 | `					nLineLocal = pGen->pIn->nLine;` |
|       143 | 1589 | `					if( pGen->pIn->nType & PH7_TK_AMPER ){` |
...
|        79 | 1592 | `						iFlagsLocal = VM_FUNC_ARG_BY_REF;` |
|        79 | 1593 | `						pGen->pIn++;` |
|        38 | 1594 | `					}` |
|       138 | 1595 | `					if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 \|\| &pGen->pIn[1] >= pGen->pEnd` |
|       143 | 1596 | `						\|\| (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|       143 | 1615 | `						pNameLocal = &pGen->pIn[1].sData;` |
|       143 | 1616 | `						zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,pNameLocal->zString,pNameLocal->nByte);` |
|       143 | 1617 | `						if( zDup ){` |
|         - | 1618 | `							/* Zero the structure */` |
|       143 | 1619 | `							SyZero(&sEnv,sizeof(ph7_vm_func_closure_env));` |
|       143 | 1620 | `							sEnv.iFlags = iFlagsLocal;` |
|       143 | 1621 | `							sEnv.nIdx = SXU32_HIGH;` |
|       143 | 1622 | `							PH7_MemObjInit(pGen->pVm,&sEnv.sValue);` |
|       143 | 1623 | `							SyStringInitFromBuf(&sEnv.sName,zDup,pNameLocal->nByte);` |
|       158 | 1624 | `							if( !got_this && pNameLocal->nByte == sizeof("this")-1 &&` |
|        30 | 1625 | `								SyMemcmp((const void *)zDup,(const void *)"this",sizeof("this")-1) == 0 ){` |
|       ! 0 | 1626 | `									got_this = 1;` |
|       ! 0 | 1627 | `							}` |
|         - | 1628 | `							/* Save imported variable */` |
|       143 | 1629 | `							SySetPut(&pFunc->aClosureEnv,(const void *)&sEnv);` |
|        74 | 1630 | `						}else{` |
|       ! 0 | 1631 | `							 PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|       ! 0 | 1632 | `							 return SXERR_ABORT;` |
|         - | 1633 | `						}` |
|         - | 1634 | `					}` |
|       143 | 1635 | `					pGen->pIn += 2; /* $ + variable name or any other unexpected token */` |
|       171 | 1636 | `					while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA /*','*/) ){` |
...
|       117 | 1646 | `				if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COLON) ){` |
...
|         3 | 1653 | `				}` |
|        56 | 1654 | `		}` |
|       613 | 1655 | `		if( !got_this && (iFlags & VM_FUNC_STATIC_CL) == 0 ){` |
...
|       591 | 1663 | `			SyZero(&sEnv,sizeof(ph7_vm_func_closure_env));` |
|       591 | 1664 | `			sEnv.iFlags = VM_FUNC_ARG_IGNORE; /* Do not install if NULL */` |
|       591 | 1665 | `			sEnv.nIdx = SXU32_HIGH;` |
|       591 | 1666 | `			PH7_MemObjInit(pGen->pVm,&sEnv.sValue);` |
|       591 | 1667 | `			SyStringInitFromBuf(&sEnv.sName,"this",sizeof("this")-1);` |
|       591 | 1668 | `			SySetPut(&pFunc->aClosureEnv,(const void *)&sEnv);` |
|       293 | 1669 | `		}` |
|       613 | 1670 | `		if( SySetUsed(&pFunc->aClosureEnv) > 0 ){` |
|         - | 1671 | `			/* Mark as closure */` |
|       593 | 1672 | `			pFunc->iFlags \|= VM_FUNC_CLOSURE;` |
|       294 | 1673 | `		}` |
|       304 | 1674 | `	}` |
|         - | 1675 | `	/* Compile the body */` |
|    522999 | 1676 | `	rc = GenStateCompileFuncBody(&(*pGen),pFunc);` |
|    522999 | 1677 | `	if( rc == SXERR_ABORT ){` |
|       ! 0 | 1678 | `		return SXERR_ABORT;` |
|         - | 1679 | `	}` |
|         - | 1680 | `	/* The cursor sits just past the body's closing brace */` |
|    522999 | 1681 | `	pFunc->nEndLine = pGen->pIn[-1].nLine;` |
|    522999 | 1682 | `	if( ppFunc ){` |
|    522999 | 1683 | `		*ppFunc = pFunc;` |
|    261497 | 1684 | `	}` |
|    522999 | 1685 | `	rc = SXRET_OK;` |
|    522999 | 1686 | `	if( (pFunc->iFlags & VM_FUNC_CLOSURE) == 0 ){` |
|         - | 1687 | `		/* Reject a php-fatal redeclaration before hoisting the function */` |
|    522411 | 1688 | `		if( GenStateGuardFuncRedeclaration(pGen,pFunc) == SXERR_ABORT ){` |
|         6 | 1689 | `			return SXERR_ABORT;` |
|         - | 1690 | `		}` |
|         - | 1691 | `		/* Finally register the function */` |
|    522407 | 1692 | `		rc = PH7_VmInstallUserFunction(pGen->pVm,pFunc,0);` |
|    261201 | 1693 | `	}` |
|    522995 | 1694 | `	if( rc == SXRET_OK ){` |
|    522995 | 1695 | `		return SXRET_OK;` |
|         - | 1696 | `	}` |
...
|         - | 1708 | ` */` |
|    522410 | 1709 | `PH7_PRIVATE sxi32 PH7_CompileFunction(ph7_gen_state *pGen)` |
|         5 | 1710 | `{` |
|         - | 1711 | `	SyString *pName;` |
|         - | 1712 | `	sxi32 iFlags;` |
|         - | 1713 | `	sxu32 nKwLine;` |
...
|         - | 1715 | `	sxi32 rc;` |
|         - | 1716 |  |
|    522415 | 1717 | `	nLine = pGen->pIn->nLine;` |
|    522415 | 1718 | `	nKwLine = nLine; /* Line of the 'function' keyword (Reflection getStartLine) */` |
|    522415 | 1719 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|    522415 | 1720 | `	iFlags = 0;` |
|    522415 | 1721 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|         - | 1722 | `		/* Return by reference,remember that */` |
|        12 | 1723 | `		iFlags \|= VM_FUNC_REF_RETURN;` |
|         - | 1724 | `		/* Jump the '&' token */` |
|        12 | 1725 | `		pGen->pIn++;` |
|         5 | 1726 | `	}` |
|    522415 | 1727 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|         - | 1738 | `	}` |
|    522409 | 1739 | `	pName = &pGen->pIn->sData;` |
|    522409 | 1740 | `	nLine = pGen->pIn->nLine;` |
|         - | 1741 | `	/* Jump the function name */` |
|    522409 | 1742 | `	pGen->pIn++;` |
|    522409 | 1743 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|         - | 1744 | `		/* Syntax error */` |
...
|         - | 1757 | `	{` |
|    522407 | 1758 | `		ph7_vm_func *pFuncState = 0;` |
|    522407 | 1759 | `		rc = GenStateCompileFunc(&(*pGen),pName,iFlags,FALSE,&pFuncState);` |
|    522407 | 1760 | `		if( pFuncState ){` |
|         - | 1761 | `			/* Reflection getStartLine(): line of the 'function' keyword */` |
|    522391 | 1762 | `			pFuncState->nLine = nKwLine;` |
|    261193 | 1763 | `		}` |
|         - | 1764 | `	}` |
|    522407 | 1765 | `	return rc;` |
|    261210 | 1766 | `}` |
|         - | 1767 |  |
