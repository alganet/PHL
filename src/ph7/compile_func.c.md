...
|         - |   67 | ` */` |
|    709250 |   68 | `static sxi32 GenStateProcessArgValue(ph7_gen_state *pGen,ph7_vm_func_arg *pArg,SyToken *pIn,SyToken *pEnd)` |
|         5 |   69 | `{` |
|         - |   70 | `	SyToken *pTmpIn,*pTmpEnd;` |
|         - |   71 | `	SySet *pInstrContainer;` |
|         - |   72 | `	sxi32 rc;` |
|         - |   73 | `	/* Swap token stream */` |
|    709255 |   74 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|    709255 |   75 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|    709255 |   76 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pArg->aByteCode);` |
|         - |   77 | `	/* Compile the expression holding the argument value */` |
|    709255 |   78 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|         - |   79 | `	/* Emit the done instruction */` |
|    709255 |   80 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,(rc != SXERR_EMPTY ? 1 : 0),0,0,0);` |
|    709255 |   81 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|    709255 |   82 | `	RE_SWAP_DELIMITER(pGen);` |
|    709255 |   83 | `	if( rc == SXERR_ABORT ){` |
|       ! 0 |   84 | `		return SXERR_ABORT;` |
|         - |   85 | `	}` |
|    709255 |   86 | `	return SXRET_OK;` |
|    354630 |   87 | `}` |
|         - |   88 | `/*` |
...
|         - |  124 | ` */` |
|   1564194 |  125 | `PH7_PRIVATE sxi32 GenStateCollectFuncArgs(ph7_vm_func *pFunc,ph7_gen_state *pGen,SyToken *pEnd,int bCtorCtx,int bAbstractCtx)` |
|         5 |  126 | `{` |
...
|         - |  131 | `	sxi32 rc;` |
|         - |  132 |  |
|   1564199 |  133 | `	pIn = pGen->pIn;` |
|   1564199 |  134 | `	SyBlobInit(&sSig,&pGen->pVm->sAllocator);` |
|         - |  135 | `	/* Process arguments one after one */` |
|   2014554 |  136 | `	for(;;){` |
|   4029113 |  137 | `		if( pIn >= pEnd ){` |
|         - |  138 | `			/* No more arguments to process */` |
|   1564181 |  139 | `			break;` |
|         - |  140 | `		}` |
|   2464937 |  141 | `		SyZero(&sArg,sizeof(ph7_vm_func_arg));` |
|   2464937 |  142 | `		SySetInit(&sArg.aByteCode,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|   2464937 |  143 | `		SySetInit(&sArg.aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|   2464937 |  144 | `		SySetInit(&sArg.aAttrs,&pGen->pVm->sAllocator,sizeof(ph7_attribute));` |
|   2464937 |  145 | `		SyStringInitFromBuf(&sArg.sTypeName,0,0);` |
|         - |  146 | `		/* Parameter #[...] attributes: the group precedes the parameter's` |
|         - |  147 | `		 * first token inside the main token stream */` |
|   2464937 |  148 | `		if( GenStateCollectParamAttrs(&(*pGen),pIn,&sArg.aAttrs) == SXERR_ABORT ){` |
...
|         - |  156 | `		{` |
|   2464937 |  157 | `			int bReadonly = 0, bVisSeen = 0;` |
|   2464937 |  158 | `			sxi32 iVis = PH7_CLASS_PROT_PUBLIC;` |
|   2464937 |  159 | `			sxi32 iSetVisFlag = 0;` |
|         - |  160 | `			int nSetTok;` |
|         - |  161 | `			sxi32 nSetVis;` |
|   2464937 |  162 | `			if( pIn < pEnd && GenStateIsReadonly(pIn) ){` |
|         3 |  163 | `				bReadonly = 1;` |
|         3 |  164 | `				pIn++;` |
|         1 |  165 | `			}` |
|   2464937 |  166 | `			nSetVis = GenStatePeekSetVisibility(pIn,pEnd,&nSetTok);` |
|   2464937 |  167 | `			if( nSetVis ){` |
...
|       ! 0 |  174 | `					pIn++;` |
|         1 |  175 | `				}` |
|   2464936 |  176 | `			}else if( pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD) ){` |
|    109531 |  177 | `				sxu32 nKw = (sxu32)SX_PTR_TO_INT(pIn->pUserData);` |
|    109531 |  178 | `				if( nKw == PH7_TKWRD_PUBLIC \|\| nKw == PH7_TKWRD_PROTECTED \|\| nKw == PH7_TKWRD_PRIVATE ){` |
|        91 |  179 | `					bVisSeen = 1;` |
...
|        43 |  194 | `				}` |
|     54763 |  195 | `			}` |
|   2464937 |  196 | `			if( iSetVisFlag == PH7_CLASS_ATTR_PRIVATE_SET ){` |
|         5 |  197 | `				sArg.iFlags \|= VM_FUNC_ARG_PRIV_SET;` |
|   2464935 |  198 | `			}else if( iSetVisFlag == PH7_CLASS_ATTR_PROTECTED_SET ){` |
|       ! 0 |  199 | `				sArg.iFlags \|= VM_FUNC_ARG_PROT_SET;` |
|       ! 0 |  200 | `			}` |
|   2464937 |  201 | `			if( bVisSeen \|\| bReadonly ){` |
|        95 |  202 | `				if( !bCtorCtx ){` |
...
|   2464928 |  223 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_DOLLAR) == 0` |
|   1328276 |  224 | `			&& (pIn->nType & PH7_TK_AMPER) == 0` |
|    179917 |  225 | `			&& (pIn->nType & PH7_TK_ELLIPSIS) == 0 ){` |
|    144741 |  226 | `			sxu32 nLineLocal = pIn->nLine;` |
|    144741 |  227 | `			sxi32 iTFlags = 0;` |
|    144741 |  228 | `			pGen->pIn = pIn;` |
|    144741 |  229 | `			rc = GenStateParseUnionTypeDecl(` |
|     72368 |  230 | `				pGen, &sArg.nType, &sArg.sClass, &sArg.aUnionAlts,` |
|     72368 |  231 | `				&iTFlags, &sArg.sTypeName,` |
|         - |  232 | `				VM_FUNC_ARG_NULLABLE, VM_FUNC_ARG_UNION,` |
|         - |  233 | `				/* bAllowVoid */ 0,` |
|     72368 |  234 | `						nLineLocal);` |
|    144741 |  235 | `			pIn = pGen->pIn;` |
|    144741 |  236 | `			if( rc == SXERR_ABORT ){` |
|       ! 0 |  237 | `				return SXERR_ABORT;` |
|    144741 |  238 | `			}else if( rc == SXERR_CORRUPT ){` |
|         - |  239 | `				/* Error already reported by GenStateParseUnionTypeDecl */` |
|         3 |  240 | `				return SXERR_SYNTAX;` |
|    144739 |  241 | `			}else if( rc == SXERR_SYNTAX ){` |
|         9 |  242 | `				if( pIn < pEnd ){` |
...
|         - |  251 | `			}` |
|    144731 |  252 | `			sArg.iFlags \|= iTFlags;` |
|     72363 |  253 | `		}` |
|   2464923 |  254 | `		if( pIn >= pEnd ){` |
|       ! 0 |  255 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Missing argument name");` |
|       ! 0 |  256 | `			return rc;` |
|         - |  257 | `		}` |
|   2464923 |  258 | `		if( pIn->nType & PH7_TK_AMPER ){` |
|         - |  259 | `			/* Pass by reference,record that */` |
|     23437 |  260 | `			sArg.iFlags \|= VM_FUNC_ARG_BY_REF;` |
|     23437 |  261 | `			pIn++;` |
|     11716 |  262 | `		}` |
|   2464923 |  263 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_ELLIPSIS) ){` |
|         - |  264 | `			/* Variadic parameter: ...$args */` |
|     23493 |  265 | `			sArg.iFlags \|= VM_FUNC_ARG_VARIADIC;` |
|     23493 |  266 | `			pIn++;` |
|     11744 |  267 | `		}` |
|   2464923 |  268 | `		if( pIn >= pEnd \|\| (pIn->nType & PH7_TK_DOLLAR) == 0 \|\| &pIn[1] >= pEnd \|\| (pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|         - |  269 | `			/* Invalid argument */` |
|       ! 0 |  270 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Invalid argument name");` |
|       ! 0 |  271 | `			return rc;` |
|         - |  272 | `		}` |
|   2464923 |  273 | `		pIn++; /* Jump the dollar sign */` |
|         - |  274 | `		/* Copy argument name */` |
|   2464923 |  275 | `		zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,SyStringData(&pIn->sData),SyStringLength(&pIn->sData));` |
|   2464923 |  276 | `		if( zDup == 0 ){` |
|       ! 0 |  277 | `			PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"PH7 engine is running out of memory");` |
|       ! 0 |  278 | `			return SXERR_ABORT;` |
|         - |  279 | `		}` |
|   2464923 |  280 | `		SyStringInitFromBuf(&sArg.sName,zDup,SyStringLength(&pIn->sData));` |
|   2464923 |  281 | `		pIn++;` |
|   2464923 |  282 | `		if( pIn < pEnd ){` |
|   1364487 |  283 | `			if( pIn->nType & PH7_TK_EQUAL ){` |
|         - |  284 | `				SyToken *pDefend;` |
|    709257 |  285 | `				sxi32 iNest = 0;` |
|    709257 |  286 | `				pIn++; /* Jump the equal sign */` |
|    709257 |  287 | `				pDefend = pIn;` |
|         - |  288 | `				/* Process the default value associated with this argument */` |
|   1484787 |  289 | `				while( pDefend < pEnd ){` |
|   1021049 |  290 | `					if( (pDefend->nType & PH7_TK_COMMA) && iNest <= 0 ){` |
|    245519 |  291 | `						break;` |
|         - |  292 | `					}` |
|    775535 |  293 | `					if( pDefend->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*[*/) ){` |
|         - |  294 | `						/* Increment nesting level */` |
|     27291 |  295 | `						iNest++;` |
|    761892 |  296 | `					}else if( pDefend->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CCB/*'}'*/\|PH7_TK_CSB/*]*/) ){` |
|         - |  297 | `						/* Decrement nesting level */` |
|     27291 |  298 | `						iNest--;` |
|     13643 |  299 | `					}` |
|    775535 |  300 | `					pDefend++;` |
|         5 |  301 | `				}` |
|    709257 |  302 | `				if( pIn >= pDefend ){` |
|         3 |  303 | `					rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Missing argument default value");` |
|         3 |  304 | `					return rc;` |
|         - |  305 | `				}` |
|         - |  306 | `				/* Process default value */` |
|    709255 |  307 | `				rc = GenStateProcessArgValue(&(*pGen),&sArg,pIn,pDefend);` |
|    709255 |  308 | `				if( rc != SXRET_OK ){` |
|       ! 0 |  309 | `					return rc;` |
|         - |  310 | `				}` |
...
|    709250 |  316 | `				if( (sArg.nType > 0 \|\| (sArg.iFlags & VM_FUNC_ARG_UNION))` |
|    385816 |  317 | `					&& (sArg.iFlags & VM_FUNC_ARG_NULLABLE) == 0` |
|    378021 |  318 | `					&& &pIn[1] == pDefend` |
|     38999 |  319 | `					&& pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)` |
|     21449 |  320 | `					&& pIn->sData.nByte == sizeof("null")-1` |
|      5853 |  321 | `					&& SyStrnicmp(SyStringData(&pIn->sData),"null",sizeof("null")-1) == 0 ){` |
...
|    709253 |  344 | `				pIn = pDefend;` |
|    354624 |  345 | `			}` |
|   1364483 |  346 | `			if( pIn < pEnd && (pIn->nType & PH7_TK_COMMA) == 0 ){` |
|       ! 0 |  347 | `				rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Unexpected token '%z'",&pIn->sData);` |
|       ! 0 |  348 | `				return rc;` |
|         - |  349 | `			}` |
|   1364483 |  350 | `			pIn++; /* Jump the trailing comma */` |
|    682239 |  351 | `		}` |
|         - |  352 | `		/* Append argument signature */` |
|   2464919 |  353 | `		if( sArg.nType > 0 ){` |
|    144669 |  354 | `			if( SyStringLength(&sArg.sClass) > 0 ){` |
|         - |  355 | `				/* Class name — prefix with 'o' so generic object hint is a prefix match */` |
|     31285 |  356 | `				int marker = 'o';` |
|     31285 |  357 | `				SyBlobAppend(&sSig,(const void *)&marker,sizeof(char));` |
|     31285 |  358 | `				SyBlobAppend(&sSig,SyStringData(&sArg.sClass),SyStringLength(&sArg.sClass));` |
|     15645 |  359 | `			}else{` |
|         - |  360 | `				int c;` |
|    113389 |  361 | `				c = 'n'; /* cc warning */` |
|         - |  362 | `				/* Type leading character */` |
|    113389 |  363 | `				switch(sArg.nType){` |
|      5852 |  364 | `				case MEMOBJ_HASHMAP:` |
|         - |  365 | `					/* Hashmap aka 'array' */` |
|     11709 |  366 | `					c = 'h';` |
|     11709 |  367 | `					break;` |
|     17666 |  368 | `				case MEMOBJ_INT:` |
|         - |  369 | `					/* Integer */` |
|     35337 |  370 | `					c = 'i';` |
|     35337 |  371 | `					break;` |
...
|         2 |  389 | `					break;` |
|         - |  390 | `				}` |
|    113389 |  391 | `				SyBlobAppend(&sSig,(const void *)&c,sizeof(char));` |
|         - |  392 | `			}` |
|     72337 |  393 | `		}else{` |
|         - |  394 | `			/* No type is associated with this parameter which mean` |
|         - |  395 | `			 * that this function is not condidate for overloading.` |
|         - |  396 | `			 */` |
|   2320255 |  397 | `			SyBlobRelease(&sSig);` |
|         - |  398 | `		}` |
|         - |  399 | `		/* Save in the argument set */` |
|   2464919 |  400 | `		SySetPut(&pFunc->aArgs,(const void *)&sArg);` |
|         5 |  401 | `	}` |
|   1564181 |  402 | `	if( SyBlobLength(&sSig) > 0 ){` |
|         - |  403 | `		/* Save function signature */` |
|     97827 |  404 | `		SyStringInitFromBuf(&pFunc->sSignature,SyBlobData(&sSig),SyBlobLength(&sSig));` |
|     48911 |  405 | `	}` |
|   1564181 |  406 | `	return SXRET_OK;` |
|    782102 |  407 | `}` |
|         - |  408 | `/*` |
...
|         - |  412 | ` */` |
|     35122 |  413 | `static SyToken * GenStateSkipNestedFunc(SyToken *pIn, SyToken *pEnd)` |
|         5 |  414 | `{` |
|     35127 |  415 | `	sxi32 iParen = 0;` |
|     35127 |  416 | `	pIn++; /* past 'function'/'fn' */` |
...
|    156137 |  420 | `	while( pIn < pEnd ){` |
|    156137 |  421 | `		sxu32 t = pIn->nType;` |
|    156137 |  422 | `		if( t & PH7_TK_LPAREN ){ iParen++; }` |
|    152171 |  423 | `		else if( t & PH7_TK_RPAREN ){ iParen--; }` |
|    105349 |  424 | `		else if( (t & PH7_TK_OCB) && iParen <= 0 ){ break; }` |
|     85811 |  425 | `		else if( (t & PH7_TK_SEMI) && iParen <= 0 ){ return pIn; }` |
|    121015 |  426 | `		pIn++;` |
|         5 |  427 | `	}` |
|     19543 |  428 | `	if( pIn >= pEnd ){ return pIn; }` |
|         - |  429 | `	/* pIn at the body '{' — skip the balanced brace block. */` |
|         - |  430 | `	{` |
|     19543 |  431 | `		sxi32 d = 0;` |
|    775967 |  432 | `		while( pIn < pEnd ){` |
|    775967 |  433 | `			sxu32 t = pIn->nType;` |
|    775967 |  434 | `			if( t & PH7_TK_OCB ){ d++; }` |
|    744733 |  435 | `			else if( t & PH7_TK_CCB ){ d--; if( d <= 0 ){ pIn++; break; } }` |
|    756429 |  436 | `			pIn++;` |
|         5 |  437 | `		}` |
|         - |  438 | `	}` |
|     19543 |  439 | `	return pIn;` |
|     17566 |  440 | `}` |
|         - |  441 | `/*` |
...
|         - |  452 | ` * mixed, object.` |
|         - |  453 | ` */` |
|     11712 |  454 | `static int GenStateGenRetNameOk(const char *zName,sxu32 nName)` |
|         5 |  455 | `{` |
...
|         - |  459 | `	};` |
|         - |  460 | `	sxu32 i;` |
|     11717 |  461 | `	if( nName > 0 && zName[0] == '\\' ){` |
|       ! 0 |  462 | `		zName++;` |
|       ! 0 |  463 | `		nName--;` |
|       ! 0 |  464 | `	}` |
|     11725 |  465 | `	for( i = 0; i < SX_ARRAYSIZE(aOk); i++ ){` |
|     11725 |  466 | `		if( nName == aOk[i].nLen && SyStrnicmp(zName,aOk[i].zName,nName) == 0 ){` |
|     11717 |  467 | `			return 1;` |
|         - |  468 | `		}` |
|         5 |  469 | `	}` |
|       ! 0 |  470 | `	return 0;` |
...
|         - |  483 | ` */` |
|     11714 |  484 | `static int GenStateGenRetAtomOk(ph7_gen_state *pGen,sxu32 nType,const SyString *pName)` |
|         5 |  485 | `{` |
|     11719 |  486 | `	if( nType == MEMOBJ_OBJ ){` |
|       ! 0 |  487 | ``		return 1; /* bare `object` */`` |
|         - |  488 | `	}` |
|     11719 |  489 | `	if( nType != SXU32_HIGH ){` |
|         3 |  490 | `		return 0; /* scalar/array/void/never/null/... */` |
|         - |  491 | `	}` |
|     11717 |  492 | `	if( GenStateGenRetNameOk(pName->zString,pName->nByte) ){` |
|     11717 |  493 | `		return 1;` |
|         - |  494 | `	}` |
...
|         - |  518 | ` */` |
|     11956 |  519 | `static sxi32 GenStateValidateGeneratorReturnType(ph7_gen_state *pGen,ph7_vm_func *pFunc)` |
|         5 |  520 | `{` |
|     11961 |  521 | `	int bOk = 0;` |
|         - |  522 | `	sxu32 nLine;` |
|         - |  523 | `	sxi32 rc;` |
|     11961 |  524 | `	if( pFunc->nReturnType < 1 && SySetUsed(&pFunc->aReturnUnion) < 1 ){` |
|       247 |  525 | `		return SXRET_OK; /* untyped: nothing to validate */` |
|         - |  526 | `	}` |
|     11719 |  527 | `	if( SySetUsed(&pFunc->aReturnUnion) > 0 ){` |
...
|       ! 0 |  544 | `		}` |
|       ! 0 |  545 | `	}else{` |
|     11719 |  546 | `		bOk = GenStateGenRetAtomOk(&(*pGen),pFunc->nReturnType,&pFunc->sReturnClass);` |
|         - |  547 | `	}` |
|     11719 |  548 | `	if( bOk ){` |
|     11717 |  549 | `		return SXRET_OK;` |
|         - |  550 | `	}` |
...
|      5983 |  575 | `}` |
|   3292090 |  576 | `static int GenStateFuncBodyHasYield(ph7_gen_state *pGen)` |
|         5 |  577 | `{` |
|   3292095 |  578 | `	SyToken *pIn = pGen->pIn;   /* expected at the body's opening '{' */` |
|   3292095 |  579 | `	SyToken *pEnd = pGen->pEnd;` |
|   3292095 |  580 | `	sxi32 iDepth = 0;` |
|   3292095 |  581 | `	int bStarted = 0;` |
| 150802917 |  582 | `	while( pIn < pEnd ){` |
| 150802917 |  583 | `		sxu32 t = pIn->nType;` |
| 150802917 |  584 | `		if( t & PH7_TK_OCB ){ iDepth++; bStarted = 1; pIn++; continue; }` |
| 144011177 |  585 | `		if( t & PH7_TK_CCB ){ iDepth--; pIn++; if( bStarted && iDepth <= 0 ){ break; } continue; }` |
| 137254885 |  586 | `		if( t & PH7_TK_KEYWORD ){` |
|  10252319 |  587 | `			int kw = SX_PTR_TO_INT(pIn->pUserData);` |
|  10252319 |  588 | `			if( kw == PH7_TKWRD_YIELD ){ return TRUE; }` |
|  10240363 |  589 | `			if( kw == PH7_TKWRD_FUNCTION ){ pIn = GenStateSkipNestedFunc(pIn,pEnd); continue; }` |
|         - |  590 | ``			/* `fn` arrow bodies are single expressions and cannot contain a valid yield. */`` |
|   5102618 |  591 | `		}` |
| 137207807 |  592 | `		pIn++;` |
|         5 |  593 | `	}` |
|   3280139 |  594 | `	return FALSE;` |
|   1646050 |  595 | `}` |
|         - |  596 | `/*` |
...
|         - |  600 | ` */` |
|   3292090 |  601 | `PH7_PRIVATE sxi32 GenStateCompileFuncBody(` |
...
|   3292095 |  611 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC,PH7_VmInstrLength(pGen->pVm),pFunc,&pBlock);` |
|   3292095 |  612 | `	if( rc != SXRET_OK ){` |
...
|         - |  616 | `	}` |
|   3292095 |  617 | `	nGotoOfft = SySetUsed(&pGen->aGoto);` |
|         - |  618 | `	/* Swap bytecode containers */` |
|   3292095 |  619 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   3292095 |  620 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pFunc->aByteCode);` |
...
|         - |  625 | `	{` |
|   3292095 |  626 | `		sxu32 nArg = SySetUsed(&pFunc->aArgs);` |
|         - |  627 | `		sxu32 i;` |
|   5702289 |  628 | `		for( i = 0; i < nArg; i++ ){` |
|   2410199 |  629 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pFunc->aArgs,i);` |
|         - |  630 | `			char *zSrc;` |
|         - |  631 | `			sxu32 nSrc,nName;` |
|         - |  632 | `			SySet sToken;` |
|         - |  633 | `			SyToken *pTmpIn,*pTmpEnd;` |
|         - |  634 | `			sxi32 rcPromote;` |
|   2410199 |  635 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|   2410123 |  636 | `				continue;` |
|         - |  637 | `			}` |
...
|         - |  687 | `	{` |
|   3292095 |  688 | `		sxi8 bSavedGen = pGen->bInGenerator;` |
|   3292095 |  689 | `		pGen->bInGenerator = (sxi8)GenStateFuncBodyHasYield(&(*pGen));` |
|         - |  690 | `		/* Compile the body */` |
|   3292095 |  691 | `		PH7_CompileBlock(&(*pGen),0);` |
|   3292095 |  692 | `		pGen->bInGenerator = bSavedGen;` |
|         - |  693 | `	}` |
|         - |  694 | `	/* Fix exception jumps now the destination is resolved */` |
|   3292095 |  695 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|         - |  696 | `	/* Emit the final return if not yet done */` |
|   3292095 |  697 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|         - |  698 | `	/* Fix gotos jumps now the destination is resolved */` |
|   3292095 |  699 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),nGotoOfft) ){` |
|       ! 0 |  700 | `		rc = SXERR_ABORT;` |
|       ! 0 |  701 | `	}` |
|   3292095 |  702 | `	SySetTruncate(&pGen->aGoto,nGotoOfft);` |
|         - |  703 | `	/* Restore the default container */` |
|   3292095 |  704 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|         - |  705 | `	/* Leave function block */` |
|   3292095 |  706 | `	GenStateLeaveBlock(&(*pGen),0);` |
|   3292095 |  707 | `	if( rc == SXERR_ABORT ){` |
...
|         - |  712 | `	{` |
|   3292095 |  713 | `		VmInstr *aInstr = (VmInstr *)SySetBasePtr(&pFunc->aByteCode);` |
|         - |  714 | `		sxu32 i;` |
|  92368001 |  715 | `		for( i = 0; i < SySetUsed(&pFunc->aByteCode); i++ ){` |
|  89087867 |  716 | `			if( aInstr[i].iOp == PH7_OP_YIELD \|\| aInstr[i].iOp == PH7_OP_YIELD_FROM ){` |
|     11961 |  717 | `				pFunc->iFlags \|= VM_FUNC_GENERATOR;` |
|     11961 |  718 | `				break;` |
|         - |  719 | `			}` |
|  44537958 |  720 | `		}` |
|         - |  721 | `	}` |
|   3292095 |  722 | `	if( pFunc->iFlags & VM_FUNC_GENERATOR ){` |
|         - |  723 | `		/* php-exact definition-time check; see the helper's block comment. */` |
|     11961 |  724 | `		if( SXERR_ABORT == GenStateValidateGeneratorReturnType(&(*pGen),pFunc) ){` |
|       ! 0 |  725 | `			return SXERR_ABORT;` |
|         - |  726 | `		}` |
|      5978 |  727 | `	}` |
|         - |  728 | `	/* All done, function body compiled */` |
|   3292095 |  729 | `	return SXRET_OK;` |
|   1646050 |  730 | `}` |
|         - |  731 | `/*` |
...
|         - |  800 | ` */` |
|     43206 |  801 | `static int GenStateIsReservedTypeWord(const SyString *pName)` |
|         5 |  802 | `{` |
...
|         - |  807 | `	};` |
|         - |  808 | `	sxu32 i;` |
|    905221 |  809 | `	for( i = 0 ; i < SX_ARRAYSIZE(azWords) ; i++ ){` |
|    862135 |  810 | `		sxu32 n = (sxu32)SyStrlen(azWords[i]);` |
|    862135 |  811 | `		if( pName->nByte == n && SyStrnicmp(pName->zString,azWords[i],n) == 0 ){` |
|       125 |  812 | `			return 1;` |
|         - |  813 | `		}` |
|    431010 |  814 | `	}` |
|     43091 |  815 | `	return 0;` |
|     21608 |  816 | `}` |
|    192880 |  817 | `static sxi32 GenStateParseOneTypeAtom(ph7_gen_state *pGen, PhlTypeAtom *pOut)` |
|         5 |  818 | `{` |
|    192885 |  819 | `	SyToken *pIn = pGen->pIn;` |
|    192885 |  820 | `	int bAbsolute = 0;` |
|    192885 |  821 | `	SyZero(pOut, sizeof(*pOut));` |
|    192885 |  822 | `	SyStringInitFromBuf(&pOut->sClass, 0, 0);` |
|    192885 |  823 | `	if( pIn >= pGen->pEnd ){` |
|       ! 0 |  824 | `		return SXERR_SYNTAX;` |
|         - |  825 | `	}` |
|         - |  826 | `	/* Optional leading namespace separator '\' on FQN class types */` |
|    192885 |  827 | `	if( pIn->nType & PH7_TK_NSSEP ){` |
...
|         - |  832 | `		}` |
|         4 |  833 | `	}` |
|    192885 |  834 | `	if( (pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|       ! 0 |  835 | `		return SXERR_SYNTAX;` |
|         - |  836 | `	}` |
|    192885 |  837 | `	if( pIn->nType & PH7_TK_KEYWORD ){` |
|    149443 |  838 | `		sxu32 nKey = (sxu32)(SX_PTR_TO_INT(pIn->pUserData));` |
|    149443 |  839 | `		if( nKey & PH7_TKWRD_ARRAY ){` |
|     15673 |  840 | `			pOut->nType = MEMOBJ_HASHMAP; pOut->zCanon = "array"; pOut->nCanon = 5;` |
|    141609 |  841 | `		}else if( nKey & PH7_TKWRD_BOOL ){` |
|      7879 |  842 | `			pOut->nType = MEMOBJ_BOOL; pOut->zCanon = "bool"; pOut->nCanon = 4;` |
|    129838 |  843 | `		}else if( nKey & PH7_TKWRD_INT ){` |
|     47459 |  844 | `			pOut->nType = MEMOBJ_INT; pOut->zCanon = "int"; pOut->nCanon = 3;` |
|    102174 |  845 | `		}else if( nKey & PH7_TKWRD_STRING ){` |
|     78351 |  846 | `			pOut->nType = MEMOBJ_STRING; pOut->zCanon = "string"; pOut->nCanon = 6;` |
|     39274 |  847 | `		}else if( nKey & PH7_TKWRD_FLOAT ){` |
...
|     43447 |  862 | `		SyString *pT = &pIn->sData;` |
|     43447 |  863 | `		if( pT->nByte == 4 && SyMemcmpNoCase(pT->zString, "null", 4) == 0 ){` |
|        34 |  864 | `			pOut->nType = UTA_NULL_FLAG; pOut->zCanon = "null"; pOut->nCanon = 4;` |
|        34 |  865 | `			pIn++;` |
|     43432 |  866 | `		}else if( pT->nByte == 4 && SyMemcmpNoCase(pT->zString, "void", 4) == 0 ){` |
|       181 |  867 | `			pOut->nType = UTA_VOID_FLAG; pOut->zCanon = "void"; pOut->nCanon = 4;` |
|       181 |  868 | `			pIn++;` |
|     43329 |  869 | `		}else if( pT->nByte == 5 && SyMemcmpNoCase(pT->zString, "never", 5) == 0 ){` |
|        27 |  870 | `			pOut->nType = UTA_NEVER_FLAG; pOut->zCanon = "never"; pOut->nCanon = 5;` |
|        27 |  871 | `			pIn++;` |
|        16 |  872 | `		}else{` |
|         - |  873 | `			/* Class / interface name; consume namespace path a\b\c */` |
|     43219 |  874 | `			SyToken *pFirst = pIn;` |
|     43219 |  875 | `			SyToken *pLast = pIn;` |
|     43219 |  876 | `			pOut->nType = SXU32_HIGH;` |
|     43219 |  877 | `			pOut->sClass = pIn->sData;` |
|     43219 |  878 | `			pIn++;` |
|     64824 |  879 | `			while( pIn + 1 < pGen->pEnd && (pIn->nType & PH7_TK_NSSEP)` |
|     43222 |  880 | `				&& (pIn[1].nType & PH7_TK_ID) ){` |
|         3 |  881 | `				pLast = &pIn[1];` |
|         3 |  882 | `				pIn += 2;` |
|         1 |  883 | `			}` |
|     43219 |  884 | `			if( pLast != pFirst ){` |
...
|     43219 |  898 | `			if( !bAbsolute && pLast == pFirst && !GenStateIsReservedTypeWord(&pOut->sClass) ){` |
|         - |  899 | `				SyBlob sFqn;` |
|     43091 |  900 | `				SyBlobInit(&sFqn,&pGen->pVm->sAllocator);` |
|     43091 |  901 | `				GenStateResolveName(pGen,&pOut->sClass,&sFqn);` |
|     43086 |  902 | `				if( SyBlobLength(&sFqn) != pOut->sClass.nByte` |
|     43086 |  903 | `				 \|\| SyMemcmp(SyBlobData(&sFqn),(const void *)pOut->sClass.zString,pOut->sClass.nByte) != 0 ){` |
...
|         5 |  908 | `					}` |
|         5 |  909 | `				}` |
|     43091 |  910 | `				SyBlobRelease(&sFqn);` |
|     21543 |  911 | `			}` |
|         - |  912 | `		}` |
|         - |  913 | `	}` |
|    192883 |  914 | `	pGen->pIn = pIn;` |
|    192883 |  915 | `	return SXRET_OK;` |
|     96445 |  916 | `}` |
|         - |  917 |  |
|         - |  918 | `/*` |
...
|         - |  924 | ` */` |
|    192704 |  925 | `static void GenBuildUnionTypeText(SyBlob *pBlob, PhlTypeAtom *aAtoms, int nAtoms, int bNullable)` |
|         5 |  926 | `{` |
|         - |  927 | `	int i;` |
|    192709 |  928 | `	int nNonNull = 0;` |
|    192709 |  929 | `	int bAnyIntersection = 0;` |
|         - |  930 | `	sxu32 aGroupCount[PHL_UNION_MAX_ALTS];` |
|    192709 |  931 | `	sxu32 nMaxGroup = 0;` |
|   6359237 |  932 | `	for( i = 0; i < PHL_UNION_MAX_ALTS; i++ ) aGroupCount[i] = 0;` |
|    385563 |  933 | `	for( i = 0; i < nAtoms; i++ ){` |
|    192859 |  934 | `		if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|    192829 |  935 | `			nNonNull++;` |
|    192829 |  936 | `			if( aAtoms[i].nGroup < PHL_UNION_MAX_ALTS ){` |
|    192829 |  937 | `				aGroupCount[aAtoms[i].nGroup]++;` |
|    192829 |  938 | `				if( aAtoms[i].nGroup > nMaxGroup ) nMaxGroup = aAtoms[i].nGroup;` |
|     96412 |  939 | `			}` |
|     96412 |  940 | `		}` |
|     96432 |  941 | `	}` |
|    385511 |  942 | `	for( i = 0; i < nAtoms; i++ ){` |
|    192831 |  943 | `		if( aAtoms[i].nType != UTA_NULL_FLAG && aGroupCount[aAtoms[i].nGroup] >= 2 ){` |
|        29 |  944 | `			bAnyIntersection = 1;` |
|        29 |  945 | `			break;` |
|         - |  946 | `		}` |
|     96406 |  947 | `	}` |
|    192709 |  948 | `	if( bAnyIntersection ){` |
...
|      9827 |  983 | `		return;` |
|         - |  984 | `	}` |
|    192685 |  985 | `	if( nNonNull == 1 && bNullable ){` |
|         - |  986 | `		/* Shorthand: ?T */` |
|     19601 |  987 | `		for( i = 0; i < nAtoms; i++ ){` |
|     19601 |  988 | `			if( aAtoms[i].nType == UTA_NULL_FLAG ) continue;` |
|     19601 |  989 | `			SyBlobAppend(pBlob, "?", 1);` |
|     19601 |  990 | `			if( aAtoms[i].nType == SXU32_HIGH ){` |
|     11719 |  991 | `				SyBlobAppend(pBlob, aAtoms[i].sClass.zString, aAtoms[i].sClass.nByte);` |
|      5862 |  992 | `			}else{` |
|      7887 |  993 | `				SyBlobAppend(pBlob, aAtoms[i].zCanon, aAtoms[i].nCanon);` |
|         - |  994 | `			}` |
|     19601 |  995 | `			return;` |
|       ! 0 |  996 | `		}` |
|       ! 0 |  997 | `	}` |
|         - |  998 | `	{` |
|    173089 |  999 | `		int bFirst = 1;` |
|         - | 1000 | `		/* 1) Classes in declaration order */` |
|    346279 | 1001 | `		for( i = 0; i < nAtoms; i++ ){` |
|    173195 | 1002 | `			if( aAtoms[i].nType == SXU32_HIGH ){` |
|     31487 | 1003 | `				if( !bFirst ) SyBlobAppend(pBlob, "\|", 1);` |
|     31487 | 1004 | `				SyBlobAppend(pBlob, aAtoms[i].sClass.zString, aAtoms[i].sClass.nByte);` |
|     31487 | 1005 | `				bFirst = 0;` |
|     15741 | 1006 | `			}` |
|     86600 | 1007 | `		}` |
...
|         - | 1012 | `			int k;` |
|   1211593 | 1013 | `			for( k = 0; k < (int)(sizeof(aOrder)/sizeof(aOrder[0])); k++ ){` |
|   1936035 | 1014 | `				for( i = 0; i < nAtoms; i++ ){` |
|   1039033 | 1015 | `					if( aAtoms[i].nType == aOrder[k] ){` |
|    141507 | 1016 | `						if( !bFirst ) SyBlobAppend(pBlob, "\|", 1);` |
|    141507 | 1017 | `						SyBlobAppend(pBlob, aAtoms[i].zCanon, aAtoms[i].nCanon);` |
|    141507 | 1018 | `						bFirst = 0;` |
|    141507 | 1019 | `						break;` |
|         - | 1020 | `					}` |
|    448768 | 1021 | `				}` |
|    519257 | 1022 | `			}` |
...
|         - | 1045 | ` */` |
|    192854 | 1046 | `static sxi32 GenStateParsePart(` |
|         - | 1047 | `	ph7_gen_state *pGen, PhlTypeAtom *aAtoms, int *pnAtoms, sxu32 iGroup,` |
|         - | 1048 | `	int *pnMembers, int *pbParen, sxu32 nLine)` |
|         5 | 1049 | `{` |
|         - | 1050 | `	sxi32 rc;` |
|    192859 | 1051 | `	int nMembers = 0;` |
|    192859 | 1052 | `	int bParen = 0;` |
|    192859 | 1053 | `	*pnMembers = 0;` |
|    192859 | 1054 | `	*pbParen = 0;` |
|    192859 | 1055 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_LPAREN) ){` |
|         9 | 1056 | `		bParen = 1;` |
|         9 | 1057 | `		pGen->pIn++; /* skip '(' */` |
|         3 | 1058 | `	}` |
|     96427 | 1059 | `	for(;;){` |
|    192885 | 1060 | `		if( *pnAtoms >= PHL_UNION_MAX_ALTS ){` |
...
|         - | 1064 | `		}` |
|    192885 | 1065 | `		rc = GenStateParseOneTypeAtom(pGen, &aAtoms[*pnAtoms]);` |
|    192885 | 1066 | `		if( rc != SXRET_OK ){` |
|         3 | 1067 | `			return rc;` |
|         - | 1068 | `		}` |
|    192883 | 1069 | `		aAtoms[*pnAtoms].nGroup = iGroup;` |
|    192883 | 1070 | `		(*pnAtoms)++;` |
|    192883 | 1071 | `		nMembers++;` |
|         - | 1072 | ``		/* Continue the intersection while `&` is followed by another type atom. */`` |
|    192883 | 1073 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
...
|         - | 1094 | `		}` |
|         3 | 1095 | `	}` |
|    192857 | 1096 | `	*pnMembers = nMembers;` |
|    192857 | 1097 | `	*pbParen = bParen;` |
|    192857 | 1098 | `	return SXRET_OK;` |
|     96432 | 1099 | `}` |
|         - | 1100 |  |
|         - | 1101 | `/*` |
...
|         - | 1118 | ` */` |
|    192720 | 1119 | `PH7_PRIVATE sxi32 GenStateParseUnionTypeDecl(` |
...
|    192725 | 1132 | `	int nAtoms = 0;` |
|    192725 | 1133 | `	int bShortNullable = 0;` |
|    192725 | 1134 | `	int bExplicitNull = 0;` |
|         - | 1135 | `	sxi32 rc;` |
|    192725 | 1136 | `	*pnType = 0;` |
|    192725 | 1137 | `	if( pClass ) SyStringInitFromBuf(pClass, 0, 0);` |
|    192725 | 1138 | `	*piTypeFlags = 0;` |
|    192725 | 1139 | `	if( pTypeText ) SyStringInitFromBuf(pTypeText, 0, 0);` |
|         - | 1140 |  |
|    192725 | 1141 | `	if( pGen->pIn >= pGen->pEnd ){` |
|       ! 0 | 1142 | `		return SXRET_OK;` |
|         - | 1143 | `	}` |
|         - | 1144 | ``	/* Optional `?` shorthand prefix */`` |
|    192720 | 1145 | `	if( (pGen->pIn->nType & PH7_TK_OP) && pGen->pIn->sData.nByte == 1` |
|     19589 | 1146 | `	 && pGen->pIn->sData.zString[0] == '?' ){` |
|     19589 | 1147 | `		bShortNullable = 1;` |
|     19589 | 1148 | `		pGen->pIn++;` |
|     19589 | 1149 | `		if( pGen->pIn >= pGen->pEnd ){` |
...
|    192725 | 1158 | `		sxu32 iGroup = 0;` |
|    192725 | 1159 | `		rc = GenStateParsePart(pGen, aAtoms, &nAtoms, iGroup, &nMembers, &bParen, nLine);` |
|    192725 | 1160 | `		if( rc != SXRET_OK ){` |
|         4 | 1161 | `			return rc;` |
|         - | 1162 | `		}` |
...
|    289283 | 1168 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OP)` |
|    192929 | 1169 | `			&& pGen->pIn->sData.nByte == 1 && pGen->pIn->sData.zString[0] == '\|' ){` |
...
|         - | 1187 | `			}` |
|         5 | 1188 | `		}` |
|    192721 | 1189 | `		if( iGroup > 0 && nMembers >= 2 && !bParen ){` |
...
|         - | 1201 | `	{` |
|         - | 1202 | `		int i, j;` |
|    192721 | 1203 | `		int bHasNonNull = 0;` |
|    192721 | 1204 | `		int bAnyIntersection = 0;` |
...
|   6359633 | 1208 | `		for( i = 0; i < PHL_UNION_MAX_ALTS; i++ ) aGroupCount[i] = 0;` |
|    385597 | 1209 | `		for( i = 0; i < nAtoms; i++ ){` |
|    192881 | 1210 | `			if( aAtoms[i].nGroup < PHL_UNION_MAX_ALTS ) aGroupCount[aAtoms[i].nGroup]++;` |
|     96443 | 1211 | `		}` |
|    385541 | 1212 | `		for( i = 0; i < nAtoms; i++ ){` |
|    192851 | 1213 | `			if( aGroupCount[aAtoms[i].nGroup] >= 2 ){ bAnyIntersection = 1; break; }` |
|     96415 | 1214 | `		}` |
...
|    192721 | 1217 | `		if( bShortNullable && bAnyIntersection ){` |
...
|         - | 1221 | `		}` |
|    385583 | 1222 | `		for( i = 0; i < nAtoms; i++ ){` |
...
|    192879 | 1226 | `			if( aGroupCount[aAtoms[i].nGroup] >= 2 ){` |
...
|         - | 1248 | `				}` |
|        24 | 1249 | `			}` |
|    192877 | 1250 | `			if( aAtoms[i].nType == UTA_VOID_FLAG ){` |
...
|         - | 1265 | `				}` |
|        87 | 1266 | `			}` |
|    192875 | 1267 | `			if( aAtoms[i].nType == UTA_NEVER_FLAG ){` |
...
|         - | 1284 | `				}` |
|         8 | 1285 | `			}` |
|    192869 | 1286 | `			if( aAtoms[i].nType == UTA_NULL_FLAG ){` |
|        34 | 1287 | `				bExplicitNull = 1;` |
|        19 | 1288 | `			}else{` |
|    192839 | 1289 | `				bHasNonNull = 1;` |
|         - | 1290 | `			}` |
...
|        98 | 1328 | `			}` |
|     96436 | 1329 | `		}` |
|    192709 | 1330 | `		if( !bHasNonNull && bExplicitNull ){` |
...
|    192709 | 1345 | `	if( bShortNullable \|\| bExplicitNull ){` |
|     19617 | 1346 | `		*piTypeFlags \|= iNullableFlag;` |
|      9806 | 1347 | `	}` |
|         - | 1348 | `	/* Build canonical type text */` |
|    192709 | 1349 | `	if( pTypeText ){` |
|         - | 1350 | `		SyBlob sBlob;` |
|    192709 | 1351 | `		SyBlobInit(&sBlob, &pGen->pVm->sAllocator);` |
|    279270 | 1352 | `		GenBuildUnionTypeText(&sBlob, aAtoms, nAtoms,` |
|     96352 | 1353 | `			(bShortNullable \|\| bExplicitNull) ? 1 : 0);` |
|    192709 | 1354 | `		if( SyBlobLength(&sBlob) > 0 ){` |
|    288776 | 1355 | `			char *zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|    192514 | 1356 | `				(const char *)SyBlobData(&sBlob), SyBlobLength(&sBlob));` |
|    192519 | 1357 | `			if( zDup ){` |
|    192519 | 1358 | `				SyStringInitFromBuf(pTypeText, zDup, SyBlobLength(&sBlob));` |
|     96257 | 1359 | `			}` |
|     96257 | 1360 | `		}` |
|    192709 | 1361 | `		SyBlobRelease(&sBlob);` |
|     96352 | 1362 | `	}` |
...
|         - | 1366 | `	{` |
|    192709 | 1367 | `		int nNonNull = 0;` |
|    192709 | 1368 | `		int iNonNullIdx = -1;` |
|         - | 1369 | `		int i;` |
|    385563 | 1370 | `		for( i = 0; i < nAtoms; i++ ){` |
|    192859 | 1371 | `			if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|    192829 | 1372 | `				nNonNull++;` |
|    192829 | 1373 | `				iNonNullIdx = i;` |
|     96412 | 1374 | `			}` |
|     96432 | 1375 | `		}` |
|    192709 | 1376 | `		if( nNonNull <= 1 ){` |
|         - | 1377 | `			/* Fast path: store as single type. */` |
|    192605 | 1378 | `			if( iNonNullIdx >= 0 ){` |
|    192599 | 1379 | `				PhlTypeAtom *pA = &aAtoms[iNonNullIdx];` |
|    192599 | 1380 | `				if( pA->nType == SXU32_HIGH ){` |
|     64739 | 1381 | `					char *zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|     21578 | 1382 | `						pA->sClass.zString, pA->sClass.nByte);` |
|     43161 | 1383 | `					if( zDup == 0 ) return SXERR_ABORT;` |
|     43161 | 1384 | `					*pnType = SXU32_HIGH;` |
|     43161 | 1385 | `					if( pClass ) SyStringInitFromBuf(pClass, zDup, pA->sClass.nByte);` |
|    171021 | 1386 | `				}else if( pA->nType == UTA_VOID_FLAG ){` |
|       179 | 1387 | `					*pnType = MEMOBJ_VOID;` |
|    149356 | 1388 | `				}else if( pA->nType == UTA_NEVER_FLAG ){` |
|        18 | 1389 | `					*pnType = MEMOBJ_NEVER;` |
|        10 | 1390 | `				}else{` |
|    149253 | 1391 | `					*pnType = pA->nType;` |
|         - | 1392 | `				}` |
|     96297 | 1393 | `			}` |
|     96305 | 1394 | `		}else{` |
...
|         - | 1426 | ` */` |
|   3432918 | 1427 | `PH7_PRIVATE sxi32 GenStateParseReturnType(ph7_gen_state *pGen, ph7_vm_func *pFunc)` |
|         5 | 1428 | `{` |
|   3432923 | 1429 | `	sxi32 iFlags = 0;` |
|         - | 1430 | `	sxi32 rc;` |
|         - | 1431 | `	sxu32 nLine;` |
|   3432923 | 1432 | `	pFunc->nReturnType = 0;` |
|   3432923 | 1433 | `	SyStringInitFromBuf(&pFunc->sReturnClass, 0, 0);` |
|   3432923 | 1434 | `	SyStringInitFromBuf(&pFunc->sReturnTypeName, 0, 0);` |
...
|   3432923 | 1440 | `	SySetReset(&pFunc->aReturnUnion);` |
|   3432923 | 1441 | `	pFunc->iFlags &= ~VM_FUNC_RETURN_NULLABLE;` |
|   3432923 | 1442 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COLON) == 0 ){` |
|   3400927 | 1443 | `		return SXRET_OK;` |
|         - | 1444 | `	}` |
|     32001 | 1445 | `	pGen->pIn++; /* Skip ':' */` |
|     32001 | 1446 | `	if( pGen->pIn >= pGen->pEnd ){` |
|       ! 0 | 1447 | `		return SXRET_OK;` |
|         - | 1448 | `	}` |
|     32001 | 1449 | `	nLine = pGen->pIn->nLine;` |
|     32001 | 1450 | `	rc = GenStateParseUnionTypeDecl(` |
|     15998 | 1451 | `		pGen,` |
|     15998 | 1452 | `		&pFunc->nReturnType,` |
|     15998 | 1453 | `		&pFunc->sReturnClass,` |
|     15998 | 1454 | `		&pFunc->aReturnUnion,` |
|         - | 1455 | `		&iFlags,` |
|     15998 | 1456 | `		&pFunc->sReturnTypeName,` |
...
|         - | 1460 | `		/* bAllowVoid */ 1,` |
|     15998 | 1461 | `		nLine);` |
|     32001 | 1462 | `	if( rc == SXERR_ABORT ){` |
|       ! 0 | 1463 | `		return SXERR_ABORT;` |
|         - | 1464 | `	}` |
|     32001 | 1465 | `	if( rc == SXERR_CORRUPT ){` |
|         - | 1466 | `		/* Error already reported */` |
|       ! 0 | 1467 | `		return SXERR_SYNTAX;` |
|         - | 1468 | `	}` |
|     32001 | 1469 | `	if( rc == SXERR_SYNTAX ){` |
...
|         - | 1479 | `	}` |
|     31995 | 1480 | `	pFunc->iFlags \|= (iFlags & VM_FUNC_RETURN_NULLABLE);` |
|     31995 | 1481 | `	return SXRET_OK;` |
|   1716464 | 1482 | `}` |
|         - | 1483 |  |
|    524086 | 1484 | `PH7_PRIVATE sxi32 GenStateCompileFunc(` |
...
|    524091 | 1498 | `	nLine = pGen->pIn->nLine;` |
|         - | 1499 | `	/* Jump the left parenthesis '(' */` |
|    524091 | 1500 | `	pGen->pIn++;` |
|         - | 1501 | `	/* Delimit the function signature */` |
|    524091 | 1502 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|    524091 | 1503 | `	if( pEnd >= pGen->pEnd ){` |
|         - | 1504 | `		/* Syntax error */` |
...
|    524083 | 1515 | `	pFunc = (ph7_vm_func *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_vm_func));` |
|    524083 | 1516 | `	if( pFunc == 0 ){` |
|       ! 0 | 1517 | `		goto OutOfMem;` |
|         - | 1518 | `	}` |
|         - | 1519 | `	/* Build the function name, prepending namespace if active */` |
|    524091 | 1520 | `	if( SyBlobLength(&pGen->sNamespace) > 0 && !bHandleClosure ){` |
|         - | 1521 | `		SyBlob sFQN;` |
|         - | 1522 | `		sxu32 nLen;` |
...
|        10 | 1534 | `	}else{` |
|    524067 | 1535 | `		zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|    524067 | 1536 | `		if( zName == 0 ){` |
|       ! 0 | 1537 | `			goto OutOfMem;` |
|         - | 1538 | `		}` |
|    524067 | 1539 | `		PH7_VmInitFuncState(pGen->pVm,pFunc,zName,pName->nByte,iFlags,0);` |
|         - | 1540 | `	}` |
...
|    524083 | 1543 | `	pFunc->nLine = nLine;` |
|    524083 | 1544 | `	GenStateConsumeDoc(&(*pGen),&pFunc->sDoc);` |
|    524083 | 1545 | `	if( GenStateConsumeAttrs(&(*pGen),&pFunc->aAttrs) == SXERR_ABORT ){` |
|       ! 0 | 1546 | `		return SXERR_ABORT;` |
|         - | 1547 | `	}` |
|    524083 | 1548 | `	if( pGen->pIn < pEnd ){` |
|         - | 1549 | `		/* Collect function arguments */` |
|    445139 | 1550 | `		rc = GenStateCollectFuncArgs(pFunc,&(*pGen),pEnd,0,0);` |
|    445139 | 1551 | `		if( rc == SXERR_ABORT ){` |
...
|    524081 | 1557 | `	pGen->pIn = &pEnd[1];` |
|         - | 1558 | `	{` |
|    524081 | 1559 | `		sxi32 rcRt = GenStateParseReturnType(pGen, pFunc);` |
|    524081 | 1560 | `		if( rcRt == SXERR_ABORT ){` |
|       ! 0 | 1561 | `			return SXERR_ABORT;` |
|    524081 | 1562 | `		}else if( rcRt == SXERR_SYNTAX ){` |
|         9 | 1563 | `			return SXERR_SYNTAX;` |
|         - | 1564 | `		}` |
|         - | 1565 | `	}` |
|    524075 | 1566 | `	if( bHandleClosure ){` |
...
|    524075 | 1676 | `	rc = GenStateCompileFuncBody(&(*pGen),pFunc);` |
|    524075 | 1677 | `	if( rc == SXERR_ABORT ){` |
|       ! 0 | 1678 | `		return SXERR_ABORT;` |
|         - | 1679 | `	}` |
|         - | 1680 | `	/* The cursor sits just past the body's closing brace */` |
|    524075 | 1681 | `	pFunc->nEndLine = pGen->pIn[-1].nLine;` |
|    524075 | 1682 | `	if( ppFunc ){` |
|    524075 | 1683 | `		*ppFunc = pFunc;` |
|    262035 | 1684 | `	}` |
|    524075 | 1685 | `	rc = SXRET_OK;` |
|    524075 | 1686 | `	if( (pFunc->iFlags & VM_FUNC_CLOSURE) == 0 ){` |
|         - | 1687 | `		/* Reject a php-fatal redeclaration before hoisting the function */` |
|    523487 | 1688 | `		if( GenStateGuardFuncRedeclaration(pGen,pFunc) == SXERR_ABORT ){` |
|         6 | 1689 | `			return SXERR_ABORT;` |
|         - | 1690 | `		}` |
|         - | 1691 | `		/* Finally register the function */` |
|    523483 | 1692 | `		rc = PH7_VmInstallUserFunction(pGen->pVm,pFunc,0);` |
|    261739 | 1693 | `	}` |
|    524071 | 1694 | `	if( rc == SXRET_OK ){` |
|    524071 | 1695 | `		return SXRET_OK;` |
|         - | 1696 | `	}` |
...
|         - | 1708 | ` */` |
|    523484 | 1709 | `PH7_PRIVATE sxi32 PH7_CompileFunction(ph7_gen_state *pGen)` |
|         5 | 1710 | `{` |
|         - | 1711 | `	SyString *pName;` |
|         - | 1712 | `	sxi32 iFlags;` |
|         - | 1713 | `	sxu32 nKwLine;` |
...
|         - | 1715 | `	sxi32 rc;` |
|         - | 1716 |  |
|    523489 | 1717 | `	nLine = pGen->pIn->nLine;` |
|    523489 | 1718 | `	nKwLine = nLine; /* Line of the 'function' keyword (Reflection getStartLine) */` |
|    523489 | 1719 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|    523489 | 1720 | `	iFlags = 0;` |
|    523489 | 1721 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|         - | 1722 | `		/* Return by reference,remember that */` |
|        12 | 1723 | `		iFlags \|= VM_FUNC_REF_RETURN;` |
|         - | 1724 | `		/* Jump the '&' token */` |
|        12 | 1725 | `		pGen->pIn++;` |
|         5 | 1726 | `	}` |
|    523489 | 1727 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|         - | 1738 | `	}` |
|    523483 | 1739 | `	pName = &pGen->pIn->sData;` |
|    523483 | 1740 | `	nLine = pGen->pIn->nLine;` |
|         - | 1741 | `	/* Jump the function name */` |
|    523483 | 1742 | `	pGen->pIn++;` |
|    523483 | 1743 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|         - | 1744 | `		/* Syntax error */` |
...
|         - | 1757 | `	{` |
|    523481 | 1758 | `		ph7_vm_func *pFuncState = 0;` |
|    523481 | 1759 | `		rc = GenStateCompileFunc(&(*pGen),pName,iFlags,FALSE,&pFuncState);` |
|    523481 | 1760 | `		if( pFuncState ){` |
|         - | 1761 | `			/* Reflection getStartLine(): line of the 'function' keyword */` |
|    523465 | 1762 | `			pFuncState->nLine = nKwLine;` |
|    261730 | 1763 | `		}` |
|         - | 1764 | `	}` |
|    523481 | 1765 | `	return rc;` |
|    261747 | 1766 | `}` |
|         - | 1767 |  |
