...
|     - |   92 | ` * "all valid".)` |
|     - |   93 | ` */` |
|  1468 |   94 | `static int FormatUnknownSpec(const char *zIn,int nByte,int *pBad,int *pbDangling)` |
|     5 |   95 | `{` |
|  1473 |   96 | `	const char *zEnd = &zIn[nByte];` |
|     - |   97 | `	int c,idx;` |
| 14869 |   98 | `	while( zIn < zEnd ){` |
| 13437 |   99 | `		if( zIn[0] != '%' ){` |
|  9823 |  100 | `			zIn++;` |
|  9823 |  101 | `			continue;` |
|     - |  102 | `		}` |
|  3619 |  103 | `		zIn++; /* jump the percent sign */` |
...
|  5035 |  107 | `		while( zIn < zEnd ){` |
|  5023 |  108 | `			c = zIn[0];` |
|  5023 |  109 | `			if( c=='-' \|\| c=='+' \|\| c==' ' \|\| c=='0' ){` |
|  1373 |  110 | `				zIn++;` |
|  1373 |  111 | `				continue;` |
|     - |  112 | `			}` |
|  3655 |  113 | `			if( c=='\'' ){` |
...
|   ! 0 |  121 | `		}` |
|     - |  122 | `		/* field width */` |
|  6143 |  123 | `		while( zIn < zEnd && zIn[0]>='0' && zIn[0]<='9' ){` |
|  2529 |  124 | `			zIn++;` |
|     5 |  125 | `		}` |
...
|  3619 |  157 | `		if( zIn < zEnd && zIn[0]=='l' ){` |
|    11 |  158 | `			zIn++;` |
|     5 |  159 | `		}` |
|  3619 |  160 | `		if( zIn >= zEnd ){` |
...
|     - |  165 | `		}` |
|  3603 |  166 | `		c = zIn[0];` |
|  3603 |  167 | `		zIn++; /* jump the conversion specifier */` |
|  9311 |  168 | `		for( idx = 0 ; idx < (int)SX_ARRAYSIZE(aFmt) ; idx++ ){` |
|  9291 |  169 | `			if( c == aFmt[idx].fmttype ){` |
|  3583 |  170 | `				break;` |
|     - |  171 | `			}` |
|  2859 |  172 | `		}` |
|  3603 |  173 | `		if( idx >= (int)SX_ARRAYSIZE(aFmt) ){` |
|    21 |  174 | `			*pBad = c; /* unknown specifier */` |
|    21 |  175 | `			return TRUE;` |
|     - |  176 | `		}` |
|     5 |  177 | `	}` |
|  1437 |  178 | `	return FALSE;` |
|   739 |  179 | `}` |
|     - |  180 | `/*` |
...
|     - |  187 | ` */` |
|  1468 |  188 | `PH7_PRIVATE sxi32 PH7_FormatValidate(ph7_context *pCtx,const char *zFormat,int nByte)` |
|     5 |  189 | `{` |
|  1473 |  190 | `	int badSpec = 0,bDangling = FALSE;` |
|  1473 |  191 | `	if( FormatUnknownSpec(zFormat,nByte,&badSpec,&bDangling) ){` |
|    31 |  192 | `		return PH7_VmThrowException(pCtx,"ValueError",` |
|    10 |  193 | `			"Unknown format specifier \"%c\"",badSpec);` |
|     - |  194 | `	}` |
|  1453 |  195 | `	if( bDangling ){` |
|    17 |  196 | `		return PH7_VmThrowException(pCtx,"ValueError",` |
|     - |  197 | `			"Missing format specifier at end of string");` |
|     - |  198 | `	}` |
|  1437 |  199 | `	return PH7_OK;` |
|   739 |  200 | `}` |
|     - |  201 | `/*` |
...
|  7650 |  208 | `static int FormatScanNumber(const char **pzIn,const char *zEnd)` |
|     5 |  209 | `{` |
|  7655 |  210 | `	const char *zIn = *pzIn;` |
|  7655 |  211 | `	int v = 0;` |
| 13193 |  212 | `	while( zIn < zEnd && zIn[0]>='0' && zIn[0]<='9' ){` |
|  5543 |  213 | `		int d = zIn[0]-'0';` |
...
|  5543 |  217 | `		if( v > (PH7_FMT_NUM_CAP - d)/10 ){` |
...
|  1520 |  247 | `static int FormatRequiredArgs(const char *zIn,int nByte,const char **pzBad)` |
|     5 |  248 | `{` |
|  1525 |  249 | `	const char *zEnd = &zIn[nByte];` |
|  1525 |  250 | `	int c,seq = 0,maxpos = 0;` |
| 15021 |  251 | `	while( zIn < zEnd ){` |
| 13547 |  252 | `		int numVal = 0,pos = 0;` |
| 13547 |  253 | `		if( zIn[0] != '%' ){` |
|  9863 |  254 | `			zIn++;` |
|  9863 |  255 | `			continue;` |
|     - |  256 | `		}` |
|  3689 |  257 | `		zIn++; /* jump the percent sign */` |
|     - |  258 | `		/* leading flags (incl. the "'<pad>'" custom-pad form) */` |
|  5109 |  259 | `		while( zIn < zEnd ){` |
|  5091 |  260 | `			c = zIn[0];` |
|  5091 |  261 | `			if( c=='-' \|\| c=='+' \|\| c==' ' \|\| c=='0' ){ zIn++; continue; }` |
|  3719 |  262 | `			if( c=='\'' ){` |
|    53 |  263 | `				zIn++;` |
|    53 |  264 | `				if( zIn >= zEnd ){` |
...
|  3685 |  276 | `		numVal = FormatScanNumber(&zIn,zEnd);` |
|  3685 |  277 | `		if( zIn < zEnd && zIn[0]=='$' ){` |
|    68 |  278 | `			pos = numVal;` |
...
|    28 |  303 | `		}` |
|  3675 |  304 | `		if( numVal >= PH7_FMT_NUM_CAP ){` |
|     7 |  305 | `			*pzBad = PH7_FMT_BAD_WIDTH;` |
|     7 |  306 | `			return seq;` |
|     - |  307 | `		}` |
|     - |  308 | `		/* precision */` |
|  3669 |  309 | `		if( zIn < zEnd && zIn[0]=='.' ){` |
|   150 |  310 | `			zIn++;` |
...
|  3665 |  317 | `		if( zIn < zEnd && zIn[0]=='l' ){ zIn++; }` |
|  3665 |  318 | `		if( zIn >= zEnd ){` |
...
|     - |  328 | `		}` |
|  3643 |  329 | `		c = zIn[0];` |
|  3643 |  330 | `		zIn++; /* jump the conversion specifier */` |
|  3643 |  331 | `		if( c == '%' ){ continue; } /* %% consumes no argument */` |
|  3633 |  332 | `		if( pos > 0 ){` |
...
|     - |  336 | `		}` |
|     5 |  337 | `	}` |
|  1501 |  338 | `	return seq > maxpos ? seq : maxpos;` |
|   765 |  339 | `}` |
|     - |  340 | `/*` |
...
|     - |  350 | ` * when enough.` |
|     - |  351 | ` */` |
|  1520 |  352 | `PH7_PRIVATE sxi32 PH7_FormatCheckArgCount(ph7_context *pCtx,const char *zFormat,int nByte,int nValues,int nFixed,int bVararg)` |
|     5 |  353 | `{` |
|  1525 |  354 | `	const char *zBad = 0;` |
|  1525 |  355 | `	int required = FormatRequiredArgs(zFormat,nByte,&zBad);` |
|  1525 |  356 | `	if( zBad ){` |
...
|    16 |  393 | `}` |
|  1520 |  394 | `PH7_PRIVATE sxi32 PH7_FormatCheckFormatArg(ph7_context *pCtx,ph7_value *pArg,int iArg)` |
|     5 |  395 | `{` |
|  1525 |  396 | `	if( ph7_value_is_array(pArg) \|\| ph7_value_is_object(pArg) \|\| ph7_value_is_resource(pArg) ){` |
|     - |  397 | `		char zBuf[64];` |
...
|     - |  417 | ` */` |
|  1432 |  418 | `PH7_PRIVATE sxi32 PH7_InputFormat(` |
...
|     - |  427 | `	)` |
|     5 |  428 | `{` |
|  1437 |  429 | `	char spaces[] = "                                                  ";` |
|     - |  430 | `#define etSPACESIZE ((int)sizeof(spaces)-1)` |
|  1437 |  431 | `	const char *zCur,*zEnd = &zIn[nByte];` |
...
|     - |  478 | `	int c,rc,n;` |
|  1437 |  479 | `	sxi32 rcRet = SXRET_OK;   /* Status to hand back through the single exit */` |
|  1437 |  480 | `	ph7_value *pThrowArg = 0; /* First not-stringable %s argument; throws at the end */` |
|     - |  481 | `	int length;              /* Length of the field */` |
|     - |  482 | `	int prefix;` |
|     - |  483 | `	sxu8 xtype;              /* Conversion paradigm */` |
|     - |  484 | `	int width;               /* Width of the current field */` |
|     - |  485 | `	int idx;` |
|  1437 |  486 | `	n = (vf == TRUE) ? 0 : 1;` |
|  1437 |  487 | `	PH7_MemObjInit(pCtx->pVm,&sScratch);` |
...
|  2503 |  507 | `	for(;;){` |
|  5011 |  508 | `		zCur = zIn;` |
| 14803 |  509 | `		while( zIn < zEnd && zIn[0] != '%' ){` |
|  9797 |  510 | `			zIn++;` |
|     5 |  511 | `		}` |
|  5011 |  512 | `		if( zCur < zIn ){` |
|     - |  513 | `			/* Consume chunk verbatim */` |
|  3299 |  514 | `			rc = xConsumer(pCtx,zCur,(int)(zIn-zCur),pUserData);` |
|  3299 |  515 | `			if( rc != SXRET_OK ){` |
|     - |  516 | `				/* Callback requested an abort (e.g. an allocation failure) */` |
|   ! 0 |  517 | `				break;` |
|     - |  518 | `			}` |
|  1647 |  519 | `		}` |
|  5011 |  520 | `		if( zIn >= zEnd ){` |
|     - |  521 | `			/* No more input to process,break immediately */` |
|  1435 |  522 | `			break;` |
|     - |  523 | `		}` |
|     - |  524 | `		/* Find out what flags are present */` |
|  3581 |  525 | `		flag_leftjustify = flag_plussign =` |
|  3576 |  526 | `			flag_alternateform = flag_zeropad = 0;` |
...
|  3581 |  529 | `		cPad = ' ';` |
|  3581 |  530 | `		bDropDigits = 0;` |
|  3581 |  531 | `		cLeadSign = 0;` |
|  3581 |  532 | `		nPos = -1;` |
|  3581 |  533 | `		zIn++; /* Jump the precent sign */` |
|  1788 |  534 | `		do{` |
|  4993 |  535 | `			c = zIn[0];` |
|  4993 |  536 | `			switch( c ){` |
|  1135 |  537 | `			case '-':   flag_leftjustify = 1;     c = 0;   break;` |
|    27 |  538 | `			case '+':   flag_plussign = 1;        c = 0;   break;` |
|    39 |  539 | `			case ' ':   cPad = ' ';               c = 0;   break;` |
|   174 |  540 | `			case '0':   cPad = '0';               c = 0;   break;` |
|    23 |  541 | `			case '\'':` |
|    47 |  542 | `				zIn++;` |
|    47 |  543 | `				if( zIn < zEnd ){` |
...
|    23 |  547 | `				}` |
|    46 |  548 | `				break;` |
|  3576 |  549 | `			default:                                       break;` |
|     - |  550 | `			}` |
|  4993 |  551 | `		}while( c==0 && (zIn++ < zEnd) );` |
|     - |  552 | `		/* Get the field width (saturating — see FormatScanNumber) */` |
|  3581 |  553 | `		width = FormatScanNumber(&zIn,zEnd);` |
|  3581 |  554 | `		if( zIn < zEnd && zIn[0] == '$' ){` |
...
|  3581 |  591 | `		precision = -1;` |
|  3581 |  592 | `		bExplicitPrec = 0;` |
|  3581 |  593 | `		if( zIn < zEnd && zIn[0] == '.' ){` |
|   146 |  594 | `			zIn++;` |
...
|  3581 |  601 | `		if( zIn < zEnd && zIn[0] == 'l' ){` |
|     9 |  602 | `			zIn++;` |
|     4 |  603 | `		}` |
|  3581 |  604 | `		if( zIn >= zEnd ){` |
|     - |  605 | `			/* No more input */` |
|   ! 0 |  606 | `			break;` |
|     - |  607 | `		}` |
|     - |  608 | `		/* Fetch the info entry for the field */` |
|  3581 |  609 | `		pInfo = 0;` |
|  3581 |  610 | `		xtype = PH7_FMT_ERROR;` |
|  3581 |  611 | `		c = zIn[0];` |
|  3581 |  612 | `		zIn++; /* Jump the format specifer */` |
|  8949 |  613 | `		for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
|  8949 |  614 | `			if( c==aFmt[idx].fmttype ){` |
|  3581 |  615 | `				pInfo = &aFmt[idx];` |
|  3581 |  616 | `				xtype = pInfo->type;` |
|  3581 |  617 | `				break;` |
|     - |  618 | `			}` |
|  2689 |  619 | `		}` |
|  3581 |  620 | `		zBuf = zWorker; /* Point to the working buffer */` |
|  3581 |  621 | `		length = 0;` |
...
|     9 |  665 | `			width = 0;` |
|     9 |  666 | `			break;` |
|  1240 |  667 | `		case PH7_FMT_STRING:` |
|     - |  668 | `			/* the argument is treated as and presented as a string */` |
|  2485 |  669 | `			pArg = NEXT_ARG;` |
|  2485 |  670 | `			if( pArg == 0 ){` |
|   ! 0 |  671 | `				length = 0;` |
|  2485 |  672 | `			}else if( PH7_MemObjIsNotStringable(pArg) ){` |
...
|     - |  691 | `				const char *zSv;` |
|  2465 |  692 | `				sxi32 rcSv = PH7_ValueToStringUV(pCtx,pArg,&zSv,&length);` |
|  2465 |  693 | `				zBuf = (char *)zSv;` |
|  2465 |  694 | `				if( rcSv != SXRET_OK ){` |
...
|    38 |  711 | `				length = 0;` |
|    18 |  712 | `			}` |
|  2483 |  713 | `			if( bExplicitPrec && precision<length ){` |
|     7 |  714 | `				length = precision;` |
|     3 |  715 | `			}` |
|  2483 |  716 | `			break;` |
|   434 |  717 | `		case PH7_FMT_RADIX: {` |
...
|     - |  732 | `			 */` |
|     - |  733 | `			sxu64 uVal;` |
|   872 |  734 | `			pArg = NEXT_ARG;` |
|   872 |  735 | `			if( pArg == 0 ){` |
|   ! 0 |  736 | `				iVal = 0;` |
|   ! 0 |  737 | `			}else{` |
|   872 |  738 | `				iVal = ph7_value_to_int64(pArg);` |
|     - |  739 | `			}` |
...
|   872 |  749 | `			bDropDigits = (bExplicitPrec && pInfo->base != 10);` |
|   872 |  750 | `			if( precision >= 0 ){` |
|    19 |  751 | `				precision = -1;` |
|     9 |  752 | `			}` |
...
|   872 |  758 | `			if( flag_leftjustify && flag_zeropad && pInfo->base == 10 ){` |
|    19 |  759 | `				flag_zeropad = 0;` |
|    19 |  760 | `				cPad = ' ';` |
|     9 |  761 | `			}` |
|     - |  762 | `        /* For the format %#x, the value zero is printed "0" not "0x0". */` |
|   872 |  763 | `        if( iVal==0 ) flag_alternateform = 0;` |
|   872 |  764 | `        if( pInfo->flags & PH7_FMT_FLAG_SIGNED ){` |
|   718 |  765 | `          if( iVal<0 ){` |
|   100 |  766 | `            uVal = (sxu64)0 - (sxu64)iVal;` |
|   100 |  767 | `            prefix = '-';` |
|    51 |  768 | `          }else{` |
|   620 |  769 | `            uVal = (sxu64)iVal;` |
|     - |  770 | `            /* php's ' ' is a PAD selector, not C's space-for-a-positive-sign, so` |
|     - |  771 | `             * '+' is the only flag that prefixes a non-negative value. */` |
|   620 |  772 | `            prefix = flag_plussign ? '+' : 0;` |
|     - |  773 | `          }` |
|   361 |  774 | `        }else{` |
|   155 |  775 | `			uVal = (sxu64)iVal;` |
|   155 |  776 | `			prefix = 0;` |
|     - |  777 | `		}` |
...
|   872 |  782 | `        if( flag_zeropad && !flag_leftjustify ){` |
|   106 |  783 | `          cLeadSign = (char)prefix;` |
|   106 |  784 | `          prefix = 0;` |
|    52 |  785 | `        }` |
|   872 |  786 | `        zBuf = &zWorker[PH7_FMT_BUFSIZ-1];` |
|     - |  787 | `        {` |
|     - |  788 | `          const char *cset;` |
|     - |  789 | `          sxu64 base;` |
|   872 |  790 | `          cset = pInfo->charset;` |
|   872 |  791 | `          base = (sxu64)pInfo->base;` |
|   434 |  792 | `          do{                                           /* Convert to ascii */` |
|  3432 |  793 | `            *(--zBuf) = cset[uVal%base];` |
|  3432 |  794 | `            uVal = uVal/base;` |
|  3432 |  795 | `          }while( uVal>0 );` |
|     - |  796 | `        }` |
|   872 |  797 | `		length = (int)(&zWorker[PH7_FMT_BUFSIZ-1]-zBuf);` |
...
|   872 |  800 | `        if( prefix ) *(--zBuf) = (char)prefix;               /* Add sign */` |
|   872 |  801 | `        if( flag_alternateform && pInfo->prefix ){      /* Add "0" or "0x" */` |
|     - |  802 | `          char *pre, x;` |
...
|   ! 0 |  806 | `          }` |
|   ! 0 |  807 | `        }` |
|   872 |  808 | `		length = (int)(&zWorker[PH7_FMT_BUFSIZ-1]-zBuf);` |
|   872 |  809 | `		if( bDropDigits ){` |
|     9 |  810 | `			length = 0;` |
|     4 |  811 | `		}` |
|   872 |  812 | `		break;` |
|     - |  813 | `		}` |
...
|    37 |  923 | `      width--;` |
|    18 |  924 | `    }` |
|  3579 |  925 | `    if( width > length ){` |
|     - |  926 | `      /* Fill the pad buffer with THIS specifier's pad character. */` |
| 59369 |  927 | `      for( idx = 0 ; idx < etSPACESIZE ; ++idx ){ spaces[idx] = cPad; }` |
|   582 |  928 | `    }` |
|  3579 |  929 | `    if( !flag_leftjustify ){` |
|     - |  930 | `      register int nspace;` |
|  2449 |  931 | `      nspace = width-length;` |
|  2449 |  932 | `      if( nspace>0 ){` |
|  2331 |  933 | `        while( nspace>=etSPACESIZE ){` |
...
|     1 |  940 | `        }` |
|   229 |  941 | `        if( nspace>0 ){` |
|   229 |  942 | `			rc = xConsumer(pCtx,spaces,(unsigned int)nspace,pUserData);` |
|   229 |  943 | `			if( rc != SXRET_OK ){` |
...
|   113 |  948 | `      }` |
|  1222 |  949 | `    }` |
|  3579 |  950 | `    if( length>0 ){` |
|  3533 |  951 | `		rc = xConsumer(pCtx,zBuf,(unsigned int)length,pUserData);` |
|  3533 |  952 | `		if( rc != SXRET_OK ){` |
|   ! 0 |  953 | `		  rcRet = SXERR_ABORT; /* Consumer routine request an operation abort */` |
|   ! 0 |  954 | `		  goto Done;` |
|     - |  955 | `		}` |
|  1764 |  956 | `    }` |
|  3579 |  957 | `    if( flag_leftjustify ){` |
|     - |  958 | `      register int nspace;` |
|  1135 |  959 | `      nspace = width-length;` |
|  1135 |  960 | `      if( nspace>0 ){` |
|  1411 |  961 | `        while( nspace>=etSPACESIZE ){` |
...
|     1 |  968 | `        }` |
|   943 |  969 | `        if( nspace>0 ){` |
|   943 |  970 | `			rc = xConsumer(pCtx,spaces,(unsigned int)nspace,pUserData);` |
|   943 |  971 | `			if( rc != SXRET_OK ){` |
...
|  1419 |  989 | `	PH7_MemObjRelease(&sScratch);` |
|  1419 |  990 | `	return rcRet;` |
|   721 |  991 | `}` |
|     - |  992 | `/*` |
|     - |  993 | ` * Callback [i.e: Formatted input consumer] of the sprintf function.` |
|     - |  994 | ` */` |
|  3680 |  995 | `static int sprintfConsumer(ph7_context *pCtx,const char *zInput,int nLen,void *pUserData)` |
|     5 |  996 | `{` |
...
|  3685 | 1000 | `	sxi32 *pRc = (sxi32 *)pUserData;` |
|  3685 | 1001 | `	*pRc = ph7_result_string(pCtx,zInput,nLen);` |
|  3685 | 1002 | `	return *pRc;` |
|     5 | 1003 | `}` |
|     - | 1004 | `/*` |
...
|     - | 1012 | ` */` |
|   580 | 1013 | `PH7_PRIVATE int PH7_builtin_sprintf(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 | 1014 | `{` |
|     - | 1015 | `	sxi32 rcFmt;` |
|     - | 1016 | `	const char *zFormat;` |
|   585 | 1017 | `	sxi32 rc = SXRET_OK;` |
|     - | 1018 | `	int nLen;` |
|   585 | 1019 | `	if( nArg < 1 ){` |
...
|   585 | 1025 | `	rc = PH7_FormatCheckFormatArg(pCtx,apArg[0],1);` |
|   585 | 1026 | `	if( rc != PH7_OK ){` |
|   ! 0 | 1027 | `		return rc;` |
|     - | 1028 | `	}` |
|     - | 1029 | `	/* Extract the string format (scalars/null coerce). */` |
|   585 | 1030 | `	zFormat = ph7_value_to_string(apArg[0],&nLen);` |
|   585 | 1031 | `	if( nLen < 1 ){` |
|     - | 1032 | `		/* Empty string */` |
...
|   585 | 1038 | `	rc = PH7_FormatCheckArgCount(pCtx,zFormat,nLen,nArg-1,1,FALSE);` |
|   585 | 1039 | `	if( rc != PH7_OK ){` |
|    41 | 1040 | `		return rc;` |
|     - | 1041 | `	}` |
|     - | 1042 | `	/* PHP 8: too few value arguments is a catchable ArgumentCountError before output. */` |
|   545 | 1043 | `	rc = PH7_FormatValidate(pCtx,zFormat,nLen);` |
|   545 | 1044 | `	if( rc != PH7_OK ){` |
|    31 | 1045 | `		return rc;` |
|     - | 1046 | `	}` |
...
|   515 | 1051 | `	ph7_result_string(pCtx,"",0);` |
|     - | 1052 | `	/* Format the string; sprintfConsumer reports an allocation failure via &rc. */` |
|   515 | 1053 | `	rcFmt = PH7_InputFormat(sprintfConsumer,pCtx,zFormat,nLen,nArg,apArg,(void *)&rc,FALSE);` |
|   515 | 1054 | `	if( rc != SXRET_OK ){` |
...
|   515 | 1062 | `	if( rcFmt != SXRET_OK ){` |
|    12 | 1063 | `		pCtx->nThrowRc = rcFmt;` |
|    12 | 1064 | `		return rcFmt;` |
|     - | 1065 | `	}` |
|   505 | 1066 | `	return PH7_OK;` |
|   295 | 1067 | `}` |
|     - | 1068 | `/*` |
|     - | 1069 | ` * Callback [i.e: Formatted input consumer] of the printf function.` |
|     - | 1070 | ` */` |
|  6874 | 1071 | `static int printfConsumer(ph7_context *pCtx,const char *zInput,int nLen,void *pUserData)` |
|     5 | 1072 | `{` |
|  6879 | 1073 | `	ph7_int64 *pCounter = (ph7_int64 *)pUserData;` |
|     - | 1074 | `	/* Call the VM output consumer directly */` |
|  6879 | 1075 | `	ph7_context_output(pCtx,zInput,nLen);` |
|     - | 1076 | `	/* Increment counter */` |
|  6879 | 1077 | `	*pCounter += nLen;` |
|  6879 | 1078 | `	return PH7_OK;` |
|     5 | 1079 | `}` |
|     - | 1080 | `/*` |
...
|     - | 1088 | ` */` |
|   884 | 1089 | `PH7_PRIVATE int PH7_builtin_printf(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 | 1090 | `{` |
|     - | 1091 | `	sxi32 rcFmt;` |
|   889 | 1092 | `	ph7_int64 nCounter = 0;` |
...
|     - | 1101 | `	{` |
|   889 | 1102 | `		sxi32 rcf = PH7_FormatCheckFormatArg(pCtx,apArg[0],1);` |
|   889 | 1103 | `		if( rcf != PH7_OK ){` |
|   ! 0 | 1104 | `			return rcf;` |
|     - | 1105 | `		}` |
|     - | 1106 | `	}` |
|     - | 1107 | `	/* Extract the string format (scalars/null coerce). */` |
|   889 | 1108 | `	zFormat = ph7_value_to_string(apArg[0],&nLen);` |
|   889 | 1109 | `	if( nLen < 1 ){` |
|     - | 1110 | `		/* Empty string */` |
...
|   889 | 1117 | `		sxi32 rcv = PH7_FormatCheckArgCount(pCtx,zFormat,nLen,nArg-1,1,FALSE);` |
|   889 | 1118 | `		if( rcv != PH7_OK ){` |
|     3 | 1119 | `			return rcv;` |
|     - | 1120 | `		}` |
...
|   887 | 1123 | `		rcv = PH7_FormatValidate(pCtx,zFormat,nLen);` |
|   887 | 1124 | `		if( rcv != PH7_OK ){` |
|   ! 0 | 1125 | `			return rcv;` |
|     - | 1126 | `		}` |
|     - | 1127 | `	}` |
|     - | 1128 | `	/* Format the string */` |
|   887 | 1129 | `	rcFmt = PH7_InputFormat(printfConsumer,pCtx,zFormat,nLen,nArg,apArg,(void *)&nCounter,FALSE);` |
|     - | 1130 | `	/* Return the length of the outputted string */` |
|   887 | 1131 | `	ph7_result_int64(pCtx,nCounter);` |
...
|   887 | 1135 | `	if( rcFmt != SXRET_OK ){` |
|     3 | 1136 | `		pCtx->nThrowRc = rcFmt;` |
|     3 | 1137 | `		return rcFmt;` |
|     - | 1138 | `	}` |
|   885 | 1139 | `	return PH7_OK;` |
|   447 | 1140 | `}` |
|     - | 1141 | `/*` |
