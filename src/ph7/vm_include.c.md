...
|        - |   20 | ` * information.` |
|        - |   21 | ` */` |
|    90544 |   22 | `PH7_PRIVATE sxi32 VmEvalChunk(` |
...
|        - |   31 | `	SyBlob sSavedNs;` |
|    90549 |   32 | `	ProcConsumer xErr = 0;` |
|    90549 |   33 | `	void *pErrData = 0;` |
|        - |   34 | `	ph7_gen_state sSavedGen;` |
|        - |   35 | `	int bNested;` |
|    90549 |   36 | `	sxi32 rcThrow = SXRET_OK; /* status of a ParseError raised for a failed eval() compile */` |
|        - |   37 | `	/* Initialize bytecode container */` |
|    90549 |   38 | `	SySetInit(&aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|    90549 |   39 | `	SySetAlloc(&aByteCode,0x20);` |
|        - |   40 | `	/* Reset the code generator */` |
|    90549 |   41 | `	if( bTrueReturn ){` |
...
|    90549 |   50 | `	bNested = (pVm->sCodeGen.pIn != 0);` |
|    90549 |   51 | `	if( bNested ){` |
|        5 |   52 | `		PH7_CompilerSaveState(pVm,&sSavedGen,xErr,pErrData);` |
|        3 |   53 | `	}else{` |
|    90545 |   54 | `		PH7_ResetCodeGenerator(pVm,xErr,pErrData);` |
|        - |   55 | `	}` |
...
|    90549 |   59 | `	SyBlobInit(&sSavedNs,&pVm->sAllocator);` |
|    90549 |   60 | `	SyBlobDup(&pVm->sNamespace,&sSavedNs);` |
|    90549 |   61 | `	if( bTrueReturn ){` |
|        - |   62 | `		/* Include/require: start in a fresh (global) namespace scope. */` |
|     9091 |   63 | `		SyBlobReset(&pVm->sNamespace);` |
|     4544 |   64 | `	}` |
|        - |   65 | `	/* Swap bytecode container */` |
|    90549 |   66 | `	pByteCode = pVm->pByteContainer;` |
|    90549 |   67 | `	pVm->pByteContainer = &aByteCode;` |
|        - |   68 | `	/* Compile the chunk */` |
|    90549 |   69 | `	PH7_CompileScript(pVm,pChunk,iFlags);` |
|   135820 |   70 | `	if( pVm->sCodeGen.nErr > 0 ){` |
...
|        - |   98 | `		sxi32 rc;` |
|    90545 |   99 | `		if( pVm->nMagic != PH7_VM_INIT ){` |
...
|        5 |  114 | `			}` |
|     4592 |  115 | `		}` |
|    90543 |  116 | `		if( SXRET_OK != PH7_VmEmitInstr(pVm,PH7_OP_DONE,0,0,0,0) ){` |
|        - |  117 | `			/* Out of memory */` |
|      ! 0 |  118 | `			if( pCtx ){` |
...
|    90543 |  135 | `		VmLocalExec(pVm,&aByteCode,&sResult,FALSE);` |
|    90543 |  136 | `		if( pCtx ){` |
|        - |  137 | `			/* Set the execution result */` |
|     9189 |  138 | `			ph7_result_value(pCtx,&sResult);` |
|     4592 |  139 | `		}` |
|    90543 |  140 | `		PH7_MemObjRelease(&sResult);` |
|        - |  141 | `	}` |
|    45272 |  142 | `Cleanup:` |
|        - |  143 | `	/* Cleanup the mess left behind */` |
|    90549 |  144 | `	pVm->pByteContainer = pByteCode;` |
|    90549 |  145 | `	SySetRelease(&aByteCode);` |
|        - |  146 | `	/* Restore caller's namespace state */` |
|    90549 |  147 | `	SyBlobReset(&pVm->sNamespace);` |
|    90549 |  148 | `	SyBlobDup(&sSavedNs,&pVm->sNamespace);` |
|    90549 |  149 | `	SyBlobRelease(&sSavedNs);` |
|        - |  150 | `	/* Restore the outer compile's generator state if this was a nested unit. */` |
|    90549 |  151 | `	if( bNested ){` |
