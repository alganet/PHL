...
|        - |   20 | ` * information.` |
|        - |   21 | ` */` |
|    90474 |   22 | `PH7_PRIVATE sxi32 VmEvalChunk(` |
...
|        - |   31 | `	SyBlob sSavedNs;` |
|    90479 |   32 | `	ProcConsumer xErr = 0;` |
|    90479 |   33 | `	void *pErrData = 0;` |
|        - |   34 | `	ph7_gen_state sSavedGen;` |
|        - |   35 | `	int bNested;` |
|    90479 |   36 | `	sxi32 rcThrow = SXRET_OK; /* status of a ParseError raised for a failed eval() compile */` |
|        - |   37 | `	/* Initialize bytecode container */` |
|    90479 |   38 | `	SySetInit(&aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|    90479 |   39 | `	SySetAlloc(&aByteCode,0x20);` |
|        - |   40 | `	/* Reset the code generator */` |
|    90479 |   41 | `	if( bTrueReturn ){` |
|        - |   42 | `		/* Included file,log compile-time errors */` |
|     8979 |   43 | `		xErr = pVm->pEngine->xConf.xErr;` |
|     8979 |   44 | `		pErrData = pVm->pEngine->xConf.pErrData;` |
|     4488 |   45 | `	}` |
...
|    90479 |   50 | `	bNested = (pVm->sCodeGen.pIn != 0);` |
|    90479 |   51 | `	if( bNested ){` |
|        5 |   52 | `		PH7_CompilerSaveState(pVm,&sSavedGen,xErr,pErrData);` |
|        3 |   53 | `	}else{` |
|    90475 |   54 | `		PH7_ResetCodeGenerator(pVm,xErr,pErrData);` |
|        - |   55 | `	}` |
...
|    90479 |   59 | `	SyBlobInit(&sSavedNs,&pVm->sAllocator);` |
|    90479 |   60 | `	SyBlobDup(&pVm->sNamespace,&sSavedNs);` |
|    90479 |   61 | `	if( bTrueReturn ){` |
|        - |   62 | `		/* Include/require: start in a fresh (global) namespace scope. */` |
|     8979 |   63 | `		SyBlobReset(&pVm->sNamespace);` |
|     4488 |   64 | `	}` |
|        - |   65 | `	/* Swap bytecode container */` |
|    90479 |   66 | `	pByteCode = pVm->pByteContainer;` |
|    90479 |   67 | `	pVm->pByteContainer = &aByteCode;` |
|        - |   68 | `	/* Compile the chunk */` |
|    90479 |   69 | `	PH7_CompileScript(pVm,pChunk,iFlags);` |
|   135715 |   70 | `	if( pVm->sCodeGen.nErr > 0 ){` |
...
|        - |   98 | `		sxi32 rc;` |
|    90475 |   99 | `		if( pVm->nMagic != PH7_VM_INIT ){` |
|     9079 |  100 | `			SyHashResetLoopCursor(&pVm->hClass);` |
|  2409878 |  101 | `			while((pEntry = SyHashGetNextEntry(&pVm->hClass)) != 0 ){` |
|  2396269 |  102 | `				pClass = (ph7_class *)pEntry->pUserData;` |
|        - |  103 | `				/* Only mount classes that haven't been mounted yet */` |
|  2396269 |  104 | `				if( !pClass->bMounted ){` |
|   241137 |  105 | `					rc = VmMountUserClass(pVm,pClass);` |
|   241137 |  106 | `					if( rc != SXRET_OK ){` |
...
|        4 |  114 | `			}` |
|     4536 |  115 | `		}` |
|    90473 |  116 | `		if( SXRET_OK != PH7_VmEmitInstr(pVm,PH7_OP_DONE,0,0,0,0) ){` |
|        - |  117 | `			/* Out of memory */` |
|      ! 0 |  118 | `			if( pCtx ){` |
...
|      ! 0 |  121 | `			goto Cleanup;` |
|        - |  122 | `		}` |
|    90473 |  123 | `		if( bTrueReturn ){` |
|        - |  124 | `			/* Assume a boolean true return value */` |
|     8979 |  125 | `			PH7_MemObjInitFromBool(pVm,&sResult,1);` |
|     4491 |  126 | `		}else{` |
|        - |  127 | `			/* Assume a null return value */` |
|    81497 |  128 | `			PH7_MemObjInit(pVm,&sResult);` |
|        - |  129 | `		}` |
...
|    90473 |  135 | `		VmLocalExec(pVm,&aByteCode,&sResult,FALSE);` |
|    90473 |  136 | `		if( pCtx ){` |
|        - |  137 | `			/* Set the execution result */` |
|     9076 |  138 | `			ph7_result_value(pCtx,&sResult);` |
|     4536 |  139 | `		}` |
|    90473 |  140 | `		PH7_MemObjRelease(&sResult);` |
|        - |  141 | `	}` |
|    45237 |  142 | `Cleanup:` |
|        - |  143 | `	/* Cleanup the mess left behind */` |
|    90479 |  144 | `	pVm->pByteContainer = pByteCode;` |
|    90479 |  145 | `	SySetRelease(&aByteCode);` |
|        - |  146 | `	/* Restore caller's namespace state */` |
|    90479 |  147 | `	SyBlobReset(&pVm->sNamespace);` |
|    90479 |  148 | `	SyBlobDup(&sSavedNs,&pVm->sNamespace);` |
|    90479 |  149 | `	SyBlobRelease(&sSavedNs);` |
|        - |  150 | `	/* Restore the outer compile's generator state if this was a nested unit. */` |
|    90479 |  151 | `	if( bNested ){` |
...
|        - |  163 | ` */` |
|    73644 |  164 | `PH7_PRIVATE sxi32 PH7_VmEvalBuiltinChunk(ph7_vm *pVm,const char *zSrc,sxu32 nLen)` |
|        5 |  165 | `{` |
|        - |  166 | `	SyString sChunk;` |
|    73649 |  167 | `	SyStringInitFromBuf(&sChunk,zSrc,nLen);` |
|    73649 |  168 | `	return VmEvalChunk(&(*pVm),0,&sChunk,PH7_PHP_ONLY,FALSE);` |
|        5 |  169 | `}` |
|        - |  170 | `/*` |
...
|        - |  209 | ` */` |
|     8988 |  210 | `static int VmIsIncludedFile(ph7_vm *pVm,SyString *pFile)` |
|        3 |  211 | `{` |
|        - |  212 | `	SyString *aEntries;` |
|        - |  213 | `	sxu32 n;` |
|     8991 |  214 | `	aEntries = (SyString *)SySetBasePtr(&pVm->aIncluded);` |
|        - |  215 | `	/* Perform a linear search */` |
| 20088361 |  216 | `	for( n = 0 ; n < SySetUsed(&pVm->aIncluded) ; ++n ){` |
| 20079386 |  217 | `		if( SyStringCmp(pFile,&aEntries[n],SyMemcmp) == 0 ){` |
|        - |  218 | `			/* Already included */` |
|       16 |  219 | `			return TRUE;` |
|        - |  220 | `		}` |
| 10039687 |  221 | `	}` |
|     8977 |  222 | `	return FALSE;` |
|     4497 |  223 | `}` |
|        - |  224 | `/*` |
|        - |  225 | ` * Push a file path in the appropriate VM container.` |
|        - |  226 | ` */` |
|    12864 |  227 | `PH7_PRIVATE sxi32 PH7_VmPushFilePath(ph7_vm *pVm,const char *zPath,int nLen,sxu8 bMain,sxi32 *pNew)` |
|        5 |  228 | `{` |
|        - |  229 | `	SyString sPath;` |
|        - |  230 | `	char *zDup;` |
|        - |  231 | `	sxi32 rc;` |
|    12869 |  232 | `	if( nLen < 0 ){` |
|     3881 |  233 | `		nLen = SyStrlen(zPath);` |
|     1938 |  234 | `	}` |
|        - |  235 | `	/* Duplicate the file path first */` |
|    12869 |  236 | `	zDup = SyMemBackendStrDup(&pVm->sAllocator,zPath,nLen);` |
|    12869 |  237 | `	if( zDup == 0 ){` |
...
|        - |  246 | `	{` |
|    12864 |  247 | `		char *zReal = realpath(zDup,0); /* POSIX: malloc'd result */` |
|    12864 |  248 | `		if( zReal ){` |
|    12828 |  249 | `			sxu32 nReal = SyStrlen(zReal);` |
|    12828 |  250 | `			char *zRealDup = SyMemBackendStrDup(&pVm->sAllocator,zReal,nReal);` |
|    12828 |  251 | `			free(zReal);` |
|    12828 |  252 | `			if( zRealDup ){` |
|    12828 |  253 | `				SyMemBackendFree(&pVm->sAllocator,zDup);` |
|    12828 |  254 | `				zDup = zRealDup;` |
|    12828 |  255 | `				nLen = (int)nReal;` |
|     6414 |  256 | `			}` |
|     6414 |  257 | `		}` |
|        - |  258 | `	}` |
|        - |  259 | `#endif` |
...
|    12869 |  284 | `	SyStringInitFromBuf(&sPath,zDup,nLen);` |
|    12869 |  285 | `	if( !bMain ){` |
|     8991 |  286 | `		if( VmIsIncludedFile(&(*pVm),&sPath) ){` |
|        - |  287 | `			/* Already included */` |
|       16 |  288 | `			*pNew = 0;` |
|        9 |  289 | `		}else{` |
|        - |  290 | `			/* Insert in the corresponding container */` |
|     8977 |  291 | `			rc = SySetPut(&pVm->aIncluded,(const void *)&sPath);` |
|     8977 |  292 | `			if( rc != SXRET_OK ){` |
...
|        - |  297 | `		}` |
|     4494 |  298 | `	}` |
|    12869 |  299 | `	SySetPut(&pVm->aFiles,(const void *)&sPath);` |
|    12869 |  300 | `	return SXRET_OK;` |
|     6437 |  301 | `}` |
|        - |  302 | `/*` |
...
|        - |  313 | ` */` |
|     8994 |  314 | `static sxi32 VmExecIncludedFile(` |
...
|     8998 |  328 | `	pVm = pCtx->pVm;` |
|     8998 |  329 | `	SyBlobInit(&sContents,&pVm->sAllocator);` |
|     8998 |  330 | `	isNew = 0;` |
|        - |  331 | `	/* Extract the associated stream */` |
|     8998 |  332 | `	pStream = PH7_VmGetStreamDevice(pVm,&pPath->zString,pPath->nByte);` |
|        - |  333 | `	/*` |
|        - |  334 | `	 * Open the file or the URL [i.e: http://ph7.symisc.net/example/hello.php"]` |
|        - |  335 | `	 * in a read-only mode.` |
|        - |  336 | `	 */` |
|     8998 |  337 | `	pHandle = PH7_StreamOpenHandle(pVm,pStream,pPath->zString,PH7_IO_OPEN_RDONLY,TRUE,0,TRUE,&isNew);` |
|     8998 |  338 | `	if( pHandle == 0 ){` |
|        8 |  339 | `		return SXERR_IO;` |
|        - |  340 | `	}` |
|     8991 |  341 | `	rc = SXRET_OK; /* Stupid cc warning */` |
|     8991 |  342 | `	if( IncludeOnce && !isNew ){` |
|        - |  343 | `		/* Already included */` |
|       14 |  344 | `		rc = SXERR_EXISTS;` |
|        8 |  345 | `	}else{` |
|        - |  346 | `		/* Read the whole file contents */` |
|     8979 |  347 | `		rc = PH7_StreamReadWholeFile(pHandle,pStream,&sContents);` |
|     8979 |  348 | `		if( rc == SXRET_OK ){` |
|        - |  349 | `			SyString sScript;` |
|        - |  350 | `			/* Compile and execute the script */` |
|     8979 |  351 | `			SyStringInitFromBuf(&sScript,SyBlobData(&sContents),SyBlobLength(&sContents));` |
|     8979 |  352 | `			VmEvalChunk(pCtx->pVm,&(*pCtx),&sScript,0,TRUE);` |
|     4488 |  353 | `		}` |
|        - |  354 | `	}` |
|        - |  355 | `	/* Pop from the set of included file */` |
|     8991 |  356 | `	(void)SySetPop(&pVm->aFiles);` |
|        - |  357 | `	/* Close the handle */` |
|     8991 |  358 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|        - |  359 | `	/* Release the working buffer */` |
|     8991 |  360 | `	SyBlobRelease(&sContents);` |
|        - |  361 | `#else` |
...
|        - |  537 | ` */` |
|     8954 |  538 | `PH7_PRIVATE int vm_builtin_include(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        4 |  539 | `{` |
|        - |  540 | `	SyString sFile;` |
|        - |  541 | `	sxi32 rc;` |
|     8958 |  542 | `	if( nArg < 1 ){` |
...
|        - |  546 | `	}` |
|        - |  547 | `	/* File to include */` |
|     8958 |  548 | `	sFile.zString = ph7_value_to_string(apArg[0],(int *)&sFile.nByte);` |
|     8958 |  549 | `	if( sFile.nByte < 1 ){` |
...
|     8958 |  555 | `	rc = VmExecIncludedFile(&(*pCtx),&sFile,FALSE);` |
|     8958 |  556 | `	if( rc != SXRET_OK ){` |
