...
|        - |   20 | ` * information.` |
|        - |   21 | ` */` |
|    90626 |   22 | `PH7_PRIVATE sxi32 VmEvalChunk(` |
...
|        - |   31 | `	SyBlob sSavedNs;` |
|    90631 |   32 | `	ProcConsumer xErr = 0;` |
|    90631 |   33 | `	void *pErrData = 0;` |
|        - |   34 | `	ph7_gen_state sSavedGen;` |
|        - |   35 | `	int bNested;` |
|        - |   36 | `	/* Initialize bytecode container */` |
|    90631 |   37 | `	SySetInit(&aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|    90631 |   38 | `	SySetAlloc(&aByteCode,0x20);` |
|        - |   39 | `	/* Reset the code generator */` |
|    90631 |   40 | `	if( bTrueReturn ){` |
|        - |   41 | `		/* Included file,log compile-time errors */` |
|     9137 |   42 | `		xErr = pVm->pEngine->xConf.xErr;` |
|     9137 |   43 | `		pErrData = pVm->pEngine->xConf.pErrData;` |
|     4567 |   44 | `	}` |
...
|    90631 |   49 | `	bNested = (pVm->sCodeGen.pIn != 0);` |
|    90631 |   50 | `	if( bNested ){` |
|        5 |   51 | `		PH7_CompilerSaveState(pVm,&sSavedGen,xErr,pErrData);` |
|        3 |   52 | `	}else{` |
|    90627 |   53 | `		PH7_ResetCodeGenerator(pVm,xErr,pErrData);` |
|        - |   54 | `	}` |
...
|    90631 |   58 | `	SyBlobInit(&sSavedNs,&pVm->sAllocator);` |
|    90631 |   59 | `	SyBlobDup(&pVm->sNamespace,&sSavedNs);` |
|    90631 |   60 | `	if( bTrueReturn ){` |
|        - |   61 | `		/* Include/require: start in a fresh (global) namespace scope. */` |
|     9137 |   62 | `		SyBlobReset(&pVm->sNamespace);` |
|     4567 |   63 | `	}` |
|        - |   64 | `	/* Swap bytecode container */` |
|    90631 |   65 | `	pByteCode = pVm->pByteContainer;` |
|    90631 |   66 | `	pVm->pByteContainer = &aByteCode;` |
|        - |   67 | `	/* Compile the chunk */` |
|    90631 |   68 | `	PH7_CompileScript(pVm,pChunk,iFlags);` |
|   135943 |   69 | `	if( pVm->sCodeGen.nErr > 0 ){` |
...
|        - |   84 | `		sxi32 rc;` |
|    90629 |   85 | `		if( pVm->nMagic != PH7_VM_INIT ){` |
|     9233 |   86 | `			SyHashResetLoopCursor(&pVm->hClass);` |
|  2425023 |   87 | `			while((pEntry = SyHashGetNextEntry(&pVm->hClass)) != 0 ){` |
|  2411183 |   88 | `				pClass = (ph7_class *)pEntry->pUserData;` |
|        - |   89 | `				/* Only mount classes that haven't been mounted yet */` |
|  2411183 |   90 | `				if( !pClass->bMounted ){` |
|   245017 |   91 | `					rc = VmMountUserClass(pVm,pClass);` |
|   245017 |   92 | `					if( rc != SXRET_OK ){` |
...
|        5 |  100 | `			}` |
|     4613 |  101 | `		}` |
|    90627 |  102 | `		if( SXRET_OK != PH7_VmEmitInstr(pVm,PH7_OP_DONE,0,0,0,0) ){` |
|        - |  103 | `			/* Out of memory */` |
|      ! 0 |  104 | `			if( pCtx ){` |
...
|      ! 0 |  107 | `			goto Cleanup;` |
|        - |  108 | `		}` |
|    90627 |  109 | `		if( bTrueReturn ){` |
|        - |  110 | `			/* Assume a boolean true return value */` |
|     9137 |  111 | `			PH7_MemObjInitFromBool(pVm,&sResult,1);` |
|     4570 |  112 | `		}else{` |
...
|    90627 |  121 | `		VmLocalExec(pVm,&aByteCode,&sResult,FALSE);` |
|    90627 |  122 | `		if( pCtx ){` |
|        - |  123 | `			/* Set the execution result */` |
|     9231 |  124 | `			ph7_result_value(pCtx,&sResult);` |
|     4613 |  125 | `		}` |
|    90627 |  126 | `		PH7_MemObjRelease(&sResult);` |
|        - |  127 | `	}` |
|    45313 |  128 | `Cleanup:` |
|        - |  129 | `	/* Cleanup the mess left behind */` |
|    90631 |  130 | `	pVm->pByteContainer = pByteCode;` |
|    90631 |  131 | `	SySetRelease(&aByteCode);` |
|        - |  132 | `	/* Restore caller's namespace state */` |
|    90631 |  133 | `	SyBlobReset(&pVm->sNamespace);` |
|    90631 |  134 | `	SyBlobDup(&sSavedNs,&pVm->sNamespace);` |
|    90631 |  135 | `	SyBlobRelease(&sSavedNs);` |
|        - |  136 | `	/* Restore the outer compile's generator state if this was a nested unit. */` |
|    90631 |  137 | `	if( bNested ){` |
|        5 |  138 | `		PH7_CompilerRestoreState(pVm,&sSavedGen);` |
|        2 |  139 | `	}` |
|    90631 |  140 | `	return SXRET_OK;` |
|        5 |  141 | `}` |
|        - |  142 | `/*` |
...
|        - |  188 | ` */` |
|     9146 |  189 | `static int VmIsIncludedFile(ph7_vm *pVm,SyString *pFile)` |
|        3 |  190 | `{` |
|        - |  191 | `	SyString *aEntries;` |
|        - |  192 | `	sxu32 n;` |
|     9149 |  193 | `	aEntries = (SyString *)SySetBasePtr(&pVm->aIncluded);` |
|        - |  194 | `	/* Perform a linear search */` |
| 20802797 |  195 | `	for( n = 0 ; n < SySetUsed(&pVm->aIncluded) ; ++n ){` |
| 20793664 |  196 | `		if( SyStringCmp(pFile,&aEntries[n],SyMemcmp) == 0 ){` |
|        - |  197 | `			/* Already included */` |
|       16 |  198 | `			return TRUE;` |
|        - |  199 | `		}` |
| 10396826 |  200 | `	}` |
|     9135 |  201 | `	return FALSE;` |
|     4576 |  202 | `}` |
|        - |  203 | `/*` |
|        - |  204 | ` * Push a file path in the appropriate VM container.` |
|        - |  205 | ` */` |
|    13022 |  206 | `PH7_PRIVATE sxi32 PH7_VmPushFilePath(ph7_vm *pVm,const char *zPath,int nLen,sxu8 bMain,sxi32 *pNew)` |
|        5 |  207 | `{` |
|        - |  208 | `	SyString sPath;` |
|        - |  209 | `	char *zDup;` |
|        - |  210 | `	sxi32 rc;` |
...
|    13027 |  215 | `	zDup = SyMemBackendStrDup(&pVm->sAllocator,zPath,nLen);` |
|    13027 |  216 | `	if( zDup == 0 ){` |
...
|        - |  225 | `	{` |
|    13022 |  226 | `		char *zReal = realpath(zDup,0); /* POSIX: malloc'd result */` |
|    13022 |  227 | `		if( zReal ){` |
|    12986 |  228 | `			sxu32 nReal = SyStrlen(zReal);` |
|    12986 |  229 | `			char *zRealDup = SyMemBackendStrDup(&pVm->sAllocator,zReal,nReal);` |
|    12986 |  230 | `			free(zReal);` |
|    12986 |  231 | `			if( zRealDup ){` |
|    12986 |  232 | `				SyMemBackendFree(&pVm->sAllocator,zDup);` |
|    12986 |  233 | `				zDup = zRealDup;` |
|    12986 |  234 | `				nLen = (int)nReal;` |
|     6493 |  235 | `			}` |
|     6493 |  236 | `		}` |
|        - |  237 | `	}` |
|        - |  238 | `#endif` |
...
|    13027 |  263 | `	SyStringInitFromBuf(&sPath,zDup,nLen);` |
|    13027 |  264 | `	if( !bMain ){` |
|     9149 |  265 | `		if( VmIsIncludedFile(&(*pVm),&sPath) ){` |
|        - |  266 | `			/* Already included */` |
|       16 |  267 | `			*pNew = 0;` |
|        9 |  268 | `		}else{` |
|        - |  269 | `			/* Insert in the corresponding container */` |
|     9135 |  270 | `			rc = SySetPut(&pVm->aIncluded,(const void *)&sPath);` |
|     9135 |  271 | `			if( rc != SXRET_OK ){` |
...
|        - |  276 | `		}` |
|     4573 |  277 | `	}` |
|    13027 |  278 | `	SySetPut(&pVm->aFiles,(const void *)&sPath);` |
|    13027 |  279 | `	return SXRET_OK;` |
|     6516 |  280 | `}` |
|        - |  281 | `/*` |
...
|        - |  292 | ` */` |
|     9152 |  293 | `static sxi32 VmExecIncludedFile(` |
...
|     9155 |  307 | `	pVm = pCtx->pVm;` |
|     9155 |  308 | `	SyBlobInit(&sContents,&pVm->sAllocator);` |
|     9155 |  309 | `	isNew = 0;` |
|        - |  310 | `	/* Extract the associated stream */` |
|     9155 |  311 | `	pStream = PH7_VmGetStreamDevice(pVm,&pPath->zString,pPath->nByte);` |
|        - |  312 | `	/*` |
|        - |  313 | `	 * Open the file or the URL [i.e: http://ph7.symisc.net/example/hello.php"]` |
|        - |  314 | `	 * in a read-only mode.` |
|        - |  315 | `	 */` |
|     9155 |  316 | `	pHandle = PH7_StreamOpenHandle(pVm,pStream,pPath->zString,PH7_IO_OPEN_RDONLY,TRUE,0,TRUE,&isNew);` |
|     9155 |  317 | `	if( pHandle == 0 ){` |
|        8 |  318 | `		return SXERR_IO;` |
|        - |  319 | `	}` |
|     9149 |  320 | `	rc = SXRET_OK; /* Stupid cc warning */` |
|     9149 |  321 | `	if( IncludeOnce && !isNew ){` |
|        - |  322 | `		/* Already included */` |
|       14 |  323 | `		rc = SXERR_EXISTS;` |
|        8 |  324 | `	}else{` |
|        - |  325 | `		/* Read the whole file contents */` |
|     9137 |  326 | `		rc = PH7_StreamReadWholeFile(pHandle,pStream,&sContents);` |
|     9137 |  327 | `		if( rc == SXRET_OK ){` |
|        - |  328 | `			SyString sScript;` |
|        - |  329 | `			/* Compile and execute the script */` |
|     9137 |  330 | `			SyStringInitFromBuf(&sScript,SyBlobData(&sContents),SyBlobLength(&sContents));` |
|     9137 |  331 | `			VmEvalChunk(pCtx->pVm,&(*pCtx),&sScript,0,TRUE);` |
|     4567 |  332 | `		}` |
|        - |  333 | `	}` |
|        - |  334 | `	/* Pop from the set of included file */` |
|     9149 |  335 | `	(void)SySetPop(&pVm->aFiles);` |
|        - |  336 | `	/* Close the handle */` |
|     9149 |  337 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|        - |  338 | `	/* Release the working buffer */` |
|     9149 |  339 | `	SyBlobRelease(&sContents);` |
|        - |  340 | `#else` |
...
|        - |  516 | ` */` |
|     9112 |  517 | `PH7_PRIVATE int vm_builtin_include(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        3 |  518 | `{` |
|        - |  519 | `	SyString sFile;` |
|        - |  520 | `	sxi32 rc;` |
|     9115 |  521 | `	if( nArg < 1 ){` |
...
|        - |  525 | `	}` |
|        - |  526 | `	/* File to include */` |
|     9115 |  527 | `	sFile.zString = ph7_value_to_string(apArg[0],(int *)&sFile.nByte);` |
|     9115 |  528 | `	if( sFile.nByte < 1 ){` |
...
|     9115 |  534 | `	rc = VmExecIncludedFile(&(*pCtx),&sFile,FALSE);` |
|     9115 |  535 | `	if( rc != SXRET_OK ){` |
