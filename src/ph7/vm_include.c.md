...
|        - |   20 | ` * information.` |
|        - |   21 | ` */` |
|    90602 |   22 | `PH7_PRIVATE sxi32 VmEvalChunk(` |
...
|        - |   31 | `	SyBlob sSavedNs;` |
|    90607 |   32 | `	ProcConsumer xErr = 0;` |
|    90607 |   33 | `	void *pErrData = 0;` |
|        - |   34 | `	ph7_gen_state sSavedGen;` |
|        - |   35 | `	int bNested;` |
|    90607 |   36 | `	sxi32 rcThrow = SXRET_OK; /* status of a ParseError raised for a failed eval() compile */` |
|        - |   37 | `	/* Initialize bytecode container */` |
|    90607 |   38 | `	SySetInit(&aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|    90607 |   39 | `	SySetAlloc(&aByteCode,0x20);` |
|        - |   40 | `	/* Reset the code generator */` |
|    90607 |   41 | `	if( bTrueReturn ){` |
|        - |   42 | `		/* Included file,log compile-time errors */` |
|     9107 |   43 | `		xErr = pVm->pEngine->xConf.xErr;` |
|     9107 |   44 | `		pErrData = pVm->pEngine->xConf.pErrData;` |
|     4552 |   45 | `	}` |
...
|    90607 |   50 | `	bNested = (pVm->sCodeGen.pIn != 0);` |
|    90607 |   51 | `	if( bNested ){` |
|        5 |   52 | `		PH7_CompilerSaveState(pVm,&sSavedGen,xErr,pErrData);` |
|        3 |   53 | `	}else{` |
|    90603 |   54 | `		PH7_ResetCodeGenerator(pVm,xErr,pErrData);` |
|        - |   55 | `	}` |
...
|    90607 |   59 | `	SyBlobInit(&sSavedNs,&pVm->sAllocator);` |
|    90607 |   60 | `	SyBlobDup(&pVm->sNamespace,&sSavedNs);` |
|    90607 |   61 | `	if( bTrueReturn ){` |
|        - |   62 | `		/* Include/require: start in a fresh (global) namespace scope. */` |
|     9107 |   63 | `		SyBlobReset(&pVm->sNamespace);` |
|     4552 |   64 | `	}` |
|        - |   65 | `	/* Swap bytecode container */` |
|    90607 |   66 | `	pByteCode = pVm->pByteContainer;` |
|    90607 |   67 | `	pVm->pByteContainer = &aByteCode;` |
|        - |   68 | `	/* Compile the chunk */` |
|    90607 |   69 | `	PH7_CompileScript(pVm,pChunk,iFlags);` |
|   135907 |   70 | `	if( pVm->sCodeGen.nErr > 0 ){` |
...
|        - |   98 | `		sxi32 rc;` |
|    90603 |   99 | `		if( pVm->nMagic != PH7_VM_INIT ){` |
|     9207 |  100 | `			SyHashResetLoopCursor(&pVm->hClass);` |
|  2437398 |  101 | `			while((pEntry = SyHashGetNextEntry(&pVm->hClass)) != 0 ){` |
|  2423597 |  102 | `				pClass = (ph7_class *)pEntry->pUserData;` |
|        - |  103 | `				/* Only mount classes that haven't been mounted yet */` |
|  2423597 |  104 | `				if( !pClass->bMounted ){` |
|   244425 |  105 | `					rc = VmMountUserClass(pVm,pClass);` |
|   244425 |  106 | `					if( rc != SXRET_OK ){` |
...
|        5 |  114 | `			}` |
|     4600 |  115 | `		}` |
|    90601 |  116 | `		if( SXRET_OK != PH7_VmEmitInstr(pVm,PH7_OP_DONE,0,0,0,0) ){` |
|        - |  117 | `			/* Out of memory */` |
|      ! 0 |  118 | `			if( pCtx ){` |
...
|      ! 0 |  121 | `			goto Cleanup;` |
|        - |  122 | `		}` |
|    90601 |  123 | `		if( bTrueReturn ){` |
|        - |  124 | `			/* Assume a boolean true return value */` |
|     9107 |  125 | `			PH7_MemObjInitFromBool(pVm,&sResult,1);` |
|     4555 |  126 | `		}else{` |
...
|    90601 |  135 | `		VmLocalExec(pVm,&aByteCode,&sResult,FALSE);` |
|    90601 |  136 | `		if( pCtx ){` |
|        - |  137 | `			/* Set the execution result */` |
|     9205 |  138 | `			ph7_result_value(pCtx,&sResult);` |
|     4600 |  139 | `		}` |
|    90601 |  140 | `		PH7_MemObjRelease(&sResult);` |
|        - |  141 | `	}` |
|    45301 |  142 | `Cleanup:` |
|        - |  143 | `	/* Cleanup the mess left behind */` |
|    90607 |  144 | `	pVm->pByteContainer = pByteCode;` |
|    90607 |  145 | `	SySetRelease(&aByteCode);` |
|        - |  146 | `	/* Restore caller's namespace state */` |
|    90607 |  147 | `	SyBlobReset(&pVm->sNamespace);` |
|    90607 |  148 | `	SyBlobDup(&sSavedNs,&pVm->sNamespace);` |
|    90607 |  149 | `	SyBlobRelease(&sSavedNs);` |
|        - |  150 | `	/* Restore the outer compile's generator state if this was a nested unit. */` |
|    90607 |  151 | `	if( bNested ){` |
...
|        - |  209 | ` */` |
|     9116 |  210 | `static int VmIsIncludedFile(ph7_vm *pVm,SyString *pFile)` |
|        3 |  211 | `{` |
|        - |  212 | `	SyString *aEntries;` |
|        - |  213 | `	sxu32 n;` |
|     9119 |  214 | `	aEntries = (SyString *)SySetBasePtr(&pVm->aIncluded);` |
|        - |  215 | `	/* Perform a linear search */` |
| 20666207 |  216 | `	for( n = 0 ; n < SySetUsed(&pVm->aIncluded) ; ++n ){` |
| 20657104 |  217 | `		if( SyStringCmp(pFile,&aEntries[n],SyMemcmp) == 0 ){` |
|        - |  218 | `			/* Already included */` |
|       16 |  219 | `			return TRUE;` |
|        - |  220 | `		}` |
| 10328546 |  221 | `	}` |
|     9105 |  222 | `	return FALSE;` |
|     4561 |  223 | `}` |
|        - |  224 | `/*` |
|        - |  225 | ` * Push a file path in the appropriate VM container.` |
|        - |  226 | ` */` |
|    12992 |  227 | `PH7_PRIVATE sxi32 PH7_VmPushFilePath(ph7_vm *pVm,const char *zPath,int nLen,sxu8 bMain,sxi32 *pNew)` |
|        5 |  228 | `{` |
|        - |  229 | `	SyString sPath;` |
|        - |  230 | `	char *zDup;` |
|        - |  231 | `	sxi32 rc;` |
...
|    12997 |  236 | `	zDup = SyMemBackendStrDup(&pVm->sAllocator,zPath,nLen);` |
|    12997 |  237 | `	if( zDup == 0 ){` |
...
|        - |  246 | `	{` |
|    12992 |  247 | `		char *zReal = realpath(zDup,0); /* POSIX: malloc'd result */` |
|    12992 |  248 | `		if( zReal ){` |
|    12956 |  249 | `			sxu32 nReal = SyStrlen(zReal);` |
|    12956 |  250 | `			char *zRealDup = SyMemBackendStrDup(&pVm->sAllocator,zReal,nReal);` |
|    12956 |  251 | `			free(zReal);` |
|    12956 |  252 | `			if( zRealDup ){` |
|    12956 |  253 | `				SyMemBackendFree(&pVm->sAllocator,zDup);` |
|    12956 |  254 | `				zDup = zRealDup;` |
|    12956 |  255 | `				nLen = (int)nReal;` |
|     6478 |  256 | `			}` |
|     6478 |  257 | `		}` |
|        - |  258 | `	}` |
|        - |  259 | `#endif` |
...
|    12997 |  284 | `	SyStringInitFromBuf(&sPath,zDup,nLen);` |
|    12997 |  285 | `	if( !bMain ){` |
|     9119 |  286 | `		if( VmIsIncludedFile(&(*pVm),&sPath) ){` |
|        - |  287 | `			/* Already included */` |
|       16 |  288 | `			*pNew = 0;` |
|        9 |  289 | `		}else{` |
|        - |  290 | `			/* Insert in the corresponding container */` |
|     9105 |  291 | `			rc = SySetPut(&pVm->aIncluded,(const void *)&sPath);` |
|     9105 |  292 | `			if( rc != SXRET_OK ){` |
...
|        - |  297 | `		}` |
|     4558 |  298 | `	}` |
|    12997 |  299 | `	SySetPut(&pVm->aFiles,(const void *)&sPath);` |
|    12997 |  300 | `	return SXRET_OK;` |
|     6501 |  301 | `}` |
|        - |  302 | `/*` |
...
|        - |  313 | ` */` |
|     9122 |  314 | `static sxi32 VmExecIncludedFile(` |
...
|     9125 |  328 | `	pVm = pCtx->pVm;` |
|     9125 |  329 | `	SyBlobInit(&sContents,&pVm->sAllocator);` |
|     9125 |  330 | `	isNew = 0;` |
|        - |  331 | `	/* Extract the associated stream */` |
|     9125 |  332 | `	pStream = PH7_VmGetStreamDevice(pVm,&pPath->zString,pPath->nByte);` |
|        - |  333 | `	/*` |
|        - |  334 | `	 * Open the file or the URL [i.e: http://ph7.symisc.net/example/hello.php"]` |
|        - |  335 | `	 * in a read-only mode.` |
|        - |  336 | `	 */` |
|     9125 |  337 | `	pHandle = PH7_StreamOpenHandle(pVm,pStream,pPath->zString,PH7_IO_OPEN_RDONLY,TRUE,0,TRUE,&isNew);` |
|     9125 |  338 | `	if( pHandle == 0 ){` |
|        8 |  339 | `		return SXERR_IO;` |
|        - |  340 | `	}` |
|     9119 |  341 | `	rc = SXRET_OK; /* Stupid cc warning */` |
|     9119 |  342 | `	if( IncludeOnce && !isNew ){` |
|        - |  343 | `		/* Already included */` |
|       14 |  344 | `		rc = SXERR_EXISTS;` |
|        8 |  345 | `	}else{` |
|        - |  346 | `		/* Read the whole file contents */` |
|     9107 |  347 | `		rc = PH7_StreamReadWholeFile(pHandle,pStream,&sContents);` |
|     9107 |  348 | `		if( rc == SXRET_OK ){` |
|        - |  349 | `			SyString sScript;` |
|        - |  350 | `			/* Compile and execute the script */` |
|     9107 |  351 | `			SyStringInitFromBuf(&sScript,SyBlobData(&sContents),SyBlobLength(&sContents));` |
|     9107 |  352 | `			VmEvalChunk(pCtx->pVm,&(*pCtx),&sScript,0,TRUE);` |
|     4552 |  353 | `		}` |
|        - |  354 | `	}` |
|        - |  355 | `	/* Pop from the set of included file */` |
|     9119 |  356 | `	(void)SySetPop(&pVm->aFiles);` |
|        - |  357 | `	/* Close the handle */` |
|     9119 |  358 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|        - |  359 | `	/* Release the working buffer */` |
|     9119 |  360 | `	SyBlobRelease(&sContents);` |
|        - |  361 | `#else` |
...
|        - |  537 | ` */` |
|     9082 |  538 | `PH7_PRIVATE int vm_builtin_include(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        3 |  539 | `{` |
|        - |  540 | `	SyString sFile;` |
|        - |  541 | `	sxi32 rc;` |
|     9085 |  542 | `	if( nArg < 1 ){` |
...
|        - |  546 | `	}` |
|        - |  547 | `	/* File to include */` |
|     9085 |  548 | `	sFile.zString = ph7_value_to_string(apArg[0],(int *)&sFile.nByte);` |
|     9085 |  549 | `	if( sFile.nByte < 1 ){` |
...
|     9085 |  555 | `	rc = VmExecIncludedFile(&(*pCtx),&sFile,FALSE);` |
|     9085 |  556 | `	if( rc != SXRET_OK ){` |
