...
|        - |   20 | ` * information.` |
|        - |   21 | ` */` |
|    90634 |   22 | `PH7_PRIVATE sxi32 VmEvalChunk(` |
...
|        - |   31 | `	SyBlob sSavedNs;` |
|    90639 |   32 | `	ProcConsumer xErr = 0;` |
|    90639 |   33 | `	void *pErrData = 0;` |
|        - |   34 | `	ph7_gen_state sSavedGen;` |
|        - |   35 | `	int bNested;` |
|        - |   36 | `	/* Initialize bytecode container */` |
|    90639 |   37 | `	SySetInit(&aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|    90639 |   38 | `	SySetAlloc(&aByteCode,0x20);` |
|        - |   39 | `	/* Reset the code generator */` |
|    90639 |   40 | `	if( bTrueReturn ){` |
...
|    90639 |   49 | `	bNested = (pVm->sCodeGen.pIn != 0);` |
|    90639 |   50 | `	if( bNested ){` |
|        5 |   51 | `		PH7_CompilerSaveState(pVm,&sSavedGen,xErr,pErrData);` |
|        3 |   52 | `	}else{` |
|    90635 |   53 | `		PH7_ResetCodeGenerator(pVm,xErr,pErrData);` |
|        - |   54 | `	}` |
...
|    90639 |   58 | `	SyBlobInit(&sSavedNs,&pVm->sAllocator);` |
|    90639 |   59 | `	SyBlobDup(&pVm->sNamespace,&sSavedNs);` |
|    90639 |   60 | `	if( bTrueReturn ){` |
|        - |   61 | `		/* Include/require: start in a fresh (global) namespace scope. */` |
|     9145 |   62 | `		SyBlobReset(&pVm->sNamespace);` |
|     4571 |   63 | `	}` |
|        - |   64 | `	/* Swap bytecode container */` |
|    90639 |   65 | `	pByteCode = pVm->pByteContainer;` |
|    90639 |   66 | `	pVm->pByteContainer = &aByteCode;` |
|        - |   67 | `	/* Compile the chunk */` |
|    90639 |   68 | `	PH7_CompileScript(pVm,pChunk,iFlags);` |
|   135955 |   69 | `	if( pVm->sCodeGen.nErr > 0 ){` |
...
|        - |   84 | `		sxi32 rc;` |
|    90637 |   85 | `		if( pVm->nMagic != PH7_VM_INIT ){` |
...
|        5 |  100 | `			}` |
|     4617 |  101 | `		}` |
|    90635 |  102 | `		if( SXRET_OK != PH7_VmEmitInstr(pVm,PH7_OP_DONE,0,0,0,0) ){` |
|        - |  103 | `			/* Out of memory */` |
|      ! 0 |  104 | `			if( pCtx ){` |
...
|    90635 |  121 | `		VmLocalExec(pVm,&aByteCode,&sResult,FALSE);` |
|    90635 |  122 | `		if( pCtx ){` |
|        - |  123 | `			/* Set the execution result */` |
|     9239 |  124 | `			ph7_result_value(pCtx,&sResult);` |
|     4617 |  125 | `		}` |
|    90635 |  126 | `		PH7_MemObjRelease(&sResult);` |
|        - |  127 | `	}` |
|    45317 |  128 | `Cleanup:` |
|        - |  129 | `	/* Cleanup the mess left behind */` |
|    90639 |  130 | `	pVm->pByteContainer = pByteCode;` |
|    90639 |  131 | `	SySetRelease(&aByteCode);` |
|        - |  132 | `	/* Restore caller's namespace state */` |
|    90639 |  133 | `	SyBlobReset(&pVm->sNamespace);` |
|    90639 |  134 | `	SyBlobDup(&sSavedNs,&pVm->sNamespace);` |
|    90639 |  135 | `	SyBlobRelease(&sSavedNs);` |
|        - |  136 | `	/* Restore the outer compile's generator state if this was a nested unit. */` |
|    90639 |  137 | `	if( bNested ){` |
|        5 |  138 | `		PH7_CompilerRestoreState(pVm,&sSavedGen);` |
|        2 |  139 | `	}` |
|    90639 |  140 | `	return SXRET_OK;` |
|        5 |  141 | `}` |
|        - |  142 | `/*` |
...
|        - |  146 | ` */` |
|    73644 |  147 | `PH7_PRIVATE sxi32 PH7_VmEvalBuiltinChunk(ph7_vm *pVm,const char *zSrc,sxu32 nLen)` |
|        5 |  148 | `{` |
|        - |  149 | `	SyString sChunk;` |
|    73649 |  150 | `	SyStringInitFromBuf(&sChunk,zSrc,nLen);` |
|    73649 |  151 | `	return VmEvalChunk(&(*pVm),0,&sChunk,PH7_PHP_ONLY,FALSE);` |
|        5 |  152 | `}` |
|        - |  153 | `/*` |
...
|        - |  205 | ` */` |
|    13030 |  206 | `PH7_PRIVATE sxi32 PH7_VmPushFilePath(ph7_vm *pVm,const char *zPath,int nLen,sxu8 bMain,sxi32 *pNew)` |
|        5 |  207 | `{` |
|        - |  208 | `	SyString sPath;` |
|        - |  209 | `	char *zDup;` |
|        - |  210 | `	sxi32 rc;` |
|    13035 |  211 | `	if( nLen < 0 ){` |
|     3881 |  212 | `		nLen = SyStrlen(zPath);` |
|     1938 |  213 | `	}` |
|        - |  214 | `	/* Duplicate the file path first */` |
|    13035 |  215 | `	zDup = SyMemBackendStrDup(&pVm->sAllocator,zPath,nLen);` |
|    13035 |  216 | `	if( zDup == 0 ){` |
...
|        - |  225 | `	{` |
|    13030 |  226 | `		char *zReal = realpath(zDup,0); /* POSIX: malloc'd result */` |
|    13030 |  227 | `		if( zReal ){` |
|    12994 |  228 | `			sxu32 nReal = SyStrlen(zReal);` |
|    12994 |  229 | `			char *zRealDup = SyMemBackendStrDup(&pVm->sAllocator,zReal,nReal);` |
|    12994 |  230 | `			free(zReal);` |
|    12994 |  231 | `			if( zRealDup ){` |
|    12994 |  232 | `				SyMemBackendFree(&pVm->sAllocator,zDup);` |
|    12994 |  233 | `				zDup = zRealDup;` |
|    12994 |  234 | `				nLen = (int)nReal;` |
|     6497 |  235 | `			}` |
|     6497 |  236 | `		}` |
|        - |  237 | `	}` |
|        - |  238 | `#endif` |
...
|    13035 |  263 | `	SyStringInitFromBuf(&sPath,zDup,nLen);` |
|    13035 |  264 | `	if( !bMain ){` |
...
|        - |  276 | `		}` |
|     4577 |  277 | `	}` |
|    13035 |  278 | `	SySetPut(&pVm->aFiles,(const void *)&sPath);` |
|    13035 |  279 | `	return SXRET_OK;` |
|     6520 |  280 | `}` |
|        - |  281 | `/*` |
