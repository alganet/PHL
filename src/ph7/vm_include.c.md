...
|        - |   20 | ` * information.` |
|        - |   21 | ` */` |
|    90304 |   22 | `PH7_PRIVATE sxi32 VmEvalChunk(` |
...
|        - |   31 | `	SyBlob sSavedNs;` |
|    90309 |   32 | `	ProcConsumer xErr = 0;` |
|    90309 |   33 | `	void *pErrData = 0;` |
|        - |   34 | `	ph7_gen_state sSavedGen;` |
|        - |   35 | `	int bNested;` |
|    90309 |   36 | `	sxi32 rcThrow = SXRET_OK; /* status of a ParseError raised for a failed eval() compile */` |
|        - |   37 | `	/* Initialize bytecode container */` |
|    90309 |   38 | `	SySetInit(&aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|    90309 |   39 | `	SySetAlloc(&aByteCode,0x20);` |
|        - |   40 | `	/* Reset the code generator */` |
|    90309 |   41 | `	if( bTrueReturn ){` |
...
|    90309 |   50 | `	bNested = (pVm->sCodeGen.pIn != 0);` |
|    90309 |   51 | `	if( bNested ){` |
|        5 |   52 | `		PH7_CompilerSaveState(pVm,&sSavedGen,xErr,pErrData);` |
|        3 |   53 | `	}else{` |
|    90305 |   54 | `		PH7_ResetCodeGenerator(pVm,xErr,pErrData);` |
|        - |   55 | `	}` |
...
|    90309 |   59 | `	SyBlobInit(&sSavedNs,&pVm->sAllocator);` |
|    90309 |   60 | `	SyBlobDup(&pVm->sNamespace,&sSavedNs);` |
|    90309 |   61 | `	if( bTrueReturn ){` |
|        - |   62 | `		/* Include/require: start in a fresh (global) namespace scope. */` |
|     8978 |   63 | `		SyBlobReset(&pVm->sNamespace);` |
|     4487 |   64 | `	}` |
|        - |   65 | `	/* Swap bytecode container */` |
|    90309 |   66 | `	pByteCode = pVm->pByteContainer;` |
|    90309 |   67 | `	pVm->pByteContainer = &aByteCode;` |
|        - |   68 | `	/* Compile the chunk */` |
|    90309 |   69 | `	PH7_CompileScript(pVm,pChunk,iFlags);` |
|   135460 |   70 | `	if( pVm->sCodeGen.nErr > 0 ){` |
...
|        - |   98 | `		sxi32 rc;` |
|    90305 |   99 | `		if( pVm->nMagic != PH7_VM_INIT ){` |
...
|        5 |  114 | `			}` |
|     4535 |  115 | `		}` |
|    90303 |  116 | `		if( SXRET_OK != PH7_VmEmitInstr(pVm,PH7_OP_DONE,0,0,0,0) ){` |
|        - |  117 | `			/* Out of memory */` |
|      ! 0 |  118 | `			if( pCtx ){` |
...
|    90303 |  135 | `		VmLocalExec(pVm,&aByteCode,&sResult,FALSE);` |
|    90303 |  136 | `		if( pCtx ){` |
|        - |  137 | `			/* Set the execution result */` |
|     9075 |  138 | `			ph7_result_value(pCtx,&sResult);` |
|     4535 |  139 | `		}` |
|    90303 |  140 | `		PH7_MemObjRelease(&sResult);` |
|        - |  141 | `	}` |
|    45152 |  142 | `Cleanup:` |
|        - |  143 | `	/* Cleanup the mess left behind */` |
|    90309 |  144 | `	pVm->pByteContainer = pByteCode;` |
|    90309 |  145 | `	SySetRelease(&aByteCode);` |
|        - |  146 | `	/* Restore caller's namespace state */` |
|    90309 |  147 | `	SyBlobReset(&pVm->sNamespace);` |
|    90309 |  148 | `	SyBlobDup(&sSavedNs,&pVm->sNamespace);` |
|    90309 |  149 | `	SyBlobRelease(&sSavedNs);` |
|        - |  150 | `	/* Restore the outer compile's generator state if this was a nested unit. */` |
|    90309 |  151 | `	if( bNested ){` |
...
|        - |  163 | ` */` |
|    73492 |  164 | `PH7_PRIVATE sxi32 PH7_VmEvalBuiltinChunk(ph7_vm *pVm,const char *zSrc,sxu32 nLen)` |
|        5 |  165 | `{` |
|        - |  166 | `	SyString sChunk;` |
|    73497 |  167 | `	SyStringInitFromBuf(&sChunk,zSrc,nLen);` |
|    73497 |  168 | `	return VmEvalChunk(&(*pVm),0,&sChunk,PH7_PHP_ONLY,FALSE);` |
|        5 |  169 | `}` |
|        - |  170 | `/*` |
...
|        - |  226 | ` */` |
|    12854 |  227 | `PH7_PRIVATE sxi32 PH7_VmPushFilePath(ph7_vm *pVm,const char *zPath,int nLen,sxu8 bMain,sxi32 *pNew)` |
|        5 |  228 | `{` |
|        - |  229 | `	SyString sPath;` |
|        - |  230 | `	char *zDup;` |
|        - |  231 | `	sxi32 rc;` |
|    12859 |  232 | `	if( nLen < 0 ){` |
|     3873 |  233 | `		nLen = SyStrlen(zPath);` |
|     1934 |  234 | `	}` |
|        - |  235 | `	/* Duplicate the file path first */` |
|    12859 |  236 | `	zDup = SyMemBackendStrDup(&pVm->sAllocator,zPath,nLen);` |
|    12859 |  237 | `	if( zDup == 0 ){` |
...
|        - |  246 | `	{` |
|    12854 |  247 | `		char *zReal = realpath(zDup,0); /* POSIX: malloc'd result */` |
|    12854 |  248 | `		if( zReal ){` |
|    12818 |  249 | `			sxu32 nReal = SyStrlen(zReal);` |
|    12818 |  250 | `			char *zRealDup = SyMemBackendStrDup(&pVm->sAllocator,zReal,nReal);` |
|    12818 |  251 | `			free(zReal);` |
|    12818 |  252 | `			if( zRealDup ){` |
|    12818 |  253 | `				SyMemBackendFree(&pVm->sAllocator,zDup);` |
|    12818 |  254 | `				zDup = zRealDup;` |
|    12818 |  255 | `				nLen = (int)nReal;` |
|     6409 |  256 | `			}` |
|     6409 |  257 | `		}` |
|        - |  258 | `	}` |
|        - |  259 | `#endif` |
...
|    12859 |  284 | `	SyStringInitFromBuf(&sPath,zDup,nLen);` |
|    12859 |  285 | `	if( !bMain ){` |
...
|        - |  297 | `		}` |
|     4493 |  298 | `	}` |
|    12859 |  299 | `	SySetPut(&pVm->aFiles,(const void *)&sPath);` |
|    12859 |  300 | `	return SXRET_OK;` |
|     6432 |  301 | `}` |
|        - |  302 | `/*` |
