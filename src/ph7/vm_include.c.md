...
|        - |   20 | ` * information.` |
|        - |   21 | ` */` |
|    91008 |   22 | `PH7_PRIVATE sxi32 VmEvalChunk(` |
...
|        - |   31 | `	SyBlob sSavedNs;` |
|    91013 |   32 | `	ProcConsumer xErr = 0;` |
|    91013 |   33 | `	void *pErrData = 0;` |
|        - |   34 | `	ph7_gen_state sSavedGen;` |
|        - |   35 | `	int bNested;` |
|    91013 |   36 | `	sxi32 rcThrow = SXRET_OK; /* status of a ParseError raised for a failed eval() compile */` |
|        - |   37 | `	/* Initialize bytecode container */` |
|    91013 |   38 | `	SySetInit(&aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|    91013 |   39 | `	SySetAlloc(&aByteCode,0x20);` |
|        - |   40 | `	/* Reset the code generator */` |
|    91013 |   41 | `	if( bTrueReturn ){` |
...
|    91013 |   50 | `	bNested = (pVm->sCodeGen.pIn != 0);` |
|    91013 |   51 | `	if( bNested ){` |
|        5 |   52 | `		PH7_CompilerSaveState(pVm,&sSavedGen,xErr,pErrData);` |
|        3 |   53 | `	}else{` |
|    91009 |   54 | `		PH7_ResetCodeGenerator(pVm,xErr,pErrData);` |
|        - |   55 | `	}` |
...
|    91013 |   59 | `	SyBlobInit(&sSavedNs,&pVm->sAllocator);` |
|    91013 |   60 | `	SyBlobDup(&pVm->sNamespace,&sSavedNs);` |
|    91013 |   61 | `	if( bTrueReturn ){` |
|        - |   62 | `		/* Include/require: start in a fresh (global) namespace scope. */` |
|     9052 |   63 | `		SyBlobReset(&pVm->sNamespace);` |
|     4524 |   64 | `	}` |
|        - |   65 | `	/* Swap bytecode container */` |
|    91013 |   66 | `	pByteCode = pVm->pByteContainer;` |
|    91013 |   67 | `	pVm->pByteContainer = &aByteCode;` |
|        - |   68 | `	/* Compile the chunk */` |
|    91013 |   69 | `	PH7_CompileScript(pVm,pChunk,iFlags);` |
|   136516 |   70 | `	if( pVm->sCodeGen.nErr > 0 ){` |
...
|        - |   98 | `		sxi32 rc;` |
|    91009 |   99 | `		if( pVm->nMagic != PH7_VM_INIT ){` |
...
|        5 |  114 | `			}` |
|     4572 |  115 | `		}` |
|    91007 |  116 | `		if( SXRET_OK != PH7_VmEmitInstr(pVm,PH7_OP_DONE,0,0,0,0) ){` |
|        - |  117 | `			/* Out of memory */` |
|      ! 0 |  118 | `			if( pCtx ){` |
...
|    91007 |  135 | `		VmLocalExec(pVm,&aByteCode,&sResult,FALSE);` |
|    91007 |  136 | `		if( pCtx ){` |
|        - |  137 | `			/* Set the execution result */` |
|     9149 |  138 | `			ph7_result_value(pCtx,&sResult);` |
|     4572 |  139 | `		}` |
|    91007 |  140 | `		PH7_MemObjRelease(&sResult);` |
|        - |  141 | `	}` |
|    45504 |  142 | `Cleanup:` |
|        - |  143 | `	/* Cleanup the mess left behind */` |
|    91013 |  144 | `	pVm->pByteContainer = pByteCode;` |
|    91013 |  145 | `	SySetRelease(&aByteCode);` |
|        - |  146 | `	/* Restore caller's namespace state */` |
|    91013 |  147 | `	SyBlobReset(&pVm->sNamespace);` |
|    91013 |  148 | `	SyBlobDup(&sSavedNs,&pVm->sNamespace);` |
|    91013 |  149 | `	SyBlobRelease(&sSavedNs);` |
|        - |  150 | `	/* Restore the outer compile's generator state if this was a nested unit. */` |
|    91013 |  151 | `	if( bNested ){` |
