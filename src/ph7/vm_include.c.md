...
|        - |   20 | ` * information.` |
|        - |   21 | ` */` |
|    90724 |   22 | `PH7_PRIVATE sxi32 VmEvalChunk(` |
...
|        - |   31 | `	SyBlob sSavedNs;` |
|    90729 |   32 | `	ProcConsumer xErr = 0;` |
|    90729 |   33 | `	void *pErrData = 0;` |
|        - |   34 | `	ph7_gen_state sSavedGen;` |
|        - |   35 | `	int bNested;` |
|        - |   36 | `	/* Initialize bytecode container */` |
|    90729 |   37 | `	SySetInit(&aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|    90729 |   38 | `	SySetAlloc(&aByteCode,0x20);` |
|        - |   39 | `	/* Reset the code generator */` |
|    90729 |   40 | `	if( bTrueReturn ){` |
|        - |   41 | `		/* Included file,log compile-time errors */` |
|     9152 |   42 | `		xErr = pVm->pEngine->xConf.xErr;` |
|     9152 |   43 | `		pErrData = pVm->pEngine->xConf.pErrData;` |
|     4574 |   44 | `	}` |
...
|    90729 |   49 | `	bNested = (pVm->sCodeGen.pIn != 0);` |
|    90729 |   50 | `	if( bNested ){` |
|        5 |   51 | `		PH7_CompilerSaveState(pVm,&sSavedGen,xErr,pErrData);` |
|        3 |   52 | `	}else{` |
|    90725 |   53 | `		PH7_ResetCodeGenerator(pVm,xErr,pErrData);` |
|        - |   54 | `	}` |
...
|    90729 |   58 | `	SyBlobInit(&sSavedNs,&pVm->sAllocator);` |
|    90729 |   59 | `	SyBlobDup(&pVm->sNamespace,&sSavedNs);` |
|    90729 |   60 | `	if( bTrueReturn ){` |
|        - |   61 | `		/* Include/require: start in a fresh (global) namespace scope. */` |
|     9152 |   62 | `		SyBlobReset(&pVm->sNamespace);` |
|     4574 |   63 | `	}` |
|        - |   64 | `	/* Swap bytecode container */` |
|    90729 |   65 | `	pByteCode = pVm->pByteContainer;` |
|    90729 |   66 | `	pVm->pByteContainer = &aByteCode;` |
|        - |   67 | `	/* Compile the chunk */` |
|    90729 |   68 | `	PH7_CompileScript(pVm,pChunk,iFlags);` |
|   136090 |   69 | `	if( pVm->sCodeGen.nErr > 0 ){` |
...
|        - |   84 | `		sxi32 rc;` |
|    90727 |   85 | `		if( pVm->nMagic != PH7_VM_INIT ){` |
...
|        5 |  100 | `			}` |
|     4620 |  101 | `		}` |
|    90725 |  102 | `		if( SXRET_OK != PH7_VmEmitInstr(pVm,PH7_OP_DONE,0,0,0,0) ){` |
|        - |  103 | `			/* Out of memory */` |
|      ! 0 |  104 | `			if( pCtx ){` |
...
|      ! 0 |  107 | `			goto Cleanup;` |
|        - |  108 | `		}` |
|    90725 |  109 | `		if( bTrueReturn ){` |
|        - |  110 | `			/* Assume a boolean true return value */` |
|     9152 |  111 | `			PH7_MemObjInitFromBool(pVm,&sResult,1);` |
|     4578 |  112 | `		}else{` |
...
|    90725 |  121 | `		VmLocalExec(pVm,&aByteCode,&sResult,FALSE);` |
|    90725 |  122 | `		if( pCtx ){` |
|        - |  123 | `			/* Set the execution result */` |
|     9245 |  124 | `			ph7_result_value(pCtx,&sResult);` |
|     4620 |  125 | `		}` |
|    90725 |  126 | `		PH7_MemObjRelease(&sResult);` |
|        - |  127 | `	}` |
|    45362 |  128 | `Cleanup:` |
|        - |  129 | `	/* Cleanup the mess left behind */` |
|    90729 |  130 | `	pVm->pByteContainer = pByteCode;` |
|    90729 |  131 | `	SySetRelease(&aByteCode);` |
|        - |  132 | `	/* Restore caller's namespace state */` |
|    90729 |  133 | `	SyBlobReset(&pVm->sNamespace);` |
|    90729 |  134 | `	SyBlobDup(&sSavedNs,&pVm->sNamespace);` |
|    90729 |  135 | `	SyBlobRelease(&sSavedNs);` |
|        - |  136 | `	/* Restore the outer compile's generator state if this was a nested unit. */` |
|    90729 |  137 | `	if( bNested ){` |
|        5 |  138 | `		PH7_CompilerRestoreState(pVm,&sSavedGen);` |
|        2 |  139 | `	}` |
|    90729 |  140 | `	return SXRET_OK;` |
|        5 |  141 | `}` |
|        - |  142 | `/*` |
...
|        - |  192 | `	sxu32 n;` |
|     9164 |  193 | `	aEntries = (SyString *)SySetBasePtr(&pVm->aIncluded);` |
|        - |  194 | `	/* Perform a linear search */` |
| 20866700 |  195 | `	for( n = 0 ; n < SySetUsed(&pVm->aIncluded) ; ++n ){` |
| 20857552 |  196 | `		if( SyStringCmp(pFile,&aEntries[n],SyMemcmp) == 0 ){` |
|        - |  197 | `			/* Already included */` |
|       16 |  198 | `			return TRUE;` |
|        - |  199 | `		}` |
| 10428770 |  200 | `	}` |
|     9150 |  201 | `	return FALSE;` |
|     4584 |  202 | `}` |
|        - |  203 | `/*` |
|        - |  204 | ` * Push a file path in the appropriate VM container.` |
|        - |  205 | ` */` |
|    13040 |  206 | `PH7_PRIVATE sxi32 PH7_VmPushFilePath(ph7_vm *pVm,const char *zPath,int nLen,sxu8 bMain,sxi32 *pNew)` |
|        5 |  207 | `{` |
|        - |  208 | `	SyString sPath;` |
|        - |  209 | `	char *zDup;` |
|        - |  210 | `	sxi32 rc;` |
...
|    13045 |  215 | `	zDup = SyMemBackendStrDup(&pVm->sAllocator,zPath,nLen);` |
|    13045 |  216 | `	if( zDup == 0 ){` |
...
|        - |  225 | `	{` |
|    13040 |  226 | `		char *zReal = realpath(zDup,0); /* POSIX: malloc'd result */` |
|    13040 |  227 | `		if( zReal ){` |
|    13004 |  228 | `			sxu32 nReal = SyStrlen(zReal);` |
|    13004 |  229 | `			char *zRealDup = SyMemBackendStrDup(&pVm->sAllocator,zReal,nReal);` |
|    13004 |  230 | `			free(zReal);` |
|    13004 |  231 | `			if( zRealDup ){` |
|    13004 |  232 | `				SyMemBackendFree(&pVm->sAllocator,zDup);` |
|    13004 |  233 | `				zDup = zRealDup;` |
|    13004 |  234 | `				nLen = (int)nReal;` |
|     6502 |  235 | `			}` |
|     6502 |  236 | `		}` |
|        - |  237 | `	}` |
|        - |  238 | `#endif` |
...
|    13045 |  263 | `	SyStringInitFromBuf(&sPath,zDup,nLen);` |
|    13045 |  264 | `	if( !bMain ){` |
|     9164 |  265 | `		if( VmIsIncludedFile(&(*pVm),&sPath) ){` |
|        - |  266 | `			/* Already included */` |
|       16 |  267 | `			*pNew = 0;` |
|        9 |  268 | `		}else{` |
|        - |  269 | `			/* Insert in the corresponding container */` |
|     9150 |  270 | `			rc = SySetPut(&pVm->aIncluded,(const void *)&sPath);` |
|     9150 |  271 | `			if( rc != SXRET_OK ){` |
...
|        - |  276 | `		}` |
|     4580 |  277 | `	}` |
|    13045 |  278 | `	SySetPut(&pVm->aFiles,(const void *)&sPath);` |
|    13045 |  279 | `	return SXRET_OK;` |
|     6525 |  280 | `}` |
|        - |  281 | `/*` |
...
|     9171 |  307 | `	pVm = pCtx->pVm;` |
|     9171 |  308 | `	SyBlobInit(&sContents,&pVm->sAllocator);` |
|     9171 |  309 | `	isNew = 0;` |
|        - |  310 | `	/* Extract the associated stream */` |
|     9171 |  311 | `	pStream = PH7_VmGetStreamDevice(pVm,&pPath->zString,pPath->nByte);` |
|        - |  312 | `	/*` |
|        - |  313 | `	 * Open the file or the URL [i.e: http://ph7.symisc.net/example/hello.php"]` |
|        - |  314 | `	 * in a read-only mode.` |
|        - |  315 | `	 */` |
|     9171 |  316 | `	pHandle = PH7_StreamOpenHandle(pVm,pStream,pPath->zString,PH7_IO_OPEN_RDONLY,TRUE,0,TRUE,&isNew);` |
|     9171 |  317 | `	if( pHandle == 0 ){` |
|        8 |  318 | `		return SXERR_IO;` |
|        - |  319 | `	}` |
|     9164 |  320 | `	rc = SXRET_OK; /* Stupid cc warning */` |
|     9164 |  321 | `	if( IncludeOnce && !isNew ){` |
|        - |  322 | `		/* Already included */` |
|       14 |  323 | `		rc = SXERR_EXISTS;` |
|        8 |  324 | `	}else{` |
|        - |  325 | `		/* Read the whole file contents */` |
|     9152 |  326 | `		rc = PH7_StreamReadWholeFile(pHandle,pStream,&sContents);` |
|     9152 |  327 | `		if( rc == SXRET_OK ){` |
|        - |  328 | `			SyString sScript;` |
|        - |  329 | `			/* Compile and execute the script */` |
|     9152 |  330 | `			SyStringInitFromBuf(&sScript,SyBlobData(&sContents),SyBlobLength(&sContents));` |
|     9152 |  331 | `			VmEvalChunk(pCtx->pVm,&(*pCtx),&sScript,0,TRUE);` |
|     4574 |  332 | `		}` |
|        - |  333 | `	}` |
|        - |  334 | `	/* Pop from the set of included file */` |
|     9164 |  335 | `	(void)SySetPop(&pVm->aFiles);` |
|        - |  336 | `	/* Close the handle */` |
|     9164 |  337 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|        - |  338 | `	/* Release the working buffer */` |
|     9164 |  339 | `	SyBlobRelease(&sContents);` |
|        - |  340 | `#else` |
...
|        - |  525 | `	}` |
|        - |  526 | `	/* File to include */` |
|     9130 |  527 | `	sFile.zString = ph7_value_to_string(apArg[0],(int *)&sFile.nByte);` |
|     9130 |  528 | `	if( sFile.nByte < 1 ){` |
...
|     9130 |  534 | `	rc = VmExecIncludedFile(&(*pCtx),&sFile,FALSE);` |
|     9130 |  535 | `	if( rc != SXRET_OK ){` |
...
|        1 |  539 | `	}` |
|     9130 |  540 | `	if( pCtx->pVm->bHaltRequested ){` |
