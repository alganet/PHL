...
|        - |   20 | ` * information.` |
|        - |   21 | ` */` |
|    90770 |   22 | `PH7_PRIVATE sxi32 VmEvalChunk(` |
...
|        - |   31 | `	SyBlob sSavedNs;` |
|    90775 |   32 | `	ProcConsumer xErr = 0;` |
|    90775 |   33 | `	void *pErrData = 0;` |
|        - |   34 | `	ph7_gen_state sSavedGen;` |
|        - |   35 | `	int bNested;` |
|        - |   36 | `	/* Initialize bytecode container */` |
|    90775 |   37 | `	SySetInit(&aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|    90775 |   38 | `	SySetAlloc(&aByteCode,0x20);` |
|        - |   39 | `	/* Reset the code generator */` |
|    90775 |   40 | `	if( bTrueReturn ){` |
|        - |   41 | `		/* Included file,log compile-time errors */` |
|     9156 |   42 | `		xErr = pVm->pEngine->xConf.xErr;` |
|     9156 |   43 | `		pErrData = pVm->pEngine->xConf.pErrData;` |
|     4576 |   44 | `	}` |
...
|    90775 |   49 | `	bNested = (pVm->sCodeGen.pIn != 0);` |
|    90775 |   50 | `	if( bNested ){` |
|        5 |   51 | `		PH7_CompilerSaveState(pVm,&sSavedGen,xErr,pErrData);` |
|        3 |   52 | `	}else{` |
|    90771 |   53 | `		PH7_ResetCodeGenerator(pVm,xErr,pErrData);` |
|        - |   54 | `	}` |
...
|    90775 |   58 | `	SyBlobInit(&sSavedNs,&pVm->sAllocator);` |
|    90775 |   59 | `	SyBlobDup(&pVm->sNamespace,&sSavedNs);` |
|    90775 |   60 | `	if( bTrueReturn ){` |
|        - |   61 | `		/* Include/require: start in a fresh (global) namespace scope. */` |
|     9156 |   62 | `		SyBlobReset(&pVm->sNamespace);` |
|     4576 |   63 | `	}` |
|        - |   64 | `	/* Swap bytecode container */` |
|    90775 |   65 | `	pByteCode = pVm->pByteContainer;` |
|    90775 |   66 | `	pVm->pByteContainer = &aByteCode;` |
|        - |   67 | `	/* Compile the chunk */` |
|    90775 |   68 | `	PH7_CompileScript(pVm,pChunk,iFlags);` |
|   136159 |   69 | `	if( pVm->sCodeGen.nErr > 0 ){` |
...
|        - |   84 | `		sxi32 rc;` |
|    90773 |   85 | `		if( pVm->nMagic != PH7_VM_INIT ){` |
|     9251 |   86 | `			SyHashResetLoopCursor(&pVm->hClass);` |
|  2429878 |   87 | `			while((pEntry = SyHashGetNextEntry(&pVm->hClass)) != 0 ){` |
|  2416011 |   88 | `				pClass = (ph7_class *)pEntry->pUserData;` |
|        - |   89 | `				/* Only mount classes that haven't been mounted yet */` |
|  2416011 |   90 | `				if( !pClass->bMounted ){` |
...
|        5 |  100 | `			}` |
|     4622 |  101 | `		}` |
|    90771 |  102 | `		if( SXRET_OK != PH7_VmEmitInstr(pVm,PH7_OP_DONE,0,0,0,0) ){` |
|        - |  103 | `			/* Out of memory */` |
|      ! 0 |  104 | `			if( pCtx ){` |
...
|      ! 0 |  107 | `			goto Cleanup;` |
|        - |  108 | `		}` |
|    90771 |  109 | `		if( bTrueReturn ){` |
|        - |  110 | `			/* Assume a boolean true return value */` |
|     9156 |  111 | `			PH7_MemObjInitFromBool(pVm,&sResult,1);` |
|     4580 |  112 | `		}else{` |
|        - |  113 | `			/* Assume a null return value */` |
|    81619 |  114 | `			PH7_MemObjInit(pVm,&sResult);` |
|        - |  115 | `		}` |
...
|    90771 |  121 | `		VmLocalExec(pVm,&aByteCode,&sResult,FALSE);` |
|    90771 |  122 | `		if( pCtx ){` |
|        - |  123 | `			/* Set the execution result */` |
|     9249 |  124 | `			ph7_result_value(pCtx,&sResult);` |
|     4622 |  125 | `		}` |
|    90771 |  126 | `		PH7_MemObjRelease(&sResult);` |
|        - |  127 | `	}` |
|    45385 |  128 | `Cleanup:` |
|        - |  129 | `	/* Cleanup the mess left behind */` |
|    90775 |  130 | `	pVm->pByteContainer = pByteCode;` |
|    90775 |  131 | `	SySetRelease(&aByteCode);` |
|        - |  132 | `	/* Restore caller's namespace state */` |
|    90775 |  133 | `	SyBlobReset(&pVm->sNamespace);` |
|    90775 |  134 | `	SyBlobDup(&sSavedNs,&pVm->sNamespace);` |
|    90775 |  135 | `	SyBlobRelease(&sSavedNs);` |
|        - |  136 | `	/* Restore the outer compile's generator state if this was a nested unit. */` |
|    90775 |  137 | `	if( bNested ){` |
|        5 |  138 | `		PH7_CompilerRestoreState(pVm,&sSavedGen);` |
|        2 |  139 | `	}` |
|    90775 |  140 | `	return SXRET_OK;` |
|        5 |  141 | `}` |
|        - |  142 | `/*` |
...
|        - |  146 | ` */` |
|    73758 |  147 | `PH7_PRIVATE sxi32 PH7_VmEvalBuiltinChunk(ph7_vm *pVm,const char *zSrc,sxu32 nLen)` |
|        5 |  148 | `{` |
|        - |  149 | `	SyString sChunk;` |
|    73763 |  150 | `	SyStringInitFromBuf(&sChunk,zSrc,nLen);` |
|    73763 |  151 | `	return VmEvalChunk(&(*pVm),0,&sChunk,PH7_PHP_ONLY,FALSE);` |
|        5 |  152 | `}` |
|        - |  153 | `/*` |
...
|        - |  192 | `	sxu32 n;` |
|     9168 |  193 | `	aEntries = (SyString *)SySetBasePtr(&pVm->aIncluded);` |
|        - |  194 | `	/* Perform a linear search */` |
| 20884982 |  195 | `	for( n = 0 ; n < SySetUsed(&pVm->aIncluded) ; ++n ){` |
| 20875830 |  196 | `		if( SyStringCmp(pFile,&aEntries[n],SyMemcmp) == 0 ){` |
|        - |  197 | `			/* Already included */` |
|       16 |  198 | `			return TRUE;` |
|        - |  199 | `		}` |
| 10437909 |  200 | `	}` |
|     9154 |  201 | `	return FALSE;` |
|     4586 |  202 | `}` |
|        - |  203 | `/*` |
...
|    13051 |  264 | `	if( !bMain ){` |
|     9168 |  265 | `		if( VmIsIncludedFile(&(*pVm),&sPath) ){` |
|        - |  266 | `			/* Already included */` |
|       16 |  267 | `			*pNew = 0;` |
|        9 |  268 | `		}else{` |
|        - |  269 | `			/* Insert in the corresponding container */` |
|     9154 |  270 | `			rc = SySetPut(&pVm->aIncluded,(const void *)&sPath);` |
|     9154 |  271 | `			if( rc != SXRET_OK ){` |
...
|     9175 |  307 | `	pVm = pCtx->pVm;` |
|     9175 |  308 | `	SyBlobInit(&sContents,&pVm->sAllocator);` |
|     9175 |  309 | `	isNew = 0;` |
|        - |  310 | `	/* Extract the associated stream */` |
|     9175 |  311 | `	pStream = PH7_VmGetStreamDevice(pVm,&pPath->zString,pPath->nByte);` |
|        - |  312 | `	/*` |
|        - |  313 | `	 * Open the file or the URL [i.e: http://ph7.symisc.net/example/hello.php"]` |
|        - |  314 | `	 * in a read-only mode.` |
|        - |  315 | `	 */` |
|     9175 |  316 | `	pHandle = PH7_StreamOpenHandle(pVm,pStream,pPath->zString,PH7_IO_OPEN_RDONLY,TRUE,0,TRUE,&isNew);` |
|     9175 |  317 | `	if( pHandle == 0 ){` |
|        8 |  318 | `		return SXERR_IO;` |
|        - |  319 | `	}` |
|     9168 |  320 | `	rc = SXRET_OK; /* Stupid cc warning */` |
|     9168 |  321 | `	if( IncludeOnce && !isNew ){` |
|        - |  322 | `		/* Already included */` |
|       14 |  323 | `		rc = SXERR_EXISTS;` |
|        8 |  324 | `	}else{` |
|        - |  325 | `		/* Read the whole file contents */` |
|     9156 |  326 | `		rc = PH7_StreamReadWholeFile(pHandle,pStream,&sContents);` |
|     9156 |  327 | `		if( rc == SXRET_OK ){` |
|        - |  328 | `			SyString sScript;` |
|        - |  329 | `			/* Compile and execute the script */` |
|     9156 |  330 | `			SyStringInitFromBuf(&sScript,SyBlobData(&sContents),SyBlobLength(&sContents));` |
|     9156 |  331 | `			VmEvalChunk(pCtx->pVm,&(*pCtx),&sScript,0,TRUE);` |
|     4576 |  332 | `		}` |
|        - |  333 | `	}` |
|        - |  334 | `	/* Pop from the set of included file */` |
|     9168 |  335 | `	(void)SySetPop(&pVm->aFiles);` |
|        - |  336 | `	/* Close the handle */` |
|     9168 |  337 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|        - |  338 | `	/* Release the working buffer */` |
|     9168 |  339 | `	SyBlobRelease(&sContents);` |
|        - |  340 | `#else` |
...
|        - |  525 | `	}` |
|        - |  526 | `	/* File to include */` |
|     9134 |  527 | `	sFile.zString = ph7_value_to_string(apArg[0],(int *)&sFile.nByte);` |
|     9134 |  528 | `	if( sFile.nByte < 1 ){` |
...
|     9134 |  534 | `	rc = VmExecIncludedFile(&(*pCtx),&sFile,FALSE);` |
|     9134 |  535 | `	if( rc != SXRET_OK ){` |
...
|        1 |  539 | `	}` |
|     9134 |  540 | `	if( pCtx->pVm->bHaltRequested ){` |
