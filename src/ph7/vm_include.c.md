...
|  2438787 |  101 | `			while((pEntry = SyHashGetNextEntry(&pVm->hClass)) != 0 ){` |
|  2424977 |  102 | `				pClass = (ph7_class *)pEntry->pUserData;` |
|        - |  103 | `				/* Only mount classes that haven't been mounted yet */` |
|  2424977 |  104 | `				if( !pClass->bMounted ){` |
|   244565 |  105 | `					rc = VmMountUserClass(pVm,pClass);` |
|   244565 |  106 | `					if( rc != SXRET_OK ){` |
