...
| 12636 |   29 | `static int UnixVfs_chdir(const char *zPath)` |
|     - |   30 |  |
|     - |   31 | `  int rc;` |
| 12636 |   32 | `  rc = chdir(zPath);` |
| 12636 |   33 | `  return rc == 0 ? PH7_OK : -1;` |
|     - |   34 |  |
...
|  7422 |   64 | `static int UnixVfs_isdir(const char *zPath)` |
|     - |   65 |  |
|     - |   66 | `	struct stat st;` |
|     - |   67 | `	int rc;` |
|  7422 |   68 | `	rc = stat(zPath,&st);` |
|  7422 |   69 | `	if( rc != 0 ){` |
|     4 |   70 | `	 return -1;` |
|     - |   71 | `	}` |
|  7418 |   72 | `	rc = S_ISDIR(st.st_mode);` |
|  7418 |   73 | `	return rc ? PH7_OK : -1 ;` |
|  3711 |   74 |  |
...
| 27942 |  108 | `static int UnixVfs_unlink(const char *zPath)` |
|     - |  109 |  |
|     - |  110 | `	int rc;` |
| 27942 |  111 | `	rc = unlink(zPath);` |
| 27942 |  112 | `	return rc == 0 ? PH7_OK : -1 ;` |
|     - |  113 |  |
...
|  5562 |  320 | `static int UnixVfs_isfile(const char *zPath)` |
|     - |  321 |  |
|     - |  322 | `	struct stat st;` |
|     - |  323 | `	int rc;` |
|  5562 |  324 | `	rc = stat(zPath,&st);` |
|  5562 |  325 | `	if( rc != 0 ){` |
|     2 |  326 | `	 return -1;` |
|     - |  327 | `	}` |
|  5560 |  328 | `	rc = S_ISREG(st.st_mode);` |
|  5560 |  329 | `	return rc ? PH7_OK : -1 ;` |
|  2781 |  330 |  |
...
| 28086 |  580 | `static int UnixFile_Open(const char *zPath,int iOpenMode,ph7_value *pResource,void **ppHandle)` |
|     - |  581 |  |
| 28086 |  582 | `	int iOpen = O_RDONLY;` |
|     - |  583 | `	int fd;` |
|     - |  584 | `	/* Set the desired flags according to the open mode */` |
| 28086 |  585 | `	if( iOpenMode & PH7_IO_OPEN_CREATE ){` |
|     - |  586 | `		/* Open existing file, or create if it doesn't exist */` |
| 12882 |  587 | `		iOpen = O_CREAT;` |
| 12882 |  588 | `		if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  589 | `			/* If the specified file exists and is writable, the function overwrites the file */` |
| 12882 |  590 | `			iOpen \|= O_TRUNC;` |
|  6441 |  591 | `			SXUNUSED(pResource); /* cc warning */` |
|  6441 |  592 | `		}` |
| 21645 |  593 | `	}else if( iOpenMode & PH7_IO_OPEN_EXCL ){` |
|     - |  594 | `		/* Creates a new file, only if it does not already exist.` |
|     - |  595 | `		* If the file exists, it fails.` |
|     - |  596 | `		*/` |
|   ! 0 |  597 | `		iOpen = O_CREAT\|O_EXCL;` |
| 15204 |  598 | `	}else if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  599 | `		/* Opens a file and truncates it so that its size is zero bytes` |
|     - |  600 | `		 * The file must exist.` |
|     - |  601 | `		 */` |
|   ! 0 |  602 | `		iOpen = O_RDWR\|O_TRUNC;` |
|   ! 0 |  603 | `	}` |
| 28086 |  604 | `	if( iOpenMode & PH7_IO_OPEN_RDWR ){` |
|     - |  605 | `		/* Read+Write access */` |
| 12866 |  606 | `		iOpen &= ~O_RDONLY;` |
| 12866 |  607 | `		iOpen \|= O_RDWR;` |
| 21653 |  608 | `	}else if( iOpenMode & PH7_IO_OPEN_WRONLY ){` |
|     - |  609 | `		/* Write only access */` |
|    22 |  610 | `		iOpen &= ~O_RDONLY;` |
|    22 |  611 | `		iOpen \|= O_WRONLY;` |
|    11 |  612 | `	}` |
| 28086 |  613 | `	if( iOpenMode & PH7_IO_OPEN_APPEND ){` |
|     - |  614 | `		/* Append mode */` |
...
| 28086 |  624 | `	fd = open(zPath,iOpen,PH7_UNIX_OPEN_MODE);` |
| 28086 |  625 | `	if( fd < 0 ){` |
|     - |  626 | `		/* IO error */` |
|    12 |  627 | `		return -1;` |
|     - |  628 | `	}` |
|     - |  629 | `	/* Save the handle */` |
| 28074 |  630 | `	*ppHandle = SX_INT_TO_PTR(fd);` |
| 28074 |  631 | `	return PH7_OK;` |
| 14043 |  632 |  |
...
| 28072 |  653 | `static void UnixFile_Close(void *pUserData)` |
|     - |  654 |  |
| 28072 |  655 | `	close(SX_PTR_TO_INT(pUserData));` |
| 28072 |  656 |  |
|     - |  657 | `/* int (*xReadDir)(void *,ph7_context *) */` |
|  7420 |  658 | `static int UnixDir_Read(void *pUserData,ph7_context *pCtx)` |
|     - |  659 |  |
|  7420 |  660 | `	DIR *pDir = (DIR *)pUserData;` |
|     - |  661 | `	struct dirent *pEntry;` |
|  7420 |  662 | `	char *zName = 0; /* cc warning */` |
|  7420 |  663 | `	sxu32 n = 0;` |
|  4644 |  664 | `	for(;;){` |
|  9284 |  665 | `		pEntry = readdir(pDir);` |
|  9284 |  666 | `		if( pEntry == 0 ){` |
|     - |  667 | `			/* No more entries to process */` |
|   930 |  668 | `			return -1;` |
|     - |  669 | `		}` |
|  8354 |  670 | `		zName = pEntry->d_name;` |
|  8354 |  671 | `		n = SyStrlen(zName);` |
|     - |  672 | `		/* Ignore '.' && '..' */` |
|  8354 |  673 | `		if( n > sizeof("..")-1 \|\| zName[0] != '.' \|\| ( n == sizeof("..")-1 && zName[1] != '.') ){` |
|  3245 |  674 | `			break;` |
|     - |  675 | `		}` |
|     - |  676 | `		/* Next entry */` |
|     - |  677 | `	}` |
|     - |  678 | `	/* Return the current file name */` |
|  6490 |  679 | `	ph7_result_string(pCtx,zName,(int)n);` |
|  6490 |  680 | `	return PH7_OK;` |
|  3710 |  681 |  |
...
| 30334 |  688 | `static ph7_int64 UnixFile_Read(void *pUserData,void *pBuffer,ph7_int64 nDatatoRead)` |
|     - |  689 |  |
|     - |  690 | `	ssize_t nRd;` |
| 30334 |  691 | `	nRd = read(SX_PTR_TO_INT(pUserData),pBuffer,(size_t)nDatatoRead);` |
| 30334 |  692 | `	if( nRd < 1 ){` |
|     - |  693 | `		/* EOF or IO error */` |
| 15162 |  694 | `		return -1;` |
|     - |  695 | `	}` |
| 15172 |  696 | `	return (ph7_int64)nRd;` |
| 15167 |  697 |  |
|     - |  698 | `/* ph7_int64 (*xWrite)(void *,const void *,ph7_int64); */` |
| 12904 |  699 | `static ph7_int64 UnixFile_Write(void *pUserData,const void *pBuffer,ph7_int64 nWrite)` |
|     - |  700 |  |
| 12904 |  701 | `	const char *zData = (const char *)pBuffer;` |
| 12904 |  702 | `	int fd = SX_PTR_TO_INT(pUserData);` |
|     - |  703 | `	ph7_int64 nCount;` |
|     - |  704 | `	ssize_t nWr;` |
| 12904 |  705 | `	nCount = 0;` |
| 12904 |  706 | `	for(;;){` |
| 25808 |  707 | `		if( nWrite < 1 ){` |
| 12904 |  708 | `			break;` |
|     - |  709 | `		}` |
| 12904 |  710 | `		nWr = write(fd,zData,(size_t)nWrite);` |
| 12904 |  711 | `		if( nWr < 1 ){` |
|     - |  712 | `			/* IO error */` |
|   ! 0 |  713 | `			break;` |
|     - |  714 | `		}` |
| 12904 |  715 | `		nWrite -= nWr;` |
| 12904 |  716 | `		nCount += nWr;` |
| 12904 |  717 | `		zData += nWr;` |
|     - |  718 | `	}` |
| 12904 |  719 | `	if( nWrite > 0 ){` |
|   ! 0 |  720 | `		return -1;` |
|     - |  721 | `	}` |
| 12904 |  722 | `	return nCount;` |
|  6452 |  723 |  |
