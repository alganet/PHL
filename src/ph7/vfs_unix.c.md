...
| 13126 |   31 | `static int UnixVfs_chdir(const char *zPath)` |
|     - |   32 | `{` |
|     - |   33 | `  int rc;` |
| 13126 |   34 | `  rc = chdir(zPath);` |
| 13126 |   35 | `  return rc == 0 ? PH7_OK : -1;` |
|     - |   36 | `}` |
...
|  8510 |   66 | `static int UnixVfs_isdir(const char *zPath)` |
|     - |   67 | `{` |
|     - |   68 | `	struct stat st;` |
|     - |   69 | `	int rc;` |
|  8510 |   70 | `	rc = stat(zPath,&st);` |
|  8510 |   71 | `	if( rc != 0 ){` |
|     4 |   72 | `	 return -1;` |
|     - |   73 | `	}` |
|  8506 |   74 | `	rc = S_ISDIR(st.st_mode);` |
|  8506 |   75 | `	return rc ? PH7_OK : -1 ;` |
|  4255 |   76 | `}` |
...
| 32748 |  110 | `static int UnixVfs_unlink(const char *zPath)` |
|     - |  111 | `{` |
|     - |  112 | `	int rc;` |
| 32748 |  113 | `	rc = unlink(zPath);` |
| 32748 |  114 | `	return rc == 0 ? PH7_OK : -1 ;` |
|     - |  115 | `}` |
...
|  6520 |  355 | `static int UnixVfs_isfile(const char *zPath)` |
|     - |  356 | `{` |
|     - |  357 | `	struct stat st;` |
|     - |  358 | `	int rc;` |
|  6520 |  359 | `	rc = stat(zPath,&st);` |
|  6520 |  360 | `	if( rc != 0 ){` |
|     2 |  361 | `	 return -1;` |
|     - |  362 | `	}` |
|  6518 |  363 | `	rc = S_ISREG(st.st_mode);` |
|  6518 |  364 | `	return rc ? PH7_OK : -1 ;` |
|  3260 |  365 | `}` |
...
| 29538 |  607 | `static int UnixFile_Open(const char *zPath,int iOpenMode,ph7_value *pResource,void **ppHandle)` |
|     - |  608 | `{` |
| 29538 |  609 | `	int iOpen = O_RDONLY;` |
|     - |  610 | `	int fd;` |
|     - |  611 | `	/* Set the desired flags according to the open mode */` |
| 29538 |  612 | `	if( iOpenMode & PH7_IO_OPEN_CREATE ){` |
|     - |  613 | `		/* Open existing file, or create if it doesn't exist */` |
| 13390 |  614 | `		iOpen = O_CREAT;` |
| 13390 |  615 | `		if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  616 | `			/* If the specified file exists and is writable, the function overwrites the file */` |
| 13390 |  617 | `			iOpen \|= O_TRUNC;` |
|  6695 |  618 | `			SXUNUSED(pResource); /* cc warning */` |
|  6695 |  619 | `		}` |
| 22843 |  620 | `	}else if( iOpenMode & PH7_IO_OPEN_EXCL ){` |
|     - |  621 | `		/* Creates a new file, only if it does not already exist.` |
|     - |  622 | `		* If the file exists, it fails.` |
|     - |  623 | `		*/` |
|   124 |  624 | `		iOpen = O_CREAT\|O_EXCL;` |
| 16086 |  625 | `	}else if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  626 | `		/* Opens a file and truncates it so that its size is zero bytes` |
|     - |  627 | `		 * The file must exist.` |
|     - |  628 | `		 */` |
|   ! 0 |  629 | `		iOpen = O_RDWR\|O_TRUNC;` |
|   ! 0 |  630 | `	}` |
| 29538 |  631 | `	if( iOpenMode & PH7_IO_OPEN_RDWR ){` |
|     - |  632 | `		/* Read+Write access */` |
| 13374 |  633 | `		iOpen &= ~O_RDONLY;` |
| 13374 |  634 | `		iOpen \|= O_RDWR;` |
| 22851 |  635 | `	}else if( iOpenMode & PH7_IO_OPEN_WRONLY ){` |
|     - |  636 | `		/* Write only access */` |
|   146 |  637 | `		iOpen &= ~O_RDONLY;` |
|   146 |  638 | `		iOpen \|= O_WRONLY;` |
|    73 |  639 | `	}` |
| 29538 |  640 | `	if( iOpenMode & PH7_IO_OPEN_APPEND ){` |
|     - |  641 | `		/* Append mode */` |
...
| 29538 |  651 | `	fd = open(zPath,iOpen,PH7_UNIX_OPEN_MODE);` |
| 29538 |  652 | `	if( fd < 0 ){` |
|     - |  653 | `		/* IO error */` |
|    12 |  654 | `		return -1;` |
|     - |  655 | `	}` |
|     - |  656 | `	/* Save the handle */` |
| 29526 |  657 | `	*ppHandle = SX_INT_TO_PTR(fd);` |
| 29526 |  658 | `	return PH7_OK;` |
| 14769 |  659 | `}` |
...
| 29524 |  680 | `static void UnixFile_Close(void *pUserData)` |
|     - |  681 | `{` |
| 29524 |  682 | `	close(SX_PTR_TO_INT(pUserData));` |
| 29524 |  683 | `}` |
|     - |  684 | `/* int (*xReadDir)(void *,ph7_context *) */` |
|  8508 |  685 | `static int UnixDir_Read(void *pUserData,ph7_context *pCtx)` |
|     - |  686 | `{` |
|  8508 |  687 | `	DIR *pDir = (DIR *)pUserData;` |
|     - |  688 | `	struct dirent *pEntry;` |
|  8508 |  689 | `	char *zName = 0; /* cc warning */` |
|  8508 |  690 | `	sxu32 n = 0;` |
|  5254 |  691 | `	for(;;){` |
| 10508 |  692 | `		pEntry = readdir(pDir);` |
| 10508 |  693 | `		if( pEntry == 0 ){` |
|     - |  694 | `			/* No more entries to process */` |
|   996 |  695 | `			return -1;` |
|     - |  696 | `		}` |
|  9512 |  697 | `		zName = pEntry->d_name;` |
|  9512 |  698 | `		n = SyStrlen(zName);` |
|     - |  699 | `		/* Ignore '.' && '..' */` |
|  9512 |  700 | `		if( n > sizeof("..")-1 \|\| zName[0] != '.' \|\| ( n == sizeof("..")-1 && zName[1] != '.') ){` |
|  3756 |  701 | `			break;` |
|     - |  702 | `		}` |
|     - |  703 | `		/* Next entry */` |
|     - |  704 | `	}` |
|     - |  705 | `	/* Return the current file name */` |
|  7512 |  706 | `	ph7_result_string(pCtx,zName,(int)n);` |
|  7512 |  707 | `	return PH7_OK;` |
|  4254 |  708 | `}` |
...
| 31964 |  715 | `static ph7_int64 UnixFile_Read(void *pUserData,void *pBuffer,ph7_int64 nDatatoRead)` |
|     - |  716 | `{` |
|     - |  717 | `	ssize_t nRd;` |
| 31964 |  718 | `	nRd = read(SX_PTR_TO_INT(pUserData),pBuffer,(size_t)nDatatoRead);` |
| 31964 |  719 | `	if( nRd < 1 ){` |
|     - |  720 | `		/* EOF or IO error */` |
| 15978 |  721 | `		return -1;` |
|     - |  722 | `	}` |
| 15986 |  723 | `	return (ph7_int64)nRd;` |
| 15982 |  724 | `}` |
|     - |  725 | `/* ph7_int64 (*xWrite)(void *,const void *,ph7_int64); */` |
| 13404 |  726 | `static ph7_int64 UnixFile_Write(void *pUserData,const void *pBuffer,ph7_int64 nWrite)` |
|     - |  727 | `{` |
| 13404 |  728 | `	const char *zData = (const char *)pBuffer;` |
| 13404 |  729 | `	int fd = SX_PTR_TO_INT(pUserData);` |
|     - |  730 | `	ph7_int64 nCount;` |
|     - |  731 | `	ssize_t nWr;` |
| 13404 |  732 | `	nCount = 0;` |
| 13404 |  733 | `	for(;;){` |
| 26808 |  734 | `		if( nWrite < 1 ){` |
| 13404 |  735 | `			break;` |
|     - |  736 | `		}` |
| 13404 |  737 | `		nWr = write(fd,zData,(size_t)nWrite);` |
| 13404 |  738 | `		if( nWr < 1 ){` |
|     - |  739 | `			/* IO error */` |
|   ! 0 |  740 | `			break;` |
|     - |  741 | `		}` |
| 13404 |  742 | `		nWrite -= nWr;` |
| 13404 |  743 | `		nCount += nWr;` |
| 13404 |  744 | `		zData += nWr;` |
|     - |  745 | `	}` |
| 13404 |  746 | `	if( nWrite > 0 ){` |
|   ! 0 |  747 | `		return -1;` |
|     - |  748 | `	}` |
| 13404 |  749 | `	return nCount;` |
|  6702 |  750 | `}` |
