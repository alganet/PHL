...
| 10978 |   29 | `static int UnixVfs_chdir(const char *zPath)` |
|     - |   30 |  |
|     - |   31 | `  int rc;` |
| 10978 |   32 | `  rc = chdir(zPath);` |
| 10978 |   33 | `  return rc == 0 ? PH7_OK : -1;` |
|     - |   34 |  |
...
|  6516 |   64 | `static int UnixVfs_isdir(const char *zPath)` |
|     - |   65 |  |
|     - |   66 | `	struct stat st;` |
|     - |   67 | `	int rc;` |
|  6516 |   68 | `	rc = stat(zPath,&st);` |
|  6516 |   69 | `	if( rc != 0 ){` |
|     4 |   70 | `	 return -1;` |
|     - |   71 | `	}` |
|  6512 |   72 | `	rc = S_ISDIR(st.st_mode);` |
|  6512 |   73 | `	return rc ? PH7_OK : -1 ;` |
|  3258 |   74 |  |
...
| 23778 |  108 | `static int UnixVfs_unlink(const char *zPath)` |
|     - |  109 |  |
|     - |  110 | `	int rc;` |
| 23778 |  111 | `	rc = unlink(zPath);` |
| 23778 |  112 | `	return rc == 0 ? PH7_OK : -1 ;` |
|     - |  113 |  |
...
|  4728 |  320 | `static int UnixVfs_isfile(const char *zPath)` |
|     - |  321 |  |
|     - |  322 | `	struct stat st;` |
|     - |  323 | `	int rc;` |
|  4728 |  324 | `	rc = stat(zPath,&st);` |
|  4728 |  325 | `	if( rc != 0 ){` |
|     2 |  326 | `	 return -1;` |
|     - |  327 | `	}` |
|  4726 |  328 | `	rc = S_ISREG(st.st_mode);` |
|  4726 |  329 | `	return rc ? PH7_OK : -1 ;` |
|  2364 |  330 |  |
...
|  2706 |  411 | `static int UnixVfs_Mmap(const char *zPath,void **ppMap,ph7_int64 *pSize)` |
|     - |  412 |  |
|     - |  413 | `	struct stat st;` |
|     - |  414 | `	void *pMap;` |
|     - |  415 | `	int fd;` |
...
|  2706 |  418 | `	fd = open(zPath,O_RDONLY);` |
|  2706 |  419 | `	if( fd < 0 ){` |
|     2 |  420 | `		return -1;` |
|     - |  421 | `	}` |
|     - |  422 | `	/* stat the handle */` |
|  2704 |  423 | `	fstat(fd,&st);` |
|     - |  424 | `	/* Obtain a memory view of the whole file */` |
|  2704 |  425 | `	pMap = mmap(0,st.st_size,PROT_READ,MAP_PRIVATE\|MAP_FILE,fd,0);` |
|  2704 |  426 | `	rc = PH7_OK;` |
|  2704 |  427 | `	if( pMap == MAP_FAILED ){` |
|   ! 0 |  428 | `		rc = -1;` |
|   ! 0 |  429 | `	}else{` |
|     - |  430 | `		/* Point to the memory view */` |
|  2704 |  431 | `		*ppMap = pMap;` |
|  2704 |  432 | `		*pSize = (ph7_int64)st.st_size;` |
|     - |  433 | `	}` |
|  2704 |  434 | `	close(fd);` |
|  2704 |  435 | `	return rc;` |
|  1353 |  436 |  |
|     - |  437 | `/* void (*xUnmap)(void *,ph7_int64)  */` |
|  2704 |  438 | `static void UnixVfs_Unmap(void *pView,ph7_int64 nSize)` |
|     - |  439 |  |
|  2704 |  440 | `	munmap(pView,(size_t)nSize);` |
|  2704 |  441 |  |
...
| 24370 |  580 | `static int UnixFile_Open(const char *zPath,int iOpenMode,ph7_value *pResource,void **ppHandle)` |
|     - |  581 |  |
| 24370 |  582 | `	int iOpen = O_RDONLY;` |
|     - |  583 | `	int fd;` |
|     - |  584 | `	/* Set the desired flags according to the open mode */` |
| 24370 |  585 | `	if( iOpenMode & PH7_IO_OPEN_CREATE ){` |
|     - |  586 | `		/* Open existing file, or create if it doesn't exist */` |
| 11212 |  587 | `		iOpen = O_CREAT;` |
| 11212 |  588 | `		if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  589 | `			/* If the specified file exists and is writable, the function overwrites the file */` |
| 11212 |  590 | `			iOpen \|= O_TRUNC;` |
|  5606 |  591 | `			SXUNUSED(pResource); /* cc warning */` |
|  5606 |  592 | `		}` |
| 18764 |  593 | `	}else if( iOpenMode & PH7_IO_OPEN_EXCL ){` |
|     - |  594 | `		/* Creates a new file, only if it does not already exist.` |
|     - |  595 | `		* If the file exists, it fails.` |
|     - |  596 | `		*/` |
|   ! 0 |  597 | `		iOpen = O_CREAT\|O_EXCL;` |
| 13158 |  598 | `	}else if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  599 | `		/* Opens a file and truncates it so that its size is zero bytes` |
|     - |  600 | `		 * The file must exist.` |
|     - |  601 | `		 */` |
|   ! 0 |  602 | `		iOpen = O_RDWR\|O_TRUNC;` |
|   ! 0 |  603 | `	}` |
| 24370 |  604 | `	if( iOpenMode & PH7_IO_OPEN_RDWR ){` |
|     - |  605 | `		/* Read+Write access */` |
| 11196 |  606 | `		iOpen &= ~O_RDONLY;` |
| 11196 |  607 | `		iOpen \|= O_RDWR;` |
| 18772 |  608 | `	}else if( iOpenMode & PH7_IO_OPEN_WRONLY ){` |
|     - |  609 | `		/* Write only access */` |
|    22 |  610 | `		iOpen &= ~O_RDONLY;` |
|    22 |  611 | `		iOpen \|= O_WRONLY;` |
|    11 |  612 | `	}` |
| 24370 |  613 | `	if( iOpenMode & PH7_IO_OPEN_APPEND ){` |
|     - |  614 | `		/* Append mode */` |
...
| 24370 |  624 | `	fd = open(zPath,iOpen,PH7_UNIX_OPEN_MODE);` |
| 24370 |  625 | `	if( fd < 0 ){` |
|     - |  626 | `		/* IO error */` |
|    12 |  627 | `		return -1;` |
|     - |  628 | `	}` |
|     - |  629 | `	/* Save the handle */` |
| 24358 |  630 | `	*ppHandle = SX_INT_TO_PTR(fd);` |
| 24358 |  631 | `	return PH7_OK;` |
| 12185 |  632 |  |
...
| 24356 |  653 | `static void UnixFile_Close(void *pUserData)` |
|     - |  654 |  |
| 24356 |  655 | `	close(SX_PTR_TO_INT(pUserData));` |
| 24356 |  656 |  |
|     - |  657 | `/* int (*xReadDir)(void *,ph7_context *) */` |
|  6514 |  658 | `static int UnixDir_Read(void *pUserData,ph7_context *pCtx)` |
|     - |  659 |  |
|  6514 |  660 | `	DIR *pDir = (DIR *)pUserData;` |
|     - |  661 | `	struct dirent *pEntry;` |
|  6514 |  662 | `	char *zName = 0; /* cc warning */` |
|  6514 |  663 | `	sxu32 n = 0;` |
|  4155 |  664 | `	for(;;){` |
|  8308 |  665 | `		pEntry = readdir(pDir);` |
|  8308 |  666 | `		if( pEntry == 0 ){` |
|     - |  667 | `			/* No more entries to process */` |
|   894 |  668 | `			return -1;` |
|     - |  669 | `		}` |
|  7414 |  670 | `		zName = pEntry->d_name;` |
|  7414 |  671 | `		n = SyStrlen(zName);` |
|     - |  672 | `		/* Ignore '.' && '..' */` |
|  7414 |  673 | `		if( n > sizeof("..")-1 \|\| zName[0] != '.' \|\| ( n == sizeof("..")-1 && zName[1] != '.') ){` |
|  2810 |  674 | `			break;` |
|     - |  675 | `		}` |
|     - |  676 | `		/* Next entry */` |
|     - |  677 | `	}` |
|     - |  678 | `	/* Return the current file name */` |
|  5620 |  679 | `	ph7_result_string(pCtx,zName,(int)n);` |
|  5620 |  680 | `	return PH7_OK;` |
|  3257 |  681 |  |
...
| 26242 |  688 | `static ph7_int64 UnixFile_Read(void *pUserData,void *pBuffer,ph7_int64 nDatatoRead)` |
|     - |  689 |  |
|     - |  690 | `	ssize_t nRd;` |
| 26242 |  691 | `	nRd = read(SX_PTR_TO_INT(pUserData),pBuffer,(size_t)nDatatoRead);` |
| 26242 |  692 | `	if( nRd < 1 ){` |
|     - |  693 | `		/* EOF or IO error */` |
| 13116 |  694 | `		return -1;` |
|     - |  695 | `	}` |
| 13126 |  696 | `	return (ph7_int64)nRd;` |
| 13121 |  697 |  |
|     - |  698 | `/* ph7_int64 (*xWrite)(void *,const void *,ph7_int64); */` |
| 11234 |  699 | `static ph7_int64 UnixFile_Write(void *pUserData,const void *pBuffer,ph7_int64 nWrite)` |
|     - |  700 |  |
| 11234 |  701 | `	const char *zData = (const char *)pBuffer;` |
| 11234 |  702 | `	int fd = SX_PTR_TO_INT(pUserData);` |
|     - |  703 | `	ph7_int64 nCount;` |
|     - |  704 | `	ssize_t nWr;` |
| 11234 |  705 | `	nCount = 0;` |
| 11234 |  706 | `	for(;;){` |
| 22468 |  707 | `		if( nWrite < 1 ){` |
| 11234 |  708 | `			break;` |
|     - |  709 | `		}` |
| 11234 |  710 | `		nWr = write(fd,zData,(size_t)nWrite);` |
| 11234 |  711 | `		if( nWr < 1 ){` |
|     - |  712 | `			/* IO error */` |
|   ! 0 |  713 | `			break;` |
|     - |  714 | `		}` |
| 11234 |  715 | `		nWrite -= nWr;` |
| 11234 |  716 | `		nCount += nWr;` |
| 11234 |  717 | `		zData += nWr;` |
|     - |  718 | `	}` |
| 11234 |  719 | `	if( nWrite > 0 ){` |
|   ! 0 |  720 | `		return -1;` |
|     - |  721 | `	}` |
| 11234 |  722 | `	return nCount;` |
|  5617 |  723 |  |
