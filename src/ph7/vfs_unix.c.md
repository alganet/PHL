...
| 11408 |   29 | `static int UnixVfs_chdir(const char *zPath)` |
|     - |   30 |  |
|     - |   31 | `  int rc;` |
| 11408 |   32 | `  rc = chdir(zPath);` |
| 11408 |   33 | `  return rc == 0 ? PH7_OK : -1;` |
|     - |   34 |  |
...
|  6732 |   64 | `static int UnixVfs_isdir(const char *zPath)` |
|     - |   65 |  |
|     - |   66 | `	struct stat st;` |
|     - |   67 | `	int rc;` |
|  6732 |   68 | `	rc = stat(zPath,&st);` |
|  6732 |   69 | `	if( rc != 0 ){` |
|     4 |   70 | `	 return -1;` |
|     - |   71 | `	}` |
|  6728 |   72 | `	rc = S_ISDIR(st.st_mode);` |
|  6728 |   73 | `	return rc ? PH7_OK : -1 ;` |
|  3366 |   74 |  |
...
| 24858 |  108 | `static int UnixVfs_unlink(const char *zPath)` |
|     - |  109 |  |
|     - |  110 | `	int rc;` |
| 24858 |  111 | `	rc = unlink(zPath);` |
| 24858 |  112 | `	return rc == 0 ? PH7_OK : -1 ;` |
|     - |  113 |  |
...
|  4944 |  320 | `static int UnixVfs_isfile(const char *zPath)` |
|     - |  321 |  |
|     - |  322 | `	struct stat st;` |
|     - |  323 | `	int rc;` |
|  4944 |  324 | `	rc = stat(zPath,&st);` |
|  4944 |  325 | `	if( rc != 0 ){` |
|     2 |  326 | `	 return -1;` |
|     - |  327 | `	}` |
|  4942 |  328 | `	rc = S_ISREG(st.st_mode);` |
|  4942 |  329 | `	return rc ? PH7_OK : -1 ;` |
|  2472 |  330 |  |
...
|  2844 |  411 | `static int UnixVfs_Mmap(const char *zPath,void **ppMap,ph7_int64 *pSize)` |
|     - |  412 |  |
|     - |  413 | `	struct stat st;` |
|     - |  414 | `	void *pMap;` |
|     - |  415 | `	int fd;` |
...
|  2844 |  418 | `	fd = open(zPath,O_RDONLY);` |
|  2844 |  419 | `	if( fd < 0 ){` |
|     2 |  420 | `		return -1;` |
|     - |  421 | `	}` |
|     - |  422 | `	/* stat the handle */` |
|  2842 |  423 | `	fstat(fd,&st);` |
|     - |  424 | `	/* Obtain a memory view of the whole file */` |
|  2842 |  425 | `	pMap = mmap(0,st.st_size,PROT_READ,MAP_PRIVATE\|MAP_FILE,fd,0);` |
|  2842 |  426 | `	rc = PH7_OK;` |
|  2842 |  427 | `	if( pMap == MAP_FAILED ){` |
|   ! 0 |  428 | `		rc = -1;` |
|   ! 0 |  429 | `	}else{` |
|     - |  430 | `		/* Point to the memory view */` |
|  2842 |  431 | `		*ppMap = pMap;` |
|  2842 |  432 | `		*pSize = (ph7_int64)st.st_size;` |
|     - |  433 | `	}` |
|  2842 |  434 | `	close(fd);` |
|  2842 |  435 | `	return rc;` |
|  1422 |  436 |  |
|     - |  437 | `/* void (*xUnmap)(void *,ph7_int64)  */` |
|  2842 |  438 | `static void UnixVfs_Unmap(void *pView,ph7_int64 nSize)` |
|     - |  439 |  |
|  2842 |  440 | `	munmap(pView,(size_t)nSize);` |
|  2842 |  441 |  |
...
| 25308 |  580 | `static int UnixFile_Open(const char *zPath,int iOpenMode,ph7_value *pResource,void **ppHandle)` |
|     - |  581 |  |
| 25308 |  582 | `	int iOpen = O_RDONLY;` |
|     - |  583 | `	int fd;` |
|     - |  584 | `	/* Set the desired flags according to the open mode */` |
| 25308 |  585 | `	if( iOpenMode & PH7_IO_OPEN_CREATE ){` |
|     - |  586 | `		/* Open existing file, or create if it doesn't exist */` |
| 11642 |  587 | `		iOpen = O_CREAT;` |
| 11642 |  588 | `		if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  589 | `			/* If the specified file exists and is writable, the function overwrites the file */` |
| 11642 |  590 | `			iOpen \|= O_TRUNC;` |
|  5821 |  591 | `			SXUNUSED(pResource); /* cc warning */` |
|  5821 |  592 | `		}` |
| 19487 |  593 | `	}else if( iOpenMode & PH7_IO_OPEN_EXCL ){` |
|     - |  594 | `		/* Creates a new file, only if it does not already exist.` |
|     - |  595 | `		* If the file exists, it fails.` |
|     - |  596 | `		*/` |
|   ! 0 |  597 | `		iOpen = O_CREAT\|O_EXCL;` |
| 13666 |  598 | `	}else if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  599 | `		/* Opens a file and truncates it so that its size is zero bytes` |
|     - |  600 | `		 * The file must exist.` |
|     - |  601 | `		 */` |
|   ! 0 |  602 | `		iOpen = O_RDWR\|O_TRUNC;` |
|   ! 0 |  603 | `	}` |
| 25308 |  604 | `	if( iOpenMode & PH7_IO_OPEN_RDWR ){` |
|     - |  605 | `		/* Read+Write access */` |
| 11626 |  606 | `		iOpen &= ~O_RDONLY;` |
| 11626 |  607 | `		iOpen \|= O_RDWR;` |
| 19495 |  608 | `	}else if( iOpenMode & PH7_IO_OPEN_WRONLY ){` |
|     - |  609 | `		/* Write only access */` |
|    22 |  610 | `		iOpen &= ~O_RDONLY;` |
|    22 |  611 | `		iOpen \|= O_WRONLY;` |
|    11 |  612 | `	}` |
| 25308 |  613 | `	if( iOpenMode & PH7_IO_OPEN_APPEND ){` |
|     - |  614 | `		/* Append mode */` |
...
| 25308 |  624 | `	fd = open(zPath,iOpen,PH7_UNIX_OPEN_MODE);` |
| 25308 |  625 | `	if( fd < 0 ){` |
|     - |  626 | `		/* IO error */` |
|    12 |  627 | `		return -1;` |
|     - |  628 | `	}` |
|     - |  629 | `	/* Save the handle */` |
| 25296 |  630 | `	*ppHandle = SX_INT_TO_PTR(fd);` |
| 25296 |  631 | `	return PH7_OK;` |
| 12654 |  632 |  |
...
| 25294 |  653 | `static void UnixFile_Close(void *pUserData)` |
|     - |  654 |  |
| 25294 |  655 | `	close(SX_PTR_TO_INT(pUserData));` |
| 25294 |  656 |  |
|     - |  657 | `/* int (*xReadDir)(void *,ph7_context *) */` |
|  6730 |  658 | `static int UnixDir_Read(void *pUserData,ph7_context *pCtx)` |
|     - |  659 |  |
|  6730 |  660 | `	DIR *pDir = (DIR *)pUserData;` |
|     - |  661 | `	struct dirent *pEntry;` |
|  6730 |  662 | `	char *zName = 0; /* cc warning */` |
|  6730 |  663 | `	sxu32 n = 0;` |
|  4263 |  664 | `	for(;;){` |
|  8524 |  665 | `		pEntry = readdir(pDir);` |
|  8524 |  666 | `		if( pEntry == 0 ){` |
|     - |  667 | `			/* No more entries to process */` |
|   894 |  668 | `			return -1;` |
|     - |  669 | `		}` |
|  7630 |  670 | `		zName = pEntry->d_name;` |
|  7630 |  671 | `		n = SyStrlen(zName);` |
|     - |  672 | `		/* Ignore '.' && '..' */` |
|  7630 |  673 | `		if( n > sizeof("..")-1 \|\| zName[0] != '.' \|\| ( n == sizeof("..")-1 && zName[1] != '.') ){` |
|  2918 |  674 | `			break;` |
|     - |  675 | `		}` |
|     - |  676 | `		/* Next entry */` |
|     - |  677 | `	}` |
|     - |  678 | `	/* Return the current file name */` |
|  5836 |  679 | `	ph7_result_string(pCtx,zName,(int)n);` |
|  5836 |  680 | `	return PH7_OK;` |
|  3365 |  681 |  |
...
| 27258 |  688 | `static ph7_int64 UnixFile_Read(void *pUserData,void *pBuffer,ph7_int64 nDatatoRead)` |
|     - |  689 |  |
|     - |  690 | `	ssize_t nRd;` |
| 27258 |  691 | `	nRd = read(SX_PTR_TO_INT(pUserData),pBuffer,(size_t)nDatatoRead);` |
| 27258 |  692 | `	if( nRd < 1 ){` |
|     - |  693 | `		/* EOF or IO error */` |
| 13624 |  694 | `		return -1;` |
|     - |  695 | `	}` |
| 13634 |  696 | `	return (ph7_int64)nRd;` |
| 13629 |  697 |  |
|     - |  698 | `/* ph7_int64 (*xWrite)(void *,const void *,ph7_int64); */` |
| 11664 |  699 | `static ph7_int64 UnixFile_Write(void *pUserData,const void *pBuffer,ph7_int64 nWrite)` |
|     - |  700 |  |
| 11664 |  701 | `	const char *zData = (const char *)pBuffer;` |
| 11664 |  702 | `	int fd = SX_PTR_TO_INT(pUserData);` |
|     - |  703 | `	ph7_int64 nCount;` |
|     - |  704 | `	ssize_t nWr;` |
| 11664 |  705 | `	nCount = 0;` |
| 11664 |  706 | `	for(;;){` |
| 23328 |  707 | `		if( nWrite < 1 ){` |
| 11664 |  708 | `			break;` |
|     - |  709 | `		}` |
| 11664 |  710 | `		nWr = write(fd,zData,(size_t)nWrite);` |
| 11664 |  711 | `		if( nWr < 1 ){` |
|     - |  712 | `			/* IO error */` |
|   ! 0 |  713 | `			break;` |
|     - |  714 | `		}` |
| 11664 |  715 | `		nWrite -= nWr;` |
| 11664 |  716 | `		nCount += nWr;` |
| 11664 |  717 | `		zData += nWr;` |
|     - |  718 | `	}` |
| 11664 |  719 | `	if( nWrite > 0 ){` |
|   ! 0 |  720 | `		return -1;` |
|     - |  721 | `	}` |
| 11664 |  722 | `	return nCount;` |
|  5832 |  723 |  |
