...
| 13718 |   29 | `static int UnixVfs_chdir(const char *zPath)` |
|     - |   30 | `{` |
|     - |   31 | `  int rc;` |
| 13718 |   32 | `  rc = chdir(zPath);` |
| 13718 |   33 | `  return rc == 0 ? PH7_OK : -1;` |
|     - |   34 | `}` |
...
|  8102 |   64 | `static int UnixVfs_isdir(const char *zPath)` |
|     - |   65 | `{` |
|     - |   66 | `	struct stat st;` |
|     - |   67 | `	int rc;` |
|  8102 |   68 | `	rc = stat(zPath,&st);` |
|  8102 |   69 | `	if( rc != 0 ){` |
|     4 |   70 | `	 return -1;` |
|     - |   71 | `	}` |
|  8098 |   72 | `	rc = S_ISDIR(st.st_mode);` |
|  8098 |   73 | `	return rc ? PH7_OK : -1 ;` |
|  4051 |   74 | `}` |
...
| 30958 |  108 | `static int UnixVfs_unlink(const char *zPath)` |
|     - |  109 | `{` |
|     - |  110 | `	int rc;` |
| 30958 |  111 | `	rc = unlink(zPath);` |
| 30958 |  112 | `	return rc == 0 ? PH7_OK : -1 ;` |
|     - |  113 | `}` |
...
|  6164 |  320 | `static int UnixVfs_isfile(const char *zPath)` |
|     - |  321 | `{` |
|     - |  322 | `	struct stat st;` |
|     - |  323 | `	int rc;` |
|  6164 |  324 | `	rc = stat(zPath,&st);` |
|  6164 |  325 | `	if( rc != 0 ){` |
|     2 |  326 | `	 return -1;` |
|     - |  327 | `	}` |
|  6162 |  328 | `	rc = S_ISREG(st.st_mode);` |
|  6162 |  329 | `	return rc ? PH7_OK : -1 ;` |
|  3082 |  330 | `}` |
...
|  3818 |  411 | `static int UnixVfs_Mmap(const char *zPath,void **ppMap,ph7_int64 *pSize)` |
|     - |  412 | `{` |
|     - |  413 | `	struct stat st;` |
|     - |  414 | `	void *pMap;` |
|     - |  415 | `	int fd;` |
...
|  3818 |  418 | `	fd = open(zPath,O_RDONLY);` |
|  3818 |  419 | `	if( fd < 0 ){` |
|     2 |  420 | `		return -1;` |
|     - |  421 | `	}` |
|     - |  422 | `	/* stat the handle */` |
|  3816 |  423 | `	fstat(fd,&st);` |
|     - |  424 | `	/* Obtain a memory view of the whole file */` |
|  3816 |  425 | `	pMap = mmap(0,st.st_size,PROT_READ,MAP_PRIVATE\|MAP_FILE,fd,0);` |
|  3816 |  426 | `	rc = PH7_OK;` |
|  3816 |  427 | `	if( pMap == MAP_FAILED ){` |
|   ! 0 |  428 | `		rc = -1;` |
|   ! 0 |  429 | `	}else{` |
|     - |  430 | `		/* Point to the memory view */` |
|  3816 |  431 | `		*ppMap = pMap;` |
|  3816 |  432 | `		*pSize = (ph7_int64)st.st_size;` |
|     - |  433 | `	}` |
|  3816 |  434 | `	close(fd);` |
|  3816 |  435 | `	return rc;` |
|  1909 |  436 | `}` |
|     - |  437 | `/* void (*xUnmap)(void *,ph7_int64)  */` |
|  3816 |  438 | `static void UnixVfs_Unmap(void *pView,ph7_int64 nSize)` |
|     - |  439 | `{` |
|  3816 |  440 | `	munmap(pView,(size_t)nSize);` |
|  3816 |  441 | `}` |
...
| 30228 |  580 | `static int UnixFile_Open(const char *zPath,int iOpenMode,ph7_value *pResource,void **ppHandle)` |
|     - |  581 | `{` |
| 30228 |  582 | `	int iOpen = O_RDONLY;` |
|     - |  583 | `	int fd;` |
|     - |  584 | `	/* Set the desired flags according to the open mode */` |
| 30228 |  585 | `	if( iOpenMode & PH7_IO_OPEN_CREATE ){` |
|     - |  586 | `		/* Open existing file, or create if it doesn't exist */` |
| 13988 |  587 | `		iOpen = O_CREAT;` |
| 13988 |  588 | `		if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  589 | `			/* If the specified file exists and is writable, the function overwrites the file */` |
| 13988 |  590 | `			iOpen \|= O_TRUNC;` |
|  6994 |  591 | `			SXUNUSED(pResource); /* cc warning */` |
|  6994 |  592 | `		}` |
| 23234 |  593 | `	}else if( iOpenMode & PH7_IO_OPEN_EXCL ){` |
|     - |  594 | `		/* Creates a new file, only if it does not already exist.` |
|     - |  595 | `		* If the file exists, it fails.` |
|     - |  596 | `		*/` |
|   ! 0 |  597 | `		iOpen = O_CREAT\|O_EXCL;` |
| 16240 |  598 | `	}else if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  599 | `		/* Opens a file and truncates it so that its size is zero bytes` |
|     - |  600 | `		 * The file must exist.` |
|     - |  601 | `		 */` |
|   ! 0 |  602 | `		iOpen = O_RDWR\|O_TRUNC;` |
|   ! 0 |  603 | `	}` |
| 30228 |  604 | `	if( iOpenMode & PH7_IO_OPEN_RDWR ){` |
|     - |  605 | `		/* Read+Write access */` |
| 13972 |  606 | `		iOpen &= ~O_RDONLY;` |
| 13972 |  607 | `		iOpen \|= O_RDWR;` |
| 23242 |  608 | `	}else if( iOpenMode & PH7_IO_OPEN_WRONLY ){` |
|     - |  609 | `		/* Write only access */` |
|    22 |  610 | `		iOpen &= ~O_RDONLY;` |
|    22 |  611 | `		iOpen \|= O_WRONLY;` |
|    11 |  612 | `	}` |
| 30228 |  613 | `	if( iOpenMode & PH7_IO_OPEN_APPEND ){` |
|     - |  614 | `		/* Append mode */` |
...
| 30228 |  624 | `	fd = open(zPath,iOpen,PH7_UNIX_OPEN_MODE);` |
| 30228 |  625 | `	if( fd < 0 ){` |
|     - |  626 | `		/* IO error */` |
|    12 |  627 | `		return -1;` |
|     - |  628 | `	}` |
|     - |  629 | `	/* Save the handle */` |
| 30216 |  630 | `	*ppHandle = SX_INT_TO_PTR(fd);` |
| 30216 |  631 | `	return PH7_OK;` |
| 15114 |  632 | `}` |
...
| 30214 |  653 | `static void UnixFile_Close(void *pUserData)` |
|     - |  654 | `{` |
| 30214 |  655 | `	close(SX_PTR_TO_INT(pUserData));` |
| 30214 |  656 | `}` |
|     - |  657 | `/* int (*xReadDir)(void *,ph7_context *) */` |
|  8100 |  658 | `static int UnixDir_Read(void *pUserData,ph7_context *pCtx)` |
|     - |  659 | `{` |
|  8100 |  660 | `	DIR *pDir = (DIR *)pUserData;` |
|     - |  661 | `	struct dirent *pEntry;` |
|  8100 |  662 | `	char *zName = 0; /* cc warning */` |
|  8100 |  663 | `	sxu32 n = 0;` |
|  5024 |  664 | `	for(;;){` |
| 10044 |  665 | `		pEntry = readdir(pDir);` |
| 10044 |  666 | `		if( pEntry == 0 ){` |
|     - |  667 | `			/* No more entries to process */` |
|   970 |  668 | `			return -1;` |
|     - |  669 | `		}` |
|  9074 |  670 | `		zName = pEntry->d_name;` |
|  9074 |  671 | `		n = SyStrlen(zName);` |
|     - |  672 | `		/* Ignore '.' && '..' */` |
|  9074 |  673 | `		if( n > sizeof("..")-1 \|\| zName[0] != '.' \|\| ( n == sizeof("..")-1 && zName[1] != '.') ){` |
|  3565 |  674 | `			break;` |
|     - |  675 | `		}` |
|     - |  676 | `		/* Next entry */` |
|     - |  677 | `	}` |
|     - |  678 | `	/* Return the current file name */` |
|  7130 |  679 | `	ph7_result_string(pCtx,zName,(int)n);` |
|  7130 |  680 | `	return PH7_OK;` |
|  4050 |  681 | `}` |
...
| 32398 |  688 | `static ph7_int64 UnixFile_Read(void *pUserData,void *pBuffer,ph7_int64 nDatatoRead)` |
|     - |  689 | `{` |
|     - |  690 | `	ssize_t nRd;` |
| 32398 |  691 | `	nRd = read(SX_PTR_TO_INT(pUserData),pBuffer,(size_t)nDatatoRead);` |
| 32398 |  692 | `	if( nRd < 1 ){` |
|     - |  693 | `		/* EOF or IO error */` |
| 16194 |  694 | `		return -1;` |
|     - |  695 | `	}` |
| 16204 |  696 | `	return (ph7_int64)nRd;` |
| 16199 |  697 | `}` |
|     - |  698 | `/* ph7_int64 (*xWrite)(void *,const void *,ph7_int64); */` |
| 14010 |  699 | `static ph7_int64 UnixFile_Write(void *pUserData,const void *pBuffer,ph7_int64 nWrite)` |
|     - |  700 | `{` |
| 14010 |  701 | `	const char *zData = (const char *)pBuffer;` |
| 14010 |  702 | `	int fd = SX_PTR_TO_INT(pUserData);` |
|     - |  703 | `	ph7_int64 nCount;` |
|     - |  704 | `	ssize_t nWr;` |
| 14010 |  705 | `	nCount = 0;` |
| 14010 |  706 | `	for(;;){` |
| 28020 |  707 | `		if( nWrite < 1 ){` |
| 14010 |  708 | `			break;` |
|     - |  709 | `		}` |
| 14010 |  710 | `		nWr = write(fd,zData,(size_t)nWrite);` |
| 14010 |  711 | `		if( nWr < 1 ){` |
|     - |  712 | `			/* IO error */` |
|   ! 0 |  713 | `			break;` |
|     - |  714 | `		}` |
| 14010 |  715 | `		nWrite -= nWr;` |
| 14010 |  716 | `		nCount += nWr;` |
| 14010 |  717 | `		zData += nWr;` |
|     - |  718 | `	}` |
| 14010 |  719 | `	if( nWrite > 0 ){` |
|   ! 0 |  720 | `		return -1;` |
|     - |  721 | `	}` |
| 14010 |  722 | `	return nCount;` |
|  7005 |  723 | `}` |
