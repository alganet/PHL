...
| 13038 |   29 | `static int UnixVfs_chdir(const char *zPath)` |
|     - |   30 |  |
|     - |   31 | `  int rc;` |
| 13038 |   32 | `  rc = chdir(zPath);` |
| 13038 |   33 | `  return rc == 0 ? PH7_OK : -1;` |
|     - |   34 |  |
...
|  7676 |   64 | `static int UnixVfs_isdir(const char *zPath)` |
|     - |   65 |  |
|     - |   66 | `	struct stat st;` |
|     - |   67 | `	int rc;` |
|  7676 |   68 | `	rc = stat(zPath,&st);` |
|  7676 |   69 | `	if( rc != 0 ){` |
|     4 |   70 | `	 return -1;` |
|     - |   71 | `	}` |
|  7672 |   72 | `	rc = S_ISDIR(st.st_mode);` |
|  7672 |   73 | `	return rc ? PH7_OK : -1 ;` |
|  3838 |   74 |  |
...
| 28926 |  108 | `static int UnixVfs_unlink(const char *zPath)` |
|     - |  109 |  |
|     - |  110 | `	int rc;` |
| 28926 |  111 | `	rc = unlink(zPath);` |
| 28926 |  112 | `	return rc == 0 ? PH7_OK : -1 ;` |
|     - |  113 |  |
...
|  5758 |  320 | `static int UnixVfs_isfile(const char *zPath)` |
|     - |  321 |  |
|     - |  322 | `	struct stat st;` |
|     - |  323 | `	int rc;` |
|  5758 |  324 | `	rc = stat(zPath,&st);` |
|  5758 |  325 | `	if( rc != 0 ){` |
|     2 |  326 | `	 return -1;` |
|     - |  327 | `	}` |
|  5756 |  328 | `	rc = S_ISREG(st.st_mode);` |
|  5756 |  329 | `	return rc ? PH7_OK : -1 ;` |
|  2879 |  330 |  |
...
|  3326 |  411 | `static int UnixVfs_Mmap(const char *zPath,void **ppMap,ph7_int64 *pSize)` |
|     - |  412 |  |
|     - |  413 | `	struct stat st;` |
|     - |  414 | `	void *pMap;` |
|     - |  415 | `	int fd;` |
...
|  3326 |  418 | `	fd = open(zPath,O_RDONLY);` |
|  3326 |  419 | `	if( fd < 0 ){` |
|     2 |  420 | `		return -1;` |
|     - |  421 | `	}` |
|     - |  422 | `	/* stat the handle */` |
|  3324 |  423 | `	fstat(fd,&st);` |
|     - |  424 | `	/* Obtain a memory view of the whole file */` |
|  3324 |  425 | `	pMap = mmap(0,st.st_size,PROT_READ,MAP_PRIVATE\|MAP_FILE,fd,0);` |
|  3324 |  426 | `	rc = PH7_OK;` |
|  3324 |  427 | `	if( pMap == MAP_FAILED ){` |
|   ! 0 |  428 | `		rc = -1;` |
|   ! 0 |  429 | `	}else{` |
|     - |  430 | `		/* Point to the memory view */` |
|  3324 |  431 | `		*ppMap = pMap;` |
|  3324 |  432 | `		*pSize = (ph7_int64)st.st_size;` |
|     - |  433 | `	}` |
|  3324 |  434 | `	close(fd);` |
|  3324 |  435 | `	return rc;` |
|  1663 |  436 |  |
|     - |  437 | `/* void (*xUnmap)(void *,ph7_int64)  */` |
|  3324 |  438 | `static void UnixVfs_Unmap(void *pView,ph7_int64 nSize)` |
|     - |  439 |  |
|  3324 |  440 | `	munmap(pView,(size_t)nSize);` |
|  3324 |  441 |  |
|     - |  442 | `/* void (*xTempDir)(ph7_context *) */` |
|   202 |  443 | `static void UnixVfs_TempDir(ph7_context *pCtx)` |
|     - |  444 |  |
...
|     - |  451 | `  struct stat buf;` |
|     - |  452 | `  const char *zDir;` |
|   202 |  453 | `  zDir = getenv("TMPDIR");` |
|   202 |  454 | `  if( zDir && zDir[0] != 0 && !access(zDir,07) ){` |
|   101 |  455 | `	  ph7_result_string(pCtx,zDir,-1);` |
|   101 |  456 | `	  return;` |
|     - |  457 | `  }` |
|   101 |  458 | `  for(i=0; i<sizeof(azDirs)/sizeof(azDirs[0]); i++){` |
|   101 |  459 | `	zDir=azDirs[i];` |
|   101 |  460 | `    if( zDir==0 ) continue;` |
|   101 |  461 | `    if( stat(zDir, &buf) ) continue;` |
|   101 |  462 | `    if( !S_ISDIR(buf.st_mode) ) continue;` |
|   101 |  463 | `    if( access(zDir, 07) ) continue;` |
|     - |  464 | `    /* Got one */` |
|   101 |  465 | `	ph7_result_string(pCtx,zDir,-1);` |
|   101 |  466 | `	return;` |
|     - |  467 | `  }` |
...
| 28944 |  580 | `static int UnixFile_Open(const char *zPath,int iOpenMode,ph7_value *pResource,void **ppHandle)` |
|     - |  581 |  |
| 28944 |  582 | `	int iOpen = O_RDONLY;` |
|     - |  583 | `	int fd;` |
|     - |  584 | `	/* Set the desired flags according to the open mode */` |
| 28944 |  585 | `	if( iOpenMode & PH7_IO_OPEN_CREATE ){` |
|     - |  586 | `		/* Open existing file, or create if it doesn't exist */` |
| 13298 |  587 | `		iOpen = O_CREAT;` |
| 13298 |  588 | `		if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  589 | `			/* If the specified file exists and is writable, the function overwrites the file */` |
| 13298 |  590 | `			iOpen \|= O_TRUNC;` |
|  6649 |  591 | `			SXUNUSED(pResource); /* cc warning */` |
|  6649 |  592 | `		}` |
| 22295 |  593 | `	}else if( iOpenMode & PH7_IO_OPEN_EXCL ){` |
|     - |  594 | `		/* Creates a new file, only if it does not already exist.` |
|     - |  595 | `		* If the file exists, it fails.` |
|     - |  596 | `		*/` |
|   ! 0 |  597 | `		iOpen = O_CREAT\|O_EXCL;` |
| 15646 |  598 | `	}else if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  599 | `		/* Opens a file and truncates it so that its size is zero bytes` |
|     - |  600 | `		 * The file must exist.` |
|     - |  601 | `		 */` |
|   ! 0 |  602 | `		iOpen = O_RDWR\|O_TRUNC;` |
|   ! 0 |  603 | `	}` |
| 28944 |  604 | `	if( iOpenMode & PH7_IO_OPEN_RDWR ){` |
|     - |  605 | `		/* Read+Write access */` |
| 13282 |  606 | `		iOpen &= ~O_RDONLY;` |
| 13282 |  607 | `		iOpen \|= O_RDWR;` |
| 22303 |  608 | `	}else if( iOpenMode & PH7_IO_OPEN_WRONLY ){` |
|     - |  609 | `		/* Write only access */` |
|    22 |  610 | `		iOpen &= ~O_RDONLY;` |
|    22 |  611 | `		iOpen \|= O_WRONLY;` |
|    11 |  612 | `	}` |
| 28944 |  613 | `	if( iOpenMode & PH7_IO_OPEN_APPEND ){` |
|     - |  614 | `		/* Append mode */` |
...
| 28944 |  624 | `	fd = open(zPath,iOpen,PH7_UNIX_OPEN_MODE);` |
| 28944 |  625 | `	if( fd < 0 ){` |
|     - |  626 | `		/* IO error */` |
|    12 |  627 | `		return -1;` |
|     - |  628 | `	}` |
|     - |  629 | `	/* Save the handle */` |
| 28932 |  630 | `	*ppHandle = SX_INT_TO_PTR(fd);` |
| 28932 |  631 | `	return PH7_OK;` |
| 14472 |  632 |  |
|     - |  633 | `/* int (*xOpenDir)(const char *,ph7_value *,void **) */` |
|   962 |  634 | `static int UnixDir_Open(const char *zPath,ph7_value *pResource,void **ppHandle)` |
|     - |  635 |  |
|     - |  636 | `	DIR *pDir;` |
|     - |  637 | `	/* Open the target directory */` |
|   962 |  638 | `	pDir = opendir(zPath);` |
|   962 |  639 | `	if( pDir == 0 ){` |
|   ! 0 |  640 | `		SXUNUSED(pResource); /* Compiler warning */` |
|   ! 0 |  641 | `		return -1;` |
|     - |  642 | `	}` |
|     - |  643 | `	/* Save our structure */` |
|   962 |  644 | `	*ppHandle = pDir;` |
|   962 |  645 | `	return PH7_OK;` |
|   481 |  646 |  |
|     - |  647 | `/* void (*xCloseDir)(void *) */` |
|   962 |  648 | `static void UnixDir_Close(void *pUserData)` |
|     - |  649 |  |
|   962 |  650 | `	closedir((DIR *)pUserData);` |
|   962 |  651 |  |
|     - |  652 | `/* void (*xClose)(void *); */` |
| 28930 |  653 | `static void UnixFile_Close(void *pUserData)` |
|     - |  654 |  |
| 28930 |  655 | `	close(SX_PTR_TO_INT(pUserData));` |
| 28930 |  656 |  |
|     - |  657 | `/* int (*xReadDir)(void *,ph7_context *) */` |
|  7674 |  658 | `static int UnixDir_Read(void *pUserData,ph7_context *pCtx)` |
|     - |  659 |  |
|  7674 |  660 | `	DIR *pDir = (DIR *)pUserData;` |
|     - |  661 | `	struct dirent *pEntry;` |
|  7674 |  662 | `	char *zName = 0; /* cc warning */` |
|  7674 |  663 | `	sxu32 n = 0;` |
|  4801 |  664 | `	for(;;){` |
|  9598 |  665 | `		pEntry = readdir(pDir);` |
|  9598 |  666 | `		if( pEntry == 0 ){` |
|     - |  667 | `			/* No more entries to process */` |
|   960 |  668 | `			return -1;` |
|     - |  669 | `		}` |
|  8638 |  670 | `		zName = pEntry->d_name;` |
|  8638 |  671 | `		n = SyStrlen(zName);` |
|     - |  672 | `		/* Ignore '.' && '..' */` |
|  8638 |  673 | `		if( n > sizeof("..")-1 \|\| zName[0] != '.' \|\| ( n == sizeof("..")-1 && zName[1] != '.') ){` |
|  3357 |  674 | `			break;` |
|     - |  675 | `		}` |
|     - |  676 | `		/* Next entry */` |
|     - |  677 | `	}` |
|     - |  678 | `	/* Return the current file name */` |
|  6714 |  679 | `	ph7_result_string(pCtx,zName,(int)n);` |
|  6714 |  680 | `	return PH7_OK;` |
|  3837 |  681 |  |
...
| 31210 |  688 | `static ph7_int64 UnixFile_Read(void *pUserData,void *pBuffer,ph7_int64 nDatatoRead)` |
|     - |  689 |  |
|     - |  690 | `	ssize_t nRd;` |
| 31210 |  691 | `	nRd = read(SX_PTR_TO_INT(pUserData),pBuffer,(size_t)nDatatoRead);` |
| 31210 |  692 | `	if( nRd < 1 ){` |
|     - |  693 | `		/* EOF or IO error */` |
| 15600 |  694 | `		return -1;` |
|     - |  695 | `	}` |
| 15610 |  696 | `	return (ph7_int64)nRd;` |
| 15605 |  697 |  |
|     - |  698 | `/* ph7_int64 (*xWrite)(void *,const void *,ph7_int64); */` |
| 13320 |  699 | `static ph7_int64 UnixFile_Write(void *pUserData,const void *pBuffer,ph7_int64 nWrite)` |
|     - |  700 |  |
| 13320 |  701 | `	const char *zData = (const char *)pBuffer;` |
| 13320 |  702 | `	int fd = SX_PTR_TO_INT(pUserData);` |
|     - |  703 | `	ph7_int64 nCount;` |
|     - |  704 | `	ssize_t nWr;` |
| 13320 |  705 | `	nCount = 0;` |
| 13320 |  706 | `	for(;;){` |
| 26640 |  707 | `		if( nWrite < 1 ){` |
| 13320 |  708 | `			break;` |
|     - |  709 | `		}` |
| 13320 |  710 | `		nWr = write(fd,zData,(size_t)nWrite);` |
| 13320 |  711 | `		if( nWr < 1 ){` |
|     - |  712 | `			/* IO error */` |
|   ! 0 |  713 | `			break;` |
|     - |  714 | `		}` |
| 13320 |  715 | `		nWrite -= nWr;` |
| 13320 |  716 | `		nCount += nWr;` |
| 13320 |  717 | `		zData += nWr;` |
|     - |  718 | `	}` |
| 13320 |  719 | `	if( nWrite > 0 ){` |
|   ! 0 |  720 | `		return -1;` |
|     - |  721 | `	}` |
| 13320 |  722 | `	return nCount;` |
|  6660 |  723 |  |
