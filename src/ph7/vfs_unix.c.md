...
| 13548 |   29 | `static int UnixVfs_chdir(const char *zPath)` |
|     - |   30 |  |
|     - |   31 | `  int rc;` |
| 13548 |   32 | `  rc = chdir(zPath);` |
| 13548 |   33 | `  return rc == 0 ? PH7_OK : -1;` |
|     - |   34 |  |
...
|  7952 |   64 | `static int UnixVfs_isdir(const char *zPath)` |
|     - |   65 |  |
|     - |   66 | `	struct stat st;` |
|     - |   67 | `	int rc;` |
|  7952 |   68 | `	rc = stat(zPath,&st);` |
|  7952 |   69 | `	if( rc != 0 ){` |
|     4 |   70 | `	 return -1;` |
|     - |   71 | `	}` |
|  7948 |   72 | `	rc = S_ISDIR(st.st_mode);` |
|  7948 |   73 | `	return rc ? PH7_OK : -1 ;` |
|  3976 |   74 |  |
...
| 30248 |  108 | `static int UnixVfs_unlink(const char *zPath)` |
|     - |  109 |  |
|     - |  110 | `	int rc;` |
| 30248 |  111 | `	rc = unlink(zPath);` |
| 30248 |  112 | `	return rc == 0 ? PH7_OK : -1 ;` |
|     - |  113 |  |
...
|  6022 |  320 | `static int UnixVfs_isfile(const char *zPath)` |
|     - |  321 |  |
|     - |  322 | `	struct stat st;` |
|     - |  323 | `	int rc;` |
|  6022 |  324 | `	rc = stat(zPath,&st);` |
|  6022 |  325 | `	if( rc != 0 ){` |
|     2 |  326 | `	 return -1;` |
|     - |  327 | `	}` |
|  6020 |  328 | `	rc = S_ISREG(st.st_mode);` |
|  6020 |  329 | `	return rc ? PH7_OK : -1 ;` |
|  3011 |  330 |  |
...
| 29990 |  580 | `static int UnixFile_Open(const char *zPath,int iOpenMode,ph7_value *pResource,void **ppHandle)` |
|     - |  581 |  |
| 29990 |  582 | `	int iOpen = O_RDONLY;` |
|     - |  583 | `	int fd;` |
|     - |  584 | `	/* Set the desired flags according to the open mode */` |
| 29990 |  585 | `	if( iOpenMode & PH7_IO_OPEN_CREATE ){` |
|     - |  586 | `		/* Open existing file, or create if it doesn't exist */` |
| 13810 |  587 | `		iOpen = O_CREAT;` |
| 13810 |  588 | `		if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  589 | `			/* If the specified file exists and is writable, the function overwrites the file */` |
| 13810 |  590 | `			iOpen \|= O_TRUNC;` |
|  6905 |  591 | `			SXUNUSED(pResource); /* cc warning */` |
|  6905 |  592 | `		}` |
| 23085 |  593 | `	}else if( iOpenMode & PH7_IO_OPEN_EXCL ){` |
|     - |  594 | `		/* Creates a new file, only if it does not already exist.` |
|     - |  595 | `		* If the file exists, it fails.` |
|     - |  596 | `		*/` |
|   ! 0 |  597 | `		iOpen = O_CREAT\|O_EXCL;` |
| 16180 |  598 | `	}else if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  599 | `		/* Opens a file and truncates it so that its size is zero bytes` |
|     - |  600 | `		 * The file must exist.` |
|     - |  601 | `		 */` |
|   ! 0 |  602 | `		iOpen = O_RDWR\|O_TRUNC;` |
|   ! 0 |  603 | `	}` |
| 29990 |  604 | `	if( iOpenMode & PH7_IO_OPEN_RDWR ){` |
|     - |  605 | `		/* Read+Write access */` |
| 13794 |  606 | `		iOpen &= ~O_RDONLY;` |
| 13794 |  607 | `		iOpen \|= O_RDWR;` |
| 23093 |  608 | `	}else if( iOpenMode & PH7_IO_OPEN_WRONLY ){` |
|     - |  609 | `		/* Write only access */` |
|    22 |  610 | `		iOpen &= ~O_RDONLY;` |
|    22 |  611 | `		iOpen \|= O_WRONLY;` |
|    11 |  612 | `	}` |
| 29990 |  613 | `	if( iOpenMode & PH7_IO_OPEN_APPEND ){` |
|     - |  614 | `		/* Append mode */` |
...
| 29990 |  624 | `	fd = open(zPath,iOpen,PH7_UNIX_OPEN_MODE);` |
| 29990 |  625 | `	if( fd < 0 ){` |
|     - |  626 | `		/* IO error */` |
|    12 |  627 | `		return -1;` |
|     - |  628 | `	}` |
|     - |  629 | `	/* Save the handle */` |
| 29978 |  630 | `	*ppHandle = SX_INT_TO_PTR(fd);` |
| 29978 |  631 | `	return PH7_OK;` |
| 14995 |  632 |  |
...
| 29976 |  653 | `static void UnixFile_Close(void *pUserData)` |
|     - |  654 |  |
| 29976 |  655 | `	close(SX_PTR_TO_INT(pUserData));` |
| 29976 |  656 |  |
|     - |  657 | `/* int (*xReadDir)(void *,ph7_context *) */` |
|  7950 |  658 | `static int UnixDir_Read(void *pUserData,ph7_context *pCtx)` |
|     - |  659 |  |
|  7950 |  660 | `	DIR *pDir = (DIR *)pUserData;` |
|     - |  661 | `	struct dirent *pEntry;` |
|  7950 |  662 | `	char *zName = 0; /* cc warning */` |
|  7950 |  663 | `	sxu32 n = 0;` |
|  4945 |  664 | `	for(;;){` |
|  9886 |  665 | `		pEntry = readdir(pDir);` |
|  9886 |  666 | `		if( pEntry == 0 ){` |
|     - |  667 | `			/* No more entries to process */` |
|   966 |  668 | `			return -1;` |
|     - |  669 | `		}` |
|  8920 |  670 | `		zName = pEntry->d_name;` |
|  8920 |  671 | `		n = SyStrlen(zName);` |
|     - |  672 | `		/* Ignore '.' && '..' */` |
|  8920 |  673 | `		if( n > sizeof("..")-1 \|\| zName[0] != '.' \|\| ( n == sizeof("..")-1 && zName[1] != '.') ){` |
|  3492 |  674 | `			break;` |
|     - |  675 | `		}` |
|     - |  676 | `		/* Next entry */` |
|     - |  677 | `	}` |
|     - |  678 | `	/* Return the current file name */` |
|  6984 |  679 | `	ph7_result_string(pCtx,zName,(int)n);` |
|  6984 |  680 | `	return PH7_OK;` |
|  3975 |  681 |  |
...
| 32278 |  688 | `static ph7_int64 UnixFile_Read(void *pUserData,void *pBuffer,ph7_int64 nDatatoRead)` |
|     - |  689 |  |
|     - |  690 | `	ssize_t nRd;` |
| 32278 |  691 | `	nRd = read(SX_PTR_TO_INT(pUserData),pBuffer,(size_t)nDatatoRead);` |
| 32278 |  692 | `	if( nRd < 1 ){` |
|     - |  693 | `		/* EOF or IO error */` |
| 16134 |  694 | `		return -1;` |
|     - |  695 | `	}` |
| 16144 |  696 | `	return (ph7_int64)nRd;` |
| 16139 |  697 |  |
|     - |  698 | `/* ph7_int64 (*xWrite)(void *,const void *,ph7_int64); */` |
| 13832 |  699 | `static ph7_int64 UnixFile_Write(void *pUserData,const void *pBuffer,ph7_int64 nWrite)` |
|     - |  700 |  |
| 13832 |  701 | `	const char *zData = (const char *)pBuffer;` |
| 13832 |  702 | `	int fd = SX_PTR_TO_INT(pUserData);` |
|     - |  703 | `	ph7_int64 nCount;` |
|     - |  704 | `	ssize_t nWr;` |
| 13832 |  705 | `	nCount = 0;` |
| 13832 |  706 | `	for(;;){` |
| 27664 |  707 | `		if( nWrite < 1 ){` |
| 13832 |  708 | `			break;` |
|     - |  709 | `		}` |
| 13832 |  710 | `		nWr = write(fd,zData,(size_t)nWrite);` |
| 13832 |  711 | `		if( nWr < 1 ){` |
|     - |  712 | `			/* IO error */` |
|   ! 0 |  713 | `			break;` |
|     - |  714 | `		}` |
| 13832 |  715 | `		nWrite -= nWr;` |
| 13832 |  716 | `		nCount += nWr;` |
| 13832 |  717 | `		zData += nWr;` |
|     - |  718 | `	}` |
| 13832 |  719 | `	if( nWrite > 0 ){` |
|   ! 0 |  720 | `		return -1;` |
|     - |  721 | `	}` |
| 13832 |  722 | `	return nCount;` |
|  6916 |  723 |  |
