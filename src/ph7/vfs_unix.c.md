...
| 11484 |   29 | `static int UnixVfs_chdir(const char *zPath)` |
|     - |   30 |  |
|     - |   31 | `  int rc;` |
| 11484 |   32 | `  rc = chdir(zPath);` |
| 11484 |   33 | `  return rc == 0 ? PH7_OK : -1;` |
|     - |   34 |  |
...
|  6770 |   64 | `static int UnixVfs_isdir(const char *zPath)` |
|     - |   65 |  |
|     - |   66 | `	struct stat st;` |
|     - |   67 | `	int rc;` |
|  6770 |   68 | `	rc = stat(zPath,&st);` |
|  6770 |   69 | `	if( rc != 0 ){` |
|     4 |   70 | `	 return -1;` |
|     - |   71 | `	}` |
|  6766 |   72 | `	rc = S_ISDIR(st.st_mode);` |
|  6766 |   73 | `	return rc ? PH7_OK : -1 ;` |
|  3385 |   74 |  |
...
| 25048 |  108 | `static int UnixVfs_unlink(const char *zPath)` |
|     - |  109 |  |
|     - |  110 | `	int rc;` |
| 25048 |  111 | `	rc = unlink(zPath);` |
| 25048 |  112 | `	return rc == 0 ? PH7_OK : -1 ;` |
|     - |  113 |  |
...
|  4982 |  320 | `static int UnixVfs_isfile(const char *zPath)` |
|     - |  321 |  |
|     - |  322 | `	struct stat st;` |
|     - |  323 | `	int rc;` |
|  4982 |  324 | `	rc = stat(zPath,&st);` |
|  4982 |  325 | `	if( rc != 0 ){` |
|     2 |  326 | `	 return -1;` |
|     - |  327 | `	}` |
|  4980 |  328 | `	rc = S_ISREG(st.st_mode);` |
|  4980 |  329 | `	return rc ? PH7_OK : -1 ;` |
|  2491 |  330 |  |
...
|  2860 |  411 | `static int UnixVfs_Mmap(const char *zPath,void **ppMap,ph7_int64 *pSize)` |
|     - |  412 |  |
|     - |  413 | `	struct stat st;` |
|     - |  414 | `	void *pMap;` |
|     - |  415 | `	int fd;` |
...
|  2860 |  418 | `	fd = open(zPath,O_RDONLY);` |
|  2860 |  419 | `	if( fd < 0 ){` |
|     2 |  420 | `		return -1;` |
|     - |  421 | `	}` |
|     - |  422 | `	/* stat the handle */` |
|  2858 |  423 | `	fstat(fd,&st);` |
|     - |  424 | `	/* Obtain a memory view of the whole file */` |
|  2858 |  425 | `	pMap = mmap(0,st.st_size,PROT_READ,MAP_PRIVATE\|MAP_FILE,fd,0);` |
|  2858 |  426 | `	rc = PH7_OK;` |
|  2858 |  427 | `	if( pMap == MAP_FAILED ){` |
|   ! 0 |  428 | `		rc = -1;` |
|   ! 0 |  429 | `	}else{` |
|     - |  430 | `		/* Point to the memory view */` |
|  2858 |  431 | `		*ppMap = pMap;` |
|  2858 |  432 | `		*pSize = (ph7_int64)st.st_size;` |
|     - |  433 | `	}` |
|  2858 |  434 | `	close(fd);` |
|  2858 |  435 | `	return rc;` |
|  1430 |  436 |  |
|     - |  437 | `/* void (*xUnmap)(void *,ph7_int64)  */` |
|  2858 |  438 | `static void UnixVfs_Unmap(void *pView,ph7_int64 nSize)` |
|     - |  439 |  |
|  2858 |  440 | `	munmap(pView,(size_t)nSize);` |
|  2858 |  441 |  |
...
| 25482 |  580 | `static int UnixFile_Open(const char *zPath,int iOpenMode,ph7_value *pResource,void **ppHandle)` |
|     - |  581 |  |
| 25482 |  582 | `	int iOpen = O_RDONLY;` |
|     - |  583 | `	int fd;` |
|     - |  584 | `	/* Set the desired flags according to the open mode */` |
| 25482 |  585 | `	if( iOpenMode & PH7_IO_OPEN_CREATE ){` |
|     - |  586 | `		/* Open existing file, or create if it doesn't exist */` |
| 11718 |  587 | `		iOpen = O_CREAT;` |
| 11718 |  588 | `		if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  589 | `			/* If the specified file exists and is writable, the function overwrites the file */` |
| 11718 |  590 | `			iOpen \|= O_TRUNC;` |
|  5859 |  591 | `			SXUNUSED(pResource); /* cc warning */` |
|  5859 |  592 | `		}` |
| 19623 |  593 | `	}else if( iOpenMode & PH7_IO_OPEN_EXCL ){` |
|     - |  594 | `		/* Creates a new file, only if it does not already exist.` |
|     - |  595 | `		* If the file exists, it fails.` |
|     - |  596 | `		*/` |
|   ! 0 |  597 | `		iOpen = O_CREAT\|O_EXCL;` |
| 13764 |  598 | `	}else if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  599 | `		/* Opens a file and truncates it so that its size is zero bytes` |
|     - |  600 | `		 * The file must exist.` |
|     - |  601 | `		 */` |
|   ! 0 |  602 | `		iOpen = O_RDWR\|O_TRUNC;` |
|   ! 0 |  603 | `	}` |
| 25482 |  604 | `	if( iOpenMode & PH7_IO_OPEN_RDWR ){` |
|     - |  605 | `		/* Read+Write access */` |
| 11702 |  606 | `		iOpen &= ~O_RDONLY;` |
| 11702 |  607 | `		iOpen \|= O_RDWR;` |
| 19631 |  608 | `	}else if( iOpenMode & PH7_IO_OPEN_WRONLY ){` |
|     - |  609 | `		/* Write only access */` |
|    22 |  610 | `		iOpen &= ~O_RDONLY;` |
|    22 |  611 | `		iOpen \|= O_WRONLY;` |
|    11 |  612 | `	}` |
| 25482 |  613 | `	if( iOpenMode & PH7_IO_OPEN_APPEND ){` |
|     - |  614 | `		/* Append mode */` |
...
| 25482 |  624 | `	fd = open(zPath,iOpen,PH7_UNIX_OPEN_MODE);` |
| 25482 |  625 | `	if( fd < 0 ){` |
|     - |  626 | `		/* IO error */` |
|    12 |  627 | `		return -1;` |
|     - |  628 | `	}` |
|     - |  629 | `	/* Save the handle */` |
| 25470 |  630 | `	*ppHandle = SX_INT_TO_PTR(fd);` |
| 25470 |  631 | `	return PH7_OK;` |
| 12741 |  632 |  |
...
| 25468 |  653 | `static void UnixFile_Close(void *pUserData)` |
|     - |  654 |  |
| 25468 |  655 | `	close(SX_PTR_TO_INT(pUserData));` |
| 25468 |  656 |  |
|     - |  657 | `/* int (*xReadDir)(void *,ph7_context *) */` |
|  6768 |  658 | `static int UnixDir_Read(void *pUserData,ph7_context *pCtx)` |
|     - |  659 |  |
|  6768 |  660 | `	DIR *pDir = (DIR *)pUserData;` |
|     - |  661 | `	struct dirent *pEntry;` |
|  6768 |  662 | `	char *zName = 0; /* cc warning */` |
|  6768 |  663 | `	sxu32 n = 0;` |
|  4282 |  664 | `	for(;;){` |
|  8562 |  665 | `		pEntry = readdir(pDir);` |
|  8562 |  666 | `		if( pEntry == 0 ){` |
|     - |  667 | `			/* No more entries to process */` |
|   894 |  668 | `			return -1;` |
|     - |  669 | `		}` |
|  7668 |  670 | `		zName = pEntry->d_name;` |
|  7668 |  671 | `		n = SyStrlen(zName);` |
|     - |  672 | `		/* Ignore '.' && '..' */` |
|  7668 |  673 | `		if( n > sizeof("..")-1 \|\| zName[0] != '.' \|\| ( n == sizeof("..")-1 && zName[1] != '.') ){` |
|  2937 |  674 | `			break;` |
|     - |  675 | `		}` |
|     - |  676 | `		/* Next entry */` |
|     - |  677 | `	}` |
|     - |  678 | `	/* Return the current file name */` |
|  5874 |  679 | `	ph7_result_string(pCtx,zName,(int)n);` |
|  5874 |  680 | `	return PH7_OK;` |
|  3384 |  681 |  |
...
| 27454 |  688 | `static ph7_int64 UnixFile_Read(void *pUserData,void *pBuffer,ph7_int64 nDatatoRead)` |
|     - |  689 |  |
|     - |  690 | `	ssize_t nRd;` |
| 27454 |  691 | `	nRd = read(SX_PTR_TO_INT(pUserData),pBuffer,(size_t)nDatatoRead);` |
| 27454 |  692 | `	if( nRd < 1 ){` |
|     - |  693 | `		/* EOF or IO error */` |
| 13722 |  694 | `		return -1;` |
|     - |  695 | `	}` |
| 13732 |  696 | `	return (ph7_int64)nRd;` |
| 13727 |  697 |  |
|     - |  698 | `/* ph7_int64 (*xWrite)(void *,const void *,ph7_int64); */` |
| 11740 |  699 | `static ph7_int64 UnixFile_Write(void *pUserData,const void *pBuffer,ph7_int64 nWrite)` |
|     - |  700 |  |
| 11740 |  701 | `	const char *zData = (const char *)pBuffer;` |
| 11740 |  702 | `	int fd = SX_PTR_TO_INT(pUserData);` |
|     - |  703 | `	ph7_int64 nCount;` |
|     - |  704 | `	ssize_t nWr;` |
| 11740 |  705 | `	nCount = 0;` |
| 11740 |  706 | `	for(;;){` |
| 23480 |  707 | `		if( nWrite < 1 ){` |
| 11740 |  708 | `			break;` |
|     - |  709 | `		}` |
| 11740 |  710 | `		nWr = write(fd,zData,(size_t)nWrite);` |
| 11740 |  711 | `		if( nWr < 1 ){` |
|     - |  712 | `			/* IO error */` |
|   ! 0 |  713 | `			break;` |
|     - |  714 | `		}` |
| 11740 |  715 | `		nWrite -= nWr;` |
| 11740 |  716 | `		nCount += nWr;` |
| 11740 |  717 | `		zData += nWr;` |
|     - |  718 | `	}` |
| 11740 |  719 | `	if( nWrite > 0 ){` |
|   ! 0 |  720 | `		return -1;` |
|     - |  721 | `	}` |
| 11740 |  722 | `	return nCount;` |
|  5870 |  723 |  |
