...
|     - |   38 | ` */` |
| 53208 |   39 | `static const char * UnixVfsLocalPath(const char *zPath)` |
|     - |   40 | `{` |
|     - |   41 | `	const char *zRest;` |
| 53208 |   42 | `	if( zPath == 0 \|\| SyStrnicmp(zPath,"file://",sizeof("file://")-1) != 0 ){` |
| 53198 |   43 | `		return zPath;` |
|     - |   44 | `	}` |
...
| 13194 |   57 | `static int UnixVfs_chdir(const char *zPath)` |
|     - |   58 | `{` |
|     - |   59 | `  int rc;` |
| 13194 |   60 | `  rc = chdir(zPath);` |
| 13194 |   61 | `  return rc == 0 ? PH7_OK : -1;` |
|     - |   62 | `}` |
...
|  8766 |   94 | `static int UnixVfs_isdir(const char *zPath)` |
|     - |   95 | `{` |
|  8766 |   96 | `	zPath = UnixVfsLocalPath(zPath);` |
|     - |   97 | `	struct stat st;` |
|     - |   98 | `	int rc;` |
|  8766 |   99 | `	rc = stat(zPath,&st);` |
|  8766 |  100 | `	if( rc != 0 ){` |
|     4 |  101 | `	 return -1;` |
|     - |  102 | `	}` |
|  8762 |  103 | `	rc = S_ISDIR(st.st_mode);` |
|  8762 |  104 | `	return rc ? PH7_OK : -1 ;` |
|  4383 |  105 | `}` |
...
| 33336 |  141 | `static int UnixVfs_unlink(const char *zPath)` |
|     - |  142 | `{` |
| 33336 |  143 | `	zPath = UnixVfsLocalPath(zPath);` |
|     - |  144 | `	int rc;` |
| 33336 |  145 | `	rc = unlink(zPath);` |
| 33336 |  146 | `	return rc == 0 ? PH7_OK : -1 ;` |
|     - |  147 | `}` |
...
|  6692 |  400 | `static int UnixVfs_isfile(const char *zPath)` |
|     - |  401 | `{` |
|  6692 |  402 | `	zPath = UnixVfsLocalPath(zPath);` |
|     - |  403 | `	struct stat st;` |
|     - |  404 | `	int rc;` |
|  6692 |  405 | `	rc = stat(zPath,&st);` |
|  6692 |  406 | `	if( rc != 0 ){` |
|    54 |  407 | `	 return -1;` |
|     - |  408 | `	}` |
|  6638 |  409 | `	rc = S_ISREG(st.st_mode);` |
|  6638 |  410 | `	return rc ? PH7_OK : -1 ;` |
|  3346 |  411 | `}` |
...
| 29800 |  661 | `static int UnixFile_Open(const char *zPath,int iOpenMode,ph7_value *pResource,void **ppHandle)` |
|     - |  662 | `{` |
| 29800 |  663 | `	int iOpen = O_RDONLY;` |
|     - |  664 | `	int fd;` |
|     - |  665 | `	/* Set the desired flags according to the open mode */` |
| 29800 |  666 | `	if( iOpenMode & PH7_IO_OPEN_CREATE ){` |
|     - |  667 | `		/* Open existing file, or create if it doesn't exist */` |
| 13500 |  668 | `		iOpen = O_CREAT;` |
| 13500 |  669 | `		if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  670 | `			/* If the specified file exists and is writable, the function overwrites the file */` |
| 13500 |  671 | `			iOpen \|= O_TRUNC;` |
|  6750 |  672 | `			SXUNUSED(pResource); /* cc warning */` |
|  6750 |  673 | `		}` |
| 23050 |  674 | `	}else if( iOpenMode & PH7_IO_OPEN_EXCL ){` |
|     - |  675 | `		/* Creates a new file, only if it does not already exist.` |
|     - |  676 | `		* If the file exists, it fails.` |
|     - |  677 | `		*/` |
|   136 |  678 | `		iOpen = O_CREAT\|O_EXCL;` |
| 16232 |  679 | `	}else if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  680 | `		/* Opens a file and truncates it so that its size is zero bytes` |
|     - |  681 | `		 * The file must exist.` |
|     - |  682 | `		 */` |
|   ! 0 |  683 | `		iOpen = O_RDWR\|O_TRUNC;` |
|   ! 0 |  684 | `	}` |
| 29800 |  685 | `	if( iOpenMode & PH7_IO_OPEN_RDWR ){` |
|     - |  686 | `		/* Read+Write access */` |
| 13482 |  687 | `		iOpen &= ~O_RDONLY;` |
| 13482 |  688 | `		iOpen \|= O_RDWR;` |
| 23059 |  689 | `	}else if( iOpenMode & PH7_IO_OPEN_WRONLY ){` |
|     - |  690 | `		/* Write only access */` |
|   160 |  691 | `		iOpen &= ~O_RDONLY;` |
|   160 |  692 | `		iOpen \|= O_WRONLY;` |
|    80 |  693 | `	}` |
| 29800 |  694 | `	if( iOpenMode & PH7_IO_OPEN_APPEND ){` |
|     - |  695 | `		/* Append mode */` |
...
| 29800 |  705 | `	fd = open(zPath,iOpen,PH7_UNIX_OPEN_MODE);` |
| 29800 |  706 | `	if( fd < 0 ){` |
|     - |  707 | `		/* IO error */` |
|    20 |  708 | `		return -1;` |
|     - |  709 | `	}` |
|     - |  710 | `	/* Save the handle */` |
| 29780 |  711 | `	*ppHandle = SX_INT_TO_PTR(fd);` |
| 29780 |  712 | `	return PH7_OK;` |
| 14900 |  713 | `}` |
...
| 29806 |  734 | `static void UnixFile_Close(void *pUserData)` |
|     - |  735 | `{` |
| 29806 |  736 | `	close(SX_PTR_TO_INT(pUserData));` |
| 29806 |  737 | `}` |
|     - |  738 | `/* int (*xReadDir)(void *,ph7_context *) */` |
| 10938 |  739 | `static int UnixDir_Read(void *pUserData,ph7_context *pCtx)` |
|     - |  740 | `{` |
| 10938 |  741 | `	DIR *pDir = (DIR *)pUserData;` |
|     - |  742 | `	struct dirent *pEntry;` |
|     - |  743 | `	char *zName;` |
|     - |  744 | `	sxu32 n;` |
|     - |  745 | `	/* php's readdir() yields every entry including '.' and '..' */` |
| 10938 |  746 | `	pEntry = readdir(pDir);` |
| 10938 |  747 | `	if( pEntry == 0 ){` |
|     - |  748 | `		/* No more entries to process */` |
|  1068 |  749 | `		return -1;` |
|     - |  750 | `	}` |
|  9870 |  751 | `	zName = pEntry->d_name;` |
|  9870 |  752 | `	n = SyStrlen(zName);` |
|     - |  753 | `	/* Return the current file name */` |
|  9870 |  754 | `	ph7_result_string(pCtx,zName,(int)n);` |
|  9870 |  755 | `	return PH7_OK;` |
|  5469 |  756 | `}` |
...
| 32246 |  763 | `static ph7_int64 UnixFile_Read(void *pUserData,void *pBuffer,ph7_int64 nDatatoRead)` |
|     - |  764 | `{` |
|     - |  765 | `	ssize_t nRd;` |
| 32246 |  766 | `	nRd = read(SX_PTR_TO_INT(pUserData),pBuffer,(size_t)nDatatoRead);` |
| 32246 |  767 | `	if( nRd < 1 ){` |
|     - |  768 | `		/* EOF or IO error */` |
| 16124 |  769 | `		return -1;` |
|     - |  770 | `	}` |
| 16122 |  771 | `	return (ph7_int64)nRd;` |
| 16123 |  772 | `}` |
|     - |  773 | `/* ph7_int64 (*xWrite)(void *,const void *,ph7_int64); */` |
| 13520 |  774 | `static ph7_int64 UnixFile_Write(void *pUserData,const void *pBuffer,ph7_int64 nWrite)` |
|     - |  775 | `{` |
| 13520 |  776 | `	const char *zData = (const char *)pBuffer;` |
| 13520 |  777 | `	int fd = SX_PTR_TO_INT(pUserData);` |
|     - |  778 | `	ph7_int64 nCount;` |
|     - |  779 | `	ssize_t nWr;` |
| 13520 |  780 | `	nCount = 0;` |
| 13520 |  781 | `	for(;;){` |
| 27040 |  782 | `		if( nWrite < 1 ){` |
| 13520 |  783 | `			break;` |
|     - |  784 | `		}` |
| 13520 |  785 | `		nWr = write(fd,zData,(size_t)nWrite);` |
| 13520 |  786 | `		if( nWr < 1 ){` |
|     - |  787 | `			/* IO error */` |
|   ! 0 |  788 | `			break;` |
|     - |  789 | `		}` |
| 13520 |  790 | `		nWrite -= nWr;` |
| 13520 |  791 | `		nCount += nWr;` |
| 13520 |  792 | `		zData += nWr;` |
|     - |  793 | `	}` |
| 13520 |  794 | `	if( nWrite > 0 ){` |
|   ! 0 |  795 | `		return -1;` |
|     - |  796 | `	}` |
| 13520 |  797 | `	return nCount;` |
|  6760 |  798 | `}` |
