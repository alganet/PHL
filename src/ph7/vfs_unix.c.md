...
| 11316 |   29 | `static int UnixVfs_chdir(const char *zPath)` |
|     - |   30 |  |
|     - |   31 | `  int rc;` |
| 11316 |   32 | `  rc = chdir(zPath);` |
| 11316 |   33 | `  return rc == 0 ? PH7_OK : -1;` |
|     - |   34 |  |
...
|  6686 |   64 | `static int UnixVfs_isdir(const char *zPath)` |
|     - |   65 |  |
|     - |   66 | `	struct stat st;` |
|     - |   67 | `	int rc;` |
|  6686 |   68 | `	rc = stat(zPath,&st);` |
|  6686 |   69 | `	if( rc != 0 ){` |
|     4 |   70 | `	 return -1;` |
|     - |   71 | `	}` |
|  6682 |   72 | `	rc = S_ISDIR(st.st_mode);` |
|  6682 |   73 | `	return rc ? PH7_OK : -1 ;` |
|  3343 |   74 |  |
...
| 24628 |  108 | `static int UnixVfs_unlink(const char *zPath)` |
|     - |  109 |  |
|     - |  110 | `	int rc;` |
| 24628 |  111 | `	rc = unlink(zPath);` |
| 24628 |  112 | `	return rc == 0 ? PH7_OK : -1 ;` |
|     - |  113 |  |
...
|  4898 |  320 | `static int UnixVfs_isfile(const char *zPath)` |
|     - |  321 |  |
|     - |  322 | `	struct stat st;` |
|     - |  323 | `	int rc;` |
|  4898 |  324 | `	rc = stat(zPath,&st);` |
|  4898 |  325 | `	if( rc != 0 ){` |
|     2 |  326 | `	 return -1;` |
|     - |  327 | `	}` |
|  4896 |  328 | `	rc = S_ISREG(st.st_mode);` |
|  4896 |  329 | `	return rc ? PH7_OK : -1 ;` |
|  2449 |  330 |  |
...
|  2824 |  411 | `static int UnixVfs_Mmap(const char *zPath,void **ppMap,ph7_int64 *pSize)` |
|     - |  412 |  |
|     - |  413 | `	struct stat st;` |
|     - |  414 | `	void *pMap;` |
|     - |  415 | `	int fd;` |
...
|  2824 |  418 | `	fd = open(zPath,O_RDONLY);` |
|  2824 |  419 | `	if( fd < 0 ){` |
|     2 |  420 | `		return -1;` |
|     - |  421 | `	}` |
|     - |  422 | `	/* stat the handle */` |
|  2822 |  423 | `	fstat(fd,&st);` |
|     - |  424 | `	/* Obtain a memory view of the whole file */` |
|  2822 |  425 | `	pMap = mmap(0,st.st_size,PROT_READ,MAP_PRIVATE\|MAP_FILE,fd,0);` |
|  2822 |  426 | `	rc = PH7_OK;` |
|  2822 |  427 | `	if( pMap == MAP_FAILED ){` |
|   ! 0 |  428 | `		rc = -1;` |
|   ! 0 |  429 | `	}else{` |
|     - |  430 | `		/* Point to the memory view */` |
|  2822 |  431 | `		*ppMap = pMap;` |
|  2822 |  432 | `		*pSize = (ph7_int64)st.st_size;` |
|     - |  433 | `	}` |
|  2822 |  434 | `	close(fd);` |
|  2822 |  435 | `	return rc;` |
|  1412 |  436 |  |
|     - |  437 | `/* void (*xUnmap)(void *,ph7_int64)  */` |
|  2822 |  438 | `static void UnixVfs_Unmap(void *pView,ph7_int64 nSize)` |
|     - |  439 |  |
|  2822 |  440 | `	munmap(pView,(size_t)nSize);` |
|  2822 |  441 |  |
...
| 25098 |  580 | `static int UnixFile_Open(const char *zPath,int iOpenMode,ph7_value *pResource,void **ppHandle)` |
|     - |  581 |  |
| 25098 |  582 | `	int iOpen = O_RDONLY;` |
|     - |  583 | `	int fd;` |
|     - |  584 | `	/* Set the desired flags according to the open mode */` |
| 25098 |  585 | `	if( iOpenMode & PH7_IO_OPEN_CREATE ){` |
|     - |  586 | `		/* Open existing file, or create if it doesn't exist */` |
| 11550 |  587 | `		iOpen = O_CREAT;` |
| 11550 |  588 | `		if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  589 | `			/* If the specified file exists and is writable, the function overwrites the file */` |
| 11550 |  590 | `			iOpen \|= O_TRUNC;` |
|  5775 |  591 | `			SXUNUSED(pResource); /* cc warning */` |
|  5775 |  592 | `		}` |
| 19323 |  593 | `	}else if( iOpenMode & PH7_IO_OPEN_EXCL ){` |
|     - |  594 | `		/* Creates a new file, only if it does not already exist.` |
|     - |  595 | `		* If the file exists, it fails.` |
|     - |  596 | `		*/` |
|   ! 0 |  597 | `		iOpen = O_CREAT\|O_EXCL;` |
| 13548 |  598 | `	}else if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  599 | `		/* Opens a file and truncates it so that its size is zero bytes` |
|     - |  600 | `		 * The file must exist.` |
|     - |  601 | `		 */` |
|   ! 0 |  602 | `		iOpen = O_RDWR\|O_TRUNC;` |
|   ! 0 |  603 | `	}` |
| 25098 |  604 | `	if( iOpenMode & PH7_IO_OPEN_RDWR ){` |
|     - |  605 | `		/* Read+Write access */` |
| 11534 |  606 | `		iOpen &= ~O_RDONLY;` |
| 11534 |  607 | `		iOpen \|= O_RDWR;` |
| 19331 |  608 | `	}else if( iOpenMode & PH7_IO_OPEN_WRONLY ){` |
|     - |  609 | `		/* Write only access */` |
|    22 |  610 | `		iOpen &= ~O_RDONLY;` |
|    22 |  611 | `		iOpen \|= O_WRONLY;` |
|    11 |  612 | `	}` |
| 25098 |  613 | `	if( iOpenMode & PH7_IO_OPEN_APPEND ){` |
|     - |  614 | `		/* Append mode */` |
...
| 25098 |  624 | `	fd = open(zPath,iOpen,PH7_UNIX_OPEN_MODE);` |
| 25098 |  625 | `	if( fd < 0 ){` |
|     - |  626 | `		/* IO error */` |
|    12 |  627 | `		return -1;` |
|     - |  628 | `	}` |
|     - |  629 | `	/* Save the handle */` |
| 25086 |  630 | `	*ppHandle = SX_INT_TO_PTR(fd);` |
| 25086 |  631 | `	return PH7_OK;` |
| 12549 |  632 |  |
...
| 25084 |  653 | `static void UnixFile_Close(void *pUserData)` |
|     - |  654 |  |
| 25084 |  655 | `	close(SX_PTR_TO_INT(pUserData));` |
| 25084 |  656 |  |
|     - |  657 | `/* int (*xReadDir)(void *,ph7_context *) */` |
|  6684 |  658 | `static int UnixDir_Read(void *pUserData,ph7_context *pCtx)` |
|     - |  659 |  |
|  6684 |  660 | `	DIR *pDir = (DIR *)pUserData;` |
|     - |  661 | `	struct dirent *pEntry;` |
|  6684 |  662 | `	char *zName = 0; /* cc warning */` |
|  6684 |  663 | `	sxu32 n = 0;` |
|  4240 |  664 | `	for(;;){` |
|  8478 |  665 | `		pEntry = readdir(pDir);` |
|  8478 |  666 | `		if( pEntry == 0 ){` |
|     - |  667 | `			/* No more entries to process */` |
|   894 |  668 | `			return -1;` |
|     - |  669 | `		}` |
|  7584 |  670 | `		zName = pEntry->d_name;` |
|  7584 |  671 | `		n = SyStrlen(zName);` |
|     - |  672 | `		/* Ignore '.' && '..' */` |
|  7584 |  673 | `		if( n > sizeof("..")-1 \|\| zName[0] != '.' \|\| ( n == sizeof("..")-1 && zName[1] != '.') ){` |
|  2895 |  674 | `			break;` |
|     - |  675 | `		}` |
|     - |  676 | `		/* Next entry */` |
|     - |  677 | `	}` |
|     - |  678 | `	/* Return the current file name */` |
|  5790 |  679 | `	ph7_result_string(pCtx,zName,(int)n);` |
|  5790 |  680 | `	return PH7_OK;` |
|  3342 |  681 |  |
...
| 27022 |  688 | `static ph7_int64 UnixFile_Read(void *pUserData,void *pBuffer,ph7_int64 nDatatoRead)` |
|     - |  689 |  |
|     - |  690 | `	ssize_t nRd;` |
| 27022 |  691 | `	nRd = read(SX_PTR_TO_INT(pUserData),pBuffer,(size_t)nDatatoRead);` |
| 27022 |  692 | `	if( nRd < 1 ){` |
|     - |  693 | `		/* EOF or IO error */` |
| 13506 |  694 | `		return -1;` |
|     - |  695 | `	}` |
| 13516 |  696 | `	return (ph7_int64)nRd;` |
| 13511 |  697 |  |
|     - |  698 | `/* ph7_int64 (*xWrite)(void *,const void *,ph7_int64); */` |
| 11572 |  699 | `static ph7_int64 UnixFile_Write(void *pUserData,const void *pBuffer,ph7_int64 nWrite)` |
|     - |  700 |  |
| 11572 |  701 | `	const char *zData = (const char *)pBuffer;` |
| 11572 |  702 | `	int fd = SX_PTR_TO_INT(pUserData);` |
|     - |  703 | `	ph7_int64 nCount;` |
|     - |  704 | `	ssize_t nWr;` |
| 11572 |  705 | `	nCount = 0;` |
| 11572 |  706 | `	for(;;){` |
| 23144 |  707 | `		if( nWrite < 1 ){` |
| 11572 |  708 | `			break;` |
|     - |  709 | `		}` |
| 11572 |  710 | `		nWr = write(fd,zData,(size_t)nWrite);` |
| 11572 |  711 | `		if( nWr < 1 ){` |
|     - |  712 | `			/* IO error */` |
|   ! 0 |  713 | `			break;` |
|     - |  714 | `		}` |
| 11572 |  715 | `		nWrite -= nWr;` |
| 11572 |  716 | `		nCount += nWr;` |
| 11572 |  717 | `		zData += nWr;` |
|     - |  718 | `	}` |
| 11572 |  719 | `	if( nWrite > 0 ){` |
|   ! 0 |  720 | `		return -1;` |
|     - |  721 | `	}` |
| 11572 |  722 | `	return nCount;` |
|  5786 |  723 |  |
