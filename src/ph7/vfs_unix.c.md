...
|     - |   38 | ` */` |
| 52566 |   39 | `static const char * UnixVfsLocalPath(const char *zPath)` |
|     - |   40 | `{` |
|     - |   41 | `	const char *zRest;` |
| 52566 |   42 | `	if( zPath == 0 \|\| SyStrnicmp(zPath,"file://",sizeof("file://")-1) != 0 ){` |
| 52556 |   43 | `		return zPath;` |
|     - |   44 | `	}` |
...
| 12840 |   57 | `static int UnixVfs_chdir(const char *zPath)` |
|     - |   58 | `{` |
|     - |   59 | `  int rc;` |
| 12840 |   60 | `  rc = chdir(zPath);` |
| 12840 |   61 | `  return rc == 0 ? PH7_OK : -1;` |
|     - |   62 | `}` |
...
|  8676 |   94 | `static int UnixVfs_isdir(const char *zPath)` |
|     - |   95 | `{` |
|  8676 |   96 | `	zPath = UnixVfsLocalPath(zPath);` |
|     - |   97 | `	struct stat st;` |
|     - |   98 | `	int rc;` |
|  8676 |   99 | `	rc = stat(zPath,&st);` |
|  8676 |  100 | `	if( rc != 0 ){` |
|     4 |  101 | `	 return -1;` |
|     - |  102 | `	}` |
|  8672 |  103 | `	rc = S_ISDIR(st.st_mode);` |
|  8672 |  104 | `	return rc ? PH7_OK : -1 ;` |
|  4338 |  105 | `}` |
...
| 32938 |  141 | `static int UnixVfs_unlink(const char *zPath)` |
|     - |  142 | `{` |
| 32938 |  143 | `	zPath = UnixVfsLocalPath(zPath);` |
|     - |  144 | `	int rc;` |
| 32938 |  145 | `	rc = unlink(zPath);` |
| 32938 |  146 | `	return rc == 0 ? PH7_OK : -1 ;` |
|     - |  147 | `}` |
...
|  6618 |  400 | `static int UnixVfs_isfile(const char *zPath)` |
|     - |  401 | `{` |
|  6618 |  402 | `	zPath = UnixVfsLocalPath(zPath);` |
|     - |  403 | `	struct stat st;` |
|     - |  404 | `	int rc;` |
|  6618 |  405 | `	rc = stat(zPath,&st);` |
|  6618 |  406 | `	if( rc != 0 ){` |
|    54 |  407 | `	 return -1;` |
|     - |  408 | `	}` |
|  6564 |  409 | `	rc = S_ISREG(st.st_mode);` |
|  6564 |  410 | `	return rc ? PH7_OK : -1 ;` |
|  3309 |  411 | `}` |
...
| 13096 |  668 | `		iOpen = O_CREAT;` |
| 13096 |  669 | `		if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  670 | `			/* If the specified file exists and is writable, the function overwrites the file */` |
| 13096 |  671 | `			iOpen \|= O_TRUNC;` |
|  6548 |  672 | `			SXUNUSED(pResource); /* cc warning */` |
|  6548 |  673 | `		}` |
| 22388 |  674 | `	}else if( iOpenMode & PH7_IO_OPEN_EXCL ){` |
|     - |  675 | `		/* Creates a new file, only if it does not already exist.` |
|     - |  676 | `		* If the file exists, it fails.` |
|     - |  677 | `		*/` |
|   126 |  678 | `		iOpen = O_CREAT\|O_EXCL;` |
| 15777 |  679 | `	}else if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
...
| 13074 |  687 | `		iOpen &= ~O_RDONLY;` |
| 13074 |  688 | `		iOpen \|= O_RDWR;` |
| 22399 |  689 | `	}else if( iOpenMode & PH7_IO_OPEN_WRONLY ){` |
...
| 31352 |  763 | `static ph7_int64 UnixFile_Read(void *pUserData,void *pBuffer,ph7_int64 nDatatoRead)` |
|     - |  764 | `{` |
|     - |  765 | `	ssize_t nRd;` |
| 31352 |  766 | `	nRd = read(SX_PTR_TO_INT(pUserData),pBuffer,(size_t)nDatatoRead);` |
| 31352 |  767 | `	if( nRd < 1 ){` |
|     - |  768 | `		/* EOF or IO error */` |
| 15678 |  769 | `		return -1;` |
|     - |  770 | `	}` |
| 15674 |  771 | `	return (ph7_int64)nRd;` |
| 15676 |  772 | `}` |
|     - |  773 | `/* ph7_int64 (*xWrite)(void *,const void *,ph7_int64); */` |
| 13114 |  774 | `static ph7_int64 UnixFile_Write(void *pUserData,const void *pBuffer,ph7_int64 nWrite)` |
|     - |  775 | `{` |
| 13114 |  776 | `	const char *zData = (const char *)pBuffer;` |
| 13114 |  777 | `	int fd = SX_PTR_TO_INT(pUserData);` |
|     - |  778 | `	ph7_int64 nCount;` |
|     - |  779 | `	ssize_t nWr;` |
| 13114 |  780 | `	nCount = 0;` |
| 13114 |  781 | `	for(;;){` |
| 26228 |  782 | `		if( nWrite < 1 ){` |
| 13114 |  783 | `			break;` |
|     - |  784 | `		}` |
| 13114 |  785 | `		nWr = write(fd,zData,(size_t)nWrite);` |
| 13114 |  786 | `		if( nWr < 1 ){` |
|     - |  787 | `			/* IO error */` |
|   ! 0 |  788 | `			break;` |
|     - |  789 | `		}` |
| 13114 |  790 | `		nWrite -= nWr;` |
| 13114 |  791 | `		nCount += nWr;` |
| 13114 |  792 | `		zData += nWr;` |
|     - |  793 | `	}` |
| 13114 |  794 | `	if( nWrite > 0 ){` |
|   ! 0 |  795 | `		return -1;` |
|     - |  796 | `	}` |
| 13114 |  797 | `	return nCount;` |
|  6557 |  798 | `}` |
