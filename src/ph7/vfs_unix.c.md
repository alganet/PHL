...
| 13122 |   31 | `static int UnixVfs_chdir(const char *zPath)` |
|     - |   32 | `{` |
|     - |   33 | `  int rc;` |
| 13122 |   34 | `  rc = chdir(zPath);` |
| 13122 |   35 | `  return rc == 0 ? PH7_OK : -1;` |
|     - |   36 | `}` |
...
|  8508 |   66 | `static int UnixVfs_isdir(const char *zPath)` |
|     - |   67 | `{` |
|     - |   68 | `	struct stat st;` |
|     - |   69 | `	int rc;` |
|  8508 |   70 | `	rc = stat(zPath,&st);` |
|  8508 |   71 | `	if( rc != 0 ){` |
|     4 |   72 | `	 return -1;` |
|     - |   73 | `	}` |
|  8504 |   74 | `	rc = S_ISDIR(st.st_mode);` |
|  8504 |   75 | `	return rc ? PH7_OK : -1 ;` |
|  4254 |   76 | `}` |
...
| 32738 |  110 | `static int UnixVfs_unlink(const char *zPath)` |
|     - |  111 | `{` |
|     - |  112 | `	int rc;` |
| 32738 |  113 | `	rc = unlink(zPath);` |
| 32738 |  114 | `	return rc == 0 ? PH7_OK : -1 ;` |
|     - |  115 | `}` |
...
|  6518 |  355 | `static int UnixVfs_isfile(const char *zPath)` |
|     - |  356 | `{` |
|     - |  357 | `	struct stat st;` |
|     - |  358 | `	int rc;` |
|  6518 |  359 | `	rc = stat(zPath,&st);` |
|  6518 |  360 | `	if( rc != 0 ){` |
|     2 |  361 | `	 return -1;` |
|     - |  362 | `	}` |
|  6516 |  363 | `	rc = S_ISREG(st.st_mode);` |
|  6516 |  364 | `	return rc ? PH7_OK : -1 ;` |
|  3259 |  365 | `}` |
...
| 29528 |  607 | `static int UnixFile_Open(const char *zPath,int iOpenMode,ph7_value *pResource,void **ppHandle)` |
|     - |  608 | `{` |
| 29528 |  609 | `	int iOpen = O_RDONLY;` |
|     - |  610 | `	int fd;` |
|     - |  611 | `	/* Set the desired flags according to the open mode */` |
| 29528 |  612 | `	if( iOpenMode & PH7_IO_OPEN_CREATE ){` |
|     - |  613 | `		/* Open existing file, or create if it doesn't exist */` |
| 13386 |  614 | `		iOpen = O_CREAT;` |
| 13386 |  615 | `		if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  616 | `			/* If the specified file exists and is writable, the function overwrites the file */` |
| 13386 |  617 | `			iOpen \|= O_TRUNC;` |
|  6693 |  618 | `			SXUNUSED(pResource); /* cc warning */` |
|  6693 |  619 | `		}` |
| 22835 |  620 | `	}else if( iOpenMode & PH7_IO_OPEN_EXCL ){` |
|     - |  621 | `		/* Creates a new file, only if it does not already exist.` |
|     - |  622 | `		* If the file exists, it fails.` |
|     - |  623 | `		*/` |
|   124 |  624 | `		iOpen = O_CREAT\|O_EXCL;` |
| 16080 |  625 | `	}else if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  626 | `		/* Opens a file and truncates it so that its size is zero bytes` |
|     - |  627 | `		 * The file must exist.` |
|     - |  628 | `		 */` |
|   ! 0 |  629 | `		iOpen = O_RDWR\|O_TRUNC;` |
|   ! 0 |  630 | `	}` |
| 29528 |  631 | `	if( iOpenMode & PH7_IO_OPEN_RDWR ){` |
|     - |  632 | `		/* Read+Write access */` |
| 13370 |  633 | `		iOpen &= ~O_RDONLY;` |
| 13370 |  634 | `		iOpen \|= O_RDWR;` |
| 22843 |  635 | `	}else if( iOpenMode & PH7_IO_OPEN_WRONLY ){` |
|     - |  636 | `		/* Write only access */` |
|   146 |  637 | `		iOpen &= ~O_RDONLY;` |
|   146 |  638 | `		iOpen \|= O_WRONLY;` |
|    73 |  639 | `	}` |
| 29528 |  640 | `	if( iOpenMode & PH7_IO_OPEN_APPEND ){` |
|     - |  641 | `		/* Append mode */` |
...
| 29528 |  651 | `	fd = open(zPath,iOpen,PH7_UNIX_OPEN_MODE);` |
| 29528 |  652 | `	if( fd < 0 ){` |
|     - |  653 | `		/* IO error */` |
|    12 |  654 | `		return -1;` |
|     - |  655 | `	}` |
|     - |  656 | `	/* Save the handle */` |
| 29516 |  657 | `	*ppHandle = SX_INT_TO_PTR(fd);` |
| 29516 |  658 | `	return PH7_OK;` |
| 14764 |  659 | `}` |
...
| 29514 |  680 | `static void UnixFile_Close(void *pUserData)` |
|     - |  681 | `{` |
| 29514 |  682 | `	close(SX_PTR_TO_INT(pUserData));` |
| 29514 |  683 | `}` |
|     - |  684 | `/* int (*xReadDir)(void *,ph7_context *) */` |
|  8506 |  685 | `static int UnixDir_Read(void *pUserData,ph7_context *pCtx)` |
|     - |  686 | `{` |
|  8506 |  687 | `	DIR *pDir = (DIR *)pUserData;` |
|     - |  688 | `	struct dirent *pEntry;` |
|  8506 |  689 | `	char *zName = 0; /* cc warning */` |
|  8506 |  690 | `	sxu32 n = 0;` |
|  5253 |  691 | `	for(;;){` |
| 10506 |  692 | `		pEntry = readdir(pDir);` |
| 10506 |  693 | `		if( pEntry == 0 ){` |
|     - |  694 | `			/* No more entries to process */` |
|   996 |  695 | `			return -1;` |
|     - |  696 | `		}` |
|  9510 |  697 | `		zName = pEntry->d_name;` |
|  9510 |  698 | `		n = SyStrlen(zName);` |
|     - |  699 | `		/* Ignore '.' && '..' */` |
|  9510 |  700 | `		if( n > sizeof("..")-1 \|\| zName[0] != '.' \|\| ( n == sizeof("..")-1 && zName[1] != '.') ){` |
|  3755 |  701 | `			break;` |
|     - |  702 | `		}` |
|     - |  703 | `		/* Next entry */` |
|     - |  704 | `	}` |
|     - |  705 | `	/* Return the current file name */` |
|  7510 |  706 | `	ph7_result_string(pCtx,zName,(int)n);` |
|  7510 |  707 | `	return PH7_OK;` |
|  4253 |  708 | `}` |
...
| 31952 |  715 | `static ph7_int64 UnixFile_Read(void *pUserData,void *pBuffer,ph7_int64 nDatatoRead)` |
|     - |  716 | `{` |
|     - |  717 | `	ssize_t nRd;` |
| 31952 |  718 | `	nRd = read(SX_PTR_TO_INT(pUserData),pBuffer,(size_t)nDatatoRead);` |
| 31952 |  719 | `	if( nRd < 1 ){` |
|     - |  720 | `		/* EOF or IO error */` |
| 15972 |  721 | `		return -1;` |
|     - |  722 | `	}` |
| 15980 |  723 | `	return (ph7_int64)nRd;` |
| 15976 |  724 | `}` |
|     - |  725 | `/* ph7_int64 (*xWrite)(void *,const void *,ph7_int64); */` |
| 13400 |  726 | `static ph7_int64 UnixFile_Write(void *pUserData,const void *pBuffer,ph7_int64 nWrite)` |
|     - |  727 | `{` |
| 13400 |  728 | `	const char *zData = (const char *)pBuffer;` |
| 13400 |  729 | `	int fd = SX_PTR_TO_INT(pUserData);` |
|     - |  730 | `	ph7_int64 nCount;` |
|     - |  731 | `	ssize_t nWr;` |
| 13400 |  732 | `	nCount = 0;` |
| 13400 |  733 | `	for(;;){` |
| 26800 |  734 | `		if( nWrite < 1 ){` |
| 13400 |  735 | `			break;` |
|     - |  736 | `		}` |
| 13400 |  737 | `		nWr = write(fd,zData,(size_t)nWrite);` |
| 13400 |  738 | `		if( nWr < 1 ){` |
|     - |  739 | `			/* IO error */` |
|   ! 0 |  740 | `			break;` |
|     - |  741 | `		}` |
| 13400 |  742 | `		nWrite -= nWr;` |
| 13400 |  743 | `		nCount += nWr;` |
| 13400 |  744 | `		zData += nWr;` |
|     - |  745 | `	}` |
| 13400 |  746 | `	if( nWrite > 0 ){` |
|   ! 0 |  747 | `		return -1;` |
|     - |  748 | `	}` |
| 13400 |  749 | `	return nCount;` |
|  6700 |  750 | `}` |
