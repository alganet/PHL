...
| 13370 |   31 | `static int UnixVfs_chdir(const char *zPath)` |
|     - |   32 | `{` |
|     - |   33 | `  int rc;` |
| 13370 |   34 | `  rc = chdir(zPath);` |
| 13370 |   35 | `  return rc == 0 ? PH7_OK : -1;` |
|     - |   36 | `}` |
...
|  8750 |   66 | `static int UnixVfs_isdir(const char *zPath)` |
|     - |   67 | `{` |
|     - |   68 | `	struct stat st;` |
|     - |   69 | `	int rc;` |
|  8750 |   70 | `	rc = stat(zPath,&st);` |
|  8750 |   71 | `	if( rc != 0 ){` |
|     4 |   72 | `	 return -1;` |
|     - |   73 | `	}` |
|  8746 |   74 | `	rc = S_ISDIR(st.st_mode);` |
|  8746 |   75 | `	return rc ? PH7_OK : -1 ;` |
|  4375 |   76 | `}` |
...
| 33418 |  110 | `static int UnixVfs_unlink(const char *zPath)` |
|     - |  111 | `{` |
|     - |  112 | `	int rc;` |
| 33418 |  113 | `	rc = unlink(zPath);` |
| 33418 |  114 | `	return rc == 0 ? PH7_OK : -1 ;` |
|     - |  115 | `}` |
...
|    98 |  361 | `	 return -1;` |
|     - |  362 | `	}` |
|  6656 |  363 | `	rc = S_ISREG(st.st_mode);` |
|  6656 |  364 | `	return rc ? PH7_OK : -1 ;` |
|  3377 |  365 | `}` |
...
| 30158 |  607 | `static int UnixFile_Open(const char *zPath,int iOpenMode,ph7_value *pResource,void **ppHandle)` |
|     - |  608 | `{` |
| 30158 |  609 | `	int iOpen = O_RDONLY;` |
|     - |  610 | `	int fd;` |
|     - |  611 | `	/* Set the desired flags according to the open mode */` |
| 30158 |  612 | `	if( iOpenMode & PH7_IO_OPEN_CREATE ){` |
|     - |  613 | `		/* Open existing file, or create if it doesn't exist */` |
| 13644 |  614 | `		iOpen = O_CREAT;` |
| 13644 |  615 | `		if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  616 | `			/* If the specified file exists and is writable, the function overwrites the file */` |
| 13644 |  617 | `			iOpen \|= O_TRUNC;` |
|  6822 |  618 | `			SXUNUSED(pResource); /* cc warning */` |
|  6822 |  619 | `		}` |
| 23336 |  620 | `	}else if( iOpenMode & PH7_IO_OPEN_EXCL ){` |
|     - |  621 | `		/* Creates a new file, only if it does not already exist.` |
|     - |  622 | `		* If the file exists, it fails.` |
|     - |  623 | `		*/` |
|   130 |  624 | `		iOpen = O_CREAT\|O_EXCL;` |
| 16449 |  625 | `	}else if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  626 | `		/* Opens a file and truncates it so that its size is zero bytes` |
|     - |  627 | `		 * The file must exist.` |
|     - |  628 | `		 */` |
|   ! 0 |  629 | `		iOpen = O_RDWR\|O_TRUNC;` |
|   ! 0 |  630 | `	}` |
| 30158 |  631 | `	if( iOpenMode & PH7_IO_OPEN_RDWR ){` |
|     - |  632 | `		/* Read+Write access */` |
| 13626 |  633 | `		iOpen &= ~O_RDONLY;` |
| 13626 |  634 | `		iOpen \|= O_RDWR;` |
| 23345 |  635 | `	}else if( iOpenMode & PH7_IO_OPEN_WRONLY ){` |
|     - |  636 | `		/* Write only access */` |
|   154 |  637 | `		iOpen &= ~O_RDONLY;` |
|   154 |  638 | `		iOpen \|= O_WRONLY;` |
|    77 |  639 | `	}` |
| 30158 |  640 | `	if( iOpenMode & PH7_IO_OPEN_APPEND ){` |
|     - |  641 | `		/* Append mode */` |
...
| 30158 |  651 | `	fd = open(zPath,iOpen,PH7_UNIX_OPEN_MODE);` |
| 30158 |  652 | `	if( fd < 0 ){` |
|     - |  653 | `		/* IO error */` |
|    12 |  654 | `		return -1;` |
|     - |  655 | `	}` |
|     - |  656 | `	/* Save the handle */` |
| 30146 |  657 | `	*ppHandle = SX_INT_TO_PTR(fd);` |
| 30146 |  658 | `	return PH7_OK;` |
| 15079 |  659 | `}` |
...
| 30144 |  680 | `static void UnixFile_Close(void *pUserData)` |
|     - |  681 | `{` |
| 30144 |  682 | `	close(SX_PTR_TO_INT(pUserData));` |
| 30144 |  683 | `}` |
|     - |  684 | `/* int (*xReadDir)(void *,ph7_context *) */` |
|  8748 |  685 | `static int UnixDir_Read(void *pUserData,ph7_context *pCtx)` |
|     - |  686 | `{` |
|  8748 |  687 | `	DIR *pDir = (DIR *)pUserData;` |
|     - |  688 | `	struct dirent *pEntry;` |
|  8748 |  689 | `	char *zName = 0; /* cc warning */` |
|  8748 |  690 | `	sxu32 n = 0;` |
|  5428 |  691 | `	for(;;){` |
| 10856 |  692 | `		pEntry = readdir(pDir);` |
| 10856 |  693 | `		if( pEntry == 0 ){` |
|     - |  694 | `			/* No more entries to process */` |
|  1050 |  695 | `			return -1;` |
|     - |  696 | `		}` |
|  9806 |  697 | `		zName = pEntry->d_name;` |
|  9806 |  698 | `		n = SyStrlen(zName);` |
|     - |  699 | `		/* Ignore '.' && '..' */` |
|  9806 |  700 | `		if( n > sizeof("..")-1 \|\| zName[0] != '.' \|\| ( n == sizeof("..")-1 && zName[1] != '.') ){` |
|  3849 |  701 | `			break;` |
|     - |  702 | `		}` |
|     - |  703 | `		/* Next entry */` |
|     - |  704 | `	}` |
|     - |  705 | `	/* Return the current file name */` |
|  7698 |  706 | `	ph7_result_string(pCtx,zName,(int)n);` |
|  7698 |  707 | `	return PH7_OK;` |
|  4374 |  708 | `}` |
...
| 32684 |  715 | `static ph7_int64 UnixFile_Read(void *pUserData,void *pBuffer,ph7_int64 nDatatoRead)` |
|     - |  716 | `{` |
|     - |  717 | `	ssize_t nRd;` |
| 32684 |  718 | `	nRd = read(SX_PTR_TO_INT(pUserData),pBuffer,(size_t)nDatatoRead);` |
| 32684 |  719 | `	if( nRd < 1 ){` |
|     - |  720 | `		/* EOF or IO error */` |
| 16338 |  721 | `		return -1;` |
|     - |  722 | `	}` |
| 16346 |  723 | `	return (ph7_int64)nRd;` |
| 16342 |  724 | `}` |
|     - |  725 | `/* ph7_int64 (*xWrite)(void *,const void *,ph7_int64); */` |
| 13656 |  726 | `static ph7_int64 UnixFile_Write(void *pUserData,const void *pBuffer,ph7_int64 nWrite)` |
|     - |  727 | `{` |
| 13656 |  728 | `	const char *zData = (const char *)pBuffer;` |
| 13656 |  729 | `	int fd = SX_PTR_TO_INT(pUserData);` |
|     - |  730 | `	ph7_int64 nCount;` |
|     - |  731 | `	ssize_t nWr;` |
| 13656 |  732 | `	nCount = 0;` |
| 13656 |  733 | `	for(;;){` |
| 27312 |  734 | `		if( nWrite < 1 ){` |
| 13656 |  735 | `			break;` |
|     - |  736 | `		}` |
| 13656 |  737 | `		nWr = write(fd,zData,(size_t)nWrite);` |
| 13656 |  738 | `		if( nWr < 1 ){` |
|     - |  739 | `			/* IO error */` |
|   ! 0 |  740 | `			break;` |
|     - |  741 | `		}` |
| 13656 |  742 | `		nWrite -= nWr;` |
| 13656 |  743 | `		nCount += nWr;` |
| 13656 |  744 | `		zData += nWr;` |
|     - |  745 | `	}` |
| 13656 |  746 | `	if( nWrite > 0 ){` |
|   ! 0 |  747 | `		return -1;` |
|     - |  748 | `	}` |
| 13656 |  749 | `	return nCount;` |
|  6828 |  750 | `}` |
