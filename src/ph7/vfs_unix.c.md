...
| 13014 |   29 | `static int UnixVfs_chdir(const char *zPath)` |
|     - |   30 |  |
|     - |   31 | `  int rc;` |
| 13014 |   32 | `  rc = chdir(zPath);` |
| 13014 |   33 | `  return rc == 0 ? PH7_OK : -1;` |
|     - |   34 |  |
...
|  7644 |   64 | `static int UnixVfs_isdir(const char *zPath)` |
|     - |   65 |  |
|     - |   66 | `	struct stat st;` |
|     - |   67 | `	int rc;` |
|  7644 |   68 | `	rc = stat(zPath,&st);` |
|  7644 |   69 | `	if( rc != 0 ){` |
|     4 |   70 | `	 return -1;` |
|     - |   71 | `	}` |
|  7640 |   72 | `	rc = S_ISDIR(st.st_mode);` |
|  7640 |   73 | `	return rc ? PH7_OK : -1 ;` |
|  3822 |   74 |  |
...
| 28866 |  108 | `static int UnixVfs_unlink(const char *zPath)` |
|     - |  109 |  |
|     - |  110 | `	int rc;` |
| 28866 |  111 | `	rc = unlink(zPath);` |
| 28866 |  112 | `	return rc == 0 ? PH7_OK : -1 ;` |
|     - |  113 |  |
...
|  5746 |  320 | `static int UnixVfs_isfile(const char *zPath)` |
|     - |  321 |  |
|     - |  322 | `	struct stat st;` |
|     - |  323 | `	int rc;` |
|  5746 |  324 | `	rc = stat(zPath,&st);` |
|  5746 |  325 | `	if( rc != 0 ){` |
|     2 |  326 | `	 return -1;` |
|     - |  327 | `	}` |
|  5744 |  328 | `	rc = S_ISREG(st.st_mode);` |
|  5744 |  329 | `	return rc ? PH7_OK : -1 ;` |
|  2873 |  330 |  |
...
|  3318 |  411 | `static int UnixVfs_Mmap(const char *zPath,void **ppMap,ph7_int64 *pSize)` |
|     - |  412 |  |
|     - |  413 | `	struct stat st;` |
|     - |  414 | `	void *pMap;` |
|     - |  415 | `	int fd;` |
...
|  3318 |  418 | `	fd = open(zPath,O_RDONLY);` |
|  3318 |  419 | `	if( fd < 0 ){` |
|     2 |  420 | `		return -1;` |
|     - |  421 | `	}` |
|     - |  422 | `	/* stat the handle */` |
|  3316 |  423 | `	fstat(fd,&st);` |
|     - |  424 | `	/* Obtain a memory view of the whole file */` |
|  3316 |  425 | `	pMap = mmap(0,st.st_size,PROT_READ,MAP_PRIVATE\|MAP_FILE,fd,0);` |
|  3316 |  426 | `	rc = PH7_OK;` |
|  3316 |  427 | `	if( pMap == MAP_FAILED ){` |
|   ! 0 |  428 | `		rc = -1;` |
|   ! 0 |  429 | `	}else{` |
|     - |  430 | `		/* Point to the memory view */` |
|  3316 |  431 | `		*ppMap = pMap;` |
|  3316 |  432 | `		*pSize = (ph7_int64)st.st_size;` |
|     - |  433 | `	}` |
|  3316 |  434 | `	close(fd);` |
|  3316 |  435 | `	return rc;` |
|  1659 |  436 |  |
|     - |  437 | `/* void (*xUnmap)(void *,ph7_int64)  */` |
|  3316 |  438 | `static void UnixVfs_Unmap(void *pView,ph7_int64 nSize)` |
|     - |  439 |  |
|  3316 |  440 | `	munmap(pView,(size_t)nSize);` |
|  3316 |  441 |  |
...
| 28892 |  580 | `static int UnixFile_Open(const char *zPath,int iOpenMode,ph7_value *pResource,void **ppHandle)` |
|     - |  581 |  |
| 28892 |  582 | `	int iOpen = O_RDONLY;` |
|     - |  583 | `	int fd;` |
|     - |  584 | `	/* Set the desired flags according to the open mode */` |
| 28892 |  585 | `	if( iOpenMode & PH7_IO_OPEN_CREATE ){` |
|     - |  586 | `		/* Open existing file, or create if it doesn't exist */` |
| 13274 |  587 | `		iOpen = O_CREAT;` |
| 13274 |  588 | `		if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  589 | `			/* If the specified file exists and is writable, the function overwrites the file */` |
| 13274 |  590 | `			iOpen \|= O_TRUNC;` |
|  6637 |  591 | `			SXUNUSED(pResource); /* cc warning */` |
|  6637 |  592 | `		}` |
| 22255 |  593 | `	}else if( iOpenMode & PH7_IO_OPEN_EXCL ){` |
|     - |  594 | `		/* Creates a new file, only if it does not already exist.` |
|     - |  595 | `		* If the file exists, it fails.` |
|     - |  596 | `		*/` |
|   ! 0 |  597 | `		iOpen = O_CREAT\|O_EXCL;` |
| 15618 |  598 | `	}else if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  599 | `		/* Opens a file and truncates it so that its size is zero bytes` |
|     - |  600 | `		 * The file must exist.` |
|     - |  601 | `		 */` |
|   ! 0 |  602 | `		iOpen = O_RDWR\|O_TRUNC;` |
|   ! 0 |  603 | `	}` |
| 28892 |  604 | `	if( iOpenMode & PH7_IO_OPEN_RDWR ){` |
|     - |  605 | `		/* Read+Write access */` |
| 13258 |  606 | `		iOpen &= ~O_RDONLY;` |
| 13258 |  607 | `		iOpen \|= O_RDWR;` |
| 22263 |  608 | `	}else if( iOpenMode & PH7_IO_OPEN_WRONLY ){` |
|     - |  609 | `		/* Write only access */` |
|    22 |  610 | `		iOpen &= ~O_RDONLY;` |
|    22 |  611 | `		iOpen \|= O_WRONLY;` |
|    11 |  612 | `	}` |
| 28892 |  613 | `	if( iOpenMode & PH7_IO_OPEN_APPEND ){` |
|     - |  614 | `		/* Append mode */` |
...
| 28892 |  624 | `	fd = open(zPath,iOpen,PH7_UNIX_OPEN_MODE);` |
| 28892 |  625 | `	if( fd < 0 ){` |
|     - |  626 | `		/* IO error */` |
|    12 |  627 | `		return -1;` |
|     - |  628 | `	}` |
|     - |  629 | `	/* Save the handle */` |
| 28880 |  630 | `	*ppHandle = SX_INT_TO_PTR(fd);` |
| 28880 |  631 | `	return PH7_OK;` |
| 14446 |  632 |  |
|     - |  633 | `/* int (*xOpenDir)(const char *,ph7_value *,void **) */` |
|   952 |  634 | `static int UnixDir_Open(const char *zPath,ph7_value *pResource,void **ppHandle)` |
|     - |  635 |  |
|     - |  636 | `	DIR *pDir;` |
|     - |  637 | `	/* Open the target directory */` |
|   952 |  638 | `	pDir = opendir(zPath);` |
|   952 |  639 | `	if( pDir == 0 ){` |
|   ! 0 |  640 | `		SXUNUSED(pResource); /* Compiler warning */` |
|   ! 0 |  641 | `		return -1;` |
|     - |  642 | `	}` |
|     - |  643 | `	/* Save our structure */` |
|   952 |  644 | `	*ppHandle = pDir;` |
|   952 |  645 | `	return PH7_OK;` |
|   476 |  646 |  |
|     - |  647 | `/* void (*xCloseDir)(void *) */` |
|   952 |  648 | `static void UnixDir_Close(void *pUserData)` |
|     - |  649 |  |
|   952 |  650 | `	closedir((DIR *)pUserData);` |
|   952 |  651 |  |
|     - |  652 | `/* void (*xClose)(void *); */` |
| 28878 |  653 | `static void UnixFile_Close(void *pUserData)` |
|     - |  654 |  |
| 28878 |  655 | `	close(SX_PTR_TO_INT(pUserData));` |
| 28878 |  656 |  |
|     - |  657 | `/* int (*xReadDir)(void *,ph7_context *) */` |
|  7642 |  658 | `static int UnixDir_Read(void *pUserData,ph7_context *pCtx)` |
|     - |  659 |  |
|  7642 |  660 | `	DIR *pDir = (DIR *)pUserData;` |
|     - |  661 | `	struct dirent *pEntry;` |
|  7642 |  662 | `	char *zName = 0; /* cc warning */` |
|  7642 |  663 | `	sxu32 n = 0;` |
|  4775 |  664 | `	for(;;){` |
|  9546 |  665 | `		pEntry = readdir(pDir);` |
|  9546 |  666 | `		if( pEntry == 0 ){` |
|     - |  667 | `			/* No more entries to process */` |
|   950 |  668 | `			return -1;` |
|     - |  669 | `		}` |
|  8596 |  670 | `		zName = pEntry->d_name;` |
|  8596 |  671 | `		n = SyStrlen(zName);` |
|     - |  672 | `		/* Ignore '.' && '..' */` |
|  8596 |  673 | `		if( n > sizeof("..")-1 \|\| zName[0] != '.' \|\| ( n == sizeof("..")-1 && zName[1] != '.') ){` |
|  3346 |  674 | `			break;` |
|     - |  675 | `		}` |
|     - |  676 | `		/* Next entry */` |
|     - |  677 | `	}` |
|     - |  678 | `	/* Return the current file name */` |
|  6692 |  679 | `	ph7_result_string(pCtx,zName,(int)n);` |
|  6692 |  680 | `	return PH7_OK;` |
|  3821 |  681 |  |
...
| 31154 |  688 | `static ph7_int64 UnixFile_Read(void *pUserData,void *pBuffer,ph7_int64 nDatatoRead)` |
|     - |  689 |  |
|     - |  690 | `	ssize_t nRd;` |
| 31154 |  691 | `	nRd = read(SX_PTR_TO_INT(pUserData),pBuffer,(size_t)nDatatoRead);` |
| 31154 |  692 | `	if( nRd < 1 ){` |
|     - |  693 | `		/* EOF or IO error */` |
| 15572 |  694 | `		return -1;` |
|     - |  695 | `	}` |
| 15582 |  696 | `	return (ph7_int64)nRd;` |
| 15577 |  697 |  |
|     - |  698 | `/* ph7_int64 (*xWrite)(void *,const void *,ph7_int64); */` |
| 13296 |  699 | `static ph7_int64 UnixFile_Write(void *pUserData,const void *pBuffer,ph7_int64 nWrite)` |
|     - |  700 |  |
| 13296 |  701 | `	const char *zData = (const char *)pBuffer;` |
| 13296 |  702 | `	int fd = SX_PTR_TO_INT(pUserData);` |
|     - |  703 | `	ph7_int64 nCount;` |
|     - |  704 | `	ssize_t nWr;` |
| 13296 |  705 | `	nCount = 0;` |
| 13296 |  706 | `	for(;;){` |
| 26592 |  707 | `		if( nWrite < 1 ){` |
| 13296 |  708 | `			break;` |
|     - |  709 | `		}` |
| 13296 |  710 | `		nWr = write(fd,zData,(size_t)nWrite);` |
| 13296 |  711 | `		if( nWr < 1 ){` |
|     - |  712 | `			/* IO error */` |
|   ! 0 |  713 | `			break;` |
|     - |  714 | `		}` |
| 13296 |  715 | `		nWrite -= nWr;` |
| 13296 |  716 | `		nCount += nWr;` |
| 13296 |  717 | `		zData += nWr;` |
|     - |  718 | `	}` |
| 13296 |  719 | `	if( nWrite > 0 ){` |
|   ! 0 |  720 | `		return -1;` |
|     - |  721 | `	}` |
| 13296 |  722 | `	return nCount;` |
|  6648 |  723 |  |
