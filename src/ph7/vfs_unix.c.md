...
| 13182 |   29 | `static int UnixVfs_chdir(const char *zPath)` |
|     - |   30 | `{` |
|     - |   31 | `  int rc;` |
| 13182 |   32 | `  rc = chdir(zPath);` |
| 13182 |   33 | `  return rc == 0 ? PH7_OK : -1;` |
|     - |   34 | `}` |
...
|  8132 |   64 | `static int UnixVfs_isdir(const char *zPath)` |
|     - |   65 | `{` |
|     - |   66 | `	struct stat st;` |
|     - |   67 | `	int rc;` |
|  8132 |   68 | `	rc = stat(zPath,&st);` |
|  8132 |   69 | `	if( rc != 0 ){` |
|     4 |   70 | `	 return -1;` |
|     - |   71 | `	}` |
|  8128 |   72 | `	rc = S_ISDIR(st.st_mode);` |
|  8128 |   73 | `	return rc ? PH7_OK : -1 ;` |
|  4066 |   74 | `}` |
...
| 31108 |  108 | `static int UnixVfs_unlink(const char *zPath)` |
|     - |  109 | `{` |
|     - |  110 | `	int rc;` |
| 31108 |  111 | `	rc = unlink(zPath);` |
| 31108 |  112 | `	return rc == 0 ? PH7_OK : -1 ;` |
|     - |  113 | `}` |
...
|  6194 |  320 | `static int UnixVfs_isfile(const char *zPath)` |
|     - |  321 | `{` |
|     - |  322 | `	struct stat st;` |
|     - |  323 | `	int rc;` |
|  6194 |  324 | `	rc = stat(zPath,&st);` |
|  6194 |  325 | `	if( rc != 0 ){` |
|     2 |  326 | `	 return -1;` |
|     - |  327 | `	}` |
|  6192 |  328 | `	rc = S_ISREG(st.st_mode);` |
|  6192 |  329 | `	return rc ? PH7_OK : -1 ;` |
|  3097 |  330 | `}` |
...
| 29128 |  580 | `static int UnixFile_Open(const char *zPath,int iOpenMode,ph7_value *pResource,void **ppHandle)` |
|     - |  581 | `{` |
| 29128 |  582 | `	int iOpen = O_RDONLY;` |
|     - |  583 | `	int fd;` |
|     - |  584 | `	/* Set the desired flags according to the open mode */` |
| 29128 |  585 | `	if( iOpenMode & PH7_IO_OPEN_CREATE ){` |
|     - |  586 | `		/* Open existing file, or create if it doesn't exist */` |
| 13428 |  587 | `		iOpen = O_CREAT;` |
| 13428 |  588 | `		if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  589 | `			/* If the specified file exists and is writable, the function overwrites the file */` |
| 13428 |  590 | `			iOpen \|= O_TRUNC;` |
|  6714 |  591 | `			SXUNUSED(pResource); /* cc warning */` |
|  6714 |  592 | `		}` |
| 22414 |  593 | `	}else if( iOpenMode & PH7_IO_OPEN_EXCL ){` |
|     - |  594 | `		/* Creates a new file, only if it does not already exist.` |
|     - |  595 | `		* If the file exists, it fails.` |
|     - |  596 | `		*/` |
|   ! 0 |  597 | `		iOpen = O_CREAT\|O_EXCL;` |
| 15700 |  598 | `	}else if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  599 | `		/* Opens a file and truncates it so that its size is zero bytes` |
|     - |  600 | `		 * The file must exist.` |
|     - |  601 | `		 */` |
|   ! 0 |  602 | `		iOpen = O_RDWR\|O_TRUNC;` |
|   ! 0 |  603 | `	}` |
| 29128 |  604 | `	if( iOpenMode & PH7_IO_OPEN_RDWR ){` |
|     - |  605 | `		/* Read+Write access */` |
| 13412 |  606 | `		iOpen &= ~O_RDONLY;` |
| 13412 |  607 | `		iOpen \|= O_RDWR;` |
| 22422 |  608 | `	}else if( iOpenMode & PH7_IO_OPEN_WRONLY ){` |
|     - |  609 | `		/* Write only access */` |
|    22 |  610 | `		iOpen &= ~O_RDONLY;` |
|    22 |  611 | `		iOpen \|= O_WRONLY;` |
|    11 |  612 | `	}` |
| 29128 |  613 | `	if( iOpenMode & PH7_IO_OPEN_APPEND ){` |
|     - |  614 | `		/* Append mode */` |
...
| 29128 |  624 | `	fd = open(zPath,iOpen,PH7_UNIX_OPEN_MODE);` |
| 29128 |  625 | `	if( fd < 0 ){` |
|     - |  626 | `		/* IO error */` |
|    12 |  627 | `		return -1;` |
|     - |  628 | `	}` |
|     - |  629 | `	/* Save the handle */` |
| 29116 |  630 | `	*ppHandle = SX_INT_TO_PTR(fd);` |
| 29116 |  631 | `	return PH7_OK;` |
| 14564 |  632 | `}` |
...
| 29114 |  653 | `static void UnixFile_Close(void *pUserData)` |
|     - |  654 | `{` |
| 29114 |  655 | `	close(SX_PTR_TO_INT(pUserData));` |
| 29114 |  656 | `}` |
|     - |  657 | `/* int (*xReadDir)(void *,ph7_context *) */` |
|  8130 |  658 | `static int UnixDir_Read(void *pUserData,ph7_context *pCtx)` |
|     - |  659 | `{` |
|  8130 |  660 | `	DIR *pDir = (DIR *)pUserData;` |
|     - |  661 | `	struct dirent *pEntry;` |
|  8130 |  662 | `	char *zName = 0; /* cc warning */` |
|  8130 |  663 | `	sxu32 n = 0;` |
|  5039 |  664 | `	for(;;){` |
| 10074 |  665 | `		pEntry = readdir(pDir);` |
| 10074 |  666 | `		if( pEntry == 0 ){` |
|     - |  667 | `			/* No more entries to process */` |
|   970 |  668 | `			return -1;` |
|     - |  669 | `		}` |
|  9104 |  670 | `		zName = pEntry->d_name;` |
|  9104 |  671 | `		n = SyStrlen(zName);` |
|     - |  672 | `		/* Ignore '.' && '..' */` |
|  9104 |  673 | `		if( n > sizeof("..")-1 \|\| zName[0] != '.' \|\| ( n == sizeof("..")-1 && zName[1] != '.') ){` |
|  3580 |  674 | `			break;` |
|     - |  675 | `		}` |
|     - |  676 | `		/* Next entry */` |
|     - |  677 | `	}` |
|     - |  678 | `	/* Return the current file name */` |
|  7160 |  679 | `	ph7_result_string(pCtx,zName,(int)n);` |
|  7160 |  680 | `	return PH7_OK;` |
|  4065 |  681 | `}` |
...
| 31318 |  688 | `static ph7_int64 UnixFile_Read(void *pUserData,void *pBuffer,ph7_int64 nDatatoRead)` |
|     - |  689 | `{` |
|     - |  690 | `	ssize_t nRd;` |
| 31318 |  691 | `	nRd = read(SX_PTR_TO_INT(pUserData),pBuffer,(size_t)nDatatoRead);` |
| 31318 |  692 | `	if( nRd < 1 ){` |
|     - |  693 | `		/* EOF or IO error */` |
| 15654 |  694 | `		return -1;` |
|     - |  695 | `	}` |
| 15664 |  696 | `	return (ph7_int64)nRd;` |
| 15659 |  697 | `}` |
|     - |  698 | `/* ph7_int64 (*xWrite)(void *,const void *,ph7_int64); */` |
| 13450 |  699 | `static ph7_int64 UnixFile_Write(void *pUserData,const void *pBuffer,ph7_int64 nWrite)` |
|     - |  700 | `{` |
| 13450 |  701 | `	const char *zData = (const char *)pBuffer;` |
| 13450 |  702 | `	int fd = SX_PTR_TO_INT(pUserData);` |
|     - |  703 | `	ph7_int64 nCount;` |
|     - |  704 | `	ssize_t nWr;` |
| 13450 |  705 | `	nCount = 0;` |
| 13450 |  706 | `	for(;;){` |
| 26900 |  707 | `		if( nWrite < 1 ){` |
| 13450 |  708 | `			break;` |
|     - |  709 | `		}` |
| 13450 |  710 | `		nWr = write(fd,zData,(size_t)nWrite);` |
| 13450 |  711 | `		if( nWr < 1 ){` |
|     - |  712 | `			/* IO error */` |
|   ! 0 |  713 | `			break;` |
|     - |  714 | `		}` |
| 13450 |  715 | `		nWrite -= nWr;` |
| 13450 |  716 | `		nCount += nWr;` |
| 13450 |  717 | `		zData += nWr;` |
|     - |  718 | `	}` |
| 13450 |  719 | `	if( nWrite > 0 ){` |
|   ! 0 |  720 | `		return -1;` |
|     - |  721 | `	}` |
| 13450 |  722 | `	return nCount;` |
|  6725 |  723 | `}` |
