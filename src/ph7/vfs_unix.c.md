...
|     - |   38 | ` */` |
| 52444 |   39 | `static const char * UnixVfsLocalPath(const char *zPath)` |
|     - |   40 | `{` |
|     - |   41 | `	const char *zRest;` |
| 52444 |   42 | `	if( zPath == 0 \|\| SyStrnicmp(zPath,"file://",sizeof("file://")-1) != 0 ){` |
| 52434 |   43 | `		return zPath;` |
|     - |   44 | `	}` |
...
| 12858 |   57 | `static int UnixVfs_chdir(const char *zPath)` |
|     - |   58 | `{` |
|     - |   59 | `  int rc;` |
| 12858 |   60 | `  rc = chdir(zPath);` |
| 12858 |   61 | `  return rc == 0 ? PH7_OK : -1;` |
|     - |   62 | `}` |
...
|  8664 |   94 | `static int UnixVfs_isdir(const char *zPath)` |
|     - |   95 | `{` |
|  8664 |   96 | `	zPath = UnixVfsLocalPath(zPath);` |
|     - |   97 | `	struct stat st;` |
|     - |   98 | `	int rc;` |
|  8664 |   99 | `	rc = stat(zPath,&st);` |
|  8664 |  100 | `	if( rc != 0 ){` |
|     4 |  101 | `	 return -1;` |
|     - |  102 | `	}` |
|  8660 |  103 | `	rc = S_ISDIR(st.st_mode);` |
|  8660 |  104 | `	return rc ? PH7_OK : -1 ;` |
|  4332 |  105 | `}` |
...
| 32858 |  141 | `static int UnixVfs_unlink(const char *zPath)` |
|     - |  142 | `{` |
| 32858 |  143 | `	zPath = UnixVfsLocalPath(zPath);` |
|     - |  144 | `	int rc;` |
| 32858 |  145 | `	rc = unlink(zPath);` |
| 32858 |  146 | `	return rc == 0 ? PH7_OK : -1 ;` |
|     - |  147 | `}` |
...
|  6602 |  400 | `static int UnixVfs_isfile(const char *zPath)` |
|     - |  401 | `{` |
|  6602 |  402 | `	zPath = UnixVfsLocalPath(zPath);` |
|     - |  403 | `	struct stat st;` |
|     - |  404 | `	int rc;` |
|  6602 |  405 | `	rc = stat(zPath,&st);` |
|  6602 |  406 | `	if( rc != 0 ){` |
|    54 |  407 | `	 return -1;` |
|     - |  408 | `	}` |
|  6548 |  409 | `	rc = S_ISREG(st.st_mode);` |
|  6548 |  410 | `	return rc ? PH7_OK : -1 ;` |
|  3301 |  411 | `}` |
...
|  3838 |  497 | `static int UnixVfs_Mmap(const char *zPath,void **ppMap,ph7_int64 *pSize)` |
|     - |  498 | `{` |
|  3838 |  499 | `	zPath = UnixVfsLocalPath(zPath);` |
|     - |  500 | `	struct stat st;` |
|     - |  501 | `	void *pMap;` |
|     - |  502 | `	int fd;` |
|     - |  503 | `	int rc;` |
|     - |  504 | `	/* Open the file in a read-only mode */` |
|  3838 |  505 | `	fd = open(zPath,O_RDONLY);` |
|  3838 |  506 | `	if( fd < 0 ){` |
|   ! 0 |  507 | `		return -1;` |
|     - |  508 | `	}` |
|     - |  509 | `	/* stat the handle */` |
|  3838 |  510 | `	fstat(fd,&st);` |
|     - |  511 | `	/* Obtain a memory view of the whole file */` |
|  3838 |  512 | `	pMap = mmap(0,st.st_size,PROT_READ,MAP_PRIVATE\|MAP_FILE,fd,0);` |
|  3838 |  513 | `	rc = PH7_OK;` |
|  3838 |  514 | `	if( pMap == MAP_FAILED ){` |
|   ! 0 |  515 | `		rc = -1;` |
|   ! 0 |  516 | `	}else{` |
|     - |  517 | `		/* Point to the memory view */` |
|  3838 |  518 | `		*ppMap = pMap;` |
|  3838 |  519 | `		*pSize = (ph7_int64)st.st_size;` |
|     - |  520 | `	}` |
|  3838 |  521 | `	close(fd);` |
|  3838 |  522 | `	return rc;` |
|  1919 |  523 | `}` |
|     - |  524 | `/* void (*xUnmap)(void *,ph7_int64)  */` |
|  3838 |  525 | `static void UnixVfs_Unmap(void *pView,ph7_int64 nSize)` |
|     - |  526 | `{` |
|  3838 |  527 | `	munmap(pView,(size_t)nSize);` |
|  3838 |  528 | `}` |
...
| 28972 |  661 | `static int UnixFile_Open(const char *zPath,int iOpenMode,ph7_value *pResource,void **ppHandle)` |
|     - |  662 | `{` |
| 28972 |  663 | `	int iOpen = O_RDONLY;` |
|     - |  664 | `	int fd;` |
|     - |  665 | `	/* Set the desired flags according to the open mode */` |
| 28972 |  666 | `	if( iOpenMode & PH7_IO_OPEN_CREATE ){` |
|     - |  667 | `		/* Open existing file, or create if it doesn't exist */` |
| 13118 |  668 | `		iOpen = O_CREAT;` |
| 13118 |  669 | `		if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  670 | `			/* If the specified file exists and is writable, the function overwrites the file */` |
| 13118 |  671 | `			iOpen \|= O_TRUNC;` |
|  6559 |  672 | `			SXUNUSED(pResource); /* cc warning */` |
|  6559 |  673 | `		}` |
| 22413 |  674 | `	}else if( iOpenMode & PH7_IO_OPEN_EXCL ){` |
...
|   ! 0 |  684 | `	}` |
| 28972 |  685 | `	if( iOpenMode & PH7_IO_OPEN_RDWR ){` |
|     - |  686 | `		/* Read+Write access */` |
| 13096 |  687 | `		iOpen &= ~O_RDONLY;` |
| 13096 |  688 | `		iOpen \|= O_RDWR;` |
| 22424 |  689 | `	}else if( iOpenMode & PH7_IO_OPEN_WRONLY ){` |
|     - |  690 | `		/* Write only access */` |
|   150 |  691 | `		iOpen &= ~O_RDONLY;` |
|   150 |  692 | `		iOpen \|= O_WRONLY;` |
|    75 |  693 | `	}` |
| 28972 |  694 | `	if( iOpenMode & PH7_IO_OPEN_APPEND ){` |
|     - |  695 | `		/* Append mode */` |
...
| 28972 |  705 | `	fd = open(zPath,iOpen,PH7_UNIX_OPEN_MODE);` |
| 28972 |  706 | `	if( fd < 0 ){` |
|     - |  707 | `		/* IO error */` |
|    18 |  708 | `		return -1;` |
|     - |  709 | `	}` |
|     - |  710 | `	/* Save the handle */` |
| 28954 |  711 | `	*ppHandle = SX_INT_TO_PTR(fd);` |
| 28954 |  712 | `	return PH7_OK;` |
| 14486 |  713 | `}` |
...
| 28980 |  734 | `static void UnixFile_Close(void *pUserData)` |
|     - |  735 | `{` |
| 28980 |  736 | `	close(SX_PTR_TO_INT(pUserData));` |
| 28980 |  737 | `}` |
...
|  1062 |  749 | `		return -1;` |
|     - |  750 | `	}` |
|  9762 |  751 | `	zName = pEntry->d_name;` |
|  9762 |  752 | `	n = SyStrlen(zName);` |
|     - |  753 | `	/* Return the current file name */` |
|  9762 |  754 | `	ph7_result_string(pCtx,zName,(int)n);` |
|  9762 |  755 | `	return PH7_OK;` |
|  5412 |  756 | `}` |
...
| 31386 |  763 | `static ph7_int64 UnixFile_Read(void *pUserData,void *pBuffer,ph7_int64 nDatatoRead)` |
|     - |  764 | `{` |
|     - |  765 | `	ssize_t nRd;` |
| 31386 |  766 | `	nRd = read(SX_PTR_TO_INT(pUserData),pBuffer,(size_t)nDatatoRead);` |
| 31386 |  767 | `	if( nRd < 1 ){` |
|     - |  768 | `		/* EOF or IO error */` |
| 15694 |  769 | `		return -1;` |
|     - |  770 | `	}` |
| 15692 |  771 | `	return (ph7_int64)nRd;` |
| 15693 |  772 | `}` |
