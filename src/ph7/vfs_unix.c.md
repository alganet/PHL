...
| 13556 |   29 | `static int UnixVfs_chdir(const char *zPath)` |
|     - |   30 |  |
|     - |   31 | `  int rc;` |
| 13556 |   32 | `  rc = chdir(zPath);` |
| 13556 |   33 | `  return rc == 0 ? PH7_OK : -1;` |
|     - |   34 |  |
...
|  7956 |   64 | `static int UnixVfs_isdir(const char *zPath)` |
|     - |   65 |  |
|     - |   66 | `	struct stat st;` |
|     - |   67 | `	int rc;` |
|  7956 |   68 | `	rc = stat(zPath,&st);` |
|  7956 |   69 | `	if( rc != 0 ){` |
|     4 |   70 | `	 return -1;` |
|     - |   71 | `	}` |
|  7952 |   72 | `	rc = S_ISDIR(st.st_mode);` |
|  7952 |   73 | `	return rc ? PH7_OK : -1 ;` |
|  3978 |   74 |  |
...
| 30268 |  108 | `static int UnixVfs_unlink(const char *zPath)` |
|     - |  109 |  |
|     - |  110 | `	int rc;` |
| 30268 |  111 | `	rc = unlink(zPath);` |
| 30268 |  112 | `	return rc == 0 ? PH7_OK : -1 ;` |
|     - |  113 |  |
...
|  6026 |  320 | `static int UnixVfs_isfile(const char *zPath)` |
|     - |  321 |  |
|     - |  322 | `	struct stat st;` |
|     - |  323 | `	int rc;` |
|  6026 |  324 | `	rc = stat(zPath,&st);` |
|  6026 |  325 | `	if( rc != 0 ){` |
|     2 |  326 | `	 return -1;` |
|     - |  327 | `	}` |
|  6024 |  328 | `	rc = S_ISREG(st.st_mode);` |
|  6024 |  329 | `	return rc ? PH7_OK : -1 ;` |
|  3013 |  330 |  |
...
|  3566 |  411 | `static int UnixVfs_Mmap(const char *zPath,void **ppMap,ph7_int64 *pSize)` |
|     - |  412 |  |
|     - |  413 | `	struct stat st;` |
|     - |  414 | `	void *pMap;` |
|     - |  415 | `	int fd;` |
...
|  3566 |  418 | `	fd = open(zPath,O_RDONLY);` |
|  3566 |  419 | `	if( fd < 0 ){` |
|     2 |  420 | `		return -1;` |
|     - |  421 | `	}` |
|     - |  422 | `	/* stat the handle */` |
|  3564 |  423 | `	fstat(fd,&st);` |
|     - |  424 | `	/* Obtain a memory view of the whole file */` |
|  3564 |  425 | `	pMap = mmap(0,st.st_size,PROT_READ,MAP_PRIVATE\|MAP_FILE,fd,0);` |
|  3564 |  426 | `	rc = PH7_OK;` |
|  3564 |  427 | `	if( pMap == MAP_FAILED ){` |
|   ! 0 |  428 | `		rc = -1;` |
|   ! 0 |  429 | `	}else{` |
|     - |  430 | `		/* Point to the memory view */` |
|  3564 |  431 | `		*ppMap = pMap;` |
|  3564 |  432 | `		*pSize = (ph7_int64)st.st_size;` |
|     - |  433 | `	}` |
|  3564 |  434 | `	close(fd);` |
|  3564 |  435 | `	return rc;` |
|  1783 |  436 |  |
|     - |  437 | `/* void (*xUnmap)(void *,ph7_int64)  */` |
|  3564 |  438 | `static void UnixVfs_Unmap(void *pView,ph7_int64 nSize)` |
|     - |  439 |  |
|  3564 |  440 | `	munmap(pView,(size_t)nSize);` |
|  3564 |  441 |  |
...
| 13818 |  587 | `		iOpen = O_CREAT;` |
| 13818 |  588 | `		if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  589 | `			/* If the specified file exists and is writable, the function overwrites the file */` |
| 13818 |  590 | `			iOpen \|= O_TRUNC;` |
|  6909 |  591 | `			SXUNUSED(pResource); /* cc warning */` |
|  6909 |  592 | `		}` |
| 23101 |  593 | `	}else if( iOpenMode & PH7_IO_OPEN_EXCL ){` |
|     - |  594 | `		/* Creates a new file, only if it does not already exist.` |
|     - |  595 | `		* If the file exists, it fails.` |
|     - |  596 | `		*/` |
|   ! 0 |  597 | `		iOpen = O_CREAT\|O_EXCL;` |
| 16192 |  598 | `	}else if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
...
| 13802 |  606 | `		iOpen &= ~O_RDONLY;` |
| 13802 |  607 | `		iOpen \|= O_RDWR;` |
| 23109 |  608 | `	}else if( iOpenMode & PH7_IO_OPEN_WRONLY ){` |
...
|  7954 |  658 | `static int UnixDir_Read(void *pUserData,ph7_context *pCtx)` |
|     - |  659 |  |
|  7954 |  660 | `	DIR *pDir = (DIR *)pUserData;` |
|     - |  661 | `	struct dirent *pEntry;` |
|  7954 |  662 | `	char *zName = 0; /* cc warning */` |
|  7954 |  663 | `	sxu32 n = 0;` |
|  4947 |  664 | `	for(;;){` |
|  9890 |  665 | `		pEntry = readdir(pDir);` |
|  9890 |  666 | `		if( pEntry == 0 ){` |
|     - |  667 | `			/* No more entries to process */` |
|   966 |  668 | `			return -1;` |
|     - |  669 | `		}` |
|  8924 |  670 | `		zName = pEntry->d_name;` |
|  8924 |  671 | `		n = SyStrlen(zName);` |
|     - |  672 | `		/* Ignore '.' && '..' */` |
|  8924 |  673 | `		if( n > sizeof("..")-1 \|\| zName[0] != '.' \|\| ( n == sizeof("..")-1 && zName[1] != '.') ){` |
|  3494 |  674 | `			break;` |
|     - |  675 | `		}` |
|     - |  676 | `		/* Next entry */` |
|     - |  677 | `	}` |
|     - |  678 | `	/* Return the current file name */` |
|  6988 |  679 | `	ph7_result_string(pCtx,zName,(int)n);` |
|  6988 |  680 | `	return PH7_OK;` |
|  3977 |  681 |  |
...
| 32302 |  688 | `static ph7_int64 UnixFile_Read(void *pUserData,void *pBuffer,ph7_int64 nDatatoRead)` |
|     - |  689 |  |
|     - |  690 | `	ssize_t nRd;` |
| 32302 |  691 | `	nRd = read(SX_PTR_TO_INT(pUserData),pBuffer,(size_t)nDatatoRead);` |
| 32302 |  692 | `	if( nRd < 1 ){` |
|     - |  693 | `		/* EOF or IO error */` |
| 16146 |  694 | `		return -1;` |
|     - |  695 | `	}` |
| 16156 |  696 | `	return (ph7_int64)nRd;` |
| 16151 |  697 |  |
|     - |  698 | `/* ph7_int64 (*xWrite)(void *,const void *,ph7_int64); */` |
| 13840 |  699 | `static ph7_int64 UnixFile_Write(void *pUserData,const void *pBuffer,ph7_int64 nWrite)` |
|     - |  700 |  |
| 13840 |  701 | `	const char *zData = (const char *)pBuffer;` |
| 13840 |  702 | `	int fd = SX_PTR_TO_INT(pUserData);` |
|     - |  703 | `	ph7_int64 nCount;` |
|     - |  704 | `	ssize_t nWr;` |
| 13840 |  705 | `	nCount = 0;` |
| 13840 |  706 | `	for(;;){` |
| 27680 |  707 | `		if( nWrite < 1 ){` |
| 13840 |  708 | `			break;` |
|     - |  709 | `		}` |
| 13840 |  710 | `		nWr = write(fd,zData,(size_t)nWrite);` |
| 13840 |  711 | `		if( nWr < 1 ){` |
|     - |  712 | `			/* IO error */` |
|   ! 0 |  713 | `			break;` |
|     - |  714 | `		}` |
| 13840 |  715 | `		nWrite -= nWr;` |
| 13840 |  716 | `		nCount += nWr;` |
| 13840 |  717 | `		zData += nWr;` |
|     - |  718 | `	}` |
| 13840 |  719 | `	if( nWrite > 0 ){` |
|   ! 0 |  720 | `		return -1;` |
|     - |  721 | `	}` |
| 13840 |  722 | `	return nCount;` |
|  6920 |  723 |  |
