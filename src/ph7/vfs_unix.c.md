...
| 13572 |   29 | `static int UnixVfs_chdir(const char *zPath)` |
|     - |   30 | `{` |
|     - |   31 | `  int rc;` |
| 13572 |   32 | `  rc = chdir(zPath);` |
| 13572 |   33 | `  return rc == 0 ? PH7_OK : -1;` |
|     - |   34 | `}` |
...
|  8450 |   64 | `static int UnixVfs_isdir(const char *zPath)` |
|     - |   65 | `{` |
|     - |   66 | `	struct stat st;` |
|     - |   67 | `	int rc;` |
|  8450 |   68 | `	rc = stat(zPath,&st);` |
|  8450 |   69 | `	if( rc != 0 ){` |
|     4 |   70 | `	 return -1;` |
|     - |   71 | `	}` |
|  8446 |   72 | `	rc = S_ISDIR(st.st_mode);` |
|  8446 |   73 | `	return rc ? PH7_OK : -1 ;` |
|  4225 |   74 | `}` |
...
| 32558 |  108 | `static int UnixVfs_unlink(const char *zPath)` |
|     - |  109 | `{` |
|     - |  110 | `	int rc;` |
| 32558 |  111 | `	rc = unlink(zPath);` |
| 32558 |  112 | `	return rc == 0 ? PH7_OK : -1 ;` |
|     - |  113 | `}` |
...
|  6484 |  320 | `static int UnixVfs_isfile(const char *zPath)` |
|     - |  321 | `{` |
|     - |  322 | `	struct stat st;` |
|     - |  323 | `	int rc;` |
|  6484 |  324 | `	rc = stat(zPath,&st);` |
|  6484 |  325 | `	if( rc != 0 ){` |
|     2 |  326 | `	 return -1;` |
|     - |  327 | `	}` |
|  6482 |  328 | `	rc = S_ISREG(st.st_mode);` |
|  6482 |  329 | `	return rc ? PH7_OK : -1 ;` |
|  3242 |  330 | `}` |
...
|  3894 |  411 | `static int UnixVfs_Mmap(const char *zPath,void **ppMap,ph7_int64 *pSize)` |
|     - |  412 | `{` |
|     - |  413 | `	struct stat st;` |
|     - |  414 | `	void *pMap;` |
|     - |  415 | `	int fd;` |
...
|  3894 |  418 | `	fd = open(zPath,O_RDONLY);` |
|  3894 |  419 | `	if( fd < 0 ){` |
|     2 |  420 | `		return -1;` |
|     - |  421 | `	}` |
|     - |  422 | `	/* stat the handle */` |
|  3892 |  423 | `	fstat(fd,&st);` |
|     - |  424 | `	/* Obtain a memory view of the whole file */` |
|  3892 |  425 | `	pMap = mmap(0,st.st_size,PROT_READ,MAP_PRIVATE\|MAP_FILE,fd,0);` |
|  3892 |  426 | `	rc = PH7_OK;` |
|  3892 |  427 | `	if( pMap == MAP_FAILED ){` |
|   ! 0 |  428 | `		rc = -1;` |
|   ! 0 |  429 | `	}else{` |
|     - |  430 | `		/* Point to the memory view */` |
|  3892 |  431 | `		*ppMap = pMap;` |
|  3892 |  432 | `		*pSize = (ph7_int64)st.st_size;` |
|     - |  433 | `	}` |
|  3892 |  434 | `	close(fd);` |
|  3892 |  435 | `	return rc;` |
|  1947 |  436 | `}` |
|     - |  437 | `/* void (*xUnmap)(void *,ph7_int64)  */` |
|  3892 |  438 | `static void UnixVfs_Unmap(void *pView,ph7_int64 nSize)` |
|     - |  439 | `{` |
|  3892 |  440 | `	munmap(pView,(size_t)nSize);` |
|  3892 |  441 | `}` |
...
| 30170 |  580 | `static int UnixFile_Open(const char *zPath,int iOpenMode,ph7_value *pResource,void **ppHandle)` |
|     - |  581 | `{` |
| 30170 |  582 | `	int iOpen = O_RDONLY;` |
|     - |  583 | `	int fd;` |
|     - |  584 | `	/* Set the desired flags according to the open mode */` |
| 30170 |  585 | `	if( iOpenMode & PH7_IO_OPEN_CREATE ){` |
|     - |  586 | `		/* Open existing file, or create if it doesn't exist */` |
| 13832 |  587 | `		iOpen = O_CREAT;` |
| 13832 |  588 | `		if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  589 | `			/* If the specified file exists and is writable, the function overwrites the file */` |
| 13832 |  590 | `			iOpen \|= O_TRUNC;` |
|  6916 |  591 | `			SXUNUSED(pResource); /* cc warning */` |
|  6916 |  592 | `		}` |
| 23254 |  593 | `	}else if( iOpenMode & PH7_IO_OPEN_EXCL ){` |
...
|   ! 0 |  603 | `	}` |
| 30170 |  604 | `	if( iOpenMode & PH7_IO_OPEN_RDWR ){` |
|     - |  605 | `		/* Read+Write access */` |
| 13816 |  606 | `		iOpen &= ~O_RDONLY;` |
| 13816 |  607 | `		iOpen \|= O_RDWR;` |
| 23262 |  608 | `	}else if( iOpenMode & PH7_IO_OPEN_WRONLY ){` |
|     - |  609 | `		/* Write only access */` |
|    22 |  610 | `		iOpen &= ~O_RDONLY;` |
|    22 |  611 | `		iOpen \|= O_WRONLY;` |
|    11 |  612 | `	}` |
| 30170 |  613 | `	if( iOpenMode & PH7_IO_OPEN_APPEND ){` |
|     - |  614 | `		/* Append mode */` |
...
| 30170 |  624 | `	fd = open(zPath,iOpen,PH7_UNIX_OPEN_MODE);` |
| 30170 |  625 | `	if( fd < 0 ){` |
|     - |  626 | `		/* IO error */` |
|    12 |  627 | `		return -1;` |
|     - |  628 | `	}` |
|     - |  629 | `	/* Save the handle */` |
| 30158 |  630 | `	*ppHandle = SX_INT_TO_PTR(fd);` |
| 30158 |  631 | `	return PH7_OK;` |
| 15085 |  632 | `}` |
|     - |  633 | `/* int (*xOpenDir)(const char *,ph7_value *,void **) */` |
|   988 |  634 | `static int UnixDir_Open(const char *zPath,ph7_value *pResource,void **ppHandle)` |
|     - |  635 | `{` |
|     - |  636 | `	DIR *pDir;` |
|     - |  637 | `	/* Open the target directory */` |
|   988 |  638 | `	pDir = opendir(zPath);` |
|   988 |  639 | `	if( pDir == 0 ){` |
|   ! 0 |  640 | `		SXUNUSED(pResource); /* Compiler warning */` |
|   ! 0 |  641 | `		return -1;` |
|     - |  642 | `	}` |
|     - |  643 | `	/* Save our structure */` |
|   988 |  644 | `	*ppHandle = pDir;` |
|   988 |  645 | `	return PH7_OK;` |
|   494 |  646 | `}` |
|     - |  647 | `/* void (*xCloseDir)(void *) */` |
|   988 |  648 | `static void UnixDir_Close(void *pUserData)` |
|     - |  649 | `{` |
|   988 |  650 | `	closedir((DIR *)pUserData);` |
|   988 |  651 | `}` |
|     - |  652 | `/* void (*xClose)(void *); */` |
| 30156 |  653 | `static void UnixFile_Close(void *pUserData)` |
|     - |  654 | `{` |
| 30156 |  655 | `	close(SX_PTR_TO_INT(pUserData));` |
| 30156 |  656 | `}` |
|     - |  657 | `/* int (*xReadDir)(void *,ph7_context *) */` |
|  8448 |  658 | `static int UnixDir_Read(void *pUserData,ph7_context *pCtx)` |
|     - |  659 | `{` |
|  8448 |  660 | `	DIR *pDir = (DIR *)pUserData;` |
|     - |  661 | `	struct dirent *pEntry;` |
|  8448 |  662 | `	char *zName = 0; /* cc warning */` |
|  8448 |  663 | `	sxu32 n = 0;` |
|  5212 |  664 | `	for(;;){` |
| 10424 |  665 | `		pEntry = readdir(pDir);` |
| 10424 |  666 | `		if( pEntry == 0 ){` |
|     - |  667 | `			/* No more entries to process */` |
|   984 |  668 | `			return -1;` |
|     - |  669 | `		}` |
|  9440 |  670 | `		zName = pEntry->d_name;` |
|  9440 |  671 | `		n = SyStrlen(zName);` |
|     - |  672 | `		/* Ignore '.' && '..' */` |
|  9440 |  673 | `		if( n > sizeof("..")-1 \|\| zName[0] != '.' \|\| ( n == sizeof("..")-1 && zName[1] != '.') ){` |
|  3732 |  674 | `			break;` |
|     - |  675 | `		}` |
|     - |  676 | `		/* Next entry */` |
|     - |  677 | `	}` |
|     - |  678 | `	/* Return the current file name */` |
|  7464 |  679 | `	ph7_result_string(pCtx,zName,(int)n);` |
|  7464 |  680 | `	return PH7_OK;` |
|  4224 |  681 | `}` |
...
| 32592 |  688 | `static ph7_int64 UnixFile_Read(void *pUserData,void *pBuffer,ph7_int64 nDatatoRead)` |
|     - |  689 | `{` |
|     - |  690 | `	ssize_t nRd;` |
| 32592 |  691 | `	nRd = read(SX_PTR_TO_INT(pUserData),pBuffer,(size_t)nDatatoRead);` |
| 32592 |  692 | `	if( nRd < 1 ){` |
|     - |  693 | `		/* EOF or IO error */` |
| 16292 |  694 | `		return -1;` |
|     - |  695 | `	}` |
| 16300 |  696 | `	return (ph7_int64)nRd;` |
| 16296 |  697 | `}` |
|     - |  698 | `/* ph7_int64 (*xWrite)(void *,const void *,ph7_int64); */` |
| 13846 |  699 | `static ph7_int64 UnixFile_Write(void *pUserData,const void *pBuffer,ph7_int64 nWrite)` |
|     - |  700 | `{` |
| 13846 |  701 | `	const char *zData = (const char *)pBuffer;` |
| 13846 |  702 | `	int fd = SX_PTR_TO_INT(pUserData);` |
|     - |  703 | `	ph7_int64 nCount;` |
|     - |  704 | `	ssize_t nWr;` |
| 13846 |  705 | `	nCount = 0;` |
| 13846 |  706 | `	for(;;){` |
| 27692 |  707 | `		if( nWrite < 1 ){` |
| 13846 |  708 | `			break;` |
|     - |  709 | `		}` |
| 13846 |  710 | `		nWr = write(fd,zData,(size_t)nWrite);` |
| 13846 |  711 | `		if( nWr < 1 ){` |
|     - |  712 | `			/* IO error */` |
|   ! 0 |  713 | `			break;` |
|     - |  714 | `		}` |
| 13846 |  715 | `		nWrite -= nWr;` |
| 13846 |  716 | `		nCount += nWr;` |
| 13846 |  717 | `		zData += nWr;` |
|     - |  718 | `	}` |
| 13846 |  719 | `	if( nWrite > 0 ){` |
|   ! 0 |  720 | `		return -1;` |
|     - |  721 | `	}` |
| 13846 |  722 | `	return nCount;` |
|  6923 |  723 | `}` |
