...
| 12414 |   29 | `static int UnixVfs_chdir(const char *zPath)` |
|     - |   30 |  |
|     - |   31 | `  int rc;` |
| 12414 |   32 | `  rc = chdir(zPath);` |
| 12414 |   33 | `  return rc == 0 ? PH7_OK : -1;` |
|     - |   34 |  |
...
|  7274 |   64 | `static int UnixVfs_isdir(const char *zPath)` |
|     - |   65 |  |
|     - |   66 | `	struct stat st;` |
|     - |   67 | `	int rc;` |
|  7274 |   68 | `	rc = stat(zPath,&st);` |
|  7274 |   69 | `	if( rc != 0 ){` |
|     4 |   70 | `	 return -1;` |
|     - |   71 | `	}` |
|  7270 |   72 | `	rc = S_ISDIR(st.st_mode);` |
|  7270 |   73 | `	return rc ? PH7_OK : -1 ;` |
|  3637 |   74 |  |
...
| 27398 |  108 | `static int UnixVfs_unlink(const char *zPath)` |
|     - |  109 |  |
|     - |  110 | `	int rc;` |
| 27398 |  111 | `	rc = unlink(zPath);` |
| 27398 |  112 | `	return rc == 0 ? PH7_OK : -1 ;` |
|     - |  113 |  |
...
|  5454 |  320 | `static int UnixVfs_isfile(const char *zPath)` |
|     - |  321 |  |
|     - |  322 | `	struct stat st;` |
|     - |  323 | `	int rc;` |
|  5454 |  324 | `	rc = stat(zPath,&st);` |
|  5454 |  325 | `	if( rc != 0 ){` |
|     2 |  326 | `	 return -1;` |
|     - |  327 | `	}` |
|  5452 |  328 | `	rc = S_ISREG(st.st_mode);` |
|  5452 |  329 | `	return rc ? PH7_OK : -1 ;` |
|  2727 |  330 |  |
...
| 27530 |  580 | `static int UnixFile_Open(const char *zPath,int iOpenMode,ph7_value *pResource,void **ppHandle)` |
|     - |  581 |  |
| 27530 |  582 | `	int iOpen = O_RDONLY;` |
|     - |  583 | `	int fd;` |
|     - |  584 | `	/* Set the desired flags according to the open mode */` |
| 27530 |  585 | `	if( iOpenMode & PH7_IO_OPEN_CREATE ){` |
|     - |  586 | `		/* Open existing file, or create if it doesn't exist */` |
| 12648 |  587 | `		iOpen = O_CREAT;` |
| 12648 |  588 | `		if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  589 | `			/* If the specified file exists and is writable, the function overwrites the file */` |
| 12648 |  590 | `			iOpen \|= O_TRUNC;` |
|  6324 |  591 | `			SXUNUSED(pResource); /* cc warning */` |
|  6324 |  592 | `		}` |
| 21206 |  593 | `	}else if( iOpenMode & PH7_IO_OPEN_EXCL ){` |
|     - |  594 | `		/* Creates a new file, only if it does not already exist.` |
|     - |  595 | `		* If the file exists, it fails.` |
|     - |  596 | `		*/` |
|   ! 0 |  597 | `		iOpen = O_CREAT\|O_EXCL;` |
| 14882 |  598 | `	}else if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  599 | `		/* Opens a file and truncates it so that its size is zero bytes` |
|     - |  600 | `		 * The file must exist.` |
|     - |  601 | `		 */` |
|   ! 0 |  602 | `		iOpen = O_RDWR\|O_TRUNC;` |
|   ! 0 |  603 | `	}` |
| 27530 |  604 | `	if( iOpenMode & PH7_IO_OPEN_RDWR ){` |
|     - |  605 | `		/* Read+Write access */` |
| 12632 |  606 | `		iOpen &= ~O_RDONLY;` |
| 12632 |  607 | `		iOpen \|= O_RDWR;` |
| 21214 |  608 | `	}else if( iOpenMode & PH7_IO_OPEN_WRONLY ){` |
|     - |  609 | `		/* Write only access */` |
|    22 |  610 | `		iOpen &= ~O_RDONLY;` |
|    22 |  611 | `		iOpen \|= O_WRONLY;` |
|    11 |  612 | `	}` |
| 27530 |  613 | `	if( iOpenMode & PH7_IO_OPEN_APPEND ){` |
|     - |  614 | `		/* Append mode */` |
...
| 27530 |  624 | `	fd = open(zPath,iOpen,PH7_UNIX_OPEN_MODE);` |
| 27530 |  625 | `	if( fd < 0 ){` |
|     - |  626 | `		/* IO error */` |
|    12 |  627 | `		return -1;` |
|     - |  628 | `	}` |
|     - |  629 | `	/* Save the handle */` |
| 27518 |  630 | `	*ppHandle = SX_INT_TO_PTR(fd);` |
| 27518 |  631 | `	return PH7_OK;` |
| 13765 |  632 |  |
...
| 27516 |  653 | `static void UnixFile_Close(void *pUserData)` |
|     - |  654 |  |
| 27516 |  655 | `	close(SX_PTR_TO_INT(pUserData));` |
| 27516 |  656 |  |
|     - |  657 | `/* int (*xReadDir)(void *,ph7_context *) */` |
|  7272 |  658 | `static int UnixDir_Read(void *pUserData,ph7_context *pCtx)` |
|     - |  659 |  |
|  7272 |  660 | `	DIR *pDir = (DIR *)pUserData;` |
|     - |  661 | `	struct dirent *pEntry;` |
|  7272 |  662 | `	char *zName = 0; /* cc warning */` |
|  7272 |  663 | `	sxu32 n = 0;` |
|  4550 |  664 | `	for(;;){` |
|  9096 |  665 | `		pEntry = readdir(pDir);` |
|  9096 |  666 | `		if( pEntry == 0 ){` |
|     - |  667 | `			/* No more entries to process */` |
|   910 |  668 | `			return -1;` |
|     - |  669 | `		}` |
|  8186 |  670 | `		zName = pEntry->d_name;` |
|  8186 |  671 | `		n = SyStrlen(zName);` |
|     - |  672 | `		/* Ignore '.' && '..' */` |
|  8186 |  673 | `		if( n > sizeof("..")-1 \|\| zName[0] != '.' \|\| ( n == sizeof("..")-1 && zName[1] != '.') ){` |
|  3181 |  674 | `			break;` |
|     - |  675 | `		}` |
|     - |  676 | `		/* Next entry */` |
|     - |  677 | `	}` |
|     - |  678 | `	/* Return the current file name */` |
|  6362 |  679 | `	ph7_result_string(pCtx,zName,(int)n);` |
|  6362 |  680 | `	return PH7_OK;` |
|  3636 |  681 |  |
...
| 29690 |  688 | `static ph7_int64 UnixFile_Read(void *pUserData,void *pBuffer,ph7_int64 nDatatoRead)` |
|     - |  689 |  |
|     - |  690 | `	ssize_t nRd;` |
| 29690 |  691 | `	nRd = read(SX_PTR_TO_INT(pUserData),pBuffer,(size_t)nDatatoRead);` |
| 29690 |  692 | `	if( nRd < 1 ){` |
|     - |  693 | `		/* EOF or IO error */` |
| 14840 |  694 | `		return -1;` |
|     - |  695 | `	}` |
| 14850 |  696 | `	return (ph7_int64)nRd;` |
| 14845 |  697 |  |
|     - |  698 | `/* ph7_int64 (*xWrite)(void *,const void *,ph7_int64); */` |
| 12670 |  699 | `static ph7_int64 UnixFile_Write(void *pUserData,const void *pBuffer,ph7_int64 nWrite)` |
|     - |  700 |  |
| 12670 |  701 | `	const char *zData = (const char *)pBuffer;` |
| 12670 |  702 | `	int fd = SX_PTR_TO_INT(pUserData);` |
|     - |  703 | `	ph7_int64 nCount;` |
|     - |  704 | `	ssize_t nWr;` |
| 12670 |  705 | `	nCount = 0;` |
| 12670 |  706 | `	for(;;){` |
| 25340 |  707 | `		if( nWrite < 1 ){` |
| 12670 |  708 | `			break;` |
|     - |  709 | `		}` |
| 12670 |  710 | `		nWr = write(fd,zData,(size_t)nWrite);` |
| 12670 |  711 | `		if( nWr < 1 ){` |
|     - |  712 | `			/* IO error */` |
|   ! 0 |  713 | `			break;` |
|     - |  714 | `		}` |
| 12670 |  715 | `		nWrite -= nWr;` |
| 12670 |  716 | `		nCount += nWr;` |
| 12670 |  717 | `		zData += nWr;` |
|     - |  718 | `	}` |
| 12670 |  719 | `	if( nWrite > 0 ){` |
|   ! 0 |  720 | `		return -1;` |
|     - |  721 | `	}` |
| 12670 |  722 | `	return nCount;` |
|  6335 |  723 |  |
