...
| 13486 |   29 | `static int UnixVfs_chdir(const char *zPath)` |
|     - |   30 | `{` |
|     - |   31 | `  int rc;` |
| 13486 |   32 | `  rc = chdir(zPath);` |
| 13486 |   33 | `  return rc == 0 ? PH7_OK : -1;` |
|     - |   34 | `}` |
...
|  8364 |   64 | `static int UnixVfs_isdir(const char *zPath)` |
|     - |   65 | `{` |
|     - |   66 | `	struct stat st;` |
|     - |   67 | `	int rc;` |
|  8364 |   68 | `	rc = stat(zPath,&st);` |
|  8364 |   69 | `	if( rc != 0 ){` |
|     4 |   70 | `	 return -1;` |
|     - |   71 | `	}` |
|  8360 |   72 | `	rc = S_ISDIR(st.st_mode);` |
|  8360 |   73 | `	return rc ? PH7_OK : -1 ;` |
|  4182 |   74 | `}` |
...
| 32148 |  108 | `static int UnixVfs_unlink(const char *zPath)` |
|     - |  109 | `{` |
|     - |  110 | `	int rc;` |
| 32148 |  111 | `	rc = unlink(zPath);` |
| 32148 |  112 | `	return rc == 0 ? PH7_OK : -1 ;` |
|     - |  113 | `}` |
...
|  6402 |  320 | `static int UnixVfs_isfile(const char *zPath)` |
|     - |  321 | `{` |
|     - |  322 | `	struct stat st;` |
|     - |  323 | `	int rc;` |
|  6402 |  324 | `	rc = stat(zPath,&st);` |
|  6402 |  325 | `	if( rc != 0 ){` |
|     2 |  326 | `	 return -1;` |
|     - |  327 | `	}` |
|  6400 |  328 | `	rc = S_ISREG(st.st_mode);` |
|  6400 |  329 | `	return rc ? PH7_OK : -1 ;` |
|  3201 |  330 | `}` |
...
| 29906 |  580 | `static int UnixFile_Open(const char *zPath,int iOpenMode,ph7_value *pResource,void **ppHandle)` |
|     - |  581 | `{` |
| 29906 |  582 | `	int iOpen = O_RDONLY;` |
|     - |  583 | `	int fd;` |
|     - |  584 | `	/* Set the desired flags according to the open mode */` |
| 29906 |  585 | `	if( iOpenMode & PH7_IO_OPEN_CREATE ){` |
|     - |  586 | `		/* Open existing file, or create if it doesn't exist */` |
| 13732 |  587 | `		iOpen = O_CREAT;` |
| 13732 |  588 | `		if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  589 | `			/* If the specified file exists and is writable, the function overwrites the file */` |
| 13732 |  590 | `			iOpen \|= O_TRUNC;` |
|  6866 |  591 | `			SXUNUSED(pResource); /* cc warning */` |
|  6866 |  592 | `		}` |
...
| 29906 |  624 | `	fd = open(zPath,iOpen,PH7_UNIX_OPEN_MODE);` |
| 29906 |  625 | `	if( fd < 0 ){` |
|     - |  626 | `		/* IO error */` |
|    12 |  627 | `		return -1;` |
|     - |  628 | `	}` |
|     - |  629 | `	/* Save the handle */` |
| 29894 |  630 | `	*ppHandle = SX_INT_TO_PTR(fd);` |
| 29894 |  631 | `	return PH7_OK;` |
| 14953 |  632 | `}` |
...
| 29892 |  653 | `static void UnixFile_Close(void *pUserData)` |
|     - |  654 | `{` |
| 29892 |  655 | `	close(SX_PTR_TO_INT(pUserData));` |
| 29892 |  656 | `}` |
|     - |  657 | `/* int (*xReadDir)(void *,ph7_context *) */` |
|  8362 |  658 | `static int UnixDir_Read(void *pUserData,ph7_context *pCtx)` |
|     - |  659 | `{` |
|  8362 |  660 | `	DIR *pDir = (DIR *)pUserData;` |
|     - |  661 | `	struct dirent *pEntry;` |
|  8362 |  662 | `	char *zName = 0; /* cc warning */` |
|  8362 |  663 | `	sxu32 n = 0;` |
|  5167 |  664 | `	for(;;){` |
| 10334 |  665 | `		pEntry = readdir(pDir);` |
| 10334 |  666 | `		if( pEntry == 0 ){` |
|     - |  667 | `			/* No more entries to process */` |
|   982 |  668 | `			return -1;` |
|     - |  669 | `		}` |
|  9352 |  670 | `		zName = pEntry->d_name;` |
|  9352 |  671 | `		n = SyStrlen(zName);` |
|     - |  672 | `		/* Ignore '.' && '..' */` |
|  9352 |  673 | `		if( n > sizeof("..")-1 \|\| zName[0] != '.' \|\| ( n == sizeof("..")-1 && zName[1] != '.') ){` |
|  3690 |  674 | `			break;` |
|     - |  675 | `		}` |
|     - |  676 | `		/* Next entry */` |
|     - |  677 | `	}` |
|     - |  678 | `	/* Return the current file name */` |
|  7380 |  679 | `	ph7_result_string(pCtx,zName,(int)n);` |
|  7380 |  680 | `	return PH7_OK;` |
|  4181 |  681 | `}` |
...
| 32264 |  688 | `static ph7_int64 UnixFile_Read(void *pUserData,void *pBuffer,ph7_int64 nDatatoRead)` |
|     - |  689 | `{` |
|     - |  690 | `	ssize_t nRd;` |
| 32264 |  691 | `	nRd = read(SX_PTR_TO_INT(pUserData),pBuffer,(size_t)nDatatoRead);` |
| 32264 |  692 | `	if( nRd < 1 ){` |
|     - |  693 | `		/* EOF or IO error */` |
| 16128 |  694 | `		return -1;` |
|     - |  695 | `	}` |
| 16136 |  696 | `	return (ph7_int64)nRd;` |
| 16132 |  697 | `}` |
|     - |  698 | `/* ph7_int64 (*xWrite)(void *,const void *,ph7_int64); */` |
| 13746 |  699 | `static ph7_int64 UnixFile_Write(void *pUserData,const void *pBuffer,ph7_int64 nWrite)` |
|     - |  700 | `{` |
| 13746 |  701 | `	const char *zData = (const char *)pBuffer;` |
| 13746 |  702 | `	int fd = SX_PTR_TO_INT(pUserData);` |
|     - |  703 | `	ph7_int64 nCount;` |
|     - |  704 | `	ssize_t nWr;` |
| 13746 |  705 | `	nCount = 0;` |
| 13746 |  706 | `	for(;;){` |
| 27492 |  707 | `		if( nWrite < 1 ){` |
| 13746 |  708 | `			break;` |
|     - |  709 | `		}` |
| 13746 |  710 | `		nWr = write(fd,zData,(size_t)nWrite);` |
| 13746 |  711 | `		if( nWr < 1 ){` |
|     - |  712 | `			/* IO error */` |
|   ! 0 |  713 | `			break;` |
|     - |  714 | `		}` |
| 13746 |  715 | `		nWrite -= nWr;` |
| 13746 |  716 | `		nCount += nWr;` |
| 13746 |  717 | `		zData += nWr;` |
|     - |  718 | `	}` |
| 13746 |  719 | `	if( nWrite > 0 ){` |
|   ! 0 |  720 | `		return -1;` |
|     - |  721 | `	}` |
| 13746 |  722 | `	return nCount;` |
|  6873 |  723 | `}` |
