...
| 13378 |   31 | `static int UnixVfs_chdir(const char *zPath)` |
|     - |   32 | `{` |
|     - |   33 | `  int rc;` |
| 13378 |   34 | `  rc = chdir(zPath);` |
| 13378 |   35 | `  return rc == 0 ? PH7_OK : -1;` |
|     - |   36 | `}` |
...
|  8754 |   66 | `static int UnixVfs_isdir(const char *zPath)` |
|     - |   67 | `{` |
|     - |   68 | `	struct stat st;` |
|     - |   69 | `	int rc;` |
|  8754 |   70 | `	rc = stat(zPath,&st);` |
|  8754 |   71 | `	if( rc != 0 ){` |
|     4 |   72 | `	 return -1;` |
|     - |   73 | `	}` |
|  8750 |   74 | `	rc = S_ISDIR(st.st_mode);` |
|  8750 |   75 | `	return rc ? PH7_OK : -1 ;` |
|  4377 |   76 | `}` |
...
| 33438 |  110 | `static int UnixVfs_unlink(const char *zPath)` |
|     - |  111 | `{` |
|     - |  112 | `	int rc;` |
| 33438 |  113 | `	rc = unlink(zPath);` |
| 33438 |  114 | `	return rc == 0 ? PH7_OK : -1 ;` |
|     - |  115 | `}` |
...
|    52 |  361 | `	 return -1;` |
|     - |  362 | `	}` |
|  6660 |  363 | `	rc = S_ISREG(st.st_mode);` |
|  6660 |  364 | `	return rc ? PH7_OK : -1 ;` |
|  3356 |  365 | `}` |
...
| 30178 |  607 | `static int UnixFile_Open(const char *zPath,int iOpenMode,ph7_value *pResource,void **ppHandle)` |
|     - |  608 | `{` |
| 30178 |  609 | `	int iOpen = O_RDONLY;` |
|     - |  610 | `	int fd;` |
|     - |  611 | `	/* Set the desired flags according to the open mode */` |
| 30178 |  612 | `	if( iOpenMode & PH7_IO_OPEN_CREATE ){` |
|     - |  613 | `		/* Open existing file, or create if it doesn't exist */` |
| 13652 |  614 | `		iOpen = O_CREAT;` |
| 13652 |  615 | `		if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  616 | `			/* If the specified file exists and is writable, the function overwrites the file */` |
| 13652 |  617 | `			iOpen \|= O_TRUNC;` |
|  6826 |  618 | `			SXUNUSED(pResource); /* cc warning */` |
|  6826 |  619 | `		}` |
| 23352 |  620 | `	}else if( iOpenMode & PH7_IO_OPEN_EXCL ){` |
|     - |  621 | `		/* Creates a new file, only if it does not already exist.` |
|     - |  622 | `		* If the file exists, it fails.` |
|     - |  623 | `		*/` |
|   130 |  624 | `		iOpen = O_CREAT\|O_EXCL;` |
| 16461 |  625 | `	}else if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  626 | `		/* Opens a file and truncates it so that its size is zero bytes` |
|     - |  627 | `		 * The file must exist.` |
|     - |  628 | `		 */` |
|   ! 0 |  629 | `		iOpen = O_RDWR\|O_TRUNC;` |
|   ! 0 |  630 | `	}` |
| 30178 |  631 | `	if( iOpenMode & PH7_IO_OPEN_RDWR ){` |
|     - |  632 | `		/* Read+Write access */` |
| 13634 |  633 | `		iOpen &= ~O_RDONLY;` |
| 13634 |  634 | `		iOpen \|= O_RDWR;` |
| 23361 |  635 | `	}else if( iOpenMode & PH7_IO_OPEN_WRONLY ){` |
|     - |  636 | `		/* Write only access */` |
|   154 |  637 | `		iOpen &= ~O_RDONLY;` |
|   154 |  638 | `		iOpen \|= O_WRONLY;` |
|    77 |  639 | `	}` |
| 30178 |  640 | `	if( iOpenMode & PH7_IO_OPEN_APPEND ){` |
|     - |  641 | `		/* Append mode */` |
...
| 30178 |  651 | `	fd = open(zPath,iOpen,PH7_UNIX_OPEN_MODE);` |
| 30178 |  652 | `	if( fd < 0 ){` |
|     - |  653 | `		/* IO error */` |
|    12 |  654 | `		return -1;` |
|     - |  655 | `	}` |
|     - |  656 | `	/* Save the handle */` |
| 30166 |  657 | `	*ppHandle = SX_INT_TO_PTR(fd);` |
| 30166 |  658 | `	return PH7_OK;` |
| 15089 |  659 | `}` |
...
| 30164 |  680 | `static void UnixFile_Close(void *pUserData)` |
|     - |  681 | `{` |
| 30164 |  682 | `	close(SX_PTR_TO_INT(pUserData));` |
| 30164 |  683 | `}` |
|     - |  684 | `/* int (*xReadDir)(void *,ph7_context *) */` |
|  8752 |  685 | `static int UnixDir_Read(void *pUserData,ph7_context *pCtx)` |
|     - |  686 | `{` |
|  8752 |  687 | `	DIR *pDir = (DIR *)pUserData;` |
|     - |  688 | `	struct dirent *pEntry;` |
|  8752 |  689 | `	char *zName = 0; /* cc warning */` |
|  8752 |  690 | `	sxu32 n = 0;` |
|  5430 |  691 | `	for(;;){` |
| 10860 |  692 | `		pEntry = readdir(pDir);` |
| 10860 |  693 | `		if( pEntry == 0 ){` |
|     - |  694 | `			/* No more entries to process */` |
|  1050 |  695 | `			return -1;` |
|     - |  696 | `		}` |
|  9810 |  697 | `		zName = pEntry->d_name;` |
|  9810 |  698 | `		n = SyStrlen(zName);` |
|     - |  699 | `		/* Ignore '.' && '..' */` |
|  9810 |  700 | `		if( n > sizeof("..")-1 \|\| zName[0] != '.' \|\| ( n == sizeof("..")-1 && zName[1] != '.') ){` |
|  3851 |  701 | `			break;` |
|     - |  702 | `		}` |
|     - |  703 | `		/* Next entry */` |
|     - |  704 | `	}` |
|     - |  705 | `	/* Return the current file name */` |
|  7702 |  706 | `	ph7_result_string(pCtx,zName,(int)n);` |
|  7702 |  707 | `	return PH7_OK;` |
|  4376 |  708 | `}` |
...
| 32708 |  715 | `static ph7_int64 UnixFile_Read(void *pUserData,void *pBuffer,ph7_int64 nDatatoRead)` |
|     - |  716 | `{` |
|     - |  717 | `	ssize_t nRd;` |
| 32708 |  718 | `	nRd = read(SX_PTR_TO_INT(pUserData),pBuffer,(size_t)nDatatoRead);` |
| 32708 |  719 | `	if( nRd < 1 ){` |
|     - |  720 | `		/* EOF or IO error */` |
| 16350 |  721 | `		return -1;` |
|     - |  722 | `	}` |
| 16358 |  723 | `	return (ph7_int64)nRd;` |
| 16354 |  724 | `}` |
|     - |  725 | `/* ph7_int64 (*xWrite)(void *,const void *,ph7_int64); */` |
| 13664 |  726 | `static ph7_int64 UnixFile_Write(void *pUserData,const void *pBuffer,ph7_int64 nWrite)` |
|     - |  727 | `{` |
| 13664 |  728 | `	const char *zData = (const char *)pBuffer;` |
| 13664 |  729 | `	int fd = SX_PTR_TO_INT(pUserData);` |
|     - |  730 | `	ph7_int64 nCount;` |
|     - |  731 | `	ssize_t nWr;` |
| 13664 |  732 | `	nCount = 0;` |
| 13664 |  733 | `	for(;;){` |
| 27328 |  734 | `		if( nWrite < 1 ){` |
| 13664 |  735 | `			break;` |
|     - |  736 | `		}` |
| 13664 |  737 | `		nWr = write(fd,zData,(size_t)nWrite);` |
| 13664 |  738 | `		if( nWr < 1 ){` |
|     - |  739 | `			/* IO error */` |
|   ! 0 |  740 | `			break;` |
|     - |  741 | `		}` |
| 13664 |  742 | `		nWrite -= nWr;` |
| 13664 |  743 | `		nCount += nWr;` |
| 13664 |  744 | `		zData += nWr;` |
|     - |  745 | `	}` |
| 13664 |  746 | `	if( nWrite > 0 ){` |
|   ! 0 |  747 | `		return -1;` |
|     - |  748 | `	}` |
| 13664 |  749 | `	return nCount;` |
|  6832 |  750 | `}` |
