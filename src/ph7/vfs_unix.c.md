...
| 13554 |   29 | `static int UnixVfs_chdir(const char *zPath)` |
|     - |   30 | `{` |
|     - |   31 | `  int rc;` |
| 13554 |   32 | `  rc = chdir(zPath);` |
| 13554 |   33 | `  return rc == 0 ? PH7_OK : -1;` |
|     - |   34 | `}` |
...
|  8406 |   64 | `static int UnixVfs_isdir(const char *zPath)` |
|     - |   65 | `{` |
|     - |   66 | `	struct stat st;` |
|     - |   67 | `	int rc;` |
|  8406 |   68 | `	rc = stat(zPath,&st);` |
|  8406 |   69 | `	if( rc != 0 ){` |
|     4 |   70 | `	 return -1;` |
|     - |   71 | `	}` |
|  8402 |   72 | `	rc = S_ISDIR(st.st_mode);` |
|  8402 |   73 | `	return rc ? PH7_OK : -1 ;` |
|  4203 |   74 | `}` |
...
| 32358 |  108 | `static int UnixVfs_unlink(const char *zPath)` |
|     - |  109 | `{` |
|     - |  110 | `	int rc;` |
| 32358 |  111 | `	rc = unlink(zPath);` |
| 32358 |  112 | `	return rc == 0 ? PH7_OK : -1 ;` |
|     - |  113 | `}` |
...
|  6444 |  320 | `static int UnixVfs_isfile(const char *zPath)` |
|     - |  321 | `{` |
|     - |  322 | `	struct stat st;` |
|     - |  323 | `	int rc;` |
|  6444 |  324 | `	rc = stat(zPath,&st);` |
|  6444 |  325 | `	if( rc != 0 ){` |
|     2 |  326 | `	 return -1;` |
|     - |  327 | `	}` |
|  6442 |  328 | `	rc = S_ISREG(st.st_mode);` |
|  6442 |  329 | `	return rc ? PH7_OK : -1 ;` |
|  3222 |  330 | `}` |
...
| 30068 |  580 | `static int UnixFile_Open(const char *zPath,int iOpenMode,ph7_value *pResource,void **ppHandle)` |
|     - |  581 | `{` |
| 30068 |  582 | `	int iOpen = O_RDONLY;` |
|     - |  583 | `	int fd;` |
|     - |  584 | `	/* Set the desired flags according to the open mode */` |
| 30068 |  585 | `	if( iOpenMode & PH7_IO_OPEN_CREATE ){` |
|     - |  586 | `		/* Open existing file, or create if it doesn't exist */` |
| 13800 |  587 | `		iOpen = O_CREAT;` |
| 13800 |  588 | `		if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  589 | `			/* If the specified file exists and is writable, the function overwrites the file */` |
| 13800 |  590 | `			iOpen \|= O_TRUNC;` |
|  6900 |  591 | `			SXUNUSED(pResource); /* cc warning */` |
|  6900 |  592 | `		}` |
| 23168 |  593 | `	}else if( iOpenMode & PH7_IO_OPEN_EXCL ){` |
|     - |  594 | `		/* Creates a new file, only if it does not already exist.` |
|     - |  595 | `		* If the file exists, it fails.` |
|     - |  596 | `		*/` |
|   ! 0 |  597 | `		iOpen = O_CREAT\|O_EXCL;` |
| 16268 |  598 | `	}else if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  599 | `		/* Opens a file and truncates it so that its size is zero bytes` |
|     - |  600 | `		 * The file must exist.` |
|     - |  601 | `		 */` |
|   ! 0 |  602 | `		iOpen = O_RDWR\|O_TRUNC;` |
|   ! 0 |  603 | `	}` |
| 30068 |  604 | `	if( iOpenMode & PH7_IO_OPEN_RDWR ){` |
|     - |  605 | `		/* Read+Write access */` |
| 13784 |  606 | `		iOpen &= ~O_RDONLY;` |
| 13784 |  607 | `		iOpen \|= O_RDWR;` |
| 23176 |  608 | `	}else if( iOpenMode & PH7_IO_OPEN_WRONLY ){` |
|     - |  609 | `		/* Write only access */` |
|    22 |  610 | `		iOpen &= ~O_RDONLY;` |
|    22 |  611 | `		iOpen \|= O_WRONLY;` |
|    11 |  612 | `	}` |
| 30068 |  613 | `	if( iOpenMode & PH7_IO_OPEN_APPEND ){` |
|     - |  614 | `		/* Append mode */` |
...
| 30068 |  624 | `	fd = open(zPath,iOpen,PH7_UNIX_OPEN_MODE);` |
| 30068 |  625 | `	if( fd < 0 ){` |
|     - |  626 | `		/* IO error */` |
|    12 |  627 | `		return -1;` |
|     - |  628 | `	}` |
|     - |  629 | `	/* Save the handle */` |
| 30056 |  630 | `	*ppHandle = SX_INT_TO_PTR(fd);` |
| 30056 |  631 | `	return PH7_OK;` |
| 15034 |  632 | `}` |
...
| 30054 |  653 | `static void UnixFile_Close(void *pUserData)` |
|     - |  654 | `{` |
| 30054 |  655 | `	close(SX_PTR_TO_INT(pUserData));` |
| 30054 |  656 | `}` |
|     - |  657 | `/* int (*xReadDir)(void *,ph7_context *) */` |
|  8404 |  658 | `static int UnixDir_Read(void *pUserData,ph7_context *pCtx)` |
|     - |  659 | `{` |
|  8404 |  660 | `	DIR *pDir = (DIR *)pUserData;` |
|     - |  661 | `	struct dirent *pEntry;` |
|  8404 |  662 | `	char *zName = 0; /* cc warning */` |
|  8404 |  663 | `	sxu32 n = 0;` |
|  5188 |  664 | `	for(;;){` |
| 10376 |  665 | `		pEntry = readdir(pDir);` |
| 10376 |  666 | `		if( pEntry == 0 ){` |
|     - |  667 | `			/* No more entries to process */` |
|   982 |  668 | `			return -1;` |
|     - |  669 | `		}` |
|  9394 |  670 | `		zName = pEntry->d_name;` |
|  9394 |  671 | `		n = SyStrlen(zName);` |
|     - |  672 | `		/* Ignore '.' && '..' */` |
|  9394 |  673 | `		if( n > sizeof("..")-1 \|\| zName[0] != '.' \|\| ( n == sizeof("..")-1 && zName[1] != '.') ){` |
|  3711 |  674 | `			break;` |
|     - |  675 | `		}` |
|     - |  676 | `		/* Next entry */` |
|     - |  677 | `	}` |
|     - |  678 | `	/* Return the current file name */` |
|  7422 |  679 | `	ph7_result_string(pCtx,zName,(int)n);` |
|  7422 |  680 | `	return PH7_OK;` |
|  4202 |  681 | `}` |
...
| 32452 |  688 | `static ph7_int64 UnixFile_Read(void *pUserData,void *pBuffer,ph7_int64 nDatatoRead)` |
|     - |  689 | `{` |
|     - |  690 | `	ssize_t nRd;` |
| 32452 |  691 | `	nRd = read(SX_PTR_TO_INT(pUserData),pBuffer,(size_t)nDatatoRead);` |
| 32452 |  692 | `	if( nRd < 1 ){` |
|     - |  693 | `		/* EOF or IO error */` |
| 16222 |  694 | `		return -1;` |
|     - |  695 | `	}` |
| 16230 |  696 | `	return (ph7_int64)nRd;` |
| 16226 |  697 | `}` |
|     - |  698 | `/* ph7_int64 (*xWrite)(void *,const void *,ph7_int64); */` |
| 13814 |  699 | `static ph7_int64 UnixFile_Write(void *pUserData,const void *pBuffer,ph7_int64 nWrite)` |
|     - |  700 | `{` |
| 13814 |  701 | `	const char *zData = (const char *)pBuffer;` |
| 13814 |  702 | `	int fd = SX_PTR_TO_INT(pUserData);` |
|     - |  703 | `	ph7_int64 nCount;` |
|     - |  704 | `	ssize_t nWr;` |
| 13814 |  705 | `	nCount = 0;` |
| 13814 |  706 | `	for(;;){` |
| 27628 |  707 | `		if( nWrite < 1 ){` |
| 13814 |  708 | `			break;` |
|     - |  709 | `		}` |
| 13814 |  710 | `		nWr = write(fd,zData,(size_t)nWrite);` |
| 13814 |  711 | `		if( nWr < 1 ){` |
|     - |  712 | `			/* IO error */` |
|   ! 0 |  713 | `			break;` |
|     - |  714 | `		}` |
| 13814 |  715 | `		nWrite -= nWr;` |
| 13814 |  716 | `		nCount += nWr;` |
| 13814 |  717 | `		zData += nWr;` |
|     - |  718 | `	}` |
| 13814 |  719 | `	if( nWrite > 0 ){` |
|   ! 0 |  720 | `		return -1;` |
|     - |  721 | `	}` |
| 13814 |  722 | `	return nCount;` |
|  6907 |  723 | `}` |
