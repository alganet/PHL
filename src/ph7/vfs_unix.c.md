...
|     - |   38 | ` */` |
| 52458 |   39 | `static const char * UnixVfsLocalPath(const char *zPath)` |
|     - |   40 | `{` |
|     - |   41 | `	const char *zRest;` |
| 52458 |   42 | `	if( zPath == 0 \|\| SyStrnicmp(zPath,"file://",sizeof("file://")-1) != 0 ){` |
| 52448 |   43 | `		return zPath;` |
|     - |   44 | `	}` |
...
|  8666 |   94 | `static int UnixVfs_isdir(const char *zPath)` |
|     - |   95 | `{` |
|  8666 |   96 | `	zPath = UnixVfsLocalPath(zPath);` |
|     - |   97 | `	struct stat st;` |
|     - |   98 | `	int rc;` |
|  8666 |   99 | `	rc = stat(zPath,&st);` |
|  8666 |  100 | `	if( rc != 0 ){` |
|     4 |  101 | `	 return -1;` |
|     - |  102 | `	}` |
|  8662 |  103 | `	rc = S_ISDIR(st.st_mode);` |
|  8662 |  104 | `	return rc ? PH7_OK : -1 ;` |
|  4333 |  105 | `}` |
...
| 32868 |  141 | `static int UnixVfs_unlink(const char *zPath)` |
|     - |  142 | `{` |
| 32868 |  143 | `	zPath = UnixVfsLocalPath(zPath);` |
|     - |  144 | `	int rc;` |
| 32868 |  145 | `	rc = unlink(zPath);` |
| 32868 |  146 | `	return rc == 0 ? PH7_OK : -1 ;` |
|     - |  147 | `}` |
...
|  6604 |  400 | `static int UnixVfs_isfile(const char *zPath)` |
|     - |  401 | `{` |
|  6604 |  402 | `	zPath = UnixVfsLocalPath(zPath);` |
|     - |  403 | `	struct stat st;` |
|     - |  404 | `	int rc;` |
|  6604 |  405 | `	rc = stat(zPath,&st);` |
|  6604 |  406 | `	if( rc != 0 ){` |
|    54 |  407 | `	 return -1;` |
|     - |  408 | `	}` |
|  6550 |  409 | `	rc = S_ISREG(st.st_mode);` |
|  6550 |  410 | `	return rc ? PH7_OK : -1 ;` |
|  3302 |  411 | `}` |
...
| 28978 |  661 | `static int UnixFile_Open(const char *zPath,int iOpenMode,ph7_value *pResource,void **ppHandle)` |
|     - |  662 | `{` |
| 28978 |  663 | `	int iOpen = O_RDONLY;` |
|     - |  664 | `	int fd;` |
|     - |  665 | `	/* Set the desired flags according to the open mode */` |
| 28978 |  666 | `	if( iOpenMode & PH7_IO_OPEN_CREATE ){` |
...
| 28978 |  705 | `	fd = open(zPath,iOpen,PH7_UNIX_OPEN_MODE);` |
| 28978 |  706 | `	if( fd < 0 ){` |
|     - |  707 | `		/* IO error */` |
|    18 |  708 | `		return -1;` |
|     - |  709 | `	}` |
|     - |  710 | `	/* Save the handle */` |
| 28960 |  711 | `	*ppHandle = SX_INT_TO_PTR(fd);` |
| 28960 |  712 | `	return PH7_OK;` |
| 14489 |  713 | `}` |
...
| 28986 |  734 | `static void UnixFile_Close(void *pUserData)` |
|     - |  735 | `{` |
| 28986 |  736 | `	close(SX_PTR_TO_INT(pUserData));` |
| 28986 |  737 | `}` |
...
| 31392 |  763 | `static ph7_int64 UnixFile_Read(void *pUserData,void *pBuffer,ph7_int64 nDatatoRead)` |
|     - |  764 | `{` |
|     - |  765 | `	ssize_t nRd;` |
| 31392 |  766 | `	nRd = read(SX_PTR_TO_INT(pUserData),pBuffer,(size_t)nDatatoRead);` |
| 31392 |  767 | `	if( nRd < 1 ){` |
|     - |  768 | `		/* EOF or IO error */` |
| 15698 |  769 | `		return -1;` |
|     - |  770 | `	}` |
| 15694 |  771 | `	return (ph7_int64)nRd;` |
| 15696 |  772 | `}` |
