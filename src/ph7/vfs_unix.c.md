...
| 11090 |   29 | `static int UnixVfs_chdir(const char *zPath)` |
|     - |   30 |  |
|     - |   31 | `  int rc;` |
| 11090 |   32 | `  rc = chdir(zPath);` |
| 11090 |   33 | `  return rc == 0 ? PH7_OK : -1;` |
|     - |   34 |  |
...
|  6572 |   64 | `static int UnixVfs_isdir(const char *zPath)` |
|     - |   65 |  |
|     - |   66 | `	struct stat st;` |
|     - |   67 | `	int rc;` |
|  6572 |   68 | `	rc = stat(zPath,&st);` |
|  6572 |   69 | `	if( rc != 0 ){` |
|     4 |   70 | `	 return -1;` |
|     - |   71 | `	}` |
|  6568 |   72 | `	rc = S_ISDIR(st.st_mode);` |
|  6568 |   73 | `	return rc ? PH7_OK : -1 ;` |
|  3286 |   74 |  |
...
| 24058 |  108 | `static int UnixVfs_unlink(const char *zPath)` |
|     - |  109 |  |
|     - |  110 | `	int rc;` |
| 24058 |  111 | `	rc = unlink(zPath);` |
| 24058 |  112 | `	return rc == 0 ? PH7_OK : -1 ;` |
|     - |  113 |  |
...
|  4784 |  320 | `static int UnixVfs_isfile(const char *zPath)` |
|     - |  321 |  |
|     - |  322 | `	struct stat st;` |
|     - |  323 | `	int rc;` |
|  4784 |  324 | `	rc = stat(zPath,&st);` |
|  4784 |  325 | `	if( rc != 0 ){` |
|     2 |  326 | `	 return -1;` |
|     - |  327 | `	}` |
|  4782 |  328 | `	rc = S_ISREG(st.st_mode);` |
|  4782 |  329 | `	return rc ? PH7_OK : -1 ;` |
|  2392 |  330 |  |
...
|  2718 |  411 | `static int UnixVfs_Mmap(const char *zPath,void **ppMap,ph7_int64 *pSize)` |
|     - |  412 |  |
|     - |  413 | `	struct stat st;` |
|     - |  414 | `	void *pMap;` |
|     - |  415 | `	int fd;` |
...
|  2718 |  418 | `	fd = open(zPath,O_RDONLY);` |
|  2718 |  419 | `	if( fd < 0 ){` |
|     2 |  420 | `		return -1;` |
|     - |  421 | `	}` |
|     - |  422 | `	/* stat the handle */` |
|  2716 |  423 | `	fstat(fd,&st);` |
|     - |  424 | `	/* Obtain a memory view of the whole file */` |
|  2716 |  425 | `	pMap = mmap(0,st.st_size,PROT_READ,MAP_PRIVATE\|MAP_FILE,fd,0);` |
|  2716 |  426 | `	rc = PH7_OK;` |
|  2716 |  427 | `	if( pMap == MAP_FAILED ){` |
|   ! 0 |  428 | `		rc = -1;` |
|   ! 0 |  429 | `	}else{` |
|     - |  430 | `		/* Point to the memory view */` |
|  2716 |  431 | `		*ppMap = pMap;` |
|  2716 |  432 | `		*pSize = (ph7_int64)st.st_size;` |
|     - |  433 | `	}` |
|  2716 |  434 | `	close(fd);` |
|  2716 |  435 | `	return rc;` |
|  1359 |  436 |  |
|     - |  437 | `/* void (*xUnmap)(void *,ph7_int64)  */` |
|  2716 |  438 | `static void UnixVfs_Unmap(void *pView,ph7_int64 nSize)` |
|     - |  439 |  |
|  2716 |  440 | `	munmap(pView,(size_t)nSize);` |
|  2716 |  441 |  |
...
| 24638 |  580 | `static int UnixFile_Open(const char *zPath,int iOpenMode,ph7_value *pResource,void **ppHandle)` |
|     - |  581 |  |
| 24638 |  582 | `	int iOpen = O_RDONLY;` |
|     - |  583 | `	int fd;` |
|     - |  584 | `	/* Set the desired flags according to the open mode */` |
| 24638 |  585 | `	if( iOpenMode & PH7_IO_OPEN_CREATE ){` |
|     - |  586 | `		/* Open existing file, or create if it doesn't exist */` |
| 11324 |  587 | `		iOpen = O_CREAT;` |
| 11324 |  588 | `		if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  589 | `			/* If the specified file exists and is writable, the function overwrites the file */` |
| 11324 |  590 | `			iOpen \|= O_TRUNC;` |
|  5662 |  591 | `			SXUNUSED(pResource); /* cc warning */` |
|  5662 |  592 | `		}` |
| 18976 |  593 | `	}else if( iOpenMode & PH7_IO_OPEN_EXCL ){` |
|     - |  594 | `		/* Creates a new file, only if it does not already exist.` |
|     - |  595 | `		* If the file exists, it fails.` |
|     - |  596 | `		*/` |
|   ! 0 |  597 | `		iOpen = O_CREAT\|O_EXCL;` |
| 13314 |  598 | `	}else if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  599 | `		/* Opens a file and truncates it so that its size is zero bytes` |
|     - |  600 | `		 * The file must exist.` |
|     - |  601 | `		 */` |
|   ! 0 |  602 | `		iOpen = O_RDWR\|O_TRUNC;` |
|   ! 0 |  603 | `	}` |
| 24638 |  604 | `	if( iOpenMode & PH7_IO_OPEN_RDWR ){` |
|     - |  605 | `		/* Read+Write access */` |
| 11308 |  606 | `		iOpen &= ~O_RDONLY;` |
| 11308 |  607 | `		iOpen \|= O_RDWR;` |
| 18984 |  608 | `	}else if( iOpenMode & PH7_IO_OPEN_WRONLY ){` |
|     - |  609 | `		/* Write only access */` |
|    22 |  610 | `		iOpen &= ~O_RDONLY;` |
|    22 |  611 | `		iOpen \|= O_WRONLY;` |
|    11 |  612 | `	}` |
| 24638 |  613 | `	if( iOpenMode & PH7_IO_OPEN_APPEND ){` |
|     - |  614 | `		/* Append mode */` |
...
| 24638 |  624 | `	fd = open(zPath,iOpen,PH7_UNIX_OPEN_MODE);` |
| 24638 |  625 | `	if( fd < 0 ){` |
|     - |  626 | `		/* IO error */` |
|    12 |  627 | `		return -1;` |
|     - |  628 | `	}` |
|     - |  629 | `	/* Save the handle */` |
| 24626 |  630 | `	*ppHandle = SX_INT_TO_PTR(fd);` |
| 24626 |  631 | `	return PH7_OK;` |
| 12319 |  632 |  |
...
| 24624 |  653 | `static void UnixFile_Close(void *pUserData)` |
|     - |  654 |  |
| 24624 |  655 | `	close(SX_PTR_TO_INT(pUserData));` |
| 24624 |  656 |  |
|     - |  657 | `/* int (*xReadDir)(void *,ph7_context *) */` |
|  6570 |  658 | `static int UnixDir_Read(void *pUserData,ph7_context *pCtx)` |
|     - |  659 |  |
|  6570 |  660 | `	DIR *pDir = (DIR *)pUserData;` |
|     - |  661 | `	struct dirent *pEntry;` |
|  6570 |  662 | `	char *zName = 0; /* cc warning */` |
|  6570 |  663 | `	sxu32 n = 0;` |
|  4183 |  664 | `	for(;;){` |
|  8364 |  665 | `		pEntry = readdir(pDir);` |
|  8364 |  666 | `		if( pEntry == 0 ){` |
|     - |  667 | `			/* No more entries to process */` |
|   894 |  668 | `			return -1;` |
|     - |  669 | `		}` |
|  7470 |  670 | `		zName = pEntry->d_name;` |
|  7470 |  671 | `		n = SyStrlen(zName);` |
|     - |  672 | `		/* Ignore '.' && '..' */` |
|  7470 |  673 | `		if( n > sizeof("..")-1 \|\| zName[0] != '.' \|\| ( n == sizeof("..")-1 && zName[1] != '.') ){` |
|  2838 |  674 | `			break;` |
|     - |  675 | `		}` |
|     - |  676 | `		/* Next entry */` |
|     - |  677 | `	}` |
|     - |  678 | `	/* Return the current file name */` |
|  5676 |  679 | `	ph7_result_string(pCtx,zName,(int)n);` |
|  5676 |  680 | `	return PH7_OK;` |
|  3285 |  681 |  |
...
| 26554 |  688 | `static ph7_int64 UnixFile_Read(void *pUserData,void *pBuffer,ph7_int64 nDatatoRead)` |
|     - |  689 |  |
|     - |  690 | `	ssize_t nRd;` |
| 26554 |  691 | `	nRd = read(SX_PTR_TO_INT(pUserData),pBuffer,(size_t)nDatatoRead);` |
| 26554 |  692 | `	if( nRd < 1 ){` |
|     - |  693 | `		/* EOF or IO error */` |
| 13272 |  694 | `		return -1;` |
|     - |  695 | `	}` |
| 13282 |  696 | `	return (ph7_int64)nRd;` |
| 13277 |  697 |  |
|     - |  698 | `/* ph7_int64 (*xWrite)(void *,const void *,ph7_int64); */` |
| 11346 |  699 | `static ph7_int64 UnixFile_Write(void *pUserData,const void *pBuffer,ph7_int64 nWrite)` |
|     - |  700 |  |
| 11346 |  701 | `	const char *zData = (const char *)pBuffer;` |
| 11346 |  702 | `	int fd = SX_PTR_TO_INT(pUserData);` |
|     - |  703 | `	ph7_int64 nCount;` |
|     - |  704 | `	ssize_t nWr;` |
| 11346 |  705 | `	nCount = 0;` |
| 11346 |  706 | `	for(;;){` |
| 22692 |  707 | `		if( nWrite < 1 ){` |
| 11346 |  708 | `			break;` |
|     - |  709 | `		}` |
| 11346 |  710 | `		nWr = write(fd,zData,(size_t)nWrite);` |
| 11346 |  711 | `		if( nWr < 1 ){` |
|     - |  712 | `			/* IO error */` |
|   ! 0 |  713 | `			break;` |
|     - |  714 | `		}` |
| 11346 |  715 | `		nWrite -= nWr;` |
| 11346 |  716 | `		nCount += nWr;` |
| 11346 |  717 | `		zData += nWr;` |
|     - |  718 | `	}` |
| 11346 |  719 | `	if( nWrite > 0 ){` |
|   ! 0 |  720 | `		return -1;` |
|     - |  721 | `	}` |
| 11346 |  722 | `	return nCount;` |
|  5673 |  723 |  |
