...
| 10396 |   29 | `static int UnixVfs_chdir(const char *zPath)` |
|     - |   30 |  |
|     - |   31 | `  int rc;` |
| 10396 |   32 | `  rc = chdir(zPath);` |
| 10396 |   33 | `  return rc == 0 ? PH7_OK : -1;` |
|     - |   34 |  |
...
|  6190 |   64 | `static int UnixVfs_isdir(const char *zPath)` |
|     - |   65 |  |
|     - |   66 | `	struct stat st;` |
|     - |   67 | `	int rc;` |
|  6190 |   68 | `	rc = stat(zPath,&st);` |
|  6190 |   69 | `	if( rc != 0 ){` |
|     4 |   70 | `	 return -1;` |
|     - |   71 | `	}` |
|  6186 |   72 | `	rc = S_ISDIR(st.st_mode);` |
|  6186 |   73 | `	return rc ? PH7_OK : -1 ;` |
|  3095 |   74 |  |
...
| 22318 |  108 | `static int UnixVfs_unlink(const char *zPath)` |
|     - |  109 |  |
|     - |  110 | `	int rc;` |
| 22318 |  111 | `	rc = unlink(zPath);` |
| 22318 |  112 | `	return rc == 0 ? PH7_OK : -1 ;` |
|     - |  113 |  |
...
|  4434 |  320 | `static int UnixVfs_isfile(const char *zPath)` |
|     - |  321 |  |
|     - |  322 | `	struct stat st;` |
|     - |  323 | `	int rc;` |
|  4434 |  324 | `	rc = stat(zPath,&st);` |
|  4434 |  325 | `	if( rc != 0 ){` |
|     2 |  326 | `	 return -1;` |
|     - |  327 | `	}` |
|  4432 |  328 | `	rc = S_ISREG(st.st_mode);` |
|  4432 |  329 | `	return rc ? PH7_OK : -1 ;` |
|  2217 |  330 |  |
...
|  2818 |  411 | `static int UnixVfs_Mmap(const char *zPath,void **ppMap,ph7_int64 *pSize)` |
|     - |  412 |  |
|     - |  413 | `	struct stat st;` |
|     - |  414 | `	void *pMap;` |
|     - |  415 | `	int fd;` |
...
|  2818 |  418 | `	fd = open(zPath,O_RDONLY);` |
|  2818 |  419 | `	if( fd < 0 ){` |
|     2 |  420 | `		return -1;` |
|     - |  421 | `	}` |
|     - |  422 | `	/* stat the handle */` |
|  2816 |  423 | `	fstat(fd,&st);` |
|     - |  424 | `	/* Obtain a memory view of the whole file */` |
|  2816 |  425 | `	pMap = mmap(0,st.st_size,PROT_READ,MAP_PRIVATE\|MAP_FILE,fd,0);` |
|  2816 |  426 | `	rc = PH7_OK;` |
|  2816 |  427 | `	if( pMap == MAP_FAILED ){` |
|   ! 0 |  428 | `		rc = -1;` |
|   ! 0 |  429 | `	}else{` |
|     - |  430 | `		/* Point to the memory view */` |
|  2816 |  431 | `		*ppMap = pMap;` |
|  2816 |  432 | `		*pSize = (ph7_int64)st.st_size;` |
|     - |  433 | `	}` |
|  2816 |  434 | `	close(fd);` |
|  2816 |  435 | `	return rc;` |
|  1409 |  436 |  |
|     - |  437 | `/* void (*xUnmap)(void *,ph7_int64)  */` |
|  2816 |  438 | `static void UnixVfs_Unmap(void *pView,ph7_int64 nSize)` |
|     - |  439 |  |
|  2816 |  440 | `	munmap(pView,(size_t)nSize);` |
|  2816 |  441 |  |
...
| 22796 |  580 | `static int UnixFile_Open(const char *zPath,int iOpenMode,ph7_value *pResource,void **ppHandle)` |
|     - |  581 |  |
| 22796 |  582 | `	int iOpen = O_RDONLY;` |
|     - |  583 | `	int fd;` |
|     - |  584 | `	/* Set the desired flags according to the open mode */` |
| 22796 |  585 | `	if( iOpenMode & PH7_IO_OPEN_CREATE ){` |
|     - |  586 | `		/* Open existing file, or create if it doesn't exist */` |
| 10630 |  587 | `		iOpen = O_CREAT;` |
| 10630 |  588 | `		if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  589 | `			/* If the specified file exists and is writable, the function overwrites the file */` |
| 10630 |  590 | `			iOpen \|= O_TRUNC;` |
|  5315 |  591 | `			SXUNUSED(pResource); /* cc warning */` |
|  5315 |  592 | `		}` |
| 17481 |  593 | `	}else if( iOpenMode & PH7_IO_OPEN_EXCL ){` |
|     - |  594 | `		/* Creates a new file, only if it does not already exist.` |
|     - |  595 | `		* If the file exists, it fails.` |
|     - |  596 | `		*/` |
|   ! 0 |  597 | `		iOpen = O_CREAT\|O_EXCL;` |
| 12166 |  598 | `	}else if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|     - |  599 | `		/* Opens a file and truncates it so that its size is zero bytes` |
|     - |  600 | `		 * The file must exist.` |
|     - |  601 | `		 */` |
|   ! 0 |  602 | `		iOpen = O_RDWR\|O_TRUNC;` |
|   ! 0 |  603 | `	}` |
| 22796 |  604 | `	if( iOpenMode & PH7_IO_OPEN_RDWR ){` |
|     - |  605 | `		/* Read+Write access */` |
| 10614 |  606 | `		iOpen &= ~O_RDONLY;` |
| 10614 |  607 | `		iOpen \|= O_RDWR;` |
| 17489 |  608 | `	}else if( iOpenMode & PH7_IO_OPEN_WRONLY ){` |
|     - |  609 | `		/* Write only access */` |
|    22 |  610 | `		iOpen &= ~O_RDONLY;` |
|    22 |  611 | `		iOpen \|= O_WRONLY;` |
|    11 |  612 | `	}` |
| 22796 |  613 | `	if( iOpenMode & PH7_IO_OPEN_APPEND ){` |
|     - |  614 | `		/* Append mode */` |
...
| 22796 |  624 | `	fd = open(zPath,iOpen,PH7_UNIX_OPEN_MODE);` |
| 22796 |  625 | `	if( fd < 0 ){` |
|     - |  626 | `		/* IO error */` |
|     8 |  627 | `		return -1;` |
|     - |  628 | `	}` |
|     - |  629 | `	/* Save the handle */` |
| 22788 |  630 | `	*ppHandle = SX_INT_TO_PTR(fd);` |
| 22788 |  631 | `	return PH7_OK;` |
| 11398 |  632 |  |
|     - |  633 | `/* int (*xOpenDir)(const char *,ph7_value *,void **) */` |
|   880 |  634 | `static int UnixDir_Open(const char *zPath,ph7_value *pResource,void **ppHandle)` |
|     - |  635 |  |
|     - |  636 | `	DIR *pDir;` |
|     - |  637 | `	/* Open the target directory */` |
|   880 |  638 | `	pDir = opendir(zPath);` |
|   880 |  639 | `	if( pDir == 0 ){` |
|   ! 0 |  640 | `		SXUNUSED(pResource); /* Compiler warning */` |
|   ! 0 |  641 | `		return -1;` |
|     - |  642 | `	}` |
|     - |  643 | `	/* Save our structure */` |
|   880 |  644 | `	*ppHandle = pDir;` |
|   880 |  645 | `	return PH7_OK;` |
|   440 |  646 |  |
|     - |  647 | `/* void (*xCloseDir)(void *) */` |
|   880 |  648 | `static void UnixDir_Close(void *pUserData)` |
|     - |  649 |  |
|   880 |  650 | `	closedir((DIR *)pUserData);` |
|   880 |  651 |  |
|     - |  652 | `/* void (*xClose)(void *); */` |
| 22786 |  653 | `static void UnixFile_Close(void *pUserData)` |
|     - |  654 |  |
| 22786 |  655 | `	close(SX_PTR_TO_INT(pUserData));` |
| 22786 |  656 |  |
|     - |  657 | `/* int (*xReadDir)(void *,ph7_context *) */` |
|  6188 |  658 | `static int UnixDir_Read(void *pUserData,ph7_context *pCtx)` |
|     - |  659 |  |
|  6188 |  660 | `	DIR *pDir = (DIR *)pUserData;` |
|     - |  661 | `	struct dirent *pEntry;` |
|  6188 |  662 | `	char *zName = 0; /* cc warning */` |
|  6188 |  663 | `	sxu32 n = 0;` |
|  3976 |  664 | `	for(;;){` |
|  7948 |  665 | `		pEntry = readdir(pDir);` |
|  7948 |  666 | `		if( pEntry == 0 ){` |
|     - |  667 | `			/* No more entries to process */` |
|   878 |  668 | `			return -1;` |
|     - |  669 | `		}` |
|  7070 |  670 | `		zName = pEntry->d_name;` |
|  7070 |  671 | `		n = SyStrlen(zName);` |
|     - |  672 | `		/* Ignore '.' && '..' */` |
|  7070 |  673 | `		if( n > sizeof("..")-1 \|\| zName[0] != '.' \|\| ( n == sizeof("..")-1 && zName[1] != '.') ){` |
|  2655 |  674 | `			break;` |
|     - |  675 | `		}` |
|     - |  676 | `		/* Next entry */` |
|     - |  677 | `	}` |
|     - |  678 | `	/* Return the current file name */` |
|  5310 |  679 | `	ph7_result_string(pCtx,zName,(int)n);` |
|  5310 |  680 | `	return PH7_OK;` |
|  3094 |  681 |  |
...
| 24266 |  688 | `static ph7_int64 UnixFile_Read(void *pUserData,void *pBuffer,ph7_int64 nDatatoRead)` |
|     - |  689 |  |
|     - |  690 | `	ssize_t nRd;` |
| 24266 |  691 | `	nRd = read(SX_PTR_TO_INT(pUserData),pBuffer,(size_t)nDatatoRead);` |
| 24266 |  692 | `	if( nRd < 1 ){` |
|     - |  693 | `		/* EOF or IO error */` |
| 12128 |  694 | `		return -1;` |
|     - |  695 | `	}` |
| 12138 |  696 | `	return (ph7_int64)nRd;` |
| 12133 |  697 |  |
|     - |  698 | `/* ph7_int64 (*xWrite)(void *,const void *,ph7_int64); */` |
| 10652 |  699 | `static ph7_int64 UnixFile_Write(void *pUserData,const void *pBuffer,ph7_int64 nWrite)` |
|     - |  700 |  |
| 10652 |  701 | `	const char *zData = (const char *)pBuffer;` |
| 10652 |  702 | `	int fd = SX_PTR_TO_INT(pUserData);` |
|     - |  703 | `	ph7_int64 nCount;` |
|     - |  704 | `	ssize_t nWr;` |
| 10652 |  705 | `	nCount = 0;` |
| 10652 |  706 | `	for(;;){` |
| 21304 |  707 | `		if( nWrite < 1 ){` |
| 10652 |  708 | `			break;` |
|     - |  709 | `		}` |
| 10652 |  710 | `		nWr = write(fd,zData,(size_t)nWrite);` |
| 10652 |  711 | `		if( nWr < 1 ){` |
|     - |  712 | `			/* IO error */` |
|   ! 0 |  713 | `			break;` |
|     - |  714 | `		}` |
| 10652 |  715 | `		nWrite -= nWr;` |
| 10652 |  716 | `		nCount += nWr;` |
| 10652 |  717 | `		zData += nWr;` |
|     - |  718 | `	}` |
| 10652 |  719 | `	if( nWrite > 0 ){` |
|   ! 0 |  720 | `		return -1;` |
|     - |  721 | `	}` |
| 10652 |  722 | `	return nCount;` |
|  5326 |  723 |  |
