...
|        - |  265 | ` */` |
|  1213110 |  266 | `PH7_PRIVATE const ph7_expr_op *  PH7_ExprExtractOperator(SyString *pStr,SyToken *pLast)` |
|        5 |  267 | `{` |
|  1213115 |  268 | `	sxu32 n = 0;` |
|        - |  269 | `	sxi32 rc;` |
|        - |  270 | `	/* Do a linear lookup on the operators table */` |
| 20815821 |  271 | `	for(;;){` |
| 41631647 |  272 | `		if( n >= SX_ARRAYSIZE(aOpTable) ){` |
|      ! 0 |  273 | `			break;` |
|        - |  274 | `		}` |
| 41631647 |  275 | `		if( SyisAlpha(aOpTable[n].sOp.zString[0]) ){` |
|        - |  276 | `			/* TICKET 1433-012: Alpha stream operators [i.e: and,or,xor,new...] */` |
|  3717647 |  277 | `			rc = SyStringCmp(pStr,&aOpTable[n].sOp,SyStrnicmp);` |
|  1858826 |  278 | `		}else{` |
| 37914005 |  279 | `			rc = SyStringCmp(pStr,&aOpTable[n].sOp,SyMemcmp);` |
|        - |  280 | `		}` |
| 41631647 |  281 | `		if( rc == 0 ){` |
|  1217747 |  282 | `			if( aOpTable[n].sOp.nByte != sizeof(char) \|\| (aOpTable[n].iOp != EXPR_OP_UMINUS && aOpTable[n].iOp != EXPR_OP_UPLUS) \|\| pLast == 0 ){` |
|        - |  283 | `				/* There is no ambiguity here,simply return the first operator seen */` |
|  1212653 |  284 | `				return &aOpTable[n];` |
|        - |  285 | `			}` |
...
|        - |  290 | `			}` |
|     4769 |  291 | `			if( pLast->nType & PH7_TK_OP ){` |
...
|        4 |  299 | `			}` |
|     2316 |  300 | `		}` |
| 40418537 |  301 | `		++n; /* Next operator in the table */` |
|        5 |  302 | `	}` |
...
|        - |  310 | ` */` |
|   743134 |  311 | `PH7_PRIVATE void PH7_DelimitNestedTokens(SyToken *pIn,SyToken *pEnd,sxu32 nTokStart,sxu32 nTokEnd,SyToken **ppEnd)` |
|        5 |  312 | `{` |
|   743139 |  313 | `	SyToken *pCur = pIn;` |
|   743139 |  314 | `	sxi32 iNest = 1;` |
|  4144789 |  315 | `	for(;;){` |
|  8289583 |  316 | `		if( pCur >= pEnd ){` |
|      409 |  317 | `			break;` |
|        - |  318 | `		}` |
|  8289179 |  319 | `		if( pCur->nType & nTokStart ){` |
|        - |  320 | `			/* Increment nesting level */` |
|   391173 |  321 | `			iNest++;` |
|  8093595 |  322 | `		}else if( pCur->nType & nTokEnd ){` |
|        - |  323 | `			/* Decrement nesting level */` |
|  1133903 |  324 | `			iNest--;` |
|  1133903 |  325 | `			if( iNest <= 0 ){` |
|   742735 |  326 | `				break;` |
|        - |  327 | `			}` |
|   195584 |  328 | `		}` |
|        - |  329 | `		/* Advance cursor */` |
...
|        - |  366 | ` */` |
|  1023682 |  367 | `static sxi32 ExprVerifyNodes(ph7_gen_state *pGen,ph7_expr_node **apNode,sxi32 nNode)` |
|        5 |  368 | `{` |
|        - |  369 | `	sxi32 iParen,iSquare,iQuesty,iBraces;` |
|        - |  370 | `	sxi32 i,rc;` |
|        - |  371 |  |
|  1023687 |  372 | `	if( nNode > 0 && apNode[0]->pOp && (apNode[0]->pOp->iOp == EXPR_OP_ADD \|\| apNode[0]->pOp->iOp == EXPR_OP_SUB) ){` |
...
|       15 |  376 | `	}` |
|  1023687 |  377 | `	iParen = iSquare = iQuesty = iBraces = 0;` |
|  5548647 |  378 | `	for( i = 0 ; i < nNode ; ++i ){` |
|  4524999 |  379 | `		if( apNode[i]->xCode == PH7_CompileShortArray \|\| apNode[i]->xCode == PH7_CompileShortList ){` |
|        - |  380 | `			/* Short array/list literal: brackets are self-contained, skip */` |
|     1241 |  381 | `			continue;` |
|        - |  382 | `		}` |
|  4523763 |  383 | `		if( apNode[i]->pStart->nType & PH7_TK_LPAREN /*'('*/){` |
|   514167 |  384 | `			if( i > 0 && ( apNode[i-1]->xCode == PH7_CompileVariable \|\| apNode[i-1]->xCode == PH7_CompileLiteral \|\|` |
...
|   481759 |  387 | `					if( (apNode[i - 1]->pStart->nType & PH7_TK_OP) == 0 ){` |
|        - |  388 | `						/* We are dealing with a postfix [i.e: function call]  operator` |
|        - |  389 | `						 * not a simple left parenthesis. Mark the node.` |
|        - |  390 | `						 */` |
|   481759 |  391 | `						apNode[i]->pStart->nType \|= PH7_TK_OP;` |
|   481759 |  392 | `						apNode[i]->pStart->pUserData = (void *)&sFCallOp; /* Function call operator */` |
|   481759 |  393 | `						apNode[i]->pOp = &sFCallOp;` |
|   240877 |  394 | `					}` |
|   240877 |  395 | `			}` |
|   514167 |  396 | `			iParen++;` |
|  4266682 |  397 | `		}else if( apNode[i]->pStart->nType & PH7_TK_RPAREN/*')*/){` |
|   514167 |  398 | `			if( iParen <= 0 ){` |
...
|        - |  404 | `			}` |
|   514155 |  405 | `			iParen--;` |
|  3752514 |  406 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OSB /*'['*/){` |
|    98313 |  407 | `			iSquare++;` |
|  3446285 |  408 | `		}else if (apNode[i]->pStart->nType & PH7_TK_CSB /*']'*/){` |
...
|        - |  415 | `			}` |
|    98321 |  416 | `			iSquare--;` |
|  3347967 |  417 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OCB /*'{'*/){` |
|       20 |  418 | `			iBraces++;` |
...
|        - |  462 |  |
|        7 |  463 | `			}` |
|  3298800 |  464 | `		}else if (apNode[i]->pStart->nType & PH7_TK_CCB /*'}'*/){` |
|       24 |  465 | `			if( iBraces <= 0 ){` |
...
|        - |  471 | `			}` |
|       10 |  472 | `			iBraces--;` |
|  3298775 |  473 | `		}else if ( apNode[i]->pStart->nType & PH7_TK_COLON ){` |
|     2931 |  474 | `			if( iQuesty > 0 ){` |
|     2681 |  475 | `				iQuesty--;` |
|     1593 |  476 | `			}else if( iParen <= 0 ){` |
...
|        6 |  484 | `				return rc;` |
|        5 |  485 | `			}` |
|  3297306 |  486 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OP ){` |
|   923803 |  487 | `			const ph7_expr_op *pOp = (const ph7_expr_op *)apNode[i]->pOp;` |
|   923803 |  488 | `			if( pOp->iOp == EXPR_OP_QUESTY ){` |
|     2683 |  489 | `				iQuesty++;` |
|   922464 |  490 | `			}else if( i > 0 && (pOp->iOp == EXPR_OP_UMINUS \|\| pOp->iOp == EXPR_OP_UPLUS)){` |
...
|   461899 |  510 | `		}` |
|  2261867 |  511 | `	}` |
|  1023653 |  512 | `	if( iParen != 0 \|\| iSquare != 0 \|\| iQuesty != 0 \|\| iBraces != 0){` |
...
|       18 |  517 | `		return rc;` |
|        - |  518 | `	}` |
|  1023637 |  519 | `	return SXRET_OK;` |
|   511846 |  520 | `}` |
|        - |  521 | `/*` |
|        - |  522 | ` * Collect and assemble tokens holding a namespace path [i.e: namespace\to\const]` |
|        - |  523 | ` * or a simple literal [i.e: PHP_EOL].` |
|        - |  524 | ` */` |
|   848408 |  525 | `static void ExprAssembleLiteral(SyToken **ppCur,SyToken *pEnd)` |
|        5 |  526 | `{` |
|   848413 |  527 | `	SyToken *pIn = *ppCur;` |
|        - |  528 | `	/* Jump the first literal seen */` |
|   848413 |  529 | `	if( (pIn->nType & PH7_TK_NSSEP) == 0 ){` |
|   844539 |  530 | `		pIn++;` |
|   422267 |  531 | `	}` |
|   426168 |  532 | `	for(;;){` |
|   852341 |  533 | `		if(pIn < pEnd && (pIn->nType & PH7_TK_NSSEP) ){` |
|     3933 |  534 | `			pIn++;` |
...
|        - |  884 | ` */` |
|  4529058 |  885 | `static sxi32 ExprExtractNode(ph7_gen_state *pGen,ph7_expr_node **ppNode,int iLastWasTerm,int bAfterMemberOp)` |
|        5 |  886 | `{` |
|        - |  887 | `	ph7_expr_node *pNode;` |
|        - |  888 | `	SyToken *pCur;` |
|        - |  889 | `	sxi32 rc;` |
|        - |  890 | `	/* Allocate a new node */` |
|  4529063 |  891 | `	pNode = (ph7_expr_node *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_expr_node));` |
|  4529063 |  892 | `	if( pNode == 0 ){` |
...
|  4529063 |  899 | `	SyZero(pNode,sizeof(ph7_expr_node));` |
|  4529063 |  900 | `	SySetInit(&pNode->aNodeArgs,&pGen->pVm->sAllocator,sizeof(ph7_expr_node **));` |
|        - |  901 | `	/* Point to the head of the token stream */` |
|  4529063 |  902 | `	pCur = pNode->pStart = pGen->pIn;` |
|        - |  903 | `	/* Start collecting tokens */` |
|  4529063 |  904 | `	if( pCur->nType & PH7_TK_ELLIPSIS ){` |
...
|     3919 |  927 | `		return rc;` |
|        - |  928 | `	}` |
|  4525085 |  929 | `	if( (pCur->nType & PH7_TK_OSB) && !iLastWasTerm ){` |
...
|        5 |  958 | `		}` |
|  4524466 |  959 | `	}else if( pCur->nType & PH7_TK_OP ){` |
|        - |  960 | `		/* Point to the instance that describe this operator */` |
|  1022145 |  961 | `		pNode->pOp = (const ph7_expr_op *)pCur->pUserData;` |
|        - |  962 | `		/* Advance the stream cursor */` |
|  1022145 |  963 | `		pCur++;` |
|  4012777 |  964 | `	}else if( pCur->nType & PH7_TK_DOLLAR ){` |
|        - |  965 | `		/* Isolate variable */` |
|  2446505 |  966 | `		while( pCur < pGen->pEnd && (pCur->nType & PH7_TK_DOLLAR) ){` |
|  1223261 |  967 | `			pCur++; /* Variable variable */` |
|        5 |  968 | `		}` |
|  1223249 |  969 | `		if( pCur < pGen->pEnd ){` |
|  1223249 |  970 | `			if (pCur->nType & (PH7_TK_ID\|PH7_TK_KEYWORD) ){` |
|        - |  971 | `				/* Variable name */` |
|  1223221 |  972 | `				pCur++;` |
|   611641 |  973 | `			}else if( pCur->nType & PH7_TK_OCB /* '{' */ ){` |
|       24 |  974 | `				pCur++;` |
...
|        8 |  987 | `			}` |
|   611620 |  988 | `		}` |
|  1223245 |  989 | `		pNode->xCode = PH7_CompileVariable;` |
|  2890083 |  990 | `	 }else if( pCur->nType & PH7_TK_KEYWORD ){` |
...
|        5 | 1108 | `		 }` |
|  2249852 | 1109 | `	 }else if( pCur->nType & (PH7_TK_NSSEP\|PH7_TK_ID) ){` |
|        - | 1110 | `		 /* Constants,function name,namespace path,class name... */` |
|   824689 | 1111 | `		 ExprAssembleLiteral(&pCur,pGen->pEnd);` |
|   824689 | 1112 | `		 pNode->xCode = PH7_CompileLiteral;` |
|   412347 | 1113 | `	 }else{` |
|  1396585 | 1114 | `		 if( (pCur->nType & (PH7_TK_LPAREN\|PH7_TK_RPAREN\|PH7_TK_COMMA\|PH7_TK_COLON\|PH7_TK_CSB\|PH7_TK_OCB\|PH7_TK_CCB)) == 0 ){` |
|        - | 1115 | `			 /* Point to the code generator routine */` |
|   266953 | 1116 | `			 pNode->xCode = PH7_GetNodeHandler(pCur->nType);` |
|   266953 | 1117 | `			 if( pNode->xCode == 0 ){` |
...
|  4525051 | 1130 | `	pNode->pEnd = pCur;` |
|        - | 1131 | `	/* Save the node for later processing */` |
|  4525051 | 1132 | `	*ppNode = pNode;` |
|        - | 1133 | `	/* Synchronize cursors */` |
|  4525051 | 1134 | `	pGen->pIn = pCur;` |
|  4525051 | 1135 | `	return SXRET_OK;` |
|  2264534 | 1136 | `}` |
|        - | 1137 | `/*` |
...
|        - | 1140 | ` * level is zero.` |
|        - | 1141 | ` */` |
|    99740 | 1142 | `PH7_PRIVATE sxi32 PH7_GetNextExpr(SyToken *pStart,SyToken *pEnd,SyToken **ppNext)` |
|        5 | 1143 | `{` |
|    99745 | 1144 | `	SyToken *pCur = pStart;` |
|    99745 | 1145 | `	sxi32 iNest = 0;` |
|    99745 | 1146 | `	if( pCur >= pEnd \|\| (pCur->nType & PH7_TK_SEMI/*';'*/) ){` |
|        - | 1147 | `		/* Last expression */` |
|    51965 | 1148 | `		return SXERR_EOF;` |
|        - | 1149 | `	}` |
|   194381 | 1150 | `	while( pCur < pEnd ){` |
|   177131 | 1151 | `		if( (pCur->nType & (PH7_TK_COMMA/*','*/\|PH7_TK_SEMI/*';'*/)) && iNest <= 0){` |
|    30535 | 1152 | `			break;` |
|        - | 1153 | `		}` |
|   146601 | 1154 | `		if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|     9907 | 1155 | `			iNest++;` |
|   141650 | 1156 | `		}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}*/) ){` |
|     9909 | 1157 | `			iNest--;` |
|     4952 | 1158 | `		}` |
|   146601 | 1159 | `		pCur++;` |
|        5 | 1160 | `	}` |
|    47785 | 1161 | `	*ppNext = pCur;` |
|    47785 | 1162 | `	return SXRET_OK;` |
|    49875 | 1163 | `}` |
|        - | 1164 | `/*` |
|        - | 1165 | ` * Free an expression tree.` |
|        - | 1166 | ` */` |
|  3867092 | 1167 | `static void ExprFreeTree(ph7_gen_state *pGen,ph7_expr_node *pNode)` |
|        5 | 1168 | `{` |
|  3867097 | 1169 | `	if( pNode->pLeft ){` |
|        - | 1170 | `		/* Release the left tree */` |
|  1428385 | 1171 | `		ExprFreeTree(&(*pGen),pNode->pLeft);` |
|   714190 | 1172 | `	}` |
|  3867097 | 1173 | `	if( pNode->pRight ){` |
|        - | 1174 | `		/* Release the right tree */` |
|   771883 | 1175 | `		ExprFreeTree(&(*pGen),pNode->pRight);` |
|   385939 | 1176 | `	}` |
|  3867097 | 1177 | `	if( pNode->pCond ){` |
|        - | 1178 | `		/* Release the conditional tree used by the ternary operator */` |
|     2679 | 1179 | `		ExprFreeTree(&(*pGen),pNode->pCond);` |
|     1337 | 1180 | `	}` |
|  3867097 | 1181 | `	if( SySetUsed(&pNode->aNodeArgs) > 0 ){` |
|        - | 1182 | `		ph7_expr_node **apArg;` |
|        - | 1183 | `		sxu32 n;` |
|        - | 1184 | `		/* Release node arguments */` |
|   499545 | 1185 | `		apArg = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  1074355 | 1186 | `		for( n = 0 ; n < SySetUsed(&pNode->aNodeArgs) ; ++n ){` |
|   574815 | 1187 | `			ExprFreeTree(&(*pGen),apArg[n]);` |
|   287410 | 1188 | `		}` |
|   499545 | 1189 | `		SySetRelease(&pNode->aNodeArgs);` |
|   249770 | 1190 | `	}` |
|        - | 1191 | `	/* Finally,release this node */` |
|  3867097 | 1192 | `	SyMemBackendPoolFree(&pGen->pVm->sAllocator,pNode);` |
|  3867097 | 1193 | `}` |
|        - | 1194 | `/*` |
|        - | 1195 | ` * Free an expression tree.` |
|        - | 1196 | ` * This function is a wrapper around ExprFreeTree() defined above.` |
|        - | 1197 | ` */` |
|  1023716 | 1198 | `PH7_PRIVATE sxi32 PH7_ExprFreeTree(ph7_gen_state *pGen,SySet *pNodeSet)` |
|        5 | 1199 | `{` |
|        - | 1200 | `	ph7_expr_node **apNode;` |
|        - | 1201 | `	sxu32 n;` |
|  1023721 | 1202 | `	apNode = (ph7_expr_node **)SySetBasePtr(pNodeSet);` |
|  5548831 | 1203 | `	for( n = 0  ; n < SySetUsed(pNodeSet) ; ++n ){` |
|  4525115 | 1204 | `		if( apNode[n] ){` |
|  1024055 | 1205 | `			ExprFreeTree(&(*pGen),apNode[n]);` |
|   512025 | 1206 | `		}` |
|  2262560 | 1207 | `	}` |
|  1023721 | 1208 | `	return SXRET_OK;` |
|        5 | 1209 | `}` |
|        - | 1210 | `/*` |
...
|        - | 1216 | ` */` |
|  1397798 | 1217 | `PH7_PRIVATE int PH7_ExprContainsNullsafe(ph7_expr_node *pNode)` |
|        5 | 1218 | `{` |
|  1397803 | 1219 | `	if( pNode == 0 ){` |
|   862375 | 1220 | `		return 0;` |
|        - | 1221 | `	}` |
|   535433 | 1222 | `	if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW ){` |
|       16 | 1223 | `		return 1;` |
|        - | 1224 | `	}` |
|   535421 | 1225 | `	if( PH7_ExprContainsNullsafe(pNode->pLeft) ){` |
|        6 | 1226 | `		return 1;` |
|        - | 1227 | `	}` |
|   535417 | 1228 | `	if( PH7_ExprContainsNullsafe(pNode->pRight) ){` |
|      ! 0 | 1229 | `		return 1;` |
|        - | 1230 | `	}` |
|   535417 | 1231 | `	return 0;` |
|   698904 | 1232 | `}` |
|        - | 1233 | `/*` |
|        - | 1234 | ` * Check if the given node is a modifialbe l/r-value.` |
|        - | 1235 | ` * Return TRUE if modifiable.FALSE otherwise.` |
|        - | 1236 | ` */` |
|   320184 | 1237 | `static int ExprIsModifiableValue(ph7_expr_node *pNode,sxu8 bFunc)` |
|        5 | 1238 | `{` |
|        - | 1239 | `	sxi32 iExprOp;` |
|   320189 | 1240 | `	if( pNode->pOp == 0 ){` |
|   196727 | 1241 | `		return pNode->xCode == PH7_CompileVariable ? TRUE : FALSE;` |
|        - | 1242 | `	}` |
...
|        - | 1274 | ` */` |
|   420470 | 1275 | `static sxi32 ExprProcessFuncArguments(ph7_gen_state *pGen,ph7_expr_node *pOp,ph7_expr_node **apNode,sxi32 nToken)` |
|        5 | 1276 | `{` |
...
|   420475 | 1280 | `	iCur = 0;` |
|   458093 | 1281 | `	for(;;){` |
|   916191 | 1282 | `		if( iCur >= nToken ){` |
|        - | 1283 | `			/* No more arguments to process */` |
|   420449 | 1284 | `			break;` |
|        - | 1285 | `		}` |
|   495747 | 1286 | `		iNode = iCur;` |
|   495747 | 1287 | `		iNest = 0;` |
|  1226863 | 1288 | `		while( iCur < nToken ){` |
|   806417 | 1289 | `			if( apNode[iCur] ){` |
|   791113 | 1290 | `				if( (apNode[iCur]->pStart->nType & PH7_TK_COMMA) && apNode[iCur]->pLeft == 0 && iNest <= 0 ){` |
|    37653 | 1291 | `					break;` |
|   715812 | 1292 | `				}else if( (apNode[iCur]->pStart->nType & (PH7_TK_LPAREN\|PH7_TK_OSB\|PH7_TK_OCB))` |
|   378170 | 1293 | `					&& apNode[iCur]->xCode != PH7_CompileShortArray` |
|    40315 | 1294 | `					&& apNode[iCur]->xCode != PH7_CompileShortList ){` |
...
|    40097 | 1301 | `					iNest++;` |
|   695771 | 1302 | `				}else if( apNode[iCur]->pStart->nType & (PH7_TK_RPAREN\|PH7_TK_CCB\|PH7_TK_CSB) ){` |
|    40097 | 1303 | `					iNest--;` |
|    20046 | 1304 | `				}` |
|   357906 | 1305 | `			}` |
|   731121 | 1306 | `			iCur++;` |
|        5 | 1307 | `		}` |
|   495747 | 1308 | `		if( iCur > iNode ){` |
|   495741 | 1309 | `			SyString sArgName = {0, 0};` |
...
|   495736 | 1313 | `			if( (iCur - iNode) >= 2` |
|   274201 | 1314 | `				&& apNode[iNode]` |
|    52666 | 1315 | `				&& (apNode[iNode]->pStart->nType & (PH7_TK_ID\|PH7_TK_KEYWORD))` |
|    30954 | 1316 | `				&& apNode[iNode]->xCode == PH7_CompileLiteral` |
|     9103 | 1317 | `				&& apNode[iNode+1]` |
|     8969 | 1318 | `				&& (apNode[iNode+1]->pStart->nType & PH7_TK_COLON) ){` |
...
|        - | 1337 | `				}` |
|      122 | 1338 | `			}` |
|   495734 | 1339 | `			if( apNode[iNode] && (apNode[iNode]->pStart->nType & PH7_TK_AMPER /*'&'*/) && ((iCur - iNode) == 2)` |
...
|      ! 0 | 1345 | `			}` |
|   495739 | 1346 | `			ExprMakeTree(&(*pGen),&apNode[iNode],iCur-iNode);` |
|   495739 | 1347 | `			if( apNode[iNode] ){` |
|   495739 | 1348 | `				if( sArgName.nByte > 0 ){` |
...
|   495739 | 1353 | `				SySetPut(&pOp->aNodeArgs,(const void *)&apNode[iNode]);` |
|   247872 | 1354 | `			}else{` |
...
|   495739 | 1373 | `		if( iCur < nToken && apNode[iCur] && (apNode[iCur]->pStart->nType & PH7_TK_COMMA) ){` |
|    75295 | 1374 | `			iCur++;` |
|    75295 | 1375 | `			if( iCur >= nToken ){` |
|        - | 1376 | `				/* Trailing comma after last argument */` |
|       19 | 1377 | `				break;` |
|        - | 1378 | `			}` |
|    37636 | 1379 | `		}` |
|        5 | 1380 | `	}` |
|   420467 | 1381 | `	return SXRET_OK;` |
|   210240 | 1382 | `}` |
|        - | 1383 | ` /*` |
...
|        - | 1387 | `  */` |
|  1640298 | 1388 | ` static sxi32 ExprMakeTree(ph7_gen_state *pGen,ph7_expr_node **apNode,sxi32 nToken)` |
|        5 | 1389 | ` {` |
|        - | 1390 | `	 sxi32 i,iLeft,iRight;` |
|        - | 1391 | `	 ph7_expr_node *pNode;` |
|        - | 1392 | `	 sxi32 iCur;` |
|        - | 1393 | `	 sxi32 rc;` |
|  1640303 | 1394 | `	 if( nToken <= 0 \|\| (nToken == 1 && apNode[0]->xCode) ){` |
|        - | 1395 | `		 /* TICKET 1433-17: self evaluating node */` |
|   768553 | 1396 | `		 return SXRET_OK;` |
|        - | 1397 | `	 }` |
|        - | 1398 | `	 /* Process expressions enclosed in parenthesis first */` |
|  5411765 | 1399 | `	 for( iCur =  0 ; iCur < nToken ; ++iCur ){` |
|        - | 1400 | `		 sxi32 iNest;` |
...
|        - | 1403 | `		  */` |
|  4540017 | 1404 | `		 if( apNode[iCur] == 0 \|\| apNode[iCur]->pStart->nType != PH7_TK_LPAREN ){` |
|  4507619 | 1405 | `			 continue;` |
|        - | 1406 | `		 }` |
|    32403 | 1407 | `		 iNest = 1;` |
...
|  5619417 | 1450 | `	 for( iCur =  0 ; iCur < nToken ; ++iCur ){` |
|        - | 1451 | `		 sxi32 iNest;` |
...
|        - | 1454 | `		  */` |
|  4756013 | 1455 | `		 if( apNode[iCur] == 0 \|\| apNode[iCur]->pStart->nType != PH7_TK_OCB ){` |
|  4756005 | 1456 | `			 continue;` |
|        - | 1457 | `		 }` |
|       10 | 1458 | `		 iNest = 1;` |
|       10 | 1459 | `		 iLeft = iCur;` |
...
|   863409 | 1491 | `	 iLeft = -1;` |
|  5619395 | 1492 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  4756003 | 1493 | `		 if( apNode[iCur] == 0 ){` |
|  1873485 | 1494 | `			 continue;` |
|        - | 1495 | `		 }` |
|  2882523 | 1496 | `		 pNode = apNode[iCur];` |
|  2882523 | 1497 | `		 if( pNode->pOp && pNode->pOp->iPrec == 2 && pNode->pLeft == 0  ){` |
|   770905 | 1498 | `			 if( pNode->pOp->iOp == EXPR_OP_FUNC_CALL ){` |
|        - | 1499 | `				 /* Collect function arguments */` |
|   481755 | 1500 | `				 sxi32 iPtr = 0;` |
|   481755 | 1501 | `				 sxi32 nFuncTok = 0;` |
|  1769919 | 1502 | `				 while( nFuncTok + iCur < nToken ){` |
|  1769919 | 1503 | `					 if( apNode[nFuncTok+iCur] ){` |
|  1754615 | 1504 | `						 if( apNode[nFuncTok+iCur]->pStart->nType & PH7_TK_LPAREN /*'('*/ ){` |
|   502265 | 1505 | `							 iPtr++;` |
|  1503485 | 1506 | `						 }else if ( apNode[nFuncTok+iCur]->pStart->nType & PH7_TK_RPAREN /*')'*/){` |
|   502265 | 1507 | `							 iPtr--;` |
|   502265 | 1508 | `							 if( iPtr <= 0 ){` |
|   481755 | 1509 | `								 break;` |
|        - | 1510 | `							 }` |
|    10255 | 1511 | `						 }` |
|   636430 | 1512 | `					 }` |
|  1288169 | 1513 | `					 nFuncTok++;` |
|        5 | 1514 | `				 }` |
|   481755 | 1515 | `				 if( nFuncTok + iCur >= nToken ){` |
|        - | 1516 | `					 /* Syntax error */` |
...
|      ! 0 | 1521 | `					 return rc;` |
|        - | 1522 | `				 }` |
|   481755 | 1523 | `				 if(  iLeft < 0 \|\| !NODE_ISTERM(iLeft) /*\|\| ( apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec != 2)*/ ){` |
|        - | 1524 | `					 /* Syntax error */` |
...
|      ! 0 | 1529 | `					 return rc;` |
|        - | 1530 | `				 }` |
|   481755 | 1531 | `				 if( nFuncTok > 1 ){` |
|        - | 1532 | `					 /* Process function arguments */` |
|   420475 | 1533 | `					 rc = ExprProcessFuncArguments(&(*pGen),pNode,&apNode[iCur+1],nFuncTok-1);` |
|   420475 | 1534 | `					 if( rc != SXRET_OK ){` |
|       11 | 1535 | `						 return rc;` |
|        - | 1536 | `					 }` |
|   210231 | 1537 | `				 }` |
|        - | 1538 | `				 /* Link the node to the tree */` |
|   481747 | 1539 | `				 pNode->pLeft = apNode[iLeft];` |
|   481747 | 1540 | `				 apNode[iLeft] = 0;` |
|  1769887 | 1541 | `				 for( iPtr = 1; iPtr <= nFuncTok ; iPtr++ ){` |
|  1288145 | 1542 | `					 apNode[iCur+iPtr] = 0;` |
|   644075 | 1543 | `				 }` |
|   530026 | 1544 | `			 }else if (pNode->pOp->iOp == EXPR_OP_SUBSCRIPT ){` |
|        - | 1545 | `				 /* Subscripting */` |
...
|   190839 | 1594 | `				  iRight = iCur + 1;` |
|   190845 | 1595 | `				 while( iRight < nToken && apNode[iRight] == 0 ){` |
|        7 | 1596 | `					 iRight++;` |
|        1 | 1597 | `				 }` |
|   190839 | 1598 | `				 if( iRight >= nToken \|\| iLeft < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|        - | 1599 | `					 /* Syntax error */` |
...
|   190835 | 1607 | `				 pNode->pLeft = apNode[iLeft];` |
|   190830 | 1608 | `				 if( (pNode->pOp->iOp == EXPR_OP_ARROW /*'->'*/ \|\| pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW /*'?->'*/)` |
|   190650 | 1609 | `					 && pNode->pLeft->pOp == 0 &&` |
|   190344 | 1610 | `					 pNode->pLeft->xCode != PH7_CompileVariable ){` |
|        - | 1611 | `						 /* Syntax error */` |
...
|      ! 0 | 1617 | `						 return rc;` |
|        - | 1618 | `				 }` |
|   190835 | 1619 | `				 pNode->pRight = apNode[iRight];` |
|   190835 | 1620 | `				 apNode[iLeft] = apNode[iRight] = 0;` |
|        - | 1621 | `			 }` |
|   385444 | 1622 | `		 }` |
|  2882511 | 1623 | `		 iLeft = iCur;` |
|  1441258 | 1624 | `	 }` |
|        - | 1625 | `	 /* Handle left associative (new, clone) operators */` |
|  5619363 | 1626 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  4755971 | 1627 | `		 if( apNode[iCur] == 0 ){` |
|  2669081 | 1628 | `			 continue;` |
|        - | 1629 | `		 }` |
|  2086895 | 1630 | `		 pNode = apNode[iCur];` |
|  2086895 | 1631 | `		 if( pNode->pOp && pNode->pOp->iPrec == 1 && pNode->pLeft == 0 ){` |
|        - | 1632 | `			 SyToken *pToken;` |
...
|   863397 | 1695 | `	 iLeft = -1;` |
|  5623535 | 1696 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  4755971 | 1697 | `		 if( apNode[iCur] == 0 ){` |
|  2669081 | 1698 | `			 continue;` |
|        - | 1699 | `		 }` |
|  2086895 | 1700 | `		 pNode = apNode[iCur];` |
|  2086895 | 1701 | `		 if( pNode->pOp && pNode->pOp->iPrec == 3 && pNode->pLeft == 0){` |
...
|     2108 | 1707 | `			 }` |
|     7857 | 1708 | `		  }` |
|  2091067 | 1709 | `		 iLeft = iCur;` |
|  1047622 | 1710 | `	  }` |
|   867569 | 1711 | `	 iLeft = -1;` |
|  5623535 | 1712 | `	 for( iCur = nToken -  1 ; iCur >= 0 ; iCur-- ){` |
|  4755971 | 1713 | `		 if( apNode[iCur] == 0 ){` |
|  2673297 | 1714 | `			 continue;` |
|        - | 1715 | `		 }` |
|  2082679 | 1716 | `		 pNode = apNode[iCur];` |
|  2082679 | 1717 | `		 if( pNode->pOp && pNode->pOp->iPrec == 3 && pNode->pLeft == 0){` |
...
|     5749 | 1732 | `		  }` |
|  2082679 | 1733 | `		 iLeft = iCur;` |
|  1041342 | 1734 | `	 }` |
|        - | 1735 | `	 /* Handle right associative unary and cast operators [i.e: !,(string),~...]  with precedence 4*/` |
|   867569 | 1736 | `	  iLeft = 0;` |
|  5623529 | 1737 | `	  for( iCur = nToken -  1 ; iCur >= 0 ; iCur-- ){` |
|  4755967 | 1738 | `		  if( apNode[iCur] ){` |
|  2071177 | 1739 | `			  pNode = apNode[iCur];` |
|  2071177 | 1740 | `			  if( pNode->pOp && pNode->pOp->iPrec == 4 && pNode->pLeft == 0){` |
|    36097 | 1741 | `				  if( iLeft > 0 ){` |
|        - | 1742 | `					  /* Link the node to the tree */` |
|    36095 | 1743 | `					  pNode->pLeft = apNode[iLeft];` |
|    36095 | 1744 | `					  apNode[iLeft] = 0;` |
|    36095 | 1745 | `					  if( pNode->pLeft && pNode->pLeft->pOp && pNode->pLeft->pOp->iPrec > 4 ){` |
...
|  5623527 | 1772 | `	 for( iCur = nToken - 1 ; iCur >= 0 ; --iCur ){` |
|  4755965 | 1773 | `		 if( apNode[iCur] == 0 ){` |
|  2720997 | 1774 | `			 continue;` |
|        - | 1775 | `		 }` |
|  2034973 | 1776 | `		 pNode = apNode[iCur];` |
|  2034973 | 1777 | `		 if( pNode->pOp && pNode->pOp->iPrec == 5 && pNode->pLeft == 0 ){` |
|        - | 1778 | `			 sxi32 iL, iR;` |
...
|  9543101 | 1841 | `	 for( i = 7 ; i < 17 ; i++ ){` |
|  8675549 | 1842 | `		 iLeft = -1;` |
| 56234855 | 1843 | `		 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
| 47559321 | 1844 | `			 if( apNode[iCur] == 0 ){` |
| 30661229 | 1845 | `				 continue;` |
|        - | 1846 | `			 }` |
| 16898097 | 1847 | `			 pNode = apNode[iCur];` |
| 16898097 | 1848 | `			 if( pNode->pOp && pNode->pOp->iPrec == i && pNode->pLeft == 0 ){` |
|        - | 1849 | `				 /* Get the right node */` |
|   258119 | 1850 | `				 iRight = iCur + 1;` |
|   368993 | 1851 | `				 while( iRight < nToken && apNode[iRight] == 0 ){` |
|   110879 | 1852 | `					 iRight++;` |
|        5 | 1853 | `				 }` |
|   258119 | 1854 | `				 if( iRight >= nToken \|\| iLeft < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|        - | 1855 | `					 /* Syntax error */` |
...
|       10 | 1860 | `					 return rc;` |
|        - | 1861 | `				 }` |
|   258111 | 1862 | `				 if( pNode->pOp->iOp == EXPR_OP_REF ){` |
|        - | 1863 | `					 sxi32  iTmp;` |
...
|   258109 | 1904 | `				 pNode->pLeft = apNode[iLeft];` |
|   258109 | 1905 | `				 pNode->pRight = apNode[iRight];` |
|   258109 | 1906 | `				 apNode[iLeft] = apNode[iRight] = 0;` |
|   129052 | 1907 | `			 }` |
| 16898087 | 1908 | `			 iLeft = iCur;` |
|  8449046 | 1909 | `		 }` |
|  4337772 | 1910 | `	 }` |
...
|        - | 1914 | `	  */` |
|   867557 | 1915 | `	  iLeft = -1;` |
|  5611875 | 1916 | `	  for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  4746999 | 1917 | `		  if( apNode[iCur] == 0 ){` |
|  3236363 | 1918 | `			  continue;` |
|        - | 1919 | `		  }` |
|  1510641 | 1920 | `		  pNode = apNode[iCur];` |
|  1510641 | 1921 | `		  if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_QUESTY && pNode->pLeft == 0 ){` |
|     2681 | 1922 | `			  sxi32 iNest = 1;` |
|     2681 | 1923 | `			  if( iLeft < 0 \|\| !NODE_ISTERM(iLeft) ){` |
...
|     2679 | 1932 | `			  iRight = iCur + 1;` |
|     5643 | 1933 | `			  while( iRight < nToken  ){` |
|     5643 | 1934 | `				  if( apNode[iRight] ){` |
|     5285 | 1935 | `					  if( apNode[iRight]->pOp && apNode[iRight]->pOp->iOp == EXPR_OP_QUESTY && apNode[iRight]->pCond == 0){` |
|        - | 1936 | `						  /* Increment nesting level */` |
|      ! 0 | 1937 | `						  ++iNest;` |
|     5285 | 1938 | `					  }else if( apNode[iRight]->pStart->nType & PH7_TK_COLON /*:*/ ){` |
|        - | 1939 | `						  /* Decrement nesting level */` |
|     2679 | 1940 | `						  --iNest;` |
|     2679 | 1941 | `						  if( iNest <= 0 ){` |
|     2679 | 1942 | `							  break;` |
|        - | 1943 | `						  }` |
|      ! 0 | 1944 | `					  }` |
|     1303 | 1945 | `				  }` |
|     2969 | 1946 | `				  iRight++;` |
|        5 | 1947 | `			  }` |
|     2679 | 1948 | `			  if( iRight > iCur + 1 ){` |
|        - | 1949 | `				  /* Recurse and process the then expression */` |
|     2611 | 1950 | `				  rc = ExprMakeTree(&(*pGen),&apNode[iCur + 1],iRight - iCur - 1);` |
|     2611 | 1951 | `				  if( rc != SXRET_OK ){` |
|      ! 0 | 1952 | `					  return rc;` |
|        - | 1953 | `				  }` |
|        - | 1954 | `				  /* Link the node to the tree */` |
|     2611 | 1955 | `				  pNode->pLeft = apNode[iCur + 1];` |
|     1303 | 1956 | `			  }else{` |
|        - | 1957 | `				  /* Elvis operator (?:): pLeft stays NULL.` |
|        - | 1958 | `				   * NODE_ISTERM() recognizes this node as complete via pCond. */` |
|        - | 1959 | `			  }` |
|     2679 | 1960 | `			  apNode[iCur + 1] = 0;` |
|     2679 | 1961 | `			  if( iRight + 1 < nToken ){` |
|        - | 1962 | `				  /* Recurse and process the else expression */` |
|     2679 | 1963 | `				  rc = ExprMakeTree(&(*pGen),&apNode[iRight + 1],nToken - iRight - 1);` |
|     2679 | 1964 | `				  if( rc != SXRET_OK ){` |
|      ! 0 | 1965 | `					  return rc;` |
|        - | 1966 | `				  }` |
|        - | 1967 | `				  /* Link the node to the tree */` |
|     2679 | 1968 | `				  pNode->pRight = apNode[iRight + 1];` |
|     2679 | 1969 | `				  apNode[iRight + 1] =  apNode[iRight] = 0;` |
|     1342 | 1970 | `			  }else{` |
...
|     2679 | 1978 | `			  pNode->pCond  = apNode[iLeft];` |
|     2679 | 1979 | `			  apNode[iLeft] = 0;` |
|     2679 | 1980 | `			  break;` |
|        - | 1981 | `		  }` |
|  1507965 | 1982 | `		  iLeft = iCur;` |
|   753985 | 1983 | `	  }` |
...
|        - | 1987 | `	  */` |
|   867555 | 1988 | `	 iRight = -1;` |
|  5623331 | 1989 | `	 for( iCur = nToken -  1 ; iCur >= 0 ; iCur--){` |
|  4755835 | 1990 | `		 if( apNode[iCur] == 0 ){` |
|  3568021 | 1991 | `			 continue;` |
|        - | 1992 | `		 }` |
|  1187819 | 1993 | `		 pNode = apNode[iCur];` |
|  1187819 | 1994 | `		 if( pNode->pOp && pNode->pOp->iPrec == 18 && pNode->pLeft == 0 ){` |
|        - | 1995 | `			 /* Get the left node */` |
|   320147 | 1996 | `			 iLeft = iCur - 1;` |
|   463199 | 1997 | `			 while( iLeft >= 0 && apNode[iLeft] == 0 ){` |
|   143057 | 1998 | `				 iLeft--;` |
|        5 | 1999 | `			 }` |
|   320147 | 2000 | `			 if( iLeft < 0 \|\| iRight < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|        - | 2001 | `				 /* Syntax error */` |
...
|        - | 2018 | `			  * a write. */` |
|   320105 | 2019 | `			 if( PH7_ExprContainsNullsafe(apNode[iLeft]) ){` |
...
|       11 | 2025 | `				 return rc;` |
|        - | 2026 | `			 }` |
|   320097 | 2027 | `			 if( ExprIsModifiableValue(apNode[iLeft],FALSE) == FALSE ){` |
...
|   320093 | 2046 | `			 pNode->pLeft = apNode[iRight];` |
|   320093 | 2047 | `			 pNode->pRight = apNode[iLeft];` |
|   320093 | 2048 | `			 apNode[iLeft] = apNode[iRight] = 0;` |
|   160044 | 2049 | `		 }` |
|  1187765 | 2050 | `		 iRight = iCur;` |
|   593885 | 2051 | `	 }` |
|        - | 2052 | `	 /* Process left associative binary operators that have the lowest precedence [i.e: and,or,xor] */` |
|  4337485 | 2053 | `	 for( i = 19 ; i < 23 ; i++ ){` |
|  3469989 | 2054 | `		 iLeft = -1;` |
| 22493037 | 2055 | `		 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
| 19023053 | 2056 | `			 if( apNode[iCur] == 0 ){` |
| 15552663 | 2057 | `				 continue;` |
|        - | 2058 | `			 }` |
|  3470395 | 2059 | `			 pNode = apNode[iCur];` |
|  3470395 | 2060 | `			 if( pNode->pOp && pNode->pOp->iPrec == i && pNode->pLeft == 0 ){` |
...
|       35 | 2078 | `			 }` |
|  3470395 | 2079 | `			 iLeft = iCur;` |
|  1735200 | 2080 | `		 }` |
|  1734997 | 2081 | `	 }` |
|        - | 2082 | `	 /* Point to the root of the expression tree */` |
|  4755739 | 2083 | `	 for( iCur = 1 ; iCur < nToken ; ++iCur ){` |
|  3888261 | 2084 | `		 if( apNode[iCur] ){` |
|   800751 | 2085 | `			 if( (apNode[iCur]->pOp \|\| apNode[iCur]->xCode ) && apNode[0] != 0){` |
...
|       22 | 2090 | `				  return rc;` |
|        - | 2091 | `			 }` |
|   800733 | 2092 | `			 apNode[0] = apNode[iCur];` |
|   800733 | 2093 | `			 apNode[iCur] = 0;` |
|   400364 | 2094 | `		 }` |
|  1944124 | 2095 | `	 }` |
|   867483 | 2096 | `	 return SXRET_OK;` |
|   818068 | 2097 | ` }` |
|        - | 2098 | ` /*` |
...
|        - | 2103 | `  */` |
|  1023716 | 2104 | `PH7_PRIVATE sxi32 PH7_ExprMakeTree(ph7_gen_state *pGen,SySet *pExprNode,ph7_expr_node **ppRoot)` |
|        5 | 2105 | `{` |
|        - | 2106 | `	ph7_expr_node **apNode;` |
|        - | 2107 | `	ph7_expr_node *pNode;` |
|        - | 2108 | `	sxi32 rc;` |
|        - | 2109 | `	/* Reset node container */` |
|  1023721 | 2110 | `	SySetReset(pExprNode);` |
|  1023721 | 2111 | `	pNode = 0; /* Prevent compiler warning */` |
|        - | 2112 | `	/* Extract nodes one after one until we hit the end of the input */` |
|        - | 2113 | `	{` |
|  1023721 | 2114 | `		int iLastWasTerm = 0;` |
|  1023721 | 2115 | `		int bAfterMemberOp = 0; /* TRUE iff the previous node was -> / ?-> / :: */` |
|  5548831 | 2116 | `		while( pGen->pIn < pGen->pEnd ){` |
|  4525149 | 2117 | `			rc = ExprExtractNode(&(*pGen),&pNode,iLastWasTerm,bAfterMemberOp);` |
|  4525149 | 2118 | `			if( rc != SXRET_OK ){` |
|       38 | 2119 | `				return rc;` |
|        - | 2120 | `			}` |
|        - | 2121 | `			/* Determine if this node is a term for short-array disambiguation */` |
|  4525115 | 2122 | `			if( pNode->xCode ){` |
|        - | 2123 | `				/* Node with compile handler: variable, literal, string, array, etc. */` |
|  2373343 | 2124 | `				iLastWasTerm = 1;` |
|  3338446 | 2125 | `			}else if( pNode->pOp ){` |
|        - | 2126 | `				/* Operator node */` |
|  1022145 | 2127 | `				iLastWasTerm = 0;` |
|   511075 | 2128 | `			}else{` |
|        - | 2129 | `				/* Delimiter: ')' and ']' end terms */` |
|  1129637 | 2130 | `				iLastWasTerm = (pNode->pStart->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB)) ? 1 : 0;` |
|        - | 2131 | `			}` |
...
|  4525115 | 2135 | `			bAfterMemberOp = ( pNode->pOp && pNode->pOp->iVmOp == PH7_OP_MEMBER );` |
|        - | 2136 | `			/* Save the extracted node */` |
|  4525115 | 2137 | `			SySetPut(pExprNode,(const void *)&pNode);` |
|        5 | 2138 | `		}` |
|        - | 2139 | `	}` |
|  1023687 | 2140 | `	if( SySetUsed(pExprNode) < 1 ){` |
|        - | 2141 | `		/* Empty expression [i.e: A semi-colon;] */` |
|      ! 0 | 2142 | `		*ppRoot = 0;` |
|      ! 0 | 2143 | `		return SXRET_OK;` |
|        - | 2144 | `	}` |
|  1023687 | 2145 | `	apNode = (ph7_expr_node **)SySetBasePtr(pExprNode);` |
|        - | 2146 | `	/* Make sure we are dealing with valid nodes */` |
|  1023687 | 2147 | `	rc = ExprVerifyNodes(&(*pGen),apNode,(sxi32)SySetUsed(pExprNode));` |
|  1023687 | 2148 | `	if( rc != SXRET_OK ){` |
...
|        - | 2154 | `	}` |
|        - | 2155 | `	/* Build the tree */` |
|  1023637 | 2156 | `	rc = ExprMakeTree(&(*pGen),apNode,(sxi32)SySetUsed(pExprNode));` |
|  1023637 | 2157 | `	if( rc != SXRET_OK ){` |
|        - | 2158 | `		/* Something goes wrong [i.e: Syntax error] */` |
|      103 | 2159 | `		*ppRoot = 0;` |
|      103 | 2160 | `		return rc;` |
|        - | 2161 | `	}` |
|        - | 2162 | `	/* Point to the root of the tree */` |
|  1023539 | 2163 | `	*ppRoot = apNode[0];` |
|  1023539 | 2164 | `	return SXRET_OK;` |
|   511863 | 2165 | `}` |
|        - | 2166 |  |
