...
|        - |  265 | ` */` |
|  1203510 |  266 | `PH7_PRIVATE const ph7_expr_op *  PH7_ExprExtractOperator(SyString *pStr,SyToken *pLast)` |
|        5 |  267 | `{` |
|  1203515 |  268 | `	sxu32 n = 0;` |
|        - |  269 | `	sxi32 rc;` |
|        - |  270 | `	/* Do a linear lookup on the operators table */` |
| 20650864 |  271 | `	for(;;){` |
| 41301733 |  272 | `		if( n >= SX_ARRAYSIZE(aOpTable) ){` |
|      ! 0 |  273 | `			break;` |
|        - |  274 | `		}` |
| 41301733 |  275 | `		if( SyisAlpha(aOpTable[n].sOp.zString[0]) ){` |
|        - |  276 | `			/* TICKET 1433-012: Alpha stream operators [i.e: and,or,xor,new...] */` |
|  3688153 |  277 | `			rc = SyStringCmp(pStr,&aOpTable[n].sOp,SyStrnicmp);` |
|  1844079 |  278 | `		}else{` |
| 37613585 |  279 | `			rc = SyStringCmp(pStr,&aOpTable[n].sOp,SyMemcmp);` |
|        - |  280 | `		}` |
| 41301733 |  281 | `		if( rc == 0 ){` |
|  1208111 |  282 | `			if( aOpTable[n].sOp.nByte != sizeof(char) \|\| (aOpTable[n].iOp != EXPR_OP_UMINUS && aOpTable[n].iOp != EXPR_OP_UPLUS) \|\| pLast == 0 ){` |
|        - |  283 | `				/* There is no ambiguity here,simply return the first operator seen */` |
|  1203053 |  284 | `				return &aOpTable[n];` |
|        - |  285 | `			}` |
|        - |  286 | `			/* Handle ambiguity */` |
|     5063 |  287 | `			if( pLast->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*'['*/\|PH7_TK_COLON/*:*/\|PH7_TK_COMMA/*,'*/) ){` |
|        - |  288 | `				/* Unary opertors have prcedence here over binary operators */` |
|      335 |  289 | `				return &aOpTable[n];` |
|        - |  290 | `			}` |
|     4733 |  291 | `			if( pLast->nType & PH7_TK_OP ){` |
...
|        4 |  299 | `			}` |
|     2298 |  300 | `		}` |
| 40098223 |  301 | `		++n; /* Next operator in the table */` |
|        5 |  302 | `	}` |
...
|        - |  310 | ` */` |
|   737268 |  311 | `PH7_PRIVATE void PH7_DelimitNestedTokens(SyToken *pIn,SyToken *pEnd,sxu32 nTokStart,sxu32 nTokEnd,SyToken **ppEnd)` |
|        5 |  312 | `{` |
|   737273 |  313 | `	SyToken *pCur = pIn;` |
|   737273 |  314 | `	sxi32 iNest = 1;` |
|  4112131 |  315 | `	for(;;){` |
|  8224267 |  316 | `		if( pCur >= pEnd ){` |
|      409 |  317 | `			break;` |
|        - |  318 | `		}` |
|  8223863 |  319 | `		if( pCur->nType & nTokStart ){` |
|        - |  320 | `			/* Increment nesting level */` |
|   388113 |  321 | `			iNest++;` |
|  8029809 |  322 | `		}else if( pCur->nType & nTokEnd ){` |
|        - |  323 | `			/* Decrement nesting level */` |
|  1124977 |  324 | `			iNest--;` |
|  1124977 |  325 | `			if( iNest <= 0 ){` |
|   736869 |  326 | `				break;` |
|        - |  327 | `			}` |
|   194054 |  328 | `		}` |
|        - |  329 | `		/* Advance cursor */` |
...
|        - |  343 | ` */` |
|    23806 |  344 | `PH7_PRIVATE int PH7_IsLangConstruct(sxu32 nKeyID,sxu8 bCheckFunc)` |
|        5 |  345 | `{` |
|    23806 |  346 | `	if( nKeyID == PH7_TKWRD_ECHO \|\| nKeyID == PH7_TKWRD_PRINT \|\| nKeyID == PH7_TKWRD_INCLUDE` |
|    23708 |  347 | `		\|\| nKeyID == PH7_TKWRD_INCONCE \|\| nKeyID == PH7_TKWRD_REQUIRE \|\| nKeyID == PH7_TKWRD_REQONCE` |
|        - |  348 | `		){` |
|      167 |  349 | `			return TRUE;` |
|        - |  350 | `	}` |
|    23649 |  351 | `	if( bCheckFunc ){` |
...
|        - |  366 | ` */` |
|  1015522 |  367 | `static sxi32 ExprVerifyNodes(ph7_gen_state *pGen,ph7_expr_node **apNode,sxi32 nNode)` |
|        5 |  368 | `{` |
|        - |  369 | `	sxi32 iParen,iSquare,iQuesty,iBraces;` |
|        - |  370 | `	sxi32 i,rc;` |
|        - |  371 |  |
|  1015527 |  372 | `	if( nNode > 0 && apNode[0]->pOp && (apNode[0]->pOp->iOp == EXPR_OP_ADD \|\| apNode[0]->pOp->iOp == EXPR_OP_SUB) ){` |
...
|       15 |  376 | `	}` |
|  1015527 |  377 | `	iParen = iSquare = iQuesty = iBraces = 0;` |
|  5504443 |  378 | `	for( i = 0 ; i < nNode ; ++i ){` |
|  4488955 |  379 | `		if( apNode[i]->xCode == PH7_CompileShortArray \|\| apNode[i]->xCode == PH7_CompileShortList ){` |
|        - |  380 | `			/* Short array/list literal: brackets are self-contained, skip */` |
|     1221 |  381 | `			continue;` |
|        - |  382 | `		}` |
|  4487739 |  383 | `		if( apNode[i]->pStart->nType & PH7_TK_LPAREN /*'('*/){` |
|   510017 |  384 | `			if( i > 0 && ( apNode[i-1]->xCode == PH7_CompileVariable \|\| apNode[i-1]->xCode == PH7_CompileLiteral \|\|` |
|    23916 |  385 | `				(apNode[i - 1]->pStart->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_SSTR\|PH7_TK_DSTR\|PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}'*/))) ){` |
|        - |  386 | `					/* Ticket 1433-033: Take care to ignore alpha-stream [i.e: or,xor] operators followed by an opening parenthesis */` |
|   477861 |  387 | `					if( (apNode[i - 1]->pStart->nType & PH7_TK_OP) == 0 ){` |
|        - |  388 | `						/* We are dealing with a postfix [i.e: function call]  operator` |
|        - |  389 | `						 * not a simple left parenthesis. Mark the node.` |
|        - |  390 | `						 */` |
|   477861 |  391 | `						apNode[i]->pStart->nType \|= PH7_TK_OP;` |
|   477861 |  392 | `						apNode[i]->pStart->pUserData = (void *)&sFCallOp; /* Function call operator */` |
|   477861 |  393 | `						apNode[i]->pOp = &sFCallOp;` |
|   238928 |  394 | `					}` |
|   238928 |  395 | `			}` |
|   510017 |  396 | `			iParen++;` |
|  4232733 |  397 | `		}else if( apNode[i]->pStart->nType & PH7_TK_RPAREN/*')*/){` |
|   510017 |  398 | `			if( iParen <= 0 ){` |
...
|        - |  404 | `			}` |
|   510005 |  405 | `			iParen--;` |
|  3722715 |  406 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OSB /*'['*/){` |
|    97551 |  407 | `			iSquare++;` |
|  3418942 |  408 | `		}else if (apNode[i]->pStart->nType & PH7_TK_CSB /*']'*/){` |
|    97565 |  409 | `			if( iSquare <= 0 ){` |
...
|        - |  415 | `			}` |
|    97559 |  416 | `			iSquare--;` |
|  3321386 |  417 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OCB /*'{'*/){` |
|       20 |  418 | `			iBraces++;` |
...
|        - |  462 |  |
|        7 |  463 | `			}` |
|  3272600 |  464 | `		}else if (apNode[i]->pStart->nType & PH7_TK_CCB /*'}'*/){` |
|       24 |  465 | `			if( iBraces <= 0 ){` |
...
|        - |  471 | `			}` |
|       10 |  472 | `			iBraces--;` |
|  3272575 |  473 | `		}else if ( apNode[i]->pStart->nType & PH7_TK_COLON ){` |
...
|        6 |  484 | `				return rc;` |
|        5 |  485 | `			}` |
|  3271126 |  486 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OP ){` |
|   916487 |  487 | `			const ph7_expr_op *pOp = (const ph7_expr_op *)apNode[i]->pOp;` |
|   916487 |  488 | `			if( pOp->iOp == EXPR_OP_QUESTY ){` |
|     2673 |  489 | `				iQuesty++;` |
|   915153 |  490 | `			}else if( i > 0 && (pOp->iOp == EXPR_OP_UMINUS \|\| pOp->iOp == EXPR_OP_UPLUS)){` |
...
|   458241 |  510 | `		}` |
|  2243855 |  511 | `	}` |
|  1015493 |  512 | `	if( iParen != 0 \|\| iSquare != 0 \|\| iQuesty != 0 \|\| iBraces != 0){` |
...
|       20 |  517 | `		return rc;` |
|        - |  518 | `	}` |
|  1015477 |  519 | `	return SXRET_OK;` |
|   507766 |  520 | `}` |
|        - |  521 | `/*` |
|        - |  522 | ` * Collect and assemble tokens holding a namespace path [i.e: namespace\to\const]` |
|        - |  523 | ` * or a simple literal [i.e: PHP_EOL].` |
|        - |  524 | ` */` |
|   841594 |  525 | `static void ExprAssembleLiteral(SyToken **ppCur,SyToken *pEnd)` |
|        5 |  526 | `{` |
|   841599 |  527 | `	SyToken *pIn = *ppCur;` |
|        - |  528 | `	/* Jump the first literal seen */` |
|   841599 |  529 | `	if( (pIn->nType & PH7_TK_NSSEP) == 0 ){` |
|   837755 |  530 | `		pIn++;` |
|   418875 |  531 | `	}` |
|   422746 |  532 | `	for(;;){` |
|   845497 |  533 | `		if(pIn < pEnd && (pIn->nType & PH7_TK_NSSEP) ){` |
|     3903 |  534 | `			pIn++;` |
|     3903 |  535 | `			if(pIn < pEnd && (pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|     3901 |  536 | `				pIn++;` |
|     1948 |  537 | `			}` |
|     1954 |  538 | `		}else{` |
|   420802 |  539 | `			break;` |
...
|        - |  884 | ` */` |
|  4492984 |  885 | `static sxi32 ExprExtractNode(ph7_gen_state *pGen,ph7_expr_node **ppNode,int iLastWasTerm,int bAfterMemberOp)` |
|        5 |  886 | `{` |
|        - |  887 | `	ph7_expr_node *pNode;` |
|        - |  888 | `	SyToken *pCur;` |
|        - |  889 | `	sxi32 rc;` |
|        - |  890 | `	/* Allocate a new node */` |
|  4492989 |  891 | `	pNode = (ph7_expr_node *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_expr_node));` |
|  4492989 |  892 | `	if( pNode == 0 ){` |
...
|  4492989 |  899 | `	SyZero(pNode,sizeof(ph7_expr_node));` |
|  4492989 |  900 | `	SySetInit(&pNode->aNodeArgs,&pGen->pVm->sAllocator,sizeof(ph7_expr_node **));` |
|        - |  901 | `	/* Point to the head of the token stream */` |
|  4492989 |  902 | `	pCur = pNode->pStart = pGen->pIn;` |
|        - |  903 | `	/* Start collecting tokens */` |
|  4492989 |  904 | `	if( pCur->nType & PH7_TK_ELLIPSIS ){` |
|     3953 |  905 | `		if( &pCur[1] < pGen->pEnd && (pCur[1].nType & PH7_TK_RPAREN) ){` |
...
|     3889 |  920 | `		pCur++;` |
|     3889 |  921 | `		pGen->pIn = pCur;` |
|     3889 |  922 | `		SyMemBackendPoolFree(&pGen->pVm->sAllocator, pNode);` |
|     3889 |  923 | `		rc = ExprExtractNode(pGen, ppNode, iLastWasTerm, 0/* a spread element is never a member name */);` |
|     3889 |  924 | `		if( rc == SXRET_OK && *ppNode ){` |
|     3889 |  925 | `			(*ppNode)->iFlags \|= EXPR_NODE_SPREAD;` |
|     1942 |  926 | `		}` |
|     3889 |  927 | `		return rc;` |
|        - |  928 | `	}` |
|  4489041 |  929 | `	if( (pCur->nType & PH7_TK_OSB) && !iLastWasTerm ){` |
|        - |  930 | `		/* PHP 5.4 short array syntax: [1, 2, 3] or ['key' => 'value'].` |
|        - |  931 | `		 * This '[' does not follow a term, so it is an array literal, not subscript.` |
|        - |  932 | `		 */` |
|     1223 |  933 | `		pCur++; /* Skip the opening '[' */` |
|     1223 |  934 | `		PH7_DelimitNestedTokens(pCur,pGen->pEnd,PH7_TK_OSB,PH7_TK_CSB,&pCur);` |
|     1223 |  935 | `		if( pCur < pGen->pEnd ){` |
|     1223 |  936 | `			pCur++; /* Skip past the closing ']' */` |
|      614 |  937 | `		}else{` |
...
|        - |  948 | `		 */` |
|     1307 |  949 | `		if( pCur < pGen->pEnd && (pCur->nType & PH7_TK_OP) ){` |
...
|        - |  955 | `			}` |
|       88 |  956 | `		}else{` |
|     1055 |  957 | `			pNode->xCode = PH7_CompileShortArray;` |
|        5 |  958 | `		}` |
|  4488432 |  959 | `	}else if( pCur->nType & PH7_TK_OP ){` |
|        - |  960 | `		/* Point to the instance that describe this operator */` |
|  1014067 |  961 | `		pNode->pOp = (const ph7_expr_op *)pCur->pUserData;` |
|        - |  962 | `		/* Advance the stream cursor */` |
|  1014067 |  963 | `		pCur++;` |
|  3980792 |  964 | `	}else if( pCur->nType & PH7_TK_DOLLAR ){` |
|        - |  965 | `		/* Isolate variable */` |
|  2427177 |  966 | `		while( pCur < pGen->pEnd && (pCur->nType & PH7_TK_DOLLAR) ){` |
|  1213597 |  967 | `			pCur++; /* Variable variable */` |
|        5 |  968 | `		}` |
|  1213585 |  969 | `		if( pCur < pGen->pEnd ){` |
|  1213585 |  970 | `			if (pCur->nType & (PH7_TK_ID\|PH7_TK_KEYWORD) ){` |
|        - |  971 | `				/* Variable name */` |
|  1213557 |  972 | `				pCur++;` |
|   606809 |  973 | `			}else if( pCur->nType & PH7_TK_OCB /* '{' */ ){` |
|       24 |  974 | `				pCur++;` |
...
|        8 |  987 | `			}` |
|   606788 |  988 | `		}` |
|  1213581 |  989 | `		pNode->xCode = PH7_CompileVariable;` |
|  2866969 |  990 | `	 }else if( pCur->nType & PH7_TK_KEYWORD ){` |
|    56729 |  991 | `		 sxu32 nKeyword = (sxu32)SX_PTR_TO_INT(pCur->pUserData);` |
|    56729 |  992 | `		 if( bAfterMemberOp ){` |
...
|    56643 |  999 | `		 }else if( nKeyword == PH7_TKWRD_ARRAY \|\|  nKeyword == PH7_TKWRD_LIST ){` |
|        - | 1000 | `			 /* List/Array node */` |
|    32209 | 1001 | `			 if( &pCur[1] >= pGen->pEnd \|\| (pCur[1].nType & PH7_TK_LPAREN) == 0 ){` |
...
|    32209 | 1008 | `				 PH7_DelimitNestedTokens(pCur,pGen->pEnd,PH7_TK_LPAREN /* '(' */, PH7_TK_RPAREN /* ')' */,&pCur);` |
|    32209 | 1009 | `				 if( pCur < pGen->pEnd ){` |
|    32207 | 1010 | `					 pCur++;` |
|    16106 | 1011 | `				 }else{` |
|        - | 1012 | `					 /* Syntax error */` |
...
|        3 | 1019 | `					 return rc;` |
|        - | 1020 | `				 }` |
|    32207 | 1021 | `				 pNode->xCode = (nKeyword == PH7_TKWRD_LIST) ? PH7_CompileList : PH7_CompileArray;` |
|    32207 | 1022 | `				 if( pNode->xCode == PH7_CompileList ){` |
...
|       13 | 1033 | `				 }` |
|        5 | 1034 | `			 }` |
|    40453 | 1035 | `		 }else if( nKeyword == PH7_TKWRD_YIELD ){` |
...
|    24220 | 1042 | `		 }else if( nKeyword == PH7_TKWRD_FUNCTION ){` |
...
|        - | 1056 | `			  }` |
|    23907 | 1057 | `		 }else if( nKeyword == PH7_TKWRD_CLASS && &pCur[1] < pGen->pEnd` |
...
|    23737 | 1072 | `		 }else if( nKeyword == PH7_TKWRD_FN` |
|    23639 | 1073 | `			\|\| ( nKeyword == PH7_TKWRD_STATIC && &pCur[1] < pGen->pEnd` |
...
|    23637 | 1083 | `		 }else if( nKeyword == PH7_TKWRD_MATCH ){` |
...
|    23514 | 1091 | `		 }else if( nKeyword == PH7_TKWRD_THROW ){` |
...
|    23461 | 1100 | `		 }else if( PH7_IsLangConstruct(nKeyword,FALSE) == TRUE && &pCur[1] < pGen->pEnd ){` |
...
|    23355 | 1106 | `			 ExprAssembleLiteral(&pCur,pGen->pEnd);` |
|    23355 | 1107 | `			 pNode->xCode = PH7_CompileLiteral;` |
|        5 | 1108 | `		 }` |
|  2231805 | 1109 | `	 }else if( pCur->nType & (PH7_TK_NSSEP\|PH7_TK_ID) ){` |
|        - | 1110 | `		 /* Constants,function name,namespace path,class name... */` |
|   818077 | 1111 | `		 ExprAssembleLiteral(&pCur,pGen->pEnd);` |
|   818077 | 1112 | `		 pNode->xCode = PH7_CompileLiteral;` |
|   409041 | 1113 | `	 }else{` |
|  1385385 | 1114 | `		 if( (pCur->nType & (PH7_TK_LPAREN\|PH7_TK_RPAREN\|PH7_TK_COMMA\|PH7_TK_COLON\|PH7_TK_CSB\|PH7_TK_OCB\|PH7_TK_CCB)) == 0 ){` |
|        - | 1115 | `			 /* Point to the code generator routine */` |
|   264855 | 1116 | `			 pNode->xCode = PH7_GetNodeHandler(pCur->nType);` |
|   264855 | 1117 | `			 if( pNode->xCode == 0 ){` |
...
|  4489007 | 1130 | `	pNode->pEnd = pCur;` |
|        - | 1131 | `	/* Save the node for later processing */` |
|  4489007 | 1132 | `	*ppNode = pNode;` |
|        - | 1133 | `	/* Synchronize cursors */` |
|  4489007 | 1134 | `	pGen->pIn = pCur;` |
|  4489007 | 1135 | `	return SXRET_OK;` |
|  2246497 | 1136 | `}` |
|        - | 1137 | `/*` |
...
|        - | 1140 | ` * level is zero.` |
|        - | 1141 | ` */` |
|    99046 | 1142 | `PH7_PRIVATE sxi32 PH7_GetNextExpr(SyToken *pStart,SyToken *pEnd,SyToken **ppNext)` |
|        5 | 1143 | `{` |
|    99051 | 1144 | `	SyToken *pCur = pStart;` |
|    99051 | 1145 | `	sxi32 iNest = 0;` |
|    99051 | 1146 | `	if( pCur >= pEnd \|\| (pCur->nType & PH7_TK_SEMI/*';'*/) ){` |
|        - | 1147 | `		/* Last expression */` |
|    51595 | 1148 | `		return SXERR_EOF;` |
|        - | 1149 | `	}` |
|   193325 | 1150 | `	while( pCur < pEnd ){` |
|   176199 | 1151 | `		if( (pCur->nType & (PH7_TK_COMMA/*','*/\|PH7_TK_SEMI/*';'*/)) && iNest <= 0){` |
|    30335 | 1152 | `			break;` |
|        - | 1153 | `		}` |
|   145869 | 1154 | `		if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|     9877 | 1155 | `			iNest++;` |
|   140933 | 1156 | `		}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}*/) ){` |
|     9879 | 1157 | `			iNest--;` |
|     4937 | 1158 | `		}` |
|   145869 | 1159 | `		pCur++;` |
|        5 | 1160 | `	}` |
|    47461 | 1161 | `	*ppNext = pCur;` |
|    47461 | 1162 | `	return SXRET_OK;` |
|    49528 | 1163 | `}` |
|        - | 1164 | `/*` |
|        - | 1165 | ` * Free an expression tree.` |
|        - | 1166 | ` */` |
|  3836352 | 1167 | `static void ExprFreeTree(ph7_gen_state *pGen,ph7_expr_node *pNode)` |
|        5 | 1168 | `{` |
|  3836357 | 1169 | `	if( pNode->pLeft ){` |
|        - | 1170 | `		/* Release the left tree */` |
|  1417043 | 1171 | `		ExprFreeTree(&(*pGen),pNode->pLeft);` |
|   708519 | 1172 | `	}` |
|  3836357 | 1173 | `	if( pNode->pRight ){` |
|        - | 1174 | `		/* Release the right tree */` |
|   765815 | 1175 | `		ExprFreeTree(&(*pGen),pNode->pRight);` |
|   382905 | 1176 | `	}` |
|  3836357 | 1177 | `	if( pNode->pCond ){` |
|        - | 1178 | `		/* Release the conditional tree used by the ternary operator */` |
|     2669 | 1179 | `		ExprFreeTree(&(*pGen),pNode->pCond);` |
|     1332 | 1180 | `	}` |
|  3836357 | 1181 | `	if( SySetUsed(&pNode->aNodeArgs) > 0 ){` |
|        - | 1182 | `		ph7_expr_node **apArg;` |
|        - | 1183 | `		sxu32 n;` |
|        - | 1184 | `		/* Release node arguments */` |
|   495583 | 1185 | `		apArg = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  1065797 | 1186 | `		for( n = 0 ; n < SySetUsed(&pNode->aNodeArgs) ; ++n ){` |
|   570219 | 1187 | `			ExprFreeTree(&(*pGen),apArg[n]);` |
|   285112 | 1188 | `		}` |
|   495583 | 1189 | `		SySetRelease(&pNode->aNodeArgs);` |
|   247789 | 1190 | `	}` |
|        - | 1191 | `	/* Finally,release this node */` |
|  3836357 | 1192 | `	SyMemBackendPoolFree(&pGen->pVm->sAllocator,pNode);` |
|  3836357 | 1193 | `}` |
|        - | 1194 | `/*` |
|        - | 1195 | ` * Free an expression tree.` |
|        - | 1196 | ` * This function is a wrapper around ExprFreeTree() defined above.` |
|        - | 1197 | ` */` |
|  1015556 | 1198 | `PH7_PRIVATE sxi32 PH7_ExprFreeTree(ph7_gen_state *pGen,SySet *pNodeSet)` |
|        5 | 1199 | `{` |
|        - | 1200 | `	ph7_expr_node **apNode;` |
|        - | 1201 | `	sxu32 n;` |
|  1015561 | 1202 | `	apNode = (ph7_expr_node **)SySetBasePtr(pNodeSet);` |
|  5504627 | 1203 | `	for( n = 0  ; n < SySetUsed(pNodeSet) ; ++n ){` |
|  4489071 | 1204 | `		if( apNode[n] ){` |
|  1015895 | 1205 | `			ExprFreeTree(&(*pGen),apNode[n]);` |
|   507945 | 1206 | `		}` |
|  2244538 | 1207 | `	}` |
|  1015561 | 1208 | `	return SXRET_OK;` |
|        5 | 1209 | `}` |
|        - | 1210 | `/*` |
...
|        - | 1216 | ` */` |
|  1386936 | 1217 | `PH7_PRIVATE int PH7_ExprContainsNullsafe(ph7_expr_node *pNode)` |
|        5 | 1218 | `{` |
|  1386941 | 1219 | `	if( pNode == 0 ){` |
|   855675 | 1220 | `		return 0;` |
|        - | 1221 | `	}` |
|   531271 | 1222 | `	if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW ){` |
|       16 | 1223 | `		return 1;` |
|        - | 1224 | `	}` |
|   531259 | 1225 | `	if( PH7_ExprContainsNullsafe(pNode->pLeft) ){` |
|        6 | 1226 | `		return 1;` |
|        - | 1227 | `	}` |
|   531255 | 1228 | `	if( PH7_ExprContainsNullsafe(pNode->pRight) ){` |
|      ! 0 | 1229 | `		return 1;` |
|        - | 1230 | `	}` |
|   531255 | 1231 | `	return 0;` |
|   693473 | 1232 | `}` |
|        - | 1233 | `/*` |
|        - | 1234 | ` * Check if the given node is a modifialbe l/r-value.` |
|        - | 1235 | ` * Return TRUE if modifiable.FALSE otherwise.` |
|        - | 1236 | ` */` |
|   317648 | 1237 | `static int ExprIsModifiableValue(ph7_expr_node *pNode,sxu8 bFunc)` |
|        5 | 1238 | `{` |
|        - | 1239 | `	sxi32 iExprOp;` |
|   317653 | 1240 | `	if( pNode->pOp == 0 ){` |
|   195155 | 1241 | `		return pNode->xCode == PH7_CompileVariable ? TRUE : FALSE;` |
|        - | 1242 | `	}` |
|   122503 | 1243 | `	iExprOp = pNode->pOp->iOp;` |
|   122503 | 1244 | `	if( iExprOp == EXPR_OP_ARROW /*'->' */ \|\| iExprOp == EXPR_OP_DC /*'::'*/ ){` |
|    84047 | 1245 | `			return TRUE;` |
|        - | 1246 | `	}` |
|    38461 | 1247 | `	if( iExprOp == EXPR_OP_SUBSCRIPT/*'[]'*/ ){` |
|    38455 | 1248 | `		if( pNode->pLeft->pOp ) {` |
|       68 | 1249 | `			if( pNode->pLeft->pOp->iOp != EXPR_OP_SUBSCRIPT /*'['*/ && pNode->pLeft->pOp->iOp != EXPR_OP_ARROW /*'->'*/` |
|       31 | 1250 | `				&& pNode->pLeft->pOp->iOp != EXPR_OP_DC /*'::'*/){` |
|      ! 0 | 1251 | `				return FALSE;` |
|        5 | 1252 | `			}` |
|    38421 | 1253 | `		}else if( pNode->pLeft->xCode != PH7_CompileVariable ){` |
|      ! 0 | 1254 | `			return FALSE;` |
|        - | 1255 | `		}` |
|    38455 | 1256 | `		return TRUE;` |
|        - | 1257 | `	}` |
...
|        - | 1274 | ` */` |
|   417120 | 1275 | `static sxi32 ExprProcessFuncArguments(ph7_gen_state *pGen,ph7_expr_node *pOp,ph7_expr_node **apNode,sxi32 nToken)` |
|        5 | 1276 | `{` |
...
|   417125 | 1280 | `	iCur = 0;` |
|   454426 | 1281 | `	for(;;){` |
|   908857 | 1282 | `		if( iCur >= nToken ){` |
|        - | 1283 | `			/* No more arguments to process */` |
|   417099 | 1284 | `			break;` |
|        - | 1285 | `		}` |
|   491763 | 1286 | `		iNode = iCur;` |
|   491763 | 1287 | `		iNest = 0;` |
|  1217005 | 1288 | `		while( iCur < nToken ){` |
|   799909 | 1289 | `			if( apNode[iCur] ){` |
|   784725 | 1290 | `				if( (apNode[iCur]->pStart->nType & PH7_TK_COMMA) && apNode[iCur]->pLeft == 0 && iNest <= 0 ){` |
|    37336 | 1291 | `					break;` |
|   710058 | 1292 | `				}else if( (apNode[iCur]->pStart->nType & (PH7_TK_LPAREN\|PH7_TK_OSB\|PH7_TK_OCB))` |
|   375124 | 1293 | `					&& apNode[iCur]->xCode != PH7_CompileShortArray` |
|    39986 | 1294 | `					&& apNode[iCur]->xCode != PH7_CompileShortList ){` |
...
|    39777 | 1301 | `					iNest++;` |
|   690177 | 1302 | `				}else if( apNode[iCur]->pStart->nType & (PH7_TK_RPAREN\|PH7_TK_CCB\|PH7_TK_CSB) ){` |
|    39777 | 1303 | `					iNest--;` |
|    19886 | 1304 | `				}` |
|   355029 | 1305 | `			}` |
|   725247 | 1306 | `			iCur++;` |
|        5 | 1307 | `		}` |
|   491763 | 1308 | `		if( iCur > iNode ){` |
|   491757 | 1309 | `			SyString sArgName = {0, 0};` |
...
|   491752 | 1313 | `			if( (iCur - iNode) >= 2` |
|   271989 | 1314 | `				&& apNode[iNode]` |
|    52226 | 1315 | `				&& (apNode[iNode]->pStart->nType & (PH7_TK_ID\|PH7_TK_KEYWORD))` |
|    30683 | 1316 | `				&& apNode[iNode]->xCode == PH7_CompileLiteral` |
|     9005 | 1317 | `				&& apNode[iNode+1]` |
|     8875 | 1318 | `				&& (apNode[iNode+1]->pStart->nType & PH7_TK_COLON) ){` |
...
|        - | 1337 | `				}` |
|      107 | 1338 | `			}` |
|   491750 | 1339 | `			if( apNode[iNode] && (apNode[iNode]->pStart->nType & PH7_TK_AMPER /*'&'*/) && ((iCur - iNode) == 2)` |
...
|      ! 0 | 1345 | `			}` |
|   491755 | 1346 | `			ExprMakeTree(&(*pGen),&apNode[iNode],iCur-iNode);` |
|   491755 | 1347 | `			if( apNode[iNode] ){` |
|   491755 | 1348 | `				if( sArgName.nByte > 0 ){` |
...
|   491755 | 1353 | `				SySetPut(&pOp->aNodeArgs,(const void *)&apNode[iNode]);` |
|   245880 | 1354 | `			}else{` |
...
|   491755 | 1373 | `		if( iCur < nToken && apNode[iCur] && (apNode[iCur]->pStart->nType & PH7_TK_COMMA) ){` |
|    74661 | 1374 | `			iCur++;` |
|    74661 | 1375 | `			if( iCur >= nToken ){` |
|        - | 1376 | `				/* Trailing comma after last argument */` |
|       19 | 1377 | `				break;` |
|        - | 1378 | `			}` |
|    37319 | 1379 | `		}` |
|        5 | 1380 | `	}` |
|   417117 | 1381 | `	return SXRET_OK;` |
|   208565 | 1382 | `}` |
|        - | 1383 | ` /*` |
...
|        - | 1387 | `  */` |
|  1627230 | 1388 | ` static sxi32 ExprMakeTree(ph7_gen_state *pGen,ph7_expr_node **apNode,sxi32 nToken)` |
|        5 | 1389 | ` {` |
|        - | 1390 | `	 sxi32 i,iLeft,iRight;` |
|        - | 1391 | `	 ph7_expr_node *pNode;` |
|        - | 1392 | `	 sxi32 iCur;` |
|        - | 1393 | `	 sxi32 rc;` |
|  1627235 | 1394 | `	 if( nToken <= 0 \|\| (nToken == 1 && apNode[0]->xCode) ){` |
|        - | 1395 | `		 /* TICKET 1433-17: self evaluating node */` |
|   762417 | 1396 | `		 return SXRET_OK;` |
|        - | 1397 | `	 }` |
|        - | 1398 | `	 /* Process expressions enclosed in parenthesis first */` |
|  5368695 | 1399 | `	 for( iCur =  0 ; iCur < nToken ; ++iCur ){` |
|        - | 1400 | `		 sxi32 iNest;` |
...
|        - | 1403 | `		  */` |
|  4503879 | 1404 | `		 if( apNode[iCur] == 0 \|\| apNode[iCur]->pStart->nType != PH7_TK_LPAREN ){` |
|  4471733 | 1405 | `			 continue;` |
|        - | 1406 | `		 }` |
|    32151 | 1407 | `		 iNest = 1;` |
|    32151 | 1408 | `		 iLeft = iCur;` |
|        - | 1409 | `		 /* Find the closing parenthesis */` |
|    32151 | 1410 | `		 iCur++;` |
|   214335 | 1411 | `		 while( iCur < nToken ){` |
|   214335 | 1412 | `			 if( apNode[iCur] ){` |
|   214335 | 1413 | `				 if( apNode[iCur]->pStart->nType & PH7_TK_RPAREN /* ')' */){` |
|        - | 1414 | `					 /* Decrement nesting level */` |
|    55833 | 1415 | `					 iNest--;` |
|    55833 | 1416 | `					 if( iNest <= 0 ){` |
|    32151 | 1417 | `						 break;` |
|        5 | 1418 | `					 }` |
|   170348 | 1419 | `				 }else if( apNode[iCur]->pStart->nType & PH7_TK_LPAREN /* '(' */ ){` |
...
|   182189 | 1424 | `			 iCur++;` |
|        5 | 1425 | `		 }` |
|    32151 | 1426 | `		 if( iCur - iLeft > 1 ){` |
|        - | 1427 | `			 sxi32 j;` |
|        - | 1428 | `			 /* Recurse and process this expression */` |
|    32151 | 1429 | `			 rc = ExprMakeTree(&(*pGen),&apNode[iLeft + 1],iCur - iLeft - 1);` |
|    32151 | 1430 | `			 if( rc != SXRET_OK ){` |
|        3 | 1431 | `				 return rc;` |
|        - | 1432 | `			 }` |
...
|    32149 | 1436 | `			 for( j = iLeft + 1 ; j < iCur ; ++j ){` |
|    32149 | 1437 | `				 if( apNode[j] ){` |
|    32149 | 1438 | `					 apNode[j]->iFlags \|= EXPR_NODE_PARENS;` |
|    32149 | 1439 | `					 break;` |
|        - | 1440 | `				 }` |
|      ! 0 | 1441 | `			 }` |
|    16072 | 1442 | `		 }` |
|        - | 1443 | `		 /* Free the left and right nodes */` |
|    32149 | 1444 | `		 ExprFreeTree(&(*pGen),apNode[iLeft]);` |
|    32149 | 1445 | `		 ExprFreeTree(&(*pGen),apNode[iCur]);` |
|    32149 | 1446 | `		 apNode[iLeft] = 0;` |
|    32149 | 1447 | `		 apNode[iCur] = 0;` |
|    16077 | 1448 | `	 }` |
|        - | 1449 | `	  /* Process expressions enclosed in braces */` |
|  5574735 | 1450 | `	 for( iCur =  0 ; iCur < nToken ; ++iCur ){` |
|        - | 1451 | `		 sxi32 iNest;` |
...
|        - | 1454 | `		  */` |
|  4718183 | 1455 | `		 if( apNode[iCur] == 0 \|\| apNode[iCur]->pStart->nType != PH7_TK_OCB ){` |
|  4718175 | 1456 | `			 continue;` |
|        - | 1457 | `		 }` |
|       10 | 1458 | `		 iNest = 1;` |
|       10 | 1459 | `		 iLeft = iCur;` |
...
|   856557 | 1491 | `	 iLeft = -1;` |
|  5574713 | 1492 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  4718173 | 1493 | `		 if( apNode[iCur] == 0 ){` |
|  1858439 | 1494 | `			 continue;` |
|        - | 1495 | `		 }` |
|  2859739 | 1496 | `		 pNode = apNode[iCur];` |
|  2859739 | 1497 | `		 if( pNode->pOp && pNode->pOp->iPrec == 2 && pNode->pLeft == 0  ){` |
|   764707 | 1498 | `			 if( pNode->pOp->iOp == EXPR_OP_FUNC_CALL ){` |
|        - | 1499 | `				 /* Collect function arguments */` |
|   477857 | 1500 | `				 sxi32 iPtr = 0;` |
|   477857 | 1501 | `				 sxi32 nFuncTok = 0;` |
|  1755615 | 1502 | `				 while( nFuncTok + iCur < nToken ){` |
|  1755615 | 1503 | `					 if( apNode[nFuncTok+iCur] ){` |
|  1740431 | 1504 | `						 if( apNode[nFuncTok+iCur]->pStart->nType & PH7_TK_LPAREN /*'('*/ ){` |
|   498205 | 1505 | `							 iPtr++;` |
|  1491331 | 1506 | `						 }else if ( apNode[nFuncTok+iCur]->pStart->nType & PH7_TK_RPAREN /*')'*/){` |
|   498205 | 1507 | `							 iPtr--;` |
|   498205 | 1508 | `							 if( iPtr <= 0 ){` |
|   477857 | 1509 | `								 break;` |
|        - | 1510 | `							 }` |
|    10174 | 1511 | `						 }` |
|   631287 | 1512 | `					 }` |
|  1277763 | 1513 | `					 nFuncTok++;` |
|        5 | 1514 | `				 }` |
|   477857 | 1515 | `				 if( nFuncTok + iCur >= nToken ){` |
|        - | 1516 | `					 /* Syntax error */` |
...
|      ! 0 | 1521 | `					 return rc;` |
|        - | 1522 | `				 }` |
|   477857 | 1523 | `				 if(  iLeft < 0 \|\| !NODE_ISTERM(iLeft) /*\|\| ( apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec != 2)*/ ){` |
|        - | 1524 | `					 /* Syntax error */` |
...
|      ! 0 | 1529 | `					 return rc;` |
|        - | 1530 | `				 }` |
|   477857 | 1531 | `				 if( nFuncTok > 1 ){` |
|        - | 1532 | `					 /* Process function arguments */` |
|   417125 | 1533 | `					 rc = ExprProcessFuncArguments(&(*pGen),pNode,&apNode[iCur+1],nFuncTok-1);` |
|   417125 | 1534 | `					 if( rc != SXRET_OK ){` |
|       12 | 1535 | `						 return rc;` |
|        - | 1536 | `					 }` |
|   208556 | 1537 | `				 }` |
|        - | 1538 | `				 /* Link the node to the tree */` |
|   477849 | 1539 | `				 pNode->pLeft = apNode[iLeft];` |
|   477849 | 1540 | `				 apNode[iLeft] = 0;` |
|  1755583 | 1541 | `				 for( iPtr = 1; iPtr <= nFuncTok ; iPtr++ ){` |
|  1277739 | 1542 | `					 apNode[iCur+iPtr] = 0;` |
|   638872 | 1543 | `				 }` |
|   525777 | 1544 | `			 }else if (pNode->pOp->iOp == EXPR_OP_SUBSCRIPT ){` |
|        - | 1545 | `				 /* Subscripting */` |
|    97559 | 1546 | `				 sxi32 iArrTok = iCur + 1;` |
|    97559 | 1547 | `				 sxi32 iNest = 1;` |
|    97554 | 1548 | `				 if(  iLeft < 0 \|\| apNode[iLeft] == 0 \|\| (apNode[iLeft]->pOp == 0 && (apNode[iLeft]->xCode != PH7_CompileVariable &&` |
...
|    97554 | 1552 | `					 ( apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec != 2 /* postfix */) ){` |
|        - | 1553 | `						 /* Syntax error */` |
...
|   176147 | 1561 | `				 while( iArrTok < nToken ){` |
|   176147 | 1562 | `					 if( apNode[iArrTok] ){` |
|   176115 | 1563 | `						 if( apNode[iArrTok]->pOp && apNode[iArrTok]->pOp->iOp == EXPR_OP_SUBSCRIPT &&  apNode[iArrTok]->pLeft == 0){` |
|        - | 1564 | `							 /* Increment nesting level */` |
|      ! 0 | 1565 | `							 iNest++;` |
|   176115 | 1566 | `						 }else if( apNode[iArrTok]->pStart->nType & PH7_TK_CSB /*']'*/){` |
|        - | 1567 | `							 /* Decrement nesting level */` |
|    97559 | 1568 | `							 iNest--;` |
|    97559 | 1569 | `							 if( iNest <= 0 ){` |
|    97559 | 1570 | `								 break;` |
|        - | 1571 | `							 }` |
|      ! 0 | 1572 | `						 }` |
|    39278 | 1573 | `					 }` |
|    78593 | 1574 | `					 ++iArrTok;` |
|        5 | 1575 | `				 }` |
|    97559 | 1576 | `				 if( iArrTok > iCur + 1 ){` |
|        - | 1577 | `					 /* Recurse and process this expression */` |
|    78469 | 1578 | `					 rc = ExprMakeTree(&(*pGen),&apNode[iCur+1],iArrTok - iCur - 1);` |
|    78469 | 1579 | `					 if( rc != SXRET_OK ){` |
|      ! 0 | 1580 | `						 return rc;` |
|        - | 1581 | `					 }` |
|        - | 1582 | `					 /* Link the node to it's index */` |
|    78469 | 1583 | `					 SySetPut(&pNode->aNodeArgs,(const void *)&apNode[iCur+1]);` |
|    39232 | 1584 | `				 }` |
|        - | 1585 | `				 /* Link the node to the tree */` |
|    97559 | 1586 | `				 pNode->pLeft = apNode[iLeft];` |
|    97559 | 1587 | `				 pNode->pRight = 0;` |
|    97559 | 1588 | `				 apNode[iLeft] = 0;` |
|   273701 | 1589 | `				 for( iNest = iCur + 1 ; iNest <= iArrTok ; ++iNest ){` |
|   176147 | 1590 | `					 apNode[iNest] = 0;` |
|    88076 | 1591 | `				 }` |
|    48782 | 1592 | `			 }else{` |
|        - | 1593 | `				 /* Member access operators [i.e: '->','::'] */` |
|   189301 | 1594 | `				  iRight = iCur + 1;` |
|   189307 | 1595 | `				 while( iRight < nToken && apNode[iRight] == 0 ){` |
|        7 | 1596 | `					 iRight++;` |
|        1 | 1597 | `				 }` |
|   189301 | 1598 | `				 if( iRight >= nToken \|\| iLeft < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|        - | 1599 | `					 /* Syntax error */` |
...
|   189297 | 1607 | `				 pNode->pLeft = apNode[iLeft];` |
|   189292 | 1608 | `				 if( (pNode->pOp->iOp == EXPR_OP_ARROW /*'->'*/ \|\| pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW /*'?->'*/)` |
|   189123 | 1609 | `					 && pNode->pLeft->pOp == 0 &&` |
|   188830 | 1610 | `					 pNode->pLeft->xCode != PH7_CompileVariable ){` |
|        - | 1611 | `						 /* Syntax error */` |
...
|      ! 0 | 1617 | `						 return rc;` |
|        - | 1618 | `				 }` |
|   189297 | 1619 | `				 pNode->pRight = apNode[iRight];` |
|   189297 | 1620 | `				 apNode[iLeft] = apNode[iRight] = 0;` |
|        - | 1621 | `			 }` |
|   382345 | 1622 | `		 }` |
|  2859727 | 1623 | `		 iLeft = iCur;` |
|  1429866 | 1624 | `	 }` |
|        - | 1625 | `	 /* Handle left associative (new, clone) operators */` |
|  5574681 | 1626 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  4718141 | 1627 | `		 if( apNode[iCur] == 0 ){` |
|  2647631 | 1628 | `			 continue;` |
|        - | 1629 | `		 }` |
|  2070515 | 1630 | `		 pNode = apNode[iCur];` |
|  2070515 | 1631 | `		 if( pNode->pOp && pNode->pOp->iPrec == 1 && pNode->pLeft == 0 ){` |
|        - | 1632 | `			 SyToken *pToken;` |
|        - | 1633 | `			 /* Get the left node */` |
|    24507 | 1634 | `			 iLeft = iCur + 1;` |
|    48759 | 1635 | `			 while( iLeft < nToken && apNode[iLeft] == 0 ){` |
|    24257 | 1636 | `				 iLeft++;` |
|        5 | 1637 | `			 }` |
|    24507 | 1638 | `			 if( iLeft >= nToken \|\| !NODE_ISTERM(iLeft) ){` |
|        - | 1639 | `				  /* Syntax error */` |
...
|    24507 | 1648 | `			 if( pNode->pOp->iOp == EXPR_OP_CLONE ){` |
|        - | 1649 | `				 /* Clone:` |
...
|       21 | 1670 | `			 }else{` |
|        - | 1671 | `				 /* New */` |
|    24473 | 1672 | `				 if( apNode[iLeft]->pOp == 0 ){` |
...
|    24507 | 1689 | `			 pNode->pLeft = apNode[iLeft];` |
|    24507 | 1690 | `			 apNode[iLeft] = 0;` |
|    24507 | 1691 | `			 pNode->pRight = 0; /* Paranoid */` |
|    12251 | 1692 | `		 }` |
|  1035260 | 1693 | `	 }` |
|        - | 1694 | `	  /* Handle post/pre icrement/decrement [i.e: ++/--] operators with precedence 3 */` |
|   856545 | 1695 | `	 iLeft = -1;` |
|  5578813 | 1696 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  4718141 | 1697 | `		 if( apNode[iCur] == 0 ){` |
|  2647631 | 1698 | `			 continue;` |
|        - | 1699 | `		 }` |
|  2070515 | 1700 | `		 pNode = apNode[iCur];` |
|  2070515 | 1701 | `		 if( pNode->pOp && pNode->pOp->iPrec == 3 && pNode->pLeft == 0){` |
|    11457 | 1702 | `			 if( iLeft >= 0 && ((apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec == 2 /* Postfix */)` |
|     4169 | 1703 | `				 \|\| apNode[iLeft]->xCode == PH7_CompileVariable) ){` |
|        - | 1704 | `					 /* Link the node to the tree */` |
|     4181 | 1705 | `					 pNode->pLeft = apNode[iLeft];` |
|     4181 | 1706 | `					 apNode[iLeft] = 0;` |
|     2088 | 1707 | `			 }` |
|     7792 | 1708 | `		  }` |
|  2074647 | 1709 | `		 iLeft = iCur;` |
|  1039392 | 1710 | `	  }` |
|   860677 | 1711 | `	 iLeft = -1;` |
|  5578813 | 1712 | `	 for( iCur = nToken -  1 ; iCur >= 0 ; iCur-- ){` |
|  4718141 | 1713 | `		 if( apNode[iCur] == 0 ){` |
|  2651807 | 1714 | `			 continue;` |
|        - | 1715 | `		 }` |
|  2066339 | 1716 | `		 pNode = apNode[iCur];` |
|  2066339 | 1717 | `		 if( pNode->pOp && pNode->pOp->iPrec == 3 && pNode->pLeft == 0){` |
|    11408 | 1718 | `			 if( iLeft < 0 \|\| (apNode[iLeft]->pOp == 0 && apNode[iLeft]->xCode != PH7_CompileVariable)` |
|    11413 | 1719 | `				 \|\| ( apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec != 2 /* Postfix */) ){` |
|        - | 1720 | `					 /* Syntax error */` |
...
|    11413 | 1728 | `			 pNode->pLeft = apNode[iLeft];` |
|    11413 | 1729 | `			 apNode[iLeft] = 0;` |
|        - | 1730 | `			 /* Mark as pre-increment/decrement node */` |
|    11413 | 1731 | `			 pNode->iFlags \|= EXPR_NODE_PRE_INCR;` |
|     5704 | 1732 | `		  }` |
|  2066339 | 1733 | `		 iLeft = iCur;` |
|  1033172 | 1734 | `	 }` |
|        - | 1735 | `	 /* Handle right associative unary and cast operators [i.e: !,(string),~...]  with precedence 4*/` |
|   860677 | 1736 | `	  iLeft = 0;` |
|  5578807 | 1737 | `	  for( iCur = nToken -  1 ; iCur >= 0 ; iCur-- ){` |
|  4718137 | 1738 | `		  if( apNode[iCur] ){` |
|  2054927 | 1739 | `			  pNode = apNode[iCur];` |
|  2054927 | 1740 | `			  if( pNode->pOp && pNode->pOp->iPrec == 4 && pNode->pLeft == 0){` |
|    35819 | 1741 | `				  if( iLeft > 0 ){` |
|        - | 1742 | `					  /* Link the node to the tree */` |
|    35817 | 1743 | `					  pNode->pLeft = apNode[iLeft];` |
|    35817 | 1744 | `					  apNode[iLeft] = 0;` |
|    35817 | 1745 | `					  if( pNode->pLeft && pNode->pLeft->pOp && pNode->pLeft->pOp->iPrec > 4 ){` |
...
|  5578805 | 1772 | `	 for( iCur = nToken - 1 ; iCur >= 0 ; --iCur ){` |
|  4718135 | 1773 | `		 if( apNode[iCur] == 0 ){` |
|  2699139 | 1774 | `			 continue;` |
|        - | 1775 | `		 }` |
|  2019001 | 1776 | `		 pNode = apNode[iCur];` |
|  2019001 | 1777 | `		 if( pNode->pOp && pNode->pOp->iPrec == 5 && pNode->pLeft == 0 ){` |
|        - | 1778 | `			 sxi32 iL, iR;` |
...
|  9467289 | 1841 | `	 for( i = 7 ; i < 17 ; i++ ){` |
|  8606629 | 1842 | `		 iLeft = -1;` |
| 55787635 | 1843 | `		 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
| 47181021 | 1844 | `			 if( apNode[iCur] == 0 ){` |
| 30416297 | 1845 | `				 continue;` |
|        - | 1846 | `			 }` |
| 16764729 | 1847 | `			 pNode = apNode[iCur];` |
| 16764729 | 1848 | `			 if( pNode->pOp && pNode->pOp->iPrec == i && pNode->pLeft == 0 ){` |
|        - | 1849 | `				 /* Get the right node */` |
|   256135 | 1850 | `				 iRight = iCur + 1;` |
|   366133 | 1851 | `				 while( iRight < nToken && apNode[iRight] == 0 ){` |
|   110003 | 1852 | `					 iRight++;` |
|        5 | 1853 | `				 }` |
|   256135 | 1854 | `				 if( iRight >= nToken \|\| iLeft < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|        - | 1855 | `					 /* Syntax error */` |
...
|       10 | 1860 | `					 return rc;` |
|        - | 1861 | `				 }` |
|   256127 | 1862 | `				 if( pNode->pOp->iOp == EXPR_OP_REF ){` |
|        - | 1863 | `					 sxi32  iTmp;` |
...
|   256125 | 1904 | `				 pNode->pLeft = apNode[iLeft];` |
|   256125 | 1905 | `				 pNode->pRight = apNode[iRight];` |
|   256125 | 1906 | `				 apNode[iLeft] = apNode[iRight] = 0;` |
|   128060 | 1907 | `			 }` |
| 16764719 | 1908 | `			 iLeft = iCur;` |
|  8382362 | 1909 | `		 }` |
|  4303312 | 1910 | `	 }` |
...
|        - | 1914 | `	  */` |
|   860665 | 1915 | `	  iLeft = -1;` |
|  5567217 | 1916 | `	  for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  4709223 | 1917 | `		  if( apNode[iCur] == 0 ){` |
|  3210561 | 1918 | `			  continue;` |
|        - | 1919 | `		  }` |
|  1498667 | 1920 | `		  pNode = apNode[iCur];` |
|  1498667 | 1921 | `		  if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_QUESTY && pNode->pLeft == 0 ){` |
...
|        - | 1987 | `	  */` |
|   860663 | 1988 | `	 iRight = -1;` |
|  5578609 | 1989 | `	 for( iCur = nToken -  1 ; iCur >= 0 ; iCur--){` |
|  4718005 | 1990 | `		 if( apNode[iCur] == 0 ){` |
|  3539619 | 1991 | `			 continue;` |
|        - | 1992 | `		 }` |
|  1178391 | 1993 | `		 pNode = apNode[iCur];` |
|  1178391 | 1994 | `		 if( pNode->pOp && pNode->pOp->iPrec == 18 && pNode->pLeft == 0 ){` |
|        - | 1995 | `			 /* Get the left node */` |
|   317611 | 1996 | `			 iLeft = iCur - 1;` |
|   459533 | 1997 | `			 while( iLeft >= 0 && apNode[iLeft] == 0 ){` |
|   141927 | 1998 | `				 iLeft--;` |
|        5 | 1999 | `			 }` |
|   317611 | 2000 | `			 if( iLeft < 0 \|\| iRight < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|        - | 2001 | `				 /* Syntax error */` |
...
|        - | 2018 | `			  * a write. */` |
|   317569 | 2019 | `			 if( PH7_ExprContainsNullsafe(apNode[iLeft]) ){` |
...
|       11 | 2025 | `				 return rc;` |
|        - | 2026 | `			 }` |
|   317561 | 2027 | `			 if( ExprIsModifiableValue(apNode[iLeft],FALSE) == FALSE ){` |
...
|   317557 | 2046 | `			 pNode->pLeft = apNode[iRight];` |
|   317557 | 2047 | `			 pNode->pRight = apNode[iLeft];` |
|   317557 | 2048 | `			 apNode[iLeft] = apNode[iRight] = 0;` |
|   158776 | 2049 | `		 }` |
|  1178337 | 2050 | `		 iRight = iCur;` |
|   589171 | 2051 | `	 }` |
|        - | 2052 | `	 /* Process left associative binary operators that have the lowest precedence [i.e: and,or,xor] */` |
|  4303025 | 2053 | `	 for( i = 19 ; i < 23 ; i++ ){` |
|  3442421 | 2054 | `		 iLeft = -1;` |
| 22314149 | 2055 | `		 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
| 18871733 | 2056 | `			 if( apNode[iCur] == 0 ){` |
| 15428911 | 2057 | `				 continue;` |
|        - | 2058 | `			 }` |
|  3442827 | 2059 | `			 pNode = apNode[iCur];` |
|  3442827 | 2060 | `			 if( pNode->pOp && pNode->pOp->iPrec == i && pNode->pLeft == 0 ){` |
...
|       35 | 2078 | `			 }` |
|  3442827 | 2079 | `			 iLeft = iCur;` |
|  1721416 | 2080 | `		 }` |
|  1721213 | 2081 | `	 }` |
|        - | 2082 | `	 /* Point to the root of the expression tree */` |
|  4717909 | 2083 | `	 for( iCur = 1 ; iCur < nToken ; ++iCur ){` |
|  3857323 | 2084 | `		 if( apNode[iCur] ){` |
|   794379 | 2085 | `			 if( (apNode[iCur]->pOp \|\| apNode[iCur]->xCode ) && apNode[0] != 0){` |
...
|       22 | 2090 | `				  return rc;` |
|        - | 2091 | `			 }` |
|   794361 | 2092 | `			 apNode[0] = apNode[iCur];` |
|   794361 | 2093 | `			 apNode[iCur] = 0;` |
|   397178 | 2094 | `		 }` |
|  1928655 | 2095 | `	 }` |
|   860591 | 2096 | `	 return SXRET_OK;` |
|   811554 | 2097 | ` }` |
|        - | 2098 | ` /*` |
...
|        - | 2103 | `  */` |
|  1015556 | 2104 | `PH7_PRIVATE sxi32 PH7_ExprMakeTree(ph7_gen_state *pGen,SySet *pExprNode,ph7_expr_node **ppRoot)` |
|        5 | 2105 | `{` |
|        - | 2106 | `	ph7_expr_node **apNode;` |
|        - | 2107 | `	ph7_expr_node *pNode;` |
|        - | 2108 | `	sxi32 rc;` |
|        - | 2109 | `	/* Reset node container */` |
|  1015561 | 2110 | `	SySetReset(pExprNode);` |
|  1015561 | 2111 | `	pNode = 0; /* Prevent compiler warning */` |
|        - | 2112 | `	/* Extract nodes one after one until we hit the end of the input */` |
|        - | 2113 | `	{` |
|  1015561 | 2114 | `		int iLastWasTerm = 0;` |
|  1015561 | 2115 | `		int bAfterMemberOp = 0; /* TRUE iff the previous node was -> / ?-> / :: */` |
|  5504627 | 2116 | `		while( pGen->pIn < pGen->pEnd ){` |
|  4489105 | 2117 | `			rc = ExprExtractNode(&(*pGen),&pNode,iLastWasTerm,bAfterMemberOp);` |
|  4489105 | 2118 | `			if( rc != SXRET_OK ){` |
|       38 | 2119 | `				return rc;` |
|        - | 2120 | `			}` |
|        - | 2121 | `			/* Determine if this node is a term for short-array disambiguation */` |
|  4489071 | 2122 | `			if( pNode->xCode ){` |
|        - | 2123 | `				/* Node with compile handler: variable, literal, string, array, etc. */` |
|  2354479 | 2124 | `				iLastWasTerm = 1;` |
|  3311834 | 2125 | `			}else if( pNode->pOp ){` |
|        - | 2126 | `				/* Operator node */` |
|  1014067 | 2127 | `				iLastWasTerm = 0;` |
|   507036 | 2128 | `			}else{` |
|        - | 2129 | `				/* Delimiter: ')' and ']' end terms */` |
|  1120535 | 2130 | `				iLastWasTerm = (pNode->pStart->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB)) ? 1 : 0;` |
|        - | 2131 | `			}` |
...
|  4489071 | 2135 | `			bAfterMemberOp = ( pNode->pOp && pNode->pOp->iVmOp == PH7_OP_MEMBER );` |
|        - | 2136 | `			/* Save the extracted node */` |
|  4489071 | 2137 | `			SySetPut(pExprNode,(const void *)&pNode);` |
|        5 | 2138 | `		}` |
|        - | 2139 | `	}` |
|  1015527 | 2140 | `	if( SySetUsed(pExprNode) < 1 ){` |
|        - | 2141 | `		/* Empty expression [i.e: A semi-colon;] */` |
|      ! 0 | 2142 | `		*ppRoot = 0;` |
|      ! 0 | 2143 | `		return SXRET_OK;` |
|        - | 2144 | `	}` |
|  1015527 | 2145 | `	apNode = (ph7_expr_node **)SySetBasePtr(pExprNode);` |
|        - | 2146 | `	/* Make sure we are dealing with valid nodes */` |
|  1015527 | 2147 | `	rc = ExprVerifyNodes(&(*pGen),apNode,(sxi32)SySetUsed(pExprNode));` |
|  1015527 | 2148 | `	if( rc != SXRET_OK ){` |
...
|        - | 2154 | `	}` |
|        - | 2155 | `	/* Build the tree */` |
|  1015477 | 2156 | `	rc = ExprMakeTree(&(*pGen),apNode,(sxi32)SySetUsed(pExprNode));` |
|  1015477 | 2157 | `	if( rc != SXRET_OK ){` |
|        - | 2158 | `		/* Something goes wrong [i.e: Syntax error] */` |
|      103 | 2159 | `		*ppRoot = 0;` |
|      103 | 2160 | `		return rc;` |
|        - | 2161 | `	}` |
|        - | 2162 | `	/* Point to the root of the tree */` |
|  1015379 | 2163 | `	*ppRoot = apNode[0];` |
|  1015379 | 2164 | `	return SXRET_OK;` |
|   507783 | 2165 | `}` |
|        - | 2166 |  |
