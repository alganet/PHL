...
|          - |  272 | ` */` |
|   25734816 |  273 | `PH7_PRIVATE const ph7_expr_op *  PH7_ExprExtractOperator(SyString *pStr,SyToken *pLast)` |
|          5 |  274 | `{` |
|   25734821 |  275 | `	sxu32 n = 0;` |
|          - |  276 | `	sxi32 rc;` |
|          - |  277 | `	/* Do a linear lookup on the operators table */` |
|  407297738 |  278 | `	for(;;){` |
|  814595481 |  279 | `		if( n >= SX_ARRAYSIZE(aOpTable) ){` |
|        ! 0 |  280 | `			break;` |
|          - |  281 | `		}` |
|  814595481 |  282 | `		if( SyisAlpha(aOpTable[n].sOp.zString[0]) ){` |
|          - |  283 | `			/* TICKET 1433-012: Alpha stream operators [i.e: and,or,xor,new...] */` |
|   77375843 |  284 | `			rc = SyStringCmp(pStr,&aOpTable[n].sOp,SyStrnicmp);` |
|   38687924 |  285 | `		}else{` |
|  737219643 |  286 | `			rc = SyStringCmp(pStr,&aOpTable[n].sOp,SyMemcmp);` |
|          - |  287 | `		}` |
|  814595481 |  288 | `		if( rc == 0 ){` |
|   26056983 |  289 | `			if( aOpTable[n].sOp.nByte != sizeof(char) \|\| (aOpTable[n].iOp != EXPR_OP_UMINUS && aOpTable[n].iOp != EXPR_OP_UPLUS) \|\| pLast == 0 ){` |
|          - |  290 | `				/* There is no ambiguity here,simply return the first operator seen */` |
|   25634767 |  291 | `				return &aOpTable[n];` |
|          - |  292 | `			}` |
...
|          4 |  306 | `			}` |
|     161081 |  307 | `		}` |
|  788860665 |  308 | `		++n; /* Next operator in the table */` |
|          5 |  309 | `	}` |
...
|          - |  317 | ` */` |
|    6994814 |  318 | `PH7_PRIVATE void PH7_DelimitNestedTokens(SyToken *pIn,SyToken *pEnd,sxu32 nTokStart,sxu32 nTokEnd,SyToken **ppEnd)` |
|          5 |  319 | `{` |
|    6994819 |  320 | `	SyToken *pCur = pIn;` |
|    6994819 |  321 | `	sxi32 iNest = 1;` |
|   73511973 |  322 | `	for(;;){` |
|  147023951 |  323 | `		if( pCur >= pEnd ){` |
|      15819 |  324 | `			break;` |
|          - |  325 | `		}` |
|  147008137 |  326 | `		if( pCur->nType & nTokStart ){` |
|          - |  327 | `			/* Increment nesting level */` |
|    5706129 |  328 | `			iNest++;` |
|  144155075 |  329 | `		}else if( pCur->nType & nTokEnd ){` |
|          - |  330 | `			/* Decrement nesting level */` |
|   12685129 |  331 | `			iNest--;` |
|   12685129 |  332 | `			if( iNest <= 0 ){` |
|    6979005 |  333 | `				break;` |
|          - |  334 | `			}` |
|    2853062 |  335 | `		}` |
|          - |  336 | `		/* Advance cursor */` |
...
|          - |  373 | ` */` |
|   15239028 |  374 | `static sxi32 ExprVerifyNodes(ph7_gen_state *pGen,ph7_expr_node **apNode,sxi32 nNode)` |
|          5 |  375 | `{` |
|          - |  376 | `	sxi32 iParen,iSquare,iQuesty,iBraces;` |
|          - |  377 | `	sxi32 i,rc;` |
|          - |  378 |  |
|   15239033 |  379 | `	if( nNode > 0 && apNode[0]->pOp && (apNode[0]->pOp->iOp == EXPR_OP_ADD \|\| apNode[0]->pOp->iOp == EXPR_OP_SUB) ){` |
...
|       3840 |  383 | `	}` |
|   15239033 |  384 | `	iParen = iSquare = iQuesty = iBraces = 0;` |
|   95150471 |  385 | `	for( i = 0 ; i < nNode ; ++i ){` |
|   79911479 |  386 | `		if( apNode[i]->xCode == PH7_CompileShortArray \|\| apNode[i]->xCode == PH7_CompileShortList ){` |
|          - |  387 | `			/* Short array/list literal: brackets are self-contained, skip */` |
|     216525 |  388 | `			continue;` |
|          - |  389 | `		}` |
|   79694959 |  390 | `		if( apNode[i]->pStart->nType & PH7_TK_LPAREN /*'('*/){` |
|    6621909 |  391 | `			if( i > 0 && ( apNode[i-1]->xCode == PH7_CompileVariable \|\| apNode[i-1]->xCode == PH7_CompileLiteral \|\|` |
...
|    6179927 |  394 | `					if( (apNode[i - 1]->pStart->nType & PH7_TK_OP) == 0 ){` |
|          - |  395 | `						/* We are dealing with a postfix [i.e: function call]  operator` |
|          - |  396 | `						 * not a simple left parenthesis. Mark the node.` |
|          - |  397 | `						 */` |
|    6179927 |  398 | `						apNode[i]->pStart->nType \|= PH7_TK_OP;` |
|    6179927 |  399 | `						apNode[i]->pStart->pUserData = (void *)&sFCallOp; /* Function call operator */` |
|    6179927 |  400 | `						apNode[i]->pOp = &sFCallOp;` |
|    3089961 |  401 | `					}` |
|    3089961 |  402 | `			}` |
|    6621909 |  403 | `			iParen++;` |
|   76384007 |  404 | `		}else if( apNode[i]->pStart->nType & PH7_TK_RPAREN/*')*/){` |
|    6621909 |  405 | `			if( iParen <= 0 ){` |
...
|          - |  411 | `			}` |
|    6621897 |  412 | `			iParen--;` |
|   69762097 |  413 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OSB /*'['*/){` |
|    2875273 |  414 | `			iSquare++;` |
|   65013517 |  415 | `		}else if (apNode[i]->pStart->nType & PH7_TK_CSB /*']'*/){` |
|    2875277 |  416 | `			if( iSquare <= 0 ){` |
...
|          - |  422 | `			}` |
|    2875271 |  423 | `			iSquare--;` |
|   62138244 |  424 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OCB /*'{'*/){` |
|       3839 |  425 | `			iBraces++;` |
...
|          3 |  434 | `				return rc;` |
|          5 |  435 | `			}` |
|   60698693 |  436 | `		}else if (apNode[i]->pStart->nType & PH7_TK_CCB /*'}'*/){` |
...
|          - |  443 | `			}` |
|       3837 |  444 | `			iBraces--;` |
|   60694849 |  445 | `		}else if ( apNode[i]->pStart->nType & PH7_TK_COLON ){` |
...
|          6 |  456 | `				return rc;` |
|          5 |  457 | `			}` |
|   60463571 |  458 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OP ){` |
|   19738789 |  459 | `			const ph7_expr_op *pOp = (const ph7_expr_op *)apNode[i]->pOp;` |
|   19738789 |  460 | `			if( pOp->iOp == EXPR_OP_QUESTY ){` |
|     458437 |  461 | `				iQuesty++;` |
|   19509573 |  462 | `			}else if( i > 0 && (pOp->iOp == EXPR_OP_UMINUS \|\| pOp->iOp == EXPR_OP_UPLUS)){` |
...
|    9869392 |  482 | `		}` |
|   39847464 |  483 | `	}` |
|   15238997 |  484 | `	if( iParen != 0 \|\| iSquare != 0 \|\| iQuesty != 0 \|\| iBraces != 0){` |
...
|         19 |  489 | `		return rc;` |
|          - |  490 | `	}` |
|   15238981 |  491 | `	return SXRET_OK;` |
|    7619519 |  492 | `}` |
|          - |  493 | `/*` |
|          - |  494 | ` * Collect and assemble tokens holding a namespace path [i.e: namespace\to\const]` |
|          - |  495 | ` * or a simple literal [i.e: PHP_EOL].` |
|          - |  496 | ` */` |
|   11956296 |  497 | `static void ExprAssembleLiteral(SyToken **ppCur,SyToken *pEnd)` |
|          5 |  498 | `{` |
|   11956301 |  499 | `	SyToken *pIn = *ppCur;` |
|          - |  500 | `	/* Jump the first literal seen */` |
|   11956301 |  501 | `	if( (pIn->nType & PH7_TK_NSSEP) == 0 ){` |
|   11952407 |  502 | `		pIn++;` |
|    5976201 |  503 | `	}` |
|    5980133 |  504 | `	for(;;){` |
|   11960271 |  505 | `		if(pIn < pEnd && (pIn->nType & PH7_TK_NSSEP) ){` |
|       3975 |  506 | `			pIn++;` |
...
|          - |  866 | ` */` |
|   79915716 |  867 | `static sxi32 ExprExtractNode(ph7_gen_state *pGen,ph7_expr_node **ppNode,int iLastWasTerm,int bAfterMemberOp)` |
|          5 |  868 | `{` |
|          - |  869 | `	ph7_expr_node *pNode;` |
|          - |  870 | `	SyToken *pCur;` |
|          - |  871 | `	sxi32 rc;` |
|          - |  872 | `	/* Allocate a new node */` |
|   79915721 |  873 | `	pNode = (ph7_expr_node *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_expr_node));` |
|   79915721 |  874 | `	if( pNode == 0 ){` |
...
|   79915721 |  881 | `	SyZero(pNode,sizeof(ph7_expr_node));` |
|   79915721 |  882 | `	SySetInit(&pNode->aNodeArgs,&pGen->pVm->sAllocator,sizeof(ph7_expr_node **));` |
|          - |  883 | `	/* Point to the head of the token stream */` |
|   79915721 |  884 | `	pCur = pNode->pStart = pGen->pIn;` |
|          - |  885 | `	/* Start collecting tokens */` |
|   79915721 |  886 | `	if( pCur->nType & PH7_TK_ELLIPSIS ){` |
...
|       4093 |  909 | `		return rc;` |
|          - |  910 | `	}` |
|   79911553 |  911 | `	if( (pCur->nType & PH7_TK_OSB) && !iLastWasTerm ){` |
|          - |  912 | `		/* PHP 5.4 short array syntax: [1, 2, 3] or ['key' => 'value'].` |
|          - |  913 | `		 * This '[' does not follow a term, so it is an array literal, not subscript.` |
|          - |  914 | `		 */` |
|     216527 |  915 | `		pCur++; /* Skip the opening '[' */` |
|     216527 |  916 | `		PH7_DelimitNestedTokens(pCur,pGen->pEnd,PH7_TK_OSB,PH7_TK_CSB,&pCur);` |
|     216527 |  917 | `		if( pCur < pGen->pEnd ){` |
|     216527 |  918 | `			pCur++; /* Skip past the closing ']' */` |
|     108266 |  919 | `		}else{` |
...
|          - |  930 | `		 */` |
|     216728 |  931 | `		if( pCur < pGen->pEnd && (pCur->nType & PH7_TK_OP) ){` |
...
|          - |  937 | `			}` |
|        205 |  938 | `		}else{` |
|     216125 |  939 | `			pNode->xCode = PH7_CompileShortArray;` |
|          5 |  940 | `		}` |
|   79803292 |  941 | `	}else if( bAfterMemberOp && (pCur->nType & PH7_TK_OP) && (pCur->nType & PH7_TK_ID) ){` |
...
|   79695018 |  952 | `	}else if( (pCur->nType & PH7_TK_OP) && pCur->pUserData` |
|   22614108 |  953 | `		&& ((const ph7_expr_op *)pCur->pUserData)->iOp == EXPR_OP_CLONE` |
|   11335770 |  954 | `		&& &pCur[1] < pGen->pEnd && (pCur[1].nType & PH7_TK_LPAREN) ){` |
...
|   79695002 |  980 | `	}else if( pCur->nType & PH7_TK_OP ){` |
|          - |  981 | `		/* Point to the instance that describe this operator */` |
|   22614091 |  982 | `		pNode->pOp = (const ph7_expr_op *)pCur->pUserData;` |
|          - |  983 | `		/* Advance the stream cursor */` |
|   22614091 |  984 | `		pCur++;` |
|   68387948 |  985 | `	}else if( pCur->nType & PH7_TK_DOLLAR ){` |
|          - |  986 | `		/* Isolate variable */` |
|   38670193 |  987 | `		while( pCur < pGen->pEnd && (pCur->nType & PH7_TK_DOLLAR) ){` |
|   19335105 |  988 | `			pCur++; /* Variable variable */` |
|          5 |  989 | `		}` |
|   19335093 |  990 | `		if( pCur < pGen->pEnd ){` |
|   19335093 |  991 | `			if (pCur->nType & (PH7_TK_ID\|PH7_TK_KEYWORD) ){` |
|          - |  992 | `				/* Variable name */` |
|   19335065 |  993 | `				pCur++;` |
|    9667563 |  994 | `			}else if( pCur->nType & PH7_TK_OCB /* '{' */ ){` |
|         25 |  995 | `				pCur++;` |
...
|          8 | 1008 | `			}` |
|    9667542 | 1009 | `		}` |
|   19335089 | 1010 | `		pNode->xCode = PH7_CompileVariable;` |
|   47413359 | 1011 | `	 }else if( pCur->nType & PH7_TK_KEYWORD ){` |
...
|          5 | 1136 | `		 }` |
|   37265515 | 1137 | `	 }else if( pCur->nType & (PH7_TK_NSSEP\|PH7_TK_ID) ){` |
|          - | 1138 | `		 /* Constants,function name,namespace path,class name... */` |
|   11412279 | 1139 | `		 if( bAfterMemberOp ){` |
...
|    2296028 | 1145 | `		 }` |
|   11412279 | 1146 | `		 ExprAssembleLiteral(&pCur,pGen->pEnd);` |
|   11412279 | 1147 | `		 pNode->xCode = PH7_CompileLiteral;` |
|    5706142 | 1148 | `	 }else{` |
|   25372967 | 1149 | `		 if( (pCur->nType & (PH7_TK_LPAREN\|PH7_TK_RPAREN\|PH7_TK_COMMA\|PH7_TK_COLON\|PH7_TK_CSB\|PH7_TK_OCB\|PH7_TK_CCB)) == 0 ){` |
|          - | 1150 | `			 /* Point to the code generator routine */` |
|    8787465 | 1151 | `			 pNode->xCode = PH7_GetNodeHandler(pCur->nType);` |
|    8787465 | 1152 | `			 if( pNode->xCode == 0 ){` |
...
|   79911519 | 1165 | `	pNode->pEnd = pCur;` |
|          - | 1166 | `	/* Save the node for later processing */` |
|   79911519 | 1167 | `	*ppNode = pNode;` |
|          - | 1168 | `	/* Synchronize cursors */` |
|   79911519 | 1169 | `	pGen->pIn = pCur;` |
|   79911519 | 1170 | `	return SXRET_OK;` |
|   39957863 | 1171 | `}` |
|          - | 1172 | `/*` |
...
|          - | 1175 | ` * level is zero.` |
|          - | 1176 | ` */` |
|    1788902 | 1177 | `PH7_PRIVATE sxi32 PH7_GetNextExpr(SyToken *pStart,SyToken *pEnd,SyToken **ppNext)` |
|          5 | 1178 | `{` |
|    1788907 | 1179 | `	SyToken *pCur = pStart;` |
|    1788907 | 1180 | `	sxi32 iNest = 0;` |
|    1788907 | 1181 | `	if( pCur >= pEnd \|\| (pCur->nType & PH7_TK_SEMI/*';'*/) ){` |
|          - | 1182 | `		/* Last expression */` |
|     660259 | 1183 | `		return SXERR_EOF;` |
|          - | 1184 | `	}` |
|    4276095 | 1185 | `	while( pCur < pEnd ){` |
|    4001685 | 1186 | `		if( (pCur->nType & (PH7_TK_COMMA/*','*/\|PH7_TK_SEMI/*';'*/)) && iNest <= 0){` |
|     854243 | 1187 | `			break;` |
|          - | 1188 | `		}` |
|    3147447 | 1189 | `		if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|     214921 | 1190 | `			iNest++;` |
|    3039989 | 1191 | `		}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}*/) ){` |
|     214923 | 1192 | `			iNest--;` |
|     107459 | 1193 | `		}` |
|    3147447 | 1194 | `		pCur++;` |
|          5 | 1195 | `	}` |
|    1128653 | 1196 | `	*ppNext = pCur;` |
|    1128653 | 1197 | `	return SXRET_OK;` |
|     894456 | 1198 | `}` |
|          - | 1199 | `/*` |
|          - | 1200 | ` * Free an expression tree.` |
|          - | 1201 | ` */` |
|   68353814 | 1202 | `static void ExprFreeTree(ph7_gen_state *pGen,ph7_expr_node *pNode)` |
|          5 | 1203 | `{` |
|   68353819 | 1204 | `	if( pNode->pLeft ){` |
|          - | 1205 | `		/* Release the left tree */` |
|   26745787 | 1206 | `		ExprFreeTree(&(*pGen),pNode->pLeft);` |
|   13372891 | 1207 | `	}` |
|   68353819 | 1208 | `	if( pNode->pRight ){` |
|          - | 1209 | `		/* Release the right tree */` |
|   15551339 | 1210 | `		ExprFreeTree(&(*pGen),pNode->pRight);` |
|    7775667 | 1211 | `	}` |
|   68353819 | 1212 | `	if( pNode->pCond ){` |
|          - | 1213 | `		/* Release the conditional tree used by the ternary operator */` |
|     458433 | 1214 | `		ExprFreeTree(&(*pGen),pNode->pCond);` |
|     229214 | 1215 | `	}` |
|   68353819 | 1216 | `	if( SySetUsed(&pNode->aNodeArgs) > 0 ){` |
|          - | 1217 | `		ph7_expr_node **apArg;` |
|          - | 1218 | `		sxu32 n;` |
|          - | 1219 | `		/* Release node arguments */` |
|    7422563 | 1220 | `		apArg = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|   16889259 | 1221 | `		for( n = 0 ; n < SySetUsed(&pNode->aNodeArgs) ; ++n ){` |
|    9466701 | 1222 | `			ExprFreeTree(&(*pGen),apArg[n]);` |
|    4733353 | 1223 | `		}` |
|    7422563 | 1224 | `		SySetRelease(&pNode->aNodeArgs);` |
|    3711279 | 1225 | `	}` |
|          - | 1226 | `	/* Finally,release this node */` |
|   68353819 | 1227 | `	SyMemBackendPoolFree(&pGen->pVm->sAllocator,pNode);` |
|   68353819 | 1228 | `}` |
|          - | 1229 | `/*` |
|          - | 1230 | ` * Free an expression tree.` |
|          - | 1231 | ` * This function is a wrapper around ExprFreeTree() defined above.` |
|          - | 1232 | ` */` |
|   15239058 | 1233 | `PH7_PRIVATE sxi32 PH7_ExprFreeTree(ph7_gen_state *pGen,SySet *pNodeSet)` |
|          5 | 1234 | `{` |
|          - | 1235 | `	ph7_expr_node **apNode;` |
|          - | 1236 | `	sxu32 n;` |
|   15239063 | 1237 | `	apNode = (ph7_expr_node **)SySetBasePtr(pNodeSet);` |
|   95150627 | 1238 | `	for( n = 0  ; n < SySetUsed(pNodeSet) ; ++n ){` |
|   79911569 | 1239 | `		if( apNode[n] ){` |
|   15239403 | 1240 | `			ExprFreeTree(&(*pGen),apNode[n]);` |
|    7619699 | 1241 | `		}` |
|   39955787 | 1242 | `	}` |
|   15239063 | 1243 | `	return SXRET_OK;` |
|          5 | 1244 | `}` |
|          - | 1245 | `/*` |
...
|          - | 1251 | ` */` |
|   19454196 | 1252 | `PH7_PRIVATE int PH7_ExprContainsNullsafe(ph7_expr_node *pNode)` |
|          5 | 1253 | `{` |
|   19454201 | 1254 | `	if( pNode == 0 ){` |
|   12146345 | 1255 | `		return 0;` |
|          - | 1256 | `	}` |
|    7307861 | 1257 | `	if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW ){` |
|         16 | 1258 | `		return 1;` |
|          - | 1259 | `	}` |
|    7307849 | 1260 | `	if( PH7_ExprContainsNullsafe(pNode->pLeft) ){` |
|          6 | 1261 | `		return 1;` |
|          - | 1262 | `	}` |
|    7307845 | 1263 | `	if( PH7_ExprContainsNullsafe(pNode->pRight) ){` |
|        ! 0 | 1264 | `		return 1;` |
|          - | 1265 | `	}` |
|    7307845 | 1266 | `	return 0;` |
|    9727103 | 1267 | `}` |
|          - | 1268 | `/*` |
|          - | 1269 | ` * Check if the given node is a modifialbe l/r-value.` |
|          - | 1270 | ` * Return TRUE if modifiable.FALSE otherwise.` |
|          - | 1271 | ` */` |
|    4815484 | 1272 | `static int ExprIsModifiableValue(ph7_expr_node *pNode,sxu8 bFunc)` |
|          5 | 1273 | `{` |
|          - | 1274 | `	sxi32 iExprOp;` |
|    4815489 | 1275 | `	if( pNode->pOp == 0 ){` |
|    3483025 | 1276 | `		return pNode->xCode == PH7_CompileVariable ? TRUE : FALSE;` |
|          - | 1277 | `	}` |
|    1332469 | 1278 | `	iExprOp = pNode->pOp->iOp;` |
|    1332469 | 1279 | `	if( iExprOp == EXPR_OP_ARROW /*'->' */ \|\| iExprOp == EXPR_OP_DC /*'::'*/ ){` |
|     819123 | 1280 | `			return TRUE;` |
|          - | 1281 | `	}` |
|     513351 | 1282 | `	if( iExprOp == EXPR_OP_SUBSCRIPT/*'[]'*/ ){` |
|     513337 | 1283 | `		if( pNode->pLeft->pOp ) {` |
...
|        ! 0 | 1286 | `				return FALSE;` |
|          5 | 1287 | `			}` |
|     454024 | 1288 | `		}else if( pNode->pLeft->xCode != PH7_CompileVariable ){` |
|        ! 0 | 1289 | `			return FALSE;` |
|          - | 1290 | `		}` |
|     513337 | 1291 | `		return TRUE;` |
|          - | 1292 | `	}` |
...
|          - | 1309 | ` */` |
|    4769502 | 1310 | `static sxi32 ExprProcessFuncArguments(ph7_gen_state *pGen,ph7_expr_node *pOp,ph7_expr_node **apNode,sxi32 nToken)` |
|          5 | 1311 | `{` |
...
|    4769507 | 1315 | `	iCur = 0;` |
|    5791559 | 1316 | `	for(;;){` |
|   11583123 | 1317 | `		if( iCur >= nToken ){` |
|          - | 1318 | `			/* No more arguments to process */` |
|    4769481 | 1319 | `			break;` |
|          - | 1320 | `		}` |
|    6813647 | 1321 | `		iNode = iCur;` |
|    6813647 | 1322 | `		iNest = 0;` |
|   21911633 | 1323 | `		while( iCur < nToken ){` |
|   17142155 | 1324 | `			if( apNode[iCur] ){` |
|   17096089 | 1325 | `				if( (apNode[iCur]->pStart->nType & PH7_TK_COMMA) && apNode[iCur]->pLeft == 0 && iNest <= 0 ){` |
|    1022087 | 1326 | `					break;` |
|   15051920 | 1327 | `				}else if( (apNode[iCur]->pStart->nType & (PH7_TK_LPAREN\|PH7_TK_OSB\|PH7_TK_OCB))` |
|    8107540 | 1328 | `					&& apNode[iCur]->xCode != PH7_CompileShortArray` |
|    1160634 | 1329 | `					&& apNode[iCur]->xCode != PH7_CompileShortList ){` |
...
|    1158103 | 1336 | `					iNest++;` |
|   14472876 | 1337 | `				}else if( apNode[iCur]->pStart->nType & (PH7_TK_RPAREN\|PH7_TK_CCB\|PH7_TK_CSB) ){` |
|    1158103 | 1338 | `					iNest--;` |
|     579049 | 1339 | `				}` |
|    7525960 | 1340 | `			}` |
|   15097991 | 1341 | `			iCur++;` |
|          5 | 1342 | `		}` |
|    6813647 | 1343 | `		if( iCur > iNode ){` |
|    6813641 | 1344 | `			SyString sArgName = {0, 0};` |
...
|    6813636 | 1348 | `			if( (iCur - iNode) >= 2` |
|    4594635 | 1349 | `				&& apNode[iNode]` |
|    2375620 | 1350 | `				&& (apNode[iNode]->pStart->nType & (PH7_TK_ID\|PH7_TK_KEYWORD))` |
|    1277170 | 1351 | `				&& apNode[iNode]->xCode == PH7_CompileLiteral` |
|     178464 | 1352 | `				&& apNode[iNode+1]` |
|     178199 | 1353 | `				&& (apNode[iNode+1]->pStart->nType & PH7_TK_COLON) ){` |
...
|          - | 1372 | `				}` |
|        142 | 1373 | `			}` |
|    6813634 | 1374 | `			if( apNode[iNode] && (apNode[iNode]->pStart->nType & PH7_TK_AMPER /*'&'*/) && ((iCur - iNode) == 2)` |
...
|    6813639 | 1391 | `				int bSpreadArg = 0;` |
|          - | 1392 | `				sxi32 iScan;` |
|    6813667 | 1393 | `				for( iScan = iNode ; iScan < iCur ; iScan++ ){` |
|    6813667 | 1394 | `					if( apNode[iScan] ){` |
|    6813639 | 1395 | `						bSpreadArg = (apNode[iScan]->iFlags & EXPR_NODE_SPREAD) != 0;` |
|    6813639 | 1396 | `						break;` |
|          - | 1397 | `					}` |
|         15 | 1398 | `				}` |
|    6813639 | 1399 | `				ExprMakeTree(&(*pGen),&apNode[iNode],iCur-iNode);` |
|    6813639 | 1400 | `				if( bSpreadArg && apNode[iNode] ){` |
|       4023 | 1401 | `					apNode[iNode]->iFlags \|= EXPR_NODE_SPREAD;` |
|       2009 | 1402 | `				}` |
|          - | 1403 | `			}` |
|    6813639 | 1404 | `			if( apNode[iNode] ){` |
|    6813639 | 1405 | `				if( sArgName.nByte > 0 ){` |
...
|    6813639 | 1410 | `				SySetPut(&pOp->aNodeArgs,(const void *)&apNode[iNode]);` |
|    3406822 | 1411 | `			}else{` |
...
|    6813639 | 1430 | `		if( iCur < nToken && apNode[iCur] && (apNode[iCur]->pStart->nType & PH7_TK_COMMA) ){` |
|    2044163 | 1431 | `			iCur++;` |
|    2044163 | 1432 | `			if( iCur >= nToken ){` |
|          - | 1433 | `				/* Trailing comma after last argument */` |
|         19 | 1434 | `				break;` |
|          - | 1435 | `			}` |
|    1022070 | 1436 | `		}` |
|          5 | 1437 | `	}` |
|    4769499 | 1438 | `	return SXRET_OK;` |
|    2384756 | 1439 | `}` |
|          - | 1440 | ` /*` |
...
|          - | 1444 | `  */` |
|   26229270 | 1445 | ` static sxi32 ExprMakeTree(ph7_gen_state *pGen,ph7_expr_node **apNode,sxi32 nToken)` |
|          5 | 1446 | ` {` |
...
|          - | 1450 | `	 sxi32 iCur;` |
|          - | 1451 | `	 sxi32 rc;` |
|   26229275 | 1452 | `	 if( nToken <= 0 \|\| (nToken == 1 && apNode[0]->xCode) ){` |
|          - | 1453 | `		 /* TICKET 1433-17: self evaluating node */` |
|   11763937 | 1454 | `		 return SXRET_OK;` |
|          - | 1455 | `	 }` |
|          - | 1456 | `	 /* Process expressions enclosed in parenthesis first */` |
|  103305795 | 1457 | `	 for( iCur =  0 ; iCur < nToken ; ++iCur ){` |
|          - | 1458 | `		 sxi32 iNest;` |
...
|          - | 1461 | `		  */` |
|   88840459 | 1462 | `		 if( apNode[iCur] == 0 \|\| apNode[iCur]->pStart->nType != PH7_TK_LPAREN ){` |
|   88398487 | 1463 | `			 continue;` |
|          - | 1464 | `		 }` |
|     441977 | 1465 | `		 iNest = 1;` |
...
|  106816089 | 1512 | `	 for( iCur =  0 ; iCur < nToken ; ++iCur ){` |
|          - | 1513 | `		 sxi32 iNest;` |
...
|          - | 1516 | `		  */` |
|   92680417 | 1517 | `		 if( apNode[iCur] == 0 \|\| apNode[iCur]->pStart->nType != PH7_TK_OCB ){` |
|   92676585 | 1518 | `			 continue;` |
|          - | 1519 | `		 }` |
|       3837 | 1520 | `		 iNest = 1;` |
...
|   14135677 | 1553 | `	 iLeft = -1;` |
|  106823715 | 1554 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|   92688055 | 1555 | `		 if( apNode[iCur] == 0 ){` |
|   40125257 | 1556 | `			 continue;` |
|          - | 1557 | `		 }` |
|   52562803 | 1558 | `		 pNode = apNode[iCur];` |
|   52562803 | 1559 | `		 if( pNode->pOp && pNode->pOp->iPrec == 2 && pNode->pLeft == 0  ){` |
|   14007055 | 1560 | `			 if( pNode->pOp->iOp == EXPR_OP_FUNC_CALL ){` |
|          - | 1561 | `				 /* Collect function arguments */` |
|    6179923 | 1562 | `				 sxi32 iPtr = 0;` |
|    6179923 | 1563 | `				 sxi32 nFuncTok = 0;` |
|   29501993 | 1564 | `				 while( nFuncTok + iCur < nToken ){` |
|   29501993 | 1565 | `					 if( apNode[nFuncTok+iCur] ){` |
|   29455927 | 1566 | `						 if( apNode[nFuncTok+iCur]->pStart->nType & PH7_TK_LPAREN /*'('*/ ){` |
|    6545887 | 1567 | `							 iPtr++;` |
|   26182986 | 1568 | `						 }else if ( apNode[nFuncTok+iCur]->pStart->nType & PH7_TK_RPAREN /*')'*/){` |
|    6545887 | 1569 | `							 iPtr--;` |
|    6545887 | 1570 | `							 if( iPtr <= 0 ){` |
|    6179923 | 1571 | `								 break;` |
|          - | 1572 | `							 }` |
|     182982 | 1573 | `						 }` |
|   11638002 | 1574 | `					 }` |
|   23322075 | 1575 | `					 nFuncTok++;` |
|          5 | 1576 | `				 }` |
|    6179923 | 1577 | `				 if( nFuncTok + iCur >= nToken ){` |
|          - | 1578 | `					 /* Syntax error */` |
...
|        ! 0 | 1583 | `					 return rc;` |
|          - | 1584 | `				 }` |
|    6179923 | 1585 | `				 if(  iLeft < 0 \|\| !NODE_ISTERM(iLeft) /*\|\| ( apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec != 2)*/ ){` |
|          - | 1586 | `					 /* Syntax error */` |
...
|        ! 0 | 1591 | `					 return rc;` |
|          - | 1592 | `				 }` |
|    6179923 | 1593 | `				 if( nFuncTok > 1 ){` |
|          - | 1594 | `					 /* Process function arguments */` |
|    4769507 | 1595 | `					 rc = ExprProcessFuncArguments(&(*pGen),pNode,&apNode[iCur+1],nFuncTok-1);` |
|    4769507 | 1596 | `					 if( rc != SXRET_OK ){` |
|         11 | 1597 | `						 return rc;` |
|          - | 1598 | `					 }` |
|    2384747 | 1599 | `				 }` |
|          - | 1600 | `				 /* Link the node to the tree */` |
|    6179915 | 1601 | `				 pNode->pLeft = apNode[iLeft];` |
|    6179915 | 1602 | `				 apNode[iLeft] = 0;` |
|   29501961 | 1603 | `				 for( iPtr = 1; iPtr <= nFuncTok ; iPtr++ ){` |
|   23322051 | 1604 | `					 apNode[iCur+iPtr] = 0;` |
|   11661028 | 1605 | `				 }` |
...
|          - | 1616 | `				 {` |
|    6179915 | 1617 | `					 sxi32 iNew = iLeft - 1;` |
|    8026289 | 1618 | `					 while( iNew >= 0 && apNode[iNew] == 0 ){` |
|    1846379 | 1619 | `						 iNew--;` |
|          5 | 1620 | `					 }` |
|    6179910 | 1621 | `					 if( iNew >= 0 && apNode[iNew]->pOp` |
|    3681767 | 1622 | `						 && apNode[iNew]->pOp->iOp == EXPR_OP_NEW` |
|    2210303 | 1623 | `						 && apNode[iNew]->pLeft == 0 ){` |
...
|     376119 | 1628 | `					 }` |
|          - | 1629 | `				 }` |
|   10917092 | 1630 | `			 }else if (pNode->pOp->iOp == EXPR_OP_SUBSCRIPT ){` |
|          - | 1631 | `				 /* Subscripting */` |
|    2875271 | 1632 | `				 sxi32 iArrTok = iCur + 1;` |
|    2875271 | 1633 | `				 sxi32 iNest = 1;` |
|    2875266 | 1634 | `				 if(  iLeft < 0 \|\| apNode[iLeft] == 0 \|\| (apNode[iLeft]->pOp == 0 && (apNode[iLeft]->xCode != PH7_CompileVariable &&` |
...
|    2875266 | 1638 | `					 ( apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec != 2 /* postfix */` |
...
|    6056215 | 1650 | `				 while( iArrTok < nToken ){` |
|    6056215 | 1651 | `					 if( apNode[iArrTok] ){` |
|    6056183 | 1652 | `						 if( apNode[iArrTok]->pOp && apNode[iArrTok]->pOp->iOp == EXPR_OP_SUBSCRIPT &&  apNode[iArrTok]->pLeft == 0){` |
|          - | 1653 | `							 /* Increment nesting level */` |
|      26773 | 1654 | `							 iNest++;` |
|    6042799 | 1655 | `						 }else if( apNode[iArrTok]->pStart->nType & PH7_TK_CSB /*']'*/){` |
|          - | 1656 | `							 /* Decrement nesting level */` |
|    2902039 | 1657 | `							 iNest--;` |
|    2902039 | 1658 | `							 if( iNest <= 0 ){` |
|    2875271 | 1659 | `								 break;` |
|          - | 1660 | `							 }` |
|      13384 | 1661 | `						 }` |
|    1590456 | 1662 | `					 }` |
...
|          5 | 1664 | `				 }` |
|    2875271 | 1665 | `				 if( iArrTok > iCur + 1 ){` |
...
|    2875271 | 1675 | `				 pNode->pLeft = apNode[iLeft];` |
|    2875271 | 1676 | `				 pNode->pRight = 0;` |
|    2875271 | 1677 | `				 apNode[iLeft] = 0;` |
|    8931481 | 1678 | `				 for( iNest = iCur + 1 ; iNest <= iArrTok ; ++iNest ){` |
|    6056215 | 1679 | `					 apNode[iNest] = 0;` |
|    3028110 | 1680 | `				 }` |
|    1437638 | 1681 | `			 }else{` |
...
|          - | 1715 | `			 }` |
|    7003519 | 1716 | `		 }` |
|   52562791 | 1717 | `		 iLeft = iCur;` |
|   26281398 | 1718 | `	 }` |
|          - | 1719 | `	 /* Handle left associative (new, clone) operators */` |
|  106823683 | 1720 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|   92688023 | 1721 | `		 if( apNode[iCur] == 0 ){` |
|   54942269 | 1722 | `			 continue;` |
|          - | 1723 | `		 }` |
|   37745759 | 1724 | `		 pNode = apNode[iCur];` |
|   37745759 | 1725 | `		 if( pNode->pOp && pNode->pOp->iPrec == 1 && pNode->pLeft == 0 ){` |
|          - | 1726 | `			 SyToken *pToken;` |
...
|   14135665 | 1806 | `	 iLeft = -1;` |
|  106988515 | 1807 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|   92688023 | 1808 | `		 if( apNode[iCur] == 0 ){` |
|   54942269 | 1809 | `			 continue;` |
|          - | 1810 | `		 }` |
|   37745759 | 1811 | `		 pNode = apNode[iCur];` |
|   37745759 | 1812 | `		 if( pNode->pOp && pNode->pOp->iPrec == 3 && pNode->pLeft == 0){` |
...
|      90100 | 1818 | `			 }` |
|     262596 | 1819 | `		  }` |
|   37910591 | 1820 | `		 iLeft = iCur;` |
|   19037714 | 1821 | `	  }` |
|   14300497 | 1822 | `	 iLeft = -1;` |
|  106988515 | 1823 | `	 for( iCur = nToken -  1 ; iCur >= 0 ; iCur-- ){` |
|   92688023 | 1824 | `		 if( apNode[iCur] == 0 ){` |
|   55122469 | 1825 | `			 continue;` |
|          - | 1826 | `		 }` |
|   37565559 | 1827 | `		 pNode = apNode[iCur];` |
|   37565559 | 1828 | `		 if( pNode->pOp && pNode->pOp->iPrec == 3 && pNode->pLeft == 0){` |
...
|   14300497 | 1854 | `	 iLeft = -1;` |
|  106988515 | 1855 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|   92688023 | 1856 | `		 if( apNode[iCur] == 0 ){` |
|   55214561 | 1857 | `			 continue;` |
|          - | 1858 | `		 }` |
|   37473467 | 1859 | `		 pNode = apNode[iCur];` |
|   37473467 | 1860 | `		 if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_INSTOF && pNode->pLeft == 0 ){` |
...
|      38382 | 1875 | `		 }` |
|   37473467 | 1876 | `		 iLeft = iCur;` |
|   18736736 | 1877 | `	 }` |
|          - | 1878 | `	 /* Handle right associative unary and cast operators [i.e: !,(string),~...]  with precedence 4*/` |
|   14300497 | 1879 | `	  iLeft = 0;` |
|  106988509 | 1880 | `	  for( iCur = nToken -  1 ; iCur >= 0 ; iCur-- ){` |
|   92688019 | 1881 | `		  if( apNode[iCur] ){` |
|   37396699 | 1882 | `			  pNode = apNode[iCur];` |
|   37396699 | 1883 | `			  if( pNode->pOp && pNode->pOp->iPrec == 4 && pNode->pLeft == 0){` |
...
|  106988507 | 1915 | `	 for( iCur = nToken - 1 ; iCur >= 0 ; --iCur ){` |
|   92688017 | 1916 | `		 if( apNode[iCur] == 0 ){` |
|   56429103 | 1917 | `			 continue;` |
|          - | 1918 | `		 }` |
|   36258919 | 1919 | `		 pNode = apNode[iCur];` |
|   36258919 | 1920 | `		 if( pNode->pOp && pNode->pOp->iPrec == 5 && pNode->pLeft == 0 ){` |
|          - | 1921 | `			 sxi32 iL, iR;` |
...
|  157305309 | 1983 | `	 for( i = 7 ; i < 17 ; i++ ){` |
|  143004829 | 1984 | `		 iLeft = -1;` |
| 1069884655 | 1985 | `		 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  926879841 | 1986 | `			 if( apNode[iCur] == 0 ){` |
|  628085711 | 1987 | `				 continue;` |
|          - | 1988 | `			 }` |
|  298794135 | 1989 | `			 pNode = apNode[iCur];` |
|  298794135 | 1990 | `			 if( pNode->pOp && pNode->pOp->iPrec == i && pNode->pLeft == 0 ){` |
...
|          - | 2056 | `	  */` |
|   14300485 | 2057 | `	  iLeft = -1;` |
|  103218769 | 2058 | `	  for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|   89376719 | 2059 | `		  if( apNode[iCur] == 0 ){` |
|   64986885 | 2060 | `			  continue;` |
|          - | 2061 | `		  }` |
|   24389839 | 2062 | `		  pNode = apNode[iCur];` |
|   24389839 | 2063 | `		  if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_QUESTY && pNode->pLeft == 0 ){` |
...
|          - | 2129 | `	  */` |
|   14300483 | 2130 | `	 iRight = -1;` |
|  106988311 | 2131 | `	 for( iCur = nToken -  1 ; iCur >= 0 ; iCur--){` |
|   92687887 | 2132 | `		 if( apNode[iCur] == 0 ){` |
|   73571909 | 2133 | `			 continue;` |
|          - | 2134 | `		 }` |
|   19115983 | 2135 | `		 pNode = apNode[iCur];` |
|   19115983 | 2136 | `		 if( pNode->pOp && pNode->pOp->iPrec == 18 && pNode->pLeft == 0 ){` |
|          - | 2137 | `			 /* Get the left node */` |
|    4815427 | 2138 | `			 iLeft = iCur - 1;` |
|    6588241 | 2139 | `			 while( iLeft >= 0 && apNode[iLeft] == 0 ){` |
|    1772819 | 2140 | `				 iLeft--;` |
|          5 | 2141 | `			 }` |
|    4815427 | 2142 | `			 if( iLeft < 0 \|\| iRight < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|          - | 2143 | `				 /* Syntax error */` |
...
|          - | 2160 | `			  * a write. */` |
|    4815385 | 2161 | `			 if( PH7_ExprContainsNullsafe(apNode[iLeft]) ){` |
...
|    4815377 | 2174 | `			 pSuppress = 0;` |
|    4815372 | 2175 | `			 if( apNode[iLeft]->pOp` |
|    3073902 | 2176 | `				 && apNode[iLeft]->pOp->iVmOp == PH7_OP_ERR_CTRL` |
|     666216 | 2177 | `				 && apNode[iLeft]->pLeft != 0` |
|          5 | 2178 | `				 && (apNode[iLeft]->iFlags & EXPR_NODE_PARENS) == 0 ){` |
|        ! 0 | 2179 | `				 pSuppress = apNode[iLeft];` |
|        ! 0 | 2180 | `				 apNode[iLeft] = pSuppress->pLeft;` |
|        ! 0 | 2181 | `			 }` |
|    4815377 | 2182 | `			 if( ExprIsModifiableValue(apNode[iLeft],FALSE) == FALSE ){` |
...
|    4815365 | 2225 | `			 pNode->pLeft = apNode[iRight];` |
|    4815365 | 2226 | `			 pNode->pRight = apNode[iLeft];` |
|    4815365 | 2227 | `			 apNode[iLeft] = apNode[iRight] = 0;` |
|    4815365 | 2228 | `			 if( pSuppress ){` |
|          - | 2229 | `				 /* Re-wrap: the '@' now suppresses the whole assignment */` |
|        ! 0 | 2230 | `				 pSuppress->pLeft = pNode;` |
|        ! 0 | 2231 | `				 apNode[iCur] = pSuppress;` |
|        ! 0 | 2232 | `			 }` |
|    2407680 | 2233 | `		 }` |
|   19115921 | 2234 | `		 iRight = iCur;` |
|    9557963 | 2235 | `	 }` |
|          - | 2236 | `	 /* Process left associative binary operators that have the lowest precedence [i.e: and,or,xor] */` |
|   71502125 | 2237 | `	 for( i = 19 ; i < 23 ; i++ ){` |
|   57201701 | 2238 | `		 iLeft = -1;` |
|  427952957 | 2239 | `		 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  370751261 | 2240 | `			 if( apNode[iCur] == 0 ){` |
|  313549313 | 2241 | `				 continue;` |
|          - | 2242 | `			 }` |
|   57201953 | 2243 | `			 pNode = apNode[iCur];` |
|   57201953 | 2244 | `			 if( pNode->pOp && pNode->pOp->iPrec == i && pNode->pLeft == 0 ){` |
...
|         24 | 2262 | `			 }` |
|   57201953 | 2263 | `			 iLeft = iCur;` |
|   28600979 | 2264 | `		 }` |
|   28600853 | 2265 | `	 }` |
|          - | 2266 | `	 /* Point to the root of the expression tree */` |
|   92687791 | 2267 | `	 for( iCur = 1 ; iCur < nToken ; ++iCur ){` |
|   78387385 | 2268 | `		 if( apNode[iCur] ){` |
|   13694799 | 2269 | `			 if( (apNode[iCur]->pOp \|\| apNode[iCur]->xCode ) && apNode[0] != 0){` |
...
|         23 | 2274 | `				  return rc;` |
|          - | 2275 | `			 }` |
|   13694781 | 2276 | `			 apNode[0] = apNode[iCur];` |
|   13694781 | 2277 | `			 apNode[iCur] = 0;` |
|    6847388 | 2278 | `		 }` |
|   39193686 | 2279 | `	 }` |
|   14300411 | 2280 | `	 return SXRET_OK;` |
|   13032224 | 2281 | ` }` |
|          - | 2282 | ` /*` |
...
|          - | 2287 | `  */` |
|   15239062 | 2288 | `PH7_PRIVATE sxi32 PH7_ExprMakeTree(ph7_gen_state *pGen,SySet *pExprNode,ph7_expr_node **ppRoot)` |
|          5 | 2289 | `{` |
|          - | 2290 | `	ph7_expr_node **apNode;` |
|          - | 2291 | `	ph7_expr_node *pNode;` |
|          - | 2292 | `	sxi32 rc;` |
|          - | 2293 | `	/* Reset node container */` |
|   15239067 | 2294 | `	SySetReset(pExprNode);` |
|   15239067 | 2295 | `	pNode = 0; /* Prevent compiler warning */` |
|          - | 2296 | `	/* Extract nodes one after one until we hit the end of the input */` |
|          - | 2297 | `	{` |
|   15239067 | 2298 | `		int iLastWasTerm = 0;` |
|   15239067 | 2299 | `		int bAfterMemberOp = 0; /* TRUE iff the previous node was -> / ?-> / :: */` |
|   95150661 | 2300 | `		while( pGen->pIn < pGen->pEnd ){` |
|   79911633 | 2301 | `			rc = ExprExtractNode(&(*pGen),&pNode,iLastWasTerm,bAfterMemberOp);` |
|   79911633 | 2302 | `			if( rc != SXRET_OK ){` |
|         38 | 2303 | `				return rc;` |
|          - | 2304 | `			}` |
|          - | 2305 | `			/* Determine if this node is a term for short-array disambiguation */` |
|   79911599 | 2306 | `			if( pNode->xCode ){` |
|          - | 2307 | `				/* Node with compile handler: variable, literal, string, array, etc. */` |
|   40712011 | 2308 | `				iLastWasTerm = 1;` |
|   59555596 | 2309 | `			}else if( pNode->pOp ){` |
|          - | 2310 | `				/* Operator node */` |
|   22614091 | 2311 | `				iLastWasTerm = 0;` |
|   11307048 | 2312 | `			}else{` |
|          - | 2313 | `				/* Delimiter: ')' and ']' end terms */` |
|   16585507 | 2314 | `				iLastWasTerm = (pNode->pStart->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB)) ? 1 : 0;` |
|          - | 2315 | `			}` |
...
|   79911599 | 2319 | `			bAfterMemberOp = ( pNode->pOp && pNode->pOp->iVmOp == PH7_OP_MEMBER );` |
|          - | 2320 | `			/* Save the extracted node */` |
|   79911599 | 2321 | `			SySetPut(pExprNode,(const void *)&pNode);` |
|          5 | 2322 | `		}` |
|          - | 2323 | `	}` |
|   15239033 | 2324 | `	if( SySetUsed(pExprNode) < 1 ){` |
|          - | 2325 | `		/* Empty expression [i.e: A semi-colon;] */` |
|        ! 0 | 2326 | `		*ppRoot = 0;` |
|        ! 0 | 2327 | `		return SXRET_OK;` |
|          - | 2328 | `	}` |
|   15239033 | 2329 | `	apNode = (ph7_expr_node **)SySetBasePtr(pExprNode);` |
|          - | 2330 | `	/* Make sure we are dealing with valid nodes */` |
|   15239033 | 2331 | `	rc = ExprVerifyNodes(&(*pGen),apNode,(sxi32)SySetUsed(pExprNode));` |
|   15239033 | 2332 | `	if( rc != SXRET_OK ){` |
...
|          - | 2338 | `	}` |
|          - | 2339 | `	/* Build the tree */` |
|   15238981 | 2340 | `	rc = ExprMakeTree(&(*pGen),apNode,(sxi32)SySetUsed(pExprNode));` |
|   15238981 | 2341 | `	if( rc != SXRET_OK ){` |
|          - | 2342 | `		/* Something goes wrong [i.e: Syntax error] */` |
|        103 | 2343 | `		*ppRoot = 0;` |
|        103 | 2344 | `		return rc;` |
|          - | 2345 | `	}` |
|          - | 2346 | `	/* Point to the root of the tree */` |
|   15238883 | 2347 | `	*ppRoot = apNode[0];` |
|   15238883 | 2348 | `	return SXRET_OK;` |
|    7619536 | 2349 | `}` |
|          - | 2350 |  |
