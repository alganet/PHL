...
|          - |  272 | ` */` |
|   29126276 |  273 | `PH7_PRIVATE const ph7_expr_op *  PH7_ExprExtractOperator(SyString *pStr,SyToken *pLast)` |
|          5 |  274 | `{` |
|   29126281 |  275 | `	sxu32 n = 0;` |
|          - |  276 | `	sxi32 rc;` |
|          - |  277 | `	/* Do a linear lookup on the operators table */` |
|  459551525 |  278 | `	for(;;){` |
|  919103055 |  279 | `		if( n >= SX_ARRAYSIZE(aOpTable) ){` |
|        ! 0 |  280 | `			break;` |
|          - |  281 | `		}` |
|  919103055 |  282 | `		if( SyisAlpha(aOpTable[n].sOp.zString[0]) ){` |
|          - |  283 | `			/* TICKET 1433-012: Alpha stream operators [i.e: and,or,xor,new...] */` |
|   87844107 |  284 | `			rc = SyStringCmp(pStr,&aOpTable[n].sOp,SyStrnicmp);` |
|   43922056 |  285 | `		}else{` |
|  831258953 |  286 | `			rc = SyStringCmp(pStr,&aOpTable[n].sOp,SyMemcmp);` |
|          - |  287 | `		}` |
|  919103055 |  288 | `		if( rc == 0 ){` |
|   29460569 |  289 | `			if( aOpTable[n].sOp.nByte != sizeof(char) \|\| (aOpTable[n].iOp != EXPR_OP_UMINUS && aOpTable[n].iOp != EXPR_OP_UPLUS) \|\| pLast == 0 ){` |
|          - |  290 | `				/* There is no ambiguity here,simply return the first operator seen */` |
|   29005491 |  291 | `				return &aOpTable[n];` |
|          - |  292 | `			}` |
...
|          4 |  306 | `			}` |
|     167144 |  307 | `		}` |
|  889976779 |  308 | `		++n; /* Next operator in the table */` |
|          5 |  309 | `	}` |
...
|          - |  317 | ` */` |
|    7919098 |  318 | `PH7_PRIVATE void PH7_DelimitNestedTokens(SyToken *pIn,SyToken *pEnd,sxu32 nTokStart,sxu32 nTokEnd,SyToken **ppEnd)` |
|          5 |  319 | `{` |
|    7919103 |  320 | `	SyToken *pCur = pIn;` |
|    7919103 |  321 | `	sxi32 iNest = 1;` |
|   84931024 |  322 | `	for(;;){` |
|  169862053 |  323 | `		if( pCur >= pEnd ){` |
|      16023 |  324 | `			break;` |
|          - |  325 | `		}` |
|  169846035 |  326 | `		if( pCur->nType & nTokStart ){` |
|          - |  327 | `			/* Increment nesting level */` |
|    6547149 |  328 | `			iNest++;` |
|  166572463 |  329 | `		}else if( pCur->nType & nTokEnd ){` |
...
|          - |  373 | ` */` |
|   17084740 |  374 | `static sxi32 ExprVerifyNodes(ph7_gen_state *pGen,ph7_expr_node **apNode,sxi32 nNode)` |
|          5 |  375 | `{` |
|          - |  376 | `	sxi32 iParen,iSquare,iQuesty,iBraces;` |
|          - |  377 | `	sxi32 i,rc;` |
|          - |  378 |  |
|   17084745 |  379 | `	if( nNode > 0 && apNode[0]->pOp && (apNode[0]->pOp->iOp == EXPR_OP_ADD \|\| apNode[0]->pOp->iOp == EXPR_OP_SUB) ){` |
...
|       3893 |  383 | `	}` |
|   17084745 |  384 | `	iParen = iSquare = iQuesty = iBraces = 0;` |
|  107094403 |  385 | `	for( i = 0 ; i < nNode ; ++i ){` |
|   90009699 |  386 | `		if( apNode[i]->xCode == PH7_CompileShortArray \|\| apNode[i]->xCode == PH7_CompileShortList ){` |
|          - |  387 | `			/* Short array/list literal: brackets are self-contained, skip */` |
|     242859 |  388 | `			continue;` |
|          - |  389 | `		}` |
|   89766845 |  390 | `		if( apNode[i]->pStart->nType & PH7_TK_LPAREN /*'('*/){` |
|    7541231 |  391 | `			if( i > 0 && ( apNode[i-1]->xCode == PH7_CompileVariable \|\| apNode[i-1]->xCode == PH7_CompileLiteral \|\|` |
...
|    7050685 |  394 | `					if( (apNode[i - 1]->pStart->nType & PH7_TK_OP) == 0 ){` |
|          - |  395 | `						/* We are dealing with a postfix [i.e: function call]  operator` |
|          - |  396 | `						 * not a simple left parenthesis. Mark the node.` |
|          - |  397 | `						 */` |
|    7050685 |  398 | `						apNode[i]->pStart->nType \|= PH7_TK_OP;` |
|    7050685 |  399 | `						apNode[i]->pStart->pUserData = (void *)&sFCallOp; /* Function call operator */` |
|    7050685 |  400 | `						apNode[i]->pOp = &sFCallOp;` |
|    3525340 |  401 | `					}` |
|    3525340 |  402 | `			}` |
|    7541231 |  403 | `			iParen++;` |
|   85996232 |  404 | `		}else if( apNode[i]->pStart->nType & PH7_TK_RPAREN/*')*/){` |
|    7541233 |  405 | `			if( iParen <= 0 ){` |
...
|          - |  411 | `			}` |
|    7541221 |  412 | `			iParen--;` |
|   78454999 |  413 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OSB /*'['*/){` |
|    3022867 |  414 | `			iSquare++;` |
|   73172960 |  415 | `		}else if (apNode[i]->pStart->nType & PH7_TK_CSB /*']'*/){` |
...
|          - |  422 | `			}` |
|    3022865 |  423 | `			iSquare--;` |
|   70150093 |  424 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OCB /*'{'*/){` |
|       3891 |  425 | `			iBraces++;` |
...
|          3 |  434 | `				return rc;` |
|          5 |  435 | `			}` |
|   68636719 |  436 | `		}else if (apNode[i]->pStart->nType & PH7_TK_CCB /*'}'*/){` |
...
|          - |  443 | `			}` |
|       3889 |  444 | `			iBraces--;` |
|   68632823 |  445 | `		}else if ( apNode[i]->pStart->nType & PH7_TK_COLON ){` |
...
|          6 |  456 | `				return rc;` |
|          5 |  457 | `			}` |
|   68379097 |  458 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OP ){` |
|   22502383 |  459 | `			const ph7_expr_op *pOp = (const ph7_expr_op *)apNode[i]->pOp;` |
|   22502383 |  460 | `			if( pOp->iOp == EXPR_OP_QUESTY ){` |
|     503269 |  461 | `				iQuesty++;` |
|   22250751 |  462 | `			}else if( i > 0 && (pOp->iOp == EXPR_OP_UMINUS \|\| pOp->iOp == EXPR_OP_UPLUS)){` |
...
|   11251189 |  482 | `		}` |
|   44883407 |  483 | `	}` |
|   17084709 |  484 | `	if( iParen != 0 \|\| iSquare != 0 \|\| iQuesty != 0 \|\| iBraces != 0){` |
...
|         16 |  489 | `		return rc;` |
|          - |  490 | `	}` |
|   17084695 |  491 | `	return SXRET_OK;` |
|    8542375 |  492 | `}` |
|          - |  493 | `/*` |
|          - |  494 | ` * Collect and assemble tokens holding a namespace path [i.e: namespace\to\const]` |
|          - |  495 | ` * or a simple literal [i.e: PHP_EOL].` |
|          - |  496 | ` */` |
|   14087936 |  497 | `static void ExprAssembleLiteral(SyToken **ppCur,SyToken *pEnd)` |
|          5 |  498 | `{` |
|   14087941 |  499 | `	SyToken *pIn = *ppCur;` |
|          - |  500 | `	/* Jump the first literal seen */` |
|   14087941 |  501 | `	if( (pIn->nType & PH7_TK_NSSEP) == 0 ){` |
|   14083995 |  502 | `		pIn++;` |
|    7041995 |  503 | `	}` |
|    7045982 |  504 | `	for(;;){` |
|   14091969 |  505 | `		if(pIn < pEnd && (pIn->nType & PH7_TK_NSSEP) ){` |
|       4033 |  506 | `			pIn++;` |
...
|          - |  866 | ` */` |
|   90013988 |  867 | `static sxi32 ExprExtractNode(ph7_gen_state *pGen,ph7_expr_node **ppNode,int iLastWasTerm,int bAfterMemberOp)` |
|          5 |  868 | `{` |
|          - |  869 | `	ph7_expr_node *pNode;` |
|          - |  870 | `	SyToken *pCur;` |
|          - |  871 | `	sxi32 rc;` |
|          - |  872 | `	/* Allocate a new node */` |
|   90013993 |  873 | `	pNode = (ph7_expr_node *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_expr_node));` |
|   90013993 |  874 | `	if( pNode == 0 ){` |
...
|   90013993 |  881 | `	SyZero(pNode,sizeof(ph7_expr_node));` |
|   90013993 |  882 | `	SySetInit(&pNode->aNodeArgs,&pGen->pVm->sAllocator,sizeof(ph7_expr_node **));` |
|          - |  883 | `	/* Point to the head of the token stream */` |
|   90013993 |  884 | `	pCur = pNode->pStart = pGen->pIn;` |
|          - |  885 | `	/* Start collecting tokens */` |
|   90013993 |  886 | `	if( pCur->nType & PH7_TK_ELLIPSIS ){` |
...
|       4147 |  909 | `		return rc;` |
|          - |  910 | `	}` |
|   90009771 |  911 | `	if( (pCur->nType & PH7_TK_OSB) && !iLastWasTerm ){` |
...
|          5 |  940 | `		}` |
|   89888343 |  941 | `	}else if( bAfterMemberOp && (pCur->nType & PH7_TK_OP) && (pCur->nType & PH7_TK_ID) ){` |
...
|   89766902 |  952 | `	}else if( (pCur->nType & PH7_TK_OP) && pCur->pUserData` |
|   25525296 |  953 | `		&& ((const ph7_expr_op *)pCur->pUserData)->iOp == EXPR_OP_CLONE` |
|   12791757 |  954 | `		&& &pCur[1] < pGen->pEnd && (pCur[1].nType & PH7_TK_LPAREN) ){` |
...
|   89766886 |  980 | `	}else if( pCur->nType & PH7_TK_OP ){` |
|          - |  981 | `		/* Point to the instance that describe this operator */` |
|   25525279 |  982 | `		pNode->pOp = (const ph7_expr_op *)pCur->pUserData;` |
|          - |  983 | `		/* Advance the stream cursor */` |
|   25525279 |  984 | `		pCur++;` |
|   77004238 |  985 | `	}else if( pCur->nType & PH7_TK_DOLLAR ){` |
|          - |  986 | `		/* Isolate variable */` |
|   43178581 |  987 | `		while( pCur < pGen->pEnd && (pCur->nType & PH7_TK_DOLLAR) ){` |
|   21589299 |  988 | `			pCur++; /* Variable variable */` |
|          5 |  989 | `		}` |
|   21589287 |  990 | `		if( pCur < pGen->pEnd ){` |
|   21589287 |  991 | `			if (pCur->nType & (PH7_TK_ID\|PH7_TK_KEYWORD) ){` |
|          - |  992 | `				/* Variable name */` |
|   21589261 |  993 | `				pCur++;` |
|   10794659 |  994 | `			}else if( pCur->nType & PH7_TK_OCB /* '{' */ ){` |
|         22 |  995 | `				pCur++;` |
...
|          8 | 1008 | `			}` |
|   10794640 | 1009 | `		}` |
|   21589285 | 1010 | `		pNode->xCode = PH7_CompileVariable;` |
|   53446959 | 1011 | `	 }else if( pCur->nType & PH7_TK_KEYWORD ){` |
...
|          5 | 1136 | `		 }` |
|   42124767 | 1137 | `	 }else if( pCur->nType & (PH7_TK_NSSEP\|PH7_TK_ID) ){` |
|          - | 1138 | `		 /* Constants,function name,namespace path,class name... */` |
|   13478323 | 1139 | `		 if( bAfterMemberOp ){` |
...
|    2808242 | 1145 | `		 }` |
|   13478323 | 1146 | `		 ExprAssembleLiteral(&pCur,pGen->pEnd);` |
|   13478323 | 1147 | `		 pNode->xCode = PH7_CompileLiteral;` |
|    6739164 | 1148 | `	 }else{` |
|   28118925 | 1149 | `		 if( (pCur->nType & (PH7_TK_LPAREN\|PH7_TK_RPAREN\|PH7_TK_COMMA\|PH7_TK_COLON\|PH7_TK_CSB\|PH7_TK_OCB\|PH7_TK_CCB)) == 0 ){` |
|          - | 1150 | `			 /* Point to the code generator routine */` |
|    9502235 | 1151 | `			 pNode->xCode = PH7_GetNodeHandler(pCur->nType);` |
|    9502235 | 1152 | `			 if( pNode->xCode == 0 ){` |
...
|   90009739 | 1165 | `	pNode->pEnd = pCur;` |
|          - | 1166 | `	/* Save the node for later processing */` |
|   90009739 | 1167 | `	*ppNode = pNode;` |
|          - | 1168 | `	/* Synchronize cursors */` |
|   90009739 | 1169 | `	pGen->pIn = pCur;` |
|   90009739 | 1170 | `	return SXRET_OK;` |
|   45006999 | 1171 | `}` |
|          - | 1172 | `/*` |
...
|          - | 1175 | ` * level is zero.` |
|          - | 1176 | ` */` |
|    1935408 | 1177 | `PH7_PRIVATE sxi32 PH7_GetNextExpr(SyToken *pStart,SyToken *pEnd,SyToken **ppNext)` |
|          5 | 1178 | `{` |
|    1935413 | 1179 | `	SyToken *pCur = pStart;` |
|    1935413 | 1180 | `	sxi32 iNest = 0;` |
|    1935413 | 1181 | `	if( pCur >= pEnd \|\| (pCur->nType & PH7_TK_SEMI/*';'*/) ){` |
|          - | 1182 | `		/* Last expression */` |
|     714865 | 1183 | `		return SXERR_EOF;` |
|          - | 1184 | `	}` |
|    4631919 | 1185 | `	while( pCur < pEnd ){` |
|    4330667 | 1186 | `		if( (pCur->nType & (PH7_TK_COMMA/*','*/\|PH7_TK_SEMI/*';'*/)) && iNest <= 0){` |
|     919301 | 1187 | `			break;` |
|          - | 1188 | `		}` |
|    3411371 | 1189 | `		if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|     241037 | 1190 | `			iNest++;` |
|    3290855 | 1191 | `		}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}*/) ){` |
|     241041 | 1192 | `			iNest--;` |
|     120518 | 1193 | `		}` |
|    3411371 | 1194 | `		pCur++;` |
|          5 | 1195 | `	}` |
|    1220553 | 1196 | `	*ppNext = pCur;` |
|    1220553 | 1197 | `	return SXRET_OK;` |
|     967709 | 1198 | `}` |
|          - | 1199 | `/*` |
|          - | 1200 | ` * Free an expression tree.` |
|          - | 1201 | ` */` |
|   76931164 | 1202 | `static void ExprFreeTree(ph7_gen_state *pGen,ph7_expr_node *pNode)` |
|          5 | 1203 | `{` |
|   76931169 | 1204 | `	if( pNode->pLeft ){` |
|          - | 1205 | `		/* Release the left tree */` |
|   30069995 | 1206 | `		ExprFreeTree(&(*pGen),pNode->pLeft);` |
|   15034995 | 1207 | `	}` |
|   76931169 | 1208 | `	if( pNode->pRight ){` |
|          - | 1209 | `		/* Release the right tree */` |
|   17490917 | 1210 | `		ExprFreeTree(&(*pGen),pNode->pRight);` |
|    8745456 | 1211 | `	}` |
|   76931169 | 1212 | `	if( pNode->pCond ){` |
|          - | 1213 | `		/* Release the conditional tree used by the ternary operator */` |
|     503265 | 1214 | `		ExprFreeTree(&(*pGen),pNode->pCond);` |
|     251630 | 1215 | `	}` |
|   76931169 | 1216 | `	if( SySetUsed(&pNode->aNodeArgs) > 0 ){` |
|          - | 1217 | `		ph7_expr_node **apArg;` |
|          - | 1218 | `		sxu32 n;` |
|          - | 1219 | `		/* Release node arguments */` |
|    8290645 | 1220 | `		apArg = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|   19083107 | 1221 | `		for( n = 0 ; n < SySetUsed(&pNode->aNodeArgs) ; ++n ){` |
|   10792467 | 1222 | `			ExprFreeTree(&(*pGen),apArg[n]);` |
|    5396236 | 1223 | `		}` |
|    8290645 | 1224 | `		SySetRelease(&pNode->aNodeArgs);` |
|    4145320 | 1225 | `	}` |
|          - | 1226 | `	/* Finally,release this node */` |
|   76931169 | 1227 | `	SyMemBackendPoolFree(&pGen->pVm->sAllocator,pNode);` |
|   76931169 | 1228 | `}` |
|          - | 1229 | `/*` |
|          - | 1230 | ` * Free an expression tree.` |
|          - | 1231 | ` * This function is a wrapper around ExprFreeTree() defined above.` |
|          - | 1232 | ` */` |
|   17084768 | 1233 | `PH7_PRIVATE sxi32 PH7_ExprFreeTree(ph7_gen_state *pGen,SySet *pNodeSet)` |
|          5 | 1234 | `{` |
|          - | 1235 | `	ph7_expr_node **apNode;` |
|          - | 1236 | `	sxu32 n;` |
|   17084773 | 1237 | `	apNode = (ph7_expr_node **)SySetBasePtr(pNodeSet);` |
|  107094557 | 1238 | `	for( n = 0  ; n < SySetUsed(pNodeSet) ; ++n ){` |
|   90009789 | 1239 | `		if( apNode[n] ){` |
|   17085109 | 1240 | `			ExprFreeTree(&(*pGen),apNode[n]);` |
|    8542552 | 1241 | `		}` |
|   45004897 | 1242 | `	}` |
|   17084773 | 1243 | `	return SXRET_OK;` |
|          5 | 1244 | `}` |
|          - | 1245 | `/*` |
...
|          - | 1251 | ` */` |
|   21279660 | 1252 | `PH7_PRIVATE int PH7_ExprContainsNullsafe(ph7_expr_node *pNode)` |
|          5 | 1253 | `{` |
|   21279665 | 1254 | `	if( pNode == 0 ){` |
|   13256513 | 1255 | `		return 0;` |
|          - | 1256 | `	}` |
|    8023157 | 1257 | `	if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW ){` |
|         16 | 1258 | `		return 1;` |
|          - | 1259 | `	}` |
|    8023145 | 1260 | `	if( PH7_ExprContainsNullsafe(pNode->pLeft) ){` |
|          6 | 1261 | `		return 1;` |
|          - | 1262 | `	}` |
|    8023141 | 1263 | `	if( PH7_ExprContainsNullsafe(pNode->pRight) ){` |
|        ! 0 | 1264 | `		return 1;` |
|          - | 1265 | `	}` |
|    8023141 | 1266 | `	return 0;` |
|   10639835 | 1267 | `}` |
|          - | 1268 | `/*` |
|          - | 1269 | ` * Check if the given node is a modifialbe l/r-value.` |
|          - | 1270 | ` * Return TRUE if modifiable.FALSE otherwise.` |
|          - | 1271 | ` */` |
|    5210054 | 1272 | `static int ExprIsModifiableValue(ph7_expr_node *pNode,sxu8 bFunc)` |
|          5 | 1273 | `{` |
|          - | 1274 | `	sxi32 iExprOp;` |
|    5210059 | 1275 | `	if( pNode->pOp == 0 ){` |
|    3716069 | 1276 | `		return pNode->xCode == PH7_CompileVariable ? TRUE : FALSE;` |
|          - | 1277 | `	}` |
...
|          - | 1309 | ` */` |
|    5504660 | 1310 | `static sxi32 ExprProcessFuncArguments(ph7_gen_state *pGen,ph7_expr_node *pOp,ph7_expr_node **apNode,sxi32 nToken)` |
|          5 | 1311 | `{` |
...
|    5504665 | 1315 | `	iCur = 0;` |
|    6755558 | 1316 | `	for(;;){` |
|   13511121 | 1317 | `		if( iCur >= nToken ){` |
|          - | 1318 | `			/* No more arguments to process */` |
|    5504637 | 1319 | `			break;` |
|          - | 1320 | `		}` |
|    8006489 | 1321 | `		iNode = iCur;` |
|    8006489 | 1322 | `		iNest = 0;` |
|   26229953 | 1323 | `		while( iCur < nToken ){` |
|   20725319 | 1324 | `			if( apNode[iCur] ){` |
|   20678521 | 1325 | `				if( (apNode[iCur]->pStart->nType & PH7_TK_COMMA) && apNode[iCur]->pLeft == 0 && iNest <= 0 ){` |
|    1250930 | 1326 | `					break;` |
|   18176666 | 1327 | `				}else if( (apNode[iCur]->pStart->nType & (PH7_TK_LPAREN\|PH7_TK_OSB\|PH7_TK_OCB))` |
|    9732264 | 1328 | `					&& apNode[iCur]->pLeft == 0` |
...
|    1282705 | 1341 | `					iNest++;` |
|   17535321 | 1342 | `				}else if( (apNode[iCur]->pStart->nType & (PH7_TK_RPAREN\|PH7_TK_CCB\|PH7_TK_CSB))` |
|    9088338 | 1343 | `					&& apNode[iCur]->pLeft == 0 ){` |
|    1282705 | 1344 | `					iNest--;` |
|     641350 | 1345 | `				}` |
|    9088333 | 1346 | `			}` |
|   18223469 | 1347 | `			iCur++;` |
|          5 | 1348 | `		}` |
|    8006489 | 1349 | `		if( iCur > iNode ){` |
|    8006483 | 1350 | `			SyString sArgName = {0, 0};` |
...
|    8006478 | 1354 | `			if( (iCur - iNode) >= 2` |
|    5569834 | 1355 | `				&& apNode[iNode]` |
...
|          - | 1378 | `				}` |
|        148 | 1379 | `			}` |
|    8006476 | 1380 | `			if( apNode[iNode] && (apNode[iNode]->pStart->nType & PH7_TK_AMPER /*'&'*/) && ((iCur - iNode) == 2)` |
...
|    8006481 | 1397 | `				int bSpreadArg = 0;` |
|          - | 1398 | `				sxi32 iScan;` |
|    8006523 | 1399 | `				for( iScan = iNode ; iScan < iCur ; iScan++ ){` |
|    8006523 | 1400 | `					if( apNode[iScan] ){` |
|    8006481 | 1401 | `						bSpreadArg = (apNode[iScan]->iFlags & EXPR_NODE_SPREAD) != 0;` |
|    8006481 | 1402 | `						break;` |
|          - | 1403 | `					}` |
|         23 | 1404 | `				}` |
|    8006481 | 1405 | `				ExprMakeTree(&(*pGen),&apNode[iNode],iCur-iNode);` |
|    8006481 | 1406 | `				if( bSpreadArg && apNode[iNode] ){` |
|       4077 | 1407 | `					apNode[iNode]->iFlags \|= EXPR_NODE_SPREAD;` |
|       2036 | 1408 | `				}` |
|          - | 1409 | `			}` |
|    8006481 | 1410 | `			if( apNode[iNode] ){` |
|    8006481 | 1411 | `				if( sArgName.nByte > 0 ){` |
...
|    8006481 | 1416 | `				SySetPut(&pOp->aNodeArgs,(const void *)&apNode[iNode]);` |
|    4003243 | 1417 | `			}else{` |
...
|    8006481 | 1436 | `		if( iCur < nToken && apNode[iCur] && (apNode[iCur]->pStart->nType & PH7_TK_COMMA) ){` |
|    2501849 | 1437 | `			iCur++;` |
|    2501849 | 1438 | `			if( iCur >= nToken ){` |
|          - | 1439 | `				/* Trailing comma after last argument */` |
|         21 | 1440 | `				break;` |
|          - | 1441 | `			}` |
|    1250912 | 1442 | `		}` |
|          5 | 1443 | `	}` |
|    5504657 | 1444 | `	return SXRET_OK;` |
|    2752335 | 1445 | `}` |
|          - | 1446 | ` /*` |
...
|          - | 1450 | `  */` |
|   29545038 | 1451 | ` static sxi32 ExprMakeTree(ph7_gen_state *pGen,ph7_expr_node **apNode,sxi32 nToken)` |
|          5 | 1452 | ` {` |
...
|          - | 1456 | `	 sxi32 iCur;` |
|          - | 1457 | `	 sxi32 rc;` |
|   29545043 | 1458 | `	 if( nToken <= 0 \|\| (nToken == 1 && apNode[0]->xCode) ){` |
|          - | 1459 | `		 /* TICKET 1433-17: self evaluating node */` |
|   12976405 | 1460 | `		 return SXRET_OK;` |
|          - | 1461 | `	 }` |
|          - | 1462 | `	 /* Process expressions enclosed in parenthesis first */` |
|  117813907 | 1463 | `	 for( iCur =  0 ; iCur < nToken ; ++iCur ){` |
|          - | 1464 | `		 sxi32 iNest;` |
...
|          - | 1467 | `		  */` |
|  101245271 | 1468 | `		 if( apNode[iCur] == 0 \|\| apNode[iCur]->pStart->nType != PH7_TK_LPAREN ){` |
|  100754733 | 1469 | `			 continue;` |
|          - | 1470 | `		 }` |
|     490543 | 1471 | `		 iNest = 1;` |
...
|  121836507 | 1518 | `	 for( iCur =  0 ; iCur < nToken ; ++iCur ){` |
|          - | 1519 | `		 sxi32 iNest;` |
...
|          - | 1522 | `		  */` |
|  105609655 | 1523 | `		 if( apNode[iCur] == 0 \|\| apNode[iCur]->pStart->nType != PH7_TK_OCB ){` |
|  105605771 | 1524 | `			 continue;` |
|          - | 1525 | `		 }` |
|       3889 | 1526 | `		 iNest = 1;` |
...
|   16226857 | 1559 | `	 iLeft = -1;` |
|  121844237 | 1560 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  105617397 | 1561 | `		 if( apNode[iCur] == 0 ){` |
|   46637127 | 1562 | `			 continue;` |
|          - | 1563 | `		 }` |
|   58980275 | 1564 | `		 pNode = apNode[iCur];` |
|   58980275 | 1565 | `		 if( pNode->pOp && pNode->pOp->iPrec == 2 && pNode->pLeft == 0  ){` |
|   16058625 | 1566 | `			 if( pNode->pOp->iOp == EXPR_OP_FUNC_CALL ){` |
|          - | 1567 | `				 /* Collect function arguments */` |
|    7050681 | 1568 | `				 sxi32 iPtr = 0;` |
|    7050681 | 1569 | `				 sxi32 nFuncTok = 0;` |
|   34826673 | 1570 | `				 while( nFuncTok + iCur < nToken ){` |
|   34826673 | 1571 | `					 ph7_expr_node *pTok = apNode[nFuncTok+iCur];` |
...
|   34826673 | 1578 | `					 if( pTok && pTok->pLeft == 0 ){` |
|   34768201 | 1579 | `						 if( pTok->pStart->nType & PH7_TK_LPAREN /*'('*/ ){` |
|    7511067 | 1580 | `							 iPtr++;` |
|   31012670 | 1581 | `						 }else if ( pTok->pStart->nType & PH7_TK_RPAREN /*')'*/){` |
|    7511067 | 1582 | `							 iPtr--;` |
|    7511067 | 1583 | `							 if( iPtr <= 0 ){` |
|    7050681 | 1584 | `								 break;` |
|          - | 1585 | `							 }` |
|     230193 | 1586 | `						 }` |
|   13858760 | 1587 | `					 }` |
|   27775997 | 1588 | `					 nFuncTok++;` |
|          5 | 1589 | `				 }` |
|    7050681 | 1590 | `				 if( nFuncTok + iCur >= nToken ){` |
|          - | 1591 | `					 /* Syntax error */` |
...
|        ! 0 | 1596 | `					 return rc;` |
|          - | 1597 | `				 }` |
|    7050681 | 1598 | `				 if(  iLeft < 0 \|\| !NODE_ISTERM(iLeft) /*\|\| ( apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec != 2)*/ ){` |
|          - | 1599 | `					 /* Syntax error */` |
...
|        ! 0 | 1604 | `					 return rc;` |
|          - | 1605 | `				 }` |
|    7050681 | 1606 | `				 if( nFuncTok > 1 ){` |
|          - | 1607 | `					 /* Process function arguments */` |
|    5504665 | 1608 | `					 rc = ExprProcessFuncArguments(&(*pGen),pNode,&apNode[iCur+1],nFuncTok-1);` |
|    5504665 | 1609 | `					 if( rc != SXRET_OK ){` |
|         11 | 1610 | `						 return rc;` |
|          - | 1611 | `					 }` |
|    2752326 | 1612 | `				 }` |
|          - | 1613 | `				 /* Link the node to the tree */` |
|    7050673 | 1614 | `				 pNode->pLeft = apNode[iLeft];` |
|    7050673 | 1615 | `				 apNode[iLeft] = 0;` |
|   34826641 | 1616 | `				 for( iPtr = 1; iPtr <= nFuncTok ; iPtr++ ){` |
|   27775973 | 1617 | `					 apNode[iCur+iPtr] = 0;` |
|   13887989 | 1618 | `				 }` |
...
|          - | 1629 | `				 {` |
|    7050673 | 1630 | `					 sxi32 iNew = iLeft - 1;` |
|    9112881 | 1631 | `					 while( iNew >= 0 && apNode[iNew] == 0 ){` |
|    2062213 | 1632 | `						 iNew--;` |
|          5 | 1633 | `					 }` |
|    7050668 | 1634 | `					 if( iNew >= 0 && apNode[iNew]->pOp` |
|    3975628 | 1635 | `						 && apNode[iNew]->pOp->iOp == EXPR_OP_NEW` |
|    2408785 | 1636 | `						 && apNode[iNew]->pLeft == 0 ){` |
...
|     427762 | 1641 | `					 }` |
|          - | 1642 | `				 }` |
|   12533283 | 1643 | `			 }else if (pNode->pOp->iOp == EXPR_OP_SUBSCRIPT ){` |
|          - | 1644 | `				 /* Subscripting */` |
...
|          - | 1728 | `			 }` |
|    8029304 | 1729 | `		 }` |
|   58980263 | 1730 | `		 iLeft = iCur;` |
|   29490134 | 1731 | `	 }` |
|          - | 1732 | `	 /* Handle left associative (new, clone) operators */` |
|  121844205 | 1733 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  105617365 | 1734 | `		 if( apNode[iCur] == 0 ){` |
|   63613737 | 1735 | `			 continue;` |
|          - | 1736 | `		 }` |
|   42003633 | 1737 | `		 pNode = apNode[iCur];` |
|   42003633 | 1738 | `		 if( pNode->pOp && pNode->pOp->iPrec == 1 && pNode->pLeft == 0 ){` |
|          - | 1739 | `			 SyToken *pToken;` |
...
|   16226845 | 1819 | `	 iLeft = -1;` |
|  122015097 | 1820 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  105617365 | 1821 | `		 if( apNode[iCur] == 0 ){` |
|   63613737 | 1822 | `			 continue;` |
|          - | 1823 | `		 }` |
|   42003633 | 1824 | `		 pNode = apNode[iCur];` |
|   42003633 | 1825 | `		 if( pNode->pOp && pNode->pOp->iPrec == 3 && pNode->pLeft == 0){` |
...
|     100984 | 1831 | `			 }` |
|     279642 | 1832 | `		  }` |
|   42174525 | 1833 | `		 iLeft = iCur;` |
|   21172711 | 1834 | `	  }` |
|   16397737 | 1835 | `	 iLeft = -1;` |
|  122015097 | 1836 | `	 for( iCur = nToken -  1 ; iCur >= 0 ; iCur-- ){` |
|  105617365 | 1837 | `		 if( apNode[iCur] == 0 ){` |
|   63815705 | 1838 | `			 continue;` |
|          - | 1839 | `		 }` |
|   41801665 | 1840 | `		 pNode = apNode[iCur];` |
|   41801665 | 1841 | `		 if( pNode->pOp && pNode->pOp->iPrec == 3 && pNode->pLeft == 0){` |
...
|   16397737 | 1867 | `	 iLeft = -1;` |
|  122015097 | 1868 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  105617365 | 1869 | `		 if( apNode[iCur] == 0 ){` |
|   63912941 | 1870 | `			 continue;` |
|          - | 1871 | `		 }` |
|   41704429 | 1872 | `		 pNode = apNode[iCur];` |
|   41704429 | 1873 | `		 if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_INSTOF && pNode->pLeft == 0 ){` |
...
|      40852 | 1888 | `		 }` |
|   41704429 | 1889 | `		 iLeft = iCur;` |
|   20852217 | 1890 | `	 }` |
|          - | 1891 | `	 /* Handle right associative unary and cast operators [i.e: !,(string),~...]  with precedence 4*/` |
|   16397737 | 1892 | `	  iLeft = 0;` |
|  122015091 | 1893 | `	  for( iCur = nToken -  1 ; iCur >= 0 ; iCur-- ){` |
|  105617361 | 1894 | `		  if( apNode[iCur] ){` |
|   41622721 | 1895 | `			  pNode = apNode[iCur];` |
|   41622721 | 1896 | `			  if( pNode->pOp && pNode->pOp->iPrec == 4 && pNode->pLeft == 0){` |
...
|  122015089 | 1928 | `	 for( iCur = nToken - 1 ; iCur >= 0 ; --iCur ){` |
|  105617359 | 1929 | `		 if( apNode[iCur] == 0 ){` |
|   65368755 | 1930 | `			 continue;` |
|          - | 1931 | `		 }` |
|   40248609 | 1932 | `		 pNode = apNode[iCur];` |
|   40248609 | 1933 | `		 if( pNode->pOp && pNode->pOp->iPrec == 5 && pNode->pLeft == 0 ){` |
|          - | 1934 | `			 sxi32 iL, iR;` |
...
|  180374949 | 1996 | `	 for( i = 7 ; i < 17 ; i++ ){` |
|  163977229 | 1997 | `		 iLeft = -1;` |
| 1220150475 | 1998 | `		 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
| 1056173261 | 1999 | `			 if( apNode[iCur] == 0 ){` |
|  722379693 | 2000 | `				 continue;` |
|          - | 2001 | `			 }` |
|  333793573 | 2002 | `			 pNode = apNode[iCur];` |
|  333793573 | 2003 | `			 if( pNode->pOp && pNode->pOp->iPrec == i && pNode->pLeft == 0 ){` |
|          - | 2004 | `				 /* Get the right node */` |
|    5710811 | 2005 | `				 iRight = iCur + 1;` |
|    8652701 | 2006 | `				 while( iRight < nToken && apNode[iRight] == 0 ){` |
|    2941895 | 2007 | `					 iRight++;` |
|          5 | 2008 | `				 }` |
|    5710811 | 2009 | `				 if( iRight >= nToken \|\| iLeft < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|          - | 2010 | `					 /* Syntax error */` |
...
|         10 | 2015 | `					 return rc;` |
|          - | 2016 | `				 }` |
|    5710803 | 2017 | `				 if( pNode->pOp->iOp == EXPR_OP_REF ){` |
|          - | 2018 | `					 sxi32  iTmp;` |
...
|    5710801 | 2065 | `				 pNode->pLeft = apNode[iLeft];` |
|    5710801 | 2066 | `				 pNode->pRight = apNode[iRight];` |
|    5710801 | 2067 | `				 apNode[iLeft] = apNode[iRight] = 0;` |
|    2855398 | 2068 | `			 }` |
|  333793563 | 2069 | `			 iLeft = iCur;` |
|  166896784 | 2070 | `		 }` |
|   81988612 | 2071 | `	 }` |
...
|          - | 2075 | `	  */` |
|   16397725 | 2076 | `	  iLeft = -1;` |
|  117861403 | 2077 | `	  for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  101966945 | 2078 | `		  if( apNode[iCur] == 0 ){` |
|   74645939 | 2079 | `			  continue;` |
|          - | 2080 | `		  }` |
|   27321011 | 2081 | `		  pNode = apNode[iCur];` |
|   27321011 | 2082 | `		  if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_QUESTY && pNode->pLeft == 0 ){` |
...
|          - | 2148 | `	  */` |
|   16397723 | 2149 | `	 iRight = -1;` |
|  122014893 | 2150 | `	 for( iCur = nToken -  1 ; iCur >= 0 ; iCur--){` |
|  105617229 | 2151 | `		 if( apNode[iCur] == 0 ){` |
|   84009461 | 2152 | `			 continue;` |
|          - | 2153 | `		 }` |
|   21607773 | 2154 | `		 pNode = apNode[iCur];` |
|   21607773 | 2155 | `		 if( pNode->pOp && pNode->pOp->iPrec == 18 && pNode->pLeft == 0 ){` |
|          - | 2156 | `			 /* Get the left node */` |
|    5209977 | 2157 | `			 iLeft = iCur - 1;` |
|    7154059 | 2158 | `			 while( iLeft >= 0 && apNode[iLeft] == 0 ){` |
|    1944087 | 2159 | `				 iLeft--;` |
|          5 | 2160 | `			 }` |
|    5209977 | 2161 | `			 if( iLeft < 0 \|\| iRight < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|          - | 2162 | `				 /* Syntax error */` |
...
|          - | 2179 | `			  * a write. */` |
|    5209935 | 2180 | `			 if( PH7_ExprContainsNullsafe(apNode[iLeft]) ){` |
...
|    5209927 | 2193 | `			 pSuppress = 0;` |
|    5209922 | 2194 | `			 if( apNode[iLeft]->pOp` |
|    3351935 | 2195 | `				 && apNode[iLeft]->pOp->iVmOp == PH7_OP_ERR_CTRL` |
...
|        ! 0 | 2200 | `			 }` |
|    5209927 | 2201 | `			 if( ExprIsModifiableValue(apNode[iLeft],FALSE) == FALSE ){` |
...
|    5209915 | 2244 | `			 pNode->pLeft = apNode[iRight];` |
|    5209915 | 2245 | `			 pNode->pRight = apNode[iLeft];` |
|    5209915 | 2246 | `			 apNode[iLeft] = apNode[iRight] = 0;` |
|    5209915 | 2247 | `			 if( pSuppress ){` |
|          - | 2248 | `				 /* Re-wrap: the '@' now suppresses the whole assignment */` |
|        ! 0 | 2249 | `				 pSuppress->pLeft = pNode;` |
|        ! 0 | 2250 | `				 apNode[iCur] = pSuppress;` |
|        ! 0 | 2251 | `			 }` |
|    2604955 | 2252 | `		 }` |
|   21607711 | 2253 | `		 iRight = iCur;` |
|   10803858 | 2254 | `	 }` |
|          - | 2255 | `	 /* Process left associative binary operators that have the lowest precedence [i.e: and,or,xor] */` |
|   81988325 | 2256 | `	 for( i = 19 ; i < 23 ; i++ ){` |
|   65590661 | 2257 | `		 iLeft = -1;` |
|  488059285 | 2258 | `		 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  422468629 | 2259 | `			 if( apNode[iCur] == 0 ){` |
|  356877721 | 2260 | `				 continue;` |
|          - | 2261 | `			 }` |
|   65590913 | 2262 | `			 pNode = apNode[iCur];` |
|   65590913 | 2263 | `			 if( pNode->pOp && pNode->pOp->iPrec == i && pNode->pLeft == 0 ){` |
...
|         24 | 2281 | `			 }` |
|   65590913 | 2282 | `			 iLeft = iCur;` |
|   32795459 | 2283 | `		 }` |
|   32795333 | 2284 | `	 }` |
|          - | 2285 | `	 /* Point to the root of the expression tree */` |
|  105617133 | 2286 | `	 for( iCur = 1 ; iCur < nToken ; ++iCur ){` |
|   89219487 | 2287 | `		 if( apNode[iCur] ){` |
|   15597761 | 2288 | `			 if( (apNode[iCur]->pOp \|\| apNode[iCur]->xCode ) && apNode[0] != 0){` |
...
|         23 | 2293 | `				  return rc;` |
|          - | 2294 | `			 }` |
|   15597743 | 2295 | `			 apNode[0] = apNode[iCur];` |
|   15597743 | 2296 | `			 apNode[iCur] = 0;` |
|    7798869 | 2297 | `		 }` |
|   44609737 | 2298 | `	 }` |
|   16397651 | 2299 | `	 return SXRET_OK;` |
|   14687078 | 2300 | ` }` |
|          - | 2301 | ` /*` |
...
|          - | 2306 | `  */` |
|   17084772 | 2307 | `PH7_PRIVATE sxi32 PH7_ExprMakeTree(ph7_gen_state *pGen,SySet *pExprNode,ph7_expr_node **ppRoot)` |
|          5 | 2308 | `{` |
|          - | 2309 | `	ph7_expr_node **apNode;` |
|          - | 2310 | `	ph7_expr_node *pNode;` |
|          - | 2311 | `	sxi32 rc;` |
|          - | 2312 | `	/* Reset node container */` |
|   17084777 | 2313 | `	SySetReset(pExprNode);` |
|   17084777 | 2314 | `	pNode = 0; /* Prevent compiler warning */` |
|          - | 2315 | `	/* Extract nodes one after one until we hit the end of the input */` |
|          - | 2316 | `	{` |
|   17084777 | 2317 | `		int iLastWasTerm = 0;` |
|   17084777 | 2318 | `		int bAfterMemberOp = 0; /* TRUE iff the previous node was -> / ?-> / :: */` |
|  107094591 | 2319 | `		while( pGen->pIn < pGen->pEnd ){` |
|   90009851 | 2320 | `			rc = ExprExtractNode(&(*pGen),&pNode,iLastWasTerm,bAfterMemberOp);` |
|   90009851 | 2321 | `			if( rc != SXRET_OK ){` |
|         36 | 2322 | `				return rc;` |
|          - | 2323 | `			}` |
|          - | 2324 | `			/* Determine if this node is a term for short-array disambiguation */` |
|   90009819 | 2325 | `			if( pNode->xCode ){` |
|          - | 2326 | `				/* Node with compile handler: variable, literal, string, array, etc. */` |
|   45867855 | 2327 | `				iLastWasTerm = 1;` |
|   67075894 | 2328 | `			}else if( pNode->pOp ){` |
|          - | 2329 | `				/* Operator node */` |
|   25525279 | 2330 | `				iLastWasTerm = 0;` |
|   12762642 | 2331 | `			}else{` |
|          - | 2332 | `				/* Delimiter: ')' and ']' end terms */` |
|   18616695 | 2333 | `				iLastWasTerm = (pNode->pStart->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB)) ? 1 : 0;` |
|          - | 2334 | `			}` |
...
|   90009819 | 2338 | `			bAfterMemberOp = ( pNode->pOp && pNode->pOp->iVmOp == PH7_OP_MEMBER );` |
|          - | 2339 | `			/* Save the extracted node */` |
|   90009819 | 2340 | `			SySetPut(pExprNode,(const void *)&pNode);` |
|          5 | 2341 | `		}` |
|          - | 2342 | `	}` |
|   17084745 | 2343 | `	if( SySetUsed(pExprNode) < 1 ){` |
|          - | 2344 | `		/* Empty expression [i.e: A semi-colon;] */` |
|        ! 0 | 2345 | `		*ppRoot = 0;` |
|        ! 0 | 2346 | `		return SXRET_OK;` |
|          - | 2347 | `	}` |
|   17084745 | 2348 | `	apNode = (ph7_expr_node **)SySetBasePtr(pExprNode);` |
|          - | 2349 | `	/* Make sure we are dealing with valid nodes */` |
|   17084745 | 2350 | `	rc = ExprVerifyNodes(&(*pGen),apNode,(sxi32)SySetUsed(pExprNode));` |
|   17084745 | 2351 | `	if( rc != SXRET_OK ){` |
...
|          - | 2357 | `	}` |
|          - | 2358 | `	/* Build the tree */` |
|   17084695 | 2359 | `	rc = ExprMakeTree(&(*pGen),apNode,(sxi32)SySetUsed(pExprNode));` |
|   17084695 | 2360 | `	if( rc != SXRET_OK ){` |
|          - | 2361 | `		/* Something goes wrong [i.e: Syntax error] */` |
|        103 | 2362 | `		*ppRoot = 0;` |
|        103 | 2363 | `		return rc;` |
|          - | 2364 | `	}` |
|          - | 2365 | `	/* Point to the root of the tree */` |
|   17084597 | 2366 | `	*ppRoot = apNode[0];` |
|   17084597 | 2367 | `	return SXRET_OK;` |
|    8542391 | 2368 | `}` |
|          - | 2369 |  |
