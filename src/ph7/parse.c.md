...
|         - |  272 | ` */` |
|  21637498 |  273 | `PH7_PRIVATE const ph7_expr_op *  PH7_ExprExtractOperator(SyString *pStr,SyToken *pLast)` |
|         5 |  274 | `{` |
|  21637503 |  275 | `	sxu32 n = 0;` |
|         - |  276 | `	sxi32 rc;` |
|         - |  277 | `	/* Do a linear lookup on the operators table */` |
| 323540580 |  278 | `	for(;;){` |
| 647081165 |  279 | `		if( n >= SX_ARRAYSIZE(aOpTable) ){` |
|       ! 0 |  280 | `			break;` |
|         - |  281 | `		}` |
| 647081165 |  282 | `		if( SyisAlpha(aOpTable[n].sOp.zString[0]) ){` |
|         - |  283 | `			/* TICKET 1433-012: Alpha stream operators [i.e: and,or,xor,new...] */` |
|  63092991 |  284 | `			rc = SyStringCmp(pStr,&aOpTable[n].sOp,SyStrnicmp);` |
|  31546498 |  285 | `		}else{` |
| 583988179 |  286 | `			rc = SyStringCmp(pStr,&aOpTable[n].sOp,SyMemcmp);` |
|         - |  287 | `		}` |
| 647081165 |  288 | `		if( rc == 0 ){` |
|  21881351 |  289 | `			if( aOpTable[n].sOp.nByte != sizeof(char) \|\| (aOpTable[n].iOp != EXPR_OP_UMINUS && aOpTable[n].iOp != EXPR_OP_UPLUS) \|\| pLast == 0 ){` |
|         - |  290 | `				/* There is no ambiguity here,simply return the first operator seen */` |
|  21560973 |  291 | `				return &aOpTable[n];` |
|         - |  292 | `			}` |
|         - |  293 | `			/* Handle ambiguity */` |
|    320383 |  294 | `			if( pLast->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*'['*/\|PH7_TK_COLON/*:*/\|PH7_TK_COMMA/*,'*/) ){` |
|         - |  295 | `				/* Unary opertors have prcedence here over binary operators */` |
|     23259 |  296 | `				return &aOpTable[n];` |
|         - |  297 | `			}` |
|    297129 |  298 | `			if( pLast->nType & PH7_TK_OP ){` |
|     53289 |  299 | `				const ph7_expr_op *pOp = (const ph7_expr_op *)pLast->pUserData;` |
|         - |  300 | `				/* Ticket 1433-31: Handle the '++','--' operators case */` |
|     53289 |  301 | `				if( pOp->iOp != EXPR_OP_INCR && pOp->iOp != EXPR_OP_DECR ){` |
|         - |  302 | `					/* Unary opertors have prcedence here over binary operators */` |
|     53281 |  303 | `					return &aOpTable[n];` |
|         - |  304 | `				}` |
|         - |  305 |  |
|         4 |  306 | `			}` |
|    121924 |  307 | `		}` |
| 625443667 |  308 | `		++n; /* Next operator in the table */` |
|         5 |  309 | `	}` |
...
|         - |  317 | ` */` |
|   6072952 |  318 | `PH7_PRIVATE void PH7_DelimitNestedTokens(SyToken *pIn,SyToken *pEnd,sxu32 nTokStart,sxu32 nTokEnd,SyToken **ppEnd)` |
|         5 |  319 | `{` |
|   6072957 |  320 | `	SyToken *pCur = pIn;` |
|   6072957 |  321 | `	sxi32 iNest = 1;` |
|  68084985 |  322 | `	for(;;){` |
| 136169975 |  323 | `		if( pCur >= pEnd ){` |
|     15707 |  324 | `			break;` |
|         - |  325 | `		}` |
| 136154273 |  326 | `		if( pCur->nType & nTokStart ){` |
|         - |  327 | `			/* Increment nesting level */` |
|   5296021 |  328 | `			iNest++;` |
| 133506265 |  329 | `		}else if( pCur->nType & nTokEnd ){` |
|         - |  330 | `			/* Decrement nesting level */` |
|  11353271 |  331 | `			iNest--;` |
|  11353271 |  332 | `			if( iNest <= 0 ){` |
|   6057255 |  333 | `				break;` |
|         - |  334 | `			}` |
|   2648008 |  335 | `		}` |
|         - |  336 | `		/* Advance cursor */` |
...
|         - |  350 | ` */` |
|    415030 |  351 | `PH7_PRIVATE int PH7_IsLangConstruct(sxu32 nKeyID,sxu8 bCheckFunc)` |
|         5 |  352 | `{` |
|    415030 |  353 | `	if( nKeyID == PH7_TKWRD_ECHO \|\| nKeyID == PH7_TKWRD_PRINT \|\| nKeyID == PH7_TKWRD_INCLUDE` |
|    414956 |  354 | `		\|\| nKeyID == PH7_TKWRD_INCONCE \|\| nKeyID == PH7_TKWRD_REQUIRE \|\| nKeyID == PH7_TKWRD_REQONCE` |
|         - |  355 | `		){` |
|       143 |  356 | `			return TRUE;` |
|         - |  357 | `	}` |
|    414897 |  358 | `	if( bCheckFunc ){` |
|     38380 |  359 | `		if(  nKeyID == PH7_TKWRD_ISSET \|\| nKeyID == PH7_TKWRD_UNSET \|\| nKeyID == PH7_TKWRD_EVAL` |
|     38373 |  360 | `			\|\| nKeyID == PH7_TKWRD_EMPTY \|\| nKeyID == PH7_TKWRD_ARRAY \|\| nKeyID == PH7_TKWRD_LIST` |
|     38354 |  361 | `			\|\| /* TICKET 1433-012 */ nKeyID == PH7_TKWRD_NEW \|\| nKeyID == PH7_TKWRD_CLONE  ){` |
|        51 |  362 | `				return TRUE;` |
|         - |  363 | `		}` |
|     19167 |  364 | `	}` |
|         - |  365 | `	/* Not a language construct */` |
|    414851 |  366 | `	return FALSE;` |
|    207520 |  367 | `}` |
|         - |  368 | `/*` |
...
|         - |  373 | ` */` |
|  12558708 |  374 | `static sxi32 ExprVerifyNodes(ph7_gen_state *pGen,ph7_expr_node **apNode,sxi32 nNode)` |
|         5 |  375 | `{` |
|         - |  376 | `	sxi32 iParen,iSquare,iQuesty,iBraces;` |
|         - |  377 | `	sxi32 i,rc;` |
|         - |  378 |  |
|  12558713 |  379 | `	if( nNode > 0 && apNode[0]->pOp && (apNode[0]->pOp->iOp == EXPR_OP_ADD \|\| apNode[0]->pOp->iOp == EXPR_OP_SUB) ){` |
...
|        16 |  383 | `	}` |
|  12558713 |  384 | `	iParen = iSquare = iQuesty = iBraces = 0;` |
|  80313621 |  385 | `	for( i = 0 ; i < nNode ; ++i ){` |
|  67754949 |  386 | `		if( apNode[i]->xCode == PH7_CompileShortArray \|\| apNode[i]->xCode == PH7_CompileShortList ){` |
|         - |  387 | `			/* Short array/list literal: brackets are self-contained, skip */` |
|    214559 |  388 | `			continue;` |
|         - |  389 | `		}` |
|  67540395 |  390 | `		if( apNode[i]->pStart->nType & PH7_TK_LPAREN /*'('*/){` |
|   5709947 |  391 | `			if( i > 0 && ( apNode[i-1]->xCode == PH7_CompileVariable \|\| apNode[i-1]->xCode == PH7_CompileLiteral \|\|` |
|    263162 |  392 | `				(apNode[i - 1]->pStart->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_SSTR\|PH7_TK_DSTR\|PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}'*/))) ){` |
|         - |  393 | `					/* Ticket 1433-033: Take care to ignore alpha-stream [i.e: or,xor] operators followed by an opening parenthesis */` |
|   5388965 |  394 | `					if( (apNode[i - 1]->pStart->nType & PH7_TK_OP) == 0 ){` |
|         - |  395 | `						/* We are dealing with a postfix [i.e: function call]  operator` |
|         - |  396 | `						 * not a simple left parenthesis. Mark the node.` |
|         - |  397 | `						 */` |
|   5388965 |  398 | `						apNode[i]->pStart->nType \|= PH7_TK_OP;` |
|   5388965 |  399 | `						apNode[i]->pStart->pUserData = (void *)&sFCallOp; /* Function call operator */` |
|   5388965 |  400 | `						apNode[i]->pOp = &sFCallOp;` |
|   2694480 |  401 | `					}` |
|   2694480 |  402 | `			}` |
|   5709947 |  403 | `			iParen++;` |
|  64685424 |  404 | `		}else if( apNode[i]->pStart->nType & PH7_TK_RPAREN/*')*/){` |
|   5709947 |  405 | `			if( iParen <= 0 ){` |
...
|         - |  411 | `			}` |
|   5709935 |  412 | `			iParen--;` |
|  58975476 |  413 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OSB /*'['*/){` |
|   2497093 |  414 | `			iSquare++;` |
|  54871967 |  415 | `		}else if (apNode[i]->pStart->nType & PH7_TK_CSB /*']'*/){` |
|   2497097 |  416 | `			if( iSquare <= 0 ){` |
...
|         - |  422 | `			}` |
|   2497091 |  423 | `			iSquare--;` |
|  52374874 |  424 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OCB /*'{'*/){` |
|      3811 |  425 | `			iBraces++;` |
|      3811 |  426 | `			if( i > 0 && ( apNode[i - 1]->xCode == PH7_CompileVariable \|\| (apNode[i - 1]->pStart->nType & PH7_TK_CSB/*]*/)) ){` |
...
|         3 |  434 | `				return rc;` |
|         5 |  435 | `			}` |
|  51124427 |  436 | `		}else if (apNode[i]->pStart->nType & PH7_TK_CCB /*'}'*/){` |
|      3821 |  437 | `			if( iBraces <= 0 ){` |
...
|         - |  443 | `			}` |
|      3809 |  444 | `			iBraces--;` |
|  51120611 |  445 | `		}else if ( apNode[i]->pStart->nType & PH7_TK_COLON ){` |
|    368003 |  446 | `			if( iQuesty > 0 ){` |
|    367713 |  447 | `				iQuesty--;` |
|    184149 |  448 | `			}else if( iParen <= 0 ){` |
...
|         6 |  456 | `				return rc;` |
|         5 |  457 | `			}` |
|  50934708 |  458 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OP ){` |
|  16714645 |  459 | `			const ph7_expr_op *pOp = (const ph7_expr_op *)apNode[i]->pOp;` |
|  16714645 |  460 | `			if( pOp->iOp == EXPR_OP_QUESTY ){` |
|    367715 |  461 | `				iQuesty++;` |
|  16530790 |  462 | `			}else if( i > 0 && (pOp->iOp == EXPR_OP_UMINUS \|\| pOp->iOp == EXPR_OP_UPLUS)){` |
|     65071 |  463 | `				if( apNode[i-1]->xCode == PH7_CompileVariable \|\| apNode[i-1]->xCode == PH7_CompileLiteral ){` |
...
|   8357320 |  482 | `		}` |
|  33770182 |  483 | `	}` |
|  12558677 |  484 | `	if( iParen != 0 \|\| iSquare != 0 \|\| iQuesty != 0 \|\| iBraces != 0){` |
...
|        19 |  489 | `		return rc;` |
|         - |  490 | `	}` |
|  12558661 |  491 | `	return SXRET_OK;` |
|   6279359 |  492 | `}` |
|         - |  493 | `/*` |
|         - |  494 | ` * Collect and assemble tokens holding a namespace path [i.e: namespace\to\const]` |
|         - |  495 | ` * or a simple literal [i.e: PHP_EOL].` |
|         - |  496 | ` */` |
|  10777110 |  497 | `static void ExprAssembleLiteral(SyToken **ppCur,SyToken *pEnd)` |
|         5 |  498 | `{` |
|  10777115 |  499 | `	SyToken *pIn = *ppCur;` |
|         - |  500 | `	/* Jump the first literal seen */` |
|  10777115 |  501 | `	if( (pIn->nType & PH7_TK_NSSEP) == 0 ){` |
|  10773271 |  502 | `		pIn++;` |
|   5386633 |  503 | `	}` |
|   5390504 |  504 | `	for(;;){` |
|  10781013 |  505 | `		if(pIn < pEnd && (pIn->nType & PH7_TK_NSSEP) ){` |
|      3903 |  506 | `			pIn++;` |
|      3903 |  507 | `			if(pIn < pEnd && (pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|      3901 |  508 | `				pIn++;` |
|      1948 |  509 | `			}` |
|      1954 |  510 | `		}else{` |
|   5388560 |  511 | `			break;` |
...
|         - |  560 | ` */` |
|       854 |  561 | `static void ExprSkipReturnType(SyToken **ppIn,SyToken *pEnd)` |
|         5 |  562 | `{` |
|       859 |  563 | `	SyToken *pIn = *ppIn;` |
|       859 |  564 | `	if( pIn < pEnd && (pIn->nType & PH7_TK_COLON) ){` |
|        25 |  565 | `		pIn++; /* Skip ':' */` |
|        11 |  566 | `		for(;;){` |
...
|       859 |  602 | `	*ppIn = pIn;` |
|       859 |  603 | `}` |
|       490 |  604 | `static sxi32 ExprAssembleAnnon(ph7_gen_state *pGen,SyToken **ppCur,SyToken *pEnd)` |
|         5 |  605 | `{` |
|       495 |  606 | `	SyToken *pIn = *ppCur;` |
|         - |  607 | `	sxi32 rc;` |
...
|       495 |  613 | `	pIn++;` |
|       490 |  614 | `	if( pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD)` |
|       255 |  615 | `		&& SX_PTR_TO_INT(pIn->pUserData) == PH7_TKWRD_FUNCTION ){` |
|         9 |  616 | `		pIn++;` |
|         4 |  617 | `	}` |
|       495 |  618 | `	if( pIn >= pEnd \|\| (pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|         - |  619 | `		/* Syntax error */` |
...
|         - |  625 | `	}` |
|       491 |  626 | `	pIn++; /* Jump the leading parenthesis '(' */` |
|       491 |  627 | `	PH7_DelimitNestedTokens(pIn,pEnd,PH7_TK_LPAREN/*'('*/,PH7_TK_RPAREN/*')'*/,&pIn);` |
|       491 |  628 | `	if( pIn >= pEnd \|\| &pIn[1] >= pEnd ){` |
...
|         - |  638 | `	}` |
|       487 |  639 | `	pIn++; /* Jump the trailing parenthesis */` |
|         - |  640 | `	/* Skip optional return type declaration (legacy pre-use position) */` |
|       487 |  641 | `	ExprSkipReturnType(&pIn,pEnd);` |
|       487 |  642 | `	if( pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD) ){` |
...
|       471 |  681 | `	if( pIn < pEnd && (pIn->nType & PH7_TK_OCB) /*'{'*/ ){` |
|       471 |  682 | `		pIn++; /* Jump the leading curly '{' */` |
|       471 |  683 | `		PH7_DelimitNestedTokens(pIn,pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pIn);` |
|       471 |  684 | `		if( pIn < pEnd ){` |
|       471 |  685 | `			pIn++;` |
|       233 |  686 | `		}` |
|       238 |  687 | `	}else{` |
...
|         - |  756 | ` */` |
|       286 |  757 | `static sxi32 ExprAssembleArrowFunc(ph7_gen_state *pGen,SyToken **ppCur,SyToken *pEnd)` |
|         5 |  758 | `{` |
|       291 |  759 | `	SyToken *pIn = *ppCur;` |
|         - |  760 | `	sxu32 nLine;` |
|         - |  761 | `	sxi32 rc;` |
|         - |  762 | `	int iNest;` |
|       291 |  763 | `	nLine = pIn->nLine;` |
|         - |  764 | `	/* Optional 'static' prefix */` |
|       286 |  765 | `	if( pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD)` |
|       291 |  766 | `		&& SX_PTR_TO_INT(pIn->pUserData) == PH7_TKWRD_STATIC ){` |
|         7 |  767 | `		pIn++;` |
|         3 |  768 | `	}` |
|         - |  769 | `	/* Expect 'fn' (dispatch in ExprExtractNode guarantees this) */` |
|       286 |  770 | `	if( pIn >= pEnd \|\| (pIn->nType & PH7_TK_KEYWORD) == 0` |
|       291 |  771 | `		\|\| SX_PTR_TO_INT(pIn->pUserData) != PH7_TKWRD_FN ){` |
|       ! 0 |  772 | `		rc = SXERR_SYNTAX;` |
|       ! 0 |  773 | `		goto Synchronize;` |
|         - |  774 | `	}` |
|       291 |  775 | `	pIn++; /* Jump 'fn' */` |
|       143 |  776 | `	SXUNUSED(nLine);` |
|       143 |  777 | `	SXUNUSED(pGen);` |
|         - |  778 | `	/* Optional '&' for return-by-reference */` |
|       291 |  779 | `	if( pIn < pEnd && (pIn->nType & PH7_TK_AMPER) ){` |
|       ! 0 |  780 | `		pIn++;` |
|       ! 0 |  781 | `	}` |
...
|       291 |  786 | `	if( pIn < pEnd && (pIn->nType & PH7_TK_LPAREN) ){` |
|       289 |  787 | `		pIn++; /* '(' */` |
|       289 |  788 | `		PH7_DelimitNestedTokens(pIn,pEnd,PH7_TK_LPAREN,PH7_TK_RPAREN,&pIn);` |
|       289 |  789 | `		if( pIn < pEnd ){` |
|       286 |  790 | `			pIn++; /* ')' */` |
|       141 |  791 | `		}` |
|       142 |  792 | `	}` |
|         - |  793 | `	/* Optional return type — shared skipper (unions/intersections/DNF) */` |
|       291 |  794 | `	ExprSkipReturnType(&pIn,pEnd);` |
|         - |  795 | `	/* Consume '=>' if present; the compile pass diagnoses absence */` |
|       291 |  796 | `	if( pIn < pEnd && (pIn->nType & PH7_TK_ARRAY_OP) ){` |
|       283 |  797 | `		pIn++;` |
|       140 |  798 | `	}` |
|         - |  799 | `	/* Scan body until first top-level ',' ';' ')' ']' '}' */` |
|       291 |  800 | `	iNest = 0;` |
|      2007 |  801 | `	while( pIn < pEnd ){` |
|      1894 |  802 | `		if( iNest == 0 && (pIn->nType &` |
|         - |  803 | `			(PH7_TK_COMMA\|PH7_TK_SEMI\|PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB)) ){` |
|       175 |  804 | `			break;` |
|         - |  805 | `		}` |
|      1720 |  806 | `		if( pIn->nType & (PH7_TK_LPAREN\|PH7_TK_OSB\|PH7_TK_OCB) ){` |
|       195 |  807 | `			iNest++;` |
|      1624 |  808 | `		}else if( pIn->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB) ){` |
|       195 |  809 | `			iNest--;` |
|        96 |  810 | `		}` |
|      1720 |  811 | `		pIn++;` |
|         4 |  812 | `	}` |
...
|         - |  866 | ` */` |
|  67759144 |  867 | `static sxi32 ExprExtractNode(ph7_gen_state *pGen,ph7_expr_node **ppNode,int iLastWasTerm,int bAfterMemberOp)` |
|         5 |  868 | `{` |
|         - |  869 | `	ph7_expr_node *pNode;` |
|         - |  870 | `	SyToken *pCur;` |
|         - |  871 | `	sxi32 rc;` |
|         - |  872 | `	/* Allocate a new node */` |
|  67759149 |  873 | `	pNode = (ph7_expr_node *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_expr_node));` |
|  67759149 |  874 | `	if( pNode == 0 ){` |
...
|  67759149 |  881 | `	SyZero(pNode,sizeof(ph7_expr_node));` |
|  67759149 |  882 | `	SySetInit(&pNode->aNodeArgs,&pGen->pVm->sAllocator,sizeof(ph7_expr_node **));` |
|         - |  883 | `	/* Point to the head of the token stream */` |
|  67759149 |  884 | `	pCur = pNode->pStart = pGen->pIn;` |
|         - |  885 | `	/* Start collecting tokens */` |
|  67759149 |  886 | `	if( pCur->nType & PH7_TK_ELLIPSIS ){` |
|      4131 |  887 | `		if( &pCur[1] < pGen->pEnd && (pCur[1].nType & PH7_TK_RPAREN) ){` |
...
|      4051 |  902 | `		pCur++;` |
|      4051 |  903 | `		pGen->pIn = pCur;` |
|      4051 |  904 | `		SyMemBackendPoolFree(&pGen->pVm->sAllocator, pNode);` |
|      4051 |  905 | `		rc = ExprExtractNode(pGen, ppNode, iLastWasTerm, 0/* a spread element is never a member name */);` |
|      4051 |  906 | `		if( rc == SXRET_OK && *ppNode ){` |
|      4051 |  907 | `			(*ppNode)->iFlags \|= EXPR_NODE_SPREAD;` |
|      2023 |  908 | `		}` |
|      4051 |  909 | `		return rc;` |
|         - |  910 | `	}` |
|  67755023 |  911 | `	if( (pCur->nType & PH7_TK_OSB) && !iLastWasTerm ){` |
|         - |  912 | `		/* PHP 5.4 short array syntax: [1, 2, 3] or ['key' => 'value'].` |
|         - |  913 | `		 * This '[' does not follow a term, so it is an array literal, not subscript.` |
|         - |  914 | `		 */` |
|    214561 |  915 | `		pCur++; /* Skip the opening '[' */` |
|    214561 |  916 | `		PH7_DelimitNestedTokens(pCur,pGen->pEnd,PH7_TK_OSB,PH7_TK_CSB,&pCur);` |
|    214561 |  917 | `		if( pCur < pGen->pEnd ){` |
|    214561 |  918 | `			pCur++; /* Skip past the closing ']' */` |
|    107283 |  919 | `		}else{` |
...
|         - |  930 | `		 */` |
|    214731 |  931 | `		if( pCur < pGen->pEnd && (pCur->nType & PH7_TK_OP) ){` |
|       342 |  932 | `			ph7_expr_op *pOp = (ph7_expr_op *)pCur->pUserData;` |
|       342 |  933 | `			if( pOp && pOp->iVmOp == PH7_OP_STORE ){` |
|        56 |  934 | `				pNode->xCode = PH7_CompileShortList;` |
|        29 |  935 | `			}else{` |
|       287 |  936 | `				pNode->xCode = PH7_CompileShortArray;` |
|         - |  937 | `			}` |
|       172 |  938 | `		}else{` |
|    214221 |  939 | `			pNode->xCode = PH7_CompileShortArray;` |
|         5 |  940 | `		}` |
|  67647745 |  941 | `	}else if( bAfterMemberOp && (pCur->nType & PH7_TK_OP) && (pCur->nType & PH7_TK_ID) ){` |
...
|  67540455 |  952 | `	}else if( (pCur->nType & PH7_TK_OP) && pCur->pUserData` |
|  19211784 |  953 | `		&& ((const ph7_expr_op *)pCur->pUserData)->iOp == EXPR_OP_CLONE` |
|   9632500 |  954 | `		&& &pCur[1] < pGen->pEnd && (pCur[1].nType & PH7_TK_LPAREN) ){` |
...
|  67540440 |  980 | `	}else if( pCur->nType & PH7_TK_OP ){` |
|         - |  981 | `		/* Point to the instance that describe this operator */` |
|  19211767 |  982 | `		pNode->pOp = (const ph7_expr_op *)pCur->pUserData;` |
|         - |  983 | `		/* Advance the stream cursor */` |
|  19211767 |  984 | `		pCur++;` |
|  57934548 |  985 | `	}else if( pCur->nType & PH7_TK_DOLLAR ){` |
|         - |  986 | `		/* Isolate variable */` |
|  31800785 |  987 | `		while( pCur < pGen->pEnd && (pCur->nType & PH7_TK_DOLLAR) ){` |
|  15900401 |  988 | `			pCur++; /* Variable variable */` |
|         5 |  989 | `		}` |
|  15900389 |  990 | `		if( pCur < pGen->pEnd ){` |
|  15900389 |  991 | `			if (pCur->nType & (PH7_TK_ID\|PH7_TK_KEYWORD) ){` |
|         - |  992 | `				/* Variable name */` |
|  15900359 |  993 | `				pCur++;` |
|   7950211 |  994 | `			}else if( pCur->nType & PH7_TK_OCB /* '{' */ ){` |
|        26 |  995 | `				pCur++;` |
|         - |  996 | `				/* Dynamic variable name,Collect until the next non nested '}' */` |
|        26 |  997 | `				PH7_DelimitNestedTokens(pCur,pGen->pEnd,PH7_TK_OCB, PH7_TK_CCB,&pCur);` |
|        26 |  998 | `				if( pCur < pGen->pEnd ){` |
|        21 |  999 | `					pCur++;` |
|        12 | 1000 | `				}else{` |
...
|         9 | 1008 | `			}` |
|   7950190 | 1009 | `		}` |
|  15900385 | 1010 | `		pNode->xCode = PH7_CompileVariable;` |
|  40378473 | 1011 | `	 }else if( pCur->nType & PH7_TK_KEYWORD ){` |
|    801343 | 1012 | `		 sxu32 nKeyword = (sxu32)SX_PTR_TO_INT(pCur->pUserData);` |
|    801343 | 1013 | `		 if( bAfterMemberOp ){` |
...
|    125483 | 1018 | `			 ExprAssembleLiteral(&pCur,pGen->pEnd);` |
|    125483 | 1019 | `			 pNode->xCode = PH7_CompileLiteral;` |
|    738604 | 1020 | `		 }else if( nKeyword == PH7_TKWRD_ARRAY \|\|  nKeyword == PH7_TKWRD_LIST ){` |
|         - | 1021 | `			 /* List/Array node */` |
|    282793 | 1022 | `			 if( &pCur[1] >= pGen->pEnd \|\| (pCur[1].nType & PH7_TK_LPAREN) == 0 ){` |
...
|    282793 | 1029 | `				 PH7_DelimitNestedTokens(pCur,pGen->pEnd,PH7_TK_LPAREN /* '(' */, PH7_TK_RPAREN /* ')' */,&pCur);` |
|    282793 | 1030 | `				 if( pCur < pGen->pEnd ){` |
|    282791 | 1031 | `					 pCur++;` |
|    141398 | 1032 | `				 }else{` |
|         - | 1033 | `					 /* Syntax error */` |
...
|         3 | 1040 | `					 return rc;` |
|         - | 1041 | `				 }` |
|    282791 | 1042 | `				 pNode->xCode = (nKeyword == PH7_TKWRD_LIST) ? PH7_CompileList : PH7_CompileArray;` |
|    282791 | 1043 | `				 if( pNode->xCode == PH7_CompileList ){` |
...
|        16 | 1054 | `				 }` |
|         5 | 1055 | `			 }` |
|    534469 | 1056 | `		 }else if( nKeyword == PH7_TKWRD_YIELD ){` |
|         - | 1057 | `			 /* yield expression: collect tokens for the yielded value(s) */` |
|     15573 | 1058 | `			 pCur++; /* Skip 'yield' keyword */` |
|     15573 | 1059 | `			 PH7_DelimitNestedTokens(pCur,pGen->pEnd,` |
|         - | 1060 | `				 PH7_TK_LPAREN\|PH7_TK_OCB\|PH7_TK_OSB,` |
|         - | 1061 | `				 PH7_TK_RPAREN\|PH7_TK_CCB\|PH7_TK_CSB,&pCur);` |
|     15573 | 1062 | `			 pNode->xCode = PH7_CompileYield;` |
|    385293 | 1063 | `		 }else if( nKeyword == PH7_TKWRD_FUNCTION` |
|    377275 | 1064 | `			\|\| ( nKeyword == PH7_TKWRD_STATIC && &pCur[1] < pGen->pEnd` |
|        54 | 1065 | `				 && (pCur[1].nType & PH7_TK_KEYWORD)` |
|        33 | 1066 | `				 && SX_PTR_TO_INT(pCur[1].pUserData) == PH7_TKWRD_FUNCTION ) ){` |
|         - | 1067 | `			 /* Annonymous function: function (...) {...} or static function (...) {...} */` |
|       495 | 1068 | `			  if( &pCur[1] >= pGen->pEnd ){` |
...
|       495 | 1074 | `				 rc = ExprAssembleAnnon(&(*pGen),&pCur,pGen->pEnd);` |
|       495 | 1075 | `				 if( rc != SXRET_OK ){` |
|        28 | 1076 | `					 SyMemBackendPoolFree(&pGen->pVm->sAllocator,pNode);` |
|        28 | 1077 | `					 return rc;` |
|         - | 1078 | `				 }` |
|       471 | 1079 | `				 pNode->xCode = PH7_CompileAnnonFunc;` |
|         - | 1080 | `			  }` |
|    377252 | 1081 | `		 }else if( nKeyword == PH7_TKWRD_CLASS && &pCur[1] < pGen->pEnd` |
...
|    377004 | 1096 | `		 }else if( nKeyword == PH7_TKWRD_FN` |
|    376854 | 1097 | `			\|\| ( nKeyword == PH7_TKWRD_STATIC && &pCur[1] < pGen->pEnd` |
...
|       291 | 1101 | `			 rc = ExprAssembleArrowFunc(&(*pGen),&pCur,pGen->pEnd);` |
|       291 | 1102 | `			 if( rc != SXRET_OK ){` |
|       ! 0 | 1103 | `				 SyMemBackendPoolFree(&pGen->pVm->sAllocator,pNode);` |
|       ! 0 | 1104 | `				 return rc;` |
|         - | 1105 | `			 }` |
|       291 | 1106 | `			 pNode->xCode = PH7_CompileArrowFunc;` |
|    376848 | 1107 | `		 }else if( nKeyword == PH7_TKWRD_MATCH ){` |
...
|    376669 | 1115 | `		 }else if( nKeyword == PH7_TKWRD_THROW ){` |
...
|    376615 | 1124 | `		 }else if( PH7_IsLangConstruct(nKeyword,FALSE) == TRUE && &pCur[1] < pGen->pEnd ){` |
|         - | 1125 | `			 /* Language constructs [i.e: print,echo,die...] require special handling */` |
|        81 | 1126 | `			 PH7_DelimitNestedTokens(pCur,pGen->pEnd,PH7_TK_LPAREN\|PH7_TK_OCB\|PH7_TK_OSB, PH7_TK_RPAREN\|PH7_TK_CCB\|PH7_TK_CSB,&pCur);` |
|        81 | 1127 | `			 pNode->xCode = PH7_CompileLangConstruct;` |
|        43 | 1128 | `		 }else{` |
|         - | 1129 | `			 /* Assume a literal */` |
|    376521 | 1130 | `			 ExprAssembleLiteral(&pCur,pGen->pEnd);` |
|    376521 | 1131 | `			 pNode->xCode = PH7_CompileLiteral;` |
|         5 | 1132 | `		 }` |
|  32027600 | 1133 | `	 }else if( pCur->nType & (PH7_TK_NSSEP\|PH7_TK_ID) ){` |
|         - | 1134 | `		 /* Constants,function name,namespace path,class name... */` |
|  10275105 | 1135 | `		 ExprAssembleLiteral(&pCur,pGen->pEnd);` |
|  10275105 | 1136 | `		 pNode->xCode = PH7_CompileLiteral;` |
|   5137555 | 1137 | `	 }else{` |
|  21351845 | 1138 | `		 if( (pCur->nType & (PH7_TK_LPAREN\|PH7_TK_RPAREN\|PH7_TK_COMMA\|PH7_TK_COLON\|PH7_TK_CSB\|PH7_TK_OCB\|PH7_TK_CCB)) == 0 ){` |
|         - | 1139 | `			 /* Point to the code generator routine */` |
|   7059225 | 1140 | `			 pNode->xCode = PH7_GetNodeHandler(pCur->nType);` |
|   7059225 | 1141 | `			 if( pNode->xCode == 0 ){` |
...
|  67754989 | 1154 | `	pNode->pEnd = pCur;` |
|         - | 1155 | `	/* Save the node for later processing */` |
|  67754989 | 1156 | `	*ppNode = pNode;` |
|         - | 1157 | `	/* Synchronize cursors */` |
|  67754989 | 1158 | `	pGen->pIn = pCur;` |
|  67754989 | 1159 | `	return SXRET_OK;` |
|  33879577 | 1160 | `}` |
|         - | 1161 | `/*` |
...
|         - | 1164 | ` * level is zero.` |
|         - | 1165 | ` */` |
|   1307926 | 1166 | `PH7_PRIVATE sxi32 PH7_GetNextExpr(SyToken *pStart,SyToken *pEnd,SyToken **ppNext)` |
|         5 | 1167 | `{` |
|   1307931 | 1168 | `	SyToken *pCur = pStart;` |
|   1307931 | 1169 | `	sxi32 iNest = 0;` |
|   1307931 | 1170 | `	if( pCur >= pEnd \|\| (pCur->nType & PH7_TK_SEMI/*';'*/) ){` |
|         - | 1171 | `		/* Last expression */` |
|    540887 | 1172 | `		return SXERR_EOF;` |
|         - | 1173 | `	}` |
|   3355091 | 1174 | `	while( pCur < pEnd ){` |
|   3113295 | 1175 | `		if( (pCur->nType & (PH7_TK_COMMA/*','*/\|PH7_TK_SEMI/*';'*/)) && iNest <= 0){` |
|    525253 | 1176 | `			break;` |
|         - | 1177 | `		}` |
|   2588047 | 1178 | `		if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|    212411 | 1179 | `			iNest++;` |
|   2481844 | 1180 | `		}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}*/) ){` |
|    212413 | 1181 | `			iNest--;` |
|    106204 | 1182 | `		}` |
|   2588047 | 1183 | `		pCur++;` |
|         5 | 1184 | `	}` |
|    767049 | 1185 | `	*ppNext = pCur;` |
|    767049 | 1186 | `	return SXRET_OK;` |
|    653968 | 1187 | `}` |
|         - | 1188 | `/*` |
|         - | 1189 | ` * Free an expression tree.` |
|         - | 1190 | ` */` |
|  57890518 | 1191 | `static void ExprFreeTree(ph7_gen_state *pGen,ph7_expr_node *pNode)` |
|         5 | 1192 | `{` |
|  57890523 | 1193 | `	if( pNode->pLeft ){` |
|         - | 1194 | `		/* Release the left tree */` |
|  22985899 | 1195 | `		ExprFreeTree(&(*pGen),pNode->pLeft);` |
|  11492947 | 1196 | `	}` |
|  57890523 | 1197 | `	if( pNode->pRight ){` |
|         - | 1198 | `		/* Release the right tree */` |
|  13371249 | 1199 | `		ExprFreeTree(&(*pGen),pNode->pRight);` |
|   6685622 | 1200 | `	}` |
|  57890523 | 1201 | `	if( pNode->pCond ){` |
|         - | 1202 | `		/* Release the conditional tree used by the ternary operator */` |
|    367711 | 1203 | `		ExprFreeTree(&(*pGen),pNode->pCond);` |
|    183853 | 1204 | `	}` |
|  57890523 | 1205 | `	if( SySetUsed(&pNode->aNodeArgs) > 0 ){` |
|         - | 1206 | `		ph7_expr_node **apArg;` |
|         - | 1207 | `		sxu32 n;` |
|         - | 1208 | `		/* Release node arguments */` |
|   6345713 | 1209 | `		apArg = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  14302189 | 1210 | `		for( n = 0 ; n < SySetUsed(&pNode->aNodeArgs) ; ++n ){` |
|   7956481 | 1211 | `			ExprFreeTree(&(*pGen),apArg[n]);` |
|   3978243 | 1212 | `		}` |
|   6345713 | 1213 | `		SySetRelease(&pNode->aNodeArgs);` |
|   3172854 | 1214 | `	}` |
|         - | 1215 | `	/* Finally,release this node */` |
|  57890523 | 1216 | `	SyMemBackendPoolFree(&pGen->pVm->sAllocator,pNode);` |
|  57890523 | 1217 | `}` |
|         - | 1218 | `/*` |
|         - | 1219 | ` * Free an expression tree.` |
|         - | 1220 | ` * This function is a wrapper around ExprFreeTree() defined above.` |
|         - | 1221 | ` */` |
|  12558738 | 1222 | `PH7_PRIVATE sxi32 PH7_ExprFreeTree(ph7_gen_state *pGen,SySet *pNodeSet)` |
|         5 | 1223 | `{` |
|         - | 1224 | `	ph7_expr_node **apNode;` |
|         - | 1225 | `	sxu32 n;` |
|  12558743 | 1226 | `	apNode = (ph7_expr_node **)SySetBasePtr(pNodeSet);` |
|  80313777 | 1227 | `	for( n = 0  ; n < SySetUsed(pNodeSet) ; ++n ){` |
|  67755039 | 1228 | `		if( apNode[n] ){` |
|  12559083 | 1229 | `			ExprFreeTree(&(*pGen),apNode[n]);` |
|   6279539 | 1230 | `		}` |
|  33877522 | 1231 | `	}` |
|  12558743 | 1232 | `	return SXRET_OK;` |
|         5 | 1233 | `}` |
|         - | 1234 | `/*` |
...
|         - | 1240 | ` */` |
|  16464858 | 1241 | `PH7_PRIVATE int PH7_ExprContainsNullsafe(ph7_expr_node *pNode)` |
|         5 | 1242 | `{` |
|  16464863 | 1243 | `	if( pNode == 0 ){` |
|  10221561 | 1244 | `		return 0;` |
|         - | 1245 | `	}` |
|   6243307 | 1246 | `	if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW ){` |
|        16 | 1247 | `		return 1;` |
|         - | 1248 | `	}` |
|   6243295 | 1249 | `	if( PH7_ExprContainsNullsafe(pNode->pLeft) ){` |
|         6 | 1250 | `		return 1;` |
|         - | 1251 | `	}` |
|   6243291 | 1252 | `	if( PH7_ExprContainsNullsafe(pNode->pRight) ){` |
|       ! 0 | 1253 | `		return 1;` |
|         - | 1254 | `	}` |
|   6243291 | 1255 | `	return 0;` |
|   8232434 | 1256 | `}` |
|         - | 1257 | `/*` |
|         - | 1258 | ` * Check if the given node is a modifialbe l/r-value.` |
|         - | 1259 | ` * Return TRUE if modifiable.FALSE otherwise.` |
|         - | 1260 | ` */` |
|   3948324 | 1261 | `static int ExprIsModifiableValue(ph7_expr_node *pNode,sxu8 bFunc)` |
|         5 | 1262 | `{` |
|         - | 1263 | `	sxi32 iExprOp;` |
|   3948329 | 1264 | `	if( pNode->pOp == 0 ){` |
|   2800461 | 1265 | `		return pNode->xCode == PH7_CompileVariable ? TRUE : FALSE;` |
|         - | 1266 | `	}` |
|   1147873 | 1267 | `	iExprOp = pNode->pOp->iOp;` |
|   1147873 | 1268 | `	if( iExprOp == EXPR_OP_ARROW /*'->' */ \|\| iExprOp == EXPR_OP_DC /*'::'*/ ){` |
|    801727 | 1269 | `			return TRUE;` |
|         - | 1270 | `	}` |
|    346151 | 1271 | `	if( iExprOp == EXPR_OP_SUBSCRIPT/*'[]'*/ ){` |
|    346145 | 1272 | `		if( pNode->pLeft->pOp ) {` |
|    117758 | 1273 | `			if( pNode->pLeft->pOp->iOp != EXPR_OP_SUBSCRIPT /*'['*/ && pNode->pLeft->pOp->iOp != EXPR_OP_ARROW /*'->'*/` |
|     49384 | 1274 | `				&& pNode->pLeft->pOp->iOp != EXPR_OP_DC /*'::'*/){` |
|       ! 0 | 1275 | `				return FALSE;` |
|         5 | 1276 | `			}` |
|    287266 | 1277 | `		}else if( pNode->pLeft->xCode != PH7_CompileVariable ){` |
|       ! 0 | 1278 | `			return FALSE;` |
|         - | 1279 | `		}` |
|    346145 | 1280 | `		return TRUE;` |
|         - | 1281 | `	}` |
...
|         - | 1298 | ` */` |
|   4004484 | 1299 | `static sxi32 ExprProcessFuncArguments(ph7_gen_state *pGen,ph7_expr_node *pOp,ph7_expr_node **apNode,sxi32 nToken)` |
|         5 | 1300 | `{` |
...
|   4004489 | 1304 | `	iCur = 0;` |
|   4809856 | 1305 | `	for(;;){` |
|   9619717 | 1306 | `		if( iCur >= nToken ){` |
|         - | 1307 | `			/* No more arguments to process */` |
|   4004463 | 1308 | `			break;` |
|         - | 1309 | `		}` |
|   5615259 | 1310 | `		iNode = iCur;` |
|   5615259 | 1311 | `		iNest = 0;` |
|  18781039 | 1312 | `		while( iCur < nToken ){` |
|  14776579 | 1313 | `			if( apNode[iCur] ){` |
|  14730849 | 1314 | `				if( (apNode[iCur]->pStart->nType & PH7_TK_COMMA) && apNode[iCur]->pLeft == 0 && iNest <= 0 ){` |
|    805402 | 1315 | `					break;` |
|  13120050 | 1316 | `				}else if( (apNode[iCur]->pStart->nType & (PH7_TK_LPAREN\|PH7_TK_OSB\|PH7_TK_OCB))` |
|   7072579 | 1317 | `					&& apNode[iCur]->xCode != PH7_CompileShortArray` |
|   1022682 | 1318 | `					&& apNode[iCur]->xCode != PH7_CompileShortList ){` |
...
|   1020251 | 1325 | `					iNest++;` |
|  12609932 | 1326 | `				}else if( apNode[iCur]->pStart->nType & (PH7_TK_RPAREN\|PH7_TK_CCB\|PH7_TK_CSB) ){` |
|   1020251 | 1327 | `					iNest--;` |
|    510123 | 1328 | `				}` |
|   6560025 | 1329 | `			}` |
|  13165785 | 1330 | `			iCur++;` |
|         5 | 1331 | `		}` |
|   5615259 | 1332 | `		if( iCur > iNode ){` |
|   5615253 | 1333 | `			SyString sArgName = {0, 0};` |
...
|   5615248 | 1337 | `			if( (iCur - iNode) >= 2` |
|   3884090 | 1338 | `				&& apNode[iNode]` |
|   2152918 | 1339 | `				&& (apNode[iNode]->pStart->nType & (PH7_TK_ID\|PH7_TK_KEYWORD))` |
|   1142264 | 1340 | `				&& apNode[iNode]->xCode == PH7_CompileLiteral` |
|    131370 | 1341 | `				&& apNode[iNode+1]` |
|    131121 | 1342 | `				&& (apNode[iNode+1]->pStart->nType & PH7_TK_COLON) ){` |
...
|         - | 1361 | `				}` |
|       142 | 1362 | `			}` |
|   5615246 | 1363 | `			if( apNode[iNode] && (apNode[iNode]->pStart->nType & PH7_TK_AMPER /*'&'*/) && ((iCur - iNode) == 2)` |
...
|   5615251 | 1380 | `				int bSpreadArg = 0;` |
|         - | 1381 | `				sxi32 iScan;` |
|   5615279 | 1382 | `				for( iScan = iNode ; iScan < iCur ; iScan++ ){` |
|   5615279 | 1383 | `					if( apNode[iScan] ){` |
|   5615251 | 1384 | `						bSpreadArg = (apNode[iScan]->iFlags & EXPR_NODE_SPREAD) != 0;` |
|   5615251 | 1385 | `						break;` |
|         - | 1386 | `					}` |
|        15 | 1387 | `				}` |
|   5615251 | 1388 | `				ExprMakeTree(&(*pGen),&apNode[iNode],iCur-iNode);` |
|   5615251 | 1389 | `				if( bSpreadArg && apNode[iNode] ){` |
|      3985 | 1390 | `					apNode[iNode]->iFlags \|= EXPR_NODE_SPREAD;` |
|      1990 | 1391 | `				}` |
|         - | 1392 | `			}` |
|   5615251 | 1393 | `			if( apNode[iNode] ){` |
|   5615251 | 1394 | `				if( sArgName.nByte > 0 ){` |
...
|   5615251 | 1399 | `				SySetPut(&pOp->aNodeArgs,(const void *)&apNode[iNode]);` |
|   2807628 | 1400 | `			}else{` |
...
|   5615251 | 1419 | `		if( iCur < nToken && apNode[iCur] && (apNode[iCur]->pStart->nType & PH7_TK_COMMA) ){` |
|   1610793 | 1420 | `			iCur++;` |
|   1610793 | 1421 | `			if( iCur >= nToken ){` |
|         - | 1422 | `				/* Trailing comma after last argument */` |
|        19 | 1423 | `				break;` |
|         - | 1424 | `			}` |
|    805385 | 1425 | `		}` |
|         5 | 1426 | `	}` |
|   4004481 | 1427 | `	return SXRET_OK;` |
|   2002247 | 1428 | `}` |
|         - | 1429 | ` /*` |
...
|         - | 1433 | `  */` |
|  21689522 | 1434 | ` static sxi32 ExprMakeTree(ph7_gen_state *pGen,ph7_expr_node **apNode,sxi32 nToken)` |
|         5 | 1435 | ` {` |
...
|         - | 1439 | `	 sxi32 iCur;` |
|         - | 1440 | `	 sxi32 rc;` |
|  21689527 | 1441 | `	 if( nToken <= 0 \|\| (nToken == 1 && apNode[0]->xCode) ){` |
|         - | 1442 | `		 /* TICKET 1433-17: self evaluating node */` |
|   9423931 | 1443 | `		 return SXRET_OK;` |
|         - | 1444 | `	 }` |
|         - | 1445 | `	 /* Process expressions enclosed in parenthesis first */` |
|  88462043 | 1446 | `	 for( iCur =  0 ; iCur < nToken ; ++iCur ){` |
|         - | 1447 | `		 sxi32 iNest;` |
...
|         - | 1450 | `		  */` |
|  76196449 | 1451 | `		 if( apNode[iCur] == 0 \|\| apNode[iCur]->pStart->nType != PH7_TK_LPAREN ){` |
|  75875477 | 1452 | `			 continue;` |
|         - | 1453 | `		 }` |
|    320977 | 1454 | `		 iNest = 1;` |
|    320977 | 1455 | `		 iLeft = iCur;` |
|         - | 1456 | `		 /* Find the closing parenthesis */` |
|    320977 | 1457 | `		 iCur++;` |
|   2850833 | 1458 | `		 while( iCur < nToken ){` |
|   2850833 | 1459 | `			 if( apNode[iCur] ){` |
|   2850833 | 1460 | `				 if( apNode[iCur]->pStart->nType & PH7_TK_RPAREN /* ')' */){` |
|         - | 1461 | `					 /* Decrement nesting level */` |
|    447427 | 1462 | `					 iNest--;` |
|    447427 | 1463 | `					 if( iNest <= 0 ){` |
|    320977 | 1464 | `						 break;` |
|         5 | 1465 | `					 }` |
|   2466636 | 1466 | `				 }else if( apNode[iCur]->pStart->nType & PH7_TK_LPAREN /* '(' */ ){` |
...
|   2529861 | 1471 | `			 iCur++;` |
|         5 | 1472 | `		 }` |
|    320977 | 1473 | `		 if( iCur - iLeft > 1 ){` |
|         - | 1474 | `			 sxi32 j;` |
|         - | 1475 | `			 /* Recurse and process this expression */` |
|    320977 | 1476 | `			 rc = ExprMakeTree(&(*pGen),&apNode[iLeft + 1],iCur - iLeft - 1);` |
|    320977 | 1477 | `			 if( rc != SXRET_OK ){` |
|         3 | 1478 | `				 return rc;` |
|         - | 1479 | `			 }` |
...
|    320975 | 1486 | `			 for( j = iLeft + 1 ; j < iCur ; ++j ){` |
|    320975 | 1487 | `				 if( apNode[j] ){` |
|    320975 | 1488 | `					 apNode[j]->iFlags \|= EXPR_NODE_PARENS` |
|    320970 | 1489 | `						 \| (apNode[iLeft]->iFlags & EXPR_NODE_SPREAD);` |
|    320975 | 1490 | `					 break;` |
|         - | 1491 | `				 }` |
|       ! 0 | 1492 | `			 }` |
|    160485 | 1493 | `		 }` |
|         - | 1494 | `		 /* Free the left and right nodes */` |
|    320975 | 1495 | `		 ExprFreeTree(&(*pGen),apNode[iLeft]);` |
|    320975 | 1496 | `		 ExprFreeTree(&(*pGen),apNode[iCur]);` |
|    320975 | 1497 | `		 apNode[iLeft] = 0;` |
|    320975 | 1498 | `		 apNode[iCur] = 0;` |
|    160490 | 1499 | `	 }` |
|         - | 1500 | `	  /* Process expressions enclosed in braces */` |
|  91069117 | 1501 | `	 for( iCur =  0 ; iCur < nToken ; ++iCur ){` |
|         - | 1502 | `		 sxi32 iNest;` |
...
|         - | 1505 | `		  */` |
|  79039659 | 1506 | `		 if( apNode[iCur] == 0 \|\| apNode[iCur]->pStart->nType != PH7_TK_OCB ){` |
|  79035855 | 1507 | `			 continue;` |
|         - | 1508 | `		 }` |
|      3809 | 1509 | `		 iNest = 1;` |
|      3809 | 1510 | `		 iLeft = iCur;` |
|         - | 1511 | `		 /* Find the closing parenthesis */` |
|      3809 | 1512 | `		 iCur++;` |
|      7611 | 1513 | `		 while( iCur < nToken ){` |
|      7611 | 1514 | `			 if( apNode[iCur] ){` |
|      7611 | 1515 | `				 if( apNode[iCur]->pStart->nType & PH7_TK_CCB/*'}'*/){` |
|         - | 1516 | `					 /* Decrement nesting level */` |
|      3809 | 1517 | `					 iNest--;` |
|      3809 | 1518 | `					 if( iNest <= 0 ){` |
|      3809 | 1519 | `						 break;` |
|       ! 0 | 1520 | `					 }` |
|      3807 | 1521 | `				 }else if( apNode[iCur]->pStart->nType & PH7_TK_OCB /*'{'*/ ){` |
...
|      3807 | 1526 | `			 iCur++;` |
|         5 | 1527 | `		 }` |
|      3809 | 1528 | `		 if( iCur - iLeft > 1 ){` |
|         - | 1529 | `			 /* Recurse and process this expression */` |
|      3807 | 1530 | `			 rc = ExprMakeTree(&(*pGen),&apNode[iLeft + 1],iCur - iLeft - 1);` |
|      3807 | 1531 | `			 if( rc != SXRET_OK ){` |
|       ! 0 | 1532 | `				 return rc;` |
|         - | 1533 | `			 }` |
|      1901 | 1534 | `		 }` |
|         - | 1535 | `		 /* Free the left and right nodes */` |
|      3809 | 1536 | `		 ExprFreeTree(&(*pGen),apNode[iLeft]);` |
|      3809 | 1537 | `		 ExprFreeTree(&(*pGen),apNode[iCur]);` |
|      3809 | 1538 | `		 apNode[iLeft] = 0;` |
|      3809 | 1539 | `		 apNode[iCur] = 0;` |
|      1907 | 1540 | `	 }` |
|         - | 1541 | `	 /* Handle postfix [i.e: function call,subscripting,member access] operators with precedence 2 */` |
|  12029463 | 1542 | `	 iLeft = -1;` |
|  91076687 | 1543 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  79047241 | 1544 | `		 if( apNode[iCur] == 0 ){` |
|  34665277 | 1545 | `			 continue;` |
|         - | 1546 | `		 }` |
|  44381969 | 1547 | `		 pNode = apNode[iCur];` |
|  44381969 | 1548 | `		 if( pNode->pOp && pNode->pOp->iPrec == 2 && pNode->pLeft == 0  ){` |
|  12744347 | 1549 | `			 if( pNode->pOp->iOp == EXPR_OP_FUNC_CALL ){` |
|         - | 1550 | `				 /* Collect function arguments */` |
|   5388961 | 1551 | `				 sxi32 iPtr = 0;` |
|   5388961 | 1552 | `				 sxi32 nFuncTok = 0;` |
|  25554493 | 1553 | `				 while( nFuncTok + iCur < nToken ){` |
|  25554493 | 1554 | `					 if( apNode[nFuncTok+iCur] ){` |
|  25508763 | 1555 | `						 if( apNode[nFuncTok+iCur]->pStart->nType & PH7_TK_LPAREN /*'('*/ ){` |
|   5698845 | 1556 | `							 iPtr++;` |
|  22659343 | 1557 | `						 }else if ( apNode[nFuncTok+iCur]->pStart->nType & PH7_TK_RPAREN /*')'*/){` |
|   5698845 | 1558 | `							 iPtr--;` |
|   5698845 | 1559 | `							 if( iPtr <= 0 ){` |
|   5388961 | 1560 | `								 break;` |
|         - | 1561 | `							 }` |
|    154942 | 1562 | `						 }` |
|  10059901 | 1563 | `					 }` |
|  20165537 | 1564 | `					 nFuncTok++;` |
|         5 | 1565 | `				 }` |
|   5388961 | 1566 | `				 if( nFuncTok + iCur >= nToken ){` |
|         - | 1567 | `					 /* Syntax error */` |
...
|       ! 0 | 1572 | `					 return rc;` |
|         - | 1573 | `				 }` |
|   5388961 | 1574 | `				 if(  iLeft < 0 \|\| !NODE_ISTERM(iLeft) /*\|\| ( apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec != 2)*/ ){` |
|         - | 1575 | `					 /* Syntax error */` |
...
|       ! 0 | 1580 | `					 return rc;` |
|         - | 1581 | `				 }` |
|   5388961 | 1582 | `				 if( nFuncTok > 1 ){` |
|         - | 1583 | `					 /* Process function arguments */` |
|   4004489 | 1584 | `					 rc = ExprProcessFuncArguments(&(*pGen),pNode,&apNode[iCur+1],nFuncTok-1);` |
|   4004489 | 1585 | `					 if( rc != SXRET_OK ){` |
|        11 | 1586 | `						 return rc;` |
|         - | 1587 | `					 }` |
|   2002238 | 1588 | `				 }` |
|         - | 1589 | `				 /* Link the node to the tree */` |
|   5388953 | 1590 | `				 pNode->pLeft = apNode[iLeft];` |
|   5388953 | 1591 | `				 apNode[iLeft] = 0;` |
|  25554461 | 1592 | `				 for( iPtr = 1; iPtr <= nFuncTok ; iPtr++ ){` |
|  20165513 | 1593 | `					 apNode[iCur+iPtr] = 0;` |
|  10082759 | 1594 | `				 }` |
...
|         - | 1605 | `				 {` |
|   5388953 | 1606 | `					 sxi32 iNew = iLeft - 1;` |
|   7198319 | 1607 | `					 while( iNew >= 0 && apNode[iNew] == 0 ){` |
|   1809371 | 1608 | `						 iNew--;` |
|         5 | 1609 | `					 }` |
|   5388948 | 1610 | `					 if( iNew >= 0 && apNode[iNew]->pOp` |
|   3197016 | 1611 | `						 && apNode[iNew]->pOp->iOp == EXPR_OP_NEW` |
|   1949021 | 1612 | `						 && apNode[iNew]->pLeft == 0 ){` |
|    708627 | 1613 | `						 apNode[iNew]->pLeft = pNode; /* new -> ClassName(args) */` |
|    708627 | 1614 | `						 apNode[iCur] = apNode[iNew]; /* relocate onto the call slot */` |
|    708627 | 1615 | `						 apNode[iNew] = 0;` |
|    708627 | 1616 | `						 pNode = apNode[iCur];` |
|    354316 | 1617 | `					 }` |
|         - | 1618 | `				 }` |
|  10049865 | 1619 | `			 }else if (pNode->pOp->iOp == EXPR_OP_SUBSCRIPT ){` |
|         - | 1620 | `				 /* Subscripting */` |
|   2497091 | 1621 | `				 sxi32 iArrTok = iCur + 1;` |
|   2497091 | 1622 | `				 sxi32 iNest = 1;` |
|   2497086 | 1623 | `				 if(  iLeft < 0 \|\| apNode[iLeft] == 0 \|\| (apNode[iLeft]->pOp == 0 && (apNode[iLeft]->xCode != PH7_CompileVariable &&` |
...
|   2497086 | 1627 | `					 ( apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec != 2 /* postfix */` |
|         - | 1628 | ``						 /* PHP 8.4: a folded `new C()` (precedence-1 op) is a valid`` |
|         - | 1629 | ``						  * subscript base — `new C()[0]` means `(new C())[0]`. */`` |
|    298235 | 1630 | `						 && apNode[iLeft]->pOp->iOp != EXPR_OP_NEW ) ){` |
|         - | 1631 | `						 /* Syntax error */` |
...
|   5278805 | 1639 | `				 while( iArrTok < nToken ){` |
|   5278805 | 1640 | `					 if( apNode[iArrTok] ){` |
|   5278773 | 1641 | `						 if( apNode[iArrTok]->pOp && apNode[iArrTok]->pOp->iOp == EXPR_OP_SUBSCRIPT &&  apNode[iArrTok]->pLeft == 0){` |
|         - | 1642 | `							 /* Increment nesting level */` |
|     18985 | 1643 | `							 iNest++;` |
|   5269283 | 1644 | `						 }else if( apNode[iArrTok]->pStart->nType & PH7_TK_CSB /*']'*/){` |
|         - | 1645 | `							 /* Decrement nesting level */` |
|   2516071 | 1646 | `							 iNest--;` |
|   2516071 | 1647 | `							 if( iNest <= 0 ){` |
|   2497091 | 1648 | `								 break;` |
|         - | 1649 | `							 }` |
|      9490 | 1650 | `						 }` |
|   1390841 | 1651 | `					 }` |
|   2781719 | 1652 | `					 ++iArrTok;` |
|         5 | 1653 | `				 }` |
|   2497091 | 1654 | `				 if( iArrTok > iCur + 1 ){` |
|         - | 1655 | `					 /* Recurse and process this expression */` |
|   2341235 | 1656 | `					 rc = ExprMakeTree(&(*pGen),&apNode[iCur+1],iArrTok - iCur - 1);` |
|   2341235 | 1657 | `					 if( rc != SXRET_OK ){` |
|       ! 0 | 1658 | `						 return rc;` |
|         - | 1659 | `					 }` |
|         - | 1660 | `					 /* Link the node to it's index */` |
|   2341235 | 1661 | `					 SySetPut(&pNode->aNodeArgs,(const void *)&apNode[iCur+1]);` |
|   1170615 | 1662 | `				 }` |
|         - | 1663 | `				 /* Link the node to the tree */` |
|   2497091 | 1664 | `				 pNode->pLeft = apNode[iLeft];` |
|   2497091 | 1665 | `				 pNode->pRight = 0;` |
|   2497091 | 1666 | `				 apNode[iLeft] = 0;` |
|   7775891 | 1667 | `				 for( iNest = iCur + 1 ; iNest <= iArrTok ; ++iNest ){` |
|   5278805 | 1668 | `					 apNode[iNest] = 0;` |
|   2639405 | 1669 | `				 }` |
|   1248548 | 1670 | `			 }else{` |
|         - | 1671 | `				 /* Member access operators [i.e: '->','::'] */` |
|   4858305 | 1672 | `				  iRight = iCur + 1;` |
|   4862107 | 1673 | `				 while( iRight < nToken && apNode[iRight] == 0 ){` |
|      3807 | 1674 | `					 iRight++;` |
|         5 | 1675 | `				 }` |
|   4858305 | 1676 | `				 if( iRight >= nToken \|\| iLeft < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|         - | 1677 | `					 /* Syntax error */` |
...
|   4858301 | 1685 | `				 pNode->pLeft = apNode[iLeft];` |
|   4858296 | 1686 | `				 if( (pNode->pOp->iOp == EXPR_OP_ARROW /*'->'*/ \|\| pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW /*'?->'*/)` |
|   4679443 | 1687 | `					 && pNode->pLeft->pOp == 0 &&` |
|   4424129 | 1688 | `					 pNode->pLeft->xCode != PH7_CompileVariable &&` |
...
|       ! 0 | 1700 | `						 return rc;` |
|         - | 1701 | `				 }` |
|   4858301 | 1702 | `				 pNode->pRight = apNode[iRight];` |
|   4858301 | 1703 | `				 apNode[iLeft] = apNode[iRight] = 0;` |
|         - | 1704 | `			 }` |
|   6372165 | 1705 | `		 }` |
|  44381957 | 1706 | `		 iLeft = iCur;` |
|  22190981 | 1707 | `	 }` |
|         - | 1708 | `	 /* Handle left associative (new, clone) operators */` |
|  91076655 | 1709 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  79047209 | 1710 | `		 if( apNode[iCur] == 0 ){` |
|  48171737 | 1711 | `			 continue;` |
|         - | 1712 | `		 }` |
|  30875477 | 1713 | `		 pNode = apNode[iCur];` |
|  30875477 | 1714 | `		 if( pNode->pOp && pNode->pOp->iPrec == 1 && pNode->pLeft == 0 ){` |
|         - | 1715 | `			 SyToken *pToken;` |
|         - | 1716 | `			 /* Get the left node */` |
|     53513 | 1717 | `			 iLeft = iCur + 1;` |
|     53521 | 1718 | `			 while( iLeft < nToken && apNode[iLeft] == 0 ){` |
|         9 | 1719 | `				 iLeft++;` |
|         1 | 1720 | `			 }` |
|     53513 | 1721 | `			 if( iLeft >= nToken \|\| !NODE_ISTERM(iLeft) ){` |
|         - | 1722 | `				  /* Syntax error */` |
...
|     53513 | 1731 | `			 if( pNode->pOp->iOp == EXPR_OP_CLONE ){` |
|         - | 1732 | `				 /* Clone:` |
...
|         - | 1741 | `				  */` |
|     53189 | 1742 | `				 if( apNode[iLeft]->pOp == 0 ){` |
|     53183 | 1743 | `					 if( apNode[iLeft]->xCode != PH7_CompileVariable  ){` |
...
|     26597 | 1753 | `			 }else{` |
|         - | 1754 | `				 /* New */` |
|       324 | 1755 | `				 if( apNode[iLeft]->pOp && apNode[iLeft]->pOp->iOp == EXPR_OP_NEW` |
...
|       ! 0 | 1770 | `					 return rc;` |
|         - | 1771 | `				 }` |
|       329 | 1772 | `				 if( apNode[iLeft]->pOp == 0 ){` |
|       329 | 1773 | `					 ProcNodeConstruct xCons = apNode[iLeft]->xCode;` |
|       324 | 1774 | `					 if( xCons != PH7_CompileVariable && xCons != PH7_CompileLiteral && xCons != PH7_CompileSimpleString` |
...
|     53513 | 1789 | `			 pNode->pLeft = apNode[iLeft];` |
|     53513 | 1790 | `			 apNode[iLeft] = 0;` |
|     53513 | 1791 | `			 pNode->pRight = 0; /* Paranoid */` |
|     26754 | 1792 | `		 }` |
|  15437741 | 1793 | `	 }` |
|         - | 1794 | `	  /* Handle post/pre icrement/decrement [i.e: ++/--] operators with precedence 3 */` |
|  12029451 | 1795 | `	 iLeft = -1;` |
|  91194723 | 1796 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  79047209 | 1797 | `		 if( apNode[iCur] == 0 ){` |
|  48171737 | 1798 | `			 continue;` |
|         - | 1799 | `		 }` |
|  30875477 | 1800 | `		 pNode = apNode[iCur];` |
|  30875477 | 1801 | `		 if( pNode->pOp && pNode->pOp->iPrec == 3 && pNode->pLeft == 0){` |
|    144749 | 1802 | `			 if( iLeft >= 0 && ((apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec == 2 /* Postfix */)` |
|    125711 | 1803 | `				 \|\| apNode[iLeft]->xCode == PH7_CompileVariable) ){` |
|         - | 1804 | `					 /* Link the node to the tree */` |
|    133329 | 1805 | `					 pNode->pLeft = apNode[iLeft];` |
|    133329 | 1806 | `					 apNode[iLeft] = 0;` |
|     66662 | 1807 | `			 }` |
|    190440 | 1808 | `		  }` |
|  30993545 | 1809 | `		 iLeft = iCur;` |
|  15555809 | 1810 | `	  }` |
|  12147519 | 1811 | `	 iLeft = -1;` |
|  91194723 | 1812 | `	 for( iCur = nToken -  1 ; iCur >= 0 ; iCur-- ){` |
|  79047209 | 1813 | `		 if( apNode[iCur] == 0 ){` |
|  48305061 | 1814 | `			 continue;` |
|         - | 1815 | `		 }` |
|  30742153 | 1816 | `		 pNode = apNode[iCur];` |
|  30742153 | 1817 | `		 if( pNode->pOp && pNode->pOp->iPrec == 3 && pNode->pLeft == 0){` |
|     11420 | 1818 | `			 if( iLeft < 0 \|\| (apNode[iLeft]->pOp == 0 && apNode[iLeft]->xCode != PH7_CompileVariable)` |
|     11425 | 1819 | `				 \|\| ( apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec != 2 /* Postfix */) ){` |
|         - | 1820 | `					 /* Syntax error */` |
...
|     11425 | 1828 | `			 pNode->pLeft = apNode[iLeft];` |
|     11425 | 1829 | `			 apNode[iLeft] = 0;` |
|         - | 1830 | `			 /* Mark as pre-increment/decrement node */` |
|     11425 | 1831 | `			 pNode->iFlags \|= EXPR_NODE_PRE_INCR;` |
|      5710 | 1832 | `		  }` |
|  30742153 | 1833 | `		 iLeft = iCur;` |
|  15371079 | 1834 | `	 }` |
|         - | 1835 | `	 /* Handle right associative unary and cast operators [i.e: !,(string),~...]  with precedence 4*/` |
|  12147519 | 1836 | `	  iLeft = 0;` |
|  91194717 | 1837 | `	  for( iCur = nToken -  1 ; iCur >= 0 ; iCur-- ){` |
|  79047205 | 1838 | `		  if( apNode[iCur] ){` |
|  30730729 | 1839 | `			  pNode = apNode[iCur];` |
|  30730729 | 1840 | `			  if( pNode->pOp && pNode->pOp->iPrec == 4 && pNode->pLeft == 0){` |
|    825615 | 1841 | `				  if( iLeft > 0 ){` |
|         - | 1842 | `					  /* Link the node to the tree */` |
|    825613 | 1843 | `					  pNode->pLeft = apNode[iLeft];` |
|    825613 | 1844 | `					  apNode[iLeft] = 0;` |
|    825613 | 1845 | `					  if( pNode->pLeft && pNode->pLeft->pOp && pNode->pLeft->pOp->iPrec > 4 ){` |
|     53237 | 1846 | `						  if( pNode->pLeft->pLeft == 0 \|\| pNode->pLeft->pRight == 0 ){` |
|         - | 1847 | `							   /* Syntax error */` |
...
|  91194715 | 1872 | `	 for( iCur = nToken - 1 ; iCur >= 0 ; --iCur ){` |
|  79047203 | 1873 | `		 if( apNode[iCur] == 0 ){` |
|  49142201 | 1874 | `			 continue;` |
|         - | 1875 | `		 }` |
|  29905007 | 1876 | `		 pNode = apNode[iCur];` |
|  29905007 | 1877 | `		 if( pNode->pOp && pNode->pOp->iPrec == 5 && pNode->pLeft == 0 ){` |
|         - | 1878 | `			 sxi32 iL, iR;` |
|         - | 1879 | `			 /* Find the right operand */` |
|       113 | 1880 | `			 iR = -1;` |
|         - | 1881 | `			 {` |
|         - | 1882 | `				 sxi32 j;` |
|       125 | 1883 | `				 for( j = iCur + 1 ; j < nToken ; ++j ){` |
|       125 | 1884 | `					 if( apNode[j] ){ iR = j; break; }` |
|         7 | 1885 | `				 }` |
|         - | 1886 | `			 }` |
...
|         - | 1889 | `			 {` |
|         - | 1890 | `				 sxi32 j;` |
|       181 | 1891 | `				 for( j = iCur - 1 ; j >= 0 ; --j ){` |
|       181 | 1892 | `					 if( apNode[j] ){ iL = j; break; }` |
|        35 | 1893 | `				 }` |
|         - | 1894 | `			 }` |
|       113 | 1895 | `			 if( iR < 0 \|\| iL < 0 \|\| !NODE_ISTERM(iR) \|\| !NODE_ISTERM(iL) ){` |
...
|       ! 0 | 1900 | `				 return rc;` |
|         - | 1901 | `			 }` |
|       113 | 1902 | `			 pNode->pLeft  = apNode[iL];` |
|       113 | 1903 | `			 pNode->pRight = apNode[iR];` |
|       113 | 1904 | `			 apNode[iL] = 0;` |
|       113 | 1905 | `			 apNode[iR] = 0;` |
...
|       112 | 1917 | `			 if( pNode->pLeft && pNode->pLeft->pOp` |
|        74 | 1918 | `				 && pNode->pLeft->pOp->iPrec == 4` |
...
| 133622551 | 1940 | `	 for( i = 7 ; i < 17 ; i++ ){` |
| 121475049 | 1941 | `		 iLeft = -1;` |
| 911946735 | 1942 | `		 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
| 790471701 | 1943 | `			 if( apNode[iCur] == 0 ){` |
| 542927525 | 1944 | `				 continue;` |
|         - | 1945 | `			 }` |
| 247544181 | 1946 | `			 pNode = apNode[iCur];` |
| 247544181 | 1947 | `			 if( pNode->pOp && pNode->pOp->iPrec == i && pNode->pLeft == 0 ){` |
|         - | 1948 | `				 /* Get the right node */` |
|   4196887 | 1949 | `				 iRight = iCur + 1;` |
|   6535387 | 1950 | `				 while( iRight < nToken && apNode[iRight] == 0 ){` |
|   2338505 | 1951 | `					 iRight++;` |
|         5 | 1952 | `				 }` |
|   4196887 | 1953 | `				 if( iRight >= nToken \|\| iLeft < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|         - | 1954 | `					 /* Syntax error */` |
...
|        11 | 1959 | `					 return rc;` |
|         - | 1960 | `				 }` |
|   4196879 | 1961 | `				 if( pNode->pOp->iOp == EXPR_OP_REF ){` |
|         - | 1962 | `					 sxi32  iTmp;` |
...
|   4196877 | 2003 | `				 pNode->pLeft = apNode[iLeft];` |
|   4196877 | 2004 | `				 pNode->pRight = apNode[iRight];` |
|   4196877 | 2005 | `				 apNode[iLeft] = apNode[iRight] = 0;` |
|   2098436 | 2006 | `			 }` |
| 247544171 | 2007 | `			 iLeft = iCur;` |
| 123772088 | 2008 | `		 }` |
|  60737522 | 2009 | `	 }` |
...
|         - | 2013 | `	  */` |
|  12147507 | 2014 | `	  iLeft = -1;` |
|  88223443 | 2015 | `	  for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  76443649 | 2016 | `		  if( apNode[iCur] == 0 ){` |
|  56031815 | 2017 | `			  continue;` |
|         - | 2018 | `		  }` |
|  20411839 | 2019 | `		  pNode = apNode[iCur];` |
|  20411839 | 2020 | `		  if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_QUESTY && pNode->pLeft == 0 ){` |
|    367713 | 2021 | `			  sxi32 iNest = 1;` |
|    367713 | 2022 | `			  if( iLeft < 0 \|\| !NODE_ISTERM(iLeft) ){` |
...
|    367711 | 2031 | `			  iRight = iCur + 1;` |
|   1441775 | 2032 | `			  while( iRight < nToken  ){` |
|   1441775 | 2033 | `				  if( apNode[iRight] ){` |
|    731553 | 2034 | `					  if( apNode[iRight]->pOp && apNode[iRight]->pOp->iOp == EXPR_OP_QUESTY && apNode[iRight]->pCond == 0){` |
|         - | 2035 | `						  /* Increment nesting level */` |
|       ! 0 | 2036 | `						  ++iNest;` |
|    731553 | 2037 | `					  }else if( apNode[iRight]->pStart->nType & PH7_TK_COLON /*:*/ ){` |
|         - | 2038 | `						  /* Decrement nesting level */` |
|    367711 | 2039 | `						  --iNest;` |
|    367711 | 2040 | `						  if( iNest <= 0 ){` |
|    367711 | 2041 | `							  break;` |
|         - | 2042 | `						  }` |
|       ! 0 | 2043 | `					  }` |
|    181921 | 2044 | `				  }` |
|   1074069 | 2045 | `				  iRight++;` |
|         5 | 2046 | `			  }` |
|    367711 | 2047 | `			  if( iRight > iCur + 1 ){` |
|         - | 2048 | `				  /* Recurse and process the then expression */` |
|    363847 | 2049 | `				  rc = ExprMakeTree(&(*pGen),&apNode[iCur + 1],iRight - iCur - 1);` |
|    363847 | 2050 | `				  if( rc != SXRET_OK ){` |
|       ! 0 | 2051 | `					  return rc;` |
|         - | 2052 | `				  }` |
|         - | 2053 | `				  /* Link the node to the tree */` |
|    363847 | 2054 | `				  pNode->pLeft = apNode[iCur + 1];` |
|    181921 | 2055 | `			  }else{` |
|         - | 2056 | `				  /* Elvis operator (?:): pLeft stays NULL.` |
|         - | 2057 | `				   * NODE_ISTERM() recognizes this node as complete via pCond. */` |
|         - | 2058 | `			  }` |
|    367711 | 2059 | `			  apNode[iCur + 1] = 0;` |
|    367711 | 2060 | `			  if( iRight + 1 < nToken ){` |
|         - | 2061 | `				  /* Recurse and process the else expression */` |
|    367711 | 2062 | `				  rc = ExprMakeTree(&(*pGen),&apNode[iRight + 1],nToken - iRight - 1);` |
|    367711 | 2063 | `				  if( rc != SXRET_OK ){` |
|       ! 0 | 2064 | `					  return rc;` |
|         - | 2065 | `				  }` |
|         - | 2066 | `				  /* Link the node to the tree */` |
|    367711 | 2067 | `				  pNode->pRight = apNode[iRight + 1];` |
|    367711 | 2068 | `				  apNode[iRight + 1] =  apNode[iRight] = 0;` |
|    183858 | 2069 | `			  }else{` |
...
|    367711 | 2077 | `			  pNode->pCond  = apNode[iLeft];` |
|    367711 | 2078 | `			  apNode[iLeft] = 0;` |
|    367711 | 2079 | `			  break;` |
|         - | 2080 | `		  }` |
|  20044131 | 2081 | `		  iLeft = iCur;` |
|  10022068 | 2082 | `	  }` |
...
|         - | 2086 | `	  */` |
|  12147505 | 2087 | `	 iRight = -1;` |
|  91194519 | 2088 | `	 for( iCur = nToken -  1 ; iCur >= 0 ; iCur--){` |
|  79047073 | 2089 | `		 if( apNode[iCur] == 0 ){` |
|  62951223 | 2090 | `			 continue;` |
|         - | 2091 | `		 }` |
|  16095855 | 2092 | `		 pNode = apNode[iCur];` |
|  16095855 | 2093 | `		 if( pNode->pOp && pNode->pOp->iPrec == 18 && pNode->pLeft == 0 ){` |
|         - | 2094 | `			 /* Get the left node */` |
|   3948277 | 2095 | `			 iLeft = iCur - 1;` |
|   5411771 | 2096 | `			 while( iLeft >= 0 && apNode[iLeft] == 0 ){` |
|   1463499 | 2097 | `				 iLeft--;` |
|         5 | 2098 | `			 }` |
|   3948277 | 2099 | `			 if( iLeft < 0 \|\| iRight < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|         - | 2100 | `				 /* Syntax error */` |
...
|         - | 2117 | `			  * a write. */` |
|   3948235 | 2118 | `			 if( PH7_ExprContainsNullsafe(apNode[iLeft]) ){` |
...
|   3948227 | 2131 | `			 pSuppress = 0;` |
|   3948222 | 2132 | `			 if( apNode[iLeft]->pOp` |
|   2548031 | 2133 | `				 && apNode[iLeft]->pOp->iVmOp == PH7_OP_ERR_CTRL` |
|    573920 | 2134 | `				 && apNode[iLeft]->pLeft != 0` |
|         5 | 2135 | `				 && (apNode[iLeft]->iFlags & EXPR_NODE_PARENS) == 0 ){` |
|       ! 0 | 2136 | `				 pSuppress = apNode[iLeft];` |
|       ! 0 | 2137 | `				 apNode[iLeft] = pSuppress->pLeft;` |
|       ! 0 | 2138 | `			 }` |
|   3948227 | 2139 | `			 if( ExprIsModifiableValue(apNode[iLeft],FALSE) == FALSE ){` |
...
|   3948223 | 2158 | `			 pNode->pLeft = apNode[iRight];` |
|   3948223 | 2159 | `			 pNode->pRight = apNode[iLeft];` |
|   3948223 | 2160 | `			 apNode[iLeft] = apNode[iRight] = 0;` |
|   3948223 | 2161 | `			 if( pSuppress ){` |
|         - | 2162 | `				 /* Re-wrap: the '@' now suppresses the whole assignment */` |
|       ! 0 | 2163 | `				 pSuppress->pLeft = pNode;` |
|       ! 0 | 2164 | `				 apNode[iCur] = pSuppress;` |
|       ! 0 | 2165 | `			 }` |
|   1974109 | 2166 | `		 }` |
|  16095801 | 2167 | `		 iRight = iCur;` |
|   8047903 | 2168 | `	 }` |
|         - | 2169 | `	 /* Process left associative binary operators that have the lowest precedence [i.e: and,or,xor] */` |
|  60737235 | 2170 | `	 for( i = 19 ; i < 23 ; i++ ){` |
|  48589789 | 2171 | `		 iLeft = -1;` |
| 364777789 | 2172 | `		 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
| 316188005 | 2173 | `			 if( apNode[iCur] == 0 ){` |
| 267597969 | 2174 | `				 continue;` |
|         - | 2175 | `			 }` |
|  48590041 | 2176 | `			 pNode = apNode[iCur];` |
|  48590041 | 2177 | `			 if( pNode->pOp && pNode->pOp->iPrec == i && pNode->pLeft == 0 ){` |
...
|        24 | 2195 | `			 }` |
|  48590041 | 2196 | `			 iLeft = iCur;` |
|  24295023 | 2197 | `		 }` |
|  24294897 | 2198 | `	 }` |
|         - | 2199 | `	 /* Point to the root of the expression tree */` |
|  79046977 | 2200 | `	 for( iCur = 1 ; iCur < nToken ; ++iCur ){` |
|  66899549 | 2201 | `		 if( apNode[iCur] ){` |
|  11667775 | 2202 | `			 if( (apNode[iCur]->pOp \|\| apNode[iCur]->xCode ) && apNode[0] != 0){` |
...
|        23 | 2207 | `				  return rc;` |
|         - | 2208 | `			 }` |
|  11667757 | 2209 | `			 apNode[0] = apNode[iCur];` |
|  11667757 | 2210 | `			 apNode[iCur] = 0;` |
|   5833876 | 2211 | `		 }` |
|  33449768 | 2212 | `	 }` |
|  12147433 | 2213 | `	 return SXRET_OK;` |
|  10785732 | 2214 | ` }` |
|         - | 2215 | ` /*` |
...
|         - | 2220 | `  */` |
|  12558742 | 2221 | `PH7_PRIVATE sxi32 PH7_ExprMakeTree(ph7_gen_state *pGen,SySet *pExprNode,ph7_expr_node **ppRoot)` |
|         5 | 2222 | `{` |
|         - | 2223 | `	ph7_expr_node **apNode;` |
|         - | 2224 | `	ph7_expr_node *pNode;` |
|         - | 2225 | `	sxi32 rc;` |
|         - | 2226 | `	/* Reset node container */` |
|  12558747 | 2227 | `	SySetReset(pExprNode);` |
|  12558747 | 2228 | `	pNode = 0; /* Prevent compiler warning */` |
|         - | 2229 | `	/* Extract nodes one after one until we hit the end of the input */` |
|         - | 2230 | `	{` |
|  12558747 | 2231 | `		int iLastWasTerm = 0;` |
|  12558747 | 2232 | `		int bAfterMemberOp = 0; /* TRUE iff the previous node was -> / ?-> / :: */` |
|  80313811 | 2233 | `		while( pGen->pIn < pGen->pEnd ){` |
|  67755103 | 2234 | `			rc = ExprExtractNode(&(*pGen),&pNode,iLastWasTerm,bAfterMemberOp);` |
|  67755103 | 2235 | `			if( rc != SXRET_OK ){` |
|        38 | 2236 | `				return rc;` |
|         - | 2237 | `			}` |
|         - | 2238 | `			/* Determine if this node is a term for short-array disambiguation */` |
|  67755069 | 2239 | `			if( pNode->xCode ){` |
|         - | 2240 | `				/* Node with compile handler: variable, literal, string, array, etc. */` |
|  34250687 | 2241 | `				iLastWasTerm = 1;` |
|  50629728 | 2242 | `			}else if( pNode->pOp ){` |
|         - | 2243 | `				/* Operator node */` |
|  19211767 | 2244 | `				iLastWasTerm = 0;` |
|   9605886 | 2245 | `			}else{` |
|         - | 2246 | `				/* Delimiter: ')' and ']' end terms */` |
|  14292625 | 2247 | `				iLastWasTerm = (pNode->pStart->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB)) ? 1 : 0;` |
|         - | 2248 | `			}` |
...
|  67755069 | 2252 | `			bAfterMemberOp = ( pNode->pOp && pNode->pOp->iVmOp == PH7_OP_MEMBER );` |
|         - | 2253 | `			/* Save the extracted node */` |
|  67755069 | 2254 | `			SySetPut(pExprNode,(const void *)&pNode);` |
|         5 | 2255 | `		}` |
|         - | 2256 | `	}` |
|  12558713 | 2257 | `	if( SySetUsed(pExprNode) < 1 ){` |
|         - | 2258 | `		/* Empty expression [i.e: A semi-colon;] */` |
|       ! 0 | 2259 | `		*ppRoot = 0;` |
|       ! 0 | 2260 | `		return SXRET_OK;` |
|         - | 2261 | `	}` |
|  12558713 | 2262 | `	apNode = (ph7_expr_node **)SySetBasePtr(pExprNode);` |
|         - | 2263 | `	/* Make sure we are dealing with valid nodes */` |
|  12558713 | 2264 | `	rc = ExprVerifyNodes(&(*pGen),apNode,(sxi32)SySetUsed(pExprNode));` |
|  12558713 | 2265 | `	if( rc != SXRET_OK ){` |
...
|         - | 2271 | `	}` |
|         - | 2272 | `	/* Build the tree */` |
|  12558661 | 2273 | `	rc = ExprMakeTree(&(*pGen),apNode,(sxi32)SySetUsed(pExprNode));` |
|  12558661 | 2274 | `	if( rc != SXRET_OK ){` |
|         - | 2275 | `		/* Something goes wrong [i.e: Syntax error] */` |
|       103 | 2276 | `		*ppRoot = 0;` |
|       103 | 2277 | `		return rc;` |
|         - | 2278 | `	}` |
|         - | 2279 | `	/* Point to the root of the tree */` |
|  12558563 | 2280 | `	*ppRoot = apNode[0];` |
|  12558563 | 2281 | `	return SXRET_OK;` |
|   6279376 | 2282 | `}` |
|         - | 2283 |  |
