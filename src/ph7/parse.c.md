...
|          - |  272 | ` */` |
|   29172116 |  273 | `PH7_PRIVATE const ph7_expr_op *  PH7_ExprExtractOperator(SyString *pStr,SyToken *pLast)` |
|          5 |  274 | `{` |
|   29172121 |  275 | `	sxu32 n = 0;` |
|          - |  276 | `	sxi32 rc;` |
|          - |  277 | `	/* Do a linear lookup on the operators table */` |
|  460145926 |  278 | `	for(;;){` |
|  920291857 |  279 | `		if( n >= SX_ARRAYSIZE(aOpTable) ){` |
|        ! 0 |  280 | `			break;` |
|          - |  281 | `		}` |
|  920291857 |  282 | `		if( SyisAlpha(aOpTable[n].sOp.zString[0]) ){` |
|          - |  283 | `			/* TICKET 1433-012: Alpha stream operators [i.e: and,or,xor,new...] */` |
|   87983111 |  284 | `			rc = SyStringCmp(pStr,&aOpTable[n].sOp,SyStrnicmp);` |
|   43991558 |  285 | `		}else{` |
|  832308751 |  286 | `			rc = SyStringCmp(pStr,&aOpTable[n].sOp,SyMemcmp);` |
|          - |  287 | `		}` |
|  920291857 |  288 | `		if( rc == 0 ){` |
|   29507103 |  289 | `			if( aOpTable[n].sOp.nByte != sizeof(char) \|\| (aOpTable[n].iOp != EXPR_OP_UMINUS && aOpTable[n].iOp != EXPR_OP_UPLUS) \|\| pLast == 0 ){` |
|          - |  290 | `				/* There is no ambiguity here,simply return the first operator seen */` |
|   29051087 |  291 | `				return &aOpTable[n];` |
|          - |  292 | `			}` |
...
|          4 |  306 | `			}` |
|     167491 |  307 | `		}` |
|  891119741 |  308 | `		++n; /* Next operator in the table */` |
|          5 |  309 | `	}` |
...
|          - |  317 | ` */` |
|    7923858 |  318 | `PH7_PRIVATE void PH7_DelimitNestedTokens(SyToken *pIn,SyToken *pEnd,sxu32 nTokStart,sxu32 nTokEnd,SyToken **ppEnd)` |
|          5 |  319 | `{` |
|    7923863 |  320 | `	SyToken *pCur = pIn;` |
|    7923863 |  321 | `	sxi32 iNest = 1;` |
|   85085516 |  322 | `	for(;;){` |
|  170171037 |  323 | `		if( pCur >= pEnd ){` |
|      16069 |  324 | `			break;` |
|          - |  325 | `		}` |
|  170154973 |  326 | `		if( pCur->nType & nTokStart ){` |
|          - |  327 | `			/* Increment nesting level */` |
|    6560791 |  328 | `			iNest++;` |
|  166874580 |  329 | `		}else if( pCur->nType & nTokEnd ){` |
|          - |  330 | `			/* Decrement nesting level */` |
|   14468585 |  331 | `			iNest--;` |
|   14468585 |  332 | `			if( iNest <= 0 ){` |
|    7907799 |  333 | `				break;` |
|          - |  334 | `			}` |
|    3280393 |  335 | `		}` |
|          - |  336 | `		/* Advance cursor */` |
...
|          - |  373 | ` */` |
|   17120780 |  374 | `static sxi32 ExprVerifyNodes(ph7_gen_state *pGen,ph7_expr_node **apNode,sxi32 nNode)` |
|          5 |  375 | `{` |
|          - |  376 | `	sxi32 iParen,iSquare,iQuesty,iBraces;` |
|          - |  377 | `	sxi32 i,rc;` |
|          - |  378 |  |
|   17120785 |  379 | `	if( nNode > 0 && apNode[0]->pOp && (apNode[0]->pOp->iOp == EXPR_OP_ADD \|\| apNode[0]->pOp->iOp == EXPR_OP_SUB) ){` |
...
|       3901 |  383 | `	}` |
|   17120785 |  384 | `	iParen = iSquare = iQuesty = iBraces = 0;` |
|  107321075 |  385 | `	for( i = 0 ; i < nNode ; ++i ){` |
|   90200331 |  386 | `		if( apNode[i]->xCode == PH7_CompileShortArray \|\| apNode[i]->xCode == PH7_CompileShortList ){` |
|          - |  387 | `			/* Short array/list literal: brackets are self-contained, skip */` |
|     243313 |  388 | `			continue;` |
|          - |  389 | `		}` |
|   89957023 |  390 | `		if( apNode[i]->pStart->nType & PH7_TK_LPAREN /*'('*/){` |
|    7557237 |  391 | `			if( i > 0 && ( apNode[i-1]->xCode == PH7_CompileVariable \|\| apNode[i-1]->xCode == PH7_CompileLiteral \|\|` |
...
|    7065597 |  394 | `					if( (apNode[i - 1]->pStart->nType & PH7_TK_OP) == 0 ){` |
|          - |  395 | `						/* We are dealing with a postfix [i.e: function call]  operator` |
|          - |  396 | `						 * not a simple left parenthesis. Mark the node.` |
|          - |  397 | `						 */` |
|    7065597 |  398 | `						apNode[i]->pStart->nType \|= PH7_TK_OP;` |
|    7065597 |  399 | `						apNode[i]->pStart->pUserData = (void *)&sFCallOp; /* Function call operator */` |
|    7065597 |  400 | `						apNode[i]->pOp = &sFCallOp;` |
|    3532796 |  401 | `					}` |
|    3532796 |  402 | `			}` |
|    7557237 |  403 | `			iParen++;` |
|   86178407 |  404 | `		}else if( apNode[i]->pStart->nType & PH7_TK_RPAREN/*')*/){` |
|    7557237 |  405 | `			if( iParen <= 0 ){` |
...
|          - |  411 | `			}` |
|    7557225 |  412 | `			iParen--;` |
|   78621169 |  413 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OSB /*'['*/){` |
|    3029155 |  414 | `			iSquare++;` |
|   73327984 |  415 | `		}else if (apNode[i]->pStart->nType & PH7_TK_CSB /*']'*/){` |
...
|          - |  422 | `			}` |
|    3029153 |  423 | `			iSquare--;` |
|   70298829 |  424 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OCB /*'{'*/){` |
|       3899 |  425 | `			iBraces++;` |
...
|          3 |  434 | `				return rc;` |
|          5 |  435 | `			}` |
|   68782307 |  436 | `		}else if (apNode[i]->pStart->nType & PH7_TK_CCB /*'}'*/){` |
...
|          - |  443 | `			}` |
|       3897 |  444 | `			iBraces--;` |
|   68778403 |  445 | `		}else if ( apNode[i]->pStart->nType & PH7_TK_COLON ){` |
...
|          6 |  456 | `				return rc;` |
|          5 |  457 | `			}` |
|   68524097 |  458 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OP ){` |
|   22550093 |  459 | `			const ph7_expr_op *pOp = (const ph7_expr_op *)apNode[i]->pOp;` |
|   22550093 |  460 | `			if( pOp->iOp == EXPR_OP_QUESTY ){` |
|     504431 |  461 | `				iQuesty++;` |
|   22297880 |  462 | `			}else if( i > 0 && (pOp->iOp == EXPR_OP_UMINUS \|\| pOp->iOp == EXPR_OP_UPLUS)){` |
...
|   11275044 |  482 | `		}` |
|   44978496 |  483 | `	}` |
|   17120749 |  484 | `	if( iParen != 0 \|\| iSquare != 0 \|\| iQuesty != 0 \|\| iBraces != 0){` |
...
|         19 |  489 | `		return rc;` |
|          - |  490 | `	}` |
|   17120733 |  491 | `	return SXRET_OK;` |
|    8560395 |  492 | `}` |
|          - |  493 | `/*` |
|          - |  494 | ` * Collect and assemble tokens holding a namespace path [i.e: namespace\to\const]` |
|          - |  495 | ` * or a simple literal [i.e: PHP_EOL].` |
|          - |  496 | ` */` |
|   14117610 |  497 | `static void ExprAssembleLiteral(SyToken **ppCur,SyToken *pEnd)` |
|          5 |  498 | `{` |
|   14117615 |  499 | `	SyToken *pIn = *ppCur;` |
|          - |  500 | `	/* Jump the first literal seen */` |
|   14117615 |  501 | `	if( (pIn->nType & PH7_TK_NSSEP) == 0 ){` |
|   14113661 |  502 | `		pIn++;` |
|    7056828 |  503 | `	}` |
|    7060823 |  504 | `	for(;;){` |
|   14121651 |  505 | `		if(pIn < pEnd && (pIn->nType & PH7_TK_NSSEP) ){` |
|       4041 |  506 | `			pIn++;` |
...
|          - |  866 | ` */` |
|   90204630 |  867 | `static sxi32 ExprExtractNode(ph7_gen_state *pGen,ph7_expr_node **ppNode,int iLastWasTerm,int bAfterMemberOp)` |
|          5 |  868 | `{` |
|          - |  869 | `	ph7_expr_node *pNode;` |
|          - |  870 | `	SyToken *pCur;` |
|          - |  871 | `	sxi32 rc;` |
|          - |  872 | `	/* Allocate a new node */` |
|   90204635 |  873 | `	pNode = (ph7_expr_node *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_expr_node));` |
|   90204635 |  874 | `	if( pNode == 0 ){` |
...
|   90204635 |  881 | `	SyZero(pNode,sizeof(ph7_expr_node));` |
|   90204635 |  882 | `	SySetInit(&pNode->aNodeArgs,&pGen->pVm->sAllocator,sizeof(ph7_expr_node **));` |
|          - |  883 | `	/* Point to the head of the token stream */` |
|   90204635 |  884 | `	pCur = pNode->pStart = pGen->pIn;` |
|          - |  885 | `	/* Start collecting tokens */` |
|   90204635 |  886 | `	if( pCur->nType & PH7_TK_ELLIPSIS ){` |
...
|       4155 |  909 | `		return rc;` |
|          - |  910 | `	}` |
|   90200405 |  911 | `	if( (pCur->nType & PH7_TK_OSB) && !iLastWasTerm ){` |
|          - |  912 | `		/* PHP 5.4 short array syntax: [1, 2, 3] or ['key' => 'value'].` |
|          - |  913 | `		 * This '[' does not follow a term, so it is an array literal, not subscript.` |
|          - |  914 | `		 */` |
|     243315 |  915 | `		pCur++; /* Skip the opening '[' */` |
|     243315 |  916 | `		PH7_DelimitNestedTokens(pCur,pGen->pEnd,PH7_TK_OSB,PH7_TK_CSB,&pCur);` |
|     243315 |  917 | `		if( pCur < pGen->pEnd ){` |
|     243315 |  918 | `			pCur++; /* Skip past the closing ']' */` |
|     121660 |  919 | `		}else{` |
...
|          - |  930 | `		 */` |
|     243519 |  931 | `		if( pCur < pGen->pEnd && (pCur->nType & PH7_TK_OP) ){` |
...
|          - |  937 | `			}` |
|        209 |  938 | `		}else{` |
|     242907 |  939 | `			pNode->xCode = PH7_CompileShortArray;` |
|          5 |  940 | `		}` |
|   90078750 |  941 | `	}else if( bAfterMemberOp && (pCur->nType & PH7_TK_OP) && (pCur->nType & PH7_TK_ID) ){` |
...
|   89957082 |  952 | `	}else if( (pCur->nType & PH7_TK_OP) && pCur->pUserData` |
|   25579294 |  953 | `		&& ((const ph7_expr_op *)pCur->pUserData)->iOp == EXPR_OP_CLONE` |
|   12818816 |  954 | `		&& &pCur[1] < pGen->pEnd && (pCur[1].nType & PH7_TK_LPAREN) ){` |
...
|   89957066 |  980 | `	}else if( pCur->nType & PH7_TK_OP ){` |
|          - |  981 | `		/* Point to the instance that describe this operator */` |
|   25579277 |  982 | `		pNode->pOp = (const ph7_expr_op *)pCur->pUserData;` |
|          - |  983 | `		/* Advance the stream cursor */` |
|   25579277 |  984 | `		pCur++;` |
|   77167419 |  985 | `	}else if( pCur->nType & PH7_TK_DOLLAR ){` |
|          - |  986 | `		/* Isolate variable */` |
|   43269549 |  987 | `		while( pCur < pGen->pEnd && (pCur->nType & PH7_TK_DOLLAR) ){` |
|   21634783 |  988 | `			pCur++; /* Variable variable */` |
|          5 |  989 | `		}` |
|   21634771 |  990 | `		if( pCur < pGen->pEnd ){` |
|   21634771 |  991 | `			if (pCur->nType & (PH7_TK_ID\|PH7_TK_KEYWORD) ){` |
|          - |  992 | `				/* Variable name */` |
|   21634743 |  993 | `				pCur++;` |
|   10817401 |  994 | `			}else if( pCur->nType & PH7_TK_OCB /* '{' */ ){` |
|         24 |  995 | `				pCur++;` |
...
|          8 | 1008 | `			}` |
|   10817381 | 1009 | `		}` |
|   21634767 | 1010 | `		pNode->xCode = PH7_CompileVariable;` |
|   53560398 | 1011 | `	 }else if( pCur->nType & PH7_TK_KEYWORD ){` |
...
|          5 | 1136 | `		 }` |
|   42214387 | 1137 | `	 }else if( pCur->nType & (PH7_TK_NSSEP\|PH7_TK_ID) ){` |
|          - | 1138 | `		 /* Constants,function name,namespace path,class name... */` |
|   13506761 | 1139 | `		 if( bAfterMemberOp ){` |
...
|    5628015 | 1144 | `			 pCur->nType \|= PH7_TK_MEMBER_NAME;` |
|    2814005 | 1145 | `		 }` |
|   13506761 | 1146 | `		 ExprAssembleLiteral(&pCur,pGen->pEnd);` |
|   13506761 | 1147 | `		 pNode->xCode = PH7_CompileLiteral;` |
|    6753383 | 1148 | `	 }else{` |
|   28179029 | 1149 | `		 if( (pCur->nType & (PH7_TK_LPAREN\|PH7_TK_RPAREN\|PH7_TK_COMMA\|PH7_TK_COLON\|PH7_TK_CSB\|PH7_TK_OCB\|PH7_TK_CCB)) == 0 ){` |
|          - | 1150 | `			 /* Point to the code generator routine */` |
|    9522873 | 1151 | `			 pNode->xCode = PH7_GetNodeHandler(pCur->nType);` |
|    9522873 | 1152 | `			 if( pNode->xCode == 0 ){` |
...
|   90200371 | 1165 | `	pNode->pEnd = pCur;` |
|          - | 1166 | `	/* Save the node for later processing */` |
|   90200371 | 1167 | `	*ppNode = pNode;` |
|          - | 1168 | `	/* Synchronize cursors */` |
|   90200371 | 1169 | `	pGen->pIn = pCur;` |
|   90200371 | 1170 | `	return SXRET_OK;` |
|   45102320 | 1171 | `}` |
|          - | 1172 | `/*` |
...
|          - | 1175 | ` * level is zero.` |
|          - | 1176 | ` */` |
|    1940244 | 1177 | `PH7_PRIVATE sxi32 PH7_GetNextExpr(SyToken *pStart,SyToken *pEnd,SyToken **ppNext)` |
|          5 | 1178 | `{` |
|    1940249 | 1179 | `	SyToken *pCur = pStart;` |
|    1940249 | 1180 | `	sxi32 iNest = 0;` |
|    1940249 | 1181 | `	if( pCur >= pEnd \|\| (pCur->nType & PH7_TK_SEMI/*';'*/) ){` |
|          - | 1182 | `		/* Last expression */` |
|     716753 | 1183 | `		return SXERR_EOF;` |
|          - | 1184 | `	}` |
|    4644725 | 1185 | `	while( pCur < pEnd ){` |
|    4342781 | 1186 | `		if( (pCur->nType & (PH7_TK_COMMA/*','*/\|PH7_TK_SEMI/*';'*/)) && iNest <= 0){` |
|     921557 | 1187 | `			break;` |
|          - | 1188 | `		}` |
|    3421229 | 1189 | `		if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|     241729 | 1190 | `			iNest++;` |
|    3300367 | 1191 | `		}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}*/) ){` |
|     241731 | 1192 | `			iNest--;` |
|     120863 | 1193 | `		}` |
|    3421229 | 1194 | `		pCur++;` |
|          5 | 1195 | `	}` |
|    1223501 | 1196 | `	*ppNext = pCur;` |
|    1223501 | 1197 | `	return SXRET_OK;` |
|     970127 | 1198 | `}` |
|          - | 1199 | `/*` |
|          - | 1200 | ` * Free an expression tree.` |
|          - | 1201 | ` */` |
|   77094118 | 1202 | `static void ExprFreeTree(ph7_gen_state *pGen,ph7_expr_node *pNode)` |
|          5 | 1203 | `{` |
|   77094123 | 1204 | `	if( pNode->pLeft ){` |
|          - | 1205 | `		/* Release the left tree */` |
|   30133579 | 1206 | `		ExprFreeTree(&(*pGen),pNode->pLeft);` |
|   15066787 | 1207 | `	}` |
|   77094123 | 1208 | `	if( pNode->pRight ){` |
|          - | 1209 | `		/* Release the right tree */` |
|   17528013 | 1210 | `		ExprFreeTree(&(*pGen),pNode->pRight);` |
|    8764004 | 1211 | `	}` |
|   77094123 | 1212 | `	if( pNode->pCond ){` |
|          - | 1213 | `		/* Release the conditional tree used by the ternary operator */` |
|     504427 | 1214 | `		ExprFreeTree(&(*pGen),pNode->pCond);` |
|     252211 | 1215 | `	}` |
|   77094123 | 1216 | `	if( SySetUsed(&pNode->aNodeArgs) > 0 ){` |
|          - | 1217 | `		ph7_expr_node **apArg;` |
|          - | 1218 | `		sxu32 n;` |
|          - | 1219 | `		/* Release node arguments */` |
|    8308215 | 1220 | `		apArg = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|   19123563 | 1221 | `		for( n = 0 ; n < SySetUsed(&pNode->aNodeArgs) ; ++n ){` |
|   10815353 | 1222 | `			ExprFreeTree(&(*pGen),apArg[n]);` |
|    5407679 | 1223 | `		}` |
|    8308215 | 1224 | `		SySetRelease(&pNode->aNodeArgs);` |
|    4154105 | 1225 | `	}` |
|          - | 1226 | `	/* Finally,release this node */` |
|   77094123 | 1227 | `	SyMemBackendPoolFree(&pGen->pVm->sAllocator,pNode);` |
|   77094123 | 1228 | `}` |
|          - | 1229 | `/*` |
|          - | 1230 | ` * Free an expression tree.` |
|          - | 1231 | ` * This function is a wrapper around ExprFreeTree() defined above.` |
|          - | 1232 | ` */` |
|   17120810 | 1233 | `PH7_PRIVATE sxi32 PH7_ExprFreeTree(ph7_gen_state *pGen,SySet *pNodeSet)` |
|          5 | 1234 | `{` |
|          - | 1235 | `	ph7_expr_node **apNode;` |
|          - | 1236 | `	sxu32 n;` |
|   17120815 | 1237 | `	apNode = (ph7_expr_node **)SySetBasePtr(pNodeSet);` |
|  107321231 | 1238 | `	for( n = 0  ; n < SySetUsed(pNodeSet) ; ++n ){` |
|   90200421 | 1239 | `		if( apNode[n] ){` |
|   17121155 | 1240 | `			ExprFreeTree(&(*pGen),apNode[n]);` |
|    8560575 | 1241 | `		}` |
|   45100213 | 1242 | `	}` |
|   17120815 | 1243 | `	return SXRET_OK;` |
|          5 | 1244 | `}` |
|          - | 1245 | `/*` |
...
|          - | 1251 | ` */` |
|   21324752 | 1252 | `PH7_PRIVATE int PH7_ExprContainsNullsafe(ph7_expr_node *pNode)` |
|          5 | 1253 | `{` |
|   21324757 | 1254 | `	if( pNode == 0 ){` |
|   13284631 | 1255 | `		return 0;` |
|          - | 1256 | `	}` |
|    8040131 | 1257 | `	if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW ){` |
|         16 | 1258 | `		return 1;` |
|          - | 1259 | `	}` |
|    8040119 | 1260 | `	if( PH7_ExprContainsNullsafe(pNode->pLeft) ){` |
|          6 | 1261 | `		return 1;` |
|          - | 1262 | `	}` |
|    8040115 | 1263 | `	if( PH7_ExprContainsNullsafe(pNode->pRight) ){` |
|        ! 0 | 1264 | `		return 1;` |
|          - | 1265 | `	}` |
|    8040115 | 1266 | `	return 0;` |
|   10662381 | 1267 | `}` |
|          - | 1268 | `/*` |
|          - | 1269 | ` * Check if the given node is a modifialbe l/r-value.` |
|          - | 1270 | ` * Return TRUE if modifiable.FALSE otherwise.` |
|          - | 1271 | ` */` |
|    5221150 | 1272 | `static int ExprIsModifiableValue(ph7_expr_node *pNode,sxu8 bFunc)` |
|          5 | 1273 | `{` |
|          - | 1274 | `	sxi32 iExprOp;` |
|    5221155 | 1275 | `	if( pNode->pOp == 0 ){` |
|    3724013 | 1276 | `		return pNode->xCode == PH7_CompileVariable ? TRUE : FALSE;` |
|          - | 1277 | `	}` |
...
|          - | 1309 | ` */` |
|    5516422 | 1310 | `static sxi32 ExprProcessFuncArguments(ph7_gen_state *pGen,ph7_expr_node *pOp,ph7_expr_node **apNode,sxi32 nToken)` |
|          5 | 1311 | `{` |
...
|    5516427 | 1315 | `	iCur = 0;` |
|    6769978 | 1316 | `	for(;;){` |
|   13539961 | 1317 | `		if( iCur >= nToken ){` |
|          - | 1318 | `			/* No more arguments to process */` |
|    5516399 | 1319 | `			break;` |
|          - | 1320 | `		}` |
|    8023567 | 1321 | `		iNode = iCur;` |
|    8023567 | 1322 | `		iNest = 0;` |
|   26284585 | 1323 | `		while( iCur < nToken ){` |
|   20768189 | 1324 | `			if( apNode[iCur] ){` |
|   20721295 | 1325 | `				if( (apNode[iCur]->pStart->nType & PH7_TK_COMMA) && apNode[iCur]->pLeft == 0 && iNest <= 0 ){` |
|    1253588 | 1326 | `					break;` |
|   18214124 | 1327 | `				}else if( (apNode[iCur]->pStart->nType & (PH7_TK_LPAREN\|PH7_TK_OSB\|PH7_TK_OCB))` |
|    9752251 | 1328 | `					&& apNode[iCur]->pLeft == 0` |
|    1290371 | 1329 | `					&& apNode[iCur]->xCode != PH7_CompileShortArray` |
|    1287796 | 1330 | `					&& apNode[iCur]->xCode != PH7_CompileShortList ){` |
...
|    1285223 | 1341 | `					iNest++;` |
|   17571520 | 1342 | `				}else if( (apNode[iCur]->pStart->nType & (PH7_TK_RPAREN\|PH7_TK_CCB\|PH7_TK_CSB))` |
|    9107067 | 1343 | `					&& apNode[iCur]->pLeft == 0 ){` |
|    1285223 | 1344 | `					iNest--;` |
|     642609 | 1345 | `				}` |
|    9107062 | 1346 | `			}` |
|   18261023 | 1347 | `			iCur++;` |
|          5 | 1348 | `		}` |
|    8023567 | 1349 | `		if( iCur > iNode ){` |
|    8023561 | 1350 | `			SyString sArgName = {0, 0};` |
...
|    8023556 | 1354 | `			if( (iCur - iNode) >= 2` |
|    5581558 | 1355 | `				&& apNode[iNode]` |
|    3139539 | 1356 | `				&& (apNode[iNode]->pStart->nType & (PH7_TK_ID\|PH7_TK_KEYWORD))` |
|    1693581 | 1357 | `				&& apNode[iNode]->xCode == PH7_CompileLiteral` |
|     247370 | 1358 | `				&& apNode[iNode+1]` |
|     247101 | 1359 | `				&& (apNode[iNode+1]->pStart->nType & PH7_TK_COLON) ){` |
...
|          - | 1378 | `				}` |
|        143 | 1379 | `			}` |
|    8023554 | 1380 | `			if( apNode[iNode] && (apNode[iNode]->pStart->nType & PH7_TK_AMPER /*'&'*/) && ((iCur - iNode) == 2)` |
...
|    8023559 | 1397 | `				int bSpreadArg = 0;` |
|          - | 1398 | `				sxi32 iScan;` |
|    8023601 | 1399 | `				for( iScan = iNode ; iScan < iCur ; iScan++ ){` |
|    8023601 | 1400 | `					if( apNode[iScan] ){` |
|    8023559 | 1401 | `						bSpreadArg = (apNode[iScan]->iFlags & EXPR_NODE_SPREAD) != 0;` |
|    8023559 | 1402 | `						break;` |
|          - | 1403 | `					}` |
|         23 | 1404 | `				}` |
|    8023559 | 1405 | `				ExprMakeTree(&(*pGen),&apNode[iNode],iCur-iNode);` |
|    8023559 | 1406 | `				if( bSpreadArg && apNode[iNode] ){` |
|       4085 | 1407 | `					apNode[iNode]->iFlags \|= EXPR_NODE_SPREAD;` |
|       2040 | 1408 | `				}` |
|          - | 1409 | `			}` |
|    8023559 | 1410 | `			if( apNode[iNode] ){` |
|    8023559 | 1411 | `				if( sArgName.nByte > 0 ){` |
...
|    8023559 | 1416 | `				SySetPut(&pOp->aNodeArgs,(const void *)&apNode[iNode]);` |
|    4011782 | 1417 | `			}else{` |
...
|    8023559 | 1436 | `		if( iCur < nToken && apNode[iCur] && (apNode[iCur]->pStart->nType & PH7_TK_COMMA) ){` |
|    2507165 | 1437 | `			iCur++;` |
|    2507165 | 1438 | `			if( iCur >= nToken ){` |
|          - | 1439 | `				/* Trailing comma after last argument */` |
|         21 | 1440 | `				break;` |
|          - | 1441 | `			}` |
|    1253570 | 1442 | `		}` |
|          5 | 1443 | `	}` |
|    5516419 | 1444 | `	return SXRET_OK;` |
|    2758216 | 1445 | `}` |
|          - | 1446 | ` /*` |
...
|          - | 1450 | `  */` |
|   29607782 | 1451 | ` static sxi32 ExprMakeTree(ph7_gen_state *pGen,ph7_expr_node **apNode,sxi32 nToken)` |
|          5 | 1452 | ` {` |
...
|          - | 1456 | `	 sxi32 iCur;` |
|          - | 1457 | `	 sxi32 rc;` |
|   29607787 | 1458 | `	 if( nToken <= 0 \|\| (nToken == 1 && apNode[0]->xCode) ){` |
|          - | 1459 | `		 /* TICKET 1433-17: self evaluating node */` |
|   13004171 | 1460 | `		 return SXRET_OK;` |
|          - | 1461 | `	 }` |
|          - | 1462 | `	 /* Process expressions enclosed in parenthesis first */` |
|  118061929 | 1463 | `	 for( iCur =  0 ; iCur < nToken ; ++iCur ){` |
|          - | 1464 | `		 sxi32 iNest;` |
...
|          - | 1467 | `		  */` |
|  101458315 | 1468 | `		 if( apNode[iCur] == 0 \|\| apNode[iCur]->pStart->nType != PH7_TK_LPAREN ){` |
|  100966685 | 1469 | `			 continue;` |
|          - | 1470 | `		 }` |
|     491635 | 1471 | `		 iNest = 1;` |
...
|  122093349 | 1518 | `	 for( iCur =  0 ; iCur < nToken ; ++iCur ){` |
|          - | 1519 | `		 sxi32 iNest;` |
...
|          - | 1522 | `		  */` |
|  105832327 | 1523 | `		 if( apNode[iCur] == 0 \|\| apNode[iCur]->pStart->nType != PH7_TK_OCB ){` |
|  105828435 | 1524 | `			 continue;` |
|          - | 1525 | `		 }` |
|       3897 | 1526 | `		 iNest = 1;` |
...
|   16261027 | 1559 | `	 iLeft = -1;` |
|  122101095 | 1560 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  105840085 | 1561 | `		 if( apNode[iCur] == 0 ){` |
|   46734525 | 1562 | `			 continue;` |
|          - | 1563 | `		 }` |
|   59105565 | 1564 | `		 pNode = apNode[iCur];` |
|   59105565 | 1565 | `		 if( pNode->pOp && pNode->pOp->iPrec == 2 && pNode->pLeft == 0  ){` |
|   16092113 | 1566 | `			 if( pNode->pOp->iOp == EXPR_OP_FUNC_CALL ){` |
|          - | 1567 | `				 /* Collect function arguments */` |
|    7065593 | 1568 | `				 sxi32 iPtr = 0;` |
|    7065593 | 1569 | `				 sxi32 nFuncTok = 0;` |
|   34899367 | 1570 | `				 while( nFuncTok + iCur < nToken ){` |
|   34899367 | 1571 | `					 ph7_expr_node *pTok = apNode[nFuncTok+iCur];` |
...
|   34899367 | 1578 | `					 if( pTok && pTok->pLeft == 0 ){` |
|   34840775 | 1579 | `						 if( pTok->pStart->nType & PH7_TK_LPAREN /*'('*/ ){` |
|    7526825 | 1580 | `							 iPtr++;` |
|   31077365 | 1581 | `						 }else if ( pTok->pStart->nType & PH7_TK_RPAREN /*')'*/){` |
|    7526825 | 1582 | `							 iPtr--;` |
|    7526825 | 1583 | `							 if( iPtr <= 0 ){` |
|    7065593 | 1584 | `								 break;` |
|          - | 1585 | `							 }` |
|     230616 | 1586 | `						 }` |
|   13887591 | 1587 | `					 }` |
|   27833779 | 1588 | `					 nFuncTok++;` |
|          5 | 1589 | `				 }` |
|    7065593 | 1590 | `				 if( nFuncTok + iCur >= nToken ){` |
|          - | 1591 | `					 /* Syntax error */` |
...
|        ! 0 | 1596 | `					 return rc;` |
|          - | 1597 | `				 }` |
|    7065593 | 1598 | `				 if(  iLeft < 0 \|\| !NODE_ISTERM(iLeft) /*\|\| ( apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec != 2)*/ ){` |
|          - | 1599 | `					 /* Syntax error */` |
...
|        ! 0 | 1604 | `					 return rc;` |
|          - | 1605 | `				 }` |
|    7065593 | 1606 | `				 if( nFuncTok > 1 ){` |
|          - | 1607 | `					 /* Process function arguments */` |
|    5516427 | 1608 | `					 rc = ExprProcessFuncArguments(&(*pGen),pNode,&apNode[iCur+1],nFuncTok-1);` |
|    5516427 | 1609 | `					 if( rc != SXRET_OK ){` |
|         11 | 1610 | `						 return rc;` |
|          - | 1611 | `					 }` |
|    2758207 | 1612 | `				 }` |
|          - | 1613 | `				 /* Link the node to the tree */` |
|    7065585 | 1614 | `				 pNode->pLeft = apNode[iLeft];` |
|    7065585 | 1615 | `				 apNode[iLeft] = 0;` |
|   34899335 | 1616 | `				 for( iPtr = 1; iPtr <= nFuncTok ; iPtr++ ){` |
|   27833755 | 1617 | `					 apNode[iCur+iPtr] = 0;` |
|   13916880 | 1618 | `				 }` |
...
|          - | 1629 | `				 {` |
|    7065585 | 1630 | `					 sxi32 iNew = iLeft - 1;` |
|    9131971 | 1631 | `					 while( iNew >= 0 && apNode[iNew] == 0 ){` |
|    2066391 | 1632 | `						 iNew--;` |
|          5 | 1633 | `					 }` |
|    7065580 | 1634 | `					 if( iNew >= 0 && apNode[iNew]->pOp` |
|    3984132 | 1635 | `						 && apNode[iNew]->pOp->iOp == EXPR_OP_NEW` |
|    2413897 | 1636 | `						 && apNode[iNew]->pLeft == 0 ){` |
|     857267 | 1637 | `						 apNode[iNew]->pLeft = pNode; /* new -> ClassName(args) */` |
|     857267 | 1638 | `						 apNode[iCur] = apNode[iNew]; /* relocate onto the call slot */` |
|     857267 | 1639 | `						 apNode[iNew] = 0;` |
|     857267 | 1640 | `						 pNode = apNode[iCur];` |
|     428636 | 1641 | `					 }` |
|          - | 1642 | `				 }` |
|   12559315 | 1643 | `			 }else if (pNode->pOp->iOp == EXPR_OP_SUBSCRIPT ){` |
|          - | 1644 | `				 /* Subscripting */` |
...
|    5997377 | 1696 | `				  iRight = iCur + 1;` |
|    6001267 | 1697 | `				 while( iRight < nToken && apNode[iRight] == 0 ){` |
|       3895 | 1698 | `					 iRight++;` |
|          5 | 1699 | `				 }` |
|    5997377 | 1700 | `				 if( iRight >= nToken \|\| iLeft < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|          - | 1701 | `					 /* Syntax error */` |
...
|    5997373 | 1709 | `				 pNode->pLeft = apNode[iLeft];` |
|    5997368 | 1710 | `				 if( (pNode->pOp->iOp == EXPR_OP_ARROW /*'->'*/ \|\| pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW /*'?->'*/)` |
|    5787106 | 1711 | `					 && pNode->pLeft->pOp == 0 &&` |
|    5486741 | 1712 | `					 pNode->pLeft->xCode != PH7_CompileVariable &&` |
...
|        ! 0 | 1724 | `						 return rc;` |
|          - | 1725 | `				 }` |
|    5997373 | 1726 | `				 pNode->pRight = apNode[iRight];` |
|    5997373 | 1727 | `				 apNode[iLeft] = apNode[iRight] = 0;` |
|          - | 1728 | `			 }` |
|    8046048 | 1729 | `		 }` |
|   59105553 | 1730 | `		 iLeft = iCur;` |
|   29552779 | 1731 | `	 }` |
|          - | 1732 | `	 /* Handle left associative (new, clone) operators */` |
|  122101063 | 1733 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  105840053 | 1734 | `		 if( apNode[iCur] == 0 ){` |
|   63746491 | 1735 | `			 continue;` |
|          - | 1736 | `		 }` |
|   42093567 | 1737 | `		 pNode = apNode[iCur];` |
|   42093567 | 1738 | `		 if( pNode->pOp && pNode->pOp->iPrec == 1 && pNode->pLeft == 0 ){` |
|          - | 1739 | `			 SyToken *pToken;` |
|          - | 1740 | `			 /* Get the left node */` |
|      62613 | 1741 | `			 iLeft = iCur + 1;` |
|      62621 | 1742 | `			 while( iLeft < nToken && apNode[iLeft] == 0 ){` |
|          9 | 1743 | `				 iLeft++;` |
|          1 | 1744 | `			 }` |
|      62613 | 1745 | `			 if( iLeft >= nToken \|\| !NODE_ISTERM(iLeft) ){` |
|          - | 1746 | `				  /* Syntax error */` |
...
|      62613 | 1755 | `			 if( pNode->pOp->iOp == EXPR_OP_CLONE ){` |
|          - | 1756 | `				 /* Clone:` |
...
|      62613 | 1813 | `			 pNode->pLeft = apNode[iLeft];` |
|      62613 | 1814 | `			 apNode[iLeft] = 0;` |
|      62613 | 1815 | `			 pNode->pRight = 0; /* Paranoid */` |
|      31304 | 1816 | `		 }` |
|   21046786 | 1817 | `	 }` |
|          - | 1818 | `	  /* Handle post/pre icrement/decrement [i.e: ++/--] operators with precedence 3 */` |
|   16261015 | 1819 | `	 iLeft = -1;` |
|  122272359 | 1820 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  105840053 | 1821 | `		 if( apNode[iCur] == 0 ){` |
|   63746491 | 1822 | `			 continue;` |
|          - | 1823 | `		 }` |
|   42093567 | 1824 | `		 pNode = apNode[iCur];` |
|   42093567 | 1825 | `		 if( pNode->pOp && pNode->pOp->iPrec == 3 && pNode->pLeft == 0){` |
...
|     101220 | 1831 | `			 }` |
|     280300 | 1832 | `		  }` |
|   42264863 | 1833 | `		 iLeft = iCur;` |
|   21218082 | 1834 | `	  }` |
|   16432311 | 1835 | `	 iLeft = -1;` |
|  122272359 | 1836 | `	 for( iCur = nToken -  1 ; iCur >= 0 ; iCur-- ){` |
|  105840053 | 1837 | `		 if( apNode[iCur] == 0 ){` |
|   63948931 | 1838 | `			 continue;` |
|          - | 1839 | `		 }` |
|   41891127 | 1840 | `		 pNode = apNode[iCur];` |
|   41891127 | 1841 | `		 if( pNode->pOp && pNode->pOp->iPrec == 3 && pNode->pLeft == 0){` |
...
|   16432311 | 1867 | `	 iLeft = -1;` |
|  122272359 | 1868 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  105840053 | 1869 | `		 if( apNode[iCur] == 0 ){` |
|   64046371 | 1870 | `			 continue;` |
|          - | 1871 | `		 }` |
|   41793687 | 1872 | `		 pNode = apNode[iCur];` |
|   41793687 | 1873 | `		 if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_INSTOF && pNode->pLeft == 0 ){` |
...
|      40936 | 1888 | `		 }` |
|   41793687 | 1889 | `		 iLeft = iCur;` |
|   20896846 | 1890 | `	 }` |
|          - | 1891 | `	 /* Handle right associative unary and cast operators [i.e: !,(string),~...]  with precedence 4*/` |
|   16432311 | 1892 | `	  iLeft = 0;` |
|  122272353 | 1893 | `	  for( iCur = nToken -  1 ; iCur >= 0 ; iCur-- ){` |
|  105840049 | 1894 | `		  if( apNode[iCur] ){` |
|   41711811 | 1895 | `			  pNode = apNode[iCur];` |
|   41711811 | 1896 | `			  if( pNode->pOp && pNode->pOp->iPrec == 4 && pNode->pLeft == 0){` |
...
|  122272351 | 1928 | `	 for( iCur = nToken - 1 ; iCur >= 0 ; --iCur ){` |
|  105840047 | 1929 | `		 if( apNode[iCur] == 0 ){` |
|   65505273 | 1930 | `			 continue;` |
|          - | 1931 | `		 }` |
|   40334779 | 1932 | `		 pNode = apNode[iCur];` |
|   40334779 | 1933 | `		 if( pNode->pOp && pNode->pOp->iPrec == 5 && pNode->pLeft == 0 ){` |
|          - | 1934 | `			 sxi32 iL, iR;` |
...
|  180755263 | 1996 | `	 for( i = 7 ; i < 17 ; i++ ){` |
|  164322969 | 1997 | `		 iLeft = -1;` |
| 1222723095 | 1998 | `		 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
| 1058400141 | 1999 | `			 if( apNode[iCur] == 0 ){` |
|  723895843 | 2000 | `				 continue;` |
|          - | 2001 | `			 }` |
|  334504303 | 2002 | `			 pNode = apNode[iCur];` |
|  334504303 | 2003 | `			 if( pNode->pOp && pNode->pOp->iPrec == i && pNode->pLeft == 0 ){` |
...
|          - | 2075 | `	  */` |
|   16432299 | 2076 | `	  iLeft = -1;` |
|  118109601 | 2077 | `	  for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  102181731 | 2078 | `		  if( apNode[iCur] == 0 ){` |
|   74802797 | 2079 | `			  continue;` |
|          - | 2080 | `		  }` |
|   27378939 | 2081 | `		  pNode = apNode[iCur];` |
|   27378939 | 2082 | `		  if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_QUESTY && pNode->pLeft == 0 ){` |
...
|          - | 2148 | `	  */` |
|   16432297 | 2149 | `	 iRight = -1;` |
|  122272155 | 2150 | `	 for( iCur = nToken -  1 ; iCur >= 0 ; iCur--){` |
|  105839917 | 2151 | `		 if( apNode[iCur] == 0 ){` |
|   84186479 | 2152 | `			 continue;` |
|          - | 2153 | `		 }` |
|   21653443 | 2154 | `		 pNode = apNode[iCur];` |
|   21653443 | 2155 | `		 if( pNode->pOp && pNode->pOp->iPrec == 18 && pNode->pLeft == 0 ){` |
|          - | 2156 | `			 /* Get the left node */` |
|    5221073 | 2157 | `			 iLeft = iCur - 1;` |
|    7169345 | 2158 | `			 while( iLeft >= 0 && apNode[iLeft] == 0 ){` |
|    1948277 | 2159 | `				 iLeft--;` |
|          5 | 2160 | `			 }` |
|    5221073 | 2161 | `			 if( iLeft < 0 \|\| iRight < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|          - | 2162 | `				 /* Syntax error */` |
...
|          - | 2179 | `			  * a write. */` |
|    5221031 | 2180 | `			 if( PH7_ExprContainsNullsafe(apNode[iLeft]) ){` |
...
|    5221023 | 2193 | `			 pSuppress = 0;` |
|    5221018 | 2194 | `			 if( apNode[iLeft]->pOp` |
|    3359059 | 2195 | `				 && apNode[iLeft]->pOp->iVmOp == PH7_OP_ERR_CTRL` |
...
|        ! 0 | 2200 | `			 }` |
|    5221023 | 2201 | `			 if( ExprIsModifiableValue(apNode[iLeft],FALSE) == FALSE ){` |
...
|    5221011 | 2244 | `			 pNode->pLeft = apNode[iRight];` |
|    5221011 | 2245 | `			 pNode->pRight = apNode[iLeft];` |
|    5221011 | 2246 | `			 apNode[iLeft] = apNode[iRight] = 0;` |
|    5221011 | 2247 | `			 if( pSuppress ){` |
|          - | 2248 | `				 /* Re-wrap: the '@' now suppresses the whole assignment */` |
|        ! 0 | 2249 | `				 pSuppress->pLeft = pNode;` |
|        ! 0 | 2250 | `				 apNode[iCur] = pSuppress;` |
|        ! 0 | 2251 | `			 }` |
|    2610503 | 2252 | `		 }` |
|   21653381 | 2253 | `		 iRight = iCur;` |
|   10826693 | 2254 | `	 }` |
|          - | 2255 | `	 /* Process left associative binary operators that have the lowest precedence [i.e: and,or,xor] */` |
|   82161195 | 2256 | `	 for( i = 19 ; i < 23 ; i++ ){` |
|   65728957 | 2257 | `		 iLeft = -1;` |
|  489088333 | 2258 | `		 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  423359381 | 2259 | `			 if( apNode[iCur] == 0 ){` |
|  357630177 | 2260 | `				 continue;` |
|          - | 2261 | `			 }` |
|   65729209 | 2262 | `			 pNode = apNode[iCur];` |
|   65729209 | 2263 | `			 if( pNode->pOp && pNode->pOp->iPrec == i && pNode->pLeft == 0 ){` |
...
|         24 | 2281 | `			 }` |
|   65729209 | 2282 | `			 iLeft = iCur;` |
|   32864607 | 2283 | `		 }` |
|   32864481 | 2284 | `	 }` |
|          - | 2285 | `	 /* Point to the root of the expression tree */` |
|  105839821 | 2286 | `	 for( iCur = 1 ; iCur < nToken ; ++iCur ){` |
|   89407601 | 2287 | `		 if( apNode[iCur] ){` |
|   15630645 | 2288 | `			 if( (apNode[iCur]->pOp \|\| apNode[iCur]->xCode ) && apNode[0] != 0){` |
...
|         23 | 2293 | `				  return rc;` |
|          - | 2294 | `			 }` |
|   15630627 | 2295 | `			 apNode[0] = apNode[iCur];` |
|   15630627 | 2296 | `			 apNode[iCur] = 0;` |
|    7815311 | 2297 | `		 }` |
|   44703794 | 2298 | `	 }` |
|   16432225 | 2299 | `	 return SXRET_OK;` |
|   14718248 | 2300 | ` }` |
|          - | 2301 | ` /*` |
...
|          - | 2306 | `  */` |
|   17120814 | 2307 | `PH7_PRIVATE sxi32 PH7_ExprMakeTree(ph7_gen_state *pGen,SySet *pExprNode,ph7_expr_node **ppRoot)` |
|          5 | 2308 | `{` |
|          - | 2309 | `	ph7_expr_node **apNode;` |
|          - | 2310 | `	ph7_expr_node *pNode;` |
|          - | 2311 | `	sxi32 rc;` |
|          - | 2312 | `	/* Reset node container */` |
|   17120819 | 2313 | `	SySetReset(pExprNode);` |
|   17120819 | 2314 | `	pNode = 0; /* Prevent compiler warning */` |
|          - | 2315 | `	/* Extract nodes one after one until we hit the end of the input */` |
|          - | 2316 | `	{` |
|   17120819 | 2317 | `		int iLastWasTerm = 0;` |
|   17120819 | 2318 | `		int bAfterMemberOp = 0; /* TRUE iff the previous node was -> / ?-> / :: */` |
|  107321265 | 2319 | `		while( pGen->pIn < pGen->pEnd ){` |
|   90200485 | 2320 | `			rc = ExprExtractNode(&(*pGen),&pNode,iLastWasTerm,bAfterMemberOp);` |
|   90200485 | 2321 | `			if( rc != SXRET_OK ){` |
|         38 | 2322 | `				return rc;` |
|          - | 2323 | `			}` |
|          - | 2324 | `			/* Determine if this node is a term for short-array disambiguation */` |
|   90200451 | 2325 | `			if( pNode->xCode ){` |
|          - | 2326 | `				/* Node with compile handler: variable, literal, string, array, etc. */` |
|   45965023 | 2327 | `				iLastWasTerm = 1;` |
|   67217942 | 2328 | `			}else if( pNode->pOp ){` |
|          - | 2329 | `				/* Operator node */` |
|   25579277 | 2330 | `				iLastWasTerm = 0;` |
|   12789641 | 2331 | `			}else{` |
|          - | 2332 | `				/* Delimiter: ')' and ']' end terms */` |
|   18656161 | 2333 | `				iLastWasTerm = (pNode->pStart->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB)) ? 1 : 0;` |
|          - | 2334 | `			}` |
...
|   90200451 | 2338 | `			bAfterMemberOp = ( pNode->pOp && pNode->pOp->iVmOp == PH7_OP_MEMBER );` |
|          - | 2339 | `			/* Save the extracted node */` |
|   90200451 | 2340 | `			SySetPut(pExprNode,(const void *)&pNode);` |
|          5 | 2341 | `		}` |
|          - | 2342 | `	}` |
|   17120785 | 2343 | `	if( SySetUsed(pExprNode) < 1 ){` |
|          - | 2344 | `		/* Empty expression [i.e: A semi-colon;] */` |
|        ! 0 | 2345 | `		*ppRoot = 0;` |
|        ! 0 | 2346 | `		return SXRET_OK;` |
|          - | 2347 | `	}` |
|   17120785 | 2348 | `	apNode = (ph7_expr_node **)SySetBasePtr(pExprNode);` |
|          - | 2349 | `	/* Make sure we are dealing with valid nodes */` |
|   17120785 | 2350 | `	rc = ExprVerifyNodes(&(*pGen),apNode,(sxi32)SySetUsed(pExprNode));` |
|   17120785 | 2351 | `	if( rc != SXRET_OK ){` |
...
|          - | 2357 | `	}` |
|          - | 2358 | `	/* Build the tree */` |
|   17120733 | 2359 | `	rc = ExprMakeTree(&(*pGen),apNode,(sxi32)SySetUsed(pExprNode));` |
|   17120733 | 2360 | `	if( rc != SXRET_OK ){` |
|          - | 2361 | `		/* Something goes wrong [i.e: Syntax error] */` |
|        103 | 2362 | `		*ppRoot = 0;` |
|        103 | 2363 | `		return rc;` |
|          - | 2364 | `	}` |
|          - | 2365 | `	/* Point to the root of the tree */` |
|   17120635 | 2366 | `	*ppRoot = apNode[0];` |
|   17120635 | 2367 | `	return SXRET_OK;` |
|    8560412 | 2368 | `}` |
|          - | 2369 |  |
