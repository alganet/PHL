...
|        - |  267 | ` */` |
|  1146408 |  268 | `PH7_PRIVATE const ph7_expr_op *  PH7_ExprExtractOperator(SyString *pStr,SyToken *pLast)` |
|        5 |  269 | `{` |
|  1146413 |  270 | `	sxu32 n = 0;` |
|        - |  271 | `	sxi32 rc;` |
|        - |  272 | `	/* Do a linear lookup on the operators table */` |
| 20279093 |  273 | `	for(;;){` |
| 40558191 |  274 | `		if( n >= SX_ARRAYSIZE(aOpTable) ){` |
|      ! 0 |  275 | `			break;` |
|        - |  276 | `		}` |
| 40558191 |  277 | `		if( SyisAlpha(aOpTable[n].sOp.zString[0]) ){` |
|        - |  278 | `			/* TICKET 1433-012: Alpha stream operators [i.e: and,or,xor,new...] */` |
|  4729569 |  279 | `			rc = SyStringCmp(pStr,&aOpTable[n].sOp,SyStrnicmp);` |
|  2364787 |  280 | `		}else{` |
| 35828627 |  281 | `			rc = SyStringCmp(pStr,&aOpTable[n].sOp,SyMemcmp);` |
|        - |  282 | `		}` |
| 40558191 |  283 | `		if( rc == 0 ){` |
|  1150763 |  284 | `			if( aOpTable[n].sOp.nByte != sizeof(char) \|\| (aOpTable[n].iOp != EXPR_OP_UMINUS && aOpTable[n].iOp != EXPR_OP_UPLUS) \|\| pLast == 0 ){` |
|        - |  285 | `				/* There is no ambiguity here,simply return the first operator seen */` |
|  1145955 |  286 | `				return &aOpTable[n];` |
|        - |  287 | `			}` |
|        - |  288 | `			/* Handle ambiguity */` |
|     4813 |  289 | `			if( pLast->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*'['*/\|PH7_TK_COLON/*:*/\|PH7_TK_COMMA/*,'*/) ){` |
|        - |  290 | `				/* Unary opertors have prcedence here over binary operators */` |
|      329 |  291 | `				return &aOpTable[n];` |
|        - |  292 | `			}` |
|     4489 |  293 | `			if( pLast->nType & PH7_TK_OP ){` |
...
|        4 |  301 | `			}` |
|     2175 |  302 | `		}` |
| 39411783 |  303 | `		++n; /* Next operator in the table */` |
|        5 |  304 | `	}` |
...
|        - |  312 | ` */` |
|   698372 |  313 | `PH7_PRIVATE void PH7_DelimitNestedTokens(SyToken *pIn,SyToken *pEnd,sxu32 nTokStart,sxu32 nTokEnd,SyToken **ppEnd)` |
|        5 |  314 | `{` |
|   698377 |  315 | `	SyToken *pCur = pIn;` |
|   698377 |  316 | `	sxi32 iNest = 1;` |
|  3912849 |  317 | `	for(;;){` |
|  7825703 |  318 | `		if( pCur >= pEnd ){` |
|      315 |  319 | `			break;` |
|        - |  320 | `		}` |
|  7825393 |  321 | `		if( pCur->nType & nTokStart ){` |
|        - |  322 | `			/* Increment nesting level */` |
|   369523 |  323 | `			iNest++;` |
|  7640634 |  324 | `		}else if( pCur->nType & nTokEnd ){` |
|        - |  325 | `			/* Decrement nesting level */` |
|  1067585 |  326 | `			iNest--;` |
|  1067585 |  327 | `			if( iNest <= 0 ){` |
|   698067 |  328 | `				break;` |
|        - |  329 | `			}` |
|   184759 |  330 | `		}` |
|        - |  331 | `		/* Advance cursor */` |
...
|        - |  345 | ` */` |
|    22616 |  346 | `PH7_PRIVATE int PH7_IsLangConstruct(sxu32 nKeyID,sxu8 bCheckFunc)` |
|        5 |  347 | `{` |
|    33849 |  348 | `	if( nKeyID == PH7_TKWRD_ECHO \|\| nKeyID == PH7_TKWRD_PRINT \|\| nKeyID == PH7_TKWRD_INCLUDE` |
|    22518 |  349 | `		\|\| nKeyID == PH7_TKWRD_INCONCE \|\| nKeyID == PH7_TKWRD_REQUIRE \|\| nKeyID == PH7_TKWRD_REQONCE` |
|        - |  350 | `		){` |
|      167 |  351 | `			return TRUE;` |
|        - |  352 | `	}` |
|    22459 |  353 | `	if( bCheckFunc ){` |
...
|        - |  368 | ` */` |
|   967474 |  369 | `static sxi32 ExprVerifyNodes(ph7_gen_state *pGen,ph7_expr_node **apNode,sxi32 nNode)` |
|        5 |  370 | `{` |
|        - |  371 | `	sxi32 iParen,iSquare,iQuesty,iBraces;` |
|        - |  372 | `	sxi32 i,rc;` |
|        - |  373 |  |
|   967479 |  374 | `	if( nNode > 0 && apNode[0]->pOp && (apNode[0]->pOp->iOp == EXPR_OP_ADD \|\| apNode[0]->pOp->iOp == EXPR_OP_SUB) ){` |
...
|       15 |  378 | `	}` |
|   967479 |  379 | `	iParen = iSquare = iQuesty = iBraces = 0;` |
|  5243747 |  380 | `	for( i = 0 ; i < nNode ; ++i ){` |
|  4276307 |  381 | `		if( apNode[i]->xCode == PH7_CompileShortArray \|\| apNode[i]->xCode == PH7_CompileShortList ){` |
|        - |  382 | `			/* Short array/list literal: brackets are self-contained, skip */` |
|     1161 |  383 | `			continue;` |
|        - |  384 | `		}` |
|  4275151 |  385 | `		if( apNode[i]->pStart->nType & PH7_TK_LPAREN /*'('*/){` |
|   485591 |  386 | `			if( i > 0 && ( apNode[i-1]->xCode == PH7_CompileVariable \|\| apNode[i-1]->xCode == PH7_CompileLiteral \|\|` |
|    22878 |  387 | `				(apNode[i - 1]->pStart->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_SSTR\|PH7_TK_DSTR\|PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}'*/))) ){` |
|        - |  388 | `					/* Ticket 1433-033: Take care to ignore alpha-stream [i.e: or,xor] operators followed by an opening parenthesis */` |
|   454847 |  389 | `					if( (apNode[i - 1]->pStart->nType & PH7_TK_OP) == 0 ){` |
|        - |  390 | `						/* We are dealing with a postfix [i.e: function call]  operator` |
|        - |  391 | `						 * not a simple left parenthesis. Mark the node.` |
|        - |  392 | `						 */` |
|   454847 |  393 | `						apNode[i]->pStart->nType \|= PH7_TK_OP;` |
|   454847 |  394 | `						apNode[i]->pStart->pUserData = (void *)&sFCallOp; /* Function call operator */` |
|   454847 |  395 | `						apNode[i]->pOp = &sFCallOp;` |
|   227421 |  396 | `					}` |
|   227421 |  397 | `			}` |
|   485591 |  398 | `			iParen++;` |
|  4032358 |  399 | `		}else if( apNode[i]->pStart->nType & PH7_TK_RPAREN/*')*/){` |
|   485591 |  400 | `			if( iParen <= 0 ){` |
...
|        - |  406 | `			}` |
|   485579 |  407 | `			iParen--;` |
|  3546766 |  408 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OSB /*'['*/){` |
|    92909 |  409 | `			iSquare++;` |
|  3257527 |  410 | `		}else if (apNode[i]->pStart->nType & PH7_TK_CSB /*']'*/){` |
|    92923 |  411 | `			if( iSquare <= 0 ){` |
...
|        - |  417 | `			}` |
|    92917 |  418 | `			iSquare--;` |
|  3164613 |  419 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OCB /*'{'*/){` |
|       20 |  420 | `			iBraces++;` |
...
|        - |  464 |  |
|        7 |  465 | `			}` |
|  3118148 |  466 | `		}else if (apNode[i]->pStart->nType & PH7_TK_CCB /*'}'*/){` |
|       24 |  467 | `			if( iBraces <= 0 ){` |
...
|        - |  473 | `			}` |
|       10 |  474 | `			iBraces--;` |
|  3118123 |  475 | `		}else if ( apNode[i]->pStart->nType & PH7_TK_COLON ){` |
...
|        5 |  486 | `				return rc;` |
|        5 |  487 | `			}` |
|  3116675 |  488 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OP ){` |
|   873327 |  489 | `			const ph7_expr_op *pOp = (const ph7_expr_op *)apNode[i]->pOp;` |
|   873327 |  490 | `			if( pOp->iOp == EXPR_OP_QUESTY ){` |
|     2673 |  491 | `				iQuesty++;` |
|   871993 |  492 | `			}else if( i > 0 && (pOp->iOp == EXPR_OP_UMINUS \|\| pOp->iOp == EXPR_OP_UPLUS)){` |
...
|   436661 |  512 | `		}` |
|  2137561 |  513 | `	}` |
|   967445 |  514 | `	if( iParen != 0 \|\| iSquare != 0 \|\| iQuesty != 0 \|\| iBraces != 0){` |
...
|       19 |  519 | `		return rc;` |
|        - |  520 | `	}` |
|   967429 |  521 | `	return SXRET_OK;` |
|   483742 |  522 | `}` |
|        - |  523 | `/*` |
|        - |  524 | ` * Collect and assemble tokens holding a namespace path [i.e: namespace\to\const]` |
|        - |  525 | ` * or a simple literal [i.e: PHP_EOL].` |
|        - |  526 | ` */` |
|   800988 |  527 | `static void ExprAssembleLiteral(SyToken **ppCur,SyToken *pEnd)` |
|        5 |  528 | `{` |
|   800993 |  529 | `	SyToken *pIn = *ppCur;` |
|        - |  530 | `	/* Jump the first literal seen */` |
|   800993 |  531 | `	if( (pIn->nType & PH7_TK_NSSEP) == 0 ){` |
|   797341 |  532 | `		pIn++;` |
|   398668 |  533 | `	}` |
|   402344 |  534 | `	for(;;){` |
|   804693 |  535 | `		if(pIn < pEnd && (pIn->nType & PH7_TK_NSSEP) ){` |
|     3705 |  536 | `			pIn++;` |
|     3705 |  537 | `			if(pIn < pEnd && (pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|     3703 |  538 | `				pIn++;` |
|     1849 |  539 | `			}` |
|     1855 |  540 | `		}else{` |
|   400499 |  541 | `			break;` |
...
|        - |  876 | ` */` |
|  4280150 |  877 | `static sxi32 ExprExtractNode(ph7_gen_state *pGen,ph7_expr_node **ppNode,int iLastWasTerm,int bAfterMemberOp)` |
|        5 |  878 | `{` |
|        - |  879 | `	ph7_expr_node *pNode;` |
|        - |  880 | `	SyToken *pCur;` |
|        - |  881 | `	sxi32 rc;` |
|        - |  882 | `	/* Allocate a new node */` |
|  4280155 |  883 | `	pNode = (ph7_expr_node *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_expr_node));` |
|  4280155 |  884 | `	if( pNode == 0 ){` |
...
|  4280155 |  891 | `	SyZero(pNode,sizeof(ph7_expr_node));` |
|  4280155 |  892 | `	SySetInit(&pNode->aNodeArgs,&pGen->pVm->sAllocator,sizeof(ph7_expr_node **));` |
|        - |  893 | `	/* Point to the head of the token stream */` |
|  4280155 |  894 | `	pCur = pNode->pStart = pGen->pIn;` |
|        - |  895 | `	/* Start collecting tokens */` |
|  4280155 |  896 | `	if( pCur->nType & PH7_TK_ELLIPSIS ){` |
|     3767 |  897 | `		if( &pCur[1] < pGen->pEnd && (pCur[1].nType & PH7_TK_RPAREN) ){` |
...
|     3703 |  912 | `		pCur++;` |
|     3703 |  913 | `		pGen->pIn = pCur;` |
|     3703 |  914 | `		SyMemBackendPoolFree(&pGen->pVm->sAllocator, pNode);` |
|     3703 |  915 | `		rc = ExprExtractNode(pGen, ppNode, iLastWasTerm, 0/* a spread element is never a member name */);` |
|     3703 |  916 | `		if( rc == SXRET_OK && *ppNode ){` |
|     3703 |  917 | `			(*ppNode)->iFlags \|= EXPR_NODE_SPREAD;` |
|     1849 |  918 | `		}` |
|     3703 |  919 | `		return rc;` |
|        - |  920 | `	}` |
|  4276393 |  921 | `	if( (pCur->nType & PH7_TK_OSB) && !iLastWasTerm ){` |
...
|        5 |  950 | `		}` |
|  4275814 |  951 | `	}else if( pCur->nType & PH7_TK_OP ){` |
|        - |  952 | `		/* Point to the instance that describe this operator */` |
|   966265 |  953 | `		pNode->pOp = (const ph7_expr_op *)pCur->pUserData;` |
|        - |  954 | `		/* Advance the stream cursor */` |
|   966265 |  955 | `		pCur++;` |
|  3792105 |  956 | `	}else if( pCur->nType & PH7_TK_DOLLAR ){` |
|        - |  957 | `		/* Isolate variable */` |
|  2311929 |  958 | `		while( pCur < pGen->pEnd && (pCur->nType & PH7_TK_DOLLAR) ){` |
|  1155973 |  959 | `			pCur++; /* Variable variable */` |
|        5 |  960 | `		}` |
|  1155961 |  961 | `		if( pCur < pGen->pEnd ){` |
|  1155961 |  962 | `			if (pCur->nType & (PH7_TK_ID\|PH7_TK_KEYWORD) ){` |
|        - |  963 | `				/* Variable name */` |
|  1155933 |  964 | `				pCur++;` |
|   577997 |  965 | `			}else if( pCur->nType & PH7_TK_OCB /* '{' */ ){` |
|       24 |  966 | `				pCur++;` |
...
|        8 |  979 | `			}` |
|   577976 |  980 | `		}` |
|  1155957 |  981 | `		pNode->xCode = PH7_CompileVariable;` |
|  2730995 |  982 | `	 }else if( pCur->nType & PH7_TK_KEYWORD ){` |
|    54017 |  983 | `		 sxu32 nKeyword = (sxu32)SX_PTR_TO_INT(pCur->pUserData);` |
|    54017 |  984 | `		 if( bAfterMemberOp ){` |
...
|    53942 |  991 | `		 }else if( nKeyword == PH7_TKWRD_ARRAY \|\|  nKeyword == PH7_TKWRD_LIST ){` |
|        - |  992 | `			 /* List/Array node */` |
|    30739 |  993 | `			 if( &pCur[1] >= pGen->pEnd \|\| (pCur[1].nType & PH7_TK_LPAREN) == 0 ){` |
...
|    30739 | 1000 | `				 PH7_DelimitNestedTokens(pCur,pGen->pEnd,PH7_TK_LPAREN /* '(' */, PH7_TK_RPAREN /* ')' */,&pCur);` |
|    30739 | 1001 | `				 if( pCur < pGen->pEnd ){` |
|    30737 | 1002 | `					 pCur++;` |
|    15371 | 1003 | `				 }else{` |
|        - | 1004 | `					 /* Syntax error */` |
...
|        3 | 1011 | `					 return rc;` |
|        - | 1012 | `				 }` |
|    30737 | 1013 | `				 pNode->xCode = (nKeyword == PH7_TKWRD_LIST) ? PH7_CompileList : PH7_CompileArray;` |
|    30737 | 1014 | `				 if( pNode->xCode == PH7_CompileList ){` |
...
|       13 | 1025 | `				 }` |
|        5 | 1026 | `			 }` |
|    38498 | 1027 | `		 }else if( nKeyword == PH7_TKWRD_YIELD ){` |
...
|    23048 | 1034 | `		 }else if( nKeyword == PH7_TKWRD_FUNCTION ){` |
...
|        - | 1048 | `			  }` |
|    22795 | 1049 | `		 }else if( nKeyword == PH7_TKWRD_CLASS && &pCur[1] < pGen->pEnd` |
...
|    22630 | 1064 | `		 }else if( nKeyword == PH7_TKWRD_FN` |
|    22531 | 1065 | `			\|\| ( nKeyword == PH7_TKWRD_STATIC && &pCur[1] < pGen->pEnd` |
...
|    22530 | 1075 | `		 }else if( nKeyword == PH7_TKWRD_MATCH ){` |
...
|    22408 | 1083 | `		 }else if( nKeyword == PH7_TKWRD_THROW ){` |
...
|    22355 | 1092 | `		 }else if( PH7_IsLangConstruct(nKeyword,FALSE) == TRUE && &pCur[1] < pGen->pEnd ){` |
...
|    22249 | 1098 | `			 ExprAssembleLiteral(&pCur,pGen->pEnd);` |
|    22249 | 1099 | `			 pNode->xCode = PH7_CompileLiteral;` |
|        5 | 1100 | `		 }` |
|  2125999 | 1101 | `	 }else if( pCur->nType & (PH7_TK_NSSEP\|PH7_TK_ID) ){` |
|        - | 1102 | `		 /* Constants,function name,namespace path,class name... */` |
|   778599 | 1103 | `		 ExprAssembleLiteral(&pCur,pGen->pEnd);` |
|   778599 | 1104 | `		 pNode->xCode = PH7_CompileLiteral;` |
|   389302 | 1105 | `	 }else{` |
|  1320413 | 1106 | `		 if( (pCur->nType & (PH7_TK_LPAREN\|PH7_TK_RPAREN\|PH7_TK_COMMA\|PH7_TK_COLON\|PH7_TK_CSB\|PH7_TK_OCB\|PH7_TK_CCB)) == 0 ){` |
|        - | 1107 | `			 /* Point to the code generator routine */` |
|   253379 | 1108 | `			 pNode->xCode = PH7_GetNodeHandler(pCur->nType);` |
|   253379 | 1109 | `			 if( pNode->xCode == 0 ){` |
...
|  4276359 | 1122 | `	pNode->pEnd = pCur;` |
|        - | 1123 | `	/* Save the node for later processing */` |
|  4276359 | 1124 | `	*ppNode = pNode;` |
|        - | 1125 | `	/* Synchronize cursors */` |
|  4276359 | 1126 | `	pGen->pIn = pCur;` |
|  4276359 | 1127 | `	return SXRET_OK;` |
|  2140080 | 1128 | `}` |
|        - | 1129 | `/*` |
...
|        - | 1132 | ` * level is zero.` |
|        - | 1133 | ` */` |
|    95492 | 1134 | `PH7_PRIVATE sxi32 PH7_GetNextExpr(SyToken *pStart,SyToken *pEnd,SyToken **ppNext)` |
|        5 | 1135 | `{` |
|    95497 | 1136 | `	SyToken *pCur = pStart;` |
|    95497 | 1137 | `	sxi32 iNest = 0;` |
|    95497 | 1138 | `	if( pCur >= pEnd \|\| (pCur->nType & PH7_TK_SEMI/*';'*/) ){` |
|        - | 1139 | `		/* Last expression */` |
|    49815 | 1140 | `		return SXERR_EOF;` |
|        - | 1141 | `	}` |
|   187419 | 1142 | `	while( pCur < pEnd ){` |
|   170889 | 1143 | `		if( (pCur->nType & (PH7_TK_COMMA/*','*/\|PH7_TK_SEMI/*';'*/)) && iNest <= 0){` |
|    29157 | 1144 | `			break;` |
|        - | 1145 | `		}` |
|   141737 | 1146 | `		if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|     9509 | 1147 | `			iNest++;` |
|   136985 | 1148 | `		}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}*/) ){` |
|     9511 | 1149 | `			iNest--;` |
|     4753 | 1150 | `		}` |
|   141737 | 1151 | `		pCur++;` |
|        5 | 1152 | `	}` |
|    45687 | 1153 | `	*ppNext = pCur;` |
|    45687 | 1154 | `	return SXRET_OK;` |
|    47751 | 1155 | `}` |
|        - | 1156 | `/*` |
|        - | 1157 | ` * Free an expression tree.` |
|        - | 1158 | ` */` |
|  3654936 | 1159 | `static void ExprFreeTree(ph7_gen_state *pGen,ph7_expr_node *pNode)` |
|        5 | 1160 | `{` |
|  3654941 | 1161 | `	if( pNode->pLeft ){` |
|        - | 1162 | `		/* Release the left tree */` |
|  1349803 | 1163 | `		ExprFreeTree(&(*pGen),pNode->pLeft);` |
|   674899 | 1164 | `	}` |
|  3654941 | 1165 | `	if( pNode->pRight ){` |
|        - | 1166 | `		/* Release the right tree */` |
|   729827 | 1167 | `		ExprFreeTree(&(*pGen),pNode->pRight);` |
|   364911 | 1168 | `	}` |
|  3654941 | 1169 | `	if( pNode->pCond ){` |
|        - | 1170 | `		/* Release the conditional tree used by the ternary operator */` |
|     2669 | 1171 | `		ExprFreeTree(&(*pGen),pNode->pCond);` |
|     1332 | 1172 | `	}` |
|  3654941 | 1173 | `	if( SySetUsed(&pNode->aNodeArgs) > 0 ){` |
|        - | 1174 | `		ph7_expr_node **apArg;` |
|        - | 1175 | `		sxu32 n;` |
|        - | 1176 | `		/* Release node arguments */` |
|   471847 | 1177 | `		apArg = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  1014749 | 1178 | `		for( n = 0 ; n < SySetUsed(&pNode->aNodeArgs) ; ++n ){` |
|   542907 | 1179 | `			ExprFreeTree(&(*pGen),apArg[n]);` |
|   271456 | 1180 | `		}` |
|   471847 | 1181 | `		SySetRelease(&pNode->aNodeArgs);` |
|   235921 | 1182 | `	}` |
|        - | 1183 | `	/* Finally,release this node */` |
|  3654941 | 1184 | `	SyMemBackendPoolFree(&pGen->pVm->sAllocator,pNode);` |
|  3654941 | 1185 | `}` |
|        - | 1186 | `/*` |
|        - | 1187 | ` * Free an expression tree.` |
|        - | 1188 | ` * This function is a wrapper around ExprFreeTree() defined above.` |
|        - | 1189 | ` */` |
|   967508 | 1190 | `PH7_PRIVATE sxi32 PH7_ExprFreeTree(ph7_gen_state *pGen,SySet *pNodeSet)` |
|        5 | 1191 | `{` |
|        - | 1192 | `	ph7_expr_node **apNode;` |
|        - | 1193 | `	sxu32 n;` |
|   967513 | 1194 | `	apNode = (ph7_expr_node **)SySetBasePtr(pNodeSet);` |
|  5243931 | 1195 | `	for( n = 0  ; n < SySetUsed(pNodeSet) ; ++n ){` |
|  4276423 | 1196 | `		if( apNode[n] ){` |
|   967847 | 1197 | `			ExprFreeTree(&(*pGen),apNode[n]);` |
|   483921 | 1198 | `		}` |
|  2138214 | 1199 | `	}` |
|   967513 | 1200 | `	return SXRET_OK;` |
|        5 | 1201 | `}` |
|        - | 1202 | `/*` |
...
|        - | 1208 | ` */` |
|  1322162 | 1209 | `PH7_PRIVATE int PH7_ExprContainsNullsafe(ph7_expr_node *pNode)` |
|        5 | 1210 | `{` |
|  1322167 | 1211 | `	if( pNode == 0 ){` |
|   815811 | 1212 | `		return 0;` |
|        - | 1213 | `	}` |
|   506361 | 1214 | `	if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW ){` |
|       16 | 1215 | `		return 1;` |
|        - | 1216 | `	}` |
|   506349 | 1217 | `	if( PH7_ExprContainsNullsafe(pNode->pLeft) ){` |
|        6 | 1218 | `		return 1;` |
|        - | 1219 | `	}` |
|   506345 | 1220 | `	if( PH7_ExprContainsNullsafe(pNode->pRight) ){` |
|      ! 0 | 1221 | `		return 1;` |
|        - | 1222 | `	}` |
|   506345 | 1223 | `	return 0;` |
|   661086 | 1224 | `}` |
|        - | 1225 | `/*` |
|        - | 1226 | ` * Check if the given node is a modifialbe l/r-value.` |
|        - | 1227 | ` * Return TRUE if modifiable.FALSE otherwise.` |
|        - | 1228 | ` */` |
|   302638 | 1229 | `static int ExprIsModifiableValue(ph7_expr_node *pNode,sxu8 bFunc)` |
|        5 | 1230 | `{` |
|        - | 1231 | `	sxi32 iExprOp;` |
|   302643 | 1232 | `	if( pNode->pOp == 0 ){` |
|   186049 | 1233 | `		return pNode->xCode == PH7_CompileVariable ? TRUE : FALSE;` |
|        - | 1234 | `	}` |
|   116599 | 1235 | `	iExprOp = pNode->pOp->iOp;` |
|   116599 | 1236 | `	if( iExprOp == EXPR_OP_ARROW /*'->' */ \|\| iExprOp == EXPR_OP_DC /*'::'*/ ){` |
|    79997 | 1237 | `			return TRUE;` |
|        - | 1238 | `	}` |
|    36607 | 1239 | `	if( iExprOp == EXPR_OP_SUBSCRIPT/*'[]'*/ ){` |
|    36603 | 1240 | `		if( pNode->pLeft->pOp ) {` |
|       66 | 1241 | `			if( pNode->pLeft->pOp->iOp != EXPR_OP_SUBSCRIPT /*'['*/ && pNode->pLeft->pOp->iOp != EXPR_OP_ARROW /*'->'*/` |
|       31 | 1242 | `				&& pNode->pLeft->pOp->iOp != EXPR_OP_DC /*'::'*/){` |
|      ! 0 | 1243 | `				return FALSE;` |
|        5 | 1244 | `			}` |
|    36570 | 1245 | `		}else if( pNode->pLeft->xCode != PH7_CompileVariable ){` |
|      ! 0 | 1246 | `			return FALSE;` |
|        - | 1247 | `		}` |
|    36603 | 1248 | `		return TRUE;` |
|        - | 1249 | `	}` |
...
|        - | 1266 | ` */` |
|   397096 | 1267 | `static sxi32 ExprProcessFuncArguments(ph7_gen_state *pGen,ph7_expr_node *pOp,ph7_expr_node **apNode,sxi32 nToken)` |
|        5 | 1268 | `{` |
...
|   397101 | 1272 | `	iCur = 0;` |
|   432614 | 1273 | `	for(;;){` |
|   865233 | 1274 | `		if( iCur >= nToken ){` |
|        - | 1275 | `			/* No more arguments to process */` |
|   397075 | 1276 | `			break;` |
|        - | 1277 | `		}` |
|   468163 | 1278 | `		iNode = iCur;` |
|   468163 | 1279 | `		iNest = 0;` |
|  1158031 | 1280 | `		while( iCur < nToken ){` |
|   760959 | 1281 | `			if( apNode[iCur] ){` |
|   746511 | 1282 | `				if( (apNode[iCur]->pStart->nType & PH7_TK_COMMA) && apNode[iCur]->pLeft == 0 && iNest <= 0 ){` |
|    35548 | 1283 | `					break;` |
|   694309 | 1284 | `				}else if( (apNode[iCur]->pStart->nType & (PH7_TK_LPAREN\|PH7_TK_OSB\|PH7_TK_OCB))` |
|   356780 | 1285 | `					&& apNode[iCur]->xCode != PH7_CompileShortArray` |
|    37964 | 1286 | `					&& apNode[iCur]->xCode != PH7_CompileShortList ){` |
...
|    37783 | 1293 | `					iNest++;` |
|   656536 | 1294 | `				}else if( apNode[iCur]->pStart->nType & (PH7_TK_RPAREN\|PH7_TK_CCB\|PH7_TK_CSB) ){` |
|    37783 | 1295 | `					iNest--;` |
|    18889 | 1296 | `				}` |
|   337710 | 1297 | `			}` |
|   689873 | 1298 | `			iCur++;` |
|        5 | 1299 | `		}` |
|   468163 | 1300 | `		if( iCur > iNode ){` |
|   468157 | 1301 | `			SyString sArgName = {0, 0};` |
...
|   472339 | 1305 | `			if( (iCur - iNode) >= 2` |
|   258884 | 1306 | `				&& apNode[iNode]` |
|    49616 | 1307 | `				&& (apNode[iNode]->pStart->nType & (PH7_TK_ID\|PH7_TK_KEYWORD))` |
|    29119 | 1308 | `				&& apNode[iNode]->xCode == PH7_CompileLiteral` |
|     8498 | 1309 | `				&& apNode[iNode+1]` |
|     8379 | 1310 | `				&& (apNode[iNode+1]->pStart->nType & PH7_TK_COLON) ){` |
...
|        - | 1329 | `				}` |
|      106 | 1330 | `			}` |
|   468150 | 1331 | `			if( apNode[iNode] && (apNode[iNode]->pStart->nType & PH7_TK_AMPER /*'&'*/) && ((iCur - iNode) == 2)` |
...
|      ! 0 | 1337 | `			}` |
|   468155 | 1338 | `			ExprMakeTree(&(*pGen),&apNode[iNode],iCur-iNode);` |
|   468155 | 1339 | `			if( apNode[iNode] ){` |
|   468155 | 1340 | `				if( sArgName.nByte > 0 ){` |
...
|   468155 | 1345 | `				SySetPut(&pOp->aNodeArgs,(const void *)&apNode[iNode]);` |
|   234080 | 1346 | `			}else{` |
...
|   468155 | 1365 | `		if( iCur < nToken && apNode[iCur] && (apNode[iCur]->pStart->nType & PH7_TK_COMMA) ){` |
|    71085 | 1366 | `			iCur++;` |
|    71085 | 1367 | `			if( iCur >= nToken ){` |
|        - | 1368 | `				/* Trailing comma after last argument */` |
|       19 | 1369 | `				break;` |
|        - | 1370 | `			}` |
|    35531 | 1371 | `		}` |
|        5 | 1372 | `	}` |
|   397093 | 1373 | `	return SXRET_OK;` |
|   198553 | 1374 | `}` |
|        - | 1375 | ` /*` |
...
|        - | 1379 | `  */` |
|  1550270 | 1380 | ` static sxi32 ExprMakeTree(ph7_gen_state *pGen,ph7_expr_node **apNode,sxi32 nToken)` |
|        5 | 1381 | ` {` |
|        - | 1382 | `	 sxi32 i,iLeft,iRight;` |
|        - | 1383 | `	 ph7_expr_node *pNode;` |
|        - | 1384 | `	 sxi32 iCur;` |
|        - | 1385 | `	 sxi32 rc;` |
|  1550275 | 1386 | `	 if( nToken <= 0 \|\| (nToken == 1 && apNode[0]->xCode) ){` |
|        - | 1387 | `		 /* TICKET 1433-17: self evaluating node */` |
|   726579 | 1388 | `		 return SXRET_OK;` |
|        - | 1389 | `	 }` |
|        - | 1390 | `	 /* Process expressions enclosed in parenthesis first */` |
|  5112961 | 1391 | `	 for( iCur =  0 ; iCur < nToken ; ++iCur ){` |
|        - | 1392 | `		 sxi32 iNest;` |
...
|        - | 1395 | `		  */` |
|  4289267 | 1396 | `		 if( apNode[iCur] == 0 \|\| apNode[iCur]->pStart->nType != PH7_TK_LPAREN ){` |
|  4258533 | 1397 | `			 continue;` |
|        - | 1398 | `		 }` |
|    30739 | 1399 | `		 iNest = 1;` |
|    30739 | 1400 | `		 iLeft = iCur;` |
|        - | 1401 | `		 /* Find the closing parenthesis */` |
|    30739 | 1402 | `		 iCur++;` |
|   205051 | 1403 | `		 while( iCur < nToken ){` |
|   205051 | 1404 | `			 if( apNode[iCur] ){` |
|   205051 | 1405 | `				 if( apNode[iCur]->pStart->nType & PH7_TK_RPAREN /* ')' */){` |
|        - | 1406 | `					 /* Decrement nesting level */` |
|    53353 | 1407 | `					 iNest--;` |
|    53353 | 1408 | `					 if( iNest <= 0 ){` |
|    30739 | 1409 | `						 break;` |
|        5 | 1410 | `					 }` |
|   163010 | 1411 | `				 }else if( apNode[iCur]->pStart->nType & PH7_TK_LPAREN /* '(' */ ){` |
...
|   174317 | 1416 | `			 iCur++;` |
|        5 | 1417 | `		 }` |
|    30739 | 1418 | `		 if( iCur - iLeft > 1 ){` |
|        - | 1419 | `			 sxi32 j;` |
|        - | 1420 | `			 /* Recurse and process this expression */` |
|    30739 | 1421 | `			 rc = ExprMakeTree(&(*pGen),&apNode[iLeft + 1],iCur - iLeft - 1);` |
|    30739 | 1422 | `			 if( rc != SXRET_OK ){` |
|        3 | 1423 | `				 return rc;` |
|        - | 1424 | `			 }` |
...
|    30737 | 1428 | `			 for( j = iLeft + 1 ; j < iCur ; ++j ){` |
|    30737 | 1429 | `				 if( apNode[j] ){` |
|    30737 | 1430 | `					 apNode[j]->iFlags \|= EXPR_NODE_PARENS;` |
|    30737 | 1431 | `					 break;` |
|        - | 1432 | `				 }` |
|      ! 0 | 1433 | `			 }` |
|    15366 | 1434 | `		 }` |
|        - | 1435 | `		 /* Free the left and right nodes */` |
|    30737 | 1436 | `		 ExprFreeTree(&(*pGen),apNode[iLeft]);` |
|    30737 | 1437 | `		 ExprFreeTree(&(*pGen),apNode[iCur]);` |
|    30737 | 1438 | `		 apNode[iLeft] = 0;` |
|    30737 | 1439 | `		 apNode[iCur] = 0;` |
|    15371 | 1440 | `	 }` |
|        - | 1441 | `	  /* Process expressions enclosed in braces */` |
|  5310093 | 1442 | `	 for( iCur =  0 ; iCur < nToken ; ++iCur ){` |
|        - | 1443 | `		 sxi32 iNest;` |
...
|        - | 1446 | `		  */` |
|  4494287 | 1447 | `		 if( apNode[iCur] == 0 \|\| apNode[iCur]->pStart->nType != PH7_TK_OCB ){` |
|  4494279 | 1448 | `			 continue;` |
|        - | 1449 | `		 }` |
|       10 | 1450 | `		 iNest = 1;` |
|       10 | 1451 | `		 iLeft = iCur;` |
...
|   815811 | 1483 | `	 iLeft = -1;` |
|  5310071 | 1484 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  4494277 | 1485 | `		 if( apNode[iCur] == 0 ){` |
|  1769479 | 1486 | `			 continue;` |
|        - | 1487 | `		 }` |
|  2724803 | 1488 | `		 pNode = apNode[iCur];` |
|  2724803 | 1489 | `		 if( pNode->pOp && pNode->pOp->iPrec == 2 && pNode->pLeft == 0  ){` |
|   727825 | 1490 | `			 if( pNode->pOp->iOp == EXPR_OP_FUNC_CALL ){` |
|        - | 1491 | `				 /* Collect function arguments */` |
|   454843 | 1492 | `				 sxi32 iPtr = 0;` |
|   454843 | 1493 | `				 sxi32 nFuncTok = 0;` |
|  1670637 | 1494 | `				 while( nFuncTok + iCur < nToken ){` |
|  1670637 | 1495 | `					 if( apNode[nFuncTok+iCur] ){` |
|  1656189 | 1496 | `						 if( apNode[nFuncTok+iCur]->pStart->nType & PH7_TK_LPAREN /*'('*/ ){` |
|   474119 | 1497 | `							 iPtr++;` |
|  1419132 | 1498 | `						 }else if ( apNode[nFuncTok+iCur]->pStart->nType & PH7_TK_RPAREN /*')'*/){` |
|   474119 | 1499 | `							 iPtr--;` |
|   474119 | 1500 | `							 if( iPtr <= 0 ){` |
|   454843 | 1501 | `								 break;` |
|        - | 1502 | `							 }` |
|     9638 | 1503 | `						 }` |
|   600673 | 1504 | `					 }` |
|  1215799 | 1505 | `					 nFuncTok++;` |
|        5 | 1506 | `				 }` |
|   454843 | 1507 | `				 if( nFuncTok + iCur >= nToken ){` |
|        - | 1508 | `					 /* Syntax error */` |
...
|      ! 0 | 1513 | `					 return rc;` |
|        - | 1514 | `				 }` |
|   454843 | 1515 | `				 if(  iLeft < 0 \|\| !NODE_ISTERM(iLeft) /*\|\| ( apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec != 2)*/ ){` |
|        - | 1516 | `					 /* Syntax error */` |
...
|      ! 0 | 1521 | `					 return rc;` |
|        - | 1522 | `				 }` |
|   454843 | 1523 | `				 if( nFuncTok > 1 ){` |
|        - | 1524 | `					 /* Process function arguments */` |
|   397101 | 1525 | `					 rc = ExprProcessFuncArguments(&(*pGen),pNode,&apNode[iCur+1],nFuncTok-1);` |
|   397101 | 1526 | `					 if( rc != SXRET_OK ){` |
|       11 | 1527 | `						 return rc;` |
|        - | 1528 | `					 }` |
|   198544 | 1529 | `				 }` |
|        - | 1530 | `				 /* Link the node to the tree */` |
|   454835 | 1531 | `				 pNode->pLeft = apNode[iLeft];` |
|   454835 | 1532 | `				 apNode[iLeft] = 0;` |
|  1670605 | 1533 | `				 for( iPtr = 1; iPtr <= nFuncTok ; iPtr++ ){` |
|  1215775 | 1534 | `					 apNode[iCur+iPtr] = 0;` |
|   607890 | 1535 | `				 }` |
|   500402 | 1536 | `			 }else if (pNode->pOp->iOp == EXPR_OP_SUBSCRIPT ){` |
|        - | 1537 | `				 /* Subscripting */` |
|    92917 | 1538 | `				 sxi32 iArrTok = iCur + 1;` |
|    92917 | 1539 | `				 sxi32 iNest = 1;` |
|    93124 | 1540 | `				 if(  iLeft < 0 \|\| apNode[iLeft] == 0 \|\| (apNode[iLeft]->pOp == 0 && (apNode[iLeft]->xCode != PH7_CompileVariable &&` |
...
|    92912 | 1544 | `					 ( apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec != 2 /* postfix */) ){` |
|        - | 1545 | `						 /* Syntax error */` |
...
|   167791 | 1553 | `				 while( iArrTok < nToken ){` |
|   167791 | 1554 | `					 if( apNode[iArrTok] ){` |
|   167759 | 1555 | `						 if( apNode[iArrTok]->pOp && apNode[iArrTok]->pOp->iOp == EXPR_OP_SUBSCRIPT &&  apNode[iArrTok]->pLeft == 0){` |
|        - | 1556 | `							 /* Increment nesting level */` |
|      ! 0 | 1557 | `							 iNest++;` |
|   167759 | 1558 | `						 }else if( apNode[iArrTok]->pStart->nType & PH7_TK_CSB /*']'*/){` |
|        - | 1559 | `							 /* Decrement nesting level */` |
|    92917 | 1560 | `							 iNest--;` |
|    92917 | 1561 | `							 if( iNest <= 0 ){` |
|    92917 | 1562 | `								 break;` |
|        - | 1563 | `							 }` |
|      ! 0 | 1564 | `						 }` |
|    37421 | 1565 | `					 }` |
|    74879 | 1566 | `					 ++iArrTok;` |
|        5 | 1567 | `				 }` |
|    92917 | 1568 | `				 if( iArrTok > iCur + 1 ){` |
|        - | 1569 | `					 /* Recurse and process this expression */` |
|    74757 | 1570 | `					 rc = ExprMakeTree(&(*pGen),&apNode[iCur+1],iArrTok - iCur - 1);` |
|    74757 | 1571 | `					 if( rc != SXRET_OK ){` |
|      ! 0 | 1572 | `						 return rc;` |
|        - | 1573 | `					 }` |
|        - | 1574 | `					 /* Link the node to it's index */` |
|    74757 | 1575 | `					 SySetPut(&pNode->aNodeArgs,(const void *)&apNode[iCur+1]);` |
|    37376 | 1576 | `				 }` |
|        - | 1577 | `				 /* Link the node to the tree */` |
|    92917 | 1578 | `				 pNode->pLeft = apNode[iLeft];` |
|    92917 | 1579 | `				 pNode->pRight = 0;` |
|    92917 | 1580 | `				 apNode[iLeft] = 0;` |
|   260703 | 1581 | `				 for( iNest = iCur + 1 ; iNest <= iArrTok ; ++iNest ){` |
|   167791 | 1582 | `					 apNode[iNest] = 0;` |
|    83898 | 1583 | `				 }` |
|    46461 | 1584 | `			 }else{` |
|        - | 1585 | `				 /* Member access operators [i.e: '->','::'] */` |
|   180075 | 1586 | `				  iRight = iCur + 1;` |
|   180081 | 1587 | `				 while( iRight < nToken && apNode[iRight] == 0 ){` |
|        7 | 1588 | `					 iRight++;` |
|        1 | 1589 | `				 }` |
|   180075 | 1590 | `				 if( iRight >= nToken \|\| iLeft < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|        - | 1591 | `					 /* Syntax error */` |
...
|   180071 | 1599 | `				 pNode->pLeft = apNode[iLeft];` |
|   269875 | 1600 | `				 if( (pNode->pOp->iOp == EXPR_OP_ARROW /*'->'*/ \|\| pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW /*'?->'*/)` |
|   179904 | 1601 | `					 && pNode->pLeft->pOp == 0 &&` |
|   179618 | 1602 | `					 pNode->pLeft->xCode != PH7_CompileVariable ){` |
|        - | 1603 | `						 /* Syntax error */` |
...
|      ! 0 | 1609 | `						 return rc;` |
|        - | 1610 | `				 }` |
|   180071 | 1611 | `				 pNode->pRight = apNode[iRight];` |
|   180071 | 1612 | `				 apNode[iLeft] = apNode[iRight] = 0;` |
|        - | 1613 | `			 }` |
|   363904 | 1614 | `		 }` |
|  2724791 | 1615 | `		 iLeft = iCur;` |
|  1362398 | 1616 | `	 }` |
|        - | 1617 | `	 /* Handle left associative (new, clone) operators */` |
|  5310039 | 1618 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  4494245 | 1619 | `		 if( apNode[iCur] == 0 ){` |
|  2520603 | 1620 | `			 continue;` |
|        - | 1621 | `		 }` |
|  1973647 | 1622 | `		 pNode = apNode[iCur];` |
|  1973647 | 1623 | `		 if( pNode->pOp && pNode->pOp->iPrec == 1 && pNode->pLeft == 0 ){` |
|        - | 1624 | `			 SyToken *pToken;` |
|        - | 1625 | `			 /* Get the left node */` |
|    23321 | 1626 | `			 iLeft = iCur + 1;` |
|    46387 | 1627 | `			 while( iLeft < nToken && apNode[iLeft] == 0 ){` |
|    23071 | 1628 | `				 iLeft++;` |
|        5 | 1629 | `			 }` |
|    23321 | 1630 | `			 if( iLeft >= nToken \|\| !NODE_ISTERM(iLeft) ){` |
|        - | 1631 | `				  /* Syntax error */` |
...
|    23321 | 1640 | `			 if( pNode->pOp->iOp == EXPR_OP_CLONE ){` |
|        - | 1641 | `				 /* Clone:` |
...
|       21 | 1662 | `			 }else{` |
|        - | 1663 | `				 /* New */` |
|    23287 | 1664 | `				 if( apNode[iLeft]->pOp == 0 ){` |
...
|    23321 | 1681 | `			 pNode->pLeft = apNode[iLeft];` |
|    23321 | 1682 | `			 apNode[iLeft] = 0;` |
|    23321 | 1683 | `			 pNode->pRight = 0; /* Paranoid */` |
|    11658 | 1684 | `		 }` |
|   986826 | 1685 | `	 }` |
|        - | 1686 | `	  /* Handle post/pre icrement/decrement [i.e: ++/--] operators with precedence 3 */` |
|   815799 | 1687 | `	 iLeft = -1;` |
|  5313983 | 1688 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  4494245 | 1689 | `		 if( apNode[iCur] == 0 ){` |
|  2520603 | 1690 | `			 continue;` |
|        - | 1691 | `		 }` |
|  1973647 | 1692 | `		 pNode = apNode[iCur];` |
|  1973647 | 1693 | `		 if( pNode->pOp && pNode->pOp->iPrec == 3 && pNode->pLeft == 0){` |
|    10903 | 1694 | `			 if( iLeft >= 0 && ((apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec == 2 /* Postfix */)` |
|     3980 | 1695 | `				 \|\| apNode[iLeft]->xCode == PH7_CompileVariable) ){` |
|        - | 1696 | `					 /* Link the node to the tree */` |
|     3991 | 1697 | `					 pNode->pLeft = apNode[iLeft];` |
|     3991 | 1698 | `					 apNode[iLeft] = 0;` |
|     1993 | 1699 | `			 }` |
|     7421 | 1700 | `		  }` |
|  1977591 | 1701 | `		 iLeft = iCur;` |
|   990770 | 1702 | `	  }` |
|   819743 | 1703 | `	 iLeft = -1;` |
|  5313983 | 1704 | `	 for( iCur = nToken -  1 ; iCur >= 0 ; iCur-- ){` |
|  4494245 | 1705 | `		 if( apNode[iCur] == 0 ){` |
|  2524589 | 1706 | `			 continue;` |
|        - | 1707 | `		 }` |
|  1969661 | 1708 | `		 pNode = apNode[iCur];` |
|  1969661 | 1709 | `		 if( pNode->pOp && pNode->pOp->iPrec == 3 && pNode->pLeft == 0){` |
|    10859 | 1710 | `			 if( iLeft < 0 \|\| (apNode[iLeft]->pOp == 0 && apNode[iLeft]->xCode != PH7_CompileVariable)` |
|    10861 | 1711 | `				 \|\| ( apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec != 2 /* Postfix */) ){` |
|        - | 1712 | `					 /* Syntax error */` |
...
|    10861 | 1720 | `			 pNode->pLeft = apNode[iLeft];` |
|    10861 | 1721 | `			 apNode[iLeft] = 0;` |
|        - | 1722 | `			 /* Mark as pre-increment/decrement node */` |
|    10861 | 1723 | `			 pNode->iFlags \|= EXPR_NODE_PRE_INCR;` |
|     5428 | 1724 | `		  }` |
|  1969661 | 1725 | `		 iLeft = iCur;` |
|   984833 | 1726 | `	 }` |
|        - | 1727 | `	 /* Handle right associative unary and cast operators [i.e: !,(string),~...]  with precedence 4*/` |
|   819743 | 1728 | `	  iLeft = 0;` |
|  5313977 | 1729 | `	  for( iCur = nToken -  1 ; iCur >= 0 ; iCur-- ){` |
|  4494241 | 1730 | `		  if( apNode[iCur] ){` |
|  1958801 | 1731 | `			  pNode = apNode[iCur];` |
|  1958801 | 1732 | `			  if( pNode->pOp && pNode->pOp->iPrec == 4 && pNode->pLeft == 0){` |
|    34151 | 1733 | `				  if( iLeft > 0 ){` |
|        - | 1734 | `					  /* Link the node to the tree */` |
|    34149 | 1735 | `					  pNode->pLeft = apNode[iLeft];` |
|    34149 | 1736 | `					  apNode[iLeft] = 0;` |
|    34149 | 1737 | `					  if( pNode->pLeft && pNode->pLeft->pOp && pNode->pLeft->pOp->iPrec > 4 ){` |
...
|  5313975 | 1764 | `	 for( iCur = nToken - 1 ; iCur >= 0 ; --iCur ){` |
|  4494239 | 1765 | `		 if( apNode[iCur] == 0 ){` |
|  2569701 | 1766 | `			 continue;` |
|        - | 1767 | `		 }` |
|  1924543 | 1768 | `		 pNode = apNode[iCur];` |
|  1924543 | 1769 | `		 if( pNode->pOp && pNode->pOp->iPrec == 5 && pNode->pLeft == 0 ){` |
|        - | 1770 | `			 sxi32 iL, iR;` |
...
|  9017015 | 1833 | `	 for( i = 7 ; i < 17 ; i++ ){` |
|  8197289 | 1834 | `		 iLeft = -1;` |
| 53139335 | 1835 | `		 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
| 44942061 | 1836 | `			 if( apNode[iCur] == 0 ){` |
| 28966073 | 1837 | `				 continue;` |
|        - | 1838 | `			 }` |
| 15975993 | 1839 | `			 pNode = apNode[iCur];` |
| 15975993 | 1840 | `			 if( pNode->pOp && pNode->pOp->iPrec == i && pNode->pLeft == 0 ){` |
|        - | 1841 | `				 /* Get the right node */` |
|   244379 | 1842 | `				 iRight = iCur + 1;` |
|   349227 | 1843 | `				 while( iRight < nToken && apNode[iRight] == 0 ){` |
|   104853 | 1844 | `					 iRight++;` |
|        5 | 1845 | `				 }` |
|   244379 | 1846 | `				 if( iRight >= nToken \|\| iLeft < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|        - | 1847 | `					 /* Syntax error */` |
...
|       11 | 1852 | `					 return rc;` |
|        - | 1853 | `				 }` |
|   244371 | 1854 | `				 if( pNode->pOp->iOp == EXPR_OP_REF ){` |
|        - | 1855 | `					 sxi32  iTmp;` |
...
|   244369 | 1896 | `				 pNode->pLeft = apNode[iLeft];` |
|   244369 | 1897 | `				 pNode->pRight = apNode[iRight];` |
|   244369 | 1898 | `				 apNode[iLeft] = apNode[iRight] = 0;` |
|   122182 | 1899 | `			 }` |
| 15975983 | 1900 | `			 iLeft = iCur;` |
|  7987994 | 1901 | `		 }` |
|  4098642 | 1902 | `	 }` |
...
|        - | 1906 | `	  */` |
|   819731 | 1907 | `	  iLeft = -1;` |
|  5302517 | 1908 | `	  for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  4485457 | 1909 | `		  if( apNode[iCur] == 0 ){` |
|  3057741 | 1910 | `			  continue;` |
|        - | 1911 | `		  }` |
|  1427721 | 1912 | `		  pNode = apNode[iCur];` |
|  1427721 | 1913 | `		  if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_QUESTY && pNode->pLeft == 0 ){` |
...
|        - | 1979 | `	  */` |
|   819729 | 1980 | `	 iRight = -1;` |
|  5313779 | 1981 | `	 for( iCur = nToken -  1 ; iCur >= 0 ; iCur--){` |
|  4494109 | 1982 | `		 if( apNode[iCur] == 0 ){` |
|  3371663 | 1983 | `			 continue;` |
|        - | 1984 | `		 }` |
|  1122451 | 1985 | `		 pNode = apNode[iCur];` |
|  1122451 | 1986 | `		 if( pNode->pOp && pNode->pOp->iPrec == 18 && pNode->pLeft == 0 ){` |
|        - | 1987 | `			 /* Get the left node */` |
|   302605 | 1988 | `			 iLeft = iCur - 1;` |
|   437699 | 1989 | `			 while( iLeft >= 0 && apNode[iLeft] == 0 ){` |
|   135099 | 1990 | `				 iLeft--;` |
|        5 | 1991 | `			 }` |
|   302605 | 1992 | `			 if( iLeft < 0 \|\| iRight < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|        - | 1993 | `				 /* Syntax error */` |
...
|        - | 2010 | `			  * a write. */` |
|   302563 | 2011 | `			 if( PH7_ExprContainsNullsafe(apNode[iLeft]) ){` |
...
|       11 | 2017 | `				 return rc;` |
|        - | 2018 | `			 }` |
|   302555 | 2019 | `			 if( ExprIsModifiableValue(apNode[iLeft],FALSE) == FALSE ){` |
...
|   302551 | 2038 | `			 pNode->pLeft = apNode[iRight];` |
|   302551 | 2039 | `			 pNode->pRight = apNode[iLeft];` |
|   302551 | 2040 | `			 apNode[iLeft] = apNode[iRight] = 0;` |
|   151273 | 2041 | `		 }` |
|  1122397 | 2042 | `		 iRight = iCur;` |
|   561201 | 2043 | `	 }` |
|        - | 2044 | `	 /* Process left associative binary operators that have the lowest precedence [i.e: and,or,xor] */` |
|  4098355 | 2045 | `	 for( i = 19 ; i < 23 ; i++ ){` |
|  3278685 | 2046 | `		 iLeft = -1;` |
| 21254829 | 2047 | `		 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
| 17976149 | 2048 | `			 if( apNode[iCur] == 0 ){` |
| 14697063 | 2049 | `				 continue;` |
|        - | 2050 | `			 }` |
|  3279091 | 2051 | `			 pNode = apNode[iCur];` |
|  3279091 | 2052 | `			 if( pNode->pOp && pNode->pOp->iPrec == i && pNode->pLeft == 0 ){` |
...
|       35 | 2070 | `			 }` |
|  3279091 | 2071 | `			 iLeft = iCur;` |
|  1639548 | 2072 | `		 }` |
|  1639345 | 2073 | `	 }` |
|        - | 2074 | `	 /* Point to the root of the expression tree */` |
|  4494013 | 2075 | `	 for( iCur = 1 ; iCur < nToken ; ++iCur ){` |
|  3674361 | 2076 | `		 if( apNode[iCur] ){` |
|   756657 | 2077 | `			 if( (apNode[iCur]->pOp \|\| apNode[iCur]->xCode ) && apNode[0] != 0){` |
...
|       23 | 2082 | `				  return rc;` |
|        - | 2083 | `			 }` |
|   756639 | 2084 | `			 apNode[0] = apNode[iCur];` |
|   756639 | 2085 | `			 apNode[iCur] = 0;` |
|   378317 | 2086 | `		 }` |
|  1837174 | 2087 | `	 }` |
|   819657 | 2088 | `	 return SXRET_OK;` |
|   773168 | 2089 | ` }` |
|        - | 2090 | ` /*` |
...
|        - | 2095 | `  */` |
|   967508 | 2096 | `PH7_PRIVATE sxi32 PH7_ExprMakeTree(ph7_gen_state *pGen,SySet *pExprNode,ph7_expr_node **ppRoot)` |
|        5 | 2097 | `{` |
|        - | 2098 | `	ph7_expr_node **apNode;` |
|        - | 2099 | `	ph7_expr_node *pNode;` |
|        - | 2100 | `	sxi32 rc;` |
|        - | 2101 | `	/* Reset node container */` |
|   967513 | 2102 | `	SySetReset(pExprNode);` |
|   967513 | 2103 | `	pNode = 0; /* Prevent compiler warning */` |
|        - | 2104 | `	/* Extract nodes one after one until we hit the end of the input */` |
|        - | 2105 | `	{` |
|   967513 | 2106 | `		int iLastWasTerm = 0;` |
|   967513 | 2107 | `		int bAfterMemberOp = 0; /* TRUE iff the previous node was -> / ?-> / :: */` |
|  5243931 | 2108 | `		while( pGen->pIn < pGen->pEnd ){` |
|  4276457 | 2109 | `			rc = ExprExtractNode(&(*pGen),&pNode,iLastWasTerm,bAfterMemberOp);` |
|  4276457 | 2110 | `			if( rc != SXRET_OK ){` |
|       38 | 2111 | `				return rc;` |
|        - | 2112 | `			}` |
|        - | 2113 | `			/* Determine if this node is a term for short-array disambiguation */` |
|  4276423 | 2114 | `			if( pNode->xCode ){` |
|        - | 2115 | `				/* Node with compile handler: variable, literal, string, array, etc. */` |
|  2243129 | 2116 | `				iLastWasTerm = 1;` |
|  3154861 | 2117 | `			}else if( pNode->pOp ){` |
|        - | 2118 | `				/* Operator node */` |
|   966265 | 2119 | `				iLastWasTerm = 0;` |
|   483135 | 2120 | `			}else{` |
|        - | 2121 | `				/* Delimiter: ')' and ']' end terms */` |
|  1067039 | 2122 | `				iLastWasTerm = (pNode->pStart->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB)) ? 1 : 0;` |
|        - | 2123 | `			}` |
...
|  4276423 | 2127 | `			bAfterMemberOp = ( pNode->pOp && pNode->pOp->iVmOp == PH7_OP_MEMBER );` |
|        - | 2128 | `			/* Save the extracted node */` |
|  4276423 | 2129 | `			SySetPut(pExprNode,(const void *)&pNode);` |
|        5 | 2130 | `		}` |
|        - | 2131 | `	}` |
|   967479 | 2132 | `	if( SySetUsed(pExprNode) < 1 ){` |
|        - | 2133 | `		/* Empty expression [i.e: A semi-colon;] */` |
|      ! 0 | 2134 | `		*ppRoot = 0;` |
|      ! 0 | 2135 | `		return SXRET_OK;` |
|        - | 2136 | `	}` |
|   967479 | 2137 | `	apNode = (ph7_expr_node **)SySetBasePtr(pExprNode);` |
|        - | 2138 | `	/* Make sure we are dealing with valid nodes */` |
|   967479 | 2139 | `	rc = ExprVerifyNodes(&(*pGen),apNode,(sxi32)SySetUsed(pExprNode));` |
|   967479 | 2140 | `	if( rc != SXRET_OK ){` |
...
|        - | 2146 | `	}` |
|        - | 2147 | `	/* Build the tree */` |
|   967429 | 2148 | `	rc = ExprMakeTree(&(*pGen),apNode,(sxi32)SySetUsed(pExprNode));` |
|   967429 | 2149 | `	if( rc != SXRET_OK ){` |
|        - | 2150 | `		/* Something goes wrong [i.e: Syntax error] */` |
|      103 | 2151 | `		*ppRoot = 0;` |
|      103 | 2152 | `		return rc;` |
|        - | 2153 | `	}` |
|        - | 2154 | `	/* Point to the root of the tree */` |
|   967331 | 2155 | `	*ppRoot = apNode[0];` |
|   967331 | 2156 | `	return SXRET_OK;` |
|   483759 | 2157 | `}` |
|        - | 2158 |  |
