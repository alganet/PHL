...
|        - |  272 | ` */` |
|  1215358 |  273 | `PH7_PRIVATE const ph7_expr_op *  PH7_ExprExtractOperator(SyString *pStr,SyToken *pLast)` |
|        5 |  274 | `{` |
|  1215363 |  275 | `	sxu32 n = 0;` |
|        - |  276 | `	sxi32 rc;` |
|        - |  277 | `	/* Do a linear lookup on the operators table */` |
| 21234892 |  278 | `	for(;;){` |
| 42469789 |  279 | `		if( n >= SX_ARRAYSIZE(aOpTable) ){` |
|      ! 0 |  280 | `			break;` |
|        - |  281 | `		}` |
| 42469789 |  282 | `		if( SyisAlpha(aOpTable[n].sOp.zString[0]) ){` |
|        - |  283 | `			/* TICKET 1433-012: Alpha stream operators [i.e: and,or,xor,new...] */` |
|  3727573 |  284 | `			rc = SyStringCmp(pStr,&aOpTable[n].sOp,SyStrnicmp);` |
|  1863789 |  285 | `		}else{` |
| 38742221 |  286 | `			rc = SyStringCmp(pStr,&aOpTable[n].sOp,SyMemcmp);` |
|        - |  287 | `		}` |
| 42469789 |  288 | `		if( rc == 0 ){` |
|  1220021 |  289 | `			if( aOpTable[n].sOp.nByte != sizeof(char) \|\| (aOpTable[n].iOp != EXPR_OP_UMINUS && aOpTable[n].iOp != EXPR_OP_UPLUS) \|\| pLast == 0 ){` |
|        - |  290 | `				/* There is no ambiguity here,simply return the first operator seen */` |
|  1214865 |  291 | `				return &aOpTable[n];` |
|        - |  292 | `			}` |
|        - |  293 | `			/* Handle ambiguity */` |
|     5161 |  294 | `			if( pLast->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*'['*/\|PH7_TK_COLON/*:*/\|PH7_TK_COMMA/*,'*/) ){` |
|        - |  295 | `				/* Unary opertors have prcedence here over binary operators */` |
|      381 |  296 | `				return &aOpTable[n];` |
|        - |  297 | `			}` |
|     4785 |  298 | `			if( pLast->nType & PH7_TK_OP ){` |
...
|        4 |  306 | `			}` |
|     2329 |  307 | `		}` |
| 41254431 |  308 | `		++n; /* Next operator in the table */` |
|        5 |  309 | `	}` |
...
|        - |  317 | ` */` |
|   743128 |  318 | `PH7_PRIVATE void PH7_DelimitNestedTokens(SyToken *pIn,SyToken *pEnd,sxu32 nTokStart,sxu32 nTokEnd,SyToken **ppEnd)` |
|        5 |  319 | `{` |
|   743133 |  320 | `	SyToken *pCur = pIn;` |
|   743133 |  321 | `	sxi32 iNest = 1;` |
|  4146044 |  322 | `	for(;;){` |
|  8292093 |  323 | `		if( pCur >= pEnd ){` |
|      471 |  324 | `			break;` |
|        - |  325 | `		}` |
|  8291627 |  326 | `		if( pCur->nType & nTokStart ){` |
|        - |  327 | `			/* Increment nesting level */` |
|   390907 |  328 | `			iNest++;` |
|  8096176 |  329 | `		}else if( pCur->nType & nTokEnd ){` |
|        - |  330 | `			/* Decrement nesting level */` |
|  1133569 |  331 | `			iNest--;` |
|  1133569 |  332 | `			if( iNest <= 0 ){` |
|   742667 |  333 | `				break;` |
|        - |  334 | `			}` |
|   195451 |  335 | `		}` |
|        - |  336 | `		/* Advance cursor */` |
...
|        - |  373 | ` */` |
|  1024858 |  374 | `static sxi32 ExprVerifyNodes(ph7_gen_state *pGen,ph7_expr_node **apNode,sxi32 nNode)` |
|        5 |  375 | `{` |
|        - |  376 | `	sxi32 iParen,iSquare,iQuesty,iBraces;` |
|        - |  377 | `	sxi32 i,rc;` |
|        - |  378 |  |
|  1024863 |  379 | `	if( nNode > 0 && apNode[0]->pOp && (apNode[0]->pOp->iOp == EXPR_OP_ADD \|\| apNode[0]->pOp->iOp == EXPR_OP_SUB) ){` |
...
|       16 |  383 | `	}` |
|  1024863 |  384 | `	iParen = iSquare = iQuesty = iBraces = 0;` |
|  5555203 |  385 | `	for( i = 0 ; i < nNode ; ++i ){` |
|  4530379 |  386 | `		if( apNode[i]->xCode == PH7_CompileShortArray \|\| apNode[i]->xCode == PH7_CompileShortList ){` |
|        - |  387 | `			/* Short array/list literal: brackets are self-contained, skip */` |
|     1303 |  388 | `			continue;` |
|        - |  389 | `		}` |
|  4529081 |  390 | `		if( apNode[i]->pStart->nType & PH7_TK_LPAREN /*'('*/){` |
|   514959 |  391 | `			if( i > 0 && ( apNode[i-1]->xCode == PH7_CompileVariable \|\| apNode[i-1]->xCode == PH7_CompileLiteral \|\|` |
|    24106 |  392 | `				(apNode[i - 1]->pStart->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_SSTR\|PH7_TK_DSTR\|PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}'*/))) ){` |
|        - |  393 | `					/* Ticket 1433-033: Take care to ignore alpha-stream [i.e: or,xor] operators followed by an opening parenthesis */` |
|   482531 |  394 | `					if( (apNode[i - 1]->pStart->nType & PH7_TK_OP) == 0 ){` |
|        - |  395 | `						/* We are dealing with a postfix [i.e: function call]  operator` |
|        - |  396 | `						 * not a simple left parenthesis. Mark the node.` |
|        - |  397 | `						 */` |
|   482531 |  398 | `						apNode[i]->pStart->nType \|= PH7_TK_OP;` |
|   482531 |  399 | `						apNode[i]->pStart->pUserData = (void *)&sFCallOp; /* Function call operator */` |
|   482531 |  400 | `						apNode[i]->pOp = &sFCallOp;` |
|   241263 |  401 | `					}` |
|   241263 |  402 | `			}` |
|   514959 |  403 | `			iParen++;` |
|  4271604 |  404 | `		}else if( apNode[i]->pStart->nType & PH7_TK_RPAREN/*')*/){` |
|   514959 |  405 | `			if( iParen <= 0 ){` |
...
|        - |  411 | `			}` |
|   514947 |  412 | `			iParen--;` |
|  3756644 |  413 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OSB /*'['*/){` |
|    98369 |  414 | `			iSquare++;` |
|  3449991 |  415 | `		}else if (apNode[i]->pStart->nType & PH7_TK_CSB /*']'*/){` |
...
|        - |  422 | `			}` |
|    98377 |  423 | `			iSquare--;` |
|  3351617 |  424 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OCB /*'{'*/){` |
|       20 |  425 | `			iBraces++;` |
...
|        - |  469 |  |
|        7 |  470 | `			}` |
|  3302422 |  471 | `		}else if (apNode[i]->pStart->nType & PH7_TK_CCB /*'}'*/){` |
|       24 |  472 | `			if( iBraces <= 0 ){` |
...
|        - |  478 | `			}` |
|       10 |  479 | `			iBraces--;` |
|  3302397 |  480 | `		}else if ( apNode[i]->pStart->nType & PH7_TK_COLON ){` |
|     2911 |  481 | `			if( iQuesty > 0 ){` |
|     2657 |  482 | `				iQuesty--;` |
|     1585 |  483 | `			}else if( iParen <= 0 ){` |
...
|        6 |  491 | `				return rc;` |
|        5 |  492 | `			}` |
|  3300938 |  493 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OP ){` |
|   924973 |  494 | `			const ph7_expr_op *pOp = (const ph7_expr_op *)apNode[i]->pOp;` |
|   924973 |  495 | `			if( pOp->iOp == EXPR_OP_QUESTY ){` |
|     2659 |  496 | `				iQuesty++;` |
|   923646 |  497 | `			}else if( i > 0 && (pOp->iOp == EXPR_OP_UMINUS \|\| pOp->iOp == EXPR_OP_UPLUS)){` |
...
|   462484 |  517 | `		}` |
|  2264526 |  518 | `	}` |
|  1024829 |  519 | `	if( iParen != 0 \|\| iSquare != 0 \|\| iQuesty != 0 \|\| iBraces != 0){` |
...
|       20 |  524 | `		return rc;` |
|        - |  525 | `	}` |
|  1024813 |  526 | `	return SXRET_OK;` |
|   512434 |  527 | `}` |
|        - |  528 | `/*` |
|        - |  529 | ` * Collect and assemble tokens holding a namespace path [i.e: namespace\to\const]` |
|        - |  530 | ` * or a simple literal [i.e: PHP_EOL].` |
|        - |  531 | ` */` |
|   849448 |  532 | `static void ExprAssembleLiteral(SyToken **ppCur,SyToken *pEnd)` |
|        5 |  533 | `{` |
|   849453 |  534 | `	SyToken *pIn = *ppCur;` |
|        - |  535 | `	/* Jump the first literal seen */` |
|   849453 |  536 | `	if( (pIn->nType & PH7_TK_NSSEP) == 0 ){` |
|   845577 |  537 | `		pIn++;` |
|   422786 |  538 | `	}` |
|   426689 |  539 | `	for(;;){` |
|   853383 |  540 | `		if(pIn < pEnd && (pIn->nType & PH7_TK_NSSEP) ){` |
|     3935 |  541 | `			pIn++;` |
...
|        - |  595 | ` */` |
|      548 |  596 | `static void ExprSkipReturnType(SyToken **ppIn,SyToken *pEnd)` |
|        5 |  597 | `{` |
|      553 |  598 | `	SyToken *pIn = *ppIn;` |
|      553 |  599 | `	if( pIn < pEnd && (pIn->nType & PH7_TK_COLON) ){` |
|       25 |  600 | `		pIn++; /* Skip ':' */` |
|       11 |  601 | `		for(;;){` |
...
|        - |  891 | ` */` |
|  4534442 |  892 | `static sxi32 ExprExtractNode(ph7_gen_state *pGen,ph7_expr_node **ppNode,int iLastWasTerm,int bAfterMemberOp)` |
|        5 |  893 | `{` |
|        - |  894 | `	ph7_expr_node *pNode;` |
|        - |  895 | `	SyToken *pCur;` |
|        - |  896 | `	sxi32 rc;` |
|        - |  897 | `	/* Allocate a new node */` |
|  4534447 |  898 | `	pNode = (ph7_expr_node *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_expr_node));` |
|  4534447 |  899 | `	if( pNode == 0 ){` |
...
|  4534447 |  906 | `	SyZero(pNode,sizeof(ph7_expr_node));` |
|  4534447 |  907 | `	SySetInit(&pNode->aNodeArgs,&pGen->pVm->sAllocator,sizeof(ph7_expr_node **));` |
|        - |  908 | `	/* Point to the head of the token stream */` |
|  4534447 |  909 | `	pCur = pNode->pStart = pGen->pIn;` |
|        - |  910 | `	/* Start collecting tokens */` |
|  4534447 |  911 | `	if( pCur->nType & PH7_TK_ELLIPSIS ){` |
...
|     3923 |  934 | `		return rc;` |
|        - |  935 | `	}` |
|  4530453 |  936 | `	if( (pCur->nType & PH7_TK_OSB) && !iLastWasTerm ){` |
|        - |  937 | `		/* PHP 5.4 short array syntax: [1, 2, 3] or ['key' => 'value'].` |
|        - |  938 | `		 * This '[' does not follow a term, so it is an array literal, not subscript.` |
|        - |  939 | `		 */` |
|     1305 |  940 | `		pCur++; /* Skip the opening '[' */` |
|     1305 |  941 | `		PH7_DelimitNestedTokens(pCur,pGen->pEnd,PH7_TK_OSB,PH7_TK_CSB,&pCur);` |
|     1305 |  942 | `		if( pCur < pGen->pEnd ){` |
|     1305 |  943 | `			pCur++; /* Skip past the closing ']' */` |
|      655 |  944 | `		}else{` |
...
|        - |  955 | `		 */` |
|     1395 |  956 | `		if( pCur < pGen->pEnd && (pCur->nType & PH7_TK_OP) ){` |
...
|        - |  962 | `			}` |
|       94 |  963 | `		}else{` |
|     1125 |  964 | `			pNode->xCode = PH7_CompileShortArray;` |
|        5 |  965 | `		}` |
|  4529803 |  966 | `	}else if( bAfterMemberOp && (pCur->nType & PH7_TK_OP) && (pCur->nType & PH7_TK_ID) ){` |
...
|  4529141 |  977 | `	}else if( (pCur->nType & PH7_TK_OP) && pCur->pUserData` |
|  1023388 |  978 | `		&& ((const ph7_expr_op *)pCur->pUserData)->iOp == EXPR_OP_CLONE` |
|   511728 |  979 | `		&& &pCur[1] < pGen->pEnd && (pCur[1].nType & PH7_TK_LPAREN) ){` |
...
|  4529126 | 1005 | `	}else if( pCur->nType & PH7_TK_OP ){` |
|        - | 1006 | `		/* Point to the instance that describe this operator */` |
|  1023371 | 1007 | `		pNode->pOp = (const ph7_expr_op *)pCur->pUserData;` |
|        - | 1008 | `		/* Advance the stream cursor */` |
|  1023371 | 1009 | `		pCur++;` |
|  4017432 | 1010 | `	}else if( pCur->nType & PH7_TK_DOLLAR ){` |
|        - | 1011 | `		/* Isolate variable */` |
|  2448281 | 1012 | `		while( pCur < pGen->pEnd && (pCur->nType & PH7_TK_DOLLAR) ){` |
|  1224149 | 1013 | `			pCur++; /* Variable variable */` |
|        5 | 1014 | `		}` |
|  1224137 | 1015 | `		if( pCur < pGen->pEnd ){` |
|  1224137 | 1016 | `			if (pCur->nType & (PH7_TK_ID\|PH7_TK_KEYWORD) ){` |
|        - | 1017 | `				/* Variable name */` |
|  1224109 | 1018 | `				pCur++;` |
|   612084 | 1019 | `			}else if( pCur->nType & PH7_TK_OCB /* '{' */ ){` |
|       24 | 1020 | `				pCur++;` |
...
|        8 | 1033 | `			}` |
|   612064 | 1034 | `		}` |
|  1224133 | 1035 | `		pNode->xCode = PH7_CompileVariable;` |
|  2893681 | 1036 | `	 }else if( pCur->nType & PH7_TK_KEYWORD ){` |
|    57313 | 1037 | `		 sxu32 nKeyword = (sxu32)SX_PTR_TO_INT(pCur->pUserData);` |
|    57313 | 1038 | `		 if( bAfterMemberOp ){` |
...
|    57223 | 1045 | `		 }else if( nKeyword == PH7_TKWRD_ARRAY \|\|  nKeyword == PH7_TKWRD_LIST ){` |
...
|       15 | 1079 | `				 }` |
|        5 | 1080 | `			 }` |
|    40889 | 1081 | `		 }else if( nKeyword == PH7_TKWRD_YIELD ){` |
...
|    24485 | 1088 | `		 }else if( nKeyword == PH7_TKWRD_FUNCTION ){` |
...
|        - | 1102 | `			  }` |
|    24134 | 1103 | `		 }else if( nKeyword == PH7_TKWRD_CLASS && &pCur[1] < pGen->pEnd` |
...
|        5 | 1154 | `		 }` |
|  2252949 | 1155 | `	 }else if( pCur->nType & (PH7_TK_NSSEP\|PH7_TK_ID) ){` |
|        - | 1156 | `		 /* Constants,function name,namespace path,class name... */` |
|   825693 | 1157 | `		 ExprAssembleLiteral(&pCur,pGen->pEnd);` |
|   825693 | 1158 | `		 pNode->xCode = PH7_CompileLiteral;` |
|   412849 | 1159 | `	 }else{` |
|  1398621 | 1160 | `		 if( (pCur->nType & (PH7_TK_LPAREN\|PH7_TK_RPAREN\|PH7_TK_COMMA\|PH7_TK_COLON\|PH7_TK_CSB\|PH7_TK_OCB\|PH7_TK_CCB)) == 0 ){` |
|        - | 1161 | `			 /* Point to the code generator routine */` |
|   267369 | 1162 | `			 pNode->xCode = PH7_GetNodeHandler(pCur->nType);` |
|   267369 | 1163 | `			 if( pNode->xCode == 0 ){` |
...
|  4530419 | 1176 | `	pNode->pEnd = pCur;` |
|        - | 1177 | `	/* Save the node for later processing */` |
|  4530419 | 1178 | `	*ppNode = pNode;` |
|        - | 1179 | `	/* Synchronize cursors */` |
|  4530419 | 1180 | `	pGen->pIn = pCur;` |
|  4530419 | 1181 | `	return SXRET_OK;` |
|  2267226 | 1182 | `}` |
|        - | 1183 | `/*` |
...
|        - | 1186 | ` * level is zero.` |
|        - | 1187 | ` */` |
|   100102 | 1188 | `PH7_PRIVATE sxi32 PH7_GetNextExpr(SyToken *pStart,SyToken *pEnd,SyToken **ppNext)` |
|        5 | 1189 | `{` |
|   100107 | 1190 | `	SyToken *pCur = pStart;` |
|   100107 | 1191 | `	sxi32 iNest = 0;` |
|   100107 | 1192 | `	if( pCur >= pEnd \|\| (pCur->nType & PH7_TK_SEMI/*';'*/) ){` |
|        - | 1193 | `		/* Last expression */` |
|    51755 | 1194 | `		return SXERR_EOF;` |
|        - | 1195 | `	}` |
|   199053 | 1196 | `	while( pCur < pEnd ){` |
|   181789 | 1197 | `		if( (pCur->nType & (PH7_TK_COMMA/*','*/\|PH7_TK_SEMI/*';'*/)) && iNest <= 0){` |
|    31093 | 1198 | `			break;` |
|        - | 1199 | `		}` |
|   150701 | 1200 | `		if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|    10617 | 1201 | `			iNest++;` |
|   145395 | 1202 | `		}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}*/) ){` |
|    10619 | 1203 | `			iNest--;` |
|     5307 | 1204 | `		}` |
|   150701 | 1205 | `		pCur++;` |
|        5 | 1206 | `	}` |
|    48357 | 1207 | `	*ppNext = pCur;` |
|    48357 | 1208 | `	return SXRET_OK;` |
|    50056 | 1209 | `}` |
|        - | 1210 | `/*` |
|        - | 1211 | ` * Free an expression tree.` |
|        - | 1212 | ` */` |
|  3871140 | 1213 | `static void ExprFreeTree(ph7_gen_state *pGen,ph7_expr_node *pNode)` |
|        5 | 1214 | `{` |
|  3871145 | 1215 | `	if( pNode->pLeft ){` |
|        - | 1216 | `		/* Release the left tree */` |
|  1429855 | 1217 | `		ExprFreeTree(&(*pGen),pNode->pLeft);` |
|   714925 | 1218 | `	}` |
|  3871145 | 1219 | `	if( pNode->pRight ){` |
|        - | 1220 | `		/* Release the right tree */` |
|   772413 | 1221 | `		ExprFreeTree(&(*pGen),pNode->pRight);` |
|   386204 | 1222 | `	}` |
|  3871145 | 1223 | `	if( pNode->pCond ){` |
|        - | 1224 | `		/* Release the conditional tree used by the ternary operator */` |
|     2655 | 1225 | `		ExprFreeTree(&(*pGen),pNode->pCond);` |
|     1325 | 1226 | `	}` |
|  3871145 | 1227 | `	if( SySetUsed(&pNode->aNodeArgs) > 0 ){` |
|        - | 1228 | `		ph7_expr_node **apArg;` |
|        - | 1229 | `		sxu32 n;` |
|        - | 1230 | `		/* Release node arguments */` |
|   499865 | 1231 | `		apArg = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  1075523 | 1232 | `		for( n = 0 ; n < SySetUsed(&pNode->aNodeArgs) ; ++n ){` |
|   575663 | 1233 | `			ExprFreeTree(&(*pGen),apArg[n]);` |
|   287834 | 1234 | `		}` |
|   499865 | 1235 | `		SySetRelease(&pNode->aNodeArgs);` |
|   249930 | 1236 | `	}` |
|        - | 1237 | `	/* Finally,release this node */` |
|  3871145 | 1238 | `	SyMemBackendPoolFree(&pGen->pVm->sAllocator,pNode);` |
|  3871145 | 1239 | `}` |
|        - | 1240 | `/*` |
|        - | 1241 | ` * Free an expression tree.` |
|        - | 1242 | ` * This function is a wrapper around ExprFreeTree() defined above.` |
|        - | 1243 | ` */` |
|  1024892 | 1244 | `PH7_PRIVATE sxi32 PH7_ExprFreeTree(ph7_gen_state *pGen,SySet *pNodeSet)` |
|        5 | 1245 | `{` |
|        - | 1246 | `	ph7_expr_node **apNode;` |
|        - | 1247 | `	sxu32 n;` |
|  1024897 | 1248 | `	apNode = (ph7_expr_node **)SySetBasePtr(pNodeSet);` |
|  5555387 | 1249 | `	for( n = 0  ; n < SySetUsed(pNodeSet) ; ++n ){` |
|  4530495 | 1250 | `		if( apNode[n] ){` |
|  1025231 | 1251 | `			ExprFreeTree(&(*pGen),apNode[n]);` |
|   512613 | 1252 | `		}` |
|  2265250 | 1253 | `	}` |
|  1024897 | 1254 | `	return SXRET_OK;` |
|        5 | 1255 | `}` |
|        - | 1256 | `/*` |
...
|        - | 1262 | ` */` |
|  1398092 | 1263 | `PH7_PRIVATE int PH7_ExprContainsNullsafe(ph7_expr_node *pNode)` |
|        5 | 1264 | `{` |
|  1398097 | 1265 | `	if( pNode == 0 ){` |
|   862531 | 1266 | `		return 0;` |
|        - | 1267 | `	}` |
|   535571 | 1268 | `	if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW ){` |
|       16 | 1269 | `		return 1;` |
|        - | 1270 | `	}` |
|   535559 | 1271 | `	if( PH7_ExprContainsNullsafe(pNode->pLeft) ){` |
|        6 | 1272 | `		return 1;` |
|        - | 1273 | `	}` |
|   535555 | 1274 | `	if( PH7_ExprContainsNullsafe(pNode->pRight) ){` |
|      ! 0 | 1275 | `		return 1;` |
|        - | 1276 | `	}` |
|   535555 | 1277 | `	return 0;` |
|   699051 | 1278 | `}` |
|        - | 1279 | `/*` |
|        - | 1280 | ` * Check if the given node is a modifialbe l/r-value.` |
|        - | 1281 | ` * Return TRUE if modifiable.FALSE otherwise.` |
|        - | 1282 | ` */` |
|   320308 | 1283 | `static int ExprIsModifiableValue(ph7_expr_node *pNode,sxu8 bFunc)` |
|        5 | 1284 | `{` |
|        - | 1285 | `	sxi32 iExprOp;` |
|   320313 | 1286 | `	if( pNode->pOp == 0 ){` |
|   196781 | 1287 | `		return pNode->xCode == PH7_CompileVariable ? TRUE : FALSE;` |
|        - | 1288 | `	}` |
...
|        - | 1320 | ` */` |
|   420744 | 1321 | `static sxi32 ExprProcessFuncArguments(ph7_gen_state *pGen,ph7_expr_node *pOp,ph7_expr_node **apNode,sxi32 nToken)` |
|        5 | 1322 | `{` |
...
|   420749 | 1326 | `	iCur = 0;` |
|   458631 | 1327 | `	for(;;){` |
|   917267 | 1328 | `		if( iCur >= nToken ){` |
|        - | 1329 | `			/* No more arguments to process */` |
|   420723 | 1330 | `			break;` |
|        - | 1331 | `		}` |
|   496549 | 1332 | `		iNode = iCur;` |
|   496549 | 1333 | `		iNest = 0;` |
|  1229293 | 1334 | `		while( iCur < nToken ){` |
|   808573 | 1335 | `			if( apNode[iCur] ){` |
|   793261 | 1336 | `				if( (apNode[iCur]->pStart->nType & PH7_TK_COMMA) && apNode[iCur]->pLeft == 0 && iNest <= 0 ){` |
|    37917 | 1337 | `					break;` |
|   717432 | 1338 | `				}else if( (apNode[iCur]->pStart->nType & (PH7_TK_LPAREN\|PH7_TK_OSB\|PH7_TK_OCB))` |
|   379058 | 1339 | `					&& apNode[iCur]->xCode != PH7_CompileShortArray` |
|    40458 | 1340 | `					&& apNode[iCur]->xCode != PH7_CompileShortList ){` |
...
|    40227 | 1347 | `					iNest++;` |
|   697326 | 1348 | `				}else if( apNode[iCur]->pStart->nType & (PH7_TK_RPAREN\|PH7_TK_CCB\|PH7_TK_CSB) ){` |
|    40227 | 1349 | `					iNest--;` |
|    20111 | 1350 | `				}` |
|   358716 | 1351 | `			}` |
|   732749 | 1352 | `			iCur++;` |
|        5 | 1353 | `		}` |
|   496549 | 1354 | `		if( iCur > iNode ){` |
|   496543 | 1355 | `			SyString sArgName = {0, 0};` |
...
|   496538 | 1359 | `			if( (iCur - iNode) >= 2` |
|   274699 | 1360 | `				&& apNode[iNode]` |
|    52860 | 1361 | `				&& (apNode[iNode]->pStart->nType & (PH7_TK_ID\|PH7_TK_KEYWORD))` |
|    31109 | 1362 | `				&& apNode[iNode]->xCode == PH7_CompileLiteral` |
|     9215 | 1363 | `				&& apNode[iNode+1]` |
|     9077 | 1364 | `				&& (apNode[iNode+1]->pStart->nType & PH7_TK_COLON) ){` |
...
|        - | 1383 | `				}` |
|      124 | 1384 | `			}` |
|   496536 | 1385 | `			if( apNode[iNode] && (apNode[iNode]->pStart->nType & PH7_TK_AMPER /*'&'*/) && ((iCur - iNode) == 2)` |
...
|      ! 0 | 1391 | `			}` |
|   496541 | 1392 | `			ExprMakeTree(&(*pGen),&apNode[iNode],iCur-iNode);` |
|   496541 | 1393 | `			if( apNode[iNode] ){` |
|   496541 | 1394 | `				if( sArgName.nByte > 0 ){` |
...
|   496541 | 1399 | `				SySetPut(&pOp->aNodeArgs,(const void *)&apNode[iNode]);` |
|   248273 | 1400 | `			}else{` |
...
|   496541 | 1419 | `		if( iCur < nToken && apNode[iCur] && (apNode[iCur]->pStart->nType & PH7_TK_COMMA) ){` |
|    75823 | 1420 | `			iCur++;` |
|    75823 | 1421 | `			if( iCur >= nToken ){` |
|        - | 1422 | `				/* Trailing comma after last argument */` |
|       19 | 1423 | `				break;` |
|        - | 1424 | `			}` |
|    37900 | 1425 | `		}` |
|        5 | 1426 | `	}` |
|   420741 | 1427 | `	return SXRET_OK;` |
|   210377 | 1428 | `}` |
|        - | 1429 | ` /*` |
...
|        - | 1433 | `  */` |
|  1642296 | 1434 | ` static sxi32 ExprMakeTree(ph7_gen_state *pGen,ph7_expr_node **apNode,sxi32 nToken)` |
|        5 | 1435 | ` {` |
|        - | 1436 | `	 sxi32 i,iLeft,iRight;` |
|        - | 1437 | `	 ph7_expr_node *pNode;` |
|        - | 1438 | `	 sxi32 iCur;` |
|        - | 1439 | `	 sxi32 rc;` |
|  1642301 | 1440 | `	 if( nToken <= 0 \|\| (nToken == 1 && apNode[0]->xCode) ){` |
|        - | 1441 | `		 /* TICKET 1433-17: self evaluating node */` |
|   769509 | 1442 | `		 return SXRET_OK;` |
|        - | 1443 | `	 }` |
|        - | 1444 | `	 /* Process expressions enclosed in parenthesis first */` |
|  5418809 | 1445 | `	 for( iCur =  0 ; iCur < nToken ; ++iCur ){` |
|        - | 1446 | `		 sxi32 iNest;` |
...
|        - | 1449 | `		  */` |
|  4546019 | 1450 | `		 if( apNode[iCur] == 0 \|\| apNode[iCur]->pStart->nType != PH7_TK_LPAREN ){` |
|  4513601 | 1451 | `			 continue;` |
|        - | 1452 | `		 }` |
|    32423 | 1453 | `		 iNest = 1;` |
|    32423 | 1454 | `		 iLeft = iCur;` |
|        - | 1455 | `		 /* Find the closing parenthesis */` |
|    32423 | 1456 | `		 iCur++;` |
|   216099 | 1457 | `		 while( iCur < nToken ){` |
|   216099 | 1458 | `			 if( apNode[iCur] ){` |
|   216099 | 1459 | `				 if( apNode[iCur]->pStart->nType & PH7_TK_RPAREN /* ')' */){` |
|        - | 1460 | `					 /* Decrement nesting level */` |
|    56305 | 1461 | `					 iNest--;` |
|    56305 | 1462 | `					 if( iNest <= 0 ){` |
|    32423 | 1463 | `						 break;` |
|        5 | 1464 | `					 }` |
|   171740 | 1465 | `				 }else if( apNode[iCur]->pStart->nType & PH7_TK_LPAREN /* '(' */ ){` |
...
|   183681 | 1470 | `			 iCur++;` |
|        5 | 1471 | `		 }` |
|    32423 | 1472 | `		 if( iCur - iLeft > 1 ){` |
|        - | 1473 | `			 sxi32 j;` |
|        - | 1474 | `			 /* Recurse and process this expression */` |
|    32423 | 1475 | `			 rc = ExprMakeTree(&(*pGen),&apNode[iLeft + 1],iCur - iLeft - 1);` |
|    32423 | 1476 | `			 if( rc != SXRET_OK ){` |
|        3 | 1477 | `				 return rc;` |
|        - | 1478 | `			 }` |
...
|    32421 | 1482 | `			 for( j = iLeft + 1 ; j < iCur ; ++j ){` |
|    32421 | 1483 | `				 if( apNode[j] ){` |
|    32421 | 1484 | `					 apNode[j]->iFlags \|= EXPR_NODE_PARENS;` |
|    32421 | 1485 | `					 break;` |
|        - | 1486 | `				 }` |
|      ! 0 | 1487 | `			 }` |
|    16208 | 1488 | `		 }` |
|        - | 1489 | `		 /* Free the left and right nodes */` |
|    32421 | 1490 | `		 ExprFreeTree(&(*pGen),apNode[iLeft]);` |
|    32421 | 1491 | `		 ExprFreeTree(&(*pGen),apNode[iCur]);` |
|    32421 | 1492 | `		 apNode[iLeft] = 0;` |
|    32421 | 1493 | `		 apNode[iCur] = 0;` |
|    16213 | 1494 | `	 }` |
|        - | 1495 | `	  /* Process expressions enclosed in braces */` |
|  5626529 | 1496 | `	 for( iCur =  0 ; iCur < nToken ; ++iCur ){` |
|        - | 1497 | `		 sxi32 iNest;` |
...
|        - | 1500 | `		  */` |
|  4762087 | 1501 | `		 if( apNode[iCur] == 0 \|\| apNode[iCur]->pStart->nType != PH7_TK_OCB ){` |
|  4762079 | 1502 | `			 continue;` |
|        - | 1503 | `		 }` |
|       10 | 1504 | `		 iNest = 1;` |
|       10 | 1505 | `		 iLeft = iCur;` |
...
|   864447 | 1537 | `	 iLeft = -1;` |
|  5626507 | 1538 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  4762077 | 1539 | `		 if( apNode[iCur] == 0 ){` |
|  1877135 | 1540 | `			 continue;` |
|        - | 1541 | `		 }` |
|  2884947 | 1542 | `		 pNode = apNode[iCur];` |
|  2884947 | 1543 | `		 if( pNode->pOp && pNode->pOp->iPrec == 2 && pNode->pLeft == 0  ){` |
|   772301 | 1544 | `			 if( pNode->pOp->iOp == EXPR_OP_FUNC_CALL ){` |
|        - | 1545 | `				 /* Collect function arguments */` |
|   482527 | 1546 | `				 sxi32 iPtr = 0;` |
|   482527 | 1547 | `				 sxi32 nFuncTok = 0;` |
|  1773619 | 1548 | `				 while( nFuncTok + iCur < nToken ){` |
|  1773619 | 1549 | `					 if( apNode[nFuncTok+iCur] ){` |
|  1758307 | 1550 | `						 if( apNode[nFuncTok+iCur]->pStart->nType & PH7_TK_LPAREN /*'('*/ ){` |
|   503157 | 1551 | `							 iPtr++;` |
|  1506731 | 1552 | `						 }else if ( apNode[nFuncTok+iCur]->pStart->nType & PH7_TK_RPAREN /*')'*/){` |
|   503157 | 1553 | `							 iPtr--;` |
|   503157 | 1554 | `							 if( iPtr <= 0 ){` |
|   482527 | 1555 | `								 break;` |
|        - | 1556 | `							 }` |
|    10315 | 1557 | `						 }` |
|   637890 | 1558 | `					 }` |
|  1291097 | 1559 | `					 nFuncTok++;` |
|        5 | 1560 | `				 }` |
|   482527 | 1561 | `				 if( nFuncTok + iCur >= nToken ){` |
|        - | 1562 | `					 /* Syntax error */` |
...
|      ! 0 | 1567 | `					 return rc;` |
|        - | 1568 | `				 }` |
|   482527 | 1569 | `				 if(  iLeft < 0 \|\| !NODE_ISTERM(iLeft) /*\|\| ( apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec != 2)*/ ){` |
|        - | 1570 | `					 /* Syntax error */` |
...
|      ! 0 | 1575 | `					 return rc;` |
|        - | 1576 | `				 }` |
|   482527 | 1577 | `				 if( nFuncTok > 1 ){` |
|        - | 1578 | `					 /* Process function arguments */` |
|   420749 | 1579 | `					 rc = ExprProcessFuncArguments(&(*pGen),pNode,&apNode[iCur+1],nFuncTok-1);` |
|   420749 | 1580 | `					 if( rc != SXRET_OK ){` |
|       11 | 1581 | `						 return rc;` |
|        - | 1582 | `					 }` |
|   210368 | 1583 | `				 }` |
|        - | 1584 | `				 /* Link the node to the tree */` |
|   482519 | 1585 | `				 pNode->pLeft = apNode[iLeft];` |
|   482519 | 1586 | `				 apNode[iLeft] = 0;` |
|  1773587 | 1587 | `				 for( iPtr = 1; iPtr <= nFuncTok ; iPtr++ ){` |
|  1291073 | 1588 | `					 apNode[iCur+iPtr] = 0;` |
|   645539 | 1589 | `				 }` |
...
|        - | 1600 | `				 {` |
|   482519 | 1601 | `					 sxi32 iNew = iLeft - 1;` |
|   484603 | 1602 | `					 while( iNew >= 0 && apNode[iNew] == 0 ){` |
|     2089 | 1603 | `						 iNew--;` |
|        5 | 1604 | `					 }` |
|   482514 | 1605 | `					 if( iNew >= 0 && apNode[iNew]->pOp` |
|   228904 | 1606 | `						 && apNode[iNew]->pOp->iOp == EXPR_OP_NEW` |
|   126703 | 1607 | `						 && apNode[iNew]->pLeft == 0 ){` |
...
|    12256 | 1612 | `					 }` |
|        - | 1613 | `				 }` |
|   531036 | 1614 | `			 }else if (pNode->pOp->iOp == EXPR_OP_SUBSCRIPT ){` |
|        - | 1615 | `				 /* Subscripting */` |
...
|        - | 1699 | `			 }` |
|   386142 | 1700 | `		 }` |
|  2884935 | 1701 | `		 iLeft = iCur;` |
|  1442470 | 1702 | `	 }` |
|        - | 1703 | `	 /* Handle left associative (new, clone) operators */` |
|  5626475 | 1704 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  4762045 | 1705 | `		 if( apNode[iCur] == 0 ){` |
|  2674177 | 1706 | `			 continue;` |
|        - | 1707 | `		 }` |
|  2087873 | 1708 | `		 pNode = apNode[iCur];` |
|  2087873 | 1709 | `		 if( pNode->pOp && pNode->pOp->iPrec == 1 && pNode->pLeft == 0 ){` |
|        - | 1710 | `			 SyToken *pToken;` |
...
|   864435 | 1790 | `	 iLeft = -1;` |
|  5630649 | 1791 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  4762045 | 1792 | `		 if( apNode[iCur] == 0 ){` |
|  2674177 | 1793 | `			 continue;` |
|        - | 1794 | `		 }` |
|  2087873 | 1795 | `		 pNode = apNode[iCur];` |
|  2087873 | 1796 | `		 if( pNode->pOp && pNode->pOp->iPrec == 3 && pNode->pLeft == 0){` |
...
|     2109 | 1802 | `			 }` |
|    12035 | 1803 | `		  }` |
|  2092047 | 1804 | `		 iLeft = iCur;` |
|  1048113 | 1805 | `	  }` |
|   868609 | 1806 | `	 iLeft = -1;` |
|  5630649 | 1807 | `	 for( iCur = nToken -  1 ; iCur >= 0 ; iCur-- ){` |
|  4762045 | 1808 | `		 if( apNode[iCur] == 0 ){` |
|  2678395 | 1809 | `			 continue;` |
|        - | 1810 | `		 }` |
|  2083655 | 1811 | `		 pNode = apNode[iCur];` |
|  2083655 | 1812 | `		 if( pNode->pOp && pNode->pOp->iPrec == 3 && pNode->pLeft == 0){` |
...
|     5752 | 1827 | `		  }` |
|  2083655 | 1828 | `		 iLeft = iCur;` |
|  1041830 | 1829 | `	 }` |
|        - | 1830 | `	 /* Handle right associative unary and cast operators [i.e: !,(string),~...]  with precedence 4*/` |
|   868609 | 1831 | `	  iLeft = 0;` |
|  5630643 | 1832 | `	  for( iCur = nToken -  1 ; iCur >= 0 ; iCur-- ){` |
|  4762041 | 1833 | `		  if( apNode[iCur] ){` |
|  2072147 | 1834 | `			  pNode = apNode[iCur];` |
|  2072147 | 1835 | `			  if( pNode->pOp && pNode->pOp->iPrec == 4 && pNode->pLeft == 0){` |
|    36151 | 1836 | `				  if( iLeft > 0 ){` |
|        - | 1837 | `					  /* Link the node to the tree */` |
|    36149 | 1838 | `					  pNode->pLeft = apNode[iLeft];` |
|    36149 | 1839 | `					  apNode[iLeft] = 0;` |
|    36149 | 1840 | `					  if( pNode->pLeft && pNode->pLeft->pOp && pNode->pLeft->pOp->iPrec > 4 ){` |
...
|  5630641 | 1867 | `	 for( iCur = nToken - 1 ; iCur >= 0 ; --iCur ){` |
|  4762039 | 1868 | `		 if( apNode[iCur] == 0 ){` |
|  2726155 | 1869 | `			 continue;` |
|        - | 1870 | `		 }` |
|  2035889 | 1871 | `		 pNode = apNode[iCur];` |
|  2035889 | 1872 | `		 if( pNode->pOp && pNode->pOp->iPrec == 5 && pNode->pLeft == 0 ){` |
|        - | 1873 | `			 sxi32 iL, iR;` |
...
|  9554541 | 1936 | `	 for( i = 7 ; i < 17 ; i++ ){` |
|  8685949 | 1937 | `		 iLeft = -1;` |
| 56305995 | 1938 | `		 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
| 47620061 | 1939 | `			 if( apNode[iCur] == 0 ){` |
| 30711643 | 1940 | `				 continue;` |
|        - | 1941 | `			 }` |
| 16908423 | 1942 | `			 pNode = apNode[iCur];` |
| 16908423 | 1943 | `			 if( pNode->pOp && pNode->pOp->iPrec == i && pNode->pLeft == 0 ){` |
|        - | 1944 | `				 /* Get the right node */` |
|   257981 | 1945 | `				 iRight = iCur + 1;` |
|   368895 | 1946 | `				 while( iRight < nToken && apNode[iRight] == 0 ){` |
|   110919 | 1947 | `					 iRight++;` |
|        5 | 1948 | `				 }` |
|   257981 | 1949 | `				 if( iRight >= nToken \|\| iLeft < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|        - | 1950 | `					 /* Syntax error */` |
...
|       11 | 1955 | `					 return rc;` |
|        - | 1956 | `				 }` |
|   257973 | 1957 | `				 if( pNode->pOp->iOp == EXPR_OP_REF ){` |
|        - | 1958 | `					 sxi32  iTmp;` |
...
|   257971 | 1999 | `				 pNode->pLeft = apNode[iLeft];` |
|   257971 | 2000 | `				 pNode->pRight = apNode[iRight];` |
|   257971 | 2001 | `				 apNode[iLeft] = apNode[iRight] = 0;` |
|   128983 | 2002 | `			 }` |
| 16908413 | 2003 | `			 iLeft = iCur;` |
|  8454209 | 2004 | `		 }` |
|  4342972 | 2005 | `	 }` |
...
|        - | 2009 | `	  */` |
|   868597 | 2010 | `	  iLeft = -1;` |
|  5619105 | 2011 | `	  for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  4753165 | 2012 | `		  if( apNode[iCur] == 0 ){` |
|  3241265 | 2013 | `			  continue;` |
|        - | 2014 | `		  }` |
|  1511905 | 2015 | `		  pNode = apNode[iCur];` |
|  1511905 | 2016 | `		  if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_QUESTY && pNode->pLeft == 0 ){` |
|     2657 | 2017 | `			  sxi32 iNest = 1;` |
|     2657 | 2018 | `			  if( iLeft < 0 \|\| !NODE_ISTERM(iLeft) ){` |
...
|     2655 | 2027 | `			  iRight = iCur + 1;` |
|     5589 | 2028 | `			  while( iRight < nToken  ){` |
|     5589 | 2029 | `				  if( apNode[iRight] ){` |
|     5237 | 2030 | `					  if( apNode[iRight]->pOp && apNode[iRight]->pOp->iOp == EXPR_OP_QUESTY && apNode[iRight]->pCond == 0){` |
|        - | 2031 | `						  /* Increment nesting level */` |
|      ! 0 | 2032 | `						  ++iNest;` |
|     5237 | 2033 | `					  }else if( apNode[iRight]->pStart->nType & PH7_TK_COLON /*:*/ ){` |
|        - | 2034 | `						  /* Decrement nesting level */` |
|     2655 | 2035 | `						  --iNest;` |
|     2655 | 2036 | `						  if( iNest <= 0 ){` |
|     2655 | 2037 | `							  break;` |
|        - | 2038 | `						  }` |
|      ! 0 | 2039 | `					  }` |
|     1291 | 2040 | `				  }` |
|     2939 | 2041 | `				  iRight++;` |
|        5 | 2042 | `			  }` |
|     2655 | 2043 | `			  if( iRight > iCur + 1 ){` |
|        - | 2044 | `				  /* Recurse and process the then expression */` |
|     2587 | 2045 | `				  rc = ExprMakeTree(&(*pGen),&apNode[iCur + 1],iRight - iCur - 1);` |
|     2587 | 2046 | `				  if( rc != SXRET_OK ){` |
|      ! 0 | 2047 | `					  return rc;` |
|        - | 2048 | `				  }` |
|        - | 2049 | `				  /* Link the node to the tree */` |
|     2587 | 2050 | `				  pNode->pLeft = apNode[iCur + 1];` |
|     1291 | 2051 | `			  }else{` |
|        - | 2052 | `				  /* Elvis operator (?:): pLeft stays NULL.` |
|        - | 2053 | `				   * NODE_ISTERM() recognizes this node as complete via pCond. */` |
|        - | 2054 | `			  }` |
|     2655 | 2055 | `			  apNode[iCur + 1] = 0;` |
|     2655 | 2056 | `			  if( iRight + 1 < nToken ){` |
|        - | 2057 | `				  /* Recurse and process the else expression */` |
|     2655 | 2058 | `				  rc = ExprMakeTree(&(*pGen),&apNode[iRight + 1],nToken - iRight - 1);` |
|     2655 | 2059 | `				  if( rc != SXRET_OK ){` |
|      ! 0 | 2060 | `					  return rc;` |
|        - | 2061 | `				  }` |
|        - | 2062 | `				  /* Link the node to the tree */` |
|     2655 | 2063 | `				  pNode->pRight = apNode[iRight + 1];` |
|     2655 | 2064 | `				  apNode[iRight + 1] =  apNode[iRight] = 0;` |
|     1330 | 2065 | `			  }else{` |
...
|     2655 | 2073 | `			  pNode->pCond  = apNode[iLeft];` |
|     2655 | 2074 | `			  apNode[iLeft] = 0;` |
|     2655 | 2075 | `			  break;` |
|        - | 2076 | `		  }` |
|  1509253 | 2077 | `		  iLeft = iCur;` |
|   754629 | 2078 | `	  }` |
...
|        - | 2082 | `	  */` |
|   868595 | 2083 | `	 iRight = -1;` |
|  5630445 | 2084 | `	 for( iCur = nToken -  1 ; iCur >= 0 ; iCur--){` |
|  4761909 | 2085 | `		 if( apNode[iCur] == 0 ){` |
|  3572931 | 2086 | `			 continue;` |
|        - | 2087 | `		 }` |
|  1188983 | 2088 | `		 pNode = apNode[iCur];` |
|  1188983 | 2089 | `		 if( pNode->pOp && pNode->pOp->iPrec == 18 && pNode->pLeft == 0 ){` |
|        - | 2090 | `			 /* Get the left node */` |
|   320271 | 2091 | `			 iLeft = iCur - 1;` |
|   463403 | 2092 | `			 while( iLeft >= 0 && apNode[iLeft] == 0 ){` |
|   143137 | 2093 | `				 iLeft--;` |
|        5 | 2094 | `			 }` |
|   320271 | 2095 | `			 if( iLeft < 0 \|\| iRight < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|        - | 2096 | `				 /* Syntax error */` |
...
|        - | 2113 | `			  * a write. */` |
|   320229 | 2114 | `			 if( PH7_ExprContainsNullsafe(apNode[iLeft]) ){` |
...
|       11 | 2120 | `				 return rc;` |
|        - | 2121 | `			 }` |
|   320221 | 2122 | `			 if( ExprIsModifiableValue(apNode[iLeft],FALSE) == FALSE ){` |
...
|   320217 | 2141 | `			 pNode->pLeft = apNode[iRight];` |
|   320217 | 2142 | `			 pNode->pRight = apNode[iLeft];` |
|   320217 | 2143 | `			 apNode[iLeft] = apNode[iRight] = 0;` |
|   160106 | 2144 | `		 }` |
|  1188929 | 2145 | `		 iRight = iCur;` |
|   594467 | 2146 | `	 }` |
|        - | 2147 | `	 /* Process left associative binary operators that have the lowest precedence [i.e: and,or,xor] */` |
|  4342685 | 2148 | `	 for( i = 19 ; i < 23 ; i++ ){` |
|  3474149 | 2149 | `		 iLeft = -1;` |
| 22521493 | 2150 | `		 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
| 19047349 | 2151 | `			 if( apNode[iCur] == 0 ){` |
| 15572799 | 2152 | `				 continue;` |
|        - | 2153 | `			 }` |
|  3474555 | 2154 | `			 pNode = apNode[iCur];` |
|  3474555 | 2155 | `			 if( pNode->pOp && pNode->pOp->iPrec == i && pNode->pLeft == 0 ){` |
...
|       35 | 2173 | `			 }` |
|  3474555 | 2174 | `			 iLeft = iCur;` |
|  1737280 | 2175 | `		 }` |
|  1737077 | 2176 | `	 }` |
|        - | 2177 | `	 /* Point to the root of the expression tree */` |
|  4761813 | 2178 | `	 for( iCur = 1 ; iCur < nToken ; ++iCur ){` |
|  3893295 | 2179 | `		 if( apNode[iCur] ){` |
|   825343 | 2180 | `			 if( (apNode[iCur]->pOp \|\| apNode[iCur]->xCode ) && apNode[0] != 0){` |
...
|       23 | 2185 | `				  return rc;` |
|        - | 2186 | `			 }` |
|   825325 | 2187 | `			 apNode[0] = apNode[iCur];` |
|   825325 | 2188 | `			 apNode[iCur] = 0;` |
|   412660 | 2189 | `		 }` |
|  1946641 | 2190 | `	 }` |
|   868523 | 2191 | `	 return SXRET_OK;` |
|   819066 | 2192 | ` }` |
|        - | 2193 | ` /*` |
...
|        - | 2198 | `  */` |
|  1024892 | 2199 | `PH7_PRIVATE sxi32 PH7_ExprMakeTree(ph7_gen_state *pGen,SySet *pExprNode,ph7_expr_node **ppRoot)` |
|        5 | 2200 | `{` |
|        - | 2201 | `	ph7_expr_node **apNode;` |
|        - | 2202 | `	ph7_expr_node *pNode;` |
|        - | 2203 | `	sxi32 rc;` |
|        - | 2204 | `	/* Reset node container */` |
|  1024897 | 2205 | `	SySetReset(pExprNode);` |
|  1024897 | 2206 | `	pNode = 0; /* Prevent compiler warning */` |
|        - | 2207 | `	/* Extract nodes one after one until we hit the end of the input */` |
|        - | 2208 | `	{` |
|  1024897 | 2209 | `		int iLastWasTerm = 0;` |
|  1024897 | 2210 | `		int bAfterMemberOp = 0; /* TRUE iff the previous node was -> / ?-> / :: */` |
|  5555387 | 2211 | `		while( pGen->pIn < pGen->pEnd ){` |
|  4530529 | 2212 | `			rc = ExprExtractNode(&(*pGen),&pNode,iLastWasTerm,bAfterMemberOp);` |
|  4530529 | 2213 | `			if( rc != SXRET_OK ){` |
|       38 | 2214 | `				return rc;` |
|        - | 2215 | `			}` |
|        - | 2216 | `			/* Determine if this node is a term for short-array disambiguation */` |
|  4530495 | 2217 | `			if( pNode->xCode ){` |
|        - | 2218 | `				/* Node with compile handler: variable, literal, string, array, etc. */` |
|  2375877 | 2219 | `				iLastWasTerm = 1;` |
|  3342559 | 2220 | `			}else if( pNode->pOp ){` |
|        - | 2221 | `				/* Operator node */` |
|  1023371 | 2222 | `				iLastWasTerm = 0;` |
|   511688 | 2223 | `			}else{` |
|        - | 2224 | `				/* Delimiter: ')' and ']' end terms */` |
|  1131257 | 2225 | `				iLastWasTerm = (pNode->pStart->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB)) ? 1 : 0;` |
|        - | 2226 | `			}` |
...
|  4530495 | 2230 | `			bAfterMemberOp = ( pNode->pOp && pNode->pOp->iVmOp == PH7_OP_MEMBER );` |
|        - | 2231 | `			/* Save the extracted node */` |
|  4530495 | 2232 | `			SySetPut(pExprNode,(const void *)&pNode);` |
|        5 | 2233 | `		}` |
|        - | 2234 | `	}` |
|  1024863 | 2235 | `	if( SySetUsed(pExprNode) < 1 ){` |
|        - | 2236 | `		/* Empty expression [i.e: A semi-colon;] */` |
|      ! 0 | 2237 | `		*ppRoot = 0;` |
|      ! 0 | 2238 | `		return SXRET_OK;` |
|        - | 2239 | `	}` |
|  1024863 | 2240 | `	apNode = (ph7_expr_node **)SySetBasePtr(pExprNode);` |
|        - | 2241 | `	/* Make sure we are dealing with valid nodes */` |
|  1024863 | 2242 | `	rc = ExprVerifyNodes(&(*pGen),apNode,(sxi32)SySetUsed(pExprNode));` |
|  1024863 | 2243 | `	if( rc != SXRET_OK ){` |
...
|        - | 2249 | `	}` |
|        - | 2250 | `	/* Build the tree */` |
|  1024813 | 2251 | `	rc = ExprMakeTree(&(*pGen),apNode,(sxi32)SySetUsed(pExprNode));` |
|  1024813 | 2252 | `	if( rc != SXRET_OK ){` |
|        - | 2253 | `		/* Something goes wrong [i.e: Syntax error] */` |
|      103 | 2254 | `		*ppRoot = 0;` |
|      103 | 2255 | `		return rc;` |
|        - | 2256 | `	}` |
|        - | 2257 | `	/* Point to the root of the tree */` |
|  1024715 | 2258 | `	*ppRoot = apNode[0];` |
|  1024715 | 2259 | `	return SXRET_OK;` |
|   512451 | 2260 | `}` |
|        - | 2261 |  |
