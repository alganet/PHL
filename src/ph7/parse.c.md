...
|        - |  267 | ` */` |
|   991932 |  268 | `PH7_PRIVATE const ph7_expr_op *  PH7_ExprExtractOperator(SyString *pStr,SyToken *pLast)` |
|        5 |  269 |  |
|   991937 |  270 | `	sxu32 n = 0;` |
|        - |  271 | `	sxi32 rc;` |
|        - |  272 | `	/* Do a linear lookup on the operators table */` |
| 16660081 |  273 | `	for(;;){` |
| 33320167 |  274 | `		if( n >= SX_ARRAYSIZE(aOpTable) ){` |
|      ! 0 |  275 | `			break;` |
|        - |  276 | `		}` |
| 33320167 |  277 | `		if( SyisAlpha(aOpTable[n].sOp.zString[0]) ){` |
|        - |  278 | `			/* TICKET 1433-012: Alpha stream operators [i.e: and,or,xor,new...] */` |
|  3912953 |  279 | `			rc = SyStringCmp(pStr,&aOpTable[n].sOp,SyStrnicmp);` |
|  1956479 |  280 | `		}else{` |
| 29407219 |  281 | `			rc = SyStringCmp(pStr,&aOpTable[n].sOp,SyMemcmp);` |
|        - |  282 | `		}` |
| 33320167 |  283 | `		if( rc == 0 ){` |
|   995787 |  284 | `			if( aOpTable[n].sOp.nByte != sizeof(char) \|\| (aOpTable[n].iOp != EXPR_OP_UMINUS && aOpTable[n].iOp != EXPR_OP_UPLUS) \|\| pLast == 0 ){` |
|        - |  285 | `				/* There is no ambiguity here,simply return the first operator seen */` |
|   991557 |  286 | `				return &aOpTable[n];` |
|        - |  287 | `			}` |
|        - |  288 | `			/* Handle ambiguity */` |
|     4235 |  289 | `			if( pLast->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*'['*/\|PH7_TK_COLON/*:*/\|PH7_TK_COMMA/*,'*/) ){` |
|        - |  290 | `				/* Unary opertors have prcedence here over binary operators */` |
|      253 |  291 | `				return &aOpTable[n];` |
|        - |  292 | `			}` |
|     3987 |  293 | `			if( pLast->nType & PH7_TK_OP ){` |
...
|        4 |  301 | `			}` |
|     1925 |  302 | `		}` |
| 32328235 |  303 | `		++n; /* Next operator in the table */` |
|        5 |  304 | `	}` |
...
|        - |  312 | ` */` |
|   608502 |  313 | `PH7_PRIVATE void PH7_DelimitNestedTokens(SyToken *pIn,SyToken *pEnd,sxu32 nTokStart,sxu32 nTokEnd,SyToken **ppEnd)` |
|        5 |  314 |  |
|   608507 |  315 | `	SyToken *pCur = pIn;` |
|   608507 |  316 | `	sxi32 iNest = 1;` |
|  3281337 |  317 | `	for(;;){` |
|  6562679 |  318 | `		if( pCur >= pEnd ){` |
|      215 |  319 | `			break;` |
|        - |  320 | `		}` |
|  6562469 |  321 | `		if( pCur->nType & nTokStart ){` |
|        - |  322 | `			/* Increment nesting level */` |
|   323623 |  323 | `			iNest++;` |
|  6400660 |  324 | `		}else if( pCur->nType & nTokEnd ){` |
|        - |  325 | `			/* Decrement nesting level */` |
|   931915 |  326 | `			iNest--;` |
|   931915 |  327 | `			if( iNest <= 0 ){` |
|   608297 |  328 | `				break;` |
|        - |  329 | `			}` |
|   161809 |  330 | `		}` |
|        - |  331 | `		/* Advance cursor */` |
...
|        - |  345 | ` */` |
|    19870 |  346 | `PH7_PRIVATE int PH7_IsLangConstruct(sxu32 nKeyID,sxu8 bCheckFunc)` |
|        5 |  347 |  |
|    29731 |  348 | `	if( nKeyID == PH7_TKWRD_ECHO \|\| nKeyID == PH7_TKWRD_PRINT \|\| nKeyID == PH7_TKWRD_INCLUDE` |
|    19774 |  349 | `		\|\| nKeyID == PH7_TKWRD_INCONCE \|\| nKeyID == PH7_TKWRD_REQUIRE \|\| nKeyID == PH7_TKWRD_REQONCE` |
|        - |  350 | `		){` |
|      165 |  351 | `			return TRUE;` |
|        - |  352 | `	}` |
|    19715 |  353 | `	if( bCheckFunc ){` |
...
|        - |  368 | ` */` |
|   838722 |  369 | `static sxi32 ExprVerifyNodes(ph7_gen_state *pGen,ph7_expr_node **apNode,sxi32 nNode)` |
|        5 |  370 |  |
|        - |  371 | `	sxi32 iParen,iSquare,iQuesty,iBraces;` |
|        - |  372 | `	sxi32 i,rc;` |
|        - |  373 |  |
|   838727 |  374 | `	if( nNode > 0 && apNode[0]->pOp && (apNode[0]->pOp->iOp == EXPR_OP_ADD \|\| apNode[0]->pOp->iOp == EXPR_OP_SUB) ){` |
...
|       13 |  378 | `	}` |
|   838727 |  379 | `	iParen = iSquare = iQuesty = iBraces = 0;` |
|  4514795 |  380 | `	for( i = 0 ; i < nNode ; ++i ){` |
|  3676107 |  381 | `		if( apNode[i]->xCode == PH7_CompileShortArray \|\| apNode[i]->xCode == PH7_CompileShortList ){` |
|        - |  382 | `			/* Short array/list literal: brackets are self-contained, skip */` |
|      773 |  383 | `			continue;` |
|        - |  384 | `		}` |
|  3675339 |  385 | `		if( apNode[i]->pStart->nType & PH7_TK_LPAREN /*'('*/){` |
|   403049 |  386 | `			if( i > 0 && ( apNode[i-1]->xCode == PH7_CompileVariable \|\| apNode[i-1]->xCode == PH7_CompileLiteral \|\|` |
|    20150 |  387 | `				(apNode[i - 1]->pStart->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_SSTR\|PH7_TK_DSTR\|PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}'*/))) ){` |
|        - |  388 | `					/* Ticket 1433-033: Take care to ignore alpha-stream [i.e: or,xor] operators followed by an opening parenthesis */` |
|   375973 |  389 | `					if( (apNode[i - 1]->pStart->nType & PH7_TK_OP) == 0 ){` |
|        - |  390 | `						/* We are dealing with a postfix [i.e: function call]  operator` |
|        - |  391 | `						 * not a simple left parenthesis. Mark the node.` |
|        - |  392 | `						 */` |
|   375973 |  393 | `						apNode[i]->pStart->nType \|= PH7_TK_OP;` |
|   375973 |  394 | `						apNode[i]->pStart->pUserData = (void *)&sFCallOp; /* Function call operator */` |
|   375973 |  395 | `						apNode[i]->pOp = &sFCallOp;` |
|   187984 |  396 | `					}` |
|   187984 |  397 | `			}` |
|   403049 |  398 | `			iParen++;` |
|  3473817 |  399 | `		}else if( apNode[i]->pStart->nType & PH7_TK_RPAREN/*')*/){` |
|   403049 |  400 | `			if( iParen <= 0 ){` |
...
|        - |  406 | `			}` |
|   403037 |  407 | `			iParen--;` |
|  3070767 |  408 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OSB /*'['*/){` |
|    81531 |  409 | `			iSquare++;` |
|  2828488 |  410 | `		}else if (apNode[i]->pStart->nType & PH7_TK_CSB /*']'*/){` |
|    81545 |  411 | `			if( iSquare <= 0 ){` |
...
|        - |  417 | `			}` |
|    81539 |  418 | `			iSquare--;` |
|  2746952 |  419 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OCB /*'{'*/){` |
|       16 |  420 | `			iBraces++;` |
...
|        - |  464 |  |
|        7 |  465 | `			}` |
|  2706178 |  466 | `		}else if (apNode[i]->pStart->nType & PH7_TK_CCB /*'}'*/){` |
|       21 |  467 | `			if( iBraces <= 0 ){` |
...
|        - |  473 | `			}` |
|        6 |  474 | `			iBraces--;` |
|  2706157 |  475 | `		}else if ( apNode[i]->pStart->nType & PH7_TK_COLON ){` |
|     2745 |  476 | `			if( iQuesty > 0 ){` |
|     2555 |  477 | `				iQuesty--;` |
|     1470 |  478 | `			}else if( iParen <= 0 ){` |
...
|        5 |  486 | `				return rc;` |
|        5 |  487 | `			}` |
|  2704783 |  488 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OP ){` |
|   772183 |  489 | `			const ph7_expr_op *pOp = (const ph7_expr_op *)apNode[i]->pOp;` |
|   772183 |  490 | `			if( pOp->iOp == EXPR_OP_QUESTY ){` |
|     2557 |  491 | `				iQuesty++;` |
|   770907 |  492 | `			}else if( i > 0 && (pOp->iOp == EXPR_OP_UMINUS \|\| pOp->iOp == EXPR_OP_UPLUS)){` |
...
|   386089 |  512 | `		}` |
|  1837655 |  513 | `	}` |
|   838693 |  514 | `	if( iParen != 0 \|\| iSquare != 0 \|\| iQuesty != 0 \|\| iBraces != 0){` |
...
|       19 |  519 | `		return rc;` |
|        - |  520 | `	}` |
|   838677 |  521 | `	return SXRET_OK;` |
|   419366 |  522 |  |
|        - |  523 | `/*` |
|        - |  524 | ` * Collect and assemble tokens holding a namespace path [i.e: namespace\to\const]` |
|        - |  525 | ` * or a simple literal [i.e: PHP_EOL].` |
|        - |  526 | ` */` |
|   697820 |  527 | `static void ExprAssembleLiteral(SyToken **ppCur,SyToken *pEnd)` |
|        5 |  528 |  |
|   697825 |  529 | `	SyToken *pIn = *ppCur;` |
|        - |  530 | `	/* Jump the first literal seen */` |
|   697825 |  531 | `	if( (pIn->nType & PH7_TK_NSSEP) == 0 ){` |
|   697789 |  532 | `		pIn++;` |
|   348892 |  533 | `	}` |
|   348952 |  534 | `	for(;;){` |
|   697909 |  535 | `		if(pIn < pEnd && (pIn->nType & PH7_TK_NSSEP) ){` |
|       89 |  536 | `			pIn++;` |
...
|        - |  830 | ` */` |
|  3676334 |  831 | `static sxi32 ExprExtractNode(ph7_gen_state *pGen,ph7_expr_node **ppNode,int iLastWasTerm)` |
|        5 |  832 |  |
|        - |  833 | `	ph7_expr_node *pNode;` |
|        - |  834 | `	SyToken *pCur;` |
|        - |  835 | `	sxi32 rc;` |
|        - |  836 | `	/* Allocate a new node */` |
|  3676339 |  837 | `	pNode = (ph7_expr_node *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_expr_node));` |
|  3676339 |  838 | `	if( pNode == 0 ){` |
...
|  3676339 |  845 | `	SyZero(pNode,sizeof(ph7_expr_node));` |
|  3676339 |  846 | `	SySetInit(&pNode->aNodeArgs,&pGen->pVm->sAllocator,sizeof(ph7_expr_node **));` |
|        - |  847 | `	/* Point to the head of the token stream */` |
|  3676339 |  848 | `	pCur = pNode->pStart = pGen->pIn;` |
|        - |  849 | `	/* Start collecting tokens */` |
|  3676339 |  850 | `	if( pCur->nType & PH7_TK_ELLIPSIS ){` |
...
|       86 |  860 | `		return rc;` |
|        - |  861 | `	}` |
|  3676257 |  862 | `	if( (pCur->nType & PH7_TK_OSB) && !iLastWasTerm ){` |
...
|        5 |  891 | `		}` |
|  3675872 |  892 | `	}else if( pCur->nType & PH7_TK_OP ){` |
|        - |  893 | `		/* Point to the instance that describe this operator */` |
|   853743 |  894 | `		pNode->pOp = (const ph7_expr_op *)pCur->pUserData;` |
|        - |  895 | `		/* Advance the stream cursor */` |
|   853743 |  896 | `		pCur++;` |
|  3248618 |  897 | `	}else if( pCur->nType & PH7_TK_DOLLAR ){` |
|        - |  898 | `		/* Isolate variable */` |
|  1984317 |  899 | `		while( pCur < pGen->pEnd && (pCur->nType & PH7_TK_DOLLAR) ){` |
|   992167 |  900 | `			pCur++; /* Variable variable */` |
|        5 |  901 | `		}` |
|   992155 |  902 | `		if( pCur < pGen->pEnd ){` |
|   992155 |  903 | `			if (pCur->nType & (PH7_TK_ID\|PH7_TK_KEYWORD) ){` |
|        - |  904 | `				/* Variable name */` |
|   992127 |  905 | `				pCur++;` |
|   496093 |  906 | `			}else if( pCur->nType & PH7_TK_OCB /* '{' */ ){` |
|       24 |  907 | `				pCur++;` |
...
|        8 |  920 | `			}` |
|   496073 |  921 | `		}` |
|   992151 |  922 | `		pNode->xCode = PH7_CompileVariable;` |
|  2325672 |  923 | `	 }else if( pCur->nType & PH7_TK_KEYWORD ){` |
|    47413 |  924 | `		 sxu32 nKeyword = (sxu32)SX_PTR_TO_INT(pCur->pUserData);` |
|    47413 |  925 | `		 if( nKeyword == PH7_TKWRD_ARRAY \|\|  nKeyword == PH7_TKWRD_LIST ){` |
|        - |  926 | `			 /* List/Array node */` |
|    27165 |  927 | `			 if( &pCur[1] >= pGen->pEnd \|\| (pCur[1].nType & PH7_TK_LPAREN) == 0 ){` |
...
|    27149 |  934 | `				 PH7_DelimitNestedTokens(pCur,pGen->pEnd,PH7_TK_LPAREN /* '(' */, PH7_TK_RPAREN /* ')' */,&pCur);` |
|    27149 |  935 | `				 if( pCur < pGen->pEnd ){` |
|    27147 |  936 | `					 pCur++;` |
|    13576 |  937 | `				 }else{` |
|        - |  938 | `					 /* Syntax error */` |
...
|        3 |  945 | `					 return rc;` |
|        - |  946 | `				 }` |
|    27147 |  947 | `				 pNode->xCode = (nKeyword == PH7_TKWRD_LIST) ? PH7_CompileList : PH7_CompileArray;` |
|    27147 |  948 | `				 if( pNode->xCode == PH7_CompileList ){` |
...
|       12 |  959 | `				 }` |
|        5 |  960 | `			 }` |
|    33831 |  961 | `		 }else if( nKeyword == PH7_TKWRD_YIELD ){` |
...
|    20217 |  968 | `		 }else if( nKeyword == PH7_TKWRD_FUNCTION ){` |
...
|        - |  982 | `			  }` |
|    20034 |  983 | `		 }else if( nKeyword == PH7_TKWRD_FN` |
|    19851 |  984 | `			\|\| ( nKeyword == PH7_TKWRD_STATIC && &pCur[1] < pGen->pEnd` |
...
|    19850 |  994 | `		 }else if( nKeyword == PH7_TKWRD_MATCH ){` |
...
|    19756 | 1002 | `		 }else if( nKeyword == PH7_TKWRD_THROW ){` |
...
|    19703 | 1011 | `		 }else if( PH7_IsLangConstruct(nKeyword,FALSE) == TRUE && &pCur[1] < pGen->pEnd ){` |
...
|    19599 | 1017 | `			 ExprAssembleLiteral(&pCur,pGen->pEnd);` |
|    19599 | 1018 | `			 pNode->xCode = PH7_CompileLiteral;` |
|        5 | 1019 | `		 }` |
|  1805881 | 1020 | `	 }else if( pCur->nType & (PH7_TK_NSSEP\|PH7_TK_ID) ){` |
|        - | 1021 | `		 /* Constants,function name,namespace path,class name... */` |
|   678215 | 1022 | `		 ExprAssembleLiteral(&pCur,pGen->pEnd);` |
|   678215 | 1023 | `		 pNode->xCode = PH7_CompileLiteral;` |
|   339110 | 1024 | `	 }else{` |
|  1103981 | 1025 | `		 if( (pCur->nType & (PH7_TK_LPAREN\|PH7_TK_RPAREN\|PH7_TK_COMMA\|PH7_TK_COLON\|PH7_TK_CSB\|PH7_TK_OCB\|PH7_TK_CCB)) == 0 ){` |
|        - | 1026 | `			 /* Point to the code generator routine */` |
|   213561 | 1027 | `			 pNode->xCode = PH7_GetNodeHandler(pCur->nType);` |
|   213561 | 1028 | `			 if( pNode->xCode == 0 ){` |
...
|  3676223 | 1041 | `	pNode->pEnd = pCur;` |
|        - | 1042 | `	/* Save the node for later processing */` |
|  3676223 | 1043 | `	*ppNode = pNode;` |
|        - | 1044 | `	/* Synchronize cursors */` |
|  3676223 | 1045 | `	pGen->pIn = pCur;` |
|  3676223 | 1046 | `	return SXRET_OK;` |
|  1838172 | 1047 |  |
|        - | 1048 | `/*` |
...
|        - | 1051 | ` * level is zero.` |
|        - | 1052 | ` */` |
|    84512 | 1053 | `PH7_PRIVATE sxi32 PH7_GetNextExpr(SyToken *pStart,SyToken *pEnd,SyToken **ppNext)` |
|        5 | 1054 |  |
|    84517 | 1055 | `	SyToken *pCur = pStart;` |
|    84517 | 1056 | `	sxi32 iNest = 0;` |
|    84517 | 1057 | `	if( pCur >= pEnd \|\| (pCur->nType & PH7_TK_SEMI/*';'*/) ){` |
|        - | 1058 | `		/* Last expression */` |
|    44307 | 1059 | `		return SXERR_EOF;` |
|        - | 1060 | `	}` |
|   165915 | 1061 | `	while( pCur < pEnd ){` |
|   151287 | 1062 | `		if( (pCur->nType & (PH7_TK_COMMA/*','*/\|PH7_TK_SEMI/*';'*/)) && iNest <= 0){` |
|    25587 | 1063 | `			break;` |
|        - | 1064 | `		}` |
|   125705 | 1065 | `		if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|     8091 | 1066 | `			iNest++;` |
|   121662 | 1067 | `		}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}*/) ){` |
|     8093 | 1068 | `			iNest--;` |
|     4044 | 1069 | `		}` |
|   125705 | 1070 | `		pCur++;` |
|        5 | 1071 | `	}` |
|    40215 | 1072 | `	*ppNext = pCur;` |
|    40215 | 1073 | `	return SXRET_OK;` |
|    42261 | 1074 |  |
|        - | 1075 | `/*` |
|        - | 1076 | ` * Free an expression tree.` |
|        - | 1077 | ` */` |
|  3173160 | 1078 | `static void ExprFreeTree(ph7_gen_state *pGen,ph7_expr_node *pNode)` |
|        5 | 1079 |  |
|  3173165 | 1080 | `	if( pNode->pLeft ){` |
|        - | 1081 | `		/* Release the left tree */` |
|  1186463 | 1082 | `		ExprFreeTree(&(*pGen),pNode->pLeft);` |
|   593229 | 1083 | `	}` |
|  3173165 | 1084 | `	if( pNode->pRight ){` |
|        - | 1085 | `		/* Release the right tree */` |
|   656421 | 1086 | `		ExprFreeTree(&(*pGen),pNode->pRight);` |
|   328208 | 1087 | `	}` |
|  3173165 | 1088 | `	if( pNode->pCond ){` |
|        - | 1089 | `		/* Release the conditional tree used by the ternary operator */` |
|     2553 | 1090 | `		ExprFreeTree(&(*pGen),pNode->pCond);` |
|     1274 | 1091 | `	}` |
|  3173165 | 1092 | `	if( SySetUsed(&pNode->aNodeArgs) > 0 ){` |
|        - | 1093 | `		ph7_expr_node **apArg;` |
|        - | 1094 | `		sxu32 n;` |
|        - | 1095 | `		/* Release node arguments */` |
|   391141 | 1096 | `		apArg = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|   825281 | 1097 | `		for( n = 0 ; n < SySetUsed(&pNode->aNodeArgs) ; ++n ){` |
|   434145 | 1098 | `			ExprFreeTree(&(*pGen),apArg[n]);` |
|   217075 | 1099 | `		}` |
|   391141 | 1100 | `		SySetRelease(&pNode->aNodeArgs);` |
|   195568 | 1101 | `	}` |
|        - | 1102 | `	/* Finally,release this node */` |
|  3173165 | 1103 | `	SyMemBackendPoolFree(&pGen->pVm->sAllocator,pNode);` |
|  3173165 | 1104 |  |
|        - | 1105 | `/*` |
|        - | 1106 | ` * Free an expression tree.` |
|        - | 1107 | ` * This function is a wrapper around ExprFreeTree() defined above.` |
|        - | 1108 | ` */` |
|   838756 | 1109 | `PH7_PRIVATE sxi32 PH7_ExprFreeTree(ph7_gen_state *pGen,SySet *pNodeSet)` |
|        5 | 1110 |  |
|        - | 1111 | `	ph7_expr_node **apNode;` |
|        - | 1112 | `	sxu32 n;` |
|   838761 | 1113 | `	apNode = (ph7_expr_node **)SySetBasePtr(pNodeSet);` |
|  4514979 | 1114 | `	for( n = 0  ; n < SySetUsed(pNodeSet) ; ++n ){` |
|  3676223 | 1115 | `		if( apNode[n] ){` |
|   839095 | 1116 | `			ExprFreeTree(&(*pGen),apNode[n]);` |
|   419545 | 1117 | `		}` |
|  1838114 | 1118 | `	}` |
|   838761 | 1119 | `	return SXRET_OK;` |
|        5 | 1120 |  |
|        - | 1121 | `/*` |
...
|        - | 1127 | ` */` |
|  1174060 | 1128 | `PH7_PRIVATE int PH7_ExprContainsNullsafe(ph7_expr_node *pNode)` |
|        5 | 1129 |  |
|  1174065 | 1130 | `	if( pNode == 0 ){` |
|   723183 | 1131 | `		return 0;` |
|        - | 1132 | `	}` |
|   450887 | 1133 | `	if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW ){` |
|       16 | 1134 | `		return 1;` |
|        - | 1135 | `	}` |
|   450875 | 1136 | `	if( PH7_ExprContainsNullsafe(pNode->pLeft) ){` |
|        6 | 1137 | `		return 1;` |
|        - | 1138 | `	}` |
|   450871 | 1139 | `	if( PH7_ExprContainsNullsafe(pNode->pRight) ){` |
|      ! 0 | 1140 | `		return 1;` |
|        - | 1141 | `	}` |
|   450871 | 1142 | `	return 0;` |
|   587035 | 1143 |  |
|        - | 1144 | `/*` |
|        - | 1145 | ` * Check if the given node is a modifialbe l/r-value.` |
|        - | 1146 | ` * Return TRUE if modifiable.FALSE otherwise.` |
|        - | 1147 | ` */` |
|   265594 | 1148 | `static int ExprIsModifiableValue(ph7_expr_node *pNode,sxu8 bFunc)` |
|        5 | 1149 |  |
|        - | 1150 | `	sxi32 iExprOp;` |
|   265599 | 1151 | `	if( pNode->pOp == 0 ){` |
|   160367 | 1152 | `		return pNode->xCode == PH7_CompileVariable ? TRUE : FALSE;` |
|        - | 1153 | `	}` |
|   105237 | 1154 | `	iExprOp = pNode->pOp->iOp;` |
|   105237 | 1155 | `	if( iExprOp == EXPR_OP_ARROW /*'->' */ \|\| iExprOp == EXPR_OP_DC /*'::'*/ ){` |
|    73133 | 1156 | `			return TRUE;` |
|        - | 1157 | `	}` |
|    32109 | 1158 | `	if( iExprOp == EXPR_OP_SUBSCRIPT/*'[]'*/ ){` |
|    32105 | 1159 | `		if( pNode->pLeft->pOp ) {` |
|       50 | 1160 | `			if( pNode->pLeft->pOp->iOp != EXPR_OP_SUBSCRIPT /*'['*/ && pNode->pLeft->pOp->iOp != EXPR_OP_ARROW /*'->'*/` |
|       24 | 1161 | `				&& pNode->pLeft->pOp->iOp != EXPR_OP_DC /*'::'*/){` |
|      ! 0 | 1162 | `				return FALSE;` |
|        5 | 1163 | `			}` |
|    32080 | 1164 | `		}else if( pNode->pLeft->xCode != PH7_CompileVariable ){` |
|      ! 0 | 1165 | `			return FALSE;` |
|        - | 1166 | `		}` |
|    32105 | 1167 | `		return TRUE;` |
|        - | 1168 | `	}` |
...
|        - | 1185 | ` */` |
|   325522 | 1186 | `static sxi32 ExprProcessFuncArguments(ph7_gen_state *pGen,ph7_expr_node *pOp,ph7_expr_node **apNode,sxi32 nToken)` |
|        5 | 1187 |  |
...
|   325527 | 1191 | `	iCur = 0;` |
|   347012 | 1192 | `	for(;;){` |
|   694029 | 1193 | `		if( iCur >= nToken ){` |
|        - | 1194 | `			/* No more arguments to process */` |
|   325501 | 1195 | `			break;` |
|        - | 1196 | `		}` |
|   368533 | 1197 | `		iNode = iCur;` |
|   368533 | 1198 | `		iNest = 0;` |
|   919641 | 1199 | `		while( iCur < nToken ){` |
|   594143 | 1200 | `			if( apNode[iCur] ){` |
|   581487 | 1201 | `				if( (apNode[iCur]->pStart->nType & PH7_TK_COMMA) && apNode[iCur]->pLeft == 0 && iNest <= 0 ){` |
|    21520 | 1202 | `					break;` |
|   553232 | 1203 | `				}else if( (apNode[iCur]->pStart->nType & (PH7_TK_LPAREN\|PH7_TK_OSB\|PH7_TK_OCB))` |
|   284101 | 1204 | `					&& apNode[iCur]->xCode != PH7_CompileShortArray` |
|    29660 | 1205 | `					&& apNode[iCur]->xCode != PH7_CompileShortList ){` |
...
|    29565 | 1212 | `					iNest++;` |
|   523677 | 1213 | `				}else if( apNode[iCur]->pStart->nType & (PH7_TK_RPAREN\|PH7_TK_CCB\|PH7_TK_CSB) ){` |
|    29565 | 1214 | `					iNest--;` |
|    14780 | 1215 | `				}` |
|   269226 | 1216 | `			}` |
|   551113 | 1217 | `			iCur++;` |
|        5 | 1218 | `		}` |
|   368533 | 1219 | `		if( iCur > iNode ){` |
|   368527 | 1220 | `			SyString sArgName = {0, 0};` |
...
|   370466 | 1224 | `			if( (iCur - iNode) >= 2` |
|   204196 | 1225 | `				&& apNode[iNode]` |
|    39870 | 1226 | `				&& (apNode[iNode]->pStart->nType & (PH7_TK_ID\|PH7_TK_KEYWORD))` |
|    21950 | 1227 | `				&& apNode[iNode]->xCode == PH7_CompileLiteral` |
|     3959 | 1228 | `				&& apNode[iNode+1]` |
|     3893 | 1229 | `				&& (apNode[iNode+1]->pStart->nType & PH7_TK_COLON) ){` |
...
|        - | 1248 | `				}` |
|       92 | 1249 | `			}` |
|   368520 | 1250 | `			if( apNode[iNode] && (apNode[iNode]->pStart->nType & PH7_TK_AMPER /*'&'*/) && ((iCur - iNode) == 2)` |
...
|      ! 0 | 1256 | `			}` |
|   368525 | 1257 | `			ExprMakeTree(&(*pGen),&apNode[iNode],iCur-iNode);` |
|   368525 | 1258 | `			if( apNode[iNode] ){` |
|   368525 | 1259 | `				if( sArgName.nByte > 0 ){` |
...
|   368525 | 1264 | `				SySetPut(&pOp->aNodeArgs,(const void *)&apNode[iNode]);` |
|   184265 | 1265 | `			}else{` |
...
|   368525 | 1284 | `		if( iCur < nToken && apNode[iCur] && (apNode[iCur]->pStart->nType & PH7_TK_COMMA) ){` |
|    43029 | 1285 | `			iCur++;` |
|    43029 | 1286 | `			if( iCur >= nToken ){` |
|        - | 1287 | `				/* Trailing comma after last argument */` |
|       19 | 1288 | `				break;` |
|        - | 1289 | `			}` |
|    21503 | 1290 | `		}` |
|        5 | 1291 | `	}` |
|   325519 | 1292 | `	return SXRET_OK;` |
|   162766 | 1293 |  |
|        - | 1294 | ` /*` |
...
|        - | 1298 | `  */` |
|  1308404 | 1299 | ` static sxi32 ExprMakeTree(ph7_gen_state *pGen,ph7_expr_node **apNode,sxi32 nToken)` |
|        5 | 1300 | ` {` |
|        - | 1301 | `	 sxi32 i,iLeft,iRight;` |
|        - | 1302 | `	 ph7_expr_node *pNode;` |
|        - | 1303 | `	 sxi32 iCur;` |
|        - | 1304 | `	 sxi32 rc;` |
|  1308409 | 1305 | `	 if( nToken <= 0 \|\| (nToken == 1 && apNode[0]->xCode) ){` |
|        - | 1306 | `		 /* TICKET 1433-17: self evaluating node */` |
|   592893 | 1307 | `		 return SXRET_OK;` |
|        - | 1308 | `	 }` |
|        - | 1309 | `	 /* Process expressions enclosed in parenthesis first */` |
|  4393807 | 1310 | `	 for( iCur =  0 ; iCur < nToken ; ++iCur ){` |
|        - | 1311 | `		 sxi32 iNest;` |
...
|        - | 1314 | `		  */` |
|  3678293 | 1315 | `		 if( apNode[iCur] == 0 \|\| apNode[iCur]->pStart->nType != PH7_TK_LPAREN ){` |
|  3651227 | 1316 | `			 continue;` |
|        - | 1317 | `		 }` |
|    27071 | 1318 | `		 iNest = 1;` |
|    27071 | 1319 | `		 iLeft = iCur;` |
|        - | 1320 | `		 /* Find the closing parenthesis */` |
|    27071 | 1321 | `		 iCur++;` |
|   180699 | 1322 | `		 while( iCur < nToken ){` |
|   180699 | 1323 | `			 if( apNode[iCur] ){` |
|   180699 | 1324 | `				 if( apNode[iCur]->pStart->nType & PH7_TK_RPAREN /* ')' */){` |
|        - | 1325 | `					 /* Decrement nesting level */` |
|    46945 | 1326 | `					 iNest--;` |
|    46945 | 1327 | `					 if( iNest <= 0 ){` |
|    27071 | 1328 | `						 break;` |
|        5 | 1329 | `					 }` |
|   143696 | 1330 | `				 }else if( apNode[iCur]->pStart->nType & PH7_TK_LPAREN /* '(' */ ){` |
...
|   153633 | 1335 | `			 iCur++;` |
|        5 | 1336 | `		 }` |
|    27071 | 1337 | `		 if( iCur - iLeft > 1 ){` |
|        - | 1338 | `			 sxi32 j;` |
|        - | 1339 | `			 /* Recurse and process this expression */` |
|    27071 | 1340 | `			 rc = ExprMakeTree(&(*pGen),&apNode[iLeft + 1],iCur - iLeft - 1);` |
|    27071 | 1341 | `			 if( rc != SXRET_OK ){` |
|        3 | 1342 | `				 return rc;` |
|        - | 1343 | `			 }` |
...
|    27069 | 1347 | `			 for( j = iLeft + 1 ; j < iCur ; ++j ){` |
|    27069 | 1348 | `				 if( apNode[j] ){` |
|    27069 | 1349 | `					 apNode[j]->iFlags \|= EXPR_NODE_PARENS;` |
|    27069 | 1350 | `					 break;` |
|        - | 1351 | `				 }` |
|      ! 0 | 1352 | `			 }` |
|    13532 | 1353 | `		 }` |
|        - | 1354 | `		 /* Free the left and right nodes */` |
|    27069 | 1355 | `		 ExprFreeTree(&(*pGen),apNode[iLeft]);` |
|    27069 | 1356 | `		 ExprFreeTree(&(*pGen),apNode[iCur]);` |
|    27069 | 1357 | `		 apNode[iLeft] = 0;` |
|    27069 | 1358 | `		 apNode[iCur] = 0;` |
|    13537 | 1359 | `	 }` |
|        - | 1360 | `	  /* Process expressions enclosed in braces */` |
|  4567491 | 1361 | `	 for( iCur =  0 ; iCur < nToken ; ++iCur ){` |
|        - | 1362 | `		 sxi32 iNest;` |
...
|        - | 1365 | `		  */` |
|  3858969 | 1366 | `		 if( apNode[iCur] == 0 \|\| apNode[iCur]->pStart->nType != PH7_TK_OCB ){` |
|  3858965 | 1367 | `			 continue;` |
|        - | 1368 | `		 }` |
|        6 | 1369 | `		 iNest = 1;` |
|        6 | 1370 | `		 iLeft = iCur;` |
...
|   708527 | 1402 | `	 iLeft = -1;` |
|  4567461 | 1403 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  3858951 | 1404 | `		 if( apNode[iCur] == 0 ){` |
|  1471881 | 1405 | `			 continue;` |
|        - | 1406 | `		 }` |
|  2387075 | 1407 | `		 pNode = apNode[iCur];` |
|  2387075 | 1408 | `		 if( pNode->pOp && pNode->pOp->iPrec == 2 && pNode->pLeft == 0  ){` |
|   630591 | 1409 | `			 if( pNode->pOp->iOp == EXPR_OP_FUNC_CALL ){` |
|        - | 1410 | `				 /* Collect function arguments */` |
|   375969 | 1411 | `				 sxi32 iPtr = 0;` |
|   375969 | 1412 | `				 sxi32 nFuncTok = 0;` |
|  1346073 | 1413 | `				 while( nFuncTok + iCur < nToken ){` |
|  1346073 | 1414 | `					 if( apNode[nFuncTok+iCur] ){` |
|  1333417 | 1415 | `						 if( apNode[nFuncTok+iCur]->pStart->nType & PH7_TK_LPAREN /*'('*/ ){` |
|   389307 | 1416 | `							 iPtr++;` |
|  1138766 | 1417 | `						 }else if ( apNode[nFuncTok+iCur]->pStart->nType & PH7_TK_RPAREN /*')'*/){` |
|   389307 | 1418 | `							 iPtr--;` |
|   389307 | 1419 | `							 if( iPtr <= 0 ){` |
|   375969 | 1420 | `								 break;` |
|        - | 1421 | `							 }` |
|     6669 | 1422 | `						 }` |
|   478724 | 1423 | `					 }` |
|   970109 | 1424 | `					 nFuncTok++;` |
|        5 | 1425 | `				 }` |
|   375969 | 1426 | `				 if( nFuncTok + iCur >= nToken ){` |
|        - | 1427 | `					 /* Syntax error */` |
...
|      ! 0 | 1432 | `					 return rc;` |
|        - | 1433 | `				 }` |
|   375969 | 1434 | `				 if(  iLeft < 0 \|\| !NODE_ISTERM(iLeft) /*\|\| ( apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec != 2)*/ ){` |
|        - | 1435 | `					 /* Syntax error */` |
...
|      ! 0 | 1440 | `					 return rc;` |
|        - | 1441 | `				 }` |
|   375969 | 1442 | `				 if( nFuncTok > 1 ){` |
|        - | 1443 | `					 /* Process function arguments */` |
|   325527 | 1444 | `					 rc = ExprProcessFuncArguments(&(*pGen),pNode,&apNode[iCur+1],nFuncTok-1);` |
|   325527 | 1445 | `					 if( rc != SXRET_OK ){` |
|       10 | 1446 | `						 return rc;` |
|        - | 1447 | `					 }` |
|   162757 | 1448 | `				 }` |
|        - | 1449 | `				 /* Link the node to the tree */` |
|   375961 | 1450 | `				 pNode->pLeft = apNode[iLeft];` |
|   375961 | 1451 | `				 apNode[iLeft] = 0;` |
|  1346041 | 1452 | `				 for( iPtr = 1; iPtr <= nFuncTok ; iPtr++ ){` |
|   970085 | 1453 | `					 apNode[iCur+iPtr] = 0;` |
|   485045 | 1454 | `				 }` |
|   442605 | 1455 | `			 }else if (pNode->pOp->iOp == EXPR_OP_SUBSCRIPT ){` |
|        - | 1456 | `				 /* Subscripting */` |
|    81539 | 1457 | `				 sxi32 iArrTok = iCur + 1;` |
|    81539 | 1458 | `				 sxi32 iNest = 1;` |
|    81704 | 1459 | `				 if(  iLeft < 0 \|\| apNode[iLeft] == 0 \|\| (apNode[iLeft]->pOp == 0 && (apNode[iLeft]->xCode != PH7_CompileVariable &&` |
...
|    81534 | 1463 | `					 ( apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec != 2 /* postfix */) ){` |
|        - | 1464 | `						 /* Syntax error */` |
...
|   147269 | 1472 | `				 while( iArrTok < nToken ){` |
|   147269 | 1473 | `					 if( apNode[iArrTok] ){` |
|   147237 | 1474 | `						 if( apNode[iArrTok]->pOp && apNode[iArrTok]->pOp->iOp == EXPR_OP_SUBSCRIPT &&  apNode[iArrTok]->pLeft == 0){` |
|        - | 1475 | `							 /* Increment nesting level */` |
|      ! 0 | 1476 | `							 iNest++;` |
|   147237 | 1477 | `						 }else if( apNode[iArrTok]->pStart->nType & PH7_TK_CSB /*']'*/){` |
|        - | 1478 | `							 /* Decrement nesting level */` |
|    81539 | 1479 | `							 iNest--;` |
|    81539 | 1480 | `							 if( iNest <= 0 ){` |
|    81539 | 1481 | `								 break;` |
|        - | 1482 | `							 }` |
|      ! 0 | 1483 | `						 }` |
|    32849 | 1484 | `					 }` |
|    65735 | 1485 | `					 ++iArrTok;` |
|        5 | 1486 | `				 }` |
|    81539 | 1487 | `				 if( iArrTok > iCur + 1 ){` |
|        - | 1488 | `					 /* Recurse and process this expression */` |
|    65625 | 1489 | `					 rc = ExprMakeTree(&(*pGen),&apNode[iCur+1],iArrTok - iCur - 1);` |
|    65625 | 1490 | `					 if( rc != SXRET_OK ){` |
|      ! 0 | 1491 | `						 return rc;` |
|        - | 1492 | `					 }` |
|        - | 1493 | `					 /* Link the node to it's index */` |
|    65625 | 1494 | `					 SySetPut(&pNode->aNodeArgs,(const void *)&apNode[iCur+1]);` |
|    32810 | 1495 | `				 }` |
|        - | 1496 | `				 /* Link the node to the tree */` |
|    81539 | 1497 | `				 pNode->pLeft = apNode[iLeft];` |
|    81539 | 1498 | `				 pNode->pRight = 0;` |
|    81539 | 1499 | `				 apNode[iLeft] = 0;` |
|   228803 | 1500 | `				 for( iNest = iCur + 1 ; iNest <= iArrTok ; ++iNest ){` |
|   147269 | 1501 | `					 apNode[iNest] = 0;` |
|    73637 | 1502 | `				 }` |
|    40772 | 1503 | `			 }else{` |
|        - | 1504 | `				 /* Member access operators [i.e: '->','::'] */` |
|   173093 | 1505 | `				  iRight = iCur + 1;` |
|   173095 | 1506 | `				 while( iRight < nToken && apNode[iRight] == 0 ){` |
|        3 | 1507 | `					 iRight++;` |
|        1 | 1508 | `				 }` |
|   173093 | 1509 | `				 if( iRight >= nToken \|\| iLeft < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|        - | 1510 | `					 /* Syntax error */` |
...
|   173089 | 1518 | `				 pNode->pLeft = apNode[iLeft];` |
|   259446 | 1519 | `				 if( (pNode->pOp->iOp == EXPR_OP_ARROW /*'->'*/ \|\| pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW /*'?->'*/)` |
|   172947 | 1520 | `					 && pNode->pLeft->pOp == 0 &&` |
|   172724 | 1521 | `					 pNode->pLeft->xCode != PH7_CompileVariable ){` |
|        - | 1522 | `						 /* Syntax error */` |
...
|      ! 0 | 1528 | `						 return rc;` |
|        - | 1529 | `				 }` |
|   173089 | 1530 | `				 pNode->pRight = apNode[iRight];` |
|   173089 | 1531 | `				 apNode[iLeft] = apNode[iRight] = 0;` |
|        - | 1532 | `			 }` |
|   315287 | 1533 | `		 }` |
|  2387063 | 1534 | `		 iLeft = iCur;` |
|  1193534 | 1535 | `	 }` |
|        - | 1536 | `	 /* Handle left associative (new, clone) operators */` |
|  4567429 | 1537 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  3858919 | 1538 | `		 if( apNode[iCur] == 0 ){` |
|  2119427 | 1539 | `			 continue;` |
|        - | 1540 | `		 }` |
|  1739497 | 1541 | `		 pNode = apNode[iCur];` |
|  1739497 | 1542 | `		 if( pNode->pOp && pNode->pOp->iPrec == 1 && pNode->pLeft == 0 ){` |
|        - | 1543 | `			 SyToken *pToken;` |
|        - | 1544 | `			 /* Get the left node */` |
|    16977 | 1545 | `			 iLeft = iCur + 1;` |
|    33909 | 1546 | `			 while( iLeft < nToken && apNode[iLeft] == 0 ){` |
|    16937 | 1547 | `				 iLeft++;` |
|        5 | 1548 | `			 }` |
|    16977 | 1549 | `			 if( iLeft >= nToken \|\| !NODE_ISTERM(iLeft) ){` |
|        - | 1550 | `				  /* Syntax error */` |
...
|    16977 | 1559 | `			 if( pNode->pOp->iOp == EXPR_OP_CLONE ){` |
|        - | 1560 | `				 /* Clone:` |
...
|       11 | 1581 | `			 }else{` |
|        - | 1582 | `				 /* New */` |
|    16959 | 1583 | `				 if( apNode[iLeft]->pOp == 0 ){` |
...
|    16977 | 1599 | `			 pNode->pLeft = apNode[iLeft];` |
|    16977 | 1600 | `			 apNode[iLeft] = 0;` |
|    16977 | 1601 | `			 pNode->pRight = 0; /* Paranoid */` |
|     8486 | 1602 | `		 }` |
|   869751 | 1603 | `	 }` |
|        - | 1604 | `	  /* Handle post/pre icrement/decrement [i.e: ++/--] operators with precedence 3 */` |
|   708515 | 1605 | `	 iLeft = -1;` |
|  4570925 | 1606 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  3858919 | 1607 | `		 if( apNode[iCur] == 0 ){` |
|  2119427 | 1608 | `			 continue;` |
|        - | 1609 | `		 }` |
|  1739497 | 1610 | `		 pNode = apNode[iCur];` |
|  1739497 | 1611 | `		 if( pNode->pOp && pNode->pOp->iPrec == 3 && pNode->pLeft == 0){` |
|     9541 | 1612 | `			 if( iLeft >= 0 && ((apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec == 2 /* Postfix */)` |
|     3525 | 1613 | `				 \|\| apNode[iLeft]->xCode == PH7_CompileVariable) ){` |
|        - | 1614 | `					 /* Link the node to the tree */` |
|     3529 | 1615 | `					 pNode->pLeft = apNode[iLeft];` |
|     3529 | 1616 | `					 apNode[iLeft] = 0;` |
|     1762 | 1617 | `			 }` |
|     6516 | 1618 | `		  }` |
|  1742993 | 1619 | `		 iLeft = iCur;` |
|   873247 | 1620 | `	  }` |
|   712011 | 1621 | `	 iLeft = -1;` |
|  4570925 | 1622 | `	 for( iCur = nToken -  1 ; iCur >= 0 ; iCur-- ){` |
|  3858919 | 1623 | `		 if( apNode[iCur] == 0 ){` |
|  2122951 | 1624 | `			 continue;` |
|        - | 1625 | `		 }` |
|  1735973 | 1626 | `		 pNode = apNode[iCur];` |
|  1735973 | 1627 | `		 if( pNode->pOp && pNode->pOp->iPrec == 3 && pNode->pLeft == 0){` |
|     9509 | 1628 | `			 if( iLeft < 0 \|\| (apNode[iLeft]->pOp == 0 && apNode[iLeft]->xCode != PH7_CompileVariable)` |
|     9513 | 1629 | `				 \|\| ( apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec != 2 /* Postfix */) ){` |
|        - | 1630 | `					 /* Syntax error */` |
...
|     9513 | 1638 | `			 pNode->pLeft = apNode[iLeft];` |
|     9513 | 1639 | `			 apNode[iLeft] = 0;` |
|        - | 1640 | `			 /* Mark as pre-increment/decrement node */` |
|     9513 | 1641 | `			 pNode->iFlags \|= EXPR_NODE_PRE_INCR;` |
|     4754 | 1642 | `		  }` |
|  1735973 | 1643 | `		 iLeft = iCur;` |
|   867989 | 1644 | `	 }` |
|        - | 1645 | `	 /* Handle right associative unary and cast operators [i.e: !,(string),~...]  with precedence 4*/` |
|   712011 | 1646 | `	  iLeft = 0;` |
|  4570919 | 1647 | `	  for( iCur = nToken -  1 ; iCur >= 0 ; iCur-- ){` |
|  3858915 | 1648 | `		  if( apNode[iCur] ){` |
|  1726461 | 1649 | `			  pNode = apNode[iCur];` |
|  1726461 | 1650 | `			  if( pNode->pOp && pNode->pOp->iPrec == 4 && pNode->pLeft == 0){` |
|    42623 | 1651 | `				  if( iLeft > 0 ){` |
|        - | 1652 | `					  /* Link the node to the tree */` |
|    42621 | 1653 | `					  pNode->pLeft = apNode[iLeft];` |
|    42621 | 1654 | `					  apNode[iLeft] = 0;` |
|    42621 | 1655 | `					  if( pNode->pLeft && pNode->pLeft->pOp && pNode->pLeft->pOp->iPrec > 4 ){` |
...
|  4570917 | 1682 | `	 for( iCur = nToken - 1 ; iCur >= 0 ; --iCur ){` |
|  3858913 | 1683 | `		 if( apNode[iCur] == 0 ){` |
|  2175187 | 1684 | `			 continue;` |
|        - | 1685 | `		 }` |
|  1683731 | 1686 | `		 pNode = apNode[iCur];` |
|  1683731 | 1687 | `		 if( pNode->pOp && pNode->pOp->iPrec == 5 && pNode->pLeft == 0 ){` |
|        - | 1688 | `			 sxi32 iL, iR;` |
...
|  7831963 | 1751 | `	 for( i = 7 ; i < 17 ; i++ ){` |
|  7119969 | 1752 | `		 iLeft = -1;` |
| 45708755 | 1753 | `		 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
| 38588801 | 1754 | `			 if( apNode[iCur] == 0 ){` |
| 24631531 | 1755 | `				 continue;` |
|        - | 1756 | `			 }` |
| 13957275 | 1757 | `			 pNode = apNode[iCur];` |
| 13957275 | 1758 | `			 if( pNode->pOp && pNode->pOp->iPrec == i && pNode->pLeft == 0 ){` |
|        - | 1759 | `				 /* Get the right node */` |
|   215113 | 1760 | `				 iRight = iCur + 1;` |
|   307161 | 1761 | `				 while( iRight < nToken && apNode[iRight] == 0 ){` |
|    92053 | 1762 | `					 iRight++;` |
|        5 | 1763 | `				 }` |
|   215113 | 1764 | `				 if( iRight >= nToken \|\| iLeft < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|        - | 1765 | `					 /* Syntax error */` |
...
|       10 | 1770 | `					 return rc;` |
|        - | 1771 | `				 }` |
|   215105 | 1772 | `				 if( pNode->pOp->iOp == EXPR_OP_REF ){` |
|        - | 1773 | `					 sxi32  iTmp;` |
...
|   215103 | 1814 | `				 pNode->pLeft = apNode[iLeft];` |
|   215103 | 1815 | `				 pNode->pRight = apNode[iRight];` |
|   215103 | 1816 | `				 apNode[iLeft] = apNode[iRight] = 0;` |
|   107549 | 1817 | `			 }` |
| 13957265 | 1818 | `			 iLeft = iCur;` |
|  6978635 | 1819 | `		 }` |
|  3559982 | 1820 | `	 }` |
...
|        - | 1824 | `	  */` |
|   711999 | 1825 | `	  iLeft = -1;` |
|  4559967 | 1826 | `	  for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  3850523 | 1827 | `		  if( apNode[iCur] == 0 ){` |
|  2604739 | 1828 | `			  continue;` |
|        - | 1829 | `		  }` |
|  1245789 | 1830 | `		  pNode = apNode[iCur];` |
|  1245789 | 1831 | `		  if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_QUESTY && pNode->pLeft == 0 ){` |
|     2555 | 1832 | `			  sxi32 iNest = 1;` |
|     2555 | 1833 | `			  if( iLeft < 0 \|\| !NODE_ISTERM(iLeft) ){` |
...
|     2553 | 1842 | `			  iRight = iCur + 1;` |
|     5355 | 1843 | `			  while( iRight < nToken  ){` |
|     5355 | 1844 | `				  if( apNode[iRight] ){` |
|     5033 | 1845 | `					  if( apNode[iRight]->pOp && apNode[iRight]->pOp->iOp == EXPR_OP_QUESTY && apNode[iRight]->pCond == 0){` |
|        - | 1846 | `						  /* Increment nesting level */` |
|      ! 0 | 1847 | `						  ++iNest;` |
|     5033 | 1848 | `					  }else if( apNode[iRight]->pStart->nType & PH7_TK_COLON /*:*/ ){` |
|        - | 1849 | `						  /* Decrement nesting level */` |
|     2553 | 1850 | `						  --iNest;` |
|     2553 | 1851 | `						  if( iNest <= 0 ){` |
|     2553 | 1852 | `							  break;` |
|        - | 1853 | `						  }` |
|      ! 0 | 1854 | `					  }` |
|     1240 | 1855 | `				  }` |
|     2807 | 1856 | `				  iRight++;` |
|        5 | 1857 | `			  }` |
|     2553 | 1858 | `			  if( iRight > iCur + 1 ){` |
|        - | 1859 | `				  /* Recurse and process the then expression */` |
|     2485 | 1860 | `				  rc = ExprMakeTree(&(*pGen),&apNode[iCur + 1],iRight - iCur - 1);` |
|     2485 | 1861 | `				  if( rc != SXRET_OK ){` |
|      ! 0 | 1862 | `					  return rc;` |
|        - | 1863 | `				  }` |
|        - | 1864 | `				  /* Link the node to the tree */` |
|     2485 | 1865 | `				  pNode->pLeft = apNode[iCur + 1];` |
|     1240 | 1866 | `			  }else{` |
|        - | 1867 | `				  /* Elvis operator (?:): pLeft stays NULL.` |
|        - | 1868 | `				   * NODE_ISTERM() recognizes this node as complete via pCond. */` |
|        - | 1869 | `			  }` |
|     2553 | 1870 | `			  apNode[iCur + 1] = 0;` |
|     2553 | 1871 | `			  if( iRight + 1 < nToken ){` |
|        - | 1872 | `				  /* Recurse and process the else expression */` |
|     2553 | 1873 | `				  rc = ExprMakeTree(&(*pGen),&apNode[iRight + 1],nToken - iRight - 1);` |
|     2553 | 1874 | `				  if( rc != SXRET_OK ){` |
|      ! 0 | 1875 | `					  return rc;` |
|        - | 1876 | `				  }` |
|        - | 1877 | `				  /* Link the node to the tree */` |
|     2553 | 1878 | `				  pNode->pRight = apNode[iRight + 1];` |
|     2553 | 1879 | `				  apNode[iRight + 1] =  apNode[iRight] = 0;` |
|     1279 | 1880 | `			  }else{` |
...
|     2553 | 1888 | `			  pNode->pCond  = apNode[iLeft];` |
|     2553 | 1889 | `			  apNode[iLeft] = 0;` |
|     2553 | 1890 | `			  break;` |
|        - | 1891 | `		  }` |
|  1243239 | 1892 | `		  iLeft = iCur;` |
|   621622 | 1893 | `	  }` |
...
|        - | 1897 | `	  */` |
|   711997 | 1898 | `	 iRight = -1;` |
|  4570721 | 1899 | `	 for( iCur = nToken -  1 ; iCur >= 0 ; iCur--){` |
|  3858783 | 1900 | `		 if( apNode[iCur] == 0 ){` |
|  2881111 | 1901 | `			 continue;` |
|        - | 1902 | `		 }` |
|   977677 | 1903 | `		 pNode = apNode[iCur];` |
|   977677 | 1904 | `		 if( pNode->pOp && pNode->pOp->iPrec == 18 && pNode->pLeft == 0 ){` |
|        - | 1905 | `			 /* Get the left node */` |
|   265563 | 1906 | `			 iLeft = iCur - 1;` |
|   387047 | 1907 | `			 while( iLeft >= 0 && apNode[iLeft] == 0 ){` |
|   121489 | 1908 | `				 iLeft--;` |
|        5 | 1909 | `			 }` |
|   265563 | 1910 | `			 if( iLeft < 0 \|\| iRight < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|        - | 1911 | `				 /* Syntax error */` |
...
|        - | 1928 | `			  * a write. */` |
|   265521 | 1929 | `			 if( PH7_ExprContainsNullsafe(apNode[iLeft]) ){` |
...
|       11 | 1935 | `				 return rc;` |
|        - | 1936 | `			 }` |
|   265513 | 1937 | `			 if( ExprIsModifiableValue(apNode[iLeft],FALSE) == FALSE ){` |
...
|   265509 | 1956 | `			 pNode->pLeft = apNode[iRight];` |
|   265509 | 1957 | `			 pNode->pRight = apNode[iLeft];` |
|   265509 | 1958 | `			 apNode[iLeft] = apNode[iRight] = 0;` |
|   132752 | 1959 | `		 }` |
|   977623 | 1960 | `		 iRight = iCur;` |
|   488814 | 1961 | `	 }` |
|        - | 1962 | `	 /* Process left associative binary operators that have the lowest precedence [i.e: and,or,xor] */` |
|  3559695 | 1963 | `	 for( i = 19 ; i < 23 ; i++ ){` |
|  2847757 | 1964 | `		 iLeft = -1;` |
| 18282597 | 1965 | `		 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
| 15434845 | 1966 | `			 if( apNode[iCur] == 0 ){` |
| 12586687 | 1967 | `				 continue;` |
|        - | 1968 | `			 }` |
|  2848163 | 1969 | `			 pNode = apNode[iCur];` |
|  2848163 | 1970 | `			 if( pNode->pOp && pNode->pOp->iPrec == i && pNode->pLeft == 0 ){` |
...
|       35 | 1988 | `			 }` |
|  2848163 | 1989 | `			 iLeft = iCur;` |
|  1424084 | 1990 | `		 }` |
|  1423881 | 1991 | `	 }` |
|        - | 1992 | `	 /* Point to the root of the expression tree */` |
|  3858687 | 1993 | `	 for( iCur = 1 ; iCur < nToken ; ++iCur ){` |
|  3146767 | 1994 | `		 if( apNode[iCur] ){` |
|   647467 | 1995 | `			 if( (apNode[iCur]->pOp \|\| apNode[iCur]->xCode ) && apNode[0] != 0){` |
...
|       22 | 2000 | `				  return rc;` |
|        - | 2001 | `			 }` |
|   647449 | 2002 | `			 apNode[0] = apNode[iCur];` |
|   647449 | 2003 | `			 apNode[iCur] = 0;` |
|   323722 | 2004 | `		 }` |
|  1573377 | 2005 | `	 }` |
|   711925 | 2006 | `	 return SXRET_OK;` |
|   652459 | 2007 | ` }` |
|        - | 2008 | ` /*` |
...
|        - | 2013 | `  */` |
|   838756 | 2014 | `PH7_PRIVATE sxi32 PH7_ExprMakeTree(ph7_gen_state *pGen,SySet *pExprNode,ph7_expr_node **ppRoot)` |
|        5 | 2015 |  |
|        - | 2016 | `	ph7_expr_node **apNode;` |
|        - | 2017 | `	ph7_expr_node *pNode;` |
|        - | 2018 | `	sxi32 rc;` |
|        - | 2019 | `	/* Reset node container */` |
|   838761 | 2020 | `	SySetReset(pExprNode);` |
|   838761 | 2021 | `	pNode = 0; /* Prevent compiler warning */` |
|        - | 2022 | `	/* Extract nodes one after one until we hit the end of the input */` |
|        - | 2023 | `	{` |
|   838761 | 2024 | `		int iLastWasTerm = 0;` |
|  4514979 | 2025 | `		while( pGen->pIn < pGen->pEnd ){` |
|  3676257 | 2026 | `			rc = ExprExtractNode(&(*pGen),&pNode,iLastWasTerm);` |
|  3676257 | 2027 | `			if( rc != SXRET_OK ){` |
|       38 | 2028 | `				return rc;` |
|        - | 2029 | `			}` |
|        - | 2030 | `			/* Determine if this node is a term for short-array disambiguation */` |
|  3676223 | 2031 | `			if( pNode->xCode ){` |
|        - | 2032 | `				/* Node with compile handler: variable, literal, string, array, etc. */` |
|  1932065 | 2033 | `				iLastWasTerm = 1;` |
|  2710193 | 2034 | `			}else if( pNode->pOp ){` |
|        - | 2035 | `				/* Operator node */` |
|   853743 | 2036 | `				iLastWasTerm = 0;` |
|   426874 | 2037 | `			}else{` |
|        - | 2038 | `				/* Delimiter: ')' and ']' end terms */` |
|   890425 | 2039 | `				iLastWasTerm = (pNode->pStart->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB)) ? 1 : 0;` |
|        - | 2040 | `			}` |
|        - | 2041 | `			/* Save the extracted node */` |
|  3676223 | 2042 | `			SySetPut(pExprNode,(const void *)&pNode);` |
|        5 | 2043 | `		}` |
|        - | 2044 | `	}` |
|   838727 | 2045 | `	if( SySetUsed(pExprNode) < 1 ){` |
|        - | 2046 | `		/* Empty expression [i.e: A semi-colon;] */` |
|      ! 0 | 2047 | `		*ppRoot = 0;` |
|      ! 0 | 2048 | `		return SXRET_OK;` |
|        - | 2049 | `	}` |
|   838727 | 2050 | `	apNode = (ph7_expr_node **)SySetBasePtr(pExprNode);` |
|        - | 2051 | `	/* Make sure we are dealing with valid nodes */` |
|   838727 | 2052 | `	rc = ExprVerifyNodes(&(*pGen),apNode,(sxi32)SySetUsed(pExprNode));` |
|   838727 | 2053 | `	if( rc != SXRET_OK ){` |
...
|        - | 2059 | `	}` |
|        - | 2060 | `	/* Build the tree */` |
|   838677 | 2061 | `	rc = ExprMakeTree(&(*pGen),apNode,(sxi32)SySetUsed(pExprNode));` |
|   838677 | 2062 | `	if( rc != SXRET_OK ){` |
|        - | 2063 | `		/* Something goes wrong [i.e: Syntax error] */` |
|      103 | 2064 | `		*ppRoot = 0;` |
|      103 | 2065 | `		return rc;` |
|        - | 2066 | `	}` |
|        - | 2067 | `	/* Point to the root of the tree */` |
|   838579 | 2068 | `	*ppRoot = apNode[0];` |
|   838579 | 2069 | `	return SXRET_OK;` |
|   419383 | 2070 |  |
|        - | 2071 |  |
