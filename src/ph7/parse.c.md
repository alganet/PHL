...
|          - |  272 | ` */` |
|   24806694 |  273 | `PH7_PRIVATE const ph7_expr_op *  PH7_ExprExtractOperator(SyString *pStr,SyToken *pLast)` |
|          5 |  274 | `{` |
|   24806699 |  275 | `	sxu32 n = 0;` |
|          - |  276 | `	sxi32 rc;` |
|          - |  277 | `	/* Do a linear lookup on the operators table */` |
|  388254439 |  278 | `	for(;;){` |
|  776508883 |  279 | `		if( n >= SX_ARRAYSIZE(aOpTable) ){` |
|        ! 0 |  280 | `			break;` |
|          - |  281 | `		}` |
|  776508883 |  282 | `		if( SyisAlpha(aOpTable[n].sOp.zString[0]) ){` |
|          - |  283 | `			/* TICKET 1433-012: Alpha stream operators [i.e: and,or,xor,new...] */` |
|   74174093 |  284 | `			rc = SyStringCmp(pStr,&aOpTable[n].sOp,SyStrnicmp);` |
|   37087049 |  285 | `		}else{` |
|  702334795 |  286 | `			rc = SyStringCmp(pStr,&aOpTable[n].sOp,SyMemcmp);` |
|          - |  287 | `		}` |
|  776508883 |  288 | `		if( rc == 0 ){` |
|   25112591 |  289 | `			if( aOpTable[n].sOp.nByte != sizeof(char) \|\| (aOpTable[n].iOp != EXPR_OP_UMINUS && aOpTable[n].iOp != EXPR_OP_UPLUS) \|\| pLast == 0 ){` |
|          - |  290 | `				/* There is no ambiguity here,simply return the first operator seen */` |
|   24714583 |  291 | `				return &aOpTable[n];` |
|          - |  292 | `			}` |
...
|          4 |  306 | `			}` |
|     152946 |  307 | `		}` |
|  751702189 |  308 | `		++n; /* Next operator in the table */` |
|          5 |  309 | `	}` |
...
|          - |  317 | ` */` |
|    6808332 |  318 | `PH7_PRIVATE void PH7_DelimitNestedTokens(SyToken *pIn,SyToken *pEnd,sxu32 nTokStart,sxu32 nTokEnd,SyToken **ppEnd)` |
|          5 |  319 | `{` |
|    6808337 |  320 | `	SyToken *pCur = pIn;` |
|    6808337 |  321 | `	sxi32 iNest = 1;` |
|   72262005 |  322 | `	for(;;){` |
|  144524015 |  323 | `		if( pCur >= pEnd ){` |
|      15765 |  324 | `			break;` |
|          - |  325 | `		}` |
|  144508255 |  326 | `		if( pCur->nType & nTokStart ){` |
|          - |  327 | `			/* Increment nesting level */` |
|    5634641 |  328 | `			iNest++;` |
|  141690937 |  329 | `		}else if( pCur->nType & nTokEnd ){` |
|          - |  330 | `			/* Decrement nesting level */` |
|   12427213 |  331 | `			iNest--;` |
|   12427213 |  332 | `			if( iNest <= 0 ){` |
|    6792577 |  333 | `				break;` |
|          - |  334 | `			}` |
|    2817318 |  335 | `		}` |
|          - |  336 | `		/* Advance cursor */` |
...
|          - |  373 | ` */` |
|   14481658 |  374 | `static sxi32 ExprVerifyNodes(ph7_gen_state *pGen,ph7_expr_node **apNode,sxi32 nNode)` |
|          5 |  375 | `{` |
|          - |  376 | `	sxi32 iParen,iSquare,iQuesty,iBraces;` |
|          - |  377 | `	sxi32 i,rc;` |
|          - |  378 |  |
|   14481663 |  379 | `	if( nNode > 0 && apNode[0]->pOp && (apNode[0]->pOp->iOp == EXPR_OP_ADD \|\| apNode[0]->pOp->iOp == EXPR_OP_SUB) ){` |
...
|         16 |  383 | `	}` |
|   14481663 |  384 | `	iParen = iSquare = iQuesty = iBraces = 0;` |
|   91650195 |  385 | `	for( i = 0 ; i < nNode ; ++i ){` |
|   77168573 |  386 | `		if( apNode[i]->xCode == PH7_CompileShortArray \|\| apNode[i]->xCode == PH7_CompileShortList ){` |
|          - |  387 | `			/* Short array/list literal: brackets are self-contained, skip */` |
|     215671 |  388 | `			continue;` |
|          - |  389 | `		}` |
|   76952907 |  390 | `		if( apNode[i]->pStart->nType & PH7_TK_LPAREN /*'('*/){` |
|    6436159 |  391 | `			if( i > 0 && ( apNode[i-1]->xCode == PH7_CompileVariable \|\| apNode[i-1]->xCode == PH7_CompileLiteral \|\|` |
...
|    6029961 |  394 | `					if( (apNode[i - 1]->pStart->nType & PH7_TK_OP) == 0 ){` |
|          - |  395 | `						/* We are dealing with a postfix [i.e: function call]  operator` |
|          - |  396 | `						 * not a simple left parenthesis. Mark the node.` |
|          - |  397 | `						 */` |
|    6029961 |  398 | `						apNode[i]->pStart->nType \|= PH7_TK_OP;` |
|    6029961 |  399 | `						apNode[i]->pStart->pUserData = (void *)&sFCallOp; /* Function call operator */` |
|    6029961 |  400 | `						apNode[i]->pOp = &sFCallOp;` |
|    3014978 |  401 | `					}` |
|    3014978 |  402 | `			}` |
|    6436159 |  403 | `			iParen++;` |
|   73734830 |  404 | `		}else if( apNode[i]->pStart->nType & PH7_TK_RPAREN/*')*/){` |
|    6436159 |  405 | `			if( iParen <= 0 ){` |
...
|          - |  411 | `			}` |
|    6436147 |  412 | `			iParen--;` |
|   67298670 |  413 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OSB /*'['*/){` |
|    2816499 |  414 | `			iSquare++;` |
|   62672352 |  415 | `		}else if (apNode[i]->pStart->nType & PH7_TK_CSB /*']'*/){` |
|    2816503 |  416 | `			if( iSquare <= 0 ){` |
...
|          - |  422 | `			}` |
|    2816497 |  423 | `			iSquare--;` |
|   59855853 |  424 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OCB /*'{'*/){` |
|       3827 |  425 | `			iBraces++;` |
...
|          3 |  434 | `				return rc;` |
|          5 |  435 | `			}` |
|   58445695 |  436 | `		}else if (apNode[i]->pStart->nType & PH7_TK_CCB /*'}'*/){` |
...
|          - |  443 | `			}` |
|       3825 |  444 | `			iBraces--;` |
|   58441863 |  445 | `		}else if ( apNode[i]->pStart->nType & PH7_TK_COLON ){` |
|     430551 |  446 | `			if( iQuesty > 0 ){` |
|     430261 |  447 | `				iQuesty--;` |
|     215423 |  448 | `			}else if( iParen <= 0 ){` |
...
|          6 |  456 | `				return rc;` |
|          5 |  457 | `			}` |
|   58224678 |  458 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OP ){` |
|   19073035 |  459 | `			const ph7_expr_op *pOp = (const ph7_expr_op *)apNode[i]->pOp;` |
|   19073035 |  460 | `			if( pOp->iOp == EXPR_OP_QUESTY ){` |
|     430263 |  461 | `				iQuesty++;` |
|   18857906 |  462 | `			}else if( i > 0 && (pOp->iOp == EXPR_OP_UMINUS \|\| pOp->iOp == EXPR_OP_UPLUS)){` |
...
|    9536515 |  482 | `		}` |
|   38476438 |  483 | `	}` |
|   14481627 |  484 | `	if( iParen != 0 \|\| iSquare != 0 \|\| iQuesty != 0 \|\| iBraces != 0){` |
...
|         20 |  489 | `		return rc;` |
|          - |  490 | `	}` |
|   14481611 |  491 | `	return SXRET_OK;` |
|    7240834 |  492 | `}` |
|          - |  493 | `/*` |
|          - |  494 | ` * Collect and assemble tokens holding a namespace path [i.e: namespace\to\const]` |
|          - |  495 | ` * or a simple literal [i.e: PHP_EOL].` |
|          - |  496 | ` */` |
|   11688716 |  497 | `static void ExprAssembleLiteral(SyToken **ppCur,SyToken *pEnd)` |
|          5 |  498 | `{` |
|   11688721 |  499 | `	SyToken *pIn = *ppCur;` |
|          - |  500 | `	/* Jump the first literal seen */` |
|   11688721 |  501 | `	if( (pIn->nType & PH7_TK_NSSEP) == 0 ){` |
|   11684861 |  502 | `		pIn++;` |
|    5842428 |  503 | `	}` |
|    5846315 |  504 | `	for(;;){` |
|   11692635 |  505 | `		if(pIn < pEnd && (pIn->nType & PH7_TK_NSSEP) ){` |
|       3919 |  506 | `			pIn++;` |
...
|          - |  866 | ` */` |
|   77172784 |  867 | `static sxi32 ExprExtractNode(ph7_gen_state *pGen,ph7_expr_node **ppNode,int iLastWasTerm,int bAfterMemberOp)` |
|          5 |  868 | `{` |
|          - |  869 | `	ph7_expr_node *pNode;` |
|          - |  870 | `	SyToken *pCur;` |
|          - |  871 | `	sxi32 rc;` |
|          - |  872 | `	/* Allocate a new node */` |
|   77172789 |  873 | `	pNode = (ph7_expr_node *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_expr_node));` |
|   77172789 |  874 | `	if( pNode == 0 ){` |
...
|   77172789 |  881 | `	SyZero(pNode,sizeof(ph7_expr_node));` |
|   77172789 |  882 | `	SySetInit(&pNode->aNodeArgs,&pGen->pVm->sAllocator,sizeof(ph7_expr_node **));` |
|          - |  883 | `	/* Point to the head of the token stream */` |
|   77172789 |  884 | `	pCur = pNode->pStart = pGen->pIn;` |
|          - |  885 | `	/* Start collecting tokens */` |
|   77172789 |  886 | `	if( pCur->nType & PH7_TK_ELLIPSIS ){` |
...
|       4067 |  909 | `		return rc;` |
|          - |  910 | `	}` |
|   77168647 |  911 | `	if( (pCur->nType & PH7_TK_OSB) && !iLastWasTerm ){` |
|          - |  912 | `		/* PHP 5.4 short array syntax: [1, 2, 3] or ['key' => 'value'].` |
|          - |  913 | `		 * This '[' does not follow a term, so it is an array literal, not subscript.` |
|          - |  914 | `		 */` |
|     215673 |  915 | `		pCur++; /* Skip the opening '[' */` |
|     215673 |  916 | `		PH7_DelimitNestedTokens(pCur,pGen->pEnd,PH7_TK_OSB,PH7_TK_CSB,&pCur);` |
|     215673 |  917 | `		if( pCur < pGen->pEnd ){` |
|     215673 |  918 | `			pCur++; /* Skip past the closing ']' */` |
|     107839 |  919 | `		}else{` |
...
|          - |  930 | `		 */` |
|     215859 |  931 | `		if( pCur < pGen->pEnd && (pCur->nType & PH7_TK_OP) ){` |
...
|          - |  937 | `			}` |
|        189 |  938 | `		}else{` |
|     215301 |  939 | `			pNode->xCode = PH7_CompileShortArray;` |
|          5 |  940 | `		}` |
|   77060813 |  941 | `	}else if( bAfterMemberOp && (pCur->nType & PH7_TK_OP) && (pCur->nType & PH7_TK_ID) ){` |
...
|   76952967 |  952 | `	}else if( (pCur->nType & PH7_TK_OP) && pCur->pUserData` |
|   21889580 |  953 | `		&& ((const ph7_expr_op *)pCur->pUserData)->iOp == EXPR_OP_CLONE` |
|   10971510 |  954 | `		&& &pCur[1] < pGen->pEnd && (pCur[1].nType & PH7_TK_LPAREN) ){` |
...
|   76952952 |  980 | `	}else if( pCur->nType & PH7_TK_OP ){` |
|          - |  981 | `		/* Point to the instance that describe this operator */` |
|   21889563 |  982 | `		pNode->pOp = (const ph7_expr_op *)pCur->pUserData;` |
|          - |  983 | `		/* Advance the stream cursor */` |
|   21889563 |  984 | `		pCur++;` |
|   66008162 |  985 | `	}else if( pCur->nType & PH7_TK_DOLLAR ){` |
|          - |  986 | `		/* Isolate variable */` |
|   37174473 |  987 | `		while( pCur < pGen->pEnd && (pCur->nType & PH7_TK_DOLLAR) ){` |
|   18587245 |  988 | `			pCur++; /* Variable variable */` |
|          5 |  989 | `		}` |
|   18587233 |  990 | `		if( pCur < pGen->pEnd ){` |
|   18587233 |  991 | `			if (pCur->nType & (PH7_TK_ID\|PH7_TK_KEYWORD) ){` |
|          - |  992 | `				/* Variable name */` |
|   18587205 |  993 | `				pCur++;` |
|    9293633 |  994 | `			}else if( pCur->nType & PH7_TK_OCB /* '{' */ ){` |
|         25 |  995 | `				pCur++;` |
...
|          8 | 1008 | `			}` |
|    9293612 | 1009 | `		}` |
|   18587229 | 1010 | `		pNode->xCode = PH7_CompileVariable;` |
|   45769767 | 1011 | `	 }else if( pCur->nType & PH7_TK_KEYWORD ){` |
|     919333 | 1012 | `		 sxu32 nKeyword = (sxu32)SX_PTR_TO_INT(pCur->pUserData);` |
|     919333 | 1013 | `		 if( bAfterMemberOp ){` |
...
|     856330 | 1020 | `		 }else if( nKeyword == PH7_TKWRD_ARRAY \|\|  nKeyword == PH7_TKWRD_LIST ){` |
...
|         16 | 1054 | `				 }` |
|          5 | 1055 | `			 }` |
|     607501 | 1056 | `		 }else if( nKeyword == PH7_TKWRD_YIELD ){` |
...
|          5 | 1132 | `		 }` |
|   36016477 | 1133 | `	 }else if( pCur->nType & (PH7_TK_NSSEP\|PH7_TK_ID) ){` |
|          - | 1134 | `		 /* Constants,function name,namespace path,class name... */` |
|   11157923 | 1135 | `		 ExprAssembleLiteral(&pCur,pGen->pEnd);` |
|   11157923 | 1136 | `		 pNode->xCode = PH7_CompileLiteral;` |
|    5578964 | 1137 | `	 }else{` |
|   24398909 | 1138 | `		 if( (pCur->nType & (PH7_TK_LPAREN\|PH7_TK_RPAREN\|PH7_TK_COMMA\|PH7_TK_COLON\|PH7_TK_CSB\|PH7_TK_OCB\|PH7_TK_CCB)) == 0 ){` |
|          - | 1139 | `			 /* Point to the code generator routine */` |
|    8271879 | 1140 | `			 pNode->xCode = PH7_GetNodeHandler(pCur->nType);` |
|    8271879 | 1141 | `			 if( pNode->xCode == 0 ){` |
...
|   77168613 | 1154 | `	pNode->pEnd = pCur;` |
|          - | 1155 | `	/* Save the node for later processing */` |
|   77168613 | 1156 | `	*ppNode = pNode;` |
|          - | 1157 | `	/* Synchronize cursors */` |
|   77168613 | 1158 | `	pGen->pIn = pCur;` |
|   77168613 | 1159 | `	return SXRET_OK;` |
|   38586397 | 1160 | `}` |
|          - | 1161 | `/*` |
...
|          - | 1164 | ` * level is zero.` |
|          - | 1165 | ` */` |
|    1607914 | 1166 | `PH7_PRIVATE sxi32 PH7_GetNextExpr(SyToken *pStart,SyToken *pEnd,SyToken **ppNext)` |
|          5 | 1167 | `{` |
|    1607919 | 1168 | `	SyToken *pCur = pStart;` |
|    1607919 | 1169 | `	sxi32 iNest = 0;` |
|    1607919 | 1170 | `	if( pCur >= pEnd \|\| (pCur->nType & PH7_TK_SEMI/*';'*/) ){` |
|          - | 1171 | `		/* Last expression */` |
|     631027 | 1172 | `		return SXERR_EOF;` |
|          - | 1173 | `	}` |
|    3787815 | 1174 | `	while( pCur < pEnd ){` |
|    3525811 | 1175 | `		if( (pCur->nType & (PH7_TK_COMMA/*','*/\|PH7_TK_SEMI/*';'*/)) && iNest <= 0){` |
|     714893 | 1176 | `			break;` |
|          - | 1177 | `		}` |
|    2810923 | 1178 | `		if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|     213645 | 1179 | `			iNest++;` |
|    2704103 | 1180 | `		}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}*/) ){` |
|     213647 | 1181 | `			iNest--;` |
|     106821 | 1182 | `		}` |
|    2810923 | 1183 | `		pCur++;` |
|          5 | 1184 | `	}` |
|     976897 | 1185 | `	*ppNext = pCur;` |
|     976897 | 1186 | `	return SXRET_OK;` |
|     803962 | 1187 | `}` |
|          - | 1188 | `/*` |
|          - | 1189 | ` * Free an expression tree.` |
|          - | 1190 | ` */` |
|   65892722 | 1191 | `static void ExprFreeTree(ph7_gen_state *pGen,ph7_expr_node *pNode)` |
|          5 | 1192 | `{` |
|   65892727 | 1193 | `	if( pNode->pLeft ){` |
|          - | 1194 | `		/* Release the left tree */` |
|   25916205 | 1195 | `		ExprFreeTree(&(*pGen),pNode->pLeft);` |
|   12958100 | 1196 | `	}` |
|   65892727 | 1197 | `	if( pNode->pRight ){` |
|          - | 1198 | `		/* Release the right tree */` |
|   15009817 | 1199 | `		ExprFreeTree(&(*pGen),pNode->pRight);` |
|    7504906 | 1200 | `	}` |
|   65892727 | 1201 | `	if( pNode->pCond ){` |
|          - | 1202 | `		/* Release the conditional tree used by the ternary operator */` |
|     430259 | 1203 | `		ExprFreeTree(&(*pGen),pNode->pCond);` |
|     215127 | 1204 | `	}` |
|   65892727 | 1205 | `	if( SySetUsed(&pNode->aNodeArgs) > 0 ){` |
|          - | 1206 | `		ph7_expr_node **apArg;` |
|          - | 1207 | `		sxu32 n;` |
|          - | 1208 | `		/* Release node arguments */` |
|    7234611 | 1209 | `		apArg = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|   16468455 | 1210 | `		for( n = 0 ; n < SySetUsed(&pNode->aNodeArgs) ; ++n ){` |
|    9233849 | 1211 | `			ExprFreeTree(&(*pGen),apArg[n]);` |
|    4616927 | 1212 | `		}` |
|    7234611 | 1213 | `		SySetRelease(&pNode->aNodeArgs);` |
|    3617303 | 1214 | `	}` |
|          - | 1215 | `	/* Finally,release this node */` |
|   65892727 | 1216 | `	SyMemBackendPoolFree(&pGen->pVm->sAllocator,pNode);` |
|   65892727 | 1217 | `}` |
|          - | 1218 | `/*` |
|          - | 1219 | ` * Free an expression tree.` |
|          - | 1220 | ` * This function is a wrapper around ExprFreeTree() defined above.` |
|          - | 1221 | ` */` |
|   14481688 | 1222 | `PH7_PRIVATE sxi32 PH7_ExprFreeTree(ph7_gen_state *pGen,SySet *pNodeSet)` |
|          5 | 1223 | `{` |
|          - | 1224 | `	ph7_expr_node **apNode;` |
|          - | 1225 | `	sxu32 n;` |
|   14481693 | 1226 | `	apNode = (ph7_expr_node **)SySetBasePtr(pNodeSet);` |
|   91650351 | 1227 | `	for( n = 0  ; n < SySetUsed(pNodeSet) ; ++n ){` |
|   77168663 | 1228 | `		if( apNode[n] ){` |
|   14482033 | 1229 | `			ExprFreeTree(&(*pGen),apNode[n]);` |
|    7241014 | 1230 | `		}` |
|   38584334 | 1231 | `	}` |
|   14481693 | 1232 | `	return SXRET_OK;` |
|          5 | 1233 | `}` |
|          - | 1234 | `/*` |
...
|          - | 1240 | ` */` |
|   18682652 | 1241 | `PH7_PRIVATE int PH7_ExprContainsNullsafe(ph7_expr_node *pNode)` |
|          5 | 1242 | `{` |
|   18682657 | 1243 | `	if( pNode == 0 ){` |
|   11661299 | 1244 | `		return 0;` |
|          - | 1245 | `	}` |
|    7021363 | 1246 | `	if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW ){` |
|         16 | 1247 | `		return 1;` |
|          - | 1248 | `	}` |
|    7021351 | 1249 | `	if( PH7_ExprContainsNullsafe(pNode->pLeft) ){` |
|          6 | 1250 | `		return 1;` |
|          - | 1251 | `	}` |
|    7021347 | 1252 | `	if( PH7_ExprContainsNullsafe(pNode->pRight) ){` |
|        ! 0 | 1253 | `		return 1;` |
|          - | 1254 | `	}` |
|    7021347 | 1255 | `	return 0;` |
|    9341331 | 1256 | `}` |
|          - | 1257 | `/*` |
|          - | 1258 | ` * Check if the given node is a modifialbe l/r-value.` |
|          - | 1259 | ` * Return TRUE if modifiable.FALSE otherwise.` |
|          - | 1260 | ` */` |
|    4617006 | 1261 | `static int ExprIsModifiableValue(ph7_expr_node *pNode,sxu8 bFunc)` |
|          5 | 1262 | `{` |
|          - | 1263 | `	sxi32 iExprOp;` |
|    4617011 | 1264 | `	if( pNode->pOp == 0 ){` |
|    3334601 | 1265 | `		return pNode->xCode == PH7_CompileVariable ? TRUE : FALSE;` |
|          - | 1266 | `	}` |
|    1282415 | 1267 | `	iExprOp = pNode->pOp->iOp;` |
|    1282415 | 1268 | `	if( iExprOp == EXPR_OP_ARROW /*'->' */ \|\| iExprOp == EXPR_OP_DC /*'::'*/ ){` |
|     782231 | 1269 | `			return TRUE;` |
|          - | 1270 | `	}` |
|     500189 | 1271 | `	if( iExprOp == EXPR_OP_SUBSCRIPT/*'[]'*/ ){` |
|     500183 | 1272 | `		if( pNode->pLeft->pOp ) {` |
...
|        ! 0 | 1275 | `				return FALSE;` |
|          5 | 1276 | `			}` |
|     441056 | 1277 | `		}else if( pNode->pLeft->xCode != PH7_CompileVariable ){` |
|        ! 0 | 1278 | `			return FALSE;` |
|          - | 1279 | `		}` |
|     500183 | 1280 | `		return TRUE;` |
|          - | 1281 | `	}` |
...
|          - | 1298 | ` */` |
|    4635708 | 1299 | `static sxi32 ExprProcessFuncArguments(ph7_gen_state *pGen,ph7_expr_node *pOp,ph7_expr_node **apNode,sxi32 nToken)` |
|          5 | 1300 | `{` |
...
|    4635713 | 1304 | `	iCur = 0;` |
|    5635315 | 1305 | `	for(;;){` |
|   11270635 | 1306 | `		if( iCur >= nToken ){` |
|          - | 1307 | `			/* No more arguments to process */` |
|    4635687 | 1308 | `			break;` |
|          - | 1309 | `		}` |
|    6634953 | 1310 | `		iNode = iCur;` |
|    6634953 | 1311 | `		iNest = 0;` |
|   21462513 | 1312 | `		while( iCur < nToken ){` |
|   16826829 | 1313 | `			if( apNode[iCur] ){` |
|   16780907 | 1314 | `				if( (apNode[iCur]->pStart->nType & PH7_TK_COMMA) && apNode[iCur]->pLeft == 0 && iNest <= 0 ){` |
|     999637 | 1315 | `					break;` |
|   14781638 | 1316 | `				}else if( (apNode[iCur]->pStart->nType & (PH7_TK_LPAREN\|PH7_TK_OSB\|PH7_TK_OCB))` |
|    7962814 | 1317 | `					&& apNode[iCur]->xCode != PH7_CompileShortArray` |
|    1141501 | 1318 | `					&& apNode[iCur]->xCode != PH7_CompileShortList ){` |
...
|    1139007 | 1325 | `					iNest++;` |
|   14212142 | 1326 | `				}else if( apNode[iCur]->pStart->nType & (PH7_TK_RPAREN\|PH7_TK_CCB\|PH7_TK_CSB) ){` |
|    1139007 | 1327 | `					iNest--;` |
|     569501 | 1328 | `				}` |
|    7390819 | 1329 | `			}` |
|   14827565 | 1330 | `			iCur++;` |
|          5 | 1331 | `		}` |
|    6634953 | 1332 | `		if( iCur > iNode ){` |
|    6634947 | 1333 | `			SyString sArgName = {0, 0};` |
...
|    6634942 | 1337 | `			if( (iCur - iNode) >= 2` |
|    4486200 | 1338 | `				&& apNode[iNode]` |
|    2337444 | 1339 | `				&& (apNode[iNode]->pStart->nType & (PH7_TK_ID\|PH7_TK_KEYWORD))` |
|    1255809 | 1340 | `				&& apNode[iNode]->xCode == PH7_CompileLiteral` |
|     173930 | 1341 | `				&& apNode[iNode+1]` |
|     173677 | 1342 | `				&& (apNode[iNode+1]->pStart->nType & PH7_TK_COLON) ){` |
...
|          - | 1361 | `				}` |
|        142 | 1362 | `			}` |
|    6634940 | 1363 | `			if( apNode[iNode] && (apNode[iNode]->pStart->nType & PH7_TK_AMPER /*'&'*/) && ((iCur - iNode) == 2)` |
...
|    6634945 | 1380 | `				int bSpreadArg = 0;` |
|          - | 1381 | `				sxi32 iScan;` |
|    6634973 | 1382 | `				for( iScan = iNode ; iScan < iCur ; iScan++ ){` |
|    6634973 | 1383 | `					if( apNode[iScan] ){` |
|    6634945 | 1384 | `						bSpreadArg = (apNode[iScan]->iFlags & EXPR_NODE_SPREAD) != 0;` |
|    6634945 | 1385 | `						break;` |
|          - | 1386 | `					}` |
|         15 | 1387 | `				}` |
|    6634945 | 1388 | `				ExprMakeTree(&(*pGen),&apNode[iNode],iCur-iNode);` |
|    6634945 | 1389 | `				if( bSpreadArg && apNode[iNode] ){` |
|       4001 | 1390 | `					apNode[iNode]->iFlags \|= EXPR_NODE_SPREAD;` |
|       1998 | 1391 | `				}` |
|          - | 1392 | `			}` |
|    6634945 | 1393 | `			if( apNode[iNode] ){` |
|    6634945 | 1394 | `				if( sArgName.nByte > 0 ){` |
...
|    6634945 | 1399 | `				SySetPut(&pOp->aNodeArgs,(const void *)&apNode[iNode]);` |
|    3317475 | 1400 | `			}else{` |
...
|    6634945 | 1419 | `		if( iCur < nToken && apNode[iCur] && (apNode[iCur]->pStart->nType & PH7_TK_COMMA) ){` |
|    1999263 | 1420 | `			iCur++;` |
|    1999263 | 1421 | `			if( iCur >= nToken ){` |
|          - | 1422 | `				/* Trailing comma after last argument */` |
|         19 | 1423 | `				break;` |
|          - | 1424 | `			}` |
|     999620 | 1425 | `		}` |
|          5 | 1426 | `	}` |
|    4635705 | 1427 | `	return SXRET_OK;` |
|    2317859 | 1428 | `}` |
|          - | 1429 | ` /*` |
...
|          - | 1433 | `  */` |
|   25138770 | 1434 | ` static sxi32 ExprMakeTree(ph7_gen_state *pGen,ph7_expr_node **apNode,sxi32 nToken)` |
|          5 | 1435 | ` {` |
...
|          - | 1439 | `	 sxi32 iCur;` |
|          - | 1440 | `	 sxi32 rc;` |
|   25138775 | 1441 | `	 if( nToken <= 0 \|\| (nToken == 1 && apNode[0]->xCode) ){` |
|          - | 1442 | `		 /* TICKET 1433-17: self evaluating node */` |
|   11154727 | 1443 | `		 return SXRET_OK;` |
|          - | 1444 | `	 }` |
|          - | 1445 | `	 /* Process expressions enclosed in parenthesis first */` |
|  100204441 | 1446 | `	 for( iCur =  0 ; iCur < nToken ; ++iCur ){` |
|          - | 1447 | `		 sxi32 iNest;` |
...
|          - | 1450 | `		  */` |
|   86220395 | 1451 | `		 if( apNode[iCur] == 0 \|\| apNode[iCur]->pStart->nType != PH7_TK_LPAREN ){` |
|   85814207 | 1452 | `			 continue;` |
|          - | 1453 | `		 }` |
|     406193 | 1454 | `		 iNest = 1;` |
...
|  103466769 | 1501 | `	 for( iCur =  0 ; iCur < nToken ; ++iCur ){` |
|          - | 1502 | `		 sxi32 iNest;` |
...
|          - | 1505 | `		  */` |
|   89796095 | 1506 | `		 if( apNode[iCur] == 0 \|\| apNode[iCur]->pStart->nType != PH7_TK_OCB ){` |
|   89792275 | 1507 | `			 continue;` |
|          - | 1508 | `		 }` |
|       3825 | 1509 | `		 iNest = 1;` |
...
|   13670679 | 1542 | `	 iLeft = -1;` |
|  103474371 | 1543 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|   89803709 | 1544 | `		 if( apNode[iCur] == 0 ){` |
|   39072255 | 1545 | `			 continue;` |
|          - | 1546 | `		 }` |
|   50731459 | 1547 | `		 pNode = apNode[iCur];` |
|   50731459 | 1548 | `		 if( pNode->pOp && pNode->pOp->iPrec == 2 && pNode->pLeft == 0  ){` |
|   13729063 | 1549 | `			 if( pNode->pOp->iOp == EXPR_OP_FUNC_CALL ){` |
|          - | 1550 | `				 /* Collect function arguments */` |
|    6029957 | 1551 | `				 sxi32 iPtr = 0;` |
|    6029957 | 1552 | `				 sxi32 nFuncTok = 0;` |
|   28886735 | 1553 | `				 while( nFuncTok + iCur < nToken ){` |
|   28886735 | 1554 | `					 if( apNode[nFuncTok+iCur] ){` |
|   28840813 | 1555 | `						 if( apNode[nFuncTok+iCur]->pStart->nType & PH7_TK_LPAREN /*'('*/ ){` |
|    6390787 | 1556 | `							 iPtr++;` |
|   25645422 | 1557 | `						 }else if ( apNode[nFuncTok+iCur]->pStart->nType & PH7_TK_RPAREN /*')'*/){` |
|    6390787 | 1558 | `							 iPtr--;` |
|    6390787 | 1559 | `							 if( iPtr <= 0 ){` |
|    6029957 | 1560 | `								 break;` |
|          - | 1561 | `							 }` |
|     180415 | 1562 | `						 }` |
|   11405428 | 1563 | `					 }` |
|   22856783 | 1564 | `					 nFuncTok++;` |
|          5 | 1565 | `				 }` |
|    6029957 | 1566 | `				 if( nFuncTok + iCur >= nToken ){` |
|          - | 1567 | `					 /* Syntax error */` |
...
|        ! 0 | 1572 | `					 return rc;` |
|          - | 1573 | `				 }` |
|    6029957 | 1574 | `				 if(  iLeft < 0 \|\| !NODE_ISTERM(iLeft) /*\|\| ( apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec != 2)*/ ){` |
|          - | 1575 | `					 /* Syntax error */` |
...
|        ! 0 | 1580 | `					 return rc;` |
|          - | 1581 | `				 }` |
|    6029957 | 1582 | `				 if( nFuncTok > 1 ){` |
|          - | 1583 | `					 /* Process function arguments */` |
|    4635713 | 1584 | `					 rc = ExprProcessFuncArguments(&(*pGen),pNode,&apNode[iCur+1],nFuncTok-1);` |
|    4635713 | 1585 | `					 if( rc != SXRET_OK ){` |
|         11 | 1586 | `						 return rc;` |
|          - | 1587 | `					 }` |
|    2317850 | 1588 | `				 }` |
|          - | 1589 | `				 /* Link the node to the tree */` |
|    6029949 | 1590 | `				 pNode->pLeft = apNode[iLeft];` |
|    6029949 | 1591 | `				 apNode[iLeft] = 0;` |
|   28886703 | 1592 | `				 for( iPtr = 1; iPtr <= nFuncTok ; iPtr++ ){` |
|   22856759 | 1593 | `					 apNode[iCur+iPtr] = 0;` |
|   11428382 | 1594 | `				 }` |
...
|          - | 1605 | `				 {` |
|    6029949 | 1606 | `					 sxi32 iNew = iLeft - 1;` |
|    7858413 | 1607 | `					 while( iNew >= 0 && apNode[iNew] == 0 ){` |
|    1828469 | 1608 | `						 iNew--;` |
|          5 | 1609 | `					 }` |
|    6029944 | 1610 | `					 if( iNew >= 0 && apNode[iNew]->pOp` |
|    3593657 | 1611 | `						 && apNode[iNew]->pOp->iOp == EXPR_OP_NEW` |
|    2165024 | 1612 | `						 && apNode[iNew]->pLeft == 0 ){` |
...
|     374874 | 1617 | `					 }` |
|          - | 1618 | `				 }` |
|   10714083 | 1619 | `			 }else if (pNode->pOp->iOp == EXPR_OP_SUBSCRIPT ){` |
|          - | 1620 | `				 /* Subscripting */` |
|    2816497 | 1621 | `				 sxi32 iArrTok = iCur + 1;` |
|    2816497 | 1622 | `				 sxi32 iNest = 1;` |
|    2816492 | 1623 | `				 if(  iLeft < 0 \|\| apNode[iLeft] == 0 \|\| (apNode[iLeft]->pOp == 0 && (apNode[iLeft]->xCode != PH7_CompileVariable &&` |
...
|    2816492 | 1627 | `					 ( apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec != 2 /* postfix */` |
...
|    5922555 | 1639 | `				 while( iArrTok < nToken ){` |
|    5922555 | 1640 | `					 if( apNode[iArrTok] ){` |
|    5922523 | 1641 | `						 if( apNode[iArrTok]->pOp && apNode[iArrTok]->pOp->iOp == EXPR_OP_SUBSCRIPT &&  apNode[iArrTok]->pLeft == 0){` |
|          - | 1642 | `							 /* Increment nesting level */` |
|      26689 | 1643 | `							 iNest++;` |
|    5909181 | 1644 | `						 }else if( apNode[iArrTok]->pStart->nType & PH7_TK_CSB /*']'*/){` |
|          - | 1645 | `							 /* Decrement nesting level */` |
|    2843181 | 1646 | `							 iNest--;` |
|    2843181 | 1647 | `							 if( iNest <= 0 ){` |
|    2816497 | 1648 | `								 break;` |
|          - | 1649 | `							 }` |
|      13342 | 1650 | `						 }` |
|    1553013 | 1651 | `					 }` |
|    3106063 | 1652 | `					 ++iArrTok;` |
|          5 | 1653 | `				 }` |
|    2816497 | 1654 | `				 if( iArrTok > iCur + 1 ){` |
|          - | 1655 | `					 /* Recurse and process this expression */` |
|    2598909 | 1656 | `					 rc = ExprMakeTree(&(*pGen),&apNode[iCur+1],iArrTok - iCur - 1);` |
|    2598909 | 1657 | `					 if( rc != SXRET_OK ){` |
|        ! 0 | 1658 | `						 return rc;` |
|          - | 1659 | `					 }` |
|          - | 1660 | `					 /* Link the node to it's index */` |
|    2598909 | 1661 | `					 SySetPut(&pNode->aNodeArgs,(const void *)&apNode[iCur+1]);` |
|    1299452 | 1662 | `				 }` |
|          - | 1663 | `				 /* Link the node to the tree */` |
|    2816497 | 1664 | `				 pNode->pLeft = apNode[iLeft];` |
|    2816497 | 1665 | `				 pNode->pRight = 0;` |
|    2816497 | 1666 | `				 apNode[iLeft] = 0;` |
|    8739047 | 1667 | `				 for( iNest = iCur + 1 ; iNest <= iArrTok ; ++iNest ){` |
|    5922555 | 1668 | `					 apNode[iNest] = 0;` |
|    2961280 | 1669 | `				 }` |
|    1408251 | 1670 | `			 }else{` |
|          - | 1671 | `				 /* Member access operators [i.e: '->','::'] */` |
|    4882619 | 1672 | `				  iRight = iCur + 1;` |
|    4886437 | 1673 | `				 while( iRight < nToken && apNode[iRight] == 0 ){` |
|       3823 | 1674 | `					 iRight++;` |
|          5 | 1675 | `				 }` |
|    4882619 | 1676 | `				 if( iRight >= nToken \|\| iLeft < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|          - | 1677 | `					 /* Syntax error */` |
...
|    4882615 | 1685 | `				 pNode->pLeft = apNode[iLeft];` |
|    4882610 | 1686 | `				 if( (pNode->pOp->iOp == EXPR_OP_ARROW /*'->'*/ \|\| pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW /*'?->'*/)` |
|    4703003 | 1687 | `					 && pNode->pLeft->pOp == 0 &&` |
|    4446611 | 1688 | `					 pNode->pLeft->xCode != PH7_CompileVariable &&` |
...
|        ! 0 | 1700 | `						 return rc;` |
|          - | 1701 | `				 }` |
|    4882615 | 1702 | `				 pNode->pRight = apNode[iRight];` |
|    4882615 | 1703 | `				 apNode[iLeft] = apNode[iRight] = 0;` |
|          - | 1704 | `			 }` |
|    6864523 | 1705 | `		 }` |
|   50731447 | 1706 | `		 iLeft = iCur;` |
|   25365726 | 1707 | `	 }` |
|          - | 1708 | `	 /* Handle left associative (new, clone) operators */` |
|  103474339 | 1709 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|   89803677 | 1710 | `		 if( apNode[iCur] == 0 ){` |
|   53604785 | 1711 | `			 continue;` |
|          - | 1712 | `		 }` |
|   36198897 | 1713 | `		 pNode = apNode[iCur];` |
|   36198897 | 1714 | `		 if( pNode->pOp && pNode->pOp->iPrec == 1 && pNode->pLeft == 0 ){` |
|          - | 1715 | `			 SyToken *pToken;` |
...
|   13670667 | 1795 | `	 iLeft = -1;` |
|  103631025 | 1796 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|   89803677 | 1797 | `		 if( apNode[iCur] == 0 ){` |
|   53604785 | 1798 | `			 continue;` |
|          - | 1799 | `		 }` |
|   36198897 | 1800 | `		 pNode = apNode[iCur];` |
|   36198897 | 1801 | `		 if( pNode->pOp && pNode->pOp->iPrec == 3 && pNode->pLeft == 0){` |
...
|      86003 | 1807 | `			 }` |
|     250329 | 1808 | `		  }` |
|   36355583 | 1809 | `		 iLeft = iCur;` |
|   18256137 | 1810 | `	  }` |
|   13827353 | 1811 | `	 iLeft = -1;` |
|  103631025 | 1812 | `	 for( iCur = nToken -  1 ; iCur >= 0 ; iCur-- ){` |
|   89803677 | 1813 | `		 if( apNode[iCur] == 0 ){` |
|   53776791 | 1814 | `			 continue;` |
|          - | 1815 | `		 }` |
|   36026891 | 1816 | `		 pNode = apNode[iCur];` |
|   36026891 | 1817 | `		 if( pNode->pOp && pNode->pOp->iPrec == 3 && pNode->pLeft == 0){` |
...
|       7640 | 1832 | `		  }` |
|   36026891 | 1833 | `		 iLeft = iCur;` |
|   18013448 | 1834 | `	 }` |
|          - | 1835 | `	 /* Handle right associative unary and cast operators [i.e: !,(string),~...]  with precedence 4*/` |
|   13827353 | 1836 | `	  iLeft = 0;` |
|  103631019 | 1837 | `	  for( iCur = nToken -  1 ; iCur >= 0 ; iCur-- ){` |
|   89803673 | 1838 | `		  if( apNode[iCur] ){` |
|   36011607 | 1839 | `			  pNode = apNode[iCur];` |
|   36011607 | 1840 | `			  if( pNode->pOp && pNode->pOp->iPrec == 4 && pNode->pLeft == 0){` |
|    1073071 | 1841 | `				  if( iLeft > 0 ){` |
|          - | 1842 | `					  /* Link the node to the tree */` |
|    1073069 | 1843 | `					  pNode->pLeft = apNode[iLeft];` |
|    1073069 | 1844 | `					  apNode[iLeft] = 0;` |
|    1073069 | 1845 | `					  if( pNode->pLeft && pNode->pLeft->pOp && pNode->pLeft->pOp->iPrec > 4 ){` |
...
|  103631017 | 1872 | `	 for( iCur = nToken - 1 ; iCur >= 0 ; --iCur ){` |
|   89803671 | 1873 | `		 if( apNode[iCur] == 0 ){` |
|   54865249 | 1874 | `			 continue;` |
|          - | 1875 | `		 }` |
|   34938427 | 1876 | `		 pNode = apNode[iCur];` |
|   34938427 | 1877 | `		 if( pNode->pOp && pNode->pOp->iPrec == 5 && pNode->pLeft == 0 ){` |
|          - | 1878 | `			 sxi32 iL, iR;` |
...
|  152100725 | 1940 | `	 for( i = 7 ; i < 17 ; i++ ){` |
|  138273389 | 1941 | `		 iLeft = -1;` |
| 1036309755 | 1942 | `		 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  898036381 | 1943 | `			 if( apNode[iCur] == 0 ){` |
|  611471751 | 1944 | `				 continue;` |
|          - | 1945 | `			 }` |
|  286564635 | 1946 | `			 pNode = apNode[iCur];` |
|  286564635 | 1947 | `			 if( pNode->pOp && pNode->pOp->iPrec == i && pNode->pLeft == 0 ){` |
|          - | 1948 | `				 /* Get the right node */` |
|    5079909 | 1949 | `				 iRight = iCur + 1;` |
|    7641733 | 1950 | `				 while( iRight < nToken && apNode[iRight] == 0 ){` |
|    2561829 | 1951 | `					 iRight++;` |
|          5 | 1952 | `				 }` |
|    5079909 | 1953 | `				 if( iRight >= nToken \|\| iLeft < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|          - | 1954 | `					 /* Syntax error */` |
...
|         11 | 1959 | `					 return rc;` |
|          - | 1960 | `				 }` |
|    5079901 | 1961 | `				 if( pNode->pOp->iOp == EXPR_OP_REF ){` |
|          - | 1962 | `					 sxi32  iTmp;` |
...
|    5079899 | 2003 | `				 pNode->pLeft = apNode[iLeft];` |
|    5079899 | 2004 | `				 pNode->pRight = apNode[iRight];` |
|    5079899 | 2005 | `				 apNode[iLeft] = apNode[iRight] = 0;` |
|    2539947 | 2006 | `			 }` |
|  286564625 | 2007 | `			 iLeft = iCur;` |
|  143282315 | 2008 | `		 }` |
|   69136692 | 2009 | `	 }` |
...
|          - | 2013 | `	  */` |
|   13827341 | 2014 | `	  iLeft = -1;` |
|  100094455 | 2015 | `	  for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|   86697375 | 2016 | `		  if( apNode[iCur] == 0 ){` |
|   63205795 | 2017 | `			  continue;` |
|          - | 2018 | `		  }` |
|   23491585 | 2019 | `		  pNode = apNode[iCur];` |
|   23491585 | 2020 | `		  if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_QUESTY && pNode->pLeft == 0 ){` |
|     430261 | 2021 | `			  sxi32 iNest = 1;` |
|     430261 | 2022 | `			  if( iLeft < 0 \|\| !NODE_ISTERM(iLeft) ){` |
...
|     430259 | 2031 | `			  iRight = iCur + 1;` |
|    1771883 | 2032 | `			  while( iRight < nToken  ){` |
|    1771883 | 2033 | `				  if( apNode[iRight] ){` |
|     856633 | 2034 | `					  if( apNode[iRight]->pOp && apNode[iRight]->pOp->iOp == EXPR_OP_QUESTY && apNode[iRight]->pCond == 0){` |
|          - | 2035 | `						  /* Increment nesting level */` |
|        ! 0 | 2036 | `						  ++iNest;` |
|     856633 | 2037 | `					  }else if( apNode[iRight]->pStart->nType & PH7_TK_COLON /*:*/ ){` |
|          - | 2038 | `						  /* Decrement nesting level */` |
|     430259 | 2039 | `						  --iNest;` |
|     430259 | 2040 | `						  if( iNest <= 0 ){` |
|     430259 | 2041 | `							  break;` |
|          - | 2042 | `						  }` |
|        ! 0 | 2043 | `					  }` |
|     213187 | 2044 | `				  }` |
|    1341629 | 2045 | `				  iRight++;` |
|          5 | 2046 | `			  }` |
|     430259 | 2047 | `			  if( iRight > iCur + 1 ){` |
|          - | 2048 | `				  /* Recurse and process the then expression */` |
|     426379 | 2049 | `				  rc = ExprMakeTree(&(*pGen),&apNode[iCur + 1],iRight - iCur - 1);` |
|     426379 | 2050 | `				  if( rc != SXRET_OK ){` |
|        ! 0 | 2051 | `					  return rc;` |
|          - | 2052 | `				  }` |
|          - | 2053 | `				  /* Link the node to the tree */` |
|     426379 | 2054 | `				  pNode->pLeft = apNode[iCur + 1];` |
|     213187 | 2055 | `			  }else{` |
|          - | 2056 | `				  /* Elvis operator (?:): pLeft stays NULL.` |
|          - | 2057 | `				   * NODE_ISTERM() recognizes this node as complete via pCond. */` |
|          - | 2058 | `			  }` |
|     430259 | 2059 | `			  apNode[iCur + 1] = 0;` |
|     430259 | 2060 | `			  if( iRight + 1 < nToken ){` |
|          - | 2061 | `				  /* Recurse and process the else expression */` |
|     430259 | 2062 | `				  rc = ExprMakeTree(&(*pGen),&apNode[iRight + 1],nToken - iRight - 1);` |
|     430259 | 2063 | `				  if( rc != SXRET_OK ){` |
|        ! 0 | 2064 | `					  return rc;` |
|          - | 2065 | `				  }` |
|          - | 2066 | `				  /* Link the node to the tree */` |
|     430259 | 2067 | `				  pNode->pRight = apNode[iRight + 1];` |
|     430259 | 2068 | `				  apNode[iRight + 1] =  apNode[iRight] = 0;` |
|     215132 | 2069 | `			  }else{` |
...
|     430259 | 2077 | `			  pNode->pCond  = apNode[iLeft];` |
|     430259 | 2078 | `			  apNode[iLeft] = 0;` |
|     430259 | 2079 | `			  break;` |
|          - | 2080 | `		  }` |
|   23061329 | 2081 | `		  iLeft = iCur;` |
|   11530667 | 2082 | `	  }` |
...
|          - | 2086 | `	  */` |
|   13827339 | 2087 | `	 iRight = -1;` |
|  103630821 | 2088 | `	 for( iCur = nToken -  1 ; iCur >= 0 ; iCur--){` |
|   89803541 | 2089 | `		 if( apNode[iCur] == 0 ){` |
|   71359175 | 2090 | `			 continue;` |
|          - | 2091 | `		 }` |
|   18444371 | 2092 | `		 pNode = apNode[iCur];` |
|   18444371 | 2093 | `		 if( pNode->pOp && pNode->pOp->iPrec == 18 && pNode->pLeft == 0 ){` |
|          - | 2094 | `			 /* Get the left node */` |
|    4616959 | 2095 | `			 iLeft = iCur - 1;` |
|    6319269 | 2096 | `			 while( iLeft >= 0 && apNode[iLeft] == 0 ){` |
|    1702315 | 2097 | `				 iLeft--;` |
|          5 | 2098 | `			 }` |
|    4616959 | 2099 | `			 if( iLeft < 0 \|\| iRight < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|          - | 2100 | `				 /* Syntax error */` |
...
|          - | 2117 | `			  * a write. */` |
|    4616917 | 2118 | `			 if( PH7_ExprContainsNullsafe(apNode[iLeft]) ){` |
...
|    4616909 | 2131 | `			 pSuppress = 0;` |
|    4616904 | 2132 | `			 if( apNode[iLeft]->pOp` |
|    2949643 | 2133 | `				 && apNode[iLeft]->pOp->iVmOp == PH7_OP_ERR_CTRL` |
|     641191 | 2134 | `				 && apNode[iLeft]->pLeft != 0` |
|          5 | 2135 | `				 && (apNode[iLeft]->iFlags & EXPR_NODE_PARENS) == 0 ){` |
|        ! 0 | 2136 | `				 pSuppress = apNode[iLeft];` |
|        ! 0 | 2137 | `				 apNode[iLeft] = pSuppress->pLeft;` |
|        ! 0 | 2138 | `			 }` |
|    4616909 | 2139 | `			 if( ExprIsModifiableValue(apNode[iLeft],FALSE) == FALSE ){` |
...
|    4616905 | 2158 | `			 pNode->pLeft = apNode[iRight];` |
|    4616905 | 2159 | `			 pNode->pRight = apNode[iLeft];` |
|    4616905 | 2160 | `			 apNode[iLeft] = apNode[iRight] = 0;` |
|    4616905 | 2161 | `			 if( pSuppress ){` |
|          - | 2162 | `				 /* Re-wrap: the '@' now suppresses the whole assignment */` |
|        ! 0 | 2163 | `				 pSuppress->pLeft = pNode;` |
|        ! 0 | 2164 | `				 apNode[iCur] = pSuppress;` |
|        ! 0 | 2165 | `			 }` |
|    2308450 | 2166 | `		 }` |
|   18444317 | 2167 | `		 iRight = iCur;` |
|    9222161 | 2168 | `	 }` |
|          - | 2169 | `	 /* Process left associative binary operators that have the lowest precedence [i.e: and,or,xor] */` |
|   69136405 | 2170 | `	 for( i = 19 ; i < 23 ; i++ ){` |
|   55309125 | 2171 | `		 iLeft = -1;` |
|  414522997 | 2172 | `		 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  359213877 | 2173 | `			 if( apNode[iCur] == 0 ){` |
|  303904505 | 2174 | `				 continue;` |
|          - | 2175 | `			 }` |
|   55309377 | 2176 | `			 pNode = apNode[iCur];` |
|   55309377 | 2177 | `			 if( pNode->pOp && pNode->pOp->iPrec == i && pNode->pLeft == 0 ){` |
...
|         24 | 2195 | `			 }` |
|   55309377 | 2196 | `			 iLeft = iCur;` |
|   27654691 | 2197 | `		 }` |
|   27654565 | 2198 | `	 }` |
|          - | 2199 | `	 /* Point to the root of the expression tree */` |
|   89803445 | 2200 | `	 for( iCur = 1 ; iCur < nToken ; ++iCur ){` |
|   75976183 | 2201 | `		 if( apNode[iCur] ){` |
|   13257887 | 2202 | `			 if( (apNode[iCur]->pOp \|\| apNode[iCur]->xCode ) && apNode[0] != 0){` |
...
|         23 | 2207 | `				  return rc;` |
|          - | 2208 | `			 }` |
|   13257869 | 2209 | `			 apNode[0] = apNode[iCur];` |
|   13257869 | 2210 | `			 apNode[iCur] = 0;` |
|    6628932 | 2211 | `		 }` |
|   37988085 | 2212 | `	 }` |
|   13827267 | 2213 | `	 return SXRET_OK;` |
|   12491047 | 2214 | ` }` |
|          - | 2215 | ` /*` |
...
|          - | 2220 | `  */` |
|   14481692 | 2221 | `PH7_PRIVATE sxi32 PH7_ExprMakeTree(ph7_gen_state *pGen,SySet *pExprNode,ph7_expr_node **ppRoot)` |
|          5 | 2222 | `{` |
|          - | 2223 | `	ph7_expr_node **apNode;` |
|          - | 2224 | `	ph7_expr_node *pNode;` |
|          - | 2225 | `	sxi32 rc;` |
|          - | 2226 | `	/* Reset node container */` |
|   14481697 | 2227 | `	SySetReset(pExprNode);` |
|   14481697 | 2228 | `	pNode = 0; /* Prevent compiler warning */` |
|          - | 2229 | `	/* Extract nodes one after one until we hit the end of the input */` |
|          - | 2230 | `	{` |
|   14481697 | 2231 | `		int iLastWasTerm = 0;` |
|   14481697 | 2232 | `		int bAfterMemberOp = 0; /* TRUE iff the previous node was -> / ?-> / :: */` |
|   91650385 | 2233 | `		while( pGen->pIn < pGen->pEnd ){` |
|   77168727 | 2234 | `			rc = ExprExtractNode(&(*pGen),&pNode,iLastWasTerm,bAfterMemberOp);` |
|   77168727 | 2235 | `			if( rc != SXRET_OK ){` |
|         38 | 2236 | `				return rc;` |
|          - | 2237 | `			}` |
|          - | 2238 | `			/* Determine if this node is a term for short-array disambiguation */` |
|   77168693 | 2239 | `			if( pNode->xCode ){` |
|          - | 2240 | `				/* Node with compile handler: variable, literal, string, array, etc. */` |
|   39152105 | 2241 | `				iLastWasTerm = 1;` |
|   57592643 | 2242 | `			}else if( pNode->pOp ){` |
|          - | 2243 | `				/* Operator node */` |
|   21889563 | 2244 | `				iLastWasTerm = 0;` |
|   10944784 | 2245 | `			}else{` |
|          - | 2246 | `				/* Delimiter: ')' and ']' end terms */` |
|   16127035 | 2247 | `				iLastWasTerm = (pNode->pStart->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB)) ? 1 : 0;` |
|          - | 2248 | `			}` |
...
|   77168693 | 2252 | `			bAfterMemberOp = ( pNode->pOp && pNode->pOp->iVmOp == PH7_OP_MEMBER );` |
|          - | 2253 | `			/* Save the extracted node */` |
|   77168693 | 2254 | `			SySetPut(pExprNode,(const void *)&pNode);` |
|          5 | 2255 | `		}` |
|          - | 2256 | `	}` |
|   14481663 | 2257 | `	if( SySetUsed(pExprNode) < 1 ){` |
|          - | 2258 | `		/* Empty expression [i.e: A semi-colon;] */` |
|        ! 0 | 2259 | `		*ppRoot = 0;` |
|        ! 0 | 2260 | `		return SXRET_OK;` |
|          - | 2261 | `	}` |
|   14481663 | 2262 | `	apNode = (ph7_expr_node **)SySetBasePtr(pExprNode);` |
|          - | 2263 | `	/* Make sure we are dealing with valid nodes */` |
|   14481663 | 2264 | `	rc = ExprVerifyNodes(&(*pGen),apNode,(sxi32)SySetUsed(pExprNode));` |
|   14481663 | 2265 | `	if( rc != SXRET_OK ){` |
...
|          - | 2271 | `	}` |
|          - | 2272 | `	/* Build the tree */` |
|   14481611 | 2273 | `	rc = ExprMakeTree(&(*pGen),apNode,(sxi32)SySetUsed(pExprNode));` |
|   14481611 | 2274 | `	if( rc != SXRET_OK ){` |
|          - | 2275 | `		/* Something goes wrong [i.e: Syntax error] */` |
|        103 | 2276 | `		*ppRoot = 0;` |
|        103 | 2277 | `		return rc;` |
|          - | 2278 | `	}` |
|          - | 2279 | `	/* Point to the root of the tree */` |
|   14481513 | 2280 | `	*ppRoot = apNode[0];` |
|   14481513 | 2281 | `	return SXRET_OK;` |
|    7240851 | 2282 | `}` |
|          - | 2283 |  |
