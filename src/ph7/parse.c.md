...
|        - |  267 | ` */` |
|  1067074 |  268 | `PH7_PRIVATE const ph7_expr_op *  PH7_ExprExtractOperator(SyString *pStr,SyToken *pLast)` |
|        5 |  269 |  |
|  1067079 |  270 | `	sxu32 n = 0;` |
|        - |  271 | `	sxi32 rc;` |
|        - |  272 | `	/* Do a linear lookup on the operators table */` |
| 17916943 |  273 | `	for(;;){` |
| 35833891 |  274 | `		if( n >= SX_ARRAYSIZE(aOpTable) ){` |
|      ! 0 |  275 | `			break;` |
|        - |  276 | `		}` |
| 35833891 |  277 | `		if( SyisAlpha(aOpTable[n].sOp.zString[0]) ){` |
|        - |  278 | `			/* TICKET 1433-012: Alpha stream operators [i.e: and,or,xor,new...] */` |
|  4209229 |  279 | `			rc = SyStringCmp(pStr,&aOpTable[n].sOp,SyStrnicmp);` |
|  2104617 |  280 | `		}else{` |
| 31624667 |  281 | `			rc = SyStringCmp(pStr,&aOpTable[n].sOp,SyMemcmp);` |
|        - |  282 | `		}` |
| 35833891 |  283 | `		if( rc == 0 ){` |
|  1071203 |  284 | `			if( aOpTable[n].sOp.nByte != sizeof(char) \|\| (aOpTable[n].iOp != EXPR_OP_UMINUS && aOpTable[n].iOp != EXPR_OP_UPLUS) \|\| pLast == 0 ){` |
|        - |  285 | `				/* There is no ambiguity here,simply return the first operator seen */` |
|  1066683 |  286 | `				return &aOpTable[n];` |
|        - |  287 | `			}` |
|        - |  288 | `			/* Handle ambiguity */` |
|     4525 |  289 | `			if( pLast->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*'['*/\|PH7_TK_COLON/*:*/\|PH7_TK_COMMA/*,'*/) ){` |
|        - |  290 | `				/* Unary opertors have prcedence here over binary operators */` |
|      269 |  291 | `				return &aOpTable[n];` |
|        - |  292 | `			}` |
|     4261 |  293 | `			if( pLast->nType & PH7_TK_OP ){` |
...
|        4 |  301 | `			}` |
|     2062 |  302 | `		}` |
| 34766817 |  303 | `		++n; /* Next operator in the table */` |
|        5 |  304 | `	}` |
...
|        - |  312 | ` */` |
|   654988 |  313 | `PH7_PRIVATE void PH7_DelimitNestedTokens(SyToken *pIn,SyToken *pEnd,sxu32 nTokStart,sxu32 nTokEnd,SyToken **ppEnd)` |
|        5 |  314 |  |
|   654993 |  315 | `	SyToken *pCur = pIn;` |
|   654993 |  316 | `	sxi32 iNest = 1;` |
|  3533063 |  317 | `	for(;;){` |
|  7066131 |  318 | `		if( pCur >= pEnd ){` |
|      273 |  319 | `			break;` |
|        - |  320 | `		}` |
|  7065863 |  321 | `		if( pCur->nType & nTokStart ){` |
|        - |  322 | `			/* Increment nesting level */` |
|   348477 |  323 | `			iNest++;` |
|  6891627 |  324 | `		}else if( pCur->nType & nTokEnd ){` |
|        - |  325 | `			/* Decrement nesting level */` |
|  1003197 |  326 | `			iNest--;` |
|  1003197 |  327 | `			if( iNest <= 0 ){` |
|   654725 |  328 | `				break;` |
|        - |  329 | `			}` |
|   174236 |  330 | `		}` |
|        - |  331 | `		/* Advance cursor */` |
...
|        - |  345 | ` */` |
|    21382 |  346 | `PH7_PRIVATE int PH7_IsLangConstruct(sxu32 nKeyID,sxu8 bCheckFunc)` |
|        5 |  347 |  |
|    21382 |  348 | `	if( nKeyID == PH7_TKWRD_ECHO \|\| nKeyID == PH7_TKWRD_PRINT \|\| nKeyID == PH7_TKWRD_INCLUDE` |
|    21286 |  349 | `		\|\| nKeyID == PH7_TKWRD_INCONCE \|\| nKeyID == PH7_TKWRD_REQUIRE \|\| nKeyID == PH7_TKWRD_REQONCE` |
|        - |  350 | `		){` |
|      165 |  351 | `			return TRUE;` |
|        - |  352 | `	}` |
|    21227 |  353 | `	if( bCheckFunc ){` |
|      176 |  354 | `		if(  nKeyID == PH7_TKWRD_ISSET \|\| nKeyID == PH7_TKWRD_UNSET \|\| nKeyID == PH7_TKWRD_EVAL` |
...
|        - |  368 | ` */` |
|   902080 |  369 | `static sxi32 ExprVerifyNodes(ph7_gen_state *pGen,ph7_expr_node **apNode,sxi32 nNode)` |
|        5 |  370 |  |
|        - |  371 | `	sxi32 iParen,iSquare,iQuesty,iBraces;` |
|        - |  372 | `	sxi32 i,rc;` |
|        - |  373 |  |
|   902085 |  374 | `	if( nNode > 0 && apNode[0]->pOp && (apNode[0]->pOp->iOp == EXPR_OP_ADD \|\| apNode[0]->pOp->iOp == EXPR_OP_SUB) ){` |
...
|       15 |  378 | `	}` |
|   902085 |  379 | `	iParen = iSquare = iQuesty = iBraces = 0;` |
|  4855763 |  380 | `	for( i = 0 ; i < nNode ; ++i ){` |
|  3953717 |  381 | `		if( apNode[i]->xCode == PH7_CompileShortArray \|\| apNode[i]->xCode == PH7_CompileShortList ){` |
|        - |  382 | `			/* Short array/list literal: brackets are self-contained, skip */` |
|     1005 |  383 | `			continue;` |
|        - |  384 | `		}` |
|  3952717 |  385 | `		if( apNode[i]->pStart->nType & PH7_TK_LPAREN /*'('*/){` |
|   433617 |  386 | `			if( i > 0 && ( apNode[i-1]->xCode == PH7_CompileVariable \|\| apNode[i-1]->xCode == PH7_CompileLiteral \|\|` |
|    21630 |  387 | `				(apNode[i - 1]->pStart->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_SSTR\|PH7_TK_DSTR\|PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}'*/))) ){` |
|        - |  388 | `					/* Ticket 1433-033: Take care to ignore alpha-stream [i.e: or,xor] operators followed by an opening parenthesis */` |
|   404543 |  389 | `					if( (apNode[i - 1]->pStart->nType & PH7_TK_OP) == 0 ){` |
|        - |  390 | `						/* We are dealing with a postfix [i.e: function call]  operator` |
|        - |  391 | `						 * not a simple left parenthesis. Mark the node.` |
|        - |  392 | `						 */` |
|   404543 |  393 | `						apNode[i]->pStart->nType \|= PH7_TK_OP;` |
|   404543 |  394 | `						apNode[i]->pStart->pUserData = (void *)&sFCallOp; /* Function call operator */` |
|   404543 |  395 | `						apNode[i]->pOp = &sFCallOp;` |
|   202269 |  396 | `					}` |
|   202269 |  397 | `			}` |
|   433617 |  398 | `			iParen++;` |
|  3735911 |  399 | `		}else if( apNode[i]->pStart->nType & PH7_TK_RPAREN/*')*/){` |
|   433617 |  400 | `			if( iParen <= 0 ){` |
...
|        - |  406 | `			}` |
|   433605 |  407 | `			iParen--;` |
|  3302293 |  408 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OSB /*'['*/){` |
|    87731 |  409 | `			iSquare++;` |
|  3041630 |  410 | `		}else if (apNode[i]->pStart->nType & PH7_TK_CSB /*']'*/){` |
|    87745 |  411 | `			if( iSquare <= 0 ){` |
...
|        - |  417 | `			}` |
|    87739 |  418 | `			iSquare--;` |
|  2953894 |  419 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OCB /*'{'*/){` |
|       16 |  420 | `			iBraces++;` |
...
|        - |  464 |  |
|        7 |  465 | `			}` |
|  2910020 |  466 | `		}else if (apNode[i]->pStart->nType & PH7_TK_CCB /*'}'*/){` |
|       21 |  467 | `			if( iBraces <= 0 ){` |
...
|        - |  473 | `			}` |
|        6 |  474 | `			iBraces--;` |
|  2909999 |  475 | `		}else if ( apNode[i]->pStart->nType & PH7_TK_COLON ){` |
|     2825 |  476 | `			if( iQuesty > 0 ){` |
|     2635 |  477 | `				iQuesty--;` |
|     1510 |  478 | `			}else if( iParen <= 0 ){` |
...
|        6 |  486 | `				return rc;` |
|        5 |  487 | `			}` |
|  2908585 |  488 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OP ){` |
|   830353 |  489 | `			const ph7_expr_op *pOp = (const ph7_expr_op *)apNode[i]->pOp;` |
|   830353 |  490 | `			if( pOp->iOp == EXPR_OP_QUESTY ){` |
|     2637 |  491 | `				iQuesty++;` |
|   829037 |  492 | `			}else if( i > 0 && (pOp->iOp == EXPR_OP_UMINUS \|\| pOp->iOp == EXPR_OP_UPLUS)){` |
...
|   415174 |  512 | `		}` |
|  1976344 |  513 | `	}` |
|   902051 |  514 | `	if( iParen != 0 \|\| iSquare != 0 \|\| iQuesty != 0 \|\| iBraces != 0){` |
...
|       19 |  519 | `		return rc;` |
|        - |  520 | `	}` |
|   902035 |  521 | `	return SXRET_OK;` |
|   451045 |  522 |  |
|        - |  523 | `/*` |
|        - |  524 | ` * Collect and assemble tokens holding a namespace path [i.e: namespace\to\const]` |
|        - |  525 | ` * or a simple literal [i.e: PHP_EOL].` |
|        - |  526 | ` */` |
|   751228 |  527 | `static void ExprAssembleLiteral(SyToken **ppCur,SyToken *pEnd)` |
|        5 |  528 |  |
|   751233 |  529 | `	SyToken *pIn = *ppCur;` |
|        - |  530 | `	/* Jump the first literal seen */` |
|   751233 |  531 | `	if( (pIn->nType & PH7_TK_NSSEP) == 0 ){` |
|   751193 |  532 | `		pIn++;` |
|   375594 |  533 | `	}` |
|   375658 |  534 | `	for(;;){` |
|   751321 |  535 | `		if(pIn < pEnd && (pIn->nType & PH7_TK_NSSEP) ){` |
|       92 |  536 | `			pIn++;` |
...
|        - |  876 | ` */` |
|  3953944 |  877 | `static sxi32 ExprExtractNode(ph7_gen_state *pGen,ph7_expr_node **ppNode,int iLastWasTerm)` |
|        5 |  878 |  |
|        - |  879 | `	ph7_expr_node *pNode;` |
|        - |  880 | `	SyToken *pCur;` |
|        - |  881 | `	sxi32 rc;` |
|        - |  882 | `	/* Allocate a new node */` |
|  3953949 |  883 | `	pNode = (ph7_expr_node *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_expr_node));` |
|  3953949 |  884 | `	if( pNode == 0 ){` |
...
|  3953949 |  891 | `	SyZero(pNode,sizeof(ph7_expr_node));` |
|  3953949 |  892 | `	SySetInit(&pNode->aNodeArgs,&pGen->pVm->sAllocator,sizeof(ph7_expr_node **));` |
|        - |  893 | `	/* Point to the head of the token stream */` |
|  3953949 |  894 | `	pCur = pNode->pStart = pGen->pIn;` |
|        - |  895 | `	/* Start collecting tokens */` |
|  3953949 |  896 | `	if( pCur->nType & PH7_TK_ELLIPSIS ){` |
...
|       85 |  906 | `		return rc;` |
|        - |  907 | `	}` |
|  3953867 |  908 | `	if( (pCur->nType & PH7_TK_OSB) && !iLastWasTerm ){` |
|        - |  909 | `		/* PHP 5.4 short array syntax: [1, 2, 3] or ['key' => 'value'].` |
|        - |  910 | `		 * This '[' does not follow a term, so it is an array literal, not subscript.` |
|        - |  911 | `		 */` |
|     1007 |  912 | `		pCur++; /* Skip the opening '[' */` |
|     1007 |  913 | `		PH7_DelimitNestedTokens(pCur,pGen->pEnd,PH7_TK_OSB,PH7_TK_CSB,&pCur);` |
|     1007 |  914 | `		if( pCur < pGen->pEnd ){` |
|     1007 |  915 | `			pCur++; /* Skip past the closing ']' */` |
|      506 |  916 | `		}else{` |
...
|        - |  927 | `		 */` |
|     1075 |  928 | `		if( pCur < pGen->pEnd && (pCur->nType & PH7_TK_OP) ){` |
...
|        - |  934 | `			}` |
|       71 |  935 | `		}else{` |
|      871 |  936 | `			pNode->xCode = PH7_CompileShortArray;` |
|        5 |  937 | `		}` |
|  3953366 |  938 | `	}else if( pCur->nType & PH7_TK_OP ){` |
|        - |  939 | `		/* Point to the instance that describe this operator */` |
|   918113 |  940 | `		pNode->pOp = (const ph7_expr_op *)pCur->pUserData;` |
|        - |  941 | `		/* Advance the stream cursor */` |
|   918113 |  942 | `		pCur++;` |
|  3493811 |  943 | `	}else if( pCur->nType & PH7_TK_DOLLAR ){` |
|        - |  944 | `		/* Isolate variable */` |
|  2133561 |  945 | `		while( pCur < pGen->pEnd && (pCur->nType & PH7_TK_DOLLAR) ){` |
|  1066789 |  946 | `			pCur++; /* Variable variable */` |
|        5 |  947 | `		}` |
|  1066777 |  948 | `		if( pCur < pGen->pEnd ){` |
|  1066777 |  949 | `			if (pCur->nType & (PH7_TK_ID\|PH7_TK_KEYWORD) ){` |
|        - |  950 | `				/* Variable name */` |
|  1066749 |  951 | `				pCur++;` |
|   533405 |  952 | `			}else if( pCur->nType & PH7_TK_OCB /* '{' */ ){` |
|       24 |  953 | `				pCur++;` |
...
|        8 |  966 | `			}` |
|   533384 |  967 | `		}` |
|  1066773 |  968 | `		pNode->xCode = PH7_CompileVariable;` |
|  2501369 |  969 | `	 }else if( pCur->nType & PH7_TK_KEYWORD ){` |
|    50897 |  970 | `		 sxu32 nKeyword = (sxu32)SX_PTR_TO_INT(pCur->pUserData);` |
|    50897 |  971 | `		 if( nKeyword == PH7_TKWRD_ARRAY \|\|  nKeyword == PH7_TKWRD_LIST ){` |
|        - |  972 | `			 /* List/Array node */` |
|    29107 |  973 | `			 if( &pCur[1] >= pGen->pEnd \|\| (pCur[1].nType & PH7_TK_LPAREN) == 0 ){` |
...
|    29091 |  980 | `				 PH7_DelimitNestedTokens(pCur,pGen->pEnd,PH7_TK_LPAREN /* '(' */, PH7_TK_RPAREN /* ')' */,&pCur);` |
|    29091 |  981 | `				 if( pCur < pGen->pEnd ){` |
|    29089 |  982 | `					 pCur++;` |
|    14547 |  983 | `				 }else{` |
|        - |  984 | `					 /* Syntax error */` |
...
|        3 |  991 | `					 return rc;` |
|        - |  992 | `				 }` |
|    29089 |  993 | `				 pNode->xCode = (nKeyword == PH7_TKWRD_LIST) ? PH7_CompileList : PH7_CompileArray;` |
|    29089 |  994 | `				 if( pNode->xCode == PH7_CompileList ){` |
...
|       13 | 1005 | `				 }` |
|        5 | 1006 | `			 }` |
|    36344 | 1007 | `		 }else if( nKeyword == PH7_TKWRD_YIELD ){` |
...
|    21730 | 1014 | `		 }else if( nKeyword == PH7_TKWRD_FUNCTION ){` |
...
|        - | 1028 | `			  }` |
|    21514 | 1029 | `		 }else if( nKeyword == PH7_TKWRD_CLASS && &pCur[1] < pGen->pEnd` |
...
|    21373 | 1044 | `		 }else if( nKeyword == PH7_TKWRD_FN` |
|    21309 | 1045 | `			\|\| ( nKeyword == PH7_TKWRD_STATIC && &pCur[1] < pGen->pEnd` |
...
|    21307 | 1055 | `		 }else if( nKeyword == PH7_TKWRD_MATCH ){` |
...
|    21212 | 1063 | `		 }else if( nKeyword == PH7_TKWRD_THROW ){` |
...
|    21159 | 1072 | `		 }else if( PH7_IsLangConstruct(nKeyword,FALSE) == TRUE && &pCur[1] < pGen->pEnd ){` |
...
|    21055 | 1078 | `			 ExprAssembleLiteral(&pCur,pGen->pEnd);` |
|    21055 | 1079 | `			 pNode->xCode = PH7_CompileLiteral;` |
|        5 | 1080 | `		 }` |
|  1942525 | 1081 | `	 }else if( pCur->nType & (PH7_TK_NSSEP\|PH7_TK_ID) ){` |
|        - | 1082 | `		 /* Constants,function name,namespace path,class name... */` |
|   730167 | 1083 | `		 ExprAssembleLiteral(&pCur,pGen->pEnd);` |
|   730167 | 1084 | `		 pNode->xCode = PH7_CompileLiteral;` |
|   365086 | 1085 | `	 }else{` |
|  1186931 | 1086 | `		 if( (pCur->nType & (PH7_TK_LPAREN\|PH7_TK_RPAREN\|PH7_TK_COMMA\|PH7_TK_COLON\|PH7_TK_CSB\|PH7_TK_OCB\|PH7_TK_CCB)) == 0 ){` |
|        - | 1087 | `			 /* Point to the code generator routine */` |
|   229095 | 1088 | `			 pNode->xCode = PH7_GetNodeHandler(pCur->nType);` |
|   229095 | 1089 | `			 if( pNode->xCode == 0 ){` |
...
|  3953833 | 1102 | `	pNode->pEnd = pCur;` |
|        - | 1103 | `	/* Save the node for later processing */` |
|  3953833 | 1104 | `	*ppNode = pNode;` |
|        - | 1105 | `	/* Synchronize cursors */` |
|  3953833 | 1106 | `	pGen->pIn = pCur;` |
|  3953833 | 1107 | `	return SXRET_OK;` |
|  1976977 | 1108 |  |
|        - | 1109 | `/*` |
...
|        - | 1112 | ` * level is zero.` |
|        - | 1113 | ` */` |
|    90272 | 1114 | `PH7_PRIVATE sxi32 PH7_GetNextExpr(SyToken *pStart,SyToken *pEnd,SyToken **ppNext)` |
|        5 | 1115 |  |
|    90277 | 1116 | `	SyToken *pCur = pStart;` |
|    90277 | 1117 | `	sxi32 iNest = 0;` |
|    90277 | 1118 | `	if( pCur >= pEnd \|\| (pCur->nType & PH7_TK_SEMI/*';'*/) ){` |
|        - | 1119 | `		/* Last expression */` |
|    47251 | 1120 | `		return SXERR_EOF;` |
|        - | 1121 | `	}` |
|   176461 | 1122 | `	while( pCur < pEnd ){` |
|   160741 | 1123 | `		if( (pCur->nType & (PH7_TK_COMMA/*','*/\|PH7_TK_SEMI/*';'*/)) && iNest <= 0){` |
|    27311 | 1124 | `			break;` |
|        - | 1125 | `		}` |
|   133435 | 1126 | `		if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|     8643 | 1127 | `			iNest++;` |
|   129116 | 1128 | `		}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}*/) ){` |
|     8645 | 1129 | `			iNest--;` |
|     4320 | 1130 | `		}` |
|   133435 | 1131 | `		pCur++;` |
|        5 | 1132 | `	}` |
|    43031 | 1133 | `	*ppNext = pCur;` |
|    43031 | 1134 | `	return SXRET_OK;` |
|    45141 | 1135 |  |
|        - | 1136 | `/*` |
|        - | 1137 | ` * Free an expression tree.` |
|        - | 1138 | ` */` |
|  3412546 | 1139 | `static void ExprFreeTree(ph7_gen_state *pGen,ph7_expr_node *pNode)` |
|        5 | 1140 |  |
|  3412551 | 1141 | `	if( pNode->pLeft ){` |
|        - | 1142 | `		/* Release the left tree */` |
|  1276029 | 1143 | `		ExprFreeTree(&(*pGen),pNode->pLeft);` |
|   638012 | 1144 | `	}` |
|  3412551 | 1145 | `	if( pNode->pRight ){` |
|        - | 1146 | `		/* Release the right tree */` |
|   705675 | 1147 | `		ExprFreeTree(&(*pGen),pNode->pRight);` |
|   352835 | 1148 | `	}` |
|  3412551 | 1149 | `	if( pNode->pCond ){` |
|        - | 1150 | `		/* Release the conditional tree used by the ternary operator */` |
|     2633 | 1151 | `		ExprFreeTree(&(*pGen),pNode->pCond);` |
|     1314 | 1152 | `	}` |
|  3412551 | 1153 | `	if( SySetUsed(&pNode->aNodeArgs) > 0 ){` |
|        - | 1154 | `		ph7_expr_node **apArg;` |
|        - | 1155 | `		sxu32 n;` |
|        - | 1156 | `		/* Release node arguments */` |
|   420899 | 1157 | `		apArg = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|   888171 | 1158 | `		for( n = 0 ; n < SySetUsed(&pNode->aNodeArgs) ; ++n ){` |
|   467277 | 1159 | `			ExprFreeTree(&(*pGen),apArg[n]);` |
|   233641 | 1160 | `		}` |
|   420899 | 1161 | `		SySetRelease(&pNode->aNodeArgs);` |
|   210447 | 1162 | `	}` |
|        - | 1163 | `	/* Finally,release this node */` |
|  3412551 | 1164 | `	SyMemBackendPoolFree(&pGen->pVm->sAllocator,pNode);` |
|  3412551 | 1165 |  |
|        - | 1166 | `/*` |
|        - | 1167 | ` * Free an expression tree.` |
|        - | 1168 | ` * This function is a wrapper around ExprFreeTree() defined above.` |
|        - | 1169 | ` */` |
|   902114 | 1170 | `PH7_PRIVATE sxi32 PH7_ExprFreeTree(ph7_gen_state *pGen,SySet *pNodeSet)` |
|        5 | 1171 |  |
|        - | 1172 | `	ph7_expr_node **apNode;` |
|        - | 1173 | `	sxu32 n;` |
|   902119 | 1174 | `	apNode = (ph7_expr_node **)SySetBasePtr(pNodeSet);` |
|  4855947 | 1175 | `	for( n = 0  ; n < SySetUsed(pNodeSet) ; ++n ){` |
|  3953833 | 1176 | `		if( apNode[n] ){` |
|   902453 | 1177 | `			ExprFreeTree(&(*pGen),apNode[n]);` |
|   451224 | 1178 | `		}` |
|  1976919 | 1179 | `	}` |
|   902119 | 1180 | `	return SXRET_OK;` |
|        5 | 1181 |  |
|        - | 1182 | `/*` |
...
|        - | 1188 | ` */` |
|  1261516 | 1189 | `PH7_PRIVATE int PH7_ExprContainsNullsafe(ph7_expr_node *pNode)` |
|        5 | 1190 |  |
|  1261521 | 1191 | `	if( pNode == 0 ){` |
|   776911 | 1192 | `		return 0;` |
|        - | 1193 | `	}` |
|   484615 | 1194 | `	if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW ){` |
|       16 | 1195 | `		return 1;` |
|        - | 1196 | `	}` |
|   484603 | 1197 | `	if( PH7_ExprContainsNullsafe(pNode->pLeft) ){` |
|        6 | 1198 | `		return 1;` |
|        - | 1199 | `	}` |
|   484599 | 1200 | `	if( PH7_ExprContainsNullsafe(pNode->pRight) ){` |
|      ! 0 | 1201 | `		return 1;` |
|        - | 1202 | `	}` |
|   484599 | 1203 | `	return 0;` |
|   630763 | 1204 |  |
|        - | 1205 | `/*` |
|        - | 1206 | ` * Check if the given node is a modifialbe l/r-value.` |
|        - | 1207 | ` * Return TRUE if modifiable.FALSE otherwise.` |
|        - | 1208 | ` */` |
|   285526 | 1209 | `static int ExprIsModifiableValue(ph7_expr_node *pNode,sxu8 bFunc)` |
|        5 | 1210 |  |
|        - | 1211 | `	sxi32 iExprOp;` |
|   285531 | 1212 | `	if( pNode->pOp == 0 ){` |
|   172223 | 1213 | `		return pNode->xCode == PH7_CompileVariable ? TRUE : FALSE;` |
|        - | 1214 | `	}` |
|   113313 | 1215 | `	iExprOp = pNode->pOp->iOp;` |
|   113313 | 1216 | `	if( iExprOp == EXPR_OP_ARROW /*'->' */ \|\| iExprOp == EXPR_OP_DC /*'::'*/ ){` |
|    78787 | 1217 | `			return TRUE;` |
|        - | 1218 | `	}` |
|    34531 | 1219 | `	if( iExprOp == EXPR_OP_SUBSCRIPT/*'[]'*/ ){` |
|    34527 | 1220 | `		if( pNode->pLeft->pOp ) {` |
|       50 | 1221 | `			if( pNode->pLeft->pOp->iOp != EXPR_OP_SUBSCRIPT /*'['*/ && pNode->pLeft->pOp->iOp != EXPR_OP_ARROW /*'->'*/` |
|       24 | 1222 | `				&& pNode->pLeft->pOp->iOp != EXPR_OP_DC /*'::'*/){` |
|      ! 0 | 1223 | `				return FALSE;` |
|        5 | 1224 | `			}` |
|    34502 | 1225 | `		}else if( pNode->pLeft->xCode != PH7_CompileVariable ){` |
|      ! 0 | 1226 | `			return FALSE;` |
|        - | 1227 | `		}` |
|    34527 | 1228 | `		return TRUE;` |
|        - | 1229 | `	}` |
...
|        - | 1246 | ` */` |
|   350290 | 1247 | `static sxi32 ExprProcessFuncArguments(ph7_gen_state *pGen,ph7_expr_node *pOp,ph7_expr_node **apNode,sxi32 nToken)` |
|        5 | 1248 |  |
...
|   350295 | 1252 | `	iCur = 0;` |
|   373467 | 1253 | `	for(;;){` |
|   746939 | 1254 | `		if( iCur >= nToken ){` |
|        - | 1255 | `			/* No more arguments to process */` |
|   350269 | 1256 | `			break;` |
|        - | 1257 | `		}` |
|   396675 | 1258 | `		iNode = iCur;` |
|   396675 | 1259 | `		iNest = 0;` |
|   990709 | 1260 | `		while( iCur < nToken ){` |
|   640443 | 1261 | `			if( apNode[iCur] ){` |
|   626819 | 1262 | `				if( (apNode[iCur]->pStart->nType & PH7_TK_COMMA) && apNode[iCur]->pLeft == 0 && iNest <= 0 ){` |
|    23207 | 1263 | `					break;` |
|   580410 | 1264 | `				}else if( (apNode[iCur]->pStart->nType & (PH7_TK_LPAREN\|PH7_TK_OSB\|PH7_TK_OCB))` |
|   306325 | 1265 | `					&& apNode[iCur]->xCode != PH7_CompileShortArray` |
|    32111 | 1266 | `					&& apNode[iCur]->xCode != PH7_CompileShortList ){` |
...
|    31977 | 1273 | `					iNest++;` |
|   564429 | 1274 | `				}else if( apNode[iCur]->pStart->nType & (PH7_TK_RPAREN\|PH7_TK_CCB\|PH7_TK_CSB) ){` |
|    31977 | 1275 | `					iNest--;` |
|    15986 | 1276 | `				}` |
|   290205 | 1277 | `			}` |
|   594039 | 1278 | `			iCur++;` |
|        5 | 1279 | `		}` |
|   396675 | 1280 | `		if( iCur > iNode ){` |
|   396669 | 1281 | `			SyString sArgName = {0, 0};` |
...
|   396664 | 1285 | `			if( (iCur - iNode) >= 2` |
|   219849 | 1286 | `				&& apNode[iNode]` |
|    43034 | 1287 | `				&& (apNode[iNode]->pStart->nType & (PH7_TK_ID\|PH7_TK_KEYWORD))` |
|    23746 | 1288 | `				&& apNode[iNode]->xCode == PH7_CompileLiteral` |
|     4375 | 1289 | `				&& apNode[iNode+1]` |
|     4297 | 1290 | `				&& (apNode[iNode+1]->pStart->nType & PH7_TK_COLON) ){` |
...
|        - | 1309 | `				}` |
|       92 | 1310 | `			}` |
|   396662 | 1311 | `			if( apNode[iNode] && (apNode[iNode]->pStart->nType & PH7_TK_AMPER /*'&'*/) && ((iCur - iNode) == 2)` |
...
|      ! 0 | 1317 | `			}` |
|   396667 | 1318 | `			ExprMakeTree(&(*pGen),&apNode[iNode],iCur-iNode);` |
|   396667 | 1319 | `			if( apNode[iNode] ){` |
|   396667 | 1320 | `				if( sArgName.nByte > 0 ){` |
...
|   396667 | 1325 | `				SySetPut(&pOp->aNodeArgs,(const void *)&apNode[iNode]);` |
|   198336 | 1326 | `			}else{` |
...
|   396667 | 1345 | `		if( iCur < nToken && apNode[iCur] && (apNode[iCur]->pStart->nType & PH7_TK_COMMA) ){` |
|    46403 | 1346 | `			iCur++;` |
|    46403 | 1347 | `			if( iCur >= nToken ){` |
|        - | 1348 | `				/* Trailing comma after last argument */` |
|       19 | 1349 | `				break;` |
|        - | 1350 | `			}` |
|    23190 | 1351 | `		}` |
|        5 | 1352 | `	}` |
|   350287 | 1353 | `	return SXRET_OK;` |
|   175150 | 1354 |  |
|        - | 1355 | ` /*` |
...
|        - | 1359 | `  */` |
|  1407294 | 1360 | ` static sxi32 ExprMakeTree(ph7_gen_state *pGen,ph7_expr_node **apNode,sxi32 nToken)` |
|        5 | 1361 | ` {` |
|        - | 1362 | `	 sxi32 i,iLeft,iRight;` |
|        - | 1363 | `	 ph7_expr_node *pNode;` |
|        - | 1364 | `	 sxi32 iCur;` |
|        - | 1365 | `	 sxi32 rc;` |
|  1407299 | 1366 | `	 if( nToken <= 0 \|\| (nToken == 1 && apNode[0]->xCode) ){` |
|        - | 1367 | `		 /* TICKET 1433-17: self evaluating node */` |
|   637673 | 1368 | `		 return SXRET_OK;` |
|        - | 1369 | `	 }` |
|        - | 1370 | `	 /* Process expressions enclosed in parenthesis first */` |
|  4726851 | 1371 | `	 for( iCur =  0 ; iCur < nToken ; ++iCur ){` |
|        - | 1372 | `		 sxi32 iNest;` |
...
|        - | 1375 | `		  */` |
|  3957227 | 1376 | `		 if( apNode[iCur] == 0 \|\| apNode[iCur]->pStart->nType != PH7_TK_LPAREN ){` |
|  3928163 | 1377 | `			 continue;` |
|        - | 1378 | `		 }` |
|    29069 | 1379 | `		 iNest = 1;` |
|    29069 | 1380 | `		 iLeft = iCur;` |
|        - | 1381 | `		 /* Find the closing parenthesis */` |
|    29069 | 1382 | `		 iCur++;` |
|   193941 | 1383 | `		 while( iCur < nToken ){` |
|   193941 | 1384 | `			 if( apNode[iCur] ){` |
|   193941 | 1385 | `				 if( apNode[iCur]->pStart->nType & PH7_TK_RPAREN /* ')' */){` |
|        - | 1386 | `					 /* Decrement nesting level */` |
|    50417 | 1387 | `					 iNest--;` |
|    50417 | 1388 | `					 if( iNest <= 0 ){` |
|    29069 | 1389 | `						 break;` |
|        5 | 1390 | `					 }` |
|   154203 | 1391 | `				 }else if( apNode[iCur]->pStart->nType & PH7_TK_LPAREN /* '(' */ ){` |
...
|   164877 | 1396 | `			 iCur++;` |
|        5 | 1397 | `		 }` |
|    29069 | 1398 | `		 if( iCur - iLeft > 1 ){` |
|        - | 1399 | `			 sxi32 j;` |
|        - | 1400 | `			 /* Recurse and process this expression */` |
|    29069 | 1401 | `			 rc = ExprMakeTree(&(*pGen),&apNode[iLeft + 1],iCur - iLeft - 1);` |
|    29069 | 1402 | `			 if( rc != SXRET_OK ){` |
|        3 | 1403 | `				 return rc;` |
|        - | 1404 | `			 }` |
...
|    29067 | 1408 | `			 for( j = iLeft + 1 ; j < iCur ; ++j ){` |
|    29067 | 1409 | `				 if( apNode[j] ){` |
|    29067 | 1410 | `					 apNode[j]->iFlags \|= EXPR_NODE_PARENS;` |
|    29067 | 1411 | `					 break;` |
|        - | 1412 | `				 }` |
|      ! 0 | 1413 | `			 }` |
|    14531 | 1414 | `		 }` |
|        - | 1415 | `		 /* Free the left and right nodes */` |
|    29067 | 1416 | `		 ExprFreeTree(&(*pGen),apNode[iLeft]);` |
|    29067 | 1417 | `		 ExprFreeTree(&(*pGen),apNode[iCur]);` |
|    29067 | 1418 | `		 apNode[iLeft] = 0;` |
|    29067 | 1419 | `		 apNode[iCur] = 0;` |
|    14536 | 1420 | `	 }` |
|        - | 1421 | `	  /* Process expressions enclosed in braces */` |
|  4913293 | 1422 | `	 for( iCur =  0 ; iCur < nToken ; ++iCur ){` |
|        - | 1423 | `		 sxi32 iNest;` |
...
|        - | 1426 | `		  */` |
|  4151145 | 1427 | `		 if( apNode[iCur] == 0 \|\| apNode[iCur]->pStart->nType != PH7_TK_OCB ){` |
|  4151141 | 1428 | `			 continue;` |
|        - | 1429 | `		 }` |
|        6 | 1430 | `		 iNest = 1;` |
|        6 | 1431 | `		 iLeft = iCur;` |
...
|   762153 | 1463 | `	 iLeft = -1;` |
|  4913263 | 1464 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  4151127 | 1465 | `		 if( apNode[iCur] == 0 ){` |
|  1584569 | 1466 | `			 continue;` |
|        - | 1467 | `		 }` |
|  2566563 | 1468 | `		 pNode = apNode[iCur];` |
|  2566563 | 1469 | `		 if( pNode->pOp && pNode->pOp->iPrec == 2 && pNode->pLeft == 0  ){` |
|   678721 | 1470 | `			 if( pNode->pOp->iOp == EXPR_OP_FUNC_CALL ){` |
|        - | 1471 | `				 /* Collect function arguments */` |
|   404539 | 1472 | `				 sxi32 iPtr = 0;` |
|   404539 | 1473 | `				 sxi32 nFuncTok = 0;` |
|  1449513 | 1474 | `				 while( nFuncTok + iCur < nToken ){` |
|  1449513 | 1475 | `					 if( apNode[nFuncTok+iCur] ){` |
|  1435889 | 1476 | `						 if( apNode[nFuncTok+iCur]->pStart->nType & PH7_TK_LPAREN /*'('*/ ){` |
|   419039 | 1477 | `							 iPtr++;` |
|  1226372 | 1478 | `						 }else if ( apNode[nFuncTok+iCur]->pStart->nType & PH7_TK_RPAREN /*')'*/){` |
|   419039 | 1479 | `							 iPtr--;` |
|   419039 | 1480 | `							 if( iPtr <= 0 ){` |
|   404539 | 1481 | `								 break;` |
|        - | 1482 | `							 }` |
|     7250 | 1483 | `						 }` |
|   515675 | 1484 | `					 }` |
|  1044979 | 1485 | `					 nFuncTok++;` |
|        5 | 1486 | `				 }` |
|   404539 | 1487 | `				 if( nFuncTok + iCur >= nToken ){` |
|        - | 1488 | `					 /* Syntax error */` |
...
|      ! 0 | 1493 | `					 return rc;` |
|        - | 1494 | `				 }` |
|   404539 | 1495 | `				 if(  iLeft < 0 \|\| !NODE_ISTERM(iLeft) /*\|\| ( apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec != 2)*/ ){` |
|        - | 1496 | `					 /* Syntax error */` |
...
|      ! 0 | 1501 | `					 return rc;` |
|        - | 1502 | `				 }` |
|   404539 | 1503 | `				 if( nFuncTok > 1 ){` |
|        - | 1504 | `					 /* Process function arguments */` |
|   350295 | 1505 | `					 rc = ExprProcessFuncArguments(&(*pGen),pNode,&apNode[iCur+1],nFuncTok-1);` |
|   350295 | 1506 | `					 if( rc != SXRET_OK ){` |
|       11 | 1507 | `						 return rc;` |
|        - | 1508 | `					 }` |
|   175141 | 1509 | `				 }` |
|        - | 1510 | `				 /* Link the node to the tree */` |
|   404531 | 1511 | `				 pNode->pLeft = apNode[iLeft];` |
|   404531 | 1512 | `				 apNode[iLeft] = 0;` |
|  1449481 | 1513 | `				 for( iPtr = 1; iPtr <= nFuncTok ; iPtr++ ){` |
|  1044955 | 1514 | `					 apNode[iCur+iPtr] = 0;` |
|   522480 | 1515 | `				 }` |
|   476450 | 1516 | `			 }else if (pNode->pOp->iOp == EXPR_OP_SUBSCRIPT ){` |
|        - | 1517 | `				 /* Subscripting */` |
|    87739 | 1518 | `				 sxi32 iArrTok = iCur + 1;` |
|    87739 | 1519 | `				 sxi32 iNest = 1;` |
|    87734 | 1520 | `				 if(  iLeft < 0 \|\| apNode[iLeft] == 0 \|\| (apNode[iLeft]->pOp == 0 && (apNode[iLeft]->xCode != PH7_CompileVariable &&` |
...
|      214 | 1523 | `					 apNode[iLeft]->xCode != PH7_CompileArray && apNode[iLeft]->xCode != PH7_CompileShortArray ) ) \|\|` |
|    87734 | 1524 | `					 ( apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec != 2 /* postfix */) ){` |
|        - | 1525 | `						 /* Syntax error */` |
...
|   158471 | 1533 | `				 while( iArrTok < nToken ){` |
|   158471 | 1534 | `					 if( apNode[iArrTok] ){` |
|   158439 | 1535 | `						 if( apNode[iArrTok]->pOp && apNode[iArrTok]->pOp->iOp == EXPR_OP_SUBSCRIPT &&  apNode[iArrTok]->pLeft == 0){` |
|        - | 1536 | `							 /* Increment nesting level */` |
|      ! 0 | 1537 | `							 iNest++;` |
|   158439 | 1538 | `						 }else if( apNode[iArrTok]->pStart->nType & PH7_TK_CSB /*']'*/){` |
|        - | 1539 | `							 /* Decrement nesting level */` |
|    87739 | 1540 | `							 iNest--;` |
|    87739 | 1541 | `							 if( iNest <= 0 ){` |
|    87739 | 1542 | `								 break;` |
|        - | 1543 | `							 }` |
|      ! 0 | 1544 | `						 }` |
|    35350 | 1545 | `					 }` |
|    70737 | 1546 | `					 ++iArrTok;` |
|        5 | 1547 | `				 }` |
|    87739 | 1548 | `				 if( iArrTok > iCur + 1 ){` |
|        - | 1549 | `					 /* Recurse and process this expression */` |
|    70615 | 1550 | `					 rc = ExprMakeTree(&(*pGen),&apNode[iCur+1],iArrTok - iCur - 1);` |
|    70615 | 1551 | `					 if( rc != SXRET_OK ){` |
|      ! 0 | 1552 | `						 return rc;` |
|        - | 1553 | `					 }` |
|        - | 1554 | `					 /* Link the node to it's index */` |
|    70615 | 1555 | `					 SySetPut(&pNode->aNodeArgs,(const void *)&apNode[iCur+1]);` |
|    35305 | 1556 | `				 }` |
|        - | 1557 | `				 /* Link the node to the tree */` |
|    87739 | 1558 | `				 pNode->pLeft = apNode[iLeft];` |
|    87739 | 1559 | `				 pNode->pRight = 0;` |
|    87739 | 1560 | `				 apNode[iLeft] = 0;` |
|   246205 | 1561 | `				 for( iNest = iCur + 1 ; iNest <= iArrTok ; ++iNest ){` |
|   158471 | 1562 | `					 apNode[iNest] = 0;` |
|    79238 | 1563 | `				 }` |
|    43872 | 1564 | `			 }else{` |
|        - | 1565 | `				 /* Member access operators [i.e: '->','::'] */` |
|   186453 | 1566 | `				  iRight = iCur + 1;` |
|   186455 | 1567 | `				 while( iRight < nToken && apNode[iRight] == 0 ){` |
|        3 | 1568 | `					 iRight++;` |
|        1 | 1569 | `				 }` |
|   186453 | 1570 | `				 if( iRight >= nToken \|\| iLeft < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|        - | 1571 | `					 /* Syntax error */` |
...
|   186449 | 1579 | `				 pNode->pLeft = apNode[iLeft];` |
|   186444 | 1580 | `				 if( (pNode->pOp->iOp == EXPR_OP_ARROW /*'->'*/ \|\| pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW /*'?->'*/)` |
|   186306 | 1581 | `					 && pNode->pLeft->pOp == 0 &&` |
|   186068 | 1582 | `					 pNode->pLeft->xCode != PH7_CompileVariable ){` |
|        - | 1583 | `						 /* Syntax error */` |
...
|      ! 0 | 1589 | `						 return rc;` |
|        - | 1590 | `				 }` |
|   186449 | 1591 | `				 pNode->pRight = apNode[iRight];` |
|   186449 | 1592 | `				 apNode[iLeft] = apNode[iRight] = 0;` |
|        - | 1593 | `			 }` |
|   339352 | 1594 | `		 }` |
|  2566551 | 1595 | `		 iLeft = iCur;` |
|  1283278 | 1596 | `	 }` |
|        - | 1597 | `	 /* Handle left associative (new, clone) operators */` |
|  4913231 | 1598 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  4151095 | 1599 | `		 if( apNode[iCur] == 0 ){` |
|  2281591 | 1600 | `			 continue;` |
|        - | 1601 | `		 }` |
|  1869509 | 1602 | `		 pNode = apNode[iCur];` |
|  1869509 | 1603 | `		 if( pNode->pOp && pNode->pOp->iPrec == 1 && pNode->pLeft == 0 ){` |
|        - | 1604 | `			 SyToken *pToken;` |
|        - | 1605 | `			 /* Get the left node */` |
|    18323 | 1606 | `			 iLeft = iCur + 1;` |
|    36521 | 1607 | `			 while( iLeft < nToken && apNode[iLeft] == 0 ){` |
|    18203 | 1608 | `				 iLeft++;` |
|        5 | 1609 | `			 }` |
|    18323 | 1610 | `			 if( iLeft >= nToken \|\| !NODE_ISTERM(iLeft) ){` |
|        - | 1611 | `				  /* Syntax error */` |
...
|    18323 | 1620 | `			 if( pNode->pOp->iOp == EXPR_OP_CLONE ){` |
|        - | 1621 | `				 /* Clone:` |
...
|       16 | 1642 | `			 }else{` |
|        - | 1643 | `				 /* New */` |
|    18299 | 1644 | `				 if( apNode[iLeft]->pOp == 0 ){` |
...
|    18323 | 1661 | `			 pNode->pLeft = apNode[iLeft];` |
|    18323 | 1662 | `			 apNode[iLeft] = 0;` |
|    18323 | 1663 | `			 pNode->pRight = 0; /* Paranoid */` |
|     9159 | 1664 | `		 }` |
|   934757 | 1665 | `	 }` |
|        - | 1666 | `	  /* Handle post/pre icrement/decrement [i.e: ++/--] operators with precedence 3 */` |
|   762141 | 1667 | `	 iLeft = -1;` |
|  4916969 | 1668 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  4151095 | 1669 | `		 if( apNode[iCur] == 0 ){` |
|  2281591 | 1670 | `			 continue;` |
|        - | 1671 | `		 }` |
|  1869509 | 1672 | `		 pNode = apNode[iCur];` |
|  1869509 | 1673 | `		 if( pNode->pOp && pNode->pOp->iPrec == 3 && pNode->pLeft == 0){` |
|    10285 | 1674 | `			 if( iLeft >= 0 && ((apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec == 2 /* Postfix */)` |
|     3774 | 1675 | `				 \|\| apNode[iLeft]->xCode == PH7_CompileVariable) ){` |
|        - | 1676 | `					 /* Link the node to the tree */` |
|     3785 | 1677 | `					 pNode->pLeft = apNode[iLeft];` |
|     3785 | 1678 | `					 apNode[iLeft] = 0;` |
|     1890 | 1679 | `			 }` |
|     7009 | 1680 | `		  }` |
|  1873247 | 1681 | `		 iLeft = iCur;` |
|   938495 | 1682 | `	  }` |
|   765879 | 1683 | `	 iLeft = -1;` |
|  4916969 | 1684 | `	 for( iCur = nToken -  1 ; iCur >= 0 ; iCur-- ){` |
|  4151095 | 1685 | `		 if( apNode[iCur] == 0 ){` |
|  2285371 | 1686 | `			 continue;` |
|        - | 1687 | `		 }` |
|  1865729 | 1688 | `		 pNode = apNode[iCur];` |
|  1865729 | 1689 | `		 if( pNode->pOp && pNode->pOp->iPrec == 3 && pNode->pLeft == 0){` |
|    10238 | 1690 | `			 if( iLeft < 0 \|\| (apNode[iLeft]->pOp == 0 && apNode[iLeft]->xCode != PH7_CompileVariable)` |
|    10243 | 1691 | `				 \|\| ( apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec != 2 /* Postfix */) ){` |
|        - | 1692 | `					 /* Syntax error */` |
...
|    10243 | 1700 | `			 pNode->pLeft = apNode[iLeft];` |
|    10243 | 1701 | `			 apNode[iLeft] = 0;` |
|        - | 1702 | `			 /* Mark as pre-increment/decrement node */` |
|    10243 | 1703 | `			 pNode->iFlags \|= EXPR_NODE_PRE_INCR;` |
|     5119 | 1704 | `		  }` |
|  1865729 | 1705 | `		 iLeft = iCur;` |
|   932867 | 1706 | `	 }` |
|        - | 1707 | `	 /* Handle right associative unary and cast operators [i.e: !,(string),~...]  with precedence 4*/` |
|   765879 | 1708 | `	  iLeft = 0;` |
|  4916963 | 1709 | `	  for( iCur = nToken -  1 ; iCur >= 0 ; iCur-- ){` |
|  4151091 | 1710 | `		  if( apNode[iCur] ){` |
|  1855487 | 1711 | `			  pNode = apNode[iCur];` |
|  1855487 | 1712 | `			  if( pNode->pOp && pNode->pOp->iPrec == 4 && pNode->pLeft == 0){` |
|    45833 | 1713 | `				  if( iLeft > 0 ){` |
|        - | 1714 | `					  /* Link the node to the tree */` |
|    45831 | 1715 | `					  pNode->pLeft = apNode[iLeft];` |
|    45831 | 1716 | `					  apNode[iLeft] = 0;` |
|    45831 | 1717 | `					  if( pNode->pLeft && pNode->pLeft->pOp && pNode->pLeft->pOp->iPrec > 4 ){` |
...
|  4916961 | 1744 | `	 for( iCur = nToken - 1 ; iCur >= 0 ; --iCur ){` |
|  4151089 | 1745 | `		 if( apNode[iCur] == 0 ){` |
|  2341547 | 1746 | `			 continue;` |
|        - | 1747 | `		 }` |
|  1809547 | 1748 | `		 pNode = apNode[iCur];` |
|  1809547 | 1749 | `		 if( pNode->pOp && pNode->pOp->iPrec == 5 && pNode->pLeft == 0 ){` |
|        - | 1750 | `			 sxi32 iL, iR;` |
...
|  8424511 | 1813 | `	 for( i = 7 ; i < 17 ; i++ ){` |
|  7658649 | 1814 | `		 iLeft = -1;` |
| 49169195 | 1815 | `		 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
| 41510561 | 1816 | `			 if( apNode[iCur] == 0 ){` |
| 26506359 | 1817 | `				 continue;` |
|        - | 1818 | `			 }` |
| 15004207 | 1819 | `			 pNode = apNode[iCur];` |
| 15004207 | 1820 | `			 if( pNode->pOp && pNode->pOp->iPrec == i && pNode->pLeft == 0 ){` |
|        - | 1821 | `				 /* Get the right node */` |
|   230997 | 1822 | `				 iRight = iCur + 1;` |
|   329937 | 1823 | `				 while( iRight < nToken && apNode[iRight] == 0 ){` |
|    98945 | 1824 | `					 iRight++;` |
|        5 | 1825 | `				 }` |
|   230997 | 1826 | `				 if( iRight >= nToken \|\| iLeft < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|        - | 1827 | `					 /* Syntax error */` |
|       11 | 1828 | `					 rc = PH7_GenCompileError(pGen,E_ERROR,pNode->pStart->nLine,"'%z': Missing/Invalid operand",&pNode->pOp->sOp);` |
|       11 | 1829 | `					 if( rc != SXERR_ABORT ){` |
|       11 | 1830 | `						 rc = SXERR_SYNTAX;` |
|        4 | 1831 | `					 }` |
|       11 | 1832 | `					 return rc;` |
|        - | 1833 | `				 }` |
|   230989 | 1834 | `				 if( pNode->pOp->iOp == EXPR_OP_REF ){` |
|        - | 1835 | `					 sxi32  iTmp;` |
...
|   230987 | 1876 | `				 pNode->pLeft = apNode[iLeft];` |
|   230987 | 1877 | `				 pNode->pRight = apNode[iRight];` |
|   230987 | 1878 | `				 apNode[iLeft] = apNode[iRight] = 0;` |
|   115491 | 1879 | `			 }` |
| 15004197 | 1880 | `			 iLeft = iCur;` |
|  7502101 | 1881 | `		 }` |
|  3829322 | 1882 | `	 }` |
...
|        - | 1886 | `	  */` |
|   765867 | 1887 | `	  iLeft = -1;` |
|  4905677 | 1888 | `	  for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  4142445 | 1889 | `		  if( apNode[iCur] == 0 ){` |
|  2802853 | 1890 | `			  continue;` |
|        - | 1891 | `		  }` |
|  1339597 | 1892 | `		  pNode = apNode[iCur];` |
|  1339597 | 1893 | `		  if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_QUESTY && pNode->pLeft == 0 ){` |
|     2635 | 1894 | `			  sxi32 iNest = 1;` |
|     2635 | 1895 | `			  if( iLeft < 0 \|\| !NODE_ISTERM(iLeft) ){` |
...
|     2633 | 1904 | `			  iRight = iCur + 1;` |
|     5515 | 1905 | `			  while( iRight < nToken  ){` |
|     5515 | 1906 | `				  if( apNode[iRight] ){` |
|     5193 | 1907 | `					  if( apNode[iRight]->pOp && apNode[iRight]->pOp->iOp == EXPR_OP_QUESTY && apNode[iRight]->pCond == 0){` |
|        - | 1908 | `						  /* Increment nesting level */` |
|      ! 0 | 1909 | `						  ++iNest;` |
|     5193 | 1910 | `					  }else if( apNode[iRight]->pStart->nType & PH7_TK_COLON /*:*/ ){` |
|        - | 1911 | `						  /* Decrement nesting level */` |
|     2633 | 1912 | `						  --iNest;` |
|     2633 | 1913 | `						  if( iNest <= 0 ){` |
|     2633 | 1914 | `							  break;` |
|        - | 1915 | `						  }` |
|      ! 0 | 1916 | `					  }` |
|     1280 | 1917 | `				  }` |
|     2887 | 1918 | `				  iRight++;` |
|        5 | 1919 | `			  }` |
|     2633 | 1920 | `			  if( iRight > iCur + 1 ){` |
|        - | 1921 | `				  /* Recurse and process the then expression */` |
|     2565 | 1922 | `				  rc = ExprMakeTree(&(*pGen),&apNode[iCur + 1],iRight - iCur - 1);` |
|     2565 | 1923 | `				  if( rc != SXRET_OK ){` |
|      ! 0 | 1924 | `					  return rc;` |
|        - | 1925 | `				  }` |
|        - | 1926 | `				  /* Link the node to the tree */` |
|     2565 | 1927 | `				  pNode->pLeft = apNode[iCur + 1];` |
|     1280 | 1928 | `			  }else{` |
|        - | 1929 | `				  /* Elvis operator (?:): pLeft stays NULL.` |
|        - | 1930 | `				   * NODE_ISTERM() recognizes this node as complete via pCond. */` |
|        - | 1931 | `			  }` |
|     2633 | 1932 | `			  apNode[iCur + 1] = 0;` |
|     2633 | 1933 | `			  if( iRight + 1 < nToken ){` |
|        - | 1934 | `				  /* Recurse and process the else expression */` |
|     2633 | 1935 | `				  rc = ExprMakeTree(&(*pGen),&apNode[iRight + 1],nToken - iRight - 1);` |
|     2633 | 1936 | `				  if( rc != SXRET_OK ){` |
|      ! 0 | 1937 | `					  return rc;` |
|        - | 1938 | `				  }` |
|        - | 1939 | `				  /* Link the node to the tree */` |
|     2633 | 1940 | `				  pNode->pRight = apNode[iRight + 1];` |
|     2633 | 1941 | `				  apNode[iRight + 1] =  apNode[iRight] = 0;` |
|     1319 | 1942 | `			  }else{` |
...
|     2633 | 1950 | `			  pNode->pCond  = apNode[iLeft];` |
|     2633 | 1951 | `			  apNode[iLeft] = 0;` |
|     2633 | 1952 | `			  break;` |
|        - | 1953 | `		  }` |
|  1336967 | 1954 | `		  iLeft = iCur;` |
|   668486 | 1955 | `	  }` |
...
|        - | 1959 | `	  */` |
|   765865 | 1960 | `	 iRight = -1;` |
|  4916765 | 1961 | `	 for( iCur = nToken -  1 ; iCur >= 0 ; iCur--){` |
|  4150959 | 1962 | `		 if( apNode[iCur] == 0 ){` |
|  3099489 | 1963 | `			 continue;` |
|        - | 1964 | `		 }` |
|  1051475 | 1965 | `		 pNode = apNode[iCur];` |
|  1051475 | 1966 | `		 if( pNode->pOp && pNode->pOp->iPrec == 18 && pNode->pLeft == 0 ){` |
|        - | 1967 | `			 /* Get the left node */` |
|   285493 | 1968 | `			 iLeft = iCur - 1;` |
|   416261 | 1969 | `			 while( iLeft >= 0 && apNode[iLeft] == 0 ){` |
|   130773 | 1970 | `				 iLeft--;` |
|        5 | 1971 | `			 }` |
|   285493 | 1972 | `			 if( iLeft < 0 \|\| iRight < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|        - | 1973 | `				 /* Syntax error */` |
...
|        - | 1990 | `			  * a write. */` |
|   285451 | 1991 | `			 if( PH7_ExprContainsNullsafe(apNode[iLeft]) ){` |
...
|       11 | 1997 | `				 return rc;` |
|        - | 1998 | `			 }` |
|   285443 | 1999 | `			 if( ExprIsModifiableValue(apNode[iLeft],FALSE) == FALSE ){` |
...
|   285439 | 2018 | `			 pNode->pLeft = apNode[iRight];` |
|   285439 | 2019 | `			 pNode->pRight = apNode[iLeft];` |
|   285439 | 2020 | `			 apNode[iLeft] = apNode[iRight] = 0;` |
|   142717 | 2021 | `		 }` |
|  1051421 | 2022 | `		 iRight = iCur;` |
|   525713 | 2023 | `	 }` |
|        - | 2024 | `	 /* Process left associative binary operators that have the lowest precedence [i.e: and,or,xor] */` |
|  3829035 | 2025 | `	 for( i = 19 ; i < 23 ; i++ ){` |
|  3063229 | 2026 | `		 iLeft = -1;` |
| 19666773 | 2027 | `		 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
| 16603549 | 2028 | `			 if( apNode[iCur] == 0 ){` |
| 13539919 | 2029 | `				 continue;` |
|        - | 2030 | `			 }` |
|  3063635 | 2031 | `			 pNode = apNode[iCur];` |
|  3063635 | 2032 | `			 if( pNode->pOp && pNode->pOp->iPrec == i && pNode->pLeft == 0 ){` |
...
|       35 | 2050 | `			 }` |
|  3063635 | 2051 | `			 iLeft = iCur;` |
|  1531820 | 2052 | `		 }` |
|  1531617 | 2053 | `	 }` |
|        - | 2054 | `	 /* Point to the root of the expression tree */` |
|  4150863 | 2055 | `	 for( iCur = 1 ; iCur < nToken ; ++iCur ){` |
|  3385075 | 2056 | `		 if( apNode[iCur] ){` |
|   696361 | 2057 | `			 if( (apNode[iCur]->pOp \|\| apNode[iCur]->xCode ) && apNode[0] != 0){` |
...
|       22 | 2062 | `				  return rc;` |
|        - | 2063 | `			 }` |
|   696343 | 2064 | `			 apNode[0] = apNode[iCur];` |
|   696343 | 2065 | `			 apNode[iCur] = 0;` |
|   348169 | 2066 | `		 }` |
|  1692531 | 2067 | `	 }` |
|   765793 | 2068 | `	 return SXRET_OK;` |
|   701783 | 2069 | ` }` |
|        - | 2070 | ` /*` |
...
|        - | 2075 | `  */` |
|   902114 | 2076 | `PH7_PRIVATE sxi32 PH7_ExprMakeTree(ph7_gen_state *pGen,SySet *pExprNode,ph7_expr_node **ppRoot)` |
|        5 | 2077 |  |
|        - | 2078 | `	ph7_expr_node **apNode;` |
|        - | 2079 | `	ph7_expr_node *pNode;` |
|        - | 2080 | `	sxi32 rc;` |
|        - | 2081 | `	/* Reset node container */` |
|   902119 | 2082 | `	SySetReset(pExprNode);` |
|   902119 | 2083 | `	pNode = 0; /* Prevent compiler warning */` |
|        - | 2084 | `	/* Extract nodes one after one until we hit the end of the input */` |
|        - | 2085 | `	{` |
|   902119 | 2086 | `		int iLastWasTerm = 0;` |
|  4855947 | 2087 | `		while( pGen->pIn < pGen->pEnd ){` |
|  3953867 | 2088 | `			rc = ExprExtractNode(&(*pGen),&pNode,iLastWasTerm);` |
|  3953867 | 2089 | `			if( rc != SXRET_OK ){` |
|       38 | 2090 | `				return rc;` |
|        - | 2091 | `			}` |
|        - | 2092 | `			/* Determine if this node is a term for short-array disambiguation */` |
|  3953833 | 2093 | `			if( pNode->xCode ){` |
|        - | 2094 | `				/* Node with compile handler: variable, literal, string, array, etc. */` |
|  2077889 | 2095 | `				iLastWasTerm = 1;` |
|  2914891 | 2096 | `			}else if( pNode->pOp ){` |
|        - | 2097 | `				/* Operator node */` |
|   918113 | 2098 | `				iLastWasTerm = 0;` |
|   459059 | 2099 | `			}else{` |
|        - | 2100 | `				/* Delimiter: ')' and ']' end terms */` |
|   957841 | 2101 | `				iLastWasTerm = (pNode->pStart->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB)) ? 1 : 0;` |
|        - | 2102 | `			}` |
|        - | 2103 | `			/* Save the extracted node */` |
|  3953833 | 2104 | `			SySetPut(pExprNode,(const void *)&pNode);` |
|        5 | 2105 | `		}` |
|        - | 2106 | `	}` |
|   902085 | 2107 | `	if( SySetUsed(pExprNode) < 1 ){` |
|        - | 2108 | `		/* Empty expression [i.e: A semi-colon;] */` |
|      ! 0 | 2109 | `		*ppRoot = 0;` |
|      ! 0 | 2110 | `		return SXRET_OK;` |
|        - | 2111 | `	}` |
|   902085 | 2112 | `	apNode = (ph7_expr_node **)SySetBasePtr(pExprNode);` |
|        - | 2113 | `	/* Make sure we are dealing with valid nodes */` |
|   902085 | 2114 | `	rc = ExprVerifyNodes(&(*pGen),apNode,(sxi32)SySetUsed(pExprNode));` |
|   902085 | 2115 | `	if( rc != SXRET_OK ){` |
...
|        - | 2121 | `	}` |
|        - | 2122 | `	/* Build the tree */` |
|   902035 | 2123 | `	rc = ExprMakeTree(&(*pGen),apNode,(sxi32)SySetUsed(pExprNode));` |
|   902035 | 2124 | `	if( rc != SXRET_OK ){` |
|        - | 2125 | `		/* Something goes wrong [i.e: Syntax error] */` |
|      103 | 2126 | `		*ppRoot = 0;` |
|      103 | 2127 | `		return rc;` |
|        - | 2128 | `	}` |
|        - | 2129 | `	/* Point to the root of the tree */` |
|   901937 | 2130 | `	*ppRoot = apNode[0];` |
|   901937 | 2131 | `	return SXRET_OK;` |
|   451062 | 2132 |  |
|        - | 2133 |  |
