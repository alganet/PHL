...
|        - |  265 | ` */` |
|  1214760 |  266 | `PH7_PRIVATE const ph7_expr_op *  PH7_ExprExtractOperator(SyString *pStr,SyToken *pLast)` |
|        5 |  267 | `{` |
|  1214765 |  268 | `	sxu32 n = 0;` |
|        - |  269 | `	sxi32 rc;` |
|        - |  270 | `	/* Do a linear lookup on the operators table */` |
| 20844873 |  271 | `	for(;;){` |
| 41689751 |  272 | `		if( n >= SX_ARRAYSIZE(aOpTable) ){` |
|      ! 0 |  273 | `			break;` |
|        - |  274 | `		}` |
| 41689751 |  275 | `		if( SyisAlpha(aOpTable[n].sOp.zString[0]) ){` |
|        - |  276 | `			/* TICKET 1433-012: Alpha stream operators [i.e: and,or,xor,new...] */` |
|  3723799 |  277 | `			rc = SyStringCmp(pStr,&aOpTable[n].sOp,SyStrnicmp);` |
|  1861902 |  278 | `		}else{` |
| 37965957 |  279 | `			rc = SyStringCmp(pStr,&aOpTable[n].sOp,SyMemcmp);` |
|        - |  280 | `		}` |
| 41689751 |  281 | `		if( rc == 0 ){` |
|  1219403 |  282 | `			if( aOpTable[n].sOp.nByte != sizeof(char) \|\| (aOpTable[n].iOp != EXPR_OP_UMINUS && aOpTable[n].iOp != EXPR_OP_UPLUS) \|\| pLast == 0 ){` |
|        - |  283 | `				/* There is no ambiguity here,simply return the first operator seen */` |
|  1214309 |  284 | `				return &aOpTable[n];` |
|        - |  285 | `			}` |
...
|        4 |  299 | `			}` |
|     2319 |  300 | `		}` |
| 40474991 |  301 | `		++n; /* Next operator in the table */` |
|        5 |  302 | `	}` |
...
|        - |  310 | ` */` |
|   743380 |  311 | `PH7_PRIVATE void PH7_DelimitNestedTokens(SyToken *pIn,SyToken *pEnd,sxu32 nTokStart,sxu32 nTokEnd,SyToken **ppEnd)` |
|        5 |  312 | `{` |
|   743385 |  313 | `	SyToken *pCur = pIn;` |
|   743385 |  314 | `	sxi32 iNest = 1;` |
|  4147641 |  315 | `	for(;;){` |
|  8295287 |  316 | `		if( pCur >= pEnd ){` |
|      471 |  317 | `			break;` |
|        - |  318 | `		}` |
|  8294821 |  319 | `		if( pCur->nType & nTokStart ){` |
|        - |  320 | `			/* Increment nesting level */` |
|   391081 |  321 | `			iNest++;` |
|  8099283 |  322 | `		}else if( pCur->nType & nTokEnd ){` |
|        - |  323 | `			/* Decrement nesting level */` |
|  1133995 |  324 | `			iNest--;` |
|  1133995 |  325 | `			if( iNest <= 0 ){` |
|   742919 |  326 | `				break;` |
|        - |  327 | `			}` |
|   195538 |  328 | `		}` |
|        - |  329 | `		/* Advance cursor */` |
...
|        - |  366 | ` */` |
|  1024470 |  367 | `static sxi32 ExprVerifyNodes(ph7_gen_state *pGen,ph7_expr_node **apNode,sxi32 nNode)` |
|        5 |  368 | `{` |
|        - |  369 | `	sxi32 iParen,iSquare,iQuesty,iBraces;` |
|        - |  370 | `	sxi32 i,rc;` |
|        - |  371 |  |
|  1024475 |  372 | `	if( nNode > 0 && apNode[0]->pOp && (apNode[0]->pOp->iOp == EXPR_OP_ADD \|\| apNode[0]->pOp->iOp == EXPR_OP_SUB) ){` |
...
|       15 |  376 | `	}` |
|  1024475 |  377 | `	iParen = iSquare = iQuesty = iBraces = 0;` |
|  5553577 |  378 | `	for( i = 0 ; i < nNode ; ++i ){` |
|  4529141 |  379 | `		if( apNode[i]->xCode == PH7_CompileShortArray \|\| apNode[i]->xCode == PH7_CompileShortList ){` |
|        - |  380 | `			/* Short array/list literal: brackets are self-contained, skip */` |
|     1257 |  381 | `			continue;` |
|        - |  382 | `		}` |
|  4527889 |  383 | `		if( apNode[i]->pStart->nType & PH7_TK_LPAREN /*'('*/){` |
|   514803 |  384 | `			if( i > 0 && ( apNode[i-1]->xCode == PH7_CompileVariable \|\| apNode[i-1]->xCode == PH7_CompileLiteral \|\|` |
...
|   482371 |  387 | `					if( (apNode[i - 1]->pStart->nType & PH7_TK_OP) == 0 ){` |
|        - |  388 | `						/* We are dealing with a postfix [i.e: function call]  operator` |
|        - |  389 | `						 * not a simple left parenthesis. Mark the node.` |
|        - |  390 | `						 */` |
|   482371 |  391 | `						apNode[i]->pStart->nType \|= PH7_TK_OP;` |
|   482371 |  392 | `						apNode[i]->pStart->pUserData = (void *)&sFCallOp; /* Function call operator */` |
|   482371 |  393 | `						apNode[i]->pOp = &sFCallOp;` |
|   241183 |  394 | `					}` |
|   241183 |  395 | `			}` |
|   514803 |  396 | `			iParen++;` |
|  4270490 |  397 | `		}else if( apNode[i]->pStart->nType & PH7_TK_RPAREN/*')*/){` |
|   514803 |  398 | `			if( iParen <= 0 ){` |
...
|        - |  404 | `			}` |
|   514791 |  405 | `			iParen--;` |
|  3755686 |  406 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OSB /*'['*/){` |
|    98413 |  407 | `			iSquare++;` |
|  3449089 |  408 | `		}else if (apNode[i]->pStart->nType & PH7_TK_CSB /*']'*/){` |
...
|        - |  415 | `			}` |
|    98421 |  416 | `			iSquare--;` |
|  3350671 |  417 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OCB /*'{'*/){` |
|       20 |  418 | `			iBraces++;` |
...
|        - |  462 |  |
|        7 |  463 | `			}` |
|  3301454 |  464 | `		}else if (apNode[i]->pStart->nType & PH7_TK_CCB /*'}'*/){` |
|       24 |  465 | `			if( iBraces <= 0 ){` |
...
|        - |  471 | `			}` |
|       10 |  472 | `			iBraces--;` |
|  3301429 |  473 | `		}else if ( apNode[i]->pStart->nType & PH7_TK_COLON ){` |
...
|        6 |  484 | `				return rc;` |
|        5 |  485 | `			}` |
|  3299974 |  486 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OP ){` |
|   924691 |  487 | `			const ph7_expr_op *pOp = (const ph7_expr_op *)apNode[i]->pOp;` |
|   924691 |  488 | `			if( pOp->iOp == EXPR_OP_QUESTY ){` |
|     2651 |  489 | `				iQuesty++;` |
|   923368 |  490 | `			}else if( i > 0 && (pOp->iOp == EXPR_OP_UMINUS \|\| pOp->iOp == EXPR_OP_UPLUS)){` |
...
|   462343 |  510 | `		}` |
|  2263930 |  511 | `	}` |
|  1024441 |  512 | `	if( iParen != 0 \|\| iSquare != 0 \|\| iQuesty != 0 \|\| iBraces != 0){` |
...
|       20 |  517 | `		return rc;` |
|        - |  518 | `	}` |
|  1024425 |  519 | `	return SXRET_OK;` |
|   512240 |  520 | `}` |
|        - |  521 | `/*` |
|        - |  522 | ` * Collect and assemble tokens holding a namespace path [i.e: namespace\to\const]` |
|        - |  523 | ` * or a simple literal [i.e: PHP_EOL].` |
|        - |  524 | ` */` |
|   849232 |  525 | `static void ExprAssembleLiteral(SyToken **ppCur,SyToken *pEnd)` |
|        5 |  526 | `{` |
|   849237 |  527 | `	SyToken *pIn = *ppCur;` |
|        - |  528 | `	/* Jump the first literal seen */` |
|   849237 |  529 | `	if( (pIn->nType & PH7_TK_NSSEP) == 0 ){` |
|   845359 |  530 | `		pIn++;` |
|   422677 |  531 | `	}` |
|   426582 |  532 | `	for(;;){` |
|   853169 |  533 | `		if(pIn < pEnd && (pIn->nType & PH7_TK_NSSEP) ){` |
|     3937 |  534 | `			pIn++;` |
...
|        - |  884 | ` */` |
|  4533204 |  885 | `static sxi32 ExprExtractNode(ph7_gen_state *pGen,ph7_expr_node **ppNode,int iLastWasTerm,int bAfterMemberOp)` |
|        5 |  886 | `{` |
|        - |  887 | `	ph7_expr_node *pNode;` |
|        - |  888 | `	SyToken *pCur;` |
|        - |  889 | `	sxi32 rc;` |
|        - |  890 | `	/* Allocate a new node */` |
|  4533209 |  891 | `	pNode = (ph7_expr_node *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_expr_node));` |
|  4533209 |  892 | `	if( pNode == 0 ){` |
...
|  4533209 |  899 | `	SyZero(pNode,sizeof(ph7_expr_node));` |
|  4533209 |  900 | `	SySetInit(&pNode->aNodeArgs,&pGen->pVm->sAllocator,sizeof(ph7_expr_node **));` |
|        - |  901 | `	/* Point to the head of the token stream */` |
|  4533209 |  902 | `	pCur = pNode->pStart = pGen->pIn;` |
|        - |  903 | `	/* Start collecting tokens */` |
|  4533209 |  904 | `	if( pCur->nType & PH7_TK_ELLIPSIS ){` |
...
|     3923 |  927 | `		return rc;` |
|        - |  928 | `	}` |
|  4529227 |  929 | `	if( (pCur->nType & PH7_TK_OSB) && !iLastWasTerm ){` |
...
|        5 |  958 | `		}` |
|  4528600 |  959 | `	}else if( pCur->nType & PH7_TK_OP ){` |
|        - |  960 | `		/* Point to the instance that describe this operator */` |
|  1023133 |  961 | `		pNode->pOp = (const ph7_expr_op *)pCur->pUserData;` |
|        - |  962 | `		/* Advance the stream cursor */` |
|  1023133 |  963 | `		pCur++;` |
|  4016409 |  964 | `	}else if( pCur->nType & PH7_TK_DOLLAR ){` |
...
|  2892574 |  990 | `	 }else if( pCur->nType & PH7_TK_KEYWORD ){` |
...
|        5 | 1108 | `		 }` |
|  2251629 | 1109 | `	 }else if( pCur->nType & (PH7_TK_NSSEP\|PH7_TK_ID) ){` |
|        - | 1110 | `		 /* Constants,function name,namespace path,class name... */` |
|   825483 | 1111 | `		 ExprAssembleLiteral(&pCur,pGen->pEnd);` |
|   825483 | 1112 | `		 pNode->xCode = PH7_CompileLiteral;` |
|   412744 | 1113 | `	 }else{` |
|  1397501 | 1114 | `		 if( (pCur->nType & (PH7_TK_LPAREN\|PH7_TK_RPAREN\|PH7_TK_COMMA\|PH7_TK_COLON\|PH7_TK_CSB\|PH7_TK_OCB\|PH7_TK_CCB)) == 0 ){` |
|        - | 1115 | `			 /* Point to the code generator routine */` |
|   266525 | 1116 | `			 pNode->xCode = PH7_GetNodeHandler(pCur->nType);` |
|   266525 | 1117 | `			 if( pNode->xCode == 0 ){` |
...
|  4529193 | 1130 | `	pNode->pEnd = pCur;` |
|        - | 1131 | `	/* Save the node for later processing */` |
|  4529193 | 1132 | `	*ppNode = pNode;` |
|        - | 1133 | `	/* Synchronize cursors */` |
|  4529193 | 1134 | `	pGen->pIn = pCur;` |
|  4529193 | 1135 | `	return SXRET_OK;` |
|  2266607 | 1136 | `}` |
|        - | 1137 | `/*` |
...
|        - | 1140 | ` * level is zero.` |
|        - | 1141 | ` */` |
|    99230 | 1142 | `PH7_PRIVATE sxi32 PH7_GetNextExpr(SyToken *pStart,SyToken *pEnd,SyToken **ppNext)` |
|        5 | 1143 | `{` |
|    99235 | 1144 | `	SyToken *pCur = pStart;` |
|    99235 | 1145 | `	sxi32 iNest = 0;` |
|    99235 | 1146 | `	if( pCur >= pEnd \|\| (pCur->nType & PH7_TK_SEMI/*';'*/) ){` |
|        - | 1147 | `		/* Last expression */` |
|    51497 | 1148 | `		return SXERR_EOF;` |
|        - | 1149 | `	}` |
|   195857 | 1150 | `	while( pCur < pEnd ){` |
|   178655 | 1151 | `		if( (pCur->nType & (PH7_TK_COMMA/*','*/\|PH7_TK_SEMI/*';'*/)) && iNest <= 0){` |
|    30541 | 1152 | `			break;` |
|        - | 1153 | `		}` |
|   148119 | 1154 | `		if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|    10285 | 1155 | `			iNest++;` |
|   142979 | 1156 | `		}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}*/) ){` |
|    10287 | 1157 | `			iNest--;` |
|     5141 | 1158 | `		}` |
|   148119 | 1159 | `		pCur++;` |
|        5 | 1160 | `	}` |
|    47743 | 1161 | `	*ppNext = pCur;` |
|    47743 | 1162 | `	return SXRET_OK;` |
|    49620 | 1163 | `}` |
|        - | 1164 | `/*` |
|        - | 1165 | ` * Free an expression tree.` |
|        - | 1166 | ` */` |
|  3870408 | 1167 | `static void ExprFreeTree(ph7_gen_state *pGen,ph7_expr_node *pNode)` |
|        5 | 1168 | `{` |
|  3870413 | 1169 | `	if( pNode->pLeft ){` |
|        - | 1170 | `		/* Release the left tree */` |
|  1429839 | 1171 | `		ExprFreeTree(&(*pGen),pNode->pLeft);` |
|   714917 | 1172 | `	}` |
|  3870413 | 1173 | `	if( pNode->pRight ){` |
|        - | 1174 | `		/* Release the right tree */` |
|   772561 | 1175 | `		ExprFreeTree(&(*pGen),pNode->pRight);` |
|   386278 | 1176 | `	}` |
|  3870413 | 1177 | `	if( pNode->pCond ){` |
|        - | 1178 | `		/* Release the conditional tree used by the ternary operator */` |
|     2647 | 1179 | `		ExprFreeTree(&(*pGen),pNode->pCond);` |
|     1321 | 1180 | `	}` |
|  3870413 | 1181 | `	if( SySetUsed(&pNode->aNodeArgs) > 0 ){` |
|        - | 1182 | `		ph7_expr_node **apArg;` |
|        - | 1183 | `		sxu32 n;` |
|        - | 1184 | `		/* Release node arguments */` |
|   499771 | 1185 | `		apArg = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  1074953 | 1186 | `		for( n = 0 ; n < SySetUsed(&pNode->aNodeArgs) ; ++n ){` |
|   575187 | 1187 | `			ExprFreeTree(&(*pGen),apArg[n]);` |
|   287596 | 1188 | `		}` |
|   499771 | 1189 | `		SySetRelease(&pNode->aNodeArgs);` |
|   249883 | 1190 | `	}` |
|        - | 1191 | `	/* Finally,release this node */` |
|  3870413 | 1192 | `	SyMemBackendPoolFree(&pGen->pVm->sAllocator,pNode);` |
|  3870413 | 1193 | `}` |
|        - | 1194 | `/*` |
|        - | 1195 | ` * Free an expression tree.` |
|        - | 1196 | ` * This function is a wrapper around ExprFreeTree() defined above.` |
|        - | 1197 | ` */` |
|  1024504 | 1198 | `PH7_PRIVATE sxi32 PH7_ExprFreeTree(ph7_gen_state *pGen,SySet *pNodeSet)` |
|        5 | 1199 | `{` |
|        - | 1200 | `	ph7_expr_node **apNode;` |
|        - | 1201 | `	sxu32 n;` |
|  1024509 | 1202 | `	apNode = (ph7_expr_node **)SySetBasePtr(pNodeSet);` |
|  5553761 | 1203 | `	for( n = 0  ; n < SySetUsed(pNodeSet) ; ++n ){` |
|  4529257 | 1204 | `		if( apNode[n] ){` |
|  1024843 | 1205 | `			ExprFreeTree(&(*pGen),apNode[n]);` |
|   512419 | 1206 | `		}` |
|  2264631 | 1207 | `	}` |
|  1024509 | 1208 | `	return SXRET_OK;` |
|        5 | 1209 | `}` |
|        - | 1210 | `/*` |
...
|        - | 1274 | ` */` |
|   420616 | 1275 | `static sxi32 ExprProcessFuncArguments(ph7_gen_state *pGen,ph7_expr_node *pOp,ph7_expr_node **apNode,sxi32 nToken)` |
|        5 | 1276 | `{` |
...
|   420621 | 1280 | `	iCur = 0;` |
|   458312 | 1281 | `	for(;;){` |
|   916629 | 1282 | `		if( iCur >= nToken ){` |
|        - | 1283 | `			/* No more arguments to process */` |
|   420595 | 1284 | `			break;` |
|        - | 1285 | `		}` |
|   496039 | 1286 | `		iNode = iCur;` |
|   496039 | 1287 | `		iNest = 0;` |
|  1227853 | 1288 | `		while( iCur < nToken ){` |
|   807261 | 1289 | `			if( apNode[iCur] ){` |
|   791941 | 1290 | `				if( (apNode[iCur]->pStart->nType & PH7_TK_COMMA) && apNode[iCur]->pLeft == 0 && iNest <= 0 ){` |
|    37726 | 1291 | `					break;` |
|   716494 | 1292 | `				}else if( (apNode[iCur]->pStart->nType & (PH7_TK_LPAREN\|PH7_TK_OSB\|PH7_TK_OCB))` |
|   378545 | 1293 | `					&& apNode[iCur]->xCode != PH7_CompileShortArray` |
...
|    40165 | 1301 | `					iNest++;` |
|   696419 | 1302 | `				}else if( apNode[iCur]->pStart->nType & (PH7_TK_RPAREN\|PH7_TK_CCB\|PH7_TK_CSB) ){` |
|    40165 | 1303 | `					iNest--;` |
|    20080 | 1304 | `				}` |
|   358247 | 1305 | `			}` |
|   731819 | 1306 | `			iCur++;` |
...
|        - | 1387 | `  */` |
|  1641422 | 1388 | ` static sxi32 ExprMakeTree(ph7_gen_state *pGen,ph7_expr_node **apNode,sxi32 nToken)` |
|        5 | 1389 | ` {` |
|        - | 1390 | `	 sxi32 i,iLeft,iRight;` |
|        - | 1391 | `	 ph7_expr_node *pNode;` |
|        - | 1392 | `	 sxi32 iCur;` |
|        - | 1393 | `	 sxi32 rc;` |
|  1641427 | 1394 | `	 if( nToken <= 0 \|\| (nToken == 1 && apNode[0]->xCode) ){` |
|        - | 1395 | `		 /* TICKET 1433-17: self evaluating node */` |
|   768759 | 1396 | `		 return SXRET_OK;` |
|        - | 1397 | `	 }` |
|        - | 1398 | `	 /* Process expressions enclosed in parenthesis first */` |
|  5417281 | 1399 | `	 for( iCur =  0 ; iCur < nToken ; ++iCur ){` |
|        - | 1400 | `		 sxi32 iNest;` |
...
|        - | 1403 | `		  */` |
|  4544615 | 1404 | `		 if( apNode[iCur] == 0 \|\| apNode[iCur]->pStart->nType != PH7_TK_LPAREN ){` |
|  4512193 | 1405 | `			 continue;` |
|        - | 1406 | `		 }` |
|    32427 | 1407 | `		 iNest = 1;` |
...
|  5625053 | 1450 | `	 for( iCur =  0 ; iCur < nToken ; ++iCur ){` |
|        - | 1451 | `		 sxi32 iNest;` |
...
|        - | 1454 | `		  */` |
|  4760739 | 1455 | `		 if( apNode[iCur] == 0 \|\| apNode[iCur]->pStart->nType != PH7_TK_OCB ){` |
|  4760731 | 1456 | `			 continue;` |
|        - | 1457 | `		 }` |
|       10 | 1458 | `		 iNest = 1;` |
|       10 | 1459 | `		 iLeft = iCur;` |
...
|   864319 | 1491 | `	 iLeft = -1;` |
|  5625031 | 1492 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  4760729 | 1493 | `		 if( apNode[iCur] == 0 ){` |
|  1875799 | 1494 | `			 continue;` |
|        - | 1495 | `		 }` |
|  2884935 | 1496 | `		 pNode = apNode[iCur];` |
|  2884935 | 1497 | `		 if( pNode->pOp && pNode->pOp->iPrec == 2 && pNode->pLeft == 0  ){` |
|   772187 | 1498 | `			 if( pNode->pOp->iOp == EXPR_OP_FUNC_CALL ){` |
|        - | 1499 | `				 /* Collect function arguments */` |
|   482367 | 1500 | `				 sxi32 iPtr = 0;` |
|   482367 | 1501 | `				 sxi32 nFuncTok = 0;` |
|  1771987 | 1502 | `				 while( nFuncTok + iCur < nToken ){` |
|  1771987 | 1503 | `					 if( apNode[nFuncTok+iCur] ){` |
|  1756667 | 1504 | `						 if( apNode[nFuncTok+iCur]->pStart->nType & PH7_TK_LPAREN /*'('*/ ){` |
|   502925 | 1505 | `							 iPtr++;` |
|  1505207 | 1506 | `						 }else if ( apNode[nFuncTok+iCur]->pStart->nType & PH7_TK_RPAREN /*')'*/){` |
|   502925 | 1507 | `							 iPtr--;` |
|   502925 | 1508 | `							 if( iPtr <= 0 ){` |
|   482367 | 1509 | `								 break;` |
|        - | 1510 | `							 }` |
|    10279 | 1511 | `						 }` |
|   637150 | 1512 | `					 }` |
|  1289625 | 1513 | `					 nFuncTok++;` |
|        5 | 1514 | `				 }` |
|   482367 | 1515 | `				 if( nFuncTok + iCur >= nToken ){` |
|        - | 1516 | `					 /* Syntax error */` |
...
|      ! 0 | 1521 | `					 return rc;` |
|        - | 1522 | `				 }` |
|   482367 | 1523 | `				 if(  iLeft < 0 \|\| !NODE_ISTERM(iLeft) /*\|\| ( apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec != 2)*/ ){` |
|        - | 1524 | `					 /* Syntax error */` |
...
|      ! 0 | 1529 | `					 return rc;` |
|        - | 1530 | `				 }` |
|   482367 | 1531 | `				 if( nFuncTok > 1 ){` |
|        - | 1532 | `					 /* Process function arguments */` |
|   420621 | 1533 | `					 rc = ExprProcessFuncArguments(&(*pGen),pNode,&apNode[iCur+1],nFuncTok-1);` |
|   420621 | 1534 | `					 if( rc != SXRET_OK ){` |
|       11 | 1535 | `						 return rc;` |
|        - | 1536 | `					 }` |
|   210304 | 1537 | `				 }` |
|        - | 1538 | `				 /* Link the node to the tree */` |
|   482359 | 1539 | `				 pNode->pLeft = apNode[iLeft];` |
|   482359 | 1540 | `				 apNode[iLeft] = 0;` |
|  1771955 | 1541 | `				 for( iPtr = 1; iPtr <= nFuncTok ; iPtr++ ){` |
|  1289601 | 1542 | `					 apNode[iCur+iPtr] = 0;` |
|   644803 | 1543 | `				 }` |
|   531002 | 1544 | `			 }else if (pNode->pOp->iOp == EXPR_OP_SUBSCRIPT ){` |
|        - | 1545 | `				 /* Subscripting */` |
...
|        - | 1621 | `			 }` |
|   386085 | 1622 | `		 }` |
|  2884923 | 1623 | `		 iLeft = iCur;` |
|  1442464 | 1624 | `	 }` |
|        - | 1625 | `	 /* Handle left associative (new, clone) operators */` |
|  5624999 | 1626 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  4760697 | 1627 | `		 if( apNode[iCur] == 0 ){` |
|  2672709 | 1628 | `			 continue;` |
|        - | 1629 | `		 }` |
...
|   864307 | 1695 | `	 iLeft = -1;` |
|  5629175 | 1696 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  4760697 | 1697 | `		 if( apNode[iCur] == 0 ){` |
|  2672709 | 1698 | `			 continue;` |
|        - | 1699 | `		 }` |
...
|  1048175 | 1710 | `	  }` |
|   868483 | 1711 | `	 iLeft = -1;` |
|  5629175 | 1712 | `	 for( iCur = nToken -  1 ; iCur >= 0 ; iCur-- ){` |
|  4760697 | 1713 | `		 if( apNode[iCur] == 0 ){` |
|  2676929 | 1714 | `			 continue;` |
|        - | 1715 | `		 }` |
...
|   868483 | 1736 | `	  iLeft = 0;` |
|  5629169 | 1737 | `	  for( iCur = nToken -  1 ; iCur >= 0 ; iCur-- ){` |
|  4760693 | 1738 | `		  if( apNode[iCur] ){` |
...
|  5629167 | 1772 | `	 for( iCur = nToken - 1 ; iCur >= 0 ; --iCur ){` |
|  4760691 | 1773 | `		 if( apNode[iCur] == 0 ){` |
|  2724657 | 1774 | `			 continue;` |
|        - | 1775 | `		 }` |
|  2036039 | 1776 | `		 pNode = apNode[iCur];` |
|  2036039 | 1777 | `		 if( pNode->pOp && pNode->pOp->iPrec == 5 && pNode->pLeft == 0 ){` |
|        - | 1778 | `			 sxi32 iL, iR;` |
...
|  9553155 | 1841 | `	 for( i = 7 ; i < 17 ; i++ ){` |
|  8684689 | 1842 | `		 iLeft = -1;` |
| 56291255 | 1843 | `		 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
| 47606581 | 1844 | `			 if( apNode[iCur] == 0 ){` |
| 30697047 | 1845 | `				 continue;` |
|        - | 1846 | `			 }` |
| 16909539 | 1847 | `			 pNode = apNode[iCur];` |
| 16909539 | 1848 | `			 if( pNode->pOp && pNode->pOp->iPrec == i && pNode->pLeft == 0 ){` |
...
|        - | 1914 | `	  */` |
|   868471 | 1915 | `	  iLeft = -1;` |
|  5617663 | 1916 | `	  for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  4751841 | 1917 | `		  if( apNode[iCur] == 0 ){` |
|  3239855 | 1918 | `			  continue;` |
|        - | 1919 | `		  }` |
|  1511991 | 1920 | `		  pNode = apNode[iCur];` |
|  1511991 | 1921 | `		  if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_QUESTY && pNode->pLeft == 0 ){` |
...
|        - | 1987 | `	  */` |
|   868469 | 1988 | `	 iRight = -1;` |
|  5628971 | 1989 | `	 for( iCur = nToken -  1 ; iCur >= 0 ; iCur--){` |
|  4760561 | 1990 | `		 if( apNode[iCur] == 0 ){` |
|  3571599 | 1991 | `			 continue;` |
|        - | 1992 | `		 }` |
|  1188967 | 1993 | `		 pNode = apNode[iCur];` |
|  1188967 | 1994 | `		 if( pNode->pOp && pNode->pOp->iPrec == 18 && pNode->pLeft == 0 ){` |
...
|   160161 | 2049 | `		 }` |
|  1188913 | 2050 | `		 iRight = iCur;` |
|   594459 | 2051 | `	 }` |
|        - | 2052 | `	 /* Process left associative binary operators that have the lowest precedence [i.e: and,or,xor] */` |
|  4342055 | 2053 | `	 for( i = 19 ; i < 23 ; i++ ){` |
|  3473645 | 2054 | `		 iLeft = -1;` |
| 22515597 | 2055 | `		 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
| 19041957 | 2056 | `			 if( apNode[iCur] == 0 ){` |
| 15567911 | 2057 | `				 continue;` |
|        - | 2058 | `			 }` |
|  3474051 | 2059 | `			 pNode = apNode[iCur];` |
|  3474051 | 2060 | `			 if( pNode->pOp && pNode->pOp->iPrec == i && pNode->pLeft == 0 ){` |
...
|       35 | 2078 | `			 }` |
|  3474051 | 2079 | `			 iLeft = iCur;` |
|  1737028 | 2080 | `		 }` |
|  1736825 | 2081 | `	 }` |
|        - | 2082 | `	 /* Point to the root of the expression tree */` |
|  4760465 | 2083 | `	 for( iCur = 1 ; iCur < nToken ; ++iCur ){` |
|  3892073 | 2084 | `		 if( apNode[iCur] ){` |
...
|        - | 2103 | `  */` |
|  1024504 | 2104 | `PH7_PRIVATE sxi32 PH7_ExprMakeTree(ph7_gen_state *pGen,SySet *pExprNode,ph7_expr_node **ppRoot)` |
|        5 | 2105 | `{` |
|        - | 2106 | `	ph7_expr_node **apNode;` |
|        - | 2107 | `	ph7_expr_node *pNode;` |
|        - | 2108 | `	sxi32 rc;` |
|        - | 2109 | `	/* Reset node container */` |
|  1024509 | 2110 | `	SySetReset(pExprNode);` |
|  1024509 | 2111 | `	pNode = 0; /* Prevent compiler warning */` |
|        - | 2112 | `	/* Extract nodes one after one until we hit the end of the input */` |
|        - | 2113 | `	{` |
|  1024509 | 2114 | `		int iLastWasTerm = 0;` |
|  1024509 | 2115 | `		int bAfterMemberOp = 0; /* TRUE iff the previous node was -> / ?-> / :: */` |
|  5553761 | 2116 | `		while( pGen->pIn < pGen->pEnd ){` |
|  4529291 | 2117 | `			rc = ExprExtractNode(&(*pGen),&pNode,iLastWasTerm,bAfterMemberOp);` |
|  4529291 | 2118 | `			if( rc != SXRET_OK ){` |
|       38 | 2119 | `				return rc;` |
|        - | 2120 | `			}` |
|        - | 2121 | `			/* Determine if this node is a term for short-array disambiguation */` |
|  4529257 | 2122 | `			if( pNode->xCode ){` |
|        - | 2123 | `				/* Node with compile handler: variable, literal, string, array, etc. */` |
|  2375153 | 2124 | `				iLastWasTerm = 1;` |
|  3341683 | 2125 | `			}else if( pNode->pOp ){` |
|        - | 2126 | `				/* Operator node */` |
|  1023133 | 2127 | `				iLastWasTerm = 0;` |
|   511569 | 2128 | `			}else{` |
|        - | 2129 | `				/* Delimiter: ')' and ']' end terms */` |
|  1130981 | 2130 | `				iLastWasTerm = (pNode->pStart->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB)) ? 1 : 0;` |
|        - | 2131 | `			}` |
...
|  4529257 | 2135 | `			bAfterMemberOp = ( pNode->pOp && pNode->pOp->iVmOp == PH7_OP_MEMBER );` |
|        - | 2136 | `			/* Save the extracted node */` |
|  4529257 | 2137 | `			SySetPut(pExprNode,(const void *)&pNode);` |
|        5 | 2138 | `		}` |
|        - | 2139 | `	}` |
|  1024475 | 2140 | `	if( SySetUsed(pExprNode) < 1 ){` |
|        - | 2141 | `		/* Empty expression [i.e: A semi-colon;] */` |
|      ! 0 | 2142 | `		*ppRoot = 0;` |
|      ! 0 | 2143 | `		return SXRET_OK;` |
|        - | 2144 | `	}` |
|  1024475 | 2145 | `	apNode = (ph7_expr_node **)SySetBasePtr(pExprNode);` |
|        - | 2146 | `	/* Make sure we are dealing with valid nodes */` |
|  1024475 | 2147 | `	rc = ExprVerifyNodes(&(*pGen),apNode,(sxi32)SySetUsed(pExprNode));` |
|  1024475 | 2148 | `	if( rc != SXRET_OK ){` |
...
|        - | 2154 | `	}` |
|        - | 2155 | `	/* Build the tree */` |
|  1024425 | 2156 | `	rc = ExprMakeTree(&(*pGen),apNode,(sxi32)SySetUsed(pExprNode));` |
|  1024425 | 2157 | `	if( rc != SXRET_OK ){` |
|        - | 2158 | `		/* Something goes wrong [i.e: Syntax error] */` |
|      103 | 2159 | `		*ppRoot = 0;` |
|      103 | 2160 | `		return rc;` |
|        - | 2161 | `	}` |
|        - | 2162 | `	/* Point to the root of the tree */` |
|  1024327 | 2163 | `	*ppRoot = apNode[0];` |
|  1024327 | 2164 | `	return SXRET_OK;` |
|   512257 | 2165 | `}` |
|        - | 2166 |  |
