...
|        - |  272 | ` */` |
|  1264102 |  273 | `PH7_PRIVATE const ph7_expr_op *  PH7_ExprExtractOperator(SyString *pStr,SyToken *pLast)` |
|        5 |  274 | `{` |
|  1264107 |  275 | `	sxu32 n = 0;` |
|        - |  276 | `	sxi32 rc;` |
|        - |  277 | `	/* Do a linear lookup on the operators table */` |
| 21713961 |  278 | `	for(;;){` |
| 43427927 |  279 | `		if( n >= SX_ARRAYSIZE(aOpTable) ){` |
|      ! 0 |  280 | `			break;` |
|        - |  281 | `		}` |
| 43427927 |  282 | `		if( SyisAlpha(aOpTable[n].sOp.zString[0]) ){` |
|        - |  283 | `			/* TICKET 1433-012: Alpha stream operators [i.e: and,or,xor,new...] */` |
|  3830377 |  284 | `			rc = SyStringCmp(pStr,&aOpTable[n].sOp,SyStrnicmp);` |
|  1915191 |  285 | `		}else{` |
| 39597555 |  286 | `			rc = SyStringCmp(pStr,&aOpTable[n].sOp,SyMemcmp);` |
|        - |  287 | `		}` |
| 43427927 |  288 | `		if( rc == 0 ){` |
|  1268783 |  289 | `			if( aOpTable[n].sOp.nByte != sizeof(char) \|\| (aOpTable[n].iOp != EXPR_OP_UMINUS && aOpTable[n].iOp != EXPR_OP_UPLUS) \|\| pLast == 0 ){` |
|        - |  290 | `				/* There is no ambiguity here,simply return the first operator seen */` |
|  1263555 |  291 | `				return &aOpTable[n];` |
|        - |  292 | `			}` |
|        - |  293 | `			/* Handle ambiguity */` |
|     5233 |  294 | `			if( pLast->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*'['*/\|PH7_TK_COLON/*:*/\|PH7_TK_COMMA/*,'*/) ){` |
...
|        4 |  306 | `			}` |
|     2338 |  307 | `		}` |
| 42163825 |  308 | `		++n; /* Next operator in the table */` |
|        5 |  309 | `	}` |
...
|        - |  317 | ` */` |
|   788702 |  318 | `PH7_PRIVATE void PH7_DelimitNestedTokens(SyToken *pIn,SyToken *pEnd,sxu32 nTokStart,sxu32 nTokEnd,SyToken **ppEnd)` |
|        5 |  319 | `{` |
|   788707 |  320 | `	SyToken *pCur = pIn;` |
|   788707 |  321 | `	sxi32 iNest = 1;` |
|  4257951 |  322 | `	for(;;){` |
|  8515907 |  323 | `		if( pCur >= pEnd ){` |
|      471 |  324 | `			break;` |
|        - |  325 | `		}` |
|  8515441 |  326 | `		if( pCur->nType & nTokStart ){` |
|        - |  327 | `			/* Increment nesting level */` |
|   407881 |  328 | `			iNest++;` |
|  8311503 |  329 | `		}else if( pCur->nType & nTokEnd ){` |
|        - |  330 | `			/* Decrement nesting level */` |
|  1196117 |  331 | `			iNest--;` |
|  1196117 |  332 | `			if( iNest <= 0 ){` |
|   788241 |  333 | `				break;` |
|        - |  334 | `			}` |
|   203938 |  335 | `		}` |
|        - |  336 | `		/* Advance cursor */` |
...
|        - |  373 | ` */` |
|  1118764 |  374 | `static sxi32 ExprVerifyNodes(ph7_gen_state *pGen,ph7_expr_node **apNode,sxi32 nNode)` |
|        5 |  375 | `{` |
|        - |  376 | `	sxi32 iParen,iSquare,iQuesty,iBraces;` |
|        - |  377 | `	sxi32 i,rc;` |
|        - |  378 |  |
|  1118769 |  379 | `	if( nNode > 0 && apNode[0]->pOp && (apNode[0]->pOp->iOp == EXPR_OP_ADD \|\| apNode[0]->pOp->iOp == EXPR_OP_SUB) ){` |
...
|       16 |  383 | `	}` |
|  1118769 |  384 | `	iParen = iSquare = iQuesty = iBraces = 0;` |
|  5918097 |  385 | `	for( i = 0 ; i < nNode ; ++i ){` |
|  4799367 |  386 | `		if( apNode[i]->xCode == PH7_CompileShortArray \|\| apNode[i]->xCode == PH7_CompileShortList ){` |
|        - |  387 | `			/* Short array/list literal: brackets are self-contained, skip */` |
|     1437 |  388 | `			continue;` |
|        - |  389 | `		}` |
|  4797935 |  390 | `		if( apNode[i]->pStart->nType & PH7_TK_LPAREN /*'('*/){` |
|   544547 |  391 | `			if( i > 0 && ( apNode[i-1]->xCode == PH7_CompileVariable \|\| apNode[i-1]->xCode == PH7_CompileLiteral \|\|` |
|    16530 |  392 | `				(apNode[i - 1]->pStart->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_SSTR\|PH7_TK_DSTR\|PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}'*/))) ){` |
|        - |  393 | `					/* Ticket 1433-033: Take care to ignore alpha-stream [i.e: or,xor] operators followed by an opening parenthesis */` |
|   519637 |  394 | `					if( (apNode[i - 1]->pStart->nType & PH7_TK_OP) == 0 ){` |
|        - |  395 | `						/* We are dealing with a postfix [i.e: function call]  operator` |
|        - |  396 | `						 * not a simple left parenthesis. Mark the node.` |
|        - |  397 | `						 */` |
|   519637 |  398 | `						apNode[i]->pStart->nType \|= PH7_TK_OP;` |
|   519637 |  399 | `						apNode[i]->pStart->pUserData = (void *)&sFCallOp; /* Function call operator */` |
|   519637 |  400 | `						apNode[i]->pOp = &sFCallOp;` |
|   259816 |  401 | `					}` |
|   259816 |  402 | `			}` |
|   544547 |  403 | `			iParen++;` |
|  4525664 |  404 | `		}else if( apNode[i]->pStart->nType & PH7_TK_RPAREN/*')*/){` |
|   544547 |  405 | `			if( iParen <= 0 ){` |
...
|        - |  411 | `			}` |
|   544535 |  412 | `			iParen--;` |
|  3981116 |  413 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OSB /*'['*/){` |
|    98835 |  414 | `			iSquare++;` |
|  3659436 |  415 | `		}else if (apNode[i]->pStart->nType & PH7_TK_CSB /*']'*/){` |
|    98849 |  416 | `			if( iSquare <= 0 ){` |
...
|        - |  422 | `			}` |
|    98843 |  423 | `			iSquare--;` |
|  3560596 |  424 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OCB /*'{'*/){` |
|       20 |  425 | `			iBraces++;` |
...
|        - |  469 |  |
|        7 |  470 | `			}` |
|  3511168 |  471 | `		}else if (apNode[i]->pStart->nType & PH7_TK_CCB /*'}'*/){` |
|       24 |  472 | `			if( iBraces <= 0 ){` |
...
|        - |  478 | `			}` |
|       10 |  479 | `			iBraces--;` |
|  3511143 |  480 | `		}else if ( apNode[i]->pStart->nType & PH7_TK_COLON ){` |
|     6837 |  481 | `			if( iQuesty > 0 ){` |
|     6583 |  482 | `				iQuesty--;` |
|     3548 |  483 | `			}else if( iParen <= 0 ){` |
...
|        6 |  491 | `				return rc;` |
|        5 |  492 | `			}` |
|  3507721 |  493 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OP ){` |
|   971697 |  494 | `			const ph7_expr_op *pOp = (const ph7_expr_op *)apNode[i]->pOp;` |
|   971697 |  495 | `			if( pOp->iOp == EXPR_OP_QUESTY ){` |
|     6585 |  496 | `				iQuesty++;` |
|   968407 |  497 | `			}else if( i > 0 && (pOp->iOp == EXPR_OP_UMINUS \|\| pOp->iOp == EXPR_OP_UPLUS)){` |
|      483 |  498 | `				if( apNode[i-1]->xCode == PH7_CompileVariable \|\| apNode[i-1]->xCode == PH7_CompileLiteral ){` |
...
|   485846 |  517 | `		}` |
|  2398953 |  518 | `	}` |
|  1118735 |  519 | `	if( iParen != 0 \|\| iSquare != 0 \|\| iQuesty != 0 \|\| iBraces != 0){` |
...
|       19 |  524 | `		return rc;` |
|        - |  525 | `	}` |
|  1118719 |  526 | `	return SXRET_OK;` |
|   559387 |  527 | `}` |
|        - |  528 | `/*` |
|        - |  529 | ` * Collect and assemble tokens holding a namespace path [i.e: namespace\to\const]` |
|        - |  530 | ` * or a simple literal [i.e: PHP_EOL].` |
|        - |  531 | ` */` |
|   888122 |  532 | `static void ExprAssembleLiteral(SyToken **ppCur,SyToken *pEnd)` |
|        5 |  533 | `{` |
|   888127 |  534 | `	SyToken *pIn = *ppCur;` |
|        - |  535 | `	/* Jump the first literal seen */` |
|   888127 |  536 | `	if( (pIn->nType & PH7_TK_NSSEP) == 0 ){` |
|   884235 |  537 | `		pIn++;` |
|   442115 |  538 | `	}` |
|   446034 |  539 | `	for(;;){` |
|   892073 |  540 | `		if(pIn < pEnd && (pIn->nType & PH7_TK_NSSEP) ){` |
|     3951 |  541 | `			pIn++;` |
...
|        - |  891 | ` */` |
|  4803446 |  892 | `static sxi32 ExprExtractNode(ph7_gen_state *pGen,ph7_expr_node **ppNode,int iLastWasTerm,int bAfterMemberOp)` |
|        5 |  893 | `{` |
|        - |  894 | `	ph7_expr_node *pNode;` |
|        - |  895 | `	SyToken *pCur;` |
|        - |  896 | `	sxi32 rc;` |
|        - |  897 | `	/* Allocate a new node */` |
|  4803451 |  898 | `	pNode = (ph7_expr_node *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_expr_node));` |
|  4803451 |  899 | `	if( pNode == 0 ){` |
...
|  4803451 |  906 | `	SyZero(pNode,sizeof(ph7_expr_node));` |
|  4803451 |  907 | `	SySetInit(&pNode->aNodeArgs,&pGen->pVm->sAllocator,sizeof(ph7_expr_node **));` |
|        - |  908 | `	/* Point to the head of the token stream */` |
|  4803451 |  909 | `	pCur = pNode->pStart = pGen->pIn;` |
|        - |  910 | `	/* Start collecting tokens */` |
|  4803451 |  911 | `	if( pCur->nType & PH7_TK_ELLIPSIS ){` |
...
|     3939 |  934 | `		return rc;` |
|        - |  935 | `	}` |
|  4799441 |  936 | `	if( (pCur->nType & PH7_TK_OSB) && !iLastWasTerm ){` |
|        - |  937 | `		/* PHP 5.4 short array syntax: [1, 2, 3] or ['key' => 'value'].` |
|        - |  938 | `		 * This '[' does not follow a term, so it is an array literal, not subscript.` |
|        - |  939 | `		 */` |
|     1439 |  940 | `		pCur++; /* Skip the opening '[' */` |
|     1439 |  941 | `		PH7_DelimitNestedTokens(pCur,pGen->pEnd,PH7_TK_OSB,PH7_TK_CSB,&pCur);` |
|     1439 |  942 | `		if( pCur < pGen->pEnd ){` |
|     1439 |  943 | `			pCur++; /* Skip past the closing ']' */` |
|      722 |  944 | `		}else{` |
...
|        - |  955 | `		 */` |
|     1552 |  956 | `		if( pCur < pGen->pEnd && (pCur->nType & PH7_TK_OP) ){` |
...
|        - |  962 | `			}` |
|      117 |  963 | `		}else{` |
|     1213 |  964 | `			pNode->xCode = PH7_CompileShortArray;` |
|        5 |  965 | `		}` |
|  4798724 |  966 | `	}else if( bAfterMemberOp && (pCur->nType & PH7_TK_OP) && (pCur->nType & PH7_TK_ID) ){` |
...
|  4797995 |  977 | `	}else if( (pCur->nType & PH7_TK_OP) && pCur->pUserData` |
|  1070578 |  978 | `		&& ((const ph7_expr_op *)pCur->pUserData)->iOp == EXPR_OP_CLONE` |
|   535323 |  979 | `		&& &pCur[1] < pGen->pEnd && (pCur[1].nType & PH7_TK_LPAREN) ){` |
...
|  4797980 | 1005 | `	}else if( pCur->nType & PH7_TK_OP ){` |
|        - | 1006 | `		/* Point to the instance that describe this operator */` |
|  1070561 | 1007 | `		pNode->pOp = (const ph7_expr_op *)pCur->pUserData;` |
|        - | 1008 | `		/* Advance the stream cursor */` |
|  1070561 | 1009 | `		pCur++;` |
|  4262691 | 1010 | `	}else if( pCur->nType & PH7_TK_DOLLAR ){` |
|        - | 1011 | `		/* Isolate variable */` |
|  2551285 | 1012 | `		while( pCur < pGen->pEnd && (pCur->nType & PH7_TK_DOLLAR) ){` |
|  1275651 | 1013 | `			pCur++; /* Variable variable */` |
|        5 | 1014 | `		}` |
|  1275639 | 1015 | `		if( pCur < pGen->pEnd ){` |
|  1275639 | 1016 | `			if (pCur->nType & (PH7_TK_ID\|PH7_TK_KEYWORD) ){` |
|        - | 1017 | `				/* Variable name */` |
|  1275609 | 1018 | `				pCur++;` |
|   637837 | 1019 | `			}else if( pCur->nType & PH7_TK_OCB /* '{' */ ){` |
|       27 | 1020 | `				pCur++;` |
...
|        9 | 1033 | `			}` |
|   637815 | 1034 | `		}` |
|  1275635 | 1035 | `		pNode->xCode = PH7_CompileVariable;` |
|  3089594 | 1036 | `	 }else if( pCur->nType & PH7_TK_KEYWORD ){` |
...
|        5 | 1154 | `		 }` |
|  2422973 | 1155 | `	 }else if( pCur->nType & (PH7_TK_NSSEP\|PH7_TK_ID) ){` |
|        - | 1156 | `		 /* Constants,function name,namespace path,class name... */` |
|   864269 | 1157 | `		 ExprAssembleLiteral(&pCur,pGen->pEnd);` |
|   864269 | 1158 | `		 pNode->xCode = PH7_CompileLiteral;` |
|   432137 | 1159 | `	 }else{` |
|  1529931 | 1160 | `		 if( (pCur->nType & (PH7_TK_LPAREN\|PH7_TK_RPAREN\|PH7_TK_COMMA\|PH7_TK_COLON\|PH7_TK_CSB\|PH7_TK_OCB\|PH7_TK_CCB)) == 0 ){` |
|        - | 1161 | `			 /* Point to the code generator routine */` |
|   335111 | 1162 | `			 pNode->xCode = PH7_GetNodeHandler(pCur->nType);` |
|   335111 | 1163 | `			 if( pNode->xCode == 0 ){` |
...
|  4799407 | 1176 | `	pNode->pEnd = pCur;` |
|        - | 1177 | `	/* Save the node for later processing */` |
|  4799407 | 1178 | `	*ppNode = pNode;` |
|        - | 1179 | `	/* Synchronize cursors */` |
|  4799407 | 1180 | `	pGen->pIn = pCur;` |
|  4799407 | 1181 | `	return SXRET_OK;` |
|  2401728 | 1182 | `}` |
|        - | 1183 | `/*` |
...
|        - | 1186 | ` * level is zero.` |
|        - | 1187 | ` */` |
|   101896 | 1188 | `PH7_PRIVATE sxi32 PH7_GetNextExpr(SyToken *pStart,SyToken *pEnd,SyToken **ppNext)` |
|        5 | 1189 | `{` |
|   101901 | 1190 | `	SyToken *pCur = pStart;` |
|   101901 | 1191 | `	sxi32 iNest = 0;` |
|   101901 | 1192 | `	if( pCur >= pEnd \|\| (pCur->nType & PH7_TK_SEMI/*';'*/) ){` |
|        - | 1193 | `		/* Last expression */` |
|    52353 | 1194 | `		return SXERR_EOF;` |
|        - | 1195 | `	}` |
|   204635 | 1196 | `	while( pCur < pEnd ){` |
|   187235 | 1197 | `		if( (pCur->nType & (PH7_TK_COMMA/*','*/\|PH7_TK_SEMI/*';'*/)) && iNest <= 0){` |
|    32153 | 1198 | `			break;` |
|        - | 1199 | `		}` |
|   155087 | 1200 | `		if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|    11241 | 1201 | `			iNest++;` |
|   149469 | 1202 | `		}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}*/) ){` |
|    11243 | 1203 | `			iNest--;` |
|     5619 | 1204 | `		}` |
|   155087 | 1205 | `		pCur++;` |
|        5 | 1206 | `	}` |
|    49553 | 1207 | `	*ppNext = pCur;` |
|    49553 | 1208 | `	return SXRET_OK;` |
|    50953 | 1209 | `}` |
|        - | 1210 | `/*` |
|        - | 1211 | ` * Free an expression tree.` |
|        - | 1212 | ` */` |
|  4098036 | 1213 | `static void ExprFreeTree(ph7_gen_state *pGen,ph7_expr_node *pNode)` |
|        5 | 1214 | `{` |
|  4098041 | 1215 | `	if( pNode->pLeft ){` |
|        - | 1216 | `		/* Release the left tree */` |
|  1513557 | 1217 | `		ExprFreeTree(&(*pGen),pNode->pLeft);` |
|   756776 | 1218 | `	}` |
|  4098041 | 1219 | `	if( pNode->pRight ){` |
|        - | 1220 | `		/* Release the right tree */` |
|   795077 | 1221 | `		ExprFreeTree(&(*pGen),pNode->pRight);` |
|   397536 | 1222 | `	}` |
|  4098041 | 1223 | `	if( pNode->pCond ){` |
|        - | 1224 | `		/* Release the conditional tree used by the ternary operator */` |
|     6581 | 1225 | `		ExprFreeTree(&(*pGen),pNode->pCond);` |
|     3288 | 1226 | `	}` |
|  4098041 | 1227 | `	if( SySetUsed(&pNode->aNodeArgs) > 0 ){` |
|        - | 1228 | `		ph7_expr_node **apArg;` |
|        - | 1229 | `		sxu32 n;` |
|        - | 1230 | `		/* Release node arguments */` |
|   537005 | 1231 | `		apArg = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  1150397 | 1232 | `		for( n = 0 ; n < SySetUsed(&pNode->aNodeArgs) ; ++n ){` |
|   613397 | 1233 | `			ExprFreeTree(&(*pGen),apArg[n]);` |
|   306701 | 1234 | `		}` |
|   537005 | 1235 | `		SySetRelease(&pNode->aNodeArgs);` |
|   268500 | 1236 | `	}` |
|        - | 1237 | `	/* Finally,release this node */` |
|  4098041 | 1238 | `	SyMemBackendPoolFree(&pGen->pVm->sAllocator,pNode);` |
|  4098041 | 1239 | `}` |
|        - | 1240 | `/*` |
|        - | 1241 | ` * Free an expression tree.` |
|        - | 1242 | ` * This function is a wrapper around ExprFreeTree() defined above.` |
|        - | 1243 | ` */` |
|  1118798 | 1244 | `PH7_PRIVATE sxi32 PH7_ExprFreeTree(ph7_gen_state *pGen,SySet *pNodeSet)` |
|        5 | 1245 | `{` |
|        - | 1246 | `	ph7_expr_node **apNode;` |
|        - | 1247 | `	sxu32 n;` |
|  1118803 | 1248 | `	apNode = (ph7_expr_node **)SySetBasePtr(pNodeSet);` |
|  5918281 | 1249 | `	for( n = 0  ; n < SySetUsed(pNodeSet) ; ++n ){` |
|  4799483 | 1250 | `		if( apNode[n] ){` |
|  1119137 | 1251 | `			ExprFreeTree(&(*pGen),apNode[n]);` |
|   559566 | 1252 | `		}` |
|  2399744 | 1253 | `	}` |
|  1118803 | 1254 | `	return SXRET_OK;` |
|        5 | 1255 | `}` |
|        - | 1256 | `/*` |
...
|        - | 1262 | ` */` |
|  1427148 | 1263 | `PH7_PRIVATE int PH7_ExprContainsNullsafe(ph7_expr_node *pNode)` |
|        5 | 1264 | `{` |
|  1427153 | 1265 | `	if( pNode == 0 ){` |
|   881599 | 1266 | `		return 0;` |
|        - | 1267 | `	}` |
|   545559 | 1268 | `	if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW ){` |
|       16 | 1269 | `		return 1;` |
|        - | 1270 | `	}` |
|   545547 | 1271 | `	if( PH7_ExprContainsNullsafe(pNode->pLeft) ){` |
|        6 | 1272 | `		return 1;` |
|        - | 1273 | `	}` |
|   545543 | 1274 | `	if( PH7_ExprContainsNullsafe(pNode->pRight) ){` |
|      ! 0 | 1275 | `		return 1;` |
|        - | 1276 | `	}` |
|   545543 | 1277 | `	return 0;` |
|   713579 | 1278 | `}` |
|        - | 1279 | `/*` |
|        - | 1280 | ` * Check if the given node is a modifialbe l/r-value.` |
|        - | 1281 | ` * Return TRUE if modifiable.FALSE otherwise.` |
|        - | 1282 | ` */` |
|   329378 | 1283 | `static int ExprIsModifiableValue(ph7_expr_node *pNode,sxu8 bFunc)` |
|        5 | 1284 | `{` |
|        - | 1285 | `	sxi32 iExprOp;` |
|   329383 | 1286 | `	if( pNode->pOp == 0 ){` |
|   205303 | 1287 | `		return pNode->xCode == PH7_CompileVariable ? TRUE : FALSE;` |
|        - | 1288 | `	}` |
|   124085 | 1289 | `	iExprOp = pNode->pOp->iOp;` |
|   124085 | 1290 | `	if( iExprOp == EXPR_OP_ARROW /*'->' */ \|\| iExprOp == EXPR_OP_DC /*'::'*/ ){` |
|    85109 | 1291 | `			return TRUE;` |
|        - | 1292 | `	}` |
|    38981 | 1293 | `	if( iExprOp == EXPR_OP_SUBSCRIPT/*'[]'*/ ){` |
|    38975 | 1294 | `		if( pNode->pLeft->pOp ) {` |
|       70 | 1295 | `			if( pNode->pLeft->pOp->iOp != EXPR_OP_SUBSCRIPT /*'['*/ && pNode->pLeft->pOp->iOp != EXPR_OP_ARROW /*'->'*/` |
|       31 | 1296 | `				&& pNode->pLeft->pOp->iOp != EXPR_OP_DC /*'::'*/){` |
|      ! 0 | 1297 | `				return FALSE;` |
|        5 | 1298 | `			}` |
|    38940 | 1299 | `		}else if( pNode->pLeft->xCode != PH7_CompileVariable ){` |
|      ! 0 | 1300 | `			return FALSE;` |
|        - | 1301 | `		}` |
|    38975 | 1302 | `		return TRUE;` |
|        - | 1303 | `	}` |
...
|        - | 1320 | ` */` |
|   457500 | 1321 | `static sxi32 ExprProcessFuncArguments(ph7_gen_state *pGen,ph7_expr_node *pOp,ph7_expr_node **apNode,sxi32 nToken)` |
|        5 | 1322 | `{` |
...
|   457505 | 1326 | `	iCur = 0;` |
|   495684 | 1327 | `	for(;;){` |
|   991373 | 1328 | `		if( iCur >= nToken ){` |
|        - | 1329 | `			/* No more arguments to process */` |
|   457479 | 1330 | `			break;` |
|        - | 1331 | `		}` |
|   533899 | 1332 | `		iNode = iCur;` |
|   533899 | 1333 | `		iNest = 0;` |
|  1336145 | 1334 | `		while( iCur < nToken ){` |
|   878669 | 1335 | `			if( apNode[iCur] ){` |
|   863293 | 1336 | `				if( (apNode[iCur]->pStart->nType & PH7_TK_COMMA) && apNode[iCur]->pLeft == 0 && iNest <= 0 ){` |
|    38214 | 1337 | `					break;` |
|   786870 | 1338 | `				}else if( (apNode[iCur]->pStart->nType & (PH7_TK_LPAREN\|PH7_TK_OSB\|PH7_TK_OCB))` |
|   413945 | 1339 | `					&& apNode[iCur]->xCode != PH7_CompileShortArray` |
|    40746 | 1340 | `					&& apNode[iCur]->xCode != PH7_CompileShortList ){` |
...
|    40467 | 1347 | `					iNest++;` |
|   766644 | 1348 | `				}else if( apNode[iCur]->pStart->nType & (PH7_TK_RPAREN\|PH7_TK_CCB\|PH7_TK_CSB) ){` |
|    40467 | 1349 | `					iNest--;` |
|    20231 | 1350 | `				}` |
|   393435 | 1351 | `			}` |
|   802251 | 1352 | `			iCur++;` |
|        5 | 1353 | `		}` |
|   533899 | 1354 | `		if( iCur > iNode ){` |
|   533893 | 1355 | `			SyString sArgName = {0, 0};` |
...
|   533888 | 1359 | `			if( (iCur - iNode) >= 2` |
|   293544 | 1360 | `				&& apNode[iNode]` |
|    53200 | 1361 | `				&& (apNode[iNode]->pStart->nType & (PH7_TK_ID\|PH7_TK_KEYWORD))` |
|    31337 | 1362 | `				&& apNode[iNode]->xCode == PH7_CompileLiteral` |
|     9328 | 1363 | `				&& apNode[iNode+1]` |
|     9187 | 1364 | `				&& (apNode[iNode+1]->pStart->nType & PH7_TK_COLON) ){` |
...
|        - | 1383 | `				}` |
|      124 | 1384 | `			}` |
|   533886 | 1385 | `			if( apNode[iNode] && (apNode[iNode]->pStart->nType & PH7_TK_AMPER /*'&'*/) && ((iCur - iNode) == 2)` |
...
|      ! 0 | 1391 | `			}` |
|   533891 | 1392 | `			ExprMakeTree(&(*pGen),&apNode[iNode],iCur-iNode);` |
|   533891 | 1393 | `			if( apNode[iNode] ){` |
|   533891 | 1394 | `				if( sArgName.nByte > 0 ){` |
...
|   533891 | 1399 | `				SySetPut(&pOp->aNodeArgs,(const void *)&apNode[iNode]);` |
|   266948 | 1400 | `			}else{` |
...
|   533891 | 1419 | `		if( iCur < nToken && apNode[iCur] && (apNode[iCur]->pStart->nType & PH7_TK_COMMA) ){` |
|    76417 | 1420 | `			iCur++;` |
|    76417 | 1421 | `			if( iCur >= nToken ){` |
|        - | 1422 | `				/* Trailing comma after last argument */` |
|       19 | 1423 | `				break;` |
|        - | 1424 | `			}` |
|    38197 | 1425 | `		}` |
|        5 | 1426 | `	}` |
|   457497 | 1427 | `	return SXRET_OK;` |
|   228755 | 1428 | `}` |
|        - | 1429 | ` /*` |
...
|        - | 1433 | `  */` |
|  1774292 | 1434 | ` static sxi32 ExprMakeTree(ph7_gen_state *pGen,ph7_expr_node **apNode,sxi32 nToken)` |
|        5 | 1435 | ` {` |
|        - | 1436 | `	 sxi32 i,iLeft,iRight;` |
|        - | 1437 | `	 ph7_expr_node *pNode;` |
|        - | 1438 | `	 sxi32 iCur;` |
|        - | 1439 | `	 sxi32 rc;` |
|  1774297 | 1440 | `	 if( nToken <= 0 \|\| (nToken == 1 && apNode[0]->xCode) ){` |
|        - | 1441 | `		 /* TICKET 1433-17: self evaluating node */` |
|   835659 | 1442 | `		 return SXRET_OK;` |
|        - | 1443 | `	 }` |
|        - | 1444 | `	 /* Process expressions enclosed in parenthesis first */` |
|  5772743 | 1445 | `	 for( iCur =  0 ; iCur < nToken ; ++iCur ){` |
|        - | 1446 | `		 sxi32 iNest;` |
...
|        - | 1449 | `		  */` |
|  4834107 | 1450 | `		 if( apNode[iCur] == 0 \|\| apNode[iCur]->pStart->nType != PH7_TK_LPAREN ){` |
|  4809207 | 1451 | `			 continue;` |
|        - | 1452 | `		 }` |
|    24905 | 1453 | `		 iNest = 1;` |
|    24905 | 1454 | `		 iLeft = iCur;` |
|        - | 1455 | `		 /* Find the closing parenthesis */` |
|    24905 | 1456 | `		 iCur++;` |
|   163479 | 1457 | `		 while( iCur < nToken ){` |
|   163479 | 1458 | `			 if( apNode[iCur] ){` |
|   163479 | 1459 | `				 if( apNode[iCur]->pStart->nType & PH7_TK_RPAREN /* ')' */){` |
|        - | 1460 | `					 /* Decrement nesting level */` |
|    41225 | 1461 | `					 iNest--;` |
|    41225 | 1462 | `					 if( iNest <= 0 ){` |
|    24905 | 1463 | `						 break;` |
|        5 | 1464 | `					 }` |
|   130419 | 1465 | `				 }else if( apNode[iCur]->pStart->nType & PH7_TK_LPAREN /* '(' */ ){` |
...
|   138579 | 1470 | `			 iCur++;` |
|        5 | 1471 | `		 }` |
|    24905 | 1472 | `		 if( iCur - iLeft > 1 ){` |
|        - | 1473 | `			 sxi32 j;` |
|        - | 1474 | `			 /* Recurse and process this expression */` |
|    24905 | 1475 | `			 rc = ExprMakeTree(&(*pGen),&apNode[iLeft + 1],iCur - iLeft - 1);` |
|    24905 | 1476 | `			 if( rc != SXRET_OK ){` |
|        3 | 1477 | `				 return rc;` |
|        - | 1478 | `			 }` |
...
|    24903 | 1482 | `			 for( j = iLeft + 1 ; j < iCur ; ++j ){` |
|    24903 | 1483 | `				 if( apNode[j] ){` |
|    24903 | 1484 | `					 apNode[j]->iFlags \|= EXPR_NODE_PARENS;` |
|    24903 | 1485 | `					 break;` |
|        - | 1486 | `				 }` |
|      ! 0 | 1487 | `			 }` |
|    12449 | 1488 | `		 }` |
|        - | 1489 | `		 /* Free the left and right nodes */` |
|    24903 | 1490 | `		 ExprFreeTree(&(*pGen),apNode[iLeft]);` |
|    24903 | 1491 | `		 ExprFreeTree(&(*pGen),apNode[iCur]);` |
|    24903 | 1492 | `		 apNode[iLeft] = 0;` |
|    24903 | 1493 | `		 apNode[iCur] = 0;` |
|    12454 | 1494 | `	 }` |
|        - | 1495 | `	  /* Process expressions enclosed in braces */` |
|  5927799 | 1496 | `	 for( iCur =  0 ; iCur < nToken ; ++iCur ){` |
|        - | 1497 | `		 sxi32 iNest;` |
...
|        - | 1500 | `		  */` |
|  4997555 | 1501 | `		 if( apNode[iCur] == 0 \|\| apNode[iCur]->pStart->nType != PH7_TK_OCB ){` |
|  4997547 | 1502 | `			 continue;` |
|        - | 1503 | `		 }` |
|       10 | 1504 | `		 iNest = 1;` |
|       10 | 1505 | `		 iLeft = iCur;` |
...
|   930249 | 1537 | `	 iLeft = -1;` |
|  5927777 | 1538 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  4997545 | 1539 | `		 if( apNode[iCur] == 0 ){` |
|  1933433 | 1540 | `			 continue;` |
|        - | 1541 | `		 }` |
|  3064117 | 1542 | `		 pNode = apNode[iCur];` |
|  3064117 | 1543 | `		 if( pNode->pOp && pNode->pOp->iPrec == 2 && pNode->pLeft == 0  ){` |
|   810745 | 1544 | `			 if( pNode->pOp->iOp == EXPR_OP_FUNC_CALL ){` |
|        - | 1545 | `				 /* Collect function arguments */` |
|   519633 | 1546 | `				 sxi32 iPtr = 0;` |
|   519633 | 1547 | `				 sxi32 nFuncTok = 0;` |
|  1917927 | 1548 | `				 while( nFuncTok + iCur < nToken ){` |
|  1917927 | 1549 | `					 if( apNode[nFuncTok+iCur] ){` |
|  1902551 | 1550 | `						 if( apNode[nFuncTok+iCur]->pStart->nType & PH7_TK_LPAREN /*'('*/ ){` |
|   548109 | 1551 | `							 iPtr++;` |
|  1628499 | 1552 | `						 }else if ( apNode[nFuncTok+iCur]->pStart->nType & PH7_TK_RPAREN /*')'*/){` |
|   548109 | 1553 | `							 iPtr--;` |
|   548109 | 1554 | `							 if( iPtr <= 0 ){` |
|   519633 | 1555 | `								 break;` |
|        - | 1556 | `							 }` |
|    14238 | 1557 | `						 }` |
|   691459 | 1558 | `					 }` |
|  1398299 | 1559 | `					 nFuncTok++;` |
|        5 | 1560 | `				 }` |
|   519633 | 1561 | `				 if( nFuncTok + iCur >= nToken ){` |
|        - | 1562 | `					 /* Syntax error */` |
...
|      ! 0 | 1567 | `					 return rc;` |
|        - | 1568 | `				 }` |
|   519633 | 1569 | `				 if(  iLeft < 0 \|\| !NODE_ISTERM(iLeft) /*\|\| ( apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec != 2)*/ ){` |
|        - | 1570 | `					 /* Syntax error */` |
...
|      ! 0 | 1575 | `					 return rc;` |
|        - | 1576 | `				 }` |
|   519633 | 1577 | `				 if( nFuncTok > 1 ){` |
|        - | 1578 | `					 /* Process function arguments */` |
|   457505 | 1579 | `					 rc = ExprProcessFuncArguments(&(*pGen),pNode,&apNode[iCur+1],nFuncTok-1);` |
|   457505 | 1580 | `					 if( rc != SXRET_OK ){` |
|       10 | 1581 | `						 return rc;` |
|        - | 1582 | `					 }` |
|   228746 | 1583 | `				 }` |
|        - | 1584 | `				 /* Link the node to the tree */` |
|   519625 | 1585 | `				 pNode->pLeft = apNode[iLeft];` |
|   519625 | 1586 | `				 apNode[iLeft] = 0;` |
|  1917895 | 1587 | `				 for( iPtr = 1; iPtr <= nFuncTok ; iPtr++ ){` |
|  1398275 | 1588 | `					 apNode[iCur+iPtr] = 0;` |
|   699140 | 1589 | `				 }` |
...
|        - | 1600 | `				 {` |
|   519625 | 1601 | `					 sxi32 iNew = iLeft - 1;` |
|   521797 | 1602 | `					 while( iNew >= 0 && apNode[iNew] == 0 ){` |
|     2177 | 1603 | `						 iNew--;` |
|        5 | 1604 | `					 }` |
|   519620 | 1605 | `					 if( iNew >= 0 && apNode[iNew]->pOp` |
|   237534 | 1606 | `						 && apNode[iNew]->pOp->iOp == EXPR_OP_NEW` |
|   142598 | 1607 | `						 && apNode[iNew]->pLeft == 0 ){` |
...
|    23836 | 1612 | `					 }` |
|        - | 1613 | `				 }` |
|   550927 | 1614 | `			 }else if (pNode->pOp->iOp == EXPR_OP_SUBSCRIPT ){` |
|        - | 1615 | `				 /* Subscripting */` |
|    98843 | 1616 | `				 sxi32 iArrTok = iCur + 1;` |
|    98843 | 1617 | `				 sxi32 iNest = 1;` |
|    98838 | 1618 | `				 if(  iLeft < 0 \|\| apNode[iLeft] == 0 \|\| (apNode[iLeft]->pOp == 0 && (apNode[iLeft]->xCode != PH7_CompileVariable &&` |
...
|    98838 | 1622 | `					 ( apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec != 2 /* postfix */` |
...
|   178485 | 1634 | `				 while( iArrTok < nToken ){` |
|   178485 | 1635 | `					 if( apNode[iArrTok] ){` |
|   178453 | 1636 | `						 if( apNode[iArrTok]->pOp && apNode[iArrTok]->pOp->iOp == EXPR_OP_SUBSCRIPT &&  apNode[iArrTok]->pLeft == 0){` |
|        - | 1637 | `							 /* Increment nesting level */` |
|      ! 0 | 1638 | `							 iNest++;` |
|   178453 | 1639 | `						 }else if( apNode[iArrTok]->pStart->nType & PH7_TK_CSB /*']'*/){` |
|        - | 1640 | `							 /* Decrement nesting level */` |
|    98843 | 1641 | `							 iNest--;` |
|    98843 | 1642 | `							 if( iNest <= 0 ){` |
|    98843 | 1643 | `								 break;` |
|        - | 1644 | `							 }` |
|      ! 0 | 1645 | `						 }` |
|    39805 | 1646 | `					 }` |
|    79647 | 1647 | `					 ++iArrTok;` |
|        5 | 1648 | `				 }` |
|    98843 | 1649 | `				 if( iArrTok > iCur + 1 ){` |
|        - | 1650 | `					 /* Recurse and process this expression */` |
|    79511 | 1651 | `					 rc = ExprMakeTree(&(*pGen),&apNode[iCur+1],iArrTok - iCur - 1);` |
|    79511 | 1652 | `					 if( rc != SXRET_OK ){` |
|      ! 0 | 1653 | `						 return rc;` |
|        - | 1654 | `					 }` |
|        - | 1655 | `					 /* Link the node to it's index */` |
|    79511 | 1656 | `					 SySetPut(&pNode->aNodeArgs,(const void *)&apNode[iCur+1]);` |
|    39753 | 1657 | `				 }` |
|        - | 1658 | `				 /* Link the node to the tree */` |
|    98843 | 1659 | `				 pNode->pLeft = apNode[iLeft];` |
|    98843 | 1660 | `				 pNode->pRight = 0;` |
|    98843 | 1661 | `				 apNode[iLeft] = 0;` |
|   277323 | 1662 | `				 for( iNest = iCur + 1 ; iNest <= iArrTok ; ++iNest ){` |
|   178485 | 1663 | `					 apNode[iNest] = 0;` |
|    89245 | 1664 | `				 }` |
|    49424 | 1665 | `			 }else{` |
|        - | 1666 | `				 /* Member access operators [i.e: '->','::'] */` |
|   192279 | 1667 | `				  iRight = iCur + 1;` |
|   192285 | 1668 | `				 while( iRight < nToken && apNode[iRight] == 0 ){` |
|        7 | 1669 | `					 iRight++;` |
|        1 | 1670 | `				 }` |
|   192279 | 1671 | `				 if( iRight >= nToken \|\| iLeft < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|        - | 1672 | `					 /* Syntax error */` |
...
|   192275 | 1680 | `				 pNode->pLeft = apNode[iLeft];` |
|   192270 | 1681 | `				 if( (pNode->pOp->iOp == EXPR_OP_ARROW /*'->'*/ \|\| pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW /*'?->'*/)` |
|   192081 | 1682 | `					 && pNode->pLeft->pOp == 0 &&` |
|   191771 | 1683 | `					 pNode->pLeft->xCode != PH7_CompileVariable &&` |
...
|      ! 0 | 1695 | `						 return rc;` |
|        - | 1696 | `				 }` |
|   192275 | 1697 | `				 pNode->pRight = apNode[iRight];` |
|   192275 | 1698 | `				 apNode[iLeft] = apNode[iRight] = 0;` |
|        - | 1699 | `			 }` |
|   405364 | 1700 | `		 }` |
|  3064105 | 1701 | `		 iLeft = iCur;` |
|  1532055 | 1702 | `	 }` |
|        - | 1703 | `	 /* Handle left associative (new, clone) operators */` |
|  5927745 | 1704 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  4997513 | 1705 | `		 if( apNode[iCur] == 0 ){` |
|  2792101 | 1706 | `			 continue;` |
|        - | 1707 | `		 }` |
|  2205417 | 1708 | `		 pNode = apNode[iCur];` |
|  2205417 | 1709 | `		 if( pNode->pOp && pNode->pOp->iPrec == 1 && pNode->pLeft == 0 ){` |
|        - | 1710 | `			 SyToken *pToken;` |
...
|   930237 | 1790 | `	 iLeft = -1;` |
|  5931941 | 1791 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  4997513 | 1792 | `		 if( apNode[iCur] == 0 ){` |
|  2792101 | 1793 | `			 continue;` |
|        - | 1794 | `		 }` |
|  2205417 | 1795 | `		 pNode = apNode[iCur];` |
|  2205417 | 1796 | `		 if( pNode->pOp && pNode->pOp->iPrec == 3 && pNode->pLeft == 0){` |
...
|     2120 | 1802 | `			 }` |
|    12092 | 1803 | `		  }` |
|  2209613 | 1804 | `		 iLeft = iCur;` |
|  1106907 | 1805 | `	  }` |
|   934433 | 1806 | `	 iLeft = -1;` |
|  5931941 | 1807 | `	 for( iCur = nToken -  1 ; iCur >= 0 ; iCur-- ){` |
|  4997513 | 1808 | `		 if( apNode[iCur] == 0 ){` |
|  2796341 | 1809 | `			 continue;` |
|        - | 1810 | `		 }` |
|  2201177 | 1811 | `		 pNode = apNode[iCur];` |
|  2201177 | 1812 | `		 if( pNode->pOp && pNode->pOp->iPrec == 3 && pNode->pLeft == 0){` |
...
|     5776 | 1827 | `		  }` |
|  2201177 | 1828 | `		 iLeft = iCur;` |
|  1100591 | 1829 | `	 }` |
|        - | 1830 | `	 /* Handle right associative unary and cast operators [i.e: !,(string),~...]  with precedence 4*/` |
|   934433 | 1831 | `	  iLeft = 0;` |
|  5931935 | 1832 | `	  for( iCur = nToken -  1 ; iCur >= 0 ; iCur-- ){` |
|  4997509 | 1833 | `		  if( apNode[iCur] ){` |
|  2189621 | 1834 | `			  pNode = apNode[iCur];` |
|  2189621 | 1835 | `			  if( pNode->pOp && pNode->pOp->iPrec == 4 && pNode->pLeft == 0){` |
|    36365 | 1836 | `				  if( iLeft > 0 ){` |
|        - | 1837 | `					  /* Link the node to the tree */` |
|    36363 | 1838 | `					  pNode->pLeft = apNode[iLeft];` |
|    36363 | 1839 | `					  apNode[iLeft] = 0;` |
|    36363 | 1840 | `					  if( pNode->pLeft && pNode->pLeft->pOp && pNode->pLeft->pOp->iPrec > 4 ){` |
|       89 | 1841 | `						  if( pNode->pLeft->pLeft == 0 \|\| pNode->pLeft->pRight == 0 ){` |
|        - | 1842 | `							   /* Syntax error */` |
...
|  5931933 | 1867 | `	 for( iCur = nToken - 1 ; iCur >= 0 ; --iCur ){` |
|  4997507 | 1868 | `		 if( apNode[iCur] == 0 ){` |
|  2844363 | 1869 | `			 continue;` |
|        - | 1870 | `		 }` |
|  2153149 | 1871 | `		 pNode = apNode[iCur];` |
|  2153149 | 1872 | `		 if( pNode->pOp && pNode->pOp->iPrec == 5 && pNode->pLeft == 0 ){` |
|        - | 1873 | `			 sxi32 iL, iR;` |
...
| 10278605 | 1936 | `	 for( i = 7 ; i < 17 ; i++ ){` |
|  9344189 | 1937 | `		 iLeft = -1;` |
| 59318915 | 1938 | `		 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
| 49974741 | 1939 | `			 if( apNode[iCur] == 0 ){` |
| 32085029 | 1940 | `				 continue;` |
|        - | 1941 | `			 }` |
| 17889717 | 1942 | `			 pNode = apNode[iCur];` |
| 17889717 | 1943 | `			 if( pNode->pOp && pNode->pOp->iPrec == i && pNode->pLeft == 0 ){` |
|        - | 1944 | `				 /* Get the right node */` |
|   266783 | 1945 | `				 iRight = iCur + 1;` |
|   378203 | 1946 | `				 while( iRight < nToken && apNode[iRight] == 0 ){` |
|   111425 | 1947 | `					 iRight++;` |
|        5 | 1948 | `				 }` |
|   266783 | 1949 | `				 if( iRight >= nToken \|\| iLeft < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|        - | 1950 | `					 /* Syntax error */` |
...
|       11 | 1955 | `					 return rc;` |
|        - | 1956 | `				 }` |
|   266775 | 1957 | `				 if( pNode->pOp->iOp == EXPR_OP_REF ){` |
|        - | 1958 | `					 sxi32  iTmp;` |
...
|   266773 | 1999 | `				 pNode->pLeft = apNode[iLeft];` |
|   266773 | 2000 | `				 pNode->pRight = apNode[iRight];` |
|   266773 | 2001 | `				 apNode[iLeft] = apNode[iRight] = 0;` |
|   133384 | 2002 | `			 }` |
| 17889707 | 2003 | `			 iLeft = iCur;` |
|  8944856 | 2004 | `		 }` |
|  4672092 | 2005 | `	 }` |
...
|        - | 2009 | `	  */` |
|   934421 | 2010 | `	  iLeft = -1;` |
|  5904699 | 2011 | `	  for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  4976861 | 2012 | `		  if( apNode[iCur] == 0 ){` |
|  3377083 | 2013 | `			  continue;` |
|        - | 2014 | `		  }` |
|  1599783 | 2015 | `		  pNode = apNode[iCur];` |
|  1599783 | 2016 | `		  if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_QUESTY && pNode->pLeft == 0 ){` |
|     6583 | 2017 | `			  sxi32 iNest = 1;` |
|     6583 | 2018 | `			  if( iLeft < 0 \|\| !NODE_ISTERM(iLeft) ){` |
...
|     6581 | 2027 | `			  iRight = iCur + 1;` |
|    13429 | 2028 | `			  while( iRight < nToken  ){` |
|    13429 | 2029 | `				  if( apNode[iRight] ){` |
|    13089 | 2030 | `					  if( apNode[iRight]->pOp && apNode[iRight]->pOp->iOp == EXPR_OP_QUESTY && apNode[iRight]->pCond == 0){` |
|        - | 2031 | `						  /* Increment nesting level */` |
|      ! 0 | 2032 | `						  ++iNest;` |
|    13089 | 2033 | `					  }else if( apNode[iRight]->pStart->nType & PH7_TK_COLON /*:*/ ){` |
|        - | 2034 | `						  /* Decrement nesting level */` |
|     6581 | 2035 | `						  --iNest;` |
|     6581 | 2036 | `						  if( iNest <= 0 ){` |
|     6581 | 2037 | `							  break;` |
|        - | 2038 | `						  }` |
|      ! 0 | 2039 | `					  }` |
|     3254 | 2040 | `				  }` |
|     6853 | 2041 | `				  iRight++;` |
|        5 | 2042 | `			  }` |
|     6581 | 2043 | `			  if( iRight > iCur + 1 ){` |
|        - | 2044 | `				  /* Recurse and process the then expression */` |
|     6513 | 2045 | `				  rc = ExprMakeTree(&(*pGen),&apNode[iCur + 1],iRight - iCur - 1);` |
|     6513 | 2046 | `				  if( rc != SXRET_OK ){` |
|      ! 0 | 2047 | `					  return rc;` |
|        - | 2048 | `				  }` |
|        - | 2049 | `				  /* Link the node to the tree */` |
|     6513 | 2050 | `				  pNode->pLeft = apNode[iCur + 1];` |
|     3254 | 2051 | `			  }else{` |
|        - | 2052 | `				  /* Elvis operator (?:): pLeft stays NULL.` |
|        - | 2053 | `				   * NODE_ISTERM() recognizes this node as complete via pCond. */` |
|        - | 2054 | `			  }` |
|     6581 | 2055 | `			  apNode[iCur + 1] = 0;` |
|     6581 | 2056 | `			  if( iRight + 1 < nToken ){` |
|        - | 2057 | `				  /* Recurse and process the else expression */` |
|     6581 | 2058 | `				  rc = ExprMakeTree(&(*pGen),&apNode[iRight + 1],nToken - iRight - 1);` |
|     6581 | 2059 | `				  if( rc != SXRET_OK ){` |
|      ! 0 | 2060 | `					  return rc;` |
|        - | 2061 | `				  }` |
|        - | 2062 | `				  /* Link the node to the tree */` |
|     6581 | 2063 | `				  pNode->pRight = apNode[iRight + 1];` |
|     6581 | 2064 | `				  apNode[iRight + 1] =  apNode[iRight] = 0;` |
|     3293 | 2065 | `			  }else{` |
...
|     6581 | 2073 | `			  pNode->pCond  = apNode[iLeft];` |
|     6581 | 2074 | `			  apNode[iLeft] = 0;` |
|     6581 | 2075 | `			  break;` |
|        - | 2076 | `		  }` |
|  1593205 | 2077 | `		  iLeft = iCur;` |
|   796605 | 2078 | `	  }` |
...
|        - | 2082 | `	  */` |
|   934419 | 2083 | `	 iRight = -1;` |
|  5931737 | 2084 | `	 for( iCur = nToken -  1 ; iCur >= 0 ; iCur--){` |
|  4997377 | 2085 | `		 if( apNode[iCur] == 0 ){` |
|  3733511 | 2086 | `			 continue;` |
|        - | 2087 | `		 }` |
|  1263871 | 2088 | `		 pNode = apNode[iCur];` |
|  1263871 | 2089 | `		 if( pNode->pOp && pNode->pOp->iPrec == 18 && pNode->pLeft == 0 ){` |
|        - | 2090 | `			 /* Get the left node */` |
|   329335 | 2091 | `			 iLeft = iCur - 1;` |
|   473125 | 2092 | `			 while( iLeft >= 0 && apNode[iLeft] == 0 ){` |
|   143795 | 2093 | `				 iLeft--;` |
|        5 | 2094 | `			 }` |
|   329335 | 2095 | `			 if( iLeft < 0 \|\| iRight < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|        - | 2096 | `				 /* Syntax error */` |
...
|        - | 2113 | `			  * a write. */` |
|   329293 | 2114 | `			 if( PH7_ExprContainsNullsafe(apNode[iLeft]) ){` |
...
|       11 | 2120 | `				 return rc;` |
|        - | 2121 | `			 }` |
|   329285 | 2122 | `			 if( ExprIsModifiableValue(apNode[iLeft],FALSE) == FALSE ){` |
...
|   329281 | 2141 | `			 pNode->pLeft = apNode[iRight];` |
|   329281 | 2142 | `			 pNode->pRight = apNode[iLeft];` |
|   329281 | 2143 | `			 apNode[iLeft] = apNode[iRight] = 0;` |
|   164638 | 2144 | `		 }` |
|  1263817 | 2145 | `		 iRight = iCur;` |
|   631911 | 2146 | `	 }` |
|        - | 2147 | `	 /* Process left associative binary operators that have the lowest precedence [i.e: and,or,xor] */` |
|  4671805 | 2148 | `	 for( i = 19 ; i < 23 ; i++ ){` |
|  3737445 | 2149 | `		 iLeft = -1;` |
| 23726661 | 2150 | `		 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
| 19989221 | 2151 | `			 if( apNode[iCur] == 0 ){` |
| 16251375 | 2152 | `				 continue;` |
|        - | 2153 | `			 }` |
|  3737851 | 2154 | `			 pNode = apNode[iCur];` |
|  3737851 | 2155 | `			 if( pNode->pOp && pNode->pOp->iPrec == i && pNode->pLeft == 0 ){` |
...
|       35 | 2173 | `			 }` |
|  3737851 | 2174 | `			 iLeft = iCur;` |
|  1868928 | 2175 | `		 }` |
|  1868725 | 2176 | `	 }` |
|        - | 2177 | `	 /* Point to the root of the expression tree */` |
|  4997281 | 2178 | `	 for( iCur = 1 ; iCur < nToken ; ++iCur ){` |
|  4062939 | 2179 | `		 if( apNode[iCur] ){` |
|   890897 | 2180 | `			 if( (apNode[iCur]->pOp \|\| apNode[iCur]->xCode ) && apNode[0] != 0){` |
...
|       23 | 2185 | `				  return rc;` |
|        - | 2186 | `			 }` |
|   890879 | 2187 | `			 apNode[0] = apNode[iCur];` |
|   890879 | 2188 | `			 apNode[iCur] = 0;` |
|   445437 | 2189 | `		 }` |
|  2031463 | 2190 | `	 }` |
|   934347 | 2191 | `	 return SXRET_OK;` |
|   885053 | 2192 | ` }` |
|        - | 2193 | ` /*` |
...
|        - | 2198 | `  */` |
|  1118798 | 2199 | `PH7_PRIVATE sxi32 PH7_ExprMakeTree(ph7_gen_state *pGen,SySet *pExprNode,ph7_expr_node **ppRoot)` |
|        5 | 2200 | `{` |
|        - | 2201 | `	ph7_expr_node **apNode;` |
|        - | 2202 | `	ph7_expr_node *pNode;` |
|        - | 2203 | `	sxi32 rc;` |
|        - | 2204 | `	/* Reset node container */` |
|  1118803 | 2205 | `	SySetReset(pExprNode);` |
|  1118803 | 2206 | `	pNode = 0; /* Prevent compiler warning */` |
|        - | 2207 | `	/* Extract nodes one after one until we hit the end of the input */` |
|        - | 2208 | `	{` |
|  1118803 | 2209 | `		int iLastWasTerm = 0;` |
|  1118803 | 2210 | `		int bAfterMemberOp = 0; /* TRUE iff the previous node was -> / ?-> / :: */` |
|  5918281 | 2211 | `		while( pGen->pIn < pGen->pEnd ){` |
|  4799517 | 2212 | `			rc = ExprExtractNode(&(*pGen),&pNode,iLastWasTerm,bAfterMemberOp);` |
|  4799517 | 2213 | `			if( rc != SXRET_OK ){` |
|       38 | 2214 | `				return rc;` |
|        - | 2215 | `			}` |
|        - | 2216 | `			/* Determine if this node is a term for short-array disambiguation */` |
|  4799483 | 2217 | `			if( pNode->xCode ){` |
|        - | 2218 | `				/* Node with compile handler: variable, literal, string, array, etc. */` |
|  2534107 | 2219 | `				iLastWasTerm = 1;` |
|  3532432 | 2220 | `			}else if( pNode->pOp ){` |
|        - | 2221 | `				/* Operator node */` |
|  1070561 | 2222 | `				iLastWasTerm = 0;` |
|   535283 | 2223 | `			}else{` |
|        - | 2224 | `				/* Delimiter: ')' and ']' end terms */` |
|  1194825 | 2225 | `				iLastWasTerm = (pNode->pStart->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB)) ? 1 : 0;` |
|        - | 2226 | `			}` |
...
|  4799483 | 2230 | `			bAfterMemberOp = ( pNode->pOp && pNode->pOp->iVmOp == PH7_OP_MEMBER );` |
|        - | 2231 | `			/* Save the extracted node */` |
|  4799483 | 2232 | `			SySetPut(pExprNode,(const void *)&pNode);` |
|        5 | 2233 | `		}` |
|        - | 2234 | `	}` |
|  1118769 | 2235 | `	if( SySetUsed(pExprNode) < 1 ){` |
|        - | 2236 | `		/* Empty expression [i.e: A semi-colon;] */` |
|      ! 0 | 2237 | `		*ppRoot = 0;` |
|      ! 0 | 2238 | `		return SXRET_OK;` |
|        - | 2239 | `	}` |
|  1118769 | 2240 | `	apNode = (ph7_expr_node **)SySetBasePtr(pExprNode);` |
|        - | 2241 | `	/* Make sure we are dealing with valid nodes */` |
|  1118769 | 2242 | `	rc = ExprVerifyNodes(&(*pGen),apNode,(sxi32)SySetUsed(pExprNode));` |
|  1118769 | 2243 | `	if( rc != SXRET_OK ){` |
...
|        - | 2249 | `	}` |
|        - | 2250 | `	/* Build the tree */` |
|  1118719 | 2251 | `	rc = ExprMakeTree(&(*pGen),apNode,(sxi32)SySetUsed(pExprNode));` |
|  1118719 | 2252 | `	if( rc != SXRET_OK ){` |
|        - | 2253 | `		/* Something goes wrong [i.e: Syntax error] */` |
|      103 | 2254 | `		*ppRoot = 0;` |
|      103 | 2255 | `		return rc;` |
|        - | 2256 | `	}` |
|        - | 2257 | `	/* Point to the root of the tree */` |
|  1118621 | 2258 | `	*ppRoot = apNode[0];` |
|  1118621 | 2259 | `	return SXRET_OK;` |
|   559404 | 2260 | `}` |
|        - | 2261 |  |
