...
|        - |  253 | ` */` |
|   388998 |  254 | `PH7_PRIVATE const ph7_expr_op *  PH7_ExprExtractOperator(SyString *pStr,SyToken *pLast)` |
|        2 |  255 |  |
|   389000 |  256 | `	sxu32 n = 0;` |
|        - |  257 | `	sxi32 rc;` |
|        - |  258 | `	/* Do a linear lookup on the operators table */` |
|  6078665 |  259 | `	for(;;){` |
| 12157332 |  260 | `		if( n >= SX_ARRAYSIZE(aOpTable) ){` |
|      ! 0 |  261 | `			break;` |
|        - |  262 | `		}` |
| 12157332 |  263 | `		if( SyisAlpha(aOpTable[n].sOp.zString[0]) ){` |
|        - |  264 | `			/* TICKET 1433-012: Alpha stream operators [i.e: and,or,xor,new...] */` |
|  1530940 |  265 | `			rc = SyStringCmp(pStr,&aOpTable[n].sOp,SyStrnicmp);` |
|   765471 |  266 | `		}else{` |
| 10626394 |  267 | `			rc = SyStringCmp(pStr,&aOpTable[n].sOp,SyMemcmp);` |
|        - |  268 | `		}` |
| 12157332 |  269 | `		if( rc == 0 ){` |
|   389466 |  270 | `			if( aOpTable[n].sOp.nByte != sizeof(char) \|\| (aOpTable[n].iOp != EXPR_OP_UMINUS && aOpTable[n].iOp != EXPR_OP_UPLUS) \|\| pLast == 0 ){` |
|        - |  271 | `				/* There is no ambiguity here,simply return the first operator seen */` |
|   388732 |  272 | `				return &aOpTable[n];` |
|        - |  273 | `			}` |
...
|        4 |  287 | `			}` |
|      233 |  288 | `		}` |
| 11768334 |  289 | `		++n; /* Next operator in the table */` |
|        2 |  290 | `	}` |
...
|        - |  298 | ` */` |
|   166434 |  299 | `PH7_PRIVATE void PH7_DelimitNestedTokens(SyToken *pIn,SyToken *pEnd,sxu32 nTokStart,sxu32 nTokEnd,SyToken **ppEnd)` |
|        2 |  300 |  |
|   166436 |  301 | `	SyToken *pCur = pIn;` |
|   166436 |  302 | `	sxi32 iNest = 1;` |
|   966210 |  303 | `	for(;;){` |
|  1932422 |  304 | `		if( pCur >= pEnd ){` |
|       90 |  305 | `			break;` |
|        - |  306 | `		}` |
|  1932334 |  307 | `		if( pCur->nType & nTokStart ){` |
|        - |  308 | `			/* Increment nesting level */` |
|   109590 |  309 | `			iNest++;` |
|  1877540 |  310 | `		}else if( pCur->nType & nTokEnd ){` |
|        - |  311 | `			/* Decrement nesting level */` |
|   275936 |  312 | `			iNest--;` |
|   275936 |  313 | `			if( iNest <= 0 ){` |
|   166348 |  314 | `				break;` |
|        - |  315 | `			}` |
|    54794 |  316 | `		}` |
|        - |  317 | `		/* Advance cursor */` |
...
|        - |  331 | ` */` |
|    12256 |  332 | `PH7_PRIVATE int PH7_IsLangConstruct(sxu32 nKeyID,sxu8 bCheckFunc)` |
|        2 |  333 |  |
|    18322 |  334 | `	if( nKeyID == PH7_TKWRD_ECHO \|\| nKeyID == PH7_TKWRD_PRINT \|\| nKeyID == PH7_TKWRD_INCLUDE` |
|    12167 |  335 | `		\|\| nKeyID == PH7_TKWRD_INCONCE \|\| nKeyID == PH7_TKWRD_REQUIRE \|\| nKeyID == PH7_TKWRD_REQONCE` |
|        - |  336 | `		){` |
|      138 |  337 | `			return TRUE;` |
|        - |  338 | `	}` |
|    12122 |  339 | `	if( bCheckFunc ){` |
|     2042 |  340 | `		if(  nKeyID == PH7_TKWRD_ISSET \|\| nKeyID == PH7_TKWRD_UNSET \|\| nKeyID == PH7_TKWRD_EVAL` |
...
|     2032 |  343 | `				return TRUE;` |
|        - |  344 | `		}` |
|        4 |  345 | `	}` |
|        - |  346 | `	/* Not a language construct */` |
|    10092 |  347 | `	return FALSE;` |
|     6130 |  348 |  |
|        - |  349 | `/*` |
...
|        - |  354 | ` */` |
|   322164 |  355 | `static sxi32 ExprVerifyNodes(ph7_gen_state *pGen,ph7_expr_node **apNode,sxi32 nNode)` |
|        2 |  356 |  |
|        - |  357 | `	sxi32 iParen,iSquare,iQuesty,iBraces;` |
|        - |  358 | `	sxi32 i,rc;` |
|        - |  359 |  |
|   322166 |  360 | `	if( nNode > 0 && apNode[0]->pOp && (apNode[0]->pOp->iOp == EXPR_OP_ADD \|\| apNode[0]->pOp->iOp == EXPR_OP_SUB) ){` |
...
|        3 |  364 | `	}` |
|   322166 |  365 | `	iParen = iSquare = iQuesty = iBraces = 0;` |
|  1732652 |  366 | `	for( i = 0 ; i < nNode ; ++i ){` |
|  1410518 |  367 | `		if( apNode[i]->pStart->nType & PH7_TK_LPAREN /*'('*/){` |
|   145460 |  368 | `			if( i > 0 && ( apNode[i-1]->xCode == PH7_CompileVariable \|\| apNode[i-1]->xCode == PH7_CompileLiteral \|\|` |
|     8468 |  369 | `				(apNode[i - 1]->pStart->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_SSTR\|PH7_TK_DSTR\|PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}'*/))) ){` |
|        - |  370 | `					/* Ticket 1433-033: Take care to ignore alpha-stream [i.e: or,xor] operators followed by an opening parenthesis */` |
|   132070 |  371 | `					if( (apNode[i - 1]->pStart->nType & PH7_TK_OP) == 0 ){` |
|        - |  372 | `						/* We are dealing with a postfix [i.e: function call]  operator` |
|        - |  373 | `						 * not a simple left parenthesis. Mark the node.` |
|        - |  374 | `						 */` |
|   132070 |  375 | `						apNode[i]->pStart->nType \|= PH7_TK_OP;` |
|   132070 |  376 | `						apNode[i]->pStart->pUserData = (void *)&sFCallOp; /* Function call operator */` |
|   132070 |  377 | `						apNode[i]->pOp = &sFCallOp;` |
|    66034 |  378 | `					}` |
|    66034 |  379 | `			}` |
|   145460 |  380 | `			iParen++;` |
|  1337789 |  381 | `		}else if( apNode[i]->pStart->nType & PH7_TK_RPAREN/*')*/){` |
|   145456 |  382 | `			if( iParen <= 0 ){` |
...
|        - |  388 | `			}` |
|   145448 |  389 | `			iParen--;` |
|  1192329 |  390 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OSB /*'['*/){` |
|    36630 |  391 | `			iSquare++;` |
|  1101292 |  392 | `		}else if (apNode[i]->pStart->nType & PH7_TK_CSB /*']'*/){` |
|    36644 |  393 | `			if( iSquare <= 0 ){` |
...
|        - |  399 | `			}` |
|    36638 |  400 | `			iSquare--;` |
|  1064654 |  401 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OCB /*'{'*/){` |
|       14 |  402 | `			iBraces++;` |
...
|        - |  446 |  |
|        7 |  447 | `			}` |
|  1046330 |  448 | `		}else if (apNode[i]->pStart->nType & PH7_TK_CCB /*'}'*/){` |
|       15 |  449 | `			if( iBraces <= 0 ){` |
...
|        - |  455 | `			}` |
|        3 |  456 | `			iBraces--;` |
|  1046311 |  457 | `		}else if ( apNode[i]->pStart->nType & PH7_TK_COLON ){` |
...
|        - |  464 | `			}` |
|     1568 |  465 | `			iQuesty--;` |
|  1045523 |  466 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OP ){` |
|   305428 |  467 | `			const ph7_expr_op *pOp = (const ph7_expr_op *)apNode[i]->pOp;` |
|   305428 |  468 | `			if( pOp->iOp == EXPR_OP_QUESTY ){` |
|     1570 |  469 | `				iQuesty++;` |
|   304644 |  470 | `			}else if( i > 0 && (pOp->iOp == EXPR_OP_UMINUS \|\| pOp->iOp == EXPR_OP_UPLUS)){` |
...
|   152713 |  490 | `		}` |
|   705245 |  491 | `	}` |
|   322136 |  492 | `	if( iParen != 0 \|\| iSquare != 0 \|\| iQuesty != 0 \|\| iBraces != 0){` |
...
|       17 |  497 | `		return rc;` |
|        - |  498 | `	}` |
|   322120 |  499 | `	return SXRET_OK;` |
|   161084 |  500 |  |
|        - |  501 | `/*` |
|        - |  502 | ` * Collect and assemble tokens holding a namespace path [i.e: namespace\to\const]` |
|        - |  503 | ` * or a simple literal [i.e: PHP_EOL].` |
|        - |  504 | ` */` |
|   255512 |  505 | `static void ExprAssembleLiteral(SyToken **ppCur,SyToken *pEnd)` |
|        2 |  506 |  |
|   255514 |  507 | `	SyToken *pIn = *ppCur;` |
|        - |  508 | `	/* Jump the first literal seen */` |
|   255514 |  509 | `	if( (pIn->nType & PH7_TK_NSSEP) == 0 ){` |
|   255512 |  510 | `		pIn++;` |
|   127755 |  511 | `	}` |
|   127761 |  512 | `	for(;;){` |
|   255524 |  513 | `		if(pIn < pEnd && (pIn->nType & PH7_TK_NSSEP) ){` |
|       11 |  514 | `			pIn++;` |
...
|        - |  648 | ` */` |
|  1410662 |  649 | `static sxi32 ExprExtractNode(ph7_gen_state *pGen,ph7_expr_node **ppNode)` |
|        2 |  650 |  |
|        - |  651 | `	ph7_expr_node *pNode;` |
|        - |  652 | `	SyToken *pCur;` |
|        - |  653 | `	sxi32 rc;` |
|        - |  654 | `	/* Allocate a new node */` |
|  1410664 |  655 | `	pNode = (ph7_expr_node *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_expr_node));` |
|  1410664 |  656 | `	if( pNode == 0 ){` |
...
|  1410664 |  663 | `	SyZero(pNode,sizeof(ph7_expr_node));` |
|  1410664 |  664 | `	SySetInit(&pNode->aNodeArgs,&pGen->pVm->sAllocator,sizeof(ph7_expr_node **));` |
|        - |  665 | `	/* Point to the head of the token stream */` |
|  1410664 |  666 | `	pCur = pNode->pStart = pGen->pIn;` |
|        - |  667 | `	/* Start collecting tokens */` |
|  1410664 |  668 | `	if( pCur->nType & PH7_TK_OP ){` |
|        - |  669 | `		/* Point to the instance that describe this operator */` |
|   342094 |  670 | `		pNode->pOp = (const ph7_expr_op *)pCur->pUserData;` |
|        - |  671 | `		/* Advance the stream cursor */` |
|   342094 |  672 | `		pCur++;` |
|  1239618 |  673 | `	}else if( pCur->nType & PH7_TK_DOLLAR ){` |
|        - |  674 | `		/* Isolate variable */` |
|   772314 |  675 | `		while( pCur < pGen->pEnd && (pCur->nType & PH7_TK_DOLLAR) ){` |
|   386164 |  676 | `			pCur++; /* Variable variable */` |
|        2 |  677 | `		}` |
|   386152 |  678 | `		if( pCur < pGen->pEnd ){` |
|   386152 |  679 | `			if (pCur->nType & (PH7_TK_ID\|PH7_TK_KEYWORD) ){` |
|        - |  680 | `				/* Variable name */` |
|   386124 |  681 | `				pCur++;` |
|   193091 |  682 | `			}else if( pCur->nType & PH7_TK_OCB /* '{' */ ){` |
|       22 |  683 | `				pCur++;` |
...
|        8 |  696 | `			}` |
|   193073 |  697 | `		}` |
|   386148 |  698 | `		pNode->xCode = PH7_CompileVariable;` |
|   875495 |  699 | `	 }else if( pCur->nType & PH7_TK_KEYWORD ){` |
|    16086 |  700 | `		 sxu32 nKeyword = (sxu32)SX_PTR_TO_INT(pCur->pUserData);` |
|    16086 |  701 | `		 if( nKeyword == PH7_TKWRD_ARRAY \|\|  nKeyword == PH7_TKWRD_LIST ){` |
|        - |  702 | `			 /* List/Array node */` |
|     5826 |  703 | `			 if( &pCur[1] >= pGen->pEnd \|\| (pCur[1].nType & PH7_TK_LPAREN) == 0 ){` |
...
|     5810 |  710 | `				 PH7_DelimitNestedTokens(pCur,pGen->pEnd,PH7_TK_LPAREN /* '(' */, PH7_TK_RPAREN /* ')' */,&pCur);` |
|     5810 |  711 | `				 if( pCur < pGen->pEnd ){` |
|     5808 |  712 | `					 pCur++;` |
|     2905 |  713 | `				 }else{` |
|        - |  714 | `					 /* Syntax error */` |
...
|        3 |  721 | `					 return rc;` |
|        - |  722 | `				 }` |
|     5808 |  723 | `				 pNode->xCode = (nKeyword == PH7_TKWRD_LIST) ? PH7_CompileList : PH7_CompileArray;` |
|     5808 |  724 | `				 if( pNode->xCode == PH7_CompileList ){` |
...
|       12 |  735 | `				 }` |
|        2 |  736 | `			 }` |
|    13172 |  737 | `		 }else if( nKeyword == PH7_TKWRD_FUNCTION ){` |
...
|        2 |  751 | `			  }` |
|    10199 |  752 | `		 }else if( PH7_IsLangConstruct(nKeyword,FALSE) == TRUE && &pCur[1] < pGen->pEnd ){` |
...
|    10088 |  758 | `			 ExprAssembleLiteral(&pCur,pGen->pEnd);` |
|    10088 |  759 | `			 pNode->xCode = PH7_CompileLiteral;` |
|        2 |  760 | `		 }` |
|   674366 |  761 | `	 }else if( pCur->nType & (PH7_TK_NSSEP\|PH7_TK_ID) ){` |
|        - |  762 | `		 /* Constants,function name,namespace path,class name... */` |
|   245412 |  763 | `		 ExprAssembleLiteral(&pCur,pGen->pEnd);` |
|   245412 |  764 | `		 pNode->xCode = PH7_CompileLiteral;` |
|   122707 |  765 | `	 }else{` |
|   420928 |  766 | `		 if( (pCur->nType & (PH7_TK_LPAREN\|PH7_TK_RPAREN\|PH7_TK_COMMA\|PH7_TK_COLON\|PH7_TK_CSB\|PH7_TK_OCB\|PH7_TK_CCB)) == 0 ){` |
|        - |  767 | `			 /* Point to the code generator routine */` |
|    91762 |  768 | `			 pNode->xCode = PH7_GetNodeHandler(pCur->nType);` |
|    91762 |  769 | `			 if( pNode->xCode == 0 ){` |
...
|  1410630 |  782 | `	pNode->pEnd = pCur;` |
|        - |  783 | `	/* Save the node for later processing */` |
|  1410630 |  784 | `	*ppNode = pNode;` |
|        - |  785 | `	/* Synchronize cursors */` |
|  1410630 |  786 | `	pGen->pIn = pCur;` |
|  1410630 |  787 | `	return SXRET_OK;` |
|   705333 |  788 |  |
|        - |  789 | `/*` |
...
|        - |  792 | ` * level is zero.` |
|        - |  793 | ` */` |
|    25122 |  794 | `PH7_PRIVATE sxi32 PH7_GetNextExpr(SyToken *pStart,SyToken *pEnd,SyToken **ppNext)` |
|        2 |  795 |  |
|    25124 |  796 | `	SyToken *pCur = pStart;` |
|    25124 |  797 | `	sxi32 iNest = 0;` |
|    25124 |  798 | `	if( pCur >= pEnd \|\| (pCur->nType & PH7_TK_SEMI/*';'*/) ){` |
|        - |  799 | `		/* Last expression */` |
|    14344 |  800 | `		return SXERR_EOF;` |
|        - |  801 | `	}` |
|    56574 |  802 | `	while( pCur < pEnd ){` |
|    55632 |  803 | `		if( (pCur->nType & (PH7_TK_COMMA/*','*/\|PH7_TK_SEMI/*';'*/)) && iNest <= 0){` |
|     9840 |  804 | `			break;` |
|        - |  805 | `		}` |
|    45794 |  806 | `		if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|     3466 |  807 | `			iNest++;` |
|    44062 |  808 | `		}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}*/) ){` |
|     3468 |  809 | `			iNest--;` |
|     1733 |  810 | `		}` |
|    45794 |  811 | `		pCur++;` |
|        2 |  812 | `	}` |
|    10782 |  813 | `	*ppNext = pCur;` |
|    10782 |  814 | `	return SXRET_OK;` |
|    12563 |  815 |  |
|        - |  816 | `/*` |
|        - |  817 | ` * Free an expression tree.` |
|        - |  818 | ` */` |
|  1226670 |  819 | `static void ExprFreeTree(ph7_gen_state *pGen,ph7_expr_node *pNode)` |
|        2 |  820 |  |
|  1226672 |  821 | `	if( pNode->pLeft ){` |
|        - |  822 | `		/* Release the left tree */` |
|   460322 |  823 | `		ExprFreeTree(&(*pGen),pNode->pLeft);` |
|   230160 |  824 | `	}` |
|  1226672 |  825 | `	if( pNode->pRight ){` |
|        - |  826 | `		/* Release the right tree */` |
|   260736 |  827 | `		ExprFreeTree(&(*pGen),pNode->pRight);` |
|   130367 |  828 | `	}` |
|  1226672 |  829 | `	if( pNode->pCond ){` |
|        - |  830 | `		/* Release the conditional tree used by the ternary operator */` |
|     1566 |  831 | `		ExprFreeTree(&(*pGen),pNode->pCond);` |
|      782 |  832 | `	}` |
|  1226672 |  833 | `	if( SySetUsed(&pNode->aNodeArgs) > 0 ){` |
|        - |  834 | `		ph7_expr_node **apArg;` |
|        - |  835 | `		sxu32 n;` |
|        - |  836 | `		/* Release node arguments */` |
|   141118 |  837 | `		apArg = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|   295912 |  838 | `		for( n = 0 ; n < SySetUsed(&pNode->aNodeArgs) ; ++n ){` |
|   154796 |  839 | `			ExprFreeTree(&(*pGen),apArg[n]);` |
|    77399 |  840 | `		}` |
|   141118 |  841 | `		SySetRelease(&pNode->aNodeArgs);` |
|    70558 |  842 | `	}` |
|        - |  843 | `	/* Finally,release this node */` |
|  1226672 |  844 | `	SyMemBackendPoolFree(&pGen->pVm->sAllocator,pNode);` |
|  1226672 |  845 |  |
|        - |  846 | `/*` |
|        - |  847 | ` * Free an expression tree.` |
|        - |  848 | ` * This function is a wrapper around ExprFreeTree() defined above.` |
|        - |  849 | ` */` |
|   322198 |  850 | `PH7_PRIVATE sxi32 PH7_ExprFreeTree(ph7_gen_state *pGen,SySet *pNodeSet)` |
|        2 |  851 |  |
|        - |  852 | `	ph7_expr_node **apNode;` |
|        - |  853 | `	sxu32 n;` |
|   322200 |  854 | `	apNode = (ph7_expr_node **)SySetBasePtr(pNodeSet);` |
|  1732828 |  855 | `	for( n = 0  ; n < SySetUsed(pNodeSet) ; ++n ){` |
|  1410630 |  856 | `		if( apNode[n] ){` |
|   322504 |  857 | `			ExprFreeTree(&(*pGen),apNode[n]);` |
|   161251 |  858 | `		}` |
|   705316 |  859 | `	}` |
|   322200 |  860 | `	return SXRET_OK;` |
|        2 |  861 |  |
|        - |  862 | `/*` |
|        - |  863 | ` * Check if the given node is a modifialbe l/r-value.` |
|        - |  864 | ` * Return TRUE if modifiable.FALSE otherwise.` |
|        - |  865 | ` */` |
|   114190 |  866 | `static int ExprIsModifiableValue(ph7_expr_node *pNode,sxu8 bFunc)` |
|        2 |  867 |  |
|        - |  868 | `	sxi32 iExprOp;` |
|   114192 |  869 | `	if( pNode->pOp == 0 ){` |
|    76718 |  870 | `		return pNode->xCode == PH7_CompileVariable ? TRUE : FALSE;` |
|        - |  871 | `	}` |
|    37476 |  872 | `	iExprOp = pNode->pOp->iOp;` |
|    37476 |  873 | `	if( iExprOp == EXPR_OP_ARROW /*'->' */ \|\| iExprOp == EXPR_OP_DC /*'::'*/ ){` |
|    26350 |  874 | `			return TRUE;` |
|        - |  875 | `	}` |
|    11128 |  876 | `	if( iExprOp == EXPR_OP_SUBSCRIPT/*'[]'*/ ){` |
|    11124 |  877 | `		if( pNode->pLeft->pOp ) {` |
|        2 |  878 | `			if( pNode->pLeft->pOp->iOp != EXPR_OP_SUBSCRIPT /*'['*/ && pNode->pLeft->pOp->iOp != EXPR_OP_ARROW /*'->'*/` |
|        2 |  879 | `				&& pNode->pLeft->pOp->iOp != EXPR_OP_DC /*'::'*/){` |
|      ! 0 |  880 | `				return FALSE;` |
|        1 |  881 | `			}` |
|    11123 |  882 | `		}else if( pNode->pLeft->xCode != PH7_CompileVariable ){` |
|      ! 0 |  883 | `			return FALSE;` |
|        - |  884 | `		}` |
|    11124 |  885 | `		return TRUE;` |
|        - |  886 | `	}` |
...
|        - |  900 | ` */` |
|   112262 |  901 | `static sxi32 ExprProcessFuncArguments(ph7_gen_state *pGen,ph7_expr_node *pOp,ph7_expr_node **apNode,sxi32 nToken)` |
|        2 |  902 |  |
...
|   112264 |  906 | `	iCur = 0;` |
|   119100 |  907 | `	for(;;){` |
|   238202 |  908 | `		if( iCur >= nToken ){` |
|        - |  909 | `			/* No more arguments to process */` |
|   112262 |  910 | `			break;` |
|        - |  911 | `		}` |
|   125942 |  912 | `		iNode = iCur;` |
|   125942 |  913 | `		iNest = 0;` |
|   304164 |  914 | `		while( iCur < nToken ){` |
|   191904 |  915 | `			if( apNode[iCur] ){` |
|   191904 |  916 | `				if( (apNode[iCur]->pStart->nType & PH7_TK_COMMA) && apNode[iCur]->pLeft == 0 && iNest <= 0 ){` |
|     6842 |  917 | `					break;` |
|   178224 |  918 | `				}else if( apNode[iCur]->pStart->nType & (PH7_TK_LPAREN\|PH7_TK_OSB\|PH7_TK_OCB) ){` |
|    10020 |  919 | `					iNest++;` |
|   173215 |  920 | `				}else if( apNode[iCur]->pStart->nType & (PH7_TK_RPAREN\|PH7_TK_CCB\|PH7_TK_CSB) ){` |
|    10020 |  921 | `					iNest--;` |
|     5009 |  922 | `				}` |
|    89111 |  923 | `			}` |
|   178224 |  924 | `			iCur++;` |
|        2 |  925 | `		}` |
|   125942 |  926 | `		if( iCur > iNode ){` |
|   125938 |  927 | `			if( apNode[iNode] && (apNode[iNode]->pStart->nType & PH7_TK_AMPER /*'&'*/) && ((iCur - iNode) == 2)` |
...
|      ! 0 |  933 | `			}` |
|   125940 |  934 | `			ExprMakeTree(&(*pGen),&apNode[iNode],iCur-iNode);` |
|   125940 |  935 | `			if( apNode[iNode] ){` |
|        - |  936 | `				/* Put a pointer to the root of the tree in the arguments set */` |
|   125940 |  937 | `				SySetPut(&pOp->aNodeArgs,(const void *)&apNode[iNode]);` |
|    62971 |  938 | `			}else{` |
...
|   125940 |  954 | `		if( iCur < nToken && apNode[iCur] && (apNode[iCur]->pStart->nType & PH7_TK_COMMA) ){` |
|    13680 |  955 | `			iCur++;` |
|    13680 |  956 | `			if( iCur >= nToken ){` |
...
|        - |  972 | `  */` |
|   495152 |  973 | ` static sxi32 ExprMakeTree(ph7_gen_state *pGen,ph7_expr_node **apNode,sxi32 nToken)` |
|        2 |  974 | ` {` |
|        - |  975 | `	 sxi32 i,iLeft,iRight;` |
|        - |  976 | `	 ph7_expr_node *pNode;` |
|        - |  977 | `	 sxi32 iCur;` |
|        - |  978 | `	 sxi32 rc;` |
|   495154 |  979 | `	 if( nToken <= 0 \|\| (nToken == 1 && apNode[0]->xCode) ){` |
|        - |  980 | `		 /* TICKET 1433-17: self evaluating node */` |
|   214510 |  981 | `		 return SXRET_OK;` |
|        - |  982 | `	 }` |
|        - |  983 | `	 /* Process expressions enclosed in parenthesis first */` |
|  1673976 |  984 | `	 for( iCur =  0 ; iCur < nToken ; ++iCur ){` |
|        - |  985 | `		 sxi32 iNest;` |
...
|        - |  988 | `		  */` |
|  1393334 |  989 | `		 if( apNode[iCur] == 0 \|\| apNode[iCur]->pStart->nType != PH7_TK_LPAREN ){` |
|  1379954 |  990 | `			 continue;` |
|        - |  991 | `		 }` |
|    13382 |  992 | `		 iNest = 1;` |
|    13382 |  993 | `		 iLeft = iCur;` |
|        - |  994 | `		 /* Find the closing parenthesis */` |
|    13382 |  995 | `		 iCur++;` |
|    77092 |  996 | `		 while( iCur < nToken ){` |
|    77092 |  997 | `			 if( apNode[iCur] ){` |
|    77092 |  998 | `				 if( apNode[iCur]->pStart->nType & PH7_TK_RPAREN /* ')' */){` |
|        - |  999 | `					 /* Decrement nesting level */` |
|    21586 | 1000 | `					 iNest--;` |
|    21586 | 1001 | `					 if( iNest <= 0 ){` |
|    13382 | 1002 | `						 break;` |
|        2 | 1003 | `					 }` |
|    59610 | 1004 | `				 }else if( apNode[iCur]->pStart->nType & PH7_TK_LPAREN /* '(' */ ){` |
...
|    63712 | 1009 | `			 iCur++;` |
|        2 | 1010 | `		 }` |
|    13382 | 1011 | `		 if( iCur - iLeft > 1 ){` |
|        - | 1012 | `			 /* Recurse and process this expression */` |
|    13382 | 1013 | `			 rc = ExprMakeTree(&(*pGen),&apNode[iLeft + 1],iCur - iLeft - 1);` |
|    13382 | 1014 | `			 if( rc != SXRET_OK ){` |
|        3 | 1015 | `				 return rc;` |
|        - | 1016 | `			 }` |
|     6689 | 1017 | `		 }` |
|        - | 1018 | `		 /* Free the left and right nodes */` |
|    13380 | 1019 | `		 ExprFreeTree(&(*pGen),apNode[iLeft]);` |
|    13380 | 1020 | `		 ExprFreeTree(&(*pGen),apNode[iCur]);` |
|    13380 | 1021 | `		 apNode[iLeft] = 0;` |
|    13380 | 1022 | `		 apNode[iCur] = 0;` |
|     6691 | 1023 | `	 }` |
|        - | 1024 | `	  /* Process expressions enclosed in braces */` |
|  1747586 | 1025 | `	 for( iCur =  0 ; iCur < nToken ; ++iCur ){` |
|        - | 1026 | `		 sxi32 iNest;` |
...
|        - | 1029 | `		  */` |
|  1470406 | 1030 | `		 if( apNode[iCur] == 0 \|\| apNode[iCur]->pStart->nType != PH7_TK_OCB ){` |
|  1470404 | 1031 | `			 continue;` |
|        - | 1032 | `		 }` |
|        3 | 1033 | `		 iNest = 1;` |
|        3 | 1034 | `		 iLeft = iCur;` |
...
|   277182 | 1066 | `	 iLeft = -1;` |
|  1747558 | 1067 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  1470388 | 1068 | `		 if( apNode[iCur] == 0 ){` |
|   526302 | 1069 | `			 continue;` |
|        - | 1070 | `		 }` |
|   944088 | 1071 | `		 pNode = apNode[iCur];` |
|   944088 | 1072 | `		 if( pNode->pOp && pNode->pOp->iPrec == 2 && pNode->pLeft == 0  ){` |
|   227858 | 1073 | `			 if( pNode->pOp->iOp == EXPR_OP_FUNC_CALL ){` |
|        - | 1074 | `				 /* Collect function arguments */` |
|   132066 | 1075 | `				 sxi32 iPtr = 0;` |
|   132066 | 1076 | `				 sxi32 nFuncTok = 0;` |
|   456034 | 1077 | `				 while( nFuncTok + iCur < nToken ){` |
|   456034 | 1078 | `					 if( apNode[nFuncTok+iCur] ){` |
|   456034 | 1079 | `						 if( apNode[nFuncTok+iCur]->pStart->nType & PH7_TK_LPAREN /*'('*/ ){` |
|   134034 | 1080 | `							 iPtr++;` |
|   389018 | 1081 | `						 }else if ( apNode[nFuncTok+iCur]->pStart->nType & PH7_TK_RPAREN /*')'*/){` |
|   134034 | 1082 | `							 iPtr--;` |
|   134034 | 1083 | `							 if( iPtr <= 0 ){` |
|   132066 | 1084 | `								 break;` |
|        - | 1085 | `							 }` |
|      984 | 1086 | `						 }` |
|   161984 | 1087 | `					 }` |
|   323970 | 1088 | `					 nFuncTok++;` |
|        2 | 1089 | `				 }` |
|   132066 | 1090 | `				 if( nFuncTok + iCur >= nToken ){` |
|        - | 1091 | `					 /* Syntax error */` |
...
|      ! 0 | 1096 | `					 return rc;` |
|        - | 1097 | `				 }` |
|   132066 | 1098 | `				 if(  iLeft < 0 \|\| !NODE_ISTERM(iLeft) /*\|\| ( apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec != 2)*/ ){` |
|        - | 1099 | `					 /* Syntax error */` |
...
|      ! 0 | 1104 | `					 return rc;` |
|        - | 1105 | `				 }` |
|   132066 | 1106 | `				 if( nFuncTok > 1 ){` |
|        - | 1107 | `					 /* Process function arguments */` |
|   112264 | 1108 | `					 rc = ExprProcessFuncArguments(&(*pGen),pNode,&apNode[iCur+1],nFuncTok-1);` |
|   112264 | 1109 | `					 if( rc != SXRET_OK ){` |
|        3 | 1110 | `						 return rc;` |
|        - | 1111 | `					 }` |
|    56130 | 1112 | `				 }` |
|        - | 1113 | `				 /* Link the node to the tree */` |
|   132064 | 1114 | `				 pNode->pLeft = apNode[iLeft];` |
|   132064 | 1115 | `				 apNode[iLeft] = 0;` |
|   456026 | 1116 | `				 for( iPtr = 1; iPtr <= nFuncTok ; iPtr++ ){` |
|   323964 | 1117 | `					 apNode[iCur+iPtr] = 0;` |
|   161983 | 1118 | `				 }` |
|   161825 | 1119 | `			 }else if (pNode->pOp->iOp == EXPR_OP_SUBSCRIPT ){` |
|        - | 1120 | `				 /* Subscripting */` |
|    36638 | 1121 | `				 sxi32 iArrTok = iCur + 1;` |
|    36638 | 1122 | `				 sxi32 iNest = 1;` |
|    36655 | 1123 | `				 if(  iLeft < 0 \|\| apNode[iLeft] == 0 \|\| (apNode[iLeft]->pOp == 0 && (apNode[iLeft]->xCode != PH7_CompileVariable &&` |
|        2 | 1124 | `					 apNode[iLeft]->xCode != PH7_CompileSimpleString && apNode[iLeft]->xCode != PH7_CompileString ) ) \|\|` |
|    36636 | 1125 | `					 ( apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec != 2 /* postfix */) ){` |
|        - | 1126 | `						 /* Syntax error */` |
...
|    65596 | 1134 | `				 while( iArrTok < nToken ){` |
|    65596 | 1135 | `					 if( apNode[iArrTok] ){` |
|    65564 | 1136 | `						 if( apNode[iArrTok]->pOp && apNode[iArrTok]->pOp->iOp == EXPR_OP_SUBSCRIPT &&  apNode[iArrTok]->pLeft == 0){` |
|        - | 1137 | `							 /* Increment nesting level */` |
|      ! 0 | 1138 | `							 iNest++;` |
|    65564 | 1139 | `						 }else if( apNode[iArrTok]->pStart->nType & PH7_TK_CSB /*']'*/){` |
|        - | 1140 | `							 /* Decrement nesting level */` |
|    36634 | 1141 | `							 iNest--;` |
|    36634 | 1142 | `							 if( iNest <= 0 ){` |
|    36634 | 1143 | `								 break;` |
|        - | 1144 | `							 }` |
|      ! 0 | 1145 | `						 }` |
|    14465 | 1146 | `					 }` |
|    28964 | 1147 | `					 ++iArrTok;` |
|        2 | 1148 | `				 }` |
|    36634 | 1149 | `				 if( iArrTok > iCur + 1 ){` |
|        - | 1150 | `					 /* Recurse and process this expression */` |
|    28858 | 1151 | `					 rc = ExprMakeTree(&(*pGen),&apNode[iCur+1],iArrTok - iCur - 1);` |
|    28858 | 1152 | `					 if( rc != SXRET_OK ){` |
|      ! 0 | 1153 | `						 return rc;` |
|        - | 1154 | `					 }` |
|        - | 1155 | `					 /* Link the node to it's index */` |
|    28858 | 1156 | `					 SySetPut(&pNode->aNodeArgs,(const void *)&apNode[iCur+1]);` |
|    14428 | 1157 | `				 }` |
|        - | 1158 | `				 /* Link the node to the tree */` |
|    36634 | 1159 | `				 pNode->pLeft = apNode[iLeft];` |
|    36634 | 1160 | `				 pNode->pRight = 0;` |
|    36634 | 1161 | `				 apNode[iLeft] = 0;` |
|   102228 | 1162 | `				 for( iNest = iCur + 1 ; iNest <= iArrTok ; ++iNest ){` |
|    65596 | 1163 | `					 apNode[iNest] = 0;` |
|    32799 | 1164 | `				 }` |
|    18318 | 1165 | `			 }else{` |
|        - | 1166 | `				 /* Member access operators [i.e: '->','::'] */` |
|    59158 | 1167 | `				  iRight = iCur + 1;` |
|    59158 | 1168 | `				 while( iRight < nToken && apNode[iRight] == 0 ){` |
|      ! 0 | 1169 | `					 iRight++;` |
|      ! 0 | 1170 | `				 }` |
|    59158 | 1171 | `				 if( iRight >= nToken \|\| iLeft < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|        - | 1172 | `					 /* Syntax error */` |
...
|    59154 | 1180 | `				 pNode->pLeft = apNode[iLeft];` |
|    59154 | 1181 | `				 if( pNode->pOp->iOp == EXPR_OP_ARROW /*'->'*/ && pNode->pLeft->pOp == 0 &&` |
|    59094 | 1182 | `					 pNode->pLeft->xCode != PH7_CompileVariable ){` |
|        - | 1183 | `						 /* Syntax error */` |
...
|      ! 0 | 1189 | `						 return rc;` |
|        - | 1190 | `				 }` |
|    59154 | 1191 | `				 pNode->pRight = apNode[iRight];` |
|    59154 | 1192 | `				 apNode[iLeft] = apNode[iRight] = 0;` |
|        - | 1193 | `			 }` |
|   113923 | 1194 | `		 }` |
|   944078 | 1195 | `		 iLeft = iCur;` |
|   472040 | 1196 | `	 }` |
|        - | 1197 | `	 /* Handle left associative (new, clone) operators */` |
|  1747526 | 1198 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  1470356 | 1199 | `		 if( apNode[iCur] == 0 ){` |
|   757486 | 1200 | `			 continue;` |
|        - | 1201 | `		 }` |
|   712872 | 1202 | `		 pNode = apNode[iCur];` |
|   712872 | 1203 | `		 if( pNode->pOp && pNode->pOp->iPrec == 1 && pNode->pLeft == 0 ){` |
|        - | 1204 | `			 SyToken *pToken;` |
|        - | 1205 | `			 /* Get the left node */` |
|     3340 | 1206 | `			 iLeft = iCur + 1;` |
|     6656 | 1207 | `			 while( iLeft < nToken && apNode[iLeft] == 0 ){` |
|     3318 | 1208 | `				 iLeft++;` |
|        2 | 1209 | `			 }` |
|     3340 | 1210 | `			 if( iLeft >= nToken \|\| !NODE_ISTERM(iLeft) ){` |
|        - | 1211 | `				  /* Syntax error */` |
...
|     3340 | 1220 | `			 if( pNode->pOp->iOp == EXPR_OP_CLONE ){` |
|        - | 1221 | `				 /* Clone:` |
...
|       10 | 1242 | `			 }else{` |
|        - | 1243 | `				 /* New */` |
|     3324 | 1244 | `				 if( apNode[iLeft]->pOp == 0 ){` |
...
|     3340 | 1260 | `			 pNode->pLeft = apNode[iLeft];` |
|     3340 | 1261 | `			 apNode[iLeft] = 0;` |
|     3340 | 1262 | `			 pNode->pRight = 0; /* Paranoid */` |
|     1669 | 1263 | `		 }` |
|   356437 | 1264 | `	 }` |
|        - | 1265 | `	  /* Handle post/pre icrement/decrement [i.e: ++/--] operators with precedence 3 */` |
|   277172 | 1266 | `	 iLeft = -1;` |
|  1747526 | 1267 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  1468626 | 1268 | `		 if( apNode[iCur] == 0 ){` |
|   757486 | 1269 | `			 continue;` |
|        - | 1270 | `		 }` |
|   711142 | 1271 | `		 pNode = apNode[iCur];` |
|   711142 | 1272 | `		 if( pNode->pOp && pNode->pOp->iPrec == 3 && pNode->pLeft == 0){` |
|     4652 | 1273 | `			 if( iLeft >= 0 && ((apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec == 2 /* Postfix */)` |
|     1742 | 1274 | `				 \|\| apNode[iLeft]->xCode == PH7_CompileVariable) ){` |
|        - | 1275 | `					 /* Link the node to the tree */` |
|     1738 | 1276 | `					 pNode->pLeft = apNode[iLeft];` |
|     1738 | 1277 | `					 apNode[iLeft] = 0;` |
|      868 | 1278 | `			 }` |
|     3190 | 1279 | `		  }` |
|   712872 | 1280 | `		 iLeft = iCur;` |
|   356437 | 1281 | `	  }` |
|   278902 | 1282 | `	 iLeft = -1;` |
|  1749256 | 1283 | `	 for( iCur = nToken -  1 ; iCur >= 0 ; iCur-- ){` |
|  1470356 | 1284 | `		 if( apNode[iCur] == 0 ){` |
|   759222 | 1285 | `			 continue;` |
|        - | 1286 | `		 }` |
|   711136 | 1287 | `		 pNode = apNode[iCur];` |
|   711136 | 1288 | `		 if( pNode->pOp && pNode->pOp->iPrec == 3 && pNode->pLeft == 0){` |
|     4644 | 1289 | `			 if( iLeft < 0 \|\| (apNode[iLeft]->pOp == 0 && apNode[iLeft]->xCode != PH7_CompileVariable)` |
|     4646 | 1290 | `				 \|\| ( apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec != 2 /* Postfix */) ){` |
|        - | 1291 | `					 /* Syntax error */` |
...
|     4646 | 1299 | `			 pNode->pLeft = apNode[iLeft];` |
|     4646 | 1300 | `			 apNode[iLeft] = 0;` |
|        - | 1301 | `			 /* Mark as pre-increment/decrement node */` |
|     4646 | 1302 | `			 pNode->iFlags \|= EXPR_NODE_PRE_INCR;` |
|     2322 | 1303 | `		  }` |
|   711136 | 1304 | `		 iLeft = iCur;` |
|   355569 | 1305 | `	 }` |
|        - | 1306 | `	 /* Handle right associative unary and cast operators [i.e: !,(string),~...]  with precedence 4*/` |
|   278902 | 1307 | `	  iLeft = 0;` |
|  1749250 | 1308 | `	  for( iCur = nToken -  1 ; iCur >= 0 ; iCur-- ){` |
|  1470352 | 1309 | `		  if( apNode[iCur] ){` |
|   706488 | 1310 | `			  pNode = apNode[iCur];` |
|   706488 | 1311 | `			  if( pNode->pOp && pNode->pOp->iPrec == 4 && pNode->pLeft == 0){` |
|    21178 | 1312 | `				  if( iLeft > 0 ){` |
|        - | 1313 | `					  /* Link the node to the tree */` |
|    21176 | 1314 | `					  pNode->pLeft = apNode[iLeft];` |
|    21176 | 1315 | `					  apNode[iLeft] = 0;` |
|    21176 | 1316 | `					  if( pNode->pLeft && pNode->pLeft->pOp && pNode->pLeft->pOp->iPrec > 4 ){` |
...
|   706486 | 1336 | `			  iLeft = iCur;` |
|   353242 | 1337 | `		  }` |
|   735176 | 1338 | `	  }` |
|        - | 1339 | `	 /* Process left and non-associative binary operators [i.e: *,/,&&,\|\|...]*/` |
|  3067624 | 1340 | `	 for( i = 7 ; i < 17 ; i++ ){` |
|  2788754 | 1341 | `		 iLeft = -1;` |
| 17491648 | 1342 | `		 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
| 14702924 | 1343 | `			 if( apNode[iCur] == 0 ){` |
|  8944482 | 1344 | `				 continue;` |
|        - | 1345 | `			 }` |
|  5758444 | 1346 | `			 pNode = apNode[iCur];` |
|  5758444 | 1347 | `			 if( pNode->pOp && pNode->pOp->iPrec == i && pNode->pLeft == 0 ){` |
|        - | 1348 | `				 /* Get the right node */` |
|    85858 | 1349 | `				 iRight = iCur + 1;` |
|   114598 | 1350 | `				 while( iRight < nToken && apNode[iRight] == 0 ){` |
|    28742 | 1351 | `					 iRight++;` |
|        2 | 1352 | `				 }` |
|    85858 | 1353 | `				 if( iRight >= nToken \|\| iLeft < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|        - | 1354 | `					 /* Syntax error */` |
...
|       29 | 1359 | `					 return rc;` |
|        - | 1360 | `				 }` |
|    85830 | 1361 | `				 if( pNode->pOp->iOp == EXPR_OP_REF ){` |
|        - | 1362 | `					 sxi32  iTmp;` |
...
|    85830 | 1391 | `				 pNode->pLeft = apNode[iLeft];` |
|    85830 | 1392 | `				 pNode->pRight = apNode[iRight];` |
|    85830 | 1393 | `				 apNode[iLeft] = apNode[iRight] = 0;` |
|    42914 | 1394 | `			 }` |
|  5758416 | 1395 | `			 iLeft = iCur;` |
|  2879209 | 1396 | `		 }` |
|  1394364 | 1397 | `	 }` |
...
|        - | 1401 | `	  */` |
|   278872 | 1402 | `	  iLeft = -1;` |
|  1742380 | 1403 | `	  for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  1465076 | 1404 | `		  if( apNode[iCur] == 0 ){` |
|   956188 | 1405 | `			  continue;` |
|        - | 1406 | `		  }` |
|   508890 | 1407 | `		  pNode = apNode[iCur];` |
|   508890 | 1408 | `		  if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_QUESTY && pNode->pLeft == 0 ){` |
...
|        - | 1477 | `	  */` |
|   278870 | 1478 | `	 iRight = -1;` |
|  1749056 | 1479 | `	 for( iCur = nToken -  1 ; iCur >= 0 ; iCur--){` |
|  1470228 | 1480 | `		 if( apNode[iCur] == 0 ){` |
|  1077072 | 1481 | `			 continue;` |
|        - | 1482 | `		 }` |
|   393158 | 1483 | `		 pNode = apNode[iCur];` |
|   393158 | 1484 | `		 if( pNode->pOp && pNode->pOp->iPrec == 18 && pNode->pLeft == 0 ){` |
|        - | 1485 | `			 /* Get the left node */` |
|   114162 | 1486 | `			 iLeft = iCur - 1;` |
|   155040 | 1487 | `			 while( iLeft >= 0 && apNode[iLeft] == 0 ){` |
|    40880 | 1488 | `				 iLeft--;` |
|        2 | 1489 | `			 }` |
|   114162 | 1490 | `			 if( iLeft < 0 \|\| iRight < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|        - | 1491 | `				 /* Syntax error */` |
...
|       39 | 1496 | `				 return rc;` |
|        - | 1497 | `			 }` |
|   114124 | 1498 | `			 if( ExprIsModifiableValue(apNode[iLeft],FALSE) == FALSE ){` |
...
|   114122 | 1510 | `			 pNode->pLeft = apNode[iRight];` |
|   114122 | 1511 | `			 pNode->pRight = apNode[iLeft];` |
|   114122 | 1512 | `			 apNode[iLeft] = apNode[iRight] = 0;` |
|    57060 | 1513 | `		 }` |
|   393118 | 1514 | `		 iRight = iCur;` |
|   196560 | 1515 | `	 }` |
|        - | 1516 | `	 /* Process left associative binary operators that have the lowest precedence [i.e: and,or,xor] */` |
|  1394142 | 1517 | `	 for( i = 19 ; i < 23 ; i++ ){` |
|  1115314 | 1518 | `		 iLeft = -1;` |
|  6996050 | 1519 | `		 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  5880738 | 1520 | `			 if( apNode[iCur] == 0 ){` |
|  4765004 | 1521 | `				 continue;` |
|        - | 1522 | `			 }` |
|  1115736 | 1523 | `			 pNode = apNode[iCur];` |
|  1115736 | 1524 | `			 if( pNode->pOp && pNode->pOp->iPrec == i && pNode->pLeft == 0 ){` |
...
|       35 | 1542 | `			 }` |
|  1115736 | 1543 | `			 iLeft = iCur;` |
|   557869 | 1544 | `		 }` |
|   557658 | 1545 | `	 }` |
|        - | 1546 | `	 /* Point to the root of the expression tree */` |
|  1470154 | 1547 | `	 for( iCur = 1 ; iCur < nToken ; ++iCur ){` |
|  1191348 | 1548 | `		 if( apNode[iCur] ){` |
|   251930 | 1549 | `			 if( (apNode[iCur]->pOp \|\| apNode[iCur]->xCode ) && apNode[0] != 0){` |
...
|       24 | 1554 | `				  return rc;` |
|        - | 1555 | `			 }` |
|   251908 | 1556 | `			 apNode[0] = apNode[iCur];` |
|   251908 | 1557 | `			 apNode[iCur] = 0;` |
|   125953 | 1558 | `		 }` |
|   595664 | 1559 | `	 }` |
|   278808 | 1560 | `	 return SXRET_OK;` |
|   246713 | 1561 | ` }` |
|        - | 1562 | ` /*` |
...
|        - | 1567 | `  */` |
|   322198 | 1568 | `PH7_PRIVATE sxi32 PH7_ExprMakeTree(ph7_gen_state *pGen,SySet *pExprNode,ph7_expr_node **ppRoot)` |
|        2 | 1569 |  |
|        - | 1570 | `	ph7_expr_node **apNode;` |
|        - | 1571 | `	ph7_expr_node *pNode;` |
|        - | 1572 | `	sxi32 rc;` |
|        - | 1573 | `	/* Reset node container */` |
|   322200 | 1574 | `	SySetReset(pExprNode);` |
|   322200 | 1575 | `	pNode = 0; /* Prevent compiler warning */` |
|        - | 1576 | `	/* Extract nodes one after one until we hit the end of the input */` |
|  1732828 | 1577 | `	while( pGen->pIn < pGen->pEnd ){` |
|  1410664 | 1578 | `		rc = ExprExtractNode(&(*pGen),&pNode);` |
|  1410664 | 1579 | `		if( rc != SXRET_OK ){` |
|       35 | 1580 | `			return rc;` |
|        - | 1581 | `		}` |
|        - | 1582 | `		/* Save the extracted node */` |
|  1410630 | 1583 | `		SySetPut(pExprNode,(const void *)&pNode);` |
|        2 | 1584 | `	}` |
|   322166 | 1585 | `	if( SySetUsed(pExprNode) < 1 ){` |
|        - | 1586 | `		/* Empty expression [i.e: A semi-colon;] */` |
|      ! 0 | 1587 | `		*ppRoot = 0;` |
|      ! 0 | 1588 | `		return SXRET_OK;` |
|        - | 1589 | `	}` |
|   322166 | 1590 | `	apNode = (ph7_expr_node **)SySetBasePtr(pExprNode);` |
|        - | 1591 | `	/* Make sure we are dealing with valid nodes */` |
|   322166 | 1592 | `	rc = ExprVerifyNodes(&(*pGen),apNode,(sxi32)SySetUsed(pExprNode));` |
|   322166 | 1593 | `	if( rc != SXRET_OK ){` |
...
|        - | 1599 | `	}` |
|        - | 1600 | `	/* Build the tree */` |
|   322120 | 1601 | `	rc = ExprMakeTree(&(*pGen),apNode,(sxi32)SySetUsed(pExprNode));` |
|   322120 | 1602 | `	if( rc != SXRET_OK ){` |
|        - | 1603 | `		/* Something goes wrong [i.e: Syntax error] */` |
|       84 | 1604 | `		*ppRoot = 0;` |
|       84 | 1605 | `		return rc;` |
|        - | 1606 | `	}` |
|        - | 1607 | `	/* Point to the root of the tree */` |
|   322038 | 1608 | `	*ppRoot = apNode[0];` |
|   322038 | 1609 | `	return SXRET_OK;` |
|   161101 | 1610 |  |
|        - | 1611 |  |
