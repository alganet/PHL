...
|        - |  253 | ` */` |
|   482458 |  254 | `PH7_PRIVATE const ph7_expr_op *  PH7_ExprExtractOperator(SyString *pStr,SyToken *pLast)` |
|        2 |  255 |  |
|   482460 |  256 | `	sxu32 n = 0;` |
|        - |  257 | `	sxi32 rc;` |
|        - |  258 | `	/* Do a linear lookup on the operators table */` |
|  7447641 |  259 | `	for(;;){` |
| 14895284 |  260 | `		if( n >= SX_ARRAYSIZE(aOpTable) ){` |
|      ! 0 |  261 | `			break;` |
|        - |  262 | `		}` |
| 14895284 |  263 | `		if( SyisAlpha(aOpTable[n].sOp.zString[0]) ){` |
|        - |  264 | `			/* TICKET 1433-012: Alpha stream operators [i.e: and,or,xor,new...] */` |
|  1880406 |  265 | `			rc = SyStringCmp(pStr,&aOpTable[n].sOp,SyStrnicmp);` |
|   940204 |  266 | `		}else{` |
| 13014880 |  267 | `			rc = SyStringCmp(pStr,&aOpTable[n].sOp,SyMemcmp);` |
|        - |  268 | `		}` |
| 14895284 |  269 | `		if( rc == 0 ){` |
|   482936 |  270 | `			if( aOpTable[n].sOp.nByte != sizeof(char) \|\| (aOpTable[n].iOp != EXPR_OP_UMINUS && aOpTable[n].iOp != EXPR_OP_UPLUS) \|\| pLast == 0 ){` |
|        - |  271 | `				/* There is no ambiguity here,simply return the first operator seen */` |
|   482168 |  272 | `				return &aOpTable[n];` |
|        - |  273 | `			}` |
|        - |  274 | `			/* Handle ambiguity */` |
|      770 |  275 | `			if( pLast->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*'['*/\|PH7_TK_COLON/*:*/\|PH7_TK_COMMA/*,'*/) ){` |
|        - |  276 | `				/* Unary opertors have prcedence here over binary operators */` |
|      186 |  277 | `				return &aOpTable[n];` |
|        - |  278 | `			}` |
|      586 |  279 | `			if( pLast->nType & PH7_TK_OP ){` |
...
|        4 |  287 | `			}` |
|      238 |  288 | `		}` |
| 14412826 |  289 | `		++n; /* Next operator in the table */` |
|        2 |  290 | `	}` |
...
|        - |  298 | ` */` |
|   206784 |  299 | `PH7_PRIVATE void PH7_DelimitNestedTokens(SyToken *pIn,SyToken *pEnd,sxu32 nTokStart,sxu32 nTokEnd,SyToken **ppEnd)` |
|        2 |  300 |  |
|   206786 |  301 | `	SyToken *pCur = pIn;` |
|   206786 |  302 | `	sxi32 iNest = 1;` |
|  1191008 |  303 | `	for(;;){` |
|  2382018 |  304 | `		if( pCur >= pEnd ){` |
|       90 |  305 | `			break;` |
|        - |  306 | `		}` |
|  2381930 |  307 | `		if( pCur->nType & nTokStart ){` |
|        - |  308 | `			/* Increment nesting level */` |
|   134648 |  309 | `			iNest++;` |
|  2314607 |  310 | `		}else if( pCur->nType & nTokEnd ){` |
|        - |  311 | `			/* Decrement nesting level */` |
|   341344 |  312 | `			iNest--;` |
|   341344 |  313 | `			if( iNest <= 0 ){` |
|   206698 |  314 | `				break;` |
|        - |  315 | `			}` |
|    67323 |  316 | `		}` |
|        - |  317 | `		/* Advance cursor */` |
...
|        - |  331 | ` */` |
|    14734 |  332 | `PH7_PRIVATE int PH7_IsLangConstruct(sxu32 nKeyID,sxu8 bCheckFunc)` |
|        2 |  333 |  |
|    22039 |  334 | `	if( nKeyID == PH7_TKWRD_ECHO \|\| nKeyID == PH7_TKWRD_PRINT \|\| nKeyID == PH7_TKWRD_INCLUDE` |
|    14645 |  335 | `		\|\| nKeyID == PH7_TKWRD_INCONCE \|\| nKeyID == PH7_TKWRD_REQUIRE \|\| nKeyID == PH7_TKWRD_REQONCE` |
|        - |  336 | `		){` |
|      138 |  337 | `			return TRUE;` |
|        - |  338 | `	}` |
|    14600 |  339 | `	if( bCheckFunc ){` |
|     2368 |  340 | `		if(  nKeyID == PH7_TKWRD_ISSET \|\| nKeyID == PH7_TKWRD_UNSET \|\| nKeyID == PH7_TKWRD_EVAL` |
...
|     2358 |  343 | `				return TRUE;` |
|        - |  344 | `		}` |
|        4 |  345 | `	}` |
|        - |  346 | `	/* Not a language construct */` |
|    12244 |  347 | `	return FALSE;` |
|     7369 |  348 |  |
|        - |  349 | `/*` |
...
|        - |  354 | ` */` |
|   398542 |  355 | `static sxi32 ExprVerifyNodes(ph7_gen_state *pGen,ph7_expr_node **apNode,sxi32 nNode)` |
|        2 |  356 |  |
|        - |  357 | `	sxi32 iParen,iSquare,iQuesty,iBraces;` |
|        - |  358 | `	sxi32 i,rc;` |
|        - |  359 |  |
|   398544 |  360 | `	if( nNode > 0 && apNode[0]->pOp && (apNode[0]->pOp->iOp == EXPR_OP_ADD \|\| apNode[0]->pOp->iOp == EXPR_OP_SUB) ){` |
...
|        3 |  364 | `	}` |
|   398544 |  365 | `	iParen = iSquare = iQuesty = iBraces = 0;` |
|  2152540 |  366 | `	for( i = 0 ; i < nNode ; ++i ){` |
|  1754028 |  367 | `		if( apNode[i]->pStart->nType & PH7_TK_LPAREN /*'('*/){` |
|   183414 |  368 | `			if( i > 0 && ( apNode[i-1]->xCode == PH7_CompileVariable \|\| apNode[i-1]->xCode == PH7_CompileLiteral \|\|` |
|    10260 |  369 | `				(apNode[i - 1]->pStart->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_SSTR\|PH7_TK_DSTR\|PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}'*/))) ){` |
|        - |  370 | `					/* Ticket 1433-033: Take care to ignore alpha-stream [i.e: or,xor] operators followed by an opening parenthesis */` |
|   167138 |  371 | `					if( (apNode[i - 1]->pStart->nType & PH7_TK_OP) == 0 ){` |
|        - |  372 | `						/* We are dealing with a postfix [i.e: function call]  operator` |
|        - |  373 | `						 * not a simple left parenthesis. Mark the node.` |
|        - |  374 | `						 */` |
|   167138 |  375 | `						apNode[i]->pStart->nType \|= PH7_TK_OP;` |
|   167138 |  376 | `						apNode[i]->pStart->pUserData = (void *)&sFCallOp; /* Function call operator */` |
|   167138 |  377 | `						apNode[i]->pOp = &sFCallOp;` |
|    83568 |  378 | `					}` |
|    83568 |  379 | `			}` |
|   183414 |  380 | `			iParen++;` |
|  1662322 |  381 | `		}else if( apNode[i]->pStart->nType & PH7_TK_RPAREN/*')*/){` |
|   183410 |  382 | `			if( iParen <= 0 ){` |
...
|        - |  388 | `			}` |
|   183402 |  389 | `			iParen--;` |
|  1478908 |  390 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OSB /*'['*/){` |
|    45268 |  391 | `			iSquare++;` |
|  1364575 |  392 | `		}else if (apNode[i]->pStart->nType & PH7_TK_CSB /*']'*/){` |
|    45282 |  393 | `			if( iSquare <= 0 ){` |
...
|        - |  399 | `			}` |
|    45276 |  400 | `			iSquare--;` |
|  1319299 |  401 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OCB /*'{'*/){` |
|       14 |  402 | `			iBraces++;` |
...
|        - |  446 |  |
|        7 |  447 | `			}` |
|  1296656 |  448 | `		}else if (apNode[i]->pStart->nType & PH7_TK_CCB /*'}'*/){` |
|       15 |  449 | `			if( iBraces <= 0 ){` |
...
|        - |  455 | `			}` |
|        3 |  456 | `			iBraces--;` |
|  1296637 |  457 | `		}else if ( apNode[i]->pStart->nType & PH7_TK_COLON ){` |
|     1608 |  458 | `			if( iQuesty <= 0 ){` |
...
|        - |  464 | `			}` |
|     1604 |  465 | `			iQuesty--;` |
|  1295831 |  466 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OP ){` |
|   378998 |  467 | `			const ph7_expr_op *pOp = (const ph7_expr_op *)apNode[i]->pOp;` |
|   378998 |  468 | `			if( pOp->iOp == EXPR_OP_QUESTY ){` |
|     1606 |  469 | `				iQuesty++;` |
|   378196 |  470 | `			}else if( i > 0 && (pOp->iOp == EXPR_OP_UMINUS \|\| pOp->iOp == EXPR_OP_UPLUS)){` |
...
|   189498 |  490 | `		}` |
|   877000 |  491 | `	}` |
|   398514 |  492 | `	if( iParen != 0 \|\| iSquare != 0 \|\| iQuesty != 0 \|\| iBraces != 0){` |
...
|       17 |  497 | `		return rc;` |
|        - |  498 | `	}` |
|   398498 |  499 | `	return SXRET_OK;` |
|   199273 |  500 |  |
|        - |  501 | `/*` |
|        - |  502 | ` * Collect and assemble tokens holding a namespace path [i.e: namespace\to\const]` |
|        - |  503 | ` * or a simple literal [i.e: PHP_EOL].` |
|        - |  504 | ` */` |
|   319234 |  505 | `static void ExprAssembleLiteral(SyToken **ppCur,SyToken *pEnd)` |
|        2 |  506 |  |
|   319236 |  507 | `	SyToken *pIn = *ppCur;` |
|        - |  508 | `	/* Jump the first literal seen */` |
|   319236 |  509 | `	if( (pIn->nType & PH7_TK_NSSEP) == 0 ){` |
|   319234 |  510 | `		pIn++;` |
|   159616 |  511 | `	}` |
|   159622 |  512 | `	for(;;){` |
|   319246 |  513 | `		if(pIn < pEnd && (pIn->nType & PH7_TK_NSSEP) ){` |
|       11 |  514 | `			pIn++;` |
...
|        - |  648 | ` */` |
|  1754172 |  649 | `static sxi32 ExprExtractNode(ph7_gen_state *pGen,ph7_expr_node **ppNode)` |
|        2 |  650 |  |
|        - |  651 | `	ph7_expr_node *pNode;` |
|        - |  652 | `	SyToken *pCur;` |
|        - |  653 | `	sxi32 rc;` |
|        - |  654 | `	/* Allocate a new node */` |
|  1754174 |  655 | `	pNode = (ph7_expr_node *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_expr_node));` |
|  1754174 |  656 | `	if( pNode == 0 ){` |
...
|  1754174 |  663 | `	SyZero(pNode,sizeof(ph7_expr_node));` |
|  1754174 |  664 | `	SySetInit(&pNode->aNodeArgs,&pGen->pVm->sAllocator,sizeof(ph7_expr_node **));` |
|        - |  665 | `	/* Point to the head of the token stream */` |
|  1754174 |  666 | `	pCur = pNode->pStart = pGen->pIn;` |
|        - |  667 | `	/* Start collecting tokens */` |
|  1754174 |  668 | `	if( pCur->nType & PH7_TK_OP ){` |
|        - |  669 | `		/* Point to the instance that describe this operator */` |
|   424302 |  670 | `		pNode->pOp = (const ph7_expr_op *)pCur->pUserData;` |
|        - |  671 | `		/* Advance the stream cursor */` |
|   424302 |  672 | `		pCur++;` |
|  1542024 |  673 | `	}else if( pCur->nType & PH7_TK_DOLLAR ){` |
|        - |  674 | `		/* Isolate variable */` |
|   952054 |  675 | `		while( pCur < pGen->pEnd && (pCur->nType & PH7_TK_DOLLAR) ){` |
|   476034 |  676 | `			pCur++; /* Variable variable */` |
|        2 |  677 | `		}` |
|   476022 |  678 | `		if( pCur < pGen->pEnd ){` |
|   476022 |  679 | `			if (pCur->nType & (PH7_TK_ID\|PH7_TK_KEYWORD) ){` |
|        - |  680 | `				/* Variable name */` |
|   475994 |  681 | `				pCur++;` |
|   238026 |  682 | `			}else if( pCur->nType & PH7_TK_OCB /* '{' */ ){` |
|       22 |  683 | `				pCur++;` |
...
|        8 |  696 | `			}` |
|   238008 |  697 | `		}` |
|   476018 |  698 | `		pNode->xCode = PH7_CompileVariable;` |
|  1091862 |  699 | `	 }else if( pCur->nType & PH7_TK_KEYWORD ){` |
|    19810 |  700 | `		 sxu32 nKeyword = (sxu32)SX_PTR_TO_INT(pCur->pUserData);` |
|    19810 |  701 | `		 if( nKeyword == PH7_TKWRD_ARRAY \|\|  nKeyword == PH7_TKWRD_LIST ){` |
|        - |  702 | `			 /* List/Array node */` |
|     7362 |  703 | `			 if( &pCur[1] >= pGen->pEnd \|\| (pCur[1].nType & PH7_TK_LPAREN) == 0 ){` |
...
|     7346 |  710 | `				 PH7_DelimitNestedTokens(pCur,pGen->pEnd,PH7_TK_LPAREN /* '(' */, PH7_TK_RPAREN /* ')' */,&pCur);` |
|     7346 |  711 | `				 if( pCur < pGen->pEnd ){` |
|     7344 |  712 | `					 pCur++;` |
|     3673 |  713 | `				 }else{` |
|        - |  714 | `					 /* Syntax error */` |
...
|        3 |  721 | `					 return rc;` |
|        - |  722 | `				 }` |
|     7344 |  723 | `				 pNode->xCode = (nKeyword == PH7_TKWRD_LIST) ? PH7_CompileList : PH7_CompileArray;` |
|     7344 |  724 | `				 if( pNode->xCode == PH7_CompileList ){` |
...
|       12 |  735 | `				 }` |
|        2 |  736 | `			 }` |
|    16128 |  737 | `		 }else if( nKeyword == PH7_TKWRD_FUNCTION ){` |
...
|        2 |  751 | `			  }` |
|    12369 |  752 | `		 }else if( PH7_IsLangConstruct(nKeyword,FALSE) == TRUE && &pCur[1] < pGen->pEnd ){` |
...
|    12240 |  758 | `			 ExprAssembleLiteral(&pCur,pGen->pEnd);` |
|    12240 |  759 | `			 pNode->xCode = PH7_CompileLiteral;` |
|        2 |  760 | `		 }` |
|   843936 |  761 | `	 }else if( pCur->nType & (PH7_TK_NSSEP\|PH7_TK_ID) ){` |
|        - |  762 | `		 /* Constants,function name,namespace path,class name... */` |
|   306982 |  763 | `		 ExprAssembleLiteral(&pCur,pGen->pEnd);` |
|   306982 |  764 | `		 pNode->xCode = PH7_CompileLiteral;` |
|   153492 |  765 | `	 }else{` |
|   527066 |  766 | `		 if( (pCur->nType & (PH7_TK_LPAREN\|PH7_TK_RPAREN\|PH7_TK_COMMA\|PH7_TK_COLON\|PH7_TK_CSB\|PH7_TK_OCB\|PH7_TK_CCB)) == 0 ){` |
|        - |  767 | `			 /* Point to the code generator routine */` |
|   113318 |  768 | `			 pNode->xCode = PH7_GetNodeHandler(pCur->nType);` |
|   113318 |  769 | `			 if( pNode->xCode == 0 ){` |
...
|  1754140 |  782 | `	pNode->pEnd = pCur;` |
|        - |  783 | `	/* Save the node for later processing */` |
|  1754140 |  784 | `	*ppNode = pNode;` |
|        - |  785 | `	/* Synchronize cursors */` |
|  1754140 |  786 | `	pGen->pIn = pCur;` |
|  1754140 |  787 | `	return SXRET_OK;` |
|   877088 |  788 |  |
|        - |  789 | `/*` |
...
|        - |  792 | ` * level is zero.` |
|        - |  793 | ` */` |
|    28662 |  794 | `PH7_PRIVATE sxi32 PH7_GetNextExpr(SyToken *pStart,SyToken *pEnd,SyToken **ppNext)` |
|        2 |  795 |  |
|    28664 |  796 | `	SyToken *pCur = pStart;` |
|    28664 |  797 | `	sxi32 iNest = 0;` |
|    28664 |  798 | `	if( pCur >= pEnd \|\| (pCur->nType & PH7_TK_SEMI/*';'*/) ){` |
|        - |  799 | `		/* Last expression */` |
|    16366 |  800 | `		return SXERR_EOF;` |
|        - |  801 | `	}` |
|    62738 |  802 | `	while( pCur < pEnd ){` |
|    61410 |  803 | `		if( (pCur->nType & (PH7_TK_COMMA/*','*/\|PH7_TK_SEMI/*';'*/)) && iNest <= 0){` |
|    10972 |  804 | `			break;` |
|        - |  805 | `		}` |
|    50440 |  806 | `		if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|     3934 |  807 | `			iNest++;` |
|    48474 |  808 | `		}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}*/) ){` |
|     3936 |  809 | `			iNest--;` |
|     1967 |  810 | `		}` |
|    50440 |  811 | `		pCur++;` |
|        2 |  812 | `	}` |
|    12300 |  813 | `	*ppNext = pCur;` |
|    12300 |  814 | `	return SXRET_OK;` |
|    14333 |  815 |  |
|        - |  816 | `/*` |
|        - |  817 | ` * Free an expression tree.` |
|        - |  818 | ` */` |
|  1523948 |  819 | `static void ExprFreeTree(ph7_gen_state *pGen,ph7_expr_node *pNode)` |
|        2 |  820 |  |
|  1523950 |  821 | `	if( pNode->pLeft ){` |
|        - |  822 | `		/* Release the left tree */` |
|   575108 |  823 | `		ExprFreeTree(&(*pGen),pNode->pLeft);` |
|   287553 |  824 | `	}` |
|  1523950 |  825 | `	if( pNode->pRight ){` |
|        - |  826 | `		/* Release the right tree */` |
|   321048 |  827 | `		ExprFreeTree(&(*pGen),pNode->pRight);` |
|   160523 |  828 | `	}` |
|  1523950 |  829 | `	if( pNode->pCond ){` |
|        - |  830 | `		/* Release the conditional tree used by the ternary operator */` |
|     1602 |  831 | `		ExprFreeTree(&(*pGen),pNode->pCond);` |
|      800 |  832 | `	}` |
|  1523950 |  833 | `	if( SySetUsed(&pNode->aNodeArgs) > 0 ){` |
|        - |  834 | `		ph7_expr_node **apArg;` |
|        - |  835 | `		sxu32 n;` |
|        - |  836 | `		/* Release node arguments */` |
|   178602 |  837 | `		apArg = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|   373390 |  838 | `		for( n = 0 ; n < SySetUsed(&pNode->aNodeArgs) ; ++n ){` |
|   194790 |  839 | `			ExprFreeTree(&(*pGen),apArg[n]);` |
|    97396 |  840 | `		}` |
|   178602 |  841 | `		SySetRelease(&pNode->aNodeArgs);` |
|    89300 |  842 | `	}` |
|        - |  843 | `	/* Finally,release this node */` |
|  1523950 |  844 | `	SyMemBackendPoolFree(&pGen->pVm->sAllocator,pNode);` |
|  1523950 |  845 |  |
|        - |  846 | `/*` |
|        - |  847 | ` * Free an expression tree.` |
|        - |  848 | ` * This function is a wrapper around ExprFreeTree() defined above.` |
|        - |  849 | ` */` |
|   398576 |  850 | `PH7_PRIVATE sxi32 PH7_ExprFreeTree(ph7_gen_state *pGen,SySet *pNodeSet)` |
|        2 |  851 |  |
|        - |  852 | `	ph7_expr_node **apNode;` |
|        - |  853 | `	sxu32 n;` |
|   398578 |  854 | `	apNode = (ph7_expr_node **)SySetBasePtr(pNodeSet);` |
|  2152716 |  855 | `	for( n = 0  ; n < SySetUsed(pNodeSet) ; ++n ){` |
|  1754140 |  856 | `		if( apNode[n] ){` |
|   398882 |  857 | `			ExprFreeTree(&(*pGen),apNode[n]);` |
|   199440 |  858 | `		}` |
|   877071 |  859 | `	}` |
|   398578 |  860 | `	return SXRET_OK;` |
|        2 |  861 |  |
|        - |  862 | `/*` |
|        - |  863 | ` * Check if the given node is a modifialbe l/r-value.` |
|        - |  864 | ` * Return TRUE if modifiable.FALSE otherwise.` |
|        - |  865 | ` */` |
|   140192 |  866 | `static int ExprIsModifiableValue(ph7_expr_node *pNode,sxu8 bFunc)` |
|        2 |  867 |  |
|        - |  868 | `	sxi32 iExprOp;` |
|   140194 |  869 | `	if( pNode->pOp == 0 ){` |
|    93988 |  870 | `		return pNode->xCode == PH7_CompileVariable ? TRUE : FALSE;` |
|        - |  871 | `	}` |
|    46208 |  872 | `	iExprOp = pNode->pOp->iOp;` |
|    46208 |  873 | `	if( iExprOp == EXPR_OP_ARROW /*'->' */ \|\| iExprOp == EXPR_OP_DC /*'::'*/ ){` |
|    32538 |  874 | `			return TRUE;` |
|        - |  875 | `	}` |
|    13672 |  876 | `	if( iExprOp == EXPR_OP_SUBSCRIPT/*'[]'*/ ){` |
|    13668 |  877 | `		if( pNode->pLeft->pOp ) {` |
|        2 |  878 | `			if( pNode->pLeft->pOp->iOp != EXPR_OP_SUBSCRIPT /*'['*/ && pNode->pLeft->pOp->iOp != EXPR_OP_ARROW /*'->'*/` |
|        2 |  879 | `				&& pNode->pLeft->pOp->iOp != EXPR_OP_DC /*'::'*/){` |
|      ! 0 |  880 | `				return FALSE;` |
|        1 |  881 | `			}` |
|    13667 |  882 | `		}else if( pNode->pLeft->xCode != PH7_CompileVariable ){` |
|      ! 0 |  883 | `			return FALSE;` |
|        - |  884 | `		}` |
|    13668 |  885 | `		return TRUE;` |
|        - |  886 | `	}` |
...
|        - |  900 | ` */` |
|   142930 |  901 | `static sxi32 ExprProcessFuncArguments(ph7_gen_state *pGen,ph7_expr_node *pOp,ph7_expr_node **apNode,sxi32 nToken)` |
|        2 |  902 |  |
...
|   142932 |  906 | `	iCur = 0;` |
|   151023 |  907 | `	for(;;){` |
|   302048 |  908 | `		if( iCur >= nToken ){` |
|        - |  909 | `			/* No more arguments to process */` |
|   142930 |  910 | `			break;` |
|        - |  911 | `		}` |
|   159120 |  912 | `		iNode = iCur;` |
|   159120 |  913 | `		iNest = 0;` |
|   395492 |  914 | `		while( iCur < nToken ){` |
|   252564 |  915 | `			if( apNode[iCur] ){` |
|   252564 |  916 | `				if( (apNode[iCur]->pStart->nType & PH7_TK_COMMA) && apNode[iCur]->pLeft == 0 && iNest <= 0 ){` |
|     8097 |  917 | `					break;` |
|   236374 |  918 | `				}else if( apNode[iCur]->pStart->nType & (PH7_TK_LPAREN\|PH7_TK_OSB\|PH7_TK_OCB) ){` |
|    14096 |  919 | `					iNest++;` |
|   229327 |  920 | `				}else if( apNode[iCur]->pStart->nType & (PH7_TK_RPAREN\|PH7_TK_CCB\|PH7_TK_CSB) ){` |
|    14096 |  921 | `					iNest--;` |
|     7047 |  922 | `				}` |
|   118186 |  923 | `			}` |
|   236374 |  924 | `			iCur++;` |
|        2 |  925 | `		}` |
|   159120 |  926 | `		if( iCur > iNode ){` |
|   159116 |  927 | `			if( apNode[iNode] && (apNode[iNode]->pStart->nType & PH7_TK_AMPER /*'&'*/) && ((iCur - iNode) == 2)` |
...
|      ! 0 |  933 | `			}` |
|   159118 |  934 | `			ExprMakeTree(&(*pGen),&apNode[iNode],iCur-iNode);` |
|   159118 |  935 | `			if( apNode[iNode] ){` |
|        - |  936 | `				/* Put a pointer to the root of the tree in the arguments set */` |
|   159118 |  937 | `				SySetPut(&pOp->aNodeArgs,(const void *)&apNode[iNode]);` |
|    79560 |  938 | `			}else{` |
...
|   159118 |  954 | `		if( iCur < nToken && apNode[iCur] && (apNode[iCur]->pStart->nType & PH7_TK_COMMA) ){` |
|    16190 |  955 | `			iCur++;` |
|    16190 |  956 | `			if( iCur >= nToken ){` |
...
|        - |  972 | `  */` |
|   614852 |  973 | ` static sxi32 ExprMakeTree(ph7_gen_state *pGen,ph7_expr_node **apNode,sxi32 nToken)` |
|        2 |  974 | ` {` |
|        - |  975 | `	 sxi32 i,iLeft,iRight;` |
|        - |  976 | `	 ph7_expr_node *pNode;` |
|        - |  977 | `	 sxi32 iCur;` |
|        - |  978 | `	 sxi32 rc;` |
|   614854 |  979 | `	 if( nToken <= 0 \|\| (nToken == 1 && apNode[0]->xCode) ){` |
|        - |  980 | `		 /* TICKET 1433-17: self evaluating node */` |
|   263646 |  981 | `		 return SXRET_OK;` |
|        - |  982 | `	 }` |
|        - |  983 | `	 /* Process expressions enclosed in parenthesis first */` |
|  2101084 |  984 | `	 for( iCur =  0 ; iCur < nToken ; ++iCur ){` |
|        - |  985 | `		 sxi32 iNest;` |
...
|        - |  988 | `		  */` |
|  1749878 |  989 | `		 if( apNode[iCur] == 0 \|\| apNode[iCur]->pStart->nType != PH7_TK_LPAREN ){` |
|  1733612 |  990 | `			 continue;` |
|        - |  991 | `		 }` |
|    16268 |  992 | `		 iNest = 1;` |
|    16268 |  993 | `		 iLeft = iCur;` |
|        - |  994 | `		 /* Find the closing parenthesis */` |
|    16268 |  995 | `		 iCur++;` |
|    93300 |  996 | `		 while( iCur < nToken ){` |
|    93300 |  997 | `			 if( apNode[iCur] ){` |
|    93300 |  998 | `				 if( apNode[iCur]->pStart->nType & PH7_TK_RPAREN /* ')' */){` |
|        - |  999 | `					 /* Decrement nesting level */` |
|    26304 | 1000 | `					 iNest--;` |
|    26304 | 1001 | `					 if( iNest <= 0 ){` |
|    16268 | 1002 | `						 break;` |
|        2 | 1003 | `					 }` |
|    72016 | 1004 | `				 }else if( apNode[iCur]->pStart->nType & PH7_TK_LPAREN /* '(' */ ){` |
...
|    77034 | 1009 | `			 iCur++;` |
|        2 | 1010 | `		 }` |
|    16268 | 1011 | `		 if( iCur - iLeft > 1 ){` |
|        - | 1012 | `			 /* Recurse and process this expression */` |
|    16268 | 1013 | `			 rc = ExprMakeTree(&(*pGen),&apNode[iLeft + 1],iCur - iLeft - 1);` |
|    16268 | 1014 | `			 if( rc != SXRET_OK ){` |
|        3 | 1015 | `				 return rc;` |
|        - | 1016 | `			 }` |
|     8132 | 1017 | `		 }` |
|        - | 1018 | `		 /* Free the left and right nodes */` |
|    16266 | 1019 | `		 ExprFreeTree(&(*pGen),apNode[iLeft]);` |
|    16266 | 1020 | `		 ExprFreeTree(&(*pGen),apNode[iCur]);` |
|    16266 | 1021 | `		 apNode[iLeft] = 0;` |
|    16266 | 1022 | `		 apNode[iCur] = 0;` |
|     8134 | 1023 | `	 }` |
|        - | 1024 | `	  /* Process expressions enclosed in braces */` |
|  2190162 | 1025 | `	 for( iCur =  0 ; iCur < nToken ; ++iCur ){` |
|        - | 1026 | `		 sxi32 iNest;` |
...
|        - | 1029 | `		  */` |
|  1843158 | 1030 | `		 if( apNode[iCur] == 0 \|\| apNode[iCur]->pStart->nType != PH7_TK_OCB ){` |
|  1843156 | 1031 | `			 continue;` |
|        - | 1032 | `		 }` |
|        3 | 1033 | `		 iNest = 1;` |
|        3 | 1034 | `		 iLeft = iCur;` |
...
|   347006 | 1066 | `	 iLeft = -1;` |
|  2190134 | 1067 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  1843140 | 1068 | `		 if( apNode[iCur] == 0 ){` |
|   667542 | 1069 | `			 continue;` |
|        - | 1070 | `		 }` |
|  1175600 | 1071 | `		 pNode = apNode[iCur];` |
|  1175600 | 1072 | `		 if( pNode->pOp && pNode->pOp->iPrec == 2 && pNode->pLeft == 0  ){` |
|   285396 | 1073 | `			 if( pNode->pOp->iOp == EXPR_OP_FUNC_CALL ){` |
|        - | 1074 | `				 /* Collect function arguments */` |
|   167134 | 1075 | `				 sxi32 iPtr = 0;` |
|   167134 | 1076 | `				 sxi32 nFuncTok = 0;` |
|   586830 | 1077 | `				 while( nFuncTok + iCur < nToken ){` |
|   586830 | 1078 | `					 if( apNode[nFuncTok+iCur] ){` |
|   586830 | 1079 | `						 if( apNode[nFuncTok+iCur]->pStart->nType & PH7_TK_LPAREN /*'('*/ ){` |
|   171356 | 1080 | `							 iPtr++;` |
|   501153 | 1081 | `						 }else if ( apNode[nFuncTok+iCur]->pStart->nType & PH7_TK_RPAREN /*')'*/){` |
|   171356 | 1082 | `							 iPtr--;` |
|   171356 | 1083 | `							 if( iPtr <= 0 ){` |
|   167134 | 1084 | `								 break;` |
|        - | 1085 | `							 }` |
|     2111 | 1086 | `						 }` |
|   209848 | 1087 | `					 }` |
|   419698 | 1088 | `					 nFuncTok++;` |
|        2 | 1089 | `				 }` |
|   167134 | 1090 | `				 if( nFuncTok + iCur >= nToken ){` |
|        - | 1091 | `					 /* Syntax error */` |
...
|      ! 0 | 1096 | `					 return rc;` |
|        - | 1097 | `				 }` |
|   167134 | 1098 | `				 if(  iLeft < 0 \|\| !NODE_ISTERM(iLeft) /*\|\| ( apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec != 2)*/ ){` |
|        - | 1099 | `					 /* Syntax error */` |
...
|      ! 0 | 1104 | `					 return rc;` |
|        - | 1105 | `				 }` |
|   167134 | 1106 | `				 if( nFuncTok > 1 ){` |
|        - | 1107 | `					 /* Process function arguments */` |
|   142932 | 1108 | `					 rc = ExprProcessFuncArguments(&(*pGen),pNode,&apNode[iCur+1],nFuncTok-1);` |
|   142932 | 1109 | `					 if( rc != SXRET_OK ){` |
|        3 | 1110 | `						 return rc;` |
|        - | 1111 | `					 }` |
|    71464 | 1112 | `				 }` |
|        - | 1113 | `				 /* Link the node to the tree */` |
|   167132 | 1114 | `				 pNode->pLeft = apNode[iLeft];` |
|   167132 | 1115 | `				 apNode[iLeft] = 0;` |
|   586822 | 1116 | `				 for( iPtr = 1; iPtr <= nFuncTok ; iPtr++ ){` |
|   419692 | 1117 | `					 apNode[iCur+iPtr] = 0;` |
|   209847 | 1118 | `				 }` |
|   201829 | 1119 | `			 }else if (pNode->pOp->iOp == EXPR_OP_SUBSCRIPT ){` |
|        - | 1120 | `				 /* Subscripting */` |
|    45276 | 1121 | `				 sxi32 iArrTok = iCur + 1;` |
|    45276 | 1122 | `				 sxi32 iNest = 1;` |
|    45295 | 1123 | `				 if(  iLeft < 0 \|\| apNode[iLeft] == 0 \|\| (apNode[iLeft]->pOp == 0 && (apNode[iLeft]->xCode != PH7_CompileVariable &&` |
|        2 | 1124 | `					 apNode[iLeft]->xCode != PH7_CompileSimpleString && apNode[iLeft]->xCode != PH7_CompileString ) ) \|\|` |
|    45274 | 1125 | `					 ( apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec != 2 /* postfix */) ){` |
|        - | 1126 | `						 /* Syntax error */` |
...
|    81050 | 1134 | `				 while( iArrTok < nToken ){` |
|    81050 | 1135 | `					 if( apNode[iArrTok] ){` |
|    81018 | 1136 | `						 if( apNode[iArrTok]->pOp && apNode[iArrTok]->pOp->iOp == EXPR_OP_SUBSCRIPT &&  apNode[iArrTok]->pLeft == 0){` |
|        - | 1137 | `							 /* Increment nesting level */` |
|      ! 0 | 1138 | `							 iNest++;` |
|    81018 | 1139 | `						 }else if( apNode[iArrTok]->pStart->nType & PH7_TK_CSB /*']'*/){` |
|        - | 1140 | `							 /* Decrement nesting level */` |
|    45272 | 1141 | `							 iNest--;` |
|    45272 | 1142 | `							 if( iNest <= 0 ){` |
|    45272 | 1143 | `								 break;` |
|        - | 1144 | `							 }` |
|      ! 0 | 1145 | `						 }` |
|    17873 | 1146 | `					 }` |
|    35780 | 1147 | `					 ++iArrTok;` |
|        2 | 1148 | `				 }` |
|    45272 | 1149 | `				 if( iArrTok > iCur + 1 ){` |
|        - | 1150 | `					 /* Recurse and process this expression */` |
|    35674 | 1151 | `					 rc = ExprMakeTree(&(*pGen),&apNode[iCur+1],iArrTok - iCur - 1);` |
|    35674 | 1152 | `					 if( rc != SXRET_OK ){` |
|      ! 0 | 1153 | `						 return rc;` |
|        - | 1154 | `					 }` |
|        - | 1155 | `					 /* Link the node to it's index */` |
|    35674 | 1156 | `					 SySetPut(&pNode->aNodeArgs,(const void *)&apNode[iCur+1]);` |
|    17836 | 1157 | `				 }` |
|        - | 1158 | `				 /* Link the node to the tree */` |
|    45272 | 1159 | `				 pNode->pLeft = apNode[iLeft];` |
|    45272 | 1160 | `				 pNode->pRight = 0;` |
|    45272 | 1161 | `				 apNode[iLeft] = 0;` |
|   126320 | 1162 | `				 for( iNest = iCur + 1 ; iNest <= iArrTok ; ++iNest ){` |
|    81050 | 1163 | `					 apNode[iNest] = 0;` |
|    40526 | 1164 | `				 }` |
|    22637 | 1165 | `			 }else{` |
|        - | 1166 | `				 /* Member access operators [i.e: '->','::'] */` |
|    72990 | 1167 | `				  iRight = iCur + 1;` |
|    72990 | 1168 | `				 while( iRight < nToken && apNode[iRight] == 0 ){` |
|      ! 0 | 1169 | `					 iRight++;` |
|      ! 0 | 1170 | `				 }` |
|    72990 | 1171 | `				 if( iRight >= nToken \|\| iLeft < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|        - | 1172 | `					 /* Syntax error */` |
...
|    72986 | 1180 | `				 pNode->pLeft = apNode[iLeft];` |
|    72986 | 1181 | `				 if( pNode->pOp->iOp == EXPR_OP_ARROW /*'->'*/ && pNode->pLeft->pOp == 0 &&` |
|    72926 | 1182 | `					 pNode->pLeft->xCode != PH7_CompileVariable ){` |
|        - | 1183 | `						 /* Syntax error */` |
...
|      ! 0 | 1189 | `						 return rc;` |
|        - | 1190 | `				 }` |
|    72986 | 1191 | `				 pNode->pRight = apNode[iRight];` |
|    72986 | 1192 | `				 apNode[iLeft] = apNode[iRight] = 0;` |
|        - | 1193 | `			 }` |
|   142692 | 1194 | `		 }` |
|  1175590 | 1195 | `		 iLeft = iCur;` |
|   587796 | 1196 | `	 }` |
|        - | 1197 | `	 /* Handle left associative (new, clone) operators */` |
|  2190102 | 1198 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  1843108 | 1199 | `		 if( apNode[iCur] == 0 ){` |
|   960816 | 1200 | `			 continue;` |
|        - | 1201 | `		 }` |
|   882294 | 1202 | `		 pNode = apNode[iCur];` |
|   882294 | 1203 | `		 if( pNode->pOp && pNode->pOp->iPrec == 1 && pNode->pLeft == 0 ){` |
|        - | 1204 | `			 SyToken *pToken;` |
|        - | 1205 | `			 /* Get the left node */` |
|     7892 | 1206 | `			 iLeft = iCur + 1;` |
|    15760 | 1207 | `			 while( iLeft < nToken && apNode[iLeft] == 0 ){` |
|     7870 | 1208 | `				 iLeft++;` |
|        2 | 1209 | `			 }` |
|     7892 | 1210 | `			 if( iLeft >= nToken \|\| !NODE_ISTERM(iLeft) ){` |
|        - | 1211 | `				  /* Syntax error */` |
...
|     7892 | 1220 | `			 if( pNode->pOp->iOp == EXPR_OP_CLONE ){` |
|        - | 1221 | `				 /* Clone:` |
...
|       10 | 1242 | `			 }else{` |
|        - | 1243 | `				 /* New */` |
|     7876 | 1244 | `				 if( apNode[iLeft]->pOp == 0 ){` |
...
|     7892 | 1260 | `			 pNode->pLeft = apNode[iLeft];` |
|     7892 | 1261 | `			 apNode[iLeft] = 0;` |
|     7892 | 1262 | `			 pNode->pRight = 0; /* Paranoid */` |
|     3945 | 1263 | `		 }` |
|   441148 | 1264 | `	 }` |
|        - | 1265 | `	  /* Handle post/pre icrement/decrement [i.e: ++/--] operators with precedence 3 */` |
|   346996 | 1266 | `	 iLeft = -1;` |
|  2190102 | 1267 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  1841008 | 1268 | `		 if( apNode[iCur] == 0 ){` |
|   960816 | 1269 | `			 continue;` |
|        - | 1270 | `		 }` |
|   880194 | 1271 | `		 pNode = apNode[iCur];` |
|   880194 | 1272 | `		 if( pNode->pOp && pNode->pOp->iPrec == 3 && pNode->pLeft == 0){` |
|     5744 | 1273 | `			 if( iLeft >= 0 && ((apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec == 2 /* Postfix */)` |
|     2112 | 1274 | `				 \|\| apNode[iLeft]->xCode == PH7_CompileVariable) ){` |
|        - | 1275 | `					 /* Link the node to the tree */` |
|     2108 | 1276 | `					 pNode->pLeft = apNode[iLeft];` |
|     2108 | 1277 | `					 apNode[iLeft] = 0;` |
|     1053 | 1278 | `			 }` |
|     3921 | 1279 | `		  }` |
|   882294 | 1280 | `		 iLeft = iCur;` |
|   441148 | 1281 | `	  }` |
|   349096 | 1282 | `	 iLeft = -1;` |
|  2192202 | 1283 | `	 for( iCur = nToken -  1 ; iCur >= 0 ; iCur-- ){` |
|  1843108 | 1284 | `		 if( apNode[iCur] == 0 ){` |
|   962922 | 1285 | `			 continue;` |
|        - | 1286 | `		 }` |
|   880188 | 1287 | `		 pNode = apNode[iCur];` |
|   880188 | 1288 | `		 if( pNode->pOp && pNode->pOp->iPrec == 3 && pNode->pLeft == 0){` |
|     5736 | 1289 | `			 if( iLeft < 0 \|\| (apNode[iLeft]->pOp == 0 && apNode[iLeft]->xCode != PH7_CompileVariable)` |
|     5738 | 1290 | `				 \|\| ( apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec != 2 /* Postfix */) ){` |
|        - | 1291 | `					 /* Syntax error */` |
...
|     5738 | 1299 | `			 pNode->pLeft = apNode[iLeft];` |
|     5738 | 1300 | `			 apNode[iLeft] = 0;` |
|        - | 1301 | `			 /* Mark as pre-increment/decrement node */` |
|     5738 | 1302 | `			 pNode->iFlags \|= EXPR_NODE_PRE_INCR;` |
|     2868 | 1303 | `		  }` |
|   880188 | 1304 | `		 iLeft = iCur;` |
|   440095 | 1305 | `	 }` |
|        - | 1306 | `	 /* Handle right associative unary and cast operators [i.e: !,(string),~...]  with precedence 4*/` |
|   349096 | 1307 | `	  iLeft = 0;` |
|  2192196 | 1308 | `	  for( iCur = nToken -  1 ; iCur >= 0 ; iCur-- ){` |
|  1843104 | 1309 | `		  if( apNode[iCur] ){` |
|   874448 | 1310 | `			  pNode = apNode[iCur];` |
|   874448 | 1311 | `			  if( pNode->pOp && pNode->pOp->iPrec == 4 && pNode->pLeft == 0){` |
|    25932 | 1312 | `				  if( iLeft > 0 ){` |
|        - | 1313 | `					  /* Link the node to the tree */` |
|    25930 | 1314 | `					  pNode->pLeft = apNode[iLeft];` |
|    25930 | 1315 | `					  apNode[iLeft] = 0;` |
|    25930 | 1316 | `					  if( pNode->pLeft && pNode->pLeft->pOp && pNode->pLeft->pOp->iPrec > 4 ){` |
...
|   874446 | 1336 | `			  iLeft = iCur;` |
|   437222 | 1337 | `		  }` |
|   921552 | 1338 | `	  }` |
|        - | 1339 | `	 /* Process left and non-associative binary operators [i.e: *,/,&&,\|\|...]*/` |
|  3839938 | 1340 | `	 for( i = 7 ; i < 17 ; i++ ){` |
|  3490854 | 1341 | `		 iLeft = -1;` |
| 21921608 | 1342 | `		 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
| 18430764 | 1343 | `			 if( apNode[iCur] == 0 ){` |
| 11336430 | 1344 | `				 continue;` |
|        - | 1345 | `			 }` |
|  7094336 | 1346 | `			 pNode = apNode[iCur];` |
|  7094336 | 1347 | `			 if( pNode->pOp && pNode->pOp->iPrec == i && pNode->pLeft == 0 ){` |
|        - | 1348 | `				 /* Get the right node */` |
|   106282 | 1349 | `				 iRight = iCur + 1;` |
|   143186 | 1350 | `				 while( iRight < nToken && apNode[iRight] == 0 ){` |
|    36906 | 1351 | `					 iRight++;` |
|        2 | 1352 | `				 }` |
|   106282 | 1353 | `				 if( iRight >= nToken \|\| iLeft < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|        - | 1354 | `					 /* Syntax error */` |
...
|        9 | 1359 | `					 return rc;` |
|        - | 1360 | `				 }` |
|   106274 | 1361 | `				 if( pNode->pOp->iOp == EXPR_OP_REF ){` |
|        - | 1362 | `					 sxi32  iTmp;` |
...
|   106274 | 1391 | `				 pNode->pLeft = apNode[iLeft];` |
|   106274 | 1392 | `				 pNode->pRight = apNode[iRight];` |
|   106274 | 1393 | `				 apNode[iLeft] = apNode[iRight] = 0;` |
|    53136 | 1394 | `			 }` |
|  7094328 | 1395 | `			 iLeft = iCur;` |
|  3547165 | 1396 | `		 }` |
|  1745424 | 1397 | `	 }` |
...
|        - | 1401 | `	  */` |
|   349086 | 1402 | `	  iLeft = -1;` |
|  2185224 | 1403 | `	  for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  1837742 | 1404 | `		  if( apNode[iCur] == 0 ){` |
|  1206604 | 1405 | `			  continue;` |
|        - | 1406 | `		  }` |
|   631140 | 1407 | `		  pNode = apNode[iCur];` |
|   631140 | 1408 | `		  if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_QUESTY && pNode->pLeft == 0 ){` |
|     1604 | 1409 | `			  sxi32 iNest = 1;` |
|     1604 | 1410 | `			  if( iLeft < 0 \|\| !NODE_ISTERM(iLeft) ){` |
...
|     1602 | 1419 | `			  iRight = iCur + 1;` |
|     3488 | 1420 | `			  while( iRight < nToken  ){` |
|     3488 | 1421 | `				  if( apNode[iRight] ){` |
|     3202 | 1422 | `					  if( apNode[iRight]->pOp && apNode[iRight]->pOp->iOp == EXPR_OP_QUESTY && apNode[iRight]->pCond == 0){` |
|        - | 1423 | `						  /* Increment nesting level */` |
|      ! 0 | 1424 | `						  ++iNest;` |
|     3202 | 1425 | `					  }else if( apNode[iRight]->pStart->nType & PH7_TK_COLON /*:*/ ){` |
|        - | 1426 | `						  /* Decrement nesting level */` |
|     1602 | 1427 | `						  --iNest;` |
|     1602 | 1428 | `						  if( iNest <= 0 ){` |
|     1602 | 1429 | `							  break;` |
|        - | 1430 | `						  }` |
|      ! 0 | 1431 | `					  }` |
|      800 | 1432 | `				  }` |
|     1888 | 1433 | `				  iRight++;` |
|        2 | 1434 | `			  }` |
|     1602 | 1435 | `			  if( iRight > iCur + 1 ){` |
|        - | 1436 | `				  /* Recurse and process the then expression */` |
|     1602 | 1437 | `				  rc = ExprMakeTree(&(*pGen),&apNode[iCur + 1],iRight - iCur - 1);` |
|     1602 | 1438 | `				  if( rc != SXRET_OK ){` |
|      ! 0 | 1439 | `					  return rc;` |
|        - | 1440 | `				  }` |
|        - | 1441 | `				  /* Link the node to the tree */` |
|     1602 | 1442 | `				  pNode->pLeft = apNode[iCur + 1];` |
|      802 | 1443 | `			  }else{` |
...
|      ! 0 | 1448 | `				 return rc;` |
|        - | 1449 | `			  }` |
|     1602 | 1450 | `			  apNode[iCur + 1] = 0;` |
|     1602 | 1451 | `			  if( iRight + 1 < nToken ){` |
|        - | 1452 | `				  /* Recurse and process the else expression */` |
|     1602 | 1453 | `				  rc = ExprMakeTree(&(*pGen),&apNode[iRight + 1],nToken - iRight - 1);` |
|     1602 | 1454 | `				  if( rc != SXRET_OK ){` |
|      ! 0 | 1455 | `					  return rc;` |
|        - | 1456 | `				  }` |
|        - | 1457 | `				  /* Link the node to the tree */` |
|     1602 | 1458 | `				  pNode->pRight = apNode[iRight + 1];` |
|     1602 | 1459 | `				  apNode[iRight + 1] =  apNode[iRight] = 0;` |
|      802 | 1460 | `			  }else{` |
...
|     1602 | 1468 | `			  pNode->pCond  = apNode[iLeft];` |
|     1602 | 1469 | `			  apNode[iLeft] = 0;` |
|     1602 | 1470 | `			  break;` |
|        - | 1471 | `		  }` |
|   629538 | 1472 | `		  iLeft = iCur;` |
|   314770 | 1473 | `	  }` |
...
|        - | 1477 | `	  */` |
|   349084 | 1478 | `	 iRight = -1;` |
|  2192062 | 1479 | `	 for( iCur = nToken -  1 ; iCur >= 0 ; iCur--){` |
|  1843020 | 1480 | `		 if( apNode[iCur] == 0 ){` |
|  1353650 | 1481 | `			 continue;` |
|        - | 1482 | `		 }` |
|   489372 | 1483 | `		 pNode = apNode[iCur];` |
|   489372 | 1484 | `		 if( pNode->pOp && pNode->pOp->iPrec == 18 && pNode->pLeft == 0 ){` |
|        - | 1485 | `			 /* Get the left node */` |
|   140162 | 1486 | `			 iLeft = iCur - 1;` |
|   190492 | 1487 | `			 while( iLeft >= 0 && apNode[iLeft] == 0 ){` |
|    50332 | 1488 | `				 iLeft--;` |
|        2 | 1489 | `			 }` |
|   140162 | 1490 | `			 if( iLeft < 0 \|\| iRight < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|        - | 1491 | `				 /* Syntax error */` |
...
|       39 | 1496 | `				 return rc;` |
|        - | 1497 | `			 }` |
|   140124 | 1498 | `			 if( ExprIsModifiableValue(apNode[iLeft],FALSE) == FALSE ){` |
...
|   140122 | 1510 | `			 pNode->pLeft = apNode[iRight];` |
|   140122 | 1511 | `			 pNode->pRight = apNode[iLeft];` |
|   140122 | 1512 | `			 apNode[iLeft] = apNode[iRight] = 0;` |
|    70060 | 1513 | `		 }` |
|   489332 | 1514 | `		 iRight = iCur;` |
|   244667 | 1515 | `	 }` |
|        - | 1516 | `	 /* Process left associative binary operators that have the lowest precedence [i.e: and,or,xor] */` |
|  1745212 | 1517 | `	 for( i = 19 ; i < 23 ; i++ ){` |
|  1396170 | 1518 | `		 iLeft = -1;` |
|  8768074 | 1519 | `		 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  7371906 | 1520 | `			 if( apNode[iCur] == 0 ){` |
|  5975316 | 1521 | `				 continue;` |
|        - | 1522 | `			 }` |
|  1396592 | 1523 | `			 pNode = apNode[iCur];` |
|  1396592 | 1524 | `			 if( pNode->pOp && pNode->pOp->iPrec == i && pNode->pLeft == 0 ){` |
...
|       35 | 1542 | `			 }` |
|  1396592 | 1543 | `			 iLeft = iCur;` |
|   698297 | 1544 | `		 }` |
|   698086 | 1545 | `	 }` |
|        - | 1546 | `	 /* Point to the root of the expression tree */` |
|  1842946 | 1547 | `	 for( iCur = 1 ; iCur < nToken ; ++iCur ){` |
|  1493926 | 1548 | `		 if( apNode[iCur] ){` |
|   310198 | 1549 | `			 if( (apNode[iCur]->pOp \|\| apNode[iCur]->xCode ) && apNode[0] != 0){` |
...
|       24 | 1554 | `				  return rc;` |
|        - | 1555 | `			 }` |
|   310176 | 1556 | `			 apNode[0] = apNode[iCur];` |
|   310176 | 1557 | `			 apNode[iCur] = 0;` |
|   155087 | 1558 | `		 }` |
|   746953 | 1559 | `	 }` |
|   349022 | 1560 | `	 return SXRET_OK;` |
|   306378 | 1561 | ` }` |
|        - | 1562 | ` /*` |
...
|        - | 1567 | `  */` |
|   398576 | 1568 | `PH7_PRIVATE sxi32 PH7_ExprMakeTree(ph7_gen_state *pGen,SySet *pExprNode,ph7_expr_node **ppRoot)` |
|        2 | 1569 |  |
|        - | 1570 | `	ph7_expr_node **apNode;` |
|        - | 1571 | `	ph7_expr_node *pNode;` |
|        - | 1572 | `	sxi32 rc;` |
|        - | 1573 | `	/* Reset node container */` |
|   398578 | 1574 | `	SySetReset(pExprNode);` |
|   398578 | 1575 | `	pNode = 0; /* Prevent compiler warning */` |
|        - | 1576 | `	/* Extract nodes one after one until we hit the end of the input */` |
|  2152716 | 1577 | `	while( pGen->pIn < pGen->pEnd ){` |
|  1754174 | 1578 | `		rc = ExprExtractNode(&(*pGen),&pNode);` |
|  1754174 | 1579 | `		if( rc != SXRET_OK ){` |
|       35 | 1580 | `			return rc;` |
|        - | 1581 | `		}` |
|        - | 1582 | `		/* Save the extracted node */` |
|  1754140 | 1583 | `		SySetPut(pExprNode,(const void *)&pNode);` |
|        2 | 1584 | `	}` |
|   398544 | 1585 | `	if( SySetUsed(pExprNode) < 1 ){` |
|        - | 1586 | `		/* Empty expression [i.e: A semi-colon;] */` |
|      ! 0 | 1587 | `		*ppRoot = 0;` |
|      ! 0 | 1588 | `		return SXRET_OK;` |
|        - | 1589 | `	}` |
|   398544 | 1590 | `	apNode = (ph7_expr_node **)SySetBasePtr(pExprNode);` |
|        - | 1591 | `	/* Make sure we are dealing with valid nodes */` |
|   398544 | 1592 | `	rc = ExprVerifyNodes(&(*pGen),apNode,(sxi32)SySetUsed(pExprNode));` |
|   398544 | 1593 | `	if( rc != SXRET_OK ){` |
...
|        - | 1599 | `	}` |
|        - | 1600 | `	/* Build the tree */` |
|   398498 | 1601 | `	rc = ExprMakeTree(&(*pGen),apNode,(sxi32)SySetUsed(pExprNode));` |
|   398498 | 1602 | `	if( rc != SXRET_OK ){` |
|        - | 1603 | `		/* Something goes wrong [i.e: Syntax error] */` |
|       84 | 1604 | `		*ppRoot = 0;` |
|       84 | 1605 | `		return rc;` |
|        - | 1606 | `	}` |
|        - | 1607 | `	/* Point to the root of the tree */` |
|   398416 | 1608 | `	*ppRoot = apNode[0];` |
|   398416 | 1609 | `	return SXRET_OK;` |
|   199290 | 1610 |  |
|        - | 1611 |  |
