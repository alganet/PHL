...
|        - |  267 | ` */` |
|   981230 |  268 | `PH7_PRIVATE const ph7_expr_op *  PH7_ExprExtractOperator(SyString *pStr,SyToken *pLast)` |
|        2 |  269 |  |
|   981232 |  270 | `	sxu32 n = 0;` |
|        - |  271 | `	sxi32 rc;` |
|        - |  272 | `	/* Do a linear lookup on the operators table */` |
| 16477755 |  273 | `	for(;;){` |
| 32955512 |  274 | `		if( n >= SX_ARRAYSIZE(aOpTable) ){` |
|      ! 0 |  275 | `			break;` |
|        - |  276 | `		}` |
| 32955512 |  277 | `		if( SyisAlpha(aOpTable[n].sOp.zString[0]) ){` |
|        - |  278 | `			/* TICKET 1433-012: Alpha stream operators [i.e: and,or,xor,new...] */` |
|  3870004 |  279 | `			rc = SyStringCmp(pStr,&aOpTable[n].sOp,SyStrnicmp);` |
|  1935003 |  280 | `		}else{` |
| 29085510 |  281 | `			rc = SyStringCmp(pStr,&aOpTable[n].sOp,SyMemcmp);` |
|        - |  282 | `		}` |
| 32955512 |  283 | `		if( rc == 0 ){` |
|   985030 |  284 | `			if( aOpTable[n].sOp.nByte != sizeof(char) \|\| (aOpTable[n].iOp != EXPR_OP_UMINUS && aOpTable[n].iOp != EXPR_OP_UPLUS) \|\| pLast == 0 ){` |
|        - |  285 | `				/* There is no ambiguity here,simply return the first operator seen */` |
|   980854 |  286 | `				return &aOpTable[n];` |
|        - |  287 | `			}` |
...
|        4 |  301 | `			}` |
|     1899 |  302 | `		}` |
| 31974282 |  303 | `		++n; /* Next operator in the table */` |
|        2 |  304 | `	}` |
...
|        - |  312 | ` */` |
|   555382 |  313 | `PH7_PRIVATE void PH7_DelimitNestedTokens(SyToken *pIn,SyToken *pEnd,sxu32 nTokStart,sxu32 nTokEnd,SyToken **ppEnd)` |
|        2 |  314 |  |
|   555384 |  315 | `	SyToken *pCur = pIn;` |
|   555384 |  316 | `	sxi32 iNest = 1;` |
|  3216140 |  317 | `	for(;;){` |
|  6432282 |  318 | `		if( pCur >= pEnd ){` |
|      172 |  319 | `			break;` |
|        - |  320 | `		}` |
|  6432112 |  321 | `		if( pCur->nType & nTokStart ){` |
|        - |  322 | `			/* Increment nesting level */` |
|   320484 |  323 | `			iNest++;` |
|  6271871 |  324 | `		}else if( pCur->nType & nTokEnd ){` |
|        - |  325 | `			/* Decrement nesting level */` |
|   875696 |  326 | `			iNest--;` |
|   875696 |  327 | `			if( iNest <= 0 ){` |
|   555214 |  328 | `				break;` |
|        - |  329 | `			}` |
|   160241 |  330 | `		}` |
|        - |  331 | `		/* Advance cursor */` |
...
|        - |  368 | ` */` |
|   829542 |  369 | `static sxi32 ExprVerifyNodes(ph7_gen_state *pGen,ph7_expr_node **apNode,sxi32 nNode)` |
|        2 |  370 |  |
|        - |  371 | `	sxi32 iParen,iSquare,iQuesty,iBraces;` |
|        - |  372 | `	sxi32 i,rc;` |
|        - |  373 |  |
|   829544 |  374 | `	if( nNode > 0 && apNode[0]->pOp && (apNode[0]->pOp->iOp == EXPR_OP_ADD \|\| apNode[0]->pOp->iOp == EXPR_OP_SUB) ){` |
...
|       13 |  378 | `	}` |
|   829544 |  379 | `	iParen = iSquare = iQuesty = iBraces = 0;` |
|  4466360 |  380 | `	for( i = 0 ; i < nNode ; ++i ){` |
|  3636852 |  381 | `		if( apNode[i]->xCode == PH7_CompileShortArray \|\| apNode[i]->xCode == PH7_CompileShortList ){` |
|        - |  382 | `			/* Short array/list literal: brackets are self-contained, skip */` |
|      694 |  383 | `			continue;` |
|        - |  384 | `		}` |
|  3636160 |  385 | `		if( apNode[i]->pStart->nType & PH7_TK_LPAREN /*'('*/){` |
|   398684 |  386 | `			if( i > 0 && ( apNode[i-1]->xCode == PH7_CompileVariable \|\| apNode[i-1]->xCode == PH7_CompileLiteral \|\|` |
...
|   371948 |  389 | `					if( (apNode[i - 1]->pStart->nType & PH7_TK_OP) == 0 ){` |
|        - |  390 | `						/* We are dealing with a postfix [i.e: function call]  operator` |
|        - |  391 | `						 * not a simple left parenthesis. Mark the node.` |
|        - |  392 | `						 */` |
|   371948 |  393 | `						apNode[i]->pStart->nType \|= PH7_TK_OP;` |
|   371948 |  394 | `						apNode[i]->pStart->pUserData = (void *)&sFCallOp; /* Function call operator */` |
|   371948 |  395 | `						apNode[i]->pOp = &sFCallOp;` |
|   185973 |  396 | `					}` |
|   185973 |  397 | `			}` |
|   398684 |  398 | `			iParen++;` |
|  3436819 |  399 | `		}else if( apNode[i]->pStart->nType & PH7_TK_RPAREN/*')*/){` |
|   398684 |  400 | `			if( iParen <= 0 ){` |
...
|        - |  406 | `			}` |
|   398672 |  407 | `			iParen--;` |
|  3038131 |  408 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OSB /*'['*/){` |
|    80702 |  409 | `			iSquare++;` |
|  2798446 |  410 | `		}else if (apNode[i]->pStart->nType & PH7_TK_CSB /*']'*/){` |
|    80716 |  411 | `			if( iSquare <= 0 ){` |
...
|        - |  417 | `			}` |
|    80710 |  418 | `			iSquare--;` |
|  2717736 |  419 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OCB /*'{'*/){` |
|       16 |  420 | `			iBraces++;` |
...
|        - |  464 |  |
|        7 |  465 | `			}` |
|  2677375 |  466 | `		}else if (apNode[i]->pStart->nType & PH7_TK_CCB /*'}'*/){` |
|       18 |  467 | `			if( iBraces <= 0 ){` |
...
|        - |  473 | `			}` |
|        6 |  474 | `			iBraces--;` |
|  2677354 |  475 | `		}else if ( apNode[i]->pStart->nType & PH7_TK_COLON ){` |
|     2636 |  476 | `			if( iQuesty > 0 ){` |
|     2446 |  477 | `				iQuesty--;` |
|     1414 |  478 | `			}else if( iParen <= 0 ){` |
...
|        5 |  486 | `				return rc;` |
|        2 |  487 | `			}` |
|  2676033 |  488 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OP ){` |
|   764026 |  489 | `			const ph7_expr_op *pOp = (const ph7_expr_op *)apNode[i]->pOp;` |
|   764026 |  490 | `			if( pOp->iOp == EXPR_OP_QUESTY ){` |
|     2448 |  491 | `				iQuesty++;` |
|   762803 |  492 | `			}else if( i > 0 && (pOp->iOp == EXPR_OP_UMINUS \|\| pOp->iOp == EXPR_OP_UPLUS)){` |
...
|   382012 |  512 | `		}` |
|  1818064 |  513 | `	}` |
|   829510 |  514 | `	if( iParen != 0 \|\| iSquare != 0 \|\| iQuesty != 0 \|\| iBraces != 0){` |
...
|       17 |  519 | `		return rc;` |
|        - |  520 | `	}` |
|   829494 |  521 | `	return SXRET_OK;` |
|   414773 |  522 |  |
|        - |  523 | `/*` |
|        - |  524 | ` * Collect and assemble tokens holding a namespace path [i.e: namespace\to\const]` |
|        - |  525 | ` * or a simple literal [i.e: PHP_EOL].` |
|        - |  526 | ` */` |
|   690550 |  527 | `static void ExprAssembleLiteral(SyToken **ppCur,SyToken *pEnd)` |
|        2 |  528 |  |
|   690552 |  529 | `	SyToken *pIn = *ppCur;` |
|        - |  530 | `	/* Jump the first literal seen */` |
|   690552 |  531 | `	if( (pIn->nType & PH7_TK_NSSEP) == 0 ){` |
|   690518 |  532 | `		pIn++;` |
|   345258 |  533 | `	}` |
|   345316 |  534 | `	for(;;){` |
|   690634 |  535 | `		if(pIn < pEnd && (pIn->nType & PH7_TK_NSSEP) ){` |
|       84 |  536 | `			pIn++;` |
...
|        - |  830 | ` */` |
|  3637074 |  831 | `static sxi32 ExprExtractNode(ph7_gen_state *pGen,ph7_expr_node **ppNode,int iLastWasTerm)` |
|        2 |  832 |  |
|        - |  833 | `	ph7_expr_node *pNode;` |
|        - |  834 | `	SyToken *pCur;` |
|        - |  835 | `	sxi32 rc;` |
|        - |  836 | `	/* Allocate a new node */` |
|  3637076 |  837 | `	pNode = (ph7_expr_node *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_expr_node));` |
|  3637076 |  838 | `	if( pNode == 0 ){` |
...
|  3637076 |  845 | `	SyZero(pNode,sizeof(ph7_expr_node));` |
|  3637076 |  846 | `	SySetInit(&pNode->aNodeArgs,&pGen->pVm->sAllocator,sizeof(ph7_expr_node **));` |
|        - |  847 | `	/* Point to the head of the token stream */` |
|  3637076 |  848 | `	pCur = pNode->pStart = pGen->pIn;` |
|        - |  849 | `	/* Start collecting tokens */` |
|  3637076 |  850 | `	if( pCur->nType & PH7_TK_ELLIPSIS ){` |
...
|       76 |  860 | `		return rc;` |
|        - |  861 | `	}` |
|  3637002 |  862 | `	if( (pCur->nType & PH7_TK_OSB) && !iLastWasTerm ){` |
|        - |  863 | `		/* PHP 5.4 short array syntax: [1, 2, 3] or ['key' => 'value'].` |
|        - |  864 | `		 * This '[' does not follow a term, so it is an array literal, not subscript.` |
|        - |  865 | `		 */` |
|      696 |  866 | `		pCur++; /* Skip the opening '[' */` |
|      696 |  867 | `		PH7_DelimitNestedTokens(pCur,pGen->pEnd,PH7_TK_OSB,PH7_TK_CSB,&pCur);` |
|      696 |  868 | `		if( pCur < pGen->pEnd ){` |
|      696 |  869 | `			pCur++; /* Skip past the closing ']' */` |
|      349 |  870 | `		}else{` |
...
|        - |  881 | `		 */` |
|      754 |  882 | `		if( pCur < pGen->pEnd && (pCur->nType & PH7_TK_OP) ){` |
|      118 |  883 | `			ph7_expr_op *pOp = (ph7_expr_op *)pCur->pUserData;` |
|      118 |  884 | `			if( pOp && pOp->iVmOp == PH7_OP_STORE ){` |
|       30 |  885 | `				pNode->xCode = PH7_CompileShortList;` |
|       16 |  886 | `			}else{` |
|       89 |  887 | `				pNode->xCode = PH7_CompileShortArray;` |
|        - |  888 | `			}` |
|       60 |  889 | `		}else{` |
|      580 |  890 | `			pNode->xCode = PH7_CompileShortArray;` |
|        2 |  891 | `		}` |
|  3636655 |  892 | `	}else if( pCur->nType & PH7_TK_OP ){` |
|        - |  893 | `		/* Point to the instance that describe this operator */` |
|   844760 |  894 | `		pNode->pOp = (const ph7_expr_op *)pCur->pUserData;` |
|        - |  895 | `		/* Advance the stream cursor */` |
|   844760 |  896 | `		pCur++;` |
|  3213929 |  897 | `	}else if( pCur->nType & PH7_TK_DOLLAR ){` |
|        - |  898 | `		/* Isolate variable */` |
|  1964518 |  899 | `		while( pCur < pGen->pEnd && (pCur->nType & PH7_TK_DOLLAR) ){` |
|   982266 |  900 | `			pCur++; /* Variable variable */` |
|        2 |  901 | `		}` |
|   982254 |  902 | `		if( pCur < pGen->pEnd ){` |
|   982254 |  903 | `			if (pCur->nType & (PH7_TK_ID\|PH7_TK_KEYWORD) ){` |
|        - |  904 | `				/* Variable name */` |
|   982226 |  905 | `				pCur++;` |
|   491142 |  906 | `			}else if( pCur->nType & PH7_TK_OCB /* '{' */ ){` |
|       22 |  907 | `				pCur++;` |
...
|        8 |  920 | `			}` |
|   491124 |  921 | `		}` |
|   982250 |  922 | `		pNode->xCode = PH7_CompileVariable;` |
|  2300422 |  923 | `	 }else if( pCur->nType & PH7_TK_KEYWORD ){` |
...
|        2 | 1019 | `		 }` |
|  1785828 | 1020 | `	 }else if( pCur->nType & (PH7_TK_NSSEP\|PH7_TK_ID) ){` |
|        - | 1021 | `		 /* Constants,function name,namespace path,class name... */` |
|   671130 | 1022 | `		 ExprAssembleLiteral(&pCur,pGen->pEnd);` |
|   671130 | 1023 | `		 pNode->xCode = PH7_CompileLiteral;` |
|   335566 | 1024 | `	 }else{` |
|  1091258 | 1025 | `		 if( (pCur->nType & (PH7_TK_LPAREN\|PH7_TK_RPAREN\|PH7_TK_COMMA\|PH7_TK_COLON\|PH7_TK_CSB\|PH7_TK_OCB\|PH7_TK_CCB)) == 0 ){` |
|        - | 1026 | `			 /* Point to the code generator routine */` |
|   210494 | 1027 | `			 pNode->xCode = PH7_GetNodeHandler(pCur->nType);` |
|   210494 | 1028 | `			 if( pNode->xCode == 0 ){` |
...
|  3636968 | 1041 | `	pNode->pEnd = pCur;` |
|        - | 1042 | `	/* Save the node for later processing */` |
|  3636968 | 1043 | `	*ppNode = pNode;` |
|        - | 1044 | `	/* Synchronize cursors */` |
|  3636968 | 1045 | `	pGen->pIn = pCur;` |
|  3636968 | 1046 | `	return SXRET_OK;` |
|  1818539 | 1047 |  |
|        - | 1048 | `/*` |
...
|        - | 1051 | ` * level is zero.` |
|        - | 1052 | ` */` |
|    82812 | 1053 | `PH7_PRIVATE sxi32 PH7_GetNextExpr(SyToken *pStart,SyToken *pEnd,SyToken **ppNext)` |
|        2 | 1054 |  |
|    82814 | 1055 | `	SyToken *pCur = pStart;` |
|    82814 | 1056 | `	sxi32 iNest = 0;` |
|    82814 | 1057 | `	if( pCur >= pEnd \|\| (pCur->nType & PH7_TK_SEMI/*';'*/) ){` |
|        - | 1058 | `		/* Last expression */` |
|    43568 | 1059 | `		return SXERR_EOF;` |
|        - | 1060 | `	}` |
|   161092 | 1061 | `	while( pCur < pEnd ){` |
|   146650 | 1062 | `		if( (pCur->nType & (PH7_TK_COMMA/*','*/\|PH7_TK_SEMI/*';'*/)) && iNest <= 0){` |
|    24806 | 1063 | `			break;` |
|        - | 1064 | `		}` |
|   121846 | 1065 | `		if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|     7644 | 1066 | `			iNest++;` |
|   118025 | 1067 | `		}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}*/) ){` |
|     7646 | 1068 | `			iNest--;` |
|     3822 | 1069 | `		}` |
|   121846 | 1070 | `		pCur++;` |
|        2 | 1071 | `	}` |
|    39248 | 1072 | `	*ppNext = pCur;` |
|    39248 | 1073 | `	return SXRET_OK;` |
|    41408 | 1074 |  |
|        - | 1075 | `/*` |
|        - | 1076 | ` * Free an expression tree.` |
|        - | 1077 | ` */` |
|  3139346 | 1078 | `static void ExprFreeTree(ph7_gen_state *pGen,ph7_expr_node *pNode)` |
|        2 | 1079 |  |
|  3139348 | 1080 | `	if( pNode->pLeft ){` |
|        - | 1081 | `		/* Release the left tree */` |
|  1173942 | 1082 | `		ExprFreeTree(&(*pGen),pNode->pLeft);` |
|   586970 | 1083 | `	}` |
|  3139348 | 1084 | `	if( pNode->pRight ){` |
|        - | 1085 | `		/* Release the right tree */` |
|   649594 | 1086 | `		ExprFreeTree(&(*pGen),pNode->pRight);` |
|   324796 | 1087 | `	}` |
|  3139348 | 1088 | `	if( pNode->pCond ){` |
|        - | 1089 | `		/* Release the conditional tree used by the ternary operator */` |
|     2444 | 1090 | `		ExprFreeTree(&(*pGen),pNode->pCond);` |
|     1221 | 1091 | `	}` |
|  3139348 | 1092 | `	if( SySetUsed(&pNode->aNodeArgs) > 0 ){` |
|        - | 1093 | `		ph7_expr_node **apArg;` |
|        - | 1094 | `		sxu32 n;` |
|        - | 1095 | `		/* Release node arguments */` |
|   387116 | 1096 | `		apArg = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|   816750 | 1097 | `		for( n = 0 ; n < SySetUsed(&pNode->aNodeArgs) ; ++n ){` |
|   429636 | 1098 | `			ExprFreeTree(&(*pGen),apArg[n]);` |
|   214819 | 1099 | `		}` |
|   387116 | 1100 | `		SySetRelease(&pNode->aNodeArgs);` |
|   193557 | 1101 | `	}` |
|        - | 1102 | `	/* Finally,release this node */` |
|  3139348 | 1103 | `	SyMemBackendPoolFree(&pGen->pVm->sAllocator,pNode);` |
|  3139348 | 1104 |  |
|        - | 1105 | `/*` |
|        - | 1106 | ` * Free an expression tree.` |
|        - | 1107 | ` * This function is a wrapper around ExprFreeTree() defined above.` |
|        - | 1108 | ` */` |
|   829576 | 1109 | `PH7_PRIVATE sxi32 PH7_ExprFreeTree(ph7_gen_state *pGen,SySet *pNodeSet)` |
|        2 | 1110 |  |
|        - | 1111 | `	ph7_expr_node **apNode;` |
|        - | 1112 | `	sxu32 n;` |
|   829578 | 1113 | `	apNode = (ph7_expr_node **)SySetBasePtr(pNodeSet);` |
|  4466544 | 1114 | `	for( n = 0  ; n < SySetUsed(pNodeSet) ; ++n ){` |
|  3636968 | 1115 | `		if( apNode[n] ){` |
|   829912 | 1116 | `			ExprFreeTree(&(*pGen),apNode[n]);` |
|   414955 | 1117 | `		}` |
|  1818485 | 1118 | `	}` |
|   829578 | 1119 | `	return SXRET_OK;` |
|        2 | 1120 |  |
|        - | 1121 | `/*` |
...
|        - | 1127 | ` */` |
|  1162282 | 1128 | `PH7_PRIVATE int PH7_ExprContainsNullsafe(ph7_expr_node *pNode)` |
|        2 | 1129 |  |
|  1162284 | 1130 | `	if( pNode == 0 ){` |
|   715910 | 1131 | `		return 0;` |
|        - | 1132 | `	}` |
|   446376 | 1133 | `	if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW ){` |
|       13 | 1134 | `		return 1;` |
|        - | 1135 | `	}` |
|   446364 | 1136 | `	if( PH7_ExprContainsNullsafe(pNode->pLeft) ){` |
|        5 | 1137 | `		return 1;` |
|        - | 1138 | `	}` |
|   446360 | 1139 | `	if( PH7_ExprContainsNullsafe(pNode->pRight) ){` |
|      ! 0 | 1140 | `		return 1;` |
|        - | 1141 | `	}` |
|   446360 | 1142 | `	return 0;` |
|   581143 | 1143 |  |
|        - | 1144 | `/*` |
|        - | 1145 | ` * Check if the given node is a modifialbe l/r-value.` |
|        - | 1146 | ` * Return TRUE if modifiable.FALSE otherwise.` |
|        - | 1147 | ` */` |
|   262916 | 1148 | `static int ExprIsModifiableValue(ph7_expr_node *pNode,sxu8 bFunc)` |
|        2 | 1149 |  |
|        - | 1150 | `	sxi32 iExprOp;` |
|   262918 | 1151 | `	if( pNode->pOp == 0 ){` |
|   158712 | 1152 | `		return pNode->xCode == PH7_CompileVariable ? TRUE : FALSE;` |
|        - | 1153 | `	}` |
...
|        - | 1185 | ` */` |
|   322172 | 1186 | `static sxi32 ExprProcessFuncArguments(ph7_gen_state *pGen,ph7_expr_node *pOp,ph7_expr_node **apNode,sxi32 nToken)` |
|        2 | 1187 |  |
...
|   322174 | 1191 | `	iCur = 0;` |
|   343420 | 1192 | `	for(;;){` |
|   686842 | 1193 | `		if( iCur >= nToken ){` |
|        - | 1194 | `			/* No more arguments to process */` |
|   322148 | 1195 | `			break;` |
|        - | 1196 | `		}` |
|   364696 | 1197 | `		iNode = iCur;` |
|   364696 | 1198 | `		iNest = 0;` |
|   909962 | 1199 | `		while( iCur < nToken ){` |
|   587814 | 1200 | `			if( apNode[iCur] ){` |
|   575278 | 1201 | `				if( (apNode[iCur]->pStart->nType & PH7_TK_COMMA) && apNode[iCur]->pLeft == 0 && iNest <= 0 ){` |
|    21275 | 1202 | `					break;` |
|   547341 | 1203 | `				}else if( (apNode[iCur]->pStart->nType & (PH7_TK_LPAREN\|PH7_TK_OSB\|PH7_TK_OCB))` |
|   281053 | 1204 | `					&& apNode[iCur]->xCode != PH7_CompileShortArray` |
|    29301 | 1205 | `					&& apNode[iCur]->xCode != PH7_CompileShortList ){` |
...
|    29224 | 1212 | `					iNest++;` |
|   518121 | 1213 | `				}else if( apNode[iCur]->pStart->nType & (PH7_TK_RPAREN\|PH7_TK_CCB\|PH7_TK_CSB) ){` |
|    29224 | 1214 | `					iNest--;` |
|    14611 | 1215 | `				}` |
|   266365 | 1216 | `			}` |
|   545268 | 1217 | `			iCur++;` |
|        2 | 1218 | `		}` |
|   364696 | 1219 | `		if( iCur > iNode ){` |
|   364690 | 1220 | `			SyString sArgName = {0, 0};` |
...
|   366599 | 1224 | `			if( (iCur - iNode) >= 2` |
|   202049 | 1225 | `				&& apNode[iNode]` |
|    39410 | 1226 | `				&& (apNode[iNode]->pStart->nType & (PH7_TK_ID\|PH7_TK_KEYWORD))` |
|    21679 | 1227 | `				&& apNode[iNode]->xCode == PH7_CompileLiteral` |
|     3885 | 1228 | `				&& apNode[iNode+1]` |
|     3824 | 1229 | `				&& (apNode[iNode+1]->pStart->nType & PH7_TK_COLON) ){` |
...
|        - | 1248 | `				}` |
|       92 | 1249 | `			}` |
|   364686 | 1250 | `			if( apNode[iNode] && (apNode[iNode]->pStart->nType & PH7_TK_AMPER /*'&'*/) && ((iCur - iNode) == 2)` |
...
|      ! 0 | 1256 | `			}` |
|   364688 | 1257 | `			ExprMakeTree(&(*pGen),&apNode[iNode],iCur-iNode);` |
|   364688 | 1258 | `			if( apNode[iNode] ){` |
|   364688 | 1259 | `				if( sArgName.nByte > 0 ){` |
...
|   364688 | 1264 | `				SySetPut(&pOp->aNodeArgs,(const void *)&apNode[iNode]);` |
|   182345 | 1265 | `			}else{` |
...
|   364688 | 1284 | `		if( iCur < nToken && apNode[iCur] && (apNode[iCur]->pStart->nType & PH7_TK_COMMA) ){` |
|    42542 | 1285 | `			iCur++;` |
|    42542 | 1286 | `			if( iCur >= nToken ){` |
|        - | 1287 | `				/* Trailing comma after last argument */` |
|       19 | 1288 | `				break;` |
|        - | 1289 | `			}` |
|    21261 | 1290 | `		}` |
|        2 | 1291 | `	}` |
|   322166 | 1292 | `	return SXRET_OK;` |
|   161088 | 1293 |  |
|        - | 1294 | ` /*` |
...
|        - | 1298 | `  */` |
|  1294128 | 1299 | ` static sxi32 ExprMakeTree(ph7_gen_state *pGen,ph7_expr_node **apNode,sxi32 nToken)` |
|        2 | 1300 | ` {` |
|        - | 1301 | `	 sxi32 i,iLeft,iRight;` |
|        - | 1302 | `	 ph7_expr_node *pNode;` |
|        - | 1303 | `	 sxi32 iCur;` |
|        - | 1304 | `	 sxi32 rc;` |
|  1294130 | 1305 | `	 if( nToken <= 0 \|\| (nToken == 1 && apNode[0]->xCode) ){` |
|        - | 1306 | `		 /* TICKET 1433-17: self evaluating node */` |
|   586196 | 1307 | `		 return SXRET_OK;` |
|        - | 1308 | `	 }` |
|        - | 1309 | `	 /* Process expressions enclosed in parenthesis first */` |
|  4347262 | 1310 | `	 for( iCur =  0 ; iCur < nToken ; ++iCur ){` |
|        - | 1311 | `		 sxi32 iNest;` |
...
|        - | 1314 | `		  */` |
|  3639330 | 1315 | `		 if( apNode[iCur] == 0 \|\| apNode[iCur]->pStart->nType != PH7_TK_LPAREN ){` |
|  3612604 | 1316 | `			 continue;` |
|        - | 1317 | `		 }` |
|    26728 | 1318 | `		 iNest = 1;` |
|    26728 | 1319 | `		 iLeft = iCur;` |
|        - | 1320 | `		 /* Find the closing parenthesis */` |
|    26728 | 1321 | `		 iCur++;` |
|   178468 | 1322 | `		 while( iCur < nToken ){` |
|   178468 | 1323 | `			 if( apNode[iCur] ){` |
|   178468 | 1324 | `				 if( apNode[iCur]->pStart->nType & PH7_TK_RPAREN /* ')' */){` |
|        - | 1325 | `					 /* Decrement nesting level */` |
|    46376 | 1326 | `					 iNest--;` |
|    46376 | 1327 | `					 if( iNest <= 0 ){` |
|    26728 | 1328 | `						 break;` |
|        2 | 1329 | `					 }` |
|   141918 | 1330 | `				 }else if( apNode[iCur]->pStart->nType & PH7_TK_LPAREN /* '(' */ ){` |
...
|   151742 | 1335 | `			 iCur++;` |
|        2 | 1336 | `		 }` |
|    26728 | 1337 | `		 if( iCur - iLeft > 1 ){` |
|        - | 1338 | `			 sxi32 j;` |
|        - | 1339 | `			 /* Recurse and process this expression */` |
|    26728 | 1340 | `			 rc = ExprMakeTree(&(*pGen),&apNode[iLeft + 1],iCur - iLeft - 1);` |
|    26728 | 1341 | `			 if( rc != SXRET_OK ){` |
|        3 | 1342 | `				 return rc;` |
|        - | 1343 | `			 }` |
...
|    26726 | 1347 | `			 for( j = iLeft + 1 ; j < iCur ; ++j ){` |
|    26726 | 1348 | `				 if( apNode[j] ){` |
|    26726 | 1349 | `					 apNode[j]->iFlags \|= EXPR_NODE_PARENS;` |
|    26726 | 1350 | `					 break;` |
|        - | 1351 | `				 }` |
|      ! 0 | 1352 | `			 }` |
|    13362 | 1353 | `		 }` |
|        - | 1354 | `		 /* Free the left and right nodes */` |
|    26726 | 1355 | `		 ExprFreeTree(&(*pGen),apNode[iLeft]);` |
|    26726 | 1356 | `		 ExprFreeTree(&(*pGen),apNode[iCur]);` |
|    26726 | 1357 | `		 apNode[iLeft] = 0;` |
|    26726 | 1358 | `		 apNode[iCur] = 0;` |
|    13364 | 1359 | `	 }` |
|        - | 1360 | `	  /* Process expressions enclosed in braces */` |
|  4518794 | 1361 | `	 for( iCur =  0 ; iCur < nToken ; ++iCur ){` |
|        - | 1362 | `		 sxi32 iNest;` |
...
|        - | 1365 | `		  */` |
|  3817778 | 1366 | `		 if( apNode[iCur] == 0 \|\| apNode[iCur]->pStart->nType != PH7_TK_OCB ){` |
|  3817774 | 1367 | `			 continue;` |
|        - | 1368 | `		 }` |
|        6 | 1369 | `		 iNest = 1;` |
|        6 | 1370 | `		 iLeft = iCur;` |
...
|   701018 | 1402 | `	 iLeft = -1;` |
|  4518764 | 1403 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  3817760 | 1404 | `		 if( apNode[iCur] == 0 ){` |
|  1456026 | 1405 | `			 continue;` |
|        - | 1406 | `		 }` |
|  2361736 | 1407 | `		 pNode = apNode[iCur];` |
|  2361736 | 1408 | `		 if( pNode->pOp && pNode->pOp->iPrec == 2 && pNode->pLeft == 0  ){` |
|   623978 | 1409 | `			 if( pNode->pOp->iOp == EXPR_OP_FUNC_CALL ){` |
|        - | 1410 | `				 /* Collect function arguments */` |
|   371944 | 1411 | `				 sxi32 iPtr = 0;` |
|   371944 | 1412 | `				 sxi32 nFuncTok = 0;` |
|  1331700 | 1413 | `				 while( nFuncTok + iCur < nToken ){` |
|  1331700 | 1414 | `					 if( apNode[nFuncTok+iCur] ){` |
|  1319164 | 1415 | `						 if( apNode[nFuncTok+iCur]->pStart->nType & PH7_TK_LPAREN /*'('*/ ){` |
|   385102 | 1416 | `							 iPtr++;` |
|  1126614 | 1417 | `						 }else if ( apNode[nFuncTok+iCur]->pStart->nType & PH7_TK_RPAREN /*')'*/){` |
|   385102 | 1418 | `							 iPtr--;` |
|   385102 | 1419 | `							 if( iPtr <= 0 ){` |
|   371944 | 1420 | `								 break;` |
|        - | 1421 | `							 }` |
|     6579 | 1422 | `						 }` |
|   473610 | 1423 | `					 }` |
|   959758 | 1424 | `					 nFuncTok++;` |
|        2 | 1425 | `				 }` |
|   371944 | 1426 | `				 if( nFuncTok + iCur >= nToken ){` |
|        - | 1427 | `					 /* Syntax error */` |
...
|      ! 0 | 1432 | `					 return rc;` |
|        - | 1433 | `				 }` |
|   371944 | 1434 | `				 if(  iLeft < 0 \|\| !NODE_ISTERM(iLeft) /*\|\| ( apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec != 2)*/ ){` |
|        - | 1435 | `					 /* Syntax error */` |
...
|      ! 0 | 1440 | `					 return rc;` |
|        - | 1441 | `				 }` |
|   371944 | 1442 | `				 if( nFuncTok > 1 ){` |
|        - | 1443 | `					 /* Process function arguments */` |
|   322174 | 1444 | `					 rc = ExprProcessFuncArguments(&(*pGen),pNode,&apNode[iCur+1],nFuncTok-1);` |
|   322174 | 1445 | `					 if( rc != SXRET_OK ){` |
|        9 | 1446 | `						 return rc;` |
|        - | 1447 | `					 }` |
|   161082 | 1448 | `				 }` |
|        - | 1449 | `				 /* Link the node to the tree */` |
|   371936 | 1450 | `				 pNode->pLeft = apNode[iLeft];` |
|   371936 | 1451 | `				 apNode[iLeft] = 0;` |
|  1331668 | 1452 | `				 for( iPtr = 1; iPtr <= nFuncTok ; iPtr++ ){` |
|   959734 | 1453 | `					 apNode[iCur+iPtr] = 0;` |
|   479868 | 1454 | `				 }` |
|   438003 | 1455 | `			 }else if (pNode->pOp->iOp == EXPR_OP_SUBSCRIPT ){` |
|        - | 1456 | `				 /* Subscripting */` |
|    80710 | 1457 | `				 sxi32 iArrTok = iCur + 1;` |
|    80710 | 1458 | `				 sxi32 iNest = 1;` |
|    80873 | 1459 | `				 if(  iLeft < 0 \|\| apNode[iLeft] == 0 \|\| (apNode[iLeft]->pOp == 0 && (apNode[iLeft]->xCode != PH7_CompileVariable &&` |
...
|    80708 | 1463 | `					 ( apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec != 2 /* postfix */) ){` |
|        - | 1464 | `						 /* Syntax error */` |
...
|   145768 | 1472 | `				 while( iArrTok < nToken ){` |
|   145768 | 1473 | `					 if( apNode[iArrTok] ){` |
|   145736 | 1474 | `						 if( apNode[iArrTok]->pOp && apNode[iArrTok]->pOp->iOp == EXPR_OP_SUBSCRIPT &&  apNode[iArrTok]->pLeft == 0){` |
|        - | 1475 | `							 /* Increment nesting level */` |
|      ! 0 | 1476 | `							 iNest++;` |
|   145736 | 1477 | `						 }else if( apNode[iArrTok]->pStart->nType & PH7_TK_CSB /*']'*/){` |
|        - | 1478 | `							 /* Decrement nesting level */` |
|    80710 | 1479 | `							 iNest--;` |
|    80710 | 1480 | `							 if( iNest <= 0 ){` |
|    80710 | 1481 | `								 break;` |
|        - | 1482 | `							 }` |
|      ! 0 | 1483 | `						 }` |
|    32513 | 1484 | `					 }` |
...
|    80710 | 1497 | `				 pNode->pLeft = apNode[iLeft];` |
|    80710 | 1498 | `				 pNode->pRight = 0;` |
|    80710 | 1499 | `				 apNode[iLeft] = 0;` |
|   226476 | 1500 | `				 for( iNest = iCur + 1 ; iNest <= iArrTok ; ++iNest ){` |
|   145768 | 1501 | `					 apNode[iNest] = 0;` |
|    72885 | 1502 | `				 }` |
|    40356 | 1503 | `			 }else{` |
...
|        - | 1532 | `			 }` |
|   311982 | 1533 | `		 }` |
|  2361724 | 1534 | `		 iLeft = iCur;` |
|  1180863 | 1535 | `	 }` |
|        - | 1536 | `	 /* Handle left associative (new, clone) operators */` |
|  4518732 | 1537 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  3817728 | 1538 | `		 if( apNode[iCur] == 0 ){` |
|  2096686 | 1539 | `			 continue;` |
|        - | 1540 | `		 }` |
|  1721044 | 1541 | `		 pNode = apNode[iCur];` |
|  1721044 | 1542 | `		 if( pNode->pOp && pNode->pOp->iPrec == 1 && pNode->pLeft == 0 ){` |
|        - | 1543 | `			 SyToken *pToken;` |
...
|   701006 | 1605 | `	 iLeft = -1;` |
|  4522190 | 1606 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  3817728 | 1607 | `		 if( apNode[iCur] == 0 ){` |
|  2096686 | 1608 | `			 continue;` |
|        - | 1609 | `		 }` |
|  1721044 | 1610 | `		 pNode = apNode[iCur];` |
|  1721044 | 1611 | `		 if( pNode->pOp && pNode->pOp->iPrec == 3 && pNode->pLeft == 0){` |
...
|     1741 | 1617 | `			 }` |
|     6449 | 1618 | `		  }` |
|  1724502 | 1619 | `		 iLeft = iCur;` |
|   863981 | 1620 | `	  }` |
|   704464 | 1621 | `	 iLeft = -1;` |
|  4522190 | 1622 | `	 for( iCur = nToken -  1 ; iCur >= 0 ; iCur-- ){` |
|  3817728 | 1623 | `		 if( apNode[iCur] == 0 ){` |
|  2100168 | 1624 | `			 continue;` |
|        - | 1625 | `		 }` |
|  1717562 | 1626 | `		 pNode = apNode[iCur];` |
|  1717562 | 1627 | `		 if( pNode->pOp && pNode->pOp->iPrec == 3 && pNode->pLeft == 0){` |
...
|     4708 | 1642 | `		  }` |
|  1717562 | 1643 | `		 iLeft = iCur;` |
|   858782 | 1644 | `	 }` |
|        - | 1645 | `	 /* Handle right associative unary and cast operators [i.e: !,(string),~...]  with precedence 4*/` |
|   704464 | 1646 | `	  iLeft = 0;` |
|  4522184 | 1647 | `	  for( iCur = nToken -  1 ; iCur >= 0 ; iCur-- ){` |
|  3817724 | 1648 | `		  if( apNode[iCur] ){` |
|  1708142 | 1649 | `			  pNode = apNode[iCur];` |
|  1708142 | 1650 | `			  if( pNode->pOp && pNode->pOp->iPrec == 4 && pNode->pLeft == 0){` |
|    42184 | 1651 | `				  if( iLeft > 0 ){` |
|        - | 1652 | `					  /* Link the node to the tree */` |
|    42182 | 1653 | `					  pNode->pLeft = apNode[iLeft];` |
|    42182 | 1654 | `					  apNode[iLeft] = 0;` |
|    42182 | 1655 | `					  if( pNode->pLeft && pNode->pLeft->pOp && pNode->pLeft->pOp->iPrec > 4 ){` |
...
|  4522182 | 1682 | `	 for( iCur = nToken - 1 ; iCur >= 0 ; --iCur ){` |
|  3817722 | 1683 | `		 if( apNode[iCur] == 0 ){` |
|  2151876 | 1684 | `			 continue;` |
|        - | 1685 | `		 }` |
|  1665848 | 1686 | `		 pNode = apNode[iCur];` |
|  1665848 | 1687 | `		 if( pNode->pOp && pNode->pOp->iPrec == 5 && pNode->pLeft == 0 ){` |
|        - | 1688 | `			 sxi32 iL, iR;` |
...
|  7748976 | 1751 | `	 for( i = 7 ; i < 17 ; i++ ){` |
|  7044526 | 1752 | `		 iLeft = -1;` |
| 45221432 | 1753 | `		 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
| 38176918 | 1754 | `			 if( apNode[iCur] == 0 ){` |
| 24367678 | 1755 | `				 continue;` |
|        - | 1756 | `			 }` |
| 13809242 | 1757 | `			 pNode = apNode[iCur];` |
| 13809242 | 1758 | `			 if( pNode->pOp && pNode->pOp->iPrec == i && pNode->pLeft == 0 ){` |
|        - | 1759 | `				 /* Get the right node */` |
|   212824 | 1760 | `				 iRight = iCur + 1;` |
|   303924 | 1761 | `				 while( iRight < nToken && apNode[iRight] == 0 ){` |
|    91102 | 1762 | `					 iRight++;` |
|        2 | 1763 | `				 }` |
|   212824 | 1764 | `				 if( iRight >= nToken \|\| iLeft < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|        - | 1765 | `					 /* Syntax error */` |
...
|        9 | 1770 | `					 return rc;` |
|        - | 1771 | `				 }` |
|   212816 | 1772 | `				 if( pNode->pOp->iOp == EXPR_OP_REF ){` |
|        - | 1773 | `					 sxi32  iTmp;` |
...
|   212814 | 1814 | `				 pNode->pLeft = apNode[iLeft];` |
|   212814 | 1815 | `				 pNode->pRight = apNode[iRight];` |
|   212814 | 1816 | `				 apNode[iLeft] = apNode[iRight] = 0;` |
|   106406 | 1817 | `			 }` |
| 13809232 | 1818 | `			 iLeft = iCur;` |
|  6904617 | 1819 | `		 }` |
|  3522259 | 1820 | `	 }` |
...
|        - | 1824 | `	  */` |
|   704452 | 1825 | `	  iLeft = -1;` |
|  4511672 | 1826 | `	  for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  3809666 | 1827 | `		  if( apNode[iCur] == 0 ){` |
|  2576872 | 1828 | `			  continue;` |
|        - | 1829 | `		  }` |
|  1232796 | 1830 | `		  pNode = apNode[iCur];` |
|  1232796 | 1831 | `		  if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_QUESTY && pNode->pLeft == 0 ){` |
|     2446 | 1832 | `			  sxi32 iNest = 1;` |
|     2446 | 1833 | `			  if( iLeft < 0 \|\| !NODE_ISTERM(iLeft) ){` |
...
|     2444 | 1842 | `			  iRight = iCur + 1;` |
|     5130 | 1843 | `			  while( iRight < nToken  ){` |
|     5130 | 1844 | `				  if( apNode[iRight] ){` |
|     4818 | 1845 | `					  if( apNode[iRight]->pOp && apNode[iRight]->pOp->iOp == EXPR_OP_QUESTY && apNode[iRight]->pCond == 0){` |
|        - | 1846 | `						  /* Increment nesting level */` |
|      ! 0 | 1847 | `						  ++iNest;` |
|     4818 | 1848 | `					  }else if( apNode[iRight]->pStart->nType & PH7_TK_COLON /*:*/ ){` |
|        - | 1849 | `						  /* Decrement nesting level */` |
|     2444 | 1850 | `						  --iNest;` |
|     2444 | 1851 | `						  if( iNest <= 0 ){` |
|     2444 | 1852 | `							  break;` |
|        - | 1853 | `						  }` |
|      ! 0 | 1854 | `					  }` |
|     1187 | 1855 | `				  }` |
|     2688 | 1856 | `				  iRight++;` |
|        2 | 1857 | `			  }` |
|     2444 | 1858 | `			  if( iRight > iCur + 1 ){` |
|        - | 1859 | `				  /* Recurse and process the then expression */` |
|     2376 | 1860 | `				  rc = ExprMakeTree(&(*pGen),&apNode[iCur + 1],iRight - iCur - 1);` |
|     2376 | 1861 | `				  if( rc != SXRET_OK ){` |
|      ! 0 | 1862 | `					  return rc;` |
|        - | 1863 | `				  }` |
|        - | 1864 | `				  /* Link the node to the tree */` |
|     2376 | 1865 | `				  pNode->pLeft = apNode[iCur + 1];` |
|     1187 | 1866 | `			  }else{` |
|        - | 1867 | `				  /* Elvis operator (?:): pLeft stays NULL.` |
|        - | 1868 | `				   * NODE_ISTERM() recognizes this node as complete via pCond. */` |
|        - | 1869 | `			  }` |
|     2444 | 1870 | `			  apNode[iCur + 1] = 0;` |
|     2444 | 1871 | `			  if( iRight + 1 < nToken ){` |
|        - | 1872 | `				  /* Recurse and process the else expression */` |
|     2444 | 1873 | `				  rc = ExprMakeTree(&(*pGen),&apNode[iRight + 1],nToken - iRight - 1);` |
|     2444 | 1874 | `				  if( rc != SXRET_OK ){` |
|      ! 0 | 1875 | `					  return rc;` |
|        - | 1876 | `				  }` |
|        - | 1877 | `				  /* Link the node to the tree */` |
|     2444 | 1878 | `				  pNode->pRight = apNode[iRight + 1];` |
|     2444 | 1879 | `				  apNode[iRight + 1] =  apNode[iRight] = 0;` |
|     1223 | 1880 | `			  }else{` |
...
|     2444 | 1888 | `			  pNode->pCond  = apNode[iLeft];` |
|     2444 | 1889 | `			  apNode[iLeft] = 0;` |
|     2444 | 1890 | `			  break;` |
|        - | 1891 | `		  }` |
|  1230352 | 1892 | `		  iLeft = iCur;` |
|   615177 | 1893 | `	  }` |
...
|        - | 1897 | `	  */` |
|   704450 | 1898 | `	 iRight = -1;` |
|  4521986 | 1899 | `	 for( iCur = nToken -  1 ; iCur >= 0 ; iCur--){` |
|  3817592 | 1900 | `		 if( apNode[iCur] == 0 ){` |
|  2850134 | 1901 | `			 continue;` |
|        - | 1902 | `		 }` |
|   967460 | 1903 | `		 pNode = apNode[iCur];` |
|   967460 | 1904 | `		 if( pNode->pOp && pNode->pOp->iPrec == 18 && pNode->pLeft == 0 ){` |
|        - | 1905 | `			 /* Get the left node */` |
|   262890 | 1906 | `			 iLeft = iCur - 1;` |
|   383196 | 1907 | `			 while( iLeft >= 0 && apNode[iLeft] == 0 ){` |
|   120308 | 1908 | `				 iLeft--;` |
|        2 | 1909 | `			 }` |
|   262890 | 1910 | `			 if( iLeft < 0 \|\| iRight < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|        - | 1911 | `				 /* Syntax error */` |
...
|        - | 1928 | `			  * a write. */` |
|   262848 | 1929 | `			 if( PH7_ExprContainsNullsafe(apNode[iLeft]) ){` |
...
|        9 | 1935 | `				 return rc;` |
|        - | 1936 | `			 }` |
|   262840 | 1937 | `			 if( ExprIsModifiableValue(apNode[iLeft],FALSE) == FALSE ){` |
...
|   262836 | 1956 | `			 pNode->pLeft = apNode[iRight];` |
|   262836 | 1957 | `			 pNode->pRight = apNode[iLeft];` |
|   262836 | 1958 | `			 apNode[iLeft] = apNode[iRight] = 0;` |
|   131417 | 1959 | `		 }` |
|   967406 | 1960 | `		 iRight = iCur;` |
|   483704 | 1961 | `	 }` |
|        - | 1962 | `	 /* Process left associative binary operators that have the lowest precedence [i.e: and,or,xor] */` |
|  3521972 | 1963 | `	 for( i = 19 ; i < 23 ; i++ ){` |
|  2817578 | 1964 | `		 iLeft = -1;` |
| 18087666 | 1965 | `		 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
| 15270090 | 1966 | `			 if( apNode[iCur] == 0 ){` |
| 12452108 | 1967 | `				 continue;` |
|        - | 1968 | `			 }` |
|  2817984 | 1969 | `			 pNode = apNode[iCur];` |
|  2817984 | 1970 | `			 if( pNode->pOp && pNode->pOp->iPrec == i && pNode->pLeft == 0 ){` |
...
|       35 | 1988 | `			 }` |
|  2817984 | 1989 | `			 iLeft = iCur;` |
|  1408993 | 1990 | `		 }` |
|  1408790 | 1991 | `	 }` |
|        - | 1992 | `	 /* Point to the root of the expression tree */` |
|  3817496 | 1993 | `	 for( iCur = 1 ; iCur < nToken ; ++iCur ){` |
|  3113120 | 1994 | `		 if( apNode[iCur] ){` |
|   640628 | 1995 | `			 if( (apNode[iCur]->pOp \|\| apNode[iCur]->xCode ) && apNode[0] != 0){` |
...
|       20 | 2000 | `				  return rc;` |
|        - | 2001 | `			 }` |
|   640610 | 2002 | `			 apNode[0] = apNode[iCur];` |
|   640610 | 2003 | `			 apNode[iCur] = 0;` |
|   320304 | 2004 | `		 }` |
|  1556552 | 2005 | `	 }` |
|   704378 | 2006 | `	 return SXRET_OK;` |
|   645337 | 2007 | ` }` |
|        - | 2008 | ` /*` |
...
|        - | 2013 | `  */` |
|   829576 | 2014 | `PH7_PRIVATE sxi32 PH7_ExprMakeTree(ph7_gen_state *pGen,SySet *pExprNode,ph7_expr_node **ppRoot)` |
|        2 | 2015 |  |
|        - | 2016 | `	ph7_expr_node **apNode;` |
|        - | 2017 | `	ph7_expr_node *pNode;` |
|        - | 2018 | `	sxi32 rc;` |
|        - | 2019 | `	/* Reset node container */` |
|   829578 | 2020 | `	SySetReset(pExprNode);` |
|   829578 | 2021 | `	pNode = 0; /* Prevent compiler warning */` |
|        - | 2022 | `	/* Extract nodes one after one until we hit the end of the input */` |
|        - | 2023 | `	{` |
|   829578 | 2024 | `		int iLastWasTerm = 0;` |
|  4466544 | 2025 | `		while( pGen->pIn < pGen->pEnd ){` |
|  3637002 | 2026 | `			rc = ExprExtractNode(&(*pGen),&pNode,iLastWasTerm);` |
|  3637002 | 2027 | `			if( rc != SXRET_OK ){` |
|       35 | 2028 | `				return rc;` |
|        - | 2029 | `			}` |
|        - | 2030 | `			/* Determine if this node is a term for short-array disambiguation */` |
|  3636968 | 2031 | `			if( pNode->xCode ){` |
|        - | 2032 | `				/* Node with compile handler: variable, literal, string, array, etc. */` |
|  1911446 | 2033 | `				iLastWasTerm = 1;` |
|  2681246 | 2034 | `			}else if( pNode->pOp ){` |
|        - | 2035 | `				/* Operator node */` |
|   844760 | 2036 | `				iLastWasTerm = 0;` |
|   422381 | 2037 | `			}else{` |
|        - | 2038 | `				/* Delimiter: ')' and ']' end terms */` |
|   880766 | 2039 | `				iLastWasTerm = (pNode->pStart->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB)) ? 1 : 0;` |
|        - | 2040 | `			}` |
|        - | 2041 | `			/* Save the extracted node */` |
|  3636968 | 2042 | `			SySetPut(pExprNode,(const void *)&pNode);` |
|        2 | 2043 | `		}` |
|        - | 2044 | `	}` |
|   829544 | 2045 | `	if( SySetUsed(pExprNode) < 1 ){` |
|        - | 2046 | `		/* Empty expression [i.e: A semi-colon;] */` |
|      ! 0 | 2047 | `		*ppRoot = 0;` |
|      ! 0 | 2048 | `		return SXRET_OK;` |
|        - | 2049 | `	}` |
|   829544 | 2050 | `	apNode = (ph7_expr_node **)SySetBasePtr(pExprNode);` |
|        - | 2051 | `	/* Make sure we are dealing with valid nodes */` |
|   829544 | 2052 | `	rc = ExprVerifyNodes(&(*pGen),apNode,(sxi32)SySetUsed(pExprNode));` |
|   829544 | 2053 | `	if( rc != SXRET_OK ){` |
...
|        - | 2059 | `	}` |
|        - | 2060 | `	/* Build the tree */` |
|   829494 | 2061 | `	rc = ExprMakeTree(&(*pGen),apNode,(sxi32)SySetUsed(pExprNode));` |
|   829494 | 2062 | `	if( rc != SXRET_OK ){` |
|        - | 2063 | `		/* Something goes wrong [i.e: Syntax error] */` |
|      100 | 2064 | `		*ppRoot = 0;` |
|      100 | 2065 | `		return rc;` |
|        - | 2066 | `	}` |
|        - | 2067 | `	/* Point to the root of the tree */` |
|   829396 | 2068 | `	*ppRoot = apNode[0];` |
|   829396 | 2069 | `	return SXRET_OK;` |
|   414790 | 2070 |  |
|        - | 2071 |  |
