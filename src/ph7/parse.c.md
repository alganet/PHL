...
|          - |  272 | ` */` |
|   24806992 |  273 | `PH7_PRIVATE const ph7_expr_op *  PH7_ExprExtractOperator(SyString *pStr,SyToken *pLast)` |
|          5 |  274 | `{` |
|   24806997 |  275 | `	sxu32 n = 0;` |
|          - |  276 | `	sxi32 rc;` |
|          - |  277 | `	/* Do a linear lookup on the operators table */` |
|  388263166 |  278 | `	for(;;){` |
|  776526337 |  279 | `		if( n >= SX_ARRAYSIZE(aOpTable) ){` |
|        ! 0 |  280 | `			break;` |
|          - |  281 | `		}` |
|  776526337 |  282 | `		if( SyisAlpha(aOpTable[n].sOp.zString[0]) ){` |
|          - |  283 | `			/* TICKET 1433-012: Alpha stream operators [i.e: and,or,xor,new...] */` |
|   74175677 |  284 | `			rc = SyStringCmp(pStr,&aOpTable[n].sOp,SyStrnicmp);` |
|   37087841 |  285 | `		}else{` |
|  702350665 |  286 | `			rc = SyStringCmp(pStr,&aOpTable[n].sOp,SyMemcmp);` |
|          - |  287 | `		}` |
|  776526337 |  288 | `		if( rc == 0 ){` |
|   25112889 |  289 | `			if( aOpTable[n].sOp.nByte != sizeof(char) \|\| (aOpTable[n].iOp != EXPR_OP_UMINUS && aOpTable[n].iOp != EXPR_OP_UPLUS) \|\| pLast == 0 ){` |
|          - |  290 | `				/* There is no ambiguity here,simply return the first operator seen */` |
|   24714881 |  291 | `				return &aOpTable[n];` |
|          - |  292 | `			}` |
...
|          4 |  306 | `			}` |
|     152946 |  307 | `		}` |
|  751719345 |  308 | `		++n; /* Next operator in the table */` |
|          5 |  309 | `	}` |
...
|          - |  317 | ` */` |
|    6808354 |  318 | `PH7_PRIVATE void PH7_DelimitNestedTokens(SyToken *pIn,SyToken *pEnd,sxu32 nTokStart,sxu32 nTokEnd,SyToken **ppEnd)` |
|          5 |  319 | `{` |
|    6808359 |  320 | `	SyToken *pCur = pIn;` |
|    6808359 |  321 | `	sxi32 iNest = 1;` |
|   72262244 |  322 | `	for(;;){` |
|  144524493 |  323 | `		if( pCur >= pEnd ){` |
|      15765 |  324 | `			break;` |
|          - |  325 | `		}` |
|  144508733 |  326 | `		if( pCur->nType & nTokStart ){` |
|          - |  327 | `			/* Increment nesting level */` |
|    5634639 |  328 | `			iNest++;` |
|  141691416 |  329 | `		}else if( pCur->nType & nTokEnd ){` |
|          - |  330 | `			/* Decrement nesting level */` |
|   12427233 |  331 | `			iNest--;` |
|   12427233 |  332 | `			if( iNest <= 0 ){` |
|    6792599 |  333 | `				break;` |
|          - |  334 | `			}` |
|    2817317 |  335 | `		}` |
|          - |  336 | `		/* Advance cursor */` |
...
|          - |  373 | ` */` |
|   14481914 |  374 | `static sxi32 ExprVerifyNodes(ph7_gen_state *pGen,ph7_expr_node **apNode,sxi32 nNode)` |
|          5 |  375 | `{` |
|          - |  376 | `	sxi32 iParen,iSquare,iQuesty,iBraces;` |
|          - |  377 | `	sxi32 i,rc;` |
|          - |  378 |  |
|   14481919 |  379 | `	if( nNode > 0 && apNode[0]->pOp && (apNode[0]->pOp->iOp == EXPR_OP_ADD \|\| apNode[0]->pOp->iOp == EXPR_OP_SUB) ){` |
...
|         16 |  383 | `	}` |
|   14481919 |  384 | `	iParen = iSquare = iQuesty = iBraces = 0;` |
|   91650923 |  385 | `	for( i = 0 ; i < nNode ; ++i ){` |
|   77169045 |  386 | `		if( apNode[i]->xCode == PH7_CompileShortArray \|\| apNode[i]->xCode == PH7_CompileShortList ){` |
|          - |  387 | `			/* Short array/list literal: brackets are self-contained, skip */` |
|     215691 |  388 | `			continue;` |
|          - |  389 | `		}` |
|   76953359 |  390 | `		if( apNode[i]->pStart->nType & PH7_TK_LPAREN /*'('*/){` |
|    6436193 |  391 | `			if( i > 0 && ( apNode[i-1]->xCode == PH7_CompileVariable \|\| apNode[i-1]->xCode == PH7_CompileLiteral \|\|` |
...
|    6029995 |  394 | `					if( (apNode[i - 1]->pStart->nType & PH7_TK_OP) == 0 ){` |
|          - |  395 | `						/* We are dealing with a postfix [i.e: function call]  operator` |
|          - |  396 | `						 * not a simple left parenthesis. Mark the node.` |
|          - |  397 | `						 */` |
|    6029995 |  398 | `						apNode[i]->pStart->nType \|= PH7_TK_OP;` |
|    6029995 |  399 | `						apNode[i]->pStart->pUserData = (void *)&sFCallOp; /* Function call operator */` |
|    6029995 |  400 | `						apNode[i]->pOp = &sFCallOp;` |
|    3014995 |  401 | `					}` |
|    3014995 |  402 | `			}` |
|    6436193 |  403 | `			iParen++;` |
|   73735265 |  404 | `		}else if( apNode[i]->pStart->nType & PH7_TK_RPAREN/*')*/){` |
|    6436193 |  405 | `			if( iParen <= 0 ){` |
...
|          - |  411 | `			}` |
|    6436181 |  412 | `			iParen--;` |
|   67299071 |  413 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OSB /*'['*/){` |
|    2816507 |  414 | `			iSquare++;` |
|   62672732 |  415 | `		}else if (apNode[i]->pStart->nType & PH7_TK_CSB /*']'*/){` |
|    2816511 |  416 | `			if( iSquare <= 0 ){` |
...
|          - |  422 | `			}` |
|    2816505 |  423 | `			iSquare--;` |
|   59856225 |  424 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OCB /*'{'*/){` |
|       3827 |  425 | `			iBraces++;` |
...
|          3 |  434 | `				return rc;` |
|          5 |  435 | `			}` |
|   58446063 |  436 | `		}else if (apNode[i]->pStart->nType & PH7_TK_CCB /*'}'*/){` |
...
|          - |  443 | `			}` |
|       3825 |  444 | `			iBraces--;` |
|   58442231 |  445 | `		}else if ( apNode[i]->pStart->nType & PH7_TK_COLON ){` |
...
|          6 |  456 | `				return rc;` |
|          5 |  457 | `			}` |
|   58225046 |  458 | `		}else if( apNode[i]->pStart->nType & PH7_TK_OP ){` |
|   19073089 |  459 | `			const ph7_expr_op *pOp = (const ph7_expr_op *)apNode[i]->pOp;` |
|   19073089 |  460 | `			if( pOp->iOp == EXPR_OP_QUESTY ){` |
|     430263 |  461 | `				iQuesty++;` |
|   18857960 |  462 | `			}else if( i > 0 && (pOp->iOp == EXPR_OP_UMINUS \|\| pOp->iOp == EXPR_OP_UPLUS)){` |
...
|    9536542 |  482 | `		}` |
|   38476664 |  483 | `	}` |
|   14481883 |  484 | `	if( iParen != 0 \|\| iSquare != 0 \|\| iQuesty != 0 \|\| iBraces != 0){` |
...
|         20 |  489 | `		return rc;` |
|          - |  490 | `	}` |
|   14481867 |  491 | `	return SXRET_OK;` |
|    7240962 |  492 | `}` |
|          - |  493 | `/*` |
|          - |  494 | ` * Collect and assemble tokens holding a namespace path [i.e: namespace\to\const]` |
|          - |  495 | ` * or a simple literal [i.e: PHP_EOL].` |
|          - |  496 | ` */` |
|   11688760 |  497 | `static void ExprAssembleLiteral(SyToken **ppCur,SyToken *pEnd)` |
|          5 |  498 | `{` |
|   11688765 |  499 | `	SyToken *pIn = *ppCur;` |
|          - |  500 | `	/* Jump the first literal seen */` |
|   11688765 |  501 | `	if( (pIn->nType & PH7_TK_NSSEP) == 0 ){` |
|   11684905 |  502 | `		pIn++;` |
|    5842450 |  503 | `	}` |
|    5846337 |  504 | `	for(;;){` |
|   11692679 |  505 | `		if(pIn < pEnd && (pIn->nType & PH7_TK_NSSEP) ){` |
|       3919 |  506 | `			pIn++;` |
...
|          - |  866 | ` */` |
|   77173256 |  867 | `static sxi32 ExprExtractNode(ph7_gen_state *pGen,ph7_expr_node **ppNode,int iLastWasTerm,int bAfterMemberOp)` |
|          5 |  868 | `{` |
|          - |  869 | `	ph7_expr_node *pNode;` |
|          - |  870 | `	SyToken *pCur;` |
|          - |  871 | `	sxi32 rc;` |
|          - |  872 | `	/* Allocate a new node */` |
|   77173261 |  873 | `	pNode = (ph7_expr_node *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_expr_node));` |
|   77173261 |  874 | `	if( pNode == 0 ){` |
...
|   77173261 |  881 | `	SyZero(pNode,sizeof(ph7_expr_node));` |
|   77173261 |  882 | `	SySetInit(&pNode->aNodeArgs,&pGen->pVm->sAllocator,sizeof(ph7_expr_node **));` |
|          - |  883 | `	/* Point to the head of the token stream */` |
|   77173261 |  884 | `	pCur = pNode->pStart = pGen->pIn;` |
|          - |  885 | `	/* Start collecting tokens */` |
|   77173261 |  886 | `	if( pCur->nType & PH7_TK_ELLIPSIS ){` |
...
|       4067 |  909 | `		return rc;` |
|          - |  910 | `	}` |
|   77169119 |  911 | `	if( (pCur->nType & PH7_TK_OSB) && !iLastWasTerm ){` |
|          - |  912 | `		/* PHP 5.4 short array syntax: [1, 2, 3] or ['key' => 'value'].` |
|          - |  913 | `		 * This '[' does not follow a term, so it is an array literal, not subscript.` |
|          - |  914 | `		 */` |
|     215693 |  915 | `		pCur++; /* Skip the opening '[' */` |
|     215693 |  916 | `		PH7_DelimitNestedTokens(pCur,pGen->pEnd,PH7_TK_OSB,PH7_TK_CSB,&pCur);` |
|     215693 |  917 | `		if( pCur < pGen->pEnd ){` |
|     215693 |  918 | `			pCur++; /* Skip past the closing ']' */` |
|     107849 |  919 | `		}else{` |
...
|          - |  930 | `		 */` |
|     215879 |  931 | `		if( pCur < pGen->pEnd && (pCur->nType & PH7_TK_OP) ){` |
...
|          - |  937 | `			}` |
|        189 |  938 | `		}else{` |
|     215321 |  939 | `			pNode->xCode = PH7_CompileShortArray;` |
|          5 |  940 | `		}` |
|   77061275 |  941 | `	}else if( bAfterMemberOp && (pCur->nType & PH7_TK_OP) && (pCur->nType & PH7_TK_ID) ){` |
...
|   76953419 |  952 | `	}else if( (pCur->nType & PH7_TK_OP) && pCur->pUserData` |
|   21889642 |  953 | `		&& ((const ph7_expr_op *)pCur->pUserData)->iOp == EXPR_OP_CLONE` |
|   10971541 |  954 | `		&& &pCur[1] < pGen->pEnd && (pCur[1].nType & PH7_TK_LPAREN) ){` |
...
|   76953404 |  980 | `	}else if( pCur->nType & PH7_TK_OP ){` |
|          - |  981 | `		/* Point to the instance that describe this operator */` |
|   21889625 |  982 | `		pNode->pOp = (const ph7_expr_op *)pCur->pUserData;` |
|          - |  983 | `		/* Advance the stream cursor */` |
|   21889625 |  984 | `		pCur++;` |
|   66008583 |  985 | `	}else if( pCur->nType & PH7_TK_DOLLAR ){` |
|          - |  986 | `		/* Isolate variable */` |
|   37174601 |  987 | `		while( pCur < pGen->pEnd && (pCur->nType & PH7_TK_DOLLAR) ){` |
|   18587309 |  988 | `			pCur++; /* Variable variable */` |
|          5 |  989 | `		}` |
|   18587297 |  990 | `		if( pCur < pGen->pEnd ){` |
|   18587297 |  991 | `			if (pCur->nType & (PH7_TK_ID\|PH7_TK_KEYWORD) ){` |
|          - |  992 | `				/* Variable name */` |
|   18587269 |  993 | `				pCur++;` |
|    9293665 |  994 | `			}else if( pCur->nType & PH7_TK_OCB /* '{' */ ){` |
|         25 |  995 | `				pCur++;` |
...
|          8 | 1008 | `			}` |
|    9293644 | 1009 | `		}` |
|   18587293 | 1010 | `		pNode->xCode = PH7_CompileVariable;` |
|   45770125 | 1011 | `	 }else if( pCur->nType & PH7_TK_KEYWORD ){` |
...
|          5 | 1132 | `		 }` |
|   36016804 | 1133 | `	 }else if( pCur->nType & (PH7_TK_NSSEP\|PH7_TK_ID) ){` |
|          - | 1134 | `		 /* Constants,function name,namespace path,class name... */` |
|   11157967 | 1135 | `		 ExprAssembleLiteral(&pCur,pGen->pEnd);` |
|   11157967 | 1136 | `		 pNode->xCode = PH7_CompileLiteral;` |
|    5578986 | 1137 | `	 }else{` |
|   24399193 | 1138 | `		 if( (pCur->nType & (PH7_TK_LPAREN\|PH7_TK_RPAREN\|PH7_TK_COMMA\|PH7_TK_COLON\|PH7_TK_CSB\|PH7_TK_OCB\|PH7_TK_CCB)) == 0 ){` |
|          - | 1139 | `			 /* Point to the code generator routine */` |
|    8272087 | 1140 | `			 pNode->xCode = PH7_GetNodeHandler(pCur->nType);` |
|    8272087 | 1141 | `			 if( pNode->xCode == 0 ){` |
...
|   77169085 | 1154 | `	pNode->pEnd = pCur;` |
|          - | 1155 | `	/* Save the node for later processing */` |
|   77169085 | 1156 | `	*ppNode = pNode;` |
|          - | 1157 | `	/* Synchronize cursors */` |
|   77169085 | 1158 | `	pGen->pIn = pCur;` |
|   77169085 | 1159 | `	return SXRET_OK;` |
|   38586633 | 1160 | `}` |
|          - | 1161 | `/*` |
...
|          - | 1164 | ` * level is zero.` |
|          - | 1165 | ` */` |
|    1608130 | 1166 | `PH7_PRIVATE sxi32 PH7_GetNextExpr(SyToken *pStart,SyToken *pEnd,SyToken **ppNext)` |
|          5 | 1167 | `{` |
|    1608135 | 1168 | `	SyToken *pCur = pStart;` |
|    1608135 | 1169 | `	sxi32 iNest = 0;` |
|    1608135 | 1170 | `	if( pCur >= pEnd \|\| (pCur->nType & PH7_TK_SEMI/*';'*/) ){` |
|          - | 1171 | `		/* Last expression */` |
|     631035 | 1172 | `		return SXERR_EOF;` |
|          - | 1173 | `	}` |
|    3788313 | 1174 | `	while( pCur < pEnd ){` |
|    3526309 | 1175 | `		if( (pCur->nType & (PH7_TK_COMMA/*','*/\|PH7_TK_SEMI/*';'*/)) && iNest <= 0){` |
|     715101 | 1176 | `			break;` |
|          - | 1177 | `		}` |
|    2811213 | 1178 | `		if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|     213667 | 1179 | `			iNest++;` |
|    2704382 | 1180 | `		}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}*/) ){` |
|     213669 | 1181 | `			iNest--;` |
|     106832 | 1182 | `		}` |
|    2811213 | 1183 | `		pCur++;` |
|          5 | 1184 | `	}` |
|     977105 | 1185 | `	*ppNext = pCur;` |
|     977105 | 1186 | `	return SXRET_OK;` |
|     804070 | 1187 | `}` |
|          - | 1188 | `/*` |
|          - | 1189 | ` * Free an expression tree.` |
|          - | 1190 | ` */` |
|   65893128 | 1191 | `static void ExprFreeTree(ph7_gen_state *pGen,ph7_expr_node *pNode)` |
|          5 | 1192 | `{` |
|   65893133 | 1193 | `	if( pNode->pLeft ){` |
|          - | 1194 | `		/* Release the left tree */` |
|   25916277 | 1195 | `		ExprFreeTree(&(*pGen),pNode->pLeft);` |
|   12958136 | 1196 | `	}` |
|   65893133 | 1197 | `	if( pNode->pRight ){` |
|          - | 1198 | `		/* Release the right tree */` |
|   15009847 | 1199 | `		ExprFreeTree(&(*pGen),pNode->pRight);` |
|    7504921 | 1200 | `	}` |
|   65893133 | 1201 | `	if( pNode->pCond ){` |
|          - | 1202 | `		/* Release the conditional tree used by the ternary operator */` |
|     430259 | 1203 | `		ExprFreeTree(&(*pGen),pNode->pCond);` |
|     215127 | 1204 | `	}` |
|   65893133 | 1205 | `	if( SySetUsed(&pNode->aNodeArgs) > 0 ){` |
|          - | 1206 | `		ph7_expr_node **apArg;` |
|          - | 1207 | `		sxu32 n;` |
|          - | 1208 | `		/* Release node arguments */` |
|    7234635 | 1209 | `		apArg = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|   16468527 | 1210 | `		for( n = 0 ; n < SySetUsed(&pNode->aNodeArgs) ; ++n ){` |
|    9233897 | 1211 | `			ExprFreeTree(&(*pGen),apArg[n]);` |
|    4616951 | 1212 | `		}` |
|    7234635 | 1213 | `		SySetRelease(&pNode->aNodeArgs);` |
|    3617315 | 1214 | `	}` |
|          - | 1215 | `	/* Finally,release this node */` |
|   65893133 | 1216 | `	SyMemBackendPoolFree(&pGen->pVm->sAllocator,pNode);` |
|   65893133 | 1217 | `}` |
|          - | 1218 | `/*` |
|          - | 1219 | ` * Free an expression tree.` |
|          - | 1220 | ` * This function is a wrapper around ExprFreeTree() defined above.` |
|          - | 1221 | ` */` |
|   14481944 | 1222 | `PH7_PRIVATE sxi32 PH7_ExprFreeTree(ph7_gen_state *pGen,SySet *pNodeSet)` |
|          5 | 1223 | `{` |
|          - | 1224 | `	ph7_expr_node **apNode;` |
|          - | 1225 | `	sxu32 n;` |
|   14481949 | 1226 | `	apNode = (ph7_expr_node **)SySetBasePtr(pNodeSet);` |
|   91651079 | 1227 | `	for( n = 0  ; n < SySetUsed(pNodeSet) ; ++n ){` |
|   77169135 | 1228 | `		if( apNode[n] ){` |
|   14482289 | 1229 | `			ExprFreeTree(&(*pGen),apNode[n]);` |
|    7241142 | 1230 | `		}` |
|   38584570 | 1231 | `	}` |
|   14481949 | 1232 | `	return SXRET_OK;` |
|          5 | 1233 | `}` |
|          - | 1234 | `/*` |
...
|          - | 1240 | ` */` |
|   18682734 | 1241 | `PH7_PRIVATE int PH7_ExprContainsNullsafe(ph7_expr_node *pNode)` |
|          5 | 1242 | `{` |
|   18682739 | 1243 | `	if( pNode == 0 ){` |
|   11661351 | 1244 | `		return 0;` |
|          - | 1245 | `	}` |
|    7021393 | 1246 | `	if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW ){` |
|         16 | 1247 | `		return 1;` |
|          - | 1248 | `	}` |
|    7021381 | 1249 | `	if( PH7_ExprContainsNullsafe(pNode->pLeft) ){` |
|          6 | 1250 | `		return 1;` |
|          - | 1251 | `	}` |
|    7021377 | 1252 | `	if( PH7_ExprContainsNullsafe(pNode->pRight) ){` |
|        ! 0 | 1253 | `		return 1;` |
|          - | 1254 | `	}` |
|    7021377 | 1255 | `	return 0;` |
|    9341372 | 1256 | `}` |
|          - | 1257 | `/*` |
|          - | 1258 | ` * Check if the given node is a modifialbe l/r-value.` |
|          - | 1259 | ` * Return TRUE if modifiable.FALSE otherwise.` |
|          - | 1260 | ` */` |
|    4617028 | 1261 | `static int ExprIsModifiableValue(ph7_expr_node *pNode,sxu8 bFunc)` |
|          5 | 1262 | `{` |
|          - | 1263 | `	sxi32 iExprOp;` |
|    4617033 | 1264 | `	if( pNode->pOp == 0 ){` |
|    3334615 | 1265 | `		return pNode->xCode == PH7_CompileVariable ? TRUE : FALSE;` |
|          - | 1266 | `	}` |
|    1282423 | 1267 | `	iExprOp = pNode->pOp->iOp;` |
|    1282423 | 1268 | `	if( iExprOp == EXPR_OP_ARROW /*'->' */ \|\| iExprOp == EXPR_OP_DC /*'::'*/ ){` |
|     782231 | 1269 | `			return TRUE;` |
|          - | 1270 | `	}` |
|     500197 | 1271 | `	if( iExprOp == EXPR_OP_SUBSCRIPT/*'[]'*/ ){` |
|     500191 | 1272 | `		if( pNode->pLeft->pOp ) {` |
...
|        ! 0 | 1275 | `				return FALSE;` |
|          5 | 1276 | `			}` |
|     441064 | 1277 | `		}else if( pNode->pLeft->xCode != PH7_CompileVariable ){` |
|        ! 0 | 1278 | `			return FALSE;` |
|          - | 1279 | `		}` |
|     500191 | 1280 | `		return TRUE;` |
|          - | 1281 | `	}` |
...
|          - | 1298 | ` */` |
|    4635732 | 1299 | `static sxi32 ExprProcessFuncArguments(ph7_gen_state *pGen,ph7_expr_node *pOp,ph7_expr_node **apNode,sxi32 nToken)` |
|          5 | 1300 | `{` |
...
|    4635737 | 1304 | `	iCur = 0;` |
|    5635351 | 1305 | `	for(;;){` |
|   11270707 | 1306 | `		if( iCur >= nToken ){` |
|          - | 1307 | `			/* No more arguments to process */` |
|    4635711 | 1308 | `			break;` |
|          - | 1309 | `		}` |
|    6635001 | 1310 | `		iNode = iCur;` |
|    6635001 | 1311 | `		iNest = 0;` |
|   21462665 | 1312 | `		while( iCur < nToken ){` |
|   16826957 | 1313 | `			if( apNode[iCur] ){` |
|   16781035 | 1314 | `				if( (apNode[iCur]->pStart->nType & PH7_TK_COMMA) && apNode[iCur]->pLeft == 0 && iNest <= 0 ){` |
|     999649 | 1315 | `					break;` |
|   14781742 | 1316 | `				}else if( (apNode[iCur]->pStart->nType & (PH7_TK_LPAREN\|PH7_TK_OSB\|PH7_TK_OCB))` |
|    7962874 | 1317 | `					&& apNode[iCur]->xCode != PH7_CompileShortArray` |
|    1141517 | 1318 | `					&& apNode[iCur]->xCode != PH7_CompileShortList ){` |
...
|    1139023 | 1325 | `					iNest++;` |
|   14212238 | 1326 | `				}else if( apNode[iCur]->pStart->nType & (PH7_TK_RPAREN\|PH7_TK_CCB\|PH7_TK_CSB) ){` |
|    1139023 | 1327 | `					iNest--;` |
|     569509 | 1328 | `				}` |
|    7390871 | 1329 | `			}` |
|   14827669 | 1330 | `			iCur++;` |
|          5 | 1331 | `		}` |
|    6635001 | 1332 | `		if( iCur > iNode ){` |
|    6634995 | 1333 | `			SyString sArgName = {0, 0};` |
...
|    6634990 | 1337 | `			if( (iCur - iNode) >= 2` |
|    4486232 | 1338 | `				&& apNode[iNode]` |
|    2337460 | 1339 | `				&& (apNode[iNode]->pStart->nType & (PH7_TK_ID\|PH7_TK_KEYWORD))` |
|    1255825 | 1340 | `				&& apNode[iNode]->xCode == PH7_CompileLiteral` |
|     173946 | 1341 | `				&& apNode[iNode+1]` |
|     173693 | 1342 | `				&& (apNode[iNode+1]->pStart->nType & PH7_TK_COLON) ){` |
...
|          - | 1361 | `				}` |
|        142 | 1362 | `			}` |
|    6634988 | 1363 | `			if( apNode[iNode] && (apNode[iNode]->pStart->nType & PH7_TK_AMPER /*'&'*/) && ((iCur - iNode) == 2)` |
...
|    6634993 | 1380 | `				int bSpreadArg = 0;` |
|          - | 1381 | `				sxi32 iScan;` |
|    6635021 | 1382 | `				for( iScan = iNode ; iScan < iCur ; iScan++ ){` |
|    6635021 | 1383 | `					if( apNode[iScan] ){` |
|    6634993 | 1384 | `						bSpreadArg = (apNode[iScan]->iFlags & EXPR_NODE_SPREAD) != 0;` |
|    6634993 | 1385 | `						break;` |
|          - | 1386 | `					}` |
|         15 | 1387 | `				}` |
|    6634993 | 1388 | `				ExprMakeTree(&(*pGen),&apNode[iNode],iCur-iNode);` |
|    6634993 | 1389 | `				if( bSpreadArg && apNode[iNode] ){` |
|       4001 | 1390 | `					apNode[iNode]->iFlags \|= EXPR_NODE_SPREAD;` |
|       1998 | 1391 | `				}` |
|          - | 1392 | `			}` |
|    6634993 | 1393 | `			if( apNode[iNode] ){` |
|    6634993 | 1394 | `				if( sArgName.nByte > 0 ){` |
...
|    6634993 | 1399 | `				SySetPut(&pOp->aNodeArgs,(const void *)&apNode[iNode]);` |
|    3317499 | 1400 | `			}else{` |
...
|    6634993 | 1419 | `		if( iCur < nToken && apNode[iCur] && (apNode[iCur]->pStart->nType & PH7_TK_COMMA) ){` |
|    1999287 | 1420 | `			iCur++;` |
|    1999287 | 1421 | `			if( iCur >= nToken ){` |
|          - | 1422 | `				/* Trailing comma after last argument */` |
|         19 | 1423 | `				break;` |
|          - | 1424 | `			}` |
|     999632 | 1425 | `		}` |
|          5 | 1426 | `	}` |
|    4635729 | 1427 | `	return SXRET_OK;` |
|    2317871 | 1428 | `}` |
|          - | 1429 | ` /*` |
...
|          - | 1433 | `  */` |
|   25139074 | 1434 | ` static sxi32 ExprMakeTree(ph7_gen_state *pGen,ph7_expr_node **apNode,sxi32 nToken)` |
|          5 | 1435 | ` {` |
...
|          - | 1439 | `	 sxi32 iCur;` |
|          - | 1440 | `	 sxi32 rc;` |
|   25139079 | 1441 | `	 if( nToken <= 0 \|\| (nToken == 1 && apNode[0]->xCode) ){` |
|          - | 1442 | `		 /* TICKET 1433-17: self evaluating node */` |
|   11154985 | 1443 | `		 return SXRET_OK;` |
|          - | 1444 | `	 }` |
|          - | 1445 | `	 /* Process expressions enclosed in parenthesis first */` |
|  100204805 | 1446 | `	 for( iCur =  0 ; iCur < nToken ; ++iCur ){` |
|          - | 1447 | `		 sxi32 iNest;` |
...
|          - | 1450 | `		  */` |
|   86220713 | 1451 | `		 if( apNode[iCur] == 0 \|\| apNode[iCur]->pStart->nType != PH7_TK_LPAREN ){` |
|   85814525 | 1452 | `			 continue;` |
|          - | 1453 | `		 }` |
|     406193 | 1454 | `		 iNest = 1;` |
...
|  103467133 | 1501 | `	 for( iCur =  0 ; iCur < nToken ; ++iCur ){` |
|          - | 1502 | `		 sxi32 iNest;` |
...
|          - | 1505 | `		  */` |
|   89796413 | 1506 | `		 if( apNode[iCur] == 0 \|\| apNode[iCur]->pStart->nType != PH7_TK_OCB ){` |
|   89792593 | 1507 | `			 continue;` |
|          - | 1508 | `		 }` |
|       3825 | 1509 | `		 iNest = 1;` |
...
|   13670725 | 1542 | `	 iLeft = -1;` |
|  103474735 | 1543 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|   89804027 | 1544 | `		 if( apNode[iCur] == 0 ){` |
|   39072425 | 1545 | `			 continue;` |
|          - | 1546 | `		 }` |
|   50731607 | 1547 | `		 pNode = apNode[iCur];` |
|   50731607 | 1548 | `		 if( pNode->pOp && pNode->pOp->iPrec == 2 && pNode->pLeft == 0  ){` |
|   13729105 | 1549 | `			 if( pNode->pOp->iOp == EXPR_OP_FUNC_CALL ){` |
|          - | 1550 | `				 /* Collect function arguments */` |
|    6029991 | 1551 | `				 sxi32 iPtr = 0;` |
|    6029991 | 1552 | `				 sxi32 nFuncTok = 0;` |
|   28886931 | 1553 | `				 while( nFuncTok + iCur < nToken ){` |
|   28886931 | 1554 | `					 if( apNode[nFuncTok+iCur] ){` |
|   28841009 | 1555 | `						 if( apNode[nFuncTok+iCur]->pStart->nType & PH7_TK_LPAREN /*'('*/ ){` |
|    6390837 | 1556 | `							 iPtr++;` |
|   25645593 | 1557 | `						 }else if ( apNode[nFuncTok+iCur]->pStart->nType & PH7_TK_RPAREN /*')'*/){` |
|    6390837 | 1558 | `							 iPtr--;` |
|    6390837 | 1559 | `							 if( iPtr <= 0 ){` |
|    6029991 | 1560 | `								 break;` |
|          - | 1561 | `							 }` |
|     180423 | 1562 | `						 }` |
|   11405509 | 1563 | `					 }` |
|   22856945 | 1564 | `					 nFuncTok++;` |
|          5 | 1565 | `				 }` |
|    6029991 | 1566 | `				 if( nFuncTok + iCur >= nToken ){` |
|          - | 1567 | `					 /* Syntax error */` |
...
|        ! 0 | 1572 | `					 return rc;` |
|          - | 1573 | `				 }` |
|    6029991 | 1574 | `				 if(  iLeft < 0 \|\| !NODE_ISTERM(iLeft) /*\|\| ( apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec != 2)*/ ){` |
|          - | 1575 | `					 /* Syntax error */` |
...
|        ! 0 | 1580 | `					 return rc;` |
|          - | 1581 | `				 }` |
|    6029991 | 1582 | `				 if( nFuncTok > 1 ){` |
|          - | 1583 | `					 /* Process function arguments */` |
|    4635737 | 1584 | `					 rc = ExprProcessFuncArguments(&(*pGen),pNode,&apNode[iCur+1],nFuncTok-1);` |
|    4635737 | 1585 | `					 if( rc != SXRET_OK ){` |
|         11 | 1586 | `						 return rc;` |
|          - | 1587 | `					 }` |
|    2317862 | 1588 | `				 }` |
|          - | 1589 | `				 /* Link the node to the tree */` |
|    6029983 | 1590 | `				 pNode->pLeft = apNode[iLeft];` |
|    6029983 | 1591 | `				 apNode[iLeft] = 0;` |
|   28886899 | 1592 | `				 for( iPtr = 1; iPtr <= nFuncTok ; iPtr++ ){` |
|   22856921 | 1593 | `					 apNode[iCur+iPtr] = 0;` |
|   11428463 | 1594 | `				 }` |
...
|          - | 1605 | `				 {` |
|    6029983 | 1606 | `					 sxi32 iNew = iLeft - 1;` |
|    7858447 | 1607 | `					 while( iNew >= 0 && apNode[iNew] == 0 ){` |
|    1828469 | 1608 | `						 iNew--;` |
|          5 | 1609 | `					 }` |
|    6029978 | 1610 | `					 if( iNew >= 0 && apNode[iNew]->pOp` |
|    3593657 | 1611 | `						 && apNode[iNew]->pOp->iOp == EXPR_OP_NEW` |
|    2165025 | 1612 | `						 && apNode[iNew]->pLeft == 0 ){` |
...
|     374875 | 1617 | `					 }` |
|          - | 1618 | `				 }` |
|   10714108 | 1619 | `			 }else if (pNode->pOp->iOp == EXPR_OP_SUBSCRIPT ){` |
|          - | 1620 | `				 /* Subscripting */` |
|    2816505 | 1621 | `				 sxi32 iArrTok = iCur + 1;` |
|    2816505 | 1622 | `				 sxi32 iNest = 1;` |
|    2816500 | 1623 | `				 if(  iLeft < 0 \|\| apNode[iLeft] == 0 \|\| (apNode[iLeft]->pOp == 0 && (apNode[iLeft]->xCode != PH7_CompileVariable &&` |
...
|    2816500 | 1627 | `					 ( apNode[iLeft]->pOp && apNode[iLeft]->pOp->iPrec != 2 /* postfix */` |
...
|    5922563 | 1639 | `				 while( iArrTok < nToken ){` |
|    5922563 | 1640 | `					 if( apNode[iArrTok] ){` |
|    5922531 | 1641 | `						 if( apNode[iArrTok]->pOp && apNode[iArrTok]->pOp->iOp == EXPR_OP_SUBSCRIPT &&  apNode[iArrTok]->pLeft == 0){` |
|          - | 1642 | `							 /* Increment nesting level */` |
|      26689 | 1643 | `							 iNest++;` |
|    5909189 | 1644 | `						 }else if( apNode[iArrTok]->pStart->nType & PH7_TK_CSB /*']'*/){` |
|          - | 1645 | `							 /* Decrement nesting level */` |
|    2843189 | 1646 | `							 iNest--;` |
|    2843189 | 1647 | `							 if( iNest <= 0 ){` |
|    2816505 | 1648 | `								 break;` |
|          - | 1649 | `							 }` |
|      13342 | 1650 | `						 }` |
|    1553013 | 1651 | `					 }` |
...
|          5 | 1653 | `				 }` |
|    2816505 | 1654 | `				 if( iArrTok > iCur + 1 ){` |
...
|    2816505 | 1664 | `				 pNode->pLeft = apNode[iLeft];` |
|    2816505 | 1665 | `				 pNode->pRight = 0;` |
|    2816505 | 1666 | `				 apNode[iLeft] = 0;` |
|    8739063 | 1667 | `				 for( iNest = iCur + 1 ; iNest <= iArrTok ; ++iNest ){` |
|    5922563 | 1668 | `					 apNode[iNest] = 0;` |
|    2961284 | 1669 | `				 }` |
|    1408255 | 1670 | `			 }else{` |
...
|          - | 1704 | `			 }` |
|    6864544 | 1705 | `		 }` |
|   50731595 | 1706 | `		 iLeft = iCur;` |
|   25365800 | 1707 | `	 }` |
|          - | 1708 | `	 /* Handle left associative (new, clone) operators */` |
|  103474703 | 1709 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|   89803995 | 1710 | `		 if( apNode[iCur] == 0 ){` |
|   53604999 | 1711 | `			 continue;` |
|          - | 1712 | `		 }` |
|   36199001 | 1713 | `		 pNode = apNode[iCur];` |
|   36199001 | 1714 | `		 if( pNode->pOp && pNode->pOp->iPrec == 1 && pNode->pLeft == 0 ){` |
|          - | 1715 | `			 SyToken *pToken;` |
...
|   13670713 | 1795 | `	 iLeft = -1;` |
|  103631389 | 1796 | `	 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|   89803995 | 1797 | `		 if( apNode[iCur] == 0 ){` |
|   53604999 | 1798 | `			 continue;` |
|          - | 1799 | `		 }` |
|   36199001 | 1800 | `		 pNode = apNode[iCur];` |
|   36199001 | 1801 | `		 if( pNode->pOp && pNode->pOp->iPrec == 3 && pNode->pLeft == 0){` |
...
|      86003 | 1807 | `			 }` |
|     250329 | 1808 | `		  }` |
|   36355687 | 1809 | `		 iLeft = iCur;` |
|   18256189 | 1810 | `	  }` |
|   13827399 | 1811 | `	 iLeft = -1;` |
|  103631389 | 1812 | `	 for( iCur = nToken -  1 ; iCur >= 0 ; iCur-- ){` |
|   89803995 | 1813 | `		 if( apNode[iCur] == 0 ){` |
|   53777005 | 1814 | `			 continue;` |
|          - | 1815 | `		 }` |
|   36026995 | 1816 | `		 pNode = apNode[iCur];` |
|   36026995 | 1817 | `		 if( pNode->pOp && pNode->pOp->iPrec == 3 && pNode->pLeft == 0){` |
...
|       7640 | 1832 | `		  }` |
|   36026995 | 1833 | `		 iLeft = iCur;` |
|   18013500 | 1834 | `	 }` |
|          - | 1835 | `	 /* Handle right associative unary and cast operators [i.e: !,(string),~...]  with precedence 4*/` |
|   13827399 | 1836 | `	  iLeft = 0;` |
|  103631383 | 1837 | `	  for( iCur = nToken -  1 ; iCur >= 0 ; iCur-- ){` |
|   89803991 | 1838 | `		  if( apNode[iCur] ){` |
|   36011711 | 1839 | `			  pNode = apNode[iCur];` |
|   36011711 | 1840 | `			  if( pNode->pOp && pNode->pOp->iPrec == 4 && pNode->pLeft == 0){` |
...
|  103631381 | 1872 | `	 for( iCur = nToken - 1 ; iCur >= 0 ; --iCur ){` |
|   89803989 | 1873 | `		 if( apNode[iCur] == 0 ){` |
|   54865461 | 1874 | `			 continue;` |
|          - | 1875 | `		 }` |
|   34938533 | 1876 | `		 pNode = apNode[iCur];` |
|   34938533 | 1877 | `		 if( pNode->pOp && pNode->pOp->iPrec == 5 && pNode->pLeft == 0 ){` |
|          - | 1878 | `			 sxi32 iL, iR;` |
...
|  152101231 | 1940 | `	 for( i = 7 ; i < 17 ; i++ ){` |
|  138273849 | 1941 | `		 iLeft = -1;` |
| 1036313395 | 1942 | `		 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  898039561 | 1943 | `			 if( apNode[iCur] == 0 ){` |
|  611474055 | 1944 | `				 continue;` |
|          - | 1945 | `			 }` |
|  286565511 | 1946 | `			 pNode = apNode[iCur];` |
|  286565511 | 1947 | `			 if( pNode->pOp && pNode->pOp->iPrec == i && pNode->pLeft == 0 ){` |
|          - | 1948 | `				 /* Get the right node */` |
|    5079917 | 1949 | `				 iRight = iCur + 1;` |
|    7641749 | 1950 | `				 while( iRight < nToken && apNode[iRight] == 0 ){` |
|    2561837 | 1951 | `					 iRight++;` |
|          5 | 1952 | `				 }` |
|    5079917 | 1953 | `				 if( iRight >= nToken \|\| iLeft < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|          - | 1954 | `					 /* Syntax error */` |
...
|         11 | 1959 | `					 return rc;` |
|          - | 1960 | `				 }` |
|    5079909 | 1961 | `				 if( pNode->pOp->iOp == EXPR_OP_REF ){` |
|          - | 1962 | `					 sxi32  iTmp;` |
...
|    5079907 | 2003 | `				 pNode->pLeft = apNode[iLeft];` |
|    5079907 | 2004 | `				 pNode->pRight = apNode[iRight];` |
|    5079907 | 2005 | `				 apNode[iLeft] = apNode[iRight] = 0;` |
|    2539951 | 2006 | `			 }` |
|  286565501 | 2007 | `			 iLeft = iCur;` |
|  143282753 | 2008 | `		 }` |
|   69136922 | 2009 | `	 }` |
...
|          - | 2013 | `	  */` |
|   13827387 | 2014 | `	  iLeft = -1;` |
|  100094819 | 2015 | `	  for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|   86697693 | 2016 | `		  if( apNode[iCur] == 0 ){` |
|   63206023 | 2017 | `			  continue;` |
|          - | 2018 | `		  }` |
|   23491675 | 2019 | `		  pNode = apNode[iCur];` |
|   23491675 | 2020 | `		  if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_QUESTY && pNode->pLeft == 0 ){` |
...
|          - | 2086 | `	  */` |
|   13827385 | 2087 | `	 iRight = -1;` |
|  103631185 | 2088 | `	 for( iCur = nToken -  1 ; iCur >= 0 ; iCur--){` |
|   89803859 | 2089 | `		 if( apNode[iCur] == 0 ){` |
|   71359425 | 2090 | `			 continue;` |
|          - | 2091 | `		 }` |
|   18444439 | 2092 | `		 pNode = apNode[iCur];` |
|   18444439 | 2093 | `		 if( pNode->pOp && pNode->pOp->iPrec == 18 && pNode->pLeft == 0 ){` |
|          - | 2094 | `			 /* Get the left node */` |
|    4616981 | 2095 | `			 iLeft = iCur - 1;` |
|    6319299 | 2096 | `			 while( iLeft >= 0 && apNode[iLeft] == 0 ){` |
|    1702323 | 2097 | `				 iLeft--;` |
|          5 | 2098 | `			 }` |
|    4616981 | 2099 | `			 if( iLeft < 0 \|\| iRight < 0 \|\| !NODE_ISTERM(iRight) \|\| !NODE_ISTERM(iLeft) ){` |
|          - | 2100 | `				 /* Syntax error */` |
...
|          - | 2117 | `			  * a write. */` |
|    4616939 | 2118 | `			 if( PH7_ExprContainsNullsafe(apNode[iLeft]) ){` |
...
|    4616931 | 2131 | `			 pSuppress = 0;` |
|    4616926 | 2132 | `			 if( apNode[iLeft]->pOp` |
|    2949658 | 2133 | `				 && apNode[iLeft]->pOp->iVmOp == PH7_OP_ERR_CTRL` |
|     641195 | 2134 | `				 && apNode[iLeft]->pLeft != 0` |
|          5 | 2135 | `				 && (apNode[iLeft]->iFlags & EXPR_NODE_PARENS) == 0 ){` |
|        ! 0 | 2136 | `				 pSuppress = apNode[iLeft];` |
|        ! 0 | 2137 | `				 apNode[iLeft] = pSuppress->pLeft;` |
|        ! 0 | 2138 | `			 }` |
|    4616931 | 2139 | `			 if( ExprIsModifiableValue(apNode[iLeft],FALSE) == FALSE ){` |
...
|    4616927 | 2158 | `			 pNode->pLeft = apNode[iRight];` |
|    4616927 | 2159 | `			 pNode->pRight = apNode[iLeft];` |
|    4616927 | 2160 | `			 apNode[iLeft] = apNode[iRight] = 0;` |
|    4616927 | 2161 | `			 if( pSuppress ){` |
|          - | 2162 | `				 /* Re-wrap: the '@' now suppresses the whole assignment */` |
|        ! 0 | 2163 | `				 pSuppress->pLeft = pNode;` |
|        ! 0 | 2164 | `				 apNode[iCur] = pSuppress;` |
|        ! 0 | 2165 | `			 }` |
|    2308461 | 2166 | `		 }` |
|   18444385 | 2167 | `		 iRight = iCur;` |
|    9222195 | 2168 | `	 }` |
|          - | 2169 | `	 /* Process left associative binary operators that have the lowest precedence [i.e: and,or,xor] */` |
|   69136635 | 2170 | `	 for( i = 19 ; i < 23 ; i++ ){` |
|   55309309 | 2171 | `		 iLeft = -1;` |
|  414524453 | 2172 | `		 for( iCur = 0 ; iCur < nToken ; ++iCur ){` |
|  359215149 | 2173 | `			 if( apNode[iCur] == 0 ){` |
|  303905593 | 2174 | `				 continue;` |
|          - | 2175 | `			 }` |
|   55309561 | 2176 | `			 pNode = apNode[iCur];` |
|   55309561 | 2177 | `			 if( pNode->pOp && pNode->pOp->iPrec == i && pNode->pLeft == 0 ){` |
...
|         24 | 2195 | `			 }` |
|   55309561 | 2196 | `			 iLeft = iCur;` |
|   27654783 | 2197 | `		 }` |
|   27654657 | 2198 | `	 }` |
|          - | 2199 | `	 /* Point to the root of the expression tree */` |
|   89803763 | 2200 | `	 for( iCur = 1 ; iCur < nToken ; ++iCur ){` |
|   75976455 | 2201 | `		 if( apNode[iCur] ){` |
|   13257935 | 2202 | `			 if( (apNode[iCur]->pOp \|\| apNode[iCur]->xCode ) && apNode[0] != 0){` |
...
|         23 | 2207 | `				  return rc;` |
|          - | 2208 | `			 }` |
|   13257917 | 2209 | `			 apNode[0] = apNode[iCur];` |
|   13257917 | 2210 | `			 apNode[iCur] = 0;` |
|    6628956 | 2211 | `		 }` |
|   37988221 | 2212 | `	 }` |
|   13827313 | 2213 | `	 return SXRET_OK;` |
|   12491199 | 2214 | ` }` |
|          - | 2215 | ` /*` |
...
|          - | 2220 | `  */` |
|   14481948 | 2221 | `PH7_PRIVATE sxi32 PH7_ExprMakeTree(ph7_gen_state *pGen,SySet *pExprNode,ph7_expr_node **ppRoot)` |
|          5 | 2222 | `{` |
|          - | 2223 | `	ph7_expr_node **apNode;` |
|          - | 2224 | `	ph7_expr_node *pNode;` |
|          - | 2225 | `	sxi32 rc;` |
|          - | 2226 | `	/* Reset node container */` |
|   14481953 | 2227 | `	SySetReset(pExprNode);` |
|   14481953 | 2228 | `	pNode = 0; /* Prevent compiler warning */` |
|          - | 2229 | `	/* Extract nodes one after one until we hit the end of the input */` |
|          - | 2230 | `	{` |
|   14481953 | 2231 | `		int iLastWasTerm = 0;` |
|   14481953 | 2232 | `		int bAfterMemberOp = 0; /* TRUE iff the previous node was -> / ?-> / :: */` |
|   91651113 | 2233 | `		while( pGen->pIn < pGen->pEnd ){` |
|   77169199 | 2234 | `			rc = ExprExtractNode(&(*pGen),&pNode,iLastWasTerm,bAfterMemberOp);` |
|   77169199 | 2235 | `			if( rc != SXRET_OK ){` |
|         38 | 2236 | `				return rc;` |
|          - | 2237 | `			}` |
|          - | 2238 | `			/* Determine if this node is a term for short-array disambiguation */` |
|   77169165 | 2239 | `			if( pNode->xCode ){` |
|          - | 2240 | `				/* Node with compile handler: variable, literal, string, array, etc. */` |
|   39152439 | 2241 | `				iLastWasTerm = 1;` |
|   57592948 | 2242 | `			}else if( pNode->pOp ){` |
|          - | 2243 | `				/* Operator node */` |
|   21889625 | 2244 | `				iLastWasTerm = 0;` |
|   10944815 | 2245 | `			}else{` |
|          - | 2246 | `				/* Delimiter: ')' and ']' end terms */` |
|   16127111 | 2247 | `				iLastWasTerm = (pNode->pStart->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB)) ? 1 : 0;` |
|          - | 2248 | `			}` |
...
|   77169165 | 2252 | `			bAfterMemberOp = ( pNode->pOp && pNode->pOp->iVmOp == PH7_OP_MEMBER );` |
|          - | 2253 | `			/* Save the extracted node */` |
|   77169165 | 2254 | `			SySetPut(pExprNode,(const void *)&pNode);` |
|          5 | 2255 | `		}` |
|          - | 2256 | `	}` |
|   14481919 | 2257 | `	if( SySetUsed(pExprNode) < 1 ){` |
|          - | 2258 | `		/* Empty expression [i.e: A semi-colon;] */` |
|        ! 0 | 2259 | `		*ppRoot = 0;` |
|        ! 0 | 2260 | `		return SXRET_OK;` |
|          - | 2261 | `	}` |
|   14481919 | 2262 | `	apNode = (ph7_expr_node **)SySetBasePtr(pExprNode);` |
|          - | 2263 | `	/* Make sure we are dealing with valid nodes */` |
|   14481919 | 2264 | `	rc = ExprVerifyNodes(&(*pGen),apNode,(sxi32)SySetUsed(pExprNode));` |
|   14481919 | 2265 | `	if( rc != SXRET_OK ){` |
...
|          - | 2271 | `	}` |
|          - | 2272 | `	/* Build the tree */` |
|   14481867 | 2273 | `	rc = ExprMakeTree(&(*pGen),apNode,(sxi32)SySetUsed(pExprNode));` |
|   14481867 | 2274 | `	if( rc != SXRET_OK ){` |
|          - | 2275 | `		/* Something goes wrong [i.e: Syntax error] */` |
|        103 | 2276 | `		*ppRoot = 0;` |
|        103 | 2277 | `		return rc;` |
|          - | 2278 | `	}` |
|          - | 2279 | `	/* Point to the root of the tree */` |
|   14481769 | 2280 | `	*ppRoot = apNode[0];` |
|   14481769 | 2281 | `	return SXRET_OK;` |
|    7240979 | 2282 | `}` |
|          - | 2283 |  |
