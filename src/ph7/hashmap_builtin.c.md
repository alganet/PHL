...
|       - |   63 | ` */` |
|    2252 |   64 | `PH7_PRIVATE int ph7_hashmap_count(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       5 |   65 | `{` |
|    2257 |   66 | `	int bRecursive = FALSE;` |
|    2257 |   67 | `	int bCycleDetected = FALSE;` |
|       - |   68 | `	sxi64 iCount;` |
|    2257 |   69 | `	if( nArg < 1 ){` |
...
|       - |  118 | `	}` |
|       - |  119 | `	/* Count */` |
|    2175 |  120 | `	iCount = HashmapCount((ph7_hashmap *)apArg[0]->x.pOther,bRecursive,&bCycleDetected);` |
|    2175 |  121 | `	if( bCycleDetected ){` |
|       3 |  122 | `		PH7_VmThrowError(pCtx->pVm,0,PH7_CTX_WARNING,"count(): Recursion detected");` |
|       1 |  123 | `	}` |
|    2175 |  124 | `	ph7_result_int64(pCtx,iCount);` |
|    2175 |  125 | `	return PH7_OK;` |
|    1131 |  126 | `}` |
|       - |  127 | `/*` |
...
|       - | 1316 | ` */` |
|     194 | 1317 | `PH7_PRIVATE int ph7_hashmap_keys(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       5 | 1318 | `{` |
...
|     199 | 1336 | `	if( !ph7_value_is_array(apArg[0]) ){` |
...
|     197 | 1345 | `	pMap = (ph7_hashmap *)apArg[0]->x.pOther;` |
|       - | 1346 | `	/* Create a new array */` |
|     197 | 1347 | `	pArray = ph7_context_new_array(pCtx);` |
|     197 | 1348 | `	if( pArray == 0 ){` |
|     ! 0 | 1349 | `		ph7_result_null(pCtx);` |
|     ! 0 | 1350 | `		return PH7_OK;` |
|       - | 1351 | `	}` |
|     197 | 1352 | `	bStrict = FALSE;` |
|     197 | 1353 | `	if( nArg > 2 ){` |
...
|     197 | 1365 | `	pNode = pMap->pFirst;` |
|     197 | 1366 | `	PH7_MemObjInit(pMap->pVm,&sVal);` |
|    1631 | 1367 | `	for( n = 0 ; n < pMap->nEntry ; ++n ){` |
|    1439 | 1368 | `		if( pNode->iType == HASHMAP_INT_NODE ){` |
|     191 | 1369 | `			PH7_MemObjInitFromInt(pMap->pVm,&sObj,pNode->xKey.iKey);` |
|      97 | 1370 | `		}else{` |
|    1250 | 1371 | `			SyStringInitFromBuf(&sKey,SyBlobData(&pNode->xKey.sKey),SyBlobLength(&pNode->xKey.sKey));` |
|    1250 | 1372 | `			PH7_MemObjInitFromString(pMap->pVm,&sObj,&sKey);` |
|       - | 1373 | `		}` |
|    1439 | 1374 | `		rc = 0;` |
|    1439 | 1375 | `		if( nArg > 1 ){` |
...
|    1407 | 1393 | `			ph7_array_add_elem(pArray,0,&sObj);` |
|     701 | 1394 | `		}` |
|    1439 | 1395 | `		PH7_MemObjRelease(&sObj);` |
|       - | 1396 | `		/* Point to the next entry */` |
|    1439 | 1397 | `		pNode = pNode->pPrev; /* Reverse link */` |
|     722 | 1398 | `	}` |
|       - | 1399 | `	/* return the new array */` |
|     197 | 1400 | `	ph7_result_value(pCtx,pArray);` |
|     197 | 1401 | `	return PH7_OK;` |
|     102 | 1402 | `}` |
|       - | 1403 | `/*` |
...
|       - | 1938 | ` */` |
|   32694 | 1939 | `PH7_PRIVATE int ph7_hashmap_in_array(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       5 | 1940 | `{` |
|       - | 1941 | `	ph7_value *pNeedle;` |
|       - | 1942 | `	int bStrict;` |
|       - | 1943 | `	int rc;` |
|   32699 | 1944 | `	if( nArg < 2 ){` |
|       - | 1945 | `		/* Missing argument,return FALSE */` |
|     ! 0 | 1946 | `		ph7_result_bool(pCtx,0);` |
|     ! 0 | 1947 | `		return PH7_OK;` |
|       - | 1948 | `	}` |
|   32699 | 1949 | `	pNeedle = apArg[0];` |
|   32699 | 1950 | `	bStrict = 0;` |
|   32699 | 1951 | `	if( nArg > 2 ){` |
|      62 | 1952 | `		bStrict = ph7_value_to_bool(apArg[2]);` |
|      30 | 1953 | `	}` |
|   32699 | 1954 | `	if( !ph7_value_is_array(apArg[1]) ){` |
...
|   32699 | 1962 | `	rc = HashmapFindValue((ph7_hashmap *)apArg[1]->x.pOther,pNeedle,0,bStrict);` |
|       - | 1963 | `	/* Lookup result */` |
|   32699 | 1964 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|   32699 | 1965 | `	return PH7_OK;` |
|   16352 | 1966 | `}` |
|       - | 1967 | `/*` |
...
|       1 | 4122 | `				pNode = pNode->pPrev; /* Reverse link */` |
|       1 | 4123 | `				nEntry--;` |
|       1 | 4124 | `			}` |
|       - | 4125 | `		}` |
...
|     177 | 4721 | `	for( i = 1 ; i < nArg ; i++ ){` |
|      97 | 4722 | `		if( !ph7_value_is_array(apArg[i]) ){` |
|       3 | 4723 | `			if( i == 1 ){` |
...
|       - | 4735 | `		}` |
|      49 | 4736 | `	}` |
|      83 | 4737 | `	pVm = pCtx->pVm;` |
|       - | 4738 | `	/* Create a new array */` |
|      83 | 4739 | `	pArray = ph7_context_new_array(pCtx);` |
|      83 | 4740 | `	if( pArray == 0 ){` |
|     ! 0 | 4741 | `		ph7_result_null(pCtx);` |
|     ! 0 | 4742 | `		return PH7_OK;` |
|       - | 4743 | `	}` |
|      83 | 4744 | `	PH7_MemObjInit(pVm,&sResult);` |
|      83 | 4745 | `	PH7_MemObjInit(pVm,&sKey);` |
|      83 | 4746 | `	sResult.nIdx = SXU32_HIGH; /* Mark as constant */` |
|      83 | 4747 | `	sKey.nIdx    = SXU32_HIGH; /* Mark as constant */` |
|      83 | 4748 | `	if( nArg == 2 ){` |
|       - | 4749 | `		/* Single-array mode: keys are preserved (PHP semantics). */` |
|      73 | 4750 | `		pMap = (ph7_hashmap *)apArg[1]->x.pOther;` |
|      73 | 4751 | `		pEntry = pMap->pFirst;` |
|     257 | 4752 | `		for( n = 0 ; n < pMap->nEntry ; n++ ){` |
|       - | 4753 | `			/* Extract the node value */` |
|     191 | 4754 | `			pValue = HashmapExtractNodeValue(pEntry);` |
|     191 | 4755 | `			if( pValue ){` |
|       - | 4756 | `				/* Extract the node key */` |
|     191 | 4757 | `				PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|     191 | 4758 | `				if( bNullCallback ){` |
...
|     181 | 4763 | `					rc = PH7_VmCallUserFunction(pVm,apArg[0],1,&pValue,&sResult);` |
|     181 | 4764 | `					if( rc == PH7_EXCEPTION ){` |
...
|     177 | 4772 | `					ph7_array_add_elem(pArray,&sKey,&sResult);` |
|       - | 4773 | `				}` |
|     187 | 4774 | `				PH7_MemObjRelease(&sKey);` |
|     187 | 4775 | `				PH7_MemObjRelease(&sResult);` |
|      92 | 4776 | `			}` |
|       - | 4777 | `			/* Point to the next entry */` |
|     187 | 4778 | `			pEntry = pEntry->pPrev; /* Reverse link */` |
|      95 | 4779 | `		}` |
|      36 | 4780 | `	}else{` |
...
|       - | 4851 | `	}` |
|      79 | 4852 | `	PH7_MemObjRelease(&sKey);` |
|      79 | 4853 | `	PH7_MemObjRelease(&sResult);` |
|      79 | 4854 | `	ph7_result_value(pCtx,pArray);` |
|      79 | 4855 | `	return PH7_OK;` |
|      48 | 4856 | `}` |
|       - | 4857 | `/*` |
