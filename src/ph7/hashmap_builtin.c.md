...
Coverage: 2443/2846 lines (85.84%)
...
|       - |   63 | ` */` |
|    2248 |   64 | `PH7_PRIVATE int ph7_hashmap_count(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       5 |   65 | `{` |
|    2253 |   66 | `	int bRecursive = FALSE;` |
|    2253 |   67 | `	int bCycleDetected = FALSE;` |
|       - |   68 | `	sxi64 iCount;` |
|    2253 |   69 | `	if( nArg < 1 ){` |
