...
Coverage: 2481/2846 lines (87.17%)
...
|       - |   74 | `	}` |
|    2255 |   75 | `	if( nArg > 2 ){` |
|       4 |   76 | `		return PH7_VmThrowException(pCtx,` |
...
|    2253 |   85 | `	if( nArg > 1 ){` |
|      42 |   86 | `		sxi32 iMode = ph7_value_to_int(apArg[1]);` |
|      42 |   87 | `		if( iMode != 0 /* COUNT_NORMAL */ && iMode != 1 /* COUNT_RECURSIVE */ ){` |
...
|      15 |   94 | `	}` |
|    2245 |   95 | `	if( !ph7_value_is_array(apArg[0]) ){` |
|       - |   96 | `		/* Countable object: dispatch to ->count() */` |
|      77 |   97 | `		if( apArg[0]->iFlags & MEMOBJ_OBJ ){` |
...
|      62 |  101 | `				ph7_class_method *pMeth = PH7_ClassExtractMethod(pInst->pClass,` |
|       - |  102 | `					"count",sizeof("count")-1);` |
|      62 |  103 | `				if( pMeth ){` |
|       - |  104 | `					ph7_value sResult;` |
|      62 |  105 | `					PH7_MemObjInit(pCtx->pVm,&sResult);` |
|      62 |  106 | `					PH7_VmCallClassMethod(pCtx->pVm,pInst,pMeth,&sResult,0,0);` |
|      62 |  107 | `					ph7_result_int64(pCtx,ph7_value_to_int64(&sResult));` |
|      62 |  108 | `					PH7_MemObjRelease(&sResult);` |
|      62 |  109 | `					return PH7_OK;` |
|       - |  110 | `				}` |
|     ! 0 |  111 | `			}` |
|       1 |  112 | `		}` |
|      22 |  113 | `		return PH7_VmThrowException(pCtx,` |
|       - |  114 | `			"TypeError",` |
|       - |  115 | `			"count(): Argument #1 ($value) must be of type Countable\|array, %s given",` |
|       6 |  116 | `			ph7_type_name(apArg[0])` |
|       - |  117 | `			);` |
|       - |  118 | `	}` |
|       - |  119 | `	/* Count */` |
|    2173 |  120 | `	iCount = HashmapCount((ph7_hashmap *)apArg[0]->x.pOther,bRecursive,&bCycleDetected);` |
|    2173 |  121 | `	if( bCycleDetected ){` |
|       3 |  122 | `		PH7_VmThrowError(pCtx->pVm,0,PH7_CTX_WARNING,"count(): Recursion detected");` |
|       1 |  123 | `	}` |
|    2173 |  124 | `	ph7_result_int64(pCtx,iCount);` |
|    2173 |  125 | `	return PH7_OK;` |
|    1130 |  126 | `}` |
|       - |  127 | `/*` |
...
|       - |  137 | ` */` |
|      94 |  138 | `PH7_PRIVATE int ph7_hashmap_key_exists(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       5 |  139 | `{` |
|       - |  140 | `	sxi32 rc;` |
|      99 |  141 | `	if( nArg != 2 ){` |
|       - |  142 | `		/* PHP requires exactly two arguments */` |
|       4 |  143 | `		return PH7_VmThrowException(pCtx,` |
...
|      97 |  150 | `	if( !ph7_value_is_array(apArg[1]) ){` |
...
|      93 |  159 | `	if( apArg[0]->iFlags & MEMOBJ_NULL ){` |
...
|      91 |  162 | `	}else if( apArg[0]->iFlags & MEMOBJ_REAL ){` |
...
|      88 |  170 | `	rc = PH7_HashmapLookup((ph7_hashmap *)apArg[1]->x.pOther,apArg[0],0);` |
|       - |  171 | `	/* lookup result */` |
|      88 |  172 | `	ph7_result_bool(pCtx,rc == SXRET_OK ? 1 : 0);` |
|      88 |  173 | `	return PH7_OK;` |
|      52 |  174 | `}` |
|       - |  175 | `/*` |
...
|       - |  182 | ` */` |
|     108 |  183 | `PH7_PRIVATE int ph7_hashmap_pop(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       4 |  184 | `{` |
|       - |  185 | `	ph7_hashmap *pMap;` |
|       - |  186 | `	/* PHP requires exactly one argument and it must be passed by reference */` |
|     112 |  187 | `	if( nArg != 1 ){` |
|       4 |  188 | `		return PH7_VmThrowException(pCtx,` |
...
|       - |  296 | ` */` |
|      44 |  297 | `PH7_PRIVATE int ph7_hashmap_shift(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       5 |  298 | `{` |
|       - |  299 | `	ph7_hashmap *pMap;` |
|       - |  300 | `	/* PHP requires exactly one argument and it must be passed by reference */` |
|      49 |  301 | `	if( nArg != 1 ){` |
|       4 |  302 | `		return PH7_VmThrowException(pCtx,` |
...
|       - |  773 | ` */` |
|     278 |  774 | `static int RangeEndpointZpp(ph7_context *pCtx,ph7_value *pIn,int iArg,const char *zName,int *pbNullCoerced,sxi32 *pRc)` |
|       2 |  775 | `{` |
|     139 |  776 | `	SXUNUSED(pbNullCoerced); /* php coerces null to 0 with a deprecation; PHL rejects it */` |
|     280 |  777 | `	*pRc = PH7_OK;` |
|     280 |  778 | `	if( pIn->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|       - |  779 | `		char zType[80];` |
...
|     ! 0 |  783 | `		return FALSE;` |
|       - |  784 | `	}` |
|     280 |  785 | `	if( pIn->iFlags & MEMOBJ_NULL ){` |
|       - |  786 | `		/* php only DEPRECATES null here; PHL rejects it. */` |
|       4 |  787 | `		*pRc = PH7_VmThrowException(pCtx,"TypeError",` |
...
|       - |  800 | ` */` |
|      56 |  801 | `static sxu8 RangeStepInput(ph7_context *pCtx,ph7_value *pIn,sxi64 *pLong,double *pDouble,sxi32 *pRc)` |
|       2 |  802 | `{` |
|      58 |  803 | `	*pRc = PH7_OK;` |
|      58 |  804 | `	if( pIn->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|       - |  805 | `		char zType[80];` |
...
|       - |  983 | ` */` |
|     142 |  984 | `PH7_PRIVATE int ph7_hashmap_range(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       2 |  985 | `{` |
|       - |  986 | `	ph7_value *pValue,*pArray;` |
|     144 |  987 | `	sxi32 rc = PH7_OK;` |
|     144 |  988 | `	int is_step_double = 0,is_step_negative = 0;` |
|     144 |  989 | `	double step_double = 1.0;` |
|     144 |  990 | `	sxi64 step = 1;` |
|       - |  991 | `	sxu8 start_type,end_type;` |
|     144 |  992 | `	sxi64 start_long = 0,end_long = 0;` |
|     144 |  993 | `	double start_double = 0.0,end_double = 0.0;` |
|     144 |  994 | `	unsigned char cStart = 0,cEnd = 0;` |
|     144 |  995 | `	int bStartNull = FALSE,bEndNull = FALSE;` |
|       - |  996 | `	sxu32 i,size;` |
|       - |  997 |  |
|       - |  998 | `	/* php ZPP arity: at least 2 (enforced centrally, aBuiltinArity), at most 3. */` |
|     144 |  999 | `	if( nArg > 3 ){` |
|       4 | 1000 | `		return PH7_VmThrowException(pCtx,"ArgumentCountError",` |
|       1 | 1001 | `			"range() expects at most 3 arguments, %d given",nArg);` |
|       - | 1002 | `	}` |
|     142 | 1003 | `	if( nArg < 2 ){` |
...
|     142 | 1010 | `	if( !RangeEndpointZpp(pCtx,apArg[0],1,"start",&bStartNull,&rc) ){` |
|       3 | 1011 | `		return rc;` |
|       - | 1012 | `	}` |
|     140 | 1013 | `	if( !RangeEndpointZpp(pCtx,apArg[1],2,"end",&bEndNull,&rc) ){` |
|     ! 0 | 1014 | `		return rc;` |
|       - | 1015 | `	}` |
|     140 | 1016 | `	if( nArg > 2 ){` |
|      58 | 1017 | `		sxu8 iStepKind = RangeStepInput(pCtx,apArg[2],&step,&step_double,&rc);` |
|      58 | 1018 | `		if( iStepKind == RANGE_IN_ERROR ){` |
|       6 | 1019 | `			return rc;` |
|       - | 1020 | `		}` |
...
|       - | 1256 | ` */` |
|      48 | 1257 | `PH7_PRIVATE int ph7_hashmap_values(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       4 | 1258 | `{` |
...
|       4 | 1266 | `		return PH7_VmThrowException(pCtx,` |
...
|       - | 1316 | ` */` |
|     176 | 1317 | `PH7_PRIVATE int ph7_hashmap_keys(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       4 | 1318 | `{` |
...
|     180 | 1336 | `	if( !ph7_value_is_array(apArg[0]) ){` |
...
|     178 | 1345 | `	pMap = (ph7_hashmap *)apArg[0]->x.pOther;` |
|       - | 1346 | `	/* Create a new array */` |
|     178 | 1347 | `	pArray = ph7_context_new_array(pCtx);` |
|     178 | 1348 | `	if( pArray == 0 ){` |
|     ! 0 | 1349 | `		ph7_result_null(pCtx);` |
|     ! 0 | 1350 | `		return PH7_OK;` |
|       - | 1351 | `	}` |
|     178 | 1352 | `	bStrict = FALSE;` |
|     178 | 1353 | `	if( nArg > 2 ){` |
...
|     178 | 1365 | `	pNode = pMap->pFirst;` |
|     178 | 1366 | `	PH7_MemObjInit(pMap->pVm,&sVal);` |
|    1558 | 1367 | `	for( n = 0 ; n < pMap->nEntry ; ++n ){` |
|    1384 | 1368 | `		if( pNode->iType == HASHMAP_INT_NODE ){` |
|     191 | 1369 | `			PH7_MemObjInitFromInt(pMap->pVm,&sObj,pNode->xKey.iKey);` |
|      97 | 1370 | `		}else{` |
|    1194 | 1371 | `			SyStringInitFromBuf(&sKey,SyBlobData(&pNode->xKey.sKey),SyBlobLength(&pNode->xKey.sKey));` |
|    1194 | 1372 | `			PH7_MemObjInitFromString(pMap->pVm,&sObj,&sKey);` |
|       - | 1373 | `		}` |
|    1384 | 1374 | `		rc = 0;` |
|    1384 | 1375 | `		if( nArg > 1 ){` |
...
|    1352 | 1393 | `			ph7_array_add_elem(pArray,0,&sObj);` |
|     674 | 1394 | `		}` |
|    1384 | 1395 | `		PH7_MemObjRelease(&sObj);` |
|       - | 1396 | `		/* Point to the next entry */` |
|    1384 | 1397 | `		pNode = pNode->pPrev; /* Reverse link */` |
|     694 | 1398 | `	}` |
|       - | 1399 | `	/* return the new array */` |
|     178 | 1400 | `	ph7_result_value(pCtx,pArray);` |
|     178 | 1401 | `	return PH7_OK;` |
|      92 | 1402 | `}` |
|       - | 1403 | `/*` |
...
|       - | 1581 | `	}` |
|      71 | 1582 | `	if( nArg > 4 ){` |
|       4 | 1583 | `		return PH7_VmThrowException(pCtx,` |
...
|       - | 1938 | ` */` |
|   32632 | 1939 | `PH7_PRIVATE int ph7_hashmap_in_array(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       5 | 1940 | `{` |
|       - | 1941 | `	ph7_value *pNeedle;` |
|       - | 1942 | `	int bStrict;` |
|       - | 1943 | `	int rc;` |
|   32637 | 1944 | `	if( nArg < 2 ){` |
|       - | 1945 | `		/* Missing argument,return FALSE */` |
|     ! 0 | 1946 | `		ph7_result_bool(pCtx,0);` |
|     ! 0 | 1947 | `		return PH7_OK;` |
|       - | 1948 | `	}` |
|   32637 | 1949 | `	pNeedle = apArg[0];` |
|   32637 | 1950 | `	bStrict = 0;` |
|   32637 | 1951 | `	if( nArg > 2 ){` |
|      62 | 1952 | `		bStrict = ph7_value_to_bool(apArg[2]);` |
|      30 | 1953 | `	}` |
|   32637 | 1954 | `	if( !ph7_value_is_array(apArg[1]) ){` |
...
|   32637 | 1962 | `	rc = HashmapFindValue((ph7_hashmap *)apArg[1]->x.pOther,pNeedle,0,bStrict);` |
|       - | 1963 | `	/* Lookup result */` |
|   32637 | 1964 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|   32637 | 1965 | `	return PH7_OK;` |
|   16321 | 1966 | `}` |
|       - | 1967 | `/*` |
...
|       - | 3240 | ` */` |
|     236 | 3241 | `PH7_PRIVATE int ph7_hashmap_fill(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       5 | 3242 | `{` |
...
|       4 | 3249 | `		return PH7_VmThrowException(pCtx,` |
...
|       - | 3368 | ` */` |
|      22 | 3369 | `PH7_PRIVATE int ph7_hashmap_fill_keys(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       3 | 3370 | `{` |
...
|      25 | 3376 | `	if( nArg != 2 ){` |
|       4 | 3377 | `		return PH7_VmThrowException(pCtx,` |
...
|       - | 3571 | ` */` |
|      36 | 3572 | `PH7_PRIVATE int ph7_hashmap_unique(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       3 | 3573 | `{` |
...
|       - | 3656 | ` */` |
|      30 | 3657 | `PH7_PRIVATE int ph7_hashmap_flip(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       3 | 3658 | `{` |
...
|       4 | 3669 | `		return PH7_VmThrowException(pCtx,` |
...
|       - | 3831 | ` */` |
|     726 | 3832 | `PH7_PRIVATE int ph7_hashmap_sum(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       5 | 3833 | `{` |
|       - | 3834 | `	ph7_hashmap_node *pEntry;` |
|       - | 3835 | `	ph7_hashmap *pMap;` |
|       - | 3836 | `	ph7_value *pObj;` |
|     731 | 3837 | `	int useDouble = 0;` |
|       - | 3838 | `	sxu32 n;` |
|       - | 3839 | `	/* PHP requires exactly one argument */` |
|     731 | 3840 | `	if( nArg != 1 ){` |
|       4 | 3841 | `		return PH7_VmThrowException(pCtx,` |
...
|     729 | 3848 | `	if( !ph7_value_is_array(apArg[0]) ){` |
...
|       - | 3966 | ` */` |
|      16 | 3967 | `PH7_PRIVATE int ph7_hashmap_product(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       1 | 3968 | `{` |
...
|      17 | 3977 | `	if( !ph7_value_is_array(apArg[0]) ){` |
|       - | 3978 | `		char zBuf[64];` |
|      16 | 3979 | `		return PH7_VmThrowException(pCtx,` |
|       - | 3980 | `			"TypeError",` |
|       - | 3981 | `			"array_product(): Argument #1 ($array) must be of type array, %s given",` |
|       5 | 3982 | `			VmValueGivenName(apArg[0],zBuf,sizeof(zBuf))` |
|       - | 3983 | `			);` |
|       - | 3984 | `	}` |
...
|       2 | 4122 | `				pNode = pNode->pPrev; /* Reverse link */` |
|       2 | 4123 | `				nEntry--;` |
|     ! 0 | 4124 | `			}` |
|       - | 4125 | `		}` |
...
|      26 | 4375 | `}` |
|      62 | 4376 | `PH7_PRIVATE int ph7_hashmap_pad(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       3 | 4377 | `{` |
...
|       - | 4382 | `	sxi32 rc;` |
|      65 | 4383 | `	if( nArg != 3 ){` |
|       4 | 4384 | `		return PH7_VmThrowException(pCtx,` |
...
|       - | 4574 | ` */` |
|      30 | 4575 | `PH7_PRIVATE int ph7_hashmap_filter(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       2 | 4576 | `{` |
...
|      32 | 4591 | `	if( !ph7_value_is_array(apArg[0]) ){` |
|       - | 4592 | `		char zBuf[64];` |
|      19 | 4593 | `		return PH7_VmThrowException(pCtx,` |
|       - | 4594 | `			"TypeError",` |
|       - | 4595 | `			"array_filter(): Argument #1 ($array) must be of type array, %s given",` |
|       6 | 4596 | `			VmValueGivenName(apArg[0],zBuf,sizeof(zBuf))` |
|       - | 4597 | `			);` |
|       - | 4598 | `	}` |
...
|       - | 4685 | ` */` |
|      84 | 4686 | `PH7_PRIVATE int ph7_hashmap_map(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       4 | 4687 | `{` |
...
|       - | 4701 | `			);` |
|       - | 4702 | `	}` |
|      88 | 4703 | `	bNullCallback = ph7_value_is_null(apArg[0]);` |
|      88 | 4704 | `	if( !bNullCallback && !ph7_value_is_callable(apArg[0]) ){` |
...
|     169 | 4721 | `	for( i = 1 ; i < nArg ; i++ ){` |
|      93 | 4722 | `		if( !ph7_value_is_array(apArg[i]) ){` |
|       3 | 4723 | `			if( i == 1 ){` |
...
|       - | 4735 | `		}` |
|      47 | 4736 | `	}` |
|      79 | 4737 | `	pVm = pCtx->pVm;` |
|       - | 4738 | `	/* Create a new array */` |
|      79 | 4739 | `	pArray = ph7_context_new_array(pCtx);` |
|      79 | 4740 | `	if( pArray == 0 ){` |
|     ! 0 | 4741 | `		ph7_result_null(pCtx);` |
|     ! 0 | 4742 | `		return PH7_OK;` |
|       - | 4743 | `	}` |
|      79 | 4744 | `	PH7_MemObjInit(pVm,&sResult);` |
|      79 | 4745 | `	PH7_MemObjInit(pVm,&sKey);` |
|      79 | 4746 | `	sResult.nIdx = SXU32_HIGH; /* Mark as constant */` |
|      79 | 4747 | `	sKey.nIdx    = SXU32_HIGH; /* Mark as constant */` |
|      79 | 4748 | `	if( nArg == 2 ){` |
|       - | 4749 | `		/* Single-array mode: keys are preserved (PHP semantics). */` |
|      69 | 4750 | `		pMap = (ph7_hashmap *)apArg[1]->x.pOther;` |
|      69 | 4751 | `		pEntry = pMap->pFirst;` |
|     239 | 4752 | `		for( n = 0 ; n < pMap->nEntry ; n++ ){` |
|       - | 4753 | `			/* Extract the node value */` |
|     177 | 4754 | `			pValue = HashmapExtractNodeValue(pEntry);` |
|     177 | 4755 | `			if( pValue ){` |
|       - | 4756 | `				/* Extract the node key */` |
|     177 | 4757 | `				PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|     177 | 4758 | `				if( bNullCallback ){` |
...
|     167 | 4763 | `					rc = PH7_VmCallUserFunction(pVm,apArg[0],1,&pValue,&sResult);` |
|     167 | 4764 | `					if( rc == PH7_EXCEPTION ){` |
...
|     163 | 4772 | `					ph7_array_add_elem(pArray,&sKey,&sResult);` |
|       - | 4773 | `				}` |
|     173 | 4774 | `				PH7_MemObjRelease(&sKey);` |
|     173 | 4775 | `				PH7_MemObjRelease(&sResult);` |
|      85 | 4776 | `			}` |
|       - | 4777 | `			/* Point to the next entry */` |
|     173 | 4778 | `			pEntry = pEntry->pPrev; /* Reverse link */` |
|      88 | 4779 | `		}` |
|      34 | 4780 | `	}else{` |
...
|       - | 4851 | `	}` |
|      75 | 4852 | `	PH7_MemObjRelease(&sKey);` |
|      75 | 4853 | `	PH7_MemObjRelease(&sResult);` |
|      75 | 4854 | `	ph7_result_value(pCtx,pArray);` |
|      75 | 4855 | `	return PH7_OK;` |
|      46 | 4856 | `}` |
|       - | 4857 | `/*` |
...
|       - | 4871 | ` */` |
|      30 | 4872 | `PH7_PRIVATE int ph7_hashmap_reduce(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       5 | 4873 | `{` |
...
|       - | 4970 | ` */` |
|      36 | 4971 | `PH7_PRIVATE int ph7_hashmap_walk(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       5 | 4972 | `{` |
...
|       - | 5119 | ` */` |
|      26 | 5120 | `PH7_PRIVATE int ph7_hashmap_walk_recursive(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       5 | 5121 | `{` |
...
|       - | 5190 | ` */` |
|     336 | 5191 | `PH7_PRIVATE int PH7_HashmapIsList(ph7_hashmap *pMap)` |
|       3 | 5192 | `{` |
|     339 | 5193 | `	ph7_hashmap_node *pNode = pMap->pFirst;` |
|     339 | 5194 | `	sxi64 iExpect = 0;` |
|       - | 5195 | `	sxu32 n;` |
|     777 | 5196 | `	for( n = 0 ; n < pMap->nEntry ; ++n ){` |
|     583 | 5197 | `		if( pNode->iType != HASHMAP_INT_NODE \|\| pNode->xKey.iKey != iExpect ){` |
|       - | 5198 | `			/* A non-integer key or a gap in the sequence: not a list */` |
|     145 | 5199 | `			return 0;` |
|       - | 5200 | `		}` |
|     441 | 5201 | `		++iExpect;` |
|     441 | 5202 | `		pNode = pNode->pPrev; /* Reverse link */` |
|     222 | 5203 | `	}` |
|     197 | 5204 | `	return 1;` |
|     171 | 5205 | `}` |
