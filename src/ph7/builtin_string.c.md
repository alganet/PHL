...
|      - |   59 | ` */` |
| 277655 |   60 | `PH7_PRIVATE int PH7_builtin_substr(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |   61 | `{` |
|      - |   62 | `	const char *zSource;` |
|      - |   63 | `	int nSrcLen;` |
|      - |   64 | `	sxi64 iStart,iEnd;` |
| 277660 |   65 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"substr",1,"$string"); }` |
| 277660 |   66 | `	if( nArg < 2 ){` |
...
| 277660 |   72 | `	zSource = ph7_value_to_string(apArg[0],&nSrcLen);` |
|      - |   73 | `	/* Extract the offset */` |
|      - |   74 | `	{` |
| 277660 |   75 | `		sxi64 iTmp = 0;` |
| 277660 |   76 | `		sxi32 rcArg = PH7_IntArgResolve(pCtx,apArg[1],"substr",2,"$offset","int",&iTmp);` |
| 277660 |   77 | `		if( rcArg != PH7_OK ){` |
|    ! 0 |   78 | `			return rcArg;` |
|      - |   79 | `		}` |
| 277660 |   80 | `		iStart = iTmp;` |
|      - |   81 | `	}` |
|      - |   82 | `	/*` |
...
|      - |   91 | `	 */` |
| 277660 |   92 | `	if( iStart < 0 ){` |
|  32957 |   93 | `		iStart += nSrcLen;` |
|  32957 |   94 | `		if( iStart < 0 ){` |
|      5 |   95 | `			iStart = 0;` |
|      7 |   96 | `		}` |
| 261184 |   97 | `	}else if( iStart > nSrcLen ){` |
|      7 |   98 | `		iStart = nSrcLen;` |
|      3 |   99 | `	}` |
| 277660 |  100 | `	iEnd = nSrcLen;` |
| 277660 |  101 | `	if( nArg > 2 && !ph7_value_is_null(apArg[2]) ){` |
| 196933 |  102 | `		sxi64 iLen = 0;` |
| 196933 |  103 | `		sxi32 rcArg = PH7_IntArgResolve(pCtx,apArg[2],"substr",3,"$length","?int",&iLen);` |
| 196933 |  104 | `		if( rcArg != PH7_OK ){` |
|    ! 0 |  105 | `			return rcArg;` |
|      - |  106 | `		}` |
| 196933 |  107 | `		if( iLen < 0 ){` |
|  32589 |  108 | `			iEnd = (sxi64)nSrcLen + iLen;` |
| 180641 |  109 | `		}else if( iLen > (sxi64)nSrcLen - iStart ){` |
|  18343 |  110 | `			iEnd = nSrcLen;` |
|   9174 |  111 | `		}else{` |
| 146011 |  112 | `			iEnd = iStart + iLen;` |
|      - |  113 | `		}` |
|  98464 |  114 | `	}` |
| 277660 |  115 | `	if( iEnd < iStart ){` |
|      3 |  116 | `		iEnd = iStart;` |
|      1 |  117 | `	}` |
| 277660 |  118 | `	ph7_result_string(pCtx,&zSource[iStart],(int)(iEnd - iStart));` |
| 277660 |  119 | `	return PH7_OK;` |
| 138935 |  120 | `}` |
|      - |  121 | `/*` |
...
| 421031 |  319 | `static void StrNullArgNotice(ph7_context *pCtx,ph7_value *pArg,const char *zFunc,int iArgNum,const char *zParamName)` |
|      5 |  320 | `{` |
| 421036 |  321 | `	if( ph7_value_is_null(pArg) ){` |
...
|      - | 1857 | ` */` |
| 155726 | 1858 | `static int implode_callback(ph7_value *pKey,ph7_value *pValue,void *pUserData)` |
|      5 | 1859 | `{` |
|  77863 | 1860 | `	SXUNUSED(pKey);` |
| 155731 | 1861 | `	struct implode_data *pData = (struct implode_data *)pUserData;` |
|      - | 1862 | `	const char *zData;` |
|      - | 1863 | `	int nLen;` |
| 155731 | 1864 | `	if( pData->bRecursive && ph7_value_is_array(pValue) && pData->nRecCount < 32 ){` |
...
| 155729 | 1888 | `	zData = ph7_value_to_string(pValue,&nLen);` |
|      - | 1889 | `	/* Manage separator insertion: always mark first seen; append separator for subsequent items */` |
| 155729 | 1890 | `	if( pData->bFirst ){` |
|  33269 | 1891 | `		pData->bFirst = 0;` |
| 139097 | 1892 | `	}else if( pData->nSeplen > 0 ){` |
|      - | 1893 | `		/* append the separator first */` |
| 122385 | 1894 | `		if( ph7_result_string(pData->pCtx,pData->zSep,pData->nSeplen) != SXRET_OK ){` |
...
| 155729 | 1900 | `	if( nLen > 0 ){` |
| 143571 | 1901 | `		if( ph7_result_string(pData->pCtx,zData,nLen) != SXRET_OK ){` |
|    ! 0 | 1902 | `			pData->rc = SXERR_MEM;` |
|    ! 0 | 1903 | `			return PH7_ABORT;` |
|      - | 1904 | `		}` |
|  71783 | 1905 | `	}` |
| 155729 | 1906 | `	return PH7_OK;` |
|  77868 | 1907 | `}` |
|      - | 1908 | `/*` |
...
|      - | 1920 | ` */` |
|  33330 | 1921 | `PH7_PRIVATE int PH7_builtin_implode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1922 | `{` |
|      - | 1923 | `	struct implode_data imp_data;` |
|  33335 | 1924 | `	int i = 1;` |
|  33335 | 1925 | `	if( nArg < 1 ){` |
|      - | 1926 | `		/* Missing argument,return NULL */` |
|    ! 0 | 1927 | `		ph7_result_null(pCtx);` |
|    ! 0 | 1928 | `		return PH7_OK;` |
|      - | 1929 | `	}` |
|      - | 1930 | `	/* Prepare the implode context */` |
|  33335 | 1931 | `	imp_data.pCtx = pCtx;` |
|  33335 | 1932 | `	imp_data.bRecursive = 0;` |
|  33335 | 1933 | `	imp_data.bFirst = 1;` |
|  33335 | 1934 | `	imp_data.nRecCount = 0;` |
|  33335 | 1935 | `	imp_data.rc = SXRET_OK;` |
|  33335 | 1936 | `	if( !ph7_value_is_array(apArg[0]) ){` |
|  33333 | 1937 | `		imp_data.zSep = ph7_value_to_string(apArg[0],&imp_data.nSeplen);` |
|  33333 | 1938 | `		if( nArg > 1 && !ph7_value_is_array(apArg[1]) && !ph7_value_is_null(apArg[1]) ){` |
...
|      3 | 1949 | `		i = 0;` |
|      - | 1950 | `	}` |
|  33333 | 1951 | `	if( ph7_result_string(pCtx,"",0) != SXRET_OK ){ /* Set an empty stirng */` |
|    ! 0 | 1952 | `		return PH7_ContextMemoryError(pCtx);` |
|      - | 1953 | `	}` |
|      - | 1954 | `	/* Start the 'join' process */` |
|  66661 | 1955 | `	while( i < nArg ){` |
|  33333 | 1956 | `		if( ph7_value_is_array(apArg[i]) ){` |
|      - | 1957 | `			/* Iterate throw array entries */` |
|  33333 | 1958 | `			ph7_array_walk(apArg[i],implode_callback,&imp_data);` |
|      - | 1959 | `			/* Surface a callback allocation failure as a fatal */` |
|  33333 | 1960 | `			if( imp_data.rc != SXRET_OK ){` |
...
|      - | 2085 | ` */` |
|   6862 | 2086 | `PH7_PRIVATE int PH7_builtin_explode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2087 | `{` |
...
|   6867 | 2100 | `	zDelim = ph7_value_to_string(apArg[0],&nDelim);` |
|   6867 | 2101 | `	if( nDelim < 1 ){` |
...
|   6863 | 2107 | `	zString = ph7_value_to_string(apArg[1],&nStrlen);` |
|   6863 | 2108 | `	if( nStrlen < 1 ){` |
...
|   6851 | 2134 | `	zEnd = &zString[nStrlen];` |
|      - | 2135 | `	/* Create the array */` |
|   6851 | 2136 | `	pArray =  ph7_context_new_array(pCtx);` |
|   6851 | 2137 | `	pValue = ph7_context_new_scalar(pCtx);` |
|   6851 | 2138 | `	if( pArray == 0 \|\| pValue == 0 ){` |
|      - | 2139 | `		/* Out of memory,return FALSE */` |
|    ! 0 | 2140 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 2141 | `		return PH7_OK;` |
|      - | 2142 | `	}` |
|      - | 2143 | `	/* Set a defualt limit */` |
|   6851 | 2144 | `	iLimit = SXI32_HIGH;` |
|   6851 | 2145 | `	if( nArg > 2 ){` |
...
|  82378 | 2180 | `	for(;;){` |
| 164761 | 2181 | `		rc = SyBlobSearch(zString,(sxu32)(zEnd-zString),zDelim,nDelim,&nOfft);` |
| 164761 | 2182 | `		if( rc != SXRET_OK \|\| iLimit <= (int)ph7_array_count(pArray) ){` |
|      - | 2183 | `			/* Limit reached or no more delimiter; insert the rest (may be empty) and break */` |
|   6835 | 2184 | `			ph7_value_string(pValue, zString, (int)(zEnd - zString));` |
|   6835 | 2185 | `			if( ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue) != SXRET_OK ){` |
|    ! 0 | 2186 | `				return PH7_ContextMemoryError(pCtx);` |
|      - | 2187 | `			}` |
|   6835 | 2188 | `			break;` |
|      - | 2189 | `		}` |
|      - | 2190 | `		/* Point to the desired offset */` |
| 157931 | 2191 | `		zCur = &zString[nOfft];` |
|      - | 2192 | `		/* Perform the store operation (may be empty) */` |
| 157931 | 2193 | `		ph7_value_string(pValue, zString, (int)(zCur - zString));` |
| 157931 | 2194 | `		if( ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue) != SXRET_OK ){` |
|    ! 0 | 2195 | `			return PH7_ContextMemoryError(pCtx);` |
|      - | 2196 | `		}` |
|      - | 2197 | `		/* Point beyond the delimiter */` |
| 157931 | 2198 | `		zString = &zCur[nDelim];` |
|      - | 2199 | `		/* Reset the cursor */` |
| 157931 | 2200 | `		ph7_value_reset_string_cursor(pValue);` |
|      5 | 2201 | `	}` |
|      - | 2202 | `	/* Return the freshly created array */` |
|   6835 | 2203 | `	ph7_result_value(pCtx,pArray);` |
|      - | 2204 | `	/* NOTE that every allocated ph7_value will be automatically` |
|      - | 2205 | `	 * released as soon we return from this foregin function.` |
|      - | 2206 | `	 */` |
|   6835 | 2207 | `	return PH7_OK;` |
|   3436 | 2208 | `}` |
|      - | 2209 | `/*` |
...
|    561 | 2238 | `		ph7_result_string(pCtx,"",0);` |
|    561 | 2239 | `		return PH7_OK;` |
|      - | 2240 | `	}` |
|      - | 2241 | `	/* Start the trim process */` |
|  13711 | 2242 | `	if( nArg < 2 ){` |
|      - | 2243 | `		SyString sStr;` |
|      - | 2244 | `		/* Remove white spaces and NUL bytes */` |
|  13681 | 2245 | `		SyStringInitFromBuf(&sStr,zString,nLen);` |
|  34437 | 2246 | `		SyStringFullTrimSafe(&sStr);` |
|  13681 | 2247 | `		ph7_result_string(pCtx,sStr.zString,(int)sStr.nByte);` |
|   6843 | 2248 | `	}else{` |
|      - | 2249 | `		/* Char list */` |
...
|      - | 2419 | ` */` |
|  33112 | 2420 | `PH7_PRIVATE int PH7_builtin_strtolower(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2421 | `{` |
|  33117 | 2422 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"strtolower",1,"$string"); }` |
|      - | 2423 | `	const char *zString,*zCur,*zEnd;` |
|      - | 2424 | `	int nLen;` |
|  33117 | 2425 | `	if( nArg < 1 ){` |
|      - | 2426 | `		/* Missing arguments,return null */` |
|    ! 0 | 2427 | `		ph7_result_null(pCtx);` |
|    ! 0 | 2428 | `		return PH7_OK;` |
|      - | 2429 | `	}` |
|      - | 2430 | `	/* Extract the target string */` |
|  33117 | 2431 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|  33117 | 2432 | `	if( nLen < 1 ){` |
|      - | 2433 | `		/* Empty string,return */` |
|      3 | 2434 | `		ph7_result_string(pCtx,"",0);` |
|      3 | 2435 | `		return PH7_OK;` |
|      - | 2436 | `	}` |
|      - | 2437 | `	/* Perform the requested operation */` |
|  33115 | 2438 | `	zEnd = &zString[nLen];` |
| 104400 | 2439 | `	for(;;){` |
| 208805 | 2440 | `		if( zString >= zEnd ){` |
|      - | 2441 | `			/* No more input,break immediately */` |
|  33115 | 2442 | `			break;` |
|      - | 2443 | `		}` |
| 175695 | 2444 | `		if( (unsigned char)zString[0] >= 0xc0 ){` |
...
|    ! 0 | 2453 | `		}else{` |
| 175695 | 2454 | `			int c = zString[0];` |
| 175695 | 2455 | `			if( SyisUpper(c) ){` |
| 172683 | 2456 | `				c = SyToLower(zString[0]);` |
|  86339 | 2457 | `			}` |
|      - | 2458 | `			/* Append character */` |
| 175695 | 2459 | `			ph7_result_string(pCtx,(const char *)&c,(int)sizeof(char));` |
|      - | 2460 | `			/* Advance the cursor */` |
| 175695 | 2461 | `			zString++;` |
|      - | 2462 | `		}` |
|      5 | 2463 | `	}` |
|  33115 | 2464 | `	return PH7_OK;` |
|  16561 | 2465 | `}` |
|      - | 2466 | `/*` |
...
|      - | 4688 | ` */` |
|     94 | 4689 | `PH7_PRIVATE int PH7_builtin_str_pad(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 4690 | `{` |
...
|     96 | 4699 | `	zIn = ph7_value_to_string(apArg[0],&iLen);` |
|      - | 4700 | `	/* Padding length */` |
|      - | 4701 | `	{` |
|     96 | 4702 | `		sxi64 iTmp = 0;` |
|     96 | 4703 | `		sxi32 rcArg = PH7_IntArgResolve(pCtx,apArg[1],"str_pad",2,"$length","int",&iTmp);` |
|     96 | 4704 | `		if( rcArg != PH7_OK ){` |
|    ! 0 | 4705 | `			return rcArg;` |
|      - | 4706 | `		}` |
|     96 | 4707 | `		iRealPad = iPadlen = (int)iTmp;` |
|      - | 4708 | `	}` |
|     96 | 4709 | `	if( iPadlen > 0 ){` |
|     94 | 4710 | `		iPadlen -= iLen;` |
|     46 | 4711 | `	}` |
|     96 | 4712 | `	if( iPadlen < 1  ){` |
...
|      - | 4716 | `	}` |
|     92 | 4717 | `	zPad = " "; /* Whitespace padding */` |
|     92 | 4718 | `	iStrpad = (int)sizeof(char);` |
|     92 | 4719 | `	iType = 1 ; /* STR_PAD_RIGHT */` |
|     92 | 4720 | `	if( nArg > 2 ){` |
|      - | 4721 | `		/* Padding string */` |
...
|     90 | 4742 | `	if( iType == 0 /* STR_PAD_LEFT */ \|\| iType == 2 /* STR_PAD_BOTH */ ){` |
|      3 | 4743 | `		jPad = iStrpad;` |
...
|     90 | 4766 | `		if( ph7_result_string(pCtx,zIn,iLen) != SXRET_OK ){ return PH7_ContextMemoryError(pCtx); }` |
|     44 | 4767 | `	}` |
|     90 | 4768 | `	if( iType == 1 /* STR_PAD_RIGHT */ \|\| iType == 2 /* STR_PAD_BOTH */ ){` |
|   1140 | 4769 | `		for( i = 0 ; i < iPadlen/iDiv ; i += iStrpad ){` |
|      - | 4770 | `			/* Padding */` |
|   1140 | 4771 | `			if( (int)ph7_context_result_buf_length(pCtx) + iStrpad >= iRealPad ){` |
|     88 | 4772 | `				break;` |
|      - | 4773 | `			}` |
|   1054 | 4774 | `			if( ph7_result_string(pCtx,zPad,iStrpad) != SXRET_OK ){ return PH7_ContextMemoryError(pCtx); }` |
|    528 | 4775 | `		}` |
|    174 | 4776 | `		while( (int)ph7_context_result_buf_length(pCtx) < iRealPad ){` |
|     88 | 4777 | `			jPad = iRealPad - (int)ph7_context_result_buf_length(pCtx);` |
|     88 | 4778 | `			if( jPad > iStrpad ){` |
|    ! 0 | 4779 | `				jPad = iStrpad;` |
|    ! 0 | 4780 | `			}` |
|     88 | 4781 | `			if( jPad < 1){` |
|    ! 0 | 4782 | `				break;` |
|      - | 4783 | `			}` |
|     88 | 4784 | `			if( ph7_result_string(pCtx,zPad,jPad) != SXRET_OK ){ return PH7_ContextMemoryError(pCtx); }` |
|      2 | 4785 | `		}` |
|     43 | 4786 | `	}` |
|     90 | 4787 | `	return PH7_OK;` |
|     49 | 4788 | `}` |
|      - | 4789 | `/*` |
...
|      - | 4924 | ` */` |
|  30030 | 4925 | `PH7_PRIVATE int PH7_builtin_str_replace(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 4926 | `{` |
...
|      - | 4935 | `	int nByte;` |
|      - | 4936 | `	sxi32 rc;` |
|  30035 | 4937 | `	if( nArg < 3 ){` |
|      - | 4938 | `		/* Missing/Invalid arguments,return null */` |
|    ! 0 | 4939 | `		ph7_result_null(pCtx);` |
|    ! 0 | 4940 | `		return PH7_OK;` |
|      - | 4941 | `	}` |
|      - | 4942 | `	/* Initialize fields */` |
|  30035 | 4943 | `	SySetInit(&sSearch,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  30035 | 4944 | `	SySetInit(&sReplace,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  30035 | 4945 | `	SyBlobInit(&sWorker,&pCtx->pVm->sAllocator);` |
|  30035 | 4946 | `	SyZero(&sRep,sizeof(str_replace_data));` |
|  30035 | 4947 | `	sRep.pCtx = pCtx;` |
|  30035 | 4948 | `	sRep.pCollector = &sSearch;` |
|  30035 | 4949 | `	rep_str = 0;` |
|      - | 4950 | `	/* Extract the subject */` |
|  30035 | 4951 | `	zIn = ph7_value_to_string(apArg[2],&nByte);` |
|  30035 | 4952 | `	if( nByte < 1 ){` |
...
|  30015 | 4958 | `	SyBlobAppend(&sWorker,(const void *)zIn,(sxu32)nByte);` |
|      - | 4959 | `	/* Search string */` |
|  30015 | 4960 | `	if( ph7_value_is_array(apArg[0]) ){` |
|      - | 4961 | `		/* Collect search string */` |
|     93 | 4962 | `		ph7_array_walk(apArg[0],StrReplaceWalker,&sRep);` |
|     49 | 4963 | `	}else{` |
|      - | 4964 | `		/* Single pattern */` |
|  29927 | 4965 | `		zIn = ph7_value_to_string(apArg[0],&nByte);` |
|  29927 | 4966 | `		if( nByte < 1 ){` |
...
|      - | 4970 | `		}` |
|  29921 | 4971 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 4972 | `		/* Save for later processing */` |
|  29921 | 4973 | `		SySetPut(&sSearch,(const void *)&sTemp);` |
|      - | 4974 | `	}` |
|      - | 4975 | `	/* Replace string */` |
|  30009 | 4976 | `	if( ph7_value_is_array(apArg[1]) ){` |
|      - | 4977 | `		/* Collect replace string */` |
|      9 | 4978 | `		sRep.pCollector = &sReplace;` |
|      9 | 4979 | `		ph7_array_walk(apArg[1],StrReplaceWalker,&sRep);` |
|      5 | 4980 | `	}else{` |
|      - | 4981 | `		/* Single needle */` |
|  30001 | 4982 | `		zIn = ph7_value_to_string(apArg[1],&nByte);` |
|  30001 | 4983 | `		rep_str = 1;` |
|  30001 | 4984 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 4985 | `		/* Save for later processing */` |
|  30001 | 4986 | `		SySetPut(&sReplace,(const void *)&sTemp);` |
|      - | 4987 | `	}` |
|      - | 4988 | `	/* Surface a collector allocation failure (StrReplaceWalker) as a fatal */` |
|  30009 | 4989 | `	if( sRep.rc != SXRET_OK ){` |
...
|  30009 | 4996 | `	SySetResetCursor(&sSearch);` |
|  30009 | 4997 | `	SySetResetCursor(&sReplace);` |
|  30009 | 4998 | `	pReplace = pSearch = 0; /* cc warning */` |
|  30009 | 4999 | `	SyStringInitFromBuf(&sTemp,"",0);` |
|      - | 5000 | `	/* Extract function name */` |
|  30009 | 5001 | `	zFunc = ph7_function_name(pCtx);` |
|      - | 5002 | `	/* Set the default pattern match routine */` |
|  30009 | 5003 | `	xMatch = SyBlobSearch;` |
|  30009 | 5004 | `	if( SyStrncmp(zFunc,"str_ireplace",sizeof("str_ireplace") - 1) ==  0 ){` |
|      - | 5005 | `		/* Case insensitive pattern match */` |
|     11 | 5006 | `		xMatch = iPatternMatch;` |
|      5 | 5007 | `	}` |
|      - | 5008 | `	/* Start the replace process */` |
|  60103 | 5009 | `	while( SXRET_OK == SySetGetNextEntry(&sSearch,(void **)&pSearch) ){` |
|      - | 5010 | `		sxu32 nCount,nOfft;` |
|      - | 5011 | `		/* Extract the replace string */` |
|  30099 | 5012 | `		if( rep_str ){` |
|  30081 | 5013 | `			pReplace = (SyString *)SySetPeek(&sReplace);` |
|  15043 | 5014 | `		}else{` |
...
|      1 | 5020 | `			}` |
|      - | 5021 | `		}` |
|  30099 | 5022 | `		if( pReplace == 0 ){` |
|      - | 5023 | `			/* Use an empty string instead */` |
|      3 | 5024 | `			pReplace = &sTemp;` |
|      1 | 5025 | `		}` |
|  30099 | 5026 | `		if( pSearch->nByte <  1 ){` |
...
|      7 | 5031 | `			continue;` |
|      - | 5032 | `		}` |
|  30093 | 5033 | `		nOfft = nCount = 0;` |
|  15088 | 5034 | `		for(;;){` |
|  30181 | 5035 | `			if( nCount >= SyBlobLength(&sWorker) ){` |
|     15 | 5036 | `				break;` |
|      - | 5037 | `			}` |
|      - | 5038 | `			/* Perform a pattern lookup */` |
|  45248 | 5039 | `			rc = xMatch(SyBlobDataAt(&sWorker,nCount),SyBlobLength(&sWorker) - nCount,(const void *)pSearch->zString,` |
|  30162 | 5040 | `				pSearch->nByte,&nOfft);` |
|  30167 | 5041 | `			if( rc != SXRET_OK ){` |
...
|  30009 | 5059 | `	rc = ph7_result_string(pCtx,(const char *)SyBlobData(&sWorker),(int)SyBlobLength(&sWorker));` |
|  30009 | 5060 | `	SySetRelease(&sSearch);` |
|  30009 | 5061 | `	SySetRelease(&sReplace);` |
|  30009 | 5062 | `	SyBlobRelease(&sWorker);` |
|  30009 | 5063 | `	if( rc != PH7_OK ){` |
|    ! 0 | 5064 | `		return PH7_ContextMemoryError(pCtx);` |
|      - | 5065 | `	}` |
|  30009 | 5066 | `	return PH7_OK;` |
|  15020 | 5067 | `}` |
|      - | 5068 | `/*` |
