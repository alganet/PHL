...
|      - |   59 | ` */` |
| 277506 |   60 | `PH7_PRIVATE int PH7_builtin_substr(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |   61 | `{` |
|      - |   62 | `	const char *zSource;` |
|      - |   63 | `	int nSrcLen;` |
|      - |   64 | `	sxi64 iStart,iEnd;` |
| 277511 |   65 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"substr",1,"$string"); }` |
| 277511 |   66 | `	if( nArg < 2 ){` |
...
| 277511 |   72 | `	zSource = ph7_value_to_string(apArg[0],&nSrcLen);` |
|      - |   73 | `	/* Extract the offset */` |
|      - |   74 | `	{` |
| 277511 |   75 | `		sxi64 iTmp = 0;` |
| 277511 |   76 | `		sxi32 rcArg = PH7_IntArgResolve(pCtx,apArg[1],"substr",2,"$offset","int",&iTmp);` |
| 277511 |   77 | `		if( rcArg != PH7_OK ){` |
|    ! 0 |   78 | `			return rcArg;` |
|      - |   79 | `		}` |
| 277511 |   80 | `		iStart = iTmp;` |
|      - |   81 | `	}` |
|      - |   82 | `	/*` |
...
|      - |   91 | `	 */` |
| 277511 |   92 | `	if( iStart < 0 ){` |
|  32949 |   93 | `		iStart += nSrcLen;` |
|  32949 |   94 | `		if( iStart < 0 ){` |
|      5 |   95 | `			iStart = 0;` |
|      7 |   96 | `		}` |
| 261039 |   97 | `	}else if( iStart > nSrcLen ){` |
|      7 |   98 | `		iStart = nSrcLen;` |
|      3 |   99 | `	}` |
| 277511 |  100 | `	iEnd = nSrcLen;` |
| 277511 |  101 | `	if( nArg > 2 && !ph7_value_is_null(apArg[2]) ){` |
| 196665 |  102 | `		sxi64 iLen = 0;` |
| 196665 |  103 | `		sxi32 rcArg = PH7_IntArgResolve(pCtx,apArg[2],"substr",3,"$length","?int",&iLen);` |
| 196665 |  104 | `		if( rcArg != PH7_OK ){` |
|    ! 0 |  105 | `			return rcArg;` |
|      - |  106 | `		}` |
| 196665 |  107 | `		if( iLen < 0 ){` |
|  32581 |  108 | `			iEnd = (sxi64)nSrcLen + iLen;` |
| 180377 |  109 | `		}else if( iLen > (sxi64)nSrcLen - iStart ){` |
|  18409 |  110 | `			iEnd = nSrcLen;` |
|   9207 |  111 | `		}else{` |
| 145685 |  112 | `			iEnd = iStart + iLen;` |
|      - |  113 | `		}` |
|  98330 |  114 | `	}` |
| 277511 |  115 | `	if( iEnd < iStart ){` |
|      3 |  116 | `		iEnd = iStart;` |
|      1 |  117 | `	}` |
| 277511 |  118 | `	ph7_result_string(pCtx,&zSource[iStart],(int)(iEnd - iStart));` |
| 277511 |  119 | `	return PH7_OK;` |
| 138861 |  120 | `}` |
|      - |  121 | `/*` |
...
| 421198 |  319 | `static void StrNullArgNotice(ph7_context *pCtx,ph7_value *pArg,const char *zFunc,int iArgNum,const char *zParamName)` |
|      5 |  320 | `{` |
| 421203 |  321 | `	if( ph7_value_is_null(pArg) ){` |
...
|      - | 1609 | ` */` |
|  92844 | 1610 | `PH7_PRIVATE int PH7_builtin_strlen(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1611 | `{` |
|  92849 | 1612 | `	int iLen = 0;` |
|  92849 | 1613 | `	if( nArg > 0 ){` |
|  92849 | 1614 | `		StrNullArgNotice(pCtx,apArg[0],"strlen",1,"$string");` |
|  92849 | 1615 | `		ph7_value_to_string(apArg[0],&iLen);` |
|  46628 | 1616 | `	}` |
|      - | 1617 | `	/* String length */` |
|  92849 | 1618 | `	ph7_result_int(pCtx,iLen);` |
|  92849 | 1619 | `	return PH7_OK;` |
|      5 | 1620 | `}` |
|      - | 1621 | `/*` |
...
|      - | 1857 | ` */` |
| 155400 | 1858 | `static int implode_callback(ph7_value *pKey,ph7_value *pValue,void *pUserData)` |
|      5 | 1859 | `{` |
|  77700 | 1860 | `	SXUNUSED(pKey);` |
| 155405 | 1861 | `	struct implode_data *pData = (struct implode_data *)pUserData;` |
|      - | 1862 | `	const char *zData;` |
|      - | 1863 | `	int nLen;` |
| 155405 | 1864 | `	if( pData->bRecursive && ph7_value_is_array(pValue) && pData->nRecCount < 32 ){` |
...
| 155403 | 1888 | `	zData = ph7_value_to_string(pValue,&nLen);` |
|      - | 1889 | `	/* Manage separator insertion: always mark first seen; append separator for subsequent items */` |
| 155403 | 1890 | `	if( pData->bFirst ){` |
|  33223 | 1891 | `		pData->bFirst = 0;` |
| 138794 | 1892 | `	}else if( pData->nSeplen > 0 ){` |
|      - | 1893 | `		/* append the separator first */` |
| 122105 | 1894 | `		if( ph7_result_string(pData->pCtx,pData->zSep,pData->nSeplen) != SXRET_OK ){` |
...
| 155403 | 1900 | `	if( nLen > 0 ){` |
| 143159 | 1901 | `		if( ph7_result_string(pData->pCtx,zData,nLen) != SXRET_OK ){` |
|    ! 0 | 1902 | `			pData->rc = SXERR_MEM;` |
|    ! 0 | 1903 | `			return PH7_ABORT;` |
|      - | 1904 | `		}` |
|  71577 | 1905 | `	}` |
| 155403 | 1906 | `	return PH7_OK;` |
|  77705 | 1907 | `}` |
|      - | 1908 | `/*` |
...
|      - | 1920 | ` */` |
|  33284 | 1921 | `PH7_PRIVATE int PH7_builtin_implode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1922 | `{` |
|      - | 1923 | `	struct implode_data imp_data;` |
|  33289 | 1924 | `	int i = 1;` |
|  33289 | 1925 | `	if( nArg < 1 ){` |
|      - | 1926 | `		/* Missing argument,return NULL */` |
|    ! 0 | 1927 | `		ph7_result_null(pCtx);` |
|    ! 0 | 1928 | `		return PH7_OK;` |
|      - | 1929 | `	}` |
|      - | 1930 | `	/* Prepare the implode context */` |
|  33289 | 1931 | `	imp_data.pCtx = pCtx;` |
|  33289 | 1932 | `	imp_data.bRecursive = 0;` |
|  33289 | 1933 | `	imp_data.bFirst = 1;` |
|  33289 | 1934 | `	imp_data.nRecCount = 0;` |
|  33289 | 1935 | `	imp_data.rc = SXRET_OK;` |
|  33289 | 1936 | `	if( !ph7_value_is_array(apArg[0]) ){` |
|  33287 | 1937 | `		imp_data.zSep = ph7_value_to_string(apArg[0],&imp_data.nSeplen);` |
|  33287 | 1938 | `		if( nArg > 1 && !ph7_value_is_array(apArg[1]) && !ph7_value_is_null(apArg[1]) ){` |
...
|      3 | 1949 | `		i = 0;` |
|      - | 1950 | `	}` |
|  33287 | 1951 | `	if( ph7_result_string(pCtx,"",0) != SXRET_OK ){ /* Set an empty stirng */` |
|    ! 0 | 1952 | `		return PH7_ContextMemoryError(pCtx);` |
|      - | 1953 | `	}` |
|      - | 1954 | `	/* Start the 'join' process */` |
|  66569 | 1955 | `	while( i < nArg ){` |
|  33287 | 1956 | `		if( ph7_value_is_array(apArg[i]) ){` |
|      - | 1957 | `			/* Iterate throw array entries */` |
|  33287 | 1958 | `			ph7_array_walk(apArg[i],implode_callback,&imp_data);` |
|      - | 1959 | `			/* Surface a callback allocation failure as a fatal */` |
|  33287 | 1960 | `			if( imp_data.rc != SXRET_OK ){` |
...
|  82248 | 2180 | `	for(;;){` |
| 164501 | 2181 | `		rc = SyBlobSearch(zString,(sxu32)(zEnd-zString),zDelim,nDelim,&nOfft);` |
| 164501 | 2182 | `		if( rc != SXRET_OK \|\| iLimit <= (int)ph7_array_count(pArray) ){` |
...
| 157681 | 2191 | `		zCur = &zString[nOfft];` |
|      - | 2192 | `		/* Perform the store operation (may be empty) */` |
| 157681 | 2193 | `		ph7_value_string(pValue, zString, (int)(zCur - zString));` |
| 157681 | 2194 | `		if( ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue) != SXRET_OK ){` |
|    ! 0 | 2195 | `			return PH7_ContextMemoryError(pCtx);` |
|      - | 2196 | `		}` |
|      - | 2197 | `		/* Point beyond the delimiter */` |
| 157681 | 2198 | `		zString = &zCur[nDelim];` |
|      - | 2199 | `		/* Reset the cursor */` |
| 157681 | 2200 | `		ph7_value_reset_string_cursor(pValue);` |
|      5 | 2201 | `	}` |
...
|    605 | 2238 | `		ph7_result_string(pCtx,"",0);` |
|    605 | 2239 | `		return PH7_OK;` |
|      - | 2240 | `	}` |
...
| 104399 | 2439 | `	for(;;){` |
| 208803 | 2440 | `		if( zString >= zEnd ){` |
|      - | 2441 | `			/* No more input,break immediately */` |
|  33107 | 2442 | `			break;` |
|      - | 2443 | `		}` |
| 175701 | 2444 | `		if( (unsigned char)zString[0] >= 0xc0 ){` |
...
|    ! 0 | 2453 | `		}else{` |
| 175701 | 2454 | `			int c = zString[0];` |
| 175701 | 2455 | `			if( SyisUpper(c) ){` |
| 172689 | 2456 | `				c = SyToLower(zString[0]);` |
|  86342 | 2457 | `			}` |
|      - | 2458 | `			/* Append character */` |
| 175701 | 2459 | `			ph7_result_string(pCtx,(const char *)&c,(int)sizeof(char));` |
