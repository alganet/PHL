...
|      - |   59 | ` */` |
| 279473 |   60 | `PH7_PRIVATE int PH7_builtin_substr(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |   61 | `{` |
|      - |   62 | `	const char *zSource;` |
|      - |   63 | `	int nSrcLen;` |
|      - |   64 | `	sxi64 iStart,iEnd;` |
| 279478 |   65 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"substr",1,"$string"); }` |
| 279478 |   66 | `	if( nArg < 2 ){` |
...
| 279478 |   72 | `	zSource = ph7_value_to_string(apArg[0],&nSrcLen);` |
|      - |   73 | `	/* Extract the offset */` |
|      - |   74 | `	{` |
| 279478 |   75 | `		sxi64 iTmp = 0;` |
| 279478 |   76 | `		sxi32 rcArg = PH7_IntArgResolve(pCtx,apArg[1],"substr",2,"$offset","int",&iTmp);` |
| 279478 |   77 | `		if( rcArg != PH7_OK ){` |
|    ! 0 |   78 | `			return rcArg;` |
|      - |   79 | `		}` |
| 279478 |   80 | `		iStart = iTmp;` |
|      - |   81 | `	}` |
|      - |   82 | `	/*` |
...
|      - |   91 | `	 */` |
| 279478 |   92 | `	if( iStart < 0 ){` |
|  32985 |   93 | `		iStart += nSrcLen;` |
|  32985 |   94 | `		if( iStart < 0 ){` |
|      5 |   95 | `			iStart = 0;` |
|      7 |   96 | `		}` |
| 262988 |   97 | `	}else if( iStart > nSrcLen ){` |
|      7 |   98 | `		iStart = nSrcLen;` |
|      3 |   99 | `	}` |
| 279478 |  100 | `	iEnd = nSrcLen;` |
| 279478 |  101 | `	if( nArg > 2 && !ph7_value_is_null(apArg[2]) ){` |
| 197941 |  102 | `		sxi64 iLen = 0;` |
| 197941 |  103 | `		sxi32 rcArg = PH7_IntArgResolve(pCtx,apArg[2],"substr",3,"$length","?int",&iLen);` |
| 197941 |  104 | `		if( rcArg != PH7_OK ){` |
|    ! 0 |  105 | `			return rcArg;` |
|      - |  106 | `		}` |
| 197941 |  107 | `		if( iLen < 0 ){` |
|  32617 |  108 | `			iEnd = (sxi64)nSrcLen + iLen;` |
| 181635 |  109 | `		}else if( iLen > (sxi64)nSrcLen - iStart ){` |
|  18395 |  110 | `			iEnd = nSrcLen;` |
|   9200 |  111 | `		}else{` |
| 146939 |  112 | `			iEnd = iStart + iLen;` |
|      - |  113 | `		}` |
|  98968 |  114 | `	}` |
| 279478 |  115 | `	if( iEnd < iStart ){` |
|      3 |  116 | `		iEnd = iStart;` |
|      1 |  117 | `	}` |
| 279478 |  118 | `	ph7_result_string(pCtx,&zSource[iStart],(int)(iEnd - iStart));` |
| 279478 |  119 | `	return PH7_OK;` |
| 139845 |  120 | `}` |
|      - |  121 | `/*` |
...
| 424351 |  319 | `static void StrNullArgNotice(ph7_context *pCtx,ph7_value *pArg,const char *zFunc,int iArgNum,const char *zParamName)` |
|      5 |  320 | `{` |
| 424356 |  321 | `	if( ph7_value_is_null(pArg) ){` |
...
|      - | 1609 | ` */` |
|  94014 | 1610 | `PH7_PRIVATE int PH7_builtin_strlen(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1611 | `{` |
|  94019 | 1612 | `	int iLen = 0;` |
|  94019 | 1613 | `	if( nArg > 0 ){` |
|  94019 | 1614 | `		StrNullArgNotice(pCtx,apArg[0],"strlen",1,"$string");` |
|  94019 | 1615 | `		ph7_value_to_string(apArg[0],&iLen);` |
|  47214 | 1616 | `	}` |
|      - | 1617 | `	/* String length */` |
|  94019 | 1618 | `	ph7_result_int(pCtx,iLen);` |
|  94019 | 1619 | `	return PH7_OK;` |
|      5 | 1620 | `}` |
|      - | 1621 | `/*` |
...
|      - | 1857 | ` */` |
| 156678 | 1858 | `static int implode_callback(ph7_value *pKey,ph7_value *pValue,void *pUserData)` |
|      5 | 1859 | `{` |
|  78339 | 1860 | `	SXUNUSED(pKey);` |
| 156683 | 1861 | `	struct implode_data *pData = (struct implode_data *)pUserData;` |
|      - | 1862 | `	const char *zData;` |
|      - | 1863 | `	int nLen;` |
| 156683 | 1864 | `	if( pData->bRecursive && ph7_value_is_array(pValue) && pData->nRecCount < 32 ){` |
...
| 156681 | 1888 | `	zData = ph7_value_to_string(pValue,&nLen);` |
|      - | 1889 | `	/* Manage separator insertion: always mark first seen; append separator for subsequent items */` |
| 156681 | 1890 | `	if( pData->bFirst ){` |
|  33297 | 1891 | `		pData->bFirst = 0;` |
| 140035 | 1892 | `	}else if( pData->nSeplen > 0 ){` |
|      - | 1893 | `		/* append the separator first */` |
| 123309 | 1894 | `		if( ph7_result_string(pData->pCtx,pData->zSep,pData->nSeplen) != SXRET_OK ){` |
...
| 156681 | 1900 | `	if( nLen > 0 ){` |
| 144485 | 1901 | `		if( ph7_result_string(pData->pCtx,zData,nLen) != SXRET_OK ){` |
|    ! 0 | 1902 | `			pData->rc = SXERR_MEM;` |
|    ! 0 | 1903 | `			return PH7_ABORT;` |
|      - | 1904 | `		}` |
|  72240 | 1905 | `	}` |
| 156681 | 1906 | `	return PH7_OK;` |
|  78344 | 1907 | `}` |
|      - | 1908 | `/*` |
...
|  82868 | 2180 | `	for(;;){` |
| 165741 | 2181 | `		rc = SyBlobSearch(zString,(sxu32)(zEnd-zString),zDelim,nDelim,&nOfft);` |
| 165741 | 2182 | `		if( rc != SXRET_OK \|\| iLimit <= (int)ph7_array_count(pArray) ){` |
...
| 158897 | 2191 | `		zCur = &zString[nOfft];` |
|      - | 2192 | `		/* Perform the store operation (may be empty) */` |
| 158897 | 2193 | `		ph7_value_string(pValue, zString, (int)(zCur - zString));` |
| 158897 | 2194 | `		if( ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue) != SXRET_OK ){` |
|    ! 0 | 2195 | `			return PH7_ContextMemoryError(pCtx);` |
|      - | 2196 | `		}` |
|      - | 2197 | `		/* Point beyond the delimiter */` |
| 158897 | 2198 | `		zString = &zCur[nDelim];` |
|      - | 2199 | `		/* Reset the cursor */` |
| 158897 | 2200 | `		ph7_value_reset_string_cursor(pValue);` |
|      5 | 2201 | `	}` |
...
|      - | 2223 | ` */` |
|  14238 | 2224 | `PH7_PRIVATE int PH7_builtin_trim(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2225 | `{` |
|  14243 | 2226 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"trim",1,"$string"); }` |
|      - | 2227 | `	const char *zString;` |
|      - | 2228 | `	int nLen;` |
|  14243 | 2229 | `	if( nArg < 1 ){` |
|      - | 2230 | `		/* Missing arguments,return null */` |
|    ! 0 | 2231 | `		ph7_result_null(pCtx);` |
|    ! 0 | 2232 | `		return PH7_OK;` |
|      - | 2233 | `	}` |
|      - | 2234 | `	/* Extract the target string */` |
|  14243 | 2235 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|  14243 | 2236 | `	if( nLen < 1 ){` |
|      - | 2237 | `		/* Empty string,return */` |
|    507 | 2238 | `		ph7_result_string(pCtx,"",0);` |
|    507 | 2239 | `		return PH7_OK;` |
|      - | 2240 | `	}` |
...
|  34517 | 2246 | `		SyStringFullTrimSafe(&sStr);` |
...
|      - | 4867 | ` */` |
|    190 | 4868 | `static int StrReplaceWalker(ph7_value *pKey,ph7_value *pData,void *pUserData)` |
|      5 | 4869 | `{` |
|    195 | 4870 | `	str_replace_data *pRep = (str_replace_data *)pUserData;` |
|      - | 4871 | `	SyString sWorker;` |
|      - | 4872 | `	const char *zIn;` |
|      - | 4873 | `	int nByte;` |
|      - | 4874 | `	/* Extract a string representation of the given argument */` |
|    195 | 4875 | `	zIn = ph7_value_to_string(pData,&nByte);` |
|    195 | 4876 | `	SyStringInitFromBuf(&sWorker,0,0);` |
|    195 | 4877 | `	if( nByte > 0 ){` |
|      - | 4878 | `		char *zDup;` |
|      - | 4879 | `		/* Duplicate the chunk */` |
|    189 | 4880 | `		zDup = (char *)ph7_context_alloc_chunk(pRep->pCtx,(unsigned int)nByte,FALSE,` |
...
|      - | 4888 | `		}` |
|    189 | 4889 | `		SyMemcpy(zIn,zDup,(sxu32)nByte);` |
|      - | 4890 | `		/* Save the chunk */` |
|    189 | 4891 | `		SyStringInitFromBuf(&sWorker,zDup,nByte);` |
|     92 | 4892 | `	}` |
|      - | 4893 | `	/* Save for later processing */` |
|    195 | 4894 | `	SySetPut(pRep->pCollector,(const void *)&sWorker);` |
|      - | 4895 | `	/* All done */` |
|     95 | 4896 | `	SXUNUSED(pKey); /* cc warning */` |
|    195 | 4897 | `	return PH7_OK;` |
|    100 | 4898 | `}` |
|      - | 4899 | `/*` |
...
|      - | 4924 | ` */` |
|  30102 | 4925 | `PH7_PRIVATE int PH7_builtin_str_replace(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 4926 | `{` |
...
|      - | 4935 | `	int nByte;` |
|      - | 4936 | `	sxi32 rc;` |
|  30107 | 4937 | `	if( nArg < 3 ){` |
|      - | 4938 | `		/* Missing/Invalid arguments,return null */` |
|    ! 0 | 4939 | `		ph7_result_null(pCtx);` |
|    ! 0 | 4940 | `		return PH7_OK;` |
|      - | 4941 | `	}` |
|      - | 4942 | `	/* Initialize fields */` |
|  30107 | 4943 | `	SySetInit(&sSearch,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  30107 | 4944 | `	SySetInit(&sReplace,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  30107 | 4945 | `	SyBlobInit(&sWorker,&pCtx->pVm->sAllocator);` |
|  30107 | 4946 | `	SyZero(&sRep,sizeof(str_replace_data));` |
|  30107 | 4947 | `	sRep.pCtx = pCtx;` |
|  30107 | 4948 | `	sRep.pCollector = &sSearch;` |
|  30107 | 4949 | `	rep_str = 0;` |
|      - | 4950 | `	/* Extract the subject */` |
|  30107 | 4951 | `	zIn = ph7_value_to_string(apArg[2],&nByte);` |
|  30107 | 4952 | `	if( nByte < 1 ){` |
...
|  30087 | 4958 | `	SyBlobAppend(&sWorker,(const void *)zIn,(sxu32)nByte);` |
|      - | 4959 | `	/* Search string */` |
|  30087 | 4960 | `	if( ph7_value_is_array(apArg[0]) ){` |
|      - | 4961 | `		/* Collect search string */` |
|     91 | 4962 | `		ph7_array_walk(apArg[0],StrReplaceWalker,&sRep);` |
|     48 | 4963 | `	}else{` |
|      - | 4964 | `		/* Single pattern */` |
|  30001 | 4965 | `		zIn = ph7_value_to_string(apArg[0],&nByte);` |
|  30001 | 4966 | `		if( nByte < 1 ){` |
...
|      - | 4970 | `		}` |
|  29995 | 4971 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 4972 | `		/* Save for later processing */` |
|  29995 | 4973 | `		SySetPut(&sSearch,(const void *)&sTemp);` |
|      - | 4974 | `	}` |
|      - | 4975 | `	/* Replace string */` |
|  30081 | 4976 | `	if( ph7_value_is_array(apArg[1]) ){` |
|      - | 4977 | `		/* Collect replace string */` |
|      9 | 4978 | `		sRep.pCollector = &sReplace;` |
|      9 | 4979 | `		ph7_array_walk(apArg[1],StrReplaceWalker,&sRep);` |
|      5 | 4980 | `	}else{` |
|      - | 4981 | `		/* Single needle */` |
|  30073 | 4982 | `		zIn = ph7_value_to_string(apArg[1],&nByte);` |
|  30073 | 4983 | `		rep_str = 1;` |
|  30073 | 4984 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 4985 | `		/* Save for later processing */` |
|  30073 | 4986 | `		SySetPut(&sReplace,(const void *)&sTemp);` |
|      - | 4987 | `	}` |
|      - | 4988 | `	/* Surface a collector allocation failure (StrReplaceWalker) as a fatal */` |
|  30081 | 4989 | `	if( sRep.rc != SXRET_OK ){` |
...
|  30081 | 4996 | `	SySetResetCursor(&sSearch);` |
|  30081 | 4997 | `	SySetResetCursor(&sReplace);` |
|  30081 | 4998 | `	pReplace = pSearch = 0; /* cc warning */` |
|  30081 | 4999 | `	SyStringInitFromBuf(&sTemp,"",0);` |
|      - | 5000 | `	/* Extract function name */` |
|  30081 | 5001 | `	zFunc = ph7_function_name(pCtx);` |
|      - | 5002 | `	/* Set the default pattern match routine */` |
|  30081 | 5003 | `	xMatch = SyBlobSearch;` |
|  30081 | 5004 | `	if( SyStrncmp(zFunc,"str_ireplace",sizeof("str_ireplace") - 1) ==  0 ){` |
|      - | 5005 | `		/* Case insensitive pattern match */` |
|     11 | 5006 | `		xMatch = iPatternMatch;` |
|      5 | 5007 | `	}` |
|      - | 5008 | `	/* Start the replace process */` |
|  60245 | 5009 | `	while( SXRET_OK == SySetGetNextEntry(&sSearch,(void **)&pSearch) ){` |
|      - | 5010 | `		sxu32 nCount,nOfft;` |
|      - | 5011 | `		/* Extract the replace string */` |
|  30169 | 5012 | `		if( rep_str ){` |
|  30151 | 5013 | `			pReplace = (SyString *)SySetPeek(&sReplace);` |
|  15078 | 5014 | `		}else{` |
...
|      1 | 5020 | `			}` |
|      - | 5021 | `		}` |
|  30169 | 5022 | `		if( pReplace == 0 ){` |
|      - | 5023 | `			/* Use an empty string instead */` |
|      3 | 5024 | `			pReplace = &sTemp;` |
|      1 | 5025 | `		}` |
|  30169 | 5026 | `		if( pSearch->nByte <  1 ){` |
...
|      7 | 5031 | `			continue;` |
|      - | 5032 | `		}` |
|  30163 | 5033 | `		nOfft = nCount = 0;` |
|  15123 | 5034 | `		for(;;){` |
|  30251 | 5035 | `			if( nCount >= SyBlobLength(&sWorker) ){` |
|     15 | 5036 | `				break;` |
|      - | 5037 | `			}` |
|      - | 5038 | `			/* Perform a pattern lookup */` |
|  45353 | 5039 | `			rc = xMatch(SyBlobDataAt(&sWorker,nCount),SyBlobLength(&sWorker) - nCount,(const void *)pSearch->zString,` |
|  30232 | 5040 | `				pSearch->nByte,&nOfft);` |
|  30237 | 5041 | `			if( rc != SXRET_OK ){` |
...
|  30081 | 5059 | `	rc = ph7_result_string(pCtx,(const char *)SyBlobData(&sWorker),(int)SyBlobLength(&sWorker));` |
|  30081 | 5060 | `	SySetRelease(&sSearch);` |
|  30081 | 5061 | `	SySetRelease(&sReplace);` |
|  30081 | 5062 | `	SyBlobRelease(&sWorker);` |
|  30081 | 5063 | `	if( rc != PH7_OK ){` |
|    ! 0 | 5064 | `		return PH7_ContextMemoryError(pCtx);` |
|      - | 5065 | `	}` |
|  30081 | 5066 | `	return PH7_OK;` |
|  15056 | 5067 | `}` |
|      - | 5068 | `/*` |
