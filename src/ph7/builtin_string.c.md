...
|      - |   59 | ` */` |
| 276441 |   60 | `PH7_PRIVATE int PH7_builtin_substr(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |   61 | `{` |
|      - |   62 | `	const char *zSource;` |
|      - |   63 | `	int nSrcLen;` |
|      - |   64 | `	sxi64 iStart,iEnd;` |
| 276446 |   65 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"substr",1,"$string"); }` |
| 276446 |   66 | `	if( nArg < 2 ){` |
...
| 276446 |   72 | `	zSource = ph7_value_to_string(apArg[0],&nSrcLen);` |
|      - |   73 | `	/* Extract the offset */` |
|      - |   74 | `	{` |
| 276446 |   75 | `		sxi64 iTmp = 0;` |
| 276446 |   76 | `		sxi32 rcArg = PH7_IntArgResolve(pCtx,apArg[1],"substr",2,"$offset","int",&iTmp);` |
| 276446 |   77 | `		if( rcArg != PH7_OK ){` |
|    ! 0 |   78 | `			return rcArg;` |
|      - |   79 | `		}` |
| 276446 |   80 | `		iStart = iTmp;` |
|      - |   81 | `	}` |
|      - |   82 | `	/*` |
...
|      - |   91 | `	 */` |
| 276446 |   92 | `	if( iStart < 0 ){` |
|  32921 |   93 | `		iStart += nSrcLen;` |
|  32921 |   94 | `		if( iStart < 0 ){` |
|      5 |   95 | `			iStart = 0;` |
|      7 |   96 | `		}` |
| 259988 |   97 | `	}else if( iStart > nSrcLen ){` |
|      7 |   98 | `		iStart = nSrcLen;` |
|      3 |   99 | `	}` |
| 276446 |  100 | `	iEnd = nSrcLen;` |
| 276446 |  101 | `	if( nArg > 2 && !ph7_value_is_null(apArg[2]) ){` |
| 196149 |  102 | `		sxi64 iLen = 0;` |
| 196149 |  103 | `		sxi32 rcArg = PH7_IntArgResolve(pCtx,apArg[2],"substr",3,"$length","?int",&iLen);` |
| 196149 |  104 | `		if( rcArg != PH7_OK ){` |
|    ! 0 |  105 | `			return rcArg;` |
|      - |  106 | `		}` |
| 196149 |  107 | `		if( iLen < 0 ){` |
|  32553 |  108 | `			iEnd = (sxi64)nSrcLen + iLen;` |
| 179875 |  109 | `		}else if( iLen > (sxi64)nSrcLen - iStart ){` |
|  18399 |  110 | `			iEnd = nSrcLen;` |
|   9202 |  111 | `		}else{` |
| 145207 |  112 | `			iEnd = iStart + iLen;` |
|      - |  113 | `		}` |
|  98072 |  114 | `	}` |
| 276446 |  115 | `	if( iEnd < iStart ){` |
|      3 |  116 | `		iEnd = iStart;` |
|      1 |  117 | `	}` |
| 276446 |  118 | `	ph7_result_string(pCtx,&zSource[iStart],(int)(iEnd - iStart));` |
| 276446 |  119 | `	return PH7_OK;` |
| 138327 |  120 | `}` |
|      - |  121 | `/*` |
...
| 419109 |  319 | `static void StrNullArgNotice(ph7_context *pCtx,ph7_value *pArg,const char *zFunc,int iArgNum,const char *zParamName)` |
|      5 |  320 | `{` |
| 419114 |  321 | `	if( ph7_value_is_null(pArg) ){` |
...
|      - | 1605 | ` */` |
|  91850 | 1606 | `PH7_PRIVATE int PH7_builtin_strlen(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1607 | `{` |
|  91855 | 1608 | `	int iLen = 0;` |
|  91855 | 1609 | `	if( nArg > 0 ){` |
|  91855 | 1610 | `		StrNullArgNotice(pCtx,apArg[0],"strlen",1,"$string");` |
|  91855 | 1611 | `		ph7_value_to_string(apArg[0],&iLen);` |
|  46128 | 1612 | `	}` |
|      - | 1613 | `	/* String length */` |
|  91855 | 1614 | `	ph7_result_int(pCtx,iLen);` |
|  91855 | 1615 | `	return PH7_OK;` |
|      5 | 1616 | `}` |
|      - | 1617 | `/*` |
...
|      - | 1853 | ` */` |
| 154874 | 1854 | `static int implode_callback(ph7_value *pKey,ph7_value *pValue,void *pUserData)` |
|      5 | 1855 | `{` |
|  77437 | 1856 | `	SXUNUSED(pKey);` |
| 154879 | 1857 | `	struct implode_data *pData = (struct implode_data *)pUserData;` |
|      - | 1858 | `	const char *zData;` |
|      - | 1859 | `	int nLen;` |
| 154879 | 1860 | `	if( pData->bRecursive && ph7_value_is_array(pValue) && pData->nRecCount < 32 ){` |
...
| 154877 | 1884 | `	zData = ph7_value_to_string(pValue,&nLen);` |
|      - | 1885 | `	/* Manage separator insertion: always mark first seen; append separator for subsequent items */` |
| 154877 | 1886 | `	if( pData->bFirst ){` |
|  33171 | 1887 | `		pData->bFirst = 0;` |
| 138294 | 1888 | `	}else if( pData->nSeplen > 0 ){` |
|      - | 1889 | `		/* append the separator first */` |
| 121631 | 1890 | `		if( ph7_result_string(pData->pCtx,pData->zSep,pData->nSeplen) != SXRET_OK ){` |
...
| 154877 | 1896 | `	if( nLen > 0 ){` |
| 142641 | 1897 | `		if( ph7_result_string(pData->pCtx,zData,nLen) != SXRET_OK ){` |
|    ! 0 | 1898 | `			pData->rc = SXERR_MEM;` |
|    ! 0 | 1899 | `			return PH7_ABORT;` |
|      - | 1900 | `		}` |
|  71318 | 1901 | `	}` |
| 154877 | 1902 | `	return PH7_OK;` |
|  77442 | 1903 | `}` |
|      - | 1904 | `/*` |
...
|  82004 | 2176 | `	for(;;){` |
| 164013 | 2177 | `		rc = SyBlobSearch(zString,(sxu32)(zEnd-zString),zDelim,nDelim,&nOfft);` |
| 164013 | 2178 | `		if( rc != SXRET_OK \|\| iLimit <= (int)ph7_array_count(pArray) ){` |
...
| 157207 | 2187 | `		zCur = &zString[nOfft];` |
|      - | 2188 | `		/* Perform the store operation (may be empty) */` |
| 157207 | 2189 | `		ph7_value_string(pValue, zString, (int)(zCur - zString));` |
| 157207 | 2190 | `		if( ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue) != SXRET_OK ){` |
|    ! 0 | 2191 | `			return PH7_ContextMemoryError(pCtx);` |
|      - | 2192 | `		}` |
|      - | 2193 | `		/* Point beyond the delimiter */` |
| 157207 | 2194 | `		zString = &zCur[nDelim];` |
|      - | 2195 | `		/* Reset the cursor */` |
| 157207 | 2196 | `		ph7_value_reset_string_cursor(pValue);` |
|      5 | 2197 | `	}` |
...
|  34297 | 2242 | `		SyStringFullTrimSafe(&sStr);` |
...
| 104244 | 2435 | `	for(;;){` |
| 208493 | 2436 | `		if( zString >= zEnd ){` |
|      - | 2437 | `			/* No more input,break immediately */` |
|  33079 | 2438 | `			break;` |
|      - | 2439 | `		}` |
| 175419 | 2440 | `		if( (unsigned char)zString[0] >= 0xc0 ){` |
...
|    ! 0 | 2449 | `		}else{` |
| 175419 | 2450 | `			int c = zString[0];` |
| 175419 | 2451 | `			if( SyisUpper(c) ){` |
| 172407 | 2452 | `				c = SyToLower(zString[0]);` |
|  86201 | 2453 | `			}` |
|      - | 2454 | `			/* Append character */` |
| 175419 | 2455 | `			ph7_result_string(pCtx,(const char *)&c,(int)sizeof(char));` |
...
|      3 | 2472 | `{` |
|     77 | 2473 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"strtoupper",1,"$string"); }` |
...
|     77 | 2482 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|     77 | 2483 | `	if( nLen < 1 ){` |
...
|     73 | 2489 | `	zEnd = &zString[nLen];` |
|    146 | 2490 | `	for(;;){` |
|    295 | 2491 | `		if( zString >= zEnd ){` |
|      - | 2492 | `			/* No more input,break immediately */` |
|     73 | 2493 | `			break;` |
|      - | 2494 | `		}` |
|    225 | 2495 | `		if( (unsigned char)zString[0] >= 0xc0 ){` |
...
|    ! 0 | 2504 | `		}else{` |
|    225 | 2505 | `			int c = zString[0];` |
|    225 | 2506 | `			if( SyisLower(c) ){` |
|    209 | 2507 | `				c = SyToUpper(zString[0]);` |
|    103 | 2508 | `			}` |
|      - | 2509 | `			/* Append character */` |
|    225 | 2510 | `			ph7_result_string(pCtx,(const char *)&c,(int)sizeof(char));` |
|      - | 2511 | `			/* Advance the cursor */` |
|    225 | 2512 | `			zString++;` |
|      - | 2513 | `		}` |
|      3 | 2514 | `	}` |
|     73 | 2515 | `	return PH7_OK;` |
|     40 | 2516 | `}` |
|      - | 2517 | `/*` |
...
|     46 | 4922 | `	}else{` |
|      - | 4923 | `		/* Single pattern */` |
|  29819 | 4924 | `		zIn = ph7_value_to_string(apArg[0],&nByte);` |
|  29819 | 4925 | `		if( nByte < 1 ){` |
...
|      - | 4929 | `		}` |
|  29815 | 4930 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 4931 | `		/* Save for later processing */` |
|  29815 | 4932 | `		SySetPut(&sSearch,(const void *)&sTemp);` |
|      - | 4933 | `	}` |
|      - | 4934 | `	/* Replace string */` |
...
|  59871 | 4968 | `	while( SXRET_OK == SySetGetNextEntry(&sSearch,(void **)&pSearch) ){` |
|      - | 4969 | `		sxu32 nCount,nOfft;` |
|  29979 | 4970 | `		if( pSearch->nByte <  1 ){` |
|      - | 4971 | `			/* Empty string,ignore */` |
|      3 | 4972 | `			continue;` |
|      - | 4973 | `		}` |
|      - | 4974 | `		/* Extract the replace string */` |
|  29977 | 4975 | `		if( rep_str ){` |
|  29967 | 4976 | `			pReplace = (SyString *)SySetPeek(&sReplace);` |
|  14986 | 4977 | `		}else{` |
...
|      1 | 4983 | `			}` |
|      - | 4984 | `		}` |
|  29977 | 4985 | `		if( pReplace == 0 ){` |
|      - | 4986 | `			/* Use an empty string instead */` |
|      3 | 4987 | `			pReplace = &sTemp;` |
|      1 | 4988 | `		}` |
|  29977 | 4989 | `		nOfft = nCount = 0;` |
|  15012 | 4990 | `		for(;;){` |
|  30029 | 4991 | `			if( nCount >= SyBlobLength(&sWorker) ){` |
|     13 | 4992 | `				break;` |
|      - | 4993 | `			}` |
|      - | 4994 | `			/* Perform a pattern lookup */` |
|  45023 | 4995 | `			rc = xMatch(SyBlobDataAt(&sWorker,nCount),SyBlobLength(&sWorker) - nCount,(const void *)pSearch->zString,` |
|  30012 | 4996 | `				pSearch->nByte,&nOfft);` |
|  30017 | 4997 | `			if( rc != SXRET_OK ){` |
