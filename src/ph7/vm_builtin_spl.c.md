...
|    - |  743 | `;` |
|    - |  744 |  |
| 3904 |  745 | `PH7_PRIVATE sxi32 PH7_VmInstallSpl(ph7_vm *pVm)` |
|    5 |  746 | `{` |
| 3909 |  747 | `	ph7_create_function(&(*pVm),"__spl_deprecated",vm_builtin_spl_deprecated,0);` |
| 3909 |  748 | `	return PH7_VmEvalBuiltinChunk(&(*pVm),zSplLib,sizeof(zSplLib)-1);` |
|    5 |  749 | `}` |
|    - |  750 |  |
