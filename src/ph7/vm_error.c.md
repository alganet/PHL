...
|      - |   23 | ` */` |
|  19728 |   24 | `static void VmRecordLastError(ph7_vm *pVm,sxi32 iErr,const char *zMsg,sxu32 nMsg,SyString *pFile)` |
|      5 |   25 | `{` |
|  19733 |   26 | `	pVm->nLastErrType = iErr;` |
|  19733 |   27 | `	pVm->nLastErrLine = pVm->nCurLine ? pVm->nCurLine : 1;` |
|  19733 |   28 | `	SyBlobReset(&pVm->sLastErrMsg);` |
|  19733 |   29 | `	if( zMsg && nMsg > 0 ){` |
|  19733 |   30 | `		SyBlobAppend(&pVm->sLastErrMsg,zMsg,nMsg);` |
|   9864 |   31 | `	}` |
|  19733 |   32 | `	SyBlobReset(&pVm->sLastErrFile);` |
|  19733 |   33 | `	if( pFile ){` |
|  19733 |   34 | `		SyBlobAppend(&pVm->sLastErrFile,pFile->zString,pFile->nByte);` |
|   9864 |   35 | `	}` |
|  19733 |   36 | `}` |
...
|      - |   55 | ` * information.` |
|      - |   56 | ` */` |
|  19866 |   57 | `static sxi32 VmInvokeErrorHandler(ph7_vm *pVm, sxi32 iErr, const char *zMessage, sxi32 nLen, SyString *pFile, sxi32 iLine)` |
|      5 |   58 | `{` |
|  19871 |   59 | `	if( ph7_value_is_callable(&pVm->aErrCB[1]) ){` |
...
|      - |  132 | ` */` |
|  19728 |  133 | `static int VmErrReportWants(ph7_vm *pVm,sxi32 iErr)` |
|      5 |  134 | `{` |
|      - |  135 | `	sxi32 iBit;` |
|  19733 |  136 | `	if( !pVm->bErrReport ){` |
|   3532 |  137 | `		return 0;` |
|      - |  138 | `	}` |
|  16203 |  139 | `	switch( iErr ){` |
|   8078 |  140 | `	case PH7_CTX_WARNING:            /* == 2 == E_WARNING */` |
|  16161 |  141 | `		iBit = 2; break;` |
...
|     26 |  157 | `		break;` |
|      - |  158 | `	}` |
|  16203 |  159 | `	return (pVm->iErrMask & iBit) != 0;` |
|   9869 |  160 | `}` |
|  19866 |  161 | `static const char * VmDiagnosticLabel(sxi32 iErr)` |
|      5 |  162 | `{` |
|  19871 |  163 | `	switch(iErr){` |
|   9896 |  164 | `	case PH7_CTX_WARNING:          /* == 2 == E_WARNING */` |
|      - |  165 | `	case 512  /* E_USER_WARNING */:` |
|  19797 |  166 | `		return "Warning";` |
...
|      - |  186 | ` */` |
|  19866 |  187 | `static void VmDiagnosticHeader(SyBlob *pWorker,sxi32 iErr,SyString *pFuncName)` |
|      5 |  188 | `{` |
|  19871 |  189 | `	SyBlobFormat(pWorker,"%s: ",VmDiagnosticLabel(iErr));` |
|  19871 |  190 | `	if( pFuncName ){` |
...
|      - |  293 | ` */` |
| 105021 |  294 | `PH7_PRIVATE int VmRecursionExceeded(ph7_vm *pVm)` |
|      5 |  295 | `{` |
...
| 105026 |  298 | `	return pVm->nMaxDepth > 0 && pVm->nRecursionDepth > pVm->nMaxDepth;` |
|      5 |  299 | `}` |
|      - |  300 | `/*` |
...
|      - |  307 | ` */` |
| 159620 |  308 | `PH7_PRIVATE int VmNativeNestingExceeded(ph7_vm *pVm)` |
|      5 |  309 | `{` |
| 159625 |  310 | `	return pVm->nVmExecDepth >= pVm->nMaxNativeDepth;` |
|      5 |  311 | `}` |
|      - |  312 | `/*` |
...
|      - |  357 | ` * information.` |
|      - |  358 | ` */` |
|  19788 |  359 | `static sxi32 VmThrowErrorAp(` |
...
|      - |  365 | `	)` |
|      5 |  366 | `{` |
|  19793 |  367 | `	SyBlob *pWorker = &pVm->sWorker;` |
|      - |  368 | `	SyBlob sMsg;` |
|      - |  369 | `	SyString *pFile;` |
|  19793 |  370 | `	sxi32 rc = SXRET_OK;` |
|      - |  371 | `	/* Reset the working buffer */` |
|  19793 |  372 | `	SyBlobReset(pWorker);` |
|      - |  373 | `	/* Peek the processed file if available */` |
|  19793 |  374 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|  19793 |  375 | `	VmDiagnosticHeader(pWorker,iErr,pFuncName);` |
|      - |  376 | `	/* Format the raw message */` |
|  19793 |  377 | `	SyBlobInit(&sMsg, &pVm->sAllocator);` |
|  19793 |  378 | `	SyBlobFormatAp(&sMsg,zFormat,ap);` |
...
|  19793 |  383 | `	if( VmInvokeErrorHandler(pVm, iErr, (const char *)SyBlobData(&sMsg), (sxi32)SyBlobLength(&sMsg), pFile, (sxi32)pVm->nCurLine) ){` |
...
|  19689 |  386 | `		VmRecordLastError(&(*pVm),iErr,(const char *)SyBlobData(&sMsg),SyBlobLength(&sMsg),pFile);` |
|  19689 |  387 | `		if( !VmErrReportWants(pVm,iErr) \|\| pVm->nErrSuppress > 0 ){` |
|  19661 |  388 | `			SyBlobRelease(&sMsg);` |
|  19661 |  389 | `			return SXRET_OK;` |
|      - |  390 | `		}` |
...
|      - |  949 | ` */` |
| 367655 |  950 | `PH7_PRIVATE sxi32 VmCheckReadonlyMutate(ph7_vm *pVm,sxu32 nIdx)` |
|      5 |  951 | `{` |
|      - |  952 | `	SyHashEntry *pSlot;` |
|      - |  953 | `	VmClassAttr *pVmAttr;` |
| 367660 |  954 | `	if( nIdx == SXU32_HIGH \|\| SyHashTotalEntry(&pVm->hTypedSlot) == 0 ){` |
| 280720 |  955 | `		return SXRET_OK; /* Non-lvalue operand, or no typed/readonly properties — skip */` |
|      - |  956 | `	}` |
...
|      - | 2095 | ` * type field.` |
|      - | 2096 | ` */` |
| 123345 | 2097 | `PH7_PRIVATE int VmFuncHasReturnType(ph7_vm_func *pFunc)` |
|      5 | 2098 | `{` |
| 123350 | 2099 | `	return pFunc->nReturnType > 0 \|\| SySetUsed(&pFunc->aReturnUnion) > 0;` |
|      5 | 2100 | `}` |
...
|      - | 2279 | ` * ------------------------------------` |
|      - | 2280 | ` */` |
|  19724 | 2281 | `PH7_PRIVATE sxi32 PH7_VmThrowErrorAp(ph7_vm *pVm,SyString *pFuncName,sxi32 iErr,const char *zFormat,va_list ap)` |
|      5 | 2282 | `{` |
|      - | 2283 | `	sxi32 rc;` |
|  19729 | 2284 | `	rc = VmThrowErrorAp(&(*pVm),&(*pFuncName),iErr,zFormat,ap);` |
|  19729 | 2285 | `	return rc;` |
|      5 | 2286 | `}` |
|      - | 2287 | `/*` |
...
|      - | 2847 | ` */` |
|   8454 | 2848 | `PH7_PRIVATE void PH7_VmStampThrowableSite(ph7_vm *pVm,ph7_class_instance *pThis)` |
|      5 | 2849 | `{` |
...
|      - | 2854 | `	sxu32 n;` |
|   8459 | 2855 | `	if( pThis == 0 \|\| pThis->pClass == 0 ){` |
|    ! 0 | 2856 | `		return;` |
|      - | 2857 | `	}` |
|   8459 | 2858 | `	pThrowable = PH7_VmExtractClass(&(*pVm),"Throwable",sizeof("Throwable")-1,FALSE,0);` |
|   8459 | 2859 | `	if( pThrowable == 0 \|\| !PH7_VmInstanceOf(pThis->pClass,pThrowable) ){` |
|   5715 | 2860 | `		return;` |
|      - | 2861 | `	}` |
...
|     26 | 2930 | `}` |
|  43187 | 2931 | `PH7_PRIVATE sxi32 VmArithOperandCheck(ph7_vm *pVm,ph7_value *pLeft,ph7_value *pRight,const char *zOp,SyBlob *pMsgOut)` |
|      5 | 2932 | `{` |
|  43192 | 2933 | `	int bBadL = 0, bBadR = 0;` |
|      - | 2934 | `	int i;` |
|      - | 2935 | `	ph7_value *apOperand[2];` |
|  43192 | 2936 | `	apOperand[0] = pLeft;` |
|  43192 | 2937 | `	apOperand[1] = pRight;` |
|      - | 2938 | `	/* array + array is php's union operator, not arithmetic */` |
|  43187 | 2939 | `	if( zOp[0] == '+' && zOp[1] == '\0'` |
|  14701 | 2940 | `	 && (pLeft->iFlags & MEMOBJ_HASHMAP) && (pRight->iFlags & MEMOBJ_HASHMAP) ){` |
|   3835 | 2941 | `		return SXRET_OK;` |
|      - | 2942 | `	}` |
