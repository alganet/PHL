...
" }"
" protected function __rfinfo(){ return __reflect_sig_fixup(__reflect_func_info($this->class, $this->name)); }"
...
"   $t = $rm->class;"
"   $m = $rm->name;"
"   $i = __reflect_sig_fixup(__reflect_func_info($t, $m));"
...
"  if($this->__m !== null){ return __reflect_sig_fixup(__reflect_func_info($this->__t, $this->__m)); }"
