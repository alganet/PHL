...
|        - |  156 | ` */` |
|   178638 |  157 | `static int GenStateEmitExceptionPopForBreak(ph7_gen_state *pGen,GenBlock *pTarget)` |
|        5 |  158 | `{` |
|   178643 |  159 | `	GenBlock *pBlock = pGen->pCurrent;` |
|   178643 |  160 | `	int nInlineTry = 0;` |
|   722101 |  161 | `	while( pBlock && pBlock != pTarget ){` |
|   543463 |  162 | `		if( pBlock->iFlags & GEN_BLOCK_EXCEPTION ){` |
...
|        - |  177 | `			}` |
|        2 |  178 | `		}` |
|   543463 |  179 | `		pBlock = pBlock->pParent;` |
|        5 |  180 | `	}` |
|   178643 |  181 | `	return nInlineTry;` |
|        5 |  182 | `}` |
|    89290 |  183 | `PH7_PRIVATE sxi32 PH7_CompileContinue(ph7_gen_state *pGen)` |
|        5 |  184 | `{` |
|        - |  185 | `	GenBlock *pLoop; /* Target loop */` |
|        - |  186 | `	sxi32 iLevel;    /* How many nesting loop to skip */` |
|        - |  187 | `	sxu32 nLineLocal;` |
|        - |  188 | `	sxi32 rc;` |
|    89295 |  189 | `	nLineLocal = pGen->pIn->nLine;` |
|    89295 |  190 | `	iLevel = 0;` |
|        - |  191 | `	/* Jump the 'continue' keyword */` |
|    89295 |  192 | `	pGen->pIn++;` |
|    89295 |  193 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NUM) ){` |
...
|    89295 |  219 | `	pLoop = GenStateFetchBlock(pGen->pCurrent,GEN_BLOCK_LOOP,iLevel);` |
|    89295 |  220 | `	if( pLoop == 0 ){` |
...
|        - |  226 | `		}` |
|        7 |  227 | `	}else{` |
|    89285 |  228 | `		sxu32 nInstrIdx = 0;` |
|        - |  229 | `		/* Emit POP_EXCEPTION (legacy) for crossed try blocks, or count them (generator). */` |
|    89285 |  230 | `		int nCross = GenStateEmitExceptionPopForBreak(&(*pGen),pLoop);` |
...
|    89285 |  233 | `		sxi32 iJmpOp = nCross > 0 ? PH7_OP_SET_FINALLY_JMP : PH7_OP_JMP;` |
|    89285 |  234 | `		if( pLoop->iFlags & GEN_BLOCK_SWITCH ){` |
...
|    89281 |  250 | `			PH7_VmEmitInstr(pGen->pVm,iJmpOp,nCross,pLoop->nFirstInstr,0,&nInstrIdx);` |
|    89281 |  251 | `			if( pLoop->bPostContinue == TRUE ){` |
|        - |  252 | `				JumpFixup sJumpFix;` |
|        - |  253 | `				/* Post-continue */` |
|    27177 |  254 | `				sJumpFix.nJumpType = PH7_OP_JMP;` |
|    27177 |  255 | `				sJumpFix.nInstrIdx = nInstrIdx;` |
|    27177 |  256 | `				SySetPut(&pLoop->aPostContFix,(const void *)&sJumpFix);` |
|    13586 |  257 | `			}` |
|        - |  258 | `		}` |
|        - |  259 | `	}` |
|    89295 |  260 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
...
|        - |  274 | ` */` |
|    89374 |  275 | `PH7_PRIVATE sxi32 PH7_CompileBreak(ph7_gen_state *pGen)` |
|        5 |  276 | `{` |
...
|    89379 |  282 | `	pGen->pIn++;` |
|    89379 |  283 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NUM) ){` |
...
|    89379 |  309 | `	pLoop = GenStateFetchBlock(pGen->pCurrent,GEN_BLOCK_LOOP,iLevel);` |
|    89379 |  310 | `	if( pLoop == 0 ){` |
|        - |  311 | `		/* Illegal break */` |
...
|    89363 |  320 | `		int nCross = GenStateEmitExceptionPopForBreak(&(*pGen),pLoop);` |
|        - |  321 | `		/* ROOT C: OP_SET_FINALLY_JMP runs the crossed inline finallys before the break jump. */` |
|    89363 |  322 | `		rc = PH7_VmEmitInstr(pGen->pVm,nCross > 0 ? PH7_OP_SET_FINALLY_JMP : PH7_OP_JMP,nCross,0,0,&nInstrIdx);` |
|    89363 |  323 | `		if( rc == SXRET_OK ){` |
|        - |  324 | `			/* Fix the jump later when the jump destination is resolved */` |
|    89363 |  325 | `			GenStateNewJumpFixup(pLoop,PH7_OP_JMP,nInstrIdx);` |
|    44679 |  326 | `		}` |
|        - |  327 | `	}` |
|    89379 |  328 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
...
|        - |  536 | ` * message.` |
|        - |  537 | ` */` |
|  6921432 |  538 | `PH7_PRIVATE sxi32 PH7_CompileBlock(` |
...
|        - |  543 | `	sxi32 rc;` |
|        - |  544 | `	sxu32 nLine;` |
|  6921437 |  545 | `	if( pGen->pIn->nType & PH7_TK_OCB /* '{' */ ){` |
|  6796211 |  546 | `		nLine = pGen->pIn->nLine;` |
|  6796211 |  547 | `		rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_STD,PH7_VmInstrLength(pGen->pVm),0,0);` |
|  6796211 |  548 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  549 | `			return SXERR_ABORT;` |
|        - |  550 | `		}` |
|  6796211 |  551 | `		pGen->pIn++;` |
|        - |  552 | `		/* Compile until we hit the closing braces '}' */` |
|  9944186 |  553 | `		for(;;){` |
| 19888377 |  554 | `			if( pGen->pIn >= pGen->pEnd ){` |
...
|        - |  564 | `				}` |
|      ! 0 |  565 | `			}` |
| 19888357 |  566 | `			if( pGen->pIn->nType & PH7_TK_CCB/*'}'*/ ){` |
|        - |  567 | `				/* Closing braces found,break immediately*/` |
|  6796191 |  568 | `				pGen->pIn++;` |
|  6796191 |  569 | `				break;` |
|        - |  570 | `			}` |
|        - |  571 | `			/* Compile a single statement */` |
| 13092171 |  572 | `			rc = GenStateCompileChunk(&(*pGen),PH7_COMPILE_SINGLE_STMT);` |
| 13092171 |  573 | `			if( rc == SXERR_ABORT ){` |
|      ! 0 |  574 | `				return SXERR_ABORT;` |
|        - |  575 | `			}` |
|        5 |  576 | `		}` |
|  6796211 |  577 | `		GenStateLeaveBlock(&(*pGen),0);` |
|  3523334 |  578 | `	}else if( (pGen->pIn->nType & PH7_TK_COLON /* ':' */) && nKeywordEnd > 0 ){` |
|      ! 0 |  579 | `		pGen->pIn++;` |
...
|   125231 |  622 | `		rc = GenStateCompileChunk(&(*pGen),PH7_COMPILE_SINGLE_STMT);` |
|   125231 |  623 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 |  624 | `			return SXERR_ABORT;` |
|        - |  625 | `		}` |
|        - |  626 | `	}` |
|        - |  627 | `	/* Jump trailing semi-colons ';' */` |
|  6921437 |  628 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|      ! 0 |  629 | `		pGen->pIn++;` |
|      ! 0 |  630 | `	}` |
|  6921437 |  631 | `	return SXRET_OK;` |
|  3460721 |  632 | `}` |
|        - |  633 | `/*` |
...
|        - |  650 | ` *   endwhile;` |
|        - |  651 | ` */` |
|    73864 |  652 | `PH7_PRIVATE sxi32 PH7_CompileWhile(ph7_gen_state *pGen)` |
|        5 |  653 | `{` |
|    73869 |  654 | `	GenBlock *pWhileBlock = 0;` |
|    73869 |  655 | `	SyToken *pTmp,*pEnd = 0;` |
|        - |  656 | `	sxu32 nFalseJump;` |
|        - |  657 | `	sxu32 nLine;` |
|        - |  658 | `	sxi32 rc;` |
|    73869 |  659 | `	nLine = pGen->pIn->nLine;` |
|        - |  660 | `	/* Jump the 'while' keyword */` |
|    73869 |  661 | `	pGen->pIn++;` |
|    73869 |  662 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|        - |  663 | `		/* Syntax error */` |
...
|    73869 |  674 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pWhileBlock);` |
|    73869 |  675 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  676 | `		return SXERR_ABORT;` |
|        - |  677 | `	}` |
|        - |  678 | `	/* Delimit the condition */` |
|    73869 |  679 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|    73869 |  680 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|    73869 |  689 | `	pTmp = pGen->pEnd;` |
|    73869 |  690 | `	pGen->pEnd = pEnd;` |
|        - |  691 | `	/* Compile the expression */` |
|    73869 |  692 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|    73869 |  693 | `	if( rc == SXERR_ABORT ){` |
|        - |  694 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|      ! 0 |  695 | `		return SXERR_ABORT;` |
|        - |  696 | `	}` |
|        - |  697 | `	/* Update token stream */` |
|    73869 |  698 | `	while(pGen->pIn < pEnd ){` |
...
|    73869 |  706 | `	pGen->pIn  = &pEnd[1];` |
|    73869 |  707 | `	pGen->pEnd = pTmp;` |
|        - |  708 | `	/* Emit the false jump */` |
|    73869 |  709 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nFalseJump);` |
|        - |  710 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|    73869 |  711 | `	GenStateNewJumpFixup(pWhileBlock,PH7_OP_JZ,nFalseJump);` |
|        - |  712 | `	/* Compile the loop body */` |
|    73869 |  713 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDWHILE);` |
|    73869 |  714 | `	if( rc == SXERR_ABORT ){` |
|      ! 0 |  715 | `		return SXERR_ABORT;` |
|        - |  716 | `	}` |
|        - |  717 | `	/* Emit the unconditional jump to the start of the loop */` |
|    73869 |  718 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pWhileBlock->nFirstInstr,0,0);` |
|        - |  719 | `	/* Fix all jumps now the destination is resolved */` |
|    73869 |  720 | `	GenStateFixJumps(pWhileBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|        - |  721 | `	/* Release the loop block */` |
|    73869 |  722 | `	GenStateLeaveBlock(pGen,0);` |
|        - |  723 | `	/* Statement successfully compiled */` |
|    73869 |  724 | `	return SXRET_OK;` |
|      ! 0 |  725 | `Synchronize:` |
...
|        - |  880 | ` */` |
|   128192 |  881 | `PH7_PRIVATE sxi32 PH7_CompileFor(ph7_gen_state *pGen)` |
|        5 |  882 | `{` |
|   128197 |  883 | `	SyToken *pTmp,*pPostStart,*pEnd = 0;` |
|   128197 |  884 | `	GenBlock *pForBlock = 0;` |
|        - |  885 | `	sxu32 nFalseJump;` |
|        - |  886 | `	sxu32 nLine;` |
|        - |  887 | `	sxi32 rc;` |
|   128197 |  888 | `	nLine = pGen->pIn->nLine;` |
|        - |  889 | `	/* Jump the 'for' keyword */` |
|   128197 |  890 | `	pGen->pIn++;` |
|   128197 |  891 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|        - |  892 | `		/* Syntax error */` |
...
|   128197 |  903 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   128197 |  904 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|   128197 |  919 | `	pTmp = pGen->pEnd;` |
|   128197 |  920 | `	pGen->pEnd = pEnd;` |
...
|   128197 |  925 | `	pGen->nCommaExprOk++;` |
|        - |  926 | `	/* Compile initialization expressions if available */` |
|   128197 |  927 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|        - |  928 | `	/* Pop operand lvalues */` |
|   128197 |  929 | `	if( rc == SXERR_ABORT ){` |
|        - |  930 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|      ! 0 |  931 | `		return SXERR_ABORT;` |
|   128197 |  932 | `	}else if( rc != SXERR_EMPTY ){` |
|   116555 |  933 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|    58275 |  934 | `	}` |
|   128197 |  935 | `	if( (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|        - |  936 | `		/* Syntax error */` |
...
|   128197 |  947 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pForBlock);` |
|   128197 |  948 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  949 | `		return SXERR_ABORT;` |
|        - |  950 | `	}` |
|        - |  951 | `	/* Deffer continue jumps */` |
|   128197 |  952 | `	pForBlock->bPostContinue = TRUE;` |
|        - |  953 | `	/* Compile the condition */` |
|   128197 |  954 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   128197 |  955 | `	if( rc == SXERR_ABORT ){` |
|        - |  956 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|      ! 0 |  957 | `		return SXERR_ABORT;` |
|   128197 |  958 | `	}else if( rc != SXERR_EMPTY ){` |
|        - |  959 | `		/* Emit the false jump */` |
|   116555 |  960 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nFalseJump);` |
|        - |  961 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   116555 |  962 | `		GenStateNewJumpFixup(pForBlock,PH7_OP_JZ,nFalseJump);` |
|    58275 |  963 | `	}` |
|   128197 |  964 | `	if( (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|        - |  965 | `		/* Syntax error */` |
...
|   128193 |  976 | `	pPostStart = pGen->pIn;` |
...
|   128193 |  979 | `	pGen->nCommaExprOk--;` |
|   128193 |  980 | `	pGen->pIn  = &pEnd[1]; /* Jump the trailing parenthesis ')' */` |
|   128193 |  981 | `	pGen->pEnd = pTmp;` |
|   128193 |  982 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDFOR);` |
|   128193 |  983 | `	if( rc == SXERR_ABORT ){` |
|      ! 0 |  984 | `		return SXERR_ABORT;` |
|        - |  985 | `	}` |
|        - |  986 | `	/* Fix post-continue jumps */` |
|   128193 |  987 | `	if( SySetUsed(&pForBlock->aPostContFix) > 0 ){` |
|        - |  988 | `		JumpFixup *aPost;` |
|        - |  989 | `		VmInstr *pInstr;` |
|        - |  990 | `		sxu32 nJumpDest;` |
|        - |  991 | `		sxu32 n;` |
|    11657 |  992 | `		aPost = (JumpFixup *)SySetBasePtr(&pForBlock->aPostContFix);` |
|    11657 |  993 | `		nJumpDest = PH7_VmInstrLength(pGen->pVm);` |
|    38829 |  994 | `		for( n = 0 ; n < SySetUsed(&pForBlock->aPostContFix) ; ++n ){` |
|    27177 |  995 | `			pInstr = PH7_VmGetInstr(pGen->pVm,aPost[n].nInstrIdx);` |
|    27177 |  996 | `			if( pInstr ){` |
|        - |  997 | `				/* Fix jump */` |
|    27177 |  998 | `				pInstr->iP2 = nJumpDest;` |
|    13586 |  999 | `			}` |
|    13591 | 1000 | `		}` |
|     5826 | 1001 | `	}` |
|        - | 1002 | `	/* compile the post-expressions if available */` |
|   128193 | 1003 | `	while( pPostStart < pEnd && (pPostStart->nType & PH7_TK_SEMI) ){` |
|      ! 0 | 1004 | `		pPostStart++;` |
|      ! 0 | 1005 | `	}` |
|   128193 | 1006 | `	if( pPostStart < pEnd ){` |
|        - | 1007 | `		SyToken *pTmpIn,*pTmpEnd;` |
|   116553 | 1008 | `		SWAP_DELIMITER(pGen,pPostStart,pEnd);` |
|   116553 | 1009 | `		pGen->nCommaExprOk++; /* post-expressions are a clause list again */` |
|   116553 | 1010 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   116553 | 1011 | `		pGen->nCommaExprOk--;` |
|   116553 | 1012 | `		if( pGen->pIn < pGen->pEnd ){` |
|        - | 1013 | `			/* Syntax error */` |
...
|        - | 1020 | `		}` |
|   116553 | 1021 | `		RE_SWAP_DELIMITER(pGen);` |
|   116553 | 1022 | `		if( rc == SXERR_ABORT ){` |
|        - | 1023 | `			/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|      ! 0 | 1024 | `			return SXERR_ABORT;` |
|   116553 | 1025 | `		}else if( rc != SXERR_EMPTY){` |
|        - | 1026 | `			/* Pop operand lvalue */` |
|   116553 | 1027 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|    58274 | 1028 | `		}` |
|    58274 | 1029 | `	}` |
|        - | 1030 | `	/* Emit the unconditional jump to the start of the loop */` |
|   128193 | 1031 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pForBlock->nFirstInstr,0,0);` |
|        - | 1032 | `	/* Fix all jumps now the destination is resolved */` |
|   128193 | 1033 | `	GenStateFixJumps(pForBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|        - | 1034 | `	/* Release the loop block */` |
|   128193 | 1035 | `	GenStateLeaveBlock(pGen,0);` |
|        - | 1036 | `	/* Statement successfully compiled */` |
|   128193 | 1037 | `	return SXRET_OK;` |
|    64101 | 1038 | `}` |
...
|        - | 1041 | ` * are allowed.` |
|        - | 1042 | ` */` |
|   462828 | 1043 | `static sxi32 GenStateForEachNodeValidator(ph7_gen_state *pGen,ph7_expr_node *pRoot)` |
|        5 | 1044 | `{` |
|   462833 | 1045 | `	sxi32 rc = SXRET_OK; /* Assume a valid expression tree */` |
|   462833 | 1046 | `	if( pRoot->xCode != PH7_CompileVariable ){` |
...
|        - | 1081 | ` */` |
|   326738 | 1082 | `PH7_PRIVATE sxi32 PH7_CompileForeach(ph7_gen_state *pGen)` |
|        5 | 1083 | `{` |
|   326743 | 1084 | `	SyToken *pCur,*pTmp,*pEnd = 0;` |
|   326743 | 1085 | `	SyToken *pListStart = 0,*pListEnd = 0;` |
|   326743 | 1086 | `	GenBlock *pForeachBlock = 0;` |
|        - | 1087 | `	ph7_foreach_info *pInfo;` |
|        - | 1088 | `	sxu32 nFalseJump;` |
|        - | 1089 | `	VmInstr *pInstr;` |
|        - | 1090 | `	sxu32 nLine;` |
|        - | 1091 | `	sxi32 rc;` |
|   326743 | 1092 | `	nLine = pGen->pIn->nLine;` |
|        - | 1093 | `	/* Jump the 'foreach' keyword */` |
|   326743 | 1094 | `	pGen->pIn++;` |
|   326743 | 1095 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|        - | 1096 | `		/* Syntax error */` |
...
|   326743 | 1105 | `	pGen->pIn++;` |
|        - | 1106 | `	/* Create the loop block */` |
|   326743 | 1107 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pForeachBlock);` |
|   326743 | 1108 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 1109 | `		return SXERR_ABORT;` |
|        - | 1110 | `	}` |
|        - | 1111 | `	/* Delimit the expression */` |
|   326743 | 1112 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   326743 | 1113 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|   326743 | 1128 | `	pCur = pGen->pIn;` |
|  1851627 | 1129 | `	while( pCur < pEnd ){` |
|  1851627 | 1130 | `		if( pCur->nType & PH7_TK_KEYWORD ){` |
|   357797 | 1131 | `			sxi32 nKeywrd = SX_PTR_TO_INT(pCur->pUserData);` |
|   357797 | 1132 | `			if( nKeywrd == PH7_TKWRD_AS ){` |
...
|   326743 | 1150 | `	pTmp = pGen->pEnd;` |
|   326743 | 1151 | `	pGen->pEnd = pCur;` |
|   326743 | 1152 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   326743 | 1153 | `	if( rc == SXERR_ABORT ){` |
|        - | 1154 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|      ! 0 | 1155 | `		return SXERR_ABORT;` |
|        - | 1156 | `	}` |
|        - | 1157 | `	/* Update token stream */` |
|   326743 | 1158 | `	while(pGen->pIn < pCur ){` |
...
|      ! 0 | 1164 | `		pGen->pIn++;` |
|      ! 0 | 1165 | `	}` |
|   326743 | 1166 | `	pCur++; /* Jump the 'as' keyword */` |
|   326743 | 1167 | `	pGen->pIn = pCur;` |
|   326743 | 1168 | `	if( pGen->pIn >= pEnd ){` |
...
|   326743 | 1175 | `	pInfo = (ph7_foreach_info *)SyMemBackendAlloc(&pGen->pVm->sAllocator,sizeof(ph7_foreach_info));` |
|   326743 | 1176 | `	if( pInfo == 0 ){` |
...
|   326743 | 1181 | `	SyZero(pInfo,sizeof(ph7_foreach_info));` |
|        - | 1182 | `	/* Initialize structure fields */` |
|   326743 | 1183 | `	SySetInit(&pInfo->aStep,&pGen->pVm->sAllocator,sizeof(ph7_foreach_step *));` |
...
|        - | 1186 | `	 * '=>'. */` |
|   326743 | 1187 | `	pCur = GenStateFindTopLevelArrow(pCur,pEnd);` |
|   326743 | 1188 | `	if( pCur < pEnd ){` |
|        - | 1189 | `		/* Compile the expression holding the key name */` |
|   136119 | 1190 | `		if( pGen->pIn >= pCur ){` |
...
|        - | 1195 | `			}` |
|      ! 0 | 1196 | `		}else{` |
|   136119 | 1197 | `			pGen->pEnd = pCur;` |
|   136119 | 1198 | `			rc = PH7_CompileExpr(&(*pGen),0,GenStateForEachNodeValidator);` |
|   136119 | 1199 | `			if( rc == SXERR_ABORT ){` |
|        - | 1200 | `				/* Don't worry about freeing memory, everything will be released shortly */` |
|      ! 0 | 1201 | `				return SXERR_ABORT;` |
|        - | 1202 | `			}` |
|   136119 | 1203 | `			pInstr = PH7_VmPopInstr(pGen->pVm);` |
|   136119 | 1204 | `			if( pInstr->p3 ){` |
|        - | 1205 | `				/* Record key name */` |
|   136119 | 1206 | `				SyStringInitFromBuf(&pInfo->sKey,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|    68057 | 1207 | `			}` |
|   136119 | 1208 | `			pInfo->iFlags \|= PH7_4EACH_STEP_KEY;` |
|        - | 1209 | `		}` |
|   136119 | 1210 | `		pGen->pIn = &pCur[1]; /* Jump the arrow */` |
|    68057 | 1211 | `	}` |
|   326743 | 1212 | `	pGen->pEnd = pEnd;` |
|   326743 | 1213 | `	if( pGen->pIn >= pEnd ){` |
...
|   326738 | 1268 | `	}else if( pGen->pIn->nType & PH7_TK_OSB ){` |
...
|   326719 | 1301 | `		rc = PH7_CompileExpr(&(*pGen),0,GenStateForEachNodeValidator);` |
|   326719 | 1302 | `		if( rc == SXERR_ABORT ){` |
|        - | 1303 | `			/* Don't worry about freeing memory, everything will be released shortly */` |
|      ! 0 | 1304 | `			return SXERR_ABORT;` |
|        - | 1305 | `		}` |
|   326719 | 1306 | `		pInstr = PH7_VmPopInstr(pGen->pVm);` |
|   326719 | 1307 | `		if( pInstr->p3 ){` |
|        - | 1308 | `			/* Record value name */` |
|   326719 | 1309 | `			SyStringInitFromBuf(&pInfo->sValue,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|   163357 | 1310 | `		}` |
|        - | 1311 | `	}` |
|        - | 1312 | `	/* Emit the 'FOREACH_INIT' instruction */` |
|   326741 | 1313 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_FOREACH_INIT,0,0,pInfo,&nFalseJump);` |
|        - | 1314 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   326741 | 1315 | `	GenStateNewJumpFixup(pForeachBlock,PH7_OP_FOREACH_INIT,nFalseJump);` |
|        - | 1316 | `	/* Record the first instruction to execute */` |
|   326741 | 1317 | `	pForeachBlock->nFirstInstr = PH7_VmInstrLength(pGen->pVm);` |
|        - | 1318 | `	/* Emit the FOREACH_STEP instruction */` |
|   326741 | 1319 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_FOREACH_STEP,0,0,pInfo,&nFalseJump);` |
|        - | 1320 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   326741 | 1321 | `	GenStateNewJumpFixup(pForeachBlock,PH7_OP_FOREACH_STEP,nFalseJump);` |
|        - | 1322 | `	/* If list() unpacking, emit bytecode to destructure the temp variable */` |
|   326741 | 1323 | `	if( (pInfo->iFlags & PH7_4EACH_STEP_LIST) && pListStart && pListEnd ){` |
...
|   326741 | 1351 | `	pGen->pIn = &pEnd[1];` |
|   326741 | 1352 | `	pGen->pEnd = pTmp;` |
|   326741 | 1353 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_END4EACH);` |
|   326741 | 1354 | `	if( rc == SXERR_ABORT ){` |
...
|   326741 | 1359 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pForeachBlock->nFirstInstr,0,0);` |
|        - | 1360 | `	/* Fix all jumps now the destination is resolved */` |
|   326741 | 1361 | `	GenStateFixJumps(pForeachBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|        - | 1362 | `	/* Release the loop block */` |
|   326741 | 1363 | `	GenStateLeaveBlock(pGen,0);` |
|        - | 1364 | `	/* Statement successfully compiled */` |
|   326741 | 1365 | `	return SXRET_OK;` |
|        1 | 1366 | `Synchronize:` |
...
|        - | 1405 | ` *    ?>` |
|        - | 1406 | ` */` |
|  2426784 | 1407 | `PH7_PRIVATE sxi32 PH7_CompileIf(ph7_gen_state *pGen)` |
|        5 | 1408 | `{` |
|  2426789 | 1409 | `	SyToken *pToken,*pTmp,*pEnd = 0;` |
|  2426789 | 1410 | `	GenBlock *pCondBlock = 0;` |
|        - | 1411 | `	sxu32 nJumpIdx;` |
|        - | 1412 | `	sxu32 nKeyID;` |
|        - | 1413 | `	sxi32 rc;` |
|        - | 1414 | `	/* Jump the 'if' keyword */` |
|  2426789 | 1415 | `	pGen->pIn++;` |
|  2426789 | 1416 | `	pToken = pGen->pIn;` |
|        - | 1417 | `	/* Create the conditional block */` |
|  2426789 | 1418 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_COND,PH7_VmInstrLength(pGen->pVm),0,&pCondBlock);` |
|  2426789 | 1419 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 1420 | `		return SXERR_ABORT;` |
|        - | 1421 | `	}` |
|        - | 1422 | `	/* Process as many [if/else if/elseif/else] blocks as we can */` |
|  1357013 | 1423 | `	for(;;){` |
|  2714031 | 1424 | `		if( pToken >= pGen->pEnd \|\| (pToken->nType & PH7_TK_LPAREN) == 0 ){` |
|        - | 1425 | `			/* Syntax error */` |
...
|  2714031 | 1439 | `		PH7_DelimitNestedTokens(pToken,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|  2714031 | 1440 | `		if( pToken >= pEnd \|\| (pEnd->nType & PH7_TK_RPAREN) == 0 ){` |
|        - | 1441 | `			/* Syntax error */` |
...
|  2714027 | 1453 | `		SWAP_TOKEN_STREAM(pGen,pToken,pEnd);` |
|        - | 1454 | `		/* Compile the condition */` |
|  2714027 | 1455 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|        - | 1456 | `		/* Update token stream */` |
|  2714027 | 1457 | `		while(pGen->pIn < pEnd ){` |
|      ! 0 | 1458 | `			PH7_GenSyntaxError(&(*pGen),pGen->pIn,0);` |
|      ! 0 | 1459 | `			pGen->pIn++;` |
|      ! 0 | 1460 | `		}` |
|  2714027 | 1461 | `		pGen->pIn  = &pEnd[1];` |
|  2714027 | 1462 | `		pGen->pEnd = pTmp;` |
|  2714027 | 1463 | `		if( rc == SXERR_ABORT ){` |
|        - | 1464 | `			/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|      ! 0 | 1465 | `			return SXERR_ABORT;` |
|        - | 1466 | `		}` |
|        - | 1467 | `		/* Emit the false jump */` |
|  2714027 | 1468 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nJumpIdx);` |
|        - | 1469 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|  2714027 | 1470 | `		GenStateNewJumpFixup(pCondBlock,PH7_OP_JZ,nJumpIdx);` |
|        - | 1471 | `		/* Compile the body */` |
|  2714027 | 1472 | `		rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDIF);` |
|  2714027 | 1473 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 | 1474 | `			return SXERR_ABORT;` |
|        - | 1475 | `		}` |
|  2714027 | 1476 | `		if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
|   520453 | 1477 | `			break;` |
|        - | 1478 | `		}` |
|        - | 1479 | `		/* Ensure that the keyword ID is 'else if' or 'else' */` |
|  1673131 | 1480 | `		nKeyID = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  1673131 | 1481 | `		if( (nKeyID & (PH7_TKWRD_ELSE\|PH7_TKWRD_ELIF)) == 0 ){` |
|  1164297 | 1482 | `			break;` |
|        - | 1483 | `		}` |
|        - | 1484 | `		/* Emit the unconditional jump */` |
|   508839 | 1485 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,0,0,&nJumpIdx);` |
|        - | 1486 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   508839 | 1487 | `		GenStateNewJumpFixup(pCondBlock,PH7_OP_JMP,nJumpIdx);` |
|   508839 | 1488 | `		if( nKeyID & PH7_TKWRD_ELSE ){` |
|   306957 | 1489 | `			pToken = &pGen->pIn[1];` |
|   306957 | 1490 | `			if( pToken >= pGen->pEnd \|\| (pToken->nType & PH7_TK_KEYWORD) == 0 \|\|` |
|    85398 | 1491 | `				SX_PTR_TO_INT(pToken->pUserData) != PH7_TKWRD_IF ){` |
|   110801 | 1492 | `					break;` |
|        - | 1493 | `			}` |
|    85365 | 1494 | `			pGen->pIn++; /* Jump the 'else' keyword */` |
|    42680 | 1495 | `		}` |
|   287247 | 1496 | `		pGen->pIn++; /* Jump the 'elseif/if' keyword */` |
|        - | 1497 | `		/* Synchronize cursors */` |
|   287247 | 1498 | `		pToken = pGen->pIn;` |
|        - | 1499 | `		/* Fix the false jump */` |
|   287247 | 1500 | `		GenStateFixJumps(pCondBlock,PH7_OP_JZ,PH7_VmInstrLength(pGen->pVm));` |
|        5 | 1501 | `	} /* For(;;) */` |
|        - | 1502 | `	/* Fix the false jump */` |
|  2426785 | 1503 | `	GenStateFixJumps(pCondBlock,PH7_OP_JZ,PH7_VmInstrLength(pGen->pVm));` |
|  2426785 | 1504 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|  1385884 | 1505 | `		(SX_PTR_TO_INT(pGen->pIn->pUserData) & PH7_TKWRD_ELSE) ){` |
|        - | 1506 | `			/* Compile the else block */` |
|   221597 | 1507 | `			pGen->pIn++;` |
|   221597 | 1508 | `			rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDIF);` |
|   221597 | 1509 | `			if( rc == SXERR_ABORT ){` |
|        - | 1510 |  |
|      ! 0 | 1511 | `				return SXERR_ABORT;` |
|        - | 1512 | `			}` |
|   110796 | 1513 | `	}` |
|  2426785 | 1514 | `	nJumpIdx = PH7_VmInstrLength(pGen->pVm);` |
|        - | 1515 | `	/* Fix all unconditional jumps now the destination is resolved */` |
|  2426785 | 1516 | `	GenStateFixJumps(pCondBlock,PH7_OP_JMP,nJumpIdx);` |
|        - | 1517 | `	/* Release the conditional block */` |
|  2426785 | 1518 | `	GenStateLeaveBlock(pGen,0);` |
|        - | 1519 | `	/* Statement successfully compiled */` |
|  2426785 | 1520 | `	return SXRET_OK;` |
|        2 | 1521 | `Synchronize:` |
...
|        - | 1621 | ` */` |
|  3618586 | 1622 | `PH7_PRIVATE sxi32 PH7_CompileReturn(ph7_gen_state *pGen)` |
|        5 | 1623 | `{` |
|  3618591 | 1624 | `	sxi32 nRet = 0; /* TRUE if there is a return value */` |
|        - | 1625 | `	sxi32 rc;` |
|  3618591 | 1626 | `	sxu32 nLine = pGen->pIn->nLine;` |
|  3618591 | 1627 | `	GenBlock *pFuncBlock = pGen->pCurrent;` |
...
|  9527191 | 1633 | `	while( pFuncBlock && (pFuncBlock->iFlags & GEN_BLOCK_FUNC) == 0 ){` |
|  5908605 | 1634 | `		pFuncBlock = pFuncBlock->pParent;` |
|        5 | 1635 | `	}` |
|  3618586 | 1636 | `	if( pFuncBlock && pFuncBlock->pUserData` |
|  3618577 | 1637 | `	 && ((ph7_vm_func *)pFuncBlock->pUserData)->nReturnType == MEMOBJ_NEVER ){` |
...
|  3618591 | 1645 | `	pGen->pIn++;` |
|  3618591 | 1646 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|        - | 1647 | `		/* Compile the expression */` |
|  3521579 | 1648 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|  3521579 | 1649 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 | 1650 | `			return SXERR_ABORT;` |
|  3521579 | 1651 | `		}else if(rc != SXERR_EMPTY ){` |
|  3521579 | 1652 | `			nRet = 1;` |
|  1760787 | 1653 | `		}` |
|  1760787 | 1654 | `	}` |
...
|  3618591 | 1659 | `	if( pGen->bInGenerator ){` |
|     3913 | 1660 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_SET_FINALLY_RET,nRet,0,0,0);` |
|     3913 | 1661 | `		return SXRET_OK;` |
|        - | 1662 | `	}` |
...
|  3614683 | 1668 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,nRet,1,0,0);` |
|  3614683 | 1669 | `	return SXRET_OK;` |
|  1809298 | 1670 | `}` |
|        - | 1671 | `/*` |
...
|        - | 1676 | ` */` |
|    15908 | 1677 | `PH7_PRIVATE sxi32 PH7_CompileYield(ph7_gen_state *pGen, sxi32 iCompileFlag)` |
|        5 | 1678 | `{` |
|        - | 1679 | `	SyToken *pTmp, *pSplit;` |
|    15913 | 1680 | `	sxi32 iP1 = 0; /* 1 if value present */` |
|    15913 | 1681 | `	sxi32 iP2 = 0; /* 1 if key => value */` |
|        - | 1682 | `	sxi32 rc;` |
|     7954 | 1683 | `	(void)iCompileFlag;` |
...
|    15908 | 1691 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_ID)` |
|     7989 | 1692 | `		&& pGen->pIn->sData.nByte == 4` |
...
|        - | 1709 | `	}` |
|    15851 | 1710 | `	if( pGen->pIn >= pGen->pEnd ){` |
...
|    15849 | 1716 | `	pSplit = 0;` |
|        - | 1717 | `	{` |
|    15849 | 1718 | `		SyToken *pCur = pGen->pIn;` |
|    15849 | 1719 | `		sxi32 nNest = 0;` |
|    47351 | 1720 | `		while( pCur < pGen->pEnd ){` |
|    47041 | 1721 | `			if( pCur->nType & (PH7_TK_LPAREN\|PH7_TK_OSB\|PH7_TK_OCB) ){` |
|       18 | 1722 | `				nNest++;` |
|    47033 | 1723 | `			}else if( pCur->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB) ){` |
|       18 | 1724 | `				nNest--;` |
|    47017 | 1725 | `			}else if( nNest == 0 && (pCur->nType & PH7_TK_ARRAY_OP) ){` |
|    15539 | 1726 | `				pSplit = pCur;` |
|    15539 | 1727 | `				break;` |
|        - | 1728 | `			}` |
|    31507 | 1729 | `			pCur++;` |
|        5 | 1730 | `		}` |
|        - | 1731 | `	}` |
|    15849 | 1732 | `	pTmp = pGen->pEnd;` |
|    15849 | 1733 | `	if( pSplit ){` |
|        - | 1734 | `		/* yield $key => $value */` |
|    15539 | 1735 | `		pGen->pEnd = pSplit;` |
|    15539 | 1736 | `		rc = PH7_CompileExpr(pGen, 0, 0);` |
|    15539 | 1737 | `		if( rc == SXERR_ABORT ) return SXERR_ABORT;` |
|    15539 | 1738 | `		pGen->pIn = pSplit + 1; /* Skip '=>' */` |
|    15539 | 1739 | `		pGen->pEnd = pTmp;` |
|    15539 | 1740 | `		rc = PH7_CompileExpr(pGen, 0, 0);` |
|    15539 | 1741 | `		if( rc == SXERR_ABORT ) return SXERR_ABORT;` |
|    15539 | 1742 | `		iP1 = 1;` |
|    15539 | 1743 | `		iP2 = 1;` |
|     7772 | 1744 | `	}else{` |
|        - | 1745 | `		/* yield $value */` |
...
|      155 | 1750 | `		}` |
|        - | 1751 | `	}` |
|    15849 | 1752 | `	pGen->pEnd = pTmp;` |
|    15849 | 1753 | `	PH7_VmEmitInstr(pGen->pVm, PH7_OP_YIELD, iP1, iP2, 0, 0);` |
|    15849 | 1754 | `	return SXRET_OK;` |
|     7959 | 1755 | `}` |
|        - | 1756 | `/*` |
...
|        - | 1782 | ` */` |
|    17554 | 1783 | `PH7_PRIVATE sxi32 PH7_CompileEcho(ph7_gen_state *pGen)` |
|        5 | 1784 | `{` |
|    17559 | 1785 | `	SyToken *pTmp,*pNext = 0;` |
|    17559 | 1786 | `	sxu32 nLine = pGen->pIn->nLine;` |
|    17559 | 1787 | `	int nExpr = 0;      /* expressions actually compiled */` |
|    17559 | 1788 | `	int bExpectMore = 1;/* after 'echo' or a comma an expression is REQUIRED */` |
|        - | 1789 | `	sxi32 rc;` |
|        - | 1790 | `	/* Jump the 'echo' keyword */` |
|    17559 | 1791 | `	pGen->pIn++;` |
|        - | 1792 | `	/* Compile arguments one after one */` |
|    17559 | 1793 | `	pTmp = pGen->pEnd;` |
|    45151 | 1794 | `	while( SXRET_OK == PH7_GetNextExpr(pGen->pIn,pTmp,&pNext) ){` |
|    27603 | 1795 | `		if( pGen->pIn < pNext ){` |
|    27603 | 1796 | `			pGen->pEnd = pNext;` |
|    27603 | 1797 | `			rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_RDONLY_LOAD/* Do not create variable if inexistant */,0);` |
|    27603 | 1798 | `			if( rc == SXERR_ABORT ){` |
|        5 | 1799 | `				return SXERR_ABORT;` |
|    27599 | 1800 | `			}else if( rc != SXERR_EMPTY ){` |
|        - | 1801 | `				/* Emit the consume instruction */` |
|    27575 | 1802 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_CONSUME,1,0,0,0);` |
|    27575 | 1803 | `				nExpr++;` |
|    27575 | 1804 | `				bExpectMore = 0;` |
|    13785 | 1805 | `			}` |
|    13797 | 1806 | `		}` |
...
|    37649 | 1809 | `		while( pNext < pTmp && (pNext->nType & PH7_TK_COMMA) ){` |
|    10057 | 1810 | `			if( bExpectMore ){` |
...
|        - | 1815 | `			}` |
|    10055 | 1816 | `			bExpectMore = 1;` |
|    10055 | 1817 | `			pNext++;` |
|        5 | 1818 | `		}` |
|    27597 | 1819 | `		pGen->pIn = pNext;` |
|        5 | 1820 | `	}` |
|        - | 1821 | `	/* Restore token stream */` |
|    17553 | 1822 | `	pGen->pEnd = pTmp;` |
|    17553 | 1823 | `	if( nExpr == 0 \|\| bExpectMore ){` |
...
|        - | 1844 | ` */` |
|    11652 | 1845 | `PH7_PRIVATE sxi32 PH7_CompileStatic(ph7_gen_state *pGen)` |
|        5 | 1846 | `{` |
...
|    11652 | 1857 | `	if( &pGen->pIn[1] < pGen->pEnd && (pGen->pIn[1].nType & PH7_TK_KEYWORD)` |
|     5832 | 1858 | `	 && (SX_PTR_TO_INT(pGen->pIn[1].pUserData) == PH7_TKWRD_FUNCTION` |
...
|    11655 | 1869 | `	nLine = pGen->pIn->nLine;` |
|    11655 | 1870 | `	pGen->pIn++;` |
|        - | 1871 | `	/* Extract the enclosing function if any */` |
|    11655 | 1872 | `	pBlock = pGen->pCurrent;` |
|    23305 | 1873 | `	while( pBlock ){` |
|    23305 | 1874 | `		if( pBlock->iFlags & GEN_BLOCK_FUNC){` |
|    11655 | 1875 | `			break;` |
|        - | 1876 | `		}` |
|        - | 1877 | `		/* Point to the upper block */` |
|    11655 | 1878 | `		pBlock = pBlock->pParent;` |
|        5 | 1879 | `	}` |
|    11655 | 1880 | `	if( pBlock == 0 ){` |
...
|        - | 1898 | `	}` |
|    11655 | 1899 | `	pFunc = (ph7_vm_func *)pBlock->pUserData;` |
|        - | 1900 | `	/* Make sure we are dealing with a valid statement */` |
|    11655 | 1901 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 \|\| &pGen->pIn[1] >= pGen->pEnd \|\|` |
|    11648 | 1902 | `		(pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|    11653 | 1911 | `	pName = &pGen->pIn->sData;` |
|    11653 | 1912 | `	pGen->pIn++; /* Jump the var name */` |
|    11653 | 1913 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & (PH7_TK_SEMI/*';'*/\|PH7_TK_EQUAL/*'='*/)) == 0 ){` |
...
|    11653 | 1918 | `	SySetInit(&sStatic.aByteCode,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|    11653 | 1919 | `	sStatic.nIdx = SXU32_HIGH; /* Not yet created */` |
|        - | 1920 | `	/* Duplicate variable name */` |
|    11653 | 1921 | `	zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|    11653 | 1922 | `	if( zDup == 0 ){` |
|      ! 0 | 1923 | `		PH7_GenCompileError(&(*pGen),E_ERROR,nLine,"Fatal, PH7 engine is running out of memory");` |
|      ! 0 | 1924 | `		return SXERR_ABORT;` |
|        - | 1925 | `	}` |
|    11653 | 1926 | `	SyStringInitFromBuf(&sStatic.sName,zDup,pName->nByte);` |
|        - | 1927 | `	/* Check if we have an expression to compile */` |
|    11653 | 1928 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_EQUAL) ){` |
...
|        - | 1935 | `		 */` |
|    11653 | 1936 | `		pGen->pIn++; /* Jump the equal '=' sign */` |
|        - | 1937 | `		/* Swap bytecode container */` |
|    11653 | 1938 | `		pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|    11653 | 1939 | `		PH7_VmSetByteCodeContainer(pGen->pVm,&sStatic.aByteCode);` |
|        - | 1940 | `		/* Compile the expression */` |
|    11653 | 1941 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|        - | 1942 | `		/* Emit the done instruction */` |
|    11653 | 1943 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,(rc != SXERR_EMPTY ? 1 : 0),0,0,0);` |
|        - | 1944 | `		/* Restore default bytecode container */` |
|    11653 | 1945 | `		PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|     5824 | 1946 | `	}` |
|        - | 1947 | `	/* Finally save the compiled static variable in the appropriate container */` |
|    11653 | 1948 | `	SySetPut(&pFunc->aStatic,(const void *)&sStatic);` |
|    11653 | 1949 | `	return SXRET_OK;` |
|        1 | 1950 | `Synchronize:` |
...
|        - | 2010 | ` */` |
|  6431618 | 2011 | `PH7_PRIVATE sxu32 GenStateNsQualifyName(ph7_gen_state *pGen,sxu32 nOrigIdx,SyHash *pImports,int *pFromImport)` |
|        5 | 2012 | `{` |
|        - | 2013 | `	ph7_value *pLit;` |
...
|        - | 2021 | `	ph7_value *pNew;` |
|  6431623 | 2022 | `	if( pFromImport ){` |
|  5244021 | 2023 | `		*pFromImport = 0;` |
|  2622008 | 2024 | `	}` |
|  6431623 | 2025 | `	pLit = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,nOrigIdx);` |
|  6431623 | 2026 | `	if( !pLit \|\| !(pLit->iFlags & MEMOBJ_STRING) \|\| SyBlobLength(&pLit->sBlob) == 0 ){` |
|      ! 0 | 2027 | `		return nOrigIdx;` |
|        - | 2028 | `	}` |
|  6431623 | 2029 | `	zLit = (const char *)SyBlobData(&pLit->sBlob);` |
|  6431623 | 2030 | `	nLit = (sxu32)SyBlobLength(&pLit->sBlob);` |
|        - | 2031 | `	/* Skip if already qualified (contains backslash) */` |
|  6431623 | 2032 | `	hasNsSep = 0;` |
| 77772915 | 2033 | `	for( k = 0; k < nLit; k++ ){` |
| 71341323 | 2034 | `		if( zLit[k] == '\\' ){ hasNsSep = 1; break; }` |
| 35670651 | 2035 | `	}` |
|  6431623 | 2036 | `	if( hasNsSep ){` |
|       28 | 2037 | `		return nOrigIdx;` |
|        - | 2038 | `	}` |
|        - | 2039 | `	/* Check use imports first (works even outside namespaces) */` |
|  6431597 | 2040 | `	SyBlobReset(&pGen->sWorker);` |
|  6431597 | 2041 | `	pImport = SyHashGet(pImports,(const void *)zLit,nLit);` |
|  6431597 | 2042 | `	if( pImport ){` |
...
|        8 | 2047 | `		}` |
|       23 | 2048 | `	}else{` |
|  6431561 | 2049 | `		if( SyBlobLength(&pGen->sNamespace) == 0 ){` |
|  6431423 | 2050 | `			return nOrigIdx; /* Not in a namespace and no import match */` |
|        - | 2051 | `		}` |
...
|        - | 2073 | ` */` |
|   545088 | 2074 | `PH7_PRIVATE void GenStateResolveName(ph7_gen_state *pGen,const SyString *pName,SyBlob *pOut)` |
|        5 | 2075 | `{` |
|        - | 2076 | `	SyHashEntry *pImport;` |
|   545093 | 2077 | `	const char *zName = pName->zString;` |
|   545093 | 2078 | `	sxu32 nName = pName->nByte;` |
|   545093 | 2079 | `	sxu32 nFirst = 0;` |
...
|  6956765 | 2087 | `	while( nFirst < nName && zName[nFirst] != '\\' ){ nFirst++; }` |
|   545093 | 2088 | `	pImport = SyHashGet(&pGen->hUseImports,(const void *)zName,nFirst);` |
|   545093 | 2089 | `	if( pImport ){` |
...
|        - | 2106 | ` */` |
|   522100 | 2107 | `PH7_PRIVATE void GenStateBuildFQN(ph7_gen_state *pGen,const SyString *pName,SyBlob *pOut)` |
|        5 | 2108 | `{` |
|   522105 | 2109 | `	if( SyBlobLength(&pGen->sNamespace) > 0 ){` |
|     3973 | 2110 | `		SyBlobAppend(pOut,SyBlobData(&pGen->sNamespace),SyBlobLength(&pGen->sNamespace));` |
|     3973 | 2111 | `		SyBlobAppend(pOut,"\\",1);` |
|     1984 | 2112 | `	}` |
|   522105 | 2113 | `	SyBlobAppend(pOut,pName->zString,pName->nByte);` |
|   522105 | 2114 | `}` |
|        - | 2115 | `/*` |
...
|        3 | 2152 | `{` |
|       17 | 2153 | `	if( nType & PH7_TK_INTEGER ){ return "integer"; }` |
...
|        3 | 2159 | `	return "token";` |
|       10 | 2160 | `}` |
|     4012 | 2161 | `PH7_PRIVATE sxi32 PH7_CompileNamespace(ph7_gen_state *pGen)` |
|        5 | 2162 | `{` |
|        - | 2163 | `	sxu32 nLine;` |
|        - | 2164 | `	sxi32 rc;` |
|     4017 | 2165 | `	nLine = pGen->pIn->nLine;` |
|     4017 | 2166 | `	pGen->pIn++; /* Jump the 'namespace' keyword */` |
|        - | 2167 | `	/* Reset namespace and clear previous use imports */` |
|     4017 | 2168 | `	SyBlobReset(&pGen->sNamespace);` |
|     4017 | 2169 | `	SyHashRelease(&pGen->hUseImports);` |
|     4017 | 2170 | `	SyHashInit(&pGen->hUseImports,&pGen->pVm->sAllocator,0,0);` |
|     4017 | 2171 | `	SyHashRelease(&pGen->hUseFuncImports);` |
|     4017 | 2172 | `	SyHashInit(&pGen->hUseFuncImports,&pGen->pVm->sAllocator,0,0);` |
|     4017 | 2173 | `	SyHashRelease(&pGen->hUseConstImports);` |
|     4017 | 2174 | `	SyHashInit(&pGen->hUseConstImports,&pGen->pVm->sAllocator,0,0);` |
|     4017 | 2175 | `	if( pGen->pIn >= pGen->pEnd ){` |
|        - | 2176 | `		/* Global namespace (bare "namespace;") */` |
|      ! 0 | 2177 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_NSSWITCH,0,0,0,0);` |
|      ! 0 | 2178 | `		return SXRET_OK;` |
|        - | 2179 | `	}` |
|     4017 | 2180 | `	if( pGen->pIn->nType & PH7_TK_SEMI ){` |
|        - | 2181 | `		/* namespace; — switch to global namespace */` |
|      ! 0 | 2182 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_NSSWITCH,0,0,0,0);` |
|      ! 0 | 2183 | `		return SXRET_OK;` |
|        - | 2184 | `	}` |
|     4017 | 2185 | `	if( pGen->pIn->nType & PH7_TK_OCB ){` |
...
|     8103 | 2191 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & (PH7_TK_NSSEP\|PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|     4095 | 2192 | `		if( pGen->pIn->nType & PH7_TK_NSSEP ){` |
...
|     4053 | 2199 | `			SyBlobAppend(&pGen->sNamespace,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|        - | 2200 | `		}` |
|     4095 | 2201 | `		pGen->pIn++;` |
|        5 | 2202 | `	}` |
...
|        - | 2205 | `	{` |
|     4013 | 2206 | `		char *zNsDup = 0;` |
|     4013 | 2207 | `		if( SyBlobLength(&pGen->sNamespace) > 0 ){` |
|     6014 | 2208 | `			zNsDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|     4006 | 2209 | `				(const char *)SyBlobData(&pGen->sNamespace),SyBlobLength(&pGen->sNamespace));` |
|     2003 | 2210 | `		}` |
|     4013 | 2211 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_NSSWITCH,0,0,zNsDup,0);` |
|        - | 2212 | `	}` |
|     4013 | 2213 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & (PH7_TK_SEMI\|PH7_TK_OCB)) == 0 ){` |
...
|        - | 2526 | `			}` |
|       34 | 2527 | `			pGen->bStrictTypes = (sxi8)iStrictValue;` |
|       19 | 2528 | `		}else{` |
...
|        - | 2602 | ` */` |
|   547504 | 2603 | `static sxi32 GenStateThrowNodeValidator(ph7_gen_state *pGen,ph7_expr_node *pRoot)` |
|        5 | 2604 | `{` |
|   547509 | 2605 | `	sxi32 rc = SXRET_OK;` |
|   547509 | 2606 | `	if( pRoot->pOp ){` |
|   547497 | 2607 | `		switch( pRoot->pOp->iOp ){` |
|   273746 | 2608 | `		case EXPR_OP_NEW:            /* new Exception() */` |
...
|      ! 0 | 2624 | `			break;` |
|        - | 2625 | `		}` |
|   273763 | 2626 | `	}else if( pRoot->xCode != PH7_CompileVariable ){` |
...
|        - | 2640 | ` */` |
|   547468 | 2641 | `PH7_PRIVATE sxi32 PH7_CompileThrow(ph7_gen_state *pGen)` |
|        5 | 2642 | `{` |
|   547473 | 2643 | `	sxu32 nLine = pGen->pIn->nLine;` |
|        - | 2644 | `	GenBlock *pBlock;` |
|        - | 2645 | `	sxu32 nIdx;` |
|        - | 2646 | `	sxi32 rc;` |
|   547473 | 2647 | `	pGen->pIn++; /* Jump the 'throw' keyword */` |
|        - | 2648 | `	/* Compile the expression */` |
|   547473 | 2649 | `	rc = PH7_CompileExpr(&(*pGen),0,GenStateThrowNodeValidator);` |
|   547473 | 2650 | `	if( rc == SXERR_EMPTY ){` |
...
|        - | 2656 | `	}` |
|   547473 | 2657 | `	pBlock = pGen->pCurrent;` |
|        - | 2658 | `	/* Point to the top most function or try block and emit the forward jump */` |
|  2181361 | 2659 | `	while(pBlock->pParent){` |
|  2181357 | 2660 | `		if( pBlock->iFlags & (GEN_BLOCK_EXCEPTION\|GEN_BLOCK_FUNC) ){` |
|   547469 | 2661 | `			break;` |
|        - | 2662 | `		}` |
|        - | 2663 | `		/* Point to the parent block */` |
|  1633893 | 2664 | `		pBlock = pBlock->pParent;` |
|        5 | 2665 | `	}` |
|        - | 2666 | `	/* Emit the throw instruction */` |
|   547473 | 2667 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_THROW,0,0,0,&nIdx);` |
|        - | 2668 | `	/* Emit the jump */` |
|   547473 | 2669 | `	GenStateNewJumpFixup(pBlock,PH7_OP_THROW,nIdx);` |
|   547473 | 2670 | `	return SXRET_OK;` |
|   273739 | 2671 | `}` |
|        - | 2672 | `/*` |
...
|        - | 2916 | ` */` |
|    24862 | 2917 | `static sxi32 PH7_CompileCatch(ph7_gen_state *pGen,ph7_exception *pException)` |
|        5 | 2918 | `{` |
|    24867 | 2919 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|        - | 2926 | `	char *zDup;` |
|        - | 2927 | `	sxi32 rc;` |
|    24867 | 2928 | `	pGen->pIn++; /* Jump the 'catch' keyword */` |
|        - | 2929 | `	/* Zero the structure */` |
|    24867 | 2930 | `	SyZero(&sCatch,sizeof(ph7_exception_block));` |
|        - | 2931 | `	/* Initialize fields */` |
|    24867 | 2932 | `	SySetInit(&sCatch.aClasses,&pException->pVm->sAllocator,sizeof(SyString));` |
|    24867 | 2933 | `	SySetInit(&sCatch.sByteCode,&pException->pVm->sAllocator,sizeof(VmInstr));` |
|    24867 | 2934 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 /*(*/ ){` |
...
|    24867 | 2949 | `	pGen->pIn++; /* Jump the left parenthesis '(' */` |
|    12446 | 2950 | `	for(;;){` |
|        - | 2951 | `		SyBlob sResolved;` |
|    24897 | 2952 | `		SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|    24897 | 2953 | `		if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|    37337 | 2969 | `		zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|    24888 | 2970 | `			(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|    24893 | 2971 | `		SyStringInitFromBuf(&sClassName,zDup,SyBlobLength(&sResolved));` |
|    24893 | 2972 | `		SyBlobRelease(&sResolved);` |
|    24893 | 2973 | `		if( zDup == 0 ){` |
|      ! 0 | 2974 | `			goto Mem;` |
|        - | 2975 | `		}` |
|    24893 | 2976 | `		rc = SySetPut(&sCatch.aClasses,(const void *)&sClassName);` |
|    24893 | 2977 | `		if( rc != SXRET_OK ){` |
|      ! 0 | 2978 | `			goto Mem;` |
|        - | 2979 | `		}` |
|        - | 2980 | `		/* Check for '\|' (multi-catch separator) */` |
|    24888 | 2981 | `		if( pGen->pIn < pGen->pEnd &&` |
|    24888 | 2982 | `			(pGen->pIn->nType & PH7_TK_OP) &&` |
...
|    24863 | 2993 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_RPAREN) /*)*/ ){` |
|        7 | 2994 | `		goto CatchBody;` |
|        - | 2995 | `	}` |
|    24852 | 2996 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 /*$*/ \|\|` |
|    24857 | 2997 | `		&pGen->pIn[1] >= pGen->pEnd \|\| (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|        - | 3010 | `	}` |
|    24857 | 3011 | `	pGen->pIn++; /* Jump the dollar sign */` |
|        - | 3012 | `	/* Duplicate instance name */` |
|    24857 | 3013 | `	pName = &pGen->pIn->sData;` |
|    24857 | 3014 | `	zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|    24857 | 3015 | `	if( zDup == 0 ){` |
|      ! 0 | 3016 | `		goto Mem;` |
|        - | 3017 | `	}` |
|    24857 | 3018 | `	SyStringInitFromBuf(&sCatch.sThis,zDup,pName->nByte);` |
|    24857 | 3019 | `	pGen->pIn++;` |
|    12429 | 3020 | `CatchBody:` |
|    24863 | 3021 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_RPAREN) == 0 /*)*/ ){` |
...
|    24863 | 3036 | `	pGen->pIn++; /* Jump the right parenthesis */` |
|        - | 3037 | `	/* Create the catch block */` |
|    24863 | 3038 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_EXCEPTION,PH7_VmInstrLength(pGen->pVm),0,&pCatch);` |
|    24863 | 3039 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 3040 | `		return SXERR_ABORT;` |
|        - | 3041 | `	}` |
|        - | 3042 | `	/* Swap bytecode container */` |
|    24863 | 3043 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|    24863 | 3044 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&sCatch.sByteCode);` |
|        - | 3045 | `	/* Compile the block */` |
|    24863 | 3046 | `	PH7_CompileBlock(&(*pGen),0);` |
|        - | 3047 | `	/* Fix forward jumps now the destination is resolved  */` |
|    24863 | 3048 | `	GenStateFixJumps(pCatch,-1,PH7_VmInstrLength(pGen->pVm));` |
|        - | 3049 | `	/* Emit the DONE instruction */` |
|    24863 | 3050 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|        - | 3051 | `	/* Leave the block */` |
|    24863 | 3052 | `	GenStateLeaveBlock(&(*pGen),0);` |
|        - | 3053 | `	/* Restore the default container */` |
|    24863 | 3054 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|        - | 3055 | `	/* Install the catch block */` |
|    24863 | 3056 | `	rc = SySetPut(&pException->sEntry,(const void *)&sCatch);` |
|    24863 | 3057 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 3058 | `		goto Mem;` |
|        - | 3059 | `	}` |
|    24863 | 3060 | `	return SXRET_OK;` |
|      ! 0 | 3061 | `Mem:` |
...
|        - | 3070 | ` * is "thrown".` |
|        - | 3071 | ` */` |
|    25020 | 3072 | `PH7_PRIVATE sxi32 PH7_CompileTry(ph7_gen_state *pGen)` |
|        5 | 3073 | `{` |
|        - | 3074 | `	ph7_exception *pException;` |
|    25025 | 3075 | `	sxu32 nLine = pGen->pIn->nLine;` |
|        - | 3076 | `	GenBlock *pTry;` |
|        - | 3077 | `	sxu32 nJmpIdx;` |
|        - | 3078 | `	sxi32 rc;` |
|        - | 3079 | `	/* Create the exception container */` |
|    25025 | 3080 | `	pException = (ph7_exception *)SyMemBackendAlloc(&pGen->pVm->sAllocator,sizeof(ph7_exception));` |
|    25025 | 3081 | `	if( pException == 0 ){` |
...
|    25025 | 3087 | `	SyZero(pException,sizeof(ph7_exception));` |
|        - | 3088 | `	/* Initialize fields */` |
|    25025 | 3089 | `	SySetInit(&pException->sEntry,&pGen->pVm->sAllocator,sizeof(ph7_exception_block));` |
|    25025 | 3090 | `	SySetInit(&pException->sFinally,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|    25025 | 3091 | `	pException->iHasFinally = 0;` |
|    25025 | 3092 | `	pException->iFinallyDone = 0;` |
|    25025 | 3093 | `	pException->pVm = pGen->pVm;` |
...
|    25025 | 3100 | `	if( pGen->bInGenerator && pGen->pVm->bInlineTryCatch ){` |
|      105 | 3101 | `		return PH7_CompileTryInline(&(*pGen),pException);` |
|        - | 3102 | `	}` |
|        - | 3103 | `	/* Create the try block */` |
|    24925 | 3104 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_EXCEPTION,PH7_VmInstrLength(pGen->pVm),0,&pTry);` |
|    24925 | 3105 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 3106 | `		return SXERR_ABORT;` |
|        - | 3107 | `	}` |
|        - | 3108 | `	/* Store exception pointer so break/continue can emit POP_EXCEPTION */` |
|    24925 | 3109 | `	pTry->pUserData = pException;` |
|        - | 3110 | `	/* Emit the 'LOAD_EXCEPTION' instruction */` |
|    24925 | 3111 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_EXCEPTION,0,0,pException,&nJmpIdx);` |
|        - | 3112 | `	/* Fix the jump later when the destination is resolved */` |
|    24925 | 3113 | `	GenStateNewJumpFixup(pTry,PH7_OP_LOAD_EXCEPTION,nJmpIdx);` |
|    24925 | 3114 | `	pGen->pIn++; /* Jump the 'try' keyword */` |
|        - | 3115 | `	/* Compile the block */` |
|    24925 | 3116 | `	rc = PH7_CompileBlock(&(*pGen),0);` |
|    24925 | 3117 | `	if( rc == SXERR_ABORT ){` |
|      ! 0 | 3118 | `		return SXERR_ABORT;` |
|        - | 3119 | `	}` |
|        - | 3120 | `	/* Fix forward jumps now the destination is resolved */` |
|    24925 | 3121 | `	GenStateFixJumps(pTry,-1,PH7_VmInstrLength(pGen->pVm));` |
|        - | 3122 | `	/* Emit the 'POP_EXCEPTION' instruction */` |
|    24925 | 3123 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP_EXCEPTION,0,0,pException,0);` |
|        - | 3124 | `	/* Leave the block */` |
|    24925 | 3125 | `	GenStateLeaveBlock(&(*pGen),0);` |
|        - | 3126 | `	/* Compile catch block(s) — at least one catch or finally is required */` |
|    24925 | 3127 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|    24918 | 3128 | `		SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_CATCH ){` |
|        - | 3129 | `		/* Compile one or more catch blocks */` |
|    24858 | 3130 | `		for(;;){` |
|    49716 | 3131 | `			if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0` |
|    37358 | 3132 | `				\|\| SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_CATCH ){` |
|    12432 | 3133 | `					break;` |
|        - | 3134 | `			}` |
|    24867 | 3135 | `			rc = PH7_CompileCatch(&(*pGen),pException);` |
|    24867 | 3136 | `			if( rc == SXERR_ABORT ){` |
|      ! 0 | 3137 | `				return SXERR_ABORT;` |
|        - | 3138 | `			}` |
|        5 | 3139 | `		}` |
|    12427 | 3140 | `	}` |
|        - | 3141 | `	/* Compile optional finally block */` |
|    24925 | 3142 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|      772 | 3143 | `		SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_FINALLY ){` |
...
|    24925 | 3172 | `	if( SySetUsed(&pException->sEntry) == 0 && !pException->iHasFinally ){` |
...
|        - | 3177 | `		}` |
|        3 | 3178 | `	}` |
|    24925 | 3179 | `	return SXRET_OK;` |
|    12515 | 3180 | `}` |
|        - | 3181 | `/*` |
|        - | 3182 | ` * Compile a switch block.` |
|        - | 3183 | ` *  (See block-comment below for more information)` |
|        - | 3184 | ` */` |
|   135912 | 3185 | `static sxi32 GenStateCompileSwitchBlock(ph7_gen_state *pGen,sxu32 iTokenDelim,sxu32 *pBlockStart)` |
|        5 | 3186 | `{` |
|   135917 | 3187 | `	sxi32 rc = SXRET_OK;` |
|   135917 | 3188 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & (PH7_TK_SEMI/*';'*/\|PH7_TK_COLON/*':'*/)) == 0 ){` |
...
|      ! 0 | 3194 | `		pGen->pIn++;` |
|      ! 0 | 3195 | `	}` |
|   135917 | 3196 | `	pGen->pIn++;` |
|        - | 3197 | `	/* First instruction to execute in this block. */` |
|   135917 | 3198 | `	*pBlockStart = PH7_VmInstrLength(pGen->pVm);` |
|        - | 3199 | `	/* Compile the block until we hit a case/default/endswitch keyword` |
|        - | 3200 | `	 * or the '}' token */` |
|   130186 | 3201 | `	for(;;){` |
|   260377 | 3202 | `		if( pGen->pIn >= pGen->pEnd ){` |
|        - | 3203 | `			/* No more input to process */` |
|      ! 0 | 3204 | `			break;` |
|        - | 3205 | `		}` |
|   260377 | 3206 | `		rc = SXRET_OK;` |
|   260377 | 3207 | `		if( (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
|    35005 | 3208 | `			if( pGen->pIn->nType & PH7_TK_CCB /*'}' */ ){` |
|    11671 | 3209 | `				if( iTokenDelim != PH7_TK_CCB ){` |
...
|        - | 3216 | `					/* FALL THROUGH */` |
|      ! 0 | 3217 | `				}` |
|    11671 | 3218 | `				rc = SXERR_EOF;` |
|    11671 | 3219 | `				break;` |
|        - | 3220 | `			}` |
|    11672 | 3221 | `		}else{` |
|        - | 3222 | `			sxi32 nKwrd;` |
|        - | 3223 | `			/* Extract the keyword */` |
|   225377 | 3224 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   225377 | 3225 | `			if( nKwrd == PH7_TKWRD_CASE \|\| nKwrd == PH7_TKWRD_DEFAULT ){` |
|    62127 | 3226 | `				break;` |
|        - | 3227 | `			}` |
|   101133 | 3228 | `			if( nKwrd == PH7_TKWRD_ENDSWITCH /* endswitch; */){` |
...
|        - | 3241 | `		}` |
|        - | 3242 | `		/* Compile block */` |
|   124465 | 3243 | `		rc = PH7_CompileBlock(&(*pGen),0);` |
|   124465 | 3244 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 | 3245 | `			return SXERR_ABORT;` |
|        - | 3246 | `		}` |
|        5 | 3247 | `	}` |
|   135917 | 3248 | `	return rc;` |
|    67961 | 3249 | `}` |
|        - | 3250 | `/*` |
|        - | 3251 | ` * Compile a case eXpression.` |
|        - | 3252 | ` *  (See block-comment below for more information)` |
|        - | 3253 | ` */` |
|   132012 | 3254 | `static sxi32 GenStateCompileCaseExpr(ph7_gen_state *pGen,ph7_case_expr *pExpr)` |
|        5 | 3255 | `{` |
|        - | 3256 | `	SySet *pInstrContainer;` |
|        - | 3257 | `	SyToken *pEnd,*pTmp;` |
|   132017 | 3258 | `	sxi32 iNest = 0;` |
|        - | 3259 | `	sxi32 rc;` |
|        - | 3260 | `	/* Delimit the expression */` |
|   132017 | 3261 | `	pEnd = pGen->pIn;` |
|   264037 | 3262 | `	while( pEnd < pGen->pEnd ){` |
|   264037 | 3263 | `		if( pEnd->nType & PH7_TK_LPAREN /*(*/ ){` |
|        - | 3264 | `			/* Increment nesting level */` |
|        3 | 3265 | `			iNest++;` |
|   264036 | 3266 | `		}else if( pEnd->nType & PH7_TK_RPAREN /*)*/ ){` |
|        - | 3267 | `			/* Decrement nesting level */` |
|        3 | 3268 | `			iNest--;` |
|   264034 | 3269 | `		}else if( pEnd->nType & (PH7_TK_SEMI/*';'*/\|PH7_TK_COLON/*;'*/) && iNest < 1 ){` |
|   132017 | 3270 | `			break;` |
|        - | 3271 | `		}` |
|   132025 | 3272 | `		pEnd++;` |
|        5 | 3273 | `	}` |
|   132017 | 3274 | `	if( pGen->pIn >= pEnd ){` |
...
|   132017 | 3282 | `	pTmp = pGen->pEnd;` |
|   132017 | 3283 | `	pGen->pEnd = pEnd;` |
|   132017 | 3284 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   132017 | 3285 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pExpr->aByteCode);` |
|   132017 | 3286 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|        - | 3287 | `	/* Emit the done instruction */` |
|   132017 | 3288 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,(rc != SXERR_EMPTY ? 1 : 0),0,0,0);` |
|   132017 | 3289 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|        - | 3290 | `	/* Update token stream */` |
|   132017 | 3291 | `	pGen->pIn  = pEnd;` |
|   132017 | 3292 | `	pGen->pEnd = pTmp;` |
|   132017 | 3293 | `	if( rc == SXERR_ABORT ){` |
|      ! 0 | 3294 | `		return SXERR_ABORT;` |
|        - | 3295 | `	}` |
|   132017 | 3296 | `	return SXRET_OK;` |
|    66011 | 3297 | `}` |
|        - | 3298 | `/*` |
...
|        - | 3322 | ` */` |
|    11668 | 3323 | `PH7_PRIVATE sxi32 PH7_CompileSwitch(ph7_gen_state *pGen)` |
|        5 | 3324 | `{` |
...
|        - | 3329 | `	sxu32 nLine;` |
|        - | 3330 | `	sxi32 rc;` |
|    11673 | 3331 | `	nLine = pGen->pIn->nLine;` |
|        - | 3332 | `	/* Jump the 'switch' keyword */` |
|    11673 | 3333 | `	pGen->pIn++;` |
|    11673 | 3334 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|        - | 3335 | `		/* Syntax error */` |
...
|    11673 | 3344 | `	pGen->pIn++;` |
|    11673 | 3345 | `	pEnd = 0; /* cc warning */` |
|        - | 3346 | `	/* Create the loop block */` |
|    17507 | 3347 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP\|GEN_BLOCK_SWITCH,` |
|     5834 | 3348 | `		PH7_VmInstrLength(pGen->pVm),0,&pSwitchBlock);` |
|    11673 | 3349 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 3350 | `		return SXERR_ABORT;` |
|        - | 3351 | `	}` |
|        - | 3352 | `	/* Delimit the condition */` |
|    11673 | 3353 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|    11673 | 3354 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|    11673 | 3363 | `	pTmp = pGen->pEnd;` |
|    11673 | 3364 | `	pGen->pEnd = pEnd;` |
|        - | 3365 | `	/* Compile the expression */` |
|    11673 | 3366 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|    11673 | 3367 | `	if( rc == SXERR_ABORT ){` |
|        - | 3368 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|      ! 0 | 3369 | `		return SXERR_ABORT;` |
|        - | 3370 | `	}` |
|        - | 3371 | `	/* Update token stream */` |
|    11673 | 3372 | `	while(pGen->pIn < pEnd ){` |
...
|      ! 0 | 3378 | `		pGen->pIn++;` |
|      ! 0 | 3379 | `	}` |
|    11673 | 3380 | `	pGen->pIn  = &pEnd[1];` |
|    11673 | 3381 | `	pGen->pEnd = pTmp;` |
|    11673 | 3382 | `	if( pGen->pIn >= pGen->pEnd \|\| &pGen->pIn[1] >= pGen->pEnd \|\|` |
|    11668 | 3383 | `		(pGen->pIn->nType & (PH7_TK_OCB/*'{'*/\|PH7_TK_COLON/*:*/)) == 0 ){` |
...
|    11673 | 3396 | `	if( pGen->pIn->nType & PH7_TK_COLON ){` |
|        3 | 3397 | `		nToken = PH7_TK_KEYWORD;` |
|        - | 3398 | `		/* Stop compilation when the 'endswitch;' keyword is seen */` |
|        2 | 3399 | `	}else{` |
|    11671 | 3400 | `		nToken = PH7_TK_CCB; /* '}' */` |
|        - | 3401 | `	}` |
|    11673 | 3402 | `	pGen->pIn++; /* Jump the leading curly braces/colons */` |
|        - | 3403 | `	/* Create the switch blocks container */` |
|    11673 | 3404 | `	pSwitch = (ph7_switch *)SyMemBackendAlloc(&pGen->pVm->sAllocator,sizeof(ph7_switch));` |
|    11673 | 3405 | `	if( pSwitch == 0 ){` |
...
|    11673 | 3411 | `	SyZero(pSwitch,sizeof(ph7_switch));` |
|        - | 3412 | `	/* Initialize fields */` |
|    11673 | 3413 | `	SySetInit(&pSwitch->aCaseExpr,&pGen->pVm->sAllocator,sizeof(ph7_case_expr));` |
|        - | 3414 | `	/* Emit the switch instruction */` |
|    11673 | 3415 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_SWITCH,0,0,pSwitch,0);` |
|        - | 3416 | `	/* Compile case blocks */` |
|   130080 | 3417 | `	for(;;){` |
|        - | 3418 | `		sxu32 nKwrd;` |
|   135919 | 3419 | `		if( pGen->pIn >= pGen->pEnd ){` |
|        - | 3420 | `			/* No more input to process */` |
|      ! 0 | 3421 | `			break;` |
|        - | 3422 | `		}` |
|   135919 | 3423 | `		if( (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|   135919 | 3437 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   135919 | 3438 | `		if( nKwrd == PH7_TKWRD_ENDSWITCH /* endswitch; */){` |
...
|        3 | 3449 | `			break;` |
|        - | 3450 | `		}` |
|   135917 | 3451 | `		if( nKwrd == PH7_TKWRD_DEFAULT ){` |
|        - | 3452 | `			/*` |
...
|        - | 3456 | `			 */` |
|     3905 | 3457 | `			if( pSwitch->nDefault > 0 ){` |
...
|        - | 3462 | `				}` |
|      ! 0 | 3463 | `			}` |
|     3905 | 3464 | `			pGen->pIn++; /* Jump the 'default' keyword */` |
|        - | 3465 | `			/* Compile the default block */` |
|     3905 | 3466 | `			rc = GenStateCompileSwitchBlock(pGen,nToken,&pSwitch->nDefault);` |
|     3905 | 3467 | `			if( rc == SXERR_ABORT){` |
|      ! 0 | 3468 | `				return SXERR_ABORT;` |
|     3905 | 3469 | `			}else if( rc == SXERR_EOF ){` |
|     3903 | 3470 | `				break;` |
|        1 | 3471 | `			}` |
|   132018 | 3472 | `		}else if( nKwrd == PH7_TKWRD_CASE ){` |
|        - | 3473 | `			ph7_case_expr sCase;` |
|        - | 3474 | `			/* Standard case block */` |
|   132017 | 3475 | `			pGen->pIn++; /* Jump the 'case' keyword */` |
|        - | 3476 | `			/* initialize the structure */` |
|   132017 | 3477 | `			SySetInit(&sCase.aByteCode,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|        - | 3478 | `			/* Compile the case expression */` |
|   132017 | 3479 | `			rc = GenStateCompileCaseExpr(pGen,&sCase);` |
|   132017 | 3480 | `			if( rc == SXERR_ABORT ){` |
|      ! 0 | 3481 | `				return SXERR_ABORT;` |
|        - | 3482 | `			}` |
|        - | 3483 | `			/* Compile the case block */` |
|   132017 | 3484 | `			rc = GenStateCompileSwitchBlock(pGen,nToken,&sCase.nStart);` |
|        - | 3485 | `			/* Insert in the switch container */` |
|   132017 | 3486 | `			SySetPut(&pSwitch->aCaseExpr,(const void *)&sCase);` |
|   132017 | 3487 | `			if( rc == SXERR_ABORT){` |
|      ! 0 | 3488 | `				return SXERR_ABORT;` |
|   132017 | 3489 | `			}else if( rc == SXERR_EOF ){` |
|     7773 | 3490 | `				break;` |
|        - | 3491 | `			}` |
|    62127 | 3492 | `		}else{` |
...
|    11673 | 3503 | `	pSwitch->nOut = PH7_VmInstrLength(pGen->pVm);` |
|    11673 | 3504 | `	GenStateFixJumps(pSwitchBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|        - | 3505 | `	/* Release the loop block */` |
|    11673 | 3506 | `	GenStateLeaveBlock(pGen,0);` |
|    11673 | 3507 | `	if( pGen->pIn < pGen->pEnd ){` |
|        - | 3508 | `		/* Jump the trailing curly braces or the endswitch keyword*/` |
|    11673 | 3509 | `		pGen->pIn++;` |
|     5834 | 3510 | `	}` |
|        - | 3511 | `	/* Statement successfully compiled */` |
|    11673 | 3512 | `	return SXRET_OK;` |
|      ! 0 | 3513 | `Synchronize:` |
