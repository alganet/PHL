...
|      - |   37 | ` */` |
|   3876 |   38 | `static void LibxmlGlobalInit(void)` |
|      5 |   39 | `{` |
|      - |   40 | `	static int bInit = 0;` |
|   3881 |   41 | `	if( !bInit ){` |
|   3881 |   42 | `		xmlInitParser();` |
|   3881 |   43 | `		bInit = 1;` |
|   1938 |   44 | `	}` |
|   3881 |   45 | `}` |
|      - |   46 | `/*` |
...
|      - |   70 | ` */` |
|   3414 |   71 | `PH7_PRIVATE void PH7_LibxmlVmReset(ph7_vm *pVm)` |
|      5 |   72 | `{` |
|      - |   73 | `	phl_xmldoc *pDoc,*pNext;` |
|   3419 |   74 | `	PH7_LibxmlClearErrors(pVm);` |
|   3419 |   75 | `	pVm->bLibxmlInternalErr = 0;` |
|   3419 |   76 | `	pDoc = (phl_xmldoc *)pVm->pXmlDocs;` |
|   3511 |   77 | `	while( pDoc ){` |
...
|      - |  114 | ` */` |
|   3464 |  115 | `static void LibxmlClearQueue(ph7_vm *pVm)` |
|      5 |  116 | `{` |
|   3469 |  117 | `	phl_libxml_err *aErr = (phl_libxml_err *)SySetBasePtr(&pVm->aLibxmlErr);` |
|      - |  118 | `	sxu32 n;` |
|   3483 |  119 | `	for( n = 0 ; n < SySetUsed(&pVm->aLibxmlErr) ; ++n ){` |
|     15 |  120 | `		LibxmlFreeErr(pVm,&aErr[n]);` |
|      8 |  121 | `	}` |
|   3469 |  122 | `	SySetReset(&pVm->aLibxmlErr);` |
|   3469 |  123 | `}` |
|      - |  124 | `/*` |
|      - |  125 | ` * libxml_clear_errors(): drop the queue AND the last-error slot.` |
|      - |  126 | ` */` |
|   3438 |  127 | `PH7_PRIVATE void PH7_LibxmlClearErrors(ph7_vm *pVm)` |
|      5 |  128 | `{` |
|   3443 |  129 | `	LibxmlClearQueue(pVm);` |
|   3443 |  130 | `	if( pVm->pLibxmlLastErr ){` |
...
|    ! 0 |  349 | `}` |
|      - |  350 |  |
|   3408 |  351 | `PH7_PRIVATE void PH7_RegisterLibxmlConstants(ph7_vm *pVm)` |
|      5 |  352 | `{` |
...
|      - |  396 | `	};` |
|      - |  397 | `	sxu32 n;` |
| 136325 |  398 | `	for( n = 0 ; n < sizeof(aConst)/sizeof(aConst[0]) ; n++ ){` |
| 132917 |  399 | `		ph7_create_constant(&(*pVm),aConst[n].zName,aConst[n].xExpand,0);` |
|  66461 |  400 | `	}` |
|   3413 |  401 | `}` |
...
|      - |  565 | ` */` |
|   3876 |  566 | `PH7_PRIVATE sxi32 PH7_VmInstallLibxml(ph7_vm *pVm)` |
|      5 |  567 | `{` |
...
|      - |  576 | `	};` |
|      - |  577 | `	sxu32 n;` |
|   3881 |  578 | `	LibxmlGlobalInit();` |
|   3881 |  579 | `	SySetInit(&pVm->aLibxmlErr,&pVm->sAllocator,sizeof(phl_libxml_err));` |
|   3881 |  580 | `	pVm->bLibxmlInternalErr = 0;` |
|   3881 |  581 | `	pVm->pLibxmlLastErr = 0;` |
|   3881 |  582 | `	pVm->pXmlDocs = 0;` |
|   3881 |  583 | `	pVm->pXmlWriters = 0;` |
|  19385 |  584 | `	for( n = 0 ; n < sizeof(aFunc)/sizeof(aFunc[0]) ; n++ ){` |
|  15509 |  585 | `		ph7_create_function(&(*pVm),aFunc[n].zName,aFunc[n].xFunc,0);` |
|   7757 |  586 | `	}` |
|   3881 |  587 | `	return PH7_VmEvalBuiltinChunk(&(*pVm),zLibxmlLib,sizeof(zLibxmlLib)-1);` |
|      5 |  588 | `}` |
|      - |  589 |  |
|      - |  590 | `#else` |
