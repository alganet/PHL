...
|      - |   37 | ` */` |
|   3870 |   38 | `static void LibxmlGlobalInit(void)` |
|      5 |   39 | `{` |
|      - |   40 | `	static int bInit = 0;` |
|   3875 |   41 | `	if( !bInit ){` |
|   3875 |   42 | `		xmlInitParser();` |
|   3875 |   43 | `		bInit = 1;` |
|   1935 |   44 | `	}` |
|   3875 |   45 | `}` |
|      - |   46 | `/*` |
...
|      - |   70 | ` */` |
|   3396 |   71 | `PH7_PRIVATE void PH7_LibxmlVmReset(ph7_vm *pVm)` |
|      5 |   72 | `{` |
|      - |   73 | `	phl_xmldoc *pDoc,*pNext;` |
|   3401 |   74 | `	PH7_LibxmlClearErrors(pVm);` |
|   3401 |   75 | `	pVm->bLibxmlInternalErr = 0;` |
|   3401 |   76 | `	pDoc = (phl_xmldoc *)pVm->pXmlDocs;` |
|   3493 |   77 | `	while( pDoc ){` |
...
|      - |  114 | ` */` |
|   3446 |  115 | `static void LibxmlClearQueue(ph7_vm *pVm)` |
|      5 |  116 | `{` |
|   3451 |  117 | `	phl_libxml_err *aErr = (phl_libxml_err *)SySetBasePtr(&pVm->aLibxmlErr);` |
|      - |  118 | `	sxu32 n;` |
|   3465 |  119 | `	for( n = 0 ; n < SySetUsed(&pVm->aLibxmlErr) ; ++n ){` |
|     15 |  120 | `		LibxmlFreeErr(pVm,&aErr[n]);` |
|      8 |  121 | `	}` |
|   3451 |  122 | `	SySetReset(&pVm->aLibxmlErr);` |
|   3451 |  123 | `}` |
|      - |  124 | `/*` |
|      - |  125 | ` * libxml_clear_errors(): drop the queue AND the last-error slot.` |
|      - |  126 | ` */` |
|   3420 |  127 | `PH7_PRIVATE void PH7_LibxmlClearErrors(ph7_vm *pVm)` |
|      5 |  128 | `{` |
|   3425 |  129 | `	LibxmlClearQueue(pVm);` |
|   3425 |  130 | `	if( pVm->pLibxmlLastErr ){` |
...
|    ! 0 |  349 | `}` |
|      - |  350 |  |
|   3390 |  351 | `PH7_PRIVATE void PH7_RegisterLibxmlConstants(ph7_vm *pVm)` |
|      5 |  352 | `{` |
...
|      - |  396 | `	};` |
|      - |  397 | `	sxu32 n;` |
| 135605 |  398 | `	for( n = 0 ; n < sizeof(aConst)/sizeof(aConst[0]) ; n++ ){` |
| 132215 |  399 | `		ph7_create_constant(&(*pVm),aConst[n].zName,aConst[n].xExpand,0);` |
|  66110 |  400 | `	}` |
|   3395 |  401 | `}` |
...
|      - |  565 | ` */` |
|   3870 |  566 | `PH7_PRIVATE sxi32 PH7_VmInstallLibxml(ph7_vm *pVm)` |
|      5 |  567 | `{` |
...
|      - |  576 | `	};` |
|      - |  577 | `	sxu32 n;` |
|   3875 |  578 | `	LibxmlGlobalInit();` |
|   3875 |  579 | `	SySetInit(&pVm->aLibxmlErr,&pVm->sAllocator,sizeof(phl_libxml_err));` |
|   3875 |  580 | `	pVm->bLibxmlInternalErr = 0;` |
|   3875 |  581 | `	pVm->pLibxmlLastErr = 0;` |
|   3875 |  582 | `	pVm->pXmlDocs = 0;` |
|   3875 |  583 | `	pVm->pXmlWriters = 0;` |
|  19355 |  584 | `	for( n = 0 ; n < sizeof(aFunc)/sizeof(aFunc[0]) ; n++ ){` |
|  15485 |  585 | `		ph7_create_function(&(*pVm),aFunc[n].zName,aFunc[n].xFunc,0);` |
|   7745 |  586 | `	}` |
|   3875 |  587 | `	return PH7_VmEvalBuiltinChunk(&(*pVm),zLibxmlLib,sizeof(zLibxmlLib)-1);` |
|      5 |  588 | `}` |
|      - |  589 |  |
|      - |  590 | `#else` |
