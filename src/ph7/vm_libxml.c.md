...
|      - |   37 | ` */` |
|   3890 |   38 | `static void LibxmlGlobalInit(void)` |
|      5 |   39 | `{` |
|      - |   40 | `	static int bInit = 0;` |
|   3895 |   41 | `	if( !bInit ){` |
|   3895 |   42 | `		xmlInitParser();` |
|   3895 |   43 | `		bInit = 1;` |
|   1945 |   44 | `	}` |
|   3895 |   45 | `}` |
|      - |   46 | `/*` |
...
|      - |   70 | ` */` |
|   3428 |   71 | `PH7_PRIVATE void PH7_LibxmlVmReset(ph7_vm *pVm)` |
|      5 |   72 | `{` |
|      - |   73 | `	phl_xmldoc *pDoc,*pNext;` |
|   3433 |   74 | `	PH7_LibxmlClearErrors(pVm);` |
|   3433 |   75 | `	pVm->bLibxmlInternalErr = 0;` |
|   3433 |   76 | `	pDoc = (phl_xmldoc *)pVm->pXmlDocs;` |
|   3525 |   77 | `	while( pDoc ){` |
...
|      - |  114 | ` */` |
|   3478 |  115 | `static void LibxmlClearQueue(ph7_vm *pVm)` |
|      5 |  116 | `{` |
|   3483 |  117 | `	phl_libxml_err *aErr = (phl_libxml_err *)SySetBasePtr(&pVm->aLibxmlErr);` |
|      - |  118 | `	sxu32 n;` |
|   3497 |  119 | `	for( n = 0 ; n < SySetUsed(&pVm->aLibxmlErr) ; ++n ){` |
|     15 |  120 | `		LibxmlFreeErr(pVm,&aErr[n]);` |
|      8 |  121 | `	}` |
|   3483 |  122 | `	SySetReset(&pVm->aLibxmlErr);` |
|   3483 |  123 | `}` |
|      - |  124 | `/*` |
|      - |  125 | ` * libxml_clear_errors(): drop the queue AND the last-error slot.` |
|      - |  126 | ` */` |
|   3452 |  127 | `PH7_PRIVATE void PH7_LibxmlClearErrors(ph7_vm *pVm)` |
|      5 |  128 | `{` |
|   3457 |  129 | `	LibxmlClearQueue(pVm);` |
|   3457 |  130 | `	if( pVm->pLibxmlLastErr ){` |
...
|    ! 0 |  349 | `}` |
|      - |  350 |  |
|   3422 |  351 | `PH7_PRIVATE void PH7_RegisterLibxmlConstants(ph7_vm *pVm)` |
|      5 |  352 | `{` |
...
|      - |  396 | `	};` |
|      - |  397 | `	sxu32 n;` |
| 136885 |  398 | `	for( n = 0 ; n < sizeof(aConst)/sizeof(aConst[0]) ; n++ ){` |
| 133463 |  399 | `		ph7_create_constant(&(*pVm),aConst[n].zName,aConst[n].xExpand,0);` |
|  66734 |  400 | `	}` |
|   3427 |  401 | `}` |
...
|      - |  565 | ` */` |
|   3890 |  566 | `PH7_PRIVATE sxi32 PH7_VmInstallLibxml(ph7_vm *pVm)` |
|      5 |  567 | `{` |
...
|      - |  576 | `	};` |
|      - |  577 | `	sxu32 n;` |
|   3895 |  578 | `	LibxmlGlobalInit();` |
|   3895 |  579 | `	SySetInit(&pVm->aLibxmlErr,&pVm->sAllocator,sizeof(phl_libxml_err));` |
|   3895 |  580 | `	pVm->bLibxmlInternalErr = 0;` |
|   3895 |  581 | `	pVm->pLibxmlLastErr = 0;` |
|   3895 |  582 | `	pVm->pXmlDocs = 0;` |
|   3895 |  583 | `	pVm->pXmlWriters = 0;` |
|  19455 |  584 | `	for( n = 0 ; n < sizeof(aFunc)/sizeof(aFunc[0]) ; n++ ){` |
|  15565 |  585 | `		ph7_create_function(&(*pVm),aFunc[n].zName,aFunc[n].xFunc,0);` |
|   7785 |  586 | `	}` |
|   3895 |  587 | `	return PH7_VmEvalBuiltinChunk(&(*pVm),zLibxmlLib,sizeof(zLibxmlLib)-1);` |
|      5 |  588 | `}` |
|      - |  589 |  |
|      - |  590 | `#else` |
