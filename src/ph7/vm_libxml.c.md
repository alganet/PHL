...
|      - |   37 | ` */` |
|   3886 |   38 | `static void LibxmlGlobalInit(void)` |
|      5 |   39 | `{` |
|      - |   40 | `	static int bInit = 0;` |
|   3891 |   41 | `	if( !bInit ){` |
|   3891 |   42 | `		xmlInitParser();` |
|   3891 |   43 | `		bInit = 1;` |
|   1943 |   44 | `	}` |
|   3891 |   45 | `}` |
|      - |   46 | `/*` |
...
|      - |  565 | ` */` |
|   3886 |  566 | `PH7_PRIVATE sxi32 PH7_VmInstallLibxml(ph7_vm *pVm)` |
|      5 |  567 | `{` |
...
|      - |  576 | `	};` |
|      - |  577 | `	sxu32 n;` |
|   3891 |  578 | `	LibxmlGlobalInit();` |
|   3891 |  579 | `	SySetInit(&pVm->aLibxmlErr,&pVm->sAllocator,sizeof(phl_libxml_err));` |
|   3891 |  580 | `	pVm->bLibxmlInternalErr = 0;` |
|   3891 |  581 | `	pVm->pLibxmlLastErr = 0;` |
|   3891 |  582 | `	pVm->pXmlDocs = 0;` |
|   3891 |  583 | `	pVm->pXmlWriters = 0;` |
|  19435 |  584 | `	for( n = 0 ; n < sizeof(aFunc)/sizeof(aFunc[0]) ; n++ ){` |
|  15549 |  585 | `		ph7_create_function(&(*pVm),aFunc[n].zName,aFunc[n].xFunc,0);` |
|   7777 |  586 | `	}` |
|   3891 |  587 | `	return PH7_VmEvalBuiltinChunk(&(*pVm),zLibxmlLib,sizeof(zLibxmlLib)-1);` |
|      5 |  588 | `}` |
|      - |  589 |  |
|      - |  590 | `#else` |
