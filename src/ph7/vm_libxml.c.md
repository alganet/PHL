...
|      - |   37 | ` */` |
|   3878 |   38 | `static void LibxmlGlobalInit(void)` |
|      5 |   39 | `{` |
|      - |   40 | `	static int bInit = 0;` |
|   3883 |   41 | `	if( !bInit ){` |
|   3883 |   42 | `		xmlInitParser();` |
|   3883 |   43 | `		bInit = 1;` |
|   1939 |   44 | `	}` |
|   3883 |   45 | `}` |
|      - |   46 | `/*` |
...
|      - |  565 | ` */` |
|   3878 |  566 | `PH7_PRIVATE sxi32 PH7_VmInstallLibxml(ph7_vm *pVm)` |
|      5 |  567 | `{` |
...
|      - |  576 | `	};` |
|      - |  577 | `	sxu32 n;` |
|   3883 |  578 | `	LibxmlGlobalInit();` |
|   3883 |  579 | `	SySetInit(&pVm->aLibxmlErr,&pVm->sAllocator,sizeof(phl_libxml_err));` |
|   3883 |  580 | `	pVm->bLibxmlInternalErr = 0;` |
|   3883 |  581 | `	pVm->pLibxmlLastErr = 0;` |
|   3883 |  582 | `	pVm->pXmlDocs = 0;` |
|   3883 |  583 | `	pVm->pXmlWriters = 0;` |
|  19395 |  584 | `	for( n = 0 ; n < sizeof(aFunc)/sizeof(aFunc[0]) ; n++ ){` |
|  15517 |  585 | `		ph7_create_function(&(*pVm),aFunc[n].zName,aFunc[n].xFunc,0);` |
|   7761 |  586 | `	}` |
|   3883 |  587 | `	return PH7_VmEvalBuiltinChunk(&(*pVm),zLibxmlLib,sizeof(zLibxmlLib)-1);` |
|      5 |  588 | `}` |
|      - |  589 |  |
|      - |  590 | `#else` |
