...
|      - |   37 | ` */` |
|   3868 |   38 | `static void LibxmlGlobalInit(void)` |
|      5 |   39 | `{` |
|      - |   40 | `	static int bInit = 0;` |
|   3873 |   41 | `	if( !bInit ){` |
|   3873 |   42 | `		xmlInitParser();` |
|   3873 |   43 | `		bInit = 1;` |
|   1934 |   44 | `	}` |
|   3873 |   45 | `}` |
|      - |   46 | `/*` |
...
|      - |   70 | ` */` |
|   3394 |   71 | `PH7_PRIVATE void PH7_LibxmlVmReset(ph7_vm *pVm)` |
|      5 |   72 | `{` |
|      - |   73 | `	phl_xmldoc *pDoc,*pNext;` |
|   3399 |   74 | `	PH7_LibxmlClearErrors(pVm);` |
|   3399 |   75 | `	pVm->bLibxmlInternalErr = 0;` |
|   3399 |   76 | `	pDoc = (phl_xmldoc *)pVm->pXmlDocs;` |
|   3491 |   77 | `	while( pDoc ){` |
...
|      - |  114 | ` */` |
|   3444 |  115 | `static void LibxmlClearQueue(ph7_vm *pVm)` |
|      5 |  116 | `{` |
|   3449 |  117 | `	phl_libxml_err *aErr = (phl_libxml_err *)SySetBasePtr(&pVm->aLibxmlErr);` |
|      - |  118 | `	sxu32 n;` |
|   3463 |  119 | `	for( n = 0 ; n < SySetUsed(&pVm->aLibxmlErr) ; ++n ){` |
|     15 |  120 | `		LibxmlFreeErr(pVm,&aErr[n]);` |
|      8 |  121 | `	}` |
|   3449 |  122 | `	SySetReset(&pVm->aLibxmlErr);` |
|   3449 |  123 | `}` |
|      - |  124 | `/*` |
|      - |  125 | ` * libxml_clear_errors(): drop the queue AND the last-error slot.` |
|      - |  126 | ` */` |
|   3418 |  127 | `PH7_PRIVATE void PH7_LibxmlClearErrors(ph7_vm *pVm)` |
|      5 |  128 | `{` |
|   3423 |  129 | `	LibxmlClearQueue(pVm);` |
|   3423 |  130 | `	if( pVm->pLibxmlLastErr ){` |
...
|    ! 0 |  349 | `}` |
|      - |  350 |  |
|   3388 |  351 | `PH7_PRIVATE void PH7_RegisterLibxmlConstants(ph7_vm *pVm)` |
|      5 |  352 | `{` |
...
|      - |  396 | `	};` |
|      - |  397 | `	sxu32 n;` |
| 135525 |  398 | `	for( n = 0 ; n < sizeof(aConst)/sizeof(aConst[0]) ; n++ ){` |
| 132137 |  399 | `		ph7_create_constant(&(*pVm),aConst[n].zName,aConst[n].xExpand,0);` |
|  66071 |  400 | `	}` |
|   3393 |  401 | `}` |
...
|      - |  565 | ` */` |
|   3868 |  566 | `PH7_PRIVATE sxi32 PH7_VmInstallLibxml(ph7_vm *pVm)` |
|      5 |  567 | `{` |
...
|      - |  576 | `	};` |
|      - |  577 | `	sxu32 n;` |
|   3873 |  578 | `	LibxmlGlobalInit();` |
|   3873 |  579 | `	SySetInit(&pVm->aLibxmlErr,&pVm->sAllocator,sizeof(phl_libxml_err));` |
|   3873 |  580 | `	pVm->bLibxmlInternalErr = 0;` |
|   3873 |  581 | `	pVm->pLibxmlLastErr = 0;` |
|   3873 |  582 | `	pVm->pXmlDocs = 0;` |
|   3873 |  583 | `	pVm->pXmlWriters = 0;` |
|  19345 |  584 | `	for( n = 0 ; n < sizeof(aFunc)/sizeof(aFunc[0]) ; n++ ){` |
|  15477 |  585 | `		ph7_create_function(&(*pVm),aFunc[n].zName,aFunc[n].xFunc,0);` |
|   7741 |  586 | `	}` |
|   3873 |  587 | `	return PH7_VmEvalBuiltinChunk(&(*pVm),zLibxmlLib,sizeof(zLibxmlLib)-1);` |
|      5 |  588 | `}` |
|      - |  589 |  |
|      - |  590 | `#else` |
