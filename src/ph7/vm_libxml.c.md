...
|      - |   37 | ` */` |
|   3872 |   38 | `static void LibxmlGlobalInit(void)` |
|      5 |   39 | `{` |
|      - |   40 | `	static int bInit = 0;` |
|   3877 |   41 | `	if( !bInit ){` |
|   3877 |   42 | `		xmlInitParser();` |
|   3877 |   43 | `		bInit = 1;` |
|   1936 |   44 | `	}` |
|   3877 |   45 | `}` |
|      - |   46 | `/*` |
...
|      - |   70 | ` */` |
|   3398 |   71 | `PH7_PRIVATE void PH7_LibxmlVmReset(ph7_vm *pVm)` |
|      5 |   72 | `{` |
|      - |   73 | `	phl_xmldoc *pDoc,*pNext;` |
|   3403 |   74 | `	PH7_LibxmlClearErrors(pVm);` |
|   3403 |   75 | `	pVm->bLibxmlInternalErr = 0;` |
|   3403 |   76 | `	pDoc = (phl_xmldoc *)pVm->pXmlDocs;` |
|   3495 |   77 | `	while( pDoc ){` |
...
|      - |  114 | ` */` |
|   3448 |  115 | `static void LibxmlClearQueue(ph7_vm *pVm)` |
|      5 |  116 | `{` |
|   3453 |  117 | `	phl_libxml_err *aErr = (phl_libxml_err *)SySetBasePtr(&pVm->aLibxmlErr);` |
|      - |  118 | `	sxu32 n;` |
|   3467 |  119 | `	for( n = 0 ; n < SySetUsed(&pVm->aLibxmlErr) ; ++n ){` |
|     15 |  120 | `		LibxmlFreeErr(pVm,&aErr[n]);` |
|      8 |  121 | `	}` |
|   3453 |  122 | `	SySetReset(&pVm->aLibxmlErr);` |
|   3453 |  123 | `}` |
|      - |  124 | `/*` |
|      - |  125 | ` * libxml_clear_errors(): drop the queue AND the last-error slot.` |
|      - |  126 | ` */` |
|   3422 |  127 | `PH7_PRIVATE void PH7_LibxmlClearErrors(ph7_vm *pVm)` |
|      5 |  128 | `{` |
|   3427 |  129 | `	LibxmlClearQueue(pVm);` |
|   3427 |  130 | `	if( pVm->pLibxmlLastErr ){` |
...
|    ! 0 |  349 | `}` |
|      - |  350 |  |
|   3392 |  351 | `PH7_PRIVATE void PH7_RegisterLibxmlConstants(ph7_vm *pVm)` |
|      5 |  352 | `{` |
...
|      - |  396 | `	};` |
|      - |  397 | `	sxu32 n;` |
| 135685 |  398 | `	for( n = 0 ; n < sizeof(aConst)/sizeof(aConst[0]) ; n++ ){` |
| 132293 |  399 | `		ph7_create_constant(&(*pVm),aConst[n].zName,aConst[n].xExpand,0);` |
|  66149 |  400 | `	}` |
|   3397 |  401 | `}` |
...
|      - |  565 | ` */` |
|   3872 |  566 | `PH7_PRIVATE sxi32 PH7_VmInstallLibxml(ph7_vm *pVm)` |
|      5 |  567 | `{` |
...
|      - |  576 | `	};` |
|      - |  577 | `	sxu32 n;` |
|   3877 |  578 | `	LibxmlGlobalInit();` |
|   3877 |  579 | `	SySetInit(&pVm->aLibxmlErr,&pVm->sAllocator,sizeof(phl_libxml_err));` |
|   3877 |  580 | `	pVm->bLibxmlInternalErr = 0;` |
|   3877 |  581 | `	pVm->pLibxmlLastErr = 0;` |
|   3877 |  582 | `	pVm->pXmlDocs = 0;` |
|   3877 |  583 | `	pVm->pXmlWriters = 0;` |
|  19365 |  584 | `	for( n = 0 ; n < sizeof(aFunc)/sizeof(aFunc[0]) ; n++ ){` |
|  15493 |  585 | `		ph7_create_function(&(*pVm),aFunc[n].zName,aFunc[n].xFunc,0);` |
|   7749 |  586 | `	}` |
|   3877 |  587 | `	return PH7_VmEvalBuiltinChunk(&(*pVm),zLibxmlLib,sizeof(zLibxmlLib)-1);` |
|      5 |  588 | `}` |
|      - |  589 |  |
|      - |  590 | `#else` |
