...
|      - |   37 | ` */` |
|   3892 |   38 | `static void LibxmlGlobalInit(void)` |
|      5 |   39 | `{` |
|      - |   40 | `	static int bInit = 0;` |
|   3897 |   41 | `	if( !bInit ){` |
|   3897 |   42 | `		xmlInitParser();` |
|   3897 |   43 | `		bInit = 1;` |
|   1946 |   44 | `	}` |
|   3897 |   45 | `}` |
|      - |   46 | `/*` |
...
|      - |   70 | ` */` |
|   3430 |   71 | `PH7_PRIVATE void PH7_LibxmlVmReset(ph7_vm *pVm)` |
|      5 |   72 | `{` |
|      - |   73 | `	phl_xmldoc *pDoc,*pNext;` |
|   3435 |   74 | `	PH7_LibxmlClearErrors(pVm);` |
|   3435 |   75 | `	pVm->bLibxmlInternalErr = 0;` |
|   3435 |   76 | `	pDoc = (phl_xmldoc *)pVm->pXmlDocs;` |
|   3527 |   77 | `	while( pDoc ){` |
...
|      - |  114 | ` */` |
|   3480 |  115 | `static void LibxmlClearQueue(ph7_vm *pVm)` |
|      5 |  116 | `{` |
|   3485 |  117 | `	phl_libxml_err *aErr = (phl_libxml_err *)SySetBasePtr(&pVm->aLibxmlErr);` |
|      - |  118 | `	sxu32 n;` |
|   3499 |  119 | `	for( n = 0 ; n < SySetUsed(&pVm->aLibxmlErr) ; ++n ){` |
|     15 |  120 | `		LibxmlFreeErr(pVm,&aErr[n]);` |
|      8 |  121 | `	}` |
|   3485 |  122 | `	SySetReset(&pVm->aLibxmlErr);` |
|   3485 |  123 | `}` |
|      - |  124 | `/*` |
|      - |  125 | ` * libxml_clear_errors(): drop the queue AND the last-error slot.` |
|      - |  126 | ` */` |
|   3454 |  127 | `PH7_PRIVATE void PH7_LibxmlClearErrors(ph7_vm *pVm)` |
|      5 |  128 | `{` |
|   3459 |  129 | `	LibxmlClearQueue(pVm);` |
|   3459 |  130 | `	if( pVm->pLibxmlLastErr ){` |
...
|    ! 0 |  349 | `}` |
|      - |  350 |  |
|   3424 |  351 | `PH7_PRIVATE void PH7_RegisterLibxmlConstants(ph7_vm *pVm)` |
|      5 |  352 | `{` |
...
|      - |  396 | `	};` |
|      - |  397 | `	sxu32 n;` |
| 136965 |  398 | `	for( n = 0 ; n < sizeof(aConst)/sizeof(aConst[0]) ; n++ ){` |
| 133541 |  399 | `		ph7_create_constant(&(*pVm),aConst[n].zName,aConst[n].xExpand,0);` |
|  66773 |  400 | `	}` |
|   3429 |  401 | `}` |
...
|      - |  565 | ` */` |
|   3892 |  566 | `PH7_PRIVATE sxi32 PH7_VmInstallLibxml(ph7_vm *pVm)` |
|      5 |  567 | `{` |
...
|      - |  576 | `	};` |
|      - |  577 | `	sxu32 n;` |
|   3897 |  578 | `	LibxmlGlobalInit();` |
|   3897 |  579 | `	SySetInit(&pVm->aLibxmlErr,&pVm->sAllocator,sizeof(phl_libxml_err));` |
|   3897 |  580 | `	pVm->bLibxmlInternalErr = 0;` |
|   3897 |  581 | `	pVm->pLibxmlLastErr = 0;` |
|   3897 |  582 | `	pVm->pXmlDocs = 0;` |
|   3897 |  583 | `	pVm->pXmlWriters = 0;` |
|  19465 |  584 | `	for( n = 0 ; n < sizeof(aFunc)/sizeof(aFunc[0]) ; n++ ){` |
|  15573 |  585 | `		ph7_create_function(&(*pVm),aFunc[n].zName,aFunc[n].xFunc,0);` |
|   7789 |  586 | `	}` |
|   3897 |  587 | `	return PH7_VmEvalBuiltinChunk(&(*pVm),zLibxmlLib,sizeof(zLibxmlLib)-1);` |
|      5 |  588 | `}` |
|      - |  589 |  |
|      - |  590 | `#else` |
