...
|     5 |   45 |  |
|  4353 |   46 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |   47 | `	VmObEntry *pOb;` |
|     - |   48 | `	/* Pop the top most OB */` |
|  4353 |   49 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  4353 |   50 | `	if( pOb == 0){` |
...
|   ! 0 |   55 | `	}else{` |
|     - |   56 | `		/* Release */` |
|  4353 |   57 | `		VmObRestore(pVm,pOb);` |
|     - |   58 | `		/* Return true */` |
|  4353 |   59 | `		ph7_result_bool(pCtx,1);` |
|     - |   60 | `	}` |
|  4353 |   61 | `	return PH7_OK;` |
|     5 |   62 |  |
|     - |   63 | `/*` |
...
|     - |   96 | ` */` |
|  5696 |   97 | `PH7_PRIVATE int vm_builtin_ob_get_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     3 |   98 |  |
|  5699 |   99 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  100 | `	VmObEntry *pOb;` |
|     - |  101 | `	/* Pop the top most OB */` |
|  5699 |  102 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  5699 |  103 | `	if( pOb == 0 ){` |
...
|   ! 0 |  108 | `	}else{` |
|     - |  109 | `		/* Return contents */` |
|  5699 |  110 | `		ph7_result_string(pCtx,(const char *)SyBlobData(&pOb->sOB),(int)SyBlobLength(&pOb->sOB)); /* Will make it's own copy */` |
|     - |  111 | `		/* Release */` |
|  5699 |  112 | `		VmObRestore(pVm,pOb);` |
|     - |  113 | `	}` |
|  5699 |  114 | `	return PH7_OK;` |
|     3 |  115 |  |
|     - |  116 | `/*` |
...
|     - |  165 | ` */` |
| 14428 |  166 | `PH7_PRIVATE int VmObConsumer(const void *pData,unsigned int nDataLen,void *pUserData)` |
|     5 |  167 |  |
| 14433 |  168 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|     - |  169 | `	VmObEntry *pEntry;` |
|     - |  170 | `	ph7_value sResult;` |
|     - |  171 | `	/* Peek the top most entry */` |
| 14433 |  172 | `	pEntry = (VmObEntry *)SySetPeek(&pVm->aOB);` |
| 14433 |  173 | `	if( pEntry == 0 ){` |
|     - |  174 | `		/* CAN'T HAPPEN */` |
|   ! 0 |  175 | `		return PH7_OK;` |
|     - |  176 | `	}` |
| 14433 |  177 | `	PH7_MemObjInit(pVm,&sResult);` |
| 14433 |  178 | `	if( ph7_value_is_callable(&pEntry->sCallback) && pVm->nObDepth < 15 ){` |
...
|   ! 0 |  194 | `	}` |
| 14433 |  195 | `	if( nDataLen > 0 ){` |
|     - |  196 | `		/* Redirect the VM output to the internal buffer */` |
| 14433 |  197 | `		SyBlobAppend(&pEntry->sOB,pData,nDataLen);` |
|  7214 |  198 | `	}` |
|     - |  199 | `	/* Release */` |
| 14433 |  200 | `	PH7_MemObjRelease(&sResult);` |
| 14433 |  201 | `	return PH7_OK;` |
|  7219 |  202 |  |
|     - |  203 | `/*` |
...
|     - |  206 | ` * information.` |
|     - |  207 | ` */` |
| 10046 |  208 | `static void VmObRestore(ph7_vm *pVm,VmObEntry *pEntry)` |
|     5 |  209 |  |
| 10051 |  210 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
| 10051 |  211 | `	if( SySetUsed(&pVm->aOB) < 1 ){` |
|     - |  212 | `		/* No more stackable OB */` |
| 10033 |  213 | `		pCons->xConsumer = pCons->xDef;` |
| 10033 |  214 | `		pCons->pUserData = pCons->pDefData;` |
|  5014 |  215 | `	}` |
|     - |  216 | `	/* Release OB data */` |
| 10051 |  217 | `	PH7_MemObjRelease(&pEntry->sCallback);` |
| 10051 |  218 | `	SyBlobRelease(&pEntry->sOB);` |
| 10051 |  219 |  |
|     - |  220 | `/*` |
...
|     - |  242 | ` */` |
| 10046 |  243 | `PH7_PRIVATE int vm_builtin_ob_start(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 |  244 |  |
| 10051 |  245 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  246 | `	VmObEntry sOb;` |
|     - |  247 | `	sxi32 rc;` |
|     - |  248 | `	/* Initialize the OB entry */` |
| 10051 |  249 | `	PH7_MemObjInit(pCtx->pVm,&sOb.sCallback);` |
| 10051 |  250 | `	SyBlobInit(&sOb.sOB,&pVm->sAllocator);` |
| 10051 |  251 | `	if( nArg > 0 && (apArg[0]->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ)) ){` |
...
| 10051 |  256 | `	rc = SySetPut(&pVm->aOB,(const void *)&sOb);` |
| 10051 |  257 | `	if( rc != SXRET_OK ){` |
|   ! 0 |  258 | `		PH7_MemObjRelease(&sOb.sCallback);` |
|   ! 0 |  259 | `	}else{` |
| 10051 |  260 | `		ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|     - |  261 | `		/* Substitute the default VM consumer */` |
| 10051 |  262 | `		if( pCons->xConsumer != VmObConsumer ){` |
| 10033 |  263 | `			pCons->xDef = pCons->xConsumer;` |
| 10033 |  264 | `			pCons->pDefData = pCons->pUserData;` |
|     - |  265 | `			/* Install the new consumer */` |
| 10033 |  266 | `			pCons->xConsumer = VmObConsumer;` |
| 10033 |  267 | `			pCons->pUserData = pVm;` |
|  5014 |  268 | `		}` |
|     - |  269 | `	}` |
| 10051 |  270 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
| 10051 |  271 | `	return PH7_OK;` |
|     5 |  272 |  |
|     - |  273 | `/*` |
...
|     2 |  279 |  |
|     6 |  280 | `	SyBlob *pBlob = &pEntry->sOB;` |
|     - |  281 | `	sxi32 rc;` |
|     - |  282 | `	/* Flush contents */` |
|     6 |  283 | `	rc = PH7_OK;` |
|     6 |  284 | `	if( SyBlobLength(pBlob) > 0 ){` |
|     - |  285 | `		/* Call the VM output consumer */` |
|     6 |  286 | `		rc = pVm->sVmConsumer.xDef(SyBlobData(pBlob),SyBlobLength(pBlob),pVm->sVmConsumer.pDefData);` |
|     - |  287 | `		/* Increment VM output counter */` |
|     6 |  288 | `		pVm->nOutputLen += SyBlobLength(pBlob);` |
|     6 |  289 | `		if( rc != PH7_ABORT ){` |
|     6 |  290 | `			rc = PH7_OK;` |
|     2 |  291 | `		}` |
|     2 |  292 | `	}` |
|     6 |  293 | `	if( bRelease ){` |
