...
|     - |  165 | ` */` |
| 24516 |  166 | `PH7_PRIVATE int VmObConsumer(const void *pData,unsigned int nDataLen,void *pUserData)` |
|     5 |  167 | `{` |
| 24521 |  168 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|     - |  169 | `	VmObEntry *pEntry;` |
|     - |  170 | `	ph7_value sResult;` |
|     - |  171 | `	/* Peek the top most entry */` |
| 24521 |  172 | `	pEntry = (VmObEntry *)SySetPeek(&pVm->aOB);` |
| 24521 |  173 | `	if( pEntry == 0 ){` |
|     - |  174 | `		/* CAN'T HAPPEN */` |
|   ! 0 |  175 | `		return PH7_OK;` |
|     - |  176 | `	}` |
| 24521 |  177 | `	PH7_MemObjInit(pVm,&sResult);` |
| 24521 |  178 | `	if( ph7_value_is_callable(&pEntry->sCallback) && pVm->nObDepth < 15 ){` |
...
|   ! 0 |  201 | `	}` |
| 24521 |  202 | `	if( nDataLen > 0 ){` |
|     - |  203 | `		/* Redirect the VM output to the internal buffer */` |
| 24521 |  204 | `		SyBlobAppend(&pEntry->sOB,pData,nDataLen);` |
| 12258 |  205 | `	}` |
|     - |  206 | `	/* Release */` |
| 24521 |  207 | `	PH7_MemObjRelease(&sResult);` |
| 24521 |  208 | `	return PH7_OK;` |
| 12263 |  209 | `}` |
|     - |  210 | `/*` |
...
|     - |  213 | ` * information.` |
|     - |  214 | ` */` |
|  9744 |  215 | `static void VmObRestore(ph7_vm *pVm,VmObEntry *pEntry)` |
|     5 |  216 | `{` |
|  9749 |  217 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|  9749 |  218 | `	if( SySetUsed(&pVm->aOB) < 1 ){` |
|     - |  219 | `		/* No more stackable OB */` |
|  9731 |  220 | `		pCons->xConsumer = pCons->xDef;` |
|  9731 |  221 | `		pCons->pUserData = pCons->pDefData;` |
|  4863 |  222 | `	}` |
|     - |  223 | `	/* Release OB data */` |
|  9749 |  224 | `	PH7_MemObjRelease(&pEntry->sCallback);` |
|  9749 |  225 | `	SyBlobRelease(&pEntry->sOB);` |
|  9749 |  226 | `}` |
|     - |  227 | `/*` |
...
|  9731 |  270 | `			pCons->xDef = pCons->xConsumer;` |
|  9731 |  271 | `			pCons->pDefData = pCons->pUserData;` |
|     - |  272 | `			/* Install the new consumer */` |
|  9731 |  273 | `			pCons->xConsumer = VmObConsumer;` |
|  9731 |  274 | `			pCons->pUserData = pVm;` |
|  4863 |  275 | `		}` |
|     - |  276 | `	}` |
