...
|     - |   96 | ` */` |
|  4942 |   97 | `PH7_PRIVATE int vm_builtin_ob_get_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     2 |   98 | `{` |
|  4944 |   99 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  100 | `	VmObEntry *pOb;` |
|     - |  101 | `	/* Pop the top most OB */` |
|  4944 |  102 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  4944 |  103 | `	if( pOb == 0 ){` |
...
|   ! 0 |  108 | `	}else{` |
|     - |  109 | `		/* Return contents */` |
|  4944 |  110 | `		ph7_result_string(pCtx,(const char *)SyBlobData(&pOb->sOB),(int)SyBlobLength(&pOb->sOB)); /* Will make it's own copy */` |
|     - |  111 | `		/* Release */` |
|  4944 |  112 | `		VmObRestore(pVm,pOb);` |
|     - |  113 | `	}` |
|  4944 |  114 | `	return PH7_OK;` |
|     2 |  115 | `}` |
|     - |  116 | `/*` |
...
|     - |  165 | ` */` |
| 29896 |  166 | `PH7_PRIVATE int VmObConsumer(const void *pData,unsigned int nDataLen,void *pUserData)` |
|     5 |  167 | `{` |
| 29901 |  168 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|     - |  169 | `	VmObEntry *pEntry;` |
|     - |  170 | `	ph7_value sResult;` |
|     - |  171 | `	/* Peek the top most entry */` |
| 29901 |  172 | `	pEntry = (VmObEntry *)SySetPeek(&pVm->aOB);` |
| 29901 |  173 | `	if( pEntry == 0 ){` |
|     - |  174 | `		/* CAN'T HAPPEN */` |
|   ! 0 |  175 | `		return PH7_OK;` |
|     - |  176 | `	}` |
| 29901 |  177 | `	PH7_MemObjInit(pVm,&sResult);` |
| 29901 |  178 | `	if( ph7_value_is_callable(&pEntry->sCallback) && pVm->nObDepth < 15 ){` |
...
|   ! 0 |  201 | `	}` |
| 29901 |  202 | `	if( nDataLen > 0 ){` |
|     - |  203 | `		/* Redirect the VM output to the internal buffer */` |
| 29901 |  204 | `		SyBlobAppend(&pEntry->sOB,pData,nDataLen);` |
| 14948 |  205 | `	}` |
|     - |  206 | `	/* Release */` |
| 29901 |  207 | `	PH7_MemObjRelease(&sResult);` |
| 29901 |  208 | `	return PH7_OK;` |
| 14953 |  209 | `}` |
|     - |  210 | `/*` |
...
|     - |  213 | ` * information.` |
|     - |  214 | ` */` |
|  9072 |  215 | `static void VmObRestore(ph7_vm *pVm,VmObEntry *pEntry)` |
|     4 |  216 | `{` |
|  9076 |  217 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|  9076 |  218 | `	if( SySetUsed(&pVm->aOB) < 1 ){` |
|     - |  219 | `		/* No more stackable OB */` |
|  9058 |  220 | `		pCons->xConsumer = pCons->xDef;` |
|  9058 |  221 | `		pCons->pUserData = pCons->pDefData;` |
|  4527 |  222 | `	}` |
|     - |  223 | `	/* Release OB data */` |
|  9076 |  224 | `	PH7_MemObjRelease(&pEntry->sCallback);` |
|  9076 |  225 | `	SyBlobRelease(&pEntry->sOB);` |
|  9076 |  226 | `}` |
|     - |  227 | `/*` |
...
|     - |  249 | ` */` |
|  9076 |  250 | `PH7_PRIVATE int vm_builtin_ob_start(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 |  251 | `{` |
|  9081 |  252 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  253 | `	VmObEntry sOb;` |
|     - |  254 | `	sxi32 rc;` |
|     - |  255 | `	/* Initialize the OB entry */` |
|  9081 |  256 | `	PH7_MemObjInit(pCtx->pVm,&sOb.sCallback);` |
|  9081 |  257 | `	SyBlobInit(&sOb.sOB,&pVm->sAllocator);` |
|  9081 |  258 | `	if( nArg > 0 && (apArg[0]->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ)) ){` |
...
|  9081 |  263 | `	rc = SySetPut(&pVm->aOB,(const void *)&sOb);` |
|  9081 |  264 | `	if( rc != SXRET_OK ){` |
|   ! 0 |  265 | `		PH7_MemObjRelease(&sOb.sCallback);` |
|   ! 0 |  266 | `	}else{` |
|  9081 |  267 | `		ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|     - |  268 | `		/* Substitute the default VM consumer */` |
|  9081 |  269 | `		if( pCons->xConsumer != VmObConsumer ){` |
|  9061 |  270 | `			pCons->xDef = pCons->xConsumer;` |
|  9061 |  271 | `			pCons->pDefData = pCons->pUserData;` |
|     - |  272 | `			/* Install the new consumer */` |
|  9061 |  273 | `			pCons->xConsumer = VmObConsumer;` |
|  9061 |  274 | `			pCons->pUserData = pVm;` |
|  4528 |  275 | `		}` |
|     - |  276 | `	}` |
|  9081 |  277 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|  9081 |  278 | `	return PH7_OK;` |
|     5 |  279 | `}` |
|     - |  280 | `/*` |
