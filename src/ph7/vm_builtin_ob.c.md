...
|     - |   43 | ` */` |
|  4352 |   44 | `PH7_PRIVATE int vm_builtin_ob_end_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     4 |   45 | `{` |
|  4356 |   46 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |   47 | `	VmObEntry *pOb;` |
|     - |   48 | `	/* Pop the top most OB */` |
|  4356 |   49 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  4356 |   50 | `	if( pOb == 0){` |
...
|   ! 0 |   55 | `	}else{` |
|     - |   56 | `		/* Release */` |
|  4356 |   57 | `		VmObRestore(pVm,pOb);` |
|     - |   58 | `		/* Return true */` |
|  4356 |   59 | `		ph7_result_bool(pCtx,1);` |
|     - |   60 | `	}` |
|  4356 |   61 | `	return PH7_OK;` |
|     4 |   62 | `}` |
|     - |   63 | `/*` |
...
|     - |   96 | ` */` |
|  5332 |   97 | `PH7_PRIVATE int vm_builtin_ob_get_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     2 |   98 | `{` |
|  5334 |   99 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  100 | `	VmObEntry *pOb;` |
|     - |  101 | `	/* Pop the top most OB */` |
|  5334 |  102 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  5334 |  103 | `	if( pOb == 0 ){` |
...
|   ! 0 |  108 | `	}else{` |
|     - |  109 | `		/* Return contents */` |
|  5334 |  110 | `		ph7_result_string(pCtx,(const char *)SyBlobData(&pOb->sOB),(int)SyBlobLength(&pOb->sOB)); /* Will make it's own copy */` |
|     - |  111 | `		/* Release */` |
|  5334 |  112 | `		VmObRestore(pVm,pOb);` |
|     - |  113 | `	}` |
|  5334 |  114 | `	return PH7_OK;` |
|     2 |  115 | `}` |
|     - |  116 | `/*` |
...
|     - |  165 | ` */` |
| 29164 |  166 | `PH7_PRIVATE int VmObConsumer(const void *pData,unsigned int nDataLen,void *pUserData)` |
|     5 |  167 | `{` |
| 29169 |  168 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|     - |  169 | `	VmObEntry *pEntry;` |
|     - |  170 | `	ph7_value sResult;` |
|     - |  171 | `	/* Peek the top most entry */` |
| 29169 |  172 | `	pEntry = (VmObEntry *)SySetPeek(&pVm->aOB);` |
| 29169 |  173 | `	if( pEntry == 0 ){` |
|     - |  174 | `		/* CAN'T HAPPEN */` |
|   ! 0 |  175 | `		return PH7_OK;` |
|     - |  176 | `	}` |
| 29169 |  177 | `	PH7_MemObjInit(pVm,&sResult);` |
| 29169 |  178 | `	if( ph7_value_is_callable(&pEntry->sCallback) && pVm->nObDepth < 15 ){` |
...
|   ! 0 |  201 | `	}` |
| 29169 |  202 | `	if( nDataLen > 0 ){` |
|     - |  203 | `		/* Redirect the VM output to the internal buffer */` |
| 29169 |  204 | `		SyBlobAppend(&pEntry->sOB,pData,nDataLen);` |
| 14582 |  205 | `	}` |
|     - |  206 | `	/* Release */` |
| 29169 |  207 | `	PH7_MemObjRelease(&sResult);` |
| 29169 |  208 | `	return PH7_OK;` |
| 14587 |  209 | `}` |
|     - |  210 | `/*` |
...
|     4 |  216 | `{` |
|  9692 |  217 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|  9692 |  218 | `	if( SySetUsed(&pVm->aOB) < 1 ){` |
|     - |  219 | `		/* No more stackable OB */` |
|  9674 |  220 | `		pCons->xConsumer = pCons->xDef;` |
|  9674 |  221 | `		pCons->pUserData = pCons->pDefData;` |
|  4835 |  222 | `	}` |
|     - |  223 | `	/* Release OB data */` |
|  9692 |  224 | `	PH7_MemObjRelease(&pEntry->sCallback);` |
|  9692 |  225 | `	SyBlobRelease(&pEntry->sOB);` |
|  9692 |  226 | `}` |
|     - |  227 | `/*` |
...
|     - |  249 | ` */` |
|  9692 |  250 | `PH7_PRIVATE int vm_builtin_ob_start(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 |  251 | `{` |
|  9697 |  252 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  253 | `	VmObEntry sOb;` |
|     - |  254 | `	sxi32 rc;` |
|     - |  255 | `	/* Initialize the OB entry */` |
|  9697 |  256 | `	PH7_MemObjInit(pCtx->pVm,&sOb.sCallback);` |
|  9697 |  257 | `	SyBlobInit(&sOb.sOB,&pVm->sAllocator);` |
|  9697 |  258 | `	if( nArg > 0 && (apArg[0]->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ)) ){` |
...
|  9697 |  263 | `	rc = SySetPut(&pVm->aOB,(const void *)&sOb);` |
|  9697 |  264 | `	if( rc != SXRET_OK ){` |
|   ! 0 |  265 | `		PH7_MemObjRelease(&sOb.sCallback);` |
|   ! 0 |  266 | `	}else{` |
|  9697 |  267 | `		ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|     - |  268 | `		/* Substitute the default VM consumer */` |
|  9697 |  269 | `		if( pCons->xConsumer != VmObConsumer ){` |
|  9677 |  270 | `			pCons->xDef = pCons->xConsumer;` |
|  9677 |  271 | `			pCons->pDefData = pCons->pUserData;` |
|     - |  272 | `			/* Install the new consumer */` |
|  9677 |  273 | `			pCons->xConsumer = VmObConsumer;` |
|  9677 |  274 | `			pCons->pUserData = pVm;` |
|  4836 |  275 | `		}` |
|     - |  276 | `	}` |
|  9697 |  277 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|  9697 |  278 | `	return PH7_OK;` |
|     5 |  279 | `}` |
|     - |  280 | `/*` |
