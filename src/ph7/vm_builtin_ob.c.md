...
|     - |   43 | ` */` |
|  4034 |   44 | `PH7_PRIVATE int vm_builtin_ob_end_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     2 |   45 |  |
|  4036 |   46 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |   47 | `	VmObEntry *pOb;` |
|     - |   48 | `	/* Pop the top most OB */` |
|  4036 |   49 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  4036 |   50 | `	if( pOb == 0){` |
...
|   ! 0 |   55 | `	}else{` |
|     - |   56 | `		/* Release */` |
|  4036 |   57 | `		VmObRestore(pVm,pOb);` |
|     - |   58 | `		/* Return true */` |
|  4036 |   59 | `		ph7_result_bool(pCtx,1);` |
|     - |   60 | `	}` |
|  4036 |   61 | `	return PH7_OK;` |
|     2 |   62 |  |
|     - |   63 | `/*` |
...
|     - |  165 | ` */` |
| 11022 |  166 | `PH7_PRIVATE int VmObConsumer(const void *pData,unsigned int nDataLen,void *pUserData)` |
|     2 |  167 |  |
| 11024 |  168 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|     - |  169 | `	VmObEntry *pEntry;` |
|     - |  170 | `	ph7_value sResult;` |
|     - |  171 | `	/* Peek the top most entry */` |
| 11024 |  172 | `	pEntry = (VmObEntry *)SySetPeek(&pVm->aOB);` |
| 11024 |  173 | `	if( pEntry == 0 ){` |
|     - |  174 | `		/* CAN'T HAPPEN */` |
|   ! 0 |  175 | `		return PH7_OK;` |
|     - |  176 | `	}` |
| 11024 |  177 | `	PH7_MemObjInit(pVm,&sResult);` |
| 11024 |  178 | `	if( ph7_value_is_callable(&pEntry->sCallback) && pVm->nObDepth < 15 ){` |
...
|   ! 0 |  194 | `	}` |
| 11024 |  195 | `	if( nDataLen > 0 ){` |
|     - |  196 | `		/* Redirect the VM output to the internal buffer */` |
| 11024 |  197 | `		SyBlobAppend(&pEntry->sOB,pData,nDataLen);` |
|  5511 |  198 | `	}` |
|     - |  199 | `	/* Release */` |
| 11024 |  200 | `	PH7_MemObjRelease(&sResult);` |
| 11024 |  201 | `	return PH7_OK;` |
|  5513 |  202 |  |
|     - |  203 | `/*` |
...
|     - |  206 | ` * information.` |
|     - |  207 | ` */` |
|  9328 |  208 | `static void VmObRestore(ph7_vm *pVm,VmObEntry *pEntry)` |
|     2 |  209 |  |
|  9330 |  210 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|  9330 |  211 | `	if( SySetUsed(&pVm->aOB) < 1 ){` |
|     - |  212 | `		/* No more stackable OB */` |
|  9312 |  213 | `		pCons->xConsumer = pCons->xDef;` |
|  9312 |  214 | `		pCons->pUserData = pCons->pDefData;` |
|  4655 |  215 | `	}` |
|     - |  216 | `	/* Release OB data */` |
|  9330 |  217 | `	PH7_MemObjRelease(&pEntry->sCallback);` |
|  9330 |  218 | `	SyBlobRelease(&pEntry->sOB);` |
|  9330 |  219 |  |
|     - |  220 | `/*` |
...
|     - |  242 | ` */` |
|  9328 |  243 | `PH7_PRIVATE int vm_builtin_ob_start(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     2 |  244 |  |
|  9330 |  245 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  246 | `	VmObEntry sOb;` |
|     - |  247 | `	sxi32 rc;` |
|     - |  248 | `	/* Initialize the OB entry */` |
|  9330 |  249 | `	PH7_MemObjInit(pCtx->pVm,&sOb.sCallback);` |
|  9330 |  250 | `	SyBlobInit(&sOb.sOB,&pVm->sAllocator);` |
|  9330 |  251 | `	if( nArg > 0 && (apArg[0]->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP)) ){` |
|     - |  252 | `		/* Save the callback name for later invocation */` |
|   ! 0 |  253 | `		PH7_MemObjStore(apArg[0],&sOb.sCallback);` |
|   ! 0 |  254 | `	}` |
|     - |  255 | `	/* Push in the stack */` |
|  9330 |  256 | `	rc = SySetPut(&pVm->aOB,(const void *)&sOb);` |
|  9330 |  257 | `	if( rc != SXRET_OK ){` |
|   ! 0 |  258 | `		PH7_MemObjRelease(&sOb.sCallback);` |
|   ! 0 |  259 | `	}else{` |
|  9330 |  260 | `		ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|     - |  261 | `		/* Substitute the default VM consumer */` |
|  9330 |  262 | `		if( pCons->xConsumer != VmObConsumer ){` |
|  9312 |  263 | `			pCons->xDef = pCons->xConsumer;` |
|  9312 |  264 | `			pCons->pDefData = pCons->pUserData;` |
|     - |  265 | `			/* Install the new consumer */` |
|  9312 |  266 | `			pCons->xConsumer = VmObConsumer;` |
|  9312 |  267 | `			pCons->pUserData = pVm;` |
|  4655 |  268 | `		}` |
|     - |  269 | `	}` |
|  9330 |  270 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|  9330 |  271 | `	return PH7_OK;` |
|     2 |  272 |  |
|     - |  273 | `/*` |
