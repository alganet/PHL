...
|     - |   43 | ` */` |
|  4264 |   44 | `PH7_PRIVATE int vm_builtin_ob_end_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 |   45 | `{` |
|  4269 |   46 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |   47 | `	VmObEntry *pOb;` |
|     - |   48 | `	/* Pop the top most OB */` |
|  4269 |   49 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  4269 |   50 | `	if( pOb == 0){` |
...
|   ! 0 |   55 | `	}else{` |
|     - |   56 | `		/* Release */` |
|  4269 |   57 | `		VmObRestore(pVm,pOb);` |
|     - |   58 | `		/* Return true */` |
|  4269 |   59 | `		ph7_result_bool(pCtx,1);` |
|     - |   60 | `	}` |
|  4269 |   61 | `	return PH7_OK;` |
|     5 |   62 | `}` |
|     - |   63 | `/*` |
...
|     - |  165 | ` */` |
| 27722 |  166 | `PH7_PRIVATE int VmObConsumer(const void *pData,unsigned int nDataLen,void *pUserData)` |
|     5 |  167 | `{` |
| 27727 |  168 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|     - |  169 | `	VmObEntry *pEntry;` |
|     - |  170 | `	ph7_value sResult;` |
|     - |  171 | `	/* Peek the top most entry */` |
| 27727 |  172 | `	pEntry = (VmObEntry *)SySetPeek(&pVm->aOB);` |
| 27727 |  173 | `	if( pEntry == 0 ){` |
|     - |  174 | `		/* CAN'T HAPPEN */` |
|   ! 0 |  175 | `		return PH7_OK;` |
|     - |  176 | `	}` |
| 27727 |  177 | `	PH7_MemObjInit(pVm,&sResult);` |
| 27727 |  178 | `	if( ph7_value_is_callable(&pEntry->sCallback) && pVm->nObDepth < 15 ){` |
...
|   ! 0 |  201 | `	}` |
| 27727 |  202 | `	if( nDataLen > 0 ){` |
|     - |  203 | `		/* Redirect the VM output to the internal buffer */` |
| 27727 |  204 | `		SyBlobAppend(&pEntry->sOB,pData,nDataLen);` |
| 13861 |  205 | `	}` |
|     - |  206 | `	/* Release */` |
| 27727 |  207 | `	PH7_MemObjRelease(&sResult);` |
| 27727 |  208 | `	return PH7_OK;` |
| 13866 |  209 | `}` |
|     - |  210 | `/*` |
