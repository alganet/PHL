...
|     - |   96 | ` */` |
|  5548 |   97 | `PH7_PRIVATE int vm_builtin_ob_get_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     3 |   98 |  |
|  5551 |   99 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  100 | `	VmObEntry *pOb;` |
|     - |  101 | `	/* Pop the top most OB */` |
|  5551 |  102 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  5551 |  103 | `	if( pOb == 0 ){` |
...
|   ! 0 |  108 | `	}else{` |
|     - |  109 | `		/* Return contents */` |
|  5551 |  110 | `		ph7_result_string(pCtx,(const char *)SyBlobData(&pOb->sOB),(int)SyBlobLength(&pOb->sOB)); /* Will make it's own copy */` |
|     - |  111 | `		/* Release */` |
|  5551 |  112 | `		VmObRestore(pVm,pOb);` |
|     - |  113 | `	}` |
|  5551 |  114 | `	return PH7_OK;` |
|     3 |  115 |  |
|     - |  116 | `/*` |
...
|     - |  165 | ` */` |
| 13002 |  166 | `PH7_PRIVATE int VmObConsumer(const void *pData,unsigned int nDataLen,void *pUserData)` |
|     5 |  167 |  |
| 13007 |  168 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|     - |  169 | `	VmObEntry *pEntry;` |
|     - |  170 | `	ph7_value sResult;` |
|     - |  171 | `	/* Peek the top most entry */` |
| 13007 |  172 | `	pEntry = (VmObEntry *)SySetPeek(&pVm->aOB);` |
| 13007 |  173 | `	if( pEntry == 0 ){` |
|     - |  174 | `		/* CAN'T HAPPEN */` |
|   ! 0 |  175 | `		return PH7_OK;` |
|     - |  176 | `	}` |
| 13007 |  177 | `	PH7_MemObjInit(pVm,&sResult);` |
| 13007 |  178 | `	if( ph7_value_is_callable(&pEntry->sCallback) && pVm->nObDepth < 15 ){` |
...
|   ! 0 |  194 | `	}` |
| 13007 |  195 | `	if( nDataLen > 0 ){` |
|     - |  196 | `		/* Redirect the VM output to the internal buffer */` |
| 13007 |  197 | `		SyBlobAppend(&pEntry->sOB,pData,nDataLen);` |
|  6501 |  198 | `	}` |
|     - |  199 | `	/* Release */` |
| 13007 |  200 | `	PH7_MemObjRelease(&sResult);` |
| 13007 |  201 | `	return PH7_OK;` |
|  6506 |  202 |  |
|     - |  203 | `/*` |
...
|     - |  206 | ` * information.` |
|     - |  207 | ` */` |
|  9800 |  208 | `static void VmObRestore(ph7_vm *pVm,VmObEntry *pEntry)` |
|     5 |  209 |  |
|  9805 |  210 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|  9805 |  211 | `	if( SySetUsed(&pVm->aOB) < 1 ){` |
|     - |  212 | `		/* No more stackable OB */` |
|  9787 |  213 | `		pCons->xConsumer = pCons->xDef;` |
|  9787 |  214 | `		pCons->pUserData = pCons->pDefData;` |
|  4891 |  215 | `	}` |
|     - |  216 | `	/* Release OB data */` |
|  9805 |  217 | `	PH7_MemObjRelease(&pEntry->sCallback);` |
|  9805 |  218 | `	SyBlobRelease(&pEntry->sOB);` |
|  9805 |  219 |  |
|     - |  220 | `/*` |
...
|     - |  242 | ` */` |
|  9800 |  243 | `PH7_PRIVATE int vm_builtin_ob_start(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 |  244 |  |
|  9805 |  245 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  246 | `	VmObEntry sOb;` |
|     - |  247 | `	sxi32 rc;` |
|     - |  248 | `	/* Initialize the OB entry */` |
|  9805 |  249 | `	PH7_MemObjInit(pCtx->pVm,&sOb.sCallback);` |
|  9805 |  250 | `	SyBlobInit(&sOb.sOB,&pVm->sAllocator);` |
|  9805 |  251 | `	if( nArg > 0 && (apArg[0]->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP)) ){` |
|     - |  252 | `		/* Save the callback name for later invocation */` |
|   ! 0 |  253 | `		PH7_MemObjStore(apArg[0],&sOb.sCallback);` |
|   ! 0 |  254 | `	}` |
|     - |  255 | `	/* Push in the stack */` |
|  9805 |  256 | `	rc = SySetPut(&pVm->aOB,(const void *)&sOb);` |
|  9805 |  257 | `	if( rc != SXRET_OK ){` |
|   ! 0 |  258 | `		PH7_MemObjRelease(&sOb.sCallback);` |
|   ! 0 |  259 | `	}else{` |
|  9805 |  260 | `		ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|     - |  261 | `		/* Substitute the default VM consumer */` |
|  9805 |  262 | `		if( pCons->xConsumer != VmObConsumer ){` |
|  9787 |  263 | `			pCons->xDef = pCons->xConsumer;` |
|  9787 |  264 | `			pCons->pDefData = pCons->pUserData;` |
|     - |  265 | `			/* Install the new consumer */` |
|  9787 |  266 | `			pCons->xConsumer = VmObConsumer;` |
|  9787 |  267 | `			pCons->pUserData = pVm;` |
|  4891 |  268 | `		}` |
|     - |  269 | `	}` |
|  9805 |  270 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|  9805 |  271 | `	return PH7_OK;` |
|     5 |  272 |  |
|     - |  273 | `/*` |
