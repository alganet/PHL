...
|     - |   96 | ` */` |
|  5168 |   97 | `PH7_PRIVATE int vm_builtin_ob_get_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     2 |   98 | `{` |
|  5170 |   99 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  100 | `	VmObEntry *pOb;` |
|     - |  101 | `	/* Pop the top most OB */` |
|  5170 |  102 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  5170 |  103 | `	if( pOb == 0 ){` |
...
|   ! 0 |  108 | `	}else{` |
|     - |  109 | `		/* Return contents */` |
|  5170 |  110 | `		ph7_result_string(pCtx,(const char *)SyBlobData(&pOb->sOB),(int)SyBlobLength(&pOb->sOB)); /* Will make it's own copy */` |
|     - |  111 | `		/* Release */` |
|  5170 |  112 | `		VmObRestore(pVm,pOb);` |
|     - |  113 | `	}` |
|  5170 |  114 | `	return PH7_OK;` |
|     2 |  115 | `}` |
|     - |  116 | `/*` |
...
|     - |  165 | ` */` |
| 29378 |  166 | `PH7_PRIVATE int VmObConsumer(const void *pData,unsigned int nDataLen,void *pUserData)` |
|     5 |  167 | `{` |
| 29383 |  168 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|     - |  169 | `	VmObEntry *pEntry;` |
|     - |  170 | `	ph7_value sResult;` |
|     - |  171 | `	/* Peek the top most entry */` |
| 29383 |  172 | `	pEntry = (VmObEntry *)SySetPeek(&pVm->aOB);` |
| 29383 |  173 | `	if( pEntry == 0 ){` |
|     - |  174 | `		/* CAN'T HAPPEN */` |
|   ! 0 |  175 | `		return PH7_OK;` |
|     - |  176 | `	}` |
| 29383 |  177 | `	PH7_MemObjInit(pVm,&sResult);` |
| 29383 |  178 | `	if( ph7_value_is_callable(&pEntry->sCallback) && pVm->nObDepth < 15 ){` |
...
|   ! 0 |  201 | `	}` |
| 29383 |  202 | `	if( nDataLen > 0 ){` |
|     - |  203 | `		/* Redirect the VM output to the internal buffer */` |
| 29383 |  204 | `		SyBlobAppend(&pEntry->sOB,pData,nDataLen);` |
| 14689 |  205 | `	}` |
|     - |  206 | `	/* Release */` |
| 29383 |  207 | `	PH7_MemObjRelease(&sResult);` |
| 29383 |  208 | `	return PH7_OK;` |
| 14694 |  209 | `}` |
|     - |  210 | `/*` |
...
|     - |  213 | ` * information.` |
|     - |  214 | ` */` |
|  9420 |  215 | `static void VmObRestore(ph7_vm *pVm,VmObEntry *pEntry)` |
|     4 |  216 | `{` |
|  9424 |  217 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|  9424 |  218 | `	if( SySetUsed(&pVm->aOB) < 1 ){` |
|     - |  219 | `		/* No more stackable OB */` |
|  9406 |  220 | `		pCons->xConsumer = pCons->xDef;` |
|  9406 |  221 | `		pCons->pUserData = pCons->pDefData;` |
|  4701 |  222 | `	}` |
|     - |  223 | `	/* Release OB data */` |
|  9424 |  224 | `	PH7_MemObjRelease(&pEntry->sCallback);` |
|  9424 |  225 | `	SyBlobRelease(&pEntry->sOB);` |
|  9424 |  226 | `}` |
|     - |  227 | `/*` |
...
|     - |  249 | ` */` |
|  9424 |  250 | `PH7_PRIVATE int vm_builtin_ob_start(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 |  251 | `{` |
|  9429 |  252 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  253 | `	VmObEntry sOb;` |
|     - |  254 | `	sxi32 rc;` |
|     - |  255 | `	/* Initialize the OB entry */` |
|  9429 |  256 | `	PH7_MemObjInit(pCtx->pVm,&sOb.sCallback);` |
|  9429 |  257 | `	SyBlobInit(&sOb.sOB,&pVm->sAllocator);` |
|  9429 |  258 | `	if( nArg > 0 && (apArg[0]->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ)) ){` |
...
|  9429 |  263 | `	rc = SySetPut(&pVm->aOB,(const void *)&sOb);` |
|  9429 |  264 | `	if( rc != SXRET_OK ){` |
|   ! 0 |  265 | `		PH7_MemObjRelease(&sOb.sCallback);` |
|   ! 0 |  266 | `	}else{` |
|  9429 |  267 | `		ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|     - |  268 | `		/* Substitute the default VM consumer */` |
|  9429 |  269 | `		if( pCons->xConsumer != VmObConsumer ){` |
|  9409 |  270 | `			pCons->xDef = pCons->xConsumer;` |
|  9409 |  271 | `			pCons->pDefData = pCons->pUserData;` |
|     - |  272 | `			/* Install the new consumer */` |
|  9409 |  273 | `			pCons->xConsumer = VmObConsumer;` |
|  9409 |  274 | `			pCons->pUserData = pVm;` |
|  4702 |  275 | `		}` |
|     - |  276 | `	}` |
|  9429 |  277 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|  9429 |  278 | `	return PH7_OK;` |
|     5 |  279 | `}` |
|     - |  280 | `/*` |
