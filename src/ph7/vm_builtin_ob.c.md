...
|     2 |   45 |  |
|  4146 |   46 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |   47 | `	VmObEntry *pOb;` |
|     - |   48 | `	/* Pop the top most OB */` |
|  4146 |   49 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  4146 |   50 | `	if( pOb == 0){` |
...
|   ! 0 |   55 | `	}else{` |
|     - |   56 | `		/* Release */` |
|  4146 |   57 | `		VmObRestore(pVm,pOb);` |
|     - |   58 | `		/* Return true */` |
|  4146 |   59 | `		ph7_result_bool(pCtx,1);` |
|     - |   60 | `	}` |
|  4146 |   61 | `	return PH7_OK;` |
|     2 |   62 |  |
|     - |   63 | `/*` |
...
|     2 |   98 |  |
|  5444 |   99 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  100 | `	VmObEntry *pOb;` |
|     - |  101 | `	/* Pop the top most OB */` |
|  5444 |  102 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  5444 |  103 | `	if( pOb == 0 ){` |
...
|   ! 0 |  108 | `	}else{` |
|     - |  109 | `		/* Return contents */` |
|  5444 |  110 | `		ph7_result_string(pCtx,(const char *)SyBlobData(&pOb->sOB),(int)SyBlobLength(&pOb->sOB)); /* Will make it's own copy */` |
|     - |  111 | `		/* Release */` |
|  5444 |  112 | `		VmObRestore(pVm,pOb);` |
|     - |  113 | `	}` |
|  5444 |  114 | `	return PH7_OK;` |
|     2 |  115 |  |
|     - |  116 | `/*` |
...
|     - |  165 | ` */` |
| 12398 |  166 | `PH7_PRIVATE int VmObConsumer(const void *pData,unsigned int nDataLen,void *pUserData)` |
|     2 |  167 |  |
| 12400 |  168 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|     - |  169 | `	VmObEntry *pEntry;` |
|     - |  170 | `	ph7_value sResult;` |
|     - |  171 | `	/* Peek the top most entry */` |
| 12400 |  172 | `	pEntry = (VmObEntry *)SySetPeek(&pVm->aOB);` |
| 12400 |  173 | `	if( pEntry == 0 ){` |
|     - |  174 | `		/* CAN'T HAPPEN */` |
|   ! 0 |  175 | `		return PH7_OK;` |
|     - |  176 | `	}` |
| 12400 |  177 | `	PH7_MemObjInit(pVm,&sResult);` |
| 12400 |  178 | `	if( ph7_value_is_callable(&pEntry->sCallback) && pVm->nObDepth < 15 ){` |
...
|   ! 0 |  194 | `	}` |
| 12400 |  195 | `	if( nDataLen > 0 ){` |
|     - |  196 | `		/* Redirect the VM output to the internal buffer */` |
| 12400 |  197 | `		SyBlobAppend(&pEntry->sOB,pData,nDataLen);` |
|  6199 |  198 | `	}` |
|     - |  199 | `	/* Release */` |
| 12400 |  200 | `	PH7_MemObjRelease(&sResult);` |
| 12400 |  201 | `	return PH7_OK;` |
|  6201 |  202 |  |
|     - |  203 | `/*` |
...
|     - |  206 | ` * information.` |
|     - |  207 | ` */` |
|  9588 |  208 | `static void VmObRestore(ph7_vm *pVm,VmObEntry *pEntry)` |
|     2 |  209 |  |
|  9590 |  210 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|  9590 |  211 | `	if( SySetUsed(&pVm->aOB) < 1 ){` |
|     - |  212 | `		/* No more stackable OB */` |
|  9572 |  213 | `		pCons->xConsumer = pCons->xDef;` |
|  9572 |  214 | `		pCons->pUserData = pCons->pDefData;` |
|  4785 |  215 | `	}` |
|     - |  216 | `	/* Release OB data */` |
|  9590 |  217 | `	PH7_MemObjRelease(&pEntry->sCallback);` |
|  9590 |  218 | `	SyBlobRelease(&pEntry->sOB);` |
|  9590 |  219 |  |
|     - |  220 | `/*` |
...
|     - |  242 | ` */` |
|  9588 |  243 | `PH7_PRIVATE int vm_builtin_ob_start(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     2 |  244 |  |
|  9590 |  245 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  246 | `	VmObEntry sOb;` |
|     - |  247 | `	sxi32 rc;` |
|     - |  248 | `	/* Initialize the OB entry */` |
|  9590 |  249 | `	PH7_MemObjInit(pCtx->pVm,&sOb.sCallback);` |
|  9590 |  250 | `	SyBlobInit(&sOb.sOB,&pVm->sAllocator);` |
|  9590 |  251 | `	if( nArg > 0 && (apArg[0]->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP)) ){` |
|     - |  252 | `		/* Save the callback name for later invocation */` |
|   ! 0 |  253 | `		PH7_MemObjStore(apArg[0],&sOb.sCallback);` |
|   ! 0 |  254 | `	}` |
|     - |  255 | `	/* Push in the stack */` |
|  9590 |  256 | `	rc = SySetPut(&pVm->aOB,(const void *)&sOb);` |
|  9590 |  257 | `	if( rc != SXRET_OK ){` |
|   ! 0 |  258 | `		PH7_MemObjRelease(&sOb.sCallback);` |
|   ! 0 |  259 | `	}else{` |
|  9590 |  260 | `		ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|     - |  261 | `		/* Substitute the default VM consumer */` |
|  9590 |  262 | `		if( pCons->xConsumer != VmObConsumer ){` |
|  9572 |  263 | `			pCons->xDef = pCons->xConsumer;` |
|  9572 |  264 | `			pCons->pDefData = pCons->pUserData;` |
|     - |  265 | `			/* Install the new consumer */` |
|  9572 |  266 | `			pCons->xConsumer = VmObConsumer;` |
|  9572 |  267 | `			pCons->pUserData = pVm;` |
|  4785 |  268 | `		}` |
|     - |  269 | `	}` |
|  9590 |  270 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|  9590 |  271 | `	return PH7_OK;` |
|     2 |  272 |  |
|     - |  273 | `/*` |
