...
|     5 |   45 |  |
|  4375 |   46 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |   47 | `	VmObEntry *pOb;` |
|     - |   48 | `	/* Pop the top most OB */` |
|  4375 |   49 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  4375 |   50 | `	if( pOb == 0){` |
...
|   ! 0 |   55 | `	}else{` |
|     - |   56 | `		/* Release */` |
|  4375 |   57 | `		VmObRestore(pVm,pOb);` |
|     - |   58 | `		/* Return true */` |
|  4375 |   59 | `		ph7_result_bool(pCtx,1);` |
|     - |   60 | `	}` |
|  4375 |   61 | `	return PH7_OK;` |
|     5 |   62 |  |
|     - |   63 | `/*` |
...
|     - |  165 | ` */` |
| 14890 |  166 | `PH7_PRIVATE int VmObConsumer(const void *pData,unsigned int nDataLen,void *pUserData)` |
|     5 |  167 |  |
| 14895 |  168 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|     - |  169 | `	VmObEntry *pEntry;` |
|     - |  170 | `	ph7_value sResult;` |
|     - |  171 | `	/* Peek the top most entry */` |
| 14895 |  172 | `	pEntry = (VmObEntry *)SySetPeek(&pVm->aOB);` |
| 14895 |  173 | `	if( pEntry == 0 ){` |
|     - |  174 | `		/* CAN'T HAPPEN */` |
|   ! 0 |  175 | `		return PH7_OK;` |
|     - |  176 | `	}` |
| 14895 |  177 | `	PH7_MemObjInit(pVm,&sResult);` |
| 14895 |  178 | `	if( ph7_value_is_callable(&pEntry->sCallback) && pVm->nObDepth < 15 ){` |
...
|   ! 0 |  194 | `	}` |
| 14895 |  195 | `	if( nDataLen > 0 ){` |
|     - |  196 | `		/* Redirect the VM output to the internal buffer */` |
| 14895 |  197 | `		SyBlobAppend(&pEntry->sOB,pData,nDataLen);` |
|  7445 |  198 | `	}` |
|     - |  199 | `	/* Release */` |
| 14895 |  200 | `	PH7_MemObjRelease(&sResult);` |
| 14895 |  201 | `	return PH7_OK;` |
|  7450 |  202 |  |
|     - |  203 | `/*` |
...
|     - |  206 | ` * information.` |
|     - |  207 | ` */` |
| 10088 |  208 | `static void VmObRestore(ph7_vm *pVm,VmObEntry *pEntry)` |
|     5 |  209 |  |
| 10093 |  210 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
| 10093 |  211 | `	if( SySetUsed(&pVm->aOB) < 1 ){` |
|     - |  212 | `		/* No more stackable OB */` |
| 10075 |  213 | `		pCons->xConsumer = pCons->xDef;` |
| 10075 |  214 | `		pCons->pUserData = pCons->pDefData;` |
|  5035 |  215 | `	}` |
|     - |  216 | `	/* Release OB data */` |
| 10093 |  217 | `	PH7_MemObjRelease(&pEntry->sCallback);` |
| 10093 |  218 | `	SyBlobRelease(&pEntry->sOB);` |
| 10093 |  219 |  |
|     - |  220 | `/*` |
...
|     - |  242 | ` */` |
| 10088 |  243 | `PH7_PRIVATE int vm_builtin_ob_start(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 |  244 |  |
| 10093 |  245 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  246 | `	VmObEntry sOb;` |
|     - |  247 | `	sxi32 rc;` |
|     - |  248 | `	/* Initialize the OB entry */` |
| 10093 |  249 | `	PH7_MemObjInit(pCtx->pVm,&sOb.sCallback);` |
| 10093 |  250 | `	SyBlobInit(&sOb.sOB,&pVm->sAllocator);` |
| 10093 |  251 | `	if( nArg > 0 && (apArg[0]->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ)) ){` |
...
| 10093 |  256 | `	rc = SySetPut(&pVm->aOB,(const void *)&sOb);` |
| 10093 |  257 | `	if( rc != SXRET_OK ){` |
|   ! 0 |  258 | `		PH7_MemObjRelease(&sOb.sCallback);` |
|   ! 0 |  259 | `	}else{` |
| 10093 |  260 | `		ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|     - |  261 | `		/* Substitute the default VM consumer */` |
| 10093 |  262 | `		if( pCons->xConsumer != VmObConsumer ){` |
| 10075 |  263 | `			pCons->xDef = pCons->xConsumer;` |
| 10075 |  264 | `			pCons->pDefData = pCons->pUserData;` |
|     - |  265 | `			/* Install the new consumer */` |
| 10075 |  266 | `			pCons->xConsumer = VmObConsumer;` |
| 10075 |  267 | `			pCons->pUserData = pVm;` |
|  5035 |  268 | `		}` |
|     - |  269 | `	}` |
| 10093 |  270 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
| 10093 |  271 | `	return PH7_OK;` |
|     5 |  272 |  |
|     - |  273 | `/*` |
