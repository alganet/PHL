...
|     - |   96 | ` */` |
|  5188 |   97 | `PH7_PRIVATE int vm_builtin_ob_get_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     3 |   98 | `{` |
|  5191 |   99 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  100 | `	VmObEntry *pOb;` |
|     - |  101 | `	/* Pop the top most OB */` |
|  5191 |  102 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  5191 |  103 | `	if( pOb == 0 ){` |
...
|   ! 0 |  108 | `	}else{` |
|     - |  109 | `		/* Return contents */` |
|  5191 |  110 | `		ph7_result_string(pCtx,(const char *)SyBlobData(&pOb->sOB),(int)SyBlobLength(&pOb->sOB)); /* Will make it's own copy */` |
|     - |  111 | `		/* Release */` |
|  5191 |  112 | `		VmObRestore(pVm,pOb);` |
|     - |  113 | `	}` |
|  5191 |  114 | `	return PH7_OK;` |
|     3 |  115 | `}` |
|     - |  116 | `/*` |
...
|     - |  165 | ` */` |
| 26650 |  166 | `PH7_PRIVATE int VmObConsumer(const void *pData,unsigned int nDataLen,void *pUserData)` |
|     5 |  167 | `{` |
| 26655 |  168 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|     - |  169 | `	VmObEntry *pEntry;` |
|     - |  170 | `	ph7_value sResult;` |
|     - |  171 | `	/* Peek the top most entry */` |
| 26655 |  172 | `	pEntry = (VmObEntry *)SySetPeek(&pVm->aOB);` |
| 26655 |  173 | `	if( pEntry == 0 ){` |
|     - |  174 | `		/* CAN'T HAPPEN */` |
|   ! 0 |  175 | `		return PH7_OK;` |
|     - |  176 | `	}` |
| 26655 |  177 | `	PH7_MemObjInit(pVm,&sResult);` |
| 26655 |  178 | `	if( ph7_value_is_callable(&pEntry->sCallback) && pVm->nObDepth < 15 ){` |
...
|   ! 0 |  201 | `	}` |
| 26655 |  202 | `	if( nDataLen > 0 ){` |
|     - |  203 | `		/* Redirect the VM output to the internal buffer */` |
| 26655 |  204 | `		SyBlobAppend(&pEntry->sOB,pData,nDataLen);` |
| 13325 |  205 | `	}` |
|     - |  206 | `	/* Release */` |
| 26655 |  207 | `	PH7_MemObjRelease(&sResult);` |
| 26655 |  208 | `	return PH7_OK;` |
| 13330 |  209 | `}` |
|     - |  210 | `/*` |
...
|     - |  213 | ` * information.` |
|     - |  214 | ` */` |
|  9428 |  215 | `static void VmObRestore(ph7_vm *pVm,VmObEntry *pEntry)` |
|     5 |  216 | `{` |
|  9433 |  217 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|  9433 |  218 | `	if( SySetUsed(&pVm->aOB) < 1 ){` |
|     - |  219 | `		/* No more stackable OB */` |
|  9415 |  220 | `		pCons->xConsumer = pCons->xDef;` |
|  9415 |  221 | `		pCons->pUserData = pCons->pDefData;` |
|  4705 |  222 | `	}` |
|     - |  223 | `	/* Release OB data */` |
|  9433 |  224 | `	PH7_MemObjRelease(&pEntry->sCallback);` |
|  9433 |  225 | `	SyBlobRelease(&pEntry->sOB);` |
|  9433 |  226 | `}` |
|     - |  227 | `/*` |
...
|  9415 |  270 | `			pCons->xDef = pCons->xConsumer;` |
|  9415 |  271 | `			pCons->pDefData = pCons->pUserData;` |
|     - |  272 | `			/* Install the new consumer */` |
|  9415 |  273 | `			pCons->xConsumer = VmObConsumer;` |
|  9415 |  274 | `			pCons->pUserData = pVm;` |
|  4705 |  275 | `		}` |
|     - |  276 | `	}` |
