...
|     - |   96 | ` */` |
|  5532 |   97 | `PH7_PRIVATE int vm_builtin_ob_get_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     3 |   98 | `{` |
|  5535 |   99 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  100 | `	VmObEntry *pOb;` |
|     - |  101 | `	/* Pop the top most OB */` |
|  5535 |  102 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  5535 |  103 | `	if( pOb == 0 ){` |
...
|   ! 0 |  108 | `	}else{` |
|     - |  109 | `		/* Return contents */` |
|  5535 |  110 | `		ph7_result_string(pCtx,(const char *)SyBlobData(&pOb->sOB),(int)SyBlobLength(&pOb->sOB)); /* Will make it's own copy */` |
|     - |  111 | `		/* Release */` |
|  5535 |  112 | `		VmObRestore(pVm,pOb);` |
|     - |  113 | `	}` |
|  5535 |  114 | `	return PH7_OK;` |
|     3 |  115 | `}` |
|     - |  116 | `/*` |
...
|     - |  165 | ` */` |
| 26202 |  166 | `PH7_PRIVATE int VmObConsumer(const void *pData,unsigned int nDataLen,void *pUserData)` |
|     5 |  167 | `{` |
| 26207 |  168 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|     - |  169 | `	VmObEntry *pEntry;` |
|     - |  170 | `	ph7_value sResult;` |
|     - |  171 | `	/* Peek the top most entry */` |
| 26207 |  172 | `	pEntry = (VmObEntry *)SySetPeek(&pVm->aOB);` |
| 26207 |  173 | `	if( pEntry == 0 ){` |
|     - |  174 | `		/* CAN'T HAPPEN */` |
|   ! 0 |  175 | `		return PH7_OK;` |
|     - |  176 | `	}` |
| 26207 |  177 | `	PH7_MemObjInit(pVm,&sResult);` |
| 26207 |  178 | `	if( ph7_value_is_callable(&pEntry->sCallback) && pVm->nObDepth < 15 ){` |
...
|   ! 0 |  201 | `	}` |
| 26207 |  202 | `	if( nDataLen > 0 ){` |
|     - |  203 | `		/* Redirect the VM output to the internal buffer */` |
| 26207 |  204 | `		SyBlobAppend(&pEntry->sOB,pData,nDataLen);` |
| 13101 |  205 | `	}` |
|     - |  206 | `	/* Release */` |
| 26207 |  207 | `	PH7_MemObjRelease(&sResult);` |
| 26207 |  208 | `	return PH7_OK;` |
| 13106 |  209 | `}` |
|     - |  210 | `/*` |
...
|     - |  213 | ` * information.` |
|     - |  214 | ` */` |
|  9782 |  215 | `static void VmObRestore(ph7_vm *pVm,VmObEntry *pEntry)` |
|     5 |  216 | `{` |
|  9787 |  217 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|  9787 |  218 | `	if( SySetUsed(&pVm->aOB) < 1 ){` |
|     - |  219 | `		/* No more stackable OB */` |
|  9769 |  220 | `		pCons->xConsumer = pCons->xDef;` |
|  9769 |  221 | `		pCons->pUserData = pCons->pDefData;` |
|  4882 |  222 | `	}` |
|     - |  223 | `	/* Release OB data */` |
|  9787 |  224 | `	PH7_MemObjRelease(&pEntry->sCallback);` |
|  9787 |  225 | `	SyBlobRelease(&pEntry->sOB);` |
|  9787 |  226 | `}` |
|     - |  227 | `/*` |
...
|     - |  249 | ` */` |
|  9782 |  250 | `PH7_PRIVATE int vm_builtin_ob_start(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 |  251 | `{` |
|  9787 |  252 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  253 | `	VmObEntry sOb;` |
|     - |  254 | `	sxi32 rc;` |
|     - |  255 | `	/* Initialize the OB entry */` |
|  9787 |  256 | `	PH7_MemObjInit(pCtx->pVm,&sOb.sCallback);` |
|  9787 |  257 | `	SyBlobInit(&sOb.sOB,&pVm->sAllocator);` |
|  9787 |  258 | `	if( nArg > 0 && (apArg[0]->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ)) ){` |
...
|  9787 |  263 | `	rc = SySetPut(&pVm->aOB,(const void *)&sOb);` |
|  9787 |  264 | `	if( rc != SXRET_OK ){` |
|   ! 0 |  265 | `		PH7_MemObjRelease(&sOb.sCallback);` |
|   ! 0 |  266 | `	}else{` |
|  9787 |  267 | `		ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|     - |  268 | `		/* Substitute the default VM consumer */` |
|  9787 |  269 | `		if( pCons->xConsumer != VmObConsumer ){` |
|  9769 |  270 | `			pCons->xDef = pCons->xConsumer;` |
|  9769 |  271 | `			pCons->pDefData = pCons->pUserData;` |
|     - |  272 | `			/* Install the new consumer */` |
|  9769 |  273 | `			pCons->xConsumer = VmObConsumer;` |
|  9769 |  274 | `			pCons->pUserData = pVm;` |
|  4882 |  275 | `		}` |
|     - |  276 | `	}` |
|  9787 |  277 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|  9787 |  278 | `	return PH7_OK;` |
|     5 |  279 | `}` |
|     - |  280 | `/*` |
