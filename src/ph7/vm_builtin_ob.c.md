...
|     - |   43 | ` */` |
|  4084 |   44 | `PH7_PRIVATE int vm_builtin_ob_end_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 |   45 | `{` |
|  4089 |   46 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |   47 | `	VmObEntry *pOb;` |
|     - |   48 | `	/* Pop the top most OB */` |
|  4089 |   49 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  4089 |   50 | `	if( pOb == 0){` |
...
|   ! 0 |   55 | `	}else{` |
|     - |   56 | `		/* Release */` |
|  4089 |   57 | `		VmObRestore(pVm,pOb);` |
|     - |   58 | `		/* Return true */` |
|  4089 |   59 | `		ph7_result_bool(pCtx,1);` |
|     - |   60 | `	}` |
|  4089 |   61 | `	return PH7_OK;` |
|     5 |   62 | `}` |
|     - |   63 | `/*` |
...
|     - |  165 | ` */` |
| 16650 |  166 | `PH7_PRIVATE int VmObConsumer(const void *pData,unsigned int nDataLen,void *pUserData)` |
|     5 |  167 | `{` |
| 16655 |  168 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|     - |  169 | `	VmObEntry *pEntry;` |
|     - |  170 | `	ph7_value sResult;` |
|     - |  171 | `	/* Peek the top most entry */` |
| 16655 |  172 | `	pEntry = (VmObEntry *)SySetPeek(&pVm->aOB);` |
| 16655 |  173 | `	if( pEntry == 0 ){` |
|     - |  174 | `		/* CAN'T HAPPEN */` |
|   ! 0 |  175 | `		return PH7_OK;` |
|     - |  176 | `	}` |
| 16655 |  177 | `	PH7_MemObjInit(pVm,&sResult);` |
| 16655 |  178 | `	if( ph7_value_is_callable(&pEntry->sCallback) && pVm->nObDepth < 15 ){` |
...
|   ! 0 |  194 | `	}` |
| 16655 |  195 | `	if( nDataLen > 0 ){` |
|     - |  196 | `		/* Redirect the VM output to the internal buffer */` |
| 16655 |  197 | `		SyBlobAppend(&pEntry->sOB,pData,nDataLen);` |
|  8325 |  198 | `	}` |
|     - |  199 | `	/* Release */` |
| 16655 |  200 | `	PH7_MemObjRelease(&sResult);` |
| 16655 |  201 | `	return PH7_OK;` |
|  8330 |  202 | `}` |
|     - |  203 | `/*` |
...
|     - |  206 | ` * information.` |
|     - |  207 | ` */` |
|  9420 |  208 | `static void VmObRestore(ph7_vm *pVm,VmObEntry *pEntry)` |
|     5 |  209 | `{` |
|  9425 |  210 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|  9425 |  211 | `	if( SySetUsed(&pVm->aOB) < 1 ){` |
|     - |  212 | `		/* No more stackable OB */` |
|  9407 |  213 | `		pCons->xConsumer = pCons->xDef;` |
|  9407 |  214 | `		pCons->pUserData = pCons->pDefData;` |
|  4701 |  215 | `	}` |
|     - |  216 | `	/* Release OB data */` |
|  9425 |  217 | `	PH7_MemObjRelease(&pEntry->sCallback);` |
|  9425 |  218 | `	SyBlobRelease(&pEntry->sOB);` |
|  9425 |  219 | `}` |
|     - |  220 | `/*` |
...
|     - |  242 | ` */` |
|  9420 |  243 | `PH7_PRIVATE int vm_builtin_ob_start(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 |  244 | `{` |
|  9425 |  245 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  246 | `	VmObEntry sOb;` |
|     - |  247 | `	sxi32 rc;` |
|     - |  248 | `	/* Initialize the OB entry */` |
|  9425 |  249 | `	PH7_MemObjInit(pCtx->pVm,&sOb.sCallback);` |
|  9425 |  250 | `	SyBlobInit(&sOb.sOB,&pVm->sAllocator);` |
|  9425 |  251 | `	if( nArg > 0 && (apArg[0]->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ)) ){` |
...
|  9425 |  256 | `	rc = SySetPut(&pVm->aOB,(const void *)&sOb);` |
|  9425 |  257 | `	if( rc != SXRET_OK ){` |
|   ! 0 |  258 | `		PH7_MemObjRelease(&sOb.sCallback);` |
|   ! 0 |  259 | `	}else{` |
|  9425 |  260 | `		ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|     - |  261 | `		/* Substitute the default VM consumer */` |
|  9425 |  262 | `		if( pCons->xConsumer != VmObConsumer ){` |
|  9407 |  263 | `			pCons->xDef = pCons->xConsumer;` |
|  9407 |  264 | `			pCons->pDefData = pCons->pUserData;` |
|     - |  265 | `			/* Install the new consumer */` |
|  9407 |  266 | `			pCons->xConsumer = VmObConsumer;` |
|  9407 |  267 | `			pCons->pUserData = pVm;` |
|  4701 |  268 | `		}` |
|     - |  269 | `	}` |
|  9425 |  270 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|  9425 |  271 | `	return PH7_OK;` |
|     5 |  272 | `}` |
|     - |  273 | `/*` |
