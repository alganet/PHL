...
|     - |   43 | ` */` |
|  4268 |   44 | `PH7_PRIVATE int vm_builtin_ob_end_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 |   45 | `{` |
|  4273 |   46 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |   47 | `	VmObEntry *pOb;` |
|     - |   48 | `	/* Pop the top most OB */` |
|  4273 |   49 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  4273 |   50 | `	if( pOb == 0){` |
...
|   ! 0 |   55 | `	}else{` |
|     - |   56 | `		/* Release */` |
|  4273 |   57 | `		VmObRestore(pVm,pOb);` |
|     - |   58 | `		/* Return true */` |
|  4273 |   59 | `		ph7_result_bool(pCtx,1);` |
|     - |   60 | `	}` |
|  4273 |   61 | `	return PH7_OK;` |
|     5 |   62 | `}` |
|     - |   63 | `/*` |
...
|     - |  165 | ` */` |
| 27730 |  166 | `PH7_PRIVATE int VmObConsumer(const void *pData,unsigned int nDataLen,void *pUserData)` |
|     5 |  167 | `{` |
| 27735 |  168 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|     - |  169 | `	VmObEntry *pEntry;` |
|     - |  170 | `	ph7_value sResult;` |
|     - |  171 | `	/* Peek the top most entry */` |
| 27735 |  172 | `	pEntry = (VmObEntry *)SySetPeek(&pVm->aOB);` |
| 27735 |  173 | `	if( pEntry == 0 ){` |
|     - |  174 | `		/* CAN'T HAPPEN */` |
|   ! 0 |  175 | `		return PH7_OK;` |
|     - |  176 | `	}` |
| 27735 |  177 | `	PH7_MemObjInit(pVm,&sResult);` |
| 27735 |  178 | `	if( ph7_value_is_callable(&pEntry->sCallback) && pVm->nObDepth < 15 ){` |
...
|   ! 0 |  201 | `	}` |
| 27735 |  202 | `	if( nDataLen > 0 ){` |
|     - |  203 | `		/* Redirect the VM output to the internal buffer */` |
| 27735 |  204 | `		SyBlobAppend(&pEntry->sOB,pData,nDataLen);` |
| 13865 |  205 | `	}` |
|     - |  206 | `	/* Release */` |
| 27735 |  207 | `	PH7_MemObjRelease(&sResult);` |
| 27735 |  208 | `	return PH7_OK;` |
| 13870 |  209 | `}` |
|     - |  210 | `/*` |
...
|     - |  213 | ` * information.` |
|     - |  214 | ` */` |
|  9478 |  215 | `static void VmObRestore(ph7_vm *pVm,VmObEntry *pEntry)` |
|     5 |  216 | `{` |
|  9483 |  217 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|  9483 |  218 | `	if( SySetUsed(&pVm->aOB) < 1 ){` |
|     - |  219 | `		/* No more stackable OB */` |
|  9465 |  220 | `		pCons->xConsumer = pCons->xDef;` |
|  9465 |  221 | `		pCons->pUserData = pCons->pDefData;` |
|  4730 |  222 | `	}` |
|     - |  223 | `	/* Release OB data */` |
|  9483 |  224 | `	PH7_MemObjRelease(&pEntry->sCallback);` |
|  9483 |  225 | `	SyBlobRelease(&pEntry->sOB);` |
|  9483 |  226 | `}` |
|     - |  227 | `/*` |
...
|     - |  249 | ` */` |
|  9478 |  250 | `PH7_PRIVATE int vm_builtin_ob_start(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 |  251 | `{` |
|  9483 |  252 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  253 | `	VmObEntry sOb;` |
|     - |  254 | `	sxi32 rc;` |
|     - |  255 | `	/* Initialize the OB entry */` |
|  9483 |  256 | `	PH7_MemObjInit(pCtx->pVm,&sOb.sCallback);` |
|  9483 |  257 | `	SyBlobInit(&sOb.sOB,&pVm->sAllocator);` |
|  9483 |  258 | `	if( nArg > 0 && (apArg[0]->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ)) ){` |
...
|  9483 |  263 | `	rc = SySetPut(&pVm->aOB,(const void *)&sOb);` |
|  9483 |  264 | `	if( rc != SXRET_OK ){` |
|   ! 0 |  265 | `		PH7_MemObjRelease(&sOb.sCallback);` |
|   ! 0 |  266 | `	}else{` |
|  9483 |  267 | `		ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|     - |  268 | `		/* Substitute the default VM consumer */` |
|  9483 |  269 | `		if( pCons->xConsumer != VmObConsumer ){` |
|  9465 |  270 | `			pCons->xDef = pCons->xConsumer;` |
|  9465 |  271 | `			pCons->pDefData = pCons->pUserData;` |
|     - |  272 | `			/* Install the new consumer */` |
|  9465 |  273 | `			pCons->xConsumer = VmObConsumer;` |
|  9465 |  274 | `			pCons->pUserData = pVm;` |
|  4730 |  275 | `		}` |
|     - |  276 | `	}` |
|  9483 |  277 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|  9483 |  278 | `	return PH7_OK;` |
|     5 |  279 | `}` |
|     - |  280 | `/*` |
