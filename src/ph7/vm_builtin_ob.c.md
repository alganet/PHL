...
|     - |   43 | ` */` |
|  4370 |   44 | `PH7_PRIVATE int vm_builtin_ob_end_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     4 |   45 | `{` |
|  4374 |   46 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |   47 | `	VmObEntry *pOb;` |
|     - |   48 | `	/* Pop the top most OB */` |
|  4374 |   49 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  4374 |   50 | `	if( pOb == 0){` |
...
|   ! 0 |   55 | `	}else{` |
|     - |   56 | `		/* Release */` |
|  4374 |   57 | `		VmObRestore(pVm,pOb);` |
|     - |   58 | `		/* Return true */` |
|  4374 |   59 | `		ph7_result_bool(pCtx,1);` |
|     - |   60 | `	}` |
|  4374 |   61 | `	return PH7_OK;` |
|     4 |   62 | `}` |
|     - |   63 | `/*` |
...
|     - |   96 | ` */` |
|  5354 |   97 | `PH7_PRIVATE int vm_builtin_ob_get_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     2 |   98 | `{` |
|  5356 |   99 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  100 | `	VmObEntry *pOb;` |
|     - |  101 | `	/* Pop the top most OB */` |
|  5356 |  102 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  5356 |  103 | `	if( pOb == 0 ){` |
...
|   ! 0 |  108 | `	}else{` |
|     - |  109 | `		/* Return contents */` |
|  5356 |  110 | `		ph7_result_string(pCtx,(const char *)SyBlobData(&pOb->sOB),(int)SyBlobLength(&pOb->sOB)); /* Will make it's own copy */` |
|     - |  111 | `		/* Release */` |
|  5356 |  112 | `		VmObRestore(pVm,pOb);` |
|     - |  113 | `	}` |
|  5356 |  114 | `	return PH7_OK;` |
|     2 |  115 | `}` |
|     - |  116 | `/*` |
...
|     - |  165 | ` */` |
| 29326 |  166 | `PH7_PRIVATE int VmObConsumer(const void *pData,unsigned int nDataLen,void *pUserData)` |
|     5 |  167 | `{` |
| 29331 |  168 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|     - |  169 | `	VmObEntry *pEntry;` |
|     - |  170 | `	ph7_value sResult;` |
|     - |  171 | `	/* Peek the top most entry */` |
| 29331 |  172 | `	pEntry = (VmObEntry *)SySetPeek(&pVm->aOB);` |
| 29331 |  173 | `	if( pEntry == 0 ){` |
|     - |  174 | `		/* CAN'T HAPPEN */` |
|   ! 0 |  175 | `		return PH7_OK;` |
|     - |  176 | `	}` |
| 29331 |  177 | `	PH7_MemObjInit(pVm,&sResult);` |
| 29331 |  178 | `	if( ph7_value_is_callable(&pEntry->sCallback) && pVm->nObDepth < 15 ){` |
...
|   ! 0 |  201 | `	}` |
| 29331 |  202 | `	if( nDataLen > 0 ){` |
|     - |  203 | `		/* Redirect the VM output to the internal buffer */` |
| 29331 |  204 | `		SyBlobAppend(&pEntry->sOB,pData,nDataLen);` |
| 14663 |  205 | `	}` |
|     - |  206 | `	/* Release */` |
| 29331 |  207 | `	PH7_MemObjRelease(&sResult);` |
| 29331 |  208 | `	return PH7_OK;` |
| 14668 |  209 | `}` |
|     - |  210 | `/*` |
...
|     - |  213 | ` * information.` |
|     - |  214 | ` */` |
|  9728 |  215 | `static void VmObRestore(ph7_vm *pVm,VmObEntry *pEntry)` |
|     4 |  216 | `{` |
|  9732 |  217 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|  9732 |  218 | `	if( SySetUsed(&pVm->aOB) < 1 ){` |
|     - |  219 | `		/* No more stackable OB */` |
|  9714 |  220 | `		pCons->xConsumer = pCons->xDef;` |
|  9714 |  221 | `		pCons->pUserData = pCons->pDefData;` |
|  4855 |  222 | `	}` |
|     - |  223 | `	/* Release OB data */` |
|  9732 |  224 | `	PH7_MemObjRelease(&pEntry->sCallback);` |
|  9732 |  225 | `	SyBlobRelease(&pEntry->sOB);` |
|  9732 |  226 | `}` |
|     - |  227 | `/*` |
...
|     - |  249 | ` */` |
|  9732 |  250 | `PH7_PRIVATE int vm_builtin_ob_start(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 |  251 | `{` |
|  9737 |  252 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  253 | `	VmObEntry sOb;` |
|     - |  254 | `	sxi32 rc;` |
|     - |  255 | `	/* Initialize the OB entry */` |
|  9737 |  256 | `	PH7_MemObjInit(pCtx->pVm,&sOb.sCallback);` |
|  9737 |  257 | `	SyBlobInit(&sOb.sOB,&pVm->sAllocator);` |
|  9737 |  258 | `	if( nArg > 0 && (apArg[0]->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ)) ){` |
...
|  9737 |  263 | `	rc = SySetPut(&pVm->aOB,(const void *)&sOb);` |
|  9737 |  264 | `	if( rc != SXRET_OK ){` |
|   ! 0 |  265 | `		PH7_MemObjRelease(&sOb.sCallback);` |
|   ! 0 |  266 | `	}else{` |
|  9737 |  267 | `		ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|     - |  268 | `		/* Substitute the default VM consumer */` |
|  9737 |  269 | `		if( pCons->xConsumer != VmObConsumer ){` |
|  9717 |  270 | `			pCons->xDef = pCons->xConsumer;` |
|  9717 |  271 | `			pCons->pDefData = pCons->pUserData;` |
|     - |  272 | `			/* Install the new consumer */` |
|  9717 |  273 | `			pCons->xConsumer = VmObConsumer;` |
|  9717 |  274 | `			pCons->pUserData = pVm;` |
|  4856 |  275 | `		}` |
|     - |  276 | `	}` |
|  9737 |  277 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|  9737 |  278 | `	return PH7_OK;` |
|     5 |  279 | `}` |
|     - |  280 | `/*` |
