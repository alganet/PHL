...
|     - |   96 | ` */` |
|  5180 |   97 | `PH7_PRIVATE int vm_builtin_ob_get_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     3 |   98 | `{` |
|  5183 |   99 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  100 | `	VmObEntry *pOb;` |
|     - |  101 | `	/* Pop the top most OB */` |
|  5183 |  102 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  5183 |  103 | `	if( pOb == 0 ){` |
...
|   ! 0 |  108 | `	}else{` |
|     - |  109 | `		/* Return contents */` |
|  5183 |  110 | `		ph7_result_string(pCtx,(const char *)SyBlobData(&pOb->sOB),(int)SyBlobLength(&pOb->sOB)); /* Will make it's own copy */` |
|     - |  111 | `		/* Release */` |
|  5183 |  112 | `		VmObRestore(pVm,pOb);` |
|     - |  113 | `	}` |
|  5183 |  114 | `	return PH7_OK;` |
|     3 |  115 | `}` |
|     - |  116 | `/*` |
...
|     - |  165 | ` */` |
| 26780 |  166 | `PH7_PRIVATE int VmObConsumer(const void *pData,unsigned int nDataLen,void *pUserData)` |
|     5 |  167 | `{` |
| 26785 |  168 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|     - |  169 | `	VmObEntry *pEntry;` |
|     - |  170 | `	ph7_value sResult;` |
|     - |  171 | `	/* Peek the top most entry */` |
| 26785 |  172 | `	pEntry = (VmObEntry *)SySetPeek(&pVm->aOB);` |
| 26785 |  173 | `	if( pEntry == 0 ){` |
|     - |  174 | `		/* CAN'T HAPPEN */` |
|   ! 0 |  175 | `		return PH7_OK;` |
|     - |  176 | `	}` |
| 26785 |  177 | `	PH7_MemObjInit(pVm,&sResult);` |
| 26785 |  178 | `	if( ph7_value_is_callable(&pEntry->sCallback) && pVm->nObDepth < 15 ){` |
...
|   ! 0 |  201 | `	}` |
| 26785 |  202 | `	if( nDataLen > 0 ){` |
|     - |  203 | `		/* Redirect the VM output to the internal buffer */` |
| 26785 |  204 | `		SyBlobAppend(&pEntry->sOB,pData,nDataLen);` |
| 13390 |  205 | `	}` |
|     - |  206 | `	/* Release */` |
| 26785 |  207 | `	PH7_MemObjRelease(&sResult);` |
| 26785 |  208 | `	return PH7_OK;` |
| 13395 |  209 | `}` |
|     - |  210 | `/*` |
...
|     5 |  216 | `{` |
|  9425 |  217 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|  9425 |  218 | `	if( SySetUsed(&pVm->aOB) < 1 ){` |
|     - |  219 | `		/* No more stackable OB */` |
|  9407 |  220 | `		pCons->xConsumer = pCons->xDef;` |
|  9407 |  221 | `		pCons->pUserData = pCons->pDefData;` |
|  4701 |  222 | `	}` |
|     - |  223 | `	/* Release OB data */` |
|  9425 |  224 | `	PH7_MemObjRelease(&pEntry->sCallback);` |
|  9425 |  225 | `	SyBlobRelease(&pEntry->sOB);` |
|  9425 |  226 | `}` |
|     - |  227 | `/*` |
...
|     - |  249 | ` */` |
|  9420 |  250 | `PH7_PRIVATE int vm_builtin_ob_start(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 |  251 | `{` |
|  9425 |  252 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  253 | `	VmObEntry sOb;` |
|     - |  254 | `	sxi32 rc;` |
|     - |  255 | `	/* Initialize the OB entry */` |
|  9425 |  256 | `	PH7_MemObjInit(pCtx->pVm,&sOb.sCallback);` |
|  9425 |  257 | `	SyBlobInit(&sOb.sOB,&pVm->sAllocator);` |
|  9425 |  258 | `	if( nArg > 0 && (apArg[0]->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ)) ){` |
...
|  9425 |  263 | `	rc = SySetPut(&pVm->aOB,(const void *)&sOb);` |
|  9425 |  264 | `	if( rc != SXRET_OK ){` |
|   ! 0 |  265 | `		PH7_MemObjRelease(&sOb.sCallback);` |
|   ! 0 |  266 | `	}else{` |
|  9425 |  267 | `		ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|     - |  268 | `		/* Substitute the default VM consumer */` |
|  9425 |  269 | `		if( pCons->xConsumer != VmObConsumer ){` |
|  9407 |  270 | `			pCons->xDef = pCons->xConsumer;` |
|  9407 |  271 | `			pCons->pDefData = pCons->pUserData;` |
|     - |  272 | `			/* Install the new consumer */` |
|  9407 |  273 | `			pCons->xConsumer = VmObConsumer;` |
|  9407 |  274 | `			pCons->pUserData = pVm;` |
|  4701 |  275 | `		}` |
|     - |  276 | `	}` |
|  9425 |  277 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|  9425 |  278 | `	return PH7_OK;` |
|     5 |  279 | `}` |
|     - |  280 | `/*` |
