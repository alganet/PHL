...
|     - |   43 | ` */` |
|  4158 |   44 | `PH7_PRIVATE int vm_builtin_ob_end_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 |   45 | `{` |
|  4163 |   46 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |   47 | `	VmObEntry *pOb;` |
|     - |   48 | `	/* Pop the top most OB */` |
|  4163 |   49 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  4163 |   50 | `	if( pOb == 0){` |
...
|   ! 0 |   55 | `	}else{` |
|     - |   56 | `		/* Release */` |
|  4163 |   57 | `		VmObRestore(pVm,pOb);` |
|     - |   58 | `		/* Return true */` |
|  4163 |   59 | `		ph7_result_bool(pCtx,1);` |
|     - |   60 | `	}` |
|  4163 |   61 | `	return PH7_OK;` |
|     5 |   62 | `}` |
|     - |   63 | `/*` |
...
|     3 |   98 | `{` |
|  5379 |   99 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  100 | `	VmObEntry *pOb;` |
|     - |  101 | `	/* Pop the top most OB */` |
|  5379 |  102 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  5379 |  103 | `	if( pOb == 0 ){` |
...
|   ! 0 |  108 | `	}else{` |
|     - |  109 | `		/* Return contents */` |
|  5379 |  110 | `		ph7_result_string(pCtx,(const char *)SyBlobData(&pOb->sOB),(int)SyBlobLength(&pOb->sOB)); /* Will make it's own copy */` |
|     - |  111 | `		/* Release */` |
|  5379 |  112 | `		VmObRestore(pVm,pOb);` |
|     - |  113 | `	}` |
|  5379 |  114 | `	return PH7_OK;` |
|     3 |  115 | `}` |
|     - |  116 | `/*` |
...
|     - |  165 | ` */` |
| 18404 |  166 | `PH7_PRIVATE int VmObConsumer(const void *pData,unsigned int nDataLen,void *pUserData)` |
|     5 |  167 | `{` |
| 18409 |  168 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|     - |  169 | `	VmObEntry *pEntry;` |
|     - |  170 | `	ph7_value sResult;` |
|     - |  171 | `	/* Peek the top most entry */` |
| 18409 |  172 | `	pEntry = (VmObEntry *)SySetPeek(&pVm->aOB);` |
| 18409 |  173 | `	if( pEntry == 0 ){` |
|     - |  174 | `		/* CAN'T HAPPEN */` |
|   ! 0 |  175 | `		return PH7_OK;` |
|     - |  176 | `	}` |
| 18409 |  177 | `	PH7_MemObjInit(pVm,&sResult);` |
| 18409 |  178 | `	if( ph7_value_is_callable(&pEntry->sCallback) && pVm->nObDepth < 15 ){` |
...
|   ! 0 |  194 | `	}` |
| 18409 |  195 | `	if( nDataLen > 0 ){` |
|     - |  196 | `		/* Redirect the VM output to the internal buffer */` |
| 18409 |  197 | `		SyBlobAppend(&pEntry->sOB,pData,nDataLen);` |
|  9202 |  198 | `	}` |
|     - |  199 | `	/* Release */` |
| 18409 |  200 | `	PH7_MemObjRelease(&sResult);` |
| 18409 |  201 | `	return PH7_OK;` |
|  9207 |  202 | `}` |
|     - |  203 | `/*` |
...
|     - |  206 | ` * information.` |
|     - |  207 | ` */` |
|  9536 |  208 | `static void VmObRestore(ph7_vm *pVm,VmObEntry *pEntry)` |
|     5 |  209 | `{` |
|  9541 |  210 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|  9541 |  211 | `	if( SySetUsed(&pVm->aOB) < 1 ){` |
|     - |  212 | `		/* No more stackable OB */` |
|  9523 |  213 | `		pCons->xConsumer = pCons->xDef;` |
|  9523 |  214 | `		pCons->pUserData = pCons->pDefData;` |
|  4759 |  215 | `	}` |
|     - |  216 | `	/* Release OB data */` |
|  9541 |  217 | `	PH7_MemObjRelease(&pEntry->sCallback);` |
|  9541 |  218 | `	SyBlobRelease(&pEntry->sOB);` |
|  9541 |  219 | `}` |
|     - |  220 | `/*` |
...
|     - |  242 | ` */` |
|  9536 |  243 | `PH7_PRIVATE int vm_builtin_ob_start(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 |  244 | `{` |
|  9541 |  245 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  246 | `	VmObEntry sOb;` |
|     - |  247 | `	sxi32 rc;` |
|     - |  248 | `	/* Initialize the OB entry */` |
|  9541 |  249 | `	PH7_MemObjInit(pCtx->pVm,&sOb.sCallback);` |
|  9541 |  250 | `	SyBlobInit(&sOb.sOB,&pVm->sAllocator);` |
|  9541 |  251 | `	if( nArg > 0 && (apArg[0]->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ)) ){` |
...
|  9541 |  256 | `	rc = SySetPut(&pVm->aOB,(const void *)&sOb);` |
|  9541 |  257 | `	if( rc != SXRET_OK ){` |
|   ! 0 |  258 | `		PH7_MemObjRelease(&sOb.sCallback);` |
|   ! 0 |  259 | `	}else{` |
|  9541 |  260 | `		ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|     - |  261 | `		/* Substitute the default VM consumer */` |
|  9541 |  262 | `		if( pCons->xConsumer != VmObConsumer ){` |
|  9523 |  263 | `			pCons->xDef = pCons->xConsumer;` |
|  9523 |  264 | `			pCons->pDefData = pCons->pUserData;` |
|     - |  265 | `			/* Install the new consumer */` |
|  9523 |  266 | `			pCons->xConsumer = VmObConsumer;` |
|  9523 |  267 | `			pCons->pUserData = pVm;` |
|  4759 |  268 | `		}` |
|     - |  269 | `	}` |
|  9541 |  270 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|  9541 |  271 | `	return PH7_OK;` |
|     5 |  272 | `}` |
|     - |  273 | `/*` |
