...
|     - |   43 | ` */` |
|  4050 |   44 | `PH7_PRIVATE int vm_builtin_ob_end_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     2 |   45 |  |
|  4052 |   46 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |   47 | `	VmObEntry *pOb;` |
|     - |   48 | `	/* Pop the top most OB */` |
|  4052 |   49 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  4052 |   50 | `	if( pOb == 0){` |
...
|   ! 0 |   55 | `	}else{` |
|     - |   56 | `		/* Release */` |
|  4052 |   57 | `		VmObRestore(pVm,pOb);` |
|     - |   58 | `		/* Return true */` |
|  4052 |   59 | `		ph7_result_bool(pCtx,1);` |
|     - |   60 | `	}` |
|  4052 |   61 | `	return PH7_OK;` |
|     2 |   62 |  |
|     - |   63 | `/*` |
...
|     - |  165 | ` */` |
| 11402 |  166 | `PH7_PRIVATE int VmObConsumer(const void *pData,unsigned int nDataLen,void *pUserData)` |
|     2 |  167 |  |
| 11404 |  168 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|     - |  169 | `	VmObEntry *pEntry;` |
|     - |  170 | `	ph7_value sResult;` |
|     - |  171 | `	/* Peek the top most entry */` |
| 11404 |  172 | `	pEntry = (VmObEntry *)SySetPeek(&pVm->aOB);` |
| 11404 |  173 | `	if( pEntry == 0 ){` |
|     - |  174 | `		/* CAN'T HAPPEN */` |
|   ! 0 |  175 | `		return PH7_OK;` |
|     - |  176 | `	}` |
| 11404 |  177 | `	PH7_MemObjInit(pVm,&sResult);` |
| 11404 |  178 | `	if( ph7_value_is_callable(&pEntry->sCallback) && pVm->nObDepth < 15 ){` |
...
|   ! 0 |  194 | `	}` |
| 11404 |  195 | `	if( nDataLen > 0 ){` |
|     - |  196 | `		/* Redirect the VM output to the internal buffer */` |
| 11404 |  197 | `		SyBlobAppend(&pEntry->sOB,pData,nDataLen);` |
|  5701 |  198 | `	}` |
|     - |  199 | `	/* Release */` |
| 11404 |  200 | `	PH7_MemObjRelease(&sResult);` |
| 11404 |  201 | `	return PH7_OK;` |
|  5703 |  202 |  |
|     - |  203 | `/*` |
...
|     - |  206 | ` * information.` |
|     - |  207 | ` */` |
|  9362 |  208 | `static void VmObRestore(ph7_vm *pVm,VmObEntry *pEntry)` |
|     2 |  209 |  |
|  9364 |  210 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|  9364 |  211 | `	if( SySetUsed(&pVm->aOB) < 1 ){` |
|     - |  212 | `		/* No more stackable OB */` |
|  9346 |  213 | `		pCons->xConsumer = pCons->xDef;` |
|  9346 |  214 | `		pCons->pUserData = pCons->pDefData;` |
|  4672 |  215 | `	}` |
|     - |  216 | `	/* Release OB data */` |
|  9364 |  217 | `	PH7_MemObjRelease(&pEntry->sCallback);` |
|  9364 |  218 | `	SyBlobRelease(&pEntry->sOB);` |
|  9364 |  219 |  |
|     - |  220 | `/*` |
...
|     - |  242 | ` */` |
|  9362 |  243 | `PH7_PRIVATE int vm_builtin_ob_start(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     2 |  244 |  |
|  9364 |  245 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  246 | `	VmObEntry sOb;` |
|     - |  247 | `	sxi32 rc;` |
|     - |  248 | `	/* Initialize the OB entry */` |
|  9364 |  249 | `	PH7_MemObjInit(pCtx->pVm,&sOb.sCallback);` |
|  9364 |  250 | `	SyBlobInit(&sOb.sOB,&pVm->sAllocator);` |
|  9364 |  251 | `	if( nArg > 0 && (apArg[0]->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP)) ){` |
|     - |  252 | `		/* Save the callback name for later invocation */` |
|   ! 0 |  253 | `		PH7_MemObjStore(apArg[0],&sOb.sCallback);` |
|   ! 0 |  254 | `	}` |
|     - |  255 | `	/* Push in the stack */` |
|  9364 |  256 | `	rc = SySetPut(&pVm->aOB,(const void *)&sOb);` |
|  9364 |  257 | `	if( rc != SXRET_OK ){` |
|   ! 0 |  258 | `		PH7_MemObjRelease(&sOb.sCallback);` |
|   ! 0 |  259 | `	}else{` |
|  9364 |  260 | `		ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|     - |  261 | `		/* Substitute the default VM consumer */` |
|  9364 |  262 | `		if( pCons->xConsumer != VmObConsumer ){` |
|  9346 |  263 | `			pCons->xDef = pCons->xConsumer;` |
|  9346 |  264 | `			pCons->pDefData = pCons->pUserData;` |
|     - |  265 | `			/* Install the new consumer */` |
|  9346 |  266 | `			pCons->xConsumer = VmObConsumer;` |
|  9346 |  267 | `			pCons->pUserData = pVm;` |
|  4672 |  268 | `		}` |
|     - |  269 | `	}` |
|  9364 |  270 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|  9364 |  271 | `	return PH7_OK;` |
|     2 |  272 |  |
|     - |  273 | `/*` |
