...
|     - |   43 | ` */` |
|  4012 |   44 | `PH7_PRIVATE int vm_builtin_ob_end_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     2 |   45 |  |
|  4014 |   46 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |   47 | `	VmObEntry *pOb;` |
|     - |   48 | `	/* Pop the top most OB */` |
|  4014 |   49 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  4014 |   50 | `	if( pOb == 0){` |
...
|   ! 0 |   55 | `	}else{` |
|     - |   56 | `		/* Release */` |
|  4014 |   57 | `		VmObRestore(pVm,pOb);` |
|     - |   58 | `		/* Return true */` |
|  4014 |   59 | `		ph7_result_bool(pCtx,1);` |
|     - |   60 | `	}` |
|  4014 |   61 | `	return PH7_OK;` |
|     2 |   62 |  |
|     - |   63 | `/*` |
...
|     - |   96 | ` */` |
|  5270 |   97 | `PH7_PRIVATE int vm_builtin_ob_get_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     2 |   98 |  |
|  5272 |   99 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  100 | `	VmObEntry *pOb;` |
|     - |  101 | `	/* Pop the top most OB */` |
|  5272 |  102 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  5272 |  103 | `	if( pOb == 0 ){` |
...
|   ! 0 |  108 | `	}else{` |
|     - |  109 | `		/* Return contents */` |
|  5272 |  110 | `		ph7_result_string(pCtx,(const char *)SyBlobData(&pOb->sOB),(int)SyBlobLength(&pOb->sOB)); /* Will make it's own copy */` |
|     - |  111 | `		/* Release */` |
|  5272 |  112 | `		VmObRestore(pVm,pOb);` |
|     - |  113 | `	}` |
|  5272 |  114 | `	return PH7_OK;` |
|     2 |  115 |  |
|     - |  116 | `/*` |
...
|     - |  165 | ` */` |
| 10436 |  166 | `PH7_PRIVATE int VmObConsumer(const void *pData,unsigned int nDataLen,void *pUserData)` |
|     2 |  167 |  |
| 10438 |  168 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|     - |  169 | `	VmObEntry *pEntry;` |
|     - |  170 | `	ph7_value sResult;` |
|     - |  171 | `	/* Peek the top most entry */` |
| 10438 |  172 | `	pEntry = (VmObEntry *)SySetPeek(&pVm->aOB);` |
| 10438 |  173 | `	if( pEntry == 0 ){` |
|     - |  174 | `		/* CAN'T HAPPEN */` |
|   ! 0 |  175 | `		return PH7_OK;` |
|     - |  176 | `	}` |
| 10438 |  177 | `	PH7_MemObjInit(pVm,&sResult);` |
| 10438 |  178 | `	if( ph7_value_is_callable(&pEntry->sCallback) && pVm->nObDepth < 15 ){` |
...
|   ! 0 |  194 | `	}` |
| 10438 |  195 | `	if( nDataLen > 0 ){` |
|     - |  196 | `		/* Redirect the VM output to the internal buffer */` |
| 10438 |  197 | `		SyBlobAppend(&pEntry->sOB,pData,nDataLen);` |
|  5218 |  198 | `	}` |
|     - |  199 | `	/* Release */` |
| 10438 |  200 | `	PH7_MemObjRelease(&sResult);` |
| 10438 |  201 | `	return PH7_OK;` |
|  5220 |  202 |  |
|     - |  203 | `/*` |
...
|     - |  206 | ` * information.` |
|     - |  207 | ` */` |
|  9284 |  208 | `static void VmObRestore(ph7_vm *pVm,VmObEntry *pEntry)` |
|     2 |  209 |  |
|  9286 |  210 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|  9286 |  211 | `	if( SySetUsed(&pVm->aOB) < 1 ){` |
|     - |  212 | `		/* No more stackable OB */` |
|  9268 |  213 | `		pCons->xConsumer = pCons->xDef;` |
|  9268 |  214 | `		pCons->pUserData = pCons->pDefData;` |
|  4633 |  215 | `	}` |
|     - |  216 | `	/* Release OB data */` |
|  9286 |  217 | `	PH7_MemObjRelease(&pEntry->sCallback);` |
|  9286 |  218 | `	SyBlobRelease(&pEntry->sOB);` |
|  9286 |  219 |  |
|     - |  220 | `/*` |
...
|     - |  242 | ` */` |
|  9284 |  243 | `PH7_PRIVATE int vm_builtin_ob_start(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     2 |  244 |  |
|  9286 |  245 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  246 | `	VmObEntry sOb;` |
|     - |  247 | `	sxi32 rc;` |
|     - |  248 | `	/* Initialize the OB entry */` |
|  9286 |  249 | `	PH7_MemObjInit(pCtx->pVm,&sOb.sCallback);` |
|  9286 |  250 | `	SyBlobInit(&sOb.sOB,&pVm->sAllocator);` |
|  9286 |  251 | `	if( nArg > 0 && (apArg[0]->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP)) ){` |
|     - |  252 | `		/* Save the callback name for later invocation */` |
|   ! 0 |  253 | `		PH7_MemObjStore(apArg[0],&sOb.sCallback);` |
|   ! 0 |  254 | `	}` |
|     - |  255 | `	/* Push in the stack */` |
|  9286 |  256 | `	rc = SySetPut(&pVm->aOB,(const void *)&sOb);` |
|  9286 |  257 | `	if( rc != SXRET_OK ){` |
|   ! 0 |  258 | `		PH7_MemObjRelease(&sOb.sCallback);` |
|   ! 0 |  259 | `	}else{` |
|  9286 |  260 | `		ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|     - |  261 | `		/* Substitute the default VM consumer */` |
|  9286 |  262 | `		if( pCons->xConsumer != VmObConsumer ){` |
|  9268 |  263 | `			pCons->xDef = pCons->xConsumer;` |
|  9268 |  264 | `			pCons->pDefData = pCons->pUserData;` |
|     - |  265 | `			/* Install the new consumer */` |
|  9268 |  266 | `			pCons->xConsumer = VmObConsumer;` |
|  9268 |  267 | `			pCons->pUserData = pVm;` |
|  4633 |  268 | `		}` |
|     - |  269 | `	}` |
|  9286 |  270 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|  9286 |  271 | `	return PH7_OK;` |
|     2 |  272 |  |
|     - |  273 | `/*` |
