...
|     - |   43 | ` */` |
|  4210 |   44 | `PH7_PRIVATE int vm_builtin_ob_end_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 |   45 |  |
|  4215 |   46 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |   47 | `	VmObEntry *pOb;` |
|     - |   48 | `	/* Pop the top most OB */` |
|  4215 |   49 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  4215 |   50 | `	if( pOb == 0){` |
...
|   ! 0 |   55 | `	}else{` |
|     - |   56 | `		/* Release */` |
|  4215 |   57 | `		VmObRestore(pVm,pOb);` |
|     - |   58 | `		/* Return true */` |
|  4215 |   59 | `		ph7_result_bool(pCtx,1);` |
|     - |   60 | `	}` |
|  4215 |   61 | `	return PH7_OK;` |
|     5 |   62 |  |
|     - |   63 | `/*` |
...
|     - |   96 | ` */` |
|  5508 |   97 | `PH7_PRIVATE int vm_builtin_ob_get_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     3 |   98 |  |
|  5511 |   99 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  100 | `	VmObEntry *pOb;` |
|     - |  101 | `	/* Pop the top most OB */` |
|  5511 |  102 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  5511 |  103 | `	if( pOb == 0 ){` |
...
|   ! 0 |  108 | `	}else{` |
|     - |  109 | `		/* Return contents */` |
|  5511 |  110 | `		ph7_result_string(pCtx,(const char *)SyBlobData(&pOb->sOB),(int)SyBlobLength(&pOb->sOB)); /* Will make it's own copy */` |
|     - |  111 | `		/* Release */` |
|  5511 |  112 | `		VmObRestore(pVm,pOb);` |
|     - |  113 | `	}` |
|  5511 |  114 | `	return PH7_OK;` |
|     3 |  115 |  |
|     - |  116 | `/*` |
...
|     - |  165 | ` */` |
| 12618 |  166 | `PH7_PRIVATE int VmObConsumer(const void *pData,unsigned int nDataLen,void *pUserData)` |
|     5 |  167 |  |
| 12623 |  168 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|     - |  169 | `	VmObEntry *pEntry;` |
|     - |  170 | `	ph7_value sResult;` |
|     - |  171 | `	/* Peek the top most entry */` |
| 12623 |  172 | `	pEntry = (VmObEntry *)SySetPeek(&pVm->aOB);` |
| 12623 |  173 | `	if( pEntry == 0 ){` |
|     - |  174 | `		/* CAN'T HAPPEN */` |
|   ! 0 |  175 | `		return PH7_OK;` |
|     - |  176 | `	}` |
| 12623 |  177 | `	PH7_MemObjInit(pVm,&sResult);` |
| 12623 |  178 | `	if( ph7_value_is_callable(&pEntry->sCallback) && pVm->nObDepth < 15 ){` |
...
|   ! 0 |  194 | `	}` |
| 12623 |  195 | `	if( nDataLen > 0 ){` |
|     - |  196 | `		/* Redirect the VM output to the internal buffer */` |
| 12623 |  197 | `		SyBlobAppend(&pEntry->sOB,pData,nDataLen);` |
|  6309 |  198 | `	}` |
|     - |  199 | `	/* Release */` |
| 12623 |  200 | `	PH7_MemObjRelease(&sResult);` |
| 12623 |  201 | `	return PH7_OK;` |
|  6314 |  202 |  |
|     - |  203 | `/*` |
...
|     - |  206 | ` * information.` |
|     - |  207 | ` */` |
|  9720 |  208 | `static void VmObRestore(ph7_vm *pVm,VmObEntry *pEntry)` |
|     5 |  209 |  |
|  9725 |  210 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|  9725 |  211 | `	if( SySetUsed(&pVm->aOB) < 1 ){` |
|     - |  212 | `		/* No more stackable OB */` |
|  9707 |  213 | `		pCons->xConsumer = pCons->xDef;` |
|  9707 |  214 | `		pCons->pUserData = pCons->pDefData;` |
|  4851 |  215 | `	}` |
|     - |  216 | `	/* Release OB data */` |
|  9725 |  217 | `	PH7_MemObjRelease(&pEntry->sCallback);` |
|  9725 |  218 | `	SyBlobRelease(&pEntry->sOB);` |
|  9725 |  219 |  |
|     - |  220 | `/*` |
...
|     - |  242 | ` */` |
|  9720 |  243 | `PH7_PRIVATE int vm_builtin_ob_start(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 |  244 |  |
|  9725 |  245 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  246 | `	VmObEntry sOb;` |
|     - |  247 | `	sxi32 rc;` |
|     - |  248 | `	/* Initialize the OB entry */` |
|  9725 |  249 | `	PH7_MemObjInit(pCtx->pVm,&sOb.sCallback);` |
|  9725 |  250 | `	SyBlobInit(&sOb.sOB,&pVm->sAllocator);` |
|  9725 |  251 | `	if( nArg > 0 && (apArg[0]->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP)) ){` |
|     - |  252 | `		/* Save the callback name for later invocation */` |
|   ! 0 |  253 | `		PH7_MemObjStore(apArg[0],&sOb.sCallback);` |
|   ! 0 |  254 | `	}` |
|     - |  255 | `	/* Push in the stack */` |
|  9725 |  256 | `	rc = SySetPut(&pVm->aOB,(const void *)&sOb);` |
|  9725 |  257 | `	if( rc != SXRET_OK ){` |
|   ! 0 |  258 | `		PH7_MemObjRelease(&sOb.sCallback);` |
|   ! 0 |  259 | `	}else{` |
|  9725 |  260 | `		ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|     - |  261 | `		/* Substitute the default VM consumer */` |
|  9725 |  262 | `		if( pCons->xConsumer != VmObConsumer ){` |
|  9707 |  263 | `			pCons->xDef = pCons->xConsumer;` |
|  9707 |  264 | `			pCons->pDefData = pCons->pUserData;` |
|     - |  265 | `			/* Install the new consumer */` |
|  9707 |  266 | `			pCons->xConsumer = VmObConsumer;` |
|  9707 |  267 | `			pCons->pUserData = pVm;` |
|  4851 |  268 | `		}` |
|     - |  269 | `	}` |
|  9725 |  270 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|  9725 |  271 | `	return PH7_OK;` |
|     5 |  272 |  |
|     - |  273 | `/*` |
