...
|     3 |   98 | `{` |
|  5175 |   99 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  100 | `	VmObEntry *pOb;` |
|     - |  101 | `	/* Pop the top most OB */` |
|  5175 |  102 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  5175 |  103 | `	if( pOb == 0 ){` |
...
|   ! 0 |  108 | `	}else{` |
|     - |  109 | `		/* Return contents */` |
|  5175 |  110 | `		ph7_result_string(pCtx,(const char *)SyBlobData(&pOb->sOB),(int)SyBlobLength(&pOb->sOB)); /* Will make it's own copy */` |
|     - |  111 | `		/* Release */` |
|  5175 |  112 | `		VmObRestore(pVm,pOb);` |
|     - |  113 | `	}` |
|  5175 |  114 | `	return PH7_OK;` |
|     3 |  115 | `}` |
|     - |  116 | `/*` |
...
|     - |  165 | ` */` |
| 26830 |  166 | `PH7_PRIVATE int VmObConsumer(const void *pData,unsigned int nDataLen,void *pUserData)` |
|     5 |  167 | `{` |
| 26835 |  168 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|     - |  169 | `	VmObEntry *pEntry;` |
|     - |  170 | `	ph7_value sResult;` |
|     - |  171 | `	/* Peek the top most entry */` |
| 26835 |  172 | `	pEntry = (VmObEntry *)SySetPeek(&pVm->aOB);` |
| 26835 |  173 | `	if( pEntry == 0 ){` |
|     - |  174 | `		/* CAN'T HAPPEN */` |
|   ! 0 |  175 | `		return PH7_OK;` |
|     - |  176 | `	}` |
| 26835 |  177 | `	PH7_MemObjInit(pVm,&sResult);` |
| 26835 |  178 | `	if( ph7_value_is_callable(&pEntry->sCallback) && pVm->nObDepth < 15 ){` |
...
|   ! 0 |  201 | `	}` |
| 26835 |  202 | `	if( nDataLen > 0 ){` |
|     - |  203 | `		/* Redirect the VM output to the internal buffer */` |
| 26835 |  204 | `		SyBlobAppend(&pEntry->sOB,pData,nDataLen);` |
| 13415 |  205 | `	}` |
|     - |  206 | `	/* Release */` |
| 26835 |  207 | `	PH7_MemObjRelease(&sResult);` |
| 26835 |  208 | `	return PH7_OK;` |
| 13420 |  209 | `}` |
|     - |  210 | `/*` |
...
|     5 |  216 | `{` |
|  9415 |  217 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|  9415 |  218 | `	if( SySetUsed(&pVm->aOB) < 1 ){` |
|     - |  219 | `		/* No more stackable OB */` |
|  9397 |  220 | `		pCons->xConsumer = pCons->xDef;` |
|  9397 |  221 | `		pCons->pUserData = pCons->pDefData;` |
|  4696 |  222 | `	}` |
|     - |  223 | `	/* Release OB data */` |
|  9415 |  224 | `	PH7_MemObjRelease(&pEntry->sCallback);` |
|  9415 |  225 | `	SyBlobRelease(&pEntry->sOB);` |
|  9415 |  226 | `}` |
|     - |  227 | `/*` |
...
|     - |  249 | ` */` |
|  9410 |  250 | `PH7_PRIVATE int vm_builtin_ob_start(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 |  251 | `{` |
|  9415 |  252 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  253 | `	VmObEntry sOb;` |
|     - |  254 | `	sxi32 rc;` |
|     - |  255 | `	/* Initialize the OB entry */` |
|  9415 |  256 | `	PH7_MemObjInit(pCtx->pVm,&sOb.sCallback);` |
|  9415 |  257 | `	SyBlobInit(&sOb.sOB,&pVm->sAllocator);` |
|  9415 |  258 | `	if( nArg > 0 && (apArg[0]->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ)) ){` |
...
|  9415 |  263 | `	rc = SySetPut(&pVm->aOB,(const void *)&sOb);` |
|  9415 |  264 | `	if( rc != SXRET_OK ){` |
|   ! 0 |  265 | `		PH7_MemObjRelease(&sOb.sCallback);` |
|   ! 0 |  266 | `	}else{` |
|  9415 |  267 | `		ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|     - |  268 | `		/* Substitute the default VM consumer */` |
|  9415 |  269 | `		if( pCons->xConsumer != VmObConsumer ){` |
|  9397 |  270 | `			pCons->xDef = pCons->xConsumer;` |
|  9397 |  271 | `			pCons->pDefData = pCons->pUserData;` |
|     - |  272 | `			/* Install the new consumer */` |
|  9397 |  273 | `			pCons->xConsumer = VmObConsumer;` |
|  9397 |  274 | `			pCons->pUserData = pVm;` |
|  4696 |  275 | `		}` |
|     - |  276 | `	}` |
|  9415 |  277 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|  9415 |  278 | `	return PH7_OK;` |
|     5 |  279 | `}` |
|     - |  280 | `/*` |
