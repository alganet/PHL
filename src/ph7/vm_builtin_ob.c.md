...
|     - |   43 | ` */` |
|  4138 |   44 | `PH7_PRIVATE int vm_builtin_ob_end_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     2 |   45 |  |
|  4140 |   46 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |   47 | `	VmObEntry *pOb;` |
|     - |   48 | `	/* Pop the top most OB */` |
|  4140 |   49 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  4140 |   50 | `	if( pOb == 0){` |
...
|   ! 0 |   55 | `	}else{` |
|     - |   56 | `		/* Release */` |
|  4140 |   57 | `		VmObRestore(pVm,pOb);` |
|     - |   58 | `		/* Return true */` |
|  4140 |   59 | `		ph7_result_bool(pCtx,1);` |
|     - |   60 | `	}` |
|  4140 |   61 | `	return PH7_OK;` |
|     2 |   62 |  |
|     - |   63 | `/*` |
...
|     - |   96 | ` */` |
|  5434 |   97 | `PH7_PRIVATE int vm_builtin_ob_get_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     2 |   98 |  |
|  5436 |   99 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  100 | `	VmObEntry *pOb;` |
|     - |  101 | `	/* Pop the top most OB */` |
|  5436 |  102 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  5436 |  103 | `	if( pOb == 0 ){` |
...
|   ! 0 |  108 | `	}else{` |
|     - |  109 | `		/* Return contents */` |
|  5436 |  110 | `		ph7_result_string(pCtx,(const char *)SyBlobData(&pOb->sOB),(int)SyBlobLength(&pOb->sOB)); /* Will make it's own copy */` |
|     - |  111 | `		/* Release */` |
|  5436 |  112 | `		VmObRestore(pVm,pOb);` |
|     - |  113 | `	}` |
|  5436 |  114 | `	return PH7_OK;` |
|     2 |  115 |  |
|     - |  116 | `/*` |
...
|     - |  165 | ` */` |
| 12272 |  166 | `PH7_PRIVATE int VmObConsumer(const void *pData,unsigned int nDataLen,void *pUserData)` |
|     2 |  167 |  |
| 12274 |  168 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|     - |  169 | `	VmObEntry *pEntry;` |
|     - |  170 | `	ph7_value sResult;` |
|     - |  171 | `	/* Peek the top most entry */` |
| 12274 |  172 | `	pEntry = (VmObEntry *)SySetPeek(&pVm->aOB);` |
| 12274 |  173 | `	if( pEntry == 0 ){` |
|     - |  174 | `		/* CAN'T HAPPEN */` |
|   ! 0 |  175 | `		return PH7_OK;` |
|     - |  176 | `	}` |
| 12274 |  177 | `	PH7_MemObjInit(pVm,&sResult);` |
| 12274 |  178 | `	if( ph7_value_is_callable(&pEntry->sCallback) && pVm->nObDepth < 15 ){` |
...
|   ! 0 |  194 | `	}` |
| 12274 |  195 | `	if( nDataLen > 0 ){` |
|     - |  196 | `		/* Redirect the VM output to the internal buffer */` |
| 12274 |  197 | `		SyBlobAppend(&pEntry->sOB,pData,nDataLen);` |
|  6136 |  198 | `	}` |
|     - |  199 | `	/* Release */` |
| 12274 |  200 | `	PH7_MemObjRelease(&sResult);` |
| 12274 |  201 | `	return PH7_OK;` |
|  6138 |  202 |  |
|     - |  203 | `/*` |
...
|     - |  206 | ` * information.` |
|     - |  207 | ` */` |
|  9574 |  208 | `static void VmObRestore(ph7_vm *pVm,VmObEntry *pEntry)` |
|     2 |  209 |  |
|  9576 |  210 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|  9576 |  211 | `	if( SySetUsed(&pVm->aOB) < 1 ){` |
|     - |  212 | `		/* No more stackable OB */` |
|  9558 |  213 | `		pCons->xConsumer = pCons->xDef;` |
|  9558 |  214 | `		pCons->pUserData = pCons->pDefData;` |
|  4778 |  215 | `	}` |
|     - |  216 | `	/* Release OB data */` |
|  9576 |  217 | `	PH7_MemObjRelease(&pEntry->sCallback);` |
|  9576 |  218 | `	SyBlobRelease(&pEntry->sOB);` |
|  9576 |  219 |  |
|     - |  220 | `/*` |
...
|     - |  242 | ` */` |
|  9574 |  243 | `PH7_PRIVATE int vm_builtin_ob_start(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     2 |  244 |  |
|  9576 |  245 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  246 | `	VmObEntry sOb;` |
|     - |  247 | `	sxi32 rc;` |
|     - |  248 | `	/* Initialize the OB entry */` |
|  9576 |  249 | `	PH7_MemObjInit(pCtx->pVm,&sOb.sCallback);` |
|  9576 |  250 | `	SyBlobInit(&sOb.sOB,&pVm->sAllocator);` |
|  9576 |  251 | `	if( nArg > 0 && (apArg[0]->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP)) ){` |
|     - |  252 | `		/* Save the callback name for later invocation */` |
|   ! 0 |  253 | `		PH7_MemObjStore(apArg[0],&sOb.sCallback);` |
|   ! 0 |  254 | `	}` |
|     - |  255 | `	/* Push in the stack */` |
|  9576 |  256 | `	rc = SySetPut(&pVm->aOB,(const void *)&sOb);` |
|  9576 |  257 | `	if( rc != SXRET_OK ){` |
|   ! 0 |  258 | `		PH7_MemObjRelease(&sOb.sCallback);` |
|   ! 0 |  259 | `	}else{` |
|  9576 |  260 | `		ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|     - |  261 | `		/* Substitute the default VM consumer */` |
|  9576 |  262 | `		if( pCons->xConsumer != VmObConsumer ){` |
|  9558 |  263 | `			pCons->xDef = pCons->xConsumer;` |
|  9558 |  264 | `			pCons->pDefData = pCons->pUserData;` |
|     - |  265 | `			/* Install the new consumer */` |
|  9558 |  266 | `			pCons->xConsumer = VmObConsumer;` |
|  9558 |  267 | `			pCons->pUserData = pVm;` |
|  4778 |  268 | `		}` |
|     - |  269 | `	}` |
|  9576 |  270 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|  9576 |  271 | `	return PH7_OK;` |
|     2 |  272 |  |
|     - |  273 | `/*` |
