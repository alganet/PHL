...
|     - |   43 | ` */` |
|  4344 |   44 | `PH7_PRIVATE int vm_builtin_ob_end_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     4 |   45 | `{` |
|  4348 |   46 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |   47 | `	VmObEntry *pOb;` |
|     - |   48 | `	/* Pop the top most OB */` |
|  4348 |   49 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  4348 |   50 | `	if( pOb == 0){` |
...
|   ! 0 |   55 | `	}else{` |
|     - |   56 | `		/* Release */` |
|  4348 |   57 | `		VmObRestore(pVm,pOb);` |
|     - |   58 | `		/* Return true */` |
|  4348 |   59 | `		ph7_result_bool(pCtx,1);` |
|     - |   60 | `	}` |
|  4348 |   61 | `	return PH7_OK;` |
|     4 |   62 | `}` |
|     - |   63 | `/*` |
...
|     2 |   72 | `{` |
|     8 |   73 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |   74 | `	VmObEntry *pOb;` |
|     - |   75 | `	/* Peek the top most OB */` |
|     8 |   76 | `	pOb = (VmObEntry *)SySetPeek(&pVm->aOB);` |
|     8 |   77 | `	if( pOb == 0 ){` |
...
|   ! 0 |   82 | `	}else{` |
|     - |   83 | `		/* Return contents */` |
|     8 |   84 | `		ph7_result_string(pCtx,(const char *)SyBlobData(&pOb->sOB),(int)SyBlobLength(&pOb->sOB));` |
|     - |   85 | `	}` |
|     8 |   86 | `	return PH7_OK;` |
|     2 |   87 | `}` |
|     - |   88 | `/*` |
...
|     - |   96 | ` */` |
|  5310 |   97 | `PH7_PRIVATE int vm_builtin_ob_get_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     2 |   98 | `{` |
|  5312 |   99 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  100 | `	VmObEntry *pOb;` |
|     - |  101 | `	/* Pop the top most OB */` |
|  5312 |  102 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  5312 |  103 | `	if( pOb == 0 ){` |
...
|   ! 0 |  108 | `	}else{` |
|     - |  109 | `		/* Return contents */` |
|  5312 |  110 | `		ph7_result_string(pCtx,(const char *)SyBlobData(&pOb->sOB),(int)SyBlobLength(&pOb->sOB)); /* Will make it's own copy */` |
|     - |  111 | `		/* Release */` |
|  5312 |  112 | `		VmObRestore(pVm,pOb);` |
|     - |  113 | `	}` |
|  5312 |  114 | `	return PH7_OK;` |
|     2 |  115 | `}` |
|     - |  116 | `/*` |
...
|     - |  165 | ` */` |
| 28998 |  166 | `PH7_PRIVATE int VmObConsumer(const void *pData,unsigned int nDataLen,void *pUserData)` |
|     5 |  167 | `{` |
| 29003 |  168 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|     - |  169 | `	VmObEntry *pEntry;` |
|     - |  170 | `	ph7_value sResult;` |
|     - |  171 | `	/* Peek the top most entry */` |
| 29003 |  172 | `	pEntry = (VmObEntry *)SySetPeek(&pVm->aOB);` |
| 29003 |  173 | `	if( pEntry == 0 ){` |
|     - |  174 | `		/* CAN'T HAPPEN */` |
|   ! 0 |  175 | `		return PH7_OK;` |
|     - |  176 | `	}` |
| 29003 |  177 | `	PH7_MemObjInit(pVm,&sResult);` |
| 29003 |  178 | `	if( ph7_value_is_callable(&pEntry->sCallback) && pVm->nObDepth < 15 ){` |
...
|   ! 0 |  201 | `	}` |
| 29003 |  202 | `	if( nDataLen > 0 ){` |
|     - |  203 | `		/* Redirect the VM output to the internal buffer */` |
| 29003 |  204 | `		SyBlobAppend(&pEntry->sOB,pData,nDataLen);` |
| 14499 |  205 | `	}` |
|     - |  206 | `	/* Release */` |
| 29003 |  207 | `	PH7_MemObjRelease(&sResult);` |
| 29003 |  208 | `	return PH7_OK;` |
| 14504 |  209 | `}` |
|     - |  210 | `/*` |
...
|     - |  213 | ` * information.` |
|     - |  214 | ` */` |
|  9658 |  215 | `static void VmObRestore(ph7_vm *pVm,VmObEntry *pEntry)` |
|     4 |  216 | `{` |
|  9662 |  217 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|  9662 |  218 | `	if( SySetUsed(&pVm->aOB) < 1 ){` |
|     - |  219 | `		/* No more stackable OB */` |
|  9644 |  220 | `		pCons->xConsumer = pCons->xDef;` |
|  9644 |  221 | `		pCons->pUserData = pCons->pDefData;` |
|  4820 |  222 | `	}` |
|     - |  223 | `	/* Release OB data */` |
|  9662 |  224 | `	PH7_MemObjRelease(&pEntry->sCallback);` |
|  9662 |  225 | `	SyBlobRelease(&pEntry->sOB);` |
|  9662 |  226 | `}` |
|     - |  227 | `/*` |
...
|     - |  249 | ` */` |
|  9662 |  250 | `PH7_PRIVATE int vm_builtin_ob_start(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 |  251 | `{` |
|  9667 |  252 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  253 | `	VmObEntry sOb;` |
|     - |  254 | `	sxi32 rc;` |
|     - |  255 | `	/* Initialize the OB entry */` |
|  9667 |  256 | `	PH7_MemObjInit(pCtx->pVm,&sOb.sCallback);` |
|  9667 |  257 | `	SyBlobInit(&sOb.sOB,&pVm->sAllocator);` |
|  9667 |  258 | `	if( nArg > 0 && (apArg[0]->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ)) ){` |
...
|  9667 |  263 | `	rc = SySetPut(&pVm->aOB,(const void *)&sOb);` |
|  9667 |  264 | `	if( rc != SXRET_OK ){` |
|   ! 0 |  265 | `		PH7_MemObjRelease(&sOb.sCallback);` |
|   ! 0 |  266 | `	}else{` |
|  9667 |  267 | `		ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|     - |  268 | `		/* Substitute the default VM consumer */` |
|  9667 |  269 | `		if( pCons->xConsumer != VmObConsumer ){` |
|  9647 |  270 | `			pCons->xDef = pCons->xConsumer;` |
|  9647 |  271 | `			pCons->pDefData = pCons->pUserData;` |
|     - |  272 | `			/* Install the new consumer */` |
|  9647 |  273 | `			pCons->xConsumer = VmObConsumer;` |
|  9647 |  274 | `			pCons->pUserData = pVm;` |
|  4821 |  275 | `		}` |
|     - |  276 | `	}` |
|  9667 |  277 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|  9667 |  278 | `	return PH7_OK;` |
|     5 |  279 | `}` |
|     - |  280 | `/*` |
...
|     - |  283 | ` * information.` |
|     - |  284 | ` */` |
|     6 |  285 | `static sxi32 VmObFlush(ph7_vm *pVm,VmObEntry *pEntry,int bRelease)` |
|     3 |  286 | `{` |
|     9 |  287 | `	SyBlob *pBlob = &pEntry->sOB;` |
|     - |  288 | `	sxi32 rc;` |
|     - |  289 | `	/* Flush contents */` |
|     9 |  290 | `	rc = PH7_OK;` |
|     9 |  291 | `	if( SyBlobLength(pBlob) > 0 ){` |
|     - |  292 | `		/* Call the VM output consumer */` |
|     9 |  293 | `		rc = pVm->sVmConsumer.xDef(SyBlobData(pBlob),SyBlobLength(pBlob),pVm->sVmConsumer.pDefData);` |
|     - |  294 | `		/* Increment VM output counter */` |
|     9 |  295 | `		pVm->nOutputLen += SyBlobLength(pBlob);` |
|     9 |  296 | `		if( rc != PH7_ABORT ){` |
|     9 |  297 | `			rc = PH7_OK;` |
|     3 |  298 | `		}` |
|     3 |  299 | `	}` |
|     9 |  300 | `	if( bRelease ){` |
|     6 |  301 | `		VmObRestore(&(*pVm),pEntry);` |
|     4 |  302 | `	}else{` |
|     - |  303 | `		/* Reset the blob */` |
...
|     - |  343 | ` */` |
|     4 |  344 | `PH7_PRIVATE int vm_builtin_ob_end_flush(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     2 |  345 | `{` |
|     6 |  346 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  347 | `	VmObEntry *pOb;` |
|     - |  348 | `	sxi32 rc;` |
|     - |  349 | `	/* Pop the top most OB entry */` |
|     6 |  350 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|     6 |  351 | `	if( pOb == 0 ){` |
...
|     - |  357 | `	}` |
|     - |  358 | `	/* Flush contents */` |
|     6 |  359 | `	rc = VmObFlush(pVm,pOb,TRUE);` |
|     - |  360 | `	/* Return true */` |
|     6 |  361 | `	ph7_result_bool(pCtx,1);` |
|     6 |  362 | `	return rc;` |
|     4 |  363 | `}` |
|     - |  364 | `/*` |
