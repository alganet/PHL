...
|     - |   43 | ` */` |
|  4128 |   44 | `PH7_PRIVATE int vm_builtin_ob_end_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     4 |   45 | `{` |
|  4132 |   46 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |   47 | `	VmObEntry *pOb;` |
|     - |   48 | `	/* Pop the top most OB */` |
|  4132 |   49 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  4132 |   50 | `	if( pOb == 0){` |
...
|   ! 0 |   55 | `	}else{` |
|     - |   56 | `		/* Release */` |
|  4132 |   57 | `		VmObRestore(pVm,pOb);` |
|     - |   58 | `		/* Return true */` |
|  4132 |   59 | `		ph7_result_bool(pCtx,1);` |
|     - |   60 | `	}` |
|  4132 |   61 | `	return PH7_OK;` |
|     4 |   62 | `}` |
|     - |   63 | `/*` |
...
|     - |   96 | ` */` |
|  5012 |   97 | `PH7_PRIVATE int vm_builtin_ob_get_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     2 |   98 | `{` |
|  5014 |   99 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  100 | `	VmObEntry *pOb;` |
|     - |  101 | `	/* Pop the top most OB */` |
|  5014 |  102 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  5014 |  103 | `	if( pOb == 0 ){` |
...
|   ! 0 |  108 | `	}else{` |
|     - |  109 | `		/* Return contents */` |
|  5014 |  110 | `		ph7_result_string(pCtx,(const char *)SyBlobData(&pOb->sOB),(int)SyBlobLength(&pOb->sOB)); /* Will make it's own copy */` |
|     - |  111 | `		/* Release */` |
|  5014 |  112 | `		VmObRestore(pVm,pOb);` |
|     - |  113 | `	}` |
|  5014 |  114 | `	return PH7_OK;` |
|     2 |  115 | `}` |
|     - |  116 | `/*` |
...
|     - |  165 | ` */` |
| 28814 |  166 | `PH7_PRIVATE int VmObConsumer(const void *pData,unsigned int nDataLen,void *pUserData)` |
|     5 |  167 | `{` |
| 28819 |  168 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|     - |  169 | `	VmObEntry *pEntry;` |
|     - |  170 | `	ph7_value sResult;` |
|     - |  171 | `	/* Peek the top most entry */` |
| 28819 |  172 | `	pEntry = (VmObEntry *)SySetPeek(&pVm->aOB);` |
| 28819 |  173 | `	if( pEntry == 0 ){` |
|     - |  174 | `		/* CAN'T HAPPEN */` |
|   ! 0 |  175 | `		return PH7_OK;` |
|     - |  176 | `	}` |
| 28819 |  177 | `	PH7_MemObjInit(pVm,&sResult);` |
| 28819 |  178 | `	if( ph7_value_is_callable(&pEntry->sCallback) && pVm->nObDepth < 15 ){` |
...
|   ! 0 |  201 | `	}` |
| 28819 |  202 | `	if( nDataLen > 0 ){` |
|     - |  203 | `		/* Redirect the VM output to the internal buffer */` |
| 28819 |  204 | `		SyBlobAppend(&pEntry->sOB,pData,nDataLen);` |
| 14407 |  205 | `	}` |
|     - |  206 | `	/* Release */` |
| 28819 |  207 | `	PH7_MemObjRelease(&sResult);` |
| 28819 |  208 | `	return PH7_OK;` |
| 14412 |  209 | `}` |
|     - |  210 | `/*` |
...
|     - |  213 | ` * information.` |
|     - |  214 | ` */` |
|  9144 |  215 | `static void VmObRestore(ph7_vm *pVm,VmObEntry *pEntry)` |
|     4 |  216 | `{` |
|  9148 |  217 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|  9148 |  218 | `	if( SySetUsed(&pVm->aOB) < 1 ){` |
|     - |  219 | `		/* No more stackable OB */` |
|  9130 |  220 | `		pCons->xConsumer = pCons->xDef;` |
|  9130 |  221 | `		pCons->pUserData = pCons->pDefData;` |
|  4563 |  222 | `	}` |
|     - |  223 | `	/* Release OB data */` |
|  9148 |  224 | `	PH7_MemObjRelease(&pEntry->sCallback);` |
|  9148 |  225 | `	SyBlobRelease(&pEntry->sOB);` |
|  9148 |  226 | `}` |
|     - |  227 | `/*` |
...
|     - |  249 | ` */` |
|  9148 |  250 | `PH7_PRIVATE int vm_builtin_ob_start(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 |  251 | `{` |
|  9153 |  252 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  253 | `	VmObEntry sOb;` |
|     - |  254 | `	sxi32 rc;` |
|     - |  255 | `	/* Initialize the OB entry */` |
|  9153 |  256 | `	PH7_MemObjInit(pCtx->pVm,&sOb.sCallback);` |
|  9153 |  257 | `	SyBlobInit(&sOb.sOB,&pVm->sAllocator);` |
|  9153 |  258 | `	if( nArg > 0 && (apArg[0]->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ)) ){` |
...
|  9153 |  263 | `	rc = SySetPut(&pVm->aOB,(const void *)&sOb);` |
|  9153 |  264 | `	if( rc != SXRET_OK ){` |
|   ! 0 |  265 | `		PH7_MemObjRelease(&sOb.sCallback);` |
|   ! 0 |  266 | `	}else{` |
|  9153 |  267 | `		ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|     - |  268 | `		/* Substitute the default VM consumer */` |
|  9153 |  269 | `		if( pCons->xConsumer != VmObConsumer ){` |
|  9133 |  270 | `			pCons->xDef = pCons->xConsumer;` |
|  9133 |  271 | `			pCons->pDefData = pCons->pUserData;` |
|     - |  272 | `			/* Install the new consumer */` |
|  9133 |  273 | `			pCons->xConsumer = VmObConsumer;` |
|  9133 |  274 | `			pCons->pUserData = pVm;` |
|  4564 |  275 | `		}` |
|     - |  276 | `	}` |
|  9153 |  277 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|  9153 |  278 | `	return PH7_OK;` |
|     5 |  279 | `}` |
|     - |  280 | `/*` |
