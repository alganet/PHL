...
|     - |   43 | ` */` |
|  4306 |   44 | `PH7_PRIVATE int vm_builtin_ob_end_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 |   45 |  |
|  4311 |   46 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |   47 | `	VmObEntry *pOb;` |
|     - |   48 | `	/* Pop the top most OB */` |
|  4311 |   49 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  4311 |   50 | `	if( pOb == 0){` |
...
|   ! 0 |   55 | `	}else{` |
|     - |   56 | `		/* Release */` |
|  4311 |   57 | `		VmObRestore(pVm,pOb);` |
|     - |   58 | `		/* Return true */` |
|  4311 |   59 | `		ph7_result_bool(pCtx,1);` |
|     - |   60 | `	}` |
|  4311 |   61 | `	return PH7_OK;` |
|     5 |   62 |  |
|     - |   63 | `/*` |
...
|     - |   96 | ` */` |
|  5652 |   97 | `PH7_PRIVATE int vm_builtin_ob_get_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     3 |   98 |  |
|  5655 |   99 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  100 | `	VmObEntry *pOb;` |
|     - |  101 | `	/* Pop the top most OB */` |
|  5655 |  102 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  5655 |  103 | `	if( pOb == 0 ){` |
...
|   ! 0 |  108 | `	}else{` |
|     - |  109 | `		/* Return contents */` |
|  5655 |  110 | `		ph7_result_string(pCtx,(const char *)SyBlobData(&pOb->sOB),(int)SyBlobLength(&pOb->sOB)); /* Will make it's own copy */` |
|     - |  111 | `		/* Release */` |
|  5655 |  112 | `		VmObRestore(pVm,pOb);` |
|     - |  113 | `	}` |
|  5655 |  114 | `	return PH7_OK;` |
|     3 |  115 |  |
|     - |  116 | `/*` |
...
|     - |  165 | ` */` |
| 14030 |  166 | `PH7_PRIVATE int VmObConsumer(const void *pData,unsigned int nDataLen,void *pUserData)` |
|     5 |  167 |  |
| 14035 |  168 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|     - |  169 | `	VmObEntry *pEntry;` |
|     - |  170 | `	ph7_value sResult;` |
|     - |  171 | `	/* Peek the top most entry */` |
| 14035 |  172 | `	pEntry = (VmObEntry *)SySetPeek(&pVm->aOB);` |
| 14035 |  173 | `	if( pEntry == 0 ){` |
|     - |  174 | `		/* CAN'T HAPPEN */` |
|   ! 0 |  175 | `		return PH7_OK;` |
|     - |  176 | `	}` |
| 14035 |  177 | `	PH7_MemObjInit(pVm,&sResult);` |
| 14035 |  178 | `	if( ph7_value_is_callable(&pEntry->sCallback) && pVm->nObDepth < 15 ){` |
...
|   ! 0 |  194 | `	}` |
| 14035 |  195 | `	if( nDataLen > 0 ){` |
|     - |  196 | `		/* Redirect the VM output to the internal buffer */` |
| 14035 |  197 | `		SyBlobAppend(&pEntry->sOB,pData,nDataLen);` |
|  7015 |  198 | `	}` |
|     - |  199 | `	/* Release */` |
| 14035 |  200 | `	PH7_MemObjRelease(&sResult);` |
| 14035 |  201 | `	return PH7_OK;` |
|  7020 |  202 |  |
|     - |  203 | `/*` |
...
|     - |  206 | ` * information.` |
|     - |  207 | ` */` |
|  9960 |  208 | `static void VmObRestore(ph7_vm *pVm,VmObEntry *pEntry)` |
|     5 |  209 |  |
|  9965 |  210 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|  9965 |  211 | `	if( SySetUsed(&pVm->aOB) < 1 ){` |
|     - |  212 | `		/* No more stackable OB */` |
|  9947 |  213 | `		pCons->xConsumer = pCons->xDef;` |
|  9947 |  214 | `		pCons->pUserData = pCons->pDefData;` |
|  4971 |  215 | `	}` |
|     - |  216 | `	/* Release OB data */` |
|  9965 |  217 | `	PH7_MemObjRelease(&pEntry->sCallback);` |
|  9965 |  218 | `	SyBlobRelease(&pEntry->sOB);` |
|  9965 |  219 |  |
|     - |  220 | `/*` |
...
|     - |  242 | ` */` |
|  9960 |  243 | `PH7_PRIVATE int vm_builtin_ob_start(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 |  244 |  |
|  9965 |  245 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  246 | `	VmObEntry sOb;` |
|     - |  247 | `	sxi32 rc;` |
|     - |  248 | `	/* Initialize the OB entry */` |
|  9965 |  249 | `	PH7_MemObjInit(pCtx->pVm,&sOb.sCallback);` |
|  9965 |  250 | `	SyBlobInit(&sOb.sOB,&pVm->sAllocator);` |
|  9965 |  251 | `	if( nArg > 0 && (apArg[0]->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP)) ){` |
|     - |  252 | `		/* Save the callback name for later invocation */` |
|   ! 0 |  253 | `		PH7_MemObjStore(apArg[0],&sOb.sCallback);` |
|   ! 0 |  254 | `	}` |
|     - |  255 | `	/* Push in the stack */` |
|  9965 |  256 | `	rc = SySetPut(&pVm->aOB,(const void *)&sOb);` |
|  9965 |  257 | `	if( rc != SXRET_OK ){` |
|   ! 0 |  258 | `		PH7_MemObjRelease(&sOb.sCallback);` |
|   ! 0 |  259 | `	}else{` |
|  9965 |  260 | `		ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|     - |  261 | `		/* Substitute the default VM consumer */` |
|  9965 |  262 | `		if( pCons->xConsumer != VmObConsumer ){` |
|  9947 |  263 | `			pCons->xDef = pCons->xConsumer;` |
|  9947 |  264 | `			pCons->pDefData = pCons->pUserData;` |
|     - |  265 | `			/* Install the new consumer */` |
|  9947 |  266 | `			pCons->xConsumer = VmObConsumer;` |
|  9947 |  267 | `			pCons->pUserData = pVm;` |
|  4971 |  268 | `		}` |
|     - |  269 | `	}` |
|  9965 |  270 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|  9965 |  271 | `	return PH7_OK;` |
|     5 |  272 |  |
|     - |  273 | `/*` |
