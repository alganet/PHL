...
|     2 |   45 |  |
|  4114 |   46 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |   47 | `	VmObEntry *pOb;` |
|     - |   48 | `	/* Pop the top most OB */` |
|  4114 |   49 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  4114 |   50 | `	if( pOb == 0){` |
...
|   ! 0 |   55 | `	}else{` |
|     - |   56 | `		/* Release */` |
|  4114 |   57 | `		VmObRestore(pVm,pOb);` |
|     - |   58 | `		/* Return true */` |
|  4114 |   59 | `		ph7_result_bool(pCtx,1);` |
|     - |   60 | `	}` |
|  4114 |   61 | `	return PH7_OK;` |
|     2 |   62 |  |
|     - |   63 | `/*` |
...
|     - |   96 | ` */` |
|  5404 |   97 | `PH7_PRIVATE int vm_builtin_ob_get_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     2 |   98 |  |
|  5406 |   99 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  100 | `	VmObEntry *pOb;` |
|     - |  101 | `	/* Pop the top most OB */` |
|  5406 |  102 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  5406 |  103 | `	if( pOb == 0 ){` |
...
|   ! 0 |  108 | `	}else{` |
|     - |  109 | `		/* Return contents */` |
|  5406 |  110 | `		ph7_result_string(pCtx,(const char *)SyBlobData(&pOb->sOB),(int)SyBlobLength(&pOb->sOB)); /* Will make it's own copy */` |
|     - |  111 | `		/* Release */` |
|  5406 |  112 | `		VmObRestore(pVm,pOb);` |
|     - |  113 | `	}` |
|  5406 |  114 | `	return PH7_OK;` |
|     2 |  115 |  |
|     - |  116 | `/*` |
...
|     - |  165 | ` */` |
| 11934 |  166 | `PH7_PRIVATE int VmObConsumer(const void *pData,unsigned int nDataLen,void *pUserData)` |
|     2 |  167 |  |
| 11936 |  168 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|     - |  169 | `	VmObEntry *pEntry;` |
|     - |  170 | `	ph7_value sResult;` |
|     - |  171 | `	/* Peek the top most entry */` |
| 11936 |  172 | `	pEntry = (VmObEntry *)SySetPeek(&pVm->aOB);` |
| 11936 |  173 | `	if( pEntry == 0 ){` |
|     - |  174 | `		/* CAN'T HAPPEN */` |
|   ! 0 |  175 | `		return PH7_OK;` |
|     - |  176 | `	}` |
| 11936 |  177 | `	PH7_MemObjInit(pVm,&sResult);` |
| 11936 |  178 | `	if( ph7_value_is_callable(&pEntry->sCallback) && pVm->nObDepth < 15 ){` |
...
|   ! 0 |  194 | `	}` |
| 11936 |  195 | `	if( nDataLen > 0 ){` |
|     - |  196 | `		/* Redirect the VM output to the internal buffer */` |
| 11936 |  197 | `		SyBlobAppend(&pEntry->sOB,pData,nDataLen);` |
|  5967 |  198 | `	}` |
|     - |  199 | `	/* Release */` |
| 11936 |  200 | `	PH7_MemObjRelease(&sResult);` |
| 11936 |  201 | `	return PH7_OK;` |
|  5969 |  202 |  |
|     - |  203 | `/*` |
...
|     - |  206 | ` * information.` |
|     - |  207 | ` */` |
|  9518 |  208 | `static void VmObRestore(ph7_vm *pVm,VmObEntry *pEntry)` |
|     2 |  209 |  |
|  9520 |  210 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|  9520 |  211 | `	if( SySetUsed(&pVm->aOB) < 1 ){` |
|     - |  212 | `		/* No more stackable OB */` |
|  9502 |  213 | `		pCons->xConsumer = pCons->xDef;` |
|  9502 |  214 | `		pCons->pUserData = pCons->pDefData;` |
|  4750 |  215 | `	}` |
|     - |  216 | `	/* Release OB data */` |
|  9520 |  217 | `	PH7_MemObjRelease(&pEntry->sCallback);` |
|  9520 |  218 | `	SyBlobRelease(&pEntry->sOB);` |
|  9520 |  219 |  |
|     - |  220 | `/*` |
...
|     - |  242 | ` */` |
|  9518 |  243 | `PH7_PRIVATE int vm_builtin_ob_start(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     2 |  244 |  |
|  9520 |  245 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  246 | `	VmObEntry sOb;` |
|     - |  247 | `	sxi32 rc;` |
|     - |  248 | `	/* Initialize the OB entry */` |
|  9520 |  249 | `	PH7_MemObjInit(pCtx->pVm,&sOb.sCallback);` |
|  9520 |  250 | `	SyBlobInit(&sOb.sOB,&pVm->sAllocator);` |
|  9520 |  251 | `	if( nArg > 0 && (apArg[0]->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP)) ){` |
|     - |  252 | `		/* Save the callback name for later invocation */` |
|   ! 0 |  253 | `		PH7_MemObjStore(apArg[0],&sOb.sCallback);` |
|   ! 0 |  254 | `	}` |
|     - |  255 | `	/* Push in the stack */` |
|  9520 |  256 | `	rc = SySetPut(&pVm->aOB,(const void *)&sOb);` |
|  9520 |  257 | `	if( rc != SXRET_OK ){` |
|   ! 0 |  258 | `		PH7_MemObjRelease(&sOb.sCallback);` |
|   ! 0 |  259 | `	}else{` |
|  9520 |  260 | `		ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|     - |  261 | `		/* Substitute the default VM consumer */` |
|  9520 |  262 | `		if( pCons->xConsumer != VmObConsumer ){` |
|  9502 |  263 | `			pCons->xDef = pCons->xConsumer;` |
|  9502 |  264 | `			pCons->pDefData = pCons->pUserData;` |
|     - |  265 | `			/* Install the new consumer */` |
|  9502 |  266 | `			pCons->xConsumer = VmObConsumer;` |
|  9502 |  267 | `			pCons->pUserData = pVm;` |
|  4750 |  268 | `		}` |
|     - |  269 | `	}` |
|  9520 |  270 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|  9520 |  271 | `	return PH7_OK;` |
|     2 |  272 |  |
|     - |  273 | `/*` |
