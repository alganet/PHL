...
|     - |  165 | ` */` |
| 27038 |  166 | `PH7_PRIVATE int VmObConsumer(const void *pData,unsigned int nDataLen,void *pUserData)` |
|     5 |  167 | `{` |
| 27043 |  168 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|     - |  169 | `	VmObEntry *pEntry;` |
|     - |  170 | `	ph7_value sResult;` |
|     - |  171 | `	/* Peek the top most entry */` |
| 27043 |  172 | `	pEntry = (VmObEntry *)SySetPeek(&pVm->aOB);` |
| 27043 |  173 | `	if( pEntry == 0 ){` |
|     - |  174 | `		/* CAN'T HAPPEN */` |
|   ! 0 |  175 | `		return PH7_OK;` |
|     - |  176 | `	}` |
| 27043 |  177 | `	PH7_MemObjInit(pVm,&sResult);` |
| 27043 |  178 | `	if( ph7_value_is_callable(&pEntry->sCallback) && pVm->nObDepth < 15 ){` |
...
|   ! 0 |  201 | `	}` |
| 27043 |  202 | `	if( nDataLen > 0 ){` |
|     - |  203 | `		/* Redirect the VM output to the internal buffer */` |
| 27043 |  204 | `		SyBlobAppend(&pEntry->sOB,pData,nDataLen);` |
| 13519 |  205 | `	}` |
|     - |  206 | `	/* Release */` |
| 27043 |  207 | `	PH7_MemObjRelease(&sResult);` |
| 27043 |  208 | `	return PH7_OK;` |
| 13524 |  209 | `}` |
|     - |  210 | `/*` |
...
|     - |  213 | ` * information.` |
|     - |  214 | ` */` |
|  9414 |  215 | `static void VmObRestore(ph7_vm *pVm,VmObEntry *pEntry)` |
|     5 |  216 | `{` |
|  9419 |  217 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|  9419 |  218 | `	if( SySetUsed(&pVm->aOB) < 1 ){` |
|     - |  219 | `		/* No more stackable OB */` |
|  9401 |  220 | `		pCons->xConsumer = pCons->xDef;` |
|  9401 |  221 | `		pCons->pUserData = pCons->pDefData;` |
|  4698 |  222 | `	}` |
|     - |  223 | `	/* Release OB data */` |
|  9419 |  224 | `	PH7_MemObjRelease(&pEntry->sCallback);` |
|  9419 |  225 | `	SyBlobRelease(&pEntry->sOB);` |
|  9419 |  226 | `}` |
|     - |  227 | `/*` |
...
|  9401 |  270 | `			pCons->xDef = pCons->xConsumer;` |
|  9401 |  271 | `			pCons->pDefData = pCons->pUserData;` |
|     - |  272 | `			/* Install the new consumer */` |
|  9401 |  273 | `			pCons->xConsumer = VmObConsumer;` |
|  9401 |  274 | `			pCons->pUserData = pVm;` |
|  4698 |  275 | `		}` |
|     - |  276 | `	}` |
