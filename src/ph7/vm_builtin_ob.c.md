...
|     - |   96 | ` */` |
|  5426 |   97 | `PH7_PRIVATE int vm_builtin_ob_get_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     2 |   98 |  |
|  5428 |   99 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  100 | `	VmObEntry *pOb;` |
|     - |  101 | `	/* Pop the top most OB */` |
|  5428 |  102 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  5428 |  103 | `	if( pOb == 0 ){` |
...
|   ! 0 |  108 | `	}else{` |
|     - |  109 | `		/* Return contents */` |
|  5428 |  110 | `		ph7_result_string(pCtx,(const char *)SyBlobData(&pOb->sOB),(int)SyBlobLength(&pOb->sOB)); /* Will make it's own copy */` |
|     - |  111 | `		/* Release */` |
|  5428 |  112 | `		VmObRestore(pVm,pOb);` |
|     - |  113 | `	}` |
|  5428 |  114 | `	return PH7_OK;` |
|     2 |  115 |  |
|     - |  116 | `/*` |
...
|     - |  165 | ` */` |
| 12020 |  166 | `PH7_PRIVATE int VmObConsumer(const void *pData,unsigned int nDataLen,void *pUserData)` |
|     2 |  167 |  |
| 12022 |  168 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|     - |  169 | `	VmObEntry *pEntry;` |
|     - |  170 | `	ph7_value sResult;` |
|     - |  171 | `	/* Peek the top most entry */` |
| 12022 |  172 | `	pEntry = (VmObEntry *)SySetPeek(&pVm->aOB);` |
| 12022 |  173 | `	if( pEntry == 0 ){` |
|     - |  174 | `		/* CAN'T HAPPEN */` |
|   ! 0 |  175 | `		return PH7_OK;` |
|     - |  176 | `	}` |
| 12022 |  177 | `	PH7_MemObjInit(pVm,&sResult);` |
| 12022 |  178 | `	if( ph7_value_is_callable(&pEntry->sCallback) && pVm->nObDepth < 15 ){` |
...
|   ! 0 |  194 | `	}` |
| 12022 |  195 | `	if( nDataLen > 0 ){` |
|     - |  196 | `		/* Redirect the VM output to the internal buffer */` |
| 12022 |  197 | `		SyBlobAppend(&pEntry->sOB,pData,nDataLen);` |
|  6010 |  198 | `	}` |
|     - |  199 | `	/* Release */` |
| 12022 |  200 | `	PH7_MemObjRelease(&sResult);` |
| 12022 |  201 | `	return PH7_OK;` |
|  6012 |  202 |  |
|     - |  203 | `/*` |
...
|     - |  206 | ` * information.` |
|     - |  207 | ` */` |
|  9558 |  208 | `static void VmObRestore(ph7_vm *pVm,VmObEntry *pEntry)` |
|     2 |  209 |  |
|  9560 |  210 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|  9560 |  211 | `	if( SySetUsed(&pVm->aOB) < 1 ){` |
|     - |  212 | `		/* No more stackable OB */` |
|  9542 |  213 | `		pCons->xConsumer = pCons->xDef;` |
|  9542 |  214 | `		pCons->pUserData = pCons->pDefData;` |
|  4770 |  215 | `	}` |
|     - |  216 | `	/* Release OB data */` |
|  9560 |  217 | `	PH7_MemObjRelease(&pEntry->sCallback);` |
|  9560 |  218 | `	SyBlobRelease(&pEntry->sOB);` |
|  9560 |  219 |  |
|     - |  220 | `/*` |
...
|     - |  242 | ` */` |
|  9558 |  243 | `PH7_PRIVATE int vm_builtin_ob_start(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     2 |  244 |  |
|  9560 |  245 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  246 | `	VmObEntry sOb;` |
|     - |  247 | `	sxi32 rc;` |
|     - |  248 | `	/* Initialize the OB entry */` |
|  9560 |  249 | `	PH7_MemObjInit(pCtx->pVm,&sOb.sCallback);` |
|  9560 |  250 | `	SyBlobInit(&sOb.sOB,&pVm->sAllocator);` |
|  9560 |  251 | `	if( nArg > 0 && (apArg[0]->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP)) ){` |
|     - |  252 | `		/* Save the callback name for later invocation */` |
|   ! 0 |  253 | `		PH7_MemObjStore(apArg[0],&sOb.sCallback);` |
|   ! 0 |  254 | `	}` |
|     - |  255 | `	/* Push in the stack */` |
|  9560 |  256 | `	rc = SySetPut(&pVm->aOB,(const void *)&sOb);` |
|  9560 |  257 | `	if( rc != SXRET_OK ){` |
|   ! 0 |  258 | `		PH7_MemObjRelease(&sOb.sCallback);` |
|   ! 0 |  259 | `	}else{` |
|  9560 |  260 | `		ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|     - |  261 | `		/* Substitute the default VM consumer */` |
|  9560 |  262 | `		if( pCons->xConsumer != VmObConsumer ){` |
|  9542 |  263 | `			pCons->xDef = pCons->xConsumer;` |
|  9542 |  264 | `			pCons->pDefData = pCons->pUserData;` |
|     - |  265 | `			/* Install the new consumer */` |
|  9542 |  266 | `			pCons->xConsumer = VmObConsumer;` |
|  9542 |  267 | `			pCons->pUserData = pVm;` |
|  4770 |  268 | `		}` |
|     - |  269 | `	}` |
|  9560 |  270 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|  9560 |  271 | `	return PH7_OK;` |
|     2 |  272 |  |
|     - |  273 | `/*` |
