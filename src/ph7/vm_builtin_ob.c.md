...
|     - |   43 | ` */` |
|  4130 |   44 | `PH7_PRIVATE int vm_builtin_ob_end_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     4 |   45 | `{` |
|  4134 |   46 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |   47 | `	VmObEntry *pOb;` |
|     - |   48 | `	/* Pop the top most OB */` |
|  4134 |   49 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  4134 |   50 | `	if( pOb == 0){` |
...
|   ! 0 |   55 | `	}else{` |
|     - |   56 | `		/* Release */` |
|  4134 |   57 | `		VmObRestore(pVm,pOb);` |
|     - |   58 | `		/* Return true */` |
|  4134 |   59 | `		ph7_result_bool(pCtx,1);` |
|     - |   60 | `	}` |
|  4134 |   61 | `	return PH7_OK;` |
|     4 |   62 | `}` |
|     - |   63 | `/*` |
...
|     - |  165 | ` */` |
| 29854 |  166 | `PH7_PRIVATE int VmObConsumer(const void *pData,unsigned int nDataLen,void *pUserData)` |
|     5 |  167 | `{` |
| 29859 |  168 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|     - |  169 | `	VmObEntry *pEntry;` |
|     - |  170 | `	ph7_value sResult;` |
|     - |  171 | `	/* Peek the top most entry */` |
| 29859 |  172 | `	pEntry = (VmObEntry *)SySetPeek(&pVm->aOB);` |
| 29859 |  173 | `	if( pEntry == 0 ){` |
|     - |  174 | `		/* CAN'T HAPPEN */` |
|   ! 0 |  175 | `		return PH7_OK;` |
|     - |  176 | `	}` |
| 29859 |  177 | `	PH7_MemObjInit(pVm,&sResult);` |
| 29859 |  178 | `	if( ph7_value_is_callable(&pEntry->sCallback) && pVm->nObDepth < 15 ){` |
...
|   ! 0 |  201 | `	}` |
| 29859 |  202 | `	if( nDataLen > 0 ){` |
|     - |  203 | `		/* Redirect the VM output to the internal buffer */` |
| 29859 |  204 | `		SyBlobAppend(&pEntry->sOB,pData,nDataLen);` |
| 14927 |  205 | `	}` |
|     - |  206 | `	/* Release */` |
| 29859 |  207 | `	PH7_MemObjRelease(&sResult);` |
| 29859 |  208 | `	return PH7_OK;` |
| 14932 |  209 | `}` |
|     - |  210 | `/*` |
...
|     - |  213 | ` * information.` |
|     - |  214 | ` */` |
|  9086 |  215 | `static void VmObRestore(ph7_vm *pVm,VmObEntry *pEntry)` |
|     4 |  216 | `{` |
|  9090 |  217 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|  9090 |  218 | `	if( SySetUsed(&pVm->aOB) < 1 ){` |
|     - |  219 | `		/* No more stackable OB */` |
|  9072 |  220 | `		pCons->xConsumer = pCons->xDef;` |
|  9072 |  221 | `		pCons->pUserData = pCons->pDefData;` |
|  4534 |  222 | `	}` |
|     - |  223 | `	/* Release OB data */` |
|  9090 |  224 | `	PH7_MemObjRelease(&pEntry->sCallback);` |
|  9090 |  225 | `	SyBlobRelease(&pEntry->sOB);` |
|  9090 |  226 | `}` |
|     - |  227 | `/*` |
...
|     - |  249 | ` */` |
|  9090 |  250 | `PH7_PRIVATE int vm_builtin_ob_start(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 |  251 | `{` |
|  9095 |  252 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  253 | `	VmObEntry sOb;` |
|     - |  254 | `	sxi32 rc;` |
|     - |  255 | `	/* Initialize the OB entry */` |
|  9095 |  256 | `	PH7_MemObjInit(pCtx->pVm,&sOb.sCallback);` |
|  9095 |  257 | `	SyBlobInit(&sOb.sOB,&pVm->sAllocator);` |
|  9095 |  258 | `	if( nArg > 0 && (apArg[0]->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ)) ){` |
...
|  9095 |  263 | `	rc = SySetPut(&pVm->aOB,(const void *)&sOb);` |
|  9095 |  264 | `	if( rc != SXRET_OK ){` |
|   ! 0 |  265 | `		PH7_MemObjRelease(&sOb.sCallback);` |
|   ! 0 |  266 | `	}else{` |
|  9095 |  267 | `		ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|     - |  268 | `		/* Substitute the default VM consumer */` |
|  9095 |  269 | `		if( pCons->xConsumer != VmObConsumer ){` |
|  9075 |  270 | `			pCons->xDef = pCons->xConsumer;` |
|  9075 |  271 | `			pCons->pDefData = pCons->pUserData;` |
|     - |  272 | `			/* Install the new consumer */` |
|  9075 |  273 | `			pCons->xConsumer = VmObConsumer;` |
|  9075 |  274 | `			pCons->pUserData = pVm;` |
|  4535 |  275 | `		}` |
|     - |  276 | `	}` |
|  9095 |  277 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|  9095 |  278 | `	return PH7_OK;` |
|     5 |  279 | `}` |
|     - |  280 | `/*` |
