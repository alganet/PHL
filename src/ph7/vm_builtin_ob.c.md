...
|     - |   96 | ` */` |
|  4846 |   97 | `PH7_PRIVATE int vm_builtin_ob_get_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     2 |   98 | `{` |
|  4848 |   99 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  100 | `	VmObEntry *pOb;` |
|     - |  101 | `	/* Pop the top most OB */` |
|  4848 |  102 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  4848 |  103 | `	if( pOb == 0 ){` |
...
|   ! 0 |  108 | `	}else{` |
|     - |  109 | `		/* Return contents */` |
|  4848 |  110 | `		ph7_result_string(pCtx,(const char *)SyBlobData(&pOb->sOB),(int)SyBlobLength(&pOb->sOB)); /* Will make it's own copy */` |
|     - |  111 | `		/* Release */` |
|  4848 |  112 | `		VmObRestore(pVm,pOb);` |
|     - |  113 | `	}` |
|  4848 |  114 | `	return PH7_OK;` |
|     2 |  115 | `}` |
|     - |  116 | `/*` |
...
|     - |  165 | ` */` |
| 30288 |  166 | `PH7_PRIVATE int VmObConsumer(const void *pData,unsigned int nDataLen,void *pUserData)` |
|     5 |  167 | `{` |
| 30293 |  168 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|     - |  169 | `	VmObEntry *pEntry;` |
|     - |  170 | `	ph7_value sResult;` |
|     - |  171 | `	/* Peek the top most entry */` |
| 30293 |  172 | `	pEntry = (VmObEntry *)SySetPeek(&pVm->aOB);` |
| 30293 |  173 | `	if( pEntry == 0 ){` |
|     - |  174 | `		/* CAN'T HAPPEN */` |
|   ! 0 |  175 | `		return PH7_OK;` |
|     - |  176 | `	}` |
| 30293 |  177 | `	PH7_MemObjInit(pVm,&sResult);` |
| 30293 |  178 | `	if( ph7_value_is_callable(&pEntry->sCallback) && pVm->nObDepth < 15 ){` |
...
|   ! 0 |  201 | `	}` |
| 30293 |  202 | `	if( nDataLen > 0 ){` |
|     - |  203 | `		/* Redirect the VM output to the internal buffer */` |
| 30293 |  204 | `		SyBlobAppend(&pEntry->sOB,pData,nDataLen);` |
| 15144 |  205 | `	}` |
|     - |  206 | `	/* Release */` |
| 30293 |  207 | `	PH7_MemObjRelease(&sResult);` |
| 30293 |  208 | `	return PH7_OK;` |
| 15149 |  209 | `}` |
|     - |  210 | `/*` |
