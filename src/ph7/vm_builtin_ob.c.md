...
|     - |   96 | ` */` |
|  5010 |   97 | `PH7_PRIVATE int vm_builtin_ob_get_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     2 |   98 | `{` |
|  5012 |   99 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  100 | `	VmObEntry *pOb;` |
|     - |  101 | `	/* Pop the top most OB */` |
|  5012 |  102 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  5012 |  103 | `	if( pOb == 0 ){` |
...
|   ! 0 |  108 | `	}else{` |
|     - |  109 | `		/* Return contents */` |
|  5012 |  110 | `		ph7_result_string(pCtx,(const char *)SyBlobData(&pOb->sOB),(int)SyBlobLength(&pOb->sOB)); /* Will make it's own copy */` |
|     - |  111 | `		/* Release */` |
|  5012 |  112 | `		VmObRestore(pVm,pOb);` |
|     - |  113 | `	}` |
|  5012 |  114 | `	return PH7_OK;` |
|     2 |  115 | `}` |
|     - |  116 | `/*` |
...
|     - |  213 | ` * information.` |
|     - |  214 | ` */` |
|  9142 |  215 | `static void VmObRestore(ph7_vm *pVm,VmObEntry *pEntry)` |
|     4 |  216 | `{` |
|  9146 |  217 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|  9146 |  218 | `	if( SySetUsed(&pVm->aOB) < 1 ){` |
|     - |  219 | `		/* No more stackable OB */` |
|  9128 |  220 | `		pCons->xConsumer = pCons->xDef;` |
|  9128 |  221 | `		pCons->pUserData = pCons->pDefData;` |
|  4562 |  222 | `	}` |
|     - |  223 | `	/* Release OB data */` |
|  9146 |  224 | `	PH7_MemObjRelease(&pEntry->sCallback);` |
|  9146 |  225 | `	SyBlobRelease(&pEntry->sOB);` |
|  9146 |  226 | `}` |
|     - |  227 | `/*` |
...
|     - |  249 | ` */` |
|  9146 |  250 | `PH7_PRIVATE int vm_builtin_ob_start(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 |  251 | `{` |
|  9151 |  252 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  253 | `	VmObEntry sOb;` |
|     - |  254 | `	sxi32 rc;` |
|     - |  255 | `	/* Initialize the OB entry */` |
|  9151 |  256 | `	PH7_MemObjInit(pCtx->pVm,&sOb.sCallback);` |
|  9151 |  257 | `	SyBlobInit(&sOb.sOB,&pVm->sAllocator);` |
|  9151 |  258 | `	if( nArg > 0 && (apArg[0]->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ)) ){` |
...
|  9151 |  263 | `	rc = SySetPut(&pVm->aOB,(const void *)&sOb);` |
|  9151 |  264 | `	if( rc != SXRET_OK ){` |
|   ! 0 |  265 | `		PH7_MemObjRelease(&sOb.sCallback);` |
|   ! 0 |  266 | `	}else{` |
|  9151 |  267 | `		ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|     - |  268 | `		/* Substitute the default VM consumer */` |
|  9151 |  269 | `		if( pCons->xConsumer != VmObConsumer ){` |
|  9131 |  270 | `			pCons->xDef = pCons->xConsumer;` |
|  9131 |  271 | `			pCons->pDefData = pCons->pUserData;` |
|     - |  272 | `			/* Install the new consumer */` |
|  9131 |  273 | `			pCons->xConsumer = VmObConsumer;` |
|  9131 |  274 | `			pCons->pUserData = pVm;` |
|  4563 |  275 | `		}` |
|     - |  276 | `	}` |
|  9151 |  277 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|  9151 |  278 | `	return PH7_OK;` |
|     5 |  279 | `}` |
|     - |  280 | `/*` |
