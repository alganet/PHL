...
|     - |   43 | ` */` |
|  4160 |   44 | `PH7_PRIVATE int vm_builtin_ob_end_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 |   45 | `{` |
|  4165 |   46 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |   47 | `	VmObEntry *pOb;` |
|     - |   48 | `	/* Pop the top most OB */` |
|  4165 |   49 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|  4165 |   50 | `	if( pOb == 0){` |
...
|   ! 0 |   55 | `	}else{` |
|     - |   56 | `		/* Release */` |
|  4165 |   57 | `		VmObRestore(pVm,pOb);` |
|     - |   58 | `		/* Return true */` |
|  4165 |   59 | `		ph7_result_bool(pCtx,1);` |
|     - |   60 | `	}` |
|  4165 |   61 | `	return PH7_OK;` |
|     5 |   62 | `}` |
|     - |   63 | `/*` |
...
|     - |  206 | ` * information.` |
|     - |  207 | ` */` |
|  9538 |  208 | `static void VmObRestore(ph7_vm *pVm,VmObEntry *pEntry)` |
|     5 |  209 | `{` |
|  9543 |  210 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|  9543 |  211 | `	if( SySetUsed(&pVm->aOB) < 1 ){` |
|     - |  212 | `		/* No more stackable OB */` |
|  9525 |  213 | `		pCons->xConsumer = pCons->xDef;` |
|  9525 |  214 | `		pCons->pUserData = pCons->pDefData;` |
|  4760 |  215 | `	}` |
|     - |  216 | `	/* Release OB data */` |
|  9543 |  217 | `	PH7_MemObjRelease(&pEntry->sCallback);` |
|  9543 |  218 | `	SyBlobRelease(&pEntry->sOB);` |
|  9543 |  219 | `}` |
|     - |  220 | `/*` |
...
|     - |  242 | ` */` |
|  9538 |  243 | `PH7_PRIVATE int vm_builtin_ob_start(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 |  244 | `{` |
|  9543 |  245 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  246 | `	VmObEntry sOb;` |
|     - |  247 | `	sxi32 rc;` |
|     - |  248 | `	/* Initialize the OB entry */` |
|  9543 |  249 | `	PH7_MemObjInit(pCtx->pVm,&sOb.sCallback);` |
|  9543 |  250 | `	SyBlobInit(&sOb.sOB,&pVm->sAllocator);` |
|  9543 |  251 | `	if( nArg > 0 && (apArg[0]->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ)) ){` |
...
|  9543 |  256 | `	rc = SySetPut(&pVm->aOB,(const void *)&sOb);` |
|  9543 |  257 | `	if( rc != SXRET_OK ){` |
|   ! 0 |  258 | `		PH7_MemObjRelease(&sOb.sCallback);` |
|   ! 0 |  259 | `	}else{` |
|  9543 |  260 | `		ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|     - |  261 | `		/* Substitute the default VM consumer */` |
|  9543 |  262 | `		if( pCons->xConsumer != VmObConsumer ){` |
|  9525 |  263 | `			pCons->xDef = pCons->xConsumer;` |
|  9525 |  264 | `			pCons->pDefData = pCons->pUserData;` |
|     - |  265 | `			/* Install the new consumer */` |
|  9525 |  266 | `			pCons->xConsumer = VmObConsumer;` |
|  9525 |  267 | `			pCons->pUserData = pVm;` |
|  4760 |  268 | `		}` |
|     - |  269 | `	}` |
|  9543 |  270 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|  9543 |  271 | `	return PH7_OK;` |
|     5 |  272 | `}` |
|     - |  273 | `/*` |
