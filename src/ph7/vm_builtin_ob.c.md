...
|     - |  165 | ` */` |
| 28912 |  166 | `PH7_PRIVATE int VmObConsumer(const void *pData,unsigned int nDataLen,void *pUserData)` |
|     5 |  167 | `{` |
| 28917 |  168 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|     - |  169 | `	VmObEntry *pEntry;` |
|     - |  170 | `	ph7_value sResult;` |
|     - |  171 | `	/* Peek the top most entry */` |
| 28917 |  172 | `	pEntry = (VmObEntry *)SySetPeek(&pVm->aOB);` |
| 28917 |  173 | `	if( pEntry == 0 ){` |
|     - |  174 | `		/* CAN'T HAPPEN */` |
|   ! 0 |  175 | `		return PH7_OK;` |
|     - |  176 | `	}` |
| 28917 |  177 | `	PH7_MemObjInit(pVm,&sResult);` |
| 28917 |  178 | `	if( ph7_value_is_callable(&pEntry->sCallback) && pVm->nObDepth < 15 ){` |
...
|   ! 0 |  201 | `	}` |
| 28917 |  202 | `	if( nDataLen > 0 ){` |
|     - |  203 | `		/* Redirect the VM output to the internal buffer */` |
| 28917 |  204 | `		SyBlobAppend(&pEntry->sOB,pData,nDataLen);` |
| 14456 |  205 | `	}` |
|     - |  206 | `	/* Release */` |
| 28917 |  207 | `	PH7_MemObjRelease(&sResult);` |
| 28917 |  208 | `	return PH7_OK;` |
| 14461 |  209 | `}` |
|     - |  210 | `/*` |
...
|     - |  213 | ` * information.` |
|     - |  214 | ` */` |
|  9108 |  215 | `static void VmObRestore(ph7_vm *pVm,VmObEntry *pEntry)` |
|     4 |  216 | `{` |
|  9112 |  217 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|  9112 |  218 | `	if( SySetUsed(&pVm->aOB) < 1 ){` |
|     - |  219 | `		/* No more stackable OB */` |
|  9094 |  220 | `		pCons->xConsumer = pCons->xDef;` |
|  9094 |  221 | `		pCons->pUserData = pCons->pDefData;` |
|  4545 |  222 | `	}` |
|     - |  223 | `	/* Release OB data */` |
|  9112 |  224 | `	PH7_MemObjRelease(&pEntry->sCallback);` |
|  9112 |  225 | `	SyBlobRelease(&pEntry->sOB);` |
|  9112 |  226 | `}` |
|     - |  227 | `/*` |
...
|     - |  249 | ` */` |
|  9112 |  250 | `PH7_PRIVATE int vm_builtin_ob_start(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 |  251 | `{` |
|  9117 |  252 | `	ph7_vm *pVm = pCtx->pVm;` |
|     - |  253 | `	VmObEntry sOb;` |
|     - |  254 | `	sxi32 rc;` |
|     - |  255 | `	/* Initialize the OB entry */` |
|  9117 |  256 | `	PH7_MemObjInit(pCtx->pVm,&sOb.sCallback);` |
|  9117 |  257 | `	SyBlobInit(&sOb.sOB,&pVm->sAllocator);` |
|  9117 |  258 | `	if( nArg > 0 && (apArg[0]->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ)) ){` |
...
|  9117 |  263 | `	rc = SySetPut(&pVm->aOB,(const void *)&sOb);` |
|  9117 |  264 | `	if( rc != SXRET_OK ){` |
|   ! 0 |  265 | `		PH7_MemObjRelease(&sOb.sCallback);` |
|   ! 0 |  266 | `	}else{` |
|  9117 |  267 | `		ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|     - |  268 | `		/* Substitute the default VM consumer */` |
|  9117 |  269 | `		if( pCons->xConsumer != VmObConsumer ){` |
|  9097 |  270 | `			pCons->xDef = pCons->xConsumer;` |
|  9097 |  271 | `			pCons->pDefData = pCons->pUserData;` |
|     - |  272 | `			/* Install the new consumer */` |
|  9097 |  273 | `			pCons->xConsumer = VmObConsumer;` |
|  9097 |  274 | `			pCons->pUserData = pVm;` |
|  4546 |  275 | `		}` |
|     - |  276 | `	}` |
|  9117 |  277 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|  9117 |  278 | `	return PH7_OK;` |
|     5 |  279 | `}` |
|     - |  280 | `/*` |
