...
|     - |  165 | ` */` |
| 16628 |  166 | `PH7_PRIVATE int VmObConsumer(const void *pData,unsigned int nDataLen,void *pUserData)` |
|     5 |  167 | `{` |
| 16633 |  168 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|     - |  169 | `	VmObEntry *pEntry;` |
|     - |  170 | `	ph7_value sResult;` |
|     - |  171 | `	/* Peek the top most entry */` |
| 16633 |  172 | `	pEntry = (VmObEntry *)SySetPeek(&pVm->aOB);` |
| 16633 |  173 | `	if( pEntry == 0 ){` |
|     - |  174 | `		/* CAN'T HAPPEN */` |
|   ! 0 |  175 | `		return PH7_OK;` |
|     - |  176 | `	}` |
| 16633 |  177 | `	PH7_MemObjInit(pVm,&sResult);` |
| 16633 |  178 | `	if( ph7_value_is_callable(&pEntry->sCallback) && pVm->nObDepth < 15 ){` |
...
|   ! 0 |  194 | `	}` |
| 16633 |  195 | `	if( nDataLen > 0 ){` |
|     - |  196 | `		/* Redirect the VM output to the internal buffer */` |
| 16633 |  197 | `		SyBlobAppend(&pEntry->sOB,pData,nDataLen);` |
|  8314 |  198 | `	}` |
|     - |  199 | `	/* Release */` |
| 16633 |  200 | `	PH7_MemObjRelease(&sResult);` |
| 16633 |  201 | `	return PH7_OK;` |
|  8319 |  202 | `}` |
|     - |  203 | `/*` |
