...
|      - |  164 | ` */` |
| 241108 |  165 | `PH7_PRIVATE VmOpRc VmExecOpStoreIdxRef(ph7_vm *pVm,VmExecState *pState,VmInstr *pInstr)` |
|      5 |  166 | `{` |
| 241113 |  167 | `	ph7_value *pTos = pState->pTos;` |
| 241113 |  168 | `	ph7_value *pStack = pState->pStack;` |
| 241113 |  169 | `	VmInstr *aInstr = pState->aInstr;` |
| 241113 |  170 | `	sxi32 pc = pState->pc;` |
|      - |  171 | `	sxi32 rc;` |
| 120554 |  172 | `	SXUNUSED(pInstr); SXUNUSED(pStack); SXUNUSED(aInstr); SXUNUSED(rc);` |
| 241113 |  173 | `	ph7_hashmap *pMap = 0; /* cc  warning */` |
|      - |  174 | `	ph7_value *pKey;` |
|      - |  175 | `	sxu32 nIdx;` |
| 241113 |  176 | `	if( pInstr->iP1 ){` |
...
| 241113 |  185 | `		if( pKey && (pTos->iFlags & MEMOBJ_HASHMAP) ){` |
...
| 241109 |  206 | `		ph7_class_instance *pInst = 0;` |
| 241109 |  207 | `		if( pTos->iFlags & MEMOBJ_OBJ ){` |
|     89 |  208 | `			pInst = (ph7_class_instance *)pTos->x.pOther;` |
| 241066 |  209 | `		}else if( nIdx != SXU32_HIGH ){` |
| 241023 |  210 | `			ph7_value *pBacking = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
| 241023 |  211 | `			if( pBacking && (pBacking->iFlags & MEMOBJ_OBJ) ){` |
...
|      - |  267 | `		}` |
|      - |  268 | `	}` |
| 241023 |  269 | `	if( pTos->iFlags & MEMOBJ_HASHMAP ){` |
...
| 240887 |  273 | `		if( nIdx != SXU32_HIGH ){` |
| 240887 |  274 | `			ph7_value *pBacking = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
| 361328 |  275 | `			if( pBacking && (pBacking->iFlags & MEMOBJ_HASHMAP) ){` |
| 240887 |  276 | `				ph7_hashmap *pCur = (ph7_hashmap *)pTos->x.pOther;` |
...
| 240887 |  281 | `				if( pBacking->x.pOther == (void *)pCur ){` |
| 240887 |  282 | `					pCur->iRef--;  /* Undo stack ref to reveal true sharing count */` |
| 240887 |  283 | `					pMap = PH7_HashmapCowSeparate(&(*pVm),pBacking);` |
| 240887 |  284 | `					pMap->iRef++;  /* Re-add stack ref */` |
| 240887 |  285 | `					pTos->x.pOther = pMap;` |
| 120446 |  286 | `				}else{` |
...
|      - |  406 | `	}` |
| 240911 |  407 | `	VmPopOperand(&pTos,1);` |
|      - |  408 | `	/* Phase#2: Perform the insertion */` |
| 240911 |  409 | `	if( pInstr->iOp == PH7_OP_STORE_IDX_REF && pTos->nIdx != SXU32_HIGH ){` |
...
|      - |  433 | `		}` |
|     10 |  434 | `	}else{` |
| 240893 |  435 | `		rc = PH7_HashmapInsert(pMap,pKey,pTos);` |
|      - |  436 | `	}` |
| 240911 |  437 | `	if( pKey ){` |
...
| 240911 |  443 | `	PH7_DISPATCH_ENFORCE_RC(rc)` |
| 240907 |  444 | `	VM_EXIT_BREAK;` |
|    ! 0 |  445 | `	VM_EXIT_BREAK;` |
| 120559 |  446 | `}` |
|      - |  447 |  |
|      - |  448 | `/*` |
...
|      - |  599 | ` */` |
| 660991 |  600 | `PH7_PRIVATE VmOpRc VmExecOpLoadIdx(ph7_vm *pVm,VmExecState *pState,VmInstr *pInstr)` |
|      5 |  601 | `{` |
| 660996 |  602 | `	ph7_value *pTos = pState->pTos;` |
| 660996 |  603 | `	ph7_value *pStack = pState->pStack;` |
| 660996 |  604 | `	VmInstr *aInstr = pState->aInstr;` |
| 660996 |  605 | `	sxi32 pc = pState->pc;` |
|      - |  606 | `	sxi32 rc;` |
| 330854 |  607 | `	SXUNUSED(pInstr); SXUNUSED(pStack); SXUNUSED(aInstr); SXUNUSED(rc);` |
| 660996 |  608 | `	ph7_hashmap_node *pNode = 0; /* cc warning */` |
| 660996 |  609 | `	ph7_hashmap *pMap = 0;` |
|      - |  610 | `	ph7_value *pIdx;` |
| 660996 |  611 | `	pIdx = 0;` |
| 660996 |  612 | `	if( pInstr->iP1 == 0 ){` |
|      3 |  613 | `		if( !pInstr->iP2){` |
...
|      - |  627 | `		}` |
|      2 |  628 | `	}else{` |
| 660994 |  629 | `		pIdx = pTos;` |
| 660994 |  630 | `		pTos--;` |
|      - |  631 | `	}` |
| 660996 |  632 | `	if( pInstr->iP2 == 7 && (pTos->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
...
|    ! 0 |  647 | `		VM_EXIT_BREAK;` |
|      - |  648 | `	}` |
| 660996 |  649 | `	if( pTos->iFlags & MEMOBJ_STRING ){` |
|      - |  650 | `		/* String access */` |
| 514964 |  651 | `		if( pIdx ){` |
|      - |  652 | `			sxi64 iOfft;` |
| 514964 |  653 | `			sxi64 nLen = (sxi64)SyBlobLength(&pTos->sBlob);` |
| 514964 |  654 | `			if( (pIdx->iFlags & MEMOBJ_INT) == 0 ){` |
|      - |  655 | `				/* Force an int cast */` |
|    ! 0 |  656 | `				PH7_MemObjToInteger(pIdx);` |
|    ! 0 |  657 | `			}` |
| 514964 |  658 | `			iOfft = pIdx->x.iVal;` |
...
| 514964 |  662 | `			if( iOfft < 0 ){` |
|      7 |  663 | `				iOfft += nLen;` |
|      3 |  664 | `			}` |
| 514968 |  665 | `			if( iOfft < 0 \|\| iOfft >= nLen ){` |
...
|      - |  681 | `				}` |
|      6 |  682 | `			}else{` |
| 514956 |  683 | `				const char *zData = (const char *)SyBlobData(&pTos->sBlob);` |
| 514956 |  684 | `				int c = zData[iOfft];` |
| 514956 |  685 | `				PH7_MemObjRelease(pTos);` |
| 514956 |  686 | `				MemObjSetType(pTos,MEMOBJ_STRING);` |
| 514956 |  687 | `				SyBlobAppend(&pTos->sBlob,(const void *)&c,sizeof(char));` |
|      - |  688 | `			}` |
| 257846 |  689 | `		}else{` |
|      - |  690 | `			/* No available index,load NULL */` |
|    ! 0 |  691 | `			MemObjSetType(pTos,MEMOBJ_NULL);` |
|      - |  692 | `		}` |
| 514964 |  693 | `		VM_EXIT_BREAK;` |
|      - |  694 | `	}` |
| 146037 |  695 | `	if( pTos->iFlags & MEMOBJ_OBJ ){` |
...
|      - |  865 | `		}` |
|    ! 0 |  866 | `	}` |
| 145859 |  867 | `	if( (pInstr->iP2 == 1 \|\| pInstr->iP2 == 3 \|\| pInstr->iP2 == 5) && (pTos->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
...
|      8 |  897 | `		}` |
|      8 |  898 | `	}` |
| 145853 |  899 | `	rc = SXERR_NOTFOUND; /* Assume the index is invalid */` |
...
| 145848 |  903 | `	if( (pTos->iFlags & MEMOBJ_HASHMAP) && pIdx` |
| 145842 |  904 | `	 && (pInstr->iP2 == 0 \|\| pInstr->iP2 == 1) ){` |
|  34003 |  905 | `		int bNull = (pIdx->iFlags & MEMOBJ_NULL) != 0;` |
|  51005 |  906 | `		int bLossyFloat = (pIdx->iFlags & MEMOBJ_REAL) != 0` |
|  33998 |  907 | `			&& pIdx->rVal != (ph7_real)(sxi64)pIdx->rVal;` |
|  34003 |  908 | `		if( bNull \|\| bLossyFloat ){` |
|      - |  909 | `			SyBlob sErrMsg;` |
...
|      - |  921 | `		}` |
|  16997 |  922 | `	}` |
| 145849 |  923 | `	if( pTos->iFlags & MEMOBJ_HASHMAP ){` |
| 145839 |  924 | `		if( pInstr->iP2 == 1 \|\| pInstr->iP2 == 5 ){` |
...
|   1269 |  931 | `			PH7_HashmapCowSeparate(&(*pVm),pTos);` |
|    632 |  932 | `		}` |
|      - |  933 | `		/* Point to the hashmap */` |
| 145839 |  934 | `		pMap = (ph7_hashmap *)pTos->x.pOther;` |
| 145839 |  935 | `		if( pIdx ){` |
|      - |  936 | `			/* Load the desired entry */` |
| 145837 |  937 | `			rc = PH7_HashmapLookup(pMap,pIdx,&pNode);` |
|  72916 |  938 | `		}` |
| 145839 |  939 | `		if( pInstr->iP2 == 3 ){` |
...
|      7 |  965 | `			}` |
|     10 |  966 | `		}` |
| 145839 |  967 | `		if( rc != SXRET_OK && (pInstr->iP2 == 1 \|\| pInstr->iP2 == 3 \|\| pInstr->iP2 == 5) ){` |
...
|    160 |  980 | `		}` |
|  72916 |  981 | `	}` |
| 145842 |  982 | `	if( rc != SXRET_OK && pIdx && (pInstr->iP2 == 2 \|\| pInstr->iP2 == 0)` |
|  39908 |  983 | `	 && (pTos->iFlags & MEMOBJ_HASHMAP)` |
...
|      3 | 1011 | `	}` |
| 145848 | 1012 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_STRING\|MEMOBJ_OBJ)) == 0` |
|  72932 | 1013 | `	 && (pInstr->iP2 == 0 \|\| pInstr->iP2 == 2)` |
...
|      3 | 1019 | `	}` |
| 145853 | 1020 | `	if( pIdx ){` |
| 145853 | 1021 | `		PH7_MemObjRelease(pIdx);` |
|  72924 | 1022 | `	}` |
| 145853 | 1023 | `	if( rc == SXRET_OK ){` |
|      - | 1024 | `		/* Load entry contents */` |
|  66049 | 1025 | `		if( pMap->iRef < 2 ){` |
...
|     53 | 1031 | `		}else{` |
|  65949 | 1032 | `			pTos->nIdx = pNode->nValIdx;` |
|  65949 | 1033 | `			PH7_HashmapExtractNodeValue(pNode,pTos,FALSE);` |
|  65949 | 1034 | `			PH7_HashmapUnref(pMap);` |
|      - | 1035 | `		}` |
|  33027 | 1036 | `	}else{` |
|      - | 1037 | `		/* No such entry,load NULL */` |
|  79809 | 1038 | `		PH7_MemObjRelease(pTos);` |
|  79809 | 1039 | `		pTos->nIdx = SXU32_HIGH;` |
|      - | 1040 | `	}` |
| 145853 | 1041 | `	VM_EXIT_BREAK;` |
...
|      - | 1048 | ` */` |
|  73794 | 1049 | `PH7_PRIVATE VmOpRc VmExecOpLoadMap(ph7_vm *pVm,VmExecState *pState,VmInstr *pInstr)` |
|      5 | 1050 | `{` |
|  73799 | 1051 | `	ph7_value *pTos = pState->pTos;` |
|  73799 | 1052 | `	ph7_value *pStack = pState->pStack;` |
|  73799 | 1053 | `	VmInstr *aInstr = pState->aInstr;` |
|  73799 | 1054 | `	sxi32 pc = pState->pc;` |
|      - | 1055 | `	sxi32 rc;` |
|  36897 | 1056 | `	SXUNUSED(pInstr); SXUNUSED(pStack); SXUNUSED(aInstr); SXUNUSED(rc);` |
|      - | 1057 | `	ph7_hashmap *pMap;` |
|      - | 1058 | `	/* Allocate a new hashmap instance */` |
|  73799 | 1059 | `	pMap = PH7_NewHashmap(&(*pVm),0,0);` |
|  73799 | 1060 | `	if( pMap == 0 ){` |
...
|      - | 1064 | `	}` |
|  73799 | 1065 | `	if( pInstr->iP1 > 0 ){` |
|  10945 | 1066 | `		ph7_value *pEntry = &pTos[-pInstr->iP1+1]; /* Point to the first entry */` |
|  10945 | 1067 | `		sxi32 rcSpread = SXRET_OK;` |
|      - | 1068 | `		/* Perform the insertion */` |
|  41559 | 1069 | `		while( pEntry < pTos ){` |
|  30637 | 1070 | `			if( pEntry[1].iFlags & MEMOBJ_AUX_SPREAD ){` |
...
|     21 | 1096 | `					break;` |
|      1 | 1097 | `				}` |
|  30288 | 1098 | `			}else if( pEntry[1].iFlags & MEMOBJ_REFERENCE ){` |
...
|  29837 | 1111 | `					if( (pEntry->iFlags & MEMOBJ_AUX_NOKEY) == 0 ){` |
...
|  44753 | 1126 | `				PH7_HashmapInsert(pMap,` |
|  29832 | 1127 | `					(pEntry->iFlags & MEMOBJ_AUX_NOKEY) ? 0 /* Automatic index assign */ : pEntry,` |
|  14916 | 1128 | `					&pEntry[1]` |
|      - | 1129 | `				);` |
|      - | 1130 | `			}` |
...
|  10945 | 1135 | `		VmPopOperand(&pTos,pInstr->iP1);` |
|  10945 | 1136 | `		if( rcSpread != SXRET_OK ){` |
...
|  73781 | 1153 | `	pTos++;` |
|  73781 | 1154 | `	pTos->nIdx = SXU32_HIGH;` |
|  73781 | 1155 | `	pTos->x.pOther = pMap;` |
|  73781 | 1156 | `	MemObjSetType(pTos,MEMOBJ_HASHMAP);` |
|  73781 | 1157 | `	VM_EXIT_BREAK;` |
...
|      - | 1233 | ` */` |
|   6700 | 1234 | `PH7_PRIVATE VmOpRc VmExecOpUnsetVar(ph7_vm *pVm,VmExecState *pState,VmInstr *pInstr)` |
|      5 | 1235 | `{` |
|   6705 | 1236 | `	ph7_value *pTos = pState->pTos;` |
|   6705 | 1237 | `	ph7_value *pStack = pState->pStack;` |
|   6705 | 1238 | `	VmInstr *aInstr = pState->aInstr;` |
|   6705 | 1239 | `	sxi32 pc = pState->pc;` |
|      - | 1240 | `	sxi32 rc;` |
|   3350 | 1241 | `	SXUNUSED(pInstr); SXUNUSED(pStack); SXUNUSED(aInstr); SXUNUSED(rc);` |
|      - | 1242 | `	/* unset($name): p3 is the variable name. Drops the NAME only — see VmUnsetVarByName */` |
|   6705 | 1243 | `	SyString *pName = (SyString *)pInstr->p3;` |
|   6705 | 1244 | `	if( pName && pVm->pFrame ){` |
...
|   6705 | 1248 | `		VmFrame *pVarFrame = VmSkipExceptionFrames(pVm->pFrame);` |
|   6705 | 1249 | `		sxi32 rcU = VmUnsetVarByName(&(*pVm),pVarFrame,pName->zString,pName->nByte);` |
|   6705 | 1250 | `		if( rcU == PH7_ABORT ){` |
...
|   6703 | 1257 | `		if( pVm->nBoundaryRc != 0 ){` |
