...
|      - |  164 | ` */` |
| 241156 |  165 | `PH7_PRIVATE VmOpRc VmExecOpStoreIdxRef(ph7_vm *pVm,VmExecState *pState,VmInstr *pInstr)` |
|      5 |  166 | `{` |
| 241161 |  167 | `	ph7_value *pTos = pState->pTos;` |
| 241161 |  168 | `	ph7_value *pStack = pState->pStack;` |
| 241161 |  169 | `	VmInstr *aInstr = pState->aInstr;` |
| 241161 |  170 | `	sxi32 pc = pState->pc;` |
|      - |  171 | `	sxi32 rc;` |
| 120578 |  172 | `	SXUNUSED(pInstr); SXUNUSED(pStack); SXUNUSED(aInstr); SXUNUSED(rc);` |
| 241161 |  173 | `	ph7_hashmap *pMap = 0; /* cc  warning */` |
|      - |  174 | `	ph7_value *pKey;` |
|      - |  175 | `	sxu32 nIdx;` |
| 241161 |  176 | `	if( pInstr->iP1 ){` |
...
| 241161 |  185 | `		if( pKey && (pTos->iFlags & MEMOBJ_HASHMAP) ){` |
|  69125 |  186 | `			int bNull = (pKey->iFlags & MEMOBJ_NULL) != 0;` |
| 103688 |  187 | `			int bLossyFloat = (pKey->iFlags & MEMOBJ_REAL) != 0` |
|  69120 |  188 | `				&& pKey->rVal != (ph7_real)(sxi64)pKey->rVal;` |
|  69125 |  189 | `			if( bNull \|\| bLossyFloat ){` |
|      - |  190 | `				sxi32 rcSc;` |
...
| 241157 |  206 | `		ph7_class_instance *pInst = 0;` |
| 241157 |  207 | `		if( pTos->iFlags & MEMOBJ_OBJ ){` |
|     89 |  208 | `			pInst = (ph7_class_instance *)pTos->x.pOther;` |
| 241114 |  209 | `		}else if( nIdx != SXU32_HIGH ){` |
| 241071 |  210 | `			ph7_value *pBacking = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
| 241071 |  211 | `			if( pBacking && (pBacking->iFlags & MEMOBJ_OBJ) ){` |
...
|      - |  267 | `		}` |
|      - |  268 | `	}` |
| 241071 |  269 | `	if( pTos->iFlags & MEMOBJ_HASHMAP ){` |
...
| 240935 |  273 | `		if( nIdx != SXU32_HIGH ){` |
| 240935 |  274 | `			ph7_value *pBacking = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
| 361400 |  275 | `			if( pBacking && (pBacking->iFlags & MEMOBJ_HASHMAP) ){` |
| 240935 |  276 | `				ph7_hashmap *pCur = (ph7_hashmap *)pTos->x.pOther;` |
...
| 240935 |  281 | `				if( pBacking->x.pOther == (void *)pCur ){` |
| 240935 |  282 | `					pCur->iRef--;  /* Undo stack ref to reveal true sharing count */` |
| 240935 |  283 | `					pMap = PH7_HashmapCowSeparate(&(*pVm),pBacking);` |
| 240935 |  284 | `					pMap->iRef++;  /* Re-add stack ref */` |
| 240935 |  285 | `					pTos->x.pOther = pMap;` |
| 120470 |  286 | `				}else{` |
...
|      - |  406 | `	}` |
| 240959 |  407 | `	VmPopOperand(&pTos,1);` |
|      - |  408 | `	/* Phase#2: Perform the insertion */` |
| 240959 |  409 | `	if( pInstr->iOp == PH7_OP_STORE_IDX_REF && pTos->nIdx != SXU32_HIGH ){` |
...
|      - |  433 | `		}` |
|     10 |  434 | `	}else{` |
| 240941 |  435 | `		rc = PH7_HashmapInsert(pMap,pKey,pTos);` |
|      - |  436 | `	}` |
| 240959 |  437 | `	if( pKey ){` |
|  69133 |  438 | `		PH7_MemObjRelease(pKey);` |
|  34564 |  439 | `	}` |
...
| 240959 |  443 | `	PH7_DISPATCH_ENFORCE_RC(rc)` |
| 240955 |  444 | `	VM_EXIT_BREAK;` |
|    ! 0 |  445 | `	VM_EXIT_BREAK;` |
| 120583 |  446 | `}` |
|      - |  447 |  |
|      - |  448 | `/*` |
...
|      - |  599 | ` */` |
| 661153 |  600 | `PH7_PRIVATE VmOpRc VmExecOpLoadIdx(ph7_vm *pVm,VmExecState *pState,VmInstr *pInstr)` |
|      5 |  601 | `{` |
| 661158 |  602 | `	ph7_value *pTos = pState->pTos;` |
| 661158 |  603 | `	ph7_value *pStack = pState->pStack;` |
| 661158 |  604 | `	VmInstr *aInstr = pState->aInstr;` |
| 661158 |  605 | `	sxi32 pc = pState->pc;` |
|      - |  606 | `	sxi32 rc;` |
| 330939 |  607 | `	SXUNUSED(pInstr); SXUNUSED(pStack); SXUNUSED(aInstr); SXUNUSED(rc);` |
| 661158 |  608 | `	ph7_hashmap_node *pNode = 0; /* cc warning */` |
| 661158 |  609 | `	ph7_hashmap *pMap = 0;` |
|      - |  610 | `	ph7_value *pIdx;` |
| 661158 |  611 | `	pIdx = 0;` |
| 661158 |  612 | `	if( pInstr->iP1 == 0 ){` |
|      3 |  613 | `		if( !pInstr->iP2){` |
...
|      - |  627 | `		}` |
|      2 |  628 | `	}else{` |
| 661156 |  629 | `		pIdx = pTos;` |
| 661156 |  630 | `		pTos--;` |
|      - |  631 | `	}` |
| 661158 |  632 | `	if( pInstr->iP2 == 7 && (pTos->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
...
|    ! 0 |  647 | `		VM_EXIT_BREAK;` |
|      - |  648 | `	}` |
| 661158 |  649 | `	if( pTos->iFlags & MEMOBJ_STRING ){` |
|      - |  650 | `		/* String access */` |
| 514966 |  651 | `		if( pIdx ){` |
|      - |  652 | `			sxi64 iOfft;` |
| 514966 |  653 | `			sxi64 nLen = (sxi64)SyBlobLength(&pTos->sBlob);` |
| 514966 |  654 | `			if( (pIdx->iFlags & MEMOBJ_INT) == 0 ){` |
|      - |  655 | `				/* Force an int cast */` |
|    ! 0 |  656 | `				PH7_MemObjToInteger(pIdx);` |
|    ! 0 |  657 | `			}` |
| 514966 |  658 | `			iOfft = pIdx->x.iVal;` |
...
| 514966 |  662 | `			if( iOfft < 0 ){` |
|      7 |  663 | `				iOfft += nLen;` |
|      3 |  664 | `			}` |
| 514970 |  665 | `			if( iOfft < 0 \|\| iOfft >= nLen ){` |
...
|      - |  681 | `				}` |
|      6 |  682 | `			}else{` |
| 514958 |  683 | `				const char *zData = (const char *)SyBlobData(&pTos->sBlob);` |
| 514958 |  684 | `				int c = zData[iOfft];` |
| 514958 |  685 | `				PH7_MemObjRelease(pTos);` |
| 514958 |  686 | `				MemObjSetType(pTos,MEMOBJ_STRING);` |
| 514958 |  687 | `				SyBlobAppend(&pTos->sBlob,(const void *)&c,sizeof(char));` |
|      - |  688 | `			}` |
| 257851 |  689 | `		}else{` |
|      - |  690 | `			/* No available index,load NULL */` |
|    ! 0 |  691 | `			MemObjSetType(pTos,MEMOBJ_NULL);` |
|      - |  692 | `		}` |
| 514966 |  693 | `		VM_EXIT_BREAK;` |
|      - |  694 | `	}` |
| 146197 |  695 | `	if( pTos->iFlags & MEMOBJ_OBJ ){` |
...
|      - |  865 | `		}` |
|    ! 0 |  866 | `	}` |
| 146019 |  867 | `	if( (pInstr->iP2 == 1 \|\| pInstr->iP2 == 3 \|\| pInstr->iP2 == 5) && (pTos->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
...
|      8 |  897 | `		}` |
|      8 |  898 | `	}` |
| 146013 |  899 | `	rc = SXERR_NOTFOUND; /* Assume the index is invalid */` |
...
| 146008 |  903 | `	if( (pTos->iFlags & MEMOBJ_HASHMAP) && pIdx` |
| 146002 |  904 | `	 && (pInstr->iP2 == 0 \|\| pInstr->iP2 == 1) ){` |
|  33977 |  905 | `		int bNull = (pIdx->iFlags & MEMOBJ_NULL) != 0;` |
|  50966 |  906 | `		int bLossyFloat = (pIdx->iFlags & MEMOBJ_REAL) != 0` |
|  33972 |  907 | `			&& pIdx->rVal != (ph7_real)(sxi64)pIdx->rVal;` |
|  33977 |  908 | `		if( bNull \|\| bLossyFloat ){` |
|      - |  909 | `			SyBlob sErrMsg;` |
...
|      - |  921 | `		}` |
|  16984 |  922 | `	}` |
| 146009 |  923 | `	if( pTos->iFlags & MEMOBJ_HASHMAP ){` |
| 145999 |  924 | `		if( pInstr->iP2 == 1 \|\| pInstr->iP2 == 5 ){` |
...
|   1275 |  931 | `			PH7_HashmapCowSeparate(&(*pVm),pTos);` |
|    635 |  932 | `		}` |
|      - |  933 | `		/* Point to the hashmap */` |
| 145999 |  934 | `		pMap = (ph7_hashmap *)pTos->x.pOther;` |
| 145999 |  935 | `		if( pIdx ){` |
|      - |  936 | `			/* Load the desired entry */` |
| 145997 |  937 | `			rc = PH7_HashmapLookup(pMap,pIdx,&pNode);` |
|  72996 |  938 | `		}` |
| 145999 |  939 | `		if( pInstr->iP2 == 3 ){` |
...
|      7 |  965 | `			}` |
|     10 |  966 | `		}` |
| 145999 |  967 | `		if( rc != SXRET_OK && (pInstr->iP2 == 1 \|\| pInstr->iP2 == 3 \|\| pInstr->iP2 == 5) ){` |
...
|    160 |  980 | `		}` |
|  72996 |  981 | `	}` |
| 146002 |  982 | `	if( rc != SXRET_OK && pIdx && (pInstr->iP2 == 2 \|\| pInstr->iP2 == 0)` |
|  40026 |  983 | `	 && (pTos->iFlags & MEMOBJ_HASHMAP)` |
...
|      3 | 1011 | `	}` |
| 146008 | 1012 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_STRING\|MEMOBJ_OBJ)) == 0` |
|  73012 | 1013 | `	 && (pInstr->iP2 == 0 \|\| pInstr->iP2 == 2)` |
...
|      3 | 1019 | `	}` |
| 146013 | 1020 | `	if( pIdx ){` |
| 146013 | 1021 | `		PH7_MemObjRelease(pIdx);` |
|  73004 | 1022 | `	}` |
| 146013 | 1023 | `	if( rc == SXRET_OK ){` |
|      - | 1024 | `		/* Load entry contents */` |
|  65973 | 1025 | `		if( pMap->iRef < 2 ){` |
...
|      - | 1028 | `			 */` |
|    103 | 1029 | `			pTos->nIdx = SXU32_HIGH;` |
|    103 | 1030 | `			PH7_HashmapExtractNodeValue(pNode,pTos,TRUE);` |
|     53 | 1031 | `		}else{` |
|  65873 | 1032 | `			pTos->nIdx = pNode->nValIdx;` |
|  65873 | 1033 | `			PH7_HashmapExtractNodeValue(pNode,pTos,FALSE);` |
|  65873 | 1034 | `			PH7_HashmapUnref(pMap);` |
|      - | 1035 | `		}` |
|  32989 | 1036 | `	}else{` |
|      - | 1037 | `		/* No such entry,load NULL */` |
|  80045 | 1038 | `		PH7_MemObjRelease(pTos);` |
|  80045 | 1039 | `		pTos->nIdx = SXU32_HIGH;` |
|      - | 1040 | `	}` |
| 146013 | 1041 | `	VM_EXIT_BREAK;` |
...
|      - | 1048 | ` */` |
|  73816 | 1049 | `PH7_PRIVATE VmOpRc VmExecOpLoadMap(ph7_vm *pVm,VmExecState *pState,VmInstr *pInstr)` |
|      5 | 1050 | `{` |
|  73821 | 1051 | `	ph7_value *pTos = pState->pTos;` |
|  73821 | 1052 | `	ph7_value *pStack = pState->pStack;` |
|  73821 | 1053 | `	VmInstr *aInstr = pState->aInstr;` |
|  73821 | 1054 | `	sxi32 pc = pState->pc;` |
|      - | 1055 | `	sxi32 rc;` |
|  36908 | 1056 | `	SXUNUSED(pInstr); SXUNUSED(pStack); SXUNUSED(aInstr); SXUNUSED(rc);` |
|      - | 1057 | `	ph7_hashmap *pMap;` |
|      - | 1058 | `	/* Allocate a new hashmap instance */` |
|  73821 | 1059 | `	pMap = PH7_NewHashmap(&(*pVm),0,0);` |
|  73821 | 1060 | `	if( pMap == 0 ){` |
...
|      - | 1064 | `	}` |
|  73821 | 1065 | `	if( pInstr->iP1 > 0 ){` |
|  10967 | 1066 | `		ph7_value *pEntry = &pTos[-pInstr->iP1+1]; /* Point to the first entry */` |
|  10967 | 1067 | `		sxi32 rcSpread = SXRET_OK;` |
|      - | 1068 | `		/* Perform the insertion */` |
|  41625 | 1069 | `		while( pEntry < pTos ){` |
|  30681 | 1070 | `			if( pEntry[1].iFlags & MEMOBJ_AUX_SPREAD ){` |
...
|     21 | 1096 | `					break;` |
|      1 | 1097 | `				}` |
|  30332 | 1098 | `			}else if( pEntry[1].iFlags & MEMOBJ_REFERENCE ){` |
...
|  29881 | 1111 | `					if( (pEntry->iFlags & MEMOBJ_AUX_NOKEY) == 0 ){` |
|      - | 1112 | `						/* php only DEPRECATES a lossy-float / null literal key; PHL rejects it. */` |
|  11181 | 1113 | `						int bNull = (pEntry->iFlags & MEMOBJ_NULL) != 0;` |
|  16770 | 1114 | `						int bLossyFloat = (pEntry->iFlags & MEMOBJ_REAL) != 0` |
|  11176 | 1115 | `							&& pEntry->rVal != (ph7_real)(sxi64)pEntry->rVal;` |
|  11181 | 1116 | `						if( bNull \|\| bLossyFloat ){` |
...
|  44819 | 1126 | `				PH7_HashmapInsert(pMap,` |
|  29876 | 1127 | `					(pEntry->iFlags & MEMOBJ_AUX_NOKEY) ? 0 /* Automatic index assign */ : pEntry,` |
|  14938 | 1128 | `					&pEntry[1]` |
|      - | 1129 | `				);` |
|      - | 1130 | `			}` |
...
|  10967 | 1135 | `		VmPopOperand(&pTos,pInstr->iP1);` |
|  10967 | 1136 | `		if( rcSpread != SXRET_OK ){` |
...
|  73803 | 1153 | `	pTos++;` |
|  73803 | 1154 | `	pTos->nIdx = SXU32_HIGH;` |
|  73803 | 1155 | `	pTos->x.pOther = pMap;` |
|  73803 | 1156 | `	MemObjSetType(pTos,MEMOBJ_HASHMAP);` |
|  73803 | 1157 | `	VM_EXIT_BREAK;` |
...
|      - | 1233 | ` */` |
|   6718 | 1234 | `PH7_PRIVATE VmOpRc VmExecOpUnsetVar(ph7_vm *pVm,VmExecState *pState,VmInstr *pInstr)` |
|      5 | 1235 | `{` |
|   6723 | 1236 | `	ph7_value *pTos = pState->pTos;` |
|   6723 | 1237 | `	ph7_value *pStack = pState->pStack;` |
|   6723 | 1238 | `	VmInstr *aInstr = pState->aInstr;` |
|   6723 | 1239 | `	sxi32 pc = pState->pc;` |
|      - | 1240 | `	sxi32 rc;` |
|   3359 | 1241 | `	SXUNUSED(pInstr); SXUNUSED(pStack); SXUNUSED(aInstr); SXUNUSED(rc);` |
|      - | 1242 | `	/* unset($name): p3 is the variable name. Drops the NAME only — see VmUnsetVarByName */` |
|   6723 | 1243 | `	SyString *pName = (SyString *)pInstr->p3;` |
|   6723 | 1244 | `	if( pName && pVm->pFrame ){` |
...
|   6723 | 1248 | `		VmFrame *pVarFrame = VmSkipExceptionFrames(pVm->pFrame);` |
|   6723 | 1249 | `		sxi32 rcU = VmUnsetVarByName(&(*pVm),pVarFrame,pName->zString,pName->nByte);` |
|   6723 | 1250 | `		if( rcU == PH7_ABORT ){` |
...
|   6721 | 1257 | `		if( pVm->nBoundaryRc != 0 ){` |
