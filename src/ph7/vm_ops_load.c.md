...
|      - |  164 | ` */` |
| 241146 |  165 | `PH7_PRIVATE VmOpRc VmExecOpStoreIdxRef(ph7_vm *pVm,VmExecState *pState,VmInstr *pInstr)` |
|      5 |  166 | `{` |
| 241151 |  167 | `	ph7_value *pTos = pState->pTos;` |
| 241151 |  168 | `	ph7_value *pStack = pState->pStack;` |
| 241151 |  169 | `	VmInstr *aInstr = pState->aInstr;` |
| 241151 |  170 | `	sxi32 pc = pState->pc;` |
|      - |  171 | `	sxi32 rc;` |
| 120573 |  172 | `	SXUNUSED(pInstr); SXUNUSED(pStack); SXUNUSED(aInstr); SXUNUSED(rc);` |
| 241151 |  173 | `	ph7_hashmap *pMap = 0; /* cc  warning */` |
|      - |  174 | `	ph7_value *pKey;` |
|      - |  175 | `	sxu32 nIdx;` |
| 241151 |  176 | `	if( pInstr->iP1 ){` |
...
| 241151 |  185 | `		if( pKey && (pTos->iFlags & MEMOBJ_HASHMAP) ){` |
|  69115 |  186 | `			int bNull = (pKey->iFlags & MEMOBJ_NULL) != 0;` |
| 103673 |  187 | `			int bLossyFloat = (pKey->iFlags & MEMOBJ_REAL) != 0` |
|  69110 |  188 | `				&& pKey->rVal != (ph7_real)(sxi64)pKey->rVal;` |
|  69115 |  189 | `			if( bNull \|\| bLossyFloat ){` |
|      - |  190 | `				sxi32 rcSc;` |
...
| 241147 |  206 | `		ph7_class_instance *pInst = 0;` |
| 241147 |  207 | `		if( pTos->iFlags & MEMOBJ_OBJ ){` |
|     89 |  208 | `			pInst = (ph7_class_instance *)pTos->x.pOther;` |
| 241104 |  209 | `		}else if( nIdx != SXU32_HIGH ){` |
| 241061 |  210 | `			ph7_value *pBacking = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
| 241061 |  211 | `			if( pBacking && (pBacking->iFlags & MEMOBJ_OBJ) ){` |
...
|      - |  267 | `		}` |
|      - |  268 | `	}` |
| 241061 |  269 | `	if( pTos->iFlags & MEMOBJ_HASHMAP ){` |
...
| 240925 |  273 | `		if( nIdx != SXU32_HIGH ){` |
| 240925 |  274 | `			ph7_value *pBacking = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
| 361385 |  275 | `			if( pBacking && (pBacking->iFlags & MEMOBJ_HASHMAP) ){` |
| 240925 |  276 | `				ph7_hashmap *pCur = (ph7_hashmap *)pTos->x.pOther;` |
...
| 240925 |  281 | `				if( pBacking->x.pOther == (void *)pCur ){` |
| 240925 |  282 | `					pCur->iRef--;  /* Undo stack ref to reveal true sharing count */` |
| 240925 |  283 | `					pMap = PH7_HashmapCowSeparate(&(*pVm),pBacking);` |
| 240925 |  284 | `					pMap->iRef++;  /* Re-add stack ref */` |
| 240925 |  285 | `					pTos->x.pOther = pMap;` |
| 120465 |  286 | `				}else{` |
...
|      - |  406 | `	}` |
| 240949 |  407 | `	VmPopOperand(&pTos,1);` |
|      - |  408 | `	/* Phase#2: Perform the insertion */` |
| 240949 |  409 | `	if( pInstr->iOp == PH7_OP_STORE_IDX_REF && pTos->nIdx != SXU32_HIGH ){` |
...
|      - |  433 | `		}` |
|     10 |  434 | `	}else{` |
| 240931 |  435 | `		rc = PH7_HashmapInsert(pMap,pKey,pTos);` |
|      - |  436 | `	}` |
| 240949 |  437 | `	if( pKey ){` |
|  69123 |  438 | `		PH7_MemObjRelease(pKey);` |
|  34559 |  439 | `	}` |
...
| 240949 |  443 | `	PH7_DISPATCH_ENFORCE_RC(rc)` |
| 240945 |  444 | `	VM_EXIT_BREAK;` |
|    ! 0 |  445 | `	VM_EXIT_BREAK;` |
| 120578 |  446 | `}` |
|      - |  447 |  |
|      - |  448 | `/*` |
...
|      - |  599 | ` */` |
| 661058 |  600 | `PH7_PRIVATE VmOpRc VmExecOpLoadIdx(ph7_vm *pVm,VmExecState *pState,VmInstr *pInstr)` |
|      5 |  601 | `{` |
| 661063 |  602 | `	ph7_value *pTos = pState->pTos;` |
| 661063 |  603 | `	ph7_value *pStack = pState->pStack;` |
| 661063 |  604 | `	VmInstr *aInstr = pState->aInstr;` |
| 661063 |  605 | `	sxi32 pc = pState->pc;` |
|      - |  606 | `	sxi32 rc;` |
| 330889 |  607 | `	SXUNUSED(pInstr); SXUNUSED(pStack); SXUNUSED(aInstr); SXUNUSED(rc);` |
| 661063 |  608 | `	ph7_hashmap_node *pNode = 0; /* cc warning */` |
| 661063 |  609 | `	ph7_hashmap *pMap = 0;` |
|      - |  610 | `	ph7_value *pIdx;` |
| 661063 |  611 | `	pIdx = 0;` |
| 661063 |  612 | `	if( pInstr->iP1 == 0 ){` |
|      3 |  613 | `		if( !pInstr->iP2){` |
...
|      - |  627 | `		}` |
|      2 |  628 | `	}else{` |
| 661061 |  629 | `		pIdx = pTos;` |
| 661061 |  630 | `		pTos--;` |
|      - |  631 | `	}` |
| 661063 |  632 | `	if( pInstr->iP2 == 7 && (pTos->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
...
|    ! 0 |  647 | `		VM_EXIT_BREAK;` |
|      - |  648 | `	}` |
| 661063 |  649 | `	if( pTos->iFlags & MEMOBJ_STRING ){` |
|      - |  650 | `		/* String access */` |
| 514961 |  651 | `		if( pIdx ){` |
|      - |  652 | `			sxi64 iOfft;` |
...
|      - |  694 | `	}` |
| 146107 |  695 | `	if( pTos->iFlags & MEMOBJ_OBJ ){` |
...
|      - |  865 | `		}` |
|    ! 0 |  866 | `	}` |
| 145929 |  867 | `	if( (pInstr->iP2 == 1 \|\| pInstr->iP2 == 3 \|\| pInstr->iP2 == 5) && (pTos->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
...
|      8 |  897 | `		}` |
|      8 |  898 | `	}` |
| 145923 |  899 | `	rc = SXERR_NOTFOUND; /* Assume the index is invalid */` |
...
| 145918 |  903 | `	if( (pTos->iFlags & MEMOBJ_HASHMAP) && pIdx` |
| 145912 |  904 | `	 && (pInstr->iP2 == 0 \|\| pInstr->iP2 == 1) ){` |
...
|      - |  921 | `		}` |
|  16984 |  922 | `	}` |
| 145919 |  923 | `	if( pTos->iFlags & MEMOBJ_HASHMAP ){` |
| 145909 |  924 | `		if( pInstr->iP2 == 1 \|\| pInstr->iP2 == 5 ){` |
...
|   1265 |  931 | `			PH7_HashmapCowSeparate(&(*pVm),pTos);` |
|    630 |  932 | `		}` |
|      - |  933 | `		/* Point to the hashmap */` |
| 145909 |  934 | `		pMap = (ph7_hashmap *)pTos->x.pOther;` |
| 145909 |  935 | `		if( pIdx ){` |
|      - |  936 | `			/* Load the desired entry */` |
| 145907 |  937 | `			rc = PH7_HashmapLookup(pMap,pIdx,&pNode);` |
|  72951 |  938 | `		}` |
| 145909 |  939 | `		if( pInstr->iP2 == 3 ){` |
...
|      7 |  965 | `			}` |
|     10 |  966 | `		}` |
| 145909 |  967 | `		if( rc != SXRET_OK && (pInstr->iP2 == 1 \|\| pInstr->iP2 == 3 \|\| pInstr->iP2 == 5) ){` |
...
|    160 |  980 | `		}` |
|  72951 |  981 | `	}` |
| 145912 |  982 | `	if( rc != SXRET_OK && pIdx && (pInstr->iP2 == 2 \|\| pInstr->iP2 == 0)` |
|  39986 |  983 | `	 && (pTos->iFlags & MEMOBJ_HASHMAP)` |
...
|      3 | 1011 | `	}` |
| 145918 | 1012 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_STRING\|MEMOBJ_OBJ)) == 0` |
|  72967 | 1013 | `	 && (pInstr->iP2 == 0 \|\| pInstr->iP2 == 2)` |
...
|      3 | 1019 | `	}` |
| 145923 | 1020 | `	if( pIdx ){` |
| 145923 | 1021 | `		PH7_MemObjRelease(pIdx);` |
|  72959 | 1022 | `	}` |
| 145923 | 1023 | `	if( rc == SXRET_OK ){` |
|      - | 1024 | `		/* Load entry contents */` |
|  65963 | 1025 | `		if( pMap->iRef < 2 ){` |
...
|     53 | 1031 | `		}else{` |
|  65863 | 1032 | `			pTos->nIdx = pNode->nValIdx;` |
|  65863 | 1033 | `			PH7_HashmapExtractNodeValue(pNode,pTos,FALSE);` |
|  65863 | 1034 | `			PH7_HashmapUnref(pMap);` |
|      - | 1035 | `		}` |
|  32984 | 1036 | `	}else{` |
|      - | 1037 | `		/* No such entry,load NULL */` |
|  79965 | 1038 | `		PH7_MemObjRelease(pTos);` |
|  79965 | 1039 | `		pTos->nIdx = SXU32_HIGH;` |
|      - | 1040 | `	}` |
| 145923 | 1041 | `	VM_EXIT_BREAK;` |
...
|  30693 | 1070 | `			if( pEntry[1].iFlags & MEMOBJ_AUX_SPREAD ){` |
...
|     21 | 1096 | `					break;` |
|      1 | 1097 | `				}` |
|  30344 | 1098 | `			}else if( pEntry[1].iFlags & MEMOBJ_REFERENCE ){` |
...
|  29893 | 1111 | `					if( (pEntry->iFlags & MEMOBJ_AUX_NOKEY) == 0 ){` |
...
|  44837 | 1126 | `				PH7_HashmapInsert(pMap,` |
|  29888 | 1127 | `					(pEntry->iFlags & MEMOBJ_AUX_NOKEY) ? 0 /* Automatic index assign */ : pEntry,` |
|  14944 | 1128 | `					&pEntry[1]` |
|      - | 1129 | `				);` |
|      - | 1130 | `			}` |
