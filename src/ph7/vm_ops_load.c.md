...
| 516053 |  631 | `		if( pIdx ){` |
|      - |  632 | `			sxi64 iOfft;` |
| 516053 |  633 | `			sxi64 nLen = (sxi64)SyBlobLength(&pTos->sBlob);` |
| 516053 |  634 | `			if( (pIdx->iFlags & MEMOBJ_INT) == 0 ){` |
|      - |  635 | `				/* Force an int cast */` |
|    ! 0 |  636 | `				PH7_MemObjToInteger(pIdx);` |
|    ! 0 |  637 | `			}` |
| 516053 |  638 | `			iOfft = pIdx->x.iVal;` |
...
| 516053 |  642 | `			if( iOfft < 0 ){` |
|      7 |  643 | `				iOfft += nLen;` |
|      3 |  644 | `			}` |
| 516056 |  645 | `			if( iOfft < 0 \|\| iOfft >= nLen ){` |
...
|      - |  660 | `				}` |
|      4 |  661 | `			}else{` |
| 516047 |  662 | `				const char *zData = (const char *)SyBlobData(&pTos->sBlob);` |
| 516047 |  663 | `				int c = zData[iOfft];` |
| 516047 |  664 | `				PH7_MemObjRelease(pTos);` |
| 516047 |  665 | `				MemObjSetType(pTos,MEMOBJ_STRING);` |
| 516047 |  666 | `				SyBlobAppend(&pTos->sBlob,(const void *)&c,sizeof(char));` |
|      - |  667 | `			}` |
| 258386 |  668 | `		}else{` |
