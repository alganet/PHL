...
|      - |  164 | ` */` |
| 241168 |  165 | `PH7_PRIVATE VmOpRc VmExecOpStoreIdxRef(ph7_vm *pVm,VmExecState *pState,VmInstr *pInstr)` |
|      5 |  166 | `{` |
| 241173 |  167 | `	ph7_value *pTos = pState->pTos;` |
| 241173 |  168 | `	ph7_value *pStack = pState->pStack;` |
| 241173 |  169 | `	VmInstr *aInstr = pState->aInstr;` |
| 241173 |  170 | `	sxi32 pc = pState->pc;` |
|      - |  171 | `	sxi32 rc;` |
| 120584 |  172 | `	SXUNUSED(pInstr); SXUNUSED(pStack); SXUNUSED(aInstr); SXUNUSED(rc);` |
| 241173 |  173 | `	ph7_hashmap *pMap = 0; /* cc  warning */` |
|      - |  174 | `	ph7_value *pKey;` |
|      - |  175 | `	sxu32 nIdx;` |
| 241173 |  176 | `	if( pInstr->iP1 ){` |
...
| 241173 |  185 | `		if( pKey && (pTos->iFlags & MEMOBJ_HASHMAP) ){` |
|  69143 |  186 | `			int bNull = (pKey->iFlags & MEMOBJ_NULL) != 0;` |
| 103715 |  187 | `			int bLossyFloat = (pKey->iFlags & MEMOBJ_REAL) != 0` |
|  69138 |  188 | `				&& pKey->rVal != (ph7_real)(sxi64)pKey->rVal;` |
|  69143 |  189 | `			if( bNull \|\| bLossyFloat ){` |
|      - |  190 | `				sxi32 rcSc;` |
...
| 241169 |  206 | `		ph7_class_instance *pInst = 0;` |
| 241169 |  207 | `		if( pTos->iFlags & MEMOBJ_OBJ ){` |
|     89 |  208 | `			pInst = (ph7_class_instance *)pTos->x.pOther;` |
| 241126 |  209 | `		}else if( nIdx != SXU32_HIGH ){` |
| 241083 |  210 | `			ph7_value *pBacking = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
| 241083 |  211 | `			if( pBacking && (pBacking->iFlags & MEMOBJ_OBJ) ){` |
...
|      - |  267 | `		}` |
|      - |  268 | `	}` |
| 241083 |  269 | `	if( pTos->iFlags & MEMOBJ_HASHMAP ){` |
...
| 240947 |  273 | `		if( nIdx != SXU32_HIGH ){` |
| 240947 |  274 | `			ph7_value *pBacking = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
| 361418 |  275 | `			if( pBacking && (pBacking->iFlags & MEMOBJ_HASHMAP) ){` |
| 240947 |  276 | `				ph7_hashmap *pCur = (ph7_hashmap *)pTos->x.pOther;` |
...
| 240947 |  281 | `				if( pBacking->x.pOther == (void *)pCur ){` |
| 240947 |  282 | `					pCur->iRef--;  /* Undo stack ref to reveal true sharing count */` |
| 240947 |  283 | `					pMap = PH7_HashmapCowSeparate(&(*pVm),pBacking);` |
| 240947 |  284 | `					pMap->iRef++;  /* Re-add stack ref */` |
| 240947 |  285 | `					pTos->x.pOther = pMap;` |
| 120476 |  286 | `				}else{` |
...
|      - |  406 | `	}` |
| 240971 |  407 | `	VmPopOperand(&pTos,1);` |
|      - |  408 | `	/* Phase#2: Perform the insertion */` |
| 240971 |  409 | `	if( pInstr->iOp == PH7_OP_STORE_IDX_REF && pTos->nIdx != SXU32_HIGH ){` |
...
|      - |  433 | `		}` |
|     10 |  434 | `	}else{` |
| 240953 |  435 | `		rc = PH7_HashmapInsert(pMap,pKey,pTos);` |
|      - |  436 | `	}` |
| 240971 |  437 | `	if( pKey ){` |
|  69151 |  438 | `		PH7_MemObjRelease(pKey);` |
|  34573 |  439 | `	}` |
...
| 240971 |  443 | `	PH7_DISPATCH_ENFORCE_RC(rc)` |
| 240967 |  444 | `	VM_EXIT_BREAK;` |
|    ! 0 |  445 | `	VM_EXIT_BREAK;` |
| 120589 |  446 | `}` |
|      - |  447 |  |
|      - |  448 | `/*` |
...
|      - |  599 | ` */` |
| 661026 |  600 | `PH7_PRIVATE VmOpRc VmExecOpLoadIdx(ph7_vm *pVm,VmExecState *pState,VmInstr *pInstr)` |
|      5 |  601 | `{` |
| 661031 |  602 | `	ph7_value *pTos = pState->pTos;` |
| 661031 |  603 | `	ph7_value *pStack = pState->pStack;` |
| 661031 |  604 | `	VmInstr *aInstr = pState->aInstr;` |
| 661031 |  605 | `	sxi32 pc = pState->pc;` |
|      - |  606 | `	sxi32 rc;` |
| 330873 |  607 | `	SXUNUSED(pInstr); SXUNUSED(pStack); SXUNUSED(aInstr); SXUNUSED(rc);` |
| 661031 |  608 | `	ph7_hashmap_node *pNode = 0; /* cc warning */` |
| 661031 |  609 | `	ph7_hashmap *pMap = 0;` |
|      - |  610 | `	ph7_value *pIdx;` |
| 661031 |  611 | `	pIdx = 0;` |
| 661031 |  612 | `	if( pInstr->iP1 == 0 ){` |
|      3 |  613 | `		if( !pInstr->iP2){` |
...
|      - |  627 | `		}` |
|      2 |  628 | `	}else{` |
| 661029 |  629 | `		pIdx = pTos;` |
| 661029 |  630 | `		pTos--;` |
|      - |  631 | `	}` |
| 661031 |  632 | `	if( pInstr->iP2 == 7 && (pTos->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
...
|    ! 0 |  647 | `		VM_EXIT_BREAK;` |
|      - |  648 | `	}` |
| 661031 |  649 | `	if( pTos->iFlags & MEMOBJ_STRING ){` |
|      - |  650 | `		/* String access */` |
| 514961 |  651 | `		if( pIdx ){` |
|      - |  652 | `			sxi64 iOfft;` |
...
|      - |  694 | `	}` |
| 146075 |  695 | `	if( pTos->iFlags & MEMOBJ_OBJ ){` |
...
|      - |  865 | `		}` |
|    ! 0 |  866 | `	}` |
| 145897 |  867 | `	if( (pInstr->iP2 == 1 \|\| pInstr->iP2 == 3 \|\| pInstr->iP2 == 5) && (pTos->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
...
|      8 |  897 | `		}` |
|      8 |  898 | `	}` |
| 145891 |  899 | `	rc = SXERR_NOTFOUND; /* Assume the index is invalid */` |
...
| 145886 |  903 | `	if( (pTos->iFlags & MEMOBJ_HASHMAP) && pIdx` |
| 145880 |  904 | `	 && (pInstr->iP2 == 0 \|\| pInstr->iP2 == 1) ){` |
|  34009 |  905 | `		int bNull = (pIdx->iFlags & MEMOBJ_NULL) != 0;` |
|  51014 |  906 | `		int bLossyFloat = (pIdx->iFlags & MEMOBJ_REAL) != 0` |
|  34004 |  907 | `			&& pIdx->rVal != (ph7_real)(sxi64)pIdx->rVal;` |
|  34009 |  908 | `		if( bNull \|\| bLossyFloat ){` |
|      - |  909 | `			SyBlob sErrMsg;` |
...
|      - |  921 | `		}` |
|  17000 |  922 | `	}` |
| 145887 |  923 | `	if( pTos->iFlags & MEMOBJ_HASHMAP ){` |
| 145877 |  924 | `		if( pInstr->iP2 == 1 \|\| pInstr->iP2 == 5 ){` |
...
| 145877 |  934 | `		pMap = (ph7_hashmap *)pTos->x.pOther;` |
| 145877 |  935 | `		if( pIdx ){` |
|      - |  936 | `			/* Load the desired entry */` |
| 145875 |  937 | `			rc = PH7_HashmapLookup(pMap,pIdx,&pNode);` |
|  72935 |  938 | `		}` |
| 145877 |  939 | `		if( pInstr->iP2 == 3 ){` |
...
|      7 |  965 | `			}` |
|     10 |  966 | `		}` |
| 145877 |  967 | `		if( rc != SXRET_OK && (pInstr->iP2 == 1 \|\| pInstr->iP2 == 3 \|\| pInstr->iP2 == 5) ){` |
...
|    160 |  980 | `		}` |
|  72935 |  981 | `	}` |
| 145880 |  982 | `	if( rc != SXRET_OK && pIdx && (pInstr->iP2 == 2 \|\| pInstr->iP2 == 0)` |
|  39920 |  983 | `	 && (pTos->iFlags & MEMOBJ_HASHMAP)` |
...
|      3 | 1011 | `	}` |
| 145886 | 1012 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_STRING\|MEMOBJ_OBJ)) == 0` |
|  72951 | 1013 | `	 && (pInstr->iP2 == 0 \|\| pInstr->iP2 == 2)` |
...
|      3 | 1019 | `	}` |
| 145891 | 1020 | `	if( pIdx ){` |
| 145891 | 1021 | `		PH7_MemObjRelease(pIdx);` |
|  72943 | 1022 | `	}` |
| 145891 | 1023 | `	if( rc == SXRET_OK ){` |
|      - | 1024 | `		/* Load entry contents */` |
|  66063 | 1025 | `		if( pMap->iRef < 2 ){` |
...
|     53 | 1031 | `		}else{` |
|  65963 | 1032 | `			pTos->nIdx = pNode->nValIdx;` |
|  65963 | 1033 | `			PH7_HashmapExtractNodeValue(pNode,pTos,FALSE);` |
|  65963 | 1034 | `			PH7_HashmapUnref(pMap);` |
|      - | 1035 | `		}` |
|  33034 | 1036 | `	}else{` |
|      - | 1037 | `		/* No such entry,load NULL */` |
|  79833 | 1038 | `		PH7_MemObjRelease(pTos);` |
|  79833 | 1039 | `		pTos->nIdx = SXU32_HIGH;` |
|      - | 1040 | `	}` |
| 145891 | 1041 | `	VM_EXIT_BREAK;` |
...
|      - | 1048 | ` */` |
|  73812 | 1049 | `PH7_PRIVATE VmOpRc VmExecOpLoadMap(ph7_vm *pVm,VmExecState *pState,VmInstr *pInstr)` |
|      5 | 1050 | `{` |
|  73817 | 1051 | `	ph7_value *pTos = pState->pTos;` |
|  73817 | 1052 | `	ph7_value *pStack = pState->pStack;` |
|  73817 | 1053 | `	VmInstr *aInstr = pState->aInstr;` |
|  73817 | 1054 | `	sxi32 pc = pState->pc;` |
|      - | 1055 | `	sxi32 rc;` |
|  36906 | 1056 | `	SXUNUSED(pInstr); SXUNUSED(pStack); SXUNUSED(aInstr); SXUNUSED(rc);` |
|      - | 1057 | `	ph7_hashmap *pMap;` |
|      - | 1058 | `	/* Allocate a new hashmap instance */` |
|  73817 | 1059 | `	pMap = PH7_NewHashmap(&(*pVm),0,0);` |
|  73817 | 1060 | `	if( pMap == 0 ){` |
...
|  73799 | 1153 | `	pTos++;` |
|  73799 | 1154 | `	pTos->nIdx = SXU32_HIGH;` |
|  73799 | 1155 | `	pTos->x.pOther = pMap;` |
|  73799 | 1156 | `	MemObjSetType(pTos,MEMOBJ_HASHMAP);` |
|  73799 | 1157 | `	VM_EXIT_BREAK;` |
...
|      - | 1233 | ` */` |
|   6702 | 1234 | `PH7_PRIVATE VmOpRc VmExecOpUnsetVar(ph7_vm *pVm,VmExecState *pState,VmInstr *pInstr)` |
|      5 | 1235 | `{` |
|   6707 | 1236 | `	ph7_value *pTos = pState->pTos;` |
|   6707 | 1237 | `	ph7_value *pStack = pState->pStack;` |
|   6707 | 1238 | `	VmInstr *aInstr = pState->aInstr;` |
|   6707 | 1239 | `	sxi32 pc = pState->pc;` |
|      - | 1240 | `	sxi32 rc;` |
|   3351 | 1241 | `	SXUNUSED(pInstr); SXUNUSED(pStack); SXUNUSED(aInstr); SXUNUSED(rc);` |
|      - | 1242 | `	/* unset($name): p3 is the variable name. Drops the NAME only — see VmUnsetVarByName */` |
|   6707 | 1243 | `	SyString *pName = (SyString *)pInstr->p3;` |
|   6707 | 1244 | `	if( pName && pVm->pFrame ){` |
...
|   6707 | 1248 | `		VmFrame *pVarFrame = VmSkipExceptionFrames(pVm->pFrame);` |
|   6707 | 1249 | `		sxi32 rcU = VmUnsetVarByName(&(*pVm),pVarFrame,pName->zString,pName->nByte);` |
|   6707 | 1250 | `		if( rcU == PH7_ABORT ){` |
...
|   6705 | 1257 | `		if( pVm->nBoundaryRc != 0 ){` |
