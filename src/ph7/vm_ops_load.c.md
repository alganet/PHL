...
|      - |  164 | ` */` |
| 241034 |  165 | `PH7_PRIVATE VmOpRc VmExecOpStoreIdxRef(ph7_vm *pVm,VmExecState *pState,VmInstr *pInstr)` |
|      5 |  166 | `{` |
| 241039 |  167 | `	ph7_value *pTos = pState->pTos;` |
| 241039 |  168 | `	ph7_value *pStack = pState->pStack;` |
| 241039 |  169 | `	VmInstr *aInstr = pState->aInstr;` |
| 241039 |  170 | `	sxi32 pc = pState->pc;` |
|      - |  171 | `	sxi32 rc;` |
| 120517 |  172 | `	SXUNUSED(pInstr); SXUNUSED(pStack); SXUNUSED(aInstr); SXUNUSED(rc);` |
| 241039 |  173 | `	ph7_hashmap *pMap = 0; /* cc  warning */` |
|      - |  174 | `	ph7_value *pKey;` |
|      - |  175 | `	sxu32 nIdx;` |
| 241039 |  176 | `	if( pInstr->iP1 ){` |
...
| 241039 |  185 | `		if( pKey && (pTos->iFlags & MEMOBJ_HASHMAP) ){` |
...
| 241035 |  206 | `		ph7_class_instance *pInst = 0;` |
| 241035 |  207 | `		if( pTos->iFlags & MEMOBJ_OBJ ){` |
|     89 |  208 | `			pInst = (ph7_class_instance *)pTos->x.pOther;` |
| 240992 |  209 | `		}else if( nIdx != SXU32_HIGH ){` |
| 240949 |  210 | `			ph7_value *pBacking = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
| 240949 |  211 | `			if( pBacking && (pBacking->iFlags & MEMOBJ_OBJ) ){` |
...
|      - |  267 | `		}` |
|      - |  268 | `	}` |
| 240949 |  269 | `	if( pTos->iFlags & MEMOBJ_HASHMAP ){` |
...
| 240813 |  273 | `		if( nIdx != SXU32_HIGH ){` |
| 240813 |  274 | `			ph7_value *pBacking = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
| 361217 |  275 | `			if( pBacking && (pBacking->iFlags & MEMOBJ_HASHMAP) ){` |
| 240813 |  276 | `				ph7_hashmap *pCur = (ph7_hashmap *)pTos->x.pOther;` |
...
| 240813 |  281 | `				if( pBacking->x.pOther == (void *)pCur ){` |
| 240813 |  282 | `					pCur->iRef--;  /* Undo stack ref to reveal true sharing count */` |
| 240813 |  283 | `					pMap = PH7_HashmapCowSeparate(&(*pVm),pBacking);` |
| 240813 |  284 | `					pMap->iRef++;  /* Re-add stack ref */` |
| 240813 |  285 | `					pTos->x.pOther = pMap;` |
| 120409 |  286 | `				}else{` |
...
|      - |  406 | `	}` |
| 240837 |  407 | `	VmPopOperand(&pTos,1);` |
|      - |  408 | `	/* Phase#2: Perform the insertion */` |
| 240837 |  409 | `	if( pInstr->iOp == PH7_OP_STORE_IDX_REF && pTos->nIdx != SXU32_HIGH ){` |
...
|      - |  433 | `		}` |
|     10 |  434 | `	}else{` |
| 240819 |  435 | `		rc = PH7_HashmapInsert(pMap,pKey,pTos);` |
|      - |  436 | `	}` |
| 240837 |  437 | `	if( pKey ){` |
...
| 240837 |  443 | `	PH7_DISPATCH_ENFORCE_RC(rc)` |
| 240833 |  444 | `	VM_EXIT_BREAK;` |
|    ! 0 |  445 | `	VM_EXIT_BREAK;` |
| 120522 |  446 | `}` |
|      - |  447 |  |
|      - |  448 | `/*` |
...
|      - |  599 | ` */` |
| 661022 |  600 | `PH7_PRIVATE VmOpRc VmExecOpLoadIdx(ph7_vm *pVm,VmExecState *pState,VmInstr *pInstr)` |
|      5 |  601 | `{` |
| 661027 |  602 | `	ph7_value *pTos = pState->pTos;` |
| 661027 |  603 | `	ph7_value *pStack = pState->pStack;` |
| 661027 |  604 | `	VmInstr *aInstr = pState->aInstr;` |
| 661027 |  605 | `	sxi32 pc = pState->pc;` |
|      - |  606 | `	sxi32 rc;` |
| 330871 |  607 | `	SXUNUSED(pInstr); SXUNUSED(pStack); SXUNUSED(aInstr); SXUNUSED(rc);` |
| 661027 |  608 | `	ph7_hashmap_node *pNode = 0; /* cc warning */` |
| 661027 |  609 | `	ph7_hashmap *pMap = 0;` |
|      - |  610 | `	ph7_value *pIdx;` |
| 661027 |  611 | `	pIdx = 0;` |
| 661027 |  612 | `	if( pInstr->iP1 == 0 ){` |
|      3 |  613 | `		if( !pInstr->iP2){` |
...
|      - |  627 | `		}` |
|      2 |  628 | `	}else{` |
| 661025 |  629 | `		pIdx = pTos;` |
| 661025 |  630 | `		pTos--;` |
|      - |  631 | `	}` |
| 661027 |  632 | `	if( pInstr->iP2 == 7 && (pTos->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
...
|    ! 0 |  647 | `		VM_EXIT_BREAK;` |
|      - |  648 | `	}` |
| 661027 |  649 | `	if( pTos->iFlags & MEMOBJ_STRING ){` |
|      - |  650 | `		/* String access */` |
| 514961 |  651 | `		if( pIdx ){` |
|      - |  652 | `			sxi64 iOfft;` |
...
|      - |  694 | `	}` |
| 146071 |  695 | `	if( pTos->iFlags & MEMOBJ_OBJ ){` |
...
|      - |  865 | `		}` |
|    ! 0 |  866 | `	}` |
| 145893 |  867 | `	if( (pInstr->iP2 == 1 \|\| pInstr->iP2 == 3 \|\| pInstr->iP2 == 5) && (pTos->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
...
|      8 |  897 | `		}` |
|      8 |  898 | `	}` |
| 145887 |  899 | `	rc = SXERR_NOTFOUND; /* Assume the index is invalid */` |
...
| 145882 |  903 | `	if( (pTos->iFlags & MEMOBJ_HASHMAP) && pIdx` |
| 145876 |  904 | `	 && (pInstr->iP2 == 0 \|\| pInstr->iP2 == 1) ){` |
|  33973 |  905 | `		int bNull = (pIdx->iFlags & MEMOBJ_NULL) != 0;` |
|  50960 |  906 | `		int bLossyFloat = (pIdx->iFlags & MEMOBJ_REAL) != 0` |
|  33968 |  907 | `			&& pIdx->rVal != (ph7_real)(sxi64)pIdx->rVal;` |
|  33973 |  908 | `		if( bNull \|\| bLossyFloat ){` |
|      - |  909 | `			SyBlob sErrMsg;` |
...
|      - |  921 | `		}` |
|  16982 |  922 | `	}` |
| 145883 |  923 | `	if( pTos->iFlags & MEMOBJ_HASHMAP ){` |
| 145873 |  924 | `		if( pInstr->iP2 == 1 \|\| pInstr->iP2 == 5 ){` |
...
| 145873 |  934 | `		pMap = (ph7_hashmap *)pTos->x.pOther;` |
| 145873 |  935 | `		if( pIdx ){` |
|      - |  936 | `			/* Load the desired entry */` |
| 145871 |  937 | `			rc = PH7_HashmapLookup(pMap,pIdx,&pNode);` |
|  72933 |  938 | `		}` |
| 145873 |  939 | `		if( pInstr->iP2 == 3 ){` |
...
|      7 |  965 | `			}` |
|     10 |  966 | `		}` |
| 145873 |  967 | `		if( rc != SXRET_OK && (pInstr->iP2 == 1 \|\| pInstr->iP2 == 3 \|\| pInstr->iP2 == 5) ){` |
...
|    160 |  980 | `		}` |
|  72933 |  981 | `	}` |
| 145876 |  982 | `	if( rc != SXRET_OK && pIdx && (pInstr->iP2 == 2 \|\| pInstr->iP2 == 0)` |
|  39972 |  983 | `	 && (pTos->iFlags & MEMOBJ_HASHMAP)` |
...
|      3 | 1011 | `	}` |
| 145882 | 1012 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_STRING\|MEMOBJ_OBJ)) == 0` |
|  72949 | 1013 | `	 && (pInstr->iP2 == 0 \|\| pInstr->iP2 == 2)` |
...
|      3 | 1019 | `	}` |
| 145887 | 1020 | `	if( pIdx ){` |
| 145887 | 1021 | `		PH7_MemObjRelease(pIdx);` |
|  72941 | 1022 | `	}` |
| 145887 | 1023 | `	if( rc == SXRET_OK ){` |
|      - | 1024 | `		/* Load entry contents */` |
|  65955 | 1025 | `		if( pMap->iRef < 2 ){` |
...
|     53 | 1031 | `		}else{` |
|  65855 | 1032 | `			pTos->nIdx = pNode->nValIdx;` |
|  65855 | 1033 | `			PH7_HashmapExtractNodeValue(pNode,pTos,FALSE);` |
|  65855 | 1034 | `			PH7_HashmapUnref(pMap);` |
|      - | 1035 | `		}` |
|  32980 | 1036 | `	}else{` |
|      - | 1037 | `		/* No such entry,load NULL */` |
|  79937 | 1038 | `		PH7_MemObjRelease(pTos);` |
|  79937 | 1039 | `		pTos->nIdx = SXU32_HIGH;` |
|      - | 1040 | `	}` |
| 145887 | 1041 | `	VM_EXIT_BREAK;` |
...
|      - | 1048 | ` */` |
|  73772 | 1049 | `PH7_PRIVATE VmOpRc VmExecOpLoadMap(ph7_vm *pVm,VmExecState *pState,VmInstr *pInstr)` |
|      5 | 1050 | `{` |
|  73777 | 1051 | `	ph7_value *pTos = pState->pTos;` |
|  73777 | 1052 | `	ph7_value *pStack = pState->pStack;` |
|  73777 | 1053 | `	VmInstr *aInstr = pState->aInstr;` |
|  73777 | 1054 | `	sxi32 pc = pState->pc;` |
|      - | 1055 | `	sxi32 rc;` |
|  36886 | 1056 | `	SXUNUSED(pInstr); SXUNUSED(pStack); SXUNUSED(aInstr); SXUNUSED(rc);` |
|      - | 1057 | `	ph7_hashmap *pMap;` |
|      - | 1058 | `	/* Allocate a new hashmap instance */` |
|  73777 | 1059 | `	pMap = PH7_NewHashmap(&(*pVm),0,0);` |
|  73777 | 1060 | `	if( pMap == 0 ){` |
...
|      - | 1064 | `	}` |
|  73777 | 1065 | `	if( pInstr->iP1 > 0 ){` |
|  10941 | 1066 | `		ph7_value *pEntry = &pTos[-pInstr->iP1+1]; /* Point to the first entry */` |
|  10941 | 1067 | `		sxi32 rcSpread = SXRET_OK;` |
|      - | 1068 | `		/* Perform the insertion */` |
|  41547 | 1069 | `		while( pEntry < pTos ){` |
|  30629 | 1070 | `			if( pEntry[1].iFlags & MEMOBJ_AUX_SPREAD ){` |
...
|     21 | 1096 | `					break;` |
|      1 | 1097 | `				}` |
|  30280 | 1098 | `			}else if( pEntry[1].iFlags & MEMOBJ_REFERENCE ){` |
...
|  29829 | 1111 | `					if( (pEntry->iFlags & MEMOBJ_AUX_NOKEY) == 0 ){` |
...
|  44741 | 1126 | `				PH7_HashmapInsert(pMap,` |
|  29824 | 1127 | `					(pEntry->iFlags & MEMOBJ_AUX_NOKEY) ? 0 /* Automatic index assign */ : pEntry,` |
|  14912 | 1128 | `					&pEntry[1]` |
|      - | 1129 | `				);` |
|      - | 1130 | `			}` |
...
|  10941 | 1135 | `		VmPopOperand(&pTos,pInstr->iP1);` |
|  10941 | 1136 | `		if( rcSpread != SXRET_OK ){` |
...
|  73759 | 1153 | `	pTos++;` |
|  73759 | 1154 | `	pTos->nIdx = SXU32_HIGH;` |
|  73759 | 1155 | `	pTos->x.pOther = pMap;` |
|  73759 | 1156 | `	MemObjSetType(pTos,MEMOBJ_HASHMAP);` |
|  73759 | 1157 | `	VM_EXIT_BREAK;` |
...
|      - | 1233 | ` */` |
|   6714 | 1234 | `PH7_PRIVATE VmOpRc VmExecOpUnsetVar(ph7_vm *pVm,VmExecState *pState,VmInstr *pInstr)` |
|      5 | 1235 | `{` |
|   6719 | 1236 | `	ph7_value *pTos = pState->pTos;` |
|   6719 | 1237 | `	ph7_value *pStack = pState->pStack;` |
|   6719 | 1238 | `	VmInstr *aInstr = pState->aInstr;` |
|   6719 | 1239 | `	sxi32 pc = pState->pc;` |
|      - | 1240 | `	sxi32 rc;` |
|   3357 | 1241 | `	SXUNUSED(pInstr); SXUNUSED(pStack); SXUNUSED(aInstr); SXUNUSED(rc);` |
|      - | 1242 | `	/* unset($name): p3 is the variable name. Drops the NAME only — see VmUnsetVarByName */` |
|   6719 | 1243 | `	SyString *pName = (SyString *)pInstr->p3;` |
|   6719 | 1244 | `	if( pName && pVm->pFrame ){` |
...
|   6719 | 1248 | `		VmFrame *pVarFrame = VmSkipExceptionFrames(pVm->pFrame);` |
|   6719 | 1249 | `		sxi32 rcU = VmUnsetVarByName(&(*pVm),pVarFrame,pName->zString,pName->nByte);` |
|   6719 | 1250 | `		if( rcU == PH7_ABORT ){` |
...
|   6717 | 1257 | `		if( pVm->nBoundaryRc != 0 ){` |
