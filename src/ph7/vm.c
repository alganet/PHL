...
static const struct VmBuiltinSig {
	...
	{ "array_unique", "array $array, int $flags = 2" },
	...
	{ "arsort", "array &$array, int $flags = 0" },
	{ "asin", "float $num" },
	...
	{ "cos", "float $num" },
	{ "cosh", "float $num" },
	{ "count", "Countable|array $value, int $mode = 0" },
	{ "crc32", "string $string" },
	...
	{ "debug_backtrace", "int $options = 1, int $limit = 0" },
	...
	{ "exp", "float $num" },
	{ "explode", "string $separator, string $string, int $limit = 9223372036854775807" },
	{ "extract", "array &$array, int $flags = 0, string $prefix = ''" },
	{ "fclose", "$stream" },
	{ "feof", "$stream" },
	{ "fflush", "$stream" },
	{ "fgetc", "$stream" },
	...
	{ "filter_input", "int $type, string $var_name, int $filter = 516, array|int $options = 0" },
	{ "filter_var", "mixed $value, int $filter = 516, array|int $options = 0" },
	...
	{ "fseek", "$stream, int $offset, int $whence = 0" },
	{ "fstat", "$stream" },
	{ "ftell", "$stream" },
	...
	{ "get_defined_vars", "" },
	{ "get_html_translation_table", "int $table = 0, int $flags = 11, string $encoding = 'UTF-8'" },
	{ "get_include_path", "" },
	{ "get_included_files", "" },
	...
	{ "html_entity_decode", "string $string, int $flags = 11, ?string $encoding = NULL" },
	{ "htmlentities", "string $string, int $flags = 11, ?string $encoding = NULL, bool $double_encode = true" },
	{ "htmlspecialchars", "string $string, int $flags = 11, ?string $encoding = NULL, bool $double_encode = true" },
	{ "htmlspecialchars_decode", "string $string, int $flags = 11" },
	{ "http_response_code", "int $response_code = 0" },
	{ "hypot", "float $x, float $y" },
	{ "idate", "string $format, ?int $timestamp = NULL" },
	{ "implode", "array|string $separator, ?array $array = NULL" },
	...
	{ "join", "array|string $separator, ?array $array = NULL" },
	...
	{ "krsort", "array &$array, int $flags = 0" },
	{ "ksort", "array &$array, int $flags = 0" },
	{ "lcfirst", "string $string" },
	{ "link", "string $target, string $link" },
	{ "localtime", "?int $timestamp = NULL, bool $associative = false" },
	{ "log", "float $num, float $base = 2.718281828459045" },
	{ "log10", "float $num" },
	...
	{ "mkdir", "string $directory, int $permissions = 511, bool $recursive = false, $context = NULL" },
	{ "mktime", "int $hour, ?int $minute = NULL, ?int $second = NULL, ?int $month = NULL, ?int $day = NULL, ?int $year = NULL" },
	{ "mt_getrandmax", "" },
	{ "mt_rand", "int $min = ?, int $max = ?" },
	{ "mt_srand", "?int $seed = NULL, int $mode = 0" },
	...
	{ "ob_list_handlers", "" },
	{ "ob_start", "$callback = NULL, int $chunk_size = 0, int $flags = 112" },
	{ "octdec", "string $octal_string" },
	{ "opendir", "string $directory, $context = NULL" },
	{ "ord", "string $character" },
	{ "parse_ini_file", "string $filename, bool $process_sections = false, int $scanner_mode = 0" },
	{ "parse_ini_string", "string $ini_string, bool $process_sections = false, int $scanner_mode = 0" },
	...
	{ "pathinfo", "string $path, int $flags = 15" },
	{ "pclose", "$handle" },
	{ "php_sapi_name", "" },
	{ "php_uname", "string $mode = 'a'" },
	{ "phpinfo", "int $flags = 4294967295" },
	...
	{ "preg_replace", "array|string $pattern, array|string $replacement, array|string $subject, int $limit = -1, &$count = NULL" },
	{ "preg_replace_callback", "array|string $pattern, callable $callback, array|string $subject, int $limit = -1, &$count = NULL, int $flags = 0" },
	...
	{ "round", "int|float $num, int $precision = 0, RoundingMode|int $mode = ?" },
	{ "rsort", "array &$array, int $flags = 0" },
	...
	{ "sin", "float $num" },
	{ "sinh", "float $num" },
	{ "sizeof", "Countable|array $value, int $mode = 0" },
	{ "sleep", "int $seconds" },
	...
	{ "sqrt", "float $num" },
	{ "srand", "?int $seed = NULL, int $mode = 0" },
	...
	{ "str_ireplace", "array|string $search, array|string $replace, array|string $subject, &$count = NULL" },
	{ "str_pad", "string $string, int $length, string $pad_string = ' ', int $pad_type = 1" },
	{ "str_repeat", "string $string, int $times" },
	{ "str_replace", "array|string $search, array|string $replace, array|string $subject, &$count = NULL" },
	...
	{ "strtr", "string $string, array|string $from, ?string $to = NULL" },
	{ "strval", "mixed $value" },
	...
	{ "trigger_error", "string $message, int $error_level = 1024" },
	...
	{ "user_error", "string $message, int $error_level = 1024" },
	...
	{ "wordwrap", "string $string, int $width = 75, string $break = ?, bool $cut_long_words = false" },
...
static void VmSetBuiltinSignatures(ph7_vm *pVm)
{
	...
	for( n = 0 ; n < SX_ARRAYSIZE(aBuiltinSig) ; n++ ){
		...
		if( pEntry ){
			((ph7_user_func *)pEntry->pUserData)->zSig = aBuiltinSig[n].zSig;
		}
	}
}
/*
