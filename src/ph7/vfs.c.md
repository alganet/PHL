...
|      - |   67 | ` */` |
|  19944 |   68 | `static const char * VfsStrerror(int iErr)` |
|      5 |   69 | `{` |
|      - |   70 | `#if defined(_MSC_VER)` |
|      - |   71 | `#pragma warning(push)` |
|      - |   72 | `#pragma warning(disable:4996)` |
|      - |   73 | `#endif` |
|  19949 |   74 | `	return strerror(iErr);` |
...
|      - |   84 | ` */` |
|  19924 |   85 | `static void VfsThrowSysWarning(ph7_context *pCtx,const char *zPath)` |
|      5 |   86 | `{` |
|  29891 |   87 | `	PH7_VmThrowWarningFmt(pCtx->pVm,"%s(%s): %s",` |
|  19924 |   88 | `		ph7_function_name(pCtx),zPath ? zPath : "",VfsStrerror(errno));` |
|  19929 |   89 | `}` |
...
|      - |  103 | ` */` |
|  13432 |  104 | `static int PH7_vfs_chdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  105 | `{` |
|      - |  106 | `	const char *zPath;` |
|      - |  107 | `	ph7_vfs *pVfs;` |
|      - |  108 | `	int rc;` |
|  13437 |  109 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  110 | `		/* Missing/Invalid argument,return FALSE */` |
|      6 |  111 | `		ph7_result_bool(pCtx,0);` |
|      6 |  112 | `		return PH7_OK;` |
|      - |  113 | `	}` |
|      - |  114 | `	/* Point to the underlying vfs */` |
|  13433 |  115 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  13433 |  116 | `	if( pVfs == 0 \|\| pVfs->xChdir == 0 ){` |
...
|  13433 |  126 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  127 | `	/* Perform the requested operation */` |
|  13433 |  128 | `	errno = 0;` |
|  13433 |  129 | `	rc = pVfs->xChdir(zPath);` |
|  13433 |  130 | `	if( rc != PH7_OK ){` |
...
|      1 |  134 | `	}` |
|      - |  135 | `	/* IO return value */` |
|  13433 |  136 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  13433 |  137 | `	return PH7_OK;` |
|   6721 |  138 | `}` |
|      - |  139 | `/*` |
...
|      - |  261 | ` */` |
|   8808 |  262 | `static int PH7_vfs_is_dir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  263 | `{` |
|      - |  264 | `	const char *zPath;` |
|      - |  265 | `	ph7_vfs *pVfs;` |
|      - |  266 | `	int rc;` |
|   8813 |  267 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  268 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  269 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  270 | `		return PH7_OK;` |
|      - |  271 | `	}` |
|      - |  272 | `	/* Point to the underlying vfs */` |
|   8813 |  273 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   8813 |  274 | `	if( pVfs == 0 \|\| pVfs->xIsdir == 0 ){` |
...
|   8813 |  284 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  285 | `	/* Perform the requested operation */` |
|   8813 |  286 | `	rc = pVfs->xIsdir(zPath);` |
|      - |  287 | `	/* IO return value */` |
|   8813 |  288 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   8813 |  289 | `	return PH7_OK;` |
|   4409 |  290 | `}` |
|      - |  291 | `/*` |
...
|      - |  536 | ` */` |
|  33626 |  537 | `static int PH7_vfs_unlink(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  538 | `{` |
|      - |  539 | `	const char *zPath;` |
|      - |  540 | `	ph7_vfs *pVfs;` |
|      - |  541 | `	int rc;` |
|  33631 |  542 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  543 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  544 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  545 | `		return PH7_OK;` |
|      - |  546 | `	}` |
|      - |  547 | `	/* Point to the underlying vfs */` |
|  33631 |  548 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  33631 |  549 | `	if( pVfs == 0 \|\| pVfs->xUnlink == 0 ){` |
...
|  33631 |  559 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  560 | `	/* Perform the requested operation */` |
|  33631 |  561 | `	errno = 0;` |
|  33631 |  562 | `	rc = pVfs->xUnlink(zPath);` |
|  33631 |  563 | `	if( rc != PH7_OK ){` |
|  19927 |  564 | `		VfsThrowSysWarning(pCtx,zPath);` |
|   9961 |  565 | `	}` |
|      - |  566 | `	/* IO return value */` |
|  33631 |  567 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  33631 |  568 | `	return PH7_OK;` |
|  16818 |  569 | `}` |
|      - |  570 | `/*` |
...
|      - | 1005 | ` */` |
|   6748 | 1006 | `static int PH7_vfs_is_file(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1007 | `{` |
|      - | 1008 | `	const char *zPath;` |
|      - | 1009 | `	ph7_vfs *pVfs;` |
|      - | 1010 | `	int rc;` |
|   6753 | 1011 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   6753 | 1017 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   6753 | 1018 | `	if( pVfs == 0 \|\| pVfs->xIsfile == 0 ){` |
...
|   6753 | 1028 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - | 1029 | `	/* Perform the requested operation */` |
|   6753 | 1030 | `	rc = pVfs->xIsfile(zPath);` |
|      - | 1031 | `	/* IO return value */` |
|   6753 | 1032 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   6753 | 1033 | `	return PH7_OK;` |
|   3379 | 1034 | `}` |
|      - | 1035 | `/*` |
...
|      - | 1658 | ` */` |
|  13374 | 1659 | `static sxi32 ExtractPathInfo(const char *zPath,int nByte,path_info *pOut)` |
|      5 | 1660 | `{` |
|  13379 | 1661 | `	const char *zPtr,*zEnd = &zPath[nByte - 1];` |
|      - | 1662 | `	SyString *pCur;` |
|      - | 1663 | `	int c,d;` |
|  13379 | 1664 | `	c = d = '/';` |
...
|  13379 | 1669 | `	SyZero(pOut,sizeof(path_info));` |
|      - | 1670 | `	/* Handle special case */` |
|  13379 | 1671 | `	if( nByte == sizeof(char) && ( (int)zPath[0] == c \|\| (int)zPath[0] == d ) ){` |
...
| 360906 | 1680 | `	while( zEnd > zPath && ( (int)zEnd[0] != c && (int)zEnd[0] != d ) ){` |
| 340845 | 1681 | `		zEnd--;` |
|      5 | 1682 | `	}` |
|  13379 | 1683 | `	zPtr = (zEnd > zPath) ? &zEnd[1] : zPath;` |
|  13379 | 1684 | `	zEnd = &zPath[nByte];` |
|      - | 1685 | `	/* dirname */` |
|  13379 | 1686 | `	pCur = &pOut->sDir;` |
|  13379 | 1687 | `	SyStringInitFromBuf(pCur,zPath,zPtr-zPath);` |
|  13379 | 1688 | `	if( pCur->nByte > 1 ){` |
|  26753 | 1689 | `		SyStringTrimTrailingChar(pCur,'/');` |
|      - | 1690 | `#ifdef __WINNT__` |
|      5 | 1691 | `		SyStringTrimTrailingChar(pCur,'\\');` |
|      - | 1692 | `#endif` |
|   6692 | 1693 | `	}else if( (int)zPath[0] == c \|\| (int)zPath[0] == d ){` |
...
|  13379 | 1701 | `	pCur = &pOut->sBasename;` |
|  13379 | 1702 | `	SyStringInitFromBuf(pCur,zPtr,zEnd-zPtr);` |
|  13379 | 1703 | `	SyStringTrimLeadingChar(pCur,'/');` |
|      - | 1704 | `#ifdef __WINNT__` |
|      5 | 1705 | `	SyStringTrimLeadingChar(pCur,'\\');` |
|      - | 1706 | `#endif` |
|  13379 | 1707 | `	SyStringDupPtr(&pOut->sFilename,pCur);` |
|  13379 | 1708 | `	if( pCur->nByte > 0 ){` |
|      - | 1709 | `		/* extension */` |
|  13379 | 1710 | `		zEnd--;` |
|  66869 | 1711 | `		while( zEnd > pCur->zString /*basename*/ && zEnd[0] != '.' ){` |
|  53495 | 1712 | `			zEnd--;` |
|      5 | 1713 | `		}` |
|  13379 | 1714 | `		if( zEnd > pCur->zString ){` |
|  13377 | 1715 | `			zEnd++; /* Jump leading dot */` |
|  13377 | 1716 | `			SyStringInitFromBuf(&pOut->sExtension,zEnd,&zPath[nByte]-zEnd);` |
|      - | 1717 | `			/* Fix filename */` |
|  13377 | 1718 | `			pCur = &pOut->sFilename;` |
|  13377 | 1719 | `			if( pCur->nByte > SyStringLength(&pOut->sExtension) ){` |
|  13377 | 1720 | `				pCur->nByte -= 1 + SyStringLength(&pOut->sExtension);` |
|   6686 | 1721 | `			}` |
|   6686 | 1722 | `		}` |
|   6687 | 1723 | `	}` |
|  13379 | 1724 | `	return SXRET_OK;` |
|   6692 | 1725 | `}` |
|      - | 1726 | `/*` |
...
|      - | 1729 | ` */` |
|  13374 | 1730 | `static int PH7_builtin_pathinfo(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1731 | `{` |
|      - | 1732 | `	const char *zPath;` |
|      - | 1733 | `	path_info sInfo;` |
|      - | 1734 | `	SyString *pComp;` |
|      - | 1735 | `	int iLen;` |
|  13379 | 1736 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  13379 | 1742 | `	zPath = ph7_value_to_string(apArg[0],&iLen);` |
|  13379 | 1743 | `	if( iLen < 1 ){` |
|      - | 1744 | `		/* Empty string */` |
|    ! 0 | 1745 | `		ph7_result_string(pCtx,"",0);` |
|    ! 0 | 1746 | `		return PH7_OK;` |
|      - | 1747 | `	}` |
|      - | 1748 | `	/* Extract path info */` |
|  13379 | 1749 | `	ExtractPathInfo(zPath,iLen,&sInfo);` |
|  20065 | 1750 | `	if( nArg > 1 && ph7_value_is_int(apArg[1]) ){` |
|      - | 1751 | `		/* Return path component */` |
|  13377 | 1752 | `		int nComp = ph7_value_to_int(apArg[1]);` |
|  13377 | 1753 | `		switch(nComp){` |
...
|      - | 1770 | `			}` |
|      3 | 1771 | `			break;` |
|   3344 | 1772 | `		case 3: /*PATHINFO_EXTENSION*/` |
|   6693 | 1773 | `			pComp = &sInfo.sExtension;` |
|   6693 | 1774 | `			if( pComp->nByte > 0 ){` |
|   6691 | 1775 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   3348 | 1776 | `			}else{` |
|      - | 1777 | `				/* Expand the empty string */` |
|      3 | 1778 | `				ph7_result_string(pCtx,"",0);` |
|      - | 1779 | `			}` |
|   6693 | 1780 | `			break;` |
|   3340 | 1781 | `		case 4: /*PATHINFO_FILENAME*/` |
|   6685 | 1782 | `			pComp = &sInfo.sFilename;` |
|   6685 | 1783 | `			if( pComp->nByte > 0 ){` |
|   6685 | 1784 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   3345 | 1785 | `			}else{` |
...
|    240 | 2248 | `	ph7_result_string(pCtx,"",0);` |
|      - | 2249 | `	/* Point to the underlying vfs */` |
|    240 | 2250 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|    240 | 2251 | `	if( pVfs == 0 \|\| pVfs->xTempDir == 0 ){` |
...
|    240 | 2262 | `	pVfs->xTempDir(pCtx);` |
|    240 | 2263 | `	return PH7_OK;` |
|    122 | 2264 | `}` |
|      - | 2265 | `/*` |
...
|      - | 2847 | ` */` |
|  10570 | 2848 | `static int PH7_builtin_feof(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2849 | `{` |
|      - | 2850 | `	const ph7_io_stream *pStream;` |
|      - | 2851 | `	io_private *pDev;` |
|      - | 2852 | `	int rc;` |
|  10575 | 2853 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|  10575 | 2860 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 2861 | `	/* Make sure we are dealing with a valid io_private instance */` |
|  10575 | 2862 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|  10575 | 2869 | `	pStream = pDev->pStream;` |
|  10575 | 2870 | `	if( pStream == 0 ){` |
...
|      - | 2877 | `	}` |
|  10575 | 2878 | `	rc = SXERR_EOF;` |
|      - | 2879 | `	/* Perform the requested operation */` |
|  10575 | 2880 | `	if( SyBlobLength(&pDev->sBuffer) > pDev->nOfft ){` |
...
|   5737 | 2887 | `		n = pStream->xRead(pDev->pHandle,zBuf,sizeof(zBuf));` |
|   5737 | 2888 | `		if( n > 0 ){` |
|      - | 2889 | `			/* Copy buffered data */` |
|   1871 | 2890 | `			SyBlobAppend(&pDev->sBuffer,zBuf,(sxu32)n);` |
|   1871 | 2891 | `			rc = PH7_OK;` |
|    933 | 2892 | `		}` |
|      - | 2893 | `	}` |
|      - | 2894 | `	/* EOF or not */` |
|  10575 | 2895 | `	ph7_result_bool(pCtx,rc == SXERR_EOF);` |
|  10575 | 2896 | `	return PH7_OK;` |
|   5290 | 2897 | `}` |
|      - | 2898 | `/*` |
...
|      - | 2942 | ` */` |
|   6770 | 2943 | `static sxi32 GetLine(io_private *pDev,ph7_int64 *pLen,const char **pzLine)` |
|      5 | 2944 | `{` |
|      - | 2945 | `	const char *zIn,*zEnd,*zPtr;` |
|   6775 | 2946 | `	zIn = (const char *)SyBlobDataAt(&pDev->sBuffer,pDev->nOfft);` |
|   6775 | 2947 | `	zEnd = &zIn[SyBlobLength(&pDev->sBuffer)-pDev->nOfft];` |
|   6775 | 2948 | `	zPtr = zIn;` |
| 392541 | 2949 | `	while( zIn < zEnd ){` |
| 392437 | 2950 | `		if( zIn[0] == '\n' ){` |
|      - | 2951 | `			/* Line found */` |
|   6671 | 2952 | `			zIn++; /* Include the line ending as requested by the PHP specification */` |
|   6671 | 2953 | `			*pLen = (ph7_int64)(zIn-zPtr);` |
|   6671 | 2954 | `			*pzLine = zPtr;` |
|   6671 | 2955 | `			return SXRET_OK;` |
|      - | 2956 | `		}` |
| 385771 | 2957 | `		zIn++;` |
|      5 | 2958 | `	}` |
...
|      - | 2964 | ` */` |
|   6774 | 2965 | `static ph7_int64 StreamReadLine(io_private *pDev,const char **pzData,ph7_int64 nMaxLen)` |
|      5 | 2966 | `{` |
|   6779 | 2967 | `	const ph7_io_stream *pStream = pDev->pStream;` |
|      - | 2968 | `	char zBuf[8192];` |
|      - | 2969 | `	ph7_int64 n;` |
|      - | 2970 | `	sxi32 rc;` |
|   6779 | 2971 | `	n = 0;` |
|   6779 | 2972 | `	if( pDev->nOfft >= SyBlobLength(&pDev->sBuffer) ){` |
...
|     34 | 2976 | `	}` |
|   6745 | 2977 | `	if( SyBlobLength(&pDev->sBuffer) > pDev->nOfft ){` |
|      - | 2978 | `		/* Check if there is a line */` |
|   6711 | 2979 | `		rc = GetLine(pDev,&n,pzData);` |
|   6711 | 2980 | `		if( rc == SXRET_OK ){` |
|      - | 2981 | `			/* Got line,update the cursor  */` |
|   6611 | 2982 | `			pDev->nOfft += (sxu32)n;` |
|   6611 | 2983 | `			return n;` |
|      - | 2984 | `		}` |
|     50 | 2985 | `	}` |
...
|      - | 3044 | ` */` |
|  30340 | 3045 | `PH7_PRIVATE void * PH7_StreamOpenHandle(ph7_vm *pVm,const ph7_io_stream *pStream,const char *zFile,` |
|      - | 3046 | `	int iFlags,int use_include,ph7_value *pResource,int bPushInclude,int *pNew)` |
|      5 | 3047 | `{` |
|  30345 | 3048 | `	void *pHandle = 0; /* cc warning */` |
|      - | 3049 | `	SyString sFile;` |
|      - | 3050 | `	ph7_value sDummy;` |
|      - | 3051 | `	int rc;` |
|  30345 | 3052 | `	if( pStream == 0 ){` |
|      - | 3053 | `		/* No such stream device */` |
|    ! 0 | 3054 | `		return 0;` |
|      - | 3055 | `	}` |
|  30345 | 3056 | `	if( pResource == 0 ){` |
...
|  30323 | 3062 | `		PH7_MemObjInit(pVm,&sDummy);` |
|  30323 | 3063 | `		pResource = &sDummy;` |
|  15159 | 3064 | `	}` |
|  30345 | 3065 | `	SyStringInitFromBuf(&sFile,zFile,SyStrlen(zFile));` |
|  30345 | 3066 | `	if( use_include ){` |
|   9678 | 3067 | `		if(	sFile.zString[0] == '/' \|\|` |
|      - | 3068 | `#ifdef __WINNT__` |
|      - | 3069 | `			(sFile.nByte > 2 && sFile.zString[1] == ':' && (sFile.zString[2] == '\\' \|\| sFile.zString[2] == '/') ) \|\|` |
|      - | 3070 | `#endif` |
|   9656 | 3071 | `			(sFile.nByte > 1 && sFile.zString[0] == '.' && sFile.zString[1] == '/') \|\|` |
|   9652 | 3072 | `			(sFile.nByte > 2 && sFile.zString[0] == '.' && sFile.zString[1] == '.' && sFile.zString[2] == '/') ){` |
...
|   9656 | 3084 | `			SyBlobInit(&sWorker,&pVm->sAllocator);` |
|      - | 3085 | `			/* Build a path from the set of include path */` |
|   9656 | 3086 | `			SySetResetCursor(&pVm->aPaths);` |
|   9656 | 3087 | `			rc = SXERR_IO;` |
|   9662 | 3088 | `			while( SXRET_OK == SySetGetNextEntry(&pVm->aPaths,(void **)&pPath) ){` |
|      - | 3089 | `				/* Build full path */` |
|   9656 | 3090 | `				SyBlobFormat(&sWorker,"%z%c%z",pPath,c,&sFile);` |
|      - | 3091 | `				/* Append null terminator */` |
|   9656 | 3092 | `				if( SXRET_OK != SyBlobNullAppend(&sWorker) ){` |
|    ! 0 | 3093 | `					continue;` |
|      - | 3094 | `				}` |
|      - | 3095 | `				/* Try to open the file */` |
|   9656 | 3096 | `				rc = pStream->xOpen((const char *)SyBlobData(&sWorker),iFlags,pResource,&pHandle);` |
|   9656 | 3097 | `				if( rc == PH7_OK ){` |
|   9650 | 3098 | `					if( bPushInclude ){` |
|      - | 3099 | `						/* Mark as included */` |
|   9650 | 3100 | `						PH7_VmPushFilePath(pVm,(const char *)SyBlobData(&sWorker),SyBlobLength(&sWorker),FALSE,pNew);` |
|   4823 | 3101 | `					}` |
|   9650 | 3102 | `					break;` |
|      - | 3103 | `				}` |
...
|      2 | 3107 | `			}` |
|   9656 | 3108 | `			SyBlobRelease(&sWorker);` |
|      - | 3109 | `		}` |
|   9682 | 3110 | `		if( rc == PH7_OK ){` |
|   9676 | 3111 | `			if( bPushInclude ){` |
|      - | 3112 | `				/* Mark as included */` |
|   9676 | 3113 | `				PH7_VmPushFilePath(pVm,sFile.zString,sFile.nByte,FALSE,pNew);` |
|   4836 | 3114 | `			}` |
|   4836 | 3115 | `		}` |
|   4843 | 3116 | `	}else{` |
|      - | 3117 | `		/* Open the URI direcly */` |
|  20667 | 3118 | `		rc = pStream->xOpen(zFile,iFlags,pResource,&pHandle);` |
|      - | 3119 | `	}` |
|  30345 | 3120 | `	if( rc != PH7_OK ){` |
|      - | 3121 | `		/* IO error */` |
|     22 | 3122 | `		return 0;` |
|      - | 3123 | `	}` |
|      - | 3124 | `	/* Return the file handle */` |
|  30327 | 3125 | `	return pHandle;` |
|  15175 | 3126 | `}` |
|      - | 3127 | `/*` |
...
|      - | 3131 | ` */` |
|   9666 | 3132 | `PH7_PRIVATE sxi32 PH7_StreamReadWholeFile(void *pHandle,const ph7_io_stream *pStream,SyBlob *pOut)` |
|      4 | 3133 | `{` |
...
|   9666 | 3138 | `	for(;;){` |
|  19336 | 3139 | `		nRead = pStream->xRead(pHandle,zBuf,sizeof(zBuf));` |
|  19336 | 3140 | `		if( nRead < 1 ){` |
|      - | 3141 | `			/* EOF or IO error */` |
|   9670 | 3142 | `			break;` |
|      - | 3143 | `		}` |
|      - | 3144 | `		/* Append contents */` |
|   9670 | 3145 | `		rc = SyBlobAppend(pOut,zBuf,(sxu32)nRead);` |
|   9670 | 3146 | `		if( rc != SXRET_OK ){` |
|    ! 0 | 3147 | `			break;` |
|      - | 3148 | `		}` |
|      4 | 3149 | `	}` |
|   9670 | 3150 | `	return SyBlobLength(pOut) > 0 ? SXRET_OK : -1;` |
|      4 | 3151 | `}` |
|      - | 3152 | `/*` |
|      - | 3153 | ` * Close an open IO stream handle [i.e local file/URI..].` |
|      - | 3154 | ` */` |
|  30448 | 3155 | `PH7_PRIVATE void PH7_StreamCloseHandle(const ph7_io_stream *pStream,void *pHandle)` |
|      5 | 3156 | `{` |
|  30453 | 3157 | `	if( pStream->xClose ){` |
|  30453 | 3158 | `		pStream->xClose(pHandle);` |
|  15224 | 3159 | `	}` |
|  30453 | 3160 | `}` |
|      - | 3161 | `/*` |
...
|      - | 3230 | ` */` |
|   6764 | 3231 | `static int PH7_builtin_fgets(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3232 | `{` |
|      - | 3233 | `	const ph7_io_stream *pStream;` |
|      - | 3234 | `	const char *zLine;` |
|      - | 3235 | `	io_private *pDev;` |
|      - | 3236 | `	ph7_int64 n,nLen;` |
|   6769 | 3237 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   6769 | 3244 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3245 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   6769 | 3246 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   6769 | 3253 | `	pStream = pDev->pStream;` |
|   6769 | 3254 | `	if( pStream == 0  ){` |
...
|   6769 | 3268 | `	n = StreamReadLine(pDev,&zLine,nLen);` |
|   6769 | 3269 | `	if( n < 1 ){` |
|      - | 3270 | `		/* EOF or IO error,return FALSE */` |
|      7 | 3271 | `		ph7_result_bool(pCtx,0);` |
|      6 | 3272 | `	}else{` |
|      - | 3273 | `		/* Return the freshly extracted line */` |
|   6767 | 3274 | `		ph7_result_string(pCtx,zLine,(int)n);` |
|      - | 3275 | `	}` |
|   6769 | 3276 | `	return PH7_OK;` |
|   3387 | 3277 | `}` |
|      - | 3278 | `/*` |
...
|      - | 3539 | ` */` |
|  10966 | 3540 | `static int PH7_builtin_readdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3541 | `{` |
|      - | 3542 | `	const ph7_io_stream *pStream;` |
|      - | 3543 | `	io_private *pDev;` |
|      - | 3544 | `	int rc;` |
|  10971 | 3545 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|  10971 | 3552 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3553 | `	/* Make sure we are dealing with a valid io_private instance */` |
|  10971 | 3554 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|  10971 | 3561 | `	pStream = pDev->pStream;` |
|  10971 | 3562 | `	if( pStream == 0  \|\| pStream->xReadDir == 0 ){` |
...
|      - | 3569 | `	}` |
|  10971 | 3570 | `	ph7_result_bool(pCtx,0);` |
|      - | 3571 | `	/* Perform the requested operation */` |
|  10971 | 3572 | `	rc = pStream->xReadDir(pDev->pHandle,pCtx);` |
|  10971 | 3573 | `	if( rc != PH7_OK ){` |
|      - | 3574 | `		/* Return FALSE */` |
|   1065 | 3575 | `		ph7_result_bool(pCtx,0);` |
|    530 | 3576 | `	}` |
|  10971 | 3577 | `	return PH7_OK;` |
|   5488 | 3578 | `}` |
|      - | 3579 | `/*` |
...
|      - | 3829 | ` */` |
|   6734 | 3830 | `static int PH7_builtin_file_get_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3831 | `{` |
|      - | 3832 | `	const ph7_io_stream *pStream;` |
|      - | 3833 | `	ph7_int64 n,nRead,nMaxlen;` |
|   6739 | 3834 | `	int use_include  = FALSE;` |
|      - | 3835 | `	const char *zFile;` |
|      - | 3836 | `	char zBuf[8192];` |
|      - | 3837 | `	void *pHandle;` |
|      - | 3838 | `	int nLen;` |
|      - | 3839 |  |
|   6739 | 3840 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   6739 | 3847 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3848 | `	/* Point to the target IO stream device */` |
|   6739 | 3849 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|   6739 | 3850 | `	if( pStream == 0 ){` |
...
|   6739 | 3860 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,PH7_IO_OPEN_RDONLY,use_include,nArg > 2 ? apArg[2] : 0,FALSE,0);` |
|   6739 | 3861 | `	if( pHandle == 0 ){` |
...
|   6739 | 3881 | `	nRead = 0;` |
|   6732 | 3882 | `	for(;;){` |
|  20204 | 3883 | `		n = pStream->xRead(pHandle,zBuf,` |
|   6735 | 3884 | `			(nMaxlen > 0 && (nMaxlen < (ph7_int64)sizeof(zBuf))) ? nMaxlen : (ph7_int64)sizeof(zBuf));` |
|  13469 | 3885 | `		if( n < 1 ){` |
|      - | 3886 | `			/* EOF or IO error,break immediately */` |
|   6737 | 3887 | `			break;` |
|      - | 3888 | `		}` |
|      - | 3889 | `		/* Append data */` |
|   6737 | 3890 | `		ph7_result_string(pCtx,zBuf,(int)n);` |
|      - | 3891 | `		/* Increment read counter */` |
|   6737 | 3892 | `		nRead += n;` |
|   6737 | 3893 | `		if( nMaxlen > 0 && nRead >= nMaxlen ){` |
|      - | 3894 | `			/* Read limit reached */` |
|      3 | 3895 | `			break;` |
|      - | 3896 | `		}` |
|      5 | 3897 | `	}` |
|      - | 3898 | `	/* Close the stream */` |
|   6739 | 3899 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|      - | 3900 | `	/* Check if we have read something */` |
|   6739 | 3901 | `	if( ph7_context_result_buf_length(pCtx) < 1 ){` |
|      - | 3902 | `		/* Nothing read,return FALSE */` |
|      3 | 3903 | `		ph7_result_bool(pCtx,0);` |
|      1 | 3904 | `	}` |
|   6739 | 3905 | `	return PH7_OK;` |
|   3372 | 3906 | `}` |
|      - | 3907 | `/*` |
...
|      - | 3925 | ` */` |
|  13684 | 3926 | `static int PH7_builtin_file_put_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3927 | `{` |
|  13689 | 3928 | `	int use_include  = FALSE;` |
...
|      - | 3935 | `	int nLen;` |
|      - | 3936 |  |
|  13689 | 3937 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  13689 | 3944 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3945 | `	/* Point to the target IO stream device */` |
|  13689 | 3946 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|  13689 | 3947 | `	if( pStream == 0 ){` |
...
|      - | 3951 | `	}` |
|      - | 3952 | `	/* Data to write */` |
|  13689 | 3953 | `	zData = ph7_value_to_string(apArg[1],&nLen);` |
|      - | 3954 | `	/* Try to open the file in read-write mode */` |
|  13689 | 3955 | `	iOpenFlags = PH7_IO_OPEN_CREATE\|PH7_IO_OPEN_RDWR\|PH7_IO_OPEN_TRUNC;` |
|      - | 3956 | `	/* Extract the flags */` |
|  13689 | 3957 | `	iFlags = 0;` |
|  13689 | 3958 | `	if( nArg > 2 ){` |
...
|    ! 0 | 3970 | `		}` |
|    ! 0 | 3971 | `	}` |
|  20531 | 3972 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,iOpenFlags,use_include,` |
|   6842 | 3973 | `		nArg > 3 ? apArg[3] : 0,FALSE,FALSE);` |
|  13689 | 3974 | `	if( pHandle == 0 ){` |
|    ! 0 | 3975 | `		VfsThrowOpenWarning(pCtx,zFile);` |
|    ! 0 | 3976 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 3977 | `		return PH7_OK;` |
|      - | 3978 | `	}` |
|  13689 | 3979 | `	if( nLen < 1 ){` |
...
|  13683 | 4009 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|  13683 | 4010 | `	return PH7_OK;` |
|   6847 | 4011 | `}` |
|      - | 4012 | `/*` |
...
|      - | 4963 | ` */` |
|   5290 | 4964 | `static void InitIOPrivate(ph7_vm *pVm,const ph7_io_stream *pStream,io_private *pOut)` |
|      5 | 4965 | `{` |
|   5295 | 4966 | `	pOut->pStream = pStream;` |
|   5295 | 4967 | `	SyBlobInit(&pOut->sBuffer,&pVm->sAllocator);` |
|   5295 | 4968 | `	pOut->nOfft = 0;` |
|      - | 4969 | `	/* Set the magic number */` |
|   5295 | 4970 | `	pOut->iMagic = IO_PRIVATE_MAGIC;` |
|   5295 | 4971 | `}` |
|      - | 4972 | `/*` |
...
|      - | 4990 | ` */` |
|   5232 | 4991 | `static void MarkIOPrivateClosed(io_private *pDev)` |
|      5 | 4992 | `{` |
|   5237 | 4993 | `	SyBlobRelease(&pDev->sBuffer);` |
|   5237 | 4994 | `	pDev->pHandle = 0;` |
|   5237 | 4995 | `	pDev->iMagic = IO_PRIVATE_CLOSED_MAGIC;` |
|   5237 | 4996 | `}` |
|      - | 4997 | `/*` |
...
|     49 | 5065 | `	while( nMax != 0 ){` |
|     47 | 5066 | `		ph7_int64 nAsk = (ph7_int64)sizeof(zBuf);` |
|     47 | 5067 | `		if( nMax > 0 && nMax < nAsk ){` |
|      3 | 5068 | `			nAsk = nMax;` |
|      1 | 5069 | `		}` |
|     47 | 5070 | `		nRead = pStream->xRead(pDev->pHandle,zBuf,nAsk);` |
|     47 | 5071 | `		if( nRead < 1 ){` |
|     27 | 5072 | `			break;` |
|      - | 5073 | `		}` |
|     21 | 5074 | `		ph7_result_string(pCtx,zBuf,(int)nRead); /* appends */` |
|     21 | 5075 | `		if( nMax > 0 ){` |
|      3 | 5076 | `			nMax -= nRead;` |
|      1 | 5077 | `		}` |
|      1 | 5078 | `	}` |
...
|      - | 5182 | `	int bEof;` |
|      - | 5183 | `};` |
|     10 | 5184 | `static ph7_int64 SockStreamData_Read(void *pHandle,void *pBuffer,ph7_int64 nRead)` |
|    ! 0 | 5185 | `{` |
|     10 | 5186 | `	sock_private *pSock = (sock_private *)pHandle;` |
|      - | 5187 | `	int n;` |
|     10 | 5188 | `	if( pSock == 0 \|\| pSock->bEof ){` |
|      2 | 5189 | `		return 0;` |
|      - | 5190 | `	}` |
|      8 | 5191 | `	n = PH7_NetRecv(pSock->sock,pBuffer,(int)nRead,0);` |
|      8 | 5192 | `	if( n <= 0 ){` |
|      4 | 5193 | `		pSock->bEof = 1;` |
|      4 | 5194 | `		return 0;` |
|      - | 5195 | `	}` |
|      4 | 5196 | `	return (ph7_int64)n;` |
|      5 | 5197 | `}` |
...
|      - | 6183 | ` */` |
|   3892 | 6184 | `PH7_PRIVATE const ph7_vfs * PH7_ExportBuiltinVfs(void)` |
|      5 | 6185 | `{` |
...
|      - | 6810 | ` */` |
|   3954 | 6811 | `static pipe_private * PipeOpen(ph7_vm *pVm, const char *zCommand, const char *zMode)` |
|      5 | 6812 | `{` |
|      - | 6813 | `	pipe_private *pPipe;` |
|      - | 6814 | `	FILE *pFile;` |
|   3959 | 6815 | `	if( pVm == 0 \|\| zCommand == 0 \|\| zMode == 0 ){` |
|    ! 0 | 6816 | `		return 0;` |
|      - | 6817 | `	}` |
|      - | 6818 | `	/* Validate mode - only 'r' or 'w' allowed */` |
|   3959 | 6819 | `	if( zMode[0] != 'r' && zMode[0] != 'w' ){` |
|    ! 0 | 6820 | `		return 0;` |
|      - | 6821 | `	}` |
...
|   3954 | 6883 | `	pFile = popen(zCommand, zMode);` |
|   3954 | 6884 | `	if( pFile == 0 ){` |
|    ! 0 | 6885 | `		return 0;` |
|      - | 6886 | `	}` |
|      - | 6887 | `	/* Allocate pipe private structure */` |
|   3954 | 6888 | `	pPipe = (pipe_private *)SyMemBackendAlloc(&pVm->sAllocator, sizeof(pipe_private));` |
|   3954 | 6889 | `	if( pPipe == 0 ){` |
|      - | 6890 | `		/* Out of memory, close the pipe */` |
|    ! 0 | 6891 | `		pclose(pFile);` |
|    ! 0 | 6892 | `		return 0;` |
|      - | 6893 | `	}` |
|      - | 6894 | `	/* Initialize the structure */` |
|   3954 | 6895 | `	pPipe->pFile = pFile;` |
|   3954 | 6896 | `	pPipe->pVm = pVm;` |
|   3954 | 6897 | `	pPipe->iMode = zMode[0];` |
|      - | 6898 | `#else /* OS_OTHER: no process pipes on this platform */` |
|      - | 6899 | `	(void)pFile;` |
|      - | 6900 | `	return 0;` |
|      - | 6901 | `#endif` |
|   3959 | 6902 | `	return pPipe;` |
|   1982 | 6903 | `}` |
|      - | 6904 | `/*` |
|      - | 6905 | ` * Close a pipe and return the exit status of the process.` |
|      - | 6906 | ` * Returns the exit status, or -1 on error.` |
|      - | 6907 | ` */` |
|   3928 | 6908 | `static int PipeClose(pipe_private *pPipe)` |
|      5 | 6909 | `{` |
|      - | 6910 | `	int status;` |
|      - | 6911 | `	ph7_vm *pVm;` |
|   3933 | 6912 | `	if( pPipe == 0 \|\| pPipe->pFile == 0 ){` |
|    ! 0 | 6913 | `		return -1;` |
|      - | 6914 | `	}` |
|   3933 | 6915 | `	pVm = pPipe->pVm;` |
...
|   3928 | 6921 | `	status = pclose(pPipe->pFile);` |
|      - | 6922 | `	/* On Unix, pclose returns the status from waitpid, need to extract exit code */` |
|   3928 | 6923 | `	if( status != -1 ){` |
|   3928 | 6924 | `		if( WIFEXITED(status) ){` |
|   3928 | 6925 | `			status = WEXITSTATUS(status);` |
|   1964 | 6926 | `		}else if( WIFSIGNALED(status) ){` |
...
|   3933 | 6938 | `	SyMemBackendFree(&pVm->sAllocator, pPipe);` |
|   3933 | 6939 | `	return status;` |
|   1969 | 6940 | `}` |
|      - | 6941 | `/*` |
...
|      - | 6955 | ` */` |
|   5874 | 6956 | `static ph7_int64 PipeStream_Read(void *pHandle, void *pBuffer, ph7_int64 nDatatoRead)` |
|      4 | 6957 | `{` |
|   5878 | 6958 | `	pipe_private *pPipe = (pipe_private *)pHandle;` |
|      - | 6959 | `	size_t nRead;` |
|   5878 | 6960 | `	if( pPipe == 0 \|\| pPipe->pFile == 0 ){` |
|    ! 0 | 6961 | `		return -1;` |
|      - | 6962 | `	}` |
|   5878 | 6963 | `	if( pPipe->iMode != 'r' ){` |
|      - | 6964 | `		/* Cannot read from a write-only pipe */` |
|    ! 0 | 6965 | `		return -1;` |
|      - | 6966 | `	}` |
|   5878 | 6967 | `	nRead = fread(pBuffer, 1, (size_t)nDatatoRead, pPipe->pFile);` |
|   5878 | 6968 | `	if( nRead == 0 ){` |
|   3960 | 6969 | `		if( feof(pPipe->pFile) ){` |
|   3960 | 6970 | `			return 0; /* EOF */` |
|      - | 6971 | `		}` |
|    ! 0 | 6972 | `		return -1; /* Error */` |
|      - | 6973 | `	}` |
|   1922 | 6974 | `	return (ph7_int64)nRead;` |
|   2941 | 6975 | `}` |
|      - | 6976 | `/*` |
...
|      - | 7018 | ` */` |
|   3824 | 7019 | `static int is_pipe_stream(const ph7_io_stream *pStream)` |
|      5 | 7020 | `{` |
|   3829 | 7021 | `	return pStream == &sPipe_Stream;` |
|      5 | 7022 | `}` |
|      - | 7023 | `/*` |
...
|      4 | 7081 | `}` |
|   3950 | 7082 | `static int PH7_builtin_popen(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 7083 | `{` |
|      - | 7084 | `	const char *zCommand, *zMode;` |
|      - | 7085 | `	pipe_private *pPipe;` |
|      - | 7086 | `	io_private *pDev;` |
|      - | 7087 | `	int nCmdLen, nModeLen;` |
|   3955 | 7088 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) \|\| !ph7_value_is_string(apArg[1]) ){` |
...
|   3955 | 7095 | `	zCommand = ph7_value_to_string(apArg[0], &nCmdLen);` |
|   3955 | 7096 | `	zMode = ph7_value_to_string(apArg[1], &nModeLen);` |
|   3955 | 7097 | `	if( nCmdLen < 1 ){` |
|    ! 0 | 7098 | `		ph7_context_throw_error(pCtx, PH7_CTX_WARNING, "Empty command");` |
|    ! 0 | 7099 | `		ph7_result_bool(pCtx, 0);` |
|    ! 0 | 7100 | `		return PH7_OK;` |
|      - | 7101 | `	}` |
|   3955 | 7102 | `	if( nModeLen < 1 \|\| (zMode[0] != 'r' && zMode[0] != 'w') ){` |
...
|      - | 7106 | `	}` |
|      - | 7107 | `	/* Open the pipe */` |
|   3955 | 7108 | `	pPipe = PipeOpen(pCtx->pVm, zCommand, zMode);` |
|   3955 | 7109 | `	if( pPipe == 0 ){` |
...
|   3955 | 7115 | `	pDev = (io_private *)ph7_context_alloc_chunk(pCtx, sizeof(io_private), TRUE, FALSE);` |
|   3955 | 7116 | `	if( pDev == 0 ){` |
...
|   3955 | 7123 | `	InitIOPrivate(pCtx->pVm, &sPipe_Stream, pDev);` |
|   3955 | 7124 | `	pDev->pHandle = pPipe;` |
|      - | 7125 | `	/* Return the io_private instance as a resource */` |
|   3955 | 7126 | `	ph7_result_resource(pCtx, pDev);` |
|   3955 | 7127 | `	return PH7_OK;` |
|   1980 | 7128 | `}` |
|      - | 7129 | `/*` |
...
|      - | 7137 | ` */` |
|   3824 | 7138 | `static int PH7_builtin_pclose(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 7139 | `{` |
|      - | 7140 | `	const ph7_io_stream *pStream;` |
|      - | 7141 | `	pipe_private *pPipe;` |
|      - | 7142 | `	io_private *pDev;` |
|      - | 7143 | `	int status;` |
|   3829 | 7144 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   3829 | 7151 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 7152 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   3829 | 7153 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   3829 | 7159 | `	pStream = pDev->pStream;` |
|   3829 | 7160 | `	if( pStream == 0 \|\| !is_pipe_stream(pStream) ){` |
...
|   3829 | 7166 | `	pPipe = (pipe_private *)pDev->pHandle;` |
|      - | 7167 | `	/* Close the pipe and get exit status */` |
|   3829 | 7168 | `	status = PipeClose(pPipe);` |
|      - | 7169 | `	/* Keep the handle alive but flag it closed so shared copies see it */` |
|   3829 | 7170 | `	MarkIOPrivateClosed(pDev);` |
|      - | 7171 | `	/* Return the exit status */` |
|   3829 | 7172 | `	ph7_result_int(pCtx, status);` |
|   3829 | 7173 | `	return PH7_OK;` |
|   1917 | 7174 | `}` |
|      - | 7175 | `/*` |
...
|      - | 7610 | ` */` |
|   3404 | 7611 | `PH7_PRIVATE sxi32 PH7_RegisterIORoutine(ph7_vm *pVm)` |
|      5 | 7612 | `{` |
|      - | 7613 | `	/*` |
...
|      - | 7728 | `	};` |
|   3409 | 7729 | `	const ph7_io_stream *pFileStream = 0;` |
|   3409 | 7730 | `	sxu32 n = 0;` |
|      - | 7731 | `	/* Register disk-related functions */` |
| 166801 | 7732 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVfsDiskFunc) ; ++n ){` |
| 163397 | 7733 | `		ph7_create_function(&(*pVm),aVfsDiskFunc[n].zName,aVfsDiskFunc[n].xFunc,(void *)pVm->pEngine->pVfs);` |
|  81701 | 7734 | `	}` |
| 177013 | 7735 | `	for( n = 0 ; n < SX_ARRAYSIZE(aIOFunc) ; ++n ){` |
| 173609 | 7736 | `		ph7_create_function(&(*pVm),aIOFunc[n].zName,aIOFunc[n].xFunc,pVm);` |
|  86807 | 7737 | `	}` |
|      - | 7738 | `#else` |
|      - | 7739 | `	SXUNUSED(pVm);` |
...
|      - | 7766 | `	};` |
|  57873 | 7767 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVfsHelperFunc) ; ++n ){` |
|  54469 | 7768 | `		ph7_create_function(&(*pVm),aVfsHelperFunc[n].zName,aVfsHelperFunc[n].xFunc,pVm);` |
|  27237 | 7769 | `	}` |
...
|   3404 | 7777 | `	pFileStream = &sUnixFileStream;` |
|      - | 7778 | `#endif` |
|      - | 7779 | `	/* Install the php:// stream */` |
|   3409 | 7780 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,&sPHP_Stream);` |
|   3409 | 7781 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,&sDATA_Stream);` |
|      - | 7782 | `#ifdef PH7_ENABLE_NET` |
|   3409 | 7783 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,&sTCP_Stream);` |
|      - | 7784 | `#endif` |
|   3409 | 7785 | `	if( pFileStream ){` |
|      - | 7786 | `		/* Install the file:// stream */` |
|   3409 | 7787 | `		ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,pFileStream);` |
|   1702 | 7788 | `	}` |
|      - | 7789 | `#endif /* PH7_DISABLE_DISK_IO */` |
|      - | 7790 |  |
|   3409 | 7791 | `	return SXRET_OK;` |
|      5 | 7792 | `}` |
|      - | 7793 | `/*` |
