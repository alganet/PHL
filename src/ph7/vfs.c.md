...
|      - |   89 | ` */` |
|  19992 |   90 | `PH7_PRIVATE const char * VfsStrerror(int iErr)` |
|      5 |   91 | `{` |
|      - |   92 | `#if defined(_MSC_VER)` |
|      - |   93 | `#pragma warning(push)` |
|      - |   94 | `#pragma warning(disable:4996)` |
|      - |   95 | `#endif` |
|  19997 |   96 | `	return strerror(iErr);` |
...
|      - |  106 | ` */` |
|  19968 |  107 | `static void VfsThrowSysWarning(ph7_context *pCtx,const char *zPath)` |
|      5 |  108 | `{` |
|  29957 |  109 | `	PH7_VmThrowWarningFmt(pCtx->pVm,"%s(%s): %s",` |
|  19968 |  110 | `		ph7_function_name(pCtx),zPath ? zPath : "",VfsStrerror(errno));` |
|  19973 |  111 | `}` |
...
|      - |  125 | ` */` |
|  12738 |  126 | `static int PH7_vfs_chdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  127 | `{` |
...
|  12743 |  140 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  12743 |  141 | `	if( pVfs == 0 \|\| pVfs->xChdir == 0 ){` |
...
|  12743 |  151 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  152 | `	/* Perform the requested operation */` |
|  12743 |  153 | `	errno = 0;` |
|  12743 |  154 | `	rc = pVfs->xChdir(zPath);` |
|  12743 |  155 | `	if( rc != PH7_OK ){` |
...
|      2 |  159 | `	}` |
|      - |  160 | `	/* IO return value */` |
|  12743 |  161 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  12743 |  162 | `	return PH7_OK;` |
|   6374 |  163 | `}` |
|      - |  164 | `/*` |
...
|  19967 |  590 | `		VfsThrowSysWarning(pCtx,zPath);` |
|   9981 |  591 | `	}` |
|      - |  592 | `	/* IO return value */` |
