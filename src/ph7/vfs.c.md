...
|      - |   65 | ` */` |
|  19408 |   66 | `static const char * VfsStrerror(int iErr)` |
|      5 |   67 | `{` |
|      - |   68 | `#if defined(_MSC_VER)` |
|      - |   69 | `#pragma warning(push)` |
|      - |   70 | `#pragma warning(disable:4996)` |
|      - |   71 | `#endif` |
|  19413 |   72 | `	return strerror(iErr);` |
...
|      - |   82 | ` */` |
|  19394 |   83 | `static void VfsThrowSysWarning(ph7_context *pCtx,const char *zPath)` |
|      5 |   84 | `{` |
|  29096 |   85 | `	PH7_VmThrowWarningFmt(pCtx->pVm,"%s(%s): %s",` |
|  19394 |   86 | `		ph7_function_name(pCtx),zPath ? zPath : "",VfsStrerror(errno));` |
|  19399 |   87 | `}` |
...
|      - |  101 | ` */` |
|  13146 |  102 | `static int PH7_vfs_chdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  103 | `{` |
|      - |  104 | `	const char *zPath;` |
|      - |  105 | `	ph7_vfs *pVfs;` |
|      - |  106 | `	int rc;` |
|  13151 |  107 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  108 | `		/* Missing/Invalid argument,return FALSE */` |
|      6 |  109 | `		ph7_result_bool(pCtx,0);` |
|      6 |  110 | `		return PH7_OK;` |
|      - |  111 | `	}` |
|      - |  112 | `	/* Point to the underlying vfs */` |
|  13147 |  113 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  13147 |  114 | `	if( pVfs == 0 \|\| pVfs->xChdir == 0 ){` |
...
|  13147 |  124 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  125 | `	/* Perform the requested operation */` |
|  13147 |  126 | `	errno = 0;` |
|  13147 |  127 | `	rc = pVfs->xChdir(zPath);` |
|  13147 |  128 | `	if( rc != PH7_OK ){` |
...
|      1 |  132 | `	}` |
|      - |  133 | `	/* IO return value */` |
|  13147 |  134 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  13147 |  135 | `	return PH7_OK;` |
|   6578 |  136 | `}` |
|      - |  137 | `/*` |
...
|      - |  259 | ` */` |
|   8518 |  260 | `static int PH7_vfs_is_dir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  261 | `{` |
|      - |  262 | `	const char *zPath;` |
|      - |  263 | `	ph7_vfs *pVfs;` |
|      - |  264 | `	int rc;` |
|   8523 |  265 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  266 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  267 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  268 | `		return PH7_OK;` |
|      - |  269 | `	}` |
|      - |  270 | `	/* Point to the underlying vfs */` |
|   8523 |  271 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   8523 |  272 | `	if( pVfs == 0 \|\| pVfs->xIsdir == 0 ){` |
...
|   8523 |  282 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  283 | `	/* Perform the requested operation */` |
|   8523 |  284 | `	rc = pVfs->xIsdir(zPath);` |
|      - |  285 | `	/* IO return value */` |
|   8523 |  286 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   8523 |  287 | `	return PH7_OK;` |
|   4264 |  288 | `}` |
|      - |  289 | `/*` |
...
|      - |  534 | ` */` |
|  32788 |  535 | `static int PH7_vfs_unlink(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  536 | `{` |
|      - |  537 | `	const char *zPath;` |
|      - |  538 | `	ph7_vfs *pVfs;` |
|      - |  539 | `	int rc;` |
|  32793 |  540 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  541 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  542 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  543 | `		return PH7_OK;` |
|      - |  544 | `	}` |
|      - |  545 | `	/* Point to the underlying vfs */` |
|  32793 |  546 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  32793 |  547 | `	if( pVfs == 0 \|\| pVfs->xUnlink == 0 ){` |
...
|  32793 |  557 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  558 | `	/* Perform the requested operation */` |
|  32793 |  559 | `	errno = 0;` |
|  32793 |  560 | `	rc = pVfs->xUnlink(zPath);` |
|  32793 |  561 | `	if( rc != PH7_OK ){` |
|  19397 |  562 | `		VfsThrowSysWarning(pCtx,zPath);` |
|   9696 |  563 | `	}` |
|      - |  564 | `	/* IO return value */` |
|  32793 |  565 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  32793 |  566 | `	return PH7_OK;` |
|  16399 |  567 | `}` |
|      - |  568 | `/*` |
...
|      - | 1003 | ` */` |
|   6528 | 1004 | `static int PH7_vfs_is_file(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1005 | `{` |
|      - | 1006 | `	const char *zPath;` |
|      - | 1007 | `	ph7_vfs *pVfs;` |
|      - | 1008 | `	int rc;` |
|   6533 | 1009 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   6533 | 1015 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   6533 | 1016 | `	if( pVfs == 0 \|\| pVfs->xIsfile == 0 ){` |
...
|   6533 | 1026 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - | 1027 | `	/* Perform the requested operation */` |
|   6533 | 1028 | `	rc = pVfs->xIsfile(zPath);` |
|      - | 1029 | `	/* IO return value */` |
|   6533 | 1030 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   6533 | 1031 | `	return PH7_OK;` |
|   3269 | 1032 | `}` |
|      - | 1033 | `/*` |
...
|      - | 1656 | ` */` |
|  13046 | 1657 | `static sxi32 ExtractPathInfo(const char *zPath,int nByte,path_info *pOut)` |
|      5 | 1658 | `{` |
|  13051 | 1659 | `	const char *zPtr,*zEnd = &zPath[nByte - 1];` |
|      - | 1660 | `	SyString *pCur;` |
|      - | 1661 | `	int c,d;` |
|  13051 | 1662 | `	c = d = '/';` |
...
|  13051 | 1667 | `	SyZero(pOut,sizeof(path_info));` |
|      - | 1668 | `	/* Handle special case */` |
|  13051 | 1669 | `	if( nByte == sizeof(char) && ( (int)zPath[0] == c \|\| (int)zPath[0] == d ) ){` |
...
| 351942 | 1678 | `	while( zEnd > zPath && ( (int)zEnd[0] != c && (int)zEnd[0] != d ) ){` |
| 332373 | 1679 | `		zEnd--;` |
|      5 | 1680 | `	}` |
|  13051 | 1681 | `	zPtr = (zEnd > zPath) ? &zEnd[1] : zPath;` |
|  13051 | 1682 | `	zEnd = &zPath[nByte];` |
|      - | 1683 | `	/* dirname */` |
|  13051 | 1684 | `	pCur = &pOut->sDir;` |
|  13051 | 1685 | `	SyStringInitFromBuf(pCur,zPath,zPtr-zPath);` |
|  13051 | 1686 | `	if( pCur->nByte > 1 ){` |
|  26097 | 1687 | `		SyStringTrimTrailingChar(pCur,'/');` |
|      - | 1688 | `#ifdef __WINNT__` |
|      5 | 1689 | `		SyStringTrimTrailingChar(pCur,'\\');` |
|      - | 1690 | `#endif` |
|   6528 | 1691 | `	}else if( (int)zPath[0] == c \|\| (int)zPath[0] == d ){` |
...
|  13051 | 1699 | `	pCur = &pOut->sBasename;` |
|  13051 | 1700 | `	SyStringInitFromBuf(pCur,zPtr,zEnd-zPtr);` |
|  13051 | 1701 | `	SyStringTrimLeadingChar(pCur,'/');` |
|      - | 1702 | `#ifdef __WINNT__` |
|      5 | 1703 | `	SyStringTrimLeadingChar(pCur,'\\');` |
|      - | 1704 | `#endif` |
|  13051 | 1705 | `	SyStringDupPtr(&pOut->sFilename,pCur);` |
|  13051 | 1706 | `	if( pCur->nByte > 0 ){` |
|      - | 1707 | `		/* extension */` |
|  13051 | 1708 | `		zEnd--;` |
|  65229 | 1709 | `		while( zEnd > pCur->zString /*basename*/ && zEnd[0] != '.' ){` |
|  52183 | 1710 | `			zEnd--;` |
|      5 | 1711 | `		}` |
|  13051 | 1712 | `		if( zEnd > pCur->zString ){` |
|  13049 | 1713 | `			zEnd++; /* Jump leading dot */` |
|  13049 | 1714 | `			SyStringInitFromBuf(&pOut->sExtension,zEnd,&zPath[nByte]-zEnd);` |
|      - | 1715 | `			/* Fix filename */` |
|  13049 | 1716 | `			pCur = &pOut->sFilename;` |
|  13049 | 1717 | `			if( pCur->nByte > SyStringLength(&pOut->sExtension) ){` |
|  13049 | 1718 | `				pCur->nByte -= 1 + SyStringLength(&pOut->sExtension);` |
|   6522 | 1719 | `			}` |
|   6522 | 1720 | `		}` |
|   6523 | 1721 | `	}` |
|  13051 | 1722 | `	return SXRET_OK;` |
|   6528 | 1723 | `}` |
|      - | 1724 | `/*` |
...
|      - | 1727 | ` */` |
|  13046 | 1728 | `static int PH7_builtin_pathinfo(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1729 | `{` |
|      - | 1730 | `	const char *zPath;` |
|      - | 1731 | `	path_info sInfo;` |
|      - | 1732 | `	SyString *pComp;` |
|      - | 1733 | `	int iLen;` |
|  13051 | 1734 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  13051 | 1740 | `	zPath = ph7_value_to_string(apArg[0],&iLen);` |
|  13051 | 1741 | `	if( iLen < 1 ){` |
|      - | 1742 | `		/* Empty string */` |
|    ! 0 | 1743 | `		ph7_result_string(pCtx,"",0);` |
|    ! 0 | 1744 | `		return PH7_OK;` |
|      - | 1745 | `	}` |
|      - | 1746 | `	/* Extract path info */` |
|  13051 | 1747 | `	ExtractPathInfo(zPath,iLen,&sInfo);` |
|  19573 | 1748 | `	if( nArg > 1 && ph7_value_is_int(apArg[1]) ){` |
|      - | 1749 | `		/* Return path component */` |
|  13049 | 1750 | `		int nComp = ph7_value_to_int(apArg[1]);` |
|  13049 | 1751 | `		switch(nComp){` |
...
|      - | 1768 | `			}` |
|      3 | 1769 | `			break;` |
|   3262 | 1770 | `		case 3: /*PATHINFO_EXTENSION*/` |
|   6529 | 1771 | `			pComp = &sInfo.sExtension;` |
|   6529 | 1772 | `			if( pComp->nByte > 0 ){` |
|   6527 | 1773 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   3266 | 1774 | `			}else{` |
|      - | 1775 | `				/* Expand the empty string */` |
|      3 | 1776 | `				ph7_result_string(pCtx,"",0);` |
|      - | 1777 | `			}` |
|   6529 | 1778 | `			break;` |
|   3258 | 1779 | `		case 4: /*PATHINFO_FILENAME*/` |
|   6521 | 1780 | `			pComp = &sInfo.sFilename;` |
|   6521 | 1781 | `			if( pComp->nByte > 0 ){` |
|   6521 | 1782 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   3263 | 1783 | `			}else{` |
...
|      - | 2827 | ` */` |
|  10446 | 2828 | `static int PH7_builtin_feof(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2829 | `{` |
|      - | 2830 | `	const ph7_io_stream *pStream;` |
|      - | 2831 | `	io_private *pDev;` |
|      - | 2832 | `	int rc;` |
|  10451 | 2833 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|  10451 | 2840 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 2841 | `	/* Make sure we are dealing with a valid io_private instance */` |
|  10451 | 2842 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|  10451 | 2849 | `	pStream = pDev->pStream;` |
|  10451 | 2850 | `	if( pStream == 0 ){` |
...
|      - | 2857 | `	}` |
|  10451 | 2858 | `	rc = SXERR_EOF;` |
|      - | 2859 | `	/* Perform the requested operation */` |
|  10451 | 2860 | `	if( SyBlobLength(&pDev->sBuffer) > pDev->nOfft ){` |
...
|   5675 | 2867 | `		n = pStream->xRead(pDev->pHandle,zBuf,sizeof(zBuf));` |
|   5675 | 2868 | `		if( n > 0 ){` |
|      - | 2869 | `			/* Copy buffered data */` |
|   1849 | 2870 | `			SyBlobAppend(&pDev->sBuffer,zBuf,(sxu32)n);` |
|   1849 | 2871 | `			rc = PH7_OK;` |
|    922 | 2872 | `		}` |
|      - | 2873 | `	}` |
|      - | 2874 | `	/* EOF or not */` |
|  10451 | 2875 | `	ph7_result_bool(pCtx,rc == SXERR_EOF);` |
|  10451 | 2876 | `	return PH7_OK;` |
|   5228 | 2877 | `}` |
|      - | 2878 | `/*` |
...
|      - | 2922 | ` */` |
|   6686 | 2923 | `static sxi32 GetLine(io_private *pDev,ph7_int64 *pLen,const char **pzLine)` |
|      5 | 2924 | `{` |
|      - | 2925 | `	const char *zIn,*zEnd,*zPtr;` |
|   6691 | 2926 | `	zIn = (const char *)SyBlobDataAt(&pDev->sBuffer,pDev->nOfft);` |
|   6691 | 2927 | `	zEnd = &zIn[SyBlobLength(&pDev->sBuffer)-pDev->nOfft];` |
|   6691 | 2928 | `	zPtr = zIn;` |
| 391592 | 2929 | `	while( zIn < zEnd ){` |
| 391490 | 2930 | `		if( zIn[0] == '\n' ){` |
|      - | 2931 | `			/* Line found */` |
|   6589 | 2932 | `			zIn++; /* Include the line ending as requested by the PHP specification */` |
|   6589 | 2933 | `			*pLen = (ph7_int64)(zIn-zPtr);` |
|   6589 | 2934 | `			*pzLine = zPtr;` |
|   6589 | 2935 | `			return SXRET_OK;` |
|      - | 2936 | `		}` |
| 384906 | 2937 | `		zIn++;` |
|      5 | 2938 | `	}` |
...
|      - | 2944 | ` */` |
|   6690 | 2945 | `static ph7_int64 StreamReadLine(io_private *pDev,const char **pzData,ph7_int64 nMaxLen)` |
|      5 | 2946 | `{` |
|   6695 | 2947 | `	const ph7_io_stream *pStream = pDev->pStream;` |
|      - | 2948 | `	char zBuf[8192];` |
|      - | 2949 | `	ph7_int64 n;` |
|      - | 2950 | `	sxi32 rc;` |
|   6695 | 2951 | `	n = 0;` |
|   6695 | 2952 | `	if( pDev->nOfft >= SyBlobLength(&pDev->sBuffer) ){` |
...
|     34 | 2956 | `	}` |
|   6695 | 2957 | `	if( SyBlobLength(&pDev->sBuffer) > pDev->nOfft ){` |
|      - | 2958 | `		/* Check if there is a line */` |
|   6627 | 2959 | `		rc = GetLine(pDev,&n,pzData);` |
|   6627 | 2960 | `		if( rc == SXRET_OK ){` |
|      - | 2961 | `			/* Got line,update the cursor  */` |
|   6529 | 2962 | `			pDev->nOfft += (sxu32)n;` |
|   6529 | 2963 | `			return n;` |
|      - | 2964 | `		}` |
|     49 | 2965 | `	}` |
...
|      - | 3024 | ` */` |
|  29596 | 3025 | `PH7_PRIVATE void * PH7_StreamOpenHandle(ph7_vm *pVm,const ph7_io_stream *pStream,const char *zFile,` |
|      - | 3026 | `	int iFlags,int use_include,ph7_value *pResource,int bPushInclude,int *pNew)` |
|      5 | 3027 | `{` |
|  29601 | 3028 | `	void *pHandle = 0; /* cc warning */` |
|      - | 3029 | `	SyString sFile;` |
|      - | 3030 | `	ph7_value sDummy;` |
|      - | 3031 | `	int rc;` |
|  29601 | 3032 | `	if( pStream == 0 ){` |
|      - | 3033 | `		/* No such stream device */` |
|    ! 0 | 3034 | `		return 0;` |
|      - | 3035 | `	}` |
|  29601 | 3036 | `	if( pResource == 0 ){` |
...
|  29583 | 3042 | `		PH7_MemObjInit(pVm,&sDummy);` |
|  29583 | 3043 | `		pResource = &sDummy;` |
|  14789 | 3044 | `	}` |
|  29601 | 3045 | `	SyStringInitFromBuf(&sFile,zFile,SyStrlen(zFile));` |
|  29601 | 3046 | `	if( use_include ){` |
...
|   9403 | 3078 | `					if( bPushInclude ){` |
|      - | 3079 | `						/* Mark as included */` |
|   9403 | 3080 | `						PH7_VmPushFilePath(pVm,(const char *)SyBlobData(&sWorker),SyBlobLength(&sWorker),FALSE,pNew);` |
|   4700 | 3081 | `					}` |
|   9403 | 3082 | `					break;` |
|      - | 3083 | `				}` |
...
|   9421 | 3091 | `			if( bPushInclude ){` |
|      - | 3092 | `				/* Mark as included */` |
|   9421 | 3093 | `				PH7_VmPushFilePath(pVm,sFile.zString,sFile.nByte,FALSE,pNew);` |
|   4709 | 3094 | `			}` |
|   4709 | 3095 | `		}` |
|   4716 | 3096 | `	}else{` |
|      - | 3097 | `		/* Open the URI direcly */` |
|  20177 | 3098 | `		rc = pStream->xOpen(zFile,iFlags,pResource,&pHandle);` |
|      - | 3099 | `	}` |
|  29601 | 3100 | `	if( rc != PH7_OK ){` |
|      - | 3101 | `		/* IO error */` |
|     16 | 3102 | `		return 0;` |
|      - | 3103 | `	}` |
|      - | 3104 | `	/* Return the file handle */` |
|  29589 | 3105 | `	return pHandle;` |
|  14803 | 3106 | `}` |
|      - | 3107 | `/*` |
...
|   9412 | 3118 | `	for(;;){` |
|  18827 | 3119 | `		nRead = pStream->xRead(pHandle,zBuf,sizeof(zBuf));` |
|  18827 | 3120 | `		if( nRead < 1 ){` |
|      - | 3121 | `			/* EOF or IO error */` |
|   9415 | 3122 | `			break;` |
|      - | 3123 | `		}` |
|      - | 3124 | `		/* Append contents */` |
|   9415 | 3125 | `		rc = SyBlobAppend(pOut,zBuf,(sxu32)nRead);` |
|   9415 | 3126 | `		if( rc != SXRET_OK ){` |
|    ! 0 | 3127 | `			break;` |
|      - | 3128 | `		}` |
|      3 | 3129 | `	}` |
|   9415 | 3130 | `	return SyBlobLength(pOut) > 0 ? SXRET_OK : -1;` |
|      3 | 3131 | `}` |
|      - | 3132 | `/*` |
|      - | 3133 | ` * Close an open IO stream handle [i.e local file/URI..].` |
|      - | 3134 | ` */` |
|  29682 | 3135 | `PH7_PRIVATE void PH7_StreamCloseHandle(const ph7_io_stream *pStream,void *pHandle)` |
|      5 | 3136 | `{` |
|  29687 | 3137 | `	if( pStream->xClose ){` |
|  29687 | 3138 | `		pStream->xClose(pHandle);` |
|  14841 | 3139 | `	}` |
|  29687 | 3140 | `}` |
|      - | 3141 | `/*` |
...
|      - | 3210 | ` */` |
|   6680 | 3211 | `static int PH7_builtin_fgets(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3212 | `{` |
|      - | 3213 | `	const ph7_io_stream *pStream;` |
|      - | 3214 | `	const char *zLine;` |
|      - | 3215 | `	io_private *pDev;` |
|      - | 3216 | `	ph7_int64 n,nLen;` |
|   6685 | 3217 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   6685 | 3224 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3225 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   6685 | 3226 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   6685 | 3233 | `	pStream = pDev->pStream;` |
|   6685 | 3234 | `	if( pStream == 0  ){` |
...
|   6685 | 3248 | `	n = StreamReadLine(pDev,&zLine,nLen);` |
|   6685 | 3249 | `	if( n < 1 ){` |
|      - | 3250 | `		/* EOF or IO error,return FALSE */` |
|      7 | 3251 | `		ph7_result_bool(pCtx,0);` |
|      6 | 3252 | `	}else{` |
|      - | 3253 | `		/* Return the freshly extracted line */` |
|   6683 | 3254 | `		ph7_result_string(pCtx,zLine,(int)n);` |
|      - | 3255 | `	}` |
|   6685 | 3256 | `	return PH7_OK;` |
|   3345 | 3257 | `}` |
|      - | 3258 | `/*` |
...
|      - | 3519 | ` */` |
|   8516 | 3520 | `static int PH7_builtin_readdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3521 | `{` |
|      - | 3522 | `	const ph7_io_stream *pStream;` |
|      - | 3523 | `	io_private *pDev;` |
|      - | 3524 | `	int rc;` |
|   8521 | 3525 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   8521 | 3532 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3533 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   8521 | 3534 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   8521 | 3541 | `	pStream = pDev->pStream;` |
|   8521 | 3542 | `	if( pStream == 0  \|\| pStream->xReadDir == 0 ){` |
...
|      - | 3549 | `	}` |
|   8521 | 3550 | `	ph7_result_bool(pCtx,0);` |
|      - | 3551 | `	/* Perform the requested operation */` |
|   8521 | 3552 | `	rc = pStream->xReadDir(pDev->pHandle,pCtx);` |
|   8521 | 3553 | `	if( rc != PH7_OK ){` |
|      - | 3554 | `		/* Return FALSE */` |
|   1001 | 3555 | `		ph7_result_bool(pCtx,0);` |
|    498 | 3556 | `	}` |
|   8521 | 3557 | `	return PH7_OK;` |
|   4263 | 3558 | `}` |
|      - | 3559 | `/*` |
...
|      - | 3809 | ` */` |
|   6568 | 3810 | `static int PH7_builtin_file_get_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3811 | `{` |
|      - | 3812 | `	const ph7_io_stream *pStream;` |
|      - | 3813 | `	ph7_int64 n,nRead,nMaxlen;` |
|   6573 | 3814 | `	int use_include  = FALSE;` |
|      - | 3815 | `	const char *zFile;` |
|      - | 3816 | `	char zBuf[8192];` |
|      - | 3817 | `	void *pHandle;` |
|      - | 3818 | `	int nLen;` |
|      - | 3819 |  |
|   6573 | 3820 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   6573 | 3827 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3828 | `	/* Point to the target IO stream device */` |
|   6573 | 3829 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|   6573 | 3830 | `	if( pStream == 0 ){` |
...
|   6573 | 3840 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,PH7_IO_OPEN_RDONLY,use_include,nArg > 2 ? apArg[2] : 0,FALSE,0);` |
|   6573 | 3841 | `	if( pHandle == 0 ){` |
...
|   6573 | 3861 | `	nRead = 0;` |
|   6566 | 3862 | `	for(;;){` |
|  19706 | 3863 | `		n = pStream->xRead(pHandle,zBuf,` |
|   6569 | 3864 | `			(nMaxlen > 0 && (nMaxlen < (ph7_int64)sizeof(zBuf))) ? nMaxlen : (ph7_int64)sizeof(zBuf));` |
|  13137 | 3865 | `		if( n < 1 ){` |
|      - | 3866 | `			/* EOF or IO error,break immediately */` |
|   6571 | 3867 | `			break;` |
|      - | 3868 | `		}` |
|      - | 3869 | `		/* Append data */` |
|   6571 | 3870 | `		ph7_result_string(pCtx,zBuf,(int)n);` |
|      - | 3871 | `		/* Increment read counter */` |
|   6571 | 3872 | `		nRead += n;` |
|   6571 | 3873 | `		if( nMaxlen > 0 && nRead >= nMaxlen ){` |
|      - | 3874 | `			/* Read limit reached */` |
|      3 | 3875 | `			break;` |
|      - | 3876 | `		}` |
|      5 | 3877 | `	}` |
|      - | 3878 | `	/* Close the stream */` |
|   6573 | 3879 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|      - | 3880 | `	/* Check if we have read something */` |
|   6573 | 3881 | `	if( ph7_context_result_buf_length(pCtx) < 1 ){` |
|      - | 3882 | `		/* Nothing read,return FALSE */` |
|      3 | 3883 | `		ph7_result_bool(pCtx,0);` |
|      1 | 3884 | `	}` |
|   6573 | 3885 | `	return PH7_OK;` |
|   3289 | 3886 | `}` |
|      - | 3887 | `/*` |
...
|      - | 3905 | ` */` |
|  13380 | 3906 | `static int PH7_builtin_file_put_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3907 | `{` |
|  13385 | 3908 | `	int use_include  = FALSE;` |
...
|      - | 3915 | `	int nLen;` |
|      - | 3916 |  |
|  13385 | 3917 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  13385 | 3924 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3925 | `	/* Point to the target IO stream device */` |
|  13385 | 3926 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|  13385 | 3927 | `	if( pStream == 0 ){` |
...
|      - | 3931 | `	}` |
|      - | 3932 | `	/* Data to write */` |
|  13385 | 3933 | `	zData = ph7_value_to_string(apArg[1],&nLen);` |
|      - | 3934 | `	/* Try to open the file in read-write mode */` |
|  13385 | 3935 | `	iOpenFlags = PH7_IO_OPEN_CREATE\|PH7_IO_OPEN_RDWR\|PH7_IO_OPEN_TRUNC;` |
|      - | 3936 | `	/* Extract the flags */` |
|  13385 | 3937 | `	iFlags = 0;` |
|  13385 | 3938 | `	if( nArg > 2 ){` |
...
|    ! 0 | 3950 | `		}` |
|    ! 0 | 3951 | `	}` |
|  20075 | 3952 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,iOpenFlags,use_include,` |
|   6690 | 3953 | `		nArg > 3 ? apArg[3] : 0,FALSE,FALSE);` |
|  13385 | 3954 | `	if( pHandle == 0 ){` |
|    ! 0 | 3955 | `		VfsThrowOpenWarning(pCtx,zFile);` |
|    ! 0 | 3956 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 3957 | `		return PH7_OK;` |
|      - | 3958 | `	}` |
|  13385 | 3959 | `	if( nLen < 1 ){` |
...
|  13379 | 3989 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|  13379 | 3990 | `	return PH7_OK;` |
|   6695 | 3991 | `}` |
|      - | 3992 | `/*` |
...
|      - | 4930 | ` */` |
|   5126 | 4931 | `static void InitIOPrivate(ph7_vm *pVm,const ph7_io_stream *pStream,io_private *pOut)` |
|      5 | 4932 | `{` |
|   5131 | 4933 | `	pOut->pStream = pStream;` |
|   5131 | 4934 | `	SyBlobInit(&pOut->sBuffer,&pVm->sAllocator);` |
|   5131 | 4935 | `	pOut->nOfft = 0;` |
|      - | 4936 | `	/* Set the magic number */` |
|   5131 | 4937 | `	pOut->iMagic = IO_PRIVATE_MAGIC;` |
|   5131 | 4938 | `}` |
|      - | 4939 | `/*` |
|      - | 4940 | ` * Release the IO private structure.` |
|      - | 4941 | ` */` |
|   5086 | 4942 | `static void ReleaseIOPrivate(ph7_context *pCtx,io_private *pDev)` |
|      5 | 4943 | `{` |
|   5091 | 4944 | `	SyBlobRelease(&pDev->sBuffer);` |
|   5091 | 4945 | `	pDev->iMagic = 0x2126; /* Invalid magic number so we can detetct misuse */` |
|      - | 4946 | `	/* Release the whole structure */` |
|   5091 | 4947 | `	ph7_context_free_chunk(pCtx,pDev);` |
|   5091 | 4948 | `}` |
|      - | 4949 | `/*` |
...
|     21 | 5017 | `	while( nMax != 0 ){` |
|     19 | 5018 | `		ph7_int64 nAsk = (ph7_int64)sizeof(zBuf);` |
|     19 | 5019 | `		if( nMax > 0 && nMax < nAsk ){` |
|      3 | 5020 | `			nAsk = nMax;` |
|      1 | 5021 | `		}` |
|     19 | 5022 | `		nRead = pStream->xRead(pDev->pHandle,zBuf,nAsk);` |
|     19 | 5023 | `		if( nRead < 1 ){` |
|      9 | 5024 | `			break;` |
|      - | 5025 | `		}` |
|     11 | 5026 | `		ph7_result_string(pCtx,zBuf,(int)nRead); /* appends */` |
|     11 | 5027 | `		if( nMax > 0 ){` |
|      3 | 5028 | `			nMax -= nRead;` |
|      1 | 5029 | `		}` |
|      1 | 5030 | `	}` |
...
|      - | 5134 | `	int bEof;` |
|      - | 5135 | `};` |
|     10 | 5136 | `static ph7_int64 SockStreamData_Read(void *pHandle,void *pBuffer,ph7_int64 nRead)` |
|    ! 0 | 5137 | `{` |
|     10 | 5138 | `	sock_private *pSock = (sock_private *)pHandle;` |
|      - | 5139 | `	int n;` |
|     10 | 5140 | `	if( pSock == 0 \|\| pSock->bEof ){` |
|      2 | 5141 | `		return 0;` |
|      - | 5142 | `	}` |
|      8 | 5143 | `	n = PH7_NetRecv(pSock->sock,pBuffer,(int)nRead,0);` |
|      8 | 5144 | `	if( n <= 0 ){` |
|      4 | 5145 | `		pSock->bEof = 1;` |
|      4 | 5146 | `		return 0;` |
|      - | 5147 | `	}` |
|      4 | 5148 | `	return (ph7_int64)n;` |
|      5 | 5149 | `}` |
...
|      - | 6126 | ` */` |
|   3840 | 6127 | `PH7_PRIVATE const ph7_vfs * PH7_ExportBuiltinVfs(void)` |
|      5 | 6128 | `{` |
...
|      - | 6753 | ` */` |
|   3912 | 6754 | `static pipe_private * PipeOpen(ph7_vm *pVm, const char *zCommand, const char *zMode)` |
|      5 | 6755 | `{` |
|      - | 6756 | `	pipe_private *pPipe;` |
|      - | 6757 | `	FILE *pFile;` |
|   3917 | 6758 | `	if( pVm == 0 \|\| zCommand == 0 \|\| zMode == 0 ){` |
|    ! 0 | 6759 | `		return 0;` |
|      - | 6760 | `	}` |
|      - | 6761 | `	/* Validate mode - only 'r' or 'w' allowed */` |
|   3917 | 6762 | `	if( zMode[0] != 'r' && zMode[0] != 'w' ){` |
|    ! 0 | 6763 | `		return 0;` |
|      - | 6764 | `	}` |
...
|   3912 | 6826 | `	pFile = popen(zCommand, zMode);` |
|   3912 | 6827 | `	if( pFile == 0 ){` |
|    ! 0 | 6828 | `		return 0;` |
|      - | 6829 | `	}` |
|      - | 6830 | `	/* Allocate pipe private structure */` |
|   3912 | 6831 | `	pPipe = (pipe_private *)SyMemBackendAlloc(&pVm->sAllocator, sizeof(pipe_private));` |
|   3912 | 6832 | `	if( pPipe == 0 ){` |
|      - | 6833 | `		/* Out of memory, close the pipe */` |
|    ! 0 | 6834 | `		pclose(pFile);` |
|    ! 0 | 6835 | `		return 0;` |
|      - | 6836 | `	}` |
|      - | 6837 | `	/* Initialize the structure */` |
|   3912 | 6838 | `	pPipe->pFile = pFile;` |
|   3912 | 6839 | `	pPipe->pVm = pVm;` |
|   3912 | 6840 | `	pPipe->iMode = zMode[0];` |
|      - | 6841 | `#else /* OS_OTHER: no process pipes on this platform */` |
|      - | 6842 | `	(void)pFile;` |
|      - | 6843 | `	return 0;` |
|      - | 6844 | `#endif` |
|   3917 | 6845 | `	return pPipe;` |
|   1961 | 6846 | `}` |
|      - | 6847 | `/*` |
|      - | 6848 | ` * Close a pipe and return the exit status of the process.` |
|      - | 6849 | ` * Returns the exit status, or -1 on error.` |
|      - | 6850 | ` */` |
|   3886 | 6851 | `static int PipeClose(pipe_private *pPipe)` |
|      5 | 6852 | `{` |
|      - | 6853 | `	int status;` |
|      - | 6854 | `	ph7_vm *pVm;` |
|   3891 | 6855 | `	if( pPipe == 0 \|\| pPipe->pFile == 0 ){` |
|    ! 0 | 6856 | `		return -1;` |
|      - | 6857 | `	}` |
|   3891 | 6858 | `	pVm = pPipe->pVm;` |
...
|   3886 | 6864 | `	status = pclose(pPipe->pFile);` |
|      - | 6865 | `	/* On Unix, pclose returns the status from waitpid, need to extract exit code */` |
|   3886 | 6866 | `	if( status != -1 ){` |
|   3886 | 6867 | `		if( WIFEXITED(status) ){` |
|   3886 | 6868 | `			status = WEXITSTATUS(status);` |
|   1943 | 6869 | `		}else if( WIFSIGNALED(status) ){` |
...
|   3891 | 6881 | `	SyMemBackendFree(&pVm->sAllocator, pPipe);` |
|   3891 | 6882 | `	return status;` |
|   1948 | 6883 | `}` |
|      - | 6884 | `/*` |
...
|      - | 6898 | ` */` |
|   5810 | 6899 | `static ph7_int64 PipeStream_Read(void *pHandle, void *pBuffer, ph7_int64 nDatatoRead)` |
|      4 | 6900 | `{` |
|   5814 | 6901 | `	pipe_private *pPipe = (pipe_private *)pHandle;` |
|      - | 6902 | `	size_t nRead;` |
|   5814 | 6903 | `	if( pPipe == 0 \|\| pPipe->pFile == 0 ){` |
|    ! 0 | 6904 | `		return -1;` |
|      - | 6905 | `	}` |
|   5814 | 6906 | `	if( pPipe->iMode != 'r' ){` |
|      - | 6907 | `		/* Cannot read from a write-only pipe */` |
|    ! 0 | 6908 | `		return -1;` |
|      - | 6909 | `	}` |
|   5814 | 6910 | `	nRead = fread(pBuffer, 1, (size_t)nDatatoRead, pPipe->pFile);` |
|   5814 | 6911 | `	if( nRead == 0 ){` |
|   3918 | 6912 | `		if( feof(pPipe->pFile) ){` |
|   3918 | 6913 | `			return 0; /* EOF */` |
|      - | 6914 | `		}` |
|    ! 0 | 6915 | `		return -1; /* Error */` |
|      - | 6916 | `	}` |
|   1900 | 6917 | `	return (ph7_int64)nRead;` |
|   2909 | 6918 | `}` |
|      - | 6919 | `/*` |
...
|      - | 6961 | ` */` |
|   3782 | 6962 | `static int is_pipe_stream(const ph7_io_stream *pStream)` |
|      5 | 6963 | `{` |
|   3787 | 6964 | `	return pStream == &sPipe_Stream;` |
|      5 | 6965 | `}` |
|      - | 6966 | `/*` |
...
|      4 | 7024 | `}` |
|   3908 | 7025 | `static int PH7_builtin_popen(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 7026 | `{` |
|      - | 7027 | `	const char *zCommand, *zMode;` |
|      - | 7028 | `	pipe_private *pPipe;` |
|      - | 7029 | `	io_private *pDev;` |
|      - | 7030 | `	int nCmdLen, nModeLen;` |
|   3913 | 7031 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) \|\| !ph7_value_is_string(apArg[1]) ){` |
...
|   3913 | 7038 | `	zCommand = ph7_value_to_string(apArg[0], &nCmdLen);` |
|   3913 | 7039 | `	zMode = ph7_value_to_string(apArg[1], &nModeLen);` |
|   3913 | 7040 | `	if( nCmdLen < 1 ){` |
|    ! 0 | 7041 | `		ph7_context_throw_error(pCtx, PH7_CTX_WARNING, "Empty command");` |
|    ! 0 | 7042 | `		ph7_result_bool(pCtx, 0);` |
|    ! 0 | 7043 | `		return PH7_OK;` |
|      - | 7044 | `	}` |
|   3913 | 7045 | `	if( nModeLen < 1 \|\| (zMode[0] != 'r' && zMode[0] != 'w') ){` |
...
|      - | 7049 | `	}` |
|      - | 7050 | `	/* Open the pipe */` |
|   3913 | 7051 | `	pPipe = PipeOpen(pCtx->pVm, zCommand, zMode);` |
|   3913 | 7052 | `	if( pPipe == 0 ){` |
...
|   3913 | 7058 | `	pDev = (io_private *)ph7_context_alloc_chunk(pCtx, sizeof(io_private), TRUE, FALSE);` |
|   3913 | 7059 | `	if( pDev == 0 ){` |
...
|   3913 | 7066 | `	InitIOPrivate(pCtx->pVm, &sPipe_Stream, pDev);` |
|   3913 | 7067 | `	pDev->pHandle = pPipe;` |
|      - | 7068 | `	/* Return the io_private instance as a resource */` |
|   3913 | 7069 | `	ph7_result_resource(pCtx, pDev);` |
|   3913 | 7070 | `	return PH7_OK;` |
|   1959 | 7071 | `}` |
|      - | 7072 | `/*` |
...
|      - | 7080 | ` */` |
|   3782 | 7081 | `static int PH7_builtin_pclose(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 7082 | `{` |
|      - | 7083 | `	const ph7_io_stream *pStream;` |
|      - | 7084 | `	pipe_private *pPipe;` |
|      - | 7085 | `	io_private *pDev;` |
|      - | 7086 | `	int status;` |
|   3787 | 7087 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   3787 | 7094 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 7095 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   3787 | 7096 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   3787 | 7102 | `	pStream = pDev->pStream;` |
|   3787 | 7103 | `	if( pStream == 0 \|\| !is_pipe_stream(pStream) ){` |
...
|   3787 | 7109 | `	pPipe = (pipe_private *)pDev->pHandle;` |
|      - | 7110 | `	/* Close the pipe and get exit status */` |
|   3787 | 7111 | `	status = PipeClose(pPipe);` |
|      - | 7112 | `	/* Release the IO private structure */` |
|   3787 | 7113 | `	ReleaseIOPrivate(pCtx, pDev);` |
|      - | 7114 | `	/* Invalidate the resource handle */` |
|   3787 | 7115 | `	ph7_value_release(apArg[0]);` |
|      - | 7116 | `	/* Return the exit status */` |
|   3787 | 7117 | `	ph7_result_int(pCtx, status);` |
|   3787 | 7118 | `	return PH7_OK;` |
|   1896 | 7119 | `}` |
...
|      - | 7173 | ` */` |
|   3352 | 7174 | `PH7_PRIVATE sxi32 PH7_RegisterIORoutine(ph7_vm *pVm)` |
|      5 | 7175 | `{` |
|      - | 7176 | `	/*` |
...
|      - | 7286 | `	};` |
|   3357 | 7287 | `	const ph7_io_stream *pFileStream = 0;` |
|   3357 | 7288 | `	sxu32 n = 0;` |
|      - | 7289 | `	/* Register disk-related functions */` |
| 164253 | 7290 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVfsDiskFunc) ; ++n ){` |
| 160901 | 7291 | `		ph7_create_function(&(*pVm),aVfsDiskFunc[n].zName,aVfsDiskFunc[n].xFunc,(void *)pVm->pEngine->pVfs);` |
|  80453 | 7292 | `	}` |
| 157549 | 7293 | `	for( n = 0 ; n < SX_ARRAYSIZE(aIOFunc) ; ++n ){` |
| 154197 | 7294 | `		ph7_create_function(&(*pVm),aIOFunc[n].zName,aIOFunc[n].xFunc,pVm);` |
|  77101 | 7295 | `	}` |
|      - | 7296 | `#else` |
|      - | 7297 | `	SXUNUSED(pVm);` |
...
|      - | 7324 | `	};` |
|  56989 | 7325 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVfsHelperFunc) ; ++n ){` |
|  53637 | 7326 | `		ph7_create_function(&(*pVm),aVfsHelperFunc[n].zName,aVfsHelperFunc[n].xFunc,pVm);` |
|  26821 | 7327 | `	}` |
...
|   3352 | 7335 | `	pFileStream = &sUnixFileStream;` |
|      - | 7336 | `#endif` |
|      - | 7337 | `	/* Install the php:// stream */` |
|   3357 | 7338 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,&sPHP_Stream);` |
|   3357 | 7339 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,&sDATA_Stream);` |
|      - | 7340 | `#ifdef PH7_ENABLE_NET` |
|   3357 | 7341 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,&sTCP_Stream);` |
|      - | 7342 | `#endif` |
|   3357 | 7343 | `	if( pFileStream ){` |
|      - | 7344 | `		/* Install the file:// stream */` |
|   3357 | 7345 | `		ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,pFileStream);` |
|   1676 | 7346 | `	}` |
|      - | 7347 | `#endif /* PH7_DISABLE_DISK_IO */` |
|      - | 7348 |  |
|   3357 | 7349 | `	return SXRET_OK;` |
|      5 | 7350 | `}` |
|      - | 7351 | `/*` |
