...
|      - |  213 | ` */` |
|   8166 |  214 | `static int PH7_vfs_is_dir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  215 | `{` |
|      - |  216 | `	const char *zPath;` |
|      - |  217 | `	ph7_vfs *pVfs;` |
|      - |  218 | `	int rc;` |
|   8171 |  219 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  220 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  221 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  222 | `		return PH7_OK;` |
|      - |  223 | `	}` |
|      - |  224 | `	/* Point to the underlying vfs */` |
|   8171 |  225 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   8171 |  226 | `	if( pVfs == 0 \|\| pVfs->xIsdir == 0 ){` |
...
|   8171 |  236 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  237 | `	/* Perform the requested operation */` |
|   8171 |  238 | `	rc = pVfs->xIsdir(zPath);` |
|      - |  239 | `	/* IO return value */` |
|   8171 |  240 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   8171 |  241 | `	return PH7_OK;` |
|   4088 |  242 | `}` |
|      - |  243 | `/*` |
...
|      - |  476 | ` */` |
|  31278 |  477 | `static int PH7_vfs_unlink(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  478 | `{` |
|      - |  479 | `	const char *zPath;` |
|      - |  480 | `	ph7_vfs *pVfs;` |
|      - |  481 | `	int rc;` |
|  31283 |  482 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  483 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  484 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  485 | `		return PH7_OK;` |
|      - |  486 | `	}` |
|      - |  487 | `	/* Point to the underlying vfs */` |
|  31283 |  488 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  31283 |  489 | `	if( pVfs == 0 \|\| pVfs->xUnlink == 0 ){` |
...
|  31283 |  499 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  500 | `	/* Perform the requested operation */` |
|  31283 |  501 | `	rc = pVfs->xUnlink(zPath);` |
|      - |  502 | `	/* IO return value */` |
|  31283 |  503 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  31283 |  504 | `	return PH7_OK;` |
|  15644 |  505 | `}` |
|      - |  506 | `/*` |
...
|      - |  907 | ` */` |
|   6228 |  908 | `static int PH7_vfs_is_file(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  909 | `{` |
|      - |  910 | `	const char *zPath;` |
|      - |  911 | `	ph7_vfs *pVfs;` |
|      - |  912 | `	int rc;` |
|   6233 |  913 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  914 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  915 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  916 | `		return PH7_OK;` |
|      - |  917 | `	}` |
|      - |  918 | `	/* Point to the underlying vfs */` |
|   6233 |  919 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   6233 |  920 | `	if( pVfs == 0 \|\| pVfs->xIsfile == 0 ){` |
...
|   6233 |  930 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  931 | `	/* Perform the requested operation */` |
|   6233 |  932 | `	rc = pVfs->xIsfile(zPath);` |
|      - |  933 | `	/* IO return value */` |
|   6233 |  934 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   6233 |  935 | `	return PH7_OK;` |
|   3119 |  936 | `}` |
|      - |  937 | `/*` |
...
|      - | 1554 | ` */` |
|  12446 | 1555 | `static sxi32 ExtractPathInfo(const char *zPath,int nByte,path_info *pOut)` |
|      5 | 1556 | `{` |
|  12451 | 1557 | `	const char *zPtr,*zEnd = &zPath[nByte - 1];` |
|      - | 1558 | `	SyString *pCur;` |
|      - | 1559 | `	int c,d;` |
|  12451 | 1560 | `	c = d = '/';` |
...
|  12451 | 1565 | `	SyZero(pOut,sizeof(path_info));` |
|      - | 1566 | `	/* Handle special case */` |
|  12451 | 1567 | `	if( nByte == sizeof(char) && ( (int)zPath[0] == c \|\| (int)zPath[0] == d ) ){` |
...
| 335106 | 1576 | `	while( zEnd > zPath && ( (int)zEnd[0] != c && (int)zEnd[0] != d ) ){` |
| 316437 | 1577 | `		zEnd--;` |
|      5 | 1578 | `	}` |
|  12451 | 1579 | `	zPtr = (zEnd > zPath) ? &zEnd[1] : zPath;` |
|  12451 | 1580 | `	zEnd = &zPath[nByte];` |
|      - | 1581 | `	/* dirname */` |
|  12451 | 1582 | `	pCur = &pOut->sDir;` |
|  12451 | 1583 | `	SyStringInitFromBuf(pCur,zPath,zPtr-zPath);` |
|  12451 | 1584 | `	if( pCur->nByte > 1 ){` |
|  24897 | 1585 | `		SyStringTrimTrailingChar(pCur,'/');` |
|      - | 1586 | `#ifdef __WINNT__` |
|      5 | 1587 | `		SyStringTrimTrailingChar(pCur,'\\');` |
|      - | 1588 | `#endif` |
|   6228 | 1589 | `	}else if( (int)zPath[0] == c \|\| (int)zPath[0] == d ){` |
...
|  12451 | 1597 | `	pCur = &pOut->sBasename;` |
|  12451 | 1598 | `	SyStringInitFromBuf(pCur,zPtr,zEnd-zPtr);` |
|  12451 | 1599 | `	SyStringTrimLeadingChar(pCur,'/');` |
|      - | 1600 | `#ifdef __WINNT__` |
|      5 | 1601 | `	SyStringTrimLeadingChar(pCur,'\\');` |
|      - | 1602 | `#endif` |
|  12451 | 1603 | `	SyStringDupPtr(&pOut->sFilename,pCur);` |
|  12451 | 1604 | `	if( pCur->nByte > 0 ){` |
|      - | 1605 | `		/* extension */` |
|  12451 | 1606 | `		zEnd--;` |
|  62229 | 1607 | `		while( zEnd > pCur->zString /*basename*/ && zEnd[0] != '.' ){` |
|  49783 | 1608 | `			zEnd--;` |
|      5 | 1609 | `		}` |
|  12451 | 1610 | `		if( zEnd > pCur->zString ){` |
|  12449 | 1611 | `			zEnd++; /* Jump leading dot */` |
|  12449 | 1612 | `			SyStringInitFromBuf(&pOut->sExtension,zEnd,&zPath[nByte]-zEnd);` |
|      - | 1613 | `			/* Fix filename */` |
|  12449 | 1614 | `			pCur = &pOut->sFilename;` |
|  12449 | 1615 | `			if( pCur->nByte > SyStringLength(&pOut->sExtension) ){` |
|  12449 | 1616 | `				pCur->nByte -= 1 + SyStringLength(&pOut->sExtension);` |
|   6222 | 1617 | `			}` |
|   6222 | 1618 | `		}` |
|   6223 | 1619 | `	}` |
|  12451 | 1620 | `	return SXRET_OK;` |
|   6228 | 1621 | `}` |
|      - | 1622 | `/*` |
...
|      - | 1625 | ` */` |
|  12446 | 1626 | `static int PH7_builtin_pathinfo(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1627 | `{` |
|      - | 1628 | `	const char *zPath;` |
|      - | 1629 | `	path_info sInfo;` |
|      - | 1630 | `	SyString *pComp;` |
|      - | 1631 | `	int iLen;` |
|  12451 | 1632 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  12451 | 1638 | `	zPath = ph7_value_to_string(apArg[0],&iLen);` |
|  12451 | 1639 | `	if( iLen < 1 ){` |
|      - | 1640 | `		/* Empty string */` |
|    ! 0 | 1641 | `		ph7_result_string(pCtx,"",0);` |
|    ! 0 | 1642 | `		return PH7_OK;` |
|      - | 1643 | `	}` |
|      - | 1644 | `	/* Extract path info */` |
|  12451 | 1645 | `	ExtractPathInfo(zPath,iLen,&sInfo);` |
|  18673 | 1646 | `	if( nArg > 1 && ph7_value_is_int(apArg[1]) ){` |
|      - | 1647 | `		/* Return path component */` |
|  12449 | 1648 | `		int nComp = ph7_value_to_int(apArg[1]);` |
|  12449 | 1649 | `		switch(nComp){` |
...
|      - | 1666 | `			}` |
|      3 | 1667 | `			break;` |
|   3112 | 1668 | `		case 3: /*PATHINFO_EXTENSION*/` |
|   6229 | 1669 | `			pComp = &sInfo.sExtension;` |
|   6229 | 1670 | `			if( pComp->nByte > 0 ){` |
|   6227 | 1671 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   3116 | 1672 | `			}else{` |
|      - | 1673 | `				/* Expand the empty string */` |
|      3 | 1674 | `				ph7_result_string(pCtx,"",0);` |
|      - | 1675 | `			}` |
|   6229 | 1676 | `			break;` |
|   3108 | 1677 | `		case 4: /*PATHINFO_FILENAME*/` |
|   6221 | 1678 | `			pComp = &sInfo.sFilename;` |
|   6221 | 1679 | `			if( pComp->nByte > 0 ){` |
|   6221 | 1680 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   3113 | 1681 | `			}else{` |
...
|      - | 2722 | ` */` |
|  10334 | 2723 | `static int PH7_builtin_feof(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2724 | `{` |
|      - | 2725 | `	const ph7_io_stream *pStream;` |
|      - | 2726 | `	io_private *pDev;` |
|      - | 2727 | `	int rc;` |
|  10339 | 2728 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|  10339 | 2735 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 2736 | `	/* Make sure we are dealing with a valid io_private instance */` |
|  10339 | 2737 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|  10339 | 2744 | `	pStream = pDev->pStream;` |
|  10339 | 2745 | `	if( pStream == 0 ){` |
...
|      - | 2752 | `	}` |
|  10339 | 2753 | `	rc = SXERR_EOF;` |
|      - | 2754 | `	/* Perform the requested operation */` |
|  10339 | 2755 | `	if( SyBlobLength(&pDev->sBuffer) > pDev->nOfft ){` |
...
|      - | 2768 | `	}` |
|      - | 2769 | `	/* EOF or not */` |
|  10339 | 2770 | `	ph7_result_bool(pCtx,rc == SXERR_EOF);` |
|  10339 | 2771 | `	return PH7_OK;` |
|   5172 | 2772 | `}` |
|      - | 2773 | `/*` |
...
|   6531 | 2823 | `	zPtr = zIn;` |
| 381310 | 2824 | `	while( zIn < zEnd ){` |
| 381228 | 2825 | `		if( zIn[0] == '\n' ){` |
|      - | 2826 | `			/* Line found */` |
...
|      - | 2919 | ` */` |
|  29258 | 2920 | `PH7_PRIVATE void * PH7_StreamOpenHandle(ph7_vm *pVm,const ph7_io_stream *pStream,const char *zFile,` |
|      - | 2921 | `	int iFlags,int use_include,ph7_value *pResource,int bPushInclude,int *pNew)` |
|      5 | 2922 | `{` |
|  29263 | 2923 | `	void *pHandle = 0; /* cc warning */` |
|      - | 2924 | `	SyString sFile;` |
|      - | 2925 | `	int rc;` |
|  29263 | 2926 | `	if( pStream == 0 ){` |
|      - | 2927 | `		/* No such stream device */` |
|    ! 0 | 2928 | `		return 0;` |
|      - | 2929 | `	}` |
|  29263 | 2930 | `	SyStringInitFromBuf(&sFile,zFile,SyStrlen(zFile));` |
|  29263 | 2931 | `	if( use_include ){` |
|   9464 | 2932 | `		if(	sFile.zString[0] == '/' \|\|` |
|      - | 2933 | `#ifdef __WINNT__` |
|      - | 2934 | `			(sFile.nByte > 2 && sFile.zString[1] == ':' && (sFile.zString[2] == '\\' \|\| sFile.zString[2] == '/') ) \|\|` |
|      - | 2935 | `#endif` |
|   9450 | 2936 | `			(sFile.nByte > 1 && sFile.zString[0] == '.' && sFile.zString[1] == '/') \|\|` |
|   9446 | 2937 | `			(sFile.nByte > 2 && sFile.zString[0] == '.' && sFile.zString[1] == '.' && sFile.zString[2] == '/') ){` |
...
|   9450 | 2949 | `			SyBlobInit(&sWorker,&pVm->sAllocator);` |
|      - | 2950 | `			/* Build a path from the set of include path */` |
|   9450 | 2951 | `			SySetResetCursor(&pVm->aPaths);` |
|   9450 | 2952 | `			rc = SXERR_IO;` |
|   9456 | 2953 | `			while( SXRET_OK == SySetGetNextEntry(&pVm->aPaths,(void **)&pPath) ){` |
|      - | 2954 | `				/* Build full path */` |
|   9450 | 2955 | `				SyBlobFormat(&sWorker,"%z%c%z",pPath,c,&sFile);` |
|      - | 2956 | `				/* Append null terminator */` |
|   9450 | 2957 | `				if( SXRET_OK != SyBlobNullAppend(&sWorker) ){` |
|    ! 0 | 2958 | `					continue;` |
|      - | 2959 | `				}` |
|      - | 2960 | `				/* Try to open the file */` |
|   9450 | 2961 | `				rc = pStream->xOpen((const char *)SyBlobData(&sWorker),iFlags,pResource,&pHandle);` |
|   9450 | 2962 | `				if( rc == PH7_OK ){` |
|   9443 | 2963 | `					if( bPushInclude ){` |
|      - | 2964 | `						/* Mark as included */` |
|   9443 | 2965 | `						PH7_VmPushFilePath(pVm,(const char *)SyBlobData(&sWorker),SyBlobLength(&sWorker),FALSE,pNew);` |
|   4720 | 2966 | `					}` |
|   9443 | 2967 | `					break;` |
|      - | 2968 | `				}` |
...
|      2 | 2972 | `			}` |
|   9450 | 2973 | `			SyBlobRelease(&sWorker);` |
|      - | 2974 | `		}` |
|   9468 | 2975 | `		if( rc == PH7_OK ){` |
|   9461 | 2976 | `			if( bPushInclude ){` |
|      - | 2977 | `				/* Mark as included */` |
|   9461 | 2978 | `				PH7_VmPushFilePath(pVm,sFile.zString,sFile.nByte,FALSE,pNew);` |
|   4729 | 2979 | `			}` |
|   4729 | 2980 | `		}` |
|   4736 | 2981 | `	}else{` |
|      - | 2982 | `		/* Open the URI direcly */` |
|  19799 | 2983 | `		rc = pStream->xOpen(zFile,iFlags,pResource,&pHandle);` |
|      - | 2984 | `	}` |
|  29263 | 2985 | `	if( rc != PH7_OK ){` |
|      - | 2986 | `		/* IO error */` |
|     15 | 2987 | `		return 0;` |
|      - | 2988 | `	}` |
|      - | 2989 | `	/* Return the file handle */` |
|  29251 | 2990 | `	return pHandle;` |
|  14634 | 2991 | `}` |
|      - | 2992 | `/*` |
...
|      - | 2996 | ` */` |
|   9452 | 2997 | `PH7_PRIVATE sxi32 PH7_StreamReadWholeFile(void *pHandle,const ph7_io_stream *pStream,SyBlob *pOut)` |
|      3 | 2998 | `{` |
...
|   9452 | 3003 | `	for(;;){` |
|  18907 | 3004 | `		nRead = pStream->xRead(pHandle,zBuf,sizeof(zBuf));` |
|  18907 | 3005 | `		if( nRead < 1 ){` |
|      - | 3006 | `			/* EOF or IO error */` |
|   9455 | 3007 | `			break;` |
|      - | 3008 | `		}` |
|      - | 3009 | `		/* Append contents */` |
|   9455 | 3010 | `		rc = SyBlobAppend(pOut,zBuf,(sxu32)nRead);` |
|   9455 | 3011 | `		if( rc != SXRET_OK ){` |
|    ! 0 | 3012 | `			break;` |
|      - | 3013 | `		}` |
|      3 | 3014 | `	}` |
|   9455 | 3015 | `	return SyBlobLength(pOut) > 0 ? SXRET_OK : -1;` |
|      3 | 3016 | `}` |
|      - | 3017 | `/*` |
|      - | 3018 | ` * Close an open IO stream handle [i.e local file/URI..].` |
|      - | 3019 | ` */` |
|  29338 | 3020 | `PH7_PRIVATE void PH7_StreamCloseHandle(const ph7_io_stream *pStream,void *pHandle)` |
|      5 | 3021 | `{` |
|  29343 | 3022 | `	if( pStream->xClose ){` |
|  29343 | 3023 | `		pStream->xClose(pHandle);` |
|  14669 | 3024 | `	}` |
|  29343 | 3025 | `}` |
|      - | 3026 | `/*` |
...
|      - | 3404 | ` */` |
|   8164 | 3405 | `static int PH7_builtin_readdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3406 | `{` |
|      - | 3407 | `	const ph7_io_stream *pStream;` |
|      - | 3408 | `	io_private *pDev;` |
|      - | 3409 | `	int rc;` |
|   8169 | 3410 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   8169 | 3417 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3418 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   8169 | 3419 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   8169 | 3426 | `	pStream = pDev->pStream;` |
|   8169 | 3427 | `	if( pStream == 0  \|\| pStream->xReadDir == 0 ){` |
...
|      - | 3434 | `	}` |
|   8169 | 3435 | `	ph7_result_bool(pCtx,0);` |
|      - | 3436 | `	/* Perform the requested operation */` |
|   8169 | 3437 | `	rc = pStream->xReadDir(pDev->pHandle,pCtx);` |
|   8169 | 3438 | `	if( rc != PH7_OK ){` |
|      - | 3439 | `		/* Return FALSE */` |
|    975 | 3440 | `		ph7_result_bool(pCtx,0);` |
|    485 | 3441 | `	}` |
|   8169 | 3442 | `	return PH7_OK;` |
|   4087 | 3443 | `}` |
|      - | 3444 | `/*` |
...
|      - | 3686 | ` */` |
|   6256 | 3687 | `static int PH7_builtin_file_get_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3688 | `{` |
|      - | 3689 | `	const ph7_io_stream *pStream;` |
|      - | 3690 | `	ph7_int64 n,nRead,nMaxlen;` |
|   6261 | 3691 | `	int use_include  = FALSE;` |
|      - | 3692 | `	const char *zFile;` |
|      - | 3693 | `	char zBuf[8192];` |
|      - | 3694 | `	void *pHandle;` |
|      - | 3695 | `	int nLen;` |
|      - | 3696 |  |
|   6261 | 3697 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   6261 | 3704 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3705 | `	/* Point to the target IO stream device */` |
|   6261 | 3706 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|   6261 | 3707 | `	if( pStream == 0 ){` |
...
|   6261 | 3717 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,PH7_IO_OPEN_RDONLY,use_include,nArg > 2 ? apArg[2] : 0,FALSE,0);` |
|   6261 | 3718 | `	if( pHandle == 0 ){` |
...
|   6261 | 3738 | `	nRead = 0;` |
|   6255 | 3739 | `	for(;;){` |
|  18773 | 3740 | `		n = pStream->xRead(pHandle,zBuf,` |
|   6258 | 3741 | `			(nMaxlen > 0 && (nMaxlen < (ph7_int64)sizeof(zBuf))) ? nMaxlen : (ph7_int64)sizeof(zBuf));` |
|  12515 | 3742 | `		if( n < 1 ){` |
|      - | 3743 | `			/* EOF or IO error,break immediately */` |
|   6259 | 3744 | `			break;` |
|      - | 3745 | `		}` |
|      - | 3746 | `		/* Append data */` |
|   6261 | 3747 | `		ph7_result_string(pCtx,zBuf,(int)n);` |
|      - | 3748 | `		/* Increment read counter */` |
|   6261 | 3749 | `		nRead += n;` |
|   6261 | 3750 | `		if( nMaxlen > 0 && nRead >= nMaxlen ){` |
|      - | 3751 | `			/* Read limit reached */` |
|      3 | 3752 | `			break;` |
|      - | 3753 | `		}` |
|      5 | 3754 | `	}` |
|      - | 3755 | `	/* Close the stream */` |
|   6261 | 3756 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|      - | 3757 | `	/* Check if we have read something */` |
|   6261 | 3758 | `	if( ph7_context_result_buf_length(pCtx) < 1 ){` |
|      - | 3759 | `		/* Nothing read,return FALSE */` |
|    ! 0 | 3760 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 3761 | `	}` |
|   6261 | 3762 | `	return PH7_OK;` |
|   3133 | 3763 | `}` |
|      - | 3764 | `/*` |
...
|      - | 4743 | ` */` |
|   4990 | 4744 | `static void InitIOPrivate(ph7_vm *pVm,const ph7_io_stream *pStream,io_private *pOut)` |
|      5 | 4745 | `{` |
|   4995 | 4746 | `	pOut->pStream = pStream;` |
|   4995 | 4747 | `	SyBlobInit(&pOut->sBuffer,&pVm->sAllocator);` |
|   4995 | 4748 | `	pOut->nOfft = 0;` |
|      - | 4749 | `	/* Set the magic number */` |
|   4995 | 4750 | `	pOut->iMagic = IO_PRIVATE_MAGIC;` |
|   4995 | 4751 | `}` |
|      - | 4752 | `/*` |
|      - | 4753 | ` * Release the IO private structure.` |
|      - | 4754 | ` */` |
|   4958 | 4755 | `static void ReleaseIOPrivate(ph7_context *pCtx,io_private *pDev)` |
|      5 | 4756 | `{` |
|   4963 | 4757 | `	SyBlobRelease(&pDev->sBuffer);` |
|   4963 | 4758 | `	pDev->iMagic = 0x2126; /* Invalid magic number so we can detetct misuse */` |
|      - | 4759 | `	/* Release the whole structure */` |
|   4963 | 4760 | `	ph7_context_free_chunk(pCtx,pDev);` |
|   4963 | 4761 | `}` |
|      - | 4762 | `/*` |
...
|      - | 5203 | ` */` |
|   3882 | 5204 | `PH7_PRIVATE const ph7_vfs * PH7_ExportBuiltinVfs(void)` |
|      5 | 5205 | `{` |
...
|      - | 5623 | ` */` |
|   3942 | 5624 | `static pipe_private * PipeOpen(ph7_vm *pVm, const char *zCommand, const char *zMode)` |
|      5 | 5625 | `{` |
|      - | 5626 | `	pipe_private *pPipe;` |
|      - | 5627 | `	FILE *pFile;` |
|   3947 | 5628 | `	if( pVm == 0 \|\| zCommand == 0 \|\| zMode == 0 ){` |
|    ! 0 | 5629 | `		return 0;` |
|      - | 5630 | `	}` |
|      - | 5631 | `	/* Validate mode - only 'r' or 'w' allowed */` |
|   3947 | 5632 | `	if( zMode[0] != 'r' && zMode[0] != 'w' ){` |
|    ! 0 | 5633 | `		return 0;` |
|      - | 5634 | `	}` |
...
|   3942 | 5696 | `	pFile = popen(zCommand, zMode);` |
|   3942 | 5697 | `	if( pFile == 0 ){` |
|    ! 0 | 5698 | `		return 0;` |
|      - | 5699 | `	}` |
|      - | 5700 | `	/* Allocate pipe private structure */` |
|   3942 | 5701 | `	pPipe = (pipe_private *)SyMemBackendAlloc(&pVm->sAllocator, sizeof(pipe_private));` |
|   3942 | 5702 | `	if( pPipe == 0 ){` |
|      - | 5703 | `		/* Out of memory, close the pipe */` |
|    ! 0 | 5704 | `		pclose(pFile);` |
|    ! 0 | 5705 | `		return 0;` |
|      - | 5706 | `	}` |
|      - | 5707 | `	/* Initialize the structure */` |
|   3942 | 5708 | `	pPipe->pFile = pFile;` |
|   3942 | 5709 | `	pPipe->pVm = pVm;` |
|   3942 | 5710 | `	pPipe->iMode = zMode[0];` |
|      - | 5711 | `#else /* OS_OTHER: no process pipes on this platform */` |
|      - | 5712 | `	(void)pFile;` |
|      - | 5713 | `	return 0;` |
|      - | 5714 | `#endif` |
|   3947 | 5715 | `	return pPipe;` |
|   1976 | 5716 | `}` |
|      - | 5717 | `/*` |
|      - | 5718 | ` * Close a pipe and return the exit status of the process.` |
|      - | 5719 | ` * Returns the exit status, or -1 on error.` |
|      - | 5720 | ` */` |
|   3920 | 5721 | `static int PipeClose(pipe_private *pPipe)` |
|      5 | 5722 | `{` |
|      - | 5723 | `	int status;` |
|      - | 5724 | `	ph7_vm *pVm;` |
|   3925 | 5725 | `	if( pPipe == 0 \|\| pPipe->pFile == 0 ){` |
|    ! 0 | 5726 | `		return -1;` |
|      - | 5727 | `	}` |
|   3925 | 5728 | `	pVm = pPipe->pVm;` |
...
|   3920 | 5734 | `	status = pclose(pPipe->pFile);` |
|      - | 5735 | `	/* On Unix, pclose returns the status from waitpid, need to extract exit code */` |
|   3920 | 5736 | `	if( status != -1 ){` |
|   3920 | 5737 | `		if( WIFEXITED(status) ){` |
|   3920 | 5738 | `			status = WEXITSTATUS(status);` |
|   1960 | 5739 | `		}else if( WIFSIGNALED(status) ){` |
...
|   3925 | 5751 | `	SyMemBackendFree(&pVm->sAllocator, pPipe);` |
|   3925 | 5752 | `	return status;` |
|   1965 | 5753 | `}` |
|      - | 5754 | `/*` |
...
|      - | 5768 | ` */` |
|   5758 | 5769 | `static ph7_int64 PipeStream_Read(void *pHandle, void *pBuffer, ph7_int64 nDatatoRead)` |
|      4 | 5770 | `{` |
|   5762 | 5771 | `	pipe_private *pPipe = (pipe_private *)pHandle;` |
|      - | 5772 | `	size_t nRead;` |
|   5762 | 5773 | `	if( pPipe == 0 \|\| pPipe->pFile == 0 ){` |
|    ! 0 | 5774 | `		return -1;` |
|      - | 5775 | `	}` |
|   5762 | 5776 | `	if( pPipe->iMode != 'r' ){` |
|      - | 5777 | `		/* Cannot read from a write-only pipe */` |
|    ! 0 | 5778 | `		return -1;` |
|      - | 5779 | `	}` |
|   5762 | 5780 | `	nRead = fread(pBuffer, 1, (size_t)nDatatoRead, pPipe->pFile);` |
|   5762 | 5781 | `	if( nRead == 0 ){` |
|   3944 | 5782 | `		if( feof(pPipe->pFile) ){` |
|   3944 | 5783 | `			return 0; /* EOF */` |
|      - | 5784 | `		}` |
...
|      - | 5831 | ` */` |
|   3826 | 5832 | `static int is_pipe_stream(const ph7_io_stream *pStream)` |
|      5 | 5833 | `{` |
|   3831 | 5834 | `	return pStream == &sPipe_Stream;` |
|      5 | 5835 | `}` |
|      - | 5836 | `/*` |
...
|      - | 5848 | ` */` |
|   3942 | 5849 | `static int PH7_builtin_popen(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 5850 | `{` |
|      - | 5851 | `	const char *zCommand, *zMode;` |
|      - | 5852 | `	pipe_private *pPipe;` |
|      - | 5853 | `	io_private *pDev;` |
|      - | 5854 | `	int nCmdLen, nModeLen;` |
|   3947 | 5855 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) \|\| !ph7_value_is_string(apArg[1]) ){` |
...
|   3947 | 5862 | `	zCommand = ph7_value_to_string(apArg[0], &nCmdLen);` |
|   3947 | 5863 | `	zMode = ph7_value_to_string(apArg[1], &nModeLen);` |
|   3947 | 5864 | `	if( nCmdLen < 1 ){` |
|    ! 0 | 5865 | `		ph7_context_throw_error(pCtx, PH7_CTX_WARNING, "Empty command");` |
|    ! 0 | 5866 | `		ph7_result_bool(pCtx, 0);` |
|    ! 0 | 5867 | `		return PH7_OK;` |
|      - | 5868 | `	}` |
|   3947 | 5869 | `	if( nModeLen < 1 \|\| (zMode[0] != 'r' && zMode[0] != 'w') ){` |
...
|      - | 5873 | `	}` |
|      - | 5874 | `	/* Open the pipe */` |
|   3947 | 5875 | `	pPipe = PipeOpen(pCtx->pVm, zCommand, zMode);` |
|   3947 | 5876 | `	if( pPipe == 0 ){` |
...
|   3947 | 5882 | `	pDev = (io_private *)ph7_context_alloc_chunk(pCtx, sizeof(io_private), TRUE, FALSE);` |
|   3947 | 5883 | `	if( pDev == 0 ){` |
...
|   3947 | 5890 | `	InitIOPrivate(pCtx->pVm, &sPipe_Stream, pDev);` |
|   3947 | 5891 | `	pDev->pHandle = pPipe;` |
|      - | 5892 | `	/* Return the io_private instance as a resource */` |
|   3947 | 5893 | `	ph7_result_resource(pCtx, pDev);` |
|   3947 | 5894 | `	return PH7_OK;` |
|   1976 | 5895 | `}` |
|      - | 5896 | `/*` |
...
|      - | 5904 | ` */` |
|   3826 | 5905 | `static int PH7_builtin_pclose(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 5906 | `{` |
|      - | 5907 | `	const ph7_io_stream *pStream;` |
|      - | 5908 | `	pipe_private *pPipe;` |
|      - | 5909 | `	io_private *pDev;` |
|      - | 5910 | `	int status;` |
|   3831 | 5911 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   3831 | 5918 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 5919 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   3831 | 5920 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   3831 | 5926 | `	pStream = pDev->pStream;` |
|   3831 | 5927 | `	if( pStream == 0 \|\| !is_pipe_stream(pStream) ){` |
...
|   3831 | 5933 | `	pPipe = (pipe_private *)pDev->pHandle;` |
|      - | 5934 | `	/* Close the pipe and get exit status */` |
|   3831 | 5935 | `	status = PipeClose(pPipe);` |
|      - | 5936 | `	/* Release the IO private structure */` |
|   3831 | 5937 | `	ReleaseIOPrivate(pCtx, pDev);` |
|      - | 5938 | `	/* Invalidate the resource handle */` |
|   3831 | 5939 | `	ph7_value_release(apArg[0]);` |
|      - | 5940 | `	/* Return the exit status */` |
|   3831 | 5941 | `	ph7_result_int(pCtx, status);` |
|   3831 | 5942 | `	return PH7_OK;` |
|   1918 | 5943 | `}` |
...
|      - | 5985 | ` */` |
|   3476 | 5986 | `PH7_PRIVATE sxi32 PH7_RegisterIORoutine(ph7_vm *pVm)` |
|      5 | 5987 | `{` |
|      - | 5988 | `	/*` |
...
|      - | 6085 | `	};` |
|   3481 | 6086 | `	const ph7_io_stream *pFileStream = 0;` |
|   3481 | 6087 | `	sxu32 n = 0;` |
|      - | 6088 | `	/* Register disk-related functions */` |
| 170329 | 6089 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVfsDiskFunc) ; ++n ){` |
| 166853 | 6090 | `		ph7_create_function(&(*pVm),aVfsDiskFunc[n].zName,aVfsDiskFunc[n].xFunc,(void *)pVm->pEngine->pVfs);` |
|  83429 | 6091 | `	}` |
| 125141 | 6092 | `	for( n = 0 ; n < SX_ARRAYSIZE(aIOFunc) ; ++n ){` |
| 121665 | 6093 | `		ph7_create_function(&(*pVm),aIOFunc[n].zName,aIOFunc[n].xFunc,pVm);` |
|  60835 | 6094 | `	}` |
|      - | 6095 | `#else` |
|      - | 6096 | `	SXUNUSED(pVm);` |
...
|      - | 6123 | `	};` |
|  59097 | 6124 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVfsHelperFunc) ; ++n ){` |
|  55621 | 6125 | `		ph7_create_function(&(*pVm),aVfsHelperFunc[n].zName,aVfsHelperFunc[n].xFunc,pVm);` |
|  27813 | 6126 | `	}` |
...
|   3476 | 6134 | `	pFileStream = &sUnixFileStream;` |
|      - | 6135 | `#endif` |
|      - | 6136 | `	/* Install the php:// stream */` |
|   3481 | 6137 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,&sPHP_Stream);` |
|   3481 | 6138 | `	if( pFileStream ){` |
|      - | 6139 | `		/* Install the file:// stream */` |
|   3481 | 6140 | `		ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,pFileStream);` |
|   1738 | 6141 | `	}` |
|      - | 6142 | `#endif /* PH7_DISABLE_DISK_IO */` |
|      - | 6143 |  |
|   3481 | 6144 | `	return SXRET_OK;` |
|      5 | 6145 | `}` |
|      - | 6146 | `/*` |
