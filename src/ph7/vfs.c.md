...
|      - |   65 | ` */` |
|  11096 |   66 | `static int PH7_vfs_chdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 |   67 |  |
|      - |   68 | `	const char *zPath;` |
|      - |   69 | `	ph7_vfs *pVfs;` |
|      - |   70 | `	int rc;` |
|  11098 |   71 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |   72 | `		/* Missing/Invalid argument,return FALSE */` |
|      8 |   73 | `		ph7_result_bool(pCtx,0);` |
|      8 |   74 | `		return PH7_OK;` |
|      - |   75 | `	}` |
|      - |   76 | `	/* Point to the underlying vfs */` |
|  11092 |   77 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  11092 |   78 | `	if( pVfs == 0 \|\| pVfs->xChdir == 0 ){` |
...
|  11092 |   88 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |   89 | `	/* Perform the requested operation */` |
|  11092 |   90 | `	rc = pVfs->xChdir(zPath);` |
|      - |   91 | `	/* IO return value */` |
|  11092 |   92 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  11092 |   93 | `	return PH7_OK;` |
|   5550 |   94 |  |
|      - |   95 | `/*` |
...
|      - |  213 | ` */` |
|   6572 |  214 | `static int PH7_vfs_is_dir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 |  215 |  |
|      - |  216 | `	const char *zPath;` |
|      - |  217 | `	ph7_vfs *pVfs;` |
|      - |  218 | `	int rc;` |
|   6574 |  219 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  220 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  221 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  222 | `		return PH7_OK;` |
|      - |  223 | `	}` |
|      - |  224 | `	/* Point to the underlying vfs */` |
|   6574 |  225 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   6574 |  226 | `	if( pVfs == 0 \|\| pVfs->xIsdir == 0 ){` |
...
|   6574 |  236 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  237 | `	/* Perform the requested operation */` |
|   6574 |  238 | `	rc = pVfs->xIsdir(zPath);` |
|      - |  239 | `	/* IO return value */` |
|   6574 |  240 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   6574 |  241 | `	return PH7_OK;` |
|   3288 |  242 |  |
|      - |  243 | `/*` |
...
|      - |  476 | ` */` |
|  24058 |  477 | `static int PH7_vfs_unlink(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 |  478 |  |
|      - |  479 | `	const char *zPath;` |
|      - |  480 | `	ph7_vfs *pVfs;` |
|      - |  481 | `	int rc;` |
|  24060 |  482 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  483 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  484 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  485 | `		return PH7_OK;` |
|      - |  486 | `	}` |
|      - |  487 | `	/* Point to the underlying vfs */` |
|  24060 |  488 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  24060 |  489 | `	if( pVfs == 0 \|\| pVfs->xUnlink == 0 ){` |
...
|  24060 |  499 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  500 | `	/* Perform the requested operation */` |
|  24060 |  501 | `	rc = pVfs->xUnlink(zPath);` |
|      - |  502 | `	/* IO return value */` |
|  24060 |  503 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  24060 |  504 | `	return PH7_OK;` |
|  12031 |  505 |  |
|      - |  506 | `/*` |
...
|      - |  907 | ` */` |
|   4784 |  908 | `static int PH7_vfs_is_file(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 |  909 |  |
|      - |  910 | `	const char *zPath;` |
|      - |  911 | `	ph7_vfs *pVfs;` |
|      - |  912 | `	int rc;` |
|   4786 |  913 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  914 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  915 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  916 | `		return PH7_OK;` |
|      - |  917 | `	}` |
|      - |  918 | `	/* Point to the underlying vfs */` |
|   4786 |  919 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   4786 |  920 | `	if( pVfs == 0 \|\| pVfs->xIsfile == 0 ){` |
...
|   4786 |  930 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  931 | `	/* Perform the requested operation */` |
|   4786 |  932 | `	rc = pVfs->xIsfile(zPath);` |
|      - |  933 | `	/* IO return value */` |
|   4786 |  934 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   4786 |  935 | `	return PH7_OK;` |
|   2394 |  936 |  |
|      - |  937 | `/*` |
...
|      - | 1554 | ` */` |
|   9564 | 1555 | `static sxi32 ExtractPathInfo(const char *zPath,int nByte,path_info *pOut)` |
|      2 | 1556 |  |
|   9566 | 1557 | `	const char *zPtr,*zEnd = &zPath[nByte - 1];` |
|      - | 1558 | `	SyString *pCur;` |
|      - | 1559 | `	int c,d;` |
|   9566 | 1560 | `	c = d = '/';` |
...
|   9566 | 1565 | `	SyZero(pOut,sizeof(path_info));` |
|      - | 1566 | `	/* Handle special case */` |
|   9566 | 1567 | `	if( nByte == sizeof(char) && ( (int)zPath[0] == c \|\| (int)zPath[0] == d ) ){` |
...
| 248664 | 1576 | `	while( zEnd > zPath && ( (int)zEnd[0] != c && (int)zEnd[0] != d ) ){` |
| 234318 | 1577 | `		zEnd--;` |
|      2 | 1578 | `	}` |
|   9566 | 1579 | `	zPtr = (zEnd > zPath) ? &zEnd[1] : zPath;` |
|   9566 | 1580 | `	zEnd = &zPath[nByte];` |
|      - | 1581 | `	/* dirname */` |
|   9566 | 1582 | `	pCur = &pOut->sDir;` |
|   9566 | 1583 | `	SyStringInitFromBuf(pCur,zPath,zPtr-zPath);` |
|   9566 | 1584 | `	if( pCur->nByte > 1 ){` |
|  19130 | 1585 | `		SyStringTrimTrailingChar(pCur,'/');` |
|      - | 1586 | `#ifdef __WINNT__` |
|      2 | 1587 | `		SyStringTrimTrailingChar(pCur,'\\');` |
|      - | 1588 | `#endif` |
|   4784 | 1589 | `	}else if( (int)zPath[0] == c \|\| (int)zPath[0] == d ){` |
...
|   9566 | 1597 | `	pCur = &pOut->sBasename;` |
|   9566 | 1598 | `	SyStringInitFromBuf(pCur,zPtr,zEnd-zPtr);` |
|   9566 | 1599 | `	SyStringTrimLeadingChar(pCur,'/');` |
|      - | 1600 | `#ifdef __WINNT__` |
|      2 | 1601 | `	SyStringTrimLeadingChar(pCur,'\\');` |
|      - | 1602 | `#endif` |
|   9566 | 1603 | `	SyStringDupPtr(&pOut->sFilename,pCur);` |
|   9566 | 1604 | `	if( pCur->nByte > 0 ){` |
|      - | 1605 | `		/* extension */` |
|   9566 | 1606 | `		zEnd--;` |
|  47818 | 1607 | `		while( zEnd > pCur->zString /*basename*/ && zEnd[0] != '.' ){` |
|  38254 | 1608 | `			zEnd--;` |
|      2 | 1609 | `		}` |
|   9566 | 1610 | `		if( zEnd > pCur->zString ){` |
|   9564 | 1611 | `			zEnd++; /* Jump leading dot */` |
|   9564 | 1612 | `			SyStringInitFromBuf(&pOut->sExtension,zEnd,&zPath[nByte]-zEnd);` |
|      - | 1613 | `			/* Fix filename */` |
|   9564 | 1614 | `			pCur = &pOut->sFilename;` |
|   9564 | 1615 | `			if( pCur->nByte > SyStringLength(&pOut->sExtension) ){` |
|   9564 | 1616 | `				pCur->nByte -= 1 + SyStringLength(&pOut->sExtension);` |
|   4781 | 1617 | `			}` |
|   4781 | 1618 | `		}` |
|   4782 | 1619 | `	}` |
|   9566 | 1620 | `	return SXRET_OK;` |
|   4784 | 1621 |  |
|      - | 1622 | `/*` |
...
|      - | 1625 | ` */` |
|   9564 | 1626 | `static int PH7_builtin_pathinfo(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 1627 |  |
|      - | 1628 | `	const char *zPath;` |
|      - | 1629 | `	path_info sInfo;` |
|      - | 1630 | `	SyString *pComp;` |
|      - | 1631 | `	int iLen;` |
|   9566 | 1632 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   9566 | 1638 | `	zPath = ph7_value_to_string(apArg[0],&iLen);` |
|   9566 | 1639 | `	if( iLen < 1 ){` |
|      - | 1640 | `		/* Empty string */` |
...
|   9566 | 1645 | `	ExtractPathInfo(zPath,iLen,&sInfo);` |
|  14347 | 1646 | `	if( nArg > 1 && ph7_value_is_int(apArg[1]) ){` |
|      - | 1647 | `		/* Return path component */` |
|   9564 | 1648 | `		int nComp = ph7_value_to_int(apArg[1]);` |
|   9564 | 1649 | `		switch(nComp){` |
...
|      - | 1666 | `			}` |
|      3 | 1667 | `			break;` |
|   2391 | 1668 | `		case 3: /*PATHINFO_EXTENSION*/` |
|   4784 | 1669 | `			pComp = &sInfo.sExtension;` |
|   4784 | 1670 | `			if( pComp->nByte > 0 ){` |
|   4782 | 1671 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   2392 | 1672 | `			}else{` |
|      - | 1673 | `				/* Expand the empty string */` |
|      3 | 1674 | `				ph7_result_string(pCtx,"",0);` |
|      - | 1675 | `			}` |
|   4784 | 1676 | `			break;` |
|   2388 | 1677 | `		case 4: /*PATHINFO_FILENAME*/` |
|   4778 | 1678 | `			pComp = &sInfo.sFilename;` |
|   4778 | 1679 | `			if( pComp->nByte > 0 ){` |
|   4778 | 1680 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   2390 | 1681 | `			}else{` |
...
|      - | 2703 | ` */` |
|   7038 | 2704 | `static int PH7_builtin_feof(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 2705 |  |
|      - | 2706 | `	const ph7_io_stream *pStream;` |
|      - | 2707 | `	io_private *pDev;` |
|      - | 2708 | `	int rc;` |
|   7040 | 2709 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   7040 | 2716 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 2717 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   7040 | 2718 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   7040 | 2725 | `	pStream = pDev->pStream;` |
|   7040 | 2726 | `	if( pStream == 0 ){` |
...
|      - | 2733 | `	}` |
|   7040 | 2734 | `	rc = SXERR_EOF;` |
|      - | 2735 | `	/* Perform the requested operation */` |
|   7040 | 2736 | `	if( SyBlobLength(&pDev->sBuffer) > pDev->nOfft ){` |
...
|   3886 | 2743 | `		n = pStream->xRead(pDev->pHandle,zBuf,sizeof(zBuf));` |
|   3886 | 2744 | `		if( n > 0 ){` |
|      - | 2745 | `			/* Copy buffered data */` |
|   1178 | 2746 | `			SyBlobAppend(&pDev->sBuffer,zBuf,(sxu32)n);` |
|   1178 | 2747 | `			rc = PH7_OK;` |
|    588 | 2748 | `		}` |
|      - | 2749 | `	}` |
|      - | 2750 | `	/* EOF or not */` |
|   7040 | 2751 | `	ph7_result_bool(pCtx,rc == SXERR_EOF);` |
|   7040 | 2752 | `	return PH7_OK;` |
|   3521 | 2753 |  |
|      - | 2754 | `/*` |
...
|      - | 2798 | ` */` |
|   4382 | 2799 | `static sxi32 GetLine(io_private *pDev,ph7_int64 *pLen,const char **pzLine)` |
|      2 | 2800 |  |
|      - | 2801 | `	const char *zIn,*zEnd,*zPtr;` |
|   4384 | 2802 | `	zIn = (const char *)SyBlobDataAt(&pDev->sBuffer,pDev->nOfft);` |
|   4384 | 2803 | `	zEnd = &zIn[SyBlobLength(&pDev->sBuffer)-pDev->nOfft];` |
|   4384 | 2804 | `	zPtr = zIn;` |
| 303521 | 2805 | `	while( zIn < zEnd ){` |
| 303447 | 2806 | `		if( zIn[0] == '\n' ){` |
|      - | 2807 | `			/* Line found */` |
|   4310 | 2808 | `			zIn++; /* Include the line ending as requested by the PHP specification */` |
|   4310 | 2809 | `			*pLen = (ph7_int64)(zIn-zPtr);` |
|   4310 | 2810 | `			*pzLine = zPtr;` |
|   4310 | 2811 | `			return SXRET_OK;` |
|      - | 2812 | `		}` |
| 299139 | 2813 | `		zIn++;` |
|      2 | 2814 | `	}` |
...
|      - | 2820 | ` */` |
|   4386 | 2821 | `static ph7_int64 StreamReadLine(io_private *pDev,const char **pzData,ph7_int64 nMaxLen)` |
|      2 | 2822 |  |
|   4388 | 2823 | `	const ph7_io_stream *pStream = pDev->pStream;` |
|      - | 2824 | `	char zBuf[8192];` |
|      - | 2825 | `	ph7_int64 n;` |
|      - | 2826 | `	sxi32 rc;` |
|   4388 | 2827 | `	n = 0;` |
|   4388 | 2828 | `	if( pDev->nOfft >= SyBlobLength(&pDev->sBuffer) ){` |
...
|     26 | 2832 | `	}` |
|   4388 | 2833 | `	if( SyBlobLength(&pDev->sBuffer) > pDev->nOfft ){` |
|      - | 2834 | `		/* Check if there is a line */` |
|   4336 | 2835 | `		rc = GetLine(pDev,&n,pzData);` |
|   4336 | 2836 | `		if( rc == SXRET_OK ){` |
|      - | 2837 | `			/* Got line,update the cursor  */` |
|   4264 | 2838 | `			pDev->nOfft += (sxu32)n;` |
|   4264 | 2839 | `			return n;` |
|      - | 2840 | `		}` |
|     36 | 2841 | `	}` |
...
|      - | 2900 | ` */` |
|  24640 | 2901 | `PH7_PRIVATE void * PH7_StreamOpenHandle(ph7_vm *pVm,const ph7_io_stream *pStream,const char *zFile,` |
|      - | 2902 | `	int iFlags,int use_include,ph7_value *pResource,int bPushInclude,int *pNew)` |
|      2 | 2903 |  |
|  24642 | 2904 | `	void *pHandle = 0; /* cc warning */` |
|      - | 2905 | `	SyString sFile;` |
|      - | 2906 | `	int rc;` |
|  24642 | 2907 | `	if( pStream == 0 ){` |
|      - | 2908 | `		/* No such stream device */` |
|    ! 0 | 2909 | `		return 0;` |
|      - | 2910 | `	}` |
|  24642 | 2911 | `	SyStringInitFromBuf(&sFile,zFile,SyStrlen(zFile));` |
|  24642 | 2912 | `	if( use_include ){` |
|   8442 | 2913 | `		if(	sFile.zString[0] == '/' \|\|` |
|      - | 2914 | `#ifdef __WINNT__` |
|      - | 2915 | `			(sFile.nByte > 2 && sFile.zString[1] == ':' && (sFile.zString[2] == '\\' \|\| sFile.zString[2] == '/') ) \|\|` |
|      - | 2916 | `#endif` |
|   8432 | 2917 | `			(sFile.nByte > 1 && sFile.zString[0] == '.' && sFile.zString[1] == '/') \|\|` |
|   8430 | 2918 | `			(sFile.nByte > 2 && sFile.zString[0] == '.' && sFile.zString[1] == '.' && sFile.zString[2] == '/') ){` |
...
|   8432 | 2930 | `			SyBlobInit(&sWorker,&pVm->sAllocator);` |
|      - | 2931 | `			/* Build a path from the set of include path */` |
|   8432 | 2932 | `			SySetResetCursor(&pVm->aPaths);` |
|   8432 | 2933 | `			rc = SXERR_IO;` |
|   8438 | 2934 | `			while( SXRET_OK == SySetGetNextEntry(&pVm->aPaths,(void **)&pPath) ){` |
|      - | 2935 | `				/* Build full path */` |
|   8432 | 2936 | `				SyBlobFormat(&sWorker,"%z%c%z",pPath,c,&sFile);` |
|      - | 2937 | `				/* Append null terminator */` |
|   8432 | 2938 | `				if( SXRET_OK != SyBlobNullAppend(&sWorker) ){` |
|    ! 0 | 2939 | `					continue;` |
|      - | 2940 | `				}` |
|      - | 2941 | `				/* Try to open the file */` |
|   8432 | 2942 | `				rc = pStream->xOpen((const char *)SyBlobData(&sWorker),iFlags,pResource,&pHandle);` |
|   8432 | 2943 | `				if( rc == PH7_OK ){` |
|   8426 | 2944 | `					if( bPushInclude ){` |
|      - | 2945 | `						/* Mark as included */` |
|   8426 | 2946 | `						PH7_VmPushFilePath(pVm,(const char *)SyBlobData(&sWorker),SyBlobLength(&sWorker),FALSE,pNew);` |
|   4212 | 2947 | `					}` |
|   8426 | 2948 | `					break;` |
|      - | 2949 | `				}` |
...
|      2 | 2953 | `			}` |
|   8432 | 2954 | `			SyBlobRelease(&sWorker);` |
|      - | 2955 | `		}` |
|   8444 | 2956 | `		if( rc == PH7_OK ){` |
|   8438 | 2957 | `			if( bPushInclude ){` |
|      - | 2958 | `				/* Mark as included */` |
|   8438 | 2959 | `				PH7_VmPushFilePath(pVm,sFile.zString,sFile.nByte,FALSE,pNew);` |
|   4218 | 2960 | `			}` |
|   4218 | 2961 | `		}` |
|   4223 | 2962 | `	}else{` |
|      - | 2963 | `		/* Open the URI direcly */` |
|  16200 | 2964 | `		rc = pStream->xOpen(zFile,iFlags,pResource,&pHandle);` |
|      - | 2965 | `	}` |
|  24642 | 2966 | `	if( rc != PH7_OK ){` |
|      - | 2967 | `		/* IO error */` |
|     14 | 2968 | `		return 0;` |
|      - | 2969 | `	}` |
|      - | 2970 | `	/* Return the file handle */` |
|  24630 | 2971 | `	return pHandle;` |
|  12322 | 2972 |  |
|      - | 2973 | `/*` |
...
|      - | 2977 | ` */` |
|   8434 | 2978 | `PH7_PRIVATE sxi32 PH7_StreamReadWholeFile(void *pHandle,const ph7_io_stream *pStream,SyBlob *pOut)` |
|      2 | 2979 |  |
...
|   8434 | 2984 | `	for(;;){` |
|  16870 | 2985 | `		nRead = pStream->xRead(pHandle,zBuf,sizeof(zBuf));` |
|  16870 | 2986 | `		if( nRead < 1 ){` |
|      - | 2987 | `			/* EOF or IO error */` |
|   8436 | 2988 | `			break;` |
|      - | 2989 | `		}` |
|      - | 2990 | `		/* Append contents */` |
|   8436 | 2991 | `		rc = SyBlobAppend(pOut,zBuf,(sxu32)nRead);` |
|   8436 | 2992 | `		if( rc != SXRET_OK ){` |
|    ! 0 | 2993 | `			break;` |
|      - | 2994 | `		}` |
|      2 | 2995 | `	}` |
|   8436 | 2996 | `	return SyBlobLength(pOut) > 0 ? SXRET_OK : -1;` |
|      2 | 2997 |  |
|      - | 2998 | `/*` |
|      - | 2999 | ` * Close an open IO stream handle [i.e local file/URI..].` |
|      - | 3000 | ` */` |
|  24698 | 3001 | `PH7_PRIVATE void PH7_StreamCloseHandle(const ph7_io_stream *pStream,void *pHandle)` |
|      2 | 3002 |  |
|  24700 | 3003 | `	if( pStream->xClose ){` |
|  24700 | 3004 | `		pStream->xClose(pHandle);` |
|  12349 | 3005 | `	}` |
|  24700 | 3006 |  |
|      - | 3007 | `/*` |
...
|      - | 3076 | ` */` |
|   4376 | 3077 | `static int PH7_builtin_fgets(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 3078 |  |
|      - | 3079 | `	const ph7_io_stream *pStream;` |
|      - | 3080 | `	const char *zLine;` |
|      - | 3081 | `	io_private *pDev;` |
|      - | 3082 | `	ph7_int64 n,nLen;` |
|   4378 | 3083 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   4378 | 3090 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3091 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   4378 | 3092 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   4378 | 3099 | `	pStream = pDev->pStream;` |
|   4378 | 3100 | `	if( pStream == 0  ){` |
...
|   4378 | 3114 | `	n = StreamReadLine(pDev,&zLine,nLen);` |
|   4378 | 3115 | `	if( n < 1 ){` |
|      - | 3116 | `		/* EOF or IO error,return FALSE */` |
|      4 | 3117 | `		ph7_result_bool(pCtx,0);` |
|      3 | 3118 | `	}else{` |
|      - | 3119 | `		/* Return the freshly extracted line */` |
|   4376 | 3120 | `		ph7_result_string(pCtx,zLine,(int)n);` |
|      - | 3121 | `	}` |
|   4378 | 3122 | `	return PH7_OK;` |
|   2190 | 3123 |  |
|      - | 3124 | `/*` |
...
|      - | 3385 | ` */` |
|   6570 | 3386 | `static int PH7_builtin_readdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 3387 |  |
|      - | 3388 | `	const ph7_io_stream *pStream;` |
|      - | 3389 | `	io_private *pDev;` |
|      - | 3390 | `	int rc;` |
|   6572 | 3391 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   6572 | 3398 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3399 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   6572 | 3400 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   6572 | 3407 | `	pStream = pDev->pStream;` |
|   6572 | 3408 | `	if( pStream == 0  \|\| pStream->xReadDir == 0 ){` |
...
|      - | 3415 | `	}` |
|   6572 | 3416 | `	ph7_result_bool(pCtx,0);` |
|      - | 3417 | `	/* Perform the requested operation */` |
|   6572 | 3418 | `	rc = pStream->xReadDir(pDev->pHandle,pCtx);` |
|   6572 | 3419 | `	if( rc != PH7_OK ){` |
|      - | 3420 | `		/* Return FALSE */` |
|    896 | 3421 | `		ph7_result_bool(pCtx,0);` |
|    447 | 3422 | `	}` |
|   6572 | 3423 | `	return PH7_OK;` |
|   3287 | 3424 |  |
|      - | 3425 | `/*` |
...
|      - | 3667 | ` */` |
|   4816 | 3668 | `static int PH7_builtin_file_get_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 3669 |  |
|      - | 3670 | `	const ph7_io_stream *pStream;` |
|      - | 3671 | `	ph7_int64 n,nRead,nMaxlen;` |
|   4818 | 3672 | `	int use_include  = FALSE;` |
|      - | 3673 | `	const char *zFile;` |
|      - | 3674 | `	char zBuf[8192];` |
|      - | 3675 | `	void *pHandle;` |
|      - | 3676 | `	int nLen;` |
|      - | 3677 |  |
|   4818 | 3678 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   4818 | 3685 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3686 | `	/* Point to the target IO stream device */` |
|   4818 | 3687 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|   4818 | 3688 | `	if( pStream == 0 ){` |
...
|   4818 | 3698 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,PH7_IO_OPEN_RDONLY,use_include,nArg > 2 ? apArg[2] : 0,FALSE,0);` |
|   4818 | 3699 | `	if( pHandle == 0 ){` |
...
|   4818 | 3719 | `	nRead = 0;` |
|   4815 | 3720 | `	for(;;){` |
|  14450 | 3721 | `		n = pStream->xRead(pHandle,zBuf,` |
|   4818 | 3722 | `			(nMaxlen > 0 && (nMaxlen < (ph7_int64)sizeof(zBuf))) ? nMaxlen : (ph7_int64)sizeof(zBuf));` |
|   9632 | 3723 | `		if( n < 1 ){` |
|      - | 3724 | `			/* EOF or IO error,break immediately */` |
|   4816 | 3725 | `			break;` |
|      - | 3726 | `		}` |
|      - | 3727 | `		/* Append data */` |
|   4818 | 3728 | `		ph7_result_string(pCtx,zBuf,(int)n);` |
|      - | 3729 | `		/* Increment read counter */` |
|   4818 | 3730 | `		nRead += n;` |
|   4818 | 3731 | `		if( nMaxlen > 0 && nRead >= nMaxlen ){` |
|      - | 3732 | `			/* Read limit reached */` |
|      3 | 3733 | `			break;` |
|      - | 3734 | `		}` |
|      2 | 3735 | `	}` |
|      - | 3736 | `	/* Close the stream */` |
|   4818 | 3737 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|      - | 3738 | `	/* Check if we have read something */` |
|   4818 | 3739 | `	if( ph7_context_result_buf_length(pCtx) < 1 ){` |
|      - | 3740 | `		/* Nothing read,return FALSE */` |
|    ! 0 | 3741 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 3742 | `	}` |
|   4818 | 3743 | `	return PH7_OK;` |
|   2410 | 3744 |  |
|      - | 3745 | `/*` |
...
|      - | 3763 | ` */` |
|  11298 | 3764 | `static int PH7_builtin_file_put_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 3765 |  |
|  11300 | 3766 | `	int use_include  = FALSE;` |
...
|      - | 3773 | `	int nLen;` |
|      - | 3774 |  |
|  11300 | 3775 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  11300 | 3782 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3783 | `	/* Point to the target IO stream device */` |
|  11300 | 3784 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|  11300 | 3785 | `	if( pStream == 0 ){` |
...
|      - | 3789 | `	}` |
|      - | 3790 | `	/* Data to write */` |
|  11300 | 3791 | `	zData = ph7_value_to_string(apArg[1],&nLen);` |
|      - | 3792 | `	/* Try to open the file in read-write mode */` |
|  11300 | 3793 | `	iOpenFlags = PH7_IO_OPEN_CREATE\|PH7_IO_OPEN_RDWR\|PH7_IO_OPEN_TRUNC;` |
|      - | 3794 | `	/* Extract the flags */` |
|  11300 | 3795 | `	iFlags = 0;` |
|  11300 | 3796 | `	if( nArg > 2 ){` |
...
|    ! 0 | 3808 | `		}` |
|    ! 0 | 3809 | `	}` |
|  16949 | 3810 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,iOpenFlags,use_include,` |
|   5649 | 3811 | `		nArg > 3 ? apArg[3] : 0,FALSE,FALSE);` |
|  11300 | 3812 | `	if( pHandle == 0 ){` |
...
|  11294 | 3847 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|  11294 | 3848 | `	return PH7_OK;` |
|   5651 | 3849 |  |
|      - | 3850 | `/*` |
...
|      - | 4724 | ` */` |
|   3740 | 4725 | `static void InitIOPrivate(ph7_vm *pVm,const ph7_io_stream *pStream,io_private *pOut)` |
|      2 | 4726 |  |
|   3742 | 4727 | `	pOut->pStream = pStream;` |
|   3742 | 4728 | `	SyBlobInit(&pOut->sBuffer,&pVm->sAllocator);` |
|   3742 | 4729 | `	pOut->nOfft = 0;` |
|      - | 4730 | `	/* Set the magic number */` |
|   3742 | 4731 | `	pOut->iMagic = IO_PRIVATE_MAGIC;` |
|   3742 | 4732 |  |
|      - | 4733 | `/*` |
|      - | 4734 | ` * Release the IO private structure.` |
|      - | 4735 | ` */` |
|   3712 | 4736 | `static void ReleaseIOPrivate(ph7_context *pCtx,io_private *pDev)` |
|      2 | 4737 |  |
|   3714 | 4738 | `	SyBlobRelease(&pDev->sBuffer);` |
|   3714 | 4739 | `	pDev->iMagic = 0x2126; /* Invalid magic number so we can detetct misuse */` |
|      - | 4740 | `	/* Release the whole structure */` |
|   3714 | 4741 | `	ph7_context_free_chunk(pCtx,pDev);` |
|   3714 | 4742 |  |
|      - | 4743 | `/*` |
...
|      - | 5170 | ` */` |
|   2728 | 5171 | `PH7_PRIVATE const ph7_vfs * PH7_ExportBuiltinVfs(void)` |
|      2 | 5172 |  |
...
|      - | 5590 | ` */` |
|   2770 | 5591 | `static pipe_private * PipeOpen(ph7_vm *pVm, const char *zCommand, const char *zMode)` |
|      2 | 5592 |  |
|      - | 5593 | `	pipe_private *pPipe;` |
|      - | 5594 | `	FILE *pFile;` |
|   2772 | 5595 | `	if( pVm == 0 \|\| zCommand == 0 \|\| zMode == 0 ){` |
|    ! 0 | 5596 | `		return 0;` |
|      - | 5597 | `	}` |
|      - | 5598 | `	/* Validate mode - only 'r' or 'w' allowed */` |
|   2772 | 5599 | `	if( zMode[0] != 'r' && zMode[0] != 'w' ){` |
|    ! 0 | 5600 | `		return 0;` |
|      - | 5601 | `	}` |
...
|      - | 5661 | `	}` |
|      - | 5662 | `#else /* Unix */` |
|   2770 | 5663 | `	pFile = popen(zCommand, zMode);` |
|   2770 | 5664 | `	if( pFile == 0 ){` |
|    ! 0 | 5665 | `		return 0;` |
|      - | 5666 | `	}` |
|      - | 5667 | `	/* Allocate pipe private structure */` |
|   2770 | 5668 | `	pPipe = (pipe_private *)SyMemBackendAlloc(&pVm->sAllocator, sizeof(pipe_private));` |
|   2770 | 5669 | `	if( pPipe == 0 ){` |
|      - | 5670 | `		/* Out of memory, close the pipe */` |
|    ! 0 | 5671 | `		pclose(pFile);` |
|    ! 0 | 5672 | `		return 0;` |
|      - | 5673 | `	}` |
|      - | 5674 | `	/* Initialize the structure */` |
|   2770 | 5675 | `	pPipe->pFile = pFile;` |
|   2770 | 5676 | `	pPipe->pVm = pVm;` |
|   2770 | 5677 | `	pPipe->iMode = zMode[0];` |
|      - | 5678 | `#endif` |
|   2772 | 5679 | `	return pPipe;` |
|   1387 | 5680 |  |
|      - | 5681 | `/*` |
|      - | 5682 | ` * Close a pipe and return the exit status of the process.` |
|      - | 5683 | ` * Returns the exit status, or -1 on error.` |
|      - | 5684 | ` */` |
|   2752 | 5685 | `static int PipeClose(pipe_private *pPipe)` |
|      2 | 5686 |  |
|      - | 5687 | `	int status;` |
|      - | 5688 | `	ph7_vm *pVm;` |
|   2754 | 5689 | `	if( pPipe == 0 \|\| pPipe->pFile == 0 ){` |
|    ! 0 | 5690 | `		return -1;` |
|      - | 5691 | `	}` |
|   2754 | 5692 | `	pVm = pPipe->pVm;` |
...
|      - | 5697 | `#else` |
|   2752 | 5698 | `	status = pclose(pPipe->pFile);` |
|      - | 5699 | `	/* On Unix, pclose returns the status from waitpid, need to extract exit code */` |
|   2752 | 5700 | `	if( status != -1 ){` |
|   2752 | 5701 | `		if( WIFEXITED(status) ){` |
|   2752 | 5702 | `			status = WEXITSTATUS(status);` |
|   1376 | 5703 | `		}else if( WIFSIGNALED(status) ){` |
...
|   2754 | 5713 | `	SyMemBackendFree(&pVm->sAllocator, pPipe);` |
|   2754 | 5714 | `	return status;` |
|   1378 | 5715 |  |
|      - | 5716 | `/*` |
...
|      - | 5730 | ` */` |
|   3988 | 5731 | `static ph7_int64 PipeStream_Read(void *pHandle, void *pBuffer, ph7_int64 nDatatoRead)` |
|      1 | 5732 |  |
|   3989 | 5733 | `	pipe_private *pPipe = (pipe_private *)pHandle;` |
|      - | 5734 | `	size_t nRead;` |
|   3989 | 5735 | `	if( pPipe == 0 \|\| pPipe->pFile == 0 ){` |
|    ! 0 | 5736 | `		return -1;` |
|      - | 5737 | `	}` |
|   3989 | 5738 | `	if( pPipe->iMode != 'r' ){` |
|      - | 5739 | `		/* Cannot read from a write-only pipe */` |
|    ! 0 | 5740 | `		return -1;` |
|      - | 5741 | `	}` |
|   3989 | 5742 | `	nRead = fread(pBuffer, 1, (size_t)nDatatoRead, pPipe->pFile);` |
|   3989 | 5743 | `	if( nRead == 0 ){` |
|   2773 | 5744 | `		if( feof(pPipe->pFile) ){` |
|   2773 | 5745 | `			return 0; /* EOF */` |
|      - | 5746 | `		}` |
|    ! 0 | 5747 | `		return -1; /* Error */` |
|      - | 5748 | `	}` |
|   1217 | 5749 | `	return (ph7_int64)nRead;` |
|   1995 | 5750 |  |
|      - | 5751 | `/*` |
...
|      - | 5793 | ` */` |
|   2680 | 5794 | `static int is_pipe_stream(const ph7_io_stream *pStream)` |
|      2 | 5795 |  |
|   2682 | 5796 | `	return pStream == &sPipe_Stream;` |
|      2 | 5797 |  |
|      - | 5798 | `/*` |
...
|      - | 5810 | ` */` |
|   2770 | 5811 | `static int PH7_builtin_popen(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 5812 |  |
|      - | 5813 | `	const char *zCommand, *zMode;` |
|      - | 5814 | `	pipe_private *pPipe;` |
|      - | 5815 | `	io_private *pDev;` |
|      - | 5816 | `	int nCmdLen, nModeLen;` |
|   2772 | 5817 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) \|\| !ph7_value_is_string(apArg[1]) ){` |
...
|   2772 | 5824 | `	zCommand = ph7_value_to_string(apArg[0], &nCmdLen);` |
|   2772 | 5825 | `	zMode = ph7_value_to_string(apArg[1], &nModeLen);` |
|   2772 | 5826 | `	if( nCmdLen < 1 ){` |
|    ! 0 | 5827 | `		ph7_context_throw_error(pCtx, PH7_CTX_WARNING, "Empty command");` |
|    ! 0 | 5828 | `		ph7_result_bool(pCtx, 0);` |
|    ! 0 | 5829 | `		return PH7_OK;` |
|      - | 5830 | `	}` |
|   2772 | 5831 | `	if( nModeLen < 1 \|\| (zMode[0] != 'r' && zMode[0] != 'w') ){` |
...
|      - | 5835 | `	}` |
|      - | 5836 | `	/* Open the pipe */` |
|   2772 | 5837 | `	pPipe = PipeOpen(pCtx->pVm, zCommand, zMode);` |
|   2772 | 5838 | `	if( pPipe == 0 ){` |
...
|   2772 | 5844 | `	pDev = (io_private *)ph7_context_alloc_chunk(pCtx, sizeof(io_private), TRUE, FALSE);` |
|   2772 | 5845 | `	if( pDev == 0 ){` |
...
|   2772 | 5852 | `	InitIOPrivate(pCtx->pVm, &sPipe_Stream, pDev);` |
|   2772 | 5853 | `	pDev->pHandle = pPipe;` |
|      - | 5854 | `	/* Return the io_private instance as a resource */` |
|   2772 | 5855 | `	ph7_result_resource(pCtx, pDev);` |
|   2772 | 5856 | `	return PH7_OK;` |
|   1387 | 5857 |  |
|      - | 5858 | `/*` |
...
|      - | 5866 | ` */` |
|   2680 | 5867 | `static int PH7_builtin_pclose(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 5868 |  |
|      - | 5869 | `	const ph7_io_stream *pStream;` |
|      - | 5870 | `	pipe_private *pPipe;` |
|      - | 5871 | `	io_private *pDev;` |
|      - | 5872 | `	int status;` |
|   2682 | 5873 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   2682 | 5880 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 5881 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   2682 | 5882 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   2682 | 5888 | `	pStream = pDev->pStream;` |
|   2682 | 5889 | `	if( pStream == 0 \|\| !is_pipe_stream(pStream) ){` |
...
|   2682 | 5895 | `	pPipe = (pipe_private *)pDev->pHandle;` |
|      - | 5896 | `	/* Close the pipe and get exit status */` |
|   2682 | 5897 | `	status = PipeClose(pPipe);` |
|      - | 5898 | `	/* Release the IO private structure */` |
|   2682 | 5899 | `	ReleaseIOPrivate(pCtx, pDev);` |
|      - | 5900 | `	/* Invalidate the resource handle */` |
|   2682 | 5901 | `	ph7_value_release(apArg[0]);` |
|      - | 5902 | `	/* Return the exit status */` |
|   2682 | 5903 | `	ph7_result_int(pCtx, status);` |
|   2682 | 5904 | `	return PH7_OK;` |
|   1342 | 5905 |  |
...
|      - | 5947 | ` */` |
|   2422 | 5948 | `PH7_PRIVATE sxi32 PH7_RegisterIORoutine(ph7_vm *pVm)` |
|      2 | 5949 |  |
|      - | 5950 | `	/*` |
...
|      - | 6047 | `	};` |
|   2424 | 6048 | `	const ph7_io_stream *pFileStream = 0;` |
|   2424 | 6049 | `	sxu32 n = 0;` |
|      - | 6050 | `	/* Register disk-related functions */` |
| 118680 | 6051 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVfsDiskFunc) ; ++n ){` |
| 116258 | 6052 | `		ph7_create_function(&(*pVm),aVfsDiskFunc[n].zName,aVfsDiskFunc[n].xFunc,(void *)pVm->pEngine->pVfs);` |
|  58130 | 6053 | `	}` |
|  87194 | 6054 | `	for( n = 0 ; n < SX_ARRAYSIZE(aIOFunc) ; ++n ){` |
|  84772 | 6055 | `		ph7_create_function(&(*pVm),aIOFunc[n].zName,aIOFunc[n].xFunc,pVm);` |
|  42387 | 6056 | `	}` |
|      - | 6057 | `#else` |
|      - | 6058 | `	SXUNUSED(pVm);` |
...
|      - | 6085 | `	};` |
|  41176 | 6086 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVfsHelperFunc) ; ++n ){` |
|  38754 | 6087 | `		ph7_create_function(&(*pVm),aVfsHelperFunc[n].zName,aVfsHelperFunc[n].xFunc,pVm);` |
|  19378 | 6088 | `	}` |
...
|   2422 | 6096 | `	pFileStream = &sUnixFileStream;` |
|      - | 6097 | `#endif` |
|      - | 6098 | `	/* Install the php:// stream */` |
|   2424 | 6099 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,&sPHP_Stream);` |
|   2424 | 6100 | `	if( pFileStream ){` |
|      - | 6101 | `		/* Install the file:// stream */` |
|   2424 | 6102 | `		ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,pFileStream);` |
|   1211 | 6103 | `	}` |
|      - | 6104 | `#endif /* PH7_DISABLE_DISK_IO */` |
|      - | 6105 |  |
|   2424 | 6106 | `	return SXRET_OK;` |
|      2 | 6107 |  |
|      - | 6108 | `/*` |
