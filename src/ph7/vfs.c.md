...
|      - |   65 | ` */` |
|  19732 |   66 | `static const char * VfsStrerror(int iErr)` |
|      5 |   67 | `{` |
|      - |   68 | `#if defined(_MSC_VER)` |
|      - |   69 | `#pragma warning(push)` |
|      - |   70 | `#pragma warning(disable:4996)` |
|      - |   71 | `#endif` |
|  19737 |   72 | `	return strerror(iErr);` |
...
|      - |   82 | ` */` |
|  19718 |   83 | `static void VfsThrowSysWarning(ph7_context *pCtx,const char *zPath)` |
|      5 |   84 | `{` |
|  29582 |   85 | `	PH7_VmThrowWarningFmt(pCtx->pVm,"%s(%s): %s",` |
|  19718 |   86 | `		ph7_function_name(pCtx),zPath ? zPath : "",VfsStrerror(errno));` |
|  19723 |   87 | `}` |
...
|      - |  101 | ` */` |
|  13342 |  102 | `static int PH7_vfs_chdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  103 | `{` |
|      - |  104 | `	const char *zPath;` |
|      - |  105 | `	ph7_vfs *pVfs;` |
|      - |  106 | `	int rc;` |
|  13347 |  107 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  108 | `		/* Missing/Invalid argument,return FALSE */` |
|      6 |  109 | `		ph7_result_bool(pCtx,0);` |
|      6 |  110 | `		return PH7_OK;` |
|      - |  111 | `	}` |
|      - |  112 | `	/* Point to the underlying vfs */` |
|  13343 |  113 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  13343 |  114 | `	if( pVfs == 0 \|\| pVfs->xChdir == 0 ){` |
...
|  13343 |  124 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  125 | `	/* Perform the requested operation */` |
|  13343 |  126 | `	errno = 0;` |
|  13343 |  127 | `	rc = pVfs->xChdir(zPath);` |
|  13343 |  128 | `	if( rc != PH7_OK ){` |
...
|      1 |  132 | `	}` |
|      - |  133 | `	/* IO return value */` |
|  13343 |  134 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  13343 |  135 | `	return PH7_OK;` |
|   6676 |  136 | `}` |
|      - |  137 | `/*` |
...
|      - |  259 | ` */` |
|   8730 |  260 | `static int PH7_vfs_is_dir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  261 | `{` |
|      - |  262 | `	const char *zPath;` |
|      - |  263 | `	ph7_vfs *pVfs;` |
|      - |  264 | `	int rc;` |
|   8735 |  265 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  266 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  267 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  268 | `		return PH7_OK;` |
|      - |  269 | `	}` |
|      - |  270 | `	/* Point to the underlying vfs */` |
|   8735 |  271 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   8735 |  272 | `	if( pVfs == 0 \|\| pVfs->xIsdir == 0 ){` |
...
|   8735 |  282 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  283 | `	/* Perform the requested operation */` |
|   8735 |  284 | `	rc = pVfs->xIsdir(zPath);` |
|      - |  285 | `	/* IO return value */` |
|   8735 |  286 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   8735 |  287 | `	return PH7_OK;` |
|   4370 |  288 | `}` |
|      - |  289 | `/*` |
...
|      - |  534 | ` */` |
|  33318 |  535 | `static int PH7_vfs_unlink(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  536 | `{` |
|      - |  537 | `	const char *zPath;` |
|      - |  538 | `	ph7_vfs *pVfs;` |
|      - |  539 | `	int rc;` |
|  33323 |  540 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  541 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  542 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  543 | `		return PH7_OK;` |
|      - |  544 | `	}` |
|      - |  545 | `	/* Point to the underlying vfs */` |
|  33323 |  546 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  33323 |  547 | `	if( pVfs == 0 \|\| pVfs->xUnlink == 0 ){` |
...
|  33323 |  557 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  558 | `	/* Perform the requested operation */` |
|  33323 |  559 | `	errno = 0;` |
|  33323 |  560 | `	rc = pVfs->xUnlink(zPath);` |
|  33323 |  561 | `	if( rc != PH7_OK ){` |
|  19721 |  562 | `		VfsThrowSysWarning(pCtx,zPath);` |
|   9858 |  563 | `	}` |
|      - |  564 | `	/* IO return value */` |
|  33323 |  565 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  33323 |  566 | `	return PH7_OK;` |
|  16664 |  567 | `}` |
|      - |  568 | `/*` |
...
|      - | 1003 | ` */` |
|   6722 | 1004 | `static int PH7_vfs_is_file(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1005 | `{` |
|      - | 1006 | `	const char *zPath;` |
|      - | 1007 | `	ph7_vfs *pVfs;` |
|      - | 1008 | `	int rc;` |
|   6727 | 1009 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   6727 | 1015 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   6727 | 1016 | `	if( pVfs == 0 \|\| pVfs->xIsfile == 0 ){` |
...
|   6727 | 1026 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - | 1027 | `	/* Perform the requested operation */` |
|   6727 | 1028 | `	rc = pVfs->xIsfile(zPath);` |
|      - | 1029 | `	/* IO return value */` |
|   6727 | 1030 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   6727 | 1031 | `	return PH7_OK;` |
|   3366 | 1032 | `}` |
|      - | 1033 | `/*` |
...
|      - | 1656 | ` */` |
|  13254 | 1657 | `static sxi32 ExtractPathInfo(const char *zPath,int nByte,path_info *pOut)` |
|      5 | 1658 | `{` |
|  13259 | 1659 | `	const char *zPtr,*zEnd = &zPath[nByte - 1];` |
|      - | 1660 | `	SyString *pCur;` |
|      - | 1661 | `	int c,d;` |
|  13259 | 1662 | `	c = d = '/';` |
...
|  13259 | 1667 | `	SyZero(pOut,sizeof(path_info));` |
|      - | 1668 | `	/* Handle special case */` |
|  13259 | 1669 | `	if( nByte == sizeof(char) && ( (int)zPath[0] == c \|\| (int)zPath[0] == d ) ){` |
...
| 357310 | 1678 | `	while( zEnd > zPath && ( (int)zEnd[0] != c && (int)zEnd[0] != d ) ){` |
| 337429 | 1679 | `		zEnd--;` |
|      5 | 1680 | `	}` |
|  13259 | 1681 | `	zPtr = (zEnd > zPath) ? &zEnd[1] : zPath;` |
|  13259 | 1682 | `	zEnd = &zPath[nByte];` |
|      - | 1683 | `	/* dirname */` |
|  13259 | 1684 | `	pCur = &pOut->sDir;` |
|  13259 | 1685 | `	SyStringInitFromBuf(pCur,zPath,zPtr-zPath);` |
|  13259 | 1686 | `	if( pCur->nByte > 1 ){` |
|  26513 | 1687 | `		SyStringTrimTrailingChar(pCur,'/');` |
|      - | 1688 | `#ifdef __WINNT__` |
|      5 | 1689 | `		SyStringTrimTrailingChar(pCur,'\\');` |
|      - | 1690 | `#endif` |
|   6632 | 1691 | `	}else if( (int)zPath[0] == c \|\| (int)zPath[0] == d ){` |
...
|  13259 | 1699 | `	pCur = &pOut->sBasename;` |
|  13259 | 1700 | `	SyStringInitFromBuf(pCur,zPtr,zEnd-zPtr);` |
|  13259 | 1701 | `	SyStringTrimLeadingChar(pCur,'/');` |
|      - | 1702 | `#ifdef __WINNT__` |
|      5 | 1703 | `	SyStringTrimLeadingChar(pCur,'\\');` |
|      - | 1704 | `#endif` |
|  13259 | 1705 | `	SyStringDupPtr(&pOut->sFilename,pCur);` |
|  13259 | 1706 | `	if( pCur->nByte > 0 ){` |
|      - | 1707 | `		/* extension */` |
|  13259 | 1708 | `		zEnd--;` |
|  66269 | 1709 | `		while( zEnd > pCur->zString /*basename*/ && zEnd[0] != '.' ){` |
|  53015 | 1710 | `			zEnd--;` |
|      5 | 1711 | `		}` |
|  13259 | 1712 | `		if( zEnd > pCur->zString ){` |
|  13257 | 1713 | `			zEnd++; /* Jump leading dot */` |
|  13257 | 1714 | `			SyStringInitFromBuf(&pOut->sExtension,zEnd,&zPath[nByte]-zEnd);` |
|      - | 1715 | `			/* Fix filename */` |
|  13257 | 1716 | `			pCur = &pOut->sFilename;` |
|  13257 | 1717 | `			if( pCur->nByte > SyStringLength(&pOut->sExtension) ){` |
|  13257 | 1718 | `				pCur->nByte -= 1 + SyStringLength(&pOut->sExtension);` |
|   6626 | 1719 | `			}` |
|   6626 | 1720 | `		}` |
|   6627 | 1721 | `	}` |
|  13259 | 1722 | `	return SXRET_OK;` |
|   6632 | 1723 | `}` |
|      - | 1724 | `/*` |
...
|      - | 1727 | ` */` |
|  13254 | 1728 | `static int PH7_builtin_pathinfo(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1729 | `{` |
|      - | 1730 | `	const char *zPath;` |
|      - | 1731 | `	path_info sInfo;` |
|      - | 1732 | `	SyString *pComp;` |
|      - | 1733 | `	int iLen;` |
|  13259 | 1734 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  13259 | 1740 | `	zPath = ph7_value_to_string(apArg[0],&iLen);` |
|  13259 | 1741 | `	if( iLen < 1 ){` |
|      - | 1742 | `		/* Empty string */` |
|    ! 0 | 1743 | `		ph7_result_string(pCtx,"",0);` |
|    ! 0 | 1744 | `		return PH7_OK;` |
|      - | 1745 | `	}` |
|      - | 1746 | `	/* Extract path info */` |
|  13259 | 1747 | `	ExtractPathInfo(zPath,iLen,&sInfo);` |
|  19885 | 1748 | `	if( nArg > 1 && ph7_value_is_int(apArg[1]) ){` |
|      - | 1749 | `		/* Return path component */` |
|  13257 | 1750 | `		int nComp = ph7_value_to_int(apArg[1]);` |
|  13257 | 1751 | `		switch(nComp){` |
...
|      - | 1768 | `			}` |
|      3 | 1769 | `			break;` |
|   3314 | 1770 | `		case 3: /*PATHINFO_EXTENSION*/` |
|   6633 | 1771 | `			pComp = &sInfo.sExtension;` |
|   6633 | 1772 | `			if( pComp->nByte > 0 ){` |
|   6631 | 1773 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   3318 | 1774 | `			}else{` |
|      - | 1775 | `				/* Expand the empty string */` |
|      3 | 1776 | `				ph7_result_string(pCtx,"",0);` |
|      - | 1777 | `			}` |
|   6633 | 1778 | `			break;` |
|   3310 | 1779 | `		case 4: /*PATHINFO_FILENAME*/` |
|   6625 | 1780 | `			pComp = &sInfo.sFilename;` |
|   6625 | 1781 | `			if( pComp->nByte > 0 ){` |
|   6625 | 1782 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   3315 | 1783 | `			}else{` |
...
|      - | 3024 | ` */` |
|  30106 | 3025 | `PH7_PRIVATE void * PH7_StreamOpenHandle(ph7_vm *pVm,const ph7_io_stream *pStream,const char *zFile,` |
|      - | 3026 | `	int iFlags,int use_include,ph7_value *pResource,int bPushInclude,int *pNew)` |
|      5 | 3027 | `{` |
|  30111 | 3028 | `	void *pHandle = 0; /* cc warning */` |
|      - | 3029 | `	SyString sFile;` |
|      - | 3030 | `	ph7_value sDummy;` |
|      - | 3031 | `	int rc;` |
|  30111 | 3032 | `	if( pStream == 0 ){` |
|      - | 3033 | `		/* No such stream device */` |
|    ! 0 | 3034 | `		return 0;` |
|      - | 3035 | `	}` |
|  30111 | 3036 | `	if( pResource == 0 ){` |
...
|  30091 | 3042 | `		PH7_MemObjInit(pVm,&sDummy);` |
|  30091 | 3043 | `		pResource = &sDummy;` |
|  15043 | 3044 | `	}` |
|  30111 | 3045 | `	SyStringInitFromBuf(&sFile,zFile,SyStrlen(zFile));` |
|  30111 | 3046 | `	if( use_include ){` |
|   9616 | 3047 | `		if(	sFile.zString[0] == '/' \|\|` |
|      - | 3048 | `#ifdef __WINNT__` |
|      - | 3049 | `			(sFile.nByte > 2 && sFile.zString[1] == ':' && (sFile.zString[2] == '\\' \|\| sFile.zString[2] == '/') ) \|\|` |
|      - | 3050 | `#endif` |
|   9594 | 3051 | `			(sFile.nByte > 1 && sFile.zString[0] == '.' && sFile.zString[1] == '/') \|\|` |
|   9590 | 3052 | `			(sFile.nByte > 2 && sFile.zString[0] == '.' && sFile.zString[1] == '.' && sFile.zString[2] == '/') ){` |
...
|   9594 | 3064 | `			SyBlobInit(&sWorker,&pVm->sAllocator);` |
|      - | 3065 | `			/* Build a path from the set of include path */` |
|   9594 | 3066 | `			SySetResetCursor(&pVm->aPaths);` |
|   9594 | 3067 | `			rc = SXERR_IO;` |
|   9600 | 3068 | `			while( SXRET_OK == SySetGetNextEntry(&pVm->aPaths,(void **)&pPath) ){` |
|      - | 3069 | `				/* Build full path */` |
|   9594 | 3070 | `				SyBlobFormat(&sWorker,"%z%c%z",pPath,c,&sFile);` |
|      - | 3071 | `				/* Append null terminator */` |
|   9594 | 3072 | `				if( SXRET_OK != SyBlobNullAppend(&sWorker) ){` |
|    ! 0 | 3073 | `					continue;` |
|      - | 3074 | `				}` |
|      - | 3075 | `				/* Try to open the file */` |
|   9594 | 3076 | `				rc = pStream->xOpen((const char *)SyBlobData(&sWorker),iFlags,pResource,&pHandle);` |
|   9594 | 3077 | `				if( rc == PH7_OK ){` |
|   9588 | 3078 | `					if( bPushInclude ){` |
|      - | 3079 | `						/* Mark as included */` |
|   9588 | 3080 | `						PH7_VmPushFilePath(pVm,(const char *)SyBlobData(&sWorker),SyBlobLength(&sWorker),FALSE,pNew);` |
|   4792 | 3081 | `					}` |
|   9588 | 3082 | `					break;` |
|      - | 3083 | `				}` |
...
|      2 | 3087 | `			}` |
|   9594 | 3088 | `			SyBlobRelease(&sWorker);` |
|      - | 3089 | `		}` |
|   9620 | 3090 | `		if( rc == PH7_OK ){` |
|   9614 | 3091 | `			if( bPushInclude ){` |
|      - | 3092 | `				/* Mark as included */` |
|   9614 | 3093 | `				PH7_VmPushFilePath(pVm,sFile.zString,sFile.nByte,FALSE,pNew);` |
|   4805 | 3094 | `			}` |
|   4805 | 3095 | `		}` |
|   4812 | 3096 | `	}else{` |
|      - | 3097 | `		/* Open the URI direcly */` |
|  20495 | 3098 | `		rc = pStream->xOpen(zFile,iFlags,pResource,&pHandle);` |
|      - | 3099 | `	}` |
|  30111 | 3100 | `	if( rc != PH7_OK ){` |
|      - | 3101 | `		/* IO error */` |
|     16 | 3102 | `		return 0;` |
|      - | 3103 | `	}` |
|      - | 3104 | `	/* Return the file handle */` |
|  30099 | 3105 | `	return pHandle;` |
|  15058 | 3106 | `}` |
|      - | 3107 | `/*` |
...
|      - | 3111 | ` */` |
|   9604 | 3112 | `PH7_PRIVATE sxi32 PH7_StreamReadWholeFile(void *pHandle,const ph7_io_stream *pStream,SyBlob *pOut)` |
|      4 | 3113 | `{` |
...
|   9604 | 3118 | `	for(;;){` |
|  19212 | 3119 | `		nRead = pStream->xRead(pHandle,zBuf,sizeof(zBuf));` |
|  19212 | 3120 | `		if( nRead < 1 ){` |
|      - | 3121 | `			/* EOF or IO error */` |
|   9608 | 3122 | `			break;` |
|      - | 3123 | `		}` |
|      - | 3124 | `		/* Append contents */` |
|   9608 | 3125 | `		rc = SyBlobAppend(pOut,zBuf,(sxu32)nRead);` |
|   9608 | 3126 | `		if( rc != SXRET_OK ){` |
|    ! 0 | 3127 | `			break;` |
|      - | 3128 | `		}` |
|      4 | 3129 | `	}` |
|   9608 | 3130 | `	return SyBlobLength(pOut) > 0 ? SXRET_OK : -1;` |
|      4 | 3131 | `}` |
|      - | 3132 | `/*` |
|      - | 3133 | ` * Close an open IO stream handle [i.e local file/URI..].` |
|      - | 3134 | ` */` |
|  30192 | 3135 | `PH7_PRIVATE void PH7_StreamCloseHandle(const ph7_io_stream *pStream,void *pHandle)` |
|      5 | 3136 | `{` |
|  30197 | 3137 | `	if( pStream->xClose ){` |
|  30197 | 3138 | `		pStream->xClose(pHandle);` |
|  15096 | 3139 | `	}` |
|  30197 | 3140 | `}` |
|      - | 3141 | `/*` |
...
|      - | 3519 | ` */` |
|   8728 | 3520 | `static int PH7_builtin_readdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3521 | `{` |
|      - | 3522 | `	const ph7_io_stream *pStream;` |
|      - | 3523 | `	io_private *pDev;` |
|      - | 3524 | `	int rc;` |
|   8733 | 3525 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   8733 | 3532 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3533 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   8733 | 3534 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   8733 | 3541 | `	pStream = pDev->pStream;` |
|   8733 | 3542 | `	if( pStream == 0  \|\| pStream->xReadDir == 0 ){` |
...
|      - | 3549 | `	}` |
|   8733 | 3550 | `	ph7_result_bool(pCtx,0);` |
|      - | 3551 | `	/* Perform the requested operation */` |
|   8733 | 3552 | `	rc = pStream->xReadDir(pDev->pHandle,pCtx);` |
|   8733 | 3553 | `	if( rc != PH7_OK ){` |
|      - | 3554 | `		/* Return FALSE */` |
|   1055 | 3555 | `		ph7_result_bool(pCtx,0);` |
|    525 | 3556 | `	}` |
|   8733 | 3557 | `	return PH7_OK;` |
|   4369 | 3558 | `}` |
|      - | 3559 | `/*` |
...
|      - | 3809 | ` */` |
|   6672 | 3810 | `static int PH7_builtin_file_get_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3811 | `{` |
|      - | 3812 | `	const ph7_io_stream *pStream;` |
|      - | 3813 | `	ph7_int64 n,nRead,nMaxlen;` |
|   6677 | 3814 | `	int use_include  = FALSE;` |
|      - | 3815 | `	const char *zFile;` |
|      - | 3816 | `	char zBuf[8192];` |
|      - | 3817 | `	void *pHandle;` |
|      - | 3818 | `	int nLen;` |
|      - | 3819 |  |
|   6677 | 3820 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   6677 | 3827 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3828 | `	/* Point to the target IO stream device */` |
|   6677 | 3829 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|   6677 | 3830 | `	if( pStream == 0 ){` |
...
|   6677 | 3840 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,PH7_IO_OPEN_RDONLY,use_include,nArg > 2 ? apArg[2] : 0,FALSE,0);` |
|   6677 | 3841 | `	if( pHandle == 0 ){` |
...
|   6677 | 3861 | `	nRead = 0;` |
|   6670 | 3862 | `	for(;;){` |
|  20018 | 3863 | `		n = pStream->xRead(pHandle,zBuf,` |
|   6673 | 3864 | `			(nMaxlen > 0 && (nMaxlen < (ph7_int64)sizeof(zBuf))) ? nMaxlen : (ph7_int64)sizeof(zBuf));` |
|  13345 | 3865 | `		if( n < 1 ){` |
|      - | 3866 | `			/* EOF or IO error,break immediately */` |
|   6675 | 3867 | `			break;` |
|      - | 3868 | `		}` |
|      - | 3869 | `		/* Append data */` |
|   6675 | 3870 | `		ph7_result_string(pCtx,zBuf,(int)n);` |
|      - | 3871 | `		/* Increment read counter */` |
|   6675 | 3872 | `		nRead += n;` |
|   6675 | 3873 | `		if( nMaxlen > 0 && nRead >= nMaxlen ){` |
|      - | 3874 | `			/* Read limit reached */` |
|      3 | 3875 | `			break;` |
|      - | 3876 | `		}` |
|      5 | 3877 | `	}` |
|      - | 3878 | `	/* Close the stream */` |
|   6677 | 3879 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|      - | 3880 | `	/* Check if we have read something */` |
|   6677 | 3881 | `	if( ph7_context_result_buf_length(pCtx) < 1 ){` |
|      - | 3882 | `		/* Nothing read,return FALSE */` |
|      3 | 3883 | `		ph7_result_bool(pCtx,0);` |
|      1 | 3884 | `	}` |
|   6677 | 3885 | `	return PH7_OK;` |
|   3341 | 3886 | `}` |
|      - | 3887 | `/*` |
...
|      - | 3905 | ` */` |
|  13584 | 3906 | `static int PH7_builtin_file_put_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3907 | `{` |
|  13589 | 3908 | `	int use_include  = FALSE;` |
...
|      - | 3915 | `	int nLen;` |
|      - | 3916 |  |
|  13589 | 3917 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  13589 | 3924 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3925 | `	/* Point to the target IO stream device */` |
|  13589 | 3926 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|  13589 | 3927 | `	if( pStream == 0 ){` |
...
|      - | 3931 | `	}` |
|      - | 3932 | `	/* Data to write */` |
|  13589 | 3933 | `	zData = ph7_value_to_string(apArg[1],&nLen);` |
|      - | 3934 | `	/* Try to open the file in read-write mode */` |
|  13589 | 3935 | `	iOpenFlags = PH7_IO_OPEN_CREATE\|PH7_IO_OPEN_RDWR\|PH7_IO_OPEN_TRUNC;` |
|      - | 3936 | `	/* Extract the flags */` |
|  13589 | 3937 | `	iFlags = 0;` |
|  13589 | 3938 | `	if( nArg > 2 ){` |
...
|    ! 0 | 3950 | `		}` |
|    ! 0 | 3951 | `	}` |
|  20381 | 3952 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,iOpenFlags,use_include,` |
|   6792 | 3953 | `		nArg > 3 ? apArg[3] : 0,FALSE,FALSE);` |
|  13589 | 3954 | `	if( pHandle == 0 ){` |
|    ! 0 | 3955 | `		VfsThrowOpenWarning(pCtx,zFile);` |
|    ! 0 | 3956 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 3957 | `		return PH7_OK;` |
|      - | 3958 | `	}` |
|  13589 | 3959 | `	if( nLen < 1 ){` |
...
|  13583 | 3989 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|  13583 | 3990 | `	return PH7_OK;` |
|   6797 | 3991 | `}` |
|      - | 3992 | `/*` |
