...
|      - |   67 | ` */` |
|  19672 |   68 | `PH7_PRIVATE const char * VfsStrerror(int iErr)` |
|      5 |   69 | `{` |
|      - |   70 | `#if defined(_MSC_VER)` |
|      - |   71 | `#pragma warning(push)` |
|      - |   72 | `#pragma warning(disable:4996)` |
|      - |   73 | `#endif` |
|  19677 |   74 | `	return strerror(iErr);` |
...
|      - |   84 | ` */` |
|  19650 |   85 | `static void VfsThrowSysWarning(ph7_context *pCtx,const char *zPath)` |
|      5 |   86 | `{` |
|  29480 |   87 | `	PH7_VmThrowWarningFmt(pCtx->pVm,"%s(%s): %s",` |
|  19650 |   88 | `		ph7_function_name(pCtx),zPath ? zPath : "",VfsStrerror(errno));` |
|  19655 |   89 | `}` |
...
|      - |  103 | ` */` |
|  12920 |  104 | `static int PH7_vfs_chdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  105 | `{` |
|      - |  106 | `	const char *zPath;` |
|      - |  107 | `	ph7_vfs *pVfs;` |
|      - |  108 | `	int rc;` |
|  12925 |  109 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  110 | `		/* Missing/Invalid argument,return FALSE */` |
|      6 |  111 | `		ph7_result_bool(pCtx,0);` |
|      6 |  112 | `		return PH7_OK;` |
|      - |  113 | `	}` |
|      - |  114 | `	/* Point to the underlying vfs */` |
|  12921 |  115 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  12921 |  116 | `	if( pVfs == 0 \|\| pVfs->xChdir == 0 ){` |
...
|  12921 |  126 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  127 | `	/* Perform the requested operation */` |
|  12921 |  128 | `	errno = 0;` |
|  12921 |  129 | `	rc = pVfs->xChdir(zPath);` |
|  12921 |  130 | `	if( rc != PH7_OK ){` |
...
|      1 |  134 | `	}` |
|      - |  135 | `	/* IO return value */` |
|  12921 |  136 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  12921 |  137 | `	return PH7_OK;` |
|   6465 |  138 | `}` |
|      - |  139 | `/*` |
...
|  19649 |  564 | `		VfsThrowSysWarning(pCtx,zPath);` |
|   9822 |  565 | `	}` |
|      - |  566 | `	/* IO return value */` |
