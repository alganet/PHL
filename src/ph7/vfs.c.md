...
|      - |   65 | ` */` |
|  12686 |   66 | `static int PH7_vfs_chdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 |   67 |  |
|      - |   68 | `	const char *zPath;` |
|      - |   69 | `	ph7_vfs *pVfs;` |
|      - |   70 | `	int rc;` |
|  12688 |   71 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |   72 | `		/* Missing/Invalid argument,return FALSE */` |
|      8 |   73 | `		ph7_result_bool(pCtx,0);` |
|      8 |   74 | `		return PH7_OK;` |
|      - |   75 | `	}` |
|      - |   76 | `	/* Point to the underlying vfs */` |
|  12682 |   77 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  12682 |   78 | `	if( pVfs == 0 \|\| pVfs->xChdir == 0 ){` |
...
|  12682 |   88 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |   89 | `	/* Perform the requested operation */` |
|  12682 |   90 | `	rc = pVfs->xChdir(zPath);` |
|      - |   91 | `	/* IO return value */` |
|  12682 |   92 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  12682 |   93 | `	return PH7_OK;` |
|   6345 |   94 |  |
|      - |   95 | `/*` |
...
|      - |  213 | ` */` |
|   7442 |  214 | `static int PH7_vfs_is_dir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 |  215 |  |
|      - |  216 | `	const char *zPath;` |
|      - |  217 | `	ph7_vfs *pVfs;` |
|      - |  218 | `	int rc;` |
|   7444 |  219 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  220 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  221 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  222 | `		return PH7_OK;` |
|      - |  223 | `	}` |
|      - |  224 | `	/* Point to the underlying vfs */` |
|   7444 |  225 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   7444 |  226 | `	if( pVfs == 0 \|\| pVfs->xIsdir == 0 ){` |
...
|   7444 |  236 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  237 | `	/* Perform the requested operation */` |
|   7444 |  238 | `	rc = pVfs->xIsdir(zPath);` |
|      - |  239 | `	/* IO return value */` |
|   7444 |  240 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   7444 |  241 | `	return PH7_OK;` |
|   3723 |  242 |  |
|      - |  243 | `/*` |
...
|      - |  476 | ` */` |
|  28046 |  477 | `static int PH7_vfs_unlink(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 |  478 |  |
|      - |  479 | `	const char *zPath;` |
|      - |  480 | `	ph7_vfs *pVfs;` |
|      - |  481 | `	int rc;` |
|  28048 |  482 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  483 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  484 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  485 | `		return PH7_OK;` |
|      - |  486 | `	}` |
|      - |  487 | `	/* Point to the underlying vfs */` |
|  28048 |  488 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  28048 |  489 | `	if( pVfs == 0 \|\| pVfs->xUnlink == 0 ){` |
...
|  28048 |  499 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  500 | `	/* Perform the requested operation */` |
|  28048 |  501 | `	rc = pVfs->xUnlink(zPath);` |
|      - |  502 | `	/* IO return value */` |
|  28048 |  503 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  28048 |  504 | `	return PH7_OK;` |
|  14025 |  505 |  |
|      - |  506 | `/*` |
...
|      - |  907 | ` */` |
|   5582 |  908 | `static int PH7_vfs_is_file(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 |  909 |  |
|      - |  910 | `	const char *zPath;` |
|      - |  911 | `	ph7_vfs *pVfs;` |
|      - |  912 | `	int rc;` |
|   5584 |  913 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  914 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  915 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  916 | `		return PH7_OK;` |
|      - |  917 | `	}` |
|      - |  918 | `	/* Point to the underlying vfs */` |
|   5584 |  919 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   5584 |  920 | `	if( pVfs == 0 \|\| pVfs->xIsfile == 0 ){` |
...
|   5584 |  930 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  931 | `	/* Perform the requested operation */` |
|   5584 |  932 | `	rc = pVfs->xIsfile(zPath);` |
|      - |  933 | `	/* IO return value */` |
|   5584 |  934 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   5584 |  935 | `	return PH7_OK;` |
|   2793 |  936 |  |
|      - |  937 | `/*` |
...
|      - | 1554 | ` */` |
|  11158 | 1555 | `static sxi32 ExtractPathInfo(const char *zPath,int nByte,path_info *pOut)` |
|      2 | 1556 |  |
|  11160 | 1557 | `	const char *zPtr,*zEnd = &zPath[nByte - 1];` |
|      - | 1558 | `	SyString *pCur;` |
|      - | 1559 | `	int c,d;` |
|  11160 | 1560 | `	c = d = '/';` |
...
|  11160 | 1565 | `	SyZero(pOut,sizeof(path_info));` |
|      - | 1566 | `	/* Handle special case */` |
|  11160 | 1567 | `	if( nByte == sizeof(char) && ( (int)zPath[0] == c \|\| (int)zPath[0] == d ) ){` |
...
| 298455 | 1576 | `	while( zEnd > zPath && ( (int)zEnd[0] != c && (int)zEnd[0] != d ) ){` |
| 281718 | 1577 | `		zEnd--;` |
|      2 | 1578 | `	}` |
|  11160 | 1579 | `	zPtr = (zEnd > zPath) ? &zEnd[1] : zPath;` |
|  11160 | 1580 | `	zEnd = &zPath[nByte];` |
|      - | 1581 | `	/* dirname */` |
|  11160 | 1582 | `	pCur = &pOut->sDir;` |
|  11160 | 1583 | `	SyStringInitFromBuf(pCur,zPath,zPtr-zPath);` |
|  11160 | 1584 | `	if( pCur->nByte > 1 ){` |
|  22318 | 1585 | `		SyStringTrimTrailingChar(pCur,'/');` |
|      - | 1586 | `#ifdef __WINNT__` |
|      2 | 1587 | `		SyStringTrimTrailingChar(pCur,'\\');` |
|      - | 1588 | `#endif` |
|   5581 | 1589 | `	}else if( (int)zPath[0] == c \|\| (int)zPath[0] == d ){` |
...
|  11160 | 1597 | `	pCur = &pOut->sBasename;` |
|  11160 | 1598 | `	SyStringInitFromBuf(pCur,zPtr,zEnd-zPtr);` |
|  11160 | 1599 | `	SyStringTrimLeadingChar(pCur,'/');` |
|      - | 1600 | `#ifdef __WINNT__` |
|      2 | 1601 | `	SyStringTrimLeadingChar(pCur,'\\');` |
|      - | 1602 | `#endif` |
|  11160 | 1603 | `	SyStringDupPtr(&pOut->sFilename,pCur);` |
|  11160 | 1604 | `	if( pCur->nByte > 0 ){` |
|      - | 1605 | `		/* extension */` |
|  11160 | 1606 | `		zEnd--;` |
|  55786 | 1607 | `		while( zEnd > pCur->zString /*basename*/ && zEnd[0] != '.' ){` |
|  44628 | 1608 | `			zEnd--;` |
|      2 | 1609 | `		}` |
|  11160 | 1610 | `		if( zEnd > pCur->zString ){` |
|  11158 | 1611 | `			zEnd++; /* Jump leading dot */` |
|  11158 | 1612 | `			SyStringInitFromBuf(&pOut->sExtension,zEnd,&zPath[nByte]-zEnd);` |
|      - | 1613 | `			/* Fix filename */` |
|  11158 | 1614 | `			pCur = &pOut->sFilename;` |
|  11158 | 1615 | `			if( pCur->nByte > SyStringLength(&pOut->sExtension) ){` |
|  11158 | 1616 | `				pCur->nByte -= 1 + SyStringLength(&pOut->sExtension);` |
|   5578 | 1617 | `			}` |
|   5578 | 1618 | `		}` |
|   5579 | 1619 | `	}` |
|  11160 | 1620 | `	return SXRET_OK;` |
|   5581 | 1621 |  |
|      - | 1622 | `/*` |
...
|      - | 1625 | ` */` |
|  11158 | 1626 | `static int PH7_builtin_pathinfo(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 1627 |  |
|      - | 1628 | `	const char *zPath;` |
|      - | 1629 | `	path_info sInfo;` |
|      - | 1630 | `	SyString *pComp;` |
|      - | 1631 | `	int iLen;` |
|  11160 | 1632 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  11160 | 1638 | `	zPath = ph7_value_to_string(apArg[0],&iLen);` |
|  11160 | 1639 | `	if( iLen < 1 ){` |
|      - | 1640 | `		/* Empty string */` |
|    ! 0 | 1641 | `		ph7_result_string(pCtx,"",0);` |
|    ! 0 | 1642 | `		return PH7_OK;` |
|      - | 1643 | `	}` |
|      - | 1644 | `	/* Extract path info */` |
|  11160 | 1645 | `	ExtractPathInfo(zPath,iLen,&sInfo);` |
|  16738 | 1646 | `	if( nArg > 1 && ph7_value_is_int(apArg[1]) ){` |
|      - | 1647 | `		/* Return path component */` |
|  11158 | 1648 | `		int nComp = ph7_value_to_int(apArg[1]);` |
|  11158 | 1649 | `		switch(nComp){` |
...
|      - | 1666 | `			}` |
|      3 | 1667 | `			break;` |
|   2790 | 1668 | `		case 3: /*PATHINFO_EXTENSION*/` |
|   5582 | 1669 | `			pComp = &sInfo.sExtension;` |
|   5582 | 1670 | `			if( pComp->nByte > 0 ){` |
|   5580 | 1671 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   2791 | 1672 | `			}else{` |
|      - | 1673 | `				/* Expand the empty string */` |
|      3 | 1674 | `				ph7_result_string(pCtx,"",0);` |
|      - | 1675 | `			}` |
|   5582 | 1676 | `			break;` |
|   2786 | 1677 | `		case 4: /*PATHINFO_FILENAME*/` |
|   5574 | 1678 | `			pComp = &sInfo.sFilename;` |
|   5574 | 1679 | `			if( pComp->nByte > 0 ){` |
|   5574 | 1680 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   2788 | 1681 | `			}else{` |
...
|   5148 | 2808 | `	zPtr = zIn;` |
| 341106 | 2809 | `	while( zIn < zEnd ){` |
| 341032 | 2810 | `		if( zIn[0] == '\n' ){` |
|      - | 2811 | `			/* Line found */` |
...
|      - | 2904 | ` */` |
|  28192 | 2905 | `PH7_PRIVATE void * PH7_StreamOpenHandle(ph7_vm *pVm,const ph7_io_stream *pStream,const char *zFile,` |
|      - | 2906 | `	int iFlags,int use_include,ph7_value *pResource,int bPushInclude,int *pNew)` |
|      2 | 2907 |  |
|  28194 | 2908 | `	void *pHandle = 0; /* cc warning */` |
|      - | 2909 | `	SyString sFile;` |
|      - | 2910 | `	int rc;` |
|  28194 | 2911 | `	if( pStream == 0 ){` |
|      - | 2912 | `		/* No such stream device */` |
|    ! 0 | 2913 | `		return 0;` |
|      - | 2914 | `	}` |
|  28194 | 2915 | `	SyStringInitFromBuf(&sFile,zFile,SyStrlen(zFile));` |
|  28194 | 2916 | `	if( use_include ){` |
|   9592 | 2917 | `		if(	sFile.zString[0] == '/' \|\|` |
|      - | 2918 | `#ifdef __WINNT__` |
|      - | 2919 | `			(sFile.nByte > 2 && sFile.zString[1] == ':' && (sFile.zString[2] == '\\' \|\| sFile.zString[2] == '/') ) \|\|` |
|      - | 2920 | `#endif` |
|   9576 | 2921 | `			(sFile.nByte > 1 && sFile.zString[0] == '.' && sFile.zString[1] == '/') \|\|` |
|   9574 | 2922 | `			(sFile.nByte > 2 && sFile.zString[0] == '.' && sFile.zString[1] == '.' && sFile.zString[2] == '/') ){` |
...
|   9576 | 2934 | `			SyBlobInit(&sWorker,&pVm->sAllocator);` |
|      - | 2935 | `			/* Build a path from the set of include path */` |
|   9576 | 2936 | `			SySetResetCursor(&pVm->aPaths);` |
|   9576 | 2937 | `			rc = SXERR_IO;` |
|   9582 | 2938 | `			while( SXRET_OK == SySetGetNextEntry(&pVm->aPaths,(void **)&pPath) ){` |
|      - | 2939 | `				/* Build full path */` |
|   9576 | 2940 | `				SyBlobFormat(&sWorker,"%z%c%z",pPath,c,&sFile);` |
|      - | 2941 | `				/* Append null terminator */` |
|   9576 | 2942 | `				if( SXRET_OK != SyBlobNullAppend(&sWorker) ){` |
|    ! 0 | 2943 | `					continue;` |
|      - | 2944 | `				}` |
|      - | 2945 | `				/* Try to open the file */` |
|   9576 | 2946 | `				rc = pStream->xOpen((const char *)SyBlobData(&sWorker),iFlags,pResource,&pHandle);` |
|   9576 | 2947 | `				if( rc == PH7_OK ){` |
|   9570 | 2948 | `					if( bPushInclude ){` |
|      - | 2949 | `						/* Mark as included */` |
|   9570 | 2950 | `						PH7_VmPushFilePath(pVm,(const char *)SyBlobData(&sWorker),SyBlobLength(&sWorker),FALSE,pNew);` |
|   4784 | 2951 | `					}` |
|   9570 | 2952 | `					break;` |
|      - | 2953 | `				}` |
...
|      2 | 2957 | `			}` |
|   9576 | 2958 | `			SyBlobRelease(&sWorker);` |
|      - | 2959 | `		}` |
|   9594 | 2960 | `		if( rc == PH7_OK ){` |
|   9588 | 2961 | `			if( bPushInclude ){` |
|      - | 2962 | `				/* Mark as included */` |
|   9588 | 2963 | `				PH7_VmPushFilePath(pVm,sFile.zString,sFile.nByte,FALSE,pNew);` |
|   4793 | 2964 | `			}` |
|   4793 | 2965 | `		}` |
|   4798 | 2966 | `	}else{` |
|      - | 2967 | `		/* Open the URI direcly */` |
|  18602 | 2968 | `		rc = pStream->xOpen(zFile,iFlags,pResource,&pHandle);` |
|      - | 2969 | `	}` |
|  28194 | 2970 | `	if( rc != PH7_OK ){` |
|      - | 2971 | `		/* IO error */` |
|     14 | 2972 | `		return 0;` |
|      - | 2973 | `	}` |
|      - | 2974 | `	/* Return the file handle */` |
|  28182 | 2975 | `	return pHandle;` |
|  14098 | 2976 |  |
|      - | 2977 | `/*` |
...
|      - | 2981 | ` */` |
|   9580 | 2982 | `PH7_PRIVATE sxi32 PH7_StreamReadWholeFile(void *pHandle,const ph7_io_stream *pStream,SyBlob *pOut)` |
|      2 | 2983 |  |
...
|   9580 | 2988 | `	for(;;){` |
|  19162 | 2989 | `		nRead = pStream->xRead(pHandle,zBuf,sizeof(zBuf));` |
|  19162 | 2990 | `		if( nRead < 1 ){` |
|      - | 2991 | `			/* EOF or IO error */` |
|   9582 | 2992 | `			break;` |
|      - | 2993 | `		}` |
|      - | 2994 | `		/* Append contents */` |
|   9582 | 2995 | `		rc = SyBlobAppend(pOut,zBuf,(sxu32)nRead);` |
|   9582 | 2996 | `		if( rc != SXRET_OK ){` |
|    ! 0 | 2997 | `			break;` |
|      - | 2998 | `		}` |
|      2 | 2999 | `	}` |
|   9582 | 3000 | `	return SyBlobLength(pOut) > 0 ? SXRET_OK : -1;` |
|      2 | 3001 |  |
|      - | 3002 | `/*` |
|      - | 3003 | ` * Close an open IO stream handle [i.e local file/URI..].` |
|      - | 3004 | ` */` |
|  28260 | 3005 | `PH7_PRIVATE void PH7_StreamCloseHandle(const ph7_io_stream *pStream,void *pHandle)` |
|      2 | 3006 |  |
|  28262 | 3007 | `	if( pStream->xClose ){` |
|  28262 | 3008 | `		pStream->xClose(pHandle);` |
|  14130 | 3009 | `	}` |
|  28262 | 3010 |  |
|      - | 3011 | `/*` |
...
|      - | 3389 | ` */` |
|   7440 | 3390 | `static int PH7_builtin_readdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 3391 |  |
|      - | 3392 | `	const ph7_io_stream *pStream;` |
|      - | 3393 | `	io_private *pDev;` |
|      - | 3394 | `	int rc;` |
|   7442 | 3395 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   7442 | 3402 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3403 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   7442 | 3404 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   7442 | 3411 | `	pStream = pDev->pStream;` |
|   7442 | 3412 | `	if( pStream == 0  \|\| pStream->xReadDir == 0 ){` |
...
|      - | 3419 | `	}` |
|   7442 | 3420 | `	ph7_result_bool(pCtx,0);` |
|      - | 3421 | `	/* Perform the requested operation */` |
|   7442 | 3422 | `	rc = pStream->xReadDir(pDev->pHandle,pCtx);` |
|   7442 | 3423 | `	if( rc != PH7_OK ){` |
|      - | 3424 | `		/* Return FALSE */` |
|    932 | 3425 | `		ph7_result_bool(pCtx,0);` |
|    465 | 3426 | `	}` |
|   7442 | 3427 | `	return PH7_OK;` |
|   3722 | 3428 |  |
|      - | 3429 | `/*` |
...
|      - | 3671 | ` */` |
|   5612 | 3672 | `static int PH7_builtin_file_get_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 3673 |  |
|      - | 3674 | `	const ph7_io_stream *pStream;` |
|      - | 3675 | `	ph7_int64 n,nRead,nMaxlen;` |
|   5614 | 3676 | `	int use_include  = FALSE;` |
|      - | 3677 | `	const char *zFile;` |
|      - | 3678 | `	char zBuf[8192];` |
|      - | 3679 | `	void *pHandle;` |
|      - | 3680 | `	int nLen;` |
|      - | 3681 |  |
|   5614 | 3682 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   5614 | 3689 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3690 | `	/* Point to the target IO stream device */` |
|   5614 | 3691 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|   5614 | 3692 | `	if( pStream == 0 ){` |
...
|   5614 | 3702 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,PH7_IO_OPEN_RDONLY,use_include,nArg > 2 ? apArg[2] : 0,FALSE,0);` |
|   5614 | 3703 | `	if( pHandle == 0 ){` |
...
|   5614 | 3723 | `	nRead = 0;` |
|   5611 | 3724 | `	for(;;){` |
|  16838 | 3725 | `		n = pStream->xRead(pHandle,zBuf,` |
|   5614 | 3726 | `			(nMaxlen > 0 && (nMaxlen < (ph7_int64)sizeof(zBuf))) ? nMaxlen : (ph7_int64)sizeof(zBuf));` |
|  11224 | 3727 | `		if( n < 1 ){` |
|      - | 3728 | `			/* EOF or IO error,break immediately */` |
|   5612 | 3729 | `			break;` |
|      - | 3730 | `		}` |
|      - | 3731 | `		/* Append data */` |
|   5614 | 3732 | `		ph7_result_string(pCtx,zBuf,(int)n);` |
|      - | 3733 | `		/* Increment read counter */` |
|   5614 | 3734 | `		nRead += n;` |
|   5614 | 3735 | `		if( nMaxlen > 0 && nRead >= nMaxlen ){` |
|      - | 3736 | `			/* Read limit reached */` |
|      3 | 3737 | `			break;` |
|      - | 3738 | `		}` |
|      2 | 3739 | `	}` |
|      - | 3740 | `	/* Close the stream */` |
|   5614 | 3741 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|      - | 3742 | `	/* Check if we have read something */` |
|   5614 | 3743 | `	if( ph7_context_result_buf_length(pCtx) < 1 ){` |
|      - | 3744 | `		/* Nothing read,return FALSE */` |
|    ! 0 | 3745 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 3746 | `	}` |
|   5614 | 3747 | `	return PH7_OK;` |
|   2808 | 3748 |  |
|      - | 3749 | `/*` |
...
|      - | 3767 | ` */` |
|  12904 | 3768 | `static int PH7_builtin_file_put_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 3769 |  |
|  12906 | 3770 | `	int use_include  = FALSE;` |
...
|      - | 3777 | `	int nLen;` |
|      - | 3778 |  |
|  12906 | 3779 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  12906 | 3786 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3787 | `	/* Point to the target IO stream device */` |
|  12906 | 3788 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|  12906 | 3789 | `	if( pStream == 0 ){` |
...
|      - | 3793 | `	}` |
|      - | 3794 | `	/* Data to write */` |
|  12906 | 3795 | `	zData = ph7_value_to_string(apArg[1],&nLen);` |
|      - | 3796 | `	/* Try to open the file in read-write mode */` |
|  12906 | 3797 | `	iOpenFlags = PH7_IO_OPEN_CREATE\|PH7_IO_OPEN_RDWR\|PH7_IO_OPEN_TRUNC;` |
|      - | 3798 | `	/* Extract the flags */` |
|  12906 | 3799 | `	iFlags = 0;` |
|  12906 | 3800 | `	if( nArg > 2 ){` |
...
|    ! 0 | 3812 | `		}` |
|    ! 0 | 3813 | `	}` |
|  19358 | 3814 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,iOpenFlags,use_include,` |
|   6452 | 3815 | `		nArg > 3 ? apArg[3] : 0,FALSE,FALSE);` |
|  12906 | 3816 | `	if( pHandle == 0 ){` |
...
|  12900 | 3851 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|  12900 | 3852 | `	return PH7_OK;` |
|   6454 | 3853 |  |
|      - | 3854 | `/*` |
