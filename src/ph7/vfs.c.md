...
|      - |   65 | ` */` |
|  12766 |   66 | `static int PH7_vfs_chdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |   67 |  |
|      - |   68 | `	const char *zPath;` |
|      - |   69 | `	ph7_vfs *pVfs;` |
|      - |   70 | `	int rc;` |
|  12771 |   71 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |   72 | `		/* Missing/Invalid argument,return FALSE */` |
|      8 |   73 | `		ph7_result_bool(pCtx,0);` |
|      8 |   74 | `		return PH7_OK;` |
|      - |   75 | `	}` |
|      - |   76 | `	/* Point to the underlying vfs */` |
|  12765 |   77 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  12765 |   78 | `	if( pVfs == 0 \|\| pVfs->xChdir == 0 ){` |
...
|  12765 |   88 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |   89 | `	/* Perform the requested operation */` |
|  12765 |   90 | `	rc = pVfs->xChdir(zPath);` |
|      - |   91 | `	/* IO return value */` |
|  12765 |   92 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  12765 |   93 | `	return PH7_OK;` |
|   6388 |   94 |  |
|      - |   95 | `/*` |
...
|      - |  213 | ` */` |
|   7494 |  214 | `static int PH7_vfs_is_dir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  215 |  |
|      - |  216 | `	const char *zPath;` |
|      - |  217 | `	ph7_vfs *pVfs;` |
|      - |  218 | `	int rc;` |
|   7499 |  219 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  220 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  221 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  222 | `		return PH7_OK;` |
|      - |  223 | `	}` |
|      - |  224 | `	/* Point to the underlying vfs */` |
|   7499 |  225 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   7499 |  226 | `	if( pVfs == 0 \|\| pVfs->xIsdir == 0 ){` |
...
|   7499 |  236 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  237 | `	/* Perform the requested operation */` |
|   7499 |  238 | `	rc = pVfs->xIsdir(zPath);` |
|      - |  239 | `	/* IO return value */` |
|   7499 |  240 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   7499 |  241 | `	return PH7_OK;` |
|   3752 |  242 |  |
|      - |  243 | `/*` |
...
|      - |  476 | ` */` |
|  28246 |  477 | `static int PH7_vfs_unlink(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  478 |  |
|      - |  479 | `	const char *zPath;` |
|      - |  480 | `	ph7_vfs *pVfs;` |
|      - |  481 | `	int rc;` |
|  28251 |  482 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  483 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  484 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  485 | `		return PH7_OK;` |
|      - |  486 | `	}` |
|      - |  487 | `	/* Point to the underlying vfs */` |
|  28251 |  488 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  28251 |  489 | `	if( pVfs == 0 \|\| pVfs->xUnlink == 0 ){` |
...
|  28251 |  499 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  500 | `	/* Perform the requested operation */` |
|  28251 |  501 | `	rc = pVfs->xUnlink(zPath);` |
|      - |  502 | `	/* IO return value */` |
|  28251 |  503 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  28251 |  504 | `	return PH7_OK;` |
|  14128 |  505 |  |
|      - |  506 | `/*` |
...
|      - |  907 | ` */` |
|   5622 |  908 | `static int PH7_vfs_is_file(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  909 |  |
|      - |  910 | `	const char *zPath;` |
|      - |  911 | `	ph7_vfs *pVfs;` |
|      - |  912 | `	int rc;` |
|   5627 |  913 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  914 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  915 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  916 | `		return PH7_OK;` |
|      - |  917 | `	}` |
|      - |  918 | `	/* Point to the underlying vfs */` |
|   5627 |  919 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   5627 |  920 | `	if( pVfs == 0 \|\| pVfs->xIsfile == 0 ){` |
...
|   5627 |  930 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  931 | `	/* Perform the requested operation */` |
|   5627 |  932 | `	rc = pVfs->xIsfile(zPath);` |
|      - |  933 | `	/* IO return value */` |
|   5627 |  934 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   5627 |  935 | `	return PH7_OK;` |
|   2816 |  936 |  |
|      - |  937 | `/*` |
...
|      - | 1554 | ` */` |
|  11238 | 1555 | `static sxi32 ExtractPathInfo(const char *zPath,int nByte,path_info *pOut)` |
|      5 | 1556 |  |
|  11243 | 1557 | `	const char *zPtr,*zEnd = &zPath[nByte - 1];` |
|      - | 1558 | `	SyString *pCur;` |
|      - | 1559 | `	int c,d;` |
|  11243 | 1560 | `	c = d = '/';` |
...
|  11243 | 1565 | `	SyZero(pOut,sizeof(path_info));` |
|      - | 1566 | `	/* Handle special case */` |
|  11243 | 1567 | `	if( nByte == sizeof(char) && ( (int)zPath[0] == c \|\| (int)zPath[0] == d ) ){` |
...
| 300646 | 1576 | `	while( zEnd > zPath && ( (int)zEnd[0] != c && (int)zEnd[0] != d ) ){` |
| 283789 | 1577 | `		zEnd--;` |
|      5 | 1578 | `	}` |
|  11243 | 1579 | `	zPtr = (zEnd > zPath) ? &zEnd[1] : zPath;` |
|  11243 | 1580 | `	zEnd = &zPath[nByte];` |
|      - | 1581 | `	/* dirname */` |
|  11243 | 1582 | `	pCur = &pOut->sDir;` |
|  11243 | 1583 | `	SyStringInitFromBuf(pCur,zPath,zPtr-zPath);` |
|  11243 | 1584 | `	if( pCur->nByte > 1 ){` |
|  22481 | 1585 | `		SyStringTrimTrailingChar(pCur,'/');` |
|      - | 1586 | `#ifdef __WINNT__` |
|      5 | 1587 | `		SyStringTrimTrailingChar(pCur,'\\');` |
|      - | 1588 | `#endif` |
|   5624 | 1589 | `	}else if( (int)zPath[0] == c \|\| (int)zPath[0] == d ){` |
...
|  11243 | 1597 | `	pCur = &pOut->sBasename;` |
|  11243 | 1598 | `	SyStringInitFromBuf(pCur,zPtr,zEnd-zPtr);` |
|  11243 | 1599 | `	SyStringTrimLeadingChar(pCur,'/');` |
|      - | 1600 | `#ifdef __WINNT__` |
|      5 | 1601 | `	SyStringTrimLeadingChar(pCur,'\\');` |
|      - | 1602 | `#endif` |
|  11243 | 1603 | `	SyStringDupPtr(&pOut->sFilename,pCur);` |
|  11243 | 1604 | `	if( pCur->nByte > 0 ){` |
|      - | 1605 | `		/* extension */` |
|  11243 | 1606 | `		zEnd--;` |
|  56189 | 1607 | `		while( zEnd > pCur->zString /*basename*/ && zEnd[0] != '.' ){` |
|  44951 | 1608 | `			zEnd--;` |
|      5 | 1609 | `		}` |
|  11243 | 1610 | `		if( zEnd > pCur->zString ){` |
|  11241 | 1611 | `			zEnd++; /* Jump leading dot */` |
|  11241 | 1612 | `			SyStringInitFromBuf(&pOut->sExtension,zEnd,&zPath[nByte]-zEnd);` |
|      - | 1613 | `			/* Fix filename */` |
|  11241 | 1614 | `			pCur = &pOut->sFilename;` |
|  11241 | 1615 | `			if( pCur->nByte > SyStringLength(&pOut->sExtension) ){` |
|  11241 | 1616 | `				pCur->nByte -= 1 + SyStringLength(&pOut->sExtension);` |
|   5618 | 1617 | `			}` |
|   5618 | 1618 | `		}` |
|   5619 | 1619 | `	}` |
|  11243 | 1620 | `	return SXRET_OK;` |
|   5624 | 1621 |  |
|      - | 1622 | `/*` |
...
|      - | 1625 | ` */` |
|  11238 | 1626 | `static int PH7_builtin_pathinfo(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1627 |  |
|      - | 1628 | `	const char *zPath;` |
|      - | 1629 | `	path_info sInfo;` |
|      - | 1630 | `	SyString *pComp;` |
|      - | 1631 | `	int iLen;` |
|  11243 | 1632 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  11243 | 1638 | `	zPath = ph7_value_to_string(apArg[0],&iLen);` |
|  11243 | 1639 | `	if( iLen < 1 ){` |
|      - | 1640 | `		/* Empty string */` |
|    ! 0 | 1641 | `		ph7_result_string(pCtx,"",0);` |
|    ! 0 | 1642 | `		return PH7_OK;` |
|      - | 1643 | `	}` |
|      - | 1644 | `	/* Extract path info */` |
|  11243 | 1645 | `	ExtractPathInfo(zPath,iLen,&sInfo);` |
|  16861 | 1646 | `	if( nArg > 1 && ph7_value_is_int(apArg[1]) ){` |
|      - | 1647 | `		/* Return path component */` |
|  11241 | 1648 | `		int nComp = ph7_value_to_int(apArg[1]);` |
|  11241 | 1649 | `		switch(nComp){` |
...
|      - | 1666 | `			}` |
|      3 | 1667 | `			break;` |
|   2810 | 1668 | `		case 3: /*PATHINFO_EXTENSION*/` |
|   5625 | 1669 | `			pComp = &sInfo.sExtension;` |
|   5625 | 1670 | `			if( pComp->nByte > 0 ){` |
|   5623 | 1671 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   2814 | 1672 | `			}else{` |
|      - | 1673 | `				/* Expand the empty string */` |
|      3 | 1674 | `				ph7_result_string(pCtx,"",0);` |
|      - | 1675 | `			}` |
|   5625 | 1676 | `			break;` |
|   2806 | 1677 | `		case 4: /*PATHINFO_FILENAME*/` |
|   5617 | 1678 | `			pComp = &sInfo.sFilename;` |
|   5617 | 1679 | `			if( pComp->nByte > 0 ){` |
|   5617 | 1680 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   2811 | 1681 | `			}else{` |
...
|      - | 2712 | `	int rc;` |
|   8261 | 2713 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   8261 | 2720 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 2721 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   8261 | 2722 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   8261 | 2729 | `	pStream = pDev->pStream;` |
|   8261 | 2730 | `	if( pStream == 0 ){` |
...
|      - | 2737 | `	}` |
|   8261 | 2738 | `	rc = SXERR_EOF;` |
|      - | 2739 | `	/* Perform the requested operation */` |
|   8261 | 2740 | `	if( SyBlobLength(&pDev->sBuffer) > pDev->nOfft ){` |
...
|   4593 | 2747 | `		n = pStream->xRead(pDev->pHandle,zBuf,sizeof(zBuf));` |
|   4593 | 2748 | `		if( n > 0 ){` |
|      - | 2749 | `			/* Copy buffered data */` |
|   1427 | 2750 | `			SyBlobAppend(&pDev->sBuffer,zBuf,(sxu32)n);` |
|   1427 | 2751 | `			rc = PH7_OK;` |
|    711 | 2752 | `		}` |
|      - | 2753 | `	}` |
|      - | 2754 | `	/* EOF or not */` |
|   8261 | 2755 | `	ph7_result_bool(pCtx,rc == SXERR_EOF);` |
|   8261 | 2756 | `	return PH7_OK;` |
|   4133 | 2757 |  |
|      - | 2758 | `/*` |
...
|   5151 | 2806 | `	zIn = (const char *)SyBlobDataAt(&pDev->sBuffer,pDev->nOfft);` |
|   5151 | 2807 | `	zEnd = &zIn[SyBlobLength(&pDev->sBuffer)-pDev->nOfft];` |
|   5151 | 2808 | `	zPtr = zIn;` |
| 341109 | 2809 | `	while( zIn < zEnd ){` |
| 341035 | 2810 | `		if( zIn[0] == '\n' ){` |
|      - | 2811 | `			/* Line found */` |
|   5077 | 2812 | `			zIn++; /* Include the line ending as requested by the PHP specification */` |
|   5077 | 2813 | `			*pLen = (ph7_int64)(zIn-zPtr);` |
|   5077 | 2814 | `			*pzLine = zPtr;` |
|   5077 | 2815 | `			return SXRET_OK;` |
|      - | 2816 | `		}` |
| 335963 | 2817 | `		zIn++;` |
|      5 | 2818 | `	}` |
...
|      5 | 2826 |  |
|   5155 | 2827 | `	const ph7_io_stream *pStream = pDev->pStream;` |
|      - | 2828 | `	char zBuf[8192];` |
|      - | 2829 | `	ph7_int64 n;` |
|      - | 2830 | `	sxi32 rc;` |
|   5155 | 2831 | `	n = 0;` |
|   5155 | 2832 | `	if( pDev->nOfft >= SyBlobLength(&pDev->sBuffer) ){` |
...
|     28 | 2836 | `	}` |
|   5155 | 2837 | `	if( SyBlobLength(&pDev->sBuffer) > pDev->nOfft ){` |
|      - | 2838 | `		/* Check if there is a line */` |
|   5099 | 2839 | `		rc = GetLine(pDev,&n,pzData);` |
|   5099 | 2840 | `		if( rc == SXRET_OK ){` |
|      - | 2841 | `			/* Got line,update the cursor  */` |
|   5027 | 2842 | `			pDev->nOfft += (sxu32)n;` |
|   5027 | 2843 | `			return n;` |
|      - | 2844 | `		}` |
|     36 | 2845 | `	}` |
...
|      - | 2904 | ` */` |
|  28392 | 2905 | `PH7_PRIVATE void * PH7_StreamOpenHandle(ph7_vm *pVm,const ph7_io_stream *pStream,const char *zFile,` |
|      - | 2906 | `	int iFlags,int use_include,ph7_value *pResource,int bPushInclude,int *pNew)` |
|      5 | 2907 |  |
|  28397 | 2908 | `	void *pHandle = 0; /* cc warning */` |
|      - | 2909 | `	SyString sFile;` |
|      - | 2910 | `	int rc;` |
|  28397 | 2911 | `	if( pStream == 0 ){` |
|      - | 2912 | `		/* No such stream device */` |
|    ! 0 | 2913 | `		return 0;` |
|      - | 2914 | `	}` |
|  28397 | 2915 | `	SyStringInitFromBuf(&sFile,zFile,SyStrlen(zFile));` |
|  28397 | 2916 | `	if( use_include ){` |
|   9672 | 2917 | `		if(	sFile.zString[0] == '/' \|\|` |
|      - | 2918 | `#ifdef __WINNT__` |
|      - | 2919 | `			(sFile.nByte > 2 && sFile.zString[1] == ':' && (sFile.zString[2] == '\\' \|\| sFile.zString[2] == '/') ) \|\|` |
|      - | 2920 | `#endif` |
|   9658 | 2921 | `			(sFile.nByte > 1 && sFile.zString[0] == '.' && sFile.zString[1] == '/') \|\|` |
|   9654 | 2922 | `			(sFile.nByte > 2 && sFile.zString[0] == '.' && sFile.zString[1] == '.' && sFile.zString[2] == '/') ){` |
...
|   9658 | 2934 | `			SyBlobInit(&sWorker,&pVm->sAllocator);` |
|      - | 2935 | `			/* Build a path from the set of include path */` |
|   9658 | 2936 | `			SySetResetCursor(&pVm->aPaths);` |
|   9658 | 2937 | `			rc = SXERR_IO;` |
|   9664 | 2938 | `			while( SXRET_OK == SySetGetNextEntry(&pVm->aPaths,(void **)&pPath) ){` |
|      - | 2939 | `				/* Build full path */` |
|   9658 | 2940 | `				SyBlobFormat(&sWorker,"%z%c%z",pPath,c,&sFile);` |
|      - | 2941 | `				/* Append null terminator */` |
|   9658 | 2942 | `				if( SXRET_OK != SyBlobNullAppend(&sWorker) ){` |
|    ! 0 | 2943 | `					continue;` |
|      - | 2944 | `				}` |
|      - | 2945 | `				/* Try to open the file */` |
|   9658 | 2946 | `				rc = pStream->xOpen((const char *)SyBlobData(&sWorker),iFlags,pResource,&pHandle);` |
|   9658 | 2947 | `				if( rc == PH7_OK ){` |
|   9652 | 2948 | `					if( bPushInclude ){` |
|      - | 2949 | `						/* Mark as included */` |
|   9652 | 2950 | `						PH7_VmPushFilePath(pVm,(const char *)SyBlobData(&sWorker),SyBlobLength(&sWorker),FALSE,pNew);` |
|   4824 | 2951 | `					}` |
|   9652 | 2952 | `					break;` |
|      - | 2953 | `				}` |
...
|      2 | 2957 | `			}` |
|   9658 | 2958 | `			SyBlobRelease(&sWorker);` |
|      - | 2959 | `		}` |
|   9676 | 2960 | `		if( rc == PH7_OK ){` |
|   9670 | 2961 | `			if( bPushInclude ){` |
|      - | 2962 | `				/* Mark as included */` |
|   9670 | 2963 | `				PH7_VmPushFilePath(pVm,sFile.zString,sFile.nByte,FALSE,pNew);` |
|   4833 | 2964 | `			}` |
|   4833 | 2965 | `		}` |
|   4840 | 2966 | `	}else{` |
|      - | 2967 | `		/* Open the URI direcly */` |
|  18725 | 2968 | `		rc = pStream->xOpen(zFile,iFlags,pResource,&pHandle);` |
|      - | 2969 | `	}` |
|  28397 | 2970 | `	if( rc != PH7_OK ){` |
|      - | 2971 | `		/* IO error */` |
|     15 | 2972 | `		return 0;` |
|      - | 2973 | `	}` |
|      - | 2974 | `	/* Return the file handle */` |
|  28385 | 2975 | `	return pHandle;` |
|  14201 | 2976 |  |
|      - | 2977 | `/*` |
...
|      - | 2981 | ` */` |
|   9660 | 2982 | `PH7_PRIVATE sxi32 PH7_StreamReadWholeFile(void *pHandle,const ph7_io_stream *pStream,SyBlob *pOut)` |
|      4 | 2983 |  |
...
|   9660 | 2988 | `	for(;;){` |
|  19324 | 2989 | `		nRead = pStream->xRead(pHandle,zBuf,sizeof(zBuf));` |
|  19324 | 2990 | `		if( nRead < 1 ){` |
|      - | 2991 | `			/* EOF or IO error */` |
|   9664 | 2992 | `			break;` |
|      - | 2993 | `		}` |
|      - | 2994 | `		/* Append contents */` |
|   9664 | 2995 | `		rc = SyBlobAppend(pOut,zBuf,(sxu32)nRead);` |
|   9664 | 2996 | `		if( rc != SXRET_OK ){` |
|    ! 0 | 2997 | `			break;` |
|      - | 2998 | `		}` |
|      4 | 2999 | `	}` |
|   9664 | 3000 | `	return SyBlobLength(pOut) > 0 ? SXRET_OK : -1;` |
|      4 | 3001 |  |
|      - | 3002 | `/*` |
|      - | 3003 | ` * Close an open IO stream handle [i.e local file/URI..].` |
|      - | 3004 | ` */` |
|  28460 | 3005 | `PH7_PRIVATE void PH7_StreamCloseHandle(const ph7_io_stream *pStream,void *pHandle)` |
|      5 | 3006 |  |
|  28465 | 3007 | `	if( pStream->xClose ){` |
|  28465 | 3008 | `		pStream->xClose(pHandle);` |
|  14230 | 3009 | `	}` |
|  28465 | 3010 |  |
|      - | 3011 | `/*` |
...
|   5145 | 3087 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   5145 | 3094 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3095 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   5145 | 3096 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   5145 | 3103 | `	pStream = pDev->pStream;` |
|   5145 | 3104 | `	if( pStream == 0  ){` |
...
|   5145 | 3118 | `	n = StreamReadLine(pDev,&zLine,nLen);` |
|   5145 | 3119 | `	if( n < 1 ){` |
|      - | 3120 | `		/* EOF or IO error,return FALSE */` |
|      7 | 3121 | `		ph7_result_bool(pCtx,0);` |
|      6 | 3122 | `	}else{` |
|      - | 3123 | `		/* Return the freshly extracted line */` |
|   5143 | 3124 | `		ph7_result_string(pCtx,zLine,(int)n);` |
|      - | 3125 | `	}` |
|   5145 | 3126 | `	return PH7_OK;` |
|   2575 | 3127 |  |
|      - | 3128 | `/*` |
...
|      - | 3389 | ` */` |
|   7492 | 3390 | `static int PH7_builtin_readdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3391 |  |
|      - | 3392 | `	const ph7_io_stream *pStream;` |
|      - | 3393 | `	io_private *pDev;` |
|      - | 3394 | `	int rc;` |
|   7497 | 3395 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   7497 | 3402 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3403 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   7497 | 3404 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   7497 | 3411 | `	pStream = pDev->pStream;` |
|   7497 | 3412 | `	if( pStream == 0  \|\| pStream->xReadDir == 0 ){` |
...
|      - | 3419 | `	}` |
|   7497 | 3420 | `	ph7_result_bool(pCtx,0);` |
|      - | 3421 | `	/* Perform the requested operation */` |
|   7497 | 3422 | `	rc = pStream->xReadDir(pDev->pHandle,pCtx);` |
|   7497 | 3423 | `	if( rc != PH7_OK ){` |
|      - | 3424 | `		/* Return FALSE */` |
|    941 | 3425 | `		ph7_result_bool(pCtx,0);` |
|    468 | 3426 | `	}` |
|   7497 | 3427 | `	return PH7_OK;` |
|   3751 | 3428 |  |
|      - | 3429 | `/*` |
...
|      - | 3671 | ` */` |
|   5652 | 3672 | `static int PH7_builtin_file_get_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3673 |  |
|      - | 3674 | `	const ph7_io_stream *pStream;` |
|      - | 3675 | `	ph7_int64 n,nRead,nMaxlen;` |
|   5657 | 3676 | `	int use_include  = FALSE;` |
|      - | 3677 | `	const char *zFile;` |
|      - | 3678 | `	char zBuf[8192];` |
|      - | 3679 | `	void *pHandle;` |
|      - | 3680 | `	int nLen;` |
|      - | 3681 |  |
|   5657 | 3682 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   5657 | 3689 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3690 | `	/* Point to the target IO stream device */` |
|   5657 | 3691 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|   5657 | 3692 | `	if( pStream == 0 ){` |
...
|   5657 | 3702 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,PH7_IO_OPEN_RDONLY,use_include,nArg > 2 ? apArg[2] : 0,FALSE,0);` |
|   5657 | 3703 | `	if( pHandle == 0 ){` |
...
|   5657 | 3723 | `	nRead = 0;` |
|   5651 | 3724 | `	for(;;){` |
|  16961 | 3725 | `		n = pStream->xRead(pHandle,zBuf,` |
|   5654 | 3726 | `			(nMaxlen > 0 && (nMaxlen < (ph7_int64)sizeof(zBuf))) ? nMaxlen : (ph7_int64)sizeof(zBuf));` |
|  11307 | 3727 | `		if( n < 1 ){` |
|      - | 3728 | `			/* EOF or IO error,break immediately */` |
|   5655 | 3729 | `			break;` |
|      - | 3730 | `		}` |
|      - | 3731 | `		/* Append data */` |
|   5657 | 3732 | `		ph7_result_string(pCtx,zBuf,(int)n);` |
|      - | 3733 | `		/* Increment read counter */` |
|   5657 | 3734 | `		nRead += n;` |
|   5657 | 3735 | `		if( nMaxlen > 0 && nRead >= nMaxlen ){` |
|      - | 3736 | `			/* Read limit reached */` |
|      3 | 3737 | `			break;` |
|      - | 3738 | `		}` |
|      5 | 3739 | `	}` |
|      - | 3740 | `	/* Close the stream */` |
|   5657 | 3741 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|      - | 3742 | `	/* Check if we have read something */` |
|   5657 | 3743 | `	if( ph7_context_result_buf_length(pCtx) < 1 ){` |
|      - | 3744 | `		/* Nothing read,return FALSE */` |
|    ! 0 | 3745 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 3746 | `	}` |
|   5657 | 3747 | `	return PH7_OK;` |
|   2831 | 3748 |  |
|      - | 3749 | `/*` |
...
|      - | 3767 | ` */` |
|  12984 | 3768 | `static int PH7_builtin_file_put_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3769 |  |
|  12989 | 3770 | `	int use_include  = FALSE;` |
...
|      - | 3777 | `	int nLen;` |
|      - | 3778 |  |
|  12989 | 3779 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  12989 | 3786 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3787 | `	/* Point to the target IO stream device */` |
|  12989 | 3788 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|  12989 | 3789 | `	if( pStream == 0 ){` |
...
|      - | 3793 | `	}` |
|      - | 3794 | `	/* Data to write */` |
|  12989 | 3795 | `	zData = ph7_value_to_string(apArg[1],&nLen);` |
|      - | 3796 | `	/* Try to open the file in read-write mode */` |
|  12989 | 3797 | `	iOpenFlags = PH7_IO_OPEN_CREATE\|PH7_IO_OPEN_RDWR\|PH7_IO_OPEN_TRUNC;` |
|      - | 3798 | `	/* Extract the flags */` |
|  12989 | 3799 | `	iFlags = 0;` |
|  12989 | 3800 | `	if( nArg > 2 ){` |
...
|    ! 0 | 3812 | `		}` |
|    ! 0 | 3813 | `	}` |
|  19481 | 3814 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,iOpenFlags,use_include,` |
|   6492 | 3815 | `		nArg > 3 ? apArg[3] : 0,FALSE,FALSE);` |
|  12989 | 3816 | `	if( pHandle == 0 ){` |
...
|  12983 | 3851 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|  12983 | 3852 | `	return PH7_OK;` |
|   6497 | 3853 |  |
|      - | 3854 | `/*` |
...
|      5 | 4730 |  |
|   4251 | 4731 | `	pOut->pStream = pStream;` |
|   4251 | 4732 | `	SyBlobInit(&pOut->sBuffer,&pVm->sAllocator);` |
|   4251 | 4733 | `	pOut->nOfft = 0;` |
|      - | 4734 | `	/* Set the magic number */` |
|   4251 | 4735 | `	pOut->iMagic = IO_PRIVATE_MAGIC;` |
|   4251 | 4736 |  |
|      - | 4737 | `/*` |
...
|      5 | 4741 |  |
|   4221 | 4742 | `	SyBlobRelease(&pDev->sBuffer);` |
|   4221 | 4743 | `	pDev->iMagic = 0x2126; /* Invalid magic number so we can detetct misuse */` |
|      - | 4744 | `	/* Release the whole structure */` |
|   4221 | 4745 | `	ph7_context_free_chunk(pCtx,pDev);` |
|   4221 | 4746 |  |
|      - | 4747 | `/*` |
...
|      - | 5600 | `	FILE *pFile;` |
|   3239 | 5601 | `	if( pVm == 0 \|\| zCommand == 0 \|\| zMode == 0 ){` |
|    ! 0 | 5602 | `		return 0;` |
|      - | 5603 | `	}` |
|      - | 5604 | `	/* Validate mode - only 'r' or 'w' allowed */` |
|   3239 | 5605 | `	if( zMode[0] != 'r' && zMode[0] != 'w' ){` |
|    ! 0 | 5606 | `		return 0;` |
|      - | 5607 | `	}` |
...
|      - | 5696 | `	int status;` |
|      - | 5697 | `	ph7_vm *pVm;` |
|   3219 | 5698 | `	if( pPipe == 0 \|\| pPipe->pFile == 0 ){` |
|    ! 0 | 5699 | `		return -1;` |
|      - | 5700 | `	}` |
|   3219 | 5701 | `	pVm = pPipe->pVm;` |
...
|   3219 | 5724 | `	SyMemBackendFree(&pVm->sAllocator, pPipe);` |
|   3219 | 5725 | `	return status;` |
|   1612 | 5726 |  |
|      - | 5727 | `/*` |
...
|      4 | 5743 |  |
|   4700 | 5744 | `	pipe_private *pPipe = (pipe_private *)pHandle;` |
|      - | 5745 | `	size_t nRead;` |
|   4700 | 5746 | `	if( pPipe == 0 \|\| pPipe->pFile == 0 ){` |
|    ! 0 | 5747 | `		return -1;` |
|      - | 5748 | `	}` |
|   4700 | 5749 | `	if( pPipe->iMode != 'r' ){` |
|      - | 5750 | `		/* Cannot read from a write-only pipe */` |
|    ! 0 | 5751 | `		return -1;` |
|      - | 5752 | `	}` |
|   4700 | 5753 | `	nRead = fread(pBuffer, 1, (size_t)nDatatoRead, pPipe->pFile);` |
|   4700 | 5754 | `	if( nRead == 0 ){` |
|   3234 | 5755 | `		if( feof(pPipe->pFile) ){` |
|   3234 | 5756 | `			return 0; /* EOF */` |
|      - | 5757 | `		}` |
|    ! 0 | 5758 | `		return -1; /* Error */` |
|      - | 5759 | `	}` |
|   1470 | 5760 | `	return (ph7_int64)nRead;` |
|   2352 | 5761 |  |
|      - | 5762 | `/*` |
...
|      5 | 5806 |  |
|   3137 | 5807 | `	return pStream == &sPipe_Stream;` |
|      5 | 5808 |  |
|      - | 5809 | `/*` |
...
|   3239 | 5828 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) \|\| !ph7_value_is_string(apArg[1]) ){` |
...
|   3239 | 5835 | `	zCommand = ph7_value_to_string(apArg[0], &nCmdLen);` |
|   3239 | 5836 | `	zMode = ph7_value_to_string(apArg[1], &nModeLen);` |
|   3239 | 5837 | `	if( nCmdLen < 1 ){` |
|    ! 0 | 5838 | `		ph7_context_throw_error(pCtx, PH7_CTX_WARNING, "Empty command");` |
|    ! 0 | 5839 | `		ph7_result_bool(pCtx, 0);` |
|    ! 0 | 5840 | `		return PH7_OK;` |
|      - | 5841 | `	}` |
|   3239 | 5842 | `	if( nModeLen < 1 \|\| (zMode[0] != 'r' && zMode[0] != 'w') ){` |
...
|      - | 5846 | `	}` |
|      - | 5847 | `	/* Open the pipe */` |
|   3239 | 5848 | `	pPipe = PipeOpen(pCtx->pVm, zCommand, zMode);` |
|   3239 | 5849 | `	if( pPipe == 0 ){` |
...
|   3239 | 5855 | `	pDev = (io_private *)ph7_context_alloc_chunk(pCtx, sizeof(io_private), TRUE, FALSE);` |
|   3239 | 5856 | `	if( pDev == 0 ){` |
...
|   3239 | 5863 | `	InitIOPrivate(pCtx->pVm, &sPipe_Stream, pDev);` |
|   3239 | 5864 | `	pDev->pHandle = pPipe;` |
|      - | 5865 | `	/* Return the io_private instance as a resource */` |
|   3239 | 5866 | `	ph7_result_resource(pCtx, pDev);` |
|   3239 | 5867 | `	return PH7_OK;` |
|   1622 | 5868 |  |
|      - | 5869 | `/*` |
...
|      - | 5883 | `	int status;` |
|   3137 | 5884 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   3137 | 5891 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 5892 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   3137 | 5893 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   3137 | 5899 | `	pStream = pDev->pStream;` |
|   3137 | 5900 | `	if( pStream == 0 \|\| !is_pipe_stream(pStream) ){` |
...
|   3137 | 5906 | `	pPipe = (pipe_private *)pDev->pHandle;` |
|      - | 5907 | `	/* Close the pipe and get exit status */` |
|   3137 | 5908 | `	status = PipeClose(pPipe);` |
|      - | 5909 | `	/* Release the IO private structure */` |
|   3137 | 5910 | `	ReleaseIOPrivate(pCtx, pDev);` |
|      - | 5911 | `	/* Invalidate the resource handle */` |
|   3137 | 5912 | `	ph7_value_release(apArg[0]);` |
|      - | 5913 | `	/* Return the exit status */` |
|   3137 | 5914 | `	ph7_result_int(pCtx, status);` |
|   3137 | 5915 | `	return PH7_OK;` |
|   1571 | 5916 |  |
...
|      - | 6058 | `	};` |
|   2839 | 6059 | `	const ph7_io_stream *pFileStream = 0;` |
|   2839 | 6060 | `	sxu32 n = 0;` |
|      - | 6061 | `	/* Register disk-related functions */` |
| 138871 | 6062 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVfsDiskFunc) ; ++n ){` |
| 136037 | 6063 | `		ph7_create_function(&(*pVm),aVfsDiskFunc[n].zName,aVfsDiskFunc[n].xFunc,(void *)pVm->pEngine->pVfs);` |
|  68021 | 6064 | `	}` |
| 102029 | 6065 | `	for( n = 0 ; n < SX_ARRAYSIZE(aIOFunc) ; ++n ){` |
|  99195 | 6066 | `		ph7_create_function(&(*pVm),aIOFunc[n].zName,aIOFunc[n].xFunc,pVm);` |
|  49600 | 6067 | `	}` |
|      - | 6068 | `#else` |
|      - | 6069 | `	SXUNUSED(pVm);` |
...
|      - | 6096 | `	};` |
|  48183 | 6097 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVfsHelperFunc) ; ++n ){` |
|  45349 | 6098 | `		ph7_create_function(&(*pVm),aVfsHelperFunc[n].zName,aVfsHelperFunc[n].xFunc,pVm);` |
|  22677 | 6099 | `	}` |
...
|   2839 | 6110 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,&sPHP_Stream);` |
|   2839 | 6111 | `	if( pFileStream ){` |
|      - | 6112 | `		/* Install the file:// stream */` |
|   2839 | 6113 | `		ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,pFileStream);` |
|   1417 | 6114 | `	}` |
|      - | 6115 | `#endif /* PH7_DISABLE_DISK_IO */` |
|      - | 6116 |  |
|   2839 | 6117 | `	return SXRET_OK;` |
|      5 | 6118 |  |
|      - | 6119 | `/*` |
