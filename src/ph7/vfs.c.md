...
|      5 |   30 | `	d = '\\';` |
|      - |   31 | `#endif` |
|   1735 |   32 | `	while( zEnd > zPath && ( (int)zEnd[0] != c && (int)zEnd[0] != d ) ){` |
|   1631 |   33 | `		zEnd--;` |
|      5 |   34 | `	}` |
...
|      - |   67 | ` */` |
|  20144 |   68 | `static const char * VfsStrerror(int iErr)` |
|      5 |   69 | `{` |
|      - |   70 | `#if defined(_MSC_VER)` |
|      - |   71 | `#pragma warning(push)` |
|      - |   72 | `#pragma warning(disable:4996)` |
|      - |   73 | `#endif` |
|  20149 |   74 | `	return strerror(iErr);` |
...
|      - |   84 | ` */` |
|  20122 |   85 | `static void VfsThrowSysWarning(ph7_context *pCtx,const char *zPath)` |
|      5 |   86 | `{` |
|  30188 |   87 | `	PH7_VmThrowWarningFmt(pCtx->pVm,"%s(%s): %s",` |
|  20122 |   88 | `		ph7_function_name(pCtx),zPath ? zPath : "",VfsStrerror(errno));` |
|  20127 |   89 | `}` |
...
|      - |  103 | ` */` |
|  13520 |  104 | `static int PH7_vfs_chdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  105 | `{` |
|      - |  106 | `	const char *zPath;` |
|      - |  107 | `	ph7_vfs *pVfs;` |
|      - |  108 | `	int rc;` |
|  13525 |  109 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  110 | `		/* Missing/Invalid argument,return FALSE */` |
|      6 |  111 | `		ph7_result_bool(pCtx,0);` |
|      6 |  112 | `		return PH7_OK;` |
|      - |  113 | `	}` |
|      - |  114 | `	/* Point to the underlying vfs */` |
|  13521 |  115 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  13521 |  116 | `	if( pVfs == 0 \|\| pVfs->xChdir == 0 ){` |
...
|  13521 |  126 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  127 | `	/* Perform the requested operation */` |
|  13521 |  128 | `	errno = 0;` |
|  13521 |  129 | `	rc = pVfs->xChdir(zPath);` |
|  13521 |  130 | `	if( rc != PH7_OK ){` |
...
|      1 |  134 | `	}` |
|      - |  135 | `	/* IO return value */` |
|  13521 |  136 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  13521 |  137 | `	return PH7_OK;` |
|   6765 |  138 | `}` |
|      - |  139 | `/*` |
...
|      - |  223 | `	ph7_vfs *pVfs;` |
|      - |  224 | `	int rc;` |
|     48 |  225 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  226 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  227 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  228 | `		return PH7_OK;` |
|      - |  229 | `	}` |
|      - |  230 | `	/* Point to the underlying vfs */` |
|     48 |  231 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|     48 |  232 | `	if( pVfs == 0 \|\| pVfs->xRmdir == 0 ){` |
...
|     48 |  242 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  243 | `	/* Perform the requested operation */` |
|     48 |  244 | `	errno = 0;` |
|     48 |  245 | `	rc = pVfs->xRmdir(zPath);` |
|     48 |  246 | `	if( rc != PH7_OK ){` |
|      8 |  247 | `		VfsThrowSysWarning(pCtx,zPath);` |
|      3 |  248 | `	}` |
|      - |  249 | `	/* IO return value */` |
|     48 |  250 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|     48 |  251 | `	return PH7_OK;` |
|     25 |  252 | `}` |
|      - |  253 | `/*` |
...
|      - |  261 | ` */` |
|   8880 |  262 | `static int PH7_vfs_is_dir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  263 | `{` |
|      - |  264 | `	const char *zPath;` |
|      - |  265 | `	ph7_vfs *pVfs;` |
|      - |  266 | `	int rc;` |
|   8885 |  267 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  268 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  269 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  270 | `		return PH7_OK;` |
|      - |  271 | `	}` |
|      - |  272 | `	/* Point to the underlying vfs */` |
|   8885 |  273 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   8885 |  274 | `	if( pVfs == 0 \|\| pVfs->xIsdir == 0 ){` |
...
|   8885 |  284 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  285 | `	/* Perform the requested operation */` |
|   8885 |  286 | `	rc = pVfs->xIsdir(zPath);` |
|      - |  287 | `	/* IO return value */` |
|   8885 |  288 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   8885 |  289 | `	return PH7_OK;` |
|   4445 |  290 | `}` |
|      - |  291 | `/*` |
...
|      2 |  311 | `{` |
|     48 |  312 | `	int iRecursive = 0;` |
|      - |  313 | `	const char *zPath;` |
|      - |  314 | `	ph7_vfs *pVfs;` |
|      - |  315 | `	int iMode,rc;` |
|     48 |  316 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  317 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  318 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  319 | `		return PH7_OK;` |
|      - |  320 | `	}` |
|      - |  321 | `	/* Point to the underlying vfs */` |
|     48 |  322 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|     48 |  323 | `	if( pVfs == 0 \|\| pVfs->xMkdir == 0 ){` |
...
|     48 |  333 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  334 | `#ifdef __WINNT__` |
|      2 |  335 | `	iMode = 0;` |
|      - |  336 | `#else` |
|      - |  337 | `	/* Assume UNIX */` |
...
|    ! 0 |  353 | `	}` |
|      - |  354 | `	/* IO return value */` |
|     48 |  355 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|     48 |  356 | `	return PH7_OK;` |
|     25 |  357 | `}` |
|      - |  358 | `/*` |
...
|      - |  536 | ` */` |
|  33926 |  537 | `static int PH7_vfs_unlink(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  538 | `{` |
|      - |  539 | `	const char *zPath;` |
|      - |  540 | `	ph7_vfs *pVfs;` |
|      - |  541 | `	int rc;` |
|  33931 |  542 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  543 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  544 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  545 | `		return PH7_OK;` |
|      - |  546 | `	}` |
|      - |  547 | `	/* Point to the underlying vfs */` |
|  33931 |  548 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  33931 |  549 | `	if( pVfs == 0 \|\| pVfs->xUnlink == 0 ){` |
...
|  33931 |  559 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  560 | `	/* Perform the requested operation */` |
|  33931 |  561 | `	errno = 0;` |
|  33931 |  562 | `	rc = pVfs->xUnlink(zPath);` |
|  33931 |  563 | `	if( rc != PH7_OK ){` |
|  20121 |  564 | `		VfsThrowSysWarning(pCtx,zPath);` |
|  10058 |  565 | `	}` |
|      - |  566 | `	/* IO return value */` |
|  33931 |  567 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  33931 |  568 | `	return PH7_OK;` |
|  16968 |  569 | `}` |
|      - |  570 | `/*` |
...
|      - |  580 | ` */` |
|    150 |  581 | `static int PH7_vfs_chmod(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      3 |  582 | `{` |
|      - |  583 | `	const char *zPath;` |
|      - |  584 | `	ph7_vfs *pVfs;` |
|      - |  585 | `	int iMode;` |
|      - |  586 | `	int rc;` |
|    153 |  587 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  588 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  589 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  590 | `		return PH7_OK;` |
|      - |  591 | `	}` |
|      - |  592 | `	/* Point to the underlying vfs */` |
|    153 |  593 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|    153 |  594 | `	if( pVfs == 0 \|\| pVfs->xChmod == 0 ){` |
...
|    153 |  604 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  605 | `	/* Extract the mode */` |
|    153 |  606 | `	iMode = ph7_value_to_int(apArg[1]);` |
|      - |  607 | `	/* Perform the requested operation */` |
|    153 |  608 | `	rc = pVfs->xChmod(zPath,iMode);` |
|      - |  609 | `	/* IO return value */` |
|    153 |  610 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|    153 |  611 | `	return PH7_OK;` |
|     78 |  612 | `}` |
|      - |  613 | `/*` |
...
|      - |  807 | ` */` |
|    186 |  808 | `static int PH7_vfs_file_exists(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      3 |  809 | `{` |
|      - |  810 | `	const char *zPath;` |
|      - |  811 | `	ph7_vfs *pVfs;` |
|      - |  812 | `	int rc;` |
|    189 |  813 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  814 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  815 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  816 | `		return PH7_OK;` |
|      - |  817 | `	}` |
|      - |  818 | `	/* Point to the underlying vfs */` |
|    189 |  819 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|    189 |  820 | `	if( pVfs == 0 \|\| pVfs->xFileExists == 0 ){` |
...
|    189 |  830 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  831 | `	/* Perform the requested operation */` |
|    189 |  832 | `	rc = pVfs->xFileExists(zPath);` |
|      - |  833 | `	/* IO return value */` |
|    189 |  834 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|    189 |  835 | `	return PH7_OK;` |
|     96 |  836 | `}` |
|      - |  837 | `/*` |
...
|      - |  845 | ` */` |
|     28 |  846 | `static int PH7_vfs_file_size(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      1 |  847 | `{` |
|      - |  848 | `	const char *zPath;` |
|      - |  849 | `	ph7_int64 iSize;` |
|      - |  850 | `	ph7_vfs *pVfs;` |
|     29 |  851 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  852 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  853 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  854 | `		return PH7_OK;` |
|      - |  855 | `	}` |
|      - |  856 | `	/* Point to the underlying vfs */` |
|     29 |  857 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|     29 |  858 | `	if( pVfs == 0 \|\| pVfs->xFileSize == 0 ){` |
...
|     29 |  868 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  869 | `	/* Perform the requested operation */` |
|     29 |  870 | `	iSize = pVfs->xFileSize(zPath);` |
|     29 |  871 | `	if( iSize < 0 ){` |
...
|      - |  878 | `	}` |
|      - |  879 | `	/* IO return value */` |
|     29 |  880 | `	ph7_result_int64(pCtx,iSize);` |
|     29 |  881 | `	return PH7_OK;` |
|     15 |  882 | `}` |
|      - |  883 | `/*` |
...
|      - | 1005 | ` */` |
|   6810 | 1006 | `static int PH7_vfs_is_file(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1007 | `{` |
|      - | 1008 | `	const char *zPath;` |
|      - | 1009 | `	ph7_vfs *pVfs;` |
|      - | 1010 | `	int rc;` |
|   6815 | 1011 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   6815 | 1017 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   6815 | 1018 | `	if( pVfs == 0 \|\| pVfs->xIsfile == 0 ){` |
...
|   6815 | 1028 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - | 1029 | `	/* Perform the requested operation */` |
|   6815 | 1030 | `	rc = pVfs->xIsfile(zPath);` |
|      - | 1031 | `	/* IO return value */` |
|   6815 | 1032 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   6815 | 1033 | `	return PH7_OK;` |
|   3410 | 1034 | `}` |
|      - | 1035 | `/*` |
...
|      - | 1658 | ` */` |
|  13490 | 1659 | `static sxi32 ExtractPathInfo(const char *zPath,int nByte,path_info *pOut)` |
|      5 | 1660 | `{` |
|  13495 | 1661 | `	const char *zPtr,*zEnd = &zPath[nByte - 1];` |
|      - | 1662 | `	SyString *pCur;` |
|      - | 1663 | `	int c,d;` |
|  13495 | 1664 | `	c = d = '/';` |
...
|  13495 | 1669 | `	SyZero(pOut,sizeof(path_info));` |
|      - | 1670 | `	/* Handle special case */` |
|  13495 | 1671 | `	if( nByte == sizeof(char) && ( (int)zPath[0] == c \|\| (int)zPath[0] == d ) ){` |
...
| 364544 | 1680 | `	while( zEnd > zPath && ( (int)zEnd[0] != c && (int)zEnd[0] != d ) ){` |
| 344309 | 1681 | `		zEnd--;` |
|      5 | 1682 | `	}` |
|  13495 | 1683 | `	zPtr = (zEnd > zPath) ? &zEnd[1] : zPath;` |
|  13495 | 1684 | `	zEnd = &zPath[nByte];` |
|      - | 1685 | `	/* dirname */` |
|  13495 | 1686 | `	pCur = &pOut->sDir;` |
|  13495 | 1687 | `	SyStringInitFromBuf(pCur,zPath,zPtr-zPath);` |
|  13495 | 1688 | `	if( pCur->nByte > 1 ){` |
|  26985 | 1689 | `		SyStringTrimTrailingChar(pCur,'/');` |
|      - | 1690 | `#ifdef __WINNT__` |
|      5 | 1691 | `		SyStringTrimTrailingChar(pCur,'\\');` |
|      - | 1692 | `#endif` |
|   6750 | 1693 | `	}else if( (int)zPath[0] == c \|\| (int)zPath[0] == d ){` |
...
|  13495 | 1701 | `	pCur = &pOut->sBasename;` |
|  13495 | 1702 | `	SyStringInitFromBuf(pCur,zPtr,zEnd-zPtr);` |
|  13495 | 1703 | `	SyStringTrimLeadingChar(pCur,'/');` |
|      - | 1704 | `#ifdef __WINNT__` |
|      5 | 1705 | `	SyStringTrimLeadingChar(pCur,'\\');` |
|      - | 1706 | `#endif` |
|  13495 | 1707 | `	SyStringDupPtr(&pOut->sFilename,pCur);` |
|  13495 | 1708 | `	if( pCur->nByte > 0 ){` |
|      - | 1709 | `		/* extension */` |
|  13495 | 1710 | `		zEnd--;` |
|  67449 | 1711 | `		while( zEnd > pCur->zString /*basename*/ && zEnd[0] != '.' ){` |
|  53959 | 1712 | `			zEnd--;` |
|      5 | 1713 | `		}` |
|  13495 | 1714 | `		if( zEnd > pCur->zString ){` |
|  13493 | 1715 | `			zEnd++; /* Jump leading dot */` |
|  13493 | 1716 | `			SyStringInitFromBuf(&pOut->sExtension,zEnd,&zPath[nByte]-zEnd);` |
|      - | 1717 | `			/* Fix filename */` |
|  13493 | 1718 | `			pCur = &pOut->sFilename;` |
|  13493 | 1719 | `			if( pCur->nByte > SyStringLength(&pOut->sExtension) ){` |
|  13493 | 1720 | `				pCur->nByte -= 1 + SyStringLength(&pOut->sExtension);` |
|   6744 | 1721 | `			}` |
|   6744 | 1722 | `		}` |
|   6745 | 1723 | `	}` |
|  13495 | 1724 | `	return SXRET_OK;` |
|   6750 | 1725 | `}` |
|      - | 1726 | `/*` |
...
|      - | 1729 | ` */` |
|  13490 | 1730 | `static int PH7_builtin_pathinfo(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1731 | `{` |
|      - | 1732 | `	const char *zPath;` |
|      - | 1733 | `	path_info sInfo;` |
|      - | 1734 | `	SyString *pComp;` |
|      - | 1735 | `	int iLen;` |
|  13495 | 1736 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  13495 | 1742 | `	zPath = ph7_value_to_string(apArg[0],&iLen);` |
|  13495 | 1743 | `	if( iLen < 1 ){` |
|      - | 1744 | `		/* Empty string */` |
|    ! 0 | 1745 | `		ph7_result_string(pCtx,"",0);` |
|    ! 0 | 1746 | `		return PH7_OK;` |
|      - | 1747 | `	}` |
|      - | 1748 | `	/* Extract path info */` |
|  13495 | 1749 | `	ExtractPathInfo(zPath,iLen,&sInfo);` |
|  20239 | 1750 | `	if( nArg > 1 && ph7_value_is_int(apArg[1]) ){` |
|      - | 1751 | `		/* Return path component */` |
|  13493 | 1752 | `		int nComp = ph7_value_to_int(apArg[1]);` |
|  13493 | 1753 | `		switch(nComp){` |
...
|      - | 1770 | `			}` |
|      3 | 1771 | `			break;` |
|   3373 | 1772 | `		case 3: /*PATHINFO_EXTENSION*/` |
|   6751 | 1773 | `			pComp = &sInfo.sExtension;` |
|   6751 | 1774 | `			if( pComp->nByte > 0 ){` |
|   6749 | 1775 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   3377 | 1776 | `			}else{` |
|      - | 1777 | `				/* Expand the empty string */` |
|      3 | 1778 | `				ph7_result_string(pCtx,"",0);` |
|      - | 1779 | `			}` |
|   6751 | 1780 | `			break;` |
|   3369 | 1781 | `		case 4: /*PATHINFO_FILENAME*/` |
|   6743 | 1782 | `			pComp = &sInfo.sFilename;` |
|   6743 | 1783 | `			if( pComp->nByte > 0 ){` |
|   6743 | 1784 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   3374 | 1785 | `			}else{` |
...
|      - | 2243 | ` */` |
|    244 | 2244 | `static int PH7_vfs_sys_get_temp_dir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      4 | 2245 | `{` |
|      - | 2246 | `	ph7_vfs *pVfs;` |
|      - | 2247 | `	/* Set the empty string as the default return value */` |
|    248 | 2248 | `	ph7_result_string(pCtx,"",0);` |
|      - | 2249 | `	/* Point to the underlying vfs */` |
|    248 | 2250 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|    248 | 2251 | `	if( pVfs == 0 \|\| pVfs->xTempDir == 0 ){` |
...
|    248 | 2262 | `	pVfs->xTempDir(pCtx);` |
|    248 | 2263 | `	return PH7_OK;` |
|    126 | 2264 | `}` |
|      - | 2265 | `/*` |
...
|      - | 2847 | ` */` |
|  10707 | 2848 | `static int PH7_builtin_feof(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2849 | `{` |
|      - | 2850 | `	const ph7_io_stream *pStream;` |
|      - | 2851 | `	io_private *pDev;` |
|      - | 2852 | `	int rc;` |
|  10712 | 2853 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|  10712 | 2860 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 2861 | `	/* Make sure we are dealing with a valid io_private instance */` |
|  10712 | 2862 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|  10712 | 2869 | `	pStream = pDev->pStream;` |
|  10712 | 2870 | `	if( pStream == 0 ){` |
...
|      - | 2877 | `	}` |
|  10712 | 2878 | `	rc = SXERR_EOF;` |
|      - | 2879 | `	/* Perform the requested operation */` |
|  10712 | 2880 | `	if( SyBlobLength(&pDev->sBuffer) > pDev->nOfft ){` |
...
|   5784 | 2887 | `		n = pStream->xRead(pDev->pHandle,zBuf,sizeof(zBuf));` |
|   5784 | 2888 | `		if( n > 0 ){` |
|      - | 2889 | `			/* Copy buffered data */` |
|   1894 | 2890 | `			SyBlobAppend(&pDev->sBuffer,zBuf,(sxu32)n);` |
|   1894 | 2891 | `			rc = PH7_OK;` |
|    944 | 2892 | `		}` |
|      - | 2893 | `	}` |
|      - | 2894 | `	/* EOF or not */` |
|  10712 | 2895 | `	ph7_result_bool(pCtx,rc == SXERR_EOF);` |
|  10712 | 2896 | `	return PH7_OK;` |
|   5358 | 2897 | `}` |
|      - | 2898 | `/*` |
...
|      - | 2902 | ` */` |
|     37 | 2903 | `static ph7_int64 StreamRead(io_private *pDev,void *pBuf,ph7_int64 nLen)` |
|      3 | 2904 | `{` |
|     40 | 2905 | `	const ph7_io_stream *pStream = pDev->pStream;` |
|     40 | 2906 | `	char *zBuf = (char *)pBuf;` |
|      - | 2907 | `	ph7_int64 n,nRead;` |
|     40 | 2908 | `	n = SyBlobLength(&pDev->sBuffer) - pDev->nOfft;` |
|     40 | 2909 | `	if( n > 0 ){` |
|      3 | 2910 | `		if( n > nLen ){` |
|    ! 0 | 2911 | `			n = nLen;` |
|    ! 0 | 2912 | `		}` |
|      - | 2913 | `		/* Copy the buffered data */` |
|      3 | 2914 | `		SyMemcpy(SyBlobDataAt(&pDev->sBuffer,pDev->nOfft),pBuf,(sxu32)n);` |
|      - | 2915 | `		/* Update the read offset */` |
|      3 | 2916 | `		pDev->nOfft += (sxu32)n;` |
|      3 | 2917 | `		if( pDev->nOfft >= SyBlobLength(&pDev->sBuffer) ){` |
|      - | 2918 | `			/* Reset the working buffer so that we avoid excessive memory allocation */` |
|      3 | 2919 | `			SyBlobReset(&pDev->sBuffer);` |
|      3 | 2920 | `			pDev->nOfft = 0;` |
|      1 | 2921 | `		}` |
|      3 | 2922 | `		nLen -= n;` |
|      3 | 2923 | `		if( nLen < 1 ){` |
...
|     40 | 2931 | `	nRead = pStream->xRead(pDev->pHandle,zBuf,nLen);` |
|     40 | 2932 | `	if( nRead > 0 ){` |
|     37 | 2933 | `		n += nRead;` |
|     20 | 2934 | `	}else if( n < 1 ){` |
...
|      - | 2942 | ` */` |
|   6882 | 2943 | `static sxi32 GetLine(io_private *pDev,ph7_int64 *pLen,const char **pzLine)` |
|      5 | 2944 | `{` |
|      - | 2945 | `	const char *zIn,*zEnd,*zPtr;` |
|   6887 | 2946 | `	zIn = (const char *)SyBlobDataAt(&pDev->sBuffer,pDev->nOfft);` |
|   6887 | 2947 | `	zEnd = &zIn[SyBlobLength(&pDev->sBuffer)-pDev->nOfft];` |
|   6887 | 2948 | `	zPtr = zIn;` |
| 458638 | 2949 | `	while( zIn < zEnd ){` |
| 458530 | 2950 | `		if( zIn[0] == '\n' ){` |
|      - | 2951 | `			/* Line found */` |
|   6779 | 2952 | `			zIn++; /* Include the line ending as requested by the PHP specification */` |
|   6779 | 2953 | `			*pLen = (ph7_int64)(zIn-zPtr);` |
|   6779 | 2954 | `			*pzLine = zPtr;` |
|   6779 | 2955 | `			return SXRET_OK;` |
|      - | 2956 | `		}` |
| 451756 | 2957 | `		zIn++;` |
|      5 | 2958 | `	}` |
|      - | 2959 | `	/* No line were found */` |
|    113 | 2960 | `	return SXERR_NOTFOUND;` |
|   3446 | 2961 | `}` |
|      - | 2962 | `/*` |
|      - | 2963 | ` * Read a single line from the underlying IO stream device.` |
|      - | 2964 | ` */` |
|   6886 | 2965 | `static ph7_int64 StreamReadLine(io_private *pDev,const char **pzData,ph7_int64 nMaxLen)` |
|      5 | 2966 | `{` |
|   6891 | 2967 | `	const ph7_io_stream *pStream = pDev->pStream;` |
|      - | 2968 | `	char zBuf[8192];` |
|      - | 2969 | `	ph7_int64 n;` |
|      - | 2970 | `	sxi32 rc;` |
|   6891 | 2971 | `	n = 0;` |
|   6891 | 2972 | `	if( pDev->nOfft >= SyBlobLength(&pDev->sBuffer) ){` |
...
|     34 | 2976 | `	}` |
|   6857 | 2977 | `	if( SyBlobLength(&pDev->sBuffer) > pDev->nOfft ){` |
|      - | 2978 | `		/* Check if there is a line */` |
|   6823 | 2979 | `		rc = GetLine(pDev,&n,pzData);` |
|   6823 | 2980 | `		if( rc == SXRET_OK ){` |
|      - | 2981 | `			/* Got line,update the cursor  */` |
|   6719 | 2982 | `			pDev->nOfft += (sxu32)n;` |
|   6719 | 2983 | `			return n;` |
|      - | 2984 | `		}` |
|     52 | 2985 | `	}` |
...
|      - | 2988 | `	 */` |
|     88 | 2989 | `	for(;;){` |
|    181 | 2990 | `		n = pStream->xRead(pDev->pHandle,zBuf, (nMaxLen > 0 && nMaxLen < (ph7_int64)sizeof(zBuf)) ? nMaxLen : (ph7_int64)sizeof(zBuf));` |
|    181 | 2991 | `		if( n < 1 ){` |
...
|      - | 3012 | `		}` |
|      1 | 3013 | `	}` |
|    117 | 3014 | `	if( SyBlobLength(&pDev->sBuffer) > pDev->nOfft ){` |
|      - | 3015 | `		/* Read limit reached,return the available data */` |
|    113 | 3016 | `		*pzData = (const char *)SyBlobDataAt(&pDev->sBuffer,pDev->nOfft);` |
|    113 | 3017 | `		n = SyBlobLength(&pDev->sBuffer) - pDev->nOfft;` |
|      - | 3018 | `		/* Reset the working buffer */` |
|    113 | 3019 | `		SyBlobReset(&pDev->sBuffer);` |
|    113 | 3020 | `		pDev->nOfft = 0;` |
|     54 | 3021 | `	}` |
|    117 | 3022 | `	return n;` |
|   3448 | 3023 | `}` |
|      - | 3024 | `/*` |
...
|      - | 3044 | ` */` |
|  30592 | 3045 | `PH7_PRIVATE void * PH7_StreamOpenHandle(ph7_vm *pVm,const ph7_io_stream *pStream,const char *zFile,` |
|      - | 3046 | `	int iFlags,int use_include,ph7_value *pResource,int bPushInclude,int *pNew)` |
|      5 | 3047 | `{` |
|  30597 | 3048 | `	void *pHandle = 0; /* cc warning */` |
|      - | 3049 | `	SyString sFile;` |
|      - | 3050 | `	ph7_value sDummy;` |
|      - | 3051 | `	int rc;` |
|  30597 | 3052 | `	if( pStream == 0 ){` |
|      - | 3053 | `		/* No such stream device */` |
|    ! 0 | 3054 | `		return 0;` |
|      - | 3055 | `	}` |
|  30597 | 3056 | `	if( pResource == 0 ){` |
...
|  30575 | 3062 | `		PH7_MemObjInit(pVm,&sDummy);` |
|  30575 | 3063 | `		pResource = &sDummy;` |
|  15285 | 3064 | `	}` |
|  30597 | 3065 | `	SyStringInitFromBuf(&sFile,zFile,SyStrlen(zFile));` |
|  30597 | 3066 | `	if( use_include ){` |
|   9752 | 3067 | `		if(	sFile.zString[0] == '/' \|\|` |
|      - | 3068 | `#ifdef __WINNT__` |
|      - | 3069 | `			(sFile.nByte > 2 && sFile.zString[1] == ':' && (sFile.zString[2] == '\\' \|\| sFile.zString[2] == '/') ) \|\|` |
|      - | 3070 | `#endif` |
|   9715 | 3071 | `			(sFile.nByte > 1 && sFile.zString[0] == '.' && sFile.zString[1] == '/') \|\|` |
|   9710 | 3072 | `			(sFile.nByte > 2 && sFile.zString[0] == '.' && sFile.zString[1] == '.' && sFile.zString[2] == '/') ){` |
|      - | 3073 | `				/*  Open the file directly */` |
|     45 | 3074 | `				rc = pStream->xOpen(zFile,iFlags,pResource,&pHandle);` |
|     45 | 3075 | `				if( rc == PH7_OK && bPushInclude ){` |
|      - | 3076 | `					/* Mark as included */` |
|     45 | 3077 | `					PH7_VmPushFilePath(pVm,sFile.zString,sFile.nByte,FALSE,pNew);` |
|     21 | 3078 | `				}` |
|     24 | 3079 | `		}else{` |
|      - | 3080 | `			SyString *pPath;` |
|      - | 3081 | `			SyBlob sWorker;` |
...
|   9713 | 3088 | `			SyBlobInit(&sWorker,&pVm->sAllocator);` |
|      - | 3089 | `			/* Build a path from the set of include path */` |
|   9713 | 3090 | `			SySetResetCursor(&pVm->aPaths);` |
|   9713 | 3091 | `			rc = SXERR_IO;` |
|   9719 | 3092 | `			while( SXRET_OK == SySetGetNextEntry(&pVm->aPaths,(void **)&pPath) ){` |
|      - | 3093 | `				/* Build full path */` |
|   9713 | 3094 | `				SyBlobFormat(&sWorker,"%z%c%z",pPath,c,&sFile);` |
|      - | 3095 | `				/* Append null terminator */` |
|   9713 | 3096 | `				if( SXRET_OK != SyBlobNullAppend(&sWorker) ){` |
|    ! 0 | 3097 | `					continue;` |
|      - | 3098 | `				}` |
|      - | 3099 | `				/* Try to open the file */` |
|   9713 | 3100 | `				rc = pStream->xOpen((const char *)SyBlobData(&sWorker),iFlags,pResource,&pHandle);` |
|   9713 | 3101 | `				if( rc == PH7_OK ){` |
|   9706 | 3102 | `					if( bPushInclude ){` |
|      - | 3103 | `						/* Mark as included */` |
|   9706 | 3104 | `						PH7_VmPushFilePath(pVm,(const char *)SyBlobData(&sWorker),SyBlobLength(&sWorker),FALSE,pNew);` |
|   4852 | 3105 | `					}` |
|   9706 | 3106 | `					break;` |
|      - | 3107 | `				}` |
...
|      2 | 3111 | `			}` |
|   9713 | 3112 | `			SyBlobRelease(&sWorker);` |
|      - | 3113 | `		}` |
|   4879 | 3114 | `	}else{` |
|      - | 3115 | `		/* Open the URI direcly */` |
|  20845 | 3116 | `		rc = pStream->xOpen(zFile,iFlags,pResource,&pHandle);` |
|      - | 3117 | `	}` |
|  30597 | 3118 | `	if( rc != PH7_OK ){` |
|      - | 3119 | `		/* IO error */` |
|     25 | 3120 | `		return 0;` |
|      - | 3121 | `	}` |
|      - | 3122 | `	/* Return the file handle */` |
|  30577 | 3123 | `	return pHandle;` |
|  15301 | 3124 | `}` |
|      - | 3125 | `/*` |
...
|      - | 3129 | ` */` |
|   9736 | 3130 | `PH7_PRIVATE sxi32 PH7_StreamReadWholeFile(void *pHandle,const ph7_io_stream *pStream,SyBlob *pOut)` |
|      3 | 3131 | `{` |
...
|   9736 | 3136 | `	for(;;){` |
|  19475 | 3137 | `		nRead = pStream->xRead(pHandle,zBuf,sizeof(zBuf));` |
|  19475 | 3138 | `		if( nRead < 1 ){` |
|      - | 3139 | `			/* EOF or IO error */` |
|   9739 | 3140 | `			break;` |
|      - | 3141 | `		}` |
|      - | 3142 | `		/* Append contents */` |
|   9739 | 3143 | `		rc = SyBlobAppend(pOut,zBuf,(sxu32)nRead);` |
|   9739 | 3144 | `		if( rc != SXRET_OK ){` |
|    ! 0 | 3145 | `			break;` |
|      - | 3146 | `		}` |
|      3 | 3147 | `	}` |
|   9739 | 3148 | `	return SyBlobLength(pOut) > 0 ? SXRET_OK : -1;` |
|      3 | 3149 | `}` |
|      - | 3150 | `/*` |
|      - | 3151 | ` * Close an open IO stream handle [i.e local file/URI..].` |
|      - | 3152 | ` */` |
|  30700 | 3153 | `PH7_PRIVATE void PH7_StreamCloseHandle(const ph7_io_stream *pStream,void *pHandle)` |
|      5 | 3154 | `{` |
|  30705 | 3155 | `	if( pStream->xClose ){` |
|  30705 | 3156 | `		pStream->xClose(pHandle);` |
|  15350 | 3157 | `	}` |
|  30705 | 3158 | `}` |
|      - | 3159 | `/*` |
...
|      - | 3228 | ` */` |
|   6876 | 3229 | `static int PH7_builtin_fgets(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3230 | `{` |
|      - | 3231 | `	const ph7_io_stream *pStream;` |
|      - | 3232 | `	const char *zLine;` |
|      - | 3233 | `	io_private *pDev;` |
|      - | 3234 | `	ph7_int64 n,nLen;` |
|   6881 | 3235 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   6881 | 3242 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3243 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   6881 | 3244 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   6881 | 3251 | `	pStream = pDev->pStream;` |
|   6881 | 3252 | `	if( pStream == 0  ){` |
...
|   6881 | 3266 | `	n = StreamReadLine(pDev,&zLine,nLen);` |
|   6881 | 3267 | `	if( n < 1 ){` |
|      - | 3268 | `		/* EOF or IO error,return FALSE */` |
|      7 | 3269 | `		ph7_result_bool(pCtx,0);` |
|      6 | 3270 | `	}else{` |
|      - | 3271 | `		/* Return the freshly extracted line */` |
|   6879 | 3272 | `		ph7_result_string(pCtx,zLine,(int)n);` |
|      - | 3273 | `	}` |
|   6881 | 3274 | `	return PH7_OK;` |
|   3443 | 3275 | `}` |
|      - | 3276 | `/*` |
...
|      - | 3286 | ` */` |
|     29 | 3287 | `static int PH7_builtin_fread(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      3 | 3288 | `{` |
...
|      - | 3292 | `	void *pBuf;` |
|      - | 3293 | `	int nLen;` |
|     32 | 3294 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|     32 | 3301 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3302 | `	/* Make sure we are dealing with a valid io_private instance */` |
|     32 | 3303 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|     32 | 3310 | `	pStream = pDev->pStream;` |
|     32 | 3311 | `	if( pStream == 0  ){` |
...
|     32 | 3319 | `        nLen = 4096;` |
|     32 | 3320 | `	if( nArg > 1 ){` |
|     32 | 3321 | ` 	  nLen = ph7_value_to_int(apArg[1]);` |
|     32 | 3322 | `	  if( nLen < 1 ){` |
...
|     32 | 3328 | `	pBuf = ph7_context_alloc_chunk(pCtx,(unsigned int)nLen,FALSE,FALSE);` |
|     32 | 3329 | `	if( pBuf == 0 ){` |
...
|     32 | 3335 | `	nRead = StreamRead(pDev,pBuf,(ph7_int64)nLen);` |
|     32 | 3336 | `	if( nRead < 1 ){` |
|      - | 3337 | `		/* Nothing read,return FALSE */` |
|    ! 0 | 3338 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 3339 | `	}else{` |
|      - | 3340 | `		/* Make a copy of the data just read */` |
|     32 | 3341 | `		ph7_result_string(pCtx,(const char *)pBuf,(int)nRead);` |
|      - | 3342 | `	}` |
|      - | 3343 | `	/* Release the buffer */` |
|     32 | 3344 | `	ph7_context_free_chunk(pCtx,pBuf);` |
|     32 | 3345 | `	return PH7_OK;` |
|     17 | 3346 | `}` |
|      - | 3347 | `/*` |
...
|      - | 3537 | ` */` |
|  11048 | 3538 | `static int PH7_builtin_readdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3539 | `{` |
|      - | 3540 | `	const ph7_io_stream *pStream;` |
|      - | 3541 | `	io_private *pDev;` |
|      - | 3542 | `	int rc;` |
|  11053 | 3543 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|  11053 | 3550 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3551 | `	/* Make sure we are dealing with a valid io_private instance */` |
|  11053 | 3552 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|  11053 | 3559 | `	pStream = pDev->pStream;` |
|  11053 | 3560 | `	if( pStream == 0  \|\| pStream->xReadDir == 0 ){` |
...
|      - | 3567 | `	}` |
|  11053 | 3568 | `	ph7_result_bool(pCtx,0);` |
|      - | 3569 | `	/* Perform the requested operation */` |
|  11053 | 3570 | `	rc = pStream->xReadDir(pDev->pHandle,pCtx);` |
|  11053 | 3571 | `	if( rc != PH7_OK ){` |
|      - | 3572 | `		/* Return FALSE */` |
|   1071 | 3573 | `		ph7_result_bool(pCtx,0);` |
|    533 | 3574 | `	}` |
|  11053 | 3575 | `	return PH7_OK;` |
|   5529 | 3576 | `}` |
|      - | 3577 | `/*` |
...
|      - | 3631 | ` */` |
|   1070 | 3632 | `static int PH7_builtin_closedir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3633 | `{` |
|      - | 3634 | `	const ph7_io_stream *pStream;` |
|      - | 3635 | `	io_private *pDev;` |
|   1075 | 3636 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   1075 | 3643 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3644 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   1075 | 3645 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   1075 | 3652 | `	pStream = pDev->pStream;` |
|   1075 | 3653 | `	if( pStream == 0  \|\| pStream->xCloseDir == 0 ){` |
...
|   1075 | 3662 | `	pStream->xCloseDir(pDev->pHandle);` |
|      - | 3663 | `	/* Keep the handle alive but flag it closed (php: gettype()=='resource (closed)') */` |
|   1075 | 3664 | `	MarkIOPrivateClosed(pDev);` |
|   1075 | 3665 | `	return PH7_OK;` |
|    540 | 3666 | ` }` |
|      - | 3667 | `/*` |
...
|      - | 3677 | ` */` |
|   1070 | 3678 | `static int PH7_builtin_opendir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3679 | `{` |
|      - | 3680 | `	const ph7_io_stream *pStream;` |
|      - | 3681 | `	const char *zPath;` |
|      - | 3682 | `	io_private *pDev;` |
|      - | 3683 | `	int iLen,rc;` |
|   1075 | 3684 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   1075 | 3691 | `	zPath  = ph7_value_to_string(apArg[0],&iLen);` |
|      - | 3692 | `	/* Try to extract a stream */` |
|   1075 | 3693 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zPath,iLen);` |
|   1075 | 3694 | `	if( pStream == 0 ){` |
...
|      - | 3699 | `	}` |
|   1075 | 3700 | `	if( pStream->xOpenDir == 0 ){` |
...
|   1075 | 3709 | `	pDev = (io_private *)ph7_context_alloc_chunk(pCtx,sizeof(io_private),TRUE,FALSE);` |
|   1075 | 3710 | `	if( pDev == 0 ){` |
...
|   1075 | 3716 | `	InitIOPrivate(pCtx->pVm,pStream,pDev);` |
|      - | 3717 | `	/* Open the target directory */` |
|   1075 | 3718 | `	rc = pStream->xOpenDir(zPath,nArg > 1 ? apArg[1] : 0,&pDev->pHandle);` |
|   1075 | 3719 | `	if( rc != PH7_OK ){` |
...
|   1075 | 3725 | `		ph7_result_resource(pCtx,pDev);` |
|      - | 3726 | `	}` |
|   1075 | 3727 | `	return PH7_OK;` |
|    540 | 3728 | `}` |
|      - | 3729 | `/*` |
...
|      - | 3827 | ` */` |
|   6798 | 3828 | `static int PH7_builtin_file_get_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3829 | `{` |
|      - | 3830 | `	const ph7_io_stream *pStream;` |
|      - | 3831 | `	ph7_int64 n,nRead,nMaxlen;` |
|   6803 | 3832 | `	int use_include  = FALSE;` |
|      - | 3833 | `	const char *zFile;` |
|      - | 3834 | `	char zBuf[8192];` |
|      - | 3835 | `	void *pHandle;` |
|      - | 3836 | `	int nLen;` |
|      - | 3837 |  |
|   6803 | 3838 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   6803 | 3845 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3846 | `	/* Point to the target IO stream device */` |
|   6803 | 3847 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|   6803 | 3848 | `	if( pStream == 0 ){` |
...
|   6803 | 3858 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,PH7_IO_OPEN_RDONLY,use_include,nArg > 2 ? apArg[2] : 0,FALSE,0);` |
|   6803 | 3859 | `	if( pHandle == 0 ){` |
...
|   6801 | 3879 | `	nRead = 0;` |
|   6793 | 3880 | `	for(;;){` |
|  20387 | 3881 | `		n = pStream->xRead(pHandle,zBuf,` |
|   6796 | 3882 | `			(nMaxlen > 0 && (nMaxlen < (ph7_int64)sizeof(zBuf))) ? nMaxlen : (ph7_int64)sizeof(zBuf));` |
|  13591 | 3883 | `		if( n < 1 ){` |
|      - | 3884 | `			/* EOF or IO error,break immediately */` |
|   6799 | 3885 | `			break;` |
|      - | 3886 | `		}` |
|      - | 3887 | `		/* Append data */` |
|   6797 | 3888 | `		ph7_result_string(pCtx,zBuf,(int)n);` |
|      - | 3889 | `		/* Increment read counter */` |
|   6797 | 3890 | `		nRead += n;` |
|   6797 | 3891 | `		if( nMaxlen > 0 && nRead >= nMaxlen ){` |
|      - | 3892 | `			/* Read limit reached */` |
|      3 | 3893 | `			break;` |
|      - | 3894 | `		}` |
|      5 | 3895 | `	}` |
|      - | 3896 | `	/* Close the stream */` |
|   6801 | 3897 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
...
|   6801 | 3901 | `	if( ph7_context_result_buf_length(pCtx) < 1 ){` |
|      6 | 3902 | `		ph7_result_string(pCtx,"",0);` |
|      2 | 3903 | `	}` |
|   6801 | 3904 | `	return PH7_OK;` |
|   3404 | 3905 | `}` |
|      - | 3906 | `/*` |
...
|      - | 3924 | ` */` |
|  13794 | 3925 | `static int PH7_builtin_file_put_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3926 | `{` |
|  13799 | 3927 | `	int use_include  = FALSE;` |
...
|      - | 3934 | `	int nLen;` |
|      - | 3935 |  |
|  13799 | 3936 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  13799 | 3943 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3944 | `	/* Point to the target IO stream device */` |
|  13799 | 3945 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|  13799 | 3946 | `	if( pStream == 0 ){` |
...
|      - | 3950 | `	}` |
|      - | 3951 | `	/* Data to write */` |
|  13799 | 3952 | `	zData = ph7_value_to_string(apArg[1],&nLen);` |
|      - | 3953 | `	/* Try to open the file in read-write mode */` |
|  13799 | 3954 | `	iOpenFlags = PH7_IO_OPEN_CREATE\|PH7_IO_OPEN_RDWR\|PH7_IO_OPEN_TRUNC;` |
|      - | 3955 | `	/* Extract the flags */` |
|  13799 | 3956 | `	iFlags = 0;` |
|  13799 | 3957 | `	if( nArg > 2 ){` |
...
|    ! 0 | 3969 | `		}` |
|    ! 0 | 3970 | `	}` |
|  20696 | 3971 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,iOpenFlags,use_include,` |
|   6897 | 3972 | `		nArg > 3 ? apArg[3] : 0,FALSE,FALSE);` |
|  13799 | 3973 | `	if( pHandle == 0 ){` |
|    ! 0 | 3974 | `		VfsThrowOpenWarning(pCtx,zFile);` |
|    ! 0 | 3975 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 3976 | `		return PH7_OK;` |
|      - | 3977 | `	}` |
|  13799 | 3978 | `	if( nLen < 1 ){` |
...
|      - | 3983 | `	}` |
|  13791 | 3984 | `	if( pStream->xWrite ){` |
|      - | 3985 | `		ph7_int64 n;` |
|  13791 | 3986 | `		if( (iFlags & 2/* LOCK_EX, php's value */) && pStream->xLock ){` |
|      - | 3987 | `			/* Try to acquire an exclusive lock */` |
|    ! 0 | 3988 | `			pStream->xLock(pHandle,1/* LOCK_EX */);` |
|    ! 0 | 3989 | `		}` |
|      - | 3990 | `		/* Perform the write operation */` |
|  13791 | 3991 | `		n = pStream->xWrite(pHandle,(const void *)zData,nLen);` |
|  13791 | 3992 | `		if( n < 0 ){` |
...
|  13791 | 4000 | `			ph7_result_int64(pCtx,n);` |
|      - | 4001 | `		}` |
|   6898 | 4002 | `	}else{` |
...
|  13791 | 4011 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|  13791 | 4012 | `	return PH7_OK;` |
|   6902 | 4013 | `}` |
|      - | 4014 | `/*` |
...
|      - | 4868 | ` */` |
|    222 | 4869 | `static int StrModeToFlags(ph7_context *pCtx,const char *zMode,int nLen)` |
|      5 | 4870 | `{` |
|    227 | 4871 | `	const char *zEnd = &zMode[nLen];` |
|    227 | 4872 | `	int iFlag = 0;` |
|      - | 4873 | `	int c;` |
|    227 | 4874 | `	if( nLen < 1 ){` |
...
|      - | 4922 | `		 */` |
|     71 | 4923 | `		iFlag = PH7_IO_OPEN_WRONLY\|PH7_IO_OPEN_EXCL;` |
|     71 | 4924 | `		zMode++; /* Advance */` |
|     71 | 4925 | `		if( zMode < zEnd ){` |
|    ! 0 | 4926 | `			c = zMode[0];` |
|    ! 0 | 4927 | `			if( c == '+' \|\| c == 'r' \|\| c == 'R' ){` |
...
|     21 | 4959 | `		zMode++;` |
|      1 | 4960 | `	}` |
|    227 | 4961 | `	return iFlag;` |
|    116 | 4962 | `}` |
|      - | 4963 | `/*` |
|      - | 4964 | ` * Initialize the IO private structure.` |
|      - | 4965 | ` */` |
|   5324 | 4966 | `static void InitIOPrivate(ph7_vm *pVm,const ph7_io_stream *pStream,io_private *pOut)` |
|      5 | 4967 | `{` |
|   5329 | 4968 | `	pOut->pStream = pStream;` |
|   5329 | 4969 | `	SyBlobInit(&pOut->sBuffer,&pVm->sAllocator);` |
|   5329 | 4970 | `	pOut->nOfft = 0;` |
|      - | 4971 | `	/* Set the magic number */` |
|   5329 | 4972 | `	pOut->iMagic = IO_PRIVATE_MAGIC;` |
|   5329 | 4973 | `}` |
|      - | 4974 | `/*` |
...
|      - | 4992 | ` */` |
|   5266 | 4993 | `static void MarkIOPrivateClosed(io_private *pDev)` |
|      5 | 4994 | `{` |
|   5271 | 4995 | `	SyBlobRelease(&pDev->sBuffer);` |
|   5271 | 4996 | `	pDev->pHandle = 0;` |
|   5271 | 4997 | `	pDev->iMagic = IO_PRIVATE_CLOSED_MAGIC;` |
|   5271 | 4998 | `}` |
|      - | 4999 | `/*` |
...
|     52 | 5067 | `	while( nMax != 0 ){` |
|     50 | 5068 | `		ph7_int64 nAsk = (ph7_int64)sizeof(zBuf);` |
|     50 | 5069 | `		if( nMax > 0 && nMax < nAsk ){` |
|      3 | 5070 | `			nAsk = nMax;` |
|      1 | 5071 | `		}` |
|     50 | 5072 | `		nRead = pStream->xRead(pDev->pHandle,zBuf,nAsk);` |
|     50 | 5073 | `		if( nRead < 1 ){` |
|     27 | 5074 | `			break;` |
|      - | 5075 | `		}` |
|     24 | 5076 | `		ph7_result_string(pCtx,zBuf,(int)nRead); /* appends */` |
|     24 | 5077 | `		if( nMax > 0 ){` |
|      3 | 5078 | `			nMax -= nRead;` |
|      1 | 5079 | `		}` |
|      1 | 5080 | `	}` |
...
|      - | 5184 | `	int bEof;` |
|      - | 5185 | `};` |
|     15 | 5186 | `static ph7_int64 SockStreamData_Read(void *pHandle,void *pBuffer,ph7_int64 nRead)` |
|    ! 0 | 5187 | `{` |
|     15 | 5188 | `	sock_private *pSock = (sock_private *)pHandle;` |
|      - | 5189 | `	int n;` |
|     15 | 5190 | `	if( pSock == 0 \|\| pSock->bEof ){` |
|      1 | 5191 | `		return 0;` |
|      - | 5192 | `	}` |
|     14 | 5193 | `	n = PH7_NetRecv(pSock->sock,pBuffer,(int)nRead,0);` |
|     14 | 5194 | `	if( n <= 0 ){` |
|      4 | 5195 | `		pSock->bEof = 1;` |
|      4 | 5196 | `		return 0;` |
|      - | 5197 | `	}` |
|     10 | 5198 | `	return (ph7_int64)n;` |
|      5 | 5199 | `}` |
...
|    222 | 5765 | `static int PH7_builtin_fopen(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 5766 | `{` |
...
|      - | 5771 | `	int iLen,imLen;` |
|      - | 5772 | `	int iOpenFlags;` |
|    227 | 5773 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|    227 | 5780 | `	zUri  = ph7_value_to_string(apArg[0],&iLen);` |
|    227 | 5781 | `	if( nArg > 1 ){` |
|    227 | 5782 | `		zMode = ph7_value_to_string(apArg[1],&imLen);` |
|    116 | 5783 | `	}else{` |
...
|    227 | 5789 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zUri,iLen);` |
|    227 | 5790 | `	if( pStream == 0 ){` |
...
|    227 | 5797 | `	pDev = (io_private *)ph7_context_alloc_chunk(pCtx,sizeof(io_private),TRUE,FALSE);` |
|    227 | 5798 | `	if( pDev == 0 ){` |
...
|      - | 5802 | `	}` |
|    227 | 5803 | `	pResource = 0;` |
|    227 | 5804 | `	if( nArg > 3 ){` |
|    ! 0 | 5805 | `		pResource = apArg[3];` |
|    227 | 5806 | `	}else if( is_php_stream(pStream) \|\| is_data_stream(pStream) ){` |
...
|    227 | 5813 | `	InitIOPrivate(pCtx->pVm,pStream,pDev);` |
|      - | 5814 | `	/* Convert open mode to PH7 flags */` |
|    227 | 5815 | `	iOpenFlags = StrModeToFlags(pCtx,zMode,imLen);` |
|      - | 5816 | `	/* Try to get a handle */` |
|    338 | 5817 | `	pDev->pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zUri,iOpenFlags,` |
|    111 | 5818 | `		nArg > 2 ? ph7_value_to_bool(apArg[2]) : FALSE,pResource,FALSE,0);` |
|    227 | 5819 | `	if( pDev->pHandle == 0 ){` |
...
|    227 | 5826 | `	ph7_result_resource(pCtx,pDev);` |
|    227 | 5827 | `	return PH7_OK;` |
|    116 | 5828 | `}` |
|      - | 5829 | `/*` |
...
|      - | 5837 | ` */` |
|    352 | 5838 | `static int PH7_builtin_fclose(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 5839 | `{` |
|      - | 5840 | `	const ph7_io_stream *pStream;` |
|      - | 5841 | `	io_private *pDev;` |
|      - | 5842 | `	ph7_vm *pVm;` |
|    357 | 5843 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|    357 | 5850 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 5851 | `	/* php: fclose() on an already-closed stream raises a catchable TypeError */` |
|    357 | 5852 | `	if( pDev != 0 && pDev->iMagic == IO_PRIVATE_CLOSED_MAGIC ){` |
...
|    355 | 5857 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|    355 | 5864 | `	pStream = pDev->pStream;` |
|    355 | 5865 | `	if( pStream == 0 ){` |
...
|    355 | 5874 | `	pVm = pCtx->pVm;` |
|      - | 5875 | `	/* TICKET 1433-62: Keep the STDIN/STDOUT/STDERR handles open */` |
|    355 | 5876 | `	if( pDev != pVm->pStdin && pDev != pVm->pStdout && pDev != pVm->pStderr ){` |
|      - | 5877 | `		/* Perform the requested operation */` |
|    355 | 5878 | `		PH7_StreamCloseHandle(pStream,pDev->pHandle);` |
|      - | 5879 | `		/* Keep the handle alive but flag it closed so shared copies see it */` |
|    355 | 5880 | `		MarkIOPrivateClosed(pDev);` |
|    175 | 5881 | `	}` |
|      - | 5882 | `	/* Return TRUE */` |
|    355 | 5883 | `	ph7_result_bool(pCtx,1);` |
|    355 | 5884 | `	return PH7_OK;` |
|    181 | 5885 | `}` |
...
|      - | 6185 | ` */` |
|   3916 | 6186 | `PH7_PRIVATE const ph7_vfs * PH7_ExportBuiltinVfs(void)` |
|      5 | 6187 | `{` |
...
|      - | 6812 | ` */` |
|   3978 | 6813 | `static pipe_private * PipeOpen(ph7_vm *pVm, const char *zCommand, const char *zMode)` |
|      5 | 6814 | `{` |
|      - | 6815 | `	pipe_private *pPipe;` |
|      - | 6816 | `	FILE *pFile;` |
|   3983 | 6817 | `	if( pVm == 0 \|\| zCommand == 0 \|\| zMode == 0 ){` |
|    ! 0 | 6818 | `		return 0;` |
|      - | 6819 | `	}` |
|      - | 6820 | `	/* Validate mode - only 'r' or 'w' allowed */` |
|   3983 | 6821 | `	if( zMode[0] != 'r' && zMode[0] != 'w' ){` |
|    ! 0 | 6822 | `		return 0;` |
|      - | 6823 | `	}` |
...
|   3978 | 6885 | `	pFile = popen(zCommand, zMode);` |
|   3978 | 6886 | `	if( pFile == 0 ){` |
|    ! 0 | 6887 | `		return 0;` |
|      - | 6888 | `	}` |
|      - | 6889 | `	/* Allocate pipe private structure */` |
|   3978 | 6890 | `	pPipe = (pipe_private *)SyMemBackendAlloc(&pVm->sAllocator, sizeof(pipe_private));` |
|   3978 | 6891 | `	if( pPipe == 0 ){` |
|      - | 6892 | `		/* Out of memory, close the pipe */` |
|    ! 0 | 6893 | `		pclose(pFile);` |
|    ! 0 | 6894 | `		return 0;` |
|      - | 6895 | `	}` |
|      - | 6896 | `	/* Initialize the structure */` |
|   3978 | 6897 | `	pPipe->pFile = pFile;` |
|   3978 | 6898 | `	pPipe->pVm = pVm;` |
|   3978 | 6899 | `	pPipe->iMode = zMode[0];` |
|      - | 6900 | `#else /* OS_OTHER: no process pipes on this platform */` |
|      - | 6901 | `	(void)pFile;` |
|      - | 6902 | `	return 0;` |
|      - | 6903 | `#endif` |
|   3983 | 6904 | `	return pPipe;` |
|   1994 | 6905 | `}` |
|      - | 6906 | `/*` |
|      - | 6907 | ` * Close a pipe and return the exit status of the process.` |
|      - | 6908 | ` * Returns the exit status, or -1 on error.` |
|      - | 6909 | ` */` |
|   3952 | 6910 | `static int PipeClose(pipe_private *pPipe)` |
|      5 | 6911 | `{` |
|      - | 6912 | `	int status;` |
|      - | 6913 | `	ph7_vm *pVm;` |
|   3957 | 6914 | `	if( pPipe == 0 \|\| pPipe->pFile == 0 ){` |
|    ! 0 | 6915 | `		return -1;` |
|      - | 6916 | `	}` |
|   3957 | 6917 | `	pVm = pPipe->pVm;` |
...
|   3952 | 6923 | `	status = pclose(pPipe->pFile);` |
|      - | 6924 | `	/* On Unix, pclose returns the status from waitpid, need to extract exit code */` |
|   3952 | 6925 | `	if( status != -1 ){` |
|   3952 | 6926 | `		if( WIFEXITED(status) ){` |
|   3952 | 6927 | `			status = WEXITSTATUS(status);` |
|   1976 | 6928 | `		}else if( WIFSIGNALED(status) ){` |
...
|   3957 | 6940 | `	SyMemBackendFree(&pVm->sAllocator, pPipe);` |
|   3957 | 6941 | `	return status;` |
|   1981 | 6942 | `}` |
|      - | 6943 | `/*` |
...
|      - | 6957 | ` */` |
|   5924 | 6958 | `static ph7_int64 PipeStream_Read(void *pHandle, void *pBuffer, ph7_int64 nDatatoRead)` |
|      4 | 6959 | `{` |
|   5928 | 6960 | `	pipe_private *pPipe = (pipe_private *)pHandle;` |
|      - | 6961 | `	size_t nRead;` |
|   5928 | 6962 | `	if( pPipe == 0 \|\| pPipe->pFile == 0 ){` |
|    ! 0 | 6963 | `		return -1;` |
|      - | 6964 | `	}` |
|   5928 | 6965 | `	if( pPipe->iMode != 'r' ){` |
|      - | 6966 | `		/* Cannot read from a write-only pipe */` |
|    ! 0 | 6967 | `		return -1;` |
|      - | 6968 | `	}` |
|   5928 | 6969 | `	nRead = fread(pBuffer, 1, (size_t)nDatatoRead, pPipe->pFile);` |
|   5928 | 6970 | `	if( nRead == 0 ){` |
|   3988 | 6971 | `		if( feof(pPipe->pFile) ){` |
|   3988 | 6972 | `			return 0; /* EOF */` |
|      - | 6973 | `		}` |
|    ! 0 | 6974 | `		return -1; /* Error */` |
|      - | 6975 | `	}` |
|   1944 | 6976 | `	return (ph7_int64)nRead;` |
|   2966 | 6977 | `}` |
|      - | 6978 | `/*` |
...
|      - | 7020 | ` */` |
|   3846 | 7021 | `static int is_pipe_stream(const ph7_io_stream *pStream)` |
|      5 | 7022 | `{` |
|   3851 | 7023 | `	return pStream == &sPipe_Stream;` |
|      5 | 7024 | `}` |
|      - | 7025 | `/*` |
...
|      4 | 7083 | `}` |
|   3974 | 7084 | `static int PH7_builtin_popen(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 7085 | `{` |
|      - | 7086 | `	const char *zCommand, *zMode;` |
|      - | 7087 | `	pipe_private *pPipe;` |
|      - | 7088 | `	io_private *pDev;` |
|      - | 7089 | `	int nCmdLen, nModeLen;` |
|   3979 | 7090 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) \|\| !ph7_value_is_string(apArg[1]) ){` |
...
|   3979 | 7097 | `	zCommand = ph7_value_to_string(apArg[0], &nCmdLen);` |
|   3979 | 7098 | `	zMode = ph7_value_to_string(apArg[1], &nModeLen);` |
|   3979 | 7099 | `	if( nCmdLen < 1 ){` |
|    ! 0 | 7100 | `		ph7_context_throw_error(pCtx, PH7_CTX_WARNING, "Empty command");` |
|    ! 0 | 7101 | `		ph7_result_bool(pCtx, 0);` |
|    ! 0 | 7102 | `		return PH7_OK;` |
|      - | 7103 | `	}` |
|   3979 | 7104 | `	if( nModeLen < 1 \|\| (zMode[0] != 'r' && zMode[0] != 'w') ){` |
...
|      - | 7108 | `	}` |
|      - | 7109 | `	/* Open the pipe */` |
|   3979 | 7110 | `	pPipe = PipeOpen(pCtx->pVm, zCommand, zMode);` |
|   3979 | 7111 | `	if( pPipe == 0 ){` |
...
|   3979 | 7117 | `	pDev = (io_private *)ph7_context_alloc_chunk(pCtx, sizeof(io_private), TRUE, FALSE);` |
|   3979 | 7118 | `	if( pDev == 0 ){` |
...
|   3979 | 7125 | `	InitIOPrivate(pCtx->pVm, &sPipe_Stream, pDev);` |
|   3979 | 7126 | `	pDev->pHandle = pPipe;` |
|      - | 7127 | `	/* Return the io_private instance as a resource */` |
|   3979 | 7128 | `	ph7_result_resource(pCtx, pDev);` |
|   3979 | 7129 | `	return PH7_OK;` |
|   1992 | 7130 | `}` |
|      - | 7131 | `/*` |
...
|      - | 7139 | ` */` |
|   3846 | 7140 | `static int PH7_builtin_pclose(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 7141 | `{` |
|      - | 7142 | `	const ph7_io_stream *pStream;` |
|      - | 7143 | `	pipe_private *pPipe;` |
|      - | 7144 | `	io_private *pDev;` |
|      - | 7145 | `	int status;` |
|   3851 | 7146 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   3851 | 7153 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 7154 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   3851 | 7155 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   3851 | 7161 | `	pStream = pDev->pStream;` |
|   3851 | 7162 | `	if( pStream == 0 \|\| !is_pipe_stream(pStream) ){` |
...
|   3851 | 7168 | `	pPipe = (pipe_private *)pDev->pHandle;` |
|      - | 7169 | `	/* Close the pipe and get exit status */` |
|   3851 | 7170 | `	status = PipeClose(pPipe);` |
|      - | 7171 | `	/* Keep the handle alive but flag it closed so shared copies see it */` |
|   3851 | 7172 | `	MarkIOPrivateClosed(pDev);` |
|      - | 7173 | `	/* Return the exit status */` |
|   3851 | 7174 | `	ph7_result_int(pCtx, status);` |
|   3851 | 7175 | `	return PH7_OK;` |
|   1928 | 7176 | `}` |
|      - | 7177 | `/*` |
...
|      - | 7548 | ` */` |
|    228 | 7549 | `static int is_php_stream(const ph7_io_stream *pStream)` |
|      5 | 7550 | `{` |
|      - | 7551 | `#ifndef PH7_DISABLE_DISK_IO` |
|    233 | 7552 | `	return pStream == &sPHP_Stream;` |
|      - | 7553 | `#else` |
...
|      - | 7560 | ` */` |
|    208 | 7561 | `static int is_data_stream(const ph7_io_stream *pStream)` |
|      5 | 7562 | `{` |
|      - | 7563 | `#ifndef PH7_DISABLE_DISK_IO` |
|    213 | 7564 | `	return pStream == &sDATA_Stream;` |
|      - | 7565 | `#else` |
...
|      - | 7612 | ` */` |
|   3428 | 7613 | `PH7_PRIVATE sxi32 PH7_RegisterIORoutine(ph7_vm *pVm)` |
|      5 | 7614 | `{` |
|      - | 7615 | `	/*` |
...
|      - | 7730 | `	};` |
|   3433 | 7731 | `	const ph7_io_stream *pFileStream = 0;` |
|   3433 | 7732 | `	sxu32 n = 0;` |
|      - | 7733 | `	/* Register disk-related functions */` |
| 167977 | 7734 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVfsDiskFunc) ; ++n ){` |
| 164549 | 7735 | `		ph7_create_function(&(*pVm),aVfsDiskFunc[n].zName,aVfsDiskFunc[n].xFunc,(void *)pVm->pEngine->pVfs);` |
|  82277 | 7736 | `	}` |
| 178261 | 7737 | `	for( n = 0 ; n < SX_ARRAYSIZE(aIOFunc) ; ++n ){` |
| 174833 | 7738 | `		ph7_create_function(&(*pVm),aIOFunc[n].zName,aIOFunc[n].xFunc,pVm);` |
|  87419 | 7739 | `	}` |
|      - | 7740 | `#else` |
|      - | 7741 | `	SXUNUSED(pVm);` |
...
|      - | 7768 | `	};` |
|  58281 | 7769 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVfsHelperFunc) ; ++n ){` |
|  54853 | 7770 | `		ph7_create_function(&(*pVm),aVfsHelperFunc[n].zName,aVfsHelperFunc[n].xFunc,pVm);` |
|  27429 | 7771 | `	}` |
...
|   3428 | 7779 | `	pFileStream = &sUnixFileStream;` |
|      - | 7780 | `#endif` |
|      - | 7781 | `	/* Install the php:// stream */` |
|   3433 | 7782 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,&sPHP_Stream);` |
|   3433 | 7783 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,&sDATA_Stream);` |
|      - | 7784 | `#ifdef PH7_ENABLE_NET` |
|   3433 | 7785 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,&sTCP_Stream);` |
|      - | 7786 | `#endif` |
|   3433 | 7787 | `	if( pFileStream ){` |
|      - | 7788 | `		/* Install the file:// stream */` |
|   3433 | 7789 | `		ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,pFileStream);` |
|   1714 | 7790 | `	}` |
|      - | 7791 | `#endif /* PH7_DISABLE_DISK_IO */` |
|      - | 7792 |  |
|   3433 | 7793 | `	return SXRET_OK;` |
|      5 | 7794 | `}` |
|      - | 7795 | `/*` |
