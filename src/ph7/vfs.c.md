...
|      - |   65 | ` */` |
|  13530 |   66 | `static int PH7_vfs_chdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |   67 | `{` |
|      - |   68 | `	const char *zPath;` |
|      - |   69 | `	ph7_vfs *pVfs;` |
|      - |   70 | `	int rc;` |
|  13535 |   71 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |   72 | `		/* Missing/Invalid argument,return FALSE */` |
|      6 |   73 | `		ph7_result_bool(pCtx,0);` |
|      6 |   74 | `		return PH7_OK;` |
|      - |   75 | `	}` |
|      - |   76 | `	/* Point to the underlying vfs */` |
|  13531 |   77 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  13531 |   78 | `	if( pVfs == 0 \|\| pVfs->xChdir == 0 ){` |
...
|  13531 |   88 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |   89 | `	/* Perform the requested operation */` |
|  13531 |   90 | `	rc = pVfs->xChdir(zPath);` |
|      - |   91 | `	/* IO return value */` |
|  13531 |   92 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  13531 |   93 | `	return PH7_OK;` |
|   6770 |   94 | `}` |
|      - |   95 | `/*` |
...
|      - |  213 | ` */` |
|   8422 |  214 | `static int PH7_vfs_is_dir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  215 | `{` |
|      - |  216 | `	const char *zPath;` |
|      - |  217 | `	ph7_vfs *pVfs;` |
|      - |  218 | `	int rc;` |
|   8427 |  219 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  220 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  221 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  222 | `		return PH7_OK;` |
|      - |  223 | `	}` |
|      - |  224 | `	/* Point to the underlying vfs */` |
|   8427 |  225 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   8427 |  226 | `	if( pVfs == 0 \|\| pVfs->xIsdir == 0 ){` |
...
|   8427 |  236 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  237 | `	/* Perform the requested operation */` |
|   8427 |  238 | `	rc = pVfs->xIsdir(zPath);` |
|      - |  239 | `	/* IO return value */` |
|   8427 |  240 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   8427 |  241 | `	return PH7_OK;` |
|   4216 |  242 | `}` |
|      - |  243 | `/*` |
...
|      - |  476 | ` */` |
|  32438 |  477 | `static int PH7_vfs_unlink(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  478 | `{` |
|      - |  479 | `	const char *zPath;` |
|      - |  480 | `	ph7_vfs *pVfs;` |
|      - |  481 | `	int rc;` |
|  32443 |  482 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  483 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  484 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  485 | `		return PH7_OK;` |
|      - |  486 | `	}` |
|      - |  487 | `	/* Point to the underlying vfs */` |
|  32443 |  488 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  32443 |  489 | `	if( pVfs == 0 \|\| pVfs->xUnlink == 0 ){` |
...
|  32443 |  499 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  500 | `	/* Perform the requested operation */` |
|  32443 |  501 | `	rc = pVfs->xUnlink(zPath);` |
|      - |  502 | `	/* IO return value */` |
|  32443 |  503 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  32443 |  504 | `	return PH7_OK;` |
|  16224 |  505 | `}` |
|      - |  506 | `/*` |
...
|      - |  907 | ` */` |
|   6460 |  908 | `static int PH7_vfs_is_file(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  909 | `{` |
|      - |  910 | `	const char *zPath;` |
|      - |  911 | `	ph7_vfs *pVfs;` |
|      - |  912 | `	int rc;` |
|   6465 |  913 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  914 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  915 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  916 | `		return PH7_OK;` |
|      - |  917 | `	}` |
|      - |  918 | `	/* Point to the underlying vfs */` |
|   6465 |  919 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   6465 |  920 | `	if( pVfs == 0 \|\| pVfs->xIsfile == 0 ){` |
...
|   6465 |  930 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  931 | `	/* Perform the requested operation */` |
|   6465 |  932 | `	rc = pVfs->xIsfile(zPath);` |
|      - |  933 | `	/* IO return value */` |
|   6465 |  934 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   6465 |  935 | `	return PH7_OK;` |
|   3235 |  936 | `}` |
|      - |  937 | `/*` |
...
|      - | 1554 | ` */` |
|  12910 | 1555 | `static sxi32 ExtractPathInfo(const char *zPath,int nByte,path_info *pOut)` |
|      5 | 1556 | `{` |
|  12915 | 1557 | `	const char *zPtr,*zEnd = &zPath[nByte - 1];` |
|      - | 1558 | `	SyString *pCur;` |
|      - | 1559 | `	int c,d;` |
|  12915 | 1560 | `	c = d = '/';` |
...
|  12915 | 1565 | `	SyZero(pOut,sizeof(path_info));` |
|      - | 1566 | `	/* Handle special case */` |
|  12915 | 1567 | `	if( nByte == sizeof(char) && ( (int)zPath[0] == c \|\| (int)zPath[0] == d ) ){` |
...
| 348714 | 1576 | `	while( zEnd > zPath && ( (int)zEnd[0] != c && (int)zEnd[0] != d ) ){` |
| 329349 | 1577 | `		zEnd--;` |
|      5 | 1578 | `	}` |
|  12915 | 1579 | `	zPtr = (zEnd > zPath) ? &zEnd[1] : zPath;` |
|  12915 | 1580 | `	zEnd = &zPath[nByte];` |
|      - | 1581 | `	/* dirname */` |
|  12915 | 1582 | `	pCur = &pOut->sDir;` |
|  12915 | 1583 | `	SyStringInitFromBuf(pCur,zPath,zPtr-zPath);` |
|  12915 | 1584 | `	if( pCur->nByte > 1 ){` |
|  25825 | 1585 | `		SyStringTrimTrailingChar(pCur,'/');` |
|      - | 1586 | `#ifdef __WINNT__` |
|      5 | 1587 | `		SyStringTrimTrailingChar(pCur,'\\');` |
|      - | 1588 | `#endif` |
|   6460 | 1589 | `	}else if( (int)zPath[0] == c \|\| (int)zPath[0] == d ){` |
...
|  12915 | 1597 | `	pCur = &pOut->sBasename;` |
|  12915 | 1598 | `	SyStringInitFromBuf(pCur,zPtr,zEnd-zPtr);` |
|  12915 | 1599 | `	SyStringTrimLeadingChar(pCur,'/');` |
|      - | 1600 | `#ifdef __WINNT__` |
|      5 | 1601 | `	SyStringTrimLeadingChar(pCur,'\\');` |
|      - | 1602 | `#endif` |
|  12915 | 1603 | `	SyStringDupPtr(&pOut->sFilename,pCur);` |
|  12915 | 1604 | `	if( pCur->nByte > 0 ){` |
|      - | 1605 | `		/* extension */` |
|  12915 | 1606 | `		zEnd--;` |
|  64549 | 1607 | `		while( zEnd > pCur->zString /*basename*/ && zEnd[0] != '.' ){` |
|  51639 | 1608 | `			zEnd--;` |
|      5 | 1609 | `		}` |
|  12915 | 1610 | `		if( zEnd > pCur->zString ){` |
|  12913 | 1611 | `			zEnd++; /* Jump leading dot */` |
|  12913 | 1612 | `			SyStringInitFromBuf(&pOut->sExtension,zEnd,&zPath[nByte]-zEnd);` |
|      - | 1613 | `			/* Fix filename */` |
|  12913 | 1614 | `			pCur = &pOut->sFilename;` |
|  12913 | 1615 | `			if( pCur->nByte > SyStringLength(&pOut->sExtension) ){` |
|  12913 | 1616 | `				pCur->nByte -= 1 + SyStringLength(&pOut->sExtension);` |
|   6454 | 1617 | `			}` |
|   6454 | 1618 | `		}` |
|   6455 | 1619 | `	}` |
|  12915 | 1620 | `	return SXRET_OK;` |
|   6460 | 1621 | `}` |
|      - | 1622 | `/*` |
...
|      - | 1625 | ` */` |
|  12910 | 1626 | `static int PH7_builtin_pathinfo(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1627 | `{` |
|      - | 1628 | `	const char *zPath;` |
|      - | 1629 | `	path_info sInfo;` |
|      - | 1630 | `	SyString *pComp;` |
|      - | 1631 | `	int iLen;` |
|  12915 | 1632 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  12915 | 1638 | `	zPath = ph7_value_to_string(apArg[0],&iLen);` |
|  12915 | 1639 | `	if( iLen < 1 ){` |
|      - | 1640 | `		/* Empty string */` |
|    ! 0 | 1641 | `		ph7_result_string(pCtx,"",0);` |
|    ! 0 | 1642 | `		return PH7_OK;` |
|      - | 1643 | `	}` |
|      - | 1644 | `	/* Extract path info */` |
|  12915 | 1645 | `	ExtractPathInfo(zPath,iLen,&sInfo);` |
|  19369 | 1646 | `	if( nArg > 1 && ph7_value_is_int(apArg[1]) ){` |
|      - | 1647 | `		/* Return path component */` |
|  12913 | 1648 | `		int nComp = ph7_value_to_int(apArg[1]);` |
|  12913 | 1649 | `		switch(nComp){` |
...
|      - | 1666 | `			}` |
|      3 | 1667 | `			break;` |
|   3228 | 1668 | `		case 3: /*PATHINFO_EXTENSION*/` |
|   6461 | 1669 | `			pComp = &sInfo.sExtension;` |
|   6461 | 1670 | `			if( pComp->nByte > 0 ){` |
|   6459 | 1671 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   3232 | 1672 | `			}else{` |
|      - | 1673 | `				/* Expand the empty string */` |
|      3 | 1674 | `				ph7_result_string(pCtx,"",0);` |
|      - | 1675 | `			}` |
|   6461 | 1676 | `			break;` |
|   3224 | 1677 | `		case 4: /*PATHINFO_FILENAME*/` |
|   6453 | 1678 | `			pComp = &sInfo.sFilename;` |
|   6453 | 1679 | `			if( pComp->nByte > 0 ){` |
|   6453 | 1680 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   3229 | 1681 | `			}else{` |
...
|   5693 | 2762 | `		n = pStream->xRead(pDev->pHandle,zBuf,sizeof(zBuf));` |
|   5693 | 2763 | `		if( n > 0 ){` |
|      - | 2764 | `			/* Copy buffered data */` |
|   1801 | 2765 | `			SyBlobAppend(&pDev->sBuffer,zBuf,(sxu32)n);` |
|   1801 | 2766 | `			rc = PH7_OK;` |
|    898 | 2767 | `		}` |
|      - | 2768 | `	}` |
|      - | 2769 | `	/* EOF or not */` |
...
|      - | 2817 | ` */` |
|   6606 | 2818 | `static sxi32 GetLine(io_private *pDev,ph7_int64 *pLen,const char **pzLine)` |
|      5 | 2819 | `{` |
|      - | 2820 | `	const char *zIn,*zEnd,*zPtr;` |
|   6611 | 2821 | `	zIn = (const char *)SyBlobDataAt(&pDev->sBuffer,pDev->nOfft);` |
|   6611 | 2822 | `	zEnd = &zIn[SyBlobLength(&pDev->sBuffer)-pDev->nOfft];` |
|   6611 | 2823 | `	zPtr = zIn;` |
| 387172 | 2824 | `	while( zIn < zEnd ){` |
| 387088 | 2825 | `		if( zIn[0] == '\n' ){` |
|      - | 2826 | `			/* Line found */` |
|   6527 | 2827 | `			zIn++; /* Include the line ending as requested by the PHP specification */` |
|   6527 | 2828 | `			*pLen = (ph7_int64)(zIn-zPtr);` |
|   6527 | 2829 | `			*pzLine = zPtr;` |
|   6527 | 2830 | `			return SXRET_OK;` |
|      - | 2831 | `		}` |
| 380566 | 2832 | `		zIn++;` |
|      5 | 2833 | `	}` |
...
|      - | 2839 | ` */` |
|   6610 | 2840 | `static ph7_int64 StreamReadLine(io_private *pDev,const char **pzData,ph7_int64 nMaxLen)` |
|      5 | 2841 | `{` |
|   6615 | 2842 | `	const ph7_io_stream *pStream = pDev->pStream;` |
|      - | 2843 | `	char zBuf[8192];` |
|      - | 2844 | `	ph7_int64 n;` |
|      - | 2845 | `	sxi32 rc;` |
|   6615 | 2846 | `	n = 0;` |
|   6615 | 2847 | `	if( pDev->nOfft >= SyBlobLength(&pDev->sBuffer) ){` |
...
|     30 | 2851 | `	}` |
|   6615 | 2852 | `	if( SyBlobLength(&pDev->sBuffer) > pDev->nOfft ){` |
|      - | 2853 | `		/* Check if there is a line */` |
|   6555 | 2854 | `		rc = GetLine(pDev,&n,pzData);` |
|   6555 | 2855 | `		if( rc == SXRET_OK ){` |
|      - | 2856 | `			/* Got line,update the cursor  */` |
|   6473 | 2857 | `			pDev->nOfft += (sxu32)n;` |
|   6473 | 2858 | `			return n;` |
|      - | 2859 | `		}` |
|     41 | 2860 | `	}` |
...
|      - | 2919 | ` */` |
|  30060 | 2920 | `PH7_PRIVATE void * PH7_StreamOpenHandle(ph7_vm *pVm,const ph7_io_stream *pStream,const char *zFile,` |
|      - | 2921 | `	int iFlags,int use_include,ph7_value *pResource,int bPushInclude,int *pNew)` |
|      5 | 2922 | `{` |
|  30065 | 2923 | `	void *pHandle = 0; /* cc warning */` |
|      - | 2924 | `	SyString sFile;` |
|      - | 2925 | `	int rc;` |
|  30065 | 2926 | `	if( pStream == 0 ){` |
|      - | 2927 | `		/* No such stream device */` |
|    ! 0 | 2928 | `		return 0;` |
|      - | 2929 | `	}` |
|  30065 | 2930 | `	SyStringInitFromBuf(&sFile,zFile,SyStrlen(zFile));` |
|  30065 | 2931 | `	if( use_include ){` |
|   9728 | 2932 | `		if(	sFile.zString[0] == '/' \|\|` |
|      - | 2933 | `#ifdef __WINNT__` |
|      - | 2934 | `			(sFile.nByte > 2 && sFile.zString[1] == ':' && (sFile.zString[2] == '\\' \|\| sFile.zString[2] == '/') ) \|\|` |
|      - | 2935 | `#endif` |
|   9714 | 2936 | `			(sFile.nByte > 1 && sFile.zString[0] == '.' && sFile.zString[1] == '/') \|\|` |
|   9710 | 2937 | `			(sFile.nByte > 2 && sFile.zString[0] == '.' && sFile.zString[1] == '.' && sFile.zString[2] == '/') ){` |
...
|   9714 | 2949 | `			SyBlobInit(&sWorker,&pVm->sAllocator);` |
|      - | 2950 | `			/* Build a path from the set of include path */` |
|   9714 | 2951 | `			SySetResetCursor(&pVm->aPaths);` |
|   9714 | 2952 | `			rc = SXERR_IO;` |
|   9720 | 2953 | `			while( SXRET_OK == SySetGetNextEntry(&pVm->aPaths,(void **)&pPath) ){` |
|      - | 2954 | `				/* Build full path */` |
|   9714 | 2955 | `				SyBlobFormat(&sWorker,"%z%c%z",pPath,c,&sFile);` |
|      - | 2956 | `				/* Append null terminator */` |
|   9714 | 2957 | `				if( SXRET_OK != SyBlobNullAppend(&sWorker) ){` |
|    ! 0 | 2958 | `					continue;` |
|      - | 2959 | `				}` |
|      - | 2960 | `				/* Try to open the file */` |
|   9714 | 2961 | `				rc = pStream->xOpen((const char *)SyBlobData(&sWorker),iFlags,pResource,&pHandle);` |
|   9714 | 2962 | `				if( rc == PH7_OK ){` |
|   9708 | 2963 | `					if( bPushInclude ){` |
|      - | 2964 | `						/* Mark as included */` |
|   9708 | 2965 | `						PH7_VmPushFilePath(pVm,(const char *)SyBlobData(&sWorker),SyBlobLength(&sWorker),FALSE,pNew);` |
|   4852 | 2966 | `					}` |
|   9708 | 2967 | `					break;` |
|      - | 2968 | `				}` |
...
|      2 | 2972 | `			}` |
|   9714 | 2973 | `			SyBlobRelease(&sWorker);` |
|      - | 2974 | `		}` |
|   9732 | 2975 | `		if( rc == PH7_OK ){` |
|   9726 | 2976 | `			if( bPushInclude ){` |
|      - | 2977 | `				/* Mark as included */` |
|   9726 | 2978 | `				PH7_VmPushFilePath(pVm,sFile.zString,sFile.nByte,FALSE,pNew);` |
|   4861 | 2979 | `			}` |
|   4861 | 2980 | `		}` |
|   4868 | 2981 | `	}else{` |
|      - | 2982 | `		/* Open the URI direcly */` |
|  20337 | 2983 | `		rc = pStream->xOpen(zFile,iFlags,pResource,&pHandle);` |
|      - | 2984 | `	}` |
|  30065 | 2985 | `	if( rc != PH7_OK ){` |
|      - | 2986 | `		/* IO error */` |
|     16 | 2987 | `		return 0;` |
|      - | 2988 | `	}` |
|      - | 2989 | `	/* Return the file handle */` |
|  30053 | 2990 | `	return pHandle;` |
|  15035 | 2991 | `}` |
|      - | 2992 | `/*` |
...
|      - | 2996 | ` */` |
|   9716 | 2997 | `PH7_PRIVATE sxi32 PH7_StreamReadWholeFile(void *pHandle,const ph7_io_stream *pStream,SyBlob *pOut)` |
|      4 | 2998 | `{` |
...
|   9716 | 3003 | `	for(;;){` |
|  19436 | 3004 | `		nRead = pStream->xRead(pHandle,zBuf,sizeof(zBuf));` |
|  19436 | 3005 | `		if( nRead < 1 ){` |
|      - | 3006 | `			/* EOF or IO error */` |
|   9720 | 3007 | `			break;` |
|      - | 3008 | `		}` |
|      - | 3009 | `		/* Append contents */` |
|   9720 | 3010 | `		rc = SyBlobAppend(pOut,zBuf,(sxu32)nRead);` |
|   9720 | 3011 | `		if( rc != SXRET_OK ){` |
|    ! 0 | 3012 | `			break;` |
|      - | 3013 | `		}` |
|      4 | 3014 | `	}` |
|   9720 | 3015 | `	return SyBlobLength(pOut) > 0 ? SXRET_OK : -1;` |
|      4 | 3016 | `}` |
|      - | 3017 | `/*` |
|      - | 3018 | ` * Close an open IO stream handle [i.e local file/URI..].` |
|      - | 3019 | ` */` |
|  30138 | 3020 | `PH7_PRIVATE void PH7_StreamCloseHandle(const ph7_io_stream *pStream,void *pHandle)` |
|      5 | 3021 | `{` |
|  30143 | 3022 | `	if( pStream->xClose ){` |
|  30143 | 3023 | `		pStream->xClose(pHandle);` |
|  15069 | 3024 | `	}` |
|  30143 | 3025 | `}` |
|      - | 3026 | `/*` |
...
|      - | 3095 | ` */` |
|   6600 | 3096 | `static int PH7_builtin_fgets(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3097 | `{` |
|      - | 3098 | `	const ph7_io_stream *pStream;` |
|      - | 3099 | `	const char *zLine;` |
|      - | 3100 | `	io_private *pDev;` |
|      - | 3101 | `	ph7_int64 n,nLen;` |
|   6605 | 3102 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   6605 | 3109 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3110 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   6605 | 3111 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   6605 | 3118 | `	pStream = pDev->pStream;` |
|   6605 | 3119 | `	if( pStream == 0  ){` |
...
|   6605 | 3133 | `	n = StreamReadLine(pDev,&zLine,nLen);` |
|   6605 | 3134 | `	if( n < 1 ){` |
|      - | 3135 | `		/* EOF or IO error,return FALSE */` |
|      7 | 3136 | `		ph7_result_bool(pCtx,0);` |
|      6 | 3137 | `	}else{` |
|      - | 3138 | `		/* Return the freshly extracted line */` |
|   6603 | 3139 | `		ph7_result_string(pCtx,zLine,(int)n);` |
|      - | 3140 | `	}` |
|   6605 | 3141 | `	return PH7_OK;` |
|   3305 | 3142 | `}` |
|      - | 3143 | `/*` |
...
|      - | 3404 | ` */` |
|   8420 | 3405 | `static int PH7_builtin_readdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3406 | `{` |
|      - | 3407 | `	const ph7_io_stream *pStream;` |
|      - | 3408 | `	io_private *pDev;` |
|      - | 3409 | `	int rc;` |
|   8425 | 3410 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   8425 | 3417 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3418 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   8425 | 3419 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   8425 | 3426 | `	pStream = pDev->pStream;` |
|   8425 | 3427 | `	if( pStream == 0  \|\| pStream->xReadDir == 0 ){` |
...
|      - | 3434 | `	}` |
|   8425 | 3435 | `	ph7_result_bool(pCtx,0);` |
|      - | 3436 | `	/* Perform the requested operation */` |
|   8425 | 3437 | `	rc = pStream->xReadDir(pDev->pHandle,pCtx);` |
|   8425 | 3438 | `	if( rc != PH7_OK ){` |
|      - | 3439 | `		/* Return FALSE */` |
|    987 | 3440 | `		ph7_result_bool(pCtx,0);` |
|    491 | 3441 | `	}` |
|   8425 | 3442 | `	return PH7_OK;` |
|   4215 | 3443 | `}` |
|      - | 3444 | `/*` |
...
|      - | 3497 | ` */` |
|    986 | 3498 | `static int PH7_builtin_closedir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3499 | `{` |
|      - | 3500 | `	const ph7_io_stream *pStream;` |
|      - | 3501 | `	io_private *pDev;` |
|    991 | 3502 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|    991 | 3509 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3510 | `	/* Make sure we are dealing with a valid io_private instance */` |
|    991 | 3511 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|    991 | 3518 | `	pStream = pDev->pStream;` |
|    991 | 3519 | `	if( pStream == 0  \|\| pStream->xCloseDir == 0 ){` |
...
|    991 | 3528 | `	pStream->xCloseDir(pDev->pHandle);` |
|      - | 3529 | `	/* Release the private stucture */` |
|    991 | 3530 | `	ReleaseIOPrivate(pCtx,pDev);` |
|    991 | 3531 | `	PH7_MemObjRelease(apArg[0]);` |
|    991 | 3532 | `	return PH7_OK;` |
|    498 | 3533 | ` }` |
|      - | 3534 | `/*` |
...
|      - | 3544 | ` */` |
|    986 | 3545 | `static int PH7_builtin_opendir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3546 | `{` |
|      - | 3547 | `	const ph7_io_stream *pStream;` |
|      - | 3548 | `	const char *zPath;` |
|      - | 3549 | `	io_private *pDev;` |
|      - | 3550 | `	int iLen,rc;` |
|    991 | 3551 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|    991 | 3558 | `	zPath  = ph7_value_to_string(apArg[0],&iLen);` |
|      - | 3559 | `	/* Try to extract a stream */` |
|    991 | 3560 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zPath,iLen);` |
|    991 | 3561 | `	if( pStream == 0 ){` |
...
|      - | 3566 | `	}` |
|    991 | 3567 | `	if( pStream->xOpenDir == 0 ){` |
...
|    991 | 3576 | `	pDev = (io_private *)ph7_context_alloc_chunk(pCtx,sizeof(io_private),TRUE,FALSE);` |
|    991 | 3577 | `	if( pDev == 0 ){` |
...
|    991 | 3583 | `	InitIOPrivate(pCtx->pVm,pStream,pDev);` |
|      - | 3584 | `	/* Open the target directory */` |
|    991 | 3585 | `	rc = pStream->xOpenDir(zPath,nArg > 1 ? apArg[1] : 0,&pDev->pHandle);` |
|    991 | 3586 | `	if( rc != PH7_OK ){` |
...
|    991 | 3592 | `		ph7_result_resource(pCtx,pDev);` |
|      - | 3593 | `	}` |
|    991 | 3594 | `	return PH7_OK;` |
|    498 | 3595 | `}` |
|      - | 3596 | `/*` |
...
|      - | 3686 | ` */` |
|   6488 | 3687 | `static int PH7_builtin_file_get_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3688 | `{` |
|      - | 3689 | `	const ph7_io_stream *pStream;` |
|      - | 3690 | `	ph7_int64 n,nRead,nMaxlen;` |
|   6493 | 3691 | `	int use_include  = FALSE;` |
|      - | 3692 | `	const char *zFile;` |
|      - | 3693 | `	char zBuf[8192];` |
|      - | 3694 | `	void *pHandle;` |
|      - | 3695 | `	int nLen;` |
|      - | 3696 |  |
|   6493 | 3697 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   6493 | 3704 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3705 | `	/* Point to the target IO stream device */` |
|   6493 | 3706 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|   6493 | 3707 | `	if( pStream == 0 ){` |
...
|   6493 | 3717 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,PH7_IO_OPEN_RDONLY,use_include,nArg > 2 ? apArg[2] : 0,FALSE,0);` |
|   6493 | 3718 | `	if( pHandle == 0 ){` |
...
|   6493 | 3738 | `	nRead = 0;` |
|   6486 | 3739 | `	for(;;){` |
|  19466 | 3740 | `		n = pStream->xRead(pHandle,zBuf,` |
|   6489 | 3741 | `			(nMaxlen > 0 && (nMaxlen < (ph7_int64)sizeof(zBuf))) ? nMaxlen : (ph7_int64)sizeof(zBuf));` |
|  12977 | 3742 | `		if( n < 1 ){` |
|      - | 3743 | `			/* EOF or IO error,break immediately */` |
|   6491 | 3744 | `			break;` |
|      - | 3745 | `		}` |
|      - | 3746 | `		/* Append data */` |
|   6491 | 3747 | `		ph7_result_string(pCtx,zBuf,(int)n);` |
|      - | 3748 | `		/* Increment read counter */` |
|   6491 | 3749 | `		nRead += n;` |
|   6491 | 3750 | `		if( nMaxlen > 0 && nRead >= nMaxlen ){` |
|      - | 3751 | `			/* Read limit reached */` |
|      3 | 3752 | `			break;` |
|      - | 3753 | `		}` |
|      5 | 3754 | `	}` |
|      - | 3755 | `	/* Close the stream */` |
|   6493 | 3756 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|      - | 3757 | `	/* Check if we have read something */` |
|   6493 | 3758 | `	if( ph7_context_result_buf_length(pCtx) < 1 ){` |
|      - | 3759 | `		/* Nothing read,return FALSE */` |
|      3 | 3760 | `		ph7_result_bool(pCtx,0);` |
|      1 | 3761 | `	}` |
|   6493 | 3762 | `	return PH7_OK;` |
|   3249 | 3763 | `}` |
|      - | 3764 | `/*` |
...
|      - | 3782 | ` */` |
|  13760 | 3783 | `static int PH7_builtin_file_put_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3784 | `{` |
|  13765 | 3785 | `	int use_include  = FALSE;` |
...
|      - | 3792 | `	int nLen;` |
|      - | 3793 |  |
|  13765 | 3794 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  13765 | 3801 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3802 | `	/* Point to the target IO stream device */` |
|  13765 | 3803 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|  13765 | 3804 | `	if( pStream == 0 ){` |
...
|      - | 3808 | `	}` |
|      - | 3809 | `	/* Data to write */` |
|  13765 | 3810 | `	zData = ph7_value_to_string(apArg[1],&nLen);` |
|      - | 3811 | `	/* Try to open the file in read-write mode */` |
|  13765 | 3812 | `	iOpenFlags = PH7_IO_OPEN_CREATE\|PH7_IO_OPEN_RDWR\|PH7_IO_OPEN_TRUNC;` |
|      - | 3813 | `	/* Extract the flags */` |
|  13765 | 3814 | `	iFlags = 0;` |
|  13765 | 3815 | `	if( nArg > 2 ){` |
...
|    ! 0 | 3827 | `		}` |
|    ! 0 | 3828 | `	}` |
|  20645 | 3829 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,iOpenFlags,use_include,` |
|   6880 | 3830 | `		nArg > 3 ? apArg[3] : 0,FALSE,FALSE);` |
|  13765 | 3831 | `	if( pHandle == 0 ){` |
...
|  13759 | 3866 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|  13759 | 3867 | `	return PH7_OK;` |
|   6885 | 3868 | `}` |
|      - | 3869 | `/*` |
...
|      - | 4780 | ` */` |
|   5026 | 4781 | `static void InitIOPrivate(ph7_vm *pVm,const ph7_io_stream *pStream,io_private *pOut)` |
|      5 | 4782 | `{` |
|   5031 | 4783 | `	pOut->pStream = pStream;` |
|   5031 | 4784 | `	SyBlobInit(&pOut->sBuffer,&pVm->sAllocator);` |
|   5031 | 4785 | `	pOut->nOfft = 0;` |
|      - | 4786 | `	/* Set the magic number */` |
|   5031 | 4787 | `	pOut->iMagic = IO_PRIVATE_MAGIC;` |
|   5031 | 4788 | `}` |
|      - | 4789 | `/*` |
|      - | 4790 | ` * Release the IO private structure.` |
|      - | 4791 | ` */` |
|   4994 | 4792 | `static void ReleaseIOPrivate(ph7_context *pCtx,io_private *pDev)` |
|      5 | 4793 | `{` |
|   4999 | 4794 | `	SyBlobRelease(&pDev->sBuffer);` |
|   4999 | 4795 | `	pDev->iMagic = 0x2126; /* Invalid magic number so we can detetct misuse */` |
|      - | 4796 | `	/* Release the whole structure */` |
|   4999 | 4797 | `	ph7_context_free_chunk(pCtx,pDev);` |
|   4999 | 4798 | `}` |
|      - | 4799 | `/*` |
...
|      - | 5240 | ` */` |
|   3906 | 5241 | `PH7_PRIVATE const ph7_vfs * PH7_ExportBuiltinVfs(void)` |
|      5 | 5242 | `{` |
...
|      - | 5660 | ` */` |
|   3966 | 5661 | `static pipe_private * PipeOpen(ph7_vm *pVm, const char *zCommand, const char *zMode)` |
|      5 | 5662 | `{` |
|      - | 5663 | `	pipe_private *pPipe;` |
|      - | 5664 | `	FILE *pFile;` |
|   3971 | 5665 | `	if( pVm == 0 \|\| zCommand == 0 \|\| zMode == 0 ){` |
|    ! 0 | 5666 | `		return 0;` |
|      - | 5667 | `	}` |
|      - | 5668 | `	/* Validate mode - only 'r' or 'w' allowed */` |
|   3971 | 5669 | `	if( zMode[0] != 'r' && zMode[0] != 'w' ){` |
|    ! 0 | 5670 | `		return 0;` |
|      - | 5671 | `	}` |
...
|   3966 | 5733 | `	pFile = popen(zCommand, zMode);` |
|   3966 | 5734 | `	if( pFile == 0 ){` |
|    ! 0 | 5735 | `		return 0;` |
|      - | 5736 | `	}` |
|      - | 5737 | `	/* Allocate pipe private structure */` |
|   3966 | 5738 | `	pPipe = (pipe_private *)SyMemBackendAlloc(&pVm->sAllocator, sizeof(pipe_private));` |
|   3966 | 5739 | `	if( pPipe == 0 ){` |
|      - | 5740 | `		/* Out of memory, close the pipe */` |
|    ! 0 | 5741 | `		pclose(pFile);` |
|    ! 0 | 5742 | `		return 0;` |
|      - | 5743 | `	}` |
|      - | 5744 | `	/* Initialize the structure */` |
|   3966 | 5745 | `	pPipe->pFile = pFile;` |
|   3966 | 5746 | `	pPipe->pVm = pVm;` |
|   3966 | 5747 | `	pPipe->iMode = zMode[0];` |
|      - | 5748 | `#else /* OS_OTHER: no process pipes on this platform */` |
|      - | 5749 | `	(void)pFile;` |
|      - | 5750 | `	return 0;` |
|      - | 5751 | `#endif` |
|   3971 | 5752 | `	return pPipe;` |
|   1988 | 5753 | `}` |
|      - | 5754 | `/*` |
|      - | 5755 | ` * Close a pipe and return the exit status of the process.` |
|      - | 5756 | ` * Returns the exit status, or -1 on error.` |
|      - | 5757 | ` */` |
|   3944 | 5758 | `static int PipeClose(pipe_private *pPipe)` |
|      5 | 5759 | `{` |
|      - | 5760 | `	int status;` |
|      - | 5761 | `	ph7_vm *pVm;` |
|   3949 | 5762 | `	if( pPipe == 0 \|\| pPipe->pFile == 0 ){` |
|    ! 0 | 5763 | `		return -1;` |
|      - | 5764 | `	}` |
|   3949 | 5765 | `	pVm = pPipe->pVm;` |
...
|   3944 | 5771 | `	status = pclose(pPipe->pFile);` |
|      - | 5772 | `	/* On Unix, pclose returns the status from waitpid, need to extract exit code */` |
|   3944 | 5773 | `	if( status != -1 ){` |
|   3944 | 5774 | `		if( WIFEXITED(status) ){` |
|   3944 | 5775 | `			status = WEXITSTATUS(status);` |
|   1972 | 5776 | `		}else if( WIFSIGNALED(status) ){` |
...
|   3949 | 5788 | `	SyMemBackendFree(&pVm->sAllocator, pPipe);` |
|   3949 | 5789 | `	return status;` |
|   1977 | 5790 | `}` |
|      - | 5791 | `/*` |
...
|      - | 5805 | ` */` |
|   5810 | 5806 | `static ph7_int64 PipeStream_Read(void *pHandle, void *pBuffer, ph7_int64 nDatatoRead)` |
|      4 | 5807 | `{` |
|   5814 | 5808 | `	pipe_private *pPipe = (pipe_private *)pHandle;` |
|      - | 5809 | `	size_t nRead;` |
|   5814 | 5810 | `	if( pPipe == 0 \|\| pPipe->pFile == 0 ){` |
|    ! 0 | 5811 | `		return -1;` |
|      - | 5812 | `	}` |
|   5814 | 5813 | `	if( pPipe->iMode != 'r' ){` |
|      - | 5814 | `		/* Cannot read from a write-only pipe */` |
|    ! 0 | 5815 | `		return -1;` |
|      - | 5816 | `	}` |
|   5814 | 5817 | `	nRead = fread(pBuffer, 1, (size_t)nDatatoRead, pPipe->pFile);` |
|   5814 | 5818 | `	if( nRead == 0 ){` |
|   3970 | 5819 | `		if( feof(pPipe->pFile) ){` |
|   3970 | 5820 | `			return 0; /* EOF */` |
|      - | 5821 | `		}` |
|    ! 0 | 5822 | `		return -1; /* Error */` |
|      - | 5823 | `	}` |
|   1848 | 5824 | `	return (ph7_int64)nRead;` |
|   2909 | 5825 | `}` |
|      - | 5826 | `/*` |
...
|      - | 5868 | ` */` |
|   3852 | 5869 | `static int is_pipe_stream(const ph7_io_stream *pStream)` |
|      5 | 5870 | `{` |
|   3857 | 5871 | `	return pStream == &sPipe_Stream;` |
|      5 | 5872 | `}` |
|      - | 5873 | `/*` |
...
|      - | 5885 | ` */` |
|   3966 | 5886 | `static int PH7_builtin_popen(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 5887 | `{` |
|      - | 5888 | `	const char *zCommand, *zMode;` |
|      - | 5889 | `	pipe_private *pPipe;` |
|      - | 5890 | `	io_private *pDev;` |
|      - | 5891 | `	int nCmdLen, nModeLen;` |
|   3971 | 5892 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) \|\| !ph7_value_is_string(apArg[1]) ){` |
...
|   3971 | 5899 | `	zCommand = ph7_value_to_string(apArg[0], &nCmdLen);` |
|   3971 | 5900 | `	zMode = ph7_value_to_string(apArg[1], &nModeLen);` |
|   3971 | 5901 | `	if( nCmdLen < 1 ){` |
|    ! 0 | 5902 | `		ph7_context_throw_error(pCtx, PH7_CTX_WARNING, "Empty command");` |
|    ! 0 | 5903 | `		ph7_result_bool(pCtx, 0);` |
|    ! 0 | 5904 | `		return PH7_OK;` |
|      - | 5905 | `	}` |
|   3971 | 5906 | `	if( nModeLen < 1 \|\| (zMode[0] != 'r' && zMode[0] != 'w') ){` |
...
|      - | 5910 | `	}` |
|      - | 5911 | `	/* Open the pipe */` |
|   3971 | 5912 | `	pPipe = PipeOpen(pCtx->pVm, zCommand, zMode);` |
|   3971 | 5913 | `	if( pPipe == 0 ){` |
...
|   3971 | 5919 | `	pDev = (io_private *)ph7_context_alloc_chunk(pCtx, sizeof(io_private), TRUE, FALSE);` |
|   3971 | 5920 | `	if( pDev == 0 ){` |
...
|   3971 | 5927 | `	InitIOPrivate(pCtx->pVm, &sPipe_Stream, pDev);` |
|   3971 | 5928 | `	pDev->pHandle = pPipe;` |
|      - | 5929 | `	/* Return the io_private instance as a resource */` |
|   3971 | 5930 | `	ph7_result_resource(pCtx, pDev);` |
|   3971 | 5931 | `	return PH7_OK;` |
|   1988 | 5932 | `}` |
|      - | 5933 | `/*` |
...
|      - | 5941 | ` */` |
|   3852 | 5942 | `static int PH7_builtin_pclose(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 5943 | `{` |
|      - | 5944 | `	const ph7_io_stream *pStream;` |
|      - | 5945 | `	pipe_private *pPipe;` |
|      - | 5946 | `	io_private *pDev;` |
|      - | 5947 | `	int status;` |
|   3857 | 5948 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   3857 | 5955 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 5956 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   3857 | 5957 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   3857 | 5963 | `	pStream = pDev->pStream;` |
|   3857 | 5964 | `	if( pStream == 0 \|\| !is_pipe_stream(pStream) ){` |
...
|   3857 | 5970 | `	pPipe = (pipe_private *)pDev->pHandle;` |
|      - | 5971 | `	/* Close the pipe and get exit status */` |
|   3857 | 5972 | `	status = PipeClose(pPipe);` |
|      - | 5973 | `	/* Release the IO private structure */` |
|   3857 | 5974 | `	ReleaseIOPrivate(pCtx, pDev);` |
|      - | 5975 | `	/* Invalidate the resource handle */` |
|   3857 | 5976 | `	ph7_value_release(apArg[0]);` |
|      - | 5977 | `	/* Return the exit status */` |
|   3857 | 5978 | `	ph7_result_int(pCtx, status);` |
|   3857 | 5979 | `	return PH7_OK;` |
|   1931 | 5980 | `}` |
...
|      - | 6022 | ` */` |
|   3484 | 6023 | `PH7_PRIVATE sxi32 PH7_RegisterIORoutine(ph7_vm *pVm)` |
|      5 | 6024 | `{` |
|      - | 6025 | `	/*` |
...
|      - | 6122 | `	};` |
|   3489 | 6123 | `	const ph7_io_stream *pFileStream = 0;` |
|   3489 | 6124 | `	sxu32 n = 0;` |
|      - | 6125 | `	/* Register disk-related functions */` |
| 170721 | 6126 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVfsDiskFunc) ; ++n ){` |
| 167237 | 6127 | `		ph7_create_function(&(*pVm),aVfsDiskFunc[n].zName,aVfsDiskFunc[n].xFunc,(void *)pVm->pEngine->pVfs);` |
|  83621 | 6128 | `	}` |
| 125429 | 6129 | `	for( n = 0 ; n < SX_ARRAYSIZE(aIOFunc) ; ++n ){` |
| 121945 | 6130 | `		ph7_create_function(&(*pVm),aIOFunc[n].zName,aIOFunc[n].xFunc,pVm);` |
|  60975 | 6131 | `	}` |
|      - | 6132 | `#else` |
|      - | 6133 | `	SXUNUSED(pVm);` |
...
|      - | 6160 | `	};` |
|  59233 | 6161 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVfsHelperFunc) ; ++n ){` |
|  55749 | 6162 | `		ph7_create_function(&(*pVm),aVfsHelperFunc[n].zName,aVfsHelperFunc[n].xFunc,pVm);` |
|  27877 | 6163 | `	}` |
...
|   3484 | 6171 | `	pFileStream = &sUnixFileStream;` |
|      - | 6172 | `#endif` |
|      - | 6173 | `	/* Install the php:// stream */` |
|   3489 | 6174 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,&sPHP_Stream);` |
|   3489 | 6175 | `	if( pFileStream ){` |
|      - | 6176 | `		/* Install the file:// stream */` |
|   3489 | 6177 | `		ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,pFileStream);` |
|   1742 | 6178 | `	}` |
|      - | 6179 | `#endif /* PH7_DISABLE_DISK_IO */` |
|      - | 6180 |  |
|   3489 | 6181 | `	return SXRET_OK;` |
|      5 | 6182 | `}` |
|      - | 6183 | `/*` |
