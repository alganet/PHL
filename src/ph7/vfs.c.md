...
|      - |  213 | ` */` |
|   8100 |  214 | `static int PH7_vfs_is_dir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  215 | `{` |
|      - |  216 | `	const char *zPath;` |
|      - |  217 | `	ph7_vfs *pVfs;` |
|      - |  218 | `	int rc;` |
|   8105 |  219 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  220 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  221 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  222 | `		return PH7_OK;` |
|      - |  223 | `	}` |
|      - |  224 | `	/* Point to the underlying vfs */` |
|   8105 |  225 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   8105 |  226 | `	if( pVfs == 0 \|\| pVfs->xIsdir == 0 ){` |
...
|   8105 |  236 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  237 | `	/* Perform the requested operation */` |
|   8105 |  238 | `	rc = pVfs->xIsdir(zPath);` |
|      - |  239 | `	/* IO return value */` |
|   8105 |  240 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   8105 |  241 | `	return PH7_OK;` |
|   4055 |  242 | `}` |
|      - |  243 | `/*` |
...
|      - |  476 | ` */` |
|  30948 |  477 | `static int PH7_vfs_unlink(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  478 | `{` |
|      - |  479 | `	const char *zPath;` |
|      - |  480 | `	ph7_vfs *pVfs;` |
|      - |  481 | `	int rc;` |
|  30953 |  482 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  483 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  484 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  485 | `		return PH7_OK;` |
|      - |  486 | `	}` |
|      - |  487 | `	/* Point to the underlying vfs */` |
|  30953 |  488 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  30953 |  489 | `	if( pVfs == 0 \|\| pVfs->xUnlink == 0 ){` |
...
|  30953 |  499 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  500 | `	/* Perform the requested operation */` |
|  30953 |  501 | `	rc = pVfs->xUnlink(zPath);` |
|      - |  502 | `	/* IO return value */` |
|  30953 |  503 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  30953 |  504 | `	return PH7_OK;` |
|  15479 |  505 | `}` |
|      - |  506 | `/*` |
...
|      - |  907 | ` */` |
|   6162 |  908 | `static int PH7_vfs_is_file(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  909 | `{` |
|      - |  910 | `	const char *zPath;` |
|      - |  911 | `	ph7_vfs *pVfs;` |
|      - |  912 | `	int rc;` |
|   6167 |  913 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  914 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  915 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  916 | `		return PH7_OK;` |
|      - |  917 | `	}` |
|      - |  918 | `	/* Point to the underlying vfs */` |
|   6167 |  919 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   6167 |  920 | `	if( pVfs == 0 \|\| pVfs->xIsfile == 0 ){` |
...
|   6167 |  930 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  931 | `	/* Perform the requested operation */` |
|   6167 |  932 | `	rc = pVfs->xIsfile(zPath);` |
|      - |  933 | `	/* IO return value */` |
|   6167 |  934 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   6167 |  935 | `	return PH7_OK;` |
|   3086 |  936 | `}` |
|      - |  937 | `/*` |
...
|      - | 1554 | ` */` |
|  12314 | 1555 | `static sxi32 ExtractPathInfo(const char *zPath,int nByte,path_info *pOut)` |
|      5 | 1556 | `{` |
|  12319 | 1557 | `	const char *zPtr,*zEnd = &zPath[nByte - 1];` |
|      - | 1558 | `	SyString *pCur;` |
|      - | 1559 | `	int c,d;` |
|  12319 | 1560 | `	c = d = '/';` |
...
|  12319 | 1565 | `	SyZero(pOut,sizeof(path_info));` |
|      - | 1566 | `	/* Handle special case */` |
|  12319 | 1567 | `	if( nByte == sizeof(char) && ( (int)zPath[0] == c \|\| (int)zPath[0] == d ) ){` |
...
| 330792 | 1576 | `	while( zEnd > zPath && ( (int)zEnd[0] != c && (int)zEnd[0] != d ) ){` |
| 312321 | 1577 | `		zEnd--;` |
|      5 | 1578 | `	}` |
|  12319 | 1579 | `	zPtr = (zEnd > zPath) ? &zEnd[1] : zPath;` |
|  12319 | 1580 | `	zEnd = &zPath[nByte];` |
|      - | 1581 | `	/* dirname */` |
|  12319 | 1582 | `	pCur = &pOut->sDir;` |
|  12319 | 1583 | `	SyStringInitFromBuf(pCur,zPath,zPtr-zPath);` |
|  12319 | 1584 | `	if( pCur->nByte > 1 ){` |
|  24633 | 1585 | `		SyStringTrimTrailingChar(pCur,'/');` |
|      - | 1586 | `#ifdef __WINNT__` |
|      5 | 1587 | `		SyStringTrimTrailingChar(pCur,'\\');` |
|      - | 1588 | `#endif` |
|   6162 | 1589 | `	}else if( (int)zPath[0] == c \|\| (int)zPath[0] == d ){` |
...
|  12319 | 1597 | `	pCur = &pOut->sBasename;` |
|  12319 | 1598 | `	SyStringInitFromBuf(pCur,zPtr,zEnd-zPtr);` |
|  12319 | 1599 | `	SyStringTrimLeadingChar(pCur,'/');` |
|      - | 1600 | `#ifdef __WINNT__` |
|      5 | 1601 | `	SyStringTrimLeadingChar(pCur,'\\');` |
|      - | 1602 | `#endif` |
|  12319 | 1603 | `	SyStringDupPtr(&pOut->sFilename,pCur);` |
|  12319 | 1604 | `	if( pCur->nByte > 0 ){` |
|      - | 1605 | `		/* extension */` |
|  12319 | 1606 | `		zEnd--;` |
|  61569 | 1607 | `		while( zEnd > pCur->zString /*basename*/ && zEnd[0] != '.' ){` |
|  49255 | 1608 | `			zEnd--;` |
|      5 | 1609 | `		}` |
|  12319 | 1610 | `		if( zEnd > pCur->zString ){` |
|  12317 | 1611 | `			zEnd++; /* Jump leading dot */` |
|  12317 | 1612 | `			SyStringInitFromBuf(&pOut->sExtension,zEnd,&zPath[nByte]-zEnd);` |
|      - | 1613 | `			/* Fix filename */` |
|  12317 | 1614 | `			pCur = &pOut->sFilename;` |
|  12317 | 1615 | `			if( pCur->nByte > SyStringLength(&pOut->sExtension) ){` |
|  12317 | 1616 | `				pCur->nByte -= 1 + SyStringLength(&pOut->sExtension);` |
|   6156 | 1617 | `			}` |
|   6156 | 1618 | `		}` |
|   6157 | 1619 | `	}` |
|  12319 | 1620 | `	return SXRET_OK;` |
|   6162 | 1621 | `}` |
|      - | 1622 | `/*` |
...
|      - | 1625 | ` */` |
|  12314 | 1626 | `static int PH7_builtin_pathinfo(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1627 | `{` |
|      - | 1628 | `	const char *zPath;` |
|      - | 1629 | `	path_info sInfo;` |
|      - | 1630 | `	SyString *pComp;` |
|      - | 1631 | `	int iLen;` |
|  12319 | 1632 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  12319 | 1638 | `	zPath = ph7_value_to_string(apArg[0],&iLen);` |
|  12319 | 1639 | `	if( iLen < 1 ){` |
|      - | 1640 | `		/* Empty string */` |
|    ! 0 | 1641 | `		ph7_result_string(pCtx,"",0);` |
|    ! 0 | 1642 | `		return PH7_OK;` |
|      - | 1643 | `	}` |
|      - | 1644 | `	/* Extract path info */` |
|  12319 | 1645 | `	ExtractPathInfo(zPath,iLen,&sInfo);` |
|  18475 | 1646 | `	if( nArg > 1 && ph7_value_is_int(apArg[1]) ){` |
|      - | 1647 | `		/* Return path component */` |
|  12317 | 1648 | `		int nComp = ph7_value_to_int(apArg[1]);` |
|  12317 | 1649 | `		switch(nComp){` |
...
|      - | 1666 | `			}` |
|      3 | 1667 | `			break;` |
|   3079 | 1668 | `		case 3: /*PATHINFO_EXTENSION*/` |
|   6163 | 1669 | `			pComp = &sInfo.sExtension;` |
|   6163 | 1670 | `			if( pComp->nByte > 0 ){` |
|   6161 | 1671 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   3083 | 1672 | `			}else{` |
|      - | 1673 | `				/* Expand the empty string */` |
|      3 | 1674 | `				ph7_result_string(pCtx,"",0);` |
|      - | 1675 | `			}` |
|   6163 | 1676 | `			break;` |
|   3075 | 1677 | `		case 4: /*PATHINFO_FILENAME*/` |
|   6155 | 1678 | `			pComp = &sInfo.sFilename;` |
|   6155 | 1679 | `			if( pComp->nByte > 0 ){` |
|   6155 | 1680 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   3080 | 1681 | `			}else{` |
...
|      - | 2707 | ` */` |
|  10092 | 2708 | `static int PH7_builtin_feof(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2709 | `{` |
|      - | 2710 | `	const ph7_io_stream *pStream;` |
|      - | 2711 | `	io_private *pDev;` |
|      - | 2712 | `	int rc;` |
|  10097 | 2713 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|  10097 | 2720 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 2721 | `	/* Make sure we are dealing with a valid io_private instance */` |
|  10097 | 2722 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|  10097 | 2729 | `	pStream = pDev->pStream;` |
|  10097 | 2730 | `	if( pStream == 0 ){` |
...
|      - | 2737 | `	}` |
|  10097 | 2738 | `	rc = SXERR_EOF;` |
|      - | 2739 | `	/* Perform the requested operation */` |
|  10097 | 2740 | `	if( SyBlobLength(&pDev->sBuffer) > pDev->nOfft ){` |
...
|   5555 | 2747 | `		n = pStream->xRead(pDev->pHandle,zBuf,sizeof(zBuf));` |
|   5555 | 2748 | `		if( n > 0 ){` |
|      - | 2749 | `			/* Copy buffered data */` |
|   1743 | 2750 | `			SyBlobAppend(&pDev->sBuffer,zBuf,(sxu32)n);` |
|   1743 | 2751 | `			rc = PH7_OK;` |
|    869 | 2752 | `		}` |
|      - | 2753 | `	}` |
|      - | 2754 | `	/* EOF or not */` |
|  10097 | 2755 | `	ph7_result_bool(pCtx,rc == SXERR_EOF);` |
|  10097 | 2756 | `	return PH7_OK;` |
|   5051 | 2757 | `}` |
|      - | 2758 | `/*` |
...
|      - | 2802 | ` */` |
|   6340 | 2803 | `static sxi32 GetLine(io_private *pDev,ph7_int64 *pLen,const char **pzLine)` |
|      5 | 2804 | `{` |
|      - | 2805 | `	const char *zIn,*zEnd,*zPtr;` |
|   6345 | 2806 | `	zIn = (const char *)SyBlobDataAt(&pDev->sBuffer,pDev->nOfft);` |
|   6345 | 2807 | `	zEnd = &zIn[SyBlobLength(&pDev->sBuffer)-pDev->nOfft];` |
|   6345 | 2808 | `	zPtr = zIn;` |
| 377850 | 2809 | `	while( zIn < zEnd ){` |
| 377770 | 2810 | `		if( zIn[0] == '\n' ){` |
|      - | 2811 | `			/* Line found */` |
|   6265 | 2812 | `			zIn++; /* Include the line ending as requested by the PHP specification */` |
|   6265 | 2813 | `			*pLen = (ph7_int64)(zIn-zPtr);` |
|   6265 | 2814 | `			*pzLine = zPtr;` |
|   6265 | 2815 | `			return SXRET_OK;` |
|      - | 2816 | `		}` |
| 371510 | 2817 | `		zIn++;` |
|      5 | 2818 | `	}` |
|      - | 2819 | `	/* No line were found */` |
|     85 | 2820 | `	return SXERR_NOTFOUND;` |
|   3175 | 2821 | `}` |
|      - | 2822 | `/*` |
|      - | 2823 | ` * Read a single line from the underlying IO stream device.` |
|      - | 2824 | ` */` |
|   6344 | 2825 | `static ph7_int64 StreamReadLine(io_private *pDev,const char **pzData,ph7_int64 nMaxLen)` |
|      5 | 2826 | `{` |
|   6349 | 2827 | `	const ph7_io_stream *pStream = pDev->pStream;` |
|      - | 2828 | `	char zBuf[8192];` |
|      - | 2829 | `	ph7_int64 n;` |
|      - | 2830 | `	sxi32 rc;` |
|   6349 | 2831 | `	n = 0;` |
|   6349 | 2832 | `	if( pDev->nOfft >= SyBlobLength(&pDev->sBuffer) ){` |
...
|     30 | 2836 | `	}` |
|   6349 | 2837 | `	if( SyBlobLength(&pDev->sBuffer) > pDev->nOfft ){` |
|      - | 2838 | `		/* Check if there is a line */` |
|   6289 | 2839 | `		rc = GetLine(pDev,&n,pzData);` |
|   6289 | 2840 | `		if( rc == SXRET_OK ){` |
|      - | 2841 | `			/* Got line,update the cursor  */` |
|   6211 | 2842 | `			pDev->nOfft += (sxu32)n;` |
|   6211 | 2843 | `			return n;` |
|      - | 2844 | `		}` |
|     39 | 2845 | `	}` |
...
|      - | 2848 | `	 */` |
|     70 | 2849 | `	for(;;){` |
|    145 | 2850 | `		n = pStream->xRead(pDev->pHandle,zBuf, (nMaxLen > 0 && nMaxLen < (ph7_int64)sizeof(zBuf)) ? nMaxLen : (ph7_int64)sizeof(zBuf));` |
|    145 | 2851 | `		if( n < 1 ){` |
...
|      - | 2872 | `		}` |
|      1 | 2873 | `	}` |
|     89 | 2874 | `	if( SyBlobLength(&pDev->sBuffer) > pDev->nOfft ){` |
|      - | 2875 | `		/* Read limit reached,return the available data */` |
|     85 | 2876 | `		*pzData = (const char *)SyBlobDataAt(&pDev->sBuffer,pDev->nOfft);` |
|     85 | 2877 | `		n = SyBlobLength(&pDev->sBuffer) - pDev->nOfft;` |
|      - | 2878 | `		/* Reset the working buffer */` |
|     85 | 2879 | `		SyBlobReset(&pDev->sBuffer);` |
|     85 | 2880 | `		pDev->nOfft = 0;` |
|     40 | 2881 | `	}` |
|     89 | 2882 | `	return n;` |
|   3177 | 2883 | `}` |
|      - | 2884 | `/*` |
...
|      - | 2904 | ` */` |
|  30224 | 2905 | `PH7_PRIVATE void * PH7_StreamOpenHandle(ph7_vm *pVm,const ph7_io_stream *pStream,const char *zFile,` |
|      - | 2906 | `	int iFlags,int use_include,ph7_value *pResource,int bPushInclude,int *pNew)` |
|      5 | 2907 | `{` |
|  30229 | 2908 | `	void *pHandle = 0; /* cc warning */` |
|      - | 2909 | `	SyString sFile;` |
|      - | 2910 | `	int rc;` |
|  30229 | 2911 | `	if( pStream == 0 ){` |
|      - | 2912 | `		/* No such stream device */` |
|    ! 0 | 2913 | `		return 0;` |
|      - | 2914 | `	}` |
|  30229 | 2915 | `	SyStringInitFromBuf(&sFile,zFile,SyStrlen(zFile));` |
|  30229 | 2916 | `	if( use_include ){` |
...
|   9971 | 2948 | `					if( bPushInclude ){` |
|      - | 2949 | `						/* Mark as included */` |
|   9971 | 2950 | `						PH7_VmPushFilePath(pVm,(const char *)SyBlobData(&sWorker),SyBlobLength(&sWorker),FALSE,pNew);` |
|   4984 | 2951 | `					}` |
|   9971 | 2952 | `					break;` |
|      - | 2953 | `				}` |
...
|   9989 | 2961 | `			if( bPushInclude ){` |
|      - | 2962 | `				/* Mark as included */` |
|   9989 | 2963 | `				PH7_VmPushFilePath(pVm,sFile.zString,sFile.nByte,FALSE,pNew);` |
|   4993 | 2964 | `			}` |
|   4993 | 2965 | `		}` |
|   5000 | 2966 | `	}else{` |
|      - | 2967 | `		/* Open the URI direcly */` |
|  20237 | 2968 | `		rc = pStream->xOpen(zFile,iFlags,pResource,&pHandle);` |
|      - | 2969 | `	}` |
|  30229 | 2970 | `	if( rc != PH7_OK ){` |
|      - | 2971 | `		/* IO error */` |
|     15 | 2972 | `		return 0;` |
|      - | 2973 | `	}` |
|      - | 2974 | `	/* Return the file handle */` |
|  30217 | 2975 | `	return pHandle;` |
|  15117 | 2976 | `}` |
|      - | 2977 | `/*` |
...
|   9980 | 2988 | `	for(;;){` |
|  19963 | 2989 | `		nRead = pStream->xRead(pHandle,zBuf,sizeof(zBuf));` |
|  19963 | 2990 | `		if( nRead < 1 ){` |
|      - | 2991 | `			/* EOF or IO error */` |
|   9983 | 2992 | `			break;` |
|      - | 2993 | `		}` |
|      - | 2994 | `		/* Append contents */` |
|   9983 | 2995 | `		rc = SyBlobAppend(pOut,zBuf,(sxu32)nRead);` |
|   9983 | 2996 | `		if( rc != SXRET_OK ){` |
|    ! 0 | 2997 | `			break;` |
|      - | 2998 | `		}` |
|      3 | 2999 | `	}` |
|   9983 | 3000 | `	return SyBlobLength(pOut) > 0 ? SXRET_OK : -1;` |
|      3 | 3001 | `}` |
|      - | 3002 | `/*` |
|      - | 3003 | ` * Close an open IO stream handle [i.e local file/URI..].` |
|      - | 3004 | ` */` |
|  30304 | 3005 | `PH7_PRIVATE void PH7_StreamCloseHandle(const ph7_io_stream *pStream,void *pHandle)` |
|      5 | 3006 | `{` |
|  30309 | 3007 | `	if( pStream->xClose ){` |
|  30309 | 3008 | `		pStream->xClose(pHandle);` |
|  15152 | 3009 | `	}` |
|  30309 | 3010 | `}` |
|      - | 3011 | `/*` |
...
|      - | 3080 | ` */` |
|   6334 | 3081 | `static int PH7_builtin_fgets(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3082 | `{` |
|      - | 3083 | `	const ph7_io_stream *pStream;` |
|      - | 3084 | `	const char *zLine;` |
|      - | 3085 | `	io_private *pDev;` |
|      - | 3086 | `	ph7_int64 n,nLen;` |
|   6339 | 3087 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   6339 | 3094 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3095 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   6339 | 3096 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   6339 | 3103 | `	pStream = pDev->pStream;` |
|   6339 | 3104 | `	if( pStream == 0  ){` |
...
|   6339 | 3118 | `	n = StreamReadLine(pDev,&zLine,nLen);` |
|   6339 | 3119 | `	if( n < 1 ){` |
|      - | 3120 | `		/* EOF or IO error,return FALSE */` |
|      7 | 3121 | `		ph7_result_bool(pCtx,0);` |
|      6 | 3122 | `	}else{` |
|      - | 3123 | `		/* Return the freshly extracted line */` |
|   6337 | 3124 | `		ph7_result_string(pCtx,zLine,(int)n);` |
|      - | 3125 | `	}` |
|   6339 | 3126 | `	return PH7_OK;` |
|   3172 | 3127 | `}` |
|      - | 3128 | `/*` |
...
|      - | 3389 | ` */` |
|   8098 | 3390 | `static int PH7_builtin_readdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3391 | `{` |
|      - | 3392 | `	const ph7_io_stream *pStream;` |
|      - | 3393 | `	io_private *pDev;` |
|      - | 3394 | `	int rc;` |
|   8103 | 3395 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   8103 | 3402 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3403 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   8103 | 3404 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   8103 | 3411 | `	pStream = pDev->pStream;` |
|   8103 | 3412 | `	if( pStream == 0  \|\| pStream->xReadDir == 0 ){` |
...
|      - | 3419 | `	}` |
|   8103 | 3420 | `	ph7_result_bool(pCtx,0);` |
|      - | 3421 | `	/* Perform the requested operation */` |
|   8103 | 3422 | `	rc = pStream->xReadDir(pDev->pHandle,pCtx);` |
|   8103 | 3423 | `	if( rc != PH7_OK ){` |
|      - | 3424 | `		/* Return FALSE */` |
|    975 | 3425 | `		ph7_result_bool(pCtx,0);` |
|    485 | 3426 | `	}` |
|   8103 | 3427 | `	return PH7_OK;` |
|   4054 | 3428 | `}` |
|      - | 3429 | `/*` |
...
|      - | 3671 | ` */` |
|   6190 | 3672 | `static int PH7_builtin_file_get_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3673 | `{` |
|      - | 3674 | `	const ph7_io_stream *pStream;` |
|      - | 3675 | `	ph7_int64 n,nRead,nMaxlen;` |
|   6195 | 3676 | `	int use_include  = FALSE;` |
|      - | 3677 | `	const char *zFile;` |
|      - | 3678 | `	char zBuf[8192];` |
|      - | 3679 | `	void *pHandle;` |
|      - | 3680 | `	int nLen;` |
|      - | 3681 |  |
|   6195 | 3682 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   6195 | 3689 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3690 | `	/* Point to the target IO stream device */` |
|   6195 | 3691 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|   6195 | 3692 | `	if( pStream == 0 ){` |
...
|   6195 | 3702 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,PH7_IO_OPEN_RDONLY,use_include,nArg > 2 ? apArg[2] : 0,FALSE,0);` |
|   6195 | 3703 | `	if( pHandle == 0 ){` |
...
|   6195 | 3723 | `	nRead = 0;` |
|   6189 | 3724 | `	for(;;){` |
|  18575 | 3725 | `		n = pStream->xRead(pHandle,zBuf,` |
|   6192 | 3726 | `			(nMaxlen > 0 && (nMaxlen < (ph7_int64)sizeof(zBuf))) ? nMaxlen : (ph7_int64)sizeof(zBuf));` |
|  12383 | 3727 | `		if( n < 1 ){` |
|      - | 3728 | `			/* EOF or IO error,break immediately */` |
|   6193 | 3729 | `			break;` |
|      - | 3730 | `		}` |
|      - | 3731 | `		/* Append data */` |
|   6195 | 3732 | `		ph7_result_string(pCtx,zBuf,(int)n);` |
|      - | 3733 | `		/* Increment read counter */` |
|   6195 | 3734 | `		nRead += n;` |
|   6195 | 3735 | `		if( nMaxlen > 0 && nRead >= nMaxlen ){` |
|      - | 3736 | `			/* Read limit reached */` |
|      3 | 3737 | `			break;` |
|      - | 3738 | `		}` |
|      5 | 3739 | `	}` |
|      - | 3740 | `	/* Close the stream */` |
|   6195 | 3741 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|      - | 3742 | `	/* Check if we have read something */` |
|   6195 | 3743 | `	if( ph7_context_result_buf_length(pCtx) < 1 ){` |
|      - | 3744 | `		/* Nothing read,return FALSE */` |
|    ! 0 | 3745 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 3746 | `	}` |
|   6195 | 3747 | `	return PH7_OK;` |
|   3100 | 3748 | `}` |
|      - | 3749 | `/*` |
...
|      - | 3767 | ` */` |
|  13958 | 3768 | `static int PH7_builtin_file_put_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3769 | `{` |
|  13963 | 3770 | `	int use_include  = FALSE;` |
...
|      - | 3777 | `	int nLen;` |
|      - | 3778 |  |
|  13963 | 3779 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  13963 | 3786 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3787 | `	/* Point to the target IO stream device */` |
|  13963 | 3788 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|  13963 | 3789 | `	if( pStream == 0 ){` |
...
|      - | 3793 | `	}` |
|      - | 3794 | `	/* Data to write */` |
|  13963 | 3795 | `	zData = ph7_value_to_string(apArg[1],&nLen);` |
|      - | 3796 | `	/* Try to open the file in read-write mode */` |
|  13963 | 3797 | `	iOpenFlags = PH7_IO_OPEN_CREATE\|PH7_IO_OPEN_RDWR\|PH7_IO_OPEN_TRUNC;` |
|      - | 3798 | `	/* Extract the flags */` |
|  13963 | 3799 | `	iFlags = 0;` |
|  13963 | 3800 | `	if( nArg > 2 ){` |
...
|    ! 0 | 3812 | `		}` |
|    ! 0 | 3813 | `	}` |
|  20942 | 3814 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,iOpenFlags,use_include,` |
|   6979 | 3815 | `		nArg > 3 ? apArg[3] : 0,FALSE,FALSE);` |
|  13963 | 3816 | `	if( pHandle == 0 ){` |
...
|  13957 | 3851 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|  13957 | 3852 | `	return PH7_OK;` |
|   6984 | 3853 | `}` |
|      - | 3854 | `/*` |
...
|      - | 4728 | ` */` |
|   4932 | 4729 | `static void InitIOPrivate(ph7_vm *pVm,const ph7_io_stream *pStream,io_private *pOut)` |
|      5 | 4730 | `{` |
|   4937 | 4731 | `	pOut->pStream = pStream;` |
|   4937 | 4732 | `	SyBlobInit(&pOut->sBuffer,&pVm->sAllocator);` |
|   4937 | 4733 | `	pOut->nOfft = 0;` |
|      - | 4734 | `	/* Set the magic number */` |
|   4937 | 4735 | `	pOut->iMagic = IO_PRIVATE_MAGIC;` |
|   4937 | 4736 | `}` |
|      - | 4737 | `/*` |
|      - | 4738 | ` * Release the IO private structure.` |
|      - | 4739 | ` */` |
|   4900 | 4740 | `static void ReleaseIOPrivate(ph7_context *pCtx,io_private *pDev)` |
|      5 | 4741 | `{` |
|   4905 | 4742 | `	SyBlobRelease(&pDev->sBuffer);` |
|   4905 | 4743 | `	pDev->iMagic = 0x2126; /* Invalid magic number so we can detetct misuse */` |
|      - | 4744 | `	/* Release the whole structure */` |
|   4905 | 4745 | `	ph7_context_free_chunk(pCtx,pDev);` |
|   4905 | 4746 | `}` |
|      - | 4747 | `/*` |
...
|      - | 5176 | ` */` |
|   3826 | 5177 | `PH7_PRIVATE const ph7_vfs * PH7_ExportBuiltinVfs(void)` |
|      5 | 5178 | `{` |
...
|      - | 5596 | ` */` |
|   3886 | 5597 | `static pipe_private * PipeOpen(ph7_vm *pVm, const char *zCommand, const char *zMode)` |
|      5 | 5598 | `{` |
|      - | 5599 | `	pipe_private *pPipe;` |
|      - | 5600 | `	FILE *pFile;` |
|   3891 | 5601 | `	if( pVm == 0 \|\| zCommand == 0 \|\| zMode == 0 ){` |
|    ! 0 | 5602 | `		return 0;` |
|      - | 5603 | `	}` |
|      - | 5604 | `	/* Validate mode - only 'r' or 'w' allowed */` |
|   3891 | 5605 | `	if( zMode[0] != 'r' && zMode[0] != 'w' ){` |
|    ! 0 | 5606 | `		return 0;` |
|      - | 5607 | `	}` |
...
|   3886 | 5669 | `	pFile = popen(zCommand, zMode);` |
|   3886 | 5670 | `	if( pFile == 0 ){` |
|    ! 0 | 5671 | `		return 0;` |
|      - | 5672 | `	}` |
|      - | 5673 | `	/* Allocate pipe private structure */` |
|   3886 | 5674 | `	pPipe = (pipe_private *)SyMemBackendAlloc(&pVm->sAllocator, sizeof(pipe_private));` |
|   3886 | 5675 | `	if( pPipe == 0 ){` |
|      - | 5676 | `		/* Out of memory, close the pipe */` |
|    ! 0 | 5677 | `		pclose(pFile);` |
|    ! 0 | 5678 | `		return 0;` |
|      - | 5679 | `	}` |
|      - | 5680 | `	/* Initialize the structure */` |
|   3886 | 5681 | `	pPipe->pFile = pFile;` |
|   3886 | 5682 | `	pPipe->pVm = pVm;` |
|   3886 | 5683 | `	pPipe->iMode = zMode[0];` |
|      - | 5684 | `#else /* OS_OTHER: no process pipes on this platform */` |
|      - | 5685 | `	(void)pFile;` |
|      - | 5686 | `	return 0;` |
|      - | 5687 | `#endif` |
|   3891 | 5688 | `	return pPipe;` |
|   1948 | 5689 | `}` |
|      - | 5690 | `/*` |
|      - | 5691 | ` * Close a pipe and return the exit status of the process.` |
|      - | 5692 | ` * Returns the exit status, or -1 on error.` |
|      - | 5693 | ` */` |
|   3864 | 5694 | `static int PipeClose(pipe_private *pPipe)` |
|      5 | 5695 | `{` |
|      - | 5696 | `	int status;` |
|      - | 5697 | `	ph7_vm *pVm;` |
|   3869 | 5698 | `	if( pPipe == 0 \|\| pPipe->pFile == 0 ){` |
|    ! 0 | 5699 | `		return -1;` |
|      - | 5700 | `	}` |
|   3869 | 5701 | `	pVm = pPipe->pVm;` |
...
|   3864 | 5707 | `	status = pclose(pPipe->pFile);` |
|      - | 5708 | `	/* On Unix, pclose returns the status from waitpid, need to extract exit code */` |
|   3864 | 5709 | `	if( status != -1 ){` |
|   3864 | 5710 | `		if( WIFEXITED(status) ){` |
|   3864 | 5711 | `			status = WEXITSTATUS(status);` |
|   1932 | 5712 | `		}else if( WIFSIGNALED(status) ){` |
...
|   3869 | 5724 | `	SyMemBackendFree(&pVm->sAllocator, pPipe);` |
|   3869 | 5725 | `	return status;` |
|   1937 | 5726 | `}` |
|      - | 5727 | `/*` |
...
|      - | 5741 | ` */` |
|   5668 | 5742 | `static ph7_int64 PipeStream_Read(void *pHandle, void *pBuffer, ph7_int64 nDatatoRead)` |
|      4 | 5743 | `{` |
|   5672 | 5744 | `	pipe_private *pPipe = (pipe_private *)pHandle;` |
|      - | 5745 | `	size_t nRead;` |
|   5672 | 5746 | `	if( pPipe == 0 \|\| pPipe->pFile == 0 ){` |
|    ! 0 | 5747 | `		return -1;` |
|      - | 5748 | `	}` |
|   5672 | 5749 | `	if( pPipe->iMode != 'r' ){` |
|      - | 5750 | `		/* Cannot read from a write-only pipe */` |
|    ! 0 | 5751 | `		return -1;` |
|      - | 5752 | `	}` |
|   5672 | 5753 | `	nRead = fread(pBuffer, 1, (size_t)nDatatoRead, pPipe->pFile);` |
|   5672 | 5754 | `	if( nRead == 0 ){` |
|   3886 | 5755 | `		if( feof(pPipe->pFile) ){` |
|   3886 | 5756 | `			return 0; /* EOF */` |
|      - | 5757 | `		}` |
|    ! 0 | 5758 | `		return -1; /* Error */` |
|      - | 5759 | `	}` |
|   1790 | 5760 | `	return (ph7_int64)nRead;` |
|   2838 | 5761 | `}` |
|      - | 5762 | `/*` |
...
|      - | 5804 | ` */` |
|   3770 | 5805 | `static int is_pipe_stream(const ph7_io_stream *pStream)` |
|      5 | 5806 | `{` |
|   3775 | 5807 | `	return pStream == &sPipe_Stream;` |
|      5 | 5808 | `}` |
|      - | 5809 | `/*` |
...
|      - | 5821 | ` */` |
|   3886 | 5822 | `static int PH7_builtin_popen(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 5823 | `{` |
|      - | 5824 | `	const char *zCommand, *zMode;` |
|      - | 5825 | `	pipe_private *pPipe;` |
|      - | 5826 | `	io_private *pDev;` |
|      - | 5827 | `	int nCmdLen, nModeLen;` |
|   3891 | 5828 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) \|\| !ph7_value_is_string(apArg[1]) ){` |
...
|   3891 | 5835 | `	zCommand = ph7_value_to_string(apArg[0], &nCmdLen);` |
|   3891 | 5836 | `	zMode = ph7_value_to_string(apArg[1], &nModeLen);` |
|   3891 | 5837 | `	if( nCmdLen < 1 ){` |
|    ! 0 | 5838 | `		ph7_context_throw_error(pCtx, PH7_CTX_WARNING, "Empty command");` |
|    ! 0 | 5839 | `		ph7_result_bool(pCtx, 0);` |
|    ! 0 | 5840 | `		return PH7_OK;` |
|      - | 5841 | `	}` |
|   3891 | 5842 | `	if( nModeLen < 1 \|\| (zMode[0] != 'r' && zMode[0] != 'w') ){` |
...
|      - | 5846 | `	}` |
|      - | 5847 | `	/* Open the pipe */` |
|   3891 | 5848 | `	pPipe = PipeOpen(pCtx->pVm, zCommand, zMode);` |
|   3891 | 5849 | `	if( pPipe == 0 ){` |
...
|   3891 | 5855 | `	pDev = (io_private *)ph7_context_alloc_chunk(pCtx, sizeof(io_private), TRUE, FALSE);` |
|   3891 | 5856 | `	if( pDev == 0 ){` |
...
|   3891 | 5863 | `	InitIOPrivate(pCtx->pVm, &sPipe_Stream, pDev);` |
|   3891 | 5864 | `	pDev->pHandle = pPipe;` |
|      - | 5865 | `	/* Return the io_private instance as a resource */` |
|   3891 | 5866 | `	ph7_result_resource(pCtx, pDev);` |
|   3891 | 5867 | `	return PH7_OK;` |
|   1948 | 5868 | `}` |
|      - | 5869 | `/*` |
...
|      - | 5877 | ` */` |
|   3770 | 5878 | `static int PH7_builtin_pclose(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 5879 | `{` |
|      - | 5880 | `	const ph7_io_stream *pStream;` |
|      - | 5881 | `	pipe_private *pPipe;` |
|      - | 5882 | `	io_private *pDev;` |
|      - | 5883 | `	int status;` |
|   3775 | 5884 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   3775 | 5891 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 5892 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   3775 | 5893 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   3775 | 5899 | `	pStream = pDev->pStream;` |
|   3775 | 5900 | `	if( pStream == 0 \|\| !is_pipe_stream(pStream) ){` |
...
|   3775 | 5906 | `	pPipe = (pipe_private *)pDev->pHandle;` |
|      - | 5907 | `	/* Close the pipe and get exit status */` |
|   3775 | 5908 | `	status = PipeClose(pPipe);` |
|      - | 5909 | `	/* Release the IO private structure */` |
|   3775 | 5910 | `	ReleaseIOPrivate(pCtx, pDev);` |
|      - | 5911 | `	/* Invalidate the resource handle */` |
|   3775 | 5912 | `	ph7_value_release(apArg[0]);` |
|      - | 5913 | `	/* Return the exit status */` |
|   3775 | 5914 | `	ph7_result_int(pCtx, status);` |
|   3775 | 5915 | `	return PH7_OK;` |
|   1890 | 5916 | `}` |
...
|      - | 5958 | ` */` |
|   3420 | 5959 | `PH7_PRIVATE sxi32 PH7_RegisterIORoutine(ph7_vm *pVm)` |
|      5 | 5960 | `{` |
|      - | 5961 | `	/*` |
...
|      - | 6058 | `	};` |
|   3425 | 6059 | `	const ph7_io_stream *pFileStream = 0;` |
|   3425 | 6060 | `	sxu32 n = 0;` |
|      - | 6061 | `	/* Register disk-related functions */` |
| 167585 | 6062 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVfsDiskFunc) ; ++n ){` |
| 164165 | 6063 | `		ph7_create_function(&(*pVm),aVfsDiskFunc[n].zName,aVfsDiskFunc[n].xFunc,(void *)pVm->pEngine->pVfs);` |
|  82085 | 6064 | `	}` |
| 123125 | 6065 | `	for( n = 0 ; n < SX_ARRAYSIZE(aIOFunc) ; ++n ){` |
| 119705 | 6066 | `		ph7_create_function(&(*pVm),aIOFunc[n].zName,aIOFunc[n].xFunc,pVm);` |
|  59855 | 6067 | `	}` |
|      - | 6068 | `#else` |
|      - | 6069 | `	SXUNUSED(pVm);` |
...
|      - | 6096 | `	};` |
|  58145 | 6097 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVfsHelperFunc) ; ++n ){` |
|  54725 | 6098 | `		ph7_create_function(&(*pVm),aVfsHelperFunc[n].zName,aVfsHelperFunc[n].xFunc,pVm);` |
|  27365 | 6099 | `	}` |
...
|   3420 | 6107 | `	pFileStream = &sUnixFileStream;` |
|      - | 6108 | `#endif` |
|      - | 6109 | `	/* Install the php:// stream */` |
|   3425 | 6110 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,&sPHP_Stream);` |
|   3425 | 6111 | `	if( pFileStream ){` |
|      - | 6112 | `		/* Install the file:// stream */` |
|   3425 | 6113 | `		ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,pFileStream);` |
|   1710 | 6114 | `	}` |
|      - | 6115 | `#endif /* PH7_DISABLE_DISK_IO */` |
|      - | 6116 |  |
|   3425 | 6117 | `	return SXRET_OK;` |
|      5 | 6118 | `}` |
|      - | 6119 | `/*` |
