...
|      - |   65 | ` */` |
|  13546 |   66 | `static int PH7_vfs_chdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |   67 | `{` |
|      - |   68 | `	const char *zPath;` |
|      - |   69 | `	ph7_vfs *pVfs;` |
|      - |   70 | `	int rc;` |
|  13551 |   71 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |   72 | `		/* Missing/Invalid argument,return FALSE */` |
|      6 |   73 | `		ph7_result_bool(pCtx,0);` |
|      6 |   74 | `		return PH7_OK;` |
|      - |   75 | `	}` |
|      - |   76 | `	/* Point to the underlying vfs */` |
|  13547 |   77 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  13547 |   78 | `	if( pVfs == 0 \|\| pVfs->xChdir == 0 ){` |
...
|  13547 |   88 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |   89 | `	/* Perform the requested operation */` |
|  13547 |   90 | `	rc = pVfs->xChdir(zPath);` |
|      - |   91 | `	/* IO return value */` |
|  13547 |   92 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  13547 |   93 | `	return PH7_OK;` |
|   6778 |   94 | `}` |
|      - |   95 | `/*` |
...
|      - |  213 | ` */` |
|   8394 |  214 | `static int PH7_vfs_is_dir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  215 | `{` |
|      - |  216 | `	const char *zPath;` |
|      - |  217 | `	ph7_vfs *pVfs;` |
|      - |  218 | `	int rc;` |
|   8399 |  219 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  220 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  221 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  222 | `		return PH7_OK;` |
|      - |  223 | `	}` |
|      - |  224 | `	/* Point to the underlying vfs */` |
|   8399 |  225 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   8399 |  226 | `	if( pVfs == 0 \|\| pVfs->xIsdir == 0 ){` |
...
|   8399 |  236 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  237 | `	/* Perform the requested operation */` |
|   8399 |  238 | `	rc = pVfs->xIsdir(zPath);` |
|      - |  239 | `	/* IO return value */` |
|   8399 |  240 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   8399 |  241 | `	return PH7_OK;` |
|   4202 |  242 | `}` |
|      - |  243 | `/*` |
...
|      - |  476 | ` */` |
|  32298 |  477 | `static int PH7_vfs_unlink(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  478 | `{` |
|      - |  479 | `	const char *zPath;` |
|      - |  480 | `	ph7_vfs *pVfs;` |
|      - |  481 | `	int rc;` |
|  32303 |  482 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  483 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  484 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  485 | `		return PH7_OK;` |
|      - |  486 | `	}` |
|      - |  487 | `	/* Point to the underlying vfs */` |
|  32303 |  488 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  32303 |  489 | `	if( pVfs == 0 \|\| pVfs->xUnlink == 0 ){` |
...
|  32303 |  499 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  500 | `	/* Perform the requested operation */` |
|  32303 |  501 | `	rc = pVfs->xUnlink(zPath);` |
|      - |  502 | `	/* IO return value */` |
|  32303 |  503 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  32303 |  504 | `	return PH7_OK;` |
|  16154 |  505 | `}` |
|      - |  506 | `/*` |
...
|      - |  907 | ` */` |
|   6432 |  908 | `static int PH7_vfs_is_file(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  909 | `{` |
|      - |  910 | `	const char *zPath;` |
|      - |  911 | `	ph7_vfs *pVfs;` |
|      - |  912 | `	int rc;` |
|   6437 |  913 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  914 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  915 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  916 | `		return PH7_OK;` |
|      - |  917 | `	}` |
|      - |  918 | `	/* Point to the underlying vfs */` |
|   6437 |  919 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   6437 |  920 | `	if( pVfs == 0 \|\| pVfs->xIsfile == 0 ){` |
...
|   6437 |  930 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  931 | `	/* Perform the requested operation */` |
|   6437 |  932 | `	rc = pVfs->xIsfile(zPath);` |
|      - |  933 | `	/* IO return value */` |
|   6437 |  934 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   6437 |  935 | `	return PH7_OK;` |
|   3221 |  936 | `}` |
|      - |  937 | `/*` |
...
|      - | 1554 | ` */` |
|  12854 | 1555 | `static sxi32 ExtractPathInfo(const char *zPath,int nByte,path_info *pOut)` |
|      5 | 1556 | `{` |
|  12859 | 1557 | `	const char *zPtr,*zEnd = &zPath[nByte - 1];` |
|      - | 1558 | `	SyString *pCur;` |
|      - | 1559 | `	int c,d;` |
|  12859 | 1560 | `	c = d = '/';` |
...
|  12859 | 1565 | `	SyZero(pOut,sizeof(path_info));` |
|      - | 1566 | `	/* Handle special case */` |
|  12859 | 1567 | `	if( nByte == sizeof(char) && ( (int)zPath[0] == c \|\| (int)zPath[0] == d ) ){` |
...
| 346914 | 1576 | `	while( zEnd > zPath && ( (int)zEnd[0] != c && (int)zEnd[0] != d ) ){` |
| 327633 | 1577 | `		zEnd--;` |
|      5 | 1578 | `	}` |
|  12859 | 1579 | `	zPtr = (zEnd > zPath) ? &zEnd[1] : zPath;` |
|  12859 | 1580 | `	zEnd = &zPath[nByte];` |
|      - | 1581 | `	/* dirname */` |
|  12859 | 1582 | `	pCur = &pOut->sDir;` |
|  12859 | 1583 | `	SyStringInitFromBuf(pCur,zPath,zPtr-zPath);` |
|  12859 | 1584 | `	if( pCur->nByte > 1 ){` |
|  25713 | 1585 | `		SyStringTrimTrailingChar(pCur,'/');` |
|      - | 1586 | `#ifdef __WINNT__` |
|      5 | 1587 | `		SyStringTrimTrailingChar(pCur,'\\');` |
|      - | 1588 | `#endif` |
|   6432 | 1589 | `	}else if( (int)zPath[0] == c \|\| (int)zPath[0] == d ){` |
...
|  12859 | 1597 | `	pCur = &pOut->sBasename;` |
|  12859 | 1598 | `	SyStringInitFromBuf(pCur,zPtr,zEnd-zPtr);` |
|  12859 | 1599 | `	SyStringTrimLeadingChar(pCur,'/');` |
|      - | 1600 | `#ifdef __WINNT__` |
|      5 | 1601 | `	SyStringTrimLeadingChar(pCur,'\\');` |
|      - | 1602 | `#endif` |
|  12859 | 1603 | `	SyStringDupPtr(&pOut->sFilename,pCur);` |
|  12859 | 1604 | `	if( pCur->nByte > 0 ){` |
|      - | 1605 | `		/* extension */` |
|  12859 | 1606 | `		zEnd--;` |
|  64269 | 1607 | `		while( zEnd > pCur->zString /*basename*/ && zEnd[0] != '.' ){` |
|  51415 | 1608 | `			zEnd--;` |
|      5 | 1609 | `		}` |
|  12859 | 1610 | `		if( zEnd > pCur->zString ){` |
|  12857 | 1611 | `			zEnd++; /* Jump leading dot */` |
|  12857 | 1612 | `			SyStringInitFromBuf(&pOut->sExtension,zEnd,&zPath[nByte]-zEnd);` |
|      - | 1613 | `			/* Fix filename */` |
|  12857 | 1614 | `			pCur = &pOut->sFilename;` |
|  12857 | 1615 | `			if( pCur->nByte > SyStringLength(&pOut->sExtension) ){` |
|  12857 | 1616 | `				pCur->nByte -= 1 + SyStringLength(&pOut->sExtension);` |
|   6426 | 1617 | `			}` |
|   6426 | 1618 | `		}` |
|   6427 | 1619 | `	}` |
|  12859 | 1620 | `	return SXRET_OK;` |
|   6432 | 1621 | `}` |
|      - | 1622 | `/*` |
...
|      - | 1625 | ` */` |
|  12854 | 1626 | `static int PH7_builtin_pathinfo(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1627 | `{` |
|      - | 1628 | `	const char *zPath;` |
|      - | 1629 | `	path_info sInfo;` |
|      - | 1630 | `	SyString *pComp;` |
|      - | 1631 | `	int iLen;` |
|  12859 | 1632 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  12859 | 1638 | `	zPath = ph7_value_to_string(apArg[0],&iLen);` |
|  12859 | 1639 | `	if( iLen < 1 ){` |
|      - | 1640 | `		/* Empty string */` |
|    ! 0 | 1641 | `		ph7_result_string(pCtx,"",0);` |
|    ! 0 | 1642 | `		return PH7_OK;` |
|      - | 1643 | `	}` |
|      - | 1644 | `	/* Extract path info */` |
|  12859 | 1645 | `	ExtractPathInfo(zPath,iLen,&sInfo);` |
|  19285 | 1646 | `	if( nArg > 1 && ph7_value_is_int(apArg[1]) ){` |
|      - | 1647 | `		/* Return path component */` |
|  12857 | 1648 | `		int nComp = ph7_value_to_int(apArg[1]);` |
|  12857 | 1649 | `		switch(nComp){` |
...
|      - | 1666 | `			}` |
|      3 | 1667 | `			break;` |
|   3214 | 1668 | `		case 3: /*PATHINFO_EXTENSION*/` |
|   6433 | 1669 | `			pComp = &sInfo.sExtension;` |
|   6433 | 1670 | `			if( pComp->nByte > 0 ){` |
|   6431 | 1671 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   3218 | 1672 | `			}else{` |
|      - | 1673 | `				/* Expand the empty string */` |
|      3 | 1674 | `				ph7_result_string(pCtx,"",0);` |
|      - | 1675 | `			}` |
|   6433 | 1676 | `			break;` |
|   3210 | 1677 | `		case 4: /*PATHINFO_FILENAME*/` |
|   6425 | 1678 | `			pComp = &sInfo.sFilename;` |
|   6425 | 1679 | `			if( pComp->nByte > 0 ){` |
|   6425 | 1680 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   3215 | 1681 | `			}else{` |
...
|      - | 2919 | ` */` |
|  30034 | 2920 | `PH7_PRIVATE void * PH7_StreamOpenHandle(ph7_vm *pVm,const ph7_io_stream *pStream,const char *zFile,` |
|      - | 2921 | `	int iFlags,int use_include,ph7_value *pResource,int bPushInclude,int *pNew)` |
|      5 | 2922 | `{` |
|  30039 | 2923 | `	void *pHandle = 0; /* cc warning */` |
|      - | 2924 | `	SyString sFile;` |
|      - | 2925 | `	int rc;` |
|  30039 | 2926 | `	if( pStream == 0 ){` |
|      - | 2927 | `		/* No such stream device */` |
|    ! 0 | 2928 | `		return 0;` |
|      - | 2929 | `	}` |
|  30039 | 2930 | `	SyStringInitFromBuf(&sFile,zFile,SyStrlen(zFile));` |
|  30039 | 2931 | `	if( use_include ){` |
...
|  20311 | 2983 | `		rc = pStream->xOpen(zFile,iFlags,pResource,&pHandle);` |
|      - | 2984 | `	}` |
|  30039 | 2985 | `	if( rc != PH7_OK ){` |
|      - | 2986 | `		/* IO error */` |
|     15 | 2987 | `		return 0;` |
|      - | 2988 | `	}` |
|      - | 2989 | `	/* Return the file handle */` |
|  30027 | 2990 | `	return pHandle;` |
|  15022 | 2991 | `}` |
|      - | 2992 | `/*` |
...
|      - | 3019 | ` */` |
|  30114 | 3020 | `PH7_PRIVATE void PH7_StreamCloseHandle(const ph7_io_stream *pStream,void *pHandle)` |
|      5 | 3021 | `{` |
|  30119 | 3022 | `	if( pStream->xClose ){` |
|  30119 | 3023 | `		pStream->xClose(pHandle);` |
|  15057 | 3024 | `	}` |
|  30119 | 3025 | `}` |
|      - | 3026 | `/*` |
...
|      - | 3404 | ` */` |
|   8392 | 3405 | `static int PH7_builtin_readdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3406 | `{` |
|      - | 3407 | `	const ph7_io_stream *pStream;` |
|      - | 3408 | `	io_private *pDev;` |
|      - | 3409 | `	int rc;` |
|   8397 | 3410 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   8397 | 3417 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3418 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   8397 | 3419 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   8397 | 3426 | `	pStream = pDev->pStream;` |
|   8397 | 3427 | `	if( pStream == 0  \|\| pStream->xReadDir == 0 ){` |
...
|      - | 3434 | `	}` |
|   8397 | 3435 | `	ph7_result_bool(pCtx,0);` |
|      - | 3436 | `	/* Perform the requested operation */` |
|   8397 | 3437 | `	rc = pStream->xReadDir(pDev->pHandle,pCtx);` |
|   8397 | 3438 | `	if( rc != PH7_OK ){` |
|      - | 3439 | `		/* Return FALSE */` |
|    987 | 3440 | `		ph7_result_bool(pCtx,0);` |
|    491 | 3441 | `	}` |
|   8397 | 3442 | `	return PH7_OK;` |
|   4201 | 3443 | `}` |
|      - | 3444 | `/*` |
...
|      - | 3686 | ` */` |
|   6460 | 3687 | `static int PH7_builtin_file_get_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3688 | `{` |
|      - | 3689 | `	const ph7_io_stream *pStream;` |
|      - | 3690 | `	ph7_int64 n,nRead,nMaxlen;` |
|   6465 | 3691 | `	int use_include  = FALSE;` |
|      - | 3692 | `	const char *zFile;` |
|      - | 3693 | `	char zBuf[8192];` |
|      - | 3694 | `	void *pHandle;` |
|      - | 3695 | `	int nLen;` |
|      - | 3696 |  |
|   6465 | 3697 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   6465 | 3704 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3705 | `	/* Point to the target IO stream device */` |
|   6465 | 3706 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|   6465 | 3707 | `	if( pStream == 0 ){` |
...
|   6465 | 3717 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,PH7_IO_OPEN_RDONLY,use_include,nArg > 2 ? apArg[2] : 0,FALSE,0);` |
|   6465 | 3718 | `	if( pHandle == 0 ){` |
...
|   6465 | 3738 | `	nRead = 0;` |
|   6458 | 3739 | `	for(;;){` |
|  19382 | 3740 | `		n = pStream->xRead(pHandle,zBuf,` |
|   6461 | 3741 | `			(nMaxlen > 0 && (nMaxlen < (ph7_int64)sizeof(zBuf))) ? nMaxlen : (ph7_int64)sizeof(zBuf));` |
|  12921 | 3742 | `		if( n < 1 ){` |
|      - | 3743 | `			/* EOF or IO error,break immediately */` |
|   6463 | 3744 | `			break;` |
|      - | 3745 | `		}` |
|      - | 3746 | `		/* Append data */` |
|   6463 | 3747 | `		ph7_result_string(pCtx,zBuf,(int)n);` |
|      - | 3748 | `		/* Increment read counter */` |
|   6463 | 3749 | `		nRead += n;` |
|   6463 | 3750 | `		if( nMaxlen > 0 && nRead >= nMaxlen ){` |
|      - | 3751 | `			/* Read limit reached */` |
|      3 | 3752 | `			break;` |
|      - | 3753 | `		}` |
|      5 | 3754 | `	}` |
|      - | 3755 | `	/* Close the stream */` |
|   6465 | 3756 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|      - | 3757 | `	/* Check if we have read something */` |
|   6465 | 3758 | `	if( ph7_context_result_buf_length(pCtx) < 1 ){` |
|      - | 3759 | `		/* Nothing read,return FALSE */` |
|      3 | 3760 | `		ph7_result_bool(pCtx,0);` |
|      1 | 3761 | `	}` |
|   6465 | 3762 | `	return PH7_OK;` |
|   3235 | 3763 | `}` |
|      - | 3764 | `/*` |
...
|      - | 3782 | ` */` |
|  13762 | 3783 | `static int PH7_builtin_file_put_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3784 | `{` |
|  13767 | 3785 | `	int use_include  = FALSE;` |
...
|      - | 3792 | `	int nLen;` |
|      - | 3793 |  |
|  13767 | 3794 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  13767 | 3801 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3802 | `	/* Point to the target IO stream device */` |
|  13767 | 3803 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|  13767 | 3804 | `	if( pStream == 0 ){` |
...
|      - | 3808 | `	}` |
|      - | 3809 | `	/* Data to write */` |
|  13767 | 3810 | `	zData = ph7_value_to_string(apArg[1],&nLen);` |
|      - | 3811 | `	/* Try to open the file in read-write mode */` |
|  13767 | 3812 | `	iOpenFlags = PH7_IO_OPEN_CREATE\|PH7_IO_OPEN_RDWR\|PH7_IO_OPEN_TRUNC;` |
|      - | 3813 | `	/* Extract the flags */` |
|  13767 | 3814 | `	iFlags = 0;` |
|  13767 | 3815 | `	if( nArg > 2 ){` |
...
|    ! 0 | 3827 | `		}` |
|    ! 0 | 3828 | `	}` |
|  20648 | 3829 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,iOpenFlags,use_include,` |
|   6881 | 3830 | `		nArg > 3 ? apArg[3] : 0,FALSE,FALSE);` |
|  13767 | 3831 | `	if( pHandle == 0 ){` |
...
|  13761 | 3866 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|  13761 | 3867 | `	return PH7_OK;` |
|   6886 | 3868 | `}` |
|      - | 3869 | `/*` |
