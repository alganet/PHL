...
|      - |   65 | ` */` |
|   9722 |   66 | `static int PH7_vfs_chdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 |   67 |  |
|      - |   68 | `	const char *zPath;` |
|      - |   69 | `	ph7_vfs *pVfs;` |
|      - |   70 | `	int rc;` |
|   9724 |   71 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |   72 | `		/* Missing/Invalid argument,return FALSE */` |
|      8 |   73 | `		ph7_result_bool(pCtx,0);` |
|      8 |   74 | `		return PH7_OK;` |
|      - |   75 | `	}` |
|      - |   76 | `	/* Point to the underlying vfs */` |
|   9718 |   77 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   9718 |   78 | `	if( pVfs == 0 \|\| pVfs->xChdir == 0 ){` |
...
|   9718 |   88 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |   89 | `	/* Perform the requested operation */` |
|   9718 |   90 | `	rc = pVfs->xChdir(zPath);` |
|      - |   91 | `	/* IO return value */` |
|   9718 |   92 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   9718 |   93 | `	return PH7_OK;` |
|   4863 |   94 |  |
|      - |   95 | `/*` |
...
|      - |  213 | ` */` |
|   5806 |  214 | `static int PH7_vfs_is_dir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 |  215 |  |
|      - |  216 | `	const char *zPath;` |
|      - |  217 | `	ph7_vfs *pVfs;` |
|      - |  218 | `	int rc;` |
|   5808 |  219 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  220 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  221 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  222 | `		return PH7_OK;` |
|      - |  223 | `	}` |
|      - |  224 | `	/* Point to the underlying vfs */` |
|   5808 |  225 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   5808 |  226 | `	if( pVfs == 0 \|\| pVfs->xIsdir == 0 ){` |
...
|   5808 |  236 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  237 | `	/* Perform the requested operation */` |
|   5808 |  238 | `	rc = pVfs->xIsdir(zPath);` |
|      - |  239 | `	/* IO return value */` |
|   5808 |  240 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   5808 |  241 | `	return PH7_OK;` |
|   2905 |  242 |  |
|      - |  243 | `/*` |
...
|      - |  476 | ` */` |
|  20642 |  477 | `static int PH7_vfs_unlink(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 |  478 |  |
|      - |  479 | `	const char *zPath;` |
|      - |  480 | `	ph7_vfs *pVfs;` |
|      - |  481 | `	int rc;` |
|  20644 |  482 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  483 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  484 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  485 | `		return PH7_OK;` |
|      - |  486 | `	}` |
|      - |  487 | `	/* Point to the underlying vfs */` |
|  20644 |  488 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  20644 |  489 | `	if( pVfs == 0 \|\| pVfs->xUnlink == 0 ){` |
...
|  20644 |  499 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  500 | `	/* Perform the requested operation */` |
|  20644 |  501 | `	rc = pVfs->xUnlink(zPath);` |
|      - |  502 | `	/* IO return value */` |
|  20644 |  503 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  20644 |  504 | `	return PH7_OK;` |
|  10323 |  505 |  |
|      - |  506 | `/*` |
...
|      - |  907 | ` */` |
|   4102 |  908 | `static int PH7_vfs_is_file(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 |  909 |  |
|      - |  910 | `	const char *zPath;` |
|      - |  911 | `	ph7_vfs *pVfs;` |
|      - |  912 | `	int rc;` |
|   4104 |  913 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  914 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  915 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  916 | `		return PH7_OK;` |
|      - |  917 | `	}` |
|      - |  918 | `	/* Point to the underlying vfs */` |
|   4104 |  919 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   4104 |  920 | `	if( pVfs == 0 \|\| pVfs->xIsfile == 0 ){` |
...
|   4104 |  930 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  931 | `	/* Perform the requested operation */` |
|   4104 |  932 | `	rc = pVfs->xIsfile(zPath);` |
|      - |  933 | `	/* IO return value */` |
|   4104 |  934 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   4104 |  935 | `	return PH7_OK;` |
|   2053 |  936 |  |
|      - |  937 | `/*` |
...
|      - | 1554 | ` */` |
|   8202 | 1555 | `static sxi32 ExtractPathInfo(const char *zPath,int nByte,path_info *pOut)` |
|      2 | 1556 |  |
|   8204 | 1557 | `	const char *zPtr,*zEnd = &zPath[nByte - 1];` |
|      - | 1558 | `	SyString *pCur;` |
|      - | 1559 | `	int c,d;` |
|   8204 | 1560 | `	c = d = '/';` |
...
|   8204 | 1565 | `	SyZero(pOut,sizeof(path_info));` |
|      - | 1566 | `	/* Handle special case */` |
|   8204 | 1567 | `	if( nByte == sizeof(char) && ( (int)zPath[0] == c \|\| (int)zPath[0] == d ) ){` |
...
| 209345 | 1576 | `	while( zEnd > zPath && ( (int)zEnd[0] != c && (int)zEnd[0] != d ) ){` |
| 197042 | 1577 | `		zEnd--;` |
|      2 | 1578 | `	}` |
|   8204 | 1579 | `	zPtr = (zEnd > zPath) ? &zEnd[1] : zPath;` |
|   8204 | 1580 | `	zEnd = &zPath[nByte];` |
|      - | 1581 | `	/* dirname */` |
|   8204 | 1582 | `	pCur = &pOut->sDir;` |
|   8204 | 1583 | `	SyStringInitFromBuf(pCur,zPath,zPtr-zPath);` |
|   8204 | 1584 | `	if( pCur->nByte > 1 ){` |
|  16406 | 1585 | `		SyStringTrimTrailingChar(pCur,'/');` |
|      - | 1586 | `#ifdef __WINNT__` |
|      2 | 1587 | `		SyStringTrimTrailingChar(pCur,'\\');` |
|      - | 1588 | `#endif` |
|   4103 | 1589 | `	}else if( (int)zPath[0] == c \|\| (int)zPath[0] == d ){` |
...
|   8204 | 1597 | `	pCur = &pOut->sBasename;` |
|   8204 | 1598 | `	SyStringInitFromBuf(pCur,zPtr,zEnd-zPtr);` |
|   8204 | 1599 | `	SyStringTrimLeadingChar(pCur,'/');` |
|      - | 1600 | `#ifdef __WINNT__` |
|      2 | 1601 | `	SyStringTrimLeadingChar(pCur,'\\');` |
|      - | 1602 | `#endif` |
|   8204 | 1603 | `	SyStringDupPtr(&pOut->sFilename,pCur);` |
|   8204 | 1604 | `	if( pCur->nByte > 0 ){` |
|      - | 1605 | `		/* extension */` |
|   8204 | 1606 | `		zEnd--;` |
|  41010 | 1607 | `		while( zEnd > pCur->zString /*basename*/ && zEnd[0] != '.' ){` |
|  32808 | 1608 | `			zEnd--;` |
|      2 | 1609 | `		}` |
|   8204 | 1610 | `		if( zEnd > pCur->zString ){` |
|   8202 | 1611 | `			zEnd++; /* Jump leading dot */` |
|   8202 | 1612 | `			SyStringInitFromBuf(&pOut->sExtension,zEnd,&zPath[nByte]-zEnd);` |
|      - | 1613 | `			/* Fix filename */` |
|   8202 | 1614 | `			pCur = &pOut->sFilename;` |
|   8202 | 1615 | `			if( pCur->nByte > SyStringLength(&pOut->sExtension) ){` |
|   8202 | 1616 | `				pCur->nByte -= 1 + SyStringLength(&pOut->sExtension);` |
|   4100 | 1617 | `			}` |
|   4100 | 1618 | `		}` |
|   4101 | 1619 | `	}` |
|   8204 | 1620 | `	return SXRET_OK;` |
|   4103 | 1621 |  |
|      - | 1622 | `/*` |
...
|      - | 1625 | ` */` |
|   8202 | 1626 | `static int PH7_builtin_pathinfo(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 1627 |  |
|      - | 1628 | `	const char *zPath;` |
|      - | 1629 | `	path_info sInfo;` |
|      - | 1630 | `	SyString *pComp;` |
|      - | 1631 | `	int iLen;` |
|   8204 | 1632 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   8204 | 1638 | `	zPath = ph7_value_to_string(apArg[0],&iLen);` |
|   8204 | 1639 | `	if( iLen < 1 ){` |
|      - | 1640 | `		/* Empty string */` |
...
|   8204 | 1645 | `	ExtractPathInfo(zPath,iLen,&sInfo);` |
|  12304 | 1646 | `	if( nArg > 1 && ph7_value_is_int(apArg[1]) ){` |
|      - | 1647 | `		/* Return path component */` |
|   8202 | 1648 | `		int nComp = ph7_value_to_int(apArg[1]);` |
|   8202 | 1649 | `		switch(nComp){` |
...
|      - | 1666 | `			}` |
|      3 | 1667 | `			break;` |
|   2050 | 1668 | `		case 3: /*PATHINFO_EXTENSION*/` |
|   4102 | 1669 | `			pComp = &sInfo.sExtension;` |
|   4102 | 1670 | `			if( pComp->nByte > 0 ){` |
|   4100 | 1671 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   2051 | 1672 | `			}else{` |
|      - | 1673 | `				/* Expand the empty string */` |
|      3 | 1674 | `				ph7_result_string(pCtx,"",0);` |
|      - | 1675 | `			}` |
|   4102 | 1676 | `			break;` |
|   2048 | 1677 | `		case 4: /*PATHINFO_FILENAME*/` |
|   4098 | 1678 | `			pComp = &sInfo.sFilename;` |
|   4098 | 1679 | `			if( pComp->nByte > 0 ){` |
|   4098 | 1680 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   2050 | 1681 | `			}else{` |
...
|      - | 2703 | ` */` |
|   5648 | 2704 | `static int PH7_builtin_feof(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 2705 |  |
|      - | 2706 | `	const ph7_io_stream *pStream;` |
|      - | 2707 | `	io_private *pDev;` |
|      - | 2708 | `	int rc;` |
|   5650 | 2709 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   5650 | 2716 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 2717 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   5650 | 2718 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   5650 | 2725 | `	pStream = pDev->pStream;` |
|   5650 | 2726 | `	if( pStream == 0 ){` |
...
|      - | 2733 | `	}` |
|   5650 | 2734 | `	rc = SXERR_EOF;` |
|      - | 2735 | `	/* Perform the requested operation */` |
|   5650 | 2736 | `	if( SyBlobLength(&pDev->sBuffer) > pDev->nOfft ){` |
...
|   3124 | 2743 | `		n = pStream->xRead(pDev->pHandle,zBuf,sizeof(zBuf));` |
|   3124 | 2744 | `		if( n > 0 ){` |
|      - | 2745 | `			/* Copy buffered data */` |
|    922 | 2746 | `			SyBlobAppend(&pDev->sBuffer,zBuf,(sxu32)n);` |
|    922 | 2747 | `			rc = PH7_OK;` |
|    460 | 2748 | `		}` |
|      - | 2749 | `	}` |
|      - | 2750 | `	/* EOF or not */` |
|   5650 | 2751 | `	ph7_result_bool(pCtx,rc == SXERR_EOF);` |
|   5650 | 2752 | `	return PH7_OK;` |
|   2826 | 2753 |  |
|      - | 2754 | `/*` |
...
|      - | 2798 | ` */` |
|   3462 | 2799 | `static sxi32 GetLine(io_private *pDev,ph7_int64 *pLen,const char **pzLine)` |
|      2 | 2800 |  |
|      - | 2801 | `	const char *zIn,*zEnd,*zPtr;` |
|   3464 | 2802 | `	zIn = (const char *)SyBlobDataAt(&pDev->sBuffer,pDev->nOfft);` |
|   3464 | 2803 | `	zEnd = &zIn[SyBlobLength(&pDev->sBuffer)-pDev->nOfft];` |
|   3464 | 2804 | `	zPtr = zIn;` |
| 260549 | 2805 | `	while( zIn < zEnd ){` |
| 260495 | 2806 | `		if( zIn[0] == '\n' ){` |
|      - | 2807 | `			/* Line found */` |
|   3410 | 2808 | `			zIn++; /* Include the line ending as requested by the PHP specification */` |
|   3410 | 2809 | `			*pLen = (ph7_int64)(zIn-zPtr);` |
|   3410 | 2810 | `			*pzLine = zPtr;` |
|   3410 | 2811 | `			return SXRET_OK;` |
|      - | 2812 | `		}` |
| 257087 | 2813 | `		zIn++;` |
|      2 | 2814 | `	}` |
...
|      - | 2820 | ` */` |
|   3466 | 2821 | `static ph7_int64 StreamReadLine(io_private *pDev,const char **pzData,ph7_int64 nMaxLen)` |
|      2 | 2822 |  |
|   3468 | 2823 | `	const ph7_io_stream *pStream = pDev->pStream;` |
|      - | 2824 | `	char zBuf[8192];` |
|      - | 2825 | `	ph7_int64 n;` |
|      - | 2826 | `	sxi32 rc;` |
|   3468 | 2827 | `	n = 0;` |
|   3468 | 2828 | `	if( pDev->nOfft >= SyBlobLength(&pDev->sBuffer) ){` |
...
|      8 | 2832 | `	}` |
|   3468 | 2833 | `	if( SyBlobLength(&pDev->sBuffer) > pDev->nOfft ){` |
|      - | 2834 | `		/* Check if there is a line */` |
|   3452 | 2835 | `		rc = GetLine(pDev,&n,pzData);` |
|   3452 | 2836 | `		if( rc == SXRET_OK ){` |
|      - | 2837 | `			/* Got line,update the cursor  */` |
|   3400 | 2838 | `			pDev->nOfft += (sxu32)n;` |
|   3400 | 2839 | `			return n;` |
|      - | 2840 | `		}` |
|     26 | 2841 | `	}` |
...
|      - | 2900 | ` */` |
|  21674 | 2901 | `PH7_PRIVATE void * PH7_StreamOpenHandle(ph7_vm *pVm,const ph7_io_stream *pStream,const char *zFile,` |
|      - | 2902 | `	int iFlags,int use_include,ph7_value *pResource,int bPushInclude,int *pNew)` |
|      2 | 2903 |  |
|  21676 | 2904 | `	void *pHandle = 0; /* cc warning */` |
|      - | 2905 | `	SyString sFile;` |
|      - | 2906 | `	int rc;` |
|  21676 | 2907 | `	if( pStream == 0 ){` |
|      - | 2908 | `		/* No such stream device */` |
|    ! 0 | 2909 | `		return 0;` |
|      - | 2910 | `	}` |
|  21676 | 2911 | `	SyStringInitFromBuf(&sFile,zFile,SyStrlen(zFile));` |
|  21676 | 2912 | `	if( use_include ){` |
|   7546 | 2913 | `		if(	sFile.zString[0] == '/' \|\|` |
|      - | 2914 | `#ifdef __WINNT__` |
|      - | 2915 | `			(sFile.nByte > 2 && sFile.zString[1] == ':' && (sFile.zString[2] == '\\' \|\| sFile.zString[2] == '/') ) \|\|` |
|      - | 2916 | `#endif` |
|   7536 | 2917 | `			(sFile.nByte > 1 && sFile.zString[0] == '.' && sFile.zString[1] == '/') \|\|` |
|   7534 | 2918 | `			(sFile.nByte > 2 && sFile.zString[0] == '.' && sFile.zString[1] == '.' && sFile.zString[2] == '/') ){` |
...
|   7536 | 2930 | `			SyBlobInit(&sWorker,&pVm->sAllocator);` |
|      - | 2931 | `			/* Build a path from the set of include path */` |
|   7536 | 2932 | `			SySetResetCursor(&pVm->aPaths);` |
|   7536 | 2933 | `			rc = SXERR_IO;` |
|   7538 | 2934 | `			while( SXRET_OK == SySetGetNextEntry(&pVm->aPaths,(void **)&pPath) ){` |
|      - | 2935 | `				/* Build full path */` |
|   7536 | 2936 | `				SyBlobFormat(&sWorker,"%z%c%z",pPath,c,&sFile);` |
|      - | 2937 | `				/* Append null terminator */` |
|   7536 | 2938 | `				if( SXRET_OK != SyBlobNullAppend(&sWorker) ){` |
|    ! 0 | 2939 | `					continue;` |
|      - | 2940 | `				}` |
|      - | 2941 | `				/* Try to open the file */` |
|   7536 | 2942 | `				rc = pStream->xOpen((const char *)SyBlobData(&sWorker),iFlags,pResource,&pHandle);` |
|   7536 | 2943 | `				if( rc == PH7_OK ){` |
|   7533 | 2944 | `					if( bPushInclude ){` |
|      - | 2945 | `						/* Mark as included */` |
|   7533 | 2946 | `						PH7_VmPushFilePath(pVm,(const char *)SyBlobData(&sWorker),SyBlobLength(&sWorker),FALSE,pNew);` |
|   3766 | 2947 | `					}` |
|   7533 | 2948 | `					break;` |
|      - | 2949 | `				}` |
...
|      1 | 2953 | `			}` |
|   7536 | 2954 | `			SyBlobRelease(&sWorker);` |
|      - | 2955 | `		}` |
|   7548 | 2956 | `		if( rc == PH7_OK ){` |
|   7545 | 2957 | `			if( bPushInclude ){` |
|      - | 2958 | `				/* Mark as included */` |
|   7545 | 2959 | `				PH7_VmPushFilePath(pVm,sFile.zString,sFile.nByte,FALSE,pNew);` |
|   3772 | 2960 | `			}` |
|   3772 | 2961 | `		}` |
|   3775 | 2962 | `	}else{` |
|      - | 2963 | `		/* Open the URI direcly */` |
|  14130 | 2964 | `		rc = pStream->xOpen(zFile,iFlags,pResource,&pHandle);` |
|      - | 2965 | `	}` |
|  21676 | 2966 | `	if( rc != PH7_OK ){` |
|      - | 2967 | `		/* IO error */` |
|      9 | 2968 | `		return 0;` |
|      - | 2969 | `	}` |
|      - | 2970 | `	/* Return the file handle */` |
|  21668 | 2971 | `	return pHandle;` |
|  10839 | 2972 |  |
|      - | 2973 | `/*` |
...
|      - | 2977 | ` */` |
|   7542 | 2978 | `PH7_PRIVATE sxi32 PH7_StreamReadWholeFile(void *pHandle,const ph7_io_stream *pStream,SyBlob *pOut)` |
|      1 | 2979 |  |
...
|   7542 | 2984 | `	for(;;){` |
|  15085 | 2985 | `		nRead = pStream->xRead(pHandle,zBuf,sizeof(zBuf));` |
|  15085 | 2986 | `		if( nRead < 1 ){` |
|      - | 2987 | `			/* EOF or IO error */` |
|   7543 | 2988 | `			break;` |
|      - | 2989 | `		}` |
|      - | 2990 | `		/* Append contents */` |
|   7543 | 2991 | `		rc = SyBlobAppend(pOut,zBuf,(sxu32)nRead);` |
|   7543 | 2992 | `		if( rc != SXRET_OK ){` |
|    ! 0 | 2993 | `			break;` |
|      - | 2994 | `		}` |
|      1 | 2995 | `	}` |
|   7543 | 2996 | `	return SyBlobLength(pOut) > 0 ? SXRET_OK : -1;` |
|      1 | 2997 |  |
|      - | 2998 | `/*` |
|      - | 2999 | ` * Close an open IO stream handle [i.e local file/URI..].` |
|      - | 3000 | ` */` |
|  21678 | 3001 | `PH7_PRIVATE void PH7_StreamCloseHandle(const ph7_io_stream *pStream,void *pHandle)` |
|      2 | 3002 |  |
|  21680 | 3003 | `	if( pStream->xClose ){` |
|  21680 | 3004 | `		pStream->xClose(pHandle);` |
|  10839 | 3005 | `	}` |
|  21680 | 3006 |  |
|      - | 3007 | `/*` |
...
|      - | 3076 | ` */` |
|   3456 | 3077 | `static int PH7_builtin_fgets(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 3078 |  |
|      - | 3079 | `	const ph7_io_stream *pStream;` |
|      - | 3080 | `	const char *zLine;` |
|      - | 3081 | `	io_private *pDev;` |
|      - | 3082 | `	ph7_int64 n,nLen;` |
|   3458 | 3083 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   3458 | 3090 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3091 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   3458 | 3092 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   3458 | 3099 | `	pStream = pDev->pStream;` |
|   3458 | 3100 | `	if( pStream == 0  ){` |
...
|   3458 | 3114 | `	n = StreamReadLine(pDev,&zLine,nLen);` |
|   3458 | 3115 | `	if( n < 1 ){` |
|      - | 3116 | `		/* EOF or IO error,return FALSE */` |
|      3 | 3117 | `		ph7_result_bool(pCtx,0);` |
|      2 | 3118 | `	}else{` |
|      - | 3119 | `		/* Return the freshly extracted line */` |
|   3456 | 3120 | `		ph7_result_string(pCtx,zLine,(int)n);` |
|      - | 3121 | `	}` |
|   3458 | 3122 | `	return PH7_OK;` |
|   1730 | 3123 |  |
|      - | 3124 | `/*` |
...
|      - | 3385 | ` */` |
|   5804 | 3386 | `static int PH7_builtin_readdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 3387 |  |
|      - | 3388 | `	const ph7_io_stream *pStream;` |
|      - | 3389 | `	io_private *pDev;` |
|      - | 3390 | `	int rc;` |
|   5806 | 3391 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   5806 | 3398 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3399 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   5806 | 3400 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   5806 | 3407 | `	pStream = pDev->pStream;` |
|   5806 | 3408 | `	if( pStream == 0  \|\| pStream->xReadDir == 0 ){` |
...
|      - | 3415 | `	}` |
|   5806 | 3416 | `	ph7_result_bool(pCtx,0);` |
|      - | 3417 | `	/* Perform the requested operation */` |
|   5806 | 3418 | `	rc = pStream->xReadDir(pDev->pHandle,pCtx);` |
|   5806 | 3419 | `	if( rc != PH7_OK ){` |
|      - | 3420 | `		/* Return FALSE */` |
|    854 | 3421 | `		ph7_result_bool(pCtx,0);` |
|    426 | 3422 | `	}` |
|   5806 | 3423 | `	return PH7_OK;` |
|   2904 | 3424 |  |
|      - | 3425 | `/*` |
...
|      - | 3478 | ` */` |
|    854 | 3479 | `static int PH7_builtin_closedir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 3480 |  |
|      - | 3481 | `	const ph7_io_stream *pStream;` |
|      - | 3482 | `	io_private *pDev;` |
|    856 | 3483 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|    856 | 3490 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3491 | `	/* Make sure we are dealing with a valid io_private instance */` |
|    856 | 3492 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|    856 | 3499 | `	pStream = pDev->pStream;` |
|    856 | 3500 | `	if( pStream == 0  \|\| pStream->xCloseDir == 0 ){` |
...
|    856 | 3509 | `	pStream->xCloseDir(pDev->pHandle);` |
|      - | 3510 | `	/* Release the private stucture */` |
|    856 | 3511 | `	ReleaseIOPrivate(pCtx,pDev);` |
|    856 | 3512 | `	PH7_MemObjRelease(apArg[0]);` |
|    856 | 3513 | `	return PH7_OK;` |
|    429 | 3514 | ` }` |
|      - | 3515 | `/*` |
...
|      - | 3525 | ` */` |
|    854 | 3526 | `static int PH7_builtin_opendir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 3527 |  |
|      - | 3528 | `	const ph7_io_stream *pStream;` |
|      - | 3529 | `	const char *zPath;` |
|      - | 3530 | `	io_private *pDev;` |
|      - | 3531 | `	int iLen,rc;` |
|    856 | 3532 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|    856 | 3539 | `	zPath  = ph7_value_to_string(apArg[0],&iLen);` |
|      - | 3540 | `	/* Try to extract a stream */` |
|    856 | 3541 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zPath,iLen);` |
|    856 | 3542 | `	if( pStream == 0 ){` |
...
|      - | 3547 | `	}` |
|    856 | 3548 | `	if( pStream->xOpenDir == 0 ){` |
...
|    856 | 3557 | `	pDev = (io_private *)ph7_context_alloc_chunk(pCtx,sizeof(io_private),TRUE,FALSE);` |
|    856 | 3558 | `	if( pDev == 0 ){` |
...
|    856 | 3564 | `	InitIOPrivate(pCtx->pVm,pStream,pDev);` |
|      - | 3565 | `	/* Open the target directory */` |
|    856 | 3566 | `	rc = pStream->xOpenDir(zPath,nArg > 1 ? apArg[1] : 0,&pDev->pHandle);` |
|    856 | 3567 | `	if( rc != PH7_OK ){` |
...
|    856 | 3573 | `		ph7_result_resource(pCtx,pDev);` |
|      - | 3574 | `	}` |
|    856 | 3575 | `	return PH7_OK;` |
|    429 | 3576 |  |
|      - | 3577 | `/*` |
...
|      - | 3667 | ` */` |
|   4136 | 3668 | `static int PH7_builtin_file_get_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 3669 |  |
|      - | 3670 | `	const ph7_io_stream *pStream;` |
|      - | 3671 | `	ph7_int64 n,nRead,nMaxlen;` |
|   4138 | 3672 | `	int use_include  = FALSE;` |
|      - | 3673 | `	const char *zFile;` |
|      - | 3674 | `	char zBuf[8192];` |
|      - | 3675 | `	void *pHandle;` |
|      - | 3676 | `	int nLen;` |
|      - | 3677 |  |
|   4138 | 3678 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   4138 | 3685 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3686 | `	/* Point to the target IO stream device */` |
|   4138 | 3687 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|   4138 | 3688 | `	if( pStream == 0 ){` |
...
|   4138 | 3698 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,PH7_IO_OPEN_RDONLY,use_include,nArg > 2 ? apArg[2] : 0,FALSE,0);` |
|   4138 | 3699 | `	if( pHandle == 0 ){` |
...
|   4138 | 3719 | `	nRead = 0;` |
|   4135 | 3720 | `	for(;;){` |
|  12410 | 3721 | `		n = pStream->xRead(pHandle,zBuf,` |
|   4138 | 3722 | `			(nMaxlen > 0 && (nMaxlen < (ph7_int64)sizeof(zBuf))) ? nMaxlen : (ph7_int64)sizeof(zBuf));` |
|   8272 | 3723 | `		if( n < 1 ){` |
|      - | 3724 | `			/* EOF or IO error,break immediately */` |
|   4136 | 3725 | `			break;` |
|      - | 3726 | `		}` |
|      - | 3727 | `		/* Append data */` |
|   4138 | 3728 | `		ph7_result_string(pCtx,zBuf,(int)n);` |
|      - | 3729 | `		/* Increment read counter */` |
|   4138 | 3730 | `		nRead += n;` |
|   4138 | 3731 | `		if( nMaxlen > 0 && nRead >= nMaxlen ){` |
|      - | 3732 | `			/* Read limit reached */` |
|      3 | 3733 | `			break;` |
|      - | 3734 | `		}` |
|      2 | 3735 | `	}` |
|      - | 3736 | `	/* Close the stream */` |
|   4138 | 3737 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|      - | 3738 | `	/* Check if we have read something */` |
|   4138 | 3739 | `	if( ph7_context_result_buf_length(pCtx) < 1 ){` |
|      - | 3740 | `		/* Nothing read,return FALSE */` |
|    ! 0 | 3741 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 3742 | `	}` |
|   4138 | 3743 | `	return PH7_OK;` |
|   2070 | 3744 |  |
|      - | 3745 | `/*` |
...
|      - | 3763 | ` */` |
|   9908 | 3764 | `static int PH7_builtin_file_put_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 3765 |  |
|   9910 | 3766 | `	int use_include  = FALSE;` |
...
|      - | 3773 | `	int nLen;` |
|      - | 3774 |  |
|   9910 | 3775 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   9910 | 3782 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3783 | `	/* Point to the target IO stream device */` |
|   9910 | 3784 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|   9910 | 3785 | `	if( pStream == 0 ){` |
...
|      - | 3789 | `	}` |
|      - | 3790 | `	/* Data to write */` |
|   9910 | 3791 | `	zData = ph7_value_to_string(apArg[1],&nLen);` |
|      - | 3792 | `	/* Try to open the file in read-write mode */` |
|   9910 | 3793 | `	iOpenFlags = PH7_IO_OPEN_CREATE\|PH7_IO_OPEN_RDWR\|PH7_IO_OPEN_TRUNC;` |
...
|    ! 0 | 3808 | `		}` |
|    ! 0 | 3809 | `	}` |
|  14864 | 3810 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,iOpenFlags,use_include,` |
|   4954 | 3811 | `		nArg > 3 ? apArg[3] : 0,FALSE,FALSE);` |
|   9910 | 3812 | `	if( pHandle == 0 ){` |
...
|   9904 | 3847 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|   9904 | 3848 | `	return PH7_OK;` |
|   4956 | 3849 |  |
|      - | 3850 | `/*` |
...
|      - | 4724 | ` */` |
|   3138 | 4725 | `static void InitIOPrivate(ph7_vm *pVm,const ph7_io_stream *pStream,io_private *pOut)` |
|      2 | 4726 |  |
|   3140 | 4727 | `	pOut->pStream = pStream;` |
|   3140 | 4728 | `	SyBlobInit(&pOut->sBuffer,&pVm->sAllocator);` |
|   3140 | 4729 | `	pOut->nOfft = 0;` |
|      - | 4730 | `	/* Set the magic number */` |
|   3140 | 4731 | `	pOut->iMagic = IO_PRIVATE_MAGIC;` |
|   3140 | 4732 |  |
|      - | 4733 | `/*` |
|      - | 4734 | ` * Release the IO private structure.` |
|      - | 4735 | ` */` |
|   3128 | 4736 | `static void ReleaseIOPrivate(ph7_context *pCtx,io_private *pDev)` |
|      2 | 4737 |  |
|   3130 | 4738 | `	SyBlobRelease(&pDev->sBuffer);` |
|   3130 | 4739 | `	pDev->iMagic = 0x2126; /* Invalid magic number so we can detetct misuse */` |
|      - | 4740 | `	/* Release the whole structure */` |
|   3130 | 4741 | `	ph7_context_free_chunk(pCtx,pDev);` |
|   3130 | 4742 |  |
|      - | 4743 | `/*` |
...
|      - | 5170 | ` */` |
|   2226 | 5171 | `PH7_PRIVATE const ph7_vfs * PH7_ExportBuiltinVfs(void)` |
|      2 | 5172 |  |
...
|      - | 5590 | ` */` |
|   2210 | 5591 | `static pipe_private * PipeOpen(ph7_vm *pVm, const char *zCommand, const char *zMode)` |
|      2 | 5592 |  |
|      - | 5593 | `	pipe_private *pPipe;` |
|      - | 5594 | `	FILE *pFile;` |
|   2212 | 5595 | `	if( pVm == 0 \|\| zCommand == 0 \|\| zMode == 0 ){` |
|    ! 0 | 5596 | `		return 0;` |
|      - | 5597 | `	}` |
|      - | 5598 | `	/* Validate mode - only 'r' or 'w' allowed */` |
|   2212 | 5599 | `	if( zMode[0] != 'r' && zMode[0] != 'w' ){` |
|    ! 0 | 5600 | `		return 0;` |
|      - | 5601 | `	}` |
...
|      - | 5661 | `	}` |
|      - | 5662 | `#else /* Unix */` |
|   2210 | 5663 | `	pFile = popen(zCommand, zMode);` |
|   2210 | 5664 | `	if( pFile == 0 ){` |
|    ! 0 | 5665 | `		return 0;` |
|      - | 5666 | `	}` |
|      - | 5667 | `	/* Allocate pipe private structure */` |
|   2210 | 5668 | `	pPipe = (pipe_private *)SyMemBackendAlloc(&pVm->sAllocator, sizeof(pipe_private));` |
|   2210 | 5669 | `	if( pPipe == 0 ){` |
|      - | 5670 | `		/* Out of memory, close the pipe */` |
|    ! 0 | 5671 | `		pclose(pFile);` |
|    ! 0 | 5672 | `		return 0;` |
|      - | 5673 | `	}` |
|      - | 5674 | `	/* Initialize the structure */` |
|   2210 | 5675 | `	pPipe->pFile = pFile;` |
|   2210 | 5676 | `	pPipe->pVm = pVm;` |
|   2210 | 5677 | `	pPipe->iMode = zMode[0];` |
|      - | 5678 | `#endif` |
|   2212 | 5679 | `	return pPipe;` |
|   1107 | 5680 |  |
|      - | 5681 | `/*` |
|      - | 5682 | ` * Close a pipe and return the exit status of the process.` |
|      - | 5683 | ` * Returns the exit status, or -1 on error.` |
|      - | 5684 | ` */` |
|   2210 | 5685 | `static int PipeClose(pipe_private *pPipe)` |
|      2 | 5686 |  |
|      - | 5687 | `	int status;` |
|      - | 5688 | `	ph7_vm *pVm;` |
|   2212 | 5689 | `	if( pPipe == 0 \|\| pPipe->pFile == 0 ){` |
|    ! 0 | 5690 | `		return -1;` |
|      - | 5691 | `	}` |
|   2212 | 5692 | `	pVm = pPipe->pVm;` |
...
|      - | 5697 | `#else` |
|   2210 | 5698 | `	status = pclose(pPipe->pFile);` |
|      - | 5699 | `	/* On Unix, pclose returns the status from waitpid, need to extract exit code */` |
|   2210 | 5700 | `	if( status != -1 ){` |
|   2210 | 5701 | `		if( WIFEXITED(status) ){` |
|   2210 | 5702 | `			status = WEXITSTATUS(status);` |
|   1105 | 5703 | `		}else if( WIFSIGNALED(status) ){` |
...
|   2212 | 5713 | `	SyMemBackendFree(&pVm->sAllocator, pPipe);` |
|   2212 | 5714 | `	return status;` |
|   1107 | 5715 |  |
|      - | 5716 | `/*` |
...
|      - | 5730 | ` */` |
|   3170 | 5731 | `static ph7_int64 PipeStream_Read(void *pHandle, void *pBuffer, ph7_int64 nDatatoRead)` |
|      1 | 5732 |  |
|   3171 | 5733 | `	pipe_private *pPipe = (pipe_private *)pHandle;` |
|      - | 5734 | `	size_t nRead;` |
|   3171 | 5735 | `	if( pPipe == 0 \|\| pPipe->pFile == 0 ){` |
|    ! 0 | 5736 | `		return -1;` |
|      - | 5737 | `	}` |
|   3171 | 5738 | `	if( pPipe->iMode != 'r' ){` |
|      - | 5739 | `		/* Cannot read from a write-only pipe */` |
|    ! 0 | 5740 | `		return -1;` |
|      - | 5741 | `	}` |
|   3171 | 5742 | `	nRead = fread(pBuffer, 1, (size_t)nDatatoRead, pPipe->pFile);` |
|   3171 | 5743 | `	if( nRead == 0 ){` |
|   2247 | 5744 | `		if( feof(pPipe->pFile) ){` |
|   2247 | 5745 | `			return 0; /* EOF */` |
|      - | 5746 | `		}` |
|    ! 0 | 5747 | `		return -1; /* Error */` |
|      - | 5748 | `	}` |
|    925 | 5749 | `	return (ph7_int64)nRead;` |
|   1586 | 5750 |  |
|      - | 5751 | `/*` |
...
|      - | 5793 | ` */` |
|   2196 | 5794 | `static int is_pipe_stream(const ph7_io_stream *pStream)` |
|      2 | 5795 |  |
|   2198 | 5796 | `	return pStream == &sPipe_Stream;` |
|      2 | 5797 |  |
|      - | 5798 | `/*` |
...
|      - | 5810 | ` */` |
|   2210 | 5811 | `static int PH7_builtin_popen(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 5812 |  |
|      - | 5813 | `	const char *zCommand, *zMode;` |
|      - | 5814 | `	pipe_private *pPipe;` |
|      - | 5815 | `	io_private *pDev;` |
|      - | 5816 | `	int nCmdLen, nModeLen;` |
|   2212 | 5817 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) \|\| !ph7_value_is_string(apArg[1]) ){` |
...
|   2212 | 5824 | `	zCommand = ph7_value_to_string(apArg[0], &nCmdLen);` |
|   2212 | 5825 | `	zMode = ph7_value_to_string(apArg[1], &nModeLen);` |
|   2212 | 5826 | `	if( nCmdLen < 1 ){` |
|    ! 0 | 5827 | `		ph7_context_throw_error(pCtx, PH7_CTX_WARNING, "Empty command");` |
|    ! 0 | 5828 | `		ph7_result_bool(pCtx, 0);` |
|    ! 0 | 5829 | `		return PH7_OK;` |
|      - | 5830 | `	}` |
|   2212 | 5831 | `	if( nModeLen < 1 \|\| (zMode[0] != 'r' && zMode[0] != 'w') ){` |
...
|      - | 5835 | `	}` |
|      - | 5836 | `	/* Open the pipe */` |
|   2212 | 5837 | `	pPipe = PipeOpen(pCtx->pVm, zCommand, zMode);` |
|   2212 | 5838 | `	if( pPipe == 0 ){` |
...
|   2212 | 5844 | `	pDev = (io_private *)ph7_context_alloc_chunk(pCtx, sizeof(io_private), TRUE, FALSE);` |
|   2212 | 5845 | `	if( pDev == 0 ){` |
...
|   2212 | 5852 | `	InitIOPrivate(pCtx->pVm, &sPipe_Stream, pDev);` |
|   2212 | 5853 | `	pDev->pHandle = pPipe;` |
|      - | 5854 | `	/* Return the io_private instance as a resource */` |
|   2212 | 5855 | `	ph7_result_resource(pCtx, pDev);` |
|   2212 | 5856 | `	return PH7_OK;` |
|   1107 | 5857 |  |
|      - | 5858 | `/*` |
...
|      - | 5866 | ` */` |
|   2196 | 5867 | `static int PH7_builtin_pclose(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 5868 |  |
|      - | 5869 | `	const ph7_io_stream *pStream;` |
|      - | 5870 | `	pipe_private *pPipe;` |
|      - | 5871 | `	io_private *pDev;` |
|      - | 5872 | `	int status;` |
|   2198 | 5873 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   2198 | 5880 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 5881 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   2198 | 5882 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   2198 | 5888 | `	pStream = pDev->pStream;` |
|   2198 | 5889 | `	if( pStream == 0 \|\| !is_pipe_stream(pStream) ){` |
...
|   2198 | 5895 | `	pPipe = (pipe_private *)pDev->pHandle;` |
|      - | 5896 | `	/* Close the pipe and get exit status */` |
|   2198 | 5897 | `	status = PipeClose(pPipe);` |
|      - | 5898 | `	/* Release the IO private structure */` |
|   2198 | 5899 | `	ReleaseIOPrivate(pCtx, pDev);` |
|      - | 5900 | `	/* Invalidate the resource handle */` |
|   2198 | 5901 | `	ph7_value_release(apArg[0]);` |
|      - | 5902 | `	/* Return the exit status */` |
|   2198 | 5903 | `	ph7_result_int(pCtx, status);` |
|   2198 | 5904 | `	return PH7_OK;` |
|   1100 | 5905 |  |
...
|      - | 5947 | ` */` |
|   1958 | 5948 | `PH7_PRIVATE sxi32 PH7_RegisterIORoutine(ph7_vm *pVm)` |
|      2 | 5949 |  |
|      - | 5950 | `	/*` |
...
|      - | 6047 | `	};` |
|   1960 | 6048 | `	const ph7_io_stream *pFileStream = 0;` |
|   1960 | 6049 | `	sxu32 n = 0;` |
|      - | 6050 | `	/* Register disk-related functions */` |
|  95944 | 6051 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVfsDiskFunc) ; ++n ){` |
|  93986 | 6052 | `		ph7_create_function(&(*pVm),aVfsDiskFunc[n].zName,aVfsDiskFunc[n].xFunc,(void *)pVm->pEngine->pVfs);` |
|  46994 | 6053 | `	}` |
|  70490 | 6054 | `	for( n = 0 ; n < SX_ARRAYSIZE(aIOFunc) ; ++n ){` |
|  68532 | 6055 | `		ph7_create_function(&(*pVm),aIOFunc[n].zName,aIOFunc[n].xFunc,pVm);` |
|  34267 | 6056 | `	}` |
|      - | 6057 | `#else` |
|      - | 6058 | `	SXUNUSED(pVm);` |
...
|      - | 6085 | `	};` |
|  33288 | 6086 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVfsHelperFunc) ; ++n ){` |
|  31330 | 6087 | `		ph7_create_function(&(*pVm),aVfsHelperFunc[n].zName,aVfsHelperFunc[n].xFunc,pVm);` |
|  15666 | 6088 | `	}` |
...
|   1958 | 6096 | `	pFileStream = &sUnixFileStream;` |
|      - | 6097 | `#endif` |
|      - | 6098 | `	/* Install the php:// stream */` |
|   1960 | 6099 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,&sPHP_Stream);` |
|   1960 | 6100 | `	if( pFileStream ){` |
|      - | 6101 | `		/* Install the file:// stream */` |
|   1960 | 6102 | `		ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,pFileStream);` |
|    979 | 6103 | `	}` |
|      - | 6104 | `#endif /* PH7_DISABLE_DISK_IO */` |
|      - | 6105 |  |
|   1960 | 6106 | `	return SXRET_OK;` |
|      2 | 6107 |  |
|      - | 6108 | `/*` |
