...
|      - |   65 | ` */` |
|  13246 |   66 | `static int PH7_vfs_chdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |   67 | `{` |
|      - |   68 | `	const char *zPath;` |
|      - |   69 | `	ph7_vfs *pVfs;` |
|      - |   70 | `	int rc;` |
|  13251 |   71 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |   72 | `		/* Missing/Invalid argument,return FALSE */` |
|      6 |   73 | `		ph7_result_bool(pCtx,0);` |
|      6 |   74 | `		return PH7_OK;` |
|      - |   75 | `	}` |
|      - |   76 | `	/* Point to the underlying vfs */` |
|  13247 |   77 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  13247 |   78 | `	if( pVfs == 0 \|\| pVfs->xChdir == 0 ){` |
...
|  13247 |   88 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |   89 | `	/* Perform the requested operation */` |
|  13247 |   90 | `	rc = pVfs->xChdir(zPath);` |
|      - |   91 | `	/* IO return value */` |
|  13247 |   92 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  13247 |   93 | `	return PH7_OK;` |
|   6628 |   94 | `}` |
|      - |   95 | `/*` |
...
|      - |  213 | ` */` |
|   8168 |  214 | `static int PH7_vfs_is_dir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  215 | `{` |
|      - |  216 | `	const char *zPath;` |
|      - |  217 | `	ph7_vfs *pVfs;` |
|      - |  218 | `	int rc;` |
|   8173 |  219 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  220 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  221 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  222 | `		return PH7_OK;` |
|      - |  223 | `	}` |
|      - |  224 | `	/* Point to the underlying vfs */` |
|   8173 |  225 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   8173 |  226 | `	if( pVfs == 0 \|\| pVfs->xIsdir == 0 ){` |
...
|   8173 |  236 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  237 | `	/* Perform the requested operation */` |
|   8173 |  238 | `	rc = pVfs->xIsdir(zPath);` |
|      - |  239 | `	/* IO return value */` |
|   8173 |  240 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   8173 |  241 | `	return PH7_OK;` |
|   4089 |  242 | `}` |
|      - |  243 | `/*` |
...
|      - |  476 | ` */` |
|  31288 |  477 | `static int PH7_vfs_unlink(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  478 | `{` |
|      - |  479 | `	const char *zPath;` |
|      - |  480 | `	ph7_vfs *pVfs;` |
|      - |  481 | `	int rc;` |
|  31293 |  482 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  483 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  484 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  485 | `		return PH7_OK;` |
|      - |  486 | `	}` |
|      - |  487 | `	/* Point to the underlying vfs */` |
|  31293 |  488 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  31293 |  489 | `	if( pVfs == 0 \|\| pVfs->xUnlink == 0 ){` |
...
|  31293 |  499 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  500 | `	/* Perform the requested operation */` |
|  31293 |  501 | `	rc = pVfs->xUnlink(zPath);` |
|      - |  502 | `	/* IO return value */` |
|  31293 |  503 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  31293 |  504 | `	return PH7_OK;` |
|  15649 |  505 | `}` |
|      - |  506 | `/*` |
...
|      - |  907 | ` */` |
|   6230 |  908 | `static int PH7_vfs_is_file(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  909 | `{` |
|      - |  910 | `	const char *zPath;` |
|      - |  911 | `	ph7_vfs *pVfs;` |
|      - |  912 | `	int rc;` |
|   6235 |  913 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  914 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  915 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  916 | `		return PH7_OK;` |
|      - |  917 | `	}` |
|      - |  918 | `	/* Point to the underlying vfs */` |
|   6235 |  919 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   6235 |  920 | `	if( pVfs == 0 \|\| pVfs->xIsfile == 0 ){` |
...
|   6235 |  930 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  931 | `	/* Perform the requested operation */` |
|   6235 |  932 | `	rc = pVfs->xIsfile(zPath);` |
|      - |  933 | `	/* IO return value */` |
|   6235 |  934 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   6235 |  935 | `	return PH7_OK;` |
|   3120 |  936 | `}` |
|      - |  937 | `/*` |
...
|      - | 1554 | ` */` |
|  12450 | 1555 | `static sxi32 ExtractPathInfo(const char *zPath,int nByte,path_info *pOut)` |
|      5 | 1556 | `{` |
|  12455 | 1557 | `	const char *zPtr,*zEnd = &zPath[nByte - 1];` |
|      - | 1558 | `	SyString *pCur;` |
|      - | 1559 | `	int c,d;` |
|  12455 | 1560 | `	c = d = '/';` |
...
|  12455 | 1565 | `	SyZero(pOut,sizeof(path_info));` |
|      - | 1566 | `	/* Handle special case */` |
|  12455 | 1567 | `	if( nByte == sizeof(char) && ( (int)zPath[0] == c \|\| (int)zPath[0] == d ) ){` |
...
| 335224 | 1576 | `	while( zEnd > zPath && ( (int)zEnd[0] != c && (int)zEnd[0] != d ) ){` |
| 316549 | 1577 | `		zEnd--;` |
|      5 | 1578 | `	}` |
|  12455 | 1579 | `	zPtr = (zEnd > zPath) ? &zEnd[1] : zPath;` |
|  12455 | 1580 | `	zEnd = &zPath[nByte];` |
|      - | 1581 | `	/* dirname */` |
|  12455 | 1582 | `	pCur = &pOut->sDir;` |
|  12455 | 1583 | `	SyStringInitFromBuf(pCur,zPath,zPtr-zPath);` |
|  12455 | 1584 | `	if( pCur->nByte > 1 ){` |
|  24905 | 1585 | `		SyStringTrimTrailingChar(pCur,'/');` |
|      - | 1586 | `#ifdef __WINNT__` |
|      5 | 1587 | `		SyStringTrimTrailingChar(pCur,'\\');` |
|      - | 1588 | `#endif` |
|   6230 | 1589 | `	}else if( (int)zPath[0] == c \|\| (int)zPath[0] == d ){` |
...
|  12455 | 1597 | `	pCur = &pOut->sBasename;` |
|  12455 | 1598 | `	SyStringInitFromBuf(pCur,zPtr,zEnd-zPtr);` |
|  12455 | 1599 | `	SyStringTrimLeadingChar(pCur,'/');` |
|      - | 1600 | `#ifdef __WINNT__` |
|      5 | 1601 | `	SyStringTrimLeadingChar(pCur,'\\');` |
|      - | 1602 | `#endif` |
|  12455 | 1603 | `	SyStringDupPtr(&pOut->sFilename,pCur);` |
|  12455 | 1604 | `	if( pCur->nByte > 0 ){` |
|      - | 1605 | `		/* extension */` |
|  12455 | 1606 | `		zEnd--;` |
|  62249 | 1607 | `		while( zEnd > pCur->zString /*basename*/ && zEnd[0] != '.' ){` |
|  49799 | 1608 | `			zEnd--;` |
|      5 | 1609 | `		}` |
|  12455 | 1610 | `		if( zEnd > pCur->zString ){` |
|  12453 | 1611 | `			zEnd++; /* Jump leading dot */` |
|  12453 | 1612 | `			SyStringInitFromBuf(&pOut->sExtension,zEnd,&zPath[nByte]-zEnd);` |
|      - | 1613 | `			/* Fix filename */` |
|  12453 | 1614 | `			pCur = &pOut->sFilename;` |
|  12453 | 1615 | `			if( pCur->nByte > SyStringLength(&pOut->sExtension) ){` |
|  12453 | 1616 | `				pCur->nByte -= 1 + SyStringLength(&pOut->sExtension);` |
|   6224 | 1617 | `			}` |
|   6224 | 1618 | `		}` |
|   6225 | 1619 | `	}` |
|  12455 | 1620 | `	return SXRET_OK;` |
|   6230 | 1621 | `}` |
|      - | 1622 | `/*` |
...
|      - | 1625 | ` */` |
|  12450 | 1626 | `static int PH7_builtin_pathinfo(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1627 | `{` |
|      - | 1628 | `	const char *zPath;` |
|      - | 1629 | `	path_info sInfo;` |
|      - | 1630 | `	SyString *pComp;` |
|      - | 1631 | `	int iLen;` |
|  12455 | 1632 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  12455 | 1638 | `	zPath = ph7_value_to_string(apArg[0],&iLen);` |
|  12455 | 1639 | `	if( iLen < 1 ){` |
|      - | 1640 | `		/* Empty string */` |
|    ! 0 | 1641 | `		ph7_result_string(pCtx,"",0);` |
|    ! 0 | 1642 | `		return PH7_OK;` |
|      - | 1643 | `	}` |
|      - | 1644 | `	/* Extract path info */` |
|  12455 | 1645 | `	ExtractPathInfo(zPath,iLen,&sInfo);` |
|  18679 | 1646 | `	if( nArg > 1 && ph7_value_is_int(apArg[1]) ){` |
|      - | 1647 | `		/* Return path component */` |
|  12453 | 1648 | `		int nComp = ph7_value_to_int(apArg[1]);` |
|  12453 | 1649 | `		switch(nComp){` |
...
|      - | 1666 | `			}` |
|      3 | 1667 | `			break;` |
|   3113 | 1668 | `		case 3: /*PATHINFO_EXTENSION*/` |
|   6231 | 1669 | `			pComp = &sInfo.sExtension;` |
|   6231 | 1670 | `			if( pComp->nByte > 0 ){` |
|   6229 | 1671 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   3117 | 1672 | `			}else{` |
|      - | 1673 | `				/* Expand the empty string */` |
|      3 | 1674 | `				ph7_result_string(pCtx,"",0);` |
|      - | 1675 | `			}` |
|   6231 | 1676 | `			break;` |
|   3109 | 1677 | `		case 4: /*PATHINFO_FILENAME*/` |
|   6223 | 1678 | `			pComp = &sInfo.sFilename;` |
|   6223 | 1679 | `			if( pComp->nByte > 0 ){` |
|   6223 | 1680 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   3114 | 1681 | `			}else{` |
...
|   6531 | 2823 | `	zPtr = zIn;` |
| 381110 | 2824 | `	while( zIn < zEnd ){` |
| 381028 | 2825 | `		if( zIn[0] == '\n' ){` |
|      - | 2826 | `			/* Line found */` |
...
|      - | 2919 | ` */` |
|  29264 | 2920 | `PH7_PRIVATE void * PH7_StreamOpenHandle(ph7_vm *pVm,const ph7_io_stream *pStream,const char *zFile,` |
|      - | 2921 | `	int iFlags,int use_include,ph7_value *pResource,int bPushInclude,int *pNew)` |
|      5 | 2922 | `{` |
|  29269 | 2923 | `	void *pHandle = 0; /* cc warning */` |
|      - | 2924 | `	SyString sFile;` |
|      - | 2925 | `	int rc;` |
|  29269 | 2926 | `	if( pStream == 0 ){` |
|      - | 2927 | `		/* No such stream device */` |
|    ! 0 | 2928 | `		return 0;` |
|      - | 2929 | `	}` |
|  29269 | 2930 | `	SyStringInitFromBuf(&sFile,zFile,SyStrlen(zFile));` |
|  29269 | 2931 | `	if( use_include ){` |
|   9468 | 2932 | `		if(	sFile.zString[0] == '/' \|\|` |
|      - | 2933 | `#ifdef __WINNT__` |
|      - | 2934 | `			(sFile.nByte > 2 && sFile.zString[1] == ':' && (sFile.zString[2] == '\\' \|\| sFile.zString[2] == '/') ) \|\|` |
|      - | 2935 | `#endif` |
|   9454 | 2936 | `			(sFile.nByte > 1 && sFile.zString[0] == '.' && sFile.zString[1] == '/') \|\|` |
|   9450 | 2937 | `			(sFile.nByte > 2 && sFile.zString[0] == '.' && sFile.zString[1] == '.' && sFile.zString[2] == '/') ){` |
...
|   9454 | 2949 | `			SyBlobInit(&sWorker,&pVm->sAllocator);` |
|      - | 2950 | `			/* Build a path from the set of include path */` |
|   9454 | 2951 | `			SySetResetCursor(&pVm->aPaths);` |
|   9454 | 2952 | `			rc = SXERR_IO;` |
|   9460 | 2953 | `			while( SXRET_OK == SySetGetNextEntry(&pVm->aPaths,(void **)&pPath) ){` |
|      - | 2954 | `				/* Build full path */` |
|   9454 | 2955 | `				SyBlobFormat(&sWorker,"%z%c%z",pPath,c,&sFile);` |
|      - | 2956 | `				/* Append null terminator */` |
|   9454 | 2957 | `				if( SXRET_OK != SyBlobNullAppend(&sWorker) ){` |
|    ! 0 | 2958 | `					continue;` |
|      - | 2959 | `				}` |
|      - | 2960 | `				/* Try to open the file */` |
|   9454 | 2961 | `				rc = pStream->xOpen((const char *)SyBlobData(&sWorker),iFlags,pResource,&pHandle);` |
|   9454 | 2962 | `				if( rc == PH7_OK ){` |
|   9447 | 2963 | `					if( bPushInclude ){` |
|      - | 2964 | `						/* Mark as included */` |
|   9447 | 2965 | `						PH7_VmPushFilePath(pVm,(const char *)SyBlobData(&sWorker),SyBlobLength(&sWorker),FALSE,pNew);` |
|   4722 | 2966 | `					}` |
|   9447 | 2967 | `					break;` |
|      - | 2968 | `				}` |
...
|      2 | 2972 | `			}` |
|   9454 | 2973 | `			SyBlobRelease(&sWorker);` |
|      - | 2974 | `		}` |
|   9472 | 2975 | `		if( rc == PH7_OK ){` |
|   9465 | 2976 | `			if( bPushInclude ){` |
|      - | 2977 | `				/* Mark as included */` |
|   9465 | 2978 | `				PH7_VmPushFilePath(pVm,sFile.zString,sFile.nByte,FALSE,pNew);` |
|   4731 | 2979 | `			}` |
|   4731 | 2980 | `		}` |
|   4738 | 2981 | `	}else{` |
|      - | 2982 | `		/* Open the URI direcly */` |
|  19801 | 2983 | `		rc = pStream->xOpen(zFile,iFlags,pResource,&pHandle);` |
|      - | 2984 | `	}` |
|  29269 | 2985 | `	if( rc != PH7_OK ){` |
|      - | 2986 | `		/* IO error */` |
|     15 | 2987 | `		return 0;` |
|      - | 2988 | `	}` |
|      - | 2989 | `	/* Return the file handle */` |
|  29257 | 2990 | `	return pHandle;` |
|  14637 | 2991 | `}` |
|      - | 2992 | `/*` |
...
|      - | 2996 | ` */` |
|   9456 | 2997 | `PH7_PRIVATE sxi32 PH7_StreamReadWholeFile(void *pHandle,const ph7_io_stream *pStream,SyBlob *pOut)` |
|      3 | 2998 | `{` |
...
|   9456 | 3003 | `	for(;;){` |
|  18915 | 3004 | `		nRead = pStream->xRead(pHandle,zBuf,sizeof(zBuf));` |
|  18915 | 3005 | `		if( nRead < 1 ){` |
|      - | 3006 | `			/* EOF or IO error */` |
|   9459 | 3007 | `			break;` |
|      - | 3008 | `		}` |
|      - | 3009 | `		/* Append contents */` |
|   9459 | 3010 | `		rc = SyBlobAppend(pOut,zBuf,(sxu32)nRead);` |
|   9459 | 3011 | `		if( rc != SXRET_OK ){` |
|    ! 0 | 3012 | `			break;` |
|      - | 3013 | `		}` |
|      3 | 3014 | `	}` |
|   9459 | 3015 | `	return SyBlobLength(pOut) > 0 ? SXRET_OK : -1;` |
|      3 | 3016 | `}` |
|      - | 3017 | `/*` |
|      - | 3018 | ` * Close an open IO stream handle [i.e local file/URI..].` |
|      - | 3019 | ` */` |
|  29344 | 3020 | `PH7_PRIVATE void PH7_StreamCloseHandle(const ph7_io_stream *pStream,void *pHandle)` |
|      5 | 3021 | `{` |
|  29349 | 3022 | `	if( pStream->xClose ){` |
|  29349 | 3023 | `		pStream->xClose(pHandle);` |
|  14672 | 3024 | `	}` |
|  29349 | 3025 | `}` |
|      - | 3026 | `/*` |
...
|      - | 3404 | ` */` |
|   8166 | 3405 | `static int PH7_builtin_readdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3406 | `{` |
|      - | 3407 | `	const ph7_io_stream *pStream;` |
|      - | 3408 | `	io_private *pDev;` |
|      - | 3409 | `	int rc;` |
|   8171 | 3410 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   8171 | 3417 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3418 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   8171 | 3419 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   8171 | 3426 | `	pStream = pDev->pStream;` |
|   8171 | 3427 | `	if( pStream == 0  \|\| pStream->xReadDir == 0 ){` |
...
|      - | 3434 | `	}` |
|   8171 | 3435 | `	ph7_result_bool(pCtx,0);` |
|      - | 3436 | `	/* Perform the requested operation */` |
|   8171 | 3437 | `	rc = pStream->xReadDir(pDev->pHandle,pCtx);` |
|   8171 | 3438 | `	if( rc != PH7_OK ){` |
|      - | 3439 | `		/* Return FALSE */` |
|    975 | 3440 | `		ph7_result_bool(pCtx,0);` |
|    485 | 3441 | `	}` |
|   8171 | 3442 | `	return PH7_OK;` |
|   4088 | 3443 | `}` |
|      - | 3444 | `/*` |
...
|      - | 3686 | ` */` |
|   6258 | 3687 | `static int PH7_builtin_file_get_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3688 | `{` |
|      - | 3689 | `	const ph7_io_stream *pStream;` |
|      - | 3690 | `	ph7_int64 n,nRead,nMaxlen;` |
|   6263 | 3691 | `	int use_include  = FALSE;` |
|      - | 3692 | `	const char *zFile;` |
|      - | 3693 | `	char zBuf[8192];` |
|      - | 3694 | `	void *pHandle;` |
|      - | 3695 | `	int nLen;` |
|      - | 3696 |  |
|   6263 | 3697 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   6263 | 3704 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3705 | `	/* Point to the target IO stream device */` |
|   6263 | 3706 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|   6263 | 3707 | `	if( pStream == 0 ){` |
...
|   6263 | 3717 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,PH7_IO_OPEN_RDONLY,use_include,nArg > 2 ? apArg[2] : 0,FALSE,0);` |
|   6263 | 3718 | `	if( pHandle == 0 ){` |
...
|   6263 | 3738 | `	nRead = 0;` |
|   6257 | 3739 | `	for(;;){` |
|  18779 | 3740 | `		n = pStream->xRead(pHandle,zBuf,` |
|   6260 | 3741 | `			(nMaxlen > 0 && (nMaxlen < (ph7_int64)sizeof(zBuf))) ? nMaxlen : (ph7_int64)sizeof(zBuf));` |
|  12519 | 3742 | `		if( n < 1 ){` |
|      - | 3743 | `			/* EOF or IO error,break immediately */` |
|   6261 | 3744 | `			break;` |
|      - | 3745 | `		}` |
|      - | 3746 | `		/* Append data */` |
|   6263 | 3747 | `		ph7_result_string(pCtx,zBuf,(int)n);` |
|      - | 3748 | `		/* Increment read counter */` |
|   6263 | 3749 | `		nRead += n;` |
|   6263 | 3750 | `		if( nMaxlen > 0 && nRead >= nMaxlen ){` |
|      - | 3751 | `			/* Read limit reached */` |
|      3 | 3752 | `			break;` |
|      - | 3753 | `		}` |
|      5 | 3754 | `	}` |
|      - | 3755 | `	/* Close the stream */` |
|   6263 | 3756 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|      - | 3757 | `	/* Check if we have read something */` |
|   6263 | 3758 | `	if( ph7_context_result_buf_length(pCtx) < 1 ){` |
|      - | 3759 | `		/* Nothing read,return FALSE */` |
|    ! 0 | 3760 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 3761 | `	}` |
|   6263 | 3762 | `	return PH7_OK;` |
|   3134 | 3763 | `}` |
|      - | 3764 | `/*` |
...
|      - | 3782 | ` */` |
|  13454 | 3783 | `static int PH7_builtin_file_put_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3784 | `{` |
|  13459 | 3785 | `	int use_include  = FALSE;` |
...
|      - | 3792 | `	int nLen;` |
|      - | 3793 |  |
|  13459 | 3794 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  13459 | 3801 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3802 | `	/* Point to the target IO stream device */` |
|  13459 | 3803 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|  13459 | 3804 | `	if( pStream == 0 ){` |
...
|      - | 3808 | `	}` |
|      - | 3809 | `	/* Data to write */` |
|  13459 | 3810 | `	zData = ph7_value_to_string(apArg[1],&nLen);` |
|      - | 3811 | `	/* Try to open the file in read-write mode */` |
|  13459 | 3812 | `	iOpenFlags = PH7_IO_OPEN_CREATE\|PH7_IO_OPEN_RDWR\|PH7_IO_OPEN_TRUNC;` |
|      - | 3813 | `	/* Extract the flags */` |
|  13459 | 3814 | `	iFlags = 0;` |
|  13459 | 3815 | `	if( nArg > 2 ){` |
...
|    ! 0 | 3827 | `		}` |
|    ! 0 | 3828 | `	}` |
|  20186 | 3829 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,iOpenFlags,use_include,` |
|   6727 | 3830 | `		nArg > 3 ? apArg[3] : 0,FALSE,FALSE);` |
|  13459 | 3831 | `	if( pHandle == 0 ){` |
...
|  13453 | 3866 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|  13453 | 3867 | `	return PH7_OK;` |
|   6732 | 3868 | `}` |
|      - | 3869 | `/*` |
...
|      - | 4743 | ` */` |
|   4986 | 4744 | `static void InitIOPrivate(ph7_vm *pVm,const ph7_io_stream *pStream,io_private *pOut)` |
|      5 | 4745 | `{` |
|   4991 | 4746 | `	pOut->pStream = pStream;` |
|   4991 | 4747 | `	SyBlobInit(&pOut->sBuffer,&pVm->sAllocator);` |
|   4991 | 4748 | `	pOut->nOfft = 0;` |
|      - | 4749 | `	/* Set the magic number */` |
|   4991 | 4750 | `	pOut->iMagic = IO_PRIVATE_MAGIC;` |
|   4991 | 4751 | `}` |
|      - | 4752 | `/*` |
|      - | 4753 | ` * Release the IO private structure.` |
|      - | 4754 | ` */` |
|   4954 | 4755 | `static void ReleaseIOPrivate(ph7_context *pCtx,io_private *pDev)` |
|      5 | 4756 | `{` |
|   4959 | 4757 | `	SyBlobRelease(&pDev->sBuffer);` |
|   4959 | 4758 | `	pDev->iMagic = 0x2126; /* Invalid magic number so we can detetct misuse */` |
|      - | 4759 | `	/* Release the whole structure */` |
|   4959 | 4760 | `	ph7_context_free_chunk(pCtx,pDev);` |
|   4959 | 4761 | `}` |
|      - | 4762 | `/*` |
...
|      - | 5203 | ` */` |
|   3878 | 5204 | `PH7_PRIVATE const ph7_vfs * PH7_ExportBuiltinVfs(void)` |
|      5 | 5205 | `{` |
...
|      - | 5623 | ` */` |
|   3938 | 5624 | `static pipe_private * PipeOpen(ph7_vm *pVm, const char *zCommand, const char *zMode)` |
|      5 | 5625 | `{` |
|      - | 5626 | `	pipe_private *pPipe;` |
|      - | 5627 | `	FILE *pFile;` |
|   3943 | 5628 | `	if( pVm == 0 \|\| zCommand == 0 \|\| zMode == 0 ){` |
|    ! 0 | 5629 | `		return 0;` |
|      - | 5630 | `	}` |
|      - | 5631 | `	/* Validate mode - only 'r' or 'w' allowed */` |
|   3943 | 5632 | `	if( zMode[0] != 'r' && zMode[0] != 'w' ){` |
|    ! 0 | 5633 | `		return 0;` |
|      - | 5634 | `	}` |
...
|   3938 | 5696 | `	pFile = popen(zCommand, zMode);` |
|   3938 | 5697 | `	if( pFile == 0 ){` |
|    ! 0 | 5698 | `		return 0;` |
|      - | 5699 | `	}` |
|      - | 5700 | `	/* Allocate pipe private structure */` |
|   3938 | 5701 | `	pPipe = (pipe_private *)SyMemBackendAlloc(&pVm->sAllocator, sizeof(pipe_private));` |
|   3938 | 5702 | `	if( pPipe == 0 ){` |
|      - | 5703 | `		/* Out of memory, close the pipe */` |
|    ! 0 | 5704 | `		pclose(pFile);` |
|    ! 0 | 5705 | `		return 0;` |
|      - | 5706 | `	}` |
|      - | 5707 | `	/* Initialize the structure */` |
|   3938 | 5708 | `	pPipe->pFile = pFile;` |
|   3938 | 5709 | `	pPipe->pVm = pVm;` |
|   3938 | 5710 | `	pPipe->iMode = zMode[0];` |
|      - | 5711 | `#else /* OS_OTHER: no process pipes on this platform */` |
|      - | 5712 | `	(void)pFile;` |
|      - | 5713 | `	return 0;` |
|      - | 5714 | `#endif` |
|   3943 | 5715 | `	return pPipe;` |
|   1974 | 5716 | `}` |
|      - | 5717 | `/*` |
|      - | 5718 | ` * Close a pipe and return the exit status of the process.` |
|      - | 5719 | ` * Returns the exit status, or -1 on error.` |
|      - | 5720 | ` */` |
|   3916 | 5721 | `static int PipeClose(pipe_private *pPipe)` |
|      5 | 5722 | `{` |
|      - | 5723 | `	int status;` |
|      - | 5724 | `	ph7_vm *pVm;` |
|   3921 | 5725 | `	if( pPipe == 0 \|\| pPipe->pFile == 0 ){` |
|    ! 0 | 5726 | `		return -1;` |
|      - | 5727 | `	}` |
|   3921 | 5728 | `	pVm = pPipe->pVm;` |
...
|   3916 | 5734 | `	status = pclose(pPipe->pFile);` |
|      - | 5735 | `	/* On Unix, pclose returns the status from waitpid, need to extract exit code */` |
|   3916 | 5736 | `	if( status != -1 ){` |
|   3916 | 5737 | `		if( WIFEXITED(status) ){` |
|   3916 | 5738 | `			status = WEXITSTATUS(status);` |
|   1958 | 5739 | `		}else if( WIFSIGNALED(status) ){` |
...
|   3921 | 5751 | `	SyMemBackendFree(&pVm->sAllocator, pPipe);` |
|   3921 | 5752 | `	return status;` |
|   1963 | 5753 | `}` |
|      - | 5754 | `/*` |
...
|      - | 5768 | ` */` |
|   5754 | 5769 | `static ph7_int64 PipeStream_Read(void *pHandle, void *pBuffer, ph7_int64 nDatatoRead)` |
|      4 | 5770 | `{` |
|   5758 | 5771 | `	pipe_private *pPipe = (pipe_private *)pHandle;` |
|      - | 5772 | `	size_t nRead;` |
|   5758 | 5773 | `	if( pPipe == 0 \|\| pPipe->pFile == 0 ){` |
|    ! 0 | 5774 | `		return -1;` |
|      - | 5775 | `	}` |
|   5758 | 5776 | `	if( pPipe->iMode != 'r' ){` |
|      - | 5777 | `		/* Cannot read from a write-only pipe */` |
|    ! 0 | 5778 | `		return -1;` |
|      - | 5779 | `	}` |
|   5758 | 5780 | `	nRead = fread(pBuffer, 1, (size_t)nDatatoRead, pPipe->pFile);` |
|   5758 | 5781 | `	if( nRead == 0 ){` |
|   3940 | 5782 | `		if( feof(pPipe->pFile) ){` |
|   3940 | 5783 | `			return 0; /* EOF */` |
|      - | 5784 | `		}` |
|    ! 0 | 5785 | `		return -1; /* Error */` |
|      - | 5786 | `	}` |
|   1822 | 5787 | `	return (ph7_int64)nRead;` |
|   2881 | 5788 | `}` |
|      - | 5789 | `/*` |
...
|      - | 5831 | ` */` |
|   3822 | 5832 | `static int is_pipe_stream(const ph7_io_stream *pStream)` |
|      5 | 5833 | `{` |
|   3827 | 5834 | `	return pStream == &sPipe_Stream;` |
|      5 | 5835 | `}` |
|      - | 5836 | `/*` |
...
|      - | 5848 | ` */` |
|   3938 | 5849 | `static int PH7_builtin_popen(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 5850 | `{` |
|      - | 5851 | `	const char *zCommand, *zMode;` |
|      - | 5852 | `	pipe_private *pPipe;` |
|      - | 5853 | `	io_private *pDev;` |
|      - | 5854 | `	int nCmdLen, nModeLen;` |
|   3943 | 5855 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) \|\| !ph7_value_is_string(apArg[1]) ){` |
...
|   3943 | 5862 | `	zCommand = ph7_value_to_string(apArg[0], &nCmdLen);` |
|   3943 | 5863 | `	zMode = ph7_value_to_string(apArg[1], &nModeLen);` |
|   3943 | 5864 | `	if( nCmdLen < 1 ){` |
|    ! 0 | 5865 | `		ph7_context_throw_error(pCtx, PH7_CTX_WARNING, "Empty command");` |
|    ! 0 | 5866 | `		ph7_result_bool(pCtx, 0);` |
|    ! 0 | 5867 | `		return PH7_OK;` |
|      - | 5868 | `	}` |
|   3943 | 5869 | `	if( nModeLen < 1 \|\| (zMode[0] != 'r' && zMode[0] != 'w') ){` |
...
|      - | 5873 | `	}` |
|      - | 5874 | `	/* Open the pipe */` |
|   3943 | 5875 | `	pPipe = PipeOpen(pCtx->pVm, zCommand, zMode);` |
|   3943 | 5876 | `	if( pPipe == 0 ){` |
...
|   3943 | 5882 | `	pDev = (io_private *)ph7_context_alloc_chunk(pCtx, sizeof(io_private), TRUE, FALSE);` |
|   3943 | 5883 | `	if( pDev == 0 ){` |
...
|   3943 | 5890 | `	InitIOPrivate(pCtx->pVm, &sPipe_Stream, pDev);` |
|   3943 | 5891 | `	pDev->pHandle = pPipe;` |
|      - | 5892 | `	/* Return the io_private instance as a resource */` |
|   3943 | 5893 | `	ph7_result_resource(pCtx, pDev);` |
|   3943 | 5894 | `	return PH7_OK;` |
|   1974 | 5895 | `}` |
|      - | 5896 | `/*` |
...
|      - | 5904 | ` */` |
|   3822 | 5905 | `static int PH7_builtin_pclose(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 5906 | `{` |
|      - | 5907 | `	const ph7_io_stream *pStream;` |
|      - | 5908 | `	pipe_private *pPipe;` |
|      - | 5909 | `	io_private *pDev;` |
|      - | 5910 | `	int status;` |
|   3827 | 5911 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   3827 | 5918 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 5919 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   3827 | 5920 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   3827 | 5926 | `	pStream = pDev->pStream;` |
|   3827 | 5927 | `	if( pStream == 0 \|\| !is_pipe_stream(pStream) ){` |
...
|   3827 | 5933 | `	pPipe = (pipe_private *)pDev->pHandle;` |
|      - | 5934 | `	/* Close the pipe and get exit status */` |
|   3827 | 5935 | `	status = PipeClose(pPipe);` |
|      - | 5936 | `	/* Release the IO private structure */` |
|   3827 | 5937 | `	ReleaseIOPrivate(pCtx, pDev);` |
|      - | 5938 | `	/* Invalidate the resource handle */` |
|   3827 | 5939 | `	ph7_value_release(apArg[0]);` |
|      - | 5940 | `	/* Return the exit status */` |
|   3827 | 5941 | `	ph7_result_int(pCtx, status);` |
|   3827 | 5942 | `	return PH7_OK;` |
|   1916 | 5943 | `}` |
...
|      - | 5985 | ` */` |
|   3472 | 5986 | `PH7_PRIVATE sxi32 PH7_RegisterIORoutine(ph7_vm *pVm)` |
|      5 | 5987 | `{` |
|      - | 5988 | `	/*` |
...
|      - | 6085 | `	};` |
|   3477 | 6086 | `	const ph7_io_stream *pFileStream = 0;` |
|   3477 | 6087 | `	sxu32 n = 0;` |
|      - | 6088 | `	/* Register disk-related functions */` |
| 170133 | 6089 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVfsDiskFunc) ; ++n ){` |
| 166661 | 6090 | `		ph7_create_function(&(*pVm),aVfsDiskFunc[n].zName,aVfsDiskFunc[n].xFunc,(void *)pVm->pEngine->pVfs);` |
|  83333 | 6091 | `	}` |
| 124997 | 6092 | `	for( n = 0 ; n < SX_ARRAYSIZE(aIOFunc) ; ++n ){` |
| 121525 | 6093 | `		ph7_create_function(&(*pVm),aIOFunc[n].zName,aIOFunc[n].xFunc,pVm);` |
|  60765 | 6094 | `	}` |
|      - | 6095 | `#else` |
|      - | 6096 | `	SXUNUSED(pVm);` |
...
|      - | 6123 | `	};` |
|  59029 | 6124 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVfsHelperFunc) ; ++n ){` |
|  55557 | 6125 | `		ph7_create_function(&(*pVm),aVfsHelperFunc[n].zName,aVfsHelperFunc[n].xFunc,pVm);` |
|  27781 | 6126 | `	}` |
...
|   3472 | 6134 | `	pFileStream = &sUnixFileStream;` |
|      - | 6135 | `#endif` |
|      - | 6136 | `	/* Install the php:// stream */` |
|   3477 | 6137 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,&sPHP_Stream);` |
|   3477 | 6138 | `	if( pFileStream ){` |
|      - | 6139 | `		/* Install the file:// stream */` |
|   3477 | 6140 | `		ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,pFileStream);` |
|   1736 | 6141 | `	}` |
|      - | 6142 | `#endif /* PH7_DISABLE_DISK_IO */` |
|      - | 6143 |  |
|   3477 | 6144 | `	return SXRET_OK;` |
|      5 | 6145 | `}` |
|      - | 6146 | `/*` |
