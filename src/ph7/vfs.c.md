...
|      - |   67 | ` */` |
|  20068 |   68 | `static const char * VfsStrerror(int iErr)` |
|      5 |   69 | `{` |
|      - |   70 | `#if defined(_MSC_VER)` |
|      - |   71 | `#pragma warning(push)` |
|      - |   72 | `#pragma warning(disable:4996)` |
|      - |   73 | `#endif` |
|  20073 |   74 | `	return strerror(iErr);` |
...
|      - |   84 | ` */` |
|  20046 |   85 | `static void VfsThrowSysWarning(ph7_context *pCtx,const char *zPath)` |
|      5 |   86 | `{` |
|  30074 |   87 | `	PH7_VmThrowWarningFmt(pCtx->pVm,"%s(%s): %s",` |
|  20046 |   88 | `		ph7_function_name(pCtx),zPath ? zPath : "",VfsStrerror(errno));` |
|  20051 |   89 | `}` |
...
|      - |  103 | ` */` |
|  13484 |  104 | `static int PH7_vfs_chdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  105 | `{` |
|      - |  106 | `	const char *zPath;` |
|      - |  107 | `	ph7_vfs *pVfs;` |
|      - |  108 | `	int rc;` |
|  13489 |  109 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  110 | `		/* Missing/Invalid argument,return FALSE */` |
|      6 |  111 | `		ph7_result_bool(pCtx,0);` |
|      6 |  112 | `		return PH7_OK;` |
|      - |  113 | `	}` |
|      - |  114 | `	/* Point to the underlying vfs */` |
|  13485 |  115 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  13485 |  116 | `	if( pVfs == 0 \|\| pVfs->xChdir == 0 ){` |
...
|  13485 |  126 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  127 | `	/* Perform the requested operation */` |
|  13485 |  128 | `	errno = 0;` |
|  13485 |  129 | `	rc = pVfs->xChdir(zPath);` |
|  13485 |  130 | `	if( rc != PH7_OK ){` |
...
|      1 |  134 | `	}` |
|      - |  135 | `	/* IO return value */` |
|  13485 |  136 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  13485 |  137 | `	return PH7_OK;` |
|   6747 |  138 | `}` |
|      - |  139 | `/*` |
...
|      - |  261 | ` */` |
|   8854 |  262 | `static int PH7_vfs_is_dir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  263 | `{` |
|      - |  264 | `	const char *zPath;` |
|      - |  265 | `	ph7_vfs *pVfs;` |
|      - |  266 | `	int rc;` |
|   8859 |  267 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  268 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  269 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  270 | `		return PH7_OK;` |
|      - |  271 | `	}` |
|      - |  272 | `	/* Point to the underlying vfs */` |
|   8859 |  273 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   8859 |  274 | `	if( pVfs == 0 \|\| pVfs->xIsdir == 0 ){` |
...
|   8859 |  284 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  285 | `	/* Perform the requested operation */` |
|   8859 |  286 | `	rc = pVfs->xIsdir(zPath);` |
|      - |  287 | `	/* IO return value */` |
|   8859 |  288 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   8859 |  289 | `	return PH7_OK;` |
|   4432 |  290 | `}` |
|      - |  291 | `/*` |
...
|      - |  536 | ` */` |
|  33804 |  537 | `static int PH7_vfs_unlink(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  538 | `{` |
|      - |  539 | `	const char *zPath;` |
|      - |  540 | `	ph7_vfs *pVfs;` |
|      - |  541 | `	int rc;` |
|  33809 |  542 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  543 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  544 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  545 | `		return PH7_OK;` |
|      - |  546 | `	}` |
|      - |  547 | `	/* Point to the underlying vfs */` |
|  33809 |  548 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  33809 |  549 | `	if( pVfs == 0 \|\| pVfs->xUnlink == 0 ){` |
...
|  33809 |  559 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  560 | `	/* Perform the requested operation */` |
|  33809 |  561 | `	errno = 0;` |
|  33809 |  562 | `	rc = pVfs->xUnlink(zPath);` |
|  33809 |  563 | `	if( rc != PH7_OK ){` |
|  20045 |  564 | `		VfsThrowSysWarning(pCtx,zPath);` |
|  10020 |  565 | `	}` |
|      - |  566 | `	/* IO return value */` |
|  33809 |  567 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  33809 |  568 | `	return PH7_OK;` |
|  16907 |  569 | `}` |
|      - |  570 | `/*` |
...
|      - | 1005 | ` */` |
|   6782 | 1006 | `static int PH7_vfs_is_file(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1007 | `{` |
|      - | 1008 | `	const char *zPath;` |
|      - | 1009 | `	ph7_vfs *pVfs;` |
|      - | 1010 | `	int rc;` |
|   6787 | 1011 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   6787 | 1017 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   6787 | 1018 | `	if( pVfs == 0 \|\| pVfs->xIsfile == 0 ){` |
...
|   6787 | 1028 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - | 1029 | `	/* Perform the requested operation */` |
|   6787 | 1030 | `	rc = pVfs->xIsfile(zPath);` |
|      - | 1031 | `	/* IO return value */` |
|   6787 | 1032 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   6787 | 1033 | `	return PH7_OK;` |
|   3396 | 1034 | `}` |
|      - | 1035 | `/*` |
...
|      - | 1658 | ` */` |
|  13442 | 1659 | `static sxi32 ExtractPathInfo(const char *zPath,int nByte,path_info *pOut)` |
|      5 | 1660 | `{` |
|  13447 | 1661 | `	const char *zPtr,*zEnd = &zPath[nByte - 1];` |
|      - | 1662 | `	SyString *pCur;` |
|      - | 1663 | `	int c,d;` |
|  13447 | 1664 | `	c = d = '/';` |
...
|  13447 | 1669 | `	SyZero(pOut,sizeof(path_info));` |
|      - | 1670 | `	/* Handle special case */` |
|  13447 | 1671 | `	if( nByte == sizeof(char) && ( (int)zPath[0] == c \|\| (int)zPath[0] == d ) ){` |
...
| 362932 | 1680 | `	while( zEnd > zPath && ( (int)zEnd[0] != c && (int)zEnd[0] != d ) ){` |
| 342769 | 1681 | `		zEnd--;` |
|      5 | 1682 | `	}` |
|  13447 | 1683 | `	zPtr = (zEnd > zPath) ? &zEnd[1] : zPath;` |
|  13447 | 1684 | `	zEnd = &zPath[nByte];` |
|      - | 1685 | `	/* dirname */` |
|  13447 | 1686 | `	pCur = &pOut->sDir;` |
|  13447 | 1687 | `	SyStringInitFromBuf(pCur,zPath,zPtr-zPath);` |
|  13447 | 1688 | `	if( pCur->nByte > 1 ){` |
|  26889 | 1689 | `		SyStringTrimTrailingChar(pCur,'/');` |
|      - | 1690 | `#ifdef __WINNT__` |
|      5 | 1691 | `		SyStringTrimTrailingChar(pCur,'\\');` |
|      - | 1692 | `#endif` |
|   6726 | 1693 | `	}else if( (int)zPath[0] == c \|\| (int)zPath[0] == d ){` |
...
|  13447 | 1701 | `	pCur = &pOut->sBasename;` |
|  13447 | 1702 | `	SyStringInitFromBuf(pCur,zPtr,zEnd-zPtr);` |
|  13447 | 1703 | `	SyStringTrimLeadingChar(pCur,'/');` |
|      - | 1704 | `#ifdef __WINNT__` |
|      5 | 1705 | `	SyStringTrimLeadingChar(pCur,'\\');` |
|      - | 1706 | `#endif` |
|  13447 | 1707 | `	SyStringDupPtr(&pOut->sFilename,pCur);` |
|  13447 | 1708 | `	if( pCur->nByte > 0 ){` |
|      - | 1709 | `		/* extension */` |
|  13447 | 1710 | `		zEnd--;` |
|  67209 | 1711 | `		while( zEnd > pCur->zString /*basename*/ && zEnd[0] != '.' ){` |
|  53767 | 1712 | `			zEnd--;` |
|      5 | 1713 | `		}` |
|  13447 | 1714 | `		if( zEnd > pCur->zString ){` |
|  13445 | 1715 | `			zEnd++; /* Jump leading dot */` |
|  13445 | 1716 | `			SyStringInitFromBuf(&pOut->sExtension,zEnd,&zPath[nByte]-zEnd);` |
|      - | 1717 | `			/* Fix filename */` |
|  13445 | 1718 | `			pCur = &pOut->sFilename;` |
|  13445 | 1719 | `			if( pCur->nByte > SyStringLength(&pOut->sExtension) ){` |
|  13445 | 1720 | `				pCur->nByte -= 1 + SyStringLength(&pOut->sExtension);` |
|   6720 | 1721 | `			}` |
|   6720 | 1722 | `		}` |
|   6721 | 1723 | `	}` |
|  13447 | 1724 | `	return SXRET_OK;` |
|   6726 | 1725 | `}` |
|      - | 1726 | `/*` |
...
|      - | 1729 | ` */` |
|  13442 | 1730 | `static int PH7_builtin_pathinfo(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1731 | `{` |
|      - | 1732 | `	const char *zPath;` |
|      - | 1733 | `	path_info sInfo;` |
|      - | 1734 | `	SyString *pComp;` |
|      - | 1735 | `	int iLen;` |
|  13447 | 1736 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  13447 | 1742 | `	zPath = ph7_value_to_string(apArg[0],&iLen);` |
|  13447 | 1743 | `	if( iLen < 1 ){` |
|      - | 1744 | `		/* Empty string */` |
|    ! 0 | 1745 | `		ph7_result_string(pCtx,"",0);` |
|    ! 0 | 1746 | `		return PH7_OK;` |
|      - | 1747 | `	}` |
|      - | 1748 | `	/* Extract path info */` |
|  13447 | 1749 | `	ExtractPathInfo(zPath,iLen,&sInfo);` |
|  20167 | 1750 | `	if( nArg > 1 && ph7_value_is_int(apArg[1]) ){` |
|      - | 1751 | `		/* Return path component */` |
|  13445 | 1752 | `		int nComp = ph7_value_to_int(apArg[1]);` |
|  13445 | 1753 | `		switch(nComp){` |
...
|      - | 1770 | `			}` |
|      3 | 1771 | `			break;` |
|   3361 | 1772 | `		case 3: /*PATHINFO_EXTENSION*/` |
|   6727 | 1773 | `			pComp = &sInfo.sExtension;` |
|   6727 | 1774 | `			if( pComp->nByte > 0 ){` |
|   6725 | 1775 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   3365 | 1776 | `			}else{` |
|      - | 1777 | `				/* Expand the empty string */` |
|      3 | 1778 | `				ph7_result_string(pCtx,"",0);` |
|      - | 1779 | `			}` |
|   6727 | 1780 | `			break;` |
|   3357 | 1781 | `		case 4: /*PATHINFO_FILENAME*/` |
|   6719 | 1782 | `			pComp = &sInfo.sFilename;` |
|   6719 | 1783 | `			if( pComp->nByte > 0 ){` |
|   6719 | 1784 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   3362 | 1785 | `			}else{` |
...
|   6885 | 2948 | `	zPtr = zIn;` |
| 458628 | 2949 | `	while( zIn < zEnd ){` |
| 458522 | 2950 | `		if( zIn[0] == '\n' ){` |
|      - | 2951 | `			/* Line found */` |
...
|      - | 3044 | ` */` |
|  30480 | 3045 | `PH7_PRIVATE void * PH7_StreamOpenHandle(ph7_vm *pVm,const ph7_io_stream *pStream,const char *zFile,` |
|      - | 3046 | `	int iFlags,int use_include,ph7_value *pResource,int bPushInclude,int *pNew)` |
|      5 | 3047 | `{` |
|  30485 | 3048 | `	void *pHandle = 0; /* cc warning */` |
|      - | 3049 | `	SyString sFile;` |
|      - | 3050 | `	ph7_value sDummy;` |
|      - | 3051 | `	int rc;` |
|  30485 | 3052 | `	if( pStream == 0 ){` |
|      - | 3053 | `		/* No such stream device */` |
|    ! 0 | 3054 | `		return 0;` |
|      - | 3055 | `	}` |
|  30485 | 3056 | `	if( pResource == 0 ){` |
...
|  30463 | 3062 | `		PH7_MemObjInit(pVm,&sDummy);` |
|  30463 | 3063 | `		pResource = &sDummy;` |
|  15229 | 3064 | `	}` |
|  30485 | 3065 | `	SyStringInitFromBuf(&sFile,zFile,SyStrlen(zFile));` |
|  30485 | 3066 | `	if( use_include ){` |
|   9712 | 3067 | `		if(	sFile.zString[0] == '/' \|\|` |
|      - | 3068 | `#ifdef __WINNT__` |
|      - | 3069 | `			(sFile.nByte > 2 && sFile.zString[1] == ':' && (sFile.zString[2] == '\\' \|\| sFile.zString[2] == '/') ) \|\|` |
|      - | 3070 | `#endif` |
|   9676 | 3071 | `			(sFile.nByte > 1 && sFile.zString[0] == '.' && sFile.zString[1] == '/') \|\|` |
|   9670 | 3072 | `			(sFile.nByte > 2 && sFile.zString[0] == '.' && sFile.zString[1] == '.' && sFile.zString[2] == '/') ){` |
...
|   9673 | 3088 | `			SyBlobInit(&sWorker,&pVm->sAllocator);` |
|      - | 3089 | `			/* Build a path from the set of include path */` |
|   9673 | 3090 | `			SySetResetCursor(&pVm->aPaths);` |
|   9673 | 3091 | `			rc = SXERR_IO;` |
|   9679 | 3092 | `			while( SXRET_OK == SySetGetNextEntry(&pVm->aPaths,(void **)&pPath) ){` |
|      - | 3093 | `				/* Build full path */` |
|   9673 | 3094 | `				SyBlobFormat(&sWorker,"%z%c%z",pPath,c,&sFile);` |
|      - | 3095 | `				/* Append null terminator */` |
|   9673 | 3096 | `				if( SXRET_OK != SyBlobNullAppend(&sWorker) ){` |
|    ! 0 | 3097 | `					continue;` |
|      - | 3098 | `				}` |
|      - | 3099 | `				/* Try to open the file */` |
|   9673 | 3100 | `				rc = pStream->xOpen((const char *)SyBlobData(&sWorker),iFlags,pResource,&pHandle);` |
|   9673 | 3101 | `				if( rc == PH7_OK ){` |
|   9666 | 3102 | `					if( bPushInclude ){` |
|      - | 3103 | `						/* Mark as included */` |
|   9666 | 3104 | `						PH7_VmPushFilePath(pVm,(const char *)SyBlobData(&sWorker),SyBlobLength(&sWorker),FALSE,pNew);` |
|   4832 | 3105 | `					}` |
|   9666 | 3106 | `					break;` |
|      - | 3107 | `				}` |
...
|      2 | 3111 | `			}` |
|   9673 | 3112 | `			SyBlobRelease(&sWorker);` |
|      - | 3113 | `		}` |
|   4860 | 3114 | `	}else{` |
|      - | 3115 | `		/* Open the URI direcly */` |
|  20773 | 3116 | `		rc = pStream->xOpen(zFile,iFlags,pResource,&pHandle);` |
|      - | 3117 | `	}` |
|  30485 | 3118 | `	if( rc != PH7_OK ){` |
|      - | 3119 | `		/* IO error */` |
|     25 | 3120 | `		return 0;` |
|      - | 3121 | `	}` |
|      - | 3122 | `	/* Return the file handle */` |
|  30465 | 3123 | `	return pHandle;` |
|  15245 | 3124 | `}` |
|      - | 3125 | `/*` |
...
|      - | 3129 | ` */` |
|   9696 | 3130 | `PH7_PRIVATE sxi32 PH7_StreamReadWholeFile(void *pHandle,const ph7_io_stream *pStream,SyBlob *pOut)` |
|      3 | 3131 | `{` |
...
|   9696 | 3136 | `	for(;;){` |
|  19395 | 3137 | `		nRead = pStream->xRead(pHandle,zBuf,sizeof(zBuf));` |
|  19395 | 3138 | `		if( nRead < 1 ){` |
|      - | 3139 | `			/* EOF or IO error */` |
|   9699 | 3140 | `			break;` |
|      - | 3141 | `		}` |
|      - | 3142 | `		/* Append contents */` |
|   9699 | 3143 | `		rc = SyBlobAppend(pOut,zBuf,(sxu32)nRead);` |
|   9699 | 3144 | `		if( rc != SXRET_OK ){` |
|    ! 0 | 3145 | `			break;` |
|      - | 3146 | `		}` |
|      3 | 3147 | `	}` |
|   9699 | 3148 | `	return SyBlobLength(pOut) > 0 ? SXRET_OK : -1;` |
|      3 | 3149 | `}` |
|      - | 3150 | `/*` |
|      - | 3151 | ` * Close an open IO stream handle [i.e local file/URI..].` |
|      - | 3152 | ` */` |
|  30588 | 3153 | `PH7_PRIVATE void PH7_StreamCloseHandle(const ph7_io_stream *pStream,void *pHandle)` |
|      5 | 3154 | `{` |
|  30593 | 3155 | `	if( pStream->xClose ){` |
|  30593 | 3156 | `		pStream->xClose(pHandle);` |
|  15294 | 3157 | `	}` |
|  30593 | 3158 | `}` |
|      - | 3159 | `/*` |
...
|      - | 3537 | ` */` |
|  11024 | 3538 | `static int PH7_builtin_readdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3539 | `{` |
|      - | 3540 | `	const ph7_io_stream *pStream;` |
|      - | 3541 | `	io_private *pDev;` |
|      - | 3542 | `	int rc;` |
|  11029 | 3543 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|  11029 | 3550 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3551 | `	/* Make sure we are dealing with a valid io_private instance */` |
|  11029 | 3552 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|  11029 | 3559 | `	pStream = pDev->pStream;` |
|  11029 | 3560 | `	if( pStream == 0  \|\| pStream->xReadDir == 0 ){` |
...
|      - | 3567 | `	}` |
|  11029 | 3568 | `	ph7_result_bool(pCtx,0);` |
|      - | 3569 | `	/* Perform the requested operation */` |
|  11029 | 3570 | `	rc = pStream->xReadDir(pDev->pHandle,pCtx);` |
|  11029 | 3571 | `	if( rc != PH7_OK ){` |
|      - | 3572 | `		/* Return FALSE */` |
|   1071 | 3573 | `		ph7_result_bool(pCtx,0);` |
|    533 | 3574 | `	}` |
|  11029 | 3575 | `	return PH7_OK;` |
|   5517 | 3576 | `}` |
|      - | 3577 | `/*` |
...
|      - | 3827 | ` */` |
|   6774 | 3828 | `static int PH7_builtin_file_get_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3829 | `{` |
|      - | 3830 | `	const ph7_io_stream *pStream;` |
|      - | 3831 | `	ph7_int64 n,nRead,nMaxlen;` |
|   6779 | 3832 | `	int use_include  = FALSE;` |
|      - | 3833 | `	const char *zFile;` |
|      - | 3834 | `	char zBuf[8192];` |
|      - | 3835 | `	void *pHandle;` |
|      - | 3836 | `	int nLen;` |
|      - | 3837 |  |
|   6779 | 3838 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   6779 | 3845 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3846 | `	/* Point to the target IO stream device */` |
|   6779 | 3847 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|   6779 | 3848 | `	if( pStream == 0 ){` |
...
|   6779 | 3858 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,PH7_IO_OPEN_RDONLY,use_include,nArg > 2 ? apArg[2] : 0,FALSE,0);` |
|   6779 | 3859 | `	if( pHandle == 0 ){` |
...
|   6777 | 3879 | `	nRead = 0;` |
|   6769 | 3880 | `	for(;;){` |
|  20315 | 3881 | `		n = pStream->xRead(pHandle,zBuf,` |
|   6772 | 3882 | `			(nMaxlen > 0 && (nMaxlen < (ph7_int64)sizeof(zBuf))) ? nMaxlen : (ph7_int64)sizeof(zBuf));` |
|  13543 | 3883 | `		if( n < 1 ){` |
|      - | 3884 | `			/* EOF or IO error,break immediately */` |
|   6775 | 3885 | `			break;` |
|      - | 3886 | `		}` |
|      - | 3887 | `		/* Append data */` |
|   6773 | 3888 | `		ph7_result_string(pCtx,zBuf,(int)n);` |
|      - | 3889 | `		/* Increment read counter */` |
|   6773 | 3890 | `		nRead += n;` |
|   6773 | 3891 | `		if( nMaxlen > 0 && nRead >= nMaxlen ){` |
|      - | 3892 | `			/* Read limit reached */` |
|      3 | 3893 | `			break;` |
|      - | 3894 | `		}` |
|      5 | 3895 | `	}` |
|      - | 3896 | `	/* Close the stream */` |
|   6777 | 3897 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
...
|   6777 | 3901 | `	if( ph7_context_result_buf_length(pCtx) < 1 ){` |
|      6 | 3902 | `		ph7_result_string(pCtx,"",0);` |
|      2 | 3903 | `	}` |
|   6777 | 3904 | `	return PH7_OK;` |
|   3392 | 3905 | `}` |
|      - | 3906 | `/*` |
...
|      - | 3924 | ` */` |
|  13748 | 3925 | `static int PH7_builtin_file_put_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3926 | `{` |
|  13753 | 3927 | `	int use_include  = FALSE;` |
...
|      - | 3934 | `	int nLen;` |
|      - | 3935 |  |
|  13753 | 3936 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  13753 | 3943 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3944 | `	/* Point to the target IO stream device */` |
|  13753 | 3945 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|  13753 | 3946 | `	if( pStream == 0 ){` |
...
|      - | 3950 | `	}` |
|      - | 3951 | `	/* Data to write */` |
|  13753 | 3952 | `	zData = ph7_value_to_string(apArg[1],&nLen);` |
|      - | 3953 | `	/* Try to open the file in read-write mode */` |
|  13753 | 3954 | `	iOpenFlags = PH7_IO_OPEN_CREATE\|PH7_IO_OPEN_RDWR\|PH7_IO_OPEN_TRUNC;` |
|      - | 3955 | `	/* Extract the flags */` |
|  13753 | 3956 | `	iFlags = 0;` |
|  13753 | 3957 | `	if( nArg > 2 ){` |
...
|    ! 0 | 3969 | `		}` |
|    ! 0 | 3970 | `	}` |
|  20627 | 3971 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,iOpenFlags,use_include,` |
|   6874 | 3972 | `		nArg > 3 ? apArg[3] : 0,FALSE,FALSE);` |
|  13753 | 3973 | `	if( pHandle == 0 ){` |
|    ! 0 | 3974 | `		VfsThrowOpenWarning(pCtx,zFile);` |
|    ! 0 | 3975 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 3976 | `		return PH7_OK;` |
|      - | 3977 | `	}` |
|  13753 | 3978 | `	if( nLen < 1 ){` |
...
|      - | 3983 | `	}` |
|  13745 | 3984 | `	if( pStream->xWrite ){` |
|      - | 3985 | `		ph7_int64 n;` |
|  13745 | 3986 | `		if( (iFlags & 2/* LOCK_EX, php's value */) && pStream->xLock ){` |
|      - | 3987 | `			/* Try to acquire an exclusive lock */` |
|    ! 0 | 3988 | `			pStream->xLock(pHandle,1/* LOCK_EX */);` |
|    ! 0 | 3989 | `		}` |
|      - | 3990 | `		/* Perform the write operation */` |
|  13745 | 3991 | `		n = pStream->xWrite(pHandle,(const void *)zData,nLen);` |
|  13745 | 3992 | `		if( n < 0 ){` |
...
|  13745 | 4000 | `			ph7_result_int64(pCtx,n);` |
|      - | 4001 | `		}` |
|   6875 | 4002 | `	}else{` |
...
|  13745 | 4011 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|  13745 | 4012 | `	return PH7_OK;` |
|   6879 | 4013 | `}` |
|      - | 4014 | `/*` |
...
|     53 | 5067 | `	while( nMax != 0 ){` |
|     51 | 5068 | `		ph7_int64 nAsk = (ph7_int64)sizeof(zBuf);` |
|     51 | 5069 | `		if( nMax > 0 && nMax < nAsk ){` |
|      3 | 5070 | `			nAsk = nMax;` |
|      1 | 5071 | `		}` |
|     51 | 5072 | `		nRead = pStream->xRead(pDev->pHandle,zBuf,nAsk);` |
|     51 | 5073 | `		if( nRead < 1 ){` |
|     27 | 5074 | `			break;` |
|      - | 5075 | `		}` |
|     25 | 5076 | `		ph7_result_string(pCtx,zBuf,(int)nRead); /* appends */` |
|     25 | 5077 | `		if( nMax > 0 ){` |
|      3 | 5078 | `			nMax -= nRead;` |
|      1 | 5079 | `		}` |
|      1 | 5080 | `	}` |
...
|      - | 5184 | `	int bEof;` |
|      - | 5185 | `};` |
|     14 | 5186 | `static ph7_int64 SockStreamData_Read(void *pHandle,void *pBuffer,ph7_int64 nRead)` |
|    ! 0 | 5187 | `{` |
|     14 | 5188 | `	sock_private *pSock = (sock_private *)pHandle;` |
|      - | 5189 | `	int n;` |
|     14 | 5190 | `	if( pSock == 0 \|\| pSock->bEof ){` |
|      1 | 5191 | `		return 0;` |
|      - | 5192 | `	}` |
