...
|      - |   65 | ` */` |
|   9980 |   66 | `static int PH7_vfs_chdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 |   67 |  |
|      - |   68 | `	const char *zPath;` |
|      - |   69 | `	ph7_vfs *pVfs;` |
|      - |   70 | `	int rc;` |
|   9982 |   71 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |   72 | `		/* Missing/Invalid argument,return FALSE */` |
|      8 |   73 | `		ph7_result_bool(pCtx,0);` |
|      8 |   74 | `		return PH7_OK;` |
|      - |   75 | `	}` |
|      - |   76 | `	/* Point to the underlying vfs */` |
|   9976 |   77 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   9976 |   78 | `	if( pVfs == 0 \|\| pVfs->xChdir == 0 ){` |
...
|   9976 |   88 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |   89 | `	/* Perform the requested operation */` |
|   9976 |   90 | `	rc = pVfs->xChdir(zPath);` |
|      - |   91 | `	/* IO return value */` |
|   9976 |   92 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   9976 |   93 | `	return PH7_OK;` |
|   4992 |   94 |  |
|      - |   95 | `/*` |
...
|      - |  213 | ` */` |
|   5956 |  214 | `static int PH7_vfs_is_dir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 |  215 |  |
|      - |  216 | `	const char *zPath;` |
|      - |  217 | `	ph7_vfs *pVfs;` |
|      - |  218 | `	int rc;` |
|   5958 |  219 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  220 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  221 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  222 | `		return PH7_OK;` |
|      - |  223 | `	}` |
|      - |  224 | `	/* Point to the underlying vfs */` |
|   5958 |  225 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   5958 |  226 | `	if( pVfs == 0 \|\| pVfs->xIsdir == 0 ){` |
...
|   5958 |  236 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  237 | `	/* Perform the requested operation */` |
|   5958 |  238 | `	rc = pVfs->xIsdir(zPath);` |
|      - |  239 | `	/* IO return value */` |
|   5958 |  240 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   5958 |  241 | `	return PH7_OK;` |
|   2980 |  242 |  |
|      - |  243 | `/*` |
...
|      - |  476 | ` */` |
|  21352 |  477 | `static int PH7_vfs_unlink(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 |  478 |  |
|      - |  479 | `	const char *zPath;` |
|      - |  480 | `	ph7_vfs *pVfs;` |
|      - |  481 | `	int rc;` |
|  21354 |  482 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  483 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  484 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  485 | `		return PH7_OK;` |
|      - |  486 | `	}` |
|      - |  487 | `	/* Point to the underlying vfs */` |
|  21354 |  488 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  21354 |  489 | `	if( pVfs == 0 \|\| pVfs->xUnlink == 0 ){` |
...
|  21354 |  499 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  500 | `	/* Perform the requested operation */` |
|  21354 |  501 | `	rc = pVfs->xUnlink(zPath);` |
|      - |  502 | `	/* IO return value */` |
|  21354 |  503 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  21354 |  504 | `	return PH7_OK;` |
|  10678 |  505 |  |
|      - |  506 | `/*` |
...
|      - |  907 | ` */` |
|   4244 |  908 | `static int PH7_vfs_is_file(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 |  909 |  |
|      - |  910 | `	const char *zPath;` |
|      - |  911 | `	ph7_vfs *pVfs;` |
|      - |  912 | `	int rc;` |
|   4246 |  913 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  914 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  915 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  916 | `		return PH7_OK;` |
|      - |  917 | `	}` |
|      - |  918 | `	/* Point to the underlying vfs */` |
|   4246 |  919 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   4246 |  920 | `	if( pVfs == 0 \|\| pVfs->xIsfile == 0 ){` |
...
|   4246 |  930 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  931 | `	/* Perform the requested operation */` |
|   4246 |  932 | `	rc = pVfs->xIsfile(zPath);` |
|      - |  933 | `	/* IO return value */` |
|   4246 |  934 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   4246 |  935 | `	return PH7_OK;` |
|   2124 |  936 |  |
|      - |  937 | `/*` |
...
|      - | 1554 | ` */` |
|   8486 | 1555 | `static sxi32 ExtractPathInfo(const char *zPath,int nByte,path_info *pOut)` |
|      2 | 1556 |  |
|   8488 | 1557 | `	const char *zPtr,*zEnd = &zPath[nByte - 1];` |
|      - | 1558 | `	SyString *pCur;` |
|      - | 1559 | `	int c,d;` |
|   8488 | 1560 | `	c = d = '/';` |
...
|   8488 | 1565 | `	SyZero(pOut,sizeof(path_info));` |
|      - | 1566 | `	/* Handle special case */` |
|   8488 | 1567 | `	if( nByte == sizeof(char) && ( (int)zPath[0] == c \|\| (int)zPath[0] == d ) ){` |
...
| 217075 | 1576 | `	while( zEnd > zPath && ( (int)zEnd[0] != c && (int)zEnd[0] != d ) ){` |
| 204346 | 1577 | `		zEnd--;` |
|      2 | 1578 | `	}` |
|   8488 | 1579 | `	zPtr = (zEnd > zPath) ? &zEnd[1] : zPath;` |
|   8488 | 1580 | `	zEnd = &zPath[nByte];` |
|      - | 1581 | `	/* dirname */` |
|   8488 | 1582 | `	pCur = &pOut->sDir;` |
|   8488 | 1583 | `	SyStringInitFromBuf(pCur,zPath,zPtr-zPath);` |
|   8488 | 1584 | `	if( pCur->nByte > 1 ){` |
|  16974 | 1585 | `		SyStringTrimTrailingChar(pCur,'/');` |
|      - | 1586 | `#ifdef __WINNT__` |
|      2 | 1587 | `		SyStringTrimTrailingChar(pCur,'\\');` |
|      - | 1588 | `#endif` |
|   4245 | 1589 | `	}else if( (int)zPath[0] == c \|\| (int)zPath[0] == d ){` |
...
|   8488 | 1597 | `	pCur = &pOut->sBasename;` |
|   8488 | 1598 | `	SyStringInitFromBuf(pCur,zPtr,zEnd-zPtr);` |
|   8488 | 1599 | `	SyStringTrimLeadingChar(pCur,'/');` |
|      - | 1600 | `#ifdef __WINNT__` |
|      2 | 1601 | `	SyStringTrimLeadingChar(pCur,'\\');` |
|      - | 1602 | `#endif` |
|   8488 | 1603 | `	SyStringDupPtr(&pOut->sFilename,pCur);` |
|   8488 | 1604 | `	if( pCur->nByte > 0 ){` |
|      - | 1605 | `		/* extension */` |
|   8488 | 1606 | `		zEnd--;` |
|  42430 | 1607 | `		while( zEnd > pCur->zString /*basename*/ && zEnd[0] != '.' ){` |
|  33944 | 1608 | `			zEnd--;` |
|      2 | 1609 | `		}` |
|   8488 | 1610 | `		if( zEnd > pCur->zString ){` |
|   8486 | 1611 | `			zEnd++; /* Jump leading dot */` |
|   8486 | 1612 | `			SyStringInitFromBuf(&pOut->sExtension,zEnd,&zPath[nByte]-zEnd);` |
|      - | 1613 | `			/* Fix filename */` |
|   8486 | 1614 | `			pCur = &pOut->sFilename;` |
|   8486 | 1615 | `			if( pCur->nByte > SyStringLength(&pOut->sExtension) ){` |
|   8486 | 1616 | `				pCur->nByte -= 1 + SyStringLength(&pOut->sExtension);` |
|   4242 | 1617 | `			}` |
|   4242 | 1618 | `		}` |
|   4243 | 1619 | `	}` |
|   8488 | 1620 | `	return SXRET_OK;` |
|   4245 | 1621 |  |
|      - | 1622 | `/*` |
...
|      - | 1625 | ` */` |
|   8486 | 1626 | `static int PH7_builtin_pathinfo(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 1627 |  |
|      - | 1628 | `	const char *zPath;` |
|      - | 1629 | `	path_info sInfo;` |
|      - | 1630 | `	SyString *pComp;` |
|      - | 1631 | `	int iLen;` |
|   8488 | 1632 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   8488 | 1638 | `	zPath = ph7_value_to_string(apArg[0],&iLen);` |
|   8488 | 1639 | `	if( iLen < 1 ){` |
|      - | 1640 | `		/* Empty string */` |
...
|   8488 | 1645 | `	ExtractPathInfo(zPath,iLen,&sInfo);` |
|  12730 | 1646 | `	if( nArg > 1 && ph7_value_is_int(apArg[1]) ){` |
|      - | 1647 | `		/* Return path component */` |
|   8486 | 1648 | `		int nComp = ph7_value_to_int(apArg[1]);` |
|   8486 | 1649 | `		switch(nComp){` |
...
|      - | 1666 | `			}` |
|      3 | 1667 | `			break;` |
|   2121 | 1668 | `		case 3: /*PATHINFO_EXTENSION*/` |
|   4244 | 1669 | `			pComp = &sInfo.sExtension;` |
|   4244 | 1670 | `			if( pComp->nByte > 0 ){` |
|   4242 | 1671 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   2122 | 1672 | `			}else{` |
|      - | 1673 | `				/* Expand the empty string */` |
|      3 | 1674 | `				ph7_result_string(pCtx,"",0);` |
|      - | 1675 | `			}` |
|   4244 | 1676 | `			break;` |
|   2119 | 1677 | `		case 4: /*PATHINFO_FILENAME*/` |
|   4240 | 1678 | `			pComp = &sInfo.sFilename;` |
|   4240 | 1679 | `			if( pComp->nByte > 0 ){` |
|   4240 | 1680 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   2121 | 1681 | `			}else{` |
...
|      - | 2703 | ` */` |
|   6502 | 2704 | `static int PH7_builtin_feof(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 2705 |  |
|      - | 2706 | `	const ph7_io_stream *pStream;` |
|      - | 2707 | `	io_private *pDev;` |
|      - | 2708 | `	int rc;` |
|   6504 | 2709 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   6504 | 2716 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 2717 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   6504 | 2718 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   6504 | 2725 | `	pStream = pDev->pStream;` |
|   6504 | 2726 | `	if( pStream == 0 ){` |
...
|      - | 2733 | `	}` |
|   6504 | 2734 | `	rc = SXERR_EOF;` |
|      - | 2735 | `	/* Perform the requested operation */` |
|   6504 | 2736 | `	if( SyBlobLength(&pDev->sBuffer) > pDev->nOfft ){` |
...
|   3528 | 2743 | `		n = pStream->xRead(pDev->pHandle,zBuf,sizeof(zBuf));` |
|   3528 | 2744 | `		if( n > 0 ){` |
|      - | 2745 | `			/* Copy buffered data */` |
|   1062 | 2746 | `			SyBlobAppend(&pDev->sBuffer,zBuf,(sxu32)n);` |
|   1062 | 2747 | `			rc = PH7_OK;` |
|    530 | 2748 | `		}` |
|      - | 2749 | `	}` |
|      - | 2750 | `	/* EOF or not */` |
|   6504 | 2751 | `	ph7_result_bool(pCtx,rc == SXERR_EOF);` |
|   6504 | 2752 | `	return PH7_OK;` |
|   3253 | 2753 |  |
|      - | 2754 | `/*` |
...
|      - | 2798 | ` */` |
|   4052 | 2799 | `static sxi32 GetLine(io_private *pDev,ph7_int64 *pLen,const char **pzLine)` |
|      2 | 2800 |  |
|      - | 2801 | `	const char *zIn,*zEnd,*zPtr;` |
|   4054 | 2802 | `	zIn = (const char *)SyBlobDataAt(&pDev->sBuffer,pDev->nOfft);` |
|   4054 | 2803 | `	zEnd = &zIn[SyBlobLength(&pDev->sBuffer)-pDev->nOfft];` |
|   4054 | 2804 | `	zPtr = zIn;` |
| 279579 | 2805 | `	while( zIn < zEnd ){` |
| 279525 | 2806 | `		if( zIn[0] == '\n' ){` |
|      - | 2807 | `			/* Line found */` |
|   4000 | 2808 | `			zIn++; /* Include the line ending as requested by the PHP specification */` |
|   4000 | 2809 | `			*pLen = (ph7_int64)(zIn-zPtr);` |
|   4000 | 2810 | `			*pzLine = zPtr;` |
|   4000 | 2811 | `			return SXRET_OK;` |
|      - | 2812 | `		}` |
| 275527 | 2813 | `		zIn++;` |
|      2 | 2814 | `	}` |
...
|      - | 2820 | ` */` |
|   4056 | 2821 | `static ph7_int64 StreamReadLine(io_private *pDev,const char **pzData,ph7_int64 nMaxLen)` |
|      2 | 2822 |  |
|   4058 | 2823 | `	const ph7_io_stream *pStream = pDev->pStream;` |
|      - | 2824 | `	char zBuf[8192];` |
|      - | 2825 | `	ph7_int64 n;` |
|      - | 2826 | `	sxi32 rc;` |
|   4058 | 2827 | `	n = 0;` |
|   4058 | 2828 | `	if( pDev->nOfft >= SyBlobLength(&pDev->sBuffer) ){` |
...
|      8 | 2832 | `	}` |
|   4058 | 2833 | `	if( SyBlobLength(&pDev->sBuffer) > pDev->nOfft ){` |
|      - | 2834 | `		/* Check if there is a line */` |
|   4042 | 2835 | `		rc = GetLine(pDev,&n,pzData);` |
|   4042 | 2836 | `		if( rc == SXRET_OK ){` |
|      - | 2837 | `			/* Got line,update the cursor  */` |
|   3990 | 2838 | `			pDev->nOfft += (sxu32)n;` |
|   3990 | 2839 | `			return n;` |
|      - | 2840 | `		}` |
|     26 | 2841 | `	}` |
...
|      - | 2900 | ` */` |
|  22068 | 2901 | `PH7_PRIVATE void * PH7_StreamOpenHandle(ph7_vm *pVm,const ph7_io_stream *pStream,const char *zFile,` |
|      - | 2902 | `	int iFlags,int use_include,ph7_value *pResource,int bPushInclude,int *pNew)` |
|      2 | 2903 |  |
|  22070 | 2904 | `	void *pHandle = 0; /* cc warning */` |
|      - | 2905 | `	SyString sFile;` |
|      - | 2906 | `	int rc;` |
|  22070 | 2907 | `	if( pStream == 0 ){` |
|      - | 2908 | `		/* No such stream device */` |
|    ! 0 | 2909 | `		return 0;` |
|      - | 2910 | `	}` |
|  22070 | 2911 | `	SyStringInitFromBuf(&sFile,zFile,SyStrlen(zFile));` |
|  22070 | 2912 | `	if( use_include ){` |
...
|  14530 | 2964 | `		rc = pStream->xOpen(zFile,iFlags,pResource,&pHandle);` |
|      - | 2965 | `	}` |
|  22070 | 2966 | `	if( rc != PH7_OK ){` |
|      - | 2967 | `		/* IO error */` |
|      9 | 2968 | `		return 0;` |
|      - | 2969 | `	}` |
|      - | 2970 | `	/* Return the file handle */` |
|  22062 | 2971 | `	return pHandle;` |
|  11036 | 2972 |  |
|      - | 2973 | `/*` |
...
|      - | 3000 | ` */` |
|  22072 | 3001 | `PH7_PRIVATE void PH7_StreamCloseHandle(const ph7_io_stream *pStream,void *pHandle)` |
|      2 | 3002 |  |
|  22074 | 3003 | `	if( pStream->xClose ){` |
|  22074 | 3004 | `		pStream->xClose(pHandle);` |
|  11036 | 3005 | `	}` |
|  22074 | 3006 |  |
|      - | 3007 | `/*` |
...
|      - | 3076 | ` */` |
|   4046 | 3077 | `static int PH7_builtin_fgets(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 3078 |  |
|      - | 3079 | `	const ph7_io_stream *pStream;` |
|      - | 3080 | `	const char *zLine;` |
|      - | 3081 | `	io_private *pDev;` |
|      - | 3082 | `	ph7_int64 n,nLen;` |
|   4048 | 3083 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   4048 | 3090 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3091 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   4048 | 3092 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   4048 | 3099 | `	pStream = pDev->pStream;` |
|   4048 | 3100 | `	if( pStream == 0  ){` |
...
|   4048 | 3114 | `	n = StreamReadLine(pDev,&zLine,nLen);` |
|   4048 | 3115 | `	if( n < 1 ){` |
|      - | 3116 | `		/* EOF or IO error,return FALSE */` |
|      3 | 3117 | `		ph7_result_bool(pCtx,0);` |
|      2 | 3118 | `	}else{` |
|      - | 3119 | `		/* Return the freshly extracted line */` |
|   4046 | 3120 | `		ph7_result_string(pCtx,zLine,(int)n);` |
|      - | 3121 | `	}` |
|   4048 | 3122 | `	return PH7_OK;` |
|   2025 | 3123 |  |
|      - | 3124 | `/*` |
...
|      - | 3385 | ` */` |
|   5954 | 3386 | `static int PH7_builtin_readdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 3387 |  |
|      - | 3388 | `	const ph7_io_stream *pStream;` |
|      - | 3389 | `	io_private *pDev;` |
|      - | 3390 | `	int rc;` |
|   5956 | 3391 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   5956 | 3398 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3399 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   5956 | 3400 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   5956 | 3407 | `	pStream = pDev->pStream;` |
|   5956 | 3408 | `	if( pStream == 0  \|\| pStream->xReadDir == 0 ){` |
...
|      - | 3415 | `	}` |
|   5956 | 3416 | `	ph7_result_bool(pCtx,0);` |
|      - | 3417 | `	/* Perform the requested operation */` |
|   5956 | 3418 | `	rc = pStream->xReadDir(pDev->pHandle,pCtx);` |
|   5956 | 3419 | `	if( rc != PH7_OK ){` |
|      - | 3420 | `		/* Return FALSE */` |
|    858 | 3421 | `		ph7_result_bool(pCtx,0);` |
|    428 | 3422 | `	}` |
|   5956 | 3423 | `	return PH7_OK;` |
|   2979 | 3424 |  |
|      - | 3425 | `/*` |
...
|      - | 3667 | ` */` |
|   4278 | 3668 | `static int PH7_builtin_file_get_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 3669 |  |
|      - | 3670 | `	const ph7_io_stream *pStream;` |
|      - | 3671 | `	ph7_int64 n,nRead,nMaxlen;` |
|   4280 | 3672 | `	int use_include  = FALSE;` |
|      - | 3673 | `	const char *zFile;` |
|      - | 3674 | `	char zBuf[8192];` |
|      - | 3675 | `	void *pHandle;` |
|      - | 3676 | `	int nLen;` |
|      - | 3677 |  |
|   4280 | 3678 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   4280 | 3685 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3686 | `	/* Point to the target IO stream device */` |
|   4280 | 3687 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|   4280 | 3688 | `	if( pStream == 0 ){` |
...
|   4280 | 3698 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,PH7_IO_OPEN_RDONLY,use_include,nArg > 2 ? apArg[2] : 0,FALSE,0);` |
|   4280 | 3699 | `	if( pHandle == 0 ){` |
...
|   4280 | 3719 | `	nRead = 0;` |
|   4277 | 3720 | `	for(;;){` |
|  12836 | 3721 | `		n = pStream->xRead(pHandle,zBuf,` |
|   4280 | 3722 | `			(nMaxlen > 0 && (nMaxlen < (ph7_int64)sizeof(zBuf))) ? nMaxlen : (ph7_int64)sizeof(zBuf));` |
|   8556 | 3723 | `		if( n < 1 ){` |
|      - | 3724 | `			/* EOF or IO error,break immediately */` |
|   4278 | 3725 | `			break;` |
|      - | 3726 | `		}` |
|      - | 3727 | `		/* Append data */` |
|   4280 | 3728 | `		ph7_result_string(pCtx,zBuf,(int)n);` |
|      - | 3729 | `		/* Increment read counter */` |
|   4280 | 3730 | `		nRead += n;` |
|   4280 | 3731 | `		if( nMaxlen > 0 && nRead >= nMaxlen ){` |
|      - | 3732 | `			/* Read limit reached */` |
|      3 | 3733 | `			break;` |
|      - | 3734 | `		}` |
|      2 | 3735 | `	}` |
|      - | 3736 | `	/* Close the stream */` |
|   4280 | 3737 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|      - | 3738 | `	/* Check if we have read something */` |
|   4280 | 3739 | `	if( ph7_context_result_buf_length(pCtx) < 1 ){` |
|      - | 3740 | `		/* Nothing read,return FALSE */` |
|    ! 0 | 3741 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 3742 | `	}` |
|   4280 | 3743 | `	return PH7_OK;` |
|   2141 | 3744 |  |
|      - | 3745 | `/*` |
...
|      - | 3763 | ` */` |
|  10166 | 3764 | `static int PH7_builtin_file_put_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 3765 |  |
|  10168 | 3766 | `	int use_include  = FALSE;` |
...
|      - | 3773 | `	int nLen;` |
|      - | 3774 |  |
|  10168 | 3775 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  10168 | 3782 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3783 | `	/* Point to the target IO stream device */` |
|  10168 | 3784 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|  10168 | 3785 | `	if( pStream == 0 ){` |
...
|      - | 3789 | `	}` |
|      - | 3790 | `	/* Data to write */` |
|  10168 | 3791 | `	zData = ph7_value_to_string(apArg[1],&nLen);` |
|      - | 3792 | `	/* Try to open the file in read-write mode */` |
|  10168 | 3793 | `	iOpenFlags = PH7_IO_OPEN_CREATE\|PH7_IO_OPEN_RDWR\|PH7_IO_OPEN_TRUNC;` |
|      - | 3794 | `	/* Extract the flags */` |
|  10168 | 3795 | `	iFlags = 0;` |
|  10168 | 3796 | `	if( nArg > 2 ){` |
...
|    ! 0 | 3808 | `		}` |
|    ! 0 | 3809 | `	}` |
|  15251 | 3810 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,iOpenFlags,use_include,` |
|   5083 | 3811 | `		nArg > 3 ? apArg[3] : 0,FALSE,FALSE);` |
|  10168 | 3812 | `	if( pHandle == 0 ){` |
...
|  10162 | 3847 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|  10162 | 3848 | `	return PH7_OK;` |
|   5085 | 3849 |  |
|      - | 3850 | `/*` |
...
|      - | 4724 | ` */` |
|   3406 | 4725 | `static void InitIOPrivate(ph7_vm *pVm,const ph7_io_stream *pStream,io_private *pOut)` |
|      2 | 4726 |  |
|   3408 | 4727 | `	pOut->pStream = pStream;` |
|   3408 | 4728 | `	SyBlobInit(&pOut->sBuffer,&pVm->sAllocator);` |
|   3408 | 4729 | `	pOut->nOfft = 0;` |
|      - | 4730 | `	/* Set the magic number */` |
|   3408 | 4731 | `	pOut->iMagic = IO_PRIVATE_MAGIC;` |
|   3408 | 4732 |  |
|      - | 4733 | `/*` |
|      - | 4734 | ` * Release the IO private structure.` |
|      - | 4735 | ` */` |
|   3396 | 4736 | `static void ReleaseIOPrivate(ph7_context *pCtx,io_private *pDev)` |
|      2 | 4737 |  |
|   3398 | 4738 | `	SyBlobRelease(&pDev->sBuffer);` |
|   3398 | 4739 | `	pDev->iMagic = 0x2126; /* Invalid magic number so we can detetct misuse */` |
|      - | 4740 | `	/* Release the whole structure */` |
|   3398 | 4741 | `	ph7_context_free_chunk(pCtx,pDev);` |
|   3398 | 4742 |  |
|      - | 4743 | `/*` |
...
|      - | 5170 | ` */` |
|   2490 | 5171 | `PH7_PRIVATE const ph7_vfs * PH7_ExportBuiltinVfs(void)` |
|      2 | 5172 |  |
...
|      - | 5590 | ` */` |
|   2474 | 5591 | `static pipe_private * PipeOpen(ph7_vm *pVm, const char *zCommand, const char *zMode)` |
|      2 | 5592 |  |
|      - | 5593 | `	pipe_private *pPipe;` |
|      - | 5594 | `	FILE *pFile;` |
|   2476 | 5595 | `	if( pVm == 0 \|\| zCommand == 0 \|\| zMode == 0 ){` |
|    ! 0 | 5596 | `		return 0;` |
|      - | 5597 | `	}` |
|      - | 5598 | `	/* Validate mode - only 'r' or 'w' allowed */` |
|   2476 | 5599 | `	if( zMode[0] != 'r' && zMode[0] != 'w' ){` |
|    ! 0 | 5600 | `		return 0;` |
|      - | 5601 | `	}` |
...
|      - | 5661 | `	}` |
|      - | 5662 | `#else /* Unix */` |
|   2474 | 5663 | `	pFile = popen(zCommand, zMode);` |
|   2474 | 5664 | `	if( pFile == 0 ){` |
|    ! 0 | 5665 | `		return 0;` |
|      - | 5666 | `	}` |
|      - | 5667 | `	/* Allocate pipe private structure */` |
|   2474 | 5668 | `	pPipe = (pipe_private *)SyMemBackendAlloc(&pVm->sAllocator, sizeof(pipe_private));` |
|   2474 | 5669 | `	if( pPipe == 0 ){` |
|      - | 5670 | `		/* Out of memory, close the pipe */` |
|    ! 0 | 5671 | `		pclose(pFile);` |
|    ! 0 | 5672 | `		return 0;` |
|      - | 5673 | `	}` |
|      - | 5674 | `	/* Initialize the structure */` |
|   2474 | 5675 | `	pPipe->pFile = pFile;` |
|   2474 | 5676 | `	pPipe->pVm = pVm;` |
|   2474 | 5677 | `	pPipe->iMode = zMode[0];` |
|      - | 5678 | `#endif` |
|   2476 | 5679 | `	return pPipe;` |
|   1239 | 5680 |  |
|      - | 5681 | `/*` |
|      - | 5682 | ` * Close a pipe and return the exit status of the process.` |
|      - | 5683 | ` * Returns the exit status, or -1 on error.` |
|      - | 5684 | ` */` |
|   2474 | 5685 | `static int PipeClose(pipe_private *pPipe)` |
|      2 | 5686 |  |
|      - | 5687 | `	int status;` |
|      - | 5688 | `	ph7_vm *pVm;` |
|   2476 | 5689 | `	if( pPipe == 0 \|\| pPipe->pFile == 0 ){` |
|    ! 0 | 5690 | `		return -1;` |
|      - | 5691 | `	}` |
|   2476 | 5692 | `	pVm = pPipe->pVm;` |
...
|      - | 5697 | `#else` |
|   2474 | 5698 | `	status = pclose(pPipe->pFile);` |
|      - | 5699 | `	/* On Unix, pclose returns the status from waitpid, need to extract exit code */` |
|   2474 | 5700 | `	if( status != -1 ){` |
|   2474 | 5701 | `		if( WIFEXITED(status) ){` |
|   2474 | 5702 | `			status = WEXITSTATUS(status);` |
|   1237 | 5703 | `		}else if( WIFSIGNALED(status) ){` |
...
|   2476 | 5713 | `	SyMemBackendFree(&pVm->sAllocator, pPipe);` |
|   2476 | 5714 | `	return status;` |
|   1239 | 5715 |  |
|      - | 5716 | `/*` |
...
|      - | 5730 | ` */` |
|   3574 | 5731 | `static ph7_int64 PipeStream_Read(void *pHandle, void *pBuffer, ph7_int64 nDatatoRead)` |
|      1 | 5732 |  |
|   3575 | 5733 | `	pipe_private *pPipe = (pipe_private *)pHandle;` |
|      - | 5734 | `	size_t nRead;` |
|   3575 | 5735 | `	if( pPipe == 0 \|\| pPipe->pFile == 0 ){` |
|    ! 0 | 5736 | `		return -1;` |
|      - | 5737 | `	}` |
|   3575 | 5738 | `	if( pPipe->iMode != 'r' ){` |
|      - | 5739 | `		/* Cannot read from a write-only pipe */` |
|    ! 0 | 5740 | `		return -1;` |
|      - | 5741 | `	}` |
|   3575 | 5742 | `	nRead = fread(pBuffer, 1, (size_t)nDatatoRead, pPipe->pFile);` |
|   3575 | 5743 | `	if( nRead == 0 ){` |
|   2511 | 5744 | `		if( feof(pPipe->pFile) ){` |
|   2511 | 5745 | `			return 0; /* EOF */` |
|      - | 5746 | `		}` |
|    ! 0 | 5747 | `		return -1; /* Error */` |
|      - | 5748 | `	}` |
|   1065 | 5749 | `	return (ph7_int64)nRead;` |
|   1788 | 5750 |  |
|      - | 5751 | `/*` |
...
|      - | 5793 | ` */` |
|   2460 | 5794 | `static int is_pipe_stream(const ph7_io_stream *pStream)` |
|      2 | 5795 |  |
|   2462 | 5796 | `	return pStream == &sPipe_Stream;` |
|      2 | 5797 |  |
|      - | 5798 | `/*` |
...
|      - | 5810 | ` */` |
|   2474 | 5811 | `static int PH7_builtin_popen(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 5812 |  |
|      - | 5813 | `	const char *zCommand, *zMode;` |
|      - | 5814 | `	pipe_private *pPipe;` |
|      - | 5815 | `	io_private *pDev;` |
|      - | 5816 | `	int nCmdLen, nModeLen;` |
|   2476 | 5817 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) \|\| !ph7_value_is_string(apArg[1]) ){` |
...
|   2476 | 5824 | `	zCommand = ph7_value_to_string(apArg[0], &nCmdLen);` |
|   2476 | 5825 | `	zMode = ph7_value_to_string(apArg[1], &nModeLen);` |
|   2476 | 5826 | `	if( nCmdLen < 1 ){` |
|    ! 0 | 5827 | `		ph7_context_throw_error(pCtx, PH7_CTX_WARNING, "Empty command");` |
|    ! 0 | 5828 | `		ph7_result_bool(pCtx, 0);` |
|    ! 0 | 5829 | `		return PH7_OK;` |
|      - | 5830 | `	}` |
|   2476 | 5831 | `	if( nModeLen < 1 \|\| (zMode[0] != 'r' && zMode[0] != 'w') ){` |
...
|      - | 5835 | `	}` |
|      - | 5836 | `	/* Open the pipe */` |
|   2476 | 5837 | `	pPipe = PipeOpen(pCtx->pVm, zCommand, zMode);` |
|   2476 | 5838 | `	if( pPipe == 0 ){` |
...
|   2476 | 5844 | `	pDev = (io_private *)ph7_context_alloc_chunk(pCtx, sizeof(io_private), TRUE, FALSE);` |
|   2476 | 5845 | `	if( pDev == 0 ){` |
...
|   2476 | 5852 | `	InitIOPrivate(pCtx->pVm, &sPipe_Stream, pDev);` |
|   2476 | 5853 | `	pDev->pHandle = pPipe;` |
|      - | 5854 | `	/* Return the io_private instance as a resource */` |
|   2476 | 5855 | `	ph7_result_resource(pCtx, pDev);` |
|   2476 | 5856 | `	return PH7_OK;` |
|   1239 | 5857 |  |
|      - | 5858 | `/*` |
...
|      - | 5866 | ` */` |
|   2460 | 5867 | `static int PH7_builtin_pclose(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 5868 |  |
|      - | 5869 | `	const ph7_io_stream *pStream;` |
|      - | 5870 | `	pipe_private *pPipe;` |
|      - | 5871 | `	io_private *pDev;` |
|      - | 5872 | `	int status;` |
|   2462 | 5873 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   2462 | 5880 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 5881 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   2462 | 5882 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   2462 | 5888 | `	pStream = pDev->pStream;` |
|   2462 | 5889 | `	if( pStream == 0 \|\| !is_pipe_stream(pStream) ){` |
...
|   2462 | 5895 | `	pPipe = (pipe_private *)pDev->pHandle;` |
|      - | 5896 | `	/* Close the pipe and get exit status */` |
|   2462 | 5897 | `	status = PipeClose(pPipe);` |
|      - | 5898 | `	/* Release the IO private structure */` |
|   2462 | 5899 | `	ReleaseIOPrivate(pCtx, pDev);` |
|      - | 5900 | `	/* Invalidate the resource handle */` |
|   2462 | 5901 | `	ph7_value_release(apArg[0]);` |
|      - | 5902 | `	/* Return the exit status */` |
|   2462 | 5903 | `	ph7_result_int(pCtx, status);` |
|   2462 | 5904 | `	return PH7_OK;` |
|   1232 | 5905 |  |
...
|      - | 5947 | ` */` |
|   2224 | 5948 | `PH7_PRIVATE sxi32 PH7_RegisterIORoutine(ph7_vm *pVm)` |
|      2 | 5949 |  |
|      - | 5950 | `	/*` |
...
|      - | 6047 | `	};` |
|   2226 | 6048 | `	const ph7_io_stream *pFileStream = 0;` |
|   2226 | 6049 | `	sxu32 n = 0;` |
|      - | 6050 | `	/* Register disk-related functions */` |
| 108978 | 6051 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVfsDiskFunc) ; ++n ){` |
| 106754 | 6052 | `		ph7_create_function(&(*pVm),aVfsDiskFunc[n].zName,aVfsDiskFunc[n].xFunc,(void *)pVm->pEngine->pVfs);` |
|  53378 | 6053 | `	}` |
|  80066 | 6054 | `	for( n = 0 ; n < SX_ARRAYSIZE(aIOFunc) ; ++n ){` |
|  77842 | 6055 | `		ph7_create_function(&(*pVm),aIOFunc[n].zName,aIOFunc[n].xFunc,pVm);` |
|  38922 | 6056 | `	}` |
|      - | 6057 | `#else` |
|      - | 6058 | `	SXUNUSED(pVm);` |
...
|      - | 6085 | `	};` |
|  37810 | 6086 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVfsHelperFunc) ; ++n ){` |
|  35586 | 6087 | `		ph7_create_function(&(*pVm),aVfsHelperFunc[n].zName,aVfsHelperFunc[n].xFunc,pVm);` |
|  17794 | 6088 | `	}` |
...
|   2224 | 6096 | `	pFileStream = &sUnixFileStream;` |
|      - | 6097 | `#endif` |
|      - | 6098 | `	/* Install the php:// stream */` |
|   2226 | 6099 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,&sPHP_Stream);` |
|   2226 | 6100 | `	if( pFileStream ){` |
|      - | 6101 | `		/* Install the file:// stream */` |
|   2226 | 6102 | `		ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,pFileStream);` |
|   1112 | 6103 | `	}` |
|      - | 6104 | `#endif /* PH7_DISABLE_DISK_IO */` |
|      - | 6105 |  |
|   2226 | 6106 | `	return SXRET_OK;` |
|      2 | 6107 |  |
|      - | 6108 | `/*` |
