...
|      - |   65 | ` */` |
|  13068 |   66 | `static int PH7_vfs_chdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |   67 |  |
|      - |   68 | `	const char *zPath;` |
|      - |   69 | `	ph7_vfs *pVfs;` |
|      - |   70 | `	int rc;` |
|  13073 |   71 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |   72 | `		/* Missing/Invalid argument,return FALSE */` |
|      8 |   73 | `		ph7_result_bool(pCtx,0);` |
|      8 |   74 | `		return PH7_OK;` |
|      - |   75 | `	}` |
|      - |   76 | `	/* Point to the underlying vfs */` |
|  13067 |   77 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  13067 |   78 | `	if( pVfs == 0 \|\| pVfs->xChdir == 0 ){` |
...
|  13067 |   88 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |   89 | `	/* Perform the requested operation */` |
|  13067 |   90 | `	rc = pVfs->xChdir(zPath);` |
|      - |   91 | `	/* IO return value */` |
|  13067 |   92 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  13067 |   93 | `	return PH7_OK;` |
|   6539 |   94 |  |
|      - |   95 | `/*` |
...
|      - |  213 | ` */` |
|   7708 |  214 | `static int PH7_vfs_is_dir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  215 |  |
|      - |  216 | `	const char *zPath;` |
|      - |  217 | `	ph7_vfs *pVfs;` |
|      - |  218 | `	int rc;` |
|   7713 |  219 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  220 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  221 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  222 | `		return PH7_OK;` |
|      - |  223 | `	}` |
|      - |  224 | `	/* Point to the underlying vfs */` |
|   7713 |  225 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   7713 |  226 | `	if( pVfs == 0 \|\| pVfs->xIsdir == 0 ){` |
...
|   7713 |  236 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  237 | `	/* Perform the requested operation */` |
|   7713 |  238 | `	rc = pVfs->xIsdir(zPath);` |
|      - |  239 | `	/* IO return value */` |
|   7713 |  240 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   7713 |  241 | `	return PH7_OK;` |
|   3859 |  242 |  |
|      - |  243 | `/*` |
...
|      - |  476 | ` */` |
|  29048 |  477 | `static int PH7_vfs_unlink(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  478 |  |
|      - |  479 | `	const char *zPath;` |
|      - |  480 | `	ph7_vfs *pVfs;` |
|      - |  481 | `	int rc;` |
|  29053 |  482 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  483 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  484 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  485 | `		return PH7_OK;` |
|      - |  486 | `	}` |
|      - |  487 | `	/* Point to the underlying vfs */` |
|  29053 |  488 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  29053 |  489 | `	if( pVfs == 0 \|\| pVfs->xUnlink == 0 ){` |
...
|  29053 |  499 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  500 | `	/* Perform the requested operation */` |
|  29053 |  501 | `	rc = pVfs->xUnlink(zPath);` |
|      - |  502 | `	/* IO return value */` |
|  29053 |  503 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  29053 |  504 | `	return PH7_OK;` |
|  14529 |  505 |  |
|      - |  506 | `/*` |
...
|      - |  907 | ` */` |
|   5782 |  908 | `static int PH7_vfs_is_file(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  909 |  |
|      - |  910 | `	const char *zPath;` |
|      - |  911 | `	ph7_vfs *pVfs;` |
|      - |  912 | `	int rc;` |
|   5787 |  913 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  914 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  915 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  916 | `		return PH7_OK;` |
|      - |  917 | `	}` |
|      - |  918 | `	/* Point to the underlying vfs */` |
|   5787 |  919 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   5787 |  920 | `	if( pVfs == 0 \|\| pVfs->xIsfile == 0 ){` |
...
|   5787 |  930 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  931 | `	/* Perform the requested operation */` |
|   5787 |  932 | `	rc = pVfs->xIsfile(zPath);` |
|      - |  933 | `	/* IO return value */` |
|   5787 |  934 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   5787 |  935 | `	return PH7_OK;` |
|   2896 |  936 |  |
|      - |  937 | `/*` |
...
|      - | 1554 | ` */` |
|  11554 | 1555 | `static sxi32 ExtractPathInfo(const char *zPath,int nByte,path_info *pOut)` |
|      5 | 1556 |  |
|  11559 | 1557 | `	const char *zPtr,*zEnd = &zPath[nByte - 1];` |
|      - | 1558 | `	SyString *pCur;` |
|      - | 1559 | `	int c,d;` |
|  11559 | 1560 | `	c = d = '/';` |
...
|  11559 | 1565 | `	SyZero(pOut,sizeof(path_info));` |
|      - | 1566 | `	/* Handle special case */` |
|  11559 | 1567 | `	if( nByte == sizeof(char) && ( (int)zPath[0] == c \|\| (int)zPath[0] == d ) ){` |
...
| 308704 | 1576 | `	while( zEnd > zPath && ( (int)zEnd[0] != c && (int)zEnd[0] != d ) ){` |
| 291373 | 1577 | `		zEnd--;` |
|      5 | 1578 | `	}` |
|  11559 | 1579 | `	zPtr = (zEnd > zPath) ? &zEnd[1] : zPath;` |
|  11559 | 1580 | `	zEnd = &zPath[nByte];` |
|      - | 1581 | `	/* dirname */` |
|  11559 | 1582 | `	pCur = &pOut->sDir;` |
|  11559 | 1583 | `	SyStringInitFromBuf(pCur,zPath,zPtr-zPath);` |
|  11559 | 1584 | `	if( pCur->nByte > 1 ){` |
|  23113 | 1585 | `		SyStringTrimTrailingChar(pCur,'/');` |
|      - | 1586 | `#ifdef __WINNT__` |
|      5 | 1587 | `		SyStringTrimTrailingChar(pCur,'\\');` |
|      - | 1588 | `#endif` |
|   5782 | 1589 | `	}else if( (int)zPath[0] == c \|\| (int)zPath[0] == d ){` |
...
|  11559 | 1597 | `	pCur = &pOut->sBasename;` |
|  11559 | 1598 | `	SyStringInitFromBuf(pCur,zPtr,zEnd-zPtr);` |
|  11559 | 1599 | `	SyStringTrimLeadingChar(pCur,'/');` |
|      - | 1600 | `#ifdef __WINNT__` |
|      5 | 1601 | `	SyStringTrimLeadingChar(pCur,'\\');` |
|      - | 1602 | `#endif` |
|  11559 | 1603 | `	SyStringDupPtr(&pOut->sFilename,pCur);` |
|  11559 | 1604 | `	if( pCur->nByte > 0 ){` |
|      - | 1605 | `		/* extension */` |
|  11559 | 1606 | `		zEnd--;` |
|  57769 | 1607 | `		while( zEnd > pCur->zString /*basename*/ && zEnd[0] != '.' ){` |
|  46215 | 1608 | `			zEnd--;` |
|      5 | 1609 | `		}` |
|  11559 | 1610 | `		if( zEnd > pCur->zString ){` |
|  11557 | 1611 | `			zEnd++; /* Jump leading dot */` |
|  11557 | 1612 | `			SyStringInitFromBuf(&pOut->sExtension,zEnd,&zPath[nByte]-zEnd);` |
|      - | 1613 | `			/* Fix filename */` |
|  11557 | 1614 | `			pCur = &pOut->sFilename;` |
|  11557 | 1615 | `			if( pCur->nByte > SyStringLength(&pOut->sExtension) ){` |
|  11557 | 1616 | `				pCur->nByte -= 1 + SyStringLength(&pOut->sExtension);` |
|   5776 | 1617 | `			}` |
|   5776 | 1618 | `		}` |
|   5777 | 1619 | `	}` |
|  11559 | 1620 | `	return SXRET_OK;` |
|   5782 | 1621 |  |
|      - | 1622 | `/*` |
...
|      - | 1625 | ` */` |
|  11554 | 1626 | `static int PH7_builtin_pathinfo(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1627 |  |
|      - | 1628 | `	const char *zPath;` |
|      - | 1629 | `	path_info sInfo;` |
|      - | 1630 | `	SyString *pComp;` |
|      - | 1631 | `	int iLen;` |
|  11559 | 1632 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  11559 | 1638 | `	zPath = ph7_value_to_string(apArg[0],&iLen);` |
|  11559 | 1639 | `	if( iLen < 1 ){` |
|      - | 1640 | `		/* Empty string */` |
|    ! 0 | 1641 | `		ph7_result_string(pCtx,"",0);` |
|    ! 0 | 1642 | `		return PH7_OK;` |
|      - | 1643 | `	}` |
|      - | 1644 | `	/* Extract path info */` |
|  11559 | 1645 | `	ExtractPathInfo(zPath,iLen,&sInfo);` |
|  17335 | 1646 | `	if( nArg > 1 && ph7_value_is_int(apArg[1]) ){` |
|      - | 1647 | `		/* Return path component */` |
|  11557 | 1648 | `		int nComp = ph7_value_to_int(apArg[1]);` |
|  11557 | 1649 | `		switch(nComp){` |
...
|      - | 1666 | `			}` |
|      3 | 1667 | `			break;` |
|   2889 | 1668 | `		case 3: /*PATHINFO_EXTENSION*/` |
|   5783 | 1669 | `			pComp = &sInfo.sExtension;` |
|   5783 | 1670 | `			if( pComp->nByte > 0 ){` |
|   5781 | 1671 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   2893 | 1672 | `			}else{` |
|      - | 1673 | `				/* Expand the empty string */` |
|      3 | 1674 | `				ph7_result_string(pCtx,"",0);` |
|      - | 1675 | `			}` |
|   5783 | 1676 | `			break;` |
|   2885 | 1677 | `		case 4: /*PATHINFO_FILENAME*/` |
|   5775 | 1678 | `			pComp = &sInfo.sFilename;` |
|   5775 | 1679 | `			if( pComp->nByte > 0 ){` |
|   5775 | 1680 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   2890 | 1681 | `			}else{` |
...
|      - | 2904 | ` */` |
|  29018 | 2905 | `PH7_PRIVATE void * PH7_StreamOpenHandle(ph7_vm *pVm,const ph7_io_stream *pStream,const char *zFile,` |
|      - | 2906 | `	int iFlags,int use_include,ph7_value *pResource,int bPushInclude,int *pNew)` |
|      5 | 2907 |  |
|  29023 | 2908 | `	void *pHandle = 0; /* cc warning */` |
|      - | 2909 | `	SyString sFile;` |
|      - | 2910 | `	int rc;` |
|  29023 | 2911 | `	if( pStream == 0 ){` |
|      - | 2912 | `		/* No such stream device */` |
|    ! 0 | 2913 | `		return 0;` |
|      - | 2914 | `	}` |
|  29023 | 2915 | `	SyStringInitFromBuf(&sFile,zFile,SyStrlen(zFile));` |
|  29023 | 2916 | `	if( use_include ){` |
|   9826 | 2917 | `		if(	sFile.zString[0] == '/' \|\|` |
|      - | 2918 | `#ifdef __WINNT__` |
|      - | 2919 | `			(sFile.nByte > 2 && sFile.zString[1] == ':' && (sFile.zString[2] == '\\' \|\| sFile.zString[2] == '/') ) \|\|` |
|      - | 2920 | `#endif` |
|   9812 | 2921 | `			(sFile.nByte > 1 && sFile.zString[0] == '.' && sFile.zString[1] == '/') \|\|` |
|   9808 | 2922 | `			(sFile.nByte > 2 && sFile.zString[0] == '.' && sFile.zString[1] == '.' && sFile.zString[2] == '/') ){` |
...
|   9812 | 2934 | `			SyBlobInit(&sWorker,&pVm->sAllocator);` |
|      - | 2935 | `			/* Build a path from the set of include path */` |
|   9812 | 2936 | `			SySetResetCursor(&pVm->aPaths);` |
|   9812 | 2937 | `			rc = SXERR_IO;` |
|   9818 | 2938 | `			while( SXRET_OK == SySetGetNextEntry(&pVm->aPaths,(void **)&pPath) ){` |
|      - | 2939 | `				/* Build full path */` |
|   9812 | 2940 | `				SyBlobFormat(&sWorker,"%z%c%z",pPath,c,&sFile);` |
|      - | 2941 | `				/* Append null terminator */` |
|   9812 | 2942 | `				if( SXRET_OK != SyBlobNullAppend(&sWorker) ){` |
|    ! 0 | 2943 | `					continue;` |
|      - | 2944 | `				}` |
|      - | 2945 | `				/* Try to open the file */` |
|   9812 | 2946 | `				rc = pStream->xOpen((const char *)SyBlobData(&sWorker),iFlags,pResource,&pHandle);` |
|   9812 | 2947 | `				if( rc == PH7_OK ){` |
|   9806 | 2948 | `					if( bPushInclude ){` |
|      - | 2949 | `						/* Mark as included */` |
|   9806 | 2950 | `						PH7_VmPushFilePath(pVm,(const char *)SyBlobData(&sWorker),SyBlobLength(&sWorker),FALSE,pNew);` |
|   4901 | 2951 | `					}` |
|   9806 | 2952 | `					break;` |
|      - | 2953 | `				}` |
...
|      2 | 2957 | `			}` |
|   9812 | 2958 | `			SyBlobRelease(&sWorker);` |
|      - | 2959 | `		}` |
|   9830 | 2960 | `		if( rc == PH7_OK ){` |
|   9824 | 2961 | `			if( bPushInclude ){` |
|      - | 2962 | `				/* Mark as included */` |
|   9824 | 2963 | `				PH7_VmPushFilePath(pVm,sFile.zString,sFile.nByte,FALSE,pNew);` |
|   4910 | 2964 | `			}` |
|   4910 | 2965 | `		}` |
|   4917 | 2966 | `	}else{` |
|      - | 2967 | `		/* Open the URI direcly */` |
|  19197 | 2968 | `		rc = pStream->xOpen(zFile,iFlags,pResource,&pHandle);` |
|      - | 2969 | `	}` |
|  29023 | 2970 | `	if( rc != PH7_OK ){` |
|      - | 2971 | `		/* IO error */` |
|     15 | 2972 | `		return 0;` |
|      - | 2973 | `	}` |
|      - | 2974 | `	/* Return the file handle */` |
|  29011 | 2975 | `	return pHandle;` |
|  14514 | 2976 |  |
|      - | 2977 | `/*` |
...
|      - | 2981 | ` */` |
|   9814 | 2982 | `PH7_PRIVATE sxi32 PH7_StreamReadWholeFile(void *pHandle,const ph7_io_stream *pStream,SyBlob *pOut)` |
|      4 | 2983 |  |
...
|   9814 | 2988 | `	for(;;){` |
|  19632 | 2989 | `		nRead = pStream->xRead(pHandle,zBuf,sizeof(zBuf));` |
|  19632 | 2990 | `		if( nRead < 1 ){` |
|      - | 2991 | `			/* EOF or IO error */` |
|   9818 | 2992 | `			break;` |
|      - | 2993 | `		}` |
|      - | 2994 | `		/* Append contents */` |
|   9818 | 2995 | `		rc = SyBlobAppend(pOut,zBuf,(sxu32)nRead);` |
|   9818 | 2996 | `		if( rc != SXRET_OK ){` |
|    ! 0 | 2997 | `			break;` |
|      - | 2998 | `		}` |
|      4 | 2999 | `	}` |
|   9818 | 3000 | `	return SyBlobLength(pOut) > 0 ? SXRET_OK : -1;` |
|      4 | 3001 |  |
|      - | 3002 | `/*` |
|      - | 3003 | ` * Close an open IO stream handle [i.e local file/URI..].` |
|      - | 3004 | ` */` |
|  29098 | 3005 | `PH7_PRIVATE void PH7_StreamCloseHandle(const ph7_io_stream *pStream,void *pHandle)` |
|      5 | 3006 |  |
|  29103 | 3007 | `	if( pStream->xClose ){` |
|  29103 | 3008 | `		pStream->xClose(pHandle);` |
|  14549 | 3009 | `	}` |
|  29103 | 3010 |  |
|      - | 3011 | `/*` |
...
|      - | 3389 | ` */` |
|   7706 | 3390 | `static int PH7_builtin_readdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3391 |  |
|      - | 3392 | `	const ph7_io_stream *pStream;` |
|      - | 3393 | `	io_private *pDev;` |
|      - | 3394 | `	int rc;` |
|   7711 | 3395 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   7711 | 3402 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3403 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   7711 | 3404 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   7711 | 3411 | `	pStream = pDev->pStream;` |
|   7711 | 3412 | `	if( pStream == 0  \|\| pStream->xReadDir == 0 ){` |
...
|      - | 3419 | `	}` |
|   7711 | 3420 | `	ph7_result_bool(pCtx,0);` |
|      - | 3421 | `	/* Perform the requested operation */` |
|   7711 | 3422 | `	rc = pStream->xReadDir(pDev->pHandle,pCtx);` |
|   7711 | 3423 | `	if( rc != PH7_OK ){` |
|      - | 3424 | `		/* Return FALSE */` |
|    969 | 3425 | `		ph7_result_bool(pCtx,0);` |
|    482 | 3426 | `	}` |
|   7711 | 3427 | `	return PH7_OK;` |
|   3858 | 3428 |  |
|      - | 3429 | `/*` |
...
|      - | 3482 | ` */` |
|    966 | 3483 | `static int PH7_builtin_closedir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3484 |  |
|      - | 3485 | `	const ph7_io_stream *pStream;` |
|      - | 3486 | `	io_private *pDev;` |
|    971 | 3487 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|    971 | 3494 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3495 | `	/* Make sure we are dealing with a valid io_private instance */` |
|    971 | 3496 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|    971 | 3503 | `	pStream = pDev->pStream;` |
|    971 | 3504 | `	if( pStream == 0  \|\| pStream->xCloseDir == 0 ){` |
...
|    971 | 3513 | `	pStream->xCloseDir(pDev->pHandle);` |
|      - | 3514 | `	/* Release the private stucture */` |
|    971 | 3515 | `	ReleaseIOPrivate(pCtx,pDev);` |
|    971 | 3516 | `	PH7_MemObjRelease(apArg[0]);` |
|    971 | 3517 | `	return PH7_OK;` |
|    488 | 3518 | ` }` |
|      - | 3519 | `/*` |
...
|      - | 3529 | ` */` |
|    966 | 3530 | `static int PH7_builtin_opendir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3531 |  |
|      - | 3532 | `	const ph7_io_stream *pStream;` |
|      - | 3533 | `	const char *zPath;` |
|      - | 3534 | `	io_private *pDev;` |
|      - | 3535 | `	int iLen,rc;` |
|    971 | 3536 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|    971 | 3543 | `	zPath  = ph7_value_to_string(apArg[0],&iLen);` |
|      - | 3544 | `	/* Try to extract a stream */` |
|    971 | 3545 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zPath,iLen);` |
|    971 | 3546 | `	if( pStream == 0 ){` |
...
|      - | 3551 | `	}` |
|    971 | 3552 | `	if( pStream->xOpenDir == 0 ){` |
...
|    971 | 3561 | `	pDev = (io_private *)ph7_context_alloc_chunk(pCtx,sizeof(io_private),TRUE,FALSE);` |
|    971 | 3562 | `	if( pDev == 0 ){` |
...
|    971 | 3568 | `	InitIOPrivate(pCtx->pVm,pStream,pDev);` |
|      - | 3569 | `	/* Open the target directory */` |
|    971 | 3570 | `	rc = pStream->xOpenDir(zPath,nArg > 1 ? apArg[1] : 0,&pDev->pHandle);` |
|    971 | 3571 | `	if( rc != PH7_OK ){` |
...
|    971 | 3577 | `		ph7_result_resource(pCtx,pDev);` |
|      - | 3578 | `	}` |
|    971 | 3579 | `	return PH7_OK;` |
|    488 | 3580 |  |
|      - | 3581 | `/*` |
...
|      - | 3671 | ` */` |
|   5810 | 3672 | `static int PH7_builtin_file_get_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3673 |  |
|      - | 3674 | `	const ph7_io_stream *pStream;` |
|      - | 3675 | `	ph7_int64 n,nRead,nMaxlen;` |
|   5815 | 3676 | `	int use_include  = FALSE;` |
|      - | 3677 | `	const char *zFile;` |
|      - | 3678 | `	char zBuf[8192];` |
|      - | 3679 | `	void *pHandle;` |
|      - | 3680 | `	int nLen;` |
|      - | 3681 |  |
|   5815 | 3682 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   5815 | 3689 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3690 | `	/* Point to the target IO stream device */` |
|   5815 | 3691 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|   5815 | 3692 | `	if( pStream == 0 ){` |
...
|   5815 | 3702 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,PH7_IO_OPEN_RDONLY,use_include,nArg > 2 ? apArg[2] : 0,FALSE,0);` |
|   5815 | 3703 | `	if( pHandle == 0 ){` |
...
|   5815 | 3723 | `	nRead = 0;` |
|   5809 | 3724 | `	for(;;){` |
|  17435 | 3725 | `		n = pStream->xRead(pHandle,zBuf,` |
|   5812 | 3726 | `			(nMaxlen > 0 && (nMaxlen < (ph7_int64)sizeof(zBuf))) ? nMaxlen : (ph7_int64)sizeof(zBuf));` |
|  11623 | 3727 | `		if( n < 1 ){` |
|      - | 3728 | `			/* EOF or IO error,break immediately */` |
|   5813 | 3729 | `			break;` |
|      - | 3730 | `		}` |
|      - | 3731 | `		/* Append data */` |
|   5815 | 3732 | `		ph7_result_string(pCtx,zBuf,(int)n);` |
|      - | 3733 | `		/* Increment read counter */` |
|   5815 | 3734 | `		nRead += n;` |
|   5815 | 3735 | `		if( nMaxlen > 0 && nRead >= nMaxlen ){` |
|      - | 3736 | `			/* Read limit reached */` |
|      3 | 3737 | `			break;` |
|      - | 3738 | `		}` |
|      5 | 3739 | `	}` |
|      - | 3740 | `	/* Close the stream */` |
|   5815 | 3741 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|      - | 3742 | `	/* Check if we have read something */` |
|   5815 | 3743 | `	if( ph7_context_result_buf_length(pCtx) < 1 ){` |
|      - | 3744 | `		/* Nothing read,return FALSE */` |
|    ! 0 | 3745 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 3746 | `	}` |
|   5815 | 3747 | `	return PH7_OK;` |
|   2910 | 3748 |  |
|      - | 3749 | `/*` |
...
|      - | 3767 | ` */` |
|  13298 | 3768 | `static int PH7_builtin_file_put_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3769 |  |
|  13303 | 3770 | `	int use_include  = FALSE;` |
...
|      - | 3777 | `	int nLen;` |
|      - | 3778 |  |
|  13303 | 3779 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  13303 | 3786 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3787 | `	/* Point to the target IO stream device */` |
|  13303 | 3788 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|  13303 | 3789 | `	if( pStream == 0 ){` |
...
|      - | 3793 | `	}` |
|      - | 3794 | `	/* Data to write */` |
|  13303 | 3795 | `	zData = ph7_value_to_string(apArg[1],&nLen);` |
|      - | 3796 | `	/* Try to open the file in read-write mode */` |
|  13303 | 3797 | `	iOpenFlags = PH7_IO_OPEN_CREATE\|PH7_IO_OPEN_RDWR\|PH7_IO_OPEN_TRUNC;` |
|      - | 3798 | `	/* Extract the flags */` |
|  13303 | 3799 | `	iFlags = 0;` |
|  13303 | 3800 | `	if( nArg > 2 ){` |
...
|    ! 0 | 3812 | `		}` |
|    ! 0 | 3813 | `	}` |
|  19952 | 3814 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,iOpenFlags,use_include,` |
|   6649 | 3815 | `		nArg > 3 ? apArg[3] : 0,FALSE,FALSE);` |
|  13303 | 3816 | `	if( pHandle == 0 ){` |
...
|  13297 | 3851 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|  13297 | 3852 | `	return PH7_OK;` |
|   6654 | 3853 |  |
|      - | 3854 | `/*` |
...
|      - | 4728 | ` */` |
|   4440 | 4729 | `static void InitIOPrivate(ph7_vm *pVm,const ph7_io_stream *pStream,io_private *pOut)` |
|      5 | 4730 |  |
|   4445 | 4731 | `	pOut->pStream = pStream;` |
|   4445 | 4732 | `	SyBlobInit(&pOut->sBuffer,&pVm->sAllocator);` |
|   4445 | 4733 | `	pOut->nOfft = 0;` |
|      - | 4734 | `	/* Set the magic number */` |
|   4445 | 4735 | `	pOut->iMagic = IO_PRIVATE_MAGIC;` |
|   4445 | 4736 |  |
|      - | 4737 | `/*` |
|      - | 4738 | ` * Release the IO private structure.` |
|      - | 4739 | ` */` |
|   4408 | 4740 | `static void ReleaseIOPrivate(ph7_context *pCtx,io_private *pDev)` |
|      5 | 4741 |  |
|   4413 | 4742 | `	SyBlobRelease(&pDev->sBuffer);` |
|   4413 | 4743 | `	pDev->iMagic = 0x2126; /* Invalid magic number so we can detetct misuse */` |
|      - | 4744 | `	/* Release the whole structure */` |
|   4413 | 4745 | `	ph7_context_free_chunk(pCtx,pDev);` |
|   4413 | 4746 |  |
|      - | 4747 | `/*` |
