...
|      - |   60 | ` */` |
|   8342 |   61 | `static int PH7_vfs_chdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 |   62 |  |
|      - |   63 | `	const char *zPath;` |
|      - |   64 | `	ph7_vfs *pVfs;` |
|      - |   65 | `	int rc;` |
|   8344 |   66 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |   67 | `		/* Missing/Invalid argument,return FALSE */` |
|      8 |   68 | `		ph7_result_bool(pCtx,0);` |
|      8 |   69 | `		return PH7_OK;` |
|      - |   70 | `	}` |
|      - |   71 | `	/* Point to the underlying vfs */` |
|   8338 |   72 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   8338 |   73 | `	if( pVfs == 0 \|\| pVfs->xChdir == 0 ){` |
...
|   8338 |   83 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |   84 | `	/* Perform the requested operation */` |
|   8338 |   85 | `	rc = pVfs->xChdir(zPath);` |
|      - |   86 | `	/* IO return value */` |
|   8338 |   87 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   8338 |   88 | `	return PH7_OK;` |
|   4173 |   89 |  |
|      - |   90 | `/*` |
...
|      - |  208 | ` */` |
|   4980 |  209 | `static int PH7_vfs_is_dir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 |  210 |  |
|      - |  211 | `	const char *zPath;` |
|      - |  212 | `	ph7_vfs *pVfs;` |
|      - |  213 | `	int rc;` |
|   4982 |  214 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  215 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  216 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  217 | `		return PH7_OK;` |
|      - |  218 | `	}` |
|      - |  219 | `	/* Point to the underlying vfs */` |
|   4982 |  220 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   4982 |  221 | `	if( pVfs == 0 \|\| pVfs->xIsdir == 0 ){` |
...
|   4982 |  231 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  232 | `	/* Perform the requested operation */` |
|   4982 |  233 | `	rc = pVfs->xIsdir(zPath);` |
|      - |  234 | `	/* IO return value */` |
|   4982 |  235 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   4982 |  236 | `	return PH7_OK;` |
|   2492 |  237 |  |
|      - |  238 | `/*` |
...
|      - |  471 | ` */` |
|  17152 |  472 | `static int PH7_vfs_unlink(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 |  473 |  |
|      - |  474 | `	const char *zPath;` |
|      - |  475 | `	ph7_vfs *pVfs;` |
|      - |  476 | `	int rc;` |
|  17154 |  477 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  478 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  479 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  480 | `		return PH7_OK;` |
|      - |  481 | `	}` |
|      - |  482 | `	/* Point to the underlying vfs */` |
|  17154 |  483 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  17154 |  484 | `	if( pVfs == 0 \|\| pVfs->xUnlink == 0 ){` |
...
|  17154 |  494 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  495 | `	/* Perform the requested operation */` |
|  17154 |  496 | `	rc = pVfs->xUnlink(zPath);` |
|      - |  497 | `	/* IO return value */` |
|  17154 |  498 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  17154 |  499 | `	return PH7_OK;` |
|   8578 |  500 |  |
|      - |  501 | `/*` |
...
|      - |  902 | ` */` |
|   3404 |  903 | `static int PH7_vfs_is_file(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 |  904 |  |
|      - |  905 | `	const char *zPath;` |
|      - |  906 | `	ph7_vfs *pVfs;` |
|      - |  907 | `	int rc;` |
|   3406 |  908 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  909 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  910 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  911 | `		return PH7_OK;` |
|      - |  912 | `	}` |
|      - |  913 | `	/* Point to the underlying vfs */` |
|   3406 |  914 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   3406 |  915 | `	if( pVfs == 0 \|\| pVfs->xIsfile == 0 ){` |
...
|   3406 |  925 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  926 | `	/* Perform the requested operation */` |
|   3406 |  927 | `	rc = pVfs->xIsfile(zPath);` |
|      - |  928 | `	/* IO return value */` |
|   3406 |  929 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   3406 |  930 | `	return PH7_OK;` |
|   1704 |  931 |  |
|      - |  932 | `/*` |
...
|      - | 1549 | ` */` |
|   6806 | 1550 | `static sxi32 ExtractPathInfo(const char *zPath,int nByte,path_info *pOut)` |
|      2 | 1551 |  |
|   6808 | 1552 | `	const char *zPtr,*zEnd = &zPath[nByte - 1];` |
|      - | 1553 | `	SyString *pCur;` |
|      - | 1554 | `	int c,d;` |
|   6808 | 1555 | `	c = d = '/';` |
...
|   6808 | 1560 | `	SyZero(pOut,sizeof(path_info));` |
|      - | 1561 | `	/* Handle special case */` |
|   6808 | 1562 | `	if( nByte == sizeof(char) && ( (int)zPath[0] == c \|\| (int)zPath[0] == d ) ){` |
...
| 164707 | 1571 | `	while( zEnd > zPath && ( (int)zEnd[0] != c && (int)zEnd[0] != d ) ){` |
| 154498 | 1572 | `		zEnd--;` |
|      2 | 1573 | `	}` |
|   6808 | 1574 | `	zPtr = (zEnd > zPath) ? &zEnd[1] : zPath;` |
|   6808 | 1575 | `	zEnd = &zPath[nByte];` |
|      - | 1576 | `	/* dirname */` |
|   6808 | 1577 | `	pCur = &pOut->sDir;` |
|   6808 | 1578 | `	SyStringInitFromBuf(pCur,zPath,zPtr-zPath);` |
|   6808 | 1579 | `	if( pCur->nByte > 1 ){` |
|  13614 | 1580 | `		SyStringTrimTrailingChar(pCur,'/');` |
|      - | 1581 | `#ifdef __WINNT__` |
|      2 | 1582 | `		SyStringTrimTrailingChar(pCur,'\\');` |
|      - | 1583 | `#endif` |
|   3405 | 1584 | `	}else if( (int)zPath[0] == c \|\| (int)zPath[0] == d ){` |
...
|   6808 | 1592 | `	pCur = &pOut->sBasename;` |
|   6808 | 1593 | `	SyStringInitFromBuf(pCur,zPtr,zEnd-zPtr);` |
|   6808 | 1594 | `	SyStringTrimLeadingChar(pCur,'/');` |
|      - | 1595 | `#ifdef __WINNT__` |
|      2 | 1596 | `	SyStringTrimLeadingChar(pCur,'\\');` |
|      - | 1597 | `#endif` |
|   6808 | 1598 | `	SyStringDupPtr(&pOut->sFilename,pCur);` |
|   6808 | 1599 | `	if( pCur->nByte > 0 ){` |
|      - | 1600 | `		/* extension */` |
|   6808 | 1601 | `		zEnd--;` |
|  34030 | 1602 | `		while( zEnd > pCur->zString /*basename*/ && zEnd[0] != '.' ){` |
|  27224 | 1603 | `			zEnd--;` |
|      2 | 1604 | `		}` |
|   6808 | 1605 | `		if( zEnd > pCur->zString ){` |
|   6806 | 1606 | `			zEnd++; /* Jump leading dot */` |
|   6806 | 1607 | `			SyStringInitFromBuf(&pOut->sExtension,zEnd,&zPath[nByte]-zEnd);` |
|      - | 1608 | `			/* Fix filename */` |
|   6806 | 1609 | `			pCur = &pOut->sFilename;` |
|   6806 | 1610 | `			if( pCur->nByte > SyStringLength(&pOut->sExtension) ){` |
|   6806 | 1611 | `				pCur->nByte -= 1 + SyStringLength(&pOut->sExtension);` |
|   3402 | 1612 | `			}` |
|   3402 | 1613 | `		}` |
|   3403 | 1614 | `	}` |
|   6808 | 1615 | `	return SXRET_OK;` |
|   3405 | 1616 |  |
|      - | 1617 | `/*` |
...
|      - | 1620 | ` */` |
|   6806 | 1621 | `static int PH7_builtin_pathinfo(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 1622 |  |
|      - | 1623 | `	const char *zPath;` |
|      - | 1624 | `	path_info sInfo;` |
|      - | 1625 | `	SyString *pComp;` |
|      - | 1626 | `	int iLen;` |
|   6808 | 1627 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   6808 | 1633 | `	zPath = ph7_value_to_string(apArg[0],&iLen);` |
|   6808 | 1634 | `	if( iLen < 1 ){` |
|      - | 1635 | `		/* Empty string */` |
...
|   6808 | 1640 | `	ExtractPathInfo(zPath,iLen,&sInfo);` |
|  10210 | 1641 | `	if( nArg > 1 && ph7_value_is_int(apArg[1]) ){` |
|      - | 1642 | `		/* Return path component */` |
|   6806 | 1643 | `		int nComp = ph7_value_to_int(apArg[1]);` |
|   6806 | 1644 | `		switch(nComp){` |
...
|      - | 1661 | `			}` |
|      3 | 1662 | `			break;` |
|   1701 | 1663 | `		case 3: /*PATHINFO_EXTENSION*/` |
|   3404 | 1664 | `			pComp = &sInfo.sExtension;` |
|   3404 | 1665 | `			if( pComp->nByte > 0 ){` |
|   3402 | 1666 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   1702 | 1667 | `			}else{` |
|      - | 1668 | `				/* Expand the empty string */` |
|      3 | 1669 | `				ph7_result_string(pCtx,"",0);` |
|      - | 1670 | `			}` |
|   3404 | 1671 | `			break;` |
|   1699 | 1672 | `		case 4: /*PATHINFO_FILENAME*/` |
|   3400 | 1673 | `			pComp = &sInfo.sFilename;` |
|   3400 | 1674 | `			if( pComp->nByte > 0 ){` |
|   3400 | 1675 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   1701 | 1676 | `			}else{` |
...
|      - | 2698 | ` */` |
|   3522 | 2699 | `static int PH7_builtin_feof(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 2700 |  |
|      - | 2701 | `	const ph7_io_stream *pStream;` |
|      - | 2702 | `	io_private *pDev;` |
|      - | 2703 | `	int rc;` |
|   3524 | 2704 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   3524 | 2711 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 2712 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   3524 | 2713 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   3524 | 2720 | `	pStream = pDev->pStream;` |
|   3524 | 2721 | `	if( pStream == 0 ){` |
...
|      - | 2728 | `	}` |
|   3524 | 2729 | `	rc = SXERR_EOF;` |
|      - | 2730 | `	/* Perform the requested operation */` |
|   3524 | 2731 | `	if( SyBlobLength(&pDev->sBuffer) > pDev->nOfft ){` |
...
|   2160 | 2738 | `		n = pStream->xRead(pDev->pHandle,zBuf,sizeof(zBuf));` |
|   2160 | 2739 | `		if( n > 0 ){` |
|      - | 2740 | `			/* Copy buffered data */` |
|    616 | 2741 | `			SyBlobAppend(&pDev->sBuffer,zBuf,(sxu32)n);` |
|    616 | 2742 | `			rc = PH7_OK;` |
|    307 | 2743 | `		}` |
|      - | 2744 | `	}` |
|      - | 2745 | `	/* EOF or not */` |
|   3524 | 2746 | `	ph7_result_bool(pCtx,rc == SXERR_EOF);` |
|   3524 | 2747 | `	return PH7_OK;` |
|   1763 | 2748 |  |
|      - | 2749 | `/*` |
...
|      - | 2793 | ` */` |
|   1994 | 2794 | `static sxi32 GetLine(io_private *pDev,ph7_int64 *pLen,const char **pzLine)` |
|      2 | 2795 |  |
|      - | 2796 | `	const char *zIn,*zEnd,*zPtr;` |
|   1996 | 2797 | `	zIn = (const char *)SyBlobDataAt(&pDev->sBuffer,pDev->nOfft);` |
|   1996 | 2798 | `	zEnd = &zIn[SyBlobLength(&pDev->sBuffer)-pDev->nOfft];` |
|   1996 | 2799 | `	zPtr = zIn;` |
| 147293 | 2800 | `	while( zIn < zEnd ){` |
| 147263 | 2801 | `		if( zIn[0] == '\n' ){` |
|      - | 2802 | `			/* Line found */` |
|   1966 | 2803 | `			zIn++; /* Include the line ending as requested by the PHP specification */` |
|   1966 | 2804 | `			*pLen = (ph7_int64)(zIn-zPtr);` |
|   1966 | 2805 | `			*pzLine = zPtr;` |
|   1966 | 2806 | `			return SXRET_OK;` |
|      - | 2807 | `		}` |
| 145299 | 2808 | `		zIn++;` |
|      2 | 2809 | `	}` |
...
|      - | 2815 | ` */` |
|   1998 | 2816 | `static ph7_int64 StreamReadLine(io_private *pDev,const char **pzData,ph7_int64 nMaxLen)` |
|      2 | 2817 |  |
|   2000 | 2818 | `	const ph7_io_stream *pStream = pDev->pStream;` |
|      - | 2819 | `	char zBuf[8192];` |
|      - | 2820 | `	ph7_int64 n;` |
|      - | 2821 | `	sxi32 rc;` |
|   2000 | 2822 | `	n = 0;` |
|   2000 | 2823 | `	if( pDev->nOfft >= SyBlobLength(&pDev->sBuffer) ){` |
...
|      8 | 2827 | `	}` |
|   2000 | 2828 | `	if( SyBlobLength(&pDev->sBuffer) > pDev->nOfft ){` |
|      - | 2829 | `		/* Check if there is a line */` |
|   1984 | 2830 | `		rc = GetLine(pDev,&n,pzData);` |
|   1984 | 2831 | `		if( rc == SXRET_OK ){` |
|      - | 2832 | `			/* Got line,update the cursor  */` |
|   1956 | 2833 | `			pDev->nOfft += (sxu32)n;` |
|   1956 | 2834 | `			return n;` |
|      - | 2835 | `		}` |
|     14 | 2836 | `	}` |
...
|      - | 2895 | ` */` |
|  18872 | 2896 | `PH7_PRIVATE void * PH7_StreamOpenHandle(ph7_vm *pVm,const ph7_io_stream *pStream,const char *zFile,` |
|      - | 2897 | `	int iFlags,int use_include,ph7_value *pResource,int bPushInclude,int *pNew)` |
|      2 | 2898 |  |
|  18874 | 2899 | `	void *pHandle = 0; /* cc warning */` |
|      - | 2900 | `	SyString sFile;` |
|      - | 2901 | `	int rc;` |
|  18874 | 2902 | `	if( pStream == 0 ){` |
|      - | 2903 | `		/* No such stream device */` |
|    ! 0 | 2904 | `		return 0;` |
|      - | 2905 | `	}` |
|  18874 | 2906 | `	SyStringInitFromBuf(&sFile,zFile,SyStrlen(zFile));` |
|  18874 | 2907 | `	if( use_include ){` |
|   6824 | 2908 | `		if(	sFile.zString[0] == '/' \|\|` |
|      - | 2909 | `#ifdef __WINNT__` |
|      - | 2910 | `			(sFile.nByte > 2 && sFile.zString[1] == ':' && (sFile.zString[2] == '\\' \|\| sFile.zString[2] == '/') ) \|\|` |
|      - | 2911 | `#endif` |
|   6814 | 2912 | `			(sFile.nByte > 1 && sFile.zString[0] == '.' && sFile.zString[1] == '/') \|\|` |
|   6812 | 2913 | `			(sFile.nByte > 2 && sFile.zString[0] == '.' && sFile.zString[1] == '.' && sFile.zString[2] == '/') ){` |
...
|   6814 | 2925 | `			SyBlobInit(&sWorker,&pVm->sAllocator);` |
|      - | 2926 | `			/* Build a path from the set of include path */` |
|   6814 | 2927 | `			SySetResetCursor(&pVm->aPaths);` |
|   6814 | 2928 | `			rc = SXERR_IO;` |
|   6816 | 2929 | `			while( SXRET_OK == SySetGetNextEntry(&pVm->aPaths,(void **)&pPath) ){` |
|      - | 2930 | `				/* Build full path */` |
|   6814 | 2931 | `				SyBlobFormat(&sWorker,"%z%c%z",pPath,c,&sFile);` |
|      - | 2932 | `				/* Append null terminator */` |
|   6814 | 2933 | `				if( SXRET_OK != SyBlobNullAppend(&sWorker) ){` |
|    ! 0 | 2934 | `					continue;` |
|      - | 2935 | `				}` |
|      - | 2936 | `				/* Try to open the file */` |
|   6814 | 2937 | `				rc = pStream->xOpen((const char *)SyBlobData(&sWorker),iFlags,pResource,&pHandle);` |
|   6814 | 2938 | `				if( rc == PH7_OK ){` |
|   6811 | 2939 | `					if( bPushInclude ){` |
|      - | 2940 | `						/* Mark as included */` |
|   6811 | 2941 | `						PH7_VmPushFilePath(pVm,(const char *)SyBlobData(&sWorker),SyBlobLength(&sWorker),FALSE,pNew);` |
|   3405 | 2942 | `					}` |
|   6811 | 2943 | `					break;` |
|      - | 2944 | `				}` |
...
|      1 | 2948 | `			}` |
|   6814 | 2949 | `			SyBlobRelease(&sWorker);` |
|      - | 2950 | `		}` |
|   6826 | 2951 | `		if( rc == PH7_OK ){` |
|   6823 | 2952 | `			if( bPushInclude ){` |
|      - | 2953 | `				/* Mark as included */` |
|   6823 | 2954 | `				PH7_VmPushFilePath(pVm,sFile.zString,sFile.nByte,FALSE,pNew);` |
|   3411 | 2955 | `			}` |
|   3411 | 2956 | `		}` |
|   3414 | 2957 | `	}else{` |
|      - | 2958 | `		/* Open the URI direcly */` |
|  12050 | 2959 | `		rc = pStream->xOpen(zFile,iFlags,pResource,&pHandle);` |
|      - | 2960 | `	}` |
|  18874 | 2961 | `	if( rc != PH7_OK ){` |
|      - | 2962 | `		/* IO error */` |
|      9 | 2963 | `		return 0;` |
|      - | 2964 | `	}` |
|      - | 2965 | `	/* Return the file handle */` |
|  18866 | 2966 | `	return pHandle;` |
|   9438 | 2967 |  |
|      - | 2968 | `/*` |
...
|      - | 2972 | ` */` |
|   6820 | 2973 | `PH7_PRIVATE sxi32 PH7_StreamReadWholeFile(void *pHandle,const ph7_io_stream *pStream,SyBlob *pOut)` |
|      1 | 2974 |  |
...
|   6820 | 2979 | `	for(;;){` |
|  13641 | 2980 | `		nRead = pStream->xRead(pHandle,zBuf,sizeof(zBuf));` |
|  13641 | 2981 | `		if( nRead < 1 ){` |
|      - | 2982 | `			/* EOF or IO error */` |
|   6821 | 2983 | `			break;` |
|      - | 2984 | `		}` |
|      - | 2985 | `		/* Append contents */` |
|   6821 | 2986 | `		rc = SyBlobAppend(pOut,zBuf,(sxu32)nRead);` |
|   6821 | 2987 | `		if( rc != SXRET_OK ){` |
|    ! 0 | 2988 | `			break;` |
|      - | 2989 | `		}` |
|      1 | 2990 | `	}` |
|   6821 | 2991 | `	return SyBlobLength(pOut) > 0 ? SXRET_OK : -1;` |
|      1 | 2992 |  |
|      - | 2993 | `/*` |
|      - | 2994 | ` * Close an open IO stream handle [i.e local file/URI..].` |
|      - | 2995 | ` */` |
|  18878 | 2996 | `PH7_PRIVATE void PH7_StreamCloseHandle(const ph7_io_stream *pStream,void *pHandle)` |
|      2 | 2997 |  |
|  18880 | 2998 | `	if( pStream->xClose ){` |
|  18880 | 2999 | `		pStream->xClose(pHandle);` |
|   9439 | 3000 | `	}` |
|  18880 | 3001 |  |
|      - | 3002 | `/*` |
...
|      - | 3071 | ` */` |
|   1988 | 3072 | `static int PH7_builtin_fgets(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 3073 |  |
|      - | 3074 | `	const ph7_io_stream *pStream;` |
|      - | 3075 | `	const char *zLine;` |
|      - | 3076 | `	io_private *pDev;` |
|      - | 3077 | `	ph7_int64 n,nLen;` |
|   1990 | 3078 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   1990 | 3085 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3086 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   1990 | 3087 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   1990 | 3094 | `	pStream = pDev->pStream;` |
|   1990 | 3095 | `	if( pStream == 0  ){` |
...
|   1990 | 3109 | `	n = StreamReadLine(pDev,&zLine,nLen);` |
|   1990 | 3110 | `	if( n < 1 ){` |
|      - | 3111 | `		/* EOF or IO error,return FALSE */` |
|      3 | 3112 | `		ph7_result_bool(pCtx,0);` |
|      2 | 3113 | `	}else{` |
|      - | 3114 | `		/* Return the freshly extracted line */` |
|   1988 | 3115 | `		ph7_result_string(pCtx,zLine,(int)n);` |
|      - | 3116 | `	}` |
|   1990 | 3117 | `	return PH7_OK;` |
|    996 | 3118 |  |
|      - | 3119 | `/*` |
...
|      - | 3380 | ` */` |
|   4978 | 3381 | `static int PH7_builtin_readdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 3382 |  |
|      - | 3383 | `	const ph7_io_stream *pStream;` |
|      - | 3384 | `	io_private *pDev;` |
|      - | 3385 | `	int rc;` |
|   4980 | 3386 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   4980 | 3393 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3394 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   4980 | 3395 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   4980 | 3402 | `	pStream = pDev->pStream;` |
|   4980 | 3403 | `	if( pStream == 0  \|\| pStream->xReadDir == 0 ){` |
...
|      - | 3410 | `	}` |
|   4980 | 3411 | `	ph7_result_bool(pCtx,0);` |
|      - | 3412 | `	/* Perform the requested operation */` |
|   4980 | 3413 | `	rc = pStream->xReadDir(pDev->pHandle,pCtx);` |
|   4980 | 3414 | `	if( rc != PH7_OK ){` |
|      - | 3415 | `		/* Return FALSE */` |
|    790 | 3416 | `		ph7_result_bool(pCtx,0);` |
|    394 | 3417 | `	}` |
|   4980 | 3418 | `	return PH7_OK;` |
|   2491 | 3419 |  |
|      - | 3420 | `/*` |
...
|      - | 3473 | ` */` |
|    790 | 3474 | `static int PH7_builtin_closedir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 3475 |  |
|      - | 3476 | `	const ph7_io_stream *pStream;` |
|      - | 3477 | `	io_private *pDev;` |
|    792 | 3478 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|    792 | 3485 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3486 | `	/* Make sure we are dealing with a valid io_private instance */` |
|    792 | 3487 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|    792 | 3494 | `	pStream = pDev->pStream;` |
|    792 | 3495 | `	if( pStream == 0  \|\| pStream->xCloseDir == 0 ){` |
...
|    792 | 3504 | `	pStream->xCloseDir(pDev->pHandle);` |
|      - | 3505 | `	/* Release the private stucture */` |
|    792 | 3506 | `	ReleaseIOPrivate(pCtx,pDev);` |
|    792 | 3507 | `	PH7_MemObjRelease(apArg[0]);` |
|    792 | 3508 | `	return PH7_OK;` |
|    397 | 3509 | ` }` |
|      - | 3510 | `/*` |
...
|      - | 3520 | ` */` |
|    790 | 3521 | `static int PH7_builtin_opendir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 3522 |  |
|      - | 3523 | `	const ph7_io_stream *pStream;` |
|      - | 3524 | `	const char *zPath;` |
|      - | 3525 | `	io_private *pDev;` |
|      - | 3526 | `	int iLen,rc;` |
|    792 | 3527 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|    792 | 3534 | `	zPath  = ph7_value_to_string(apArg[0],&iLen);` |
|      - | 3535 | `	/* Try to extract a stream */` |
|    792 | 3536 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zPath,iLen);` |
|    792 | 3537 | `	if( pStream == 0 ){` |
...
|      - | 3542 | `	}` |
|    792 | 3543 | `	if( pStream->xOpenDir == 0 ){` |
...
|    792 | 3552 | `	pDev = (io_private *)ph7_context_alloc_chunk(pCtx,sizeof(io_private),TRUE,FALSE);` |
|    792 | 3553 | `	if( pDev == 0 ){` |
...
|    792 | 3559 | `	InitIOPrivate(pCtx->pVm,pStream,pDev);` |
|      - | 3560 | `	/* Open the target directory */` |
|    792 | 3561 | `	rc = pStream->xOpenDir(zPath,nArg > 1 ? apArg[1] : 0,&pDev->pHandle);` |
|    792 | 3562 | `	if( rc != PH7_OK ){` |
...
|    792 | 3568 | `		ph7_result_resource(pCtx,pDev);` |
|      - | 3569 | `	}` |
|    792 | 3570 | `	return PH7_OK;` |
|    397 | 3571 |  |
|      - | 3572 | `/*` |
...
|      - | 3662 | ` */` |
|   3438 | 3663 | `static int PH7_builtin_file_get_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 3664 |  |
|      - | 3665 | `	const ph7_io_stream *pStream;` |
|      - | 3666 | `	ph7_int64 n,nRead,nMaxlen;` |
|   3440 | 3667 | `	int use_include  = FALSE;` |
|      - | 3668 | `	const char *zFile;` |
|      - | 3669 | `	char zBuf[8192];` |
|      - | 3670 | `	void *pHandle;` |
|      - | 3671 | `	int nLen;` |
|      - | 3672 |  |
|   3440 | 3673 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   3440 | 3680 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3681 | `	/* Point to the target IO stream device */` |
|   3440 | 3682 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|   3440 | 3683 | `	if( pStream == 0 ){` |
...
|   3440 | 3693 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,PH7_IO_OPEN_RDONLY,use_include,nArg > 2 ? apArg[2] : 0,FALSE,0);` |
|   3440 | 3694 | `	if( pHandle == 0 ){` |
...
|   3440 | 3714 | `	nRead = 0;` |
|   3437 | 3715 | `	for(;;){` |
|  10316 | 3716 | `		n = pStream->xRead(pHandle,zBuf,` |
|   3440 | 3717 | `			(nMaxlen > 0 && (nMaxlen < (ph7_int64)sizeof(zBuf))) ? nMaxlen : (ph7_int64)sizeof(zBuf));` |
|   6876 | 3718 | `		if( n < 1 ){` |
|      - | 3719 | `			/* EOF or IO error,break immediately */` |
|   3438 | 3720 | `			break;` |
|      - | 3721 | `		}` |
|      - | 3722 | `		/* Append data */` |
|   3440 | 3723 | `		ph7_result_string(pCtx,zBuf,(int)n);` |
|      - | 3724 | `		/* Increment read counter */` |
|   3440 | 3725 | `		nRead += n;` |
|   3440 | 3726 | `		if( nMaxlen > 0 && nRead >= nMaxlen ){` |
|      - | 3727 | `			/* Read limit reached */` |
|      3 | 3728 | `			break;` |
|      - | 3729 | `		}` |
|      2 | 3730 | `	}` |
|      - | 3731 | `	/* Close the stream */` |
|   3440 | 3732 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|      - | 3733 | `	/* Check if we have read something */` |
|   3440 | 3734 | `	if( ph7_context_result_buf_length(pCtx) < 1 ){` |
|      - | 3735 | `		/* Nothing read,return FALSE */` |
|    ! 0 | 3736 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 3737 | `	}` |
|   3440 | 3738 | `	return PH7_OK;` |
|   1721 | 3739 |  |
|      - | 3740 | `/*` |
...
|      - | 3758 | ` */` |
|   8528 | 3759 | `static int PH7_builtin_file_put_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 3760 |  |
|   8530 | 3761 | `	int use_include  = FALSE;` |
...
|      - | 3768 | `	int nLen;` |
|      - | 3769 |  |
|   8530 | 3770 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   8530 | 3777 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3778 | `	/* Point to the target IO stream device */` |
|   8530 | 3779 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|   8530 | 3780 | `	if( pStream == 0 ){` |
...
|      - | 3784 | `	}` |
|      - | 3785 | `	/* Data to write */` |
|   8530 | 3786 | `	zData = ph7_value_to_string(apArg[1],&nLen);` |
|      - | 3787 | `	/* Try to open the file in read-write mode */` |
|   8530 | 3788 | `	iOpenFlags = PH7_IO_OPEN_CREATE\|PH7_IO_OPEN_RDWR\|PH7_IO_OPEN_TRUNC;` |
...
|    ! 0 | 3803 | `		}` |
|    ! 0 | 3804 | `	}` |
|  12794 | 3805 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,iOpenFlags,use_include,` |
|   4264 | 3806 | `		nArg > 3 ? apArg[3] : 0,FALSE,FALSE);` |
|   8530 | 3807 | `	if( pHandle == 0 ){` |
...
|   8524 | 3842 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|   8524 | 3843 | `	return PH7_OK;` |
|   4266 | 3844 |  |
|      - | 3845 | `/*` |
...
|      - | 4719 | ` */` |
|   2414 | 4720 | `static void InitIOPrivate(ph7_vm *pVm,const ph7_io_stream *pStream,io_private *pOut)` |
|      2 | 4721 |  |
|   2416 | 4722 | `	pOut->pStream = pStream;` |
|   2416 | 4723 | `	SyBlobInit(&pOut->sBuffer,&pVm->sAllocator);` |
|   2416 | 4724 | `	pOut->nOfft = 0;` |
|      - | 4725 | `	/* Set the magic number */` |
|   2416 | 4726 | `	pOut->iMagic = IO_PRIVATE_MAGIC;` |
|   2416 | 4727 |  |
|      - | 4728 | `/*` |
|      - | 4729 | ` * Release the IO private structure.` |
|      - | 4730 | ` */` |
|   2406 | 4731 | `static void ReleaseIOPrivate(ph7_context *pCtx,io_private *pDev)` |
|      2 | 4732 |  |
|   2408 | 4733 | `	SyBlobRelease(&pDev->sBuffer);` |
|   2408 | 4734 | `	pDev->iMagic = 0x2126; /* Invalid magic number so we can detetct misuse */` |
|      - | 4735 | `	/* Release the whole structure */` |
|   2408 | 4736 | `	ph7_context_free_chunk(pCtx,pDev);` |
|   2408 | 4737 |  |
|      - | 4738 | `/*` |
...
|   8336 | 6899 | `static int UnixVfs_chdir(const char *zPath)` |
|      - | 6900 |  |
|      - | 6901 | `  int rc;` |
|   8336 | 6902 | `  rc = chdir(zPath);` |
|   8336 | 6903 | `  return rc == 0 ? PH7_OK : -1;` |
|      - | 6904 |  |
...
|   4980 | 6934 | `static int UnixVfs_isdir(const char *zPath)` |
|      - | 6935 |  |
|      - | 6936 | `	struct stat st;` |
|      - | 6937 | `	int rc;` |
|   4980 | 6938 | `	rc = stat(zPath,&st);` |
|   4980 | 6939 | `	if( rc != 0 ){` |
|      4 | 6940 | `	 return -1;` |
|      - | 6941 | `	}` |
|   4976 | 6942 | `	rc = S_ISDIR(st.st_mode);` |
|   4976 | 6943 | `	return rc ? PH7_OK : -1 ;` |
|   2490 | 6944 |  |
...
|  17152 | 6978 | `static int UnixVfs_unlink(const char *zPath)` |
|      - | 6979 |  |
|      - | 6980 | `	int rc;` |
|  17152 | 6981 | `	rc = unlink(zPath);` |
|  17152 | 6982 | `	return rc == 0 ? PH7_OK : -1 ;` |
|      - | 6983 |  |
...
|   3404 | 7190 | `static int UnixVfs_isfile(const char *zPath)` |
|      - | 7191 |  |
|      - | 7192 | `	struct stat st;` |
|      - | 7193 | `	int rc;` |
|   3404 | 7194 | `	rc = stat(zPath,&st);` |
|   3404 | 7195 | `	if( rc != 0 ){` |
|      2 | 7196 | `	 return -1;` |
|      - | 7197 | `	}` |
|   3402 | 7198 | `	rc = S_ISREG(st.st_mode);` |
|   3402 | 7199 | `	return rc ? PH7_OK : -1 ;` |
|   1702 | 7200 |  |
...
|   1560 | 7281 | `static int UnixVfs_Mmap(const char *zPath,void **ppMap,ph7_int64 *pSize)` |
|      - | 7282 |  |
|      - | 7283 | `	struct stat st;` |
|      - | 7284 | `	void *pMap;` |
|      - | 7285 | `	int fd;` |
...
|   1560 | 7288 | `	fd = open(zPath,O_RDONLY);` |
|   1560 | 7289 | `	if( fd < 0 ){` |
|      2 | 7290 | `		return -1;` |
|      - | 7291 | `	}` |
|      - | 7292 | `	/* stat the handle */` |
|   1558 | 7293 | `	fstat(fd,&st);` |
|      - | 7294 | `	/* Obtain a memory view of the whole file */` |
|   1558 | 7295 | `	pMap = mmap(0,st.st_size,PROT_READ,MAP_PRIVATE\|MAP_FILE,fd,0);` |
|   1558 | 7296 | `	rc = PH7_OK;` |
|   1558 | 7297 | `	if( pMap == MAP_FAILED ){` |
|    ! 0 | 7298 | `		rc = -1;` |
|    ! 0 | 7299 | `	}else{` |
|      - | 7300 | `		/* Point to the memory view */` |
|   1558 | 7301 | `		*ppMap = pMap;` |
|   1558 | 7302 | `		*pSize = (ph7_int64)st.st_size;` |
|      - | 7303 | `	}` |
|   1558 | 7304 | `	close(fd);` |
|   1558 | 7305 | `	return rc;` |
|    780 | 7306 |  |
|      - | 7307 | `/* void (*xUnmap)(void *,ph7_int64)  */` |
|   1558 | 7308 | `static void UnixVfs_Unmap(void *pView,ph7_int64 nSize)` |
|      - | 7309 |  |
|   1558 | 7310 | `	munmap(pView,(size_t)nSize);` |
|   1558 | 7311 |  |
...
|  18870 | 7450 | `static int UnixFile_Open(const char *zPath,int iOpenMode,ph7_value *pResource,void **ppHandle)` |
|      - | 7451 |  |
|  18870 | 7452 | `	int iOpen = O_RDONLY;` |
|      - | 7453 | `	int fd;` |
|      - | 7454 | `	/* Set the desired flags according to the open mode */` |
|  18870 | 7455 | `	if( iOpenMode & PH7_IO_OPEN_CREATE ){` |
|      - | 7456 | `		/* Open existing file, or create if it doesn't exist */` |
|   8554 | 7457 | `		iOpen = O_CREAT;` |
|   8554 | 7458 | `		if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|      - | 7459 | `			/* If the specified file exists and is writable, the function overwrites the file */` |
|   8554 | 7460 | `			iOpen \|= O_TRUNC;` |
|   4277 | 7461 | `			SXUNUSED(pResource); /* cc warning */` |
|   4277 | 7462 | `		}` |
|  14593 | 7463 | `	}else if( iOpenMode & PH7_IO_OPEN_EXCL ){` |
|      - | 7464 | `		/* Creates a new file, only if it does not already exist.` |
|      - | 7465 | `		* If the file exists, it fails.` |
|      - | 7466 | `		*/` |
|    ! 0 | 7467 | `		iOpen = O_CREAT\|O_EXCL;` |
|  10316 | 7468 | `	}else if( iOpenMode & PH7_IO_OPEN_TRUNC ){` |
|      - | 7469 | `		/* Opens a file and truncates it so that its size is zero bytes` |
|      - | 7470 | `		 * The file must exist.` |
|      - | 7471 | `		 */` |
|    ! 0 | 7472 | `		iOpen = O_RDWR\|O_TRUNC;` |
|    ! 0 | 7473 | `	}` |
|  18870 | 7474 | `	if( iOpenMode & PH7_IO_OPEN_RDWR ){` |
|      - | 7475 | `		/* Read+Write access */` |
|   8538 | 7476 | `		iOpen &= ~O_RDONLY;` |
|   8538 | 7477 | `		iOpen \|= O_RDWR;` |
|  14601 | 7478 | `	}else if( iOpenMode & PH7_IO_OPEN_WRONLY ){` |
|      - | 7479 | `		/* Write only access */` |
|     22 | 7480 | `		iOpen &= ~O_RDONLY;` |
|     22 | 7481 | `		iOpen \|= O_WRONLY;` |
|     11 | 7482 | `	}` |
|  18870 | 7483 | `	if( iOpenMode & PH7_IO_OPEN_APPEND ){` |
|      - | 7484 | `		/* Append mode */` |
...
|  18870 | 7494 | `	fd = open(zPath,iOpen,PH7_UNIX_OPEN_MODE);` |
|  18870 | 7495 | `	if( fd < 0 ){` |
|      - | 7496 | `		/* IO error */` |
|      8 | 7497 | `		return -1;` |
|      - | 7498 | `	}` |
|      - | 7499 | `	/* Save the handle */` |
|  18862 | 7500 | `	*ppHandle = SX_INT_TO_PTR(fd);` |
|  18862 | 7501 | `	return PH7_OK;` |
|   9435 | 7502 |  |
|      - | 7503 | `/* int (*xOpenDir)(const char *,ph7_value *,void **) */` |
|    790 | 7504 | `static int UnixDir_Open(const char *zPath,ph7_value *pResource,void **ppHandle)` |
|      - | 7505 |  |
|      - | 7506 | `	DIR *pDir;` |
|      - | 7507 | `	/* Open the target directory */` |
|    790 | 7508 | `	pDir = opendir(zPath);` |
|    790 | 7509 | `	if( pDir == 0 ){` |
|    ! 0 | 7510 | `		SXUNUSED(pResource); /* Compiler warning */` |
|    ! 0 | 7511 | `		return -1;` |
|      - | 7512 | `	}` |
|      - | 7513 | `	/* Save our structure */` |
|    790 | 7514 | `	*ppHandle = pDir;` |
|    790 | 7515 | `	return PH7_OK;` |
|    395 | 7516 |  |
|      - | 7517 | `/* void (*xCloseDir)(void *) */` |
|    790 | 7518 | `static void UnixDir_Close(void *pUserData)` |
|      - | 7519 |  |
|    790 | 7520 | `	closedir((DIR *)pUserData);` |
|    790 | 7521 |  |
|      - | 7522 | `/* void (*xClose)(void *); */` |
|  18862 | 7523 | `static void UnixFile_Close(void *pUserData)` |
|      - | 7524 |  |
|  18862 | 7525 | `	close(SX_PTR_TO_INT(pUserData));` |
|  18862 | 7526 |  |
|      - | 7527 | `/* int (*xReadDir)(void *,ph7_context *) */` |
|   4978 | 7528 | `static int UnixDir_Read(void *pUserData,ph7_context *pCtx)` |
|      - | 7529 |  |
|   4978 | 7530 | `	DIR *pDir = (DIR *)pUserData;` |
|      - | 7531 | `	struct dirent *pEntry;` |
|   4978 | 7532 | `	char *zName = 0; /* cc warning */` |
|   4978 | 7533 | `	sxu32 n = 0;` |
|   3281 | 7534 | `	for(;;){` |
|   6562 | 7535 | `		pEntry = readdir(pDir);` |
|   6562 | 7536 | `		if( pEntry == 0 ){` |
|      - | 7537 | `			/* No more entries to process */` |
|    788 | 7538 | `			return -1;` |
|      - | 7539 | `		}` |
|   5774 | 7540 | `		zName = pEntry->d_name;` |
|   5774 | 7541 | `		n = SyStrlen(zName);` |
|      - | 7542 | `		/* Ignore '.' && '..' */` |
|   5774 | 7543 | `		if( n > sizeof("..")-1 \|\| zName[0] != '.' \|\| ( n == sizeof("..")-1 && zName[1] != '.') ){` |
|   2095 | 7544 | `			break;` |
|      - | 7545 | `		}` |
|      - | 7546 | `		/* Next entry */` |
|      - | 7547 | `	}` |
|      - | 7548 | `	/* Return the current file name */` |
|   4190 | 7549 | `	ph7_result_string(pCtx,zName,(int)n);` |
|   4190 | 7550 | `	return PH7_OK;` |
|   2489 | 7551 |  |
...
|  20570 | 7558 | `static ph7_int64 UnixFile_Read(void *pUserData,void *pBuffer,ph7_int64 nDatatoRead)` |
|      - | 7559 |  |
|      - | 7560 | `	ssize_t nRd;` |
|  20570 | 7561 | `	nRd = read(SX_PTR_TO_INT(pUserData),pBuffer,(size_t)nDatatoRead);` |
|  20570 | 7562 | `	if( nRd < 1 ){` |
|      - | 7563 | `		/* EOF or IO error */` |
|  10280 | 7564 | `		return -1;` |
|      - | 7565 | `	}` |
|  10290 | 7566 | `	return (ph7_int64)nRd;` |
|  10285 | 7567 |  |
|      - | 7568 | `/* ph7_int64 (*xWrite)(void *,const void *,ph7_int64); */` |
|   8576 | 7569 | `static ph7_int64 UnixFile_Write(void *pUserData,const void *pBuffer,ph7_int64 nWrite)` |
|      - | 7570 |  |
|   8576 | 7571 | `	const char *zData = (const char *)pBuffer;` |
|   8576 | 7572 | `	int fd = SX_PTR_TO_INT(pUserData);` |
|      - | 7573 | `	ph7_int64 nCount;` |
|      - | 7574 | `	ssize_t nWr;` |
|   8576 | 7575 | `	nCount = 0;` |
|   8576 | 7576 | `	for(;;){` |
|  17152 | 7577 | `		if( nWrite < 1 ){` |
|   8576 | 7578 | `			break;` |
|      - | 7579 | `		}` |
|   8576 | 7580 | `		nWr = write(fd,zData,(size_t)nWrite);` |
|   8576 | 7581 | `		if( nWr < 1 ){` |
|      - | 7582 | `			/* IO error */` |
|    ! 0 | 7583 | `			break;` |
|      - | 7584 | `		}` |
|   8576 | 7585 | `		nWrite -= nWr;` |
|   8576 | 7586 | `		nCount += nWr;` |
|   8576 | 7587 | `		zData += nWr;` |
|      - | 7588 | `	}` |
|   8576 | 7589 | `	if( nWrite > 0 ){` |
|    ! 0 | 7590 | `		return -1;` |
|      - | 7591 | `	}` |
|   8576 | 7592 | `	return nCount;` |
|   4288 | 7593 |  |
...
|      - | 7737 | ` */` |
|   1568 | 7738 | `PH7_PRIVATE const ph7_vfs * PH7_ExportBuiltinVfs(void)` |
|      2 | 7739 |  |
...
|      - | 8153 | ` */` |
|   1552 | 8154 | `static pipe_private * PipeOpen(ph7_vm *pVm, const char *zCommand, const char *zMode)` |
|      2 | 8155 |  |
|      - | 8156 | `	pipe_private *pPipe;` |
|      - | 8157 | `	FILE *pFile;` |
|   1554 | 8158 | `	if( pVm == 0 \|\| zCommand == 0 \|\| zMode == 0 ){` |
|    ! 0 | 8159 | `		return 0;` |
|      - | 8160 | `	}` |
|      - | 8161 | `	/* Validate mode - only 'r' or 'w' allowed */` |
|   1554 | 8162 | `	if( zMode[0] != 'r' && zMode[0] != 'w' ){` |
|    ! 0 | 8163 | `		return 0;` |
|      - | 8164 | `	}` |
...
|      - | 8224 | `	}` |
|      - | 8225 | `#else /* Unix */` |
|   1552 | 8226 | `	pFile = popen(zCommand, zMode);` |
|   1552 | 8227 | `	if( pFile == 0 ){` |
|    ! 0 | 8228 | `		return 0;` |
|      - | 8229 | `	}` |
|      - | 8230 | `	/* Allocate pipe private structure */` |
|   1552 | 8231 | `	pPipe = (pipe_private *)SyMemBackendAlloc(&pVm->sAllocator, sizeof(pipe_private));` |
|   1552 | 8232 | `	if( pPipe == 0 ){` |
|      - | 8233 | `		/* Out of memory, close the pipe */` |
|    ! 0 | 8234 | `		pclose(pFile);` |
|    ! 0 | 8235 | `		return 0;` |
|      - | 8236 | `	}` |
|      - | 8237 | `	/* Initialize the structure */` |
|   1552 | 8238 | `	pPipe->pFile = pFile;` |
|   1552 | 8239 | `	pPipe->pVm = pVm;` |
|   1552 | 8240 | `	pPipe->iMode = zMode[0];` |
|      - | 8241 | `#endif` |
|   1554 | 8242 | `	return pPipe;` |
|    778 | 8243 |  |
|      - | 8244 | `/*` |
|      - | 8245 | ` * Close a pipe and return the exit status of the process.` |
|      - | 8246 | ` * Returns the exit status, or -1 on error.` |
|      - | 8247 | ` */` |
|   1552 | 8248 | `static int PipeClose(pipe_private *pPipe)` |
|      2 | 8249 |  |
|      - | 8250 | `	int status;` |
|      - | 8251 | `	ph7_vm *pVm;` |
|   1554 | 8252 | `	if( pPipe == 0 \|\| pPipe->pFile == 0 ){` |
|    ! 0 | 8253 | `		return -1;` |
|      - | 8254 | `	}` |
|   1554 | 8255 | `	pVm = pPipe->pVm;` |
...
|      - | 8260 | `#else` |
|   1552 | 8261 | `	status = pclose(pPipe->pFile);` |
|      - | 8262 | `	/* On Unix, pclose returns the status from waitpid, need to extract exit code */` |
|   1552 | 8263 | `	if( status != -1 ){` |
|   1552 | 8264 | `		if( WIFEXITED(status) ){` |
|   1552 | 8265 | `			status = WEXITSTATUS(status);` |
|    776 | 8266 | `		}else if( WIFSIGNALED(status) ){` |
...
|   1554 | 8276 | `	SyMemBackendFree(&pVm->sAllocator, pPipe);` |
|   1554 | 8277 | `	return status;` |
|    778 | 8278 |  |
|      - | 8279 | `/*` |
...
|      - | 8293 | ` */` |
|   2182 | 8294 | `static ph7_int64 PipeStream_Read(void *pHandle, void *pBuffer, ph7_int64 nDatatoRead)` |
|      1 | 8295 |  |
|   2183 | 8296 | `	pipe_private *pPipe = (pipe_private *)pHandle;` |
|      - | 8297 | `	size_t nRead;` |
|   2183 | 8298 | `	if( pPipe == 0 \|\| pPipe->pFile == 0 ){` |
|    ! 0 | 8299 | `		return -1;` |
|      - | 8300 | `	}` |
|   2183 | 8301 | `	if( pPipe->iMode != 'r' ){` |
|      - | 8302 | `		/* Cannot read from a write-only pipe */` |
|    ! 0 | 8303 | `		return -1;` |
|      - | 8304 | `	}` |
|   2183 | 8305 | `	nRead = fread(pBuffer, 1, (size_t)nDatatoRead, pPipe->pFile);` |
|   2183 | 8306 | `	if( nRead == 0 ){` |
|   1565 | 8307 | `		if( feof(pPipe->pFile) ){` |
|   1565 | 8308 | `			return 0; /* EOF */` |
|      - | 8309 | `		}` |
|    ! 0 | 8310 | `		return -1; /* Error */` |
|      - | 8311 | `	}` |
|    619 | 8312 | `	return (ph7_int64)nRead;` |
|   1092 | 8313 |  |
|      - | 8314 | `/*` |
...
|      - | 8356 | ` */` |
|   1538 | 8357 | `static int is_pipe_stream(const ph7_io_stream *pStream)` |
|      2 | 8358 |  |
|   1540 | 8359 | `	return pStream == &sPipe_Stream;` |
|      2 | 8360 |  |
|      - | 8361 | `/*` |
...
|      - | 8373 | ` */` |
|   1552 | 8374 | `static int PH7_builtin_popen(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 8375 |  |
|      - | 8376 | `	const char *zCommand, *zMode;` |
|      - | 8377 | `	pipe_private *pPipe;` |
|      - | 8378 | `	io_private *pDev;` |
|      - | 8379 | `	int nCmdLen, nModeLen;` |
|   1554 | 8380 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) \|\| !ph7_value_is_string(apArg[1]) ){` |
...
|   1554 | 8387 | `	zCommand = ph7_value_to_string(apArg[0], &nCmdLen);` |
|   1554 | 8388 | `	zMode = ph7_value_to_string(apArg[1], &nModeLen);` |
|   1554 | 8389 | `	if( nCmdLen < 1 ){` |
|    ! 0 | 8390 | `		ph7_context_throw_error(pCtx, PH7_CTX_WARNING, "Empty command");` |
|    ! 0 | 8391 | `		ph7_result_bool(pCtx, 0);` |
|    ! 0 | 8392 | `		return PH7_OK;` |
|      - | 8393 | `	}` |
|   1554 | 8394 | `	if( nModeLen < 1 \|\| (zMode[0] != 'r' && zMode[0] != 'w') ){` |
...
|      - | 8398 | `	}` |
|      - | 8399 | `	/* Open the pipe */` |
|   1554 | 8400 | `	pPipe = PipeOpen(pCtx->pVm, zCommand, zMode);` |
|   1554 | 8401 | `	if( pPipe == 0 ){` |
...
|   1554 | 8407 | `	pDev = (io_private *)ph7_context_alloc_chunk(pCtx, sizeof(io_private), TRUE, FALSE);` |
|   1554 | 8408 | `	if( pDev == 0 ){` |
...
|   1554 | 8415 | `	InitIOPrivate(pCtx->pVm, &sPipe_Stream, pDev);` |
|   1554 | 8416 | `	pDev->pHandle = pPipe;` |
|      - | 8417 | `	/* Return the io_private instance as a resource */` |
|   1554 | 8418 | `	ph7_result_resource(pCtx, pDev);` |
|   1554 | 8419 | `	return PH7_OK;` |
|    778 | 8420 |  |
|      - | 8421 | `/*` |
...
|      - | 8429 | ` */` |
|   1538 | 8430 | `static int PH7_builtin_pclose(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 8431 |  |
|      - | 8432 | `	const ph7_io_stream *pStream;` |
|      - | 8433 | `	pipe_private *pPipe;` |
|      - | 8434 | `	io_private *pDev;` |
|      - | 8435 | `	int status;` |
|   1540 | 8436 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   1540 | 8443 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 8444 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   1540 | 8445 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   1540 | 8451 | `	pStream = pDev->pStream;` |
|   1540 | 8452 | `	if( pStream == 0 \|\| !is_pipe_stream(pStream) ){` |
...
|   1540 | 8458 | `	pPipe = (pipe_private *)pDev->pHandle;` |
|      - | 8459 | `	/* Close the pipe and get exit status */` |
|   1540 | 8460 | `	status = PipeClose(pPipe);` |
|      - | 8461 | `	/* Release the IO private structure */` |
|   1540 | 8462 | `	ReleaseIOPrivate(pCtx, pDev);` |
|      - | 8463 | `	/* Invalidate the resource handle */` |
|   1540 | 8464 | `	ph7_value_release(apArg[0]);` |
|      - | 8465 | `	/* Return the exit status */` |
|   1540 | 8466 | `	ph7_result_int(pCtx, status);` |
|   1540 | 8467 | `	return PH7_OK;` |
|    771 | 8468 |  |
...
|      - | 8510 | ` */` |
|   1280 | 8511 | `PH7_PRIVATE sxi32 PH7_RegisterIORoutine(ph7_vm *pVm)` |
|      2 | 8512 |  |
|      - | 8513 | `	/*` |
...
|      - | 8610 | `	};` |
|   1282 | 8611 | `	const ph7_io_stream *pFileStream = 0;` |
|   1282 | 8612 | `	sxu32 n = 0;` |
|      - | 8613 | `	/* Register disk-related functions */` |
|  62722 | 8614 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVfsDiskFunc) ; ++n ){` |
|  61442 | 8615 | `		ph7_create_function(&(*pVm),aVfsDiskFunc[n].zName,aVfsDiskFunc[n].xFunc,(void *)pVm->pEngine->pVfs);` |
|  30722 | 8616 | `	}` |
|  46082 | 8617 | `	for( n = 0 ; n < SX_ARRAYSIZE(aIOFunc) ; ++n ){` |
|  44802 | 8618 | `		ph7_create_function(&(*pVm),aIOFunc[n].zName,aIOFunc[n].xFunc,pVm);` |
|  22402 | 8619 | `	}` |
|      - | 8620 | `#else` |
|      - | 8621 | `	SXUNUSED(pVm);` |
...
|      - | 8648 | `	};` |
|  21762 | 8649 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVfsHelperFunc) ; ++n ){` |
|  20482 | 8650 | `		ph7_create_function(&(*pVm),aVfsHelperFunc[n].zName,aVfsHelperFunc[n].xFunc,pVm);` |
|  10242 | 8651 | `	}` |
...
|   1280 | 8659 | `	pFileStream = &sUnixFileStream;` |
|      - | 8660 | `#endif` |
|      - | 8661 | `	/* Install the php:// stream */` |
|   1282 | 8662 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,&sPHP_Stream);` |
|   1282 | 8663 | `	if( pFileStream ){` |
|      - | 8664 | `		/* Install the file:// stream */` |
|   1282 | 8665 | `		ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,pFileStream);` |
|    640 | 8666 | `	}` |
|      - | 8667 | `#endif /* PH7_DISABLE_DISK_IO */` |
|      - | 8668 |  |
|   1282 | 8669 | `	return SXRET_OK;` |
|      2 | 8670 |  |
|      - | 8671 | `/*` |
