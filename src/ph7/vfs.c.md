...
|      - |   65 | ` */` |
|  13552 |   66 | `static int PH7_vfs_chdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |   67 | `{` |
|      - |   68 | `	const char *zPath;` |
|      - |   69 | `	ph7_vfs *pVfs;` |
|      - |   70 | `	int rc;` |
|  13557 |   71 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |   72 | `		/* Missing/Invalid argument,return FALSE */` |
|      6 |   73 | `		ph7_result_bool(pCtx,0);` |
|      6 |   74 | `		return PH7_OK;` |
|      - |   75 | `	}` |
|      - |   76 | `	/* Point to the underlying vfs */` |
|  13553 |   77 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  13553 |   78 | `	if( pVfs == 0 \|\| pVfs->xChdir == 0 ){` |
...
|  13553 |   88 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |   89 | `	/* Perform the requested operation */` |
|  13553 |   90 | `	rc = pVfs->xChdir(zPath);` |
|      - |   91 | `	/* IO return value */` |
|  13553 |   92 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  13553 |   93 | `	return PH7_OK;` |
|   6781 |   94 | `}` |
|      - |   95 | `/*` |
...
|      - |  213 | ` */` |
|   8400 |  214 | `static int PH7_vfs_is_dir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  215 | `{` |
|      - |  216 | `	const char *zPath;` |
|      - |  217 | `	ph7_vfs *pVfs;` |
|      - |  218 | `	int rc;` |
|   8405 |  219 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  220 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  221 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  222 | `		return PH7_OK;` |
|      - |  223 | `	}` |
|      - |  224 | `	/* Point to the underlying vfs */` |
|   8405 |  225 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   8405 |  226 | `	if( pVfs == 0 \|\| pVfs->xIsdir == 0 ){` |
...
|   8405 |  236 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  237 | `	/* Perform the requested operation */` |
|   8405 |  238 | `	rc = pVfs->xIsdir(zPath);` |
|      - |  239 | `	/* IO return value */` |
|   8405 |  240 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   8405 |  241 | `	return PH7_OK;` |
|   4205 |  242 | `}` |
|      - |  243 | `/*` |
...
|      - |  476 | ` */` |
|  32328 |  477 | `static int PH7_vfs_unlink(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  478 | `{` |
|      - |  479 | `	const char *zPath;` |
|      - |  480 | `	ph7_vfs *pVfs;` |
|      - |  481 | `	int rc;` |
|  32333 |  482 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  483 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  484 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  485 | `		return PH7_OK;` |
|      - |  486 | `	}` |
|      - |  487 | `	/* Point to the underlying vfs */` |
|  32333 |  488 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  32333 |  489 | `	if( pVfs == 0 \|\| pVfs->xUnlink == 0 ){` |
...
|  32333 |  499 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  500 | `	/* Perform the requested operation */` |
|  32333 |  501 | `	rc = pVfs->xUnlink(zPath);` |
|      - |  502 | `	/* IO return value */` |
|  32333 |  503 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  32333 |  504 | `	return PH7_OK;` |
|  16169 |  505 | `}` |
|      - |  506 | `/*` |
...
|      - |  907 | ` */` |
|   6438 |  908 | `static int PH7_vfs_is_file(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  909 | `{` |
|      - |  910 | `	const char *zPath;` |
|      - |  911 | `	ph7_vfs *pVfs;` |
|      - |  912 | `	int rc;` |
|   6443 |  913 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  914 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  915 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  916 | `		return PH7_OK;` |
|      - |  917 | `	}` |
|      - |  918 | `	/* Point to the underlying vfs */` |
|   6443 |  919 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   6443 |  920 | `	if( pVfs == 0 \|\| pVfs->xIsfile == 0 ){` |
...
|   6443 |  930 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  931 | `	/* Perform the requested operation */` |
|   6443 |  932 | `	rc = pVfs->xIsfile(zPath);` |
|      - |  933 | `	/* IO return value */` |
|   6443 |  934 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   6443 |  935 | `	return PH7_OK;` |
|   3224 |  936 | `}` |
|      - |  937 | `/*` |
...
|      - | 1554 | ` */` |
|  12866 | 1555 | `static sxi32 ExtractPathInfo(const char *zPath,int nByte,path_info *pOut)` |
|      5 | 1556 | `{` |
|  12871 | 1557 | `	const char *zPtr,*zEnd = &zPath[nByte - 1];` |
|      - | 1558 | `	SyString *pCur;` |
|      - | 1559 | `	int c,d;` |
|  12871 | 1560 | `	c = d = '/';` |
...
|  12871 | 1565 | `	SyZero(pOut,sizeof(path_info));` |
|      - | 1566 | `	/* Handle special case */` |
|  12871 | 1567 | `	if( nByte == sizeof(char) && ( (int)zPath[0] == c \|\| (int)zPath[0] == d ) ){` |
...
| 347308 | 1576 | `	while( zEnd > zPath && ( (int)zEnd[0] != c && (int)zEnd[0] != d ) ){` |
| 328009 | 1577 | `		zEnd--;` |
|      5 | 1578 | `	}` |
|  12871 | 1579 | `	zPtr = (zEnd > zPath) ? &zEnd[1] : zPath;` |
|  12871 | 1580 | `	zEnd = &zPath[nByte];` |
|      - | 1581 | `	/* dirname */` |
|  12871 | 1582 | `	pCur = &pOut->sDir;` |
|  12871 | 1583 | `	SyStringInitFromBuf(pCur,zPath,zPtr-zPath);` |
|  12871 | 1584 | `	if( pCur->nByte > 1 ){` |
|  25737 | 1585 | `		SyStringTrimTrailingChar(pCur,'/');` |
|      - | 1586 | `#ifdef __WINNT__` |
|      5 | 1587 | `		SyStringTrimTrailingChar(pCur,'\\');` |
|      - | 1588 | `#endif` |
|   6438 | 1589 | `	}else if( (int)zPath[0] == c \|\| (int)zPath[0] == d ){` |
...
|  12871 | 1597 | `	pCur = &pOut->sBasename;` |
|  12871 | 1598 | `	SyStringInitFromBuf(pCur,zPtr,zEnd-zPtr);` |
|  12871 | 1599 | `	SyStringTrimLeadingChar(pCur,'/');` |
|      - | 1600 | `#ifdef __WINNT__` |
|      5 | 1601 | `	SyStringTrimLeadingChar(pCur,'\\');` |
|      - | 1602 | `#endif` |
|  12871 | 1603 | `	SyStringDupPtr(&pOut->sFilename,pCur);` |
|  12871 | 1604 | `	if( pCur->nByte > 0 ){` |
|      - | 1605 | `		/* extension */` |
|  12871 | 1606 | `		zEnd--;` |
|  64329 | 1607 | `		while( zEnd > pCur->zString /*basename*/ && zEnd[0] != '.' ){` |
|  51463 | 1608 | `			zEnd--;` |
|      5 | 1609 | `		}` |
|  12871 | 1610 | `		if( zEnd > pCur->zString ){` |
|  12869 | 1611 | `			zEnd++; /* Jump leading dot */` |
|  12869 | 1612 | `			SyStringInitFromBuf(&pOut->sExtension,zEnd,&zPath[nByte]-zEnd);` |
|      - | 1613 | `			/* Fix filename */` |
|  12869 | 1614 | `			pCur = &pOut->sFilename;` |
|  12869 | 1615 | `			if( pCur->nByte > SyStringLength(&pOut->sExtension) ){` |
|  12869 | 1616 | `				pCur->nByte -= 1 + SyStringLength(&pOut->sExtension);` |
|   6432 | 1617 | `			}` |
|   6432 | 1618 | `		}` |
|   6433 | 1619 | `	}` |
|  12871 | 1620 | `	return SXRET_OK;` |
|   6438 | 1621 | `}` |
|      - | 1622 | `/*` |
...
|      - | 1625 | ` */` |
|  12866 | 1626 | `static int PH7_builtin_pathinfo(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1627 | `{` |
|      - | 1628 | `	const char *zPath;` |
|      - | 1629 | `	path_info sInfo;` |
|      - | 1630 | `	SyString *pComp;` |
|      - | 1631 | `	int iLen;` |
|  12871 | 1632 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  12871 | 1638 | `	zPath = ph7_value_to_string(apArg[0],&iLen);` |
|  12871 | 1639 | `	if( iLen < 1 ){` |
|      - | 1640 | `		/* Empty string */` |
|    ! 0 | 1641 | `		ph7_result_string(pCtx,"",0);` |
|    ! 0 | 1642 | `		return PH7_OK;` |
|      - | 1643 | `	}` |
|      - | 1644 | `	/* Extract path info */` |
|  12871 | 1645 | `	ExtractPathInfo(zPath,iLen,&sInfo);` |
|  19303 | 1646 | `	if( nArg > 1 && ph7_value_is_int(apArg[1]) ){` |
|      - | 1647 | `		/* Return path component */` |
|  12869 | 1648 | `		int nComp = ph7_value_to_int(apArg[1]);` |
|  12869 | 1649 | `		switch(nComp){` |
...
|      - | 1666 | `			}` |
|      3 | 1667 | `			break;` |
|   3217 | 1668 | `		case 3: /*PATHINFO_EXTENSION*/` |
|   6439 | 1669 | `			pComp = &sInfo.sExtension;` |
|   6439 | 1670 | `			if( pComp->nByte > 0 ){` |
|   6437 | 1671 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   3221 | 1672 | `			}else{` |
|      - | 1673 | `				/* Expand the empty string */` |
|      3 | 1674 | `				ph7_result_string(pCtx,"",0);` |
|      - | 1675 | `			}` |
|   6439 | 1676 | `			break;` |
|   3213 | 1677 | `		case 4: /*PATHINFO_FILENAME*/` |
|   6431 | 1678 | `			pComp = &sInfo.sFilename;` |
|   6431 | 1679 | `			if( pComp->nByte > 0 ){` |
|   6431 | 1680 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   3218 | 1681 | `			}else{` |
...
|      - | 2919 | ` */` |
|  30052 | 2920 | `PH7_PRIVATE void * PH7_StreamOpenHandle(ph7_vm *pVm,const ph7_io_stream *pStream,const char *zFile,` |
|      - | 2921 | `	int iFlags,int use_include,ph7_value *pResource,int bPushInclude,int *pNew)` |
|      5 | 2922 | `{` |
|  30057 | 2923 | `	void *pHandle = 0; /* cc warning */` |
|      - | 2924 | `	SyString sFile;` |
|      - | 2925 | `	int rc;` |
|  30057 | 2926 | `	if( pStream == 0 ){` |
|      - | 2927 | `		/* No such stream device */` |
|    ! 0 | 2928 | `		return 0;` |
|      - | 2929 | `	}` |
|  30057 | 2930 | `	SyStringInitFromBuf(&sFile,zFile,SyStrlen(zFile));` |
|  30057 | 2931 | `	if( use_include ){` |
|   9734 | 2932 | `		if(	sFile.zString[0] == '/' \|\|` |
|      - | 2933 | `#ifdef __WINNT__` |
|      - | 2934 | `			(sFile.nByte > 2 && sFile.zString[1] == ':' && (sFile.zString[2] == '\\' \|\| sFile.zString[2] == '/') ) \|\|` |
|      - | 2935 | `#endif` |
|   9720 | 2936 | `			(sFile.nByte > 1 && sFile.zString[0] == '.' && sFile.zString[1] == '/') \|\|` |
|   9716 | 2937 | `			(sFile.nByte > 2 && sFile.zString[0] == '.' && sFile.zString[1] == '.' && sFile.zString[2] == '/') ){` |
...
|   9720 | 2949 | `			SyBlobInit(&sWorker,&pVm->sAllocator);` |
|      - | 2950 | `			/* Build a path from the set of include path */` |
|   9720 | 2951 | `			SySetResetCursor(&pVm->aPaths);` |
|   9720 | 2952 | `			rc = SXERR_IO;` |
|   9726 | 2953 | `			while( SXRET_OK == SySetGetNextEntry(&pVm->aPaths,(void **)&pPath) ){` |
|      - | 2954 | `				/* Build full path */` |
|   9720 | 2955 | `				SyBlobFormat(&sWorker,"%z%c%z",pPath,c,&sFile);` |
|      - | 2956 | `				/* Append null terminator */` |
|   9720 | 2957 | `				if( SXRET_OK != SyBlobNullAppend(&sWorker) ){` |
|    ! 0 | 2958 | `					continue;` |
|      - | 2959 | `				}` |
|      - | 2960 | `				/* Try to open the file */` |
|   9720 | 2961 | `				rc = pStream->xOpen((const char *)SyBlobData(&sWorker),iFlags,pResource,&pHandle);` |
|   9720 | 2962 | `				if( rc == PH7_OK ){` |
|   9714 | 2963 | `					if( bPushInclude ){` |
|      - | 2964 | `						/* Mark as included */` |
|   9714 | 2965 | `						PH7_VmPushFilePath(pVm,(const char *)SyBlobData(&sWorker),SyBlobLength(&sWorker),FALSE,pNew);` |
|   4855 | 2966 | `					}` |
|   9714 | 2967 | `					break;` |
|      - | 2968 | `				}` |
...
|      2 | 2972 | `			}` |
|   9720 | 2973 | `			SyBlobRelease(&sWorker);` |
|      - | 2974 | `		}` |
|   9738 | 2975 | `		if( rc == PH7_OK ){` |
|   9732 | 2976 | `			if( bPushInclude ){` |
|      - | 2977 | `				/* Mark as included */` |
|   9732 | 2978 | `				PH7_VmPushFilePath(pVm,sFile.zString,sFile.nByte,FALSE,pNew);` |
|   4864 | 2979 | `			}` |
|   4864 | 2980 | `		}` |
|   4871 | 2981 | `	}else{` |
|      - | 2982 | `		/* Open the URI direcly */` |
|  20323 | 2983 | `		rc = pStream->xOpen(zFile,iFlags,pResource,&pHandle);` |
|      - | 2984 | `	}` |
|  30057 | 2985 | `	if( rc != PH7_OK ){` |
|      - | 2986 | `		/* IO error */` |
|     15 | 2987 | `		return 0;` |
|      - | 2988 | `	}` |
|      - | 2989 | `	/* Return the file handle */` |
|  30045 | 2990 | `	return pHandle;` |
|  15031 | 2991 | `}` |
|      - | 2992 | `/*` |
...
|      - | 2996 | ` */` |
|   9722 | 2997 | `PH7_PRIVATE sxi32 PH7_StreamReadWholeFile(void *pHandle,const ph7_io_stream *pStream,SyBlob *pOut)` |
|      4 | 2998 | `{` |
...
|   9722 | 3003 | `	for(;;){` |
|  19448 | 3004 | `		nRead = pStream->xRead(pHandle,zBuf,sizeof(zBuf));` |
|  19448 | 3005 | `		if( nRead < 1 ){` |
|      - | 3006 | `			/* EOF or IO error */` |
|   9726 | 3007 | `			break;` |
|      - | 3008 | `		}` |
|      - | 3009 | `		/* Append contents */` |
|   9726 | 3010 | `		rc = SyBlobAppend(pOut,zBuf,(sxu32)nRead);` |
|   9726 | 3011 | `		if( rc != SXRET_OK ){` |
|    ! 0 | 3012 | `			break;` |
|      - | 3013 | `		}` |
|      4 | 3014 | `	}` |
|   9726 | 3015 | `	return SyBlobLength(pOut) > 0 ? SXRET_OK : -1;` |
|      4 | 3016 | `}` |
|      - | 3017 | `/*` |
|      - | 3018 | ` * Close an open IO stream handle [i.e local file/URI..].` |
|      - | 3019 | ` */` |
|  30132 | 3020 | `PH7_PRIVATE void PH7_StreamCloseHandle(const ph7_io_stream *pStream,void *pHandle)` |
|      5 | 3021 | `{` |
|  30137 | 3022 | `	if( pStream->xClose ){` |
|  30137 | 3023 | `		pStream->xClose(pHandle);` |
|  15066 | 3024 | `	}` |
|  30137 | 3025 | `}` |
|      - | 3026 | `/*` |
...
|      - | 3404 | ` */` |
|   8398 | 3405 | `static int PH7_builtin_readdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3406 | `{` |
|      - | 3407 | `	const ph7_io_stream *pStream;` |
|      - | 3408 | `	io_private *pDev;` |
|      - | 3409 | `	int rc;` |
|   8403 | 3410 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   8403 | 3417 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3418 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   8403 | 3419 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   8403 | 3426 | `	pStream = pDev->pStream;` |
|   8403 | 3427 | `	if( pStream == 0  \|\| pStream->xReadDir == 0 ){` |
...
|      - | 3434 | `	}` |
|   8403 | 3435 | `	ph7_result_bool(pCtx,0);` |
|      - | 3436 | `	/* Perform the requested operation */` |
|   8403 | 3437 | `	rc = pStream->xReadDir(pDev->pHandle,pCtx);` |
|   8403 | 3438 | `	if( rc != PH7_OK ){` |
|      - | 3439 | `		/* Return FALSE */` |
|    987 | 3440 | `		ph7_result_bool(pCtx,0);` |
|    491 | 3441 | `	}` |
|   8403 | 3442 | `	return PH7_OK;` |
|   4204 | 3443 | `}` |
|      - | 3444 | `/*` |
...
|      - | 3686 | ` */` |
|   6466 | 3687 | `static int PH7_builtin_file_get_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3688 | `{` |
|      - | 3689 | `	const ph7_io_stream *pStream;` |
|      - | 3690 | `	ph7_int64 n,nRead,nMaxlen;` |
|   6471 | 3691 | `	int use_include  = FALSE;` |
|      - | 3692 | `	const char *zFile;` |
|      - | 3693 | `	char zBuf[8192];` |
|      - | 3694 | `	void *pHandle;` |
|      - | 3695 | `	int nLen;` |
|      - | 3696 |  |
|   6471 | 3697 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   6471 | 3704 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3705 | `	/* Point to the target IO stream device */` |
|   6471 | 3706 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|   6471 | 3707 | `	if( pStream == 0 ){` |
...
|   6471 | 3717 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,PH7_IO_OPEN_RDONLY,use_include,nArg > 2 ? apArg[2] : 0,FALSE,0);` |
|   6471 | 3718 | `	if( pHandle == 0 ){` |
...
|   6471 | 3738 | `	nRead = 0;` |
|   6464 | 3739 | `	for(;;){` |
|  19400 | 3740 | `		n = pStream->xRead(pHandle,zBuf,` |
|   6467 | 3741 | `			(nMaxlen > 0 && (nMaxlen < (ph7_int64)sizeof(zBuf))) ? nMaxlen : (ph7_int64)sizeof(zBuf));` |
|  12933 | 3742 | `		if( n < 1 ){` |
|      - | 3743 | `			/* EOF or IO error,break immediately */` |
|   6469 | 3744 | `			break;` |
|      - | 3745 | `		}` |
|      - | 3746 | `		/* Append data */` |
|   6469 | 3747 | `		ph7_result_string(pCtx,zBuf,(int)n);` |
|      - | 3748 | `		/* Increment read counter */` |
|   6469 | 3749 | `		nRead += n;` |
|   6469 | 3750 | `		if( nMaxlen > 0 && nRead >= nMaxlen ){` |
|      - | 3751 | `			/* Read limit reached */` |
|      3 | 3752 | `			break;` |
|      - | 3753 | `		}` |
|      5 | 3754 | `	}` |
|      - | 3755 | `	/* Close the stream */` |
|   6471 | 3756 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|      - | 3757 | `	/* Check if we have read something */` |
|   6471 | 3758 | `	if( ph7_context_result_buf_length(pCtx) < 1 ){` |
|      - | 3759 | `		/* Nothing read,return FALSE */` |
|      3 | 3760 | `		ph7_result_bool(pCtx,0);` |
|      1 | 3761 | `	}` |
|   6471 | 3762 | `	return PH7_OK;` |
|   3238 | 3763 | `}` |
|      - | 3764 | `/*` |
...
|      - | 3782 | ` */` |
|  13768 | 3783 | `static int PH7_builtin_file_put_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3784 | `{` |
|  13773 | 3785 | `	int use_include  = FALSE;` |
...
|      - | 3792 | `	int nLen;` |
|      - | 3793 |  |
|  13773 | 3794 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  13773 | 3801 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3802 | `	/* Point to the target IO stream device */` |
|  13773 | 3803 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|  13773 | 3804 | `	if( pStream == 0 ){` |
...
|      - | 3808 | `	}` |
|      - | 3809 | `	/* Data to write */` |
|  13773 | 3810 | `	zData = ph7_value_to_string(apArg[1],&nLen);` |
|      - | 3811 | `	/* Try to open the file in read-write mode */` |
|  13773 | 3812 | `	iOpenFlags = PH7_IO_OPEN_CREATE\|PH7_IO_OPEN_RDWR\|PH7_IO_OPEN_TRUNC;` |
|      - | 3813 | `	/* Extract the flags */` |
|  13773 | 3814 | `	iFlags = 0;` |
|  13773 | 3815 | `	if( nArg > 2 ){` |
...
|    ! 0 | 3827 | `		}` |
|    ! 0 | 3828 | `	}` |
|  20657 | 3829 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,iOpenFlags,use_include,` |
|   6884 | 3830 | `		nArg > 3 ? apArg[3] : 0,FALSE,FALSE);` |
|  13773 | 3831 | `	if( pHandle == 0 ){` |
...
|  13767 | 3866 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|  13767 | 3867 | `	return PH7_OK;` |
|   6889 | 3868 | `}` |
|      - | 3869 | `/*` |
