...
|  13583 |   77 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  13583 |   78 | `	if( pVfs == 0 \|\| pVfs->xChdir == 0 ){` |
...
|  13583 |   88 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |   89 | `	/* Perform the requested operation */` |
|  13583 |   90 | `	rc = pVfs->xChdir(zPath);` |
|      - |   91 | `	/* IO return value */` |
|  13583 |   92 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  13583 |   93 | `	return PH7_OK;` |
|   6797 |   94 |  |
|      - |   95 | `/*` |
...
|      - |  213 | ` */` |
|   7968 |  214 | `static int PH7_vfs_is_dir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  215 |  |
|      - |  216 | `	const char *zPath;` |
|      - |  217 | `	ph7_vfs *pVfs;` |
|      - |  218 | `	int rc;` |
|   7973 |  219 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  220 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  221 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  222 | `		return PH7_OK;` |
|      - |  223 | `	}` |
|      - |  224 | `	/* Point to the underlying vfs */` |
|   7973 |  225 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   7973 |  226 | `	if( pVfs == 0 \|\| pVfs->xIsdir == 0 ){` |
...
|   7973 |  236 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  237 | `	/* Perform the requested operation */` |
|   7973 |  238 | `	rc = pVfs->xIsdir(zPath);` |
|      - |  239 | `	/* IO return value */` |
|   7973 |  240 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   7973 |  241 | `	return PH7_OK;` |
|   3989 |  242 |  |
|      - |  243 | `/*` |
...
|      - |  476 | ` */` |
|  30328 |  477 | `static int PH7_vfs_unlink(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  478 |  |
|      - |  479 | `	const char *zPath;` |
|      - |  480 | `	ph7_vfs *pVfs;` |
|      - |  481 | `	int rc;` |
|  30333 |  482 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  483 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  484 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  485 | `		return PH7_OK;` |
|      - |  486 | `	}` |
|      - |  487 | `	/* Point to the underlying vfs */` |
|  30333 |  488 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  30333 |  489 | `	if( pVfs == 0 \|\| pVfs->xUnlink == 0 ){` |
...
|  30333 |  499 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  500 | `	/* Perform the requested operation */` |
|  30333 |  501 | `	rc = pVfs->xUnlink(zPath);` |
|      - |  502 | `	/* IO return value */` |
|  30333 |  503 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  30333 |  504 | `	return PH7_OK;` |
|  15169 |  505 |  |
|      - |  506 | `/*` |
...
|      - |  907 | ` */` |
|   6038 |  908 | `static int PH7_vfs_is_file(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  909 |  |
|      - |  910 | `	const char *zPath;` |
|      - |  911 | `	ph7_vfs *pVfs;` |
|      - |  912 | `	int rc;` |
|   6043 |  913 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  914 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  915 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  916 | `		return PH7_OK;` |
|      - |  917 | `	}` |
|      - |  918 | `	/* Point to the underlying vfs */` |
|   6043 |  919 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   6043 |  920 | `	if( pVfs == 0 \|\| pVfs->xIsfile == 0 ){` |
...
|   6043 |  930 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  931 | `	/* Perform the requested operation */` |
|   6043 |  932 | `	rc = pVfs->xIsfile(zPath);` |
|      - |  933 | `	/* IO return value */` |
|   6043 |  934 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   6043 |  935 | `	return PH7_OK;` |
|   3024 |  936 |  |
|      - |  937 | `/*` |
...
|      - | 1554 | ` */` |
|  12066 | 1555 | `static sxi32 ExtractPathInfo(const char *zPath,int nByte,path_info *pOut)` |
|      5 | 1556 |  |
|  12071 | 1557 | `	const char *zPtr,*zEnd = &zPath[nByte - 1];` |
|      - | 1558 | `	SyString *pCur;` |
|      - | 1559 | `	int c,d;` |
|  12071 | 1560 | `	c = d = '/';` |
...
|  12071 | 1565 | `	SyZero(pOut,sizeof(path_info));` |
|      - | 1566 | `	/* Handle special case */` |
|  12071 | 1567 | `	if( nByte == sizeof(char) && ( (int)zPath[0] == c \|\| (int)zPath[0] == d ) ){` |
...
| 322308 | 1576 | `	while( zEnd > zPath && ( (int)zEnd[0] != c && (int)zEnd[0] != d ) ){` |
| 304209 | 1577 | `		zEnd--;` |
|      5 | 1578 | `	}` |
|  12071 | 1579 | `	zPtr = (zEnd > zPath) ? &zEnd[1] : zPath;` |
|  12071 | 1580 | `	zEnd = &zPath[nByte];` |
|      - | 1581 | `	/* dirname */` |
|  12071 | 1582 | `	pCur = &pOut->sDir;` |
|  12071 | 1583 | `	SyStringInitFromBuf(pCur,zPath,zPtr-zPath);` |
|  12071 | 1584 | `	if( pCur->nByte > 1 ){` |
|  24137 | 1585 | `		SyStringTrimTrailingChar(pCur,'/');` |
|      - | 1586 | `#ifdef __WINNT__` |
|      5 | 1587 | `		SyStringTrimTrailingChar(pCur,'\\');` |
|      - | 1588 | `#endif` |
|   6038 | 1589 | `	}else if( (int)zPath[0] == c \|\| (int)zPath[0] == d ){` |
...
|  12071 | 1597 | `	pCur = &pOut->sBasename;` |
|  12071 | 1598 | `	SyStringInitFromBuf(pCur,zPtr,zEnd-zPtr);` |
|  12071 | 1599 | `	SyStringTrimLeadingChar(pCur,'/');` |
|      - | 1600 | `#ifdef __WINNT__` |
|      5 | 1601 | `	SyStringTrimLeadingChar(pCur,'\\');` |
|      - | 1602 | `#endif` |
|  12071 | 1603 | `	SyStringDupPtr(&pOut->sFilename,pCur);` |
|  12071 | 1604 | `	if( pCur->nByte > 0 ){` |
|      - | 1605 | `		/* extension */` |
|  12071 | 1606 | `		zEnd--;` |
|  60329 | 1607 | `		while( zEnd > pCur->zString /*basename*/ && zEnd[0] != '.' ){` |
|  48263 | 1608 | `			zEnd--;` |
|      5 | 1609 | `		}` |
|  12071 | 1610 | `		if( zEnd > pCur->zString ){` |
|  12069 | 1611 | `			zEnd++; /* Jump leading dot */` |
|  12069 | 1612 | `			SyStringInitFromBuf(&pOut->sExtension,zEnd,&zPath[nByte]-zEnd);` |
|      - | 1613 | `			/* Fix filename */` |
|  12069 | 1614 | `			pCur = &pOut->sFilename;` |
|  12069 | 1615 | `			if( pCur->nByte > SyStringLength(&pOut->sExtension) ){` |
|  12069 | 1616 | `				pCur->nByte -= 1 + SyStringLength(&pOut->sExtension);` |
|   6032 | 1617 | `			}` |
|   6032 | 1618 | `		}` |
|   6033 | 1619 | `	}` |
|  12071 | 1620 | `	return SXRET_OK;` |
|   6038 | 1621 |  |
|      - | 1622 | `/*` |
...
|      - | 1625 | ` */` |
|  12066 | 1626 | `static int PH7_builtin_pathinfo(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1627 |  |
|      - | 1628 | `	const char *zPath;` |
|      - | 1629 | `	path_info sInfo;` |
|      - | 1630 | `	SyString *pComp;` |
|      - | 1631 | `	int iLen;` |
|  12071 | 1632 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  12071 | 1638 | `	zPath = ph7_value_to_string(apArg[0],&iLen);` |
|  12071 | 1639 | `	if( iLen < 1 ){` |
|      - | 1640 | `		/* Empty string */` |
|    ! 0 | 1641 | `		ph7_result_string(pCtx,"",0);` |
|    ! 0 | 1642 | `		return PH7_OK;` |
|      - | 1643 | `	}` |
|      - | 1644 | `	/* Extract path info */` |
|  12071 | 1645 | `	ExtractPathInfo(zPath,iLen,&sInfo);` |
|  18103 | 1646 | `	if( nArg > 1 && ph7_value_is_int(apArg[1]) ){` |
|      - | 1647 | `		/* Return path component */` |
|  12069 | 1648 | `		int nComp = ph7_value_to_int(apArg[1]);` |
|  12069 | 1649 | `		switch(nComp){` |
...
|      - | 1666 | `			}` |
|      3 | 1667 | `			break;` |
|   3017 | 1668 | `		case 3: /*PATHINFO_EXTENSION*/` |
|   6039 | 1669 | `			pComp = &sInfo.sExtension;` |
|   6039 | 1670 | `			if( pComp->nByte > 0 ){` |
|   6037 | 1671 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   3021 | 1672 | `			}else{` |
|      - | 1673 | `				/* Expand the empty string */` |
|      3 | 1674 | `				ph7_result_string(pCtx,"",0);` |
|      - | 1675 | `			}` |
|   6039 | 1676 | `			break;` |
|   3013 | 1677 | `		case 4: /*PATHINFO_FILENAME*/` |
|   6031 | 1678 | `			pComp = &sInfo.sFilename;` |
|   6031 | 1679 | `			if( pComp->nByte > 0 ){` |
|   6031 | 1680 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   3018 | 1681 | `			}else{` |
...
|      - | 2707 | ` */` |
|   9374 | 2708 | `static int PH7_builtin_feof(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2709 |  |
|      - | 2710 | `	const ph7_io_stream *pStream;` |
|      - | 2711 | `	io_private *pDev;` |
|      - | 2712 | `	int rc;` |
|   9379 | 2713 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   9379 | 2720 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 2721 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   9379 | 2722 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   9379 | 2729 | `	pStream = pDev->pStream;` |
|   9379 | 2730 | `	if( pStream == 0 ){` |
...
|      - | 2737 | `	}` |
|   9379 | 2738 | `	rc = SXERR_EOF;` |
|      - | 2739 | `	/* Perform the requested operation */` |
|   9379 | 2740 | `	if( SyBlobLength(&pDev->sBuffer) > pDev->nOfft ){` |
...
|   5191 | 2747 | `		n = pStream->xRead(pDev->pHandle,zBuf,sizeof(zBuf));` |
|   5191 | 2748 | `		if( n > 0 ){` |
|      - | 2749 | `			/* Copy buffered data */` |
|   1615 | 2750 | `			SyBlobAppend(&pDev->sBuffer,zBuf,(sxu32)n);` |
|   1615 | 2751 | `			rc = PH7_OK;` |
|    805 | 2752 | `		}` |
|      - | 2753 | `	}` |
|      - | 2754 | `	/* EOF or not */` |
|   9379 | 2755 | `	ph7_result_bool(pCtx,rc == SXERR_EOF);` |
|   9379 | 2756 | `	return PH7_OK;` |
|   4692 | 2757 |  |
|      - | 2758 | `/*` |
...
|      - | 2802 | ` */` |
|   5858 | 2803 | `static sxi32 GetLine(io_private *pDev,ph7_int64 *pLen,const char **pzLine)` |
|      5 | 2804 |  |
|      - | 2805 | `	const char *zIn,*zEnd,*zPtr;` |
|   5863 | 2806 | `	zIn = (const char *)SyBlobDataAt(&pDev->sBuffer,pDev->nOfft);` |
|   5863 | 2807 | `	zEnd = &zIn[SyBlobLength(&pDev->sBuffer)-pDev->nOfft];` |
|   5863 | 2808 | `	zPtr = zIn;` |
| 365738 | 2809 | `	while( zIn < zEnd ){` |
| 365664 | 2810 | `		if( zIn[0] == '\n' ){` |
|      - | 2811 | `			/* Line found */` |
|   5789 | 2812 | `			zIn++; /* Include the line ending as requested by the PHP specification */` |
|   5789 | 2813 | `			*pLen = (ph7_int64)(zIn-zPtr);` |
|   5789 | 2814 | `			*pzLine = zPtr;` |
|   5789 | 2815 | `			return SXRET_OK;` |
|      - | 2816 | `		}` |
| 359880 | 2817 | `		zIn++;` |
|      5 | 2818 | `	}` |
...
|      - | 2824 | ` */` |
|   5862 | 2825 | `static ph7_int64 StreamReadLine(io_private *pDev,const char **pzData,ph7_int64 nMaxLen)` |
|      5 | 2826 |  |
|   5867 | 2827 | `	const ph7_io_stream *pStream = pDev->pStream;` |
|      - | 2828 | `	char zBuf[8192];` |
|      - | 2829 | `	ph7_int64 n;` |
|      - | 2830 | `	sxi32 rc;` |
|   5867 | 2831 | `	n = 0;` |
|   5867 | 2832 | `	if( pDev->nOfft >= SyBlobLength(&pDev->sBuffer) ){` |
...
|     30 | 2836 | `	}` |
|   5867 | 2837 | `	if( SyBlobLength(&pDev->sBuffer) > pDev->nOfft ){` |
|      - | 2838 | `		/* Check if there is a line */` |
|   5807 | 2839 | `		rc = GetLine(pDev,&n,pzData);` |
|   5807 | 2840 | `		if( rc == SXRET_OK ){` |
|      - | 2841 | `			/* Got line,update the cursor  */` |
|   5735 | 2842 | `			pDev->nOfft += (sxu32)n;` |
|   5735 | 2843 | `			return n;` |
|      - | 2844 | `		}` |
|     36 | 2845 | `	}` |
...
|      - | 2904 | ` */` |
|  30056 | 2905 | `PH7_PRIVATE void * PH7_StreamOpenHandle(ph7_vm *pVm,const ph7_io_stream *pStream,const char *zFile,` |
|      - | 2906 | `	int iFlags,int use_include,ph7_value *pResource,int bPushInclude,int *pNew)` |
|      5 | 2907 |  |
|  30061 | 2908 | `	void *pHandle = 0; /* cc warning */` |
|      - | 2909 | `	SyString sFile;` |
|      - | 2910 | `	int rc;` |
|  30061 | 2911 | `	if( pStream == 0 ){` |
|      - | 2912 | `		/* No such stream device */` |
|    ! 0 | 2913 | `		return 0;` |
|      - | 2914 | `	}` |
|  30061 | 2915 | `	SyStringInitFromBuf(&sFile,zFile,SyStrlen(zFile));` |
|  30061 | 2916 | `	if( use_include ){` |
|  10092 | 2917 | `		if(	sFile.zString[0] == '/' \|\|` |
|      - | 2918 | `#ifdef __WINNT__` |
|      - | 2919 | `			(sFile.nByte > 2 && sFile.zString[1] == ':' && (sFile.zString[2] == '\\' \|\| sFile.zString[2] == '/') ) \|\|` |
|      - | 2920 | `#endif` |
|  10078 | 2921 | `			(sFile.nByte > 1 && sFile.zString[0] == '.' && sFile.zString[1] == '/') \|\|` |
|  10074 | 2922 | `			(sFile.nByte > 2 && sFile.zString[0] == '.' && sFile.zString[1] == '.' && sFile.zString[2] == '/') ){` |
...
|  10078 | 2934 | `			SyBlobInit(&sWorker,&pVm->sAllocator);` |
|      - | 2935 | `			/* Build a path from the set of include path */` |
|  10078 | 2936 | `			SySetResetCursor(&pVm->aPaths);` |
|  10078 | 2937 | `			rc = SXERR_IO;` |
|  10084 | 2938 | `			while( SXRET_OK == SySetGetNextEntry(&pVm->aPaths,(void **)&pPath) ){` |
|      - | 2939 | `				/* Build full path */` |
|  10078 | 2940 | `				SyBlobFormat(&sWorker,"%z%c%z",pPath,c,&sFile);` |
|      - | 2941 | `				/* Append null terminator */` |
|  10078 | 2942 | `				if( SXRET_OK != SyBlobNullAppend(&sWorker) ){` |
|    ! 0 | 2943 | `					continue;` |
|      - | 2944 | `				}` |
|      - | 2945 | `				/* Try to open the file */` |
|  10078 | 2946 | `				rc = pStream->xOpen((const char *)SyBlobData(&sWorker),iFlags,pResource,&pHandle);` |
|  10078 | 2947 | `				if( rc == PH7_OK ){` |
|  10071 | 2948 | `					if( bPushInclude ){` |
|      - | 2949 | `						/* Mark as included */` |
|  10071 | 2950 | `						PH7_VmPushFilePath(pVm,(const char *)SyBlobData(&sWorker),SyBlobLength(&sWorker),FALSE,pNew);` |
|   5034 | 2951 | `					}` |
|  10071 | 2952 | `					break;` |
|      - | 2953 | `				}` |
...
|      2 | 2957 | `			}` |
|  10078 | 2958 | `			SyBlobRelease(&sWorker);` |
|      - | 2959 | `		}` |
|  10096 | 2960 | `		if( rc == PH7_OK ){` |
|  10089 | 2961 | `			if( bPushInclude ){` |
|      - | 2962 | `				/* Mark as included */` |
|  10089 | 2963 | `				PH7_VmPushFilePath(pVm,sFile.zString,sFile.nByte,FALSE,pNew);` |
|   5043 | 2964 | `			}` |
|   5043 | 2965 | `		}` |
|   5050 | 2966 | `	}else{` |
|      - | 2967 | `		/* Open the URI direcly */` |
|  19969 | 2968 | `		rc = pStream->xOpen(zFile,iFlags,pResource,&pHandle);` |
|      - | 2969 | `	}` |
|  30061 | 2970 | `	if( rc != PH7_OK ){` |
|      - | 2971 | `		/* IO error */` |
|     15 | 2972 | `		return 0;` |
|      - | 2973 | `	}` |
|      - | 2974 | `	/* Return the file handle */` |
|  30049 | 2975 | `	return pHandle;` |
|  15033 | 2976 |  |
|      - | 2977 | `/*` |
...
|      - | 2981 | ` */` |
|  10080 | 2982 | `PH7_PRIVATE sxi32 PH7_StreamReadWholeFile(void *pHandle,const ph7_io_stream *pStream,SyBlob *pOut)` |
|      3 | 2983 |  |
...
|  10080 | 2988 | `	for(;;){` |
|  20163 | 2989 | `		nRead = pStream->xRead(pHandle,zBuf,sizeof(zBuf));` |
|  20163 | 2990 | `		if( nRead < 1 ){` |
|      - | 2991 | `			/* EOF or IO error */` |
|  10083 | 2992 | `			break;` |
|      - | 2993 | `		}` |
|      - | 2994 | `		/* Append contents */` |
|  10083 | 2995 | `		rc = SyBlobAppend(pOut,zBuf,(sxu32)nRead);` |
|  10083 | 2996 | `		if( rc != SXRET_OK ){` |
|    ! 0 | 2997 | `			break;` |
|      - | 2998 | `		}` |
|      3 | 2999 | `	}` |
|  10083 | 3000 | `	return SyBlobLength(pOut) > 0 ? SXRET_OK : -1;` |
|      3 | 3001 |  |
|      - | 3002 | `/*` |
|      - | 3003 | ` * Close an open IO stream handle [i.e local file/URI..].` |
|      - | 3004 | ` */` |
|  30136 | 3005 | `PH7_PRIVATE void PH7_StreamCloseHandle(const ph7_io_stream *pStream,void *pHandle)` |
|      5 | 3006 |  |
|  30141 | 3007 | `	if( pStream->xClose ){` |
|  30141 | 3008 | `		pStream->xClose(pHandle);` |
|  15068 | 3009 | `	}` |
|  30141 | 3010 |  |
|      - | 3011 | `/*` |
...
|      - | 3080 | ` */` |
|   5852 | 3081 | `static int PH7_builtin_fgets(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3082 |  |
|      - | 3083 | `	const ph7_io_stream *pStream;` |
|      - | 3084 | `	const char *zLine;` |
|      - | 3085 | `	io_private *pDev;` |
|      - | 3086 | `	ph7_int64 n,nLen;` |
|   5857 | 3087 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   5857 | 3094 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3095 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   5857 | 3096 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   5857 | 3103 | `	pStream = pDev->pStream;` |
|   5857 | 3104 | `	if( pStream == 0  ){` |
...
|   5857 | 3118 | `	n = StreamReadLine(pDev,&zLine,nLen);` |
|   5857 | 3119 | `	if( n < 1 ){` |
|      - | 3120 | `		/* EOF or IO error,return FALSE */` |
|      7 | 3121 | `		ph7_result_bool(pCtx,0);` |
|      6 | 3122 | `	}else{` |
|      - | 3123 | `		/* Return the freshly extracted line */` |
|   5855 | 3124 | `		ph7_result_string(pCtx,zLine,(int)n);` |
|      - | 3125 | `	}` |
|   5857 | 3126 | `	return PH7_OK;` |
|   2931 | 3127 |  |
|      - | 3128 | `/*` |
...
|      - | 3389 | ` */` |
|   7966 | 3390 | `static int PH7_builtin_readdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3391 |  |
|      - | 3392 | `	const ph7_io_stream *pStream;` |
|      - | 3393 | `	io_private *pDev;` |
|      - | 3394 | `	int rc;` |
|   7971 | 3395 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   7971 | 3402 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3403 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   7971 | 3404 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   7971 | 3411 | `	pStream = pDev->pStream;` |
|   7971 | 3412 | `	if( pStream == 0  \|\| pStream->xReadDir == 0 ){` |
...
|      - | 3419 | `	}` |
|   7971 | 3420 | `	ph7_result_bool(pCtx,0);` |
|      - | 3421 | `	/* Perform the requested operation */` |
|   7971 | 3422 | `	rc = pStream->xReadDir(pDev->pHandle,pCtx);` |
|   7971 | 3423 | `	if( rc != PH7_OK ){` |
|      - | 3424 | `		/* Return FALSE */` |
|    971 | 3425 | `		ph7_result_bool(pCtx,0);` |
|    483 | 3426 | `	}` |
|   7971 | 3427 | `	return PH7_OK;` |
|   3988 | 3428 |  |
|      - | 3429 | `/*` |
...
|      - | 3671 | ` */` |
|   6066 | 3672 | `static int PH7_builtin_file_get_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3673 |  |
|      - | 3674 | `	const ph7_io_stream *pStream;` |
|      - | 3675 | `	ph7_int64 n,nRead,nMaxlen;` |
|   6071 | 3676 | `	int use_include  = FALSE;` |
|      - | 3677 | `	const char *zFile;` |
|      - | 3678 | `	char zBuf[8192];` |
|      - | 3679 | `	void *pHandle;` |
|      - | 3680 | `	int nLen;` |
|      - | 3681 |  |
|   6071 | 3682 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   6071 | 3689 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3690 | `	/* Point to the target IO stream device */` |
|   6071 | 3691 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|   6071 | 3692 | `	if( pStream == 0 ){` |
...
|   6071 | 3702 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,PH7_IO_OPEN_RDONLY,use_include,nArg > 2 ? apArg[2] : 0,FALSE,0);` |
|   6071 | 3703 | `	if( pHandle == 0 ){` |
...
|   6071 | 3723 | `	nRead = 0;` |
|   6065 | 3724 | `	for(;;){` |
|  18203 | 3725 | `		n = pStream->xRead(pHandle,zBuf,` |
|   6068 | 3726 | `			(nMaxlen > 0 && (nMaxlen < (ph7_int64)sizeof(zBuf))) ? nMaxlen : (ph7_int64)sizeof(zBuf));` |
|  12135 | 3727 | `		if( n < 1 ){` |
|      - | 3728 | `			/* EOF or IO error,break immediately */` |
|   6069 | 3729 | `			break;` |
|      - | 3730 | `		}` |
|      - | 3731 | `		/* Append data */` |
|   6071 | 3732 | `		ph7_result_string(pCtx,zBuf,(int)n);` |
|      - | 3733 | `		/* Increment read counter */` |
|   6071 | 3734 | `		nRead += n;` |
|   6071 | 3735 | `		if( nMaxlen > 0 && nRead >= nMaxlen ){` |
|      - | 3736 | `			/* Read limit reached */` |
|      3 | 3737 | `			break;` |
|      - | 3738 | `		}` |
|      5 | 3739 | `	}` |
|      - | 3740 | `	/* Close the stream */` |
|   6071 | 3741 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|      - | 3742 | `	/* Check if we have read something */` |
|   6071 | 3743 | `	if( ph7_context_result_buf_length(pCtx) < 1 ){` |
|      - | 3744 | `		/* Nothing read,return FALSE */` |
|    ! 0 | 3745 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 3746 | `	}` |
|   6071 | 3747 | `	return PH7_OK;` |
|   3038 | 3748 |  |
|      - | 3749 | `/*` |
...
|      - | 3767 | ` */` |
|  13814 | 3768 | `static int PH7_builtin_file_put_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3769 |  |
|  13819 | 3770 | `	int use_include  = FALSE;` |
...
|      - | 3777 | `	int nLen;` |
|      - | 3778 |  |
|  13819 | 3779 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  13819 | 3786 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3787 | `	/* Point to the target IO stream device */` |
|  13819 | 3788 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|  13819 | 3789 | `	if( pStream == 0 ){` |
...
|      - | 3793 | `	}` |
|      - | 3794 | `	/* Data to write */` |
|  13819 | 3795 | `	zData = ph7_value_to_string(apArg[1],&nLen);` |
|      - | 3796 | `	/* Try to open the file in read-write mode */` |
|  13819 | 3797 | `	iOpenFlags = PH7_IO_OPEN_CREATE\|PH7_IO_OPEN_RDWR\|PH7_IO_OPEN_TRUNC;` |
|      - | 3798 | `	/* Extract the flags */` |
|  13819 | 3799 | `	iFlags = 0;` |
|  13819 | 3800 | `	if( nArg > 2 ){` |
...
|    ! 0 | 3812 | `		}` |
|    ! 0 | 3813 | `	}` |
|  20726 | 3814 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,iOpenFlags,use_include,` |
|   6907 | 3815 | `		nArg > 3 ? apArg[3] : 0,FALSE,FALSE);` |
|  13819 | 3816 | `	if( pHandle == 0 ){` |
...
|  13813 | 3851 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|  13813 | 3852 | `	return PH7_OK;` |
|   6912 | 3853 |  |
|      - | 3854 | `/*` |
...
|      - | 4728 | ` */` |
|   4692 | 4729 | `static void InitIOPrivate(ph7_vm *pVm,const ph7_io_stream *pStream,io_private *pOut)` |
|      5 | 4730 |  |
|   4697 | 4731 | `	pOut->pStream = pStream;` |
|   4697 | 4732 | `	SyBlobInit(&pOut->sBuffer,&pVm->sAllocator);` |
|   4697 | 4733 | `	pOut->nOfft = 0;` |
|      - | 4734 | `	/* Set the magic number */` |
|   4697 | 4735 | `	pOut->iMagic = IO_PRIVATE_MAGIC;` |
|   4697 | 4736 |  |
|      - | 4737 | `/*` |
|      - | 4738 | ` * Release the IO private structure.` |
|      - | 4739 | ` */` |
|   4660 | 4740 | `static void ReleaseIOPrivate(ph7_context *pCtx,io_private *pDev)` |
|      5 | 4741 |  |
|   4665 | 4742 | `	SyBlobRelease(&pDev->sBuffer);` |
|   4665 | 4743 | `	pDev->iMagic = 0x2126; /* Invalid magic number so we can detetct misuse */` |
|      - | 4744 | `	/* Release the whole structure */` |
|   4665 | 4745 | `	ph7_context_free_chunk(pCtx,pDev);` |
|   4665 | 4746 |  |
|      - | 4747 | `/*` |
...
|      - | 5176 | ` */` |
|   3590 | 5177 | `PH7_PRIVATE const ph7_vfs * PH7_ExportBuiltinVfs(void)` |
|      5 | 5178 |  |
...
|      - | 5596 | ` */` |
|   3650 | 5597 | `static pipe_private * PipeOpen(ph7_vm *pVm, const char *zCommand, const char *zMode)` |
|      5 | 5598 |  |
|      - | 5599 | `	pipe_private *pPipe;` |
|      - | 5600 | `	FILE *pFile;` |
|   3655 | 5601 | `	if( pVm == 0 \|\| zCommand == 0 \|\| zMode == 0 ){` |
|    ! 0 | 5602 | `		return 0;` |
|      - | 5603 | `	}` |
|      - | 5604 | `	/* Validate mode - only 'r' or 'w' allowed */` |
|   3655 | 5605 | `	if( zMode[0] != 'r' && zMode[0] != 'w' ){` |
|    ! 0 | 5606 | `		return 0;` |
|      - | 5607 | `	}` |
...
|   3650 | 5669 | `	pFile = popen(zCommand, zMode);` |
|   3650 | 5670 | `	if( pFile == 0 ){` |
|    ! 0 | 5671 | `		return 0;` |
|      - | 5672 | `	}` |
|      - | 5673 | `	/* Allocate pipe private structure */` |
|   3650 | 5674 | `	pPipe = (pipe_private *)SyMemBackendAlloc(&pVm->sAllocator, sizeof(pipe_private));` |
|   3650 | 5675 | `	if( pPipe == 0 ){` |
|      - | 5676 | `		/* Out of memory, close the pipe */` |
|    ! 0 | 5677 | `		pclose(pFile);` |
|    ! 0 | 5678 | `		return 0;` |
|      - | 5679 | `	}` |
|      - | 5680 | `	/* Initialize the structure */` |
|   3650 | 5681 | `	pPipe->pFile = pFile;` |
|   3650 | 5682 | `	pPipe->pVm = pVm;` |
|   3650 | 5683 | `	pPipe->iMode = zMode[0];` |
|      - | 5684 | `#else /* OS_OTHER: no process pipes on this platform */` |
|      - | 5685 | `	(void)pFile;` |
|      - | 5686 | `	return 0;` |
|      - | 5687 | `#endif` |
|   3655 | 5688 | `	return pPipe;` |
|   1830 | 5689 |  |
|      - | 5690 | `/*` |
|      - | 5691 | ` * Close a pipe and return the exit status of the process.` |
|      - | 5692 | ` * Returns the exit status, or -1 on error.` |
|      - | 5693 | ` */` |
|   3628 | 5694 | `static int PipeClose(pipe_private *pPipe)` |
|      5 | 5695 |  |
|      - | 5696 | `	int status;` |
|      - | 5697 | `	ph7_vm *pVm;` |
|   3633 | 5698 | `	if( pPipe == 0 \|\| pPipe->pFile == 0 ){` |
|    ! 0 | 5699 | `		return -1;` |
|      - | 5700 | `	}` |
|   3633 | 5701 | `	pVm = pPipe->pVm;` |
...
|   3628 | 5707 | `	status = pclose(pPipe->pFile);` |
|      - | 5708 | `	/* On Unix, pclose returns the status from waitpid, need to extract exit code */` |
|   3628 | 5709 | `	if( status != -1 ){` |
|   3628 | 5710 | `		if( WIFEXITED(status) ){` |
|   3628 | 5711 | `			status = WEXITSTATUS(status);` |
|   1814 | 5712 | `		}else if( WIFSIGNALED(status) ){` |
...
|   3633 | 5724 | `	SyMemBackendFree(&pVm->sAllocator, pPipe);` |
|   3633 | 5725 | `	return status;` |
|   1819 | 5726 |  |
|      - | 5727 | `/*` |
...
|      - | 5741 | ` */` |
|   5298 | 5742 | `static ph7_int64 PipeStream_Read(void *pHandle, void *pBuffer, ph7_int64 nDatatoRead)` |
|      4 | 5743 |  |
|   5302 | 5744 | `	pipe_private *pPipe = (pipe_private *)pHandle;` |
|      - | 5745 | `	size_t nRead;` |
|   5302 | 5746 | `	if( pPipe == 0 \|\| pPipe->pFile == 0 ){` |
|    ! 0 | 5747 | `		return -1;` |
|      - | 5748 | `	}` |
|   5302 | 5749 | `	if( pPipe->iMode != 'r' ){` |
|      - | 5750 | `		/* Cannot read from a write-only pipe */` |
|    ! 0 | 5751 | `		return -1;` |
|      - | 5752 | `	}` |
|   5302 | 5753 | `	nRead = fread(pBuffer, 1, (size_t)nDatatoRead, pPipe->pFile);` |
|   5302 | 5754 | `	if( nRead == 0 ){` |
|   3644 | 5755 | `		if( feof(pPipe->pFile) ){` |
|   3644 | 5756 | `			return 0; /* EOF */` |
|      - | 5757 | `		}` |
|    ! 0 | 5758 | `		return -1; /* Error */` |
|      - | 5759 | `	}` |
|   1662 | 5760 | `	return (ph7_int64)nRead;` |
|   2653 | 5761 |  |
|      - | 5762 | `/*` |
...
|      - | 5804 | ` */` |
|   3534 | 5805 | `static int is_pipe_stream(const ph7_io_stream *pStream)` |
|      5 | 5806 |  |
|   3539 | 5807 | `	return pStream == &sPipe_Stream;` |
|      5 | 5808 |  |
|      - | 5809 | `/*` |
...
|      - | 5821 | ` */` |
|   3650 | 5822 | `static int PH7_builtin_popen(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 5823 |  |
|      - | 5824 | `	const char *zCommand, *zMode;` |
|      - | 5825 | `	pipe_private *pPipe;` |
|      - | 5826 | `	io_private *pDev;` |
|      - | 5827 | `	int nCmdLen, nModeLen;` |
|   3655 | 5828 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) \|\| !ph7_value_is_string(apArg[1]) ){` |
...
|   3655 | 5835 | `	zCommand = ph7_value_to_string(apArg[0], &nCmdLen);` |
|   3655 | 5836 | `	zMode = ph7_value_to_string(apArg[1], &nModeLen);` |
|   3655 | 5837 | `	if( nCmdLen < 1 ){` |
|    ! 0 | 5838 | `		ph7_context_throw_error(pCtx, PH7_CTX_WARNING, "Empty command");` |
|    ! 0 | 5839 | `		ph7_result_bool(pCtx, 0);` |
|    ! 0 | 5840 | `		return PH7_OK;` |
|      - | 5841 | `	}` |
|   3655 | 5842 | `	if( nModeLen < 1 \|\| (zMode[0] != 'r' && zMode[0] != 'w') ){` |
...
|      - | 5846 | `	}` |
|      - | 5847 | `	/* Open the pipe */` |
|   3655 | 5848 | `	pPipe = PipeOpen(pCtx->pVm, zCommand, zMode);` |
|   3655 | 5849 | `	if( pPipe == 0 ){` |
...
|   3655 | 5855 | `	pDev = (io_private *)ph7_context_alloc_chunk(pCtx, sizeof(io_private), TRUE, FALSE);` |
|   3655 | 5856 | `	if( pDev == 0 ){` |
...
|   3655 | 5863 | `	InitIOPrivate(pCtx->pVm, &sPipe_Stream, pDev);` |
|   3655 | 5864 | `	pDev->pHandle = pPipe;` |
|      - | 5865 | `	/* Return the io_private instance as a resource */` |
|   3655 | 5866 | `	ph7_result_resource(pCtx, pDev);` |
|   3655 | 5867 | `	return PH7_OK;` |
|   1830 | 5868 |  |
|      - | 5869 | `/*` |
...
|      - | 5877 | ` */` |
|   3534 | 5878 | `static int PH7_builtin_pclose(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 5879 |  |
|      - | 5880 | `	const ph7_io_stream *pStream;` |
|      - | 5881 | `	pipe_private *pPipe;` |
|      - | 5882 | `	io_private *pDev;` |
|      - | 5883 | `	int status;` |
|   3539 | 5884 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   3539 | 5891 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 5892 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   3539 | 5893 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   3539 | 5899 | `	pStream = pDev->pStream;` |
|   3539 | 5900 | `	if( pStream == 0 \|\| !is_pipe_stream(pStream) ){` |
...
|   3539 | 5906 | `	pPipe = (pipe_private *)pDev->pHandle;` |
|      - | 5907 | `	/* Close the pipe and get exit status */` |
|   3539 | 5908 | `	status = PipeClose(pPipe);` |
|      - | 5909 | `	/* Release the IO private structure */` |
|   3539 | 5910 | `	ReleaseIOPrivate(pCtx, pDev);` |
|      - | 5911 | `	/* Invalidate the resource handle */` |
|   3539 | 5912 | `	ph7_value_release(apArg[0]);` |
|      - | 5913 | `	/* Return the exit status */` |
|   3539 | 5914 | `	ph7_result_int(pCtx, status);` |
|   3539 | 5915 | `	return PH7_OK;` |
|   1772 | 5916 |  |
...
|      - | 5958 | ` */` |
|   3210 | 5959 | `PH7_PRIVATE sxi32 PH7_RegisterIORoutine(ph7_vm *pVm)` |
|      5 | 5960 |  |
|      - | 5961 | `	/*` |
...
|      - | 6058 | `	};` |
|   3215 | 6059 | `	const ph7_io_stream *pFileStream = 0;` |
|   3215 | 6060 | `	sxu32 n = 0;` |
|      - | 6061 | `	/* Register disk-related functions */` |
| 157295 | 6062 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVfsDiskFunc) ; ++n ){` |
| 154085 | 6063 | `		ph7_create_function(&(*pVm),aVfsDiskFunc[n].zName,aVfsDiskFunc[n].xFunc,(void *)pVm->pEngine->pVfs);` |
|  77045 | 6064 | `	}` |
| 115565 | 6065 | `	for( n = 0 ; n < SX_ARRAYSIZE(aIOFunc) ; ++n ){` |
| 112355 | 6066 | `		ph7_create_function(&(*pVm),aIOFunc[n].zName,aIOFunc[n].xFunc,pVm);` |
|  56180 | 6067 | `	}` |
|      - | 6068 | `#else` |
|      - | 6069 | `	SXUNUSED(pVm);` |
...
|      - | 6096 | `	};` |
|  54575 | 6097 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVfsHelperFunc) ; ++n ){` |
|  51365 | 6098 | `		ph7_create_function(&(*pVm),aVfsHelperFunc[n].zName,aVfsHelperFunc[n].xFunc,pVm);` |
|  25685 | 6099 | `	}` |
...
|   3210 | 6107 | `	pFileStream = &sUnixFileStream;` |
|      - | 6108 | `#endif` |
|      - | 6109 | `	/* Install the php:// stream */` |
|   3215 | 6110 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,&sPHP_Stream);` |
|   3215 | 6111 | `	if( pFileStream ){` |
|      - | 6112 | `		/* Install the file:// stream */` |
|   3215 | 6113 | `		ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,pFileStream);` |
|   1605 | 6114 | `	}` |
|      - | 6115 | `#endif /* PH7_DISABLE_DISK_IO */` |
|      - | 6116 |  |
|   3215 | 6117 | `	return SXRET_OK;` |
|      5 | 6118 |  |
|      - | 6119 | `/*` |
