...
|      - |   65 | ` */` |
|  13362 |   66 | `static int PH7_vfs_chdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |   67 |  |
|      - |   68 | `	const char *zPath;` |
|      - |   69 | `	ph7_vfs *pVfs;` |
|      - |   70 | `	int rc;` |
|  13367 |   71 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |   72 | `		/* Missing/Invalid argument,return FALSE */` |
|      8 |   73 | `		ph7_result_bool(pCtx,0);` |
|      8 |   74 | `		return PH7_OK;` |
|      - |   75 | `	}` |
|      - |   76 | `	/* Point to the underlying vfs */` |
|  13361 |   77 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  13361 |   78 | `	if( pVfs == 0 \|\| pVfs->xChdir == 0 ){` |
...
|  13361 |   88 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |   89 | `	/* Perform the requested operation */` |
|  13361 |   90 | `	rc = pVfs->xChdir(zPath);` |
|      - |   91 | `	/* IO return value */` |
|  13361 |   92 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  13361 |   93 | `	return PH7_OK;` |
|   6686 |   94 |  |
|      - |   95 | `/*` |
...
|      - |  213 | ` */` |
|   7856 |  214 | `static int PH7_vfs_is_dir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  215 |  |
|      - |  216 | `	const char *zPath;` |
|      - |  217 | `	ph7_vfs *pVfs;` |
|      - |  218 | `	int rc;` |
|   7861 |  219 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  220 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  221 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  222 | `		return PH7_OK;` |
|      - |  223 | `	}` |
|      - |  224 | `	/* Point to the underlying vfs */` |
|   7861 |  225 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   7861 |  226 | `	if( pVfs == 0 \|\| pVfs->xIsdir == 0 ){` |
...
|   7861 |  236 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  237 | `	/* Perform the requested operation */` |
|   7861 |  238 | `	rc = pVfs->xIsdir(zPath);` |
|      - |  239 | `	/* IO return value */` |
|   7861 |  240 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   7861 |  241 | `	return PH7_OK;` |
|   3933 |  242 |  |
|      - |  243 | `/*` |
...
|      - |  476 | ` */` |
|  29768 |  477 | `static int PH7_vfs_unlink(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  478 |  |
|      - |  479 | `	const char *zPath;` |
|      - |  480 | `	ph7_vfs *pVfs;` |
|      - |  481 | `	int rc;` |
|  29773 |  482 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  483 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  484 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  485 | `		return PH7_OK;` |
|      - |  486 | `	}` |
|      - |  487 | `	/* Point to the underlying vfs */` |
|  29773 |  488 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  29773 |  489 | `	if( pVfs == 0 \|\| pVfs->xUnlink == 0 ){` |
...
|  29773 |  499 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  500 | `	/* Perform the requested operation */` |
|  29773 |  501 | `	rc = pVfs->xUnlink(zPath);` |
|      - |  502 | `	/* IO return value */` |
|  29773 |  503 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  29773 |  504 | `	return PH7_OK;` |
|  14889 |  505 |  |
|      - |  506 | `/*` |
...
|      - |  907 | ` */` |
|   5926 |  908 | `static int PH7_vfs_is_file(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  909 |  |
|      - |  910 | `	const char *zPath;` |
|      - |  911 | `	ph7_vfs *pVfs;` |
|      - |  912 | `	int rc;` |
|   5931 |  913 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  914 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  915 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  916 | `		return PH7_OK;` |
|      - |  917 | `	}` |
|      - |  918 | `	/* Point to the underlying vfs */` |
|   5931 |  919 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   5931 |  920 | `	if( pVfs == 0 \|\| pVfs->xIsfile == 0 ){` |
...
|   5931 |  930 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  931 | `	/* Perform the requested operation */` |
|   5931 |  932 | `	rc = pVfs->xIsfile(zPath);` |
|      - |  933 | `	/* IO return value */` |
|   5931 |  934 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   5931 |  935 | `	return PH7_OK;` |
|   2968 |  936 |  |
|      - |  937 | `/*` |
...
|      - | 1554 | ` */` |
|  11842 | 1555 | `static sxi32 ExtractPathInfo(const char *zPath,int nByte,path_info *pOut)` |
|      5 | 1556 |  |
|  11847 | 1557 | `	const char *zPtr,*zEnd = &zPath[nByte - 1];` |
|      - | 1558 | `	SyString *pCur;` |
|      - | 1559 | `	int c,d;` |
|  11847 | 1560 | `	c = d = '/';` |
...
|  11847 | 1565 | `	SyZero(pOut,sizeof(path_info));` |
|      - | 1566 | `	/* Handle special case */` |
|  11847 | 1567 | `	if( nByte == sizeof(char) && ( (int)zPath[0] == c \|\| (int)zPath[0] == d ) ){` |
...
| 316364 | 1576 | `	while( zEnd > zPath && ( (int)zEnd[0] != c && (int)zEnd[0] != d ) ){` |
| 298601 | 1577 | `		zEnd--;` |
|      5 | 1578 | `	}` |
|  11847 | 1579 | `	zPtr = (zEnd > zPath) ? &zEnd[1] : zPath;` |
|  11847 | 1580 | `	zEnd = &zPath[nByte];` |
|      - | 1581 | `	/* dirname */` |
|  11847 | 1582 | `	pCur = &pOut->sDir;` |
|  11847 | 1583 | `	SyStringInitFromBuf(pCur,zPath,zPtr-zPath);` |
|  11847 | 1584 | `	if( pCur->nByte > 1 ){` |
|  23689 | 1585 | `		SyStringTrimTrailingChar(pCur,'/');` |
|      - | 1586 | `#ifdef __WINNT__` |
|      5 | 1587 | `		SyStringTrimTrailingChar(pCur,'\\');` |
|      - | 1588 | `#endif` |
|   5926 | 1589 | `	}else if( (int)zPath[0] == c \|\| (int)zPath[0] == d ){` |
...
|  11847 | 1597 | `	pCur = &pOut->sBasename;` |
|  11847 | 1598 | `	SyStringInitFromBuf(pCur,zPtr,zEnd-zPtr);` |
|  11847 | 1599 | `	SyStringTrimLeadingChar(pCur,'/');` |
|      - | 1600 | `#ifdef __WINNT__` |
|      5 | 1601 | `	SyStringTrimLeadingChar(pCur,'\\');` |
|      - | 1602 | `#endif` |
|  11847 | 1603 | `	SyStringDupPtr(&pOut->sFilename,pCur);` |
|  11847 | 1604 | `	if( pCur->nByte > 0 ){` |
|      - | 1605 | `		/* extension */` |
|  11847 | 1606 | `		zEnd--;` |
|  59209 | 1607 | `		while( zEnd > pCur->zString /*basename*/ && zEnd[0] != '.' ){` |
|  47367 | 1608 | `			zEnd--;` |
|      5 | 1609 | `		}` |
|  11847 | 1610 | `		if( zEnd > pCur->zString ){` |
|  11845 | 1611 | `			zEnd++; /* Jump leading dot */` |
|  11845 | 1612 | `			SyStringInitFromBuf(&pOut->sExtension,zEnd,&zPath[nByte]-zEnd);` |
|      - | 1613 | `			/* Fix filename */` |
|  11845 | 1614 | `			pCur = &pOut->sFilename;` |
|  11845 | 1615 | `			if( pCur->nByte > SyStringLength(&pOut->sExtension) ){` |
|  11845 | 1616 | `				pCur->nByte -= 1 + SyStringLength(&pOut->sExtension);` |
|   5920 | 1617 | `			}` |
|   5920 | 1618 | `		}` |
|   5921 | 1619 | `	}` |
|  11847 | 1620 | `	return SXRET_OK;` |
|   5926 | 1621 |  |
|      - | 1622 | `/*` |
...
|      - | 1625 | ` */` |
|  11842 | 1626 | `static int PH7_builtin_pathinfo(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1627 |  |
|      - | 1628 | `	const char *zPath;` |
|      - | 1629 | `	path_info sInfo;` |
|      - | 1630 | `	SyString *pComp;` |
|      - | 1631 | `	int iLen;` |
|  11847 | 1632 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  11847 | 1638 | `	zPath = ph7_value_to_string(apArg[0],&iLen);` |
|  11847 | 1639 | `	if( iLen < 1 ){` |
|      - | 1640 | `		/* Empty string */` |
|    ! 0 | 1641 | `		ph7_result_string(pCtx,"",0);` |
|    ! 0 | 1642 | `		return PH7_OK;` |
|      - | 1643 | `	}` |
|      - | 1644 | `	/* Extract path info */` |
|  11847 | 1645 | `	ExtractPathInfo(zPath,iLen,&sInfo);` |
|  17767 | 1646 | `	if( nArg > 1 && ph7_value_is_int(apArg[1]) ){` |
|      - | 1647 | `		/* Return path component */` |
|  11845 | 1648 | `		int nComp = ph7_value_to_int(apArg[1]);` |
|  11845 | 1649 | `		switch(nComp){` |
...
|      - | 1666 | `			}` |
|      3 | 1667 | `			break;` |
|   2961 | 1668 | `		case 3: /*PATHINFO_EXTENSION*/` |
|   5927 | 1669 | `			pComp = &sInfo.sExtension;` |
|   5927 | 1670 | `			if( pComp->nByte > 0 ){` |
|   5925 | 1671 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   2965 | 1672 | `			}else{` |
|      - | 1673 | `				/* Expand the empty string */` |
|      3 | 1674 | `				ph7_result_string(pCtx,"",0);` |
|      - | 1675 | `			}` |
|   5927 | 1676 | `			break;` |
|   2957 | 1677 | `		case 4: /*PATHINFO_FILENAME*/` |
|   5919 | 1678 | `			pComp = &sInfo.sFilename;` |
|   5919 | 1679 | `			if( pComp->nByte > 0 ){` |
|   5919 | 1680 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   2962 | 1681 | `			}else{` |
...
|      - | 2707 | ` */` |
|   9056 | 2708 | `static int PH7_builtin_feof(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2709 |  |
|      - | 2710 | `	const ph7_io_stream *pStream;` |
|      - | 2711 | `	io_private *pDev;` |
|      - | 2712 | `	int rc;` |
|   9061 | 2713 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   9061 | 2720 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 2721 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   9061 | 2722 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   9061 | 2729 | `	pStream = pDev->pStream;` |
|   9061 | 2730 | `	if( pStream == 0 ){` |
...
|      - | 2737 | `	}` |
|   9061 | 2738 | `	rc = SXERR_EOF;` |
|      - | 2739 | `	/* Perform the requested operation */` |
|   9061 | 2740 | `	if( SyBlobLength(&pDev->sBuffer) > pDev->nOfft ){` |
...
|   5053 | 2747 | `		n = pStream->xRead(pDev->pHandle,zBuf,sizeof(zBuf));` |
|   5053 | 2748 | `		if( n > 0 ){` |
|      - | 2749 | `			/* Copy buffered data */` |
|   1571 | 2750 | `			SyBlobAppend(&pDev->sBuffer,zBuf,(sxu32)n);` |
|   1571 | 2751 | `			rc = PH7_OK;` |
|    783 | 2752 | `		}` |
|      - | 2753 | `	}` |
|      - | 2754 | `	/* EOF or not */` |
|   9061 | 2755 | `	ph7_result_bool(pCtx,rc == SXERR_EOF);` |
|   9061 | 2756 | `	return PH7_OK;` |
|   4533 | 2757 |  |
|      - | 2758 | `/*` |
...
|      - | 2802 | ` */` |
|   5634 | 2803 | `static sxi32 GetLine(io_private *pDev,ph7_int64 *pLen,const char **pzLine)` |
|      5 | 2804 |  |
|      - | 2805 | `	const char *zIn,*zEnd,*zPtr;` |
|   5639 | 2806 | `	zIn = (const char *)SyBlobDataAt(&pDev->sBuffer,pDev->nOfft);` |
|   5639 | 2807 | `	zEnd = &zIn[SyBlobLength(&pDev->sBuffer)-pDev->nOfft];` |
|   5639 | 2808 | `	zPtr = zIn;` |
| 361098 | 2809 | `	while( zIn < zEnd ){` |
| 361024 | 2810 | `		if( zIn[0] == '\n' ){` |
|      - | 2811 | `			/* Line found */` |
|   5565 | 2812 | `			zIn++; /* Include the line ending as requested by the PHP specification */` |
|   5565 | 2813 | `			*pLen = (ph7_int64)(zIn-zPtr);` |
|   5565 | 2814 | `			*pzLine = zPtr;` |
|   5565 | 2815 | `			return SXRET_OK;` |
|      - | 2816 | `		}` |
| 355464 | 2817 | `		zIn++;` |
|      5 | 2818 | `	}` |
...
|      - | 2824 | ` */` |
|   5638 | 2825 | `static ph7_int64 StreamReadLine(io_private *pDev,const char **pzData,ph7_int64 nMaxLen)` |
|      5 | 2826 |  |
|   5643 | 2827 | `	const ph7_io_stream *pStream = pDev->pStream;` |
|      - | 2828 | `	char zBuf[8192];` |
|      - | 2829 | `	ph7_int64 n;` |
|      - | 2830 | `	sxi32 rc;` |
|   5643 | 2831 | `	n = 0;` |
|   5643 | 2832 | `	if( pDev->nOfft >= SyBlobLength(&pDev->sBuffer) ){` |
...
|     30 | 2836 | `	}` |
|   5643 | 2837 | `	if( SyBlobLength(&pDev->sBuffer) > pDev->nOfft ){` |
|      - | 2838 | `		/* Check if there is a line */` |
|   5583 | 2839 | `		rc = GetLine(pDev,&n,pzData);` |
|   5583 | 2840 | `		if( rc == SXRET_OK ){` |
|      - | 2841 | `			/* Got line,update the cursor  */` |
|   5511 | 2842 | `			pDev->nOfft += (sxu32)n;` |
|   5511 | 2843 | `			return n;` |
|      - | 2844 | `		}` |
|     36 | 2845 | `	}` |
...
|      - | 2904 | ` */` |
|  29594 | 2905 | `PH7_PRIVATE void * PH7_StreamOpenHandle(ph7_vm *pVm,const ph7_io_stream *pStream,const char *zFile,` |
|      - | 2906 | `	int iFlags,int use_include,ph7_value *pResource,int bPushInclude,int *pNew)` |
|      5 | 2907 |  |
|  29599 | 2908 | `	void *pHandle = 0; /* cc warning */` |
|      - | 2909 | `	SyString sFile;` |
|      - | 2910 | `	int rc;` |
|  29599 | 2911 | `	if( pStream == 0 ){` |
|      - | 2912 | `		/* No such stream device */` |
|    ! 0 | 2913 | `		return 0;` |
|      - | 2914 | `	}` |
|  29599 | 2915 | `	SyStringInitFromBuf(&sFile,zFile,SyStrlen(zFile));` |
|  29599 | 2916 | `	if( use_include ){` |
...
|   9944 | 2948 | `					if( bPushInclude ){` |
|      - | 2949 | `						/* Mark as included */` |
|   9944 | 2950 | `						PH7_VmPushFilePath(pVm,(const char *)SyBlobData(&sWorker),SyBlobLength(&sWorker),FALSE,pNew);` |
|   4970 | 2951 | `					}` |
|   9944 | 2952 | `					break;` |
|      - | 2953 | `				}` |
...
|   9962 | 2961 | `			if( bPushInclude ){` |
|      - | 2962 | `				/* Mark as included */` |
|   9962 | 2963 | `				PH7_VmPushFilePath(pVm,sFile.zString,sFile.nByte,FALSE,pNew);` |
|   4979 | 2964 | `			}` |
|   4979 | 2965 | `		}` |
|   4986 | 2966 | `	}else{` |
|      - | 2967 | `		/* Open the URI direcly */` |
|  19635 | 2968 | `		rc = pStream->xOpen(zFile,iFlags,pResource,&pHandle);` |
|      - | 2969 | `	}` |
|  29599 | 2970 | `	if( rc != PH7_OK ){` |
|      - | 2971 | `		/* IO error */` |
|     16 | 2972 | `		return 0;` |
|      - | 2973 | `	}` |
|      - | 2974 | `	/* Return the file handle */` |
|  29587 | 2975 | `	return pHandle;` |
|  14802 | 2976 |  |
|      - | 2977 | `/*` |
...
|   9952 | 2988 | `	for(;;){` |
|  19908 | 2989 | `		nRead = pStream->xRead(pHandle,zBuf,sizeof(zBuf));` |
|  19908 | 2990 | `		if( nRead < 1 ){` |
|      - | 2991 | `			/* EOF or IO error */` |
|   9956 | 2992 | `			break;` |
|      - | 2993 | `		}` |
|      - | 2994 | `		/* Append contents */` |
|   9956 | 2995 | `		rc = SyBlobAppend(pOut,zBuf,(sxu32)nRead);` |
|   9956 | 2996 | `		if( rc != SXRET_OK ){` |
|    ! 0 | 2997 | `			break;` |
|      - | 2998 | `		}` |
|      4 | 2999 | `	}` |
|   9956 | 3000 | `	return SyBlobLength(pOut) > 0 ? SXRET_OK : -1;` |
|      4 | 3001 |  |
|      - | 3002 | `/*` |
|      - | 3003 | ` * Close an open IO stream handle [i.e local file/URI..].` |
|      - | 3004 | ` */` |
|  29674 | 3005 | `PH7_PRIVATE void PH7_StreamCloseHandle(const ph7_io_stream *pStream,void *pHandle)` |
|      5 | 3006 |  |
|  29679 | 3007 | `	if( pStream->xClose ){` |
|  29679 | 3008 | `		pStream->xClose(pHandle);` |
|  14837 | 3009 | `	}` |
|  29679 | 3010 |  |
|      - | 3011 | `/*` |
...
|      - | 3080 | ` */` |
|   5628 | 3081 | `static int PH7_builtin_fgets(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3082 |  |
|      - | 3083 | `	const ph7_io_stream *pStream;` |
|      - | 3084 | `	const char *zLine;` |
|      - | 3085 | `	io_private *pDev;` |
|      - | 3086 | `	ph7_int64 n,nLen;` |
|   5633 | 3087 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   5633 | 3094 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3095 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   5633 | 3096 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   5633 | 3103 | `	pStream = pDev->pStream;` |
|   5633 | 3104 | `	if( pStream == 0  ){` |
...
|   5633 | 3118 | `	n = StreamReadLine(pDev,&zLine,nLen);` |
|   5633 | 3119 | `	if( n < 1 ){` |
|      - | 3120 | `		/* EOF or IO error,return FALSE */` |
|      7 | 3121 | `		ph7_result_bool(pCtx,0);` |
|      6 | 3122 | `	}else{` |
|      - | 3123 | `		/* Return the freshly extracted line */` |
|   5631 | 3124 | `		ph7_result_string(pCtx,zLine,(int)n);` |
|      - | 3125 | `	}` |
|   5633 | 3126 | `	return PH7_OK;` |
|   2819 | 3127 |  |
|      - | 3128 | `/*` |
...
|      - | 3389 | ` */` |
|   7854 | 3390 | `static int PH7_builtin_readdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3391 |  |
|      - | 3392 | `	const ph7_io_stream *pStream;` |
|      - | 3393 | `	io_private *pDev;` |
|      - | 3394 | `	int rc;` |
|   7859 | 3395 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   7859 | 3402 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3403 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   7859 | 3404 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   7859 | 3411 | `	pStream = pDev->pStream;` |
|   7859 | 3412 | `	if( pStream == 0  \|\| pStream->xReadDir == 0 ){` |
...
|      - | 3419 | `	}` |
|   7859 | 3420 | `	ph7_result_bool(pCtx,0);` |
|      - | 3421 | `	/* Perform the requested operation */` |
|   7859 | 3422 | `	rc = pStream->xReadDir(pDev->pHandle,pCtx);` |
|   7859 | 3423 | `	if( rc != PH7_OK ){` |
|      - | 3424 | `		/* Return FALSE */` |
|    971 | 3425 | `		ph7_result_bool(pCtx,0);` |
|    483 | 3426 | `	}` |
|   7859 | 3427 | `	return PH7_OK;` |
|   3932 | 3428 |  |
|      - | 3429 | `/*` |
...
|      - | 3671 | ` */` |
|   5954 | 3672 | `static int PH7_builtin_file_get_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3673 |  |
|      - | 3674 | `	const ph7_io_stream *pStream;` |
|      - | 3675 | `	ph7_int64 n,nRead,nMaxlen;` |
|   5959 | 3676 | `	int use_include  = FALSE;` |
|      - | 3677 | `	const char *zFile;` |
|      - | 3678 | `	char zBuf[8192];` |
|      - | 3679 | `	void *pHandle;` |
|      - | 3680 | `	int nLen;` |
|      - | 3681 |  |
|   5959 | 3682 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   5959 | 3689 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3690 | `	/* Point to the target IO stream device */` |
|   5959 | 3691 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|   5959 | 3692 | `	if( pStream == 0 ){` |
...
|   5959 | 3702 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,PH7_IO_OPEN_RDONLY,use_include,nArg > 2 ? apArg[2] : 0,FALSE,0);` |
|   5959 | 3703 | `	if( pHandle == 0 ){` |
...
|   5959 | 3723 | `	nRead = 0;` |
|   5953 | 3724 | `	for(;;){` |
|  17867 | 3725 | `		n = pStream->xRead(pHandle,zBuf,` |
|   5956 | 3726 | `			(nMaxlen > 0 && (nMaxlen < (ph7_int64)sizeof(zBuf))) ? nMaxlen : (ph7_int64)sizeof(zBuf));` |
|  11911 | 3727 | `		if( n < 1 ){` |
|      - | 3728 | `			/* EOF or IO error,break immediately */` |
|   5957 | 3729 | `			break;` |
|      - | 3730 | `		}` |
|      - | 3731 | `		/* Append data */` |
|   5959 | 3732 | `		ph7_result_string(pCtx,zBuf,(int)n);` |
|      - | 3733 | `		/* Increment read counter */` |
|   5959 | 3734 | `		nRead += n;` |
|   5959 | 3735 | `		if( nMaxlen > 0 && nRead >= nMaxlen ){` |
|      - | 3736 | `			/* Read limit reached */` |
|      3 | 3737 | `			break;` |
|      - | 3738 | `		}` |
|      5 | 3739 | `	}` |
|      - | 3740 | `	/* Close the stream */` |
|   5959 | 3741 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|      - | 3742 | `	/* Check if we have read something */` |
|   5959 | 3743 | `	if( ph7_context_result_buf_length(pCtx) < 1 ){` |
|      - | 3744 | `		/* Nothing read,return FALSE */` |
|    ! 0 | 3745 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 3746 | `	}` |
|   5959 | 3747 | `	return PH7_OK;` |
|   2982 | 3748 |  |
|      - | 3749 | `/*` |
...
|      - | 3767 | ` */` |
|  13592 | 3768 | `static int PH7_builtin_file_put_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3769 |  |
|  13597 | 3770 | `	int use_include  = FALSE;` |
...
|      - | 3777 | `	int nLen;` |
|      - | 3778 |  |
|  13597 | 3779 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  13597 | 3786 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3787 | `	/* Point to the target IO stream device */` |
|  13597 | 3788 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|  13597 | 3789 | `	if( pStream == 0 ){` |
...
|      - | 3793 | `	}` |
|      - | 3794 | `	/* Data to write */` |
|  13597 | 3795 | `	zData = ph7_value_to_string(apArg[1],&nLen);` |
|      - | 3796 | `	/* Try to open the file in read-write mode */` |
|  13597 | 3797 | `	iOpenFlags = PH7_IO_OPEN_CREATE\|PH7_IO_OPEN_RDWR\|PH7_IO_OPEN_TRUNC;` |
|      - | 3798 | `	/* Extract the flags */` |
|  13597 | 3799 | `	iFlags = 0;` |
|  13597 | 3800 | `	if( nArg > 2 ){` |
...
|    ! 0 | 3812 | `		}` |
|    ! 0 | 3813 | `	}` |
|  20393 | 3814 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,iOpenFlags,use_include,` |
|   6796 | 3815 | `		nArg > 3 ? apArg[3] : 0,FALSE,FALSE);` |
|  13597 | 3816 | `	if( pHandle == 0 ){` |
...
|  13591 | 3851 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|  13591 | 3852 | `	return PH7_OK;` |
|   6801 | 3853 |  |
|      - | 3854 | `/*` |
...
|      - | 4728 | ` */` |
|   4598 | 4729 | `static void InitIOPrivate(ph7_vm *pVm,const ph7_io_stream *pStream,io_private *pOut)` |
|      5 | 4730 |  |
|   4603 | 4731 | `	pOut->pStream = pStream;` |
|   4603 | 4732 | `	SyBlobInit(&pOut->sBuffer,&pVm->sAllocator);` |
|   4603 | 4733 | `	pOut->nOfft = 0;` |
|      - | 4734 | `	/* Set the magic number */` |
|   4603 | 4735 | `	pOut->iMagic = IO_PRIVATE_MAGIC;` |
|   4603 | 4736 |  |
|      - | 4737 | `/*` |
|      - | 4738 | ` * Release the IO private structure.` |
|      - | 4739 | ` */` |
|   4566 | 4740 | `static void ReleaseIOPrivate(ph7_context *pCtx,io_private *pDev)` |
|      5 | 4741 |  |
|   4571 | 4742 | `	SyBlobRelease(&pDev->sBuffer);` |
|   4571 | 4743 | `	pDev->iMagic = 0x2126; /* Invalid magic number so we can detetct misuse */` |
|      - | 4744 | `	/* Release the whole structure */` |
|   4571 | 4745 | `	ph7_context_free_chunk(pCtx,pDev);` |
|   4571 | 4746 |  |
|      - | 4747 | `/*` |
...
|      - | 5176 | ` */` |
|   3496 | 5177 | `PH7_PRIVATE const ph7_vfs * PH7_ExportBuiltinVfs(void)` |
|      5 | 5178 |  |
...
|      - | 5596 | ` */` |
|   3556 | 5597 | `static pipe_private * PipeOpen(ph7_vm *pVm, const char *zCommand, const char *zMode)` |
|      5 | 5598 |  |
|      - | 5599 | `	pipe_private *pPipe;` |
|      - | 5600 | `	FILE *pFile;` |
|   3561 | 5601 | `	if( pVm == 0 \|\| zCommand == 0 \|\| zMode == 0 ){` |
|    ! 0 | 5602 | `		return 0;` |
|      - | 5603 | `	}` |
|      - | 5604 | `	/* Validate mode - only 'r' or 'w' allowed */` |
|   3561 | 5605 | `	if( zMode[0] != 'r' && zMode[0] != 'w' ){` |
|    ! 0 | 5606 | `		return 0;` |
|      - | 5607 | `	}` |
...
|   3556 | 5669 | `	pFile = popen(zCommand, zMode);` |
|   3556 | 5670 | `	if( pFile == 0 ){` |
|    ! 0 | 5671 | `		return 0;` |
|      - | 5672 | `	}` |
|      - | 5673 | `	/* Allocate pipe private structure */` |
|   3556 | 5674 | `	pPipe = (pipe_private *)SyMemBackendAlloc(&pVm->sAllocator, sizeof(pipe_private));` |
|   3556 | 5675 | `	if( pPipe == 0 ){` |
|      - | 5676 | `		/* Out of memory, close the pipe */` |
|    ! 0 | 5677 | `		pclose(pFile);` |
|    ! 0 | 5678 | `		return 0;` |
|      - | 5679 | `	}` |
|      - | 5680 | `	/* Initialize the structure */` |
|   3556 | 5681 | `	pPipe->pFile = pFile;` |
|   3556 | 5682 | `	pPipe->pVm = pVm;` |
|   3556 | 5683 | `	pPipe->iMode = zMode[0];` |
|      - | 5684 | `#else /* OS_OTHER: no process pipes on this platform */` |
|      - | 5685 | `	(void)pFile;` |
|      - | 5686 | `	return 0;` |
|      - | 5687 | `#endif` |
|   3561 | 5688 | `	return pPipe;` |
|   1783 | 5689 |  |
|      - | 5690 | `/*` |
|      - | 5691 | ` * Close a pipe and return the exit status of the process.` |
|      - | 5692 | ` * Returns the exit status, or -1 on error.` |
|      - | 5693 | ` */` |
|   3534 | 5694 | `static int PipeClose(pipe_private *pPipe)` |
|      5 | 5695 |  |
|      - | 5696 | `	int status;` |
|      - | 5697 | `	ph7_vm *pVm;` |
|   3539 | 5698 | `	if( pPipe == 0 \|\| pPipe->pFile == 0 ){` |
|    ! 0 | 5699 | `		return -1;` |
|      - | 5700 | `	}` |
|   3539 | 5701 | `	pVm = pPipe->pVm;` |
...
|   3534 | 5707 | `	status = pclose(pPipe->pFile);` |
|      - | 5708 | `	/* On Unix, pclose returns the status from waitpid, need to extract exit code */` |
|   3534 | 5709 | `	if( status != -1 ){` |
|   3534 | 5710 | `		if( WIFEXITED(status) ){` |
|   3534 | 5711 | `			status = WEXITSTATUS(status);` |
|   1767 | 5712 | `		}else if( WIFSIGNALED(status) ){` |
...
|   3539 | 5724 | `	SyMemBackendFree(&pVm->sAllocator, pPipe);` |
|   3539 | 5725 | `	return status;` |
|   1772 | 5726 |  |
|      - | 5727 | `/*` |
...
|      - | 5741 | ` */` |
|   5160 | 5742 | `static ph7_int64 PipeStream_Read(void *pHandle, void *pBuffer, ph7_int64 nDatatoRead)` |
|      4 | 5743 |  |
|   5164 | 5744 | `	pipe_private *pPipe = (pipe_private *)pHandle;` |
|      - | 5745 | `	size_t nRead;` |
|   5164 | 5746 | `	if( pPipe == 0 \|\| pPipe->pFile == 0 ){` |
|    ! 0 | 5747 | `		return -1;` |
|      - | 5748 | `	}` |
|   5164 | 5749 | `	if( pPipe->iMode != 'r' ){` |
|      - | 5750 | `		/* Cannot read from a write-only pipe */` |
|    ! 0 | 5751 | `		return -1;` |
|      - | 5752 | `	}` |
|   5164 | 5753 | `	nRead = fread(pBuffer, 1, (size_t)nDatatoRead, pPipe->pFile);` |
|   5164 | 5754 | `	if( nRead == 0 ){` |
|   3550 | 5755 | `		if( feof(pPipe->pFile) ){` |
|   3550 | 5756 | `			return 0; /* EOF */` |
|      - | 5757 | `		}` |
|    ! 0 | 5758 | `		return -1; /* Error */` |
|      - | 5759 | `	}` |
|   1618 | 5760 | `	return (ph7_int64)nRead;` |
|   2584 | 5761 |  |
|      - | 5762 | `/*` |
...
|      - | 5804 | ` */` |
|   3440 | 5805 | `static int is_pipe_stream(const ph7_io_stream *pStream)` |
|      5 | 5806 |  |
|   3445 | 5807 | `	return pStream == &sPipe_Stream;` |
|      5 | 5808 |  |
|      - | 5809 | `/*` |
...
|      - | 5821 | ` */` |
|   3556 | 5822 | `static int PH7_builtin_popen(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 5823 |  |
|      - | 5824 | `	const char *zCommand, *zMode;` |
|      - | 5825 | `	pipe_private *pPipe;` |
|      - | 5826 | `	io_private *pDev;` |
|      - | 5827 | `	int nCmdLen, nModeLen;` |
|   3561 | 5828 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) \|\| !ph7_value_is_string(apArg[1]) ){` |
...
|   3561 | 5835 | `	zCommand = ph7_value_to_string(apArg[0], &nCmdLen);` |
|   3561 | 5836 | `	zMode = ph7_value_to_string(apArg[1], &nModeLen);` |
|   3561 | 5837 | `	if( nCmdLen < 1 ){` |
|    ! 0 | 5838 | `		ph7_context_throw_error(pCtx, PH7_CTX_WARNING, "Empty command");` |
|    ! 0 | 5839 | `		ph7_result_bool(pCtx, 0);` |
|    ! 0 | 5840 | `		return PH7_OK;` |
|      - | 5841 | `	}` |
|   3561 | 5842 | `	if( nModeLen < 1 \|\| (zMode[0] != 'r' && zMode[0] != 'w') ){` |
...
|      - | 5846 | `	}` |
|      - | 5847 | `	/* Open the pipe */` |
|   3561 | 5848 | `	pPipe = PipeOpen(pCtx->pVm, zCommand, zMode);` |
|   3561 | 5849 | `	if( pPipe == 0 ){` |
...
|   3561 | 5855 | `	pDev = (io_private *)ph7_context_alloc_chunk(pCtx, sizeof(io_private), TRUE, FALSE);` |
|   3561 | 5856 | `	if( pDev == 0 ){` |
...
|   3561 | 5863 | `	InitIOPrivate(pCtx->pVm, &sPipe_Stream, pDev);` |
|   3561 | 5864 | `	pDev->pHandle = pPipe;` |
|      - | 5865 | `	/* Return the io_private instance as a resource */` |
|   3561 | 5866 | `	ph7_result_resource(pCtx, pDev);` |
|   3561 | 5867 | `	return PH7_OK;` |
|   1783 | 5868 |  |
|      - | 5869 | `/*` |
...
|      - | 5877 | ` */` |
|   3440 | 5878 | `static int PH7_builtin_pclose(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 5879 |  |
|      - | 5880 | `	const ph7_io_stream *pStream;` |
|      - | 5881 | `	pipe_private *pPipe;` |
|      - | 5882 | `	io_private *pDev;` |
|      - | 5883 | `	int status;` |
|   3445 | 5884 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   3445 | 5891 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 5892 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   3445 | 5893 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   3445 | 5899 | `	pStream = pDev->pStream;` |
|   3445 | 5900 | `	if( pStream == 0 \|\| !is_pipe_stream(pStream) ){` |
...
|   3445 | 5906 | `	pPipe = (pipe_private *)pDev->pHandle;` |
|      - | 5907 | `	/* Close the pipe and get exit status */` |
|   3445 | 5908 | `	status = PipeClose(pPipe);` |
|      - | 5909 | `	/* Release the IO private structure */` |
|   3445 | 5910 | `	ReleaseIOPrivate(pCtx, pDev);` |
|      - | 5911 | `	/* Invalidate the resource handle */` |
|   3445 | 5912 | `	ph7_value_release(apArg[0]);` |
|      - | 5913 | `	/* Return the exit status */` |
|   3445 | 5914 | `	ph7_result_int(pCtx, status);` |
|   3445 | 5915 | `	return PH7_OK;` |
|   1725 | 5916 |  |
...
|      - | 5958 | ` */` |
|   3122 | 5959 | `PH7_PRIVATE sxi32 PH7_RegisterIORoutine(ph7_vm *pVm)` |
|      5 | 5960 |  |
|      - | 5961 | `	/*` |
...
|      - | 6058 | `	};` |
|   3127 | 6059 | `	const ph7_io_stream *pFileStream = 0;` |
|   3127 | 6060 | `	sxu32 n = 0;` |
|      - | 6061 | `	/* Register disk-related functions */` |
| 152983 | 6062 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVfsDiskFunc) ; ++n ){` |
| 149861 | 6063 | `		ph7_create_function(&(*pVm),aVfsDiskFunc[n].zName,aVfsDiskFunc[n].xFunc,(void *)pVm->pEngine->pVfs);` |
|  74933 | 6064 | `	}` |
| 112397 | 6065 | `	for( n = 0 ; n < SX_ARRAYSIZE(aIOFunc) ; ++n ){` |
| 109275 | 6066 | `		ph7_create_function(&(*pVm),aIOFunc[n].zName,aIOFunc[n].xFunc,pVm);` |
|  54640 | 6067 | `	}` |
|      - | 6068 | `#else` |
|      - | 6069 | `	SXUNUSED(pVm);` |
...
|      - | 6096 | `	};` |
|  53079 | 6097 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVfsHelperFunc) ; ++n ){` |
|  49957 | 6098 | `		ph7_create_function(&(*pVm),aVfsHelperFunc[n].zName,aVfsHelperFunc[n].xFunc,pVm);` |
|  24981 | 6099 | `	}` |
...
|   3122 | 6107 | `	pFileStream = &sUnixFileStream;` |
|      - | 6108 | `#endif` |
|      - | 6109 | `	/* Install the php:// stream */` |
|   3127 | 6110 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,&sPHP_Stream);` |
|   3127 | 6111 | `	if( pFileStream ){` |
|      - | 6112 | `		/* Install the file:// stream */` |
|   3127 | 6113 | `		ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,pFileStream);` |
|   1561 | 6114 | `	}` |
|      - | 6115 | `#endif /* PH7_DISABLE_DISK_IO */` |
|      - | 6116 |  |
|   3127 | 6117 | `	return SXRET_OK;` |
|      5 | 6118 |  |
|      - | 6119 | `/*` |
