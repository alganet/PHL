...
|      - |   67 | ` */` |
|  20030 |   68 | `static const char * VfsStrerror(int iErr)` |
|      5 |   69 | `{` |
|      - |   70 | `#if defined(_MSC_VER)` |
|      - |   71 | `#pragma warning(push)` |
|      - |   72 | `#pragma warning(disable:4996)` |
|      - |   73 | `#endif` |
|  20035 |   74 | `	return strerror(iErr);` |
...
|      - |   84 | ` */` |
|  20008 |   85 | `static void VfsThrowSysWarning(ph7_context *pCtx,const char *zPath)` |
|      5 |   86 | `{` |
|  30017 |   87 | `	PH7_VmThrowWarningFmt(pCtx->pVm,"%s(%s): %s",` |
|  20008 |   88 | `		ph7_function_name(pCtx),zPath ? zPath : "",VfsStrerror(errno));` |
|  20013 |   89 | `}` |
...
|      - |  103 | ` */` |
|  13462 |  104 | `static int PH7_vfs_chdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  105 | `{` |
|      - |  106 | `	const char *zPath;` |
|      - |  107 | `	ph7_vfs *pVfs;` |
|      - |  108 | `	int rc;` |
|  13467 |  109 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  110 | `		/* Missing/Invalid argument,return FALSE */` |
|      6 |  111 | `		ph7_result_bool(pCtx,0);` |
|      6 |  112 | `		return PH7_OK;` |
|      - |  113 | `	}` |
|      - |  114 | `	/* Point to the underlying vfs */` |
|  13463 |  115 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  13463 |  116 | `	if( pVfs == 0 \|\| pVfs->xChdir == 0 ){` |
...
|  13463 |  126 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  127 | `	/* Perform the requested operation */` |
|  13463 |  128 | `	errno = 0;` |
|  13463 |  129 | `	rc = pVfs->xChdir(zPath);` |
|  13463 |  130 | `	if( rc != PH7_OK ){` |
...
|      1 |  134 | `	}` |
|      - |  135 | `	/* IO return value */` |
|  13463 |  136 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  13463 |  137 | `	return PH7_OK;` |
|   6736 |  138 | `}` |
|      - |  139 | `/*` |
...
|      - |  261 | ` */` |
|   8838 |  262 | `static int PH7_vfs_is_dir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  263 | `{` |
|      - |  264 | `	const char *zPath;` |
|      - |  265 | `	ph7_vfs *pVfs;` |
|      - |  266 | `	int rc;` |
|   8843 |  267 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  268 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  269 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  270 | `		return PH7_OK;` |
|      - |  271 | `	}` |
|      - |  272 | `	/* Point to the underlying vfs */` |
|   8843 |  273 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   8843 |  274 | `	if( pVfs == 0 \|\| pVfs->xIsdir == 0 ){` |
...
|   8843 |  284 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  285 | `	/* Perform the requested operation */` |
|   8843 |  286 | `	rc = pVfs->xIsdir(zPath);` |
|      - |  287 | `	/* IO return value */` |
|   8843 |  288 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   8843 |  289 | `	return PH7_OK;` |
|   4424 |  290 | `}` |
|      - |  291 | `/*` |
...
|      - |  536 | ` */` |
|  33744 |  537 | `static int PH7_vfs_unlink(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  538 | `{` |
|      - |  539 | `	const char *zPath;` |
|      - |  540 | `	ph7_vfs *pVfs;` |
|      - |  541 | `	int rc;` |
|  33749 |  542 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  543 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  544 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  545 | `		return PH7_OK;` |
|      - |  546 | `	}` |
|      - |  547 | `	/* Point to the underlying vfs */` |
|  33749 |  548 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  33749 |  549 | `	if( pVfs == 0 \|\| pVfs->xUnlink == 0 ){` |
...
|  33749 |  559 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  560 | `	/* Perform the requested operation */` |
|  33749 |  561 | `	errno = 0;` |
|  33749 |  562 | `	rc = pVfs->xUnlink(zPath);` |
|  33749 |  563 | `	if( rc != PH7_OK ){` |
|  20007 |  564 | `		VfsThrowSysWarning(pCtx,zPath);` |
|  10001 |  565 | `	}` |
|      - |  566 | `	/* IO return value */` |
|  33749 |  567 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  33749 |  568 | `	return PH7_OK;` |
|  16877 |  569 | `}` |
|      - |  570 | `/*` |
...
|      - | 1005 | ` */` |
|   6770 | 1006 | `static int PH7_vfs_is_file(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1007 | `{` |
|      - | 1008 | `	const char *zPath;` |
|      - | 1009 | `	ph7_vfs *pVfs;` |
|      - | 1010 | `	int rc;` |
|   6775 | 1011 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   6775 | 1017 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   6775 | 1018 | `	if( pVfs == 0 \|\| pVfs->xIsfile == 0 ){` |
...
|   6775 | 1028 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - | 1029 | `	/* Perform the requested operation */` |
|   6775 | 1030 | `	rc = pVfs->xIsfile(zPath);` |
|      - | 1031 | `	/* IO return value */` |
|   6775 | 1032 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   6775 | 1033 | `	return PH7_OK;` |
|   3390 | 1034 | `}` |
|      - | 1035 | `/*` |
...
|      - | 1658 | ` */` |
|  13418 | 1659 | `static sxi32 ExtractPathInfo(const char *zPath,int nByte,path_info *pOut)` |
|      5 | 1660 | `{` |
|  13423 | 1661 | `	const char *zPtr,*zEnd = &zPath[nByte - 1];` |
|      - | 1662 | `	SyString *pCur;` |
|      - | 1663 | `	int c,d;` |
|  13423 | 1664 | `	c = d = '/';` |
...
|  13423 | 1669 | `	SyZero(pOut,sizeof(path_info));` |
|      - | 1670 | `	/* Handle special case */` |
|  13423 | 1671 | `	if( nByte == sizeof(char) && ( (int)zPath[0] == c \|\| (int)zPath[0] == d ) ){` |
...
| 362148 | 1680 | `	while( zEnd > zPath && ( (int)zEnd[0] != c && (int)zEnd[0] != d ) ){` |
| 342021 | 1681 | `		zEnd--;` |
|      5 | 1682 | `	}` |
|  13423 | 1683 | `	zPtr = (zEnd > zPath) ? &zEnd[1] : zPath;` |
|  13423 | 1684 | `	zEnd = &zPath[nByte];` |
|      - | 1685 | `	/* dirname */` |
|  13423 | 1686 | `	pCur = &pOut->sDir;` |
|  13423 | 1687 | `	SyStringInitFromBuf(pCur,zPath,zPtr-zPath);` |
|  13423 | 1688 | `	if( pCur->nByte > 1 ){` |
|  26841 | 1689 | `		SyStringTrimTrailingChar(pCur,'/');` |
|      - | 1690 | `#ifdef __WINNT__` |
|      5 | 1691 | `		SyStringTrimTrailingChar(pCur,'\\');` |
|      - | 1692 | `#endif` |
|   6714 | 1693 | `	}else if( (int)zPath[0] == c \|\| (int)zPath[0] == d ){` |
...
|  13423 | 1701 | `	pCur = &pOut->sBasename;` |
|  13423 | 1702 | `	SyStringInitFromBuf(pCur,zPtr,zEnd-zPtr);` |
|  13423 | 1703 | `	SyStringTrimLeadingChar(pCur,'/');` |
|      - | 1704 | `#ifdef __WINNT__` |
|      5 | 1705 | `	SyStringTrimLeadingChar(pCur,'\\');` |
|      - | 1706 | `#endif` |
|  13423 | 1707 | `	SyStringDupPtr(&pOut->sFilename,pCur);` |
|  13423 | 1708 | `	if( pCur->nByte > 0 ){` |
|      - | 1709 | `		/* extension */` |
|  13423 | 1710 | `		zEnd--;` |
|  67089 | 1711 | `		while( zEnd > pCur->zString /*basename*/ && zEnd[0] != '.' ){` |
|  53671 | 1712 | `			zEnd--;` |
|      5 | 1713 | `		}` |
|  13423 | 1714 | `		if( zEnd > pCur->zString ){` |
|  13421 | 1715 | `			zEnd++; /* Jump leading dot */` |
|  13421 | 1716 | `			SyStringInitFromBuf(&pOut->sExtension,zEnd,&zPath[nByte]-zEnd);` |
|      - | 1717 | `			/* Fix filename */` |
|  13421 | 1718 | `			pCur = &pOut->sFilename;` |
|  13421 | 1719 | `			if( pCur->nByte > SyStringLength(&pOut->sExtension) ){` |
|  13421 | 1720 | `				pCur->nByte -= 1 + SyStringLength(&pOut->sExtension);` |
|   6708 | 1721 | `			}` |
|   6708 | 1722 | `		}` |
|   6709 | 1723 | `	}` |
|  13423 | 1724 | `	return SXRET_OK;` |
|   6714 | 1725 | `}` |
|      - | 1726 | `/*` |
...
|      - | 1729 | ` */` |
|  13418 | 1730 | `static int PH7_builtin_pathinfo(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1731 | `{` |
|      - | 1732 | `	const char *zPath;` |
|      - | 1733 | `	path_info sInfo;` |
|      - | 1734 | `	SyString *pComp;` |
|      - | 1735 | `	int iLen;` |
|  13423 | 1736 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  13423 | 1742 | `	zPath = ph7_value_to_string(apArg[0],&iLen);` |
|  13423 | 1743 | `	if( iLen < 1 ){` |
|      - | 1744 | `		/* Empty string */` |
|    ! 0 | 1745 | `		ph7_result_string(pCtx,"",0);` |
|    ! 0 | 1746 | `		return PH7_OK;` |
|      - | 1747 | `	}` |
|      - | 1748 | `	/* Extract path info */` |
|  13423 | 1749 | `	ExtractPathInfo(zPath,iLen,&sInfo);` |
|  20131 | 1750 | `	if( nArg > 1 && ph7_value_is_int(apArg[1]) ){` |
|      - | 1751 | `		/* Return path component */` |
|  13421 | 1752 | `		int nComp = ph7_value_to_int(apArg[1]);` |
|  13421 | 1753 | `		switch(nComp){` |
...
|      - | 1770 | `			}` |
|      3 | 1771 | `			break;` |
|   3355 | 1772 | `		case 3: /*PATHINFO_EXTENSION*/` |
|   6715 | 1773 | `			pComp = &sInfo.sExtension;` |
|   6715 | 1774 | `			if( pComp->nByte > 0 ){` |
|   6713 | 1775 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   3359 | 1776 | `			}else{` |
|      - | 1777 | `				/* Expand the empty string */` |
|      3 | 1778 | `				ph7_result_string(pCtx,"",0);` |
|      - | 1779 | `			}` |
|   6715 | 1780 | `			break;` |
|   3351 | 1781 | `		case 4: /*PATHINFO_FILENAME*/` |
|   6707 | 1782 | `			pComp = &sInfo.sFilename;` |
|   6707 | 1783 | `			if( pComp->nByte > 0 ){` |
|   6707 | 1784 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   3356 | 1785 | `			}else{` |
...
|      - | 2847 | ` */` |
|  10634 | 2848 | `static int PH7_builtin_feof(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2849 | `{` |
|      - | 2850 | `	const ph7_io_stream *pStream;` |
|      - | 2851 | `	io_private *pDev;` |
|      - | 2852 | `	int rc;` |
|  10639 | 2853 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|  10639 | 2860 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 2861 | `	/* Make sure we are dealing with a valid io_private instance */` |
|  10639 | 2862 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|  10639 | 2869 | `	pStream = pDev->pStream;` |
|  10639 | 2870 | `	if( pStream == 0 ){` |
...
|      - | 2877 | `	}` |
|  10639 | 2878 | `	rc = SXERR_EOF;` |
|      - | 2879 | `	/* Perform the requested operation */` |
|  10639 | 2880 | `	if( SyBlobLength(&pDev->sBuffer) > pDev->nOfft ){` |
...
|   5775 | 2887 | `		n = pStream->xRead(pDev->pHandle,zBuf,sizeof(zBuf));` |
|   5775 | 2888 | `		if( n > 0 ){` |
|      - | 2889 | `			/* Copy buffered data */` |
|   1887 | 2890 | `			SyBlobAppend(&pDev->sBuffer,zBuf,(sxu32)n);` |
|   1887 | 2891 | `			rc = PH7_OK;` |
|    941 | 2892 | `		}` |
|      - | 2893 | `	}` |
|      - | 2894 | `	/* EOF or not */` |
|  10639 | 2895 | `	ph7_result_bool(pCtx,rc == SXERR_EOF);` |
|  10639 | 2896 | `	return PH7_OK;` |
|   5322 | 2897 | `}` |
|      - | 2898 | `/*` |
...
|      - | 2942 | ` */` |
|   6812 | 2943 | `static sxi32 GetLine(io_private *pDev,ph7_int64 *pLen,const char **pzLine)` |
|      5 | 2944 | `{` |
|      - | 2945 | `	const char *zIn,*zEnd,*zPtr;` |
|   6817 | 2946 | `	zIn = (const char *)SyBlobDataAt(&pDev->sBuffer,pDev->nOfft);` |
|   6817 | 2947 | `	zEnd = &zIn[SyBlobLength(&pDev->sBuffer)-pDev->nOfft];` |
|   6817 | 2948 | `	zPtr = zIn;` |
| 458238 | 2949 | `	while( zIn < zEnd ){` |
| 458132 | 2950 | `		if( zIn[0] == '\n' ){` |
|      - | 2951 | `			/* Line found */` |
...
|      - | 2964 | ` */` |
|   6816 | 2965 | `static ph7_int64 StreamReadLine(io_private *pDev,const char **pzData,ph7_int64 nMaxLen)` |
|      5 | 2966 | `{` |
|   6821 | 2967 | `	const ph7_io_stream *pStream = pDev->pStream;` |
|      - | 2968 | `	char zBuf[8192];` |
|      - | 2969 | `	ph7_int64 n;` |
|      - | 2970 | `	sxi32 rc;` |
|   6821 | 2971 | `	n = 0;` |
|   6821 | 2972 | `	if( pDev->nOfft >= SyBlobLength(&pDev->sBuffer) ){` |
...
|     34 | 2976 | `	}` |
|   6787 | 2977 | `	if( SyBlobLength(&pDev->sBuffer) > pDev->nOfft ){` |
|      - | 2978 | `		/* Check if there is a line */` |
|   6753 | 2979 | `		rc = GetLine(pDev,&n,pzData);` |
|   6753 | 2980 | `		if( rc == SXRET_OK ){` |
...
|      - | 3044 | ` */` |
|  30430 | 3045 | `PH7_PRIVATE void * PH7_StreamOpenHandle(ph7_vm *pVm,const ph7_io_stream *pStream,const char *zFile,` |
|      - | 3046 | `	int iFlags,int use_include,ph7_value *pResource,int bPushInclude,int *pNew)` |
|      5 | 3047 | `{` |
|  30435 | 3048 | `	void *pHandle = 0; /* cc warning */` |
|      - | 3049 | `	SyString sFile;` |
|      - | 3050 | `	ph7_value sDummy;` |
|      - | 3051 | `	int rc;` |
|  30435 | 3052 | `	if( pStream == 0 ){` |
|      - | 3053 | `		/* No such stream device */` |
|    ! 0 | 3054 | `		return 0;` |
|      - | 3055 | `	}` |
|  30435 | 3056 | `	if( pResource == 0 ){` |
...
|  30413 | 3062 | `		PH7_MemObjInit(pVm,&sDummy);` |
|  30413 | 3063 | `		pResource = &sDummy;` |
|  15204 | 3064 | `	}` |
|  30435 | 3065 | `	SyStringInitFromBuf(&sFile,zFile,SyStrlen(zFile));` |
|  30435 | 3066 | `	if( use_include ){` |
...
|  20739 | 3116 | `		rc = pStream->xOpen(zFile,iFlags,pResource,&pHandle);` |
|      - | 3117 | `	}` |
|  30435 | 3118 | `	if( rc != PH7_OK ){` |
|      - | 3119 | `		/* IO error */` |
|     24 | 3120 | `		return 0;` |
|      - | 3121 | `	}` |
|      - | 3122 | `	/* Return the file handle */` |
|  30415 | 3123 | `	return pHandle;` |
|  15220 | 3124 | `}` |
|      - | 3125 | `/*` |
...
|      - | 3152 | ` */` |
|  30538 | 3153 | `PH7_PRIVATE void PH7_StreamCloseHandle(const ph7_io_stream *pStream,void *pHandle)` |
|      5 | 3154 | `{` |
|  30543 | 3155 | `	if( pStream->xClose ){` |
|  30543 | 3156 | `		pStream->xClose(pHandle);` |
|  15269 | 3157 | `	}` |
|  30543 | 3158 | `}` |
|      - | 3159 | `/*` |
...
|      - | 3228 | ` */` |
|   6806 | 3229 | `static int PH7_builtin_fgets(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3230 | `{` |
|      - | 3231 | `	const ph7_io_stream *pStream;` |
|      - | 3232 | `	const char *zLine;` |
|      - | 3233 | `	io_private *pDev;` |
|      - | 3234 | `	ph7_int64 n,nLen;` |
|   6811 | 3235 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   6811 | 3242 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3243 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   6811 | 3244 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   6811 | 3251 | `	pStream = pDev->pStream;` |
|   6811 | 3252 | `	if( pStream == 0  ){` |
...
|   6811 | 3266 | `	n = StreamReadLine(pDev,&zLine,nLen);` |
|   6811 | 3267 | `	if( n < 1 ){` |
|      - | 3268 | `		/* EOF or IO error,return FALSE */` |
|      7 | 3269 | `		ph7_result_bool(pCtx,0);` |
|      6 | 3270 | `	}else{` |
|      - | 3271 | `		/* Return the freshly extracted line */` |
|   6809 | 3272 | `		ph7_result_string(pCtx,zLine,(int)n);` |
|      - | 3273 | `	}` |
|   6811 | 3274 | `	return PH7_OK;` |
|   3408 | 3275 | `}` |
|      - | 3276 | `/*` |
...
|      - | 3537 | ` */` |
|  11004 | 3538 | `static int PH7_builtin_readdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3539 | `{` |
|      - | 3540 | `	const ph7_io_stream *pStream;` |
|      - | 3541 | `	io_private *pDev;` |
|      - | 3542 | `	int rc;` |
|  11009 | 3543 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|  11009 | 3550 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3551 | `	/* Make sure we are dealing with a valid io_private instance */` |
|  11009 | 3552 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|  11009 | 3559 | `	pStream = pDev->pStream;` |
|  11009 | 3560 | `	if( pStream == 0  \|\| pStream->xReadDir == 0 ){` |
...
|      - | 3567 | `	}` |
|  11009 | 3568 | `	ph7_result_bool(pCtx,0);` |
|      - | 3569 | `	/* Perform the requested operation */` |
|  11009 | 3570 | `	rc = pStream->xReadDir(pDev->pHandle,pCtx);` |
|  11009 | 3571 | `	if( rc != PH7_OK ){` |
|      - | 3572 | `		/* Return FALSE */` |
|   1069 | 3573 | `		ph7_result_bool(pCtx,0);` |
|    532 | 3574 | `	}` |
|  11009 | 3575 | `	return PH7_OK;` |
|   5507 | 3576 | `}` |
|      - | 3577 | `/*` |
...
|      - | 3631 | ` */` |
|   1068 | 3632 | `static int PH7_builtin_closedir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3633 | `{` |
|      - | 3634 | `	const ph7_io_stream *pStream;` |
|      - | 3635 | `	io_private *pDev;` |
|   1073 | 3636 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   1073 | 3643 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3644 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   1073 | 3645 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   1073 | 3652 | `	pStream = pDev->pStream;` |
|   1073 | 3653 | `	if( pStream == 0  \|\| pStream->xCloseDir == 0 ){` |
...
|   1073 | 3662 | `	pStream->xCloseDir(pDev->pHandle);` |
|      - | 3663 | `	/* Keep the handle alive but flag it closed (php: gettype()=='resource (closed)') */` |
|   1073 | 3664 | `	MarkIOPrivateClosed(pDev);` |
|   1073 | 3665 | `	return PH7_OK;` |
|    539 | 3666 | ` }` |
|      - | 3667 | `/*` |
...
|      - | 3677 | ` */` |
|   1068 | 3678 | `static int PH7_builtin_opendir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3679 | `{` |
|      - | 3680 | `	const ph7_io_stream *pStream;` |
|      - | 3681 | `	const char *zPath;` |
|      - | 3682 | `	io_private *pDev;` |
|      - | 3683 | `	int iLen,rc;` |
|   1073 | 3684 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   1073 | 3691 | `	zPath  = ph7_value_to_string(apArg[0],&iLen);` |
|      - | 3692 | `	/* Try to extract a stream */` |
|   1073 | 3693 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zPath,iLen);` |
|   1073 | 3694 | `	if( pStream == 0 ){` |
...
|      - | 3699 | `	}` |
|   1073 | 3700 | `	if( pStream->xOpenDir == 0 ){` |
...
|   1073 | 3709 | `	pDev = (io_private *)ph7_context_alloc_chunk(pCtx,sizeof(io_private),TRUE,FALSE);` |
|   1073 | 3710 | `	if( pDev == 0 ){` |
...
|   1073 | 3716 | `	InitIOPrivate(pCtx->pVm,pStream,pDev);` |
|      - | 3717 | `	/* Open the target directory */` |
|   1073 | 3718 | `	rc = pStream->xOpenDir(zPath,nArg > 1 ? apArg[1] : 0,&pDev->pHandle);` |
|   1073 | 3719 | `	if( rc != PH7_OK ){` |
...
|   1073 | 3725 | `		ph7_result_resource(pCtx,pDev);` |
|      - | 3726 | `	}` |
|   1073 | 3727 | `	return PH7_OK;` |
|    539 | 3728 | `}` |
|      - | 3729 | `/*` |
...
|      - | 3827 | ` */` |
|   6762 | 3828 | `static int PH7_builtin_file_get_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3829 | `{` |
|      - | 3830 | `	const ph7_io_stream *pStream;` |
|      - | 3831 | `	ph7_int64 n,nRead,nMaxlen;` |
|   6767 | 3832 | `	int use_include  = FALSE;` |
|      - | 3833 | `	const char *zFile;` |
|      - | 3834 | `	char zBuf[8192];` |
|      - | 3835 | `	void *pHandle;` |
|      - | 3836 | `	int nLen;` |
|      - | 3837 |  |
|   6767 | 3838 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   6767 | 3845 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3846 | `	/* Point to the target IO stream device */` |
|   6767 | 3847 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|   6767 | 3848 | `	if( pStream == 0 ){` |
...
|   6767 | 3858 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,PH7_IO_OPEN_RDONLY,use_include,nArg > 2 ? apArg[2] : 0,FALSE,0);` |
|   6767 | 3859 | `	if( pHandle == 0 ){` |
...
|   6765 | 3879 | `	nRead = 0;` |
|   6757 | 3880 | `	for(;;){` |
|  20279 | 3881 | `		n = pStream->xRead(pHandle,zBuf,` |
|   6760 | 3882 | `			(nMaxlen > 0 && (nMaxlen < (ph7_int64)sizeof(zBuf))) ? nMaxlen : (ph7_int64)sizeof(zBuf));` |
|  13519 | 3883 | `		if( n < 1 ){` |
|      - | 3884 | `			/* EOF or IO error,break immediately */` |
|   6763 | 3885 | `			break;` |
|      - | 3886 | `		}` |
|      - | 3887 | `		/* Append data */` |
|   6761 | 3888 | `		ph7_result_string(pCtx,zBuf,(int)n);` |
|      - | 3889 | `		/* Increment read counter */` |
|   6761 | 3890 | `		nRead += n;` |
|   6761 | 3891 | `		if( nMaxlen > 0 && nRead >= nMaxlen ){` |
|      - | 3892 | `			/* Read limit reached */` |
|      3 | 3893 | `			break;` |
|      - | 3894 | `		}` |
|      5 | 3895 | `	}` |
|      - | 3896 | `	/* Close the stream */` |
|   6765 | 3897 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
...
|   6765 | 3901 | `	if( ph7_context_result_buf_length(pCtx) < 1 ){` |
|      6 | 3902 | `		ph7_result_string(pCtx,"",0);` |
|      2 | 3903 | `	}` |
|   6765 | 3904 | `	return PH7_OK;` |
|   3386 | 3905 | `}` |
|      - | 3906 | `/*` |
...
|      - | 3924 | ` */` |
|  13726 | 3925 | `static int PH7_builtin_file_put_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3926 | `{` |
|  13731 | 3927 | `	int use_include  = FALSE;` |
...
|      - | 3934 | `	int nLen;` |
|      - | 3935 |  |
|  13731 | 3936 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  13731 | 3943 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3944 | `	/* Point to the target IO stream device */` |
|  13731 | 3945 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|  13731 | 3946 | `	if( pStream == 0 ){` |
...
|      - | 3950 | `	}` |
|      - | 3951 | `	/* Data to write */` |
|  13731 | 3952 | `	zData = ph7_value_to_string(apArg[1],&nLen);` |
|      - | 3953 | `	/* Try to open the file in read-write mode */` |
|  13731 | 3954 | `	iOpenFlags = PH7_IO_OPEN_CREATE\|PH7_IO_OPEN_RDWR\|PH7_IO_OPEN_TRUNC;` |
|      - | 3955 | `	/* Extract the flags */` |
|  13731 | 3956 | `	iFlags = 0;` |
|  13731 | 3957 | `	if( nArg > 2 ){` |
...
|    ! 0 | 3969 | `		}` |
|    ! 0 | 3970 | `	}` |
|  20594 | 3971 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,iOpenFlags,use_include,` |
|   6863 | 3972 | `		nArg > 3 ? apArg[3] : 0,FALSE,FALSE);` |
|  13731 | 3973 | `	if( pHandle == 0 ){` |
|    ! 0 | 3974 | `		VfsThrowOpenWarning(pCtx,zFile);` |
|    ! 0 | 3975 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 3976 | `		return PH7_OK;` |
|      - | 3977 | `	}` |
|  13731 | 3978 | `	if( nLen < 1 ){` |
...
|      - | 3983 | `	}` |
|  13723 | 3984 | `	if( pStream->xWrite ){` |
|      - | 3985 | `		ph7_int64 n;` |
|  13723 | 3986 | `		if( (iFlags & 2/* LOCK_EX, php's value */) && pStream->xLock ){` |
|      - | 3987 | `			/* Try to acquire an exclusive lock */` |
|    ! 0 | 3988 | `			pStream->xLock(pHandle,1/* LOCK_EX */);` |
|    ! 0 | 3989 | `		}` |
|      - | 3990 | `		/* Perform the write operation */` |
|  13723 | 3991 | `		n = pStream->xWrite(pHandle,(const void *)zData,nLen);` |
|  13723 | 3992 | `		if( n < 0 ){` |
...
|  13723 | 4000 | `			ph7_result_int64(pCtx,n);` |
|      - | 4001 | `		}` |
|   6864 | 4002 | `	}else{` |
...
|  13723 | 4011 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|  13723 | 4012 | `	return PH7_OK;` |
|   6868 | 4013 | `}` |
|      - | 4014 | `/*` |
...
|      - | 4965 | ` */` |
|   5318 | 4966 | `static void InitIOPrivate(ph7_vm *pVm,const ph7_io_stream *pStream,io_private *pOut)` |
|      5 | 4967 | `{` |
|   5323 | 4968 | `	pOut->pStream = pStream;` |
|   5323 | 4969 | `	SyBlobInit(&pOut->sBuffer,&pVm->sAllocator);` |
|   5323 | 4970 | `	pOut->nOfft = 0;` |
|      - | 4971 | `	/* Set the magic number */` |
|   5323 | 4972 | `	pOut->iMagic = IO_PRIVATE_MAGIC;` |
|   5323 | 4973 | `}` |
|      - | 4974 | `/*` |
...
|      - | 4992 | ` */` |
|   5260 | 4993 | `static void MarkIOPrivateClosed(io_private *pDev)` |
|      5 | 4994 | `{` |
|   5265 | 4995 | `	SyBlobRelease(&pDev->sBuffer);` |
|   5265 | 4996 | `	pDev->pHandle = 0;` |
|   5265 | 4997 | `	pDev->iMagic = IO_PRIVATE_CLOSED_MAGIC;` |
|   5265 | 4998 | `}` |
|      - | 4999 | `/*` |
...
|      - | 6185 | ` */` |
|   3914 | 6186 | `PH7_PRIVATE const ph7_vfs * PH7_ExportBuiltinVfs(void)` |
|      5 | 6187 | `{` |
...
|      - | 6812 | ` */` |
|   3976 | 6813 | `static pipe_private * PipeOpen(ph7_vm *pVm, const char *zCommand, const char *zMode)` |
|      5 | 6814 | `{` |
|      - | 6815 | `	pipe_private *pPipe;` |
|      - | 6816 | `	FILE *pFile;` |
|   3981 | 6817 | `	if( pVm == 0 \|\| zCommand == 0 \|\| zMode == 0 ){` |
|    ! 0 | 6818 | `		return 0;` |
|      - | 6819 | `	}` |
|      - | 6820 | `	/* Validate mode - only 'r' or 'w' allowed */` |
|   3981 | 6821 | `	if( zMode[0] != 'r' && zMode[0] != 'w' ){` |
|    ! 0 | 6822 | `		return 0;` |
|      - | 6823 | `	}` |
...
|   3976 | 6885 | `	pFile = popen(zCommand, zMode);` |
|   3976 | 6886 | `	if( pFile == 0 ){` |
|    ! 0 | 6887 | `		return 0;` |
|      - | 6888 | `	}` |
|      - | 6889 | `	/* Allocate pipe private structure */` |
|   3976 | 6890 | `	pPipe = (pipe_private *)SyMemBackendAlloc(&pVm->sAllocator, sizeof(pipe_private));` |
|   3976 | 6891 | `	if( pPipe == 0 ){` |
|      - | 6892 | `		/* Out of memory, close the pipe */` |
|    ! 0 | 6893 | `		pclose(pFile);` |
|    ! 0 | 6894 | `		return 0;` |
|      - | 6895 | `	}` |
|      - | 6896 | `	/* Initialize the structure */` |
|   3976 | 6897 | `	pPipe->pFile = pFile;` |
|   3976 | 6898 | `	pPipe->pVm = pVm;` |
|   3976 | 6899 | `	pPipe->iMode = zMode[0];` |
|      - | 6900 | `#else /* OS_OTHER: no process pipes on this platform */` |
|      - | 6901 | `	(void)pFile;` |
|      - | 6902 | `	return 0;` |
|      - | 6903 | `#endif` |
|   3981 | 6904 | `	return pPipe;` |
|   1993 | 6905 | `}` |
|      - | 6906 | `/*` |
|      - | 6907 | ` * Close a pipe and return the exit status of the process.` |
|      - | 6908 | ` * Returns the exit status, or -1 on error.` |
|      - | 6909 | ` */` |
|   3950 | 6910 | `static int PipeClose(pipe_private *pPipe)` |
|      5 | 6911 | `{` |
|      - | 6912 | `	int status;` |
|      - | 6913 | `	ph7_vm *pVm;` |
|   3955 | 6914 | `	if( pPipe == 0 \|\| pPipe->pFile == 0 ){` |
|    ! 0 | 6915 | `		return -1;` |
|      - | 6916 | `	}` |
|   3955 | 6917 | `	pVm = pPipe->pVm;` |
...
|   3950 | 6923 | `	status = pclose(pPipe->pFile);` |
|      - | 6924 | `	/* On Unix, pclose returns the status from waitpid, need to extract exit code */` |
|   3950 | 6925 | `	if( status != -1 ){` |
|   3950 | 6926 | `		if( WIFEXITED(status) ){` |
|   3950 | 6927 | `			status = WEXITSTATUS(status);` |
|   1975 | 6928 | `		}else if( WIFSIGNALED(status) ){` |
...
|   3955 | 6940 | `	SyMemBackendFree(&pVm->sAllocator, pPipe);` |
|   3955 | 6941 | `	return status;` |
|   1980 | 6942 | `}` |
|      - | 6943 | `/*` |
...
|      - | 6957 | ` */` |
|   5914 | 6958 | `static ph7_int64 PipeStream_Read(void *pHandle, void *pBuffer, ph7_int64 nDatatoRead)` |
|      4 | 6959 | `{` |
|   5918 | 6960 | `	pipe_private *pPipe = (pipe_private *)pHandle;` |
|      - | 6961 | `	size_t nRead;` |
|   5918 | 6962 | `	if( pPipe == 0 \|\| pPipe->pFile == 0 ){` |
|    ! 0 | 6963 | `		return -1;` |
|      - | 6964 | `	}` |
|   5918 | 6965 | `	if( pPipe->iMode != 'r' ){` |
|      - | 6966 | `		/* Cannot read from a write-only pipe */` |
|    ! 0 | 6967 | `		return -1;` |
|      - | 6968 | `	}` |
|   5918 | 6969 | `	nRead = fread(pBuffer, 1, (size_t)nDatatoRead, pPipe->pFile);` |
|   5918 | 6970 | `	if( nRead == 0 ){` |
|   3984 | 6971 | `		if( feof(pPipe->pFile) ){` |
|   3984 | 6972 | `			return 0; /* EOF */` |
|      - | 6973 | `		}` |
|    ! 0 | 6974 | `		return -1; /* Error */` |
|      - | 6975 | `	}` |
|   1938 | 6976 | `	return (ph7_int64)nRead;` |
|   2961 | 6977 | `}` |
|      - | 6978 | `/*` |
...
|      - | 7020 | ` */` |
|   3844 | 7021 | `static int is_pipe_stream(const ph7_io_stream *pStream)` |
|      5 | 7022 | `{` |
|   3849 | 7023 | `	return pStream == &sPipe_Stream;` |
|      5 | 7024 | `}` |
|      - | 7025 | `/*` |
...
|      4 | 7083 | `}` |
|   3972 | 7084 | `static int PH7_builtin_popen(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 7085 | `{` |
|      - | 7086 | `	const char *zCommand, *zMode;` |
|      - | 7087 | `	pipe_private *pPipe;` |
|      - | 7088 | `	io_private *pDev;` |
|      - | 7089 | `	int nCmdLen, nModeLen;` |
|   3977 | 7090 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) \|\| !ph7_value_is_string(apArg[1]) ){` |
...
|   3977 | 7097 | `	zCommand = ph7_value_to_string(apArg[0], &nCmdLen);` |
|   3977 | 7098 | `	zMode = ph7_value_to_string(apArg[1], &nModeLen);` |
|   3977 | 7099 | `	if( nCmdLen < 1 ){` |
|    ! 0 | 7100 | `		ph7_context_throw_error(pCtx, PH7_CTX_WARNING, "Empty command");` |
|    ! 0 | 7101 | `		ph7_result_bool(pCtx, 0);` |
|    ! 0 | 7102 | `		return PH7_OK;` |
|      - | 7103 | `	}` |
|   3977 | 7104 | `	if( nModeLen < 1 \|\| (zMode[0] != 'r' && zMode[0] != 'w') ){` |
...
|      - | 7108 | `	}` |
|      - | 7109 | `	/* Open the pipe */` |
|   3977 | 7110 | `	pPipe = PipeOpen(pCtx->pVm, zCommand, zMode);` |
|   3977 | 7111 | `	if( pPipe == 0 ){` |
...
|   3977 | 7117 | `	pDev = (io_private *)ph7_context_alloc_chunk(pCtx, sizeof(io_private), TRUE, FALSE);` |
|   3977 | 7118 | `	if( pDev == 0 ){` |
...
|   3977 | 7125 | `	InitIOPrivate(pCtx->pVm, &sPipe_Stream, pDev);` |
|   3977 | 7126 | `	pDev->pHandle = pPipe;` |
|      - | 7127 | `	/* Return the io_private instance as a resource */` |
|   3977 | 7128 | `	ph7_result_resource(pCtx, pDev);` |
|   3977 | 7129 | `	return PH7_OK;` |
|   1991 | 7130 | `}` |
|      - | 7131 | `/*` |
...
|      - | 7139 | ` */` |
|   3844 | 7140 | `static int PH7_builtin_pclose(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 7141 | `{` |
|      - | 7142 | `	const ph7_io_stream *pStream;` |
|      - | 7143 | `	pipe_private *pPipe;` |
|      - | 7144 | `	io_private *pDev;` |
|      - | 7145 | `	int status;` |
|   3849 | 7146 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   3849 | 7153 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 7154 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   3849 | 7155 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   3849 | 7161 | `	pStream = pDev->pStream;` |
|   3849 | 7162 | `	if( pStream == 0 \|\| !is_pipe_stream(pStream) ){` |
...
|   3849 | 7168 | `	pPipe = (pipe_private *)pDev->pHandle;` |
|      - | 7169 | `	/* Close the pipe and get exit status */` |
|   3849 | 7170 | `	status = PipeClose(pPipe);` |
|      - | 7171 | `	/* Keep the handle alive but flag it closed so shared copies see it */` |
|   3849 | 7172 | `	MarkIOPrivateClosed(pDev);` |
|      - | 7173 | `	/* Return the exit status */` |
|   3849 | 7174 | `	ph7_result_int(pCtx, status);` |
|   3849 | 7175 | `	return PH7_OK;` |
|   1927 | 7176 | `}` |
|      - | 7177 | `/*` |
...
|      - | 7612 | ` */` |
|   3426 | 7613 | `PH7_PRIVATE sxi32 PH7_RegisterIORoutine(ph7_vm *pVm)` |
|      5 | 7614 | `{` |
|      - | 7615 | `	/*` |
...
|      - | 7730 | `	};` |
|   3431 | 7731 | `	const ph7_io_stream *pFileStream = 0;` |
|   3431 | 7732 | `	sxu32 n = 0;` |
|      - | 7733 | `	/* Register disk-related functions */` |
| 167879 | 7734 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVfsDiskFunc) ; ++n ){` |
| 164453 | 7735 | `		ph7_create_function(&(*pVm),aVfsDiskFunc[n].zName,aVfsDiskFunc[n].xFunc,(void *)pVm->pEngine->pVfs);` |
|  82229 | 7736 | `	}` |
| 178157 | 7737 | `	for( n = 0 ; n < SX_ARRAYSIZE(aIOFunc) ; ++n ){` |
| 174731 | 7738 | `		ph7_create_function(&(*pVm),aIOFunc[n].zName,aIOFunc[n].xFunc,pVm);` |
|  87368 | 7739 | `	}` |
|      - | 7740 | `#else` |
|      - | 7741 | `	SXUNUSED(pVm);` |
...
|      - | 7768 | `	};` |
|  58247 | 7769 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVfsHelperFunc) ; ++n ){` |
|  54821 | 7770 | `		ph7_create_function(&(*pVm),aVfsHelperFunc[n].zName,aVfsHelperFunc[n].xFunc,pVm);` |
|  27413 | 7771 | `	}` |
...
|   3426 | 7779 | `	pFileStream = &sUnixFileStream;` |
|      - | 7780 | `#endif` |
|      - | 7781 | `	/* Install the php:// stream */` |
|   3431 | 7782 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,&sPHP_Stream);` |
|   3431 | 7783 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,&sDATA_Stream);` |
|      - | 7784 | `#ifdef PH7_ENABLE_NET` |
|   3431 | 7785 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,&sTCP_Stream);` |
|      - | 7786 | `#endif` |
|   3431 | 7787 | `	if( pFileStream ){` |
|      - | 7788 | `		/* Install the file:// stream */` |
|   3431 | 7789 | `		ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,pFileStream);` |
|   1713 | 7790 | `	}` |
|      - | 7791 | `#endif /* PH7_DISABLE_DISK_IO */` |
|      - | 7792 |  |
|   3431 | 7793 | `	return SXRET_OK;` |
|      5 | 7794 | `}` |
|      - | 7795 | `/*` |
