...
|      - |   67 | ` */` |
|  20214 |   68 | `static const char * VfsStrerror(int iErr)` |
|      5 |   69 | `{` |
|      - |   70 | `#if defined(_MSC_VER)` |
|      - |   71 | `#pragma warning(push)` |
|      - |   72 | `#pragma warning(disable:4996)` |
|      - |   73 | `#endif` |
|  20219 |   74 | `	return strerror(iErr);` |
...
|      - |   84 | ` */` |
|  20192 |   85 | `static void VfsThrowSysWarning(ph7_context *pCtx,const char *zPath)` |
|      5 |   86 | `{` |
|  30293 |   87 | `	PH7_VmThrowWarningFmt(pCtx->pVm,"%s(%s): %s",` |
|  20192 |   88 | `		ph7_function_name(pCtx),zPath ? zPath : "",VfsStrerror(errno));` |
|  20197 |   89 | `}` |
...
|      - |  103 | ` */` |
|  13550 |  104 | `static int PH7_vfs_chdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  105 | `{` |
|      - |  106 | `	const char *zPath;` |
|      - |  107 | `	ph7_vfs *pVfs;` |
|      - |  108 | `	int rc;` |
|  13555 |  109 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  110 | `		/* Missing/Invalid argument,return FALSE */` |
|      6 |  111 | `		ph7_result_bool(pCtx,0);` |
|      6 |  112 | `		return PH7_OK;` |
|      - |  113 | `	}` |
|      - |  114 | `	/* Point to the underlying vfs */` |
|  13551 |  115 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  13551 |  116 | `	if( pVfs == 0 \|\| pVfs->xChdir == 0 ){` |
...
|  13551 |  126 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  127 | `	/* Perform the requested operation */` |
|  13551 |  128 | `	errno = 0;` |
|  13551 |  129 | `	rc = pVfs->xChdir(zPath);` |
|  13551 |  130 | `	if( rc != PH7_OK ){` |
...
|      1 |  134 | `	}` |
|      - |  135 | `	/* IO return value */` |
|  13551 |  136 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  13551 |  137 | `	return PH7_OK;` |
|   6780 |  138 | `}` |
|      - |  139 | `/*` |
...
|      - |  261 | ` */` |
|   8908 |  262 | `static int PH7_vfs_is_dir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  263 | `{` |
|      - |  264 | `	const char *zPath;` |
|      - |  265 | `	ph7_vfs *pVfs;` |
|      - |  266 | `	int rc;` |
|   8913 |  267 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  268 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  269 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  270 | `		return PH7_OK;` |
|      - |  271 | `	}` |
|      - |  272 | `	/* Point to the underlying vfs */` |
|   8913 |  273 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   8913 |  274 | `	if( pVfs == 0 \|\| pVfs->xIsdir == 0 ){` |
...
|   8913 |  284 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  285 | `	/* Perform the requested operation */` |
|   8913 |  286 | `	rc = pVfs->xIsdir(zPath);` |
|      - |  287 | `	/* IO return value */` |
|   8913 |  288 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   8913 |  289 | `	return PH7_OK;` |
|   4459 |  290 | `}` |
|      - |  291 | `/*` |
...
|      - |  536 | ` */` |
|  34026 |  537 | `static int PH7_vfs_unlink(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  538 | `{` |
|      - |  539 | `	const char *zPath;` |
|      - |  540 | `	ph7_vfs *pVfs;` |
|      - |  541 | `	int rc;` |
|  34031 |  542 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  543 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  544 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  545 | `		return PH7_OK;` |
|      - |  546 | `	}` |
|      - |  547 | `	/* Point to the underlying vfs */` |
|  34031 |  548 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  34031 |  549 | `	if( pVfs == 0 \|\| pVfs->xUnlink == 0 ){` |
...
|  34031 |  559 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  560 | `	/* Perform the requested operation */` |
|  34031 |  561 | `	errno = 0;` |
|  34031 |  562 | `	rc = pVfs->xUnlink(zPath);` |
|  34031 |  563 | `	if( rc != PH7_OK ){` |
|  20191 |  564 | `		VfsThrowSysWarning(pCtx,zPath);` |
|  10093 |  565 | `	}` |
|      - |  566 | `	/* IO return value */` |
|  34031 |  567 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  34031 |  568 | `	return PH7_OK;` |
|  17018 |  569 | `}` |
|      - |  570 | `/*` |
...
|      - | 1005 | ` */` |
|   6830 | 1006 | `static int PH7_vfs_is_file(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1007 | `{` |
|      - | 1008 | `	const char *zPath;` |
|      - | 1009 | `	ph7_vfs *pVfs;` |
|      - | 1010 | `	int rc;` |
|   6835 | 1011 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   6835 | 1017 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   6835 | 1018 | `	if( pVfs == 0 \|\| pVfs->xIsfile == 0 ){` |
...
|   6835 | 1028 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - | 1029 | `	/* Perform the requested operation */` |
|   6835 | 1030 | `	rc = pVfs->xIsfile(zPath);` |
|      - | 1031 | `	/* IO return value */` |
|   6835 | 1032 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   6835 | 1033 | `	return PH7_OK;` |
|   3420 | 1034 | `}` |
|      - | 1035 | `/*` |
...
|      - | 1658 | ` */` |
|  13530 | 1659 | `static sxi32 ExtractPathInfo(const char *zPath,int nByte,path_info *pOut)` |
|      5 | 1660 | `{` |
|  13535 | 1661 | `	const char *zPtr,*zEnd = &zPath[nByte - 1];` |
|      - | 1662 | `	SyString *pCur;` |
|      - | 1663 | `	int c,d;` |
|  13535 | 1664 | `	c = d = '/';` |
...
|  13535 | 1669 | `	SyZero(pOut,sizeof(path_info));` |
|      - | 1670 | `	/* Handle special case */` |
|  13535 | 1671 | `	if( nByte == sizeof(char) && ( (int)zPath[0] == c \|\| (int)zPath[0] == d ) ){` |
...
| 365516 | 1680 | `	while( zEnd > zPath && ( (int)zEnd[0] != c && (int)zEnd[0] != d ) ){` |
| 345221 | 1681 | `		zEnd--;` |
|      5 | 1682 | `	}` |
|  13535 | 1683 | `	zPtr = (zEnd > zPath) ? &zEnd[1] : zPath;` |
|  13535 | 1684 | `	zEnd = &zPath[nByte];` |
|      - | 1685 | `	/* dirname */` |
|  13535 | 1686 | `	pCur = &pOut->sDir;` |
|  13535 | 1687 | `	SyStringInitFromBuf(pCur,zPath,zPtr-zPath);` |
|  13535 | 1688 | `	if( pCur->nByte > 1 ){` |
|  27065 | 1689 | `		SyStringTrimTrailingChar(pCur,'/');` |
|      - | 1690 | `#ifdef __WINNT__` |
|      5 | 1691 | `		SyStringTrimTrailingChar(pCur,'\\');` |
|      - | 1692 | `#endif` |
|   6770 | 1693 | `	}else if( (int)zPath[0] == c \|\| (int)zPath[0] == d ){` |
...
|  13535 | 1701 | `	pCur = &pOut->sBasename;` |
|  13535 | 1702 | `	SyStringInitFromBuf(pCur,zPtr,zEnd-zPtr);` |
|  13535 | 1703 | `	SyStringTrimLeadingChar(pCur,'/');` |
|      - | 1704 | `#ifdef __WINNT__` |
|      5 | 1705 | `	SyStringTrimLeadingChar(pCur,'\\');` |
|      - | 1706 | `#endif` |
|  13535 | 1707 | `	SyStringDupPtr(&pOut->sFilename,pCur);` |
|  13535 | 1708 | `	if( pCur->nByte > 0 ){` |
|      - | 1709 | `		/* extension */` |
|  13535 | 1710 | `		zEnd--;` |
|  67649 | 1711 | `		while( zEnd > pCur->zString /*basename*/ && zEnd[0] != '.' ){` |
|  54119 | 1712 | `			zEnd--;` |
|      5 | 1713 | `		}` |
|  13535 | 1714 | `		if( zEnd > pCur->zString ){` |
|  13533 | 1715 | `			zEnd++; /* Jump leading dot */` |
|  13533 | 1716 | `			SyStringInitFromBuf(&pOut->sExtension,zEnd,&zPath[nByte]-zEnd);` |
|      - | 1717 | `			/* Fix filename */` |
|  13533 | 1718 | `			pCur = &pOut->sFilename;` |
|  13533 | 1719 | `			if( pCur->nByte > SyStringLength(&pOut->sExtension) ){` |
|  13533 | 1720 | `				pCur->nByte -= 1 + SyStringLength(&pOut->sExtension);` |
|   6764 | 1721 | `			}` |
|   6764 | 1722 | `		}` |
|   6765 | 1723 | `	}` |
|  13535 | 1724 | `	return SXRET_OK;` |
|   6770 | 1725 | `}` |
|      - | 1726 | `/*` |
...
|      - | 1729 | ` */` |
|  13530 | 1730 | `static int PH7_builtin_pathinfo(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1731 | `{` |
|      - | 1732 | `	const char *zPath;` |
|      - | 1733 | `	path_info sInfo;` |
|      - | 1734 | `	SyString *pComp;` |
|      - | 1735 | `	int iLen;` |
|  13535 | 1736 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  13535 | 1742 | `	zPath = ph7_value_to_string(apArg[0],&iLen);` |
|  13535 | 1743 | `	if( iLen < 1 ){` |
|      - | 1744 | `		/* Empty string */` |
|    ! 0 | 1745 | `		ph7_result_string(pCtx,"",0);` |
|    ! 0 | 1746 | `		return PH7_OK;` |
|      - | 1747 | `	}` |
|      - | 1748 | `	/* Extract path info */` |
|  13535 | 1749 | `	ExtractPathInfo(zPath,iLen,&sInfo);` |
|  20299 | 1750 | `	if( nArg > 1 && ph7_value_is_int(apArg[1]) ){` |
|      - | 1751 | `		/* Return path component */` |
|  13533 | 1752 | `		int nComp = ph7_value_to_int(apArg[1]);` |
|  13533 | 1753 | `		switch(nComp){` |
...
|      - | 1770 | `			}` |
|      3 | 1771 | `			break;` |
|   3383 | 1772 | `		case 3: /*PATHINFO_EXTENSION*/` |
|   6771 | 1773 | `			pComp = &sInfo.sExtension;` |
|   6771 | 1774 | `			if( pComp->nByte > 0 ){` |
|   6769 | 1775 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   3387 | 1776 | `			}else{` |
|      - | 1777 | `				/* Expand the empty string */` |
|      3 | 1778 | `				ph7_result_string(pCtx,"",0);` |
|      - | 1779 | `			}` |
|   6771 | 1780 | `			break;` |
|   3379 | 1781 | `		case 4: /*PATHINFO_FILENAME*/` |
|   6763 | 1782 | `			pComp = &sInfo.sFilename;` |
|   6763 | 1783 | `			if( pComp->nByte > 0 ){` |
|   6763 | 1784 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   3384 | 1785 | `			}else{` |
...
|      - | 3044 | ` */` |
|  30672 | 3045 | `PH7_PRIVATE void * PH7_StreamOpenHandle(ph7_vm *pVm,const ph7_io_stream *pStream,const char *zFile,` |
|      - | 3046 | `	int iFlags,int use_include,ph7_value *pResource,int bPushInclude,int *pNew)` |
|      5 | 3047 | `{` |
|  30677 | 3048 | `	void *pHandle = 0; /* cc warning */` |
|      - | 3049 | `	SyString sFile;` |
|      - | 3050 | `	ph7_value sDummy;` |
|      - | 3051 | `	int rc;` |
|  30677 | 3052 | `	if( pStream == 0 ){` |
|      - | 3053 | `		/* No such stream device */` |
|    ! 0 | 3054 | `		return 0;` |
|      - | 3055 | `	}` |
|  30677 | 3056 | `	if( pResource == 0 ){` |
...
|  30655 | 3062 | `		PH7_MemObjInit(pVm,&sDummy);` |
|  30655 | 3063 | `		pResource = &sDummy;` |
|  15325 | 3064 | `	}` |
|  30677 | 3065 | `	SyStringInitFromBuf(&sFile,zFile,SyStrlen(zFile));` |
|  30677 | 3066 | `	if( use_include ){` |
|   9782 | 3067 | `		if(	sFile.zString[0] == '/' \|\|` |
|      - | 3068 | `#ifdef __WINNT__` |
|      - | 3069 | `			(sFile.nByte > 2 && sFile.zString[1] == ':' && (sFile.zString[2] == '\\' \|\| sFile.zString[2] == '/') ) \|\|` |
|      - | 3070 | `#endif` |
|   9745 | 3071 | `			(sFile.nByte > 1 && sFile.zString[0] == '.' && sFile.zString[1] == '/') \|\|` |
|   9740 | 3072 | `			(sFile.nByte > 2 && sFile.zString[0] == '.' && sFile.zString[1] == '.' && sFile.zString[2] == '/') ){` |
...
|   9743 | 3088 | `			SyBlobInit(&sWorker,&pVm->sAllocator);` |
|      - | 3089 | `			/* Build a path from the set of include path */` |
|   9743 | 3090 | `			SySetResetCursor(&pVm->aPaths);` |
|   9743 | 3091 | `			rc = SXERR_IO;` |
|   9749 | 3092 | `			while( SXRET_OK == SySetGetNextEntry(&pVm->aPaths,(void **)&pPath) ){` |
|      - | 3093 | `				/* Build full path */` |
|   9743 | 3094 | `				SyBlobFormat(&sWorker,"%z%c%z",pPath,c,&sFile);` |
|      - | 3095 | `				/* Append null terminator */` |
|   9743 | 3096 | `				if( SXRET_OK != SyBlobNullAppend(&sWorker) ){` |
|    ! 0 | 3097 | `					continue;` |
|      - | 3098 | `				}` |
|      - | 3099 | `				/* Try to open the file */` |
|   9743 | 3100 | `				rc = pStream->xOpen((const char *)SyBlobData(&sWorker),iFlags,pResource,&pHandle);` |
|   9743 | 3101 | `				if( rc == PH7_OK ){` |
|   9736 | 3102 | `					if( bPushInclude ){` |
|      - | 3103 | `						/* Mark as included */` |
|   9736 | 3104 | `						PH7_VmPushFilePath(pVm,(const char *)SyBlobData(&sWorker),SyBlobLength(&sWorker),FALSE,pNew);` |
|   4867 | 3105 | `					}` |
|   9736 | 3106 | `					break;` |
|      - | 3107 | `				}` |
...
|      2 | 3111 | `			}` |
|   9743 | 3112 | `			SyBlobRelease(&sWorker);` |
|      - | 3113 | `		}` |
|   4894 | 3114 | `	}else{` |
|      - | 3115 | `		/* Open the URI direcly */` |
|  20895 | 3116 | `		rc = pStream->xOpen(zFile,iFlags,pResource,&pHandle);` |
|      - | 3117 | `	}` |
|  30677 | 3118 | `	if( rc != PH7_OK ){` |
|      - | 3119 | `		/* IO error */` |
|     25 | 3120 | `		return 0;` |
|      - | 3121 | `	}` |
|      - | 3122 | `	/* Return the file handle */` |
|  30657 | 3123 | `	return pHandle;` |
|  15341 | 3124 | `}` |
|      - | 3125 | `/*` |
...
|      - | 3129 | ` */` |
|   9766 | 3130 | `PH7_PRIVATE sxi32 PH7_StreamReadWholeFile(void *pHandle,const ph7_io_stream *pStream,SyBlob *pOut)` |
|      3 | 3131 | `{` |
...
|   9766 | 3136 | `	for(;;){` |
|  19535 | 3137 | `		nRead = pStream->xRead(pHandle,zBuf,sizeof(zBuf));` |
|  19535 | 3138 | `		if( nRead < 1 ){` |
|      - | 3139 | `			/* EOF or IO error */` |
|   9769 | 3140 | `			break;` |
|      - | 3141 | `		}` |
|      - | 3142 | `		/* Append contents */` |
|   9769 | 3143 | `		rc = SyBlobAppend(pOut,zBuf,(sxu32)nRead);` |
|   9769 | 3144 | `		if( rc != SXRET_OK ){` |
|    ! 0 | 3145 | `			break;` |
|      - | 3146 | `		}` |
|      3 | 3147 | `	}` |
|   9769 | 3148 | `	return SyBlobLength(pOut) > 0 ? SXRET_OK : -1;` |
|      3 | 3149 | `}` |
|      - | 3150 | `/*` |
|      - | 3151 | ` * Close an open IO stream handle [i.e local file/URI..].` |
|      - | 3152 | ` */` |
|  30780 | 3153 | `PH7_PRIVATE void PH7_StreamCloseHandle(const ph7_io_stream *pStream,void *pHandle)` |
|      5 | 3154 | `{` |
|  30785 | 3155 | `	if( pStream->xClose ){` |
|  30785 | 3156 | `		pStream->xClose(pHandle);` |
|  15390 | 3157 | `	}` |
|  30785 | 3158 | `}` |
|      - | 3159 | `/*` |
...
|      - | 3537 | ` */` |
|  11084 | 3538 | `static int PH7_builtin_readdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3539 | `{` |
|      - | 3540 | `	const ph7_io_stream *pStream;` |
|      - | 3541 | `	io_private *pDev;` |
|      - | 3542 | `	int rc;` |
|  11089 | 3543 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|  11089 | 3550 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3551 | `	/* Make sure we are dealing with a valid io_private instance */` |
|  11089 | 3552 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|  11089 | 3559 | `	pStream = pDev->pStream;` |
|  11089 | 3560 | `	if( pStream == 0  \|\| pStream->xReadDir == 0 ){` |
...
|      - | 3567 | `	}` |
|  11089 | 3568 | `	ph7_result_bool(pCtx,0);` |
|      - | 3569 | `	/* Perform the requested operation */` |
|  11089 | 3570 | `	rc = pStream->xReadDir(pDev->pHandle,pCtx);` |
|  11089 | 3571 | `	if( rc != PH7_OK ){` |
|      - | 3572 | `		/* Return FALSE */` |
|   1075 | 3573 | `		ph7_result_bool(pCtx,0);` |
|    535 | 3574 | `	}` |
|  11089 | 3575 | `	return PH7_OK;` |
|   5547 | 3576 | `}` |
|      - | 3577 | `/*` |
...
|      - | 3827 | ` */` |
|   6818 | 3828 | `static int PH7_builtin_file_get_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3829 | `{` |
|      - | 3830 | `	const ph7_io_stream *pStream;` |
|      - | 3831 | `	ph7_int64 n,nRead,nMaxlen;` |
|   6823 | 3832 | `	int use_include  = FALSE;` |
|      - | 3833 | `	const char *zFile;` |
|      - | 3834 | `	char zBuf[8192];` |
|      - | 3835 | `	void *pHandle;` |
|      - | 3836 | `	int nLen;` |
|      - | 3837 |  |
|   6823 | 3838 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   6823 | 3845 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3846 | `	/* Point to the target IO stream device */` |
|   6823 | 3847 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|   6823 | 3848 | `	if( pStream == 0 ){` |
...
|   6823 | 3858 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,PH7_IO_OPEN_RDONLY,use_include,nArg > 2 ? apArg[2] : 0,FALSE,0);` |
|   6823 | 3859 | `	if( pHandle == 0 ){` |
...
|   6821 | 3879 | `	nRead = 0;` |
|   6813 | 3880 | `	for(;;){` |
|  20447 | 3881 | `		n = pStream->xRead(pHandle,zBuf,` |
|   6816 | 3882 | `			(nMaxlen > 0 && (nMaxlen < (ph7_int64)sizeof(zBuf))) ? nMaxlen : (ph7_int64)sizeof(zBuf));` |
|  13631 | 3883 | `		if( n < 1 ){` |
|      - | 3884 | `			/* EOF or IO error,break immediately */` |
|   6819 | 3885 | `			break;` |
|      - | 3886 | `		}` |
|      - | 3887 | `		/* Append data */` |
|   6817 | 3888 | `		ph7_result_string(pCtx,zBuf,(int)n);` |
|      - | 3889 | `		/* Increment read counter */` |
|   6817 | 3890 | `		nRead += n;` |
|   6817 | 3891 | `		if( nMaxlen > 0 && nRead >= nMaxlen ){` |
|      - | 3892 | `			/* Read limit reached */` |
|      3 | 3893 | `			break;` |
|      - | 3894 | `		}` |
|      5 | 3895 | `	}` |
|      - | 3896 | `	/* Close the stream */` |
|   6821 | 3897 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
...
|   6821 | 3901 | `	if( ph7_context_result_buf_length(pCtx) < 1 ){` |
|      6 | 3902 | `		ph7_result_string(pCtx,"",0);` |
|      2 | 3903 | `	}` |
|   6821 | 3904 | `	return PH7_OK;` |
|   3414 | 3905 | `}` |
|      - | 3906 | `/*` |
...
|      - | 3924 | ` */` |
|  13824 | 3925 | `static int PH7_builtin_file_put_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3926 | `{` |
|  13829 | 3927 | `	int use_include  = FALSE;` |
...
|      - | 3934 | `	int nLen;` |
|      - | 3935 |  |
|  13829 | 3936 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  13829 | 3943 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3944 | `	/* Point to the target IO stream device */` |
|  13829 | 3945 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|  13829 | 3946 | `	if( pStream == 0 ){` |
...
|      - | 3950 | `	}` |
|      - | 3951 | `	/* Data to write */` |
|  13829 | 3952 | `	zData = ph7_value_to_string(apArg[1],&nLen);` |
|      - | 3953 | `	/* Try to open the file in read-write mode */` |
|  13829 | 3954 | `	iOpenFlags = PH7_IO_OPEN_CREATE\|PH7_IO_OPEN_RDWR\|PH7_IO_OPEN_TRUNC;` |
|      - | 3955 | `	/* Extract the flags */` |
|  13829 | 3956 | `	iFlags = 0;` |
|  13829 | 3957 | `	if( nArg > 2 ){` |
...
|    ! 0 | 3969 | `		}` |
|    ! 0 | 3970 | `	}` |
|  20741 | 3971 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,iOpenFlags,use_include,` |
|   6912 | 3972 | `		nArg > 3 ? apArg[3] : 0,FALSE,FALSE);` |
|  13829 | 3973 | `	if( pHandle == 0 ){` |
|    ! 0 | 3974 | `		VfsThrowOpenWarning(pCtx,zFile);` |
|    ! 0 | 3975 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 3976 | `		return PH7_OK;` |
|      - | 3977 | `	}` |
|  13829 | 3978 | `	if( nLen < 1 ){` |
...
|      - | 3983 | `	}` |
|  13821 | 3984 | `	if( pStream->xWrite ){` |
|      - | 3985 | `		ph7_int64 n;` |
|  13821 | 3986 | `		if( (iFlags & 2/* LOCK_EX, php's value */) && pStream->xLock ){` |
|      - | 3987 | `			/* Try to acquire an exclusive lock */` |
|    ! 0 | 3988 | `			pStream->xLock(pHandle,1/* LOCK_EX */);` |
|    ! 0 | 3989 | `		}` |
|      - | 3990 | `		/* Perform the write operation */` |
|  13821 | 3991 | `		n = pStream->xWrite(pHandle,(const void *)zData,nLen);` |
|  13821 | 3992 | `		if( n < 0 ){` |
...
|  13821 | 4000 | `			ph7_result_int64(pCtx,n);` |
|      - | 4001 | `		}` |
|   6913 | 4002 | `	}else{` |
...
|  13821 | 4011 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|  13821 | 4012 | `	return PH7_OK;` |
|   6917 | 4013 | `}` |
|      - | 4014 | `/*` |
