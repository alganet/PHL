...
|      - |   65 | ` */` |
|  19402 |   66 | `static const char * VfsStrerror(int iErr)` |
|      5 |   67 | `{` |
|      - |   68 | `#if defined(_MSC_VER)` |
|      - |   69 | `#pragma warning(push)` |
|      - |   70 | `#pragma warning(disable:4996)` |
|      - |   71 | `#endif` |
|  19407 |   72 | `	return strerror(iErr);` |
...
|      - |   82 | ` */` |
|  19388 |   83 | `static void VfsThrowSysWarning(ph7_context *pCtx,const char *zPath)` |
|      5 |   84 | `{` |
|  29087 |   85 | `	PH7_VmThrowWarningFmt(pCtx->pVm,"%s(%s): %s",` |
|  19388 |   86 | `		ph7_function_name(pCtx),zPath ? zPath : "",VfsStrerror(errno));` |
|  19393 |   87 | `}` |
...
|      - |  101 | ` */` |
|  13142 |  102 | `static int PH7_vfs_chdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  103 | `{` |
|      - |  104 | `	const char *zPath;` |
|      - |  105 | `	ph7_vfs *pVfs;` |
|      - |  106 | `	int rc;` |
|  13147 |  107 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  108 | `		/* Missing/Invalid argument,return FALSE */` |
|      6 |  109 | `		ph7_result_bool(pCtx,0);` |
|      6 |  110 | `		return PH7_OK;` |
|      - |  111 | `	}` |
|      - |  112 | `	/* Point to the underlying vfs */` |
|  13143 |  113 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  13143 |  114 | `	if( pVfs == 0 \|\| pVfs->xChdir == 0 ){` |
...
|  13143 |  124 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  125 | `	/* Perform the requested operation */` |
|  13143 |  126 | `	errno = 0;` |
|  13143 |  127 | `	rc = pVfs->xChdir(zPath);` |
|  13143 |  128 | `	if( rc != PH7_OK ){` |
...
|      1 |  132 | `	}` |
|      - |  133 | `	/* IO return value */` |
|  13143 |  134 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  13143 |  135 | `	return PH7_OK;` |
|   6576 |  136 | `}` |
|      - |  137 | `/*` |
...
|      - |  259 | ` */` |
|   8516 |  260 | `static int PH7_vfs_is_dir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  261 | `{` |
|      - |  262 | `	const char *zPath;` |
|      - |  263 | `	ph7_vfs *pVfs;` |
|      - |  264 | `	int rc;` |
|   8521 |  265 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  266 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  267 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  268 | `		return PH7_OK;` |
|      - |  269 | `	}` |
|      - |  270 | `	/* Point to the underlying vfs */` |
|   8521 |  271 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   8521 |  272 | `	if( pVfs == 0 \|\| pVfs->xIsdir == 0 ){` |
...
|   8521 |  282 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  283 | `	/* Perform the requested operation */` |
|   8521 |  284 | `	rc = pVfs->xIsdir(zPath);` |
|      - |  285 | `	/* IO return value */` |
|   8521 |  286 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   8521 |  287 | `	return PH7_OK;` |
|   4263 |  288 | `}` |
|      - |  289 | `/*` |
...
|      - |  534 | ` */` |
|  32778 |  535 | `static int PH7_vfs_unlink(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  536 | `{` |
|      - |  537 | `	const char *zPath;` |
|      - |  538 | `	ph7_vfs *pVfs;` |
|      - |  539 | `	int rc;` |
|  32783 |  540 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  541 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  542 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  543 | `		return PH7_OK;` |
|      - |  544 | `	}` |
|      - |  545 | `	/* Point to the underlying vfs */` |
|  32783 |  546 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|  32783 |  547 | `	if( pVfs == 0 \|\| pVfs->xUnlink == 0 ){` |
...
|  32783 |  557 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  558 | `	/* Perform the requested operation */` |
|  32783 |  559 | `	errno = 0;` |
|  32783 |  560 | `	rc = pVfs->xUnlink(zPath);` |
|  32783 |  561 | `	if( rc != PH7_OK ){` |
|  19391 |  562 | `		VfsThrowSysWarning(pCtx,zPath);` |
|   9693 |  563 | `	}` |
|      - |  564 | `	/* IO return value */` |
|  32783 |  565 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|  32783 |  566 | `	return PH7_OK;` |
|  16394 |  567 | `}` |
|      - |  568 | `/*` |
...
|      - |  809 | `	ph7_vfs *pVfs;` |
|      - |  810 | `	int rc;` |
|    175 |  811 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
|      - |  812 | `		/* Missing/Invalid argument,return FALSE */` |
|    ! 0 |  813 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  814 | `		return PH7_OK;` |
|      - |  815 | `	}` |
|      - |  816 | `	/* Point to the underlying vfs */` |
|    175 |  817 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|    175 |  818 | `	if( pVfs == 0 \|\| pVfs->xFileExists == 0 ){` |
...
|    175 |  828 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - |  829 | `	/* Perform the requested operation */` |
|    175 |  830 | `	rc = pVfs->xFileExists(zPath);` |
|      - |  831 | `	/* IO return value */` |
|    175 |  832 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|    175 |  833 | `	return PH7_OK;` |
|     89 |  834 | `}` |
|      - |  835 | `/*` |
...
|      - | 1003 | ` */` |
|   6526 | 1004 | `static int PH7_vfs_is_file(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1005 | `{` |
|      - | 1006 | `	const char *zPath;` |
|      - | 1007 | `	ph7_vfs *pVfs;` |
|      - | 1008 | `	int rc;` |
|   6531 | 1009 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   6531 | 1015 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|   6531 | 1016 | `	if( pVfs == 0 \|\| pVfs->xIsfile == 0 ){` |
...
|   6531 | 1026 | `	zPath = ph7_value_to_string(apArg[0],0);` |
|      - | 1027 | `	/* Perform the requested operation */` |
|   6531 | 1028 | `	rc = pVfs->xIsfile(zPath);` |
|      - | 1029 | `	/* IO return value */` |
|   6531 | 1030 | `	ph7_result_bool(pCtx,rc == PH7_OK);` |
|   6531 | 1031 | `	return PH7_OK;` |
|   3268 | 1032 | `}` |
|      - | 1033 | `/*` |
...
|      - | 1656 | ` */` |
|  13042 | 1657 | `static sxi32 ExtractPathInfo(const char *zPath,int nByte,path_info *pOut)` |
|      5 | 1658 | `{` |
|  13047 | 1659 | `	const char *zPtr,*zEnd = &zPath[nByte - 1];` |
|      - | 1660 | `	SyString *pCur;` |
|      - | 1661 | `	int c,d;` |
|  13047 | 1662 | `	c = d = '/';` |
...
|  13047 | 1667 | `	SyZero(pOut,sizeof(path_info));` |
|      - | 1668 | `	/* Handle special case */` |
|  13047 | 1669 | `	if( nByte == sizeof(char) && ( (int)zPath[0] == c \|\| (int)zPath[0] == d ) ){` |
...
| 351848 | 1678 | `	while( zEnd > zPath && ( (int)zEnd[0] != c && (int)zEnd[0] != d ) ){` |
| 332285 | 1679 | `		zEnd--;` |
|      5 | 1680 | `	}` |
|  13047 | 1681 | `	zPtr = (zEnd > zPath) ? &zEnd[1] : zPath;` |
|  13047 | 1682 | `	zEnd = &zPath[nByte];` |
|      - | 1683 | `	/* dirname */` |
|  13047 | 1684 | `	pCur = &pOut->sDir;` |
|  13047 | 1685 | `	SyStringInitFromBuf(pCur,zPath,zPtr-zPath);` |
|  13047 | 1686 | `	if( pCur->nByte > 1 ){` |
|  26089 | 1687 | `		SyStringTrimTrailingChar(pCur,'/');` |
|      - | 1688 | `#ifdef __WINNT__` |
|      5 | 1689 | `		SyStringTrimTrailingChar(pCur,'\\');` |
|      - | 1690 | `#endif` |
|   6526 | 1691 | `	}else if( (int)zPath[0] == c \|\| (int)zPath[0] == d ){` |
...
|  13047 | 1699 | `	pCur = &pOut->sBasename;` |
|  13047 | 1700 | `	SyStringInitFromBuf(pCur,zPtr,zEnd-zPtr);` |
|  13047 | 1701 | `	SyStringTrimLeadingChar(pCur,'/');` |
|      - | 1702 | `#ifdef __WINNT__` |
|      5 | 1703 | `	SyStringTrimLeadingChar(pCur,'\\');` |
|      - | 1704 | `#endif` |
|  13047 | 1705 | `	SyStringDupPtr(&pOut->sFilename,pCur);` |
|  13047 | 1706 | `	if( pCur->nByte > 0 ){` |
|      - | 1707 | `		/* extension */` |
|  13047 | 1708 | `		zEnd--;` |
|  65209 | 1709 | `		while( zEnd > pCur->zString /*basename*/ && zEnd[0] != '.' ){` |
|  52167 | 1710 | `			zEnd--;` |
|      5 | 1711 | `		}` |
|  13047 | 1712 | `		if( zEnd > pCur->zString ){` |
|  13045 | 1713 | `			zEnd++; /* Jump leading dot */` |
|  13045 | 1714 | `			SyStringInitFromBuf(&pOut->sExtension,zEnd,&zPath[nByte]-zEnd);` |
|      - | 1715 | `			/* Fix filename */` |
|  13045 | 1716 | `			pCur = &pOut->sFilename;` |
|  13045 | 1717 | `			if( pCur->nByte > SyStringLength(&pOut->sExtension) ){` |
|  13045 | 1718 | `				pCur->nByte -= 1 + SyStringLength(&pOut->sExtension);` |
|   6520 | 1719 | `			}` |
|   6520 | 1720 | `		}` |
|   6521 | 1721 | `	}` |
|  13047 | 1722 | `	return SXRET_OK;` |
|   6526 | 1723 | `}` |
|      - | 1724 | `/*` |
...
|      - | 1727 | ` */` |
|  13042 | 1728 | `static int PH7_builtin_pathinfo(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1729 | `{` |
|      - | 1730 | `	const char *zPath;` |
|      - | 1731 | `	path_info sInfo;` |
|      - | 1732 | `	SyString *pComp;` |
|      - | 1733 | `	int iLen;` |
|  13047 | 1734 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  13047 | 1740 | `	zPath = ph7_value_to_string(apArg[0],&iLen);` |
|  13047 | 1741 | `	if( iLen < 1 ){` |
|      - | 1742 | `		/* Empty string */` |
|    ! 0 | 1743 | `		ph7_result_string(pCtx,"",0);` |
|    ! 0 | 1744 | `		return PH7_OK;` |
|      - | 1745 | `	}` |
|      - | 1746 | `	/* Extract path info */` |
|  13047 | 1747 | `	ExtractPathInfo(zPath,iLen,&sInfo);` |
|  19567 | 1748 | `	if( nArg > 1 && ph7_value_is_int(apArg[1]) ){` |
|      - | 1749 | `		/* Return path component */` |
|  13045 | 1750 | `		int nComp = ph7_value_to_int(apArg[1]);` |
|  13045 | 1751 | `		switch(nComp){` |
...
|      - | 1768 | `			}` |
|      3 | 1769 | `			break;` |
|   3261 | 1770 | `		case 3: /*PATHINFO_EXTENSION*/` |
|   6527 | 1771 | `			pComp = &sInfo.sExtension;` |
|   6527 | 1772 | `			if( pComp->nByte > 0 ){` |
|   6525 | 1773 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   3265 | 1774 | `			}else{` |
|      - | 1775 | `				/* Expand the empty string */` |
|      3 | 1776 | `				ph7_result_string(pCtx,"",0);` |
|      - | 1777 | `			}` |
|   6527 | 1778 | `			break;` |
|   3257 | 1779 | `		case 4: /*PATHINFO_FILENAME*/` |
|   6519 | 1780 | `			pComp = &sInfo.sFilename;` |
|   6519 | 1781 | `			if( pComp->nByte > 0 ){` |
|   6519 | 1782 | `				ph7_result_string(pCtx,pComp->zString,(int)pComp->nByte);` |
|   3262 | 1783 | `			}else{` |
...
|    226 | 2246 | `	ph7_result_string(pCtx,"",0);` |
|      - | 2247 | `	/* Point to the underlying vfs */` |
|    226 | 2248 | `	pVfs = (ph7_vfs *)ph7_context_user_data(pCtx);` |
|    226 | 2249 | `	if( pVfs == 0 \|\| pVfs->xTempDir == 0 ){` |
...
|    226 | 2260 | `	pVfs->xTempDir(pCtx);` |
|    226 | 2261 | `	return PH7_OK;` |
|    115 | 2262 | `}` |
|      - | 2263 | `/*` |
...
|      - | 2827 | ` */` |
|  10322 | 2828 | `static int PH7_builtin_feof(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2829 | `{` |
|      - | 2830 | `	const ph7_io_stream *pStream;` |
|      - | 2831 | `	io_private *pDev;` |
|      - | 2832 | `	int rc;` |
|  10327 | 2833 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|  10327 | 2840 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 2841 | `	/* Make sure we are dealing with a valid io_private instance */` |
|  10327 | 2842 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|  10327 | 2849 | `	pStream = pDev->pStream;` |
|  10327 | 2850 | `	if( pStream == 0 ){` |
...
|      - | 2857 | `	}` |
|  10327 | 2858 | `	rc = SXERR_EOF;` |
|      - | 2859 | `	/* Perform the requested operation */` |
|  10327 | 2860 | `	if( SyBlobLength(&pDev->sBuffer) > pDev->nOfft ){` |
...
|   5669 | 2867 | `		n = pStream->xRead(pDev->pHandle,zBuf,sizeof(zBuf));` |
|   5669 | 2868 | `		if( n > 0 ){` |
|      - | 2869 | `			/* Copy buffered data */` |
|   1847 | 2870 | `			SyBlobAppend(&pDev->sBuffer,zBuf,(sxu32)n);` |
|   1847 | 2871 | `			rc = PH7_OK;` |
|    921 | 2872 | `		}` |
|      - | 2873 | `	}` |
|      - | 2874 | `	/* EOF or not */` |
|  10327 | 2875 | `	ph7_result_bool(pCtx,rc == SXERR_EOF);` |
|  10327 | 2876 | `	return PH7_OK;` |
|   5166 | 2877 | `}` |
|      - | 2878 | `/*` |
...
|      - | 2922 | ` */` |
|   6566 | 2923 | `static sxi32 GetLine(io_private *pDev,ph7_int64 *pLen,const char **pzLine)` |
|      5 | 2924 | `{` |
|      - | 2925 | `	const char *zIn,*zEnd,*zPtr;` |
|   6571 | 2926 | `	zIn = (const char *)SyBlobDataAt(&pDev->sBuffer,pDev->nOfft);` |
|   6571 | 2927 | `	zEnd = &zIn[SyBlobLength(&pDev->sBuffer)-pDev->nOfft];` |
|   6571 | 2928 | `	zPtr = zIn;` |
| 389617 | 2929 | `	while( zIn < zEnd ){` |
| 389515 | 2930 | `		if( zIn[0] == '\n' ){` |
|      - | 2931 | `			/* Line found */` |
|   6469 | 2932 | `			zIn++; /* Include the line ending as requested by the PHP specification */` |
|   6469 | 2933 | `			*pLen = (ph7_int64)(zIn-zPtr);` |
|   6469 | 2934 | `			*pzLine = zPtr;` |
|   6469 | 2935 | `			return SXRET_OK;` |
|      - | 2936 | `		}` |
| 383051 | 2937 | `		zIn++;` |
|      5 | 2938 | `	}` |
...
|      - | 2944 | ` */` |
|   6570 | 2945 | `static ph7_int64 StreamReadLine(io_private *pDev,const char **pzData,ph7_int64 nMaxLen)` |
|      5 | 2946 | `{` |
|   6575 | 2947 | `	const ph7_io_stream *pStream = pDev->pStream;` |
|      - | 2948 | `	char zBuf[8192];` |
|      - | 2949 | `	ph7_int64 n;` |
|      - | 2950 | `	sxi32 rc;` |
|   6575 | 2951 | `	n = 0;` |
|   6575 | 2952 | `	if( pDev->nOfft >= SyBlobLength(&pDev->sBuffer) ){` |
...
|     34 | 2956 | `	}` |
|   6575 | 2957 | `	if( SyBlobLength(&pDev->sBuffer) > pDev->nOfft ){` |
|      - | 2958 | `		/* Check if there is a line */` |
|   6507 | 2959 | `		rc = GetLine(pDev,&n,pzData);` |
|   6507 | 2960 | `		if( rc == SXRET_OK ){` |
|      - | 2961 | `			/* Got line,update the cursor  */` |
|   6409 | 2962 | `			pDev->nOfft += (sxu32)n;` |
|   6409 | 2963 | `			return n;` |
|      - | 2964 | `		}` |
|     49 | 2965 | `	}` |
...
|      - | 3024 | ` */` |
|  29590 | 3025 | `PH7_PRIVATE void * PH7_StreamOpenHandle(ph7_vm *pVm,const ph7_io_stream *pStream,const char *zFile,` |
|      - | 3026 | `	int iFlags,int use_include,ph7_value *pResource,int bPushInclude,int *pNew)` |
|      5 | 3027 | `{` |
|  29595 | 3028 | `	void *pHandle = 0; /* cc warning */` |
|      - | 3029 | `	SyString sFile;` |
|      - | 3030 | `	ph7_value sDummy;` |
|      - | 3031 | `	int rc;` |
|  29595 | 3032 | `	if( pStream == 0 ){` |
|      - | 3033 | `		/* No such stream device */` |
|    ! 0 | 3034 | `		return 0;` |
|      - | 3035 | `	}` |
|  29595 | 3036 | `	if( pResource == 0 ){` |
...
|  29577 | 3042 | `		PH7_MemObjInit(pVm,&sDummy);` |
|  29577 | 3043 | `		pResource = &sDummy;` |
|  14786 | 3044 | `	}` |
|  29595 | 3045 | `	SyStringInitFromBuf(&sFile,zFile,SyStrlen(zFile));` |
|  29595 | 3046 | `	if( use_include ){` |
|   9424 | 3047 | `		if(	sFile.zString[0] == '/' \|\|` |
|      - | 3048 | `#ifdef __WINNT__` |
|      - | 3049 | `			(sFile.nByte > 2 && sFile.zString[1] == ':' && (sFile.zString[2] == '\\' \|\| sFile.zString[2] == '/') ) \|\|` |
|      - | 3050 | `#endif` |
|   9410 | 3051 | `			(sFile.nByte > 1 && sFile.zString[0] == '.' && sFile.zString[1] == '/') \|\|` |
|   9406 | 3052 | `			(sFile.nByte > 2 && sFile.zString[0] == '.' && sFile.zString[1] == '.' && sFile.zString[2] == '/') ){` |
...
|   9410 | 3064 | `			SyBlobInit(&sWorker,&pVm->sAllocator);` |
|      - | 3065 | `			/* Build a path from the set of include path */` |
|   9410 | 3066 | `			SySetResetCursor(&pVm->aPaths);` |
|   9410 | 3067 | `			rc = SXERR_IO;` |
|   9416 | 3068 | `			while( SXRET_OK == SySetGetNextEntry(&pVm->aPaths,(void **)&pPath) ){` |
|      - | 3069 | `				/* Build full path */` |
|   9410 | 3070 | `				SyBlobFormat(&sWorker,"%z%c%z",pPath,c,&sFile);` |
|      - | 3071 | `				/* Append null terminator */` |
|   9410 | 3072 | `				if( SXRET_OK != SyBlobNullAppend(&sWorker) ){` |
|    ! 0 | 3073 | `					continue;` |
|      - | 3074 | `				}` |
|      - | 3075 | `				/* Try to open the file */` |
|   9410 | 3076 | `				rc = pStream->xOpen((const char *)SyBlobData(&sWorker),iFlags,pResource,&pHandle);` |
|   9410 | 3077 | `				if( rc == PH7_OK ){` |
|   9404 | 3078 | `					if( bPushInclude ){` |
|      - | 3079 | `						/* Mark as included */` |
|   9404 | 3080 | `						PH7_VmPushFilePath(pVm,(const char *)SyBlobData(&sWorker),SyBlobLength(&sWorker),FALSE,pNew);` |
|   4700 | 3081 | `					}` |
|   9404 | 3082 | `					break;` |
|      - | 3083 | `				}` |
...
|      2 | 3087 | `			}` |
|   9410 | 3088 | `			SyBlobRelease(&sWorker);` |
|      - | 3089 | `		}` |
|   9428 | 3090 | `		if( rc == PH7_OK ){` |
|   9422 | 3091 | `			if( bPushInclude ){` |
|      - | 3092 | `				/* Mark as included */` |
|   9422 | 3093 | `				PH7_VmPushFilePath(pVm,sFile.zString,sFile.nByte,FALSE,pNew);` |
|   4709 | 3094 | `			}` |
|   4709 | 3095 | `		}` |
|   4716 | 3096 | `	}else{` |
|      - | 3097 | `		/* Open the URI direcly */` |
|  20171 | 3098 | `		rc = pStream->xOpen(zFile,iFlags,pResource,&pHandle);` |
|      - | 3099 | `	}` |
|  29595 | 3100 | `	if( rc != PH7_OK ){` |
|      - | 3101 | `		/* IO error */` |
|     16 | 3102 | `		return 0;` |
|      - | 3103 | `	}` |
|      - | 3104 | `	/* Return the file handle */` |
|  29583 | 3105 | `	return pHandle;` |
|  14800 | 3106 | `}` |
|      - | 3107 | `/*` |
...
|      - | 3111 | ` */` |
|   9412 | 3112 | `PH7_PRIVATE sxi32 PH7_StreamReadWholeFile(void *pHandle,const ph7_io_stream *pStream,SyBlob *pOut)` |
|      4 | 3113 | `{` |
...
|   9412 | 3118 | `	for(;;){` |
|  18828 | 3119 | `		nRead = pStream->xRead(pHandle,zBuf,sizeof(zBuf));` |
|  18828 | 3120 | `		if( nRead < 1 ){` |
|      - | 3121 | `			/* EOF or IO error */` |
|   9416 | 3122 | `			break;` |
|      - | 3123 | `		}` |
|      - | 3124 | `		/* Append contents */` |
|   9416 | 3125 | `		rc = SyBlobAppend(pOut,zBuf,(sxu32)nRead);` |
|   9416 | 3126 | `		if( rc != SXRET_OK ){` |
|    ! 0 | 3127 | `			break;` |
|      - | 3128 | `		}` |
|      4 | 3129 | `	}` |
|   9416 | 3130 | `	return SyBlobLength(pOut) > 0 ? SXRET_OK : -1;` |
|      4 | 3131 | `}` |
|      - | 3132 | `/*` |
|      - | 3133 | ` * Close an open IO stream handle [i.e local file/URI..].` |
|      - | 3134 | ` */` |
|  29676 | 3135 | `PH7_PRIVATE void PH7_StreamCloseHandle(const ph7_io_stream *pStream,void *pHandle)` |
|      5 | 3136 | `{` |
|  29681 | 3137 | `	if( pStream->xClose ){` |
|  29681 | 3138 | `		pStream->xClose(pHandle);` |
|  14838 | 3139 | `	}` |
|  29681 | 3140 | `}` |
|      - | 3141 | `/*` |
...
|      - | 3210 | ` */` |
|   6560 | 3211 | `static int PH7_builtin_fgets(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3212 | `{` |
|      - | 3213 | `	const ph7_io_stream *pStream;` |
|      - | 3214 | `	const char *zLine;` |
|      - | 3215 | `	io_private *pDev;` |
|      - | 3216 | `	ph7_int64 n,nLen;` |
|   6565 | 3217 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   6565 | 3224 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3225 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   6565 | 3226 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   6565 | 3233 | `	pStream = pDev->pStream;` |
|   6565 | 3234 | `	if( pStream == 0  ){` |
...
|   6565 | 3248 | `	n = StreamReadLine(pDev,&zLine,nLen);` |
|   6565 | 3249 | `	if( n < 1 ){` |
|      - | 3250 | `		/* EOF or IO error,return FALSE */` |
|      7 | 3251 | `		ph7_result_bool(pCtx,0);` |
|      6 | 3252 | `	}else{` |
|      - | 3253 | `		/* Return the freshly extracted line */` |
|   6563 | 3254 | `		ph7_result_string(pCtx,zLine,(int)n);` |
|      - | 3255 | `	}` |
|   6565 | 3256 | `	return PH7_OK;` |
|   3285 | 3257 | `}` |
|      - | 3258 | `/*` |
...
|      - | 3519 | ` */` |
|   8514 | 3520 | `static int PH7_builtin_readdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3521 | `{` |
|      - | 3522 | `	const ph7_io_stream *pStream;` |
|      - | 3523 | `	io_private *pDev;` |
|      - | 3524 | `	int rc;` |
|   8519 | 3525 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   8519 | 3532 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 3533 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   8519 | 3534 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   8519 | 3541 | `	pStream = pDev->pStream;` |
|   8519 | 3542 | `	if( pStream == 0  \|\| pStream->xReadDir == 0 ){` |
...
|      - | 3549 | `	}` |
|   8519 | 3550 | `	ph7_result_bool(pCtx,0);` |
|      - | 3551 | `	/* Perform the requested operation */` |
|   8519 | 3552 | `	rc = pStream->xReadDir(pDev->pHandle,pCtx);` |
|   8519 | 3553 | `	if( rc != PH7_OK ){` |
|      - | 3554 | `		/* Return FALSE */` |
|   1001 | 3555 | `		ph7_result_bool(pCtx,0);` |
|    498 | 3556 | `	}` |
|   8519 | 3557 | `	return PH7_OK;` |
|   4262 | 3558 | `}` |
|      - | 3559 | `/*` |
...
|      - | 3809 | ` */` |
|   6566 | 3810 | `static int PH7_builtin_file_get_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3811 | `{` |
|      - | 3812 | `	const ph7_io_stream *pStream;` |
|      - | 3813 | `	ph7_int64 n,nRead,nMaxlen;` |
|   6571 | 3814 | `	int use_include  = FALSE;` |
|      - | 3815 | `	const char *zFile;` |
|      - | 3816 | `	char zBuf[8192];` |
|      - | 3817 | `	void *pHandle;` |
|      - | 3818 | `	int nLen;` |
|      - | 3819 |  |
|   6571 | 3820 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   6571 | 3827 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3828 | `	/* Point to the target IO stream device */` |
|   6571 | 3829 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|   6571 | 3830 | `	if( pStream == 0 ){` |
...
|   6571 | 3840 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,PH7_IO_OPEN_RDONLY,use_include,nArg > 2 ? apArg[2] : 0,FALSE,0);` |
|   6571 | 3841 | `	if( pHandle == 0 ){` |
...
|   6571 | 3861 | `	nRead = 0;` |
|   6564 | 3862 | `	for(;;){` |
|  19700 | 3863 | `		n = pStream->xRead(pHandle,zBuf,` |
|   6567 | 3864 | `			(nMaxlen > 0 && (nMaxlen < (ph7_int64)sizeof(zBuf))) ? nMaxlen : (ph7_int64)sizeof(zBuf));` |
|  13133 | 3865 | `		if( n < 1 ){` |
|      - | 3866 | `			/* EOF or IO error,break immediately */` |
|   6569 | 3867 | `			break;` |
|      - | 3868 | `		}` |
|      - | 3869 | `		/* Append data */` |
|   6569 | 3870 | `		ph7_result_string(pCtx,zBuf,(int)n);` |
|      - | 3871 | `		/* Increment read counter */` |
|   6569 | 3872 | `		nRead += n;` |
|   6569 | 3873 | `		if( nMaxlen > 0 && nRead >= nMaxlen ){` |
|      - | 3874 | `			/* Read limit reached */` |
|      3 | 3875 | `			break;` |
|      - | 3876 | `		}` |
|      5 | 3877 | `	}` |
|      - | 3878 | `	/* Close the stream */` |
|   6571 | 3879 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|      - | 3880 | `	/* Check if we have read something */` |
|   6571 | 3881 | `	if( ph7_context_result_buf_length(pCtx) < 1 ){` |
|      - | 3882 | `		/* Nothing read,return FALSE */` |
|      3 | 3883 | `		ph7_result_bool(pCtx,0);` |
|      1 | 3884 | `	}` |
|   6571 | 3885 | `	return PH7_OK;` |
|   3288 | 3886 | `}` |
|      - | 3887 | `/*` |
...
|      - | 3905 | ` */` |
|  13376 | 3906 | `static int PH7_builtin_file_put_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3907 | `{` |
|  13381 | 3908 | `	int use_include  = FALSE;` |
...
|      - | 3915 | `	int nLen;` |
|      - | 3916 |  |
|  13381 | 3917 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  13381 | 3924 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 3925 | `	/* Point to the target IO stream device */` |
|  13381 | 3926 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|  13381 | 3927 | `	if( pStream == 0 ){` |
...
|      - | 3931 | `	}` |
|      - | 3932 | `	/* Data to write */` |
|  13381 | 3933 | `	zData = ph7_value_to_string(apArg[1],&nLen);` |
|      - | 3934 | `	/* Try to open the file in read-write mode */` |
|  13381 | 3935 | `	iOpenFlags = PH7_IO_OPEN_CREATE\|PH7_IO_OPEN_RDWR\|PH7_IO_OPEN_TRUNC;` |
|      - | 3936 | `	/* Extract the flags */` |
|  13381 | 3937 | `	iFlags = 0;` |
|  13381 | 3938 | `	if( nArg > 2 ){` |
...
|    ! 0 | 3950 | `		}` |
|    ! 0 | 3951 | `	}` |
|  20069 | 3952 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,iOpenFlags,use_include,` |
|   6688 | 3953 | `		nArg > 3 ? apArg[3] : 0,FALSE,FALSE);` |
|  13381 | 3954 | `	if( pHandle == 0 ){` |
|    ! 0 | 3955 | `		VfsThrowOpenWarning(pCtx,zFile);` |
|    ! 0 | 3956 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 3957 | `		return PH7_OK;` |
|      - | 3958 | `	}` |
|  13381 | 3959 | `	if( nLen < 1 ){` |
...
|  13375 | 3989 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|  13375 | 3990 | `	return PH7_OK;` |
|   6693 | 3991 | `}` |
|      - | 3992 | `/*` |
...
|      - | 4930 | ` */` |
|   5122 | 4931 | `static void InitIOPrivate(ph7_vm *pVm,const ph7_io_stream *pStream,io_private *pOut)` |
|      5 | 4932 | `{` |
|   5127 | 4933 | `	pOut->pStream = pStream;` |
|   5127 | 4934 | `	SyBlobInit(&pOut->sBuffer,&pVm->sAllocator);` |
|   5127 | 4935 | `	pOut->nOfft = 0;` |
|      - | 4936 | `	/* Set the magic number */` |
|   5127 | 4937 | `	pOut->iMagic = IO_PRIVATE_MAGIC;` |
|   5127 | 4938 | `}` |
|      - | 4939 | `/*` |
|      - | 4940 | ` * Release the IO private structure.` |
|      - | 4941 | ` */` |
|   5082 | 4942 | `static void ReleaseIOPrivate(ph7_context *pCtx,io_private *pDev)` |
|      5 | 4943 | `{` |
|   5087 | 4944 | `	SyBlobRelease(&pDev->sBuffer);` |
|   5087 | 4945 | `	pDev->iMagic = 0x2126; /* Invalid magic number so we can detetct misuse */` |
|      - | 4946 | `	/* Release the whole structure */` |
|   5087 | 4947 | `	ph7_context_free_chunk(pCtx,pDev);` |
|   5087 | 4948 | `}` |
|      - | 4949 | `/*` |
...
|      - | 5134 | `	int bEof;` |
|      - | 5135 | `};` |
|     13 | 5136 | `static ph7_int64 SockStreamData_Read(void *pHandle,void *pBuffer,ph7_int64 nRead)` |
|    ! 0 | 5137 | `{` |
|     13 | 5138 | `	sock_private *pSock = (sock_private *)pHandle;` |
|      - | 5139 | `	int n;` |
|     13 | 5140 | `	if( pSock == 0 \|\| pSock->bEof ){` |
|      2 | 5141 | `		return 0;` |
|      - | 5142 | `	}` |
|     11 | 5143 | `	n = PH7_NetRecv(pSock->sock,pBuffer,(int)nRead,0);` |
|     11 | 5144 | `	if( n <= 0 ){` |
|      4 | 5145 | `		pSock->bEof = 1;` |
|      4 | 5146 | `		return 0;` |
|      - | 5147 | `	}` |
|      7 | 5148 | `	return (ph7_int64)n;` |
|      5 | 5149 | `}` |
...
|    311 | 5767 | `	pDev->pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zUri,iOpenFlags,` |
...
|      - | 6126 | ` */` |
|   3836 | 6127 | `PH7_PRIVATE const ph7_vfs * PH7_ExportBuiltinVfs(void)` |
|      5 | 6128 | `{` |
...
|      - | 6753 | ` */` |
|   3908 | 6754 | `static pipe_private * PipeOpen(ph7_vm *pVm, const char *zCommand, const char *zMode)` |
|      5 | 6755 | `{` |
|      - | 6756 | `	pipe_private *pPipe;` |
|      - | 6757 | `	FILE *pFile;` |
|   3913 | 6758 | `	if( pVm == 0 \|\| zCommand == 0 \|\| zMode == 0 ){` |
|    ! 0 | 6759 | `		return 0;` |
|      - | 6760 | `	}` |
|      - | 6761 | `	/* Validate mode - only 'r' or 'w' allowed */` |
|   3913 | 6762 | `	if( zMode[0] != 'r' && zMode[0] != 'w' ){` |
|    ! 0 | 6763 | `		return 0;` |
|      - | 6764 | `	}` |
...
|   3908 | 6826 | `	pFile = popen(zCommand, zMode);` |
|   3908 | 6827 | `	if( pFile == 0 ){` |
|    ! 0 | 6828 | `		return 0;` |
|      - | 6829 | `	}` |
|      - | 6830 | `	/* Allocate pipe private structure */` |
|   3908 | 6831 | `	pPipe = (pipe_private *)SyMemBackendAlloc(&pVm->sAllocator, sizeof(pipe_private));` |
|   3908 | 6832 | `	if( pPipe == 0 ){` |
|      - | 6833 | `		/* Out of memory, close the pipe */` |
|    ! 0 | 6834 | `		pclose(pFile);` |
|    ! 0 | 6835 | `		return 0;` |
|      - | 6836 | `	}` |
|      - | 6837 | `	/* Initialize the structure */` |
|   3908 | 6838 | `	pPipe->pFile = pFile;` |
|   3908 | 6839 | `	pPipe->pVm = pVm;` |
|   3908 | 6840 | `	pPipe->iMode = zMode[0];` |
|      - | 6841 | `#else /* OS_OTHER: no process pipes on this platform */` |
|      - | 6842 | `	(void)pFile;` |
|      - | 6843 | `	return 0;` |
|      - | 6844 | `#endif` |
|   3913 | 6845 | `	return pPipe;` |
|   1959 | 6846 | `}` |
|      - | 6847 | `/*` |
|      - | 6848 | ` * Close a pipe and return the exit status of the process.` |
|      - | 6849 | ` * Returns the exit status, or -1 on error.` |
|      - | 6850 | ` */` |
|   3882 | 6851 | `static int PipeClose(pipe_private *pPipe)` |
|      5 | 6852 | `{` |
|      - | 6853 | `	int status;` |
|      - | 6854 | `	ph7_vm *pVm;` |
|   3887 | 6855 | `	if( pPipe == 0 \|\| pPipe->pFile == 0 ){` |
|    ! 0 | 6856 | `		return -1;` |
|      - | 6857 | `	}` |
|   3887 | 6858 | `	pVm = pPipe->pVm;` |
...
|   3882 | 6864 | `	status = pclose(pPipe->pFile);` |
|      - | 6865 | `	/* On Unix, pclose returns the status from waitpid, need to extract exit code */` |
|   3882 | 6866 | `	if( status != -1 ){` |
|   3882 | 6867 | `		if( WIFEXITED(status) ){` |
|   3882 | 6868 | `			status = WEXITSTATUS(status);` |
|   1941 | 6869 | `		}else if( WIFSIGNALED(status) ){` |
...
|   3887 | 6881 | `	SyMemBackendFree(&pVm->sAllocator, pPipe);` |
|   3887 | 6882 | `	return status;` |
|   1946 | 6883 | `}` |
|      - | 6884 | `/*` |
...
|      - | 6898 | ` */` |
|   5804 | 6899 | `static ph7_int64 PipeStream_Read(void *pHandle, void *pBuffer, ph7_int64 nDatatoRead)` |
|      4 | 6900 | `{` |
|   5808 | 6901 | `	pipe_private *pPipe = (pipe_private *)pHandle;` |
|      - | 6902 | `	size_t nRead;` |
|   5808 | 6903 | `	if( pPipe == 0 \|\| pPipe->pFile == 0 ){` |
|    ! 0 | 6904 | `		return -1;` |
|      - | 6905 | `	}` |
|   5808 | 6906 | `	if( pPipe->iMode != 'r' ){` |
|      - | 6907 | `		/* Cannot read from a write-only pipe */` |
|    ! 0 | 6908 | `		return -1;` |
|      - | 6909 | `	}` |
|   5808 | 6910 | `	nRead = fread(pBuffer, 1, (size_t)nDatatoRead, pPipe->pFile);` |
|   5808 | 6911 | `	if( nRead == 0 ){` |
|   3914 | 6912 | `		if( feof(pPipe->pFile) ){` |
|   3914 | 6913 | `			return 0; /* EOF */` |
|      - | 6914 | `		}` |
|    ! 0 | 6915 | `		return -1; /* Error */` |
|      - | 6916 | `	}` |
|   1898 | 6917 | `	return (ph7_int64)nRead;` |
|   2906 | 6918 | `}` |
|      - | 6919 | `/*` |
...
|      - | 6961 | ` */` |
|   3778 | 6962 | `static int is_pipe_stream(const ph7_io_stream *pStream)` |
|      5 | 6963 | `{` |
|   3783 | 6964 | `	return pStream == &sPipe_Stream;` |
|      5 | 6965 | `}` |
|      - | 6966 | `/*` |
...
|      4 | 7024 | `}` |
|   3904 | 7025 | `static int PH7_builtin_popen(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 7026 | `{` |
|      - | 7027 | `	const char *zCommand, *zMode;` |
|      - | 7028 | `	pipe_private *pPipe;` |
|      - | 7029 | `	io_private *pDev;` |
|      - | 7030 | `	int nCmdLen, nModeLen;` |
|   3909 | 7031 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) \|\| !ph7_value_is_string(apArg[1]) ){` |
...
|   3909 | 7038 | `	zCommand = ph7_value_to_string(apArg[0], &nCmdLen);` |
|   3909 | 7039 | `	zMode = ph7_value_to_string(apArg[1], &nModeLen);` |
|   3909 | 7040 | `	if( nCmdLen < 1 ){` |
|    ! 0 | 7041 | `		ph7_context_throw_error(pCtx, PH7_CTX_WARNING, "Empty command");` |
|    ! 0 | 7042 | `		ph7_result_bool(pCtx, 0);` |
|    ! 0 | 7043 | `		return PH7_OK;` |
|      - | 7044 | `	}` |
|   3909 | 7045 | `	if( nModeLen < 1 \|\| (zMode[0] != 'r' && zMode[0] != 'w') ){` |
...
|      - | 7049 | `	}` |
|      - | 7050 | `	/* Open the pipe */` |
|   3909 | 7051 | `	pPipe = PipeOpen(pCtx->pVm, zCommand, zMode);` |
|   3909 | 7052 | `	if( pPipe == 0 ){` |
...
|   3909 | 7058 | `	pDev = (io_private *)ph7_context_alloc_chunk(pCtx, sizeof(io_private), TRUE, FALSE);` |
|   3909 | 7059 | `	if( pDev == 0 ){` |
...
|   3909 | 7066 | `	InitIOPrivate(pCtx->pVm, &sPipe_Stream, pDev);` |
|   3909 | 7067 | `	pDev->pHandle = pPipe;` |
|      - | 7068 | `	/* Return the io_private instance as a resource */` |
|   3909 | 7069 | `	ph7_result_resource(pCtx, pDev);` |
|   3909 | 7070 | `	return PH7_OK;` |
|   1957 | 7071 | `}` |
|      - | 7072 | `/*` |
...
|      - | 7080 | ` */` |
|   3778 | 7081 | `static int PH7_builtin_pclose(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 7082 | `{` |
|      - | 7083 | `	const ph7_io_stream *pStream;` |
|      - | 7084 | `	pipe_private *pPipe;` |
|      - | 7085 | `	io_private *pDev;` |
|      - | 7086 | `	int status;` |
|   3783 | 7087 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   3783 | 7094 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 7095 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   3783 | 7096 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   3783 | 7102 | `	pStream = pDev->pStream;` |
|   3783 | 7103 | `	if( pStream == 0 \|\| !is_pipe_stream(pStream) ){` |
...
|   3783 | 7109 | `	pPipe = (pipe_private *)pDev->pHandle;` |
|      - | 7110 | `	/* Close the pipe and get exit status */` |
|   3783 | 7111 | `	status = PipeClose(pPipe);` |
|      - | 7112 | `	/* Release the IO private structure */` |
|   3783 | 7113 | `	ReleaseIOPrivate(pCtx, pDev);` |
|      - | 7114 | `	/* Invalidate the resource handle */` |
|   3783 | 7115 | `	ph7_value_release(apArg[0]);` |
|      - | 7116 | `	/* Return the exit status */` |
|   3783 | 7117 | `	ph7_result_int(pCtx, status);` |
|   3783 | 7118 | `	return PH7_OK;` |
|   1894 | 7119 | `}` |
...
|      - | 7173 | ` */` |
|   3348 | 7174 | `PH7_PRIVATE sxi32 PH7_RegisterIORoutine(ph7_vm *pVm)` |
|      5 | 7175 | `{` |
|      - | 7176 | `	/*` |
...
|      - | 7286 | `	};` |
|   3353 | 7287 | `	const ph7_io_stream *pFileStream = 0;` |
|   3353 | 7288 | `	sxu32 n = 0;` |
|      - | 7289 | `	/* Register disk-related functions */` |
| 164057 | 7290 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVfsDiskFunc) ; ++n ){` |
| 160709 | 7291 | `		ph7_create_function(&(*pVm),aVfsDiskFunc[n].zName,aVfsDiskFunc[n].xFunc,(void *)pVm->pEngine->pVfs);` |
|  80357 | 7292 | `	}` |
| 157361 | 7293 | `	for( n = 0 ; n < SX_ARRAYSIZE(aIOFunc) ; ++n ){` |
| 154013 | 7294 | `		ph7_create_function(&(*pVm),aIOFunc[n].zName,aIOFunc[n].xFunc,pVm);` |
|  77009 | 7295 | `	}` |
|      - | 7296 | `#else` |
|      - | 7297 | `	SXUNUSED(pVm);` |
...
|      - | 7324 | `	};` |
|  56921 | 7325 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVfsHelperFunc) ; ++n ){` |
|  53573 | 7326 | `		ph7_create_function(&(*pVm),aVfsHelperFunc[n].zName,aVfsHelperFunc[n].xFunc,pVm);` |
|  26789 | 7327 | `	}` |
...
|   3348 | 7335 | `	pFileStream = &sUnixFileStream;` |
|      - | 7336 | `#endif` |
|      - | 7337 | `	/* Install the php:// stream */` |
|   3353 | 7338 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,&sPHP_Stream);` |
|   3353 | 7339 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,&sDATA_Stream);` |
|      - | 7340 | `#ifdef PH7_ENABLE_NET` |
|   3353 | 7341 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,&sTCP_Stream);` |
|      - | 7342 | `#endif` |
|   3353 | 7343 | `	if( pFileStream ){` |
|      - | 7344 | `		/* Install the file:// stream */` |
|   3353 | 7345 | `		ph7_vm_config(pVm,PH7_VM_CONFIG_IO_STREAM,pFileStream);` |
|   1674 | 7346 | `	}` |
|      - | 7347 | `#endif /* PH7_DISABLE_DISK_IO */` |
|      - | 7348 |  |
|   3353 | 7349 | `	return SXRET_OK;` |
|      5 | 7350 | `}` |
|      - | 7351 | `/*` |
