...
|        - |   26 | ` */` |
|   522318 |   27 | `static sxi32 GenStateGuardClassRedeclaration(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 |   28 | `{` |
|        - |   29 | `	SyHashEntry *pEntry;` |
|   522323 |   30 | `	if( !GenStateUnconditionalTopLevel(pGen) ){` |
|       26 |   31 | `		return SXRET_OK; /* conditional/nested: keep hoisting */` |
|        - |   32 | `	}` |
|   522301 |   33 | `	pClass->iFlags \|= PH7_CLASS_BOUND;` |
|   522301 |   34 | `	if( pGen->pVm->bCompilingBuiltin ){` |
...
|        - |   70 | ` */` |
|  3830796 |   71 | `static sxi32 GetProtectionLevel(sxi32 nKeyword)` |
|        5 |   72 | `{` |
|  3830801 |   73 | `	if( nKeyword == PH7_TKWRD_PRIVATE ){` |
|   279731 |   74 | `		return PH7_CLASS_PROT_PRIVATE;` |
|  3551075 |   75 | `	}else if( nKeyword == PH7_TKWRD_PROTECTED ){` |
|   221379 |   76 | `		return PH7_CLASS_PROT_PROTECTED;` |
|        - |   77 | `	}` |
|        - |   78 | `	/* Assume public by default */` |
|  3329701 |   79 | `	return PH7_CLASS_PROT_PUBLIC;` |
|  1915403 |   80 | `}` |
|        - |   81 | `/*` |
...
|        - |  721 | ` */` |
| 23526448 |  722 | `PH7_PRIVATE int GenStateIsReadonly(SyToken *pTok)` |
|        5 |  723 | `{` |
| 23752335 |  724 | `	return (pTok->nType & PH7_TK_ID)` |
| 11989106 |  725 | `		&& pTok->sData.nByte == sizeof("readonly")-1` |
| 23752330 |  726 | `		&& SyStrnicmp(pTok->sData.zString,"readonly",sizeof("readonly")-1) == 0;` |
|        5 |  727 | `}` |
|        - |  728 | `/*` |
...
|        - |  733 | ` */` |
|  8450952 |  734 | `PH7_PRIVATE sxi32 GenStatePeekSetVisibility(SyToken *pTok,SyToken *pEnd,int *pnTok)` |
|        5 |  735 | `{` |
|  8450957 |  736 | `	*pnTok = 0;` |
|  8450952 |  737 | `	if( &pTok[3] < pEnd` |
|  7900806 |  738 | `	 && (pTok->nType & PH7_TK_KEYWORD)` |
...
|        - | 1034 | ` */` |
|  2897852 | 1035 | `static sxi32 GenStateCompileClassMethod(` |
...
|        - | 1041 | `	)` |
|        5 | 1042 | `{` |
|  2897857 | 1043 | `	sxu32 nLine = pGen->pIn->nLine;` |
|  2897857 | 1044 | `	sxu32 nKwLine = nLine; /* Line of the 'function' keyword (Reflection getStartLine) */` |
...
|  2897857 | 1051 | `	iProtection = GetProtectionLevel(iProtection);` |
|  2897857 | 1052 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|  2897857 | 1053 | `	iFuncFlags = 0;` |
|  2897857 | 1054 | `	if( pGen->pIn >= pGen->pEnd ){` |
...
|        - | 1062 | `	}` |
|  2897857 | 1063 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|        - | 1064 | `		/* Return by reference,remember that */` |
|      ! 0 | 1065 | `		iFuncFlags \|= VM_FUNC_REF_RETURN;` |
|        - | 1066 | `		/* Jump the '&' token */` |
|      ! 0 | 1067 | `		pGen->pIn++;` |
|      ! 0 | 1068 | `	}` |
|  2897857 | 1069 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|  2897857 | 1078 | `	pName = &pGen->pIn->sData;` |
|  2897857 | 1079 | `	nLine = pGen->pIn->nLine;` |
|        - | 1080 | `	/* Jump the method name */` |
|  2897857 | 1081 | `	pGen->pIn++;` |
|  2897857 | 1082 | `	if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
...
|    69914 | 1094 | `	}` |
|  2897857 | 1095 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|        - | 1096 | `		/* Syntax error */` |
...
|  2897857 | 1105 | `	pMeth = PH7_NewClassMethod(pGen->pVm,pClass,pName,nLine,iProtection,iFlags,iFuncFlags);` |
|  2897857 | 1106 | `	if( pMeth == 0 ){` |
|      ! 0 | 1107 | `		PH7_GenCompileError(&(*pGen),E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 1108 | `		return SXERR_ABORT;` |
|        - | 1109 | `	}` |
|  2897857 | 1110 | `	pMeth->sFunc.nLine = nKwLine;` |
|  2897857 | 1111 | `	GenStateConsumeDoc(&(*pGen),&pMeth->sFunc.sDoc);` |
|  2897857 | 1112 | `	if( GenStateConsumeAttrs(&(*pGen),&pMeth->sFunc.aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 1113 | `		return SXERR_ABORT;` |
|        - | 1114 | `	}` |
|        - | 1115 | `	/* Jump the left parenthesis '(' */` |
|  2897857 | 1116 | `	pGen->pIn++;` |
|  2897857 | 1117 | `	pEnd = 0; /* cc warning */` |
|        - | 1118 | `	/* Delimit the method signature */` |
|  2897857 | 1119 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|  2897857 | 1120 | `	if( pEnd >= pGen->pEnd ){` |
|        - | 1121 | `		/* Syntax error */` |
...
|        - | 1128 | `	}` |
|        - | 1129 | `	{` |
|  2897855 | 1130 | `		int bIsCtor = 0;` |
|  2897855 | 1131 | `		int bAbstractCtor = 0;` |
|  2897850 | 1132 | `		if( (pName->nByte == sizeof("__construct") - 1` |
|  1701426 | 1133 | `				&& SyMemcmp(pName->zString,"__construct",sizeof("__construct") - 1) == 0)` |
|  2794869 | 1134 | `		 \|\| SyStringCmp(pName,&pClass->sName,SyMemcmp) == 0 ){` |
...
|        - | 1139 | `			}` |
|   102986 | 1140 | `		}` |
|  2897855 | 1141 | `		if( pGen->pIn < pEnd ){` |
|        - | 1142 | `			/* Collect method arguments */` |
|  1114879 | 1143 | `			rc = GenStateCollectFuncArgs(&pMeth->sFunc,&(*pGen),pEnd,bIsCtor,bAbstractCtor);` |
|  1114879 | 1144 | `			if( rc == SXERR_ABORT ){` |
|      ! 0 | 1145 | `				return SXERR_ABORT;` |
|        - | 1146 | `			}` |
|   557437 | 1147 | `		}` |
|        - | 1148 | `	}` |
|        - | 1149 | `	/* Point past ')' and parse optional return type ': type' */` |
|  2897855 | 1150 | `	pGen->pIn = &pEnd[1];` |
|        - | 1151 | `	{` |
|  2897855 | 1152 | `		sxi32 rcRt = GenStateParseReturnType(pGen, &pMeth->sFunc);` |
|  2897855 | 1153 | `		if( rcRt == SXERR_ABORT ){` |
|      ! 0 | 1154 | `			return SXERR_ABORT;` |
|  2897855 | 1155 | `		}else if( rcRt == SXERR_SYNTAX ){` |
...
|        - | 1162 | `	{` |
|  2897855 | 1163 | `		sxu32 nArg = SySetUsed(&pMeth->sFunc.aArgs);` |
|        - | 1164 | `		sxu32 i;` |
|  4564167 | 1165 | `		for( i = 0; i < nArg; i++ ){` |
|  1666327 | 1166 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pMeth->sFunc.aArgs,i);` |
|        - | 1167 | `			ph7_class_attr *pAttr;` |
|  1666327 | 1168 | `			sxi32 iAttrFlags = 0;` |
|        - | 1169 | `			int bArgTyped;` |
|  1666327 | 1170 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|  1666241 | 1171 | `				continue;` |
|        - | 1172 | `			}` |
...
|       43 | 1267 | `		}` |
|        - | 1268 | `	}` |
|  2897845 | 1269 | `	if( doBody ){` |
|        - | 1270 | `		/* Compile method body */` |
|  2758017 | 1271 | `		rc = GenStateCompileFuncBody(&(*pGen),&pMeth->sFunc);` |
|  2758017 | 1272 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 | 1273 | `			return SXERR_ABORT;` |
|        - | 1274 | `		}` |
|        - | 1275 | `		/* The cursor sits just past the body's closing brace */` |
|  2758017 | 1276 | `		pMeth->sFunc.nEndLine = pGen->pIn[-1].nLine;` |
|  1379011 | 1277 | `	}else{` |
...
|  2897845 | 1294 | `	rc = PH7_ClassInstallMethod(pClass,pMeth);` |
|  2897845 | 1295 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 1296 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 1297 | `		return SXERR_ABORT;` |
|        - | 1298 | `	}` |
|  2897845 | 1299 | `	return SXRET_OK;` |
|        6 | 1300 | `Synchronize:` |
...
|        - | 2098 | ` */` |
|   444454 | 2099 | `static sxi32 GenStateCheckInterfaceSignatures(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 | 2100 | `{` |
|        - | 2101 | `	ph7_class **apIface;` |
|        - | 2102 | `	sxu32 nIface,i;` |
|        - | 2103 | `	sxi32 rc;` |
|   444459 | 2104 | `	if( pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|      ! 0 | 2105 | `		return SXRET_OK;` |
|        - | 2106 | `	}` |
|   444459 | 2107 | `	apIface = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|   444459 | 2108 | `	nIface = SySetUsed(&pClass->aInterface);` |
|   860187 | 2109 | `	for(i = 0; i < nIface; i++){` |
...
|        - | 2231 | ` */` |
|   444454 | 2232 | `static sxi32 GenStateCheckAbstractMethods(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 | 2233 | `{` |
...
|   444459 | 2240 | `	if( pClass->iFlags & (PH7_CLASS_ABSTRACT\|PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|    19469 | 2241 | `		return SXRET_OK;` |
|        - | 2242 | `	}` |
|        - | 2243 | `	/* Count abstract methods */` |
|   424995 | 2244 | `	nAbstract = 0;` |
|   424995 | 2245 | `	SyHashResetLoopCursor(&pClass->hMethod);` |
|  6385678 | 2246 | `	while((pEntry = SyHashGetNextEntry(&pClass->hMethod)) != 0 ){` |
|  5748193 | 2247 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|  5748193 | 2248 | `		if( pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
...
|        8 | 2253 | `		}` |
|        5 | 2254 | `	}` |
|   424995 | 2255 | `	if( nAbstract == 0 ){` |
|   424981 | 2256 | `		return SXRET_OK;` |
|        - | 2257 | `	}` |
...
|        - | 2394 | ` */` |
|   506950 | 2395 | `PH7_PRIVATE sxi32 GenStateParseClassReference(ph7_gen_state *pGen,SyBlob *pFqn)` |
|        5 | 2396 | `{` |
|   506955 | 2397 | `	int isAbsolute = 0;` |
|   506955 | 2398 | `	SyToken *pStart = pGen->pIn;` |
|        - | 2399 | `	SyBlob sName;` |
|   506955 | 2400 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) ){` |
|     4519 | 2401 | `		isAbsolute = 1;` |
|     4519 | 2402 | `		pGen->pIn++;` |
|     2257 | 2403 | `	}` |
|   506955 | 2404 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|        9 | 2405 | `		pGen->pIn = pStart;` |
|        9 | 2406 | `		return SXERR_INVALID;` |
|        - | 2407 | `	}` |
|   506949 | 2408 | `	SyBlobInit(&sName,&pGen->pVm->sAllocator);` |
|   506949 | 2409 | `	SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|   506949 | 2410 | `	pGen->pIn++;` |
|   760455 | 2411 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) &&` |
|   253516 | 2412 | `		&pGen->pIn[1] < pGen->pEnd && (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|       28 | 2413 | `		SyBlobAppend(&sName,"\\",1);` |
|       28 | 2414 | `		pGen->pIn++;` |
|       28 | 2415 | `		SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|       28 | 2416 | `		pGen->pIn++;` |
|        2 | 2417 | `	}` |
|   506949 | 2418 | `	if( isAbsolute ){` |
...
|        - | 2424 | `	}` |
|   506949 | 2425 | `	SyBlobRelease(&sName);` |
|   506949 | 2426 | `	return SXRET_OK;` |
|   253480 | 2427 | `}` |
|        - | 2428 | `/*` |
...
|        - | 2714 | ` */` |
|   444504 | 2715 | `static sxi32 GenStateCompileClassEx(ph7_gen_state *pGen,sxi32 iFlags,` |
|        - | 2716 | `	SyString *pAnonName,SyToken **ppArgStart,SyToken **ppArgEnd)` |
|        5 | 2717 | `{` |
|   444509 | 2718 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|   444509 | 2729 | `	pGen->pIn++;` |
|   444509 | 2730 | `	if( pAnonName ){` |
...
|       19 | 2745 | `	}else{` |
|   444479 | 2746 | `		if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
|        - | 2747 | `			/* Syntax error */` |
...
|   444479 | 2760 | `		pName = &pGen->pIn->sData;` |
|        - | 2761 | `		/* Advance the stream cursor */` |
|   444479 | 2762 | `		pGen->pIn++;` |
|        - | 2763 | `		/* Build FQN and obtain a raw class */ {` |
|        - | 2764 | `			SyBlob sFQN;` |
|        - | 2765 | `			SyString sFQNStr;` |
|   444479 | 2766 | `			SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|   444479 | 2767 | `			GenStateBuildFQN(pGen,pName,&sFQN);` |
|   444479 | 2768 | `			SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|   444479 | 2769 | `			pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|   444479 | 2770 | `			SyBlobRelease(&sFQN);` |
|        - | 2771 | `		}` |
|        - | 2772 | `	}` |
|   444509 | 2773 | `	if( pClass == 0 ){` |
|      ! 0 | 2774 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2775 | `		return SXERR_ABORT;` |
|        - | 2776 | `	}` |
|   444504 | 2777 | `	if( (iFlags & PH7_CLASS_ENUM) && pGen->pIn < pGen->pEnd` |
...
|        - | 2800 | `		}` |
|     1949 | 2801 | `	}` |
|   444509 | 2802 | `	GenStateConsumeDoc(&(*pGen),&pClass->sDoc);` |
|   444509 | 2803 | `	if( GenStateConsumeAttrs(&(*pGen),&pClass->aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 2804 | `		return SXERR_ABORT;` |
|        - | 2805 | `	}` |
|        - | 2806 | `	/* implemented interfaces and per-use-statement trait containers */` |
|   444509 | 2807 | `	SySetInit(&aInterfaces,&pGen->pVm->sAllocator,sizeof(ph7_class *));` |
|   444509 | 2808 | `	SySetInit(&aUseEntries,&pGen->pVm->sAllocator,sizeof(TraitUseEntry));` |
|        - | 2809 | `	/* Assume a standalone class */` |
|   444509 | 2810 | `	pBase = 0;` |
|   444509 | 2811 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
...
|    68033 | 2947 | `		}` |
|   180750 | 2948 | `	}` |
|   444507 | 2949 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|        - | 2950 | `		/* Syntax error */` |
...
|        - | 2958 | `	}` |
|   444507 | 2959 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|   444507 | 2960 | `	pEnd = 0; /* cc warning */` |
|        - | 2961 | `	/* Delimit the class body */` |
|   444507 | 2962 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|   444507 | 2963 | `	if( pEnd >= pGen->pEnd ){` |
|        - | 2964 | `		/* Syntax error */` |
...
|   444507 | 2974 | `	pClass->nEndLine = pEnd->nLine;` |
|        - | 2975 | `	/* Swap token stream */` |
|   444507 | 2976 | `	pTmp = pGen->pEnd;` |
|   444507 | 2977 | `	pGen->pEnd = pEnd;` |
|        - | 2978 | `	/* Merge the inherited flags (PH7_NewRawClass may have set INTERNAL) */` |
|   444507 | 2979 | `	pClass->iFlags \|= iFlags;` |
|        - | 2980 | `	/* Start the parse process */` |
|  1690556 | 2981 | `	for(;;){` |
|        - | 2982 | `		/* Jump leading/trailing semi-colons */` |
|  4858695 | 2983 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|   886351 | 2984 | `			pGen->pIn++;` |
|        5 | 2985 | `		}` |
|  3972349 | 2986 | `		if( pGen->pIn >= pGen->pEnd ){` |
|        - | 2987 | `			/* End of class body */` |
|   444465 | 2988 | `			break;` |
|        - | 2989 | `		}` |
|        - | 2990 | `		/* Bind a directly-preceding docblock to this member */` |
|  3527889 | 2991 | `		GenStateSetPendingDoc(&(*pGen));` |
|  3527884 | 2992 | `		if( (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR)) == 0` |
|  1763947 | 2993 | ``			&& !GenStateIsReadonly(pGen->pIn) /* allow a leading `readonly` modifier */ ){`` |
...
|  3527889 | 3004 | `		iProtection = PH7_TKWRD_PUBLIC;` |
|  3527889 | 3005 | `		iAttrflags = 0;` |
...
|  3527889 | 3010 | `		if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|      ! 0 | 3011 | `			int bMod = 0;` |
...
|        - | 3032 | `			}` |
|      ! 0 | 3033 | `		}` |
|  3527889 | 3034 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|        - | 3035 | `			/* Extract the current keyword */` |
|  3527889 | 3036 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  3527889 | 3037 | `			if( nKwrd == PH7_TKWRD_CASE && (pClass->iFlags & PH7_CLASS_ENUM) ){` |
...
|     7819 | 3046 | `				continue;` |
|        - | 3047 | `			}` |
|  3520071 | 3048 | `			if( nKwrd == PH7_TKWRD_USE ){` |
...
|    15619 | 3116 | `				continue;` |
|        - | 3117 | `			}` |
|  3504457 | 3118 | `			if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|        - | 3119 | `				int nSetTok;` |
...
|  1209940 | 3178 | `			}` |
|  2963881 | 3179 | `			if( nKwrd == PH7_TKWRD_CONST ){` |
...
|        - | 3187 | `				}` |
|   143719 | 3188 | `			}else{` |
|  2676445 | 3189 | `				if( nKwrd == PH7_TKWRD_STATIC ){` |
...
|  2612268 | 3256 | `				}else if( nKwrd == PH7_TKWRD_ABSTRACT ){` |
...
|  2571423 | 3305 | `				}else if( nKwrd == PH7_TKWRD_FINAL ){` |
...
|        3 | 3349 | `				}` |
|  2649199 | 3350 | `				if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_VAR ){` |
...
|      ! 0 | 3358 | `						goto done;` |
|        - | 3359 | `				}` |
|  2649199 | 3360 | `				if( nKwrd == PH7_TKWRD_VAR ){` |
...
|  2649193 | 3375 | `					rc = GenStateCompileClassMethod(&(*pGen),iProtection,iAttrflags,TRUE,pClass);` |
|        - | 3376 | `				}` |
|  2649199 | 3377 | `				if( rc != SXRET_OK ){` |
...
|        - | 3400 | `		sxu32 nU;` |
|   444465 | 3401 | `		apUse = (TraitUseEntry *)SySetBasePtr(&aUseEntries);` |
|   460079 | 3402 | `		for( nU = 0 ; nU < SySetUsed(&aUseEntries) ; nU++ ){` |
...
|     7812 | 3607 | `		}` |
|        - | 3608 | `	}` |
|   444465 | 3609 | `	if( pClass->iFlags & PH7_CLASS_ENUM ){` |
...
|   444465 | 3620 | `	if( GenStateGuardClassRedeclaration(pGen,pClass) == SXERR_ABORT ){` |
|        9 | 3621 | `		return SXERR_ABORT;` |
|        - | 3622 | `	}` |
|        - | 3623 | `	/* Install the class */` |
|   444459 | 3624 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|   444459 | 3625 | `	if( rc == SXRET_OK ){` |
|        - | 3626 | `		ph7_class **apInterface;` |
|        - | 3627 | `		sxu32 n;` |
|   444459 | 3628 | `		if( pBase ){` |
|        - | 3629 | `			/* Inherit from base class and mark as a subclass */` |
|   240981 | 3630 | `			rc = PH7_ClassInherit(&(*pGen),pClass,pBase);` |
|   120488 | 3631 | `		}` |
|   444459 | 3632 | `		apInterface = (ph7_class **)SySetBasePtr(&aInterfaces);` |
|   642645 | 3633 | `		for( n = 0 ; n < SySetUsed(&aInterfaces) ; n++ ){` |
...
|   444459 | 3642 | `		if( rc == SXRET_OK && (pClass->iFlags & PH7_CLASS_ENUM) ){` |
...
|   444454 | 3662 | `		if( rc == SXRET_OK` |
|   444454 | 3663 | `		 && (pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT)) == 0` |
|   444459 | 3664 | `		 && SyHashGet(&pClass->hMethod,"__toString",sizeof("__toString")-1) != 0 ){` |
...
|   444459 | 3684 | `		if( rc == SXRET_OK ){` |
|   444459 | 3685 | `			sxi32 rcCheck = GenStateCheckInterfaceSignatures(&(*pGen),pClass);` |
|   444459 | 3686 | `			if( rcCheck == SXERR_ABORT ){` |
...
|   444459 | 3693 | `		if( rc == SXRET_OK ){` |
|   444459 | 3694 | `			sxi32 rcCheck = GenStateCheckAbstractMethods(&(*pGen),pClass);` |
|   444459 | 3695 | `			if( rcCheck == SXERR_ABORT ){` |
...
|   222227 | 3700 | `		}` |
|   222227 | 3701 | `	}` |
|   444459 | 3702 | `	SySetRelease(&aUseEntries);` |
|   444459 | 3703 | `	SySetRelease(&aInterfaces);` |
|   444459 | 3704 | `	if( rc != SXRET_OK ){` |
...
|   444501 | 3710 | `	pGen->pIn = &pEnd[1];` |
|   444501 | 3711 | `	pGen->pEnd = pTmp;` |
|   444501 | 3712 | `	return PH7_OK;` |
|   222257 | 3713 | `}` |
|        - | 3714 | `/* Compile a named class declaration (the common case). */` |
|   444474 | 3715 | `static sxi32 GenStateCompileClass(ph7_gen_state *pGen,sxi32 iFlags)` |
|        5 | 3716 | `{` |
|   444479 | 3717 | `	return GenStateCompileClassEx(pGen,iFlags,0,0,0);` |
|        5 | 3718 | `}` |
|        - | 3719 | `/*` |
...
|        - | 3818 | ` */` |
| 14445956 | 3819 | `static int GenStateTokenIsClassModifier(SyToken *pTok,sxi32 *piFlag)` |
|        5 | 3820 | `{` |
| 14445961 | 3821 | `	if( pTok->nType & PH7_TK_KEYWORD ){` |
|  8643297 | 3822 | `		sxu32 nKw = (sxu32)SX_PTR_TO_INT(pTok->pUserData);` |
|  8643297 | 3823 | `		if( nKw == PH7_TKWRD_FINAL ){ *piFlag = PH7_CLASS_FINAL; return TRUE; }` |
|  8588903 | 3824 | `		if( nKw == PH7_TKWRD_ABSTRACT ){ *piFlag = PH7_CLASS_ABSTRACT; return TRUE; }` |
|  4274986 | 3825 | `	}` |
| 14352641 | 3826 | `	if( GenStateIsReadonly(pTok) ){ *piFlag = PH7_CLASS_READONLY; return TRUE; }` |
| 14352581 | 3827 | `	return FALSE;` |
|  7222983 | 3828 | `}` |
|        - | 3829 | `/*` |
...
|        - | 3834 | ` */` |
| 14352576 | 3835 | `static sxi32 GenStateScanClassModifiers(SyToken **ppIn,SyToken *pEnd,SyToken **ppDup)` |
|        5 | 3836 | `{` |
| 14352581 | 3837 | `	SyToken *pIn = *ppIn,*pDup = 0;` |
| 14352581 | 3838 | `	sxi32 iFlags = 0,iFlag;` |
| 14445961 | 3839 | `	while( pIn < pEnd && GenStateTokenIsClassModifier(pIn,&iFlag) ){` |
...
|    93385 | 3844 | `		pIn++;` |
|        5 | 3845 | `	}` |
| 14352581 | 3846 | `	*ppIn = pIn;` |
| 14352581 | 3847 | `	if( ppDup ){ *ppDup = pDup; }` |
| 14352581 | 3848 | `	return iFlags;` |
|        5 | 3849 | `}` |
|        - | 3850 | `/*` |
...
|        - | 3856 | ` */` |
| 14309778 | 3857 | `PH7_PRIVATE int GenStateStartsModifiedClass(SyToken *pIn,SyToken *pEnd)` |
|        5 | 3858 | `{` |
| 14309783 | 3859 | `	sxi32 iFlags = GenStateScanClassModifiers(&pIn,pEnd,0);` |
|  7205458 | 3860 | `	return iFlags != 0 && pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD)` |
| 14335061 | 3861 | `		&& (sxu32)SX_PTR_TO_INT(pIn->pUserData) == PH7_TKWRD_CLASS;` |
|        5 | 3862 | `}` |
|        - | 3863 | `/*` |
...
|        - | 4210 | ` */` |
|   397758 | 4211 | `PH7_PRIVATE sxi32 PH7_CompileClass(ph7_gen_state *pGen)` |
|        5 | 4212 | `{` |
|        - | 4213 | `	sxi32 rc;` |
|   397763 | 4214 | `	rc = GenStateCompileClass(&(*pGen),0);` |
|   397763 | 4215 | `	return rc;` |
|        5 | 4216 | `}` |
|        - | 4217 | `/*` |
...
|        - | 4223 | ` */` |
| 14259216 | 4224 | `PH7_PRIVATE int GenStateStartsEnumDecl(SyToken *pIn,SyToken *pEnd)` |
|        5 | 4225 | `{` |
| 14475278 | 4226 | `	return (pIn->nType & PH7_TK_ID)` |
|  7345665 | 4227 | `		&& pIn->sData.nByte == sizeof("enum")-1` |
|   225908 | 4228 | `		&& SyStrnicmp(pIn->sData.zString,"enum",sizeof("enum")-1) == 0` |
| 14475273 | 4229 | `		&& &pIn[1] < pEnd && (pIn[1].nType & PH7_TK_ID);` |
|        5 | 4230 | `}` |
|        - | 4231 | `/*` |
