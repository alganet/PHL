...
|        - |   26 | ` */` |
|   528522 |   27 | `static sxi32 GenStateGuardClassRedeclaration(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 |   28 | `{` |
|        - |   29 | `	SyHashEntry *pEntry;` |
|   528527 |   30 | `	if( !GenStateUnconditionalTopLevel(pGen) ){` |
|       26 |   31 | `		return SXRET_OK; /* conditional/nested: keep hoisting */` |
|        - |   32 | `	}` |
|   528505 |   33 | `	pClass->iFlags \|= PH7_CLASS_BOUND;` |
|   528505 |   34 | `	if( pGen->pVm->bCompilingBuiltin ){` |
|   526325 |   35 | `		return SXRET_OK; /* the prelude installs each builtin exactly once */` |
|        - |   36 | `	}` |
|     2185 |   37 | `	pEntry = SyHashGet(&pGen->pVm->hClass,(const void *)pClass->sName.zString,pClass->sName.nByte);` |
|     2185 |   38 | `	if( pEntry ){` |
...
|        - |   70 | ` */` |
|  3819038 |   71 | `static sxi32 GetProtectionLevel(sxi32 nKeyword)` |
|        5 |   72 | `{` |
|  3819043 |   73 | `	if( nKeyword == PH7_TKWRD_PRIVATE ){` |
|   278871 |   74 | `		return PH7_CLASS_PROT_PRIVATE;` |
|  3540177 |   75 | `	}else if( nKeyword == PH7_TKWRD_PROTECTED ){` |
|   220697 |   76 | `		return PH7_CLASS_PROT_PROTECTED;` |
|        - |   77 | `	}` |
|        - |   78 | `	/* Assume public by default */` |
|  3319485 |   79 | `	return PH7_CLASS_PROT_PUBLIC;` |
|  1909524 |   80 | `}` |
|        - |   81 | `/*` |
...
|        - |   88 | ` */` |
|   340768 |   89 | `static int GenStateClassConstHasType(ph7_gen_state *pGen)` |
|        5 |   90 | `{` |
|        - |   91 | `	SyToken *p0, *p1;` |
|   340773 |   92 | `	if( pGen->pIn >= pGen->pEnd ){` |
|      ! 0 |   93 | `		return 0;` |
|        - |   94 | `	}` |
|   340773 |   95 | `	p0 = pGen->pIn;` |
|        - |   96 | `	/* A leading '\' (namespaced class type) or '?' (nullable) always starts a type */` |
|   340773 |   97 | `	if( p0->nType & PH7_TK_NSSEP ){` |
|      ! 0 |   98 | `		return 1;` |
|        - |   99 | `	}` |
|   340773 |  100 | `	if( (p0->nType & PH7_TK_OP) && p0->sData.nByte == 1 && p0->sData.zString[0] == '?' ){` |
|        5 |  101 | `		return 1;` |
|        - |  102 | `	}` |
...
|   340769 |  106 | `	if( p0->nType & (PH7_TK_ID\|PH7_TK_KEYWORD) ){` |
|   340769 |  107 | `		p1 = (pGen->pIn + 1 < pGen->pEnd) ? (pGen->pIn + 1) : 0;` |
|   340769 |  108 | `		if( p1 ){` |
|   340769 |  109 | `			if( p1->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_NSSEP) ){` |
|       34 |  110 | `				return 1;` |
|        - |  111 | `			}` |
|   340739 |  112 | `			if( (p1->nType & PH7_TK_OP) && p1->sData.nByte == 1 && p1->sData.zString[0] == '\|' ){` |
|        5 |  113 | `				return 1;` |
|        - |  114 | `			}` |
|   170365 |  115 | `		}` |
|   170365 |  116 | `	}` |
...
|        - |  172 | ` */` |
|   720806 |  173 | `static int GenStateInitHasNewExpr(ph7_gen_state *pGen)` |
|        5 |  174 | `{` |
|   720811 |  175 | `	SyToken *p = pGen->pIn;` |
|   720811 |  176 | `	int iDepth = 0;` |
|  1903791 |  177 | `	while( p < pGen->pEnd ){` |
|  1903791 |  178 | `		if( iDepth == 0 && (p->nType & (PH7_TK_SEMI\|PH7_TK_COMMA)) ){` |
|   720759 |  179 | `			break; /* end of this initializer */` |
|        - |  180 | `		}` |
|  1183032 |  181 | `		if( (p->nType & PH7_TK_KEYWORD)` |
|   599281 |  182 | `			&& ( SX_PTR_TO_INT(p->pUserData) == PH7_TKWRD_FUNCTION` |
|    15519 |  183 | `				\|\| SX_PTR_TO_INT(p->pUserData) == PH7_TKWRD_FN ) ){` |
...
|        6 |  241 | `			continue;` |
|        - |  242 | `		}` |
|  1183033 |  243 | `		if( p->nType & PH7_TK_OCB ){` |
|       45 |  244 | `			if( iDepth == 0 ){` |
...
|        - |  250 | `			}` |
|      ! 0 |  251 | `			iDepth++;` |
|  1182989 |  252 | `		}else if( p->nType & (PH7_TK_LPAREN\|PH7_TK_OSB) ){` |
|    50415 |  253 | `			iDepth++;` |
|  1157784 |  254 | `		}else if( p->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB) ){` |
|    50413 |  255 | `			if( iDepth > 0 ){` |
|    50413 |  256 | `				iDepth--;` |
|    25204 |  257 | `			}` |
|  1107375 |  258 | `		}else if( (p->nType & PH7_TK_OP) && p->pUserData` |
|   390029 |  259 | `			&& ((const ph7_expr_op *)p->pUserData)->iOp == EXPR_OP_NEW ){` |
...
|        - |  277 | ` */` |
|  1270866 |  278 | `static ph7_class_attr * GenStateExtractConstant(ph7_class *pClass,SyString *pName)` |
|        5 |  279 | `{` |
|  1270871 |  280 | `	ph7_class_attr *pAttr = PH7_ClassExtractAttribute(pClass,pName->zString,pName->nByte);` |
|  1270871 |  281 | `	return ( pAttr && (pAttr->iFlags & PH7_CLASS_ATTR_CONSTANT) ) ? pAttr : 0;` |
|        5 |  282 | `}` |
|  1519536 |  283 | `static ph7_class_attr * GenStateExtractProperty(ph7_class *pClass,const char *zName,sxu32 nByte)` |
|        5 |  284 | `{` |
|  1519541 |  285 | `	ph7_class_attr *pAttr = PH7_ClassExtractAttribute(pClass,zName,nByte);` |
|  1519541 |  286 | `	return ( pAttr && (pAttr->iFlags & PH7_CLASS_ATTR_CONSTANT) == 0 ) ? pAttr : 0;` |
|        5 |  287 | `}` |
|        - |  288 | `/*` |
...
|        - |  308 | ` */` |
|   720856 |  309 | `PH7_PRIVATE int PH7_GenStateInitHasCallExpr(ph7_gen_state *pGen)` |
|        5 |  310 | `{` |
|   720861 |  311 | `	SyToken *p = pGen->pIn;` |
|   720861 |  312 | `	int iDepth = 0;` |
|        - |  313 | `	/* Conservative ternary bail-out (see the note above). */` |
|        - |  314 | `	{` |
|   720861 |  315 | `		SyToken *q = pGen->pIn;` |
|   720861 |  316 | `		int iQd = 0;` |
|  1905139 |  317 | `		while( q < pGen->pEnd ){` |
|  1905101 |  318 | `			if( iQd == 0 && (q->nType & (PH7_TK_SEMI\|PH7_TK_COMMA)) ){` |
|   720817 |  319 | `				break;` |
|        - |  320 | `			}` |
|  1184289 |  321 | `			if( q->nType & (PH7_TK_LPAREN\|PH7_TK_OSB\|PH7_TK_OCB) ){` |
|    50551 |  322 | `				iQd++;` |
|  1159016 |  323 | `			}else if( q->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB) ){` |
|    50551 |  324 | `				if( iQd > 0 ){ iQd--; }` |
|  1108470 |  325 | `			}else if( (q->nType & PH7_TK_OP) && q->pUserData` |
|   390255 |  326 | `				&& ((const ph7_expr_op *)q->pUserData)->iOp == EXPR_OP_QUESTY ){` |
|        8 |  327 | `				return 0;` |
|        - |  328 | `			}` |
|  1184283 |  329 | `			q++;` |
|        5 |  330 | `		}` |
|        - |  331 | `	}` |
|  1903985 |  332 | `	while( p < pGen->pEnd ){` |
|  1903985 |  333 | `		if( iDepth == 0 && (p->nType & (PH7_TK_SEMI\|PH7_TK_COMMA)) ){` |
|   720811 |  334 | `			break; /* end of this initializer */` |
|        - |  335 | `		}` |
|  1183174 |  336 | `		if( (p->nType & PH7_TK_KEYWORD)` |
|   599352 |  337 | `			&& ( SX_PTR_TO_INT(p->pUserData) == PH7_TKWRD_FUNCTION` |
|    15519 |  338 | `				\|\| SX_PTR_TO_INT(p->pUserData) == PH7_TKWRD_FN ) ){` |
...
|        6 |  388 | `			continue;` |
|        - |  389 | `		}` |
|  1183175 |  390 | `		if( p->nType & PH7_TK_OCB ){` |
|       43 |  391 | `			if( iDepth == 0 ){` |
|       43 |  392 | `				break; /* property-hook list: the default expression ends here */` |
|        - |  393 | `			}` |
|      ! 0 |  394 | `			iDepth++;` |
|  1183133 |  395 | `		}else if( p->nType & (PH7_TK_LPAREN\|PH7_TK_OSB) ){` |
...
|    50430 |  399 | `			if( (p->nType & PH7_TK_LPAREN) && p > pGen->pIn` |
|    15510 |  400 | `				&& (p[-1].nType & PH7_TK_ID)` |
|     7767 |  401 | `				&& !((p[-1].nType & PH7_TK_OP) && p[-1].pUserData` |
...
|        6 |  421 | `			}` |
|    50433 |  422 | `			iDepth++;` |
|  1157917 |  423 | `		}else if( p->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB) ){` |
|    50433 |  424 | `			if( iDepth > 0 ){` |
|    50433 |  425 | `				iDepth--;` |
|    25214 |  426 | `			}` |
|    25214 |  427 | `		}` |
|  1183131 |  428 | `		p++;` |
...
|        - |  439 | ` */` |
|    15874 |  440 | `static void GenStateCopyTypeToAttr(ph7_class_attr *pAttr,sxu32 nType,` |
|        - |  441 | `	const SyString *pClass,const SyString *pTypeName,sxi32 iTypeFlags,SySet *pAlts)` |
|        5 |  442 | `{` |
|    15879 |  443 | `	pAttr->nType = nType;` |
|    15879 |  444 | `	pAttr->sClass = *pClass;` |
|    15879 |  445 | `	pAttr->sTypeName = *pTypeName;` |
|    15879 |  446 | `	if( iTypeFlags & PH7_CLASS_ATTR_UNION ){` |
|        - |  447 | `		sxu32 i;` |
...
|       11 |  452 | `	}` |
|    15879 |  453 | `}` |
|   340768 |  454 | `static sxi32 GenStateCompileClassConstant(ph7_gen_state *pGen,sxi32 iProtection,sxi32 iFlags,ph7_class *pClass)` |
|        5 |  455 | `{` |
|   340773 |  456 | `	sxu32 nLine = pGen->pIn->nLine;` |
|        - |  457 | `	SySet *pInstrContainer;` |
|        - |  458 | `	ph7_class_attr *pCons;` |
|        - |  459 | `	SyString *pName;` |
|        - |  460 | `	sxi32 rc;` |
|   340773 |  461 | `	sxu32 nType = 0;` |
|        - |  462 | `	SyString sTypeClass;` |
|        - |  463 | `	SyString sTypeText;` |
|        - |  464 | `	SySet aUnionAlts;` |
|   340773 |  465 | `	sxi32 iTypeFlags = 0;` |
|   340773 |  466 | `	SyStringInitFromBuf(&sTypeClass,0,0);` |
|   340773 |  467 | `	SyStringInitFromBuf(&sTypeText,0,0);` |
|   340773 |  468 | `	SySetInit(&aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|        - |  469 | `	/* Extract visibility level */` |
|   340773 |  470 | `	iProtection = GetProtectionLevel(iProtection);` |
|        - |  471 | `	/* Mark as constant */` |
|   340773 |  472 | `	iFlags \|= PH7_CLASS_ATTR_CONSTANT;` |
|   340773 |  473 | `	pGen->pIn++; /* Jump the 'const' keyword */` |
...
|   340792 |  476 | `	if( GenStateClassConstHasType(pGen) ){` |
...
|       19 |  497 | `	}` |
|   170384 |  498 | `loop:` |
|   340775 |  499 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
...
|   340775 |  509 | `	pName = &pGen->pIn->sData;` |
|        - |  510 | `	/* Make sure the constant name isn't reserved */` |
|   340775 |  511 | `	if( GenStateIsReservedConstant(pName) ){` |
...
|   340775 |  521 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
...
|   340773 |  532 | `	pGen->pIn++;` |
|   340773 |  533 | `	if(pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_EQUAL /* '=' */) == 0 ){` |
...
|        - |  541 | `	}` |
|   340773 |  542 | `	pGen->pIn++; /* Jump the equal sign */` |
...
|   340768 |  547 | `	if( (iTypeFlags & PH7_CLASS_ATTR_TYPED) && !(iTypeFlags & PH7_CLASS_ATTR_UNION)` |
...
|   340769 |  559 | `	if( PH7_GenStateInitHasCallExpr(pGen) ){` |
...
|   340769 |  570 | `	if( GenStateInitHasNewExpr(pGen) ){` |
...
|   340760 |  586 | `	if( GenStateExtractConstant(pClass,pName) == 0` |
|   340765 |  587 | `	 && GenStateExtractProperty(pClass,pName->zString,pName->nByte) != 0 ){` |
...
|        - |  595 | `	}` |
|   340765 |  596 | `	if( GenStateExtractConstant(pClass,pName) != 0 ){` |
...
|   340765 |  605 | `	pCons = PH7_NewClassAttr(pGen->pVm,pName,nLine,iProtection,iFlags\|iTypeFlags);` |
|   340765 |  606 | `	if( pCons ){` |
|   340765 |  607 | `		GenStateConsumeDoc(&(*pGen),&pCons->sDoc);` |
|   340765 |  608 | `		if( GenStateConsumeAttrs(&(*pGen),&pCons->aAttrs) == SXERR_ABORT ){` |
|      ! 0 |  609 | `			return SXERR_ABORT;` |
|        - |  610 | `		}` |
|   170380 |  611 | `	}` |
|   340765 |  612 | `	if( pCons == 0 ){` |
|      ! 0 |  613 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 |  614 | `		return SXERR_ABORT;` |
|        - |  615 | `	}` |
|   340765 |  616 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|       35 |  617 | `		GenStateCopyTypeToAttr(pCons,nType,&sTypeClass,&sTypeText,iTypeFlags,&aUnionAlts);` |
|       16 |  618 | `	}` |
|        - |  619 | `	/* Swap bytecode container */` |
|   340765 |  620 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   340765 |  621 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pCons->aByteCode);` |
|        - |  622 | `	/* Compile constant value.` |
|        - |  623 | `	 */` |
|   340765 |  624 | `	rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|   340765 |  625 | `	if( rc == SXERR_EMPTY ){` |
...
|   340765 |  632 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|   340765 |  633 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|   340765 |  634 | `	if( rc == SXERR_ABORT ){` |
...
|   340765 |  639 | `	rc = PH7_ClassInstallAttr(pClass,pCons);` |
|   340765 |  640 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  641 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 |  642 | `		return SXERR_ABORT;` |
|        - |  643 | `	}` |
|   340765 |  644 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA /*','*/) ){` |
...
|        - |  662 | `		}` |
|      ! 0 |  663 | `	}` |
|   340763 |  664 | `	SySetRelease(&aUnionAlts);` |
|   340763 |  665 | `	return SXRET_OK;` |
|        5 |  666 | `Synchronize:` |
...
|        - |  702 | ` */` |
|  2614236 |  703 | `static int GenStateLooksLikeTypedProperty(SyToken *pStart,SyToken *pEnd)` |
|        5 |  704 | `{` |
|  2614241 |  705 | `	SyToken *p = pStart;` |
|  2614241 |  706 | `	int bFirst = 1;` |
|  2614241 |  707 | `	if( p >= pEnd ) return 0;` |
|        - |  708 | ``	/* Optional nullable `?` shorthand. */`` |
|  2614241 |  709 | `	if( (p->nType & PH7_TK_OP) && p->sData.nByte == 1 && p->sData.zString[0] == '?' ){` |
|       41 |  710 | `		p++;` |
...
|  1307118 |  717 | `	for(;;){` |
|  2614261 |  718 | `		if( p < pEnd && (p->nType & PH7_TK_LPAREN) ){` |
...
|  2614259 |  727 | `			if( p < pEnd && (p->nType & PH7_TK_NSSEP) ){ p++; }` |
|  2614259 |  728 | `			if( p >= pEnd \|\| (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|      ! 0 |  729 | `				return 0;` |
|        - |  730 | `			}` |
...
|  2614259 |  734 | `			if( bFirst && (p->nType & PH7_TK_KEYWORD) ){` |
|  2614203 |  735 | `				sxu32 k = (sxu32)(SX_PTR_TO_INT(p->pUserData));` |
|  2614198 |  736 | `				if( k == PH7_TKWRD_FUNCTION \|\| k == PH7_TKWRD_VAR \|\| k == PH7_TKWRD_CONST` |
|   124342 |  737 | `				 \|\| k == PH7_TKWRD_STATIC \|\| k == PH7_TKWRD_FINAL \|\| k == PH7_TKWRD_ABSTRACT ){` |
|  2598405 |  738 | `					return 0;` |
|        - |  739 | `				}` |
|     7899 |  740 | `			}` |
|    15859 |  741 | `			p++;` |
|    15861 |  742 | `			while( p + 1 < pEnd && (p->nType & PH7_TK_NSSEP) && (p[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|        3 |  743 | `				p += 2;` |
|        1 |  744 | `			}` |
|    23784 |  745 | `			while( p + 1 < pEnd && (p->nType & PH7_TK_AMPER)` |
|    15862 |  746 | `				&& (p[1].nType & (PH7_TK_NSSEP\|PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|        3 |  747 | `				p++; /* skip '&' */` |
...
|        - |  755 | `		}` |
|    15861 |  756 | `		bFirst = 0;` |
|    15856 |  757 | `		if( p < pEnd && (p->nType & PH7_TK_OP) && p->sData.nByte == 1` |
...
|    15841 |  762 | `		break;` |
|      ! 0 |  763 | `	}` |
|    15841 |  764 | `	if( p >= pEnd ) return 0;` |
|    15841 |  765 | `	return (p->nType & PH7_TK_DOLLAR) ? 1 : 0;` |
|  1307123 |  766 | `}` |
|        - |  767 |  |
|        - |  768 | `/*` |
...
|        - |  785 | ` */` |
|    15846 |  786 | `static sxi32 GenStateParsePropertyType(` |
...
|        - |  792 | `	SySet *pAlts` |
|        5 |  793 | `){` |
|    15851 |  794 | `	sxi32 iFlags = 0;` |
|        - |  795 | `	sxi32 rc;` |
|    15851 |  796 | `	if( pGen->pIn >= pGen->pEnd ){` |
|      ! 0 |  797 | `		return SXRET_OK;` |
|        - |  798 | `	}` |
|        - |  799 | `	/* If the first token is '$', there's no type */` |
|    15851 |  800 | `	if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|      ! 0 |  801 | `		return SXRET_OK;` |
|        - |  802 | `	}` |
|    15851 |  803 | `	rc = GenStateParseUnionTypeDecl(` |
|     7923 |  804 | `		pGen, pnType, pClass, pAlts, &iFlags, pTypeText,` |
|        - |  805 | `		PH7_CLASS_ATTR_NULLABLE,` |
|        - |  806 | `		PH7_CLASS_ATTR_UNION,` |
|        - |  807 | `		/* bAllowVoid */ 0,` |
|    15846 |  808 | `		pGen->pIn->nLine);` |
|    15851 |  809 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  810 | `		return rc;` |
|        - |  811 | `	}` |
|        - |  812 | `	/* Verify next token is '$' (start of property name) */` |
|    15851 |  813 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
|      ! 0 |  814 | `		return SXERR_SYNTAX;` |
|        - |  815 | `	}` |
|    15851 |  816 | `	*piTypeFlags = iFlags \| PH7_CLASS_ATTR_TYPED;` |
|    15851 |  817 | `	return SXRET_OK;` |
|     7928 |  818 | `}` |
|        - |  819 |  |
|        - |  820 | `/*` |
...
|        - |  830 | ` */` |
|    16024 |  831 | `static int GenStateIsDisallowedPropertyAtom(` |
|        - |  832 | `	sxu32 nType,` |
...
|        - |  837 | `	const char *z;` |
|        - |  838 | `	sxu32 n;` |
|    16029 |  839 | `	if( nType != SXU32_HIGH \|\| pClass == 0 \|\| pClass->nByte == 0 ){` |
|    15963 |  840 | `		return 0;` |
|        - |  841 | `	}` |
...
|        - |  863 | ` */` |
|    15962 |  864 | `PH7_PRIVATE sxi32 GenStateValidateMemberType(` |
...
|        - |  873 | `	sxu32 nLine)` |
|        5 |  874 | `{` |
|    15967 |  875 | `	const char *zBad = 0;` |
|    15967 |  876 | `	sxu32 nBad = 0;` |
|        - |  877 | `	SyString sFallback;` |
|        - |  878 | `	const SyString *pBad;` |
|        - |  879 | `	sxi32 rc;` |
|    15967 |  880 | `	int bDisallowed = 0;` |
|    15967 |  881 | `	if( GenStateIsDisallowedPropertyAtom(nType,pTypeClass,&zBad,&nBad) ){` |
|        5 |  882 | `		bDisallowed = 1;` |
|    15965 |  883 | `	}else if( pUnionAlts ){` |
|        - |  884 | `		sxu32 i;` |
...
|       34 |  891 | `		}` |
|       15 |  892 | `	}` |
|    15967 |  893 | `	if( !bDisallowed ){` |
|    15961 |  894 | `		return SXRET_OK;` |
|        - |  895 | `	}` |
...
|        - |  918 | ` */` |
| 23462400 |  919 | `PH7_PRIVATE int GenStateIsReadonly(SyToken *pTok)` |
|        5 |  920 | `{` |
| 23687826 |  921 | `	return (pTok->nType & PH7_TK_ID)` |
| 11956621 |  922 | `		&& pTok->sData.nByte == sizeof("readonly")-1` |
| 23687821 |  923 | `		&& SyStrnicmp(pTok->sData.zString,"readonly",sizeof("readonly")-1) == 0;` |
|        5 |  924 | `}` |
|        - |  925 | `/*` |
...
|        - |  930 | ` */` |
|  8425002 |  931 | `PH7_PRIVATE sxi32 GenStatePeekSetVisibility(SyToken *pTok,SyToken *pEnd,int *pnTok)` |
|        5 |  932 | `{` |
|  8425007 |  933 | `	*pnTok = 0;` |
|  8425002 |  934 | `	if( &pTok[3] < pEnd` |
|  7876542 |  935 | `	 && (pTok->nType & PH7_TK_KEYWORD)` |
|  6423647 |  936 | `	 && (pTok[1].nType & PH7_TK_LPAREN)` |
|  2759614 |  937 | `	 && (pTok[2].nType & (PH7_TK_ID\|PH7_TK_KEYWORD))` |
...
|        9 |  959 | `}` |
|   589356 |  960 | `static sxi32 GenStateCompileClassAttr(ph7_gen_state *pGen,sxi32 iProtection,sxi32 iFlags,ph7_class *pClass)` |
|        5 |  961 | `{` |
|   589361 |  962 | `	sxu32 nLine = pGen->pIn->nLine;` |
|        - |  963 | `	ph7_class_attr *pAttr;` |
|        - |  964 | `	SyString *pName;` |
|        - |  965 | `	sxi32 rc;` |
|   589361 |  966 | `	sxu32 nType = 0;` |
|        - |  967 | `	SyString sTypeClass;` |
|        - |  968 | `	SyString sTypeText;` |
|        - |  969 | `	SySet aUnionAlts;` |
|   589361 |  970 | `	sxi32 iTypeFlags = 0;` |
|   589361 |  971 | `	SyStringInitFromBuf(&sTypeClass,0,0);` |
|   589361 |  972 | `	SyStringInitFromBuf(&sTypeText,0,0);` |
|   589361 |  973 | `	SySetInit(&aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
...
|   589361 |  977 | `	if( pClass->iFlags & PH7_CLASS_READONLY ){` |
|       21 |  978 | `		iFlags \|= PH7_CLASS_ATTR_READONLY;` |
|        9 |  979 | `	}` |
|        - |  980 | `	/* Extract visibility level */` |
|   589361 |  981 | `	iProtection = GetProtectionLevel(iProtection);` |
|        - |  982 | `	/* Parse optional type hint (typed properties, PHP 7.4+) */` |
|   597284 |  983 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
|    15851 |  984 | `		rc = GenStateParsePropertyType(pGen,&nType,&sTypeClass,&iTypeFlags,&sTypeText,&aUnionAlts);` |
|    15851 |  985 | `		if( rc == SXERR_CORRUPT ){` |
|        - |  986 | `			/* Error already reported by GenStateParseUnionTypeDecl */` |
|      ! 0 |  987 | `			goto Synchronize;` |
|    15851 |  988 | `		}else if( rc == SXERR_SYNTAX ){` |
...
|    15851 |  996 | `		}else if( rc == SXERR_ABORT ){` |
|      ! 0 |  997 | `			return SXERR_ABORT;` |
|        - |  998 | `		}` |
|     7923 |  999 | `	}` |
|      ! 0 | 1000 | `loop:` |
|   589365 | 1001 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
...
|        - | 1007 | `	}` |
|   589365 | 1008 | `	pGen->pIn++; /* Jump the dollar sign */` |
|   589365 | 1009 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_ID)) == 0 ){` |
...
|   589365 | 1019 | `	pName = &pGen->pIn->sData;` |
|        - | 1020 | `	/* Advance the stream cursor */` |
|   589365 | 1021 | `	pGen->pIn++;` |
|   589365 | 1022 | `	if(pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_EQUAL/*'='*/\|PH7_TK_SEMI/*';'*/\|PH7_TK_COMMA/*','*/\|PH7_TK_OCB/*'{' hooks*/)) == 0 ){` |
...
|   589363 | 1034 | `	if( iFlags & (PH7_CLASS_ATTR_PRIVATE_SET\|PH7_CLASS_ATTR_PROTECTED_SET\|PH7_CLASS_ATTR_PUBLIC_SET) ){` |
...
|   589363 | 1054 | `	if( iFlags & PH7_CLASS_ATTR_READONLY ){` |
...
|   589353 | 1074 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|    23771 | 1075 | `		rc = GenStateValidateMemberType(pGen,pClass,pName,nType,&sTypeClass,` |
|        - | 1076 | `			&sTypeText,` |
|    15844 | 1077 | `			(iTypeFlags & PH7_CLASS_ATTR_UNION) ? &aUnionAlts : 0,` |
|     7922 | 1078 | `			"Property %z::$%z cannot have type %z",nLine);` |
|    15849 | 1079 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 | 1080 | `			return SXERR_ABORT;` |
|    15849 | 1081 | `		}else if( rc != SXRET_OK ){` |
...
|   589348 | 1088 | `	if( GenStateExtractProperty(pClass,pName->zString,pName->nByte) == 0` |
|   589352 | 1089 | `	 && GenStateExtractConstant(pClass,pName) != 0 ){` |
...
|        - | 1097 | `	}` |
|   589353 | 1098 | `	if( GenStateExtractProperty(pClass,pName->zString,pName->nByte) != 0 ){` |
...
|   589351 | 1113 | `	if( (pGen->pIn->nType & PH7_TK_EQUAL /*'='*/) && PH7_GenStateInitHasCallExpr(pGen) ){` |
...
|        - | 1120 | `	}` |
|   589351 | 1121 | `	if( (pGen->pIn->nType & PH7_TK_EQUAL /*'='*/) && GenStateInitHasNewExpr(pGen) ){` |
...
|   589347 | 1130 | `	pAttr = PH7_NewClassAttr(pGen->pVm,pName,nLine,iProtection,iFlags\|iTypeFlags);` |
|   589347 | 1131 | `	if( pAttr ){` |
|   589347 | 1132 | `		GenStateConsumeDoc(&(*pGen),&pAttr->sDoc);` |
|   589347 | 1133 | `		if( GenStateConsumeAttrs(&(*pGen),&pAttr->aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 1134 | `			return SXERR_ABORT;` |
|        - | 1135 | `		}` |
|   294671 | 1136 | `	}` |
|   589347 | 1137 | `	if( pAttr == 0 ){` |
|      ! 0 | 1138 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 engine is running out of memory");` |
|      ! 0 | 1139 | `		return SXERR_ABORT;` |
|        - | 1140 | `	}` |
|   589347 | 1141 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|    15847 | 1142 | `		GenStateCopyTypeToAttr(pAttr,nType,&sTypeClass,&sTypeText,iTypeFlags,&aUnionAlts);` |
|     7921 | 1143 | `	}` |
|   589347 | 1144 | `	if( pGen->pIn->nType & PH7_TK_EQUAL /*'='*/ ){` |
|        - | 1145 | `		SySet *pInstrContainer;` |
|   380043 | 1146 | `		SyToken *pSavedDefEnd = pGen->pEnd;` |
|   380043 | 1147 | `		pGen->pIn++; /*Jump the equal sign */` |
|        - | 1148 | `		{` |
...
|   380043 | 1153 | `			SyToken *pScan = pGen->pIn;` |
|   380043 | 1154 | `			sxi32 iNest = 0;` |
|   838099 | 1155 | `			while( pScan < pGen->pEnd ){` |
|   838099 | 1156 | `				if( pScan->nType & (PH7_TK_LPAREN\|PH7_TK_OSB) ){` |
|    50403 | 1157 | `					iNest++;` |
|   812900 | 1158 | `				}else if( pScan->nType & (PH7_TK_RPAREN\|PH7_TK_CSB) ){` |
|    50403 | 1159 | `					iNest--;` |
|   762502 | 1160 | `				}else if( iNest <= 0 && (pScan->nType & (PH7_TK_SEMI\|PH7_TK_COMMA\|PH7_TK_OCB)) ){` |
|   380043 | 1161 | `					break;` |
|        - | 1162 | `				}` |
|   458061 | 1163 | `				pScan++;` |
|        5 | 1164 | `			}` |
|   380043 | 1165 | `			pGen->pEnd = pScan;` |
|        - | 1166 | `		}` |
|        - | 1167 | `		/* Swap bytecode container */` |
|   380043 | 1168 | `		pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   380043 | 1169 | `		PH7_VmSetByteCodeContainer(pGen->pVm,&pAttr->aByteCode);` |
|        - | 1170 | `		/* Compile attribute value.` |
|        - | 1171 | `		 */` |
|   380043 | 1172 | `		rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|   380043 | 1173 | `		if( rc == SXERR_EMPTY ){` |
...
|   380043 | 1180 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|   380043 | 1181 | `		PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|   380043 | 1182 | `		pGen->pIn = pGen->pEnd;   /* land exactly on the delimiter */` |
|   380043 | 1183 | `		pGen->pEnd = pSavedDefEnd;` |
|   190019 | 1184 | `	}` |
|        - | 1185 | `	/* All done,install the attribute */` |
|   589347 | 1186 | `	rc = PH7_ClassInstallAttr(pClass,pAttr);` |
|   589347 | 1187 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 1188 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 1189 | `		return SXERR_ABORT;` |
|        - | 1190 | `	}` |
|   589347 | 1191 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) ){` |
...
|        - | 1203 | `	}` |
|   589253 | 1204 | `	if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
...
|        - | 1215 | `	}` |
|   589253 | 1216 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA /*','*/) ){` |
...
|        - | 1234 | `		}` |
|      ! 0 | 1235 | `	}` |
|   589249 | 1236 | `	SySetRelease(&aUnionAlts);` |
|   589249 | 1237 | `	return SXRET_OK;` |
|        9 | 1238 | `Synchronize:` |
...
|        - | 1253 | ` */` |
|  2888914 | 1254 | `static sxi32 GenStateCompileClassMethod(` |
...
|        - | 1260 | `	)` |
|        5 | 1261 | `{` |
|  2888919 | 1262 | `	sxu32 nLine = pGen->pIn->nLine;` |
|  2888919 | 1263 | `	sxu32 nKwLine = nLine; /* Line of the 'function' keyword (Reflection getStartLine) */` |
...
|  2888919 | 1270 | `	iProtection = GetProtectionLevel(iProtection);` |
|  2888919 | 1271 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|  2888919 | 1272 | `	iFuncFlags = 0;` |
|  2888919 | 1273 | `	if( pGen->pIn >= pGen->pEnd ){` |
...
|        - | 1281 | `	}` |
|  2888919 | 1282 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|        - | 1283 | `		/* Return by reference,remember that */` |
|      ! 0 | 1284 | `		iFuncFlags \|= VM_FUNC_REF_RETURN;` |
|        - | 1285 | `		/* Jump the '&' token */` |
|      ! 0 | 1286 | `		pGen->pIn++;` |
|      ! 0 | 1287 | `	}` |
|  2888919 | 1288 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|  2888919 | 1297 | `	pName = &pGen->pIn->sData;` |
|  2888919 | 1298 | `	nLine = pGen->pIn->nLine;` |
|        - | 1299 | `	/* Jump the method name */` |
|  2888919 | 1300 | `	pGen->pIn++;` |
|  2888919 | 1301 | `	if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|        - | 1302 | `		/* Abstract method */` |
|   139401 | 1303 | `		if( iProtection == PH7_CLASS_PROT_PRIVATE ){` |
...
|   139401 | 1312 | `		doBody = FALSE;` |
|    69698 | 1313 | `	}` |
|  2888919 | 1314 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|        - | 1315 | `		/* Syntax error */` |
...
|  2888919 | 1324 | `	pMeth = PH7_NewClassMethod(pGen->pVm,pClass,pName,nLine,iProtection,iFlags,iFuncFlags);` |
|  2888919 | 1325 | `	if( pMeth == 0 ){` |
|      ! 0 | 1326 | `		PH7_GenCompileError(&(*pGen),E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 1327 | `		return SXERR_ABORT;` |
|        - | 1328 | `	}` |
|  2888919 | 1329 | `	pMeth->sFunc.nLine = nKwLine;` |
|  2888919 | 1330 | `	GenStateConsumeDoc(&(*pGen),&pMeth->sFunc.sDoc);` |
|  2888919 | 1331 | `	if( GenStateConsumeAttrs(&(*pGen),&pMeth->sFunc.aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 1332 | `		return SXERR_ABORT;` |
|        - | 1333 | `	}` |
|        - | 1334 | `	/* Jump the left parenthesis '(' */` |
|  2888919 | 1335 | `	pGen->pIn++;` |
|  2888919 | 1336 | `	pEnd = 0; /* cc warning */` |
|        - | 1337 | `	/* Delimit the method signature */` |
|  2888919 | 1338 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|  2888919 | 1339 | `	if( pEnd >= pGen->pEnd ){` |
|        - | 1340 | `		/* Syntax error */` |
...
|        - | 1347 | `	}` |
|        - | 1348 | `	{` |
|  2888917 | 1349 | `		int bIsCtor = 0;` |
|  2888917 | 1350 | `		int bAbstractCtor = 0;` |
|  2888912 | 1351 | `		if( (pName->nByte == sizeof("__construct") - 1` |
|  1696177 | 1352 | `				&& SyMemcmp(pName->zString,"__construct",sizeof("__construct") - 1) == 0)` |
|  2786249 | 1353 | `		 \|\| SyStringCmp(pName,&pClass->sName,SyMemcmp) == 0 ){` |
|   205341 | 1354 | `			if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|        3 | 1355 | `				bAbstractCtor = 1;` |
|        2 | 1356 | `			}else{` |
|   205339 | 1357 | `				bIsCtor = 1;` |
|        - | 1358 | `			}` |
|   102668 | 1359 | `		}` |
|  2888917 | 1360 | `		if( pGen->pIn < pEnd ){` |
|        - | 1361 | `			/* Collect method arguments */` |
|  1111435 | 1362 | `			rc = GenStateCollectFuncArgs(&pMeth->sFunc,&(*pGen),pEnd,bIsCtor,bAbstractCtor);` |
|  1111435 | 1363 | `			if( rc == SXERR_ABORT ){` |
|      ! 0 | 1364 | `				return SXERR_ABORT;` |
|        - | 1365 | `			}` |
|   555715 | 1366 | `		}` |
|        - | 1367 | `	}` |
|        - | 1368 | `	/* Point past ')' and parse optional return type ': type' */` |
|  2888917 | 1369 | `	pGen->pIn = &pEnd[1];` |
|        - | 1370 | `	{` |
|  2888917 | 1371 | `		sxi32 rcRt = GenStateParseReturnType(pGen, &pMeth->sFunc);` |
|  2888917 | 1372 | `		if( rcRt == SXERR_ABORT ){` |
|      ! 0 | 1373 | `			return SXERR_ABORT;` |
|  2888917 | 1374 | `		}else if( rcRt == SXERR_SYNTAX ){` |
...
|        - | 1381 | `	{` |
|  2888917 | 1382 | `		sxu32 nArg = SySetUsed(&pMeth->sFunc.aArgs);` |
|        - | 1383 | `		sxu32 i;` |
|  4550081 | 1384 | `		for( i = 0; i < nArg; i++ ){` |
|  1661179 | 1385 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pMeth->sFunc.aArgs,i);` |
|        - | 1386 | `			ph7_class_attr *pAttr;` |
|  1661179 | 1387 | `			sxi32 iAttrFlags = 0;` |
|        - | 1388 | `			int bArgTyped;` |
|  1661179 | 1389 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|  1661093 | 1390 | `				continue;` |
|        - | 1391 | `			}` |
...
|       43 | 1486 | `		}` |
|        - | 1487 | `	}` |
|  2888907 | 1488 | `	if( doBody ){` |
|        - | 1489 | `		/* Compile method body */` |
|  2749511 | 1490 | `		rc = GenStateCompileFuncBody(&(*pGen),&pMeth->sFunc);` |
|  2749511 | 1491 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 | 1492 | `			return SXERR_ABORT;` |
|        - | 1493 | `		}` |
|        - | 1494 | `		/* The cursor sits just past the body's closing brace */` |
|  2749511 | 1495 | `		pMeth->sFunc.nEndLine = pGen->pIn[-1].nLine;` |
|  1374758 | 1496 | `	}else{` |
|        - | 1497 | `		/* Abstract/interface method: declaration ends at the ';' */` |
|   139401 | 1498 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI /* ';'*/) ){` |
|   139401 | 1499 | `			pMeth->sFunc.nEndLine = pGen->pIn->nLine;` |
|    69698 | 1500 | `		}` |
|        - | 1501 | `		/* Only method signature is allowed */` |
|   139401 | 1502 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI /* ';'*/) == 0 ){` |
...
|  2888902 | 1517 | `	if( (pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT)` |
|  1514154 | 1518 | `	 && (pClass->iFlags & (PH7_CLASS_ABSTRACT\|PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT)) == 0 ){` |
...
|  2888905 | 1531 | `	if( PH7_ClassExtractMethod(pClass,pName->zString,pName->nByte) != 0 ){` |
...
|  2888901 | 1540 | `	rc = PH7_ClassInstallMethod(pClass,pMeth);` |
|  2888901 | 1541 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 1542 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 1543 | `		return SXERR_ABORT;` |
|        - | 1544 | `	}` |
|  2888901 | 1545 | `	return SXRET_OK;` |
|        6 | 1546 | `Synchronize:` |
...
|        - | 2001 | ` */` |
|    69792 | 2002 | `PH7_PRIVATE sxi32 PH7_CompileClassInterface(ph7_gen_state *pGen)` |
|        5 | 2003 | `{` |
|    69797 | 2004 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|    69797 | 2013 | `	pName = &pGen->pIn->sData;` |
|        - | 2014 | `	/* Advance the stream cursor */` |
|    69797 | 2015 | `	pGen->pIn++;` |
|        - | 2016 | `	/* Build FQN and obtain a raw class */ {` |
|        - | 2017 | `		SyBlob sFQN;` |
|        - | 2018 | `		SyString sFQNStr;` |
|    69797 | 2019 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|    69797 | 2020 | `		GenStateBuildFQN(pGen,pName,&sFQN);` |
|    69797 | 2021 | `		SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|    69797 | 2022 | `		pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|    69797 | 2023 | `		SyBlobRelease(&sFQN);` |
|        - | 2024 | `	}` |
|    69797 | 2025 | `	if( pClass == 0 ){` |
|      ! 0 | 2026 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2027 | `		return SXERR_ABORT;` |
|        - | 2028 | `	}` |
|    69797 | 2029 | `	GenStateConsumeDoc(&(*pGen),&pClass->sDoc);` |
|    69797 | 2030 | `	if( GenStateConsumeAttrs(&(*pGen),&pClass->aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 2031 | `		return SXERR_ABORT;` |
|        - | 2032 | `	}` |
|        - | 2033 | `	/* Mark as an interface (PH7_NewRawClass may have set INTERNAL) */` |
|    69797 | 2034 | `	pClass->iFlags \|= PH7_CLASS_INTERFACE;` |
|        - | 2035 | `	/* Assume no base class is given */` |
|    69797 | 2036 | `	pBase = 0;` |
|    69797 | 2037 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|    27109 | 2038 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    27109 | 2039 | `		if( nKwrd == PH7_TKWRD_EXTENDS /* interface b extends a, c, … */ ){` |
...
|    27111 | 2050 | `				nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|    27111 | 2051 | `				SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|    27111 | 2052 | `				if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|        - | 2062 | `				}` |
|    40664 | 2063 | `				pParent = PH7_VmExtractClass(pGen->pVm,` |
|    27106 | 2064 | `					(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|    27111 | 2065 | `				SyStringInitFromBuf(&sBaseName,` |
|        - | 2066 | `					(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|        - | 2067 | `				/* Only interfaces is allowed */` |
|    27111 | 2068 | `				while( pParent && (pParent->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|      ! 0 | 2069 | `					pParent = pParent->pNextName;` |
|      ! 0 | 2070 | `				}` |
|    27111 | 2071 | `				if( pParent == 0 ){` |
...
|      ! 0 | 2077 | `					}` |
|    27111 | 2078 | `				}else if( pBase == 0 ){` |
|        - | 2079 | `					/* First parent → single-inheritance base */` |
|    27109 | 2080 | `					pBase = pParent;` |
|    13557 | 2081 | `				}else{` |
...
|        - | 2085 | `				}` |
|    27111 | 2086 | `				SyBlobRelease(&sResolved);` |
|        - | 2087 | `				/* Continue on a comma-separated list */` |
|    27111 | 2088 | `				if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA) ){` |
|        3 | 2089 | `					pGen->pIn++;` |
|        3 | 2090 | `					continue;` |
|        - | 2091 | `				}` |
|    27109 | 2092 | `				break;` |
...
|    13552 | 2094 | `		}` |
|    13552 | 2095 | `	}` |
|    69797 | 2096 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|        - | 2097 | `		/* Syntax error */` |
...
|        - | 2105 | `	}` |
|    69797 | 2106 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|    69797 | 2107 | `	pEnd = 0; /* cc warning */` |
|        - | 2108 | `	/* Delimit the interface body */` |
|    69797 | 2109 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|    69797 | 2110 | `	if( pEnd >= pGen->pEnd ){` |
|        - | 2111 | `		/* Syntax error */` |
...
|    69797 | 2121 | `	pClass->nEndLine = pEnd->nLine;` |
|        - | 2122 | `	/* Swap token stream */` |
|    69797 | 2123 | `	pTmp = pGen->pEnd;` |
|    69797 | 2124 | `	pGen->pEnd = pEnd;` |
...
|   441453 | 2132 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|   185831 | 2133 | `			pGen->pIn++;` |
|        5 | 2134 | `		}` |
|   255627 | 2135 | `		if( pGen->pIn >= pGen->pEnd ){` |
|        - | 2136 | `			/* End of interface body */` |
|    69793 | 2137 | `			break;` |
|        - | 2138 | `		}` |
|        - | 2139 | `		/* Bind a directly-preceding docblock to this member */` |
|   185839 | 2140 | `		GenStateSetPendingDoc(&(*pGen));` |
|   185839 | 2141 | `		if( (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|   185839 | 2152 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   185839 | 2153 | `		if( nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
...
|        3 | 2182 | `			goto done;` |
|        - | 2183 | `		}` |
|   185837 | 2184 | `		if( nKwrd != PH7_TKWRD_PUBLIC && nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|      ! 0 | 2191 | `			goto done;` |
|        - | 2192 | `		}` |
|   185837 | 2193 | `		if( nKwrd == PH7_TKWRD_PUBLIC ){` |
|        - | 2194 | `			/* Advance the stream cursor */` |
|   131639 | 2195 | `			pGen->pIn++;` |
|   131634 | 2196 | `			if( pGen->pIn < pGen->pEnd` |
|   131639 | 2197 | `			 && ((pGen->pIn->nType & PH7_TK_DOLLAR) != 0` |
|   131634 | 2198 | `			  \|\| (pGen->pIn->sData.nByte == 1 && pGen->pIn->sData.zString[0] == '?')) ){` |
...
|      ! 0 | 2212 | `				continue;` |
|        - | 2213 | `			}` |
|   131639 | 2214 | `			if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|      ! 0 | 2236 | `				goto done;` |
|        - | 2237 | `			}` |
|   131639 | 2238 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   131639 | 2239 | `			if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|        - | 2261 | `			}` |
|    65815 | 2262 | `		}` |
|   185833 | 2263 | `		if( nKwrd == PH7_TKWRD_CONST ){` |
|        - | 2264 | `			/* Parse constant */` |
|    54199 | 2265 | `			rc = GenStateCompileClassConstant(&(*pGen),0,0,pClass);` |
|    54199 | 2266 | `			if( rc != SXRET_OK ){` |
...
|        - | 2271 | `			}` |
|    27101 | 2272 | `		}else{` |
|   131639 | 2273 | `			sxi32 iFlags = PH7_CLASS_ATTR_ABSTRACT; /* Interface methods are implicitly abstract */` |
|   131639 | 2274 | `			if( nKwrd == PH7_TKWRD_STATIC ){` |
|        - | 2275 | `				/* Static method,record that */` |
|    11615 | 2276 | `				iFlags \|= PH7_CLASS_ATTR_STATIC;` |
|        - | 2277 | `				/* Advance the stream cursor */` |
|    11615 | 2278 | `				pGen->pIn++;` |
|    11610 | 2279 | `				if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0` |
|    11615 | 2280 | `					\|\| SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_FUNCTION ){` |
...
|   131639 | 2291 | `			rc = GenStateCompileClassMethod(&(*pGen),0,iFlags,FALSE,pClass);` |
|   131639 | 2292 | `			if( rc != SXRET_OK ){` |
...
|    69793 | 2301 | `	if( GenStateGuardClassRedeclaration(pGen,pClass) == SXERR_ABORT ){` |
|        3 | 2302 | `		return SXERR_ABORT;` |
|        - | 2303 | `	}` |
|        - | 2304 | `	/* Install the interface */` |
|    69791 | 2305 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|    69791 | 2306 | `	if( rc == SXRET_OK && pBase ){` |
|        - | 2307 | `		/* Inherit from the base interface */` |
|    27109 | 2308 | `		rc = PH7_ClassInterfaceInherit(pClass,pBase);` |
|    13552 | 2309 | `	}` |
|    69791 | 2310 | `	if( rc != SXRET_OK ){` |
...
|    69795 | 2316 | `	pGen->pIn  = &pEnd[1];` |
|    69795 | 2317 | `	pGen->pEnd = pTmp;` |
|    69795 | 2318 | `	return PH7_OK;` |
|    34901 | 2319 | `}` |
|        - | 2320 | `/*` |
...
|        - | 2344 | ` */` |
|   450886 | 2345 | `static sxi32 GenStateCheckInterfaceSignatures(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 | 2346 | `{` |
|        - | 2347 | `	ph7_class **apIface;` |
|        - | 2348 | `	sxu32 nIface,i;` |
|        - | 2349 | `	sxi32 rc;` |
|   450891 | 2350 | `	if( pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|      ! 0 | 2351 | `		return SXRET_OK;` |
|        - | 2352 | `	}` |
|   450891 | 2353 | `	apIface = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|   450891 | 2354 | `	nIface = SySetUsed(&pClass->aInterface);` |
|   873081 | 2355 | `	for(i = 0; i < nIface; i++){` |
|   422195 | 2356 | `		ph7_class *pIface = apIface[i];` |
|        - | 2357 | `		SyHashEntry *pEntry;` |
|   422195 | 2358 | `		SyHashResetLoopCursor(&pIface->hMethod);` |
|  1243243 | 2359 | `		while((pEntry = SyHashGetNextEntry(&pIface->hMethod)) != 0 ){` |
|   821053 | 2360 | `			ph7_class_method *pIfaceMeth = (ph7_class_method *)pEntry->pUserData;` |
|        - | 2361 | `			ph7_class_method *pImplMeth;` |
|   821053 | 2362 | `			SyString *pMName = &pIfaceMeth->sFunc.sName;` |
|        - | 2363 | `			/* Find the implementing method in the class */` |
|   821053 | 2364 | `			pImplMeth = PH7_ClassExtractMethod(pClass,pMName->zString,pMName->nByte);` |
|   821053 | 2365 | `			if( pImplMeth == 0 \|\| (pImplMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT) ){` |
...
|   821035 | 2369 | `			if( pImplMeth->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|        - | 2379 | `			 */` |
|        - | 2380 | `			{` |
|   821035 | 2381 | `				sxu32 nIfaceArgs = SySetUsed(&pIfaceMeth->sFunc.aArgs);` |
|   821035 | 2382 | `				sxu32 nImplArgs = SySetUsed(&pImplMeth->sFunc.aArgs);` |
|   821035 | 2383 | `				int sigError = 0;` |
|   821035 | 2384 | `				if( nImplArgs < nIfaceArgs ){` |
|        3 | 2385 | `					sigError = 1;` |
|   821034 | 2386 | `				}else if( nImplArgs > nIfaceArgs ){` |
|        - | 2387 | `					/* Extra parameters must all have default values */` |
|     3879 | 2388 | `					ph7_vm_func_arg *aImplArgs = (ph7_vm_func_arg *)SySetBasePtr(&pImplMeth->sFunc.aArgs);` |
|        - | 2389 | `					sxu32 k;` |
|     7751 | 2390 | `					for(k = nIfaceArgs; k < nImplArgs; k++){` |
|     3879 | 2391 | `						if( SySetUsed(&aImplArgs[k].aByteCode) == 0 ){` |
|        3 | 2392 | `							sigError = 1;` |
|        3 | 2393 | `							break;` |
|        - | 2394 | `						}` |
|     1941 | 2395 | `					}` |
|     1937 | 2396 | `				}` |
|   821035 | 2397 | `				if( sigError ){` |
...
|        - | 2477 | ` */` |
|   450886 | 2478 | `static sxi32 GenStateCheckAbstractMethods(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 | 2479 | `{` |
...
|   450891 | 2486 | `	if( pClass->iFlags & (PH7_CLASS_ABSTRACT\|PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|    19407 | 2487 | `		return SXRET_OK;` |
|        - | 2488 | `	}` |
|        - | 2489 | `	/* Count abstract methods */` |
|   431489 | 2490 | `	nAbstract = 0;` |
|   431489 | 2491 | `	SyHashResetLoopCursor(&pClass->hMethod);` |
|  6447331 | 2492 | `	while((pEntry = SyHashGetNextEntry(&pClass->hMethod)) != 0 ){` |
|  5800105 | 2493 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|  5800105 | 2494 | `		if( pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
...
|        8 | 2499 | `		}` |
|        5 | 2500 | `	}` |
|   431489 | 2501 | `	if( nAbstract == 0 ){` |
|   431475 | 2502 | `		return SXRET_OK;` |
|        - | 2503 | `	}` |
...
|        - | 2640 | ` */` |
|   513222 | 2641 | `PH7_PRIVATE sxi32 GenStateParseClassReference(ph7_gen_state *pGen,SyBlob *pFqn)` |
|        5 | 2642 | `{` |
|   513227 | 2643 | `	int isAbsolute = 0;` |
|   513227 | 2644 | `	SyToken *pStart = pGen->pIn;` |
|        - | 2645 | `	SyBlob sName;` |
|   513227 | 2646 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) ){` |
|     4529 | 2647 | `		isAbsolute = 1;` |
|     4529 | 2648 | `		pGen->pIn++;` |
|     2262 | 2649 | `	}` |
|   513227 | 2650 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|        9 | 2651 | `		pGen->pIn = pStart;` |
|        9 | 2652 | `		return SXERR_INVALID;` |
|        - | 2653 | `	}` |
|   513221 | 2654 | `	SyBlobInit(&sName,&pGen->pVm->sAllocator);` |
|   513221 | 2655 | `	SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|   513221 | 2656 | `	pGen->pIn++;` |
|   769863 | 2657 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) &&` |
|   256652 | 2658 | `		&pGen->pIn[1] < pGen->pEnd && (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|       28 | 2659 | `		SyBlobAppend(&sName,"\\",1);` |
|       28 | 2660 | `		pGen->pIn++;` |
|       28 | 2661 | `		SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|       28 | 2662 | `		pGen->pIn++;` |
|        2 | 2663 | `	}` |
|   513221 | 2664 | `	if( isAbsolute ){` |
|     4527 | 2665 | `		SyBlobAppend(pFqn,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|     2266 | 2666 | `	}else{` |
|        - | 2667 | `		SyString sRaw;` |
|   508699 | 2668 | `		SyStringInitFromBuf(&sRaw,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|   508699 | 2669 | `		GenStateResolveName(pGen,&sRaw,pFqn);` |
|        - | 2670 | `	}` |
|   513221 | 2671 | `	SyBlobRelease(&sName);` |
|   513221 | 2672 | `	return SXRET_OK;` |
|   256616 | 2673 | `}` |
|        - | 2674 | `/*` |
...
|   197586 | 2682 | `static int GenStateInterfaceIsThrowableAt(ph7_class *pInterface,int iDepth)` |
|        5 | 2683 | `{` |
|        - | 2684 | `	ph7_class **apParent;` |
|        - | 2685 | `	sxu32 n;` |
|   522929 | 2686 | `	while( pInterface ){` |
|   333093 | 2687 | `		if( iDepth > PH7_THROWABLE_WALK_MAX_DEPTH ){` |
|      ! 0 | 2688 | `			return FALSE;` |
|        - | 2689 | `		}` |
|   371813 | 2690 | `		if( pInterface->sName.nByte == sizeof("Throwable")-1 &&` |
|    77440 | 2691 | `			SyMemcmp(pInterface->sName.zString,"Throwable",sizeof("Throwable")-1) == 0 ){` |
|     7755 | 2692 | `			return TRUE;` |
|        - | 2693 | `		}` |
|   325343 | 2694 | `		apParent = (ph7_class **)SySetBasePtr(&pInterface->aInterface);` |
|   325345 | 2695 | `		for( n = 0 ; n < SySetUsed(&pInterface->aInterface) ; ++n ){` |
|        3 | 2696 | `			if( GenStateInterfaceIsThrowableAt(apParent[n],iDepth+1) ){` |
|      ! 0 | 2697 | `				return TRUE;` |
|        - | 2698 | `			}` |
|        2 | 2699 | `		}` |
|   325343 | 2700 | `		pInterface = pInterface->pBase;` |
|   325343 | 2701 | `		iDepth++;` |
|        5 | 2702 | `	}` |
|   189841 | 2703 | `	return FALSE;` |
|    98798 | 2704 | `}` |
|   197584 | 2705 | `static int GenStateInterfaceIsThrowable(ph7_class *pInterface)` |
|        5 | 2706 | `{` |
|   197589 | 2707 | `	return GenStateInterfaceIsThrowableAt(pInterface,0);` |
|        5 | 2708 | `}` |
|        - | 2709 | `/*` |
...
|        - | 2713 | ` */` |
|     7750 | 2714 | `static int GenStateClassIsExceptionOrError(ph7_class *pBase)` |
|        5 | 2715 | `{` |
|     7759 | 2716 | `	while( pBase ){` |
...
|        - | 2737 | ` */` |
|     7794 | 2738 | `static sxi32 GenStateCompileEnumCase(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 | 2739 | `{` |
|     7799 | 2740 | `	sxu32 nLine = pGen->pIn->nLine;` |
|        - | 2741 | `	SySet *pInstrContainer;` |
|        - | 2742 | `	ph7_class_attr *pCase;` |
|        - | 2743 | `	SyString *pName;` |
|        - | 2744 | `	sxi32 rc;` |
|     7799 | 2745 | `	pGen->pIn++; /* Jump the 'case' keyword */` |
|     7799 | 2746 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|        - | 2753 | `	}` |
|     7799 | 2754 | `	pName = &pGen->pIn->sData;` |
|        - | 2755 | `	/* Cases share the class-constant namespace (php: "Cannot redefine class constant") */` |
|     7799 | 2756 | `	if( SyHashGet(&pClass->hAttr,(const void *)pName->zString,pName->nByte) != 0 ){` |
...
|        - | 2763 | `	}` |
|     7799 | 2764 | `	pCase = PH7_NewClassAttr(pGen->pVm,pName,pGen->pIn->nLine,PH7_CLASS_PROT_PUBLIC,` |
|        - | 2765 | `		PH7_CLASS_ATTR_CONSTANT\|PH7_CLASS_ATTR_ENUMCASE);` |
|     7799 | 2766 | `	if( pCase == 0 ){` |
|      ! 0 | 2767 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2768 | `		return SXERR_ABORT;` |
|        - | 2769 | `	}` |
|     7799 | 2770 | `	GenStateConsumeDoc(&(*pGen),&pCase->sDoc);` |
|     7799 | 2771 | `	if( GenStateConsumeAttrs(&(*pGen),&pCase->aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 2772 | `		return SXERR_ABORT;` |
|        - | 2773 | `	}` |
|     7799 | 2774 | `	pGen->pIn++; /* Jump the case name */` |
|     7799 | 2775 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_EQUAL /* '=' */) ){` |
|     7785 | 2776 | `		if( pClass->nEnumBacking == 0 ){` |
...
|        - | 2783 | `		}` |
|     7781 | 2784 | `		pGen->pIn++; /* Jump the equal sign */` |
|        - | 2785 | `		/* Compile the backing value expression into the case's own container` |
|        - | 2786 | `		 * (same technique as class constants). */` |
|     7781 | 2787 | `		pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|     7781 | 2788 | `		PH7_VmSetByteCodeContainer(pGen->pVm,&pCase->aByteCode);` |
|     7781 | 2789 | `		rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|     7781 | 2790 | `		if( rc == SXERR_EMPTY ){` |
|      ! 0 | 2791 | `			rc = PH7_GenCompileError(pGen,E_ERROR,nLine,` |
|      ! 0 | 2792 | `				"Empty value for enum case %z::%z",&pClass->sName,pName);` |
|      ! 0 | 2793 | `		}` |
|     7781 | 2794 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|     7781 | 2795 | `		PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|     7781 | 2796 | `		if( rc == SXERR_ABORT ){` |
...
|        - | 2807 | `		}` |
|        - | 2808 | `	}` |
|     7795 | 2809 | `	rc = PH7_ClassInstallAttr(pClass,pCase);` |
|     7795 | 2810 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 2811 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2812 | `		return SXERR_ABORT;` |
|        - | 2813 | `	}` |
|     7795 | 2814 | `	SySetPut(&pClass->aEnumCases,(const void *)&pCase);` |
|     7795 | 2815 | `	return SXRET_OK;` |
|        2 | 2816 | `Synchronize:` |
...
|        - | 2831 | ` */` |
|     3904 | 2832 | `static sxi32 GenStateCompileEnumMethods(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 | 2833 | `{` |
...
|     3909 | 2839 | `	sxi32 rc = SXRET_OK;` |
|     3909 | 2840 | `	nMax = 3*(sxu32)sizeof("function tryFrom(string $value){return __phl_enum_tryfrom('',$value);}")` |
|     3904 | 2841 | `		+ 3*SyStringLength(&pClass->sName) + 64;` |
|     3909 | 2842 | `	zSrc = (char *)SyMemBackendAlloc(&pGen->pVm->sAllocator,nMax);` |
|     3909 | 2843 | `	if( zSrc == 0 ){` |
|      ! 0 | 2844 | `		PH7_GenCompileError(pGen,E_ERROR,pClass->nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2845 | `		return SXERR_ABORT;` |
|        - | 2846 | `	}` |
|     3909 | 2847 | `	zBack = (pClass->nEnumBacking == MEMOBJ_INT) ? "int" : "string";` |
|     3909 | 2848 | `	if( pClass->nEnumBacking != 0 ){` |
|     5831 | 2849 | `		nSrc = SyBufferFormat(zSrc,nMax,` |
...
|     1942 | 2853 | `			&pClass->sName,zBack,&pClass->sName,zBack,&pClass->sName);` |
|     1947 | 2854 | `	}else{` |
|       33 | 2855 | `		nSrc = SyBufferFormat(zSrc,nMax,` |
|       10 | 2856 | `			"function cases(){return __phl_enum_cases('%z');}",&pClass->sName);` |
|        - | 2857 | `	}` |
|     3909 | 2858 | `	SySetInit(&sToken,&pGen->pVm->sAllocator,sizeof(SyToken));` |
|     3909 | 2859 | `	PH7_TokenizePHP(zSrc,nSrc,pClass->nLine,&sToken,0);` |
|     3909 | 2860 | `	pSaveIn = pGen->pIn;` |
|     3909 | 2861 | `	pSaveEnd = pGen->pEnd;` |
|     3909 | 2862 | `	pGen->pIn = (SyToken *)SySetBasePtr(&sToken);` |
|     3909 | 2863 | `	pGen->pEnd = &pGen->pIn[SySetUsed(&sToken)];` |
|    15581 | 2864 | `	while( pGen->pIn < pGen->pEnd && rc != SXERR_ABORT ){` |
|    11677 | 2865 | `		rc = GenStateCompileClassMethod(&(*pGen),PH7_TKWRD_PUBLIC,PH7_CLASS_ATTR_STATIC,TRUE,pClass);` |
|        5 | 2866 | `	}` |
|     3909 | 2867 | `	pGen->pIn = pSaveIn;` |
|     3909 | 2868 | `	pGen->pEnd = pSaveEnd;` |
|     3909 | 2869 | `	SySetRelease(&sToken);` |
|     3909 | 2870 | `	return (rc == SXERR_ABORT) ? SXERR_ABORT : SXRET_OK;` |
|     1957 | 2871 | `}` |
|        - | 2872 | `/*` |
...
|        - | 2886 | ` */` |
|     3904 | 2887 | `static sxi32 GenStateEnumFinalize(ph7_gen_state *pGen,ph7_class *pClass,sxu32 nLine)` |
|        5 | 2888 | `{` |
|        - | 2889 | `	SyHashEntry *pEntry;` |
|        - | 2890 | `	sxi32 rc;` |
|        - | 2891 | `	sxu32 n;` |
|        - | 2892 | `	/* php: "Enum %s cannot include properties" */` |
|     3909 | 2893 | `	SyHashResetLoopCursor(&pClass->hAttr);` |
|    11705 | 2894 | `	while( (pEntry = SyHashGetNextEntry(&pClass->hAttr)) != 0 ){` |
|     7803 | 2895 | `		ph7_class_attr *pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|     7803 | 2896 | `		if( (pAttr->iFlags & PH7_CLASS_ATTR_CONSTANT) == 0 ){` |
...
|    54661 | 2906 | `	for( n = 0 ; n < SX_ARRAYSIZE(azEnumBannedMagic) ; n++ ){` |
|    76128 | 2907 | `		if( SyHashGet(&pClass->hMethod,(const void *)azEnumBannedMagic[n],` |
|    50757 | 2908 | `			SyStrlen(azEnumBannedMagic[n])) != 0 ){` |
...
|     3909 | 2924 | `		pAttr = PH7_NewClassAttr(pGen->pVm,&sNameProp,nLine,PH7_CLASS_PROT_PUBLIC,` |
|        - | 2925 | `			PH7_CLASS_ATTR_READONLY\|PH7_CLASS_ATTR_TYPED);` |
|     3909 | 2926 | `		if( pAttr == 0 ){` |
|      ! 0 | 2927 | `			PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2928 | `			return SXERR_ABORT;` |
|        - | 2929 | `		}` |
|     3909 | 2930 | `		pAttr->nType = MEMOBJ_STRING;` |
|     3909 | 2931 | `		SyStringInitFromBuf(&pAttr->sTypeName,"string",sizeof("string")-1);` |
|     3909 | 2932 | `		PH7_ClassInstallAttr(pClass,pAttr);` |
|     3909 | 2933 | `		if( pClass->nEnumBacking != 0 ){` |
|     3889 | 2934 | `			pAttr = PH7_NewClassAttr(pGen->pVm,&sValueProp,nLine,PH7_CLASS_PROT_PUBLIC,` |
|        - | 2935 | `				PH7_CLASS_ATTR_READONLY\|PH7_CLASS_ATTR_TYPED);` |
|     3889 | 2936 | `			if( pAttr == 0 ){` |
|      ! 0 | 2937 | `				PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2938 | `				return SXERR_ABORT;` |
|        - | 2939 | `			}` |
|     3889 | 2940 | `			pAttr->nType = pClass->nEnumBacking;` |
|     3889 | 2941 | `			if( pClass->nEnumBacking == MEMOBJ_INT ){` |
|        7 | 2942 | `				SyStringInitFromBuf(&pAttr->sTypeName,"int",sizeof("int")-1);` |
|        4 | 2943 | `			}else{` |
|     3883 | 2944 | `				SyStringInitFromBuf(&pAttr->sTypeName,"string",sizeof("string")-1);` |
|        - | 2945 | `			}` |
|     3889 | 2946 | `			PH7_ClassInstallAttr(pClass,pAttr);` |
|     1942 | 2947 | `		}` |
|        - | 2948 | `	}` |
|     3909 | 2949 | `	return GenStateCompileEnumMethods(&(*pGen),pClass);` |
|     1957 | 2950 | `}` |
|        - | 2951 | `/*` |
...
|        - | 2960 | ` */` |
|   450936 | 2961 | `static sxi32 GenStateCompileClassEx(ph7_gen_state *pGen,sxi32 iFlags,` |
|        - | 2962 | `	SyString *pAnonName,SyToken **ppArgStart,SyToken **ppArgEnd)` |
|        5 | 2963 | `{` |
|   450941 | 2964 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|   450941 | 2975 | `	pGen->pIn++;` |
|   450941 | 2976 | `	if( pAnonName ){` |
...
|       19 | 2991 | `	}else{` |
|   450911 | 2992 | `		if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
|        - | 2993 | `			/* Syntax error */` |
...
|   450911 | 3006 | `		pName = &pGen->pIn->sData;` |
|        - | 3007 | `		/* Advance the stream cursor */` |
|   450911 | 3008 | `		pGen->pIn++;` |
|        - | 3009 | `		/* Build FQN and obtain a raw class */ {` |
|        - | 3010 | `			SyBlob sFQN;` |
|        - | 3011 | `			SyString sFQNStr;` |
|   450911 | 3012 | `			SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|   450911 | 3013 | `			GenStateBuildFQN(pGen,pName,&sFQN);` |
|   450911 | 3014 | `			SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|   450911 | 3015 | `			pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|   450911 | 3016 | `			SyBlobRelease(&sFQN);` |
|        - | 3017 | `		}` |
|        - | 3018 | `	}` |
|   450941 | 3019 | `	if( pClass == 0 ){` |
|      ! 0 | 3020 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 3021 | `		return SXERR_ABORT;` |
|        - | 3022 | `	}` |
|   450936 | 3023 | `	if( (iFlags & PH7_CLASS_ENUM) && pGen->pIn < pGen->pEnd` |
|     3913 | 3024 | `		&& (pGen->pIn->nType & PH7_TK_COLON /* ':' */) ){` |
|        - | 3025 | ``		/* Backed enum: `enum Name: int\|string` (PHP 8.1) */`` |
|     3891 | 3026 | `		pGen->pIn++; /* Jump ':' */` |
|     3886 | 3027 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD)` |
|     3891 | 3028 | `			&& SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_INT ){` |
|        7 | 3029 | `			pClass->nEnumBacking = MEMOBJ_INT;` |
|        7 | 3030 | `			pGen->pIn++;` |
|     3884 | 3031 | `		}else if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD)` |
|     3885 | 3032 | `			&& SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_STRING ){` |
|     3883 | 3033 | `			pClass->nEnumBacking = MEMOBJ_STRING;` |
|     3883 | 3034 | `			pGen->pIn++;` |
|     1944 | 3035 | `		}else{` |
...
|        - | 3046 | `		}` |
|     1943 | 3047 | `	}` |
|   450941 | 3048 | `	GenStateConsumeDoc(&(*pGen),&pClass->sDoc);` |
|   450941 | 3049 | `	if( GenStateConsumeAttrs(&(*pGen),&pClass->aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 3050 | `		return SXERR_ABORT;` |
|        - | 3051 | `	}` |
|        - | 3052 | `	/* implemented interfaces and per-use-statement trait containers */` |
|   450941 | 3053 | `	SySetInit(&aInterfaces,&pGen->pVm->sAllocator,sizeof(ph7_class *));` |
|   450941 | 3054 | `	SySetInit(&aUseEntries,&pGen->pVm->sAllocator,sizeof(TraitUseEntry));` |
|        - | 3055 | `	/* Assume a standalone class */` |
|   450941 | 3056 | `	pBase = 0;` |
|   450941 | 3057 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|   368159 | 3058 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   368159 | 3059 | `		if( nKwrd == PH7_TKWRD_EXTENDS /* class b extends a */ ){` |
|        - | 3060 | `			SyBlob sResolved;` |
|        - | 3061 | `			SyString sBaseName;` |
|        - | 3062 | `			sxu32 nRefLine;` |
|   248005 | 3063 | `			if( iFlags & PH7_CLASS_ENUM ){` |
...
|        - | 3069 | `				}` |
|      ! 0 | 3070 | `			}` |
|   248005 | 3071 | `			pGen->pIn++; /* Advance past 'extends' */` |
|   248005 | 3072 | `			nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|   248005 | 3073 | `			SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|   248005 | 3074 | `			if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|        - | 3084 | `			}` |
|   372002 | 3085 | `			pBase = PH7_VmExtractClass(pGen->pVm,` |
|   247998 | 3086 | `				(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|   248003 | 3087 | `			SyStringInitFromBuf(&sBaseName,` |
|        - | 3088 | `				(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|        - | 3089 | `			/* Interfaces are not allowed */` |
|   248003 | 3090 | `			while( pBase && (pBase->iFlags & PH7_CLASS_INTERFACE) ){` |
|      ! 0 | 3091 | `				pBase = pBase->pNextName;` |
|      ! 0 | 3092 | `			}` |
|   248003 | 3093 | `			if( pBase == 0 ){` |
...
|        - | 3099 | `				}` |
|      ! 0 | 3100 | `			}else{` |
|   248003 | 3101 | `				if( pBase->iFlags & PH7_CLASS_ENUM ){` |
...
|   248002 | 3109 | `				}else if( pBase->iFlags & PH7_CLASS_FINAL ){` |
...
|      ! 0 | 3116 | `				}` |
|        - | 3117 | `			}` |
|   248003 | 3118 | `			SyBlobRelease(&sResolved);` |
|   248003 | 3119 | `			if( iFlags & PH7_CLASS_ENUM ){` |
|      ! 0 | 3120 | `				pBase = 0; /* Error already reported: enums have no base class */` |
|      ! 0 | 3121 | `			}` |
|   123999 | 3122 | `		}` |
|   368157 | 3123 | `		if (pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) && SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_IMPLEMENTS ){` |
|        - | 3124 | `			ph7_class *pInterface;` |
|        - | 3125 | `			/* Interface implementation */` |
|   135655 | 3126 | `			pGen->pIn++; /* Advance the stream cursor */` |
|   129759 | 3127 | `			for(;;){` |
|        - | 3128 | `				SyBlob sResolved;` |
|        - | 3129 | `				SyString sIntName;` |
|        - | 3130 | `				sxu32 nRefLine;` |
|   197589 | 3131 | `				nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|   197589 | 3132 | `				SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|   197589 | 3133 | `				if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|      ! 0 | 3141 | `					break;` |
|        - | 3142 | `				}` |
|   395173 | 3143 | `				pInterface = PH7_VmExtractClass(pGen->pVm,` |
|   197584 | 3144 | `					(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|   197589 | 3145 | `				SyStringInitFromBuf(&sIntName,` |
|        - | 3146 | `					(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|        - | 3147 | `				/* Only interfaces are allowed */` |
|   197589 | 3148 | `				while( pInterface && (pInterface->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|      ! 0 | 3149 | `					pInterface = pInterface->pNextName;` |
|      ! 0 | 3150 | `				}` |
|   197589 | 3151 | `				if( pInterface == 0 ){` |
...
|   197589 | 3165 | `					SyString *pFqn = &pClass->sName;` |
|   197589 | 3166 | `					int bIsExceptionOrError =` |
|   102666 | 3167 | `						(pFqn->nByte == sizeof("Exception")-1 &&` |
|   298315 | 3168 | `						 SyMemcmp(pFqn->zString,"Exception",sizeof("Exception")-1) == 0) \|\|` |
|   195656 | 3169 | `						(pFqn->nByte == sizeof("Error")-1 &&` |
|     3884 | 3170 | `						 SyMemcmp(pFqn->zString,"Error",sizeof("Error")-1) == 0);` |
|   201459 | 3171 | `					if( GenStateInterfaceIsThrowable(pInterface) &&` |
|    11628 | 3172 | `						!GenStateClassIsExceptionOrError(pBase) &&` |
|     3873 | 3173 | `						!bIsExceptionOrError ){` |
...
|        6 | 3183 | `					}else{` |
|   197583 | 3184 | `						SySetPut(&aInterfaces,(const void *)&pInterface);` |
|        - | 3185 | `					}` |
|        - | 3186 | `				}` |
|   197589 | 3187 | `				SyBlobRelease(&sResolved);` |
|   197589 | 3188 | `				if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COMMA) == 0 ){` |
|    67830 | 3189 | `					break;` |
|        - | 3190 | `				}` |
|    61939 | 3191 | `				pGen->pIn++;/* Jump the comma */` |
|        5 | 3192 | `			}` |
|    67825 | 3193 | `		}` |
|   184076 | 3194 | `	}` |
|   450939 | 3195 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|        - | 3196 | `		/* Syntax error */` |
...
|        - | 3204 | `	}` |
|   450939 | 3205 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|   450939 | 3206 | `	pEnd = 0; /* cc warning */` |
|        - | 3207 | `	/* Delimit the class body */` |
|   450939 | 3208 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|   450939 | 3209 | `	if( pEnd >= pGen->pEnd ){` |
|        - | 3210 | `		/* Syntax error */` |
...
|   450939 | 3220 | `	pClass->nEndLine = pEnd->nLine;` |
|        - | 3221 | `	/* Swap token stream */` |
|   450939 | 3222 | `	pTmp = pGen->pEnd;` |
|   450939 | 3223 | `	pGen->pEnd = pEnd;` |
|        - | 3224 | `	/* Merge the inherited flags (PH7_NewRawClass may have set INTERNAL) */` |
|   450939 | 3225 | `	pClass->iFlags \|= iFlags;` |
|        - | 3226 | `	/* Start the parse process */` |
|  1689249 | 3227 | `	for(;;){` |
|        - | 3228 | `		/* Jump leading/trailing semi-colons */` |
|  4851631 | 3229 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|   883677 | 3230 | `			pGen->pIn++;` |
|        5 | 3231 | `		}` |
|  3967959 | 3232 | `		if( pGen->pIn >= pGen->pEnd ){` |
|        - | 3233 | `			/* End of class body */` |
|   450897 | 3234 | `			break;` |
|        - | 3235 | `		}` |
|        - | 3236 | `		/* Bind a directly-preceding docblock to this member */` |
|  3517067 | 3237 | `		GenStateSetPendingDoc(&(*pGen));` |
|  3517062 | 3238 | `		if( (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR)) == 0` |
|  1758536 | 3239 | ``			&& !GenStateIsReadonly(pGen->pIn) /* allow a leading `readonly` modifier */ ){`` |
...
|  3517067 | 3250 | `		iProtection = PH7_TKWRD_PUBLIC;` |
|  3517067 | 3251 | `		iAttrflags = 0;` |
...
|  3517067 | 3256 | `		if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|      ! 0 | 3257 | `			int bMod = 0;` |
...
|        - | 3278 | `			}` |
|      ! 0 | 3279 | `		}` |
|  3517067 | 3280 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|        - | 3281 | `			/* Extract the current keyword */` |
|  3517067 | 3282 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  3517067 | 3283 | `			if( nKwrd == PH7_TKWRD_CASE && (pClass->iFlags & PH7_CLASS_ENUM) ){` |
|        - | 3284 | ``				/* Enum case declaration: `case NAME [= value];` */`` |
|     7799 | 3285 | `				rc = GenStateCompileEnumCase(&(*pGen),pClass);` |
|     7799 | 3286 | `				if( rc != SXRET_OK ){` |
...
|     7795 | 3292 | `				continue;` |
|        - | 3293 | `			}` |
|  3509273 | 3294 | `			if( nKwrd == PH7_TKWRD_USE ){` |
|        - | 3295 | `				/* Trait use: use TraitA, TraitB [{ ... }]; */` |
|        - | 3296 | `				TraitUseEntry sUse;` |
|    15575 | 3297 | `				SySetInit(&sUse.aTraits,&pGen->pVm->sAllocator,sizeof(ph7_class *));` |
|    15575 | 3298 | `				sUse.pResolvStart = sUse.pResolvEnd = 0;` |
|    15575 | 3299 | `				pGen->pIn++; /* Jump the 'use' keyword */` |
|     7793 | 3300 | `				for(;;){` |
|        - | 3301 | `					ph7_class *pTrait;` |
|        - | 3302 | `					SyBlob sResolved;` |
|        - | 3303 | `					SyString sTraitName;` |
|    15583 | 3304 | `					sxu32 nUseLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
...
|    15583 | 3311 | `					SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|    15583 | 3312 | `					if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|      ! 0 | 3319 | `						break;` |
|        - | 3320 | `					}` |
|    31161 | 3321 | `					pTrait = PH7_VmExtractClass(pGen->pVm,` |
|    15578 | 3322 | `						(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|    15583 | 3323 | `					SyStringInitFromBuf(&sTraitName,` |
|        - | 3324 | `						(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|        - | 3325 | `					/* Only traits are allowed */` |
|    15583 | 3326 | `					while( pTrait && (pTrait->iFlags & PH7_CLASS_TRAIT) == 0 ){` |
|      ! 0 | 3327 | `						pTrait = pTrait->pNextName;` |
|      ! 0 | 3328 | `					}` |
|    15583 | 3329 | `					if( pTrait == 0 ){` |
...
|        - | 3335 | `						}` |
|      ! 0 | 3336 | `					}else{` |
|    15583 | 3337 | `						SySetPut(&sUse.aTraits,(const void *)&pTrait);` |
|        - | 3338 | `					}` |
|    15583 | 3339 | `					SyBlobRelease(&sResolved);` |
...
|    15583 | 3342 | `					if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COMMA) == 0 ){` |
|     7790 | 3343 | `						break;` |
|        - | 3344 | `					}` |
|       10 | 3345 | `					pGen->pIn++; /* Jump the comma */` |
|        2 | 3346 | `				}` |
|        - | 3347 | `				/* Expect semicolon or opening brace (for conflict resolution) */` |
|    15575 | 3348 | `				if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OCB) ){` |
|        - | 3349 | `					SyToken *pBlock;` |
...
|        - | 3358 | `					}` |
|        5 | 3359 | `				}` |
|    15575 | 3360 | `				SySetPut(&aUseEntries,(const void *)&sUse);` |
|        - | 3361 | `				/* The semicolon will be consumed by the outer loop */` |
|    15575 | 3362 | `				continue;` |
|        - | 3363 | `			}` |
|  3493703 | 3364 | `			if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|        - | 3365 | `				int nSetTok;` |
|  2951361 | 3366 | `				sxi32 nSetVis = GenStatePeekSetVisibility(pGen->pIn,pGen->pEnd,&nSetTok);` |
|  2951361 | 3367 | `				if( nSetVis ){` |
...
|        2 | 3372 | `				}else{` |
|  2951359 | 3373 | `					iProtection = nKwrd;` |
|  2951359 | 3374 | `					pGen->pIn++; /* Jump the visibility token */` |
|        - | 3375 | `					/* Optional asymmetric set-visibility after the read` |
|        - | 3376 | ``					 * visibility: `public private(set) int $x`. */`` |
|  2951359 | 3377 | `					nSetVis = GenStatePeekSetVisibility(pGen->pIn,pGen->pEnd,&nSetTok);` |
|  2951359 | 3378 | `					if( nSetVis ){` |
...
|  2951361 | 3385 | `				if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|       28 | 3386 | `					iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|       28 | 3387 | `					pGen->pIn++; /* Jump the 'readonly' modifier */` |
|       12 | 3388 | `				}` |
|  2951356 | 3389 | `				if( pGen->pIn >= pGen->pEnd` |
|  2951361 | 3390 | `					\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|      ! 0 | 3398 | `					goto done;` |
|        - | 3399 | `				}` |
|  2951361 | 3400 | `				if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|        - | 3401 | `					/* Attribute declaration (untyped) */` |
|   523145 | 3402 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|   523145 | 3403 | `					if( rc != SXRET_OK ){` |
|       11 | 3404 | `						if( rc == SXERR_ABORT ){` |
|      ! 0 | 3405 | `							return SXERR_ABORT;` |
|        - | 3406 | `						}` |
|       11 | 3407 | `						goto done;` |
|        - | 3408 | `					}` |
|   531040 | 3409 | `					continue;` |
|        - | 3410 | `				}` |
|  2428221 | 3411 | `				if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
|        - | 3412 | `					/* Typed attribute declaration (PHP 7.4+) */` |
|    15817 | 3413 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|    15817 | 3414 | `					if( rc != SXRET_OK ){` |
...
|  2412409 | 3423 | `				nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  1206202 | 3424 | `			}` |
|  2954751 | 3425 | `			if( nKwrd == PH7_TKWRD_CONST ){` |
|        - | 3426 | `				/* Process constant declaration */` |
|   286567 | 3427 | `				rc = GenStateCompileClassConstant(&(*pGen),iProtection,iAttrflags,pClass);` |
|   286567 | 3428 | `				if( rc != SXRET_OK ){` |
...
|        - | 3433 | `				}` |
|   143282 | 3434 | `			}else{` |
|  2668189 | 3435 | `				if( nKwrd == PH7_TKWRD_STATIC ){` |
|        - | 3436 | `					/* Static method or attribute,record that */` |
|   100821 | 3437 | `					iAttrflags \|= PH7_CLASS_ATTR_STATIC;` |
|   100821 | 3438 | `					pGen->pIn++; /* Jump the static keyword */` |
|   100821 | 3439 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|        - | 3440 | `						int nSetTok;` |
|    73689 | 3441 | `						sxi32 nSetVis = GenStatePeekSetVisibility(pGen->pIn,pGen->pEnd,&nSetTok);` |
|    73689 | 3442 | `						if( nSetVis ){` |
...
|    73687 | 3448 | `							nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    73687 | 3449 | `							if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
...
|   100821 | 3463 | `					if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|      ! 0 | 3464 | `						iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|      ! 0 | 3465 | `						pGen->pIn++; /* Jump the 'readonly' modifier */` |
|      ! 0 | 3466 | `					}` |
|   100816 | 3467 | `					if( pGen->pIn >= pGen->pEnd` |
|   100821 | 3468 | `						\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|      ! 0 | 3476 | `						goto done;` |
|        - | 3477 | `					}` |
|   100821 | 3478 | `					if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|        - | 3479 | `						/* Attribute declaration */` |
|    27133 | 3480 | `						rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|    27133 | 3481 | `						if( rc != SXRET_OK ){` |
...
|    27131 | 3487 | `						continue;` |
|        - | 3488 | `					}` |
|    73693 | 3489 | `					if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|    73677 | 3501 | `					nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  2604209 | 3502 | `				}else if( nKwrd == PH7_TKWRD_ABSTRACT ){` |
...
|     7767 | 3511 | `					iAttrflags \|= PH7_CLASS_ATTR_ABSTRACT;` |
|        - | 3512 | `					/* Advance the stream cursor */` |
|     7767 | 3513 | `					pGen->pIn++;` |
|     7767 | 3514 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|     7767 | 3515 | `						nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|     7767 | 3516 | `						if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|     7765 | 3517 | `							iProtection = nKwrd;` |
|     7765 | 3518 | `							pGen->pIn++; /* Jump the visibility token */` |
|     3880 | 3519 | `						}` |
|     3881 | 3520 | `					}` |
|     7767 | 3521 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|     7762 | 3522 | `						SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_STATIC ){` |
|        - | 3523 | `							/* Static method */` |
|      ! 0 | 3524 | `							iAttrflags \|= PH7_CLASS_ATTR_STATIC;` |
|      ! 0 | 3525 | `							pGen->pIn++; /* Jump the static keyword */` |
|      ! 0 | 3526 | `					}` |
|     7767 | 3527 | `					if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 \|\|` |
|     7762 | 3528 | `						SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_FUNCTION ){` |
...
|      ! 0 | 3553 | `							goto done;` |
|        - | 3554 | `					}` |
|     7761 | 3555 | `					nKwrd = PH7_TKWRD_FUNCTION;` |
|  2563489 | 3556 | `				}else if( nKwrd == PH7_TKWRD_FINAL ){` |
...
|        3 | 3600 | `				}` |
|  2641027 | 3601 | `				if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_VAR ){` |
...
|      ! 0 | 3609 | `						goto done;` |
|        - | 3610 | `				}` |
|  2641027 | 3611 | `				if( nKwrd == PH7_TKWRD_VAR ){` |
...
|  2641021 | 3626 | `					rc = GenStateCompileClassMethod(&(*pGen),iProtection,iAttrflags,TRUE,pClass);` |
|        - | 3627 | `				}` |
|  2641027 | 3628 | `				if( rc != SXRET_OK ){` |
...
|        - | 3651 | `		sxu32 nU;` |
|   450897 | 3652 | `		apUse = (TraitUseEntry *)SySetBasePtr(&aUseEntries);` |
|   466467 | 3653 | `		for( nU = 0 ; nU < SySetUsed(&aUseEntries) ; nU++ ){` |
|    15575 | 3654 | `			TraitUseEntry *pUse = &apUse[nU];` |
|    15575 | 3655 | `			ph7_class **apTrait = (ph7_class **)SySetBasePtr(&pUse->aTraits);` |
|    15575 | 3656 | `			sxu32 nTraits = SySetUsed(&pUse->aTraits);` |
|    15575 | 3657 | `			int hasResolution = (pUse->pResolvStart && pUse->pResolvStart < pUse->pResolvEnd) ? 1 : 0;` |
|        - | 3658 | `			sxu32 nT;` |
|    15575 | 3659 | `			if( !hasResolution ){` |
|        - | 3660 | `				/* No conflict resolution block: use standard trait application */` |
|    31131 | 3661 | `				for( nT = 0 ; nT < nTraits ; nT++ ){` |
|    15571 | 3662 | `					rc = PH7_ClassUseTrait(&(*pGen),pClass,apTrait[nT]);` |
|    15571 | 3663 | `					if( rc != SXRET_OK ){` |
|      ! 0 | 3664 | `						break;` |
|        - | 3665 | `					}` |
|     7788 | 3666 | `				}` |
|     7785 | 3667 | `			}else{` |
...
|        2 | 3855 | `				}` |
|        - | 3856 | `			}` |
|    15575 | 3857 | `			SySetRelease(&pUse->aTraits);` |
|     7790 | 3858 | `		}` |
|        - | 3859 | `	}` |
|   450897 | 3860 | `	if( pClass->iFlags & PH7_CLASS_ENUM ){` |
...
|     3909 | 3863 | `		rc = GenStateEnumFinalize(&(*pGen),pClass,nLine);` |
|     3909 | 3864 | `		if( rc == SXERR_ABORT ){` |
...
|   450897 | 3871 | `	if( GenStateGuardClassRedeclaration(pGen,pClass) == SXERR_ABORT ){` |
|        9 | 3872 | `		return SXERR_ABORT;` |
|        - | 3873 | `	}` |
|        - | 3874 | `	/* Install the class */` |
|   450891 | 3875 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|   450891 | 3876 | `	if( rc == SXRET_OK ){` |
|        - | 3877 | `		ph7_class **apInterface;` |
|        - | 3878 | `		sxu32 n;` |
|   450891 | 3879 | `		if( pBase ){` |
|        - | 3880 | `			/* Inherit from base class and mark as a subclass */` |
|   248001 | 3881 | `			rc = PH7_ClassInherit(&(*pGen),pClass,pBase);` |
|   123998 | 3882 | `		}` |
|   450891 | 3883 | `		apInterface = (ph7_class **)SySetBasePtr(&aInterfaces);` |
|   648469 | 3884 | `		for( n = 0 ; n < SySetUsed(&aInterfaces) ; n++ ){` |
|        - | 3885 | `			/* Implements one or more interface */` |
|   197583 | 3886 | `			rc = PH7_ClassImplement(pClass,apInterface[n]);` |
|   197583 | 3887 | `			if( rc != SXRET_OK ){` |
|      ! 0 | 3888 | `				break;` |
|        - | 3889 | `			}` |
|    98794 | 3890 | `		}` |
...
|   450891 | 3893 | `		if( rc == SXRET_OK && (pClass->iFlags & PH7_CLASS_ENUM) ){` |
|     3907 | 3894 | `			ph7_class *pIntf = PH7_VmExtractClass(pGen->pVm,"UnitEnum",sizeof("UnitEnum")-1,FALSE,0);` |
|     3907 | 3895 | `			while( pIntf && (pIntf->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|      ! 0 | 3896 | `				pIntf = pIntf->pNextName;` |
|      ! 0 | 3897 | `			}` |
|     3907 | 3898 | `			if( pIntf ){` |
|     3907 | 3899 | `				PH7_ClassImplement(pClass,pIntf);` |
|     1951 | 3900 | `			}` |
|     3907 | 3901 | `			if( pClass->nEnumBacking != 0 ){` |
|     3889 | 3902 | `				pIntf = PH7_VmExtractClass(pGen->pVm,"BackedEnum",sizeof("BackedEnum")-1,FALSE,0);` |
|     3889 | 3903 | `				while( pIntf && (pIntf->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|      ! 0 | 3904 | `					pIntf = pIntf->pNextName;` |
|      ! 0 | 3905 | `				}` |
|     3889 | 3906 | `				if( pIntf ){` |
|     3889 | 3907 | `					PH7_ClassImplement(pClass,pIntf);` |
|     1942 | 3908 | `				}` |
|     1942 | 3909 | `			}` |
|     1951 | 3910 | `		}` |
...
|   450886 | 3913 | `		if( rc == SXRET_OK` |
|   450886 | 3914 | `		 && (pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT)) == 0` |
|   450891 | 3915 | `		 && SyHashGet(&pClass->hMethod,"__toString",sizeof("__toString")-1) != 0 ){` |
|   228443 | 3916 | `			ph7_class *pStringable = PH7_VmExtractClass(pGen->pVm,` |
|        - | 3917 | `				"Stringable",sizeof("Stringable")-1,FALSE,0);` |
|   228443 | 3918 | `			if( pStringable ){` |
|   228443 | 3919 | `				ph7_class **apImpl = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|   228443 | 3920 | `				sxu32 nImpl = SySetUsed(&pClass->aInterface);` |
|        - | 3921 | `				sxu32 i;` |
|   228443 | 3922 | `				int bAlready = 0;` |
|   274887 | 3923 | `				for( i = 0 ; i < nImpl ; i++ ){` |
|    58061 | 3924 | `					if( apImpl[i] == pStringable ){` |
|    11617 | 3925 | `						bAlready = 1;` |
|    11617 | 3926 | `						break;` |
|        - | 3927 | `					}` |
|    23227 | 3928 | `				}` |
|   228443 | 3929 | `				if( !bAlready ){` |
|   216831 | 3930 | `					PH7_ClassImplement(pClass,pStringable);` |
|   108413 | 3931 | `				}` |
|   114219 | 3932 | `			}` |
|   114219 | 3933 | `		}` |
|        - | 3934 | `		/* Validate interface method signatures (visibility and parameter count) */` |
|   450891 | 3935 | `		if( rc == SXRET_OK ){` |
|   450891 | 3936 | `			sxi32 rcCheck = GenStateCheckInterfaceSignatures(&(*pGen),pClass);` |
|   450891 | 3937 | `			if( rcCheck == SXERR_ABORT ){` |
...
|   450891 | 3944 | `		if( rc == SXRET_OK ){` |
|   450891 | 3945 | `			sxi32 rcCheck = GenStateCheckAbstractMethods(&(*pGen),pClass);` |
|   450891 | 3946 | `			if( rcCheck == SXERR_ABORT ){` |
...
|   225443 | 3951 | `		}` |
|   225443 | 3952 | `	}` |
|   450891 | 3953 | `	SySetRelease(&aUseEntries);` |
|   450891 | 3954 | `	SySetRelease(&aInterfaces);` |
|   450891 | 3955 | `	if( rc != SXRET_OK ){` |
...
|   450933 | 3961 | `	pGen->pIn = &pEnd[1];` |
|   450933 | 3962 | `	pGen->pEnd = pTmp;` |
|   450933 | 3963 | `	return PH7_OK;` |
|   225473 | 3964 | `}` |
|        - | 3965 | `/* Compile a named class declaration (the common case). */` |
|   450906 | 3966 | `static sxi32 GenStateCompileClass(ph7_gen_state *pGen,sxi32 iFlags)` |
|        5 | 3967 | `{` |
|   450911 | 3968 | `	return GenStateCompileClassEx(pGen,iFlags,0,0,0);` |
|        5 | 3969 | `}` |
|        - | 3970 | `/*` |
...
|        - | 4069 | ` */` |
| 14409770 | 4070 | `static int GenStateTokenIsClassModifier(SyToken *pTok,sxi32 *piFlag)` |
|        5 | 4071 | `{` |
| 14409775 | 4072 | `	if( pTok->nType & PH7_TK_KEYWORD ){` |
|  8624369 | 4073 | `		sxu32 nKw = (sxu32)SX_PTR_TO_INT(pTok->pUserData);` |
|  8624369 | 4074 | `		if( nKw == PH7_TKWRD_FINAL ){ *piFlag = PH7_CLASS_FINAL; return TRUE; }` |
|  8570143 | 4075 | `		if( nKw == PH7_TKWRD_ABSTRACT ){ *piFlag = PH7_CLASS_ABSTRACT; return TRUE; }` |
|  4265666 | 4076 | `	}` |
| 14316743 | 4077 | `	if( GenStateIsReadonly(pTok) ){ *piFlag = PH7_CLASS_READONLY; return TRUE; }` |
| 14316683 | 4078 | `	return FALSE;` |
|  7204890 | 4079 | `}` |
|        - | 4080 | `/*` |
...
|        - | 4085 | ` */` |
| 14316678 | 4086 | `static sxi32 GenStateScanClassModifiers(SyToken **ppIn,SyToken *pEnd,SyToken **ppDup)` |
|        5 | 4087 | `{` |
| 14316683 | 4088 | `	SyToken *pIn = *ppIn,*pDup = 0;` |
| 14316683 | 4089 | `	sxi32 iFlags = 0,iFlag;` |
| 14409775 | 4090 | `	while( pIn < pEnd && GenStateTokenIsClassModifier(pIn,&iFlag) ){` |
|    93097 | 4091 | `		if( (iFlags & iFlag) && pDup == 0 ){` |
|        5 | 4092 | `			pDup = pIn;` |
|        2 | 4093 | `		}` |
|    93097 | 4094 | `		iFlags \|= iFlag;` |
|    93097 | 4095 | `		pIn++;` |
|        5 | 4096 | `	}` |
| 14316683 | 4097 | `	*ppIn = pIn;` |
| 14316683 | 4098 | `	if( ppDup ){ *ppDup = pDup; }` |
| 14316683 | 4099 | `	return iFlags;` |
|        5 | 4100 | `}` |
|        - | 4101 | `/*` |
...
|        - | 4107 | ` */` |
| 14274012 | 4108 | `PH7_PRIVATE int GenStateStartsModifiedClass(SyToken *pIn,SyToken *pEnd)` |
|        5 | 4109 | `{` |
| 14274017 | 4110 | `	sxi32 iFlags = GenStateScanClassModifiers(&pIn,pEnd,0);` |
|  7187419 | 4111 | `	return iFlags != 0 && pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD)` |
| 14299217 | 4112 | `		&& (sxu32)SX_PTR_TO_INT(pIn->pUserData) == PH7_TKWRD_CLASS;` |
|        5 | 4113 | `}` |
|        - | 4114 | `/*` |
...
|        - | 4120 | ` */` |
|    42666 | 4121 | `PH7_PRIVATE sxi32 PH7_CompileClassModifiers(ph7_gen_state *pGen)` |
|        5 | 4122 | `{` |
|        - | 4123 | `	SyToken *pDup;` |
|    42671 | 4124 | `	sxi32 iFlags = GenStateScanClassModifiers(&pGen->pIn,pGen->pEnd,&pDup);` |
|        - | 4125 | `	sxi32 rc;` |
|    42671 | 4126 | `	if( pDup ){` |
...
|        - | 4131 | `		}` |
|        1 | 4132 | `	}` |
|    42666 | 4133 | `	if( (iFlags & (PH7_CLASS_FINAL\|PH7_CLASS_ABSTRACT))` |
|    21338 | 4134 | `		== (PH7_CLASS_FINAL\|PH7_CLASS_ABSTRACT) ){` |
...
|        - | 4139 | `		}` |
|        1 | 4140 | `	}` |
|    42671 | 4141 | `	return GenStateCompileClass(&(*pGen),iFlags);` |
|    21338 | 4142 | `}` |
|        - | 4143 | `/*` |
...
|        - | 4148 | ` */` |
|     7842 | 4149 | `PH7_PRIVATE sxi32 PH7_CompileTrait(ph7_gen_state *pGen)` |
|        5 | 4150 | `{` |
|     7847 | 4151 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|     7847 | 4160 | `	pGen->pIn++;` |
|     7847 | 4161 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
...
|     7847 | 4172 | `	pName = &pGen->pIn->sData;` |
|     7847 | 4173 | `	pGen->pIn++;` |
|        - | 4174 | `	/* Build FQN and obtain a raw class */ {` |
|        - | 4175 | `		SyBlob sFQN;` |
|        - | 4176 | `		SyString sFQNStr;` |
|     7847 | 4177 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|     7847 | 4178 | `		GenStateBuildFQN(pGen,pName,&sFQN);` |
|     7847 | 4179 | `		SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|     7847 | 4180 | `		pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|     7847 | 4181 | `		SyBlobRelease(&sFQN);` |
|        - | 4182 | `	}` |
|     7847 | 4183 | `	if( pClass == 0 ){` |
|      ! 0 | 4184 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 4185 | `		return SXERR_ABORT;` |
|        - | 4186 | `	}` |
|     7847 | 4187 | `	GenStateConsumeDoc(&(*pGen),&pClass->sDoc);` |
|     7847 | 4188 | `	if( GenStateConsumeAttrs(&(*pGen),&pClass->aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 4189 | `		return SXERR_ABORT;` |
|        - | 4190 | `	}` |
|        - | 4191 | `	/* Traits cannot extend or implement; expect opening brace directly */` |
|     7847 | 4192 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_OCB) == 0 ){` |
...
|        - | 4199 | `	}` |
|     7847 | 4200 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|     7847 | 4201 | `	pEnd = 0;` |
|     7847 | 4202 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB,PH7_TK_CCB,&pEnd);` |
|     7847 | 4203 | `	if( pEnd >= pGen->pEnd ){` |
...
|     7847 | 4212 | `	pClass->nEndLine = pEnd->nLine;` |
|        - | 4213 | `	/* Swap token stream */` |
|     7847 | 4214 | `	pTmp = pGen->pEnd;` |
|     7847 | 4215 | `	pGen->pEnd = pEnd;` |
|        - | 4216 | `	/* Mark as trait (PH7_NewRawClass may have set INTERNAL) */` |
|     7847 | 4217 | `	pClass->iFlags \|= PH7_CLASS_TRAIT;` |
|        - | 4218 | `	/* Parse the body: same as a normal class (methods, attributes, visibility modifiers) */` |
|    56217 | 4219 | `	for(;;){` |
|   158941 | 4220 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|    23259 | 4221 | `			pGen->pIn++;` |
|        5 | 4222 | `		}` |
|   135687 | 4223 | `		if( pGen->pIn >= pGen->pEnd ){` |
|     7847 | 4224 | `			break;` |
|        - | 4225 | `		}` |
|        - | 4226 | `		/* Bind a directly-preceding docblock to this member */` |
|   127845 | 4227 | `		GenStateSetPendingDoc(&(*pGen));` |
|   127845 | 4228 | `		if( (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR)) == 0 ){` |
...
|      ! 0 | 4235 | `			goto done;` |
|        - | 4236 | `		}` |
|   127845 | 4237 | `		iProtection = PH7_TKWRD_PUBLIC;` |
|   127845 | 4238 | `		iAttrflags = 0;` |
|   127845 | 4239 | `		if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|   127845 | 4240 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   127845 | 4241 | `			if( nKwrd == PH7_TKWRD_USE ){` |
...
|        5 | 4282 | `				continue;` |
|        - | 4283 | `			}` |
|   127841 | 4284 | `			if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|   127823 | 4285 | `				iProtection = nKwrd;` |
|   127823 | 4286 | `				pGen->pIn++;` |
...
|   127823 | 4290 | `				if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|        5 | 4291 | `					iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|        5 | 4292 | `					pGen->pIn++; /* Jump the 'readonly' modifier */` |
|        2 | 4293 | `				}` |
|   127818 | 4294 | `				if( pGen->pIn >= pGen->pEnd` |
|   127823 | 4295 | `					\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|      ! 0 | 4302 | `					goto done;` |
|        - | 4303 | `				}` |
|   127823 | 4304 | `				if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|    23239 | 4305 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|    23239 | 4306 | `					if( rc != SXRET_OK ){` |
...
|    23239 | 4312 | `					continue;` |
|        - | 4313 | `				}` |
|   104589 | 4314 | `				if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|        9 | 4322 | `					continue;` |
|        - | 4323 | `				}` |
|   104581 | 4324 | `				nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    52288 | 4325 | `			}` |
|   104599 | 4326 | `			if( nKwrd == PH7_TKWRD_CONST ){` |
...
|      ! 0 | 4332 | `				goto done;` |
|      ! 0 | 4333 | `			}else{` |
|   104599 | 4334 | `				if( nKwrd == PH7_TKWRD_STATIC ){` |
|     7755 | 4335 | `					iAttrflags \|= PH7_CLASS_ATTR_STATIC;` |
|     7755 | 4336 | `					pGen->pIn++;` |
|     7755 | 4337 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|     7753 | 4338 | `						nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|     7753 | 4339 | `						if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|      ! 0 | 4340 | `							iProtection = nKwrd;` |
|      ! 0 | 4341 | `							pGen->pIn++;` |
|      ! 0 | 4342 | `						}` |
|     3874 | 4343 | `					}` |
|     7750 | 4344 | `					if( pGen->pIn >= pGen->pEnd` |
|     7755 | 4345 | `						\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|      ! 0 | 4352 | `						goto done;` |
|        - | 4353 | `					}` |
|     7755 | 4354 | `					if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
...
|        3 | 4362 | `						continue;` |
|        - | 4363 | `					}` |
|     7753 | 4364 | `					if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|      ! 0 | 4372 | `						continue;` |
|        - | 4373 | `					}` |
|     7753 | 4374 | `					nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   100723 | 4375 | `				}else if( nKwrd == PH7_TKWRD_ABSTRACT ){` |
...
|        3 | 4396 | `				}` |
|   104597 | 4397 | `				if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_VAR ){` |
...
|      ! 0 | 4404 | `					goto done;` |
|        - | 4405 | `				}` |
|   104597 | 4406 | `				if( nKwrd == PH7_TKWRD_VAR ){` |
|      ! 0 | 4407 | `					pGen->pIn++;` |
...
|      ! 0 | 4417 | `				}else{` |
|   104597 | 4418 | `					rc = GenStateCompileClassMethod(&(*pGen),iProtection,iAttrflags,TRUE,pClass);` |
|        - | 4419 | `				}` |
|   104597 | 4420 | `				if( rc != SXRET_OK ){` |
...
|     7847 | 4438 | `	if( GenStateGuardClassRedeclaration(pGen,pClass) == SXERR_ABORT ){` |
|        3 | 4439 | `		return SXERR_ABORT;` |
|        - | 4440 | `	}` |
|        - | 4441 | `	/* Install the trait */` |
|     7845 | 4442 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|     7845 | 4443 | `	if( rc != SXRET_OK ){` |
...
|     7845 | 4449 | `	pGen->pIn = &pEnd[1];` |
|     7845 | 4450 | `	pGen->pEnd = pTmp;` |
|     7845 | 4451 | `	return PH7_OK;` |
|     3926 | 4452 | `}` |
|        - | 4453 | `/*` |
...
|        - | 4461 | ` */` |
|   404332 | 4462 | `PH7_PRIVATE sxi32 PH7_CompileClass(ph7_gen_state *pGen)` |
|        5 | 4463 | `{` |
|        - | 4464 | `	sxi32 rc;` |
|   404337 | 4465 | `	rc = GenStateCompileClass(&(*pGen),0);` |
|   404337 | 4466 | `	return rc;` |
|        5 | 4467 | `}` |
|        - | 4468 | `/*` |
...
|        - | 4474 | ` */` |
| 14223606 | 4475 | `PH7_PRIVATE int GenStateStartsEnumDecl(SyToken *pIn,SyToken *pEnd)` |
|        5 | 4476 | `{` |
| 14439236 | 4477 | `	return (pIn->nType & PH7_TK_ID)` |
|  7327428 | 4478 | `		&& pIn->sData.nByte == sizeof("enum")-1` |
|   225448 | 4479 | `		&& SyStrnicmp(pIn->sData.zString,"enum",sizeof("enum")-1) == 0` |
| 14439231 | 4480 | `		&& &pIn[1] < pEnd && (pIn[1].nType & PH7_TK_ID);` |
|        5 | 4481 | `}` |
|        - | 4482 | `/*` |
...
|        - | 4487 | ` */` |
|     3908 | 4488 | `PH7_PRIVATE sxi32 PH7_CompileEnum(ph7_gen_state *pGen)` |
|        5 | 4489 | `{` |
|     3913 | 4490 | `	return GenStateCompileClass(&(*pGen),PH7_CLASS_ENUM\|PH7_CLASS_FINAL);` |
|        5 | 4491 | `}` |
|        - | 4492 |  |
