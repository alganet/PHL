...
|        - |   26 | ` */` |
|   523144 |   27 | `static sxi32 GenStateGuardClassRedeclaration(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 |   28 | `{` |
|        - |   29 | `	SyHashEntry *pEntry;` |
|   523149 |   30 | `	if( !GenStateUnconditionalTopLevel(pGen) ){` |
|       26 |   31 | `		return SXRET_OK; /* conditional/nested: keep hoisting */` |
|        - |   32 | `	}` |
|   523127 |   33 | `	pClass->iFlags \|= PH7_CLASS_BOUND;` |
|   523127 |   34 | `	if( pGen->pVm->bCompilingBuiltin ){` |
|   520997 |   35 | `		return SXRET_OK; /* the prelude installs each builtin exactly once */` |
|        - |   36 | `	}` |
...
|        - |   70 | ` */` |
|  3836742 |   71 | `static sxi32 GetProtectionLevel(sxi32 nKeyword)` |
|        5 |   72 | `{` |
|  3836747 |   73 | `	if( nKeyword == PH7_TKWRD_PRIVATE ){` |
|   280163 |   74 | `		return PH7_CLASS_PROT_PRIVATE;` |
|  3556589 |   75 | `	}else if( nKeyword == PH7_TKWRD_PROTECTED ){` |
|   221721 |   76 | `		return PH7_CLASS_PROT_PROTECTED;` |
|        - |   77 | `	}` |
|        - |   78 | `	/* Assume public by default */` |
|  3334873 |   79 | `	return PH7_CLASS_PROT_PUBLIC;` |
|  1918376 |   80 | `}` |
|        - |   81 | `/*` |
...
|        - |   88 | ` */` |
|   342338 |   89 | `static int GenStateClassConstHasType(ph7_gen_state *pGen)` |
|        5 |   90 | `{` |
|        - |   91 | `	SyToken *p0, *p1;` |
|   342343 |   92 | `	if( pGen->pIn >= pGen->pEnd ){` |
|      ! 0 |   93 | `		return 0;` |
|        - |   94 | `	}` |
|   342343 |   95 | `	p0 = pGen->pIn;` |
|        - |   96 | `	/* A leading '\' (namespaced class type) or '?' (nullable) always starts a type */` |
|   342343 |   97 | `	if( p0->nType & PH7_TK_NSSEP ){` |
|      ! 0 |   98 | `		return 1;` |
|        - |   99 | `	}` |
|   342343 |  100 | `	if( (p0->nType & PH7_TK_OP) && p0->sData.nByte == 1 && p0->sData.zString[0] == '?' ){` |
|        5 |  101 | `		return 1;` |
|        - |  102 | `	}` |
...
|   342339 |  106 | `	if( p0->nType & (PH7_TK_ID\|PH7_TK_KEYWORD) ){` |
|   342339 |  107 | `		p1 = (pGen->pIn + 1 < pGen->pEnd) ? (pGen->pIn + 1) : 0;` |
|   342339 |  108 | `		if( p1 ){` |
|   342339 |  109 | `			if( p1->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_NSSEP) ){` |
|       34 |  110 | `				return 1;` |
|        - |  111 | `			}` |
|   342309 |  112 | `			if( (p1->nType & PH7_TK_OP) && p1->sData.nByte == 1 && p1->sData.zString[0] == '\|' ){` |
|        5 |  113 | `				return 1;` |
|        - |  114 | `			}` |
|   171150 |  115 | `		}` |
|   171150 |  116 | `	}` |
...
|        - |  172 | ` */` |
|   724124 |  173 | `static int GenStateInitHasNewExpr(ph7_gen_state *pGen)` |
|        5 |  174 | `{` |
|   724129 |  175 | `	SyToken *p = pGen->pIn;` |
|   724129 |  176 | `	int iDepth = 0;` |
|  1912451 |  177 | `	while( p < pGen->pEnd ){` |
|  1912451 |  178 | `		if( iDepth == 0 && (p->nType & (PH7_TK_SEMI\|PH7_TK_COMMA)) ){` |
|   724077 |  179 | `			break; /* end of this initializer */` |
|        - |  180 | `		}` |
|  1188374 |  181 | `		if( (p->nType & PH7_TK_KEYWORD)` |
|   601985 |  182 | `			&& ( SX_PTR_TO_INT(p->pUserData) == PH7_TKWRD_FUNCTION` |
|    15586 |  183 | `				\|\| SX_PTR_TO_INT(p->pUserData) == PH7_TKWRD_FN ) ){` |
...
|        3 |  241 | `			continue;` |
|        - |  242 | `		}` |
|  1188377 |  243 | `		if( p->nType & PH7_TK_OCB ){` |
|       45 |  244 | `			if( iDepth == 0 ){` |
...
|        - |  250 | `			}` |
|      ! 0 |  251 | `			iDepth++;` |
|  1188333 |  252 | `		}else if( p->nType & (PH7_TK_LPAREN\|PH7_TK_OSB) ){` |
|    50641 |  253 | `			iDepth++;` |
|  1163015 |  254 | `		}else if( p->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB) ){` |
|    50639 |  255 | `			if( iDepth > 0 ){` |
|    50639 |  256 | `				iDepth--;` |
|    25317 |  257 | `			}` |
|  1112380 |  258 | `		}else if( (p->nType & PH7_TK_OP) && p->pUserData` |
|   391781 |  259 | `			&& ((const ph7_expr_op *)p->pUserData)->iOp == EXPR_OP_NEW ){` |
...
|        - |  278 | ` */` |
|    15946 |  279 | `static void GenStateCopyTypeToAttr(ph7_class_attr *pAttr,sxu32 nType,` |
|        - |  280 | `	const SyString *pClass,const SyString *pTypeName,sxi32 iTypeFlags,SySet *pAlts)` |
|        5 |  281 | `{` |
|    15951 |  282 | `	pAttr->nType = nType;` |
|    15951 |  283 | `	pAttr->sClass = *pClass;` |
|    15951 |  284 | `	pAttr->sTypeName = *pTypeName;` |
|    15951 |  285 | `	if( iTypeFlags & PH7_CLASS_ATTR_UNION ){` |
|        - |  286 | `		sxu32 i;` |
...
|       11 |  291 | `	}` |
|    15951 |  292 | `}` |
|   342338 |  293 | `static sxi32 GenStateCompileClassConstant(ph7_gen_state *pGen,sxi32 iProtection,sxi32 iFlags,ph7_class *pClass)` |
|        5 |  294 | `{` |
|   342343 |  295 | `	sxu32 nLine = pGen->pIn->nLine;` |
|        - |  296 | `	SySet *pInstrContainer;` |
|        - |  297 | `	ph7_class_attr *pCons;` |
|        - |  298 | `	SyString *pName;` |
|        - |  299 | `	sxi32 rc;` |
|   342343 |  300 | `	sxu32 nType = 0;` |
|        - |  301 | `	SyString sTypeClass;` |
|        - |  302 | `	SyString sTypeText;` |
|        - |  303 | `	SySet aUnionAlts;` |
|   342343 |  304 | `	sxi32 iTypeFlags = 0;` |
|   342343 |  305 | `	SyStringInitFromBuf(&sTypeClass,0,0);` |
|   342343 |  306 | `	SyStringInitFromBuf(&sTypeText,0,0);` |
|   342343 |  307 | `	SySetInit(&aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|        - |  308 | `	/* Extract visibility level */` |
|   342343 |  309 | `	iProtection = GetProtectionLevel(iProtection);` |
|        - |  310 | `	/* Mark as constant */` |
|   342343 |  311 | `	iFlags \|= PH7_CLASS_ATTR_CONSTANT;` |
|   342343 |  312 | `	pGen->pIn++; /* Jump the 'const' keyword */` |
...
|   342362 |  315 | `	if( GenStateClassConstHasType(pGen) ){` |
...
|       19 |  336 | `	}` |
|   171169 |  337 | `loop:` |
|   342345 |  338 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
...
|   342345 |  348 | `	pName = &pGen->pIn->sData;` |
|        - |  349 | `	/* Make sure the constant name isn't reserved */` |
|   342345 |  350 | `	if( GenStateIsReservedConstant(pName) ){` |
...
|   342345 |  360 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
...
|   342343 |  371 | `	pGen->pIn++;` |
|   342343 |  372 | `	if(pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_EQUAL /* '=' */) == 0 ){` |
...
|        - |  380 | `	}` |
|   342343 |  381 | `	pGen->pIn++; /* Jump the equal sign */` |
...
|   342338 |  386 | `	if( (iTypeFlags & PH7_CLASS_ATTR_TYPED) && !(iTypeFlags & PH7_CLASS_ATTR_UNION)` |
...
|   342339 |  399 | `	if( GenStateInitHasNewExpr(pGen) ){` |
...
|   342335 |  408 | `	pCons = PH7_NewClassAttr(pGen->pVm,pName,nLine,iProtection,iFlags\|iTypeFlags);` |
|   342335 |  409 | `	if( pCons ){` |
|   342335 |  410 | `		GenStateConsumeDoc(&(*pGen),&pCons->sDoc);` |
|   342335 |  411 | `		if( GenStateConsumeAttrs(&(*pGen),&pCons->aAttrs) == SXERR_ABORT ){` |
|      ! 0 |  412 | `			return SXERR_ABORT;` |
|        - |  413 | `		}` |
|   171165 |  414 | `	}` |
|   342335 |  415 | `	if( pCons == 0 ){` |
|      ! 0 |  416 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 |  417 | `		return SXERR_ABORT;` |
|        - |  418 | `	}` |
|   342335 |  419 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|       35 |  420 | `		GenStateCopyTypeToAttr(pCons,nType,&sTypeClass,&sTypeText,iTypeFlags,&aUnionAlts);` |
|       16 |  421 | `	}` |
|        - |  422 | `	/* Swap bytecode container */` |
|   342335 |  423 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   342335 |  424 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pCons->aByteCode);` |
|        - |  425 | `	/* Compile constant value.` |
|        - |  426 | `	 */` |
|   342335 |  427 | `	rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|   342335 |  428 | `	if( rc == SXERR_EMPTY ){` |
...
|   342335 |  435 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|   342335 |  436 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|   342335 |  437 | `	if( rc == SXERR_ABORT ){` |
...
|   342335 |  442 | `	rc = PH7_ClassInstallAttr(pClass,pCons);` |
|   342335 |  443 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  444 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 |  445 | `		return SXERR_ABORT;` |
|        - |  446 | `	}` |
|   342335 |  447 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA /*','*/) ){` |
...
|        - |  465 | `		}` |
|      ! 0 |  466 | `	}` |
|   342333 |  467 | `	SySetRelease(&aUnionAlts);` |
|   342333 |  468 | `	return SXRET_OK;` |
|        5 |  469 | `Synchronize:` |
...
|        - |  505 | ` */` |
|  2626384 |  506 | `static int GenStateLooksLikeTypedProperty(SyToken *pStart,SyToken *pEnd)` |
|        5 |  507 | `{` |
|  2626389 |  508 | `	SyToken *p = pStart;` |
|  2626389 |  509 | `	int bFirst = 1;` |
|  2626389 |  510 | `	if( p >= pEnd ) return 0;` |
|        - |  511 | ``	/* Optional nullable `?` shorthand. */`` |
|  2626389 |  512 | `	if( (p->nType & PH7_TK_OP) && p->sData.nByte == 1 && p->sData.zString[0] == '?' ){` |
|       41 |  513 | `		p++;` |
...
|  1313192 |  520 | `	for(;;){` |
|  2626409 |  521 | `		if( p < pEnd && (p->nType & PH7_TK_LPAREN) ){` |
...
|  2626407 |  530 | `			if( p < pEnd && (p->nType & PH7_TK_NSSEP) ){ p++; }` |
|  2626407 |  531 | `			if( p >= pEnd \|\| (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|      ! 0 |  532 | `				return 0;` |
|        - |  533 | `			}` |
...
|  2626407 |  537 | `			if( bFirst && (p->nType & PH7_TK_KEYWORD) ){` |
|  2626351 |  538 | `				sxu32 k = (sxu32)(SX_PTR_TO_INT(p->pUserData));` |
|  2626346 |  539 | `				if( k == PH7_TKWRD_FUNCTION \|\| k == PH7_TKWRD_VAR \|\| k == PH7_TKWRD_CONST` |
|   124918 |  540 | `				 \|\| k == PH7_TKWRD_STATIC \|\| k == PH7_TKWRD_FINAL \|\| k == PH7_TKWRD_ABSTRACT ){` |
|  2610481 |  541 | `					return 0;` |
|        - |  542 | `				}` |
|     7935 |  543 | `			}` |
|    15931 |  544 | `			p++;` |
|    15933 |  545 | `			while( p + 1 < pEnd && (p->nType & PH7_TK_NSSEP) && (p[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|        3 |  546 | `				p += 2;` |
|        1 |  547 | `			}` |
|    23892 |  548 | `			while( p + 1 < pEnd && (p->nType & PH7_TK_AMPER)` |
|    15934 |  549 | `				&& (p[1].nType & (PH7_TK_NSSEP\|PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|        3 |  550 | `				p++; /* skip '&' */` |
...
|        - |  558 | `		}` |
|    15933 |  559 | `		bFirst = 0;` |
|    15928 |  560 | `		if( p < pEnd && (p->nType & PH7_TK_OP) && p->sData.nByte == 1` |
...
|    15913 |  565 | `		break;` |
|      ! 0 |  566 | `	}` |
|    15913 |  567 | `	if( p >= pEnd ) return 0;` |
|    15913 |  568 | `	return (p->nType & PH7_TK_DOLLAR) ? 1 : 0;` |
|  1313197 |  569 | `}` |
|        - |  570 |  |
|        - |  571 | `/*` |
...
|        - |  588 | ` */` |
|    15918 |  589 | `static sxi32 GenStateParsePropertyType(` |
...
|        - |  595 | `	SySet *pAlts` |
|        5 |  596 | `){` |
|    15923 |  597 | `	sxi32 iFlags = 0;` |
|        - |  598 | `	sxi32 rc;` |
|    15923 |  599 | `	if( pGen->pIn >= pGen->pEnd ){` |
|      ! 0 |  600 | `		return SXRET_OK;` |
|        - |  601 | `	}` |
|        - |  602 | `	/* If the first token is '$', there's no type */` |
|    15923 |  603 | `	if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|      ! 0 |  604 | `		return SXRET_OK;` |
|        - |  605 | `	}` |
|    15923 |  606 | `	rc = GenStateParseUnionTypeDecl(` |
|     7959 |  607 | `		pGen, pnType, pClass, pAlts, &iFlags, pTypeText,` |
|        - |  608 | `		PH7_CLASS_ATTR_NULLABLE,` |
|        - |  609 | `		PH7_CLASS_ATTR_UNION,` |
|        - |  610 | `		/* bAllowVoid */ 0,` |
|    15918 |  611 | `		pGen->pIn->nLine);` |
|    15923 |  612 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  613 | `		return rc;` |
|        - |  614 | `	}` |
|        - |  615 | `	/* Verify next token is '$' (start of property name) */` |
|    15923 |  616 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
|      ! 0 |  617 | `		return SXERR_SYNTAX;` |
|        - |  618 | `	}` |
|    15923 |  619 | `	*piTypeFlags = iFlags \| PH7_CLASS_ATTR_TYPED;` |
|    15923 |  620 | `	return SXRET_OK;` |
|     7964 |  621 | `}` |
|        - |  622 |  |
|        - |  623 | `/*` |
...
|        - |  633 | ` */` |
|    16096 |  634 | `static int GenStateIsDisallowedPropertyAtom(` |
|        - |  635 | `	sxu32 nType,` |
...
|        - |  640 | `	const char *z;` |
|        - |  641 | `	sxu32 n;` |
|    16101 |  642 | `	if( nType != SXU32_HIGH \|\| pClass == 0 \|\| pClass->nByte == 0 ){` |
|    16035 |  643 | `		return 0;` |
|        - |  644 | `	}` |
...
|        - |  666 | ` */` |
|    16034 |  667 | `PH7_PRIVATE sxi32 GenStateValidateMemberType(` |
...
|        - |  676 | `	sxu32 nLine)` |
|        5 |  677 | `{` |
|    16039 |  678 | `	const char *zBad = 0;` |
|    16039 |  679 | `	sxu32 nBad = 0;` |
|        - |  680 | `	SyString sFallback;` |
|        - |  681 | `	const SyString *pBad;` |
|        - |  682 | `	sxi32 rc;` |
|    16039 |  683 | `	int bDisallowed = 0;` |
|    16039 |  684 | `	if( GenStateIsDisallowedPropertyAtom(nType,pTypeClass,&zBad,&nBad) ){` |
|        5 |  685 | `		bDisallowed = 1;` |
|    16037 |  686 | `	}else if( pUnionAlts ){` |
|        - |  687 | `		sxu32 i;` |
...
|       34 |  694 | `		}` |
|       15 |  695 | `	}` |
|    16039 |  696 | `	if( !bDisallowed ){` |
|    16033 |  697 | `		return SXRET_OK;` |
|        - |  698 | `	}` |
...
|        - |  721 | ` */` |
| 23562834 |  722 | `PH7_PRIVATE int GenStateIsReadonly(SyToken *pTok)` |
|        5 |  723 | `{` |
| 23789068 |  724 | `	return (pTok->nType & PH7_TK_ID)` |
| 12007646 |  725 | `		&& pTok->sData.nByte == sizeof("readonly")-1` |
| 23789063 |  726 | `		&& SyStrnicmp(pTok->sData.zString,"readonly",sizeof("readonly")-1) == 0;` |
|        5 |  727 | `}` |
|        - |  728 | `/*` |
...
|        - |  733 | ` */` |
|  8464058 |  734 | `PH7_PRIVATE sxi32 GenStatePeekSetVisibility(SyToken *pTok,SyToken *pEnd,int *pnTok)` |
|        5 |  735 | `{` |
|  8464063 |  736 | `	*pnTok = 0;` |
|  8464058 |  737 | `	if( &pTok[3] < pEnd` |
|  7913063 |  738 | `	 && (pTok->nType & PH7_TK_KEYWORD)` |
|  6453456 |  739 | `	 && (pTok[1].nType & PH7_TK_LPAREN)` |
|  2772430 |  740 | `	 && (pTok[2].nType & (PH7_TK_ID\|PH7_TK_KEYWORD))` |
...
|        9 |  762 | `}` |
|   592076 |  763 | `static sxi32 GenStateCompileClassAttr(ph7_gen_state *pGen,sxi32 iProtection,sxi32 iFlags,ph7_class *pClass)` |
|        5 |  764 | `{` |
|   592081 |  765 | `	sxu32 nLine = pGen->pIn->nLine;` |
|        - |  766 | `	ph7_class_attr *pAttr;` |
|        - |  767 | `	SyString *pName;` |
|        - |  768 | `	sxi32 rc;` |
|   592081 |  769 | `	sxu32 nType = 0;` |
|        - |  770 | `	SyString sTypeClass;` |
|        - |  771 | `	SyString sTypeText;` |
|        - |  772 | `	SySet aUnionAlts;` |
|   592081 |  773 | `	sxi32 iTypeFlags = 0;` |
|   592081 |  774 | `	SyStringInitFromBuf(&sTypeClass,0,0);` |
|   592081 |  775 | `	SyStringInitFromBuf(&sTypeText,0,0);` |
|   592081 |  776 | `	SySetInit(&aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
...
|   592081 |  780 | `	if( pClass->iFlags & PH7_CLASS_READONLY ){` |
|       21 |  781 | `		iFlags \|= PH7_CLASS_ATTR_READONLY;` |
|        9 |  782 | `	}` |
|        - |  783 | `	/* Extract visibility level */` |
|   592081 |  784 | `	iProtection = GetProtectionLevel(iProtection);` |
|        - |  785 | `	/* Parse optional type hint (typed properties, PHP 7.4+) */` |
|   600040 |  786 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
|    15923 |  787 | `		rc = GenStateParsePropertyType(pGen,&nType,&sTypeClass,&iTypeFlags,&sTypeText,&aUnionAlts);` |
|    15923 |  788 | `		if( rc == SXERR_CORRUPT ){` |
|        - |  789 | `			/* Error already reported by GenStateParseUnionTypeDecl */` |
|      ! 0 |  790 | `			goto Synchronize;` |
|    15923 |  791 | `		}else if( rc == SXERR_SYNTAX ){` |
...
|    15923 |  799 | `		}else if( rc == SXERR_ABORT ){` |
|      ! 0 |  800 | `			return SXERR_ABORT;` |
|        - |  801 | `		}` |
|     7959 |  802 | `	}` |
|      ! 0 |  803 | `loop:` |
|   592085 |  804 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
...
|        - |  810 | `	}` |
|   592085 |  811 | `	pGen->pIn++; /* Jump the dollar sign */` |
|   592085 |  812 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_ID)) == 0 ){` |
...
|   592085 |  822 | `	pName = &pGen->pIn->sData;` |
|        - |  823 | `	/* Advance the stream cursor */` |
|   592085 |  824 | `	pGen->pIn++;` |
|   592085 |  825 | `	if(pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_EQUAL/*'='*/\|PH7_TK_SEMI/*';'*/\|PH7_TK_COMMA/*','*/\|PH7_TK_OCB/*'{' hooks*/)) == 0 ){` |
...
|   592083 |  836 | `	if( iFlags & (PH7_CLASS_ATTR_PRIVATE_SET\|PH7_CLASS_ATTR_PROTECTED_SET\|PH7_CLASS_ATTR_PUBLIC_SET) ){` |
...
|   592083 |  856 | `	if( iFlags & PH7_CLASS_ATTR_READONLY ){` |
...
|   592073 |  876 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|    23879 |  877 | `		rc = GenStateValidateMemberType(pGen,pClass,pName,nType,&sTypeClass,` |
|        - |  878 | `			&sTypeText,` |
|    15916 |  879 | `			(iTypeFlags & PH7_CLASS_ATTR_UNION) ? &aUnionAlts : 0,` |
|     7958 |  880 | `			"Property %z::$%z cannot have type %z",nLine);` |
|    15921 |  881 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 |  882 | `			return SXERR_ABORT;` |
|    15921 |  883 | `		}else if( rc != SXRET_OK ){` |
|      ! 0 |  884 | `			goto Synchronize;` |
|        - |  885 | `		}` |
|     7958 |  886 | `	}` |
|        - |  887 | `	/* Reject redeclaration (catches clash with an earlier promoted property). */` |
|   592073 |  888 | `	if( PH7_ClassExtractAttribute(pClass,pName->zString,pName->nByte) != 0 ){` |
...
|   592071 |  902 | `	if( (pGen->pIn->nType & PH7_TK_EQUAL /*'='*/) && GenStateInitHasNewExpr(pGen) ){` |
...
|   592067 |  911 | `	pAttr = PH7_NewClassAttr(pGen->pVm,pName,nLine,iProtection,iFlags\|iTypeFlags);` |
|   592067 |  912 | `	if( pAttr ){` |
|   592067 |  913 | `		GenStateConsumeDoc(&(*pGen),&pAttr->sDoc);` |
|   592067 |  914 | `		if( GenStateConsumeAttrs(&(*pGen),&pAttr->aAttrs) == SXERR_ABORT ){` |
|      ! 0 |  915 | `			return SXERR_ABORT;` |
|        - |  916 | `		}` |
|   296031 |  917 | `	}` |
|   592067 |  918 | `	if( pAttr == 0 ){` |
|      ! 0 |  919 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 engine is running out of memory");` |
|      ! 0 |  920 | `		return SXERR_ABORT;` |
|        - |  921 | `	}` |
|   592067 |  922 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|    15919 |  923 | `		GenStateCopyTypeToAttr(pAttr,nType,&sTypeClass,&sTypeText,iTypeFlags,&aUnionAlts);` |
|     7957 |  924 | `	}` |
|   592067 |  925 | `	if( pGen->pIn->nType & PH7_TK_EQUAL /*'='*/ ){` |
|        - |  926 | `		SySet *pInstrContainer;` |
|   381791 |  927 | `		SyToken *pSavedDefEnd = pGen->pEnd;` |
|   381791 |  928 | `		pGen->pIn++; /*Jump the equal sign */` |
|        - |  929 | `		{` |
...
|   381791 |  934 | `			SyToken *pScan = pGen->pIn;` |
|   381791 |  935 | `			sxi32 iNest = 0;` |
|   841907 |  936 | `			while( pScan < pGen->pEnd ){` |
|   841907 |  937 | `				if( pScan->nType & (PH7_TK_LPAREN\|PH7_TK_OSB) ){` |
|    50635 |  938 | `					iNest++;` |
|   816592 |  939 | `				}else if( pScan->nType & (PH7_TK_RPAREN\|PH7_TK_CSB) ){` |
|    50635 |  940 | `					iNest--;` |
|   765962 |  941 | `				}else if( iNest <= 0 && (pScan->nType & (PH7_TK_SEMI\|PH7_TK_COMMA\|PH7_TK_OCB)) ){` |
|   381791 |  942 | `					break;` |
|        - |  943 | `				}` |
|   460121 |  944 | `				pScan++;` |
|        5 |  945 | `			}` |
|   381791 |  946 | `			pGen->pEnd = pScan;` |
|        - |  947 | `		}` |
|        - |  948 | `		/* Swap bytecode container */` |
|   381791 |  949 | `		pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   381791 |  950 | `		PH7_VmSetByteCodeContainer(pGen->pVm,&pAttr->aByteCode);` |
|        - |  951 | `		/* Compile attribute value.` |
|        - |  952 | `		 */` |
|   381791 |  953 | `		rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|   381791 |  954 | `		if( rc == SXERR_EMPTY ){` |
...
|   381791 |  961 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|   381791 |  962 | `		PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|   381791 |  963 | `		pGen->pIn = pGen->pEnd;   /* land exactly on the delimiter */` |
|   381791 |  964 | `		pGen->pEnd = pSavedDefEnd;` |
|   190893 |  965 | `	}` |
|        - |  966 | `	/* All done,install the attribute */` |
|   592067 |  967 | `	rc = PH7_ClassInstallAttr(pClass,pAttr);` |
|   592067 |  968 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  969 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 |  970 | `		return SXERR_ABORT;` |
|        - |  971 | `	}` |
|   592067 |  972 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) ){` |
...
|        - |  984 | `	}` |
|   591973 |  985 | `	if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
...
|        - |  996 | `	}` |
|   591973 |  997 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA /*','*/) ){` |
...
|        - | 1015 | `		}` |
|      ! 0 | 1016 | `	}` |
|   591969 | 1017 | `	SySetRelease(&aUnionAlts);` |
|   591969 | 1018 | `	return SXRET_OK;` |
|        9 | 1019 | `Synchronize:` |
...
|        - | 1034 | ` */` |
|  2902328 | 1035 | `static sxi32 GenStateCompileClassMethod(` |
...
|        - | 1041 | `	)` |
|        5 | 1042 | `{` |
|  2902333 | 1043 | `	sxu32 nLine = pGen->pIn->nLine;` |
|  2902333 | 1044 | `	sxu32 nKwLine = nLine; /* Line of the 'function' keyword (Reflection getStartLine) */` |
...
|  2902333 | 1051 | `	iProtection = GetProtectionLevel(iProtection);` |
|  2902333 | 1052 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|  2902333 | 1053 | `	iFuncFlags = 0;` |
|  2902333 | 1054 | `	if( pGen->pIn >= pGen->pEnd ){` |
...
|        - | 1062 | `	}` |
|  2902333 | 1063 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|        - | 1064 | `		/* Return by reference,remember that */` |
|      ! 0 | 1065 | `		iFuncFlags \|= VM_FUNC_REF_RETURN;` |
|        - | 1066 | `		/* Jump the '&' token */` |
|      ! 0 | 1067 | `		pGen->pIn++;` |
|      ! 0 | 1068 | `	}` |
|  2902333 | 1069 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|  2902333 | 1078 | `	pName = &pGen->pIn->sData;` |
|  2902333 | 1079 | `	nLine = pGen->pIn->nLine;` |
|        - | 1080 | `	/* Jump the method name */` |
|  2902333 | 1081 | `	pGen->pIn++;` |
|  2902333 | 1082 | `	if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|        - | 1083 | `		/* Abstract method */` |
|   140049 | 1084 | `		if( iProtection == PH7_CLASS_PROT_PRIVATE ){` |
...
|   140049 | 1093 | `		doBody = FALSE;` |
|    70022 | 1094 | `	}` |
|  2902333 | 1095 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|        - | 1096 | `		/* Syntax error */` |
...
|  2902333 | 1105 | `	pMeth = PH7_NewClassMethod(pGen->pVm,pClass,pName,nLine,iProtection,iFlags,iFuncFlags);` |
|  2902333 | 1106 | `	if( pMeth == 0 ){` |
|      ! 0 | 1107 | `		PH7_GenCompileError(&(*pGen),E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 1108 | `		return SXERR_ABORT;` |
|        - | 1109 | `	}` |
|  2902333 | 1110 | `	pMeth->sFunc.nLine = nKwLine;` |
|  2902333 | 1111 | `	GenStateConsumeDoc(&(*pGen),&pMeth->sFunc.sDoc);` |
|  2902333 | 1112 | `	if( GenStateConsumeAttrs(&(*pGen),&pMeth->sFunc.aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 1113 | `		return SXERR_ABORT;` |
|        - | 1114 | `	}` |
|        - | 1115 | `	/* Jump the left parenthesis '(' */` |
|  2902333 | 1116 | `	pGen->pIn++;` |
|  2902333 | 1117 | `	pEnd = 0; /* cc warning */` |
|        - | 1118 | `	/* Delimit the method signature */` |
|  2902333 | 1119 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|  2902333 | 1120 | `	if( pEnd >= pGen->pEnd ){` |
|        - | 1121 | `		/* Syntax error */` |
...
|        - | 1128 | `	}` |
|        - | 1129 | `	{` |
|  2902331 | 1130 | `		int bIsCtor = 0;` |
|  2902331 | 1131 | `		int bAbstractCtor = 0;` |
|  2902326 | 1132 | `		if( (pName->nByte == sizeof("__construct") - 1` |
|  1704054 | 1133 | `				&& SyMemcmp(pName->zString,"__construct",sizeof("__construct") - 1) == 0)` |
|  2799186 | 1134 | `		 \|\| SyStringCmp(pName,&pClass->sName,SyMemcmp) == 0 ){` |
|   206295 | 1135 | `			if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|        3 | 1136 | `				bAbstractCtor = 1;` |
|        2 | 1137 | `			}else{` |
|   206293 | 1138 | `				bIsCtor = 1;` |
|        - | 1139 | `			}` |
|   103145 | 1140 | `		}` |
|  2902331 | 1141 | `		if( pGen->pIn < pEnd ){` |
|        - | 1142 | `			/* Collect method arguments */` |
|  1116601 | 1143 | `			rc = GenStateCollectFuncArgs(&pMeth->sFunc,&(*pGen),pEnd,bIsCtor,bAbstractCtor);` |
|  1116601 | 1144 | `			if( rc == SXERR_ABORT ){` |
|      ! 0 | 1145 | `				return SXERR_ABORT;` |
|        - | 1146 | `			}` |
|   558298 | 1147 | `		}` |
|        - | 1148 | `	}` |
|        - | 1149 | `	/* Point past ')' and parse optional return type ': type' */` |
|  2902331 | 1150 | `	pGen->pIn = &pEnd[1];` |
|        - | 1151 | `	{` |
|  2902331 | 1152 | `		sxi32 rcRt = GenStateParseReturnType(pGen, &pMeth->sFunc);` |
|  2902331 | 1153 | `		if( rcRt == SXERR_ABORT ){` |
|      ! 0 | 1154 | `			return SXERR_ABORT;` |
|  2902331 | 1155 | `		}else if( rcRt == SXERR_SYNTAX ){` |
...
|        - | 1162 | `	{` |
|  2902331 | 1163 | `		sxu32 nArg = SySetUsed(&pMeth->sFunc.aArgs);` |
|        - | 1164 | `		sxu32 i;` |
|  4571217 | 1165 | `		for( i = 0; i < nArg; i++ ){` |
|  1668901 | 1166 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pMeth->sFunc.aArgs,i);` |
|        - | 1167 | `			ph7_class_attr *pAttr;` |
|  1668901 | 1168 | `			sxi32 iAttrFlags = 0;` |
|        - | 1169 | `			int bArgTyped;` |
|  1668901 | 1170 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|  1668815 | 1171 | `				continue;` |
|        - | 1172 | `			}` |
...
|       42 | 1267 | `		}` |
|        - | 1268 | `	}` |
|  2902321 | 1269 | `	if( doBody ){` |
|        - | 1270 | `		/* Compile method body */` |
|  2762277 | 1271 | `		rc = GenStateCompileFuncBody(&(*pGen),&pMeth->sFunc);` |
|  2762277 | 1272 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 | 1273 | `			return SXERR_ABORT;` |
|        - | 1274 | `		}` |
|        - | 1275 | `		/* The cursor sits just past the body's closing brace */` |
|  2762277 | 1276 | `		pMeth->sFunc.nEndLine = pGen->pIn[-1].nLine;` |
|  1381141 | 1277 | `	}else{` |
|        - | 1278 | `		/* Abstract/interface method: declaration ends at the ';' */` |
|   140049 | 1279 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI /* ';'*/) ){` |
|   140049 | 1280 | `			pMeth->sFunc.nEndLine = pGen->pIn->nLine;` |
|    70022 | 1281 | `		}` |
|        - | 1282 | `		/* Only method signature is allowed */` |
|   140049 | 1283 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI /* ';'*/) == 0 ){` |
...
|  2902321 | 1294 | `	rc = PH7_ClassInstallMethod(pClass,pMeth);` |
|  2902321 | 1295 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 1296 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 1297 | `		return SXERR_ABORT;` |
|        - | 1298 | `	}` |
|  2902321 | 1299 | `	return SXRET_OK;` |
|        6 | 1300 | `Synchronize:` |
...
|        - | 1755 | ` */` |
|    70108 | 1756 | `PH7_PRIVATE sxi32 PH7_CompileClassInterface(ph7_gen_state *pGen)` |
|        5 | 1757 | `{` |
|    70113 | 1758 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|    70113 | 1767 | `	pName = &pGen->pIn->sData;` |
|        - | 1768 | `	/* Advance the stream cursor */` |
|    70113 | 1769 | `	pGen->pIn++;` |
|        - | 1770 | `	/* Build FQN and obtain a raw class */ {` |
|        - | 1771 | `		SyBlob sFQN;` |
|        - | 1772 | `		SyString sFQNStr;` |
|    70113 | 1773 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|    70113 | 1774 | `		GenStateBuildFQN(pGen,pName,&sFQN);` |
|    70113 | 1775 | `		SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|    70113 | 1776 | `		pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|    70113 | 1777 | `		SyBlobRelease(&sFQN);` |
|        - | 1778 | `	}` |
|    70113 | 1779 | `	if( pClass == 0 ){` |
|      ! 0 | 1780 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 1781 | `		return SXERR_ABORT;` |
|        - | 1782 | `	}` |
|    70113 | 1783 | `	GenStateConsumeDoc(&(*pGen),&pClass->sDoc);` |
|    70113 | 1784 | `	if( GenStateConsumeAttrs(&(*pGen),&pClass->aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 1785 | `		return SXERR_ABORT;` |
|        - | 1786 | `	}` |
|        - | 1787 | `	/* Mark as an interface (PH7_NewRawClass may have set INTERNAL) */` |
|    70113 | 1788 | `	pClass->iFlags \|= PH7_CLASS_INTERFACE;` |
|        - | 1789 | `	/* Assume no base class is given */` |
|    70113 | 1790 | `	pBase = 0;` |
|    70113 | 1791 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|    27233 | 1792 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    27233 | 1793 | `		if( nKwrd == PH7_TKWRD_EXTENDS /* interface b extends a, c, … */ ){` |
...
|    27235 | 1804 | `				nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|    27235 | 1805 | `				SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|    27235 | 1806 | `				if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|        - | 1816 | `				}` |
|    40850 | 1817 | `				pParent = PH7_VmExtractClass(pGen->pVm,` |
|    27230 | 1818 | `					(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|    27235 | 1819 | `				SyStringInitFromBuf(&sBaseName,` |
|        - | 1820 | `					(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|        - | 1821 | `				/* Only interfaces is allowed */` |
|    27235 | 1822 | `				while( pParent && (pParent->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|      ! 0 | 1823 | `					pParent = pParent->pNextName;` |
|      ! 0 | 1824 | `				}` |
|    27235 | 1825 | `				if( pParent == 0 ){` |
...
|      ! 0 | 1831 | `					}` |
|    27235 | 1832 | `				}else if( pBase == 0 ){` |
|        - | 1833 | `					/* First parent → single-inheritance base */` |
|    27233 | 1834 | `					pBase = pParent;` |
|    13619 | 1835 | `				}else{` |
...
|        - | 1839 | `				}` |
|    27235 | 1840 | `				SyBlobRelease(&sResolved);` |
|        - | 1841 | `				/* Continue on a comma-separated list */` |
|    27235 | 1842 | `				if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA) ){` |
|        3 | 1843 | `					pGen->pIn++;` |
|        3 | 1844 | `					continue;` |
|        - | 1845 | `				}` |
|    27233 | 1846 | `				break;` |
...
|    13614 | 1848 | `		}` |
|    13614 | 1849 | `	}` |
|    70113 | 1850 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|        - | 1851 | `		/* Syntax error */` |
...
|        - | 1859 | `	}` |
|    70113 | 1860 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|    70113 | 1861 | `	pEnd = 0; /* cc warning */` |
|        - | 1862 | `	/* Delimit the interface body */` |
|    70113 | 1863 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|    70113 | 1864 | `	if( pEnd >= pGen->pEnd ){` |
|        - | 1865 | `		/* Syntax error */` |
...
|    70113 | 1875 | `	pClass->nEndLine = pEnd->nLine;` |
|        - | 1876 | `	/* Swap token stream */` |
|    70113 | 1877 | `	pTmp = pGen->pEnd;` |
|    70113 | 1878 | `	pGen->pEnd = pEnd;` |
...
|   443497 | 1886 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|   186695 | 1887 | `			pGen->pIn++;` |
|        5 | 1888 | `		}` |
|   256807 | 1889 | `		if( pGen->pIn >= pGen->pEnd ){` |
|        - | 1890 | `			/* End of interface body */` |
|    70109 | 1891 | `			break;` |
|        - | 1892 | `		}` |
|        - | 1893 | `		/* Bind a directly-preceding docblock to this member */` |
|   186703 | 1894 | `		GenStateSetPendingDoc(&(*pGen));` |
|   186703 | 1895 | `		if( (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|   186703 | 1906 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   186703 | 1907 | `		if( nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
...
|        3 | 1936 | `			goto done;` |
|        - | 1937 | `		}` |
|   186701 | 1938 | `		if( nKwrd != PH7_TKWRD_PUBLIC && nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|      ! 0 | 1945 | `			goto done;` |
|        - | 1946 | `		}` |
|   186701 | 1947 | `		if( nKwrd == PH7_TKWRD_PUBLIC ){` |
|        - | 1948 | `			/* Advance the stream cursor */` |
|   132251 | 1949 | `			pGen->pIn++;` |
|   132246 | 1950 | `			if( pGen->pIn < pGen->pEnd` |
|   132251 | 1951 | `			 && ((pGen->pIn->nType & PH7_TK_DOLLAR) != 0` |
|   132246 | 1952 | `			  \|\| (pGen->pIn->sData.nByte == 1 && pGen->pIn->sData.zString[0] == '?')) ){` |
...
|      ! 0 | 1966 | `				continue;` |
|        - | 1967 | `			}` |
|   132251 | 1968 | `			if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|      ! 0 | 1990 | `				goto done;` |
|        - | 1991 | `			}` |
|   132251 | 1992 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   132251 | 1993 | `			if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|        - | 2015 | `			}` |
|    66121 | 2016 | `		}` |
|   186697 | 2017 | `		if( nKwrd == PH7_TKWRD_CONST ){` |
|        - | 2018 | `			/* Parse constant */` |
|    54451 | 2019 | `			rc = GenStateCompileClassConstant(&(*pGen),0,0,pClass);` |
|    54451 | 2020 | `			if( rc != SXRET_OK ){` |
...
|        - | 2025 | `			}` |
|    27227 | 2026 | `		}else{` |
|   132251 | 2027 | `			sxi32 iFlags = PH7_CLASS_ATTR_ABSTRACT; /* Interface methods are implicitly abstract */` |
|   132251 | 2028 | `			if( nKwrd == PH7_TKWRD_STATIC ){` |
|        - | 2029 | `				/* Static method,record that */` |
|    11669 | 2030 | `				iFlags \|= PH7_CLASS_ATTR_STATIC;` |
|        - | 2031 | `				/* Advance the stream cursor */` |
|    11669 | 2032 | `				pGen->pIn++;` |
|    11664 | 2033 | `				if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0` |
|    11669 | 2034 | `					\|\| SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_FUNCTION ){` |
...
|   132251 | 2045 | `			rc = GenStateCompileClassMethod(&(*pGen),0,iFlags,FALSE,pClass);` |
|   132251 | 2046 | `			if( rc != SXRET_OK ){` |
...
|    70109 | 2055 | `	if( GenStateGuardClassRedeclaration(pGen,pClass) == SXERR_ABORT ){` |
|        3 | 2056 | `		return SXERR_ABORT;` |
|        - | 2057 | `	}` |
|        - | 2058 | `	/* Install the interface */` |
|    70107 | 2059 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|    70107 | 2060 | `	if( rc == SXRET_OK && pBase ){` |
|        - | 2061 | `		/* Inherit from the base interface */` |
|    27233 | 2062 | `		rc = PH7_ClassInterfaceInherit(pClass,pBase);` |
|    13614 | 2063 | `	}` |
|    70107 | 2064 | `	if( rc != SXRET_OK ){` |
...
|    70111 | 2070 | `	pGen->pIn  = &pEnd[1];` |
|    70111 | 2071 | `	pGen->pEnd = pTmp;` |
|    70111 | 2072 | `	return PH7_OK;` |
|    35059 | 2073 | `}` |
|        - | 2074 | `/*` |
...
|        - | 2098 | ` */` |
|   445158 | 2099 | `static sxi32 GenStateCheckInterfaceSignatures(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 | 2100 | `{` |
|        - | 2101 | `	ph7_class **apIface;` |
|        - | 2102 | `	sxu32 nIface,i;` |
|        - | 2103 | `	sxi32 rc;` |
|   445163 | 2104 | `	if( pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|      ! 0 | 2105 | `		return SXRET_OK;` |
|        - | 2106 | `	}` |
|   445163 | 2107 | `	apIface = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|   445163 | 2108 | `	nIface = SySetUsed(&pClass->aInterface);` |
|   861533 | 2109 | `	for(i = 0; i < nIface; i++){` |
|   416375 | 2110 | `		ph7_class *pIface = apIface[i];` |
|        - | 2111 | `		SyHashEntry *pEntry;` |
|   416375 | 2112 | `		SyHashResetLoopCursor(&pIface->hMethod);` |
|  1233461 | 2113 | `		while((pEntry = SyHashGetNextEntry(&pIface->hMethod)) != 0 ){` |
|   817091 | 2114 | `			ph7_class_method *pIfaceMeth = (ph7_class_method *)pEntry->pUserData;` |
|        - | 2115 | `			ph7_class_method *pImplMeth;` |
|   817091 | 2116 | `			SyString *pMName = &pIfaceMeth->sFunc.sName;` |
|        - | 2117 | `			/* Find the implementing method in the class */` |
|   817091 | 2118 | `			pImplMeth = PH7_ClassExtractMethod(pClass,pMName->zString,pMName->nByte);` |
|   817091 | 2119 | `			if( pImplMeth == 0 \|\| (pImplMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT) ){` |
...
|   817073 | 2123 | `			if( pImplMeth->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|        - | 2133 | `			 */` |
|        - | 2134 | `			{` |
|   817073 | 2135 | `				sxu32 nIfaceArgs = SySetUsed(&pIfaceMeth->sFunc.aArgs);` |
|   817073 | 2136 | `				sxu32 nImplArgs = SySetUsed(&pImplMeth->sFunc.aArgs);` |
|   817073 | 2137 | `				int sigError = 0;` |
|   817073 | 2138 | `				if( nImplArgs < nIfaceArgs ){` |
|        3 | 2139 | `					sigError = 1;` |
|   817072 | 2140 | `				}else if( nImplArgs > nIfaceArgs ){` |
|        - | 2141 | `					/* Extra parameters must all have default values */` |
|     3897 | 2142 | `					ph7_vm_func_arg *aImplArgs = (ph7_vm_func_arg *)SySetBasePtr(&pImplMeth->sFunc.aArgs);` |
|        - | 2143 | `					sxu32 k;` |
|     7787 | 2144 | `					for(k = nIfaceArgs; k < nImplArgs; k++){` |
|     3897 | 2145 | `						if( SySetUsed(&aImplArgs[k].aByteCode) == 0 ){` |
|        3 | 2146 | `							sigError = 1;` |
|        3 | 2147 | `							break;` |
|        - | 2148 | `						}` |
|     1950 | 2149 | `					}` |
|     1946 | 2150 | `				}` |
|   817073 | 2151 | `				if( sigError ){` |
...
|        - | 2231 | ` */` |
|   445158 | 2232 | `static sxi32 GenStateCheckAbstractMethods(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 | 2233 | `{` |
...
|   445163 | 2240 | `	if( pClass->iFlags & (PH7_CLASS_ABSTRACT\|PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|    19499 | 2241 | `		return SXRET_OK;` |
|        - | 2242 | `	}` |
|        - | 2243 | `	/* Count abstract methods */` |
|   425669 | 2244 | `	nAbstract = 0;` |
|   425669 | 2245 | `	SyHashResetLoopCursor(&pClass->hMethod);` |
|  6395569 | 2246 | `	while((pEntry = SyHashGetNextEntry(&pClass->hMethod)) != 0 ){` |
|  5757073 | 2247 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|  5757073 | 2248 | `		if( pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
...
|        8 | 2253 | `		}` |
|        5 | 2254 | `	}` |
|   425669 | 2255 | `	if( nAbstract == 0 ){` |
|   425655 | 2256 | `		return SXRET_OK;` |
|        - | 2257 | `	}` |
...
|        - | 2394 | ` */` |
|   507746 | 2395 | `PH7_PRIVATE sxi32 GenStateParseClassReference(ph7_gen_state *pGen,SyBlob *pFqn)` |
|        5 | 2396 | `{` |
|   507751 | 2397 | `	int isAbsolute = 0;` |
|   507751 | 2398 | `	SyToken *pStart = pGen->pIn;` |
|        - | 2399 | `	SyBlob sName;` |
|   507751 | 2400 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) ){` |
|     4525 | 2401 | `		isAbsolute = 1;` |
|     4525 | 2402 | `		pGen->pIn++;` |
|     2260 | 2403 | `	}` |
|   507751 | 2404 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|        9 | 2405 | `		pGen->pIn = pStart;` |
|        9 | 2406 | `		return SXERR_INVALID;` |
|        - | 2407 | `	}` |
|   507745 | 2408 | `	SyBlobInit(&sName,&pGen->pVm->sAllocator);` |
|   507745 | 2409 | `	SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|   507745 | 2410 | `	pGen->pIn++;` |
|   761649 | 2411 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) &&` |
|   253914 | 2412 | `		&pGen->pIn[1] < pGen->pEnd && (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|       28 | 2413 | `		SyBlobAppend(&sName,"\\",1);` |
|       28 | 2414 | `		pGen->pIn++;` |
|       28 | 2415 | `		SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|       28 | 2416 | `		pGen->pIn++;` |
|        2 | 2417 | `	}` |
|   507745 | 2418 | `	if( isAbsolute ){` |
|     4523 | 2419 | `		SyBlobAppend(pFqn,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|     2264 | 2420 | `	}else{` |
|        - | 2421 | `		SyString sRaw;` |
|   503227 | 2422 | `		SyStringInitFromBuf(&sRaw,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|   503227 | 2423 | `		GenStateResolveName(pGen,&sRaw,pFqn);` |
|        - | 2424 | `	}` |
|   507745 | 2425 | `	SyBlobRelease(&sName);` |
|   507745 | 2426 | `	return SXRET_OK;` |
|   253878 | 2427 | `}` |
|        - | 2428 | `/*` |
...
|   198500 | 2436 | `static int GenStateInterfaceIsThrowableAt(ph7_class *pInterface,int iDepth)` |
|        5 | 2437 | `{` |
|        - | 2438 | `	ph7_class **apParent;` |
|        - | 2439 | `	sxu32 n;` |
|   525349 | 2440 | `	while( pInterface ){` |
|   334635 | 2441 | `		if( iDepth > PH7_THROWABLE_WALK_MAX_DEPTH ){` |
|      ! 0 | 2442 | `			return FALSE;` |
|        - | 2443 | `		}` |
|   373535 | 2444 | `		if( pInterface->sName.nByte == sizeof("Throwable")-1 &&` |
|    77800 | 2445 | `			SyMemcmp(pInterface->sName.zString,"Throwable",sizeof("Throwable")-1) == 0 ){` |
|     7791 | 2446 | `			return TRUE;` |
|        - | 2447 | `		}` |
|   326849 | 2448 | `		apParent = (ph7_class **)SySetBasePtr(&pInterface->aInterface);` |
|   326851 | 2449 | `		for( n = 0 ; n < SySetUsed(&pInterface->aInterface) ; ++n ){` |
|        3 | 2450 | `			if( GenStateInterfaceIsThrowableAt(apParent[n],iDepth+1) ){` |
|      ! 0 | 2451 | `				return TRUE;` |
|        - | 2452 | `			}` |
|        2 | 2453 | `		}` |
|   326849 | 2454 | `		pInterface = pInterface->pBase;` |
|   326849 | 2455 | `		iDepth++;` |
|        5 | 2456 | `	}` |
|   190719 | 2457 | `	return FALSE;` |
|    99255 | 2458 | `}` |
|   198498 | 2459 | `static int GenStateInterfaceIsThrowable(ph7_class *pInterface)` |
|        5 | 2460 | `{` |
|   198503 | 2461 | `	return GenStateInterfaceIsThrowableAt(pInterface,0);` |
|        5 | 2462 | `}` |
|        - | 2463 | `/*` |
...
|        - | 2467 | ` */` |
|     7786 | 2468 | `static int GenStateClassIsExceptionOrError(ph7_class *pBase)` |
|        5 | 2469 | `{` |
|     7795 | 2470 | `	while( pBase ){` |
...
|        - | 2491 | ` */` |
|     7830 | 2492 | `static sxi32 GenStateCompileEnumCase(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 | 2493 | `{` |
|     7835 | 2494 | `	sxu32 nLine = pGen->pIn->nLine;` |
|        - | 2495 | `	SySet *pInstrContainer;` |
|        - | 2496 | `	ph7_class_attr *pCase;` |
|        - | 2497 | `	SyString *pName;` |
|        - | 2498 | `	sxi32 rc;` |
|     7835 | 2499 | `	pGen->pIn++; /* Jump the 'case' keyword */` |
|     7835 | 2500 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|        - | 2507 | `	}` |
|     7835 | 2508 | `	pName = &pGen->pIn->sData;` |
|        - | 2509 | `	/* Cases share the class-constant namespace (php: "Cannot redefine class constant") */` |
|     7835 | 2510 | `	if( SyHashGet(&pClass->hAttr,(const void *)pName->zString,pName->nByte) != 0 ){` |
...
|        - | 2517 | `	}` |
|     7835 | 2518 | `	pCase = PH7_NewClassAttr(pGen->pVm,pName,pGen->pIn->nLine,PH7_CLASS_PROT_PUBLIC,` |
|        - | 2519 | `		PH7_CLASS_ATTR_CONSTANT\|PH7_CLASS_ATTR_ENUMCASE);` |
|     7835 | 2520 | `	if( pCase == 0 ){` |
|      ! 0 | 2521 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2522 | `		return SXERR_ABORT;` |
|        - | 2523 | `	}` |
|     7835 | 2524 | `	GenStateConsumeDoc(&(*pGen),&pCase->sDoc);` |
|     7835 | 2525 | `	if( GenStateConsumeAttrs(&(*pGen),&pCase->aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 2526 | `		return SXERR_ABORT;` |
|        - | 2527 | `	}` |
|     7835 | 2528 | `	pGen->pIn++; /* Jump the case name */` |
|     7835 | 2529 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_EQUAL /* '=' */) ){` |
|     7821 | 2530 | `		if( pClass->nEnumBacking == 0 ){` |
...
|        - | 2537 | `		}` |
|     7817 | 2538 | `		pGen->pIn++; /* Jump the equal sign */` |
|        - | 2539 | `		/* Compile the backing value expression into the case's own container` |
|        - | 2540 | `		 * (same technique as class constants). */` |
|     7817 | 2541 | `		pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|     7817 | 2542 | `		PH7_VmSetByteCodeContainer(pGen->pVm,&pCase->aByteCode);` |
|     7817 | 2543 | `		rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|     7817 | 2544 | `		if( rc == SXERR_EMPTY ){` |
|      ! 0 | 2545 | `			rc = PH7_GenCompileError(pGen,E_ERROR,nLine,` |
|      ! 0 | 2546 | `				"Empty value for enum case %z::%z",&pClass->sName,pName);` |
|      ! 0 | 2547 | `		}` |
|     7817 | 2548 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|     7817 | 2549 | `		PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|     7817 | 2550 | `		if( rc == SXERR_ABORT ){` |
...
|        - | 2561 | `		}` |
|        - | 2562 | `	}` |
|     7831 | 2563 | `	rc = PH7_ClassInstallAttr(pClass,pCase);` |
|     7831 | 2564 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 2565 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2566 | `		return SXERR_ABORT;` |
|        - | 2567 | `	}` |
|     7831 | 2568 | `	SySetPut(&pClass->aEnumCases,(const void *)&pCase);` |
|     7831 | 2569 | `	return SXRET_OK;` |
|        2 | 2570 | `Synchronize:` |
...
|        - | 2585 | ` */` |
|     3920 | 2586 | `static sxi32 GenStateCompileEnumMethods(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 | 2587 | `{` |
...
|     3925 | 2593 | `	sxi32 rc = SXRET_OK;` |
|     3925 | 2594 | `	nMax = 3*(sxu32)sizeof("function tryFrom(string $value){return __phl_enum_tryfrom('',$value);}")` |
|     3920 | 2595 | `		+ 3*SyStringLength(&pClass->sName) + 64;` |
|     3925 | 2596 | `	zSrc = (char *)SyMemBackendAlloc(&pGen->pVm->sAllocator,nMax);` |
|     3925 | 2597 | `	if( zSrc == 0 ){` |
|      ! 0 | 2598 | `		PH7_GenCompileError(pGen,E_ERROR,pClass->nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2599 | `		return SXERR_ABORT;` |
|        - | 2600 | `	}` |
|     3925 | 2601 | `	zBack = (pClass->nEnumBacking == MEMOBJ_INT) ? "int" : "string";` |
|     3925 | 2602 | `	if( pClass->nEnumBacking != 0 ){` |
|     5858 | 2603 | `		nSrc = SyBufferFormat(zSrc,nMax,` |
...
|     1951 | 2607 | `			&pClass->sName,zBack,&pClass->sName,zBack,&pClass->sName);` |
|     1956 | 2608 | `	}else{` |
|       30 | 2609 | `		nSrc = SyBufferFormat(zSrc,nMax,` |
|        9 | 2610 | `			"function cases(){return __phl_enum_cases('%z');}",&pClass->sName);` |
|        - | 2611 | `	}` |
|     3925 | 2612 | `	SySetInit(&sToken,&pGen->pVm->sAllocator,sizeof(SyToken));` |
|     3925 | 2613 | `	PH7_TokenizePHP(zSrc,nSrc,pClass->nLine,&sToken,0);` |
|     3925 | 2614 | `	pSaveIn = pGen->pIn;` |
|     3925 | 2615 | `	pSaveEnd = pGen->pEnd;` |
|     3925 | 2616 | `	pGen->pIn = (SyToken *)SySetBasePtr(&sToken);` |
|     3925 | 2617 | `	pGen->pEnd = &pGen->pIn[SySetUsed(&sToken)];` |
|    15649 | 2618 | `	while( pGen->pIn < pGen->pEnd && rc != SXERR_ABORT ){` |
|    11729 | 2619 | `		rc = GenStateCompileClassMethod(&(*pGen),PH7_TKWRD_PUBLIC,PH7_CLASS_ATTR_STATIC,TRUE,pClass);` |
|        5 | 2620 | `	}` |
|     3925 | 2621 | `	pGen->pIn = pSaveIn;` |
|     3925 | 2622 | `	pGen->pEnd = pSaveEnd;` |
|     3925 | 2623 | `	SySetRelease(&sToken);` |
|     3925 | 2624 | `	return (rc == SXERR_ABORT) ? SXERR_ABORT : SXRET_OK;` |
|     1965 | 2625 | `}` |
|        - | 2626 | `/*` |
...
|        - | 2640 | ` */` |
|     3920 | 2641 | `static sxi32 GenStateEnumFinalize(ph7_gen_state *pGen,ph7_class *pClass,sxu32 nLine)` |
|        5 | 2642 | `{` |
|        - | 2643 | `	SyHashEntry *pEntry;` |
|        - | 2644 | `	sxi32 rc;` |
|        - | 2645 | `	sxu32 n;` |
|        - | 2646 | `	/* php: "Enum %s cannot include properties" */` |
|     3925 | 2647 | `	SyHashResetLoopCursor(&pClass->hAttr);` |
|    11757 | 2648 | `	while( (pEntry = SyHashGetNextEntry(&pClass->hAttr)) != 0 ){` |
|     7839 | 2649 | `		ph7_class_attr *pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|     7839 | 2650 | `		if( (pAttr->iFlags & PH7_CLASS_ATTR_CONSTANT) == 0 ){` |
...
|    54885 | 2660 | `	for( n = 0 ; n < SX_ARRAYSIZE(azEnumBannedMagic) ; n++ ){` |
|    76440 | 2661 | `		if( SyHashGet(&pClass->hMethod,(const void *)azEnumBannedMagic[n],` |
|    50965 | 2662 | `			SyStrlen(azEnumBannedMagic[n])) != 0 ){` |
...
|     3925 | 2678 | `		pAttr = PH7_NewClassAttr(pGen->pVm,&sNameProp,nLine,PH7_CLASS_PROT_PUBLIC,` |
|        - | 2679 | `			PH7_CLASS_ATTR_READONLY\|PH7_CLASS_ATTR_TYPED);` |
|     3925 | 2680 | `		if( pAttr == 0 ){` |
|      ! 0 | 2681 | `			PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2682 | `			return SXERR_ABORT;` |
|        - | 2683 | `		}` |
|     3925 | 2684 | `		pAttr->nType = MEMOBJ_STRING;` |
|     3925 | 2685 | `		SyStringInitFromBuf(&pAttr->sTypeName,"string",sizeof("string")-1);` |
|     3925 | 2686 | `		PH7_ClassInstallAttr(pClass,pAttr);` |
|     3925 | 2687 | `		if( pClass->nEnumBacking != 0 ){` |
|     3907 | 2688 | `			pAttr = PH7_NewClassAttr(pGen->pVm,&sValueProp,nLine,PH7_CLASS_PROT_PUBLIC,` |
|        - | 2689 | `				PH7_CLASS_ATTR_READONLY\|PH7_CLASS_ATTR_TYPED);` |
|     3907 | 2690 | `			if( pAttr == 0 ){` |
|      ! 0 | 2691 | `				PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2692 | `				return SXERR_ABORT;` |
|        - | 2693 | `			}` |
|     3907 | 2694 | `			pAttr->nType = pClass->nEnumBacking;` |
|     3907 | 2695 | `			if( pClass->nEnumBacking == MEMOBJ_INT ){` |
|        7 | 2696 | `				SyStringInitFromBuf(&pAttr->sTypeName,"int",sizeof("int")-1);` |
|        4 | 2697 | `			}else{` |
|     3901 | 2698 | `				SyStringInitFromBuf(&pAttr->sTypeName,"string",sizeof("string")-1);` |
|        - | 2699 | `			}` |
|     3907 | 2700 | `			PH7_ClassInstallAttr(pClass,pAttr);` |
|     1951 | 2701 | `		}` |
|        - | 2702 | `	}` |
|     3925 | 2703 | `	return GenStateCompileEnumMethods(&(*pGen),pClass);` |
|     1965 | 2704 | `}` |
|        - | 2705 | `/*` |
...
|        - | 2714 | ` */` |
|   445208 | 2715 | `static sxi32 GenStateCompileClassEx(ph7_gen_state *pGen,sxi32 iFlags,` |
|        - | 2716 | `	SyString *pAnonName,SyToken **ppArgStart,SyToken **ppArgEnd)` |
|        5 | 2717 | `{` |
|   445213 | 2718 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|   445213 | 2729 | `	pGen->pIn++;` |
|   445213 | 2730 | `	if( pAnonName ){` |
...
|       19 | 2745 | `	}else{` |
|   445183 | 2746 | `		if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
|        - | 2747 | `			/* Syntax error */` |
...
|   445183 | 2760 | `		pName = &pGen->pIn->sData;` |
|        - | 2761 | `		/* Advance the stream cursor */` |
|   445183 | 2762 | `		pGen->pIn++;` |
|        - | 2763 | `		/* Build FQN and obtain a raw class */ {` |
|        - | 2764 | `			SyBlob sFQN;` |
|        - | 2765 | `			SyString sFQNStr;` |
|   445183 | 2766 | `			SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|   445183 | 2767 | `			GenStateBuildFQN(pGen,pName,&sFQN);` |
|   445183 | 2768 | `			SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|   445183 | 2769 | `			pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|   445183 | 2770 | `			SyBlobRelease(&sFQN);` |
|        - | 2771 | `		}` |
|        - | 2772 | `	}` |
|   445213 | 2773 | `	if( pClass == 0 ){` |
|      ! 0 | 2774 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2775 | `		return SXERR_ABORT;` |
|        - | 2776 | `	}` |
|   445208 | 2777 | `	if( (iFlags & PH7_CLASS_ENUM) && pGen->pIn < pGen->pEnd` |
|     3929 | 2778 | `		&& (pGen->pIn->nType & PH7_TK_COLON /* ':' */) ){` |
|        - | 2779 | ``		/* Backed enum: `enum Name: int\|string` (PHP 8.1) */`` |
|     3909 | 2780 | `		pGen->pIn++; /* Jump ':' */` |
|     3904 | 2781 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD)` |
|     3909 | 2782 | `			&& SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_INT ){` |
|        7 | 2783 | `			pClass->nEnumBacking = MEMOBJ_INT;` |
|        7 | 2784 | `			pGen->pIn++;` |
|     3902 | 2785 | `		}else if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD)` |
|     3903 | 2786 | `			&& SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_STRING ){` |
|     3901 | 2787 | `			pClass->nEnumBacking = MEMOBJ_STRING;` |
|     3901 | 2788 | `			pGen->pIn++;` |
|     1953 | 2789 | `		}else{` |
...
|        - | 2800 | `		}` |
|     1952 | 2801 | `	}` |
|   445213 | 2802 | `	GenStateConsumeDoc(&(*pGen),&pClass->sDoc);` |
|   445213 | 2803 | `	if( GenStateConsumeAttrs(&(*pGen),&pClass->aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 2804 | `		return SXERR_ABORT;` |
|        - | 2805 | `	}` |
|        - | 2806 | `	/* implemented interfaces and per-use-statement trait containers */` |
|   445213 | 2807 | `	SySetInit(&aInterfaces,&pGen->pVm->sAllocator,sizeof(ph7_class *));` |
|   445213 | 2808 | `	SySetInit(&aUseEntries,&pGen->pVm->sAllocator,sizeof(TraitUseEntry));` |
|        - | 2809 | `	/* Assume a standalone class */` |
|   445213 | 2810 | `	pBase = 0;` |
|   445213 | 2811 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|   362077 | 2812 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   362077 | 2813 | `		if( nKwrd == PH7_TKWRD_EXTENDS /* class b extends a */ ){` |
|        - | 2814 | `			SyBlob sResolved;` |
|        - | 2815 | `			SyString sBaseName;` |
|        - | 2816 | `			sxu32 nRefLine;` |
|   241369 | 2817 | `			if( iFlags & PH7_CLASS_ENUM ){` |
...
|        - | 2823 | `				}` |
|      ! 0 | 2824 | `			}` |
|   241369 | 2825 | `			pGen->pIn++; /* Advance past 'extends' */` |
|   241369 | 2826 | `			nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|   241369 | 2827 | `			SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|   241369 | 2828 | `			if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|        - | 2838 | `			}` |
|   362048 | 2839 | `			pBase = PH7_VmExtractClass(pGen->pVm,` |
|   241362 | 2840 | `				(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|   241367 | 2841 | `			SyStringInitFromBuf(&sBaseName,` |
|        - | 2842 | `				(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|        - | 2843 | `			/* Interfaces are not allowed */` |
|   241367 | 2844 | `			while( pBase && (pBase->iFlags & PH7_CLASS_INTERFACE) ){` |
|      ! 0 | 2845 | `				pBase = pBase->pNextName;` |
|      ! 0 | 2846 | `			}` |
|   241367 | 2847 | `			if( pBase == 0 ){` |
...
|        - | 2853 | `				}` |
|      ! 0 | 2854 | `			}else{` |
|   241367 | 2855 | `				if( pBase->iFlags & PH7_CLASS_ENUM ){` |
...
|   241366 | 2863 | `				}else if( pBase->iFlags & PH7_CLASS_FINAL ){` |
...
|      ! 0 | 2870 | `				}` |
|        - | 2871 | `			}` |
|   241367 | 2872 | `			SyBlobRelease(&sResolved);` |
|   241367 | 2873 | `			if( iFlags & PH7_CLASS_ENUM ){` |
|      ! 0 | 2874 | `				pBase = 0; /* Error already reported: enums have no base class */` |
|      ! 0 | 2875 | `			}` |
|   120681 | 2876 | `		}` |
|   362075 | 2877 | `		if (pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) && SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_IMPLEMENTS ){` |
|        - | 2878 | `			ph7_class *pInterface;` |
|        - | 2879 | `			/* Interface implementation */` |
|   136281 | 2880 | `			pGen->pIn++; /* Advance the stream cursor */` |
|   130360 | 2881 | `			for(;;){` |
|        - | 2882 | `				SyBlob sResolved;` |
|        - | 2883 | `				SyString sIntName;` |
|        - | 2884 | `				sxu32 nRefLine;` |
|   198503 | 2885 | `				nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|   198503 | 2886 | `				SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|   198503 | 2887 | `				if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|      ! 0 | 2895 | `					break;` |
|        - | 2896 | `				}` |
|   397001 | 2897 | `				pInterface = PH7_VmExtractClass(pGen->pVm,` |
|   198498 | 2898 | `					(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|   198503 | 2899 | `				SyStringInitFromBuf(&sIntName,` |
|        - | 2900 | `					(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|        - | 2901 | `				/* Only interfaces are allowed */` |
|   198503 | 2902 | `				while( pInterface && (pInterface->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|      ! 0 | 2903 | `					pInterface = pInterface->pNextName;` |
|      ! 0 | 2904 | `				}` |
|   198503 | 2905 | `				if( pInterface == 0 ){` |
...
|   198503 | 2919 | `					SyString *pFqn = &pClass->sName;` |
|   198503 | 2920 | `					int bIsExceptionOrError =` |
|   103141 | 2921 | `						(pFqn->nByte == sizeof("Exception")-1 &&` |
|   299695 | 2922 | `						 SyMemcmp(pFqn->zString,"Exception",sizeof("Exception")-1) == 0) \|\|` |
|   196561 | 2923 | `						(pFqn->nByte == sizeof("Error")-1 &&` |
|     3902 | 2924 | `						 SyMemcmp(pFqn->zString,"Error",sizeof("Error")-1) == 0);` |
|   202391 | 2925 | `					if( GenStateInterfaceIsThrowable(pInterface) &&` |
|    11682 | 2926 | `						!GenStateClassIsExceptionOrError(pBase) &&` |
|     3891 | 2927 | `						!bIsExceptionOrError ){` |
...
|        6 | 2937 | `					}else{` |
|   198497 | 2938 | `						SySetPut(&aInterfaces,(const void *)&pInterface);` |
|        - | 2939 | `					}` |
|        - | 2940 | `				}` |
|   198503 | 2941 | `				SyBlobRelease(&sResolved);` |
|   198503 | 2942 | `				if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COMMA) == 0 ){` |
|    68143 | 2943 | `					break;` |
|        - | 2944 | `				}` |
|    62227 | 2945 | `				pGen->pIn++;/* Jump the comma */` |
|        5 | 2946 | `			}` |
|    68138 | 2947 | `		}` |
|   181035 | 2948 | `	}` |
|   445211 | 2949 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|        - | 2950 | `		/* Syntax error */` |
...
|        - | 2958 | `	}` |
|   445211 | 2959 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|   445211 | 2960 | `	pEnd = 0; /* cc warning */` |
|        - | 2961 | `	/* Delimit the class body */` |
|   445211 | 2962 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|   445211 | 2963 | `	if( pEnd >= pGen->pEnd ){` |
|        - | 2964 | `		/* Syntax error */` |
...
|   445211 | 2974 | `	pClass->nEndLine = pEnd->nLine;` |
|        - | 2975 | `	/* Swap token stream */` |
|   445211 | 2976 | `	pTmp = pGen->pEnd;` |
|   445211 | 2977 | `	pGen->pEnd = pEnd;` |
|        - | 2978 | `	/* Merge the inherited flags (PH7_NewRawClass may have set INTERNAL) */` |
|   445211 | 2979 | `	pClass->iFlags \|= iFlags;` |
|        - | 2980 | `	/* Start the parse process */` |
|  1693176 | 2981 | `	for(;;){` |
|        - | 2982 | `		/* Jump leading/trailing semi-colons */` |
|  4866279 | 2983 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|   887751 | 2984 | `			pGen->pIn++;` |
|        5 | 2985 | `		}` |
|  3978533 | 2986 | `		if( pGen->pIn >= pGen->pEnd ){` |
|        - | 2987 | `			/* End of class body */` |
|   445169 | 2988 | `			break;` |
|        - | 2989 | `		}` |
|        - | 2990 | `		/* Bind a directly-preceding docblock to this member */` |
|  3533369 | 2991 | `		GenStateSetPendingDoc(&(*pGen));` |
|  3533364 | 2992 | `		if( (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR)) == 0` |
|  1766687 | 2993 | ``			&& !GenStateIsReadonly(pGen->pIn) /* allow a leading `readonly` modifier */ ){`` |
...
|  3533369 | 3004 | `		iProtection = PH7_TKWRD_PUBLIC;` |
|  3533369 | 3005 | `		iAttrflags = 0;` |
...
|  3533369 | 3010 | `		if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|      ! 0 | 3011 | `			int bMod = 0;` |
...
|        - | 3032 | `			}` |
|      ! 0 | 3033 | `		}` |
|  3533369 | 3034 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|        - | 3035 | `			/* Extract the current keyword */` |
|  3533369 | 3036 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  3533369 | 3037 | `			if( nKwrd == PH7_TKWRD_CASE && (pClass->iFlags & PH7_CLASS_ENUM) ){` |
|        - | 3038 | ``				/* Enum case declaration: `case NAME [= value];` */`` |
|     7835 | 3039 | `				rc = GenStateCompileEnumCase(&(*pGen),pClass);` |
|     7835 | 3040 | `				if( rc != SXRET_OK ){` |
...
|     7831 | 3046 | `				continue;` |
|        - | 3047 | `			}` |
|  3525539 | 3048 | `			if( nKwrd == PH7_TKWRD_USE ){` |
|        - | 3049 | `				/* Trait use: use TraitA, TraitB [{ ... }]; */` |
|        - | 3050 | `				TraitUseEntry sUse;` |
|    15647 | 3051 | `				SySetInit(&sUse.aTraits,&pGen->pVm->sAllocator,sizeof(ph7_class *));` |
|    15647 | 3052 | `				sUse.pResolvStart = sUse.pResolvEnd = 0;` |
|    15647 | 3053 | `				pGen->pIn++; /* Jump the 'use' keyword */` |
|     7829 | 3054 | `				for(;;){` |
|        - | 3055 | `					ph7_class *pTrait;` |
|        - | 3056 | `					SyBlob sResolved;` |
|        - | 3057 | `					SyString sTraitName;` |
|    15655 | 3058 | `					sxu32 nUseLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
...
|    15655 | 3065 | `					SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|    15655 | 3066 | `					if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|      ! 0 | 3073 | `						break;` |
|        - | 3074 | `					}` |
|    31305 | 3075 | `					pTrait = PH7_VmExtractClass(pGen->pVm,` |
|    15650 | 3076 | `						(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|    15655 | 3077 | `					SyStringInitFromBuf(&sTraitName,` |
|        - | 3078 | `						(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|        - | 3079 | `					/* Only traits are allowed */` |
|    15655 | 3080 | `					while( pTrait && (pTrait->iFlags & PH7_CLASS_TRAIT) == 0 ){` |
|      ! 0 | 3081 | `						pTrait = pTrait->pNextName;` |
|      ! 0 | 3082 | `					}` |
|    15655 | 3083 | `					if( pTrait == 0 ){` |
...
|        - | 3089 | `						}` |
|      ! 0 | 3090 | `					}else{` |
|    15655 | 3091 | `						SySetPut(&sUse.aTraits,(const void *)&pTrait);` |
|        - | 3092 | `					}` |
|    15655 | 3093 | `					SyBlobRelease(&sResolved);` |
...
|    15655 | 3096 | `					if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COMMA) == 0 ){` |
|     7826 | 3097 | `						break;` |
|        - | 3098 | `					}` |
|       10 | 3099 | `					pGen->pIn++; /* Jump the comma */` |
|        2 | 3100 | `				}` |
|        - | 3101 | `				/* Expect semicolon or opening brace (for conflict resolution) */` |
|    15647 | 3102 | `				if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OCB) ){` |
|        - | 3103 | `					SyToken *pBlock;` |
...
|        - | 3112 | `					}` |
|        5 | 3113 | `				}` |
|    15647 | 3114 | `				SySetPut(&aUseEntries,(const void *)&sUse);` |
|        - | 3115 | `				/* The semicolon will be consumed by the outer loop */` |
|    15647 | 3116 | `				continue;` |
|        - | 3117 | `			}` |
|  3509897 | 3118 | `			if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|        - | 3119 | `				int nSetTok;` |
|  2965061 | 3120 | `				sxi32 nSetVis = GenStatePeekSetVisibility(pGen->pIn,pGen->pEnd,&nSetTok);` |
|  2965061 | 3121 | `				if( nSetVis ){` |
...
|        2 | 3126 | `				}else{` |
|  2965059 | 3127 | `					iProtection = nKwrd;` |
|  2965059 | 3128 | `					pGen->pIn++; /* Jump the visibility token */` |
|        - | 3129 | `					/* Optional asymmetric set-visibility after the read` |
|        - | 3130 | ``					 * visibility: `public private(set) int $x`. */`` |
|  2965059 | 3131 | `					nSetVis = GenStatePeekSetVisibility(pGen->pIn,pGen->pEnd,&nSetTok);` |
|  2965059 | 3132 | `					if( nSetVis ){` |
...
|  2965061 | 3139 | `				if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|       28 | 3140 | `					iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|       28 | 3141 | `					pGen->pIn++; /* Jump the 'readonly' modifier */` |
|       12 | 3142 | `				}` |
|  2965056 | 3143 | `				if( pGen->pIn >= pGen->pEnd` |
|  2965061 | 3144 | `					\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|      ! 0 | 3152 | `					goto done;` |
|        - | 3153 | `				}` |
|  2965061 | 3154 | `				if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|        - | 3155 | `					/* Attribute declaration (untyped) */` |
|   525559 | 3156 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|   525559 | 3157 | `					if( rc != SXRET_OK ){` |
|       11 | 3158 | `						if( rc == SXERR_ABORT ){` |
|      ! 0 | 3159 | `							return SXERR_ABORT;` |
|        - | 3160 | `						}` |
|       11 | 3161 | `						goto done;` |
|        - | 3162 | `					}` |
|   533490 | 3163 | `					continue;` |
|        - | 3164 | `				}` |
|  2439507 | 3165 | `				if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
|        - | 3166 | `					/* Typed attribute declaration (PHP 7.4+) */` |
|    15889 | 3167 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|    15889 | 3168 | `					if( rc != SXRET_OK ){` |
...
|  2423623 | 3177 | `				nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  1211809 | 3178 | `			}` |
|  2968459 | 3179 | `			if( nKwrd == PH7_TKWRD_CONST ){` |
|        - | 3180 | `				/* Process constant declaration */` |
|   287885 | 3181 | `				rc = GenStateCompileClassConstant(&(*pGen),iProtection,iAttrflags,pClass);` |
|   287885 | 3182 | `				if( rc != SXRET_OK ){` |
...
|        - | 3187 | `				}` |
|   143941 | 3188 | `			}else{` |
|  2680579 | 3189 | `				if( nKwrd == PH7_TKWRD_STATIC ){` |
|        - | 3190 | `					/* Static method or attribute,record that */` |
|   101287 | 3191 | `					iAttrflags \|= PH7_CLASS_ATTR_STATIC;` |
|   101287 | 3192 | `					pGen->pIn++; /* Jump the static keyword */` |
|   101287 | 3193 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|        - | 3194 | `						int nSetTok;` |
|    74029 | 3195 | `						sxi32 nSetVis = GenStatePeekSetVisibility(pGen->pIn,pGen->pEnd,&nSetTok);` |
|    74029 | 3196 | `						if( nSetVis ){` |
...
|    74027 | 3202 | `							nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    74027 | 3203 | `							if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
...
|   101287 | 3217 | `					if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|      ! 0 | 3218 | `						iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|      ! 0 | 3219 | `						pGen->pIn++; /* Jump the 'readonly' modifier */` |
|      ! 0 | 3220 | `					}` |
|   101282 | 3221 | `					if( pGen->pIn >= pGen->pEnd` |
|   101287 | 3222 | `						\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|      ! 0 | 3230 | `						goto done;` |
|        - | 3231 | `					}` |
|   101287 | 3232 | `					if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|        - | 3233 | `						/* Attribute declaration */` |
|    27259 | 3234 | `						rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|    27259 | 3235 | `						if( rc != SXRET_OK ){` |
...
|    27257 | 3241 | `						continue;` |
|        - | 3242 | `					}` |
|    74033 | 3243 | `					if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|    74017 | 3255 | `					nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  2616303 | 3256 | `				}else if( nKwrd == PH7_TKWRD_ABSTRACT ){` |
|        - | 3257 | `					/* Abstract method,record that */` |
|     7803 | 3258 | `					iAttrflags \|= PH7_CLASS_ATTR_ABSTRACT;` |
|        - | 3259 | `					/* Mark the whole class as abstract */` |
|     7803 | 3260 | `					pClass->iFlags \|= PH7_CLASS_ABSTRACT;` |
|        - | 3261 | `					/* Advance the stream cursor */` |
|     7803 | 3262 | `					pGen->pIn++;` |
|     7803 | 3263 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|     7803 | 3264 | `						nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|     7803 | 3265 | `						if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|     7801 | 3266 | `							iProtection = nKwrd;` |
|     7801 | 3267 | `							pGen->pIn++; /* Jump the visibility token */` |
|     3898 | 3268 | `						}` |
|     3899 | 3269 | `					}` |
|     7803 | 3270 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|     7798 | 3271 | `						SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_STATIC ){` |
|        - | 3272 | `							/* Static method */` |
|      ! 0 | 3273 | `							iAttrflags \|= PH7_CLASS_ATTR_STATIC;` |
|      ! 0 | 3274 | `							pGen->pIn++; /* Jump the static keyword */` |
|      ! 0 | 3275 | `					}` |
|     7803 | 3276 | `					if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 \|\|` |
|     7798 | 3277 | `						SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_FUNCTION ){` |
...
|      ! 0 | 3302 | `							goto done;` |
|        - | 3303 | `					}` |
|     7797 | 3304 | `					nKwrd = PH7_TKWRD_FUNCTION;` |
|  2575395 | 3305 | `				}else if( nKwrd == PH7_TKWRD_FINAL ){` |
...
|        3 | 3349 | `				}` |
|  2653291 | 3350 | `				if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_VAR ){` |
...
|      ! 0 | 3358 | `						goto done;` |
|        - | 3359 | `				}` |
|  2653291 | 3360 | `				if( nKwrd == PH7_TKWRD_VAR ){` |
...
|  2653285 | 3375 | `					rc = GenStateCompileClassMethod(&(*pGen),iProtection,iAttrflags,TRUE,pClass);` |
|        - | 3376 | `				}` |
|  2653291 | 3377 | `				if( rc != SXRET_OK ){` |
...
|        - | 3400 | `		sxu32 nU;` |
|   445169 | 3401 | `		apUse = (TraitUseEntry *)SySetBasePtr(&aUseEntries);` |
|   460811 | 3402 | `		for( nU = 0 ; nU < SySetUsed(&aUseEntries) ; nU++ ){` |
|    15647 | 3403 | `			TraitUseEntry *pUse = &apUse[nU];` |
|    15647 | 3404 | `			ph7_class **apTrait = (ph7_class **)SySetBasePtr(&pUse->aTraits);` |
|    15647 | 3405 | `			sxu32 nTraits = SySetUsed(&pUse->aTraits);` |
|    15647 | 3406 | `			int hasResolution = (pUse->pResolvStart && pUse->pResolvStart < pUse->pResolvEnd) ? 1 : 0;` |
|        - | 3407 | `			sxu32 nT;` |
|    15647 | 3408 | `			if( !hasResolution ){` |
|        - | 3409 | `				/* No conflict resolution block: use standard trait application */` |
|    31275 | 3410 | `				for( nT = 0 ; nT < nTraits ; nT++ ){` |
|    15643 | 3411 | `					rc = PH7_ClassUseTrait(&(*pGen),pClass,apTrait[nT]);` |
|    15643 | 3412 | `					if( rc != SXRET_OK ){` |
|      ! 0 | 3413 | `						break;` |
|        - | 3414 | `					}` |
|     7824 | 3415 | `				}` |
|     7821 | 3416 | `			}else{` |
...
|        2 | 3604 | `				}` |
|        - | 3605 | `			}` |
|    15647 | 3606 | `			SySetRelease(&pUse->aTraits);` |
|     7826 | 3607 | `		}` |
|        - | 3608 | `	}` |
|   445169 | 3609 | `	if( pClass->iFlags & PH7_CLASS_ENUM ){` |
...
|     3925 | 3612 | `		rc = GenStateEnumFinalize(&(*pGen),pClass,nLine);` |
|     3925 | 3613 | `		if( rc == SXERR_ABORT ){` |
...
|   445169 | 3620 | `	if( GenStateGuardClassRedeclaration(pGen,pClass) == SXERR_ABORT ){` |
|        9 | 3621 | `		return SXERR_ABORT;` |
|        - | 3622 | `	}` |
|        - | 3623 | `	/* Install the class */` |
|   445163 | 3624 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|   445163 | 3625 | `	if( rc == SXRET_OK ){` |
|        - | 3626 | `		ph7_class **apInterface;` |
|        - | 3627 | `		sxu32 n;` |
|   445163 | 3628 | `		if( pBase ){` |
|        - | 3629 | `			/* Inherit from base class and mark as a subclass */` |
|   241365 | 3630 | `			rc = PH7_ClassInherit(&(*pGen),pClass,pBase);` |
|   120680 | 3631 | `		}` |
|   445163 | 3632 | `		apInterface = (ph7_class **)SySetBasePtr(&aInterfaces);` |
|   643655 | 3633 | `		for( n = 0 ; n < SySetUsed(&aInterfaces) ; n++ ){` |
|        - | 3634 | `			/* Implements one or more interface */` |
|   198497 | 3635 | `			rc = PH7_ClassImplement(pClass,apInterface[n]);` |
|   198497 | 3636 | `			if( rc != SXRET_OK ){` |
|      ! 0 | 3637 | `				break;` |
|        - | 3638 | `			}` |
|    99251 | 3639 | `		}` |
...
|   445163 | 3642 | `		if( rc == SXRET_OK && (pClass->iFlags & PH7_CLASS_ENUM) ){` |
|     3923 | 3643 | `			ph7_class *pIntf = PH7_VmExtractClass(pGen->pVm,"UnitEnum",sizeof("UnitEnum")-1,FALSE,0);` |
|     3923 | 3644 | `			while( pIntf && (pIntf->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|      ! 0 | 3645 | `				pIntf = pIntf->pNextName;` |
|      ! 0 | 3646 | `			}` |
|     3923 | 3647 | `			if( pIntf ){` |
|     3923 | 3648 | `				PH7_ClassImplement(pClass,pIntf);` |
|     1959 | 3649 | `			}` |
|     3923 | 3650 | `			if( pClass->nEnumBacking != 0 ){` |
|     3907 | 3651 | `				pIntf = PH7_VmExtractClass(pGen->pVm,"BackedEnum",sizeof("BackedEnum")-1,FALSE,0);` |
|     3907 | 3652 | `				while( pIntf && (pIntf->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|      ! 0 | 3653 | `					pIntf = pIntf->pNextName;` |
|      ! 0 | 3654 | `				}` |
|     3907 | 3655 | `				if( pIntf ){` |
|     3907 | 3656 | `					PH7_ClassImplement(pClass,pIntf);` |
|     1951 | 3657 | `				}` |
|     1951 | 3658 | `			}` |
|     1959 | 3659 | `		}` |
...
|   445158 | 3662 | `		if( rc == SXRET_OK` |
|   445158 | 3663 | `		 && (pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT)) == 0` |
|   445163 | 3664 | `		 && SyHashGet(&pClass->hMethod,"__toString",sizeof("__toString")-1) != 0 ){` |
|   221729 | 3665 | `			ph7_class *pStringable = PH7_VmExtractClass(pGen->pVm,` |
|        - | 3666 | `				"Stringable",sizeof("Stringable")-1,FALSE,0);` |
|   221729 | 3667 | `			if( pStringable ){` |
|   221729 | 3668 | `				ph7_class **apImpl = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|   221729 | 3669 | `				sxu32 nImpl = SySetUsed(&pClass->aInterface);` |
|        - | 3670 | `				sxu32 i;` |
|   221729 | 3671 | `				int bAlready = 0;` |
|   268389 | 3672 | `				for( i = 0 ; i < nImpl ; i++ ){` |
|    58331 | 3673 | `					if( apImpl[i] == pStringable ){` |
|    11671 | 3674 | `						bAlready = 1;` |
|    11671 | 3675 | `						break;` |
|        - | 3676 | `					}` |
|    23335 | 3677 | `				}` |
|   221729 | 3678 | `				if( !bAlready ){` |
|   210063 | 3679 | `					PH7_ClassImplement(pClass,pStringable);` |
|   105029 | 3680 | `				}` |
|   110862 | 3681 | `			}` |
|   110862 | 3682 | `		}` |
|        - | 3683 | `		/* Validate interface method signatures (visibility and parameter count) */` |
|   445163 | 3684 | `		if( rc == SXRET_OK ){` |
|   445163 | 3685 | `			sxi32 rcCheck = GenStateCheckInterfaceSignatures(&(*pGen),pClass);` |
|   445163 | 3686 | `			if( rcCheck == SXERR_ABORT ){` |
...
|   445163 | 3693 | `		if( rc == SXRET_OK ){` |
|   445163 | 3694 | `			sxi32 rcCheck = GenStateCheckAbstractMethods(&(*pGen),pClass);` |
|   445163 | 3695 | `			if( rcCheck == SXERR_ABORT ){` |
...
|   222579 | 3700 | `		}` |
|   222579 | 3701 | `	}` |
|   445163 | 3702 | `	SySetRelease(&aUseEntries);` |
|   445163 | 3703 | `	SySetRelease(&aInterfaces);` |
|   445163 | 3704 | `	if( rc != SXRET_OK ){` |
...
|   445205 | 3710 | `	pGen->pIn = &pEnd[1];` |
|   445205 | 3711 | `	pGen->pEnd = pTmp;` |
|   445205 | 3712 | `	return PH7_OK;` |
|   222609 | 3713 | `}` |
|        - | 3714 | `/* Compile a named class declaration (the common case). */` |
|   445178 | 3715 | `static sxi32 GenStateCompileClass(ph7_gen_state *pGen,sxi32 iFlags)` |
|        5 | 3716 | `{` |
|   445183 | 3717 | `	return GenStateCompileClassEx(pGen,iFlags,0,0,0);` |
|        5 | 3718 | `}` |
|        - | 3719 | `/*` |
...
|        - | 3818 | ` */` |
| 14468258 | 3819 | `static int GenStateTokenIsClassModifier(SyToken *pTok,sxi32 *piFlag)` |
|        5 | 3820 | `{` |
| 14468263 | 3821 | `	if( pTok->nType & PH7_TK_KEYWORD ){` |
|  8656649 | 3822 | `		sxu32 nKw = (sxu32)SX_PTR_TO_INT(pTok->pUserData);` |
|  8656649 | 3823 | `		if( nKw == PH7_TKWRD_FINAL ){ *piFlag = PH7_CLASS_FINAL; return TRUE; }` |
|  8602171 | 3824 | `		if( nKw == PH7_TKWRD_ABSTRACT ){ *piFlag = PH7_CLASS_ABSTRACT; return TRUE; }` |
|  4281590 | 3825 | `	}` |
| 14374799 | 3826 | `	if( GenStateIsReadonly(pTok) ){ *piFlag = PH7_CLASS_READONLY; return TRUE; }` |
| 14374739 | 3827 | `	return FALSE;` |
|  7234134 | 3828 | `}` |
|        - | 3829 | `/*` |
...
|        - | 3834 | ` */` |
| 14374734 | 3835 | `static sxi32 GenStateScanClassModifiers(SyToken **ppIn,SyToken *pEnd,SyToken **ppDup)` |
|        5 | 3836 | `{` |
| 14374739 | 3837 | `	SyToken *pIn = *ppIn,*pDup = 0;` |
| 14374739 | 3838 | `	sxi32 iFlags = 0,iFlag;` |
| 14468263 | 3839 | `	while( pIn < pEnd && GenStateTokenIsClassModifier(pIn,&iFlag) ){` |
|    93529 | 3840 | `		if( (iFlags & iFlag) && pDup == 0 ){` |
|        5 | 3841 | `			pDup = pIn;` |
|        2 | 3842 | `		}` |
|    93529 | 3843 | `		iFlags \|= iFlag;` |
|    93529 | 3844 | `		pIn++;` |
|        5 | 3845 | `	}` |
| 14374739 | 3846 | `	*ppIn = pIn;` |
| 14374739 | 3847 | `	if( ppDup ){ *ppDup = pDup; }` |
| 14374739 | 3848 | `	return iFlags;` |
|        5 | 3849 | `}` |
|        - | 3850 | `/*` |
...
|        - | 3856 | ` */` |
| 14331870 | 3857 | `PH7_PRIVATE int GenStateStartsModifiedClass(SyToken *pIn,SyToken *pEnd)` |
|        5 | 3858 | `{` |
| 14331875 | 3859 | `	sxi32 iFlags = GenStateScanClassModifiers(&pIn,pEnd,0);` |
|  7216582 | 3860 | `	return iFlags != 0 && pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD)` |
| 14357192 | 3861 | `		&& (sxu32)SX_PTR_TO_INT(pIn->pUserData) == PH7_TKWRD_CLASS;` |
|        5 | 3862 | `}` |
|        - | 3863 | `/*` |
...
|        - | 3869 | ` */` |
|    42864 | 3870 | `PH7_PRIVATE sxi32 PH7_CompileClassModifiers(ph7_gen_state *pGen)` |
|        5 | 3871 | `{` |
|        - | 3872 | `	SyToken *pDup;` |
|    42869 | 3873 | `	sxi32 iFlags = GenStateScanClassModifiers(&pGen->pIn,pGen->pEnd,&pDup);` |
|        - | 3874 | `	sxi32 rc;` |
|    42869 | 3875 | `	if( pDup ){` |
...
|        - | 3880 | `		}` |
|        1 | 3881 | `	}` |
|    42864 | 3882 | `	if( (iFlags & (PH7_CLASS_FINAL\|PH7_CLASS_ABSTRACT))` |
|    21437 | 3883 | `		== (PH7_CLASS_FINAL\|PH7_CLASS_ABSTRACT) ){` |
...
|        - | 3888 | `		}` |
|        1 | 3889 | `	}` |
|    42869 | 3890 | `	return GenStateCompileClass(&(*pGen),iFlags);` |
|    21437 | 3891 | `}` |
|        - | 3892 | `/*` |
...
|        - | 3897 | ` */` |
|     7876 | 3898 | `PH7_PRIVATE sxi32 PH7_CompileTrait(ph7_gen_state *pGen)` |
|        5 | 3899 | `{` |
|     7881 | 3900 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|     7881 | 3909 | `	pGen->pIn++;` |
|     7881 | 3910 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
...
|     7881 | 3921 | `	pName = &pGen->pIn->sData;` |
|     7881 | 3922 | `	pGen->pIn++;` |
|        - | 3923 | `	/* Build FQN and obtain a raw class */ {` |
|        - | 3924 | `		SyBlob sFQN;` |
|        - | 3925 | `		SyString sFQNStr;` |
|     7881 | 3926 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|     7881 | 3927 | `		GenStateBuildFQN(pGen,pName,&sFQN);` |
|     7881 | 3928 | `		SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|     7881 | 3929 | `		pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|     7881 | 3930 | `		SyBlobRelease(&sFQN);` |
|        - | 3931 | `	}` |
|     7881 | 3932 | `	if( pClass == 0 ){` |
|      ! 0 | 3933 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 3934 | `		return SXERR_ABORT;` |
|        - | 3935 | `	}` |
|     7881 | 3936 | `	GenStateConsumeDoc(&(*pGen),&pClass->sDoc);` |
|     7881 | 3937 | `	if( GenStateConsumeAttrs(&(*pGen),&pClass->aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 3938 | `		return SXERR_ABORT;` |
|        - | 3939 | `	}` |
|        - | 3940 | `	/* Traits cannot extend or implement; expect opening brace directly */` |
|     7881 | 3941 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_OCB) == 0 ){` |
...
|        - | 3948 | `	}` |
|     7881 | 3949 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|     7881 | 3950 | `	pEnd = 0;` |
|     7881 | 3951 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB,PH7_TK_CCB,&pEnd);` |
|     7881 | 3952 | `	if( pEnd >= pGen->pEnd ){` |
...
|     7881 | 3961 | `	pClass->nEndLine = pEnd->nLine;` |
|        - | 3962 | `	/* Swap token stream */` |
|     7881 | 3963 | `	pTmp = pGen->pEnd;` |
|     7881 | 3964 | `	pGen->pEnd = pEnd;` |
|        - | 3965 | `	/* Mark as trait (PH7_NewRawClass may have set INTERNAL) */` |
|     7881 | 3966 | `	pClass->iFlags \|= PH7_CLASS_TRAIT;` |
|        - | 3967 | `	/* Parse the body: same as a normal class (methods, attributes, visibility modifiers) */` |
|    56477 | 3968 | `	for(;;){` |
|   159677 | 3969 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|    23367 | 3970 | `			pGen->pIn++;` |
|        5 | 3971 | `		}` |
|   136315 | 3972 | `		if( pGen->pIn >= pGen->pEnd ){` |
|     7881 | 3973 | `			break;` |
|        - | 3974 | `		}` |
|        - | 3975 | `		/* Bind a directly-preceding docblock to this member */` |
|   128439 | 3976 | `		GenStateSetPendingDoc(&(*pGen));` |
|   128439 | 3977 | `		if( (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR)) == 0 ){` |
...
|      ! 0 | 3984 | `			goto done;` |
|        - | 3985 | `		}` |
|   128439 | 3986 | `		iProtection = PH7_TKWRD_PUBLIC;` |
|   128439 | 3987 | `		iAttrflags = 0;` |
|   128439 | 3988 | `		if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|   128439 | 3989 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   128439 | 3990 | `			if( nKwrd == PH7_TKWRD_USE ){` |
...
|        5 | 4031 | `				continue;` |
|        - | 4032 | `			}` |
|   128435 | 4033 | `			if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|   128417 | 4034 | `				iProtection = nKwrd;` |
|   128417 | 4035 | `				pGen->pIn++;` |
...
|   128417 | 4039 | `				if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|        5 | 4040 | `					iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|        5 | 4041 | `					pGen->pIn++; /* Jump the 'readonly' modifier */` |
|        2 | 4042 | `				}` |
|   128412 | 4043 | `				if( pGen->pIn >= pGen->pEnd` |
|   128417 | 4044 | `					\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|      ! 0 | 4051 | `					goto done;` |
|        - | 4052 | `				}` |
|   128417 | 4053 | `				if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|    23347 | 4054 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|    23347 | 4055 | `					if( rc != SXRET_OK ){` |
...
|    23347 | 4061 | `					continue;` |
|        - | 4062 | `				}` |
|   105075 | 4063 | `				if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|        9 | 4071 | `					continue;` |
|        - | 4072 | `				}` |
|   105067 | 4073 | `				nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    52531 | 4074 | `			}` |
|   105085 | 4075 | `			if( nKwrd == PH7_TKWRD_CONST ){` |
...
|      ! 0 | 4081 | `				goto done;` |
|      ! 0 | 4082 | `			}else{` |
|   105085 | 4083 | `				if( nKwrd == PH7_TKWRD_STATIC ){` |
|     7791 | 4084 | `					iAttrflags \|= PH7_CLASS_ATTR_STATIC;` |
|     7791 | 4085 | `					pGen->pIn++;` |
|     7791 | 4086 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|     7789 | 4087 | `						nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|     7789 | 4088 | `						if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|      ! 0 | 4089 | `							iProtection = nKwrd;` |
|      ! 0 | 4090 | `							pGen->pIn++;` |
|      ! 0 | 4091 | `						}` |
|     3892 | 4092 | `					}` |
|     7786 | 4093 | `					if( pGen->pIn >= pGen->pEnd` |
|     7791 | 4094 | `						\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|      ! 0 | 4101 | `						goto done;` |
|        - | 4102 | `					}` |
|     7791 | 4103 | `					if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
...
|        3 | 4111 | `						continue;` |
|        - | 4112 | `					}` |
|     7789 | 4113 | `					if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|      ! 0 | 4121 | `						continue;` |
|        - | 4122 | `					}` |
|     7789 | 4123 | `					nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   101191 | 4124 | `				}else if( nKwrd == PH7_TKWRD_ABSTRACT ){` |
...
|        3 | 4145 | `				}` |
|   105083 | 4146 | `				if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_VAR ){` |
...
|      ! 0 | 4153 | `					goto done;` |
|        - | 4154 | `				}` |
|   105083 | 4155 | `				if( nKwrd == PH7_TKWRD_VAR ){` |
|      ! 0 | 4156 | `					pGen->pIn++;` |
...
|      ! 0 | 4166 | `				}else{` |
|   105083 | 4167 | `					rc = GenStateCompileClassMethod(&(*pGen),iProtection,iAttrflags,TRUE,pClass);` |
|        - | 4168 | `				}` |
|   105083 | 4169 | `				if( rc != SXRET_OK ){` |
...
|     7881 | 4187 | `	if( GenStateGuardClassRedeclaration(pGen,pClass) == SXERR_ABORT ){` |
|        3 | 4188 | `		return SXERR_ABORT;` |
|        - | 4189 | `	}` |
|        - | 4190 | `	/* Install the trait */` |
|     7879 | 4191 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|     7879 | 4192 | `	if( rc != SXRET_OK ){` |
...
|     7879 | 4198 | `	pGen->pIn = &pEnd[1];` |
|     7879 | 4199 | `	pGen->pEnd = pTmp;` |
|     7879 | 4200 | `	return PH7_OK;` |
|     3943 | 4201 | `}` |
|        - | 4202 | `/*` |
...
|        - | 4210 | ` */` |
|   398390 | 4211 | `PH7_PRIVATE sxi32 PH7_CompileClass(ph7_gen_state *pGen)` |
|        5 | 4212 | `{` |
|        - | 4213 | `	sxi32 rc;` |
|   398395 | 4214 | `	rc = GenStateCompileClass(&(*pGen),0);` |
|   398395 | 4215 | `	return rc;` |
|        5 | 4216 | `}` |
|        - | 4217 | `/*` |
...
|        - | 4223 | ` */` |
| 14281230 | 4224 | `PH7_PRIVATE int GenStateStartsEnumDecl(SyToken *pIn,SyToken *pEnd)` |
|        5 | 4225 | `{` |
| 14497624 | 4226 | `	return (pIn->nType & PH7_TK_ID)` |
|  7357004 | 4227 | `		&& pIn->sData.nByte == sizeof("enum")-1` |
|   226255 | 4228 | `		&& SyStrnicmp(pIn->sData.zString,"enum",sizeof("enum")-1) == 0` |
| 14497619 | 4229 | `		&& &pIn[1] < pEnd && (pIn[1].nType & PH7_TK_ID);` |
|        5 | 4230 | `}` |
|        - | 4231 | `/*` |
...
|        - | 4236 | ` */` |
|     3924 | 4237 | `PH7_PRIVATE sxi32 PH7_CompileEnum(ph7_gen_state *pGen)` |
|        5 | 4238 | `{` |
|     3929 | 4239 | `	return GenStateCompileClass(&(*pGen),PH7_CLASS_ENUM\|PH7_CLASS_FINAL);` |
|        5 | 4240 | `}` |
|        - | 4241 |  |
