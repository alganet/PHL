...
|        - |   26 | ` */` |
|   517902 |   27 | `static sxi32 GenStateGuardClassRedeclaration(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 |   28 | `{` |
|        - |   29 | `	SyHashEntry *pEntry;` |
|   517907 |   30 | `	if( !GenStateUnconditionalTopLevel(pGen) ){` |
|       26 |   31 | `		return SXRET_OK; /* conditional/nested: keep hoisting */` |
|        - |   32 | `	}` |
|   517885 |   33 | `	pClass->iFlags \|= PH7_CLASS_BOUND;` |
|   517885 |   34 | `	if( pGen->pVm->bCompilingBuiltin ){` |
|   515779 |   35 | `		return SXRET_OK; /* the prelude installs each builtin exactly once */` |
|        - |   36 | `	}` |
...
|        - |   70 | ` */` |
|  3826850 |   71 | `static sxi32 GetProtectionLevel(sxi32 nKeyword)` |
|        5 |   72 | `{` |
|  3826855 |   73 | `	if( nKeyword == PH7_TKWRD_PRIVATE ){` |
|   279443 |   74 | `		return PH7_CLASS_PROT_PRIVATE;` |
|  3547417 |   75 | `	}else if( nKeyword == PH7_TKWRD_PROTECTED ){` |
|   221151 |   76 | `		return PH7_CLASS_PROT_PROTECTED;` |
|        - |   77 | `	}` |
|        - |   78 | `	/* Assume public by default */` |
|  3326271 |   79 | `	return PH7_CLASS_PROT_PUBLIC;` |
|  1913430 |   80 | `}` |
|        - |   81 | `/*` |
...
|        - |   88 | ` */` |
|   341458 |   89 | `static int GenStateClassConstHasType(ph7_gen_state *pGen)` |
|        5 |   90 | `{` |
|        - |   91 | `	SyToken *p0, *p1;` |
|   341463 |   92 | `	if( pGen->pIn >= pGen->pEnd ){` |
|      ! 0 |   93 | `		return 0;` |
|        - |   94 | `	}` |
|   341463 |   95 | `	p0 = pGen->pIn;` |
|        - |   96 | `	/* A leading '\' (namespaced class type) or '?' (nullable) always starts a type */` |
|   341463 |   97 | `	if( p0->nType & PH7_TK_NSSEP ){` |
|      ! 0 |   98 | `		return 1;` |
|        - |   99 | `	}` |
|   341463 |  100 | `	if( (p0->nType & PH7_TK_OP) && p0->sData.nByte == 1 && p0->sData.zString[0] == '?' ){` |
|        5 |  101 | `		return 1;` |
|        - |  102 | `	}` |
...
|   341459 |  106 | `	if( p0->nType & (PH7_TK_ID\|PH7_TK_KEYWORD) ){` |
|   341459 |  107 | `		p1 = (pGen->pIn + 1 < pGen->pEnd) ? (pGen->pIn + 1) : 0;` |
|   341459 |  108 | `		if( p1 ){` |
|   341459 |  109 | `			if( p1->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_NSSEP) ){` |
|       34 |  110 | `				return 1;` |
|        - |  111 | `			}` |
|   341429 |  112 | `			if( (p1->nType & PH7_TK_OP) && p1->sData.nByte == 1 && p1->sData.zString[0] == '\|' ){` |
|        5 |  113 | `				return 1;` |
|        - |  114 | `			}` |
|   170710 |  115 | `		}` |
|   170710 |  116 | `	}` |
...
|        - |  172 | ` */` |
|   722234 |  173 | `static int GenStateInitHasNewExpr(ph7_gen_state *pGen)` |
|        5 |  174 | `{` |
|   722239 |  175 | `	SyToken *p = pGen->pIn;` |
|   722239 |  176 | `	int iDepth = 0;` |
|  1907481 |  177 | `	while( p < pGen->pEnd ){` |
|  1907481 |  178 | `		if( iDepth == 0 && (p->nType & (PH7_TK_SEMI\|PH7_TK_COMMA)) ){` |
|   722187 |  179 | `			break; /* end of this initializer */` |
|        - |  180 | `		}` |
|  1185294 |  181 | `		if( (p->nType & PH7_TK_KEYWORD)` |
|   600425 |  182 | `			&& ( SX_PTR_TO_INT(p->pUserData) == PH7_TKWRD_FUNCTION` |
|    15546 |  183 | `				\|\| SX_PTR_TO_INT(p->pUserData) == PH7_TKWRD_FN ) ){` |
...
|        3 |  241 | `			continue;` |
|        - |  242 | `		}` |
|  1185297 |  243 | `		if( p->nType & PH7_TK_OCB ){` |
|       45 |  244 | `			if( iDepth == 0 ){` |
...
|        - |  250 | `			}` |
|      ! 0 |  251 | `			iDepth++;` |
|  1185253 |  252 | `		}else if( p->nType & (PH7_TK_LPAREN\|PH7_TK_OSB) ){` |
|    50511 |  253 | `			iDepth++;` |
|  1160000 |  254 | `		}else if( p->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB) ){` |
|    50509 |  255 | `			if( iDepth > 0 ){` |
|    50509 |  256 | `				iDepth--;` |
|    25252 |  257 | `			}` |
|  1109495 |  258 | `		}else if( (p->nType & PH7_TK_OP) && p->pUserData` |
|   390761 |  259 | `			&& ((const ph7_expr_op *)p->pUserData)->iOp == EXPR_OP_NEW ){` |
...
|        - |  278 | ` */` |
|    15906 |  279 | `static void GenStateCopyTypeToAttr(ph7_class_attr *pAttr,sxu32 nType,` |
|        - |  280 | `	const SyString *pClass,const SyString *pTypeName,sxi32 iTypeFlags,SySet *pAlts)` |
|        5 |  281 | `{` |
|    15911 |  282 | `	pAttr->nType = nType;` |
|    15911 |  283 | `	pAttr->sClass = *pClass;` |
|    15911 |  284 | `	pAttr->sTypeName = *pTypeName;` |
|    15911 |  285 | `	if( iTypeFlags & PH7_CLASS_ATTR_UNION ){` |
|        - |  286 | `		sxu32 i;` |
...
|       11 |  291 | `	}` |
|    15911 |  292 | `}` |
|   341458 |  293 | `static sxi32 GenStateCompileClassConstant(ph7_gen_state *pGen,sxi32 iProtection,sxi32 iFlags,ph7_class *pClass)` |
|        5 |  294 | `{` |
|   341463 |  295 | `	sxu32 nLine = pGen->pIn->nLine;` |
|        - |  296 | `	SySet *pInstrContainer;` |
|        - |  297 | `	ph7_class_attr *pCons;` |
|        - |  298 | `	SyString *pName;` |
|        - |  299 | `	sxi32 rc;` |
|   341463 |  300 | `	sxu32 nType = 0;` |
|        - |  301 | `	SyString sTypeClass;` |
|        - |  302 | `	SyString sTypeText;` |
|        - |  303 | `	SySet aUnionAlts;` |
|   341463 |  304 | `	sxi32 iTypeFlags = 0;` |
|   341463 |  305 | `	SyStringInitFromBuf(&sTypeClass,0,0);` |
|   341463 |  306 | `	SyStringInitFromBuf(&sTypeText,0,0);` |
|   341463 |  307 | `	SySetInit(&aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|        - |  308 | `	/* Extract visibility level */` |
|   341463 |  309 | `	iProtection = GetProtectionLevel(iProtection);` |
|        - |  310 | `	/* Mark as constant */` |
|   341463 |  311 | `	iFlags \|= PH7_CLASS_ATTR_CONSTANT;` |
|   341463 |  312 | `	pGen->pIn++; /* Jump the 'const' keyword */` |
...
|   341482 |  315 | `	if( GenStateClassConstHasType(pGen) ){` |
...
|       19 |  336 | `	}` |
|   170729 |  337 | `loop:` |
|   341465 |  338 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
...
|   341465 |  348 | `	pName = &pGen->pIn->sData;` |
|        - |  349 | `	/* Make sure the constant name isn't reserved */` |
|   341465 |  350 | `	if( GenStateIsReservedConstant(pName) ){` |
...
|   341465 |  360 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
...
|   341463 |  371 | `	pGen->pIn++;` |
|   341463 |  372 | `	if(pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_EQUAL /* '=' */) == 0 ){` |
...
|        - |  380 | `	}` |
|   341463 |  381 | `	pGen->pIn++; /* Jump the equal sign */` |
...
|   341458 |  386 | `	if( (iTypeFlags & PH7_CLASS_ATTR_TYPED) && !(iTypeFlags & PH7_CLASS_ATTR_UNION)` |
...
|   341459 |  399 | `	if( GenStateInitHasNewExpr(pGen) ){` |
...
|   341455 |  408 | `	pCons = PH7_NewClassAttr(pGen->pVm,pName,nLine,iProtection,iFlags\|iTypeFlags);` |
|   341455 |  409 | `	if( pCons ){` |
|   341455 |  410 | `		GenStateConsumeDoc(&(*pGen),&pCons->sDoc);` |
|   341455 |  411 | `		if( GenStateConsumeAttrs(&(*pGen),&pCons->aAttrs) == SXERR_ABORT ){` |
|      ! 0 |  412 | `			return SXERR_ABORT;` |
|        - |  413 | `		}` |
|   170725 |  414 | `	}` |
|   341455 |  415 | `	if( pCons == 0 ){` |
|      ! 0 |  416 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 |  417 | `		return SXERR_ABORT;` |
|        - |  418 | `	}` |
|   341455 |  419 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|       35 |  420 | `		GenStateCopyTypeToAttr(pCons,nType,&sTypeClass,&sTypeText,iTypeFlags,&aUnionAlts);` |
|       16 |  421 | `	}` |
|        - |  422 | `	/* Swap bytecode container */` |
|   341455 |  423 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   341455 |  424 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pCons->aByteCode);` |
|        - |  425 | `	/* Compile constant value.` |
|        - |  426 | `	 */` |
|   341455 |  427 | `	rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|   341455 |  428 | `	if( rc == SXERR_EMPTY ){` |
...
|   341455 |  435 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|   341455 |  436 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|   341455 |  437 | `	if( rc == SXERR_ABORT ){` |
...
|   341455 |  442 | `	rc = PH7_ClassInstallAttr(pClass,pCons);` |
|   341455 |  443 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  444 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 |  445 | `		return SXERR_ABORT;` |
|        - |  446 | `	}` |
|   341455 |  447 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA /*','*/) ){` |
...
|        - |  465 | `		}` |
|      ! 0 |  466 | `	}` |
|   341453 |  467 | `	SySetRelease(&aUnionAlts);` |
|   341453 |  468 | `	return SXRET_OK;` |
|        5 |  469 | `Synchronize:` |
...
|        - |  505 | ` */` |
|  2619634 |  506 | `static int GenStateLooksLikeTypedProperty(SyToken *pStart,SyToken *pEnd)` |
|        5 |  507 | `{` |
|  2619639 |  508 | `	SyToken *p = pStart;` |
|  2619639 |  509 | `	int bFirst = 1;` |
|  2619639 |  510 | `	if( p >= pEnd ) return 0;` |
|        - |  511 | ``	/* Optional nullable `?` shorthand. */`` |
|  2619639 |  512 | `	if( (p->nType & PH7_TK_OP) && p->sData.nByte == 1 && p->sData.zString[0] == '?' ){` |
|       41 |  513 | `		p++;` |
...
|  1309817 |  520 | `	for(;;){` |
|  2619659 |  521 | `		if( p < pEnd && (p->nType & PH7_TK_LPAREN) ){` |
...
|  2619657 |  530 | `			if( p < pEnd && (p->nType & PH7_TK_NSSEP) ){ p++; }` |
|  2619657 |  531 | `			if( p >= pEnd \|\| (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|      ! 0 |  532 | `				return 0;` |
|        - |  533 | `			}` |
...
|  2619657 |  537 | `			if( bFirst && (p->nType & PH7_TK_KEYWORD) ){` |
|  2619601 |  538 | `				sxu32 k = (sxu32)(SX_PTR_TO_INT(p->pUserData));` |
|  2619596 |  539 | `				if( k == PH7_TKWRD_FUNCTION \|\| k == PH7_TKWRD_VAR \|\| k == PH7_TKWRD_CONST` |
|   124598 |  540 | `				 \|\| k == PH7_TKWRD_STATIC \|\| k == PH7_TKWRD_FINAL \|\| k == PH7_TKWRD_ABSTRACT ){` |
|  2603771 |  541 | `					return 0;` |
|        - |  542 | `				}` |
|     7915 |  543 | `			}` |
|    15891 |  544 | `			p++;` |
|    15893 |  545 | `			while( p + 1 < pEnd && (p->nType & PH7_TK_NSSEP) && (p[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|        3 |  546 | `				p += 2;` |
|        1 |  547 | `			}` |
|    23832 |  548 | `			while( p + 1 < pEnd && (p->nType & PH7_TK_AMPER)` |
|    15894 |  549 | `				&& (p[1].nType & (PH7_TK_NSSEP\|PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|        3 |  550 | `				p++; /* skip '&' */` |
...
|        - |  558 | `		}` |
|    15893 |  559 | `		bFirst = 0;` |
|    15888 |  560 | `		if( p < pEnd && (p->nType & PH7_TK_OP) && p->sData.nByte == 1` |
...
|    15873 |  565 | `		break;` |
|      ! 0 |  566 | `	}` |
|    15873 |  567 | `	if( p >= pEnd ) return 0;` |
|    15873 |  568 | `	return (p->nType & PH7_TK_DOLLAR) ? 1 : 0;` |
|  1309822 |  569 | `}` |
|        - |  570 |  |
|        - |  571 | `/*` |
...
|        - |  588 | ` */` |
|    15878 |  589 | `static sxi32 GenStateParsePropertyType(` |
...
|        - |  595 | `	SySet *pAlts` |
|        5 |  596 | `){` |
|    15883 |  597 | `	sxi32 iFlags = 0;` |
|        - |  598 | `	sxi32 rc;` |
|    15883 |  599 | `	if( pGen->pIn >= pGen->pEnd ){` |
|      ! 0 |  600 | `		return SXRET_OK;` |
|        - |  601 | `	}` |
|        - |  602 | `	/* If the first token is '$', there's no type */` |
|    15883 |  603 | `	if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|      ! 0 |  604 | `		return SXRET_OK;` |
|        - |  605 | `	}` |
|    15883 |  606 | `	rc = GenStateParseUnionTypeDecl(` |
|     7939 |  607 | `		pGen, pnType, pClass, pAlts, &iFlags, pTypeText,` |
|        - |  608 | `		PH7_CLASS_ATTR_NULLABLE,` |
|        - |  609 | `		PH7_CLASS_ATTR_UNION,` |
|        - |  610 | `		/* bAllowVoid */ 0,` |
|    15878 |  611 | `		pGen->pIn->nLine);` |
|    15883 |  612 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  613 | `		return rc;` |
|        - |  614 | `	}` |
|        - |  615 | `	/* Verify next token is '$' (start of property name) */` |
|    15883 |  616 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
|      ! 0 |  617 | `		return SXERR_SYNTAX;` |
|        - |  618 | `	}` |
|    15883 |  619 | `	*piTypeFlags = iFlags \| PH7_CLASS_ATTR_TYPED;` |
|    15883 |  620 | `	return SXRET_OK;` |
|     7944 |  621 | `}` |
|        - |  622 |  |
|        - |  623 | `/*` |
...
|        - |  633 | ` */` |
|    16056 |  634 | `static int GenStateIsDisallowedPropertyAtom(` |
|        - |  635 | `	sxu32 nType,` |
...
|        - |  640 | `	const char *z;` |
|        - |  641 | `	sxu32 n;` |
|    16061 |  642 | `	if( nType != SXU32_HIGH \|\| pClass == 0 \|\| pClass->nByte == 0 ){` |
|    15995 |  643 | `		return 0;` |
|        - |  644 | `	}` |
...
|        - |  666 | ` */` |
|    15994 |  667 | `PH7_PRIVATE sxi32 GenStateValidateMemberType(` |
...
|        - |  676 | `	sxu32 nLine)` |
|        5 |  677 | `{` |
|    15999 |  678 | `	const char *zBad = 0;` |
|    15999 |  679 | `	sxu32 nBad = 0;` |
|        - |  680 | `	SyString sFallback;` |
|        - |  681 | `	const SyString *pBad;` |
|        - |  682 | `	sxi32 rc;` |
|    15999 |  683 | `	int bDisallowed = 0;` |
|    15999 |  684 | `	if( GenStateIsDisallowedPropertyAtom(nType,pTypeClass,&zBad,&nBad) ){` |
|        5 |  685 | `		bDisallowed = 1;` |
|    15997 |  686 | `	}else if( pUnionAlts ){` |
|        - |  687 | `		sxu32 i;` |
...
|       35 |  694 | `		}` |
|       15 |  695 | `	}` |
|    15999 |  696 | `	if( !bDisallowed ){` |
|    15993 |  697 | `		return SXRET_OK;` |
|        - |  698 | `	}` |
...
|        - |  721 | ` */` |
| 23498278 |  722 | `PH7_PRIVATE int GenStateIsReadonly(SyToken *pTok)` |
|        5 |  723 | `{` |
| 23723932 |  724 | `	return (pTok->nType & PH7_TK_ID)` |
| 11974788 |  725 | `		&& pTok->sData.nByte == sizeof("readonly")-1` |
| 23723927 |  726 | `		&& SyStrnicmp(pTok->sData.zString,"readonly",sizeof("readonly")-1) == 0;` |
|        5 |  727 | `}` |
|        - |  728 | `/*` |
...
|        - |  733 | ` */` |
|  8442242 |  734 | `PH7_PRIVATE sxi32 GenStatePeekSetVisibility(SyToken *pTok,SyToken *pEnd,int *pnTok)` |
|        5 |  735 | `{` |
|  8442247 |  736 | `	*pnTok = 0;` |
|  8442242 |  737 | `	if( &pTok[3] < pEnd` |
|  7892667 |  738 | `	 && (pTok->nType & PH7_TK_KEYWORD)` |
|  6436829 |  739 | `	 && (pTok[1].nType & PH7_TK_LPAREN)` |
|  2765291 |  740 | `	 && (pTok[2].nType & (PH7_TK_ID\|PH7_TK_KEYWORD))` |
...
|        9 |  762 | `}` |
|   590526 |  763 | `static sxi32 GenStateCompileClassAttr(ph7_gen_state *pGen,sxi32 iProtection,sxi32 iFlags,ph7_class *pClass)` |
|        5 |  764 | `{` |
|   590531 |  765 | `	sxu32 nLine = pGen->pIn->nLine;` |
|        - |  766 | `	ph7_class_attr *pAttr;` |
|        - |  767 | `	SyString *pName;` |
|        - |  768 | `	sxi32 rc;` |
|   590531 |  769 | `	sxu32 nType = 0;` |
|        - |  770 | `	SyString sTypeClass;` |
|        - |  771 | `	SyString sTypeText;` |
|        - |  772 | `	SySet aUnionAlts;` |
|   590531 |  773 | `	sxi32 iTypeFlags = 0;` |
|   590531 |  774 | `	SyStringInitFromBuf(&sTypeClass,0,0);` |
|   590531 |  775 | `	SyStringInitFromBuf(&sTypeText,0,0);` |
|   590531 |  776 | `	SySetInit(&aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
...
|   590531 |  780 | `	if( pClass->iFlags & PH7_CLASS_READONLY ){` |
|       21 |  781 | `		iFlags \|= PH7_CLASS_ATTR_READONLY;` |
|        9 |  782 | `	}` |
|        - |  783 | `	/* Extract visibility level */` |
|   590531 |  784 | `	iProtection = GetProtectionLevel(iProtection);` |
|        - |  785 | `	/* Parse optional type hint (typed properties, PHP 7.4+) */` |
|   598470 |  786 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
|    15883 |  787 | `		rc = GenStateParsePropertyType(pGen,&nType,&sTypeClass,&iTypeFlags,&sTypeText,&aUnionAlts);` |
|    15883 |  788 | `		if( rc == SXERR_CORRUPT ){` |
|        - |  789 | `			/* Error already reported by GenStateParseUnionTypeDecl */` |
|      ! 0 |  790 | `			goto Synchronize;` |
|    15883 |  791 | `		}else if( rc == SXERR_SYNTAX ){` |
...
|    15883 |  799 | `		}else if( rc == SXERR_ABORT ){` |
|      ! 0 |  800 | `			return SXERR_ABORT;` |
|        - |  801 | `		}` |
|     7939 |  802 | `	}` |
|      ! 0 |  803 | `loop:` |
|   590535 |  804 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
...
|        - |  810 | `	}` |
|   590535 |  811 | `	pGen->pIn++; /* Jump the dollar sign */` |
|   590535 |  812 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_ID)) == 0 ){` |
...
|   590535 |  822 | `	pName = &pGen->pIn->sData;` |
|        - |  823 | `	/* Advance the stream cursor */` |
|   590535 |  824 | `	pGen->pIn++;` |
|   590535 |  825 | `	if(pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_EQUAL/*'='*/\|PH7_TK_SEMI/*';'*/\|PH7_TK_COMMA/*','*/\|PH7_TK_OCB/*'{' hooks*/)) == 0 ){` |
...
|   590533 |  836 | `	if( iFlags & (PH7_CLASS_ATTR_PRIVATE_SET\|PH7_CLASS_ATTR_PROTECTED_SET\|PH7_CLASS_ATTR_PUBLIC_SET) ){` |
...
|   590533 |  856 | `	if( iFlags & PH7_CLASS_ATTR_READONLY ){` |
...
|   590523 |  876 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|    23819 |  877 | `		rc = GenStateValidateMemberType(pGen,pClass,pName,nType,&sTypeClass,` |
|        - |  878 | `			&sTypeText,` |
|    15876 |  879 | `			(iTypeFlags & PH7_CLASS_ATTR_UNION) ? &aUnionAlts : 0,` |
|     7938 |  880 | `			"Property %z::$%z cannot have type %z",nLine);` |
|    15881 |  881 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 |  882 | `			return SXERR_ABORT;` |
|    15881 |  883 | `		}else if( rc != SXRET_OK ){` |
|      ! 0 |  884 | `			goto Synchronize;` |
|        - |  885 | `		}` |
|     7938 |  886 | `	}` |
|        - |  887 | `	/* Reject redeclaration (catches clash with an earlier promoted property). */` |
|   590523 |  888 | `	if( PH7_ClassExtractAttribute(pClass,pName->zString,pName->nByte) != 0 ){` |
...
|   590521 |  902 | `	if( (pGen->pIn->nType & PH7_TK_EQUAL /*'='*/) && GenStateInitHasNewExpr(pGen) ){` |
...
|   590517 |  911 | `	pAttr = PH7_NewClassAttr(pGen->pVm,pName,nLine,iProtection,iFlags\|iTypeFlags);` |
|   590517 |  912 | `	if( pAttr ){` |
|   590517 |  913 | `		GenStateConsumeDoc(&(*pGen),&pAttr->sDoc);` |
|   590517 |  914 | `		if( GenStateConsumeAttrs(&(*pGen),&pAttr->aAttrs) == SXERR_ABORT ){` |
|      ! 0 |  915 | `			return SXERR_ABORT;` |
|        - |  916 | `		}` |
|   295256 |  917 | `	}` |
|   590517 |  918 | `	if( pAttr == 0 ){` |
|      ! 0 |  919 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 engine is running out of memory");` |
|      ! 0 |  920 | `		return SXERR_ABORT;` |
|        - |  921 | `	}` |
|   590517 |  922 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|    15879 |  923 | `		GenStateCopyTypeToAttr(pAttr,nType,&sTypeClass,&sTypeText,iTypeFlags,&aUnionAlts);` |
|     7937 |  924 | `	}` |
|   590517 |  925 | `	if( pGen->pIn->nType & PH7_TK_EQUAL /*'='*/ ){` |
|        - |  926 | `		SySet *pInstrContainer;` |
|   380781 |  927 | `		SyToken *pSavedDefEnd = pGen->pEnd;` |
|   380781 |  928 | `		pGen->pIn++; /*Jump the equal sign */` |
|        - |  929 | `		{` |
...
|   380781 |  934 | `			SyToken *pScan = pGen->pIn;` |
|   380781 |  935 | `			sxi32 iNest = 0;` |
|   839707 |  936 | `			while( pScan < pGen->pEnd ){` |
|   839707 |  937 | `				if( pScan->nType & (PH7_TK_LPAREN\|PH7_TK_OSB) ){` |
|    50505 |  938 | `					iNest++;` |
|   814457 |  939 | `				}else if( pScan->nType & (PH7_TK_RPAREN\|PH7_TK_CSB) ){` |
|    50505 |  940 | `					iNest--;` |
|   763957 |  941 | `				}else if( iNest <= 0 && (pScan->nType & (PH7_TK_SEMI\|PH7_TK_COMMA\|PH7_TK_OCB)) ){` |
|   380781 |  942 | `					break;` |
|        - |  943 | `				}` |
|   458931 |  944 | `				pScan++;` |
|        5 |  945 | `			}` |
|   380781 |  946 | `			pGen->pEnd = pScan;` |
|        - |  947 | `		}` |
|        - |  948 | `		/* Swap bytecode container */` |
|   380781 |  949 | `		pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   380781 |  950 | `		PH7_VmSetByteCodeContainer(pGen->pVm,&pAttr->aByteCode);` |
|        - |  951 | `		/* Compile attribute value.` |
|        - |  952 | `		 */` |
|   380781 |  953 | `		rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|   380781 |  954 | `		if( rc == SXERR_EMPTY ){` |
...
|   380781 |  961 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|   380781 |  962 | `		PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|   380781 |  963 | `		pGen->pIn = pGen->pEnd;   /* land exactly on the delimiter */` |
|   380781 |  964 | `		pGen->pEnd = pSavedDefEnd;` |
|   190388 |  965 | `	}` |
|        - |  966 | `	/* All done,install the attribute */` |
|   590517 |  967 | `	rc = PH7_ClassInstallAttr(pClass,pAttr);` |
|   590517 |  968 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  969 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 |  970 | `		return SXERR_ABORT;` |
|        - |  971 | `	}` |
|   590517 |  972 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) ){` |
...
|        - |  984 | `	}` |
|   590423 |  985 | `	if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
...
|        - |  996 | `	}` |
|   590423 |  997 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA /*','*/) ){` |
...
|        - | 1015 | `		}` |
|      ! 0 | 1016 | `	}` |
|   590419 | 1017 | `	SySetRelease(&aUnionAlts);` |
|   590419 | 1018 | `	return SXRET_OK;` |
|        9 | 1019 | `Synchronize:` |
...
|        - | 1034 | ` */` |
|  2894866 | 1035 | `static sxi32 GenStateCompileClassMethod(` |
...
|        - | 1041 | `	)` |
|        5 | 1042 | `{` |
|  2894871 | 1043 | `	sxu32 nLine = pGen->pIn->nLine;` |
|  2894871 | 1044 | `	sxu32 nKwLine = nLine; /* Line of the 'function' keyword (Reflection getStartLine) */` |
...
|  2894871 | 1051 | `	iProtection = GetProtectionLevel(iProtection);` |
|  2894871 | 1052 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|  2894871 | 1053 | `	iFuncFlags = 0;` |
|  2894871 | 1054 | `	if( pGen->pIn >= pGen->pEnd ){` |
...
|        - | 1062 | `	}` |
|  2894871 | 1063 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|        - | 1064 | `		/* Return by reference,remember that */` |
|      ! 0 | 1065 | `		iFuncFlags \|= VM_FUNC_REF_RETURN;` |
|        - | 1066 | `		/* Jump the '&' token */` |
|      ! 0 | 1067 | `		pGen->pIn++;` |
|      ! 0 | 1068 | `	}` |
|  2894871 | 1069 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|  2894871 | 1078 | `	pName = &pGen->pIn->sData;` |
|  2894871 | 1079 | `	nLine = pGen->pIn->nLine;` |
|        - | 1080 | `	/* Jump the method name */` |
|  2894871 | 1081 | `	pGen->pIn++;` |
|  2894871 | 1082 | `	if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|        - | 1083 | `		/* Abstract method */` |
|   139689 | 1084 | `		if( iProtection == PH7_CLASS_PROT_PRIVATE ){` |
...
|   139689 | 1093 | `		doBody = FALSE;` |
|    69842 | 1094 | `	}` |
|  2894871 | 1095 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|        - | 1096 | `		/* Syntax error */` |
...
|  2894871 | 1105 | `	pMeth = PH7_NewClassMethod(pGen->pVm,pClass,pName,nLine,iProtection,iFlags,iFuncFlags);` |
|  2894871 | 1106 | `	if( pMeth == 0 ){` |
|      ! 0 | 1107 | `		PH7_GenCompileError(&(*pGen),E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 1108 | `		return SXERR_ABORT;` |
|        - | 1109 | `	}` |
|  2894871 | 1110 | `	pMeth->sFunc.nLine = nKwLine;` |
|  2894871 | 1111 | `	GenStateConsumeDoc(&(*pGen),&pMeth->sFunc.sDoc);` |
|  2894871 | 1112 | `	if( GenStateConsumeAttrs(&(*pGen),&pMeth->sFunc.aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 1113 | `		return SXERR_ABORT;` |
|        - | 1114 | `	}` |
|        - | 1115 | `	/* Jump the left parenthesis '(' */` |
|  2894871 | 1116 | `	pGen->pIn++;` |
|  2894871 | 1117 | `	pEnd = 0; /* cc warning */` |
|        - | 1118 | `	/* Delimit the method signature */` |
|  2894871 | 1119 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|  2894871 | 1120 | `	if( pEnd >= pGen->pEnd ){` |
|        - | 1121 | `		/* Syntax error */` |
...
|        - | 1128 | `	}` |
|        - | 1129 | `	{` |
|  2894869 | 1130 | `		int bIsCtor = 0;` |
|  2894869 | 1131 | `		int bAbstractCtor = 0;` |
|  2894864 | 1132 | `		if( (pName->nByte == sizeof("__construct") - 1` |
|  1699673 | 1133 | `				&& SyMemcmp(pName->zString,"__construct",sizeof("__construct") - 1) == 0)` |
|  2791989 | 1134 | `		 \|\| SyStringCmp(pName,&pClass->sName,SyMemcmp) == 0 ){` |
|   205765 | 1135 | `			if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|        3 | 1136 | `				bAbstractCtor = 1;` |
|        2 | 1137 | `			}else{` |
|   205763 | 1138 | `				bIsCtor = 1;` |
|        - | 1139 | `			}` |
|   102880 | 1140 | `		}` |
|  2894869 | 1141 | `		if( pGen->pIn < pEnd ){` |
|        - | 1142 | `			/* Collect method arguments */` |
|  1113729 | 1143 | `			rc = GenStateCollectFuncArgs(&pMeth->sFunc,&(*pGen),pEnd,bIsCtor,bAbstractCtor);` |
|  1113729 | 1144 | `			if( rc == SXERR_ABORT ){` |
|      ! 0 | 1145 | `				return SXERR_ABORT;` |
|        - | 1146 | `			}` |
|   556862 | 1147 | `		}` |
|        - | 1148 | `	}` |
|        - | 1149 | `	/* Point past ')' and parse optional return type ': type' */` |
|  2894869 | 1150 | `	pGen->pIn = &pEnd[1];` |
|        - | 1151 | `	{` |
|  2894869 | 1152 | `		sxi32 rcRt = GenStateParseReturnType(pGen, &pMeth->sFunc);` |
|  2894869 | 1153 | `		if( rcRt == SXERR_ABORT ){` |
|      ! 0 | 1154 | `			return SXERR_ABORT;` |
|  2894869 | 1155 | `		}else if( rcRt == SXERR_SYNTAX ){` |
...
|        - | 1162 | `	{` |
|  2894869 | 1163 | `		sxu32 nArg = SySetUsed(&pMeth->sFunc.aArgs);` |
|        - | 1164 | `		sxu32 i;` |
|  4559463 | 1165 | `		for( i = 0; i < nArg; i++ ){` |
|  1664609 | 1166 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pMeth->sFunc.aArgs,i);` |
|        - | 1167 | `			ph7_class_attr *pAttr;` |
|  1664609 | 1168 | `			sxi32 iAttrFlags = 0;` |
|        - | 1169 | `			int bArgTyped;` |
|  1664609 | 1170 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|  1664523 | 1171 | `				continue;` |
|        - | 1172 | `			}` |
...
|       43 | 1267 | `		}` |
|        - | 1268 | `	}` |
|  2894859 | 1269 | `	if( doBody ){` |
|        - | 1270 | `		/* Compile method body */` |
|  2755175 | 1271 | `		rc = GenStateCompileFuncBody(&(*pGen),&pMeth->sFunc);` |
|  2755175 | 1272 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 | 1273 | `			return SXERR_ABORT;` |
|        - | 1274 | `		}` |
|        - | 1275 | `		/* The cursor sits just past the body's closing brace */` |
|  2755175 | 1276 | `		pMeth->sFunc.nEndLine = pGen->pIn[-1].nLine;` |
|  1377590 | 1277 | `	}else{` |
|        - | 1278 | `		/* Abstract/interface method: declaration ends at the ';' */` |
|   139689 | 1279 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI /* ';'*/) ){` |
|   139689 | 1280 | `			pMeth->sFunc.nEndLine = pGen->pIn->nLine;` |
|    69842 | 1281 | `		}` |
|        - | 1282 | `		/* Only method signature is allowed */` |
|   139689 | 1283 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI /* ';'*/) == 0 ){` |
...
|  2894859 | 1294 | `	rc = PH7_ClassInstallMethod(pClass,pMeth);` |
|  2894859 | 1295 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 1296 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 1297 | `		return SXERR_ABORT;` |
|        - | 1298 | `	}` |
|  2894859 | 1299 | `	return SXRET_OK;` |
|        6 | 1300 | `Synchronize:` |
...
|        - | 1755 | ` */` |
|    69928 | 1756 | `PH7_PRIVATE sxi32 PH7_CompileClassInterface(ph7_gen_state *pGen)` |
|        5 | 1757 | `{` |
|    69933 | 1758 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|    69933 | 1767 | `	pName = &pGen->pIn->sData;` |
|        - | 1768 | `	/* Advance the stream cursor */` |
|    69933 | 1769 | `	pGen->pIn++;` |
|        - | 1770 | `	/* Build FQN and obtain a raw class */ {` |
|        - | 1771 | `		SyBlob sFQN;` |
|        - | 1772 | `		SyString sFQNStr;` |
|    69933 | 1773 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|    69933 | 1774 | `		GenStateBuildFQN(pGen,pName,&sFQN);` |
|    69933 | 1775 | `		SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|    69933 | 1776 | `		pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|    69933 | 1777 | `		SyBlobRelease(&sFQN);` |
|        - | 1778 | `	}` |
|    69933 | 1779 | `	if( pClass == 0 ){` |
|      ! 0 | 1780 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 1781 | `		return SXERR_ABORT;` |
|        - | 1782 | `	}` |
|    69933 | 1783 | `	GenStateConsumeDoc(&(*pGen),&pClass->sDoc);` |
|    69933 | 1784 | `	if( GenStateConsumeAttrs(&(*pGen),&pClass->aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 1785 | `		return SXERR_ABORT;` |
|        - | 1786 | `	}` |
|        - | 1787 | `	/* Mark as an interface (PH7_NewRawClass may have set INTERNAL) */` |
|    69933 | 1788 | `	pClass->iFlags \|= PH7_CLASS_INTERFACE;` |
|        - | 1789 | `	/* Assume no base class is given */` |
|    69933 | 1790 | `	pBase = 0;` |
|    69933 | 1791 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|    27163 | 1792 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    27163 | 1793 | `		if( nKwrd == PH7_TKWRD_EXTENDS /* interface b extends a, c, … */ ){` |
...
|    27165 | 1804 | `				nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|    27165 | 1805 | `				SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|    27165 | 1806 | `				if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|        - | 1816 | `				}` |
|    40745 | 1817 | `				pParent = PH7_VmExtractClass(pGen->pVm,` |
|    27160 | 1818 | `					(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|    27165 | 1819 | `				SyStringInitFromBuf(&sBaseName,` |
|        - | 1820 | `					(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|        - | 1821 | `				/* Only interfaces is allowed */` |
|    27165 | 1822 | `				while( pParent && (pParent->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|      ! 0 | 1823 | `					pParent = pParent->pNextName;` |
|      ! 0 | 1824 | `				}` |
|    27165 | 1825 | `				if( pParent == 0 ){` |
...
|      ! 0 | 1831 | `					}` |
|    27165 | 1832 | `				}else if( pBase == 0 ){` |
|        - | 1833 | `					/* First parent → single-inheritance base */` |
|    27163 | 1834 | `					pBase = pParent;` |
|    13584 | 1835 | `				}else{` |
...
|        - | 1839 | `				}` |
|    27165 | 1840 | `				SyBlobRelease(&sResolved);` |
|        - | 1841 | `				/* Continue on a comma-separated list */` |
|    27165 | 1842 | `				if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA) ){` |
|        3 | 1843 | `					pGen->pIn++;` |
|        3 | 1844 | `					continue;` |
|        - | 1845 | `				}` |
|    27163 | 1846 | `				break;` |
...
|    13579 | 1848 | `		}` |
|    13579 | 1849 | `	}` |
|    69933 | 1850 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|        - | 1851 | `		/* Syntax error */` |
...
|        - | 1859 | `	}` |
|    69933 | 1860 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|    69933 | 1861 | `	pEnd = 0; /* cc warning */` |
|        - | 1862 | `	/* Delimit the interface body */` |
|    69933 | 1863 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|    69933 | 1864 | `	if( pEnd >= pGen->pEnd ){` |
|        - | 1865 | `		/* Syntax error */` |
...
|    69933 | 1875 | `	pClass->nEndLine = pEnd->nLine;` |
|        - | 1876 | `	/* Swap token stream */` |
|    69933 | 1877 | `	pTmp = pGen->pEnd;` |
|    69933 | 1878 | `	pGen->pEnd = pEnd;` |
...
|   442357 | 1886 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|   186215 | 1887 | `			pGen->pIn++;` |
|        5 | 1888 | `		}` |
|   256147 | 1889 | `		if( pGen->pIn >= pGen->pEnd ){` |
|        - | 1890 | `			/* End of interface body */` |
|    69929 | 1891 | `			break;` |
|        - | 1892 | `		}` |
|        - | 1893 | `		/* Bind a directly-preceding docblock to this member */` |
|   186223 | 1894 | `		GenStateSetPendingDoc(&(*pGen));` |
|   186223 | 1895 | `		if( (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|   186223 | 1906 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   186223 | 1907 | `		if( nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
...
|        3 | 1936 | `			goto done;` |
|        - | 1937 | `		}` |
|   186221 | 1938 | `		if( nKwrd != PH7_TKWRD_PUBLIC && nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|      ! 0 | 1945 | `			goto done;` |
|        - | 1946 | `		}` |
|   186221 | 1947 | `		if( nKwrd == PH7_TKWRD_PUBLIC ){` |
|        - | 1948 | `			/* Advance the stream cursor */` |
|   131911 | 1949 | `			pGen->pIn++;` |
|   131906 | 1950 | `			if( pGen->pIn < pGen->pEnd` |
|   131911 | 1951 | `			 && ((pGen->pIn->nType & PH7_TK_DOLLAR) != 0` |
|   131906 | 1952 | `			  \|\| (pGen->pIn->sData.nByte == 1 && pGen->pIn->sData.zString[0] == '?')) ){` |
...
|      ! 0 | 1966 | `				continue;` |
|        - | 1967 | `			}` |
|   131911 | 1968 | `			if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|      ! 0 | 1990 | `				goto done;` |
|        - | 1991 | `			}` |
|   131911 | 1992 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   131911 | 1993 | `			if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|        - | 2015 | `			}` |
|    65951 | 2016 | `		}` |
|   186217 | 2017 | `		if( nKwrd == PH7_TKWRD_CONST ){` |
|        - | 2018 | `			/* Parse constant */` |
|    54311 | 2019 | `			rc = GenStateCompileClassConstant(&(*pGen),0,0,pClass);` |
|    54311 | 2020 | `			if( rc != SXRET_OK ){` |
...
|        - | 2025 | `			}` |
|    27157 | 2026 | `		}else{` |
|   131911 | 2027 | `			sxi32 iFlags = PH7_CLASS_ATTR_ABSTRACT; /* Interface methods are implicitly abstract */` |
|   131911 | 2028 | `			if( nKwrd == PH7_TKWRD_STATIC ){` |
|        - | 2029 | `				/* Static method,record that */` |
|    11639 | 2030 | `				iFlags \|= PH7_CLASS_ATTR_STATIC;` |
|        - | 2031 | `				/* Advance the stream cursor */` |
|    11639 | 2032 | `				pGen->pIn++;` |
|    11634 | 2033 | `				if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0` |
|    11639 | 2034 | `					\|\| SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_FUNCTION ){` |
...
|   131911 | 2045 | `			rc = GenStateCompileClassMethod(&(*pGen),0,iFlags,FALSE,pClass);` |
|   131911 | 2046 | `			if( rc != SXRET_OK ){` |
...
|    69929 | 2055 | `	if( GenStateGuardClassRedeclaration(pGen,pClass) == SXERR_ABORT ){` |
|        3 | 2056 | `		return SXERR_ABORT;` |
|        - | 2057 | `	}` |
|        - | 2058 | `	/* Install the interface */` |
|    69927 | 2059 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|    69927 | 2060 | `	if( rc == SXRET_OK && pBase ){` |
|        - | 2061 | `		/* Inherit from the base interface */` |
|    27163 | 2062 | `		rc = PH7_ClassInterfaceInherit(pClass,pBase);` |
|    13579 | 2063 | `	}` |
|    69927 | 2064 | `	if( rc != SXRET_OK ){` |
...
|    69931 | 2070 | `	pGen->pIn  = &pEnd[1];` |
|    69931 | 2071 | `	pGen->pEnd = pTmp;` |
|    69931 | 2072 | `	return PH7_OK;` |
|    34969 | 2073 | `}` |
|        - | 2074 | `/*` |
...
|        - | 2098 | ` */` |
|   440118 | 2099 | `static sxi32 GenStateCheckInterfaceSignatures(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 | 2100 | `{` |
|        - | 2101 | `	ph7_class **apIface;` |
|        - | 2102 | `	sxu32 nIface,i;` |
|        - | 2103 | `	sxi32 rc;` |
|   440123 | 2104 | `	if( pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|      ! 0 | 2105 | `		return SXRET_OK;` |
|        - | 2106 | `	}` |
|   440123 | 2107 | `	apIface = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|   440123 | 2108 | `	nIface = SySetUsed(&pClass->aInterface);` |
|   851545 | 2109 | `	for(i = 0; i < nIface; i++){` |
|   411427 | 2110 | `		ph7_class *pIface = apIface[i];` |
|        - | 2111 | `		SyHashEntry *pEntry;` |
|   411427 | 2112 | `		SyHashResetLoopCursor(&pIface->hMethod);` |
|  1222535 | 2113 | `		while((pEntry = SyHashGetNextEntry(&pIface->hMethod)) != 0 ){` |
|   811113 | 2114 | `			ph7_class_method *pIfaceMeth = (ph7_class_method *)pEntry->pUserData;` |
|        - | 2115 | `			ph7_class_method *pImplMeth;` |
|   811113 | 2116 | `			SyString *pMName = &pIfaceMeth->sFunc.sName;` |
|        - | 2117 | `			/* Find the implementing method in the class */` |
|   811113 | 2118 | `			pImplMeth = PH7_ClassExtractMethod(pClass,pMName->zString,pMName->nByte);` |
|   811113 | 2119 | `			if( pImplMeth == 0 \|\| (pImplMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT) ){` |
...
|   811095 | 2123 | `			if( pImplMeth->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|        - | 2133 | `			 */` |
|        - | 2134 | `			{` |
|   811095 | 2135 | `				sxu32 nIfaceArgs = SySetUsed(&pIfaceMeth->sFunc.aArgs);` |
|   811095 | 2136 | `				sxu32 nImplArgs = SySetUsed(&pImplMeth->sFunc.aArgs);` |
|   811095 | 2137 | `				int sigError = 0;` |
|   811095 | 2138 | `				if( nImplArgs < nIfaceArgs ){` |
|        3 | 2139 | `					sigError = 1;` |
|   811094 | 2140 | `				}else if( nImplArgs > nIfaceArgs ){` |
|        - | 2141 | `					/* Extra parameters must all have default values */` |
|     3887 | 2142 | `					ph7_vm_func_arg *aImplArgs = (ph7_vm_func_arg *)SySetBasePtr(&pImplMeth->sFunc.aArgs);` |
|        - | 2143 | `					sxu32 k;` |
|     7767 | 2144 | `					for(k = nIfaceArgs; k < nImplArgs; k++){` |
|     3887 | 2145 | `						if( SySetUsed(&aImplArgs[k].aByteCode) == 0 ){` |
|        3 | 2146 | `							sigError = 1;` |
|        3 | 2147 | `							break;` |
|        - | 2148 | `						}` |
|     1945 | 2149 | `					}` |
|     1941 | 2150 | `				}` |
|   811095 | 2151 | `				if( sigError ){` |
...
|        - | 2231 | ` */` |
|   440118 | 2232 | `static sxi32 GenStateCheckAbstractMethods(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 | 2233 | `{` |
...
|   440123 | 2240 | `	if( pClass->iFlags & (PH7_CLASS_ABSTRACT\|PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|    19449 | 2241 | `		return SXRET_OK;` |
|        - | 2242 | `	}` |
|        - | 2243 | `	/* Count abstract methods */` |
|   420679 | 2244 | `	nAbstract = 0;` |
|   420679 | 2245 | `	SyHashResetLoopCursor(&pClass->hMethod);` |
|  6338380 | 2246 | `	while((pEntry = SyHashGetNextEntry(&pClass->hMethod)) != 0 ){` |
|  5707369 | 2247 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|  5707369 | 2248 | `		if( pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
...
|        8 | 2253 | `		}` |
|        5 | 2254 | `	}` |
|   420679 | 2255 | `	if( nAbstract == 0 ){` |
|   420665 | 2256 | `		return SXRET_OK;` |
|        - | 2257 | `	}` |
...
|        - | 2394 | ` */` |
|   502534 | 2395 | `PH7_PRIVATE sxi32 GenStateParseClassReference(ph7_gen_state *pGen,SyBlob *pFqn)` |
|        5 | 2396 | `{` |
|   502539 | 2397 | `	int isAbsolute = 0;` |
|   502539 | 2398 | `	SyToken *pStart = pGen->pIn;` |
|        - | 2399 | `	SyBlob sName;` |
|   502539 | 2400 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) ){` |
|     4497 | 2401 | `		isAbsolute = 1;` |
|     4497 | 2402 | `		pGen->pIn++;` |
|     2246 | 2403 | `	}` |
|   502539 | 2404 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|        9 | 2405 | `		pGen->pIn = pStart;` |
|        9 | 2406 | `		return SXERR_INVALID;` |
|        - | 2407 | `	}` |
|   502533 | 2408 | `	SyBlobInit(&sName,&pGen->pVm->sAllocator);` |
|   502533 | 2409 | `	SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|   502533 | 2410 | `	pGen->pIn++;` |
|   753831 | 2411 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) &&` |
|   251308 | 2412 | `		&pGen->pIn[1] < pGen->pEnd && (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|       28 | 2413 | `		SyBlobAppend(&sName,"\\",1);` |
|       28 | 2414 | `		pGen->pIn++;` |
|       28 | 2415 | `		SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|       28 | 2416 | `		pGen->pIn++;` |
|        2 | 2417 | `	}` |
|   502533 | 2418 | `	if( isAbsolute ){` |
|     4495 | 2419 | `		SyBlobAppend(pFqn,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|     2250 | 2420 | `	}else{` |
|        - | 2421 | `		SyString sRaw;` |
|   498043 | 2422 | `		SyStringInitFromBuf(&sRaw,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|   498043 | 2423 | `		GenStateResolveName(pGen,&sRaw,pFqn);` |
|        - | 2424 | `	}` |
|   502533 | 2425 | `	SyBlobRelease(&sName);` |
|   502533 | 2426 | `	return SXRET_OK;` |
|   251272 | 2427 | `}` |
|        - | 2428 | `/*` |
...
|   197990 | 2436 | `static int GenStateInterfaceIsThrowableAt(ph7_class *pInterface,int iDepth)` |
|        5 | 2437 | `{` |
|        - | 2438 | `	ph7_class **apParent;` |
|        - | 2439 | `	sxu32 n;` |
|   523999 | 2440 | `	while( pInterface ){` |
|   333775 | 2441 | `		if( iDepth > PH7_THROWABLE_WALK_MAX_DEPTH ){` |
|      ! 0 | 2442 | `			return FALSE;` |
|        - | 2443 | `		}` |
|   372575 | 2444 | `		if( pInterface->sName.nByte == sizeof("Throwable")-1 &&` |
|    77600 | 2445 | `			SyMemcmp(pInterface->sName.zString,"Throwable",sizeof("Throwable")-1) == 0 ){` |
|     7771 | 2446 | `			return TRUE;` |
|        - | 2447 | `		}` |
|   326009 | 2448 | `		apParent = (ph7_class **)SySetBasePtr(&pInterface->aInterface);` |
|   326011 | 2449 | `		for( n = 0 ; n < SySetUsed(&pInterface->aInterface) ; ++n ){` |
|        3 | 2450 | `			if( GenStateInterfaceIsThrowableAt(apParent[n],iDepth+1) ){` |
|      ! 0 | 2451 | `				return TRUE;` |
|        - | 2452 | `			}` |
|        2 | 2453 | `		}` |
|   326009 | 2454 | `		pInterface = pInterface->pBase;` |
|   326009 | 2455 | `		iDepth++;` |
|        5 | 2456 | `	}` |
|   190229 | 2457 | `	return FALSE;` |
|    99000 | 2458 | `}` |
|   197988 | 2459 | `static int GenStateInterfaceIsThrowable(ph7_class *pInterface)` |
|        5 | 2460 | `{` |
|   197993 | 2461 | `	return GenStateInterfaceIsThrowableAt(pInterface,0);` |
|        5 | 2462 | `}` |
|        - | 2463 | `/*` |
...
|        - | 2467 | ` */` |
|     7766 | 2468 | `static int GenStateClassIsExceptionOrError(ph7_class *pBase)` |
|        5 | 2469 | `{` |
|     7775 | 2470 | `	while( pBase ){` |
...
|        - | 2491 | ` */` |
|     7810 | 2492 | `static sxi32 GenStateCompileEnumCase(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 | 2493 | `{` |
|     7815 | 2494 | `	sxu32 nLine = pGen->pIn->nLine;` |
|        - | 2495 | `	SySet *pInstrContainer;` |
|        - | 2496 | `	ph7_class_attr *pCase;` |
|        - | 2497 | `	SyString *pName;` |
|        - | 2498 | `	sxi32 rc;` |
|     7815 | 2499 | `	pGen->pIn++; /* Jump the 'case' keyword */` |
|     7815 | 2500 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|        - | 2507 | `	}` |
|     7815 | 2508 | `	pName = &pGen->pIn->sData;` |
|        - | 2509 | `	/* Cases share the class-constant namespace (php: "Cannot redefine class constant") */` |
|     7815 | 2510 | `	if( SyHashGet(&pClass->hAttr,(const void *)pName->zString,pName->nByte) != 0 ){` |
...
|        - | 2517 | `	}` |
|     7815 | 2518 | `	pCase = PH7_NewClassAttr(pGen->pVm,pName,pGen->pIn->nLine,PH7_CLASS_PROT_PUBLIC,` |
|        - | 2519 | `		PH7_CLASS_ATTR_CONSTANT\|PH7_CLASS_ATTR_ENUMCASE);` |
|     7815 | 2520 | `	if( pCase == 0 ){` |
|      ! 0 | 2521 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2522 | `		return SXERR_ABORT;` |
|        - | 2523 | `	}` |
|     7815 | 2524 | `	GenStateConsumeDoc(&(*pGen),&pCase->sDoc);` |
|     7815 | 2525 | `	if( GenStateConsumeAttrs(&(*pGen),&pCase->aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 2526 | `		return SXERR_ABORT;` |
|        - | 2527 | `	}` |
|     7815 | 2528 | `	pGen->pIn++; /* Jump the case name */` |
|     7815 | 2529 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_EQUAL /* '=' */) ){` |
|     7801 | 2530 | `		if( pClass->nEnumBacking == 0 ){` |
...
|        - | 2537 | `		}` |
|     7797 | 2538 | `		pGen->pIn++; /* Jump the equal sign */` |
|        - | 2539 | `		/* Compile the backing value expression into the case's own container` |
|        - | 2540 | `		 * (same technique as class constants). */` |
|     7797 | 2541 | `		pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|     7797 | 2542 | `		PH7_VmSetByteCodeContainer(pGen->pVm,&pCase->aByteCode);` |
|     7797 | 2543 | `		rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|     7797 | 2544 | `		if( rc == SXERR_EMPTY ){` |
|      ! 0 | 2545 | `			rc = PH7_GenCompileError(pGen,E_ERROR,nLine,` |
|      ! 0 | 2546 | `				"Empty value for enum case %z::%z",&pClass->sName,pName);` |
|      ! 0 | 2547 | `		}` |
|     7797 | 2548 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|     7797 | 2549 | `		PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|     7797 | 2550 | `		if( rc == SXERR_ABORT ){` |
...
|        - | 2561 | `		}` |
|        - | 2562 | `	}` |
|     7811 | 2563 | `	rc = PH7_ClassInstallAttr(pClass,pCase);` |
|     7811 | 2564 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 2565 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2566 | `		return SXERR_ABORT;` |
|        - | 2567 | `	}` |
|     7811 | 2568 | `	SySetPut(&pClass->aEnumCases,(const void *)&pCase);` |
|     7811 | 2569 | `	return SXRET_OK;` |
|        2 | 2570 | `Synchronize:` |
...
|        - | 2585 | ` */` |
|     3910 | 2586 | `static sxi32 GenStateCompileEnumMethods(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 | 2587 | `{` |
...
|     3915 | 2593 | `	sxi32 rc = SXRET_OK;` |
|     3915 | 2594 | `	nMax = 3*(sxu32)sizeof("function tryFrom(string $value){return __phl_enum_tryfrom('',$value);}")` |
|     3910 | 2595 | `		+ 3*SyStringLength(&pClass->sName) + 64;` |
|     3915 | 2596 | `	zSrc = (char *)SyMemBackendAlloc(&pGen->pVm->sAllocator,nMax);` |
|     3915 | 2597 | `	if( zSrc == 0 ){` |
|      ! 0 | 2598 | `		PH7_GenCompileError(pGen,E_ERROR,pClass->nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2599 | `		return SXERR_ABORT;` |
|        - | 2600 | `	}` |
|     3915 | 2601 | `	zBack = (pClass->nEnumBacking == MEMOBJ_INT) ? "int" : "string";` |
|     3915 | 2602 | `	if( pClass->nEnumBacking != 0 ){` |
|     5843 | 2603 | `		nSrc = SyBufferFormat(zSrc,nMax,` |
...
|     1946 | 2607 | `			&pClass->sName,zBack,&pClass->sName,zBack,&pClass->sName);` |
|     1951 | 2608 | `	}else{` |
|       31 | 2609 | `		nSrc = SyBufferFormat(zSrc,nMax,` |
|        9 | 2610 | `			"function cases(){return __phl_enum_cases('%z');}",&pClass->sName);` |
|        - | 2611 | `	}` |
|     3915 | 2612 | `	SySetInit(&sToken,&pGen->pVm->sAllocator,sizeof(SyToken));` |
|     3915 | 2613 | `	PH7_TokenizePHP(zSrc,nSrc,pClass->nLine,&sToken,0);` |
|     3915 | 2614 | `	pSaveIn = pGen->pIn;` |
|     3915 | 2615 | `	pSaveEnd = pGen->pEnd;` |
|     3915 | 2616 | `	pGen->pIn = (SyToken *)SySetBasePtr(&sToken);` |
|     3915 | 2617 | `	pGen->pEnd = &pGen->pIn[SySetUsed(&sToken)];` |
|    15609 | 2618 | `	while( pGen->pIn < pGen->pEnd && rc != SXERR_ABORT ){` |
|    11699 | 2619 | `		rc = GenStateCompileClassMethod(&(*pGen),PH7_TKWRD_PUBLIC,PH7_CLASS_ATTR_STATIC,TRUE,pClass);` |
|        5 | 2620 | `	}` |
|     3915 | 2621 | `	pGen->pIn = pSaveIn;` |
|     3915 | 2622 | `	pGen->pEnd = pSaveEnd;` |
|     3915 | 2623 | `	SySetRelease(&sToken);` |
|     3915 | 2624 | `	return (rc == SXERR_ABORT) ? SXERR_ABORT : SXRET_OK;` |
|     1960 | 2625 | `}` |
|        - | 2626 | `/*` |
...
|        - | 2640 | ` */` |
|     3910 | 2641 | `static sxi32 GenStateEnumFinalize(ph7_gen_state *pGen,ph7_class *pClass,sxu32 nLine)` |
|        5 | 2642 | `{` |
|        - | 2643 | `	SyHashEntry *pEntry;` |
|        - | 2644 | `	sxi32 rc;` |
|        - | 2645 | `	sxu32 n;` |
|        - | 2646 | `	/* php: "Enum %s cannot include properties" */` |
|     3915 | 2647 | `	SyHashResetLoopCursor(&pClass->hAttr);` |
|    11725 | 2648 | `	while( (pEntry = SyHashGetNextEntry(&pClass->hAttr)) != 0 ){` |
|     7817 | 2649 | `		ph7_class_attr *pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|     7817 | 2650 | `		if( (pAttr->iFlags & PH7_CLASS_ATTR_CONSTANT) == 0 ){` |
...
|    54745 | 2660 | `	for( n = 0 ; n < SX_ARRAYSIZE(azEnumBannedMagic) ; n++ ){` |
|    76245 | 2661 | `		if( SyHashGet(&pClass->hMethod,(const void *)azEnumBannedMagic[n],` |
|    50835 | 2662 | `			SyStrlen(azEnumBannedMagic[n])) != 0 ){` |
...
|     3915 | 2678 | `		pAttr = PH7_NewClassAttr(pGen->pVm,&sNameProp,nLine,PH7_CLASS_PROT_PUBLIC,` |
|        - | 2679 | `			PH7_CLASS_ATTR_READONLY\|PH7_CLASS_ATTR_TYPED);` |
|     3915 | 2680 | `		if( pAttr == 0 ){` |
|      ! 0 | 2681 | `			PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2682 | `			return SXERR_ABORT;` |
|        - | 2683 | `		}` |
|     3915 | 2684 | `		pAttr->nType = MEMOBJ_STRING;` |
|     3915 | 2685 | `		SyStringInitFromBuf(&pAttr->sTypeName,"string",sizeof("string")-1);` |
|     3915 | 2686 | `		PH7_ClassInstallAttr(pClass,pAttr);` |
|     3915 | 2687 | `		if( pClass->nEnumBacking != 0 ){` |
|     3897 | 2688 | `			pAttr = PH7_NewClassAttr(pGen->pVm,&sValueProp,nLine,PH7_CLASS_PROT_PUBLIC,` |
|        - | 2689 | `				PH7_CLASS_ATTR_READONLY\|PH7_CLASS_ATTR_TYPED);` |
|     3897 | 2690 | `			if( pAttr == 0 ){` |
|      ! 0 | 2691 | `				PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2692 | `				return SXERR_ABORT;` |
|        - | 2693 | `			}` |
|     3897 | 2694 | `			pAttr->nType = pClass->nEnumBacking;` |
|     3897 | 2695 | `			if( pClass->nEnumBacking == MEMOBJ_INT ){` |
|        7 | 2696 | `				SyStringInitFromBuf(&pAttr->sTypeName,"int",sizeof("int")-1);` |
|        4 | 2697 | `			}else{` |
|     3891 | 2698 | `				SyStringInitFromBuf(&pAttr->sTypeName,"string",sizeof("string")-1);` |
|        - | 2699 | `			}` |
|     3897 | 2700 | `			PH7_ClassInstallAttr(pClass,pAttr);` |
|     1946 | 2701 | `		}` |
|        - | 2702 | `	}` |
|     3915 | 2703 | `	return GenStateCompileEnumMethods(&(*pGen),pClass);` |
|     1960 | 2704 | `}` |
|        - | 2705 | `/*` |
...
|        - | 2714 | ` */` |
|   440168 | 2715 | `static sxi32 GenStateCompileClassEx(ph7_gen_state *pGen,sxi32 iFlags,` |
|        - | 2716 | `	SyString *pAnonName,SyToken **ppArgStart,SyToken **ppArgEnd)` |
|        5 | 2717 | `{` |
|   440173 | 2718 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|   440173 | 2729 | `	pGen->pIn++;` |
|   440173 | 2730 | `	if( pAnonName ){` |
...
|       19 | 2745 | `	}else{` |
|   440143 | 2746 | `		if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
|        - | 2747 | `			/* Syntax error */` |
...
|   440143 | 2760 | `		pName = &pGen->pIn->sData;` |
|        - | 2761 | `		/* Advance the stream cursor */` |
|   440143 | 2762 | `		pGen->pIn++;` |
|        - | 2763 | `		/* Build FQN and obtain a raw class */ {` |
|        - | 2764 | `			SyBlob sFQN;` |
|        - | 2765 | `			SyString sFQNStr;` |
|   440143 | 2766 | `			SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|   440143 | 2767 | `			GenStateBuildFQN(pGen,pName,&sFQN);` |
|   440143 | 2768 | `			SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|   440143 | 2769 | `			pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|   440143 | 2770 | `			SyBlobRelease(&sFQN);` |
|        - | 2771 | `		}` |
|        - | 2772 | `	}` |
|   440173 | 2773 | `	if( pClass == 0 ){` |
|      ! 0 | 2774 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2775 | `		return SXERR_ABORT;` |
|        - | 2776 | `	}` |
|   440168 | 2777 | `	if( (iFlags & PH7_CLASS_ENUM) && pGen->pIn < pGen->pEnd` |
|     3919 | 2778 | `		&& (pGen->pIn->nType & PH7_TK_COLON /* ':' */) ){` |
|        - | 2779 | ``		/* Backed enum: `enum Name: int\|string` (PHP 8.1) */`` |
|     3899 | 2780 | `		pGen->pIn++; /* Jump ':' */` |
|     3894 | 2781 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD)` |
|     3899 | 2782 | `			&& SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_INT ){` |
|        7 | 2783 | `			pClass->nEnumBacking = MEMOBJ_INT;` |
|        7 | 2784 | `			pGen->pIn++;` |
|     3892 | 2785 | `		}else if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD)` |
|     3893 | 2786 | `			&& SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_STRING ){` |
|     3891 | 2787 | `			pClass->nEnumBacking = MEMOBJ_STRING;` |
|     3891 | 2788 | `			pGen->pIn++;` |
|     1948 | 2789 | `		}else{` |
...
|        - | 2800 | `		}` |
|     1947 | 2801 | `	}` |
|   440173 | 2802 | `	GenStateConsumeDoc(&(*pGen),&pClass->sDoc);` |
|   440173 | 2803 | `	if( GenStateConsumeAttrs(&(*pGen),&pClass->aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 2804 | `		return SXERR_ABORT;` |
|        - | 2805 | `	}` |
|        - | 2806 | `	/* implemented interfaces and per-use-statement trait containers */` |
|   440173 | 2807 | `	SySetInit(&aInterfaces,&pGen->pVm->sAllocator,sizeof(ph7_class *));` |
|   440173 | 2808 | `	SySetInit(&aUseEntries,&pGen->pVm->sAllocator,sizeof(TraitUseEntry));` |
|        - | 2809 | `	/* Assume a standalone class */` |
|   440173 | 2810 | `	pBase = 0;` |
|   440173 | 2811 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|   357257 | 2812 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   357257 | 2813 | `		if( nKwrd == PH7_TKWRD_EXTENDS /* class b extends a */ ){` |
|        - | 2814 | `			SyBlob sResolved;` |
|        - | 2815 | `			SyString sBaseName;` |
|        - | 2816 | `			sxu32 nRefLine;` |
|   236859 | 2817 | `			if( iFlags & PH7_CLASS_ENUM ){` |
...
|        - | 2823 | `				}` |
|      ! 0 | 2824 | `			}` |
|   236859 | 2825 | `			pGen->pIn++; /* Advance past 'extends' */` |
|   236859 | 2826 | `			nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|   236859 | 2827 | `			SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|   236859 | 2828 | `			if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|        - | 2838 | `			}` |
|   355283 | 2839 | `			pBase = PH7_VmExtractClass(pGen->pVm,` |
|   236852 | 2840 | `				(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|   236857 | 2841 | `			SyStringInitFromBuf(&sBaseName,` |
|        - | 2842 | `				(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|        - | 2843 | `			/* Interfaces are not allowed */` |
|   236857 | 2844 | `			while( pBase && (pBase->iFlags & PH7_CLASS_INTERFACE) ){` |
|      ! 0 | 2845 | `				pBase = pBase->pNextName;` |
|      ! 0 | 2846 | `			}` |
|   236857 | 2847 | `			if( pBase == 0 ){` |
...
|        - | 2853 | `				}` |
|      ! 0 | 2854 | `			}else{` |
|   236857 | 2855 | `				if( pBase->iFlags & PH7_CLASS_ENUM ){` |
...
|   236856 | 2863 | `				}else if( pBase->iFlags & PH7_CLASS_FINAL ){` |
...
|      ! 0 | 2870 | `				}` |
|        - | 2871 | `			}` |
|   236857 | 2872 | `			SyBlobRelease(&sResolved);` |
|   236857 | 2873 | `			if( iFlags & PH7_CLASS_ENUM ){` |
|      ! 0 | 2874 | `				pBase = 0; /* Error already reported: enums have no base class */` |
|      ! 0 | 2875 | `			}` |
|   118426 | 2876 | `		}` |
|   357255 | 2877 | `		if (pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) && SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_IMPLEMENTS ){` |
|        - | 2878 | `			ph7_class *pInterface;` |
|        - | 2879 | `			/* Interface implementation */` |
|   135931 | 2880 | `			pGen->pIn++; /* Advance the stream cursor */` |
|   130025 | 2881 | `			for(;;){` |
|        - | 2882 | `				SyBlob sResolved;` |
|        - | 2883 | `				SyString sIntName;` |
|        - | 2884 | `				sxu32 nRefLine;` |
|   197993 | 2885 | `				nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|   197993 | 2886 | `				SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|   197993 | 2887 | `				if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|      ! 0 | 2895 | `					break;` |
|        - | 2896 | `				}` |
|   395981 | 2897 | `				pInterface = PH7_VmExtractClass(pGen->pVm,` |
|   197988 | 2898 | `					(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|   197993 | 2899 | `				SyStringInitFromBuf(&sIntName,` |
|        - | 2900 | `					(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|        - | 2901 | `				/* Only interfaces are allowed */` |
|   197993 | 2902 | `				while( pInterface && (pInterface->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|      ! 0 | 2903 | `					pInterface = pInterface->pNextName;` |
|      ! 0 | 2904 | `				}` |
|   197993 | 2905 | `				if( pInterface == 0 ){` |
...
|   197993 | 2919 | `					SyString *pFqn = &pClass->sName;` |
|   197993 | 2920 | `					int bIsExceptionOrError =` |
|   102876 | 2921 | `						(pFqn->nByte == sizeof("Exception")-1 &&` |
|   298925 | 2922 | `						 SyMemcmp(pFqn->zString,"Exception",sizeof("Exception")-1) == 0) \|\|` |
|   196056 | 2923 | `						(pFqn->nByte == sizeof("Error")-1 &&` |
|     3892 | 2924 | `						 SyMemcmp(pFqn->zString,"Error",sizeof("Error")-1) == 0);` |
|   201871 | 2925 | `					if( GenStateInterfaceIsThrowable(pInterface) &&` |
|    11652 | 2926 | `						!GenStateClassIsExceptionOrError(pBase) &&` |
|     3881 | 2927 | `						!bIsExceptionOrError ){` |
...
|        6 | 2937 | `					}else{` |
|   197987 | 2938 | `						SySetPut(&aInterfaces,(const void *)&pInterface);` |
|        - | 2939 | `					}` |
|        - | 2940 | `				}` |
|   197993 | 2941 | `				SyBlobRelease(&sResolved);` |
|   197993 | 2942 | `				if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COMMA) == 0 ){` |
|    67968 | 2943 | `					break;` |
|        - | 2944 | `				}` |
|    62067 | 2945 | `				pGen->pIn++;/* Jump the comma */` |
|        5 | 2946 | `			}` |
|    67963 | 2947 | `		}` |
|   178625 | 2948 | `	}` |
|   440171 | 2949 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|        - | 2950 | `		/* Syntax error */` |
...
|        - | 2958 | `	}` |
|   440171 | 2959 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|   440171 | 2960 | `	pEnd = 0; /* cc warning */` |
|        - | 2961 | `	/* Delimit the class body */` |
|   440171 | 2962 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|   440171 | 2963 | `	if( pEnd >= pGen->pEnd ){` |
|        - | 2964 | `		/* Syntax error */` |
...
|   440171 | 2974 | `	pClass->nEndLine = pEnd->nLine;` |
|        - | 2975 | `	/* Swap token stream */` |
|   440171 | 2976 | `	pTmp = pGen->pEnd;` |
|   440171 | 2977 | `	pGen->pEnd = pEnd;` |
|        - | 2978 | `	/* Merge the inherited flags (PH7_NewRawClass may have set INTERNAL) */` |
|   440171 | 2979 | `	pClass->iFlags \|= iFlags;` |
|        - | 2980 | `	/* Start the parse process */` |
|  1686875 | 2981 | `	for(;;){` |
|        - | 2982 | `		/* Jump leading/trailing semi-colons */` |
|  4849813 | 2983 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|   885439 | 2984 | `			pGen->pIn++;` |
|        5 | 2985 | `		}` |
|  3964379 | 2986 | `		if( pGen->pIn >= pGen->pEnd ){` |
|        - | 2987 | `			/* End of class body */` |
|   440129 | 2988 | `			break;` |
|        - | 2989 | `		}` |
|        - | 2990 | `		/* Bind a directly-preceding docblock to this member */` |
|  3524255 | 2991 | `		GenStateSetPendingDoc(&(*pGen));` |
|  3524250 | 2992 | `		if( (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR)) == 0` |
|  1762130 | 2993 | ``			&& !GenStateIsReadonly(pGen->pIn) /* allow a leading `readonly` modifier */ ){`` |
...
|  3524255 | 3004 | `		iProtection = PH7_TKWRD_PUBLIC;` |
|  3524255 | 3005 | `		iAttrflags = 0;` |
...
|  3524255 | 3010 | `		if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|      ! 0 | 3011 | `			int bMod = 0;` |
...
|        - | 3032 | `			}` |
|      ! 0 | 3033 | `		}` |
|  3524255 | 3034 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|        - | 3035 | `			/* Extract the current keyword */` |
|  3524255 | 3036 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  3524255 | 3037 | `			if( nKwrd == PH7_TKWRD_CASE && (pClass->iFlags & PH7_CLASS_ENUM) ){` |
|        - | 3038 | ``				/* Enum case declaration: `case NAME [= value];` */`` |
|     7815 | 3039 | `				rc = GenStateCompileEnumCase(&(*pGen),pClass);` |
|     7815 | 3040 | `				if( rc != SXRET_OK ){` |
...
|     7811 | 3046 | `				continue;` |
|        - | 3047 | `			}` |
|  3516445 | 3048 | `			if( nKwrd == PH7_TKWRD_USE ){` |
|        - | 3049 | `				/* Trait use: use TraitA, TraitB [{ ... }]; */` |
|        - | 3050 | `				TraitUseEntry sUse;` |
|    15603 | 3051 | `				SySetInit(&sUse.aTraits,&pGen->pVm->sAllocator,sizeof(ph7_class *));` |
|    15603 | 3052 | `				sUse.pResolvStart = sUse.pResolvEnd = 0;` |
|    15603 | 3053 | `				pGen->pIn++; /* Jump the 'use' keyword */` |
|     7807 | 3054 | `				for(;;){` |
|        - | 3055 | `					ph7_class *pTrait;` |
|        - | 3056 | `					SyBlob sResolved;` |
|        - | 3057 | `					SyString sTraitName;` |
|    15611 | 3058 | `					sxu32 nUseLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
...
|    15611 | 3065 | `					SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|    15611 | 3066 | `					if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|      ! 0 | 3073 | `						break;` |
|        - | 3074 | `					}` |
|    31217 | 3075 | `					pTrait = PH7_VmExtractClass(pGen->pVm,` |
|    15606 | 3076 | `						(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|    15611 | 3077 | `					SyStringInitFromBuf(&sTraitName,` |
|        - | 3078 | `						(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|        - | 3079 | `					/* Only traits are allowed */` |
|    15611 | 3080 | `					while( pTrait && (pTrait->iFlags & PH7_CLASS_TRAIT) == 0 ){` |
|      ! 0 | 3081 | `						pTrait = pTrait->pNextName;` |
|      ! 0 | 3082 | `					}` |
|    15611 | 3083 | `					if( pTrait == 0 ){` |
...
|        - | 3089 | `						}` |
|      ! 0 | 3090 | `					}else{` |
|    15611 | 3091 | `						SySetPut(&sUse.aTraits,(const void *)&pTrait);` |
|        - | 3092 | `					}` |
|    15611 | 3093 | `					SyBlobRelease(&sResolved);` |
...
|    15611 | 3096 | `					if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COMMA) == 0 ){` |
|     7804 | 3097 | `						break;` |
|        - | 3098 | `					}` |
|       10 | 3099 | `					pGen->pIn++; /* Jump the comma */` |
|        2 | 3100 | `				}` |
|        - | 3101 | `				/* Expect semicolon or opening brace (for conflict resolution) */` |
|    15603 | 3102 | `				if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OCB) ){` |
|        - | 3103 | `					SyToken *pBlock;` |
...
|        - | 3112 | `					}` |
|        5 | 3113 | `				}` |
|    15603 | 3114 | `				SySetPut(&aUseEntries,(const void *)&sUse);` |
|        - | 3115 | `				/* The semicolon will be consumed by the outer loop */` |
|    15603 | 3116 | `				continue;` |
|        - | 3117 | `			}` |
|  3500847 | 3118 | `			if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|        - | 3119 | `				int nSetTok;` |
|  2957413 | 3120 | `				sxi32 nSetVis = GenStatePeekSetVisibility(pGen->pIn,pGen->pEnd,&nSetTok);` |
|  2957413 | 3121 | `				if( nSetVis ){` |
...
|        2 | 3126 | `				}else{` |
|  2957411 | 3127 | `					iProtection = nKwrd;` |
|  2957411 | 3128 | `					pGen->pIn++; /* Jump the visibility token */` |
|        - | 3129 | `					/* Optional asymmetric set-visibility after the read` |
|        - | 3130 | ``					 * visibility: `public private(set) int $x`. */`` |
|  2957411 | 3131 | `					nSetVis = GenStatePeekSetVisibility(pGen->pIn,pGen->pEnd,&nSetTok);` |
|  2957411 | 3132 | `					if( nSetVis ){` |
...
|  2957413 | 3139 | `				if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|       28 | 3140 | `					iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|       28 | 3141 | `					pGen->pIn++; /* Jump the 'readonly' modifier */` |
|       12 | 3142 | `				}` |
|  2957408 | 3143 | `				if( pGen->pIn >= pGen->pEnd` |
|  2957413 | 3144 | `					\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|      ! 0 | 3152 | `					goto done;` |
|        - | 3153 | `				}` |
|  2957413 | 3154 | `				if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|        - | 3155 | `					/* Attribute declaration (untyped) */` |
|   524181 | 3156 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|   524181 | 3157 | `					if( rc != SXRET_OK ){` |
|       12 | 3158 | `						if( rc == SXERR_ABORT ){` |
|      ! 0 | 3159 | `							return SXERR_ABORT;` |
|        - | 3160 | `						}` |
|       12 | 3161 | `						goto done;` |
|        - | 3162 | `					}` |
|   532092 | 3163 | `					continue;` |
|        - | 3164 | `				}` |
|  2433237 | 3165 | `				if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
|        - | 3166 | `					/* Typed attribute declaration (PHP 7.4+) */` |
|    15849 | 3167 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|    15849 | 3168 | `					if( rc != SXRET_OK ){` |
...
|  2417393 | 3177 | `				nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  1208694 | 3178 | `			}` |
|  2960827 | 3179 | `			if( nKwrd == PH7_TKWRD_CONST ){` |
|        - | 3180 | `				/* Process constant declaration */` |
|   287145 | 3181 | `				rc = GenStateCompileClassConstant(&(*pGen),iProtection,iAttrflags,pClass);` |
|   287145 | 3182 | `				if( rc != SXRET_OK ){` |
...
|        - | 3187 | `				}` |
|   143571 | 3188 | `			}else{` |
|  2673687 | 3189 | `				if( nKwrd == PH7_TKWRD_STATIC ){` |
|        - | 3190 | `					/* Static method or attribute,record that */` |
|   101027 | 3191 | `					iAttrflags \|= PH7_CLASS_ATTR_STATIC;` |
|   101027 | 3192 | `					pGen->pIn++; /* Jump the static keyword */` |
|   101027 | 3193 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|        - | 3194 | `						int nSetTok;` |
|    73839 | 3195 | `						sxi32 nSetVis = GenStatePeekSetVisibility(pGen->pIn,pGen->pEnd,&nSetTok);` |
|    73839 | 3196 | `						if( nSetVis ){` |
...
|    73837 | 3202 | `							nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    73837 | 3203 | `							if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
...
|   101027 | 3217 | `					if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|      ! 0 | 3218 | `						iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|      ! 0 | 3219 | `						pGen->pIn++; /* Jump the 'readonly' modifier */` |
|      ! 0 | 3220 | `					}` |
|   101022 | 3221 | `					if( pGen->pIn >= pGen->pEnd` |
|   101027 | 3222 | `						\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|      ! 0 | 3230 | `						goto done;` |
|        - | 3231 | `					}` |
|   101027 | 3232 | `					if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|        - | 3233 | `						/* Attribute declaration */` |
|    27189 | 3234 | `						rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|    27189 | 3235 | `						if( rc != SXRET_OK ){` |
...
|    27187 | 3241 | `						continue;` |
|        - | 3242 | `					}` |
|    73843 | 3243 | `					if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|    73827 | 3255 | `					nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  2609576 | 3256 | `				}else if( nKwrd == PH7_TKWRD_ABSTRACT ){` |
|        - | 3257 | `					/* Abstract method,record that */` |
|     7783 | 3258 | `					iAttrflags \|= PH7_CLASS_ATTR_ABSTRACT;` |
|        - | 3259 | `					/* Mark the whole class as abstract */` |
|     7783 | 3260 | `					pClass->iFlags \|= PH7_CLASS_ABSTRACT;` |
|        - | 3261 | `					/* Advance the stream cursor */` |
|     7783 | 3262 | `					pGen->pIn++;` |
|     7783 | 3263 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|     7783 | 3264 | `						nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|     7783 | 3265 | `						if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|     7781 | 3266 | `							iProtection = nKwrd;` |
|     7781 | 3267 | `							pGen->pIn++; /* Jump the visibility token */` |
|     3888 | 3268 | `						}` |
|     3889 | 3269 | `					}` |
|     7783 | 3270 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|     7778 | 3271 | `						SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_STATIC ){` |
|        - | 3272 | `							/* Static method */` |
|      ! 0 | 3273 | `							iAttrflags \|= PH7_CLASS_ATTR_STATIC;` |
|      ! 0 | 3274 | `							pGen->pIn++; /* Jump the static keyword */` |
|      ! 0 | 3275 | `					}` |
|     7783 | 3276 | `					if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 \|\|` |
|     7778 | 3277 | `						SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_FUNCTION ){` |
...
|      ! 0 | 3302 | `							goto done;` |
|        - | 3303 | `					}` |
|     7777 | 3304 | `					nKwrd = PH7_TKWRD_FUNCTION;` |
|  2568773 | 3305 | `				}else if( nKwrd == PH7_TKWRD_FINAL ){` |
...
|        3 | 3349 | `				}` |
|  2646469 | 3350 | `				if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_VAR ){` |
...
|      ! 0 | 3358 | `						goto done;` |
|        - | 3359 | `				}` |
|  2646469 | 3360 | `				if( nKwrd == PH7_TKWRD_VAR ){` |
...
|  2646463 | 3375 | `					rc = GenStateCompileClassMethod(&(*pGen),iProtection,iAttrflags,TRUE,pClass);` |
|        - | 3376 | `				}` |
|  2646469 | 3377 | `				if( rc != SXRET_OK ){` |
...
|        - | 3400 | `		sxu32 nU;` |
|   440129 | 3401 | `		apUse = (TraitUseEntry *)SySetBasePtr(&aUseEntries);` |
|   455727 | 3402 | `		for( nU = 0 ; nU < SySetUsed(&aUseEntries) ; nU++ ){` |
|    15603 | 3403 | `			TraitUseEntry *pUse = &apUse[nU];` |
|    15603 | 3404 | `			ph7_class **apTrait = (ph7_class **)SySetBasePtr(&pUse->aTraits);` |
|    15603 | 3405 | `			sxu32 nTraits = SySetUsed(&pUse->aTraits);` |
|    15603 | 3406 | `			int hasResolution = (pUse->pResolvStart && pUse->pResolvStart < pUse->pResolvEnd) ? 1 : 0;` |
|        - | 3407 | `			sxu32 nT;` |
|    15603 | 3408 | `			if( !hasResolution ){` |
|        - | 3409 | `				/* No conflict resolution block: use standard trait application */` |
|    31187 | 3410 | `				for( nT = 0 ; nT < nTraits ; nT++ ){` |
|    15599 | 3411 | `					rc = PH7_ClassUseTrait(&(*pGen),pClass,apTrait[nT]);` |
|    15599 | 3412 | `					if( rc != SXRET_OK ){` |
|      ! 0 | 3413 | `						break;` |
|        - | 3414 | `					}` |
|     7802 | 3415 | `				}` |
|     7799 | 3416 | `			}else{` |
...
|        2 | 3604 | `				}` |
|        - | 3605 | `			}` |
|    15603 | 3606 | `			SySetRelease(&pUse->aTraits);` |
|     7804 | 3607 | `		}` |
|        - | 3608 | `	}` |
|   440129 | 3609 | `	if( pClass->iFlags & PH7_CLASS_ENUM ){` |
...
|     3915 | 3612 | `		rc = GenStateEnumFinalize(&(*pGen),pClass,nLine);` |
|     3915 | 3613 | `		if( rc == SXERR_ABORT ){` |
...
|   440129 | 3620 | `	if( GenStateGuardClassRedeclaration(pGen,pClass) == SXERR_ABORT ){` |
|        9 | 3621 | `		return SXERR_ABORT;` |
|        - | 3622 | `	}` |
|        - | 3623 | `	/* Install the class */` |
|   440123 | 3624 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|   440123 | 3625 | `	if( rc == SXRET_OK ){` |
|        - | 3626 | `		ph7_class **apInterface;` |
|        - | 3627 | `		sxu32 n;` |
|   440123 | 3628 | `		if( pBase ){` |
|        - | 3629 | `			/* Inherit from base class and mark as a subclass */` |
|   236855 | 3630 | `			rc = PH7_ClassInherit(&(*pGen),pClass,pBase);` |
|   118425 | 3631 | `		}` |
|   440123 | 3632 | `		apInterface = (ph7_class **)SySetBasePtr(&aInterfaces);` |
|   638105 | 3633 | `		for( n = 0 ; n < SySetUsed(&aInterfaces) ; n++ ){` |
|        - | 3634 | `			/* Implements one or more interface */` |
|   197987 | 3635 | `			rc = PH7_ClassImplement(pClass,apInterface[n]);` |
|   197987 | 3636 | `			if( rc != SXRET_OK ){` |
|      ! 0 | 3637 | `				break;` |
|        - | 3638 | `			}` |
|    98996 | 3639 | `		}` |
...
|   440123 | 3642 | `		if( rc == SXRET_OK && (pClass->iFlags & PH7_CLASS_ENUM) ){` |
|     3913 | 3643 | `			ph7_class *pIntf = PH7_VmExtractClass(pGen->pVm,"UnitEnum",sizeof("UnitEnum")-1,FALSE,0);` |
|     3913 | 3644 | `			while( pIntf && (pIntf->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|      ! 0 | 3645 | `				pIntf = pIntf->pNextName;` |
|      ! 0 | 3646 | `			}` |
|     3913 | 3647 | `			if( pIntf ){` |
|     3913 | 3648 | `				PH7_ClassImplement(pClass,pIntf);` |
|     1954 | 3649 | `			}` |
|     3913 | 3650 | `			if( pClass->nEnumBacking != 0 ){` |
|     3897 | 3651 | `				pIntf = PH7_VmExtractClass(pGen->pVm,"BackedEnum",sizeof("BackedEnum")-1,FALSE,0);` |
|     3897 | 3652 | `				while( pIntf && (pIntf->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|      ! 0 | 3653 | `					pIntf = pIntf->pNextName;` |
|      ! 0 | 3654 | `				}` |
|     3897 | 3655 | `				if( pIntf ){` |
|     3897 | 3656 | `					PH7_ClassImplement(pClass,pIntf);` |
|     1946 | 3657 | `				}` |
|     1946 | 3658 | `			}` |
|     1954 | 3659 | `		}` |
...
|   440118 | 3662 | `		if( rc == SXRET_OK` |
|   440118 | 3663 | `		 && (pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT)) == 0` |
|   440123 | 3664 | `		 && SyHashGet(&pClass->hMethod,"__toString",sizeof("__toString")-1) != 0 ){` |
|   217281 | 3665 | `			ph7_class *pStringable = PH7_VmExtractClass(pGen->pVm,` |
|        - | 3666 | `				"Stringable",sizeof("Stringable")-1,FALSE,0);` |
|   217281 | 3667 | `			if( pStringable ){` |
|   217281 | 3668 | `				ph7_class **apImpl = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|   217281 | 3669 | `				sxu32 nImpl = SySetUsed(&pClass->aInterface);` |
|        - | 3670 | `				sxu32 i;` |
|   217281 | 3671 | `				int bAlready = 0;` |
|   263821 | 3672 | `				for( i = 0 ; i < nImpl ; i++ ){` |
|    58181 | 3673 | `					if( apImpl[i] == pStringable ){` |
|    11641 | 3674 | `						bAlready = 1;` |
|    11641 | 3675 | `						break;` |
|        - | 3676 | `					}` |
|    23275 | 3677 | `				}` |
|   217281 | 3678 | `				if( !bAlready ){` |
|   205645 | 3679 | `					PH7_ClassImplement(pClass,pStringable);` |
|   102820 | 3680 | `				}` |
|   108638 | 3681 | `			}` |
|   108638 | 3682 | `		}` |
|        - | 3683 | `		/* Validate interface method signatures (visibility and parameter count) */` |
|   440123 | 3684 | `		if( rc == SXRET_OK ){` |
|   440123 | 3685 | `			sxi32 rcCheck = GenStateCheckInterfaceSignatures(&(*pGen),pClass);` |
|   440123 | 3686 | `			if( rcCheck == SXERR_ABORT ){` |
...
|   440123 | 3693 | `		if( rc == SXRET_OK ){` |
|   440123 | 3694 | `			sxi32 rcCheck = GenStateCheckAbstractMethods(&(*pGen),pClass);` |
|   440123 | 3695 | `			if( rcCheck == SXERR_ABORT ){` |
...
|   220059 | 3700 | `		}` |
|   220059 | 3701 | `	}` |
|   440123 | 3702 | `	SySetRelease(&aUseEntries);` |
|   440123 | 3703 | `	SySetRelease(&aInterfaces);` |
|   440123 | 3704 | `	if( rc != SXRET_OK ){` |
...
|   440165 | 3710 | `	pGen->pIn = &pEnd[1];` |
|   440165 | 3711 | `	pGen->pEnd = pTmp;` |
|   440165 | 3712 | `	return PH7_OK;` |
|   220089 | 3713 | `}` |
|        - | 3714 | `/* Compile a named class declaration (the common case). */` |
|   440138 | 3715 | `static sxi32 GenStateCompileClass(ph7_gen_state *pGen,sxi32 iFlags)` |
|        5 | 3716 | `{` |
|   440143 | 3717 | `	return GenStateCompileClassEx(pGen,iFlags,0,0,0);` |
|        5 | 3718 | `}` |
|        - | 3719 | `/*` |
...
|        - | 3818 | ` */` |
| 14427146 | 3819 | `static int GenStateTokenIsClassModifier(SyToken *pTok,sxi32 *piFlag)` |
|        5 | 3820 | `{` |
| 14427151 | 3821 | `	if( pTok->nType & PH7_TK_KEYWORD ){` |
|  8630465 | 3822 | `		sxu32 nKw = (sxu32)SX_PTR_TO_INT(pTok->pUserData);` |
|  8630465 | 3823 | `		if( nKw == PH7_TKWRD_FINAL ){ *piFlag = PH7_CLASS_FINAL; return TRUE; }` |
|  8576127 | 3824 | `		if( nKw == PH7_TKWRD_ABSTRACT ){ *piFlag = PH7_CLASS_ABSTRACT; return TRUE; }` |
|  4268618 | 3825 | `	}` |
| 14333927 | 3826 | `	if( GenStateIsReadonly(pTok) ){ *piFlag = PH7_CLASS_READONLY; return TRUE; }` |
| 14333867 | 3827 | `	return FALSE;` |
|  7213578 | 3828 | `}` |
|        - | 3829 | `/*` |
...
|        - | 3834 | ` */` |
| 14333862 | 3835 | `static sxi32 GenStateScanClassModifiers(SyToken **ppIn,SyToken *pEnd,SyToken **ppDup)` |
|        5 | 3836 | `{` |
| 14333867 | 3837 | `	SyToken *pIn = *ppIn,*pDup = 0;` |
| 14333867 | 3838 | `	sxi32 iFlags = 0,iFlag;` |
| 14427151 | 3839 | `	while( pIn < pEnd && GenStateTokenIsClassModifier(pIn,&iFlag) ){` |
|    93289 | 3840 | `		if( (iFlags & iFlag) && pDup == 0 ){` |
|        5 | 3841 | `			pDup = pIn;` |
|        2 | 3842 | `		}` |
|    93289 | 3843 | `		iFlags \|= iFlag;` |
|    93289 | 3844 | `		pIn++;` |
|        5 | 3845 | `	}` |
| 14333867 | 3846 | `	*ppIn = pIn;` |
| 14333867 | 3847 | `	if( ppDup ){ *ppDup = pDup; }` |
| 14333867 | 3848 | `	return iFlags;` |
|        5 | 3849 | `}` |
|        - | 3850 | `/*` |
...
|        - | 3856 | ` */` |
| 14291108 | 3857 | `PH7_PRIVATE int GenStateStartsModifiedClass(SyToken *pIn,SyToken *pEnd)` |
|        5 | 3858 | `{` |
| 14291113 | 3859 | `	sxi32 iFlags = GenStateScanClassModifiers(&pIn,pEnd,0);` |
|  7196071 | 3860 | `	return iFlags != 0 && pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD)` |
| 14316365 | 3861 | `		&& (sxu32)SX_PTR_TO_INT(pIn->pUserData) == PH7_TKWRD_CLASS;` |
|        5 | 3862 | `}` |
|        - | 3863 | `/*` |
...
|        - | 3869 | ` */` |
|    42754 | 3870 | `PH7_PRIVATE sxi32 PH7_CompileClassModifiers(ph7_gen_state *pGen)` |
|        5 | 3871 | `{` |
|        - | 3872 | `	SyToken *pDup;` |
|    42759 | 3873 | `	sxi32 iFlags = GenStateScanClassModifiers(&pGen->pIn,pGen->pEnd,&pDup);` |
|        - | 3874 | `	sxi32 rc;` |
|    42759 | 3875 | `	if( pDup ){` |
...
|        - | 3880 | `		}` |
|        1 | 3881 | `	}` |
|    42754 | 3882 | `	if( (iFlags & (PH7_CLASS_FINAL\|PH7_CLASS_ABSTRACT))` |
|    21382 | 3883 | `		== (PH7_CLASS_FINAL\|PH7_CLASS_ABSTRACT) ){` |
...
|        - | 3888 | `		}` |
|        1 | 3889 | `	}` |
|    42759 | 3890 | `	return GenStateCompileClass(&(*pGen),iFlags);` |
|    21382 | 3891 | `}` |
|        - | 3892 | `/*` |
...
|        - | 3897 | ` */` |
|     7854 | 3898 | `PH7_PRIVATE sxi32 PH7_CompileTrait(ph7_gen_state *pGen)` |
|        5 | 3899 | `{` |
|     7859 | 3900 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|     7859 | 3909 | `	pGen->pIn++;` |
|     7859 | 3910 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
...
|     7859 | 3921 | `	pName = &pGen->pIn->sData;` |
|     7859 | 3922 | `	pGen->pIn++;` |
|        - | 3923 | `	/* Build FQN and obtain a raw class */ {` |
|        - | 3924 | `		SyBlob sFQN;` |
|        - | 3925 | `		SyString sFQNStr;` |
|     7859 | 3926 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|     7859 | 3927 | `		GenStateBuildFQN(pGen,pName,&sFQN);` |
|     7859 | 3928 | `		SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|     7859 | 3929 | `		pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|     7859 | 3930 | `		SyBlobRelease(&sFQN);` |
|        - | 3931 | `	}` |
|     7859 | 3932 | `	if( pClass == 0 ){` |
|      ! 0 | 3933 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 3934 | `		return SXERR_ABORT;` |
|        - | 3935 | `	}` |
|     7859 | 3936 | `	GenStateConsumeDoc(&(*pGen),&pClass->sDoc);` |
|     7859 | 3937 | `	if( GenStateConsumeAttrs(&(*pGen),&pClass->aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 3938 | `		return SXERR_ABORT;` |
|        - | 3939 | `	}` |
|        - | 3940 | `	/* Traits cannot extend or implement; expect opening brace directly */` |
|     7859 | 3941 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_OCB) == 0 ){` |
...
|        - | 3948 | `	}` |
|     7859 | 3949 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|     7859 | 3950 | `	pEnd = 0;` |
|     7859 | 3951 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB,PH7_TK_CCB,&pEnd);` |
|     7859 | 3952 | `	if( pEnd >= pGen->pEnd ){` |
...
|     7859 | 3961 | `	pClass->nEndLine = pEnd->nLine;` |
|        - | 3962 | `	/* Swap token stream */` |
|     7859 | 3963 | `	pTmp = pGen->pEnd;` |
|     7859 | 3964 | `	pGen->pEnd = pEnd;` |
|        - | 3965 | `	/* Mark as trait (PH7_NewRawClass may have set INTERNAL) */` |
|     7859 | 3966 | `	pClass->iFlags \|= PH7_CLASS_TRAIT;` |
|        - | 3967 | `	/* Parse the body: same as a normal class (methods, attributes, visibility modifiers) */` |
|    56331 | 3968 | `	for(;;){` |
|   159261 | 3969 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|    23305 | 3970 | `			pGen->pIn++;` |
|        5 | 3971 | `		}` |
|   135961 | 3972 | `		if( pGen->pIn >= pGen->pEnd ){` |
|     7859 | 3973 | `			break;` |
|        - | 3974 | `		}` |
|        - | 3975 | `		/* Bind a directly-preceding docblock to this member */` |
|   128107 | 3976 | `		GenStateSetPendingDoc(&(*pGen));` |
|   128107 | 3977 | `		if( (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR)) == 0 ){` |
...
|      ! 0 | 3984 | `			goto done;` |
|        - | 3985 | `		}` |
|   128107 | 3986 | `		iProtection = PH7_TKWRD_PUBLIC;` |
|   128107 | 3987 | `		iAttrflags = 0;` |
|   128107 | 3988 | `		if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|   128107 | 3989 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   128107 | 3990 | `			if( nKwrd == PH7_TKWRD_USE ){` |
...
|        5 | 4031 | `				continue;` |
|        - | 4032 | `			}` |
|   128103 | 4033 | `			if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|   128085 | 4034 | `				iProtection = nKwrd;` |
|   128085 | 4035 | `				pGen->pIn++;` |
...
|   128085 | 4039 | `				if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|        5 | 4040 | `					iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|        5 | 4041 | `					pGen->pIn++; /* Jump the 'readonly' modifier */` |
|        2 | 4042 | `				}` |
|   128080 | 4043 | `				if( pGen->pIn >= pGen->pEnd` |
|   128085 | 4044 | `					\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|      ! 0 | 4051 | `					goto done;` |
|        - | 4052 | `				}` |
|   128085 | 4053 | `				if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|    23285 | 4054 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|    23285 | 4055 | `					if( rc != SXRET_OK ){` |
...
|    23285 | 4061 | `					continue;` |
|        - | 4062 | `				}` |
|   104805 | 4063 | `				if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|        9 | 4071 | `					continue;` |
|        - | 4072 | `				}` |
|   104797 | 4073 | `				nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    52396 | 4074 | `			}` |
|   104815 | 4075 | `			if( nKwrd == PH7_TKWRD_CONST ){` |
...
|      ! 0 | 4081 | `				goto done;` |
|      ! 0 | 4082 | `			}else{` |
|   104815 | 4083 | `				if( nKwrd == PH7_TKWRD_STATIC ){` |
|     7771 | 4084 | `					iAttrflags \|= PH7_CLASS_ATTR_STATIC;` |
|     7771 | 4085 | `					pGen->pIn++;` |
|     7771 | 4086 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|     7769 | 4087 | `						nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|     7769 | 4088 | `						if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|      ! 0 | 4089 | `							iProtection = nKwrd;` |
|      ! 0 | 4090 | `							pGen->pIn++;` |
|      ! 0 | 4091 | `						}` |
|     3882 | 4092 | `					}` |
|     7766 | 4093 | `					if( pGen->pIn >= pGen->pEnd` |
|     7771 | 4094 | `						\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|      ! 0 | 4101 | `						goto done;` |
|        - | 4102 | `					}` |
|     7771 | 4103 | `					if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
...
|        3 | 4111 | `						continue;` |
|        - | 4112 | `					}` |
|     7769 | 4113 | `					if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|      ! 0 | 4121 | `						continue;` |
|        - | 4122 | `					}` |
|     7769 | 4123 | `					nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   100931 | 4124 | `				}else if( nKwrd == PH7_TKWRD_ABSTRACT ){` |
...
|        3 | 4145 | `				}` |
|   104813 | 4146 | `				if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_VAR ){` |
...
|      ! 0 | 4153 | `					goto done;` |
|        - | 4154 | `				}` |
|   104813 | 4155 | `				if( nKwrd == PH7_TKWRD_VAR ){` |
|      ! 0 | 4156 | `					pGen->pIn++;` |
...
|      ! 0 | 4166 | `				}else{` |
|   104813 | 4167 | `					rc = GenStateCompileClassMethod(&(*pGen),iProtection,iAttrflags,TRUE,pClass);` |
|        - | 4168 | `				}` |
|   104813 | 4169 | `				if( rc != SXRET_OK ){` |
...
|     7859 | 4187 | `	if( GenStateGuardClassRedeclaration(pGen,pClass) == SXERR_ABORT ){` |
|        3 | 4188 | `		return SXERR_ABORT;` |
|        - | 4189 | `	}` |
|        - | 4190 | `	/* Install the trait */` |
|     7857 | 4191 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|     7857 | 4192 | `	if( rc != SXRET_OK ){` |
...
|     7857 | 4198 | `	pGen->pIn = &pEnd[1];` |
|     7857 | 4199 | `	pGen->pEnd = pTmp;` |
|     7857 | 4200 | `	return PH7_OK;` |
|     3932 | 4201 | `}` |
|        - | 4202 | `/*` |
...
|        - | 4210 | ` */` |
|   393470 | 4211 | `PH7_PRIVATE sxi32 PH7_CompileClass(ph7_gen_state *pGen)` |
|        5 | 4212 | `{` |
|        - | 4213 | `	sxi32 rc;` |
|   393475 | 4214 | `	rc = GenStateCompileClass(&(*pGen),0);` |
|   393475 | 4215 | `	return rc;` |
|        5 | 4216 | `}` |
|        - | 4217 | `/*` |
...
|        - | 4223 | ` */` |
| 14240598 | 4224 | `PH7_PRIVATE int GenStateStartsEnumDecl(SyToken *pIn,SyToken *pEnd)` |
|        5 | 4225 | `{` |
| 14456437 | 4226 | `	return (pIn->nType & PH7_TK_ID)` |
|  7336133 | 4227 | `		&& pIn->sData.nByte == sizeof("enum")-1` |
|   225671 | 4228 | `		&& SyStrnicmp(pIn->sData.zString,"enum",sizeof("enum")-1) == 0` |
| 14456432 | 4229 | `		&& &pIn[1] < pEnd && (pIn[1].nType & PH7_TK_ID);` |
|        5 | 4230 | `}` |
|        - | 4231 | `/*` |
...
|        - | 4236 | ` */` |
|     3914 | 4237 | `PH7_PRIVATE sxi32 PH7_CompileEnum(ph7_gen_state *pGen)` |
|        5 | 4238 | `{` |
|     3919 | 4239 | `	return GenStateCompileClass(&(*pGen),PH7_CLASS_ENUM\|PH7_CLASS_FINAL);` |
|        5 | 4240 | `}` |
|        - | 4241 |  |
