...
|        - |   26 | ` */` |
|   527688 |   27 | `static sxi32 GenStateGuardClassRedeclaration(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 |   28 | `{` |
|        - |   29 | `	SyHashEntry *pEntry;` |
|   527693 |   30 | `	if( !GenStateUnconditionalTopLevel(pGen) ){` |
|       26 |   31 | `		return SXRET_OK; /* conditional/nested: keep hoisting */` |
|        - |   32 | `	}` |
|   527671 |   33 | `	pClass->iFlags \|= PH7_CLASS_BOUND;` |
|   527671 |   34 | `	if( pGen->pVm->bCompilingBuiltin ){` |
|   525509 |   35 | `		return SXRET_OK; /* the prelude installs each builtin exactly once */` |
|        - |   36 | `	}` |
|     2167 |   37 | `	pEntry = SyHashGet(&pGen->pVm->hClass,(const void *)pClass->sName.zString,pClass->sName.nByte);` |
|     2167 |   38 | `	if( pEntry ){` |
...
|        - |   70 | ` */` |
|  3813118 |   71 | `static sxi32 GetProtectionLevel(sxi32 nKeyword)` |
|        5 |   72 | `{` |
|  3813123 |   73 | `	if( nKeyword == PH7_TKWRD_PRIVATE ){` |
|   278439 |   74 | `		return PH7_CLASS_PROT_PRIVATE;` |
|  3534689 |   75 | `	}else if( nKeyword == PH7_TKWRD_PROTECTED ){` |
|   220355 |   76 | `		return PH7_CLASS_PROT_PROTECTED;` |
|        - |   77 | `	}` |
|        - |   78 | `	/* Assume public by default */` |
|  3314339 |   79 | `	return PH7_CLASS_PROT_PUBLIC;` |
|  1906564 |   80 | `}` |
|        - |   81 | `/*` |
...
|        - |   88 | ` */` |
|   340240 |   89 | `static int GenStateClassConstHasType(ph7_gen_state *pGen)` |
|        5 |   90 | `{` |
|        - |   91 | `	SyToken *p0, *p1;` |
|   340245 |   92 | `	if( pGen->pIn >= pGen->pEnd ){` |
|      ! 0 |   93 | `		return 0;` |
|        - |   94 | `	}` |
|   340245 |   95 | `	p0 = pGen->pIn;` |
|        - |   96 | `	/* A leading '\' (namespaced class type) or '?' (nullable) always starts a type */` |
|   340245 |   97 | `	if( p0->nType & PH7_TK_NSSEP ){` |
|      ! 0 |   98 | `		return 1;` |
|        - |   99 | `	}` |
|   340245 |  100 | `	if( (p0->nType & PH7_TK_OP) && p0->sData.nByte == 1 && p0->sData.zString[0] == '?' ){` |
|        5 |  101 | `		return 1;` |
|        - |  102 | `	}` |
...
|   340241 |  106 | `	if( p0->nType & (PH7_TK_ID\|PH7_TK_KEYWORD) ){` |
|   340241 |  107 | `		p1 = (pGen->pIn + 1 < pGen->pEnd) ? (pGen->pIn + 1) : 0;` |
|   340241 |  108 | `		if( p1 ){` |
|   340241 |  109 | `			if( p1->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_NSSEP) ){` |
|       34 |  110 | `				return 1;` |
|        - |  111 | `			}` |
|   340211 |  112 | `			if( (p1->nType & PH7_TK_OP) && p1->sData.nByte == 1 && p1->sData.zString[0] == '\|' ){` |
|        5 |  113 | `				return 1;` |
|        - |  114 | `			}` |
|   170101 |  115 | `		}` |
|   170101 |  116 | `	}` |
...
|        - |  172 | ` */` |
|   719688 |  173 | `static int GenStateInitHasNewExpr(ph7_gen_state *pGen)` |
|        5 |  174 | `{` |
|   719693 |  175 | `	SyToken *p = pGen->pIn;` |
|   719693 |  176 | `	int iDepth = 0;` |
|  1900857 |  177 | `	while( p < pGen->pEnd ){` |
|  1900857 |  178 | `		if( iDepth == 0 && (p->nType & (PH7_TK_SEMI\|PH7_TK_COMMA)) ){` |
|   719641 |  179 | `			break; /* end of this initializer */` |
|        - |  180 | `		}` |
|  1181216 |  181 | `		if( (p->nType & PH7_TK_KEYWORD)` |
|   598361 |  182 | `			&& ( SX_PTR_TO_INT(p->pUserData) == PH7_TKWRD_FUNCTION` |
|    15495 |  183 | `				\|\| SX_PTR_TO_INT(p->pUserData) == PH7_TKWRD_FN ) ){` |
...
|        6 |  241 | `			continue;` |
|        - |  242 | `		}` |
|  1181217 |  243 | `		if( p->nType & PH7_TK_OCB ){` |
|       45 |  244 | `			if( iDepth == 0 ){` |
...
|        - |  250 | `			}` |
|      ! 0 |  251 | `			iDepth++;` |
|  1181173 |  252 | `		}else if( p->nType & (PH7_TK_LPAREN\|PH7_TK_OSB) ){` |
|    50337 |  253 | `			iDepth++;` |
|  1156007 |  254 | `		}else if( p->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB) ){` |
|    50335 |  255 | `			if( iDepth > 0 ){` |
|    50335 |  256 | `				iDepth--;` |
|    25165 |  257 | `			}` |
|  1105676 |  258 | `		}else if( (p->nType & PH7_TK_OP) && p->pUserData` |
|   389433 |  259 | `			&& ((const ph7_expr_op *)p->pUserData)->iOp == EXPR_OP_NEW ){` |
...
|        - |  277 | ` */` |
|  1268896 |  278 | `static ph7_class_attr * GenStateExtractConstant(ph7_class *pClass,SyString *pName)` |
|        5 |  279 | `{` |
|  1268901 |  280 | `	ph7_class_attr *pAttr = PH7_ClassExtractAttribute(pClass,pName->zString,pName->nByte);` |
|  1268901 |  281 | `	return ( pAttr && (pAttr->iFlags & PH7_CLASS_ATTR_CONSTANT) ) ? pAttr : 0;` |
|        5 |  282 | `}` |
|  1517180 |  283 | `static ph7_class_attr * GenStateExtractProperty(ph7_class *pClass,const char *zName,sxu32 nByte)` |
|        5 |  284 | `{` |
|  1517185 |  285 | `	ph7_class_attr *pAttr = PH7_ClassExtractAttribute(pClass,zName,nByte);` |
|  1517185 |  286 | `	return ( pAttr && (pAttr->iFlags & PH7_CLASS_ATTR_CONSTANT) == 0 ) ? pAttr : 0;` |
|        5 |  287 | `}` |
|        - |  288 | `/*` |
...
|        - |  308 | ` */` |
|   719738 |  309 | `PH7_PRIVATE int PH7_GenStateInitHasCallExpr(ph7_gen_state *pGen)` |
|        5 |  310 | `{` |
|   719743 |  311 | `	SyToken *p = pGen->pIn;` |
|   719743 |  312 | `	int iDepth = 0;` |
|        - |  313 | `	/* Conservative ternary bail-out (see the note above). */` |
|        - |  314 | `	{` |
|   719743 |  315 | `		SyToken *q = pGen->pIn;` |
|   719743 |  316 | `		int iQd = 0;` |
|  1902205 |  317 | `		while( q < pGen->pEnd ){` |
|  1902167 |  318 | `			if( iQd == 0 && (q->nType & (PH7_TK_SEMI\|PH7_TK_COMMA)) ){` |
|   719699 |  319 | `				break;` |
|        - |  320 | `			}` |
|  1182473 |  321 | `			if( q->nType & (PH7_TK_LPAREN\|PH7_TK_OSB\|PH7_TK_OCB) ){` |
|    50473 |  322 | `				iQd++;` |
|  1157239 |  323 | `			}else if( q->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB) ){` |
|    50473 |  324 | `				if( iQd > 0 ){ iQd--; }` |
|  1106771 |  325 | `			}else if( (q->nType & PH7_TK_OP) && q->pUserData` |
|   389659 |  326 | `				&& ((const ph7_expr_op *)q->pUserData)->iOp == EXPR_OP_QUESTY ){` |
|        8 |  327 | `				return 0;` |
|        - |  328 | `			}` |
|  1182467 |  329 | `			q++;` |
|        5 |  330 | `		}` |
|        - |  331 | `	}` |
|  1901051 |  332 | `	while( p < pGen->pEnd ){` |
|  1901051 |  333 | `		if( iDepth == 0 && (p->nType & (PH7_TK_SEMI\|PH7_TK_COMMA)) ){` |
|   719693 |  334 | `			break; /* end of this initializer */` |
|        - |  335 | `		}` |
|  1181358 |  336 | `		if( (p->nType & PH7_TK_KEYWORD)` |
|   598432 |  337 | `			&& ( SX_PTR_TO_INT(p->pUserData) == PH7_TKWRD_FUNCTION` |
|    15495 |  338 | `				\|\| SX_PTR_TO_INT(p->pUserData) == PH7_TKWRD_FN ) ){` |
...
|        6 |  388 | `			continue;` |
|        - |  389 | `		}` |
|  1181359 |  390 | `		if( p->nType & PH7_TK_OCB ){` |
|       43 |  391 | `			if( iDepth == 0 ){` |
|       43 |  392 | `				break; /* property-hook list: the default expression ends here */` |
|        - |  393 | `			}` |
|      ! 0 |  394 | `			iDepth++;` |
|  1181317 |  395 | `		}else if( p->nType & (PH7_TK_LPAREN\|PH7_TK_OSB) ){` |
...
|    50352 |  399 | `			if( (p->nType & PH7_TK_LPAREN) && p > pGen->pIn` |
|    15486 |  400 | `				&& (p[-1].nType & PH7_TK_ID)` |
|     7755 |  401 | `				&& !((p[-1].nType & PH7_TK_OP) && p[-1].pUserData` |
...
|        6 |  421 | `			}` |
|    50355 |  422 | `			iDepth++;` |
|  1156140 |  423 | `		}else if( p->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB) ){` |
|    50355 |  424 | `			if( iDepth > 0 ){` |
|    50355 |  425 | `				iDepth--;` |
|    25175 |  426 | `			}` |
|    25175 |  427 | `		}` |
|  1181315 |  428 | `		p++;` |
...
|        - |  439 | ` */` |
|    15850 |  440 | `static void GenStateCopyTypeToAttr(ph7_class_attr *pAttr,sxu32 nType,` |
|        - |  441 | `	const SyString *pClass,const SyString *pTypeName,sxi32 iTypeFlags,SySet *pAlts)` |
|        5 |  442 | `{` |
|    15855 |  443 | `	pAttr->nType = nType;` |
|    15855 |  444 | `	pAttr->sClass = *pClass;` |
|    15855 |  445 | `	pAttr->sTypeName = *pTypeName;` |
|    15855 |  446 | `	if( iTypeFlags & PH7_CLASS_ATTR_UNION ){` |
|        - |  447 | `		sxu32 i;` |
...
|       11 |  452 | `	}` |
|    15855 |  453 | `}` |
|   340240 |  454 | `static sxi32 GenStateCompileClassConstant(ph7_gen_state *pGen,sxi32 iProtection,sxi32 iFlags,ph7_class *pClass)` |
|        5 |  455 | `{` |
|   340245 |  456 | `	sxu32 nLine = pGen->pIn->nLine;` |
|        - |  457 | `	SySet *pInstrContainer;` |
|        - |  458 | `	ph7_class_attr *pCons;` |
|        - |  459 | `	SyString *pName;` |
|        - |  460 | `	sxi32 rc;` |
|   340245 |  461 | `	sxu32 nType = 0;` |
|        - |  462 | `	SyString sTypeClass;` |
|        - |  463 | `	SyString sTypeText;` |
|        - |  464 | `	SySet aUnionAlts;` |
|   340245 |  465 | `	sxi32 iTypeFlags = 0;` |
|   340245 |  466 | `	SyStringInitFromBuf(&sTypeClass,0,0);` |
|   340245 |  467 | `	SyStringInitFromBuf(&sTypeText,0,0);` |
|   340245 |  468 | `	SySetInit(&aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|        - |  469 | `	/* Extract visibility level */` |
|   340245 |  470 | `	iProtection = GetProtectionLevel(iProtection);` |
|        - |  471 | `	/* Mark as constant */` |
|   340245 |  472 | `	iFlags \|= PH7_CLASS_ATTR_CONSTANT;` |
|   340245 |  473 | `	pGen->pIn++; /* Jump the 'const' keyword */` |
...
|   340264 |  476 | `	if( GenStateClassConstHasType(pGen) ){` |
...
|       19 |  497 | `	}` |
|   170120 |  498 | `loop:` |
|   340247 |  499 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
...
|   340247 |  509 | `	pName = &pGen->pIn->sData;` |
|        - |  510 | `	/* Make sure the constant name isn't reserved */` |
|   340247 |  511 | `	if( GenStateIsReservedConstant(pName) ){` |
...
|   340247 |  521 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
...
|   340245 |  532 | `	pGen->pIn++;` |
|   340245 |  533 | `	if(pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_EQUAL /* '=' */) == 0 ){` |
...
|        - |  541 | `	}` |
|   340245 |  542 | `	pGen->pIn++; /* Jump the equal sign */` |
...
|   340240 |  547 | `	if( (iTypeFlags & PH7_CLASS_ATTR_TYPED) && !(iTypeFlags & PH7_CLASS_ATTR_UNION)` |
...
|   340241 |  559 | `	if( PH7_GenStateInitHasCallExpr(pGen) ){` |
...
|   340241 |  570 | `	if( GenStateInitHasNewExpr(pGen) ){` |
...
|   340232 |  586 | `	if( GenStateExtractConstant(pClass,pName) == 0` |
|   340237 |  587 | `	 && GenStateExtractProperty(pClass,pName->zString,pName->nByte) != 0 ){` |
...
|        - |  595 | `	}` |
|   340237 |  596 | `	if( GenStateExtractConstant(pClass,pName) != 0 ){` |
...
|   340237 |  605 | `	pCons = PH7_NewClassAttr(pGen->pVm,pName,nLine,iProtection,iFlags\|iTypeFlags);` |
|   340237 |  606 | `	if( pCons ){` |
|   340237 |  607 | `		GenStateConsumeDoc(&(*pGen),&pCons->sDoc);` |
|   340237 |  608 | `		if( GenStateConsumeAttrs(&(*pGen),&pCons->aAttrs) == SXERR_ABORT ){` |
|      ! 0 |  609 | `			return SXERR_ABORT;` |
|        - |  610 | `		}` |
|   170116 |  611 | `	}` |
|   340237 |  612 | `	if( pCons == 0 ){` |
|      ! 0 |  613 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 |  614 | `		return SXERR_ABORT;` |
|        - |  615 | `	}` |
|   340237 |  616 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|       35 |  617 | `		GenStateCopyTypeToAttr(pCons,nType,&sTypeClass,&sTypeText,iTypeFlags,&aUnionAlts);` |
|       16 |  618 | `	}` |
|        - |  619 | `	/* Swap bytecode container */` |
|   340237 |  620 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   340237 |  621 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pCons->aByteCode);` |
|        - |  622 | `	/* Compile constant value.` |
|        - |  623 | `	 */` |
|   340237 |  624 | `	rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|   340237 |  625 | `	if( rc == SXERR_EMPTY ){` |
...
|   340237 |  632 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|   340237 |  633 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|   340237 |  634 | `	if( rc == SXERR_ABORT ){` |
...
|   340237 |  639 | `	rc = PH7_ClassInstallAttr(pClass,pCons);` |
|   340237 |  640 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  641 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 |  642 | `		return SXERR_ABORT;` |
|        - |  643 | `	}` |
|   340237 |  644 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA /*','*/) ){` |
...
|        - |  662 | `		}` |
|      ! 0 |  663 | `	}` |
|   340235 |  664 | `	SySetRelease(&aUnionAlts);` |
|   340235 |  665 | `	return SXRET_OK;` |
|        5 |  666 | `Synchronize:` |
...
|        - |  702 | ` */` |
|  2610186 |  703 | `static int GenStateLooksLikeTypedProperty(SyToken *pStart,SyToken *pEnd)` |
|        5 |  704 | `{` |
|  2610191 |  705 | `	SyToken *p = pStart;` |
|  2610191 |  706 | `	int bFirst = 1;` |
|  2610191 |  707 | `	if( p >= pEnd ) return 0;` |
|        - |  708 | ``	/* Optional nullable `?` shorthand. */`` |
|  2610191 |  709 | `	if( (p->nType & PH7_TK_OP) && p->sData.nByte == 1 && p->sData.zString[0] == '?' ){` |
|       41 |  710 | `		p++;` |
...
|  1305093 |  717 | `	for(;;){` |
|  2610211 |  718 | `		if( p < pEnd && (p->nType & PH7_TK_LPAREN) ){` |
...
|  2610209 |  727 | `			if( p < pEnd && (p->nType & PH7_TK_NSSEP) ){ p++; }` |
|  2610209 |  728 | `			if( p >= pEnd \|\| (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|      ! 0 |  729 | `				return 0;` |
|        - |  730 | `			}` |
...
|  2610209 |  734 | `			if( bFirst && (p->nType & PH7_TK_KEYWORD) ){` |
|  2610153 |  735 | `				sxu32 k = (sxu32)(SX_PTR_TO_INT(p->pUserData));` |
|  2610148 |  736 | `				if( k == PH7_TKWRD_FUNCTION \|\| k == PH7_TKWRD_VAR \|\| k == PH7_TKWRD_CONST` |
|   124150 |  737 | `				 \|\| k == PH7_TKWRD_STATIC \|\| k == PH7_TKWRD_FINAL \|\| k == PH7_TKWRD_ABSTRACT ){` |
|  2594379 |  738 | `					return 0;` |
|        - |  739 | `				}` |
|     7887 |  740 | `			}` |
|    15835 |  741 | `			p++;` |
|    15837 |  742 | `			while( p + 1 < pEnd && (p->nType & PH7_TK_NSSEP) && (p[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|        3 |  743 | `				p += 2;` |
|        1 |  744 | `			}` |
|    23748 |  745 | `			while( p + 1 < pEnd && (p->nType & PH7_TK_AMPER)` |
|    15838 |  746 | `				&& (p[1].nType & (PH7_TK_NSSEP\|PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|        3 |  747 | `				p++; /* skip '&' */` |
...
|        - |  755 | `		}` |
|    15837 |  756 | `		bFirst = 0;` |
|    15832 |  757 | `		if( p < pEnd && (p->nType & PH7_TK_OP) && p->sData.nByte == 1` |
...
|    15817 |  762 | `		break;` |
|      ! 0 |  763 | `	}` |
|    15817 |  764 | `	if( p >= pEnd ) return 0;` |
|    15817 |  765 | `	return (p->nType & PH7_TK_DOLLAR) ? 1 : 0;` |
|  1305098 |  766 | `}` |
|        - |  767 |  |
|        - |  768 | `/*` |
...
|        - |  785 | ` */` |
|    15822 |  786 | `static sxi32 GenStateParsePropertyType(` |
...
|        - |  792 | `	SySet *pAlts` |
|        5 |  793 | `){` |
|    15827 |  794 | `	sxi32 iFlags = 0;` |
|        - |  795 | `	sxi32 rc;` |
|    15827 |  796 | `	if( pGen->pIn >= pGen->pEnd ){` |
|      ! 0 |  797 | `		return SXRET_OK;` |
|        - |  798 | `	}` |
|        - |  799 | `	/* If the first token is '$', there's no type */` |
|    15827 |  800 | `	if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|      ! 0 |  801 | `		return SXRET_OK;` |
|        - |  802 | `	}` |
|    15827 |  803 | `	rc = GenStateParseUnionTypeDecl(` |
|     7911 |  804 | `		pGen, pnType, pClass, pAlts, &iFlags, pTypeText,` |
|        - |  805 | `		PH7_CLASS_ATTR_NULLABLE,` |
|        - |  806 | `		PH7_CLASS_ATTR_UNION,` |
|        - |  807 | `		/* bAllowVoid */ 0,` |
|    15822 |  808 | `		pGen->pIn->nLine);` |
|    15827 |  809 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  810 | `		return rc;` |
|        - |  811 | `	}` |
|        - |  812 | `	/* Verify next token is '$' (start of property name) */` |
|    15827 |  813 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
|      ! 0 |  814 | `		return SXERR_SYNTAX;` |
|        - |  815 | `	}` |
|    15827 |  816 | `	*piTypeFlags = iFlags \| PH7_CLASS_ATTR_TYPED;` |
|    15827 |  817 | `	return SXRET_OK;` |
|     7916 |  818 | `}` |
|        - |  819 |  |
|        - |  820 | `/*` |
...
|        - |  830 | ` */` |
|    16000 |  831 | `static int GenStateIsDisallowedPropertyAtom(` |
|        - |  832 | `	sxu32 nType,` |
...
|        - |  837 | `	const char *z;` |
|        - |  838 | `	sxu32 n;` |
|    16005 |  839 | `	if( nType != SXU32_HIGH \|\| pClass == 0 \|\| pClass->nByte == 0 ){` |
|    15939 |  840 | `		return 0;` |
|        - |  841 | `	}` |
...
|        - |  863 | ` */` |
|    15938 |  864 | `PH7_PRIVATE sxi32 GenStateValidateMemberType(` |
...
|        - |  873 | `	sxu32 nLine)` |
|        5 |  874 | `{` |
|    15943 |  875 | `	const char *zBad = 0;` |
|    15943 |  876 | `	sxu32 nBad = 0;` |
|        - |  877 | `	SyString sFallback;` |
|        - |  878 | `	const SyString *pBad;` |
|        - |  879 | `	sxi32 rc;` |
|    15943 |  880 | `	int bDisallowed = 0;` |
|    15943 |  881 | `	if( GenStateIsDisallowedPropertyAtom(nType,pTypeClass,&zBad,&nBad) ){` |
|        5 |  882 | `		bDisallowed = 1;` |
|    15941 |  883 | `	}else if( pUnionAlts ){` |
|        - |  884 | `		sxu32 i;` |
...
|       34 |  891 | `		}` |
|       15 |  892 | `	}` |
|    15943 |  893 | `	if( !bDisallowed ){` |
|    15937 |  894 | `		return SXRET_OK;` |
|        - |  895 | `	}` |
...
|        - |  918 | ` */` |
| 23425942 |  919 | `PH7_PRIVATE int GenStateIsReadonly(SyToken *pTok)` |
|        5 |  920 | `{` |
| 23650990 |  921 | `	return (pTok->nType & PH7_TK_ID)` |
| 11938014 |  922 | `		&& pTok->sData.nByte == sizeof("readonly")-1` |
| 23650985 |  923 | `		&& SyStrnicmp(pTok->sData.zString,"readonly",sizeof("readonly")-1) == 0;` |
|        5 |  924 | `}` |
|        - |  925 | `/*` |
...
|        - |  930 | ` */` |
|  8411940 |  931 | `PH7_PRIVATE sxi32 GenStatePeekSetVisibility(SyToken *pTok,SyToken *pEnd,int *pnTok)` |
|        5 |  932 | `{` |
|  8411945 |  933 | `	*pnTok = 0;` |
|  8411940 |  934 | `	if( &pTok[3] < pEnd` |
|  7864330 |  935 | `	 && (pTok->nType & PH7_TK_KEYWORD)` |
|  6413690 |  936 | `	 && (pTok[1].nType & PH7_TK_LPAREN)` |
|  2755338 |  937 | `	 && (pTok[2].nType & (PH7_TK_ID\|PH7_TK_KEYWORD))` |
...
|        9 |  959 | `}` |
|   588442 |  960 | `static sxi32 GenStateCompileClassAttr(ph7_gen_state *pGen,sxi32 iProtection,sxi32 iFlags,ph7_class *pClass)` |
|        5 |  961 | `{` |
|   588447 |  962 | `	sxu32 nLine = pGen->pIn->nLine;` |
|        - |  963 | `	ph7_class_attr *pAttr;` |
|        - |  964 | `	SyString *pName;` |
|        - |  965 | `	sxi32 rc;` |
|   588447 |  966 | `	sxu32 nType = 0;` |
|        - |  967 | `	SyString sTypeClass;` |
|        - |  968 | `	SyString sTypeText;` |
|        - |  969 | `	SySet aUnionAlts;` |
|   588447 |  970 | `	sxi32 iTypeFlags = 0;` |
|   588447 |  971 | `	SyStringInitFromBuf(&sTypeClass,0,0);` |
|   588447 |  972 | `	SyStringInitFromBuf(&sTypeText,0,0);` |
|   588447 |  973 | `	SySetInit(&aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
...
|   588447 |  977 | `	if( pClass->iFlags & PH7_CLASS_READONLY ){` |
|       21 |  978 | `		iFlags \|= PH7_CLASS_ATTR_READONLY;` |
|        9 |  979 | `	}` |
|        - |  980 | `	/* Extract visibility level */` |
|   588447 |  981 | `	iProtection = GetProtectionLevel(iProtection);` |
|        - |  982 | `	/* Parse optional type hint (typed properties, PHP 7.4+) */` |
|   596358 |  983 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
|    15827 |  984 | `		rc = GenStateParsePropertyType(pGen,&nType,&sTypeClass,&iTypeFlags,&sTypeText,&aUnionAlts);` |
|    15827 |  985 | `		if( rc == SXERR_CORRUPT ){` |
|        - |  986 | `			/* Error already reported by GenStateParseUnionTypeDecl */` |
|      ! 0 |  987 | `			goto Synchronize;` |
|    15827 |  988 | `		}else if( rc == SXERR_SYNTAX ){` |
...
|    15827 |  996 | `		}else if( rc == SXERR_ABORT ){` |
|      ! 0 |  997 | `			return SXERR_ABORT;` |
|        - |  998 | `		}` |
|     7911 |  999 | `	}` |
|      ! 0 | 1000 | `loop:` |
|   588451 | 1001 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
...
|        - | 1007 | `	}` |
|   588451 | 1008 | `	pGen->pIn++; /* Jump the dollar sign */` |
|   588451 | 1009 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_ID)) == 0 ){` |
...
|   588451 | 1019 | `	pName = &pGen->pIn->sData;` |
|        - | 1020 | `	/* Advance the stream cursor */` |
|   588451 | 1021 | `	pGen->pIn++;` |
|   588451 | 1022 | `	if(pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_EQUAL/*'='*/\|PH7_TK_SEMI/*';'*/\|PH7_TK_COMMA/*','*/\|PH7_TK_OCB/*'{' hooks*/)) == 0 ){` |
...
|   588449 | 1034 | `	if( iFlags & (PH7_CLASS_ATTR_PRIVATE_SET\|PH7_CLASS_ATTR_PROTECTED_SET\|PH7_CLASS_ATTR_PUBLIC_SET) ){` |
...
|   588449 | 1054 | `	if( iFlags & PH7_CLASS_ATTR_READONLY ){` |
...
|   588439 | 1074 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|    23735 | 1075 | `		rc = GenStateValidateMemberType(pGen,pClass,pName,nType,&sTypeClass,` |
|        - | 1076 | `			&sTypeText,` |
|    15820 | 1077 | `			(iTypeFlags & PH7_CLASS_ATTR_UNION) ? &aUnionAlts : 0,` |
|     7910 | 1078 | `			"Property %z::$%z cannot have type %z",nLine);` |
|    15825 | 1079 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 | 1080 | `			return SXERR_ABORT;` |
|    15825 | 1081 | `		}else if( rc != SXRET_OK ){` |
...
|   588434 | 1088 | `	if( GenStateExtractProperty(pClass,pName->zString,pName->nByte) == 0` |
|   588438 | 1089 | `	 && GenStateExtractConstant(pClass,pName) != 0 ){` |
...
|        - | 1097 | `	}` |
|   588439 | 1098 | `	if( GenStateExtractProperty(pClass,pName->zString,pName->nByte) != 0 ){` |
...
|   588437 | 1113 | `	if( (pGen->pIn->nType & PH7_TK_EQUAL /*'='*/) && PH7_GenStateInitHasCallExpr(pGen) ){` |
...
|        - | 1120 | `	}` |
|   588437 | 1121 | `	if( (pGen->pIn->nType & PH7_TK_EQUAL /*'='*/) && GenStateInitHasNewExpr(pGen) ){` |
...
|   588433 | 1130 | `	pAttr = PH7_NewClassAttr(pGen->pVm,pName,nLine,iProtection,iFlags\|iTypeFlags);` |
|   588433 | 1131 | `	if( pAttr ){` |
|   588433 | 1132 | `		GenStateConsumeDoc(&(*pGen),&pAttr->sDoc);` |
|   588433 | 1133 | `		if( GenStateConsumeAttrs(&(*pGen),&pAttr->aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 1134 | `			return SXERR_ABORT;` |
|        - | 1135 | `		}` |
|   294214 | 1136 | `	}` |
|   588433 | 1137 | `	if( pAttr == 0 ){` |
|      ! 0 | 1138 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 engine is running out of memory");` |
|      ! 0 | 1139 | `		return SXERR_ABORT;` |
|        - | 1140 | `	}` |
|   588433 | 1141 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|    15823 | 1142 | `		GenStateCopyTypeToAttr(pAttr,nType,&sTypeClass,&sTypeText,iTypeFlags,&aUnionAlts);` |
|     7909 | 1143 | `	}` |
|   588433 | 1144 | `	if( pGen->pIn->nType & PH7_TK_EQUAL /*'='*/ ){` |
|        - | 1145 | `		SySet *pInstrContainer;` |
|   379453 | 1146 | `		SyToken *pSavedDefEnd = pGen->pEnd;` |
|   379453 | 1147 | `		pGen->pIn++; /*Jump the equal sign */` |
|        - | 1148 | `		{` |
...
|   379453 | 1153 | `			SyToken *pScan = pGen->pIn;` |
|   379453 | 1154 | `			sxi32 iNest = 0;` |
|   836811 | 1155 | `			while( pScan < pGen->pEnd ){` |
|   836811 | 1156 | `				if( pScan->nType & (PH7_TK_LPAREN\|PH7_TK_OSB) ){` |
|    50325 | 1157 | `					iNest++;` |
|   811651 | 1158 | `				}else if( pScan->nType & (PH7_TK_RPAREN\|PH7_TK_CSB) ){` |
|    50325 | 1159 | `					iNest--;` |
|   761331 | 1160 | `				}else if( iNest <= 0 && (pScan->nType & (PH7_TK_SEMI\|PH7_TK_COMMA\|PH7_TK_OCB)) ){` |
|   379453 | 1161 | `					break;` |
|        - | 1162 | `				}` |
|   457363 | 1163 | `				pScan++;` |
|        5 | 1164 | `			}` |
|   379453 | 1165 | `			pGen->pEnd = pScan;` |
|        - | 1166 | `		}` |
|        - | 1167 | `		/* Swap bytecode container */` |
|   379453 | 1168 | `		pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   379453 | 1169 | `		PH7_VmSetByteCodeContainer(pGen->pVm,&pAttr->aByteCode);` |
|        - | 1170 | `		/* Compile attribute value.` |
|        - | 1171 | `		 */` |
|   379453 | 1172 | `		rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|   379453 | 1173 | `		if( rc == SXERR_EMPTY ){` |
...
|   379453 | 1180 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|   379453 | 1181 | `		PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|   379453 | 1182 | `		pGen->pIn = pGen->pEnd;   /* land exactly on the delimiter */` |
|   379453 | 1183 | `		pGen->pEnd = pSavedDefEnd;` |
|   189724 | 1184 | `	}` |
|        - | 1185 | `	/* All done,install the attribute */` |
|   588433 | 1186 | `	rc = PH7_ClassInstallAttr(pClass,pAttr);` |
|   588433 | 1187 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 1188 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 1189 | `		return SXERR_ABORT;` |
|        - | 1190 | `	}` |
|   588433 | 1191 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) ){` |
...
|        - | 1203 | `	}` |
|   588339 | 1204 | `	if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
...
|        - | 1215 | `	}` |
|   588339 | 1216 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA /*','*/) ){` |
...
|        - | 1234 | `		}` |
|      ! 0 | 1235 | `	}` |
|   588335 | 1236 | `	SySetRelease(&aUnionAlts);` |
|   588335 | 1237 | `	return SXRET_OK;` |
|        9 | 1238 | `Synchronize:` |
...
|        - | 1253 | ` */` |
|  2884436 | 1254 | `static sxi32 GenStateCompileClassMethod(` |
...
|        - | 1260 | `	)` |
|        5 | 1261 | `{` |
|  2884441 | 1262 | `	sxu32 nLine = pGen->pIn->nLine;` |
|  2884441 | 1263 | `	sxu32 nKwLine = nLine; /* Line of the 'function' keyword (Reflection getStartLine) */` |
...
|  2884441 | 1270 | `	iProtection = GetProtectionLevel(iProtection);` |
|  2884441 | 1271 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|  2884441 | 1272 | `	iFuncFlags = 0;` |
|  2884441 | 1273 | `	if( pGen->pIn >= pGen->pEnd ){` |
...
|        - | 1281 | `	}` |
|  2884441 | 1282 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|        - | 1283 | `		/* Return by reference,remember that */` |
|      ! 0 | 1284 | `		iFuncFlags \|= VM_FUNC_REF_RETURN;` |
|        - | 1285 | `		/* Jump the '&' token */` |
|      ! 0 | 1286 | `		pGen->pIn++;` |
|      ! 0 | 1287 | `	}` |
|  2884441 | 1288 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|  2884441 | 1297 | `	pName = &pGen->pIn->sData;` |
|  2884441 | 1298 | `	nLine = pGen->pIn->nLine;` |
|        - | 1299 | `	/* Jump the method name */` |
|  2884441 | 1300 | `	pGen->pIn++;` |
|  2884441 | 1301 | `	if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|        - | 1302 | `		/* Abstract method */` |
|   139185 | 1303 | `		if( iProtection == PH7_CLASS_PROT_PRIVATE ){` |
...
|   139185 | 1312 | `		doBody = FALSE;` |
|    69590 | 1313 | `	}` |
|  2884441 | 1314 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|        - | 1315 | `		/* Syntax error */` |
...
|  2884441 | 1324 | `	pMeth = PH7_NewClassMethod(pGen->pVm,pClass,pName,nLine,iProtection,iFlags,iFuncFlags);` |
|  2884441 | 1325 | `	if( pMeth == 0 ){` |
|      ! 0 | 1326 | `		PH7_GenCompileError(&(*pGen),E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 1327 | `		return SXERR_ABORT;` |
|        - | 1328 | `	}` |
|  2884441 | 1329 | `	pMeth->sFunc.nLine = nKwLine;` |
|  2884441 | 1330 | `	GenStateConsumeDoc(&(*pGen),&pMeth->sFunc.sDoc);` |
|  2884441 | 1331 | `	if( GenStateConsumeAttrs(&(*pGen),&pMeth->sFunc.aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 1332 | `		return SXERR_ABORT;` |
|        - | 1333 | `	}` |
|        - | 1334 | `	/* Jump the left parenthesis '(' */` |
|  2884441 | 1335 | `	pGen->pIn++;` |
|  2884441 | 1336 | `	pEnd = 0; /* cc warning */` |
|        - | 1337 | `	/* Delimit the method signature */` |
|  2884441 | 1338 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|  2884441 | 1339 | `	if( pEnd >= pGen->pEnd ){` |
|        - | 1340 | `		/* Syntax error */` |
...
|        - | 1347 | `	}` |
|        - | 1348 | `	{` |
|  2884439 | 1349 | `		int bIsCtor = 0;` |
|  2884439 | 1350 | `		int bAbstractCtor = 0;` |
|  2884434 | 1351 | `		if( (pName->nByte == sizeof("__construct") - 1` |
|  1693548 | 1352 | `				&& SyMemcmp(pName->zString,"__construct",sizeof("__construct") - 1) == 0)` |
|  2781930 | 1353 | `		 \|\| SyStringCmp(pName,&pClass->sName,SyMemcmp) == 0 ){` |
|   205023 | 1354 | `			if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|        3 | 1355 | `				bAbstractCtor = 1;` |
|        2 | 1356 | `			}else{` |
|   205021 | 1357 | `				bIsCtor = 1;` |
|        - | 1358 | `			}` |
|   102509 | 1359 | `		}` |
|  2884439 | 1360 | `		if( pGen->pIn < pEnd ){` |
|        - | 1361 | `			/* Collect method arguments */` |
|  1109713 | 1362 | `			rc = GenStateCollectFuncArgs(&pMeth->sFunc,&(*pGen),pEnd,bIsCtor,bAbstractCtor);` |
|  1109713 | 1363 | `			if( rc == SXERR_ABORT ){` |
|      ! 0 | 1364 | `				return SXERR_ABORT;` |
|        - | 1365 | `			}` |
|   554854 | 1366 | `		}` |
|        - | 1367 | `	}` |
|        - | 1368 | `	/* Point past ')' and parse optional return type ': type' */` |
|  2884439 | 1369 | `	pGen->pIn = &pEnd[1];` |
|        - | 1370 | `	{` |
|  2884439 | 1371 | `		sxi32 rcRt = GenStateParseReturnType(pGen, &pMeth->sFunc);` |
|  2884439 | 1372 | `		if( rcRt == SXERR_ABORT ){` |
|      ! 0 | 1373 | `			return SXERR_ABORT;` |
|  2884439 | 1374 | `		}else if( rcRt == SXERR_SYNTAX ){` |
...
|        - | 1381 | `	{` |
|  2884439 | 1382 | `		sxu32 nArg = SySetUsed(&pMeth->sFunc.aArgs);` |
|        - | 1383 | `		sxu32 i;` |
|  4543029 | 1384 | `		for( i = 0; i < nArg; i++ ){` |
|  1658605 | 1385 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pMeth->sFunc.aArgs,i);` |
|        - | 1386 | `			ph7_class_attr *pAttr;` |
|  1658605 | 1387 | `			sxi32 iAttrFlags = 0;` |
|        - | 1388 | `			int bArgTyped;` |
|  1658605 | 1389 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|  1658519 | 1390 | `				continue;` |
|        - | 1391 | `			}` |
...
|       43 | 1486 | `		}` |
|        - | 1487 | `	}` |
|  2884429 | 1488 | `	if( doBody ){` |
|        - | 1489 | `		/* Compile method body */` |
|  2745249 | 1490 | `		rc = GenStateCompileFuncBody(&(*pGen),&pMeth->sFunc);` |
|  2745249 | 1491 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 | 1492 | `			return SXERR_ABORT;` |
|        - | 1493 | `		}` |
|        - | 1494 | `		/* The cursor sits just past the body's closing brace */` |
|  2745249 | 1495 | `		pMeth->sFunc.nEndLine = pGen->pIn[-1].nLine;` |
|  1372627 | 1496 | `	}else{` |
|        - | 1497 | `		/* Abstract/interface method: declaration ends at the ';' */` |
|   139185 | 1498 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI /* ';'*/) ){` |
|   139185 | 1499 | `			pMeth->sFunc.nEndLine = pGen->pIn->nLine;` |
|    69590 | 1500 | `		}` |
|        - | 1501 | `		/* Only method signature is allowed */` |
|   139185 | 1502 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI /* ';'*/) == 0 ){` |
...
|  2884424 | 1517 | `	if( (pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT)` |
|  1511807 | 1518 | `	 && (pClass->iFlags & (PH7_CLASS_ABSTRACT\|PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT)) == 0 ){` |
...
|  2884427 | 1531 | `	if( PH7_ClassExtractMethod(pClass,pName->zString,pName->nByte) != 0 ){` |
...
|  2884423 | 1540 | `	rc = PH7_ClassInstallMethod(pClass,pMeth);` |
|  2884423 | 1541 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 1542 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 1543 | `		return SXERR_ABORT;` |
|        - | 1544 | `	}` |
|  2884423 | 1545 | `	return SXRET_OK;` |
|        6 | 1546 | `Synchronize:` |
...
|        - | 2001 | ` */` |
|    69678 | 2002 | `PH7_PRIVATE sxi32 PH7_CompileClassInterface(ph7_gen_state *pGen)` |
|        5 | 2003 | `{` |
|    69683 | 2004 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|    69683 | 2013 | `	pName = &pGen->pIn->sData;` |
|        - | 2014 | `	/* Advance the stream cursor */` |
|    69683 | 2015 | `	pGen->pIn++;` |
|        - | 2016 | `	/* Build FQN and obtain a raw class */ {` |
|        - | 2017 | `		SyBlob sFQN;` |
|        - | 2018 | `		SyString sFQNStr;` |
|    69683 | 2019 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|    69683 | 2020 | `		GenStateBuildFQN(pGen,pName,&sFQN);` |
|    69683 | 2021 | `		SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|    69683 | 2022 | `		pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|    69683 | 2023 | `		SyBlobRelease(&sFQN);` |
|        - | 2024 | `	}` |
|    69683 | 2025 | `	if( pClass == 0 ){` |
|      ! 0 | 2026 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2027 | `		return SXERR_ABORT;` |
|        - | 2028 | `	}` |
|    69683 | 2029 | `	GenStateConsumeDoc(&(*pGen),&pClass->sDoc);` |
|    69683 | 2030 | `	if( GenStateConsumeAttrs(&(*pGen),&pClass->aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 2031 | `		return SXERR_ABORT;` |
|        - | 2032 | `	}` |
|        - | 2033 | `	/* Mark as an interface (PH7_NewRawClass may have set INTERNAL) */` |
|    69683 | 2034 | `	pClass->iFlags \|= PH7_CLASS_INTERFACE;` |
|        - | 2035 | `	/* Assume no base class is given */` |
|    69683 | 2036 | `	pBase = 0;` |
|    69683 | 2037 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|    27065 | 2038 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    27065 | 2039 | `		if( nKwrd == PH7_TKWRD_EXTENDS /* interface b extends a, c, … */ ){` |
...
|    27067 | 2050 | `				nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|    27067 | 2051 | `				SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|    27067 | 2052 | `				if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|        - | 2062 | `				}` |
|    40598 | 2063 | `				pParent = PH7_VmExtractClass(pGen->pVm,` |
|    27062 | 2064 | `					(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|    27067 | 2065 | `				SyStringInitFromBuf(&sBaseName,` |
|        - | 2066 | `					(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|        - | 2067 | `				/* Only interfaces is allowed */` |
|    27067 | 2068 | `				while( pParent && (pParent->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|      ! 0 | 2069 | `					pParent = pParent->pNextName;` |
|      ! 0 | 2070 | `				}` |
|    27067 | 2071 | `				if( pParent == 0 ){` |
...
|      ! 0 | 2077 | `					}` |
|    27067 | 2078 | `				}else if( pBase == 0 ){` |
|        - | 2079 | `					/* First parent → single-inheritance base */` |
|    27065 | 2080 | `					pBase = pParent;` |
|    13535 | 2081 | `				}else{` |
...
|        - | 2085 | `				}` |
|    27067 | 2086 | `				SyBlobRelease(&sResolved);` |
|        - | 2087 | `				/* Continue on a comma-separated list */` |
|    27067 | 2088 | `				if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA) ){` |
|        3 | 2089 | `					pGen->pIn++;` |
|        3 | 2090 | `					continue;` |
|        - | 2091 | `				}` |
|    27065 | 2092 | `				break;` |
...
|    13530 | 2094 | `		}` |
|    13530 | 2095 | `	}` |
|    69683 | 2096 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|        - | 2097 | `		/* Syntax error */` |
...
|        - | 2105 | `	}` |
|    69683 | 2106 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|    69683 | 2107 | `	pEnd = 0; /* cc warning */` |
|        - | 2108 | `	/* Delimit the interface body */` |
|    69683 | 2109 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|    69683 | 2110 | `	if( pEnd >= pGen->pEnd ){` |
|        - | 2111 | `		/* Syntax error */` |
...
|    69683 | 2121 | `	pClass->nEndLine = pEnd->nLine;` |
|        - | 2122 | `	/* Swap token stream */` |
|    69683 | 2123 | `	pTmp = pGen->pEnd;` |
|    69683 | 2124 | `	pGen->pEnd = pEnd;` |
...
|   440763 | 2132 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|   185543 | 2133 | `			pGen->pIn++;` |
|        5 | 2134 | `		}` |
|   255225 | 2135 | `		if( pGen->pIn >= pGen->pEnd ){` |
|        - | 2136 | `			/* End of interface body */` |
|    69679 | 2137 | `			break;` |
|        - | 2138 | `		}` |
|        - | 2139 | `		/* Bind a directly-preceding docblock to this member */` |
|   185551 | 2140 | `		GenStateSetPendingDoc(&(*pGen));` |
|   185551 | 2141 | `		if( (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|   185551 | 2152 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   185551 | 2153 | `		if( nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
...
|        3 | 2182 | `			goto done;` |
|        - | 2183 | `		}` |
|   185549 | 2184 | `		if( nKwrd != PH7_TKWRD_PUBLIC && nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|      ! 0 | 2191 | `			goto done;` |
|        - | 2192 | `		}` |
|   185549 | 2193 | `		if( nKwrd == PH7_TKWRD_PUBLIC ){` |
|        - | 2194 | `			/* Advance the stream cursor */` |
|   131435 | 2195 | `			pGen->pIn++;` |
|   131430 | 2196 | `			if( pGen->pIn < pGen->pEnd` |
|   131435 | 2197 | `			 && ((pGen->pIn->nType & PH7_TK_DOLLAR) != 0` |
|   131430 | 2198 | `			  \|\| (pGen->pIn->sData.nByte == 1 && pGen->pIn->sData.zString[0] == '?')) ){` |
...
|      ! 0 | 2212 | `				continue;` |
|        - | 2213 | `			}` |
|   131435 | 2214 | `			if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|      ! 0 | 2236 | `				goto done;` |
|        - | 2237 | `			}` |
|   131435 | 2238 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   131435 | 2239 | `			if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|        - | 2261 | `			}` |
|    65713 | 2262 | `		}` |
|   185545 | 2263 | `		if( nKwrd == PH7_TKWRD_CONST ){` |
|        - | 2264 | `			/* Parse constant */` |
|    54115 | 2265 | `			rc = GenStateCompileClassConstant(&(*pGen),0,0,pClass);` |
|    54115 | 2266 | `			if( rc != SXRET_OK ){` |
...
|        - | 2271 | `			}` |
|    27059 | 2272 | `		}else{` |
|   131435 | 2273 | `			sxi32 iFlags = PH7_CLASS_ATTR_ABSTRACT; /* Interface methods are implicitly abstract */` |
|   131435 | 2274 | `			if( nKwrd == PH7_TKWRD_STATIC ){` |
|        - | 2275 | `				/* Static method,record that */` |
|    11597 | 2276 | `				iFlags \|= PH7_CLASS_ATTR_STATIC;` |
|        - | 2277 | `				/* Advance the stream cursor */` |
|    11597 | 2278 | `				pGen->pIn++;` |
|    11592 | 2279 | `				if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0` |
|    11597 | 2280 | `					\|\| SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_FUNCTION ){` |
...
|   131435 | 2291 | `			rc = GenStateCompileClassMethod(&(*pGen),0,iFlags,FALSE,pClass);` |
|   131435 | 2292 | `			if( rc != SXRET_OK ){` |
...
|    69679 | 2301 | `	if( GenStateGuardClassRedeclaration(pGen,pClass) == SXERR_ABORT ){` |
|        3 | 2302 | `		return SXERR_ABORT;` |
|        - | 2303 | `	}` |
|        - | 2304 | `	/* Install the interface */` |
|    69677 | 2305 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|    69677 | 2306 | `	if( rc == SXRET_OK && pBase ){` |
|        - | 2307 | `		/* Inherit from the base interface */` |
|    27065 | 2308 | `		rc = PH7_ClassInterfaceInherit(pClass,pBase);` |
|    13530 | 2309 | `	}` |
|    69677 | 2310 | `	if( rc != SXRET_OK ){` |
...
|    69681 | 2316 | `	pGen->pIn  = &pEnd[1];` |
|    69681 | 2317 | `	pGen->pEnd = pTmp;` |
|    69681 | 2318 | `	return PH7_OK;` |
|    34844 | 2319 | `}` |
|        - | 2320 | `/*` |
...
|        - | 2344 | ` */` |
|   450178 | 2345 | `static sxi32 GenStateCheckInterfaceSignatures(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 | 2346 | `{` |
|        - | 2347 | `	ph7_class **apIface;` |
|        - | 2348 | `	sxu32 nIface,i;` |
|        - | 2349 | `	sxi32 rc;` |
|   450183 | 2350 | `	if( pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|      ! 0 | 2351 | `		return SXRET_OK;` |
|        - | 2352 | `	}` |
|   450183 | 2353 | `	apIface = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|   450183 | 2354 | `	nIface = SySetUsed(&pClass->aInterface);` |
|   871715 | 2355 | `	for(i = 0; i < nIface; i++){` |
|   421537 | 2356 | `		ph7_class *pIface = apIface[i];` |
|        - | 2357 | `		SyHashEntry *pEntry;` |
|   421537 | 2358 | `		SyHashResetLoopCursor(&pIface->hMethod);` |
|  1241313 | 2359 | `		while((pEntry = SyHashGetNextEntry(&pIface->hMethod)) != 0 ){` |
|   819781 | 2360 | `			ph7_class_method *pIfaceMeth = (ph7_class_method *)pEntry->pUserData;` |
|        - | 2361 | `			ph7_class_method *pImplMeth;` |
|   819781 | 2362 | `			SyString *pMName = &pIfaceMeth->sFunc.sName;` |
|        - | 2363 | `			/* Find the implementing method in the class */` |
|   819781 | 2364 | `			pImplMeth = PH7_ClassExtractMethod(pClass,pMName->zString,pMName->nByte);` |
|   819781 | 2365 | `			if( pImplMeth == 0 \|\| (pImplMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT) ){` |
...
|   819763 | 2369 | `			if( pImplMeth->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|        - | 2379 | `			 */` |
|        - | 2380 | `			{` |
|   819763 | 2381 | `				sxu32 nIfaceArgs = SySetUsed(&pIfaceMeth->sFunc.aArgs);` |
|   819763 | 2382 | `				sxu32 nImplArgs = SySetUsed(&pImplMeth->sFunc.aArgs);` |
|   819763 | 2383 | `				int sigError = 0;` |
|   819763 | 2384 | `				if( nImplArgs < nIfaceArgs ){` |
|        3 | 2385 | `					sigError = 1;` |
|   819762 | 2386 | `				}else if( nImplArgs > nIfaceArgs ){` |
|        - | 2387 | `					/* Extra parameters must all have default values */` |
|     3873 | 2388 | `					ph7_vm_func_arg *aImplArgs = (ph7_vm_func_arg *)SySetBasePtr(&pImplMeth->sFunc.aArgs);` |
|        - | 2389 | `					sxu32 k;` |
|     7739 | 2390 | `					for(k = nIfaceArgs; k < nImplArgs; k++){` |
|     3873 | 2391 | `						if( SySetUsed(&aImplArgs[k].aByteCode) == 0 ){` |
|        3 | 2392 | `							sigError = 1;` |
|        3 | 2393 | `							break;` |
|        - | 2394 | `						}` |
|     1938 | 2395 | `					}` |
|     1934 | 2396 | `				}` |
|   819763 | 2397 | `				if( sigError ){` |
...
|        - | 2477 | ` */` |
|   450178 | 2478 | `static sxi32 GenStateCheckAbstractMethods(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 | 2479 | `{` |
...
|   450183 | 2486 | `	if( pClass->iFlags & (PH7_CLASS_ABSTRACT\|PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|    19377 | 2487 | `		return SXRET_OK;` |
|        - | 2488 | `	}` |
|        - | 2489 | `	/* Count abstract methods */` |
|   430811 | 2490 | `	nAbstract = 0;` |
|   430811 | 2491 | `	SyHashResetLoopCursor(&pClass->hMethod);` |
|  6437324 | 2492 | `	while((pEntry = SyHashGetNextEntry(&pClass->hMethod)) != 0 ){` |
|  5791115 | 2493 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|  5791115 | 2494 | `		if( pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
...
|        8 | 2499 | `		}` |
|        5 | 2500 | `	}` |
|   430811 | 2501 | `	if( nAbstract == 0 ){` |
|   430797 | 2502 | `		return SXRET_OK;` |
|        - | 2503 | `	}` |
...
|        - | 2640 | ` */` |
|   512418 | 2641 | `PH7_PRIVATE sxi32 GenStateParseClassReference(ph7_gen_state *pGen,SyBlob *pFqn)` |
|        5 | 2642 | `{` |
|   512423 | 2643 | `	int isAbsolute = 0;` |
|   512423 | 2644 | `	SyToken *pStart = pGen->pIn;` |
|        - | 2645 | `	SyBlob sName;` |
|   512423 | 2646 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) ){` |
|     4523 | 2647 | `		isAbsolute = 1;` |
|     4523 | 2648 | `		pGen->pIn++;` |
|     2259 | 2649 | `	}` |
|   512423 | 2650 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|        9 | 2651 | `		pGen->pIn = pStart;` |
|        9 | 2652 | `		return SXERR_INVALID;` |
|        - | 2653 | `	}` |
|   512417 | 2654 | `	SyBlobInit(&sName,&pGen->pVm->sAllocator);` |
|   512417 | 2655 | `	SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|   512417 | 2656 | `	pGen->pIn++;` |
|   768657 | 2657 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) &&` |
|   256250 | 2658 | `		&pGen->pIn[1] < pGen->pEnd && (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|       28 | 2659 | `		SyBlobAppend(&sName,"\\",1);` |
|       28 | 2660 | `		pGen->pIn++;` |
|       28 | 2661 | `		SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|       28 | 2662 | `		pGen->pIn++;` |
|        2 | 2663 | `	}` |
|   512417 | 2664 | `	if( isAbsolute ){` |
|     4521 | 2665 | `		SyBlobAppend(pFqn,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|     2263 | 2666 | `	}else{` |
|        - | 2667 | `		SyString sRaw;` |
|   507901 | 2668 | `		SyStringInitFromBuf(&sRaw,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|   507901 | 2669 | `		GenStateResolveName(pGen,&sRaw,pFqn);` |
|        - | 2670 | `	}` |
|   512417 | 2671 | `	SyBlobRelease(&sName);` |
|   512417 | 2672 | `	return SXRET_OK;` |
|   256214 | 2673 | `}` |
|        - | 2674 | `/*` |
...
|   197276 | 2682 | `static int GenStateInterfaceIsThrowableAt(ph7_class *pInterface,int iDepth)` |
|        5 | 2683 | `{` |
|        - | 2684 | `	ph7_class **apParent;` |
|        - | 2685 | `	sxu32 n;` |
|   522109 | 2686 | `	while( pInterface ){` |
|   332571 | 2687 | `		if( iDepth > PH7_THROWABLE_WALK_MAX_DEPTH ){` |
|      ! 0 | 2688 | `			return FALSE;` |
|        - | 2689 | `		}` |
|   371231 | 2690 | `		if( pInterface->sName.nByte == sizeof("Throwable")-1 &&` |
|    77320 | 2691 | `			SyMemcmp(pInterface->sName.zString,"Throwable",sizeof("Throwable")-1) == 0 ){` |
|     7743 | 2692 | `			return TRUE;` |
|        - | 2693 | `		}` |
|   324833 | 2694 | `		apParent = (ph7_class **)SySetBasePtr(&pInterface->aInterface);` |
|   324835 | 2695 | `		for( n = 0 ; n < SySetUsed(&pInterface->aInterface) ; ++n ){` |
|        3 | 2696 | `			if( GenStateInterfaceIsThrowableAt(apParent[n],iDepth+1) ){` |
|      ! 0 | 2697 | `				return TRUE;` |
|        - | 2698 | `			}` |
|        2 | 2699 | `		}` |
|   324833 | 2700 | `		pInterface = pInterface->pBase;` |
|   324833 | 2701 | `		iDepth++;` |
|        5 | 2702 | `	}` |
|   189543 | 2703 | `	return FALSE;` |
|    98643 | 2704 | `}` |
|   197274 | 2705 | `static int GenStateInterfaceIsThrowable(ph7_class *pInterface)` |
|        5 | 2706 | `{` |
|   197279 | 2707 | `	return GenStateInterfaceIsThrowableAt(pInterface,0);` |
|        5 | 2708 | `}` |
|        - | 2709 | `/*` |
...
|        - | 2713 | ` */` |
|     7738 | 2714 | `static int GenStateClassIsExceptionOrError(ph7_class *pBase)` |
|        5 | 2715 | `{` |
|     7747 | 2716 | `	while( pBase ){` |
...
|        - | 2737 | ` */` |
|     7782 | 2738 | `static sxi32 GenStateCompileEnumCase(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 | 2739 | `{` |
|     7787 | 2740 | `	sxu32 nLine = pGen->pIn->nLine;` |
|        - | 2741 | `	SySet *pInstrContainer;` |
|        - | 2742 | `	ph7_class_attr *pCase;` |
|        - | 2743 | `	SyString *pName;` |
|        - | 2744 | `	sxi32 rc;` |
|     7787 | 2745 | `	pGen->pIn++; /* Jump the 'case' keyword */` |
|     7787 | 2746 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|        - | 2753 | `	}` |
|     7787 | 2754 | `	pName = &pGen->pIn->sData;` |
|        - | 2755 | `	/* Cases share the class-constant namespace (php: "Cannot redefine class constant") */` |
|     7787 | 2756 | `	if( SyHashGet(&pClass->hAttr,(const void *)pName->zString,pName->nByte) != 0 ){` |
...
|        - | 2763 | `	}` |
|     7787 | 2764 | `	pCase = PH7_NewClassAttr(pGen->pVm,pName,pGen->pIn->nLine,PH7_CLASS_PROT_PUBLIC,` |
|        - | 2765 | `		PH7_CLASS_ATTR_CONSTANT\|PH7_CLASS_ATTR_ENUMCASE);` |
|     7787 | 2766 | `	if( pCase == 0 ){` |
|      ! 0 | 2767 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2768 | `		return SXERR_ABORT;` |
|        - | 2769 | `	}` |
|     7787 | 2770 | `	GenStateConsumeDoc(&(*pGen),&pCase->sDoc);` |
|     7787 | 2771 | `	if( GenStateConsumeAttrs(&(*pGen),&pCase->aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 2772 | `		return SXERR_ABORT;` |
|        - | 2773 | `	}` |
|     7787 | 2774 | `	pGen->pIn++; /* Jump the case name */` |
|     7787 | 2775 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_EQUAL /* '=' */) ){` |
|     7773 | 2776 | `		if( pClass->nEnumBacking == 0 ){` |
...
|        - | 2783 | `		}` |
|     7769 | 2784 | `		pGen->pIn++; /* Jump the equal sign */` |
|        - | 2785 | `		/* Compile the backing value expression into the case's own container` |
|        - | 2786 | `		 * (same technique as class constants). */` |
|     7769 | 2787 | `		pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|     7769 | 2788 | `		PH7_VmSetByteCodeContainer(pGen->pVm,&pCase->aByteCode);` |
|     7769 | 2789 | `		rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|     7769 | 2790 | `		if( rc == SXERR_EMPTY ){` |
|      ! 0 | 2791 | `			rc = PH7_GenCompileError(pGen,E_ERROR,nLine,` |
|      ! 0 | 2792 | `				"Empty value for enum case %z::%z",&pClass->sName,pName);` |
|      ! 0 | 2793 | `		}` |
|     7769 | 2794 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|     7769 | 2795 | `		PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|     7769 | 2796 | `		if( rc == SXERR_ABORT ){` |
...
|        - | 2807 | `		}` |
|        - | 2808 | `	}` |
|     7783 | 2809 | `	rc = PH7_ClassInstallAttr(pClass,pCase);` |
|     7783 | 2810 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 2811 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2812 | `		return SXERR_ABORT;` |
|        - | 2813 | `	}` |
|     7783 | 2814 | `	SySetPut(&pClass->aEnumCases,(const void *)&pCase);` |
|     7783 | 2815 | `	return SXRET_OK;` |
|        2 | 2816 | `Synchronize:` |
...
|        - | 2831 | ` */` |
|     3898 | 2832 | `static sxi32 GenStateCompileEnumMethods(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 | 2833 | `{` |
...
|     3903 | 2839 | `	sxi32 rc = SXRET_OK;` |
|     3903 | 2840 | `	nMax = 3*(sxu32)sizeof("function tryFrom(string $value){return __phl_enum_tryfrom('',$value);}")` |
|     3898 | 2841 | `		+ 3*SyStringLength(&pClass->sName) + 64;` |
|     3903 | 2842 | `	zSrc = (char *)SyMemBackendAlloc(&pGen->pVm->sAllocator,nMax);` |
|     3903 | 2843 | `	if( zSrc == 0 ){` |
|      ! 0 | 2844 | `		PH7_GenCompileError(pGen,E_ERROR,pClass->nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2845 | `		return SXERR_ABORT;` |
|        - | 2846 | `	}` |
|     3903 | 2847 | `	zBack = (pClass->nEnumBacking == MEMOBJ_INT) ? "int" : "string";` |
|     3903 | 2848 | `	if( pClass->nEnumBacking != 0 ){` |
|     5822 | 2849 | `		nSrc = SyBufferFormat(zSrc,nMax,` |
...
|     1939 | 2853 | `			&pClass->sName,zBack,&pClass->sName,zBack,&pClass->sName);` |
|     1944 | 2854 | `	}else{` |
|       34 | 2855 | `		nSrc = SyBufferFormat(zSrc,nMax,` |
|       10 | 2856 | `			"function cases(){return __phl_enum_cases('%z');}",&pClass->sName);` |
|        - | 2857 | `	}` |
|     3903 | 2858 | `	SySetInit(&sToken,&pGen->pVm->sAllocator,sizeof(SyToken));` |
|     3903 | 2859 | `	PH7_TokenizePHP(zSrc,nSrc,pClass->nLine,&sToken,0);` |
|     3903 | 2860 | `	pSaveIn = pGen->pIn;` |
|     3903 | 2861 | `	pSaveEnd = pGen->pEnd;` |
|     3903 | 2862 | `	pGen->pIn = (SyToken *)SySetBasePtr(&sToken);` |
|     3903 | 2863 | `	pGen->pEnd = &pGen->pIn[SySetUsed(&sToken)];` |
|    15557 | 2864 | `	while( pGen->pIn < pGen->pEnd && rc != SXERR_ABORT ){` |
|    11659 | 2865 | `		rc = GenStateCompileClassMethod(&(*pGen),PH7_TKWRD_PUBLIC,PH7_CLASS_ATTR_STATIC,TRUE,pClass);` |
|        5 | 2866 | `	}` |
|     3903 | 2867 | `	pGen->pIn = pSaveIn;` |
|     3903 | 2868 | `	pGen->pEnd = pSaveEnd;` |
|     3903 | 2869 | `	SySetRelease(&sToken);` |
|     3903 | 2870 | `	return (rc == SXERR_ABORT) ? SXERR_ABORT : SXRET_OK;` |
|     1954 | 2871 | `}` |
|        - | 2872 | `/*` |
...
|        - | 2886 | ` */` |
|     3898 | 2887 | `static sxi32 GenStateEnumFinalize(ph7_gen_state *pGen,ph7_class *pClass,sxu32 nLine)` |
|        5 | 2888 | `{` |
|        - | 2889 | `	SyHashEntry *pEntry;` |
|        - | 2890 | `	sxi32 rc;` |
|        - | 2891 | `	sxu32 n;` |
|        - | 2892 | `	/* php: "Enum %s cannot include properties" */` |
|     3903 | 2893 | `	SyHashResetLoopCursor(&pClass->hAttr);` |
|    11687 | 2894 | `	while( (pEntry = SyHashGetNextEntry(&pClass->hAttr)) != 0 ){` |
|     7791 | 2895 | `		ph7_class_attr *pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|     7791 | 2896 | `		if( (pAttr->iFlags & PH7_CLASS_ATTR_CONSTANT) == 0 ){` |
...
|    54577 | 2906 | `	for( n = 0 ; n < SX_ARRAYSIZE(azEnumBannedMagic) ; n++ ){` |
|    76011 | 2907 | `		if( SyHashGet(&pClass->hMethod,(const void *)azEnumBannedMagic[n],` |
|    50679 | 2908 | `			SyStrlen(azEnumBannedMagic[n])) != 0 ){` |
...
|     3903 | 2924 | `		pAttr = PH7_NewClassAttr(pGen->pVm,&sNameProp,nLine,PH7_CLASS_PROT_PUBLIC,` |
|        - | 2925 | `			PH7_CLASS_ATTR_READONLY\|PH7_CLASS_ATTR_TYPED);` |
|     3903 | 2926 | `		if( pAttr == 0 ){` |
|      ! 0 | 2927 | `			PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2928 | `			return SXERR_ABORT;` |
|        - | 2929 | `		}` |
|     3903 | 2930 | `		pAttr->nType = MEMOBJ_STRING;` |
|     3903 | 2931 | `		SyStringInitFromBuf(&pAttr->sTypeName,"string",sizeof("string")-1);` |
|     3903 | 2932 | `		PH7_ClassInstallAttr(pClass,pAttr);` |
|     3903 | 2933 | `		if( pClass->nEnumBacking != 0 ){` |
|     3883 | 2934 | `			pAttr = PH7_NewClassAttr(pGen->pVm,&sValueProp,nLine,PH7_CLASS_PROT_PUBLIC,` |
|        - | 2935 | `				PH7_CLASS_ATTR_READONLY\|PH7_CLASS_ATTR_TYPED);` |
|     3883 | 2936 | `			if( pAttr == 0 ){` |
|      ! 0 | 2937 | `				PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2938 | `				return SXERR_ABORT;` |
|        - | 2939 | `			}` |
|     3883 | 2940 | `			pAttr->nType = pClass->nEnumBacking;` |
|     3883 | 2941 | `			if( pClass->nEnumBacking == MEMOBJ_INT ){` |
|        7 | 2942 | `				SyStringInitFromBuf(&pAttr->sTypeName,"int",sizeof("int")-1);` |
|        4 | 2943 | `			}else{` |
|     3877 | 2944 | `				SyStringInitFromBuf(&pAttr->sTypeName,"string",sizeof("string")-1);` |
|        - | 2945 | `			}` |
|     3883 | 2946 | `			PH7_ClassInstallAttr(pClass,pAttr);` |
|     1939 | 2947 | `		}` |
|        - | 2948 | `	}` |
|     3903 | 2949 | `	return GenStateCompileEnumMethods(&(*pGen),pClass);` |
|     1954 | 2950 | `}` |
|        - | 2951 | `/*` |
...
|        - | 2960 | ` */` |
|   450228 | 2961 | `static sxi32 GenStateCompileClassEx(ph7_gen_state *pGen,sxi32 iFlags,` |
|        - | 2962 | `	SyString *pAnonName,SyToken **ppArgStart,SyToken **ppArgEnd)` |
|        5 | 2963 | `{` |
|   450233 | 2964 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|   450233 | 2975 | `	pGen->pIn++;` |
|   450233 | 2976 | `	if( pAnonName ){` |
...
|       19 | 2991 | `	}else{` |
|   450203 | 2992 | `		if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
|        - | 2993 | `			/* Syntax error */` |
...
|   450203 | 3006 | `		pName = &pGen->pIn->sData;` |
|        - | 3007 | `		/* Advance the stream cursor */` |
|   450203 | 3008 | `		pGen->pIn++;` |
|        - | 3009 | `		/* Build FQN and obtain a raw class */ {` |
|        - | 3010 | `			SyBlob sFQN;` |
|        - | 3011 | `			SyString sFQNStr;` |
|   450203 | 3012 | `			SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|   450203 | 3013 | `			GenStateBuildFQN(pGen,pName,&sFQN);` |
|   450203 | 3014 | `			SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|   450203 | 3015 | `			pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|   450203 | 3016 | `			SyBlobRelease(&sFQN);` |
|        - | 3017 | `		}` |
|        - | 3018 | `	}` |
|   450233 | 3019 | `	if( pClass == 0 ){` |
|      ! 0 | 3020 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 3021 | `		return SXERR_ABORT;` |
|        - | 3022 | `	}` |
|   450228 | 3023 | `	if( (iFlags & PH7_CLASS_ENUM) && pGen->pIn < pGen->pEnd` |
|     3907 | 3024 | `		&& (pGen->pIn->nType & PH7_TK_COLON /* ':' */) ){` |
|        - | 3025 | ``		/* Backed enum: `enum Name: int\|string` (PHP 8.1) */`` |
|     3885 | 3026 | `		pGen->pIn++; /* Jump ':' */` |
|     3880 | 3027 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD)` |
|     3885 | 3028 | `			&& SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_INT ){` |
|        7 | 3029 | `			pClass->nEnumBacking = MEMOBJ_INT;` |
|        7 | 3030 | `			pGen->pIn++;` |
|     3878 | 3031 | `		}else if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD)` |
|     3879 | 3032 | `			&& SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_STRING ){` |
|     3877 | 3033 | `			pClass->nEnumBacking = MEMOBJ_STRING;` |
|     3877 | 3034 | `			pGen->pIn++;` |
|     1941 | 3035 | `		}else{` |
...
|        - | 3046 | `		}` |
|     1940 | 3047 | `	}` |
|   450233 | 3048 | `	GenStateConsumeDoc(&(*pGen),&pClass->sDoc);` |
|   450233 | 3049 | `	if( GenStateConsumeAttrs(&(*pGen),&pClass->aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 3050 | `		return SXERR_ABORT;` |
|        - | 3051 | `	}` |
|        - | 3052 | `	/* implemented interfaces and per-use-statement trait containers */` |
|   450233 | 3053 | `	SySetInit(&aInterfaces,&pGen->pVm->sAllocator,sizeof(ph7_class *));` |
|   450233 | 3054 | `	SySetInit(&aUseEntries,&pGen->pVm->sAllocator,sizeof(TraitUseEntry));` |
|        - | 3055 | `	/* Assume a standalone class */` |
|   450233 | 3056 | `	pBase = 0;` |
|   450233 | 3057 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|   367579 | 3058 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   367579 | 3059 | `		if( nKwrd == PH7_TKWRD_EXTENDS /* class b extends a */ ){` |
|        - | 3060 | `			SyBlob sResolved;` |
|        - | 3061 | `			SyString sBaseName;` |
|        - | 3062 | `			sxu32 nRefLine;` |
|   247615 | 3063 | `			if( iFlags & PH7_CLASS_ENUM ){` |
...
|        - | 3069 | `				}` |
|      ! 0 | 3070 | `			}` |
|   247615 | 3071 | `			pGen->pIn++; /* Advance past 'extends' */` |
|   247615 | 3072 | `			nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|   247615 | 3073 | `			SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|   247615 | 3074 | `			if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|        - | 3084 | `			}` |
|   371417 | 3085 | `			pBase = PH7_VmExtractClass(pGen->pVm,` |
|   247608 | 3086 | `				(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|   247613 | 3087 | `			SyStringInitFromBuf(&sBaseName,` |
|        - | 3088 | `				(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|        - | 3089 | `			/* Interfaces are not allowed */` |
|   247613 | 3090 | `			while( pBase && (pBase->iFlags & PH7_CLASS_INTERFACE) ){` |
|      ! 0 | 3091 | `				pBase = pBase->pNextName;` |
|      ! 0 | 3092 | `			}` |
|   247613 | 3093 | `			if( pBase == 0 ){` |
...
|        - | 3099 | `				}` |
|      ! 0 | 3100 | `			}else{` |
|   247613 | 3101 | `				if( pBase->iFlags & PH7_CLASS_ENUM ){` |
...
|   247612 | 3109 | `				}else if( pBase->iFlags & PH7_CLASS_FINAL ){` |
...
|      ! 0 | 3116 | `				}` |
|        - | 3117 | `			}` |
|   247613 | 3118 | `			SyBlobRelease(&sResolved);` |
|   247613 | 3119 | `			if( iFlags & PH7_CLASS_ENUM ){` |
|      ! 0 | 3120 | `				pBase = 0; /* Error already reported: enums have no base class */` |
|      ! 0 | 3121 | `			}` |
|   123804 | 3122 | `		}` |
|   367577 | 3123 | `		if (pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) && SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_IMPLEMENTS ){` |
|        - | 3124 | `			ph7_class *pInterface;` |
|        - | 3125 | `			/* Interface implementation */` |
|   135441 | 3126 | `			pGen->pIn++; /* Advance the stream cursor */` |
|   129556 | 3127 | `			for(;;){` |
|        - | 3128 | `				SyBlob sResolved;` |
|        - | 3129 | `				SyString sIntName;` |
|        - | 3130 | `				sxu32 nRefLine;` |
|   197279 | 3131 | `				nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|   197279 | 3132 | `				SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|   197279 | 3133 | `				if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|      ! 0 | 3141 | `					break;` |
|        - | 3142 | `				}` |
|   394553 | 3143 | `				pInterface = PH7_VmExtractClass(pGen->pVm,` |
|   197274 | 3144 | `					(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|   197279 | 3145 | `				SyStringInitFromBuf(&sIntName,` |
|        - | 3146 | `					(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|        - | 3147 | `				/* Only interfaces are allowed */` |
|   197279 | 3148 | `				while( pInterface && (pInterface->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|      ! 0 | 3149 | `					pInterface = pInterface->pNextName;` |
|      ! 0 | 3150 | `				}` |
|   197279 | 3151 | `				if( pInterface == 0 ){` |
...
|   197279 | 3165 | `					SyString *pFqn = &pClass->sName;` |
|   197279 | 3166 | `					int bIsExceptionOrError =` |
|   102505 | 3167 | `						(pFqn->nByte == sizeof("Exception")-1 &&` |
|   297847 | 3168 | `						 SyMemcmp(pFqn->zString,"Exception",sizeof("Exception")-1) == 0) \|\|` |
|   195349 | 3169 | `						(pFqn->nByte == sizeof("Error")-1 &&` |
|     3878 | 3170 | `						 SyMemcmp(pFqn->zString,"Error",sizeof("Error")-1) == 0);` |
|   201143 | 3171 | `					if( GenStateInterfaceIsThrowable(pInterface) &&` |
|    11610 | 3172 | `						!GenStateClassIsExceptionOrError(pBase) &&` |
|     3867 | 3173 | `						!bIsExceptionOrError ){` |
...
|        6 | 3183 | `					}else{` |
|   197273 | 3184 | `						SySetPut(&aInterfaces,(const void *)&pInterface);` |
|        - | 3185 | `					}` |
|        - | 3186 | `				}` |
|   197279 | 3187 | `				SyBlobRelease(&sResolved);` |
|   197279 | 3188 | `				if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COMMA) == 0 ){` |
|    67723 | 3189 | `					break;` |
|        - | 3190 | `				}` |
|    61843 | 3191 | `				pGen->pIn++;/* Jump the comma */` |
|        5 | 3192 | `			}` |
|    67718 | 3193 | `		}` |
|   183786 | 3194 | `	}` |
|   450231 | 3195 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|        - | 3196 | `		/* Syntax error */` |
...
|        - | 3204 | `	}` |
|   450231 | 3205 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|   450231 | 3206 | `	pEnd = 0; /* cc warning */` |
|        - | 3207 | `	/* Delimit the class body */` |
|   450231 | 3208 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|   450231 | 3209 | `	if( pEnd >= pGen->pEnd ){` |
|        - | 3210 | `		/* Syntax error */` |
...
|   450231 | 3220 | `	pClass->nEndLine = pEnd->nLine;` |
|        - | 3221 | `	/* Swap token stream */` |
|   450231 | 3222 | `	pTmp = pGen->pEnd;` |
|   450231 | 3223 | `	pGen->pEnd = pEnd;` |
|        - | 3224 | `	/* Merge the inherited flags (PH7_NewRawClass may have set INTERNAL) */` |
|   450231 | 3225 | `	pClass->iFlags \|= iFlags;` |
|        - | 3226 | `	/* Start the parse process */` |
|  1686626 | 3227 | `	for(;;){` |
|        - | 3228 | `		/* Jump leading/trailing semi-colons */` |
|  4844101 | 3229 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|   882307 | 3230 | `			pGen->pIn++;` |
|        5 | 3231 | `		}` |
|  3961799 | 3232 | `		if( pGen->pIn >= pGen->pEnd ){` |
|        - | 3233 | `			/* End of class body */` |
|   450189 | 3234 | `			break;` |
|        - | 3235 | `		}` |
|        - | 3236 | `		/* Bind a directly-preceding docblock to this member */` |
|  3511615 | 3237 | `		GenStateSetPendingDoc(&(*pGen));` |
|  3511610 | 3238 | `		if( (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR)) == 0` |
|  1755810 | 3239 | ``			&& !GenStateIsReadonly(pGen->pIn) /* allow a leading `readonly` modifier */ ){`` |
...
|  3511615 | 3250 | `		iProtection = PH7_TKWRD_PUBLIC;` |
|  3511615 | 3251 | `		iAttrflags = 0;` |
...
|  3511615 | 3256 | `		if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|      ! 0 | 3257 | `			int bMod = 0;` |
...
|        - | 3278 | `			}` |
|      ! 0 | 3279 | `		}` |
|  3511615 | 3280 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|        - | 3281 | `			/* Extract the current keyword */` |
|  3511615 | 3282 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  3511615 | 3283 | `			if( nKwrd == PH7_TKWRD_CASE && (pClass->iFlags & PH7_CLASS_ENUM) ){` |
|        - | 3284 | ``				/* Enum case declaration: `case NAME [= value];` */`` |
|     7787 | 3285 | `				rc = GenStateCompileEnumCase(&(*pGen),pClass);` |
|     7787 | 3286 | `				if( rc != SXRET_OK ){` |
...
|     7783 | 3292 | `				continue;` |
|        - | 3293 | `			}` |
|  3503833 | 3294 | `			if( nKwrd == PH7_TKWRD_USE ){` |
|        - | 3295 | `				/* Trait use: use TraitA, TraitB [{ ... }]; */` |
|        - | 3296 | `				TraitUseEntry sUse;` |
|    15551 | 3297 | `				SySetInit(&sUse.aTraits,&pGen->pVm->sAllocator,sizeof(ph7_class *));` |
|    15551 | 3298 | `				sUse.pResolvStart = sUse.pResolvEnd = 0;` |
|    15551 | 3299 | `				pGen->pIn++; /* Jump the 'use' keyword */` |
|     7781 | 3300 | `				for(;;){` |
|        - | 3301 | `					ph7_class *pTrait;` |
|        - | 3302 | `					SyBlob sResolved;` |
|        - | 3303 | `					SyString sTraitName;` |
|    15559 | 3304 | `					sxu32 nUseLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
...
|    15559 | 3311 | `					SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|    15559 | 3312 | `					if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|      ! 0 | 3319 | `						break;` |
|        - | 3320 | `					}` |
|    31113 | 3321 | `					pTrait = PH7_VmExtractClass(pGen->pVm,` |
|    15554 | 3322 | `						(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|    15559 | 3323 | `					SyStringInitFromBuf(&sTraitName,` |
|        - | 3324 | `						(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|        - | 3325 | `					/* Only traits are allowed */` |
|    15559 | 3326 | `					while( pTrait && (pTrait->iFlags & PH7_CLASS_TRAIT) == 0 ){` |
|      ! 0 | 3327 | `						pTrait = pTrait->pNextName;` |
|      ! 0 | 3328 | `					}` |
|    15559 | 3329 | `					if( pTrait == 0 ){` |
...
|        - | 3335 | `						}` |
|      ! 0 | 3336 | `					}else{` |
|    15559 | 3337 | `						SySetPut(&sUse.aTraits,(const void *)&pTrait);` |
|        - | 3338 | `					}` |
|    15559 | 3339 | `					SyBlobRelease(&sResolved);` |
...
|    15559 | 3342 | `					if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COMMA) == 0 ){` |
|     7778 | 3343 | `						break;` |
|        - | 3344 | `					}` |
|       10 | 3345 | `					pGen->pIn++; /* Jump the comma */` |
|        2 | 3346 | `				}` |
|        - | 3347 | `				/* Expect semicolon or opening brace (for conflict resolution) */` |
|    15551 | 3348 | `				if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OCB) ){` |
|        - | 3349 | `					SyToken *pBlock;` |
...
|        - | 3358 | `					}` |
|        5 | 3359 | `				}` |
|    15551 | 3360 | `				SySetPut(&aUseEntries,(const void *)&sUse);` |
|        - | 3361 | `				/* The semicolon will be consumed by the outer loop */` |
|    15551 | 3362 | `				continue;` |
|        - | 3363 | `			}` |
|  3488287 | 3364 | `			if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|        - | 3365 | `				int nSetTok;` |
|  2946787 | 3366 | `				sxi32 nSetVis = GenStatePeekSetVisibility(pGen->pIn,pGen->pEnd,&nSetTok);` |
|  2946787 | 3367 | `				if( nSetVis ){` |
...
|        2 | 3372 | `				}else{` |
|  2946785 | 3373 | `					iProtection = nKwrd;` |
|  2946785 | 3374 | `					pGen->pIn++; /* Jump the visibility token */` |
|        - | 3375 | `					/* Optional asymmetric set-visibility after the read` |
|        - | 3376 | ``					 * visibility: `public private(set) int $x`. */`` |
|  2946785 | 3377 | `					nSetVis = GenStatePeekSetVisibility(pGen->pIn,pGen->pEnd,&nSetTok);` |
|  2946785 | 3378 | `					if( nSetVis ){` |
...
|  2946787 | 3385 | `				if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|       28 | 3386 | `					iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|       28 | 3387 | `					pGen->pIn++; /* Jump the 'readonly' modifier */` |
|       12 | 3388 | `				}` |
|  2946782 | 3389 | `				if( pGen->pIn >= pGen->pEnd` |
|  2946787 | 3390 | `					\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|      ! 0 | 3398 | `					goto done;` |
|        - | 3399 | `				}` |
|  2946787 | 3400 | `				if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|        - | 3401 | `					/* Attribute declaration (untyped) */` |
|   522333 | 3402 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|   522333 | 3403 | `					if( rc != SXRET_OK ){` |
|       11 | 3404 | `						if( rc == SXERR_ABORT ){` |
|      ! 0 | 3405 | `							return SXERR_ABORT;` |
|        - | 3406 | `						}` |
|       11 | 3407 | `						goto done;` |
|        - | 3408 | `					}` |
|   530216 | 3409 | `					continue;` |
|        - | 3410 | `				}` |
|  2424459 | 3411 | `				if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
|        - | 3412 | `					/* Typed attribute declaration (PHP 7.4+) */` |
|    15793 | 3413 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|    15793 | 3414 | `					if( rc != SXRET_OK ){` |
...
|  2408671 | 3423 | `				nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  1204333 | 3424 | `			}` |
|  2950171 | 3425 | `			if( nKwrd == PH7_TKWRD_CONST ){` |
|        - | 3426 | `				/* Process constant declaration */` |
|   286123 | 3427 | `				rc = GenStateCompileClassConstant(&(*pGen),iProtection,iAttrflags,pClass);` |
|   286123 | 3428 | `				if( rc != SXRET_OK ){` |
...
|        - | 3433 | `				}` |
|   143060 | 3434 | `			}else{` |
|  2664053 | 3435 | `				if( nKwrd == PH7_TKWRD_STATIC ){` |
|        - | 3436 | `					/* Static method or attribute,record that */` |
|   100665 | 3437 | `					iAttrflags \|= PH7_CLASS_ATTR_STATIC;` |
|   100665 | 3438 | `					pGen->pIn++; /* Jump the static keyword */` |
|   100665 | 3439 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|        - | 3440 | `						int nSetTok;` |
|    73575 | 3441 | `						sxi32 nSetVis = GenStatePeekSetVisibility(pGen->pIn,pGen->pEnd,&nSetTok);` |
|    73575 | 3442 | `						if( nSetVis ){` |
...
|    73573 | 3448 | `							nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    73573 | 3449 | `							if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
...
|   100665 | 3463 | `					if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|      ! 0 | 3464 | `						iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|      ! 0 | 3465 | `						pGen->pIn++; /* Jump the 'readonly' modifier */` |
|      ! 0 | 3466 | `					}` |
|   100660 | 3467 | `					if( pGen->pIn >= pGen->pEnd` |
|   100665 | 3468 | `						\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|      ! 0 | 3476 | `						goto done;` |
|        - | 3477 | `					}` |
|   100665 | 3478 | `					if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|        - | 3479 | `						/* Attribute declaration */` |
|    27091 | 3480 | `						rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|    27091 | 3481 | `						if( rc != SXRET_OK ){` |
...
|    27089 | 3487 | `						continue;` |
|        - | 3488 | `					}` |
|    73579 | 3489 | `					if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|    73563 | 3501 | `					nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  2600172 | 3502 | `				}else if( nKwrd == PH7_TKWRD_ABSTRACT ){` |
...
|     7755 | 3511 | `					iAttrflags \|= PH7_CLASS_ATTR_ABSTRACT;` |
|        - | 3512 | `					/* Advance the stream cursor */` |
|     7755 | 3513 | `					pGen->pIn++;` |
|     7755 | 3514 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|     7755 | 3515 | `						nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|     7755 | 3516 | `						if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|     7753 | 3517 | `							iProtection = nKwrd;` |
|     7753 | 3518 | `							pGen->pIn++; /* Jump the visibility token */` |
|     3874 | 3519 | `						}` |
|     3875 | 3520 | `					}` |
|     7755 | 3521 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|     7750 | 3522 | `						SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_STATIC ){` |
|        - | 3523 | `							/* Static method */` |
|      ! 0 | 3524 | `							iAttrflags \|= PH7_CLASS_ATTR_STATIC;` |
|      ! 0 | 3525 | `							pGen->pIn++; /* Jump the static keyword */` |
|      ! 0 | 3526 | `					}` |
|     7755 | 3527 | `					if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 \|\|` |
|     7750 | 3528 | `						SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_FUNCTION ){` |
...
|      ! 0 | 3553 | `							goto done;` |
|        - | 3554 | `					}` |
|     7749 | 3555 | `					nKwrd = PH7_TKWRD_FUNCTION;` |
|  2559515 | 3556 | `				}else if( nKwrd == PH7_TKWRD_FINAL ){` |
...
|        3 | 3600 | `				}` |
|  2636933 | 3601 | `				if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_VAR ){` |
...
|      ! 0 | 3609 | `						goto done;` |
|        - | 3610 | `				}` |
|  2636933 | 3611 | `				if( nKwrd == PH7_TKWRD_VAR ){` |
...
|  2636927 | 3626 | `					rc = GenStateCompileClassMethod(&(*pGen),iProtection,iAttrflags,TRUE,pClass);` |
|        - | 3627 | `				}` |
|  2636933 | 3628 | `				if( rc != SXRET_OK ){` |
...
|        - | 3651 | `		sxu32 nU;` |
|   450189 | 3652 | `		apUse = (TraitUseEntry *)SySetBasePtr(&aUseEntries);` |
|   465735 | 3653 | `		for( nU = 0 ; nU < SySetUsed(&aUseEntries) ; nU++ ){` |
|    15551 | 3654 | `			TraitUseEntry *pUse = &apUse[nU];` |
|    15551 | 3655 | `			ph7_class **apTrait = (ph7_class **)SySetBasePtr(&pUse->aTraits);` |
|    15551 | 3656 | `			sxu32 nTraits = SySetUsed(&pUse->aTraits);` |
|    15551 | 3657 | `			int hasResolution = (pUse->pResolvStart && pUse->pResolvStart < pUse->pResolvEnd) ? 1 : 0;` |
|        - | 3658 | `			sxu32 nT;` |
|    15551 | 3659 | `			if( !hasResolution ){` |
|        - | 3660 | `				/* No conflict resolution block: use standard trait application */` |
|    31083 | 3661 | `				for( nT = 0 ; nT < nTraits ; nT++ ){` |
|    15547 | 3662 | `					rc = PH7_ClassUseTrait(&(*pGen),pClass,apTrait[nT]);` |
|    15547 | 3663 | `					if( rc != SXRET_OK ){` |
|      ! 0 | 3664 | `						break;` |
|        - | 3665 | `					}` |
|     7776 | 3666 | `				}` |
|     7773 | 3667 | `			}else{` |
...
|        2 | 3855 | `				}` |
|        - | 3856 | `			}` |
|    15551 | 3857 | `			SySetRelease(&pUse->aTraits);` |
|     7778 | 3858 | `		}` |
|        - | 3859 | `	}` |
|   450189 | 3860 | `	if( pClass->iFlags & PH7_CLASS_ENUM ){` |
...
|     3903 | 3863 | `		rc = GenStateEnumFinalize(&(*pGen),pClass,nLine);` |
|     3903 | 3864 | `		if( rc == SXERR_ABORT ){` |
...
|   450189 | 3871 | `	if( GenStateGuardClassRedeclaration(pGen,pClass) == SXERR_ABORT ){` |
|        9 | 3872 | `		return SXERR_ABORT;` |
|        - | 3873 | `	}` |
|        - | 3874 | `	/* Install the class */` |
|   450183 | 3875 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|   450183 | 3876 | `	if( rc == SXRET_OK ){` |
|        - | 3877 | `		ph7_class **apInterface;` |
|        - | 3878 | `		sxu32 n;` |
|   450183 | 3879 | `		if( pBase ){` |
|        - | 3880 | `			/* Inherit from base class and mark as a subclass */` |
|   247611 | 3881 | `			rc = PH7_ClassInherit(&(*pGen),pClass,pBase);` |
|   123803 | 3882 | `		}` |
|   450183 | 3883 | `		apInterface = (ph7_class **)SySetBasePtr(&aInterfaces);` |
|   647451 | 3884 | `		for( n = 0 ; n < SySetUsed(&aInterfaces) ; n++ ){` |
|        - | 3885 | `			/* Implements one or more interface */` |
|   197273 | 3886 | `			rc = PH7_ClassImplement(pClass,apInterface[n]);` |
|   197273 | 3887 | `			if( rc != SXRET_OK ){` |
|      ! 0 | 3888 | `				break;` |
|        - | 3889 | `			}` |
|    98639 | 3890 | `		}` |
...
|   450183 | 3893 | `		if( rc == SXRET_OK && (pClass->iFlags & PH7_CLASS_ENUM) ){` |
|     3901 | 3894 | `			ph7_class *pIntf = PH7_VmExtractClass(pGen->pVm,"UnitEnum",sizeof("UnitEnum")-1,FALSE,0);` |
|     3901 | 3895 | `			while( pIntf && (pIntf->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|      ! 0 | 3896 | `				pIntf = pIntf->pNextName;` |
|      ! 0 | 3897 | `			}` |
|     3901 | 3898 | `			if( pIntf ){` |
|     3901 | 3899 | `				PH7_ClassImplement(pClass,pIntf);` |
|     1948 | 3900 | `			}` |
|     3901 | 3901 | `			if( pClass->nEnumBacking != 0 ){` |
|     3883 | 3902 | `				pIntf = PH7_VmExtractClass(pGen->pVm,"BackedEnum",sizeof("BackedEnum")-1,FALSE,0);` |
|     3883 | 3903 | `				while( pIntf && (pIntf->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|      ! 0 | 3904 | `					pIntf = pIntf->pNextName;` |
|      ! 0 | 3905 | `				}` |
|     3883 | 3906 | `				if( pIntf ){` |
|     3883 | 3907 | `					PH7_ClassImplement(pClass,pIntf);` |
|     1939 | 3908 | `				}` |
|     1939 | 3909 | `			}` |
|     1948 | 3910 | `		}` |
...
|   450178 | 3913 | `		if( rc == SXRET_OK` |
|   450178 | 3914 | `		 && (pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT)) == 0` |
|   450183 | 3915 | `		 && SyHashGet(&pClass->hMethod,"__toString",sizeof("__toString")-1) != 0 ){` |
|   228089 | 3916 | `			ph7_class *pStringable = PH7_VmExtractClass(pGen->pVm,` |
|        - | 3917 | `				"Stringable",sizeof("Stringable")-1,FALSE,0);` |
|   228089 | 3918 | `			if( pStringable ){` |
|   228089 | 3919 | `				ph7_class **apImpl = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|   228089 | 3920 | `				sxu32 nImpl = SySetUsed(&pClass->aInterface);` |
|        - | 3921 | `				sxu32 i;` |
|   228089 | 3922 | `				int bAlready = 0;` |
|   274461 | 3923 | `				for( i = 0 ; i < nImpl ; i++ ){` |
|    57971 | 3924 | `					if( apImpl[i] == pStringable ){` |
|    11599 | 3925 | `						bAlready = 1;` |
|    11599 | 3926 | `						break;` |
|        - | 3927 | `					}` |
|    23191 | 3928 | `				}` |
|   228089 | 3929 | `				if( !bAlready ){` |
|   216495 | 3930 | `					PH7_ClassImplement(pClass,pStringable);` |
|   108245 | 3931 | `				}` |
|   114042 | 3932 | `			}` |
|   114042 | 3933 | `		}` |
|        - | 3934 | `		/* Validate interface method signatures (visibility and parameter count) */` |
|   450183 | 3935 | `		if( rc == SXRET_OK ){` |
|   450183 | 3936 | `			sxi32 rcCheck = GenStateCheckInterfaceSignatures(&(*pGen),pClass);` |
|   450183 | 3937 | `			if( rcCheck == SXERR_ABORT ){` |
...
|   450183 | 3944 | `		if( rc == SXRET_OK ){` |
|   450183 | 3945 | `			sxi32 rcCheck = GenStateCheckAbstractMethods(&(*pGen),pClass);` |
|   450183 | 3946 | `			if( rcCheck == SXERR_ABORT ){` |
...
|   225089 | 3951 | `		}` |
|   225089 | 3952 | `	}` |
|   450183 | 3953 | `	SySetRelease(&aUseEntries);` |
|   450183 | 3954 | `	SySetRelease(&aInterfaces);` |
|   450183 | 3955 | `	if( rc != SXRET_OK ){` |
...
|   450225 | 3961 | `	pGen->pIn = &pEnd[1];` |
|   450225 | 3962 | `	pGen->pEnd = pTmp;` |
|   450225 | 3963 | `	return PH7_OK;` |
|   225119 | 3964 | `}` |
|        - | 3965 | `/* Compile a named class declaration (the common case). */` |
|   450198 | 3966 | `static sxi32 GenStateCompileClass(ph7_gen_state *pGen,sxi32 iFlags)` |
|        5 | 3967 | `{` |
|   450203 | 3968 | `	return GenStateCompileClassEx(pGen,iFlags,0,0,0);` |
|        5 | 3969 | `}` |
|        - | 3970 | `/*` |
...
|        - | 4069 | ` */` |
| 14387348 | 4070 | `static int GenStateTokenIsClassModifier(SyToken *pTok,sxi32 *piFlag)` |
|        5 | 4071 | `{` |
| 14387353 | 4072 | `	if( pTok->nType & PH7_TK_KEYWORD ){` |
|  8610977 | 4073 | `		sxu32 nKw = (sxu32)SX_PTR_TO_INT(pTok->pUserData);` |
|  8610977 | 4074 | `		if( nKw == PH7_TKWRD_FINAL ){ *piFlag = PH7_CLASS_FINAL; return TRUE; }` |
|  8556835 | 4075 | `		if( nKw == PH7_TKWRD_ABSTRACT ){ *piFlag = PH7_CLASS_ABSTRACT; return TRUE; }` |
|  4259042 | 4076 | `	}` |
| 14294465 | 4077 | `	if( GenStateIsReadonly(pTok) ){ *piFlag = PH7_CLASS_READONLY; return TRUE; }` |
| 14294405 | 4078 | `	return FALSE;` |
|  7193679 | 4079 | `}` |
|        - | 4080 | `/*` |
...
|        - | 4085 | ` */` |
| 14294400 | 4086 | `static sxi32 GenStateScanClassModifiers(SyToken **ppIn,SyToken *pEnd,SyToken **ppDup)` |
|        5 | 4087 | `{` |
| 14294405 | 4088 | `	SyToken *pIn = *ppIn,*pDup = 0;` |
| 14294405 | 4089 | `	sxi32 iFlags = 0,iFlag;` |
| 14387353 | 4090 | `	while( pIn < pEnd && GenStateTokenIsClassModifier(pIn,&iFlag) ){` |
|    92953 | 4091 | `		if( (iFlags & iFlag) && pDup == 0 ){` |
|        5 | 4092 | `			pDup = pIn;` |
|        2 | 4093 | `		}` |
|    92953 | 4094 | `		iFlags \|= iFlag;` |
|    92953 | 4095 | `		pIn++;` |
|        5 | 4096 | `	}` |
| 14294405 | 4097 | `	*ppIn = pIn;` |
| 14294405 | 4098 | `	if( ppDup ){ *ppDup = pDup; }` |
| 14294405 | 4099 | `	return iFlags;` |
|        5 | 4100 | `}` |
|        - | 4101 | `/*` |
...
|        - | 4107 | ` */` |
| 14251800 | 4108 | `PH7_PRIVATE int GenStateStartsModifiedClass(SyToken *pIn,SyToken *pEnd)` |
|        5 | 4109 | `{` |
| 14251805 | 4110 | `	sxi32 iFlags = GenStateScanClassModifiers(&pIn,pEnd,0);` |
|  7176235 | 4111 | `	return iFlags != 0 && pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD)` |
| 14276966 | 4112 | `		&& (sxu32)SX_PTR_TO_INT(pIn->pUserData) == PH7_TKWRD_CLASS;` |
|        5 | 4113 | `}` |
|        - | 4114 | `/*` |
...
|        - | 4120 | ` */` |
|    42600 | 4121 | `PH7_PRIVATE sxi32 PH7_CompileClassModifiers(ph7_gen_state *pGen)` |
|        5 | 4122 | `{` |
|        - | 4123 | `	SyToken *pDup;` |
|    42605 | 4124 | `	sxi32 iFlags = GenStateScanClassModifiers(&pGen->pIn,pGen->pEnd,&pDup);` |
|        - | 4125 | `	sxi32 rc;` |
|    42605 | 4126 | `	if( pDup ){` |
...
|        - | 4131 | `		}` |
|        1 | 4132 | `	}` |
|    42600 | 4133 | `	if( (iFlags & (PH7_CLASS_FINAL\|PH7_CLASS_ABSTRACT))` |
|    21305 | 4134 | `		== (PH7_CLASS_FINAL\|PH7_CLASS_ABSTRACT) ){` |
...
|        - | 4139 | `		}` |
|        1 | 4140 | `	}` |
|    42605 | 4141 | `	return GenStateCompileClass(&(*pGen),iFlags);` |
|    21305 | 4142 | `}` |
|        - | 4143 | `/*` |
...
|        - | 4148 | ` */` |
|     7830 | 4149 | `PH7_PRIVATE sxi32 PH7_CompileTrait(ph7_gen_state *pGen)` |
|        5 | 4150 | `{` |
|     7835 | 4151 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|     7835 | 4160 | `	pGen->pIn++;` |
|     7835 | 4161 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
...
|     7835 | 4172 | `	pName = &pGen->pIn->sData;` |
|     7835 | 4173 | `	pGen->pIn++;` |
|        - | 4174 | `	/* Build FQN and obtain a raw class */ {` |
|        - | 4175 | `		SyBlob sFQN;` |
|        - | 4176 | `		SyString sFQNStr;` |
|     7835 | 4177 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|     7835 | 4178 | `		GenStateBuildFQN(pGen,pName,&sFQN);` |
|     7835 | 4179 | `		SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|     7835 | 4180 | `		pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|     7835 | 4181 | `		SyBlobRelease(&sFQN);` |
|        - | 4182 | `	}` |
|     7835 | 4183 | `	if( pClass == 0 ){` |
|      ! 0 | 4184 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 4185 | `		return SXERR_ABORT;` |
|        - | 4186 | `	}` |
|     7835 | 4187 | `	GenStateConsumeDoc(&(*pGen),&pClass->sDoc);` |
|     7835 | 4188 | `	if( GenStateConsumeAttrs(&(*pGen),&pClass->aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 4189 | `		return SXERR_ABORT;` |
|        - | 4190 | `	}` |
|        - | 4191 | `	/* Traits cannot extend or implement; expect opening brace directly */` |
|     7835 | 4192 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_OCB) == 0 ){` |
...
|        - | 4199 | `	}` |
|     7835 | 4200 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|     7835 | 4201 | `	pEnd = 0;` |
|     7835 | 4202 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB,PH7_TK_CCB,&pEnd);` |
|     7835 | 4203 | `	if( pEnd >= pGen->pEnd ){` |
...
|     7835 | 4212 | `	pClass->nEndLine = pEnd->nLine;` |
|        - | 4213 | `	/* Swap token stream */` |
|     7835 | 4214 | `	pTmp = pGen->pEnd;` |
|     7835 | 4215 | `	pGen->pEnd = pEnd;` |
|        - | 4216 | `	/* Mark as trait (PH7_NewRawClass may have set INTERNAL) */` |
|     7835 | 4217 | `	pClass->iFlags \|= PH7_CLASS_TRAIT;` |
|        - | 4218 | `	/* Parse the body: same as a normal class (methods, attributes, visibility modifiers) */` |
|    56130 | 4219 | `	for(;;){` |
|   158695 | 4220 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|    23223 | 4221 | `			pGen->pIn++;` |
|        5 | 4222 | `		}` |
|   135477 | 4223 | `		if( pGen->pIn >= pGen->pEnd ){` |
|     7835 | 4224 | `			break;` |
|        - | 4225 | `		}` |
|        - | 4226 | `		/* Bind a directly-preceding docblock to this member */` |
|   127647 | 4227 | `		GenStateSetPendingDoc(&(*pGen));` |
|   127647 | 4228 | `		if( (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR)) == 0 ){` |
...
|      ! 0 | 4235 | `			goto done;` |
|        - | 4236 | `		}` |
|   127647 | 4237 | `		iProtection = PH7_TKWRD_PUBLIC;` |
|   127647 | 4238 | `		iAttrflags = 0;` |
|   127647 | 4239 | `		if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|   127647 | 4240 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   127647 | 4241 | `			if( nKwrd == PH7_TKWRD_USE ){` |
...
|        5 | 4282 | `				continue;` |
|        - | 4283 | `			}` |
|   127643 | 4284 | `			if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|   127625 | 4285 | `				iProtection = nKwrd;` |
|   127625 | 4286 | `				pGen->pIn++;` |
...
|   127625 | 4290 | `				if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|        5 | 4291 | `					iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|        5 | 4292 | `					pGen->pIn++; /* Jump the 'readonly' modifier */` |
|        2 | 4293 | `				}` |
|   127620 | 4294 | `				if( pGen->pIn >= pGen->pEnd` |
|   127625 | 4295 | `					\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|      ! 0 | 4302 | `					goto done;` |
|        - | 4303 | `				}` |
|   127625 | 4304 | `				if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|    23203 | 4305 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|    23203 | 4306 | `					if( rc != SXRET_OK ){` |
...
|    23203 | 4312 | `					continue;` |
|        - | 4313 | `				}` |
|   104427 | 4314 | `				if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|        9 | 4322 | `					continue;` |
|        - | 4323 | `				}` |
|   104419 | 4324 | `				nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    52207 | 4325 | `			}` |
|   104437 | 4326 | `			if( nKwrd == PH7_TKWRD_CONST ){` |
...
|      ! 0 | 4332 | `				goto done;` |
|      ! 0 | 4333 | `			}else{` |
|   104437 | 4334 | `				if( nKwrd == PH7_TKWRD_STATIC ){` |
|     7743 | 4335 | `					iAttrflags \|= PH7_CLASS_ATTR_STATIC;` |
|     7743 | 4336 | `					pGen->pIn++;` |
|     7743 | 4337 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|     7741 | 4338 | `						nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|     7741 | 4339 | `						if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|      ! 0 | 4340 | `							iProtection = nKwrd;` |
|      ! 0 | 4341 | `							pGen->pIn++;` |
|      ! 0 | 4342 | `						}` |
|     3868 | 4343 | `					}` |
|     7738 | 4344 | `					if( pGen->pIn >= pGen->pEnd` |
|     7743 | 4345 | `						\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|      ! 0 | 4352 | `						goto done;` |
|        - | 4353 | `					}` |
|     7743 | 4354 | `					if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
...
|        3 | 4362 | `						continue;` |
|        - | 4363 | `					}` |
|     7741 | 4364 | `					if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|      ! 0 | 4372 | `						continue;` |
|        - | 4373 | `					}` |
|     7741 | 4374 | `					nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   100567 | 4375 | `				}else if( nKwrd == PH7_TKWRD_ABSTRACT ){` |
...
|        3 | 4396 | `				}` |
|   104435 | 4397 | `				if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_VAR ){` |
...
|      ! 0 | 4404 | `					goto done;` |
|        - | 4405 | `				}` |
|   104435 | 4406 | `				if( nKwrd == PH7_TKWRD_VAR ){` |
|      ! 0 | 4407 | `					pGen->pIn++;` |
...
|      ! 0 | 4417 | `				}else{` |
|   104435 | 4418 | `					rc = GenStateCompileClassMethod(&(*pGen),iProtection,iAttrflags,TRUE,pClass);` |
|        - | 4419 | `				}` |
|   104435 | 4420 | `				if( rc != SXRET_OK ){` |
...
|     7835 | 4438 | `	if( GenStateGuardClassRedeclaration(pGen,pClass) == SXERR_ABORT ){` |
|        3 | 4439 | `		return SXERR_ABORT;` |
|        - | 4440 | `	}` |
|        - | 4441 | `	/* Install the trait */` |
|     7833 | 4442 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|     7833 | 4443 | `	if( rc != SXRET_OK ){` |
...
|     7833 | 4449 | `	pGen->pIn = &pEnd[1];` |
|     7833 | 4450 | `	pGen->pEnd = pTmp;` |
|     7833 | 4451 | `	return PH7_OK;` |
|     3920 | 4452 | `}` |
|        - | 4453 | `/*` |
...
|        - | 4461 | ` */` |
|   403696 | 4462 | `PH7_PRIVATE sxi32 PH7_CompileClass(ph7_gen_state *pGen)` |
|        5 | 4463 | `{` |
|        - | 4464 | `	sxi32 rc;` |
|   403701 | 4465 | `	rc = GenStateCompileClass(&(*pGen),0);` |
|   403701 | 4466 | `	return rc;` |
|        5 | 4467 | `}` |
|        - | 4468 | `/*` |
...
|        - | 4474 | ` */` |
| 14201472 | 4475 | `PH7_PRIVATE int GenStateStartsEnumDecl(SyToken *pIn,SyToken *pEnd)` |
|        5 | 4476 | `{` |
| 14416739 | 4477 | `	return (pIn->nType & PH7_TK_ID)` |
|  7315998 | 4478 | `		&& pIn->sData.nByte == sizeof("enum")-1` |
|   225070 | 4479 | `		&& SyStrnicmp(pIn->sData.zString,"enum",sizeof("enum")-1) == 0` |
| 14416734 | 4480 | `		&& &pIn[1] < pEnd && (pIn[1].nType & PH7_TK_ID);` |
|        5 | 4481 | `}` |
|        - | 4482 | `/*` |
...
|        - | 4487 | ` */` |
|     3902 | 4488 | `PH7_PRIVATE sxi32 PH7_CompileEnum(ph7_gen_state *pGen)` |
|        5 | 4489 | `{` |
|     3907 | 4490 | `	return GenStateCompileClass(&(*pGen),PH7_CLASS_ENUM\|PH7_CLASS_FINAL);` |
|        5 | 4491 | `}` |
|        - | 4492 |  |
