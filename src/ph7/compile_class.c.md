...
|        - |   26 | ` */` |
|   531212 |   27 | `static sxi32 GenStateGuardClassRedeclaration(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 |   28 | `{` |
|        - |   29 | `	SyHashEntry *pEntry;` |
|   531217 |   30 | `	if( !GenStateUnconditionalTopLevel(pGen) ){` |
|       26 |   31 | `		return SXRET_OK; /* conditional/nested: keep hoisting */` |
|        - |   32 | `	}` |
|   531195 |   33 | `	pClass->iFlags \|= PH7_CLASS_BOUND;` |
|   531195 |   34 | `	if( pGen->pVm->bCompilingBuiltin ){` |
|   529045 |   35 | `		return SXRET_OK; /* the prelude installs each builtin exactly once */` |
|        - |   36 | `	}` |
...
|        - |   70 | ` */` |
|  3838752 |   71 | `static sxi32 GetProtectionLevel(sxi32 nKeyword)` |
|        5 |   72 | `{` |
|  3838757 |   73 | `	if( nKeyword == PH7_TKWRD_PRIVATE ){` |
|   280311 |   74 | `		return PH7_CLASS_PROT_PRIVATE;` |
|  3558451 |   75 | `	}else if( nKeyword == PH7_TKWRD_PROTECTED ){` |
|   221837 |   76 | `		return PH7_CLASS_PROT_PROTECTED;` |
|        - |   77 | `	}` |
|        - |   78 | `	/* Assume public by default */` |
|  3336619 |   79 | `	return PH7_CLASS_PROT_PUBLIC;` |
|  1919381 |   80 | `}` |
|        - |   81 | `/*` |
...
|        - |   88 | ` */` |
|   342528 |   89 | `static int GenStateClassConstHasType(ph7_gen_state *pGen)` |
|        5 |   90 | `{` |
|        - |   91 | `	SyToken *p0, *p1;` |
|   342533 |   92 | `	if( pGen->pIn >= pGen->pEnd ){` |
|      ! 0 |   93 | `		return 0;` |
|        - |   94 | `	}` |
|   342533 |   95 | `	p0 = pGen->pIn;` |
|        - |   96 | `	/* A leading '\' (namespaced class type) or '?' (nullable) always starts a type */` |
|   342533 |   97 | `	if( p0->nType & PH7_TK_NSSEP ){` |
|      ! 0 |   98 | `		return 1;` |
|        - |   99 | `	}` |
|   342533 |  100 | `	if( (p0->nType & PH7_TK_OP) && p0->sData.nByte == 1 && p0->sData.zString[0] == '?' ){` |
|        5 |  101 | `		return 1;` |
|        - |  102 | `	}` |
...
|   342529 |  106 | `	if( p0->nType & (PH7_TK_ID\|PH7_TK_KEYWORD) ){` |
|   342529 |  107 | `		p1 = (pGen->pIn + 1 < pGen->pEnd) ? (pGen->pIn + 1) : 0;` |
|   342529 |  108 | `		if( p1 ){` |
|   342529 |  109 | `			if( p1->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_NSSEP) ){` |
|       34 |  110 | `				return 1;` |
|        - |  111 | `			}` |
|   342499 |  112 | `			if( (p1->nType & PH7_TK_OP) && p1->sData.nByte == 1 && p1->sData.zString[0] == '\|' ){` |
|        5 |  113 | `				return 1;` |
|        - |  114 | `			}` |
|   171245 |  115 | `		}` |
|   171245 |  116 | `	}` |
...
|        - |  172 | ` */` |
|   724524 |  173 | `static int GenStateInitHasNewExpr(ph7_gen_state *pGen)` |
|        5 |  174 | `{` |
|   724529 |  175 | `	SyToken *p = pGen->pIn;` |
|   724529 |  176 | `	int iDepth = 0;` |
|  1913545 |  177 | `	while( p < pGen->pEnd ){` |
|  1913545 |  178 | `		if( iDepth == 0 && (p->nType & (PH7_TK_SEMI\|PH7_TK_COMMA)) ){` |
|   724477 |  179 | `			break; /* end of this initializer */` |
|        - |  180 | `		}` |
|  1189068 |  181 | `		if( (p->nType & PH7_TK_KEYWORD)` |
|   602339 |  182 | `			&& ( SX_PTR_TO_INT(p->pUserData) == PH7_TKWRD_FUNCTION` |
|    15599 |  183 | `				\|\| SX_PTR_TO_INT(p->pUserData) == PH7_TKWRD_FN ) ){` |
...
|        6 |  241 | `			continue;` |
|        - |  242 | `		}` |
|  1189069 |  243 | `		if( p->nType & PH7_TK_OCB ){` |
|       45 |  244 | `			if( iDepth == 0 ){` |
...
|        - |  250 | `			}` |
|      ! 0 |  251 | `			iDepth++;` |
|  1189025 |  252 | `		}else if( p->nType & (PH7_TK_LPAREN\|PH7_TK_OSB) ){` |
|    50675 |  253 | `			iDepth++;` |
|  1163690 |  254 | `		}else if( p->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB) ){` |
|    50673 |  255 | `			if( iDepth > 0 ){` |
|    50673 |  256 | `				iDepth--;` |
|    25334 |  257 | `			}` |
|  1113021 |  258 | `		}else if( (p->nType & PH7_TK_OP) && p->pUserData` |
|   392007 |  259 | `			&& ((const ph7_expr_op *)p->pUserData)->iOp == EXPR_OP_NEW ){` |
...
|        - |  277 | ` */` |
|  1277424 |  278 | `static ph7_class_attr * GenStateExtractConstant(ph7_class *pClass,SyString *pName)` |
|        5 |  279 | `{` |
|  1277429 |  280 | `	ph7_class_attr *pAttr = PH7_ClassExtractAttribute(pClass,pName->zString,pName->nByte);` |
|  1277429 |  281 | `	return ( pAttr && (pAttr->iFlags & PH7_CLASS_ATTR_CONSTANT) ) ? pAttr : 0;` |
|        5 |  282 | `}` |
|  1527372 |  283 | `static ph7_class_attr * GenStateExtractProperty(ph7_class *pClass,const char *zName,sxu32 nByte)` |
|        5 |  284 | `{` |
|  1527377 |  285 | `	ph7_class_attr *pAttr = PH7_ClassExtractAttribute(pClass,zName,nByte);` |
|  1527377 |  286 | `	return ( pAttr && (pAttr->iFlags & PH7_CLASS_ATTR_CONSTANT) == 0 ) ? pAttr : 0;` |
|        5 |  287 | `}` |
|        - |  288 | `/*` |
...
|        - |  308 | ` */` |
|   724574 |  309 | `PH7_PRIVATE int PH7_GenStateInitHasCallExpr(ph7_gen_state *pGen)` |
|        5 |  310 | `{` |
|   724579 |  311 | `	SyToken *p = pGen->pIn;` |
|   724579 |  312 | `	int iDepth = 0;` |
|        - |  313 | `	/* Conservative ternary bail-out (see the note above). */` |
|        - |  314 | `	{` |
|   724579 |  315 | `		SyToken *q = pGen->pIn;` |
|   724579 |  316 | `		int iQd = 0;` |
|  1914893 |  317 | `		while( q < pGen->pEnd ){` |
|  1914855 |  318 | `			if( iQd == 0 && (q->nType & (PH7_TK_SEMI\|PH7_TK_COMMA)) ){` |
|   724535 |  319 | `				break;` |
|        - |  320 | `			}` |
|  1190325 |  321 | `			if( q->nType & (PH7_TK_LPAREN\|PH7_TK_OSB\|PH7_TK_OCB) ){` |
|    50811 |  322 | `				iQd++;` |
|  1164922 |  323 | `			}else if( q->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB) ){` |
|    50811 |  324 | `				if( iQd > 0 ){ iQd--; }` |
|  1114116 |  325 | `			}else if( (q->nType & PH7_TK_OP) && q->pUserData` |
|   392233 |  326 | `				&& ((const ph7_expr_op *)q->pUserData)->iOp == EXPR_OP_QUESTY ){` |
|        8 |  327 | `				return 0;` |
|        - |  328 | `			}` |
|  1190319 |  329 | `			q++;` |
|        5 |  330 | `		}` |
|        - |  331 | `	}` |
|  1913739 |  332 | `	while( p < pGen->pEnd ){` |
|  1913739 |  333 | `		if( iDepth == 0 && (p->nType & (PH7_TK_SEMI\|PH7_TK_COMMA)) ){` |
|   724529 |  334 | `			break; /* end of this initializer */` |
|        - |  335 | `		}` |
|  1189210 |  336 | `		if( (p->nType & PH7_TK_KEYWORD)` |
|   602410 |  337 | `			&& ( SX_PTR_TO_INT(p->pUserData) == PH7_TKWRD_FUNCTION` |
|    15599 |  338 | `				\|\| SX_PTR_TO_INT(p->pUserData) == PH7_TKWRD_FN ) ){` |
...
|        6 |  388 | `			continue;` |
|        - |  389 | `		}` |
|  1189211 |  390 | `		if( p->nType & PH7_TK_OCB ){` |
|       43 |  391 | `			if( iDepth == 0 ){` |
|       43 |  392 | `				break; /* property-hook list: the default expression ends here */` |
|        - |  393 | `			}` |
|      ! 0 |  394 | `			iDepth++;` |
|  1189169 |  395 | `		}else if( p->nType & (PH7_TK_LPAREN\|PH7_TK_OSB) ){` |
...
|    50690 |  399 | `			if( (p->nType & PH7_TK_LPAREN) && p > pGen->pIn` |
|    15590 |  400 | `				&& (p[-1].nType & PH7_TK_ID)` |
|     7807 |  401 | `				&& !((p[-1].nType & PH7_TK_OP) && p[-1].pUserData` |
...
|        6 |  421 | `			}` |
|    50693 |  422 | `			iDepth++;` |
|  1163823 |  423 | `		}else if( p->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB) ){` |
|    50693 |  424 | `			if( iDepth > 0 ){` |
|    50693 |  425 | `				iDepth--;` |
|    25344 |  426 | `			}` |
|    25344 |  427 | `		}` |
|  1189167 |  428 | `		p++;` |
...
|        - |  439 | ` */` |
|    15954 |  440 | `static void GenStateCopyTypeToAttr(ph7_class_attr *pAttr,sxu32 nType,` |
|        - |  441 | `	const SyString *pClass,const SyString *pTypeName,sxi32 iTypeFlags,SySet *pAlts)` |
|        5 |  442 | `{` |
|    15959 |  443 | `	pAttr->nType = nType;` |
|    15959 |  444 | `	pAttr->sClass = *pClass;` |
|    15959 |  445 | `	pAttr->sTypeName = *pTypeName;` |
|    15959 |  446 | `	if( iTypeFlags & PH7_CLASS_ATTR_UNION ){` |
|        - |  447 | `		sxu32 i;` |
...
|       11 |  452 | `	}` |
|    15959 |  453 | `}` |
|   342528 |  454 | `static sxi32 GenStateCompileClassConstant(ph7_gen_state *pGen,sxi32 iProtection,sxi32 iFlags,ph7_class *pClass)` |
|        5 |  455 | `{` |
|   342533 |  456 | `	sxu32 nLine = pGen->pIn->nLine;` |
|        - |  457 | `	SySet *pInstrContainer;` |
|        - |  458 | `	ph7_class_attr *pCons;` |
|        - |  459 | `	SyString *pName;` |
|        - |  460 | `	sxi32 rc;` |
|   342533 |  461 | `	sxu32 nType = 0;` |
|        - |  462 | `	SyString sTypeClass;` |
|        - |  463 | `	SyString sTypeText;` |
|        - |  464 | `	SySet aUnionAlts;` |
|   342533 |  465 | `	sxi32 iTypeFlags = 0;` |
|   342533 |  466 | `	SyStringInitFromBuf(&sTypeClass,0,0);` |
|   342533 |  467 | `	SyStringInitFromBuf(&sTypeText,0,0);` |
|   342533 |  468 | `	SySetInit(&aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|        - |  469 | `	/* Extract visibility level */` |
|   342533 |  470 | `	iProtection = GetProtectionLevel(iProtection);` |
|        - |  471 | `	/* Mark as constant */` |
|   342533 |  472 | `	iFlags \|= PH7_CLASS_ATTR_CONSTANT;` |
|   342533 |  473 | `	pGen->pIn++; /* Jump the 'const' keyword */` |
...
|   342552 |  476 | `	if( GenStateClassConstHasType(pGen) ){` |
...
|       19 |  497 | `	}` |
|   171264 |  498 | `loop:` |
|   342535 |  499 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
...
|   342535 |  509 | `	pName = &pGen->pIn->sData;` |
|        - |  510 | `	/* Make sure the constant name isn't reserved */` |
|   342535 |  511 | `	if( GenStateIsReservedConstant(pName) ){` |
...
|   342535 |  521 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
...
|   342533 |  532 | `	pGen->pIn++;` |
|   342533 |  533 | `	if(pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_EQUAL /* '=' */) == 0 ){` |
...
|        - |  541 | `	}` |
|   342533 |  542 | `	pGen->pIn++; /* Jump the equal sign */` |
...
|   342528 |  547 | `	if( (iTypeFlags & PH7_CLASS_ATTR_TYPED) && !(iTypeFlags & PH7_CLASS_ATTR_UNION)` |
...
|   342529 |  559 | `	if( PH7_GenStateInitHasCallExpr(pGen) ){` |
...
|   342529 |  570 | `	if( GenStateInitHasNewExpr(pGen) ){` |
...
|   342520 |  586 | `	if( GenStateExtractConstant(pClass,pName) == 0` |
|   342525 |  587 | `	 && GenStateExtractProperty(pClass,pName->zString,pName->nByte) != 0 ){` |
...
|        - |  595 | `	}` |
|   342525 |  596 | `	if( GenStateExtractConstant(pClass,pName) != 0 ){` |
...
|   342525 |  605 | `	pCons = PH7_NewClassAttr(pGen->pVm,pName,nLine,iProtection,iFlags\|iTypeFlags);` |
|   342525 |  606 | `	if( pCons ){` |
|   342525 |  607 | `		GenStateConsumeDoc(&(*pGen),&pCons->sDoc);` |
|   342525 |  608 | `		if( GenStateConsumeAttrs(&(*pGen),&pCons->aAttrs) == SXERR_ABORT ){` |
|      ! 0 |  609 | `			return SXERR_ABORT;` |
|        - |  610 | `		}` |
|   171260 |  611 | `	}` |
|   342525 |  612 | `	if( pCons == 0 ){` |
|      ! 0 |  613 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 |  614 | `		return SXERR_ABORT;` |
|        - |  615 | `	}` |
|   342525 |  616 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|       35 |  617 | `		GenStateCopyTypeToAttr(pCons,nType,&sTypeClass,&sTypeText,iTypeFlags,&aUnionAlts);` |
|       16 |  618 | `	}` |
|        - |  619 | `	/* Swap bytecode container */` |
|   342525 |  620 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   342525 |  621 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pCons->aByteCode);` |
|        - |  622 | `	/* Compile constant value.` |
|        - |  623 | `	 */` |
|   342525 |  624 | `	rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|   342525 |  625 | `	if( rc == SXERR_EMPTY ){` |
...
|   342525 |  632 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|   342525 |  633 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|   342525 |  634 | `	if( rc == SXERR_ABORT ){` |
...
|   342525 |  639 | `	rc = PH7_ClassInstallAttr(pClass,pCons);` |
|   342525 |  640 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  641 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 |  642 | `		return SXERR_ABORT;` |
|        - |  643 | `	}` |
|   342525 |  644 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA /*','*/) ){` |
...
|        - |  662 | `		}` |
|      ! 0 |  663 | `	}` |
|   342523 |  664 | `	SySetRelease(&aUnionAlts);` |
|   342523 |  665 | `	return SXRET_OK;` |
|        5 |  666 | `Synchronize:` |
...
|        - |  702 | ` */` |
|  2627736 |  703 | `static int GenStateLooksLikeTypedProperty(SyToken *pStart,SyToken *pEnd)` |
|        5 |  704 | `{` |
|  2627741 |  705 | `	SyToken *p = pStart;` |
|  2627741 |  706 | `	int bFirst = 1;` |
|  2627741 |  707 | `	if( p >= pEnd ) return 0;` |
|        - |  708 | ``	/* Optional nullable `?` shorthand. */`` |
|  2627741 |  709 | `	if( (p->nType & PH7_TK_OP) && p->sData.nByte == 1 && p->sData.zString[0] == '?' ){` |
|       41 |  710 | `		p++;` |
...
|  1313868 |  717 | `	for(;;){` |
|  2627761 |  718 | `		if( p < pEnd && (p->nType & PH7_TK_LPAREN) ){` |
...
|  2627759 |  727 | `			if( p < pEnd && (p->nType & PH7_TK_NSSEP) ){ p++; }` |
|  2627759 |  728 | `			if( p >= pEnd \|\| (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|      ! 0 |  729 | `				return 0;` |
|        - |  730 | `			}` |
...
|  2627759 |  734 | `			if( bFirst && (p->nType & PH7_TK_KEYWORD) ){` |
|  2627703 |  735 | `				sxu32 k = (sxu32)(SX_PTR_TO_INT(p->pUserData));` |
|  2627698 |  736 | `				if( k == PH7_TKWRD_FUNCTION \|\| k == PH7_TKWRD_VAR \|\| k == PH7_TKWRD_CONST` |
|   124982 |  737 | `				 \|\| k == PH7_TKWRD_STATIC \|\| k == PH7_TKWRD_FINAL \|\| k == PH7_TKWRD_ABSTRACT ){` |
|  2611825 |  738 | `					return 0;` |
|        - |  739 | `				}` |
|     7939 |  740 | `			}` |
|    15939 |  741 | `			p++;` |
|    15941 |  742 | `			while( p + 1 < pEnd && (p->nType & PH7_TK_NSSEP) && (p[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|        3 |  743 | `				p += 2;` |
|        1 |  744 | `			}` |
|    23904 |  745 | `			while( p + 1 < pEnd && (p->nType & PH7_TK_AMPER)` |
|    15942 |  746 | `				&& (p[1].nType & (PH7_TK_NSSEP\|PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|        3 |  747 | `				p++; /* skip '&' */` |
...
|        - |  755 | `		}` |
|    15941 |  756 | `		bFirst = 0;` |
|    15936 |  757 | `		if( p < pEnd && (p->nType & PH7_TK_OP) && p->sData.nByte == 1` |
...
|    15921 |  762 | `		break;` |
|      ! 0 |  763 | `	}` |
|    15921 |  764 | `	if( p >= pEnd ) return 0;` |
|    15921 |  765 | `	return (p->nType & PH7_TK_DOLLAR) ? 1 : 0;` |
|  1313873 |  766 | `}` |
|        - |  767 |  |
|        - |  768 | `/*` |
...
|        - |  785 | ` */` |
|    15926 |  786 | `static sxi32 GenStateParsePropertyType(` |
...
|        - |  792 | `	SySet *pAlts` |
|        5 |  793 | `){` |
|    15931 |  794 | `	sxi32 iFlags = 0;` |
|        - |  795 | `	sxi32 rc;` |
|    15931 |  796 | `	if( pGen->pIn >= pGen->pEnd ){` |
|      ! 0 |  797 | `		return SXRET_OK;` |
|        - |  798 | `	}` |
|        - |  799 | `	/* If the first token is '$', there's no type */` |
|    15931 |  800 | `	if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|      ! 0 |  801 | `		return SXRET_OK;` |
|        - |  802 | `	}` |
|    15931 |  803 | `	rc = GenStateParseUnionTypeDecl(` |
|     7963 |  804 | `		pGen, pnType, pClass, pAlts, &iFlags, pTypeText,` |
|        - |  805 | `		PH7_CLASS_ATTR_NULLABLE,` |
|        - |  806 | `		PH7_CLASS_ATTR_UNION,` |
|        - |  807 | `		/* bAllowVoid */ 0,` |
|    15926 |  808 | `		pGen->pIn->nLine);` |
|    15931 |  809 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  810 | `		return rc;` |
|        - |  811 | `	}` |
|        - |  812 | `	/* Verify next token is '$' (start of property name) */` |
|    15931 |  813 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
|      ! 0 |  814 | `		return SXERR_SYNTAX;` |
|        - |  815 | `	}` |
|    15931 |  816 | `	*piTypeFlags = iFlags \| PH7_CLASS_ATTR_TYPED;` |
|    15931 |  817 | `	return SXRET_OK;` |
|     7968 |  818 | `}` |
|        - |  819 |  |
|        - |  820 | `/*` |
...
|        - |  830 | ` */` |
|    16104 |  831 | `static int GenStateIsDisallowedPropertyAtom(` |
|        - |  832 | `	sxu32 nType,` |
...
|        - |  837 | `	const char *z;` |
|        - |  838 | `	sxu32 n;` |
|    16109 |  839 | `	if( nType != SXU32_HIGH \|\| pClass == 0 \|\| pClass->nByte == 0 ){` |
|    16043 |  840 | `		return 0;` |
|        - |  841 | `	}` |
...
|        - |  863 | ` */` |
|    16042 |  864 | `PH7_PRIVATE sxi32 GenStateValidateMemberType(` |
...
|        - |  873 | `	sxu32 nLine)` |
|        5 |  874 | `{` |
|    16047 |  875 | `	const char *zBad = 0;` |
|    16047 |  876 | `	sxu32 nBad = 0;` |
|        - |  877 | `	SyString sFallback;` |
|        - |  878 | `	const SyString *pBad;` |
|        - |  879 | `	sxi32 rc;` |
|    16047 |  880 | `	int bDisallowed = 0;` |
|    16047 |  881 | `	if( GenStateIsDisallowedPropertyAtom(nType,pTypeClass,&zBad,&nBad) ){` |
|        5 |  882 | `		bDisallowed = 1;` |
|    16045 |  883 | `	}else if( pUnionAlts ){` |
|        - |  884 | `		sxu32 i;` |
...
|       34 |  891 | `		}` |
|       15 |  892 | `	}` |
|    16047 |  893 | `	if( !bDisallowed ){` |
|    16041 |  894 | `		return SXRET_OK;` |
|        - |  895 | `	}` |
...
|        - |  918 | ` */` |
| 23583196 |  919 | `PH7_PRIVATE int GenStateIsReadonly(SyToken *pTok)` |
|        5 |  920 | `{` |
| 23809683 |  921 | `	return (pTok->nType & PH7_TK_ID)` |
| 12018080 |  922 | `		&& pTok->sData.nByte == sizeof("readonly")-1` |
| 23809678 |  923 | `		&& SyStrnicmp(pTok->sData.zString,"readonly",sizeof("readonly")-1) == 0;` |
|        5 |  924 | `}` |
|        - |  925 | `/*` |
...
|        - |  930 | ` */` |
|  8468488 |  931 | `PH7_PRIVATE sxi32 GenStatePeekSetVisibility(SyToken *pTok,SyToken *pEnd,int *pnTok)` |
|        5 |  932 | `{` |
|  8468493 |  933 | `	*pnTok = 0;` |
|  8468488 |  934 | `	if( &pTok[3] < pEnd` |
|  7917200 |  935 | `	 && (pTok->nType & PH7_TK_KEYWORD)` |
|  6456811 |  936 | `	 && (pTok[1].nType & PH7_TK_LPAREN)` |
|  2773863 |  937 | `	 && (pTok[2].nType & (PH7_TK_ID\|PH7_TK_KEYWORD))` |
...
|        9 |  959 | `}` |
|   592394 |  960 | `static sxi32 GenStateCompileClassAttr(ph7_gen_state *pGen,sxi32 iProtection,sxi32 iFlags,ph7_class *pClass)` |
|        5 |  961 | `{` |
|   592399 |  962 | `	sxu32 nLine = pGen->pIn->nLine;` |
|        - |  963 | `	ph7_class_attr *pAttr;` |
|        - |  964 | `	SyString *pName;` |
|        - |  965 | `	sxi32 rc;` |
|   592399 |  966 | `	sxu32 nType = 0;` |
|        - |  967 | `	SyString sTypeClass;` |
|        - |  968 | `	SyString sTypeText;` |
|        - |  969 | `	SySet aUnionAlts;` |
|   592399 |  970 | `	sxi32 iTypeFlags = 0;` |
|   592399 |  971 | `	SyStringInitFromBuf(&sTypeClass,0,0);` |
|   592399 |  972 | `	SyStringInitFromBuf(&sTypeText,0,0);` |
|   592399 |  973 | `	SySetInit(&aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
...
|   592399 |  977 | `	if( pClass->iFlags & PH7_CLASS_READONLY ){` |
|       21 |  978 | `		iFlags \|= PH7_CLASS_ATTR_READONLY;` |
|        9 |  979 | `	}` |
|        - |  980 | `	/* Extract visibility level */` |
|   592399 |  981 | `	iProtection = GetProtectionLevel(iProtection);` |
|        - |  982 | `	/* Parse optional type hint (typed properties, PHP 7.4+) */` |
|   600362 |  983 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
|    15931 |  984 | `		rc = GenStateParsePropertyType(pGen,&nType,&sTypeClass,&iTypeFlags,&sTypeText,&aUnionAlts);` |
|    15931 |  985 | `		if( rc == SXERR_CORRUPT ){` |
|        - |  986 | `			/* Error already reported by GenStateParseUnionTypeDecl */` |
|      ! 0 |  987 | `			goto Synchronize;` |
|    15931 |  988 | `		}else if( rc == SXERR_SYNTAX ){` |
...
|    15931 |  996 | `		}else if( rc == SXERR_ABORT ){` |
|      ! 0 |  997 | `			return SXERR_ABORT;` |
|        - |  998 | `		}` |
|     7963 |  999 | `	}` |
|      ! 0 | 1000 | `loop:` |
|   592403 | 1001 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
...
|        - | 1007 | `	}` |
|   592403 | 1008 | `	pGen->pIn++; /* Jump the dollar sign */` |
|   592403 | 1009 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_ID)) == 0 ){` |
...
|   592403 | 1019 | `	pName = &pGen->pIn->sData;` |
|        - | 1020 | `	/* Advance the stream cursor */` |
|   592403 | 1021 | `	pGen->pIn++;` |
|   592403 | 1022 | `	if(pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_EQUAL/*'='*/\|PH7_TK_SEMI/*';'*/\|PH7_TK_COMMA/*','*/\|PH7_TK_OCB/*'{' hooks*/)) == 0 ){` |
...
|   592401 | 1034 | `	if( iFlags & (PH7_CLASS_ATTR_PRIVATE_SET\|PH7_CLASS_ATTR_PROTECTED_SET\|PH7_CLASS_ATTR_PUBLIC_SET) ){` |
...
|   592401 | 1054 | `	if( iFlags & PH7_CLASS_ATTR_READONLY ){` |
...
|   592391 | 1074 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|    23891 | 1075 | `		rc = GenStateValidateMemberType(pGen,pClass,pName,nType,&sTypeClass,` |
|        - | 1076 | `			&sTypeText,` |
|    15924 | 1077 | `			(iTypeFlags & PH7_CLASS_ATTR_UNION) ? &aUnionAlts : 0,` |
|     7962 | 1078 | `			"Property %z::$%z cannot have type %z",nLine);` |
|    15929 | 1079 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 | 1080 | `			return SXERR_ABORT;` |
|    15929 | 1081 | `		}else if( rc != SXRET_OK ){` |
...
|   592386 | 1088 | `	if( GenStateExtractProperty(pClass,pName->zString,pName->nByte) == 0` |
|   592390 | 1089 | `	 && GenStateExtractConstant(pClass,pName) != 0 ){` |
...
|        - | 1097 | `	}` |
|   592391 | 1098 | `	if( GenStateExtractProperty(pClass,pName->zString,pName->nByte) != 0 ){` |
...
|   592389 | 1113 | `	if( (pGen->pIn->nType & PH7_TK_EQUAL /*'='*/) && PH7_GenStateInitHasCallExpr(pGen) ){` |
...
|        - | 1120 | `	}` |
|   592389 | 1121 | `	if( (pGen->pIn->nType & PH7_TK_EQUAL /*'='*/) && GenStateInitHasNewExpr(pGen) ){` |
...
|   592385 | 1130 | `	pAttr = PH7_NewClassAttr(pGen->pVm,pName,nLine,iProtection,iFlags\|iTypeFlags);` |
|   592385 | 1131 | `	if( pAttr ){` |
|   592385 | 1132 | `		GenStateConsumeDoc(&(*pGen),&pAttr->sDoc);` |
|   592385 | 1133 | `		if( GenStateConsumeAttrs(&(*pGen),&pAttr->aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 1134 | `			return SXERR_ABORT;` |
|        - | 1135 | `		}` |
|   296190 | 1136 | `	}` |
|   592385 | 1137 | `	if( pAttr == 0 ){` |
|      ! 0 | 1138 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 engine is running out of memory");` |
|      ! 0 | 1139 | `		return SXERR_ABORT;` |
|        - | 1140 | `	}` |
|   592385 | 1141 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|    15927 | 1142 | `		GenStateCopyTypeToAttr(pAttr,nType,&sTypeClass,&sTypeText,iTypeFlags,&aUnionAlts);` |
|     7961 | 1143 | `	}` |
|   592385 | 1144 | `	if( pGen->pIn->nType & PH7_TK_EQUAL /*'='*/ ){` |
|        - | 1145 | `		SySet *pInstrContainer;` |
|   382001 | 1146 | `		SyToken *pSavedDefEnd = pGen->pEnd;` |
|   382001 | 1147 | `		pGen->pIn++; /*Jump the equal sign */` |
|        - | 1148 | `		{` |
...
|   382001 | 1153 | `			SyToken *pScan = pGen->pIn;` |
|   382001 | 1154 | `			sxi32 iNest = 0;` |
|   842375 | 1155 | `			while( pScan < pGen->pEnd ){` |
|   842375 | 1156 | `				if( pScan->nType & (PH7_TK_LPAREN\|PH7_TK_OSB) ){` |
|    50663 | 1157 | `					iNest++;` |
|   817046 | 1158 | `				}else if( pScan->nType & (PH7_TK_RPAREN\|PH7_TK_CSB) ){` |
|    50663 | 1159 | `					iNest--;` |
|   766388 | 1160 | `				}else if( iNest <= 0 && (pScan->nType & (PH7_TK_SEMI\|PH7_TK_COMMA\|PH7_TK_OCB)) ){` |
|   382001 | 1161 | `					break;` |
|        - | 1162 | `				}` |
|   460379 | 1163 | `				pScan++;` |
|        5 | 1164 | `			}` |
|   382001 | 1165 | `			pGen->pEnd = pScan;` |
|        - | 1166 | `		}` |
|        - | 1167 | `		/* Swap bytecode container */` |
|   382001 | 1168 | `		pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   382001 | 1169 | `		PH7_VmSetByteCodeContainer(pGen->pVm,&pAttr->aByteCode);` |
|        - | 1170 | `		/* Compile attribute value.` |
|        - | 1171 | `		 */` |
|   382001 | 1172 | `		rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|   382001 | 1173 | `		if( rc == SXERR_EMPTY ){` |
...
|   382001 | 1180 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|   382001 | 1181 | `		PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|   382001 | 1182 | `		pGen->pIn = pGen->pEnd;   /* land exactly on the delimiter */` |
|   382001 | 1183 | `		pGen->pEnd = pSavedDefEnd;` |
|   190998 | 1184 | `	}` |
|        - | 1185 | `	/* All done,install the attribute */` |
|   592385 | 1186 | `	rc = PH7_ClassInstallAttr(pClass,pAttr);` |
|   592385 | 1187 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 1188 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 1189 | `		return SXERR_ABORT;` |
|        - | 1190 | `	}` |
|   592385 | 1191 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) ){` |
...
|        - | 1203 | `	}` |
|   592291 | 1204 | `	if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
...
|        - | 1215 | `	}` |
|   592291 | 1216 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA /*','*/) ){` |
...
|        - | 1234 | `		}` |
|      ! 0 | 1235 | `	}` |
|   592287 | 1236 | `	SySetRelease(&aUnionAlts);` |
|   592287 | 1237 | `	return SXRET_OK;` |
|        9 | 1238 | `Synchronize:` |
...
|        - | 1253 | ` */` |
|  2903830 | 1254 | `static sxi32 GenStateCompileClassMethod(` |
...
|        - | 1260 | `	)` |
|        5 | 1261 | `{` |
|  2903835 | 1262 | `	sxu32 nLine = pGen->pIn->nLine;` |
|  2903835 | 1263 | `	sxu32 nKwLine = nLine; /* Line of the 'function' keyword (Reflection getStartLine) */` |
...
|  2903835 | 1270 | `	iProtection = GetProtectionLevel(iProtection);` |
|  2903835 | 1271 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|  2903835 | 1272 | `	iFuncFlags = 0;` |
|  2903835 | 1273 | `	if( pGen->pIn >= pGen->pEnd ){` |
...
|        - | 1281 | `	}` |
|  2903835 | 1282 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|        - | 1283 | `		/* Return by reference,remember that */` |
|      ! 0 | 1284 | `		iFuncFlags \|= VM_FUNC_REF_RETURN;` |
|        - | 1285 | `		/* Jump the '&' token */` |
|      ! 0 | 1286 | `		pGen->pIn++;` |
|      ! 0 | 1287 | `	}` |
|  2903835 | 1288 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|  2903835 | 1297 | `	pName = &pGen->pIn->sData;` |
|  2903835 | 1298 | `	nLine = pGen->pIn->nLine;` |
|        - | 1299 | `	/* Jump the method name */` |
|  2903835 | 1300 | `	pGen->pIn++;` |
|  2903835 | 1301 | `	if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|        - | 1302 | `		/* Abstract method */` |
|   140121 | 1303 | `		if( iProtection == PH7_CLASS_PROT_PRIVATE ){` |
...
|   140121 | 1312 | `		doBody = FALSE;` |
|    70058 | 1313 | `	}` |
|  2903835 | 1314 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|        - | 1315 | `		/* Syntax error */` |
...
|  2903835 | 1324 | `	pMeth = PH7_NewClassMethod(pGen->pVm,pClass,pName,nLine,iProtection,iFlags,iFuncFlags);` |
|  2903835 | 1325 | `	if( pMeth == 0 ){` |
|      ! 0 | 1326 | `		PH7_GenCompileError(&(*pGen),E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 1327 | `		return SXERR_ABORT;` |
|        - | 1328 | `	}` |
|  2903835 | 1329 | `	pMeth->sFunc.nLine = nKwLine;` |
|  2903835 | 1330 | `	GenStateConsumeDoc(&(*pGen),&pMeth->sFunc.sDoc);` |
|  2903835 | 1331 | `	if( GenStateConsumeAttrs(&(*pGen),&pMeth->sFunc.aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 1332 | `		return SXERR_ABORT;` |
|        - | 1333 | `	}` |
|        - | 1334 | `	/* Jump the left parenthesis '(' */` |
|  2903835 | 1335 | `	pGen->pIn++;` |
|  2903835 | 1336 | `	pEnd = 0; /* cc warning */` |
|        - | 1337 | `	/* Delimit the method signature */` |
|  2903835 | 1338 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|  2903835 | 1339 | `	if( pEnd >= pGen->pEnd ){` |
|        - | 1340 | `		/* Syntax error */` |
...
|        - | 1347 | `	}` |
|        - | 1348 | `	{` |
|  2903833 | 1349 | `		int bIsCtor = 0;` |
|  2903833 | 1350 | `		int bAbstractCtor = 0;` |
|  2903828 | 1351 | `		if( (pName->nByte == sizeof("__construct") - 1` |
|  1704935 | 1352 | `				&& SyMemcmp(pName->zString,"__construct",sizeof("__construct") - 1) == 0)` |
|  2800635 | 1353 | `		 \|\| SyStringCmp(pName,&pClass->sName,SyMemcmp) == 0 ){` |
|   206401 | 1354 | `			if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|        3 | 1355 | `				bAbstractCtor = 1;` |
|        2 | 1356 | `			}else{` |
|   206399 | 1357 | `				bIsCtor = 1;` |
|        - | 1358 | `			}` |
|   103198 | 1359 | `		}` |
|  2903833 | 1360 | `		if( pGen->pIn < pEnd ){` |
|        - | 1361 | `			/* Collect method arguments */` |
|  1117175 | 1362 | `			rc = GenStateCollectFuncArgs(&pMeth->sFunc,&(*pGen),pEnd,bIsCtor,bAbstractCtor);` |
|  1117175 | 1363 | `			if( rc == SXERR_ABORT ){` |
|      ! 0 | 1364 | `				return SXERR_ABORT;` |
|        - | 1365 | `			}` |
|   558585 | 1366 | `		}` |
|        - | 1367 | `	}` |
|        - | 1368 | `	/* Point past ')' and parse optional return type ': type' */` |
|  2903833 | 1369 | `	pGen->pIn = &pEnd[1];` |
|        - | 1370 | `	{` |
|  2903833 | 1371 | `		sxi32 rcRt = GenStateParseReturnType(pGen, &pMeth->sFunc);` |
|  2903833 | 1372 | `		if( rcRt == SXERR_ABORT ){` |
|      ! 0 | 1373 | `			return SXERR_ABORT;` |
|  2903833 | 1374 | `		}else if( rcRt == SXERR_SYNTAX ){` |
...
|        - | 1381 | `	{` |
|  2903833 | 1382 | `		sxu32 nArg = SySetUsed(&pMeth->sFunc.aArgs);` |
|        - | 1383 | `		sxu32 i;` |
|  4573577 | 1384 | `		for( i = 0; i < nArg; i++ ){` |
|  1669759 | 1385 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pMeth->sFunc.aArgs,i);` |
|        - | 1386 | `			ph7_class_attr *pAttr;` |
|  1669759 | 1387 | `			sxi32 iAttrFlags = 0;` |
|        - | 1388 | `			int bArgTyped;` |
|  1669759 | 1389 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|  1669673 | 1390 | `				continue;` |
|        - | 1391 | `			}` |
...
|       43 | 1486 | `		}` |
|        - | 1487 | `	}` |
|  2903823 | 1488 | `	if( doBody ){` |
|        - | 1489 | `		/* Compile method body */` |
|  2763707 | 1490 | `		rc = GenStateCompileFuncBody(&(*pGen),&pMeth->sFunc);` |
|  2763707 | 1491 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 | 1492 | `			return SXERR_ABORT;` |
|        - | 1493 | `		}` |
|        - | 1494 | `		/* The cursor sits just past the body's closing brace */` |
|  2763707 | 1495 | `		pMeth->sFunc.nEndLine = pGen->pIn[-1].nLine;` |
|  1381856 | 1496 | `	}else{` |
|        - | 1497 | `		/* Abstract/interface method: declaration ends at the ';' */` |
|   140121 | 1498 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI /* ';'*/) ){` |
|   140121 | 1499 | `			pMeth->sFunc.nEndLine = pGen->pIn->nLine;` |
|    70058 | 1500 | `		}` |
|        - | 1501 | `		/* Only method signature is allowed */` |
|   140121 | 1502 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI /* ';'*/) == 0 ){` |
...
|  2903818 | 1517 | `	if( (pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT)` |
|  1521972 | 1518 | `	 && (pClass->iFlags & (PH7_CLASS_ABSTRACT\|PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT)) == 0 ){` |
...
|  2903821 | 1531 | `	if( PH7_ClassExtractMethod(pClass,pName->zString,pName->nByte) != 0 ){` |
...
|  2903817 | 1540 | `	rc = PH7_ClassInstallMethod(pClass,pMeth);` |
|  2903817 | 1541 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 1542 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 1543 | `		return SXERR_ABORT;` |
|        - | 1544 | `	}` |
|  2903817 | 1545 | `	return SXRET_OK;` |
|        6 | 1546 | `Synchronize:` |
...
|        - | 2001 | ` */` |
|    70144 | 2002 | `PH7_PRIVATE sxi32 PH7_CompileClassInterface(ph7_gen_state *pGen)` |
|        5 | 2003 | `{` |
|    70149 | 2004 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|    70149 | 2013 | `	pName = &pGen->pIn->sData;` |
|        - | 2014 | `	/* Advance the stream cursor */` |
|    70149 | 2015 | `	pGen->pIn++;` |
|        - | 2016 | `	/* Build FQN and obtain a raw class */ {` |
|        - | 2017 | `		SyBlob sFQN;` |
|        - | 2018 | `		SyString sFQNStr;` |
|    70149 | 2019 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|    70149 | 2020 | `		GenStateBuildFQN(pGen,pName,&sFQN);` |
|    70149 | 2021 | `		SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|    70149 | 2022 | `		pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|    70149 | 2023 | `		SyBlobRelease(&sFQN);` |
|        - | 2024 | `	}` |
|    70149 | 2025 | `	if( pClass == 0 ){` |
|      ! 0 | 2026 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2027 | `		return SXERR_ABORT;` |
|        - | 2028 | `	}` |
|    70149 | 2029 | `	GenStateConsumeDoc(&(*pGen),&pClass->sDoc);` |
|    70149 | 2030 | `	if( GenStateConsumeAttrs(&(*pGen),&pClass->aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 2031 | `		return SXERR_ABORT;` |
|        - | 2032 | `	}` |
|        - | 2033 | `	/* Mark as an interface (PH7_NewRawClass may have set INTERNAL) */` |
|    70149 | 2034 | `	pClass->iFlags \|= PH7_CLASS_INTERFACE;` |
|        - | 2035 | `	/* Assume no base class is given */` |
|    70149 | 2036 | `	pBase = 0;` |
|    70149 | 2037 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|    27247 | 2038 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    27247 | 2039 | `		if( nKwrd == PH7_TKWRD_EXTENDS /* interface b extends a, c, … */ ){` |
...
|    27249 | 2050 | `				nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|    27249 | 2051 | `				SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|    27249 | 2052 | `				if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|        - | 2062 | `				}` |
|    40871 | 2063 | `				pParent = PH7_VmExtractClass(pGen->pVm,` |
|    27244 | 2064 | `					(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|    27249 | 2065 | `				SyStringInitFromBuf(&sBaseName,` |
|        - | 2066 | `					(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|        - | 2067 | `				/* Only interfaces is allowed */` |
|    27249 | 2068 | `				while( pParent && (pParent->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|      ! 0 | 2069 | `					pParent = pParent->pNextName;` |
|      ! 0 | 2070 | `				}` |
|    27249 | 2071 | `				if( pParent == 0 ){` |
...
|      ! 0 | 2077 | `					}` |
|    27249 | 2078 | `				}else if( pBase == 0 ){` |
|        - | 2079 | `					/* First parent → single-inheritance base */` |
|    27247 | 2080 | `					pBase = pParent;` |
|    13626 | 2081 | `				}else{` |
...
|        - | 2085 | `				}` |
|    27249 | 2086 | `				SyBlobRelease(&sResolved);` |
|        - | 2087 | `				/* Continue on a comma-separated list */` |
|    27249 | 2088 | `				if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA) ){` |
|        3 | 2089 | `					pGen->pIn++;` |
|        3 | 2090 | `					continue;` |
|        - | 2091 | `				}` |
|    27247 | 2092 | `				break;` |
...
|    13621 | 2094 | `		}` |
|    13621 | 2095 | `	}` |
|    70149 | 2096 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|        - | 2097 | `		/* Syntax error */` |
...
|        - | 2105 | `	}` |
|    70149 | 2106 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|    70149 | 2107 | `	pEnd = 0; /* cc warning */` |
|        - | 2108 | `	/* Delimit the interface body */` |
|    70149 | 2109 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|    70149 | 2110 | `	if( pEnd >= pGen->pEnd ){` |
|        - | 2111 | `		/* Syntax error */` |
...
|    70149 | 2121 | `	pClass->nEndLine = pEnd->nLine;` |
|        - | 2122 | `	/* Swap token stream */` |
|    70149 | 2123 | `	pTmp = pGen->pEnd;` |
|    70149 | 2124 | `	pGen->pEnd = pEnd;` |
...
|   443725 | 2132 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|   186791 | 2133 | `			pGen->pIn++;` |
|        5 | 2134 | `		}` |
|   256939 | 2135 | `		if( pGen->pIn >= pGen->pEnd ){` |
|        - | 2136 | `			/* End of interface body */` |
|    70145 | 2137 | `			break;` |
|        - | 2138 | `		}` |
|        - | 2139 | `		/* Bind a directly-preceding docblock to this member */` |
|   186799 | 2140 | `		GenStateSetPendingDoc(&(*pGen));` |
|   186799 | 2141 | `		if( (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|   186799 | 2152 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   186799 | 2153 | `		if( nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
...
|        3 | 2182 | `			goto done;` |
|        - | 2183 | `		}` |
|   186797 | 2184 | `		if( nKwrd != PH7_TKWRD_PUBLIC && nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|      ! 0 | 2191 | `			goto done;` |
|        - | 2192 | `		}` |
|   186797 | 2193 | `		if( nKwrd == PH7_TKWRD_PUBLIC ){` |
|        - | 2194 | `			/* Advance the stream cursor */` |
|   132319 | 2195 | `			pGen->pIn++;` |
|   132314 | 2196 | `			if( pGen->pIn < pGen->pEnd` |
|   132319 | 2197 | `			 && ((pGen->pIn->nType & PH7_TK_DOLLAR) != 0` |
|   132314 | 2198 | `			  \|\| (pGen->pIn->sData.nByte == 1 && pGen->pIn->sData.zString[0] == '?')) ){` |
...
|      ! 0 | 2212 | `				continue;` |
|        - | 2213 | `			}` |
|   132319 | 2214 | `			if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|      ! 0 | 2236 | `				goto done;` |
|        - | 2237 | `			}` |
|   132319 | 2238 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   132319 | 2239 | `			if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|        - | 2261 | `			}` |
|    66155 | 2262 | `		}` |
|   186793 | 2263 | `		if( nKwrd == PH7_TKWRD_CONST ){` |
|        - | 2264 | `			/* Parse constant */` |
|    54479 | 2265 | `			rc = GenStateCompileClassConstant(&(*pGen),0,0,pClass);` |
|    54479 | 2266 | `			if( rc != SXRET_OK ){` |
...
|        - | 2271 | `			}` |
|    27241 | 2272 | `		}else{` |
|   132319 | 2273 | `			sxi32 iFlags = PH7_CLASS_ATTR_ABSTRACT; /* Interface methods are implicitly abstract */` |
|   132319 | 2274 | `			if( nKwrd == PH7_TKWRD_STATIC ){` |
|        - | 2275 | `				/* Static method,record that */` |
|    11675 | 2276 | `				iFlags \|= PH7_CLASS_ATTR_STATIC;` |
|        - | 2277 | `				/* Advance the stream cursor */` |
|    11675 | 2278 | `				pGen->pIn++;` |
|    11670 | 2279 | `				if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0` |
|    11675 | 2280 | `					\|\| SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_FUNCTION ){` |
...
|   132319 | 2291 | `			rc = GenStateCompileClassMethod(&(*pGen),0,iFlags,FALSE,pClass);` |
|   132319 | 2292 | `			if( rc != SXRET_OK ){` |
...
|    70145 | 2301 | `	if( GenStateGuardClassRedeclaration(pGen,pClass) == SXERR_ABORT ){` |
|        3 | 2302 | `		return SXERR_ABORT;` |
|        - | 2303 | `	}` |
|        - | 2304 | `	/* Install the interface */` |
|    70143 | 2305 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|    70143 | 2306 | `	if( rc == SXRET_OK && pBase ){` |
|        - | 2307 | `		/* Inherit from the base interface */` |
|    27247 | 2308 | `		rc = PH7_ClassInterfaceInherit(pClass,pBase);` |
|    13621 | 2309 | `	}` |
|    70143 | 2310 | `	if( rc != SXRET_OK ){` |
...
|    70147 | 2316 | `	pGen->pIn  = &pEnd[1];` |
|    70147 | 2317 | `	pGen->pEnd = pTmp;` |
|    70147 | 2318 | `	return PH7_OK;` |
|    35077 | 2319 | `}` |
|        - | 2320 | `/*` |
...
|        - | 2344 | ` */` |
|   453186 | 2345 | `static sxi32 GenStateCheckInterfaceSignatures(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 | 2346 | `{` |
|        - | 2347 | `	ph7_class **apIface;` |
|        - | 2348 | `	sxu32 nIface,i;` |
|        - | 2349 | `	sxi32 rc;` |
|   453191 | 2350 | `	if( pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|      ! 0 | 2351 | `		return SXRET_OK;` |
|        - | 2352 | `	}` |
|   453191 | 2353 | `	apIface = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|   453191 | 2354 | `	nIface = SySetUsed(&pClass->aInterface);` |
|   877555 | 2355 | `	for(i = 0; i < nIface; i++){` |
|   424369 | 2356 | `		ph7_class *pIface = apIface[i];` |
|        - | 2357 | `		SyHashEntry *pEntry;` |
|   424369 | 2358 | `		SyHashResetLoopCursor(&pIface->hMethod);` |
|  1249655 | 2359 | `		while((pEntry = SyHashGetNextEntry(&pIface->hMethod)) != 0 ){` |
|   825291 | 2360 | `			ph7_class_method *pIfaceMeth = (ph7_class_method *)pEntry->pUserData;` |
|        - | 2361 | `			ph7_class_method *pImplMeth;` |
|   825291 | 2362 | `			SyString *pMName = &pIfaceMeth->sFunc.sName;` |
|        - | 2363 | `			/* Find the implementing method in the class */` |
|   825291 | 2364 | `			pImplMeth = PH7_ClassExtractMethod(pClass,pMName->zString,pMName->nByte);` |
|   825291 | 2365 | `			if( pImplMeth == 0 \|\| (pImplMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT) ){` |
...
|   825273 | 2369 | `			if( pImplMeth->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|        - | 2379 | `			 */` |
|        - | 2380 | `			{` |
|   825273 | 2381 | `				sxu32 nIfaceArgs = SySetUsed(&pIfaceMeth->sFunc.aArgs);` |
|   825273 | 2382 | `				sxu32 nImplArgs = SySetUsed(&pImplMeth->sFunc.aArgs);` |
|   825273 | 2383 | `				int sigError = 0;` |
|   825273 | 2384 | `				if( nImplArgs < nIfaceArgs ){` |
|        3 | 2385 | `					sigError = 1;` |
|   825272 | 2386 | `				}else if( nImplArgs > nIfaceArgs ){` |
|        - | 2387 | `					/* Extra parameters must all have default values */` |
|     3899 | 2388 | `					ph7_vm_func_arg *aImplArgs = (ph7_vm_func_arg *)SySetBasePtr(&pImplMeth->sFunc.aArgs);` |
|        - | 2389 | `					sxu32 k;` |
|     7791 | 2390 | `					for(k = nIfaceArgs; k < nImplArgs; k++){` |
|     3899 | 2391 | `						if( SySetUsed(&aImplArgs[k].aByteCode) == 0 ){` |
|        3 | 2392 | `							sigError = 1;` |
|        3 | 2393 | `							break;` |
|        - | 2394 | `						}` |
|     1951 | 2395 | `					}` |
|     1947 | 2396 | `				}` |
|   825273 | 2397 | `				if( sigError ){` |
...
|        - | 2477 | ` */` |
|   453186 | 2478 | `static sxi32 GenStateCheckAbstractMethods(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 | 2479 | `{` |
...
|   453191 | 2486 | `	if( pClass->iFlags & (PH7_CLASS_ABSTRACT\|PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|    19507 | 2487 | `		return SXRET_OK;` |
|        - | 2488 | `	}` |
|        - | 2489 | `	/* Count abstract methods */` |
|   433689 | 2490 | `	nAbstract = 0;` |
|   433689 | 2491 | `	SyHashResetLoopCursor(&pClass->hMethod);` |
|  6480587 | 2492 | `	while((pEntry = SyHashGetNextEntry(&pClass->hMethod)) != 0 ){` |
|  5830061 | 2493 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|  5830061 | 2494 | `		if( pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
...
|        8 | 2499 | `		}` |
|        5 | 2500 | `	}` |
|   433689 | 2501 | `	if( nAbstract == 0 ){` |
|   433675 | 2502 | `		return SXRET_OK;` |
|        - | 2503 | `	}` |
...
|        - | 2640 | ` */` |
|   515838 | 2641 | `PH7_PRIVATE sxi32 GenStateParseClassReference(ph7_gen_state *pGen,SyBlob *pFqn)` |
|        5 | 2642 | `{` |
|   515843 | 2643 | `	int isAbsolute = 0;` |
|   515843 | 2644 | `	SyToken *pStart = pGen->pIn;` |
|        - | 2645 | `	SyBlob sName;` |
|   515843 | 2646 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) ){` |
|     4545 | 2647 | `		isAbsolute = 1;` |
|     4545 | 2648 | `		pGen->pIn++;` |
|     2270 | 2649 | `	}` |
|   515843 | 2650 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|        9 | 2651 | `		pGen->pIn = pStart;` |
|        9 | 2652 | `		return SXERR_INVALID;` |
|        - | 2653 | `	}` |
|   515837 | 2654 | `	SyBlobInit(&sName,&pGen->pVm->sAllocator);` |
|   515837 | 2655 | `	SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|   515837 | 2656 | `	pGen->pIn++;` |
|   773787 | 2657 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) &&` |
|   257960 | 2658 | `		&pGen->pIn[1] < pGen->pEnd && (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|       28 | 2659 | `		SyBlobAppend(&sName,"\\",1);` |
|       28 | 2660 | `		pGen->pIn++;` |
|       28 | 2661 | `		SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|       28 | 2662 | `		pGen->pIn++;` |
|        2 | 2663 | `	}` |
|   515837 | 2664 | `	if( isAbsolute ){` |
|     4543 | 2665 | `		SyBlobAppend(pFqn,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|     2274 | 2666 | `	}else{` |
|        - | 2667 | `		SyString sRaw;` |
|   511299 | 2668 | `		SyStringInitFromBuf(&sRaw,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|   511299 | 2669 | `		GenStateResolveName(pGen,&sRaw,pFqn);` |
|        - | 2670 | `	}` |
|   515837 | 2671 | `	SyBlobRelease(&sName);` |
|   515837 | 2672 | `	return SXRET_OK;` |
|   257924 | 2673 | `}` |
|        - | 2674 | `/*` |
...
|   198602 | 2682 | `static int GenStateInterfaceIsThrowableAt(ph7_class *pInterface,int iDepth)` |
|        5 | 2683 | `{` |
|        - | 2684 | `	ph7_class **apParent;` |
|        - | 2685 | `	sxu32 n;` |
|   525619 | 2686 | `	while( pInterface ){` |
|   334807 | 2687 | `		if( iDepth > PH7_THROWABLE_WALK_MAX_DEPTH ){` |
|      ! 0 | 2688 | `			return FALSE;` |
|        - | 2689 | `		}` |
|   373727 | 2690 | `		if( pInterface->sName.nByte == sizeof("Throwable")-1 &&` |
|    77840 | 2691 | `			SyMemcmp(pInterface->sName.zString,"Throwable",sizeof("Throwable")-1) == 0 ){` |
|     7795 | 2692 | `			return TRUE;` |
|        - | 2693 | `		}` |
|   327017 | 2694 | `		apParent = (ph7_class **)SySetBasePtr(&pInterface->aInterface);` |
|   327019 | 2695 | `		for( n = 0 ; n < SySetUsed(&pInterface->aInterface) ; ++n ){` |
|        3 | 2696 | `			if( GenStateInterfaceIsThrowableAt(apParent[n],iDepth+1) ){` |
|      ! 0 | 2697 | `				return TRUE;` |
|        - | 2698 | `			}` |
|        2 | 2699 | `		}` |
|   327017 | 2700 | `		pInterface = pInterface->pBase;` |
|   327017 | 2701 | `		iDepth++;` |
|        5 | 2702 | `	}` |
|   190817 | 2703 | `	return FALSE;` |
|    99306 | 2704 | `}` |
|   198600 | 2705 | `static int GenStateInterfaceIsThrowable(ph7_class *pInterface)` |
|        5 | 2706 | `{` |
|   198605 | 2707 | `	return GenStateInterfaceIsThrowableAt(pInterface,0);` |
|        5 | 2708 | `}` |
|        - | 2709 | `/*` |
...
|        - | 2713 | ` */` |
|     7790 | 2714 | `static int GenStateClassIsExceptionOrError(ph7_class *pBase)` |
|        5 | 2715 | `{` |
|     7799 | 2716 | `	while( pBase ){` |
...
|        - | 2737 | ` */` |
|     7834 | 2738 | `static sxi32 GenStateCompileEnumCase(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 | 2739 | `{` |
|     7839 | 2740 | `	sxu32 nLine = pGen->pIn->nLine;` |
|        - | 2741 | `	SySet *pInstrContainer;` |
|        - | 2742 | `	ph7_class_attr *pCase;` |
|        - | 2743 | `	SyString *pName;` |
|        - | 2744 | `	sxi32 rc;` |
|     7839 | 2745 | `	pGen->pIn++; /* Jump the 'case' keyword */` |
|     7839 | 2746 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|        - | 2753 | `	}` |
|     7839 | 2754 | `	pName = &pGen->pIn->sData;` |
|        - | 2755 | `	/* Cases share the class-constant namespace (php: "Cannot redefine class constant") */` |
|     7839 | 2756 | `	if( SyHashGet(&pClass->hAttr,(const void *)pName->zString,pName->nByte) != 0 ){` |
...
|        - | 2763 | `	}` |
|     7839 | 2764 | `	pCase = PH7_NewClassAttr(pGen->pVm,pName,pGen->pIn->nLine,PH7_CLASS_PROT_PUBLIC,` |
|        - | 2765 | `		PH7_CLASS_ATTR_CONSTANT\|PH7_CLASS_ATTR_ENUMCASE);` |
|     7839 | 2766 | `	if( pCase == 0 ){` |
|      ! 0 | 2767 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2768 | `		return SXERR_ABORT;` |
|        - | 2769 | `	}` |
|     7839 | 2770 | `	GenStateConsumeDoc(&(*pGen),&pCase->sDoc);` |
|     7839 | 2771 | `	if( GenStateConsumeAttrs(&(*pGen),&pCase->aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 2772 | `		return SXERR_ABORT;` |
|        - | 2773 | `	}` |
|     7839 | 2774 | `	pGen->pIn++; /* Jump the case name */` |
|     7839 | 2775 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_EQUAL /* '=' */) ){` |
|     7825 | 2776 | `		if( pClass->nEnumBacking == 0 ){` |
...
|        - | 2783 | `		}` |
|     7821 | 2784 | `		pGen->pIn++; /* Jump the equal sign */` |
|        - | 2785 | `		/* Compile the backing value expression into the case's own container` |
|        - | 2786 | `		 * (same technique as class constants). */` |
|     7821 | 2787 | `		pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|     7821 | 2788 | `		PH7_VmSetByteCodeContainer(pGen->pVm,&pCase->aByteCode);` |
|     7821 | 2789 | `		rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|     7821 | 2790 | `		if( rc == SXERR_EMPTY ){` |
|      ! 0 | 2791 | `			rc = PH7_GenCompileError(pGen,E_ERROR,nLine,` |
|      ! 0 | 2792 | `				"Empty value for enum case %z::%z",&pClass->sName,pName);` |
|      ! 0 | 2793 | `		}` |
|     7821 | 2794 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|     7821 | 2795 | `		PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|     7821 | 2796 | `		if( rc == SXERR_ABORT ){` |
...
|        - | 2807 | `		}` |
|        - | 2808 | `	}` |
|     7835 | 2809 | `	rc = PH7_ClassInstallAttr(pClass,pCase);` |
|     7835 | 2810 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 2811 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2812 | `		return SXERR_ABORT;` |
|        - | 2813 | `	}` |
|     7835 | 2814 | `	SySetPut(&pClass->aEnumCases,(const void *)&pCase);` |
|     7835 | 2815 | `	return SXRET_OK;` |
|        2 | 2816 | `Synchronize:` |
...
|        - | 2831 | ` */` |
|     3922 | 2832 | `static sxi32 GenStateCompileEnumMethods(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 | 2833 | `{` |
...
|     3927 | 2839 | `	sxi32 rc = SXRET_OK;` |
|     3927 | 2840 | `	nMax = 3*(sxu32)sizeof("function tryFrom(string $value){return __phl_enum_tryfrom('',$value);}")` |
|     3922 | 2841 | `		+ 3*SyStringLength(&pClass->sName) + 64;` |
|     3927 | 2842 | `	zSrc = (char *)SyMemBackendAlloc(&pGen->pVm->sAllocator,nMax);` |
|     3927 | 2843 | `	if( zSrc == 0 ){` |
|      ! 0 | 2844 | `		PH7_GenCompileError(pGen,E_ERROR,pClass->nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2845 | `		return SXERR_ABORT;` |
|        - | 2846 | `	}` |
|     3927 | 2847 | `	zBack = (pClass->nEnumBacking == MEMOBJ_INT) ? "int" : "string";` |
|     3927 | 2848 | `	if( pClass->nEnumBacking != 0 ){` |
|     5861 | 2849 | `		nSrc = SyBufferFormat(zSrc,nMax,` |
...
|     1952 | 2853 | `			&pClass->sName,zBack,&pClass->sName,zBack,&pClass->sName);` |
|     1957 | 2854 | `	}else{` |
|       30 | 2855 | `		nSrc = SyBufferFormat(zSrc,nMax,` |
|        9 | 2856 | `			"function cases(){return __phl_enum_cases('%z');}",&pClass->sName);` |
|        - | 2857 | `	}` |
|     3927 | 2858 | `	SySetInit(&sToken,&pGen->pVm->sAllocator,sizeof(SyToken));` |
|     3927 | 2859 | `	PH7_TokenizePHP(zSrc,nSrc,pClass->nLine,&sToken,0);` |
|     3927 | 2860 | `	pSaveIn = pGen->pIn;` |
|     3927 | 2861 | `	pSaveEnd = pGen->pEnd;` |
|     3927 | 2862 | `	pGen->pIn = (SyToken *)SySetBasePtr(&sToken);` |
|     3927 | 2863 | `	pGen->pEnd = &pGen->pIn[SySetUsed(&sToken)];` |
|    15657 | 2864 | `	while( pGen->pIn < pGen->pEnd && rc != SXERR_ABORT ){` |
|    11735 | 2865 | `		rc = GenStateCompileClassMethod(&(*pGen),PH7_TKWRD_PUBLIC,PH7_CLASS_ATTR_STATIC,TRUE,pClass);` |
|        5 | 2866 | `	}` |
|     3927 | 2867 | `	pGen->pIn = pSaveIn;` |
|     3927 | 2868 | `	pGen->pEnd = pSaveEnd;` |
|     3927 | 2869 | `	SySetRelease(&sToken);` |
|     3927 | 2870 | `	return (rc == SXERR_ABORT) ? SXERR_ABORT : SXRET_OK;` |
|     1966 | 2871 | `}` |
|        - | 2872 | `/*` |
...
|        - | 2886 | ` */` |
|     3922 | 2887 | `static sxi32 GenStateEnumFinalize(ph7_gen_state *pGen,ph7_class *pClass,sxu32 nLine)` |
|        5 | 2888 | `{` |
|        - | 2889 | `	SyHashEntry *pEntry;` |
|        - | 2890 | `	sxi32 rc;` |
|        - | 2891 | `	sxu32 n;` |
|        - | 2892 | `	/* php: "Enum %s cannot include properties" */` |
|     3927 | 2893 | `	SyHashResetLoopCursor(&pClass->hAttr);` |
|    11763 | 2894 | `	while( (pEntry = SyHashGetNextEntry(&pClass->hAttr)) != 0 ){` |
|     7843 | 2895 | `		ph7_class_attr *pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|     7843 | 2896 | `		if( (pAttr->iFlags & PH7_CLASS_ATTR_CONSTANT) == 0 ){` |
...
|    54913 | 2906 | `	for( n = 0 ; n < SX_ARRAYSIZE(azEnumBannedMagic) ; n++ ){` |
|    76479 | 2907 | `		if( SyHashGet(&pClass->hMethod,(const void *)azEnumBannedMagic[n],` |
|    50991 | 2908 | `			SyStrlen(azEnumBannedMagic[n])) != 0 ){` |
...
|     3927 | 2924 | `		pAttr = PH7_NewClassAttr(pGen->pVm,&sNameProp,nLine,PH7_CLASS_PROT_PUBLIC,` |
|        - | 2925 | `			PH7_CLASS_ATTR_READONLY\|PH7_CLASS_ATTR_TYPED);` |
|     3927 | 2926 | `		if( pAttr == 0 ){` |
|      ! 0 | 2927 | `			PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2928 | `			return SXERR_ABORT;` |
|        - | 2929 | `		}` |
|     3927 | 2930 | `		pAttr->nType = MEMOBJ_STRING;` |
|     3927 | 2931 | `		SyStringInitFromBuf(&pAttr->sTypeName,"string",sizeof("string")-1);` |
|     3927 | 2932 | `		PH7_ClassInstallAttr(pClass,pAttr);` |
|     3927 | 2933 | `		if( pClass->nEnumBacking != 0 ){` |
|     3909 | 2934 | `			pAttr = PH7_NewClassAttr(pGen->pVm,&sValueProp,nLine,PH7_CLASS_PROT_PUBLIC,` |
|        - | 2935 | `				PH7_CLASS_ATTR_READONLY\|PH7_CLASS_ATTR_TYPED);` |
|     3909 | 2936 | `			if( pAttr == 0 ){` |
|      ! 0 | 2937 | `				PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2938 | `				return SXERR_ABORT;` |
|        - | 2939 | `			}` |
|     3909 | 2940 | `			pAttr->nType = pClass->nEnumBacking;` |
|     3909 | 2941 | `			if( pClass->nEnumBacking == MEMOBJ_INT ){` |
|        7 | 2942 | `				SyStringInitFromBuf(&pAttr->sTypeName,"int",sizeof("int")-1);` |
|        4 | 2943 | `			}else{` |
|     3903 | 2944 | `				SyStringInitFromBuf(&pAttr->sTypeName,"string",sizeof("string")-1);` |
|        - | 2945 | `			}` |
|     3909 | 2946 | `			PH7_ClassInstallAttr(pClass,pAttr);` |
|     1952 | 2947 | `		}` |
|        - | 2948 | `	}` |
|     3927 | 2949 | `	return GenStateCompileEnumMethods(&(*pGen),pClass);` |
|     1966 | 2950 | `}` |
|        - | 2951 | `/*` |
...
|        - | 2960 | ` */` |
|   453236 | 2961 | `static sxi32 GenStateCompileClassEx(ph7_gen_state *pGen,sxi32 iFlags,` |
|        - | 2962 | `	SyString *pAnonName,SyToken **ppArgStart,SyToken **ppArgEnd)` |
|        5 | 2963 | `{` |
|   453241 | 2964 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|   453241 | 2975 | `	pGen->pIn++;` |
|   453241 | 2976 | `	if( pAnonName ){` |
...
|       19 | 2991 | `	}else{` |
|   453211 | 2992 | `		if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
|        - | 2993 | `			/* Syntax error */` |
...
|   453211 | 3006 | `		pName = &pGen->pIn->sData;` |
|        - | 3007 | `		/* Advance the stream cursor */` |
|   453211 | 3008 | `		pGen->pIn++;` |
|        - | 3009 | `		/* Build FQN and obtain a raw class */ {` |
|        - | 3010 | `			SyBlob sFQN;` |
|        - | 3011 | `			SyString sFQNStr;` |
|   453211 | 3012 | `			SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|   453211 | 3013 | `			GenStateBuildFQN(pGen,pName,&sFQN);` |
|   453211 | 3014 | `			SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|   453211 | 3015 | `			pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|   453211 | 3016 | `			SyBlobRelease(&sFQN);` |
|        - | 3017 | `		}` |
|        - | 3018 | `	}` |
|   453241 | 3019 | `	if( pClass == 0 ){` |
|      ! 0 | 3020 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 3021 | `		return SXERR_ABORT;` |
|        - | 3022 | `	}` |
|   453236 | 3023 | `	if( (iFlags & PH7_CLASS_ENUM) && pGen->pIn < pGen->pEnd` |
|     3931 | 3024 | `		&& (pGen->pIn->nType & PH7_TK_COLON /* ':' */) ){` |
|        - | 3025 | ``		/* Backed enum: `enum Name: int\|string` (PHP 8.1) */`` |
|     3911 | 3026 | `		pGen->pIn++; /* Jump ':' */` |
|     3906 | 3027 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD)` |
|     3911 | 3028 | `			&& SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_INT ){` |
|        7 | 3029 | `			pClass->nEnumBacking = MEMOBJ_INT;` |
|        7 | 3030 | `			pGen->pIn++;` |
|     3904 | 3031 | `		}else if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD)` |
|     3905 | 3032 | `			&& SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_STRING ){` |
|     3903 | 3033 | `			pClass->nEnumBacking = MEMOBJ_STRING;` |
|     3903 | 3034 | `			pGen->pIn++;` |
|     1954 | 3035 | `		}else{` |
...
|        - | 3046 | `		}` |
|     1953 | 3047 | `	}` |
|   453241 | 3048 | `	GenStateConsumeDoc(&(*pGen),&pClass->sDoc);` |
|   453241 | 3049 | `	if( GenStateConsumeAttrs(&(*pGen),&pClass->aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 3050 | `		return SXERR_ABORT;` |
|        - | 3051 | `	}` |
|        - | 3052 | `	/* implemented interfaces and per-use-statement trait containers */` |
|   453241 | 3053 | `	SySetInit(&aInterfaces,&pGen->pVm->sAllocator,sizeof(ph7_class *));` |
|   453241 | 3054 | `	SySetInit(&aUseEntries,&pGen->pVm->sAllocator,sizeof(TraitUseEntry));` |
|        - | 3055 | `	/* Assume a standalone class */` |
|   453241 | 3056 | `	pBase = 0;` |
|   453241 | 3057 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|   370047 | 3058 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   370047 | 3059 | `		if( nKwrd == PH7_TKWRD_EXTENDS /* class b extends a */ ){` |
|        - | 3060 | `			SyBlob sResolved;` |
|        - | 3061 | `			SyString sBaseName;` |
|        - | 3062 | `			sxu32 nRefLine;` |
|   249277 | 3063 | `			if( iFlags & PH7_CLASS_ENUM ){` |
...
|        - | 3069 | `				}` |
|      ! 0 | 3070 | `			}` |
|   249277 | 3071 | `			pGen->pIn++; /* Advance past 'extends' */` |
|   249277 | 3072 | `			nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|   249277 | 3073 | `			SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|   249277 | 3074 | `			if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|        - | 3084 | `			}` |
|   373910 | 3085 | `			pBase = PH7_VmExtractClass(pGen->pVm,` |
|   249270 | 3086 | `				(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|   249275 | 3087 | `			SyStringInitFromBuf(&sBaseName,` |
|        - | 3088 | `				(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|        - | 3089 | `			/* Interfaces are not allowed */` |
|   249275 | 3090 | `			while( pBase && (pBase->iFlags & PH7_CLASS_INTERFACE) ){` |
|      ! 0 | 3091 | `				pBase = pBase->pNextName;` |
|      ! 0 | 3092 | `			}` |
|   249275 | 3093 | `			if( pBase == 0 ){` |
...
|        - | 3099 | `				}` |
|      ! 0 | 3100 | `			}else{` |
|   249275 | 3101 | `				if( pBase->iFlags & PH7_CLASS_ENUM ){` |
...
|   249274 | 3109 | `				}else if( pBase->iFlags & PH7_CLASS_FINAL ){` |
...
|      ! 0 | 3116 | `				}` |
|        - | 3117 | `			}` |
|   249275 | 3118 | `			SyBlobRelease(&sResolved);` |
|   249275 | 3119 | `			if( iFlags & PH7_CLASS_ENUM ){` |
|      ! 0 | 3120 | `				pBase = 0; /* Error already reported: enums have no base class */` |
|      ! 0 | 3121 | `			}` |
|   124635 | 3122 | `		}` |
|   370045 | 3123 | `		if (pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) && SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_IMPLEMENTS ){` |
|        - | 3124 | `			ph7_class *pInterface;` |
|        - | 3125 | `			/* Interface implementation */` |
|   136351 | 3126 | `			pGen->pIn++; /* Advance the stream cursor */` |
|   130427 | 3127 | `			for(;;){` |
|        - | 3128 | `				SyBlob sResolved;` |
|        - | 3129 | `				SyString sIntName;` |
|        - | 3130 | `				sxu32 nRefLine;` |
|   198605 | 3131 | `				nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|   198605 | 3132 | `				SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|   198605 | 3133 | `				if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|      ! 0 | 3141 | `					break;` |
|        - | 3142 | `				}` |
|   397205 | 3143 | `				pInterface = PH7_VmExtractClass(pGen->pVm,` |
|   198600 | 3144 | `					(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|   198605 | 3145 | `				SyStringInitFromBuf(&sIntName,` |
|        - | 3146 | `					(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|        - | 3147 | `				/* Only interfaces are allowed */` |
|   198605 | 3148 | `				while( pInterface && (pInterface->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|      ! 0 | 3149 | `					pInterface = pInterface->pNextName;` |
|      ! 0 | 3150 | `				}` |
|   198605 | 3151 | `				if( pInterface == 0 ){` |
...
|   198605 | 3165 | `					SyString *pFqn = &pClass->sName;` |
|   198605 | 3166 | `					int bIsExceptionOrError =` |
|   103194 | 3167 | `						(pFqn->nByte == sizeof("Exception")-1 &&` |
|   299849 | 3168 | `						 SyMemcmp(pFqn->zString,"Exception",sizeof("Exception")-1) == 0) \|\|` |
|   196662 | 3169 | `						(pFqn->nByte == sizeof("Error")-1 &&` |
|     3904 | 3170 | `						 SyMemcmp(pFqn->zString,"Error",sizeof("Error")-1) == 0);` |
|   202495 | 3171 | `					if( GenStateInterfaceIsThrowable(pInterface) &&` |
|    11688 | 3172 | `						!GenStateClassIsExceptionOrError(pBase) &&` |
|     3893 | 3173 | `						!bIsExceptionOrError ){` |
...
|        6 | 3183 | `					}else{` |
|   198599 | 3184 | `						SySetPut(&aInterfaces,(const void *)&pInterface);` |
|        - | 3185 | `					}` |
|        - | 3186 | `				}` |
|   198605 | 3187 | `				SyBlobRelease(&sResolved);` |
|   198605 | 3188 | `				if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COMMA) == 0 ){` |
|    68178 | 3189 | `					break;` |
|        - | 3190 | `				}` |
|    62259 | 3191 | `				pGen->pIn++;/* Jump the comma */` |
|        5 | 3192 | `			}` |
|    68173 | 3193 | `		}` |
|   185020 | 3194 | `	}` |
|   453239 | 3195 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|        - | 3196 | `		/* Syntax error */` |
...
|        - | 3204 | `	}` |
|   453239 | 3205 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|   453239 | 3206 | `	pEnd = 0; /* cc warning */` |
|        - | 3207 | `	/* Delimit the class body */` |
|   453239 | 3208 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|   453239 | 3209 | `	if( pEnd >= pGen->pEnd ){` |
|        - | 3210 | `		/* Syntax error */` |
...
|   453239 | 3220 | `	pClass->nEndLine = pEnd->nLine;` |
|        - | 3221 | `	/* Swap token stream */` |
|   453239 | 3222 | `	pTmp = pGen->pEnd;` |
|   453239 | 3223 | `	pGen->pEnd = pEnd;` |
|        - | 3224 | `	/* Merge the inherited flags (PH7_NewRawClass may have set INTERNAL) */` |
|   453239 | 3225 | `	pClass->iFlags \|= iFlags;` |
|        - | 3226 | `	/* Start the parse process */` |
|  1697958 | 3227 | `	for(;;){` |
|        - | 3228 | `		/* Jump leading/trailing semi-colons */` |
|  4876645 | 3229 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|   888235 | 3230 | `			pGen->pIn++;` |
|        5 | 3231 | `		}` |
|  3988415 | 3232 | `		if( pGen->pIn >= pGen->pEnd ){` |
|        - | 3233 | `			/* End of class body */` |
|   453197 | 3234 | `			break;` |
|        - | 3235 | `		}` |
|        - | 3236 | `		/* Bind a directly-preceding docblock to this member */` |
|  3535223 | 3237 | `		GenStateSetPendingDoc(&(*pGen));` |
|  3535218 | 3238 | `		if( (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR)) == 0` |
|  1767614 | 3239 | ``			&& !GenStateIsReadonly(pGen->pIn) /* allow a leading `readonly` modifier */ ){`` |
...
|  3535223 | 3250 | `		iProtection = PH7_TKWRD_PUBLIC;` |
|  3535223 | 3251 | `		iAttrflags = 0;` |
...
|  3535223 | 3256 | `		if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|      ! 0 | 3257 | `			int bMod = 0;` |
...
|        - | 3278 | `			}` |
|      ! 0 | 3279 | `		}` |
|  3535223 | 3280 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|        - | 3281 | `			/* Extract the current keyword */` |
|  3535223 | 3282 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  3535223 | 3283 | `			if( nKwrd == PH7_TKWRD_CASE && (pClass->iFlags & PH7_CLASS_ENUM) ){` |
|        - | 3284 | ``				/* Enum case declaration: `case NAME [= value];` */`` |
|     7839 | 3285 | `				rc = GenStateCompileEnumCase(&(*pGen),pClass);` |
|     7839 | 3286 | `				if( rc != SXRET_OK ){` |
...
|     7835 | 3292 | `				continue;` |
|        - | 3293 | `			}` |
|  3527389 | 3294 | `			if( nKwrd == PH7_TKWRD_USE ){` |
|        - | 3295 | `				/* Trait use: use TraitA, TraitB [{ ... }]; */` |
|        - | 3296 | `				TraitUseEntry sUse;` |
|    15655 | 3297 | `				SySetInit(&sUse.aTraits,&pGen->pVm->sAllocator,sizeof(ph7_class *));` |
|    15655 | 3298 | `				sUse.pResolvStart = sUse.pResolvEnd = 0;` |
|    15655 | 3299 | `				pGen->pIn++; /* Jump the 'use' keyword */` |
|     7833 | 3300 | `				for(;;){` |
|        - | 3301 | `					ph7_class *pTrait;` |
|        - | 3302 | `					SyBlob sResolved;` |
|        - | 3303 | `					SyString sTraitName;` |
|    15663 | 3304 | `					sxu32 nUseLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
...
|    15663 | 3311 | `					SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|    15663 | 3312 | `					if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|      ! 0 | 3319 | `						break;` |
|        - | 3320 | `					}` |
|    31321 | 3321 | `					pTrait = PH7_VmExtractClass(pGen->pVm,` |
|    15658 | 3322 | `						(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|    15663 | 3323 | `					SyStringInitFromBuf(&sTraitName,` |
|        - | 3324 | `						(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|        - | 3325 | `					/* Only traits are allowed */` |
|    15663 | 3326 | `					while( pTrait && (pTrait->iFlags & PH7_CLASS_TRAIT) == 0 ){` |
|      ! 0 | 3327 | `						pTrait = pTrait->pNextName;` |
|      ! 0 | 3328 | `					}` |
|    15663 | 3329 | `					if( pTrait == 0 ){` |
...
|        - | 3335 | `						}` |
|      ! 0 | 3336 | `					}else{` |
|    15663 | 3337 | `						SySetPut(&sUse.aTraits,(const void *)&pTrait);` |
|        - | 3338 | `					}` |
|    15663 | 3339 | `					SyBlobRelease(&sResolved);` |
...
|    15663 | 3342 | `					if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COMMA) == 0 ){` |
|     7830 | 3343 | `						break;` |
|        - | 3344 | `					}` |
|       10 | 3345 | `					pGen->pIn++; /* Jump the comma */` |
|        2 | 3346 | `				}` |
|        - | 3347 | `				/* Expect semicolon or opening brace (for conflict resolution) */` |
|    15655 | 3348 | `				if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OCB) ){` |
|        - | 3349 | `					SyToken *pBlock;` |
...
|        - | 3358 | `					}` |
|        5 | 3359 | `				}` |
|    15655 | 3360 | `				SySetPut(&aUseEntries,(const void *)&sUse);` |
|        - | 3361 | `				/* The semicolon will be consumed by the outer loop */` |
|    15655 | 3362 | `				continue;` |
|        - | 3363 | `			}` |
|  3511739 | 3364 | `			if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|        - | 3365 | `				int nSetTok;` |
|  2966599 | 3366 | `				sxi32 nSetVis = GenStatePeekSetVisibility(pGen->pIn,pGen->pEnd,&nSetTok);` |
|  2966599 | 3367 | `				if( nSetVis ){` |
...
|        2 | 3372 | `				}else{` |
|  2966597 | 3373 | `					iProtection = nKwrd;` |
|  2966597 | 3374 | `					pGen->pIn++; /* Jump the visibility token */` |
|        - | 3375 | `					/* Optional asymmetric set-visibility after the read` |
|        - | 3376 | ``					 * visibility: `public private(set) int $x`. */`` |
|  2966597 | 3377 | `					nSetVis = GenStatePeekSetVisibility(pGen->pIn,pGen->pEnd,&nSetTok);` |
|  2966597 | 3378 | `					if( nSetVis ){` |
...
|  2966599 | 3385 | `				if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|       28 | 3386 | `					iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|       28 | 3387 | `					pGen->pIn++; /* Jump the 'readonly' modifier */` |
|       12 | 3388 | `				}` |
|  2966594 | 3389 | `				if( pGen->pIn >= pGen->pEnd` |
|  2966599 | 3390 | `					\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|      ! 0 | 3398 | `					goto done;` |
|        - | 3399 | `				}` |
|  2966599 | 3400 | `				if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|        - | 3401 | `					/* Attribute declaration (untyped) */` |
|   525843 | 3402 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|   525843 | 3403 | `					if( rc != SXRET_OK ){` |
|       11 | 3404 | `						if( rc == SXERR_ABORT ){` |
|      ! 0 | 3405 | `							return SXERR_ABORT;` |
|        - | 3406 | `						}` |
|       11 | 3407 | `						goto done;` |
|        - | 3408 | `					}` |
|   533778 | 3409 | `					continue;` |
|        - | 3410 | `				}` |
|  2440761 | 3411 | `				if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
|        - | 3412 | `					/* Typed attribute declaration (PHP 7.4+) */` |
|    15897 | 3413 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|    15897 | 3414 | `					if( rc != SXRET_OK ){` |
...
|  2424869 | 3423 | `				nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  1212432 | 3424 | `			}` |
|  2970009 | 3425 | `			if( nKwrd == PH7_TKWRD_CONST ){` |
|        - | 3426 | `				/* Process constant declaration */` |
|   288047 | 3427 | `				rc = GenStateCompileClassConstant(&(*pGen),iProtection,iAttrflags,pClass);` |
|   288047 | 3428 | `				if( rc != SXRET_OK ){` |
...
|        - | 3433 | `				}` |
|   144022 | 3434 | `			}else{` |
|  2681967 | 3435 | `				if( nKwrd == PH7_TKWRD_STATIC ){` |
|        - | 3436 | `					/* Static method or attribute,record that */` |
|   101341 | 3437 | `					iAttrflags \|= PH7_CLASS_ATTR_STATIC;` |
|   101341 | 3438 | `					pGen->pIn++; /* Jump the static keyword */` |
|   101341 | 3439 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|        - | 3440 | `						int nSetTok;` |
|    74069 | 3441 | `						sxi32 nSetVis = GenStatePeekSetVisibility(pGen->pIn,pGen->pEnd,&nSetTok);` |
|    74069 | 3442 | `						if( nSetVis ){` |
...
|    74067 | 3448 | `							nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    74067 | 3449 | `							if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
...
|   101341 | 3463 | `					if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|      ! 0 | 3464 | `						iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|      ! 0 | 3465 | `						pGen->pIn++; /* Jump the 'readonly' modifier */` |
|      ! 0 | 3466 | `					}` |
|   101336 | 3467 | `					if( pGen->pIn >= pGen->pEnd` |
|   101341 | 3468 | `						\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|      ! 0 | 3476 | `						goto done;` |
|        - | 3477 | `					}` |
|   101341 | 3478 | `					if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|        - | 3479 | `						/* Attribute declaration */` |
|    27273 | 3480 | `						rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|    27273 | 3481 | `						if( rc != SXRET_OK ){` |
...
|    27271 | 3487 | `						continue;` |
|        - | 3488 | `					}` |
|    74073 | 3489 | `					if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|    74057 | 3501 | `					nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  2617657 | 3502 | `				}else if( nKwrd == PH7_TKWRD_ABSTRACT ){` |
...
|     7807 | 3511 | `					iAttrflags \|= PH7_CLASS_ATTR_ABSTRACT;` |
|        - | 3512 | `					/* Advance the stream cursor */` |
|     7807 | 3513 | `					pGen->pIn++;` |
|     7807 | 3514 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|     7807 | 3515 | `						nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|     7807 | 3516 | `						if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|     7805 | 3517 | `							iProtection = nKwrd;` |
|     7805 | 3518 | `							pGen->pIn++; /* Jump the visibility token */` |
|     3900 | 3519 | `						}` |
|     3901 | 3520 | `					}` |
|     7807 | 3521 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|     7802 | 3522 | `						SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_STATIC ){` |
|        - | 3523 | `							/* Static method */` |
|      ! 0 | 3524 | `							iAttrflags \|= PH7_CLASS_ATTR_STATIC;` |
|      ! 0 | 3525 | `							pGen->pIn++; /* Jump the static keyword */` |
|      ! 0 | 3526 | `					}` |
|     7807 | 3527 | `					if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 \|\|` |
|     7802 | 3528 | `						SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_FUNCTION ){` |
...
|      ! 0 | 3553 | `							goto done;` |
|        - | 3554 | `					}` |
|     7801 | 3555 | `					nKwrd = PH7_TKWRD_FUNCTION;` |
|  2576727 | 3556 | `				}else if( nKwrd == PH7_TKWRD_FINAL ){` |
...
|        3 | 3600 | `				}` |
|  2654665 | 3601 | `				if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_VAR ){` |
...
|      ! 0 | 3609 | `						goto done;` |
|        - | 3610 | `				}` |
|  2654665 | 3611 | `				if( nKwrd == PH7_TKWRD_VAR ){` |
...
|  2654659 | 3626 | `					rc = GenStateCompileClassMethod(&(*pGen),iProtection,iAttrflags,TRUE,pClass);` |
|        - | 3627 | `				}` |
|  2654665 | 3628 | `				if( rc != SXRET_OK ){` |
...
|        - | 3651 | `		sxu32 nU;` |
|   453197 | 3652 | `		apUse = (TraitUseEntry *)SySetBasePtr(&aUseEntries);` |
|   468847 | 3653 | `		for( nU = 0 ; nU < SySetUsed(&aUseEntries) ; nU++ ){` |
|    15655 | 3654 | `			TraitUseEntry *pUse = &apUse[nU];` |
|    15655 | 3655 | `			ph7_class **apTrait = (ph7_class **)SySetBasePtr(&pUse->aTraits);` |
|    15655 | 3656 | `			sxu32 nTraits = SySetUsed(&pUse->aTraits);` |
|    15655 | 3657 | `			int hasResolution = (pUse->pResolvStart && pUse->pResolvStart < pUse->pResolvEnd) ? 1 : 0;` |
|        - | 3658 | `			sxu32 nT;` |
|    15655 | 3659 | `			if( !hasResolution ){` |
|        - | 3660 | `				/* No conflict resolution block: use standard trait application */` |
|    31291 | 3661 | `				for( nT = 0 ; nT < nTraits ; nT++ ){` |
|    15651 | 3662 | `					rc = PH7_ClassUseTrait(&(*pGen),pClass,apTrait[nT]);` |
|    15651 | 3663 | `					if( rc != SXRET_OK ){` |
|      ! 0 | 3664 | `						break;` |
|        - | 3665 | `					}` |
|     7828 | 3666 | `				}` |
|     7825 | 3667 | `			}else{` |
...
|        2 | 3855 | `				}` |
|        - | 3856 | `			}` |
|    15655 | 3857 | `			SySetRelease(&pUse->aTraits);` |
|     7830 | 3858 | `		}` |
|        - | 3859 | `	}` |
|   453197 | 3860 | `	if( pClass->iFlags & PH7_CLASS_ENUM ){` |
...
|     3927 | 3863 | `		rc = GenStateEnumFinalize(&(*pGen),pClass,nLine);` |
|     3927 | 3864 | `		if( rc == SXERR_ABORT ){` |
...
|   453197 | 3871 | `	if( GenStateGuardClassRedeclaration(pGen,pClass) == SXERR_ABORT ){` |
|        9 | 3872 | `		return SXERR_ABORT;` |
|        - | 3873 | `	}` |
|        - | 3874 | `	/* Install the class */` |
|   453191 | 3875 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|   453191 | 3876 | `	if( rc == SXRET_OK ){` |
|        - | 3877 | `		ph7_class **apInterface;` |
|        - | 3878 | `		sxu32 n;` |
|   453191 | 3879 | `		if( pBase ){` |
|        - | 3880 | `			/* Inherit from base class and mark as a subclass */` |
|   249273 | 3881 | `			rc = PH7_ClassInherit(&(*pGen),pClass,pBase);` |
|   124634 | 3882 | `		}` |
|   453191 | 3883 | `		apInterface = (ph7_class **)SySetBasePtr(&aInterfaces);` |
|   651785 | 3884 | `		for( n = 0 ; n < SySetUsed(&aInterfaces) ; n++ ){` |
|        - | 3885 | `			/* Implements one or more interface */` |
|   198599 | 3886 | `			rc = PH7_ClassImplement(pClass,apInterface[n]);` |
|   198599 | 3887 | `			if( rc != SXRET_OK ){` |
|      ! 0 | 3888 | `				break;` |
|        - | 3889 | `			}` |
|    99302 | 3890 | `		}` |
...
|   453191 | 3893 | `		if( rc == SXRET_OK && (pClass->iFlags & PH7_CLASS_ENUM) ){` |
|     3925 | 3894 | `			ph7_class *pIntf = PH7_VmExtractClass(pGen->pVm,"UnitEnum",sizeof("UnitEnum")-1,FALSE,0);` |
|     3925 | 3895 | `			while( pIntf && (pIntf->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|      ! 0 | 3896 | `				pIntf = pIntf->pNextName;` |
|      ! 0 | 3897 | `			}` |
|     3925 | 3898 | `			if( pIntf ){` |
|     3925 | 3899 | `				PH7_ClassImplement(pClass,pIntf);` |
|     1960 | 3900 | `			}` |
|     3925 | 3901 | `			if( pClass->nEnumBacking != 0 ){` |
|     3909 | 3902 | `				pIntf = PH7_VmExtractClass(pGen->pVm,"BackedEnum",sizeof("BackedEnum")-1,FALSE,0);` |
|     3909 | 3903 | `				while( pIntf && (pIntf->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|      ! 0 | 3904 | `					pIntf = pIntf->pNextName;` |
|      ! 0 | 3905 | `				}` |
|     3909 | 3906 | `				if( pIntf ){` |
|     3909 | 3907 | `					PH7_ClassImplement(pClass,pIntf);` |
|     1952 | 3908 | `				}` |
|     1952 | 3909 | `			}` |
|     1960 | 3910 | `		}` |
...
|   453186 | 3913 | `		if( rc == SXRET_OK` |
|   453186 | 3914 | `		 && (pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT)) == 0` |
|   453191 | 3915 | `		 && SyHashGet(&pClass->hMethod,"__toString",sizeof("__toString")-1) != 0 ){` |
|   229623 | 3916 | `			ph7_class *pStringable = PH7_VmExtractClass(pGen->pVm,` |
|        - | 3917 | `				"Stringable",sizeof("Stringable")-1,FALSE,0);` |
|   229623 | 3918 | `			if( pStringable ){` |
|   229623 | 3919 | `				ph7_class **apImpl = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|   229623 | 3920 | `				sxu32 nImpl = SySetUsed(&pClass->aInterface);` |
|        - | 3921 | `				sxu32 i;` |
|   229623 | 3922 | `				int bAlready = 0;` |
|   276307 | 3923 | `				for( i = 0 ; i < nImpl ; i++ ){` |
|    58361 | 3924 | `					if( apImpl[i] == pStringable ){` |
|    11677 | 3925 | `						bAlready = 1;` |
|    11677 | 3926 | `						break;` |
|        - | 3927 | `					}` |
|    23347 | 3928 | `				}` |
|   229623 | 3929 | `				if( !bAlready ){` |
|   217951 | 3930 | `					PH7_ClassImplement(pClass,pStringable);` |
|   108973 | 3931 | `				}` |
|   114809 | 3932 | `			}` |
|   114809 | 3933 | `		}` |
|        - | 3934 | `		/* Validate interface method signatures (visibility and parameter count) */` |
|   453191 | 3935 | `		if( rc == SXRET_OK ){` |
|   453191 | 3936 | `			sxi32 rcCheck = GenStateCheckInterfaceSignatures(&(*pGen),pClass);` |
|   453191 | 3937 | `			if( rcCheck == SXERR_ABORT ){` |
...
|   453191 | 3944 | `		if( rc == SXRET_OK ){` |
|   453191 | 3945 | `			sxi32 rcCheck = GenStateCheckAbstractMethods(&(*pGen),pClass);` |
|   453191 | 3946 | `			if( rcCheck == SXERR_ABORT ){` |
...
|   226593 | 3951 | `		}` |
|   226593 | 3952 | `	}` |
|   453191 | 3953 | `	SySetRelease(&aUseEntries);` |
|   453191 | 3954 | `	SySetRelease(&aInterfaces);` |
|   453191 | 3955 | `	if( rc != SXRET_OK ){` |
...
|   453233 | 3961 | `	pGen->pIn = &pEnd[1];` |
|   453233 | 3962 | `	pGen->pEnd = pTmp;` |
|   453233 | 3963 | `	return PH7_OK;` |
|   226623 | 3964 | `}` |
|        - | 3965 | `/* Compile a named class declaration (the common case). */` |
|   453206 | 3966 | `static sxi32 GenStateCompileClass(ph7_gen_state *pGen,sxi32 iFlags)` |
|        5 | 3967 | `{` |
|   453211 | 3968 | `	return GenStateCompileClassEx(pGen,iFlags,0,0,0);` |
|        5 | 3969 | `}` |
|        - | 3970 | `/*` |
...
|        - | 4069 | ` */` |
| 14483842 | 4070 | `static int GenStateTokenIsClassModifier(SyToken *pTok,sxi32 *piFlag)` |
|        5 | 4071 | `{` |
| 14483847 | 4072 | `	if( pTok->nType & PH7_TK_KEYWORD ){` |
|  8668855 | 4073 | `		sxu32 nKw = (sxu32)SX_PTR_TO_INT(pTok->pUserData);` |
|  8668855 | 4074 | `		if( nKw == PH7_TKWRD_FINAL ){ *piFlag = PH7_CLASS_FINAL; return TRUE; }` |
|  8614349 | 4075 | `		if( nKw == PH7_TKWRD_ABSTRACT ){ *piFlag = PH7_CLASS_ABSTRACT; return TRUE; }` |
|  4287669 | 4076 | `	}` |
| 14390335 | 4077 | `	if( GenStateIsReadonly(pTok) ){ *piFlag = PH7_CLASS_READONLY; return TRUE; }` |
| 14390275 | 4078 | `	return FALSE;` |
|  7241926 | 4079 | `}` |
|        - | 4080 | `/*` |
...
|        - | 4085 | ` */` |
| 14390270 | 4086 | `static sxi32 GenStateScanClassModifiers(SyToken **ppIn,SyToken *pEnd,SyToken **ppDup)` |
|        5 | 4087 | `{` |
| 14390275 | 4088 | `	SyToken *pIn = *ppIn,*pDup = 0;` |
| 14390275 | 4089 | `	sxi32 iFlags = 0,iFlag;` |
| 14483847 | 4090 | `	while( pIn < pEnd && GenStateTokenIsClassModifier(pIn,&iFlag) ){` |
|    93577 | 4091 | `		if( (iFlags & iFlag) && pDup == 0 ){` |
|        5 | 4092 | `			pDup = pIn;` |
|        2 | 4093 | `		}` |
|    93577 | 4094 | `		iFlags \|= iFlag;` |
|    93577 | 4095 | `		pIn++;` |
|        5 | 4096 | `	}` |
| 14390275 | 4097 | `	*ppIn = pIn;` |
| 14390275 | 4098 | `	if( ppDup ){ *ppDup = pDup; }` |
| 14390275 | 4099 | `	return iFlags;` |
|        5 | 4100 | `}` |
|        - | 4101 | `/*` |
...
|        - | 4107 | ` */` |
| 14347384 | 4108 | `PH7_PRIVATE int GenStateStartsModifiedClass(SyToken *pIn,SyToken *pEnd)` |
|        5 | 4109 | `{` |
| 14347389 | 4110 | `	sxi32 iFlags = GenStateScanClassModifiers(&pIn,pEnd,0);` |
|  7224365 | 4111 | `	return iFlags != 0 && pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD)` |
| 14372719 | 4112 | `		&& (sxu32)SX_PTR_TO_INT(pIn->pUserData) == PH7_TKWRD_CLASS;` |
|        5 | 4113 | `}` |
|        - | 4114 | `/*` |
...
|        - | 4120 | ` */` |
|    42886 | 4121 | `PH7_PRIVATE sxi32 PH7_CompileClassModifiers(ph7_gen_state *pGen)` |
|        5 | 4122 | `{` |
|        - | 4123 | `	SyToken *pDup;` |
|    42891 | 4124 | `	sxi32 iFlags = GenStateScanClassModifiers(&pGen->pIn,pGen->pEnd,&pDup);` |
|        - | 4125 | `	sxi32 rc;` |
|    42891 | 4126 | `	if( pDup ){` |
...
|        - | 4131 | `		}` |
|        1 | 4132 | `	}` |
|    42886 | 4133 | `	if( (iFlags & (PH7_CLASS_FINAL\|PH7_CLASS_ABSTRACT))` |
|    21448 | 4134 | `		== (PH7_CLASS_FINAL\|PH7_CLASS_ABSTRACT) ){` |
...
|        - | 4139 | `		}` |
|        1 | 4140 | `	}` |
|    42891 | 4141 | `	return GenStateCompileClass(&(*pGen),iFlags);` |
|    21448 | 4142 | `}` |
|        - | 4143 | `/*` |
...
|        - | 4148 | ` */` |
|     7880 | 4149 | `PH7_PRIVATE sxi32 PH7_CompileTrait(ph7_gen_state *pGen)` |
|        5 | 4150 | `{` |
|     7885 | 4151 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|     7885 | 4160 | `	pGen->pIn++;` |
|     7885 | 4161 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
...
|     7885 | 4172 | `	pName = &pGen->pIn->sData;` |
|     7885 | 4173 | `	pGen->pIn++;` |
|        - | 4174 | `	/* Build FQN and obtain a raw class */ {` |
|        - | 4175 | `		SyBlob sFQN;` |
|        - | 4176 | `		SyString sFQNStr;` |
|     7885 | 4177 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|     7885 | 4178 | `		GenStateBuildFQN(pGen,pName,&sFQN);` |
|     7885 | 4179 | `		SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|     7885 | 4180 | `		pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|     7885 | 4181 | `		SyBlobRelease(&sFQN);` |
|        - | 4182 | `	}` |
|     7885 | 4183 | `	if( pClass == 0 ){` |
|      ! 0 | 4184 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 4185 | `		return SXERR_ABORT;` |
|        - | 4186 | `	}` |
|     7885 | 4187 | `	GenStateConsumeDoc(&(*pGen),&pClass->sDoc);` |
|     7885 | 4188 | `	if( GenStateConsumeAttrs(&(*pGen),&pClass->aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 4189 | `		return SXERR_ABORT;` |
|        - | 4190 | `	}` |
|        - | 4191 | `	/* Traits cannot extend or implement; expect opening brace directly */` |
|     7885 | 4192 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_OCB) == 0 ){` |
...
|        - | 4199 | `	}` |
|     7885 | 4200 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|     7885 | 4201 | `	pEnd = 0;` |
|     7885 | 4202 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB,PH7_TK_CCB,&pEnd);` |
|     7885 | 4203 | `	if( pEnd >= pGen->pEnd ){` |
...
|     7885 | 4212 | `	pClass->nEndLine = pEnd->nLine;` |
|        - | 4213 | `	/* Swap token stream */` |
|     7885 | 4214 | `	pTmp = pGen->pEnd;` |
|     7885 | 4215 | `	pGen->pEnd = pEnd;` |
|        - | 4216 | `	/* Mark as trait (PH7_NewRawClass may have set INTERNAL) */` |
|     7885 | 4217 | `	pClass->iFlags \|= PH7_CLASS_TRAIT;` |
|        - | 4218 | `	/* Parse the body: same as a normal class (methods, attributes, visibility modifiers) */` |
|    56506 | 4219 | `	for(;;){` |
|   159759 | 4220 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|    23379 | 4221 | `			pGen->pIn++;` |
|        5 | 4222 | `		}` |
|   136385 | 4223 | `		if( pGen->pIn >= pGen->pEnd ){` |
|     7885 | 4224 | `			break;` |
|        - | 4225 | `		}` |
|        - | 4226 | `		/* Bind a directly-preceding docblock to this member */` |
|   128505 | 4227 | `		GenStateSetPendingDoc(&(*pGen));` |
|   128505 | 4228 | `		if( (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR)) == 0 ){` |
...
|      ! 0 | 4235 | `			goto done;` |
|        - | 4236 | `		}` |
|   128505 | 4237 | `		iProtection = PH7_TKWRD_PUBLIC;` |
|   128505 | 4238 | `		iAttrflags = 0;` |
|   128505 | 4239 | `		if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|   128505 | 4240 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   128505 | 4241 | `			if( nKwrd == PH7_TKWRD_USE ){` |
...
|        5 | 4282 | `				continue;` |
|        - | 4283 | `			}` |
|   128501 | 4284 | `			if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|   128483 | 4285 | `				iProtection = nKwrd;` |
|   128483 | 4286 | `				pGen->pIn++;` |
...
|   128483 | 4290 | `				if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|        5 | 4291 | `					iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|        5 | 4292 | `					pGen->pIn++; /* Jump the 'readonly' modifier */` |
|        2 | 4293 | `				}` |
|   128478 | 4294 | `				if( pGen->pIn >= pGen->pEnd` |
|   128483 | 4295 | `					\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|      ! 0 | 4302 | `					goto done;` |
|        - | 4303 | `				}` |
|   128483 | 4304 | `				if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|    23359 | 4305 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|    23359 | 4306 | `					if( rc != SXRET_OK ){` |
...
|    23359 | 4312 | `					continue;` |
|        - | 4313 | `				}` |
|   105129 | 4314 | `				if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|        9 | 4322 | `					continue;` |
|        - | 4323 | `				}` |
|   105121 | 4324 | `				nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    52558 | 4325 | `			}` |
|   105139 | 4326 | `			if( nKwrd == PH7_TKWRD_CONST ){` |
...
|      ! 0 | 4332 | `				goto done;` |
|      ! 0 | 4333 | `			}else{` |
|   105139 | 4334 | `				if( nKwrd == PH7_TKWRD_STATIC ){` |
|     7795 | 4335 | `					iAttrflags \|= PH7_CLASS_ATTR_STATIC;` |
|     7795 | 4336 | `					pGen->pIn++;` |
|     7795 | 4337 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|     7793 | 4338 | `						nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|     7793 | 4339 | `						if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|      ! 0 | 4340 | `							iProtection = nKwrd;` |
|      ! 0 | 4341 | `							pGen->pIn++;` |
|      ! 0 | 4342 | `						}` |
|     3894 | 4343 | `					}` |
|     7790 | 4344 | `					if( pGen->pIn >= pGen->pEnd` |
|     7795 | 4345 | `						\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|      ! 0 | 4352 | `						goto done;` |
|        - | 4353 | `					}` |
|     7795 | 4354 | `					if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
...
|        3 | 4362 | `						continue;` |
|        - | 4363 | `					}` |
|     7793 | 4364 | `					if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|      ! 0 | 4372 | `						continue;` |
|        - | 4373 | `					}` |
|     7793 | 4374 | `					nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   101243 | 4375 | `				}else if( nKwrd == PH7_TKWRD_ABSTRACT ){` |
...
|        3 | 4396 | `				}` |
|   105137 | 4397 | `				if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_VAR ){` |
...
|      ! 0 | 4404 | `					goto done;` |
|        - | 4405 | `				}` |
|   105137 | 4406 | `				if( nKwrd == PH7_TKWRD_VAR ){` |
|      ! 0 | 4407 | `					pGen->pIn++;` |
...
|      ! 0 | 4417 | `				}else{` |
|   105137 | 4418 | `					rc = GenStateCompileClassMethod(&(*pGen),iProtection,iAttrflags,TRUE,pClass);` |
|        - | 4419 | `				}` |
|   105137 | 4420 | `				if( rc != SXRET_OK ){` |
...
|     7885 | 4438 | `	if( GenStateGuardClassRedeclaration(pGen,pClass) == SXERR_ABORT ){` |
|        3 | 4439 | `		return SXERR_ABORT;` |
|        - | 4440 | `	}` |
|        - | 4441 | `	/* Install the trait */` |
|     7883 | 4442 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|     7883 | 4443 | `	if( rc != SXRET_OK ){` |
...
|     7883 | 4449 | `	pGen->pIn = &pEnd[1];` |
|     7883 | 4450 | `	pGen->pEnd = pTmp;` |
|     7883 | 4451 | `	return PH7_OK;` |
|     3945 | 4452 | `}` |
|        - | 4453 | `/*` |
...
|        - | 4461 | ` */` |
|   406394 | 4462 | `PH7_PRIVATE sxi32 PH7_CompileClass(ph7_gen_state *pGen)` |
|        5 | 4463 | `{` |
|        - | 4464 | `	sxi32 rc;` |
|   406399 | 4465 | `	rc = GenStateCompileClass(&(*pGen),0);` |
|   406399 | 4466 | `	return rc;` |
|        5 | 4467 | `}` |
|        - | 4468 | `/*` |
...
|        - | 4474 | ` */` |
| 14296718 | 4475 | `PH7_PRIVATE int GenStateStartsEnumDecl(SyToken *pIn,SyToken *pEnd)` |
|        5 | 4476 | `{` |
| 14513359 | 4477 | `	return (pIn->nType & PH7_TK_ID)` |
|  7364995 | 4478 | `		&& pIn->sData.nByte == sizeof("enum")-1` |
|   226508 | 4479 | `		&& SyStrnicmp(pIn->sData.zString,"enum",sizeof("enum")-1) == 0` |
| 14513354 | 4480 | `		&& &pIn[1] < pEnd && (pIn[1].nType & PH7_TK_ID);` |
|        5 | 4481 | `}` |
|        - | 4482 | `/*` |
...
|        - | 4487 | ` */` |
|     3926 | 4488 | `PH7_PRIVATE sxi32 PH7_CompileEnum(ph7_gen_state *pGen)` |
|        5 | 4489 | `{` |
|     3931 | 4490 | `	return GenStateCompileClass(&(*pGen),PH7_CLASS_ENUM\|PH7_CLASS_FINAL);` |
|        5 | 4491 | `}` |
|        - | 4492 |  |
