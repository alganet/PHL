...
|       - |   92 | ` */` |
|     464 |   93 | `static int GenStateClassConstHasType(ph7_gen_state *pGen)` |
|       5 |   94 | `{` |
|       - |   95 | `	SyToken *p0, *p1;` |
|     469 |   96 | `	if( pGen->pIn >= pGen->pEnd ){` |
|     ! 0 |   97 | `		return 0;` |
|       - |   98 | `	}` |
|     469 |   99 | `	p0 = pGen->pIn;` |
|       - |  100 | `	/* A leading '\' (namespaced class type) or '?' (nullable) always starts a type */` |
|     469 |  101 | `	if( p0->nType & PH7_TK_NSSEP ){` |
|     ! 0 |  102 | `		return 1;` |
|       - |  103 | `	}` |
|     469 |  104 | `	if( (p0->nType & PH7_TK_OP) && p0->sData.nByte == 1 && p0->sData.zString[0] == '?' ){` |
|       5 |  105 | `		return 1;` |
|       - |  106 | `	}` |
...
|     465 |  110 | `	if( p0->nType & (PH7_TK_ID\|PH7_TK_KEYWORD) ){` |
|     465 |  111 | `		p1 = (pGen->pIn + 1 < pGen->pEnd) ? (pGen->pIn + 1) : 0;` |
|     465 |  112 | `		if( p1 ){` |
|     465 |  113 | `			if( p1->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_NSSEP) ){` |
|      47 |  114 | `				return 1;` |
|       - |  115 | `			}` |
|     423 |  116 | `			if( (p1->nType & PH7_TK_OP) && p1->sData.nByte == 1 && p1->sData.zString[0] == '\|' ){` |
|       5 |  117 | `				return 1;` |
|       - |  118 | `			}` |
|     207 |  119 | `		}` |
|     207 |  120 | `	}` |
...
|       - |  150 | ` */` |
|     186 |  151 | `static int GenStateTokenIsMemberOp(const SyToken *p)` |
|       5 |  152 | `{` |
|       - |  153 | `	sxi32 iOp;` |
|     191 |  154 | `	if( (p->nType & PH7_TK_OP) == 0 \|\| p->pUserData == 0 ){` |
|      33 |  155 | `		return 0;` |
|       - |  156 | `	}` |
|     161 |  157 | `	iOp = ((const ph7_expr_op *)p->pUserData)->iOp;` |
|     161 |  158 | `	return ( iOp == EXPR_OP_DC \|\| iOp == EXPR_OP_ARROW \|\| iOp == EXPR_OP_NULLSAFE_ARROW );` |
|      98 |  159 | `}` |
|       - |  160 | `/*` |
...
|      12 |  267 | `			if( p == pGen->pIn \|\| !GenStateTokenIsMemberOp(&p[-1]) ){` |
|      12 |  268 | `				return 1;` |
|       - |  269 | `			}` |
|     ! 0 |  270 | `		}` |
|   15911 |  271 | `		p++;` |
...
|       - |  280 | ` */` |
|     456 |  281 | `static ph7_class_attr * GenStateExtractConstant(ph7_class *pClass,SyString *pName)` |
|       5 |  282 | `{` |
...
|       - |  550 | `	SyString *pName;` |
|       - |  551 | `	sxi32 rc;` |
|     469 |  552 | `	sxu32 nType = 0;` |
|       - |  553 | `	SyString sTypeClass;` |
|       - |  554 | `	SyString sTypeText;` |
|       - |  555 | `	SySet aUnionAlts;` |
|     469 |  556 | `	sxi32 iTypeFlags = 0;` |
|     469 |  557 | `	SyStringInitFromBuf(&sTypeClass,0,0);` |
|     469 |  558 | `	SyStringInitFromBuf(&sTypeText,0,0);` |
|     469 |  559 | `	SySetInit(&aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|       - |  560 | `	/* Extract visibility level */` |
|     469 |  561 | `	iProtection = GetProtectionLevel(iProtection);` |
|       - |  562 | `	/* Mark as constant */` |
|     469 |  563 | `	iFlags \|= PH7_CLASS_ATTR_CONSTANT;` |
|     469 |  564 | `	pGen->pIn++; /* Jump the 'const' keyword */` |
...
|     494 |  567 | `	if( GenStateClassConstHasType(pGen) ){` |
...
|     475 |  599 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|     475 |  609 | `	pName = &pGen->pIn->sData;` |
|     470 |  610 | `	if( (pGen->pIn->nType & PH7_TK_KEYWORD)` |
|     275 |  611 | `		&& (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_CLASS ){` |
...
|     473 |  624 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
...
|     471 |  635 | `	pGen->pIn++;` |
|     471 |  636 | `	if(pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_EQUAL /* '=' */) == 0 ){` |
...
|       - |  644 | `	}` |
|     471 |  645 | `	pGen->pIn++; /* Jump the equal sign */` |
...
|     466 |  650 | `	if( (iTypeFlags & PH7_CLASS_ATTR_TYPED) && !(iTypeFlags & PH7_CLASS_ATTR_UNION)` |
...
|       - |  662 | `	{` |
|     467 |  663 | `		int iClo = PH7_GenStateInitClosureError(pGen);` |
|     467 |  664 | `		if( iClo ){` |
...
|     465 |  676 | `	if( PH7_GenStateInitHasCallExpr(pGen) ){` |
...
|     465 |  687 | `	if( GenStateInitHasNewExpr(pGen) ){` |
...
|     461 |  701 | `	if( GenStateExtractConstant(pClass,pName) != 0 ){` |
...
|     461 |  710 | `	pCons = PH7_NewClassAttr(pGen->pVm,pName,nLine,iProtection,iFlags\|iTypeFlags);` |
|     461 |  711 | `	if( pCons ){` |
|     461 |  712 | `		GenStateConsumeDoc(&(*pGen),&pCons->sDoc);` |
|     461 |  713 | `		if( GenStateConsumeAttrs(&(*pGen),&pCons->aAttrs) == SXERR_ABORT ){` |
...
|       - |  720 | `	}` |
|     461 |  721 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|      48 |  722 | `		GenStateCopyTypeToAttr(pCons,nType,&sTypeClass,&sTypeText,iTypeFlags,&aUnionAlts);` |
|      22 |  723 | `	}` |
|       - |  724 | `	/* Swap bytecode container */` |
|     461 |  725 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|     461 |  726 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pCons->aByteCode);` |
|       - |  727 | `	/* Compile constant value.` |
|       - |  728 | `	 */` |
|     461 |  729 | `	rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|     461 |  730 | `	if( rc == SXERR_EMPTY ){` |
...
|     461 |  737 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|     461 |  738 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|     461 |  739 | `	if( rc == SXERR_ABORT ){` |
...
|     461 |  744 | `	rc = PH7_ClassInstallAttr(pClass,pCons);` |
|     461 |  745 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  746 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|     ! 0 |  747 | `		return SXERR_ABORT;` |
|       - |  748 | `	}` |
|     461 |  749 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA /*','*/) ){` |
...
|       - |  767 | `		}` |
|     ! 0 |  768 | `	}` |
|     455 |  769 | `	SySetRelease(&aUnionAlts);` |
|     455 |  770 | `	return SXRET_OK;` |
|       7 |  771 | `Synchronize:` |
...
|       5 |  855 | `				p++;` |
|       5 |  856 | `				while( p + 1 < pEnd && (p->nType & PH7_TK_NSSEP) && (p[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|     ! 0 |  857 | `					p += 2;` |
|     ! 0 |  858 | `				}` |
|       1 |  859 | `			}` |
|       - |  860 | `		}` |
...
|     115 |  949 | `	if( n == 8 && SyMemcmpNoCase(z,"callable",8) == 0 ){` |
...
|     111 |  992 | `			if( GenStateIsDisallowedPropertyAtom(pAlt->nType,&pAlt->sClass,&zBad,&nBad) ){` |
|       3 |  993 | `				bDisallowed = 1;` |
|       3 |  994 | `				break;` |
|       - |  995 | `			}` |
|      57 |  996 | `		}` |
...
|      64 | 1163 | `		}else if( (iTypeFlags & PH7_CLASS_ATTR_TYPED) == 0 ){` |
|       6 | 1164 | `			zRoErr = "Readonly property %z::$%z must have type";` |
|      61 | 1165 | `		}else if( pGen->pIn->nType & PH7_TK_EQUAL ){` |
...
|     169 | 1305 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 | 1306 | `			return SXERR_ABORT;` |
|       - | 1307 | `		}` |
|     169 | 1308 | `		if( rc != SXRET_OK ){` |
...
|       - | 1339 | `			}` |
|     ! 0 | 1340 | `		}else{` |
|       7 | 1341 | `			if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|       7 | 1342 | `				goto loop;` |
|       - | 1343 | `			}` |
|       - | 1344 | `		}` |
|     ! 0 | 1345 | `	}` |
...
|     111 | 1906 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI /* ';'*/) == 0 ){` |
...
|       - | 1993 | ` */` |
|     168 | 1994 | `static int GenStateHookBodyRefsProp(SyToken *pStart,SyToken *pEnd,const SyString *pName)` |
|       5 | 1995 | `{` |
|       - | 1996 | `	SyToken *p;` |
|     801 | 1997 | `	for( p = pStart ; p + 1 < pEnd ; p++ ){` |
|     695 | 1998 | `		if( (p->nType & PH7_TK_DOLLAR) == 0 ){` |
|     567 | 1999 | `			continue;` |
|       - | 2000 | `		}` |
|       - | 2001 | ``		/* `$this->NAME` (also `?->`/`::`) */`` |
|     128 | 2002 | `		if( p + 3 < pEnd` |
|     128 | 2003 | `		 && (p[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) != 0` |
|     128 | 2004 | `		 && p[1].sData.nByte == sizeof("this")-1` |
|     111 | 2005 | `		 && SyMemcmp((const void *)p[1].sData.zString,(const void *)"this",sizeof("this")-1) == 0` |
|      94 | 2006 | `		 && GenStateTokenIsMemberOp(&p[2])` |
|      94 | 2007 | `		 && (p[3].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) != 0` |
|      94 | 2008 | `		 && p[3].sData.nByte == pName->nByte` |
|      86 | 2009 | `		 && SyMemcmp((const void *)p[3].sData.zString,(const void *)pName->zString,pName->nByte) == 0 ){` |
|      60 | 2010 | `			return 1;` |
|       - | 2011 | `		}` |
...
|       - | 2028 | ` */` |
|    1408 | 2029 | `static int GenStateIsParentHookCallAt(SyToken *p,SyToken *pEnd)` |
|       5 | 2030 | `{` |
|    1631 | 2031 | `	return p + 6 < pEnd` |
|     922 | 2032 | `	 && (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) != 0` |
...
|    1626 | 2043 | `	 && (p[6].nType & PH7_TK_LPAREN) != 0;` |
|       5 | 2044 | `}` |
|       - | 2045 | `/*` |
...
|       - | 2099 | ` */` |
|     132 | 2100 | `static void GenStateHookGetReturnType(ph7_vm_func *pFunc,ph7_class_attr *pAttr)` |
|       5 | 2101 | `{` |
|     137 | 2102 | `	if( (pAttr->iFlags & PH7_CLASS_ATTR_TYPED) == 0 ){` |
|      13 | 2103 | `		return; /* untyped property: the hook is untyped too */` |
|       - | 2104 | `	}` |
|     126 | 2105 | `	pFunc->nReturnType = pAttr->nType;` |
|     126 | 2106 | `	pFunc->sReturnClass = pAttr->sClass;` |
|     126 | 2107 | `	pFunc->sReturnTypeName = pAttr->sTypeName;` |
|     126 | 2108 | `	if( pAttr->iFlags & PH7_CLASS_ATTR_NULLABLE ){` |
|      14 | 2109 | `		pFunc->iFlags \|= VM_FUNC_RETURN_NULLABLE;` |
|       6 | 2110 | `	}` |
|     126 | 2111 | `	if( pAttr->iFlags & PH7_CLASS_ATTR_UNION ){` |
|       - | 2112 | `		sxu32 i;` |
...
|       4 | 2131 | `{` |
|       - | 2132 | `	char *zVoid;` |
|      96 | 2133 | `	if( pValueArg && (pAttr->iFlags & PH7_CLASS_ATTR_TYPED) ){` |
...
|       1 | 2146 | `		}` |
|      33 | 2147 | `	}` |
|      96 | 2148 | `	pFunc->nReturnType = MEMOBJ_VOID;` |
|      96 | 2149 | `	zVoid = SyMemBackendStrDup(&pGen->pVm->sAllocator,"void",sizeof("void")-1);` |
|      96 | 2150 | `	if( zVoid ){` |
|      96 | 2151 | `		SyStringInitFromBuf(&pFunc->sReturnTypeName,zVoid,sizeof("void")-1);` |
|      46 | 2152 | `	}` |
|      96 | 2153 | `}` |
|     164 | 2154 | `PH7_PRIVATE sxi32 GenStateCompilePropertyHooks(ph7_gen_state *pGen,ph7_class *pClass,ph7_class_attr *pAttr)` |
|       5 | 2155 | `{` |
|     169 | 2156 | `	sxu32 nLine = pGen->pIn->nLine;` |
|       - | 2157 | `	sxi32 rc;` |
|     169 | 2158 | `	int bRefsSelf = 0;` |
|     169 | 2159 | `	pGen->pIn++; /* Jump '{' */` |
|     409 | 2160 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_CCB) == 0 ){` |
|       - | 2161 | `		char zHook[384];` |
|       - | 2162 | `		SyString sHookName;` |
|       - | 2163 | `		ph7_class_method *pMeth;` |
|       - | 2164 | `		int bGet;` |
|     245 | 2165 | `		sxu32 nHLine = pGen->pIn->nLine;` |
|     245 | 2166 | `		if( pGen->pIn->nType & PH7_TK_SEMI ){` |
|      18 | 2167 | `			pGen->pIn++; /* stray ';' between hooks */` |
|      26 | 2168 | `			continue;` |
|       - | 2169 | `		}` |
|     229 | 2170 | `		if( pGen->pIn->nType & PH7_TK_AMPER ){` |
...
|       - | 2179 | `		}` |
|     229 | 2180 | `		if( (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|     ! 0 | 2181 | `			goto HookSyntax;` |
|       - | 2182 | `		}` |
|     224 | 2183 | `		if( pGen->pIn->sData.nByte == 3` |
|     229 | 2184 | `		 && SyStrnicmp(pGen->pIn->sData.zString,"get",3) == 0 ){` |
|     137 | 2185 | `			bGet = 1;` |
|     163 | 2186 | `		}else if( pGen->pIn->sData.nByte == 3` |
|      96 | 2187 | `		 && SyStrnicmp(pGen->pIn->sData.zString,"set",3) == 0 ){` |
|      96 | 2188 | `			bGet = 0;` |
|      50 | 2189 | `		}else{` |
|     ! 0 | 2190 | `			goto HookSyntax;` |
|       - | 2191 | `		}` |
|     229 | 2192 | `		pGen->pIn++; /* Jump 'get'/'set' */` |
|     229 | 2193 | `		sHookName.zString = zHook;` |
|     341 | 2194 | `		sHookName.nByte = SyBufferFormat(zHook,sizeof(zHook),"__phl_hook_%s_%z",` |
|     112 | 2195 | `			bGet ? "get" : "set",&pAttr->sName);` |
|     229 | 2196 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & (PH7_TK_SEMI\|PH7_TK_CCB)) ){` |
...
|       - | 2249 | `		}` |
|     208 | 2250 | `		if( (pAttr->iFlags & PH7_CLASS_ATTR_ABSTRACT) != 0` |
|     213 | 2251 | `		 \|\| (pClass->iFlags & PH7_CLASS_INTERFACE) != 0 ){` |
...
|       - | 2259 | `		}` |
|     213 | 2260 | `		pMeth = PH7_NewClassMethod(pGen->pVm,pClass,&sHookName,nHLine,` |
...
|       - | 2265 | `		}` |
|     213 | 2266 | `		pMeth->sFunc.nLine = nHLine;` |
|     213 | 2267 | `		if( bGet ){` |
|     127 | 2268 | `			GenStateHookGetReturnType(&pMeth->sFunc,pAttr);` |
|      61 | 2269 | `		}` |
|     213 | 2270 | `		if( !bGet ){` |
|       - | 2271 | ``			/* Parameter list: explicit `set(Type $v)` or the implicit `$value` */`` |
|      90 | 2272 | `			if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_LPAREN) ){` |
...
|      10 | 2286 | `			}` |
|      90 | 2287 | `			if( SySetUsed(&pMeth->sFunc.aArgs) < 1 ){` |
|       - | 2288 | `				/* Implicit $value formal */` |
|       - | 2289 | `				ph7_vm_func_arg sVArg;` |
|      70 | 2290 | `				char *zVName = SyMemBackendStrDup(&pGen->pVm->sAllocator,"value",sizeof("value")-1);` |
|      70 | 2291 | `				if( zVName == 0 ){` |
|     ! 0 | 2292 | `					PH7_GenCompileError(pGen,E_ERROR,nHLine,"Fatal, PH7 is running out of memory");` |
|     ! 0 | 2293 | `					return SXERR_ABORT;` |
|       - | 2294 | `				}` |
|      70 | 2295 | `				SyZero(&sVArg,sizeof(ph7_vm_func_arg));` |
|      70 | 2296 | `				SyStringInitFromBuf(&sVArg.sName,zVName,sizeof("value")-1);` |
|      70 | 2297 | `				SySetInit(&sVArg.aByteCode,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|      70 | 2298 | `				SySetInit(&sVArg.aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|      70 | 2299 | `				SySetInit(&sVArg.aAttrs,&pGen->pVm->sAllocator,sizeof(ph7_attribute));` |
|      70 | 2300 | `				SyStringInitFromBuf(&sVArg.sTypeName,0,0);` |
|      70 | 2301 | `				GenStateHookSetSignature(&(*pGen),&pMeth->sFunc,pAttr,&sVArg);` |
|      70 | 2302 | `				SySetPut(&pMeth->sFunc.aArgs,(const void *)&sVArg);` |
|      37 | 2303 | `			}else{` |
...
|       - | 2307 | `			}` |
|      43 | 2308 | `		}` |
|     274 | 2309 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OCB) ){` |
|       - | 2310 | `			/* Block body */` |
...
|      23 | 2355 | `				bRefsSelf = 1;` |
|      15 | 2356 | `			}` |
|     194 | 2357 | `		}else if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_ARRAY_OP) ){` |
...
|      90 | 2363 | `			SyToken *pSavedEnd = 0;` |
|       - | 2364 | `			SySet sBody;` |
|      90 | 2365 | `			int bParentCall = 0;` |
|      90 | 2366 | `			pGen->pIn++; /* Jump '=>' */` |
|      90 | 2367 | `			pBodyStart = pGen->pIn;` |
...
|       - | 2372 | `			{` |
|      90 | 2373 | `				sxi32 iNest = 0;` |
|      90 | 2374 | `				pExprEnd = pBodyStart;` |
|     470 | 2375 | `				while( pExprEnd < pGen->pEnd ){` |
|     470 | 2376 | `					if( pExprEnd->nType & (PH7_TK_LPAREN\|PH7_TK_OSB\|PH7_TK_OCB) ){` |
|      15 | 2377 | `						iNest++;` |
|     464 | 2378 | `					}else if( pExprEnd->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB) ){` |
|      15 | 2379 | `						if( iNest <= 0 ){` |
|     ! 0 | 2380 | `							break;` |
|       - | 2381 | `						}` |
|      15 | 2382 | `						iNest--;` |
|     452 | 2383 | `					}else if( iNest <= 0 && (pExprEnd->nType & PH7_TK_SEMI) ){` |
|      90 | 2384 | `						break;` |
|       - | 2385 | `					}` |
|     384 | 2386 | `					pExprEnd++;` |
|       4 | 2387 | `				}` |
...
|       - | 2389 | `			{` |
|       - | 2390 | `				SyToken *pScan;` |
|     450 | 2391 | `				for( pScan = pBodyStart ; pScan < pExprEnd ; pScan++ ){` |
|     366 | 2392 | `					if( GenStateIsParentHookCallAt(pScan,pExprEnd) ){` |
|       3 | 2393 | `						bParentCall = 1;` |
|       3 | 2394 | `						break;` |
|       - | 2395 | `					}` |
|     184 | 2396 | `				}` |
|       - | 2397 | `			}` |
|      90 | 2398 | `			if( bParentCall ){` |
...
|       1 | 2409 | `			}` |
|     133 | 2410 | `			rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC,` |
|      86 | 2411 | `				PH7_VmInstrLength(pGen->pVm),&pMeth->sFunc,&pBlock);` |
|      90 | 2412 | `			if( rc != SXRET_OK ){` |
|     ! 0 | 2413 | `				PH7_GenCompileError(pGen,E_ERROR,nHLine,"PH7 engine is running out-of-memory");` |
|     ! 0 | 2414 | `				return SXERR_ABORT;` |
|       - | 2415 | `			}` |
|      90 | 2416 | `			pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|      90 | 2417 | `			PH7_VmSetByteCodeContainer(pGen->pVm,&pMeth->sFunc.aByteCode);` |
|      90 | 2418 | `			rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|      90 | 2419 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,(rc != SXERR_EMPTY ? 1 : 0),0,0,0);` |
|      90 | 2420 | `			GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|      90 | 2421 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|      90 | 2422 | `			PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|      90 | 2423 | `			GenStateLeaveBlock(&(*pGen),0);` |
|      90 | 2424 | `			if( bParentCall ){` |
|       3 | 2425 | `				pGen->pIn = pExprEnd; /* land on the original ';' */` |
|       3 | 2426 | `				pGen->pEnd = pSavedEnd;` |
|       3 | 2427 | `				SySetRelease(&sBody);` |
|       1 | 2428 | `			}` |
|      90 | 2429 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 | 2430 | `				return SXERR_ABORT;` |
|       - | 2431 | `			}` |
|      90 | 2432 | `			pMeth->sFunc.nEndLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nHLine;` |
|      90 | 2433 | `			if( !bRefsSelf && GenStateHookBodyRefsProp(pBodyStart,pGen->pIn,&pAttr->sName) ){` |
|      44 | 2434 | `				bRefsSelf = 1;` |
|      21 | 2435 | `			}` |
|      90 | 2436 | `			if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|      90 | 2437 | `				pGen->pIn++; /* Jump ';' */` |
|      43 | 2438 | `			}` |
|      90 | 2439 | `			if( !bGet ){` |
...
|       - | 2449 | `		}` |
|     213 | 2450 | `		rc = PH7_ClassInstallMethod(pClass,pMeth);` |
|     213 | 2451 | `		if( rc != SXRET_OK ){` |
|     ! 0 | 2452 | `			PH7_GenCompileError(pGen,E_ERROR,nHLine,"Fatal, PH7 is running out of memory");` |
|     ! 0 | 2453 | `			return SXERR_ABORT;` |
|       - | 2454 | `		}` |
|     213 | 2455 | `		pAttr->iFlags \|= bGet ? PH7_CLASS_ATTR_HOOK_GET : PH7_CLASS_ATTR_HOOK_SET;` |
|       5 | 2456 | `	}` |
|     169 | 2457 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_CCB) == 0 ){` |
|     ! 0 | 2458 | `		goto HookSyntax;` |
|       - | 2459 | `	}` |
|     169 | 2460 | `	pGen->pIn++; /* Jump '}' */` |
|     169 | 2461 | `	if( !bRefsSelf ){` |
...
|     105 | 2465 | `		pAttr->iFlags \|= PH7_CLASS_ATTR_HOOK_VIRTUAL;` |
|     105 | 2466 | `		if( SySetUsed(&pAttr->aByteCode) > 0 ){` |
...
|       - | 2495 | ` */` |
|     188 | 2496 | `PH7_PRIVATE sxi32 PH7_CompileClassInterface(ph7_gen_state *pGen)` |
|       5 | 2497 | `{` |
|     193 | 2498 | `	sxu32 nLine = pGen->pIn->nLine;` |
|       - | 2499 | `	ph7_class *pClass,*pBase;` |
|     193 | 2500 | `	ph7_class *pSavedCurClass = pGen->pCurClass; /* restored at 'done' */` |
...
|       - | 2508 | `		sxi32 rcDefer;` |
|     193 | 2509 | `		if( GenStateMaybeDeferClass(pGen,0,PH7_DEFER_KIND_INTERFACE,&rcDefer) ){` |
...
|     191 | 2516 | `	pName = &pGen->pIn->sData;` |
|       - | 2517 | `	/* Advance the stream cursor */` |
|     191 | 2518 | `	pGen->pIn++;` |
|       - | 2519 | `	/* Build FQN and obtain a raw class */ {` |
|       - | 2520 | `		SyBlob sFQN;` |
|       - | 2521 | `		SyString sFQNStr;` |
|     191 | 2522 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|     191 | 2523 | `		GenStateBuildFQN(pGen,pName,&sFQN);` |
|     191 | 2524 | `		SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|       - | 2525 | ``		/* php refuses a declaration whose short name a local `use` already took. */`` |
|     191 | 2526 | `		if( GenStateGuardImportRedeclare(pGen,0,pName,&sFQNStr,nLine) == SXERR_ABORT ){` |
|     ! 0 | 2527 | `			SyBlobRelease(&sFQN);` |
|     ! 0 | 2528 | `			return SXERR_ABORT;` |
|       - | 2529 | `		}` |
|     191 | 2530 | `		GenStateRecordDeclaredName(pGen,0,&sFQNStr);` |
|     191 | 2531 | `		pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|     191 | 2532 | `		SyBlobRelease(&sFQN);` |
|       - | 2533 | `	}` |
|     191 | 2534 | `	if( pClass == 0 ){` |
|     ! 0 | 2535 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|     ! 0 | 2536 | `		return SXERR_ABORT;` |
|       - | 2537 | `	}` |
|     191 | 2538 | `	GenStateConsumeDoc(&(*pGen),&pClass->sDoc);` |
|     191 | 2539 | `	if( GenStateConsumeAttrs(&(*pGen),&pClass->aAttrs) == SXERR_ABORT ){` |
|     ! 0 | 2540 | `		return SXERR_ABORT;` |
|       - | 2541 | `	}` |
|       - | 2542 | `	/* Mark as an interface (PH7_NewRawClass may have set INTERNAL) */` |
|     191 | 2543 | `	pClass->iFlags \|= PH7_CLASS_INTERFACE;` |
|       - | 2544 | `	/* Assume no base class is given */` |
|     191 | 2545 | `	pBase = 0;` |
|     191 | 2546 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|      24 | 2547 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|      24 | 2548 | `		if( nKwrd == PH7_TKWRD_EXTENDS /* interface b extends a, c, … */ ){` |
...
|      26 | 2559 | `				nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|      26 | 2560 | `				SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|      26 | 2561 | `				if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|       - | 2571 | `				}` |
|      37 | 2572 | `				pParent = PH7_VmExtractClass(pGen->pVm,` |
|      22 | 2573 | `					(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|      26 | 2574 | `				SyStringInitFromBuf(&sBaseName,` |
|       - | 2575 | `					(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|       - | 2576 | `				/* Only interfaces is allowed */` |
|      26 | 2577 | `				while( pParent && (pParent->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|     ! 0 | 2578 | `					pParent = pParent->pNextName;` |
|     ! 0 | 2579 | `				}` |
|      26 | 2580 | `				if( pParent == 0 ){` |
...
|     ! 0 | 2586 | `					}` |
|      26 | 2587 | `				}else if( pBase == 0 ){` |
|       - | 2588 | `					/* First parent → single-inheritance base */` |
|      24 | 2589 | `					pBase = pParent;` |
|      14 | 2590 | `				}else{` |
...
|       - | 2594 | `				}` |
|      26 | 2595 | `				SyBlobRelease(&sResolved);` |
|       - | 2596 | `				/* Continue on a comma-separated list */` |
|      26 | 2597 | `				if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA) ){` |
|       3 | 2598 | `					pGen->pIn++;` |
|       3 | 2599 | `					continue;` |
|       - | 2600 | `				}` |
|      24 | 2601 | `				break;` |
...
|      10 | 2603 | `		}` |
|      10 | 2604 | `	}` |
|     191 | 2605 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|       - | 2606 | `		/* Syntax error */` |
...
|       - | 2614 | `	}` |
|     191 | 2615 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|     191 | 2616 | `	pEnd = 0; /* cc warning */` |
|       - | 2617 | `	/* Delimit the interface body */` |
|     191 | 2618 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|     191 | 2619 | `	if( pEnd >= pGen->pEnd ){` |
|       - | 2620 | `		/* Syntax error */` |
...
|     191 | 2630 | `	pClass->nEndLine = pEnd->nLine;` |
|       - | 2631 | `	/* Swap token stream */` |
|     191 | 2632 | `	pTmp = pGen->pEnd;` |
|     191 | 2633 | `	pGen->pEnd = pEnd;` |
...
|     191 | 2636 | `	pGen->pCurClass = pClass;` |
...
|     371 | 2644 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|      93 | 2645 | `			pGen->pIn++;` |
|       5 | 2646 | `		}` |
|     283 | 2647 | `		if( pGen->pIn >= pGen->pEnd ){` |
|       - | 2648 | `			/* End of interface body */` |
|     187 | 2649 | `			break;` |
|       - | 2650 | `		}` |
|       - | 2651 | `		/* Bind a directly-preceding docblock to this member */` |
|     101 | 2652 | `		GenStateSetPendingDoc(&(*pGen));` |
|     101 | 2653 | `		if( (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|     101 | 2664 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|     101 | 2665 | `		if( nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
...
|       3 | 2694 | `			goto done;` |
|       - | 2695 | `		}` |
|      99 | 2696 | `		if( nKwrd != PH7_TKWRD_PUBLIC && nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|     ! 0 | 2703 | `			goto done;` |
|       - | 2704 | `		}` |
|      99 | 2705 | `		if( nKwrd == PH7_TKWRD_PUBLIC ){` |
|       - | 2706 | `			/* Advance the stream cursor */` |
|      71 | 2707 | `			pGen->pIn++;` |
|      66 | 2708 | `			if( pGen->pIn < pGen->pEnd` |
|      71 | 2709 | `			 && ((pGen->pIn->nType & PH7_TK_DOLLAR) != 0` |
|      66 | 2710 | `			  \|\| (pGen->pIn->sData.nByte == 1 && pGen->pIn->sData.zString[0] == '?')) ){` |
...
|     ! 0 | 2724 | `				continue;` |
|       - | 2725 | `			}` |
|      71 | 2726 | `			if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|     ! 0 | 2748 | `				goto done;` |
|       - | 2749 | `			}` |
|      71 | 2750 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|      71 | 2751 | `			if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|       - | 2773 | `			}` |
|      31 | 2774 | `		}` |
|      95 | 2775 | `		if( nKwrd == PH7_TKWRD_CONST ){` |
|       - | 2776 | `			/* Parse constant */` |
|      28 | 2777 | `			rc = GenStateCompileClassConstant(&(*pGen),0,0,pClass);` |
|      28 | 2778 | `			if( rc != SXRET_OK ){` |
...
|      71 | 2803 | `			rc = GenStateCompileClassMethod(&(*pGen),0,iFlags,FALSE,pClass);` |
|      71 | 2804 | `			if( rc != SXRET_OK ){` |
...
|     187 | 2813 | `	if( GenStateGuardClassRedeclaration(pGen,pClass) == SXERR_ABORT ){` |
|       3 | 2814 | `		return SXERR_ABORT;` |
|       - | 2815 | `	}` |
|       - | 2816 | `	/* Install the interface */` |
|     185 | 2817 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|     185 | 2818 | `	if( rc == SXRET_OK && pBase ){` |
|       - | 2819 | `		/* Inherit from the base interface */` |
|      24 | 2820 | `		rc = PH7_ClassInterfaceInherit(pClass,pBase);` |
|      10 | 2821 | `	}` |
|     185 | 2822 | `	if( rc != SXRET_OK ){` |
|     ! 0 | 2823 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|     ! 0 | 2824 | `		return SXERR_ABORT;` |
|       - | 2825 | `	}` |
|      90 | 2826 | `done:` |
|     189 | 2827 | `	pGen->pCurClass = pSavedCurClass;` |
|       - | 2828 | `	/* Point beyond the interface body */` |
|     189 | 2829 | `	pGen->pIn  = &pEnd[1];` |
|     189 | 2830 | `	pGen->pEnd = pTmp;` |
|     189 | 2831 | `	return PH7_OK;` |
|      99 | 2832 | `}` |
|       - | 2833 | `/*` |
...
|       - | 3263 | ` */` |
|     132 | 3264 | `static sxi32 GenStateCompileEnumCase(ph7_gen_state *pGen,ph7_class *pClass)` |
|       5 | 3265 | `{` |
|     137 | 3266 | `	sxu32 nLine = pGen->pIn->nLine;` |
|       - | 3267 | `	SySet *pInstrContainer;` |
|       - | 3268 | `	ph7_class_attr *pCase;` |
|       - | 3269 | `	SyString *pName;` |
|       - | 3270 | `	sxi32 rc;` |
|     137 | 3271 | `	pGen->pIn++; /* Jump the 'case' keyword */` |
|     137 | 3272 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|       - | 3279 | `	}` |
|     137 | 3280 | `	pName = &pGen->pIn->sData;` |
|       - | 3281 | `	/* Cases share the class-constant namespace (php: "Cannot redefine class constant") */` |
|     137 | 3282 | `	if( SyHashGet(&pClass->hConst,(const void *)pName->zString,pName->nByte) != 0 ){` |
...
|       - | 3289 | `	}` |
|     137 | 3290 | `	pCase = PH7_NewClassAttr(pGen->pVm,pName,pGen->pIn->nLine,PH7_CLASS_PROT_PUBLIC,` |
...
|       - | 3295 | `	}` |
|     137 | 3296 | `	GenStateConsumeDoc(&(*pGen),&pCase->sDoc);` |
|     137 | 3297 | `	if( GenStateConsumeAttrs(&(*pGen),&pCase->aAttrs) == SXERR_ABORT ){` |
...
|       - | 3333 | `		}` |
|       - | 3334 | `	}` |
|     133 | 3335 | `	rc = PH7_ClassInstallAttr(pClass,pCase);` |
|     133 | 3336 | `	if( rc != SXRET_OK ){` |
|     ! 0 | 3337 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|     ! 0 | 3338 | `		return SXERR_ABORT;` |
|       - | 3339 | `	}` |
|     133 | 3340 | `	SySetPut(&pClass->aEnumCases,(const void *)&pCase);` |
|     133 | 3341 | `	return SXRET_OK;` |
|       2 | 3342 | `Synchronize:` |
...
|       - | 3360 | ` */` |
|      96 | 3361 | `static sxi32 GenStateCompileEnumMethods(ph7_gen_state *pGen,ph7_class *pClass)` |
|       5 | 3362 | `{` |
|     101 | 3363 | `	if( PH7_InstallEnumInterfaceMethods(pGen->pVm,pClass) != SXRET_OK ){` |
|     ! 0 | 3364 | `		PH7_GenCompileError(pGen,E_ERROR,pClass->nLine,"Fatal, PH7 is running out of memory");` |
|     ! 0 | 3365 | `		return SXERR_ABORT;` |
|       - | 3366 | `	}` |
|     101 | 3367 | `	return SXRET_OK;` |
|      53 | 3368 | `}` |
|       - | 3369 | `/*` |
...
|       - | 3383 | ` */` |
|      96 | 3384 | `static sxi32 GenStateEnumFinalize(ph7_gen_state *pGen,ph7_class *pClass,sxu32 nLine)` |
|       5 | 3385 | `{` |
|       - | 3386 | `	SyHashEntry *pEntry;` |
|       - | 3387 | `	sxi32 rc;` |
|       - | 3388 | `	sxu32 n;` |
|       - | 3389 | `	/* php: "Enum %s cannot include properties" */` |
|     101 | 3390 | `	SyHashResetLoopCursor(&pClass->hAttr);` |
|     101 | 3391 | `	while( (pEntry = SyHashGetNextEntry(&pClass->hAttr)) != 0 ){` |
...
|    1349 | 3403 | `	for( n = 0 ; n < SX_ARRAYSIZE(azEnumBannedMagic) ; n++ ){` |
|    1872 | 3404 | `		if( SyHashGet(&pClass->hMethod,(const void *)azEnumBannedMagic[n],` |
|    1253 | 3405 | `			SyStrlen(azEnumBannedMagic[n])) != 0 ){` |
...
|     101 | 3421 | `		pAttr = PH7_NewClassAttr(pGen->pVm,&sNameProp,nLine,PH7_CLASS_PROT_PUBLIC,` |
...
|       - | 3426 | `		}` |
|     101 | 3427 | `		pAttr->nType = MEMOBJ_STRING;` |
...
|      87 | 3484 | `	SyHashResetLoopCursor(pTable);` |
|     129 | 3485 | `	while( (pEntry = SyHashGetNextEntry(pTable)) != 0 ){` |
...
|       - | 3646 | `					}` |
|     219 | 3647 | `					if( p < *ppBodyEnd && (p->nType & PH7_TK_COMMA) ){` |
|      22 | 3648 | `						p++;` |
|      22 | 3649 | `						continue;` |
|       - | 3650 | `					}` |
|     201 | 3651 | `					break;` |
...
|       3 | 3681 | `{` |
|      31 | 3682 | `	SyToken *pKw = pGen->pIn; /* the declaration keyword */` |
|       - | 3683 | `	VmDeferredClass *pDefer;` |
|       - | 3684 | `	SyBlob sChunk;` |
|       - | 3685 | `	const char *zFrom;` |
|       - | 3686 | `	const char *zTo;` |
|       - | 3687 | `	char *zDup;` |
|      31 | 3688 | `	SyBlobInit(&sChunk,&pGen->pVm->sAllocator);` |
...
|      31 | 3692 | `	if( pGen->bStrictTypes ){` |
|     ! 0 | 3693 | `		SyBlobAppend(&sChunk,"declare(strict_types=1);\n",sizeof("declare(strict_types=1);\n")-1);` |
|     ! 0 | 3694 | `	}` |
|      31 | 3695 | `	if( SyBlobLength(&pGen->sNamespace) > 0 ){` |
|     ! 0 | 3696 | `		SyBlobFormat(&sChunk,"namespace %.*s;\n",` |
|     ! 0 | 3697 | `			(int)SyBlobLength(&pGen->sNamespace),(const char *)SyBlobData(&pGen->sNamespace));` |
|     ! 0 | 3698 | `	}` |
|      31 | 3699 | `	GenStateDeferEmitUses(&sChunk,&pGen->hUseImports,"");` |
|      31 | 3700 | `	GenStateDeferEmitUses(&sChunk,&pGen->hUseFuncImports,"function ");` |
|      31 | 3701 | `	GenStateDeferEmitUses(&sChunk,&pGen->hUseConstImports,"const ");` |
...
|      31 | 3704 | `	if( !bAnon && pGen->sPendingDoc.nByte > 0 ){` |
...
|       3 | 3723 | `			}` |
|       5 | 3724 | `		}else{` |
|      25 | 3725 | `			aT = (ph7_trivia *)SySetBasePtr(&pGen->aPendingAttrs);` |
|      25 | 3726 | `			nT = SySetUsed(&pGen->aPendingAttrs);` |
|      25 | 3727 | `			for( n = 0 ; n < nT ; ++n ){` |
...
|       - | 3738 | `	{` |
|      31 | 3739 | `		const char *zScan = (const char *)SyBlobData(&sChunk);` |
|      31 | 3740 | `		sxu32 nHave = 0;` |
|       - | 3741 | `		sxu32 nScan;` |
|      31 | 3742 | `		for( nScan = 0 ; nScan < SyBlobLength(&sChunk) ; ++nScan ){` |
|     ! 0 | 3743 | `			if( zScan[nScan] == '\n' ){` |
|     ! 0 | 3744 | `				nHave++;` |
|     ! 0 | 3745 | `			}` |
|     ! 0 | 3746 | `		}` |
|     305 | 3747 | `		while( nHave + 1 < pKw->nLine ){` |
|     277 | 3748 | `			SyBlobAppend(&sChunk,"\n",1);` |
|     277 | 3749 | `			nHave++;` |
|       3 | 3750 | `		}` |
|       - | 3751 | `	}` |
|      31 | 3752 | `	if( bAnon ){` |
...
|      23 | 3779 | `		 && SX_PTR_TO_INT(pKw->pUserData) == PH7_TKWRD_CLASS ){` |
|      17 | 3780 | `			if( iFlags & PH7_CLASS_FINAL ){` |
|       3 | 3781 | `				SyBlobAppend(&sChunk,"final ",sizeof("final ")-1);` |
|       1 | 3782 | `			}` |
|      17 | 3783 | `			if( iFlags & PH7_CLASS_ABSTRACT ){` |
|     ! 0 | 3784 | `				SyBlobAppend(&sChunk,"abstract ",sizeof("abstract ")-1);` |
|     ! 0 | 3785 | `			}` |
|      17 | 3786 | `			if( iFlags & PH7_CLASS_READONLY ){` |
|     ! 0 | 3787 | `				SyBlobAppend(&sChunk,"readonly ",sizeof("readonly ")-1);` |
|     ! 0 | 3788 | `			}` |
|       7 | 3789 | `		}` |
|      25 | 3790 | `		zFrom = pKw->sData.zString;` |
|      25 | 3791 | `		zTo = pBodyEnd->sData.zString + pBodyEnd->sData.nByte;` |
|      25 | 3792 | `		SyBlobAppend(&sChunk,zFrom,(sxu32)(zTo - zFrom));` |
|       - | 3793 | `	}` |
|      31 | 3794 | `	pDefer = (VmDeferredClass *)SyMemBackendAlloc(&pGen->pVm->sAllocator,sizeof(VmDeferredClass));` |
|      31 | 3795 | `	if( pDefer == 0 ){` |
...
|       - | 3799 | `	}` |
|      31 | 3800 | `	SyZero(pDefer,sizeof(VmDeferredClass));` |
|      45 | 3801 | `	zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|      28 | 3802 | `		(const char *)SyBlobData(&sChunk),SyBlobLength(&sChunk));` |
|      31 | 3803 | `	SyBlobRelease(&sChunk);` |
|      31 | 3804 | `	if( zDup == 0 ){` |
|     ! 0 | 3805 | `		PH7_GenCompileError(pGen,E_ERROR,pKw->nLine,"Fatal, PH7 is running out of memory");` |
|     ! 0 | 3806 | `		return SXERR_ABORT;` |
|       - | 3807 | `	}` |
|      31 | 3808 | `	SyStringInitFromBuf(&pDefer->sText,zDup,SyStrlen(zDup));` |
|      31 | 3809 | `	if( bAnon ){` |
...
|       5 | 3817 | `	}else{` |
|      36 | 3818 | `		zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
...
|       - | 3823 | `		}` |
|      25 | 3824 | `		SyStringInitFromBuf(&pDefer->sSelfName,zDup,SyBlobLength(pSelfFqn));` |
|       - | 3825 | `	}` |
|      31 | 3826 | `	SySetInit(&pDefer->aRequired,&pGen->pVm->sAllocator,sizeof(VmDeferredReq));` |
|       - | 3827 | `	{` |
|      31 | 3828 | `		VmDeferredReq *aReq = (VmDeferredReq *)SySetBasePtr(pMissing);` |
|       - | 3829 | `		sxu32 n;` |
|      63 | 3830 | `		for( n = 0 ; n < SySetUsed(pMissing) ; ++n ){` |
|      35 | 3831 | `			SySetPut(&pDefer->aRequired,(const void *)&aReq[n]);` |
|      19 | 3832 | `		}` |
|       - | 3833 | `	}` |
|      31 | 3834 | `	pDefer->nLine = pKw->nLine;` |
|      31 | 3835 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_CLASS_DEFER,0,0,(void *)pDefer,0);` |
|       - | 3836 | `	/* Skip the declaration: the statement cursor lands past its '}' */` |
|      31 | 3837 | `	pGen->pIn = &pBodyEnd[1];` |
|      31 | 3838 | `	return SXRET_OK;` |
|      17 | 3839 | `}` |
|       - | 3840 | `/*` |
...
|     189 | 3884 | `			int hasResolution = (pUse->pResolvStart && pUse->pResolvStart < pUse->pResolvEnd) ? 1 : 0;` |
|       - | 3885 | `			sxu32 nT;` |
|     189 | 3886 | `			if( !hasResolution ){` |
|       - | 3887 | `				/* No conflict resolution block: use standard trait application */` |
|     305 | 3888 | `				for( nT = 0 ; nT < nTraits ; nT++ ){` |
|     159 | 3889 | `					rc = PH7_ClassUseTrait(&(*pGen),pClass,apTrait[nT]);` |
|     159 | 3890 | `					if( rc != SXRET_OK ){` |
|     ! 0 | 3891 | `						break;` |
|       - | 3892 | `					}` |
|      82 | 3893 | `				}` |
|      78 | 3894 | `			}else{` |
...
|       - | 3897 | `				 */` |
|       - | 3898 | `				SyToken *pR;` |
|      91 | 3899 | `				for( nT = 0 ; nT < nTraits ; nT++ ){` |
|      53 | 3900 | `					ph7_class *pTR = apTrait[nT];` |
|       - | 3901 | `					ph7_class_attr *pAR;` |
|       - | 3902 | `					SyHashEntry *pER;` |
|       - | 3903 | `					SyString *pNR;` |
|      53 | 3904 | `					SyHashResetLoopCursor(&pTR->hAttr);` |
|      77 | 3905 | `					while((pER = SyHashGetNextEntry(&pTR->hAttr)) != 0 ){` |
...
|      53 | 3913 | `					SyHashResetLoopCursor(&pTR->hConst);` |
|      77 | 3914 | `					while((pER = SyHashGetNextEntry(&pTR->hConst)) != 0 ){` |
...
|     ! 0 | 3919 | `						}` |
|     ! 0 | 3920 | `					}` |
|      53 | 3921 | `					SySetPut(&pClass->aTrait,(const void *)&pTR);` |
|      29 | 3922 | `				}` |
|       - | 3923 | `				/* Pass 1: process insteadof rules to install winning methods */` |
|      43 | 3924 | `				pR = pUse->pResolvStart;` |
|     109 | 3925 | `				while( pR < pUse->pResolvEnd ){` |
|       - | 3926 | `					SyString sTrait,sMethod;` |
|       - | 3927 | `					ph7_class *pSrcTrait;` |
|       - | 3928 | `					ph7_class_method *pMeth;` |
|       - | 3929 | `					sxi32 nRKwrd;` |
|     175 | 3930 | `					while( pR < pUse->pResolvEnd && (pR->nType & PH7_TK_SEMI) ){ pR++; }` |
|     109 | 3931 | `					if( pR >= pUse->pResolvEnd ) break;` |
|      71 | 3932 | `					SyStringInitFromBuf(&sTrait,"",0);` |
|      71 | 3933 | `					SyStringInitFromBuf(&sMethod,"",0);` |
|      71 | 3934 | `					if( (pR->nType & PH7_TK_ID) == 0 ){ pR++; continue; }` |
|      71 | 3935 | `					sMethod = pR->sData;` |
|      71 | 3936 | `					pR++;` |
|      71 | 3937 | `					if( pR < pUse->pResolvEnd && (pR->nType & PH7_TK_OP) ){` |
...
|      13 | 3945 | `						}` |
|      13 | 3946 | `					}` |
|      71 | 3947 | `					if( pR >= pUse->pResolvEnd \|\| (pR->nType & PH7_TK_KEYWORD) == 0 ){` |
|     ! 0 | 3948 | `						while( pR < pUse->pResolvEnd && (pR->nType & PH7_TK_SEMI) == 0 ){ pR++; }` |
|     ! 0 | 3949 | `						continue;` |
|       - | 3950 | `					}` |
|      71 | 3951 | `					nRKwrd = SX_PTR_TO_INT(pR->pUserData);` |
|      71 | 3952 | `					pR++;` |
|      71 | 3953 | `					if( nRKwrd == PH7_TKWRD_INSTEADOF && sTrait.nByte > 0 ){` |
|      15 | 3954 | `						pSrcTrait = 0;` |
...
|       6 | 3971 | `						}` |
|       6 | 3972 | `					}` |
|     155 | 3973 | `					while( pR < pUse->pResolvEnd && (pR->nType & PH7_TK_SEMI) == 0 ){ pR++; }` |
|       5 | 3974 | `				}` |
|       - | 3975 | `				/* Install remaining non-conflicting methods from this use's traits */` |
|      91 | 3976 | `				for( nT = 0 ; nT < nTraits ; nT++ ){` |
|       - | 3977 | `					ph7_class_method *pMR;` |
|       - | 3978 | `					SyHashEntry *pER;` |
|       - | 3979 | `					SyString *pNR;` |
|      53 | 3980 | `					SyHashResetLoopCursor(&apTrait[nT]->hMethod);` |
|     163 | 3981 | `					while((pER = SyHashGetNextEntry(&apTrait[nT]->hMethod)) != 0 ){` |
|      91 | 3982 | `						pMR = (ph7_class_method *)pER->pUserData;` |
|      91 | 3983 | `						pNR = &pMR->sFunc.sName;` |
|      91 | 3984 | `						if( SyHashGet(&pClass->hMethod,(const void *)pNR->zString,pNR->nByte) == 0 ){` |
|      67 | 3985 | `							SyHashInsert(&pClass->hMethod,(const void *)pNR->zString,pNR->nByte,pMR);` |
|      31 | 3986 | `						}` |
|       5 | 3987 | `					}` |
|      29 | 3988 | `				}` |
|       - | 3989 | `				/* Pass 2: process as rules (aliases and visibility changes) */` |
|      43 | 3990 | `				pR = pUse->pResolvStart;` |
|     109 | 3991 | `				while( pR < pUse->pResolvEnd ){` |
|       - | 3992 | `					SyString sTrait,sMethod,sAlias;` |
|       - | 3993 | `					ph7_class *pSrcTrait;` |
|       - | 3994 | `					ph7_class_method *pMeth;` |
|     109 | 3995 | `					int hasQual = 0;` |
|       - | 3996 | `					sxi32 nRKwrd;` |
|     175 | 3997 | `					while( pR < pUse->pResolvEnd && (pR->nType & PH7_TK_SEMI) ){ pR++; }` |
|     109 | 3998 | `					if( pR >= pUse->pResolvEnd ) break;` |
|      71 | 3999 | `					SyStringInitFromBuf(&sTrait,"",0);` |
|      71 | 4000 | `					SyStringInitFromBuf(&sMethod,"",0);` |
|      71 | 4001 | `					SyStringInitFromBuf(&sAlias,"",0);` |
|      71 | 4002 | `					if( (pR->nType & PH7_TK_ID) == 0 ){ pR++; continue; }` |
|      71 | 4003 | `					sMethod = pR->sData;` |
|      71 | 4004 | `					pR++;` |
|      71 | 4005 | `					if( pR < pUse->pResolvEnd && (pR->nType & PH7_TK_OP) ){` |
...
|      13 | 4014 | `						}` |
|      13 | 4015 | `					}` |
|      71 | 4016 | `					if( pR >= pUse->pResolvEnd \|\| (pR->nType & PH7_TK_KEYWORD) == 0 ){` |
|     ! 0 | 4017 | `						while( pR < pUse->pResolvEnd && (pR->nType & PH7_TK_SEMI) == 0 ){ pR++; }` |
|     ! 0 | 4018 | `						continue;` |
|       - | 4019 | `					}` |
|      71 | 4020 | `					nRKwrd = SX_PTR_TO_INT(pR->pUserData);` |
|      71 | 4021 | `					pR++;` |
|      71 | 4022 | `					if( nRKwrd == PH7_TKWRD_AS ){` |
|      59 | 4023 | `						sxi32 iNewVis = -1;` |
|      59 | 4024 | `						if( pR < pUse->pResolvEnd && (pR->nType & PH7_TK_KEYWORD) ){` |
...
|      10 | 4029 | `							}` |
|      10 | 4030 | `						}` |
|      59 | 4031 | `						if( pR < pUse->pResolvEnd && (pR->nType & PH7_TK_ID) ){` |
|      57 | 4032 | `							sAlias = pR->sData;` |
|      57 | 4033 | `							pR++;` |
|      26 | 4034 | `						}` |
|      59 | 4035 | `						pMeth = 0;` |
|      59 | 4036 | `						if( hasQual ){` |
...
|       7 | 4048 | `							}` |
|      10 | 4049 | `						}else{` |
|      45 | 4050 | `							pMeth = PH7_ClassExtractMethod(pClass,sMethod.zString,sMethod.nByte);` |
|       - | 4051 | `						}` |
|      59 | 4052 | `						if( pMeth ){` |
...
|      59 | 4060 | `							int bClassWins = 0;` |
|      59 | 4061 | `							if( sAlias.nByte > 0 ){` |
|      57 | 4062 | `								ph7_class_method *pOwn = PH7_ClassExtractMethod(pClass,sAlias.zString,sAlias.nByte);` |
|      57 | 4063 | `								bClassWins = (pOwn && pOwn->sFunc.pUserData == pClass);` |
|      26 | 4064 | `							}` |
|      82 | 4065 | `							if( sAlias.nByte > 0 && !bClassWins ){` |
...
|       - | 4070 | `								char *zAliasDup;` |
|      51 | 4071 | `								pAlias = (ph7_class_method *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_class_method));` |
|      51 | 4072 | `								if( pAlias ){` |
|      51 | 4073 | `									SyMemcpy(pMeth,pAlias,sizeof(ph7_class_method));` |
|      51 | 4074 | `									if( iNewVis >= 0 ){` |
...
|       9 | 4078 | `									}` |
|      51 | 4079 | `									zAliasDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,sAlias.zString,sAlias.nByte);` |
|      51 | 4080 | `									if( zAliasDup ){` |
|      51 | 4081 | `										SyHashInsert(&pClass->hMethod,(const void *)zAliasDup,sAlias.nByte,pAlias);` |
|      23 | 4082 | `									}` |
|      28 | 4083 | `								}` |
...
|      27 | 4101 | `					}` |
|      83 | 4102 | `					while( pR < pUse->pResolvEnd && (pR->nType & PH7_TK_SEMI) == 0 ){ pR++; }` |
|       5 | 4103 | `				}` |
|       - | 4104 | `			}` |
...
|     175 | 4476 | `				sUse.pResolvStart = sUse.pResolvEnd = 0;` |
|     175 | 4477 | `				pGen->pIn++; /* Jump the 'use' keyword */` |
|      99 | 4478 | `				for(;;){` |
|       - | 4479 | `					ph7_class *pTrait;` |
|       - | 4480 | `					SyBlob sResolved;` |
|       - | 4481 | `					SyString sTraitName;` |
|     189 | 4482 | `					sxu32 nUseLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
...
|     189 | 4489 | `					SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|     189 | 4490 | `					if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|     ! 0 | 4497 | `						break;` |
|       - | 4498 | `					}` |
|     373 | 4499 | `					pTrait = PH7_VmExtractClass(pGen->pVm,` |
|     184 | 4500 | `						(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|     189 | 4501 | `					SyStringInitFromBuf(&sTraitName,` |
|       - | 4502 | `						(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|       - | 4503 | `					/* Only traits are allowed */` |
|     189 | 4504 | `					while( pTrait && (pTrait->iFlags & PH7_CLASS_TRAIT) == 0 ){` |
|     ! 0 | 4505 | `						pTrait = pTrait->pNextName;` |
|     ! 0 | 4506 | `					}` |
|     189 | 4507 | `					if( pTrait == 0 ){` |
...
|       - | 4513 | `						}` |
|     ! 0 | 4514 | `					}else{` |
|     189 | 4515 | `						SySetPut(&sUse.aTraits,(const void *)&pTrait);` |
|       - | 4516 | `					}` |
|     189 | 4517 | `					SyBlobRelease(&sResolved);` |
...
|     189 | 4520 | `					if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COMMA) == 0 ){` |
|      90 | 4521 | `						break;` |
|       - | 4522 | `					}` |
|      18 | 4523 | `					pGen->pIn++; /* Jump the comma */` |
|       4 | 4524 | `				}` |
|       - | 4525 | `				/* Expect semicolon or opening brace (for conflict resolution) */` |
|     175 | 4526 | `				if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OCB) ){` |
|       - | 4527 | `					SyToken *pBlock;` |
|      39 | 4528 | `					pGen->pIn++; /* Jump '{' */` |
|      39 | 4529 | `					PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB,PH7_TK_CCB,&pBlock);` |
|      39 | 4530 | `					sUse.pResolvStart = pGen->pIn;` |
|      39 | 4531 | `					sUse.pResolvEnd = pBlock;` |
|      39 | 4532 | `					if( pBlock < pGen->pEnd ){` |
|      39 | 4533 | `						pGen->pIn = &pBlock[1]; /* Skip past '}' */` |
|      22 | 4534 | `					}else{` |
|     ! 0 | 4535 | `						pGen->pIn = pGen->pEnd;` |
|       - | 4536 | `					}` |
|      17 | 4537 | `				}` |
|     175 | 4538 | `				SySetPut(&aUseEntries,(const void *)&sUse);` |
...
|      44 | 4695 | `							iProtection = nKwrd;` |
|      44 | 4696 | `							pGen->pIn++; /* Jump the visibility token */` |
|      20 | 4697 | `						}` |
|      21 | 4698 | `					}` |
...
|       - | 5165 | ` */` |
|     192 | 5166 | `PH7_PRIVATE sxi32 PH7_CompileTrait(ph7_gen_state *pGen)` |
|       5 | 5167 | `{` |
|     197 | 5168 | `	sxu32 nLine = pGen->pIn->nLine;` |
|       - | 5169 | `	ph7_class *pClass;` |
|     197 | 5170 | `	ph7_class *pSavedCurClass = pGen->pCurClass; /* restored at 'done' */` |
...
|       - | 5181 | `		sxi32 rcDefer;` |
|     197 | 5182 | `		if( GenStateMaybeDeferClass(pGen,0,PH7_DEFER_KIND_TRAIT,&rcDefer) ){` |
|       6 | 5183 | `			return rcDefer == SXERR_ABORT ? SXERR_ABORT : SXRET_OK;` |
|       - | 5184 | `		}` |
|       - | 5185 | `	}` |
|     193 | 5186 | `	SySetInit(&aUseEntries,&pGen->pVm->sAllocator,sizeof(TraitUseEntry));` |
|       - | 5187 | `	/* Jump the 'trait' keyword */` |
|     193 | 5188 | `	pGen->pIn++;` |
|     193 | 5189 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
...
|     193 | 5200 | `	pName = &pGen->pIn->sData;` |
|     193 | 5201 | `	pGen->pIn++;` |
|       - | 5202 | `	/* Build FQN and obtain a raw class */ {` |
|       - | 5203 | `		SyBlob sFQN;` |
|       - | 5204 | `		SyString sFQNStr;` |
|     193 | 5205 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|     193 | 5206 | `		GenStateBuildFQN(pGen,pName,&sFQN);` |
|     193 | 5207 | `		SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|       - | 5208 | ``		/* php refuses a declaration whose short name a local `use` already took. */`` |
|     193 | 5209 | `		if( GenStateGuardImportRedeclare(pGen,0,pName,&sFQNStr,nLine) == SXERR_ABORT ){` |
|     ! 0 | 5210 | `			SyBlobRelease(&sFQN);` |
|     ! 0 | 5211 | `			return SXERR_ABORT;` |
|       - | 5212 | `		}` |
|     193 | 5213 | `		GenStateRecordDeclaredName(pGen,0,&sFQNStr);` |
|     193 | 5214 | `		pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|     193 | 5215 | `		SyBlobRelease(&sFQN);` |
|       - | 5216 | `	}` |
|     193 | 5217 | `	if( pClass == 0 ){` |
|     ! 0 | 5218 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|     ! 0 | 5219 | `		return SXERR_ABORT;` |
|       - | 5220 | `	}` |
|     193 | 5221 | `	GenStateConsumeDoc(&(*pGen),&pClass->sDoc);` |
|     193 | 5222 | `	if( GenStateConsumeAttrs(&(*pGen),&pClass->aAttrs) == SXERR_ABORT ){` |
|     ! 0 | 5223 | `		return SXERR_ABORT;` |
|       - | 5224 | `	}` |
|       - | 5225 | `	/* Traits cannot extend or implement; expect opening brace directly */` |
|     193 | 5226 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_OCB) == 0 ){` |
...
|       - | 5233 | `	}` |
|     193 | 5234 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|     193 | 5235 | `	pEnd = 0;` |
|     193 | 5236 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB,PH7_TK_CCB,&pEnd);` |
|     193 | 5237 | `	if( pEnd >= pGen->pEnd ){` |
...
|     193 | 5246 | `	pClass->nEndLine = pEnd->nLine;` |
|       - | 5247 | `	/* Swap token stream */` |
|     193 | 5248 | `	pTmp = pGen->pEnd;` |
|     193 | 5249 | `	pGen->pEnd = pEnd;` |
|       - | 5250 | `	/* Mark as trait (PH7_NewRawClass may have set INTERNAL) */` |
|     193 | 5251 | `	pClass->iFlags \|= PH7_CLASS_TRAIT;` |
...
|     193 | 5254 | `	pGen->pCurClass = pClass;` |
|       - | 5255 | `	/* Parse the body: same as a normal class (methods, attributes, visibility modifiers) */` |
|     211 | 5256 | `	for(;;){` |
|     513 | 5257 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|      49 | 5258 | `			pGen->pIn++;` |
|       5 | 5259 | `		}` |
|     469 | 5260 | `		if( pGen->pIn >= pGen->pEnd ){` |
|     193 | 5261 | `			break;` |
|       - | 5262 | `		}` |
|       - | 5263 | `		/* Bind a directly-preceding docblock to this member */` |
|     281 | 5264 | `		GenStateSetPendingDoc(&(*pGen));` |
|     281 | 5265 | `		if( (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR)) == 0 ){` |
...
|     ! 0 | 5272 | `			goto done;` |
|       - | 5273 | `		}` |
|     281 | 5274 | `		iProtection = PH7_TKWRD_PUBLIC;` |
|     281 | 5275 | `		iAttrflags = 0;` |
|     281 | 5276 | `		if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|     281 | 5277 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|     281 | 5278 | `			if( nKwrd == PH7_TKWRD_USE ){` |
...
|      19 | 5342 | `				continue;` |
|       - | 5343 | `			}` |
|     267 | 5344 | `			if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|     245 | 5345 | `				iProtection = nKwrd;` |
|     245 | 5346 | `				pGen->pIn++;` |
...
|     245 | 5350 | `				if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|       5 | 5351 | `					iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|       5 | 5352 | `					pGen->pIn++; /* Jump the 'readonly' modifier */` |
|       2 | 5353 | `				}` |
|     240 | 5354 | `				if( pGen->pIn >= pGen->pEnd` |
|     245 | 5355 | `					\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|     ! 0 | 5362 | `					goto done;` |
|       - | 5363 | `				}` |
|     245 | 5364 | `				if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
...
|      23 | 5372 | `					continue;` |
|       - | 5373 | `				}` |
|     227 | 5374 | `				if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|       9 | 5382 | `					continue;` |
|       - | 5383 | `				}` |
|     219 | 5384 | `				nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|     107 | 5385 | `			}` |
|     241 | 5386 | `			if( nKwrd == PH7_TKWRD_CONST ){` |
...
|     ! 0 | 5392 | `				goto done;` |
|     ! 0 | 5393 | `			}else{` |
|     241 | 5394 | `				if( nKwrd == PH7_TKWRD_STATIC ){` |
...
|     232 | 5435 | `				}else if( nKwrd == PH7_TKWRD_ABSTRACT ){` |
...
|       3 | 5456 | `				}` |
|     239 | 5457 | `				if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_VAR ){` |
...
|     ! 0 | 5464 | `					goto done;` |
|       - | 5465 | `				}` |
|     239 | 5466 | `				if( nKwrd == PH7_TKWRD_VAR ){` |
|     ! 0 | 5467 | `					pGen->pIn++;` |
...
|     ! 0 | 5477 | `				}else{` |
|     239 | 5478 | `					rc = GenStateCompileClassMethod(&(*pGen),iProtection,iAttrflags,TRUE,pClass);` |
|       - | 5479 | `				}` |
|     239 | 5480 | `				if( rc != SXRET_OK ){` |
...
|     193 | 5499 | `	rc = GenStateApplyTraitUses(&(*pGen),pClass,&aUseEntries);` |
|     193 | 5500 | `	SySetRelease(&aUseEntries);` |
|     193 | 5501 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 | 5502 | `		return SXERR_ABORT;` |
|       - | 5503 | `	}` |
|       - | 5504 | `	/* Reject a php-fatal redeclaration before hoisting the trait */` |
|     193 | 5505 | `	if( GenStateGuardClassRedeclaration(pGen,pClass) == SXERR_ABORT ){` |
|       3 | 5506 | `		return SXERR_ABORT;` |
|       - | 5507 | `	}` |
|       - | 5508 | `	/* Install the trait */` |
|     191 | 5509 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|     191 | 5510 | `	if( rc != SXRET_OK ){` |
|     ! 0 | 5511 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|     ! 0 | 5512 | `		return SXERR_ABORT;` |
|       - | 5513 | `	}` |
|      93 | 5514 | `done:` |
|     191 | 5515 | `	pGen->pCurClass = pSavedCurClass;` |
|       - | 5516 | `	/* Point beyond the trait body */` |
|     191 | 5517 | `	pGen->pIn = &pEnd[1];` |
|     191 | 5518 | `	pGen->pEnd = pTmp;` |
|     191 | 5519 | `	return PH7_OK;` |
|     101 | 5520 | `}` |
|       - | 5521 | `/*` |
...
|       - | 5555 | ` */` |
|     102 | 5556 | `PH7_PRIVATE sxi32 PH7_CompileEnum(ph7_gen_state *pGen)` |
|       5 | 5557 | `{` |
|     107 | 5558 | `	return GenStateCompileClass(&(*pGen),PH7_CLASS_ENUM\|PH7_CLASS_FINAL);` |
|       5 | 5559 | `}` |
|       - | 5560 |  |
