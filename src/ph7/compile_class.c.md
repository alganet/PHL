...
|        - |   26 | ` */` |
|   527966 |   27 | `static sxi32 GenStateGuardClassRedeclaration(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 |   28 | `{` |
|        - |   29 | `	SyHashEntry *pEntry;` |
|   527971 |   30 | `	if( !GenStateUnconditionalTopLevel(pGen) ){` |
|       26 |   31 | `		return SXRET_OK; /* conditional/nested: keep hoisting */` |
|        - |   32 | `	}` |
|   527949 |   33 | `	pClass->iFlags \|= PH7_CLASS_BOUND;` |
|   527949 |   34 | `	if( pGen->pVm->bCompilingBuiltin ){` |
|   525781 |   35 | `		return SXRET_OK; /* the prelude installs each builtin exactly once */` |
|        - |   36 | `	}` |
|     2173 |   37 | `	pEntry = SyHashGet(&pGen->pVm->hClass,(const void *)pClass->sName.zString,pClass->sName.nByte);` |
|     2173 |   38 | `	if( pEntry ){` |
...
|        - |   70 | ` */` |
|  3815090 |   71 | `static sxi32 GetProtectionLevel(sxi32 nKeyword)` |
|        5 |   72 | `{` |
|  3815095 |   73 | `	if( nKeyword == PH7_TKWRD_PRIVATE ){` |
|   278583 |   74 | `		return PH7_CLASS_PROT_PRIVATE;` |
|  3536517 |   75 | `	}else if( nKeyword == PH7_TKWRD_PROTECTED ){` |
|   220469 |   76 | `		return PH7_CLASS_PROT_PROTECTED;` |
|        - |   77 | `	}` |
|        - |   78 | `	/* Assume public by default */` |
|  3316053 |   79 | `	return PH7_CLASS_PROT_PUBLIC;` |
|  1907550 |   80 | `}` |
|        - |   81 | `/*` |
...
|        - |   88 | ` */` |
|   340416 |   89 | `static int GenStateClassConstHasType(ph7_gen_state *pGen)` |
|        5 |   90 | `{` |
|        - |   91 | `	SyToken *p0, *p1;` |
|   340421 |   92 | `	if( pGen->pIn >= pGen->pEnd ){` |
|      ! 0 |   93 | `		return 0;` |
|        - |   94 | `	}` |
|   340421 |   95 | `	p0 = pGen->pIn;` |
|        - |   96 | `	/* A leading '\' (namespaced class type) or '?' (nullable) always starts a type */` |
|   340421 |   97 | `	if( p0->nType & PH7_TK_NSSEP ){` |
|      ! 0 |   98 | `		return 1;` |
|        - |   99 | `	}` |
|   340421 |  100 | `	if( (p0->nType & PH7_TK_OP) && p0->sData.nByte == 1 && p0->sData.zString[0] == '?' ){` |
|        5 |  101 | `		return 1;` |
|        - |  102 | `	}` |
...
|   340417 |  106 | `	if( p0->nType & (PH7_TK_ID\|PH7_TK_KEYWORD) ){` |
|   340417 |  107 | `		p1 = (pGen->pIn + 1 < pGen->pEnd) ? (pGen->pIn + 1) : 0;` |
|   340417 |  108 | `		if( p1 ){` |
|   340417 |  109 | `			if( p1->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_NSSEP) ){` |
|       34 |  110 | `				return 1;` |
|        - |  111 | `			}` |
|   340387 |  112 | `			if( (p1->nType & PH7_TK_OP) && p1->sData.nByte == 1 && p1->sData.zString[0] == '\|' ){` |
|        5 |  113 | `				return 1;` |
|        - |  114 | `			}` |
|   170189 |  115 | `		}` |
|   170189 |  116 | `	}` |
...
|        - |  172 | ` */` |
|   720060 |  173 | `static int GenStateInitHasNewExpr(ph7_gen_state *pGen)` |
|        5 |  174 | `{` |
|   720065 |  175 | `	SyToken *p = pGen->pIn;` |
|   720065 |  176 | `	int iDepth = 0;` |
|  1901833 |  177 | `	while( p < pGen->pEnd ){` |
|  1901833 |  178 | `		if( iDepth == 0 && (p->nType & (PH7_TK_SEMI\|PH7_TK_COMMA)) ){` |
|   720013 |  179 | `			break; /* end of this initializer */` |
|        - |  180 | `		}` |
|  1181820 |  181 | `		if( (p->nType & PH7_TK_KEYWORD)` |
|   598667 |  182 | `			&& ( SX_PTR_TO_INT(p->pUserData) == PH7_TKWRD_FUNCTION` |
|    15503 |  183 | `				\|\| SX_PTR_TO_INT(p->pUserData) == PH7_TKWRD_FN ) ){` |
...
|        6 |  241 | `			continue;` |
|        - |  242 | `		}` |
|  1181821 |  243 | `		if( p->nType & PH7_TK_OCB ){` |
|       45 |  244 | `			if( iDepth == 0 ){` |
...
|        - |  250 | `			}` |
|      ! 0 |  251 | `			iDepth++;` |
|  1181777 |  252 | `		}else if( p->nType & (PH7_TK_LPAREN\|PH7_TK_OSB) ){` |
|    50363 |  253 | `			iDepth++;` |
|  1156598 |  254 | `		}else if( p->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB) ){` |
|    50361 |  255 | `			if( iDepth > 0 ){` |
|    50361 |  256 | `				iDepth--;` |
|    25178 |  257 | `			}` |
|  1106241 |  258 | `		}else if( (p->nType & PH7_TK_OP) && p->pUserData` |
|   389631 |  259 | `			&& ((const ph7_expr_op *)p->pUserData)->iOp == EXPR_OP_NEW ){` |
...
|        - |  277 | ` */` |
|  1269552 |  278 | `static ph7_class_attr * GenStateExtractConstant(ph7_class *pClass,SyString *pName)` |
|        5 |  279 | `{` |
|  1269557 |  280 | `	ph7_class_attr *pAttr = PH7_ClassExtractAttribute(pClass,pName->zString,pName->nByte);` |
|  1269557 |  281 | `	return ( pAttr && (pAttr->iFlags & PH7_CLASS_ATTR_CONSTANT) ) ? pAttr : 0;` |
|        5 |  282 | `}` |
|  1517964 |  283 | `static ph7_class_attr * GenStateExtractProperty(ph7_class *pClass,const char *zName,sxu32 nByte)` |
|        5 |  284 | `{` |
|  1517969 |  285 | `	ph7_class_attr *pAttr = PH7_ClassExtractAttribute(pClass,zName,nByte);` |
|  1517969 |  286 | `	return ( pAttr && (pAttr->iFlags & PH7_CLASS_ATTR_CONSTANT) == 0 ) ? pAttr : 0;` |
|        5 |  287 | `}` |
|        - |  288 | `/*` |
...
|        - |  308 | ` */` |
|   720110 |  309 | `PH7_PRIVATE int PH7_GenStateInitHasCallExpr(ph7_gen_state *pGen)` |
|        5 |  310 | `{` |
|   720115 |  311 | `	SyToken *p = pGen->pIn;` |
|   720115 |  312 | `	int iDepth = 0;` |
|        - |  313 | `	/* Conservative ternary bail-out (see the note above). */` |
|        - |  314 | `	{` |
|   720115 |  315 | `		SyToken *q = pGen->pIn;` |
|   720115 |  316 | `		int iQd = 0;` |
|  1903181 |  317 | `		while( q < pGen->pEnd ){` |
|  1903143 |  318 | `			if( iQd == 0 && (q->nType & (PH7_TK_SEMI\|PH7_TK_COMMA)) ){` |
|   720071 |  319 | `				break;` |
|        - |  320 | `			}` |
|  1183077 |  321 | `			if( q->nType & (PH7_TK_LPAREN\|PH7_TK_OSB\|PH7_TK_OCB) ){` |
|    50499 |  322 | `				iQd++;` |
|  1157830 |  323 | `			}else if( q->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB) ){` |
|    50499 |  324 | `				if( iQd > 0 ){ iQd--; }` |
|  1107336 |  325 | `			}else if( (q->nType & PH7_TK_OP) && q->pUserData` |
|   389857 |  326 | `				&& ((const ph7_expr_op *)q->pUserData)->iOp == EXPR_OP_QUESTY ){` |
|        8 |  327 | `				return 0;` |
|        - |  328 | `			}` |
|  1183071 |  329 | `			q++;` |
|        5 |  330 | `		}` |
|        - |  331 | `	}` |
|  1902027 |  332 | `	while( p < pGen->pEnd ){` |
|  1902027 |  333 | `		if( iDepth == 0 && (p->nType & (PH7_TK_SEMI\|PH7_TK_COMMA)) ){` |
|   720065 |  334 | `			break; /* end of this initializer */` |
|        - |  335 | `		}` |
|  1181962 |  336 | `		if( (p->nType & PH7_TK_KEYWORD)` |
|   598738 |  337 | `			&& ( SX_PTR_TO_INT(p->pUserData) == PH7_TKWRD_FUNCTION` |
|    15503 |  338 | `				\|\| SX_PTR_TO_INT(p->pUserData) == PH7_TKWRD_FN ) ){` |
...
|        6 |  388 | `			continue;` |
|        - |  389 | `		}` |
|  1181963 |  390 | `		if( p->nType & PH7_TK_OCB ){` |
|       43 |  391 | `			if( iDepth == 0 ){` |
|       43 |  392 | `				break; /* property-hook list: the default expression ends here */` |
|        - |  393 | `			}` |
|      ! 0 |  394 | `			iDepth++;` |
|  1181921 |  395 | `		}else if( p->nType & (PH7_TK_LPAREN\|PH7_TK_OSB) ){` |
...
|    50378 |  399 | `			if( (p->nType & PH7_TK_LPAREN) && p > pGen->pIn` |
|    15494 |  400 | `				&& (p[-1].nType & PH7_TK_ID)` |
|     7759 |  401 | `				&& !((p[-1].nType & PH7_TK_OP) && p[-1].pUserData` |
...
|        6 |  421 | `			}` |
|    50381 |  422 | `			iDepth++;` |
|  1156731 |  423 | `		}else if( p->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB) ){` |
|    50381 |  424 | `			if( iDepth > 0 ){` |
|    50381 |  425 | `				iDepth--;` |
|    25188 |  426 | `			}` |
|    25188 |  427 | `		}` |
|  1181919 |  428 | `		p++;` |
...
|        - |  439 | ` */` |
|    15858 |  440 | `static void GenStateCopyTypeToAttr(ph7_class_attr *pAttr,sxu32 nType,` |
|        - |  441 | `	const SyString *pClass,const SyString *pTypeName,sxi32 iTypeFlags,SySet *pAlts)` |
|        5 |  442 | `{` |
|    15863 |  443 | `	pAttr->nType = nType;` |
|    15863 |  444 | `	pAttr->sClass = *pClass;` |
|    15863 |  445 | `	pAttr->sTypeName = *pTypeName;` |
|    15863 |  446 | `	if( iTypeFlags & PH7_CLASS_ATTR_UNION ){` |
|        - |  447 | `		sxu32 i;` |
...
|       11 |  452 | `	}` |
|    15863 |  453 | `}` |
|   340416 |  454 | `static sxi32 GenStateCompileClassConstant(ph7_gen_state *pGen,sxi32 iProtection,sxi32 iFlags,ph7_class *pClass)` |
|        5 |  455 | `{` |
|   340421 |  456 | `	sxu32 nLine = pGen->pIn->nLine;` |
|        - |  457 | `	SySet *pInstrContainer;` |
|        - |  458 | `	ph7_class_attr *pCons;` |
|        - |  459 | `	SyString *pName;` |
|        - |  460 | `	sxi32 rc;` |
|   340421 |  461 | `	sxu32 nType = 0;` |
|        - |  462 | `	SyString sTypeClass;` |
|        - |  463 | `	SyString sTypeText;` |
|        - |  464 | `	SySet aUnionAlts;` |
|   340421 |  465 | `	sxi32 iTypeFlags = 0;` |
|   340421 |  466 | `	SyStringInitFromBuf(&sTypeClass,0,0);` |
|   340421 |  467 | `	SyStringInitFromBuf(&sTypeText,0,0);` |
|   340421 |  468 | `	SySetInit(&aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|        - |  469 | `	/* Extract visibility level */` |
|   340421 |  470 | `	iProtection = GetProtectionLevel(iProtection);` |
|        - |  471 | `	/* Mark as constant */` |
|   340421 |  472 | `	iFlags \|= PH7_CLASS_ATTR_CONSTANT;` |
|   340421 |  473 | `	pGen->pIn++; /* Jump the 'const' keyword */` |
...
|   340440 |  476 | `	if( GenStateClassConstHasType(pGen) ){` |
...
|       19 |  497 | `	}` |
|   170208 |  498 | `loop:` |
|   340423 |  499 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
...
|   340423 |  509 | `	pName = &pGen->pIn->sData;` |
|        - |  510 | `	/* Make sure the constant name isn't reserved */` |
|   340423 |  511 | `	if( GenStateIsReservedConstant(pName) ){` |
...
|   340423 |  521 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
...
|   340421 |  532 | `	pGen->pIn++;` |
|   340421 |  533 | `	if(pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_EQUAL /* '=' */) == 0 ){` |
...
|        - |  541 | `	}` |
|   340421 |  542 | `	pGen->pIn++; /* Jump the equal sign */` |
...
|   340416 |  547 | `	if( (iTypeFlags & PH7_CLASS_ATTR_TYPED) && !(iTypeFlags & PH7_CLASS_ATTR_UNION)` |
...
|   340417 |  559 | `	if( PH7_GenStateInitHasCallExpr(pGen) ){` |
...
|   340417 |  570 | `	if( GenStateInitHasNewExpr(pGen) ){` |
...
|   340408 |  586 | `	if( GenStateExtractConstant(pClass,pName) == 0` |
|   340413 |  587 | `	 && GenStateExtractProperty(pClass,pName->zString,pName->nByte) != 0 ){` |
...
|        - |  595 | `	}` |
|   340413 |  596 | `	if( GenStateExtractConstant(pClass,pName) != 0 ){` |
...
|   340413 |  605 | `	pCons = PH7_NewClassAttr(pGen->pVm,pName,nLine,iProtection,iFlags\|iTypeFlags);` |
|   340413 |  606 | `	if( pCons ){` |
|   340413 |  607 | `		GenStateConsumeDoc(&(*pGen),&pCons->sDoc);` |
|   340413 |  608 | `		if( GenStateConsumeAttrs(&(*pGen),&pCons->aAttrs) == SXERR_ABORT ){` |
|      ! 0 |  609 | `			return SXERR_ABORT;` |
|        - |  610 | `		}` |
|   170204 |  611 | `	}` |
|   340413 |  612 | `	if( pCons == 0 ){` |
|      ! 0 |  613 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 |  614 | `		return SXERR_ABORT;` |
|        - |  615 | `	}` |
|   340413 |  616 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|       35 |  617 | `		GenStateCopyTypeToAttr(pCons,nType,&sTypeClass,&sTypeText,iTypeFlags,&aUnionAlts);` |
|       16 |  618 | `	}` |
|        - |  619 | `	/* Swap bytecode container */` |
|   340413 |  620 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   340413 |  621 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pCons->aByteCode);` |
|        - |  622 | `	/* Compile constant value.` |
|        - |  623 | `	 */` |
|   340413 |  624 | `	rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|   340413 |  625 | `	if( rc == SXERR_EMPTY ){` |
...
|   340413 |  632 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|   340413 |  633 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|   340413 |  634 | `	if( rc == SXERR_ABORT ){` |
...
|   340413 |  639 | `	rc = PH7_ClassInstallAttr(pClass,pCons);` |
|   340413 |  640 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  641 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 |  642 | `		return SXERR_ABORT;` |
|        - |  643 | `	}` |
|   340413 |  644 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA /*','*/) ){` |
...
|        - |  662 | `		}` |
|      ! 0 |  663 | `	}` |
|   340411 |  664 | `	SySetRelease(&aUnionAlts);` |
|   340411 |  665 | `	return SXRET_OK;` |
|        5 |  666 | `Synchronize:` |
...
|        - |  702 | ` */` |
|  2611536 |  703 | `static int GenStateLooksLikeTypedProperty(SyToken *pStart,SyToken *pEnd)` |
|        5 |  704 | `{` |
|  2611541 |  705 | `	SyToken *p = pStart;` |
|  2611541 |  706 | `	int bFirst = 1;` |
|  2611541 |  707 | `	if( p >= pEnd ) return 0;` |
|        - |  708 | ``	/* Optional nullable `?` shorthand. */`` |
|  2611541 |  709 | `	if( (p->nType & PH7_TK_OP) && p->sData.nByte == 1 && p->sData.zString[0] == '?' ){` |
|       41 |  710 | `		p++;` |
...
|  1305768 |  717 | `	for(;;){` |
|  2611561 |  718 | `		if( p < pEnd && (p->nType & PH7_TK_LPAREN) ){` |
...
|  2611559 |  727 | `			if( p < pEnd && (p->nType & PH7_TK_NSSEP) ){ p++; }` |
|  2611559 |  728 | `			if( p >= pEnd \|\| (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|      ! 0 |  729 | `				return 0;` |
|        - |  730 | `			}` |
...
|  2611559 |  734 | `			if( bFirst && (p->nType & PH7_TK_KEYWORD) ){` |
|  2611503 |  735 | `				sxu32 k = (sxu32)(SX_PTR_TO_INT(p->pUserData));` |
|  2611498 |  736 | `				if( k == PH7_TKWRD_FUNCTION \|\| k == PH7_TKWRD_VAR \|\| k == PH7_TKWRD_CONST` |
|   124214 |  737 | `				 \|\| k == PH7_TKWRD_STATIC \|\| k == PH7_TKWRD_FINAL \|\| k == PH7_TKWRD_ABSTRACT ){` |
|  2595721 |  738 | `					return 0;` |
|        - |  739 | `				}` |
|     7891 |  740 | `			}` |
|    15843 |  741 | `			p++;` |
|    15845 |  742 | `			while( p + 1 < pEnd && (p->nType & PH7_TK_NSSEP) && (p[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|        3 |  743 | `				p += 2;` |
|        1 |  744 | `			}` |
|    23760 |  745 | `			while( p + 1 < pEnd && (p->nType & PH7_TK_AMPER)` |
|    15846 |  746 | `				&& (p[1].nType & (PH7_TK_NSSEP\|PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|        3 |  747 | `				p++; /* skip '&' */` |
...
|        - |  755 | `		}` |
|    15845 |  756 | `		bFirst = 0;` |
|    15840 |  757 | `		if( p < pEnd && (p->nType & PH7_TK_OP) && p->sData.nByte == 1` |
...
|    15825 |  762 | `		break;` |
|      ! 0 |  763 | `	}` |
|    15825 |  764 | `	if( p >= pEnd ) return 0;` |
|    15825 |  765 | `	return (p->nType & PH7_TK_DOLLAR) ? 1 : 0;` |
|  1305773 |  766 | `}` |
|        - |  767 |  |
|        - |  768 | `/*` |
...
|        - |  785 | ` */` |
|    15830 |  786 | `static sxi32 GenStateParsePropertyType(` |
...
|        - |  792 | `	SySet *pAlts` |
|        5 |  793 | `){` |
|    15835 |  794 | `	sxi32 iFlags = 0;` |
|        - |  795 | `	sxi32 rc;` |
|    15835 |  796 | `	if( pGen->pIn >= pGen->pEnd ){` |
|      ! 0 |  797 | `		return SXRET_OK;` |
|        - |  798 | `	}` |
|        - |  799 | `	/* If the first token is '$', there's no type */` |
|    15835 |  800 | `	if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|      ! 0 |  801 | `		return SXRET_OK;` |
|        - |  802 | `	}` |
|    15835 |  803 | `	rc = GenStateParseUnionTypeDecl(` |
|     7915 |  804 | `		pGen, pnType, pClass, pAlts, &iFlags, pTypeText,` |
|        - |  805 | `		PH7_CLASS_ATTR_NULLABLE,` |
|        - |  806 | `		PH7_CLASS_ATTR_UNION,` |
|        - |  807 | `		/* bAllowVoid */ 0,` |
|    15830 |  808 | `		pGen->pIn->nLine);` |
|    15835 |  809 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  810 | `		return rc;` |
|        - |  811 | `	}` |
|        - |  812 | `	/* Verify next token is '$' (start of property name) */` |
|    15835 |  813 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
|      ! 0 |  814 | `		return SXERR_SYNTAX;` |
|        - |  815 | `	}` |
|    15835 |  816 | `	*piTypeFlags = iFlags \| PH7_CLASS_ATTR_TYPED;` |
|    15835 |  817 | `	return SXRET_OK;` |
|     7920 |  818 | `}` |
|        - |  819 |  |
|        - |  820 | `/*` |
...
|        - |  830 | ` */` |
|    16008 |  831 | `static int GenStateIsDisallowedPropertyAtom(` |
|        - |  832 | `	sxu32 nType,` |
...
|        - |  837 | `	const char *z;` |
|        - |  838 | `	sxu32 n;` |
|    16013 |  839 | `	if( nType != SXU32_HIGH \|\| pClass == 0 \|\| pClass->nByte == 0 ){` |
|    15947 |  840 | `		return 0;` |
|        - |  841 | `	}` |
...
|        - |  863 | ` */` |
|    15946 |  864 | `PH7_PRIVATE sxi32 GenStateValidateMemberType(` |
...
|        - |  873 | `	sxu32 nLine)` |
|        5 |  874 | `{` |
|    15951 |  875 | `	const char *zBad = 0;` |
|    15951 |  876 | `	sxu32 nBad = 0;` |
|        - |  877 | `	SyString sFallback;` |
|        - |  878 | `	const SyString *pBad;` |
|        - |  879 | `	sxi32 rc;` |
|    15951 |  880 | `	int bDisallowed = 0;` |
|    15951 |  881 | `	if( GenStateIsDisallowedPropertyAtom(nType,pTypeClass,&zBad,&nBad) ){` |
|        5 |  882 | `		bDisallowed = 1;` |
|    15949 |  883 | `	}else if( pUnionAlts ){` |
|        - |  884 | `		sxu32 i;` |
...
|       34 |  891 | `		}` |
|       15 |  892 | `	}` |
|    15951 |  893 | `	if( !bDisallowed ){` |
|    15945 |  894 | `		return SXRET_OK;` |
|        - |  895 | `	}` |
...
|        - |  918 | ` */` |
| 23438070 |  919 | `PH7_PRIVATE int GenStateIsReadonly(SyToken *pTok)` |
|        5 |  920 | `{` |
| 23663247 |  921 | `	return (pTok->nType & PH7_TK_ID)` |
| 11944207 |  922 | `		&& pTok->sData.nByte == sizeof("readonly")-1` |
| 23663242 |  923 | `		&& SyStrnicmp(pTok->sData.zString,"readonly",sizeof("readonly")-1) == 0;` |
|        5 |  924 | `}` |
|        - |  925 | `/*` |
...
|        - |  930 | ` */` |
|  8416290 |  931 | `PH7_PRIVATE sxi32 GenStatePeekSetVisibility(SyToken *pTok,SyToken *pEnd,int *pnTok)` |
|        5 |  932 | `{` |
|  8416295 |  933 | `	*pnTok = 0;` |
|  8416290 |  934 | `	if( &pTok[3] < pEnd` |
|  7868397 |  935 | `	 && (pTok->nType & PH7_TK_KEYWORD)` |
|  6417007 |  936 | `	 && (pTok[1].nType & PH7_TK_LPAREN)` |
|  2756763 |  937 | `	 && (pTok[2].nType & (PH7_TK_ID\|PH7_TK_KEYWORD))` |
...
|        9 |  959 | `}` |
|   588746 |  960 | `static sxi32 GenStateCompileClassAttr(ph7_gen_state *pGen,sxi32 iProtection,sxi32 iFlags,ph7_class *pClass)` |
|        5 |  961 | `{` |
|   588751 |  962 | `	sxu32 nLine = pGen->pIn->nLine;` |
|        - |  963 | `	ph7_class_attr *pAttr;` |
|        - |  964 | `	SyString *pName;` |
|        - |  965 | `	sxi32 rc;` |
|   588751 |  966 | `	sxu32 nType = 0;` |
|        - |  967 | `	SyString sTypeClass;` |
|        - |  968 | `	SyString sTypeText;` |
|        - |  969 | `	SySet aUnionAlts;` |
|   588751 |  970 | `	sxi32 iTypeFlags = 0;` |
|   588751 |  971 | `	SyStringInitFromBuf(&sTypeClass,0,0);` |
|   588751 |  972 | `	SyStringInitFromBuf(&sTypeText,0,0);` |
|   588751 |  973 | `	SySetInit(&aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
...
|   588751 |  977 | `	if( pClass->iFlags & PH7_CLASS_READONLY ){` |
|       21 |  978 | `		iFlags \|= PH7_CLASS_ATTR_READONLY;` |
|        9 |  979 | `	}` |
|        - |  980 | `	/* Extract visibility level */` |
|   588751 |  981 | `	iProtection = GetProtectionLevel(iProtection);` |
|        - |  982 | `	/* Parse optional type hint (typed properties, PHP 7.4+) */` |
|   596666 |  983 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
|    15835 |  984 | `		rc = GenStateParsePropertyType(pGen,&nType,&sTypeClass,&iTypeFlags,&sTypeText,&aUnionAlts);` |
|    15835 |  985 | `		if( rc == SXERR_CORRUPT ){` |
|        - |  986 | `			/* Error already reported by GenStateParseUnionTypeDecl */` |
|      ! 0 |  987 | `			goto Synchronize;` |
|    15835 |  988 | `		}else if( rc == SXERR_SYNTAX ){` |
...
|    15835 |  996 | `		}else if( rc == SXERR_ABORT ){` |
|      ! 0 |  997 | `			return SXERR_ABORT;` |
|        - |  998 | `		}` |
|     7915 |  999 | `	}` |
|      ! 0 | 1000 | `loop:` |
|   588755 | 1001 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
...
|        - | 1007 | `	}` |
|   588755 | 1008 | `	pGen->pIn++; /* Jump the dollar sign */` |
|   588755 | 1009 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_ID)) == 0 ){` |
...
|   588755 | 1019 | `	pName = &pGen->pIn->sData;` |
|        - | 1020 | `	/* Advance the stream cursor */` |
|   588755 | 1021 | `	pGen->pIn++;` |
|   588755 | 1022 | `	if(pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_EQUAL/*'='*/\|PH7_TK_SEMI/*';'*/\|PH7_TK_COMMA/*','*/\|PH7_TK_OCB/*'{' hooks*/)) == 0 ){` |
...
|   588753 | 1034 | `	if( iFlags & (PH7_CLASS_ATTR_PRIVATE_SET\|PH7_CLASS_ATTR_PROTECTED_SET\|PH7_CLASS_ATTR_PUBLIC_SET) ){` |
...
|   588753 | 1054 | `	if( iFlags & PH7_CLASS_ATTR_READONLY ){` |
...
|   588743 | 1074 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|    23747 | 1075 | `		rc = GenStateValidateMemberType(pGen,pClass,pName,nType,&sTypeClass,` |
|        - | 1076 | `			&sTypeText,` |
|    15828 | 1077 | `			(iTypeFlags & PH7_CLASS_ATTR_UNION) ? &aUnionAlts : 0,` |
|     7914 | 1078 | `			"Property %z::$%z cannot have type %z",nLine);` |
|    15833 | 1079 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 | 1080 | `			return SXERR_ABORT;` |
|    15833 | 1081 | `		}else if( rc != SXRET_OK ){` |
...
|   588738 | 1088 | `	if( GenStateExtractProperty(pClass,pName->zString,pName->nByte) == 0` |
|   588742 | 1089 | `	 && GenStateExtractConstant(pClass,pName) != 0 ){` |
...
|        - | 1097 | `	}` |
|   588743 | 1098 | `	if( GenStateExtractProperty(pClass,pName->zString,pName->nByte) != 0 ){` |
...
|   588741 | 1113 | `	if( (pGen->pIn->nType & PH7_TK_EQUAL /*'='*/) && PH7_GenStateInitHasCallExpr(pGen) ){` |
...
|        - | 1120 | `	}` |
|   588741 | 1121 | `	if( (pGen->pIn->nType & PH7_TK_EQUAL /*'='*/) && GenStateInitHasNewExpr(pGen) ){` |
...
|   588737 | 1130 | `	pAttr = PH7_NewClassAttr(pGen->pVm,pName,nLine,iProtection,iFlags\|iTypeFlags);` |
|   588737 | 1131 | `	if( pAttr ){` |
|   588737 | 1132 | `		GenStateConsumeDoc(&(*pGen),&pAttr->sDoc);` |
|   588737 | 1133 | `		if( GenStateConsumeAttrs(&(*pGen),&pAttr->aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 1134 | `			return SXERR_ABORT;` |
|        - | 1135 | `		}` |
|   294366 | 1136 | `	}` |
|   588737 | 1137 | `	if( pAttr == 0 ){` |
|      ! 0 | 1138 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 engine is running out of memory");` |
|      ! 0 | 1139 | `		return SXERR_ABORT;` |
|        - | 1140 | `	}` |
|   588737 | 1141 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|    15831 | 1142 | `		GenStateCopyTypeToAttr(pAttr,nType,&sTypeClass,&sTypeText,iTypeFlags,&aUnionAlts);` |
|     7913 | 1143 | `	}` |
|   588737 | 1144 | `	if( pGen->pIn->nType & PH7_TK_EQUAL /*'='*/ ){` |
|        - | 1145 | `		SySet *pInstrContainer;` |
|   379649 | 1146 | `		SyToken *pSavedDefEnd = pGen->pEnd;` |
|   379649 | 1147 | `		pGen->pIn++; /*Jump the equal sign */` |
|        - | 1148 | `		{` |
...
|   379649 | 1153 | `			SyToken *pScan = pGen->pIn;` |
|   379649 | 1154 | `			sxi32 iNest = 0;` |
|   837239 | 1155 | `			while( pScan < pGen->pEnd ){` |
|   837239 | 1156 | `				if( pScan->nType & (PH7_TK_LPAREN\|PH7_TK_OSB) ){` |
|    50351 | 1157 | `					iNest++;` |
|   812066 | 1158 | `				}else if( pScan->nType & (PH7_TK_RPAREN\|PH7_TK_CSB) ){` |
|    50351 | 1159 | `					iNest--;` |
|   761720 | 1160 | `				}else if( iNest <= 0 && (pScan->nType & (PH7_TK_SEMI\|PH7_TK_COMMA\|PH7_TK_OCB)) ){` |
|   379649 | 1161 | `					break;` |
|        - | 1162 | `				}` |
|   457595 | 1163 | `				pScan++;` |
|        5 | 1164 | `			}` |
|   379649 | 1165 | `			pGen->pEnd = pScan;` |
|        - | 1166 | `		}` |
|        - | 1167 | `		/* Swap bytecode container */` |
|   379649 | 1168 | `		pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   379649 | 1169 | `		PH7_VmSetByteCodeContainer(pGen->pVm,&pAttr->aByteCode);` |
|        - | 1170 | `		/* Compile attribute value.` |
|        - | 1171 | `		 */` |
|   379649 | 1172 | `		rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|   379649 | 1173 | `		if( rc == SXERR_EMPTY ){` |
...
|   379649 | 1180 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|   379649 | 1181 | `		PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|   379649 | 1182 | `		pGen->pIn = pGen->pEnd;   /* land exactly on the delimiter */` |
|   379649 | 1183 | `		pGen->pEnd = pSavedDefEnd;` |
|   189822 | 1184 | `	}` |
|        - | 1185 | `	/* All done,install the attribute */` |
|   588737 | 1186 | `	rc = PH7_ClassInstallAttr(pClass,pAttr);` |
|   588737 | 1187 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 1188 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 1189 | `		return SXERR_ABORT;` |
|        - | 1190 | `	}` |
|   588737 | 1191 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) ){` |
...
|        - | 1203 | `	}` |
|   588643 | 1204 | `	if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
...
|        - | 1215 | `	}` |
|   588643 | 1216 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA /*','*/) ){` |
...
|        - | 1234 | `		}` |
|      ! 0 | 1235 | `	}` |
|   588639 | 1236 | `	SySetRelease(&aUnionAlts);` |
|   588639 | 1237 | `	return SXRET_OK;` |
|        9 | 1238 | `Synchronize:` |
...
|        - | 1253 | ` */` |
|  2885928 | 1254 | `static sxi32 GenStateCompileClassMethod(` |
...
|        - | 1260 | `	)` |
|        5 | 1261 | `{` |
|  2885933 | 1262 | `	sxu32 nLine = pGen->pIn->nLine;` |
|  2885933 | 1263 | `	sxu32 nKwLine = nLine; /* Line of the 'function' keyword (Reflection getStartLine) */` |
...
|  2885933 | 1270 | `	iProtection = GetProtectionLevel(iProtection);` |
|  2885933 | 1271 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|  2885933 | 1272 | `	iFuncFlags = 0;` |
|  2885933 | 1273 | `	if( pGen->pIn >= pGen->pEnd ){` |
...
|        - | 1281 | `	}` |
|  2885933 | 1282 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|        - | 1283 | `		/* Return by reference,remember that */` |
|      ! 0 | 1284 | `		iFuncFlags \|= VM_FUNC_REF_RETURN;` |
|        - | 1285 | `		/* Jump the '&' token */` |
|      ! 0 | 1286 | `		pGen->pIn++;` |
|      ! 0 | 1287 | `	}` |
|  2885933 | 1288 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|  2885933 | 1297 | `	pName = &pGen->pIn->sData;` |
|  2885933 | 1298 | `	nLine = pGen->pIn->nLine;` |
|        - | 1299 | `	/* Jump the method name */` |
|  2885933 | 1300 | `	pGen->pIn++;` |
|  2885933 | 1301 | `	if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|        - | 1302 | `		/* Abstract method */` |
|   139257 | 1303 | `		if( iProtection == PH7_CLASS_PROT_PRIVATE ){` |
...
|   139257 | 1312 | `		doBody = FALSE;` |
|    69626 | 1313 | `	}` |
|  2885933 | 1314 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|        - | 1315 | `		/* Syntax error */` |
...
|  2885933 | 1324 | `	pMeth = PH7_NewClassMethod(pGen->pVm,pClass,pName,nLine,iProtection,iFlags,iFuncFlags);` |
|  2885933 | 1325 | `	if( pMeth == 0 ){` |
|      ! 0 | 1326 | `		PH7_GenCompileError(&(*pGen),E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 1327 | `		return SXERR_ABORT;` |
|        - | 1328 | `	}` |
|  2885933 | 1329 | `	pMeth->sFunc.nLine = nKwLine;` |
|  2885933 | 1330 | `	GenStateConsumeDoc(&(*pGen),&pMeth->sFunc.sDoc);` |
|  2885933 | 1331 | `	if( GenStateConsumeAttrs(&(*pGen),&pMeth->sFunc.aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 1332 | `		return SXERR_ABORT;` |
|        - | 1333 | `	}` |
|        - | 1334 | `	/* Jump the left parenthesis '(' */` |
|  2885933 | 1335 | `	pGen->pIn++;` |
|  2885933 | 1336 | `	pEnd = 0; /* cc warning */` |
|        - | 1337 | `	/* Delimit the method signature */` |
|  2885933 | 1338 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|  2885933 | 1339 | `	if( pEnd >= pGen->pEnd ){` |
|        - | 1340 | `		/* Syntax error */` |
...
|        - | 1347 | `	}` |
|        - | 1348 | `	{` |
|  2885931 | 1349 | `		int bIsCtor = 0;` |
|  2885931 | 1350 | `		int bAbstractCtor = 0;` |
|  2885926 | 1351 | `		if( (pName->nByte == sizeof("__construct") - 1` |
|  1694424 | 1352 | `				&& SyMemcmp(pName->zString,"__construct",sizeof("__construct") - 1) == 0)` |
|  2783369 | 1353 | `		 \|\| SyStringCmp(pName,&pClass->sName,SyMemcmp) == 0 ){` |
|   205129 | 1354 | `			if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|        3 | 1355 | `				bAbstractCtor = 1;` |
|        2 | 1356 | `			}else{` |
|   205127 | 1357 | `				bIsCtor = 1;` |
|        - | 1358 | `			}` |
|   102562 | 1359 | `		}` |
|  2885931 | 1360 | `		if( pGen->pIn < pEnd ){` |
|        - | 1361 | `			/* Collect method arguments */` |
|  1110287 | 1362 | `			rc = GenStateCollectFuncArgs(&pMeth->sFunc,&(*pGen),pEnd,bIsCtor,bAbstractCtor);` |
|  1110287 | 1363 | `			if( rc == SXERR_ABORT ){` |
|      ! 0 | 1364 | `				return SXERR_ABORT;` |
|        - | 1365 | `			}` |
|   555141 | 1366 | `		}` |
|        - | 1367 | `	}` |
|        - | 1368 | `	/* Point past ')' and parse optional return type ': type' */` |
|  2885931 | 1369 | `	pGen->pIn = &pEnd[1];` |
|        - | 1370 | `	{` |
|  2885931 | 1371 | `		sxi32 rcRt = GenStateParseReturnType(pGen, &pMeth->sFunc);` |
|  2885931 | 1372 | `		if( rcRt == SXERR_ABORT ){` |
|      ! 0 | 1373 | `			return SXERR_ABORT;` |
|  2885931 | 1374 | `		}else if( rcRt == SXERR_SYNTAX ){` |
...
|        - | 1381 | `	{` |
|  2885931 | 1382 | `		sxu32 nArg = SySetUsed(&pMeth->sFunc.aArgs);` |
|        - | 1383 | `		sxu32 i;` |
|  4545379 | 1384 | `		for( i = 0; i < nArg; i++ ){` |
|  1659463 | 1385 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pMeth->sFunc.aArgs,i);` |
|        - | 1386 | `			ph7_class_attr *pAttr;` |
|  1659463 | 1387 | `			sxi32 iAttrFlags = 0;` |
|        - | 1388 | `			int bArgTyped;` |
|  1659463 | 1389 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|  1659377 | 1390 | `				continue;` |
|        - | 1391 | `			}` |
...
|       43 | 1486 | `		}` |
|        - | 1487 | `	}` |
|  2885921 | 1488 | `	if( doBody ){` |
|        - | 1489 | `		/* Compile method body */` |
|  2746669 | 1490 | `		rc = GenStateCompileFuncBody(&(*pGen),&pMeth->sFunc);` |
|  2746669 | 1491 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 | 1492 | `			return SXERR_ABORT;` |
|        - | 1493 | `		}` |
|        - | 1494 | `		/* The cursor sits just past the body's closing brace */` |
|  2746669 | 1495 | `		pMeth->sFunc.nEndLine = pGen->pIn[-1].nLine;` |
|  1373337 | 1496 | `	}else{` |
|        - | 1497 | `		/* Abstract/interface method: declaration ends at the ';' */` |
|   139257 | 1498 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI /* ';'*/) ){` |
|   139257 | 1499 | `			pMeth->sFunc.nEndLine = pGen->pIn->nLine;` |
|    69626 | 1500 | `		}` |
|        - | 1501 | `		/* Only method signature is allowed */` |
|   139257 | 1502 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI /* ';'*/) == 0 ){` |
...
|  2885916 | 1517 | `	if( (pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT)` |
|  1512589 | 1518 | `	 && (pClass->iFlags & (PH7_CLASS_ABSTRACT\|PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT)) == 0 ){` |
...
|  2885919 | 1531 | `	if( PH7_ClassExtractMethod(pClass,pName->zString,pName->nByte) != 0 ){` |
...
|  2885915 | 1540 | `	rc = PH7_ClassInstallMethod(pClass,pMeth);` |
|  2885915 | 1541 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 1542 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 1543 | `		return SXERR_ABORT;` |
|        - | 1544 | `	}` |
|  2885915 | 1545 | `	return SXRET_OK;` |
|        6 | 1546 | `Synchronize:` |
...
|        - | 2001 | ` */` |
|    69716 | 2002 | `PH7_PRIVATE sxi32 PH7_CompileClassInterface(ph7_gen_state *pGen)` |
|        5 | 2003 | `{` |
|    69721 | 2004 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|    69721 | 2013 | `	pName = &pGen->pIn->sData;` |
|        - | 2014 | `	/* Advance the stream cursor */` |
|    69721 | 2015 | `	pGen->pIn++;` |
|        - | 2016 | `	/* Build FQN and obtain a raw class */ {` |
|        - | 2017 | `		SyBlob sFQN;` |
|        - | 2018 | `		SyString sFQNStr;` |
|    69721 | 2019 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|    69721 | 2020 | `		GenStateBuildFQN(pGen,pName,&sFQN);` |
|    69721 | 2021 | `		SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|    69721 | 2022 | `		pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|    69721 | 2023 | `		SyBlobRelease(&sFQN);` |
|        - | 2024 | `	}` |
|    69721 | 2025 | `	if( pClass == 0 ){` |
|      ! 0 | 2026 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2027 | `		return SXERR_ABORT;` |
|        - | 2028 | `	}` |
|    69721 | 2029 | `	GenStateConsumeDoc(&(*pGen),&pClass->sDoc);` |
|    69721 | 2030 | `	if( GenStateConsumeAttrs(&(*pGen),&pClass->aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 2031 | `		return SXERR_ABORT;` |
|        - | 2032 | `	}` |
|        - | 2033 | `	/* Mark as an interface (PH7_NewRawClass may have set INTERNAL) */` |
|    69721 | 2034 | `	pClass->iFlags \|= PH7_CLASS_INTERFACE;` |
|        - | 2035 | `	/* Assume no base class is given */` |
|    69721 | 2036 | `	pBase = 0;` |
|    69721 | 2037 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|    27079 | 2038 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    27079 | 2039 | `		if( nKwrd == PH7_TKWRD_EXTENDS /* interface b extends a, c, … */ ){` |
...
|    27081 | 2050 | `				nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|    27081 | 2051 | `				SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|    27081 | 2052 | `				if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|        - | 2062 | `				}` |
|    40619 | 2063 | `				pParent = PH7_VmExtractClass(pGen->pVm,` |
|    27076 | 2064 | `					(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|    27081 | 2065 | `				SyStringInitFromBuf(&sBaseName,` |
|        - | 2066 | `					(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|        - | 2067 | `				/* Only interfaces is allowed */` |
|    27081 | 2068 | `				while( pParent && (pParent->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|      ! 0 | 2069 | `					pParent = pParent->pNextName;` |
|      ! 0 | 2070 | `				}` |
|    27081 | 2071 | `				if( pParent == 0 ){` |
...
|      ! 0 | 2077 | `					}` |
|    27081 | 2078 | `				}else if( pBase == 0 ){` |
|        - | 2079 | `					/* First parent → single-inheritance base */` |
|    27079 | 2080 | `					pBase = pParent;` |
|    13542 | 2081 | `				}else{` |
...
|        - | 2085 | `				}` |
|    27081 | 2086 | `				SyBlobRelease(&sResolved);` |
|        - | 2087 | `				/* Continue on a comma-separated list */` |
|    27081 | 2088 | `				if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA) ){` |
|        3 | 2089 | `					pGen->pIn++;` |
|        3 | 2090 | `					continue;` |
|        - | 2091 | `				}` |
|    27079 | 2092 | `				break;` |
...
|    13537 | 2094 | `		}` |
|    13537 | 2095 | `	}` |
|    69721 | 2096 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|        - | 2097 | `		/* Syntax error */` |
...
|        - | 2105 | `	}` |
|    69721 | 2106 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|    69721 | 2107 | `	pEnd = 0; /* cc warning */` |
|        - | 2108 | `	/* Delimit the interface body */` |
|    69721 | 2109 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|    69721 | 2110 | `	if( pEnd >= pGen->pEnd ){` |
|        - | 2111 | `		/* Syntax error */` |
...
|    69721 | 2121 | `	pClass->nEndLine = pEnd->nLine;` |
|        - | 2122 | `	/* Swap token stream */` |
|    69721 | 2123 | `	pTmp = pGen->pEnd;` |
|    69721 | 2124 | `	pGen->pEnd = pEnd;` |
...
|   440993 | 2132 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|   185639 | 2133 | `			pGen->pIn++;` |
|        5 | 2134 | `		}` |
|   255359 | 2135 | `		if( pGen->pIn >= pGen->pEnd ){` |
|        - | 2136 | `			/* End of interface body */` |
|    69717 | 2137 | `			break;` |
|        - | 2138 | `		}` |
|        - | 2139 | `		/* Bind a directly-preceding docblock to this member */` |
|   185647 | 2140 | `		GenStateSetPendingDoc(&(*pGen));` |
|   185647 | 2141 | `		if( (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|   185647 | 2152 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   185647 | 2153 | `		if( nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
...
|        3 | 2182 | `			goto done;` |
|        - | 2183 | `		}` |
|   185645 | 2184 | `		if( nKwrd != PH7_TKWRD_PUBLIC && nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|      ! 0 | 2191 | `			goto done;` |
|        - | 2192 | `		}` |
|   185645 | 2193 | `		if( nKwrd == PH7_TKWRD_PUBLIC ){` |
|        - | 2194 | `			/* Advance the stream cursor */` |
|   131503 | 2195 | `			pGen->pIn++;` |
|   131498 | 2196 | `			if( pGen->pIn < pGen->pEnd` |
|   131503 | 2197 | `			 && ((pGen->pIn->nType & PH7_TK_DOLLAR) != 0` |
|   131498 | 2198 | `			  \|\| (pGen->pIn->sData.nByte == 1 && pGen->pIn->sData.zString[0] == '?')) ){` |
...
|      ! 0 | 2212 | `				continue;` |
|        - | 2213 | `			}` |
|   131503 | 2214 | `			if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|      ! 0 | 2236 | `				goto done;` |
|        - | 2237 | `			}` |
|   131503 | 2238 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   131503 | 2239 | `			if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|        - | 2261 | `			}` |
|    65747 | 2262 | `		}` |
|   185641 | 2263 | `		if( nKwrd == PH7_TKWRD_CONST ){` |
|        - | 2264 | `			/* Parse constant */` |
|    54143 | 2265 | `			rc = GenStateCompileClassConstant(&(*pGen),0,0,pClass);` |
|    54143 | 2266 | `			if( rc != SXRET_OK ){` |
...
|        - | 2271 | `			}` |
|    27073 | 2272 | `		}else{` |
|   131503 | 2273 | `			sxi32 iFlags = PH7_CLASS_ATTR_ABSTRACT; /* Interface methods are implicitly abstract */` |
|   131503 | 2274 | `			if( nKwrd == PH7_TKWRD_STATIC ){` |
|        - | 2275 | `				/* Static method,record that */` |
|    11603 | 2276 | `				iFlags \|= PH7_CLASS_ATTR_STATIC;` |
|        - | 2277 | `				/* Advance the stream cursor */` |
|    11603 | 2278 | `				pGen->pIn++;` |
|    11598 | 2279 | `				if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0` |
|    11603 | 2280 | `					\|\| SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_FUNCTION ){` |
...
|   131503 | 2291 | `			rc = GenStateCompileClassMethod(&(*pGen),0,iFlags,FALSE,pClass);` |
|   131503 | 2292 | `			if( rc != SXRET_OK ){` |
...
|    69717 | 2301 | `	if( GenStateGuardClassRedeclaration(pGen,pClass) == SXERR_ABORT ){` |
|        3 | 2302 | `		return SXERR_ABORT;` |
|        - | 2303 | `	}` |
|        - | 2304 | `	/* Install the interface */` |
|    69715 | 2305 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|    69715 | 2306 | `	if( rc == SXRET_OK && pBase ){` |
|        - | 2307 | `		/* Inherit from the base interface */` |
|    27079 | 2308 | `		rc = PH7_ClassInterfaceInherit(pClass,pBase);` |
|    13537 | 2309 | `	}` |
|    69715 | 2310 | `	if( rc != SXRET_OK ){` |
...
|    69719 | 2316 | `	pGen->pIn  = &pEnd[1];` |
|    69719 | 2317 | `	pGen->pEnd = pTmp;` |
|    69719 | 2318 | `	return PH7_OK;` |
|    34863 | 2319 | `}` |
|        - | 2320 | `/*` |
...
|        - | 2344 | ` */` |
|   450414 | 2345 | `static sxi32 GenStateCheckInterfaceSignatures(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 | 2346 | `{` |
|        - | 2347 | `	ph7_class **apIface;` |
|        - | 2348 | `	sxu32 nIface,i;` |
|        - | 2349 | `	sxi32 rc;` |
|   450419 | 2350 | `	if( pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|      ! 0 | 2351 | `		return SXRET_OK;` |
|        - | 2352 | `	}` |
|   450419 | 2353 | `	apIface = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|   450419 | 2354 | `	nIface = SySetUsed(&pClass->aInterface);` |
|   872171 | 2355 | `	for(i = 0; i < nIface; i++){` |
|   421757 | 2356 | `		ph7_class *pIface = apIface[i];` |
|        - | 2357 | `		SyHashEntry *pEntry;` |
|   421757 | 2358 | `		SyHashResetLoopCursor(&pIface->hMethod);` |
|  1241957 | 2359 | `		while((pEntry = SyHashGetNextEntry(&pIface->hMethod)) != 0 ){` |
|   820205 | 2360 | `			ph7_class_method *pIfaceMeth = (ph7_class_method *)pEntry->pUserData;` |
|        - | 2361 | `			ph7_class_method *pImplMeth;` |
|   820205 | 2362 | `			SyString *pMName = &pIfaceMeth->sFunc.sName;` |
|        - | 2363 | `			/* Find the implementing method in the class */` |
|   820205 | 2364 | `			pImplMeth = PH7_ClassExtractMethod(pClass,pMName->zString,pMName->nByte);` |
|   820205 | 2365 | `			if( pImplMeth == 0 \|\| (pImplMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT) ){` |
...
|   820187 | 2369 | `			if( pImplMeth->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|        - | 2379 | `			 */` |
|        - | 2380 | `			{` |
|   820187 | 2381 | `				sxu32 nIfaceArgs = SySetUsed(&pIfaceMeth->sFunc.aArgs);` |
|   820187 | 2382 | `				sxu32 nImplArgs = SySetUsed(&pImplMeth->sFunc.aArgs);` |
|   820187 | 2383 | `				int sigError = 0;` |
|   820187 | 2384 | `				if( nImplArgs < nIfaceArgs ){` |
|        3 | 2385 | `					sigError = 1;` |
|   820186 | 2386 | `				}else if( nImplArgs > nIfaceArgs ){` |
|        - | 2387 | `					/* Extra parameters must all have default values */` |
|     3875 | 2388 | `					ph7_vm_func_arg *aImplArgs = (ph7_vm_func_arg *)SySetBasePtr(&pImplMeth->sFunc.aArgs);` |
|        - | 2389 | `					sxu32 k;` |
|     7743 | 2390 | `					for(k = nIfaceArgs; k < nImplArgs; k++){` |
|     3875 | 2391 | `						if( SySetUsed(&aImplArgs[k].aByteCode) == 0 ){` |
|        3 | 2392 | `							sigError = 1;` |
|        3 | 2393 | `							break;` |
|        - | 2394 | `						}` |
|     1939 | 2395 | `					}` |
|     1935 | 2396 | `				}` |
|   820187 | 2397 | `				if( sigError ){` |
...
|        - | 2477 | ` */` |
|   450414 | 2478 | `static sxi32 GenStateCheckAbstractMethods(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 | 2479 | `{` |
...
|   450419 | 2486 | `	if( pClass->iFlags & (PH7_CLASS_ABSTRACT\|PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|    19387 | 2487 | `		return SXRET_OK;` |
|        - | 2488 | `	}` |
|        - | 2489 | `	/* Count abstract methods */` |
|   431037 | 2490 | `	nAbstract = 0;` |
|   431037 | 2491 | `	SyHashResetLoopCursor(&pClass->hMethod);` |
|  6440659 | 2492 | `	while((pEntry = SyHashGetNextEntry(&pClass->hMethod)) != 0 ){` |
|  5794111 | 2493 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|  5794111 | 2494 | `		if( pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
...
|        8 | 2499 | `		}` |
|        5 | 2500 | `	}` |
|   431037 | 2501 | `	if( nAbstract == 0 ){` |
|   431023 | 2502 | `		return SXRET_OK;` |
|        - | 2503 | `	}` |
...
|        - | 2640 | ` */` |
|   512686 | 2641 | `PH7_PRIVATE sxi32 GenStateParseClassReference(ph7_gen_state *pGen,SyBlob *pFqn)` |
|        5 | 2642 | `{` |
|   512691 | 2643 | `	int isAbsolute = 0;` |
|   512691 | 2644 | `	SyToken *pStart = pGen->pIn;` |
|        - | 2645 | `	SyBlob sName;` |
|   512691 | 2646 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) ){` |
|     4525 | 2647 | `		isAbsolute = 1;` |
|     4525 | 2648 | `		pGen->pIn++;` |
|     2260 | 2649 | `	}` |
|   512691 | 2650 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|        9 | 2651 | `		pGen->pIn = pStart;` |
|        9 | 2652 | `		return SXERR_INVALID;` |
|        - | 2653 | `	}` |
|   512685 | 2654 | `	SyBlobInit(&sName,&pGen->pVm->sAllocator);` |
|   512685 | 2655 | `	SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|   512685 | 2656 | `	pGen->pIn++;` |
|   769059 | 2657 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) &&` |
|   256384 | 2658 | `		&pGen->pIn[1] < pGen->pEnd && (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|       28 | 2659 | `		SyBlobAppend(&sName,"\\",1);` |
|       28 | 2660 | `		pGen->pIn++;` |
|       28 | 2661 | `		SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|       28 | 2662 | `		pGen->pIn++;` |
|        2 | 2663 | `	}` |
|   512685 | 2664 | `	if( isAbsolute ){` |
|     4523 | 2665 | `		SyBlobAppend(pFqn,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|     2264 | 2666 | `	}else{` |
|        - | 2667 | `		SyString sRaw;` |
|   508167 | 2668 | `		SyStringInitFromBuf(&sRaw,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|   508167 | 2669 | `		GenStateResolveName(pGen,&sRaw,pFqn);` |
|        - | 2670 | `	}` |
|   512685 | 2671 | `	SyBlobRelease(&sName);` |
|   512685 | 2672 | `	return SXRET_OK;` |
|   256348 | 2673 | `}` |
|        - | 2674 | `/*` |
...
|   197380 | 2682 | `static int GenStateInterfaceIsThrowableAt(ph7_class *pInterface,int iDepth)` |
|        5 | 2683 | `{` |
|        - | 2684 | `	ph7_class **apParent;` |
|        - | 2685 | `	sxu32 n;` |
|   522383 | 2686 | `	while( pInterface ){` |
|   332745 | 2687 | `		if( iDepth > PH7_THROWABLE_WALK_MAX_DEPTH ){` |
|      ! 0 | 2688 | `			return FALSE;` |
|        - | 2689 | `		}` |
|   371425 | 2690 | `		if( pInterface->sName.nByte == sizeof("Throwable")-1 &&` |
|    77360 | 2691 | `			SyMemcmp(pInterface->sName.zString,"Throwable",sizeof("Throwable")-1) == 0 ){` |
|     7747 | 2692 | `			return TRUE;` |
|        - | 2693 | `		}` |
|   325003 | 2694 | `		apParent = (ph7_class **)SySetBasePtr(&pInterface->aInterface);` |
|   325005 | 2695 | `		for( n = 0 ; n < SySetUsed(&pInterface->aInterface) ; ++n ){` |
|        3 | 2696 | `			if( GenStateInterfaceIsThrowableAt(apParent[n],iDepth+1) ){` |
|      ! 0 | 2697 | `				return TRUE;` |
|        - | 2698 | `			}` |
|        2 | 2699 | `		}` |
|   325003 | 2700 | `		pInterface = pInterface->pBase;` |
|   325003 | 2701 | `		iDepth++;` |
|        5 | 2702 | `	}` |
|   189643 | 2703 | `	return FALSE;` |
|    98695 | 2704 | `}` |
|   197378 | 2705 | `static int GenStateInterfaceIsThrowable(ph7_class *pInterface)` |
|        5 | 2706 | `{` |
|   197383 | 2707 | `	return GenStateInterfaceIsThrowableAt(pInterface,0);` |
|        5 | 2708 | `}` |
|        - | 2709 | `/*` |
...
|        - | 2713 | ` */` |
|     7742 | 2714 | `static int GenStateClassIsExceptionOrError(ph7_class *pBase)` |
|        5 | 2715 | `{` |
|     7751 | 2716 | `	while( pBase ){` |
...
|        - | 2737 | ` */` |
|     7786 | 2738 | `static sxi32 GenStateCompileEnumCase(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 | 2739 | `{` |
|     7791 | 2740 | `	sxu32 nLine = pGen->pIn->nLine;` |
|        - | 2741 | `	SySet *pInstrContainer;` |
|        - | 2742 | `	ph7_class_attr *pCase;` |
|        - | 2743 | `	SyString *pName;` |
|        - | 2744 | `	sxi32 rc;` |
|     7791 | 2745 | `	pGen->pIn++; /* Jump the 'case' keyword */` |
|     7791 | 2746 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|        - | 2753 | `	}` |
|     7791 | 2754 | `	pName = &pGen->pIn->sData;` |
|        - | 2755 | `	/* Cases share the class-constant namespace (php: "Cannot redefine class constant") */` |
|     7791 | 2756 | `	if( SyHashGet(&pClass->hAttr,(const void *)pName->zString,pName->nByte) != 0 ){` |
...
|        - | 2763 | `	}` |
|     7791 | 2764 | `	pCase = PH7_NewClassAttr(pGen->pVm,pName,pGen->pIn->nLine,PH7_CLASS_PROT_PUBLIC,` |
|        - | 2765 | `		PH7_CLASS_ATTR_CONSTANT\|PH7_CLASS_ATTR_ENUMCASE);` |
|     7791 | 2766 | `	if( pCase == 0 ){` |
|      ! 0 | 2767 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2768 | `		return SXERR_ABORT;` |
|        - | 2769 | `	}` |
|     7791 | 2770 | `	GenStateConsumeDoc(&(*pGen),&pCase->sDoc);` |
|     7791 | 2771 | `	if( GenStateConsumeAttrs(&(*pGen),&pCase->aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 2772 | `		return SXERR_ABORT;` |
|        - | 2773 | `	}` |
|     7791 | 2774 | `	pGen->pIn++; /* Jump the case name */` |
|     7791 | 2775 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_EQUAL /* '=' */) ){` |
|     7777 | 2776 | `		if( pClass->nEnumBacking == 0 ){` |
...
|        - | 2783 | `		}` |
|     7773 | 2784 | `		pGen->pIn++; /* Jump the equal sign */` |
|        - | 2785 | `		/* Compile the backing value expression into the case's own container` |
|        - | 2786 | `		 * (same technique as class constants). */` |
|     7773 | 2787 | `		pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|     7773 | 2788 | `		PH7_VmSetByteCodeContainer(pGen->pVm,&pCase->aByteCode);` |
|     7773 | 2789 | `		rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|     7773 | 2790 | `		if( rc == SXERR_EMPTY ){` |
|      ! 0 | 2791 | `			rc = PH7_GenCompileError(pGen,E_ERROR,nLine,` |
|      ! 0 | 2792 | `				"Empty value for enum case %z::%z",&pClass->sName,pName);` |
|      ! 0 | 2793 | `		}` |
|     7773 | 2794 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|     7773 | 2795 | `		PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|     7773 | 2796 | `		if( rc == SXERR_ABORT ){` |
...
|        - | 2807 | `		}` |
|        - | 2808 | `	}` |
|     7787 | 2809 | `	rc = PH7_ClassInstallAttr(pClass,pCase);` |
|     7787 | 2810 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 2811 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2812 | `		return SXERR_ABORT;` |
|        - | 2813 | `	}` |
|     7787 | 2814 | `	SySetPut(&pClass->aEnumCases,(const void *)&pCase);` |
|     7787 | 2815 | `	return SXRET_OK;` |
|        2 | 2816 | `Synchronize:` |
...
|        - | 2831 | ` */` |
|     3900 | 2832 | `static sxi32 GenStateCompileEnumMethods(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 | 2833 | `{` |
...
|     3905 | 2839 | `	sxi32 rc = SXRET_OK;` |
|     3905 | 2840 | `	nMax = 3*(sxu32)sizeof("function tryFrom(string $value){return __phl_enum_tryfrom('',$value);}")` |
|     3900 | 2841 | `		+ 3*SyStringLength(&pClass->sName) + 64;` |
|     3905 | 2842 | `	zSrc = (char *)SyMemBackendAlloc(&pGen->pVm->sAllocator,nMax);` |
|     3905 | 2843 | `	if( zSrc == 0 ){` |
|      ! 0 | 2844 | `		PH7_GenCompileError(pGen,E_ERROR,pClass->nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2845 | `		return SXERR_ABORT;` |
|        - | 2846 | `	}` |
|     3905 | 2847 | `	zBack = (pClass->nEnumBacking == MEMOBJ_INT) ? "int" : "string";` |
|     3905 | 2848 | `	if( pClass->nEnumBacking != 0 ){` |
|     5825 | 2849 | `		nSrc = SyBufferFormat(zSrc,nMax,` |
...
|     1940 | 2853 | `			&pClass->sName,zBack,&pClass->sName,zBack,&pClass->sName);` |
|     1945 | 2854 | `	}else{` |
|       34 | 2855 | `		nSrc = SyBufferFormat(zSrc,nMax,` |
|       10 | 2856 | `			"function cases(){return __phl_enum_cases('%z');}",&pClass->sName);` |
|        - | 2857 | `	}` |
|     3905 | 2858 | `	SySetInit(&sToken,&pGen->pVm->sAllocator,sizeof(SyToken));` |
|     3905 | 2859 | `	PH7_TokenizePHP(zSrc,nSrc,pClass->nLine,&sToken,0);` |
|     3905 | 2860 | `	pSaveIn = pGen->pIn;` |
|     3905 | 2861 | `	pSaveEnd = pGen->pEnd;` |
|     3905 | 2862 | `	pGen->pIn = (SyToken *)SySetBasePtr(&sToken);` |
|     3905 | 2863 | `	pGen->pEnd = &pGen->pIn[SySetUsed(&sToken)];` |
|    15565 | 2864 | `	while( pGen->pIn < pGen->pEnd && rc != SXERR_ABORT ){` |
|    11665 | 2865 | `		rc = GenStateCompileClassMethod(&(*pGen),PH7_TKWRD_PUBLIC,PH7_CLASS_ATTR_STATIC,TRUE,pClass);` |
|        5 | 2866 | `	}` |
|     3905 | 2867 | `	pGen->pIn = pSaveIn;` |
|     3905 | 2868 | `	pGen->pEnd = pSaveEnd;` |
|     3905 | 2869 | `	SySetRelease(&sToken);` |
|     3905 | 2870 | `	return (rc == SXERR_ABORT) ? SXERR_ABORT : SXRET_OK;` |
|     1955 | 2871 | `}` |
|        - | 2872 | `/*` |
...
|        - | 2886 | ` */` |
|     3900 | 2887 | `static sxi32 GenStateEnumFinalize(ph7_gen_state *pGen,ph7_class *pClass,sxu32 nLine)` |
|        5 | 2888 | `{` |
|        - | 2889 | `	SyHashEntry *pEntry;` |
|        - | 2890 | `	sxi32 rc;` |
|        - | 2891 | `	sxu32 n;` |
|        - | 2892 | `	/* php: "Enum %s cannot include properties" */` |
|     3905 | 2893 | `	SyHashResetLoopCursor(&pClass->hAttr);` |
|    11693 | 2894 | `	while( (pEntry = SyHashGetNextEntry(&pClass->hAttr)) != 0 ){` |
|     7795 | 2895 | `		ph7_class_attr *pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|     7795 | 2896 | `		if( (pAttr->iFlags & PH7_CLASS_ATTR_CONSTANT) == 0 ){` |
...
|    54605 | 2906 | `	for( n = 0 ; n < SX_ARRAYSIZE(azEnumBannedMagic) ; n++ ){` |
|    76050 | 2907 | `		if( SyHashGet(&pClass->hMethod,(const void *)azEnumBannedMagic[n],` |
|    50705 | 2908 | `			SyStrlen(azEnumBannedMagic[n])) != 0 ){` |
...
|     3905 | 2924 | `		pAttr = PH7_NewClassAttr(pGen->pVm,&sNameProp,nLine,PH7_CLASS_PROT_PUBLIC,` |
|        - | 2925 | `			PH7_CLASS_ATTR_READONLY\|PH7_CLASS_ATTR_TYPED);` |
|     3905 | 2926 | `		if( pAttr == 0 ){` |
|      ! 0 | 2927 | `			PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2928 | `			return SXERR_ABORT;` |
|        - | 2929 | `		}` |
|     3905 | 2930 | `		pAttr->nType = MEMOBJ_STRING;` |
|     3905 | 2931 | `		SyStringInitFromBuf(&pAttr->sTypeName,"string",sizeof("string")-1);` |
|     3905 | 2932 | `		PH7_ClassInstallAttr(pClass,pAttr);` |
|     3905 | 2933 | `		if( pClass->nEnumBacking != 0 ){` |
|     3885 | 2934 | `			pAttr = PH7_NewClassAttr(pGen->pVm,&sValueProp,nLine,PH7_CLASS_PROT_PUBLIC,` |
|        - | 2935 | `				PH7_CLASS_ATTR_READONLY\|PH7_CLASS_ATTR_TYPED);` |
|     3885 | 2936 | `			if( pAttr == 0 ){` |
|      ! 0 | 2937 | `				PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2938 | `				return SXERR_ABORT;` |
|        - | 2939 | `			}` |
|     3885 | 2940 | `			pAttr->nType = pClass->nEnumBacking;` |
|     3885 | 2941 | `			if( pClass->nEnumBacking == MEMOBJ_INT ){` |
|        7 | 2942 | `				SyStringInitFromBuf(&pAttr->sTypeName,"int",sizeof("int")-1);` |
|        4 | 2943 | `			}else{` |
|     3879 | 2944 | `				SyStringInitFromBuf(&pAttr->sTypeName,"string",sizeof("string")-1);` |
|        - | 2945 | `			}` |
|     3885 | 2946 | `			PH7_ClassInstallAttr(pClass,pAttr);` |
|     1940 | 2947 | `		}` |
|        - | 2948 | `	}` |
|     3905 | 2949 | `	return GenStateCompileEnumMethods(&(*pGen),pClass);` |
|     1955 | 2950 | `}` |
|        - | 2951 | `/*` |
...
|        - | 2960 | ` */` |
|   450464 | 2961 | `static sxi32 GenStateCompileClassEx(ph7_gen_state *pGen,sxi32 iFlags,` |
|        - | 2962 | `	SyString *pAnonName,SyToken **ppArgStart,SyToken **ppArgEnd)` |
|        5 | 2963 | `{` |
|   450469 | 2964 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|   450469 | 2975 | `	pGen->pIn++;` |
|   450469 | 2976 | `	if( pAnonName ){` |
...
|       19 | 2991 | `	}else{` |
|   450439 | 2992 | `		if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
|        - | 2993 | `			/* Syntax error */` |
...
|   450439 | 3006 | `		pName = &pGen->pIn->sData;` |
|        - | 3007 | `		/* Advance the stream cursor */` |
|   450439 | 3008 | `		pGen->pIn++;` |
|        - | 3009 | `		/* Build FQN and obtain a raw class */ {` |
|        - | 3010 | `			SyBlob sFQN;` |
|        - | 3011 | `			SyString sFQNStr;` |
|   450439 | 3012 | `			SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|   450439 | 3013 | `			GenStateBuildFQN(pGen,pName,&sFQN);` |
|   450439 | 3014 | `			SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|   450439 | 3015 | `			pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|   450439 | 3016 | `			SyBlobRelease(&sFQN);` |
|        - | 3017 | `		}` |
|        - | 3018 | `	}` |
|   450469 | 3019 | `	if( pClass == 0 ){` |
|      ! 0 | 3020 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 3021 | `		return SXERR_ABORT;` |
|        - | 3022 | `	}` |
|   450464 | 3023 | `	if( (iFlags & PH7_CLASS_ENUM) && pGen->pIn < pGen->pEnd` |
|     3909 | 3024 | `		&& (pGen->pIn->nType & PH7_TK_COLON /* ':' */) ){` |
|        - | 3025 | ``		/* Backed enum: `enum Name: int\|string` (PHP 8.1) */`` |
|     3887 | 3026 | `		pGen->pIn++; /* Jump ':' */` |
|     3882 | 3027 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD)` |
|     3887 | 3028 | `			&& SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_INT ){` |
|        7 | 3029 | `			pClass->nEnumBacking = MEMOBJ_INT;` |
|        7 | 3030 | `			pGen->pIn++;` |
|     3880 | 3031 | `		}else if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD)` |
|     3881 | 3032 | `			&& SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_STRING ){` |
|     3879 | 3033 | `			pClass->nEnumBacking = MEMOBJ_STRING;` |
|     3879 | 3034 | `			pGen->pIn++;` |
|     1942 | 3035 | `		}else{` |
...
|        - | 3046 | `		}` |
|     1941 | 3047 | `	}` |
|   450469 | 3048 | `	GenStateConsumeDoc(&(*pGen),&pClass->sDoc);` |
|   450469 | 3049 | `	if( GenStateConsumeAttrs(&(*pGen),&pClass->aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 3050 | `		return SXERR_ABORT;` |
|        - | 3051 | `	}` |
|        - | 3052 | `	/* implemented interfaces and per-use-statement trait containers */` |
|   450469 | 3053 | `	SySetInit(&aInterfaces,&pGen->pVm->sAllocator,sizeof(ph7_class *));` |
|   450469 | 3054 | `	SySetInit(&aUseEntries,&pGen->pVm->sAllocator,sizeof(TraitUseEntry));` |
|        - | 3055 | `	/* Assume a standalone class */` |
|   450469 | 3056 | `	pBase = 0;` |
|   450469 | 3057 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|   367773 | 3058 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   367773 | 3059 | `		if( nKwrd == PH7_TKWRD_EXTENDS /* class b extends a */ ){` |
|        - | 3060 | `			SyBlob sResolved;` |
|        - | 3061 | `			SyString sBaseName;` |
|        - | 3062 | `			sxu32 nRefLine;` |
|   247745 | 3063 | `			if( iFlags & PH7_CLASS_ENUM ){` |
...
|        - | 3069 | `				}` |
|      ! 0 | 3070 | `			}` |
|   247745 | 3071 | `			pGen->pIn++; /* Advance past 'extends' */` |
|   247745 | 3072 | `			nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|   247745 | 3073 | `			SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|   247745 | 3074 | `			if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|        - | 3084 | `			}` |
|   371612 | 3085 | `			pBase = PH7_VmExtractClass(pGen->pVm,` |
|   247738 | 3086 | `				(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|   247743 | 3087 | `			SyStringInitFromBuf(&sBaseName,` |
|        - | 3088 | `				(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|        - | 3089 | `			/* Interfaces are not allowed */` |
|   247743 | 3090 | `			while( pBase && (pBase->iFlags & PH7_CLASS_INTERFACE) ){` |
|      ! 0 | 3091 | `				pBase = pBase->pNextName;` |
|      ! 0 | 3092 | `			}` |
|   247743 | 3093 | `			if( pBase == 0 ){` |
...
|        - | 3099 | `				}` |
|      ! 0 | 3100 | `			}else{` |
|   247743 | 3101 | `				if( pBase->iFlags & PH7_CLASS_ENUM ){` |
...
|   247742 | 3109 | `				}else if( pBase->iFlags & PH7_CLASS_FINAL ){` |
...
|      ! 0 | 3116 | `				}` |
|        - | 3117 | `			}` |
|   247743 | 3118 | `			SyBlobRelease(&sResolved);` |
|   247743 | 3119 | `			if( iFlags & PH7_CLASS_ENUM ){` |
|      ! 0 | 3120 | `				pBase = 0; /* Error already reported: enums have no base class */` |
|      ! 0 | 3121 | `			}` |
|   123869 | 3122 | `		}` |
|   367771 | 3123 | `		if (pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) && SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_IMPLEMENTS ){` |
|        - | 3124 | `			ph7_class *pInterface;` |
|        - | 3125 | `			/* Interface implementation */` |
|   135513 | 3126 | `			pGen->pIn++; /* Advance the stream cursor */` |
|   129624 | 3127 | `			for(;;){` |
|        - | 3128 | `				SyBlob sResolved;` |
|        - | 3129 | `				SyString sIntName;` |
|        - | 3130 | `				sxu32 nRefLine;` |
|   197383 | 3131 | `				nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|   197383 | 3132 | `				SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|   197383 | 3133 | `				if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|      ! 0 | 3141 | `					break;` |
|        - | 3142 | `				}` |
|   394761 | 3143 | `				pInterface = PH7_VmExtractClass(pGen->pVm,` |
|   197378 | 3144 | `					(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|   197383 | 3145 | `				SyStringInitFromBuf(&sIntName,` |
|        - | 3146 | `					(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|        - | 3147 | `				/* Only interfaces are allowed */` |
|   197383 | 3148 | `				while( pInterface && (pInterface->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|      ! 0 | 3149 | `					pInterface = pInterface->pNextName;` |
|      ! 0 | 3150 | `				}` |
|   197383 | 3151 | `				if( pInterface == 0 ){` |
...
|   197383 | 3165 | `					SyString *pFqn = &pClass->sName;` |
|   197383 | 3166 | `					int bIsExceptionOrError =` |
|   102559 | 3167 | `						(pFqn->nByte == sizeof("Exception")-1 &&` |
|   298004 | 3168 | `						 SyMemcmp(pFqn->zString,"Exception",sizeof("Exception")-1) == 0) \|\|` |
|   195452 | 3169 | `						(pFqn->nByte == sizeof("Error")-1 &&` |
|     3880 | 3170 | `						 SyMemcmp(pFqn->zString,"Error",sizeof("Error")-1) == 0);` |
|   201249 | 3171 | `					if( GenStateInterfaceIsThrowable(pInterface) &&` |
|    11616 | 3172 | `						!GenStateClassIsExceptionOrError(pBase) &&` |
|     3869 | 3173 | `						!bIsExceptionOrError ){` |
...
|        6 | 3183 | `					}else{` |
|   197377 | 3184 | `						SySetPut(&aInterfaces,(const void *)&pInterface);` |
|        - | 3185 | `					}` |
|        - | 3186 | `				}` |
|   197383 | 3187 | `				SyBlobRelease(&sResolved);` |
|   197383 | 3188 | `				if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COMMA) == 0 ){` |
|    67759 | 3189 | `					break;` |
|        - | 3190 | `				}` |
|    61875 | 3191 | `				pGen->pIn++;/* Jump the comma */` |
|        5 | 3192 | `			}` |
|    67754 | 3193 | `		}` |
|   183883 | 3194 | `	}` |
|   450467 | 3195 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|        - | 3196 | `		/* Syntax error */` |
...
|        - | 3204 | `	}` |
|   450467 | 3205 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|   450467 | 3206 | `	pEnd = 0; /* cc warning */` |
|        - | 3207 | `	/* Delimit the class body */` |
|   450467 | 3208 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|   450467 | 3209 | `	if( pEnd >= pGen->pEnd ){` |
|        - | 3210 | `		/* Syntax error */` |
...
|   450467 | 3220 | `	pClass->nEndLine = pEnd->nLine;` |
|        - | 3221 | `	/* Swap token stream */` |
|   450467 | 3222 | `	pTmp = pGen->pEnd;` |
|   450467 | 3223 | `	pGen->pEnd = pEnd;` |
|        - | 3224 | `	/* Merge the inherited flags (PH7_NewRawClass may have set INTERNAL) */` |
|   450467 | 3225 | `	pClass->iFlags \|= iFlags;` |
|        - | 3226 | `	/* Start the parse process */` |
|  1687500 | 3227 | `	for(;;){` |
|        - | 3228 | `		/* Jump leading/trailing semi-colons */` |
|  4846609 | 3229 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|   882763 | 3230 | `			pGen->pIn++;` |
|        5 | 3231 | `		}` |
|  3963851 | 3232 | `		if( pGen->pIn >= pGen->pEnd ){` |
|        - | 3233 | `			/* End of class body */` |
|   450425 | 3234 | `			break;` |
|        - | 3235 | `		}` |
|        - | 3236 | `		/* Bind a directly-preceding docblock to this member */` |
|  3513431 | 3237 | `		GenStateSetPendingDoc(&(*pGen));` |
|  3513426 | 3238 | `		if( (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR)) == 0` |
|  1756718 | 3239 | ``			&& !GenStateIsReadonly(pGen->pIn) /* allow a leading `readonly` modifier */ ){`` |
...
|  3513431 | 3250 | `		iProtection = PH7_TKWRD_PUBLIC;` |
|  3513431 | 3251 | `		iAttrflags = 0;` |
...
|  3513431 | 3256 | `		if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|      ! 0 | 3257 | `			int bMod = 0;` |
...
|        - | 3278 | `			}` |
|      ! 0 | 3279 | `		}` |
|  3513431 | 3280 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|        - | 3281 | `			/* Extract the current keyword */` |
|  3513431 | 3282 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  3513431 | 3283 | `			if( nKwrd == PH7_TKWRD_CASE && (pClass->iFlags & PH7_CLASS_ENUM) ){` |
|        - | 3284 | ``				/* Enum case declaration: `case NAME [= value];` */`` |
|     7791 | 3285 | `				rc = GenStateCompileEnumCase(&(*pGen),pClass);` |
|     7791 | 3286 | `				if( rc != SXRET_OK ){` |
...
|     7787 | 3292 | `				continue;` |
|        - | 3293 | `			}` |
|  3505645 | 3294 | `			if( nKwrd == PH7_TKWRD_USE ){` |
|        - | 3295 | `				/* Trait use: use TraitA, TraitB [{ ... }]; */` |
|        - | 3296 | `				TraitUseEntry sUse;` |
|    15559 | 3297 | `				SySetInit(&sUse.aTraits,&pGen->pVm->sAllocator,sizeof(ph7_class *));` |
|    15559 | 3298 | `				sUse.pResolvStart = sUse.pResolvEnd = 0;` |
|    15559 | 3299 | `				pGen->pIn++; /* Jump the 'use' keyword */` |
|     7785 | 3300 | `				for(;;){` |
|        - | 3301 | `					ph7_class *pTrait;` |
|        - | 3302 | `					SyBlob sResolved;` |
|        - | 3303 | `					SyString sTraitName;` |
|    15567 | 3304 | `					sxu32 nUseLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
...
|    15567 | 3311 | `					SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|    15567 | 3312 | `					if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|      ! 0 | 3319 | `						break;` |
|        - | 3320 | `					}` |
|    31129 | 3321 | `					pTrait = PH7_VmExtractClass(pGen->pVm,` |
|    15562 | 3322 | `						(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|    15567 | 3323 | `					SyStringInitFromBuf(&sTraitName,` |
|        - | 3324 | `						(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|        - | 3325 | `					/* Only traits are allowed */` |
|    15567 | 3326 | `					while( pTrait && (pTrait->iFlags & PH7_CLASS_TRAIT) == 0 ){` |
|      ! 0 | 3327 | `						pTrait = pTrait->pNextName;` |
|      ! 0 | 3328 | `					}` |
|    15567 | 3329 | `					if( pTrait == 0 ){` |
...
|        - | 3335 | `						}` |
|      ! 0 | 3336 | `					}else{` |
|    15567 | 3337 | `						SySetPut(&sUse.aTraits,(const void *)&pTrait);` |
|        - | 3338 | `					}` |
|    15567 | 3339 | `					SyBlobRelease(&sResolved);` |
...
|    15567 | 3342 | `					if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COMMA) == 0 ){` |
|     7782 | 3343 | `						break;` |
|        - | 3344 | `					}` |
|       10 | 3345 | `					pGen->pIn++; /* Jump the comma */` |
|        2 | 3346 | `				}` |
|        - | 3347 | `				/* Expect semicolon or opening brace (for conflict resolution) */` |
|    15559 | 3348 | `				if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OCB) ){` |
|        - | 3349 | `					SyToken *pBlock;` |
...
|        - | 3358 | `					}` |
|        5 | 3359 | `				}` |
|    15559 | 3360 | `				SySetPut(&aUseEntries,(const void *)&sUse);` |
|        - | 3361 | `				/* The semicolon will be consumed by the outer loop */` |
|    15559 | 3362 | `				continue;` |
|        - | 3363 | `			}` |
|  3490091 | 3364 | `			if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|        - | 3365 | `				int nSetTok;` |
|  2948311 | 3366 | `				sxi32 nSetVis = GenStatePeekSetVisibility(pGen->pIn,pGen->pEnd,&nSetTok);` |
|  2948311 | 3367 | `				if( nSetVis ){` |
...
|        2 | 3372 | `				}else{` |
|  2948309 | 3373 | `					iProtection = nKwrd;` |
|  2948309 | 3374 | `					pGen->pIn++; /* Jump the visibility token */` |
|        - | 3375 | `					/* Optional asymmetric set-visibility after the read` |
|        - | 3376 | ``					 * visibility: `public private(set) int $x`. */`` |
|  2948309 | 3377 | `					nSetVis = GenStatePeekSetVisibility(pGen->pIn,pGen->pEnd,&nSetTok);` |
|  2948309 | 3378 | `					if( nSetVis ){` |
...
|  2948311 | 3385 | `				if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|       28 | 3386 | `					iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|       28 | 3387 | `					pGen->pIn++; /* Jump the 'readonly' modifier */` |
|       12 | 3388 | `				}` |
|  2948306 | 3389 | `				if( pGen->pIn >= pGen->pEnd` |
|  2948311 | 3390 | `					\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|      ! 0 | 3398 | `					goto done;` |
|        - | 3399 | `				}` |
|  2948311 | 3400 | `				if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|        - | 3401 | `					/* Attribute declaration (untyped) */` |
|   522603 | 3402 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|   522603 | 3403 | `					if( rc != SXRET_OK ){` |
|       11 | 3404 | `						if( rc == SXERR_ABORT ){` |
|      ! 0 | 3405 | `							return SXERR_ABORT;` |
|        - | 3406 | `						}` |
|       11 | 3407 | `						goto done;` |
|        - | 3408 | `					}` |
|   530490 | 3409 | `					continue;` |
|        - | 3410 | `				}` |
|  2425713 | 3411 | `				if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
|        - | 3412 | `					/* Typed attribute declaration (PHP 7.4+) */` |
|    15801 | 3413 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|    15801 | 3414 | `					if( rc != SXRET_OK ){` |
...
|  2409917 | 3423 | `				nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  1204956 | 3424 | `			}` |
|  2951697 | 3425 | `			if( nKwrd == PH7_TKWRD_CONST ){` |
|        - | 3426 | `				/* Process constant declaration */` |
|   286271 | 3427 | `				rc = GenStateCompileClassConstant(&(*pGen),iProtection,iAttrflags,pClass);` |
|   286271 | 3428 | `				if( rc != SXRET_OK ){` |
...
|        - | 3433 | `				}` |
|   143134 | 3434 | `			}else{` |
|  2665431 | 3435 | `				if( nKwrd == PH7_TKWRD_STATIC ){` |
|        - | 3436 | `					/* Static method or attribute,record that */` |
|   100717 | 3437 | `					iAttrflags \|= PH7_CLASS_ATTR_STATIC;` |
|   100717 | 3438 | `					pGen->pIn++; /* Jump the static keyword */` |
|   100717 | 3439 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|        - | 3440 | `						int nSetTok;` |
|    73613 | 3441 | `						sxi32 nSetVis = GenStatePeekSetVisibility(pGen->pIn,pGen->pEnd,&nSetTok);` |
|    73613 | 3442 | `						if( nSetVis ){` |
...
|    73611 | 3448 | `							nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    73611 | 3449 | `							if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
...
|   100717 | 3463 | `					if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|      ! 0 | 3464 | `						iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|      ! 0 | 3465 | `						pGen->pIn++; /* Jump the 'readonly' modifier */` |
|      ! 0 | 3466 | `					}` |
|   100712 | 3467 | `					if( pGen->pIn >= pGen->pEnd` |
|   100717 | 3468 | `						\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|      ! 0 | 3476 | `						goto done;` |
|        - | 3477 | `					}` |
|   100717 | 3478 | `					if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|        - | 3479 | `						/* Attribute declaration */` |
|    27105 | 3480 | `						rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|    27105 | 3481 | `						if( rc != SXRET_OK ){` |
...
|    27103 | 3487 | `						continue;` |
|        - | 3488 | `					}` |
|    73617 | 3489 | `					if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|    73601 | 3501 | `					nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  2601517 | 3502 | `				}else if( nKwrd == PH7_TKWRD_ABSTRACT ){` |
...
|     7759 | 3511 | `					iAttrflags \|= PH7_CLASS_ATTR_ABSTRACT;` |
|        - | 3512 | `					/* Advance the stream cursor */` |
|     7759 | 3513 | `					pGen->pIn++;` |
|     7759 | 3514 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|     7759 | 3515 | `						nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|     7759 | 3516 | `						if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|     7757 | 3517 | `							iProtection = nKwrd;` |
|     7757 | 3518 | `							pGen->pIn++; /* Jump the visibility token */` |
|     3876 | 3519 | `						}` |
|     3877 | 3520 | `					}` |
|     7759 | 3521 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|     7754 | 3522 | `						SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_STATIC ){` |
|        - | 3523 | `							/* Static method */` |
|      ! 0 | 3524 | `							iAttrflags \|= PH7_CLASS_ATTR_STATIC;` |
|      ! 0 | 3525 | `							pGen->pIn++; /* Jump the static keyword */` |
|      ! 0 | 3526 | `					}` |
|     7759 | 3527 | `					if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 \|\|` |
|     7754 | 3528 | `						SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_FUNCTION ){` |
...
|      ! 0 | 3553 | `							goto done;` |
|        - | 3554 | `					}` |
|     7753 | 3555 | `					nKwrd = PH7_TKWRD_FUNCTION;` |
|  2560839 | 3556 | `				}else if( nKwrd == PH7_TKWRD_FINAL ){` |
|        - | 3557 | `					/* final method ,record that */` |
|       22 | 3558 | `					iAttrflags \|= PH7_CLASS_ATTR_FINAL;` |
|       22 | 3559 | `					pGen->pIn++; /* Jump the final keyword */` |
|       22 | 3560 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|        - | 3561 | `						/* Extract the keyword */` |
|       22 | 3562 | `						nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|       22 | 3563 | `						if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|       11 | 3564 | `							iProtection = nKwrd;` |
|       11 | 3565 | `							pGen->pIn++; /* Jump the visibility token */` |
|        4 | 3566 | `						}` |
|        9 | 3567 | `					}` |
|       22 | 3568 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
...
|       14 | 3580 | `							continue;` |
|        - | 3581 | `					}` |
|        9 | 3582 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
...
|      ! 0 | 3587 | `					}` |
|        9 | 3588 | `					if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 \|\|` |
...
|      ! 0 | 3597 | `							goto done;` |
|        - | 3598 | `					}` |
|        9 | 3599 | `					nKwrd = PH7_TKWRD_FUNCTION;` |
|        3 | 3600 | `				}` |
|  2638297 | 3601 | `				if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_VAR ){` |
...
|      ! 0 | 3609 | `						goto done;` |
|        - | 3610 | `				}` |
|  2638297 | 3611 | `				if( nKwrd == PH7_TKWRD_VAR ){` |
...
|  2638291 | 3626 | `					rc = GenStateCompileClassMethod(&(*pGen),iProtection,iAttrflags,TRUE,pClass);` |
|        - | 3627 | `				}` |
|  2638297 | 3628 | `				if( rc != SXRET_OK ){` |
...
|        - | 3651 | `		sxu32 nU;` |
|   450425 | 3652 | `		apUse = (TraitUseEntry *)SySetBasePtr(&aUseEntries);` |
|   465979 | 3653 | `		for( nU = 0 ; nU < SySetUsed(&aUseEntries) ; nU++ ){` |
|    15559 | 3654 | `			TraitUseEntry *pUse = &apUse[nU];` |
|    15559 | 3655 | `			ph7_class **apTrait = (ph7_class **)SySetBasePtr(&pUse->aTraits);` |
|    15559 | 3656 | `			sxu32 nTraits = SySetUsed(&pUse->aTraits);` |
|    15559 | 3657 | `			int hasResolution = (pUse->pResolvStart && pUse->pResolvStart < pUse->pResolvEnd) ? 1 : 0;` |
|        - | 3658 | `			sxu32 nT;` |
|    15559 | 3659 | `			if( !hasResolution ){` |
|        - | 3660 | `				/* No conflict resolution block: use standard trait application */` |
|    31099 | 3661 | `				for( nT = 0 ; nT < nTraits ; nT++ ){` |
|    15555 | 3662 | `					rc = PH7_ClassUseTrait(&(*pGen),pClass,apTrait[nT]);` |
|    15555 | 3663 | `					if( rc != SXRET_OK ){` |
|      ! 0 | 3664 | `						break;` |
|        - | 3665 | `					}` |
|     7780 | 3666 | `				}` |
|     7777 | 3667 | `			}else{` |
...
|        2 | 3855 | `				}` |
|        - | 3856 | `			}` |
|    15559 | 3857 | `			SySetRelease(&pUse->aTraits);` |
|     7782 | 3858 | `		}` |
|        - | 3859 | `	}` |
|   450425 | 3860 | `	if( pClass->iFlags & PH7_CLASS_ENUM ){` |
...
|     3905 | 3863 | `		rc = GenStateEnumFinalize(&(*pGen),pClass,nLine);` |
|     3905 | 3864 | `		if( rc == SXERR_ABORT ){` |
...
|   450425 | 3871 | `	if( GenStateGuardClassRedeclaration(pGen,pClass) == SXERR_ABORT ){` |
|        9 | 3872 | `		return SXERR_ABORT;` |
|        - | 3873 | `	}` |
|        - | 3874 | `	/* Install the class */` |
|   450419 | 3875 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|   450419 | 3876 | `	if( rc == SXRET_OK ){` |
|        - | 3877 | `		ph7_class **apInterface;` |
|        - | 3878 | `		sxu32 n;` |
|   450419 | 3879 | `		if( pBase ){` |
|        - | 3880 | `			/* Inherit from base class and mark as a subclass */` |
|   247741 | 3881 | `			rc = PH7_ClassInherit(&(*pGen),pClass,pBase);` |
|   123868 | 3882 | `		}` |
|   450419 | 3883 | `		apInterface = (ph7_class **)SySetBasePtr(&aInterfaces);` |
|   647791 | 3884 | `		for( n = 0 ; n < SySetUsed(&aInterfaces) ; n++ ){` |
|        - | 3885 | `			/* Implements one or more interface */` |
|   197377 | 3886 | `			rc = PH7_ClassImplement(pClass,apInterface[n]);` |
|   197377 | 3887 | `			if( rc != SXRET_OK ){` |
|      ! 0 | 3888 | `				break;` |
|        - | 3889 | `			}` |
|    98691 | 3890 | `		}` |
...
|   450419 | 3893 | `		if( rc == SXRET_OK && (pClass->iFlags & PH7_CLASS_ENUM) ){` |
|     3903 | 3894 | `			ph7_class *pIntf = PH7_VmExtractClass(pGen->pVm,"UnitEnum",sizeof("UnitEnum")-1,FALSE,0);` |
|     3903 | 3895 | `			while( pIntf && (pIntf->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|      ! 0 | 3896 | `				pIntf = pIntf->pNextName;` |
|      ! 0 | 3897 | `			}` |
|     3903 | 3898 | `			if( pIntf ){` |
|     3903 | 3899 | `				PH7_ClassImplement(pClass,pIntf);` |
|     1949 | 3900 | `			}` |
|     3903 | 3901 | `			if( pClass->nEnumBacking != 0 ){` |
|     3885 | 3902 | `				pIntf = PH7_VmExtractClass(pGen->pVm,"BackedEnum",sizeof("BackedEnum")-1,FALSE,0);` |
|     3885 | 3903 | `				while( pIntf && (pIntf->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|      ! 0 | 3904 | `					pIntf = pIntf->pNextName;` |
|      ! 0 | 3905 | `				}` |
|     3885 | 3906 | `				if( pIntf ){` |
|     3885 | 3907 | `					PH7_ClassImplement(pClass,pIntf);` |
|     1940 | 3908 | `				}` |
|     1940 | 3909 | `			}` |
|     1949 | 3910 | `		}` |
...
|   450414 | 3913 | `		if( rc == SXRET_OK` |
|   450414 | 3914 | `		 && (pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT)) == 0` |
|   450419 | 3915 | `		 && SyHashGet(&pClass->hMethod,"__toString",sizeof("__toString")-1) != 0 ){` |
|   228207 | 3916 | `			ph7_class *pStringable = PH7_VmExtractClass(pGen->pVm,` |
|        - | 3917 | `				"Stringable",sizeof("Stringable")-1,FALSE,0);` |
|   228207 | 3918 | `			if( pStringable ){` |
|   228207 | 3919 | `				ph7_class **apImpl = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|   228207 | 3920 | `				sxu32 nImpl = SySetUsed(&pClass->aInterface);` |
|        - | 3921 | `				sxu32 i;` |
|   228207 | 3922 | `				int bAlready = 0;` |
|   274603 | 3923 | `				for( i = 0 ; i < nImpl ; i++ ){` |
|    58001 | 3924 | `					if( apImpl[i] == pStringable ){` |
|    11605 | 3925 | `						bAlready = 1;` |
|    11605 | 3926 | `						break;` |
|        - | 3927 | `					}` |
|    23203 | 3928 | `				}` |
|   228207 | 3929 | `				if( !bAlready ){` |
|   216607 | 3930 | `					PH7_ClassImplement(pClass,pStringable);` |
|   108301 | 3931 | `				}` |
|   114101 | 3932 | `			}` |
|   114101 | 3933 | `		}` |
|        - | 3934 | `		/* Validate interface method signatures (visibility and parameter count) */` |
|   450419 | 3935 | `		if( rc == SXRET_OK ){` |
|   450419 | 3936 | `			sxi32 rcCheck = GenStateCheckInterfaceSignatures(&(*pGen),pClass);` |
|   450419 | 3937 | `			if( rcCheck == SXERR_ABORT ){` |
...
|   450419 | 3944 | `		if( rc == SXRET_OK ){` |
|   450419 | 3945 | `			sxi32 rcCheck = GenStateCheckAbstractMethods(&(*pGen),pClass);` |
|   450419 | 3946 | `			if( rcCheck == SXERR_ABORT ){` |
...
|   225207 | 3951 | `		}` |
|   225207 | 3952 | `	}` |
|   450419 | 3953 | `	SySetRelease(&aUseEntries);` |
|   450419 | 3954 | `	SySetRelease(&aInterfaces);` |
|   450419 | 3955 | `	if( rc != SXRET_OK ){` |
...
|   450461 | 3961 | `	pGen->pIn = &pEnd[1];` |
|   450461 | 3962 | `	pGen->pEnd = pTmp;` |
|   450461 | 3963 | `	return PH7_OK;` |
|   225237 | 3964 | `}` |
|        - | 3965 | `/* Compile a named class declaration (the common case). */` |
|   450434 | 3966 | `static sxi32 GenStateCompileClass(ph7_gen_state *pGen,sxi32 iFlags)` |
|        5 | 3967 | `{` |
|   450439 | 3968 | `	return GenStateCompileClassEx(pGen,iFlags,0,0,0);` |
|        5 | 3969 | `}` |
|        - | 3970 | `/*` |
...
|        - | 4069 | ` */` |
| 14394802 | 4070 | `static int GenStateTokenIsClassModifier(SyToken *pTok,sxi32 *piFlag)` |
|        5 | 4071 | `{` |
| 14394807 | 4072 | `	if( pTok->nType & PH7_TK_KEYWORD ){` |
|  8615423 | 4073 | `		sxu32 nKw = (sxu32)SX_PTR_TO_INT(pTok->pUserData);` |
|  8615423 | 4074 | `		if( nKw == PH7_TKWRD_FINAL ){ *piFlag = PH7_CLASS_FINAL; return TRUE; }` |
|  8561253 | 4075 | `		if( nKw == PH7_TKWRD_ABSTRACT ){ *piFlag = PH7_CLASS_ABSTRACT; return TRUE; }` |
|  4261241 | 4076 | `	}` |
| 14301871 | 4077 | `	if( GenStateIsReadonly(pTok) ){ *piFlag = PH7_CLASS_READONLY; return TRUE; }` |
| 14301811 | 4078 | `	return FALSE;` |
|  7197406 | 4079 | `}` |
|        - | 4080 | `/*` |
...
|        - | 4085 | ` */` |
| 14301806 | 4086 | `static sxi32 GenStateScanClassModifiers(SyToken **ppIn,SyToken *pEnd,SyToken **ppDup)` |
|        5 | 4087 | `{` |
| 14301811 | 4088 | `	SyToken *pIn = *ppIn,*pDup = 0;` |
| 14301811 | 4089 | `	sxi32 iFlags = 0,iFlag;` |
| 14394807 | 4090 | `	while( pIn < pEnd && GenStateTokenIsClassModifier(pIn,&iFlag) ){` |
|    93001 | 4091 | `		if( (iFlags & iFlag) && pDup == 0 ){` |
|        5 | 4092 | `			pDup = pIn;` |
|        2 | 4093 | `		}` |
|    93001 | 4094 | `		iFlags \|= iFlag;` |
|    93001 | 4095 | `		pIn++;` |
|        5 | 4096 | `	}` |
| 14301811 | 4097 | `	*ppIn = pIn;` |
| 14301811 | 4098 | `	if( ppDup ){ *ppDup = pDup; }` |
| 14301811 | 4099 | `	return iFlags;` |
|        5 | 4100 | `}` |
|        - | 4101 | `/*` |
...
|        - | 4107 | ` */` |
| 14259184 | 4108 | `PH7_PRIVATE int GenStateStartsModifiedClass(SyToken *pIn,SyToken *pEnd)` |
|        5 | 4109 | `{` |
| 14259189 | 4110 | `	sxi32 iFlags = GenStateScanClassModifiers(&pIn,pEnd,0);` |
|  7179953 | 4111 | `	return iFlags != 0 && pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD)` |
| 14284363 | 4112 | `		&& (sxu32)SX_PTR_TO_INT(pIn->pUserData) == PH7_TKWRD_CLASS;` |
|        5 | 4113 | `}` |
|        - | 4114 | `/*` |
...
|        - | 4120 | ` */` |
|    42622 | 4121 | `PH7_PRIVATE sxi32 PH7_CompileClassModifiers(ph7_gen_state *pGen)` |
|        5 | 4122 | `{` |
|        - | 4123 | `	SyToken *pDup;` |
|    42627 | 4124 | `	sxi32 iFlags = GenStateScanClassModifiers(&pGen->pIn,pGen->pEnd,&pDup);` |
|        - | 4125 | `	sxi32 rc;` |
|    42627 | 4126 | `	if( pDup ){` |
...
|        - | 4131 | `		}` |
|        1 | 4132 | `	}` |
|    42622 | 4133 | `	if( (iFlags & (PH7_CLASS_FINAL\|PH7_CLASS_ABSTRACT))` |
|    21316 | 4134 | `		== (PH7_CLASS_FINAL\|PH7_CLASS_ABSTRACT) ){` |
...
|        - | 4139 | `		}` |
|        1 | 4140 | `	}` |
|    42627 | 4141 | `	return GenStateCompileClass(&(*pGen),iFlags);` |
|    21316 | 4142 | `}` |
|        - | 4143 | `/*` |
...
|        - | 4148 | ` */` |
|     7834 | 4149 | `PH7_PRIVATE sxi32 PH7_CompileTrait(ph7_gen_state *pGen)` |
|        5 | 4150 | `{` |
|     7839 | 4151 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|     7839 | 4160 | `	pGen->pIn++;` |
|     7839 | 4161 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
...
|     7839 | 4172 | `	pName = &pGen->pIn->sData;` |
|     7839 | 4173 | `	pGen->pIn++;` |
|        - | 4174 | `	/* Build FQN and obtain a raw class */ {` |
|        - | 4175 | `		SyBlob sFQN;` |
|        - | 4176 | `		SyString sFQNStr;` |
|     7839 | 4177 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|     7839 | 4178 | `		GenStateBuildFQN(pGen,pName,&sFQN);` |
|     7839 | 4179 | `		SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|     7839 | 4180 | `		pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|     7839 | 4181 | `		SyBlobRelease(&sFQN);` |
|        - | 4182 | `	}` |
|     7839 | 4183 | `	if( pClass == 0 ){` |
|      ! 0 | 4184 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 4185 | `		return SXERR_ABORT;` |
|        - | 4186 | `	}` |
|     7839 | 4187 | `	GenStateConsumeDoc(&(*pGen),&pClass->sDoc);` |
|     7839 | 4188 | `	if( GenStateConsumeAttrs(&(*pGen),&pClass->aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 4189 | `		return SXERR_ABORT;` |
|        - | 4190 | `	}` |
|        - | 4191 | `	/* Traits cannot extend or implement; expect opening brace directly */` |
|     7839 | 4192 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_OCB) == 0 ){` |
...
|        - | 4199 | `	}` |
|     7839 | 4200 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|     7839 | 4201 | `	pEnd = 0;` |
|     7839 | 4202 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB,PH7_TK_CCB,&pEnd);` |
|     7839 | 4203 | `	if( pEnd >= pGen->pEnd ){` |
...
|     7839 | 4212 | `	pClass->nEndLine = pEnd->nLine;` |
|        - | 4213 | `	/* Swap token stream */` |
|     7839 | 4214 | `	pTmp = pGen->pEnd;` |
|     7839 | 4215 | `	pGen->pEnd = pEnd;` |
|        - | 4216 | `	/* Mark as trait (PH7_NewRawClass may have set INTERNAL) */` |
|     7839 | 4217 | `	pClass->iFlags \|= PH7_CLASS_TRAIT;` |
|        - | 4218 | `	/* Parse the body: same as a normal class (methods, attributes, visibility modifiers) */` |
|    56159 | 4219 | `	for(;;){` |
|   158777 | 4220 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|    23235 | 4221 | `			pGen->pIn++;` |
|        5 | 4222 | `		}` |
|   135547 | 4223 | `		if( pGen->pIn >= pGen->pEnd ){` |
|     7839 | 4224 | `			break;` |
|        - | 4225 | `		}` |
|        - | 4226 | `		/* Bind a directly-preceding docblock to this member */` |
|   127713 | 4227 | `		GenStateSetPendingDoc(&(*pGen));` |
|   127713 | 4228 | `		if( (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR)) == 0 ){` |
...
|      ! 0 | 4235 | `			goto done;` |
|        - | 4236 | `		}` |
|   127713 | 4237 | `		iProtection = PH7_TKWRD_PUBLIC;` |
|   127713 | 4238 | `		iAttrflags = 0;` |
|   127713 | 4239 | `		if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|   127713 | 4240 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   127713 | 4241 | `			if( nKwrd == PH7_TKWRD_USE ){` |
...
|        5 | 4282 | `				continue;` |
|        - | 4283 | `			}` |
|   127709 | 4284 | `			if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|   127691 | 4285 | `				iProtection = nKwrd;` |
|   127691 | 4286 | `				pGen->pIn++;` |
...
|   127691 | 4290 | `				if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|        5 | 4291 | `					iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|        5 | 4292 | `					pGen->pIn++; /* Jump the 'readonly' modifier */` |
|        2 | 4293 | `				}` |
|   127686 | 4294 | `				if( pGen->pIn >= pGen->pEnd` |
|   127691 | 4295 | `					\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|      ! 0 | 4302 | `					goto done;` |
|        - | 4303 | `				}` |
|   127691 | 4304 | `				if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|    23215 | 4305 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|    23215 | 4306 | `					if( rc != SXRET_OK ){` |
...
|    23215 | 4312 | `					continue;` |
|        - | 4313 | `				}` |
|   104481 | 4314 | `				if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|        9 | 4322 | `					continue;` |
|        - | 4323 | `				}` |
|   104473 | 4324 | `				nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    52234 | 4325 | `			}` |
|   104491 | 4326 | `			if( nKwrd == PH7_TKWRD_CONST ){` |
...
|      ! 0 | 4332 | `				goto done;` |
|      ! 0 | 4333 | `			}else{` |
|   104491 | 4334 | `				if( nKwrd == PH7_TKWRD_STATIC ){` |
|     7747 | 4335 | `					iAttrflags \|= PH7_CLASS_ATTR_STATIC;` |
|     7747 | 4336 | `					pGen->pIn++;` |
|     7747 | 4337 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|     7745 | 4338 | `						nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|     7745 | 4339 | `						if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|      ! 0 | 4340 | `							iProtection = nKwrd;` |
|      ! 0 | 4341 | `							pGen->pIn++;` |
|      ! 0 | 4342 | `						}` |
|     3870 | 4343 | `					}` |
|     7742 | 4344 | `					if( pGen->pIn >= pGen->pEnd` |
|     7747 | 4345 | `						\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|      ! 0 | 4352 | `						goto done;` |
|        - | 4353 | `					}` |
|     7747 | 4354 | `					if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
...
|        3 | 4362 | `						continue;` |
|        - | 4363 | `					}` |
|     7745 | 4364 | `					if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|      ! 0 | 4372 | `						continue;` |
|        - | 4373 | `					}` |
|     7745 | 4374 | `					nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   100619 | 4375 | `				}else if( nKwrd == PH7_TKWRD_ABSTRACT ){` |
...
|        3 | 4396 | `				}` |
|   104489 | 4397 | `				if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_VAR ){` |
...
|      ! 0 | 4404 | `					goto done;` |
|        - | 4405 | `				}` |
|   104489 | 4406 | `				if( nKwrd == PH7_TKWRD_VAR ){` |
|      ! 0 | 4407 | `					pGen->pIn++;` |
...
|      ! 0 | 4417 | `				}else{` |
|   104489 | 4418 | `					rc = GenStateCompileClassMethod(&(*pGen),iProtection,iAttrflags,TRUE,pClass);` |
|        - | 4419 | `				}` |
|   104489 | 4420 | `				if( rc != SXRET_OK ){` |
...
|     7839 | 4438 | `	if( GenStateGuardClassRedeclaration(pGen,pClass) == SXERR_ABORT ){` |
|        3 | 4439 | `		return SXERR_ABORT;` |
|        - | 4440 | `	}` |
|        - | 4441 | `	/* Install the trait */` |
|     7837 | 4442 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|     7837 | 4443 | `	if( rc != SXRET_OK ){` |
...
|     7837 | 4449 | `	pGen->pIn = &pEnd[1];` |
|     7837 | 4450 | `	pGen->pEnd = pTmp;` |
|     7837 | 4451 | `	return PH7_OK;` |
|     3922 | 4452 | `}` |
|        - | 4453 | `/*` |
...
|        - | 4461 | ` */` |
|   403908 | 4462 | `PH7_PRIVATE sxi32 PH7_CompileClass(ph7_gen_state *pGen)` |
|        5 | 4463 | `{` |
|        - | 4464 | `	sxi32 rc;` |
|   403913 | 4465 | `	rc = GenStateCompileClass(&(*pGen),0);` |
|   403913 | 4466 | `	return rc;` |
|        5 | 4467 | `}` |
|        - | 4468 | `/*` |
...
|        - | 4474 | ` */` |
| 14208830 | 4475 | `PH7_PRIVATE int GenStateStartsEnumDecl(SyToken *pIn,SyToken *pEnd)` |
|        5 | 4476 | `{` |
| 14424221 | 4477 | `	return (pIn->nType & PH7_TK_ID)` |
|  7319801 | 4478 | `		&& pIn->sData.nByte == sizeof("enum")-1` |
|   225199 | 4479 | `		&& SyStrnicmp(pIn->sData.zString,"enum",sizeof("enum")-1) == 0` |
| 14424216 | 4480 | `		&& &pIn[1] < pEnd && (pIn[1].nType & PH7_TK_ID);` |
|        5 | 4481 | `}` |
|        - | 4482 | `/*` |
...
|        - | 4487 | ` */` |
|     3904 | 4488 | `PH7_PRIVATE sxi32 PH7_CompileEnum(ph7_gen_state *pGen)` |
|        5 | 4489 | `{` |
|     3909 | 4490 | `	return GenStateCompileClass(&(*pGen),PH7_CLASS_ENUM\|PH7_CLASS_FINAL);` |
|        5 | 4491 | `}` |
|        - | 4492 |  |
