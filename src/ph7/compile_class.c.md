...
|        - |   26 | ` */` |
|   529338 |   27 | `static sxi32 GenStateGuardClassRedeclaration(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 |   28 | `{` |
|        - |   29 | `	SyHashEntry *pEntry;` |
|   529343 |   30 | `	if( !GenStateUnconditionalTopLevel(pGen) ){` |
|       26 |   31 | `		return SXRET_OK; /* conditional/nested: keep hoisting */` |
|        - |   32 | `	}` |
|   529321 |   33 | `	pClass->iFlags \|= PH7_CLASS_BOUND;` |
|   529321 |   34 | `	if( pGen->pVm->bCompilingBuiltin ){` |
...
|        - |   70 | ` */` |
|  3824954 |   71 | `static sxi32 GetProtectionLevel(sxi32 nKeyword)` |
|        5 |   72 | `{` |
|  3824959 |   73 | `	if( nKeyword == PH7_TKWRD_PRIVATE ){` |
|   279303 |   74 | `		return PH7_CLASS_PROT_PRIVATE;` |
|  3545661 |   75 | `	}else if( nKeyword == PH7_TKWRD_PROTECTED ){` |
|   221039 |   76 | `		return PH7_CLASS_PROT_PROTECTED;` |
|        - |   77 | `	}` |
|        - |   78 | `	/* Assume public by default */` |
|  3324627 |   79 | `	return PH7_CLASS_PROT_PUBLIC;` |
|  1912482 |   80 | `}` |
|        - |   81 | `/*` |
...
|        - |   88 | ` */` |
|   341296 |   89 | `static int GenStateClassConstHasType(ph7_gen_state *pGen)` |
|        5 |   90 | `{` |
|        - |   91 | `	SyToken *p0, *p1;` |
|   341301 |   92 | `	if( pGen->pIn >= pGen->pEnd ){` |
|      ! 0 |   93 | `		return 0;` |
|        - |   94 | `	}` |
|   341301 |   95 | `	p0 = pGen->pIn;` |
|        - |   96 | `	/* A leading '\' (namespaced class type) or '?' (nullable) always starts a type */` |
|   341301 |   97 | `	if( p0->nType & PH7_TK_NSSEP ){` |
|      ! 0 |   98 | `		return 1;` |
|        - |   99 | `	}` |
|   341301 |  100 | `	if( (p0->nType & PH7_TK_OP) && p0->sData.nByte == 1 && p0->sData.zString[0] == '?' ){` |
|        5 |  101 | `		return 1;` |
|        - |  102 | `	}` |
...
|   341297 |  106 | `	if( p0->nType & (PH7_TK_ID\|PH7_TK_KEYWORD) ){` |
|   341297 |  107 | `		p1 = (pGen->pIn + 1 < pGen->pEnd) ? (pGen->pIn + 1) : 0;` |
|   341297 |  108 | `		if( p1 ){` |
|   341297 |  109 | `			if( p1->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_NSSEP) ){` |
|       34 |  110 | `				return 1;` |
|        - |  111 | `			}` |
|   341267 |  112 | `			if( (p1->nType & PH7_TK_OP) && p1->sData.nByte == 1 && p1->sData.zString[0] == '\|' ){` |
|        5 |  113 | `				return 1;` |
|        - |  114 | `			}` |
|   170629 |  115 | `		}` |
|   170629 |  116 | `	}` |
...
|        - |  172 | ` */` |
|   721922 |  173 | `static int GenStateInitHasNewExpr(ph7_gen_state *pGen)` |
|        5 |  174 | `{` |
|   721927 |  175 | `	SyToken *p = pGen->pIn;` |
|   721927 |  176 | `	int iDepth = 0;` |
|  1906719 |  177 | `	while( p < pGen->pEnd ){` |
|  1906719 |  178 | `		if( iDepth == 0 && (p->nType & (PH7_TK_SEMI\|PH7_TK_COMMA)) ){` |
|   721875 |  179 | `			break; /* end of this initializer */` |
|        - |  180 | `		}` |
|  1184844 |  181 | `		if( (p->nType & PH7_TK_KEYWORD)` |
|   600199 |  182 | `			&& ( SX_PTR_TO_INT(p->pUserData) == PH7_TKWRD_FUNCTION` |
|    15543 |  183 | `				\|\| SX_PTR_TO_INT(p->pUserData) == PH7_TKWRD_FN ) ){` |
...
|        6 |  241 | `			continue;` |
|        - |  242 | `		}` |
|  1184845 |  243 | `		if( p->nType & PH7_TK_OCB ){` |
|       45 |  244 | `			if( iDepth == 0 ){` |
...
|        - |  250 | `			}` |
|      ! 0 |  251 | `			iDepth++;` |
|  1184801 |  252 | `		}else if( p->nType & (PH7_TK_LPAREN\|PH7_TK_OSB) ){` |
|    50493 |  253 | `			iDepth++;` |
|  1159557 |  254 | `		}else if( p->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB) ){` |
|    50491 |  255 | `			if( iDepth > 0 ){` |
|    50491 |  256 | `				iDepth--;` |
|    25243 |  257 | `			}` |
|  1109070 |  258 | `		}else if( (p->nType & PH7_TK_OP) && p->pUserData` |
|   390623 |  259 | `			&& ((const ph7_expr_op *)p->pUserData)->iOp == EXPR_OP_NEW ){` |
...
|        - |  277 | ` */` |
|  1272834 |  278 | `static ph7_class_attr * GenStateExtractConstant(ph7_class *pClass,SyString *pName)` |
|        5 |  279 | `{` |
|  1272839 |  280 | `	ph7_class_attr *pAttr = PH7_ClassExtractAttribute(pClass,pName->zString,pName->nByte);` |
|  1272839 |  281 | `	return ( pAttr && (pAttr->iFlags & PH7_CLASS_ATTR_CONSTANT) ) ? pAttr : 0;` |
|        5 |  282 | `}` |
|  1521888 |  283 | `static ph7_class_attr * GenStateExtractProperty(ph7_class *pClass,const char *zName,sxu32 nByte)` |
|        5 |  284 | `{` |
|  1521893 |  285 | `	ph7_class_attr *pAttr = PH7_ClassExtractAttribute(pClass,zName,nByte);` |
|  1521893 |  286 | `	return ( pAttr && (pAttr->iFlags & PH7_CLASS_ATTR_CONSTANT) == 0 ) ? pAttr : 0;` |
|        5 |  287 | `}` |
|        - |  288 | `/*` |
...
|        - |  308 | ` */` |
|   721972 |  309 | `PH7_PRIVATE int PH7_GenStateInitHasCallExpr(ph7_gen_state *pGen)` |
|        5 |  310 | `{` |
|   721977 |  311 | `	SyToken *p = pGen->pIn;` |
|   721977 |  312 | `	int iDepth = 0;` |
|        - |  313 | `	/* Conservative ternary bail-out (see the note above). */` |
|        - |  314 | `	{` |
|   721977 |  315 | `		SyToken *q = pGen->pIn;` |
|   721977 |  316 | `		int iQd = 0;` |
|  1908067 |  317 | `		while( q < pGen->pEnd ){` |
|  1908029 |  318 | `			if( iQd == 0 && (q->nType & (PH7_TK_SEMI\|PH7_TK_COMMA)) ){` |
|   721933 |  319 | `				break;` |
|        - |  320 | `			}` |
|  1186101 |  321 | `			if( q->nType & (PH7_TK_LPAREN\|PH7_TK_OSB\|PH7_TK_OCB) ){` |
|    50629 |  322 | `				iQd++;` |
|  1160789 |  323 | `			}else if( q->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB) ){` |
|    50629 |  324 | `				if( iQd > 0 ){ iQd--; }` |
|  1110165 |  325 | `			}else if( (q->nType & PH7_TK_OP) && q->pUserData` |
|   390849 |  326 | `				&& ((const ph7_expr_op *)q->pUserData)->iOp == EXPR_OP_QUESTY ){` |
|        8 |  327 | `				return 0;` |
|        - |  328 | `			}` |
|  1186095 |  329 | `			q++;` |
|        5 |  330 | `		}` |
|        - |  331 | `	}` |
|  1906913 |  332 | `	while( p < pGen->pEnd ){` |
|  1906913 |  333 | `		if( iDepth == 0 && (p->nType & (PH7_TK_SEMI\|PH7_TK_COMMA)) ){` |
|   721927 |  334 | `			break; /* end of this initializer */` |
|        - |  335 | `		}` |
|  1184986 |  336 | `		if( (p->nType & PH7_TK_KEYWORD)` |
|   600270 |  337 | `			&& ( SX_PTR_TO_INT(p->pUserData) == PH7_TKWRD_FUNCTION` |
|    15543 |  338 | `				\|\| SX_PTR_TO_INT(p->pUserData) == PH7_TKWRD_FN ) ){` |
...
|        6 |  388 | `			continue;` |
|        - |  389 | `		}` |
|  1184987 |  390 | `		if( p->nType & PH7_TK_OCB ){` |
|       43 |  391 | `			if( iDepth == 0 ){` |
|       43 |  392 | `				break; /* property-hook list: the default expression ends here */` |
|        - |  393 | `			}` |
|      ! 0 |  394 | `			iDepth++;` |
|  1184945 |  395 | `		}else if( p->nType & (PH7_TK_LPAREN\|PH7_TK_OSB) ){` |
...
|    50508 |  399 | `			if( (p->nType & PH7_TK_LPAREN) && p > pGen->pIn` |
|    15534 |  400 | `				&& (p[-1].nType & PH7_TK_ID)` |
|     7779 |  401 | `				&& !((p[-1].nType & PH7_TK_OP) && p[-1].pUserData` |
...
|        6 |  421 | `			}` |
|    50511 |  422 | `			iDepth++;` |
|  1159690 |  423 | `		}else if( p->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB) ){` |
|    50511 |  424 | `			if( iDepth > 0 ){` |
|    50511 |  425 | `				iDepth--;` |
|    25253 |  426 | `			}` |
|    25253 |  427 | `		}` |
|  1184943 |  428 | `		p++;` |
...
|        - |  439 | ` */` |
|    15898 |  440 | `static void GenStateCopyTypeToAttr(ph7_class_attr *pAttr,sxu32 nType,` |
|        - |  441 | `	const SyString *pClass,const SyString *pTypeName,sxi32 iTypeFlags,SySet *pAlts)` |
|        5 |  442 | `{` |
|    15903 |  443 | `	pAttr->nType = nType;` |
|    15903 |  444 | `	pAttr->sClass = *pClass;` |
|    15903 |  445 | `	pAttr->sTypeName = *pTypeName;` |
|    15903 |  446 | `	if( iTypeFlags & PH7_CLASS_ATTR_UNION ){` |
|        - |  447 | `		sxu32 i;` |
...
|       11 |  452 | `	}` |
|    15903 |  453 | `}` |
|   341296 |  454 | `static sxi32 GenStateCompileClassConstant(ph7_gen_state *pGen,sxi32 iProtection,sxi32 iFlags,ph7_class *pClass)` |
|        5 |  455 | `{` |
|   341301 |  456 | `	sxu32 nLine = pGen->pIn->nLine;` |
|        - |  457 | `	SySet *pInstrContainer;` |
|        - |  458 | `	ph7_class_attr *pCons;` |
|        - |  459 | `	SyString *pName;` |
|        - |  460 | `	sxi32 rc;` |
|   341301 |  461 | `	sxu32 nType = 0;` |
|        - |  462 | `	SyString sTypeClass;` |
|        - |  463 | `	SyString sTypeText;` |
|        - |  464 | `	SySet aUnionAlts;` |
|   341301 |  465 | `	sxi32 iTypeFlags = 0;` |
|   341301 |  466 | `	SyStringInitFromBuf(&sTypeClass,0,0);` |
|   341301 |  467 | `	SyStringInitFromBuf(&sTypeText,0,0);` |
|   341301 |  468 | `	SySetInit(&aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|        - |  469 | `	/* Extract visibility level */` |
|   341301 |  470 | `	iProtection = GetProtectionLevel(iProtection);` |
|        - |  471 | `	/* Mark as constant */` |
|   341301 |  472 | `	iFlags \|= PH7_CLASS_ATTR_CONSTANT;` |
|   341301 |  473 | `	pGen->pIn++; /* Jump the 'const' keyword */` |
...
|   341320 |  476 | `	if( GenStateClassConstHasType(pGen) ){` |
...
|       19 |  497 | `	}` |
|   170648 |  498 | `loop:` |
|   341303 |  499 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
...
|   341303 |  509 | `	pName = &pGen->pIn->sData;` |
|        - |  510 | `	/* Make sure the constant name isn't reserved */` |
|   341303 |  511 | `	if( GenStateIsReservedConstant(pName) ){` |
...
|   341303 |  521 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
...
|   341301 |  532 | `	pGen->pIn++;` |
|   341301 |  533 | `	if(pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_EQUAL /* '=' */) == 0 ){` |
...
|        - |  541 | `	}` |
|   341301 |  542 | `	pGen->pIn++; /* Jump the equal sign */` |
...
|   341296 |  547 | `	if( (iTypeFlags & PH7_CLASS_ATTR_TYPED) && !(iTypeFlags & PH7_CLASS_ATTR_UNION)` |
...
|   341297 |  559 | `	if( PH7_GenStateInitHasCallExpr(pGen) ){` |
...
|   341297 |  570 | `	if( GenStateInitHasNewExpr(pGen) ){` |
...
|   341288 |  586 | `	if( GenStateExtractConstant(pClass,pName) == 0` |
|   341293 |  587 | `	 && GenStateExtractProperty(pClass,pName->zString,pName->nByte) != 0 ){` |
...
|        - |  595 | `	}` |
|   341293 |  596 | `	if( GenStateExtractConstant(pClass,pName) != 0 ){` |
...
|   341293 |  605 | `	pCons = PH7_NewClassAttr(pGen->pVm,pName,nLine,iProtection,iFlags\|iTypeFlags);` |
|   341293 |  606 | `	if( pCons ){` |
|   341293 |  607 | `		GenStateConsumeDoc(&(*pGen),&pCons->sDoc);` |
|   341293 |  608 | `		if( GenStateConsumeAttrs(&(*pGen),&pCons->aAttrs) == SXERR_ABORT ){` |
|      ! 0 |  609 | `			return SXERR_ABORT;` |
|        - |  610 | `		}` |
|   170644 |  611 | `	}` |
|   341293 |  612 | `	if( pCons == 0 ){` |
|      ! 0 |  613 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 |  614 | `		return SXERR_ABORT;` |
|        - |  615 | `	}` |
|   341293 |  616 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|       35 |  617 | `		GenStateCopyTypeToAttr(pCons,nType,&sTypeClass,&sTypeText,iTypeFlags,&aUnionAlts);` |
|       16 |  618 | `	}` |
|        - |  619 | `	/* Swap bytecode container */` |
|   341293 |  620 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   341293 |  621 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pCons->aByteCode);` |
|        - |  622 | `	/* Compile constant value.` |
|        - |  623 | `	 */` |
|   341293 |  624 | `	rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|   341293 |  625 | `	if( rc == SXERR_EMPTY ){` |
...
|   341293 |  632 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|   341293 |  633 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|   341293 |  634 | `	if( rc == SXERR_ABORT ){` |
...
|   341293 |  639 | `	rc = PH7_ClassInstallAttr(pClass,pCons);` |
|   341293 |  640 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  641 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 |  642 | `		return SXERR_ABORT;` |
|        - |  643 | `	}` |
|   341293 |  644 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA /*','*/) ){` |
...
|        - |  662 | `		}` |
|      ! 0 |  663 | `	}` |
|   341291 |  664 | `	SySetRelease(&aUnionAlts);` |
|   341291 |  665 | `	return SXRET_OK;` |
|        5 |  666 | `Synchronize:` |
...
|        - |  702 | ` */` |
|  2618286 |  703 | `static int GenStateLooksLikeTypedProperty(SyToken *pStart,SyToken *pEnd)` |
|        5 |  704 | `{` |
|  2618291 |  705 | `	SyToken *p = pStart;` |
|  2618291 |  706 | `	int bFirst = 1;` |
|  2618291 |  707 | `	if( p >= pEnd ) return 0;` |
|        - |  708 | ``	/* Optional nullable `?` shorthand. */`` |
|  2618291 |  709 | `	if( (p->nType & PH7_TK_OP) && p->sData.nByte == 1 && p->sData.zString[0] == '?' ){` |
|       41 |  710 | `		p++;` |
...
|  1309143 |  717 | `	for(;;){` |
|  2618311 |  718 | `		if( p < pEnd && (p->nType & PH7_TK_LPAREN) ){` |
...
|  2618309 |  727 | `			if( p < pEnd && (p->nType & PH7_TK_NSSEP) ){ p++; }` |
|  2618309 |  728 | `			if( p >= pEnd \|\| (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|      ! 0 |  729 | `				return 0;` |
|        - |  730 | `			}` |
...
|  2618309 |  734 | `			if( bFirst && (p->nType & PH7_TK_KEYWORD) ){` |
|  2618253 |  735 | `				sxu32 k = (sxu32)(SX_PTR_TO_INT(p->pUserData));` |
|  2618248 |  736 | `				if( k == PH7_TKWRD_FUNCTION \|\| k == PH7_TKWRD_VAR \|\| k == PH7_TKWRD_CONST` |
|   124534 |  737 | `				 \|\| k == PH7_TKWRD_STATIC \|\| k == PH7_TKWRD_FINAL \|\| k == PH7_TKWRD_ABSTRACT ){` |
|  2602431 |  738 | `					return 0;` |
|        - |  739 | `				}` |
|     7911 |  740 | `			}` |
|    15883 |  741 | `			p++;` |
|    15885 |  742 | `			while( p + 1 < pEnd && (p->nType & PH7_TK_NSSEP) && (p[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|        3 |  743 | `				p += 2;` |
|        1 |  744 | `			}` |
|    23820 |  745 | `			while( p + 1 < pEnd && (p->nType & PH7_TK_AMPER)` |
|    15886 |  746 | `				&& (p[1].nType & (PH7_TK_NSSEP\|PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|        3 |  747 | `				p++; /* skip '&' */` |
...
|        - |  755 | `		}` |
|    15885 |  756 | `		bFirst = 0;` |
|    15880 |  757 | `		if( p < pEnd && (p->nType & PH7_TK_OP) && p->sData.nByte == 1` |
...
|    15865 |  762 | `		break;` |
|      ! 0 |  763 | `	}` |
|    15865 |  764 | `	if( p >= pEnd ) return 0;` |
|    15865 |  765 | `	return (p->nType & PH7_TK_DOLLAR) ? 1 : 0;` |
|  1309148 |  766 | `}` |
|        - |  767 |  |
|        - |  768 | `/*` |
...
|        - |  785 | ` */` |
|    15870 |  786 | `static sxi32 GenStateParsePropertyType(` |
...
|        - |  792 | `	SySet *pAlts` |
|        5 |  793 | `){` |
|    15875 |  794 | `	sxi32 iFlags = 0;` |
|        - |  795 | `	sxi32 rc;` |
|    15875 |  796 | `	if( pGen->pIn >= pGen->pEnd ){` |
|      ! 0 |  797 | `		return SXRET_OK;` |
|        - |  798 | `	}` |
|        - |  799 | `	/* If the first token is '$', there's no type */` |
|    15875 |  800 | `	if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|      ! 0 |  801 | `		return SXRET_OK;` |
|        - |  802 | `	}` |
|    15875 |  803 | `	rc = GenStateParseUnionTypeDecl(` |
|     7935 |  804 | `		pGen, pnType, pClass, pAlts, &iFlags, pTypeText,` |
|        - |  805 | `		PH7_CLASS_ATTR_NULLABLE,` |
|        - |  806 | `		PH7_CLASS_ATTR_UNION,` |
|        - |  807 | `		/* bAllowVoid */ 0,` |
|    15870 |  808 | `		pGen->pIn->nLine);` |
|    15875 |  809 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  810 | `		return rc;` |
|        - |  811 | `	}` |
|        - |  812 | `	/* Verify next token is '$' (start of property name) */` |
|    15875 |  813 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
|      ! 0 |  814 | `		return SXERR_SYNTAX;` |
|        - |  815 | `	}` |
|    15875 |  816 | `	*piTypeFlags = iFlags \| PH7_CLASS_ATTR_TYPED;` |
|    15875 |  817 | `	return SXRET_OK;` |
|     7940 |  818 | `}` |
|        - |  819 |  |
|        - |  820 | `/*` |
...
|        - |  830 | ` */` |
|    16048 |  831 | `static int GenStateIsDisallowedPropertyAtom(` |
|        - |  832 | `	sxu32 nType,` |
...
|        - |  837 | `	const char *z;` |
|        - |  838 | `	sxu32 n;` |
|    16053 |  839 | `	if( nType != SXU32_HIGH \|\| pClass == 0 \|\| pClass->nByte == 0 ){` |
|    15987 |  840 | `		return 0;` |
|        - |  841 | `	}` |
...
|        - |  863 | ` */` |
|    15986 |  864 | `PH7_PRIVATE sxi32 GenStateValidateMemberType(` |
...
|        - |  873 | `	sxu32 nLine)` |
|        5 |  874 | `{` |
|    15991 |  875 | `	const char *zBad = 0;` |
|    15991 |  876 | `	sxu32 nBad = 0;` |
|        - |  877 | `	SyString sFallback;` |
|        - |  878 | `	const SyString *pBad;` |
|        - |  879 | `	sxi32 rc;` |
|    15991 |  880 | `	int bDisallowed = 0;` |
|    15991 |  881 | `	if( GenStateIsDisallowedPropertyAtom(nType,pTypeClass,&zBad,&nBad) ){` |
|        5 |  882 | `		bDisallowed = 1;` |
|    15989 |  883 | `	}else if( pUnionAlts ){` |
|        - |  884 | `		sxu32 i;` |
...
|       34 |  891 | `		}` |
|       15 |  892 | `	}` |
|    15991 |  893 | `	if( !bDisallowed ){` |
|    15985 |  894 | `		return SXRET_OK;` |
|        - |  895 | `	}` |
...
|        - |  918 | ` */` |
| 23498814 |  919 | `PH7_PRIVATE int GenStateIsReadonly(SyToken *pTok)` |
|        5 |  920 | `{` |
| 23724603 |  921 | `	return (pTok->nType & PH7_TK_ID)` |
| 11975191 |  922 | `		&& pTok->sData.nByte == sizeof("readonly")-1` |
| 23724598 |  923 | `		&& SyStrnicmp(pTok->sData.zString,"readonly",sizeof("readonly")-1) == 0;` |
|        5 |  924 | `}` |
|        - |  925 | `/*` |
...
|        - |  930 | ` */` |
|  8438064 |  931 | `PH7_PRIVATE sxi32 GenStatePeekSetVisibility(SyToken *pTok,SyToken *pEnd,int *pnTok)` |
|        5 |  932 | `{` |
|  8438069 |  933 | `	*pnTok = 0;` |
|  8438064 |  934 | `	if( &pTok[3] < pEnd` |
|  7888753 |  935 | `	 && (pTok->nType & PH7_TK_KEYWORD)` |
|  6433602 |  936 | `	 && (pTok[1].nType & PH7_TK_LPAREN)` |
|  2763889 |  937 | `	 && (pTok[2].nType & (PH7_TK_ID\|PH7_TK_KEYWORD))` |
...
|        9 |  959 | `}` |
|   590268 |  960 | `static sxi32 GenStateCompileClassAttr(ph7_gen_state *pGen,sxi32 iProtection,sxi32 iFlags,ph7_class *pClass)` |
|        5 |  961 | `{` |
|   590273 |  962 | `	sxu32 nLine = pGen->pIn->nLine;` |
|        - |  963 | `	ph7_class_attr *pAttr;` |
|        - |  964 | `	SyString *pName;` |
|        - |  965 | `	sxi32 rc;` |
|   590273 |  966 | `	sxu32 nType = 0;` |
|        - |  967 | `	SyString sTypeClass;` |
|        - |  968 | `	SyString sTypeText;` |
|        - |  969 | `	SySet aUnionAlts;` |
|   590273 |  970 | `	sxi32 iTypeFlags = 0;` |
|   590273 |  971 | `	SyStringInitFromBuf(&sTypeClass,0,0);` |
|   590273 |  972 | `	SyStringInitFromBuf(&sTypeText,0,0);` |
|   590273 |  973 | `	SySetInit(&aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
...
|   590273 |  977 | `	if( pClass->iFlags & PH7_CLASS_READONLY ){` |
|       21 |  978 | `		iFlags \|= PH7_CLASS_ATTR_READONLY;` |
|        9 |  979 | `	}` |
|        - |  980 | `	/* Extract visibility level */` |
|   590273 |  981 | `	iProtection = GetProtectionLevel(iProtection);` |
|        - |  982 | `	/* Parse optional type hint (typed properties, PHP 7.4+) */` |
|   598208 |  983 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
|    15875 |  984 | `		rc = GenStateParsePropertyType(pGen,&nType,&sTypeClass,&iTypeFlags,&sTypeText,&aUnionAlts);` |
|    15875 |  985 | `		if( rc == SXERR_CORRUPT ){` |
|        - |  986 | `			/* Error already reported by GenStateParseUnionTypeDecl */` |
|      ! 0 |  987 | `			goto Synchronize;` |
|    15875 |  988 | `		}else if( rc == SXERR_SYNTAX ){` |
...
|    15875 |  996 | `		}else if( rc == SXERR_ABORT ){` |
|      ! 0 |  997 | `			return SXERR_ABORT;` |
|        - |  998 | `		}` |
|     7935 |  999 | `	}` |
|      ! 0 | 1000 | `loop:` |
|   590277 | 1001 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
...
|        - | 1007 | `	}` |
|   590277 | 1008 | `	pGen->pIn++; /* Jump the dollar sign */` |
|   590277 | 1009 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_ID)) == 0 ){` |
...
|   590277 | 1019 | `	pName = &pGen->pIn->sData;` |
|        - | 1020 | `	/* Advance the stream cursor */` |
|   590277 | 1021 | `	pGen->pIn++;` |
|   590277 | 1022 | `	if(pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_EQUAL/*'='*/\|PH7_TK_SEMI/*';'*/\|PH7_TK_COMMA/*','*/\|PH7_TK_OCB/*'{' hooks*/)) == 0 ){` |
...
|   590275 | 1034 | `	if( iFlags & (PH7_CLASS_ATTR_PRIVATE_SET\|PH7_CLASS_ATTR_PROTECTED_SET\|PH7_CLASS_ATTR_PUBLIC_SET) ){` |
...
|   590275 | 1054 | `	if( iFlags & PH7_CLASS_ATTR_READONLY ){` |
...
|   590265 | 1074 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|    23807 | 1075 | `		rc = GenStateValidateMemberType(pGen,pClass,pName,nType,&sTypeClass,` |
|        - | 1076 | `			&sTypeText,` |
|    15868 | 1077 | `			(iTypeFlags & PH7_CLASS_ATTR_UNION) ? &aUnionAlts : 0,` |
|     7934 | 1078 | `			"Property %z::$%z cannot have type %z",nLine);` |
|    15873 | 1079 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 | 1080 | `			return SXERR_ABORT;` |
|    15873 | 1081 | `		}else if( rc != SXRET_OK ){` |
...
|   590260 | 1088 | `	if( GenStateExtractProperty(pClass,pName->zString,pName->nByte) == 0` |
|   590264 | 1089 | `	 && GenStateExtractConstant(pClass,pName) != 0 ){` |
...
|        - | 1097 | `	}` |
|   590265 | 1098 | `	if( GenStateExtractProperty(pClass,pName->zString,pName->nByte) != 0 ){` |
...
|   590263 | 1113 | `	if( (pGen->pIn->nType & PH7_TK_EQUAL /*'='*/) && PH7_GenStateInitHasCallExpr(pGen) ){` |
...
|        - | 1120 | `	}` |
|   590263 | 1121 | `	if( (pGen->pIn->nType & PH7_TK_EQUAL /*'='*/) && GenStateInitHasNewExpr(pGen) ){` |
...
|   590259 | 1130 | `	pAttr = PH7_NewClassAttr(pGen->pVm,pName,nLine,iProtection,iFlags\|iTypeFlags);` |
|   590259 | 1131 | `	if( pAttr ){` |
|   590259 | 1132 | `		GenStateConsumeDoc(&(*pGen),&pAttr->sDoc);` |
|   590259 | 1133 | `		if( GenStateConsumeAttrs(&(*pGen),&pAttr->aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 1134 | `			return SXERR_ABORT;` |
|        - | 1135 | `		}` |
|   295127 | 1136 | `	}` |
|   590259 | 1137 | `	if( pAttr == 0 ){` |
|      ! 0 | 1138 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 engine is running out of memory");` |
|      ! 0 | 1139 | `		return SXERR_ABORT;` |
|        - | 1140 | `	}` |
|   590259 | 1141 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|    15871 | 1142 | `		GenStateCopyTypeToAttr(pAttr,nType,&sTypeClass,&sTypeText,iTypeFlags,&aUnionAlts);` |
|     7933 | 1143 | `	}` |
|   590259 | 1144 | `	if( pGen->pIn->nType & PH7_TK_EQUAL /*'='*/ ){` |
|        - | 1145 | `		SySet *pInstrContainer;` |
|   380631 | 1146 | `		SyToken *pSavedDefEnd = pGen->pEnd;` |
|   380631 | 1147 | `		pGen->pIn++; /*Jump the equal sign */` |
|        - | 1148 | `		{` |
...
|   380631 | 1153 | `			SyToken *pScan = pGen->pIn;` |
|   380631 | 1154 | `			sxi32 iNest = 0;` |
|   839383 | 1155 | `			while( pScan < pGen->pEnd ){` |
|   839383 | 1156 | `				if( pScan->nType & (PH7_TK_LPAREN\|PH7_TK_OSB) ){` |
|    50481 | 1157 | `					iNest++;` |
|   814145 | 1158 | `				}else if( pScan->nType & (PH7_TK_RPAREN\|PH7_TK_CSB) ){` |
|    50481 | 1159 | `					iNest--;` |
|   763669 | 1160 | `				}else if( iNest <= 0 && (pScan->nType & (PH7_TK_SEMI\|PH7_TK_COMMA\|PH7_TK_OCB)) ){` |
|   380631 | 1161 | `					break;` |
|        - | 1162 | `				}` |
|   458757 | 1163 | `				pScan++;` |
|        5 | 1164 | `			}` |
|   380631 | 1165 | `			pGen->pEnd = pScan;` |
|        - | 1166 | `		}` |
|        - | 1167 | `		/* Swap bytecode container */` |
|   380631 | 1168 | `		pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   380631 | 1169 | `		PH7_VmSetByteCodeContainer(pGen->pVm,&pAttr->aByteCode);` |
|        - | 1170 | `		/* Compile attribute value.` |
|        - | 1171 | `		 */` |
|   380631 | 1172 | `		rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|   380631 | 1173 | `		if( rc == SXERR_EMPTY ){` |
...
|   380631 | 1180 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|   380631 | 1181 | `		PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|   380631 | 1182 | `		pGen->pIn = pGen->pEnd;   /* land exactly on the delimiter */` |
|   380631 | 1183 | `		pGen->pEnd = pSavedDefEnd;` |
|   190313 | 1184 | `	}` |
|        - | 1185 | `	/* All done,install the attribute */` |
|   590259 | 1186 | `	rc = PH7_ClassInstallAttr(pClass,pAttr);` |
|   590259 | 1187 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 1188 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 1189 | `		return SXERR_ABORT;` |
|        - | 1190 | `	}` |
|   590259 | 1191 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) ){` |
...
|        - | 1203 | `	}` |
|   590165 | 1204 | `	if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
...
|        - | 1215 | `	}` |
|   590165 | 1216 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA /*','*/) ){` |
...
|        - | 1234 | `		}` |
|      ! 0 | 1235 | `	}` |
|   590161 | 1236 | `	SySetRelease(&aUnionAlts);` |
|   590161 | 1237 | `	return SXRET_OK;` |
|        9 | 1238 | `Synchronize:` |
...
|        - | 1253 | ` */` |
|  2893390 | 1254 | `static sxi32 GenStateCompileClassMethod(` |
...
|        - | 1260 | `	)` |
|        5 | 1261 | `{` |
|  2893395 | 1262 | `	sxu32 nLine = pGen->pIn->nLine;` |
|  2893395 | 1263 | `	sxu32 nKwLine = nLine; /* Line of the 'function' keyword (Reflection getStartLine) */` |
...
|  2893395 | 1270 | `	iProtection = GetProtectionLevel(iProtection);` |
|  2893395 | 1271 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|  2893395 | 1272 | `	iFuncFlags = 0;` |
|  2893395 | 1273 | `	if( pGen->pIn >= pGen->pEnd ){` |
...
|        - | 1281 | `	}` |
|  2893395 | 1282 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|        - | 1283 | `		/* Return by reference,remember that */` |
|      ! 0 | 1284 | `		iFuncFlags \|= VM_FUNC_REF_RETURN;` |
|        - | 1285 | `		/* Jump the '&' token */` |
|      ! 0 | 1286 | `		pGen->pIn++;` |
|      ! 0 | 1287 | `	}` |
|  2893395 | 1288 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|  2893395 | 1297 | `	pName = &pGen->pIn->sData;` |
|  2893395 | 1298 | `	nLine = pGen->pIn->nLine;` |
|        - | 1299 | `	/* Jump the method name */` |
|  2893395 | 1300 | `	pGen->pIn++;` |
|  2893395 | 1301 | `	if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|        - | 1302 | `		/* Abstract method */` |
|   139617 | 1303 | `		if( iProtection == PH7_CLASS_PROT_PRIVATE ){` |
...
|   139617 | 1312 | `		doBody = FALSE;` |
|    69806 | 1313 | `	}` |
|  2893395 | 1314 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|        - | 1315 | `		/* Syntax error */` |
...
|  2893395 | 1324 | `	pMeth = PH7_NewClassMethod(pGen->pVm,pClass,pName,nLine,iProtection,iFlags,iFuncFlags);` |
|  2893395 | 1325 | `	if( pMeth == 0 ){` |
|      ! 0 | 1326 | `		PH7_GenCompileError(&(*pGen),E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 1327 | `		return SXERR_ABORT;` |
|        - | 1328 | `	}` |
|  2893395 | 1329 | `	pMeth->sFunc.nLine = nKwLine;` |
|  2893395 | 1330 | `	GenStateConsumeDoc(&(*pGen),&pMeth->sFunc.sDoc);` |
|  2893395 | 1331 | `	if( GenStateConsumeAttrs(&(*pGen),&pMeth->sFunc.aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 1332 | `		return SXERR_ABORT;` |
|        - | 1333 | `	}` |
|        - | 1334 | `	/* Jump the left parenthesis '(' */` |
|  2893395 | 1335 | `	pGen->pIn++;` |
|  2893395 | 1336 | `	pEnd = 0; /* cc warning */` |
|        - | 1337 | `	/* Delimit the method signature */` |
|  2893395 | 1338 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|  2893395 | 1339 | `	if( pEnd >= pGen->pEnd ){` |
|        - | 1340 | `		/* Syntax error */` |
...
|        - | 1347 | `	}` |
|        - | 1348 | `	{` |
|  2893393 | 1349 | `		int bIsCtor = 0;` |
|  2893393 | 1350 | `		int bAbstractCtor = 0;` |
|  2893388 | 1351 | `		if( (pName->nByte == sizeof("__construct") - 1` |
|  1698805 | 1352 | `				&& SyMemcmp(pName->zString,"__construct",sizeof("__construct") - 1) == 0)` |
|  2790566 | 1353 | `		 \|\| SyStringCmp(pName,&pClass->sName,SyMemcmp) == 0 ){` |
|   205659 | 1354 | `			if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|        3 | 1355 | `				bAbstractCtor = 1;` |
|        2 | 1356 | `			}else{` |
|   205657 | 1357 | `				bIsCtor = 1;` |
|        - | 1358 | `			}` |
|   102827 | 1359 | `		}` |
|  2893393 | 1360 | `		if( pGen->pIn < pEnd ){` |
|        - | 1361 | `			/* Collect method arguments */` |
|  1113157 | 1362 | `			rc = GenStateCollectFuncArgs(&pMeth->sFunc,&(*pGen),pEnd,bIsCtor,bAbstractCtor);` |
|  1113157 | 1363 | `			if( rc == SXERR_ABORT ){` |
|      ! 0 | 1364 | `				return SXERR_ABORT;` |
|        - | 1365 | `			}` |
|   556576 | 1366 | `		}` |
|        - | 1367 | `	}` |
|        - | 1368 | `	/* Point past ')' and parse optional return type ': type' */` |
|  2893393 | 1369 | `	pGen->pIn = &pEnd[1];` |
|        - | 1370 | `	{` |
|  2893393 | 1371 | `		sxi32 rcRt = GenStateParseReturnType(pGen, &pMeth->sFunc);` |
|  2893393 | 1372 | `		if( rcRt == SXERR_ABORT ){` |
|      ! 0 | 1373 | `			return SXERR_ABORT;` |
|  2893393 | 1374 | `		}else if( rcRt == SXERR_SYNTAX ){` |
...
|        - | 1381 | `	{` |
|  2893393 | 1382 | `		sxu32 nArg = SySetUsed(&pMeth->sFunc.aArgs);` |
|        - | 1383 | `		sxu32 i;` |
|  4557131 | 1384 | `		for( i = 0; i < nArg; i++ ){` |
|  1663753 | 1385 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pMeth->sFunc.aArgs,i);` |
|        - | 1386 | `			ph7_class_attr *pAttr;` |
|  1663753 | 1387 | `			sxi32 iAttrFlags = 0;` |
|        - | 1388 | `			int bArgTyped;` |
|  1663753 | 1389 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|  1663667 | 1390 | `				continue;` |
|        - | 1391 | `			}` |
...
|       43 | 1486 | `		}` |
|        - | 1487 | `	}` |
|  2893383 | 1488 | `	if( doBody ){` |
|        - | 1489 | `		/* Compile method body */` |
|  2753771 | 1490 | `		rc = GenStateCompileFuncBody(&(*pGen),&pMeth->sFunc);` |
|  2753771 | 1491 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 | 1492 | `			return SXERR_ABORT;` |
|        - | 1493 | `		}` |
|        - | 1494 | `		/* The cursor sits just past the body's closing brace */` |
|  2753771 | 1495 | `		pMeth->sFunc.nEndLine = pGen->pIn[-1].nLine;` |
|  1376888 | 1496 | `	}else{` |
|        - | 1497 | `		/* Abstract/interface method: declaration ends at the ';' */` |
|   139617 | 1498 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI /* ';'*/) ){` |
|   139617 | 1499 | `			pMeth->sFunc.nEndLine = pGen->pIn->nLine;` |
|    69806 | 1500 | `		}` |
|        - | 1501 | `		/* Only method signature is allowed */` |
|   139617 | 1502 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI /* ';'*/) == 0 ){` |
...
|  2893378 | 1517 | `	if( (pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT)` |
|  1516500 | 1518 | `	 && (pClass->iFlags & (PH7_CLASS_ABSTRACT\|PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT)) == 0 ){` |
...
|  2893381 | 1531 | `	if( PH7_ClassExtractMethod(pClass,pName->zString,pName->nByte) != 0 ){` |
...
|  2893377 | 1540 | `	rc = PH7_ClassInstallMethod(pClass,pMeth);` |
|  2893377 | 1541 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 1542 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 1543 | `		return SXERR_ABORT;` |
|        - | 1544 | `	}` |
|  2893377 | 1545 | `	return SXRET_OK;` |
|        6 | 1546 | `Synchronize:` |
...
|        - | 2001 | ` */` |
|    69900 | 2002 | `PH7_PRIVATE sxi32 PH7_CompileClassInterface(ph7_gen_state *pGen)` |
|        5 | 2003 | `{` |
|    69905 | 2004 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|    69905 | 2013 | `	pName = &pGen->pIn->sData;` |
|        - | 2014 | `	/* Advance the stream cursor */` |
|    69905 | 2015 | `	pGen->pIn++;` |
|        - | 2016 | `	/* Build FQN and obtain a raw class */ {` |
|        - | 2017 | `		SyBlob sFQN;` |
|        - | 2018 | `		SyString sFQNStr;` |
|    69905 | 2019 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|    69905 | 2020 | `		GenStateBuildFQN(pGen,pName,&sFQN);` |
|    69905 | 2021 | `		SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|    69905 | 2022 | `		pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|    69905 | 2023 | `		SyBlobRelease(&sFQN);` |
|        - | 2024 | `	}` |
|    69905 | 2025 | `	if( pClass == 0 ){` |
|      ! 0 | 2026 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2027 | `		return SXERR_ABORT;` |
|        - | 2028 | `	}` |
|    69905 | 2029 | `	GenStateConsumeDoc(&(*pGen),&pClass->sDoc);` |
|    69905 | 2030 | `	if( GenStateConsumeAttrs(&(*pGen),&pClass->aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 2031 | `		return SXERR_ABORT;` |
|        - | 2032 | `	}` |
|        - | 2033 | `	/* Mark as an interface (PH7_NewRawClass may have set INTERNAL) */` |
|    69905 | 2034 | `	pClass->iFlags \|= PH7_CLASS_INTERFACE;` |
|        - | 2035 | `	/* Assume no base class is given */` |
|    69905 | 2036 | `	pBase = 0;` |
|    69905 | 2037 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|    27151 | 2038 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    27151 | 2039 | `		if( nKwrd == PH7_TKWRD_EXTENDS /* interface b extends a, c, … */ ){` |
...
|    27153 | 2050 | `				nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|    27153 | 2051 | `				SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|    27153 | 2052 | `				if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|        - | 2062 | `				}` |
|    40727 | 2063 | `				pParent = PH7_VmExtractClass(pGen->pVm,` |
|    27148 | 2064 | `					(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|    27153 | 2065 | `				SyStringInitFromBuf(&sBaseName,` |
|        - | 2066 | `					(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|        - | 2067 | `				/* Only interfaces is allowed */` |
|    27153 | 2068 | `				while( pParent && (pParent->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|      ! 0 | 2069 | `					pParent = pParent->pNextName;` |
|      ! 0 | 2070 | `				}` |
|    27153 | 2071 | `				if( pParent == 0 ){` |
...
|      ! 0 | 2077 | `					}` |
|    27153 | 2078 | `				}else if( pBase == 0 ){` |
|        - | 2079 | `					/* First parent → single-inheritance base */` |
|    27151 | 2080 | `					pBase = pParent;` |
|    13578 | 2081 | `				}else{` |
...
|        - | 2085 | `				}` |
|    27153 | 2086 | `				SyBlobRelease(&sResolved);` |
|        - | 2087 | `				/* Continue on a comma-separated list */` |
|    27153 | 2088 | `				if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA) ){` |
|        3 | 2089 | `					pGen->pIn++;` |
|        3 | 2090 | `					continue;` |
|        - | 2091 | `				}` |
|    27151 | 2092 | `				break;` |
...
|    13573 | 2094 | `		}` |
|    13573 | 2095 | `	}` |
|    69905 | 2096 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|        - | 2097 | `		/* Syntax error */` |
...
|        - | 2105 | `	}` |
|    69905 | 2106 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|    69905 | 2107 | `	pEnd = 0; /* cc warning */` |
|        - | 2108 | `	/* Delimit the interface body */` |
|    69905 | 2109 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|    69905 | 2110 | `	if( pEnd >= pGen->pEnd ){` |
|        - | 2111 | `		/* Syntax error */` |
...
|    69905 | 2121 | `	pClass->nEndLine = pEnd->nLine;` |
|        - | 2122 | `	/* Swap token stream */` |
|    69905 | 2123 | `	pTmp = pGen->pEnd;` |
|    69905 | 2124 | `	pGen->pEnd = pEnd;` |
...
|   442137 | 2132 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|   186119 | 2133 | `			pGen->pIn++;` |
|        5 | 2134 | `		}` |
|   256023 | 2135 | `		if( pGen->pIn >= pGen->pEnd ){` |
|        - | 2136 | `			/* End of interface body */` |
|    69901 | 2137 | `			break;` |
|        - | 2138 | `		}` |
|        - | 2139 | `		/* Bind a directly-preceding docblock to this member */` |
|   186127 | 2140 | `		GenStateSetPendingDoc(&(*pGen));` |
|   186127 | 2141 | `		if( (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|   186127 | 2152 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   186127 | 2153 | `		if( nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
...
|        3 | 2182 | `			goto done;` |
|        - | 2183 | `		}` |
|   186125 | 2184 | `		if( nKwrd != PH7_TKWRD_PUBLIC && nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|      ! 0 | 2191 | `			goto done;` |
|        - | 2192 | `		}` |
|   186125 | 2193 | `		if( nKwrd == PH7_TKWRD_PUBLIC ){` |
|        - | 2194 | `			/* Advance the stream cursor */` |
|   131843 | 2195 | `			pGen->pIn++;` |
|   131838 | 2196 | `			if( pGen->pIn < pGen->pEnd` |
|   131843 | 2197 | `			 && ((pGen->pIn->nType & PH7_TK_DOLLAR) != 0` |
|   131838 | 2198 | `			  \|\| (pGen->pIn->sData.nByte == 1 && pGen->pIn->sData.zString[0] == '?')) ){` |
...
|      ! 0 | 2212 | `				continue;` |
|        - | 2213 | `			}` |
|   131843 | 2214 | `			if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|      ! 0 | 2236 | `				goto done;` |
|        - | 2237 | `			}` |
|   131843 | 2238 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   131843 | 2239 | `			if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|        - | 2261 | `			}` |
|    65917 | 2262 | `		}` |
|   186121 | 2263 | `		if( nKwrd == PH7_TKWRD_CONST ){` |
|        - | 2264 | `			/* Parse constant */` |
|    54283 | 2265 | `			rc = GenStateCompileClassConstant(&(*pGen),0,0,pClass);` |
|    54283 | 2266 | `			if( rc != SXRET_OK ){` |
...
|        - | 2271 | `			}` |
|    27143 | 2272 | `		}else{` |
|   131843 | 2273 | `			sxi32 iFlags = PH7_CLASS_ATTR_ABSTRACT; /* Interface methods are implicitly abstract */` |
|   131843 | 2274 | `			if( nKwrd == PH7_TKWRD_STATIC ){` |
|        - | 2275 | `				/* Static method,record that */` |
|    11633 | 2276 | `				iFlags \|= PH7_CLASS_ATTR_STATIC;` |
|        - | 2277 | `				/* Advance the stream cursor */` |
|    11633 | 2278 | `				pGen->pIn++;` |
|    11628 | 2279 | `				if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0` |
|    11633 | 2280 | `					\|\| SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_FUNCTION ){` |
...
|   131843 | 2291 | `			rc = GenStateCompileClassMethod(&(*pGen),0,iFlags,FALSE,pClass);` |
|   131843 | 2292 | `			if( rc != SXRET_OK ){` |
...
|    69901 | 2301 | `	if( GenStateGuardClassRedeclaration(pGen,pClass) == SXERR_ABORT ){` |
|        3 | 2302 | `		return SXERR_ABORT;` |
|        - | 2303 | `	}` |
|        - | 2304 | `	/* Install the interface */` |
|    69899 | 2305 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|    69899 | 2306 | `	if( rc == SXRET_OK && pBase ){` |
|        - | 2307 | `		/* Inherit from the base interface */` |
|    27151 | 2308 | `		rc = PH7_ClassInterfaceInherit(pClass,pBase);` |
|    13573 | 2309 | `	}` |
|    69899 | 2310 | `	if( rc != SXRET_OK ){` |
...
|    69903 | 2316 | `	pGen->pIn  = &pEnd[1];` |
|    69903 | 2317 | `	pGen->pEnd = pTmp;` |
|    69903 | 2318 | `	return PH7_OK;` |
|    34955 | 2319 | `}` |
|        - | 2320 | `/*` |
...
|        - | 2344 | ` */` |
|   451582 | 2345 | `static sxi32 GenStateCheckInterfaceSignatures(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 | 2346 | `{` |
|        - | 2347 | `	ph7_class **apIface;` |
|        - | 2348 | `	sxu32 nIface,i;` |
|        - | 2349 | `	sxi32 rc;` |
|   451587 | 2350 | `	if( pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|      ! 0 | 2351 | `		return SXRET_OK;` |
|        - | 2352 | `	}` |
|   451587 | 2353 | `	apIface = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|   451587 | 2354 | `	nIface = SySetUsed(&pClass->aInterface);` |
|   874431 | 2355 | `	for(i = 0; i < nIface; i++){` |
|   422849 | 2356 | `		ph7_class *pIface = apIface[i];` |
|        - | 2357 | `		SyHashEntry *pEntry;` |
|   422849 | 2358 | `		SyHashResetLoopCursor(&pIface->hMethod);` |
|  1245169 | 2359 | `		while((pEntry = SyHashGetNextEntry(&pIface->hMethod)) != 0 ){` |
|   822325 | 2360 | `			ph7_class_method *pIfaceMeth = (ph7_class_method *)pEntry->pUserData;` |
|        - | 2361 | `			ph7_class_method *pImplMeth;` |
|   822325 | 2362 | `			SyString *pMName = &pIfaceMeth->sFunc.sName;` |
|        - | 2363 | `			/* Find the implementing method in the class */` |
|   822325 | 2364 | `			pImplMeth = PH7_ClassExtractMethod(pClass,pMName->zString,pMName->nByte);` |
|   822325 | 2365 | `			if( pImplMeth == 0 \|\| (pImplMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT) ){` |
...
|   822307 | 2369 | `			if( pImplMeth->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|        - | 2379 | `			 */` |
|        - | 2380 | `			{` |
|   822307 | 2381 | `				sxu32 nIfaceArgs = SySetUsed(&pIfaceMeth->sFunc.aArgs);` |
|   822307 | 2382 | `				sxu32 nImplArgs = SySetUsed(&pImplMeth->sFunc.aArgs);` |
|   822307 | 2383 | `				int sigError = 0;` |
|   822307 | 2384 | `				if( nImplArgs < nIfaceArgs ){` |
|        3 | 2385 | `					sigError = 1;` |
|   822306 | 2386 | `				}else if( nImplArgs > nIfaceArgs ){` |
|        - | 2387 | `					/* Extra parameters must all have default values */` |
|     3885 | 2388 | `					ph7_vm_func_arg *aImplArgs = (ph7_vm_func_arg *)SySetBasePtr(&pImplMeth->sFunc.aArgs);` |
|        - | 2389 | `					sxu32 k;` |
|     7763 | 2390 | `					for(k = nIfaceArgs; k < nImplArgs; k++){` |
|     3885 | 2391 | `						if( SySetUsed(&aImplArgs[k].aByteCode) == 0 ){` |
|        3 | 2392 | `							sigError = 1;` |
|        3 | 2393 | `							break;` |
|        - | 2394 | `						}` |
|     1944 | 2395 | `					}` |
|     1940 | 2396 | `				}` |
|   822307 | 2397 | `				if( sigError ){` |
...
|        - | 2477 | ` */` |
|   451582 | 2478 | `static sxi32 GenStateCheckAbstractMethods(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 | 2479 | `{` |
...
|   451587 | 2486 | `	if( pClass->iFlags & (PH7_CLASS_ABSTRACT\|PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|    19437 | 2487 | `		return SXRET_OK;` |
|        - | 2488 | `	}` |
|        - | 2489 | `	/* Count abstract methods */` |
|   432155 | 2490 | `	nAbstract = 0;` |
|   432155 | 2491 | `	SyHashResetLoopCursor(&pClass->hMethod);` |
|  6457318 | 2492 | `	while((pEntry = SyHashGetNextEntry(&pClass->hMethod)) != 0 ){` |
|  5809093 | 2493 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|  5809093 | 2494 | `		if( pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
...
|        8 | 2499 | `		}` |
|        5 | 2500 | `	}` |
|   432155 | 2501 | `	if( nAbstract == 0 ){` |
|   432141 | 2502 | `		return SXRET_OK;` |
|        - | 2503 | `	}` |
...
|        - | 2640 | ` */` |
|   514014 | 2641 | `PH7_PRIVATE sxi32 GenStateParseClassReference(ph7_gen_state *pGen,SyBlob *pFqn)` |
|        5 | 2642 | `{` |
|   514019 | 2643 | `	int isAbsolute = 0;` |
|   514019 | 2644 | `	SyToken *pStart = pGen->pIn;` |
|        - | 2645 | `	SyBlob sName;` |
|   514019 | 2646 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) ){` |
|     4535 | 2647 | `		isAbsolute = 1;` |
|     4535 | 2648 | `		pGen->pIn++;` |
|     2265 | 2649 | `	}` |
|   514019 | 2650 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|        9 | 2651 | `		pGen->pIn = pStart;` |
|        9 | 2652 | `		return SXERR_INVALID;` |
|        - | 2653 | `	}` |
|   514013 | 2654 | `	SyBlobInit(&sName,&pGen->pVm->sAllocator);` |
|   514013 | 2655 | `	SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|   514013 | 2656 | `	pGen->pIn++;` |
|   771051 | 2657 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) &&` |
|   257048 | 2658 | `		&pGen->pIn[1] < pGen->pEnd && (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|       28 | 2659 | `		SyBlobAppend(&sName,"\\",1);` |
|       28 | 2660 | `		pGen->pIn++;` |
|       28 | 2661 | `		SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|       28 | 2662 | `		pGen->pIn++;` |
|        2 | 2663 | `	}` |
|   514013 | 2664 | `	if( isAbsolute ){` |
|     4533 | 2665 | `		SyBlobAppend(pFqn,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|     2269 | 2666 | `	}else{` |
|        - | 2667 | `		SyString sRaw;` |
|   509485 | 2668 | `		SyStringInitFromBuf(&sRaw,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|   509485 | 2669 | `		GenStateResolveName(pGen,&sRaw,pFqn);` |
|        - | 2670 | `	}` |
|   514013 | 2671 | `	SyBlobRelease(&sName);` |
|   514013 | 2672 | `	return SXRET_OK;` |
|   257012 | 2673 | `}` |
|        - | 2674 | `/*` |
...
|   197892 | 2682 | `static int GenStateInterfaceIsThrowableAt(ph7_class *pInterface,int iDepth)` |
|        5 | 2683 | `{` |
|        - | 2684 | `	ph7_class **apParent;` |
|        - | 2685 | `	sxu32 n;` |
|   523739 | 2686 | `	while( pInterface ){` |
|   333609 | 2687 | `		if( iDepth > PH7_THROWABLE_WALK_MAX_DEPTH ){` |
|      ! 0 | 2688 | `			return FALSE;` |
|        - | 2689 | `		}` |
|   372389 | 2690 | `		if( pInterface->sName.nByte == sizeof("Throwable")-1 &&` |
|    77560 | 2691 | `			SyMemcmp(pInterface->sName.zString,"Throwable",sizeof("Throwable")-1) == 0 ){` |
|     7767 | 2692 | `			return TRUE;` |
|        - | 2693 | `		}` |
|   325847 | 2694 | `		apParent = (ph7_class **)SySetBasePtr(&pInterface->aInterface);` |
|   325849 | 2695 | `		for( n = 0 ; n < SySetUsed(&pInterface->aInterface) ; ++n ){` |
|        3 | 2696 | `			if( GenStateInterfaceIsThrowableAt(apParent[n],iDepth+1) ){` |
|      ! 0 | 2697 | `				return TRUE;` |
|        - | 2698 | `			}` |
|        2 | 2699 | `		}` |
|   325847 | 2700 | `		pInterface = pInterface->pBase;` |
|   325847 | 2701 | `		iDepth++;` |
|        5 | 2702 | `	}` |
|   190135 | 2703 | `	return FALSE;` |
|    98951 | 2704 | `}` |
|   197890 | 2705 | `static int GenStateInterfaceIsThrowable(ph7_class *pInterface)` |
|        5 | 2706 | `{` |
|   197895 | 2707 | `	return GenStateInterfaceIsThrowableAt(pInterface,0);` |
|        5 | 2708 | `}` |
|        - | 2709 | `/*` |
...
|        - | 2713 | ` */` |
|     7762 | 2714 | `static int GenStateClassIsExceptionOrError(ph7_class *pBase)` |
|        5 | 2715 | `{` |
|     7771 | 2716 | `	while( pBase ){` |
...
|        - | 2737 | ` */` |
|     7806 | 2738 | `static sxi32 GenStateCompileEnumCase(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 | 2739 | `{` |
|     7811 | 2740 | `	sxu32 nLine = pGen->pIn->nLine;` |
|        - | 2741 | `	SySet *pInstrContainer;` |
|        - | 2742 | `	ph7_class_attr *pCase;` |
|        - | 2743 | `	SyString *pName;` |
|        - | 2744 | `	sxi32 rc;` |
|     7811 | 2745 | `	pGen->pIn++; /* Jump the 'case' keyword */` |
|     7811 | 2746 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|        - | 2753 | `	}` |
|     7811 | 2754 | `	pName = &pGen->pIn->sData;` |
|        - | 2755 | `	/* Cases share the class-constant namespace (php: "Cannot redefine class constant") */` |
|     7811 | 2756 | `	if( SyHashGet(&pClass->hAttr,(const void *)pName->zString,pName->nByte) != 0 ){` |
...
|        - | 2763 | `	}` |
|     7811 | 2764 | `	pCase = PH7_NewClassAttr(pGen->pVm,pName,pGen->pIn->nLine,PH7_CLASS_PROT_PUBLIC,` |
|        - | 2765 | `		PH7_CLASS_ATTR_CONSTANT\|PH7_CLASS_ATTR_ENUMCASE);` |
|     7811 | 2766 | `	if( pCase == 0 ){` |
|      ! 0 | 2767 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2768 | `		return SXERR_ABORT;` |
|        - | 2769 | `	}` |
|     7811 | 2770 | `	GenStateConsumeDoc(&(*pGen),&pCase->sDoc);` |
|     7811 | 2771 | `	if( GenStateConsumeAttrs(&(*pGen),&pCase->aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 2772 | `		return SXERR_ABORT;` |
|        - | 2773 | `	}` |
|     7811 | 2774 | `	pGen->pIn++; /* Jump the case name */` |
|     7811 | 2775 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_EQUAL /* '=' */) ){` |
|     7797 | 2776 | `		if( pClass->nEnumBacking == 0 ){` |
...
|        - | 2783 | `		}` |
|     7793 | 2784 | `		pGen->pIn++; /* Jump the equal sign */` |
|        - | 2785 | `		/* Compile the backing value expression into the case's own container` |
|        - | 2786 | `		 * (same technique as class constants). */` |
|     7793 | 2787 | `		pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|     7793 | 2788 | `		PH7_VmSetByteCodeContainer(pGen->pVm,&pCase->aByteCode);` |
|     7793 | 2789 | `		rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|     7793 | 2790 | `		if( rc == SXERR_EMPTY ){` |
|      ! 0 | 2791 | `			rc = PH7_GenCompileError(pGen,E_ERROR,nLine,` |
|      ! 0 | 2792 | `				"Empty value for enum case %z::%z",&pClass->sName,pName);` |
|      ! 0 | 2793 | `		}` |
|     7793 | 2794 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|     7793 | 2795 | `		PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|     7793 | 2796 | `		if( rc == SXERR_ABORT ){` |
...
|        - | 2807 | `		}` |
|        - | 2808 | `	}` |
|     7807 | 2809 | `	rc = PH7_ClassInstallAttr(pClass,pCase);` |
|     7807 | 2810 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 2811 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2812 | `		return SXERR_ABORT;` |
|        - | 2813 | `	}` |
|     7807 | 2814 | `	SySetPut(&pClass->aEnumCases,(const void *)&pCase);` |
|     7807 | 2815 | `	return SXRET_OK;` |
|        2 | 2816 | `Synchronize:` |
...
|        - | 2831 | ` */` |
|     3910 | 2832 | `static sxi32 GenStateCompileEnumMethods(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 | 2833 | `{` |
...
|     3915 | 2839 | `	sxi32 rc = SXRET_OK;` |
|     3915 | 2840 | `	nMax = 3*(sxu32)sizeof("function tryFrom(string $value){return __phl_enum_tryfrom('',$value);}")` |
|     3910 | 2841 | `		+ 3*SyStringLength(&pClass->sName) + 64;` |
|     3915 | 2842 | `	zSrc = (char *)SyMemBackendAlloc(&pGen->pVm->sAllocator,nMax);` |
|     3915 | 2843 | `	if( zSrc == 0 ){` |
|      ! 0 | 2844 | `		PH7_GenCompileError(pGen,E_ERROR,pClass->nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2845 | `		return SXERR_ABORT;` |
|        - | 2846 | `	}` |
|     3915 | 2847 | `	zBack = (pClass->nEnumBacking == MEMOBJ_INT) ? "int" : "string";` |
|     3915 | 2848 | `	if( pClass->nEnumBacking != 0 ){` |
|     5840 | 2849 | `		nSrc = SyBufferFormat(zSrc,nMax,` |
...
|     1945 | 2853 | `			&pClass->sName,zBack,&pClass->sName,zBack,&pClass->sName);` |
|     1950 | 2854 | `	}else{` |
|       33 | 2855 | `		nSrc = SyBufferFormat(zSrc,nMax,` |
|       10 | 2856 | `			"function cases(){return __phl_enum_cases('%z');}",&pClass->sName);` |
|        - | 2857 | `	}` |
|     3915 | 2858 | `	SySetInit(&sToken,&pGen->pVm->sAllocator,sizeof(SyToken));` |
|     3915 | 2859 | `	PH7_TokenizePHP(zSrc,nSrc,pClass->nLine,&sToken,0);` |
|     3915 | 2860 | `	pSaveIn = pGen->pIn;` |
|     3915 | 2861 | `	pSaveEnd = pGen->pEnd;` |
|     3915 | 2862 | `	pGen->pIn = (SyToken *)SySetBasePtr(&sToken);` |
|     3915 | 2863 | `	pGen->pEnd = &pGen->pIn[SySetUsed(&sToken)];` |
|    15605 | 2864 | `	while( pGen->pIn < pGen->pEnd && rc != SXERR_ABORT ){` |
|    11695 | 2865 | `		rc = GenStateCompileClassMethod(&(*pGen),PH7_TKWRD_PUBLIC,PH7_CLASS_ATTR_STATIC,TRUE,pClass);` |
|        5 | 2866 | `	}` |
|     3915 | 2867 | `	pGen->pIn = pSaveIn;` |
|     3915 | 2868 | `	pGen->pEnd = pSaveEnd;` |
|     3915 | 2869 | `	SySetRelease(&sToken);` |
|     3915 | 2870 | `	return (rc == SXERR_ABORT) ? SXERR_ABORT : SXRET_OK;` |
|     1960 | 2871 | `}` |
|        - | 2872 | `/*` |
...
|        - | 2886 | ` */` |
|     3910 | 2887 | `static sxi32 GenStateEnumFinalize(ph7_gen_state *pGen,ph7_class *pClass,sxu32 nLine)` |
|        5 | 2888 | `{` |
|        - | 2889 | `	SyHashEntry *pEntry;` |
|        - | 2890 | `	sxi32 rc;` |
|        - | 2891 | `	sxu32 n;` |
|        - | 2892 | `	/* php: "Enum %s cannot include properties" */` |
|     3915 | 2893 | `	SyHashResetLoopCursor(&pClass->hAttr);` |
|    11723 | 2894 | `	while( (pEntry = SyHashGetNextEntry(&pClass->hAttr)) != 0 ){` |
|     7815 | 2895 | `		ph7_class_attr *pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|     7815 | 2896 | `		if( (pAttr->iFlags & PH7_CLASS_ATTR_CONSTANT) == 0 ){` |
...
|    54745 | 2906 | `	for( n = 0 ; n < SX_ARRAYSIZE(azEnumBannedMagic) ; n++ ){` |
|    76245 | 2907 | `		if( SyHashGet(&pClass->hMethod,(const void *)azEnumBannedMagic[n],` |
|    50835 | 2908 | `			SyStrlen(azEnumBannedMagic[n])) != 0 ){` |
...
|     3915 | 2924 | `		pAttr = PH7_NewClassAttr(pGen->pVm,&sNameProp,nLine,PH7_CLASS_PROT_PUBLIC,` |
|        - | 2925 | `			PH7_CLASS_ATTR_READONLY\|PH7_CLASS_ATTR_TYPED);` |
|     3915 | 2926 | `		if( pAttr == 0 ){` |
|      ! 0 | 2927 | `			PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2928 | `			return SXERR_ABORT;` |
|        - | 2929 | `		}` |
|     3915 | 2930 | `		pAttr->nType = MEMOBJ_STRING;` |
|     3915 | 2931 | `		SyStringInitFromBuf(&pAttr->sTypeName,"string",sizeof("string")-1);` |
|     3915 | 2932 | `		PH7_ClassInstallAttr(pClass,pAttr);` |
|     3915 | 2933 | `		if( pClass->nEnumBacking != 0 ){` |
|     3895 | 2934 | `			pAttr = PH7_NewClassAttr(pGen->pVm,&sValueProp,nLine,PH7_CLASS_PROT_PUBLIC,` |
|        - | 2935 | `				PH7_CLASS_ATTR_READONLY\|PH7_CLASS_ATTR_TYPED);` |
|     3895 | 2936 | `			if( pAttr == 0 ){` |
|      ! 0 | 2937 | `				PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 2938 | `				return SXERR_ABORT;` |
|        - | 2939 | `			}` |
|     3895 | 2940 | `			pAttr->nType = pClass->nEnumBacking;` |
|     3895 | 2941 | `			if( pClass->nEnumBacking == MEMOBJ_INT ){` |
|        7 | 2942 | `				SyStringInitFromBuf(&pAttr->sTypeName,"int",sizeof("int")-1);` |
|        4 | 2943 | `			}else{` |
|     3889 | 2944 | `				SyStringInitFromBuf(&pAttr->sTypeName,"string",sizeof("string")-1);` |
|        - | 2945 | `			}` |
|     3895 | 2946 | `			PH7_ClassInstallAttr(pClass,pAttr);` |
|     1945 | 2947 | `		}` |
|        - | 2948 | `	}` |
|     3915 | 2949 | `	return GenStateCompileEnumMethods(&(*pGen),pClass);` |
|     1960 | 2950 | `}` |
|        - | 2951 | `/*` |
...
|        - | 2960 | ` */` |
|   451632 | 2961 | `static sxi32 GenStateCompileClassEx(ph7_gen_state *pGen,sxi32 iFlags,` |
|        - | 2962 | `	SyString *pAnonName,SyToken **ppArgStart,SyToken **ppArgEnd)` |
|        5 | 2963 | `{` |
|   451637 | 2964 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|   451637 | 2975 | `	pGen->pIn++;` |
|   451637 | 2976 | `	if( pAnonName ){` |
...
|       19 | 2991 | `	}else{` |
|   451607 | 2992 | `		if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
|        - | 2993 | `			/* Syntax error */` |
...
|   451607 | 3006 | `		pName = &pGen->pIn->sData;` |
|        - | 3007 | `		/* Advance the stream cursor */` |
|   451607 | 3008 | `		pGen->pIn++;` |
|        - | 3009 | `		/* Build FQN and obtain a raw class */ {` |
|        - | 3010 | `			SyBlob sFQN;` |
|        - | 3011 | `			SyString sFQNStr;` |
|   451607 | 3012 | `			SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|   451607 | 3013 | `			GenStateBuildFQN(pGen,pName,&sFQN);` |
|   451607 | 3014 | `			SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|   451607 | 3015 | `			pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|   451607 | 3016 | `			SyBlobRelease(&sFQN);` |
|        - | 3017 | `		}` |
|        - | 3018 | `	}` |
|   451637 | 3019 | `	if( pClass == 0 ){` |
|      ! 0 | 3020 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 3021 | `		return SXERR_ABORT;` |
|        - | 3022 | `	}` |
|   451632 | 3023 | `	if( (iFlags & PH7_CLASS_ENUM) && pGen->pIn < pGen->pEnd` |
|     3919 | 3024 | `		&& (pGen->pIn->nType & PH7_TK_COLON /* ':' */) ){` |
|        - | 3025 | ``		/* Backed enum: `enum Name: int\|string` (PHP 8.1) */`` |
|     3897 | 3026 | `		pGen->pIn++; /* Jump ':' */` |
|     3892 | 3027 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD)` |
|     3897 | 3028 | `			&& SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_INT ){` |
|        7 | 3029 | `			pClass->nEnumBacking = MEMOBJ_INT;` |
|        7 | 3030 | `			pGen->pIn++;` |
|     3890 | 3031 | `		}else if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD)` |
|     3891 | 3032 | `			&& SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_STRING ){` |
|     3889 | 3033 | `			pClass->nEnumBacking = MEMOBJ_STRING;` |
|     3889 | 3034 | `			pGen->pIn++;` |
|     1947 | 3035 | `		}else{` |
...
|        - | 3046 | `		}` |
|     1946 | 3047 | `	}` |
|   451637 | 3048 | `	GenStateConsumeDoc(&(*pGen),&pClass->sDoc);` |
|   451637 | 3049 | `	if( GenStateConsumeAttrs(&(*pGen),&pClass->aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 3050 | `		return SXERR_ABORT;` |
|        - | 3051 | `	}` |
|        - | 3052 | `	/* implemented interfaces and per-use-statement trait containers */` |
|   451637 | 3053 | `	SySetInit(&aInterfaces,&pGen->pVm->sAllocator,sizeof(ph7_class *));` |
|   451637 | 3054 | `	SySetInit(&aUseEntries,&pGen->pVm->sAllocator,sizeof(TraitUseEntry));` |
|        - | 3055 | `	/* Assume a standalone class */` |
|   451637 | 3056 | `	pBase = 0;` |
|   451637 | 3057 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|   368729 | 3058 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   368729 | 3059 | `		if( nKwrd == PH7_TKWRD_EXTENDS /* class b extends a */ ){` |
|        - | 3060 | `			SyBlob sResolved;` |
|        - | 3061 | `			SyString sBaseName;` |
|        - | 3062 | `			sxu32 nRefLine;` |
|   248389 | 3063 | `			if( iFlags & PH7_CLASS_ENUM ){` |
...
|        - | 3069 | `				}` |
|      ! 0 | 3070 | `			}` |
|   248389 | 3071 | `			pGen->pIn++; /* Advance past 'extends' */` |
|   248389 | 3072 | `			nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|   248389 | 3073 | `			SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|   248389 | 3074 | `			if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|        - | 3084 | `			}` |
|   372578 | 3085 | `			pBase = PH7_VmExtractClass(pGen->pVm,` |
|   248382 | 3086 | `				(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|   248387 | 3087 | `			SyStringInitFromBuf(&sBaseName,` |
|        - | 3088 | `				(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|        - | 3089 | `			/* Interfaces are not allowed */` |
|   248387 | 3090 | `			while( pBase && (pBase->iFlags & PH7_CLASS_INTERFACE) ){` |
|      ! 0 | 3091 | `				pBase = pBase->pNextName;` |
|      ! 0 | 3092 | `			}` |
|   248387 | 3093 | `			if( pBase == 0 ){` |
...
|        - | 3099 | `				}` |
|      ! 0 | 3100 | `			}else{` |
|   248387 | 3101 | `				if( pBase->iFlags & PH7_CLASS_ENUM ){` |
...
|   248386 | 3109 | `				}else if( pBase->iFlags & PH7_CLASS_FINAL ){` |
...
|      ! 0 | 3116 | `				}` |
|        - | 3117 | `			}` |
|   248387 | 3118 | `			SyBlobRelease(&sResolved);` |
|   248387 | 3119 | `			if( iFlags & PH7_CLASS_ENUM ){` |
|      ! 0 | 3120 | `				pBase = 0; /* Error already reported: enums have no base class */` |
|      ! 0 | 3121 | `			}` |
|   124191 | 3122 | `		}` |
|   368727 | 3123 | `		if (pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) && SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_IMPLEMENTS ){` |
|        - | 3124 | `			ph7_class *pInterface;` |
|        - | 3125 | `			/* Interface implementation */` |
|   135865 | 3126 | `			pGen->pIn++; /* Advance the stream cursor */` |
|   129960 | 3127 | `			for(;;){` |
|        - | 3128 | `				SyBlob sResolved;` |
|        - | 3129 | `				SyString sIntName;` |
|        - | 3130 | `				sxu32 nRefLine;` |
|   197895 | 3131 | `				nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|   197895 | 3132 | `				SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|   197895 | 3133 | `				if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|      ! 0 | 3141 | `					break;` |
|        - | 3142 | `				}` |
|   395785 | 3143 | `				pInterface = PH7_VmExtractClass(pGen->pVm,` |
|   197890 | 3144 | `					(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|   197895 | 3145 | `				SyStringInitFromBuf(&sIntName,` |
|        - | 3146 | `					(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|        - | 3147 | `				/* Only interfaces are allowed */` |
|   197895 | 3148 | `				while( pInterface && (pInterface->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|      ! 0 | 3149 | `					pInterface = pInterface->pNextName;` |
|      ! 0 | 3150 | `				}` |
|   197895 | 3151 | `				if( pInterface == 0 ){` |
...
|   197895 | 3165 | `					SyString *pFqn = &pClass->sName;` |
|   197895 | 3166 | `					int bIsExceptionOrError =` |
|   102825 | 3167 | `						(pFqn->nByte == sizeof("Exception")-1 &&` |
|   298777 | 3168 | `						 SyMemcmp(pFqn->zString,"Exception",sizeof("Exception")-1) == 0) \|\|` |
|   195959 | 3169 | `						(pFqn->nByte == sizeof("Error")-1 &&` |
|     3890 | 3170 | `						 SyMemcmp(pFqn->zString,"Error",sizeof("Error")-1) == 0);` |
|   201771 | 3171 | `					if( GenStateInterfaceIsThrowable(pInterface) &&` |
|    11646 | 3172 | `						!GenStateClassIsExceptionOrError(pBase) &&` |
|     3879 | 3173 | `						!bIsExceptionOrError ){` |
...
|        6 | 3183 | `					}else{` |
|   197889 | 3184 | `						SySetPut(&aInterfaces,(const void *)&pInterface);` |
|        - | 3185 | `					}` |
|        - | 3186 | `				}` |
|   197895 | 3187 | `				SyBlobRelease(&sResolved);` |
|   197895 | 3188 | `				if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COMMA) == 0 ){` |
|    67935 | 3189 | `					break;` |
|        - | 3190 | `				}` |
|    62035 | 3191 | `				pGen->pIn++;/* Jump the comma */` |
|        5 | 3192 | `			}` |
|    67930 | 3193 | `		}` |
|   184361 | 3194 | `	}` |
|   451635 | 3195 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|        - | 3196 | `		/* Syntax error */` |
...
|        - | 3204 | `	}` |
|   451635 | 3205 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|   451635 | 3206 | `	pEnd = 0; /* cc warning */` |
|        - | 3207 | `	/* Delimit the class body */` |
|   451635 | 3208 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|   451635 | 3209 | `	if( pEnd >= pGen->pEnd ){` |
|        - | 3210 | `		/* Syntax error */` |
...
|   451635 | 3220 | `	pClass->nEndLine = pEnd->nLine;` |
|        - | 3221 | `	/* Swap token stream */` |
|   451635 | 3222 | `	pTmp = pGen->pEnd;` |
|   451635 | 3223 | `	pGen->pEnd = pEnd;` |
|        - | 3224 | `	/* Merge the inherited flags (PH7_NewRawClass may have set INTERNAL) */` |
|   451635 | 3225 | `	pClass->iFlags \|= iFlags;` |
|        - | 3226 | `	/* Start the parse process */` |
|  1691865 | 3227 | `	for(;;){` |
|        - | 3228 | `		/* Jump leading/trailing semi-colons */` |
|  4859143 | 3229 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|   885045 | 3230 | `			pGen->pIn++;` |
|        5 | 3231 | `		}` |
|  3974103 | 3232 | `		if( pGen->pIn >= pGen->pEnd ){` |
|        - | 3233 | `			/* End of class body */` |
|   451593 | 3234 | `			break;` |
|        - | 3235 | `		}` |
|        - | 3236 | `		/* Bind a directly-preceding docblock to this member */` |
|  3522515 | 3237 | `		GenStateSetPendingDoc(&(*pGen));` |
|  3522510 | 3238 | `		if( (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR)) == 0` |
|  1761260 | 3239 | ``			&& !GenStateIsReadonly(pGen->pIn) /* allow a leading `readonly` modifier */ ){`` |
...
|  3522515 | 3250 | `		iProtection = PH7_TKWRD_PUBLIC;` |
|  3522515 | 3251 | `		iAttrflags = 0;` |
...
|  3522515 | 3256 | `		if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|      ! 0 | 3257 | `			int bMod = 0;` |
...
|        - | 3278 | `			}` |
|      ! 0 | 3279 | `		}` |
|  3522515 | 3280 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|        - | 3281 | `			/* Extract the current keyword */` |
|  3522515 | 3282 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  3522515 | 3283 | `			if( nKwrd == PH7_TKWRD_CASE && (pClass->iFlags & PH7_CLASS_ENUM) ){` |
|        - | 3284 | ``				/* Enum case declaration: `case NAME [= value];` */`` |
|     7811 | 3285 | `				rc = GenStateCompileEnumCase(&(*pGen),pClass);` |
|     7811 | 3286 | `				if( rc != SXRET_OK ){` |
...
|     7807 | 3292 | `				continue;` |
|        - | 3293 | `			}` |
|  3514709 | 3294 | `			if( nKwrd == PH7_TKWRD_USE ){` |
|        - | 3295 | `				/* Trait use: use TraitA, TraitB [{ ... }]; */` |
|        - | 3296 | `				TraitUseEntry sUse;` |
|    15599 | 3297 | `				SySetInit(&sUse.aTraits,&pGen->pVm->sAllocator,sizeof(ph7_class *));` |
|    15599 | 3298 | `				sUse.pResolvStart = sUse.pResolvEnd = 0;` |
|    15599 | 3299 | `				pGen->pIn++; /* Jump the 'use' keyword */` |
|     7805 | 3300 | `				for(;;){` |
|        - | 3301 | `					ph7_class *pTrait;` |
|        - | 3302 | `					SyBlob sResolved;` |
|        - | 3303 | `					SyString sTraitName;` |
|    15607 | 3304 | `					sxu32 nUseLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
...
|    15607 | 3311 | `					SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|    15607 | 3312 | `					if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|      ! 0 | 3319 | `						break;` |
|        - | 3320 | `					}` |
|    31209 | 3321 | `					pTrait = PH7_VmExtractClass(pGen->pVm,` |
|    15602 | 3322 | `						(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|    15607 | 3323 | `					SyStringInitFromBuf(&sTraitName,` |
|        - | 3324 | `						(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|        - | 3325 | `					/* Only traits are allowed */` |
|    15607 | 3326 | `					while( pTrait && (pTrait->iFlags & PH7_CLASS_TRAIT) == 0 ){` |
|      ! 0 | 3327 | `						pTrait = pTrait->pNextName;` |
|      ! 0 | 3328 | `					}` |
|    15607 | 3329 | `					if( pTrait == 0 ){` |
...
|        - | 3335 | `						}` |
|      ! 0 | 3336 | `					}else{` |
|    15607 | 3337 | `						SySetPut(&sUse.aTraits,(const void *)&pTrait);` |
|        - | 3338 | `					}` |
|    15607 | 3339 | `					SyBlobRelease(&sResolved);` |
...
|    15607 | 3342 | `					if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COMMA) == 0 ){` |
|     7802 | 3343 | `						break;` |
|        - | 3344 | `					}` |
|       10 | 3345 | `					pGen->pIn++; /* Jump the comma */` |
|        2 | 3346 | `				}` |
|        - | 3347 | `				/* Expect semicolon or opening brace (for conflict resolution) */` |
|    15599 | 3348 | `				if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OCB) ){` |
|        - | 3349 | `					SyToken *pBlock;` |
...
|        - | 3358 | `					}` |
|        5 | 3359 | `				}` |
|    15599 | 3360 | `				SySetPut(&aUseEntries,(const void *)&sUse);` |
|        - | 3361 | `				/* The semicolon will be consumed by the outer loop */` |
|    15599 | 3362 | `				continue;` |
|        - | 3363 | `			}` |
|  3499115 | 3364 | `			if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|        - | 3365 | `				int nSetTok;` |
|  2955933 | 3366 | `				sxi32 nSetVis = GenStatePeekSetVisibility(pGen->pIn,pGen->pEnd,&nSetTok);` |
|  2955933 | 3367 | `				if( nSetVis ){` |
...
|        2 | 3372 | `				}else{` |
|  2955931 | 3373 | `					iProtection = nKwrd;` |
|  2955931 | 3374 | `					pGen->pIn++; /* Jump the visibility token */` |
|        - | 3375 | `					/* Optional asymmetric set-visibility after the read` |
|        - | 3376 | ``					 * visibility: `public private(set) int $x`. */`` |
|  2955931 | 3377 | `					nSetVis = GenStatePeekSetVisibility(pGen->pIn,pGen->pEnd,&nSetTok);` |
|  2955931 | 3378 | `					if( nSetVis ){` |
...
|  2955933 | 3385 | `				if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|       28 | 3386 | `					iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|       28 | 3387 | `					pGen->pIn++; /* Jump the 'readonly' modifier */` |
|       12 | 3388 | `				}` |
|  2955928 | 3389 | `				if( pGen->pIn >= pGen->pEnd` |
|  2955933 | 3390 | `					\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|      ! 0 | 3398 | `					goto done;` |
|        - | 3399 | `				}` |
|  2955933 | 3400 | `				if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|        - | 3401 | `					/* Attribute declaration (untyped) */` |
|   523955 | 3402 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|   523955 | 3403 | `					if( rc != SXRET_OK ){` |
|       11 | 3404 | `						if( rc == SXERR_ABORT ){` |
|      ! 0 | 3405 | `							return SXERR_ABORT;` |
|        - | 3406 | `						}` |
|       11 | 3407 | `						goto done;` |
|        - | 3408 | `					}` |
|   531862 | 3409 | `					continue;` |
|        - | 3410 | `				}` |
|  2431983 | 3411 | `				if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
|        - | 3412 | `					/* Typed attribute declaration (PHP 7.4+) */` |
|    15841 | 3413 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|    15841 | 3414 | `					if( rc != SXRET_OK ){` |
...
|  2416147 | 3423 | `				nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  1208071 | 3424 | `			}` |
|  2959329 | 3425 | `			if( nKwrd == PH7_TKWRD_CONST ){` |
|        - | 3426 | `				/* Process constant declaration */` |
|   287011 | 3427 | `				rc = GenStateCompileClassConstant(&(*pGen),iProtection,iAttrflags,pClass);` |
|   287011 | 3428 | `				if( rc != SXRET_OK ){` |
...
|        - | 3433 | `				}` |
|   143504 | 3434 | `			}else{` |
|  2672323 | 3435 | `				if( nKwrd == PH7_TKWRD_STATIC ){` |
|        - | 3436 | `					/* Static method or attribute,record that */` |
|   100977 | 3437 | `					iAttrflags \|= PH7_CLASS_ATTR_STATIC;` |
|   100977 | 3438 | `					pGen->pIn++; /* Jump the static keyword */` |
|   100977 | 3439 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|        - | 3440 | `						int nSetTok;` |
|    73803 | 3441 | `						sxi32 nSetVis = GenStatePeekSetVisibility(pGen->pIn,pGen->pEnd,&nSetTok);` |
|    73803 | 3442 | `						if( nSetVis ){` |
...
|    73801 | 3448 | `							nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    73801 | 3449 | `							if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
...
|   100977 | 3463 | `					if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|      ! 0 | 3464 | `						iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|      ! 0 | 3465 | `						pGen->pIn++; /* Jump the 'readonly' modifier */` |
|      ! 0 | 3466 | `					}` |
|   100972 | 3467 | `					if( pGen->pIn >= pGen->pEnd` |
|   100977 | 3468 | `						\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|      ! 0 | 3476 | `						goto done;` |
|        - | 3477 | `					}` |
|   100977 | 3478 | `					if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|        - | 3479 | `						/* Attribute declaration */` |
|    27175 | 3480 | `						rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|    27175 | 3481 | `						if( rc != SXRET_OK ){` |
...
|    27173 | 3487 | `						continue;` |
|        - | 3488 | `					}` |
|    73807 | 3489 | `					if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|    73791 | 3501 | `					nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  2608244 | 3502 | `				}else if( nKwrd == PH7_TKWRD_ABSTRACT ){` |
...
|     7779 | 3511 | `					iAttrflags \|= PH7_CLASS_ATTR_ABSTRACT;` |
|        - | 3512 | `					/* Advance the stream cursor */` |
|     7779 | 3513 | `					pGen->pIn++;` |
|     7779 | 3514 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|     7779 | 3515 | `						nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|     7779 | 3516 | `						if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|     7777 | 3517 | `							iProtection = nKwrd;` |
|     7777 | 3518 | `							pGen->pIn++; /* Jump the visibility token */` |
|     3886 | 3519 | `						}` |
|     3887 | 3520 | `					}` |
|     7779 | 3521 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|     7774 | 3522 | `						SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_STATIC ){` |
|        - | 3523 | `							/* Static method */` |
|      ! 0 | 3524 | `							iAttrflags \|= PH7_CLASS_ATTR_STATIC;` |
|      ! 0 | 3525 | `							pGen->pIn++; /* Jump the static keyword */` |
|      ! 0 | 3526 | `					}` |
|     7779 | 3527 | `					if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 \|\|` |
|     7774 | 3528 | `						SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_FUNCTION ){` |
...
|      ! 0 | 3553 | `							goto done;` |
|        - | 3554 | `					}` |
|     7773 | 3555 | `					nKwrd = PH7_TKWRD_FUNCTION;` |
|  2567461 | 3556 | `				}else if( nKwrd == PH7_TKWRD_FINAL ){` |
...
|        3 | 3600 | `				}` |
|  2645119 | 3601 | `				if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_VAR ){` |
...
|      ! 0 | 3609 | `						goto done;` |
|        - | 3610 | `				}` |
|  2645119 | 3611 | `				if( nKwrd == PH7_TKWRD_VAR ){` |
...
|  2645113 | 3626 | `					rc = GenStateCompileClassMethod(&(*pGen),iProtection,iAttrflags,TRUE,pClass);` |
|        - | 3627 | `				}` |
|  2645119 | 3628 | `				if( rc != SXRET_OK ){` |
...
|        - | 3651 | `		sxu32 nU;` |
|   451593 | 3652 | `		apUse = (TraitUseEntry *)SySetBasePtr(&aUseEntries);` |
|   467187 | 3653 | `		for( nU = 0 ; nU < SySetUsed(&aUseEntries) ; nU++ ){` |
|    15599 | 3654 | `			TraitUseEntry *pUse = &apUse[nU];` |
|    15599 | 3655 | `			ph7_class **apTrait = (ph7_class **)SySetBasePtr(&pUse->aTraits);` |
|    15599 | 3656 | `			sxu32 nTraits = SySetUsed(&pUse->aTraits);` |
|    15599 | 3657 | `			int hasResolution = (pUse->pResolvStart && pUse->pResolvStart < pUse->pResolvEnd) ? 1 : 0;` |
|        - | 3658 | `			sxu32 nT;` |
|    15599 | 3659 | `			if( !hasResolution ){` |
|        - | 3660 | `				/* No conflict resolution block: use standard trait application */` |
|    31179 | 3661 | `				for( nT = 0 ; nT < nTraits ; nT++ ){` |
|    15595 | 3662 | `					rc = PH7_ClassUseTrait(&(*pGen),pClass,apTrait[nT]);` |
|    15595 | 3663 | `					if( rc != SXRET_OK ){` |
|      ! 0 | 3664 | `						break;` |
|        - | 3665 | `					}` |
|     7800 | 3666 | `				}` |
|     7797 | 3667 | `			}else{` |
...
|        2 | 3855 | `				}` |
|        - | 3856 | `			}` |
|    15599 | 3857 | `			SySetRelease(&pUse->aTraits);` |
|     7802 | 3858 | `		}` |
|        - | 3859 | `	}` |
|   451593 | 3860 | `	if( pClass->iFlags & PH7_CLASS_ENUM ){` |
...
|     3915 | 3863 | `		rc = GenStateEnumFinalize(&(*pGen),pClass,nLine);` |
|     3915 | 3864 | `		if( rc == SXERR_ABORT ){` |
...
|   451593 | 3871 | `	if( GenStateGuardClassRedeclaration(pGen,pClass) == SXERR_ABORT ){` |
|        9 | 3872 | `		return SXERR_ABORT;` |
|        - | 3873 | `	}` |
|        - | 3874 | `	/* Install the class */` |
|   451587 | 3875 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|   451587 | 3876 | `	if( rc == SXRET_OK ){` |
|        - | 3877 | `		ph7_class **apInterface;` |
|        - | 3878 | `		sxu32 n;` |
|   451587 | 3879 | `		if( pBase ){` |
|        - | 3880 | `			/* Inherit from base class and mark as a subclass */` |
|   248385 | 3881 | `			rc = PH7_ClassInherit(&(*pGen),pClass,pBase);` |
|   124190 | 3882 | `		}` |
|   451587 | 3883 | `		apInterface = (ph7_class **)SySetBasePtr(&aInterfaces);` |
|   649471 | 3884 | `		for( n = 0 ; n < SySetUsed(&aInterfaces) ; n++ ){` |
|        - | 3885 | `			/* Implements one or more interface */` |
|   197889 | 3886 | `			rc = PH7_ClassImplement(pClass,apInterface[n]);` |
|   197889 | 3887 | `			if( rc != SXRET_OK ){` |
|      ! 0 | 3888 | `				break;` |
|        - | 3889 | `			}` |
|    98947 | 3890 | `		}` |
...
|   451587 | 3893 | `		if( rc == SXRET_OK && (pClass->iFlags & PH7_CLASS_ENUM) ){` |
|     3913 | 3894 | `			ph7_class *pIntf = PH7_VmExtractClass(pGen->pVm,"UnitEnum",sizeof("UnitEnum")-1,FALSE,0);` |
|     3913 | 3895 | `			while( pIntf && (pIntf->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|      ! 0 | 3896 | `				pIntf = pIntf->pNextName;` |
|      ! 0 | 3897 | `			}` |
|     3913 | 3898 | `			if( pIntf ){` |
|     3913 | 3899 | `				PH7_ClassImplement(pClass,pIntf);` |
|     1954 | 3900 | `			}` |
|     3913 | 3901 | `			if( pClass->nEnumBacking != 0 ){` |
|     3895 | 3902 | `				pIntf = PH7_VmExtractClass(pGen->pVm,"BackedEnum",sizeof("BackedEnum")-1,FALSE,0);` |
|     3895 | 3903 | `				while( pIntf && (pIntf->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|      ! 0 | 3904 | `					pIntf = pIntf->pNextName;` |
|      ! 0 | 3905 | `				}` |
|     3895 | 3906 | `				if( pIntf ){` |
|     3895 | 3907 | `					PH7_ClassImplement(pClass,pIntf);` |
|     1945 | 3908 | `				}` |
|     1945 | 3909 | `			}` |
|     1954 | 3910 | `		}` |
...
|   451582 | 3913 | `		if( rc == SXRET_OK` |
|   451582 | 3914 | `		 && (pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT)) == 0` |
|   451587 | 3915 | `		 && SyHashGet(&pClass->hMethod,"__toString",sizeof("__toString")-1) != 0 ){` |
|   228797 | 3916 | `			ph7_class *pStringable = PH7_VmExtractClass(pGen->pVm,` |
|        - | 3917 | `				"Stringable",sizeof("Stringable")-1,FALSE,0);` |
|   228797 | 3918 | `			if( pStringable ){` |
|   228797 | 3919 | `				ph7_class **apImpl = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|   228797 | 3920 | `				sxu32 nImpl = SySetUsed(&pClass->aInterface);` |
|        - | 3921 | `				sxu32 i;` |
|   228797 | 3922 | `				int bAlready = 0;` |
|   275313 | 3923 | `				for( i = 0 ; i < nImpl ; i++ ){` |
|    58151 | 3924 | `					if( apImpl[i] == pStringable ){` |
|    11635 | 3925 | `						bAlready = 1;` |
|    11635 | 3926 | `						break;` |
|        - | 3927 | `					}` |
|    23263 | 3928 | `				}` |
|   228797 | 3929 | `				if( !bAlready ){` |
|   217167 | 3930 | `					PH7_ClassImplement(pClass,pStringable);` |
|   108581 | 3931 | `				}` |
|   114396 | 3932 | `			}` |
|   114396 | 3933 | `		}` |
|        - | 3934 | `		/* Validate interface method signatures (visibility and parameter count) */` |
|   451587 | 3935 | `		if( rc == SXRET_OK ){` |
|   451587 | 3936 | `			sxi32 rcCheck = GenStateCheckInterfaceSignatures(&(*pGen),pClass);` |
|   451587 | 3937 | `			if( rcCheck == SXERR_ABORT ){` |
...
|   451587 | 3944 | `		if( rc == SXRET_OK ){` |
|   451587 | 3945 | `			sxi32 rcCheck = GenStateCheckAbstractMethods(&(*pGen),pClass);` |
|   451587 | 3946 | `			if( rcCheck == SXERR_ABORT ){` |
...
|   225791 | 3951 | `		}` |
|   225791 | 3952 | `	}` |
|   451587 | 3953 | `	SySetRelease(&aUseEntries);` |
|   451587 | 3954 | `	SySetRelease(&aInterfaces);` |
|   451587 | 3955 | `	if( rc != SXRET_OK ){` |
...
|   451629 | 3961 | `	pGen->pIn = &pEnd[1];` |
|   451629 | 3962 | `	pGen->pEnd = pTmp;` |
|   451629 | 3963 | `	return PH7_OK;` |
|   225821 | 3964 | `}` |
|        - | 3965 | `/* Compile a named class declaration (the common case). */` |
|   451602 | 3966 | `static sxi32 GenStateCompileClass(ph7_gen_state *pGen,sxi32 iFlags)` |
|        5 | 3967 | `{` |
|   451607 | 3968 | `	return GenStateCompileClassEx(pGen,iFlags,0,0,0);` |
|        5 | 3969 | `}` |
|        - | 3970 | `/*` |
...
|        - | 4069 | ` */` |
| 14432150 | 4070 | `static int GenStateTokenIsClassModifier(SyToken *pTok,sxi32 *piFlag)` |
|        5 | 4071 | `{` |
| 14432155 | 4072 | `	if( pTok->nType & PH7_TK_KEYWORD ){` |
|  8637743 | 4073 | `		sxu32 nKw = (sxu32)SX_PTR_TO_INT(pTok->pUserData);` |
|  8637743 | 4074 | `		if( nKw == PH7_TKWRD_FINAL ){ *piFlag = PH7_CLASS_FINAL; return TRUE; }` |
|  8583433 | 4075 | `		if( nKw == PH7_TKWRD_ABSTRACT ){ *piFlag = PH7_CLASS_ABSTRACT; return TRUE; }` |
|  4272281 | 4076 | `	}` |
| 14338979 | 4077 | `	if( GenStateIsReadonly(pTok) ){ *piFlag = PH7_CLASS_READONLY; return TRUE; }` |
| 14338919 | 4078 | `	return FALSE;` |
|  7216080 | 4079 | `}` |
|        - | 4080 | `/*` |
...
|        - | 4085 | ` */` |
| 14338914 | 4086 | `static sxi32 GenStateScanClassModifiers(SyToken **ppIn,SyToken *pEnd,SyToken **ppDup)` |
|        5 | 4087 | `{` |
| 14338919 | 4088 | `	SyToken *pIn = *ppIn,*pDup = 0;` |
| 14338919 | 4089 | `	sxi32 iFlags = 0,iFlag;` |
| 14432155 | 4090 | `	while( pIn < pEnd && GenStateTokenIsClassModifier(pIn,&iFlag) ){` |
|    93241 | 4091 | `		if( (iFlags & iFlag) && pDup == 0 ){` |
|        5 | 4092 | `			pDup = pIn;` |
|        2 | 4093 | `		}` |
|    93241 | 4094 | `		iFlags \|= iFlag;` |
|    93241 | 4095 | `		pIn++;` |
|        5 | 4096 | `	}` |
| 14338919 | 4097 | `	*ppIn = pIn;` |
| 14338919 | 4098 | `	if( ppDup ){ *ppDup = pDup; }` |
| 14338919 | 4099 | `	return iFlags;` |
|        5 | 4100 | `}` |
|        - | 4101 | `/*` |
...
|        - | 4107 | ` */` |
| 14296182 | 4108 | `PH7_PRIVATE int GenStateStartsModifiedClass(SyToken *pIn,SyToken *pEnd)` |
|        5 | 4109 | `{` |
| 14296187 | 4110 | `	sxi32 iFlags = GenStateScanClassModifiers(&pIn,pEnd,0);` |
|  7198582 | 4111 | `	return iFlags != 0 && pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD)` |
| 14321426 | 4112 | `		&& (sxu32)SX_PTR_TO_INT(pIn->pUserData) == PH7_TKWRD_CLASS;` |
|        5 | 4113 | `}` |
|        - | 4114 | `/*` |
...
|        - | 4120 | ` */` |
|    42732 | 4121 | `PH7_PRIVATE sxi32 PH7_CompileClassModifiers(ph7_gen_state *pGen)` |
|        5 | 4122 | `{` |
|        - | 4123 | `	SyToken *pDup;` |
|    42737 | 4124 | `	sxi32 iFlags = GenStateScanClassModifiers(&pGen->pIn,pGen->pEnd,&pDup);` |
|        - | 4125 | `	sxi32 rc;` |
|    42737 | 4126 | `	if( pDup ){` |
...
|        - | 4131 | `		}` |
|        1 | 4132 | `	}` |
|    42732 | 4133 | `	if( (iFlags & (PH7_CLASS_FINAL\|PH7_CLASS_ABSTRACT))` |
|    21371 | 4134 | `		== (PH7_CLASS_FINAL\|PH7_CLASS_ABSTRACT) ){` |
...
|        - | 4139 | `		}` |
|        1 | 4140 | `	}` |
|    42737 | 4141 | `	return GenStateCompileClass(&(*pGen),iFlags);` |
|    21371 | 4142 | `}` |
|        - | 4143 | `/*` |
...
|        - | 4148 | ` */` |
|     7854 | 4149 | `PH7_PRIVATE sxi32 PH7_CompileTrait(ph7_gen_state *pGen)` |
|        5 | 4150 | `{` |
|     7859 | 4151 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|     7859 | 4160 | `	pGen->pIn++;` |
|     7859 | 4161 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
...
|     7859 | 4172 | `	pName = &pGen->pIn->sData;` |
|     7859 | 4173 | `	pGen->pIn++;` |
|        - | 4174 | `	/* Build FQN and obtain a raw class */ {` |
|        - | 4175 | `		SyBlob sFQN;` |
|        - | 4176 | `		SyString sFQNStr;` |
|     7859 | 4177 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|     7859 | 4178 | `		GenStateBuildFQN(pGen,pName,&sFQN);` |
|     7859 | 4179 | `		SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|     7859 | 4180 | `		pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|     7859 | 4181 | `		SyBlobRelease(&sFQN);` |
|        - | 4182 | `	}` |
|     7859 | 4183 | `	if( pClass == 0 ){` |
|      ! 0 | 4184 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 4185 | `		return SXERR_ABORT;` |
|        - | 4186 | `	}` |
|     7859 | 4187 | `	GenStateConsumeDoc(&(*pGen),&pClass->sDoc);` |
|     7859 | 4188 | `	if( GenStateConsumeAttrs(&(*pGen),&pClass->aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 4189 | `		return SXERR_ABORT;` |
|        - | 4190 | `	}` |
|        - | 4191 | `	/* Traits cannot extend or implement; expect opening brace directly */` |
|     7859 | 4192 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_OCB) == 0 ){` |
...
|        - | 4199 | `	}` |
|     7859 | 4200 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|     7859 | 4201 | `	pEnd = 0;` |
|     7859 | 4202 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB,PH7_TK_CCB,&pEnd);` |
|     7859 | 4203 | `	if( pEnd >= pGen->pEnd ){` |
...
|     7859 | 4212 | `	pClass->nEndLine = pEnd->nLine;` |
|        - | 4213 | `	/* Swap token stream */` |
|     7859 | 4214 | `	pTmp = pGen->pEnd;` |
|     7859 | 4215 | `	pGen->pEnd = pEnd;` |
|        - | 4216 | `	/* Mark as trait (PH7_NewRawClass may have set INTERNAL) */` |
|     7859 | 4217 | `	pClass->iFlags \|= PH7_CLASS_TRAIT;` |
|        - | 4218 | `	/* Parse the body: same as a normal class (methods, attributes, visibility modifiers) */` |
|    56304 | 4219 | `	for(;;){` |
|   159187 | 4220 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|    23295 | 4221 | `			pGen->pIn++;` |
|        5 | 4222 | `		}` |
|   135897 | 4223 | `		if( pGen->pIn >= pGen->pEnd ){` |
|     7859 | 4224 | `			break;` |
|        - | 4225 | `		}` |
|        - | 4226 | `		/* Bind a directly-preceding docblock to this member */` |
|   128043 | 4227 | `		GenStateSetPendingDoc(&(*pGen));` |
|   128043 | 4228 | `		if( (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR)) == 0 ){` |
...
|      ! 0 | 4235 | `			goto done;` |
|        - | 4236 | `		}` |
|   128043 | 4237 | `		iProtection = PH7_TKWRD_PUBLIC;` |
|   128043 | 4238 | `		iAttrflags = 0;` |
|   128043 | 4239 | `		if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|   128043 | 4240 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   128043 | 4241 | `			if( nKwrd == PH7_TKWRD_USE ){` |
...
|        5 | 4282 | `				continue;` |
|        - | 4283 | `			}` |
|   128039 | 4284 | `			if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|   128021 | 4285 | `				iProtection = nKwrd;` |
|   128021 | 4286 | `				pGen->pIn++;` |
...
|   128021 | 4290 | `				if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|        5 | 4291 | `					iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|        5 | 4292 | `					pGen->pIn++; /* Jump the 'readonly' modifier */` |
|        2 | 4293 | `				}` |
|   128016 | 4294 | `				if( pGen->pIn >= pGen->pEnd` |
|   128021 | 4295 | `					\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|      ! 0 | 4302 | `					goto done;` |
|        - | 4303 | `				}` |
|   128021 | 4304 | `				if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|    23275 | 4305 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|    23275 | 4306 | `					if( rc != SXRET_OK ){` |
...
|    23275 | 4312 | `					continue;` |
|        - | 4313 | `				}` |
|   104751 | 4314 | `				if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|        9 | 4322 | `					continue;` |
|        - | 4323 | `				}` |
|   104743 | 4324 | `				nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    52369 | 4325 | `			}` |
|   104761 | 4326 | `			if( nKwrd == PH7_TKWRD_CONST ){` |
...
|      ! 0 | 4332 | `				goto done;` |
|      ! 0 | 4333 | `			}else{` |
|   104761 | 4334 | `				if( nKwrd == PH7_TKWRD_STATIC ){` |
|     7767 | 4335 | `					iAttrflags \|= PH7_CLASS_ATTR_STATIC;` |
|     7767 | 4336 | `					pGen->pIn++;` |
|     7767 | 4337 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|     7765 | 4338 | `						nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|     7765 | 4339 | `						if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|      ! 0 | 4340 | `							iProtection = nKwrd;` |
|      ! 0 | 4341 | `							pGen->pIn++;` |
|      ! 0 | 4342 | `						}` |
|     3880 | 4343 | `					}` |
|     7762 | 4344 | `					if( pGen->pIn >= pGen->pEnd` |
|     7767 | 4345 | `						\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|      ! 0 | 4352 | `						goto done;` |
|        - | 4353 | `					}` |
|     7767 | 4354 | `					if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
...
|        3 | 4362 | `						continue;` |
|        - | 4363 | `					}` |
|     7765 | 4364 | `					if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|      ! 0 | 4372 | `						continue;` |
|        - | 4373 | `					}` |
|     7765 | 4374 | `					nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   100879 | 4375 | `				}else if( nKwrd == PH7_TKWRD_ABSTRACT ){` |
...
|        3 | 4396 | `				}` |
|   104759 | 4397 | `				if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_VAR ){` |
...
|      ! 0 | 4404 | `					goto done;` |
|        - | 4405 | `				}` |
|   104759 | 4406 | `				if( nKwrd == PH7_TKWRD_VAR ){` |
|      ! 0 | 4407 | `					pGen->pIn++;` |
...
|      ! 0 | 4417 | `				}else{` |
|   104759 | 4418 | `					rc = GenStateCompileClassMethod(&(*pGen),iProtection,iAttrflags,TRUE,pClass);` |
|        - | 4419 | `				}` |
|   104759 | 4420 | `				if( rc != SXRET_OK ){` |
...
|     7859 | 4438 | `	if( GenStateGuardClassRedeclaration(pGen,pClass) == SXERR_ABORT ){` |
|        3 | 4439 | `		return SXERR_ABORT;` |
|        - | 4440 | `	}` |
|        - | 4441 | `	/* Install the trait */` |
|     7857 | 4442 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|     7857 | 4443 | `	if( rc != SXRET_OK ){` |
...
|     7857 | 4449 | `	pGen->pIn = &pEnd[1];` |
|     7857 | 4450 | `	pGen->pEnd = pTmp;` |
|     7857 | 4451 | `	return PH7_OK;` |
|     3932 | 4452 | `}` |
|        - | 4453 | `/*` |
...
|        - | 4461 | ` */` |
|   404956 | 4462 | `PH7_PRIVATE sxi32 PH7_CompileClass(ph7_gen_state *pGen)` |
|        5 | 4463 | `{` |
|        - | 4464 | `	sxi32 rc;` |
|   404961 | 4465 | `	rc = GenStateCompileClass(&(*pGen),0);` |
|   404961 | 4466 | `	return rc;` |
|        5 | 4467 | `}` |
|        - | 4468 | `/*` |
...
|        - | 4474 | ` */` |
| 14245698 | 4475 | `PH7_PRIVATE int GenStateStartsEnumDecl(SyToken *pIn,SyToken *pEnd)` |
|        5 | 4476 | `{` |
| 14461676 | 4477 | `	return (pIn->nType & PH7_TK_ID)` |
|  7338822 | 4478 | `		&& pIn->sData.nByte == sizeof("enum")-1` |
|   225811 | 4479 | `		&& SyStrnicmp(pIn->sData.zString,"enum",sizeof("enum")-1) == 0` |
| 14461671 | 4480 | `		&& &pIn[1] < pEnd && (pIn[1].nType & PH7_TK_ID);` |
|        5 | 4481 | `}` |
|        - | 4482 | `/*` |
...
|        - | 4487 | ` */` |
|     3914 | 4488 | `PH7_PRIVATE sxi32 PH7_CompileEnum(ph7_gen_state *pGen)` |
|        5 | 4489 | `{` |
|     3919 | 4490 | `	return GenStateCompileClass(&(*pGen),PH7_CLASS_ENUM\|PH7_CLASS_FINAL);` |
|        5 | 4491 | `}` |
|        - | 4492 |  |
