...
|        - |  430 | ` */` |
|  2904124 |  431 | `PH7_PRIVATE void PH7_VmRandomString(ph7_vm *pVm,char *zBuf,int nLen)` |
|        5 |  432 | `{` |
|        - |  433 | `	static const char zBase[] = {"abcdefghijklmnopqrstuvwxyz"}; /* English Alphabet */` |
|        - |  434 | `	int i;` |
|        - |  435 | `	/* Generate a binary string first */` |
|  2904129 |  436 | `	SyRandomness(&pVm->sPrng,zBuf,(sxu32)nLen);` |
|        - |  437 | `	/* Turn the binary string into english based alphabet */` |
| 31945557 |  438 | `	for( i = 0 ; i < nLen ; ++i ){` |
| 29041433 |  439 | `		 zBuf[i] = zBase[zBuf[i] % (sizeof(zBase)-1)];` |
| 14520719 |  440 | `	 }` |
|  2904129 |  441 | `}` |
|        - |  442 | `/*` |
|        - |  443 | ` * int rand()` |
