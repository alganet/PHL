...
|        - |  418 | ` */` |
|     5119 |  419 | `PH7_PRIVATE sxu32 PH7_VmRandomNum(ph7_vm *pVm)` |
|        5 |  420 | `{` |
|        - |  421 | `	sxu32 iNum;` |
|     5124 |  422 | `	SyRandomness(&pVm->sPrng,(void *)&iNum,sizeof(sxu32));` |
|     5124 |  423 | `	return iNum;` |
|        5 |  424 | `}` |
|        - |  425 | `/*` |
...
|        - |  430 | ` */` |
|  2910092 |  431 | `PH7_PRIVATE void PH7_VmRandomString(ph7_vm *pVm,char *zBuf,int nLen)` |
|        5 |  432 | `{` |
|        - |  433 | `	static const char zBase[] = {"abcdefghijklmnopqrstuvwxyz"}; /* English Alphabet */` |
|        - |  434 | `	int i;` |
|        - |  435 | `	/* Generate a binary string first */` |
|  2910097 |  436 | `	SyRandomness(&pVm->sPrng,zBuf,(sxu32)nLen);` |
|        - |  437 | `	/* Turn the binary string into english based alphabet */` |
| 32011205 |  438 | `	for( i = 0 ; i < nLen ; ++i ){` |
| 29101113 |  439 | `		 zBuf[i] = zBase[zBuf[i] % (sizeof(zBase)-1)];` |
| 14550559 |  440 | `	 }` |
|  2910097 |  441 | `}` |
|        - |  442 | `/*` |
|        - |  443 | ` * int rand()` |
