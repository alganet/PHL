...
|        - |  430 | ` */` |
|  2902632 |  431 | `PH7_PRIVATE void PH7_VmRandomString(ph7_vm *pVm,char *zBuf,int nLen)` |
|        5 |  432 | `{` |
|        - |  433 | `	static const char zBase[] = {"abcdefghijklmnopqrstuvwxyz"}; /* English Alphabet */` |
|        - |  434 | `	int i;` |
|        - |  435 | `	/* Generate a binary string first */` |
|  2902637 |  436 | `	SyRandomness(&pVm->sPrng,zBuf,(sxu32)nLen);` |
|        - |  437 | `	/* Turn the binary string into english based alphabet */` |
| 31929145 |  438 | `	for( i = 0 ; i < nLen ; ++i ){` |
| 29026513 |  439 | `		 zBuf[i] = zBase[zBuf[i] % (sizeof(zBase)-1)];` |
| 14513259 |  440 | `	 }` |
|  2902637 |  441 | `}` |
|        - |  442 | `/*` |
|        - |  443 | ` * int rand()` |
...
|      225 |  638 | `	uResult = 0;` |
|      386 |  639 | `	for( nAttempt = 0 ; nAttempt < 50 ; ++nAttempt ){` |
...
|        - |  643 | `		sxu64 uDraw;` |
|      386 |  644 | `		if( SyOSCSPRNG(&uDraw,sizeof(uDraw)) != SXRET_OK ){` |
