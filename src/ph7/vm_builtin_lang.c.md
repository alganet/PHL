...
|        - |  418 | ` */` |
|     5086 |  419 | `PH7_PRIVATE sxu32 PH7_VmRandomNum(ph7_vm *pVm)` |
|        5 |  420 | `{` |
|        - |  421 | `	sxu32 iNum;` |
|     5091 |  422 | `	SyRandomness(&pVm->sPrng,(void *)&iNum,sizeof(sxu32));` |
|     5091 |  423 | `	return iNum;` |
|        5 |  424 | `}` |
|        - |  425 | `/*` |
...
|      225 |  638 | `	uResult = 0;` |
|      377 |  639 | `	for( nAttempt = 0 ; nAttempt < 50 ; ++nAttempt ){` |
...
|        - |  643 | `		sxu64 uDraw;` |
|      377 |  644 | `		if( SyOSCSPRNG(&uDraw,sizeof(uDraw)) != SXRET_OK ){` |
