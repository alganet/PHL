...
|       - |   22 | ` */` |
|  115850 |   23 | `PH7_PRIVATE int vm_builtin_isset(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       5 |   24 | `{` |
|       - |   25 | `	ph7_value *pObj;` |
|  115855 |   26 | `	int res = 0;` |
|       - |   27 | `	int i;` |
...
|  148581 |   34 | `	for( i = 0 ; i < nArg ; ++i ){` |
|  115867 |   35 | `		pObj = apArg[i];` |
|  115867 |   36 | `		if( pObj->nIdx == SXU32_HIGH ){` |
...
|   80255 |   40 | `			if( (pObj->iFlags & (MEMOBJ_NULL\|MEMOBJ_BOOL)) == 0 ){` |
|       - |   41 | `				/* Not so fatal,Throw a warning */` |
|     ! 0 |   42 | `				ph7_context_throw_error(pCtx,PH7_CTX_WARNING,"Expecting a variable not a constant");` |
|     ! 0 |   43 | `			}` |
|   40125 |   44 | `		}` |
|  115867 |   45 | `		res = (pObj->iFlags & MEMOBJ_NULL) ? 0 : 1;` |
|  115867 |   46 | `		if( !res ){` |
|       - |   47 | `			/* Variable not set,return FALSE */` |
|   83141 |   48 | `			ph7_result_bool(pCtx,0);` |
|   83141 |   49 | `			return SXRET_OK;` |
|       - |   50 | `		}` |
|   16368 |   51 | `	}` |
|       - |   52 | `	/* All given variable are set,return TRUE */` |
|   32719 |   53 | `	ph7_result_bool(pCtx,1);` |
|   32719 |   54 | `	return SXRET_OK;` |
|   57930 |   55 | `}` |
|       - |   56 | `/*` |
...
|       - |  191 | ` */` |
|  709796 |  192 | `PH7_PRIVATE int PH7_VmSlotIsReferenced(ph7_vm *pVm,sxu32 nIdx)` |
|       5 |  193 | `{` |
|       - |  194 | `	VmRefObj *pRef;` |
|  709801 |  195 | `	sxu32 n, nLive = 0;` |
|       - |  196 | `	SyHashEntry **apEntry;` |
|  709801 |  197 | `	if( nIdx == SXU32_HIGH ){` |
|     ! 0 |  198 | `		return 0;` |
|       - |  199 | `	}` |
|  709801 |  200 | `	pRef = VmRefObjExtract(&(*pVm),nIdx);` |
|  709801 |  201 | `	if( pRef == 0 ){` |
|     ! 0 |  202 | `		return 0;` |
|       - |  203 | `	}` |
|  709801 |  204 | `	apEntry = (SyHashEntry **)SySetBasePtr(&pRef->aReference);` |
|  709805 |  205 | `	for( n = 0 ; n < SySetUsed(&pRef->aReference) ; ++n ){` |
|       5 |  206 | `		if( apEntry[n] ){` |
|       5 |  207 | `			nLive++;` |
|       2 |  208 | `		}` |
|       3 |  209 | `	}` |
|  709801 |  210 | `	return nLive > 0;` |
|  354903 |  211 | `}` |
| 4255101 |  212 | `PH7_PRIVATE sxi32 PH7_VmUnsetMemObj(ph7_vm *pVm,sxu32 nObjIdx,int bForce)` |
|       5 |  213 | `{` |
|       - |  214 | `	ph7_value *pObj;` |
|       - |  215 | `	VmRefObj *pRef;` |
| 4255106 |  216 | `	pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nObjIdx);` |
| 4255106 |  217 | `	if( pObj ){` |
|       - |  218 | `		/* Release the object */` |
| 4255106 |  219 | `		PH7_MemObjRelease(pObj);` |
| 2128183 |  220 | `	}` |
|       - |  221 | `	/* Remove old reference links */` |
| 4255106 |  222 | `	pRef = VmRefObjExtract(&(*pVm),nObjIdx);` |
| 4255106 |  223 | `	if( pRef ){` |
| 4255106 |  224 | `		sxi32 iFlags = pRef->iFlags;` |
|       - |  225 | `		/* Unlink from the reference table */` |
| 4255106 |  226 | `		VmRefObjUnlink(&(*pVm),pRef);` |
| 4255106 |  227 | `		if( (bForce == TRUE) \|\| (iFlags & VM_REF_IDX_KEEP) == 0 ){` |
|       - |  228 | `			VmSlot sFree;` |
|       - |  229 | `			/* Restore to the free list */` |
| 4255088 |  230 | `			sFree.nIdx = nObjIdx;` |
| 4255088 |  231 | `			sFree.pUserData = 0;` |
| 4255088 |  232 | `			SySetPut(&pVm->aFreeObj,(const void *)&sFree);` |
| 2128174 |  233 | `		}` |
| 2128183 |  234 | `	}` |
| 4255106 |  235 | `	return SXRET_OK;` |
|       5 |  236 | `}` |
|       - |  237 | `/*` |
|       - |  238 | ` * void unset($var,...)` |
...
|       - |  437 | ` *  Nothing.` |
|       - |  438 | ` */` |
|     660 |  439 | `PH7_PRIVATE int vm_builtin_var_dump(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       5 |  440 | `{` |
|       - |  441 | `	SyBlob sDump; /* Generated dump is stored here */` |
|       - |  442 | `	int i;` |
|     665 |  443 | `	SyBlobInit(&sDump,&pCtx->pVm->sAllocator);` |
|       - |  444 | `	/* Dump one or more expressions */` |
|    1423 |  445 | `	for( i = 0 ; i < nArg ; i++ ){` |
|     763 |  446 | `		ph7_value *pObj = apArg[i];` |
|       - |  447 | `		/* Reset the working buffer */` |
|     763 |  448 | `		SyBlobReset(&sDump);` |
|       - |  449 | `		/* Dump the given expression */` |
|     763 |  450 | `		PH7_MemObjDump(&sDump,pObj,TRUE,0,0,0);` |
|       - |  451 | `		/* Output */` |
|     763 |  452 | `		if( SyBlobLength(&sDump) > 0 ){` |
|     763 |  453 | `			ph7_context_output(pCtx,(const char *)SyBlobData(&sDump),(int)SyBlobLength(&sDump));` |
|     379 |  454 | `		}` |
|     384 |  455 | `	}` |
|       - |  456 | `	/* Release the working buffer */` |
|     665 |  457 | `	SyBlobRelease(&sDump);` |
|     665 |  458 | `	return SXRET_OK;` |
|       5 |  459 | `}` |
|       - |  460 | `/*` |
