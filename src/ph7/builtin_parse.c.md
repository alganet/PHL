...
|     - | 2114 | ` */` |
| 16091 | 2115 | `PH7_PRIVATE int PH7_builtin_ctype_space(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 | 2116 | `{` |
|     - | 2117 | `	const unsigned char *zIn,*zEnd;` |
|     - | 2118 | `	int nLen;` |
| 16096 | 2119 | `	if( nArg < 1 ){` |
|     - | 2120 | `		/* Missing arguments,return FALSE */` |
|   ! 0 | 2121 | `		ph7_result_bool(pCtx,0);` |
|   ! 0 | 2122 | `		return PH7_OK;` |
|     - | 2123 | `	}` |
|     - | 2124 | `	/* Extract the target string */` |
| 16096 | 2125 | `	zIn  = (const unsigned char *)ph7_value_to_string(apArg[0],&nLen);` |
| 16096 | 2126 | `	zEnd = &zIn[nLen];` |
| 16096 | 2127 | `	if( nLen < 1 ){` |
...
| 16084 | 2150 | `	ph7_result_bool(pCtx,0);` |
| 16084 | 2151 | `	return PH7_OK;` |
|  8106 | 2152 | `}` |
|     - | 2153 | `/*` |
