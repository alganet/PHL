...
|     - | 1872 | ` */` |
|  1825 | 1873 | `PH7_PRIVATE int PH7_builtin_ctype_digit(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 | 1874 | `{` |
...
|  1830 | 1883 | `	zIn  = (const unsigned char *)ph7_value_to_string(apArg[0],&nLen);` |
|  1830 | 1884 | `	zEnd = &zIn[nLen];` |
|  1830 | 1885 | `	if( nLen < 1 ){` |
...
|  1696 | 1891 | `	for(;;){` |
|  3395 | 1892 | `		if( zIn >= zEnd ){` |
|     - | 1893 | `			/* If we reach the end of the string,then the test succeeded. */` |
|  1510 | 1894 | `			ph7_result_bool(pCtx,1);` |
|  1510 | 1895 | `			return PH7_OK;` |
|     - | 1896 | `		}` |
|  1890 | 1897 | `		if( zIn[0] >= 0xc0 ){` |
|     - | 1898 | `			/* UTF-8 stream  */` |
|   ! 0 | 1899 | `			break;` |
|     - | 1900 | `		}` |
|  1890 | 1901 | `		if( !SyisDigit(zIn[0]) ){` |
|   317 | 1902 | `			break;` |
|     - | 1903 | `		}` |
...
|     - | 2114 | ` */` |
| 16529 | 2115 | `PH7_PRIVATE int PH7_builtin_ctype_space(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 | 2116 | `{` |
|     - | 2117 | `	const unsigned char *zIn,*zEnd;` |
|     - | 2118 | `	int nLen;` |
| 16534 | 2119 | `	if( nArg < 1 ){` |
|     - | 2120 | `		/* Missing arguments,return FALSE */` |
|   ! 0 | 2121 | `		ph7_result_bool(pCtx,0);` |
|   ! 0 | 2122 | `		return PH7_OK;` |
|     - | 2123 | `	}` |
|     - | 2124 | `	/* Extract the target string */` |
| 16534 | 2125 | `	zIn  = (const unsigned char *)ph7_value_to_string(apArg[0],&nLen);` |
| 16534 | 2126 | `	zEnd = &zIn[nLen];` |
| 16534 | 2127 | `	if( nLen < 1 ){` |
...
| 16522 | 2150 | `	ph7_result_bool(pCtx,0);` |
| 16522 | 2151 | `	return PH7_OK;` |
|  8327 | 2152 | `}` |
|     - | 2153 | `/*` |
