...
|     - | 1872 | ` */` |
|  1830 | 1873 | `PH7_PRIVATE int PH7_builtin_ctype_digit(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 | 1874 | `{` |
...
|  1835 | 1883 | `	zIn  = (const unsigned char *)ph7_value_to_string(apArg[0],&nLen);` |
|  1835 | 1884 | `	zEnd = &zIn[nLen];` |
|  1835 | 1885 | `	if( nLen < 1 ){` |
...
|  1701 | 1891 | `	for(;;){` |
|  3407 | 1892 | `		if( zIn >= zEnd ){` |
|     - | 1893 | `			/* If we reach the end of the string,then the test succeeded. */` |
|  1517 | 1894 | `			ph7_result_bool(pCtx,1);` |
|  1517 | 1895 | `			return PH7_OK;` |
|     - | 1896 | `		}` |
|  1895 | 1897 | `		if( zIn[0] >= 0xc0 ){` |
|     - | 1898 | `			/* UTF-8 stream  */` |
|   ! 0 | 1899 | `			break;` |
|     - | 1900 | `		}` |
|  1895 | 1901 | `		if( !SyisDigit(zIn[0]) ){` |
|   315 | 1902 | `			break;` |
|     - | 1903 | `		}` |
...
|   315 | 1908 | `	ph7_result_bool(pCtx,0);` |
|   315 | 1909 | `	return PH7_OK;` |
|   920 | 1910 | `}` |
|     - | 1911 | `/*` |
...
|     - | 2114 | ` */` |
| 16417 | 2115 | `PH7_PRIVATE int PH7_builtin_ctype_space(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 | 2116 | `{` |
|     - | 2117 | `	const unsigned char *zIn,*zEnd;` |
|     - | 2118 | `	int nLen;` |
| 16422 | 2119 | `	if( nArg < 1 ){` |
|     - | 2120 | `		/* Missing arguments,return FALSE */` |
|   ! 0 | 2121 | `		ph7_result_bool(pCtx,0);` |
|   ! 0 | 2122 | `		return PH7_OK;` |
|     - | 2123 | `	}` |
|     - | 2124 | `	/* Extract the target string */` |
| 16422 | 2125 | `	zIn  = (const unsigned char *)ph7_value_to_string(apArg[0],&nLen);` |
| 16422 | 2126 | `	zEnd = &zIn[nLen];` |
| 16422 | 2127 | `	if( nLen < 1 ){` |
...
| 16410 | 2150 | `	ph7_result_bool(pCtx,0);` |
| 16410 | 2151 | `	return PH7_OK;` |
|  8270 | 2152 | `}` |
|     - | 2153 | `/*` |
