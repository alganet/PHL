...
|     - | 1872 | ` */` |
|  1795 | 1873 | `PH7_PRIVATE int PH7_builtin_ctype_digit(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 | 1874 | `{` |
...
|  1800 | 1883 | `	zIn  = (const unsigned char *)ph7_value_to_string(apArg[0],&nLen);` |
|  1800 | 1884 | `	zEnd = &zIn[nLen];` |
|  1800 | 1885 | `	if( nLen < 1 ){` |
...
|  1671 | 1891 | `	for(;;){` |
|  3345 | 1892 | `		if( zIn >= zEnd ){` |
|     - | 1893 | `			/* If we reach the end of the string,then the test succeeded. */` |
|  1490 | 1894 | `			ph7_result_bool(pCtx,1);` |
|  1490 | 1895 | `			return PH7_OK;` |
|     - | 1896 | `		}` |
|  1860 | 1897 | `		if( zIn[0] >= 0xc0 ){` |
|     - | 1898 | `			/* UTF-8 stream  */` |
|   ! 0 | 1899 | `			break;` |
|     - | 1900 | `		}` |
|  1860 | 1901 | `		if( !SyisDigit(zIn[0]) ){` |
|   307 | 1902 | `			break;` |
|     - | 1903 | `		}` |
