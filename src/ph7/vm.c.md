...
Coverage: 5029/7224 lines (69.62%)
...
|       - |   168 | ` */` |
| 1018420 |   169 | `PH7_PRIVATE sxi32 PH7_VmRegisterConstant(` |
...
|       - |   178 | `	char *zDupName;` |
|       - |   179 | `	sxi32 rc;` |
| 1018421 |   180 | `	pEntry = SyHashGet(&pVm->hConstant,(const void *)pName->zString,pName->nByte);` |
| 1018421 |   181 | `	if( pEntry ){` |
|       - |   182 | `		/* Overwrite the old definition and return immediately */` |
|       5 |   183 | `		pCons = (ph7_constant *)pEntry->pUserData;` |
|       5 |   184 | `		pCons->xExpand = xExpand;` |
|       5 |   185 | `		pCons->pUserData = pUserData;` |
|       5 |   186 | `		return SXRET_OK;` |
|       - |   187 | `	}` |
|       - |   188 | `	/* Allocate a new constant instance */` |
| 1018417 |   189 | `	pCons = (ph7_constant *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_constant));` |
| 1018417 |   190 | `	if( pCons == 0 ){` |
|     ! 0 |   191 | `		return 0;` |
|       - |   192 | `	}` |
|       - |   193 | `	/* Duplicate constant name */` |
| 1018417 |   194 | `	zDupName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
| 1018417 |   195 | `	if( zDupName == 0 ){` |
|     ! 0 |   196 | `		SyMemBackendPoolFree(&pVm->sAllocator,pCons);` |
|     ! 0 |   197 | `		return 0;` |
|       - |   198 | `	}` |
|       - |   199 | `	/* Install the constant */` |
| 1018417 |   200 | `	SyStringInitFromBuf(&pCons->sName,zDupName,pName->nByte);` |
| 1018417 |   201 | `	pCons->xExpand = xExpand;` |
| 1018417 |   202 | `	pCons->pUserData = pUserData;` |
| 1018417 |   203 | `	rc = SyHashInsert(&pVm->hConstant,(const void *)zDupName,SyStringLength(&pCons->sName),pCons);` |
| 1018417 |   204 | `	if( rc != SXRET_OK ){` |
...
|       - |   218 | ` */` |
| 2215020 |   219 | `static sxi32 PH7_NewForeignFunction(` |
...
| 2215021 |   230 | `	pFunc = (ph7_user_func *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_user_func));` |
| 2215021 |   231 | `	if( pFunc == 0 ){` |
|     ! 0 |   232 | `		return SXERR_MEM;` |
|       - |   233 | `	}` |
|       - |   234 | `	/* Duplicate function name */` |
| 2215021 |   235 | `	zDup = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
| 2215021 |   236 | `	if( zDup == 0 ){` |
|     ! 0 |   237 | `		SyMemBackendPoolFree(&pVm->sAllocator,pFunc);` |
|     ! 0 |   238 | `		return SXERR_MEM;` |
|       - |   239 | `	}` |
|       - |   240 | `	/* Zero the structure */` |
| 2215021 |   241 | `	SyZero(pFunc,sizeof(ph7_user_func));` |
|       - |   242 | `	/* Initialize structure fields */` |
| 2215021 |   243 | `	SyStringInitFromBuf(&pFunc->sName,zDup,pName->nByte);` |
| 2215021 |   244 | `	pFunc->pVm   = pVm;` |
| 2215021 |   245 | `	pFunc->xFunc = xFunc;` |
| 2215021 |   246 | `	pFunc->pUserData = pUserData;` |
| 2215021 |   247 | `	SySetInit(&pFunc->aAux,&pVm->sAllocator,sizeof(ph7_aux_data));` |
|       - |   248 | `	/* Write a pointer to the new function */` |
| 2215021 |   249 | `	*ppOut = pFunc;` |
| 2215021 |   250 | `	return SXRET_OK;` |
| 1107511 |   251 |  |
|       - |   252 | `/*` |
...
|       - |   259 | ` */` |
| 2220112 |   260 | `PH7_PRIVATE sxi32 PH7_VmInstallForeignFunction(` |
...
| 2220113 |   271 | `	pEntry = SyHashGet(&pVm->hHostFunction,pName->zString,pName->nByte);` |
| 2220113 |   272 | `	if( pEntry ){` |
|    5093 |   273 | `		pFunc = (ph7_user_func *)pEntry->pUserData;` |
|    5093 |   274 | `		pFunc->pUserData = pUserData;` |
|    5093 |   275 | `		pFunc->xFunc = xFunc;` |
|    5093 |   276 | `		SySetReset(&pFunc->aAux);` |
|    5093 |   277 | `		return SXRET_OK;` |
|       - |   278 | `	}` |
|       - |   279 | `	/* Create a new user function */` |
| 2215021 |   280 | `	rc = PH7_NewForeignFunction(&(*pVm),&(*pName),xFunc,pUserData,&pFunc);` |
| 2215021 |   281 | `	if( rc != SXRET_OK ){` |
|     ! 0 |   282 | `		return rc;` |
|       - |   283 | `	}` |
|       - |   284 | `	/* Install the function in the corresponding hashtable */` |
| 2215021 |   285 | `	rc = SyHashInsert(&pVm->hHostFunction,SyStringData(&pFunc->sName),pName->nByte,pFunc);` |
| 2215021 |   286 | `	if( rc != SXRET_OK ){` |
...
| 2215021 |   292 | `	return SXRET_OK;` |
| 1110057 |   293 |  |
|       - |   294 | `/*` |
|       - |   295 | ` * Initialize a VM function.` |
|       - |   296 | ` */` |
|  224626 |   297 | `PH7_PRIVATE sxi32 PH7_VmInitFuncState(` |
...
|  224627 |   307 | `	SyZero(pFunc,sizeof(ph7_vm_func));` |
|       - |   308 | `	/* Initialize structure fields */` |
|       - |   309 | `	/* Arguments container */` |
|  224627 |   310 | `	SySetInit(&pFunc->aArgs,&pVm->sAllocator,sizeof(ph7_vm_func_arg));` |
|       - |   311 | `	/* Static variable container */` |
|  224627 |   312 | `	SySetInit(&pFunc->aStatic,&pVm->sAllocator,sizeof(ph7_vm_func_static_var));` |
|       - |   313 | `	/* Bytecode container */` |
|  224627 |   314 | `	SySetInit(&pFunc->aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|       - |   315 | `    /* Preallocate some instruction slots */` |
|  224627 |   316 | `	SySetAlloc(&pFunc->aByteCode,0x10);` |
|       - |   317 | `	/* Closure environment */` |
|  224627 |   318 | `	SySetInit(&pFunc->aClosureEnv,&pVm->sAllocator,sizeof(ph7_vm_func_closure_env));` |
|  224627 |   319 | `	pFunc->iFlags = iFlags;` |
|  224627 |   320 | `	pFunc->pUserData = pUserData;` |
|  224627 |   321 | `	SyStringInitFromBuf(&pFunc->sName,zName,nByte);` |
|  224627 |   322 | `	return SXRET_OK;` |
|       1 |   323 |  |
|       - |   324 | `/*` |
|       - |   325 | ` * Install a user defined function in the corresponding VM container.` |
|       - |   326 | ` */` |
|  372316 |   327 | `PH7_PRIVATE sxi32 PH7_VmInstallUserFunction(` |
...
|       - |   334 | `	sxi32 rc;` |
|  372317 |   335 | `	if( pName == 0 ){` |
|       - |   336 | `		/* Use the built-in name */` |
|   69733 |   337 | `		pName = &pFunc->sName;` |
|   34866 |   338 | `	}` |
|       - |   339 | `	/* Check for duplicates (functions with the same name) first */` |
|  372317 |   340 | `	pEntry = SyHashGet(&pVm->hFunction,pName->zString,pName->nByte);` |
|  372317 |   341 | `	if( pEntry ){` |
|  190393 |   342 | `		ph7_vm_func *pLink = (ph7_vm_func *)pEntry->pUserData;` |
|  190393 |   343 | `		if( pLink != pFunc ){` |
|       - |   344 | `			/* Link */` |
|       7 |   345 | `			pFunc->pNextName = pLink;` |
|       7 |   346 | `			pEntry->pUserData = pFunc;` |
|       3 |   347 | `		}` |
|  190393 |   348 | `		return SXRET_OK;` |
|       - |   349 | `	}` |
|       - |   350 | `	/* First time seen */` |
|  181925 |   351 | `	pFunc->pNextName = 0;` |
|  181925 |   352 | `	rc = SyHashInsert(&pVm->hFunction,pName->zString,pName->nByte,pFunc);` |
|  181925 |   353 | `	return rc;` |
|  186159 |   354 |  |
|       - |   355 | `/*` |
|       - |   356 | ` * Install a user defined class in the corresponding VM container.` |
|       - |   357 | ` */` |
|   37598 |   358 | `PH7_PRIVATE sxi32 PH7_VmInstallClass(` |
|       - |   359 | `	ph7_vm *pVm,      /* Target VM  */` |
|       - |   360 | `	ph7_class *pClass /* Target Class */` |
|       - |   361 | `	)` |
|       1 |   362 |  |
|   37599 |   363 | `	SyString *pName = &pClass->sName;` |
|       - |   364 | `	SyHashEntry *pEntry;` |
|       - |   365 | `	sxi32 rc;` |
|       - |   366 | `	/* Check for duplicates */` |
|   37599 |   367 | `	pEntry = SyHashGet(&pVm->hClass,(const void *)pName->zString,pName->nByte);` |
|   37599 |   368 | `	if( pEntry ){` |
|       3 |   369 | `		ph7_class *pLink = (ph7_class *)pEntry->pUserData;` |
|       - |   370 | `		/* Link entry with the same name */` |
|       3 |   371 | `		pClass->pNextName = pLink;` |
|       3 |   372 | `		pEntry->pUserData = pClass;` |
|       3 |   373 | `		return SXRET_OK;` |
|       - |   374 | `	}` |
|   37597 |   375 | `	pClass->pNextName = 0;` |
|       - |   376 | `	/* Perform a simple hashtable insertion */` |
|   37597 |   377 | `	rc = SyHashInsert(&pVm->hClass,(const void *)pName->zString,pName->nByte,pClass);` |
|   37597 |   378 | `	return rc;` |
|   18800 |   379 |  |
|       - |   380 | `/*` |
|       - |   381 | ` * Instruction builder interface.` |
|       - |   382 | ` */` |
| 5237070 |   383 | `PH7_PRIVATE sxi32 PH7_VmEmitInstr(` |
...
| 5237071 |   395 | `	sInstr.iOp = (sxu8)iOp;` |
| 5237071 |   396 | `	sInstr.iP1 = iP1;` |
| 5237071 |   397 | `	sInstr.iP2 = iP2;` |
| 5237071 |   398 | `	sInstr.p3  = p3;` |
| 5237071 |   399 | `	if( pIndex ){` |
|       - |   400 | `		/* Instruction index in the bytecode array */` |
|  316949 |   401 | `		*pIndex = SySetUsed(pVm->pByteContainer);` |
|  158474 |   402 | `	}` |
|       - |   403 | `	/* Finally,record the instruction */` |
| 5237071 |   404 | `	rc = SySetPut(pVm->pByteContainer,(const void *)&sInstr);` |
| 5237071 |   405 | `	if( rc != SXRET_OK ){` |
|     ! 0 |   406 | `		PH7_GenCompileError(&pVm->sCodeGen,E_ERROR,1,"Fatal,Cannot emit instruction due to a memory failure");` |
|       - |   407 | `		/* Fall throw */` |
|     ! 0 |   408 | `	}` |
| 5237071 |   409 | `	return rc;` |
|       1 |   410 |  |
|       - |   411 | `/*` |
|       - |   412 | ` * Swap the current bytecode container with the given one.` |
|       - |   413 | ` */` |
|  545728 |   414 | `PH7_PRIVATE sxi32 PH7_VmSetByteCodeContainer(ph7_vm *pVm,SySet *pContainer)` |
|       1 |   415 |  |
|  545729 |   416 | `	if( pContainer == 0 ){` |
|       - |   417 | `		/* Point to the default container */` |
|     ! 0 |   418 | `		pVm->pByteContainer = &pVm->aByteCode;` |
|     ! 0 |   419 | `	}else{` |
|       - |   420 | `		/* Change container */` |
|  545729 |   421 | `		pVm->pByteContainer = &(*pContainer);` |
|       - |   422 | `	}` |
|  545729 |   423 | `	return SXRET_OK;` |
|       1 |   424 |  |
|       - |   425 | `/*` |
|       - |   426 | ` * Return the current bytecode container.` |
|       - |   427 | ` */` |
|  272864 |   428 | `PH7_PRIVATE SySet * PH7_VmGetByteCodeContainer(ph7_vm *pVm)` |
|       1 |   429 |  |
|  272865 |   430 | `	return pVm->pByteContainer;` |
|       1 |   431 |  |
|       - |   432 | `/*` |
|       - |   433 | ` * Extract the VM instruction rooted at nIndex.` |
|       - |   434 | ` */` |
|  311546 |   435 | `PH7_PRIVATE VmInstr * PH7_VmGetInstr(ph7_vm *pVm,sxu32 nIndex)` |
|       1 |   436 |  |
|       - |   437 | `	VmInstr *pInstr;` |
|  311547 |   438 | `	pInstr = (VmInstr *)SySetAt(pVm->pByteContainer,nIndex);` |
|  311547 |   439 | `	return pInstr;` |
|       1 |   440 |  |
|       - |   441 | `/*` |
|       - |   442 | ` * Return the total number of VM instructions recorded so far.` |
|       - |   443 | ` */` |
| 1569538 |   444 | `PH7_PRIVATE sxu32 PH7_VmInstrLength(ph7_vm *pVm)` |
|       1 |   445 |  |
| 1569539 |   446 | `	return SySetUsed(pVm->pByteContainer);` |
|       1 |   447 |  |
|       - |   448 | `/*` |
|       - |   449 | ` * Pop the last VM instruction.` |
|       - |   450 | ` */` |
|  304366 |   451 | `PH7_PRIVATE VmInstr * PH7_VmPopInstr(ph7_vm *pVm)` |
|       1 |   452 |  |
|  304367 |   453 | `	return (VmInstr *)SySetPop(pVm->pByteContainer);` |
|       1 |   454 |  |
|       - |   455 | `/*` |
|       - |   456 | ` * Peek the last VM instruction.` |
|       - |   457 | ` */` |
|  809640 |   458 | `PH7_PRIVATE VmInstr * PH7_VmPeekInstr(ph7_vm *pVm)` |
|       1 |   459 |  |
|  809641 |   460 | `	return (VmInstr *)SySetPeek(pVm->pByteContainer);` |
|       1 |   461 |  |
|   10894 |   462 | `PH7_PRIVATE VmInstr * PH7_VmPeekNextInstr(ph7_vm *pVm)` |
|       1 |   463 |  |
|       - |   464 | `	VmInstr *aInstr;` |
|       - |   465 | `	sxu32 n;` |
|   10895 |   466 | `	n = SySetUsed(pVm->pByteContainer);` |
|   10895 |   467 | `	if( n < 2 ){` |
|     ! 0 |   468 | `		return 0;` |
|       - |   469 | `	}` |
|   10895 |   470 | `	aInstr = (VmInstr *)SySetBasePtr(pVm->pByteContainer);` |
|   10895 |   471 | `	return &aInstr[n - 2];` |
|    5448 |   472 |  |
|       - |   473 | `/*` |
|       - |   474 | ` * Allocate a new virtual machine frame.` |
|       - |   475 | ` */` |
|    6638 |   476 | `static VmFrame * VmNewFrame(` |
...
|    6639 |   484 | `	pFrame = (VmFrame *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmFrame));` |
|    6639 |   485 | `	if( pFrame == 0 ){` |
|     ! 0 |   486 | `		return 0;` |
|       - |   487 | `	}` |
|       - |   488 | `	/* Zero the structure */` |
|    6639 |   489 | `	SyZero(pFrame,sizeof(VmFrame));` |
|       - |   490 | `	/* Initialize frame fields */` |
|    6639 |   491 | `	pFrame->pUserData = pUserData;` |
|    6639 |   492 | `	pFrame->pThis = pThis;` |
|    6639 |   493 | `	pFrame->pVm = pVm;` |
|    6639 |   494 | `	SyHashInit(&pFrame->hVar,&pVm->sAllocator,0,0);` |
|    6639 |   495 | `	SySetInit(&pFrame->sArg,&pVm->sAllocator,sizeof(VmSlot));` |
|    6639 |   496 | `	SySetInit(&pFrame->sLocal,&pVm->sAllocator,sizeof(VmSlot));` |
|    6639 |   497 | `	SySetInit(&pFrame->sRef,&pVm->sAllocator,sizeof(VmSlot));` |
|    6639 |   498 | `	return pFrame;` |
|    3320 |   499 |  |
|       - |   500 | `/*` |
|       - |   501 | ` * Enter a VM frame.` |
|       - |   502 | ` */` |
|    6638 |   503 | `static sxi32 VmEnterFrame(` |
...
|    6639 |   512 | `	pFrame = VmNewFrame(&(*pVm),pUserData,pThis);` |
|    6639 |   513 | `	if( pFrame == 0 ){` |
|     ! 0 |   514 | `		return SXERR_MEM;` |
|       - |   515 | `	}` |
|       - |   516 | `	/* Link to the list of active VM frame */` |
|    6639 |   517 | `	pFrame->pParent = pVm->pFrame;` |
|    6639 |   518 | `	pVm->pFrame = pFrame;` |
|    6639 |   519 | `	if( ppFrame ){` |
|       - |   520 | `		/* Write a pointer to the new VM frame */` |
|    1305 |   521 | `		*ppFrame = pFrame;` |
|     652 |   522 | `	}` |
|    6639 |   523 | `	return SXRET_OK;` |
|    3320 |   524 |  |
|       - |   525 | `/*` |
...
|       - |   528 | ` * information.` |
|       - |   529 | ` */` |
|      32 |   530 | `static sxi32 VmFrameLink(ph7_vm *pVm,SyString *pName)` |
|       1 |   531 |  |
|       - |   532 | `	VmFrame *pTarget,*pFrame;` |
|      33 |   533 | `	SyHashEntry *pEntry = 0;` |
|       - |   534 | `	sxi32 rc;` |
|       - |   535 | `	/* Point to the upper frame */` |
|      33 |   536 | `	pFrame = pVm->pFrame;` |
|      33 |   537 | `	while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|       - |   538 | `		/* Safely ignore the exception frame */` |
|     ! 0 |   539 | `		pFrame = pFrame->pParent;` |
|     ! 0 |   540 | `	}` |
|      33 |   541 | `	pTarget = pFrame;` |
|      33 |   542 | `	pFrame = pTarget->pParent;` |
|      33 |   543 | `	while( pFrame ){` |
|      33 |   544 | `		if( (pFrame->iFlags & VM_FRAME_EXCEPTION) == 0 ){` |
|       - |   545 | `			/* Query the current frame */` |
|      33 |   546 | `			pEntry = SyHashGet(&pFrame->hVar,(const void *)pName->zString,pName->nByte);` |
|      33 |   547 | `			if( pEntry ){` |
|       - |   548 | `				/* Variable found */` |
|      33 |   549 | `				break;` |
|       - |   550 | `			}` |
...
|      33 |   560 | `	rc = SyHashInsert(&pTarget->hVar,pEntry->pKey,pEntry->nKeyLen,pEntry->pUserData);` |
|      33 |   561 | `	if( rc == SXRET_OK ){` |
|       - |   562 | `		sxu32 nIdx;` |
|      33 |   563 | `		nIdx = SX_PTR_TO_INT(pEntry->pUserData);` |
|      33 |   564 | `		PH7_VmRefObjInstall(&(*pVm),nIdx,SyHashLastEntry(&pTarget->hVar),0,0);` |
|      16 |   565 | `	}` |
|      33 |   566 | `	return rc;` |
|      17 |   567 |  |
|       - |   568 | `/*` |
...
|       - |   570 | ` */` |
|    1304 |   571 | `static void VmLeaveFrame(ph7_vm *pVm)` |
|       1 |   572 |  |
|    1305 |   573 | `		VmFrame *pCurFrame = pVm->pFrame;` |
|    1305 |   574 | `	if( pCurFrame ){` |
|       - |   575 | `		/* Unlink from the list of active VM frame */` |
|    1305 |   576 | `		pVm->pFrame = pCurFrame->pParent;` |
|    1305 |   577 | `		if( pCurFrame->pParent && (pCurFrame->iFlags & VM_FRAME_EXCEPTION) == 0 ){` |
|       - |   578 | `			VmSlot  *aSlot;` |
|       - |   579 | `			sxu32 n;` |
|       - |   580 | `			/* Restore local variable to the free pool so that they can be reused again */` |
|    1285 |   581 | `			aSlot = (VmSlot *)SySetBasePtr(&pCurFrame->sLocal);` |
|    3363 |   582 | `			for(n = 0 ; n < SySetUsed(&pCurFrame->sLocal) ; ++n ){` |
|       - |   583 | `				/* Unset the local variable */` |
|    2079 |   584 | `				PH7_VmUnsetMemObj(&(*pVm),aSlot[n].nIdx,FALSE);` |
|    1040 |   585 | `			}` |
|       - |   586 | `			/* Remove local reference */` |
|    1285 |   587 | `			aSlot = (VmSlot *)SySetBasePtr(&pCurFrame->sRef);` |
|    3399 |   588 | `			for(n = 0 ; n < SySetUsed(&pCurFrame->sRef) ; ++n ){` |
|    2115 |   589 | `				PH7_VmRefObjRemove(&(*pVm),aSlot[n].nIdx,(SyHashEntry *)aSlot[n].pUserData,0);` |
|    1058 |   590 | `			}` |
|     642 |   591 | `		}` |
|       - |   592 | `		/* Release internal containers */` |
|    1305 |   593 | `		SyHashRelease(&pCurFrame->hVar);` |
|    1305 |   594 | `		SySetRelease(&pCurFrame->sArg);` |
|    1305 |   595 | `		SySetRelease(&pCurFrame->sLocal);` |
|    1305 |   596 | `		SySetRelease(&pCurFrame->sRef);` |
|       - |   597 | `		/* Release the whole structure */` |
|    1305 |   598 | `		SyMemBackendPoolFree(&pVm->sAllocator,pCurFrame);` |
|     652 |   599 | `	}` |
|    1305 |   600 |  |
|       - |   601 | `/*` |
|       - |   602 | ` * Compare two functions signature and return the comparison result.` |
|       - |   603 | ` */` |
|     ! 0 |   604 | `static int VmOverloadCompare(SyString *pFirst,SyString *pSecond)` |
|     ! 0 |   605 |  |
|     ! 0 |   606 | `	const char *zSend = &pSecond->zString[pSecond->nByte];` |
|     ! 0 |   607 | `	const char *zFend = &pFirst->zString[pFirst->nByte];` |
|     ! 0 |   608 | `	const char *zSin = pSecond->zString;` |
|     ! 0 |   609 | `	const char *zFin = pFirst->zString;` |
|     ! 0 |   610 | `	const char *zPtr = zFin;` |
|     ! 0 |   611 | `	for(;;){` |
|     ! 0 |   612 | `		if( zFin >= zFend \|\| zSin >= zSend ){` |
|     ! 0 |   613 | `			break;` |
|       - |   614 | `		}` |
...
|       - |   629 | ` */` |
|       8 |   630 | `static ph7_vm_func * VmOverload(` |
...
|      31 |   646 | `	while( i < (int)SX_ARRAYSIZE(apSet) ){` |
|      31 |   647 | `		if( pLink == 0 ){` |
|       9 |   648 | `			break;` |
|       - |   649 | `		}` |
|      23 |   650 | `		if( (int)SySetUsed(&pLink->aArgs) == nArg ){` |
|       - |   651 | `			/* Candidate for overloading */` |
|      11 |   652 | `			apSet[i++] = pLink;` |
|       5 |   653 | `		}` |
|       - |   654 | `		/* Point to the next entry */` |
|      23 |   655 | `		pLink = pLink->pNextName;` |
|       1 |   656 | `	}` |
|       9 |   657 | `	if( i < 1 ){` |
...
|       9 |   663 | `		return apSet[0];` |
|       - |   664 | `	}` |
|       - |   665 | `	/* Calculate function signature */` |
|     ! 0 |   666 | `	SyBlobInit(&sSig,&pVm->sAllocator);` |
|     ! 0 |   667 | `	for( j = 0 ; j < nArg ; j++ ){` |
|     ! 0 |   668 | `		int c = 'n'; /* null */` |
|     ! 0 |   669 | `		if( aArg[j].iFlags & MEMOBJ_HASHMAP ){` |
|       - |   670 | `			/* Hashmap */` |
|     ! 0 |   671 | `			c = 'h';` |
|     ! 0 |   672 | `		}else if( aArg[j].iFlags & MEMOBJ_BOOL ){` |
|       - |   673 | `			/* bool */` |
|     ! 0 |   674 | `			c = 'b';` |
|     ! 0 |   675 | `		}else if( aArg[j].iFlags & MEMOBJ_INT ){` |
|       - |   676 | `			/* int */` |
|     ! 0 |   677 | `			c = 'i';` |
|     ! 0 |   678 | `		}else if( aArg[j].iFlags & MEMOBJ_STRING ){` |
|       - |   679 | `			/* String */` |
|     ! 0 |   680 | `			c = 's';` |
|     ! 0 |   681 | `		}else if( aArg[j].iFlags & MEMOBJ_REAL ){` |
|       - |   682 | `			/* Float */` |
|     ! 0 |   683 | `			c = 'f';` |
|     ! 0 |   684 | `		}else if( aArg[j].iFlags & MEMOBJ_OBJ ){` |
|       - |   685 | `			/* Class instance */` |
...
|     ! 0 |   690 | `		}` |
|     ! 0 |   691 | `		if( c > 0 ){` |
|     ! 0 |   692 | `			SyBlobAppend(&sSig,(const void *)&c,sizeof(char));` |
|     ! 0 |   693 | `		}` |
|     ! 0 |   694 | `	}` |
|     ! 0 |   695 | `	SyStringInitFromBuf(&sArgSig,SyBlobData(&sSig),SyBlobLength(&sSig));` |
|     ! 0 |   696 | `	iTarget = 0;` |
|     ! 0 |   697 | `	iMax = -1;` |
|       - |   698 | `	/* Select the appropriate function */` |
|     ! 0 |   699 | `	for( j = 0 ; j < i ; j++ ){` |
|       - |   700 | `		/* Compare the two signatures */` |
|     ! 0 |   701 | `		iCur = VmOverloadCompare(&sArgSig,&apSet[j]->sSignature);` |
|     ! 0 |   702 | `		if( iCur > iMax ){` |
|     ! 0 |   703 | `			iMax = iCur;` |
|     ! 0 |   704 | `			iTarget = j;` |
|     ! 0 |   705 | `		}` |
|     ! 0 |   706 | `	}` |
|     ! 0 |   707 | `	SyBlobRelease(&sSig);` |
|       - |   708 | `	/* Appropriate function for the current call context */` |
|     ! 0 |   709 | `	return apSet[iTarget];` |
|       5 |   710 |  |
...
|       - |   717 | ` */` |
|   73318 |   718 | `PH7_PRIVATE sxi32 VmMountUserClass(` |
...
|   73319 |   728 | `	SyHashResetLoopCursor(&pClass->hAttr);` |
|       - |   729 | `	/* Process only static and constant attribute */` |
|  277008 |   730 | `	while( (pEntry = SyHashGetNextEntry(&pClass->hAttr)) != 0 ){` |
|       - |   731 | `		/* Extract the current attribute */` |
|  167031 |   732 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|  167031 |   733 | `		if( pAttr->iFlags & (PH7_CLASS_ATTR_CONSTANT\|PH7_CLASS_ATTR_STATIC) ){` |
|       - |   734 | `			ph7_value *pMemObj;` |
|       - |   735 | `			/* Reserve a memory object for this constant/static attribute */` |
|      17 |   736 | `			pMemObj = PH7_ReserveMemObj(&(*pVm));` |
|      17 |   737 | `			if( pMemObj == 0 ){` |
...
|       - |   743 | `			}` |
|      17 |   744 | `			if( SySetUsed(&pAttr->aByteCode) > 0 ){` |
|       - |   745 | `				/* Initialize attribute default value (any complex expression) */` |
|      17 |   746 | `				VmLocalExec(&(*pVm),&pAttr->aByteCode,pMemObj);` |
|       8 |   747 | `			}` |
|       - |   748 | `			/* Record attribute index */` |
|      17 |   749 | `			pAttr->nIdx = pMemObj->nIdx;` |
|       - |   750 | `			/* Install static attribute in the reference table */` |
|      17 |   751 | `			PH7_VmRefObjInstall(&(*pVm),pMemObj->nIdx,0,0,VM_REF_IDX_KEEP);` |
|       8 |   752 | `		}` |
|       1 |   753 | `	}` |
|       - |   754 | `	/* Install class methods */` |
|   73319 |   755 | `	if( pClass->iFlags & PH7_CLASS_INTERFACE ){` |
|       - |   756 | `		/* Do not mount interface methods since they are signatures only.` |
|       - |   757 | `		 */` |
|   31379 |   758 | `		return SXRET_OK;` |
|       - |   759 | `	}` |
|       - |   760 | `	/* Create constructor alias if not yet done */` |
|   41941 |   761 | `	if( SyHashGet(&pClass->hMethod,"__construct",sizeof("__construct")-1) == 0 ){` |
|       - |   762 | `		/* User constructor with the same base class name */` |
|     207 |   763 | `		pEntry = SyHashGet(&pClass->hMethod,SyStringData(&pClass->sName),SyStringLength(&pClass->sName));` |
|     207 |   764 | `		if( pEntry ){` |
...
|   41941 |   771 | `	SyHashResetLoopCursor(&pClass->hMethod);` |
|  365501 |   772 | `	while((pEntry = SyHashGetNextEntry(&pClass->hMethod)) != 0 ){` |
|  302591 |   773 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|  302591 |   774 | `		if( (pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT) == 0 ){` |
|  302585 |   775 | `			rc = PH7_VmInstallUserFunction(&(*pVm),&pMeth->sFunc,&pMeth->sVmName);` |
|  302585 |   776 | `			if( rc != SXRET_OK ){` |
|     ! 0 |   777 | `				return rc;` |
|       - |   778 | `			}` |
|  151292 |   779 | `		}` |
|       1 |   780 | `	}` |
|       - |   781 | `	/* Mark class as mounted to avoid redundant mounting */` |
|   41941 |   782 | `	pClass->bMounted = TRUE;` |
|   41941 |   783 | `	return SXRET_OK;` |
|   36660 |   784 |  |
|       - |   785 | `/*` |
|       - |   786 | ` * Allocate a private frame for attributes of the given` |
|       - |   787 | ` * class instance (Object in the PHP jargon).` |
|       - |   788 | ` */` |
|     558 |   789 | `PH7_PRIVATE sxi32 PH7_VmCreateClassInstanceFrame(` |
|       - |   790 | `	ph7_vm *pVm, /* Target VM */` |
|       - |   791 | `	ph7_class_instance *pObj /* Class instance */` |
|       - |   792 | `	)` |
|       1 |   793 |  |
|     559 |   794 | `	ph7_class *pClass = pObj->pClass;` |
...
|     559 |   799 | `	SyHashResetLoopCursor(&pClass->hAttr);` |
|    1225 |   800 | `	while( (pEntry = SyHashGetNextEntry(&pClass->hAttr)) != 0 ){` |
|       - |   801 | `		VmClassAttr *pVmAttr;` |
|       - |   802 | `		/* Extract the current attribute */` |
|     667 |   803 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|     667 |   804 | `		pVmAttr = (VmClassAttr *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmClassAttr));` |
|     667 |   805 | `		if( pVmAttr == 0 ){` |
|     ! 0 |   806 | `			return SXERR_MEM;` |
|       - |   807 | `		}` |
|     667 |   808 | `		pVmAttr->pAttr = pAttr;` |
|     667 |   809 | `		if( (pAttr->iFlags & (PH7_CLASS_ATTR_CONSTANT\|PH7_CLASS_ATTR_STATIC)) == 0 ){` |
|       - |   810 | `			ph7_value *pMemObj;` |
|       - |   811 | `			/* Reserve a memory object for this attribute */` |
|     661 |   812 | `			pMemObj = PH7_ReserveMemObj(&(*pVm));` |
|     661 |   813 | `			if( pMemObj == 0 ){` |
|     ! 0 |   814 | `				SyMemBackendPoolFree(&pVm->sAllocator,pVmAttr);` |
|     ! 0 |   815 | `				return SXERR_MEM;` |
|       - |   816 | `			}` |
|     661 |   817 | `			pVmAttr->nIdx = pMemObj->nIdx;` |
|     661 |   818 | `			if( SySetUsed(&pAttr->aByteCode) > 0 ){` |
|       - |   819 | `				/* Initialize attribute default value (any complex expression) */` |
|     199 |   820 | `				VmLocalExec(&(*pVm),&pAttr->aByteCode,pMemObj);` |
|      99 |   821 | `			}` |
|     661 |   822 | `			rc = SyHashInsert(&pObj->hAttr,SyStringData(&pAttr->sName),SyStringLength(&pAttr->sName),pVmAttr);` |
|     661 |   823 | `			if( rc != SXRET_OK ){` |
|       - |   824 | `				VmSlot sSlot;` |
...
|     661 |   833 | `			PH7_VmRefObjInstall(&(*pVm),pMemObj->nIdx,0,0,VM_REF_IDX_KEEP);` |
|     331 |   834 | `		}else{` |
|       - |   835 | `			/* Install static/constant attribute */` |
|       7 |   836 | `			pVmAttr->nIdx = pAttr->nIdx;` |
|       7 |   837 | `			rc = SyHashInsert(&pObj->hAttr,SyStringData(&pAttr->sName),SyStringLength(&pAttr->sName),pVmAttr);` |
|       7 |   838 | `			if( rc != SXRET_OK ){` |
|     ! 0 |   839 | `				SyMemBackendPoolFree(&pVm->sAllocator,pVmAttr);` |
|     ! 0 |   840 | `				return SXERR_MEM;` |
|       - |   841 | `			}` |
|       - |   842 | `		}` |
|       1 |   843 | `	}` |
|     559 |   844 | `	return SXRET_OK;` |
|     280 |   845 |  |
...
|       - |   856 | ` */` |
|  559466 |   857 | `PH7_PRIVATE ph7_value * PH7_ReserveConstObj(ph7_vm *pVm,sxu32 *pIndex)` |
|       1 |   858 |  |
|       - |   859 | `	ph7_value *pObj;` |
|       - |   860 | `	sxi32 rc;` |
|  559467 |   861 | `	if( pIndex ){` |
|       - |   862 | `		/* Object index in the object table */` |
|  543465 |   863 | `		*pIndex = SySetUsed(&pVm->aLitObj);` |
|  271732 |   864 | `	}` |
|       - |   865 | `	/* Reserve a slot for the new object */` |
|  559467 |   866 | `	rc = SySetPut(&pVm->aLitObj,(const void *)zDummy);` |
|  559467 |   867 | `	if( rc != SXRET_OK ){` |
...
|     ! 0 |   871 | `		return 0;` |
|       - |   872 | `	}` |
|  559467 |   873 | `	pObj = (ph7_value *)SySetPeek(&pVm->aLitObj);` |
|  559467 |   874 | `	return pObj;` |
|  279734 |   875 |  |
|       - |   876 | `/*` |
|       - |   877 | ` * Reserve a memory object.` |
|       - |   878 | ` * Return a pointer to the raw ph7_value on success. NULL on failure.` |
|       - |   879 | ` */` |
|  188864 |   880 | `PH7_PRIVATE ph7_value * VmReserveMemObj(ph7_vm *pVm,sxu32 *pIndex)` |
|       1 |   881 |  |
|       - |   882 | `	ph7_value *pObj;` |
|       - |   883 | `	sxi32 rc;` |
|  188865 |   884 | `	if( pIndex ){` |
|       - |   885 | `		/* Object index in the object table */` |
|  188865 |   886 | `		*pIndex = SySetUsed(&pVm->aMemObj);` |
|   94432 |   887 | `	}` |
|       - |   888 | `	/* Reserve a slot for the new object */` |
|  188865 |   889 | `	rc = SySetPut(&pVm->aMemObj,(const void *)zDummy);` |
|  188865 |   890 | `	if( rc != SXRET_OK ){` |
...
|     ! 0 |   894 | `		return 0;` |
|       - |   895 | `	}` |
|  188865 |   896 | `	pObj = (ph7_value *)SySetPeek(&pVm->aMemObj);` |
|  188865 |   897 | `	return pObj;` |
|   94433 |   898 |  |
...
|       - |  1232 | ` */` |
|    5334 |  1233 | `PH7_PRIVATE sxi32 PH7_VmInit(` |
...
|    5335 |  1242 | `	SyZero(pVm,sizeof(ph7_vm));` |
|       - |  1243 | `	/* Initialize VM fields */` |
|    5335 |  1244 | `	pVm->pEngine = &(*pEngine);` |
|    5335 |  1245 | `	SyMemBackendInitFromParent(&pVm->sAllocator,&pEngine->sAllocator);` |
|       - |  1246 | `	/* Instructions containers */` |
|    5335 |  1247 | `	SySetInit(&pVm->aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|    5335 |  1248 | `	SySetAlloc(&pVm->aByteCode,0xFF);` |
|    5335 |  1249 | `	pVm->pByteContainer = &pVm->aByteCode;` |
|       - |  1250 | `	/* Object containers */` |
|    5335 |  1251 | `	SySetInit(&pVm->aMemObj,&pVm->sAllocator,sizeof(ph7_value));` |
|    5335 |  1252 | `	SySetAlloc(&pVm->aMemObj,0xFF);` |
|       - |  1253 | `	/* Virtual machine internal containers */` |
|    5335 |  1254 | `	SyBlobInit(&pVm->sConsumer,&pVm->sAllocator);` |
|    5335 |  1255 | `	SyBlobInit(&pVm->sWorker,&pVm->sAllocator);` |
|    5335 |  1256 | `	SyBlobInit(&pVm->sArgv,&pVm->sAllocator);` |
|    5335 |  1257 | `	SySetInit(&pVm->aLitObj,&pVm->sAllocator,sizeof(ph7_value));` |
|    5335 |  1258 | `	SySetAlloc(&pVm->aLitObj,0xFF);` |
|    5335 |  1259 | `	SyHashInit(&pVm->hHostFunction,&pVm->sAllocator,0,0);` |
|    5335 |  1260 | `	SyHashInit(&pVm->hFunction,&pVm->sAllocator,0,0);` |
|    5335 |  1261 | `	SyHashInit(&pVm->hClass,&pVm->sAllocator,SyStrHash,SyStrnmicmp);` |
|    5335 |  1262 | `	SyHashInit(&pVm->hConstant,&pVm->sAllocator,0,0);` |
|    5335 |  1263 | `	SyHashInit(&pVm->hSuper,&pVm->sAllocator,0,0);` |
|    5335 |  1264 | `	SyHashInit(&pVm->hPDO,&pVm->sAllocator,0,0);` |
|    5335 |  1265 | `	SySetInit(&pVm->aFreeObj,&pVm->sAllocator,sizeof(VmSlot));` |
|    5335 |  1266 | `	SySetInit(&pVm->aSelf,&pVm->sAllocator,sizeof(ph7_class *));` |
|    5335 |  1267 | `	SySetInit(&pVm->aShutdown,&pVm->sAllocator,sizeof(VmShutdownCB));` |
|    5335 |  1268 | `	SySetInit(&pVm->aException,&pVm->sAllocator,sizeof(ph7_exception *));` |
|       - |  1269 | `	/* Configuration containers */` |
|    5335 |  1270 | `	SySetInit(&pVm->aFiles,&pVm->sAllocator,sizeof(SyString));` |
|    5335 |  1271 | `	SySetInit(&pVm->aPaths,&pVm->sAllocator,sizeof(SyString));` |
|    5335 |  1272 | `	SySetInit(&pVm->aIncluded,&pVm->sAllocator,sizeof(SyString));` |
|    5335 |  1273 | `	SySetInit(&pVm->aOB,&pVm->sAllocator,sizeof(VmObEntry));` |
|    5335 |  1274 | `	SySetInit(&pVm->aIOstream,&pVm->sAllocator,sizeof(ph7_io_stream *));` |
|       - |  1275 | `	/* Error callbacks containers */` |
|    5335 |  1276 | `	PH7_MemObjInit(&(*pVm),&pVm->aExceptionCB[0]);` |
|    5335 |  1277 | `	PH7_MemObjInit(&(*pVm),&pVm->aExceptionCB[1]);` |
|    5335 |  1278 | `	PH7_MemObjInit(&(*pVm),&pVm->aErrCB[0]);` |
|    5335 |  1279 | `	PH7_MemObjInit(&(*pVm),&pVm->aErrCB[1]);` |
|    5335 |  1280 | `	PH7_MemObjInit(&(*pVm),&pVm->sAssertCallback);` |
|       - |  1281 | `	/* Set a default recursion limit */` |
|       - |  1282 | `#if defined(__WINNT__) \|\| defined(__UNIXES__)` |
|    5335 |  1283 | `	pVm->nMaxDepth = 32;` |
|       - |  1284 | `#else` |
|       - |  1285 | `	pVm->nMaxDepth = 16;` |
|       - |  1286 | `#endif` |
|       - |  1287 | `	/* Default assertion flags */` |
|    5335 |  1288 | `	pVm->iAssertFlags = PH7_ASSERT_WARNING; /* Issue a warning for each failed assertion */` |
|       - |  1289 | `	/* JSON return status */` |
|    5335 |  1290 | `	pVm->json_rc = JSON_ERROR_NONE;` |
|       - |  1291 | `	/* PRNG context */` |
|    5335 |  1292 | `	SyRandomnessInit(&pVm->sPrng,0,0);` |
|       - |  1293 | `	/* Install the null constant */` |
|    5335 |  1294 | `	pObj = PH7_ReserveConstObj(&(*pVm),0);` |
|    5335 |  1295 | `	if( pObj == 0 ){` |
|     ! 0 |  1296 | `		rc = SXERR_MEM;` |
|     ! 0 |  1297 | `		goto Err;` |
|       - |  1298 | `	}` |
|    5335 |  1299 | `	PH7_MemObjInit(pVm,pObj);` |
|       - |  1300 | `	/* Install the boolean TRUE constant */` |
|    5335 |  1301 | `	pObj = PH7_ReserveConstObj(&(*pVm),0);` |
|    5335 |  1302 | `	if( pObj == 0 ){` |
|     ! 0 |  1303 | `		rc = SXERR_MEM;` |
|     ! 0 |  1304 | `		goto Err;` |
|       - |  1305 | `	}` |
|    5335 |  1306 | `	PH7_MemObjInitFromBool(pVm,pObj,1);` |
|       - |  1307 | `	/* Install the boolean FALSE constant */` |
|    5335 |  1308 | `	pObj = PH7_ReserveConstObj(&(*pVm),0);` |
|    5335 |  1309 | `	if( pObj == 0 ){` |
|     ! 0 |  1310 | `		rc = SXERR_MEM;` |
|     ! 0 |  1311 | `		goto Err;` |
|       - |  1312 | `	}` |
|    5335 |  1313 | `	PH7_MemObjInitFromBool(pVm,pObj,0);` |
|       - |  1314 | `	/* Create the global frame */` |
|    5335 |  1315 | `	rc = VmEnterFrame(&(*pVm),0,0,0);` |
|    5335 |  1316 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  1317 | `		goto Err;` |
|       - |  1318 | `	}` |
|       - |  1319 | `	/* Initialize the code generator */` |
|    5335 |  1320 | `	rc = PH7_InitCodeGenerator(pVm,pEngine->xConf.xErr,pEngine->xConf.pErrData);` |
|    5335 |  1321 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  1322 | `		goto Err;` |
|       - |  1323 | `	}` |
|       - |  1324 | `	/* VM correctly initialized,set the magic number */` |
|    5335 |  1325 | `	pVm->nMagic = PH7_VM_INIT;` |
|    5335 |  1326 | `	SyStringInitFromBuf(&sBuiltin,PH7_BUILTIN_LIB,sizeof(PH7_BUILTIN_LIB)-1);` |
|       - |  1327 | `	/* Compile the built-in library */` |
|    5335 |  1328 | `	VmEvalChunk(&(*pVm),0,&sBuiltin,PH7_PHP_ONLY,FALSE);` |
|       - |  1329 | `	/* Reset the code generator */` |
|    5335 |  1330 | `	PH7_ResetCodeGenerator(&(*pVm),pEngine->xConf.xErr,pEngine->xConf.pErrData);` |
|    5335 |  1331 | `	return SXRET_OK;` |
|     ! 0 |  1332 | `Err:` |
...
|       - |  1364 | ` */` |
|   12554 |  1365 | `static ph7_value * VmNewOperandStack(` |
...
|       - |  1377 | `  */` |
|   12555 |  1378 | `	nInstr += VM_STACK_GUARD;` |
|   12555 |  1379 | `	pStack = (ph7_value *)SyMemBackendAlloc(&pVm->sAllocator,nInstr * sizeof(ph7_value));` |
|   12555 |  1380 | `	if( pStack == 0 ){` |
|     ! 0 |  1381 | `		return 0;` |
|       - |  1382 | `	}` |
|       - |  1383 | `	/* Initialize the operand stack */` |
|  350561 |  1384 | `	while( nInstr > 0 ){` |
|  338007 |  1385 | `		PH7_MemObjInit(&(*pVm),&pStack[nInstr - 1]);` |
|  338007 |  1386 | `		--nInstr;` |
|       1 |  1387 | `	}` |
|       - |  1388 | `	/* Ready for bytecode execution */` |
|   12555 |  1389 | `	return pStack;` |
|    6278 |  1390 |  |
...
|       - |  1399 | ` */` |
|    5092 |  1400 | `PH7_PRIVATE sxi32 PH7_VmMakeReady(` |
|       - |  1401 | `	ph7_vm *pVm /* Target VM */` |
|       - |  1402 | `	)` |
|       1 |  1403 |  |
|       - |  1404 | `	SyHashEntry *pEntry;` |
|       - |  1405 | `	sxi32 rc;` |
|    5093 |  1406 | `	if( pVm->nMagic != PH7_VM_INIT ){` |
|       - |  1407 | `		/* Initialize your VM first */` |
|     ! 0 |  1408 | `		return SXERR_CORRUPT;` |
|       - |  1409 | `	}` |
|       - |  1410 | `	/* Mark the VM ready for byte-code execution */` |
|    5093 |  1411 | `	pVm->nMagic = PH7_VM_RUN;` |
|       - |  1412 | `	/* Release the code generator now we have compiled our program */` |
|    5093 |  1413 | `	PH7_ResetCodeGenerator(pVm,0,0);` |
|       - |  1414 | `	/* Emit the DONE instruction */` |
|    5093 |  1415 | `	rc = PH7_VmEmitInstr(&(*pVm),PH7_OP_DONE,0,0,0,0);` |
|    5093 |  1416 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  1417 | `		return SXERR_MEM;` |
|       - |  1418 | `	}` |
|       - |  1419 | `	/* Script return value */` |
|    5093 |  1420 | `	PH7_MemObjInit(&(*pVm),&pVm->sExec); /* Assume a NULL return value */` |
|       - |  1421 | `	/* Allocate a new operand stack */` |
|    5093 |  1422 | `	pVm->aOps = VmNewOperandStack(&(*pVm),SySetUsed(pVm->pByteContainer));` |
|    5093 |  1423 | `	if( pVm->aOps == 0 ){` |
|     ! 0 |  1424 | `		return SXERR_MEM;` |
|       - |  1425 | `	}` |
|       - |  1426 | `	/* Set the default VM output consumer callback and it's` |
|       - |  1427 | `	 * private data. */` |
|    5093 |  1428 | `	pVm->sVmConsumer.xConsumer = PH7_VmBlobConsumer;` |
|    5093 |  1429 | `	pVm->sVmConsumer.pUserData = &pVm->sConsumer;` |
|       - |  1430 | `	/* Allocate the reference table */` |
|    5093 |  1431 | `	pVm->nRefSize = 0x10; /* Must be a power of two for fast arithemtic */` |
|    5093 |  1432 | `	pVm->apRefObj = (VmRefObj **)SyMemBackendAlloc(&pVm->sAllocator,sizeof(VmRefObj *) * pVm->nRefSize);` |
|    5093 |  1433 | `	if( pVm->apRefObj == 0 ){` |
...
|    5093 |  1452 | `	PH7_RegisterBuiltInConstant(&(*pVm));` |
|       - |  1453 | `	/* Register built-in functions [i.e: is_null(), array_diff(), strlen(), etc.] */` |
|    5093 |  1454 | `	PH7_RegisterBuiltInFunction(&(*pVm));` |
|       - |  1455 | `	/* Initialize and install static and constants class attributes */` |
|    5093 |  1456 | `	SyHashResetLoopCursor(&pVm->hClass);` |
|   40979 |  1457 | `	while((pEntry = SyHashGetNextEntry(&pVm->hClass)) != 0 ){` |
|   35887 |  1458 | `		rc = VmMountUserClass(&(*pVm),(ph7_class *)pEntry->pUserData);` |
|   35887 |  1459 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  1460 | `			return rc;` |
|       - |  1461 | `		}` |
|       1 |  1462 | `	}` |
|       - |  1463 | `	/* Random number betwwen 0 and 1023 used to generate unique ID */` |
|    5093 |  1464 | `	pVm->unique_id = PH7_VmRandomNum(&(*pVm)) & 1023;` |
|       - |  1465 | `	/* VM is ready for bytecode execution */` |
|    5093 |  1466 | `	return SXRET_OK;` |
|    2547 |  1467 |  |
|       - |  1468 | `/*` |
...
|       - |  1486 | ` */` |
|    5084 |  1487 | `PH7_PRIVATE sxi32 PH7_VmRelease(ph7_vm *pVm)` |
|       1 |  1488 |  |
|       - |  1489 | `	/* Set the stale magic number */` |
|    5085 |  1490 | `	pVm->nMagic = PH7_VM_STALE;` |
|       - |  1491 | `	/* Release the private memory subsystem */` |
|    5085 |  1492 | `	SyMemBackendRelease(&pVm->sAllocator);` |
|    5085 |  1493 | `	return SXRET_OK;` |
|       1 |  1494 |  |
|       - |  1495 | `/*` |
...
|       - |  1504 | ` */` |
|   32326 |  1505 | `static sxi32 VmInitCallContext(` |
...
|       - |  1511 | `	)` |
|       1 |  1512 |  |
|   32327 |  1513 | `	pOut->pFunc = pFunc;` |
|   32327 |  1514 | `	pOut->pVm   = pVm;` |
|   32327 |  1515 | `	SySetInit(&pOut->sVar,&pVm->sAllocator,sizeof(ph7_value *));` |
|   32327 |  1516 | `	SySetInit(&pOut->sChunk,&pVm->sAllocator,sizeof(ph7_aux_data));` |
|       - |  1517 | `	/* Assume a null return value */` |
|   32327 |  1518 | `	MemObjSetType(pRet,MEMOBJ_NULL);` |
|   32327 |  1519 | `	pOut->pRet = pRet;` |
|   32327 |  1520 | `	pOut->iFlags = iFlags;` |
|   32327 |  1521 | `	return SXRET_OK;` |
|       1 |  1522 |  |
|       - |  1523 | `/*` |
|       - |  1524 | ` * Release a foreign function call context and cleanup the mess` |
|       - |  1525 | ` * left behind.` |
|       - |  1526 | ` */` |
|   32326 |  1527 | `static void VmReleaseCallContext(ph7_context *pCtx)` |
|       1 |  1528 |  |
|       - |  1529 | `	sxu32 n;` |
|   32327 |  1530 | `	if( SySetUsed(&pCtx->sVar) > 0 ){` |
|     651 |  1531 | `		ph7_value **apObj = (ph7_value **)SySetBasePtr(&pCtx->sVar);` |
|    1679 |  1532 | `		for( n = 0 ; n < SySetUsed(&pCtx->sVar) ; ++n ){` |
|    1029 |  1533 | `			if( apObj[n] == 0 ){` |
|       - |  1534 | `				/* Already released */` |
|     237 |  1535 | `				continue;` |
|       - |  1536 | `			}` |
|     793 |  1537 | `			PH7_MemObjRelease(apObj[n]);` |
|     793 |  1538 | `			SyMemBackendPoolFree(&pCtx->pVm->sAllocator,apObj[n]);` |
|     397 |  1539 | `		}` |
|     651 |  1540 | `		SySetRelease(&pCtx->sVar);` |
|     325 |  1541 | `	}` |
|   32327 |  1542 | `	if( SySetUsed(&pCtx->sChunk) > 0 ){` |
...
|       - |  1562 | ` */` |
|     236 |  1563 | `PH7_PRIVATE void PH7_VmReleaseContextValue(` |
|       - |  1564 | `	ph7_context *pCtx, /* Call context */` |
|       - |  1565 | `	ph7_value *pValue  /* Release this value */` |
|       - |  1566 | `	)` |
|       1 |  1567 |  |
|     237 |  1568 | `	if( pValue == 0 ){` |
|       - |  1569 | `		/* NULL value is a harmless operation */` |
|     ! 0 |  1570 | `		return;` |
|       - |  1571 | `	}` |
|     237 |  1572 | `	if( SySetUsed(&pCtx->sVar) > 0 ){` |
|     237 |  1573 | `		ph7_value **apObj = (ph7_value **)SySetBasePtr(&pCtx->sVar);` |
|       - |  1574 | `		sxu32 n;` |
|     893 |  1575 | `		for( n = 0 ; n < SySetUsed(&pCtx->sVar) ; ++n ){` |
|     893 |  1576 | `			if( apObj[n] == pValue ){` |
|     237 |  1577 | `				PH7_MemObjRelease(pValue);` |
|     237 |  1578 | `				SyMemBackendPoolFree(&pCtx->pVm->sAllocator,pValue);` |
...
|       - |  1588 | ` */` |
|  333038 |  1589 | `static void VmPopOperand(` |
|       - |  1590 | `	ph7_value **ppTos, /* Operand stack */` |
|       - |  1591 | `	sxi32 nPop         /* Total number of memory objects to pop */` |
|       - |  1592 | `	)` |
|       1 |  1593 |  |
|  333039 |  1594 | `	ph7_value *pTos = *ppTos;` |
|  693233 |  1595 | `	while( nPop > 0 ){` |
|  360195 |  1596 | `		PH7_MemObjRelease(pTos);` |
|  360195 |  1597 | `		pTos--;` |
|  360195 |  1598 | `		nPop--;` |
|       1 |  1599 | `	}` |
|       - |  1600 | `	/* Top of the stack */` |
|  333039 |  1601 | `	*ppTos = pTos;` |
|  333039 |  1602 |  |
|       - |  1603 | `/*` |
|       - |  1604 | ` * Reserve a memory object.` |
|       - |  1605 | ` * Return a pointer to the raw ph7_value on success. NULL on failure.` |
|       - |  1606 | ` */` |
|  190992 |  1607 | `PH7_PRIVATE ph7_value * PH7_ReserveMemObj(ph7_vm *pVm)` |
|       1 |  1608 |  |
|  190993 |  1609 | `	ph7_value *pObj = 0;` |
|       - |  1610 | `	VmSlot *pSlot;` |
|       - |  1611 | `	sxu32 nIdx;` |
|       - |  1612 | `	/* Check for a free slot */` |
|  190993 |  1613 | `	nIdx = SXU32_HIGH; /* cc warning */` |
|  190993 |  1614 | `	pSlot = (VmSlot *)SySetPop(&pVm->aFreeObj);` |
|  190993 |  1615 | `	if( pSlot ){` |
|    2131 |  1616 | `		pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pSlot->nIdx);` |
|    2131 |  1617 | `		nIdx = pSlot->nIdx;` |
|    1065 |  1618 | `	}` |
|  190993 |  1619 | `	if( pObj == 0 ){` |
|       - |  1620 | `		/* Reserve a new memory object */` |
|  188863 |  1621 | `		pObj = VmReserveMemObj(&(*pVm),&nIdx);` |
|  188863 |  1622 | `		if( pObj == 0 ){` |
|     ! 0 |  1623 | `			return 0;` |
|       - |  1624 | `		}` |
|   94431 |  1625 | `	}` |
|       - |  1626 | `	/* Set a null default value */` |
|  190993 |  1627 | `	PH7_MemObjInit(&(*pVm),pObj);` |
|  190993 |  1628 | `	pObj->nIdx = nIdx;` |
|  190993 |  1629 | `	return pObj;` |
|   95497 |  1630 |  |
|       - |  1631 | `/*` |
|       - |  1632 | ` * Insert an entry by reference (not copy) in the given hashmap.` |
|       - |  1633 | ` */` |
|   55736 |  1634 | `static sxi32 VmHashmapRefInsert(` |
...
|       - |  1641 | `	ph7_value sKey;` |
|       - |  1642 | `	sxi32 rc;` |
|   55737 |  1643 | `	PH7_MemObjInitFromString(pMap->pVm,&sKey,0);` |
|   55737 |  1644 | `	PH7_MemObjStringAppend(&sKey,zKey,nByte);` |
|       - |  1645 | `	/* Perform the insertion */` |
|   55737 |  1646 | `	rc = PH7_HashmapInsertByRef(&(*pMap),&sKey,nRefIdx);` |
|   55737 |  1647 | `	PH7_MemObjRelease(&sKey);` |
|   55737 |  1648 | `	return rc;` |
|       1 |  1649 |  |
|       - |  1650 | `/*` |
...
|       - |  1654 | ` */` |
|  261324 |  1655 | `static ph7_value * VmExtractMemObj(` |
...
|       - |  1660 | `	)` |
|       1 |  1661 |  |
|  261325 |  1662 | `	int bNullify = FALSE;` |
...
|  261325 |  1669 | `	pFrame = pVm->pFrame;` |
|  261337 |  1670 | `	while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|       - |  1671 | `		/* Safely ignore the exception frame */` |
|      13 |  1672 | `		pFrame = pFrame->pParent; /* Parent frame */` |
|       1 |  1673 | `	}` |
|       - |  1674 | `	/* Perform the lookup */` |
|  261325 |  1675 | `	if( pName == 0 \|\| pName->nByte < 1 ){` |
...
|  261325 |  1683 | `	pEntry = SyHashGet(&pVm->hSuper,(const void *)pName->zString,pName->nByte);` |
|  261325 |  1684 | `	if( pEntry == 0 ){` |
|       - |  1685 | `		/* Query the top active frame */` |
|  261303 |  1686 | `		pEntry = SyHashGet(&pFrame->hVar,(const void *)pName->zString,pName->nByte);` |
|  261303 |  1687 | `		if( pEntry == 0 ){` |
|    7931 |  1688 | `			char *zName = (char *)pName->zString;` |
|       - |  1689 | `			VmSlot sLocal;` |
|    7931 |  1690 | `			if( !bCreate ){` |
...
|       - |  1696 | `			 */` |
|    6867 |  1697 | `			pObj = PH7_ReserveMemObj(&(*pVm));` |
|    6867 |  1698 | `			if( pObj == 0 ){` |
|     ! 0 |  1699 | `				return 0;` |
|       - |  1700 | `			}` |
|    6867 |  1701 | `			nIdx = pObj->nIdx;` |
|    6867 |  1702 | `			if( bDup ){` |
|       - |  1703 | `				/* Duplicate name */` |
|     129 |  1704 | `				zName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|     129 |  1705 | `				if( zName == 0 ){` |
|     ! 0 |  1706 | `					return 0;` |
|       - |  1707 | `				}` |
|      64 |  1708 | `			}` |
|       - |  1709 | `			/* Link to the top active VM frame */` |
|    6867 |  1710 | `			rc = SyHashInsert(&pFrame->hVar,zName,pName->nByte,SX_INT_TO_PTR(nIdx));` |
|    6867 |  1711 | `			if( rc != SXRET_OK ){` |
...
|     ! 0 |  1716 | `				return 0;` |
|       - |  1717 | `			}` |
|    6867 |  1718 | `			if( pFrame->pParent != 0 ){` |
|       - |  1719 | `				/* Local variable */` |
|    2079 |  1720 | `				sLocal.nIdx = nIdx;` |
|    2079 |  1721 | `				SySetPut(&pFrame->sLocal,(const void *)&sLocal);` |
|    1040 |  1722 | `			}else{` |
|       - |  1723 | `				/* Register in the $GLOBALS array */` |
|    4789 |  1724 | `				VmHashmapRefInsert(pVm->pGlobal,pName->zString,pName->nByte,nIdx);` |
|       - |  1725 | `			}` |
|       - |  1726 | `			/* Install in the reference table */` |
|    6867 |  1727 | `			PH7_VmRefObjInstall(&(*pVm),nIdx,SyHashLastEntry(&pFrame->hVar),0,0);` |
|       - |  1728 | `			/* Save object index */` |
|    6867 |  1729 | `			pObj->nIdx = nIdx;` |
|    3434 |  1730 | `		}else{` |
|       - |  1731 | `			/* Extract variable contents */` |
|  253373 |  1732 | `			nIdx = (sxu32)SX_PTR_TO_INT(pEntry->pUserData);` |
|  253373 |  1733 | `			pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|  253373 |  1734 | `			if( bNullify && pObj ){` |
|     ! 0 |  1735 | `				PH7_MemObjRelease(pObj);` |
|     ! 0 |  1736 | `			}` |
|       - |  1737 | `		}` |
|  130120 |  1738 | `	}else{` |
|       - |  1739 | `		/* Superglobal */` |
|      23 |  1740 | `		nIdx = (sxu32)SX_PTR_TO_INT(pEntry->pUserData);` |
|      23 |  1741 | `		pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|       - |  1742 | `	}` |
|  260261 |  1743 | `	return pObj;` |
|  130663 |  1744 |  |
|       - |  1745 | `/*` |
...
|       - |  1748 | ` */` |
|    5098 |  1749 | `static ph7_value * VmExtractSuper(` |
...
|    5099 |  1759 | `	pEntry = SyHashGet(&pVm->hSuper,(const void *)zName,nByte);` |
|    5099 |  1760 | `	if( pEntry == 0 ){` |
|       - |  1761 | `		/* No such entry */` |
|     ! 0 |  1762 | `		return 0;` |
|       - |  1763 | `	}` |
|       - |  1764 | `	/* Extract the superglobal index in the global object pool */` |
|    5099 |  1765 | `	nIdx = SX_PTR_TO_INT(pEntry->pUserData);` |
|       - |  1766 | `	/* Extract the variable value  */` |
|    5099 |  1767 | `	pValue = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|    5099 |  1768 | `	return pValue;` |
|    2550 |  1769 |  |
|       - |  1770 | `/*` |
|       - |  1771 | ` * Perform a raw hashmap insertion.` |
|       - |  1772 | ` * Refer to the [PH7_VmConfigure()] implementation for additional information.` |
|       - |  1773 | ` */` |
|    5096 |  1774 | `static sxi32 VmHashmapInsert(` |
...
|       - |  1783 | `	sxi32 rc;` |
|    5097 |  1784 | `	PH7_MemObjInitFromString(pMap->pVm,&sKey,0);` |
|    5097 |  1785 | `	PH7_MemObjInitFromString(pMap->pVm,&sValue,0);` |
|    5097 |  1786 | `	if( zKey ){` |
|    5095 |  1787 | `		if( nKeylen < 0 ){` |
|    5095 |  1788 | `			nKeylen = (int)SyStrlen(zKey);` |
|    2547 |  1789 | `		}` |
|    5095 |  1790 | `		PH7_MemObjStringAppend(&sKey,zKey,(sxu32)nKeylen);` |
|    2547 |  1791 | `	}` |
|    5097 |  1792 | `	if( zData ){` |
|    5097 |  1793 | `		if( nLen < 0 ){` |
...
|     ! 0 |  1796 | `		}` |
|    5097 |  1797 | `		PH7_MemObjStringAppend(&sValue,zData,(sxu32)nLen);` |
|    2548 |  1798 | `	}` |
|       - |  1799 | `	/* Perform the insertion */` |
|    5097 |  1800 | `	rc = PH7_HashmapInsert(&(*pMap),&sKey,&sValue);` |
|    5097 |  1801 | `	PH7_MemObjRelease(&sKey);` |
|    5097 |  1802 | `	PH7_MemObjRelease(&sValue);` |
|    5097 |  1803 | `	return rc;` |
|       1 |  1804 |  |
...
|       - |  1819 | ` */` |
|   81476 |  1820 | `PH7_PRIVATE sxi32 PH7_VmConfigure(` |
|       - |  1821 | `	ph7_vm *pVm, /* Target VM */` |
|       - |  1822 | `	sxi32 nOp,   /* Configuration verb */` |
|       - |  1823 | `	va_list ap   /* Subsequent option arguments */` |
|       - |  1824 | `	)` |
|       1 |  1825 |  |
|   81477 |  1826 | `	sxi32 rc = SXRET_OK;` |
|   81477 |  1827 | `	switch(nOp){` |
|    2546 |  1828 | `	case PH7_VM_CONFIG_OUTPUT: {` |
|    5093 |  1829 | `		ProcConsumer xConsumer = va_arg(ap,ProcConsumer);` |
|    5093 |  1830 | `		void *pUserData = va_arg(ap,void *);` |
...
|    5093 |  1839 | `		pVm->sVmConsumer.xConsumer = xConsumer;` |
|    5093 |  1840 | `		pVm->sVmConsumer.pUserData = pUserData;` |
|    5093 |  1841 | `		break;` |
|       - |  1842 | `							   }` |
|    2546 |  1843 | `	case PH7_VM_CONFIG_IMPORT_PATH: {` |
|       - |  1844 | `		/* Import path */` |
|       - |  1845 | `		  const char *zPath;` |
|       - |  1846 | `		  SyString sPath;` |
|    5093 |  1847 | `		  zPath = va_arg(ap,const char *);` |
...
|       - |  1852 | `		  }` |
|       - |  1853 | `#endif` |
|    5093 |  1854 | `		  SyStringInitFromBuf(&sPath,zPath,SyStrlen(zPath));` |
|       - |  1855 | `		  /* Remove trailing slashes and backslashes */` |
|       - |  1856 | `#ifdef __WINNT__` |
|       1 |  1857 | `		  SyStringTrimTrailingChar(&sPath,'\\');` |
|       - |  1858 | `#endif` |
|   10185 |  1859 | `		  SyStringTrimTrailingChar(&sPath,'/');` |
|       - |  1860 | `		  /* Remove leading and trailing white spaces */` |
|    5093 |  1861 | `		  SyStringFullTrim(&sPath);` |
|    5093 |  1862 | `		  if( sPath.nByte > 0 ){` |
|       - |  1863 | `			  /* Store the path in the corresponding conatiner */` |
|    5093 |  1864 | `			  rc = SySetPut(&pVm->aPaths,(const void *)&sPath);` |
|    2546 |  1865 | `		  }` |
|    5093 |  1866 | `		  break;` |
|       - |  1867 | `									 }` |
|    2546 |  1868 | `	case PH7_VM_CONFIG_ERR_REPORT:` |
|       - |  1869 | `		/* Run-Time Error report */` |
|    5093 |  1870 | `		pVm->bErrReport = 1;` |
|    5093 |  1871 | `		break;` |
...
|       - |  1891 | `							   }` |
|       - |  1892 |  |
|   25460 |  1893 | `	case PH7_VM_CONFIG_CREATE_SUPER:` |
|       - |  1894 | `	case PH7_VM_CONFIG_CREATE_VAR: {` |
|       - |  1895 | `		/* Create a new superglobal/global variable */` |
|   50921 |  1896 | `		const char *zName = va_arg(ap,const char *);` |
|   50921 |  1897 | `		ph7_value *pValue = va_arg(ap,ph7_value *);` |
...
|       - |  1906 | `		}` |
|       - |  1907 | `#endif` |
|   50921 |  1908 | `		nByte = SyStrlen(zName);` |
|   50921 |  1909 | `		if( nOp == PH7_VM_CONFIG_CREATE_SUPER ){` |
|       - |  1910 | `			/* Check if the superglobal is already installed */` |
|   50921 |  1911 | `			pEntry = SyHashGet(&pVm->hSuper,(const void *)zName,nByte);` |
|   25461 |  1912 | `		}else{` |
|       - |  1913 | `			/* Query the top active VM frame */` |
|     ! 0 |  1914 | `			pEntry = SyHashGet(&pVm->pFrame->hVar,(const void *)zName,nByte);` |
|       - |  1915 | `		}` |
|   50921 |  1916 | `		if( pEntry ){` |
...
|   50921 |  1927 | `			pObj = PH7_ReserveMemObj(&(*pVm));` |
|   50921 |  1928 | `			if( pObj == 0 ){` |
|     ! 0 |  1929 | `				rc = SXERR_MEM;` |
|     ! 0 |  1930 | `				break;` |
|       - |  1931 | `			}` |
|   50921 |  1932 | `			nIdx = pObj->nIdx;` |
|       - |  1933 | `			/* Copy value */` |
|   50921 |  1934 | `			PH7_MemObjStore(pValue,pObj);` |
|   50921 |  1935 | `			if( nOp == PH7_VM_CONFIG_CREATE_SUPER ){` |
|       - |  1936 | `				/* Install the superglobal */` |
|   50921 |  1937 | `				rc = SyHashInsert(&pVm->hSuper,(const void *)zName,nByte,SX_INT_TO_PTR(nIdx));` |
|   25461 |  1938 | `			}else{` |
|       - |  1939 | `				/* Install in the current frame */` |
|     ! 0 |  1940 | `				rc = SyHashInsert(&pVm->pFrame->hVar,(const void *)zName,nByte,SX_INT_TO_PTR(nIdx));` |
|       - |  1941 | `			}` |
|   50921 |  1942 | `			if( rc == SXRET_OK ){` |
|       - |  1943 | `				SyHashEntry *pRef;` |
|   50921 |  1944 | `				if( nOp == PH7_VM_CONFIG_CREATE_SUPER ){` |
|   50921 |  1945 | `					pRef = SyHashLastEntry(&pVm->hSuper);` |
|   25461 |  1946 | `				}else{` |
|     ! 0 |  1947 | `					pRef = SyHashLastEntry(&pVm->pFrame->hVar);` |
|       - |  1948 | `				}` |
|       - |  1949 | `				/* Install in the reference table */` |
|   50921 |  1950 | `				PH7_VmRefObjInstall(&(*pVm),nIdx,pRef,0,0);` |
|   50921 |  1951 | `				if( nOp == PH7_VM_CONFIG_CREATE_SUPER \|\| pVm->pFrame->pParent == 0){` |
|       - |  1952 | `					/* Register in the $GLOBALS array */` |
|   50921 |  1953 | `					VmHashmapRefInsert(pVm->pGlobal,zName,nByte,nIdx);` |
|   25460 |  1954 | `				}` |
|   25460 |  1955 | `			}` |
|       - |  1956 | `		}` |
|   50921 |  1957 | `		break;` |
|       - |  1958 | `									}` |
|    2547 |  1959 | `	case PH7_VM_CONFIG_SERVER_ATTR:` |
...
|    5093 |  1991 | `			pValue = VmExtractSuper(&(*pVm),"_SERVER",sizeof("_SERVER")-1);` |
|       - |  1992 | `		}` |
|    5095 |  1993 | `		if( pValue == 0 \|\| (pValue->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
|       - |  1994 | `			/* No such entry */` |
|     ! 0 |  1995 | `			rc = SXERR_NOTFOUND;` |
|     ! 0 |  1996 | `			break;` |
|       - |  1997 | `		}` |
|       - |  1998 | `		/* Point to the hashmap */` |
|    5095 |  1999 | `		pMap = (ph7_hashmap *)pValue->x.pOther;` |
|       - |  2000 | `		/* Perform the insertion */` |
|    5095 |  2001 | `		rc = VmHashmapInsert(pMap,zKey,-1,zValue,nLen);` |
|    5095 |  2002 | `		break;` |
|       - |  2003 | `								   }` |
|       1 |  2004 | `	case PH7_VM_CONFIG_ARGV_ENTRY:{` |
|       - |  2005 | `		/* Script arguments */` |
|       2 |  2006 | `		const char *zValue = va_arg(ap,const char *);` |
|       - |  2007 | `		ph7_hashmap *pMap;` |
|       - |  2008 | `		ph7_value *pValue;` |
|       - |  2009 | `		sxu32 n;` |
|       2 |  2010 | `		if( SX_EMPTY_STR(zValue) ){` |
|     ! 0 |  2011 | `			rc = SXERR_EMPTY;` |
|     ! 0 |  2012 | `			break;` |
|       - |  2013 | `		}` |
|       - |  2014 | `		/* Extract the $argv array */` |
|       2 |  2015 | `		pValue = VmExtractSuper(&(*pVm),"argv",sizeof("argv")-1);` |
|       2 |  2016 | `		if( pValue == 0 \|\| (pValue->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
|       - |  2017 | `			/* No such entry */` |
|     ! 0 |  2018 | `			rc = SXERR_NOTFOUND;` |
|     ! 0 |  2019 | `			break;` |
|       - |  2020 | `		}` |
|       - |  2021 | `		/* Point to the hashmap */` |
|       2 |  2022 | `		pMap = (ph7_hashmap *)pValue->x.pOther;` |
|       - |  2023 | `		/* Perform the insertion */` |
|       2 |  2024 | `		n = (sxu32)SyStrlen(zValue);` |
|       2 |  2025 | `		rc = VmHashmapInsert(pMap,0,0,zValue,(int)n);` |
|       2 |  2026 | `		if( rc == SXRET_OK ){` |
|       2 |  2027 | `			if( pMap->nEntry > 1 ){` |
|       - |  2028 | `				/* Append space separator first */` |
|     ! 0 |  2029 | `				SyBlobAppend(&pVm->sArgv,(const void *)" ",sizeof(char));` |
|     ! 0 |  2030 | `			}` |
|       2 |  2031 | `			SyBlobAppend(&pVm->sArgv,(const void *)zValue,n);` |
|       1 |  2032 | `		}` |
|       2 |  2033 | `		break;` |
|       - |  2034 | `								  }` |
...
|     ! 0 |  2051 | `		break;` |
|       - |  2052 | `								   }` |
|    5092 |  2053 | `	case PH7_VM_CONFIG_IO_STREAM: {` |
|       - |  2054 | `		/* Register an IO stream device */` |
|   10185 |  2055 | `		const ph7_io_stream *pStream = va_arg(ap,const ph7_io_stream *);` |
|       - |  2056 | `		/* Make sure we are dealing with a valid IO stream */` |
|   15276 |  2057 | `		if( pStream == 0 \|\| pStream->zName == 0 \|\| pStream->zName[0] == 0 \|\|` |
|   10185 |  2058 | `			pStream->xOpen == 0 \|\| pStream->xRead == 0 ){` |
|       - |  2059 | `				/* Invalid stream */` |
|     ! 0 |  2060 | `				rc = SXERR_INVALID;` |
|     ! 0 |  2061 | `				break;` |
|       - |  2062 | `		}` |
|   10185 |  2063 | `		if( pVm->pDefStream == 0 && SyStrnicmp(pStream->zName,"file",sizeof("file")-1) == 0 ){` |
|       - |  2064 | `			/* Make the 'file://' stream the defaut stream device */` |
|    5093 |  2065 | `			pVm->pDefStream = pStream;` |
|    2546 |  2066 | `		}` |
|       - |  2067 | `		/* Insert in the appropriate container */` |
|   10185 |  2068 | `		rc = SySetPut(&pVm->aIOstream,(const void *)&pStream);` |
|   10185 |  2069 | `		break;` |
|       - |  2070 | `								  }` |
...
|       - |  2162 | ` */` |
|      84 |  2163 | `static sxi32 VmCallErrorHandler(ph7_vm *pVm,SyBlob *pMsg)` |
|       1 |  2164 |  |
|      85 |  2165 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|      85 |  2166 | `	sxi32 rc = SXRET_OK;` |
|       - |  2167 | `	/* Append a new line */` |
|       - |  2168 | `#ifdef __WINNT__` |
|       1 |  2169 | `	SyBlobAppend(pMsg,"\r\n",sizeof("\r\n")-1);` |
|       - |  2170 | `#else` |
|      84 |  2171 | `	SyBlobAppend(pMsg,"\n",sizeof(char));` |
|       - |  2172 | `#endif` |
|       - |  2173 | `	/* Invoke the output consumer callback */` |
|      85 |  2174 | `	rc = pCons->xConsumer(SyBlobData(pMsg),SyBlobLength(pMsg),pCons->pUserData);` |
|      85 |  2175 | `	if( pCons->xConsumer != VmObConsumer ){` |
|       - |  2176 | `		/* Increment output length */` |
|      85 |  2177 | `		pVm->nOutputLen += SyBlobLength(pMsg);` |
|      42 |  2178 | `	}` |
|      85 |  2179 | `	return rc;` |
|       1 |  2180 |  |
|       - |  2181 | `/*` |
...
|       - |  2184 | ` * information.` |
|       - |  2185 | ` */` |
|      92 |  2186 | `static sxi32 VmInvokeErrorHandler(ph7_vm *pVm, sxi32 iErr, const char *zMessage, SyString *pFile, sxi32 iLine)` |
|       1 |  2187 |  |
|      93 |  2188 | `	if( ph7_value_is_callable(&pVm->aErrCB[1]) ){` |
...
|      85 |  2227 | `	return TRUE;` |
|      47 |  2228 |  |
|      64 |  2229 | `PH7_PRIVATE sxi32 PH7_VmThrowError(` |
...
|       - |  2234 | `	)` |
|       1 |  2235 |  |
|      65 |  2236 | `	SyBlob *pWorker = &pVm->sWorker;` |
|       - |  2237 | `	SyString *pFile;` |
|       - |  2238 | `	char *zErr;` |
|      65 |  2239 | `	sxi32 rc = SXRET_OK;` |
|      65 |  2240 | `	if( !pVm->bErrReport ){` |
|       - |  2241 | `		/* Don't bother reporting errors */` |
|       3 |  2242 | `		return SXRET_OK;` |
|       - |  2243 | `	}` |
|       - |  2244 | `	/* Reset the working buffer */` |
|      63 |  2245 | `	SyBlobReset(pWorker);` |
|       - |  2246 | `	/* Peek the processed file if available */` |
|      63 |  2247 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|      63 |  2248 | `	if( pFile ){` |
|       - |  2249 | `		/* Append file name */` |
|      63 |  2250 | `		SyBlobAppend(pWorker,pFile->zString,pFile->nByte);` |
|      63 |  2251 | `		SyBlobAppend(pWorker,(const void *)" ",sizeof(char));` |
|      31 |  2252 | `	}` |
|      63 |  2253 | `	zErr = "Error: ";` |
|      63 |  2254 | `	switch(iErr){` |
|      29 |  2255 | `	case PH7_CTX_WARNING: zErr = "Warning: "; break;` |
|      13 |  2256 | `	case PH7_CTX_NOTICE:  zErr = "Notice: ";  break;` |
|      11 |  2257 | `	default:` |
|      23 |  2258 | `		iErr = PH7_CTX_ERR;` |
|      22 |  2259 | `		break;` |
|       - |  2260 | `	}` |
|      63 |  2261 | `	SyBlobAppend(pWorker,zErr,SyStrlen(zErr));` |
|      63 |  2262 | `	if( pFuncName ){` |
|       - |  2263 | `		/* Append function name first */` |
|      31 |  2264 | `		SyBlobAppend(pWorker,pFuncName->zString,pFuncName->nByte);` |
|      31 |  2265 | `		SyBlobAppend(pWorker,"(): ",sizeof("(): ")-1);` |
|      15 |  2266 | `	}` |
|      63 |  2267 | `	SyBlobAppend(pWorker,zMessage,SyStrlen(zMessage));` |
|       - |  2268 | `	/* Check for user error handler */` |
|      63 |  2269 | `	if( VmInvokeErrorHandler(pVm, iErr, zMessage, pFile, 0) ){` |
|      55 |  2270 | `		rc = VmCallErrorHandler(&(*pVm),pWorker);` |
|      27 |  2271 | `	}` |
|      63 |  2272 | `	return rc;` |
|      33 |  2273 |  |
|       - |  2274 | `/*` |
...
|       - |  2277 | ` * information.` |
|       - |  2278 | ` */` |
|      30 |  2279 | `static sxi32 VmThrowErrorAp(` |
...
|       - |  2285 | `	)` |
|       1 |  2286 |  |
|      31 |  2287 | `	SyBlob *pWorker = &pVm->sWorker;` |
|       - |  2288 | `	SyBlob sMsg;` |
|       - |  2289 | `	SyString *pFile;` |
|       - |  2290 | `	char *zErr;` |
|      31 |  2291 | `	sxi32 rc = SXRET_OK;` |
|      31 |  2292 | `	if( !pVm->bErrReport ){` |
|       - |  2293 | `		/* Don't bother reporting errors */` |
|     ! 0 |  2294 | `		return SXRET_OK;` |
|       - |  2295 | `	}` |
|       - |  2296 | `	/* Reset the working buffer */` |
|      31 |  2297 | `	SyBlobReset(pWorker);` |
|       - |  2298 | `	/* Peek the processed file if available */` |
|      31 |  2299 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|      31 |  2300 | `	if( pFile ){` |
|       - |  2301 | `		/* Append file name */` |
|      31 |  2302 | `		SyBlobAppend(pWorker,pFile->zString,pFile->nByte);` |
|      31 |  2303 | `		SyBlobAppend(pWorker,(const void *)" ",sizeof(char));` |
|      15 |  2304 | `	}` |
|      31 |  2305 | `	zErr = "Error: ";` |
|      31 |  2306 | `	switch(iErr){` |
|       9 |  2307 | `	case PH7_CTX_WARNING: zErr = "Warning: "; break;` |
|       7 |  2308 | `	case PH7_CTX_NOTICE:  zErr = "Notice: ";  break;` |
|       8 |  2309 | `	default:` |
|      17 |  2310 | `		iErr = PH7_CTX_ERR;` |
|      16 |  2311 | `		break;` |
|       - |  2312 | `	}` |
|      31 |  2313 | `	SyBlobAppend(pWorker,zErr,SyStrlen(zErr));` |
|      31 |  2314 | `	if( pFuncName ){` |
|       - |  2315 | `		/* Append function name first */` |
|      13 |  2316 | `		SyBlobAppend(pWorker,pFuncName->zString,pFuncName->nByte);` |
|      13 |  2317 | `		SyBlobAppend(pWorker,"(): ",sizeof("(): ")-1);` |
|       6 |  2318 | `	}` |
|       - |  2319 | `	/* Format the raw message */` |
|      31 |  2320 | `	SyBlobInit(&sMsg, &pVm->sAllocator);` |
|      31 |  2321 | `	SyBlobFormatAp(&sMsg,zFormat,ap);` |
|       - |  2322 | `	/* Check if a user error handler is installed */` |
|      31 |  2323 | `	if( VmInvokeErrorHandler(pVm, iErr, (const char *)SyBlobData(&sMsg), pFile, 0) ){` |
|       - |  2324 | `		/* No handler or handler returned TRUE, normal processing */` |
|      31 |  2325 | `		SyBlobAppend(pWorker,SyBlobData(&sMsg),SyBlobLength(&sMsg));` |
|      31 |  2326 | `		rc = VmCallErrorHandler(&(*pVm),pWorker);` |
|      15 |  2327 | `	}` |
|      31 |  2328 | `	SyBlobRelease(&sMsg);` |
|      31 |  2329 | `	return rc;` |
|      16 |  2330 |  |
|       - |  2331 | `/*` |
...
|       - |  2337 | ` * ------------------------------------` |
|       - |  2338 | ` */` |
|      18 |  2339 | `static sxi32 VmErrorFormat(ph7_vm *pVm,sxi32 iErr,const char *zFormat,...)` |
|       1 |  2340 |  |
|       - |  2341 | `	va_list ap;` |
|       - |  2342 | `	sxi32 rc;` |
|      19 |  2343 | `	va_start(ap,zFormat);` |
|      19 |  2344 | `	rc = VmThrowErrorAp(&(*pVm),0,iErr,zFormat,ap);` |
|      19 |  2345 | `	va_end(ap);` |
|      19 |  2346 | `	return rc;` |
|       1 |  2347 |  |
|       - |  2348 | `/*` |
...
|       1 |  2357 |  |
|       - |  2358 | `	sxi32 rc;` |
|      13 |  2359 | `	rc = VmThrowErrorAp(&(*pVm),&(*pFuncName),iErr,zFormat,ap);` |
|      13 |  2360 | `	return rc;` |
|       1 |  2361 |  |
|       - |  2362 | `/*` |
...
|       - |  2374 | ` */` |
|   12554 |  2375 | `static sxi32 VmByteCodeExec(` |
...
|   12555 |  2391 | `	SySetInit(&aArg,&pVm->sAllocator,sizeof(ph7_value *));` |
|   12555 |  2392 | `	if( nTos < 0 ){` |
|   12059 |  2393 | `		pTos = &pStack[-1];` |
|    6030 |  2394 | `	}else{` |
|     497 |  2395 | `		pTos = &pStack[nTos];` |
|       - |  2396 | `	}` |
|   12555 |  2397 | `	pc = 0;` |
|       - |  2398 | `	/* Execute as much as we can */` |
|  501879 |  2399 | `	for(;;){` |
|       - |  2400 | `		/* Fetch the instruction to execute */` |
| 1003759 |  2401 | `		pInstr = &aInstr[pc];` |
| 1003759 |  2402 | `		rc = SXRET_OK;` |
|       - |  2403 | `/*` |
...
|       - |  2409 | ` */` |
| 1003759 |  2410 | `		switch(pInstr->iOp){` |
|       - |  2411 | `/*` |
|       - |  2412 | ` * DONE: P1 * *` |
|       - |  2413 | ` *` |
...
|       - |  2416 | ` */` |
|    6269 |  2417 | `case PH7_OP_DONE:` |
|   12539 |  2418 | `	if( pInstr->iP1 ){` |
|       - |  2419 | `#ifdef UNTRUST` |
|       - |  2420 | `		if( pTos < pStack ){` |
|       - |  2421 | `			goto Abort;` |
|       - |  2422 | `		}` |
|       - |  2423 | `#endif` |
|    1729 |  2424 | `		if( pLastRef ){` |
|     903 |  2425 | `			*pLastRef = pTos->nIdx;` |
|     451 |  2426 | `		}` |
|    1729 |  2427 | `		if( pResult ){` |
|       - |  2428 | `			/* Execution result */` |
|    1447 |  2429 | `			PH7_MemObjStore(pTos,pResult);` |
|     723 |  2430 | `		}` |
|    1729 |  2431 | `		VmPopOperand(&pTos,1);` |
|   11675 |  2432 | `	}else if( pLastRef ){` |
|       - |  2433 | `		/* Nothing referenced */` |
|     369 |  2434 | `		*pLastRef = SXU32_HIGH;` |
|     184 |  2435 | `	}` |
|   12539 |  2436 | `	goto Done;` |
|       - |  2437 | `/*` |
|       - |  2438 | ` * HALT: P1 * *` |
|       - |  2439 | ` *` |
...
|       - |  2483 | ` */` |
|   27649 |  2484 | `case PH7_OP_JMP:` |
|   55299 |  2485 | `	pc = pInstr->iP2 - 1;` |
|   55299 |  2486 | `	break;` |
|       - |  2487 | `/*` |
|       - |  2488 | ` * JZ: P1 P2 *` |
|       - |  2489 | ` *` |
...
|   60857 |  2500 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      77 |  2501 | `		PH7_MemObjToBool(pTos);` |
|      38 |  2502 | `	}` |
|   60857 |  2503 | `	if( !pTos->x.iVal ){` |
|       - |  2504 | `		/* Take the jump */` |
|    5179 |  2505 | `		pc = pInstr->iP2 - 1;` |
|    2589 |  2506 | `	}` |
|   60857 |  2507 | `	if( !pInstr->iP1 ){` |
|   60539 |  2508 | `		VmPopOperand(&pTos,1);` |
|   30269 |  2509 | `	}` |
|   60857 |  2510 | `	break;` |
|       - |  2511 | `/*` |
|       - |  2512 | ` * JNZ: P1 P2 *` |
...
|    2119 |  2524 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     ! 0 |  2525 | `		PH7_MemObjToBool(pTos);` |
|     ! 0 |  2526 | `	}` |
|    2119 |  2527 | `	if( pTos->x.iVal ){` |
|       - |  2528 | `		/* Take the jump */` |
|      37 |  2529 | `		pc = pInstr->iP2 - 1;` |
|      18 |  2530 | `	}` |
|    2119 |  2531 | `	if( !pInstr->iP1 ){` |
|      11 |  2532 | `		VmPopOperand(&pTos,1);` |
|       5 |  2533 | `	}` |
|    2119 |  2534 | `	break;` |
|       - |  2535 | `/*` |
|       - |  2536 | ` * NOOP: * * *` |
...
|       - |  2547 | ` */` |
|   58120 |  2548 | `case PH7_OP_POP: {` |
|  116241 |  2549 | `	sxi32 n = pInstr->iP1;` |
|  116241 |  2550 | `	if( &pTos[-n+1] < pStack ){` |
|       - |  2551 | `		/* TICKET 1433-51 Stack underflow must be handled at run-time */` |
|     ! 0 |  2552 | `		n = (sxi32)(pTos - pStack);` |
|     ! 0 |  2553 | `	}` |
|  116241 |  2554 | `	VmPopOperand(&pTos,n);` |
|  116241 |  2555 | `	break;` |
|       - |  2556 | `				 }` |
|       - |  2557 | `/*` |
|       - |  2558 | ` * CVT_INT: * * *` |
...
|       - |  2561 | ` */` |
|      29 |  2562 | `case PH7_OP_CVT_INT:` |
|       - |  2563 | `#ifdef UNTRUST` |
|       - |  2564 | `	if( pTos < pStack ){` |
|       - |  2565 | `		goto Abort;` |
|       - |  2566 | `	}` |
|       - |  2567 | `#endif` |
|      59 |  2568 | `	if((pTos->iFlags & MEMOBJ_INT) == 0 ){` |
|      31 |  2569 | `		PH7_MemObjToInteger(pTos);` |
|      15 |  2570 | `	}` |
|       - |  2571 | `	/* Invalidate any prior representation */` |
|      59 |  2572 | `	MemObjSetType(pTos,MEMOBJ_INT);` |
|      59 |  2573 | `	break;` |
|       - |  2574 | `/*` |
|       - |  2575 | ` * CVT_REAL: * * *` |
|       - |  2576 | ` *` |
...
|       - |  2595 | ` */` |
|     137 |  2596 | `case PH7_OP_CVT_STR:` |
|       - |  2597 | `#ifdef UNTRUST` |
|       - |  2598 | `	if( pTos < pStack ){` |
|       - |  2599 | `		goto Abort;` |
|       - |  2600 | `	}` |
|       - |  2601 | `#endif` |
|     275 |  2602 | `	if( (pTos->iFlags & MEMOBJ_STRING) == 0 ){` |
|     275 |  2603 | `		PH7_MemObjToString(pTos);` |
|     137 |  2604 | `	}` |
|     275 |  2605 | `	break;` |
|       - |  2606 | `/*` |
|       - |  2607 | ` * CVT_BOOL: * * *` |
...
|       - |  2610 | ` */` |
|       6 |  2611 | `case PH7_OP_CVT_BOOL:` |
|       - |  2612 | `#ifdef UNTRUST` |
|       - |  2613 | `	if( pTos < pStack ){` |
|       - |  2614 | `		goto Abort;` |
|       - |  2615 | `	}` |
|       - |  2616 | `#endif` |
|      13 |  2617 | `	if( (pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|       9 |  2618 | `		PH7_MemObjToBool(pTos);` |
|       4 |  2619 | `	}` |
|      13 |  2620 | `	break;` |
|       - |  2621 | `/*` |
|       - |  2622 | ` * CVT_NULL: * * *` |
...
|       - |  2702 | ` */` |
|      13 |  2703 | `case PH7_OP_IS_A:{` |
|      27 |  2704 | `	ph7_value *pNos = &pTos[-1];` |
|      27 |  2705 | `	sxi32 iRes = 0; /* assume false by default */` |
|       - |  2706 | `#ifdef UNTRUST` |
|       - |  2707 | `	if( pNos < pStack ){` |
|       - |  2708 | `		goto Abort;` |
|       - |  2709 | `	}` |
|       - |  2710 | `#endif` |
|      27 |  2711 | `	if( pNos->iFlags& MEMOBJ_OBJ ){` |
|      23 |  2712 | `		ph7_class_instance *pThis = (ph7_class_instance *)pNos->x.pOther;` |
|      23 |  2713 | `		ph7_class *pClass = 0;` |
|       - |  2714 | `		/* Extract the target class */` |
|      23 |  2715 | `		if( pTos->iFlags & MEMOBJ_OBJ ){` |
|       - |  2716 | `			/* Instance already loaded */` |
|     ! 0 |  2717 | `			pClass = ((ph7_class_instance *)pTos->x.pOther)->pClass;` |
|      23 |  2718 | `		}else if( pTos->iFlags & MEMOBJ_STRING && SyBlobLength(&pTos->sBlob) > 0 ){` |
|       - |  2719 | `			/* Perform the query */` |
|      34 |  2720 | `			pClass = PH7_VmExtractClass(&(*pVm),(const char *)SyBlobData(&pTos->sBlob),` |
|      22 |  2721 | `				SyBlobLength(&pTos->sBlob),FALSE,0);` |
|      11 |  2722 | `		}` |
|      23 |  2723 | `		if( pClass ){` |
|       - |  2724 | `			/* Perform the query */` |
|      23 |  2725 | `			iRes = VmInstanceOf(pThis->pClass,pClass);` |
|      11 |  2726 | `		}` |
|      11 |  2727 | `	}` |
|       - |  2728 | `	/* Push result */` |
|      27 |  2729 | `	VmPopOperand(&pTos,1);` |
|      27 |  2730 | `	PH7_MemObjRelease(pTos);` |
|      27 |  2731 | `	pTos->x.iVal = iRes;` |
|      27 |  2732 | `	MemObjSetType(pTos,MEMOBJ_BOOL);` |
|      27 |  2733 | `	break;` |
|       - |  2734 | `				 }` |
|       - |  2735 |  |
|       - |  2736 | `/*` |
...
|       - |  2741 | ` */` |
|  106301 |  2742 | `case PH7_OP_LOADC: {` |
|       - |  2743 | `	ph7_value *pObj;` |
|       - |  2744 | `	/* Reserve a room */` |
|  212603 |  2745 | `	pTos++;` |
|  212603 |  2746 | `	if( (pObj = (ph7_value *)SySetAt(&pVm->aLitObj,pInstr->iP2)) != 0 ){` |
|  212603 |  2747 | `		if( pInstr->iP1 == 1 && SyBlobLength(&pObj->sBlob) <= 64 ){` |
|       - |  2748 | `			SyHashEntry *pEntry;` |
|       - |  2749 | `			/* Candidate for expansion via user defined callbacks */` |
|    2217 |  2750 | `			pEntry = SyHashGet(&pVm->hConstant,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|    2217 |  2751 | `			if( pEntry ){` |
|    1271 |  2752 | `				ph7_constant *pCons = (ph7_constant *)pEntry->pUserData;` |
|       - |  2753 | `				/* Set a NULL default value */` |
|    1271 |  2754 | `				MemObjSetType(pTos,MEMOBJ_NULL);` |
|    1271 |  2755 | `				SyBlobReset(&pTos->sBlob);` |
|       - |  2756 | `				/* Invoke the callback and deal with the expanded value */` |
|    1271 |  2757 | `				pCons->xExpand(pTos,pCons->pUserData);` |
|       - |  2758 | `				/* Mark as constant */` |
|    1271 |  2759 | `				pTos->nIdx = SXU32_HIGH;` |
|    1271 |  2760 | `				break;` |
|       - |  2761 | `			}` |
|     473 |  2762 | `		}` |
|  211333 |  2763 | `		PH7_MemObjLoad(pObj,pTos);` |
|  105667 |  2764 | `	}else{` |
|       - |  2765 | `		/* Set a NULL value */` |
|     ! 0 |  2766 | `		MemObjSetType(pTos,MEMOBJ_NULL);` |
|       - |  2767 | `	}` |
|       - |  2768 | `	/* Mark as constant */` |
|  211333 |  2769 | `	pTos->nIdx = SXU32_HIGH;` |
|  211333 |  2770 | `	break;` |
|       - |  2771 | `				  }` |
|       - |  2772 | `/*` |
|       - |  2773 | ` * LOAD: P1 * P3` |
...
|       - |  2779 | ` */` |
|  126557 |  2780 | `case PH7_OP_LOAD:{` |
|       - |  2781 | `	ph7_value *pObj;` |
|       - |  2782 | `	SyString sName;` |
|  253115 |  2783 | `	if( pInstr->p3 == 0 ){` |
...
|      17 |  2791 | `		if( (pTos->iFlags & MEMOBJ_STRING) == 0 ){` |
|     ! 0 |  2792 | `			PH7_MemObjToString(pTos);` |
|     ! 0 |  2793 | `		}` |
|      17 |  2794 | `		SyStringInitFromBuf(&sName,SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
|       9 |  2795 | `	}else{` |
|  253099 |  2796 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|       - |  2797 | `		/* Reserve a room for the target object */` |
|  253099 |  2798 | `		pTos++;` |
|       - |  2799 | `	}` |
|       - |  2800 | `	/* Extract the requested memory object */` |
|  253115 |  2801 | `	pObj = VmExtractMemObj(&(*pVm),&sName,pInstr->p3 ? FALSE : TRUE,pInstr->iP1 != 1);` |
|  253115 |  2802 | `	if( pObj == 0 ){` |
|    1053 |  2803 | `		if( pInstr->iP1 ){` |
|       - |  2804 | `			/* Variable not found,load NULL */` |
|    1053 |  2805 | `			if( !pInstr->p3 ){` |
|     ! 0 |  2806 | `				PH7_MemObjRelease(pTos);` |
|     ! 0 |  2807 | `			}else{` |
|    1053 |  2808 | `				MemObjSetType(pTos,MEMOBJ_NULL);` |
|       - |  2809 | `			}` |
|    1053 |  2810 | `			pTos->nIdx = SXU32_HIGH; /* Mark as constant */` |
|  127084 |  2811 | `			break;` |
|     ! 0 |  2812 | `		}else{` |
|       - |  2813 | `			/* Fatal error */` |
...
|  252063 |  2819 | `	PH7_MemObjLoad(pObj,pTos);` |
|  252063 |  2820 | `	pTos->nIdx = pObj->nIdx;` |
|  252063 |  2821 | `	break;` |
|       - |  2822 | `				   }` |
|       - |  2823 | `/*` |
|       - |  2824 | ` * LOAD_MAP P1 * *` |
...
|       - |  2829 | ` */` |
|     788 |  2830 | `case PH7_OP_LOAD_MAP: {` |
|       - |  2831 | `	ph7_hashmap *pMap;` |
|       - |  2832 | `	/* Allocate a new hashmap instance */` |
|    1577 |  2833 | `	pMap = PH7_NewHashmap(&(*pVm),0,0);` |
|    1577 |  2834 | `	if( pMap == 0 ){` |
...
|     ! 0 |  2837 | `		goto Abort;` |
|       - |  2838 | `	}` |
|    1577 |  2839 | `	if( pInstr->iP1 > 0 ){` |
|    1429 |  2840 | `		ph7_value *pEntry = &pTos[-pInstr->iP1+1]; /* Point to the first entry */` |
|       - |  2841 | `		/* Perform the insertion */` |
|    3989 |  2842 | `		while( pEntry < pTos ){` |
|    2561 |  2843 | `			if( pEntry[1].iFlags & MEMOBJ_REFERENCE ){` |
...
|    3700 |  2851 | `				PH7_HashmapInsert(pMap,` |
|    2466 |  2852 | `					(pEntry->iFlags & MEMOBJ_NULL) ? 0 /* Automatic index assign */ : pEntry,` |
|    1233 |  2853 | `					&pEntry[1]` |
|       - |  2854 | `				);` |
|       - |  2855 | `			}` |
...
|    1429 |  2860 | `		VmPopOperand(&pTos,pInstr->iP1);` |
|     714 |  2861 | `	}` |
|       - |  2862 | `	/* Push the hashmap */` |
|    1577 |  2863 | `	pTos++;` |
|    1577 |  2864 | `	pTos->nIdx = SXU32_HIGH;` |
|    1577 |  2865 | `	pTos->x.pOther = pMap;` |
|    1577 |  2866 | `	MemObjSetType(pTos,MEMOBJ_HASHMAP);` |
|    1577 |  2867 | `	break;` |
|       - |  2868 | `					  }` |
|       - |  2869 | `/*` |
|       - |  2870 | ` * LOAD_LIST: P1 * *` |
...
|       - |  2921 | ` * instead.` |
|       - |  2922 | ` */` |
|    2785 |  2923 | `case PH7_OP_LOAD_IDX: {` |
|    5571 |  2924 | `	ph7_hashmap_node *pNode = 0; /* cc warning */` |
|    5571 |  2925 | `	ph7_hashmap *pMap = 0;` |
|       - |  2926 | `	ph7_value *pIdx;` |
|    5571 |  2927 | `	pIdx = 0;` |
|    5571 |  2928 | `	if( pInstr->iP1 == 0 ){` |
...
|    5571 |  2946 | `		pTos--;` |
|       - |  2947 | `	}` |
|    5571 |  2948 | `	if( pTos->iFlags & MEMOBJ_STRING ){` |
|       - |  2949 | `		/* String access */` |
|     ! 0 |  2950 | `		if( pIdx ){` |
|       - |  2951 | `			sxu32 nOfft;` |
|     ! 0 |  2952 | `			if( (pIdx->iFlags & MEMOBJ_INT) == 0 ){` |
|       - |  2953 | `				/* Force an int cast */` |
|     ! 0 |  2954 | `				PH7_MemObjToInteger(pIdx);` |
|     ! 0 |  2955 | `			}` |
|     ! 0 |  2956 | `			nOfft = (sxu32)pIdx->x.iVal;` |
|     ! 0 |  2957 | `			if( nOfft >= SyBlobLength(&pTos->sBlob) ){` |
|       - |  2958 | `				/* Invalid offset,load null */` |
|     ! 0 |  2959 | `				PH7_MemObjRelease(pTos);` |
|     ! 0 |  2960 | `			}else{` |
|     ! 0 |  2961 | `				const char *zData = (const char *)SyBlobData(&pTos->sBlob);` |
|     ! 0 |  2962 | `				int c = zData[nOfft];` |
|     ! 0 |  2963 | `				PH7_MemObjRelease(pTos);` |
|     ! 0 |  2964 | `				MemObjSetType(pTos,MEMOBJ_STRING);` |
|     ! 0 |  2965 | `				SyBlobAppend(&pTos->sBlob,(const void *)&c,sizeof(char));` |
|       - |  2966 | `			}` |
|     ! 0 |  2967 | `		}else{` |
...
|     ! 0 |  2971 | `		break;` |
|       - |  2972 | `	}` |
|    5571 |  2973 | `	if( pInstr->iP2 && (pTos->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
...
|     ! 0 |  2980 | `		}` |
|     ! 0 |  2981 | `	}` |
|    5571 |  2982 | `	rc = SXERR_NOTFOUND; /* Assume the index is invalid */` |
|    5571 |  2983 | `	if( pTos->iFlags & MEMOBJ_HASHMAP ){` |
|       - |  2984 | `		/* Point to the hashmap */` |
|    5571 |  2985 | `		pMap = (ph7_hashmap *)pTos->x.pOther;` |
|    5571 |  2986 | `		if( pIdx ){` |
|       - |  2987 | `			/* Load the desired entry */` |
|    5571 |  2988 | `			rc = PH7_HashmapLookup(pMap,pIdx,&pNode);` |
|    2785 |  2989 | `		}` |
|    5571 |  2990 | `		if( rc != SXRET_OK && pInstr->iP2 ){` |
...
|    2785 |  2998 | `	}` |
|    5571 |  2999 | `	if( pIdx ){` |
|    5571 |  3000 | `		PH7_MemObjRelease(pIdx);` |
|    2785 |  3001 | `	}` |
|    5571 |  3002 | `	if( rc == SXRET_OK ){` |
|       - |  3003 | `		/* Load entry contents */` |
|    5255 |  3004 | `		if( pMap->iRef < 2 ){` |
...
|     ! 0 |  3010 | `		}else{` |
|    5255 |  3011 | `			pTos->nIdx = pNode->nValIdx;` |
|    5255 |  3012 | `			PH7_HashmapExtractNodeValue(pNode,pTos,FALSE);` |
|    5255 |  3013 | `			PH7_HashmapUnref(pMap);` |
|       - |  3014 | `		}` |
|    2628 |  3015 | `	}else{` |
|       - |  3016 | `		/* No such entry,load NULL */` |
|     317 |  3017 | `		PH7_MemObjRelease(pTos);` |
|     317 |  3018 | `		pTos->nIdx = SXU32_HIGH;` |
|       - |  3019 | `	}` |
|    5571 |  3020 | `	break;` |
|       - |  3021 | `					  }` |
|       - |  3022 | `/*` |
...
|       - |  3027 | ` */` |
|       3 |  3028 | `case PH7_OP_LOAD_CLOSURE:{` |
|       7 |  3029 | `	ph7_vm_func *pFunc = (ph7_vm_func *)pInstr->p3;` |
|       7 |  3030 | `	if( pFunc->iFlags & VM_FUNC_CLOSURE ){` |
...
|       7 |  3037 | `		pClosure = (ph7_vm_func *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_vm_func));` |
|       - |  3038 | `		/* Generate an unique closure name */` |
|       7 |  3039 | `		zName = (char *)SyMemBackendAlloc(&pVm->sAllocator,sizeof("[closure_]")+64);` |
|       7 |  3040 | `		if( pClosure == 0 \|\| zName == 0){` |
|     ! 0 |  3041 | `			PH7_VmThrowError(pVm,0,E_ERROR,"Fatal: PH7 is running out of memory while creating closure environment");` |
|     ! 0 |  3042 | `			goto Abort;` |
|       - |  3043 | `		}` |
|       7 |  3044 | `		mLen = SyBufferFormat(zName,sizeof("[closure_]")+64,"[closure_%d]",pVm->closure_cnt++);` |
|       7 |  3045 | `		while( SyHashGet(&pVm->hFunction,zName,mLen) != 0 && mLen < (sizeof("[closure_]")+60/* not 64 */) ){` |
|     ! 0 |  3046 | `			mLen = SyBufferFormat(zName,sizeof("[closure_]")+64,"[closure_%d]",pVm->closure_cnt++);` |
|     ! 0 |  3047 | `		}` |
|       - |  3048 | `		/* Zero the stucture */` |
|       7 |  3049 | `		SyZero(pClosure,sizeof(ph7_vm_func));` |
|       - |  3050 | `		/* Perform a structure assignment on read-only items */` |
|       7 |  3051 | `		pClosure->aArgs = pFunc->aArgs;` |
|       7 |  3052 | `		pClosure->aByteCode = pFunc->aByteCode;` |
|       7 |  3053 | `		pClosure->aStatic = pFunc->aStatic;` |
|       7 |  3054 | `		pClosure->iFlags = pFunc->iFlags;` |
|       7 |  3055 | `		pClosure->pUserData = pFunc->pUserData;` |
|       7 |  3056 | `		pClosure->sSignature = pFunc->sSignature;` |
|       7 |  3057 | `		SyStringInitFromBuf(&pClosure->sName,zName,mLen);` |
|       - |  3058 | `		/* Register the closure */` |
|       7 |  3059 | `		PH7_VmInstallUserFunction(pVm,pClosure,0);` |
|       - |  3060 | `		/* Set up closure environment */` |
|       7 |  3061 | `		SySetInit(&pClosure->aClosureEnv,&pVm->sAllocator,sizeof(ph7_vm_func_closure_env));` |
|       7 |  3062 | `		aEnv = (ph7_vm_func_closure_env *)SySetBasePtr(&pFunc->aClosureEnv);` |
|      19 |  3063 | `		for( n = 0 ; n < SySetUsed(&pFunc->aClosureEnv) ; ++n ){` |
|       - |  3064 | `			ph7_value *pValue;` |
|      13 |  3065 | `			pEnv = &aEnv[n];` |
|      13 |  3066 | `			sEnv.sName  = pEnv->sName;` |
|      13 |  3067 | `			sEnv.iFlags = pEnv->iFlags;` |
|      13 |  3068 | `			sEnv.nIdx = SXU32_HIGH;` |
|      13 |  3069 | `			PH7_MemObjInit(pVm,&sEnv.sValue);` |
|      13 |  3070 | `			if( sEnv.iFlags & VM_FUNC_ARG_BY_REF ){` |
...
|      13 |  3077 | `			pValue = VmExtractMemObj(pVm,&sEnv.sName,FALSE,FALSE);` |
|      13 |  3078 | `			if( pValue ){` |
|       - |  3079 | `				/* Copy imported value */` |
|       7 |  3080 | `				PH7_MemObjStore(pValue,&sEnv.sValue);` |
|       3 |  3081 | `			}` |
|       - |  3082 | `			/* Insert the imported variable */` |
|      13 |  3083 | `			SySetPut(&pClosure->aClosureEnv,(const void *)&sEnv);` |
|       7 |  3084 | `		}` |
|       - |  3085 | `		/* Finally,load the closure name on the stack */` |
|       7 |  3086 | `		pTos++;` |
|       7 |  3087 | `		PH7_MemObjStringAppend(pTos,zName,mLen);` |
|       3 |  3088 | `	}` |
|       7 |  3089 | `	break;` |
|       - |  3090 | `						 }` |
|       - |  3091 | `/*` |
...
|       - |  3102 | `	}` |
|       - |  3103 | `#endif` |
|    6395 |  3104 | `	if( pInstr->iP2 ){` |
|       - |  3105 | `		sxu32 nIdx;` |
|       - |  3106 | `		/* Member store operation */` |
|     487 |  3107 | `		nIdx = pTos->nIdx;` |
|     487 |  3108 | `		VmPopOperand(&pTos,1);` |
|     487 |  3109 | `		if( nIdx == SXU32_HIGH ){` |
...
|     483 |  3115 | `			pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|     483 |  3116 | `			if( pObj ){` |
|       - |  3117 | `				/* Perform the store operation */` |
|     483 |  3118 | `				PH7_MemObjStore(pTos,pObj);` |
|     241 |  3119 | `			}` |
|       - |  3120 | `		}` |
|    3441 |  3121 | `		break;` |
|    5909 |  3122 | `	}else if( pInstr->p3 == 0 ){` |
...
|       - |  3157 | ` */` |
|   27018 |  3158 | `case PH7_OP_STORE_IDX:` |
|       - |  3159 | `case PH7_OP_STORE_IDX_REF: {` |
|   54037 |  3160 | `	ph7_hashmap *pMap = 0; /* cc  warning */` |
|       - |  3161 | `	ph7_value *pKey;` |
|       - |  3162 | `	sxu32 nIdx;` |
|   54037 |  3163 | `	if( pInstr->iP1 ){` |
|       - |  3164 | `		/* Key is next on stack */` |
|   33783 |  3165 | `		pKey = pTos;` |
|   33783 |  3166 | `		pTos--;` |
|   16892 |  3167 | `	}else{` |
|   20255 |  3168 | `		pKey = 0;` |
|       - |  3169 | `	}` |
|   54037 |  3170 | `	nIdx = pTos->nIdx;` |
|   54037 |  3171 | `	if( pTos->iFlags & MEMOBJ_HASHMAP ){` |
|       - |  3172 | `		/* Hashmap already loaded */` |
|   53985 |  3173 | `		pMap = (ph7_hashmap *)pTos->x.pOther;` |
|   53985 |  3174 | `		if( pMap->iRef < 2 ){` |
...
|       - |  3231 | `	}` |
|   53985 |  3232 | `	VmPopOperand(&pTos,1);` |
|       - |  3233 | `	/* Phase#2: Perform the insertion */` |
|   53985 |  3234 | `	if( pInstr->iOp == PH7_OP_STORE_IDX_REF && pTos->nIdx != SXU32_HIGH ){` |
|       - |  3235 | `		/* Insertion by reference */` |
|      13 |  3236 | `		PH7_HashmapInsertByRef(pMap,pKey,pTos->nIdx);` |
|       7 |  3237 | `	}else{` |
|   53973 |  3238 | `		PH7_HashmapInsert(pMap,pKey,pTos);` |
|       - |  3239 | `	}` |
|   53985 |  3240 | `	if( pKey ){` |
|   33733 |  3241 | `		PH7_MemObjRelease(pKey);` |
|   16866 |  3242 | `	}` |
|   53985 |  3243 | `	break;` |
|       - |  3244 | `					   }` |
|       - |  3245 | `/*` |
...
|       - |  3251 | ` */` |
|   25995 |  3252 | `case PH7_OP_INCR:` |
|       - |  3253 | `#ifdef UNTRUST` |
|       - |  3254 | `	if( pTos < pStack ){` |
|       - |  3255 | `		goto Abort;` |
|       - |  3256 | `	}` |
|       - |  3257 | `#endif` |
|   51991 |  3258 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) == 0 ){` |
|   51991 |  3259 | `		if( pTos->nIdx != SXU32_HIGH ){` |
|       - |  3260 | `			ph7_value *pObj;` |
|   51991 |  3261 | `			if( (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pTos->nIdx)) != 0 ){` |
|       - |  3262 | `				/* Force a numeric cast */` |
|   51991 |  3263 | `				PH7_MemObjToNumeric(pObj);` |
|   51991 |  3264 | `				if( pObj->iFlags & MEMOBJ_REAL ){` |
|     ! 0 |  3265 | `					pObj->rVal++;` |
|       - |  3266 | `					/* Try to get an integer representation */` |
|     ! 0 |  3267 | `					PH7_MemObjTryInteger(pTos);` |
|     ! 0 |  3268 | `				}else{` |
|   51991 |  3269 | `					pObj->x.iVal++;` |
|   51991 |  3270 | `					MemObjSetType(pTos,MEMOBJ_INT);` |
|       - |  3271 | `				}` |
|   51991 |  3272 | `				if( pInstr->iP1 ){` |
|       - |  3273 | `					/* Pre-icrement */` |
|      65 |  3274 | `					PH7_MemObjStore(pObj,pTos);` |
|      32 |  3275 | `				}` |
|   25995 |  3276 | `			}` |
|   25996 |  3277 | `		}else{` |
...
|     203 |  3355 | `	PH7_MemObjToNumeric(pTos);` |
|     203 |  3356 | `	if( pTos->iFlags & MEMOBJ_REAL ){` |
|      17 |  3357 | `		pTos->rVal = -pTos->rVal;` |
|       8 |  3358 | `	}` |
|     203 |  3359 | `	if( pTos->iFlags & MEMOBJ_INT ){` |
|     187 |  3360 | `		pTos->x.iVal = -pTos->x.iVal;` |
|      93 |  3361 | `	}` |
|     203 |  3362 | `	break;` |
|       - |  3363 | `/*` |
|       - |  3364 | ` * UPLUS: * * *` |
...
|    2467 |  3396 | `	if( (pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      21 |  3397 | `		PH7_MemObjToBool(pTos);` |
|      10 |  3398 | `	}` |
|    2467 |  3399 | `	pTos->x.iVal = !pTos->x.iVal;` |
|    2467 |  3400 | `	break;` |
|       - |  3401 | `/*` |
|       - |  3402 | ` * OP_BITNOT: * * *` |
|       - |  3403 | ` *` |
...
|       - |  3424 | ` */` |
|    1236 |  3425 | `case PH7_OP_MUL:` |
|       - |  3426 | `case PH7_OP_MUL_STORE: {` |
|    2473 |  3427 | `	ph7_value *pNos = &pTos[-1];` |
...
|       - |  3432 | `	}` |
|       - |  3433 | `#endif` |
|    2473 |  3434 | `	PH7_MemObjToNumeric(pTos);` |
|    2473 |  3435 | `	PH7_MemObjToNumeric(pNos);` |
|       - |  3436 | `	/* Perform the requested operation */` |
|    2473 |  3437 | `	if( MEMOBJ_REAL & (pTos->iFlags\|pNos->iFlags) ){` |
...
|       - |  3456 | `		sxi64 a,b,r;` |
|    2457 |  3457 | `		a = pNos->x.iVal;` |
|    2457 |  3458 | `		b = pTos->x.iVal;` |
|    2457 |  3459 | `		r = a * b;` |
|       - |  3460 | `		/* Push the result */` |
|    2457 |  3461 | `		pNos->x.iVal = r;` |
|    2457 |  3462 | `		MemObjSetType(pNos,MEMOBJ_INT);` |
|       - |  3463 | `	}` |
|    2473 |  3464 | `	if( pInstr->iOp == PH7_OP_MUL_STORE ){` |
|       - |  3465 | `		ph7_value *pObj;` |
|      25 |  3466 | `		if( pTos->nIdx == SXU32_HIGH ){` |
|     ! 0 |  3467 | `			PH7_VmThrowError(&(*pVm),0,PH7_CTX_ERR,"Cannot perform assignment on a constant class attribute");` |
|      25 |  3468 | `		}else if( (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pTos->nIdx)) != 0 ){` |
|      25 |  3469 | `			PH7_MemObjStore(pNos,pObj);` |
|      12 |  3470 | `		}` |
|      12 |  3471 | `	}` |
|    2473 |  3472 | `	VmPopOperand(&pTos,1);` |
|    2473 |  3473 | `	break;` |
|       - |  3474 | `				 }` |
|       - |  3475 | `/* OP_ADD * * *` |
|       - |  3476 | ` *` |
...
|       - |  3479 | ` */` |
|     414 |  3480 | `case PH7_OP_ADD:{` |
|     829 |  3481 | `	ph7_value *pNos = &pTos[-1];` |
|       - |  3482 | `#ifdef UNTRUST` |
|       - |  3483 | `	if( pNos < pStack ){` |
|       - |  3484 | `		goto Abort;` |
|       - |  3485 | `	}` |
...
|     829 |  3488 | `	PH7_MemObjAdd(pNos,pTos,FALSE);` |
|     829 |  3489 | `	VmPopOperand(&pTos,1);` |
|     829 |  3490 | `	break;` |
|       - |  3491 | `				}` |
|       - |  3492 | `/*` |
|       - |  3493 | ` * OP_ADD_STORE * * *` |
...
|       - |  3497 | ` */` |
|     492 |  3498 | `case PH7_OP_ADD_STORE:{` |
|     985 |  3499 | `	ph7_value *pNos = &pTos[-1];` |
|       - |  3500 | `	ph7_value *pObj;` |
|       - |  3501 | `	sxu32 nIdx;` |
|       - |  3502 | `#ifdef UNTRUST` |
|       - |  3503 | `	if( pNos < pStack ){` |
...
|     985 |  3508 | `	nIdx = pTos->nIdx;` |
|     985 |  3509 | `	PH7_MemObjAdd(pTos,pNos,TRUE);` |
|       - |  3510 | `	/* Peform the store operation */` |
|     985 |  3511 | `	if( nIdx == SXU32_HIGH ){` |
|     ! 0 |  3512 | `		PH7_VmThrowError(&(*pVm),0,PH7_CTX_ERR,"Cannot perform assignment on a constant class attribute");` |
|     985 |  3513 | `	}else if( (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx)) != 0 ){` |
|     985 |  3514 | `		PH7_MemObjStore(pTos,pObj);` |
|     492 |  3515 | `	}` |
|       - |  3516 | `	/* Ticket 1433-35: Perform a stack dup */` |
|     985 |  3517 | `	PH7_MemObjStore(pTos,pNos);` |
|     985 |  3518 | `	VmPopOperand(&pTos,1);` |
|     985 |  3519 | `	break;` |
|       - |  3520 | `				}` |
|       - |  3521 | `/* OP_SUB * * *` |
|       - |  3522 | ` *` |
...
|       - |  3526 | ` */` |
|     281 |  3527 | `case PH7_OP_SUB: {` |
|     563 |  3528 | `	ph7_value *pNos = &pTos[-1];` |
|       - |  3529 | `#ifdef UNTRUST` |
|       - |  3530 | `	if( pNos < pStack ){` |
|       - |  3531 | `		goto Abort;` |
|       - |  3532 | `	}` |
|       - |  3533 | `#endif` |
|     563 |  3534 | `	if( MEMOBJ_REAL & (pTos->iFlags\|pNos->iFlags) ){` |
...
|       - |  3553 | `		sxi64 a,b,r;` |
|     491 |  3554 | `		a = pNos->x.iVal;` |
|     491 |  3555 | `		b = pTos->x.iVal;` |
|     491 |  3556 | `		r = a - b;` |
|       - |  3557 | `		/* Push the result */` |
|     491 |  3558 | `		pNos->x.iVal = r;` |
|     491 |  3559 | `		MemObjSetType(pNos,MEMOBJ_INT);` |
|       - |  3560 | `	}` |
|     563 |  3561 | `	VmPopOperand(&pTos,1);` |
|     563 |  3562 | `	break;` |
|       - |  3563 | `				 }` |
|       - |  3564 | `/* OP_SUB_STORE * * *` |
|       - |  3565 | ` *` |
...
|       - |  3622 | ` */` |
|     305 |  3623 | `case PH7_OP_MOD:{` |
|     611 |  3624 | `	ph7_value *pNos = &pTos[-1];` |
|       - |  3625 | `	sxi64 a,b,r;` |
|       - |  3626 | `#ifdef UNTRUST` |
|       - |  3627 | `	if( pNos < pStack ){` |
|       - |  3628 | `		goto Abort;` |
...
|     611 |  3632 | `	if( (pTos->iFlags & MEMOBJ_INT) == 0 ){` |
|     ! 0 |  3633 | `		PH7_MemObjToInteger(pTos);` |
|     ! 0 |  3634 | `	}` |
|     611 |  3635 | `	if( (pNos->iFlags & MEMOBJ_INT) == 0 ){` |
|       5 |  3636 | `		PH7_MemObjToInteger(pNos);` |
|       2 |  3637 | `	}` |
|       - |  3638 | `	/* Perform the requested operation */` |
|     611 |  3639 | `	a = pNos->x.iVal;` |
|     611 |  3640 | `	b = pTos->x.iVal;` |
|     611 |  3641 | `	if( b == 0 ){` |
|       3 |  3642 | `		r = 0;` |
...
|     611 |  3649 | `	pNos->x.iVal = r;` |
|     611 |  3650 | `	MemObjSetType(pNos,MEMOBJ_INT);` |
|     611 |  3651 | `	VmPopOperand(&pTos,1);` |
|     611 |  3652 | `	break;` |
|       - |  3653 | `				}` |
|       - |  3654 | `/*` |
|       - |  3655 | ` * OP_MOD_STORE * * *` |
...
|       - |  3707 | ` */` |
|      29 |  3708 | `case PH7_OP_DIV:{` |
|      59 |  3709 | `	ph7_value *pNos = &pTos[-1];` |
|       - |  3710 | `	ph7_real a,b,r;` |
|       - |  3711 | `#ifdef UNTRUST` |
|       - |  3712 | `	if( pNos < pStack ){` |
|       - |  3713 | `		goto Abort;` |
...
|      59 |  3717 | `	if( (pTos->iFlags & MEMOBJ_REAL) == 0 ){` |
|      55 |  3718 | `		PH7_MemObjToReal(pTos);` |
|      27 |  3719 | `	}` |
|      59 |  3720 | `	if( (pNos->iFlags & MEMOBJ_REAL) == 0 ){` |
|      21 |  3721 | `		PH7_MemObjToReal(pNos);` |
|      10 |  3722 | `	}` |
...
|      57 |  3734 | `		pNos->rVal = r;` |
|      57 |  3735 | `		MemObjSetType(pNos,MEMOBJ_REAL);` |
|       - |  3736 | `		/* Try to get an integer representation */` |
|      57 |  3737 | `		PH7_MemObjTryInteger(pNos);` |
|       - |  3738 | `	}` |
|      59 |  3739 | `	VmPopOperand(&pTos,1);` |
|      59 |  3740 | `	break;` |
|       - |  3741 | `				}` |
|       - |  3742 | `/*` |
|       - |  3743 | ` * OP_DIV_STORE * * *` |
...
|       - |  4001 | ` * back.` |
|       - |  4002 | ` */` |
|   27490 |  4003 | `case PH7_OP_CAT:{` |
|       - |  4004 | `	ph7_value *pNos,*pCur;` |
|   54981 |  4005 | `	if( pInstr->iP1 < 1 ){` |
|   28329 |  4006 | `		pNos = &pTos[-1];` |
|   14165 |  4007 | `	}else{` |
|   26653 |  4008 | `		pNos = &pTos[-pInstr->iP1+1];` |
|       - |  4009 | `	}` |
|       - |  4010 | `#ifdef UNTRUST` |
|       - |  4011 | `	if( pNos < pStack ){` |
|       - |  4012 | `		goto Abort;` |
...
|   54981 |  4016 | `	if( (pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|     547 |  4017 | `		PH7_MemObjToString(pNos);` |
|     273 |  4018 | `	}` |
|   54981 |  4019 | `	pCur = &pNos[1];` |
|  111039 |  4020 | `	while( pCur <= pTos ){` |
|   56059 |  4021 | `		if( (pCur->iFlags & MEMOBJ_STRING) == 0 ){` |
|   50129 |  4022 | `			PH7_MemObjToString(pCur);` |
|   25064 |  4023 | `		}` |
|       - |  4024 | `		/* Perform the concatenation */` |
|   56059 |  4025 | `		if( SyBlobLength(&pCur->sBlob) > 0 ){` |
|   56019 |  4026 | `			PH7_MemObjStringAppend(pNos,(const char *)SyBlobData(&pCur->sBlob),SyBlobLength(&pCur->sBlob));` |
|   28009 |  4027 | `		}` |
|   56059 |  4028 | `		SyBlobRelease(&pCur->sBlob);` |
|   56059 |  4029 | `		pCur++;` |
|       1 |  4030 | `	}` |
|   54981 |  4031 | `	pTos = pNos;` |
|   54981 |  4032 | `	break;` |
|       - |  4033 | `				}` |
|       - |  4034 | `/*  CAT_STORE: * * *` |
|       - |  4035 | ` *` |
...
|       - |  4079 | ` * stack.` |
|       - |  4080 | ` */` |
|    1171 |  4081 | `case PH7_OP_LAND:` |
|       - |  4082 | `case PH7_OP_LOR: {` |
|    2343 |  4083 | `	ph7_value *pNos = &pTos[-1];` |
...
|    2343 |  4091 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|       3 |  4092 | `		PH7_MemObjToBool(pTos);` |
|       1 |  4093 | `	}` |
|    2343 |  4094 | `	if((pNos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     ! 0 |  4095 | `		PH7_MemObjToBool(pNos);` |
|     ! 0 |  4096 | `	}` |
|    2343 |  4097 | `	v1 = pNos->x.iVal == 0 ? 1 : 0;` |
|    2343 |  4098 | `	v2 = pTos->x.iVal == 0 ? 1 : 0;` |
|    2343 |  4099 | `	if( pInstr->iOp == PH7_OP_LAND ){` |
|       - |  4100 | `		static const unsigned char and_logic[] = { 0, 1, 2, 1, 1, 1, 2, 1, 2 };` |
|     263 |  4101 | `		v1 = and_logic[v1*3+v2];` |
|     132 |  4102 | `	}else{` |
|       - |  4103 | `		static const unsigned char or_logic[] = { 0, 0, 0, 0, 1, 2, 0, 2, 2 };` |
|    2081 |  4104 | `		v1 = or_logic[v1*3+v2];` |
|       - |  4105 | `	}` |
|    2343 |  4106 | `	if( v1 == 2 ){` |
|     ! 0 |  4107 | `		v1 = 1;` |
|     ! 0 |  4108 | `	}` |
|    2343 |  4109 | `	VmPopOperand(&pTos,1);` |
|    2343 |  4110 | `	pTos->x.iVal = v1 == 0 ? 1 : 0;` |
|    2343 |  4111 | `	MemObjSetType(pTos,MEMOBJ_BOOL);` |
|    2343 |  4112 | `	break;` |
|       - |  4113 | `				 }` |
|       - |  4114 | `/* OP_LXOR: * * *` |
|       - |  4115 | ` *` |
...
|       - |  4159 | ` */` |
|     384 |  4160 | `case PH7_OP_EQ:` |
|       - |  4161 | `case PH7_OP_NEQ: {` |
|     769 |  4162 | `	ph7_value *pNos = &pTos[-1];` |
...
|       - |  4167 | `	}` |
|       - |  4168 | `#endif` |
|     769 |  4169 | `	rc = PH7_MemObjCmp(pNos,pTos,FALSE,0);` |
|     769 |  4170 | `	if( pInstr->iOp == PH7_OP_EQ ){` |
|     759 |  4171 | `		rc = rc == 0;` |
|     380 |  4172 | `	}else{` |
|      11 |  4173 | `		rc = rc != 0;` |
|       - |  4174 | `	}` |
|     769 |  4175 | `	VmPopOperand(&pTos,1);` |
|     769 |  4176 | `	if( !pInstr->iP2 ){` |
|       - |  4177 | `		/* Push comparison result without taking the jump */` |
|     769 |  4178 | `		PH7_MemObjRelease(pTos);` |
|     769 |  4179 | `		pTos->x.iVal = rc;` |
|       - |  4180 | `		/* Invalidate any prior representation */` |
|     769 |  4181 | `		MemObjSetType(pTos,MEMOBJ_BOOL);` |
|     385 |  4182 | `	}else{` |
|     ! 0 |  4183 | `		if( rc ){` |
...
|       - |  4197 | ` */` |
|     489 |  4198 | `case PH7_OP_TEQ: {` |
|     979 |  4199 | `	ph7_value *pNos = &pTos[-1];` |
...
|       - |  4204 | `	}` |
|       - |  4205 | `#endif` |
|     979 |  4206 | `	rc = PH7_MemObjCmp(pNos,pTos,TRUE,0) == 0;` |
|     979 |  4207 | `	VmPopOperand(&pTos,1);` |
|     979 |  4208 | `	if( !pInstr->iP2 ){` |
|       - |  4209 | `		/* Push comparison result without taking the jump */` |
|     979 |  4210 | `		PH7_MemObjRelease(pTos);` |
|     979 |  4211 | `		pTos->x.iVal = rc;` |
|       - |  4212 | `		/* Invalidate any prior representation */` |
|     979 |  4213 | `		MemObjSetType(pTos,MEMOBJ_BOOL);` |
|     490 |  4214 | `	}else{` |
|     ! 0 |  4215 | `		if( rc ){` |
...
|       - |  4230 | ` *` |
|       - |  4231 | ` */` |
|    1059 |  4232 | `case PH7_OP_TNE: {` |
|    2119 |  4233 | `	ph7_value *pNos = &pTos[-1];` |
...
|       - |  4238 | `	}` |
|       - |  4239 | `#endif` |
|    2119 |  4240 | `	rc = PH7_MemObjCmp(pNos,pTos,TRUE,0) != 0;` |
|    2119 |  4241 | `	VmPopOperand(&pTos,1);` |
|    2119 |  4242 | `	if( !pInstr->iP2 ){` |
|       - |  4243 | `		/* Push comparison result without taking the jump */` |
|    2119 |  4244 | `		PH7_MemObjRelease(pTos);` |
|    2119 |  4245 | `		pTos->x.iVal = rc;` |
|       - |  4246 | `		/* Invalidate any prior representation */` |
|    2119 |  4247 | `		MemObjSetType(pTos,MEMOBJ_BOOL);` |
|    1060 |  4248 | `	}else{` |
|     ! 0 |  4249 | `		if( rc ){` |
...
|       - |  4273 | ` *` |
|       - |  4274 | ` */` |
|   26824 |  4275 | `case PH7_OP_LT:` |
|       - |  4276 | `case PH7_OP_LE: {` |
|   53649 |  4277 | `	ph7_value *pNos = &pTos[-1];` |
...
|       - |  4282 | `	}` |
|       - |  4283 | `#endif` |
|   53649 |  4284 | `	rc = PH7_MemObjCmp(pNos,pTos,FALSE,0);` |
|   53649 |  4285 | `	if( pInstr->iOp == PH7_OP_LE ){` |
|     411 |  4286 | `		rc = rc < 1;` |
|     206 |  4287 | `	}else{` |
|   53239 |  4288 | `		rc = rc < 0;` |
|       - |  4289 | `	}` |
|   53649 |  4290 | `	VmPopOperand(&pTos,1);` |
|   53649 |  4291 | `	if( !pInstr->iP2 ){` |
|       - |  4292 | `		/* Push comparison result without taking the jump */` |
|   53649 |  4293 | `		PH7_MemObjRelease(pTos);` |
|   53649 |  4294 | `		pTos->x.iVal = rc;` |
|       - |  4295 | `		/* Invalidate any prior representation */` |
|   53649 |  4296 | `		MemObjSetType(pTos,MEMOBJ_BOOL);` |
|   26825 |  4297 | `	}else{` |
|     ! 0 |  4298 | `		if( rc ){` |
...
|       - |  4322 | ` *` |
|       - |  4323 | ` */` |
|     124 |  4324 | `case PH7_OP_GT:` |
|       - |  4325 | `case PH7_OP_GE: {` |
|     249 |  4326 | `	ph7_value *pNos = &pTos[-1];` |
...
|       - |  4331 | `	}` |
|       - |  4332 | `#endif` |
|     249 |  4333 | `	rc = PH7_MemObjCmp(pNos,pTos,FALSE,0);` |
|     249 |  4334 | `	if( pInstr->iOp == PH7_OP_GE ){` |
|      95 |  4335 | `		rc = rc >= 0;` |
|      48 |  4336 | `	}else{` |
|     155 |  4337 | `		rc = rc > 0;` |
|       - |  4338 | `	}` |
|     249 |  4339 | `	VmPopOperand(&pTos,1);` |
|     249 |  4340 | `	if( !pInstr->iP2 ){` |
|       - |  4341 | `		/* Push comparison result without taking the jump */` |
|     249 |  4342 | `		PH7_MemObjRelease(pTos);` |
|     249 |  4343 | `		pTos->x.iVal = rc;` |
|       - |  4344 | `		/* Invalidate any prior representation */` |
|     249 |  4345 | `		MemObjSetType(pTos,MEMOBJ_BOOL);` |
|     125 |  4346 | `	}else{` |
|     ! 0 |  4347 | `		if( rc ){` |
...
|      37 |  4386 | `	if((pTos->iFlags & MEMOBJ_STRING) == 0 ){` |
|       9 |  4387 | `		PH7_MemObjToString(pTos);` |
|       4 |  4388 | `	}` |
|      37 |  4389 | `	if((pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|       5 |  4390 | `		PH7_MemObjToString(pNos);` |
|       2 |  4391 | `	}` |
|      37 |  4392 | `	SyStringInitFromBuf(&s1,SyBlobData(&pNos->sBlob),SyBlobLength(&pNos->sBlob));` |
|      37 |  4393 | `	SyStringInitFromBuf(&s2,SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
|      37 |  4394 | `	rc = SyStringCmp(&s1,&s2,SyMemcmp);` |
|      37 |  4395 | `	if( pInstr->iOp == PH7_OP_NEQ ){` |
|     ! 0 |  4396 | `		rc = rc != 0;` |
|     ! 0 |  4397 | `	}else{` |
|      37 |  4398 | `		rc = rc == 0;` |
|       - |  4399 | `	}` |
|      37 |  4400 | `	VmPopOperand(&pTos,1);` |
|      37 |  4401 | `	if( !pInstr->iP2 ){` |
|       - |  4402 | `		/* Push comparison result without taking the jump */` |
|      37 |  4403 | `		PH7_MemObjRelease(pTos);` |
|      37 |  4404 | `		pTos->x.iVal = rc;` |
|       - |  4405 | `		/* Invalidate any prior representation */` |
|      37 |  4406 | `		MemObjSetType(pTos,MEMOBJ_BOOL);` |
|      19 |  4407 | `	}else{` |
|     ! 0 |  4408 | `		if( rc ){` |
...
|       - |  4442 | ` */` |
|      16 |  4443 | ` case PH7_OP_STORE_REF: {` |
|      33 |  4444 | `	 SyString sName = { 0 , 0 };` |
...
|     ! 0 |  4468 | `		pTos--;` |
|     ! 0 |  4469 | `	}else{` |
|      33 |  4470 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|       - |  4471 | `	}` |
|      33 |  4472 | `	nIdx = pTos->nIdx;` |
|      33 |  4473 | `	if(nIdx == SXU32_HIGH ){` |
...
|     ! 0 |  4489 | `		}` |
|      33 |  4490 | `	}else if( sName.nByte > 0){` |
|      33 |  4491 | `		if( (pTos->iFlags & MEMOBJ_HASHMAP) && (pVm->pGlobal == (ph7_hashmap *)pTos->x.pOther) ){` |
|     ! 0 |  4492 | `			PH7_VmThrowError(&(*pVm),0,PH7_CTX_ERR,"$GLOBALS is a read-only array and therefore cannot be referenced");` |
|     ! 0 |  4493 | `		}else{` |
|      33 |  4494 | `			pFrameLocal = pVm->pFrame;` |
|      33 |  4495 | `			while( pFrameLocal->pParent && (pFrameLocal->iFlags & VM_FRAME_EXCEPTION) ){` |
|       - |  4496 | `				/* Safely ignore the exception frame */` |
|     ! 0 |  4497 | `				pFrameLocal = pFrameLocal->pParent;` |
|     ! 0 |  4498 | `			}` |
|       - |  4499 | `			/* Query the local frame */` |
|      33 |  4500 | `			pEntry = SyHashGet(&pFrameLocal->hVar,(const void *)sName.zString,sName.nByte);` |
|      33 |  4501 | `			if( pEntry ){` |
|     ! 0 |  4502 | `				VmErrorFormat(&(*pVm),PH7_CTX_ERR,"Referenced variable name '%z' already exists",&sName);` |
|     ! 0 |  4503 | `			}else{` |
|      33 |  4504 | `				rc = SyHashInsert(&pFrameLocal->hVar,(const void *)sName.zString,sName.nByte,SX_INT_TO_PTR(nIdx));` |
|      33 |  4505 | `				if( pFrameLocal->pParent == 0 ){` |
|       - |  4506 | `					/* Insert in the $GLOBALS array */` |
|      29 |  4507 | `					VmHashmapRefInsert(pVm->pGlobal,sName.zString,sName.nByte,nIdx);` |
|      14 |  4508 | `				}` |
|      33 |  4509 | `				if( rc == SXRET_OK ){` |
|      33 |  4510 | `					PH7_VmRefObjInstall(&(*pVm),nIdx,SyHashLastEntry(&pFrameLocal->hVar),0,0);` |
|      16 |  4511 | `				}` |
|       - |  4512 | `			}` |
|       - |  4513 | `		}` |
|      16 |  4514 | `	}` |
...
|       - |  4521 | ` */` |
|      15 |  4522 | `case PH7_OP_UPLINK: {` |
|      31 |  4523 | `	if( pVm->pFrame->pParent ){` |
|      31 |  4524 | `		ph7_value *pLink = &pTos[-pInstr->iP1+1];` |
|       - |  4525 | `		SyString sName;` |
|       - |  4526 | `		/* Perform the link */` |
|      63 |  4527 | `		while( pLink <= pTos ){` |
|      33 |  4528 | `			if((pLink->iFlags & MEMOBJ_STRING) == 0 ){` |
|       - |  4529 | `				/* Force a string cast */` |
|     ! 0 |  4530 | `				PH7_MemObjToString(pLink);` |
|     ! 0 |  4531 | `			}` |
|      33 |  4532 | `			SyStringInitFromBuf(&sName,SyBlobData(&pLink->sBlob),SyBlobLength(&pLink->sBlob));` |
|      33 |  4533 | `			if( sName.nByte > 0 ){` |
|      33 |  4534 | `				VmFrameLink(&(*pVm),&sName);` |
|      16 |  4535 | `			}` |
|      33 |  4536 | `			pLink++;` |
|       1 |  4537 | `		}` |
|      15 |  4538 | `	}` |
|      31 |  4539 | `	VmPopOperand(&pTos,pInstr->iP1);` |
|      31 |  4540 | `	break;` |
|       - |  4541 | `					}` |
|       - |  4542 | `/*` |
...
|       - |  4546 | ` */` |
|      10 |  4547 | `case PH7_OP_LOAD_EXCEPTION: {` |
|      21 |  4548 | `	ph7_exception *pException = (ph7_exception *)pInstr->p3;` |
|       - |  4549 | `	VmFrame *pFrameLocal;` |
|      21 |  4550 | `	SySetPut(&pVm->aException,(const void *)&pException);` |
|       - |  4551 | `	/* Create the exception frame */` |
|      21 |  4552 | `	rc = VmEnterFrame(&(*pVm),0,0,&pFrameLocal);` |
|      21 |  4553 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  4554 | `		VmErrorFormat(&(*pVm),PH7_CTX_ERR,"Fatal PH7 engine is runnig out of memory");` |
|     ! 0 |  4555 | `		goto Abort;` |
|       - |  4556 | `	}` |
|       - |  4557 | `	/* Mark the special frame */` |
|      21 |  4558 | `	pFrameLocal->iFlags \|= VM_FRAME_EXCEPTION;` |
|      21 |  4559 | `	pFrameLocal->iExceptionJump = pInstr->iP2;` |
|       - |  4560 | `	/* Point to the frame that trigger the exception */` |
|      21 |  4561 | `	pFrameLocal = pFrameLocal->pParent;` |
|      23 |  4562 | `	while( pFrameLocal->pParent && (pFrameLocal->iFlags & VM_FRAME_EXCEPTION) ){` |
|       3 |  4563 | `		pFrameLocal = pFrameLocal->pParent;` |
|       1 |  4564 | `	}` |
|      21 |  4565 | `	pException->pFrame = pFrameLocal;` |
|      21 |  4566 | `	break;` |
|       - |  4567 | `							}` |
|       - |  4568 | `/*` |
...
|       - |  4571 | ` */` |
|      10 |  4572 | `case PH7_OP_POP_EXCEPTION: {` |
|      21 |  4573 | `	ph7_exception *pException = (ph7_exception *)pInstr->p3;` |
|      21 |  4574 | `	if( SySetUsed(&pVm->aException) > 0 ){` |
...
|       3 |  4580 | `		}` |
|       3 |  4581 | `	}` |
|      21 |  4582 | `	pException->pFrame = 0;` |
|       - |  4583 | `	/* Leave the exception frame */` |
|      21 |  4584 | `	VmLeaveFrame(&(*pVm));` |
|      21 |  4585 | `	break;` |
|       - |  4586 | `							}` |
|       - |  4587 |  |
|       - |  4588 | `/*` |
...
|       - |  4591 | ` */` |
|      10 |  4592 | `case PH7_OP_THROW: {` |
|      21 |  4593 | `	VmFrame *pFrameLocal = pVm->pFrame;` |
|      21 |  4594 | `	sxu32 nJump = pInstr->iP2;` |
|       - |  4595 | `#ifdef UNTRUST` |
|       - |  4596 | `	if( pTos < pStack ){` |
|       - |  4597 | `		goto Abort;` |
|       - |  4598 | `	}` |
|       - |  4599 | `#endif` |
|      27 |  4600 | `	while( pFrameLocal->pParent && (pFrameLocal->iFlags & VM_FRAME_EXCEPTION) ){` |
|       - |  4601 | `		/* Safely ignore the exception frame */` |
|       7 |  4602 | `		pFrameLocal = pFrameLocal->pParent;` |
|       1 |  4603 | `	}` |
|       - |  4604 | `	/* Tell the upper layer that an exception was thrown */` |
|      21 |  4605 | `	pFrameLocal->iFlags \|= VM_FRAME_THROW;` |
|      21 |  4606 | `	if( pTos->iFlags & MEMOBJ_OBJ ){` |
|      21 |  4607 | `		ph7_class_instance *pThis = (ph7_class_instance *)pTos->x.pOther;` |
|       - |  4608 | `		ph7_class *pException;` |
|       - |  4609 | `		/* Make sure the loaded object is an instance of the 'Exception' base class.` |
|       - |  4610 | `		 */` |
|      21 |  4611 | `		pException = PH7_VmExtractClass(&(*pVm),"Exception",sizeof("Exception")-1,TRUE,0);` |
|      21 |  4612 | `		if( pException == 0 \|\| !VmInstanceOf(pThis->pClass,pException) ){` |
...
|      21 |  4621 | `			rc = VmThrowException(&(*pVm),pThis);` |
|      21 |  4622 | `			if( rc == SXERR_ABORT ){` |
...
|       - |  4644 | ` */` |
|      42 |  4645 | `case PH7_OP_FOREACH_INIT: {` |
|      85 |  4646 | `	ph7_foreach_info *pInfo = (ph7_foreach_info *)pInstr->p3;` |
|       - |  4647 | `	void *pName;` |
|       - |  4648 | `#ifdef UNTRUST` |
|       - |  4649 | `	if( pTos < pStack ){` |
|       - |  4650 | `		goto Abort;` |
|       - |  4651 | `	}` |
|       - |  4652 | `#endif` |
|      85 |  4653 | `	if( SyStringLength(&pInfo->sValue) < 1 ){` |
...
|     ! 0 |  4665 | `	}` |
|      85 |  4666 | `	if( (pInfo->iFlags & PH7_4EACH_STEP_KEY) && SyStringLength(&pInfo->sKey) < 1 ){` |
...
|      85 |  4679 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ)) == 0 \|\| SyStringLength(&pInfo->sValue) < 1 ){` |
...
|      85 |  4687 | `		pStep = (ph7_foreach_step *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_foreach_step));` |
|      85 |  4688 | `		if( pStep == 0 ){` |
...
|      85 |  4694 | `			SyZero(pStep,sizeof(ph7_foreach_step));` |
|       - |  4695 | `			/* Prepare the step */` |
|      85 |  4696 | `			pStep->iFlags = pInfo->iFlags;` |
|      85 |  4697 | `			if( pTos->iFlags & MEMOBJ_HASHMAP ){` |
|      77 |  4698 | `				ph7_hashmap *pMap = (ph7_hashmap *)pTos->x.pOther;` |
|       - |  4699 | `				/* Reset the internal loop cursor */` |
|      77 |  4700 | `				PH7_HashmapResetLoopCursor(pMap);` |
|       - |  4701 | `				/* Mark the step */` |
|      77 |  4702 | `				pStep->iFlags \|= PH7_4EACH_STEP_HASHMAP;` |
|      77 |  4703 | `				pStep->xIter.pMap = pMap;` |
|      77 |  4704 | `				pMap->iRef++;` |
|      39 |  4705 | `			}else{` |
...
|       - |  4713 | `			}` |
|       - |  4714 | `		}` |
|      85 |  4715 | `		if( SXRET_OK != SySetPut(&pInfo->aStep,(const void *)&pStep) ){` |
...
|       - |  4728 | ` */` |
|     181 |  4729 | `case PH7_OP_FOREACH_STEP: {` |
|     363 |  4730 | `	ph7_foreach_info *pInfo = (ph7_foreach_info *)pInstr->p3;` |
|       - |  4731 | `	ph7_foreach_step **apStep,*pStep;` |
|       - |  4732 | `	ph7_value *pValue;` |
|       - |  4733 | `	VmFrame *pFrameLocal;` |
|       - |  4734 | `	/* Peek the last step */` |
|     363 |  4735 | `	apStep = (ph7_foreach_step **)SySetBasePtr(&pInfo->aStep);` |
|     363 |  4736 | `	pStep = apStep[SySetUsed(&pInfo->aStep) - 1];` |
|     363 |  4737 | `	pFrameLocal = pVm->pFrame;` |
|     363 |  4738 | `	while( pFrameLocal->pParent && (pFrameLocal->iFlags & VM_FRAME_EXCEPTION) ){` |
|       - |  4739 | `		/* Safely ignore the exception frame */` |
|     ! 0 |  4740 | `		pFrameLocal = pFrameLocal->pParent;` |
|     ! 0 |  4741 | `	}` |
|     363 |  4742 | `	if( pStep->iFlags & PH7_4EACH_STEP_HASHMAP ){` |
|     339 |  4743 | `		ph7_hashmap *pMap = pStep->xIter.pMap;` |
|       - |  4744 | `		ph7_hashmap_node *pNode;` |
|       - |  4745 | `		/* Extract the current node value */` |
|     339 |  4746 | `		pNode = PH7_HashmapGetNextEntry(pMap);` |
|     339 |  4747 | `		if( pNode == 0 ){` |
|       - |  4748 | `			/* No more entry to process */` |
|      77 |  4749 | `			pc = pInstr->iP2 - 1; /* Jump to this destination */` |
|      77 |  4750 | `			if( pStep->iFlags & PH7_4EACH_STEP_REF ){` |
...
|      77 |  4755 | `			PH7_HashmapResetLoopCursor(pMap);` |
|       - |  4756 | `			/* Cleanup the mess left behind */` |
|      77 |  4757 | `			SyMemBackendPoolFree(&pVm->sAllocator,pStep);` |
|      77 |  4758 | `			SySetPop(&pInfo->aStep);` |
|      77 |  4759 | `			PH7_HashmapUnref(pMap);` |
|      39 |  4760 | `		}else{` |
|     263 |  4761 | `			if( (pStep->iFlags & PH7_4EACH_STEP_KEY) && SyStringLength(&pInfo->sKey) > 0 ){` |
|     141 |  4762 | `				ph7_value *pKey = VmExtractMemObj(&(*pVm),&pInfo->sKey,FALSE,TRUE);` |
|     141 |  4763 | `				if( pKey ){` |
|     141 |  4764 | `					PH7_HashmapExtractNodeKey(pNode,pKey);` |
|      70 |  4765 | `				}` |
|      70 |  4766 | `			}` |
|     263 |  4767 | `			if( pStep->iFlags & PH7_4EACH_STEP_REF ){` |
...
|      13 |  4771 | `				if( pEntry ){` |
|      11 |  4772 | `					pEntry->pUserData = SX_INT_TO_PTR(pNode->nValIdx);` |
|       6 |  4773 | `				}else{` |
|       4 |  4774 | `					SyHashInsert(&pFrameLocal->hVar,SyStringData(&pInfo->sValue),SyStringLength(&pInfo->sValue),` |
|       2 |  4775 | `						SX_INT_TO_PTR(pNode->nValIdx));` |
|       - |  4776 | `				}` |
|       7 |  4777 | `			}else{` |
|       - |  4778 | `				/* Make a copy of the entry value */` |
|     251 |  4779 | `				pValue = VmExtractMemObj(&(*pVm),&pInfo->sValue,FALSE,TRUE);` |
|     251 |  4780 | `				if( pValue ){` |
|     251 |  4781 | `					PH7_HashmapExtractNodeValue(pNode,pValue,TRUE);` |
|     125 |  4782 | `				}` |
|       - |  4783 | `			}` |
|       - |  4784 | `		}` |
|     170 |  4785 | `	}else{` |
...
|       3 |  4826 | `					if( pEntry ){` |
|     ! 0 |  4827 | `						pEntry->pUserData = SX_INT_TO_PTR(pVmAttr->nIdx);` |
|     ! 0 |  4828 | `					}else{` |
|       4 |  4829 | `						SyHashInsert(&pFrameLocal->hVar,SyStringData(&pInfo->sValue),SyStringLength(&pInfo->sValue),` |
|       2 |  4830 | `							SX_INT_TO_PTR(pVmAttr->nIdx));` |
|       - |  4831 | `					}` |
|       2 |  4832 | `				}else{` |
...
|       - |  4847 | ` */` |
|     426 |  4848 | `case PH7_OP_MEMBER: {` |
|       - |  4849 | `	ph7_class_instance *pThis;` |
|       - |  4850 | `	ph7_value *pNos;` |
|       - |  4851 | `	SyString sName;` |
|     853 |  4852 | `	if( !pInstr->iP1 ){` |
|     795 |  4853 | `		pNos = &pTos[-1];` |
|       - |  4854 | `#ifdef UNTRUST` |
|       - |  4855 | `		if( pNos < pStack ){` |
|       - |  4856 | `			goto Abort;` |
|       - |  4857 | `		}` |
|       - |  4858 | `#endif` |
|     795 |  4859 | `		if( pNos->iFlags & MEMOBJ_OBJ ){` |
|       - |  4860 | `			ph7_class *pClass;` |
|       - |  4861 | `			/* Class already instantiated */` |
|     795 |  4862 | `			pThis = (ph7_class_instance *)pNos->x.pOther;` |
|       - |  4863 | `			/* Point to the instantiated class */` |
|     795 |  4864 | `			pClass = pThis->pClass;` |
|       - |  4865 | `			/* Extract attribute name first */` |
|     795 |  4866 | `			SyStringInitFromBuf(&sName,(const char *)SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
|     795 |  4867 | `			if( pInstr->iP2 ){` |
|       - |  4868 | `				/* Method call */` |
|     121 |  4869 | `				ph7_class_method *pMeth = 0;` |
|     121 |  4870 | `				if( sName.nByte > 0 ){` |
|       - |  4871 | `					/* Extract the target method */` |
|     121 |  4872 | `					pMeth = PH7_ClassExtractMethod(pClass,sName.zString,sName.nByte);` |
|      60 |  4873 | `				}` |
|     121 |  4874 | `				if( pMeth == 0 ){` |
...
|     121 |  4885 | `					PH7_MemObjRelease(pTos);` |
|     121 |  4886 | `					SyBlobAppend(&pTos->sBlob,SyStringData(&pMeth->sVmName),SyStringLength(&pMeth->sVmName));` |
|     121 |  4887 | `					MemObjSetType(pTos,MEMOBJ_STRING);` |
|       - |  4888 | `				}` |
|     121 |  4889 | `				pTos->nIdx = SXU32_HIGH;` |
|      61 |  4890 | `			}else{` |
|       - |  4891 | `				/* Attribute access */` |
|     675 |  4892 | `				VmClassAttr *pObjAttr = 0;` |
|       - |  4893 | `				SyHashEntry *pEntry;` |
|       - |  4894 | `				/* Extract the target attribute */` |
|     675 |  4895 | `				if( sName.nByte > 0 ){` |
|     675 |  4896 | `					pEntry = SyHashGet(&pThis->hAttr,(const void *)sName.zString,sName.nByte);` |
|     675 |  4897 | `					if( pEntry ){` |
|       - |  4898 | `						/* Point to the attribute value */` |
|     673 |  4899 | `						pObjAttr = (VmClassAttr *)pEntry->pUserData;` |
|     336 |  4900 | `					}` |
|     337 |  4901 | `				}` |
|     675 |  4902 | `				if( pObjAttr == 0 ){` |
...
|       - |  4913 | `				 */` |
|     675 |  4914 | `				pThis->iRef++;` |
|     675 |  4915 | `				PH7_MemObjRelease(pTos);` |
|     675 |  4916 | `				pTos->nIdx = SXU32_HIGH; /* Assume we are loading a constant */` |
|     675 |  4917 | `				if( pObjAttr ){` |
|     673 |  4918 | `					ph7_value *pValue = 0; /* cc warning */` |
|       - |  4919 | `					/* Check attribute access */` |
|     673 |  4920 | `					if( VmClassMemberAccess(&(*pVm),pClass,&pObjAttr->pAttr->sName,pObjAttr->pAttr->iProtection,TRUE) ){` |
|       - |  4921 | `						/* Load attribute */` |
|     673 |  4922 | `						pValue = (ph7_value *)SySetAt(&pVm->aMemObj,pObjAttr->nIdx);` |
|     673 |  4923 | `						if( pValue ){` |
|     673 |  4924 | `							if( pThis->iRef < 2 ){` |
...
|       2 |  4929 | `							}else{` |
|       - |  4930 | `								/* Simple load */` |
|     671 |  4931 | `								PH7_MemObjLoad(pValue,pTos);` |
|       - |  4932 | `							}` |
|     673 |  4933 | `							if( (pObjAttr->pAttr->iFlags & PH7_CLASS_ATTR_CONSTANT) == 0 ){` |
|     671 |  4934 | `								if( pThis->iRef > 1 ){` |
|       - |  4935 | `									/* Load attribute index */` |
|     669 |  4936 | `									pTos->nIdx = pObjAttr->nIdx;` |
|     334 |  4937 | `								}` |
|     335 |  4938 | `							}` |
|     336 |  4939 | `						}` |
|     336 |  4940 | `					}` |
...
|     675 |  4943 | `				PH7_ClassInstanceUnref(pThis);` |
|       - |  4944 | `			}` |
|     398 |  4945 | `		}else{` |
...
|       - |  5100 | ` */` |
|     250 |  5101 | `case PH7_OP_NEW: {` |
|     501 |  5102 | `	ph7_value *pArg = &pTos[-pInstr->iP1]; /* Constructor arguments (if available) */` |
|     501 |  5103 | `	ph7_class *pClass = 0;` |
|       - |  5104 | `	ph7_class_instance *pNew;` |
|     501 |  5105 | `	if( (pTos->iFlags & MEMOBJ_STRING) && SyBlobLength(&pTos->sBlob) > 0 ){` |
|       - |  5106 | `		/* Try to extract the desired class */` |
|     751 |  5107 | `		pClass = PH7_VmExtractClass(&(*pVm),(const char *)SyBlobData(&pTos->sBlob),` |
|     500 |  5108 | `			SyBlobLength(&pTos->sBlob),TRUE /* Only loadable class but not 'interface' or 'abstract' class*/,0);` |
|     250 |  5109 | `	}else if( pTos->iFlags & MEMOBJ_OBJ ){` |
|       - |  5110 | `		/* Take the base class from the loaded instance */` |
|     ! 0 |  5111 | `		pClass = ((ph7_class_instance *)pTos->x.pOther)->pClass;` |
|     ! 0 |  5112 | `	}` |
|     501 |  5113 | `	if( pClass == 0 ){` |
|       - |  5114 | `		/* No such class */` |
...
|     501 |  5126 | `		pNew = PH7_NewClassInstance(&(*pVm),pClass);` |
|     501 |  5127 | `		if( pNew == 0 ){` |
...
|     501 |  5140 | `		pCons = PH7_ClassExtractMethod(pClass,"__construct",sizeof("__construct")-1);` |
|     501 |  5141 | `		if( pCons == 0 ){` |
|     445 |  5142 | `			SyString *pName = &pClass->sName;` |
|       - |  5143 | `			/* Check for a constructor with the same base class name */` |
|     445 |  5144 | `			pCons = PH7_ClassExtractMethod(pClass,pName->zString,pName->nByte);` |
|     222 |  5145 | `		}` |
|     501 |  5146 | `		if( pCons ){` |
|       - |  5147 | `			/* Call the class constructor */` |
|      57 |  5148 | `			SySetReset(&aArg);` |
|     103 |  5149 | `			while( pArg < pTos ){` |
|      47 |  5150 | `				SySetPut(&aArg,(const void *)&pArg);` |
|      47 |  5151 | `				pArg++;` |
|       1 |  5152 | `			}` |
|      57 |  5153 | `			if( pVm->bErrReport ){` |
|       - |  5154 | `				ph7_vm_func_arg *pFuncArg;` |
|       - |  5155 | `				sxu32 n;` |
|      57 |  5156 | `				n = SySetUsed(&aArg);` |
|       - |  5157 | `				/* Emit a notice for missing arguments */` |
|      99 |  5158 | `				while( n < SySetUsed(&pCons->sFunc.aArgs) ){` |
|      43 |  5159 | `					pFuncArg = (ph7_vm_func_arg *)SySetAt(&pCons->sFunc.aArgs,n);` |
|      43 |  5160 | `					if( pFuncArg ){` |
|      43 |  5161 | `						if( SySetUsed(&pFuncArg->aByteCode) < 1 ){` |
...
|       1 |  5167 | `				}` |
|      28 |  5168 | `			}` |
|      57 |  5169 | `			PH7_VmCallClassMethod(&(*pVm),pNew,pCons,0,(int)SySetUsed(&aArg),(ph7_value **)SySetBasePtr(&aArg));` |
|       - |  5170 | `			/* TICKET 1433-52: Unsetting $this in the constructor body */` |
|      57 |  5171 | `			if( pNew->iRef < 1 ){` |
|     ! 0 |  5172 | `				pNew->iRef = 1;` |
|     ! 0 |  5173 | `			}` |
|      28 |  5174 | `		}` |
|     501 |  5175 | `		if( pInstr->iP1 > 0 ){` |
|       - |  5176 | `			/* Pop given arguments */` |
|      41 |  5177 | `			VmPopOperand(&pTos,pInstr->iP1);` |
|      20 |  5178 | `		}` |
|     501 |  5179 | `		PH7_MemObjRelease(pTos);` |
|     501 |  5180 | `		pTos->x.pOther = pNew;` |
|     501 |  5181 | `		MemObjSetType(pTos,MEMOBJ_OBJ);` |
|       - |  5182 | `	}` |
|     501 |  5183 | `	break;` |
|       - |  5184 | `				 }` |
|       - |  5185 | `/*` |
...
|      47 |  5197 | `	if( (pTos->iFlags & MEMOBJ_OBJ) == 0 ){` |
...
|      43 |  5204 | `	pSrc = (ph7_class_instance *)pTos->x.pOther;` |
|       - |  5205 | `	/* Perform the clone operation */` |
|      43 |  5206 | `	pClone = PH7_CloneClassInstance(pSrc);` |
|      43 |  5207 | `	PH7_MemObjRelease(pTos);` |
|      43 |  5208 | `	if( pClone == 0 ){` |
...
|      43 |  5213 | `		pTos->x.pOther = pClone;` |
|      43 |  5214 | `		MemObjSetType(pTos,MEMOBJ_OBJ);` |
|       - |  5215 | `	}` |
|      43 |  5216 | `	break;` |
|       - |  5217 | `				   }` |
|       - |  5218 | `/*` |
...
|      57 |  5238 | `	for( n = 0 ; n < nEntry ; ++n ){` |
|      57 |  5239 | `		pCase = &aCase[n];` |
|      57 |  5240 | `		PH7_MemObjLoad(pTos,&sValue);` |
|       - |  5241 | `		/* Execute the case expression first */` |
|      57 |  5242 | `		VmLocalExec(pVm,&pCase->aByteCode,&sCaseValue);` |
|       - |  5243 | `		/* Compare the two expression */` |
|      57 |  5244 | `		rc = PH7_MemObjCmp(&sValue,&sCaseValue,FALSE,0);` |
|      57 |  5245 | `		PH7_MemObjRelease(&sValue);` |
|      57 |  5246 | `		PH7_MemObjRelease(&sCaseValue);` |
|      57 |  5247 | `		if( rc == 0 ){` |
...
|       - |  5269 | ` */` |
|   16802 |  5270 | `case PH7_OP_CALL: {` |
|   33605 |  5271 | `	ph7_value *pArg = &pTos[-pInstr->iP1];` |
|       - |  5272 | `	SyHashEntry *pEntry;` |
|       - |  5273 | `	SyString sName;` |
|       - |  5274 | `	/* Extract function name */` |
|   33605 |  5275 | `	if( (pTos->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|   16802 |  5310 | `		break;` |
|       - |  5311 | `	}` |
|   33603 |  5312 | `	SyStringInitFromBuf(&sName,SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
|       - |  5313 | `	/* Check for a compiled function first */` |
|   33603 |  5314 | `	pEntry = SyHashGet(&pVm->hFunction,(const void *)sName.zString,sName.nByte);` |
|   33603 |  5315 | `	if( pEntry ){` |
...
|    1273 |  5326 | `		pVmFunc = (ph7_vm_func *)pEntry->pUserData;` |
|    1273 |  5327 | `		pThis = 0;` |
|    1273 |  5328 | `		pSelf = 0;` |
|    1273 |  5329 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
|       - |  5330 | `			ph7_class_method *pMeth;` |
|       - |  5331 | `			/* Class method call */` |
|     351 |  5332 | `			ph7_value *pTarget = &pTos[-1];` |
|     351 |  5333 | `			if( pTarget >= pStack && (pTarget->iFlags & (MEMOBJ_STRING\|MEMOBJ_OBJ\|MEMOBJ_NULL)) ){` |
|       - |  5334 | `				/* Extract the 'this' pointer */` |
|     351 |  5335 | `				if(pTarget->iFlags & MEMOBJ_OBJ ){` |
|       - |  5336 | `					/* Instance already loaded */` |
|     321 |  5337 | `					pThis = (ph7_class_instance *)pTarget->x.pOther;` |
|     321 |  5338 | `					pThis->iRef++;` |
|     321 |  5339 | `					pSelf = pThis->pClass;` |
|     160 |  5340 | `				}` |
|     351 |  5341 | `				if( pSelf == 0 ){` |
...
|       9 |  5363 | `					}` |
|      15 |  5364 | `				}` |
|     351 |  5365 | `				VmPopOperand(&pTos,1);` |
|     351 |  5366 | `				PH7_MemObjRelease(pTos);` |
|       - |  5367 | `				/* Synchronize pointers */` |
|     351 |  5368 | `				pArg = &pTos[-pInstr->iP1];` |
...
|       - |  5373 | `				 */` |
|     351 |  5374 | `				while( pArg < pStack ){` |
|     ! 0 |  5375 | `					pArg++;` |
|     ! 0 |  5376 | `				}` |
|     351 |  5377 | `				if( pSelf ){ /* Paranoid edition */` |
|       - |  5378 | `					/* Check if the call is allowed */` |
|     351 |  5379 | `					pMeth = PH7_ClassExtractMethod(pSelf,pVmFunc->sName.zString,pVmFunc->sName.nByte);` |
|     351 |  5380 | `					if( pMeth && pMeth->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|    1273 |  5395 | `		if( pVm->nRecursionDepth > pVm->nMaxDepth ){` |
...
|       3 |  5405 | `			break;` |
|       - |  5406 | `		}` |
|    1271 |  5407 | `		if( pVmFunc->pNextName ){` |
|       - |  5408 | `			/* Function is candidate for overloading,select the appropriate function to call */` |
|       9 |  5409 | `			pVmFunc = VmOverload(&(*pVm),pVmFunc,pArg,(int)(pTos-pArg));` |
|       4 |  5410 | `		}` |
|       - |  5411 | `		/* Extract the formal argument set */` |
|    1271 |  5412 | `		aFormalArg = (ph7_vm_func_arg *)SySetBasePtr(&pVmFunc->aArgs);` |
|       - |  5413 | `		/* Create a new VM frame  */` |
|    1271 |  5414 | `		rc = VmEnterFrame(&(*pVm),pVmFunc,pThis,&pFrame);` |
|    1271 |  5415 | `		if( rc != SXRET_OK ){` |
...
|     ! 0 |  5426 | `			break;` |
|       - |  5427 | `		}` |
|    1271 |  5428 | `		if( (pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) && pThis ){` |
|       - |  5429 | `			/* Install the '$this' variable */` |
|       - |  5430 | `			static const SyString sThis = { "this" , sizeof("this") - 1 };` |
|     331 |  5431 | `			pObj = VmExtractMemObj(&(*pVm),&sThis,FALSE,TRUE);` |
|     331 |  5432 | `			if( pObj ){` |
|       - |  5433 | `				/* Reflect the change */` |
|     331 |  5434 | `				pObj->x.pOther = pThis;` |
|     331 |  5435 | `				MemObjSetType(pObj,MEMOBJ_OBJ);` |
|     165 |  5436 | `			}` |
|     165 |  5437 | `		}` |
|    1271 |  5438 | `		if( SySetUsed(&pVmFunc->aStatic) > 0 ){` |
|       - |  5439 | `			ph7_vm_func_static_var *pStatic,*aStatic;` |
|       - |  5440 | `			/* Install static variables */` |
|       7 |  5441 | `			aStatic = (ph7_vm_func_static_var *)SySetBasePtr(&pVmFunc->aStatic);` |
|      13 |  5442 | `			for( n = 0 ; n < SySetUsed(&pVmFunc->aStatic) ; ++n ){` |
|       7 |  5443 | `				pStatic = &aStatic[n];` |
|       7 |  5444 | `				if( pStatic->nIdx == SXU32_HIGH ){` |
|       - |  5445 | `					/* Initialize the static variables */` |
|       3 |  5446 | `					pObj = VmReserveMemObj(&(*pVm),&pStatic->nIdx);` |
|       3 |  5447 | `					if( pObj ){` |
|       - |  5448 | `						/* Assume a NULL initialization value */` |
|       3 |  5449 | `						PH7_MemObjInit(&(*pVm),pObj);` |
|       3 |  5450 | `						if( SySetUsed(&pStatic->aByteCode) > 0 ){` |
|       - |  5451 | `							/* Evaluate initialization expression (Any complex expression) */` |
|       3 |  5452 | `							VmLocalExec(&(*pVm),&pStatic->aByteCode,pObj);` |
|       1 |  5453 | `						}` |
|       3 |  5454 | `						pObj->nIdx = pStatic->nIdx;` |
|       2 |  5455 | `					}else{` |
|     ! 0 |  5456 | `						continue;` |
|       - |  5457 | `					}` |
|       1 |  5458 | `				}` |
|       - |  5459 | `				/* Install in the current frame */` |
|      10 |  5460 | `				SyHashInsert(&pFrame->hVar,SyStringData(&pStatic->sName),SyStringLength(&pStatic->sName),` |
|       6 |  5461 | `					SX_INT_TO_PTR(pStatic->nIdx));` |
|       4 |  5462 | `			}` |
|       3 |  5463 | `		}` |
|       - |  5464 | `		/* Push arguments in the local frame */` |
|    1271 |  5465 | `		n = 0;` |
|    2755 |  5466 | `		while( pArg < pTos ){` |
|    1485 |  5467 | `			if( n < SySetUsed(&pVmFunc->aArgs) ){` |
|    1371 |  5468 | `				if( (pArg->iFlags & MEMOBJ_NULL) && SySetUsed(&aFormalArg[n].aByteCode) > 0 ){` |
|       - |  5469 | `					/* NULL values are redirected to default arguments */` |
|     ! 0 |  5470 | `					rc = VmLocalExec(&(*pVm),&aFormalArg[n].aByteCode,pArg);` |
|     ! 0 |  5471 | `					if( rc == PH7_ABORT ){` |
|     ! 0 |  5472 | `						goto Abort;` |
|       - |  5473 | `					}` |
|     ! 0 |  5474 | `				}` |
|       - |  5475 | `				/* Make sure the given arguments are of the correct type */` |
|    1371 |  5476 | `				if( aFormalArg[n].nType > 0 ){` |
|     237 |  5477 | `					if ( aFormalArg[n].nType == SXU32_HIGH ){` |
...
|       - |  5501 | `							}` |
|     ! 0 |  5502 | `						}` |
|     237 |  5503 | `					}else if( ((pArg->iFlags & aFormalArg[n].nType) == 0) ){` |
|     ! 0 |  5504 | `						ProcMemObjCast xCast = PH7_MemObjCastMethod(aFormalArg[n].nType);` |
|       - |  5505 | `						/* Cast to the desired type */` |
|     ! 0 |  5506 | `						xCast(pArg);` |
|     ! 0 |  5507 | `					}` |
|     118 |  5508 | `				}` |
|    1371 |  5509 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_BY_REF ){` |
|       - |  5510 | `					/* Pass by reference */` |
|      27 |  5511 | `					if( pArg->nIdx == SXU32_HIGH ){` |
...
|      27 |  5523 | `						pRefEntry = SyHashGet(&pFrame->hVar,SyStringData(&aFormalArg[n].sName),SyStringLength(&aFormalArg[n].sName));` |
|      27 |  5524 | `						if( pRefEntry == 0 ){` |
|      40 |  5525 | `							SyHashInsert(&pFrame->hVar,SyStringData(&aFormalArg[n].sName),` |
|      26 |  5526 | `								SyStringLength(&aFormalArg[n].sName),SX_INT_TO_PTR(pArg->nIdx));` |
|      27 |  5527 | `							sArg.nIdx = pArg->nIdx;` |
|      27 |  5528 | `							sArg.pUserData = 0;` |
|      27 |  5529 | `							SySetPut(&pFrame->sArg,(const void *)&sArg);` |
|      13 |  5530 | `						}` |
|      27 |  5531 | `						pObj = 0;` |
|       - |  5532 | `					}` |
|      14 |  5533 | `				}else{` |
|       - |  5534 | `					/* Pass by value,make a copy of the given argument */` |
|    1345 |  5535 | `					pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|       - |  5536 | `				}` |
|     686 |  5537 | `			}else{` |
|       - |  5538 | `				char zName[32];` |
|       - |  5539 | `				SyString sArgName;` |
|       - |  5540 | `				/* Set a dummy name */` |
|     115 |  5541 | `				sArgName.nByte = SyBufferFormat(zName,sizeof(zName),"[%u]apArg",n);` |
|     115 |  5542 | `				sArgName.zString = zName;` |
|       - |  5543 | `				/* Annonymous argument */` |
|     115 |  5544 | `				pObj = VmExtractMemObj(&(*pVm),&sArgName,TRUE,TRUE);` |
|       - |  5545 | `			}` |
|    1485 |  5546 | `			if( pObj ){` |
|    1459 |  5547 | `				PH7_MemObjStore(pArg,pObj);` |
|       - |  5548 | `				/* Insert argument index  */` |
|    1459 |  5549 | `				sArg.nIdx = pObj->nIdx;` |
|    1459 |  5550 | `				sArg.pUserData = 0;` |
|    1459 |  5551 | `				SySetPut(&pFrame->sArg,(const void *)&sArg);` |
|     729 |  5552 | `			}` |
|    1485 |  5553 | `			PH7_MemObjRelease(pArg);` |
|    1485 |  5554 | `			pArg++;` |
|    1485 |  5555 | `			++n;` |
|       1 |  5556 | `		}` |
|       - |  5557 | `		/* Set up closure environment */` |
|    1271 |  5558 | `		if( pVmFunc->iFlags & VM_FUNC_CLOSURE ){` |
|       - |  5559 | `			ph7_vm_func_closure_env *aEnv,*pEnv;` |
|       - |  5560 | `			ph7_value *pValue;` |
|       - |  5561 | `			sxu32 iEnv;` |
|      11 |  5562 | `			aEnv = (ph7_vm_func_closure_env *)SySetBasePtr(&pVmFunc->aClosureEnv);` |
|      31 |  5563 | `			for(iEnv = 0 ; iEnv < SySetUsed(&pVmFunc->aClosureEnv) ; ++iEnv ){` |
|      21 |  5564 | `				pEnv = &aEnv[iEnv];` |
|      21 |  5565 | `				if( (pEnv->iFlags & VM_FUNC_ARG_IGNORE) && (pEnv->sValue.iFlags & MEMOBJ_NULL) ){` |
|       - |  5566 | `					/* Do not install null value */` |
|      11 |  5567 | `					continue;` |
|       - |  5568 | `				}` |
|      11 |  5569 | `				pValue = VmExtractMemObj(pVm,&pEnv->sName,FALSE,TRUE);` |
|      11 |  5570 | `				if( pValue == 0 ){` |
|     ! 0 |  5571 | `					continue;` |
|       - |  5572 | `				}` |
|       - |  5573 | `				/* Invalidate any prior representation */` |
|      11 |  5574 | `				PH7_MemObjRelease(pValue);` |
|       - |  5575 | `				/* Duplicate bound variable value */` |
|      11 |  5576 | `				PH7_MemObjStore(&pEnv->sValue,pValue);` |
|       6 |  5577 | `			}` |
|       5 |  5578 | `		}` |
|       - |  5579 | `		/* Process default values */` |
|    1319 |  5580 | `		while( n < SySetUsed(&pVmFunc->aArgs) ){` |
|      49 |  5581 | `			if( SySetUsed(&aFormalArg[n].aByteCode) > 0 ){` |
|      39 |  5582 | `				pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|      39 |  5583 | `				if( pObj ){` |
|       - |  5584 | `					/* Evaluate the default value and extract it's result */` |
|      39 |  5585 | `					rc = VmLocalExec(&(*pVm),&aFormalArg[n].aByteCode,pObj);` |
|      39 |  5586 | `					if( rc == PH7_ABORT ){` |
|     ! 0 |  5587 | `						goto Abort;` |
|       - |  5588 | `					}` |
|       - |  5589 | `					/* Insert argument index */` |
|      39 |  5590 | `					sArg.nIdx = pObj->nIdx;` |
|      39 |  5591 | `					sArg.pUserData = 0;` |
|      39 |  5592 | `					SySetPut(&pFrame->sArg,(const void *)&sArg);` |
|       - |  5593 | `					/* Make sure the default argument is of the correct type */` |
|      39 |  5594 | `					if( aFormalArg[n].nType > 0 && ((pObj->iFlags & aFormalArg[n].nType) == 0) ){` |
...
|       - |  5605 | `		 */` |
|    1271 |  5606 | `		PH7_MemObjRelease(pTos);` |
|    1271 |  5607 | `		pTos = &pTos[-pInstr->iP1];` |
|       - |  5608 | `		/* Allocate a new operand stack and evaluate the function body */` |
|    1271 |  5609 | `		pFrameStack = VmNewOperandStack(&(*pVm),SySetUsed(&pVmFunc->aByteCode));` |
|    1271 |  5610 | `		if( pFrameStack == 0 ){` |
...
|     349 |  5621 | `			SySetPut(&pVm->aSelf,(const void *)&pSelf);` |
|     174 |  5622 | `		}` |
|       - |  5623 | `		/* Increment nesting level */` |
|    1271 |  5624 | `		pVm->nRecursionDepth++;` |
|       - |  5625 | `		/* Execute function body */` |
|    1271 |  5626 | `		rc = VmByteCodeExec(&(*pVm),(VmInstr *)SySetBasePtr(&pVmFunc->aByteCode),pFrameStack,-1,pTos,&n,FALSE);` |
|       - |  5627 | `		/* Decrement nesting level */` |
|    1271 |  5628 | `		pVm->nRecursionDepth--;` |
|    1271 |  5629 | `		if( pSelf ){` |
|       - |  5630 | `			/* Pop class name */` |
|     349 |  5631 | `			(void)SySetPop(&pVm->aSelf);` |
|     174 |  5632 | `		}` |
|       - |  5633 | `		/* Cleanup the mess left behind */` |
|    1271 |  5634 | `		if( (pVmFunc->iFlags & VM_FUNC_REF_RETURN) && rc == SXRET_OK ){` |
...
|    1271 |  5662 | `		if( rc != PH7_ABORT && ((pFrame->iFlags & VM_FRAME_THROW) \|\| rc == PH7_EXCEPTION) ){` |
...
|    1271 |  5681 | `		SyMemBackendFree(&pVm->sAllocator,pFrameStack);` |
|       - |  5682 | `		/* Leave the frame */` |
|    1271 |  5683 | `		VmLeaveFrame(&(*pVm));` |
|    1271 |  5684 | `		if( rc == PH7_ABORT ){` |
|       - |  5685 | `			/* Abort processing immeditaley */` |
|     ! 0 |  5686 | `			goto Abort;` |
|    1271 |  5687 | `		}else if( rc == PH7_EXCEPTION ){` |
...
|   32331 |  5695 | `		pEntry = SyHashGet(&pVm->hHostFunction,(const void *)sName.zString,sName.nByte);` |
|   32331 |  5696 | `		if( pEntry == 0 ){` |
...
|       5 |  5705 | `			break;` |
|       - |  5706 | `		}` |
|   32327 |  5707 | `		pFunc = (ph7_user_func *)pEntry->pUserData;` |
|       - |  5708 | `		/* Start collecting function arguments */` |
|   32327 |  5709 | `		SySetReset(&aArg);` |
|   87159 |  5710 | `		while( pArg < pTos ){` |
|   54833 |  5711 | `			SySetPut(&aArg,(const void *)&pArg);` |
|   54833 |  5712 | `			pArg++;` |
|       1 |  5713 | `		}` |
|       - |  5714 | `		/* Assume a null return value */` |
|   32327 |  5715 | `		PH7_MemObjInit(&(*pVm),&sRet);` |
|       - |  5716 | `		/* Init the call context */` |
|   32327 |  5717 | `		VmInitCallContext(&sCtx,&(*pVm),pFunc,&sRet,0);` |
|       - |  5718 | `		/* Call the foreign function */` |
|   32327 |  5719 | `		rc = pFunc->xFunc(&sCtx,(int)SySetUsed(&aArg),(ph7_value **)SySetBasePtr(&aArg));` |
|       - |  5720 | `		/* Release the call context */` |
|   32327 |  5721 | `		VmReleaseCallContext(&sCtx);` |
|   32327 |  5722 | `		if( rc == PH7_ABORT ){` |
|       3 |  5723 | `			goto Abort;` |
|       - |  5724 | `		}` |
|   32325 |  5725 | `		if( pInstr->iP1 > 0 ){` |
|       - |  5726 | `			/* Pop function name and arguments */` |
|   31417 |  5727 | `			VmPopOperand(&pTos,pInstr->iP1);` |
|   15708 |  5728 | `		}` |
|       - |  5729 | `		/* Save foreign function return value */` |
|   32325 |  5730 | `		PH7_MemObjStore(&sRet,pTos);` |
|   32325 |  5731 | `		PH7_MemObjRelease(&sRet);` |
|       - |  5732 | `	}` |
|   33593 |  5733 | `	break;` |
|       - |  5734 | `				  }` |
|       - |  5735 | `/*` |
...
|       - |  5738 | ` */` |
|    5782 |  5739 | `case PH7_OP_CONSUME: {` |
|   11565 |  5740 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|   11565 |  5741 | `	ph7_value *pCur,*pOut = pTos;` |
|       - |  5742 |  |
|   11565 |  5743 | `	pOut = &pTos[-pInstr->iP1 + 1];` |
|   11565 |  5744 | `	pCur = pOut;` |
|       - |  5745 | `	/* Start the consume process  */` |
|   23129 |  5746 | `	while( pOut <= pTos ){` |
|       - |  5747 | `		/* Force a string cast */` |
|   11565 |  5748 | `		if( (pOut->iFlags & MEMOBJ_STRING) == 0 ){` |
|     147 |  5749 | `			PH7_MemObjToString(pOut);` |
|      73 |  5750 | `		}` |
|   11565 |  5751 | `		if( SyBlobLength(&pOut->sBlob) > 0 ){` |
|       - |  5752 | `			/*SyBlobNullAppend(&pOut->sBlob);*/` |
|       - |  5753 | `			/* Invoke the output consumer callback */` |
|    6453 |  5754 | `			rc = pCons->xConsumer(SyBlobData(&pOut->sBlob),SyBlobLength(&pOut->sBlob),pCons->pUserData);` |
|    6453 |  5755 | `			if( pCons->xConsumer != VmObConsumer ){` |
|       - |  5756 | `				/* Increment output length */` |
|    6433 |  5757 | `				pVm->nOutputLen += SyBlobLength(&pOut->sBlob);` |
|    3216 |  5758 | `			}` |
|    6453 |  5759 | `			SyBlobRelease(&pOut->sBlob);` |
|    6453 |  5760 | `			if( rc == SXERR_ABORT ){` |
...
|   11565 |  5765 | `		pOut++;` |
|       1 |  5766 | `	}` |
|   11565 |  5767 | `	pTos = &pCur[-1];` |
|   11564 |  5768 | `	break;` |
|       - |  5769 | `					 }` |
|       - |  5770 |  |
|       - |  5771 | `		} /* Switch() */` |
|  991205 |  5772 | `		pc++; /* Next instruction in the stream */` |
|       1 |  5773 | `	} /* For(;;) */` |
|    6269 |  5774 | `Done:` |
|   12539 |  5775 | `	SySetRelease(&aArg);` |
|   12539 |  5776 | `	return SXRET_OK;` |
|       3 |  5777 | `Abort:` |
|       7 |  5778 | `	SySetRelease(&aArg);` |
|      15 |  5779 | `	while( pTos >= pStack ){` |
|       9 |  5780 | `		PH7_MemObjRelease(pTos);` |
|       9 |  5781 | `		pTos--;` |
|       1 |  5782 | `	}` |
|       7 |  5783 | `	return PH7_ABORT;` |
|       1 |  5784 | `Exception:` |
...
|       - |  5796 | ` */` |
|    5696 |  5797 | `static sxi32 VmLocalExec(ph7_vm *pVm,SySet *pByteCode,ph7_value *pResult)` |
|       1 |  5798 |  |
|       - |  5799 | `	ph7_value *pStack;` |
|       - |  5800 | `	sxi32 rc;` |
|       - |  5801 | `	/* Allocate a new operand stack */` |
|    5697 |  5802 | `	pStack = VmNewOperandStack(&(*pVm),SySetUsed(pByteCode));` |
|    5697 |  5803 | `	if( pStack == 0 ){` |
|     ! 0 |  5804 | `		return SXERR_MEM;` |
|       - |  5805 | `	}` |
|       - |  5806 | `	/* Execute the program */` |
|    5697 |  5807 | `	rc = VmByteCodeExec(&(*pVm),(VmInstr *)SySetBasePtr(pByteCode),pStack,-1,&(*pResult),0,FALSE);` |
|       - |  5808 | `	/* Free the operand stack */` |
|    5697 |  5809 | `	SyMemBackendFree(&pVm->sAllocator,pStack);` |
...
|       - |  5821 | ` */` |
|    5084 |  5822 | `static void VmInvokeShutdownCallbacks(ph7_vm *pVm)` |
|       1 |  5823 |  |
...
|    5085 |  5829 | `	nEntry = SySetUsed(&pVm->aShutdown);` |
|   55925 |  5830 | `	for( i = 0 ; i < (int)SX_ARRAYSIZE(apArg) ; i++ ){` |
|   50841 |  5831 | `		apArg[i] = 0;` |
|   25421 |  5832 | `	}` |
|    5087 |  5833 | `	for( n = 0 ; n < nEntry ; ++n ){` |
...
|       1 |  5856 | `		}` |
|       2 |  5857 | `	}` |
|    5085 |  5858 | `	SySetReset(&pVm->aShutdown);` |
|    5085 |  5859 |  |
|       - |  5860 | `/*` |
...
|       - |  5864 | ` */` |
|    5092 |  5865 | `PH7_PRIVATE sxi32 PH7_VmByteCodeExec(ph7_vm *pVm)` |
|       1 |  5866 |  |
|       - |  5867 | `	/* Make sure we are ready to execute this program */` |
|    5093 |  5868 | `	if( pVm->nMagic != PH7_VM_RUN ){` |
|     ! 0 |  5869 | `		return pVm->nMagic == PH7_VM_EXEC ? SXERR_LOCKED /* Locked VM */ : SXERR_CORRUPT; /* Stale VM */` |
|       - |  5870 | `	}` |
|       - |  5871 | `	/* Set the execution magic number  */` |
|    5093 |  5872 | `	pVm->nMagic = PH7_VM_EXEC;` |
|       - |  5873 | `	/* Execute the program */` |
|    5093 |  5874 | `	VmByteCodeExec(&(*pVm),(VmInstr *)SySetBasePtr(pVm->pByteContainer),pVm->aOps,-1,&pVm->sExec,0,FALSE);` |
|       - |  5875 | `	/* Invoke any shutdown callbacks */` |
|    5089 |  5876 | `	VmInvokeShutdownCallbacks(&(*pVm));` |
|       - |  5877 | `	/*` |
...
|       - |  5889 | ` */` |
|     382 |  5890 | `PH7_PRIVATE sxi32 PH7_VmOutputConsume(` |
|       - |  5891 | `	ph7_vm *pVm,      /* Target VM */` |
|       - |  5892 | `	SyString *pString /* Message to output */` |
|       - |  5893 | `	)` |
|       1 |  5894 |  |
|     383 |  5895 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|     383 |  5896 | `	sxi32 rc = SXRET_OK;` |
|       - |  5897 | `	/* Call the output consumer */` |
|     383 |  5898 | `	if( pString->nByte > 0 ){` |
|     383 |  5899 | `		rc = pCons->xConsumer((const void *)pString->zString,pString->nByte,pCons->pUserData);` |
|     383 |  5900 | `		if( pCons->xConsumer != VmObConsumer ){` |
|       - |  5901 | `			/* Increment output length */` |
|     363 |  5902 | `			pVm->nOutputLen += pString->nByte;` |
|     181 |  5903 | `		}` |
|     191 |  5904 | `	}` |
|     383 |  5905 | `	return rc;` |
|       1 |  5906 |  |
...
|       - |  6082 | ` */` |
|      10 |  6083 | `static int vm_builtin_func_num_args(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       1 |  6084 |  |
|       - |  6085 | `	VmFrame *pFrame;` |
|       - |  6086 | `	ph7_vm *pVm;` |
|       - |  6087 | `	/* Point to the target VM */` |
|      11 |  6088 | `	pVm = pCtx->pVm;` |
|       - |  6089 | `	/* Current frame */` |
|      11 |  6090 | `	pFrame = pVm->pFrame;` |
|      11 |  6091 | `	while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|       - |  6092 | `		/* Safely ignore the exception frame */` |
|     ! 0 |  6093 | `		pFrame = pFrame->pParent;` |
|     ! 0 |  6094 | `	}` |
|      11 |  6095 | `	if( pFrame->pParent == 0 ){` |
...
|      11 |  6103 | `	nArg = (int)SySetUsed(&pFrame->sArg);` |
|      11 |  6104 | `	ph7_result_int(pCtx,nArg);` |
|      11 |  6105 | `	return SXRET_OK;` |
|       6 |  6106 |  |
|       - |  6107 | `/*` |
...
|       - |  6114 | ` */` |
|       8 |  6115 | `static int vm_builtin_func_get_arg(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       1 |  6116 |  |
|       9 |  6117 | `	ph7_value *pObj = 0;` |
|       9 |  6118 | `	VmSlot *pSlot = 0;` |
|       - |  6119 | `	VmFrame *pFrame;` |
|       - |  6120 | `	ph7_vm *pVm;` |
|       - |  6121 | `	/* Point to the target VM */` |
|       9 |  6122 | `	pVm = pCtx->pVm;` |
|       - |  6123 | `	/* Current frame */` |
|       9 |  6124 | `	pFrame = pVm->pFrame;` |
|       9 |  6125 | `	while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|       - |  6126 | `		/* Safely ignore the exception frame */` |
|     ! 0 |  6127 | `		pFrame = pFrame->pParent;` |
|     ! 0 |  6128 | `	}` |
|       9 |  6129 | `	if( nArg < 1 \|\| pFrame->pParent == 0 ){` |
...
|       7 |  6136 | `	nArg = ph7_value_to_int(apArg[0]);` |
|       7 |  6137 | `	if( nArg < 0 \|\| nArg >= (int)SySetUsed(&pFrame->sArg) ){` |
|       - |  6138 | `		/* Invalid index,return FALSE */` |
|     ! 0 |  6139 | `		ph7_result_bool(pCtx,0);` |
|     ! 0 |  6140 | `		return SXRET_OK;` |
|       - |  6141 | `	}` |
|       - |  6142 | `	/* Extract the desired argument */` |
|       7 |  6143 | `	if( (pSlot = (VmSlot *)SySetAt(&pFrame->sArg,(sxu32)nArg)) != 0 ){` |
|       7 |  6144 | `		if( (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pSlot->nIdx)) != 0 ){` |
|       - |  6145 | `			/* Return the desired argument */` |
|       7 |  6146 | `			ph7_result_value(pCtx,(ph7_value *)pObj);` |
|       4 |  6147 | `		}else{` |
...
|       - |  6213 | ` */` |
|      50 |  6214 | `static int vm_builtin_func_get_args(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       1 |  6215 |  |
|      51 |  6216 | `	ph7_value *pObj = 0;` |
|       - |  6217 | `	ph7_value *pArray;` |
|       - |  6218 | `	VmFrame *pFrame;` |
|       - |  6219 | `	VmSlot *aSlot;` |
|       - |  6220 | `	sxu32 n;` |
|       - |  6221 | `	/* Point to the current frame */` |
|      51 |  6222 | `	pFrame = pCtx->pVm->pFrame;` |
|      51 |  6223 | `	while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|       - |  6224 | `		/* Safely ignore the exception frame */` |
|     ! 0 |  6225 | `		pFrame = pFrame->pParent;` |
|     ! 0 |  6226 | `	}` |
|      51 |  6227 | `	if( pFrame->pParent == 0 ){` |
...
|      51 |  6234 | `	pArray = ph7_context_new_array(pCtx);` |
|      51 |  6235 | `	if( pArray == 0 ){` |
...
|      51 |  6242 | `	aSlot = (VmSlot *)SySetBasePtr(&pFrame->sArg);` |
|     159 |  6243 | `	for( n = 0;  n < SySetUsed(&pFrame->sArg) ; n++ ){` |
|     109 |  6244 | `		pObj = (ph7_value *)SySetAt(&pCtx->pVm->aMemObj,aSlot[n].nIdx);` |
|     109 |  6245 | `		if( pObj ){` |
|     109 |  6246 | `			ph7_array_add_elem(pArray,0/* Automatic index assign*/,pObj);` |
|      54 |  6247 | `		}` |
|      55 |  6248 | `	}` |
|       - |  6249 | `	/* Return the freshly created array */` |
|      51 |  6250 | `	ph7_result_value(pCtx,pArray);` |
|      51 |  6251 | `	return SXRET_OK;` |
|      26 |  6252 |  |
|       - |  6253 | `/*` |
...
|       - |  6260 | ` */` |
|    1764 |  6261 | `static int vm_builtin_func_exists(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       1 |  6262 |  |
...
|    1765 |  6273 | `	pVm = pCtx->pVm;` |
|       - |  6274 | `	/* Extract the function name */` |
|    1765 |  6275 | `	zName = ph7_value_to_string(apArg[0],&nLen);` |
|       - |  6276 | `	/* Assume the function is not defined */` |
|    1765 |  6277 | `	res = 0;` |
|       - |  6278 | `	/* Perform the lookup */` |
|    2645 |  6279 | `	if( SyHashGet(&pVm->hFunction,(const void *)zName,(sxu32)nLen) != 0 \|\|` |
|    1760 |  6280 | `		SyHashGet(&pVm->hHostFunction,(const void *)zName,(sxu32)nLen) != 0 ){` |
|       - |  6281 | `			/* Function is defined */` |
|     237 |  6282 | `			res = 1;` |
|     118 |  6283 | `	}` |
|    1765 |  6284 | `	ph7_result_bool(pCtx,res);` |
|    1765 |  6285 | `	return SXRET_OK;` |
|     883 |  6286 |  |
...
|       - |  6293 | ` */` |
|     360 |  6294 | `PH7_PRIVATE int PH7_VmIsCallable(ph7_vm *pVm,ph7_value *pValue,int CallInvoke)` |
|       1 |  6295 |  |
|     361 |  6296 | `	int res = 0;` |
|     361 |  6297 | `	if( pValue->iFlags & MEMOBJ_OBJ ){` |
...
|     ! 0 |  6312 | `		}` |
|     361 |  6313 | `	}else if( pValue->iFlags & MEMOBJ_HASHMAP ){` |
...
|       3 |  6335 | `			}` |
|       4 |  6336 | `		}` |
|     358 |  6337 | `	}else if( pValue->iFlags & MEMOBJ_STRING ){` |
|       - |  6338 | `		const char *zName;` |
|       - |  6339 | `		int nLen;` |
|       - |  6340 | `		/* Extract the name */` |
|     179 |  6341 | `		zName = ph7_value_to_string(pValue,&nLen);` |
|       - |  6342 | `		/* Perform the lookup */` |
|     186 |  6343 | `		if( SyHashGet(&pVm->hFunction,(const void *)zName,(sxu32)nLen) != 0 \|\|` |
|      14 |  6344 | `			SyHashGet(&pVm->hHostFunction,(const void *)zName,(sxu32)nLen) != 0 ){` |
...
|       - |  6384 | ` * defined below.` |
|       - |  6385 | ` */` |
|     938 |  6386 | `static int VmHashFuncStep(SyHashEntry *pEntry,void *pUserData)` |
|       1 |  6387 |  |
|     939 |  6388 | `	ph7_value *pArray = (ph7_value *)pUserData;` |
|       - |  6389 | `	ph7_value sName;` |
|       - |  6390 | `	sxi32 rc;` |
|       - |  6391 | `	/* Prepare the function name for insertion */` |
|     939 |  6392 | `	PH7_MemObjInitFromString(pArray->pVm,&sName,0);` |
|     939 |  6393 | `	PH7_MemObjStringAppend(&sName,(const char *)pEntry->pKey,pEntry->nKeyLen);` |
|       - |  6394 | `	/* Perform the insertion */` |
|     939 |  6395 | `	rc = ph7_array_add_elem(pArray,0/* Automatic index assign */,&sName); /* Will make it's own copy */` |
|     939 |  6396 | `	PH7_MemObjRelease(&sName);` |
|     939 |  6397 | `	return rc;` |
|       1 |  6398 |  |
|       - |  6399 | `/*` |
...
|       - |  6505 | ` */` |
|      46 |  6506 | `PH7_PRIVATE ph7_class * PH7_VmPeekTopClass(ph7_vm *pVm)` |
|       1 |  6507 |  |
|      47 |  6508 | `	SySet *pSet = &pVm->aSelf;` |
|       - |  6509 | `	ph7_class **apClass;` |
|      47 |  6510 | `	if( SySetUsed(pSet) <= 0 ){` |
|       - |  6511 | `		/* Empty stack,return NULL */` |
|      15 |  6512 | `		return 0;` |
|       - |  6513 | `	}` |
|       - |  6514 | `	/* Peek the last entry */` |
|      33 |  6515 | `	apClass = (ph7_class **)SySetBasePtr(pSet);` |
|      33 |  6516 | `	return apClass[pSet->nUsed - 1];` |
|      24 |  6517 |  |
|       - |  6518 | `/*` |
...
|      17 |  6587 | `		pClass = VmExtractClassFromValue(pCtx->pVm,apArg[0]);` |
|      17 |  6588 | `		if( pClass ){` |
|      15 |  6589 | `			pName = &pClass->sName;` |
|       - |  6590 | `			/* Return the class name */` |
|      15 |  6591 | `			ph7_result_string(pCtx,pName->zString,(int)pName->nByte);` |
|       8 |  6592 | `		}else{` |
|       - |  6593 | `			/* Not a class instance,return FALSE */` |
|       3 |  6594 | `			ph7_result_bool(pCtx,0);` |
|       - |  6595 | `		}` |
|       - |  6596 | `	}` |
|      17 |  6597 | `	return PH7_OK;` |
|       1 |  6598 |  |
|       - |  6599 | `/*` |
...
|       1 |  6677 |  |
|      77 |  6678 | `	ph7_class *pClass = 0;` |
|      77 |  6679 | `	if( ph7_value_is_object(pArg) ){` |
|       - |  6680 | `		/* Class instance already loaded,no need to perform a lookup */` |
|      41 |  6681 | `		pClass = ((ph7_class_instance *)pArg->x.pOther)->pClass;` |
|      57 |  6682 | `	}else if( ph7_value_is_string(pArg) ){` |
...
|       1 |  6781 |  |
|      13 |  6782 | `	int res = 0; /* Assume class does not exists */` |
|      13 |  6783 | `	if( nArg > 0 ){` |
|       - |  6784 | `		const char *zName;` |
|       - |  6785 | `		int nLen;` |
|       - |  6786 | `		/* Extract given name */` |
|      13 |  6787 | `		zName = ph7_value_to_string(apArg[0],&nLen);` |
|       - |  6788 | `		/* Perform a hashlookup */` |
|      13 |  6789 | `		if( nLen > 0 && SyHashGet(&pCtx->pVm->hClass,(const void *)zName,(sxu32)nLen) != 0 ){` |
|       - |  6790 | `			/* class is available */` |
|       9 |  6791 | `			res = 1;` |
|       4 |  6792 | `		}` |
|       6 |  6793 | `	}` |
|      13 |  6794 | `	ph7_result_bool(pCtx,res);` |
...
|      18 |  6922 | `	while((pEntry = SyHashGetNextEntry(&pCtx->pVm->hClass)) != 0 ){` |
|      15 |  6923 | `		ph7_class *pClass = (ph7_class *)pEntry->pUserData;` |
|       - |  6924 | `		/* Do not register classes defined as interfaces */` |
|      15 |  6925 | `		if( (pClass->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|       9 |  6926 | `			ph7_value_string(pName,SyStringData(&pClass->sName),(int)SyStringLength(&pClass->sName));` |
|       - |  6927 | `			/* insert class name */` |
|       9 |  6928 | `			ph7_array_add_elem(pArray,0/*Automatic index assign*/,pName); /* Will make it's own copy */` |
|       - |  6929 | `			/* Reset the cursor */` |
|       9 |  6930 | `			ph7_value_reset_string_cursor(pName);` |
|       4 |  6931 | `		}` |
|       1 |  6932 | `	}` |
...
|      20 |  6964 | `	while((pEntry = SyHashGetNextEntry(&pCtx->pVm->hClass)) != 0 ){` |
|      17 |  6965 | `		ph7_class *pClass = (ph7_class *)pEntry->pUserData;` |
|       - |  6966 | `		/* Register classes defined as interfaces only */` |
|      17 |  6967 | `		if( pClass->iFlags & PH7_CLASS_INTERFACE ){` |
...
|       - |  7036 | ` */` |
|     714 |  7037 | `static int VmClassMemberAccess(` |
...
|       - |  7043 | `	)` |
|       1 |  7044 |  |
|     715 |  7045 | `	if( iProtection != PH7_CLASS_PROT_PUBLIC ){` |
|     151 |  7046 | `		VmFrame *pFrame = pVm->pFrame;` |
|       - |  7047 | `		ph7_vm_func *pVmFunc;` |
|     151 |  7048 | `		while( pFrame->pParent && (pFrame->iFlags & (VM_FRAME_EXCEPTION\|VM_FRAME_CATCH) ) ){` |
|       - |  7049 | `			/* Safely ignore the exception frame */` |
|     ! 0 |  7050 | `			pFrame = pFrame->pParent;` |
|     ! 0 |  7051 | `		}` |
|     151 |  7052 | `		pVmFunc = (ph7_vm_func *)pFrame->pUserData;` |
|     151 |  7053 | `		if( pVmFunc == 0 \|\| (pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) == 0 ){` |
|       9 |  7054 | `			goto dis; /* Access is forbidden */` |
|       - |  7055 | `		}` |
|     143 |  7056 | `		if( iProtection == PH7_CLASS_PROT_PRIVATE ){` |
...
|       4 |  7061 | `		}else{` |
|       - |  7062 | `			/* Protected */` |
|     137 |  7063 | `			ph7_class *pBase = (ph7_class *)pVmFunc->pUserData;` |
|       - |  7064 | `			/* Must be a derived class */` |
|     137 |  7065 | `			if( !VmInstanceOf(pClass,pBase) ){` |
|     ! 0 |  7066 | `				goto dis; /* Access is forbidden */` |
|       - |  7067 | `			}` |
|       - |  7068 | `		}` |
|      71 |  7069 | `	}` |
|     707 |  7070 | `	return 1; /* Access is granted */` |
|       4 |  7071 | `dis:` |
|       9 |  7072 | `	if( bLog ){` |
...
|       - |  7244 | ` */` |
|     194 |  7245 | `static int VmInstanceOf(ph7_class *pThis,ph7_class *pClass)` |
|       1 |  7246 |  |
|       - |  7247 | `	ph7_class *pParent;` |
|       - |  7248 | `	sxi32 rc;` |
|     195 |  7249 | `	if( pThis == pClass ){` |
|       - |  7250 | `		/* Instance of the same class */` |
|     167 |  7251 | `		return TRUE;` |
|       - |  7252 | `	}` |
...
|       - |  7366 | ` */` |
|     206 |  7367 | `PH7_PRIVATE sxi32 PH7_VmCallClassMethod(` |
...
|     207 |  7381 | `	aStack = VmNewOperandStack(&(*pVm),2/* Method name + Aux data */+nArg);` |
|     207 |  7382 | `	if( aStack == 0 ){` |
...
|     283 |  7388 | `	for( i = 0 ; i < nArg ; i++ ){` |
|      77 |  7389 | `		PH7_MemObjLoad(apArg[i],&aStack[i]);` |
|       - |  7390 | `		/*` |
|       - |  7391 | `		 * Symisc eXtension:` |
|       - |  7392 | `		 *  Parameters to [call_user_func()] can be passed by reference.` |
|       - |  7393 | `		 */` |
|      77 |  7394 | `		aStack[i].nIdx = apArg[i]->nIdx;` |
|      39 |  7395 | `	}` |
|     207 |  7396 | `	iCursor = nArg + 1;` |
|     207 |  7397 | `	if( pThis ){` |
|       - |  7398 | `		/*` |
|       - |  7399 | `		 * Push the class instance so that the '$this' variable will be available.` |
|       - |  7400 | `		 */` |
|     201 |  7401 | `		pThis->iRef++; /* Increment reference count */` |
|     201 |  7402 | `		aStack[i].x.pOther = pThis;` |
|     201 |  7403 | `		aStack[i].iFlags = MEMOBJ_OBJ;` |
|     100 |  7404 | `	}` |
|     207 |  7405 | `	aStack[i].nIdx = SXU32_HIGH; /* Mark as constant */` |
|     207 |  7406 | `	i++;` |
|       - |  7407 | `	/* Push method name */` |
|     207 |  7408 | `	SyBlobReset(&aStack[i].sBlob);` |
|     207 |  7409 | `	SyBlobAppend(&aStack[i].sBlob,(const void *)SyStringData(&pMethod->sVmName),SyStringLength(&pMethod->sVmName));` |
|     207 |  7410 | `	aStack[i].iFlags = MEMOBJ_STRING;` |
|     207 |  7411 | `	aStack[i].nIdx = SXU32_HIGH;` |
|       - |  7412 | `	/* Emit the CALL istruction */` |
|     207 |  7413 | `	aInstr[0].iOp = PH7_OP_CALL;` |
|     207 |  7414 | `	aInstr[0].iP1 = nArg; /* Total number of given arguments */` |
|     207 |  7415 | `	aInstr[0].iP2 = 0;` |
|     207 |  7416 | `	aInstr[0].p3  = 0;` |
|       - |  7417 | `	/* Emit the DONE instruction */` |
|     207 |  7418 | `	aInstr[1].iOp = PH7_OP_DONE;` |
|     207 |  7419 | `	aInstr[1].iP1 = 1;   /* Extract method return value */` |
|     207 |  7420 | `	aInstr[1].iP2 = 0;` |
|     207 |  7421 | `	aInstr[1].p3  = 0;` |
|       - |  7422 | `	/* Execute the method body (if available) */` |
|     207 |  7423 | `	VmByteCodeExec(&(*pVm),aInstr,aStack,iCursor,pResult,0,TRUE);` |
|       - |  7424 | `	/* Clean up the mess left behind */` |
|     207 |  7425 | `	SyMemBackendFree(&pVm->sAllocator,aStack);` |
|     207 |  7426 | `	return PH7_OK;` |
|     104 |  7427 |  |
|       - |  7428 | `/*` |
...
|       - |  7434 | ` */` |
|     304 |  7435 | `PH7_PRIVATE sxi32 PH7_VmCallUserFunction(` |
...
|       - |  7445 | `	int i;` |
|     305 |  7446 | `	if((pFunc->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP)) == 0 ){` |
|       - |  7447 | `		/* Don't bother processing,it's invalid anyway */` |
|       5 |  7448 | `		if( pResult ){` |
|       - |  7449 | `			/* Assume a null return value */` |
|     ! 0 |  7450 | `			PH7_MemObjRelease(pResult);` |
|     ! 0 |  7451 | `		}` |
|       5 |  7452 | `		return SXERR_INVALID;` |
|       - |  7453 | `	}` |
|     301 |  7454 | `	if( pFunc->iFlags & MEMOBJ_HASHMAP ){` |
|       - |  7455 | `		/* Class method */` |
...
|     291 |  7506 | `	aStack = VmNewOperandStack(&(*pVm),1+nArg);` |
|     291 |  7507 | `	if( aStack == 0 ){` |
...
|     899 |  7517 | `	for( i = 0 ; i < nArg ; i++ ){` |
|     609 |  7518 | `		PH7_MemObjLoad(apArg[i],&aStack[i]);` |
|       - |  7519 | `		/*` |
|       - |  7520 | `		 * Symisc eXtension:` |
|       - |  7521 | `		 *  Parameters to [call_user_func()] can be passed by reference.` |
|       - |  7522 | `		 */` |
|     609 |  7523 | `		aStack[i].nIdx = apArg[i]->nIdx;` |
|     305 |  7524 | `	}` |
|       - |  7525 | `	/* Push the function name */` |
|     291 |  7526 | `	PH7_MemObjLoad(pFunc,&aStack[i]);` |
|     291 |  7527 | `	aStack[i].nIdx = SXU32_HIGH; /* Mark as constant */` |
|       - |  7528 | `	/* Emit the CALL istruction */` |
|     291 |  7529 | `	aInstr[0].iOp = PH7_OP_CALL;` |
|     291 |  7530 | `	aInstr[0].iP1 = nArg; /* Total number of given arguments */` |
|     291 |  7531 | `	aInstr[0].iP2 = 0;` |
|     291 |  7532 | `	aInstr[0].p3  = 0;` |
|       - |  7533 | `	/* Emit the DONE instruction */` |
|     291 |  7534 | `	aInstr[1].iOp = PH7_OP_DONE;` |
|     291 |  7535 | `	aInstr[1].iP1 = 1;   /* Extract function return value if available */` |
|     291 |  7536 | `	aInstr[1].iP2 = 0;` |
|     291 |  7537 | `	aInstr[1].p3  = 0;` |
|       - |  7538 | `	/* Execute the function body (if available) */` |
|     291 |  7539 | `	VmByteCodeExec(&(*pVm),aInstr,aStack,nArg,pResult,0,TRUE);` |
|       - |  7540 | `	/* Clean up the mess left behind */` |
|     291 |  7541 | `	SyMemBackendFree(&pVm->sAllocator,aStack);` |
|     291 |  7542 | `	return PH7_OK;` |
|     153 |  7543 |  |
|       - |  7544 | `/*` |
...
|       - |  7550 | ` */` |
|     182 |  7551 | `PH7_PRIVATE sxi32 PH7_VmCallUserFunctionAp(` |
...
|       - |  7560 | `	va_list ap;` |
|       - |  7561 | `	sxi32 rc;` |
|     183 |  7562 | `	SySetInit(&aArg,&pVm->sAllocator,sizeof(ph7_value *));` |
|       - |  7563 | `	/* Copy arguments one after one */` |
|     183 |  7564 | `	va_start(ap,pResult);` |
|     305 |  7565 | `	for(;;){` |
|     611 |  7566 | `		pArg = va_arg(ap,ph7_value *);` |
|     611 |  7567 | `		if( pArg == 0 ){` |
|     183 |  7568 | `			break;` |
|       - |  7569 | `		}` |
|     429 |  7570 | `		SySetPut(&aArg,(const void *)&pArg);` |
|       1 |  7571 | `	}` |
|       - |  7572 | `	/* Call the core routine */` |
|     183 |  7573 | `	rc = PH7_VmCallUserFunction(&(*pVm),pFunc,(int)SySetUsed(&aArg),(ph7_value **)SySetBasePtr(&aArg),pResult);` |
|       - |  7574 | `	/* Cleanup */` |
|     183 |  7575 | `	SySetRelease(&aArg);` |
|     183 |  7576 | `	return rc;` |
|       1 |  7577 |  |
|       - |  7578 | `/*` |
...
|       - |  7672 | ` */` |
|      14 |  7673 | `static int vm_builtin_defined(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       1 |  7674 |  |
...
|      15 |  7685 | `	zName = ph7_value_to_string(apArg[0],&nLen);` |
|       - |  7686 | `	/* Perform the lookup */` |
|      15 |  7687 | `	if( nLen > 0 && SyHashGet(&pCtx->pVm->hConstant,(const void *)zName,(sxu32)nLen) != 0 ){` |
|       - |  7688 | `		/* Already defined */` |
|       9 |  7689 | `		res = 1;` |
|       4 |  7690 | `	}` |
|      15 |  7691 | `	ph7_result_bool(pCtx,res);` |
|      15 |  7692 | `	return SXRET_OK;` |
|       8 |  7693 |  |
|       - |  7694 | `/*` |
|       - |  7695 | ` * Constant expansion callback used by the [define()] function defined` |
|       - |  7696 | ` * below.` |
|       - |  7697 | ` */` |
|      10 |  7698 | `static void VmExpandUserConstant(ph7_value *pVal,void *pUserData)` |
|       1 |  7699 |  |
|      11 |  7700 | `	ph7_value *pConstantValue = (ph7_value *)pUserData;` |
|       - |  7701 | `	/* Expand constant value */` |
|      11 |  7702 | `	PH7_MemObjStore(pConstantValue,pVal);` |
|      11 |  7703 |  |
|       - |  7704 | `/*` |
...
|       - |  7714 | ` */` |
|      12 |  7715 | `static int vm_builtin_define(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       1 |  7716 |  |
|       - |  7717 | `	const char *zName;  /* Constant name */` |
|       - |  7718 | `	ph7_value *pValue;  /* Duplicated constant value */` |
|      13 |  7719 | `	int nLen = 0;       /* Name length */` |
|       - |  7720 | `	sxi32 rc;` |
|      13 |  7721 | `	if( nArg < 2 ){` |
...
|       - |  7726 | `	}` |
|      13 |  7727 | `	if( !ph7_value_is_string(apArg[0]) ){` |
...
|      13 |  7733 | `	zName = ph7_value_to_string(apArg[0],&nLen);` |
|      13 |  7734 | `	if( nLen < 1 ){` |
...
|      13 |  7740 | `	pValue = (ph7_value *)SyMemBackendPoolAlloc(&pCtx->pVm->sAllocator,sizeof(ph7_value));` |
|      13 |  7741 | `	if( pValue == 0 ){` |
...
|      13 |  7747 | `	PH7_MemObjInit(pCtx->pVm,pValue);` |
|       - |  7748 | `	/* Register the constant */` |
|      13 |  7749 | `	rc = ph7_create_constant(pCtx->pVm,zName,VmExpandUserConstant,pValue);` |
|      13 |  7750 | `	if( rc != SXRET_OK ){` |
...
|      13 |  7757 | `	PH7_MemObjStore(apArg[1],pValue);` |
|      13 |  7758 | `	if( nArg == 3 && ph7_value_is_bool(apArg[2]) && ph7_value_to_bool(apArg[2]) ){` |
...
|      13 |  7780 | `	ph7_result_bool(pCtx,1);` |
|      13 |  7781 | `	return SXRET_OK;` |
|       7 |  7782 |  |
|       - |  7783 | `/*` |
...
|       - |  7798 | `	int nLen;` |
|       9 |  7799 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|       9 |  7806 | `	zName = ph7_value_to_string(apArg[0],&nLen);` |
|       - |  7807 | `	/* Perform the query */` |
|       9 |  7808 | `	pEntry = SyHashGet(&pCtx->pVm->hConstant,(const void *)zName,(sxu32)nLen);` |
|       9 |  7809 | `	if( pEntry == 0 ){` |
...
|       - |  7813 | `	}` |
|       7 |  7814 | `	PH7_MemObjInit(pCtx->pVm,&sVal);` |
|       - |  7815 | `	/* Point to the structure that describe the constant */` |
|       7 |  7816 | `	pCons = (ph7_constant *)SyHashEntryGetUserData(pEntry);` |
|       - |  7817 | `	/* Extract constant value by calling it's associated callback */` |
|       7 |  7818 | `	pCons->xExpand(&sVal,pCons->pUserData);` |
|       - |  7819 | `	/* Return that value */` |
|       7 |  7820 | `	ph7_result_value(pCtx,&sVal);` |
|       - |  7821 | `	/* Cleanup */` |
|       7 |  7822 | `	PH7_MemObjRelease(&sVal);` |
|       7 |  7823 | `	return SXRET_OK;` |
|       5 |  7824 |  |
|       - |  7825 | `/*` |
|       - |  7826 | ` * Hash walker callback used by the [get_defined_constants()] function` |
|       - |  7827 | ` * defined below.` |
|       - |  7828 | ` */` |
|     400 |  7829 | `static int VmHashConstStep(SyHashEntry *pEntry,void *pUserData)` |
|       1 |  7830 |  |
|     401 |  7831 | `	ph7_value *pArray = (ph7_value *)pUserData;` |
|       - |  7832 | `	ph7_value sName;` |
|       - |  7833 | `	sxi32 rc;` |
|       - |  7834 | `	/* Prepare the constant name for insertion */` |
|     401 |  7835 | `	PH7_MemObjInitFromString(pArray->pVm,&sName,0);` |
|     401 |  7836 | `	PH7_MemObjStringAppend(&sName,(const char *)pEntry->pKey,pEntry->nKeyLen);` |
|       - |  7837 | `	/* Perform the insertion */` |
|     401 |  7838 | `	rc = ph7_array_add_elem(pArray,0,&sName); /* Will make it's own copy */` |
|     401 |  7839 | `	PH7_MemObjRelease(&sName);` |
|     401 |  7840 | `	return rc;` |
|       1 |  7841 |  |
|       - |  7842 | `/*` |
...
|       - |  7912 | ` */` |
|      10 |  7913 | `static int vm_builtin_ob_end_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       1 |  7914 |  |
|      11 |  7915 | `	ph7_vm *pVm = pCtx->pVm;` |
|       - |  7916 | `	VmObEntry *pOb;` |
|       - |  7917 | `	/* Pop the top most OB */` |
|      11 |  7918 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|      11 |  7919 | `	if( pOb == 0){` |
...
|     ! 0 |  7924 | `	}else{` |
|       - |  7925 | `		/* Release */` |
|      11 |  7926 | `		VmObRestore(pVm,pOb);` |
|       - |  7927 | `		/* Return true */` |
|      11 |  7928 | `		ph7_result_bool(pCtx,1);` |
|       - |  7929 | `	}` |
...
|       - |  7965 | ` */` |
|      22 |  7966 | `static int vm_builtin_ob_get_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       1 |  7967 |  |
|      23 |  7968 | `	ph7_vm *pVm = pCtx->pVm;` |
|       - |  7969 | `	VmObEntry *pOb;` |
|       - |  7970 | `	/* Pop the top most OB */` |
|      23 |  7971 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|      23 |  7972 | `	if( pOb == 0 ){` |
...
|      23 |  7979 | `		ph7_result_string(pCtx,(const char *)SyBlobData(&pOb->sOB),(int)SyBlobLength(&pOb->sOB)); /* Will make it's own copy */` |
|       - |  7980 | `		/* Release */` |
|      23 |  7981 | `		VmObRestore(pVm,pOb);` |
|       - |  7982 | `	}` |
|      23 |  7983 | `	return PH7_OK;` |
|       1 |  7984 |  |
|       - |  7985 | `/*` |
...
|       - |  8034 | ` */` |
|      42 |  8035 | `static int VmObConsumer(const void *pData,unsigned int nDataLen,void *pUserData)` |
|       1 |  8036 |  |
|      43 |  8037 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|       - |  8038 | `	VmObEntry *pEntry;` |
|       - |  8039 | `	ph7_value sResult;` |
|       - |  8040 | `	/* Peek the top most entry */` |
|      43 |  8041 | `	pEntry = (VmObEntry *)SySetPeek(&pVm->aOB);` |
|      43 |  8042 | `	if( pEntry == 0 ){` |
|       - |  8043 | `		/* CAN'T HAPPEN */` |
|     ! 0 |  8044 | `		return PH7_OK;` |
|       - |  8045 | `	}` |
|      43 |  8046 | `	PH7_MemObjInit(pVm,&sResult);` |
|      43 |  8047 | `	if( ph7_value_is_callable(&pEntry->sCallback) && pVm->nObDepth < 15 ){` |
...
|     ! 0 |  8063 | `	}` |
|      43 |  8064 | `	if( nDataLen > 0 ){` |
|       - |  8065 | `		/* Redirect the VM output to the internal buffer */` |
|      43 |  8066 | `		SyBlobAppend(&pEntry->sOB,pData,nDataLen);` |
|      21 |  8067 | `	}` |
|       - |  8068 | `	/* Release */` |
|      43 |  8069 | `	PH7_MemObjRelease(&sResult);` |
|      43 |  8070 | `	return PH7_OK;` |
|      22 |  8071 |  |
|       - |  8072 | `/*` |
...
|       - |  8075 | ` * information.` |
|       - |  8076 | ` */` |
|      34 |  8077 | `static void VmObRestore(ph7_vm *pVm,VmObEntry *pEntry)` |
|       1 |  8078 |  |
|      35 |  8079 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|      35 |  8080 | `	if( SySetUsed(&pVm->aOB) < 1 ){` |
|       - |  8081 | `		/* No more stackable OB */` |
|      33 |  8082 | `		pCons->xConsumer = pCons->xDef;` |
|      33 |  8083 | `		pCons->pUserData = pCons->pDefData;` |
|      16 |  8084 | `	}` |
|       - |  8085 | `	/* Release OB data */` |
|      35 |  8086 | `	PH7_MemObjRelease(&pEntry->sCallback);` |
|      35 |  8087 | `	SyBlobRelease(&pEntry->sOB);` |
|      35 |  8088 |  |
|       - |  8089 | `/*` |
...
|       - |  8111 | ` */` |
|      34 |  8112 | `static int vm_builtin_ob_start(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       1 |  8113 |  |
|      35 |  8114 | `	ph7_vm *pVm = pCtx->pVm;` |
|       - |  8115 | `	VmObEntry sOb;` |
|       - |  8116 | `	sxi32 rc;` |
|       - |  8117 | `	/* Initialize the OB entry */` |
|      35 |  8118 | `	PH7_MemObjInit(pCtx->pVm,&sOb.sCallback);` |
|      35 |  8119 | `	SyBlobInit(&sOb.sOB,&pVm->sAllocator);` |
|      35 |  8120 | `	if( nArg > 0 && (apArg[0]->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP)) ){` |
|       - |  8121 | `		/* Save the callback name for later invocation */` |
|     ! 0 |  8122 | `		PH7_MemObjStore(apArg[0],&sOb.sCallback);` |
|     ! 0 |  8123 | `	}` |
|       - |  8124 | `	/* Push in the stack */` |
|      35 |  8125 | `	rc = SySetPut(&pVm->aOB,(const void *)&sOb);` |
|      35 |  8126 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  8127 | `		PH7_MemObjRelease(&sOb.sCallback);` |
|     ! 0 |  8128 | `	}else{` |
|      35 |  8129 | `		ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|       - |  8130 | `		/* Substitute the default VM consumer */` |
|      35 |  8131 | `		if( pCons->xConsumer != VmObConsumer ){` |
|      33 |  8132 | `			pCons->xDef = pCons->xConsumer;` |
|      33 |  8133 | `			pCons->pDefData = pCons->pUserData;` |
|       - |  8134 | `			/* Install the new consumer */` |
|      33 |  8135 | `			pCons->xConsumer = VmObConsumer;` |
|      33 |  8136 | `			pCons->pUserData = pVm;` |
|      16 |  8137 | `		}` |
|       - |  8138 | `	}` |
|      35 |  8139 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|      35 |  8140 | `	return PH7_OK;` |
|       1 |  8141 |  |
|       - |  8142 | `/*` |
...
|       - |  8311 | ` */` |
|    5162 |  8312 | `PH7_PRIVATE sxu32 PH7_VmRandomNum(ph7_vm *pVm)` |
|       1 |  8313 |  |
|       - |  8314 | `	sxu32 iNum;` |
|    5163 |  8315 | `	SyRandomness(&pVm->sPrng,(void *)&iNum,sizeof(sxu32));` |
|    5163 |  8316 | `	return iNum;` |
|       1 |  8317 |  |
|       - |  8318 | `/*` |
...
|       - |  8323 | ` */` |
|  155038 |  8324 | `PH7_PRIVATE void PH7_VmRandomString(ph7_vm *pVm,char *zBuf,int nLen)` |
|       1 |  8325 |  |
|       - |  8326 | `	static const char zBase[] = {"abcdefghijklmnopqrstuvwxyz"}; /* English Alphabet */` |
|       - |  8327 | `	int i;` |
|       - |  8328 | `	/* Generate a binary string first */` |
|  155039 |  8329 | `	SyRandomness(&pVm->sPrng,zBuf,(sxu32)nLen);` |
|       - |  8330 | `	/* Turn the binary string into english based alphabet */` |
| 1705591 |  8331 | `	for( i = 0 ; i < nLen ; ++i ){` |
| 1550553 |  8332 | `		 zBuf[i] = zBase[zBuf[i] % (sizeof(zBase)-1)];` |
|  775277 |  8333 | `	 }` |
|  155039 |  8334 |  |
|       - |  8335 | `/*` |
|       - |  8336 | ` * int rand()` |
...
|     123 |  8410 | `	int iLen = 0x10;` |
|     123 |  8411 | `	if( nArg > 0 ){` |
|       - |  8412 | `		/* Get the desired length */` |
|     123 |  8413 | `		iLen = ph7_value_to_int(apArg[0]);` |
|     123 |  8414 | `		if( iLen < 1 \|\| iLen > 1024 ){` |
|       - |  8415 | `			/* Default length */` |
|       3 |  8416 | `			iLen = 0x10;` |
|       1 |  8417 | `		}` |
|      61 |  8418 | `	}` |
|       - |  8419 | `	/* Generate the random string */` |
|     123 |  8420 | `	PH7_VmRandomString(pCtx->pVm,zString,iLen);` |
|       - |  8421 | `	/* Return the generated string */` |
|     123 |  8422 | `	ph7_result_string(pCtx,zString,iLen); /* Will make it's own copy */` |
|     123 |  8423 | `	return SXRET_OK;` |
|       1 |  8424 |  |
...
|       - |  8636 | ` */` |
|    2218 |  8637 | `static int vm_builtin_isset(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       1 |  8638 |  |
|       - |  8639 | `	ph7_value *pObj;` |
|    2219 |  8640 | `	int res = 0;` |
|       - |  8641 | `	int i;` |
...
|    4367 |  8648 | `	for( i = 0 ; i < nArg ; ++i ){` |
|    2219 |  8649 | `		pObj = apArg[i];` |
|    2219 |  8650 | `		if( pObj->nIdx == SXU32_HIGH ){` |
|      45 |  8651 | `			if( (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
|       - |  8652 | `				/* Not so fatal,Throw a warning */` |
|     ! 0 |  8653 | `				ph7_context_throw_error(pCtx,PH7_CTX_WARNING,"Expecting a variable not a constant");` |
|     ! 0 |  8654 | `			}` |
|      22 |  8655 | `		}` |
|    2219 |  8656 | `		res = (pObj->iFlags & MEMOBJ_NULL) ? 0 : 1;` |
|    2219 |  8657 | `		if( !res ){` |
|       - |  8658 | `			/* Variable not set,return FALSE */` |
|      71 |  8659 | `			ph7_result_bool(pCtx,0);` |
|      71 |  8660 | `			return SXRET_OK;` |
|       - |  8661 | `		}` |
|    1075 |  8662 | `	}` |
|       - |  8663 | `	/* All given variable are set,return TRUE */` |
|    2149 |  8664 | `	ph7_result_bool(pCtx,1);` |
|    2149 |  8665 | `	return SXRET_OK;` |
|    1110 |  8666 |  |
|       - |  8667 | `/*` |
...
|       - |  8671 | ` */` |
|    3652 |  8672 | `PH7_PRIVATE sxi32 PH7_VmUnsetMemObj(ph7_vm *pVm,sxu32 nObjIdx,int bForce)` |
|       1 |  8673 |  |
|       - |  8674 | `	ph7_value *pObj;` |
|       - |  8675 | `	VmRefObj *pRef;` |
|    3653 |  8676 | `	pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nObjIdx);` |
|    3653 |  8677 | `	if( pObj ){` |
|       - |  8678 | `		/* Release the object */` |
|    3653 |  8679 | `		PH7_MemObjRelease(pObj);` |
|    1826 |  8680 | `	}` |
|       - |  8681 | `	/* Remove old reference links */` |
|    3653 |  8682 | `	pRef = VmRefObjExtract(&(*pVm),nObjIdx);` |
|    3653 |  8683 | `	if( pRef ){` |
|    3653 |  8684 | `		sxi32 iFlags = pRef->iFlags;` |
|       - |  8685 | `		/* Unlink from the reference table */` |
|    3653 |  8686 | `		VmRefObjUnlink(&(*pVm),pRef);` |
|    3653 |  8687 | `		if( (bForce == TRUE) \|\| (iFlags & VM_REF_IDX_KEEP) == 0 ){` |
|       - |  8688 | `			VmSlot sFree;` |
|       - |  8689 | `			/* Restore to the free list */` |
|    3647 |  8690 | `			sFree.nIdx = nObjIdx;` |
|    3647 |  8691 | `			sFree.pUserData = 0;` |
|    3647 |  8692 | `			SySetPut(&pVm->aFreeObj,(const void *)&sFree);` |
|    1823 |  8693 | `		}` |
|    1826 |  8694 | `	}` |
|    3653 |  8695 | `	return SXRET_OK;` |
|       1 |  8696 |  |
|       - |  8697 | `/*` |
|       - |  8698 | ` * void unset($var,...)` |
...
|       - |  8703 | ` *  Nothing.` |
|       - |  8704 | ` */` |
|    1370 |  8705 | `static int vm_builtin_unset(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       1 |  8706 |  |
|       - |  8707 | `	ph7_value *pObj;` |
|       - |  8708 | `	ph7_vm *pVm;` |
|       - |  8709 | `	int i;` |
|       - |  8710 | `	/* Point to the target VM */` |
|    1371 |  8711 | `	pVm = pCtx->pVm;` |
|       - |  8712 | `	/* Iterate and unset */` |
|    3179 |  8713 | `	for( i = 0 ; i < nArg ; ++i ){` |
|    1809 |  8714 | `		pObj = apArg[i];` |
|    1809 |  8715 | `		if( pObj->nIdx == SXU32_HIGH ){` |
|    1183 |  8716 | `			if( (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
|       - |  8717 | `				/* Throw an error */` |
|     ! 0 |  8718 | `				ph7_context_throw_error(pCtx,PH7_CTX_ERR,"Expecting a variable not a constant");` |
|     ! 0 |  8719 | `			}` |
|     592 |  8720 | `		}else{` |
|     627 |  8721 | `			sxu32 nIdx = pObj->nIdx;` |
|       - |  8722 | `			/* TICKET 1433-35: Protect the $GLOBALS array from deletion */` |
|     627 |  8723 | `			if( nIdx != pVm->nGlobalIdx ){` |
|     627 |  8724 | `				PH7_VmUnsetMemObj(&(*pVm),nIdx,FALSE);` |
|     313 |  8725 | `			}` |
|       - |  8726 | `		}` |
|     905 |  8727 | `	}` |
|    1371 |  8728 | `	return SXRET_OK;` |
|       1 |  8729 |  |
|       - |  8730 | `/*` |
|       - |  8731 | ` * Hash walker callback used by the [get_defined_vars()] function.` |
|       - |  8732 | ` */` |
|      24 |  8733 | `static sxi32 VmHashVarWalker(SyHashEntry *pEntry,void *pUserData)` |
|       1 |  8734 |  |
|      25 |  8735 | `	ph7_value *pArray = (ph7_value *)pUserData;` |
|      25 |  8736 | `	ph7_vm *pVm = pArray->pVm;` |
|       - |  8737 | `	ph7_value *pObj;` |
|       - |  8738 | `	sxu32 nIdx;` |
|       - |  8739 | `	/* Extract the memory object */` |
|      25 |  8740 | `	nIdx = SX_PTR_TO_INT(pEntry->pUserData);` |
|      25 |  8741 | `	pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|      25 |  8742 | `	if( pObj ){` |
|      25 |  8743 | `		if( (pObj->iFlags & MEMOBJ_HASHMAP) == 0 \|\| (ph7_hashmap *)pObj->x.pOther != pVm->pGlobal ){` |
|      23 |  8744 | `			if( pEntry->nKeyLen > 0 ){` |
|       - |  8745 | `				SyString sName;` |
|       - |  8746 | `				ph7_value sKey;` |
|       - |  8747 | `				/* Perform the insertion */` |
|      23 |  8748 | `				SyStringInitFromBuf(&sName,pEntry->pKey,pEntry->nKeyLen);` |
|      23 |  8749 | `				PH7_MemObjInitFromString(pVm,&sKey,&sName);` |
|      23 |  8750 | `				ph7_array_add_elem(pArray,&sKey/*Will make it's own copy*/,pObj);` |
|      23 |  8751 | `				PH7_MemObjRelease(&sKey);` |
|      11 |  8752 | `			}` |
|      11 |  8753 | `		}` |
|      12 |  8754 | `	}` |
|      25 |  8755 | `	return SXRET_OK;` |
|       1 |  8756 |  |
|       - |  8757 | `/*` |
...
|       - |  8834 | ` *  Nothing.` |
|       - |  8835 | ` */` |
|     250 |  8836 | `static int vm_builtin_var_dump(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       1 |  8837 |  |
|       - |  8838 | `	SyBlob sDump; /* Generated dump is stored here */` |
|       - |  8839 | `	int i;` |
|     251 |  8840 | `	SyBlobInit(&sDump,&pCtx->pVm->sAllocator);` |
|       - |  8841 | `	/* Dump one or more expressions */` |
|     507 |  8842 | `	for( i = 0 ; i < nArg ; i++ ){` |
|     257 |  8843 | `		ph7_value *pObj = apArg[i];` |
|       - |  8844 | `		/* Reset the working buffer */` |
|     257 |  8845 | `		SyBlobReset(&sDump);` |
|       - |  8846 | `		/* Dump the given expression */` |
|     257 |  8847 | `		PH7_MemObjDump(&sDump,pObj,TRUE,0,0,0);` |
|       - |  8848 | `		/* Output */` |
|     257 |  8849 | `		if( SyBlobLength(&sDump) > 0 ){` |
|     257 |  8850 | `			ph7_context_output(pCtx,(const char *)SyBlobData(&sDump),(int)SyBlobLength(&sDump));` |
|     128 |  8851 | `		}` |
|     129 |  8852 | `	}` |
|       - |  8853 | `	/* Release the working buffer */` |
|     251 |  8854 | `	SyBlobRelease(&sDump);` |
|     251 |  8855 | `	return SXRET_OK;` |
|       1 |  8856 |  |
|       - |  8857 | `/*` |
...
|       - |  8868 | ` */` |
|      18 |  8869 | `static int vm_builtin_print_r(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       1 |  8870 |  |
|      19 |  8871 | `	int ret_string = 0;` |
|       - |  8872 | `	SyBlob sDump;` |
|      19 |  8873 | `	if( nArg < 1 ){` |
...
|       - |  8877 | `	}` |
|      19 |  8878 | `	SyBlobInit(&sDump,&pCtx->pVm->sAllocator);` |
|      19 |  8879 | `	if ( nArg > 1 ){` |
|       - |  8880 | `		/* Where to redirect output */` |
|      13 |  8881 | `		ret_string = ph7_value_to_bool(apArg[1]);` |
|       6 |  8882 | `	}` |
|       - |  8883 | `	/* Generate dump */` |
|      19 |  8884 | `	PH7_MemObjDump(&sDump,apArg[0],FALSE,0,0,0);` |
|      19 |  8885 | `	if( !ret_string ){` |
|       - |  8886 | `		/* Output dump */` |
...
|      13 |  8892 | `		ph7_result_string(pCtx,(const char *)SyBlobData(&sDump),(int)SyBlobLength(&sDump));` |
|       - |  8893 | `	}` |
|       - |  8894 | `	/* Release the working buffer */` |
|      19 |  8895 | `	SyBlobRelease(&sDump);` |
|      19 |  8896 | `	return SXRET_OK;` |
|      10 |  8897 |  |
|       - |  8898 | `/*` |
...
|       1 |  9095 |  |
|      13 |  9096 | `	int nErr = PH7_CTX_NOTICE;` |
|      13 |  9097 | `	int rc = PH7_OK;` |
|      13 |  9098 | `	if( nArg > 0 ){` |
|       - |  9099 | `		const char *zErr;` |
|       - |  9100 | `		int nLen;` |
|       - |  9101 | `		/* Extract the error message */` |
|      11 |  9102 | `		zErr = ph7_value_to_string(apArg[0],&nLen);` |
|      11 |  9103 | `		if( nArg > 1 ){` |
|       - |  9104 | `			/* Extract the error type */` |
|      11 |  9105 | `			nErr = ph7_value_to_int(apArg[1]);` |
|      11 |  9106 | `			switch( nErr ){` |
...
|       3 |  9119 | `				break;` |
|       3 |  9120 | `			default:` |
|       7 |  9121 | `				nErr = PH7_CTX_NOTICE;` |
|       6 |  9122 | `				break;` |
|       - |  9123 | `			}` |
|       5 |  9124 | `		}` |
|       - |  9125 | `		/* Report error */` |
|      11 |  9126 | `		rc = PH7_VmThrowError(pCtx->pVm, NULL, nErr, zErr);` |
|      11 |  9127 | `		if( rc == PH7_ABORT ){` |
|     ! 0 |  9128 | `			return rc;` |
|       - |  9129 | `		}` |
|       - |  9130 | `		/* Return true */` |
|      11 |  9131 | `		ph7_result_bool(pCtx,1);` |
|       6 |  9132 | `	}else{` |
...
|       - |  9364 | ` */` |
|      18 |  9365 | `static int vm_builtin_set_error_handler(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       1 |  9366 |  |
|      19 |  9367 | `	ph7_vm *pVm = pCtx->pVm;` |
|       - |  9368 | `	ph7_value *pOld,*pNew;` |
|       - |  9369 | `	/* Point to the old and the new handler */` |
|      19 |  9370 | `	pOld = &pVm->aErrCB[0];` |
|      19 |  9371 | `	pNew = &pVm->aErrCB[1];` |
|       - |  9372 | `	/* Return the old handler */` |
|      19 |  9373 | `	ph7_result_value(pCtx,pOld); /* Will make it's own copy */` |
|      19 |  9374 | `	if( nArg > 0 ){` |
|      19 |  9375 | `		if( !ph7_value_is_callable(apArg[0])) {` |
|       - |  9376 | `			/* Not callable,return TRUE (As requested by the PHP specification) */` |
|       9 |  9377 | `			PH7_MemObjRelease(pNew);` |
|       9 |  9378 | `			ph7_result_bool(pCtx,1);` |
|       5 |  9379 | `		}else{` |
|      11 |  9380 | `			PH7_MemObjStore(pNew,pOld);` |
|       - |  9381 | `			/* Install the new handler */` |
|      11 |  9382 | `			PH7_MemObjStore(apArg[0],pNew);` |
|       - |  9383 | `		}` |
|       9 |  9384 | `	}` |
|      19 |  9385 | `	return PH7_OK;` |
|       1 |  9386 |  |
|       - |  9387 | `/*` |
...
|       - |  9409 | ` */` |
|      22 |  9410 | `static int vm_builtin_debug_backtrace(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       1 |  9411 |  |
|      23 |  9412 | `	ph7_vm *pVm = pCtx->pVm;` |
|       - |  9413 | `	ph7_value *pArray;` |
|       - |  9414 | `	ph7_class *pClass;` |
|       - |  9415 | `	ph7_value *pValue;` |
|       - |  9416 | `	SyString *pFile;` |
|       - |  9417 | `	/* Create a new array */` |
|      23 |  9418 | `	pArray = ph7_context_new_array(pCtx);` |
|      23 |  9419 | `	pValue = ph7_context_new_scalar(pCtx);` |
|      23 |  9420 | `	if( pArray == 0 \|\| pValue == 0 ){` |
...
|      23 |  9429 | `	if( pVm->pFrame->pParent ){` |
|      23 |  9430 | `		VmFrame *pFrame = pVm->pFrame;` |
|       - |  9431 | `		ph7_vm_func *pFunc;` |
|       - |  9432 | `		ph7_value *pArg;` |
|      23 |  9433 | `		while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|       - |  9434 | `			/* Safely ignore the exception frame */` |
|     ! 0 |  9435 | `			pFrame = pFrame->pParent;` |
|     ! 0 |  9436 | `		}` |
|      23 |  9437 | `		pFunc = (ph7_vm_func *)pFrame->pUserData;` |
|      23 |  9438 | `		if( pFrame->pParent && pFunc ){` |
|      23 |  9439 | `			ph7_value_string(pValue,pFunc->sName.zString,(int)pFunc->sName.nByte);` |
|      23 |  9440 | `			ph7_array_add_strkey_elem(pArray,"function",pValue);` |
|      23 |  9441 | `			ph7_value_reset_string_cursor(pValue);` |
|      11 |  9442 | `		}` |
|       - |  9443 | `		/* Function arguments */` |
|      23 |  9444 | `		pArg = ph7_context_new_array(pCtx);` |
|      23 |  9445 | `		if( pArg  ){` |
|       - |  9446 | `			ph7_value *pObj;` |
|       - |  9447 | `			VmSlot *aSlot;` |
|       - |  9448 | `			sxu32 n;` |
|       - |  9449 | `			/* Start filling the array with the given arguments */` |
|      23 |  9450 | `			aSlot = (VmSlot *)SySetBasePtr(&pFrame->sArg);` |
|      81 |  9451 | `			for( n = 0;  n < SySetUsed(&pFrame->sArg) ; n++ ){` |
|      59 |  9452 | `				pObj = (ph7_value *)SySetAt(&pCtx->pVm->aMemObj,aSlot[n].nIdx);` |
|      59 |  9453 | `				if( pObj ){` |
|      59 |  9454 | `					ph7_array_add_elem(pArg,0/* Automatic index assign*/,pObj);` |
|      29 |  9455 | `				}` |
|      30 |  9456 | `			}` |
|       - |  9457 | `			/* Save the array */` |
|      23 |  9458 | `			ph7_array_add_strkey_elem(pArray,"args",pArg);` |
|      11 |  9459 | `		}` |
|      11 |  9460 | `	}` |
|      23 |  9461 | `	ph7_value_int(pValue,1);` |
|       - |  9462 | `	/* Append the current line (which is always 1 since PH7 does not track` |
|       - |  9463 | `	 * line numbers at run-time. )` |
|       - |  9464 | `	 */` |
|      23 |  9465 | `	ph7_array_add_strkey_elem(pArray,"line",pValue);` |
|       - |  9466 | `	/* Current processed script */` |
|      23 |  9467 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|      23 |  9468 | `	if( pFile ){` |
|      23 |  9469 | `		ph7_value_string(pValue,pFile->zString,(int)pFile->nByte);` |
|      23 |  9470 | `		ph7_array_add_strkey_elem(pArray,"file",pValue);` |
|      23 |  9471 | `		ph7_value_reset_string_cursor(pValue);` |
|      11 |  9472 | `	}` |
|       - |  9473 | `	/* Top class */` |
|      23 |  9474 | `	pClass = PH7_VmPeekTopClass(pVm);` |
|      23 |  9475 | `	if( pClass ){` |
|      19 |  9476 | `		ph7_value_reset_string_cursor(pValue);` |
|      19 |  9477 | `		ph7_value_string(pValue,pClass->sName.zString,(int)pClass->sName.nByte);` |
|      19 |  9478 | `		ph7_array_add_strkey_elem(pArray,"class",pValue);` |
|       9 |  9479 | `	}` |
|       - |  9480 | `	/* Return the freshly created array */` |
|      23 |  9481 | `	ph7_result_value(pCtx,pArray);` |
|       - |  9482 | `	/*` |
|       - |  9483 | `	 * Don't worry about freeing memory, everything will be released automatically` |
|       - |  9484 | `	 * as soon we return from this function.` |
|       - |  9485 | `	 */` |
|      23 |  9486 | `	return PH7_OK;` |
|      12 |  9487 |  |
|       - |  9488 | `/*` |
...
|       - |  9585 | ` */` |
|       6 |  9586 | `static sxi32 VmUncaughtException(` |
...
|       7 |  9592 | `	int nArg = 1;` |
|       - |  9593 | `	sxi32 rc;` |
|       7 |  9594 | `	if( pVm->nExceptDepth > 15 ){` |
|       - |  9595 | `		/* Nesting limit reached */` |
|     ! 0 |  9596 | `		return SXRET_OK;` |
|       - |  9597 | `	}` |
|       - |  9598 | `	/* Call any exception handler if available */` |
|       7 |  9599 | `	PH7_MemObjInit(pVm,&sArg);` |
|       7 |  9600 | `	if( pThis ){` |
|       - |  9601 | `		/* Load the exception instance */` |
|       7 |  9602 | `		sArg.x.pOther = pThis;` |
|       7 |  9603 | `		pThis->iRef++;` |
|       7 |  9604 | `		MemObjSetType(&sArg,MEMOBJ_OBJ);` |
|       4 |  9605 | `	}else{` |
|     ! 0 |  9606 | `		nArg = 0;` |
|       - |  9607 | `	}` |
|       7 |  9608 | `	apArg[0] = &sArg;` |
|       - |  9609 | `	/* Call the exception handler if available */` |
|       7 |  9610 | `	pVm->nExceptDepth++;` |
|       7 |  9611 | `	rc = PH7_VmCallUserFunction(&(*pVm),&pVm->aExceptionCB[1],nArg,apArg,0);` |
|       7 |  9612 | `	pVm->nExceptDepth--;` |
|       7 |  9613 | `	if( rc != SXRET_OK ){` |
|       5 |  9614 | `		SyString sName = { "Exception" , sizeof("Exception") - 1 };` |
|       5 |  9615 | `		SyString sFuncName = { "Global",sizeof("Global") - 1 };` |
|       5 |  9616 | `		VmFrame *pFrame = pVm->pFrame;` |
|       - |  9617 | `		/* No available handler,generate a fatal error */` |
|       5 |  9618 | `		if( pThis ){` |
|       5 |  9619 | `			SyStringDupPtr(&sName,&pThis->pClass->sName);` |
|       2 |  9620 | `		}` |
|       5 |  9621 | `		while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|       - |  9622 | `			/* Ignore exception frames */` |
|     ! 0 |  9623 | `			pFrame = pFrame->pParent;` |
|     ! 0 |  9624 | `		}` |
|       5 |  9625 | `		if( pFrame->pParent ){` |
...
|       5 |  9636 | `		VmErrorFormat(&(*pVm),PH7_CTX_ERR,` |
...
|       5 |  9640 | `		rc = SXERR_ABORT;` |
|       2 |  9641 | `	}` |
|       7 |  9642 | `	PH7_MemObjRelease(&sArg);` |
|       7 |  9643 | `	return rc;` |
|       4 |  9644 |  |
|       - |  9645 | `/*` |
|       - |  9646 | ` * Throw an user exception.` |
|       - |  9647 | ` */` |
|      20 |  9648 | `static sxi32 VmThrowException(` |
...
|      21 |  9657 | `	apException = (ph7_exception **)SySetBasePtr(&pVm->aException);` |
|      21 |  9658 | `	pException = 0;` |
|      21 |  9659 | `	pCatch = 0;` |
|      21 |  9660 | `	if( SySetUsed(&pVm->aException) > 0 ){` |
|       - |  9661 | `		ph7_exception_block *aCatch;` |
|       - |  9662 | `		ph7_class *pClass;` |
|       - |  9663 | `		sxu32 j;` |
|       - |  9664 | `		/* Locate the appropriate block to execute */` |
|      15 |  9665 | `		pException = apException[SySetUsed(&pVm->aException) - 1];` |
|      15 |  9666 | `		(void)SySetPop(&pVm->aException);` |
|      15 |  9667 | `		aCatch = (ph7_exception_block *)SySetBasePtr(&pException->sEntry);` |
|      15 |  9668 | `		for( j = 0 ; j < SySetUsed(&pException->sEntry) ; ++j ){` |
|      15 |  9669 | `			SyString *pName = &aCatch[j].sClass;` |
|       - |  9670 | `			/* Extract the target class */` |
|      15 |  9671 | `			pClass = PH7_VmExtractClass(&(*pVm),pName->zString,pName->nByte,TRUE,0);` |
|      15 |  9672 | `			if( pClass == 0 ){` |
|       - |  9673 | `				/* No such class */` |
|     ! 0 |  9674 | `				continue;` |
|       - |  9675 | `			}` |
|      15 |  9676 | `			if( VmInstanceOf(pThis->pClass,pClass) ){` |
|       - |  9677 | `				/* Catch block found,break immeditaley */` |
|      15 |  9678 | `				pCatch = &aCatch[j];` |
|      15 |  9679 | `				break;` |
|       - |  9680 | `			}` |
|     ! 0 |  9681 | `		}` |
|       7 |  9682 | `	}` |
...
|      21 |  9684 | `	if( pCatch == 0 ){` |
|       - |  9685 | `		sxi32 rc;` |
|       7 |  9686 | `		rc = VmUncaughtException(&(*pVm),pThis);` |
|       7 |  9687 | `		if( rc == SXRET_OK && pException ){` |
...
|       7 |  9698 | `		return rc;` |
|     ! 0 |  9699 | `	}else{` |
|      15 |  9700 | `		VmFrame *pFrame = pVm->pFrame;` |
|       - |  9701 | `		sxi32 rc;` |
|      21 |  9702 | `		while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|       - |  9703 | `			/* Safely ignore the exception frame */` |
|       7 |  9704 | `			pFrame = pFrame->pParent;` |
|       1 |  9705 | `		}` |
|      15 |  9706 | `		if( pException->pFrame == pFrame ){` |
|       - |  9707 | `			/* Tell the upper layer that the exception was caught */` |
|       7 |  9708 | `			pFrame->iFlags &= ~VM_FRAME_THROW;` |
|       3 |  9709 | `		}` |
|       - |  9710 | `		/* Create a private frame first */` |
|      15 |  9711 | `		rc = VmEnterFrame(&(*pVm),0,0,&pFrame);` |
|      15 |  9712 | `		if( rc == SXRET_OK ){` |
|       - |  9713 | `			/* Mark as catch frame */` |
|      15 |  9714 | `			ph7_value *pObj = VmExtractMemObj(&(*pVm),&pCatch->sThis,FALSE,TRUE);` |
|      15 |  9715 | `			pFrame->iFlags \|= VM_FRAME_CATCH;` |
|      15 |  9716 | `			if( pObj ){` |
|       - |  9717 | `				/* Install the exception instance */` |
|      15 |  9718 | `				pThis->iRef++; /* Increment reference count */` |
|      15 |  9719 | `				pObj->x.pOther = pThis;` |
|      15 |  9720 | `				MemObjSetType(pObj,MEMOBJ_OBJ);` |
|       7 |  9721 | `			}` |
|       - |  9722 | `			/* Exceute the block */` |
|      15 |  9723 | `			VmLocalExec(&(*pVm),&pCatch->sByteCode,0);` |
|       - |  9724 | `			/* Leave the frame */` |
|      15 |  9725 | `			VmLeaveFrame(&(*pVm));` |
|       7 |  9726 | `		}` |
|       - |  9727 | `	}` |
|       - |  9728 | `	/* TICKET 1433-60: Do not release the 'pException' pointer since it may` |
|       - |  9729 | `	 * be used again if a 'goto' statement is executed.` |
|       - |  9730 | `	 */` |
|      15 |  9731 | `	return SXRET_OK;` |
|      11 |  9732 |  |
|       - |  9733 | `/*` |
|       - |  9734 | ` * Section:` |
...
|       - | 10519 | ` * information.` |
|       - | 10520 | ` */` |
|    5366 | 10521 | `static sxi32 VmEvalChunk(` |
...
|    5367 | 10530 | `	ProcConsumer xErr = 0;` |
|    5367 | 10531 | `	void *pErrData = 0;` |
|       - | 10532 | `	/* Initialize bytecode container */` |
|    5367 | 10533 | `	SySetInit(&aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|    5367 | 10534 | `	SySetAlloc(&aByteCode,0x20);` |
|       - | 10535 | `	/* Reset the code generator */` |
|    5367 | 10536 | `	if( bTrueReturn ){` |
|       - | 10537 | `		/* Included file,log compile-time errors */` |
|      15 | 10538 | `		xErr = pVm->pEngine->xConf.xErr;` |
|      15 | 10539 | `		pErrData = pVm->pEngine->xConf.pErrData;` |
|       7 | 10540 | `	}` |
|    5367 | 10541 | `	PH7_ResetCodeGenerator(pVm,xErr,pErrData);` |
|       - | 10542 | `	/* Swap bytecode container */` |
|    5367 | 10543 | `	pByteCode = pVm->pByteContainer;` |
|    5367 | 10544 | `	pVm->pByteContainer = &aByteCode;` |
|       - | 10545 | `	/* Compile the chunk */` |
|    5367 | 10546 | `	PH7_CompileScript(pVm,pChunk,iFlags);` |
|    8050 | 10547 | `	if( pVm->sCodeGen.nErr > 0 ){` |
...
|       - | 10557 | `		sxi32 rc;` |
|    5365 | 10558 | `		SyHashResetLoopCursor(&pVm->hClass);` |
|   45601 | 10559 | `		while((pEntry = SyHashGetNextEntry(&pVm->hClass)) != 0 ){` |
|   37555 | 10560 | `			pClass = (ph7_class *)pEntry->pUserData;` |
|       - | 10561 | `			/* Only mount classes that haven't been mounted yet */` |
|   37555 | 10562 | `			if( !pClass->bMounted ){` |
|   37433 | 10563 | `				rc = VmMountUserClass(pVm,pClass);` |
|   37433 | 10564 | `				if( rc != SXRET_OK ){` |
...
|   18716 | 10571 | `			}` |
|       1 | 10572 | `		}` |
|    5365 | 10573 | `		if( SXRET_OK != PH7_VmEmitInstr(pVm,PH7_OP_DONE,0,0,0,0) ){` |
|       - | 10574 | `			/* Out of memory */` |
|     ! 0 | 10575 | `			if( pCtx ){` |
...
|       - | 10579 | `		}` |
|    5365 | 10580 | `		if( bTrueReturn ){` |
|       - | 10581 | `			/* Assume a boolean true return value */` |
|      15 | 10582 | `			PH7_MemObjInitFromBool(pVm,&sResult,1);` |
|       8 | 10583 | `		}else{` |
|       - | 10584 | `			/* Assume a null return value */` |
|    5351 | 10585 | `			PH7_MemObjInit(pVm,&sResult);` |
|       - | 10586 | `		}` |
|       - | 10587 | `		/* Execute the compiled chunk */` |
|    5365 | 10588 | `		VmLocalExec(pVm,&aByteCode,&sResult);` |
|    5365 | 10589 | `		if( pCtx ){` |
|       - | 10590 | `			/* Set the execution result */` |
|      31 | 10591 | `			ph7_result_value(pCtx,&sResult);` |
|      15 | 10592 | `		}` |
|    5365 | 10593 | `		PH7_MemObjRelease(&sResult);` |
|       - | 10594 | `	}` |
|    2683 | 10595 | `Cleanup:` |
|       - | 10596 | `	/* Cleanup the mess left behind */` |
|    5367 | 10597 | `	pVm->pByteContainer = pByteCode;` |
|    5367 | 10598 | `	SySetRelease(&aByteCode);` |
|    5367 | 10599 | `	return SXRET_OK;` |
|       1 | 10600 |  |
|       - | 10601 | `/*` |
...
|      17 | 10620 | `	sChunk.zString = ph7_value_to_string(apArg[0],(int *)&sChunk.nByte);` |
|      17 | 10621 | `	if( sChunk.nByte < 1 ){` |
|       - | 10622 | `		/* Empty string,return NULL */` |
|       3 | 10623 | `		ph7_result_null(pCtx);` |
|       3 | 10624 | `		return SXRET_OK;` |
|       - | 10625 | `	}` |
|       - | 10626 | `	/* Eval the chunk */` |
|      15 | 10627 | `	VmEvalChunk(pCtx->pVm,&(*pCtx),&sChunk,PH7_PHP_ONLY,FALSE);` |
|      15 | 10628 | `	return SXRET_OK;` |
|       9 | 10629 |  |
|       - | 10630 | `/*` |
|       - | 10631 | ` * Check if a file path is already included.` |
|       - | 10632 | ` */` |
|      24 | 10633 | `static int VmIsIncludedFile(ph7_vm *pVm,SyString *pFile)` |
|       1 | 10634 |  |
|       - | 10635 | `	SyString *aEntries;` |
|       - | 10636 | `	sxu32 n;` |
|      25 | 10637 | `	aEntries = (SyString *)SySetBasePtr(&pVm->aIncluded);` |
|       - | 10638 | `	/* Perform a linear search */` |
|      31 | 10639 | `	for( n = 0 ; n < SySetUsed(&pVm->aIncluded) ; ++n ){` |
|      13 | 10640 | `		if( SyStringCmp(pFile,&aEntries[n],SyMemcmp) == 0 ){` |
|       - | 10641 | `			/* Already included */` |
|       7 | 10642 | `			return TRUE;` |
|       - | 10643 | `		}` |
|       4 | 10644 | `	}` |
|      19 | 10645 | `	return FALSE;` |
|      13 | 10646 |  |
|       - | 10647 | `/*` |
|       - | 10648 | ` * Push a file path in the appropriate VM container.` |
|       - | 10649 | ` */` |
|    5350 | 10650 | `PH7_PRIVATE sxi32 PH7_VmPushFilePath(ph7_vm *pVm,const char *zPath,int nLen,sxu8 bMain,sxi32 *pNew)` |
|       1 | 10651 |  |
...
|       - | 10656 | `#endif` |
|       - | 10657 | `	sxi32 rc;` |
|    5351 | 10658 | `	if( nLen < 0 ){` |
|    5327 | 10659 | `		nLen = SyStrlen(zPath);` |
|    2663 | 10660 | `	}` |
|       - | 10661 | `	/* Duplicate the file path first */` |
|    5351 | 10662 | `	zDup = SyMemBackendStrDup(&pVm->sAllocator,zPath,nLen);` |
|    5351 | 10663 | `	if( zDup == 0 ){` |
...
|       - | 10672 | `	 */` |
|       1 | 10673 | `	zCur = zDup;` |
|       1 | 10674 | `	while( zCur[0] != 0 ){` |
|       1 | 10675 | `		if( zCur[0] == '/' ){` |
|       1 | 10676 | `			zCur[0] = '\\';` |
|       1 | 10677 | `		}else if( (unsigned char)zCur[0] < 0xc0 && SyisUpper(zCur[0]) ){` |
...
|    5351 | 10685 | `	SyStringInitFromBuf(&sPath,zDup,nLen);` |
|    5351 | 10686 | `	if( !bMain ){` |
|      25 | 10687 | `		if( VmIsIncludedFile(&(*pVm),&sPath) ){` |
|       - | 10688 | `			/* Already included */` |
|       7 | 10689 | `			*pNew = 0;` |
|       4 | 10690 | `		}else{` |
|       - | 10691 | `			/* Insert in the corresponding container */` |
|      19 | 10692 | `			rc = SySetPut(&pVm->aIncluded,(const void *)&sPath);` |
|      19 | 10693 | `			if( rc != SXRET_OK ){` |
...
|       - | 10698 | `		}` |
|      12 | 10699 | `	}` |
|    5351 | 10700 | `	SySetPut(&pVm->aFiles,(const void *)&sPath);` |
|    5351 | 10701 | `	return SXRET_OK;` |
|    2676 | 10702 |  |
|       - | 10703 | `/*` |
...
|       - | 10714 | ` */` |
|      20 | 10715 | `static sxi32 VmExecIncludedFile(` |
...
|      21 | 10729 | `	pVm = pCtx->pVm;` |
|      21 | 10730 | `	SyBlobInit(&sContents,&pVm->sAllocator);` |
|      21 | 10731 | `	isNew = 0;` |
|       - | 10732 | `	/* Extract the associated stream */` |
|      21 | 10733 | `	pStream = PH7_VmGetStreamDevice(pVm,&pPath->zString,pPath->nByte);` |
|       - | 10734 | `	/*` |
|       - | 10735 | `	 * Open the file or the URL [i.e: http://ph7.symisc.net/example/hello.php"]` |
|       - | 10736 | `	 * in a read-only mode.` |
|       - | 10737 | `	 */` |
|      21 | 10738 | `	pHandle = PH7_StreamOpenHandle(pVm,pStream,pPath->zString,PH7_IO_OPEN_RDONLY,TRUE,0,TRUE,&isNew);` |
|      21 | 10739 | `	if( pHandle == 0 ){` |
|       3 | 10740 | `		return SXERR_IO;` |
|       - | 10741 | `	}` |
|      19 | 10742 | `	rc = SXRET_OK; /* Stupid cc warning */` |
|      19 | 10743 | `	if( IncludeOnce && !isNew ){` |
|       - | 10744 | `		/* Already included */` |
|       5 | 10745 | `		rc = SXERR_EXISTS;` |
|       3 | 10746 | `	}else{` |
|       - | 10747 | `		/* Read the whole file contents */` |
|      15 | 10748 | `		rc = PH7_StreamReadWholeFile(pHandle,pStream,&sContents);` |
|      15 | 10749 | `		if( rc == SXRET_OK ){` |
|       - | 10750 | `			SyString sScript;` |
|       - | 10751 | `			/* Compile and execute the script */` |
|      15 | 10752 | `			SyStringInitFromBuf(&sScript,SyBlobData(&sContents),SyBlobLength(&sContents));` |
|      15 | 10753 | `			VmEvalChunk(pCtx->pVm,&(*pCtx),&sScript,0,TRUE);` |
|       7 | 10754 | `		}` |
|       - | 10755 | `	}` |
|       - | 10756 | `	/* Pop from the set of included file */` |
|      19 | 10757 | `	(void)SySetPop(&pVm->aFiles);` |
|       - | 10758 | `	/* Close the handle */` |
|      19 | 10759 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|       - | 10760 | `	/* Release the working buffer */` |
|      19 | 10761 | `	SyBlobRelease(&sContents);` |
|       - | 10762 | `#else` |
...
|       7 | 10835 | `	while( SXRET_OK == SySetGetNextEntry(pFiles,(void **)&pEntry) ){` |
|       - | 10836 | `		const char *zBase,*zEnd;` |
|       - | 10837 | `		int iLen;` |
|       - | 10838 | `		/* reset the string cursor */` |
|       5 | 10839 | `		ph7_value_reset_string_cursor(pWorker);` |
|       - | 10840 | `		/* Extract base name */` |
|       5 | 10841 | `		zEnd = &pEntry->zString[pEntry->nByte - 1];` |
|       - | 10842 | `		/* Ignore trailing '/' */` |
|       7 | 10843 | `		while( zEnd > pEntry->zString && ( (int)zEnd[0] == c \|\| (int)zEnd[0] == d ) ){` |
|     ! 0 | 10844 | `			zEnd--;` |
|     ! 0 | 10845 | `		}` |
|       5 | 10846 | `		iLen = (int)(&zEnd[1]-pEntry->zString);` |
|      83 | 10847 | `		while( zEnd > pEntry->zString && ( (int)zEnd[0] != c && (int)zEnd[0] != d ) ){` |
|      77 | 10848 | `			zEnd--;` |
|       1 | 10849 | `		}` |
|       5 | 10850 | `		zBase = (zEnd > pEntry->zString) ? &zEnd[1] : pEntry->zString;` |
|       5 | 10851 | `		zEnd = &pEntry->zString[iLen];` |
|       - | 10852 | `		/* Copy entry name */` |
|       5 | 10853 | `		ph7_value_string(pWorker,zBase,(int)(zEnd-zBase));` |
|       - | 10854 | `		/* Perform the insertion */` |
|       5 | 10855 | `		ph7_array_add_elem(pArray,0/* Automatic index assign*/,pWorker); /* Will make it's own copy */` |
|       1 | 10856 | `	}` |
...
|       - | 10884 | ` */` |
|       8 | 10885 | `static int vm_builtin_include(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       1 | 10886 |  |
...
|       9 | 10895 | `	sFile.zString = ph7_value_to_string(apArg[0],(int *)&sFile.nByte);` |
|       9 | 10896 | `	if( sFile.nByte < 1 ){` |
...
|       9 | 10902 | `	rc = VmExecIncludedFile(&(*pCtx),&sFile,FALSE);` |
|       9 | 10903 | `	if( rc != SXRET_OK ){` |
...
|       - | 11032 | ` */` |
|     ! 0 | 11033 | `static const char * VmFindShortOpt(int c,const char *zIn,const char *zEnd)` |
|     ! 0 | 11034 |  |
|     ! 0 | 11035 | `	while( zIn < zEnd ){` |
|     ! 0 | 11036 | `		if( zIn[0] == '-' && &zIn[1] < zEnd && (int)zIn[1] == c ){` |
|       - | 11037 | `			/* Got one */` |
...
|       - | 11250 | `		 */` |
|       3 | 11251 | `		return PH7_OK;` |
|       - | 11252 | `	}` |
|     ! 0 | 11253 | `	zArgIn = (const char *)SyBlobData(pArg);` |
|     ! 0 | 11254 | `	zArgEnd = &zArgIn[SyBlobLength(pArg)];` |
|       - | 11255 | `	/* Fill the long option structure */` |
|     ! 0 | 11256 | `	sLong.pArray = pArray;` |
|     ! 0 | 11257 | `	sLong.pWorker = pWorker;` |
|     ! 0 | 11258 | `	sLong.zArgIn =  zArgIn;` |
|     ! 0 | 11259 | `	sLong.zArgEnd = zArgEnd;` |
|     ! 0 | 11260 | `	sLong.pCtx = pCtx;` |
|       - | 11261 | `	/* Start processing */` |
|     ! 0 | 11262 | `	while( zIn < zEnd ){` |
|     ! 0 | 11263 | `		int c = zIn[0];` |
|     ! 0 | 11264 | `		int need_val = 0;` |
|       - | 11265 | `		/* Advance the stream cursor */` |
|     ! 0 | 11266 | `		zIn++;` |
|       - | 11267 | `		/* Ignore non-alphanum characters */` |
|     ! 0 | 11268 | `		if( !SyisAlphaNum(c) ){` |
|     ! 0 | 11269 | `			continue;` |
|       - | 11270 | `		}` |
|     ! 0 | 11271 | `		if( zIn < zEnd && zIn[0] == ':' ){` |
|     ! 0 | 11272 | `			zIn++;` |
|     ! 0 | 11273 | `			need_val = 1;` |
|     ! 0 | 11274 | `			if( zIn < zEnd && zIn[0] == ':' ){` |
|     ! 0 | 11275 | `				zIn++;` |
|     ! 0 | 11276 | `			}` |
|     ! 0 | 11277 | `		}` |
|       - | 11278 | `		/* Find option */` |
|     ! 0 | 11279 | `		zArg = VmFindShortOpt(c,zArgIn,zArgEnd);` |
|     ! 0 | 11280 | `		if( zArg == 0 ){` |
...
|       1 | 11604 |  |
|       9 | 11605 | `	ph7_vm *pVm = pCtx->pVm;` |
|       - | 11606 | `	/* Return the error code */` |
|       9 | 11607 | `	ph7_result_int(pCtx,pVm->json_rc);` |
|       4 | 11608 | `	SXUNUSED(nArg); /* cc warning */` |
|       4 | 11609 | `	SXUNUSED(apArg);` |
|       9 | 11610 | `	return PH7_OK;` |
|       1 | 11611 |  |
...
|       1 | 11632 |  |
|      61 | 11633 | `	int *pJsonErr = (int *)pUserData;` |
|       - | 11634 | `	SyString *pStr;` |
|       - | 11635 | `	int c;` |
|       - | 11636 | `	/* Ignore leading white spaces */` |
|      65 | 11637 | `	while( pStream->zText < pStream->zEnd && pStream->zText[0] < 0xc0 && SyisSpace(pStream->zText[0]) ){` |
|       - | 11638 | `		/* Advance the stream cursor */` |
|       5 | 11639 | `		if( pStream->zText[0] == '\n' ){` |
|       - | 11640 | `			/* Update line counter */` |
|     ! 0 | 11641 | `			pStream->nLine++;` |
|     ! 0 | 11642 | `		}` |
|       5 | 11643 | `		pStream->zText++;` |
|       1 | 11644 | `	}` |
|      61 | 11645 | `	if( pStream->zText >= pStream->zEnd ){` |
...
|      61 | 11651 | `	pToken->nLine = pStream->nLine;` |
|      61 | 11652 | `	pToken->pUserData = 0;` |
|      61 | 11653 | `	pStr = &pToken->sData;` |
|      61 | 11654 | `	SyStringInitFromBuf(pStr,pStream->zText,0);` |
|      77 | 11655 | `	if( pStream->zText[0] == '{' \|\| pStream->zText[0] == '[' \|\| pStream->zText[0] == '}' \|\| pStream->zText[0] == ']'` |
|      43 | 11656 | `		\|\| pStream->zText[0] == ':' \|\| pStream->zText[0] == ',' ){` |
|       - | 11657 | `			/* Single character */` |
|      35 | 11658 | `			c = pStream->zText[0];` |
|       - | 11659 | `			/* Set token type */` |
|      35 | 11660 | `			switch(c){` |
|       5 | 11661 | `			case '[': pToken->nType = JSON_TK_OSB;   break;` |
|       9 | 11662 | `			case '{': pToken->nType = JSON_TK_OCB;   break;` |
|       5 | 11663 | `			case '}': pToken->nType = JSON_TK_CCB;   break;` |
|       5 | 11664 | `			case ']': pToken->nType = JSON_TK_CSB;   break;` |
|       7 | 11665 | `			case ':': pToken->nType = JSON_TK_COLON; break;` |
|       9 | 11666 | `			case ',': pToken->nType = JSON_TK_COMMA; break;` |
|     ! 0 | 11667 | `			default:` |
|     ! 0 | 11668 | `				break;` |
|       - | 11669 | `			}` |
|       - | 11670 | `			/* Advance the stream cursor */` |
|      35 | 11671 | `			pStream->zText++;` |
|      44 | 11672 | `	}else if( pStream->zText[0] == '"') {` |
|       - | 11673 | `		/* JSON string */` |
|       9 | 11674 | `		pStream->zText++;` |
|       9 | 11675 | `		pStr->zString++;` |
|       - | 11676 | `		/* Delimit the string */` |
|      31 | 11677 | `		while( pStream->zText < pStream->zEnd ){` |
|      31 | 11678 | `			if( pStream->zText[0] == '"' && pStream->zText[-1] != '\\' ){` |
|       9 | 11679 | `				break;` |
|       - | 11680 | `			}` |
|      23 | 11681 | `			if( pStream->zText[0] == '\n' ){` |
|       - | 11682 | `				/* Update line counter */` |
|     ! 0 | 11683 | `				pStream->nLine++;` |
|     ! 0 | 11684 | `			}` |
|      23 | 11685 | `			pStream->zText++;` |
|       1 | 11686 | `		}` |
|       9 | 11687 | `		if( pStream->zText >= pStream->zEnd ){` |
|       - | 11688 | `			/* Missing closing '"' */` |
|     ! 0 | 11689 | `			pToken->nType = JSON_TK_INVALID;` |
|     ! 0 | 11690 | `			*pJsonErr = JSON_ERROR_SYNTAX;` |
|     ! 0 | 11691 | `		}else{` |
|       9 | 11692 | `			pToken->nType = JSON_TK_STR;` |
|       9 | 11693 | `			pStream->zText++; /* Jump the closing double quotes */` |
|       1 | 11694 | `		}` |
|      23 | 11695 | `	}else if( pStream->zText[0] < 0xc0 && SyisDigit(pStream->zText[0]) ){` |
|       - | 11696 | `		/* Number */` |
...
|     ! 0 | 11737 | `				}` |
|       7 | 11738 | `			}` |
|      16 | 11739 | `	}else if( XLEX_IN_LEN(pStream) >= sizeof("true") -1 &&` |
...
|      10 | 11745 | `	}else if( XLEX_IN_LEN(pStream) >= sizeof("false") -1 &&` |
...
|      10 | 11751 | `	}else if( XLEX_IN_LEN(pStream) >= sizeof("null") -1 &&` |
...
|       7 | 11759 | `		pToken->nType = JSON_TK_INVALID;` |
|       - | 11760 | `		/* Advance the stream cursor */` |
|       7 | 11761 | `		pStream->zText++;` |
|       7 | 11762 | `		*pJsonErr = JSON_ERROR_SYNTAX;` |
|       - | 11763 | `		/* Abort processing immediatley */` |
|       7 | 11764 | `		return SXERR_ABORT;` |
|       - | 11765 | `	}` |
|       - | 11766 | `	/* record token length */` |
|      55 | 11767 | `	pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|      55 | 11768 | `	if( pToken->nType == JSON_TK_STR ){` |
|       9 | 11769 | `		pStr->nByte--;` |
|       4 | 11770 | `	}` |
|       - | 11771 | `	/* Return to the lexer */` |
|      55 | 11772 | `	return SXRET_OK;` |
|      31 | 11773 |  |
|       - | 11774 | `/*` |
...
|       1 | 11802 |  |
|       9 | 11803 | `	const char *zIn = pStr->zString;` |
|       9 | 11804 | `	const char *zEnd = &pStr->zString[pStr->nByte];` |
|       - | 11805 | `	const char *zCur;` |
|       - | 11806 | `	int c;` |
|       - | 11807 | `	/* Mark the value as a string */` |
|       9 | 11808 | `	ph7_value_string(pWorker,"",0); /* Empty string */` |
|       4 | 11809 | `	for(;;){` |
|       9 | 11810 | `		zCur = zIn;` |
|      31 | 11811 | `		while( zIn < zEnd && zIn[0] != '\\' ){` |
|      23 | 11812 | `			zIn++;` |
|       1 | 11813 | `		}` |
|       9 | 11814 | `		if( zIn > zCur ){` |
|       - | 11815 | `			/* Append chunk verbatim */` |
|       9 | 11816 | `			ph7_value_string(pWorker,zCur,(int)(zIn-zCur));` |
|       4 | 11817 | `		}` |
|       9 | 11818 | `		zIn++;` |
|       9 | 11819 | `		if( zIn >= zEnd ){` |
...
|      25 | 11862 | `	if( pDecoder->rec_count >= pDecoder->rec_depth ){` |
|       - | 11863 | `		/* Nesting limit reached,abort decoding immediately */` |
|     ! 0 | 11864 | `		*pDecoder->pErr = JSON_ERROR_DEPTH;` |
|     ! 0 | 11865 | `		return SXERR_ABORT;` |
|       - | 11866 | `	}` |
|      25 | 11867 | `	if( pDecoder->pIn->nType & (JSON_TK_STR\|JSON_TK_TRUE\|JSON_TK_FALSE\|JSON_TK_NULL\|JSON_TK_NUM) ){` |
|       - | 11868 | `		/* Scalar value */` |
|      15 | 11869 | `		pWorker = ph7_context_new_scalar(pDecoder->pCtx);` |
|      15 | 11870 | `		if( pWorker == 0 ){` |
...
|      15 | 11876 | `		if( pDecoder->pIn->nType & JSON_TK_NULL ){` |
|       - | 11877 | `			/* Nullify the value.*/` |
|     ! 0 | 11878 | `			ph7_value_null(pWorker);` |
|      15 | 11879 | `		}else if( pDecoder->pIn->nType & (JSON_TK_TRUE\|JSON_TK_FALSE) ){` |
|       - | 11880 | `			/* Boolean value */` |
|     ! 0 | 11881 | `			ph7_value_bool(pWorker,(pDecoder->pIn->nType & JSON_TK_TRUE) ? 1 : 0 );` |
|      15 | 11882 | `		}else if( pDecoder->pIn->nType & JSON_TK_NUM ){` |
...
|      15 | 11897 | `		rc = pDecoder->xConsumer(pDecoder->pCtx,pArrayKey,pWorker,pDecoder->pUserData);` |
|      15 | 11898 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 | 11899 | `			return SXERR_ABORT;` |
|       - | 11900 | `		}` |
|       - | 11901 | `		/* All done,advance the stream cursor */` |
|      15 | 11902 | `		pDecoder->pIn++;` |
|      18 | 11903 | `	}else if( pDecoder->pIn->nType & JSON_TK_OSB /*'[' */) {` |
...
|       7 | 11969 | `		pWorker = ph7_context_new_array(pDecoder->pCtx);` |
|       7 | 11970 | `		pKey = ph7_context_new_scalar(pDecoder->pCtx);` |
|       7 | 11971 | `		if( pWorker == 0 \|\| pKey == 0){` |
...
|       7 | 11977 | `		xOld = pDecoder->xConsumer;` |
|       7 | 11978 | `		pOld = pDecoder->pUserData;` |
|       - | 11979 | `		/* Set the new consumer */` |
|       7 | 11980 | `		pDecoder->xConsumer = VmJsonArrayDecoder;` |
|       7 | 11981 | `		pDecoder->pUserData = pWorker;` |
|       - | 11982 | `		/* Decode the object */` |
|       6 | 11983 | `		for(;;){` |
|       - | 11984 | `			/* Jump trailing comma. Note that the standard PHP engine will not let you` |
|       - | 11985 | `			 * do this.` |
|       - | 11986 | `			 */` |
|      15 | 11987 | `			while( (pDecoder->pIn < pDecoder->pEnd) && (pDecoder->pIn->nType & JSON_TK_COMMA) ){` |
|       3 | 11988 | `				pDecoder->pIn++;` |
|       1 | 11989 | `			}` |
|      13 | 11990 | `			if( pDecoder->pIn >= pDecoder->pEnd \|\| (pDecoder->pIn->nType & JSON_TK_CCB) /*'}'*/ ){` |
|       7 | 11991 | `				if( pDecoder->pIn < pDecoder->pEnd ){` |
|       5 | 11992 | `					pDecoder->pIn++; /* Jump the trailing ']' */` |
|       2 | 11993 | `				}` |
|       7 | 11994 | `				break;` |
|       - | 11995 | `			}` |
|       6 | 11996 | `			if( (pDecoder->pIn->nType & JSON_TK_STR) == 0 \|\| &pDecoder->pIn[1] >= pDecoder->pEnd` |
|       7 | 11997 | `				\|\| (pDecoder->pIn[1].nType & JSON_TK_COLON) == 0){` |
...
|       7 | 12003 | `			VmJsonDequoteString(&pDecoder->pIn->sData,pKey);` |
|       - | 12004 | `			/* Jump the key and the colon */` |
|       7 | 12005 | `			pDecoder->pIn += 2;` |
|       - | 12006 | `			/* Recurse and decode the value */` |
|       7 | 12007 | `			pDecoder->rec_count++;` |
|       7 | 12008 | `			rc = VmJsonDecode(pDecoder,pKey);` |
|       7 | 12009 | `			pDecoder->rec_count--;` |
|       7 | 12010 | `			if( rc == SXERR_ABORT ){` |
|       - | 12011 | `				/* Abort processing immediately */` |
|     ! 0 | 12012 | `				return SXERR_ABORT;` |
|       - | 12013 | `			}` |
|       - | 12014 | `			/* Reset the internal buffer of the key */` |
|       7 | 12015 | `			ph7_value_reset_string_cursor(pKey);` |
|       - | 12016 | `			/*The cursor is automatically advanced by the VmJsonDecode() function */` |
|       1 | 12017 | `		}` |
|       - | 12018 | `		/* Restore the old consumer */` |
|       7 | 12019 | `		pDecoder->xConsumer = xOld;` |
|       7 | 12020 | `		pDecoder->pUserData = pOld;` |
|       - | 12021 | `		/* Invoke the old consumer on the decoded object*/` |
|       7 | 12022 | `		xOld(pDecoder->pCtx,pArrayKey,pWorker,pOld);` |
|       - | 12023 | `		/* Release the key */` |
|       7 | 12024 | `		ph7_context_release_value(pDecoder->pCtx,pKey);` |
|       4 | 12025 | `	}else{` |
|       - | 12026 | `		/* Unexpected token */` |
|     ! 0 | 12027 | `		return SXERR_ABORT; /* Abort immediately */` |
|       - | 12028 | `	}` |
|       - | 12029 | `	/* Release the worker variable */` |
|      25 | 12030 | `	ph7_context_release_value(pDecoder->pCtx,pWorker);` |
|      25 | 12031 | `	return SXRET_OK;` |
|      13 | 12032 |  |
|       - | 12033 | `/*` |
...
|       1 | 12039 |  |
|      17 | 12040 | `	ph7_value *pArray = (ph7_value *)pUserData;` |
|       - | 12041 | `	/* Insert the entry */` |
|      17 | 12042 | `	ph7_array_add_elem(pArray,pKey,pWorker); /* Will make it's own copy */` |
|       8 | 12043 | `	SXUNUSED(pCtx); /* cc warning */` |
|       - | 12044 | `	/* All done */` |
|      17 | 12045 | `	return SXRET_OK;` |
|       1 | 12046 |  |
|       - | 12047 | `/*` |
...
|       9 | 12053 | `	ph7_result_value(pCtx,pWorker); /* Will make it's own copy */` |
|       4 | 12054 | `	SXUNUSED(pKey); /* cc warning */` |
|       4 | 12055 | `	SXUNUSED(pUserData);` |
|       - | 12056 | `	/* All done */` |
|       9 | 12057 | `	return SXRET_OK;` |
|       1 | 12058 |  |
|       - | 12059 | `/*` |
...
|       - | 12084 | `	int nByte;` |
|       - | 12085 | `	sxi32 rc;` |
|      17 | 12086 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|      15 | 12092 | `	zIn = ph7_value_to_string(apArg[0],&nByte);` |
|      15 | 12093 | `	if( nByte < 1 ){` |
...
|      15 | 12099 | `	pVm->json_rc = JSON_ERROR_NONE;` |
|       - | 12100 | `	/* Tokenize the input */` |
|      15 | 12101 | `	SySetInit(&sToken,&pVm->sAllocator,sizeof(SyToken));` |
|      15 | 12102 | `	SyLexInit(&sLex,&sToken,VmJsonTokenize,&pVm->json_rc);` |
|      15 | 12103 | `	SyLexTokenizeInput(&sLex,zIn,(sxu32)nByte,0,0,0);` |
|      15 | 12104 | `	if( pVm->json_rc != JSON_ERROR_NONE ){` |
|       - | 12105 | `		/* Something goes wrong while tokenizing input. [i.e: Unexpected token] */` |
|       7 | 12106 | `		SyLexRelease(&sLex);` |
|       7 | 12107 | `		SySetRelease(&sToken);` |
|       - | 12108 | `		/* return NULL */` |
|       7 | 12109 | `		ph7_result_null(pCtx);` |
|       7 | 12110 | `		return PH7_OK;` |
|       - | 12111 | `	}` |
|       - | 12112 | `	/* Fill the decoder */` |
|       9 | 12113 | `	sDecoder.pCtx = pCtx;` |
|       9 | 12114 | `	sDecoder.pErr = &pVm->json_rc;` |
|       9 | 12115 | `	sDecoder.pIn = (SyToken *)SySetBasePtr(&sToken);` |
|       9 | 12116 | `	sDecoder.pEnd = &sDecoder.pIn[SySetUsed(&sToken)];` |
|       9 | 12117 | `	sDecoder.iFlags = 0;` |
|       9 | 12118 | `	if( nArg > 1 && ph7_value_to_bool(apArg[1]) != 0 ){` |
|       - | 12119 | `		/* Returned objects will be converted into associative arrays */` |
|       7 | 12120 | `		sDecoder.iFlags \|= JSON_DECODE_ASSOC;` |
|       3 | 12121 | `	}` |
|       9 | 12122 | `	sDecoder.rec_depth = 32;` |
|       9 | 12123 | `	if( nArg > 2 && ph7_value_is_int(apArg[2]) ){` |
|     ! 0 | 12124 | `		int nDepth = ph7_value_to_int(apArg[2]);` |
|     ! 0 | 12125 | `		if( nDepth > 1 && nDepth < 32 ){` |
|     ! 0 | 12126 | `			sDecoder.rec_depth = nDepth;` |
|     ! 0 | 12127 | `		}` |
|     ! 0 | 12128 | `	}` |
|       9 | 12129 | `	sDecoder.rec_count = 0;` |
|       - | 12130 | `	/* Set a default consumer */` |
|       9 | 12131 | `	sDecoder.xConsumer = VmJsonDefaultDecoder;` |
|       9 | 12132 | `	sDecoder.pUserData = 0;` |
|       - | 12133 | `	/* Decode the raw JSON input */` |
|       9 | 12134 | `	rc = VmJsonDecode(&sDecoder,0);` |
|       9 | 12135 | `	if( rc == SXERR_ABORT \|\|  pVm->json_rc != JSON_ERROR_NONE ){` |
|       - | 12136 | `		/*` |
...
|       9 | 12142 | `	SyLexRelease(&sLex);` |
|       9 | 12143 | `	SySetRelease(&sToken);` |
|       - | 12144 | `	/* All done */` |
|       9 | 12145 | `	return PH7_OK;` |
|       9 | 12146 |  |
...
|       - | 12953 | ` */` |
|     140 | 12954 | `static ph7_value * VmXMLValue(ph7_xml_engine *pEngine,SyXMLRawStr *pXML,SyXMLRawStr *pNsUri)` |
|       1 | 12955 |  |
|       - | 12956 | `	ph7_value *pValue;` |
|       - | 12957 | `	/* Allocate a new scalar variable */` |
|     141 | 12958 | `	pValue = ph7_context_new_scalar(pEngine->pCtx);` |
|     141 | 12959 | `	if( pValue == 0 ){` |
|     ! 0 | 12960 | `		ph7_context_throw_error(pEngine->pCtx,PH7_CTX_ERR,"PH7 is running out of memory");` |
|     ! 0 | 12961 | `		return 0;` |
|       - | 12962 | `	}` |
|     141 | 12963 | `	if( pNsUri && pNsUri->nByte > 0 ){` |
...
|     141 | 12968 | `	ph7_value_string(pValue,pXML->zString,(int)pXML->nByte);` |
|     141 | 12969 | `	return pValue;` |
|      71 | 12970 |  |
|       - | 12971 | `/*` |
|       - | 12972 | ` * Create a 'ph7_value' of type array holding the values` |
|       - | 12973 | ` * of an XML tag attributes.` |
|       - | 12974 | ` */` |
|      58 | 12975 | `static ph7_value * VmXMLAttrValue(ph7_xml_engine *pEngine,SyXMLRawStr *aAttr,sxu32 nAttr)` |
|       1 | 12976 |  |
|       - | 12977 | `	ph7_value *pArray;` |
|       - | 12978 | `	/* Create an empty array */` |
|      59 | 12979 | `	pArray = ph7_context_new_array(pEngine->pCtx);` |
|      59 | 12980 | `	if( pArray == 0 ){` |
...
|      21 | 13038 | `		return SXRET_OK;` |
|       - | 13039 | `	}` |
|       - | 13040 | `	/* Create a ph7_value holding the tag name */` |
|      59 | 13041 | `	pTag = VmXMLValue(pEngine,pStart,pNS);` |
|       - | 13042 | `	/* Create a ph7_value holding the tag attributes */` |
|      59 | 13043 | `	pAttr = VmXMLAttrValue(pEngine,aAttr,nAttr);` |
|      59 | 13044 | `	if( pTag == 0  \|\| pAttr == 0 ){` |
|     ! 0 | 13045 | `		SXUNUSED(pNS); /* cc warning */` |
|       - | 13046 | `		/* Out of mem,return immediately */` |
|     ! 0 | 13047 | `		return SXRET_OK;` |
|       - | 13048 | `	}` |
|       - | 13049 | `	/* Invoke the user callback */` |
|      59 | 13050 | `	PH7_VmCallUserFunctionAp(pEngine->pVm,pCallback,0,&pEngine->sParserValue,pTag,pAttr,(ph7_value*)0);` |
|       - | 13051 | `	/* Clean-up the mess left behind */` |
|      59 | 13052 | `	ph7_context_release_value(pEngine->pCtx,pTag);` |
|      59 | 13053 | `	ph7_context_release_value(pEngine->pCtx,pAttr);` |
|      59 | 13054 | `	return SXRET_OK;` |
|      40 | 13055 |  |
|       - | 13056 | `/*` |
...
|      13 | 13077 | `		return SXRET_OK;` |
|       - | 13078 | `	}` |
|       - | 13079 | `	/* Create a ph7_value holding the tag name */` |
|      51 | 13080 | `	pTag = VmXMLValue(pEngine,pEnd,pNS);` |
|      51 | 13081 | `	if( pTag == 0  ){` |
...
|      51 | 13087 | `	PH7_VmCallUserFunctionAp(pEngine->pVm,pCallback,0,&pEngine->sParserValue,pTag,(ph7_value*)0);` |
|       - | 13088 | `	/* Clean-up the mess left behind */` |
|      51 | 13089 | `	ph7_context_release_value(pEngine->pCtx,pTag);` |
|      51 | 13090 | `	return SXRET_OK;` |
|      32 | 13091 |  |
|       - | 13092 | `/*` |
...
|       - | 13794 | ` */` |
|    5092 | 13795 | `static sxi32 VmRegisterSpecialFunction(ph7_vm *pVm)` |
|       1 | 13796 |  |
|       - | 13797 | `	sxi32 rc;` |
|       - | 13798 | `	sxu32 n;` |
|  636501 | 13799 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVmFunc) ; ++n ){` |
|       - | 13800 | `		/* Note that these special functions have access` |
|       - | 13801 | `		 * to the underlying virtual machine as their` |
|       - | 13802 | `		 * private data.` |
|       - | 13803 | `		 */` |
|  631409 | 13804 | `		rc = ph7_create_function(&(*pVm),aVmFunc[n].zName,aVmFunc[n].xFunc,&(*pVm));` |
|  631409 | 13805 | `		if( rc != SXRET_OK ){` |
|     ! 0 | 13806 | `			return rc;` |
|       - | 13807 | `		}` |
|  315705 | 13808 | `	}` |
|    5093 | 13809 | `	return SXRET_OK;` |
|    2547 | 13810 |  |
|       - | 13811 | `/*` |
|       - | 13812 | ` * Check if the given name refer to an installed class.` |
|       - | 13813 | ` * Return a pointer to that class on success. NULL on failure.` |
|       - | 13814 | ` */` |
|    6034 | 13815 | `PH7_PRIVATE ph7_class * PH7_VmExtractClass(` |
...
|    3017 | 13827 | `		SXUNUSED(iNest);` |
|       - | 13828 | `	/* Perform a hash lookup */` |
|    6035 | 13829 | `	pEntry = SyHashGet(&pVm->hClass,(const void *)zName,nByte);` |
|       - | 13830 |  |
|    6035 | 13831 | `	if( pEntry == 0 ){` |
|       - | 13832 | `		/* No such entry,return NULL */` |
|     ! 0 | 13833 | `		return 0;` |
|       - | 13834 | `	}` |
|    6035 | 13835 | `	pClass = (ph7_class *)pEntry->pUserData;` |
|    6035 | 13836 | `	if( !iLoadable ){` |
|       - | 13837 | `		/* Return the first class seen */` |
|    5501 | 13838 | `		return pClass;` |
|     ! 0 | 13839 | `	}else{` |
|       - | 13840 | `		/* Check the collision list */` |
|     535 | 13841 | `		while(pClass){` |
|     535 | 13842 | `			if( (pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_ABSTRACT)) == 0 ){` |
|       - | 13843 | `				/* Class is loadable */` |
|     535 | 13844 | `				return pClass;` |
|       - | 13845 | `			}` |
...
|       - | 13866 | ` */` |
|  185900 | 13867 | `static VmRefObj * VmNewRefObj(ph7_vm *pVm,sxu32 nIdx)` |
|       1 | 13868 |  |
|       - | 13869 | `	VmRefObj *pRef;` |
|       - | 13870 | `	/* Allocate a new instance */` |
|  185901 | 13871 | `	pRef = (VmRefObj *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmRefObj));` |
|  185901 | 13872 | `	if( pRef == 0 ){` |
|     ! 0 | 13873 | `		return 0;` |
|       - | 13874 | `	}` |
|       - | 13875 | `	/* Zero the structure */` |
|  185901 | 13876 | `	SyZero(pRef,sizeof(VmRefObj));` |
|       - | 13877 | `	/* Initialize fields */` |
|  185901 | 13878 | `	SySetInit(&pRef->aReference,&pVm->sAllocator,sizeof(SyHashEntry *));` |
|  185901 | 13879 | `	SySetInit(&pRef->aArrEntries,&pVm->sAllocator,sizeof(ph7_hashmap_node *));` |
|  185901 | 13880 | `	pRef->nIdx = nIdx;` |
|  185901 | 13881 | `	return pRef;` |
|   92951 | 13882 |  |
|       - | 13883 | `/*` |
|       - | 13884 | ` * Default hash function used by the reference table` |
|       - | 13885 | ` * for lookup/insertion operations.` |
|       - | 13886 | ` */` |
|  648782 | 13887 | `static sxu32 VmRefHash(sxu32 nIdx)` |
|       1 | 13888 |  |
|       - | 13889 | `	/* Calculate the hash based on the memory object index */` |
|  648783 | 13890 | `	return nIdx ^ (nIdx << 8) ^ (nIdx >> 8);` |
|       1 | 13891 |  |
|       - | 13892 | `/*` |
...
|       - | 13902 | ` * extension.` |
|       - | 13903 | ` */` |
|  248420 | 13904 | `static VmRefObj * VmRefObjExtract(ph7_vm *pVm,sxu32 nObjIdx)` |
|       1 | 13905 |  |
|       - | 13906 | `	VmRefObj *pRef;` |
|       - | 13907 | `	sxu32 nBucket;` |
|       - | 13908 | `	/* Point to the appropriate bucket */` |
|  248421 | 13909 | `	nBucket = VmRefHash(nObjIdx) & (pVm->nRefSize - 1);` |
|       - | 13910 | `	/* Perform the lookup */` |
|  248421 | 13911 | `	pRef = pVm->apRefObj[nBucket];` |
| 1891561 | 13912 | `	for(;;){` |
| 3783123 | 13913 | `		if( pRef == 0 ){` |
|  187981 | 13914 | `			break;` |
|       - | 13915 | `		}` |
| 3595143 | 13916 | `		if( pRef->nIdx == nObjIdx ){` |
|       - | 13917 | `			/* Entry found */` |
|   60441 | 13918 | `			return pRef;` |
|       - | 13919 | `		}` |
|       - | 13920 | `		/* Point to the next entry */` |
| 3534703 | 13921 | `		pRef = pRef->pNextCollide;` |
|       1 | 13922 | `	}` |
|       - | 13923 | `	/* No such entry,return NULL */` |
|  187981 | 13924 | `	return 0;` |
|  124211 | 13925 |  |
|       - | 13926 | `/*` |
...
|       - | 13934 | ` * extension.` |
|       - | 13935 | ` */` |
|  185900 | 13936 | `static sxi32 VmRefObjInsert(ph7_vm *pVm,VmRefObj *pRef)` |
|       1 | 13937 |  |
|       - | 13938 | `	sxu32 nBucket;` |
|  185901 | 13939 | `	if( pVm->nRefUsed * 3 >= pVm->nRefSize ){` |
|       - | 13940 | `		VmRefObj **apNew;` |
|       - | 13941 | `		sxu32 nNew;` |
|       - | 13942 | `		/* Allocate a larger table */` |
|    7221 | 13943 | `		nNew = pVm->nRefSize << 1;` |
|    7221 | 13944 | `		apNew = (VmRefObj **)SyMemBackendAlloc(&pVm->sAllocator,sizeof(VmRefObj *) * nNew);` |
|    7221 | 13945 | `		if( apNew ){` |
|    7221 | 13946 | `			VmRefObj *pEntry = pVm->pRefList;` |
|       - | 13947 | `			sxu32 n;` |
|       - | 13948 | `			/* Zero the structure */` |
|    7221 | 13949 | `			SyZero((void *)apNew,nNew * sizeof(VmRefObj *));` |
|       - | 13950 | `			/* Rehash all referenced entries */` |
|  218293 | 13951 | `			for( n = 0 ; n < pVm->nRefUsed ; ++n ){` |
|       - | 13952 | `				/* Remove old collision links */` |
|  211073 | 13953 | `				pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|       - | 13954 | `				/* Point to the appropriate bucket */` |
|  211073 | 13955 | `				nBucket = VmRefHash(pEntry->nIdx) & (nNew - 1);` |
|       - | 13956 | `				/* Insert the entry  */` |
|  211073 | 13957 | `				pEntry->pNextCollide = apNew[nBucket];` |
|  211073 | 13958 | `				if( apNew[nBucket] ){` |
|  132811 | 13959 | `					apNew[nBucket]->pPrevCollide = pEntry;` |
|   66405 | 13960 | `				}` |
|  211073 | 13961 | `				apNew[nBucket] = pEntry;` |
|       - | 13962 | `				/* Point to the next entry */` |
|  211073 | 13963 | `				pEntry = pEntry->pNext;` |
|  105537 | 13964 | `			}` |
|       - | 13965 | `			/* Release the old table */` |
|    7221 | 13966 | `			SyMemBackendFree(&pVm->sAllocator,pVm->apRefObj);` |
|       - | 13967 | `			/* Install the new one */` |
|    7221 | 13968 | `			pVm->apRefObj = apNew;` |
|    7221 | 13969 | `			pVm->nRefSize = nNew;` |
|    3610 | 13970 | `		}` |
|    3610 | 13971 | `	}` |
|       - | 13972 | `	/* Point to the appropriate bucket */` |
|  185901 | 13973 | `	nBucket = VmRefHash(pRef->nIdx) & (pVm->nRefSize - 1);` |
|       - | 13974 | `	/* Insert the entry */` |
|  185901 | 13975 | `	pRef->pNextCollide = pVm->apRefObj[nBucket];` |
|  185901 | 13976 | `	if( pVm->apRefObj[nBucket] ){` |
|  113501 | 13977 | `		pVm->apRefObj[nBucket]->pPrevCollide = pRef;` |
|   56750 | 13978 | `	}` |
|  185901 | 13979 | `	pVm->apRefObj[nBucket] = pRef;` |
|  185901 | 13980 | `	MACRO_LD_PUSH(pVm->pRefList,pRef);` |
|  185901 | 13981 | `	pVm->nRefUsed++;` |
|  185901 | 13982 | `	return SXRET_OK;` |
|       1 | 13983 |  |
|       - | 13984 | `/*` |
...
|       - | 13994 | ` * extension.` |
|       - | 13995 | ` */` |
|    3652 | 13996 | `static sxi32 VmRefObjUnlink(ph7_vm *pVm,VmRefObj *pRef)` |
|       1 | 13997 |  |
|       - | 13998 | `	ph7_hashmap_node **apNode;` |
|       - | 13999 | `	SyHashEntry **apEntry;` |
|       - | 14000 | `	sxu32 n;` |
|       - | 14001 | `	/* Point to the reference table */` |
|    3653 | 14002 | `	apNode = (ph7_hashmap_node **)SySetBasePtr(&pRef->aArrEntries);` |
|    3653 | 14003 | `	apEntry = (SyHashEntry **)SySetBasePtr(&pRef->aReference);` |
|       - | 14004 | `	/* Unlink the entry from the reference table */` |
|    5761 | 14005 | `	for( n = 0 ; n < SySetUsed(&pRef->aReference) ; n++ ){` |
|    2109 | 14006 | `		if( apEntry[n] ){` |
|    2109 | 14007 | `			SyHashDeleteEntry2(apEntry[n]);` |
|    1054 | 14008 | `		}` |
|    1055 | 14009 | `	}` |
|    5123 | 14010 | `	for(n = 0 ; n < SySetUsed(&pRef->aArrEntries) ; ++n ){` |
|    1471 | 14011 | `		if( apNode[n] ){` |
|     631 | 14012 | `			PH7_HashmapUnlinkNode(apNode[n],FALSE);` |
|     315 | 14013 | `		}` |
|     736 | 14014 | `	}` |
|    3653 | 14015 | `	if( pRef->pPrevCollide ){` |
|     263 | 14016 | `		pRef->pPrevCollide->pNextCollide = pRef->pNextCollide;` |
|     132 | 14017 | `	}else{` |
|    3391 | 14018 | `		pVm->apRefObj[VmRefHash(pRef->nIdx) & (pVm->nRefSize - 1)] = pRef->pNextCollide;` |
|       - | 14019 | `	}` |
|    3653 | 14020 | `	if( pRef->pNextCollide ){` |
|     641 | 14021 | `		pRef->pNextCollide->pPrevCollide = pRef->pPrevCollide;` |
|     320 | 14022 | `	}` |
|    3653 | 14023 | `	MACRO_LD_REMOVE(pVm->pRefList,pRef);` |
|       - | 14024 | `	/* Release the node */` |
|    3653 | 14025 | `	SySetRelease(&pRef->aReference);` |
|    3653 | 14026 | `	SySetRelease(&pRef->aArrEntries);` |
|    3653 | 14027 | `	SyMemBackendPoolFree(&pVm->sAllocator,pRef);` |
|    3653 | 14028 | `	pVm->nRefUsed--;` |
|    3653 | 14029 | `	return SXRET_OK;` |
|       1 | 14030 |  |
|       - | 14031 | `/*` |
...
|       - | 14038 | ` * extension.` |
|       - | 14039 | ` */` |
|  241808 | 14040 | `PH7_PRIVATE sxi32 PH7_VmRefObjInstall(` |
...
|       - | 14046 | `	)` |
|       1 | 14047 |  |
|  241809 | 14048 | `	VmFrame *pFrame = pVm->pFrame;` |
|       - | 14049 | `	VmRefObj *pRef;` |
|       - | 14050 | `	/* Check if the referenced object already exists */` |
|  241809 | 14051 | `	pRef = VmRefObjExtract(&(*pVm),nIdx);` |
|  241809 | 14052 | `	if( pRef == 0 ){` |
|       - | 14053 | `		/* Create a new entry */` |
|  185901 | 14054 | `		pRef = VmNewRefObj(&(*pVm),nIdx);` |
|  185901 | 14055 | `		if( pRef == 0 ){` |
|     ! 0 | 14056 | `			return SXERR_MEM;` |
|       - | 14057 | `		}` |
|  185901 | 14058 | `		pRef->iFlags = iFlags;` |
|       - | 14059 | `		/* Install the entry */` |
|  185901 | 14060 | `		VmRefObjInsert(&(*pVm),pRef);` |
|   92950 | 14061 | `	}` |
|  241861 | 14062 | `	while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|       - | 14063 | `		/* Safely ignore the exception frame */` |
|      53 | 14064 | `		pFrame = pFrame->pParent;` |
|       1 | 14065 | `	}` |
|  241809 | 14066 | `	if( pFrame->pParent != 0 && pEntry ){` |
|       - | 14067 | `		VmSlot sRef;` |
|       - | 14068 | `		/* Local frame,record referenced entry so that it can` |
|       - | 14069 | `		 * be deleted when we leave this frame.` |
|       - | 14070 | `		 */` |
|    2115 | 14071 | `		sRef.nIdx = nIdx;` |
|    2115 | 14072 | `		sRef.pUserData = pEntry;` |
|    2115 | 14073 | `		if( SXRET_OK != SySetPut(&pFrame->sRef,(const void *)&sRef)) {` |
|     ! 0 | 14074 | `			pEntry = 0; /* Do not record this entry */` |
|     ! 0 | 14075 | `		}` |
|    1057 | 14076 | `	}` |
|  241809 | 14077 | `	if( pEntry ){` |
|       - | 14078 | `		/* Address of the hash-entry */` |
|   57851 | 14079 | `		SySetPut(&pRef->aReference,(const void *)&pEntry);` |
|   28925 | 14080 | `	}` |
|  241809 | 14081 | `	if( pMapEntry ){` |
|       - | 14082 | `		/* Address of the hashmap node [i.e: Array entry] */` |
|  183283 | 14083 | `		SySetPut(&pRef->aArrEntries,(const void *)&pMapEntry);` |
|   91641 | 14084 | `	}` |
|  241809 | 14085 | `	return SXRET_OK;` |
|  120905 | 14086 |  |
|       - | 14087 | `/*` |
...
|       - | 14094 | ` * extension.` |
|       - | 14095 | ` */` |
|    2960 | 14096 | `PH7_PRIVATE sxi32 PH7_VmRefObjRemove(` |
...
|    2961 | 14106 | `	pRef = VmRefObjExtract(&(*pVm),nIdx);` |
|    2961 | 14107 | `	if( pRef == 0 ){` |
|       - | 14108 | `		/* Not such entry */` |
|    2081 | 14109 | `		return SXERR_NOTFOUND;` |
|       - | 14110 | `	}` |
|       - | 14111 | `	/* Remove the desired entry */` |
|     881 | 14112 | `	if( pEntry ){` |
|       - | 14113 | `		SyHashEntry **apEntry;` |
|      35 | 14114 | `		apEntry = (SyHashEntry **)SySetBasePtr(&pRef->aReference);` |
|     135 | 14115 | `		for( n = 0 ; n < SySetUsed(&pRef->aReference) ; n++ ){` |
|     101 | 14116 | `			if( apEntry[n] == pEntry ){` |
|       - | 14117 | `				/* Nullify the entry */` |
|      35 | 14118 | `				apEntry[n] = 0;` |
|       - | 14119 | `				/*` |
|       - | 14120 | `				 * NOTE:` |
...
|      51 | 14125 | `		}` |
|      17 | 14126 | `	}` |
|     881 | 14127 | `	if( pMapEntry ){` |
|       - | 14128 | `		ph7_hashmap_node **apNode;` |
|     847 | 14129 | `		apNode = (ph7_hashmap_node **)SySetBasePtr(&pRef->aArrEntries);` |
|    1701 | 14130 | `		for(n = 0 ; n < SySetUsed(&pRef->aArrEntries) ; n++ ){` |
|     855 | 14131 | `			if( apNode[n] == pMapEntry ){` |
|       - | 14132 | `				/* nullify the entry */` |
|     847 | 14133 | `				apNode[n] = 0;` |
|     423 | 14134 | `			}` |
|     428 | 14135 | `		}` |
|     423 | 14136 | `	}` |
|     881 | 14137 | `	return SXRET_OK;` |
|    1481 | 14138 |  |
...
|       - | 14147 | ` */` |
|     316 | 14148 | `PH7_PRIVATE const ph7_io_stream * PH7_VmGetStreamDevice(` |
...
|     317 | 14160 | `	zNext = zCur = zIn = *pzDevice;` |
|     317 | 14161 | `	zEnd = &zIn[nByte];` |
|   17420 | 14162 | `	while( zIn < zEnd ){` |
|   17106 | 14163 | `		if( zIn < &zEnd[-3]/*://*/ && zIn[0] == ':' && zIn[1] == '/' && zIn[2] == '/' ){` |
|       - | 14164 | `			/* Got one */` |
...
|   17104 | 14169 | `		zIn++;` |
|       1 | 14170 | `	}` |
|     317 | 14171 | `	if( zIn >= zEnd ){` |
|       - | 14172 | `		/* No such scheme,return the default stream */` |
|     315 | 14173 | `		return pVm->pDefStream;` |
|       - | 14174 | `	}` |
