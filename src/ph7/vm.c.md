...
|        - |   114 | ` */` |
|   579964 |   115 | `static sxi32 VmIsUnorderedCmp(ph7_value *pLeft,ph7_value *pRight)` |
|        2 |   116 |  |
|   579966 |   117 | `	if( (pLeft->iFlags & MEMOBJ_REAL) && PH7_IS_NAN(pLeft->rVal) ){` |
|       23 |   118 | `		return TRUE;` |
|        - |   119 | `	}` |
|   579944 |   120 | `	if( (pRight->iFlags & MEMOBJ_REAL) && PH7_IS_NAN(pRight->rVal) ){` |
|        9 |   121 | `		return TRUE;` |
|        - |   122 | `	}` |
|   579936 |   123 | `	return FALSE;` |
|   290006 |   124 |  |
|        - |   125 | `/*` |
...
|        - |   182 | ` */` |
|   244034 |   183 | `PH7_PRIVATE sxi32 PH7_VmRegisterConstant(` |
...
|        - |   192 | `	char *zDupName;` |
|        - |   193 | `	sxi32 rc;` |
|   244036 |   194 | `	pEntry = SyHashGet(&pVm->hConstant,(const void *)pName->zString,pName->nByte);` |
|   244036 |   195 | `	if( pEntry ){` |
...
|   244032 |   203 | `	pCons = (ph7_constant *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_constant));` |
|   244032 |   204 | `	if( pCons == 0 ){` |
|      ! 0 |   205 | `		return 0;` |
|        - |   206 | `	}` |
|        - |   207 | `	/* Duplicate constant name */` |
|   244032 |   208 | `	zDupName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|   244032 |   209 | `	if( zDupName == 0 ){` |
|      ! 0 |   210 | `		SyMemBackendPoolFree(&pVm->sAllocator,pCons);` |
|      ! 0 |   211 | `		return 0;` |
|        - |   212 | `	}` |
|        - |   213 | `	/* Install the constant */` |
|   244032 |   214 | `	SyStringInitFromBuf(&pCons->sName,zDupName,pName->nByte);` |
|   244032 |   215 | `	pCons->xExpand = xExpand;` |
|   244032 |   216 | `	pCons->pUserData = pUserData;` |
|   244032 |   217 | `	rc = SyHashInsert(&pVm->hConstant,(const void *)zDupName,SyStringLength(&pCons->sName),pCons);` |
|   244032 |   218 | `	if( rc != SXRET_OK ){` |
...
|        - |   232 | ` */` |
|   525480 |   233 | `static sxi32 PH7_NewForeignFunction(` |
...
|   525482 |   244 | `	pFunc = (ph7_user_func *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_user_func));` |
|   525482 |   245 | `	if( pFunc == 0 ){` |
|      ! 0 |   246 | `		return SXERR_MEM;` |
|        - |   247 | `	}` |
|        - |   248 | `	/* Duplicate function name */` |
|   525482 |   249 | `	zDup = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|   525482 |   250 | `	if( zDup == 0 ){` |
|      ! 0 |   251 | `		SyMemBackendPoolFree(&pVm->sAllocator,pFunc);` |
|      ! 0 |   252 | `		return SXERR_MEM;` |
|        - |   253 | `	}` |
|        - |   254 | `	/* Zero the structure */` |
|   525482 |   255 | `	SyZero(pFunc,sizeof(ph7_user_func));` |
|        - |   256 | `	/* Initialize structure fields */` |
|   525482 |   257 | `	SyStringInitFromBuf(&pFunc->sName,zDup,pName->nByte);` |
|   525482 |   258 | `	pFunc->pVm   = pVm;` |
|   525482 |   259 | `	pFunc->xFunc = xFunc;` |
|   525482 |   260 | `	pFunc->pUserData = pUserData;` |
|   525482 |   261 | `	SySetInit(&pFunc->aAux,&pVm->sAllocator,sizeof(ph7_aux_data));` |
|        - |   262 | `	/* Write a pointer to the new function */` |
|   525482 |   263 | `	*ppOut = pFunc;` |
|   525482 |   264 | `	return SXRET_OK;` |
|   262742 |   265 |  |
|        - |   266 | `/*` |
...
|        - |   273 | ` */` |
|   526688 |   274 | `PH7_PRIVATE sxi32 PH7_VmInstallForeignFunction(` |
...
|   526690 |   285 | `	pEntry = SyHashGet(&pVm->hHostFunction,pName->zString,pName->nByte);` |
|   526690 |   286 | `	if( pEntry ){` |
|     1210 |   287 | `		pFunc = (ph7_user_func *)pEntry->pUserData;` |
|     1210 |   288 | `		pFunc->pUserData = pUserData;` |
|     1210 |   289 | `		pFunc->xFunc = xFunc;` |
|     1210 |   290 | `		SySetReset(&pFunc->aAux);` |
|     1210 |   291 | `		return SXRET_OK;` |
|        - |   292 | `	}` |
|        - |   293 | `	/* Create a new user function */` |
|   525482 |   294 | `	rc = PH7_NewForeignFunction(&(*pVm),&(*pName),xFunc,pUserData,&pFunc);` |
|   525482 |   295 | `	if( rc != SXRET_OK ){` |
|      ! 0 |   296 | `		return rc;` |
|        - |   297 | `	}` |
|        - |   298 | `	/* Install the function in the corresponding hashtable */` |
|   525482 |   299 | `	rc = SyHashInsert(&pVm->hHostFunction,SyStringData(&pFunc->sName),pName->nByte,pFunc);` |
|   525482 |   300 | `	if( rc != SXRET_OK ){` |
...
|   525482 |   306 | `	return SXRET_OK;` |
|   263346 |   307 |  |
|        - |   308 | `/*` |
|        - |   309 | ` * Initialize a VM function.` |
|        - |   310 | ` */` |
|    62194 |   311 | `PH7_PRIVATE sxi32 PH7_VmInitFuncState(` |
...
|    62196 |   321 | `	SyZero(pFunc,sizeof(ph7_vm_func));` |
|        - |   322 | `	/* Initialize structure fields */` |
|        - |   323 | `	/* Arguments container */` |
|    62196 |   324 | `	SySetInit(&pFunc->aArgs,&pVm->sAllocator,sizeof(ph7_vm_func_arg));` |
|        - |   325 | `	/* Static variable container */` |
|    62196 |   326 | `	SySetInit(&pFunc->aStatic,&pVm->sAllocator,sizeof(ph7_vm_func_static_var));` |
|        - |   327 | `	/* Bytecode container */` |
|    62196 |   328 | `	SySetInit(&pFunc->aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|        - |   329 | `    /* Preallocate some instruction slots */` |
|    62196 |   330 | `	SySetAlloc(&pFunc->aByteCode,0x10);` |
|        - |   331 | `	/* Closure environment */` |
|    62196 |   332 | `	SySetInit(&pFunc->aClosureEnv,&pVm->sAllocator,sizeof(ph7_vm_func_closure_env));` |
|    62196 |   333 | `	pFunc->iFlags = iFlags;` |
|    62196 |   334 | `	pFunc->pUserData = pUserData;` |
|    62196 |   335 | `	SyStringInitFromBuf(&pFunc->sName,zName,nByte);` |
|    62196 |   336 | `	return SXRET_OK;` |
|        2 |   337 |  |
|        - |   338 | `/*` |
|        - |   339 | ` * Install a user defined function in the corresponding VM container.` |
|        - |   340 | ` */` |
|   193508 |   341 | `PH7_PRIVATE sxi32 PH7_VmInstallUserFunction(` |
...
|        - |   348 | `	sxi32 rc;` |
|   193510 |   349 | `	if( pName == 0 ){` |
|        - |   350 | `		/* Use the built-in name */` |
|    19470 |   351 | `		pName = &pFunc->sName;` |
|     9734 |   352 | `	}` |
|        - |   353 | `	/* Check for duplicates (functions with the same name) first */` |
|   193510 |   354 | `	pEntry = SyHashGet(&pVm->hFunction,pName->zString,pName->nByte);` |
|   193510 |   355 | `	if( pEntry ){` |
|   143250 |   356 | `		ph7_vm_func *pLink = (ph7_vm_func *)pEntry->pUserData;` |
|   143250 |   357 | `		if( pLink != pFunc ){` |
|        - |   358 | `			/* Link */` |
|      179 |   359 | `			pFunc->pNextName = pLink;` |
|      179 |   360 | `			pEntry->pUserData = pFunc;` |
|       89 |   361 | `		}` |
|   143250 |   362 | `		return SXRET_OK;` |
|        - |   363 | `	}` |
|        - |   364 | `	/* First time seen */` |
|    50262 |   365 | `	pFunc->pNextName = 0;` |
|    50262 |   366 | `	rc = SyHashInsert(&pVm->hFunction,pName->zString,pName->nByte,pFunc);` |
|    50262 |   367 | `	return rc;` |
|    96756 |   368 |  |
|        - |   369 | `/*` |
|        - |   370 | ` * Install a user defined class in the corresponding VM container.` |
|        - |   371 | ` */` |
|    16380 |   372 | `PH7_PRIVATE sxi32 PH7_VmInstallClass(` |
|        - |   373 | `	ph7_vm *pVm,      /* Target VM  */` |
|        - |   374 | `	ph7_class *pClass /* Target Class */` |
|        - |   375 | `	)` |
|        2 |   376 |  |
|    16382 |   377 | `	SyString *pName = &pClass->sName;` |
|        - |   378 | `	SyHashEntry *pEntry;` |
|        - |   379 | `	sxi32 rc;` |
|        - |   380 | `	/* Check for duplicates */` |
|    16382 |   381 | `	pEntry = SyHashGet(&pVm->hClass,(const void *)pName->zString,pName->nByte);` |
|    16382 |   382 | `	if( pEntry ){` |
...
|        - |   388 | `	}` |
|    16352 |   389 | `	pClass->pNextName = 0;` |
|        - |   390 | `	/* Perform a simple hashtable insertion */` |
|    16352 |   391 | `	rc = SyHashInsert(&pVm->hClass,(const void *)pName->zString,pName->nByte,pClass);` |
|    16352 |   392 | `	return rc;` |
|     8192 |   393 |  |
|        - |   394 | `/*` |
|        - |   395 | ` * Instruction builder interface.` |
|        - |   396 | ` */` |
|  1550968 |   397 | `PH7_PRIVATE sxi32 PH7_VmEmitInstr(` |
...
|  1550970 |   409 | `	sInstr.iOp = (sxu8)iOp;` |
|  1550970 |   410 | `	sInstr.iP1 = iP1;` |
|  1550970 |   411 | `	sInstr.iP2 = iP2;` |
|  1550970 |   412 | `	sInstr.p3  = p3;` |
|  1550970 |   413 | `	if( pIndex ){` |
|        - |   414 | `		/* Instruction index in the bytecode array */` |
|    93076 |   415 | `		*pIndex = SySetUsed(pVm->pByteContainer);` |
|    46537 |   416 | `	}` |
|        - |   417 | `	/* Finally,record the instruction */` |
|  1550970 |   418 | `	rc = SySetPut(pVm->pByteContainer,(const void *)&sInstr);` |
|  1550970 |   419 | `	if( rc != SXRET_OK ){` |
|      ! 0 |   420 | `		PH7_GenCompileError(&pVm->sCodeGen,E_ERROR,1,"Fatal,Cannot emit instruction due to a memory failure");` |
|        - |   421 | `		/* Fall throw */` |
|      ! 0 |   422 | `	}` |
|  1550970 |   423 | `	return rc;` |
|        2 |   424 |  |
|        - |   425 | `/*` |
|        - |   426 | ` * Swap the current bytecode container with the given one.` |
|        - |   427 | ` */` |
|   151272 |   428 | `PH7_PRIVATE sxi32 PH7_VmSetByteCodeContainer(ph7_vm *pVm,SySet *pContainer)` |
|        2 |   429 |  |
|   151274 |   430 | `	if( pContainer == 0 ){` |
|        - |   431 | `		/* Point to the default container */` |
|      ! 0 |   432 | `		pVm->pByteContainer = &pVm->aByteCode;` |
|      ! 0 |   433 | `	}else{` |
|        - |   434 | `		/* Change container */` |
|   151274 |   435 | `		pVm->pByteContainer = &(*pContainer);` |
|        - |   436 | `	}` |
|   151274 |   437 | `	return SXRET_OK;` |
|        2 |   438 |  |
|        - |   439 | `/*` |
|        - |   440 | ` * Return the current bytecode container.` |
|        - |   441 | ` */` |
|    75636 |   442 | `PH7_PRIVATE SySet * PH7_VmGetByteCodeContainer(ph7_vm *pVm)` |
|        2 |   443 |  |
|    75638 |   444 | `	return pVm->pByteContainer;` |
|        2 |   445 |  |
|        - |   446 | `/*` |
|        - |   447 | ` * Extract the VM instruction rooted at nIndex.` |
|        - |   448 | ` */` |
|    91532 |   449 | `PH7_PRIVATE VmInstr * PH7_VmGetInstr(ph7_vm *pVm,sxu32 nIndex)` |
|        2 |   450 |  |
|        - |   451 | `	VmInstr *pInstr;` |
|    91534 |   452 | `	pInstr = (VmInstr *)SySetAt(pVm->pByteContainer,nIndex);` |
|    91534 |   453 | `	return pInstr;` |
|        2 |   454 |  |
|        - |   455 | `/*` |
|        - |   456 | ` * Return the total number of VM instructions recorded so far.` |
|        - |   457 | ` */` |
|   450474 |   458 | `PH7_PRIVATE sxu32 PH7_VmInstrLength(ph7_vm *pVm)` |
|        2 |   459 |  |
|   450476 |   460 | `	return SySetUsed(pVm->pByteContainer);` |
|        2 |   461 |  |
|        - |   462 | `/*` |
|        - |   463 | ` * Pop the last VM instruction.` |
|        - |   464 | ` */` |
|    88154 |   465 | `PH7_PRIVATE VmInstr * PH7_VmPopInstr(ph7_vm *pVm)` |
|        2 |   466 |  |
|    88156 |   467 | `	return (VmInstr *)SySetPop(pVm->pByteContainer);` |
|        2 |   468 |  |
|        - |   469 | `/*` |
|        - |   470 | ` * Peek the last VM instruction.` |
|        - |   471 | ` */` |
|   235704 |   472 | `PH7_PRIVATE VmInstr * PH7_VmPeekInstr(ph7_vm *pVm)` |
|        2 |   473 |  |
|   235706 |   474 | `	return (VmInstr *)SySetPeek(pVm->pByteContainer);` |
|        2 |   475 |  |
|     3154 |   476 | `PH7_PRIVATE VmInstr * PH7_VmPeekNextInstr(ph7_vm *pVm)` |
|        2 |   477 |  |
|        - |   478 | `	VmInstr *aInstr;` |
|        - |   479 | `	sxu32 n;` |
|     3156 |   480 | `	n = SySetUsed(pVm->pByteContainer);` |
|     3156 |   481 | `	if( n < 2 ){` |
|      ! 0 |   482 | `		return 0;` |
|        - |   483 | `	}` |
|     3156 |   484 | `	aInstr = (VmInstr *)SySetBasePtr(pVm->pByteContainer);` |
|     3156 |   485 | `	return &aInstr[n - 2];` |
|     1579 |   486 |  |
|        - |   487 | `/*` |
|        - |   488 | ` * Allocate a new virtual machine frame.` |
|        - |   489 | ` */` |
|    10202 |   490 | `static VmFrame * VmNewFrame(` |
...
|    10204 |   498 | `	pFrame = (VmFrame *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmFrame));` |
|    10204 |   499 | `	if( pFrame == 0 ){` |
|      ! 0 |   500 | `		return 0;` |
|        - |   501 | `	}` |
|        - |   502 | `	/* Zero the structure */` |
|    10204 |   503 | `	SyZero(pFrame,sizeof(VmFrame));` |
|        - |   504 | `	/* Initialize frame fields */` |
|    10204 |   505 | `	pFrame->pUserData = pUserData;` |
|    10204 |   506 | `	pFrame->pThis = pThis;` |
|    10204 |   507 | `	pFrame->pVm = pVm;` |
|    10204 |   508 | `	SyHashInit(&pFrame->hVar,&pVm->sAllocator,0,0);` |
|    10204 |   509 | `	SySetInit(&pFrame->sArg,&pVm->sAllocator,sizeof(VmSlot));` |
|    10204 |   510 | `	SySetInit(&pFrame->sLocal,&pVm->sAllocator,sizeof(VmSlot));` |
|    10204 |   511 | `	SySetInit(&pFrame->sRef,&pVm->sAllocator,sizeof(VmSlot));` |
|    10204 |   512 | `	return pFrame;` |
|     5103 |   513 |  |
|        - |   514 | `/*` |
|        - |   515 | ` * Enter a VM frame.` |
|        - |   516 | ` */` |
|    10202 |   517 | `static sxi32 VmEnterFrame(` |
...
|    10204 |   526 | `	pFrame = VmNewFrame(&(*pVm),pUserData,pThis);` |
|    10204 |   527 | `	if( pFrame == 0 ){` |
|      ! 0 |   528 | `		return SXERR_MEM;` |
|        - |   529 | `	}` |
|        - |   530 | `	/* Link to the list of active VM frame */` |
|    10204 |   531 | `	pFrame->pParent = pVm->pFrame;` |
|    10204 |   532 | `	pVm->pFrame = pFrame;` |
|    10204 |   533 | `	if( ppFrame ){` |
|        - |   534 | `		/* Write a pointer to the new VM frame */` |
|     8738 |   535 | `		*ppFrame = pFrame;` |
|     4368 |   536 | `	}` |
|    10204 |   537 | `	return SXRET_OK;` |
|     5103 |   538 |  |
|        - |   539 | `/*` |
...
|        - |   584 | ` */` |
|     8734 |   585 | `static void VmLeaveFrame(ph7_vm *pVm)` |
|        2 |   586 |  |
|     8736 |   587 | `		VmFrame *pCurFrame = pVm->pFrame;` |
|     8736 |   588 | `	if( pCurFrame ){` |
|        - |   589 | `		/* Unlink from the list of active VM frame */` |
|     8736 |   590 | `		pVm->pFrame = pCurFrame->pParent;` |
|     8736 |   591 | `		if( pCurFrame->pParent && (pCurFrame->iFlags & VM_FRAME_EXCEPTION) == 0 ){` |
|        - |   592 | `			VmSlot  *aSlot;` |
|        - |   593 | `			sxu32 n;` |
|        - |   594 | `			/* Restore local variable to the free pool so that they can be reused again */` |
|     8718 |   595 | `			aSlot = (VmSlot *)SySetBasePtr(&pCurFrame->sLocal);` |
|    64120 |   596 | `			for(n = 0 ; n < SySetUsed(&pCurFrame->sLocal) ; ++n ){` |
|        - |   597 | `				/* Unset the local variable */` |
|    55404 |   598 | `				PH7_VmUnsetMemObj(&(*pVm),aSlot[n].nIdx,FALSE);` |
|    27703 |   599 | `			}` |
|        - |   600 | `			/* Remove local reference */` |
|     8718 |   601 | `			aSlot = (VmSlot *)SySetBasePtr(&pCurFrame->sRef);` |
|    64154 |   602 | `			for(n = 0 ; n < SySetUsed(&pCurFrame->sRef) ; ++n ){` |
|    55438 |   603 | `				PH7_VmRefObjRemove(&(*pVm),aSlot[n].nIdx,(SyHashEntry *)aSlot[n].pUserData,0);` |
|    27720 |   604 | `			}` |
|     4358 |   605 | `		}` |
|        - |   606 | `		/* Release internal containers */` |
|     8736 |   607 | `		SyHashRelease(&pCurFrame->hVar);` |
|     8736 |   608 | `		SySetRelease(&pCurFrame->sArg);` |
|     8736 |   609 | `		SySetRelease(&pCurFrame->sLocal);` |
|     8736 |   610 | `		SySetRelease(&pCurFrame->sRef);` |
|        - |   611 | `		/* Release the whole structure */` |
|     8736 |   612 | `		SyMemBackendPoolFree(&pVm->sAllocator,pCurFrame);` |
|     4367 |   613 | `	}` |
|     8736 |   614 |  |
|        - |   615 | `/*` |
...
|        - |   731 | ` */` |
|    58858 |   732 | `PH7_PRIVATE sxi32 VmMountUserClass(` |
...
|    58860 |   742 | `	SyHashResetLoopCursor(&pClass->hAttr);` |
|        - |   743 | `	/* Process only static and constant attribute */` |
|   196725 |   744 | `	while( (pEntry = SyHashGetNextEntry(&pClass->hAttr)) != 0 ){` |
|        - |   745 | `		/* Extract the current attribute */` |
|   108438 |   746 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|   108438 |   747 | `		if( pAttr->iFlags & (PH7_CLASS_ATTR_CONSTANT\|PH7_CLASS_ATTR_STATIC) ){` |
...
|    58860 |   769 | `	if( pClass->iFlags & PH7_CLASS_INTERFACE ){` |
|        - |   770 | `		/* Do not mount interface methods since they are signatures only.` |
|        - |   771 | `		 */` |
|    37238 |   772 | `		return SXRET_OK;` |
|        - |   773 | `	}` |
|        - |   774 | `	/* Create constructor alias if not yet done */` |
|    21624 |   775 | `	if( SyHashGet(&pClass->hMethod,"__construct",sizeof("__construct")-1) == 0 ){` |
...
|    21624 |   785 | `	SyHashResetLoopCursor(&pClass->hMethod);` |
|   206481 |   786 | `	while((pEntry = SyHashGetNextEntry(&pClass->hMethod)) != 0 ){` |
|   174048 |   787 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|   174048 |   788 | `		if( (pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT) == 0 ){` |
|   174042 |   789 | `			rc = PH7_VmInstallUserFunction(&(*pVm),&pMeth->sFunc,&pMeth->sVmName);` |
|   174042 |   790 | `			if( rc != SXRET_OK ){` |
|      ! 0 |   791 | `				return rc;` |
|        - |   792 | `			}` |
|    87020 |   793 | `		}` |
|        2 |   794 | `	}` |
|        - |   795 | `	/* Mark class as mounted to avoid redundant mounting */` |
|    21624 |   796 | `	pClass->bMounted = TRUE;` |
|    21624 |   797 | `	return SXRET_OK;` |
|    29431 |   798 |  |
|        - |   799 | `/*` |
|        - |   800 | ` * Allocate a private frame for attributes of the given` |
|        - |   801 | ` * class instance (Object in the PHP jargon).` |
|        - |   802 | ` */` |
|      690 |   803 | `PH7_PRIVATE sxi32 PH7_VmCreateClassInstanceFrame(` |
|        - |   804 | `	ph7_vm *pVm, /* Target VM */` |
|        - |   805 | `	ph7_class_instance *pObj /* Class instance */` |
|        - |   806 | `	)` |
|        2 |   807 |  |
|      692 |   808 | `	ph7_class *pClass = pObj->pClass;` |
...
|      692 |   813 | `	SyHashResetLoopCursor(&pClass->hAttr);` |
|     2146 |   814 | `	while( (pEntry = SyHashGetNextEntry(&pClass->hAttr)) != 0 ){` |
|        - |   815 | `		VmClassAttr *pVmAttr;` |
|        - |   816 | `		/* Extract the current attribute */` |
|     1456 |   817 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|     1456 |   818 | `		pVmAttr = (VmClassAttr *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmClassAttr));` |
|     1456 |   819 | `		if( pVmAttr == 0 ){` |
|      ! 0 |   820 | `			return SXERR_MEM;` |
|        - |   821 | `		}` |
|     1456 |   822 | `		pVmAttr->pAttr = pAttr;` |
|     1456 |   823 | `		if( (pAttr->iFlags & (PH7_CLASS_ATTR_CONSTANT\|PH7_CLASS_ATTR_STATIC)) == 0 ){` |
|        - |   824 | `			ph7_value *pMemObj;` |
|        - |   825 | `			/* Reserve a memory object for this attribute */` |
|     1450 |   826 | `			pMemObj = PH7_ReserveMemObj(&(*pVm));` |
|     1450 |   827 | `			if( pMemObj == 0 ){` |
|      ! 0 |   828 | `				SyMemBackendPoolFree(&pVm->sAllocator,pVmAttr);` |
|      ! 0 |   829 | `				return SXERR_MEM;` |
|        - |   830 | `			}` |
|     1450 |   831 | `			pVmAttr->nIdx = pMemObj->nIdx;` |
|     1450 |   832 | `			if( SySetUsed(&pAttr->aByteCode) > 0 ){` |
|        - |   833 | `				/* Initialize attribute default value (any complex expression) */` |
|      460 |   834 | `				VmLocalExec(&(*pVm),&pAttr->aByteCode,pMemObj);` |
|      229 |   835 | `			}` |
|     1450 |   836 | `			rc = SyHashInsert(&pObj->hAttr,SyStringData(&pAttr->sName),SyStringLength(&pAttr->sName),pVmAttr);` |
|     1450 |   837 | `			if( rc != SXRET_OK ){` |
|        - |   838 | `				VmSlot sSlot;` |
...
|     1450 |   847 | `			PH7_VmRefObjInstall(&(*pVm),pMemObj->nIdx,0,0,VM_REF_IDX_KEEP);` |
|      726 |   848 | `		}else{` |
...
|        - |   870 | ` */` |
|   176598 |   871 | `PH7_PRIVATE ph7_value * PH7_ReserveConstObj(ph7_vm *pVm,sxu32 *pIndex)` |
|        2 |   872 |  |
|        - |   873 | `	ph7_value *pObj;` |
|        - |   874 | `	sxi32 rc;` |
|   176600 |   875 | `	if( pIndex ){` |
|        - |   876 | `		/* Object index in the object table */` |
|   172202 |   877 | `		*pIndex = SySetUsed(&pVm->aLitObj);` |
|    86100 |   878 | `	}` |
|        - |   879 | `	/* Reserve a slot for the new object */` |
|   176600 |   880 | `	rc = SySetPut(&pVm->aLitObj,(const void *)zDummy);` |
|   176600 |   881 | `	if( rc != SXRET_OK ){` |
...
|      ! 0 |   885 | `		return 0;` |
|        - |   886 | `	}` |
|   176600 |   887 | `	pObj = (ph7_value *)SySetPeek(&pVm->aLitObj);` |
|   176600 |   888 | `	return pObj;` |
|    88301 |   889 |  |
|        - |   890 | `/*` |
|        - |   891 | ` * Reserve a memory object.` |
|        - |   892 | ` * Return a pointer to the raw ph7_value on success. NULL on failure.` |
|        - |   893 | ` */` |
|  2118960 |   894 | `PH7_PRIVATE ph7_value * VmReserveMemObj(ph7_vm *pVm,sxu32 *pIndex)` |
|        2 |   895 |  |
|        - |   896 | `	ph7_value *pObj;` |
|        - |   897 | `	sxi32 rc;` |
|  2118962 |   898 | `	if( pIndex ){` |
|        - |   899 | `		/* Object index in the object table */` |
|  2118962 |   900 | `		*pIndex = SySetUsed(&pVm->aMemObj);` |
|  1059480 |   901 | `	}` |
|        - |   902 | `	/* Reserve a slot for the new object */` |
|  2118962 |   903 | `	rc = SySetPut(&pVm->aMemObj,(const void *)zDummy);` |
|  2118962 |   904 | `	if( rc != SXRET_OK ){` |
...
|      ! 0 |   908 | `		return 0;` |
|        - |   909 | `	}` |
|  2118962 |   910 | `	pObj = (ph7_value *)SySetPeek(&pVm->aMemObj);` |
|  2118962 |   911 | `	return pObj;` |
|  1059482 |   912 |  |
...
|        - |  1250 | ` */` |
|     1466 |  1251 | `PH7_PRIVATE sxi32 PH7_VmInit(` |
...
|     1468 |  1260 | `	SyZero(pVm,sizeof(ph7_vm));` |
|        - |  1261 | `	/* Initialize VM fields */` |
|     1468 |  1262 | `	pVm->pEngine = &(*pEngine);` |
|     1468 |  1263 | `	SyMemBackendInitFromParent(&pVm->sAllocator,&pEngine->sAllocator);` |
|        - |  1264 | `	/* Instructions containers */` |
|     1468 |  1265 | `	SySetInit(&pVm->aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|     1468 |  1266 | `	SySetAlloc(&pVm->aByteCode,0xFF);` |
|     1468 |  1267 | `	pVm->pByteContainer = &pVm->aByteCode;` |
|        - |  1268 | `	/* Object containers */` |
|     1468 |  1269 | `	SySetInit(&pVm->aMemObj,&pVm->sAllocator,sizeof(ph7_value));` |
|     1468 |  1270 | `	SySetAlloc(&pVm->aMemObj,0xFF);` |
|        - |  1271 | `	/* Virtual machine internal containers */` |
|     1468 |  1272 | `	SyBlobInit(&pVm->sConsumer,&pVm->sAllocator);` |
|     1468 |  1273 | `	SyBlobInit(&pVm->sWorker,&pVm->sAllocator);` |
|     1468 |  1274 | `	SyBlobInit(&pVm->sArgv,&pVm->sAllocator);` |
|     1468 |  1275 | `	SySetInit(&pVm->aLitObj,&pVm->sAllocator,sizeof(ph7_value));` |
|     1468 |  1276 | `	SySetAlloc(&pVm->aLitObj,0xFF);` |
|     1468 |  1277 | `	SyHashInit(&pVm->hHostFunction,&pVm->sAllocator,0,0);` |
|     1468 |  1278 | `	SyHashInit(&pVm->hFunction,&pVm->sAllocator,0,0);` |
|     1468 |  1279 | `	SyHashInit(&pVm->hClass,&pVm->sAllocator,SyStrHash,SyStrnmicmp);` |
|     1468 |  1280 | `	SyHashInit(&pVm->hConstant,&pVm->sAllocator,0,0);` |
|     1468 |  1281 | `	SyHashInit(&pVm->hSuper,&pVm->sAllocator,0,0);` |
|     1468 |  1282 | `	SyHashInit(&pVm->hPDO,&pVm->sAllocator,0,0);` |
|     1468 |  1283 | `	SySetInit(&pVm->aFreeObj,&pVm->sAllocator,sizeof(VmSlot));` |
|     1468 |  1284 | `	SySetInit(&pVm->aSelf,&pVm->sAllocator,sizeof(ph7_class *));` |
|     1468 |  1285 | `	SySetInit(&pVm->aShutdown,&pVm->sAllocator,sizeof(VmShutdownCB));` |
|     1468 |  1286 | `	SySetInit(&pVm->aException,&pVm->sAllocator,sizeof(ph7_exception *));` |
|        - |  1287 | `	/* Configuration containers */` |
|     1468 |  1288 | `	SySetInit(&pVm->aFiles,&pVm->sAllocator,sizeof(SyString));` |
|     1468 |  1289 | `	SySetInit(&pVm->aPaths,&pVm->sAllocator,sizeof(SyString));` |
|     1468 |  1290 | `	SySetInit(&pVm->aIncluded,&pVm->sAllocator,sizeof(SyString));` |
|     1468 |  1291 | `	SySetInit(&pVm->aOB,&pVm->sAllocator,sizeof(VmObEntry));` |
|     1468 |  1292 | `	SySetInit(&pVm->aIOstream,&pVm->sAllocator,sizeof(ph7_io_stream *));` |
|        - |  1293 | `	/* Error callbacks containers */` |
|     1468 |  1294 | `	PH7_MemObjInit(&(*pVm),&pVm->aExceptionCB[0]);` |
|     1468 |  1295 | `	PH7_MemObjInit(&(*pVm),&pVm->aExceptionCB[1]);` |
|     1468 |  1296 | `	PH7_MemObjInit(&(*pVm),&pVm->aErrCB[0]);` |
|     1468 |  1297 | `	PH7_MemObjInit(&(*pVm),&pVm->aErrCB[1]);` |
|     1468 |  1298 | `	PH7_MemObjInit(&(*pVm),&pVm->sAssertCallback);` |
|        - |  1299 | `	/* Set a default recursion limit */` |
|        - |  1300 | `#if defined(__WINNT__) \|\| defined(__UNIXES__)` |
|     1468 |  1301 | `	pVm->nMaxDepth = 32;` |
|        - |  1302 | `#else` |
|        - |  1303 | `	pVm->nMaxDepth = 16;` |
|        - |  1304 | `#endif` |
|        - |  1305 | `	/* Default assertion flags */` |
|     1468 |  1306 | `	pVm->iAssertFlags = PH7_ASSERT_WARNING; /* Issue a warning for each failed assertion */` |
|        - |  1307 | `	/* JSON return status */` |
|     1468 |  1308 | `	pVm->json_rc = JSON_ERROR_NONE;` |
|        - |  1309 | `	/* PRNG context */` |
|     1468 |  1310 | `	SyRandomnessInit(&pVm->sPrng,0,0);` |
|        - |  1311 | `	/* Install the null constant */` |
|     1468 |  1312 | `	pObj = PH7_ReserveConstObj(&(*pVm),0);` |
|     1468 |  1313 | `	if( pObj == 0 ){` |
|      ! 0 |  1314 | `		rc = SXERR_MEM;` |
|      ! 0 |  1315 | `		goto Err;` |
|        - |  1316 | `	}` |
|     1468 |  1317 | `	PH7_MemObjInit(pVm,pObj);` |
|        - |  1318 | `	/* Install the boolean TRUE constant */` |
|     1468 |  1319 | `	pObj = PH7_ReserveConstObj(&(*pVm),0);` |
|     1468 |  1320 | `	if( pObj == 0 ){` |
|      ! 0 |  1321 | `		rc = SXERR_MEM;` |
|      ! 0 |  1322 | `		goto Err;` |
|        - |  1323 | `	}` |
|     1468 |  1324 | `	PH7_MemObjInitFromBool(pVm,pObj,1);` |
|        - |  1325 | `	/* Install the boolean FALSE constant */` |
|     1468 |  1326 | `	pObj = PH7_ReserveConstObj(&(*pVm),0);` |
|     1468 |  1327 | `	if( pObj == 0 ){` |
|      ! 0 |  1328 | `		rc = SXERR_MEM;` |
|      ! 0 |  1329 | `		goto Err;` |
|        - |  1330 | `	}` |
|     1468 |  1331 | `	PH7_MemObjInitFromBool(pVm,pObj,0);` |
...
|     1468 |  1335 | `	pObj = PH7_ReserveConstObj(&(*pVm),&pVm->nEmptyStringIdx);` |
|     1468 |  1336 | `	if( pObj == 0 ){` |
|      ! 0 |  1337 | `		rc = SXERR_MEM;` |
|      ! 0 |  1338 | `		goto Err;` |
|        - |  1339 | `	}` |
|     1468 |  1340 | `	PH7_MemObjInitFromString(pVm,pObj,0);` |
|        - |  1341 | `	/* Create the global frame */` |
|     1468 |  1342 | `	rc = VmEnterFrame(&(*pVm),0,0,0);` |
|     1468 |  1343 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  1344 | `		goto Err;` |
|        - |  1345 | `	}` |
|        - |  1346 | `	/* Initialize the code generator */` |
|     1468 |  1347 | `	rc = PH7_InitCodeGenerator(pVm,pEngine->xConf.xErr,pEngine->xConf.pErrData);` |
|     1468 |  1348 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  1349 | `		goto Err;` |
|        - |  1350 | `	}` |
|        - |  1351 | `	/* VM correctly initialized,set the magic number */` |
|     1468 |  1352 | `	pVm->nMagic = PH7_VM_INIT;` |
|     1468 |  1353 | `	SyStringInitFromBuf(&sBuiltin,PH7_BUILTIN_LIB,sizeof(PH7_BUILTIN_LIB)-1);` |
|        - |  1354 | `	/* Compile the built-in library */` |
|     1468 |  1355 | `	VmEvalChunk(&(*pVm),0,&sBuiltin,PH7_PHP_ONLY,FALSE);` |
|        - |  1356 | `	/* Reset the code generator */` |
|     1468 |  1357 | `	PH7_ResetCodeGenerator(&(*pVm),pEngine->xConf.xErr,pEngine->xConf.pErrData);` |
|     1468 |  1358 | `	return SXRET_OK;` |
|      ! 0 |  1359 | `Err:` |
...
|        - |  1391 | ` */` |
|    21830 |  1392 | `static ph7_value * VmNewOperandStack(` |
...
|        - |  1404 | `  */` |
|    21832 |  1405 | `	nInstr += VM_STACK_GUARD;` |
|    21832 |  1406 | `	pStack = (ph7_value *)SyMemBackendAlloc(&pVm->sAllocator,nInstr * sizeof(ph7_value));` |
|    21832 |  1407 | `	if( pStack == 0 ){` |
|      ! 0 |  1408 | `		return 0;` |
|        - |  1409 | `	}` |
|        - |  1410 | `	/* Initialize the operand stack */` |
|  1389578 |  1411 | `	while( nInstr > 0 ){` |
|  1367748 |  1412 | `		PH7_MemObjInit(&(*pVm),&pStack[nInstr - 1]);` |
|  1367748 |  1413 | `		--nInstr;` |
|        2 |  1414 | `	}` |
|        - |  1415 | `	/* Ready for bytecode execution */` |
|    21832 |  1416 | `	return pStack;` |
|    10917 |  1417 |  |
...
|        - |  1426 | ` */` |
|     1208 |  1427 | `PH7_PRIVATE sxi32 PH7_VmMakeReady(` |
|        - |  1428 | `	ph7_vm *pVm /* Target VM */` |
|        - |  1429 | `	)` |
|        2 |  1430 |  |
|        - |  1431 | `	SyHashEntry *pEntry;` |
|        - |  1432 | `	sxi32 rc;` |
|     1210 |  1433 | `	if( pVm->nMagic != PH7_VM_INIT ){` |
|        - |  1434 | `		/* Initialize your VM first */` |
|      ! 0 |  1435 | `		return SXERR_CORRUPT;` |
|        - |  1436 | `	}` |
|        - |  1437 | `	/* Mark the VM ready for byte-code execution */` |
|     1210 |  1438 | `	pVm->nMagic = PH7_VM_RUN;` |
|        - |  1439 | `	/* Release the code generator now we have compiled our program */` |
|     1210 |  1440 | `	PH7_ResetCodeGenerator(pVm,0,0);` |
|        - |  1441 | `	/* Emit the DONE instruction */` |
|     1210 |  1442 | `	rc = PH7_VmEmitInstr(&(*pVm),PH7_OP_DONE,0,0,0,0);` |
|     1210 |  1443 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  1444 | `		return SXERR_MEM;` |
|        - |  1445 | `	}` |
|        - |  1446 | `	/* Script return value */` |
|     1210 |  1447 | `	PH7_MemObjInit(&(*pVm),&pVm->sExec); /* Assume a NULL return value */` |
|        - |  1448 | `	/* Allocate a new operand stack */` |
|     1210 |  1449 | `	pVm->aOps = VmNewOperandStack(&(*pVm),SySetUsed(pVm->pByteContainer));` |
|     1210 |  1450 | `	if( pVm->aOps == 0 ){` |
|      ! 0 |  1451 | `		return SXERR_MEM;` |
|        - |  1452 | `	}` |
|        - |  1453 | `	/* Set the default VM output consumer callback and it's` |
|        - |  1454 | `	 * private data. */` |
|     1210 |  1455 | `	pVm->sVmConsumer.xConsumer = PH7_VmBlobConsumer;` |
|     1210 |  1456 | `	pVm->sVmConsumer.pUserData = &pVm->sConsumer;` |
|        - |  1457 | `	/* Allocate the reference table */` |
|     1210 |  1458 | `	pVm->nRefSize = 0x10; /* Must be a power of two for fast arithemtic */` |
|     1210 |  1459 | `	pVm->apRefObj = (VmRefObj **)SyMemBackendAlloc(&pVm->sAllocator,sizeof(VmRefObj *) * pVm->nRefSize);` |
|     1210 |  1460 | `	if( pVm->apRefObj == 0 ){` |
...
|     1210 |  1479 | `	PH7_RegisterBuiltInConstant(&(*pVm));` |
|        - |  1480 | `	/* Register built-in functions [i.e: is_null(), array_diff(), strlen(), etc.] */` |
|     1210 |  1481 | `	PH7_RegisterBuiltInFunction(&(*pVm));` |
|        - |  1482 | `	/* Initialize and install static and constants class attributes */` |
|     1210 |  1483 | `	SyHashResetLoopCursor(&pVm->hClass);` |
|    14524 |  1484 | `	while((pEntry = SyHashGetNextEntry(&pVm->hClass)) != 0 ){` |
|    13316 |  1485 | `		rc = VmMountUserClass(&(*pVm),(ph7_class *)pEntry->pUserData);` |
|    13316 |  1486 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  1487 | `			return rc;` |
|        - |  1488 | `		}` |
|        2 |  1489 | `	}` |
|        - |  1490 | `	/* Random number betwwen 0 and 1023 used to generate unique ID */` |
|     1210 |  1491 | `	pVm->unique_id = PH7_VmRandomNum(&(*pVm)) & 1023;` |
|        - |  1492 | `	/* VM is ready for bytecode execution */` |
|     1210 |  1493 | `	return SXRET_OK;` |
|      606 |  1494 |  |
|        - |  1495 | `/*` |
...
|        - |  1513 | ` */` |
|     1200 |  1514 | `PH7_PRIVATE sxi32 PH7_VmRelease(ph7_vm *pVm)` |
|        2 |  1515 |  |
|        - |  1516 | `	/* Set the stale magic number */` |
|     1202 |  1517 | `	pVm->nMagic = PH7_VM_STALE;` |
|        - |  1518 | `	/* Release the private memory subsystem */` |
|     1202 |  1519 | `	SyMemBackendRelease(&pVm->sAllocator);` |
|     1202 |  1520 | `	return SXRET_OK;` |
|        2 |  1521 |  |
|        - |  1522 | `/*` |
...
|        - |  1531 | ` */` |
|   444644 |  1532 | `static sxi32 VmInitCallContext(` |
...
|        - |  1538 | `	)` |
|        2 |  1539 |  |
|   444646 |  1540 | `	pOut->pFunc = pFunc;` |
|   444646 |  1541 | `	pOut->pVm   = pVm;` |
|   444646 |  1542 | `	SySetInit(&pOut->sVar,&pVm->sAllocator,sizeof(ph7_value *));` |
|   444646 |  1543 | `	SySetInit(&pOut->sChunk,&pVm->sAllocator,sizeof(ph7_aux_data));` |
|        - |  1544 | `	/* Assume a null return value */` |
|   444646 |  1545 | `	MemObjSetType(pRet,MEMOBJ_NULL);` |
|   444646 |  1546 | `	pOut->pRet = pRet;` |
|   444646 |  1547 | `	pOut->iFlags = iFlags;` |
|   444646 |  1548 | `	return SXRET_OK;` |
|        2 |  1549 |  |
|        - |  1550 | `/*` |
|        - |  1551 | ` * Release a foreign function call context and cleanup the mess` |
|        - |  1552 | ` * left behind.` |
|        - |  1553 | ` */` |
|   444644 |  1554 | `static void VmReleaseCallContext(ph7_context *pCtx)` |
|        2 |  1555 |  |
|        - |  1556 | `	sxu32 n;` |
|   444646 |  1557 | `	if( SySetUsed(&pCtx->sVar) > 0 ){` |
|     4982 |  1558 | `		ph7_value **apObj = (ph7_value **)SySetBasePtr(&pCtx->sVar);` |
|    13970 |  1559 | `		for( n = 0 ; n < SySetUsed(&pCtx->sVar) ; ++n ){` |
|     8990 |  1560 | `			if( apObj[n] == 0 ){` |
|        - |  1561 | `				/* Already released */` |
|      250 |  1562 | `				continue;` |
|        - |  1563 | `			}` |
|     8742 |  1564 | `			PH7_MemObjRelease(apObj[n]);` |
|     8742 |  1565 | `			SyMemBackendPoolFree(&pCtx->pVm->sAllocator,apObj[n]);` |
|     4372 |  1566 | `		}` |
|     4982 |  1567 | `		SySetRelease(&pCtx->sVar);` |
|     2490 |  1568 | `	}` |
|   444646 |  1569 | `	if( SySetUsed(&pCtx->sChunk) > 0 ){` |
...
|        - |  1615 | ` */` |
|  2529162 |  1616 | `static void VmPopOperand(` |
|        - |  1617 | `	ph7_value **ppTos, /* Operand stack */` |
|        - |  1618 | `	sxi32 nPop         /* Total number of memory objects to pop */` |
|        - |  1619 | `	)` |
|        2 |  1620 |  |
|  2529164 |  1621 | `	ph7_value *pTos = *ppTos;` |
|  5383748 |  1622 | `	while( nPop > 0 ){` |
|  2854586 |  1623 | `		PH7_MemObjRelease(pTos);` |
|  2854586 |  1624 | `		pTos--;` |
|  2854586 |  1625 | `		nPop--;` |
|        2 |  1626 | `	}` |
|        - |  1627 | `	/* Top of the stack */` |
|  2529164 |  1628 | `	*ppTos = pTos;` |
|  2529164 |  1629 |  |
|        - |  1630 | `/*` |
|        - |  1631 | ` * Reserve a memory object.` |
|        - |  1632 | ` * Return a pointer to the raw ph7_value on success. NULL on failure.` |
|        - |  1633 | ` */` |
|  2767212 |  1634 | `PH7_PRIVATE ph7_value * PH7_ReserveMemObj(ph7_vm *pVm)` |
|        2 |  1635 |  |
|  2767214 |  1636 | `	ph7_value *pObj = 0;` |
|        - |  1637 | `	VmSlot *pSlot;` |
|        - |  1638 | `	sxu32 nIdx;` |
|        - |  1639 | `	/* Check for a free slot */` |
|  2767214 |  1640 | `	nIdx = SXU32_HIGH; /* cc warning */` |
|  2767214 |  1641 | `	pSlot = (VmSlot *)SySetPop(&pVm->aFreeObj);` |
|  2767214 |  1642 | `	if( pSlot ){` |
|   648254 |  1643 | `		pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pSlot->nIdx);` |
|   648254 |  1644 | `		nIdx = pSlot->nIdx;` |
|   324126 |  1645 | `	}` |
|  2767214 |  1646 | `	if( pObj == 0 ){` |
|        - |  1647 | `		/* Reserve a new memory object */` |
|  2118962 |  1648 | `		pObj = VmReserveMemObj(&(*pVm),&nIdx);` |
|  2118962 |  1649 | `		if( pObj == 0 ){` |
|      ! 0 |  1650 | `			return 0;` |
|        - |  1651 | `		}` |
|  1059480 |  1652 | `	}` |
|        - |  1653 | `	/* Set a null default value */` |
|  2767214 |  1654 | `	PH7_MemObjInit(&(*pVm),pObj);` |
|  2767214 |  1655 | `	pObj->nIdx = nIdx;` |
|  2767214 |  1656 | `	return pObj;` |
|  1383608 |  1657 |  |
|        - |  1658 | `/*` |
|        - |  1659 | ` * Insert an entry by reference (not copy) in the given hashmap.` |
|        - |  1660 | ` */` |
|    16876 |  1661 | `static sxi32 VmHashmapRefInsert(` |
...
|        - |  1668 | `	ph7_value sKey;` |
|        - |  1669 | `	sxi32 rc;` |
|    16878 |  1670 | `	PH7_MemObjInitFromString(pMap->pVm,&sKey,0);` |
|    16878 |  1671 | `	PH7_MemObjStringAppend(&sKey,zKey,nByte);` |
|        - |  1672 | `	/* Perform the insertion */` |
|    16878 |  1673 | `	rc = PH7_HashmapInsertByRef(&(*pMap),&sKey,nRefIdx);` |
|    16878 |  1674 | `	PH7_MemObjRelease(&sKey);` |
|    16878 |  1675 | `	return rc;` |
|        2 |  1676 |  |
|        - |  1677 | `/*` |
...
|        - |  1681 | ` */` |
|  2327266 |  1682 | `static ph7_value * VmExtractMemObj(` |
...
|        - |  1687 | `	)` |
|        2 |  1688 |  |
|  2327268 |  1689 | `	int bNullify = FALSE;` |
...
|  2327268 |  1696 | `	pFrame = pVm->pFrame;` |
|  2376620 |  1697 | `	while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|        - |  1698 | `		/* Safely ignore the exception frame */` |
|    49353 |  1699 | `		pFrame = pFrame->pParent; /* Parent frame */` |
|        1 |  1700 | `	}` |
|        - |  1701 | `	/* Perform the lookup */` |
|  2327268 |  1702 | `	if( pName == 0 \|\| pName->nByte < 1 ){` |
...
|  2327268 |  1710 | `	pEntry = SyHashGet(&pVm->hSuper,(const void *)pName->zString,pName->nByte);` |
|  2327268 |  1711 | `	if( pEntry == 0 ){` |
|        - |  1712 | `		/* Query the top active frame */` |
|  2327232 |  1713 | `		pEntry = SyHashGet(&pFrame->hVar,(const void *)pName->zString,pName->nByte);` |
|  2327232 |  1714 | `		if( pEntry == 0 ){` |
|    60658 |  1715 | `			char *zName = (char *)pName->zString;` |
|        - |  1716 | `			VmSlot sLocal;` |
|    60658 |  1717 | `			if( !bCreate ){` |
...
|        - |  1723 | `			 */` |
|    60176 |  1724 | `			pObj = PH7_ReserveMemObj(&(*pVm));` |
|    60176 |  1725 | `			if( pObj == 0 ){` |
|      ! 0 |  1726 | `				return 0;` |
|        - |  1727 | `			}` |
|    60176 |  1728 | `			nIdx = pObj->nIdx;` |
|    60176 |  1729 | `			if( bDup ){` |
|        - |  1730 | `				/* Duplicate name */` |
...
|    60176 |  1737 | `			rc = SyHashInsert(&pFrame->hVar,zName,pName->nByte,SX_INT_TO_PTR(nIdx));` |
|    60176 |  1738 | `			if( rc != SXRET_OK ){` |
...
|      ! 0 |  1743 | `				return 0;` |
|        - |  1744 | `			}` |
|    60176 |  1745 | `			if( pFrame->pParent != 0 ){` |
|        - |  1746 | `				/* Local variable */` |
|    55404 |  1747 | `				sLocal.nIdx = nIdx;` |
|    55404 |  1748 | `				SySetPut(&pFrame->sLocal,(const void *)&sLocal);` |
|    27703 |  1749 | `			}else{` |
|        - |  1750 | `				/* Register in the $GLOBALS array */` |
|     4774 |  1751 | `				VmHashmapRefInsert(pVm->pGlobal,pName->zString,pName->nByte,nIdx);` |
|        - |  1752 | `			}` |
|        - |  1753 | `			/* Install in the reference table */` |
|    60176 |  1754 | `			PH7_VmRefObjInstall(&(*pVm),nIdx,SyHashLastEntry(&pFrame->hVar),0,0);` |
|        - |  1755 | `			/* Save object index */` |
|    60176 |  1756 | `			pObj->nIdx = nIdx;` |
|    30089 |  1757 | `		}else{` |
|        - |  1758 | `			/* Extract variable contents */` |
|  2266576 |  1759 | `			nIdx = (sxu32)SX_PTR_TO_INT(pEntry->pUserData);` |
|  2266576 |  1760 | `			pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|  2266576 |  1761 | `			if( bNullify && pObj ){` |
...
|        - |  1775 | ` */` |
|     1234 |  1776 | `static ph7_value * VmExtractSuper(` |
...
|     1236 |  1786 | `	pEntry = SyHashGet(&pVm->hSuper,(const void *)zName,nByte);` |
|     1236 |  1787 | `	if( pEntry == 0 ){` |
|        - |  1788 | `		/* No such entry */` |
|      ! 0 |  1789 | `		return 0;` |
|        - |  1790 | `	}` |
|        - |  1791 | `	/* Extract the superglobal index in the global object pool */` |
|     1236 |  1792 | `	nIdx = SX_PTR_TO_INT(pEntry->pUserData);` |
|        - |  1793 | `	/* Extract the variable value  */` |
|     1236 |  1794 | `	pValue = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|     1236 |  1795 | `	return pValue;` |
|      619 |  1796 |  |
|        - |  1797 | `/*` |
|        - |  1798 | ` * Perform a raw hashmap insertion.` |
|        - |  1799 | ` * Refer to the [PH7_VmConfigure()] implementation for additional information.` |
|        - |  1800 | ` */` |
|     1232 |  1801 | `static sxi32 VmHashmapInsert(` |
...
|        - |  1810 | `	sxi32 rc;` |
|     1234 |  1811 | `	PH7_MemObjInitFromString(pMap->pVm,&sKey,0);` |
|     1234 |  1812 | `	PH7_MemObjInitFromString(pMap->pVm,&sValue,0);` |
|     1234 |  1813 | `	if( zKey ){` |
|     1212 |  1814 | `		if( nKeylen < 0 ){` |
|     1212 |  1815 | `			nKeylen = (int)SyStrlen(zKey);` |
|      605 |  1816 | `		}` |
|     1212 |  1817 | `		PH7_MemObjStringAppend(&sKey,zKey,(sxu32)nKeylen);` |
|      605 |  1818 | `	}` |
|     1234 |  1819 | `	if( zData ){` |
|     1234 |  1820 | `		if( nLen < 0 ){` |
...
|      ! 0 |  1823 | `		}` |
|     1234 |  1824 | `		PH7_MemObjStringAppend(&sValue,zData,(sxu32)nLen);` |
|      616 |  1825 | `	}` |
|        - |  1826 | `	/* Perform the insertion */` |
|     1234 |  1827 | `	rc = PH7_HashmapInsert(&(*pMap),&sKey,&sValue);` |
|     1234 |  1828 | `	PH7_MemObjRelease(&sKey);` |
|     1234 |  1829 | `	PH7_MemObjRelease(&sValue);` |
|     1234 |  1830 | `	return rc;` |
|        2 |  1831 |  |
...
|        - |  1846 | ` */` |
|    19352 |  1847 | `PH7_PRIVATE sxi32 PH7_VmConfigure(` |
|        - |  1848 | `	ph7_vm *pVm, /* Target VM */` |
|        - |  1849 | `	sxi32 nOp,   /* Configuration verb */` |
|        - |  1850 | `	va_list ap   /* Subsequent option arguments */` |
|        - |  1851 | `	)` |
|        2 |  1852 |  |
|    19354 |  1853 | `	sxi32 rc = SXRET_OK;` |
|    19354 |  1854 | `	switch(nOp){` |
|      604 |  1855 | `	case PH7_VM_CONFIG_OUTPUT: {` |
|     1210 |  1856 | `		ProcConsumer xConsumer = va_arg(ap,ProcConsumer);` |
|     1210 |  1857 | `		void *pUserData = va_arg(ap,void *);` |
...
|     1210 |  1866 | `		pVm->sVmConsumer.xConsumer = xConsumer;` |
|     1210 |  1867 | `		pVm->sVmConsumer.pUserData = pUserData;` |
|     1210 |  1868 | `		break;` |
|        - |  1869 | `							   }` |
|      604 |  1870 | `	case PH7_VM_CONFIG_IMPORT_PATH: {` |
|        - |  1871 | `		/* Import path */` |
|        - |  1872 | `		  const char *zPath;` |
|        - |  1873 | `		  SyString sPath;` |
|     1210 |  1874 | `		  zPath = va_arg(ap,const char *);` |
...
|        - |  1879 | `		  }` |
|        - |  1880 | `#endif` |
|     1210 |  1881 | `		  SyStringInitFromBuf(&sPath,zPath,SyStrlen(zPath));` |
|        - |  1882 | `		  /* Remove trailing slashes and backslashes */` |
|        - |  1883 | `#ifdef __WINNT__` |
|        2 |  1884 | `		  SyStringTrimTrailingChar(&sPath,'\\');` |
|        - |  1885 | `#endif` |
|     2418 |  1886 | `		  SyStringTrimTrailingChar(&sPath,'/');` |
|        - |  1887 | `		  /* Remove leading and trailing white spaces */` |
|     1210 |  1888 | `		  SyStringFullTrim(&sPath);` |
|     1210 |  1889 | `		  if( sPath.nByte > 0 ){` |
|        - |  1890 | `			  /* Store the path in the corresponding conatiner */` |
|     1210 |  1891 | `			  rc = SySetPut(&pVm->aPaths,(const void *)&sPath);` |
|      604 |  1892 | `		  }` |
|     1210 |  1893 | `		  break;` |
|        - |  1894 | `									 }` |
|      604 |  1895 | `	case PH7_VM_CONFIG_ERR_REPORT:` |
|        - |  1896 | `		/* Run-Time Error report */` |
|     1210 |  1897 | `		pVm->bErrReport = 1;` |
|     1210 |  1898 | `		break;` |
...
|        - |  1918 | `							   }` |
|        - |  1919 |  |
|     6040 |  1920 | `	case PH7_VM_CONFIG_CREATE_SUPER:` |
|        - |  1921 | `	case PH7_VM_CONFIG_CREATE_VAR: {` |
|        - |  1922 | `		/* Create a new superglobal/global variable */` |
|    12082 |  1923 | `		const char *zName = va_arg(ap,const char *);` |
|    12082 |  1924 | `		ph7_value *pValue = va_arg(ap,ph7_value *);` |
...
|        - |  1933 | `		}` |
|        - |  1934 | `#endif` |
|    12082 |  1935 | `		nByte = SyStrlen(zName);` |
|    12082 |  1936 | `		if( nOp == PH7_VM_CONFIG_CREATE_SUPER ){` |
|        - |  1937 | `			/* Check if the superglobal is already installed */` |
|    12082 |  1938 | `			pEntry = SyHashGet(&pVm->hSuper,(const void *)zName,nByte);` |
|     6042 |  1939 | `		}else{` |
|        - |  1940 | `			/* Query the top active VM frame */` |
|      ! 0 |  1941 | `			pEntry = SyHashGet(&pVm->pFrame->hVar,(const void *)zName,nByte);` |
|        - |  1942 | `		}` |
|    12082 |  1943 | `		if( pEntry ){` |
...
|    12082 |  1954 | `			pObj = PH7_ReserveMemObj(&(*pVm));` |
|    12082 |  1955 | `			if( pObj == 0 ){` |
|      ! 0 |  1956 | `				rc = SXERR_MEM;` |
|      ! 0 |  1957 | `				break;` |
|        - |  1958 | `			}` |
|    12082 |  1959 | `			nIdx = pObj->nIdx;` |
|        - |  1960 | `			/* Copy value */` |
|    12082 |  1961 | `			PH7_MemObjStore(pValue,pObj);` |
|    12082 |  1962 | `			if( nOp == PH7_VM_CONFIG_CREATE_SUPER ){` |
|        - |  1963 | `				/* Install the superglobal */` |
|    12082 |  1964 | `				rc = SyHashInsert(&pVm->hSuper,(const void *)zName,nByte,SX_INT_TO_PTR(nIdx));` |
|     6042 |  1965 | `			}else{` |
|        - |  1966 | `				/* Install in the current frame */` |
|      ! 0 |  1967 | `				rc = SyHashInsert(&pVm->pFrame->hVar,(const void *)zName,nByte,SX_INT_TO_PTR(nIdx));` |
|        - |  1968 | `			}` |
|    12082 |  1969 | `			if( rc == SXRET_OK ){` |
|        - |  1970 | `				SyHashEntry *pRef;` |
|    12082 |  1971 | `				if( nOp == PH7_VM_CONFIG_CREATE_SUPER ){` |
|    12082 |  1972 | `					pRef = SyHashLastEntry(&pVm->hSuper);` |
|     6042 |  1973 | `				}else{` |
|      ! 0 |  1974 | `					pRef = SyHashLastEntry(&pVm->pFrame->hVar);` |
|        - |  1975 | `				}` |
|        - |  1976 | `				/* Install in the reference table */` |
|    12082 |  1977 | `				PH7_VmRefObjInstall(&(*pVm),nIdx,pRef,0,0);` |
|    12082 |  1978 | `				if( nOp == PH7_VM_CONFIG_CREATE_SUPER \|\| pVm->pFrame->pParent == 0){` |
|        - |  1979 | `					/* Register in the $GLOBALS array */` |
|    12082 |  1980 | `					VmHashmapRefInsert(pVm->pGlobal,zName,nByte,nIdx);` |
|     6040 |  1981 | `				}` |
|     6040 |  1982 | `			}` |
|        - |  1983 | `		}` |
|    12082 |  1984 | `		break;` |
|        - |  1985 | `									}` |
|      605 |  1986 | `	case PH7_VM_CONFIG_SERVER_ATTR:` |
...
|     1210 |  2018 | `			pValue = VmExtractSuper(&(*pVm),"_SERVER",sizeof("_SERVER")-1);` |
|        - |  2019 | `		}` |
|     1212 |  2020 | `		if( pValue == 0 \|\| (pValue->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
|        - |  2021 | `			/* No such entry */` |
|      ! 0 |  2022 | `			rc = SXERR_NOTFOUND;` |
|      ! 0 |  2023 | `			break;` |
|        - |  2024 | `		}` |
|        - |  2025 | `		/* Point to the hashmap */` |
|     1212 |  2026 | `		pMap = (ph7_hashmap *)pValue->x.pOther;` |
|        - |  2027 | `		/* Perform the insertion */` |
|     1212 |  2028 | `		rc = VmHashmapInsert(pMap,zKey,-1,zValue,nLen);` |
|     1212 |  2029 | `		break;` |
|        - |  2030 | `								   }` |
...
|      ! 0 |  2078 | `		break;` |
|        - |  2079 | `								   }` |
|     1208 |  2080 | `	case PH7_VM_CONFIG_IO_STREAM: {` |
|        - |  2081 | `		/* Register an IO stream device */` |
|     2418 |  2082 | `		const ph7_io_stream *pStream = va_arg(ap,const ph7_io_stream *);` |
|        - |  2083 | `		/* Make sure we are dealing with a valid IO stream */` |
|     3624 |  2084 | `		if( pStream == 0 \|\| pStream->zName == 0 \|\| pStream->zName[0] == 0 \|\|` |
|     2418 |  2085 | `			pStream->xOpen == 0 \|\| pStream->xRead == 0 ){` |
|        - |  2086 | `				/* Invalid stream */` |
|      ! 0 |  2087 | `				rc = SXERR_INVALID;` |
|      ! 0 |  2088 | `				break;` |
|        - |  2089 | `		}` |
|     2418 |  2090 | `		if( pVm->pDefStream == 0 && SyStrnicmp(pStream->zName,"file",sizeof("file")-1) == 0 ){` |
|        - |  2091 | `			/* Make the 'file://' stream the defaut stream device */` |
|     1210 |  2092 | `			pVm->pDefStream = pStream;` |
|      604 |  2093 | `		}` |
|        - |  2094 | `		/* Insert in the appropriate container */` |
|     2418 |  2095 | `		rc = SySetPut(&pVm->aIOstream,(const void *)&pStream);` |
|     2418 |  2096 | `		break;` |
|        - |  2097 | `								  }` |
...
|        - |  2192 | ` */` |
|      214 |  2193 | `static sxi32 VmCallErrorHandler(ph7_vm *pVm,SyBlob *pMsg)` |
|        1 |  2194 |  |
|      215 |  2195 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|      215 |  2196 | `	sxi32 rc = SXRET_OK;` |
|        - |  2197 | `	/* Append a new line */` |
|        - |  2198 | `#ifdef __WINNT__` |
|        1 |  2199 | `	SyBlobAppend(pMsg,"\r\n",sizeof("\r\n")-1);` |
|        - |  2200 | `#else` |
|      214 |  2201 | `	SyBlobAppend(pMsg,"\n",sizeof(char));` |
|        - |  2202 | `#endif` |
|        - |  2203 | `	/* Invoke the output consumer callback */` |
|      215 |  2204 | `	rc = pCons->xConsumer(SyBlobData(pMsg),SyBlobLength(pMsg),pCons->pUserData);` |
|      215 |  2205 | `	if( pCons->xConsumer != VmObConsumer ){` |
|        - |  2206 | `		/* Increment output length */` |
|      215 |  2207 | `		pVm->nOutputLen += SyBlobLength(pMsg);` |
|      107 |  2208 | `	}` |
|      215 |  2209 | `	return rc;` |
|        1 |  2210 |  |
|        - |  2211 | `/*` |
...
|        - |  2214 | ` * information.` |
|        - |  2215 | ` */` |
|      110 |  2216 | `static sxi32 VmInvokeErrorHandler(ph7_vm *pVm, sxi32 iErr, const char *zMessage, sxi32 nLen, SyString *pFile, sxi32 iLine)` |
|        2 |  2217 |  |
|      112 |  2218 | `	if( ph7_value_is_callable(&pVm->aErrCB[1]) ){` |
|        - |  2219 | `		ph7_value apArg[4];` |
|        - |  2220 | `		ph7_value *apArgPtr[4];` |
|        - |  2221 | `		ph7_value sResult;` |
|        - |  2222 | `		SyString sErr;` |
|        - |  2223 | `		/* Prepare arguments */` |
|       33 |  2224 | `		PH7_MemObjInitFromInt(pVm,&apArg[0],iErr);` |
|        - |  2225 | `			/* use explicit message length to avoid reading past buffer */` |
|       33 |  2226 | `			SyStringInitFromBuf(&sErr,zMessage,nLen);` |
|       33 |  2227 | `			PH7_MemObjInitFromString(pVm,&apArg[1],&sErr);` |
|       33 |  2228 | `		if( pFile ){` |
|       33 |  2229 | `			SyStringInitFromBuf(&sErr,pFile->zString,pFile->nByte);` |
|       33 |  2230 | `			PH7_MemObjInitFromString(pVm,&apArg[2],&sErr);` |
|       17 |  2231 | `		}else{` |
|      ! 0 |  2232 | `			PH7_MemObjInit(pVm,&apArg[2]);` |
|        - |  2233 | `		}` |
|       33 |  2234 | `		PH7_MemObjInitFromInt(pVm,&apArg[3],iLine);` |
|       33 |  2235 | `		PH7_MemObjInit(pVm,&sResult);` |
|        - |  2236 | `		/* Set up pointer array */` |
|       33 |  2237 | `		apArgPtr[0] = &apArg[0];` |
|       33 |  2238 | `		apArgPtr[1] = &apArg[1];` |
|       33 |  2239 | `		apArgPtr[2] = &apArg[2];` |
|       33 |  2240 | `		apArgPtr[3] = &apArg[3];` |
|        - |  2241 | `		/* Call the handler */` |
|       33 |  2242 | `		PH7_VmCallUserFunction(pVm,&pVm->aErrCB[1],4,apArgPtr,&sResult);` |
|        - |  2243 | `		/* Check return value */` |
|       33 |  2244 | `		if( (sResult.iFlags & MEMOBJ_BOOL) == 0 ){` |
|      ! 0 |  2245 | `			PH7_MemObjToBool(&sResult);` |
|      ! 0 |  2246 | `		}` |
|        - |  2247 | `		/* Release */` |
|       33 |  2248 | `		PH7_MemObjRelease(&apArg[0]);` |
|       33 |  2249 | `		PH7_MemObjRelease(&apArg[1]);` |
|       33 |  2250 | `		PH7_MemObjRelease(&apArg[2]);` |
|       33 |  2251 | `		PH7_MemObjRelease(&apArg[3]);` |
|       33 |  2252 | `		PH7_MemObjRelease(&sResult);` |
...
|       33 |  2255 | `		return sResult.x.iVal == 0 ? TRUE : FALSE;` |
|        - |  2256 | `	}` |
|        - |  2257 | `	/* No handler, always call error handler */` |
|       79 |  2258 | `	return TRUE;` |
|       57 |  2259 |  |
|       78 |  2260 | `PH7_PRIVATE sxi32 PH7_VmThrowError(` |
...
|        - |  2265 | `	)` |
|        2 |  2266 |  |
|       80 |  2267 | `	SyBlob *pWorker = &pVm->sWorker;` |
|        - |  2268 | `	SyString *pFile;` |
|        - |  2269 | `	char *zErr;` |
|       80 |  2270 | `	sxi32 rc = SXRET_OK;` |
|       80 |  2271 | `	if( !pVm->bErrReport ){` |
|        - |  2272 | `		/* Don't bother reporting errors */` |
|        3 |  2273 | `		return SXRET_OK;` |
|        - |  2274 | `	}` |
|        - |  2275 | `	/* Reset the working buffer */` |
|       78 |  2276 | `	SyBlobReset(pWorker);` |
|        - |  2277 | `	/* Peek the processed file if available */` |
|       78 |  2278 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|       78 |  2279 | `	if( pFile ){` |
|        - |  2280 | `		/* Append file name */` |
|       78 |  2281 | `		SyBlobAppend(pWorker,pFile->zString,pFile->nByte);` |
|       78 |  2282 | `		SyBlobAppend(pWorker,(const void *)" ",sizeof(char));` |
|       38 |  2283 | `	}` |
...
|       78 |  2288 | `	zErr = "Error: ";` |
|       78 |  2289 | `	switch(iErr){` |
|       18 |  2290 | `	case PH7_CTX_WARNING:` |
|       38 |  2291 | `		zErr = "Warning: ";` |
|       38 |  2292 | `		break;` |
...
|       28 |  2298 | `		break;` |
|        - |  2299 | `	}` |
|       78 |  2300 | `	SyBlobAppend(pWorker,zErr,SyStrlen(zErr));` |
|       78 |  2301 | `	if( pFuncName ){` |
...
|       14 |  2305 | `	}` |
|       78 |  2306 | `	SyBlobAppend(pWorker,zMessage,SyStrlen(zMessage));` |
|        - |  2307 | `	/* Check for user error handler.  compute length of C string */` |
|       78 |  2308 | `	if( VmInvokeErrorHandler(pVm, iErr, zMessage, (sxi32)SyStrlen(zMessage), pFile, 0) ){` |
...
|        - |  2316 | ` * information.` |
|        - |  2317 | ` */` |
|       34 |  2318 | `static sxi32 VmThrowErrorAp(` |
...
|        - |  2324 | `	)` |
|        2 |  2325 |  |
|       36 |  2326 | `	SyBlob *pWorker = &pVm->sWorker;` |
|        - |  2327 | `	SyBlob sMsg;` |
|        - |  2328 | `	SyString *pFile;` |
|        - |  2329 | `	char *zErr;` |
|       36 |  2330 | `	sxi32 rc = SXRET_OK;` |
|       36 |  2331 | `	if( !pVm->bErrReport ){` |
|        - |  2332 | `		/* Don't bother reporting errors */` |
|      ! 0 |  2333 | `		return SXRET_OK;` |
|        - |  2334 | `	}` |
|        - |  2335 | `	/* Reset the working buffer */` |
|       36 |  2336 | `	SyBlobReset(pWorker);` |
|        - |  2337 | `	/* Peek the processed file if available */` |
|       36 |  2338 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|       36 |  2339 | `	if( pFile ){` |
|        - |  2340 | `		/* Append file name */` |
|       36 |  2341 | `		SyBlobAppend(pWorker,pFile->zString,pFile->nByte);` |
|       36 |  2342 | `		SyBlobAppend(pWorker,(const void *)" ",sizeof(char));` |
|       17 |  2343 | `	}` |
...
|       20 |  2357 | `		break;` |
|        - |  2358 | `	}` |
|       36 |  2359 | `	SyBlobAppend(pWorker,zErr,SyStrlen(zErr));` |
|       36 |  2360 | `	if( pFuncName ){` |
|        - |  2361 | `		/* Append function name first */` |
|       22 |  2362 | `		SyBlobAppend(pWorker,pFuncName->zString,pFuncName->nByte);` |
|       22 |  2363 | `		SyBlobAppend(pWorker,"(): ",sizeof("(): ")-1);` |
|       10 |  2364 | `	}` |
|        - |  2365 | `	/* Format the raw message */` |
|       36 |  2366 | `	SyBlobInit(&sMsg, &pVm->sAllocator);` |
|       36 |  2367 | `	SyBlobFormatAp(&sMsg,zFormat,ap);` |
|        - |  2368 | `	/* Check if a user error handler is installed */` |
|       36 |  2369 | `	if( VmInvokeErrorHandler(pVm, iErr, (const char *)SyBlobData(&sMsg), (sxi32)SyBlobLength(&sMsg), pFile, 0) ){` |
...
|        - |  2400 | ` * ------------------------------------` |
|        - |  2401 | ` */` |
|       20 |  2402 | `PH7_PRIVATE sxi32 PH7_VmThrowErrorAp(ph7_vm *pVm,SyString *pFuncName,sxi32 iErr,const char *zFormat,va_list ap)` |
|        2 |  2403 |  |
|        - |  2404 | `	sxi32 rc;` |
|       22 |  2405 | `	rc = VmThrowErrorAp(&(*pVm),&(*pFuncName),iErr,zFormat,ap);` |
|       22 |  2406 | `	return rc;` |
|        2 |  2407 |  |
|        - |  2408 | `/*` |
|        - |  2409 | ` * Resolve function context from the current frame.` |
|        - |  2410 | ` */` |
|      272 |  2411 | `static void VmGetFrameContext(ph7_vm *pVm,const char **pzFuncName,int *pnFuncLen)` |
|        1 |  2412 |  |
|        - |  2413 | `	VmFrame *pFrame;` |
|        - |  2414 | `	ph7_vm_func *pFunc;` |
|      273 |  2415 | `	*pzFuncName = 0;` |
|      273 |  2416 | `	*pnFuncLen = 0;` |
|      273 |  2417 | `	pFrame = pVm->pFrame;` |
|      273 |  2418 | `	if( pFrame == 0 ){` |
|      ! 0 |  2419 | `		return;` |
|        - |  2420 | `	}` |
|      273 |  2421 | `	while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|      ! 0 |  2422 | `		pFrame = pFrame->pParent;` |
|      ! 0 |  2423 | `	}` |
|      273 |  2424 | `	if( pFrame->pParent == 0 ){` |
|      273 |  2425 | `		return;` |
|        - |  2426 | `	}` |
...
|        - |  2436 | ` */` |
|      136 |  2437 | `static sxi32 VmReportUncaughtException(ph7_vm *pVm,const char *zClass,sxu32 nClass,const char *zMsg,sxu32 nMsg,const char *zFuncName,int nFuncLen)` |
|        1 |  2438 |  |
|        - |  2439 | `	SyBlob sOut;` |
|        - |  2440 | `	SyString *pFile;` |
|      137 |  2441 | `	if( !pVm->bErrReport ){` |
|      ! 0 |  2442 | `		return PH7_OK;` |
|        - |  2443 | `	}` |
|      137 |  2444 | `	if( zClass == 0 \|\| nClass == 0 ){` |
...
|      ! 0 |  2451 | `	}` |
|      137 |  2452 | `	if( zFuncName == 0 \|\| nFuncLen <= 0 ){` |
|      137 |  2453 | `		VmGetFrameContext(pVm,&zFuncName,&nFuncLen);` |
|       68 |  2454 | `	}` |
|      137 |  2455 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|      137 |  2456 | `	SyBlobInit(&sOut,&pVm->sAllocator);` |
|      137 |  2457 | `	SyBlobAppend(&sOut,"PHP Fatal error:  Uncaught ",sizeof("PHP Fatal error:  Uncaught ")-1);` |
|      137 |  2458 | `	SyBlobAppend(&sOut,zClass,nClass);` |
|      137 |  2459 | `	SyBlobAppend(&sOut,": ",sizeof(": ")-1);` |
|      137 |  2460 | `	SyBlobAppend(&sOut,zMsg,nMsg);` |
|      137 |  2461 | `	if( pFile ){` |
|      137 |  2462 | `		SyBlobAppend(&sOut," in ",sizeof(" in ")-1);` |
|      137 |  2463 | `		SyBlobAppend(&sOut,pFile->zString,pFile->nByte);` |
|      137 |  2464 | `		SyBlobAppend(&sOut,":1",sizeof(":1")-1);` |
|       68 |  2465 | `	}` |
|      137 |  2466 | `	SyBlobAppend(&sOut,"\nStack trace:\n",sizeof("\nStack trace:\n")-1);` |
|      137 |  2467 | `	if( pFile ){` |
|      137 |  2468 | `		SyBlobAppend(&sOut,"#0 ",sizeof("#0 ")-1);` |
|      137 |  2469 | `		SyBlobAppend(&sOut,pFile->zString,pFile->nByte);` |
|      137 |  2470 | `		if( zFuncName && nFuncLen > 0 ){` |
|      ! 0 |  2471 | `			SyBlobFormat(&sOut,"(1): %.*s()\n",nFuncLen,zFuncName);` |
|      ! 0 |  2472 | `		}else{` |
|      137 |  2473 | `			SyBlobAppend(&sOut,"(1): {main}\n",sizeof("(1): {main}\n")-1);` |
|        1 |  2474 | `		}` |
|       68 |  2475 | `	}else if( zFuncName && nFuncLen > 0 ){` |
|      ! 0 |  2476 | `		SyBlobFormat(&sOut,"#0 [internal function]: %.*s()\n",nFuncLen,zFuncName);` |
|      ! 0 |  2477 | `	}else{` |
|      ! 0 |  2478 | `		SyBlobAppend(&sOut,"#0 {main}\n",sizeof("#0 {main}\n")-1);` |
|        - |  2479 | `	}` |
|      137 |  2480 | `	SyBlobAppend(&sOut,"#1 {main}",sizeof("#1 {main}")-1);` |
|      137 |  2481 | `	if( pFile ){` |
|      137 |  2482 | `		SyBlobAppend(&sOut,"\n",sizeof("\n")-1);` |
|      137 |  2483 | `		SyBlobAppend(&sOut,"  thrown in ",sizeof("  thrown in ")-1);` |
|      137 |  2484 | `		SyBlobAppend(&sOut,pFile->zString,pFile->nByte);` |
|      137 |  2485 | `		SyBlobAppend(&sOut," on line 1",sizeof(" on line 1")-1);` |
|       68 |  2486 | `	}` |
|      137 |  2487 | `	VmCallErrorHandler(pVm,&sOut);` |
|      137 |  2488 | `	SyBlobRelease(&sOut);` |
|      137 |  2489 | `	return PH7_ABORT;` |
|       69 |  2490 |  |
|        - |  2491 | `/*` |
|        - |  2492 | ` * Throw an internal exception instance that can be intercepted by try/catch.` |
|        - |  2493 | ` */` |
|      136 |  2494 | `PH7_PRIVATE sxi32 PH7_VmThrowException(ph7_context *pCtx,const char *zClass,const char *zFormat,...)` |
|        2 |  2495 |  |
|        - |  2496 | `	ph7_vm *pVm;` |
...
|        - |  2506 | `	sxi32 rc;` |
|        - |  2507 |  |
|      138 |  2508 | `	if( pCtx == 0 \|\| pCtx->pVm == 0 ){` |
|      ! 0 |  2509 | `		return PH7_ABORT;` |
|        - |  2510 | `	}` |
|      138 |  2511 | `	pVm = pCtx->pVm;` |
|      138 |  2512 | `	if( zClass == 0 \|\| zClass[0] == 0 ){` |
|      ! 0 |  2513 | `		zClass = "Error";` |
|      ! 0 |  2514 | `	}` |
|      138 |  2515 | `	pClass = PH7_VmExtractClass(&(*pVm),zClass,SyStrlen(zClass),TRUE,0);` |
|      138 |  2516 | `	if( pClass == 0 ){` |
|      ! 0 |  2517 | `		return PH7_VmThrowExceptionTrace(pCtx,zClass,` |
|        - |  2518 | `			"Cannot throw internal exception, class '%s' is not available",` |
|      ! 0 |  2519 | `			zClass` |
|        - |  2520 | `			);` |
|        - |  2521 | `	}` |
|      138 |  2522 | `	pThis = PH7_NewClassInstance(&(*pVm),pClass);` |
|      138 |  2523 | `	if( pThis == 0 ){` |
...
|        - |  2527 | `	}` |
|        - |  2528 |  |
|      138 |  2529 | `	SyBlobInit(&sMsg,&pVm->sAllocator);` |
|      138 |  2530 | `	va_start(ap,zFormat);` |
|      138 |  2531 | `	SyBlobFormatAp(&sMsg,zFormat,ap);` |
|      138 |  2532 | `	va_end(ap);` |
|        - |  2533 |  |
|      138 |  2534 | `	pCons = PH7_ClassExtractMethod(pClass,"__construct",sizeof("__construct")-1);` |
|      138 |  2535 | `	if( pCons ){` |
|      138 |  2536 | `		SyStringInitFromBuf(&sMsgStr,(const char *)SyBlobData(&sMsg),SyBlobLength(&sMsg));` |
|      138 |  2537 | `		PH7_MemObjInitFromString(&(*pVm),&sArg,&sMsgStr);` |
|      138 |  2538 | `		apArg[0] = &sArg;` |
|      138 |  2539 | `		PH7_VmCallClassMethod(&(*pVm),pThis,pCons,0,1,apArg);` |
|      138 |  2540 | `		PH7_MemObjRelease(&sArg);` |
|       68 |  2541 | `	}` |
|      138 |  2542 | `	SyBlobRelease(&sMsg);` |
|        - |  2543 |  |
|      138 |  2544 | `	pFrame = pVm->pFrame;` |
|      138 |  2545 | `	if( pFrame ){` |
|      140 |  2546 | `		while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|        3 |  2547 | `			pFrame = pFrame->pParent;` |
|        1 |  2548 | `		}` |
|      138 |  2549 | `		pFrame->iFlags \|= VM_FRAME_THROW;` |
|       68 |  2550 | `	}` |
|      138 |  2551 | `	rc = VmThrowException(&(*pVm),pThis);` |
|      138 |  2552 | `	PH7_ClassInstanceUnref(pThis);` |
|      138 |  2553 | `	if( rc == SXERR_ABORT ){` |
|      135 |  2554 | `		return PH7_ABORT;` |
|        - |  2555 | `	}` |
...
|        - |  2609 | ` */` |
|    21830 |  2610 | `static sxi32 VmByteCodeExec(` |
...
|    21832 |  2626 | `	SySetInit(&aArg,&pVm->sAllocator,sizeof(ph7_value *));` |
|    21832 |  2627 | `	if( nTos < 0 ){` |
|    21010 |  2628 | `		pTos = &pStack[-1];` |
|    10506 |  2629 | `	}else{` |
|      824 |  2630 | `		pTos = &pStack[nTos];` |
|        - |  2631 | `	}` |
|    21832 |  2632 | `	pc = 0;` |
|        - |  2633 | `	/* Execute as much as we can */` |
|  3782951 |  2634 | `	for(;;){` |
|        - |  2635 | `		/* Fetch the instruction to execute */` |
|  7565200 |  2636 | `		pInstr = &aInstr[pc];` |
|  7565200 |  2637 | `		rc = SXRET_OK;` |
|        - |  2638 | `/*` |
...
|        - |  2644 | ` */` |
|  7565200 |  2645 | `		switch(pInstr->iOp){` |
|        - |  2646 | `/*` |
|        - |  2647 | ` * DONE: P1 * *` |
|        - |  2648 | ` *` |
...
|        - |  2651 | ` */` |
|    10840 |  2652 | `case PH7_OP_DONE:` |
|    21682 |  2653 | `	if( pInstr->iP1 ){` |
|        - |  2654 | `#ifdef UNTRUST` |
|        - |  2655 | `		if( pTos < pStack ){` |
|        - |  2656 | `			goto Abort;` |
|        - |  2657 | `		}` |
|        - |  2658 | `#endif` |
|    11956 |  2659 | `		if( pLastRef ){` |
|     8198 |  2660 | `			*pLastRef = pTos->nIdx;` |
|     4098 |  2661 | `		}` |
|    11956 |  2662 | `		if( pResult ){` |
|        - |  2663 | `			/* Execution result */` |
|    11534 |  2664 | `			PH7_MemObjStore(pTos,pResult);` |
|     5766 |  2665 | `		}` |
|    11956 |  2666 | `		VmPopOperand(&pTos,1);` |
|    15705 |  2667 | `	}else if( pLastRef ){` |
|        - |  2668 | `		/* Nothing referenced */` |
|      508 |  2669 | `		*pLastRef = SXU32_HIGH;` |
|      253 |  2670 | `	}` |
|    21682 |  2671 | `	goto Done;` |
|        - |  2672 | `/*` |
|        - |  2673 | ` * HALT: P1 * *` |
|        - |  2674 | ` *` |
...
|        - |  2718 | ` */` |
|   168222 |  2719 | `case PH7_OP_JMP:` |
|   336490 |  2720 | `	pc = pInstr->iP2 - 1;` |
|   336490 |  2721 | `	break;` |
|        - |  2722 | `/*` |
|        - |  2723 | ` * JZ: P1 P2 *` |
|        - |  2724 | ` *` |
...
|   762436 |  2735 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|       77 |  2736 | `		PH7_MemObjToBool(pTos);` |
|       38 |  2737 | `	}` |
|   762436 |  2738 | `	if( !pTos->x.iVal ){` |
|        - |  2739 | `		/* Take the jump */` |
|   365236 |  2740 | `		pc = pInstr->iP2 - 1;` |
|   182617 |  2741 | `	}` |
|   762436 |  2742 | `	if( !pInstr->iP1 ){` |
|   597340 |  2743 | `		VmPopOperand(&pTos,1);` |
|   298691 |  2744 | `	}` |
|   762436 |  2745 | `	break;` |
|        - |  2746 | `/*` |
|        - |  2747 | ` * JNZ: P1 P2 *` |
...
|    72292 |  2759 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      ! 0 |  2760 | `		PH7_MemObjToBool(pTos);` |
|      ! 0 |  2761 | `	}` |
|    72292 |  2762 | `	if( pTos->x.iVal ){` |
|        - |  2763 | `		/* Take the jump */` |
|     3316 |  2764 | `		pc = pInstr->iP2 - 1;` |
|     1657 |  2765 | `	}` |
|    72292 |  2766 | `	if( !pInstr->iP1 ){` |
...
|        - |  2782 | ` */` |
|   302682 |  2783 | `case PH7_OP_POP: {` |
|   605410 |  2784 | `	sxi32 n = pInstr->iP1;` |
|   605410 |  2785 | `	if( &pTos[-n+1] < pStack ){` |
|        - |  2786 | `		/* TICKET 1433-51 Stack underflow must be handled at run-time */` |
|      ! 0 |  2787 | `		n = (sxi32)(pTos - pStack);` |
|      ! 0 |  2788 | `	}` |
|   605410 |  2789 | `	VmPopOperand(&pTos,n);` |
|   605410 |  2790 | `	break;` |
|        - |  2791 | `				 }` |
|        - |  2792 | `/*` |
|        - |  2793 | ` * CVT_INT: * * *` |
...
|        - |  2922 | ` */` |
|     9668 |  2923 | `case PH7_OP_ERR_CTRL:` |
|        - |  2924 | `	/*` |
...
|        - |  2976 | ` */` |
|   649189 |  2977 | `case PH7_OP_LOADC: {` |
|        - |  2978 | `	ph7_value *pObj;` |
|        - |  2979 | `	/* Reserve a room */` |
|  1298424 |  2980 | `	pTos++;` |
|  1298424 |  2981 | `	if( (pObj = (ph7_value *)SySetAt(&pVm->aLitObj,pInstr->iP2)) != 0 ){` |
|  1298424 |  2982 | `		if( pInstr->iP1 == 1 && SyBlobLength(&pObj->sBlob) <= 64 ){` |
|        - |  2983 | `			SyHashEntry *pEntry;` |
|        - |  2984 | `			/* Candidate for expansion via user defined callbacks */` |
|    13570 |  2985 | `			pEntry = SyHashGet(&pVm->hConstant,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|    13570 |  2986 | `			if( pEntry ){` |
|    11838 |  2987 | `				ph7_constant *pCons = (ph7_constant *)pEntry->pUserData;` |
|        - |  2988 | `				/* Set a NULL default value */` |
|    11838 |  2989 | `				MemObjSetType(pTos,MEMOBJ_NULL);` |
|    11838 |  2990 | `				SyBlobReset(&pTos->sBlob);` |
|        - |  2991 | `				/* Invoke the callback and deal with the expanded value */` |
|    11838 |  2992 | `				pCons->xExpand(pTos,pCons->pUserData);` |
|        - |  2993 | `				/* Mark as constant */` |
|    11838 |  2994 | `				pTos->nIdx = SXU32_HIGH;` |
|    11838 |  2995 | `				break;` |
|        - |  2996 | `			}` |
|      866 |  2997 | `		}` |
|  1286588 |  2998 | `		PH7_MemObjLoad(pObj,pTos);` |
|   643317 |  2999 | `	}else{` |
|        - |  3000 | `		/* Set a NULL value */` |
|      ! 0 |  3001 | `		MemObjSetType(pTos,MEMOBJ_NULL);` |
|        - |  3002 | `	}` |
|        - |  3003 | `	/* Mark as constant */` |
|  1286588 |  3004 | `	pTos->nIdx = SXU32_HIGH;` |
|  1286588 |  3005 | `	break;` |
|        - |  3006 | `				  }` |
|        - |  3007 | `/*` |
|        - |  3008 | ` * LOAD: P1 * P3` |
...
|        - |  3014 | ` */` |
|  1012496 |  3015 | `case PH7_OP_LOAD:{` |
|        - |  3016 | `	ph7_value *pObj;` |
|        - |  3017 | `	SyString sName;` |
|  2025214 |  3018 | `	if( pInstr->p3 == 0 ){` |
...
|       10 |  3030 | `	}else{` |
|  2025196 |  3031 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - |  3032 | `		/* Reserve a room for the target object */` |
|  2025196 |  3033 | `		pTos++;` |
|        - |  3034 | `	}` |
|        - |  3035 | `	/* Extract the requested memory object */` |
|  2025214 |  3036 | `	pObj = VmExtractMemObj(&(*pVm),&sName,pInstr->p3 ? FALSE : TRUE,pInstr->iP1 != 1);` |
|  2025214 |  3037 | `	if( pObj == 0 ){` |
|      474 |  3038 | `		if( pInstr->iP1 ){` |
|        - |  3039 | `			/* Variable not found,load NULL */` |
|      474 |  3040 | `			if( !pInstr->p3 ){` |
|      ! 0 |  3041 | `				PH7_MemObjRelease(pTos);` |
|      ! 0 |  3042 | `			}else{` |
|      474 |  3043 | `				MemObjSetType(pTos,MEMOBJ_NULL);` |
|        - |  3044 | `			}` |
|      474 |  3045 | `			pTos->nIdx = SXU32_HIGH; /* Mark as constant */` |
|  1012734 |  3046 | `			break;` |
|      ! 0 |  3047 | `		}else{` |
|        - |  3048 | `			/* Fatal error */` |
...
|  2024742 |  3054 | `	PH7_MemObjLoad(pObj,pTos);` |
|  2024742 |  3055 | `	pTos->nIdx = pObj->nIdx;` |
|  2024742 |  3056 | `	break;` |
|        - |  3057 | `				   }` |
|        - |  3058 | `/*` |
|        - |  3059 | ` * LOAD_MAP P1 * *` |
...
|        - |  3064 | ` */` |
|    13971 |  3065 | `case PH7_OP_LOAD_MAP: {` |
|        - |  3066 | `	ph7_hashmap *pMap;` |
|        - |  3067 | `	/* Allocate a new hashmap instance */` |
|    27944 |  3068 | `	pMap = PH7_NewHashmap(&(*pVm),0,0);` |
|    27944 |  3069 | `	if( pMap == 0 ){` |
...
|      ! 0 |  3072 | `		goto Abort;` |
|        - |  3073 | `	}` |
|    27944 |  3074 | `	if( pInstr->iP1 > 0 ){` |
|     1534 |  3075 | `		ph7_value *pEntry = &pTos[-pInstr->iP1+1]; /* Point to the first entry */` |
|        - |  3076 | `		/* Perform the insertion */` |
|     4408 |  3077 | `		while( pEntry < pTos ){` |
|     2876 |  3078 | `			if( pEntry[1].iFlags & MEMOBJ_REFERENCE ){` |
...
|     4172 |  3086 | `				PH7_HashmapInsert(pMap,` |
|     2780 |  3087 | `					(pEntry->iFlags & MEMOBJ_NULL) ? 0 /* Automatic index assign */ : pEntry,` |
|     1390 |  3088 | `					&pEntry[1]` |
|        - |  3089 | `				);` |
|        - |  3090 | `			}` |
...
|     1534 |  3095 | `		VmPopOperand(&pTos,pInstr->iP1);` |
|      766 |  3096 | `	}` |
|        - |  3097 | `	/* Push the hashmap */` |
|    27944 |  3098 | `	pTos++;` |
|    27944 |  3099 | `	pTos->nIdx = SXU32_HIGH;` |
|    27944 |  3100 | `	pTos->x.pOther = pMap;` |
|    27944 |  3101 | `	MemObjSetType(pTos,MEMOBJ_HASHMAP);` |
|    27944 |  3102 | `	break;` |
|        - |  3103 | `					  }` |
|        - |  3104 | `/*` |
|        - |  3105 | ` * LOAD_LIST: P1 * *` |
...
|        - |  3156 | ` * instead.` |
|        - |  3157 | ` */` |
|   154024 |  3158 | `case PH7_OP_LOAD_IDX: {` |
|   308094 |  3159 | `	ph7_hashmap_node *pNode = 0; /* cc warning */` |
|   308094 |  3160 | `	ph7_hashmap *pMap = 0;` |
|        - |  3161 | `	ph7_value *pIdx;` |
|   308094 |  3162 | `	pIdx = 0;` |
|   308094 |  3163 | `	if( pInstr->iP1 == 0 ){` |
...
|        - |  3178 | `		}` |
|      ! 0 |  3179 | `	}else{` |
|   308094 |  3180 | `		pIdx = pTos;` |
|   308094 |  3181 | `		pTos--;` |
|        - |  3182 | `	}` |
|   308094 |  3183 | `	if( pTos->iFlags & MEMOBJ_STRING ){` |
|        - |  3184 | `		/* String access */` |
|   238720 |  3185 | `		if( pIdx ){` |
|        - |  3186 | `			sxu32 nOfft;` |
|   238720 |  3187 | `			if( (pIdx->iFlags & MEMOBJ_INT) == 0 ){` |
|        - |  3188 | `				/* Force an int cast */` |
|      ! 0 |  3189 | `				PH7_MemObjToInteger(pIdx);` |
|      ! 0 |  3190 | `			}` |
|   238720 |  3191 | `			nOfft = (sxu32)pIdx->x.iVal;` |
|   238720 |  3192 | `			if( nOfft >= SyBlobLength(&pTos->sBlob) ){` |
|        - |  3193 | `				/* Invalid offset,load null */` |
|      ! 0 |  3194 | `				PH7_MemObjRelease(pTos);` |
|      ! 0 |  3195 | `			}else{` |
|   238720 |  3196 | `				const char *zData = (const char *)SyBlobData(&pTos->sBlob);` |
|   238720 |  3197 | `				int c = zData[nOfft];` |
|   238720 |  3198 | `				PH7_MemObjRelease(pTos);` |
|   238720 |  3199 | `				MemObjSetType(pTos,MEMOBJ_STRING);` |
|   238720 |  3200 | `				SyBlobAppend(&pTos->sBlob,(const void *)&c,sizeof(char));` |
|        - |  3201 | `			}` |
|   119383 |  3202 | `		}else{` |
...
|   238720 |  3206 | `		break;` |
|        - |  3207 | `	}` |
|    69376 |  3208 | `	if( pInstr->iP2 && (pTos->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
...
|      ! 0 |  3215 | `		}` |
|      ! 0 |  3216 | `	}` |
|    69376 |  3217 | `	rc = SXERR_NOTFOUND; /* Assume the index is invalid */` |
|    69376 |  3218 | `	if( pTos->iFlags & MEMOBJ_HASHMAP ){` |
|        - |  3219 | `		/* Point to the hashmap */` |
|    69376 |  3220 | `		pMap = (ph7_hashmap *)pTos->x.pOther;` |
|    69376 |  3221 | `		if( pIdx ){` |
|        - |  3222 | `			/* Load the desired entry */` |
|    69376 |  3223 | `			rc = PH7_HashmapLookup(pMap,pIdx,&pNode);` |
|    34687 |  3224 | `		}` |
|    69376 |  3225 | `		if( rc != SXRET_OK && pInstr->iP2 ){` |
...
|    34687 |  3233 | `	}` |
|    69376 |  3234 | `	if( pIdx ){` |
|    69376 |  3235 | `		PH7_MemObjRelease(pIdx);` |
|    34687 |  3236 | `	}` |
|    69376 |  3237 | `	if( rc == SXRET_OK ){` |
|        - |  3238 | `		/* Load entry contents */` |
|    33050 |  3239 | `		if( pMap->iRef < 2 ){` |
...
|        4 |  3245 | `		}else{` |
|    33044 |  3246 | `			pTos->nIdx = pNode->nValIdx;` |
|    33044 |  3247 | `			PH7_HashmapExtractNodeValue(pNode,pTos,FALSE);` |
|    33044 |  3248 | `			PH7_HashmapUnref(pMap);` |
|        - |  3249 | `		}` |
|    16526 |  3250 | `	}else{` |
|        - |  3251 | `		/* No such entry,load NULL */` |
|    36328 |  3252 | `		PH7_MemObjRelease(pTos);` |
|    36328 |  3253 | `		pTos->nIdx = SXU32_HIGH;` |
|        - |  3254 | `	}` |
|    69376 |  3255 | `	break;` |
|        - |  3256 | `					  }` |
|        - |  3257 | `/*` |
...
|        - |  3337 | `	}` |
|        - |  3338 | `#endif` |
|   169236 |  3339 | `	if( pInstr->iP2 ){` |
|        - |  3340 | `		sxu32 nIdx;` |
|        - |  3341 | `		/* Member store operation */` |
|     1148 |  3342 | `		nIdx = pTos->nIdx;` |
|     1148 |  3343 | `		VmPopOperand(&pTos,1);` |
|     1148 |  3344 | `		if( nIdx == SXU32_HIGH ){` |
...
|     1144 |  3350 | `			pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|     1144 |  3351 | `			if( pObj ){` |
|        - |  3352 | `				/* Perform the store operation */` |
|     1144 |  3353 | `				PH7_MemObjStore(pTos,pObj);` |
|      571 |  3354 | `			}` |
|        - |  3355 | `		}` |
|    85192 |  3356 | `		break;` |
|   168090 |  3357 | `	}else if( pInstr->p3 == 0 ){` |
...
|        - |  3392 | ` */` |
|    70264 |  3393 | `case PH7_OP_STORE_IDX:` |
|        - |  3394 | `case PH7_OP_STORE_IDX_REF: {` |
|   140530 |  3395 | `	ph7_hashmap *pMap = 0; /* cc  warning */` |
|        - |  3396 | `	ph7_value *pKey;` |
|        - |  3397 | `	sxu32 nIdx;` |
|   140530 |  3398 | `	if( pInstr->iP1 ){` |
|        - |  3399 | `		/* Key is next on stack */` |
|    51848 |  3400 | `		pKey = pTos;` |
|    51848 |  3401 | `		pTos--;` |
|    25925 |  3402 | `	}else{` |
|    88684 |  3403 | `		pKey = 0;` |
|        - |  3404 | `	}` |
|   140530 |  3405 | `	nIdx = pTos->nIdx;` |
|   140530 |  3406 | `	if( pTos->iFlags & MEMOBJ_HASHMAP ){` |
|        - |  3407 | `		/* Hashmap already loaded */` |
|   140478 |  3408 | `		pMap = (ph7_hashmap *)pTos->x.pOther;` |
|   140478 |  3409 | `		if( pMap->iRef < 2 ){` |
...
|        - |  3466 | `	}` |
|   140478 |  3467 | `	VmPopOperand(&pTos,1);` |
|        - |  3468 | `	/* Phase#2: Perform the insertion */` |
|   140478 |  3469 | `	if( pInstr->iOp == PH7_OP_STORE_IDX_REF && pTos->nIdx != SXU32_HIGH ){` |
|        - |  3470 | `		/* Insertion by reference */` |
|       13 |  3471 | `		PH7_HashmapInsertByRef(pMap,pKey,pTos->nIdx);` |
|        7 |  3472 | `	}else{` |
|   140466 |  3473 | `		PH7_HashmapInsert(pMap,pKey,pTos);` |
|        - |  3474 | `	}` |
|   140478 |  3475 | `	if( pKey ){` |
|    51798 |  3476 | `		PH7_MemObjRelease(pKey);` |
|    25898 |  3477 | `	}` |
|   140478 |  3478 | `	break;` |
|        - |  3479 | `					   }` |
|        - |  3480 | `/*` |
...
|        - |  3486 | ` */` |
|   116200 |  3487 | `case PH7_OP_INCR:` |
|        - |  3488 | `#ifdef UNTRUST` |
|        - |  3489 | `	if( pTos < pStack ){` |
|        - |  3490 | `		goto Abort;` |
|        - |  3491 | `	}` |
|        - |  3492 | `#endif` |
|   232446 |  3493 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) == 0 ){` |
|   232446 |  3494 | `		if( pTos->nIdx != SXU32_HIGH ){` |
|        - |  3495 | `			ph7_value *pObj;` |
|   232446 |  3496 | `			if( (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pTos->nIdx)) != 0 ){` |
|        - |  3497 | `				/* Force a numeric cast */` |
|   232446 |  3498 | `				PH7_MemObjToNumeric(pObj);` |
|   232446 |  3499 | `				if( pObj->iFlags & MEMOBJ_REAL ){` |
|      ! 0 |  3500 | `					pObj->rVal++;` |
|        - |  3501 | `					/* Try to get an integer representation */` |
|      ! 0 |  3502 | `					PH7_MemObjTryInteger(pTos);` |
|      ! 0 |  3503 | `				}else{` |
|   232446 |  3504 | `					pObj->x.iVal++;` |
|   232446 |  3505 | `					MemObjSetType(pTos,MEMOBJ_INT);` |
|        - |  3506 | `				}` |
|   232446 |  3507 | `				if( pInstr->iP1 ){` |
|        - |  3508 | `					/* Pre-icrement */` |
...
|    36346 |  3590 | `	PH7_MemObjToNumeric(pTos);` |
|    36346 |  3591 | `	if( pTos->iFlags & MEMOBJ_REAL ){` |
|       25 |  3592 | `		pTos->rVal = -pTos->rVal;` |
|       12 |  3593 | `	}` |
|    36346 |  3594 | `	if( pTos->iFlags & MEMOBJ_INT ){` |
|    36322 |  3595 | `		pTos->x.iVal = -pTos->x.iVal;` |
|    18160 |  3596 | `	}` |
|    36346 |  3597 | `	break;` |
|        - |  3598 | `/*` |
|        - |  3599 | ` * UPLUS: * * *` |
...
|    68224 |  3631 | `	if( (pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|       21 |  3632 | `		PH7_MemObjToBool(pTos);` |
|       10 |  3633 | `	}` |
|    68224 |  3634 | `	pTos->x.iVal = !pTos->x.iVal;` |
|    68224 |  3635 | `	break;` |
|        - |  3636 | `/*` |
|        - |  3637 | ` * OP_BITNOT: * * *` |
|        - |  3638 | ` *` |
...
|        - |  3761 | ` */` |
|      283 |  3762 | `case PH7_OP_SUB: {` |
|      567 |  3763 | `	ph7_value *pNos = &pTos[-1];` |
|        - |  3764 | `#ifdef UNTRUST` |
|        - |  3765 | `	if( pNos < pStack ){` |
|        - |  3766 | `		goto Abort;` |
|        - |  3767 | `	}` |
|        - |  3768 | `#endif` |
|      567 |  3769 | `	if( MEMOBJ_REAL & (pTos->iFlags\|pNos->iFlags) ){` |
|        - |  3770 | `		/* Floating point arithemic */` |
|        - |  3771 | `		ph7_real a,b,r;` |
|       73 |  3772 | `		if( (pTos->iFlags & MEMOBJ_REAL) == 0 ){` |
|      ! 0 |  3773 | `			PH7_MemObjToReal(pTos);` |
|      ! 0 |  3774 | `		}` |
|       73 |  3775 | `		if( (pNos->iFlags & MEMOBJ_REAL) == 0 ){` |
...
|       73 |  3782 | `		pNos->rVal = r;` |
|       73 |  3783 | `		MemObjSetType(pNos,MEMOBJ_REAL);` |
|        - |  3784 | `		/* Try to get an integer representation */` |
|       73 |  3785 | `		PH7_MemObjTryInteger(pNos);` |
|       37 |  3786 | `	}else{` |
...
|        - |  4236 | ` * back.` |
|        - |  4237 | ` */` |
|    52344 |  4238 | `case PH7_OP_CAT:{` |
|        - |  4239 | `	ph7_value *pNos,*pCur;` |
|   104690 |  4240 | `	if( pInstr->iP1 < 1 ){` |
|    78038 |  4241 | `		pNos = &pTos[-1];` |
|    39020 |  4242 | `	}else{` |
...
|   104690 |  4251 | `	if( (pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|      564 |  4252 | `		PH7_MemObjToString(pNos);` |
|      281 |  4253 | `	}` |
|   104690 |  4254 | `	pCur = &pNos[1];` |
|   210626 |  4255 | `	while( pCur <= pTos ){` |
|   105938 |  4256 | `		if( (pCur->iFlags & MEMOBJ_STRING) == 0 ){` |
|    50202 |  4257 | `			PH7_MemObjToString(pCur);` |
|    25100 |  4258 | `		}` |
|        - |  4259 | `		/* Perform the concatenation */` |
|   105938 |  4260 | `		if( SyBlobLength(&pCur->sBlob) > 0 ){` |
|   105900 |  4261 | `			PH7_MemObjStringAppend(pNos,(const char *)SyBlobData(&pCur->sBlob),SyBlobLength(&pCur->sBlob));` |
|    52949 |  4262 | `		}` |
|   105938 |  4263 | `		SyBlobRelease(&pCur->sBlob);` |
|   105938 |  4264 | `		pCur++;` |
|        2 |  4265 | `	}` |
|   104690 |  4266 | `	pTos = pNos;` |
|   104690 |  4267 | `	break;` |
|        - |  4268 | `				}` |
|        - |  4269 | `/*  CAT_STORE: * * *` |
|        - |  4270 | ` *` |
...
|        - |  4272 | ` * back.` |
|        - |  4273 | ` */` |
|     1640 |  4274 | `case PH7_OP_CAT_STORE:{` |
|     3281 |  4275 | `	ph7_value *pNos = &pTos[-1];` |
|        - |  4276 | `	ph7_value *pObj;` |
|        - |  4277 | `#ifdef UNTRUST` |
|        - |  4278 | `	if( pNos < pStack ){` |
|        - |  4279 | `		goto Abort;` |
|        - |  4280 | `	}` |
|        - |  4281 | `#endif` |
|     3281 |  4282 | `	if((pTos->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - |  4283 | `		/* Force a string cast */` |
|      ! 0 |  4284 | `		PH7_MemObjToString(pTos);` |
|      ! 0 |  4285 | `	}` |
|     3281 |  4286 | `	if((pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - |  4287 | `		/* Force a string cast */` |
|      ! 0 |  4288 | `		PH7_MemObjToString(pNos);` |
|      ! 0 |  4289 | `	}` |
|        - |  4290 | `	/* Perform the concatenation (Reverse order) */` |
|     3281 |  4291 | `	if( SyBlobLength(&pNos->sBlob) > 0 ){` |
|     3281 |  4292 | `		PH7_MemObjStringAppend(pTos,(const char *)SyBlobData(&pNos->sBlob),SyBlobLength(&pNos->sBlob));` |
|     1640 |  4293 | `	}` |
|        - |  4294 | `	/* Perform the store operation */` |
|     3281 |  4295 | `	if( pTos->nIdx == SXU32_HIGH ){` |
|      ! 0 |  4296 | `		PH7_VmThrowError(&(*pVm),0,PH7_CTX_ERR,"Cannot perform assignment on a constant class attribute");` |
|     3281 |  4297 | `	}else if( (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pTos->nIdx)) != 0 ){` |
|     3281 |  4298 | `		PH7_MemObjStore(pTos,pObj);` |
|     1640 |  4299 | `	}` |
|     3281 |  4300 | `	PH7_MemObjStore(pTos,pNos);` |
|     3281 |  4301 | `	VmPopOperand(&pTos,1);` |
|     3281 |  4302 | `	break;` |
|        - |  4303 | `				}` |
|        - |  4304 | `/* OP_AND: * * *` |
|        - |  4305 | ` *` |
...
|        - |  4314 | ` * stack.` |
|        - |  4315 | ` */` |
|    71626 |  4316 | `case PH7_OP_LAND:` |
|        - |  4317 | `case PH7_OP_LOR: {` |
|   143298 |  4318 | `	ph7_value *pNos = &pTos[-1];` |
...
|   143298 |  4326 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|        3 |  4327 | `		PH7_MemObjToBool(pTos);` |
|        1 |  4328 | `	}` |
|   143298 |  4329 | `	if((pNos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      ! 0 |  4330 | `		PH7_MemObjToBool(pNos);` |
|      ! 0 |  4331 | `	}` |
|   143298 |  4332 | `	v1 = pNos->x.iVal == 0 ? 1 : 0;` |
|   143298 |  4333 | `	v2 = pTos->x.iVal == 0 ? 1 : 0;` |
|   143298 |  4334 | `	if( pInstr->iOp == PH7_OP_LAND ){` |
|        - |  4335 | `		static const unsigned char and_logic[] = { 0, 1, 2, 1, 1, 1, 2, 1, 2 };` |
|    74322 |  4336 | `		v1 = and_logic[v1*3+v2];` |
|    37184 |  4337 | `	}else{` |
|        - |  4338 | `		static const unsigned char or_logic[] = { 0, 0, 0, 0, 1, 2, 0, 2, 2 };` |
|    68978 |  4339 | `		v1 = or_logic[v1*3+v2];` |
|        - |  4340 | `	}` |
|   143298 |  4341 | `	if( v1 == 2 ){` |
|      ! 0 |  4342 | `		v1 = 1;` |
|      ! 0 |  4343 | `	}` |
|   143298 |  4344 | `	VmPopOperand(&pTos,1);` |
|   143298 |  4345 | `	pTos->x.iVal = v1 == 0 ? 1 : 0;` |
|   143298 |  4346 | `	MemObjSetType(pTos,MEMOBJ_BOOL);` |
|   143298 |  4347 | `	break;` |
|        - |  4348 | `				 }` |
|        - |  4349 | `/* OP_LXOR: * * *` |
|        - |  4350 | ` *` |
...
|        - |  4394 | ` */` |
|     3204 |  4395 | `case PH7_OP_EQ:` |
|        - |  4396 | `case PH7_OP_NEQ: {` |
|     6410 |  4397 | `	ph7_value *pNos = &pTos[-1];` |
...
|        - |  4402 | `	}` |
|        - |  4403 | `#endif` |
|     6410 |  4404 | `	rc = PH7_MemObjCmp(pNos,pTos,FALSE,0);` |
|     6410 |  4405 | `	if( VmIsUnorderedCmp(pNos,pTos) ){` |
|       11 |  4406 | `		rc = pInstr->iOp == PH7_OP_EQ ? 0 : 1;` |
|     6405 |  4407 | `	}else if( pInstr->iOp == PH7_OP_EQ ){` |
|     6374 |  4408 | `		rc = rc == 0;` |
|     3188 |  4409 | `	}else{` |
|       28 |  4410 | `		rc = rc != 0;` |
|        - |  4411 | `	}` |
|     6410 |  4412 | `	VmPopOperand(&pTos,1);` |
|     6410 |  4413 | `	if( !pInstr->iP2 ){` |
|        - |  4414 | `		/* Push comparison result without taking the jump */` |
|     6410 |  4415 | `		PH7_MemObjRelease(pTos);` |
|     6410 |  4416 | `		pTos->x.iVal = rc;` |
|        - |  4417 | `		/* Invalidate any prior representation */` |
|     6410 |  4418 | `		MemObjSetType(pTos,MEMOBJ_BOOL);` |
|     3206 |  4419 | `	}else{` |
|      ! 0 |  4420 | `		if( rc ){` |
...
|        - |  4434 | ` */` |
|    95288 |  4435 | `case PH7_OP_TEQ: {` |
|   190578 |  4436 | `	ph7_value *pNos = &pTos[-1];` |
...
|        - |  4441 | `	}` |
|        - |  4442 | `#endif` |
|   190578 |  4443 | `	rc = PH7_MemObjCmp(pNos,pTos,TRUE,0);` |
|   190578 |  4444 | `	if( VmIsUnorderedCmp(pNos,pTos) ){` |
|        3 |  4445 | `		rc = 0;` |
|        2 |  4446 | `	}else{` |
|   190576 |  4447 | `		rc = rc == 0;` |
|        - |  4448 | `	}` |
|   190578 |  4449 | `	VmPopOperand(&pTos,1);` |
|   190578 |  4450 | `	if( !pInstr->iP2 ){` |
|        - |  4451 | `		/* Push comparison result without taking the jump */` |
|   190578 |  4452 | `		PH7_MemObjRelease(pTos);` |
|   190578 |  4453 | `		pTos->x.iVal = rc;` |
|        - |  4454 | `		/* Invalidate any prior representation */` |
|   190578 |  4455 | `		MemObjSetType(pTos,MEMOBJ_BOOL);` |
|    95290 |  4456 | `	}else{` |
|      ! 0 |  4457 | `		if( rc ){` |
...
|        - |  4472 | ` *` |
|        - |  4473 | ` */` |
|    75412 |  4474 | `case PH7_OP_TNE: {` |
|   150826 |  4475 | `	ph7_value *pNos = &pTos[-1];` |
...
|        - |  4480 | `	}` |
|        - |  4481 | `#endif` |
|   150826 |  4482 | `	rc = PH7_MemObjCmp(pNos,pTos,TRUE,0);` |
|   150826 |  4483 | `	if( VmIsUnorderedCmp(pNos,pTos) ){` |
|        3 |  4484 | `		rc = 1;` |
|        2 |  4485 | `	}else{` |
|   150824 |  4486 | `		rc = rc != 0;` |
|        - |  4487 | `	}` |
|   150826 |  4488 | `	VmPopOperand(&pTos,1);` |
|   150826 |  4489 | `	if( !pInstr->iP2 ){` |
|        - |  4490 | `		/* Push comparison result without taking the jump */` |
|   150826 |  4491 | `		PH7_MemObjRelease(pTos);` |
|   150826 |  4492 | `		pTos->x.iVal = rc;` |
|        - |  4493 | `		/* Invalidate any prior representation */` |
|   150826 |  4494 | `		MemObjSetType(pTos,MEMOBJ_BOOL);` |
|    75414 |  4495 | `	}else{` |
|      ! 0 |  4496 | `		if( rc ){` |
...
|        - |  4520 | ` *` |
|        - |  4521 | ` */` |
|    83820 |  4522 | `case PH7_OP_LT:` |
|        - |  4523 | `case PH7_OP_LE: {` |
|   167686 |  4524 | `	ph7_value *pNos = &pTos[-1];` |
...
|        - |  4529 | `	}` |
|        - |  4530 | `#endif` |
|   167686 |  4531 | `	rc = PH7_MemObjCmp(pNos,pTos,FALSE,0);` |
|   167686 |  4532 | `	if( VmIsUnorderedCmp(pNos,pTos) ){` |
|        9 |  4533 | `		rc = 0;` |
|   167682 |  4534 | `	}else if( pInstr->iOp == PH7_OP_LE ){` |
|      395 |  4535 | `		rc = rc < 1;` |
|      198 |  4536 | `	}else{` |
|   167284 |  4537 | `		rc = rc < 0;` |
|        - |  4538 | `	}` |
|   167686 |  4539 | `	VmPopOperand(&pTos,1);` |
|   167686 |  4540 | `	if( !pInstr->iP2 ){` |
|        - |  4541 | `		/* Push comparison result without taking the jump */` |
|   167686 |  4542 | `		PH7_MemObjRelease(pTos);` |
|   167686 |  4543 | `		pTos->x.iVal = rc;` |
|        - |  4544 | `		/* Invalidate any prior representation */` |
|   167686 |  4545 | `		MemObjSetType(pTos,MEMOBJ_BOOL);` |
|    83866 |  4546 | `	}else{` |
|      ! 0 |  4547 | `		if( rc ){` |
...
|        - |  4571 | ` *` |
|        - |  4572 | ` */` |
|    32236 |  4573 | `case PH7_OP_GT:` |
|        - |  4574 | `case PH7_OP_GE: {` |
|    64474 |  4575 | `	ph7_value *pNos = &pTos[-1];` |
...
|        - |  4580 | `	}` |
|        - |  4581 | `#endif` |
|    64474 |  4582 | `	rc = PH7_MemObjCmp(pNos,pTos,FALSE,0);` |
|    64474 |  4583 | `	if( VmIsUnorderedCmp(pNos,pTos) ){` |
|        9 |  4584 | `		rc = 0;` |
|    64470 |  4585 | `	}else if( pInstr->iOp == PH7_OP_GE ){` |
|    64318 |  4586 | `		rc = rc >= 0;` |
|    32160 |  4587 | `	}else{` |
|      150 |  4588 | `		rc = rc > 0;` |
|        - |  4589 | `	}` |
|    64474 |  4590 | `	VmPopOperand(&pTos,1);` |
|    64474 |  4591 | `	if( !pInstr->iP2 ){` |
|        - |  4592 | `		/* Push comparison result without taking the jump */` |
|    64474 |  4593 | `		PH7_MemObjRelease(pTos);` |
|    64474 |  4594 | `		pTos->x.iVal = rc;` |
|        - |  4595 | `		/* Invalidate any prior representation */` |
|    64474 |  4596 | `		MemObjSetType(pTos,MEMOBJ_BOOL);` |
|    32238 |  4597 | `	}else{` |
|      ! 0 |  4598 | `		if( rc ){` |
...
|        - |  4895 | ` */` |
|     3709 |  4896 | `case PH7_OP_FOREACH_INIT: {` |
|     7420 |  4897 | `	ph7_foreach_info *pInfo = (ph7_foreach_info *)pInstr->p3;` |
|        - |  4898 | `	void *pName;` |
|        - |  4899 | `#ifdef UNTRUST` |
|        - |  4900 | `	if( pTos < pStack ){` |
|        - |  4901 | `		goto Abort;` |
|        - |  4902 | `	}` |
|        - |  4903 | `#endif` |
|     7420 |  4904 | `	if( SyStringLength(&pInfo->sValue) < 1 ){` |
...
|      ! 0 |  4916 | `	}` |
|     7420 |  4917 | `	if( (pInfo->iFlags & PH7_4EACH_STEP_KEY) && SyStringLength(&pInfo->sKey) < 1 ){` |
...
|     7420 |  4930 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ)) == 0 \|\| SyStringLength(&pInfo->sValue) < 1 ){` |
...
|     7420 |  4938 | `		pStep = (ph7_foreach_step *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_foreach_step));` |
|     7420 |  4939 | `		if( pStep == 0 ){` |
...
|     7420 |  4945 | `			SyZero(pStep,sizeof(ph7_foreach_step));` |
|        - |  4946 | `			/* Prepare the step */` |
|     7420 |  4947 | `			pStep->iFlags = pInfo->iFlags;` |
|     7420 |  4948 | `			if( pTos->iFlags & MEMOBJ_HASHMAP ){` |
|     7412 |  4949 | `				ph7_hashmap *pMap = (ph7_hashmap *)pTos->x.pOther;` |
|        - |  4950 | `				/* Reset the internal loop cursor */` |
|     7412 |  4951 | `				PH7_HashmapResetLoopCursor(pMap);` |
|        - |  4952 | `				/* Mark the step */` |
|     7412 |  4953 | `				pStep->iFlags \|= PH7_4EACH_STEP_HASHMAP;` |
|     7412 |  4954 | `				pStep->xIter.pMap = pMap;` |
|     7412 |  4955 | `				pMap->iRef++;` |
|     3707 |  4956 | `			}else{` |
...
|        - |  4964 | `			}` |
|        - |  4965 | `		}` |
|     7420 |  4966 | `		if( SXRET_OK != SySetPut(&pInfo->aStep,(const void *)&pStep) ){` |
...
|        - |  4979 | ` */` |
|    61766 |  4980 | `case PH7_OP_FOREACH_STEP: {` |
|   123534 |  4981 | `	ph7_foreach_info *pInfo = (ph7_foreach_info *)pInstr->p3;` |
|        - |  4982 | `	ph7_foreach_step **apStep,*pStep;` |
|        - |  4983 | `	ph7_value *pValue;` |
|        - |  4984 | `	VmFrame *pFrameLocal;` |
|        - |  4985 | `	/* Peek the last step */` |
|   123534 |  4986 | `	apStep = (ph7_foreach_step **)SySetBasePtr(&pInfo->aStep);` |
|   123534 |  4987 | `	pStep = apStep[SySetUsed(&pInfo->aStep) - 1];` |
|   123534 |  4988 | `	pFrameLocal = pVm->pFrame;` |
|   128566 |  4989 | `	while( pFrameLocal->pParent && (pFrameLocal->iFlags & VM_FRAME_EXCEPTION) ){` |
|        - |  4990 | `		/* Safely ignore the exception frame */` |
|     5033 |  4991 | `		pFrameLocal = pFrameLocal->pParent;` |
|        1 |  4992 | `	}` |
|   123534 |  4993 | `	if( pStep->iFlags & PH7_4EACH_STEP_HASHMAP ){` |
|   123510 |  4994 | `		ph7_hashmap *pMap = pStep->xIter.pMap;` |
|        - |  4995 | `		ph7_hashmap_node *pNode;` |
|        - |  4996 | `		/* Extract the current node value */` |
|   123510 |  4997 | `		pNode = PH7_HashmapGetNextEntry(pMap);` |
|   123510 |  4998 | `		if( pNode == 0 ){` |
|        - |  4999 | `			/* No more entry to process */` |
|     7412 |  5000 | `			pc = pInstr->iP2 - 1; /* Jump to this destination */` |
|     7412 |  5001 | `			if( pStep->iFlags & PH7_4EACH_STEP_REF ){` |
...
|     7412 |  5006 | `			PH7_HashmapResetLoopCursor(pMap);` |
|        - |  5007 | `			/* Cleanup the mess left behind */` |
|     7412 |  5008 | `			SyMemBackendPoolFree(&pVm->sAllocator,pStep);` |
|     7412 |  5009 | `			SySetPop(&pInfo->aStep);` |
|     7412 |  5010 | `			PH7_HashmapUnref(pMap);` |
|     3707 |  5011 | `		}else{` |
|   116100 |  5012 | `			if( (pStep->iFlags & PH7_4EACH_STEP_KEY) && SyStringLength(&pInfo->sKey) > 0 ){` |
|      139 |  5013 | `				ph7_value *pKey = VmExtractMemObj(&(*pVm),&pInfo->sKey,FALSE,TRUE);` |
|      139 |  5014 | `				if( pKey ){` |
|      139 |  5015 | `					PH7_HashmapExtractNodeKey(pNode,pKey);` |
|       69 |  5016 | `				}` |
|       69 |  5017 | `			}` |
|   116100 |  5018 | `			if( pStep->iFlags & PH7_4EACH_STEP_REF ){` |
...
|   116088 |  5030 | `				pValue = VmExtractMemObj(&(*pVm),&pInfo->sValue,FALSE,TRUE);` |
|   116088 |  5031 | `				if( pValue ){` |
|   116088 |  5032 | `					PH7_HashmapExtractNodeValue(pNode,pValue,TRUE);` |
|    58043 |  5033 | `				}` |
|        - |  5034 | `			}` |
|        - |  5035 | `		}` |
|    61756 |  5036 | `	}else{` |
...
|        - |  5098 | ` */` |
|      822 |  5099 | `case PH7_OP_MEMBER: {` |
|        - |  5100 | `	ph7_class_instance *pThis;` |
|        - |  5101 | `	ph7_value *pNos;` |
|        - |  5102 | `	SyString sName;` |
|     1646 |  5103 | `	if( !pInstr->iP1 ){` |
|     1588 |  5104 | `		pNos = &pTos[-1];` |
|        - |  5105 | `#ifdef UNTRUST` |
|        - |  5106 | `		if( pNos < pStack ){` |
|        - |  5107 | `			goto Abort;` |
|        - |  5108 | `		}` |
|        - |  5109 | `#endif` |
|     1588 |  5110 | `		if( pNos->iFlags & MEMOBJ_OBJ ){` |
|        - |  5111 | `			ph7_class *pClass;` |
|        - |  5112 | `			/* Class already instantiated */` |
|     1588 |  5113 | `			pThis = (ph7_class_instance *)pNos->x.pOther;` |
|        - |  5114 | `			/* Point to the instantiated class */` |
|     1588 |  5115 | `			pClass = pThis->pClass;` |
|        - |  5116 | `			/* Extract attribute name first */` |
|     1588 |  5117 | `			SyStringInitFromBuf(&sName,(const char *)SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
|     1588 |  5118 | `			if( pInstr->iP2 ){` |
|        - |  5119 | `				/* Method call */` |
...
|     1470 |  5143 | `				VmClassAttr *pObjAttr = 0;` |
|        - |  5144 | `				SyHashEntry *pEntry;` |
|        - |  5145 | `				/* Extract the target attribute */` |
|     1470 |  5146 | `				if( sName.nByte > 0 ){` |
|     1470 |  5147 | `					pEntry = SyHashGet(&pThis->hAttr,(const void *)sName.zString,sName.nByte);` |
|     1470 |  5148 | `					if( pEntry ){` |
|        - |  5149 | `						/* Point to the attribute value */` |
|     1468 |  5150 | `						pObjAttr = (VmClassAttr *)pEntry->pUserData;` |
|      733 |  5151 | `					}` |
|      734 |  5152 | `				}` |
|     1470 |  5153 | `				if( pObjAttr == 0 ){` |
...
|        - |  5164 | `				 */` |
|     1470 |  5165 | `				pThis->iRef++;` |
|     1470 |  5166 | `				PH7_MemObjRelease(pTos);` |
|     1470 |  5167 | `				pTos->nIdx = SXU32_HIGH; /* Assume we are loading a constant */` |
|     1470 |  5168 | `				if( pObjAttr ){` |
|     1468 |  5169 | `					ph7_value *pValue = 0; /* cc warning */` |
|        - |  5170 | `					/* Check attribute access */` |
|     1468 |  5171 | `					if( VmClassMemberAccess(&(*pVm),pClass,&pObjAttr->pAttr->sName,pObjAttr->pAttr->iProtection,TRUE) ){` |
|        - |  5172 | `						/* Load attribute */` |
|     1468 |  5173 | `						pValue = (ph7_value *)SySetAt(&pVm->aMemObj,pObjAttr->nIdx);` |
|     1468 |  5174 | `						if( pValue ){` |
|     1468 |  5175 | `							if( pThis->iRef < 2 ){` |
...
|        2 |  5180 | `							}else{` |
|        - |  5181 | `								/* Simple load */` |
|     1466 |  5182 | `								PH7_MemObjLoad(pValue,pTos);` |
|        - |  5183 | `							}` |
|     1468 |  5184 | `							if( (pObjAttr->pAttr->iFlags & PH7_CLASS_ATTR_CONSTANT) == 0 ){` |
|     1466 |  5185 | `								if( pThis->iRef > 1 ){` |
|        - |  5186 | `									/* Load attribute index */` |
|     1464 |  5187 | `									pTos->nIdx = pObjAttr->nIdx;` |
|      731 |  5188 | `								}` |
|      732 |  5189 | `							}` |
|      733 |  5190 | `						}` |
|      733 |  5191 | `					}` |
...
|     1470 |  5194 | `				PH7_ClassInstanceUnref(pThis);` |
|        - |  5195 | `			}` |
|      795 |  5196 | `		}else{` |
...
|        - |  5520 | ` */` |
|   226655 |  5521 | `case PH7_OP_CALL: {` |
|   453356 |  5522 | `	ph7_value *pArg = &pTos[-pInstr->iP1];` |
|        - |  5523 | `	SyHashEntry *pEntry;` |
|        - |  5524 | `	SyString sName;` |
|        - |  5525 | `	/* Extract function name */` |
|   453356 |  5526 | `	if( (pTos->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|   226587 |  5561 | `		break;` |
|        - |  5562 | `	}` |
|   453354 |  5563 | `	SyStringInitFromBuf(&sName,SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
|        - |  5564 | `	/* Check for a compiled function first */` |
|   453354 |  5565 | `	pEntry = SyHashGet(&pVm->hFunction,(const void *)sName.zString,sName.nByte);` |
|   453354 |  5566 | `	if( pEntry ){` |
...
|     8706 |  5577 | `		pVmFunc = (ph7_vm_func *)pEntry->pUserData;` |
|     8706 |  5578 | `		pThis = 0;` |
|     8706 |  5579 | `		pSelf = 0;` |
|     8706 |  5580 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
|        - |  5581 | `			ph7_class_method *pMeth;` |
|        - |  5582 | `			/* Class method call */` |
|      618 |  5583 | `			ph7_value *pTarget = &pTos[-1];` |
|      618 |  5584 | `			if( pTarget >= pStack && (pTarget->iFlags & (MEMOBJ_STRING\|MEMOBJ_OBJ\|MEMOBJ_NULL)) ){` |
|        - |  5585 | `				/* Extract the 'this' pointer */` |
|      618 |  5586 | `				if(pTarget->iFlags & MEMOBJ_OBJ ){` |
|        - |  5587 | `					/* Instance already loaded */` |
|      588 |  5588 | `					pThis = (ph7_class_instance *)pTarget->x.pOther;` |
|      588 |  5589 | `					pThis->iRef++;` |
|      588 |  5590 | `					pSelf = pThis->pClass;` |
|      293 |  5591 | `				}` |
|      618 |  5592 | `				if( pSelf == 0 ){` |
...
|        9 |  5614 | `					}` |
|       15 |  5615 | `				}` |
|      618 |  5616 | `				VmPopOperand(&pTos,1);` |
|      618 |  5617 | `				PH7_MemObjRelease(pTos);` |
|        - |  5618 | `				/* Synchronize pointers */` |
|      618 |  5619 | `				pArg = &pTos[-pInstr->iP1];` |
...
|        - |  5624 | `				 */` |
|      618 |  5625 | `				while( pArg < pStack ){` |
|      ! 0 |  5626 | `					pArg++;` |
|      ! 0 |  5627 | `				}` |
|      618 |  5628 | `				if( pSelf ){ /* Paranoid edition */` |
|        - |  5629 | `					/* Check if the call is allowed */` |
|      618 |  5630 | `					pMeth = PH7_ClassExtractMethod(pSelf,pVmFunc->sName.zString,pVmFunc->sName.nByte);` |
|      618 |  5631 | `					if( pMeth && pMeth->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|     8706 |  5646 | `		if( pVm->nRecursionDepth > pVm->nMaxDepth ){` |
...
|        3 |  5656 | `			break;` |
|        - |  5657 | `		}` |
|     8704 |  5658 | `		if( pVmFunc->pNextName ){` |
...
|     8704 |  5663 | `		aFormalArg = (ph7_vm_func_arg *)SySetBasePtr(&pVmFunc->aArgs);` |
|        - |  5664 | `		/* Create a new VM frame  */` |
|     8704 |  5665 | `		rc = VmEnterFrame(&(*pVm),pVmFunc,pThis,&pFrame);` |
|     8704 |  5666 | `		if( rc != SXRET_OK ){` |
...
|      ! 0 |  5677 | `			break;` |
|        - |  5678 | `		}` |
|     8704 |  5679 | `		if( (pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) && pThis ){` |
|        - |  5680 | `			/* Install the '$this' variable */` |
|        - |  5681 | `			static const SyString sThis = { "this" , sizeof("this") - 1 };` |
|      598 |  5682 | `			pObj = VmExtractMemObj(&(*pVm),&sThis,FALSE,TRUE);` |
|      598 |  5683 | `			if( pObj ){` |
|        - |  5684 | `				/* Reflect the change */` |
|      598 |  5685 | `				pObj->x.pOther = pThis;` |
|      598 |  5686 | `				MemObjSetType(pObj,MEMOBJ_OBJ);` |
|      298 |  5687 | `			}` |
|      298 |  5688 | `		}` |
|     8704 |  5689 | `		if( SySetUsed(&pVmFunc->aStatic) > 0 ){` |
...
|     8704 |  5716 | `		n = 0;` |
|    24714 |  5717 | `		while( pArg < pTos ){` |
|    16012 |  5718 | `			if( n < SySetUsed(&pVmFunc->aArgs) ){` |
|    15912 |  5719 | `				if( (pArg->iFlags & MEMOBJ_NULL) && SySetUsed(&aFormalArg[n].aByteCode) > 0 ){` |
...
|    15912 |  5727 | `				if( aFormalArg[n].nType > 0 ){` |
|     1012 |  5728 | `					if ( aFormalArg[n].nType == SXU32_HIGH ){` |
...
|        - |  5752 | `							}` |
|      ! 0 |  5753 | `						}` |
|     1012 |  5754 | `					}else if( ((pArg->iFlags & aFormalArg[n].nType) == 0) ){` |
|      ! 0 |  5755 | `						ProcMemObjCast xCast = PH7_MemObjCastMethod(aFormalArg[n].nType);` |
|        - |  5756 | `						/* Cast to the desired type */` |
|      ! 0 |  5757 | `						xCast(pArg);` |
|      ! 0 |  5758 | `					}` |
|      505 |  5759 | `				}` |
|    15912 |  5760 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_BY_REF ){` |
...
|    15888 |  5786 | `					pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|        - |  5787 | `				}` |
|     7957 |  5788 | `			}else{` |
|        - |  5789 | `				char zName[32];` |
...
|        - |  5796 | `			}` |
|    16012 |  5797 | `			if( pObj ){` |
|    15988 |  5798 | `				PH7_MemObjStore(pArg,pObj);` |
|        - |  5799 | `				/* Insert argument index  */` |
|    15988 |  5800 | `				sArg.nIdx = pObj->nIdx;` |
|    15988 |  5801 | `				sArg.pUserData = 0;` |
|    15988 |  5802 | `				SySetPut(&pFrame->sArg,(const void *)&sArg);` |
|     7993 |  5803 | `			}` |
|    16012 |  5804 | `			PH7_MemObjRelease(pArg);` |
|    16012 |  5805 | `			pArg++;` |
|    16012 |  5806 | `			++n;` |
|        2 |  5807 | `		}` |
|        - |  5808 | `		/* Set up closure environment */` |
|     8704 |  5809 | `		if( pVmFunc->iFlags & VM_FUNC_CLOSURE ){` |
...
|     9794 |  5831 | `		while( n < SySetUsed(&pVmFunc->aArgs) ){` |
|     1092 |  5832 | `			if( SySetUsed(&aFormalArg[n].aByteCode) > 0 ){` |
|     1082 |  5833 | `				pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|     1082 |  5834 | `				if( pObj ){` |
|        - |  5835 | `					/* Evaluate the default value and extract it's result */` |
|     1082 |  5836 | `					rc = VmLocalExec(&(*pVm),&aFormalArg[n].aByteCode,pObj);` |
|     1082 |  5837 | `					if( rc == PH7_ABORT ){` |
|      ! 0 |  5838 | `						goto Abort;` |
|        - |  5839 | `					}` |
|        - |  5840 | `					/* Insert argument index */` |
|     1082 |  5841 | `					sArg.nIdx = pObj->nIdx;` |
|     1082 |  5842 | `					sArg.pUserData = 0;` |
|     1082 |  5843 | `					SySetPut(&pFrame->sArg,(const void *)&sArg);` |
|        - |  5844 | `					/* Make sure the default argument is of the correct type */` |
|     1082 |  5845 | `					if( aFormalArg[n].nType > 0 && ((pObj->iFlags & aFormalArg[n].nType) == 0) ){` |
...
|        - |  5856 | `		 */` |
|     8704 |  5857 | `		PH7_MemObjRelease(pTos);` |
|     8704 |  5858 | `		pTos = &pTos[-pInstr->iP1];` |
|        - |  5859 | `		/* Allocate a new operand stack and evaluate the function body */` |
|     8704 |  5860 | `		pFrameStack = VmNewOperandStack(&(*pVm),SySetUsed(&pVmFunc->aByteCode));` |
|     8704 |  5861 | `		if( pFrameStack == 0 ){` |
...
|      616 |  5872 | `			SySetPut(&pVm->aSelf,(const void *)&pSelf);` |
|      307 |  5873 | `		}` |
|        - |  5874 | `		/* Increment nesting level */` |
|     8704 |  5875 | `		pVm->nRecursionDepth++;` |
|        - |  5876 | `		/* Execute function body */` |
|     8704 |  5877 | `		rc = VmByteCodeExec(&(*pVm),(VmInstr *)SySetBasePtr(&pVmFunc->aByteCode),pFrameStack,-1,pTos,&n,FALSE);` |
|        - |  5878 | `		/* Decrement nesting level */` |
|     8704 |  5879 | `		pVm->nRecursionDepth--;` |
|     8704 |  5880 | `		if( pSelf ){` |
|        - |  5881 | `			/* Pop class name */` |
|      616 |  5882 | `			(void)SySetPop(&pVm->aSelf);` |
|      307 |  5883 | `		}` |
|        - |  5884 | `		/* Cleanup the mess left behind */` |
|     8704 |  5885 | `		if( (pVmFunc->iFlags & VM_FUNC_REF_RETURN) && rc == SXRET_OK ){` |
...
|     8704 |  5913 | `		if( rc != PH7_ABORT && ((pFrame->iFlags & VM_FRAME_THROW) \|\| rc == PH7_EXCEPTION) ){` |
...
|     8704 |  5932 | `		SyMemBackendFree(&pVm->sAllocator,pFrameStack);` |
|        - |  5933 | `		/* Leave the frame */` |
|     8704 |  5934 | `		VmLeaveFrame(&(*pVm));` |
|     8704 |  5935 | `		if( rc == PH7_ABORT ){` |
|        - |  5936 | `			/* Abort processing immeditaley */` |
|      ! 0 |  5937 | `			goto Abort;` |
|     8704 |  5938 | `		}else if( rc == PH7_EXCEPTION ){` |
...
|   444650 |  5946 | `		pEntry = SyHashGet(&pVm->hHostFunction,(const void *)sName.zString,sName.nByte);` |
|   444650 |  5947 | `		if( pEntry == 0 ){` |
...
|        5 |  5956 | `			break;` |
|        - |  5957 | `		}` |
|   444646 |  5958 | `		pFunc = (ph7_user_func *)pEntry->pUserData;` |
|        - |  5959 | `		/* Start collecting function arguments */` |
|   444646 |  5960 | `		SySetReset(&aArg);` |
|  1195390 |  5961 | `		while( pArg < pTos ){` |
|   750746 |  5962 | `			SySetPut(&aArg,(const void *)&pArg);` |
|   750746 |  5963 | `			pArg++;` |
|        2 |  5964 | `		}` |
|        - |  5965 | `		/* Assume a null return value */` |
|   444646 |  5966 | `		PH7_MemObjInit(&(*pVm),&sRet);` |
|        - |  5967 | `		/* Init the call context */` |
|   444646 |  5968 | `		VmInitCallContext(&sCtx,&(*pVm),pFunc,&sRet,0);` |
|        - |  5969 | `		/* Call the foreign function */` |
|   444646 |  5970 | `		rc = pFunc->xFunc(&sCtx,(int)SySetUsed(&aArg),(ph7_value **)SySetBasePtr(&aArg));` |
|        - |  5971 | `		/* Release the call context */` |
|   444646 |  5972 | `		VmReleaseCallContext(&sCtx);` |
|   444646 |  5973 | `		if( rc == PH7_ABORT ){` |
|      137 |  5974 | `			goto Abort;` |
|   444510 |  5975 | `		}else if( rc == PH7_EXCEPTION ){` |
|        3 |  5976 | `			goto Exception;` |
|        - |  5977 | `		}` |
|   444508 |  5978 | `		if( pInstr->iP1 > 0 ){` |
|        - |  5979 | `			/* Pop function name and arguments */` |
|   429388 |  5980 | `			VmPopOperand(&pTos,pInstr->iP1);` |
|   214715 |  5981 | `		}` |
|        - |  5982 | `		/* Save foreign function return value */` |
|   444508 |  5983 | `		PH7_MemObjStore(&sRet,pTos);` |
|   444508 |  5984 | `		PH7_MemObjRelease(&sRet);` |
|        - |  5985 | `	}` |
|   453208 |  5986 | `	break;` |
|        - |  5987 | `				  }` |
|        - |  5988 | `/*` |
...
|        - |  5991 | ` */` |
|     8509 |  5992 | `case PH7_OP_CONSUME: {` |
|    17020 |  5993 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|    17020 |  5994 | `	ph7_value *pCur,*pOut = pTos;` |
|        - |  5995 |  |
|    17020 |  5996 | `	pOut = &pTos[-pInstr->iP1 + 1];` |
|    17020 |  5997 | `	pCur = pOut;` |
|        - |  5998 | `	/* Start the consume process  */` |
|    34038 |  5999 | `	while( pOut <= pTos ){` |
|        - |  6000 | `		/* Force a string cast */` |
|    17020 |  6001 | `		if( (pOut->iFlags & MEMOBJ_STRING) == 0 ){` |
|       56 |  6002 | `			PH7_MemObjToString(pOut);` |
|       27 |  6003 | `		}` |
|    17020 |  6004 | `		if( SyBlobLength(&pOut->sBlob) > 0 ){` |
|        - |  6005 | `			/*SyBlobNullAppend(&pOut->sBlob);*/` |
|        - |  6006 | `			/* Invoke the output consumer callback */` |
|     9128 |  6007 | `			rc = pCons->xConsumer(SyBlobData(&pOut->sBlob),SyBlobLength(&pOut->sBlob),pCons->pUserData);` |
|     9128 |  6008 | `			if( pCons->xConsumer != VmObConsumer ){` |
|        - |  6009 | `				/* Increment output length */` |
|     3524 |  6010 | `				pVm->nOutputLen += SyBlobLength(&pOut->sBlob);` |
|     1761 |  6011 | `			}` |
|     9128 |  6012 | `			SyBlobRelease(&pOut->sBlob);` |
|     9128 |  6013 | `			if( rc == SXERR_ABORT ){` |
...
|    17020 |  6018 | `		pOut++;` |
|        2 |  6019 | `	}` |
|    17020 |  6020 | `	pTos = &pCur[-1];` |
|    17018 |  6021 | `	break;` |
|        - |  6022 | `					 }` |
|        - |  6023 |  |
|        - |  6024 | `		} /* Switch() */` |
|  7543370 |  6025 | `		pc++; /* Next instruction in the stream */` |
|        2 |  6026 | `	} /* For(;;) */` |
|    10840 |  6027 | `Done:` |
|    21682 |  6028 | `	SySetRelease(&aArg);` |
|    21682 |  6029 | `	return SXRET_OK;` |
|       69 |  6030 | `Abort:` |
|      139 |  6031 | `	SySetRelease(&aArg);` |
|      479 |  6032 | `	while( pTos >= pStack ){` |
|      341 |  6033 | `		PH7_MemObjRelease(pTos);` |
|      341 |  6034 | `		pTos--;` |
|        1 |  6035 | `	}` |
|      139 |  6036 | `	return PH7_ABORT;` |
|        2 |  6037 | `Exception:` |
...
|        - |  6049 | ` */` |
|    11098 |  6050 | `static sxi32 VmLocalExec(ph7_vm *pVm,SySet *pByteCode,ph7_value *pResult)` |
|        2 |  6051 |  |
|        - |  6052 | `	ph7_value *pStack;` |
|        - |  6053 | `	sxi32 rc;` |
|        - |  6054 | `	/* Allocate a new operand stack */` |
|    11100 |  6055 | `	pStack = VmNewOperandStack(&(*pVm),SySetUsed(pByteCode));` |
|    11100 |  6056 | `	if( pStack == 0 ){` |
|      ! 0 |  6057 | `		return SXERR_MEM;` |
|        - |  6058 | `	}` |
|        - |  6059 | `	/* Execute the program */` |
|    11100 |  6060 | `	rc = VmByteCodeExec(&(*pVm),(VmInstr *)SySetBasePtr(pByteCode),pStack,-1,&(*pResult),0,FALSE);` |
|        - |  6061 | `	/* Free the operand stack */` |
|    11100 |  6062 | `	SyMemBackendFree(&pVm->sAllocator,pStack);` |
|        - |  6063 | `	/* Execution result */` |
|    11100 |  6064 | `	return rc;` |
|     5551 |  6065 |  |
|        - |  6066 | `/*` |
...
|        - |  6074 | ` */` |
|     1200 |  6075 | `static void VmInvokeShutdownCallbacks(ph7_vm *pVm)` |
|        2 |  6076 |  |
...
|     1202 |  6082 | `	nEntry = SySetUsed(&pVm->aShutdown);` |
|    13202 |  6083 | `	for( i = 0 ; i < (int)SX_ARRAYSIZE(apArg) ; i++ ){` |
|    12002 |  6084 | `		apArg[i] = 0;` |
|     6002 |  6085 | `	}` |
|     1204 |  6086 | `	for( n = 0 ; n < nEntry ; ++n ){` |
...
|        1 |  6109 | `		}` |
|        2 |  6110 | `	}` |
|     1202 |  6111 | `	SySetReset(&pVm->aShutdown);` |
|     1202 |  6112 |  |
|        - |  6113 | `/*` |
...
|        - |  6117 | ` */` |
|     1208 |  6118 | `PH7_PRIVATE sxi32 PH7_VmByteCodeExec(ph7_vm *pVm)` |
|        2 |  6119 |  |
|        - |  6120 | `	/* Make sure we are ready to execute this program */` |
|     1210 |  6121 | `	if( pVm->nMagic != PH7_VM_RUN ){` |
|      ! 0 |  6122 | `		return pVm->nMagic == PH7_VM_EXEC ? SXERR_LOCKED /* Locked VM */ : SXERR_CORRUPT; /* Stale VM */` |
|        - |  6123 | `	}` |
|        - |  6124 | `	/* Set the execution magic number  */` |
|     1210 |  6125 | `	pVm->nMagic = PH7_VM_EXEC;` |
|        - |  6126 | `	/* Execute the program */` |
|     1210 |  6127 | `	VmByteCodeExec(&(*pVm),(VmInstr *)SySetBasePtr(pVm->pByteContainer),pVm->aOps,-1,&pVm->sExec,0,FALSE);` |
|        - |  6128 | `	/* Invoke any shutdown callbacks */` |
|     1206 |  6129 | `	VmInvokeShutdownCallbacks(&(*pVm));` |
|        - |  6130 | `	/*` |
...
|        - |  6142 | ` */` |
|      372 |  6143 | `PH7_PRIVATE sxi32 PH7_VmOutputConsume(` |
|        - |  6144 | `	ph7_vm *pVm,      /* Target VM */` |
|        - |  6145 | `	SyString *pString /* Message to output */` |
|        - |  6146 | `	)` |
|        2 |  6147 |  |
|      374 |  6148 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|      374 |  6149 | `	sxi32 rc = SXRET_OK;` |
|        - |  6150 | `	/* Call the output consumer */` |
|      374 |  6151 | `	if( pString->nByte > 0 ){` |
|      374 |  6152 | `		rc = pCons->xConsumer((const void *)pString->zString,pString->nByte,pCons->pUserData);` |
|      374 |  6153 | `		if( pCons->xConsumer != VmObConsumer ){` |
...
|        - |  6335 | ` */` |
|      784 |  6336 | `static int vm_builtin_func_num_args(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  6337 |  |
|        - |  6338 | `	VmFrame *pFrame;` |
|        - |  6339 | `	ph7_vm *pVm;` |
|        - |  6340 | `	/* Point to the target VM */` |
|      786 |  6341 | `	pVm = pCtx->pVm;` |
|        - |  6342 | `	/* Current frame */` |
|      786 |  6343 | `	pFrame = pVm->pFrame;` |
|      786 |  6344 | `	while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|        - |  6345 | `		/* Safely ignore the exception frame */` |
|      ! 0 |  6346 | `		pFrame = pFrame->pParent;` |
|      ! 0 |  6347 | `	}` |
|      786 |  6348 | `	if( pFrame->pParent == 0 ){` |
...
|      786 |  6356 | `	nArg = (int)SySetUsed(&pFrame->sArg);` |
|      786 |  6357 | `	ph7_result_int(pCtx,nArg);` |
|      786 |  6358 | `	return SXRET_OK;` |
|      394 |  6359 |  |
|        - |  6360 | `/*` |
...
|        - |  6513 | ` */` |
|     1684 |  6514 | `static int vm_builtin_func_exists(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  6515 |  |
...
|     1686 |  6526 | `	pVm = pCtx->pVm;` |
|        - |  6527 | `	/* Extract the function name */` |
|     1686 |  6528 | `	zName = ph7_value_to_string(apArg[0],&nLen);` |
|        - |  6529 | `	/* Assume the function is not defined */` |
|     1686 |  6530 | `	res = 0;` |
|        - |  6531 | `	/* Perform the lookup */` |
|     2526 |  6532 | `	if( SyHashGet(&pVm->hFunction,(const void *)zName,(sxu32)nLen) != 0 \|\|` |
|     1680 |  6533 | `		SyHashGet(&pVm->hHostFunction,(const void *)zName,(sxu32)nLen) != 0 ){` |
|        - |  6534 | `			/* Function is defined */` |
|      212 |  6535 | `			res = 1;` |
|      105 |  6536 | `	}` |
|     1686 |  6537 | `	ph7_result_bool(pCtx,res);` |
|     1686 |  6538 | `	return SXRET_OK;` |
|      844 |  6539 |  |
...
|        - |  6546 | ` */` |
|    14224 |  6547 | `PH7_PRIVATE int PH7_VmIsCallable(ph7_vm *pVm,ph7_value *pValue,int CallInvoke)` |
|        2 |  6548 |  |
|    14226 |  6549 | `	int res = 0;` |
|    14226 |  6550 | `	if( pValue->iFlags & MEMOBJ_OBJ ){` |
...
|      ! 0 |  6565 | `		}` |
|    14226 |  6566 | `	}else if( pValue->iFlags & MEMOBJ_HASHMAP ){` |
...
|        4 |  6588 | `			}` |
|        6 |  6589 | `		}` |
|    14222 |  6590 | `	}else if( pValue->iFlags & MEMOBJ_STRING ){` |
|        - |  6591 | `		const char *zName;` |
|        - |  6592 | `		int nLen;` |
|        - |  6593 | `		/* Extract the name */` |
|     4180 |  6594 | `		zName = ph7_value_to_string(pValue,&nLen);` |
|        - |  6595 | `		/* Perform the lookup */` |
|     4186 |  6596 | `		if( SyHashGet(&pVm->hFunction,(const void *)zName,(sxu32)nLen) != 0 \|\|` |
|       12 |  6597 | `			SyHashGet(&pVm->hHostFunction,(const void *)zName,(sxu32)nLen) != 0 ){` |
|        - |  6598 | `				/* Function is callable */` |
|     4174 |  6599 | `				res = 1;` |
|     2086 |  6600 | `		}` |
|     2089 |  6601 | `	}` |
|    14226 |  6602 | `	return res;` |
|        2 |  6603 |  |
|        - |  6604 | `/*` |
...
|        - |  6758 | ` */` |
|      178 |  6759 | `PH7_PRIVATE ph7_class * PH7_VmPeekTopClass(ph7_vm *pVm)` |
|        2 |  6760 |  |
|      180 |  6761 | `	SySet *pSet = &pVm->aSelf;` |
|        - |  6762 | `	ph7_class **apClass;` |
|      180 |  6763 | `	if( SySetUsed(pSet) <= 0 ){` |
|        - |  6764 | `		/* Empty stack,return NULL */` |
|       15 |  6765 | `		return 0;` |
|        - |  6766 | `	}` |
|        - |  6767 | `	/* Peek the last entry */` |
|      166 |  6768 | `	apClass = (ph7_class **)SySetBasePtr(pSet);` |
|      166 |  6769 | `	return apClass[pSet->nUsed - 1];` |
|       91 |  6770 |  |
|        - |  6771 | `/*` |
...
|        - |  7289 | ` */` |
|     1508 |  7290 | `static int VmClassMemberAccess(` |
...
|        - |  7296 | `	)` |
|        2 |  7297 |  |
|     1510 |  7298 | `	if( iProtection != PH7_CLASS_PROT_PUBLIC ){` |
|      946 |  7299 | `		VmFrame *pFrame = pVm->pFrame;` |
|        - |  7300 | `		ph7_vm_func *pVmFunc;` |
|      950 |  7301 | `		while( pFrame->pParent && (pFrame->iFlags & (VM_FRAME_EXCEPTION\|VM_FRAME_CATCH) ) ){` |
|        - |  7302 | `			/* Safely ignore the exception frame */` |
|        5 |  7303 | `			pFrame = pFrame->pParent;` |
|        1 |  7304 | `		}` |
|      946 |  7305 | `		pVmFunc = (ph7_vm_func *)pFrame->pUserData;` |
|      946 |  7306 | `		if( pVmFunc == 0 \|\| (pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) == 0 ){` |
|        9 |  7307 | `			goto dis; /* Access is forbidden */` |
|        - |  7308 | `		}` |
|      938 |  7309 | `		if( iProtection == PH7_CLASS_PROT_PRIVATE ){` |
...
|        4 |  7314 | `		}else{` |
|        - |  7315 | `			/* Protected */` |
|      932 |  7316 | `			ph7_class *pBase = (ph7_class *)pVmFunc->pUserData;` |
|        - |  7317 | `			/* Must be a derived class */` |
|      932 |  7318 | `			if( !VmInstanceOf(pClass,pBase) ){` |
|      ! 0 |  7319 | `				goto dis; /* Access is forbidden */` |
|        - |  7320 | `			}` |
|        - |  7321 | `		}` |
|      468 |  7322 | `	}` |
|     1502 |  7323 | `	return 1; /* Access is granted */` |
|        4 |  7324 | `dis:` |
|        9 |  7325 | `	if( bLog ){` |
...
|        - |  7474 | ` */` |
|     1922 |  7475 | `static int VmQueryInterfaceSet(ph7_class *pClass,SySet *pSet)` |
|        2 |  7476 |  |
|        - |  7477 | `	ph7_class **apInterface;` |
|        - |  7478 | `	sxu32 n;` |
|     1924 |  7479 | `	if( SySetUsed(pSet) < 1 ){` |
|        - |  7480 | `		/* Empty interface container */` |
|     1922 |  7481 | `		return FALSE;` |
|        - |  7482 | `	}` |
...
|        - |  7497 | ` */` |
|      982 |  7498 | `static int VmInstanceOf(ph7_class *pThis,ph7_class *pClass)` |
|        2 |  7499 |  |
|        - |  7500 | `	ph7_class *pParent;` |
|        - |  7501 | `	sxi32 rc;` |
|      984 |  7502 | `	if( pThis == pClass ){` |
|        - |  7503 | `		/* Instance of the same class */` |
|      140 |  7504 | `		return TRUE;` |
|        - |  7505 | `	}` |
|        - |  7506 | `	/* Check implemented interfaces */` |
|      846 |  7507 | `	rc = VmQueryInterfaceSet(pClass,&pThis->aInterface);` |
|      846 |  7508 | `	if( rc ){` |
|        3 |  7509 | `		return TRUE;` |
|        - |  7510 | `	}` |
|        - |  7511 | `	/* Check parent classes */` |
|      844 |  7512 | `	pParent = pThis->pBase;` |
|     1922 |  7513 | `	while( pParent ){` |
|     1920 |  7514 | `		if( pParent == pClass ){` |
|        - |  7515 | `			/* Same instance */` |
|      842 |  7516 | `			return TRUE;` |
|        - |  7517 | `		}` |
|        - |  7518 | `		/* Check the implemented interfaces */` |
|     1080 |  7519 | `		rc = VmQueryInterfaceSet(pClass,&pParent->aInterface);` |
|     1080 |  7520 | `		if( rc ){` |
|      ! 0 |  7521 | `			return TRUE;` |
|        - |  7522 | `		}` |
|        - |  7523 | `		/* Point to the parent class */` |
|     1080 |  7524 | `		pParent = pParent->pBase;` |
|        2 |  7525 | `	}` |
...
|        - |  7619 | ` */` |
|      474 |  7620 | `PH7_PRIVATE sxi32 PH7_VmCallClassMethod(` |
...
|      476 |  7634 | `	aStack = VmNewOperandStack(&(*pVm),2/* Method name + Aux data */+nArg);` |
|      476 |  7635 | `	if( aStack == 0 ){` |
...
|      684 |  7641 | `	for( i = 0 ; i < nArg ; i++ ){` |
|      210 |  7642 | `		PH7_MemObjLoad(apArg[i],&aStack[i]);` |
|        - |  7643 | `		/*` |
|        - |  7644 | `		 * Symisc eXtension:` |
|        - |  7645 | `		 *  Parameters to [call_user_func()] can be passed by reference.` |
|        - |  7646 | `		 */` |
|      210 |  7647 | `		aStack[i].nIdx = apArg[i]->nIdx;` |
|      106 |  7648 | `	}` |
|      476 |  7649 | `	iCursor = nArg + 1;` |
|      476 |  7650 | `	if( pThis ){` |
|        - |  7651 | `		/*` |
|        - |  7652 | `		 * Push the class instance so that the '$this' variable will be available.` |
|        - |  7653 | `		 */` |
|      470 |  7654 | `		pThis->iRef++; /* Increment reference count */` |
|      470 |  7655 | `		aStack[i].x.pOther = pThis;` |
|      470 |  7656 | `		aStack[i].iFlags = MEMOBJ_OBJ;` |
|      234 |  7657 | `	}` |
|      476 |  7658 | `	aStack[i].nIdx = SXU32_HIGH; /* Mark as constant */` |
|      476 |  7659 | `	i++;` |
|        - |  7660 | `	/* Push method name */` |
|      476 |  7661 | `	SyBlobReset(&aStack[i].sBlob);` |
|      476 |  7662 | `	SyBlobAppend(&aStack[i].sBlob,(const void *)SyStringData(&pMethod->sVmName),SyStringLength(&pMethod->sVmName));` |
|      476 |  7663 | `	aStack[i].iFlags = MEMOBJ_STRING;` |
|      476 |  7664 | `	aStack[i].nIdx = SXU32_HIGH;` |
|        - |  7665 | `	/* Emit the CALL istruction */` |
|      476 |  7666 | `	aInstr[0].iOp = PH7_OP_CALL;` |
|      476 |  7667 | `	aInstr[0].iP1 = nArg; /* Total number of given arguments */` |
|      476 |  7668 | `	aInstr[0].iP2 = 0;` |
|      476 |  7669 | `	aInstr[0].p3  = 0;` |
|        - |  7670 | `	/* Emit the DONE instruction */` |
|      476 |  7671 | `	aInstr[1].iOp = PH7_OP_DONE;` |
|      476 |  7672 | `	aInstr[1].iP1 = 1;   /* Extract method return value */` |
|      476 |  7673 | `	aInstr[1].iP2 = 0;` |
|      476 |  7674 | `	aInstr[1].p3  = 0;` |
|        - |  7675 | `	/* Execute the method body (if available) */` |
|      476 |  7676 | `	VmByteCodeExec(&(*pVm),aInstr,aStack,iCursor,pResult,0,TRUE);` |
|        - |  7677 | `	/* Clean up the mess left behind */` |
|      476 |  7678 | `	SyMemBackendFree(&pVm->sAllocator,aStack);` |
|      476 |  7679 | `	return PH7_OK;` |
|      239 |  7680 |  |
|        - |  7681 | `/*` |
...
|        - |  7687 | ` */` |
|      494 |  7688 | `PH7_PRIVATE sxi32 PH7_VmCallUserFunction(` |
...
|        - |  7698 | `	int i;` |
|      496 |  7699 | `	if((pFunc->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP)) == 0 ){` |
|        - |  7700 | `		/* Don't bother processing,it's invalid anyway */` |
|      137 |  7701 | `		if( pResult ){` |
|        - |  7702 | `			/* Assume a null return value */` |
|      ! 0 |  7703 | `			PH7_MemObjRelease(pResult);` |
|      ! 0 |  7704 | `		}` |
|      137 |  7705 | `		return SXERR_INVALID;` |
|        - |  7706 | `	}` |
|      360 |  7707 | `	if( pFunc->iFlags & MEMOBJ_HASHMAP ){` |
|        - |  7708 | `		/* Class method */` |
...
|      350 |  7759 | `	aStack = VmNewOperandStack(&(*pVm),1+nArg);` |
|      350 |  7760 | `	if( aStack == 0 ){` |
...
|     1120 |  7770 | `	for( i = 0 ; i < nArg ; i++ ){` |
|      772 |  7771 | `		PH7_MemObjLoad(apArg[i],&aStack[i]);` |
|        - |  7772 | `		/*` |
|        - |  7773 | `		 * Symisc eXtension:` |
|        - |  7774 | `		 *  Parameters to [call_user_func()] can be passed by reference.` |
|        - |  7775 | `		 */` |
|      772 |  7776 | `		aStack[i].nIdx = apArg[i]->nIdx;` |
|      387 |  7777 | `	}` |
|        - |  7778 | `	/* Push the function name */` |
|      350 |  7779 | `	PH7_MemObjLoad(pFunc,&aStack[i]);` |
|      350 |  7780 | `	aStack[i].nIdx = SXU32_HIGH; /* Mark as constant */` |
|        - |  7781 | `	/* Emit the CALL istruction */` |
|      350 |  7782 | `	aInstr[0].iOp = PH7_OP_CALL;` |
|      350 |  7783 | `	aInstr[0].iP1 = nArg; /* Total number of given arguments */` |
|      350 |  7784 | `	aInstr[0].iP2 = 0;` |
|      350 |  7785 | `	aInstr[0].p3  = 0;` |
|        - |  7786 | `	/* Emit the DONE instruction */` |
|      350 |  7787 | `	aInstr[1].iOp = PH7_OP_DONE;` |
|      350 |  7788 | `	aInstr[1].iP1 = 1;   /* Extract function return value if available */` |
|      350 |  7789 | `	aInstr[1].iP2 = 0;` |
|      350 |  7790 | `	aInstr[1].p3  = 0;` |
|        - |  7791 | `	/* Execute the function body (if available) */` |
|      350 |  7792 | `	VmByteCodeExec(&(*pVm),aInstr,aStack,nArg,pResult,0,TRUE);` |
|        - |  7793 | `	/* Clean up the mess left behind */` |
|      350 |  7794 | `	SyMemBackendFree(&pVm->sAllocator,aStack);` |
|      350 |  7795 | `	return PH7_OK;` |
|      249 |  7796 |  |
|        - |  7797 | `/*` |
...
|        - |  8165 | ` */` |
|     2734 |  8166 | `static int vm_builtin_ob_end_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  8167 |  |
|     2736 |  8168 | `	ph7_vm *pVm = pCtx->pVm;` |
|        - |  8169 | `	VmObEntry *pOb;` |
|        - |  8170 | `	/* Pop the top most OB */` |
|     2736 |  8171 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|     2736 |  8172 | `	if( pOb == 0){` |
...
|      ! 0 |  8177 | `	}else{` |
|        - |  8178 | `		/* Release */` |
|     2736 |  8179 | `		VmObRestore(pVm,pOb);` |
|        - |  8180 | `		/* Return true */` |
|     2736 |  8181 | `		ph7_result_bool(pCtx,1);` |
|        - |  8182 | `	}` |
|     2736 |  8183 | `	return PH7_OK;` |
|        2 |  8184 |  |
|        - |  8185 | `/*` |
...
|        - |  8218 | ` */` |
|     3962 |  8219 | `static int vm_builtin_ob_get_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  8220 |  |
|     3964 |  8221 | `	ph7_vm *pVm = pCtx->pVm;` |
|        - |  8222 | `	VmObEntry *pOb;` |
|        - |  8223 | `	/* Pop the top most OB */` |
|     3964 |  8224 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|     3964 |  8225 | `	if( pOb == 0 ){` |
...
|     3964 |  8232 | `		ph7_result_string(pCtx,(const char *)SyBlobData(&pOb->sOB),(int)SyBlobLength(&pOb->sOB)); /* Will make it's own copy */` |
|        - |  8233 | `		/* Release */` |
|     3964 |  8234 | `		VmObRestore(pVm,pOb);` |
|        - |  8235 | `	}` |
|     3964 |  8236 | `	return PH7_OK;` |
|        2 |  8237 |  |
|        - |  8238 | `/*` |
...
|        - |  8287 | ` */` |
|     5964 |  8288 | `static int VmObConsumer(const void *pData,unsigned int nDataLen,void *pUserData)` |
|        2 |  8289 |  |
|     5966 |  8290 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|        - |  8291 | `	VmObEntry *pEntry;` |
|        - |  8292 | `	ph7_value sResult;` |
|        - |  8293 | `	/* Peek the top most entry */` |
|     5966 |  8294 | `	pEntry = (VmObEntry *)SySetPeek(&pVm->aOB);` |
|     5966 |  8295 | `	if( pEntry == 0 ){` |
|        - |  8296 | `		/* CAN'T HAPPEN */` |
|      ! 0 |  8297 | `		return PH7_OK;` |
|        - |  8298 | `	}` |
|     5966 |  8299 | `	PH7_MemObjInit(pVm,&sResult);` |
|     5966 |  8300 | `	if( ph7_value_is_callable(&pEntry->sCallback) && pVm->nObDepth < 15 ){` |
...
|      ! 0 |  8316 | `	}` |
|     5966 |  8317 | `	if( nDataLen > 0 ){` |
|        - |  8318 | `		/* Redirect the VM output to the internal buffer */` |
|     5966 |  8319 | `		SyBlobAppend(&pEntry->sOB,pData,nDataLen);` |
|     2982 |  8320 | `	}` |
|        - |  8321 | `	/* Release */` |
|     5966 |  8322 | `	PH7_MemObjRelease(&sResult);` |
|     5966 |  8323 | `	return PH7_OK;` |
|     2984 |  8324 |  |
|        - |  8325 | `/*` |
...
|        - |  8328 | ` * information.` |
|        - |  8329 | ` */` |
|     6698 |  8330 | `static void VmObRestore(ph7_vm *pVm,VmObEntry *pEntry)` |
|        2 |  8331 |  |
|     6700 |  8332 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|     6700 |  8333 | `	if( SySetUsed(&pVm->aOB) < 1 ){` |
|        - |  8334 | `		/* No more stackable OB */` |
|     6682 |  8335 | `		pCons->xConsumer = pCons->xDef;` |
|     6682 |  8336 | `		pCons->pUserData = pCons->pDefData;` |
|     3340 |  8337 | `	}` |
|        - |  8338 | `	/* Release OB data */` |
|     6700 |  8339 | `	PH7_MemObjRelease(&pEntry->sCallback);` |
|     6700 |  8340 | `	SyBlobRelease(&pEntry->sOB);` |
|     6700 |  8341 |  |
|        - |  8342 | `/*` |
...
|        - |  8364 | ` */` |
|     6698 |  8365 | `static int vm_builtin_ob_start(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  8366 |  |
|     6700 |  8367 | `	ph7_vm *pVm = pCtx->pVm;` |
|        - |  8368 | `	VmObEntry sOb;` |
|        - |  8369 | `	sxi32 rc;` |
|        - |  8370 | `	/* Initialize the OB entry */` |
|     6700 |  8371 | `	PH7_MemObjInit(pCtx->pVm,&sOb.sCallback);` |
|     6700 |  8372 | `	SyBlobInit(&sOb.sOB,&pVm->sAllocator);` |
|     6700 |  8373 | `	if( nArg > 0 && (apArg[0]->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP)) ){` |
|        - |  8374 | `		/* Save the callback name for later invocation */` |
|      ! 0 |  8375 | `		PH7_MemObjStore(apArg[0],&sOb.sCallback);` |
|      ! 0 |  8376 | `	}` |
|        - |  8377 | `	/* Push in the stack */` |
|     6700 |  8378 | `	rc = SySetPut(&pVm->aOB,(const void *)&sOb);` |
|     6700 |  8379 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  8380 | `		PH7_MemObjRelease(&sOb.sCallback);` |
|      ! 0 |  8381 | `	}else{` |
|     6700 |  8382 | `		ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|        - |  8383 | `		/* Substitute the default VM consumer */` |
|     6700 |  8384 | `		if( pCons->xConsumer != VmObConsumer ){` |
|     6682 |  8385 | `			pCons->xDef = pCons->xConsumer;` |
|     6682 |  8386 | `			pCons->pDefData = pCons->pUserData;` |
|        - |  8387 | `			/* Install the new consumer */` |
|     6682 |  8388 | `			pCons->xConsumer = VmObConsumer;` |
|     6682 |  8389 | `			pCons->pUserData = pVm;` |
|     3340 |  8390 | `		}` |
|        - |  8391 | `	}` |
|     6700 |  8392 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|     6700 |  8393 | `	return PH7_OK;` |
|        2 |  8394 |  |
|        - |  8395 | `/*` |
...
|        - |  8564 | ` */` |
|     1279 |  8565 | `PH7_PRIVATE sxu32 PH7_VmRandomNum(ph7_vm *pVm)` |
|        2 |  8566 |  |
|        - |  8567 | `	sxu32 iNum;` |
|     1281 |  8568 | `	SyRandomness(&pVm->sPrng,(void *)&iNum,sizeof(sxu32));` |
|     1281 |  8569 | `	return iNum;` |
|        2 |  8570 |  |
|        - |  8571 | `/*` |
...
|        - |  8576 | ` */` |
|    42864 |  8577 | `PH7_PRIVATE void PH7_VmRandomString(ph7_vm *pVm,char *zBuf,int nLen)` |
|        2 |  8578 |  |
|        - |  8579 | `	static const char zBase[] = {"abcdefghijklmnopqrstuvwxyz"}; /* English Alphabet */` |
|        - |  8580 | `	int i;` |
|        - |  8581 | `	/* Generate a binary string first */` |
|    42866 |  8582 | `	SyRandomness(&pVm->sPrng,zBuf,(sxu32)nLen);` |
|        - |  8583 | `	/* Turn the binary string into english based alphabet */` |
|   471674 |  8584 | `	for( i = 0 ; i < nLen ; ++i ){` |
|   428810 |  8585 | `		 zBuf[i] = zBase[zBuf[i] % (sizeof(zBase)-1)];` |
|   214406 |  8586 | `	 }` |
|    42866 |  8587 |  |
|        - |  8588 | `/*` |
|        - |  8589 | ` * int rand()` |
...
|        - |  8889 | ` */` |
|    54832 |  8890 | `static int vm_builtin_isset(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  8891 |  |
|        - |  8892 | `	ph7_value *pObj;` |
|    54834 |  8893 | `	int res = 0;` |
|        - |  8894 | `	int i;` |
|    54834 |  8895 | `	if( nArg < 1 ){` |
...
|    73456 |  8901 | `	for( i = 0 ; i < nArg ; ++i ){` |
|    54834 |  8902 | `		pObj = apArg[i];` |
|    54834 |  8903 | `		if( pObj->nIdx == SXU32_HIGH ){` |
|    36054 |  8904 | `			if( (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
|        - |  8905 | `				/* Not so fatal,Throw a warning */` |
|      ! 0 |  8906 | `				ph7_context_throw_error(pCtx,PH7_CTX_WARNING,"Expecting a variable not a constant");` |
|      ! 0 |  8907 | `			}` |
|    18026 |  8908 | `		}` |
|    54834 |  8909 | `		res = (pObj->iFlags & MEMOBJ_NULL) ? 0 : 1;` |
|    54834 |  8910 | `		if( !res ){` |
|        - |  8911 | `			/* Variable not set,return FALSE */` |
|    36212 |  8912 | `			ph7_result_bool(pCtx,0);` |
|    36212 |  8913 | `			return SXRET_OK;` |
|        - |  8914 | `		}` |
|     9313 |  8915 | `	}` |
|        - |  8916 | `	/* All given variable are set,return TRUE */` |
|    18624 |  8917 | `	ph7_result_bool(pCtx,1);` |
|    18624 |  8918 | `	return SXRET_OK;` |
|    27418 |  8919 |  |
|        - |  8920 | `/*` |
...
|        - |  8924 | ` */` |
|  2747226 |  8925 | `PH7_PRIVATE sxi32 PH7_VmUnsetMemObj(ph7_vm *pVm,sxu32 nObjIdx,int bForce)` |
|        2 |  8926 |  |
|        - |  8927 | `	ph7_value *pObj;` |
|        - |  8928 | `	VmRefObj *pRef;` |
|  2747228 |  8929 | `	pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nObjIdx);` |
|  2747228 |  8930 | `	if( pObj ){` |
|        - |  8931 | `		/* Release the object */` |
|  2747228 |  8932 | `		PH7_MemObjRelease(pObj);` |
|  1373613 |  8933 | `	}` |
|        - |  8934 | `	/* Remove old reference links */` |
|  2747228 |  8935 | `	pRef = VmRefObjExtract(&(*pVm),nObjIdx);` |
|  2747228 |  8936 | `	if( pRef ){` |
|  2747208 |  8937 | `		sxi32 iFlags = pRef->iFlags;` |
|        - |  8938 | `		/* Unlink from the reference table */` |
|  2747208 |  8939 | `		VmRefObjUnlink(&(*pVm),pRef);` |
|  2747208 |  8940 | `		if( (bForce == TRUE) \|\| (iFlags & VM_REF_IDX_KEEP) == 0 ){` |
|        - |  8941 | `			VmSlot sFree;` |
|        - |  8942 | `			/* Restore to the free list */` |
|  2747202 |  8943 | `			sFree.nIdx = nObjIdx;` |
|  2747202 |  8944 | `			sFree.pUserData = 0;` |
|  2747202 |  8945 | `			SySetPut(&pVm->aFreeObj,(const void *)&sFree);` |
|  1373600 |  8946 | `		}` |
|  1373603 |  8947 | `	}` |
|  2747228 |  8948 | `	return SXRET_OK;` |
|        2 |  8949 |  |
|        - |  8950 | `/*` |
|        - |  8951 | ` * void unset($var,...)` |
...
|        - |  8956 | ` *  Nothing.` |
|        - |  8957 | ` */` |
|     2746 |  8958 | `static int vm_builtin_unset(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  8959 |  |
|        - |  8960 | `	ph7_value *pObj;` |
|        - |  8961 | `	ph7_vm *pVm;` |
|        - |  8962 | `	int i;` |
|        - |  8963 | `	/* Point to the target VM */` |
|     2748 |  8964 | `	pVm = pCtx->pVm;` |
|        - |  8965 | `	/* Iterate and unset */` |
|     8410 |  8966 | `	for( i = 0 ; i < nArg ; ++i ){` |
|     5664 |  8967 | `		pObj = apArg[i];` |
|     5664 |  8968 | `		if( pObj->nIdx == SXU32_HIGH ){` |
|      718 |  8969 | `			if( (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
|        - |  8970 | `				/* Throw an error */` |
|      ! 0 |  8971 | `				ph7_context_throw_error(pCtx,PH7_CTX_ERR,"Expecting a variable not a constant");` |
|      ! 0 |  8972 | `			}` |
|      360 |  8973 | `		}else{` |
|     4947 |  8974 | `			sxu32 nIdx = pObj->nIdx;` |
|        - |  8975 | `			/* TICKET 1433-35: Protect the $GLOBALS array from deletion */` |
|     4947 |  8976 | `			if( nIdx != pVm->nGlobalIdx ){` |
|     4941 |  8977 | `				PH7_VmUnsetMemObj(&(*pVm),nIdx,FALSE);` |
|     2470 |  8978 | `			}` |
|        - |  8979 | `		}` |
|     2833 |  8980 | `	}` |
|     2748 |  8981 | `	return SXRET_OK;` |
|        2 |  8982 |  |
|        - |  8983 | `/*` |
...
|        - |  9087 | ` *  Nothing.` |
|        - |  9088 | ` */` |
|      240 |  9089 | `static int vm_builtin_var_dump(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  9090 |  |
|        - |  9091 | `	SyBlob sDump; /* Generated dump is stored here */` |
|        - |  9092 | `	int i;` |
|      242 |  9093 | `	SyBlobInit(&sDump,&pCtx->pVm->sAllocator);` |
|        - |  9094 | `	/* Dump one or more expressions */` |
|      488 |  9095 | `	for( i = 0 ; i < nArg ; i++ ){` |
|      248 |  9096 | `		ph7_value *pObj = apArg[i];` |
|        - |  9097 | `		/* Reset the working buffer */` |
|      248 |  9098 | `		SyBlobReset(&sDump);` |
|        - |  9099 | `		/* Dump the given expression */` |
|      248 |  9100 | `		PH7_MemObjDump(&sDump,pObj,TRUE,0,0,0);` |
|        - |  9101 | `		/* Output */` |
|      248 |  9102 | `		if( SyBlobLength(&sDump) > 0 ){` |
|      248 |  9103 | `			ph7_context_output(pCtx,(const char *)SyBlobData(&sDump),(int)SyBlobLength(&sDump));` |
|      123 |  9104 | `		}` |
|      125 |  9105 | `	}` |
|        - |  9106 | `	/* Release the working buffer */` |
|      242 |  9107 | `	SyBlobRelease(&sDump);` |
|      242 |  9108 | `	return SXRET_OK;` |
|        2 |  9109 |  |
|        - |  9110 | `/*` |
...
|        - |  9617 | ` */` |
|     7902 |  9618 | `static int vm_builtin_set_error_handler(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  9619 |  |
|     7904 |  9620 | `	ph7_vm *pVm = pCtx->pVm;` |
|        - |  9621 | `	ph7_value *pOld,*pNew;` |
|        - |  9622 | `	/* Point to the old and the new handler */` |
|     7904 |  9623 | `	pOld = &pVm->aErrCB[0];` |
|     7904 |  9624 | `	pNew = &pVm->aErrCB[1];` |
|        - |  9625 | `	/* Return the old handler */` |
|     7904 |  9626 | `	ph7_result_value(pCtx,pOld); /* Will make it's own copy */` |
|     7904 |  9627 | `	if( nArg > 0 ){` |
|     7904 |  9628 | `		if( !ph7_value_is_callable(apArg[0])) {` |
|        - |  9629 | `			/* Not callable,return TRUE (As requested by the PHP specification) */` |
|     3951 |  9630 | `			PH7_MemObjRelease(pNew);` |
|     3951 |  9631 | `			ph7_result_bool(pCtx,1);` |
|     1976 |  9632 | `		}else{` |
|     3954 |  9633 | `			PH7_MemObjStore(pNew,pOld);` |
|        - |  9634 | `			/* Install the new handler */` |
|     3954 |  9635 | `			PH7_MemObjStore(apArg[0],pNew);` |
|        - |  9636 | `		}` |
|     3951 |  9637 | `	}` |
|     7904 |  9638 | `	return PH7_OK;` |
|        2 |  9639 |  |
|        - |  9640 | `/*` |
...
|        - |  9662 | ` */` |
|      154 |  9663 | `static int vm_builtin_debug_backtrace(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  9664 |  |
|      156 |  9665 | `	ph7_vm *pVm = pCtx->pVm;` |
|        - |  9666 | `	ph7_value *pArray;` |
|        - |  9667 | `	ph7_class *pClass;` |
|        - |  9668 | `	ph7_value *pValue;` |
|        - |  9669 | `	SyString *pFile;` |
|        - |  9670 | `	/* Create a new array */` |
|      156 |  9671 | `	pArray = ph7_context_new_array(pCtx);` |
|      156 |  9672 | `	pValue = ph7_context_new_scalar(pCtx);` |
|      156 |  9673 | `	if( pArray == 0 \|\| pValue == 0 ){` |
...
|      156 |  9682 | `	if( pVm->pFrame->pParent ){` |
|      156 |  9683 | `		VmFrame *pFrame = pVm->pFrame;` |
|        - |  9684 | `		ph7_vm_func *pFunc;` |
|        - |  9685 | `		ph7_value *pArg;` |
|      156 |  9686 | `		while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|        - |  9687 | `			/* Safely ignore the exception frame */` |
|      ! 0 |  9688 | `			pFrame = pFrame->pParent;` |
|      ! 0 |  9689 | `		}` |
|      156 |  9690 | `		pFunc = (ph7_vm_func *)pFrame->pUserData;` |
|      156 |  9691 | `		if( pFrame->pParent && pFunc ){` |
|      156 |  9692 | `			ph7_value_string(pValue,pFunc->sName.zString,(int)pFunc->sName.nByte);` |
|      156 |  9693 | `			ph7_array_add_strkey_elem(pArray,"function",pValue);` |
|      156 |  9694 | `			ph7_value_reset_string_cursor(pValue);` |
|       77 |  9695 | `		}` |
|        - |  9696 | `		/* Function arguments */` |
|      156 |  9697 | `		pArg = ph7_context_new_array(pCtx);` |
|      156 |  9698 | `		if( pArg  ){` |
|        - |  9699 | `			ph7_value *pObj;` |
|        - |  9700 | `			VmSlot *aSlot;` |
|        - |  9701 | `			sxu32 n;` |
|        - |  9702 | `			/* Start filling the array with the given arguments */` |
|      156 |  9703 | `			aSlot = (VmSlot *)SySetBasePtr(&pFrame->sArg);` |
|      610 |  9704 | `			for( n = 0;  n < SySetUsed(&pFrame->sArg) ; n++ ){` |
|      456 |  9705 | `				pObj = (ph7_value *)SySetAt(&pCtx->pVm->aMemObj,aSlot[n].nIdx);` |
|      456 |  9706 | `				if( pObj ){` |
|      456 |  9707 | `					ph7_array_add_elem(pArg,0/* Automatic index assign*/,pObj);` |
|      227 |  9708 | `				}` |
|      229 |  9709 | `			}` |
|        - |  9710 | `			/* Save the array */` |
|      156 |  9711 | `			ph7_array_add_strkey_elem(pArray,"args",pArg);` |
|       77 |  9712 | `		}` |
|       77 |  9713 | `	}` |
|      156 |  9714 | `	ph7_value_int(pValue,1);` |
|        - |  9715 | `	/* Append the current line (which is always 1 since PH7 does not track` |
|        - |  9716 | `	 * line numbers at run-time. )` |
|        - |  9717 | `	 */` |
|      156 |  9718 | `	ph7_array_add_strkey_elem(pArray,"line",pValue);` |
|        - |  9719 | `	/* Current processed script */` |
|      156 |  9720 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|      156 |  9721 | `	if( pFile ){` |
|      156 |  9722 | `		ph7_value_string(pValue,pFile->zString,(int)pFile->nByte);` |
|      156 |  9723 | `		ph7_array_add_strkey_elem(pArray,"file",pValue);` |
|      156 |  9724 | `		ph7_value_reset_string_cursor(pValue);` |
|       77 |  9725 | `	}` |
|        - |  9726 | `	/* Top class */` |
|      156 |  9727 | `	pClass = PH7_VmPeekTopClass(pVm);` |
|      156 |  9728 | `	if( pClass ){` |
|      152 |  9729 | `		ph7_value_reset_string_cursor(pValue);` |
|      152 |  9730 | `		ph7_value_string(pValue,pClass->sName.zString,(int)pClass->sName.nByte);` |
|      152 |  9731 | `		ph7_array_add_strkey_elem(pArray,"class",pValue);` |
|       75 |  9732 | `	}` |
|        - |  9733 | `	/* Return the freshly created array */` |
|      156 |  9734 | `	ph7_result_value(pCtx,pArray);` |
|        - |  9735 | `	/*` |
|        - |  9736 | `	 * Don't worry about freeing memory, everything will be released automatically` |
|        - |  9737 | `	 * as soon we return from this function.` |
|        - |  9738 | `	 */` |
|      156 |  9739 | `	return PH7_OK;` |
|       79 |  9740 |  |
|        - |  9741 | `/*` |
...
|        - |  9838 | ` */` |
|      138 |  9839 | `static sxi32 VmUncaughtException(` |
...
|      139 |  9845 | `	int nArg = 1;` |
|        - |  9846 | `	sxi32 rc;` |
|      139 |  9847 | `	if( pVm->nExceptDepth > 15 ){` |
|        - |  9848 | `		/* Nesting limit reached */` |
|      ! 0 |  9849 | `		return SXRET_OK;` |
|        - |  9850 | `	}` |
|        - |  9851 | `	/* Call any exception handler if available */` |
|      139 |  9852 | `	PH7_MemObjInit(pVm,&sArg);` |
|      139 |  9853 | `	if( pThis ){` |
|        - |  9854 | `		/* Load the exception instance */` |
|      139 |  9855 | `		sArg.x.pOther = pThis;` |
|      139 |  9856 | `		pThis->iRef++;` |
|      139 |  9857 | `		MemObjSetType(&sArg,MEMOBJ_OBJ);` |
|       70 |  9858 | `	}else{` |
|      ! 0 |  9859 | `		nArg = 0;` |
|        - |  9860 | `	}` |
|      139 |  9861 | `	apArg[0] = &sArg;` |
|        - |  9862 | `	/* Call the exception handler if available */` |
|      139 |  9863 | `	pVm->nExceptDepth++;` |
|      139 |  9864 | `	rc = PH7_VmCallUserFunction(&(*pVm),&pVm->aExceptionCB[1],nArg,apArg,0);` |
|      139 |  9865 | `	pVm->nExceptDepth--;` |
|      139 |  9866 | `	if( rc != SXRET_OK ){` |
|        - |  9867 | `		SyBlob sMsgBuf;` |
|      137 |  9868 | `		const char *zClass = "Exception";` |
|      137 |  9869 | `		sxu32 nClass = (sxu32)sizeof("Exception") - 1;` |
|        - |  9870 | `		const char *zMsg;` |
|        - |  9871 | `		sxu32 nMsg;` |
|        - |  9872 | `		const char *zFuncName;` |
|        - |  9873 | `		int nFuncLen;` |
|      137 |  9874 | `		SyBlobInit(&sMsgBuf,&pVm->sAllocator);` |
|      137 |  9875 | `		if( pThis ){` |
|        - |  9876 | `			ph7_class_method *pGetMessage;` |
|        - |  9877 | `			ph7_value sMsg;` |
|        - |  9878 | `			const char *zTmp;` |
|        - |  9879 | `			int nTmp;` |
|      137 |  9880 | `			zClass = pThis->pClass->sName.zString;` |
|      137 |  9881 | `			nClass = pThis->pClass->sName.nByte;` |
|      137 |  9882 | `			pGetMessage = PH7_ClassExtractMethod(pThis->pClass,"getMessage",sizeof("getMessage")-1);` |
|      137 |  9883 | `			if( pGetMessage ){` |
|      137 |  9884 | `				PH7_MemObjInit(pVm,&sMsg);` |
|      137 |  9885 | `				if( PH7_VmCallClassMethod(&(*pVm),pThis,pGetMessage,&sMsg,0,0) == SXRET_OK ){` |
|      137 |  9886 | `					zTmp = ph7_value_to_string(&sMsg,&nTmp);` |
|      137 |  9887 | `					if( zTmp && nTmp > 0 ){` |
|      137 |  9888 | `						SyBlobAppend(&sMsgBuf,zTmp,(sxu32)nTmp);` |
|       68 |  9889 | `					}` |
|       68 |  9890 | `				}` |
|      137 |  9891 | `				PH7_MemObjRelease(&sMsg);` |
|       68 |  9892 | `			}` |
|       68 |  9893 | `		}` |
|      137 |  9894 | `		if( SyBlobLength(&sMsgBuf) == 0 ){` |
|      ! 0 |  9895 | `			SyBlobAppend(&sMsgBuf,"Unknown exception",sizeof("Unknown exception")-1);` |
|      ! 0 |  9896 | `		}` |
|      137 |  9897 | `		zMsg = (const char *)SyBlobData(&sMsgBuf);` |
|      137 |  9898 | `		nMsg = (sxu32)SyBlobLength(&sMsgBuf);` |
|      137 |  9899 | `		VmGetFrameContext(pVm,&zFuncName,&nFuncLen);` |
|      137 |  9900 | `		VmReportUncaughtException(pVm,zClass,nClass,zMsg,nMsg,zFuncName,nFuncLen);` |
|      137 |  9901 | `		SyBlobRelease(&sMsgBuf);` |
|        - |  9902 | `		/* Tell the upper layer to stop VM execution immediately  */` |
|      137 |  9903 | `		rc = SXERR_ABORT;` |
|       68 |  9904 | `	}` |
|      139 |  9905 | `	PH7_MemObjRelease(&sArg);` |
|      139 |  9906 | `	return rc;` |
|       70 |  9907 |  |
|        - |  9908 | `/*` |
|        - |  9909 | ` * Throw an user exception.` |
|        - |  9910 | ` */` |
|      152 |  9911 | `static sxi32 VmThrowException(` |
...
|      154 |  9920 | `	apException = (ph7_exception **)SySetBasePtr(&pVm->aException);` |
|      154 |  9921 | `	pException = 0;` |
|      154 |  9922 | `	pCatch = 0;` |
|      154 |  9923 | `	if( SySetUsed(&pVm->aException) > 0 ){` |
...
|      154 |  9947 | `	if( pCatch == 0 ){` |
|        - |  9948 | `		sxi32 rc;` |
|      139 |  9949 | `		rc = VmUncaughtException(&(*pVm),pThis);` |
|      139 |  9950 | `		if( rc == SXRET_OK && pException ){` |
...
|        - | 10782 | ` * information.` |
|        - | 10783 | ` */` |
|     8162 | 10784 | `static sxi32 VmEvalChunk(` |
...
|     8164 | 10793 | `	ProcConsumer xErr = 0;` |
|     8164 | 10794 | `	void *pErrData = 0;` |
|        - | 10795 | `	/* Initialize bytecode container */` |
|     8164 | 10796 | `	SySetInit(&aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|     8164 | 10797 | `	SySetAlloc(&aByteCode,0x20);` |
|        - | 10798 | `	/* Reset the code generator */` |
|     8164 | 10799 | `	if( bTrueReturn ){` |
|        - | 10800 | `		/* Included file,log compile-time errors */` |
|     6679 | 10801 | `		xErr = pVm->pEngine->xConf.xErr;` |
|     6679 | 10802 | `		pErrData = pVm->pEngine->xConf.pErrData;` |
|     3339 | 10803 | `	}` |
|     8164 | 10804 | `	PH7_ResetCodeGenerator(pVm,xErr,pErrData);` |
|        - | 10805 | `	/* Swap bytecode container */` |
|     8164 | 10806 | `	pByteCode = pVm->pByteContainer;` |
|     8164 | 10807 | `	pVm->pByteContainer = &aByteCode;` |
|        - | 10808 | `	/* Compile the chunk */` |
|     8164 | 10809 | `	PH7_CompileScript(pVm,pChunk,iFlags);` |
|    12245 | 10810 | `	if( pVm->sCodeGen.nErr > 0 ){` |
...
|        - | 10820 | `		sxi32 rc;` |
|     8162 | 10821 | `		SyHashResetLoopCursor(&pVm->hClass);` |
|   239076 | 10822 | `		while((pEntry = SyHashGetNextEntry(&pVm->hClass)) != 0 ){` |
|   226836 | 10823 | `			pClass = (ph7_class *)pEntry->pUserData;` |
|        - | 10824 | `			/* Only mount classes that haven't been mounted yet */` |
|   226836 | 10825 | `			if( !pClass->bMounted ){` |
|    45546 | 10826 | `				rc = VmMountUserClass(pVm,pClass);` |
|    45546 | 10827 | `				if( rc != SXRET_OK ){` |
...
|    22772 | 10834 | `			}` |
|        2 | 10835 | `		}` |
|     8162 | 10836 | `		if( SXRET_OK != PH7_VmEmitInstr(pVm,PH7_OP_DONE,0,0,0,0) ){` |
|        - | 10837 | `			/* Out of memory */` |
|      ! 0 | 10838 | `			if( pCtx ){` |
...
|        - | 10842 | `		}` |
|     8162 | 10843 | `		if( bTrueReturn ){` |
|        - | 10844 | `			/* Assume a boolean true return value */` |
|     6679 | 10845 | `			PH7_MemObjInitFromBool(pVm,&sResult,1);` |
|     3340 | 10846 | `		}else{` |
|        - | 10847 | `			/* Assume a null return value */` |
|     1484 | 10848 | `			PH7_MemObjInit(pVm,&sResult);` |
|        - | 10849 | `		}` |
|        - | 10850 | `		/* Execute the compiled chunk */` |
|     8162 | 10851 | `		VmLocalExec(pVm,&aByteCode,&sResult);` |
|     8162 | 10852 | `		if( pCtx ){` |
|        - | 10853 | `			/* Set the execution result */` |
|     6696 | 10854 | `			ph7_result_value(pCtx,&sResult);` |
|     3347 | 10855 | `		}` |
|     8162 | 10856 | `		PH7_MemObjRelease(&sResult);` |
|        - | 10857 | `	}` |
|     4081 | 10858 | `Cleanup:` |
|        - | 10859 | `	/* Cleanup the mess left behind */` |
|     8164 | 10860 | `	pVm->pByteContainer = pByteCode;` |
|     8164 | 10861 | `	SySetRelease(&aByteCode);` |
|     8164 | 10862 | `	return SXRET_OK;` |
|        2 | 10863 |  |
|        - | 10864 | `/*` |
...
|        - | 10895 | ` */` |
|    13352 | 10896 | `static int VmIsIncludedFile(ph7_vm *pVm,SyString *pFile)` |
|        1 | 10897 |  |
|        - | 10898 | `	SyString *aEntries;` |
|        - | 10899 | `	sxu32 n;` |
|    13353 | 10900 | `	aEntries = (SyString *)SySetBasePtr(&pVm->aIncluded);` |
|        - | 10901 | `	/* Perform a linear search */` |
| 44557943 | 10902 | `	for( n = 0 ; n < SySetUsed(&pVm->aIncluded) ; ++n ){` |
| 44544597 | 10903 | `		if( SyStringCmp(pFile,&aEntries[n],SyMemcmp) == 0 ){` |
|        - | 10904 | `			/* Already included */` |
|        7 | 10905 | `			return TRUE;` |
|        - | 10906 | `		}` |
| 22272296 | 10907 | `	}` |
|    13347 | 10908 | `	return FALSE;` |
|     6677 | 10909 |  |
|        - | 10910 | `/*` |
|        - | 10911 | ` * Push a file path in the appropriate VM container.` |
|        - | 10912 | ` */` |
|    14810 | 10913 | `PH7_PRIVATE sxi32 PH7_VmPushFilePath(ph7_vm *pVm,const char *zPath,int nLen,sxu8 bMain,sxi32 *pNew)` |
|        2 | 10914 |  |
...
|        - | 10919 | `#endif` |
|        - | 10920 | `	sxi32 rc;` |
|    14812 | 10921 | `	if( nLen < 0 ){` |
|     1460 | 10922 | `		nLen = SyStrlen(zPath);` |
|      729 | 10923 | `	}` |
|        - | 10924 | `	/* Duplicate the file path first */` |
|    14812 | 10925 | `	zDup = SyMemBackendStrDup(&pVm->sAllocator,zPath,nLen);` |
|    14812 | 10926 | `	if( zDup == 0 ){` |
...
|    14812 | 10948 | `	SyStringInitFromBuf(&sPath,zDup,nLen);` |
|    14812 | 10949 | `	if( !bMain ){` |
|    13353 | 10950 | `		if( VmIsIncludedFile(&(*pVm),&sPath) ){` |
|        - | 10951 | `			/* Already included */` |
|        7 | 10952 | `			*pNew = 0;` |
|        4 | 10953 | `		}else{` |
|        - | 10954 | `			/* Insert in the corresponding container */` |
|    13347 | 10955 | `			rc = SySetPut(&pVm->aIncluded,(const void *)&sPath);` |
|    13347 | 10956 | `			if( rc != SXRET_OK ){` |
...
|        - | 10961 | `		}` |
|     6676 | 10962 | `	}` |
|    14812 | 10963 | `	SySetPut(&pVm->aFiles,(const void *)&sPath);` |
|    14812 | 10964 | `	return SXRET_OK;` |
|     7407 | 10965 |  |
|        - | 10966 | `/*` |
...
|        - | 10977 | ` */` |
|     6684 | 10978 | `static sxi32 VmExecIncludedFile(` |
...
|     6686 | 10992 | `	pVm = pCtx->pVm;` |
|     6686 | 10993 | `	SyBlobInit(&sContents,&pVm->sAllocator);` |
|     6686 | 10994 | `	isNew = 0;` |
|        - | 10995 | `	/* Extract the associated stream */` |
|     6686 | 10996 | `	pStream = PH7_VmGetStreamDevice(pVm,&pPath->zString,pPath->nByte);` |
|        - | 10997 | `	/*` |
|        - | 10998 | `	 * Open the file or the URL [i.e: http://ph7.symisc.net/example/hello.php"]` |
|        - | 10999 | `	 * in a read-only mode.` |
|        - | 11000 | `	 */` |
|     6686 | 11001 | `	pHandle = PH7_StreamOpenHandle(pVm,pStream,pPath->zString,PH7_IO_OPEN_RDONLY,TRUE,0,TRUE,&isNew);` |
|     6686 | 11002 | `	if( pHandle == 0 ){` |
|        3 | 11003 | `		return SXERR_IO;` |
|        - | 11004 | `	}` |
|     6683 | 11005 | `	rc = SXRET_OK; /* Stupid cc warning */` |
|     6683 | 11006 | `	if( IncludeOnce && !isNew ){` |
|        - | 11007 | `		/* Already included */` |
|        5 | 11008 | `		rc = SXERR_EXISTS;` |
|        3 | 11009 | `	}else{` |
|        - | 11010 | `		/* Read the whole file contents */` |
|     6679 | 11011 | `		rc = PH7_StreamReadWholeFile(pHandle,pStream,&sContents);` |
|     6679 | 11012 | `		if( rc == SXRET_OK ){` |
|        - | 11013 | `			SyString sScript;` |
|        - | 11014 | `			/* Compile and execute the script */` |
|     6679 | 11015 | `			SyStringInitFromBuf(&sScript,SyBlobData(&sContents),SyBlobLength(&sContents));` |
|     6679 | 11016 | `			VmEvalChunk(pCtx->pVm,&(*pCtx),&sScript,0,TRUE);` |
|     3339 | 11017 | `		}` |
|        - | 11018 | `	}` |
|        - | 11019 | `	/* Pop from the set of included file */` |
|     6683 | 11020 | `	(void)SySetPop(&pVm->aFiles);` |
|        - | 11021 | `	/* Close the handle */` |
|     6683 | 11022 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|        - | 11023 | `	/* Release the working buffer */` |
|     6683 | 11024 | `	SyBlobRelease(&sContents);` |
|        - | 11025 | `#else` |
...
|     2893 | 11098 | `	while( SXRET_OK == SySetGetNextEntry(pFiles,(void **)&pEntry) ){` |
|        - | 11099 | `		const char *zBase,*zEnd;` |
|        - | 11100 | `		int iLen;` |
|        - | 11101 | `		/* reset the string cursor */` |
|     2891 | 11102 | `		ph7_value_reset_string_cursor(pWorker);` |
|        - | 11103 | `		/* Extract base name */` |
|     2891 | 11104 | `		zEnd = &pEntry->zString[pEntry->nByte - 1];` |
|        - | 11105 | `		/* Ignore trailing '/' */` |
|     4336 | 11106 | `		while( zEnd > pEntry->zString && ( (int)zEnd[0] == c \|\| (int)zEnd[0] == d ) ){` |
|      ! 0 | 11107 | `			zEnd--;` |
|      ! 0 | 11108 | `		}` |
|     2891 | 11109 | `		iLen = (int)(&zEnd[1]-pEntry->zString);` |
|    82896 | 11110 | `		while( zEnd > pEntry->zString && ( (int)zEnd[0] != c && (int)zEnd[0] != d ) ){` |
|    78561 | 11111 | `			zEnd--;` |
|        1 | 11112 | `		}` |
|     2891 | 11113 | `		zBase = (zEnd > pEntry->zString) ? &zEnd[1] : pEntry->zString;` |
|     2891 | 11114 | `		zEnd = &pEntry->zString[iLen];` |
|        - | 11115 | `		/* Copy entry name */` |
|     2891 | 11116 | `		ph7_value_string(pWorker,zBase,(int)(zEnd-zBase));` |
|        - | 11117 | `		/* Perform the insertion */` |
|     2891 | 11118 | `		ph7_array_add_elem(pArray,0/* Automatic index assign*/,pWorker); /* Will make it's own copy */` |
|        1 | 11119 | `	}` |
...
|        - | 11147 | ` */` |
|     6672 | 11148 | `static int vm_builtin_include(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 | 11149 |  |
|        - | 11150 | `	SyString sFile;` |
|        - | 11151 | `	sxi32 rc;` |
|     6674 | 11152 | `	if( nArg < 1 ){` |
|        - | 11153 | `		/* Nothing to evaluate,return NULL */` |
|      ! 0 | 11154 | `		ph7_result_null(pCtx);` |
|      ! 0 | 11155 | `		return SXRET_OK;` |
|        - | 11156 | `	}` |
|        - | 11157 | `	/* File to include */` |
|     6674 | 11158 | `	sFile.zString = ph7_value_to_string(apArg[0],(int *)&sFile.nByte);` |
|     6674 | 11159 | `	if( sFile.nByte < 1 ){` |
...
|     6674 | 11165 | `	rc = VmExecIncludedFile(&(*pCtx),&sFile,FALSE);` |
|     6674 | 11166 | `	if( rc != SXRET_OK ){` |
...
|        - | 14057 | ` */` |
|     1208 | 14058 | `static sxi32 VmRegisterSpecialFunction(ph7_vm *pVm)` |
|        2 | 14059 |  |
|        - | 14060 | `	sxi32 rc;` |
|        - | 14061 | `	sxu32 n;` |
|   151002 | 14062 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVmFunc) ; ++n ){` |
|        - | 14063 | `		/* Note that these special functions have access` |
|        - | 14064 | `		 * to the underlying virtual machine as their` |
|        - | 14065 | `		 * private data.` |
|        - | 14066 | `		 */` |
|   149794 | 14067 | `		rc = ph7_create_function(&(*pVm),aVmFunc[n].zName,aVmFunc[n].xFunc,&(*pVm));` |
|   149794 | 14068 | `		if( rc != SXRET_OK ){` |
|      ! 0 | 14069 | `			return rc;` |
|        - | 14070 | `		}` |
|    74898 | 14071 | `	}` |
|     1210 | 14072 | `	return SXRET_OK;` |
|      606 | 14073 |  |
|        - | 14074 | `/*` |
|        - | 14075 | ` * Check if the given name refer to an installed class.` |
|        - | 14076 | ` * Return a pointer to that class on success. NULL on failure.` |
|        - | 14077 | ` */` |
|     8154 | 14078 | `PH7_PRIVATE ph7_class * PH7_VmExtractClass(` |
...
|     4077 | 14090 | `		SXUNUSED(iNest);` |
|        - | 14091 | `	/* Perform a hash lookup */` |
|     8156 | 14092 | `	pEntry = SyHashGet(&pVm->hClass,(const void *)zName,nByte);` |
|        - | 14093 |  |
|     8156 | 14094 | `	if( pEntry == 0 ){` |
|        - | 14095 | `		/* No such entry,return NULL */` |
|      ! 0 | 14096 | `		return 0;` |
|        - | 14097 | `	}` |
|     8156 | 14098 | `	pClass = (ph7_class *)pEntry->pUserData;` |
|     8156 | 14099 | `	if( !iLoadable ){` |
|        - | 14100 | `		/* Return the first class seen */` |
|     7494 | 14101 | `		return pClass;` |
|      ! 0 | 14102 | `	}else{` |
|        - | 14103 | `		/* Check the collision list */` |
|      664 | 14104 | `		while(pClass){` |
|      664 | 14105 | `			if( (pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_ABSTRACT)) == 0 ){` |
|        - | 14106 | `				/* Class is loadable */` |
|      664 | 14107 | `				return pClass;` |
|        - | 14108 | `			}` |
...
|        - | 14129 | ` */` |
|  2766004 | 14130 | `static VmRefObj * VmNewRefObj(ph7_vm *pVm,sxu32 nIdx)` |
|        2 | 14131 |  |
|        - | 14132 | `	VmRefObj *pRef;` |
|        - | 14133 | `	/* Allocate a new instance */` |
|  2766006 | 14134 | `	pRef = (VmRefObj *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmRefObj));` |
|  2766006 | 14135 | `	if( pRef == 0 ){` |
|      ! 0 | 14136 | `		return 0;` |
|        - | 14137 | `	}` |
|        - | 14138 | `	/* Zero the structure */` |
|  2766006 | 14139 | `	SyZero(pRef,sizeof(VmRefObj));` |
|        - | 14140 | `	/* Initialize fields */` |
|  2766006 | 14141 | `	SySetInit(&pRef->aReference,&pVm->sAllocator,sizeof(SyHashEntry *));` |
|  2766006 | 14142 | `	SySetInit(&pRef->aArrEntries,&pVm->sAllocator,sizeof(ph7_hashmap_node *));` |
|  2766006 | 14143 | `	pRef->nIdx = nIdx;` |
|  2766006 | 14144 | `	return pRef;` |
|  1383004 | 14145 |  |
|        - | 14146 | `/*` |
|        - | 14147 | ` * Default hash function used by the reference table` |
|        - | 14148 | ` * for lookup/insertion operations.` |
|        - | 14149 | ` */` |
| 15645179 | 14150 | `static sxu32 VmRefHash(sxu32 nIdx)` |
|        2 | 14151 |  |
|        - | 14152 | `	/* Calculate the hash based on the memory object index */` |
| 15645181 | 14153 | `	return nIdx ^ (nIdx << 8) ^ (nIdx >> 8);` |
|        2 | 14154 |  |
|        - | 14155 | `/*` |
...
|        - | 14165 | ` * extension.` |
|        - | 14166 | ` */` |
|  8271418 | 14167 | `static VmRefObj * VmRefObjExtract(ph7_vm *pVm,sxu32 nObjIdx)` |
|        2 | 14168 |  |
|        - | 14169 | `	VmRefObj *pRef;` |
|        - | 14170 | `	sxu32 nBucket;` |
|        - | 14171 | `	/* Point to the appropriate bucket */` |
|  8271420 | 14172 | `	nBucket = VmRefHash(nObjIdx) & (pVm->nRefSize - 1);` |
|        - | 14173 | `	/* Perform the lookup */` |
|  8271420 | 14174 | `	pRef = pVm->apRefObj[nBucket];` |
| 17030397 | 14175 | `	for(;;){` |
| 34061316 | 14176 | `		if( pRef == 0 ){` |
|  2821430 | 14177 | `			break;` |
|        - | 14178 | `		}` |
| 31239888 | 14179 | `		if( pRef->nIdx == nObjIdx ){` |
|        - | 14180 | `			/* Entry found */` |
|  5449992 | 14181 | `			return pRef;` |
|        - | 14182 | `		}` |
|        - | 14183 | `		/* Point to the next entry */` |
| 25789898 | 14184 | `		pRef = pRef->pNextCollide;` |
|        2 | 14185 | `	}` |
|        - | 14186 | `	/* No such entry,return NULL */` |
|  2821430 | 14187 | `	return 0;` |
|  4135711 | 14188 |  |
|        - | 14189 | `/*` |
...
|        - | 14197 | ` * extension.` |
|        - | 14198 | ` */` |
|  2766004 | 14199 | `static sxi32 VmRefObjInsert(ph7_vm *pVm,VmRefObj *pRef)` |
|        2 | 14200 |  |
|        - | 14201 | `	sxu32 nBucket;` |
|  2766006 | 14202 | `	if( pVm->nRefUsed * 3 >= pVm->nRefSize ){` |
|        - | 14203 | `		VmRefObj **apNew;` |
|        - | 14204 | `		sxu32 nNew;` |
|        - | 14205 | `		/* Allocate a larger table */` |
|     1662 | 14206 | `		nNew = pVm->nRefSize << 1;` |
|     1662 | 14207 | `		apNew = (VmRefObj **)SyMemBackendAlloc(&pVm->sAllocator,sizeof(VmRefObj *) * nNew);` |
|     1662 | 14208 | `		if( apNew ){` |
|     1662 | 14209 | `			VmRefObj *pEntry = pVm->pRefList;` |
|        - | 14210 | `			sxu32 n;` |
|        - | 14211 | `			/* Zero the structure */` |
|     1662 | 14212 | `			SyZero((void *)apNew,nNew * sizeof(VmRefObj *));` |
|        - | 14213 | `			/* Rehash all referenced entries */` |
|  2812958 | 14214 | `			for( n = 0 ; n < pVm->nRefUsed ; ++n ){` |
|        - | 14215 | `				/* Remove old collision links */` |
|  2811298 | 14216 | `				pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|        - | 14217 | `				/* Point to the appropriate bucket */` |
|  2811298 | 14218 | `				nBucket = VmRefHash(pEntry->nIdx) & (nNew - 1);` |
|        - | 14219 | `				/* Insert the entry  */` |
|  2811298 | 14220 | `				pEntry->pNextCollide = apNew[nBucket];` |
|  2811298 | 14221 | `				if( apNew[nBucket] ){` |
|  2298042 | 14222 | `					apNew[nBucket]->pPrevCollide = pEntry;` |
|  1149020 | 14223 | `				}` |
|  2811298 | 14224 | `				apNew[nBucket] = pEntry;` |
|        - | 14225 | `				/* Point to the next entry */` |
|  2811298 | 14226 | `				pEntry = pEntry->pNext;` |
|  1405650 | 14227 | `			}` |
|        - | 14228 | `			/* Release the old table */` |
|     1662 | 14229 | `			SyMemBackendFree(&pVm->sAllocator,pVm->apRefObj);` |
|        - | 14230 | `			/* Install the new one */` |
|     1662 | 14231 | `			pVm->apRefObj = apNew;` |
|     1662 | 14232 | `			pVm->nRefSize = nNew;` |
|      830 | 14233 | `		}` |
|      830 | 14234 | `	}` |
|        - | 14235 | `	/* Point to the appropriate bucket */` |
|  2766006 | 14236 | `	nBucket = VmRefHash(pRef->nIdx) & (pVm->nRefSize - 1);` |
|        - | 14237 | `	/* Insert the entry */` |
|  2766006 | 14238 | `	pRef->pNextCollide = pVm->apRefObj[nBucket];` |
|  2766006 | 14239 | `	if( pVm->apRefObj[nBucket] ){` |
|  2290494 | 14240 | `		pVm->apRefObj[nBucket]->pPrevCollide = pRef;` |
|  1144811 | 14241 | `	}` |
|  2766006 | 14242 | `	pVm->apRefObj[nBucket] = pRef;` |
|  2766006 | 14243 | `	MACRO_LD_PUSH(pVm->pRefList,pRef);` |
|  2766006 | 14244 | `	pVm->nRefUsed++;` |
|  2766006 | 14245 | `	return SXRET_OK;` |
|        2 | 14246 |  |
|        - | 14247 | `/*` |
...
|        - | 14257 | ` * extension.` |
|        - | 14258 | ` */` |
|  2747206 | 14259 | `static sxi32 VmRefObjUnlink(ph7_vm *pVm,VmRefObj *pRef)` |
|        2 | 14260 |  |
|        - | 14261 | `	ph7_hashmap_node **apNode;` |
|        - | 14262 | `	SyHashEntry **apEntry;` |
|        - | 14263 | `	sxu32 n;` |
|        - | 14264 | `	/* Point to the reference table */` |
|  2747208 | 14265 | `	apNode = (ph7_hashmap_node **)SySetBasePtr(&pRef->aArrEntries);` |
|  2747208 | 14266 | `	apEntry = (SyHashEntry **)SySetBasePtr(&pRef->aReference);` |
|        - | 14267 | `	/* Unlink the entry from the reference table */` |
|  2806986 | 14268 | `	for( n = 0 ; n < SySetUsed(&pRef->aReference) ; n++ ){` |
|    59780 | 14269 | `		if( apEntry[n] ){` |
|    59748 | 14270 | `			SyHashDeleteEntry2(apEntry[n]);` |
|    29873 | 14271 | `		}` |
|    29891 | 14272 | `	}` |
|  5437954 | 14273 | `	for(n = 0 ; n < SySetUsed(&pRef->aArrEntries) ; ++n ){` |
|  2690748 | 14274 | `		if( apNode[n] ){` |
|     5043 | 14275 | `			PH7_HashmapUnlinkNode(apNode[n],FALSE);` |
|     2521 | 14276 | `		}` |
|  1345375 | 14277 | `	}` |
|  2747208 | 14278 | `	if( pRef->pPrevCollide ){` |
|   950747 | 14279 | `		pRef->pPrevCollide->pNextCollide = pRef->pNextCollide;` |
|   475593 | 14280 | `	}else{` |
|  1796463 | 14281 | `		pVm->apRefObj[VmRefHash(pRef->nIdx) & (pVm->nRefSize - 1)] = pRef->pNextCollide;` |
|        - | 14282 | `	}` |
|  2747208 | 14283 | `	if( pRef->pNextCollide ){` |
|  1490379 | 14284 | `		pRef->pNextCollide->pPrevCollide = pRef->pPrevCollide;` |
|   744810 | 14285 | `	}` |
|  2747208 | 14286 | `	MACRO_LD_REMOVE(pVm->pRefList,pRef);` |
|        - | 14287 | `	/* Release the node */` |
|  2747208 | 14288 | `	SySetRelease(&pRef->aReference);` |
|  2747208 | 14289 | `	SySetRelease(&pRef->aArrEntries);` |
|  2747208 | 14290 | `	SyMemBackendPoolFree(&pVm->sAllocator,pRef);` |
|  2747208 | 14291 | `	pVm->nRefUsed--;` |
|  2747208 | 14292 | `	return SXRET_OK;` |
|        2 | 14293 |  |
|        - | 14294 | `/*` |
...
|        - | 14301 | ` * extension.` |
|        - | 14302 | ` */` |
|  2783046 | 14303 | `PH7_PRIVATE sxi32 PH7_VmRefObjInstall(` |
...
|        - | 14309 | `	)` |
|        2 | 14310 |  |
|  2783048 | 14311 | `	VmFrame *pFrame = pVm->pFrame;` |
|        - | 14312 | `	VmRefObj *pRef;` |
|        - | 14313 | `	/* Check if the referenced object already exists */` |
|  2783048 | 14314 | `	pRef = VmRefObjExtract(&(*pVm),nIdx);` |
|  2783048 | 14315 | `	if( pRef == 0 ){` |
|        - | 14316 | `		/* Create a new entry */` |
|  2766006 | 14317 | `		pRef = VmNewRefObj(&(*pVm),nIdx);` |
|  2766006 | 14318 | `		if( pRef == 0 ){` |
|      ! 0 | 14319 | `			return SXERR_MEM;` |
|        - | 14320 | `		}` |
|  2766006 | 14321 | `		pRef->iFlags = iFlags;` |
|        - | 14322 | `		/* Install the entry */` |
|  2766006 | 14323 | `		VmRefObjInsert(&(*pVm),pRef);` |
|  1383002 | 14324 | `	}` |
|  2787960 | 14325 | `	while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|        - | 14326 | `		/* Safely ignore the exception frame */` |
|     4914 | 14327 | `		pFrame = pFrame->pParent;` |
|        2 | 14328 | `	}` |
|  2783048 | 14329 | `	if( pFrame->pParent != 0 && pEntry ){` |
|        - | 14330 | `		VmSlot sRef;` |
|        - | 14331 | `		/* Local frame,record referenced entry so that it can` |
|        - | 14332 | `		 * be deleted when we leave this frame.` |
|        - | 14333 | `		 */` |
|    55438 | 14334 | `		sRef.nIdx = nIdx;` |
|    55438 | 14335 | `		sRef.pUserData = pEntry;` |
|    55438 | 14336 | `		if( SXRET_OK != SySetPut(&pFrame->sRef,(const void *)&sRef)) {` |
|      ! 0 | 14337 | `			pEntry = 0; /* Do not record this entry */` |
|      ! 0 | 14338 | `		}` |
|    27718 | 14339 | `	}` |
|  2783048 | 14340 | `	if( pEntry ){` |
|        - | 14341 | `		/* Address of the hash-entry */` |
|    72314 | 14342 | `		SySetPut(&pRef->aReference,(const void *)&pEntry);` |
|    36156 | 14343 | `	}` |
|  2783048 | 14344 | `	if( pMapEntry ){` |
|        - | 14345 | `		/* Address of the hashmap node [i.e: Array entry] */` |
|  2708000 | 14346 | `		SySetPut(&pRef->aArrEntries,(const void *)&pMapEntry);` |
|  1353999 | 14347 | `	}` |
|  2783048 | 14348 | `	return SXRET_OK;` |
|  1391525 | 14349 |  |
|        - | 14350 | `/*` |
...
|        - | 14357 | ` * extension.` |
|        - | 14358 | ` */` |
|  2741146 | 14359 | `PH7_PRIVATE sxi32 PH7_VmRefObjRemove(` |
...
|  2741148 | 14369 | `	pRef = VmRefObjExtract(&(*pVm),nIdx);` |
|  2741148 | 14370 | `	if( pRef == 0 ){` |
|        - | 14371 | `		/* Not such entry */` |
|    55406 | 14372 | `		return SXERR_NOTFOUND;` |
|        - | 14373 | `	}` |
|        - | 14374 | `	/* Remove the desired entry */` |
|  2685744 | 14375 | `	if( pEntry ){` |
...
|       49 | 14388 | `		}` |
|       16 | 14389 | `	}` |
|  2685744 | 14390 | `	if( pMapEntry ){` |
|        - | 14391 | `		ph7_hashmap_node **apNode;` |
|  2685712 | 14392 | `		apNode = (ph7_hashmap_node **)SySetBasePtr(&pRef->aArrEntries);` |
|  5371510 | 14393 | `		for(n = 0 ; n < SySetUsed(&pRef->aArrEntries) ; n++ ){` |
|  2685800 | 14394 | `			if( apNode[n] == pMapEntry ){` |
|        - | 14395 | `				/* nullify the entry */` |
|  2685712 | 14396 | `				apNode[n] = 0;` |
|  1342855 | 14397 | `			}` |
|  1342901 | 14398 | `		}` |
|  1342855 | 14399 | `	}` |
|  2685744 | 14400 | `	return SXRET_OK;` |
|  1370575 | 14401 |  |
...
|        - | 14410 | ` */` |
|    19226 | 14411 | `PH7_PRIVATE const ph7_io_stream * PH7_VmGetStreamDevice(` |
...
|    19228 | 14423 | `	zNext = zCur = zIn = *pzDevice;` |
|    19228 | 14424 | `	zEnd = &zIn[nByte];` |
|  1182154 | 14425 | `	while( zIn < zEnd ){` |
|  1162930 | 14426 | `		if( zIn < &zEnd[-3]/*://*/ && zIn[0] == ':' && zIn[1] == '/' && zIn[2] == '/' ){` |
|        - | 14427 | `			/* Got one */` |
...
|  1162928 | 14432 | `		zIn++;` |
|        2 | 14433 | `	}` |
|    19228 | 14434 | `	if( zIn >= zEnd ){` |
|        - | 14435 | `		/* No such scheme,return the default stream */` |
|    19226 | 14436 | `		return pVm->pDefStream;` |
|        - | 14437 | `	}` |
