...
|        - |   114 | ` */` |
|   732698 |   115 | `static sxi32 VmIsUnorderedCmp(ph7_value *pLeft,ph7_value *pRight)` |
|        2 |   116 |  |
|   732700 |   117 | `	if( (pLeft->iFlags & MEMOBJ_REAL) && PH7_IS_NAN(pLeft->rVal) ){` |
|       23 |   118 | `		return TRUE;` |
|        - |   119 | `	}` |
|   732678 |   120 | `	if( (pRight->iFlags & MEMOBJ_REAL) && PH7_IS_NAN(pRight->rVal) ){` |
|        9 |   121 | `		return TRUE;` |
|        - |   122 | `	}` |
|   732670 |   123 | `	return FALSE;` |
|   366373 |   124 |  |
|        - |   125 | `/*` |
...
|        - |   182 | ` */` |
|   334530 |   183 | `PH7_PRIVATE sxi32 PH7_VmRegisterConstant(` |
...
|        - |   192 | `	char *zDupName;` |
|        - |   193 | `	sxi32 rc;` |
|   334532 |   194 | `	pEntry = SyHashGet(&pVm->hConstant,(const void *)pName->zString,pName->nByte);` |
|   334532 |   195 | `	if( pEntry ){` |
...
|   334528 |   203 | `	pCons = (ph7_constant *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_constant));` |
|   334528 |   204 | `	if( pCons == 0 ){` |
|      ! 0 |   205 | `		return 0;` |
|        - |   206 | `	}` |
|        - |   207 | `	/* Duplicate constant name */` |
|   334528 |   208 | `	zDupName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|   334528 |   209 | `	if( zDupName == 0 ){` |
|      ! 0 |   210 | `		SyMemBackendPoolFree(&pVm->sAllocator,pCons);` |
|      ! 0 |   211 | `		return 0;` |
|        - |   212 | `	}` |
|        - |   213 | `	/* Install the constant */` |
|   334528 |   214 | `	SyStringInitFromBuf(&pCons->sName,zDupName,pName->nByte);` |
|   334528 |   215 | `	pCons->xExpand = xExpand;` |
|   334528 |   216 | `	pCons->pUserData = pUserData;` |
|   334528 |   217 | `	rc = SyHashInsert(&pVm->hConstant,(const void *)zDupName,SyStringLength(&pCons->sName),pCons);` |
|   334528 |   218 | `	if( rc != SXRET_OK ){` |
...
|        - |   232 | ` */` |
|   720360 |   233 | `static sxi32 PH7_NewForeignFunction(` |
...
|   720362 |   244 | `	pFunc = (ph7_user_func *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_user_func));` |
|   720362 |   245 | `	if( pFunc == 0 ){` |
|      ! 0 |   246 | `		return SXERR_MEM;` |
|        - |   247 | `	}` |
|        - |   248 | `	/* Duplicate function name */` |
|   720362 |   249 | `	zDup = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|   720362 |   250 | `	if( zDup == 0 ){` |
|      ! 0 |   251 | `		SyMemBackendPoolFree(&pVm->sAllocator,pFunc);` |
|      ! 0 |   252 | `		return SXERR_MEM;` |
|        - |   253 | `	}` |
|        - |   254 | `	/* Zero the structure */` |
|   720362 |   255 | `	SyZero(pFunc,sizeof(ph7_user_func));` |
|        - |   256 | `	/* Initialize structure fields */` |
|   720362 |   257 | `	SyStringInitFromBuf(&pFunc->sName,zDup,pName->nByte);` |
|   720362 |   258 | `	pFunc->pVm   = pVm;` |
|   720362 |   259 | `	pFunc->xFunc = xFunc;` |
|   720362 |   260 | `	pFunc->pUserData = pUserData;` |
|   720362 |   261 | `	SySetInit(&pFunc->aAux,&pVm->sAllocator,sizeof(ph7_aux_data));` |
|        - |   262 | `	/* Write a pointer to the new function */` |
|   720362 |   263 | `	*ppOut = pFunc;` |
|   720362 |   264 | `	return SXRET_OK;` |
|   360182 |   265 |  |
|        - |   266 | `/*` |
...
|        - |   273 | ` */` |
|   722016 |   274 | `PH7_PRIVATE sxi32 PH7_VmInstallForeignFunction(` |
...
|   722018 |   285 | `	pEntry = SyHashGet(&pVm->hHostFunction,pName->zString,pName->nByte);` |
|   722018 |   286 | `	if( pEntry ){` |
|     1658 |   287 | `		pFunc = (ph7_user_func *)pEntry->pUserData;` |
|     1658 |   288 | `		pFunc->pUserData = pUserData;` |
|     1658 |   289 | `		pFunc->xFunc = xFunc;` |
|     1658 |   290 | `		SySetReset(&pFunc->aAux);` |
|     1658 |   291 | `		return SXRET_OK;` |
|        - |   292 | `	}` |
|        - |   293 | `	/* Create a new user function */` |
|   720362 |   294 | `	rc = PH7_NewForeignFunction(&(*pVm),&(*pName),xFunc,pUserData,&pFunc);` |
|   720362 |   295 | `	if( rc != SXRET_OK ){` |
|      ! 0 |   296 | `		return rc;` |
|        - |   297 | `	}` |
|        - |   298 | `	/* Install the function in the corresponding hashtable */` |
|   720362 |   299 | `	rc = SyHashInsert(&pVm->hHostFunction,SyStringData(&pFunc->sName),pName->nByte,pFunc);` |
|   720362 |   300 | `	if( rc != SXRET_OK ){` |
...
|   720362 |   306 | `	return SXRET_OK;` |
|   361010 |   307 |  |
|        - |   308 | `/*` |
|        - |   309 | ` * Initialize a VM function.` |
|        - |   310 | ` */` |
|    80218 |   311 | `PH7_PRIVATE sxi32 PH7_VmInitFuncState(` |
...
|    80220 |   321 | `	SyZero(pFunc,sizeof(ph7_vm_func));` |
|        - |   322 | `	/* Initialize structure fields */` |
|        - |   323 | `	/* Arguments container */` |
|    80220 |   324 | `	SySetInit(&pFunc->aArgs,&pVm->sAllocator,sizeof(ph7_vm_func_arg));` |
|        - |   325 | `	/* Static variable container */` |
|    80220 |   326 | `	SySetInit(&pFunc->aStatic,&pVm->sAllocator,sizeof(ph7_vm_func_static_var));` |
|        - |   327 | `	/* Bytecode container */` |
|    80220 |   328 | `	SySetInit(&pFunc->aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|        - |   329 | `    /* Preallocate some instruction slots */` |
|    80220 |   330 | `	SySetAlloc(&pFunc->aByteCode,0x10);` |
|        - |   331 | `	/* Closure environment */` |
|    80220 |   332 | `	SySetInit(&pFunc->aClosureEnv,&pVm->sAllocator,sizeof(ph7_vm_func_closure_env));` |
|    80220 |   333 | `	pFunc->iFlags = iFlags;` |
|    80220 |   334 | `	pFunc->pUserData = pUserData;` |
|    80220 |   335 | `	SyStringInitFromBuf(&pFunc->sName,zName,nByte);` |
|    80220 |   336 | `	return SXRET_OK;` |
|        2 |   337 |  |
|        - |   338 | `/*` |
|        - |   339 | ` * Install a user defined function in the corresponding VM container.` |
|        - |   340 | ` */` |
|   256060 |   341 | `PH7_PRIVATE sxi32 PH7_VmInstallUserFunction(` |
...
|        - |   348 | `	sxi32 rc;` |
|   256062 |   349 | `	if( pName == 0 ){` |
|        - |   350 | `		/* Use the built-in name */` |
|    25078 |   351 | `		pName = &pFunc->sName;` |
|    12538 |   352 | `	}` |
|        - |   353 | `	/* Check for duplicates (functions with the same name) first */` |
|   256062 |   354 | `	pEntry = SyHashGet(&pVm->hFunction,pName->zString,pName->nByte);` |
|   256062 |   355 | `	if( pEntry ){` |
|   191202 |   356 | `		ph7_vm_func *pLink = (ph7_vm_func *)pEntry->pUserData;` |
|   191202 |   357 | `		if( pLink != pFunc ){` |
|        - |   358 | `			/* Link */` |
|      179 |   359 | `			pFunc->pNextName = pLink;` |
|      179 |   360 | `			pEntry->pUserData = pFunc;` |
|       89 |   361 | `		}` |
|   191202 |   362 | `		return SXRET_OK;` |
|        - |   363 | `	}` |
|        - |   364 | `	/* First time seen */` |
|    64862 |   365 | `	pFunc->pNextName = 0;` |
|    64862 |   366 | `	rc = SyHashInsert(&pVm->hFunction,pName->zString,pName->nByte,pFunc);` |
|    64862 |   367 | `	return rc;` |
|   128032 |   368 |  |
|        - |   369 | `/*` |
|        - |   370 | ` * Install a user defined class in the corresponding VM container.` |
|        - |   371 | ` */` |
|    21092 |   372 | `PH7_PRIVATE sxi32 PH7_VmInstallClass(` |
|        - |   373 | `	ph7_vm *pVm,      /* Target VM  */` |
|        - |   374 | `	ph7_class *pClass /* Target Class */` |
|        - |   375 | `	)` |
|        2 |   376 |  |
|    21094 |   377 | `	SyString *pName = &pClass->sName;` |
|        - |   378 | `	SyHashEntry *pEntry;` |
|        - |   379 | `	sxi32 rc;` |
|        - |   380 | `	/* Check for duplicates */` |
|    21094 |   381 | `	pEntry = SyHashGet(&pVm->hClass,(const void *)pName->zString,pName->nByte);` |
|    21094 |   382 | `	if( pEntry ){` |
...
|        - |   388 | `	}` |
|    21064 |   389 | `	pClass->pNextName = 0;` |
|        - |   390 | `	/* Perform a simple hashtable insertion */` |
|    21064 |   391 | `	rc = SyHashInsert(&pVm->hClass,(const void *)pName->zString,pName->nByte,pClass);` |
|    21064 |   392 | `	return rc;` |
|    10548 |   393 |  |
|        - |   394 | `/*` |
|        - |   395 | ` * Instruction builder interface.` |
|        - |   396 | ` */` |
|  2001604 |   397 | `PH7_PRIVATE sxi32 PH7_VmEmitInstr(` |
...
|  2001606 |   409 | `	sInstr.iOp = (sxu8)iOp;` |
|  2001606 |   410 | `	sInstr.iP1 = iP1;` |
|  2001606 |   411 | `	sInstr.iP2 = iP2;` |
|  2001606 |   412 | `	sInstr.p3  = p3;` |
|  2001606 |   413 | `	if( pIndex ){` |
|        - |   414 | `		/* Instruction index in the bytecode array */` |
|   121860 |   415 | `		*pIndex = SySetUsed(pVm->pByteContainer);` |
|    60929 |   416 | `	}` |
|        - |   417 | `	/* Finally,record the instruction */` |
|  2001606 |   418 | `	rc = SySetPut(pVm->pByteContainer,(const void *)&sInstr);` |
|  2001606 |   419 | `	if( rc != SXRET_OK ){` |
|      ! 0 |   420 | `		PH7_GenCompileError(&pVm->sCodeGen,E_ERROR,1,"Fatal,Cannot emit instruction due to a memory failure");` |
|        - |   421 | `		/* Fall throw */` |
|      ! 0 |   422 | `	}` |
|  2001606 |   423 | `	return rc;` |
|        2 |   424 |  |
|        - |   425 | `/*` |
|        - |   426 | ` * Swap the current bytecode container with the given one.` |
|        - |   427 | ` */` |
|   195024 |   428 | `PH7_PRIVATE sxi32 PH7_VmSetByteCodeContainer(ph7_vm *pVm,SySet *pContainer)` |
|        2 |   429 |  |
|   195026 |   430 | `	if( pContainer == 0 ){` |
|        - |   431 | `		/* Point to the default container */` |
|      ! 0 |   432 | `		pVm->pByteContainer = &pVm->aByteCode;` |
|      ! 0 |   433 | `	}else{` |
|        - |   434 | `		/* Change container */` |
|   195026 |   435 | `		pVm->pByteContainer = &(*pContainer);` |
|        - |   436 | `	}` |
|   195026 |   437 | `	return SXRET_OK;` |
|        2 |   438 |  |
|        - |   439 | `/*` |
|        - |   440 | ` * Return the current bytecode container.` |
|        - |   441 | ` */` |
|    97512 |   442 | `PH7_PRIVATE SySet * PH7_VmGetByteCodeContainer(ph7_vm *pVm)` |
|        2 |   443 |  |
|    97514 |   444 | `	return pVm->pByteContainer;` |
|        2 |   445 |  |
|        - |   446 | `/*` |
|        - |   447 | ` * Extract the VM instruction rooted at nIndex.` |
|        - |   448 | ` */` |
|   119888 |   449 | `PH7_PRIVATE VmInstr * PH7_VmGetInstr(ph7_vm *pVm,sxu32 nIndex)` |
|        2 |   450 |  |
|        - |   451 | `	VmInstr *pInstr;` |
|   119890 |   452 | `	pInstr = (VmInstr *)SySetAt(pVm->pByteContainer,nIndex);` |
|   119890 |   453 | `	return pInstr;` |
|        2 |   454 |  |
|        - |   455 | `/*` |
|        - |   456 | ` * Return the total number of VM instructions recorded so far.` |
|        - |   457 | ` */` |
|   581506 |   458 | `PH7_PRIVATE sxu32 PH7_VmInstrLength(ph7_vm *pVm)` |
|        2 |   459 |  |
|   581508 |   460 | `	return SySetUsed(pVm->pByteContainer);` |
|        2 |   461 |  |
|        - |   462 | `/*` |
|        - |   463 | ` * Pop the last VM instruction.` |
|        - |   464 | ` */` |
|   116598 |   465 | `PH7_PRIVATE VmInstr * PH7_VmPopInstr(ph7_vm *pVm)` |
|        2 |   466 |  |
|   116600 |   467 | `	return (VmInstr *)SySetPop(pVm->pByteContainer);` |
|        2 |   468 |  |
|        - |   469 | `/*` |
|        - |   470 | ` * Peek the last VM instruction.` |
|        - |   471 | ` */` |
|   310632 |   472 | `PH7_PRIVATE VmInstr * PH7_VmPeekInstr(ph7_vm *pVm)` |
|        2 |   473 |  |
|   310634 |   474 | `	return (VmInstr *)SySetPeek(pVm->pByteContainer);` |
|        2 |   475 |  |
|     7802 |   476 | `PH7_PRIVATE VmInstr * PH7_VmPeekNextInstr(ph7_vm *pVm)` |
|        2 |   477 |  |
|        - |   478 | `	VmInstr *aInstr;` |
|        - |   479 | `	sxu32 n;` |
|     7804 |   480 | `	n = SySetUsed(pVm->pByteContainer);` |
|     7804 |   481 | `	if( n < 2 ){` |
|      ! 0 |   482 | `		return 0;` |
|        - |   483 | `	}` |
|     7804 |   484 | `	aInstr = (VmInstr *)SySetBasePtr(pVm->pByteContainer);` |
|     7804 |   485 | `	return &aInstr[n - 2];` |
|     3903 |   486 |  |
|        - |   487 | `/*` |
|        - |   488 | ` * Allocate a new virtual machine frame.` |
|        - |   489 | ` */` |
|    12472 |   490 | `static VmFrame * VmNewFrame(` |
...
|    12474 |   498 | `	pFrame = (VmFrame *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmFrame));` |
|    12474 |   499 | `	if( pFrame == 0 ){` |
|      ! 0 |   500 | `		return 0;` |
|        - |   501 | `	}` |
|        - |   502 | `	/* Zero the structure */` |
|    12474 |   503 | `	SyZero(pFrame,sizeof(VmFrame));` |
|        - |   504 | `	/* Initialize frame fields */` |
|    12474 |   505 | `	pFrame->pUserData = pUserData;` |
|    12474 |   506 | `	pFrame->pThis = pThis;` |
|    12474 |   507 | `	pFrame->pVm = pVm;` |
|    12474 |   508 | `	SyHashInit(&pFrame->hVar,&pVm->sAllocator,0,0);` |
|    12474 |   509 | `	SySetInit(&pFrame->sArg,&pVm->sAllocator,sizeof(VmSlot));` |
|    12474 |   510 | `	SySetInit(&pFrame->sLocal,&pVm->sAllocator,sizeof(VmSlot));` |
|    12474 |   511 | `	SySetInit(&pFrame->sRef,&pVm->sAllocator,sizeof(VmSlot));` |
|    12474 |   512 | `	return pFrame;` |
|     6238 |   513 |  |
|        - |   514 | `/*` |
|        - |   515 | ` * Enter a VM frame.` |
|        - |   516 | ` */` |
|    12472 |   517 | `static sxi32 VmEnterFrame(` |
...
|    12474 |   526 | `	pFrame = VmNewFrame(&(*pVm),pUserData,pThis);` |
|    12474 |   527 | `	if( pFrame == 0 ){` |
|      ! 0 |   528 | `		return SXERR_MEM;` |
|        - |   529 | `	}` |
|        - |   530 | `	/* Link to the list of active VM frame */` |
|    12474 |   531 | `	pFrame->pParent = pVm->pFrame;` |
|    12474 |   532 | `	pVm->pFrame = pFrame;` |
|    12474 |   533 | `	if( ppFrame ){` |
|        - |   534 | `		/* Write a pointer to the new VM frame */` |
|    10580 |   535 | `		*ppFrame = pFrame;` |
|     5289 |   536 | `	}` |
|    12474 |   537 | `	return SXRET_OK;` |
|     6238 |   538 |  |
|        - |   539 | `/*` |
...
|        - |   584 | ` */` |
|    10576 |   585 | `static void VmLeaveFrame(ph7_vm *pVm)` |
|        2 |   586 |  |
|    10578 |   587 | `		VmFrame *pCurFrame = pVm->pFrame;` |
|    10578 |   588 | `	if( pCurFrame ){` |
|        - |   589 | `		/* Unlink from the list of active VM frame */` |
|    10578 |   590 | `		pVm->pFrame = pCurFrame->pParent;` |
|    10578 |   591 | `		if( pCurFrame->pParent && (pCurFrame->iFlags & VM_FRAME_EXCEPTION) == 0 ){` |
|        - |   592 | `			VmSlot  *aSlot;` |
|        - |   593 | `			sxu32 n;` |
|        - |   594 | `			/* Restore local variable to the free pool so that they can be reused again */` |
|    10560 |   595 | `			aSlot = (VmSlot *)SySetBasePtr(&pCurFrame->sLocal);` |
|    76864 |   596 | `			for(n = 0 ; n < SySetUsed(&pCurFrame->sLocal) ; ++n ){` |
|        - |   597 | `				/* Unset the local variable */` |
|    66306 |   598 | `				PH7_VmUnsetMemObj(&(*pVm),aSlot[n].nIdx,FALSE);` |
|    33154 |   599 | `			}` |
|        - |   600 | `			/* Remove local reference */` |
|    10560 |   601 | `			aSlot = (VmSlot *)SySetBasePtr(&pCurFrame->sRef);` |
|    76916 |   602 | `			for(n = 0 ; n < SySetUsed(&pCurFrame->sRef) ; ++n ){` |
|    66358 |   603 | `				PH7_VmRefObjRemove(&(*pVm),aSlot[n].nIdx,(SyHashEntry *)aSlot[n].pUserData,0);` |
|    33180 |   604 | `			}` |
|     5279 |   605 | `		}` |
|        - |   606 | `		/* Release internal containers */` |
|    10578 |   607 | `		SyHashRelease(&pCurFrame->hVar);` |
|    10578 |   608 | `		SySetRelease(&pCurFrame->sArg);` |
|    10578 |   609 | `		SySetRelease(&pCurFrame->sLocal);` |
|    10578 |   610 | `		SySetRelease(&pCurFrame->sRef);` |
|        - |   611 | `		/* Release the whole structure */` |
|    10578 |   612 | `		SyMemBackendPoolFree(&pVm->sAllocator,pCurFrame);` |
|     5288 |   613 | `	}` |
|    10578 |   614 |  |
|        - |   615 | `/*` |
...
|        - |   731 | ` */` |
|    70712 |   732 | `PH7_PRIVATE sxi32 VmMountUserClass(` |
...
|    70714 |   742 | `	SyHashResetLoopCursor(&pClass->hAttr);` |
|        - |   743 | `	/* Process only static and constant attribute */` |
|   249546 |   744 | `	while( (pEntry = SyHashGetNextEntry(&pClass->hAttr)) != 0 ){` |
|        - |   745 | `		/* Extract the current attribute */` |
|   143478 |   746 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|   143478 |   747 | `		if( pAttr->iFlags & (PH7_CLASS_ATTR_CONSTANT\|PH7_CLASS_ATTR_STATIC) ){` |
...
|    70714 |   769 | `	if( pClass->iFlags & PH7_CLASS_INTERFACE ){` |
|        - |   770 | `		/* Do not mount interface methods since they are signatures only.` |
|        - |   771 | `		 */` |
|    42080 |   772 | `		return SXRET_OK;` |
|        - |   773 | `	}` |
|        - |   774 | `	/* Create constructor alias if not yet done */` |
|    28636 |   775 | `	if( SyHashGet(&pClass->hMethod,"__construct",sizeof("__construct")-1) == 0 ){` |
...
|    28636 |   785 | `	SyHashResetLoopCursor(&pClass->hMethod);` |
|   273943 |   786 | `	while((pEntry = SyHashGetNextEntry(&pClass->hMethod)) != 0 ){` |
|   230992 |   787 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|   230992 |   788 | `		if( (pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT) == 0 ){` |
|   230986 |   789 | `			rc = PH7_VmInstallUserFunction(&(*pVm),&pMeth->sFunc,&pMeth->sVmName);` |
|   230986 |   790 | `			if( rc != SXRET_OK ){` |
|      ! 0 |   791 | `				return rc;` |
|        - |   792 | `			}` |
|   115492 |   793 | `		}` |
|        2 |   794 | `	}` |
|        - |   795 | `	/* Mark class as mounted to avoid redundant mounting */` |
|    28636 |   796 | `	pClass->bMounted = TRUE;` |
|    28636 |   797 | `	return SXRET_OK;` |
|    35358 |   798 |  |
|        - |   799 | `/*` |
|        - |   800 | ` * Allocate a private frame for attributes of the given` |
|        - |   801 | ` * class instance (Object in the PHP jargon).` |
|        - |   802 | ` */` |
|      908 |   803 | `PH7_PRIVATE sxi32 PH7_VmCreateClassInstanceFrame(` |
|        - |   804 | `	ph7_vm *pVm, /* Target VM */` |
|        - |   805 | `	ph7_class_instance *pObj /* Class instance */` |
|        - |   806 | `	)` |
|        2 |   807 |  |
|      910 |   808 | `	ph7_class *pClass = pObj->pClass;` |
...
|      910 |   813 | `	SyHashResetLoopCursor(&pClass->hAttr);` |
|     3648 |   814 | `	while( (pEntry = SyHashGetNextEntry(&pClass->hAttr)) != 0 ){` |
|        - |   815 | `		VmClassAttr *pVmAttr;` |
|        - |   816 | `		/* Extract the current attribute */` |
|     2740 |   817 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|     2740 |   818 | `		pVmAttr = (VmClassAttr *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmClassAttr));` |
|     2740 |   819 | `		if( pVmAttr == 0 ){` |
|      ! 0 |   820 | `			return SXERR_MEM;` |
|        - |   821 | `		}` |
|     2740 |   822 | `		pVmAttr->pAttr = pAttr;` |
|     2740 |   823 | `		if( (pAttr->iFlags & (PH7_CLASS_ATTR_CONSTANT\|PH7_CLASS_ATTR_STATIC)) == 0 ){` |
|        - |   824 | `			ph7_value *pMemObj;` |
|        - |   825 | `			/* Reserve a memory object for this attribute */` |
|     2734 |   826 | `			pMemObj = PH7_ReserveMemObj(&(*pVm));` |
|     2734 |   827 | `			if( pMemObj == 0 ){` |
|      ! 0 |   828 | `				SyMemBackendPoolFree(&pVm->sAllocator,pVmAttr);` |
|      ! 0 |   829 | `				return SXERR_MEM;` |
|        - |   830 | `			}` |
|     2734 |   831 | `			pVmAttr->nIdx = pMemObj->nIdx;` |
|     2734 |   832 | `			if( SySetUsed(&pAttr->aByteCode) > 0 ){` |
|        - |   833 | `				/* Initialize attribute default value (any complex expression) */` |
|      888 |   834 | `				VmLocalExec(&(*pVm),&pAttr->aByteCode,pMemObj);` |
|      443 |   835 | `			}` |
|     2734 |   836 | `			rc = SyHashInsert(&pObj->hAttr,SyStringData(&pAttr->sName),SyStringLength(&pAttr->sName),pVmAttr);` |
|     2734 |   837 | `			if( rc != SXRET_OK ){` |
|        - |   838 | `				VmSlot sSlot;` |
...
|     2734 |   847 | `			PH7_VmRefObjInstall(&(*pVm),pMemObj->nIdx,0,0,VM_REF_IDX_KEEP);` |
|     1368 |   848 | `		}else{` |
...
|        - |   870 | ` */` |
|   231508 |   871 | `PH7_PRIVATE ph7_value * PH7_ReserveConstObj(ph7_vm *pVm,sxu32 *pIndex)` |
|        2 |   872 |  |
|        - |   873 | `	ph7_value *pObj;` |
|        - |   874 | `	sxi32 rc;` |
|   231510 |   875 | `	if( pIndex ){` |
|        - |   876 | `		/* Object index in the object table */` |
|   225828 |   877 | `		*pIndex = SySetUsed(&pVm->aLitObj);` |
|   112913 |   878 | `	}` |
|        - |   879 | `	/* Reserve a slot for the new object */` |
|   231510 |   880 | `	rc = SySetPut(&pVm->aLitObj,(const void *)zDummy);` |
|   231510 |   881 | `	if( rc != SXRET_OK ){` |
...
|      ! 0 |   885 | `		return 0;` |
|        - |   886 | `	}` |
|   231510 |   887 | `	pObj = (ph7_value *)SySetPeek(&pVm->aLitObj);` |
|   231510 |   888 | `	return pObj;` |
|   115756 |   889 |  |
|        - |   890 | `/*` |
|        - |   891 | ` * Reserve a memory object.` |
|        - |   892 | ` * Return a pointer to the raw ph7_value on success. NULL on failure.` |
|        - |   893 | ` */` |
|  2129244 |   894 | `PH7_PRIVATE ph7_value * VmReserveMemObj(ph7_vm *pVm,sxu32 *pIndex)` |
|        2 |   895 |  |
|        - |   896 | `	ph7_value *pObj;` |
|        - |   897 | `	sxi32 rc;` |
|  2129246 |   898 | `	if( pIndex ){` |
|        - |   899 | `		/* Object index in the object table */` |
|  2129246 |   900 | `		*pIndex = SySetUsed(&pVm->aMemObj);` |
|  1064622 |   901 | `	}` |
|        - |   902 | `	/* Reserve a slot for the new object */` |
|  2129246 |   903 | `	rc = SySetPut(&pVm->aMemObj,(const void *)zDummy);` |
|  2129246 |   904 | `	if( rc != SXRET_OK ){` |
...
|      ! 0 |   908 | `		return 0;` |
|        - |   909 | `	}` |
|  2129246 |   910 | `	pObj = (ph7_value *)SySetPeek(&pVm->aMemObj);` |
|  2129246 |   911 | `	return pObj;` |
|  1064624 |   912 |  |
...
|        - |  1251 | ` */` |
|     1894 |  1252 | `PH7_PRIVATE sxi32 PH7_VmInit(` |
...
|     1896 |  1261 | `	SyZero(pVm,sizeof(ph7_vm));` |
|        - |  1262 | `	/* Initialize VM fields */` |
|     1896 |  1263 | `	pVm->pEngine = &(*pEngine);` |
|     1896 |  1264 | `	SyMemBackendInitFromParent(&pVm->sAllocator,&pEngine->sAllocator);` |
|        - |  1265 | `	/* Instructions containers */` |
|     1896 |  1266 | `	SySetInit(&pVm->aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|     1896 |  1267 | `	SySetAlloc(&pVm->aByteCode,0xFF);` |
|     1896 |  1268 | `	pVm->pByteContainer = &pVm->aByteCode;` |
|        - |  1269 | `	/* Object containers */` |
|     1896 |  1270 | `	SySetInit(&pVm->aMemObj,&pVm->sAllocator,sizeof(ph7_value));` |
|     1896 |  1271 | `	SySetAlloc(&pVm->aMemObj,0xFF);` |
|        - |  1272 | `	/* Virtual machine internal containers */` |
|     1896 |  1273 | `	SyBlobInit(&pVm->sConsumer,&pVm->sAllocator);` |
|     1896 |  1274 | `	SyBlobInit(&pVm->sWorker,&pVm->sAllocator);` |
|     1896 |  1275 | `	SyBlobInit(&pVm->sArgv,&pVm->sAllocator);` |
|     1896 |  1276 | `	SySetInit(&pVm->aLitObj,&pVm->sAllocator,sizeof(ph7_value));` |
|     1896 |  1277 | `	SySetAlloc(&pVm->aLitObj,0xFF);` |
|     1896 |  1278 | `	SyHashInit(&pVm->hHostFunction,&pVm->sAllocator,0,0);` |
|     1896 |  1279 | `	SyHashInit(&pVm->hFunction,&pVm->sAllocator,0,0);` |
|     1896 |  1280 | `	SyHashInit(&pVm->hClass,&pVm->sAllocator,SyStrHash,SyStrnmicmp);` |
|     1896 |  1281 | `	SyHashInit(&pVm->hConstant,&pVm->sAllocator,0,0);` |
|     1896 |  1282 | `	SyHashInit(&pVm->hSuper,&pVm->sAllocator,0,0);` |
|     1896 |  1283 | `	SyHashInit(&pVm->hPDO,&pVm->sAllocator,0,0);` |
|     1896 |  1284 | `	SySetInit(&pVm->aFreeObj,&pVm->sAllocator,sizeof(VmSlot));` |
|     1896 |  1285 | `	SySetInit(&pVm->aSelf,&pVm->sAllocator,sizeof(ph7_class *));` |
|     1896 |  1286 | `	SySetInit(&pVm->aShutdown,&pVm->sAllocator,sizeof(VmShutdownCB));` |
|     1896 |  1287 | `	SySetInit(&pVm->aException,&pVm->sAllocator,sizeof(ph7_exception *));` |
|        - |  1288 | `	/* Configuration containers */` |
|     1896 |  1289 | `	SySetInit(&pVm->aFiles,&pVm->sAllocator,sizeof(SyString));` |
|     1896 |  1290 | `	SySetInit(&pVm->aPaths,&pVm->sAllocator,sizeof(SyString));` |
|     1896 |  1291 | `	SySetInit(&pVm->aIncluded,&pVm->sAllocator,sizeof(SyString));` |
|     1896 |  1292 | `	SySetInit(&pVm->aOB,&pVm->sAllocator,sizeof(VmObEntry));` |
|     1896 |  1293 | `	SySetInit(&pVm->aIOstream,&pVm->sAllocator,sizeof(ph7_io_stream *));` |
|        - |  1294 | `	/* Error callbacks containers */` |
|     1896 |  1295 | `	PH7_MemObjInit(&(*pVm),&pVm->aExceptionCB[0]);` |
|     1896 |  1296 | `	PH7_MemObjInit(&(*pVm),&pVm->aExceptionCB[1]);` |
|     1896 |  1297 | `	PH7_MemObjInit(&(*pVm),&pVm->aErrCB[0]);` |
|     1896 |  1298 | `	PH7_MemObjInit(&(*pVm),&pVm->aErrCB[1]);` |
|     1896 |  1299 | `	PH7_MemObjInit(&(*pVm),&pVm->sAssertCallback);` |
|        - |  1300 | `	/* Set a default recursion limit */` |
|        - |  1301 | `#if defined(__WINNT__) \|\| defined(__UNIXES__)` |
|     1896 |  1302 | `	pVm->nMaxDepth = 32;` |
|        - |  1303 | `#else` |
|        - |  1304 | `	pVm->nMaxDepth = 16;` |
|        - |  1305 | `#endif` |
|        - |  1306 | `	/* Default assertion flags */` |
|     1896 |  1307 | `	pVm->iAssertFlags = PH7_ASSERT_WARNING; /* Issue a warning for each failed assertion */` |
|        - |  1308 | `	/* JSON return status */` |
|     1896 |  1309 | `	pVm->json_rc = JSON_ERROR_NONE;` |
|        - |  1310 | `	/* PRNG context */` |
|     1896 |  1311 | `	SyRandomnessInit(&pVm->sPrng,0,0);` |
|        - |  1312 | `	/* Install the null constant */` |
|     1896 |  1313 | `	pObj = PH7_ReserveConstObj(&(*pVm),0);` |
|     1896 |  1314 | `	if( pObj == 0 ){` |
|      ! 0 |  1315 | `		rc = SXERR_MEM;` |
|      ! 0 |  1316 | `		goto Err;` |
|        - |  1317 | `	}` |
|     1896 |  1318 | `	PH7_MemObjInit(pVm,pObj);` |
|        - |  1319 | `	/* Install the boolean TRUE constant */` |
|     1896 |  1320 | `	pObj = PH7_ReserveConstObj(&(*pVm),0);` |
|     1896 |  1321 | `	if( pObj == 0 ){` |
|      ! 0 |  1322 | `		rc = SXERR_MEM;` |
|      ! 0 |  1323 | `		goto Err;` |
|        - |  1324 | `	}` |
|     1896 |  1325 | `	PH7_MemObjInitFromBool(pVm,pObj,1);` |
|        - |  1326 | `	/* Install the boolean FALSE constant */` |
|     1896 |  1327 | `	pObj = PH7_ReserveConstObj(&(*pVm),0);` |
|     1896 |  1328 | `	if( pObj == 0 ){` |
|      ! 0 |  1329 | `		rc = SXERR_MEM;` |
|      ! 0 |  1330 | `		goto Err;` |
|        - |  1331 | `	}` |
|     1896 |  1332 | `	PH7_MemObjInitFromBool(pVm,pObj,0);` |
...
|     1896 |  1336 | `	pObj = PH7_ReserveConstObj(&(*pVm),&pVm->nEmptyStringIdx);` |
|     1896 |  1337 | `	if( pObj == 0 ){` |
|      ! 0 |  1338 | `		rc = SXERR_MEM;` |
|      ! 0 |  1339 | `		goto Err;` |
|        - |  1340 | `	}` |
|     1896 |  1341 | `	PH7_MemObjInitFromString(pVm,pObj,0);` |
|        - |  1342 | `	/* Create the global frame */` |
|     1896 |  1343 | `	rc = VmEnterFrame(&(*pVm),0,0,0);` |
|     1896 |  1344 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  1345 | `		goto Err;` |
|        - |  1346 | `	}` |
|        - |  1347 | `	/* Initialize the code generator */` |
|     1896 |  1348 | `	rc = PH7_InitCodeGenerator(pVm,pEngine->xConf.xErr,pEngine->xConf.pErrData);` |
|     1896 |  1349 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  1350 | `		goto Err;` |
|        - |  1351 | `	}` |
|        - |  1352 | `	/* VM correctly initialized,set the magic number */` |
|     1896 |  1353 | `	pVm->nMagic = PH7_VM_INIT;` |
|     1896 |  1354 | `	SyStringInitFromBuf(&sBuiltin,PH7_BUILTIN_LIB,sizeof(PH7_BUILTIN_LIB)-1);` |
|        - |  1355 | `	/* Compile the built-in library */` |
|     1896 |  1356 | `	VmEvalChunk(&(*pVm),0,&sBuiltin,PH7_PHP_ONLY,FALSE);` |
|        - |  1357 | `	/* Reset the code generator */` |
|     1896 |  1358 | `	PH7_ResetCodeGenerator(&(*pVm),pEngine->xConf.xErr,pEngine->xConf.pErrData);` |
|     1896 |  1359 | `	return SXRET_OK;` |
|      ! 0 |  1360 | `Err:` |
...
|        - |  1392 | ` */` |
|    26674 |  1393 | `static ph7_value * VmNewOperandStack(` |
...
|        - |  1405 | `  */` |
|    26676 |  1406 | `	nInstr += VM_STACK_GUARD;` |
|    26676 |  1407 | `	pStack = (ph7_value *)SyMemBackendAlloc(&pVm->sAllocator,nInstr * sizeof(ph7_value));` |
|    26676 |  1408 | `	if( pStack == 0 ){` |
|      ! 0 |  1409 | `		return 0;` |
|        - |  1410 | `	}` |
|        - |  1411 | `	/* Initialize the operand stack */` |
|  1676092 |  1412 | `	while( nInstr > 0 ){` |
|  1649418 |  1413 | `		PH7_MemObjInit(&(*pVm),&pStack[nInstr - 1]);` |
|  1649418 |  1414 | `		--nInstr;` |
|        2 |  1415 | `	}` |
|        - |  1416 | `	/* Ready for bytecode execution */` |
|    26676 |  1417 | `	return pStack;` |
|    13339 |  1418 |  |
...
|        - |  1427 | ` */` |
|     1656 |  1428 | `PH7_PRIVATE sxi32 PH7_VmMakeReady(` |
|        - |  1429 | `	ph7_vm *pVm /* Target VM */` |
|        - |  1430 | `	)` |
|        2 |  1431 |  |
|        - |  1432 | `	SyHashEntry *pEntry;` |
|        - |  1433 | `	sxi32 rc;` |
|     1658 |  1434 | `	if( pVm->nMagic != PH7_VM_INIT ){` |
|        - |  1435 | `		/* Initialize your VM first */` |
|      ! 0 |  1436 | `		return SXERR_CORRUPT;` |
|        - |  1437 | `	}` |
|        - |  1438 | `	/* Mark the VM ready for byte-code execution */` |
|     1658 |  1439 | `	pVm->nMagic = PH7_VM_RUN;` |
|        - |  1440 | `	/* Release the code generator now we have compiled our program */` |
|     1658 |  1441 | `	PH7_ResetCodeGenerator(pVm,0,0);` |
|        - |  1442 | `	/* Emit the DONE instruction */` |
|     1658 |  1443 | `	rc = PH7_VmEmitInstr(&(*pVm),PH7_OP_DONE,0,0,0,0);` |
|     1658 |  1444 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  1445 | `		return SXERR_MEM;` |
|        - |  1446 | `	}` |
|        - |  1447 | `	/* Script return value */` |
|     1658 |  1448 | `	PH7_MemObjInit(&(*pVm),&pVm->sExec); /* Assume a NULL return value */` |
|        - |  1449 | `	/* Allocate a new operand stack */` |
|     1658 |  1450 | `	pVm->aOps = VmNewOperandStack(&(*pVm),SySetUsed(pVm->pByteContainer));` |
|     1658 |  1451 | `	if( pVm->aOps == 0 ){` |
|      ! 0 |  1452 | `		return SXERR_MEM;` |
|        - |  1453 | `	}` |
|        - |  1454 | `	/* Set the default VM output consumer callback and it's` |
|        - |  1455 | `	 * private data. */` |
|     1658 |  1456 | `	pVm->sVmConsumer.xConsumer = PH7_VmBlobConsumer;` |
|     1658 |  1457 | `	pVm->sVmConsumer.pUserData = &pVm->sConsumer;` |
|        - |  1458 | `	/* Allocate the reference table */` |
|     1658 |  1459 | `	pVm->nRefSize = 0x10; /* Must be a power of two for fast arithemtic */` |
|     1658 |  1460 | `	pVm->apRefObj = (VmRefObj **)SyMemBackendAlloc(&pVm->sAllocator,sizeof(VmRefObj *) * pVm->nRefSize);` |
|     1658 |  1461 | `	if( pVm->apRefObj == 0 ){` |
...
|     1658 |  1480 | `	PH7_RegisterBuiltInConstant(&(*pVm));` |
|        - |  1481 | `	/* Register built-in functions [i.e: is_null(), array_diff(), strlen(), etc.] */` |
|     1658 |  1482 | `	PH7_RegisterBuiltInFunction(&(*pVm));` |
|        - |  1483 | `	/* Initialize and install static and constants class attributes */` |
|     1658 |  1484 | `	SyHashResetLoopCursor(&pVm->hClass);` |
|    19904 |  1485 | `	while((pEntry = SyHashGetNextEntry(&pVm->hClass)) != 0 ){` |
|    18248 |  1486 | `		rc = VmMountUserClass(&(*pVm),(ph7_class *)pEntry->pUserData);` |
|    18248 |  1487 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  1488 | `			return rc;` |
|        - |  1489 | `		}` |
|        2 |  1490 | `	}` |
|        - |  1491 | `	/* Random number betwwen 0 and 1023 used to generate unique ID */` |
|     1658 |  1492 | `	pVm->unique_id = PH7_VmRandomNum(&(*pVm)) & 1023;` |
|        - |  1493 | `	/* VM is ready for bytecode execution */` |
|     1658 |  1494 | `	return SXRET_OK;` |
|      830 |  1495 |  |
|        - |  1496 | `/*` |
...
|        - |  1514 | ` */` |
|     1648 |  1515 | `PH7_PRIVATE sxi32 PH7_VmRelease(ph7_vm *pVm)` |
|        2 |  1516 |  |
|        - |  1517 | `	/* Set the stale magic number */` |
|     1650 |  1518 | `	pVm->nMagic = PH7_VM_STALE;` |
|        - |  1519 | `	/* Release the private memory subsystem */` |
|     1650 |  1520 | `	SyMemBackendRelease(&pVm->sAllocator);` |
|     1650 |  1521 | `	return SXRET_OK;` |
|        2 |  1522 |  |
|        - |  1523 | `/*` |
...
|        - |  1532 | ` */` |
|   522558 |  1533 | `static sxi32 VmInitCallContext(` |
...
|        - |  1539 | `	)` |
|        2 |  1540 |  |
|   522560 |  1541 | `	pOut->pFunc = pFunc;` |
|   522560 |  1542 | `	pOut->pVm   = pVm;` |
|   522560 |  1543 | `	SySetInit(&pOut->sVar,&pVm->sAllocator,sizeof(ph7_value *));` |
|   522560 |  1544 | `	SySetInit(&pOut->sChunk,&pVm->sAllocator,sizeof(ph7_aux_data));` |
|        - |  1545 | `	/* Assume a null return value */` |
|   522560 |  1546 | `	MemObjSetType(pRet,MEMOBJ_NULL);` |
|   522560 |  1547 | `	pOut->pRet = pRet;` |
|   522560 |  1548 | `	pOut->iFlags = iFlags;` |
|   522560 |  1549 | `	return SXRET_OK;` |
|        2 |  1550 |  |
|        - |  1551 | `/*` |
|        - |  1552 | ` * Release a foreign function call context and cleanup the mess` |
|        - |  1553 | ` * left behind.` |
|        - |  1554 | ` */` |
|   522558 |  1555 | `static void VmReleaseCallContext(ph7_context *pCtx)` |
|        2 |  1556 |  |
|        - |  1557 | `	sxu32 n;` |
|   522560 |  1558 | `	if( SySetUsed(&pCtx->sVar) > 0 ){` |
|     6116 |  1559 | `		ph7_value **apObj = (ph7_value **)SySetBasePtr(&pCtx->sVar);` |
|    17272 |  1560 | `		for( n = 0 ; n < SySetUsed(&pCtx->sVar) ; ++n ){` |
|    11158 |  1561 | `			if( apObj[n] == 0 ){` |
|        - |  1562 | `				/* Already released */` |
|      250 |  1563 | `				continue;` |
|        - |  1564 | `			}` |
|    10910 |  1565 | `			PH7_MemObjRelease(apObj[n]);` |
|    10910 |  1566 | `			SyMemBackendPoolFree(&pCtx->pVm->sAllocator,apObj[n]);` |
|     5456 |  1567 | `		}` |
|     6116 |  1568 | `		SySetRelease(&pCtx->sVar);` |
|     3057 |  1569 | `	}` |
|   522560 |  1570 | `	if( SySetUsed(&pCtx->sChunk) > 0 ){` |
...
|        - |  1616 | ` */` |
|  3090758 |  1617 | `static void VmPopOperand(` |
|        - |  1618 | `	ph7_value **ppTos, /* Operand stack */` |
|        - |  1619 | `	sxi32 nPop         /* Total number of memory objects to pop */` |
|        - |  1620 | `	)` |
|        2 |  1621 |  |
|  3090760 |  1622 | `	ph7_value *pTos = *ppTos;` |
|  6550990 |  1623 | `	while( nPop > 0 ){` |
|  3460232 |  1624 | `		PH7_MemObjRelease(pTos);` |
|  3460232 |  1625 | `		pTos--;` |
|  3460232 |  1626 | `		nPop--;` |
|        2 |  1627 | `	}` |
|        - |  1628 | `	/* Top of the stack */` |
|  3090760 |  1629 | `	*ppTos = pTos;` |
|  3090760 |  1630 |  |
|        - |  1631 | `/*` |
|        - |  1632 | ` * Reserve a memory object.` |
|        - |  1633 | ` * Return a pointer to the raw ph7_value on success. NULL on failure.` |
|        - |  1634 | ` */` |
|  2932226 |  1635 | `PH7_PRIVATE ph7_value * PH7_ReserveMemObj(ph7_vm *pVm)` |
|        2 |  1636 |  |
|  2932228 |  1637 | `	ph7_value *pObj = 0;` |
|        - |  1638 | `	VmSlot *pSlot;` |
|        - |  1639 | `	sxu32 nIdx;` |
|        - |  1640 | `	/* Check for a free slot */` |
|  2932228 |  1641 | `	nIdx = SXU32_HIGH; /* cc warning */` |
|  2932228 |  1642 | `	pSlot = (VmSlot *)SySetPop(&pVm->aFreeObj);` |
|  2932228 |  1643 | `	if( pSlot ){` |
|   802984 |  1644 | `		pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pSlot->nIdx);` |
|   802984 |  1645 | `		nIdx = pSlot->nIdx;` |
|   401491 |  1646 | `	}` |
|  2932228 |  1647 | `	if( pObj == 0 ){` |
|        - |  1648 | `		/* Reserve a new memory object */` |
|  2129246 |  1649 | `		pObj = VmReserveMemObj(&(*pVm),&nIdx);` |
|  2129246 |  1650 | `		if( pObj == 0 ){` |
|      ! 0 |  1651 | `			return 0;` |
|        - |  1652 | `		}` |
|  1064622 |  1653 | `	}` |
|        - |  1654 | `	/* Set a null default value */` |
|  2932228 |  1655 | `	PH7_MemObjInit(&(*pVm),pObj);` |
|  2932228 |  1656 | `	pObj->nIdx = nIdx;` |
|  2932228 |  1657 | `	return pObj;` |
|  1466115 |  1658 |  |
|        - |  1659 | `/*` |
|        - |  1660 | ` * Insert an entry by reference (not copy) in the given hashmap.` |
|        - |  1661 | ` */` |
|    21958 |  1662 | `static sxi32 VmHashmapRefInsert(` |
...
|        - |  1669 | `	ph7_value sKey;` |
|        - |  1670 | `	sxi32 rc;` |
|    21960 |  1671 | `	PH7_MemObjInitFromString(pMap->pVm,&sKey,0);` |
|    21960 |  1672 | `	PH7_MemObjStringAppend(&sKey,zKey,nByte);` |
|        - |  1673 | `	/* Perform the insertion */` |
|    21960 |  1674 | `	rc = PH7_HashmapInsertByRef(&(*pMap),&sKey,nRefIdx);` |
|    21960 |  1675 | `	PH7_MemObjRelease(&sKey);` |
|    21960 |  1676 | `	return rc;` |
|        2 |  1677 |  |
|        - |  1678 | `/*` |
...
|        - |  1682 | ` */` |
|  2903046 |  1683 | `static ph7_value * VmExtractMemObj(` |
...
|        - |  1688 | `	)` |
|        2 |  1689 |  |
|  2903048 |  1690 | `	int bNullify = FALSE;` |
...
|  2903048 |  1697 | `	pFrame = pVm->pFrame;` |
|  2952400 |  1698 | `	while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|        - |  1699 | `		/* Safely ignore the exception frame */` |
|    49353 |  1700 | `		pFrame = pFrame->pParent; /* Parent frame */` |
|        1 |  1701 | `	}` |
|        - |  1702 | `	/* Perform the lookup */` |
|  2903048 |  1703 | `	if( pName == 0 \|\| pName->nByte < 1 ){` |
...
|  2903048 |  1711 | `	pEntry = SyHashGet(&pVm->hSuper,(const void *)pName->zString,pName->nByte);` |
|  2903048 |  1712 | `	if( pEntry == 0 ){` |
|        - |  1713 | `		/* Query the top active frame */` |
|  2903012 |  1714 | `		pEntry = SyHashGet(&pFrame->hVar,(const void *)pName->zString,pName->nByte);` |
|  2903012 |  1715 | `		if( pEntry == 0 ){` |
|    72254 |  1716 | `			char *zName = (char *)pName->zString;` |
|        - |  1717 | `			VmSlot sLocal;` |
|    72254 |  1718 | `			if( !bCreate ){` |
...
|        - |  1724 | `			 */` |
|    71680 |  1725 | `			pObj = PH7_ReserveMemObj(&(*pVm));` |
|    71680 |  1726 | `			if( pObj == 0 ){` |
|      ! 0 |  1727 | `				return 0;` |
|        - |  1728 | `			}` |
|    71680 |  1729 | `			nIdx = pObj->nIdx;` |
|    71680 |  1730 | `			if( bDup ){` |
|        - |  1731 | `				/* Duplicate name */` |
...
|    71680 |  1738 | `			rc = SyHashInsert(&pFrame->hVar,zName,pName->nByte,SX_INT_TO_PTR(nIdx));` |
|    71680 |  1739 | `			if( rc != SXRET_OK ){` |
...
|      ! 0 |  1744 | `				return 0;` |
|        - |  1745 | `			}` |
|    71680 |  1746 | `			if( pFrame->pParent != 0 ){` |
|        - |  1747 | `				/* Local variable */` |
|    66306 |  1748 | `				sLocal.nIdx = nIdx;` |
|    66306 |  1749 | `				SySetPut(&pFrame->sLocal,(const void *)&sLocal);` |
|    33154 |  1750 | `			}else{` |
...
|    71680 |  1755 | `			PH7_VmRefObjInstall(&(*pVm),nIdx,SyHashLastEntry(&pFrame->hVar),0,0);` |
|        - |  1756 | `			/* Save object index */` |
|    71680 |  1757 | `			pObj->nIdx = nIdx;` |
|    35841 |  1758 | `		}else{` |
|        - |  1759 | `			/* Extract variable contents */` |
|  2830760 |  1760 | `			nIdx = (sxu32)SX_PTR_TO_INT(pEntry->pUserData);` |
|  2830760 |  1761 | `			pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|  2830760 |  1762 | `			if( bNullify && pObj ){` |
...
|        - |  1776 | ` */` |
|     1682 |  1777 | `static ph7_value * VmExtractSuper(` |
...
|     1684 |  1787 | `	pEntry = SyHashGet(&pVm->hSuper,(const void *)zName,nByte);` |
|     1684 |  1788 | `	if( pEntry == 0 ){` |
|        - |  1789 | `		/* No such entry */` |
|      ! 0 |  1790 | `		return 0;` |
|        - |  1791 | `	}` |
|        - |  1792 | `	/* Extract the superglobal index in the global object pool */` |
|     1684 |  1793 | `	nIdx = SX_PTR_TO_INT(pEntry->pUserData);` |
|        - |  1794 | `	/* Extract the variable value  */` |
|     1684 |  1795 | `	pValue = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|     1684 |  1796 | `	return pValue;` |
|      843 |  1797 |  |
|        - |  1798 | `/*` |
|        - |  1799 | ` * Perform a raw hashmap insertion.` |
|        - |  1800 | ` * Refer to the [PH7_VmConfigure()] implementation for additional information.` |
|        - |  1801 | ` */` |
|     1680 |  1802 | `static sxi32 VmHashmapInsert(` |
...
|        - |  1811 | `	sxi32 rc;` |
|     1682 |  1812 | `	PH7_MemObjInitFromString(pMap->pVm,&sKey,0);` |
|     1682 |  1813 | `	PH7_MemObjInitFromString(pMap->pVm,&sValue,0);` |
|     1682 |  1814 | `	if( zKey ){` |
|     1660 |  1815 | `		if( nKeylen < 0 ){` |
|     1660 |  1816 | `			nKeylen = (int)SyStrlen(zKey);` |
|      829 |  1817 | `		}` |
|     1660 |  1818 | `		PH7_MemObjStringAppend(&sKey,zKey,(sxu32)nKeylen);` |
|      829 |  1819 | `	}` |
|     1682 |  1820 | `	if( zData ){` |
|     1682 |  1821 | `		if( nLen < 0 ){` |
...
|      ! 0 |  1824 | `		}` |
|     1682 |  1825 | `		PH7_MemObjStringAppend(&sValue,zData,(sxu32)nLen);` |
|      840 |  1826 | `	}` |
|        - |  1827 | `	/* Perform the insertion */` |
|     1682 |  1828 | `	rc = PH7_HashmapInsert(&(*pMap),&sKey,&sValue);` |
|     1682 |  1829 | `	PH7_MemObjRelease(&sKey);` |
|     1682 |  1830 | `	PH7_MemObjRelease(&sValue);` |
|     1682 |  1831 | `	return rc;` |
|        2 |  1832 |  |
...
|        - |  1847 | ` */` |
|    26520 |  1848 | `PH7_PRIVATE sxi32 PH7_VmConfigure(` |
|        - |  1849 | `	ph7_vm *pVm, /* Target VM */` |
|        - |  1850 | `	sxi32 nOp,   /* Configuration verb */` |
|        - |  1851 | `	va_list ap   /* Subsequent option arguments */` |
|        - |  1852 | `	)` |
|        2 |  1853 |  |
|    26522 |  1854 | `	sxi32 rc = SXRET_OK;` |
|    26522 |  1855 | `	switch(nOp){` |
|      828 |  1856 | `	case PH7_VM_CONFIG_OUTPUT: {` |
|     1658 |  1857 | `		ProcConsumer xConsumer = va_arg(ap,ProcConsumer);` |
|     1658 |  1858 | `		void *pUserData = va_arg(ap,void *);` |
...
|     1658 |  1867 | `		pVm->sVmConsumer.xConsumer = xConsumer;` |
|     1658 |  1868 | `		pVm->sVmConsumer.pUserData = pUserData;` |
|     1658 |  1869 | `		break;` |
|        - |  1870 | `							   }` |
|      828 |  1871 | `	case PH7_VM_CONFIG_IMPORT_PATH: {` |
|        - |  1872 | `		/* Import path */` |
|        - |  1873 | `		  const char *zPath;` |
|        - |  1874 | `		  SyString sPath;` |
|     1658 |  1875 | `		  zPath = va_arg(ap,const char *);` |
...
|        - |  1880 | `		  }` |
|        - |  1881 | `#endif` |
|     1658 |  1882 | `		  SyStringInitFromBuf(&sPath,zPath,SyStrlen(zPath));` |
|        - |  1883 | `		  /* Remove trailing slashes and backslashes */` |
|        - |  1884 | `#ifdef __WINNT__` |
|        2 |  1885 | `		  SyStringTrimTrailingChar(&sPath,'\\');` |
|        - |  1886 | `#endif` |
|     3314 |  1887 | `		  SyStringTrimTrailingChar(&sPath,'/');` |
|        - |  1888 | `		  /* Remove leading and trailing white spaces */` |
|     1658 |  1889 | `		  SyStringFullTrim(&sPath);` |
|     1658 |  1890 | `		  if( sPath.nByte > 0 ){` |
|        - |  1891 | `			  /* Store the path in the corresponding conatiner */` |
|     1658 |  1892 | `			  rc = SySetPut(&pVm->aPaths,(const void *)&sPath);` |
|      828 |  1893 | `		  }` |
|     1658 |  1894 | `		  break;` |
|        - |  1895 | `									 }` |
|      828 |  1896 | `	case PH7_VM_CONFIG_ERR_REPORT:` |
|        - |  1897 | `		/* Run-Time Error report */` |
|     1658 |  1898 | `		pVm->bErrReport = 1;` |
|     1658 |  1899 | `		break;` |
...
|        - |  1919 | `							   }` |
|        - |  1920 |  |
|     8280 |  1921 | `	case PH7_VM_CONFIG_CREATE_SUPER:` |
|        - |  1922 | `	case PH7_VM_CONFIG_CREATE_VAR: {` |
|        - |  1923 | `		/* Create a new superglobal/global variable */` |
|    16562 |  1924 | `		const char *zName = va_arg(ap,const char *);` |
|    16562 |  1925 | `		ph7_value *pValue = va_arg(ap,ph7_value *);` |
...
|        - |  1934 | `		}` |
|        - |  1935 | `#endif` |
|    16562 |  1936 | `		nByte = SyStrlen(zName);` |
|    16562 |  1937 | `		if( nOp == PH7_VM_CONFIG_CREATE_SUPER ){` |
|        - |  1938 | `			/* Check if the superglobal is already installed */` |
|    16562 |  1939 | `			pEntry = SyHashGet(&pVm->hSuper,(const void *)zName,nByte);` |
|     8282 |  1940 | `		}else{` |
|        - |  1941 | `			/* Query the top active VM frame */` |
|      ! 0 |  1942 | `			pEntry = SyHashGet(&pVm->pFrame->hVar,(const void *)zName,nByte);` |
|        - |  1943 | `		}` |
|    16562 |  1944 | `		if( pEntry ){` |
...
|    16562 |  1955 | `			pObj = PH7_ReserveMemObj(&(*pVm));` |
|    16562 |  1956 | `			if( pObj == 0 ){` |
|      ! 0 |  1957 | `				rc = SXERR_MEM;` |
|      ! 0 |  1958 | `				break;` |
|        - |  1959 | `			}` |
|    16562 |  1960 | `			nIdx = pObj->nIdx;` |
|        - |  1961 | `			/* Copy value */` |
|    16562 |  1962 | `			PH7_MemObjStore(pValue,pObj);` |
|    16562 |  1963 | `			if( nOp == PH7_VM_CONFIG_CREATE_SUPER ){` |
|        - |  1964 | `				/* Install the superglobal */` |
|    16562 |  1965 | `				rc = SyHashInsert(&pVm->hSuper,(const void *)zName,nByte,SX_INT_TO_PTR(nIdx));` |
|     8282 |  1966 | `			}else{` |
|        - |  1967 | `				/* Install in the current frame */` |
|      ! 0 |  1968 | `				rc = SyHashInsert(&pVm->pFrame->hVar,(const void *)zName,nByte,SX_INT_TO_PTR(nIdx));` |
|        - |  1969 | `			}` |
|    16562 |  1970 | `			if( rc == SXRET_OK ){` |
|        - |  1971 | `				SyHashEntry *pRef;` |
|    16562 |  1972 | `				if( nOp == PH7_VM_CONFIG_CREATE_SUPER ){` |
|    16562 |  1973 | `					pRef = SyHashLastEntry(&pVm->hSuper);` |
|     8282 |  1974 | `				}else{` |
|      ! 0 |  1975 | `					pRef = SyHashLastEntry(&pVm->pFrame->hVar);` |
|        - |  1976 | `				}` |
|        - |  1977 | `				/* Install in the reference table */` |
|    16562 |  1978 | `				PH7_VmRefObjInstall(&(*pVm),nIdx,pRef,0,0);` |
|    16562 |  1979 | `				if( nOp == PH7_VM_CONFIG_CREATE_SUPER \|\| pVm->pFrame->pParent == 0){` |
|        - |  1980 | `					/* Register in the $GLOBALS array */` |
|    16562 |  1981 | `					VmHashmapRefInsert(pVm->pGlobal,zName,nByte,nIdx);` |
|     8280 |  1982 | `				}` |
|     8280 |  1983 | `			}` |
|        - |  1984 | `		}` |
|    16562 |  1985 | `		break;` |
|        - |  1986 | `									}` |
|      829 |  1987 | `	case PH7_VM_CONFIG_SERVER_ATTR:` |
...
|     1658 |  2019 | `			pValue = VmExtractSuper(&(*pVm),"_SERVER",sizeof("_SERVER")-1);` |
|        - |  2020 | `		}` |
|     1660 |  2021 | `		if( pValue == 0 \|\| (pValue->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
|        - |  2022 | `			/* No such entry */` |
|      ! 0 |  2023 | `			rc = SXERR_NOTFOUND;` |
|      ! 0 |  2024 | `			break;` |
|        - |  2025 | `		}` |
|        - |  2026 | `		/* Point to the hashmap */` |
|     1660 |  2027 | `		pMap = (ph7_hashmap *)pValue->x.pOther;` |
|        - |  2028 | `		/* Perform the insertion */` |
|     1660 |  2029 | `		rc = VmHashmapInsert(pMap,zKey,-1,zValue,nLen);` |
|     1660 |  2030 | `		break;` |
|        - |  2031 | `								   }` |
...
|      ! 0 |  2079 | `		break;` |
|        - |  2080 | `								   }` |
|     1656 |  2081 | `	case PH7_VM_CONFIG_IO_STREAM: {` |
|        - |  2082 | `		/* Register an IO stream device */` |
|     3314 |  2083 | `		const ph7_io_stream *pStream = va_arg(ap,const ph7_io_stream *);` |
|        - |  2084 | `		/* Make sure we are dealing with a valid IO stream */` |
|     4968 |  2085 | `		if( pStream == 0 \|\| pStream->zName == 0 \|\| pStream->zName[0] == 0 \|\|` |
|     3314 |  2086 | `			pStream->xOpen == 0 \|\| pStream->xRead == 0 ){` |
|        - |  2087 | `				/* Invalid stream */` |
|      ! 0 |  2088 | `				rc = SXERR_INVALID;` |
|      ! 0 |  2089 | `				break;` |
|        - |  2090 | `		}` |
|     3314 |  2091 | `		if( pVm->pDefStream == 0 && SyStrnicmp(pStream->zName,"file",sizeof("file")-1) == 0 ){` |
|        - |  2092 | `			/* Make the 'file://' stream the defaut stream device */` |
|     1658 |  2093 | `			pVm->pDefStream = pStream;` |
|      828 |  2094 | `		}` |
|        - |  2095 | `		/* Insert in the appropriate container */` |
|     3314 |  2096 | `		rc = SySetPut(&pVm->aIOstream,(const void *)&pStream);` |
|     3314 |  2097 | `		break;` |
|        - |  2098 | `								  }` |
...
|        - |  2193 | ` */` |
|      428 |  2194 | `static sxi32 VmCallErrorHandler(ph7_vm *pVm,SyBlob *pMsg)` |
|        1 |  2195 |  |
|      429 |  2196 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|      429 |  2197 | `	sxi32 rc = SXRET_OK;` |
|        - |  2198 | `	/* Append a new line */` |
|        - |  2199 | `#ifdef __WINNT__` |
|        1 |  2200 | `	SyBlobAppend(pMsg,"\r\n",sizeof("\r\n")-1);` |
|        - |  2201 | `#else` |
|      428 |  2202 | `	SyBlobAppend(pMsg,"\n",sizeof(char));` |
|        - |  2203 | `#endif` |
|        - |  2204 | `	/* Invoke the output consumer callback */` |
|      429 |  2205 | `	rc = pCons->xConsumer(SyBlobData(pMsg),SyBlobLength(pMsg),pCons->pUserData);` |
|      429 |  2206 | `	if( pCons->xConsumer != VmObConsumer ){` |
|        - |  2207 | `		/* Increment output length */` |
|      429 |  2208 | `		pVm->nOutputLen += SyBlobLength(pMsg);` |
|      214 |  2209 | `	}` |
|      429 |  2210 | `	return rc;` |
|        1 |  2211 |  |
|        - |  2212 | `/*` |
...
|        - |  2215 | ` * information.` |
|        - |  2216 | ` */` |
|      120 |  2217 | `static sxi32 VmInvokeErrorHandler(ph7_vm *pVm, sxi32 iErr, const char *zMessage, sxi32 nLen, SyString *pFile, sxi32 iLine)` |
|        2 |  2218 |  |
|      122 |  2219 | `	if( ph7_value_is_callable(&pVm->aErrCB[1]) ){` |
|        - |  2220 | `		ph7_value apArg[4];` |
|        - |  2221 | `		ph7_value *apArgPtr[4];` |
|        - |  2222 | `		ph7_value sResult;` |
|        - |  2223 | `		SyString sErr;` |
|        - |  2224 | `		/* Prepare arguments */` |
|       43 |  2225 | `		PH7_MemObjInitFromInt(pVm,&apArg[0],iErr);` |
|        - |  2226 | `			/* use explicit message length to avoid reading past buffer */` |
|       43 |  2227 | `			SyStringInitFromBuf(&sErr,zMessage,nLen);` |
|       43 |  2228 | `			PH7_MemObjInitFromString(pVm,&apArg[1],&sErr);` |
|       43 |  2229 | `		if( pFile ){` |
|       43 |  2230 | `			SyStringInitFromBuf(&sErr,pFile->zString,pFile->nByte);` |
|       43 |  2231 | `			PH7_MemObjInitFromString(pVm,&apArg[2],&sErr);` |
|       22 |  2232 | `		}else{` |
|      ! 0 |  2233 | `			PH7_MemObjInit(pVm,&apArg[2]);` |
|        - |  2234 | `		}` |
|       43 |  2235 | `		PH7_MemObjInitFromInt(pVm,&apArg[3],iLine);` |
|       43 |  2236 | `		PH7_MemObjInit(pVm,&sResult);` |
|        - |  2237 | `		/* Set up pointer array */` |
|       43 |  2238 | `		apArgPtr[0] = &apArg[0];` |
|       43 |  2239 | `		apArgPtr[1] = &apArg[1];` |
|       43 |  2240 | `		apArgPtr[2] = &apArg[2];` |
|       43 |  2241 | `		apArgPtr[3] = &apArg[3];` |
|        - |  2242 | `		/* Call the handler */` |
|       43 |  2243 | `		PH7_VmCallUserFunction(pVm,&pVm->aErrCB[1],4,apArgPtr,&sResult);` |
|        - |  2244 | `		/* Check return value */` |
|       43 |  2245 | `		if( (sResult.iFlags & MEMOBJ_BOOL) == 0 ){` |
|      ! 0 |  2246 | `			PH7_MemObjToBool(&sResult);` |
|      ! 0 |  2247 | `		}` |
|        - |  2248 | `		/* Release */` |
|       43 |  2249 | `		PH7_MemObjRelease(&apArg[0]);` |
|       43 |  2250 | `		PH7_MemObjRelease(&apArg[1]);` |
|       43 |  2251 | `		PH7_MemObjRelease(&apArg[2]);` |
|       43 |  2252 | `		PH7_MemObjRelease(&apArg[3]);` |
|       43 |  2253 | `		PH7_MemObjRelease(&sResult);` |
...
|       43 |  2256 | `		return sResult.x.iVal == 0 ? TRUE : FALSE;` |
|        - |  2257 | `	}` |
|        - |  2258 | `	/* No handler, always call error handler */` |
|       79 |  2259 | `	return TRUE;` |
|       62 |  2260 |  |
|       84 |  2261 | `PH7_PRIVATE sxi32 PH7_VmThrowError(` |
...
|        - |  2266 | `	)` |
|        2 |  2267 |  |
|       86 |  2268 | `	SyBlob *pWorker = &pVm->sWorker;` |
|        - |  2269 | `	SyString *pFile;` |
|        - |  2270 | `	char *zErr;` |
|       86 |  2271 | `	sxi32 rc = SXRET_OK;` |
|       86 |  2272 | `	if( !pVm->bErrReport ){` |
|        - |  2273 | `		/* Don't bother reporting errors */` |
|        3 |  2274 | `		return SXRET_OK;` |
|        - |  2275 | `	}` |
|        - |  2276 | `	/* Reset the working buffer */` |
|       84 |  2277 | `	SyBlobReset(pWorker);` |
|        - |  2278 | `	/* Peek the processed file if available */` |
|       84 |  2279 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|       84 |  2280 | `	if( pFile ){` |
|        - |  2281 | `		/* Append file name */` |
|       84 |  2282 | `		SyBlobAppend(pWorker,pFile->zString,pFile->nByte);` |
|       84 |  2283 | `		SyBlobAppend(pWorker,(const void *)" ",sizeof(char));` |
|       41 |  2284 | `	}` |
...
|       28 |  2299 | `		break;` |
|        - |  2300 | `	}` |
|       84 |  2301 | `	SyBlobAppend(pWorker,zErr,SyStrlen(zErr));` |
|       84 |  2302 | `	if( pFuncName ){` |
...
|       14 |  2306 | `	}` |
|       84 |  2307 | `	SyBlobAppend(pWorker,zMessage,SyStrlen(zMessage));` |
|        - |  2308 | `	/* Check for user error handler.  compute length of C string */` |
|       84 |  2309 | `	if( VmInvokeErrorHandler(pVm, iErr, zMessage, (sxi32)SyStrlen(zMessage), pFile, 0) ){` |
...
|        - |  2411 | ` */` |
|      696 |  2412 | `static void VmGetFrameContext(ph7_vm *pVm,const char **pzFuncName,int *pnFuncLen)` |
|        1 |  2413 |  |
|        - |  2414 | `	VmFrame *pFrame;` |
|        - |  2415 | `	ph7_vm_func *pFunc;` |
|      697 |  2416 | `	*pzFuncName = 0;` |
|      697 |  2417 | `	*pnFuncLen = 0;` |
|      697 |  2418 | `	pFrame = pVm->pFrame;` |
|      697 |  2419 | `	if( pFrame == 0 ){` |
|      ! 0 |  2420 | `		return;` |
|        - |  2421 | `	}` |
|      697 |  2422 | `	while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|      ! 0 |  2423 | `		pFrame = pFrame->pParent;` |
|      ! 0 |  2424 | `	}` |
|      697 |  2425 | `	if( pFrame->pParent == 0 ){` |
|      693 |  2426 | `		return;` |
|        - |  2427 | `	}` |
...
|        - |  2437 | ` */` |
|      350 |  2438 | `static sxi32 VmReportUncaughtException(ph7_vm *pVm,const char *zClass,sxu32 nClass,const char *zMsg,sxu32 nMsg,const char *zFuncName,int nFuncLen)` |
|        1 |  2439 |  |
|        - |  2440 | `	SyBlob sOut;` |
|        - |  2441 | `	SyString *pFile;` |
|      351 |  2442 | `	if( !pVm->bErrReport ){` |
|      ! 0 |  2443 | `		return PH7_OK;` |
|        - |  2444 | `	}` |
|      351 |  2445 | `	if( zClass == 0 \|\| nClass == 0 ){` |
...
|      ! 0 |  2452 | `	}` |
|      351 |  2453 | `	if( zFuncName == 0 \|\| nFuncLen <= 0 ){` |
|      347 |  2454 | `		VmGetFrameContext(pVm,&zFuncName,&nFuncLen);` |
|      173 |  2455 | `	}` |
|      351 |  2456 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|      351 |  2457 | `	SyBlobInit(&sOut,&pVm->sAllocator);` |
|      351 |  2458 | `	SyBlobAppend(&sOut,"PHP Fatal error:  Uncaught ",sizeof("PHP Fatal error:  Uncaught ")-1);` |
|      351 |  2459 | `	SyBlobAppend(&sOut,zClass,nClass);` |
|      351 |  2460 | `	SyBlobAppend(&sOut,": ",sizeof(": ")-1);` |
|      351 |  2461 | `	SyBlobAppend(&sOut,zMsg,nMsg);` |
|      351 |  2462 | `	if( pFile ){` |
|      351 |  2463 | `		SyBlobAppend(&sOut," in ",sizeof(" in ")-1);` |
|      351 |  2464 | `		SyBlobAppend(&sOut,pFile->zString,pFile->nByte);` |
|      351 |  2465 | `		SyBlobAppend(&sOut,":1",sizeof(":1")-1);` |
|      175 |  2466 | `	}` |
|      351 |  2467 | `	SyBlobAppend(&sOut,"\nStack trace:\n",sizeof("\nStack trace:\n")-1);` |
|      351 |  2468 | `	if( pFile ){` |
|      351 |  2469 | `		SyBlobAppend(&sOut,"#0 ",sizeof("#0 ")-1);` |
|      351 |  2470 | `		SyBlobAppend(&sOut,pFile->zString,pFile->nByte);` |
|      351 |  2471 | `		if( zFuncName && nFuncLen > 0 ){` |
|        5 |  2472 | `			SyBlobFormat(&sOut,"(1): %.*s()\n",nFuncLen,zFuncName);` |
|        3 |  2473 | `		}else{` |
|      347 |  2474 | `			SyBlobAppend(&sOut,"(1): {main}\n",sizeof("(1): {main}\n")-1);` |
|        1 |  2475 | `		}` |
|      175 |  2476 | `	}else if( zFuncName && nFuncLen > 0 ){` |
|      ! 0 |  2477 | `		SyBlobFormat(&sOut,"#0 [internal function]: %.*s()\n",nFuncLen,zFuncName);` |
|      ! 0 |  2478 | `	}else{` |
|      ! 0 |  2479 | `		SyBlobAppend(&sOut,"#0 {main}\n",sizeof("#0 {main}\n")-1);` |
|        - |  2480 | `	}` |
|      351 |  2481 | `	SyBlobAppend(&sOut,"#1 {main}",sizeof("#1 {main}")-1);` |
|      351 |  2482 | `	if( pFile ){` |
|      351 |  2483 | `		SyBlobAppend(&sOut,"\n",sizeof("\n")-1);` |
|      351 |  2484 | `		SyBlobAppend(&sOut,"  thrown in ",sizeof("  thrown in ")-1);` |
|      351 |  2485 | `		SyBlobAppend(&sOut,pFile->zString,pFile->nByte);` |
|      351 |  2486 | `		SyBlobAppend(&sOut," on line 1",sizeof(" on line 1")-1);` |
|      175 |  2487 | `	}` |
|      351 |  2488 | `	VmCallErrorHandler(pVm,&sOut);` |
|      351 |  2489 | `	SyBlobRelease(&sOut);` |
|      351 |  2490 | `	return PH7_ABORT;` |
|      176 |  2491 |  |
|        - |  2492 | `/*` |
|        - |  2493 | ` * Throw an internal exception instance that can be intercepted by try/catch.` |
|        - |  2494 | ` */` |
|      346 |  2495 | `PH7_PRIVATE sxi32 PH7_VmThrowException(ph7_context *pCtx,const char *zClass,const char *zFormat,...)` |
|        2 |  2496 |  |
|        - |  2497 | `	ph7_vm *pVm;` |
...
|        - |  2507 | `	sxi32 rc;` |
|        - |  2508 |  |
|      348 |  2509 | `	if( pCtx == 0 \|\| pCtx->pVm == 0 ){` |
|      ! 0 |  2510 | `		return PH7_ABORT;` |
|        - |  2511 | `	}` |
|      348 |  2512 | `	pVm = pCtx->pVm;` |
|      348 |  2513 | `	if( zClass == 0 \|\| zClass[0] == 0 ){` |
|      ! 0 |  2514 | `		zClass = "Error";` |
|      ! 0 |  2515 | `	}` |
|      348 |  2516 | `	pClass = PH7_VmExtractClass(&(*pVm),zClass,SyStrlen(zClass),TRUE,0);` |
|      348 |  2517 | `	if( pClass == 0 ){` |
|      ! 0 |  2518 | `		return PH7_VmThrowExceptionTrace(pCtx,zClass,` |
|        - |  2519 | `			"Cannot throw internal exception, class '%s' is not available",` |
|      ! 0 |  2520 | `			zClass` |
|        - |  2521 | `			);` |
|        - |  2522 | `	}` |
|      348 |  2523 | `	pThis = PH7_NewClassInstance(&(*pVm),pClass);` |
|      348 |  2524 | `	if( pThis == 0 ){` |
...
|        - |  2528 | `	}` |
|        - |  2529 |  |
|      348 |  2530 | `	SyBlobInit(&sMsg,&pVm->sAllocator);` |
|      348 |  2531 | `	va_start(ap,zFormat);` |
|      348 |  2532 | `	SyBlobFormatAp(&sMsg,zFormat,ap);` |
|      348 |  2533 | `	va_end(ap);` |
|        - |  2534 |  |
|      348 |  2535 | `	pCons = PH7_ClassExtractMethod(pClass,"__construct",sizeof("__construct")-1);` |
|      348 |  2536 | `	if( pCons ){` |
|      348 |  2537 | `		SyStringInitFromBuf(&sMsgStr,(const char *)SyBlobData(&sMsg),SyBlobLength(&sMsg));` |
|      348 |  2538 | `		PH7_MemObjInitFromString(&(*pVm),&sArg,&sMsgStr);` |
|      348 |  2539 | `		apArg[0] = &sArg;` |
|      348 |  2540 | `		PH7_VmCallClassMethod(&(*pVm),pThis,pCons,0,1,apArg);` |
|      348 |  2541 | `		PH7_MemObjRelease(&sArg);` |
|      173 |  2542 | `	}` |
|      348 |  2543 | `	SyBlobRelease(&sMsg);` |
|        - |  2544 |  |
|      348 |  2545 | `	pFrame = pVm->pFrame;` |
|      348 |  2546 | `	if( pFrame ){` |
|      350 |  2547 | `		while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|        3 |  2548 | `			pFrame = pFrame->pParent;` |
|        1 |  2549 | `		}` |
|      348 |  2550 | `		pFrame->iFlags \|= VM_FRAME_THROW;` |
|      173 |  2551 | `	}` |
|      348 |  2552 | `	rc = VmThrowException(&(*pVm),pThis);` |
|      348 |  2553 | `	PH7_ClassInstanceUnref(pThis);` |
|      348 |  2554 | `	if( rc == SXERR_ABORT ){` |
|      345 |  2555 | `		return PH7_ABORT;` |
|        - |  2556 | `	}` |
...
|        - |  2610 | ` */` |
|    26674 |  2611 | `static sxi32 VmByteCodeExec(` |
...
|    26676 |  2627 | `	SySetInit(&aArg,&pVm->sAllocator,sizeof(ph7_value *));` |
|    26676 |  2628 | `	if( nTos < 0 ){` |
|    25360 |  2629 | `		pTos = &pStack[-1];` |
|    12681 |  2630 | `	}else{` |
|     1318 |  2631 | `		pTos = &pStack[nTos];` |
|        - |  2632 | `	}` |
|    26676 |  2633 | `	pc = 0;` |
|        - |  2634 | `	/* Execute as much as we can */` |
|  4633564 |  2635 | `	for(;;){` |
|        - |  2636 | `		/* Fetch the instruction to execute */` |
|  9266426 |  2637 | `		pInstr = &aInstr[pc];` |
|  9266426 |  2638 | `		rc = SXRET_OK;` |
|        - |  2639 | `/*` |
...
|        - |  2645 | ` */` |
|  9266426 |  2646 | `		switch(pInstr->iOp){` |
|        - |  2647 | `/*` |
|        - |  2648 | ` * DONE: P1 * *` |
|        - |  2649 | ` *` |
...
|        - |  2652 | ` */` |
|    13153 |  2653 | `case PH7_OP_DONE:` |
|    26308 |  2654 | `	if( pInstr->iP1 ){` |
|        - |  2655 | `#ifdef UNTRUST` |
|        - |  2656 | `		if( pTos < pStack ){` |
|        - |  2657 | `			goto Abort;` |
|        - |  2658 | `		}` |
|        - |  2659 | `#endif` |
|    14948 |  2660 | `		if( pLastRef ){` |
|     9790 |  2661 | `			*pLastRef = pTos->nIdx;` |
|     4894 |  2662 | `		}` |
|    14948 |  2663 | `		if( pResult ){` |
|        - |  2664 | `			/* Execution result */` |
|    14280 |  2665 | `			PH7_MemObjStore(pTos,pResult);` |
|     7139 |  2666 | `		}` |
|    14948 |  2667 | `		VmPopOperand(&pTos,1);` |
|    18835 |  2668 | `	}else if( pLastRef ){` |
|        - |  2669 | `		/* Nothing referenced */` |
|      754 |  2670 | `		*pLastRef = SXU32_HIGH;` |
|      376 |  2671 | `	}` |
|    26308 |  2672 | `	goto Done;` |
|        - |  2673 | `/*` |
|        - |  2674 | ` * HALT: P1 * *` |
|        - |  2675 | ` *` |
...
|        - |  2719 | ` */` |
|   203858 |  2720 | `case PH7_OP_JMP:` |
|   407762 |  2721 | `	pc = pInstr->iP2 - 1;` |
|   407762 |  2722 | `	break;` |
|        - |  2723 | `/*` |
|        - |  2724 | ` * JZ: P1 P2 *` |
|        - |  2725 | ` *` |
...
|   940132 |  2736 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|       77 |  2737 | `		PH7_MemObjToBool(pTos);` |
|       38 |  2738 | `	}` |
|   940132 |  2739 | `	if( !pTos->x.iVal ){` |
|        - |  2740 | `		/* Take the jump */` |
|   450862 |  2741 | `		pc = pInstr->iP2 - 1;` |
|   225430 |  2742 | `	}` |
|   940132 |  2743 | `	if( !pInstr->iP1 ){` |
|   739278 |  2744 | `		VmPopOperand(&pTos,1);` |
|   369660 |  2745 | `	}` |
|   940132 |  2746 | `	break;` |
|        - |  2747 | `/*` |
|        - |  2748 | ` * JNZ: P1 P2 *` |
...
|    99036 |  2760 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      ! 0 |  2761 | `		PH7_MemObjToBool(pTos);` |
|      ! 0 |  2762 | `	}` |
|    99036 |  2763 | `	if( pTos->x.iVal ){` |
|        - |  2764 | `		/* Take the jump */` |
|     3902 |  2765 | `		pc = pInstr->iP2 - 1;` |
|     1950 |  2766 | `	}` |
|    99036 |  2767 | `	if( !pInstr->iP1 ){` |
...
|        - |  2783 | ` */` |
|   363277 |  2784 | `case PH7_OP_POP: {` |
|   726600 |  2785 | `	sxi32 n = pInstr->iP1;` |
|   726600 |  2786 | `	if( &pTos[-n+1] < pStack ){` |
|        - |  2787 | `		/* TICKET 1433-51 Stack underflow must be handled at run-time */` |
|      ! 0 |  2788 | `		n = (sxi32)(pTos - pStack);` |
|      ! 0 |  2789 | `	}` |
|   726600 |  2790 | `	VmPopOperand(&pTos,n);` |
|   726600 |  2791 | `	break;` |
|        - |  2792 | `				 }` |
|        - |  2793 | `/*` |
|        - |  2794 | ` * CVT_INT: * * *` |
...
|        - |  2923 | ` */` |
|    11324 |  2924 | `case PH7_OP_ERR_CTRL:` |
|        - |  2925 | `	/*` |
...
|        - |  2977 | ` */` |
|   748964 |  2978 | `case PH7_OP_LOADC: {` |
|        - |  2979 | `	ph7_value *pObj;` |
|        - |  2980 | `	/* Reserve a room */` |
|  1497974 |  2981 | `	pTos++;` |
|  1497974 |  2982 | `	if( (pObj = (ph7_value *)SySetAt(&pVm->aLitObj,pInstr->iP2)) != 0 ){` |
|  1497974 |  2983 | `		if( pInstr->iP1 == 1 && SyBlobLength(&pObj->sBlob) <= 64 ){` |
|        - |  2984 | `			SyHashEntry *pEntry;` |
|        - |  2985 | `			/* Candidate for expansion via user defined callbacks */` |
|    17136 |  2986 | `			pEntry = SyHashGet(&pVm->hConstant,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|    17136 |  2987 | `			if( pEntry ){` |
|    14102 |  2988 | `				ph7_constant *pCons = (ph7_constant *)pEntry->pUserData;` |
|        - |  2989 | `				/* Set a NULL default value */` |
|    14102 |  2990 | `				MemObjSetType(pTos,MEMOBJ_NULL);` |
|    14102 |  2991 | `				SyBlobReset(&pTos->sBlob);` |
|        - |  2992 | `				/* Invoke the callback and deal with the expanded value */` |
|    14102 |  2993 | `				pCons->xExpand(pTos,pCons->pUserData);` |
|        - |  2994 | `				/* Mark as constant */` |
|    14102 |  2995 | `				pTos->nIdx = SXU32_HIGH;` |
|    14102 |  2996 | `				break;` |
|        - |  2997 | `			}` |
|     1517 |  2998 | `		}` |
|  1483874 |  2999 | `		PH7_MemObjLoad(pObj,pTos);` |
|   741960 |  3000 | `	}else{` |
|        - |  3001 | `		/* Set a NULL value */` |
|      ! 0 |  3002 | `		MemObjSetType(pTos,MEMOBJ_NULL);` |
|        - |  3003 | `	}` |
|        - |  3004 | `	/* Mark as constant */` |
|  1483874 |  3005 | `	pTos->nIdx = SXU32_HIGH;` |
|  1483874 |  3006 | `	break;` |
|        - |  3007 | `				  }` |
|        - |  3008 | `/*` |
|        - |  3009 | ` * LOAD: P1 * P3` |
...
|        - |  3015 | ` */` |
|  1276110 |  3016 | `case PH7_OP_LOAD:{` |
|        - |  3017 | `	ph7_value *pObj;` |
|        - |  3018 | `	SyString sName;` |
|  2552442 |  3019 | `	if( pInstr->p3 == 0 ){` |
...
|       10 |  3031 | `	}else{` |
|  2552424 |  3032 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - |  3033 | `		/* Reserve a room for the target object */` |
|  2552424 |  3034 | `		pTos++;` |
|        - |  3035 | `	}` |
|        - |  3036 | `	/* Extract the requested memory object */` |
|  2552442 |  3037 | `	pObj = VmExtractMemObj(&(*pVm),&sName,pInstr->p3 ? FALSE : TRUE,pInstr->iP1 != 1);` |
|  2552442 |  3038 | `	if( pObj == 0 ){` |
...
|  2551876 |  3055 | `	PH7_MemObjLoad(pObj,pTos);` |
|  2551876 |  3056 | `	pTos->nIdx = pObj->nIdx;` |
|  2551876 |  3057 | `	break;` |
|        - |  3058 | `				   }` |
|        - |  3059 | `/*` |
|        - |  3060 | ` * LOAD_MAP P1 * *` |
...
|        - |  3065 | ` */` |
|    16312 |  3066 | `case PH7_OP_LOAD_MAP: {` |
|        - |  3067 | `	ph7_hashmap *pMap;` |
|        - |  3068 | `	/* Allocate a new hashmap instance */` |
|    32626 |  3069 | `	pMap = PH7_NewHashmap(&(*pVm),0,0);` |
|    32626 |  3070 | `	if( pMap == 0 ){` |
...
|    32626 |  3099 | `	pTos++;` |
|    32626 |  3100 | `	pTos->nIdx = SXU32_HIGH;` |
|    32626 |  3101 | `	pTos->x.pOther = pMap;` |
|    32626 |  3102 | `	MemObjSetType(pTos,MEMOBJ_HASHMAP);` |
|    32626 |  3103 | `	break;` |
|        - |  3104 | `					  }` |
|        - |  3105 | `/*` |
|        - |  3106 | ` * LOAD_LIST: P1 * *` |
...
|        - |  3157 | ` * instead.` |
|        - |  3158 | ` */` |
|   208159 |  3159 | `case PH7_OP_LOAD_IDX: {` |
|   416364 |  3160 | `	ph7_hashmap_node *pNode = 0; /* cc warning */` |
|   416364 |  3161 | `	ph7_hashmap *pMap = 0;` |
|        - |  3162 | `	ph7_value *pIdx;` |
|   416364 |  3163 | `	pIdx = 0;` |
|   416364 |  3164 | `	if( pInstr->iP1 == 0 ){` |
...
|        - |  3179 | `		}` |
|      ! 0 |  3180 | `	}else{` |
|   416364 |  3181 | `		pIdx = pTos;` |
|   416364 |  3182 | `		pTos--;` |
|        - |  3183 | `	}` |
|   416364 |  3184 | `	if( pTos->iFlags & MEMOBJ_STRING ){` |
|        - |  3185 | `		/* String access */` |
|   335536 |  3186 | `		if( pIdx ){` |
|        - |  3187 | `			sxu32 nOfft;` |
|   335536 |  3188 | `			if( (pIdx->iFlags & MEMOBJ_INT) == 0 ){` |
|        - |  3189 | `				/* Force an int cast */` |
|      ! 0 |  3190 | `				PH7_MemObjToInteger(pIdx);` |
|      ! 0 |  3191 | `			}` |
|   335536 |  3192 | `			nOfft = (sxu32)pIdx->x.iVal;` |
|   335536 |  3193 | `			if( nOfft >= SyBlobLength(&pTos->sBlob) ){` |
|        - |  3194 | `				/* Invalid offset,load null */` |
|      ! 0 |  3195 | `				PH7_MemObjRelease(pTos);` |
|      ! 0 |  3196 | `			}else{` |
|   335536 |  3197 | `				const char *zData = (const char *)SyBlobData(&pTos->sBlob);` |
|   335536 |  3198 | `				int c = zData[nOfft];` |
|   335536 |  3199 | `				PH7_MemObjRelease(pTos);` |
|   335536 |  3200 | `				MemObjSetType(pTos,MEMOBJ_STRING);` |
|   335536 |  3201 | `				SyBlobAppend(&pTos->sBlob,(const void *)&c,sizeof(char));` |
|        - |  3202 | `			}` |
|   167791 |  3203 | `		}else{` |
...
|   335536 |  3207 | `		break;` |
|        - |  3208 | `	}` |
|    80830 |  3209 | `	if( pInstr->iP2 && (pTos->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
...
|      ! 0 |  3216 | `		}` |
|      ! 0 |  3217 | `	}` |
|    80830 |  3218 | `	rc = SXERR_NOTFOUND; /* Assume the index is invalid */` |
|    80830 |  3219 | `	if( pTos->iFlags & MEMOBJ_HASHMAP ){` |
|        - |  3220 | `		/* Point to the hashmap */` |
|    80830 |  3221 | `		pMap = (ph7_hashmap *)pTos->x.pOther;` |
|    80830 |  3222 | `		if( pIdx ){` |
|        - |  3223 | `			/* Load the desired entry */` |
|    80830 |  3224 | `			rc = PH7_HashmapLookup(pMap,pIdx,&pNode);` |
|    40414 |  3225 | `		}` |
|    80830 |  3226 | `		if( rc != SXRET_OK && pInstr->iP2 ){` |
...
|    40414 |  3234 | `	}` |
|    80830 |  3235 | `	if( pIdx ){` |
|    80830 |  3236 | `		PH7_MemObjRelease(pIdx);` |
|    40414 |  3237 | `	}` |
|    80830 |  3238 | `	if( rc == SXRET_OK ){` |
|        - |  3239 | `		/* Load entry contents */` |
|    37398 |  3240 | `		if( pMap->iRef < 2 ){` |
...
|        4 |  3246 | `		}else{` |
|    37392 |  3247 | `			pTos->nIdx = pNode->nValIdx;` |
|    37392 |  3248 | `			PH7_HashmapExtractNodeValue(pNode,pTos,FALSE);` |
|    37392 |  3249 | `			PH7_HashmapUnref(pMap);` |
|        - |  3250 | `		}` |
|    18700 |  3251 | `	}else{` |
|        - |  3252 | `		/* No such entry,load NULL */` |
|    43434 |  3253 | `		PH7_MemObjRelease(pTos);` |
|    43434 |  3254 | `		pTos->nIdx = SXU32_HIGH;` |
|        - |  3255 | `	}` |
|    80830 |  3256 | `	break;` |
|        - |  3257 | `					  }` |
|        - |  3258 | `/*` |
...
|        - |  3338 | `	}` |
|        - |  3339 | `#endif` |
|   198668 |  3340 | `	if( pInstr->iP2 ){` |
|        - |  3341 | `		sxu32 nIdx;` |
|        - |  3342 | `		/* Member store operation */` |
|     2218 |  3343 | `		nIdx = pTos->nIdx;` |
|     2218 |  3344 | `		VmPopOperand(&pTos,1);` |
|     2218 |  3345 | `		if( nIdx == SXU32_HIGH ){` |
...
|     2214 |  3351 | `			pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|     2214 |  3352 | `			if( pObj ){` |
|        - |  3353 | `				/* Perform the store operation */` |
|     2214 |  3354 | `				PH7_MemObjStore(pTos,pObj);` |
|     1106 |  3355 | `			}` |
|        - |  3356 | `		}` |
|   100443 |  3357 | `		break;` |
|   196452 |  3358 | `	}else if( pInstr->p3 == 0 ){` |
...
|        - |  3393 | ` */` |
|    75624 |  3394 | `case PH7_OP_STORE_IDX:` |
|        - |  3395 | `case PH7_OP_STORE_IDX_REF: {` |
|   151250 |  3396 | `	ph7_hashmap *pMap = 0; /* cc  warning */` |
|        - |  3397 | `	ph7_value *pKey;` |
|        - |  3398 | `	sxu32 nIdx;` |
|   151250 |  3399 | `	if( pInstr->iP1 ){` |
|        - |  3400 | `		/* Key is next on stack */` |
|    54760 |  3401 | `		pKey = pTos;` |
|    54760 |  3402 | `		pTos--;` |
|    27381 |  3403 | `	}else{` |
|    96492 |  3404 | `		pKey = 0;` |
|        - |  3405 | `	}` |
|   151250 |  3406 | `	nIdx = pTos->nIdx;` |
|   151250 |  3407 | `	if( pTos->iFlags & MEMOBJ_HASHMAP ){` |
|        - |  3408 | `		/* Hashmap already loaded */` |
|   151198 |  3409 | `		pMap = (ph7_hashmap *)pTos->x.pOther;` |
|   151198 |  3410 | `		if( pMap->iRef < 2 ){` |
...
|        - |  3467 | `	}` |
|   151198 |  3468 | `	VmPopOperand(&pTos,1);` |
|        - |  3469 | `	/* Phase#2: Perform the insertion */` |
|   151198 |  3470 | `	if( pInstr->iOp == PH7_OP_STORE_IDX_REF && pTos->nIdx != SXU32_HIGH ){` |
|        - |  3471 | `		/* Insertion by reference */` |
|       15 |  3472 | `		PH7_HashmapInsertByRef(pMap,pKey,pTos->nIdx);` |
|        8 |  3473 | `	}else{` |
|   151184 |  3474 | `		PH7_HashmapInsert(pMap,pKey,pTos);` |
|        - |  3475 | `	}` |
|   151198 |  3476 | `	if( pKey ){` |
|    54710 |  3477 | `		PH7_MemObjRelease(pKey);` |
|    27354 |  3478 | `	}` |
|   151198 |  3479 | `	break;` |
|        - |  3480 | `					   }` |
|        - |  3481 | `/*` |
...
|        - |  3487 | ` */` |
|   151954 |  3488 | `case PH7_OP_INCR:` |
|        - |  3489 | `#ifdef UNTRUST` |
|        - |  3490 | `	if( pTos < pStack ){` |
|        - |  3491 | `		goto Abort;` |
|        - |  3492 | `	}` |
|        - |  3493 | `#endif` |
|   303954 |  3494 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) == 0 ){` |
|   303954 |  3495 | `		if( pTos->nIdx != SXU32_HIGH ){` |
|        - |  3496 | `			ph7_value *pObj;` |
|   303954 |  3497 | `			if( (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pTos->nIdx)) != 0 ){` |
|        - |  3498 | `				/* Force a numeric cast */` |
|   303954 |  3499 | `				PH7_MemObjToNumeric(pObj);` |
|   303954 |  3500 | `				if( pObj->iFlags & MEMOBJ_REAL ){` |
|      ! 0 |  3501 | `					pObj->rVal++;` |
|        - |  3502 | `					/* Try to get an integer representation */` |
|      ! 0 |  3503 | `					PH7_MemObjTryInteger(pTos);` |
|      ! 0 |  3504 | `				}else{` |
|   303954 |  3505 | `					pObj->x.iVal++;` |
|   303954 |  3506 | `					MemObjSetType(pTos,MEMOBJ_INT);` |
|        - |  3507 | `				}` |
|   303954 |  3508 | `				if( pInstr->iP1 ){` |
|        - |  3509 | `					/* Pre-icrement */` |
...
|    42214 |  3591 | `	PH7_MemObjToNumeric(pTos);` |
|    42214 |  3592 | `	if( pTos->iFlags & MEMOBJ_REAL ){` |
|       25 |  3593 | `		pTos->rVal = -pTos->rVal;` |
|       12 |  3594 | `	}` |
|    42214 |  3595 | `	if( pTos->iFlags & MEMOBJ_INT ){` |
|    42190 |  3596 | `		pTos->x.iVal = -pTos->x.iVal;` |
|    21094 |  3597 | `	}` |
|    42214 |  3598 | `	break;` |
|        - |  3599 | `/*` |
|        - |  3600 | ` * UPLUS: * * *` |
...
|    91254 |  3632 | `	if( (pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|       21 |  3633 | `		PH7_MemObjToBool(pTos);` |
|       10 |  3634 | `	}` |
|    91254 |  3635 | `	pTos->x.iVal = !pTos->x.iVal;` |
|    91254 |  3636 | `	break;` |
|        - |  3637 | `/*` |
|        - |  3638 | ` * OP_BITNOT: * * *` |
|        - |  3639 | ` *` |
...
|        - |  4237 | ` * back.` |
|        - |  4238 | ` */` |
|    57139 |  4239 | `case PH7_OP_CAT:{` |
|        - |  4240 | `	ph7_value *pNos,*pCur;` |
|   114280 |  4241 | `	if( pInstr->iP1 < 1 ){` |
|    87526 |  4242 | `		pNos = &pTos[-1];` |
|    43764 |  4243 | `	}else{` |
|    26756 |  4244 | `		pNos = &pTos[-pInstr->iP1+1];` |
|        - |  4245 | `	}` |
|        - |  4246 | `#ifdef UNTRUST` |
|        - |  4247 | `	if( pNos < pStack ){` |
|        - |  4248 | `		goto Abort;` |
...
|   114280 |  4252 | `	if( (pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|      854 |  4253 | `		PH7_MemObjToString(pNos);` |
|      426 |  4254 | `	}` |
|   114280 |  4255 | `	pCur = &pNos[1];` |
|   230052 |  4256 | `	while( pCur <= pTos ){` |
|   115774 |  4257 | `		if( (pCur->iFlags & MEMOBJ_STRING) == 0 ){` |
|    50328 |  4258 | `			PH7_MemObjToString(pCur);` |
|    25163 |  4259 | `		}` |
|        - |  4260 | `		/* Perform the concatenation */` |
|   115774 |  4261 | `		if( SyBlobLength(&pCur->sBlob) > 0 ){` |
|   115736 |  4262 | `			PH7_MemObjStringAppend(pNos,(const char *)SyBlobData(&pCur->sBlob),SyBlobLength(&pCur->sBlob));` |
|    57867 |  4263 | `		}` |
|   115774 |  4264 | `		SyBlobRelease(&pCur->sBlob);` |
|   115774 |  4265 | `		pCur++;` |
|        2 |  4266 | `	}` |
|   114280 |  4267 | `	pTos = pNos;` |
|   114280 |  4268 | `	break;` |
|        - |  4269 | `				}` |
|        - |  4270 | `/*  CAT_STORE: * * *` |
|        - |  4271 | ` *` |
...
|        - |  4273 | ` * back.` |
|        - |  4274 | ` */` |
|     2376 |  4275 | `case PH7_OP_CAT_STORE:{` |
|     4754 |  4276 | `	ph7_value *pNos = &pTos[-1];` |
|        - |  4277 | `	ph7_value *pObj;` |
|        - |  4278 | `#ifdef UNTRUST` |
|        - |  4279 | `	if( pNos < pStack ){` |
|        - |  4280 | `		goto Abort;` |
|        - |  4281 | `	}` |
|        - |  4282 | `#endif` |
|     4754 |  4283 | `	if((pTos->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - |  4284 | `		/* Force a string cast */` |
|      ! 0 |  4285 | `		PH7_MemObjToString(pTos);` |
|      ! 0 |  4286 | `	}` |
|     4754 |  4287 | `	if((pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - |  4288 | `		/* Force a string cast */` |
|      ! 0 |  4289 | `		PH7_MemObjToString(pNos);` |
|      ! 0 |  4290 | `	}` |
|        - |  4291 | `	/* Perform the concatenation (Reverse order) */` |
|     4754 |  4292 | `	if( SyBlobLength(&pNos->sBlob) > 0 ){` |
|     4754 |  4293 | `		PH7_MemObjStringAppend(pTos,(const char *)SyBlobData(&pNos->sBlob),SyBlobLength(&pNos->sBlob));` |
|     2376 |  4294 | `	}` |
|        - |  4295 | `	/* Perform the store operation */` |
|     4754 |  4296 | `	if( pTos->nIdx == SXU32_HIGH ){` |
|      ! 0 |  4297 | `		PH7_VmThrowError(&(*pVm),0,PH7_CTX_ERR,"Cannot perform assignment on a constant class attribute");` |
|     4754 |  4298 | `	}else if( (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pTos->nIdx)) != 0 ){` |
|     4754 |  4299 | `		PH7_MemObjStore(pTos,pObj);` |
|     2376 |  4300 | `	}` |
|     4754 |  4301 | `	PH7_MemObjStore(pTos,pNos);` |
|     4754 |  4302 | `	VmPopOperand(&pTos,1);` |
|     4754 |  4303 | `	break;` |
|        - |  4304 | `				}` |
|        - |  4305 | `/* OP_AND: * * *` |
|        - |  4306 | ` *` |
...
|        - |  4315 | ` * stack.` |
|        - |  4316 | ` */` |
|    96658 |  4317 | `case PH7_OP_LAND:` |
|        - |  4318 | `case PH7_OP_LOR: {` |
|   193362 |  4319 | `	ph7_value *pNos = &pTos[-1];` |
...
|   193362 |  4327 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|        3 |  4328 | `		PH7_MemObjToBool(pTos);` |
|        1 |  4329 | `	}` |
|   193362 |  4330 | `	if((pNos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      ! 0 |  4331 | `		PH7_MemObjToBool(pNos);` |
|      ! 0 |  4332 | `	}` |
|   193362 |  4333 | `	v1 = pNos->x.iVal == 0 ? 1 : 0;` |
|   193362 |  4334 | `	v2 = pTos->x.iVal == 0 ? 1 : 0;` |
|   193362 |  4335 | `	if( pInstr->iOp == PH7_OP_LAND ){` |
|        - |  4336 | `		static const unsigned char and_logic[] = { 0, 1, 2, 1, 1, 1, 2, 1, 2 };` |
|    98228 |  4337 | `		v1 = and_logic[v1*3+v2];` |
|    49137 |  4338 | `	}else{` |
|        - |  4339 | `		static const unsigned char or_logic[] = { 0, 0, 0, 0, 1, 2, 0, 2, 2 };` |
|    95136 |  4340 | `		v1 = or_logic[v1*3+v2];` |
|        - |  4341 | `	}` |
|   193362 |  4342 | `	if( v1 == 2 ){` |
|      ! 0 |  4343 | `		v1 = 1;` |
|      ! 0 |  4344 | `	}` |
|   193362 |  4345 | `	VmPopOperand(&pTos,1);` |
|   193362 |  4346 | `	pTos->x.iVal = v1 == 0 ? 1 : 0;` |
|   193362 |  4347 | `	MemObjSetType(pTos,MEMOBJ_BOOL);` |
|   193362 |  4348 | `	break;` |
|        - |  4349 | `				 }` |
|        - |  4350 | `/* OP_LXOR: * * *` |
|        - |  4351 | ` *` |
...
|        - |  4395 | ` */` |
|     3573 |  4396 | `case PH7_OP_EQ:` |
|        - |  4397 | `case PH7_OP_NEQ: {` |
|     7148 |  4398 | `	ph7_value *pNos = &pTos[-1];` |
...
|        - |  4403 | `	}` |
|        - |  4404 | `#endif` |
|     7148 |  4405 | `	rc = PH7_MemObjCmp(pNos,pTos,FALSE,0);` |
|     7148 |  4406 | `	if( VmIsUnorderedCmp(pNos,pTos) ){` |
|       11 |  4407 | `		rc = pInstr->iOp == PH7_OP_EQ ? 0 : 1;` |
|     7143 |  4408 | `	}else if( pInstr->iOp == PH7_OP_EQ ){` |
|     7112 |  4409 | `		rc = rc == 0;` |
|     3557 |  4410 | `	}else{` |
|       28 |  4411 | `		rc = rc != 0;` |
|        - |  4412 | `	}` |
|     7148 |  4413 | `	VmPopOperand(&pTos,1);` |
|     7148 |  4414 | `	if( !pInstr->iP2 ){` |
|        - |  4415 | `		/* Push comparison result without taking the jump */` |
|     7148 |  4416 | `		PH7_MemObjRelease(pTos);` |
|     7148 |  4417 | `		pTos->x.iVal = rc;` |
|        - |  4418 | `		/* Invalidate any prior representation */` |
|     7148 |  4419 | `		MemObjSetType(pTos,MEMOBJ_BOOL);` |
|     3575 |  4420 | `	}else{` |
|      ! 0 |  4421 | `		if( rc ){` |
...
|        - |  4435 | ` */` |
|   117588 |  4436 | `case PH7_OP_TEQ: {` |
|   235178 |  4437 | `	ph7_value *pNos = &pTos[-1];` |
...
|        - |  4442 | `	}` |
|        - |  4443 | `#endif` |
|   235178 |  4444 | `	rc = PH7_MemObjCmp(pNos,pTos,TRUE,0);` |
|   235178 |  4445 | `	if( VmIsUnorderedCmp(pNos,pTos) ){` |
|        3 |  4446 | `		rc = 0;` |
|        2 |  4447 | `	}else{` |
|   235176 |  4448 | `		rc = rc == 0;` |
|        - |  4449 | `	}` |
|   235178 |  4450 | `	VmPopOperand(&pTos,1);` |
|   235178 |  4451 | `	if( !pInstr->iP2 ){` |
|        - |  4452 | `		/* Push comparison result without taking the jump */` |
|   235178 |  4453 | `		PH7_MemObjRelease(pTos);` |
|   235178 |  4454 | `		pTos->x.iVal = rc;` |
|        - |  4455 | `		/* Invalidate any prior representation */` |
|   235178 |  4456 | `		MemObjSetType(pTos,MEMOBJ_BOOL);` |
|   117590 |  4457 | `	}else{` |
|      ! 0 |  4458 | `		if( rc ){` |
...
|        - |  4473 | ` *` |
|        - |  4474 | ` */` |
|    93318 |  4475 | `case PH7_OP_TNE: {` |
|   186638 |  4476 | `	ph7_value *pNos = &pTos[-1];` |
...
|        - |  4481 | `	}` |
|        - |  4482 | `#endif` |
|   186638 |  4483 | `	rc = PH7_MemObjCmp(pNos,pTos,TRUE,0);` |
|   186638 |  4484 | `	if( VmIsUnorderedCmp(pNos,pTos) ){` |
|        3 |  4485 | `		rc = 1;` |
|        2 |  4486 | `	}else{` |
|   186636 |  4487 | `		rc = rc != 0;` |
|        - |  4488 | `	}` |
|   186638 |  4489 | `	VmPopOperand(&pTos,1);` |
|   186638 |  4490 | `	if( !pInstr->iP2 ){` |
|        - |  4491 | `		/* Push comparison result without taking the jump */` |
|   186638 |  4492 | `		PH7_MemObjRelease(pTos);` |
|   186638 |  4493 | `		pTos->x.iVal = rc;` |
|        - |  4494 | `		/* Invalidate any prior representation */` |
|   186638 |  4495 | `		MemObjSetType(pTos,MEMOBJ_BOOL);` |
|    93320 |  4496 | `	}else{` |
|      ! 0 |  4497 | `		if( rc ){` |
...
|        - |  4521 | ` *` |
|        - |  4522 | ` */` |
|   106619 |  4523 | `case PH7_OP_LT:` |
|        - |  4524 | `case PH7_OP_LE: {` |
|   213284 |  4525 | `	ph7_value *pNos = &pTos[-1];` |
...
|        - |  4530 | `	}` |
|        - |  4531 | `#endif` |
|   213284 |  4532 | `	rc = PH7_MemObjCmp(pNos,pTos,FALSE,0);` |
|   213284 |  4533 | `	if( VmIsUnorderedCmp(pNos,pTos) ){` |
|        9 |  4534 | `		rc = 0;` |
|   213280 |  4535 | `	}else if( pInstr->iOp == PH7_OP_LE ){` |
|      395 |  4536 | `		rc = rc < 1;` |
|      198 |  4537 | `	}else{` |
|   212882 |  4538 | `		rc = rc < 0;` |
|        - |  4539 | `	}` |
|   213284 |  4540 | `	VmPopOperand(&pTos,1);` |
|   213284 |  4541 | `	if( !pInstr->iP2 ){` |
|        - |  4542 | `		/* Push comparison result without taking the jump */` |
|   213284 |  4543 | `		PH7_MemObjRelease(pTos);` |
|   213284 |  4544 | `		pTos->x.iVal = rc;` |
|        - |  4545 | `		/* Invalidate any prior representation */` |
|   213284 |  4546 | `		MemObjSetType(pTos,MEMOBJ_BOOL);` |
|   106665 |  4547 | `	}else{` |
|      ! 0 |  4548 | `		if( rc ){` |
...
|        - |  4572 | ` *` |
|        - |  4573 | ` */` |
|    45229 |  4574 | `case PH7_OP_GT:` |
|        - |  4575 | `case PH7_OP_GE: {` |
|    90460 |  4576 | `	ph7_value *pNos = &pTos[-1];` |
...
|        - |  4581 | `	}` |
|        - |  4582 | `#endif` |
|    90460 |  4583 | `	rc = PH7_MemObjCmp(pNos,pTos,FALSE,0);` |
|    90460 |  4584 | `	if( VmIsUnorderedCmp(pNos,pTos) ){` |
|        9 |  4585 | `		rc = 0;` |
|    90456 |  4586 | `	}else if( pInstr->iOp == PH7_OP_GE ){` |
|    90304 |  4587 | `		rc = rc >= 0;` |
|    45153 |  4588 | `	}else{` |
|      150 |  4589 | `		rc = rc > 0;` |
|        - |  4590 | `	}` |
|    90460 |  4591 | `	VmPopOperand(&pTos,1);` |
|    90460 |  4592 | `	if( !pInstr->iP2 ){` |
|        - |  4593 | `		/* Push comparison result without taking the jump */` |
|    90460 |  4594 | `		PH7_MemObjRelease(pTos);` |
|    90460 |  4595 | `		pTos->x.iVal = rc;` |
|        - |  4596 | `		/* Invalidate any prior representation */` |
|    90460 |  4597 | `		MemObjSetType(pTos,MEMOBJ_BOOL);` |
|    45231 |  4598 | `	}else{` |
|      ! 0 |  4599 | `		if( rc ){` |
...
|        - |  4896 | ` */` |
|     4347 |  4897 | `case PH7_OP_FOREACH_INIT: {` |
|     8696 |  4898 | `	ph7_foreach_info *pInfo = (ph7_foreach_info *)pInstr->p3;` |
|        - |  4899 | `	void *pName;` |
|        - |  4900 | `#ifdef UNTRUST` |
|        - |  4901 | `	if( pTos < pStack ){` |
|        - |  4902 | `		goto Abort;` |
|        - |  4903 | `	}` |
|        - |  4904 | `#endif` |
|     8696 |  4905 | `	if( SyStringLength(&pInfo->sValue) < 1 ){` |
...
|      ! 0 |  4917 | `	}` |
|     8696 |  4918 | `	if( (pInfo->iFlags & PH7_4EACH_STEP_KEY) && SyStringLength(&pInfo->sKey) < 1 ){` |
...
|     8696 |  4931 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ)) == 0 \|\| SyStringLength(&pInfo->sValue) < 1 ){` |
...
|     8696 |  4939 | `		pStep = (ph7_foreach_step *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_foreach_step));` |
|     8696 |  4940 | `		if( pStep == 0 ){` |
...
|     8696 |  4946 | `			SyZero(pStep,sizeof(ph7_foreach_step));` |
|        - |  4947 | `			/* Prepare the step */` |
|     8696 |  4948 | `			pStep->iFlags = pInfo->iFlags;` |
|     8696 |  4949 | `			if( pTos->iFlags & MEMOBJ_HASHMAP ){` |
|     8688 |  4950 | `				ph7_hashmap *pMap = (ph7_hashmap *)pTos->x.pOther;` |
|        - |  4951 | `				/* Reset the internal loop cursor */` |
|     8688 |  4952 | `				PH7_HashmapResetLoopCursor(pMap);` |
|        - |  4953 | `				/* Mark the step */` |
|     8688 |  4954 | `				pStep->iFlags \|= PH7_4EACH_STEP_HASHMAP;` |
|     8688 |  4955 | `				pStep->xIter.pMap = pMap;` |
|     8688 |  4956 | `				pMap->iRef++;` |
|     4345 |  4957 | `			}else{` |
...
|        - |  4965 | `			}` |
|        - |  4966 | `		}` |
|     8696 |  4967 | `		if( SXRET_OK != SySetPut(&pInfo->aStep,(const void *)&pStep) ){` |
...
|        - |  4980 | ` */` |
|    70462 |  4981 | `case PH7_OP_FOREACH_STEP: {` |
|   140926 |  4982 | `	ph7_foreach_info *pInfo = (ph7_foreach_info *)pInstr->p3;` |
|        - |  4983 | `	ph7_foreach_step **apStep,*pStep;` |
|        - |  4984 | `	ph7_value *pValue;` |
|        - |  4985 | `	VmFrame *pFrameLocal;` |
|        - |  4986 | `	/* Peek the last step */` |
|   140926 |  4987 | `	apStep = (ph7_foreach_step **)SySetBasePtr(&pInfo->aStep);` |
|   140926 |  4988 | `	pStep = apStep[SySetUsed(&pInfo->aStep) - 1];` |
|   140926 |  4989 | `	pFrameLocal = pVm->pFrame;` |
|   145958 |  4990 | `	while( pFrameLocal->pParent && (pFrameLocal->iFlags & VM_FRAME_EXCEPTION) ){` |
|        - |  4991 | `		/* Safely ignore the exception frame */` |
|     5033 |  4992 | `		pFrameLocal = pFrameLocal->pParent;` |
|        1 |  4993 | `	}` |
|   140926 |  4994 | `	if( pStep->iFlags & PH7_4EACH_STEP_HASHMAP ){` |
|   140902 |  4995 | `		ph7_hashmap *pMap = pStep->xIter.pMap;` |
|        - |  4996 | `		ph7_hashmap_node *pNode;` |
|        - |  4997 | `		/* Extract the current node value */` |
|   140902 |  4998 | `		pNode = PH7_HashmapGetNextEntry(pMap);` |
|   140902 |  4999 | `		if( pNode == 0 ){` |
|        - |  5000 | `			/* No more entry to process */` |
|     8688 |  5001 | `			pc = pInstr->iP2 - 1; /* Jump to this destination */` |
|     8688 |  5002 | `			if( pStep->iFlags & PH7_4EACH_STEP_REF ){` |
...
|     8688 |  5007 | `			PH7_HashmapResetLoopCursor(pMap);` |
|        - |  5008 | `			/* Cleanup the mess left behind */` |
|     8688 |  5009 | `			SyMemBackendPoolFree(&pVm->sAllocator,pStep);` |
|     8688 |  5010 | `			SySetPop(&pInfo->aStep);` |
|     8688 |  5011 | `			PH7_HashmapUnref(pMap);` |
|     4345 |  5012 | `		}else{` |
|   132216 |  5013 | `			if( (pStep->iFlags & PH7_4EACH_STEP_KEY) && SyStringLength(&pInfo->sKey) > 0 ){` |
|      259 |  5014 | `				ph7_value *pKey = VmExtractMemObj(&(*pVm),&pInfo->sKey,FALSE,TRUE);` |
|      259 |  5015 | `				if( pKey ){` |
|      259 |  5016 | `					PH7_HashmapExtractNodeKey(pNode,pKey);` |
|      129 |  5017 | `				}` |
|      129 |  5018 | `			}` |
|   132216 |  5019 | `			if( pStep->iFlags & PH7_4EACH_STEP_REF ){` |
...
|   132204 |  5031 | `				pValue = VmExtractMemObj(&(*pVm),&pInfo->sValue,FALSE,TRUE);` |
|   132204 |  5032 | `				if( pValue ){` |
|   132204 |  5033 | `					PH7_HashmapExtractNodeValue(pNode,pValue,TRUE);` |
|    66101 |  5034 | `				}` |
|        - |  5035 | `			}` |
|        - |  5036 | `		}` |
|    70452 |  5037 | `	}else{` |
...
|        - |  5099 | ` */` |
|     1464 |  5100 | `case PH7_OP_MEMBER: {` |
|        - |  5101 | `	ph7_class_instance *pThis;` |
|        - |  5102 | `	ph7_value *pNos;` |
|        - |  5103 | `	SyString sName;` |
|     2930 |  5104 | `	if( !pInstr->iP1 ){` |
|     2872 |  5105 | `		pNos = &pTos[-1];` |
|        - |  5106 | `#ifdef UNTRUST` |
|        - |  5107 | `		if( pNos < pStack ){` |
|        - |  5108 | `			goto Abort;` |
|        - |  5109 | `		}` |
|        - |  5110 | `#endif` |
|     2872 |  5111 | `		if( pNos->iFlags & MEMOBJ_OBJ ){` |
|        - |  5112 | `			ph7_class *pClass;` |
|        - |  5113 | `			/* Class already instantiated */` |
|     2872 |  5114 | `			pThis = (ph7_class_instance *)pNos->x.pOther;` |
|        - |  5115 | `			/* Point to the instantiated class */` |
|     2872 |  5116 | `			pClass = pThis->pClass;` |
|        - |  5117 | `			/* Extract attribute name first */` |
|     2872 |  5118 | `			SyStringInitFromBuf(&sName,(const char *)SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
|     2872 |  5119 | `			if( pInstr->iP2 ){` |
|        - |  5120 | `				/* Method call */` |
...
|     2754 |  5144 | `				VmClassAttr *pObjAttr = 0;` |
|        - |  5145 | `				SyHashEntry *pEntry;` |
|        - |  5146 | `				/* Extract the target attribute */` |
|     2754 |  5147 | `				if( sName.nByte > 0 ){` |
|     2754 |  5148 | `					pEntry = SyHashGet(&pThis->hAttr,(const void *)sName.zString,sName.nByte);` |
|     2754 |  5149 | `					if( pEntry ){` |
|        - |  5150 | `						/* Point to the attribute value */` |
|     2752 |  5151 | `						pObjAttr = (VmClassAttr *)pEntry->pUserData;` |
|     1375 |  5152 | `					}` |
|     1376 |  5153 | `				}` |
|     2754 |  5154 | `				if( pObjAttr == 0 ){` |
...
|        - |  5165 | `				 */` |
|     2754 |  5166 | `				pThis->iRef++;` |
|     2754 |  5167 | `				PH7_MemObjRelease(pTos);` |
|     2754 |  5168 | `				pTos->nIdx = SXU32_HIGH; /* Assume we are loading a constant */` |
|     2754 |  5169 | `				if( pObjAttr ){` |
|     2752 |  5170 | `					ph7_value *pValue = 0; /* cc warning */` |
|        - |  5171 | `					/* Check attribute access */` |
|     2752 |  5172 | `					if( VmClassMemberAccess(&(*pVm),pClass,&pObjAttr->pAttr->sName,pObjAttr->pAttr->iProtection,TRUE) ){` |
|        - |  5173 | `						/* Load attribute */` |
|     2752 |  5174 | `						pValue = (ph7_value *)SySetAt(&pVm->aMemObj,pObjAttr->nIdx);` |
|     2752 |  5175 | `						if( pValue ){` |
|     2752 |  5176 | `							if( pThis->iRef < 2 ){` |
...
|        2 |  5181 | `							}else{` |
|        - |  5182 | `								/* Simple load */` |
|     2750 |  5183 | `								PH7_MemObjLoad(pValue,pTos);` |
|        - |  5184 | `							}` |
|     2752 |  5185 | `							if( (pObjAttr->pAttr->iFlags & PH7_CLASS_ATTR_CONSTANT) == 0 ){` |
|     2750 |  5186 | `								if( pThis->iRef > 1 ){` |
|        - |  5187 | `									/* Load attribute index */` |
|     2748 |  5188 | `									pTos->nIdx = pObjAttr->nIdx;` |
|     1373 |  5189 | `								}` |
|     1374 |  5190 | `							}` |
|     1375 |  5191 | `						}` |
|     1375 |  5192 | `					}` |
...
|     2754 |  5195 | `				PH7_ClassInstanceUnref(pThis);` |
|        - |  5196 | `			}` |
|     1437 |  5197 | `		}else{` |
...
|        - |  5521 | ` */` |
|   266533 |  5522 | `case PH7_OP_CALL: {` |
|   533112 |  5523 | `	ph7_value *pArg = &pTos[-pInstr->iP1];` |
|        - |  5524 | `	SyHashEntry *pEntry;` |
|        - |  5525 | `	SyString sName;` |
|        - |  5526 | `	/* Extract function name */` |
|   533112 |  5527 | `	if( (pTos->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|   266358 |  5562 | `		break;` |
|        - |  5563 | `	}` |
|   533110 |  5564 | `	SyStringInitFromBuf(&sName,SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
|        - |  5565 | `	/* Check for a compiled function first */` |
|   533110 |  5566 | `	pEntry = SyHashGet(&pVm->hFunction,(const void *)sName.zString,sName.nByte);` |
|   533110 |  5567 | `	if( pEntry ){` |
...
|    10548 |  5578 | `		pVmFunc = (ph7_vm_func *)pEntry->pUserData;` |
|    10548 |  5579 | `		pThis = 0;` |
|    10548 |  5580 | `		pSelf = 0;` |
|    10548 |  5581 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
|        - |  5582 | `			ph7_class_method *pMeth;` |
|        - |  5583 | `			/* Class method call */` |
|     1046 |  5584 | `			ph7_value *pTarget = &pTos[-1];` |
|     1046 |  5585 | `			if( pTarget >= pStack && (pTarget->iFlags & (MEMOBJ_STRING\|MEMOBJ_OBJ\|MEMOBJ_NULL)) ){` |
|        - |  5586 | `				/* Extract the 'this' pointer */` |
|     1046 |  5587 | `				if(pTarget->iFlags & MEMOBJ_OBJ ){` |
|        - |  5588 | `					/* Instance already loaded */` |
|     1016 |  5589 | `					pThis = (ph7_class_instance *)pTarget->x.pOther;` |
|     1016 |  5590 | `					pThis->iRef++;` |
|     1016 |  5591 | `					pSelf = pThis->pClass;` |
|      507 |  5592 | `				}` |
|     1046 |  5593 | `				if( pSelf == 0 ){` |
...
|        9 |  5615 | `					}` |
|       15 |  5616 | `				}` |
|     1046 |  5617 | `				VmPopOperand(&pTos,1);` |
|     1046 |  5618 | `				PH7_MemObjRelease(pTos);` |
|        - |  5619 | `				/* Synchronize pointers */` |
|     1046 |  5620 | `				pArg = &pTos[-pInstr->iP1];` |
...
|        - |  5625 | `				 */` |
|     1046 |  5626 | `				while( pArg < pStack ){` |
|      ! 0 |  5627 | `					pArg++;` |
|      ! 0 |  5628 | `				}` |
|     1046 |  5629 | `				if( pSelf ){ /* Paranoid edition */` |
|        - |  5630 | `					/* Check if the call is allowed */` |
|     1046 |  5631 | `					pMeth = PH7_ClassExtractMethod(pSelf,pVmFunc->sName.zString,pVmFunc->sName.nByte);` |
|     1046 |  5632 | `					if( pMeth && pMeth->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|    10548 |  5647 | `		if( pVm->nRecursionDepth > pVm->nMaxDepth ){` |
...
|        3 |  5657 | `			break;` |
|        - |  5658 | `		}` |
|    10546 |  5659 | `		if( pVmFunc->pNextName ){` |
...
|    10546 |  5664 | `		aFormalArg = (ph7_vm_func_arg *)SySetBasePtr(&pVmFunc->aArgs);` |
|        - |  5665 | `		/* Create a new VM frame  */` |
|    10546 |  5666 | `		rc = VmEnterFrame(&(*pVm),pVmFunc,pThis,&pFrame);` |
|    10546 |  5667 | `		if( rc != SXRET_OK ){` |
...
|      ! 0 |  5678 | `			break;` |
|        - |  5679 | `		}` |
|    10546 |  5680 | `		if( (pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) && pThis ){` |
|        - |  5681 | `			/* Install the '$this' variable */` |
|        - |  5682 | `			static const SyString sThis = { "this" , sizeof("this") - 1 };` |
|     1026 |  5683 | `			pObj = VmExtractMemObj(&(*pVm),&sThis,FALSE,TRUE);` |
|     1026 |  5684 | `			if( pObj ){` |
|        - |  5685 | `				/* Reflect the change */` |
|     1026 |  5686 | `				pObj->x.pOther = pThis;` |
|     1026 |  5687 | `				MemObjSetType(pObj,MEMOBJ_OBJ);` |
|      512 |  5688 | `			}` |
|      512 |  5689 | `		}` |
|    10546 |  5690 | `		if( SySetUsed(&pVmFunc->aStatic) > 0 ){` |
...
|    10546 |  5717 | `		n = 0;` |
|    29628 |  5718 | `		while( pArg < pTos ){` |
|    19084 |  5719 | `			if( n < SySetUsed(&pVmFunc->aArgs) ){` |
|    18966 |  5720 | `				if( (pArg->iFlags & MEMOBJ_NULL) && SySetUsed(&aFormalArg[n].aByteCode) > 0 ){` |
...
|    18966 |  5728 | `				if( aFormalArg[n].nType > 0 ){` |
|     1062 |  5729 | `					if ( aFormalArg[n].nType == SXU32_HIGH ){` |
...
|        - |  5753 | `							}` |
|      ! 0 |  5754 | `						}` |
|     1062 |  5755 | `					}else if( ((pArg->iFlags & aFormalArg[n].nType) == 0) ){` |
|      ! 0 |  5756 | `						ProcMemObjCast xCast = PH7_MemObjCastMethod(aFormalArg[n].nType);` |
|        - |  5757 | `						/* Cast to the desired type */` |
|      ! 0 |  5758 | `						xCast(pArg);` |
|      ! 0 |  5759 | `					}` |
|      530 |  5760 | `				}` |
|    18966 |  5761 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_BY_REF ){` |
...
|    18920 |  5787 | `					pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|        - |  5788 | `				}` |
|     9484 |  5789 | `			}else{` |
|        - |  5790 | `				char zName[32];` |
...
|        - |  5797 | `			}` |
|    19084 |  5798 | `			if( pObj ){` |
|    19038 |  5799 | `				PH7_MemObjStore(pArg,pObj);` |
|        - |  5800 | `				/* Insert argument index  */` |
|    19038 |  5801 | `				sArg.nIdx = pObj->nIdx;` |
|    19038 |  5802 | `				sArg.pUserData = 0;` |
|    19038 |  5803 | `				SySetPut(&pFrame->sArg,(const void *)&sArg);` |
|     9518 |  5804 | `			}` |
|    19084 |  5805 | `			PH7_MemObjRelease(pArg);` |
|    19084 |  5806 | `			pArg++;` |
|    19084 |  5807 | `			++n;` |
|        2 |  5808 | `		}` |
|        - |  5809 | `		/* Set up closure environment */` |
|    10546 |  5810 | `		if( pVmFunc->iFlags & VM_FUNC_CLOSURE ){` |
...
|    12114 |  5832 | `		while( n < SySetUsed(&pVmFunc->aArgs) ){` |
|     1570 |  5833 | `			if( SySetUsed(&aFormalArg[n].aByteCode) > 0 ){` |
|     1560 |  5834 | `				pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|     1560 |  5835 | `				if( pObj ){` |
|        - |  5836 | `					/* Evaluate the default value and extract it's result */` |
|     1560 |  5837 | `					rc = VmLocalExec(&(*pVm),&aFormalArg[n].aByteCode,pObj);` |
|     1560 |  5838 | `					if( rc == PH7_ABORT ){` |
|      ! 0 |  5839 | `						goto Abort;` |
|        - |  5840 | `					}` |
|        - |  5841 | `					/* Insert argument index */` |
|     1560 |  5842 | `					sArg.nIdx = pObj->nIdx;` |
|     1560 |  5843 | `					sArg.pUserData = 0;` |
|     1560 |  5844 | `					SySetPut(&pFrame->sArg,(const void *)&sArg);` |
|        - |  5845 | `					/* Make sure the default argument is of the correct type */` |
|     1560 |  5846 | `					if( aFormalArg[n].nType > 0 && ((pObj->iFlags & aFormalArg[n].nType) == 0) ){` |
...
|        - |  5857 | `		 */` |
|    10546 |  5858 | `		PH7_MemObjRelease(pTos);` |
|    10546 |  5859 | `		pTos = &pTos[-pInstr->iP1];` |
|        - |  5860 | `		/* Allocate a new operand stack and evaluate the function body */` |
|    10546 |  5861 | `		pFrameStack = VmNewOperandStack(&(*pVm),SySetUsed(&pVmFunc->aByteCode));` |
|    10546 |  5862 | `		if( pFrameStack == 0 ){` |
...
|     1044 |  5873 | `			SySetPut(&pVm->aSelf,(const void *)&pSelf);` |
|      521 |  5874 | `		}` |
|        - |  5875 | `		/* Increment nesting level */` |
|    10546 |  5876 | `		pVm->nRecursionDepth++;` |
|        - |  5877 | `		/* Execute function body */` |
|    10546 |  5878 | `		rc = VmByteCodeExec(&(*pVm),(VmInstr *)SySetBasePtr(&pVmFunc->aByteCode),pFrameStack,-1,pTos,&n,FALSE);` |
|        - |  5879 | `		/* Decrement nesting level */` |
|    10546 |  5880 | `		pVm->nRecursionDepth--;` |
|    10546 |  5881 | `		if( pSelf ){` |
|        - |  5882 | `			/* Pop class name */` |
|     1044 |  5883 | `			(void)SySetPop(&pVm->aSelf);` |
|      521 |  5884 | `		}` |
|        - |  5885 | `		/* Cleanup the mess left behind */` |
|    10546 |  5886 | `		if( (pVmFunc->iFlags & VM_FUNC_REF_RETURN) && rc == SXRET_OK ){` |
...
|    10546 |  5914 | `		if( rc != PH7_ABORT && ((pFrame->iFlags & VM_FRAME_THROW) \|\| rc == PH7_EXCEPTION) ){` |
...
|    10546 |  5933 | `		SyMemBackendFree(&pVm->sAllocator,pFrameStack);` |
|        - |  5934 | `		/* Leave the frame */` |
|    10546 |  5935 | `		VmLeaveFrame(&(*pVm));` |
|    10546 |  5936 | `		if( rc == PH7_ABORT ){` |
|        - |  5937 | `			/* Abort processing immeditaley */` |
|        5 |  5938 | `			goto Abort;` |
|    10542 |  5939 | `		}else if( rc == PH7_EXCEPTION ){` |
...
|   522564 |  5947 | `		pEntry = SyHashGet(&pVm->hHostFunction,(const void *)sName.zString,sName.nByte);` |
|   522564 |  5948 | `		if( pEntry == 0 ){` |
...
|        5 |  5957 | `			break;` |
|        - |  5958 | `		}` |
|   522560 |  5959 | `		pFunc = (ph7_user_func *)pEntry->pUserData;` |
|        - |  5960 | `		/* Start collecting function arguments */` |
|   522560 |  5961 | `		SySetReset(&aArg);` |
|  1391874 |  5962 | `		while( pArg < pTos ){` |
|   869316 |  5963 | `			SySetPut(&aArg,(const void *)&pArg);` |
|   869316 |  5964 | `			pArg++;` |
|        2 |  5965 | `		}` |
|        - |  5966 | `		/* Assume a null return value */` |
|   522560 |  5967 | `		PH7_MemObjInit(&(*pVm),&sRet);` |
|        - |  5968 | `		/* Init the call context */` |
|   522560 |  5969 | `		VmInitCallContext(&sCtx,&(*pVm),pFunc,&sRet,0);` |
|        - |  5970 | `		/* Call the foreign function */` |
|   522560 |  5971 | `		rc = pFunc->xFunc(&sCtx,(int)SySetUsed(&aArg),(ph7_value **)SySetBasePtr(&aArg));` |
|        - |  5972 | `		/* Release the call context */` |
|   522560 |  5973 | `		VmReleaseCallContext(&sCtx);` |
|   522560 |  5974 | `		if( rc == PH7_ABORT ){` |
|      347 |  5975 | `			goto Abort;` |
|   522214 |  5976 | `		}else if( rc == PH7_EXCEPTION ){` |
|        3 |  5977 | `			goto Exception;` |
|        - |  5978 | `		}` |
|   522212 |  5979 | `		if( pInstr->iP1 > 0 ){` |
|        - |  5980 | `			/* Pop function name and arguments */` |
|   505356 |  5981 | `			VmPopOperand(&pTos,pInstr->iP1);` |
|   252699 |  5982 | `		}` |
|        - |  5983 | `		/* Save foreign function return value */` |
|   522212 |  5984 | `		PH7_MemObjStore(&sRet,pTos);` |
|   522212 |  5985 | `		PH7_MemObjRelease(&sRet);` |
|        - |  5986 | `	}` |
|   532750 |  5987 | `	break;` |
|        - |  5988 | `				  }` |
|        - |  5989 | `/*` |
...
|        - |  5992 | ` */` |
|     9740 |  5993 | `case PH7_OP_CONSUME: {` |
|    19482 |  5994 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|    19482 |  5995 | `	ph7_value *pCur,*pOut = pTos;` |
|        - |  5996 |  |
|    19482 |  5997 | `	pOut = &pTos[-pInstr->iP1 + 1];` |
|    19482 |  5998 | `	pCur = pOut;` |
|        - |  5999 | `	/* Start the consume process  */` |
|    38962 |  6000 | `	while( pOut <= pTos ){` |
|        - |  6001 | `		/* Force a string cast */` |
|    19482 |  6002 | `		if( (pOut->iFlags & MEMOBJ_STRING) == 0 ){` |
|      158 |  6003 | `			PH7_MemObjToString(pOut);` |
|       78 |  6004 | `		}` |
|    19482 |  6005 | `		if( SyBlobLength(&pOut->sBlob) > 0 ){` |
|        - |  6006 | `			/*SyBlobNullAppend(&pOut->sBlob);*/` |
|        - |  6007 | `			/* Invoke the output consumer callback */` |
|    10416 |  6008 | `			rc = pCons->xConsumer(SyBlobData(&pOut->sBlob),SyBlobLength(&pOut->sBlob),pCons->pUserData);` |
|    10416 |  6009 | `			if( pCons->xConsumer != VmObConsumer ){` |
|        - |  6010 | `				/* Increment output length */` |
|     4112 |  6011 | `				pVm->nOutputLen += SyBlobLength(&pOut->sBlob);` |
|     2055 |  6012 | `			}` |
|    10416 |  6013 | `			SyBlobRelease(&pOut->sBlob);` |
|    10416 |  6014 | `			if( rc == SXERR_ABORT ){` |
...
|    19482 |  6019 | `		pOut++;` |
|        2 |  6020 | `	}` |
|    19482 |  6021 | `	pTos = &pCur[-1];` |
|    19480 |  6022 | `	break;` |
|        - |  6023 | `					 }` |
|        - |  6024 |  |
|        - |  6025 | `		} /* Switch() */` |
|  9239752 |  6026 | `		pc++; /* Next instruction in the stream */` |
|        2 |  6027 | `	} /* For(;;) */` |
|    13153 |  6028 | `Done:` |
|    26308 |  6029 | `	SySetRelease(&aArg);` |
|    26308 |  6030 | `	return SXRET_OK;` |
|      178 |  6031 | `Abort:` |
|      357 |  6032 | `	SySetRelease(&aArg);` |
|     1247 |  6033 | `	while( pTos >= pStack ){` |
|      891 |  6034 | `		PH7_MemObjRelease(pTos);` |
|      891 |  6035 | `		pTos--;` |
|        1 |  6036 | `	}` |
|      357 |  6037 | `	return PH7_ABORT;` |
|        2 |  6038 | `Exception:` |
...
|        - |  6050 | ` */` |
|    13158 |  6051 | `static sxi32 VmLocalExec(ph7_vm *pVm,SySet *pByteCode,ph7_value *pResult)` |
|        2 |  6052 |  |
|        - |  6053 | `	ph7_value *pStack;` |
|        - |  6054 | `	sxi32 rc;` |
|        - |  6055 | `	/* Allocate a new operand stack */` |
|    13160 |  6056 | `	pStack = VmNewOperandStack(&(*pVm),SySetUsed(pByteCode));` |
|    13160 |  6057 | `	if( pStack == 0 ){` |
|      ! 0 |  6058 | `		return SXERR_MEM;` |
|        - |  6059 | `	}` |
|        - |  6060 | `	/* Execute the program */` |
|    13160 |  6061 | `	rc = VmByteCodeExec(&(*pVm),(VmInstr *)SySetBasePtr(pByteCode),pStack,-1,&(*pResult),0,FALSE);` |
|        - |  6062 | `	/* Free the operand stack */` |
|    13160 |  6063 | `	SyMemBackendFree(&pVm->sAllocator,pStack);` |
|        - |  6064 | `	/* Execution result */` |
|    13160 |  6065 | `	return rc;` |
|     6581 |  6066 |  |
|        - |  6067 | `/*` |
...
|        - |  6075 | ` */` |
|     1648 |  6076 | `static void VmInvokeShutdownCallbacks(ph7_vm *pVm)` |
|        2 |  6077 |  |
...
|     1650 |  6083 | `	nEntry = SySetUsed(&pVm->aShutdown);` |
|    18130 |  6084 | `	for( i = 0 ; i < (int)SX_ARRAYSIZE(apArg) ; i++ ){` |
|    16482 |  6085 | `		apArg[i] = 0;` |
|     8242 |  6086 | `	}` |
|     1652 |  6087 | `	for( n = 0 ; n < nEntry ; ++n ){` |
...
|        1 |  6110 | `		}` |
|        2 |  6111 | `	}` |
|     1650 |  6112 | `	SySetReset(&pVm->aShutdown);` |
|     1650 |  6113 |  |
|        - |  6114 | `/*` |
...
|        - |  6118 | ` */` |
|     1656 |  6119 | `PH7_PRIVATE sxi32 PH7_VmByteCodeExec(ph7_vm *pVm)` |
|        2 |  6120 |  |
|        - |  6121 | `	/* Make sure we are ready to execute this program */` |
|     1658 |  6122 | `	if( pVm->nMagic != PH7_VM_RUN ){` |
|      ! 0 |  6123 | `		return pVm->nMagic == PH7_VM_EXEC ? SXERR_LOCKED /* Locked VM */ : SXERR_CORRUPT; /* Stale VM */` |
|        - |  6124 | `	}` |
|        - |  6125 | `	/* Set the execution magic number  */` |
|     1658 |  6126 | `	pVm->nMagic = PH7_VM_EXEC;` |
|        - |  6127 | `	/* Execute the program */` |
|     1658 |  6128 | `	VmByteCodeExec(&(*pVm),(VmInstr *)SySetBasePtr(pVm->pByteContainer),pVm->aOps,-1,&pVm->sExec,0,FALSE);` |
|        - |  6129 | `	/* Invoke any shutdown callbacks */` |
|     1654 |  6130 | `	VmInvokeShutdownCallbacks(&(*pVm));` |
|        - |  6131 | `	/*` |
...
|        - |  6336 | ` */` |
|      864 |  6337 | `static int vm_builtin_func_num_args(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  6338 |  |
|        - |  6339 | `	VmFrame *pFrame;` |
|        - |  6340 | `	ph7_vm *pVm;` |
|        - |  6341 | `	/* Point to the target VM */` |
|      866 |  6342 | `	pVm = pCtx->pVm;` |
|        - |  6343 | `	/* Current frame */` |
|      866 |  6344 | `	pFrame = pVm->pFrame;` |
|      866 |  6345 | `	while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|        - |  6346 | `		/* Safely ignore the exception frame */` |
|      ! 0 |  6347 | `		pFrame = pFrame->pParent;` |
|      ! 0 |  6348 | `	}` |
|      866 |  6349 | `	if( pFrame->pParent == 0 ){` |
...
|      866 |  6357 | `	nArg = (int)SySetUsed(&pFrame->sArg);` |
|      866 |  6358 | `	ph7_result_int(pCtx,nArg);` |
|      866 |  6359 | `	return SXRET_OK;` |
|      434 |  6360 |  |
|        - |  6361 | `/*` |
...
|        - |  6514 | ` */` |
|     1658 |  6515 | `static int vm_builtin_func_exists(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  6516 |  |
...
|     1660 |  6527 | `	pVm = pCtx->pVm;` |
|        - |  6528 | `	/* Extract the function name */` |
|     1660 |  6529 | `	zName = ph7_value_to_string(apArg[0],&nLen);` |
|        - |  6530 | `	/* Assume the function is not defined */` |
|     1660 |  6531 | `	res = 0;` |
|        - |  6532 | `	/* Perform the lookup */` |
|     2487 |  6533 | `	if( SyHashGet(&pVm->hFunction,(const void *)zName,(sxu32)nLen) != 0 \|\|` |
|     1654 |  6534 | `		SyHashGet(&pVm->hHostFunction,(const void *)zName,(sxu32)nLen) != 0 ){` |
|        - |  6535 | `			/* Function is defined */` |
|      212 |  6536 | `			res = 1;` |
|      105 |  6537 | `	}` |
|     1660 |  6538 | `	ph7_result_bool(pCtx,res);` |
|     1660 |  6539 | `	return SXRET_OK;` |
|      831 |  6540 |  |
...
|        - |  6547 | ` */` |
|    15700 |  6548 | `PH7_PRIVATE int PH7_VmIsCallable(ph7_vm *pVm,ph7_value *pValue,int CallInvoke)` |
|        2 |  6549 |  |
|    15702 |  6550 | `	int res = 0;` |
|    15702 |  6551 | `	if( pValue->iFlags & MEMOBJ_OBJ ){` |
...
|      ! 0 |  6566 | `		}` |
|    15702 |  6567 | `	}else if( pValue->iFlags & MEMOBJ_HASHMAP ){` |
...
|        3 |  6589 | `			}` |
|        5 |  6590 | `		}` |
|    15693 |  6591 | `	}else if( pValue->iFlags & MEMOBJ_STRING ){` |
|        - |  6592 | `		const char *zName;` |
|        - |  6593 | `		int nLen;` |
|        - |  6594 | `		/* Extract the name */` |
|     4604 |  6595 | `		zName = ph7_value_to_string(pValue,&nLen);` |
|        - |  6596 | `		/* Perform the lookup */` |
|     4617 |  6597 | `		if( SyHashGet(&pVm->hFunction,(const void *)zName,(sxu32)nLen) != 0 \|\|` |
|       26 |  6598 | `			SyHashGet(&pVm->hHostFunction,(const void *)zName,(sxu32)nLen) != 0 ){` |
|        - |  6599 | `				/* Function is callable */` |
|     4590 |  6600 | `				res = 1;` |
|     2294 |  6601 | `		}` |
|     2301 |  6602 | `	}` |
|    15702 |  6603 | `	return res;` |
|        2 |  6604 |  |
|        - |  6605 | `/*` |
...
|        - |  6759 | ` */` |
|      392 |  6760 | `PH7_PRIVATE ph7_class * PH7_VmPeekTopClass(ph7_vm *pVm)` |
|        2 |  6761 |  |
|      394 |  6762 | `	SySet *pSet = &pVm->aSelf;` |
|        - |  6763 | `	ph7_class **apClass;` |
|      394 |  6764 | `	if( SySetUsed(pSet) <= 0 ){` |
|        - |  6765 | `		/* Empty stack,return NULL */` |
|       15 |  6766 | `		return 0;` |
|        - |  6767 | `	}` |
|        - |  6768 | `	/* Peek the last entry */` |
|      380 |  6769 | `	apClass = (ph7_class **)SySetBasePtr(pSet);` |
|      380 |  6770 | `	return apClass[pSet->nUsed - 1];` |
|      198 |  6771 |  |
|        - |  6772 | `/*` |
...
|        - |  7290 | ` */` |
|     2792 |  7291 | `static int VmClassMemberAccess(` |
...
|        - |  7297 | `	)` |
|        2 |  7298 |  |
|     2794 |  7299 | `	if( iProtection != PH7_CLASS_PROT_PUBLIC ){` |
|     2230 |  7300 | `		VmFrame *pFrame = pVm->pFrame;` |
|        - |  7301 | `		ph7_vm_func *pVmFunc;` |
|     2234 |  7302 | `		while( pFrame->pParent && (pFrame->iFlags & (VM_FRAME_EXCEPTION\|VM_FRAME_CATCH) ) ){` |
|        - |  7303 | `			/* Safely ignore the exception frame */` |
|        5 |  7304 | `			pFrame = pFrame->pParent;` |
|        1 |  7305 | `		}` |
|     2230 |  7306 | `		pVmFunc = (ph7_vm_func *)pFrame->pUserData;` |
|     2230 |  7307 | `		if( pVmFunc == 0 \|\| (pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) == 0 ){` |
|        9 |  7308 | `			goto dis; /* Access is forbidden */` |
|        - |  7309 | `		}` |
|     2222 |  7310 | `		if( iProtection == PH7_CLASS_PROT_PRIVATE ){` |
...
|        4 |  7315 | `		}else{` |
|        - |  7316 | `			/* Protected */` |
|     2216 |  7317 | `			ph7_class *pBase = (ph7_class *)pVmFunc->pUserData;` |
|        - |  7318 | `			/* Must be a derived class */` |
|     2216 |  7319 | `			if( !VmInstanceOf(pClass,pBase) ){` |
|      ! 0 |  7320 | `				goto dis; /* Access is forbidden */` |
|        - |  7321 | `			}` |
|        - |  7322 | `		}` |
|     1110 |  7323 | `	}` |
|     2786 |  7324 | `	return 1; /* Access is granted */` |
|        4 |  7325 | `dis:` |
|        9 |  7326 | `	if( bLog ){` |
...
|        - |  7475 | ` */` |
|     5004 |  7476 | `static int VmQueryInterfaceSet(ph7_class *pClass,SySet *pSet)` |
|        2 |  7477 |  |
|        - |  7478 | `	ph7_class **apInterface;` |
|        - |  7479 | `	sxu32 n;` |
|     5006 |  7480 | `	if( SySetUsed(pSet) < 1 ){` |
|        - |  7481 | `		/* Empty interface container */` |
|     5004 |  7482 | `		return FALSE;` |
|        - |  7483 | `	}` |
...
|        - |  7498 | ` */` |
|     2270 |  7499 | `static int VmInstanceOf(ph7_class *pThis,ph7_class *pClass)` |
|        2 |  7500 |  |
|        - |  7501 | `	ph7_class *pParent;` |
|        - |  7502 | `	sxi32 rc;` |
|     2272 |  7503 | `	if( pThis == pClass ){` |
|        - |  7504 | `		/* Instance of the same class */` |
|      140 |  7505 | `		return TRUE;` |
|        - |  7506 | `	}` |
|        - |  7507 | `	/* Check implemented interfaces */` |
|     2134 |  7508 | `	rc = VmQueryInterfaceSet(pClass,&pThis->aInterface);` |
|     2134 |  7509 | `	if( rc ){` |
|        3 |  7510 | `		return TRUE;` |
|        - |  7511 | `	}` |
|        - |  7512 | `	/* Check parent classes */` |
|     2132 |  7513 | `	pParent = pThis->pBase;` |
|     5004 |  7514 | `	while( pParent ){` |
|     5002 |  7515 | `		if( pParent == pClass ){` |
|        - |  7516 | `			/* Same instance */` |
|     2130 |  7517 | `			return TRUE;` |
|        - |  7518 | `		}` |
|        - |  7519 | `		/* Check the implemented interfaces */` |
|     2874 |  7520 | `		rc = VmQueryInterfaceSet(pClass,&pParent->aInterface);` |
|     2874 |  7521 | `		if( rc ){` |
|      ! 0 |  7522 | `			return TRUE;` |
|        - |  7523 | `		}` |
|        - |  7524 | `		/* Point to the parent class */` |
|     2874 |  7525 | `		pParent = pParent->pBase;` |
|        2 |  7526 | `	}` |
...
|        - |  7620 | ` */` |
|      902 |  7621 | `PH7_PRIVATE sxi32 PH7_VmCallClassMethod(` |
...
|      904 |  7635 | `	aStack = VmNewOperandStack(&(*pVm),2/* Method name + Aux data */+nArg);` |
|      904 |  7636 | `	if( aStack == 0 ){` |
...
|     1326 |  7642 | `	for( i = 0 ; i < nArg ; i++ ){` |
|      424 |  7643 | `		PH7_MemObjLoad(apArg[i],&aStack[i]);` |
|        - |  7644 | `		/*` |
|        - |  7645 | `		 * Symisc eXtension:` |
|        - |  7646 | `		 *  Parameters to [call_user_func()] can be passed by reference.` |
|        - |  7647 | `		 */` |
|      424 |  7648 | `		aStack[i].nIdx = apArg[i]->nIdx;` |
|      213 |  7649 | `	}` |
|      904 |  7650 | `	iCursor = nArg + 1;` |
|      904 |  7651 | `	if( pThis ){` |
|        - |  7652 | `		/*` |
|        - |  7653 | `		 * Push the class instance so that the '$this' variable will be available.` |
|        - |  7654 | `		 */` |
|      898 |  7655 | `		pThis->iRef++; /* Increment reference count */` |
|      898 |  7656 | `		aStack[i].x.pOther = pThis;` |
|      898 |  7657 | `		aStack[i].iFlags = MEMOBJ_OBJ;` |
|      448 |  7658 | `	}` |
|      904 |  7659 | `	aStack[i].nIdx = SXU32_HIGH; /* Mark as constant */` |
|      904 |  7660 | `	i++;` |
|        - |  7661 | `	/* Push method name */` |
|      904 |  7662 | `	SyBlobReset(&aStack[i].sBlob);` |
|      904 |  7663 | `	SyBlobAppend(&aStack[i].sBlob,(const void *)SyStringData(&pMethod->sVmName),SyStringLength(&pMethod->sVmName));` |
|      904 |  7664 | `	aStack[i].iFlags = MEMOBJ_STRING;` |
|      904 |  7665 | `	aStack[i].nIdx = SXU32_HIGH;` |
|        - |  7666 | `	/* Emit the CALL istruction */` |
|      904 |  7667 | `	aInstr[0].iOp = PH7_OP_CALL;` |
|      904 |  7668 | `	aInstr[0].iP1 = nArg; /* Total number of given arguments */` |
|      904 |  7669 | `	aInstr[0].iP2 = 0;` |
|      904 |  7670 | `	aInstr[0].p3  = 0;` |
|        - |  7671 | `	/* Emit the DONE instruction */` |
|      904 |  7672 | `	aInstr[1].iOp = PH7_OP_DONE;` |
|      904 |  7673 | `	aInstr[1].iP1 = 1;   /* Extract method return value */` |
|      904 |  7674 | `	aInstr[1].iP2 = 0;` |
|      904 |  7675 | `	aInstr[1].p3  = 0;` |
|        - |  7676 | `	/* Execute the method body (if available) */` |
|      904 |  7677 | `	VmByteCodeExec(&(*pVm),aInstr,aStack,iCursor,pResult,0,TRUE);` |
|        - |  7678 | `	/* Clean up the mess left behind */` |
|      904 |  7679 | `	SyMemBackendFree(&pVm->sAllocator,aStack);` |
|      904 |  7680 | `	return PH7_OK;` |
|      453 |  7681 |  |
|        - |  7682 | `/*` |
...
|        - |  7688 | ` */` |
|      774 |  7689 | `PH7_PRIVATE sxi32 PH7_VmCallUserFunction(` |
...
|        - |  7699 | `	int i;` |
|      776 |  7700 | `	if((pFunc->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP)) == 0 ){` |
|        - |  7701 | `		/* Don't bother processing,it's invalid anyway */` |
|      351 |  7702 | `		if( pResult ){` |
|        - |  7703 | `			/* Assume a null return value */` |
|      ! 0 |  7704 | `			PH7_MemObjRelease(pResult);` |
|      ! 0 |  7705 | `		}` |
|      351 |  7706 | `		return SXERR_INVALID;` |
|        - |  7707 | `	}` |
|      426 |  7708 | `	if( pFunc->iFlags & MEMOBJ_HASHMAP ){` |
|        - |  7709 | `		/* Class method */` |
...
|      416 |  7760 | `	aStack = VmNewOperandStack(&(*pVm),1+nArg);` |
|      416 |  7761 | `	if( aStack == 0 ){` |
...
|     1338 |  7771 | `	for( i = 0 ; i < nArg ; i++ ){` |
|      924 |  7772 | `		PH7_MemObjLoad(apArg[i],&aStack[i]);` |
|        - |  7773 | `		/*` |
|        - |  7774 | `		 * Symisc eXtension:` |
|        - |  7775 | `		 *  Parameters to [call_user_func()] can be passed by reference.` |
|        - |  7776 | `		 */` |
|      924 |  7777 | `		aStack[i].nIdx = apArg[i]->nIdx;` |
|      463 |  7778 | `	}` |
|        - |  7779 | `	/* Push the function name */` |
|      416 |  7780 | `	PH7_MemObjLoad(pFunc,&aStack[i]);` |
|      416 |  7781 | `	aStack[i].nIdx = SXU32_HIGH; /* Mark as constant */` |
|        - |  7782 | `	/* Emit the CALL istruction */` |
|      416 |  7783 | `	aInstr[0].iOp = PH7_OP_CALL;` |
|      416 |  7784 | `	aInstr[0].iP1 = nArg; /* Total number of given arguments */` |
|      416 |  7785 | `	aInstr[0].iP2 = 0;` |
|      416 |  7786 | `	aInstr[0].p3  = 0;` |
|        - |  7787 | `	/* Emit the DONE instruction */` |
|      416 |  7788 | `	aInstr[1].iOp = PH7_OP_DONE;` |
|      416 |  7789 | `	aInstr[1].iP1 = 1;   /* Extract function return value if available */` |
|      416 |  7790 | `	aInstr[1].iP2 = 0;` |
|      416 |  7791 | `	aInstr[1].p3  = 0;` |
|        - |  7792 | `	/* Execute the function body (if available) */` |
|      416 |  7793 | `	VmByteCodeExec(&(*pVm),aInstr,aStack,nArg,pResult,0,TRUE);` |
|        - |  7794 | `	/* Clean up the mess left behind */` |
|      416 |  7795 | `	SyMemBackendFree(&pVm->sAllocator,aStack);` |
|      416 |  7796 | `	return PH7_OK;` |
|      389 |  7797 |  |
|        - |  7798 | `/*` |
...
|        - |  8166 | ` */` |
|     3112 |  8167 | `static int vm_builtin_ob_end_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  8168 |  |
|     3114 |  8169 | `	ph7_vm *pVm = pCtx->pVm;` |
|        - |  8170 | `	VmObEntry *pOb;` |
|        - |  8171 | `	/* Pop the top most OB */` |
|     3114 |  8172 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|     3114 |  8173 | `	if( pOb == 0){` |
...
|      ! 0 |  8178 | `	}else{` |
|        - |  8179 | `		/* Release */` |
|     3114 |  8180 | `		VmObRestore(pVm,pOb);` |
|        - |  8181 | `		/* Return true */` |
|     3114 |  8182 | `		ph7_result_bool(pCtx,1);` |
|        - |  8183 | `	}` |
|     3114 |  8184 | `	return PH7_OK;` |
|        2 |  8185 |  |
|        - |  8186 | `/*` |
...
|        - |  8219 | ` */` |
|     4310 |  8220 | `static int vm_builtin_ob_get_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  8221 |  |
|     4312 |  8222 | `	ph7_vm *pVm = pCtx->pVm;` |
|        - |  8223 | `	VmObEntry *pOb;` |
|        - |  8224 | `	/* Pop the top most OB */` |
|     4312 |  8225 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|     4312 |  8226 | `	if( pOb == 0 ){` |
...
|     4312 |  8233 | `		ph7_result_string(pCtx,(const char *)SyBlobData(&pOb->sOB),(int)SyBlobLength(&pOb->sOB)); /* Will make it's own copy */` |
|        - |  8234 | `		/* Release */` |
|     4312 |  8235 | `		VmObRestore(pVm,pOb);` |
|        - |  8236 | `	}` |
|     4312 |  8237 | `	return PH7_OK;` |
|        2 |  8238 |  |
|        - |  8239 | `/*` |
...
|        - |  8288 | ` */` |
|     6644 |  8289 | `static int VmObConsumer(const void *pData,unsigned int nDataLen,void *pUserData)` |
|        2 |  8290 |  |
|     6646 |  8291 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|        - |  8292 | `	VmObEntry *pEntry;` |
|        - |  8293 | `	ph7_value sResult;` |
|        - |  8294 | `	/* Peek the top most entry */` |
|     6646 |  8295 | `	pEntry = (VmObEntry *)SySetPeek(&pVm->aOB);` |
|     6646 |  8296 | `	if( pEntry == 0 ){` |
|        - |  8297 | `		/* CAN'T HAPPEN */` |
|      ! 0 |  8298 | `		return PH7_OK;` |
|        - |  8299 | `	}` |
|     6646 |  8300 | `	PH7_MemObjInit(pVm,&sResult);` |
|     6646 |  8301 | `	if( ph7_value_is_callable(&pEntry->sCallback) && pVm->nObDepth < 15 ){` |
...
|      ! 0 |  8317 | `	}` |
|     6646 |  8318 | `	if( nDataLen > 0 ){` |
|        - |  8319 | `		/* Redirect the VM output to the internal buffer */` |
|     6646 |  8320 | `		SyBlobAppend(&pEntry->sOB,pData,nDataLen);` |
|     3322 |  8321 | `	}` |
|        - |  8322 | `	/* Release */` |
|     6646 |  8323 | `	PH7_MemObjRelease(&sResult);` |
|     6646 |  8324 | `	return PH7_OK;` |
|     3324 |  8325 |  |
|        - |  8326 | `/*` |
...
|        - |  8329 | ` * information.` |
|        - |  8330 | ` */` |
|     7424 |  8331 | `static void VmObRestore(ph7_vm *pVm,VmObEntry *pEntry)` |
|        2 |  8332 |  |
|     7426 |  8333 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|     7426 |  8334 | `	if( SySetUsed(&pVm->aOB) < 1 ){` |
|        - |  8335 | `		/* No more stackable OB */` |
|     7408 |  8336 | `		pCons->xConsumer = pCons->xDef;` |
|     7408 |  8337 | `		pCons->pUserData = pCons->pDefData;` |
|     3703 |  8338 | `	}` |
|        - |  8339 | `	/* Release OB data */` |
|     7426 |  8340 | `	PH7_MemObjRelease(&pEntry->sCallback);` |
|     7426 |  8341 | `	SyBlobRelease(&pEntry->sOB);` |
|     7426 |  8342 |  |
|        - |  8343 | `/*` |
...
|        - |  8365 | ` */` |
|     7424 |  8366 | `static int vm_builtin_ob_start(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  8367 |  |
|     7426 |  8368 | `	ph7_vm *pVm = pCtx->pVm;` |
|        - |  8369 | `	VmObEntry sOb;` |
|        - |  8370 | `	sxi32 rc;` |
|        - |  8371 | `	/* Initialize the OB entry */` |
|     7426 |  8372 | `	PH7_MemObjInit(pCtx->pVm,&sOb.sCallback);` |
|     7426 |  8373 | `	SyBlobInit(&sOb.sOB,&pVm->sAllocator);` |
|     7426 |  8374 | `	if( nArg > 0 && (apArg[0]->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP)) ){` |
|        - |  8375 | `		/* Save the callback name for later invocation */` |
|      ! 0 |  8376 | `		PH7_MemObjStore(apArg[0],&sOb.sCallback);` |
|      ! 0 |  8377 | `	}` |
|        - |  8378 | `	/* Push in the stack */` |
|     7426 |  8379 | `	rc = SySetPut(&pVm->aOB,(const void *)&sOb);` |
|     7426 |  8380 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  8381 | `		PH7_MemObjRelease(&sOb.sCallback);` |
|      ! 0 |  8382 | `	}else{` |
|     7426 |  8383 | `		ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|        - |  8384 | `		/* Substitute the default VM consumer */` |
|     7426 |  8385 | `		if( pCons->xConsumer != VmObConsumer ){` |
|     7408 |  8386 | `			pCons->xDef = pCons->xConsumer;` |
|     7408 |  8387 | `			pCons->pDefData = pCons->pUserData;` |
|        - |  8388 | `			/* Install the new consumer */` |
|     7408 |  8389 | `			pCons->xConsumer = VmObConsumer;` |
|     7408 |  8390 | `			pCons->pUserData = pVm;` |
|     3703 |  8391 | `		}` |
|        - |  8392 | `	}` |
|     7426 |  8393 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|     7426 |  8394 | `	return PH7_OK;` |
|        2 |  8395 |  |
|        - |  8396 | `/*` |
...
|        - |  8565 | ` */` |
|     1728 |  8566 | `PH7_PRIVATE sxu32 PH7_VmRandomNum(ph7_vm *pVm)` |
|        2 |  8567 |  |
|        - |  8568 | `	sxu32 iNum;` |
|     1730 |  8569 | `	SyRandomness(&pVm->sPrng,(void *)&iNum,sizeof(sxu32));` |
|     1730 |  8570 | `	return iNum;` |
|        2 |  8571 |  |
|        - |  8572 | `/*` |
...
|        - |  8577 | ` */` |
|    55280 |  8578 | `PH7_PRIVATE void PH7_VmRandomString(ph7_vm *pVm,char *zBuf,int nLen)` |
|        2 |  8579 |  |
|        - |  8580 | `	static const char zBase[] = {"abcdefghijklmnopqrstuvwxyz"}; /* English Alphabet */` |
|        - |  8581 | `	int i;` |
|        - |  8582 | `	/* Generate a binary string first */` |
|    55282 |  8583 | `	SyRandomness(&pVm->sPrng,zBuf,(sxu32)nLen);` |
|        - |  8584 | `	/* Turn the binary string into english based alphabet */` |
|   608250 |  8585 | `	for( i = 0 ; i < nLen ; ++i ){` |
|   552970 |  8586 | `		 zBuf[i] = zBase[zBuf[i] % (sizeof(zBase)-1)];` |
|   276486 |  8587 | `	 }` |
|    55282 |  8588 |  |
|        - |  8589 | `/*` |
|        - |  8590 | ` * int rand()` |
...
|        - |  8890 | ` */` |
|    64674 |  8891 | `static int vm_builtin_isset(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  8892 |  |
|        - |  8893 | `	ph7_value *pObj;` |
|    64676 |  8894 | `	int res = 0;` |
|        - |  8895 | `	int i;` |
|    64676 |  8896 | `	if( nArg < 1 ){` |
...
|    85820 |  8902 | `	for( i = 0 ; i < nArg ; ++i ){` |
|    64676 |  8903 | `		pObj = apArg[i];` |
|    64676 |  8904 | `		if( pObj->nIdx == SXU32_HIGH ){` |
|    43160 |  8905 | `			if( (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
|        - |  8906 | `				/* Not so fatal,Throw a warning */` |
|      ! 0 |  8907 | `				ph7_context_throw_error(pCtx,PH7_CTX_WARNING,"Expecting a variable not a constant");` |
|      ! 0 |  8908 | `			}` |
|    21579 |  8909 | `		}` |
|    64676 |  8910 | `		res = (pObj->iFlags & MEMOBJ_NULL) ? 0 : 1;` |
|    64676 |  8911 | `		if( !res ){` |
|        - |  8912 | `			/* Variable not set,return FALSE */` |
|    43532 |  8913 | `			ph7_result_bool(pCtx,0);` |
|    43532 |  8914 | `			return SXRET_OK;` |
|        - |  8915 | `		}` |
|    10574 |  8916 | `	}` |
|        - |  8917 | `	/* All given variable are set,return TRUE */` |
|    21146 |  8918 | `	ph7_result_bool(pCtx,1);` |
|    21146 |  8919 | `	return SXRET_OK;` |
|    32339 |  8920 |  |
|        - |  8921 | `/*` |
...
|        - |  8925 | ` */` |
|  2906160 |  8926 | `PH7_PRIVATE sxi32 PH7_VmUnsetMemObj(ph7_vm *pVm,sxu32 nObjIdx,int bForce)` |
|        2 |  8927 |  |
|        - |  8928 | `	ph7_value *pObj;` |
|        - |  8929 | `	VmRefObj *pRef;` |
|  2906162 |  8930 | `	pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nObjIdx);` |
|  2906162 |  8931 | `	if( pObj ){` |
|        - |  8932 | `		/* Release the object */` |
|  2906162 |  8933 | `		PH7_MemObjRelease(pObj);` |
|  1453080 |  8934 | `	}` |
|        - |  8935 | `	/* Remove old reference links */` |
|  2906162 |  8936 | `	pRef = VmRefObjExtract(&(*pVm),nObjIdx);` |
|  2906162 |  8937 | `	if( pRef ){` |
|  2906142 |  8938 | `		sxi32 iFlags = pRef->iFlags;` |
|        - |  8939 | `		/* Unlink from the reference table */` |
|  2906142 |  8940 | `		VmRefObjUnlink(&(*pVm),pRef);` |
|  2906142 |  8941 | `		if( (bForce == TRUE) \|\| (iFlags & VM_REF_IDX_KEEP) == 0 ){` |
|        - |  8942 | `			VmSlot sFree;` |
|        - |  8943 | `			/* Restore to the free list */` |
|  2906136 |  8944 | `			sFree.nIdx = nObjIdx;` |
|  2906136 |  8945 | `			sFree.pUserData = 0;` |
|  2906136 |  8946 | `			SySetPut(&pVm->aFreeObj,(const void *)&sFree);` |
|  1453067 |  8947 | `		}` |
|  1453070 |  8948 | `	}` |
|  2906162 |  8949 | `	return SXRET_OK;` |
|        2 |  8950 |  |
|        - |  8951 | `/*` |
|        - |  8952 | ` * void unset($var,...)` |
...
|        - |  9618 | ` */` |
|     8598 |  9619 | `static int vm_builtin_set_error_handler(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  9620 |  |
|     8600 |  9621 | `	ph7_vm *pVm = pCtx->pVm;` |
|        - |  9622 | `	ph7_value *pOld,*pNew;` |
|        - |  9623 | `	/* Point to the old and the new handler */` |
|     8600 |  9624 | `	pOld = &pVm->aErrCB[0];` |
|     8600 |  9625 | `	pNew = &pVm->aErrCB[1];` |
|        - |  9626 | `	/* Return the old handler */` |
|     8600 |  9627 | `	ph7_result_value(pCtx,pOld); /* Will make it's own copy */` |
|     8600 |  9628 | `	if( nArg > 0 ){` |
|     8600 |  9629 | `		if( !ph7_value_is_callable(apArg[0])) {` |
|        - |  9630 | `			/* Not callable,return TRUE (As requested by the PHP specification) */` |
|     4299 |  9631 | `			PH7_MemObjRelease(pNew);` |
|     4299 |  9632 | `			ph7_result_bool(pCtx,1);` |
|     2150 |  9633 | `		}else{` |
|     4302 |  9634 | `			PH7_MemObjStore(pNew,pOld);` |
|        - |  9635 | `			/* Install the new handler */` |
|     4302 |  9636 | `			PH7_MemObjStore(apArg[0],pNew);` |
|        - |  9637 | `		}` |
|     4299 |  9638 | `	}` |
|     8600 |  9639 | `	return PH7_OK;` |
|        2 |  9640 |  |
|        - |  9641 | `/*` |
...
|        - |  9663 | ` */` |
|      368 |  9664 | `static int vm_builtin_debug_backtrace(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  9665 |  |
|      370 |  9666 | `	ph7_vm *pVm = pCtx->pVm;` |
|        - |  9667 | `	ph7_value *pArray;` |
|        - |  9668 | `	ph7_class *pClass;` |
|        - |  9669 | `	ph7_value *pValue;` |
|        - |  9670 | `	SyString *pFile;` |
|        - |  9671 | `	/* Create a new array */` |
|      370 |  9672 | `	pArray = ph7_context_new_array(pCtx);` |
|      370 |  9673 | `	pValue = ph7_context_new_scalar(pCtx);` |
|      370 |  9674 | `	if( pArray == 0 \|\| pValue == 0 ){` |
...
|      370 |  9683 | `	if( pVm->pFrame->pParent ){` |
|      370 |  9684 | `		VmFrame *pFrame = pVm->pFrame;` |
|        - |  9685 | `		ph7_vm_func *pFunc;` |
|        - |  9686 | `		ph7_value *pArg;` |
|      370 |  9687 | `		while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|        - |  9688 | `			/* Safely ignore the exception frame */` |
|      ! 0 |  9689 | `			pFrame = pFrame->pParent;` |
|      ! 0 |  9690 | `		}` |
|      370 |  9691 | `		pFunc = (ph7_vm_func *)pFrame->pUserData;` |
|      370 |  9692 | `		if( pFrame->pParent && pFunc ){` |
|      370 |  9693 | `			ph7_value_string(pValue,pFunc->sName.zString,(int)pFunc->sName.nByte);` |
|      370 |  9694 | `			ph7_array_add_strkey_elem(pArray,"function",pValue);` |
|      370 |  9695 | `			ph7_value_reset_string_cursor(pValue);` |
|      184 |  9696 | `		}` |
|        - |  9697 | `		/* Function arguments */` |
|      370 |  9698 | `		pArg = ph7_context_new_array(pCtx);` |
|      370 |  9699 | `		if( pArg  ){` |
|        - |  9700 | `			ph7_value *pObj;` |
|        - |  9701 | `			VmSlot *aSlot;` |
|        - |  9702 | `			sxu32 n;` |
|        - |  9703 | `			/* Start filling the array with the given arguments */` |
|      370 |  9704 | `			aSlot = (VmSlot *)SySetBasePtr(&pFrame->sArg);` |
|     1466 |  9705 | `			for( n = 0;  n < SySetUsed(&pFrame->sArg) ; n++ ){` |
|     1098 |  9706 | `				pObj = (ph7_value *)SySetAt(&pCtx->pVm->aMemObj,aSlot[n].nIdx);` |
|     1098 |  9707 | `				if( pObj ){` |
|     1098 |  9708 | `					ph7_array_add_elem(pArg,0/* Automatic index assign*/,pObj);` |
|      548 |  9709 | `				}` |
|      550 |  9710 | `			}` |
|        - |  9711 | `			/* Save the array */` |
|      370 |  9712 | `			ph7_array_add_strkey_elem(pArray,"args",pArg);` |
|      184 |  9713 | `		}` |
|      184 |  9714 | `	}` |
|      370 |  9715 | `	ph7_value_int(pValue,1);` |
|        - |  9716 | `	/* Append the current line (which is always 1 since PH7 does not track` |
|        - |  9717 | `	 * line numbers at run-time. )` |
|        - |  9718 | `	 */` |
|      370 |  9719 | `	ph7_array_add_strkey_elem(pArray,"line",pValue);` |
|        - |  9720 | `	/* Current processed script */` |
|      370 |  9721 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|      370 |  9722 | `	if( pFile ){` |
|      370 |  9723 | `		ph7_value_string(pValue,pFile->zString,(int)pFile->nByte);` |
|      370 |  9724 | `		ph7_array_add_strkey_elem(pArray,"file",pValue);` |
|      370 |  9725 | `		ph7_value_reset_string_cursor(pValue);` |
|      184 |  9726 | `	}` |
|        - |  9727 | `	/* Top class */` |
|      370 |  9728 | `	pClass = PH7_VmPeekTopClass(pVm);` |
|      370 |  9729 | `	if( pClass ){` |
|      366 |  9730 | `		ph7_value_reset_string_cursor(pValue);` |
|      366 |  9731 | `		ph7_value_string(pValue,pClass->sName.zString,(int)pClass->sName.nByte);` |
|      366 |  9732 | `		ph7_array_add_strkey_elem(pArray,"class",pValue);` |
|      182 |  9733 | `	}` |
|        - |  9734 | `	/* Return the freshly created array */` |
|      370 |  9735 | `	ph7_result_value(pCtx,pArray);` |
|        - |  9736 | `	/*` |
|        - |  9737 | `	 * Don't worry about freeing memory, everything will be released automatically` |
|        - |  9738 | `	 * as soon we return from this function.` |
|        - |  9739 | `	 */` |
|      370 |  9740 | `	return PH7_OK;` |
|      186 |  9741 |  |
|        - |  9742 | `/*` |
...
|        - |  9839 | ` */` |
|      352 |  9840 | `static sxi32 VmUncaughtException(` |
...
|      353 |  9846 | `	int nArg = 1;` |
|        - |  9847 | `	sxi32 rc;` |
|      353 |  9848 | `	if( pVm->nExceptDepth > 15 ){` |
|        - |  9849 | `		/* Nesting limit reached */` |
|      ! 0 |  9850 | `		return SXRET_OK;` |
|        - |  9851 | `	}` |
|        - |  9852 | `	/* Call any exception handler if available */` |
|      353 |  9853 | `	PH7_MemObjInit(pVm,&sArg);` |
|      353 |  9854 | `	if( pThis ){` |
|        - |  9855 | `		/* Load the exception instance */` |
|      353 |  9856 | `		sArg.x.pOther = pThis;` |
|      353 |  9857 | `		pThis->iRef++;` |
|      353 |  9858 | `		MemObjSetType(&sArg,MEMOBJ_OBJ);` |
|      177 |  9859 | `	}else{` |
|      ! 0 |  9860 | `		nArg = 0;` |
|        - |  9861 | `	}` |
|      353 |  9862 | `	apArg[0] = &sArg;` |
|        - |  9863 | `	/* Call the exception handler if available */` |
|      353 |  9864 | `	pVm->nExceptDepth++;` |
|      353 |  9865 | `	rc = PH7_VmCallUserFunction(&(*pVm),&pVm->aExceptionCB[1],nArg,apArg,0);` |
|      353 |  9866 | `	pVm->nExceptDepth--;` |
|      353 |  9867 | `	if( rc != SXRET_OK ){` |
|        - |  9868 | `		SyBlob sMsgBuf;` |
|      351 |  9869 | `		const char *zClass = "Exception";` |
|      351 |  9870 | `		sxu32 nClass = (sxu32)sizeof("Exception") - 1;` |
|        - |  9871 | `		const char *zMsg;` |
|        - |  9872 | `		sxu32 nMsg;` |
|        - |  9873 | `		const char *zFuncName;` |
|        - |  9874 | `		int nFuncLen;` |
|      351 |  9875 | `		SyBlobInit(&sMsgBuf,&pVm->sAllocator);` |
|      351 |  9876 | `		if( pThis ){` |
|        - |  9877 | `			ph7_class_method *pGetMessage;` |
|        - |  9878 | `			ph7_value sMsg;` |
|        - |  9879 | `			const char *zTmp;` |
|        - |  9880 | `			int nTmp;` |
|      351 |  9881 | `			zClass = pThis->pClass->sName.zString;` |
|      351 |  9882 | `			nClass = pThis->pClass->sName.nByte;` |
|      351 |  9883 | `			pGetMessage = PH7_ClassExtractMethod(pThis->pClass,"getMessage",sizeof("getMessage")-1);` |
|      351 |  9884 | `			if( pGetMessage ){` |
|      351 |  9885 | `				PH7_MemObjInit(pVm,&sMsg);` |
|      351 |  9886 | `				if( PH7_VmCallClassMethod(&(*pVm),pThis,pGetMessage,&sMsg,0,0) == SXRET_OK ){` |
|      351 |  9887 | `					zTmp = ph7_value_to_string(&sMsg,&nTmp);` |
|      351 |  9888 | `					if( zTmp && nTmp > 0 ){` |
|      351 |  9889 | `						SyBlobAppend(&sMsgBuf,zTmp,(sxu32)nTmp);` |
|      175 |  9890 | `					}` |
|      175 |  9891 | `				}` |
|      351 |  9892 | `				PH7_MemObjRelease(&sMsg);` |
|      175 |  9893 | `			}` |
|      175 |  9894 | `		}` |
|      351 |  9895 | `		if( SyBlobLength(&sMsgBuf) == 0 ){` |
|      ! 0 |  9896 | `			SyBlobAppend(&sMsgBuf,"Unknown exception",sizeof("Unknown exception")-1);` |
|      ! 0 |  9897 | `		}` |
|      351 |  9898 | `		zMsg = (const char *)SyBlobData(&sMsgBuf);` |
|      351 |  9899 | `		nMsg = (sxu32)SyBlobLength(&sMsgBuf);` |
|      351 |  9900 | `		VmGetFrameContext(pVm,&zFuncName,&nFuncLen);` |
|      351 |  9901 | `		VmReportUncaughtException(pVm,zClass,nClass,zMsg,nMsg,zFuncName,nFuncLen);` |
|      351 |  9902 | `		SyBlobRelease(&sMsgBuf);` |
|        - |  9903 | `		/* Tell the upper layer to stop VM execution immediately  */` |
|      351 |  9904 | `		rc = SXERR_ABORT;` |
|      175 |  9905 | `	}` |
|      353 |  9906 | `	PH7_MemObjRelease(&sArg);` |
|      353 |  9907 | `	return rc;` |
|      177 |  9908 |  |
|        - |  9909 | `/*` |
|        - |  9910 | ` * Throw an user exception.` |
|        - |  9911 | ` */` |
|      366 |  9912 | `static sxi32 VmThrowException(` |
...
|      368 |  9921 | `	apException = (ph7_exception **)SySetBasePtr(&pVm->aException);` |
|      368 |  9922 | `	pException = 0;` |
|      368 |  9923 | `	pCatch = 0;` |
|      368 |  9924 | `	if( SySetUsed(&pVm->aException) > 0 ){` |
...
|      368 |  9948 | `	if( pCatch == 0 ){` |
|        - |  9949 | `		sxi32 rc;` |
|      353 |  9950 | `		rc = VmUncaughtException(&(*pVm),pThis);` |
|      353 |  9951 | `		if( rc == SXRET_OK && pException ){` |
...
|        - | 10783 | ` * information.` |
|        - | 10784 | ` */` |
|     9316 | 10785 | `static sxi32 VmEvalChunk(` |
...
|     9318 | 10794 | `	ProcConsumer xErr = 0;` |
|     9318 | 10795 | `	void *pErrData = 0;` |
|        - | 10796 | `	/* Initialize bytecode container */` |
|     9318 | 10797 | `	SySetInit(&aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|     9318 | 10798 | `	SySetAlloc(&aByteCode,0x20);` |
|        - | 10799 | `	/* Reset the code generator */` |
|     9318 | 10800 | `	if( bTrueReturn ){` |
|        - | 10801 | `		/* Included file,log compile-time errors */` |
|     7405 | 10802 | `		xErr = pVm->pEngine->xConf.xErr;` |
|     7405 | 10803 | `		pErrData = pVm->pEngine->xConf.pErrData;` |
|     3702 | 10804 | `	}` |
|     9318 | 10805 | `	PH7_ResetCodeGenerator(pVm,xErr,pErrData);` |
|        - | 10806 | `	/* Swap bytecode container */` |
|     9318 | 10807 | `	pByteCode = pVm->pByteContainer;` |
|     9318 | 10808 | `	pVm->pByteContainer = &aByteCode;` |
|        - | 10809 | `	/* Compile the chunk */` |
|     9318 | 10810 | `	PH7_CompileScript(pVm,pChunk,iFlags);` |
|    13976 | 10811 | `	if( pVm->sCodeGen.nErr > 0 ){` |
...
|        - | 10821 | `		sxi32 rc;` |
|     9316 | 10822 | `		SyHashResetLoopCursor(&pVm->hClass);` |
|   255305 | 10823 | `		while((pEntry = SyHashGetNextEntry(&pVm->hClass)) != 0 ){` |
|   241334 | 10824 | `			pClass = (ph7_class *)pEntry->pUserData;` |
|        - | 10825 | `			/* Only mount classes that haven't been mounted yet */` |
|   241334 | 10826 | `			if( !pClass->bMounted ){` |
|    52468 | 10827 | `				rc = VmMountUserClass(pVm,pClass);` |
|    52468 | 10828 | `				if( rc != SXRET_OK ){` |
...
|    26233 | 10835 | `			}` |
|        2 | 10836 | `		}` |
|     9316 | 10837 | `		if( SXRET_OK != PH7_VmEmitInstr(pVm,PH7_OP_DONE,0,0,0,0) ){` |
|        - | 10838 | `			/* Out of memory */` |
|      ! 0 | 10839 | `			if( pCtx ){` |
...
|        - | 10843 | `		}` |
|     9316 | 10844 | `		if( bTrueReturn ){` |
|        - | 10845 | `			/* Assume a boolean true return value */` |
|     7405 | 10846 | `			PH7_MemObjInitFromBool(pVm,&sResult,1);` |
|     3703 | 10847 | `		}else{` |
|        - | 10848 | `			/* Assume a null return value */` |
|     1912 | 10849 | `			PH7_MemObjInit(pVm,&sResult);` |
|        - | 10850 | `		}` |
|        - | 10851 | `		/* Execute the compiled chunk */` |
|     9316 | 10852 | `		VmLocalExec(pVm,&aByteCode,&sResult);` |
|     9316 | 10853 | `		if( pCtx ){` |
|        - | 10854 | `			/* Set the execution result */` |
|     7422 | 10855 | `			ph7_result_value(pCtx,&sResult);` |
|     3710 | 10856 | `		}` |
|     9316 | 10857 | `		PH7_MemObjRelease(&sResult);` |
|        - | 10858 | `	}` |
|     4658 | 10859 | `Cleanup:` |
|        - | 10860 | `	/* Cleanup the mess left behind */` |
|     9318 | 10861 | `	pVm->pByteContainer = pByteCode;` |
|     9318 | 10862 | `	SySetRelease(&aByteCode);` |
|     9318 | 10863 | `	return SXRET_OK;` |
|        2 | 10864 |  |
|        - | 10865 | `/*` |
...
|        - | 10896 | ` */` |
|    14804 | 10897 | `static int VmIsIncludedFile(ph7_vm *pVm,SyString *pFile)` |
|        1 | 10898 |  |
|        - | 10899 | `	SyString *aEntries;` |
|        - | 10900 | `	sxu32 n;` |
|    14805 | 10901 | `	aEntries = (SyString *)SySetBasePtr(&pVm->aIncluded);` |
|        - | 10902 | `	/* Perform a linear search */` |
| 54779189 | 10903 | `	for( n = 0 ; n < SySetUsed(&pVm->aIncluded) ; ++n ){` |
| 54764391 | 10904 | `		if( SyStringCmp(pFile,&aEntries[n],SyMemcmp) == 0 ){` |
|        - | 10905 | `			/* Already included */` |
|        7 | 10906 | `			return TRUE;` |
|        - | 10907 | `		}` |
| 27382193 | 10908 | `	}` |
|    14799 | 10909 | `	return FALSE;` |
|     7403 | 10910 |  |
|        - | 10911 | `/*` |
|        - | 10912 | ` * Push a file path in the appropriate VM container.` |
|        - | 10913 | ` */` |
|    16690 | 10914 | `PH7_PRIVATE sxi32 PH7_VmPushFilePath(ph7_vm *pVm,const char *zPath,int nLen,sxu8 bMain,sxi32 *pNew)` |
|        2 | 10915 |  |
...
|        - | 10920 | `#endif` |
|        - | 10921 | `	sxi32 rc;` |
|    16692 | 10922 | `	if( nLen < 0 ){` |
|     1888 | 10923 | `		nLen = SyStrlen(zPath);` |
|      943 | 10924 | `	}` |
|        - | 10925 | `	/* Duplicate the file path first */` |
|    16692 | 10926 | `	zDup = SyMemBackendStrDup(&pVm->sAllocator,zPath,nLen);` |
|    16692 | 10927 | `	if( zDup == 0 ){` |
...
|    16692 | 10949 | `	SyStringInitFromBuf(&sPath,zDup,nLen);` |
|    16692 | 10950 | `	if( !bMain ){` |
|    14805 | 10951 | `		if( VmIsIncludedFile(&(*pVm),&sPath) ){` |
|        - | 10952 | `			/* Already included */` |
|        7 | 10953 | `			*pNew = 0;` |
|        4 | 10954 | `		}else{` |
|        - | 10955 | `			/* Insert in the corresponding container */` |
|    14799 | 10956 | `			rc = SySetPut(&pVm->aIncluded,(const void *)&sPath);` |
|    14799 | 10957 | `			if( rc != SXRET_OK ){` |
...
|        - | 10962 | `		}` |
|     7402 | 10963 | `	}` |
|    16692 | 10964 | `	SySetPut(&pVm->aFiles,(const void *)&sPath);` |
|    16692 | 10965 | `	return SXRET_OK;` |
|     8347 | 10966 |  |
|        - | 10967 | `/*` |
...
|        - | 10978 | ` */` |
|     7410 | 10979 | `static sxi32 VmExecIncludedFile(` |
...
|     7412 | 10993 | `	pVm = pCtx->pVm;` |
|     7412 | 10994 | `	SyBlobInit(&sContents,&pVm->sAllocator);` |
|     7412 | 10995 | `	isNew = 0;` |
|        - | 10996 | `	/* Extract the associated stream */` |
|     7412 | 10997 | `	pStream = PH7_VmGetStreamDevice(pVm,&pPath->zString,pPath->nByte);` |
|        - | 10998 | `	/*` |
|        - | 10999 | `	 * Open the file or the URL [i.e: http://ph7.symisc.net/example/hello.php"]` |
|        - | 11000 | `	 * in a read-only mode.` |
|        - | 11001 | `	 */` |
|     7412 | 11002 | `	pHandle = PH7_StreamOpenHandle(pVm,pStream,pPath->zString,PH7_IO_OPEN_RDONLY,TRUE,0,TRUE,&isNew);` |
|     7412 | 11003 | `	if( pHandle == 0 ){` |
|        3 | 11004 | `		return SXERR_IO;` |
|        - | 11005 | `	}` |
|     7409 | 11006 | `	rc = SXRET_OK; /* Stupid cc warning */` |
|     7409 | 11007 | `	if( IncludeOnce && !isNew ){` |
|        - | 11008 | `		/* Already included */` |
|        5 | 11009 | `		rc = SXERR_EXISTS;` |
|        3 | 11010 | `	}else{` |
|        - | 11011 | `		/* Read the whole file contents */` |
|     7405 | 11012 | `		rc = PH7_StreamReadWholeFile(pHandle,pStream,&sContents);` |
|     7405 | 11013 | `		if( rc == SXRET_OK ){` |
|        - | 11014 | `			SyString sScript;` |
|        - | 11015 | `			/* Compile and execute the script */` |
|     7405 | 11016 | `			SyStringInitFromBuf(&sScript,SyBlobData(&sContents),SyBlobLength(&sContents));` |
|     7405 | 11017 | `			VmEvalChunk(pCtx->pVm,&(*pCtx),&sScript,0,TRUE);` |
|     3702 | 11018 | `		}` |
|        - | 11019 | `	}` |
|        - | 11020 | `	/* Pop from the set of included file */` |
|     7409 | 11021 | `	(void)SySetPop(&pVm->aFiles);` |
|        - | 11022 | `	/* Close the handle */` |
|     7409 | 11023 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|        - | 11024 | `	/* Release the working buffer */` |
|     7409 | 11025 | `	SyBlobRelease(&sContents);` |
|        - | 11026 | `#else` |
...
|     3601 | 11099 | `	while( SXRET_OK == SySetGetNextEntry(pFiles,(void **)&pEntry) ){` |
|        - | 11100 | `		const char *zBase,*zEnd;` |
|        - | 11101 | `		int iLen;` |
|        - | 11102 | `		/* reset the string cursor */` |
|     3599 | 11103 | `		ph7_value_reset_string_cursor(pWorker);` |
|        - | 11104 | `		/* Extract base name */` |
|     3599 | 11105 | `		zEnd = &pEntry->zString[pEntry->nByte - 1];` |
|        - | 11106 | `		/* Ignore trailing '/' */` |
|     5398 | 11107 | `		while( zEnd > pEntry->zString && ( (int)zEnd[0] == c \|\| (int)zEnd[0] == d ) ){` |
|      ! 0 | 11108 | `			zEnd--;` |
|      ! 0 | 11109 | `		}` |
|     3599 | 11110 | `		iLen = (int)(&zEnd[1]-pEntry->zString);` |
|   110520 | 11111 | `		while( zEnd > pEntry->zString && ( (int)zEnd[0] != c && (int)zEnd[0] != d ) ){` |
|   105123 | 11112 | `			zEnd--;` |
|        1 | 11113 | `		}` |
|     3599 | 11114 | `		zBase = (zEnd > pEntry->zString) ? &zEnd[1] : pEntry->zString;` |
|     3599 | 11115 | `		zEnd = &pEntry->zString[iLen];` |
|        - | 11116 | `		/* Copy entry name */` |
|     3599 | 11117 | `		ph7_value_string(pWorker,zBase,(int)(zEnd-zBase));` |
|        - | 11118 | `		/* Perform the insertion */` |
|     3599 | 11119 | `		ph7_array_add_elem(pArray,0/* Automatic index assign*/,pWorker); /* Will make it's own copy */` |
|        1 | 11120 | `	}` |
...
|        - | 11148 | ` */` |
|     7398 | 11149 | `static int vm_builtin_include(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 | 11150 |  |
|        - | 11151 | `	SyString sFile;` |
|        - | 11152 | `	sxi32 rc;` |
|     7400 | 11153 | `	if( nArg < 1 ){` |
|        - | 11154 | `		/* Nothing to evaluate,return NULL */` |
|      ! 0 | 11155 | `		ph7_result_null(pCtx);` |
|      ! 0 | 11156 | `		return SXRET_OK;` |
|        - | 11157 | `	}` |
|        - | 11158 | `	/* File to include */` |
|     7400 | 11159 | `	sFile.zString = ph7_value_to_string(apArg[0],(int *)&sFile.nByte);` |
|     7400 | 11160 | `	if( sFile.nByte < 1 ){` |
...
|     7400 | 11166 | `	rc = VmExecIncludedFile(&(*pCtx),&sFile,FALSE);` |
|     7400 | 11167 | `	if( rc != SXRET_OK ){` |
...
|        - | 14058 | ` */` |
|     1656 | 14059 | `static sxi32 VmRegisterSpecialFunction(ph7_vm *pVm)` |
|        2 | 14060 |  |
|        - | 14061 | `	sxi32 rc;` |
|        - | 14062 | `	sxu32 n;` |
|   207002 | 14063 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVmFunc) ; ++n ){` |
|        - | 14064 | `		/* Note that these special functions have access` |
|        - | 14065 | `		 * to the underlying virtual machine as their` |
|        - | 14066 | `		 * private data.` |
|        - | 14067 | `		 */` |
|   205346 | 14068 | `		rc = ph7_create_function(&(*pVm),aVmFunc[n].zName,aVmFunc[n].xFunc,&(*pVm));` |
|   205346 | 14069 | `		if( rc != SXRET_OK ){` |
|      ! 0 | 14070 | `			return rc;` |
|        - | 14071 | `		}` |
|   102674 | 14072 | `	}` |
|     1658 | 14073 | `	return SXRET_OK;` |
|      830 | 14074 |  |
|        - | 14075 | `/*` |
|        - | 14076 | ` * Check if the given name refer to an installed class.` |
|        - | 14077 | ` * Return a pointer to that class on success. NULL on failure.` |
|        - | 14078 | ` */` |
|    10516 | 14079 | `PH7_PRIVATE ph7_class * PH7_VmExtractClass(` |
...
|     5258 | 14091 | `		SXUNUSED(iNest);` |
|        - | 14092 | `	/* Perform a hash lookup */` |
|    10518 | 14093 | `	pEntry = SyHashGet(&pVm->hClass,(const void *)zName,nByte);` |
|        - | 14094 |  |
|    10518 | 14095 | `	if( pEntry == 0 ){` |
|        - | 14096 | `		/* No such entry,return NULL */` |
|      ! 0 | 14097 | `		return 0;` |
|        - | 14098 | `	}` |
|    10518 | 14099 | `	pClass = (ph7_class *)pEntry->pUserData;` |
|    10518 | 14100 | `	if( !iLoadable ){` |
|        - | 14101 | `		/* Return the first class seen */` |
|     9634 | 14102 | `		return pClass;` |
|      ! 0 | 14103 | `	}else{` |
|        - | 14104 | `		/* Check the collision list */` |
|      886 | 14105 | `		while(pClass){` |
|      886 | 14106 | `			if( (pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_ABSTRACT)) == 0 ){` |
|        - | 14107 | `				/* Class is loadable */` |
|      886 | 14108 | `				return pClass;` |
|        - | 14109 | `			}` |
...
|        - | 14130 | ` */` |
|  2930570 | 14131 | `static VmRefObj * VmNewRefObj(ph7_vm *pVm,sxu32 nIdx)` |
|        2 | 14132 |  |
|        - | 14133 | `	VmRefObj *pRef;` |
|        - | 14134 | `	/* Allocate a new instance */` |
|  2930572 | 14135 | `	pRef = (VmRefObj *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmRefObj));` |
|  2930572 | 14136 | `	if( pRef == 0 ){` |
|      ! 0 | 14137 | `		return 0;` |
|        - | 14138 | `	}` |
|        - | 14139 | `	/* Zero the structure */` |
|  2930572 | 14140 | `	SyZero(pRef,sizeof(VmRefObj));` |
|        - | 14141 | `	/* Initialize fields */` |
|  2930572 | 14142 | `	SySetInit(&pRef->aReference,&pVm->sAllocator,sizeof(SyHashEntry *));` |
|  2930572 | 14143 | `	SySetInit(&pRef->aArrEntries,&pVm->sAllocator,sizeof(ph7_hashmap_node *));` |
|  2930572 | 14144 | `	pRef->nIdx = nIdx;` |
|  2930572 | 14145 | `	return pRef;` |
|  1465287 | 14146 |  |
|        - | 14147 | `/*` |
|        - | 14148 | ` * Default hash function used by the reference table` |
|        - | 14149 | ` * for lookup/insertion operations.` |
|        - | 14150 | ` */` |
| 16333631 | 14151 | `static sxu32 VmRefHash(sxu32 nIdx)` |
|        2 | 14152 |  |
|        - | 14153 | `	/* Calculate the hash based on the memory object index */` |
| 16333633 | 14154 | `	return nIdx ^ (nIdx << 8) ^ (nIdx >> 8);` |
|        2 | 14155 |  |
|        - | 14156 | `/*` |
...
|        - | 14166 | ` * extension.` |
|        - | 14167 | ` */` |
|  8757136 | 14168 | `static VmRefObj * VmRefObjExtract(ph7_vm *pVm,sxu32 nObjIdx)` |
|        2 | 14169 |  |
|        - | 14170 | `	VmRefObj *pRef;` |
|        - | 14171 | `	sxu32 nBucket;` |
|        - | 14172 | `	/* Point to the appropriate bucket */` |
|  8757138 | 14173 | `	nBucket = VmRefHash(nObjIdx) & (pVm->nRefSize - 1);` |
|        - | 14174 | `	/* Perform the lookup */` |
|  8757138 | 14175 | `	pRef = pVm->apRefObj[nBucket];` |
| 18460048 | 14176 | `	for(;;){` |
| 36914578 | 14177 | `		if( pRef == 0 ){` |
|  2996898 | 14178 | `			break;` |
|        - | 14179 | `		}` |
| 33917682 | 14180 | `		if( pRef->nIdx == nObjIdx ){` |
|        - | 14181 | `			/* Entry found */` |
|  5760242 | 14182 | `			return pRef;` |
|        - | 14183 | `		}` |
|        - | 14184 | `		/* Point to the next entry */` |
| 28157442 | 14185 | `		pRef = pRef->pNextCollide;` |
|        2 | 14186 | `	}` |
|        - | 14187 | `	/* No such entry,return NULL */` |
|  2996898 | 14188 | `	return 0;` |
|  4378570 | 14189 |  |
|        - | 14190 | `/*` |
...
|        - | 14198 | ` * extension.` |
|        - | 14199 | ` */` |
|  2930570 | 14200 | `static sxi32 VmRefObjInsert(ph7_vm *pVm,VmRefObj *pRef)` |
|        2 | 14201 |  |
|        - | 14202 | `	sxu32 nBucket;` |
|  2930572 | 14203 | `	if( pVm->nRefUsed * 3 >= pVm->nRefSize ){` |
|        - | 14204 | `		VmRefObj **apNew;` |
|        - | 14205 | `		sxu32 nNew;` |
|        - | 14206 | `		/* Allocate a larger table */` |
|     2540 | 14207 | `		nNew = pVm->nRefSize << 1;` |
|     2540 | 14208 | `		apNew = (VmRefObj **)SyMemBackendAlloc(&pVm->sAllocator,sizeof(VmRefObj *) * nNew);` |
|     2540 | 14209 | `		if( apNew ){` |
|     2540 | 14210 | `			VmRefObj *pEntry = pVm->pRefList;` |
|        - | 14211 | `			sxu32 n;` |
|        - | 14212 | `			/* Zero the structure */` |
|     2540 | 14213 | `			SyZero((void *)apNew,nNew * sizeof(VmRefObj *));` |
|        - | 14214 | `			/* Rehash all referenced entries */` |
|  2824952 | 14215 | `			for( n = 0 ; n < pVm->nRefUsed ; ++n ){` |
|        - | 14216 | `				/* Remove old collision links */` |
|  2822414 | 14217 | `				pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|        - | 14218 | `				/* Point to the appropriate bucket */` |
|  2822414 | 14219 | `				nBucket = VmRefHash(pEntry->nIdx) & (nNew - 1);` |
|        - | 14220 | `				/* Insert the entry  */` |
|  2822414 | 14221 | `				pEntry->pNextCollide = apNew[nBucket];` |
|  2822414 | 14222 | `				if( apNew[nBucket] ){` |
|  2298896 | 14223 | `					apNew[nBucket]->pPrevCollide = pEntry;` |
|  1149447 | 14224 | `				}` |
|  2822414 | 14225 | `				apNew[nBucket] = pEntry;` |
|        - | 14226 | `				/* Point to the next entry */` |
|  2822414 | 14227 | `				pEntry = pEntry->pNext;` |
|  1411208 | 14228 | `			}` |
|        - | 14229 | `			/* Release the old table */` |
|     2540 | 14230 | `			SyMemBackendFree(&pVm->sAllocator,pVm->apRefObj);` |
|        - | 14231 | `			/* Install the new one */` |
|     2540 | 14232 | `			pVm->apRefObj = apNew;` |
|     2540 | 14233 | `			pVm->nRefSize = nNew;` |
|     1269 | 14234 | `		}` |
|     1269 | 14235 | `	}` |
|        - | 14236 | `	/* Point to the appropriate bucket */` |
|  2930572 | 14237 | `	nBucket = VmRefHash(pRef->nIdx) & (pVm->nRefSize - 1);` |
|        - | 14238 | `	/* Insert the entry */` |
|  2930572 | 14239 | `	pRef->pNextCollide = pVm->apRefObj[nBucket];` |
|  2930572 | 14240 | `	if( pVm->apRefObj[nBucket] ){` |
|  2428530 | 14241 | `		pVm->apRefObj[nBucket]->pPrevCollide = pRef;` |
|  1213520 | 14242 | `	}` |
|  2930572 | 14243 | `	pVm->apRefObj[nBucket] = pRef;` |
|  2930572 | 14244 | `	MACRO_LD_PUSH(pVm->pRefList,pRef);` |
|  2930572 | 14245 | `	pVm->nRefUsed++;` |
|  2930572 | 14246 | `	return SXRET_OK;` |
|        2 | 14247 |  |
|        - | 14248 | `/*` |
...
|        - | 14258 | ` * extension.` |
|        - | 14259 | ` */` |
|  2906140 | 14260 | `static sxi32 VmRefObjUnlink(ph7_vm *pVm,VmRefObj *pRef)` |
|        2 | 14261 |  |
|        - | 14262 | `	ph7_hashmap_node **apNode;` |
|        - | 14263 | `	SyHashEntry **apEntry;` |
|        - | 14264 | `	sxu32 n;` |
|        - | 14265 | `	/* Point to the reference table */` |
|  2906142 | 14266 | `	apNode = (ph7_hashmap_node **)SySetBasePtr(&pRef->aArrEntries);` |
|  2906142 | 14267 | `	apEntry = (SyHashEntry **)SySetBasePtr(&pRef->aReference);` |
|        - | 14268 | `	/* Unlink the entry from the reference table */` |
|  2977392 | 14269 | `	for( n = 0 ; n < SySetUsed(&pRef->aReference) ; n++ ){` |
|    71252 | 14270 | `		if( apEntry[n] ){` |
|    71202 | 14271 | `			SyHashDeleteEntry2(apEntry[n]);` |
|    35600 | 14272 | `		}` |
|    35627 | 14273 | `	}` |
|  5743638 | 14274 | `	for(n = 0 ; n < SySetUsed(&pRef->aArrEntries) ; ++n ){` |
|  2837498 | 14275 | `		if( apNode[n] ){` |
|     5597 | 14276 | `			PH7_HashmapUnlinkNode(apNode[n],FALSE);` |
|     2798 | 14277 | `		}` |
|  1418750 | 14278 | `	}` |
|  2906142 | 14279 | `	if( pRef->pPrevCollide ){` |
|  1082629 | 14280 | `		pRef->pPrevCollide->pNextCollide = pRef->pNextCollide;` |
|   541746 | 14281 | `	}else{` |
|  1823515 | 14282 | `		pVm->apRefObj[VmRefHash(pRef->nIdx) & (pVm->nRefSize - 1)] = pRef->pNextCollide;` |
|        - | 14283 | `	}` |
|  2906142 | 14284 | `	if( pRef->pNextCollide ){` |
|  1623010 | 14285 | `		pRef->pNextCollide->pPrevCollide = pRef->pPrevCollide;` |
|   810507 | 14286 | `	}` |
|  2906142 | 14287 | `	MACRO_LD_REMOVE(pVm->pRefList,pRef);` |
|        - | 14288 | `	/* Release the node */` |
|  2906142 | 14289 | `	SySetRelease(&pRef->aReference);` |
|  2906142 | 14290 | `	SySetRelease(&pRef->aArrEntries);` |
|  2906142 | 14291 | `	SyMemBackendPoolFree(&pVm->sAllocator,pRef);` |
|  2906142 | 14292 | `	pVm->nRefUsed--;` |
|  2906142 | 14293 | `	return SXRET_OK;` |
|        2 | 14294 |  |
|        - | 14295 | `/*` |
...
|        - | 14302 | ` * extension.` |
|        - | 14303 | ` */` |
|  2952714 | 14304 | `PH7_PRIVATE sxi32 PH7_VmRefObjInstall(` |
...
|        - | 14310 | `	)` |
|        2 | 14311 |  |
|  2952716 | 14312 | `	VmFrame *pFrame = pVm->pFrame;` |
|        - | 14313 | `	VmRefObj *pRef;` |
|        - | 14314 | `	/* Check if the referenced object already exists */` |
|  2952716 | 14315 | `	pRef = VmRefObjExtract(&(*pVm),nIdx);` |
|  2952716 | 14316 | `	if( pRef == 0 ){` |
|        - | 14317 | `		/* Create a new entry */` |
|  2930572 | 14318 | `		pRef = VmNewRefObj(&(*pVm),nIdx);` |
|  2930572 | 14319 | `		if( pRef == 0 ){` |
|      ! 0 | 14320 | `			return SXERR_MEM;` |
|        - | 14321 | `		}` |
|  2930572 | 14322 | `		pRef->iFlags = iFlags;` |
|        - | 14323 | `		/* Install the entry */` |
|  2930572 | 14324 | `		VmRefObjInsert(&(*pVm),pRef);` |
|  1465285 | 14325 | `	}` |
|  2957628 | 14326 | `	while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|        - | 14327 | `		/* Safely ignore the exception frame */` |
|     4914 | 14328 | `		pFrame = pFrame->pParent;` |
|        2 | 14329 | `	}` |
|  2952716 | 14330 | `	if( pFrame->pParent != 0 && pEntry ){` |
|        - | 14331 | `		VmSlot sRef;` |
|        - | 14332 | `		/* Local frame,record referenced entry so that it can` |
|        - | 14333 | `		 * be deleted when we leave this frame.` |
|        - | 14334 | `		 */` |
|    66358 | 14335 | `		sRef.nIdx = nIdx;` |
|    66358 | 14336 | `		sRef.pUserData = pEntry;` |
|    66358 | 14337 | `		if( SXRET_OK != SySetPut(&pFrame->sRef,(const void *)&sRef)) {` |
|      ! 0 | 14338 | `			pEntry = 0; /* Do not record this entry */` |
|      ! 0 | 14339 | `		}` |
|    33178 | 14340 | `	}` |
|  2952716 | 14341 | `	if( pEntry ){` |
|        - | 14342 | `		/* Address of the hash-entry */` |
|    88316 | 14343 | `		SySetPut(&pRef->aReference,(const void *)&pEntry);` |
|    44157 | 14344 | `	}` |
|  2952716 | 14345 | `	if( pMapEntry ){` |
|        - | 14346 | `		/* Address of the hashmap node [i.e: Array entry] */` |
|  2860382 | 14347 | `		SySetPut(&pRef->aArrEntries,(const void *)&pMapEntry);` |
|  1430190 | 14348 | `	}` |
|  2952716 | 14349 | `	return SXRET_OK;` |
|  1476359 | 14350 |  |
|        - | 14351 | `/*` |
...
|        - | 14358 | ` * extension.` |
|        - | 14359 | ` */` |
|  2898262 | 14360 | `PH7_PRIVATE sxi32 PH7_VmRefObjRemove(` |
...
|  2898264 | 14370 | `	pRef = VmRefObjExtract(&(*pVm),nIdx);` |
|  2898264 | 14371 | `	if( pRef == 0 ){` |
|        - | 14372 | `		/* Not such entry */` |
|    66308 | 14373 | `		return SXERR_NOTFOUND;` |
|        - | 14374 | `	}` |
|        - | 14375 | `	/* Remove the desired entry */` |
|  2831958 | 14376 | `	if( pEntry ){` |
...
|       73 | 14389 | `		}` |
|       25 | 14390 | `	}` |
|  2831958 | 14391 | `	if( pMapEntry ){` |
|        - | 14392 | `		ph7_hashmap_node **apNode;` |
|  2831908 | 14393 | `		apNode = (ph7_hashmap_node **)SySetBasePtr(&pRef->aArrEntries);` |
|  5663902 | 14394 | `		for(n = 0 ; n < SySetUsed(&pRef->aArrEntries) ; n++ ){` |
|  2831996 | 14395 | `			if( apNode[n] == pMapEntry ){` |
|        - | 14396 | `				/* nullify the entry */` |
|  2831908 | 14397 | `				apNode[n] = 0;` |
|  1415953 | 14398 | `			}` |
|  1415999 | 14399 | `		}` |
|  1415953 | 14400 | `	}` |
|  2831958 | 14401 | `	return SXRET_OK;` |
|  1449133 | 14402 |  |
...
|        - | 14411 | ` */` |
|    21744 | 14412 | `PH7_PRIVATE const ph7_io_stream * PH7_VmGetStreamDevice(` |
...
|    21746 | 14424 | `	zNext = zCur = zIn = *pzDevice;` |
|    21746 | 14425 | `	zEnd = &zIn[nByte];` |
|  1383956 | 14426 | `	while( zIn < zEnd ){` |
|  1362214 | 14427 | `		if( zIn < &zEnd[-3]/*://*/ && zIn[0] == ':' && zIn[1] == '/' && zIn[2] == '/' ){` |
|        - | 14428 | `			/* Got one */` |
...
|  1362212 | 14433 | `		zIn++;` |
|        2 | 14434 | `	}` |
|    21746 | 14435 | `	if( zIn >= zEnd ){` |
|        - | 14436 | `		/* No such scheme,return the default stream */` |
|    21744 | 14437 | `		return pVm->pDefStream;` |
|        - | 14438 | `	}` |
