...
|        - |   75 | ` */` |
|  1281647 |   76 | `PH7_PRIVATE sxi32 VmIsUnorderedCmp(ph7_value *pLeft,ph7_value *pRight)` |
|        5 |   77 | `{` |
|  1281652 |   78 | `	if( (pLeft->iFlags & MEMOBJ_REAL) && PH7_IS_NAN(pLeft->rVal) ){` |
|       40 |   79 | `		return TRUE;` |
|        - |   80 | `	}` |
|  1281614 |   81 | `	if( (pRight->iFlags & MEMOBJ_REAL) && PH7_IS_NAN(pRight->rVal) ){` |
|       11 |   82 | `		return TRUE;` |
|        - |   83 | `	}` |
|  1281604 |   84 | `	return FALSE;` |
|   641341 |   85 | `}` |
|        - |   86 | `/*` |
...
|        - |   94 | ` */` |
|   367631 |   95 | `PH7_PRIVATE int VmStringWantsPerlIncr(ph7_value *pVal)` |
|        5 |   96 | `{` |
|        - |   97 | `	SyString sStr;` |
|   367636 |   98 | `	sxu8 bReal = FALSE;` |
|   367636 |   99 | `	const char *zTail = 0;` |
|        - |  100 | `	const char *zEnd;` |
|   367636 |  101 | `	if( (pVal->iFlags & MEMOBJ_STRING) == 0 ){` |
|   367622 |  102 | `		return FALSE;` |
|        - |  103 | `	}` |
...
|        - |  309 | ` */` |
|  3427740 |  310 | `PH7_PRIVATE sxi32 PH7_VmInitFuncState(` |
...
|  3427745 |  320 | `	SyZero(pFunc,sizeof(ph7_vm_func));` |
|        - |  321 | `	/* Initialize structure fields */` |
|        - |  322 | `	/* Arguments container */` |
|  3427745 |  323 | `	SySetInit(&pFunc->aArgs,&pVm->sAllocator,sizeof(ph7_vm_func_arg));` |
|        - |  324 | `	/* Static variable container */` |
|  3427745 |  325 | `	SySetInit(&pFunc->aStatic,&pVm->sAllocator,sizeof(ph7_vm_func_static_var));` |
|        - |  326 | `	/* Bytecode container */` |
|  3427745 |  327 | `	SySetInit(&pFunc->aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|        - |  328 | `    /* Preallocate some instruction slots */` |
|  3427745 |  329 | `	SySetAlloc(&pFunc->aByteCode,0x10);` |
|        - |  330 | `	/* Closure environment */` |
|  3427745 |  331 | `	SySetInit(&pFunc->aClosureEnv,&pVm->sAllocator,sizeof(ph7_vm_func_closure_env));` |
|        - |  332 | `	/* Return-type union alternatives (empty unless declared as a union) */` |
|  3427745 |  333 | `	SySetInit(&pFunc->aReturnUnion,&pVm->sAllocator,sizeof(ph7_type_alt));` |
|        - |  334 | `	/* Declared #[...] attributes */` |
|  3427745 |  335 | `	SySetInit(&pFunc->aAttrs,&pVm->sAllocator,sizeof(ph7_attribute));` |
|  3427745 |  336 | `	pFunc->iFlags = iFlags;` |
|  3427745 |  337 | `	pFunc->pUserData = pUserData;` |
...
|  3427745 |  340 | `	pFunc->bStrictTypes = (sxu8)(pVm->sCodeGen.bStrictTypes ? 1 : 0);` |
|  3427745 |  341 | `	if( pVm->bCompilingBuiltin ){` |
...
|     4545 |  348 | `		SyString *pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|     4545 |  349 | `		if( pFile ){` |
|     4545 |  350 | `			SyStringDupPtr(&pFunc->sFile,pFile);` |
|     2270 |  351 | `		}` |
|        - |  352 | `	}` |
|  3427745 |  353 | `	SyStringInitFromBuf(&pFunc->sName,zName,nByte);` |
|  3427745 |  354 | `	return SXRET_OK;` |
|        5 |  355 | `}` |
|        - |  356 | `/*` |
...
|        - |  363 | ` */` |
|  5824146 |  364 | `PH7_PRIVATE sxi32 PH7_VmInstallUserFunction(` |
...
|        - |  371 | `	sxi32 rc;` |
|  5824151 |  372 | `	if( pName == 0 ){` |
|        - |  373 | `		/* Use the built-in name */` |
|   523799 |  374 | `		pName = &pFunc->sName;` |
|   261897 |  375 | `	}` |
|        - |  376 | `	/* Check for duplicates (functions with the same name) first */` |
|  5824151 |  377 | `	pEntry = SyHashGet(&pVm->hFunction,pName->zString,pName->nByte);` |
|  5824151 |  378 | `	if( pEntry ){` |
...
|        - |  386 | `	}` |
|        - |  387 | `	/* First time seen */` |
|  2953841 |  388 | `	pFunc->pNextName = 0;` |
|  2953841 |  389 | `	rc = SyHashInsert(&pVm->hFunction,pName->zString,pName->nByte,pFunc);` |
|  2953841 |  390 | `	return rc;` |
|  2912078 |  391 | `}` |
|        - |  392 | `/*` |
|        - |  393 | ` * Install a user defined class in the corresponding VM container.` |
|        - |  394 | ` */` |
|   523402 |  395 | `PH7_PRIVATE sxi32 PH7_VmInstallClass(` |
|        - |  396 | `	ph7_vm *pVm,      /* Target VM  */` |
|        - |  397 | `	ph7_class *pClass /* Target Class */` |
|        - |  398 | `	)` |
|        5 |  399 | `{` |
|   523407 |  400 | `	SyString *pName = &pClass->sName;` |
|        - |  401 | `	SyHashEntry *pEntry;` |
|        - |  402 | `	sxi32 rc;` |
|        - |  403 | `	/* Check for duplicates */` |
|   523407 |  404 | `	pEntry = SyHashGet(&pVm->hClass,(const void *)pName->zString,pName->nByte);` |
|   523407 |  405 | `	if( pEntry ){` |
...
|        - |  411 | `	}` |
|   523405 |  412 | `	pClass->pNextName = 0;` |
|        - |  413 | `	/* Perform a simple hashtable insertion */` |
|   523405 |  414 | `	rc = SyHashInsert(&pVm->hClass,(const void *)pName->zString,pName->nByte,pClass);` |
|   523405 |  415 | `	return rc;` |
|   261706 |  416 | `}` |
|        - |  417 | `/*` |
|        - |  418 | ` * Instruction builder interface.` |
|        - |  419 | ` */` |
| 98651948 |  420 | `PH7_PRIVATE sxi32 PH7_VmEmitInstr(` |
...
|        5 |  428 | `{` |
|        - |  429 | `	VmInstr sInstr;` |
| 98651953 |  430 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|        - |  431 | `	sxi32 rc;` |
|        - |  432 | `	/* Fill the VM instruction */` |
| 98651953 |  433 | `	sInstr.iOp = (sxu8)iOp;` |
| 98651953 |  434 | `	sInstr.iP1 = iP1;` |
| 98651953 |  435 | `	sInstr.iP2 = iP2;` |
| 98651953 |  436 | `	sInstr.p3  = p3;` |
...
| 98651953 |  441 | `	sInstr.nLine = 0;` |
| 98651953 |  442 | `	if( pGen->pIn && pGen->pEnd && pGen->pIn < pGen->pEnd ){` |
| 42030751 |  443 | `		sInstr.nLine = pGen->pIn->nLine;` |
| 77636580 |  444 | `	}else if( pGen->pIn && pGen->pEnd && pGen->pIn >= pGen->pEnd && pGen->pEnd > (SyToken *)0 ){` |
|        - |  445 | `		/* Past the end (statement tail): blame the last real token. */` |
| 56406003 |  446 | `		sInstr.nLine = pGen->pEnd[-1].nLine;` |
| 28202999 |  447 | `	}` |
| 98651953 |  448 | `	if( pIndex ){` |
|        - |  449 | `		/* Instruction index in the bytecode array */` |
|  6678235 |  450 | `		*pIndex = SySetUsed(pVm->pByteContainer);` |
|  3339115 |  451 | `	}` |
|        - |  452 | `	/* Finally,record the instruction */` |
| 98651953 |  453 | `	rc = SySetPut(pVm->pByteContainer,(const void *)&sInstr);` |
| 98651953 |  454 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  455 | `		PH7_GenCompileError(&pVm->sCodeGen,E_ERROR,1,"Fatal,Cannot emit instruction due to a memory failure");` |
|        - |  456 | `		/* Fall throw */` |
|      ! 0 |  457 | `	}` |
| 98651953 |  458 | `	return rc;` |
|        5 |  459 | `}` |
|        - |  460 | `/*` |
|        - |  461 | ` * Swap the current bytecode container with the given one.` |
|        - |  462 | ` */` |
|  9810740 |  463 | `PH7_PRIVATE sxi32 PH7_VmSetByteCodeContainer(ph7_vm *pVm,SySet *pContainer)` |
|        5 |  464 | `{` |
|  9810745 |  465 | `	if( pContainer == 0 ){` |
|        - |  466 | `		/* Point to the default container */` |
|      ! 0 |  467 | `		pVm->pByteContainer = &pVm->aByteCode;` |
|      ! 0 |  468 | `	}else{` |
|        - |  469 | `		/* Change container */` |
|  9810745 |  470 | `		pVm->pByteContainer = &(*pContainer);` |
|        - |  471 | `	}` |
|  9810745 |  472 | `	return SXRET_OK;` |
|        5 |  473 | `}` |
|        - |  474 | `/*` |
|        - |  475 | ` * Return the current bytecode container.` |
|        - |  476 | ` */` |
|  4905370 |  477 | `PH7_PRIVATE SySet * PH7_VmGetByteCodeContainer(ph7_vm *pVm)` |
|        5 |  478 | `{` |
|  4905375 |  479 | `	return pVm->pByteContainer;` |
|        5 |  480 | `}` |
|        - |  481 | `/*` |
|        - |  482 | ` * Extract the VM instruction rooted at nIndex.` |
|        - |  483 | ` */` |
|  6615908 |  484 | `PH7_PRIVATE VmInstr * PH7_VmGetInstr(ph7_vm *pVm,sxu32 nIndex)` |
|        5 |  485 | `{` |
|        - |  486 | `	VmInstr *pInstr;` |
|  6615913 |  487 | `	pInstr = (VmInstr *)SySetAt(pVm->pByteContainer,nIndex);` |
|  6615913 |  488 | `	return pInstr;` |
|        5 |  489 | `}` |
|        - |  490 | `/*` |
|        - |  491 | ` * Return the total number of VM instructions recorded so far.` |
|        - |  492 | ` */` |
| 24591688 |  493 | `PH7_PRIVATE sxu32 PH7_VmInstrLength(ph7_vm *pVm)` |
|        5 |  494 | `{` |
| 24591693 |  495 | `	return SySetUsed(pVm->pByteContainer);` |
|        5 |  496 | `}` |
|        - |  497 | `/*` |
|        - |  498 | ` * Pop the last VM instruction.` |
|        - |  499 | ` */` |
|  5414336 |  500 | `PH7_PRIVATE VmInstr * PH7_VmPopInstr(ph7_vm *pVm)` |
|        5 |  501 | `{` |
|  5414341 |  502 | `	return (VmInstr *)SySetPop(pVm->pByteContainer);` |
|        5 |  503 | `}` |
|        - |  504 | `/*` |
|        - |  505 | ` * Peek the last VM instruction.` |
|        - |  506 | ` */` |
| 20509606 |  507 | `PH7_PRIVATE VmInstr * PH7_VmPeekInstr(ph7_vm *pVm)` |
|        5 |  508 | `{` |
| 20509611 |  509 | `	return (VmInstr *)SySetPeek(pVm->pByteContainer);` |
|        5 |  510 | `}` |
|  1717164 |  511 | `PH7_PRIVATE VmInstr * PH7_VmPeekNextInstr(ph7_vm *pVm)` |
|        5 |  512 | `{` |
|        - |  513 | `	VmInstr *aInstr;` |
|        - |  514 | `	sxu32 n;` |
|  1717169 |  515 | `	n = SySetUsed(pVm->pByteContainer);` |
|  1717169 |  516 | `	if( n < 2 ){` |
|      ! 0 |  517 | `		return 0;` |
|        - |  518 | `	}` |
|  1717169 |  519 | `	aInstr = (VmInstr *)SySetBasePtr(pVm->pByteContainer);` |
|  1717169 |  520 | `	return &aInstr[n - 2];` |
|   858587 |  521 | `}` |
|        - |  522 | `/*` |
|        - |  523 | ` * Allocate a new virtual machine frame.` |
|        - |  524 | ` */` |
|   113985 |  525 | `PH7_PRIVATE VmFrame * VmNewFrame(` |
...
|   113990 |  533 | `	pFrame = (VmFrame *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmFrame));` |
|   113990 |  534 | `	if( pFrame == 0 ){` |
|      ! 0 |  535 | `		return 0;` |
|        - |  536 | `	}` |
|        - |  537 | `	/* Zero the structure */` |
|   113990 |  538 | `	SyZero(pFrame,sizeof(VmFrame));` |
|        - |  539 | `	/* Initialize frame fields */` |
|   113990 |  540 | `	pFrame->pUserData = pUserData;` |
|   113990 |  541 | `	pFrame->pThis = pThis;` |
|   113990 |  542 | `	pFrame->pVm = pVm;` |
|   113990 |  543 | `	SyHashInit(&pFrame->hVar,&pVm->sAllocator,0,0);` |
|   113990 |  544 | `	SySetInit(&pFrame->sArg,&pVm->sAllocator,sizeof(VmSlot));` |
|   113990 |  545 | `	SySetInit(&pFrame->sLocal,&pVm->sAllocator,sizeof(VmSlot));` |
|   113990 |  546 | `	SySetInit(&pFrame->sRef,&pVm->sAllocator,sizeof(VmSlot));` |
|   113990 |  547 | `	pFrame->nActualArgs = -1; /* unknown until an arg-install site stamps it */` |
...
|   113990 |  550 | `	PH7_MemObjInit(&(*pVm),&pFrame->sRet);` |
|   113990 |  551 | `	return pFrame;` |
|    57100 |  552 | `}` |
...
|        - |  557 | ` */` |
|   113389 |  558 | `PH7_PRIVATE sxi32 VmEnterFrame(` |
...
|   113394 |  567 | `	pFrame = VmNewFrame(&(*pVm),pUserData,pThis);` |
|   113394 |  568 | `	if( pFrame == 0 ){` |
|      ! 0 |  569 | `		return SXERR_MEM;` |
|        - |  570 | `	}` |
|        - |  571 | `	/* The line currently executing IS the call site for the frame being pushed. */` |
|   113394 |  572 | `	pFrame->nCallLine = pVm->nCurLine;` |
|        - |  573 | `	/* Link to the list of active VM frame */` |
|   113394 |  574 | `	pFrame->pParent = pVm->pFrame;` |
|   113394 |  575 | `	pVm->pFrame = pFrame;` |
|   113394 |  576 | `	if( ppFrame ){` |
|        - |  577 | `		/* Write a pointer to the new VM frame */` |
|   109496 |  578 | `		*ppFrame = pFrame;` |
|    54848 |  579 | `	}` |
|   113394 |  580 | `	return SXRET_OK;` |
|    56802 |  581 | `}` |
|        - |  582 | `/*` |
...
|        - |  630 | ` */` |
|   109921 |  631 | `PH7_PRIVATE void VmDropResumeTarget(ph7_vm *pVm, VmFrame *pFrame)` |
|        5 |  632 | `{` |
|   109926 |  633 | `	if( pVm->pResumeFrame == pFrame ){` |
...
|        - |  639 | ` */` |
|   109069 |  640 | `PH7_PRIVATE void VmLeaveFrame(ph7_vm *pVm)` |
|        5 |  641 | `{` |
|   109074 |  642 | `		VmFrame *pCurFrame = pVm->pFrame;` |
|   109074 |  643 | `	if( pCurFrame ){` |
|        - |  644 | `		/* Unlink from the list of active VM frame */` |
|   109074 |  645 | `		pVm->pFrame = pCurFrame->pParent;` |
|   109074 |  646 | `		if( pCurFrame->pParent && (pCurFrame->iFlags & VM_FRAME_EXCEPTION) == 0 ){` |
|        - |  647 | `			VmSlot  *aSlot;` |
|        - |  648 | `			sxu32 n;` |
|        - |  649 | `			/* Restore local variable to the free pool so that they can be reused again */` |
|   104230 |  650 | `			aSlot = (VmSlot *)SySetBasePtr(&pCurFrame->sLocal);` |
|   592478 |  651 | `			for(n = 0 ; n < SySetUsed(&pCurFrame->sLocal) ; ++n ){` |
|        - |  652 | `				/* Unset the local variable */` |
|   488253 |  653 | `				PH7_VmUnsetMemObj(&(*pVm),aSlot[n].nIdx,FALSE);` |
|   244744 |  654 | `			}` |
|        - |  655 | `			/* Remove local reference */` |
|   104230 |  656 | `			aSlot = (VmSlot *)SySetBasePtr(&pCurFrame->sRef);` |
|   592562 |  657 | `			for(n = 0 ; n < SySetUsed(&pCurFrame->sRef) ; ++n ){` |
|   488337 |  658 | `				PH7_VmRefObjRemove(&(*pVm),aSlot[n].nIdx,(SyHashEntry *)aSlot[n].pUserData,0);` |
|   244786 |  659 | `			}` |
|    52215 |  660 | `		}` |
|        - |  661 | `		/* Release internal containers */` |
|   109074 |  662 | `		SyHashRelease(&pCurFrame->hVar);` |
|   109074 |  663 | `		SySetRelease(&pCurFrame->sArg);` |
|   109074 |  664 | `		SySetRelease(&pCurFrame->sLocal);` |
|   109074 |  665 | `		SySetRelease(&pCurFrame->sRef);` |
...
|   109074 |  669 | `		PH7_MemObjRelease(&pCurFrame->sRet);` |
|        - |  670 | `		/* Drop a recorded in-place-catch resume target pointing at this frame (ROOT B). */` |
|   109074 |  671 | `		VmDropResumeTarget(pVm,pCurFrame);` |
|        - |  672 | `		/* Release the whole structure */` |
|   109074 |  673 | `		SyMemBackendPoolFree(&pVm->sAllocator,pCurFrame);` |
|    54637 |  674 | `	}` |
|   109074 |  675 | `}` |
|        - |  676 | `/*` |
...
|        - |  727 | ` */` |
| 10553490 |  728 | `PH7_PRIVATE VmFrame * VmSkipExceptionFrames(VmFrame *pFrame)` |
|        5 |  729 | `{` |
| 10578737 |  730 | `	while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|    25247 |  731 | `		pFrame = pFrame->pParent;` |
|        5 |  732 | `	}` |
| 10553495 |  733 | `	return pFrame;` |
|        5 |  734 | `}` |
|        - |  735 | `/*` |
...
|      ! 0 |  913 | `	return 0;` |
|       38 |  914 | `}` |
|   257687 |  915 | `PH7_PRIVATE sxi32 VmDrainFinally(ph7_vm *pVm, sxu32 nExceptionBase)` |
|        5 |  916 | `{` |
|        - |  917 | `	sxu32 nUsed;` |
|   257692 |  918 | `	sxi32 rcOut = SXRET_OK;` |
|   257756 |  919 | `	while( (nUsed = SySetUsed(&pVm->aException)) > nExceptionBase ){` |
...
|        - |  956 | ` */` |
|   155062 |  957 | `PH7_PRIVATE void VmClearFrameReturn(VmFrame *pFrame)` |
|        5 |  958 | `{` |
|   155067 |  959 | `	pFrame->bHasRet = 0;` |
|   155067 |  960 | `	PH7_MemObjRelease(&pFrame->sRet);` |
|   155067 |  961 | `}` |
|        - |  962 | `/*` |
...
|        - | 1110 | ` */` |
|    34864 | 1111 | `PH7_PRIVATE sxi32 VmLocalExecIntoObj(ph7_vm *pVm,SySet *pByteCode,ph7_value **ppMemObj,int bReturnPropagates)` |
|        5 | 1112 | `{` |
|        - | 1113 | `	ph7_value sVal;` |
|    34869 | 1114 | `	sxu32 nIdx = (*ppMemObj)->nIdx;` |
|        - | 1115 | `	sxi32 rc;` |
|    34869 | 1116 | `	PH7_MemObjInit(&(*pVm),&sVal);` |
|    34869 | 1117 | `	rc = VmLocalExec(&(*pVm),pByteCode,&sVal,bReturnPropagates);` |
|        - | 1118 | `	/* aMemObj may have moved during the eval — re-fetch by the reserved index. */` |
|    34869 | 1119 | `	*ppMemObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|    34869 | 1120 | `	if( *ppMemObj ){` |
|    34869 | 1121 | `		PH7_MemObjStore(&sVal,*ppMemObj);` |
|    17432 | 1122 | `	}` |
|    34869 | 1123 | `	PH7_MemObjRelease(&sVal);` |
|    34869 | 1124 | `	return rc;` |
|        5 | 1125 | `}` |
|        - | 1126 | `/*` |
...
|        - | 1138 | ` */` |
|   705290 | 1139 | `static sxi32 VmMountUserClassAttrs(` |
...
|   705295 | 1147 | `	SyHashResetLoopCursor(&pClass->hAttr);` |
|        - | 1148 | `	/* Process only static and constant attribute */` |
|  2871933 | 1149 | `	while( (pEntry = SyHashGetNextEntry(&pClass->hAttr)) != 0 ){` |
|        - | 1150 | `		/* Extract the current attribute */` |
|  2166647 | 1151 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|  2166642 | 1152 | `		if( (pAttr->iFlags & PH7_CLASS_ATTR_CONSTANT)` |
|  1427709 | 1153 | `		 && ((pAttr->iFlags & PH7_CLASS_ATTR_TYPED) == 0` |
|   344832 | 1154 | `			\|\| (pAttr->iFlags & PH7_CLASS_ATTR_ENUMCASE) != 0) ){` |
...
|   687873 | 1164 | `			continue;` |
|        - | 1165 | `		}` |
|  1478779 | 1166 | `		if( pAttr->iFlags & (PH7_CLASS_ATTR_STATIC\|PH7_CLASS_ATTR_CONSTANT) ){` |
|        - | 1167 | `			ph7_value *pMemObj;` |
|    24959 | 1168 | `			if( pAttr->nIdx != SXU32_HIGH ){` |
...
|    12040 | 1248 | `		}` |
|        5 | 1249 | `	}` |
|   705291 | 1250 | `	return SXRET_OK;` |
|   352650 | 1251 | `}` |
|   704214 | 1252 | `PH7_PRIVATE sxi32 VmMountUserClass(` |
...
|   704219 | 1261 | `	rc = VmMountUserClassAttrs(&(*pVm),pClass);` |
|   704219 | 1262 | `	if( rc != SXRET_OK ){` |
|        6 | 1263 | `		return rc;` |
|        - | 1264 | `	}` |
|        - | 1265 | `	/* Install class methods */` |
|   704215 | 1266 | `	if( pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|        - | 1267 | `		/* Do not mount interface/trait methods since they are not directly invocable.` |
|        - | 1268 | `		 */` |
|   312535 | 1269 | `		return SXRET_OK;` |
|        - | 1270 | `	}` |
|        - | 1271 | `	/* Create constructor alias if not yet done */` |
|   391685 | 1272 | `	if( SyHashGet(&pClass->hMethod,"__construct",sizeof("__construct")-1) == 0 ){` |
|        - | 1273 | `		/* User constructor with the same base class name */` |
|    59653 | 1274 | `		pEntry = SyHashGet(&pClass->hMethod,SyStringData(&pClass->sName),SyStringLength(&pClass->sName));` |
|    59653 | 1275 | `		if( pEntry ){` |
...
|   391685 | 1282 | `	SyHashResetLoopCursor(&pClass->hMethod);` |
|  5898165 | 1283 | `	while((pEntry = SyHashGetNextEntry(&pClass->hMethod)) != 0 ){` |
...
|     8687 | 1310 | `	SyHashResetLoopCursor(&pClass->hAttr);` |
|    45675 | 1311 | `	while( (pEntry = SyHashGetNextEntry(&pClass->hAttr)) != 0 ){` |
|        - | 1312 | `		VmClassAttr *pVmAttr;` |
|        - | 1313 | `		/* Extract the current attribute */` |
|    36993 | 1314 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|    36993 | 1315 | `		pVmAttr = (VmClassAttr *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmClassAttr));` |
|    36993 | 1316 | `		if( pVmAttr == 0 ){` |
|      ! 0 | 1317 | `			return SXERR_MEM;` |
|        - | 1318 | `		}` |
|    36993 | 1319 | `		pVmAttr->pAttr = pAttr;` |
|    36993 | 1320 | `		if( (pAttr->iFlags & (PH7_CLASS_ATTR_CONSTANT\|PH7_CLASS_ATTR_STATIC)) == 0 ){` |
|        - | 1321 | `			ph7_value *pMemObj;` |
|        - | 1322 | `			/* Reserve a memory object for this attribute */` |
|    28939 | 1323 | `			pMemObj = PH7_ReserveMemObj(&(*pVm));` |
|    28939 | 1324 | `			if( pMemObj == 0 ){` |
|      ! 0 | 1325 | `				SyMemBackendPoolFree(&pVm->sAllocator,pVmAttr);` |
|      ! 0 | 1326 | `				return SXERR_MEM;` |
|        - | 1327 | `			}` |
|    28939 | 1328 | `			pVmAttr->nIdx = pMemObj->nIdx;` |
|    28939 | 1329 | `			pVmAttr->iState = 0;` |
|    28939 | 1330 | `			pVmAttr->pOwner = pClass;` |
|    28939 | 1331 | `			if( SySetUsed(&pAttr->aByteCode) > 0 ){` |
...
|    23651 | 1339 | `			}else if( pAttr->iFlags & PH7_CLASS_ATTR_TYPED ){` |
...
|      199 | 1343 | `			}` |
|    28939 | 1344 | `			rc = SyHashInsertTail(&pObj->hAttr,SyStringData(&pAttr->sName),SyStringLength(&pAttr->sName),pVmAttr);` |
|    28939 | 1345 | `			if( rc != SXRET_OK ){` |
|        - | 1346 | `				VmSlot sSlot;` |
...
|    28939 | 1355 | `			PH7_VmRefObjInstall(&(*pVm),pMemObj->nIdx,0,0,VM_REF_IDX_KEEP);` |
...
|    28939 | 1359 | `			if( pAttr->iFlags & PH7_CLASS_ATTR_TYPED ){` |
...
|        - | 1556 | ` */` |
|  8591966 | 1557 | `PH7_PRIVATE ph7_value * PH7_ReserveConstObj(ph7_vm *pVm,sxu32 *pIndex)` |
|        5 | 1558 | `{` |
|        - | 1559 | `	ph7_value *pObj;` |
|        - | 1560 | `	sxi32 rc;` |
|  8591971 | 1561 | `	if( pIndex ){` |
|        - | 1562 | `		/* Object index in the object table */` |
|  8580301 | 1563 | `		*pIndex = SySetUsed(&pVm->aLitObj);` |
|  4290148 | 1564 | `	}` |
|        - | 1565 | `	/* Reserve a slot for the new object */` |
|  8591971 | 1566 | `	rc = SySetPut(&pVm->aLitObj,(const void *)zDummy);` |
|  8591971 | 1567 | `	if( rc != SXRET_OK ){` |
...
|      ! 0 | 1571 | `		return 0;` |
|        - | 1572 | `	}` |
|  8591971 | 1573 | `	pObj = (ph7_value *)SySetPeek(&pVm->aLitObj);` |
|  8591971 | 1574 | `	return pObj;` |
|  4295988 | 1575 | `}` |
|        - | 1576 | `/*` |
|        - | 1577 | ` * Reserve a memory object.` |
|        - | 1578 | ` * Return a pointer to the raw ph7_value on success. NULL on failure.` |
|        - | 1579 | ` */` |
|  2237888 | 1580 | `PH7_PRIVATE ph7_value * VmReserveMemObj(ph7_vm *pVm,sxu32 *pIndex)` |
|        5 | 1581 | `{` |
|        - | 1582 | `	ph7_value *pObj;` |
|        - | 1583 | `	sxi32 rc;` |
|  2237893 | 1584 | `	if( pIndex ){` |
|        - | 1585 | `		/* Object index in the object table */` |
|  2237893 | 1586 | `		*pIndex = SySetUsed(&pVm->aMemObj);` |
|  1118944 | 1587 | `	}` |
|        - | 1588 | `	/* Reserve a slot for the new object */` |
|  2237893 | 1589 | `	rc = SySetPut(&pVm->aMemObj,(const void *)zDummy);` |
|  2237893 | 1590 | `	if( rc != SXRET_OK ){` |
...
|      ! 0 | 1594 | `		return 0;` |
|        - | 1595 | `	}` |
|  2237893 | 1596 | `	pObj = (ph7_value *)SySetPeek(&pVm->aMemObj);` |
|  2237893 | 1597 | `	return pObj;` |
|  1118949 | 1598 | `}` |
...
|        - | 1891 | ` */` |
|    41334 | 1892 | `PH7_PRIVATE void VmTrackOutput(ph7_vm *pVm, sxu32 nLen)` |
|        5 | 1893 | `{` |
|    41339 | 1894 | `	ProcConsumer xCons = pVm->sVmConsumer.xConsumer;` |
|    41339 | 1895 | `	if( xCons != VmObConsumer ){` |
|    12553 | 1896 | `		pVm->nOutputLen += nLen;` |
|    12553 | 1897 | `		if( !pVm->bHeadersSent && xCons != PH7_VmBlobConsumer ){` |
|     1393 | 1898 | `			pVm->bHeadersSent = 1;` |
|      694 | 1899 | `		}` |
|     6274 | 1900 | `	}` |
|    41339 | 1901 | `}` |
|        - | 1902 | `/*` |
...
|        - | 1951 | ` */` |
|    50998 | 1952 | `static int VmInstrStackEffect(VmInstr *pI, sxu32 pc, int *pPush, int *pN, sxu32 aSucc[2], sxi32 aDelta[2])` |
|        5 | 1953 | `{` |
|    51003 | 1954 | `	int push = 0, n = 0;` |
|        - | 1955 | `	sxi32 d;` |
|    51003 | 1956 | `	switch( pI->iOp ){` |
...
|     8057 | 1959 | `	case PH7_OP_LOADC:` |
|        - | 1960 | `	case PH7_OP_DUP:` |
|    16119 | 1961 | `		push = 1; aSucc[0] = pc + 1; aDelta[0] = 1; n = 1; break;` |
|     5735 | 1962 | `	case PH7_OP_LOAD:` |
|    11475 | 1963 | `		if( pI->p3 ){ push = 1; d = 1; }else{ push = 0; d = 0; }` |
|    11475 | 1964 | `		aSucc[0] = pc + 1; aDelta[0] = d; n = 1; break;` |
...
|     5917 | 2012 | `		n = 0; break;` |
|     3096 | 2013 | `	default:` |
|     6197 | 2014 | `		return 0; /* unmodeled opcode -> whole-body fallback */` |
|        - | 2015 | `	}` |
|    44811 | 2016 | `	*pPush = push; *pN = n;` |
|    44811 | 2017 | `	return 1;` |
|    25504 | 2018 | `}` |
|        - | 2019 | `/*` |
...
|        - | 2023 | ` */` |
|     8214 | 2024 | `PH7_PRIVATE sxu32 VmComputeMaxStack(ph7_vm *pVm, VmInstr *aInstr, sxu32 nInstr)` |
|        5 | 2025 | `{` |
|        - | 2026 | `	void *pScratch;` |
...
|     8219 | 2032 | `	if( nInstr == 0 \|\| nInstr > 8192 ){` |
...
|    44451 | 2037 | `	for( i = 0; i < nInstr; i++ ){` |
|    42429 | 2038 | `		if( !VmInstrStackEffect(&aInstr[i], i, &push, &n, succ, delta) ){` |
|     6197 | 2039 | `			return VM_STACK_UNMODELED;` |
|        - | 2040 | `		}` |
|    18121 | 2041 | `	}` |
...
|        - | 2088 | ` */` |
|   242226 | 2089 | `PH7_PRIVATE ph7_value * VmNewOperandStack(` |
...
|        - | 2101 | `  */` |
|   242231 | 2102 | `	nInstr += VM_STACK_GUARD;` |
|   242231 | 2103 | `	pStack = (ph7_value *)SyMemBackendAlloc(&pVm->sAllocator,nInstr * sizeof(ph7_value));` |
|   242231 | 2104 | `	if( pStack == 0 ){` |
|      ! 0 | 2105 | `		return 0;` |
|        - | 2106 | `	}` |
|        - | 2107 | `	/* Initialize the operand stack */` |
| 23088525 | 2108 | `	while( nInstr > 0 ){` |
| 22846299 | 2109 | `		PH7_MemObjInit(&(*pVm),&pStack[nInstr - 1]);` |
| 22846299 | 2110 | `		--nInstr;` |
|        5 | 2111 | `	}` |
|        - | 2112 | `	/* Ready for bytecode execution */` |
|   242231 | 2113 | `	return pStack;` |
|   121220 | 2114 | `}` |
|        - | 2115 | `/*` |
...
|        - | 2153 | ` */` |
|   104501 | 2154 | `PH7_PRIVATE ph7_value * VmOperandStackAlloc(ph7_vm *pVm, sxu32 nSlots)` |
|        5 | 2155 | `{` |
|   104506 | 2156 | `	VmIdleStack *pIdle = (VmIdleStack *)pVm->pIdleOperandStacks;` |
|   104506 | 2157 | `	sxu32 nCap = nSlots + VM_STACK_GUARD;` |
|   104506 | 2158 | `	if( pIdle && pIdle->nCap == nCap ){` |
|    18538 | 2159 | `		ph7_value *pStack = pIdle->pStack;` |
|    18538 | 2160 | `		pVm->pIdleOperandStacks = pIdle->pNext;` |
|    18538 | 2161 | `		pVm->nIdleOperandStacks--;` |
...
|    18538 | 2164 | `		pIdle->pNext = (VmIdleStack *)pVm->pIdleStackNodes;` |
|    18538 | 2165 | `		pVm->pIdleStackNodes = pIdle;` |
|    18538 | 2166 | `		return pStack; /* slots already released -> reusable without re-init */` |
|        - | 2167 | `	}` |
|    85973 | 2168 | `	return VmNewOperandStack(&(*pVm),nSlots);` |
|    52358 | 2169 | `}` |
|        - | 2170 | `/*` |
...
|        - | 2174 | ` * live value.` |
|        - | 2175 | ` */` |
|   104091 | 2176 | `PH7_PRIVATE void VmOperandStackRecycle(ph7_vm *pVm, ph7_value *pStack, sxu32 nCap)` |
|        5 | 2177 | `{` |
|        - | 2178 | `	VmIdleStack *pIdle;` |
|        - | 2179 | `	sxu32 i;` |
|   104096 | 2180 | `	if( pStack == 0 ){` |
|      ! 0 | 2181 | `		return;` |
|        - | 2182 | `	}` |
|   104096 | 2183 | `	if( pVm->nIdleOperandStacks >= VM_STACK_POOL_MAX \|\| nCap > VM_STACK_POOL_MAXSLOTS ){` |
...
|    24340 | 2189 | `	pIdle = (VmIdleStack *)pVm->pIdleStackNodes;` |
|    24340 | 2190 | `	if( pIdle ){` |
|    18538 | 2191 | `		pVm->pIdleStackNodes = pIdle->pNext;` |
|     9272 | 2192 | `	}else{` |
|     5807 | 2193 | `		pIdle = (VmIdleStack *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmIdleStack));` |
|     5807 | 2194 | `		if( pIdle == 0 ){` |
|      ! 0 | 2195 | `			SyMemBackendFree(&pVm->sAllocator,pStack);` |
|      ! 0 | 2196 | `			return;` |
|        - | 2197 | `		}` |
|        - | 2198 | `	}` |
|  1679957 | 2199 | `	for( i = 0; i < nCap; i++ ){` |
|  1655622 | 2200 | `		PH7_MemObjRelease(&pStack[i]);` |
...
|  1655622 | 2206 | `		pStack[i].nIdx = SXU32_HIGH;` |
|   828007 | 2207 | `	}` |
|    24340 | 2208 | `	pIdle->pStack = pStack;` |
|    24340 | 2209 | `	pIdle->nCap = nCap;` |
|    24340 | 2210 | `	pIdle->pNext = (VmIdleStack *)pVm->pIdleOperandStacks;` |
|    24340 | 2211 | `	pVm->pIdleOperandStacks = pIdle;` |
|    24340 | 2212 | `	pVm->nIdleOperandStacks++;` |
|    52153 | 2213 | `}` |
...
|   462233 | 2309 | `	while((pEntry = SyHashGetNextEntry(&pVm->hClass)) != 0 ){` |
|   458813 | 2310 | `		rc = VmMountUserClass(&(*pVm),(ph7_class *)pEntry->pUserData);` |
|   458813 | 2311 | `		if( rc != SXRET_OK ){` |
|        3 | 2312 | `			return rc;` |
|        - | 2313 | `		}` |
|        5 | 2314 | `	}` |
...
|        - | 2701 | ` */` |
|   933628 | 2702 | `PH7_PRIVATE sxi32 VmInitCallContext(` |
...
|        - | 2708 | `	)` |
|        5 | 2709 | `{` |
|   933633 | 2710 | `	pOut->pFunc = pFunc;` |
|   933633 | 2711 | `	pOut->pVm   = pVm;` |
|   933633 | 2712 | `	SySetInit(&pOut->sVar,&pVm->sAllocator,sizeof(ph7_value *));` |
|   933633 | 2713 | `	SySetInit(&pOut->sChunk,&pVm->sAllocator,sizeof(ph7_aux_data));` |
|        - | 2714 | `	/* Assume a null return value */` |
|   933633 | 2715 | `	MemObjSetType(pRet,MEMOBJ_NULL);` |
|   933633 | 2716 | `	pOut->pRet = pRet;` |
|   933633 | 2717 | `	pOut->iFlags = iFlags;` |
|   933633 | 2718 | `	pOut->pArgMap = 0; /* Set by the OP_CALL dispatcher for named-arg-aware builtins */` |
|   933633 | 2719 | `	return SXRET_OK;` |
|        5 | 2720 | `}` |
|        - | 2721 | `/*` |
|        - | 2722 | ` * Release a foreign function call context and cleanup the mess` |
|        - | 2723 | ` * left behind.` |
|        - | 2724 | ` */` |
|   933628 | 2725 | `PH7_PRIVATE void VmReleaseCallContext(ph7_context *pCtx)` |
|        5 | 2726 | `{` |
|        - | 2727 | `	sxu32 n;` |
|   933633 | 2728 | `	if( SySetUsed(&pCtx->sVar) > 0 ){` |
|    11685 | 2729 | `		ph7_value **apObj = (ph7_value **)SySetBasePtr(&pCtx->sVar);` |
|    68290 | 2730 | `		for( n = 0 ; n < SySetUsed(&pCtx->sVar) ; ++n ){` |
|    56610 | 2731 | `			if( apObj[n] == 0 ){` |
|        - | 2732 | `				/* Already released */` |
|      682 | 2733 | `				continue;` |
|        - | 2734 | `			}` |
|    55933 | 2735 | `			PH7_MemObjRelease(apObj[n]);` |
|    55933 | 2736 | `			SyMemBackendPoolFree(&pCtx->pVm->sAllocator,apObj[n]);` |
|    27969 | 2737 | `		}` |
|    11685 | 2738 | `		SySetRelease(&pCtx->sVar);` |
|     5840 | 2739 | `	}` |
|   933633 | 2740 | `	if( SySetUsed(&pCtx->sChunk) > 0 ){` |
...
|        - | 2786 | ` */` |
|  5677371 | 2787 | `PH7_PRIVATE void VmPopOperand(` |
|        - | 2788 | `	ph7_value **ppTos, /* Operand stack */` |
|        - | 2789 | `	sxi32 nPop         /* Total number of memory objects to pop */` |
|        - | 2790 | `	)` |
|        5 | 2791 | `{` |
|  5677376 | 2792 | `	ph7_value *pTos = *ppTos;` |
| 12082372 | 2793 | `	while( nPop > 0 ){` |
|  6405001 | 2794 | `		PH7_MemObjRelease(pTos);` |
|  6405001 | 2795 | `		pTos--;` |
|  6405001 | 2796 | `		nPop--;` |
|        5 | 2797 | `	}` |
|        - | 2798 | `	/* Top of the stack */` |
|  5677376 | 2799 | `	*ppTos = pTos;` |
|  5677376 | 2800 | `}` |
|        - | 2801 | `/*` |
|        - | 2802 | ` * Reserve a memory object.` |
|        - | 2803 | ` * Return a pointer to the raw ph7_value on success. NULL on failure.` |
|        - | 2804 | ` */` |
|  4367861 | 2805 | `PH7_PRIVATE ph7_value * PH7_ReserveMemObj(ph7_vm *pVm)` |
|        5 | 2806 | `{` |
|  4367866 | 2807 | `	ph7_value *pObj = 0;` |
|        - | 2808 | `	VmSlot *pSlot;` |
|        - | 2809 | `	sxu32 nIdx;` |
|        - | 2810 | `	/* Check for a free slot */` |
|  4367866 | 2811 | `	nIdx = SXU32_HIGH; /* cc warning */` |
|  4367866 | 2812 | `	pSlot = (VmSlot *)SySetPop(&pVm->aFreeObj);` |
|  4367866 | 2813 | `	if( pSlot ){` |
|  2130004 | 2814 | `		pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pSlot->nIdx);` |
|  2130004 | 2815 | `		nIdx = pSlot->nIdx;` |
|  1065614 | 2816 | `	}` |
|  4367866 | 2817 | `	if( pObj == 0 ){` |
|        - | 2818 | `		/* Reserve a new memory object */` |
|  2237867 | 2819 | `		pObj = VmReserveMemObj(&(*pVm),&nIdx);` |
|  2237867 | 2820 | `		if( pObj == 0 ){` |
|      ! 0 | 2821 | `			return 0;` |
|        - | 2822 | `		}` |
|  1118931 | 2823 | `	}` |
|        - | 2824 | `	/* Set a null default value */` |
|  4367866 | 2825 | `	PH7_MemObjInit(&(*pVm),pObj);` |
|  4367866 | 2826 | `	pObj->nIdx = nIdx;` |
|  4367866 | 2827 | `	return pObj;` |
|  2184550 | 2828 | `}` |
|        - | 2829 | `/*` |
|        - | 2830 | ` * Insert an entry by reference (not copy) in the given hashmap.` |
|        - | 2831 | ` */` |
|    46422 | 2832 | `PH7_PRIVATE sxi32 VmHashmapRefInsert(` |
...
|        - | 2839 | `	ph7_value sKey;` |
|        - | 2840 | `	sxi32 rc;` |
|    46427 | 2841 | `	PH7_MemObjInitFromString(pMap->pVm,&sKey,0);` |
|    46427 | 2842 | `	PH7_MemObjStringAppend(&sKey,zKey,nByte);` |
|        - | 2843 | `	/* Perform the insertion */` |
|    46427 | 2844 | `	rc = PH7_HashmapInsertByRef(&(*pMap),&sKey,nRefIdx);` |
|    46427 | 2845 | `	PH7_MemObjRelease(&sKey);` |
|    46427 | 2846 | `	return rc;` |
|        5 | 2847 | `}` |
|        - | 2848 | `/*` |
...
|        - | 2959 | ` */` |
|  5814683 | 2960 | `PH7_PRIVATE ph7_value * VmExtractMemObj(` |
...
|        - | 2965 | `	)` |
|        5 | 2966 | `{` |
|  5814688 | 2967 | `	int bNullify = FALSE;` |
...
|  5814688 | 2974 | `	pFrame = pVm->pFrame;` |
|  5814688 | 2975 | `	pFrame = VmSkipExceptionFrames(pFrame);` |
|        - | 2976 | `	/* Perform the lookup */` |
|  5814688 | 2977 | `	if( pName == 0 \|\| pName->nByte < 1 ){` |
...
|  5814688 | 2985 | `	pEntry = SyHashGet(&pVm->hSuper,(const void *)pName->zString,pName->nByte);` |
|  5814688 | 2986 | `	if( pEntry == 0 ){` |
|        - | 2987 | `		/* Query the top active frame */` |
|  5814284 | 2988 | `		pEntry = SyHashGet(&pFrame->hVar,(const void *)pName->zString,pName->nByte);` |
|  5814284 | 2989 | `		if( pEntry == 0 ){` |
|   498933 | 2990 | `			char *zName = (char *)pName->zString;` |
|        - | 2991 | `			VmSlot sLocal;` |
|   498933 | 2992 | `			if( !bCreate ){` |
...
|        - | 2998 | `			 */` |
|   497785 | 2999 | `			pObj = PH7_ReserveMemObj(&(*pVm));` |
|   497785 | 3000 | `			if( pObj == 0 ){` |
|      ! 0 | 3001 | `				return 0;` |
|        - | 3002 | `			}` |
|   497785 | 3003 | `			nIdx = pObj->nIdx;` |
|   497785 | 3004 | `			if( bDup ){` |
|        - | 3005 | `				/* Duplicate name */` |
|      520 | 3006 | `				zName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|      520 | 3007 | `				if( zName == 0 ){` |
|      ! 0 | 3008 | `					return 0;` |
|        - | 3009 | `				}` |
|      258 | 3010 | `			}` |
|        - | 3011 | `			/* Link to the top active VM frame */` |
|   497785 | 3012 | `			rc = SyHashInsert(&pFrame->hVar,zName,pName->nByte,SX_INT_TO_PTR(nIdx));` |
|   497785 | 3013 | `			if( rc != SXRET_OK ){` |
...
|      ! 0 | 3018 | `				return 0;` |
|        - | 3019 | `			}` |
|   497785 | 3020 | `			if( pFrame->pParent != 0 ){` |
|        - | 3021 | `				/* Local variable */` |
|   489233 | 3022 | `				sLocal.nIdx = nIdx;` |
|   489233 | 3023 | `				SySetPut(&pFrame->sLocal,(const void *)&sLocal);` |
|   245234 | 3024 | `			}else{` |
|        - | 3025 | `				/* Register in the $GLOBALS array */` |
|     8557 | 3026 | `				VmHashmapRefInsert(pVm->pGlobal,pName->zString,pName->nByte,nIdx);` |
|        - | 3027 | `			}` |
|        - | 3028 | `			/* Install in the reference table */` |
|   497785 | 3029 | `			PH7_VmRefObjInstall(&(*pVm),nIdx,SyHashLastEntry(&pFrame->hVar),0,0);` |
|        - | 3030 | `			/* Save object index */` |
|   497785 | 3031 | `			pObj->nIdx = nIdx;` |
|   249510 | 3032 | `		}else{` |
|        - | 3033 | `			/* Extract variable contents */` |
|  5315356 | 3034 | `			nIdx = (sxu32)SX_PTR_TO_INT(pEntry->pUserData);` |
|  5315356 | 3035 | `			pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|  5315356 | 3036 | `			if( bNullify && pObj ){` |
...
|        - | 4060 | ` */` |
|  1043553 | 4061 | `PH7_PRIVATE VmCallArgMap *VmEffCallArgMap(ph7_vm *pVm, VmInstr *pInstr,` |
|        - | 4062 | `	ph7_value *pArg, sxu32 nActual, VmCallArgMap *pStorage)` |
|        5 | 4063 | `{` |
|  1043558 | 4064 | `	VmCallArgMap *pCompile = (VmCallArgMap *)pInstr->p3;` |
|  1043558 | 4065 | `	if( pInstr->iP2 == 0 ){` |
|  1043276 | 4066 | `		return pCompile; /* no spread: compile map already aligned, nothing captured */` |
|        - | 4067 | `	}` |
...
|      238 | 4289 | `		return SXERR_NOTFOUND;` |
|        - | 4290 | `	}` |
...
|        - | 4408 | ` */` |
|    23808 | 4409 | `PH7_PRIVATE void VmForeachStepUnlink(ph7_foreach_info *pInfo,ph7_foreach_step *pStep)` |
|        5 | 4410 | `{` |
|    23813 | 4411 | `	ph7_foreach_step **apStep = (ph7_foreach_step **)SySetBasePtr(&pInfo->aStep);` |
|    23813 | 4412 | `	sxu32 n = SySetUsed(&pInfo->aStep);` |
|        - | 4413 | `	sxu32 i;` |
|    25989 | 4414 | `	for( i = 0 ; i < n ; ++i ){` |
|    25989 | 4415 | `		if( apStep[i] == pStep ){` |
|    23821 | 4416 | `			for( ; i + 1 < n ; ++i ){` |
|        9 | 4417 | `				apStep[i] = apStep[i + 1];` |
|        5 | 4418 | `			}` |
|    23813 | 4419 | `			(void)SySetPop(&pInfo->aStep);` |
|    23813 | 4420 | `			return;` |
|        - | 4421 | `		}` |
|     1093 | 4422 | `	}` |
|    11909 | 4423 | `}` |
...
|        - | 4442 | ` */` |
|    23574 | 4443 | `PH7_PRIVATE void VmForeachHashmapStepRelease(ph7_vm *pVm,ph7_foreach_info *pInfo,ph7_foreach_step *pStep,int bPop)` |
|        5 | 4444 | `{` |
|    23579 | 4445 | `	ph7_hashmap *pMap = pStep->xIter.pMap;` |
|    23579 | 4446 | `	PH7_HashmapUnregisterForeachStep(pMap,pStep);` |
|    23579 | 4447 | `	if( bPop ){` |
...
|    23579 | 4450 | `		VmForeachStepUnlink(pInfo,pStep);` |
|    11787 | 4451 | `	}` |
|    23579 | 4452 | `	SyMemBackendPoolFree(&pVm->sAllocator,pStep);` |
|    23579 | 4453 | `	PH7_HashmapUnref(pMap);` |
|    23579 | 4454 | `}` |
...
|        - | 4460 | ` */` |
|   137946 | 4461 | `PH7_PRIVATE sxi32 VmLocalExec(ph7_vm *pVm,SySet *pByteCode,ph7_value *pResult,int bReturnPropagates)` |
|        5 | 4462 | `{` |
|        - | 4463 | `	ph7_value *pStack;` |
|        - | 4464 | `	sxu32 nCap;` |
|        - | 4465 | `	sxi32 rc;` |
|        - | 4466 | `	/* Allocate a new operand stack */` |
|   137951 | 4467 | `	pStack = VmNewOperandStack(&(*pVm),SySetUsed(pByteCode));` |
|   137951 | 4468 | `	if( pStack == 0 ){` |
|      ! 0 | 4469 | `		return SXERR_MEM;` |
|        - | 4470 | `	}` |
|   137951 | 4471 | `	nCap = SySetUsed(pByteCode) + VM_STACK_GUARD; /* what VmNewOperandStack handed out */` |
...
|   137951 | 4474 | `	rc = VmByteCodeExec(&(*pVm),(VmInstr *)SySetBasePtr(pByteCode),pStack,-1,&(*pResult),0,FALSE,0,0,bReturnPropagates,0,&pStack,&nCap,nCap);` |
|        - | 4475 | `	/* Free the operand stack */` |
|   137951 | 4476 | `	SyMemBackendFree(&pVm->sAllocator,pStack);` |
|        - | 4477 | `	/* Execution result */` |
|   137951 | 4478 | `	return rc;` |
|    68978 | 4479 | `}` |
|        - | 4480 | `/*` |
...
|        - | 4635 | ` */` |
|     2192 | 4636 | `PH7_PRIVATE sxi32 PH7_VmOutputConsume(` |
|        - | 4637 | `	ph7_vm *pVm,      /* Target VM */` |
|        - | 4638 | `	SyString *pString /* Message to output */` |
|        - | 4639 | `	)` |
|        5 | 4640 | `{` |
|     2197 | 4641 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|     2197 | 4642 | `	sxi32 rc = SXRET_OK;` |
|        - | 4643 | `	/* Call the output consumer */` |
|     2197 | 4644 | `	if( pString->nByte > 0 ){` |
|     2197 | 4645 | `		rc = pCons->xConsumer((const void *)pString->zString,pString->nByte,pCons->pUserData);` |
|     2197 | 4646 | `		VmTrackOutput(pVm, pString->nByte);` |
|     1096 | 4647 | `	}` |
|     2197 | 4648 | `	return rc;` |
|        5 | 4649 | `}` |
|        - | 4650 | `/*` |
...
|        - | 5000 | ` */` |
|   770648 | 5001 | `static ph7_class * VmFilterLoadableClass(ph7_class *pClass,sxi32 iLoadable)` |
|        5 | 5002 | `{` |
|   770653 | 5003 | `	if( !iLoadable ){` |
|   764001 | 5004 | `		return pClass;` |
|        - | 5005 | `	}` |
...
|        - | 5081 | ` */` |
|   770894 | 5082 | `PH7_PRIVATE ph7_class * PH7_VmExtractClass(` |
...
|   770899 | 5098 | `	pEntry = SyHashGet(&pVm->hClass,(const void *)zName,nByte);` |
|   770899 | 5099 | `	if( pEntry == 0 ){` |
...
|        - | 5102 | `	}` |
|   770637 | 5103 | `	pClass = (ph7_class *)pEntry->pUserData;` |
|   770637 | 5104 | `	return VmFilterLoadableClass(pClass,iLoadable);` |
|   385452 | 5105 | `}` |
|        - | 5106 | `/*` |
...
|        - | 5119 | ` */` |
|  4364401 | 5120 | `static VmRefObj * VmNewRefObj(ph7_vm *pVm,sxu32 nIdx)` |
|        5 | 5121 | `{` |
|        - | 5122 | `	VmRefObj *pRef;` |
|        - | 5123 | `	/* Allocate a new instance */` |
|  4364406 | 5124 | `	pRef = (VmRefObj *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmRefObj));` |
|  4364406 | 5125 | `	if( pRef == 0 ){` |
|      ! 0 | 5126 | `		return 0;` |
|        - | 5127 | `	}` |
|        - | 5128 | `	/* Zero the structure */` |
|  4364406 | 5129 | `	SyZero(pRef,sizeof(VmRefObj));` |
|        - | 5130 | `	/* Initialize fields */` |
|  4364406 | 5131 | `	SySetInit(&pRef->aReference,&pVm->sAllocator,sizeof(SyHashEntry *));` |
|  4364406 | 5132 | `	SySetInit(&pRef->aArrEntries,&pVm->sAllocator,sizeof(ph7_hashmap_node *));` |
|  4364406 | 5133 | `	pRef->nIdx = nIdx;` |
|  4364406 | 5134 | `	return pRef;` |
|  2182820 | 5135 | `}` |
|        - | 5136 | `/*` |
|        - | 5137 | ` * Default hash function used by the reference table` |
|        - | 5138 | ` * for lookup/insertion operations.` |
|        - | 5139 | ` */` |
| 23446580 | 5140 | `static sxu32 VmRefHash(sxu32 nIdx)` |
|        5 | 5141 | `{` |
|        - | 5142 | `	/* Calculate the hash based on the memory object index */` |
| 23446585 | 5143 | `	return nIdx ^ (nIdx << 8) ^ (nIdx >> 8);` |
|        5 | 5144 | `}` |
|        - | 5145 | `/*` |
...
|        - | 5155 | ` * extension.` |
|        - | 5156 | ` */` |
| 13558801 | 5157 | `PH7_PRIVATE VmRefObj * VmRefObjExtract(ph7_vm *pVm,sxu32 nObjIdx)` |
|        5 | 5158 | `{` |
|        - | 5159 | `	VmRefObj *pRef;` |
|        - | 5160 | `	sxu32 nBucket;` |
|        - | 5161 | `	/* Point to the appropriate bucket */` |
| 13558806 | 5162 | `	nBucket = VmRefHash(nObjIdx) & (pVm->nRefSize - 1);` |
|        - | 5163 | `	/* Perform the lookup */` |
| 13558806 | 5164 | `	pRef = pVm->apRefObj[nBucket];` |
| 29860172 | 5165 | `	for(;;){` |
| 59721636 | 5166 | `		if( pRef == 0 ){` |
|  4853508 | 5167 | `			break;` |
|        - | 5168 | `		}` |
| 54868133 | 5169 | `		if( pRef->nIdx == nObjIdx ){` |
|        - | 5170 | `			/* Entry found */` |
|  8705303 | 5171 | `			return pRef;` |
|        - | 5172 | `		}` |
|        - | 5173 | `		/* Point to the next entry */` |
| 46162835 | 5174 | `		pRef = pRef->pNextCollide;` |
|        5 | 5175 | `	}` |
|        - | 5176 | `	/* No such entry,return NULL */` |
|  4853508 | 5177 | `	return 0;` |
|  6781249 | 5178 | `}` |
|        - | 5179 | `/*` |
...
|        - | 5187 | ` * extension.` |
|        - | 5188 | ` */` |
|  4364401 | 5189 | `static sxi32 VmRefObjInsert(ph7_vm *pVm,VmRefObj *pRef)` |
|        5 | 5190 | `{` |
|        - | 5191 | `	sxu32 nBucket;` |
|  4364406 | 5192 | `	if( pVm->nRefUsed * 3 >= pVm->nRefSize ){` |
|        - | 5193 | `		VmRefObj **apNew;` |
|        - | 5194 | `		sxu32 nNew;` |
|        - | 5195 | `		/* Allocate a larger table */` |
|    10593 | 5196 | `		nNew = pVm->nRefSize << 1;` |
|    10593 | 5197 | `		apNew = (VmRefObj **)SyMemBackendAlloc(&pVm->sAllocator,sizeof(VmRefObj *) * nNew);` |
|    10593 | 5198 | `		if( apNew ){` |
|    10593 | 5199 | `			VmRefObj *pEntry = pVm->pRefList;` |
|        - | 5200 | `			sxu32 n;` |
|        - | 5201 | `			/* Zero the structure */` |
|    10593 | 5202 | `			SyZero((void *)apNew,nNew * sizeof(VmRefObj *));` |
|        - | 5203 | `			/* Rehash all referenced entries */` |
|  2967065 | 5204 | `			for( n = 0 ; n < pVm->nRefUsed ; ++n ){` |
|        - | 5205 | `				/* Remove old collision links */` |
|  2956477 | 5206 | `				pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|        - | 5207 | `				/* Point to the appropriate bucket */` |
|  2956477 | 5208 | `				nBucket = VmRefHash(pEntry->nIdx) & (nNew - 1);` |
|        - | 5209 | `				/* Insert the entry  */` |
|  2956477 | 5210 | `				pEntry->pNextCollide = apNew[nBucket];` |
|  2956477 | 5211 | `				if( apNew[nBucket] ){` |
|  2306069 | 5212 | `					apNew[nBucket]->pPrevCollide = pEntry;` |
|  1153032 | 5213 | `				}` |
|  2956477 | 5214 | `				apNew[nBucket] = pEntry;` |
|        - | 5215 | `				/* Point to the next entry */` |
|  2956477 | 5216 | `				pEntry = pEntry->pNext;` |
|  1478241 | 5217 | `			}` |
|        - | 5218 | `			/* Release the old table */` |
|    10593 | 5219 | `			SyMemBackendFree(&pVm->sAllocator,pVm->apRefObj);` |
|        - | 5220 | `			/* Install the new one */` |
|    10593 | 5221 | `			pVm->apRefObj = apNew;` |
|    10593 | 5222 | `			pVm->nRefSize = nNew;` |
|     5294 | 5223 | `		}` |
|     5294 | 5224 | `	}` |
|        - | 5225 | `	/* Point to the appropriate bucket */` |
|  4364406 | 5226 | `	nBucket = VmRefHash(pRef->nIdx) & (pVm->nRefSize - 1);` |
|        - | 5227 | `	/* Insert the entry */` |
|  4364406 | 5228 | `	pRef->pNextCollide = pVm->apRefObj[nBucket];` |
|  4364406 | 5229 | `	if( pVm->apRefObj[nBucket] ){` |
|  3359865 | 5230 | `		pVm->apRefObj[nBucket]->pPrevCollide = pRef;` |
|  1680476 | 5231 | `	}` |
|  4364406 | 5232 | `	pVm->apRefObj[nBucket] = pRef;` |
|  4364406 | 5233 | `	MACRO_LD_PUSH(pVm->pRefList,pRef);` |
|  4364406 | 5234 | `	pVm->nRefUsed++;` |
|  4364406 | 5235 | `	return SXRET_OK;` |
|        5 | 5236 | `}` |
|        - | 5237 | `/*` |
...
|        - | 5247 | ` * extension.` |
|        - | 5248 | ` */` |
|  4230437 | 5249 | `PH7_PRIVATE sxi32 VmRefObjUnlink(ph7_vm *pVm,VmRefObj *pRef)` |
|        5 | 5250 | `{` |
|        - | 5251 | `	ph7_hashmap_node **apNode;` |
|        - | 5252 | `	SyHashEntry **apEntry;` |
|        - | 5253 | `	sxu32 n;` |
|        - | 5254 | `	/* Point to the reference table */` |
|  4230442 | 5255 | `	apNode = (ph7_hashmap_node **)SySetBasePtr(&pRef->aArrEntries);` |
|  4230442 | 5256 | `	apEntry = (SyHashEntry **)SySetBasePtr(&pRef->aReference);` |
|        - | 5257 | `	/* Unlink the entry from the reference table */` |
|  4725648 | 5258 | `	for( n = 0 ; n < SySetUsed(&pRef->aReference) ; n++ ){` |
|   495211 | 5259 | `		if( apEntry[n] ){` |
|   489331 | 5260 | `			SyHashDeleteEntry2(apEntry[n]);` |
|   245278 | 5261 | `		}` |
|   248223 | 5262 | `	}` |
|  7950235 | 5263 | `	for(n = 0 ; n < SySetUsed(&pRef->aArrEntries) ; ++n ){` |
|  3719798 | 5264 | `		if( apNode[n] ){` |
|     1380 | 5265 | `			PH7_HashmapUnlinkNode(apNode[n],FALSE);` |
|      688 | 5266 | `		}` |
|  1859901 | 5267 | `	}` |
|  4230442 | 5268 | `	if( pRef->pPrevCollide ){` |
|  1663536 | 5269 | `		pRef->pPrevCollide->pNextCollide = pRef->pNextCollide;` |
|   831857 | 5270 | `	}else{` |
|  2566911 | 5271 | `		pVm->apRefObj[VmRefHash(pRef->nIdx) & (pVm->nRefSize - 1)] = pRef->pNextCollide;` |
|        - | 5272 | `	}` |
|  4230442 | 5273 | `	if( pRef->pNextCollide ){` |
|  2247442 | 5274 | `		pRef->pNextCollide->pPrevCollide = pRef->pPrevCollide;` |
|  1124267 | 5275 | `	}` |
|  4230442 | 5276 | `	MACRO_LD_REMOVE(pVm->pRefList,pRef);` |
|        - | 5277 | `	/* Release the node */` |
|  4230442 | 5278 | `	SySetRelease(&pRef->aReference);` |
|  4230442 | 5279 | `	SySetRelease(&pRef->aArrEntries);` |
|  4230442 | 5280 | `	SyMemBackendPoolFree(&pVm->sAllocator,pRef);` |
|  4230442 | 5281 | `	pVm->nRefUsed--;` |
|  4230442 | 5282 | `	return SXRET_OK;` |
|        5 | 5283 | `}` |
|        - | 5284 | `/*` |
...
|        - | 5291 | ` * extension.` |
|        - | 5292 | ` */` |
|  4411077 | 5293 | `PH7_PRIVATE sxi32 PH7_VmRefObjInstall(` |
...
|        - | 5299 | `	)` |
|        5 | 5300 | `{` |
|  4411082 | 5301 | `	VmFrame *pFrame = pVm->pFrame;` |
|        - | 5302 | `	VmRefObj *pRef;` |
|        - | 5303 | `	/* Check if the referenced object already exists */` |
|  4411082 | 5304 | `	pRef = VmRefObjExtract(&(*pVm),nIdx);` |
|  4411082 | 5305 | `	if( pRef == 0 ){` |
|        - | 5306 | `		/* Create a new entry */` |
|  4364406 | 5307 | `		pRef = VmNewRefObj(&(*pVm),nIdx);` |
|  4364406 | 5308 | `		if( pRef == 0 ){` |
|      ! 0 | 5309 | `			return SXERR_MEM;` |
|        - | 5310 | `		}` |
|  4364406 | 5311 | `		pRef->iFlags = iFlags;` |
|        - | 5312 | `		/* Install the entry */` |
|  4364406 | 5313 | `		VmRefObjInsert(&(*pVm),pRef);` |
|  2182815 | 5314 | `	}` |
|  4411082 | 5315 | `	pFrame = VmSkipExceptionFrames(pFrame);` |
|  4411082 | 5316 | `	if( pFrame->pParent != 0 && pEntry ){` |
|        - | 5317 | `		VmSlot sRef;` |
|        - | 5318 | `		/* Local frame,record referenced entry so that it can` |
|        - | 5319 | `		 * be deleted when we leave this frame.` |
|        - | 5320 | `		 */` |
|   489305 | 5321 | `		sRef.nIdx = nIdx;` |
|   489305 | 5322 | `		sRef.pUserData = pEntry;` |
|   489305 | 5323 | `		if( SXRET_OK != SySetPut(&pFrame->sRef,(const void *)&sRef)) {` |
|      ! 0 | 5324 | `			pEntry = 0; /* Do not record this entry */` |
|      ! 0 | 5325 | `		}` |
|   245265 | 5326 | `	}` |
|  4411082 | 5327 | `	if( pEntry ){` |
|        - | 5328 | `		/* Address of the hash-entry */` |
|   535723 | 5329 | `		SySetPut(&pRef->aReference,(const void *)&pEntry);` |
|   268474 | 5330 | `	}` |
|  4411082 | 5331 | `	if( pMapEntry ){` |
|        - | 5332 | `		/* Address of the hashmap node [i.e: Array entry] */` |
|  3821946 | 5333 | `		SySetPut(&pRef->aArrEntries,(const void *)&pMapEntry);` |
|  1910970 | 5334 | `	}` |
|  4411082 | 5335 | `	return SXRET_OK;` |
|  2206158 | 5336 | `}` |
|        - | 5337 | `/*` |
...
|        - | 5344 | ` * extension.` |
|        - | 5345 | ` */` |
|  4201807 | 5346 | `PH7_PRIVATE sxi32 PH7_VmRefObjRemove(` |
...
|  4201812 | 5356 | `	pRef = VmRefObjExtract(&(*pVm),nIdx);` |
|  4201812 | 5357 | `	if( pRef == 0 ){` |
|        - | 5358 | `		/* Not such entry */` |
|   489107 | 5359 | `		return SXERR_NOTFOUND;` |
|        - | 5360 | `	}` |
|        - | 5361 | `	/* Remove the desired entry */` |
|  3712710 | 5362 | `	if( pEntry ){` |
...
|       95 | 5375 | `		}` |
|       41 | 5376 | `	}` |
|  3712710 | 5377 | `	if( pMapEntry ){` |
|        - | 5378 | `		ph7_hashmap_node **apNode;` |
|  3712628 | 5379 | `		apNode = (ph7_hashmap_node **)SySetBasePtr(&pRef->aArrEntries);` |
|  7425515 | 5380 | `		for(n = 0 ; n < SySetUsed(&pRef->aArrEntries) ; n++ ){` |
|  3712892 | 5381 | `			if( apNode[n] == pMapEntry ){` |
|        - | 5382 | `				/* nullify the entry */` |
|  3712628 | 5383 | `				apNode[n] = 0;` |
|  1856311 | 5384 | `			}` |
|  1856448 | 5385 | `		}` |
|  1856311 | 5386 | `	}` |
|  3712710 | 5387 | `	return SXRET_OK;` |
|  2101523 | 5388 | `}` |
...
|        - | 5397 | ` */` |
|    30196 | 5398 | `PH7_PRIVATE const ph7_io_stream * PH7_VmGetStreamDevice(` |
...
|    30201 | 5410 | `	zNext = zCur = zIn = *pzDevice;` |
|    30201 | 5411 | `	zEnd = &zIn[nByte];` |
|  1914642 | 5412 | `	while( zIn < zEnd ){` |
|  1884476 | 5413 | `		if( zIn < &zEnd[-3]/*://*/ && zIn[0] == ':' && zIn[1] == '/' && zIn[2] == '/' ){` |
|        - | 5414 | `			/* Got one */` |
...
|  1884446 | 5419 | `		zIn++;` |
|        5 | 5420 | `	}` |
|    30201 | 5421 | `	if( zIn >= zEnd ){` |
|        - | 5422 | `		/* No such scheme,return the default stream */` |
|    30171 | 5423 | `		return pVm->pDefStream;` |
|        - | 5424 | `	}` |
