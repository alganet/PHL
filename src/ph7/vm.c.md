...
|        - |   75 | ` */` |
|  1280829 |   76 | `PH7_PRIVATE sxi32 VmIsUnorderedCmp(ph7_value *pLeft,ph7_value *pRight)` |
|        5 |   77 | `{` |
|  1280834 |   78 | `	if( (pLeft->iFlags & MEMOBJ_REAL) && PH7_IS_NAN(pLeft->rVal) ){` |
|       40 |   79 | `		return TRUE;` |
|        - |   80 | `	}` |
|  1280796 |   81 | `	if( (pRight->iFlags & MEMOBJ_REAL) && PH7_IS_NAN(pRight->rVal) ){` |
|       11 |   82 | `		return TRUE;` |
|        - |   83 | `	}` |
|  1280786 |   84 | `	return FALSE;` |
|   640932 |   85 | `}` |
|        - |   86 | `/*` |
...
|  2225189 |  293 | `	rc = PH7_NewForeignFunction(&(*pVm),&(*pName),xFunc,pUserData,&pFunc);` |
|  2225189 |  294 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  295 | `		return rc;` |
|        - |  296 | `	}` |
|        - |  297 | `	/* Install the function in the corresponding hashtable */` |
|  2225189 |  298 | `	rc = SyHashInsert(&pVm->hHostFunction,SyStringData(&pFunc->sName),pName->nByte,pFunc);` |
|  2225189 |  299 | `	if( rc != SXRET_OK ){` |
...
|  2225189 |  305 | `	return SXRET_OK;` |
|  1114301 |  306 | `}` |
|        - |  307 | `/*` |
|        - |  308 | ` * Initialize a VM function.` |
|        - |  309 | ` */` |
|  3415428 |  310 | `PH7_PRIVATE sxi32 PH7_VmInitFuncState(` |
...
|  3415433 |  320 | `	SyZero(pFunc,sizeof(ph7_vm_func));` |
|        - |  321 | `	/* Initialize structure fields */` |
|        - |  322 | `	/* Arguments container */` |
|  3415433 |  323 | `	SySetInit(&pFunc->aArgs,&pVm->sAllocator,sizeof(ph7_vm_func_arg));` |
|        - |  324 | `	/* Static variable container */` |
|  3415433 |  325 | `	SySetInit(&pFunc->aStatic,&pVm->sAllocator,sizeof(ph7_vm_func_static_var));` |
|        - |  326 | `	/* Bytecode container */` |
|  3415433 |  327 | `	SySetInit(&pFunc->aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|        - |  328 | `    /* Preallocate some instruction slots */` |
|  3415433 |  329 | `	SySetAlloc(&pFunc->aByteCode,0x10);` |
|        - |  330 | `	/* Closure environment */` |
|  3415433 |  331 | `	SySetInit(&pFunc->aClosureEnv,&pVm->sAllocator,sizeof(ph7_vm_func_closure_env));` |
|        - |  332 | `	/* Return-type union alternatives (empty unless declared as a union) */` |
|  3415433 |  333 | `	SySetInit(&pFunc->aReturnUnion,&pVm->sAllocator,sizeof(ph7_type_alt));` |
|        - |  334 | `	/* Declared #[...] attributes */` |
|  3415433 |  335 | `	SySetInit(&pFunc->aAttrs,&pVm->sAllocator,sizeof(ph7_attribute));` |
|  3415433 |  336 | `	pFunc->iFlags = iFlags;` |
|  3415433 |  337 | `	pFunc->pUserData = pUserData;` |
...
|  3415433 |  340 | `	pFunc->bStrictTypes = (sxu8)(pVm->sCodeGen.bStrictTypes ? 1 : 0);` |
|  3415433 |  341 | `	if( pVm->bCompilingBuiltin ){` |
|        - |  342 | `		/* Defined by an embedded builtin chunk: internal, no defining file */` |
|  3410885 |  343 | `		pFunc->iFlags \|= VM_FUNC_INTERNAL;` |
|  1705445 |  344 | `	}else{` |
...
|     4553 |  348 | `		SyString *pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|     4553 |  349 | `		if( pFile ){` |
|     4553 |  350 | `			SyStringDupPtr(&pFunc->sFile,pFile);` |
|     2274 |  351 | `		}` |
|        - |  352 | `	}` |
|  3415433 |  353 | `	SyStringInitFromBuf(&pFunc->sName,zName,nByte);` |
|  3415433 |  354 | `	return SXRET_OK;` |
|        5 |  355 | `}` |
|        - |  356 | `/*` |
...
|        - |  363 | ` */` |
|  5800592 |  364 | `PH7_PRIVATE sxi32 PH7_VmInstallUserFunction(` |
...
|        - |  371 | `	sxi32 rc;` |
|  5800597 |  372 | `	if( pName == 0 ){` |
|        - |  373 | `		/* Use the built-in name */` |
|   521931 |  374 | `		pName = &pFunc->sName;` |
|   260963 |  375 | `	}` |
|        - |  376 | `	/* Check for duplicates (functions with the same name) first */` |
|  5800597 |  377 | `	pEntry = SyHashGet(&pVm->hFunction,pName->zString,pName->nByte);` |
|  5800597 |  378 | `	if( pEntry ){` |
|  2858569 |  379 | `		ph7_vm_func *pLink = (ph7_vm_func *)pEntry->pUserData;` |
|  2858569 |  380 | `		if( pLink != pFunc ){` |
|        - |  381 | `			/* Link */` |
|       35 |  382 | `			pFunc->pNextName = pLink;` |
|       35 |  383 | `			pEntry->pUserData = pFunc;` |
|       16 |  384 | `		}` |
|  2858569 |  385 | `		return SXRET_OK;` |
|        - |  386 | `	}` |
|        - |  387 | `	/* First time seen */` |
|  2942033 |  388 | `	pFunc->pNextName = 0;` |
|  2942033 |  389 | `	rc = SyHashInsert(&pVm->hFunction,pName->zString,pName->nByte,pFunc);` |
|  2942033 |  390 | `	return rc;` |
|  2900301 |  391 | `}` |
|        - |  392 | `/*` |
|        - |  393 | ` * Install a user defined class in the corresponding VM container.` |
|        - |  394 | ` */` |
|   521530 |  395 | `PH7_PRIVATE sxi32 PH7_VmInstallClass(` |
|        - |  396 | `	ph7_vm *pVm,      /* Target VM  */` |
|        - |  397 | `	ph7_class *pClass /* Target Class */` |
|        - |  398 | `	)` |
|        5 |  399 | `{` |
|   521535 |  400 | `	SyString *pName = &pClass->sName;` |
|        - |  401 | `	SyHashEntry *pEntry;` |
|        - |  402 | `	sxi32 rc;` |
|        - |  403 | `	/* Check for duplicates */` |
|   521535 |  404 | `	pEntry = SyHashGet(&pVm->hClass,(const void *)pName->zString,pName->nByte);` |
|   521535 |  405 | `	if( pEntry ){` |
...
|        - |  411 | `	}` |
|   521533 |  412 | `	pClass->pNextName = 0;` |
|        - |  413 | `	/* Perform a simple hashtable insertion */` |
|   521533 |  414 | `	rc = SyHashInsert(&pVm->hClass,(const void *)pName->zString,pName->nByte,pClass);` |
|   521533 |  415 | `	return rc;` |
|   260770 |  416 | `}` |
|        - |  417 | `/*` |
|        - |  418 | ` * Instruction builder interface.` |
|        - |  419 | ` */` |
| 98298856 |  420 | `PH7_PRIVATE sxi32 PH7_VmEmitInstr(` |
...
|        5 |  428 | `{` |
|        - |  429 | `	VmInstr sInstr;` |
| 98298861 |  430 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|        - |  431 | `	sxi32 rc;` |
|        - |  432 | `	/* Fill the VM instruction */` |
| 98298861 |  433 | `	sInstr.iOp = (sxu8)iOp;` |
| 98298861 |  434 | `	sInstr.iP1 = iP1;` |
| 98298861 |  435 | `	sInstr.iP2 = iP2;` |
| 98298861 |  436 | `	sInstr.p3  = p3;` |
...
| 98298861 |  441 | `	sInstr.nLine = 0;` |
| 98298861 |  442 | `	if( pGen->pIn && pGen->pEnd && pGen->pIn < pGen->pEnd ){` |
| 41880343 |  443 | `		sInstr.nLine = pGen->pIn->nLine;` |
| 77358692 |  444 | `	}else if( pGen->pIn && pGen->pEnd && pGen->pIn >= pGen->pEnd && pGen->pEnd > (SyToken *)0 ){` |
|        - |  445 | `		/* Past the end (statement tail): blame the last real token. */` |
| 56203987 |  446 | `		sInstr.nLine = pGen->pEnd[-1].nLine;` |
| 28101991 |  447 | `	}` |
| 98298861 |  448 | `	if( pIndex ){` |
|        - |  449 | `		/* Instruction index in the bytecode array */` |
|  6654271 |  450 | `		*pIndex = SySetUsed(pVm->pByteContainer);` |
|  3327133 |  451 | `	}` |
|        - |  452 | `	/* Finally,record the instruction */` |
| 98298861 |  453 | `	rc = SySetPut(pVm->pByteContainer,(const void *)&sInstr);` |
| 98298861 |  454 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  455 | `		PH7_GenCompileError(&pVm->sCodeGen,E_ERROR,1,"Fatal,Cannot emit instruction due to a memory failure");` |
|        - |  456 | `		/* Fall throw */` |
|      ! 0 |  457 | `	}` |
| 98298861 |  458 | `	return rc;` |
|        5 |  459 | `}` |
|        - |  460 | `/*` |
|        - |  461 | ` * Swap the current bytecode container with the given one.` |
|        - |  462 | ` */` |
|  9775540 |  463 | `PH7_PRIVATE sxi32 PH7_VmSetByteCodeContainer(ph7_vm *pVm,SySet *pContainer)` |
|        5 |  464 | `{` |
|  9775545 |  465 | `	if( pContainer == 0 ){` |
|        - |  466 | `		/* Point to the default container */` |
|      ! 0 |  467 | `		pVm->pByteContainer = &pVm->aByteCode;` |
|      ! 0 |  468 | `	}else{` |
|        - |  469 | `		/* Change container */` |
|  9775545 |  470 | `		pVm->pByteContainer = &(*pContainer);` |
|        - |  471 | `	}` |
|  9775545 |  472 | `	return SXRET_OK;` |
|        5 |  473 | `}` |
|        - |  474 | `/*` |
|        - |  475 | ` * Return the current bytecode container.` |
|        - |  476 | ` */` |
|  4887770 |  477 | `PH7_PRIVATE SySet * PH7_VmGetByteCodeContainer(ph7_vm *pVm)` |
|        5 |  478 | `{` |
|  4887775 |  479 | `	return pVm->pByteContainer;` |
|        5 |  480 | `}` |
|        - |  481 | `/*` |
|        - |  482 | ` * Extract the VM instruction rooted at nIndex.` |
|        - |  483 | ` */` |
|  6860170 |  484 | `PH7_PRIVATE VmInstr * PH7_VmGetInstr(ph7_vm *pVm,sxu32 nIndex)` |
|        5 |  485 | `{` |
|        - |  486 | `	VmInstr *pInstr;` |
|  6860175 |  487 | `	pInstr = (VmInstr *)SySetAt(pVm->pByteContainer,nIndex);` |
|  6860175 |  488 | `	return pInstr;` |
|        5 |  489 | `}` |
|        - |  490 | `/*` |
|        - |  491 | ` * Return the total number of VM instructions recorded so far.` |
|        - |  492 | ` */` |
| 54132244 |  493 | `PH7_PRIVATE sxu32 PH7_VmInstrLength(ph7_vm *pVm)` |
|        5 |  494 | `{` |
| 54132249 |  495 | `	return SySetUsed(pVm->pByteContainer);` |
|        5 |  496 | `}` |
|        - |  497 | `/*` |
|        - |  498 | ` * Pop the last VM instruction.` |
|        - |  499 | ` */` |
|  5394946 |  500 | `PH7_PRIVATE VmInstr * PH7_VmPopInstr(ph7_vm *pVm)` |
|        5 |  501 | `{` |
|  5394951 |  502 | `	return (VmInstr *)SySetPop(pVm->pByteContainer);` |
|        5 |  503 | `}` |
|        - |  504 | `/*` |
|        - |  505 | ` * Peek the last VM instruction.` |
|        - |  506 | ` */` |
| 20436132 |  507 | `PH7_PRIVATE VmInstr * PH7_VmPeekInstr(ph7_vm *pVm)` |
|        5 |  508 | `{` |
| 20436137 |  509 | `	return (VmInstr *)SySetPeek(pVm->pByteContainer);` |
|        5 |  510 | `}` |
|  1711028 |  511 | `PH7_PRIVATE VmInstr * PH7_VmPeekNextInstr(ph7_vm *pVm)` |
|        5 |  512 | `{` |
|        - |  513 | `	VmInstr *aInstr;` |
|        - |  514 | `	sxu32 n;` |
|  1711033 |  515 | `	n = SySetUsed(pVm->pByteContainer);` |
|  1711033 |  516 | `	if( n < 2 ){` |
|      ! 0 |  517 | `		return 0;` |
|        - |  518 | `	}` |
|  1711033 |  519 | `	aInstr = (VmInstr *)SySetBasePtr(pVm->pByteContainer);` |
|  1711033 |  520 | `	return &aInstr[n - 2];` |
|   855519 |  521 | `}` |
|        - |  522 | `/*` |
...
|        - |  630 | ` */` |
|   109969 |  631 | `PH7_PRIVATE void VmDropResumeTarget(ph7_vm *pVm, VmFrame *pFrame)` |
|        5 |  632 | `{` |
|   109974 |  633 | `	if( pVm->pResumeFrame == pFrame ){` |
...
|        - |  639 | ` */` |
|   109117 |  640 | `PH7_PRIVATE void VmLeaveFrame(ph7_vm *pVm)` |
|        5 |  641 | `{` |
|   109122 |  642 | `		VmFrame *pCurFrame = pVm->pFrame;` |
|   109122 |  643 | `	if( pCurFrame ){` |
|        - |  644 | `		/* Unlink from the list of active VM frame */` |
|   109122 |  645 | `		pVm->pFrame = pCurFrame->pParent;` |
|   109122 |  646 | `		if( pCurFrame->pParent && (pCurFrame->iFlags & VM_FRAME_EXCEPTION) == 0 ){` |
|        - |  647 | `			VmSlot  *aSlot;` |
|        - |  648 | `			sxu32 n;` |
|        - |  649 | `			/* Restore local variable to the free pool so that they can be reused again */` |
|   104258 |  650 | `			aSlot = (VmSlot *)SySetBasePtr(&pCurFrame->sLocal);` |
|   592468 |  651 | `			for(n = 0 ; n < SySetUsed(&pCurFrame->sLocal) ; ++n ){` |
|        - |  652 | `				/* Unset the local variable */` |
|   488215 |  653 | `				PH7_VmUnsetMemObj(&(*pVm),aSlot[n].nIdx,FALSE);` |
|   244725 |  654 | `			}` |
|        - |  655 | `			/* Remove local reference */` |
|   104258 |  656 | `			aSlot = (VmSlot *)SySetBasePtr(&pCurFrame->sRef);` |
|   592552 |  657 | `			for(n = 0 ; n < SySetUsed(&pCurFrame->sRef) ; ++n ){` |
|   488299 |  658 | `				PH7_VmRefObjRemove(&(*pVm),aSlot[n].nIdx,(SyHashEntry *)aSlot[n].pUserData,0);` |
|   244767 |  659 | `			}` |
|    52229 |  660 | `		}` |
|        - |  661 | `		/* Release internal containers */` |
|   109122 |  662 | `		SyHashRelease(&pCurFrame->hVar);` |
|   109122 |  663 | `		SySetRelease(&pCurFrame->sArg);` |
|   109122 |  664 | `		SySetRelease(&pCurFrame->sLocal);` |
|   109122 |  665 | `		SySetRelease(&pCurFrame->sRef);` |
...
|   109122 |  669 | `		PH7_MemObjRelease(&pCurFrame->sRet);` |
|        - |  670 | `		/* Drop a recorded in-place-catch resume target pointing at this frame (ROOT B). */` |
|   109122 |  671 | `		VmDropResumeTarget(pVm,pCurFrame);` |
|        - |  672 | `		/* Release the whole structure */` |
|   109122 |  673 | `		SyMemBackendPoolFree(&pVm->sAllocator,pCurFrame);` |
|    54661 |  674 | `	}` |
|   109122 |  675 | `}` |
|        - |  676 | `/*` |
...
|        - |  727 | ` */` |
| 10550722 |  728 | `PH7_PRIVATE VmFrame * VmSkipExceptionFrames(VmFrame *pFrame)` |
|        5 |  729 | `{` |
| 10576093 |  730 | `	while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|    25371 |  731 | `		pFrame = pFrame->pParent;` |
|        5 |  732 | `	}` |
| 10550727 |  733 | `	return pFrame;` |
|        5 |  734 | `}` |
|        - |  735 | `/*` |
...
|        - |  757 | ` */` |
|     2956 |  758 | `PH7_PRIVATE int VmRecordedResume(ph7_vm *pVm,sxi32 *pResumePc,VmFrame *pEntryFrame,VmInstr *aInstr)` |
|        5 |  759 | `{` |
|     2961 |  760 | `	if( pVm->pResumeFrame == 0 ){` |
...
|     2942 |  771 | `	if( VmSkipExceptionFrames(pEntryFrame) != pVm->pResumeFrame` |
|     2467 |  772 | `	 \|\| (void *)aInstr != pVm->pResumeInstr` |
|     1984 |  773 | `	 \|\| pVm->iResumePc == 0 ){` |
...
|     3355 |  802 | `	while( pVm->pFrame != pEntryFrame` |
|     3827 |  803 | `	    && !((pVm->pFrame->iFlags & VM_FRAME_EXCEPTION)` |
|     2432 |  804 | `	         && pVm->pFrame->iExceptionJump == pVm->iResumePc) ){` |
|      817 |  805 | `		VmLeaveFrame(&(*pVm));` |
|        5 |  806 | `	}` |
|     1971 |  807 | `	*pResumePc = (sxi32)pVm->iResumePc - 1;` |
|     1971 |  808 | `	pVm->pResumeFrame = 0; /* one-shot consume */` |
...
|     1971 |  812 | `	pVm->nBoundaryRc = 0;` |
|     1971 |  813 | `	return TRUE;` |
|     1483 |  814 | `}` |
|        - |  815 | `/*` |
...
|        - |  844 | ` * activation.` |
|        - |  845 | ` */` |
|     2702 |  846 | `PH7_PRIVATE ph7_exception * VmExcActivate(ph7_vm *pVm,ph7_exception *pCompiled)` |
|        5 |  847 | `{` |
|     2707 |  848 | `	ph7_exception *pClone = (ph7_exception *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_exception));` |
|     2707 |  849 | `	if( pClone == 0 ){` |
|      ! 0 |  850 | `		return 0;` |
|        - |  851 | `	}` |
|     2707 |  852 | `	*pClone = *pCompiled;` |
|     2707 |  853 | `	pClone->pCompiled = pCompiled;` |
|     2707 |  854 | `	pClone->iFinallyDone = 0;` |
|     2707 |  855 | `	pClone->iInCatch = 0;` |
|     2707 |  856 | `	pClone->pInflight = 0;` |
|     2707 |  857 | `	pClone->pFrame = 0;` |
|     2707 |  858 | `	return pClone;` |
|     1356 |  859 | `}` |
|     5328 |  860 | `PH7_PRIVATE void VmExcRelease(ph7_vm *pVm,ph7_exception *pExc)` |
|        5 |  861 | `{` |
|     5333 |  862 | `	if( pExc && pExc->pCompiled ){` |
...
|     2695 |  867 | `		if( pExc->pInflight ){` |
|      ! 0 |  868 | `			PH7_ClassInstanceUnref(pExc->pInflight);` |
|      ! 0 |  869 | `			pExc->pInflight = 0;` |
|      ! 0 |  870 | `		}` |
|     2695 |  871 | `		SyMemBackendPoolFree(&pVm->sAllocator,pExc);` |
|     1345 |  872 | `	}` |
|     5333 |  873 | `}` |
|        - |  874 | `/*` |
...
|      ! 0 |  913 | `	return 0;` |
|       38 |  914 | `}` |
|   257431 |  915 | `PH7_PRIVATE sxi32 VmDrainFinally(ph7_vm *pVm, sxu32 nExceptionBase)` |
|        5 |  916 | `{` |
|        - |  917 | `	sxu32 nUsed;` |
|   257436 |  918 | `	sxi32 rcOut = SXRET_OK;` |
|   257500 |  919 | `	while( (nUsed = SySetUsed(&pVm->aException)) > nExceptionBase ){` |
...
|        - |  956 | ` */` |
|   154772 |  957 | `PH7_PRIVATE void VmClearFrameReturn(VmFrame *pFrame)` |
|        5 |  958 | `{` |
|   154777 |  959 | `	pFrame->bHasRet = 0;` |
|   154777 |  960 | `	PH7_MemObjRelease(&pFrame->sRet);` |
|   154777 |  961 | `}` |
|        - |  962 | `/*` |
...
|        - | 1110 | ` */` |
|    34824 | 1111 | `PH7_PRIVATE sxi32 VmLocalExecIntoObj(ph7_vm *pVm,SySet *pByteCode,ph7_value **ppMemObj,int bReturnPropagates)` |
|        5 | 1112 | `{` |
|        - | 1113 | `	ph7_value sVal;` |
|    34829 | 1114 | `	sxu32 nIdx = (*ppMemObj)->nIdx;` |
|        - | 1115 | `	sxi32 rc;` |
|    34829 | 1116 | `	PH7_MemObjInit(&(*pVm),&sVal);` |
|    34829 | 1117 | `	rc = VmLocalExec(&(*pVm),pByteCode,&sVal,bReturnPropagates);` |
|        - | 1118 | `	/* aMemObj may have moved during the eval — re-fetch by the reserved index. */` |
|    34829 | 1119 | `	*ppMemObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|    34829 | 1120 | `	if( *ppMemObj ){` |
|    34829 | 1121 | `		PH7_MemObjStore(&sVal,*ppMemObj);` |
|    17412 | 1122 | `	}` |
|    34829 | 1123 | `	PH7_MemObjRelease(&sVal);` |
|    34829 | 1124 | `	return rc;` |
|        5 | 1125 | `}` |
|        - | 1126 | `/*` |
...
|        - | 1138 | ` */` |
|   703204 | 1139 | `static sxi32 VmMountUserClassAttrs(` |
...
|   703209 | 1147 | `	SyHashResetLoopCursor(&pClass->hAttr);` |
|        - | 1148 | `	/* Process only static and constant attribute */` |
|  2861687 | 1149 | `	while( (pEntry = SyHashGetNextEntry(&pClass->hAttr)) != 0 ){` |
|        - | 1150 | `		/* Extract the current attribute */` |
|  2158487 | 1151 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|  2158482 | 1152 | `		if( (pAttr->iFlags & PH7_CLASS_ATTR_CONSTANT)` |
|  1422458 | 1153 | `		 && ((pAttr->iFlags & PH7_CLASS_ATTR_TYPED) == 0` |
|   343660 | 1154 | `			\|\| (pAttr->iFlags & PH7_CLASS_ATTR_ENUMCASE) != 0) ){` |
...
|   685533 | 1164 | `			continue;` |
|        - | 1165 | `		}` |
|  1472959 | 1166 | `		if( pAttr->iFlags & (PH7_CLASS_ATTR_STATIC\|PH7_CLASS_ATTR_CONSTANT) ){` |
|        - | 1167 | `			ph7_value *pMemObj;` |
|    24859 | 1168 | `			if( pAttr->nIdx != SXU32_HIGH ){` |
...
|    11991 | 1248 | `		}` |
|        5 | 1249 | `	}` |
|   703205 | 1250 | `	return SXRET_OK;` |
|   351607 | 1251 | `}` |
|   702128 | 1252 | `PH7_PRIVATE sxi32 VmMountUserClass(` |
...
|   702133 | 1261 | `	rc = VmMountUserClassAttrs(&(*pVm),pClass);` |
|   702133 | 1262 | `	if( rc != SXRET_OK ){` |
|        6 | 1263 | `		return rc;` |
|        - | 1264 | `	}` |
|        - | 1265 | `	/* Install class methods */` |
|   702129 | 1266 | `	if( pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|        - | 1267 | `		/* Do not mount interface/trait methods since they are not directly invocable.` |
|        - | 1268 | `		 */` |
|   312041 | 1269 | `		return SXRET_OK;` |
|        - | 1270 | `	}` |
|        - | 1271 | `	/* Create constructor alias if not yet done */` |
|   390093 | 1272 | `	if( SyHashGet(&pClass->hMethod,"__construct",sizeof("__construct")-1) == 0 ){` |
|        - | 1273 | `		/* User constructor with the same base class name */` |
|    59419 | 1274 | `		pEntry = SyHashGet(&pClass->hMethod,SyStringData(&pClass->sName),SyStringLength(&pClass->sName));` |
|    59419 | 1275 | `		if( pEntry ){` |
...
|   390093 | 1282 | `	SyHashResetLoopCursor(&pClass->hMethod);` |
|  5874049 | 1283 | `	while((pEntry = SyHashGetNextEntry(&pClass->hMethod)) != 0 ){` |
|  5288917 | 1284 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|  5288917 | 1285 | `		if( (pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT) == 0 ){` |
|  5278671 | 1286 | `			rc = PH7_VmInstallUserFunction(&(*pVm),&pMeth->sFunc,&pMeth->sVmName);` |
|  5278671 | 1287 | `			if( rc != SXRET_OK ){` |
|      ! 0 | 1288 | `				return rc;` |
|        - | 1289 | `			}` |
|  2639333 | 1290 | `		}` |
|        5 | 1291 | `	}` |
|        - | 1292 | `	/* Mark class as mounted to avoid redundant mounting */` |
|   390093 | 1293 | `	pClass->bMounted = TRUE;` |
|   390093 | 1294 | `	return SXRET_OK;` |
|   351069 | 1295 | `}` |
|        - | 1296 | `/*` |
|        - | 1297 | ` * Allocate a private frame for attributes of the given` |
|        - | 1298 | ` * class instance (Object in the PHP jargon).` |
|        - | 1299 | ` */` |
|     8710 | 1300 | `PH7_PRIVATE sxi32 PH7_VmCreateClassInstanceFrame(` |
|        - | 1301 | `	ph7_vm *pVm, /* Target VM */` |
|        - | 1302 | `	ph7_class_instance *pObj /* Class instance */` |
|        - | 1303 | `	)` |
|        5 | 1304 | `{` |
|     8715 | 1305 | `	ph7_class *pClass = pObj->pClass;` |
...
|     8715 | 1310 | `	SyHashResetLoopCursor(&pClass->hAttr);` |
|    45817 | 1311 | `	while( (pEntry = SyHashGetNextEntry(&pClass->hAttr)) != 0 ){` |
|        - | 1312 | `		VmClassAttr *pVmAttr;` |
|        - | 1313 | `		/* Extract the current attribute */` |
|    37107 | 1314 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|    37107 | 1315 | `		pVmAttr = (VmClassAttr *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmClassAttr));` |
|    37107 | 1316 | `		if( pVmAttr == 0 ){` |
|      ! 0 | 1317 | `			return SXERR_MEM;` |
|        - | 1318 | `		}` |
|    37107 | 1319 | `		pVmAttr->pAttr = pAttr;` |
|    37107 | 1320 | `		if( (pAttr->iFlags & (PH7_CLASS_ATTR_CONSTANT\|PH7_CLASS_ATTR_STATIC)) == 0 ){` |
|        - | 1321 | `			ph7_value *pMemObj;` |
|        - | 1322 | `			/* Reserve a memory object for this attribute */` |
|    29049 | 1323 | `			pMemObj = PH7_ReserveMemObj(&(*pVm));` |
|    29049 | 1324 | `			if( pMemObj == 0 ){` |
|      ! 0 | 1325 | `				SyMemBackendPoolFree(&pVm->sAllocator,pVmAttr);` |
|      ! 0 | 1326 | `				return SXERR_MEM;` |
|        - | 1327 | `			}` |
|    29049 | 1328 | `			pVmAttr->nIdx = pMemObj->nIdx;` |
|    29049 | 1329 | `			pVmAttr->iState = 0;` |
|    29049 | 1330 | `			pVmAttr->pOwner = pClass;` |
|    29049 | 1331 | `			if( SySetUsed(&pAttr->aByteCode) > 0 ){` |
...
|    10639 | 1335 | `				ph7_class *pSaveCtx = pVm->pConstEvalClass;` |
|    10639 | 1336 | `				pVm->pConstEvalClass = pAttr->pDeclClass ? pAttr->pDeclClass : pClass;` |
|    10639 | 1337 | `				VmLocalExecIntoObj(&(*pVm),&pAttr->aByteCode,&pMemObj,FALSE);` |
|    10639 | 1338 | `				pVm->pConstEvalClass = pSaveCtx;` |
|    23732 | 1339 | `			}else if( pAttr->iFlags & PH7_CLASS_ATTR_TYPED ){` |
...
|      199 | 1343 | `			}` |
|    29049 | 1344 | `			rc = SyHashInsertTail(&pObj->hAttr,SyStringData(&pAttr->sName),SyStringLength(&pAttr->sName),pVmAttr);` |
|    29049 | 1345 | `			if( rc != SXRET_OK ){` |
|        - | 1346 | `				VmSlot sSlot;` |
...
|    29049 | 1355 | `			PH7_VmRefObjInstall(&(*pVm),pMemObj->nIdx,0,0,VM_REF_IDX_KEEP);` |
...
|    29049 | 1359 | `			if( pAttr->iFlags & PH7_CLASS_ATTR_TYPED ){` |
...
|        - | 1556 | ` */` |
|  8561404 | 1557 | `PH7_PRIVATE ph7_value * PH7_ReserveConstObj(ph7_vm *pVm,sxu32 *pIndex)` |
|        5 | 1558 | `{` |
|        - | 1559 | `	ph7_value *pObj;` |
|        - | 1560 | `	sxi32 rc;` |
|  8561409 | 1561 | `	if( pIndex ){` |
|        - | 1562 | `		/* Object index in the object table */` |
|  8549781 | 1563 | `		*pIndex = SySetUsed(&pVm->aLitObj);` |
|  4274888 | 1564 | `	}` |
|        - | 1565 | `	/* Reserve a slot for the new object */` |
|  8561409 | 1566 | `	rc = SySetPut(&pVm->aLitObj,(const void *)zDummy);` |
|  8561409 | 1567 | `	if( rc != SXRET_OK ){` |
...
|      ! 0 | 1571 | `		return 0;` |
|        - | 1572 | `	}` |
|  8561409 | 1573 | `	pObj = (ph7_value *)SySetPeek(&pVm->aLitObj);` |
|  8561409 | 1574 | `	return pObj;` |
|  4280707 | 1575 | `}` |
|        - | 1576 | `/*` |
|        - | 1577 | ` * Reserve a memory object.` |
|        - | 1578 | ` * Return a pointer to the raw ph7_value on success. NULL on failure.` |
|        - | 1579 | ` */` |
|  2237598 | 1580 | `PH7_PRIVATE ph7_value * VmReserveMemObj(ph7_vm *pVm,sxu32 *pIndex)` |
|        5 | 1581 | `{` |
|        - | 1582 | `	ph7_value *pObj;` |
|        - | 1583 | `	sxi32 rc;` |
|  2237603 | 1584 | `	if( pIndex ){` |
|        - | 1585 | `		/* Object index in the object table */` |
|  2237603 | 1586 | `		*pIndex = SySetUsed(&pVm->aMemObj);` |
|  1118799 | 1587 | `	}` |
|        - | 1588 | `	/* Reserve a slot for the new object */` |
|  2237603 | 1589 | `	rc = SySetPut(&pVm->aMemObj,(const void *)zDummy);` |
|  2237603 | 1590 | `	if( rc != SXRET_OK ){` |
...
|      ! 0 | 1594 | `		return 0;` |
|        - | 1595 | `	}` |
|  2237603 | 1596 | `	pObj = (ph7_value *)SySetPeek(&pVm->aMemObj);` |
|  2237603 | 1597 | `	return pObj;` |
|  1118804 | 1598 | `}` |
...
|        - | 1611 | ` */` |
|     3876 | 1612 | `PH7_PRIVATE sxi32 PH7_VmInit(` |
...
|     3881 | 1620 | `	SyZero(pVm,sizeof(ph7_vm));` |
|        - | 1621 | `	/* Initialize VM fields */` |
|     3881 | 1622 | `	pVm->pEngine = &(*pEngine);` |
|     3881 | 1623 | `	pVm->bGcEnabled = 1; /* php default: the cycle collector is enabled */` |
|     3881 | 1624 | `	SyMemBackendInitFromParent(&pVm->sAllocator,&pEngine->sAllocator);` |
|        - | 1625 | `	/* Instructions containers */` |
|     3881 | 1626 | `	SySetInit(&pVm->aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|     3881 | 1627 | `	SySetAlloc(&pVm->aByteCode,0xFF);` |
|     3881 | 1628 | `	pVm->pByteContainer = &pVm->aByteCode;` |
|        - | 1629 | `	/* Object containers */` |
|     3881 | 1630 | `	SySetInit(&pVm->aMemObj,&pVm->sAllocator,sizeof(ph7_value));` |
|     3881 | 1631 | `	SySetAlloc(&pVm->aMemObj,0xFF);` |
|        - | 1632 | `	/* Argument-unpacking key capture (see VmSpreadRun/VmSpreadKey in vm.c) */` |
|     3881 | 1633 | `	SySetInit(&pVm->aSpreadRun,&pVm->sAllocator,sizeof(VmSpreadRun));` |
|     3881 | 1634 | `	SySetInit(&pVm->aSpreadKey,&pVm->sAllocator,sizeof(VmSpreadKey));` |
|     3881 | 1635 | `	SyBlobInit(&pVm->sSpreadKeyBlob,&pVm->sAllocator);` |
|     3881 | 1636 | `	SySetInit(&pVm->aEffArgName,&pVm->sAllocator,sizeof(SyString));` |
|        - | 1637 | `	/* Virtual machine internal containers */` |
|     3881 | 1638 | `	SyBlobInit(&pVm->sConsumer,&pVm->sAllocator);` |
|     3881 | 1639 | `	SyBlobInit(&pVm->sWorker,&pVm->sAllocator);` |
|     3881 | 1640 | `	SyBlobInit(&pVm->sLastErrMsg,&pVm->sAllocator);` |
|     3881 | 1641 | `	SyBlobInit(&pVm->sLastErrFile,&pVm->sAllocator);` |
|     3881 | 1642 | `	SyBlobInit(&pVm->sArgv,&pVm->sAllocator);` |
|     3881 | 1643 | `	SySetInit(&pVm->aLitObj,&pVm->sAllocator,sizeof(ph7_value));` |
|     3881 | 1644 | `	SySetAlloc(&pVm->aLitObj,0xFF);` |
|     3881 | 1645 | `	SyHashInit(&pVm->hHostFunction,&pVm->sAllocator,0,0);` |
|     3881 | 1646 | `	SyHashInit(&pVm->hFunction,&pVm->sAllocator,0,0);` |
|     3881 | 1647 | `	SyBlobInit(&pVm->sNamespace,&pVm->sAllocator);` |
|     3881 | 1648 | `	SyHashInit(&pVm->hUseImports,&pVm->sAllocator,0,0);` |
|     3881 | 1649 | `	SyHashInit(&pVm->hUseConstImports,&pVm->sAllocator,0,0);` |
|     3881 | 1650 | `	SyHashInit(&pVm->hClass,&pVm->sAllocator,SyStrHash,SyStrnmicmp);` |
|     3881 | 1651 | `	SyHashInit(&pVm->hConstant,&pVm->sAllocator,0,0);` |
|     3881 | 1652 | `	SyHashInit(&pVm->hSuper,&pVm->sAllocator,0,0);` |
|     3881 | 1653 | `	SyHashInit(&pVm->hPDO,&pVm->sAllocator,0,0);` |
|     3881 | 1654 | `	SySetInit(&pVm->aFreeObj,&pVm->sAllocator,sizeof(VmSlot));` |
|     3881 | 1655 | `	SySetInit(&pVm->aSelf,&pVm->sAllocator,sizeof(ph7_class *));` |
|     3881 | 1656 | `	SySetInit(&pVm->aShutdown,&pVm->sAllocator,sizeof(VmShutdownCB));` |
|     3881 | 1657 | `	SySetInit(&pVm->aIniCli,&pVm->sAllocator,sizeof(VmIniEntry));` |
|     3881 | 1658 | `	SySetInit(&pVm->aAutoload,&pVm->sAllocator,sizeof(VmAutoloadCB));` |
|     3881 | 1659 | `	SyHashInit(&pVm->hAutoloadActive,&pVm->sAllocator,0,0);` |
|     3881 | 1660 | `	SyHashInit(&pVm->hWeakCell,&pVm->sAllocator,0,0);` |
|     3881 | 1661 | `	SyHashInit(&pVm->hTypedSlot,&pVm->sAllocator,0,0);` |
|     3881 | 1662 | `	SySetInit(&pVm->aException,&pVm->sAllocator,sizeof(ph7_exception *));` |
|     3881 | 1663 | `	SySetInit(&pVm->aMagicGuard,&pVm->sAllocator,sizeof(VmMagicGuard));` |
|     3881 | 1664 | `	pVm->pMagicSetThis = 0;` |
|     3881 | 1665 | `	SyBlobInit(&pVm->sMagicSetName,&pVm->sAllocator);` |
|     3881 | 1666 | `	pVm->pHookSetThis = 0;` |
|     3881 | 1667 | `	pVm->pHookSetAttr = 0;` |
|     3881 | 1668 | `	pVm->nHookSetIdx = SXU32_HIGH;` |
|     3881 | 1669 | `	SySetInit(&pVm->aHookRmw,&pVm->sAllocator,sizeof(VmHookRmw));` |
|     3881 | 1670 | `	pVm->pMagicCallThis = 0;` |
|     3881 | 1671 | `	pVm->pMagicCallClass = 0;` |
|     3881 | 1672 | `	SyBlobInit(&pVm->sMagicCallName,&pVm->sAllocator);` |
|     3881 | 1673 | `	pVm->pIdleCallFrames = 0;` |
|     3881 | 1674 | `	pVm->pIdleOperandStacks = 0;` |
|     3881 | 1675 | `	pVm->nIdleOperandStacks = 0;` |
|     3881 | 1676 | `	pVm->pIdleStackNodes = 0;` |
|     3881 | 1677 | `	SySetInit(&pVm->aFinallyAction,&pVm->sAllocator,sizeof(VmFinallyAction));` |
|     3881 | 1678 | `	pVm->bInlineTryCatch = 1; /* ROOT C: enable inline generator try/catch/finally */` |
|     3881 | 1679 | `	pVm->pPendingException = 0;` |
|     3881 | 1680 | `	pVm->pInflightException = 0;` |
|     3881 | 1681 | `	pVm->nInflightExcBase = 0;` |
|     3881 | 1682 | `	pVm->pResumeFrame = 0;` |
|     3881 | 1683 | `	pVm->iResumePc = 0;` |
|     3881 | 1684 | `	pVm->pResumeInstr = 0;` |
|     3881 | 1685 | `	pVm->iResumeStackDepth = 0;` |
|     3881 | 1686 | `	pVm->nBoundaryRc = 0;` |
|     3881 | 1687 | `	pVm->pConstEvalClass = 0;` |
|     3881 | 1688 | `	pVm->nConstEvalDepth = 0;` |
|     3881 | 1689 | `	pVm->pConstCycleAttr = 0;` |
|     3881 | 1690 | `	pVm->pConstCycleClass = 0;` |
|     3881 | 1691 | `	SySetReset(&pVm->aMagicGuard);` |
|     3881 | 1692 | `	if( pVm->pMagicSetThis ){` |
|      ! 0 | 1693 | `		PH7_ClassInstanceUnref(pVm->pMagicSetThis);` |
|      ! 0 | 1694 | `		pVm->pMagicSetThis = 0;` |
|      ! 0 | 1695 | `	}` |
|     3881 | 1696 | `	SyBlobRelease(&pVm->sMagicSetName);` |
|     3881 | 1697 | `	if( pVm->pHookSetThis ){` |
|      ! 0 | 1698 | `		PH7_ClassInstanceUnref(pVm->pHookSetThis);` |
|      ! 0 | 1699 | `		pVm->pHookSetThis = 0;` |
|      ! 0 | 1700 | `	}` |
|     3881 | 1701 | `	pVm->pHookSetAttr = 0;` |
|     3881 | 1702 | `	pVm->nHookSetIdx = SXU32_HIGH;` |
|     3881 | 1703 | `	if( pVm->pMagicCallThis ){` |
|      ! 0 | 1704 | `		PH7_ClassInstanceUnref(pVm->pMagicCallThis);` |
|      ! 0 | 1705 | `		pVm->pMagicCallThis = 0;` |
|      ! 0 | 1706 | `	}` |
|     3881 | 1707 | `	pVm->pMagicCallClass = 0;` |
|     3881 | 1708 | `	SyBlobRelease(&pVm->sMagicCallName);` |
|        - | 1709 | `	/* Configuration containers */` |
|     3881 | 1710 | `	SySetInit(&pVm->aFiles,&pVm->sAllocator,sizeof(SyString));` |
|     3881 | 1711 | `	SySetInit(&pVm->aPaths,&pVm->sAllocator,sizeof(SyString));` |
|     3881 | 1712 | `	SySetInit(&pVm->aIncluded,&pVm->sAllocator,sizeof(SyString));` |
|     3881 | 1713 | `	SySetInit(&pVm->aOB,&pVm->sAllocator,sizeof(VmObEntry));` |
|     3881 | 1714 | `	SySetInit(&pVm->aResponseHeaders,&pVm->sAllocator,sizeof(VmResponseHeader));` |
|     3881 | 1715 | `	pVm->iResponseStatus = 200;` |
|     3881 | 1716 | `	pVm->bHeadersSent = 0;` |
|     3881 | 1717 | `	SySetInit(&pVm->aIOstream,&pVm->sAllocator,sizeof(ph7_io_stream *));` |
|        - | 1718 | `	/* Error callbacks containers */` |
|     3881 | 1719 | `	PH7_MemObjInit(&(*pVm),&pVm->aExceptionCB[0]);` |
|     3881 | 1720 | `	PH7_MemObjInit(&(*pVm),&pVm->aExceptionCB[1]);` |
|     3881 | 1721 | `	PH7_MemObjInit(&(*pVm),&pVm->aErrCB[0]);` |
|     3881 | 1722 | `	PH7_MemObjInit(&(*pVm),&pVm->aErrCB[1]);` |
|     3881 | 1723 | `	PH7_MemObjInit(&(*pVm),&pVm->sAssertCallback);` |
...
|     3881 | 1731 | `	pVm->nMaxDepth = 0;         /* host: unbounded PHP call depth (memory-bound) */` |
|     3881 | 1732 | `	pVm->nMaxNativeDepth = 256; /* host: proven the safe ceiling under ASan (the` |
...
|     3881 | 1745 | `	pVm->iAssertFlags = PH7_ASSERT_ZEND_OFF;` |
|        - | 1746 | `	/* JSON return status */` |
|     3881 | 1747 | `	pVm->json_rc = JSON_ERROR_NONE;` |
|        - | 1748 | `	/* PRNG context */` |
|     3881 | 1749 | `	SyRandomnessInit(&pVm->sPrng,0,0);` |
|        - | 1750 | `	/* Install the null constant */` |
|     3881 | 1751 | `	pObj = PH7_ReserveConstObj(&(*pVm),0);` |
|     3881 | 1752 | `	if( pObj == 0 ){` |
|      ! 0 | 1753 | `		rc = SXERR_MEM;` |
|      ! 0 | 1754 | `		goto Err;` |
|        - | 1755 | `	}` |
|     3881 | 1756 | `	PH7_MemObjInit(pVm,pObj);` |
|        - | 1757 | `	/* Install the boolean TRUE constant */` |
|     3881 | 1758 | `	pObj = PH7_ReserveConstObj(&(*pVm),0);` |
|     3881 | 1759 | `	if( pObj == 0 ){` |
|      ! 0 | 1760 | `		rc = SXERR_MEM;` |
|      ! 0 | 1761 | `		goto Err;` |
|        - | 1762 | `	}` |
|     3881 | 1763 | `	PH7_MemObjInitFromBool(pVm,pObj,1);` |
|        - | 1764 | `	/* Install the boolean FALSE constant */` |
|     3881 | 1765 | `	pObj = PH7_ReserveConstObj(&(*pVm),0);` |
|     3881 | 1766 | `	if( pObj == 0 ){` |
|      ! 0 | 1767 | `		rc = SXERR_MEM;` |
|      ! 0 | 1768 | `		goto Err;` |
|        - | 1769 | `	}` |
|     3881 | 1770 | `	PH7_MemObjInitFromBool(pVm,pObj,0);` |
...
|     3881 | 1774 | `	pObj = PH7_ReserveConstObj(&(*pVm),&pVm->nEmptyStringIdx);` |
|     3881 | 1775 | `	if( pObj == 0 ){` |
|      ! 0 | 1776 | `		rc = SXERR_MEM;` |
|      ! 0 | 1777 | `		goto Err;` |
|        - | 1778 | `	}` |
|     3881 | 1779 | `	PH7_MemObjInitFromString(pVm,pObj,0);` |
|        - | 1780 | `	/* Create the global frame */` |
|     3881 | 1781 | `	rc = VmEnterFrame(&(*pVm),0,0,0);` |
|     3881 | 1782 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 1783 | `		goto Err;` |
|        - | 1784 | `	}` |
|        - | 1785 | `	/* Initialize the code generator */` |
|     3881 | 1786 | `	rc = PH7_InitCodeGenerator(pVm,pEngine->xConf.xErr,pEngine->xConf.pErrData);` |
|     3881 | 1787 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 1788 | `		goto Err;` |
|        - | 1789 | `	}` |
|        - | 1790 | `	/* VM correctly initialized,set the magic number */` |
|     3881 | 1791 | `	pVm->nMagic = PH7_VM_INIT;` |
...
|     3881 | 1800 | `	pVm->pFiberClass = PH7_VmExtractClass(pVm,"Fiber",5,0,0);` |
|        - | 1801 | `	/* Cache built-in interface pointers used on hot dispatch paths */` |
|     3881 | 1802 | `	pVm->pArrayAccessClass = PH7_VmExtractClass(pVm,"ArrayAccess",sizeof("ArrayAccess")-1,0,0);` |
|     3881 | 1803 | `	pVm->pCountableClass   = PH7_VmExtractClass(pVm,"Countable",sizeof("Countable")-1,0,0);` |
|     3881 | 1804 | `	pVm->pStringableClass  = PH7_VmExtractClass(pVm,"Stringable",sizeof("Stringable")-1,0,0);` |
|     3881 | 1805 | `	pVm->pJsonSerializableClass = PH7_VmExtractClass(pVm,"JsonSerializable",sizeof("JsonSerializable")-1,0,0);` |
|     3881 | 1806 | `	pVm->pTraversableClass = PH7_VmExtractClass(pVm,"Traversable",sizeof("Traversable")-1,0,0);` |
|        - | 1807 | `	/* Initialize null-coalesce-assign scratch slot */` |
|     3881 | 1808 | `	pVm->pCoalesceObj = 0;` |
|     3881 | 1809 | `	pVm->bCoalesceArmed = 0;` |
|     3881 | 1810 | `	PH7_MemObjInit(pVm,&pVm->sCoalesceKey);` |
|        - | 1811 | `	/* Register Fiber internal C functions */` |
|     3881 | 1812 | `	ph7_create_function(pVm,"__fiber_suspend",vm_builtin_Fiber_suspend,0);` |
|     3881 | 1813 | `	ph7_create_function(pVm,"__fiber_construct",vm_builtin_Fiber_construct,0);` |
|     3881 | 1814 | `	ph7_create_function(pVm,"__fiber_start",vm_builtin_Fiber_start,0);` |
|     3881 | 1815 | `	ph7_create_function(pVm,"__fiber_resume",vm_builtin_Fiber_resume,0);` |
|     3881 | 1816 | `	ph7_create_function(pVm,"__fiber_getReturn",vm_builtin_Fiber_getReturn,0);` |
|     3881 | 1817 | `	ph7_create_function(pVm,"__fiber_isStarted",vm_builtin_Fiber_isStarted,0);` |
|     3881 | 1818 | `	ph7_create_function(pVm,"__fiber_isRunning",vm_builtin_Fiber_isRunning,0);` |
|     3881 | 1819 | `	ph7_create_function(pVm,"__fiber_isSuspended",vm_builtin_Fiber_isSuspended,0);` |
|     3881 | 1820 | `	ph7_create_function(pVm,"__fiber_isTerminated",vm_builtin_Fiber_isTerminated,0);` |
|     3881 | 1821 | `	ph7_create_function(pVm,"__fiber_destruct",vm_builtin_Fiber_destruct,0);` |
|        - | 1822 | `	/* Cache the Closure class pointer (closures are instances of it) */` |
|     3881 | 1823 | `	pVm->pClosureClass = PH7_VmExtractClass(pVm,"Closure",7,0,0);` |
|     3881 | 1824 | `	pVm->pClosureThis = 0; /* transient bound-$this slot, consumed per call */` |
|     3881 | 1825 | `	pVm->pClosureScope = 0; /* transient bound-scope slot, consumed per call */` |
|        - | 1826 | `	/* Closure::bind/bindTo/call/fromCallable native delegates (Increment 2) */` |
|     3881 | 1827 | `	ph7_create_function(pVm,"__closure_bindTo",vm_builtin_Closure_bindTo,0);` |
|     3881 | 1828 | `	ph7_create_function(pVm,"__closure_fromCallable",vm_builtin_Closure_fromCallable,0);` |
|        - | 1829 | `	/* Cache the stdClass pointer ((object) cast target + dynamic-property owner) */` |
|     3881 | 1830 | `	pVm->pStdClass = PH7_VmExtractClass(pVm,"stdClass",sizeof("stdClass")-1,0,0);` |
|        - | 1831 | `	/* Cache the Generator class pointer and register generator functions */` |
|     3881 | 1832 | `	pVm->pGeneratorClass = PH7_VmExtractClass(pVm,"Generator",9,0,0);` |
|     3881 | 1833 | `	ph7_create_function(pVm,"__gen_rewind",vm_builtin_Generator_rewind,0);` |
|     3881 | 1834 | `	ph7_create_function(pVm,"__gen_valid",vm_builtin_Generator_valid,0);` |
|     3881 | 1835 | `	ph7_create_function(pVm,"__gen_current",vm_builtin_Generator_current,0);` |
|     3881 | 1836 | `	ph7_create_function(pVm,"__gen_key",vm_builtin_Generator_key,0);` |
|     3881 | 1837 | `	ph7_create_function(pVm,"__gen_next",vm_builtin_Generator_next,0);` |
|     3881 | 1838 | `	ph7_create_function(pVm,"__gen_send",vm_builtin_Generator_send,0);` |
|     3881 | 1839 | `	ph7_create_function(pVm,"__gen_throw",vm_builtin_Generator_throw,0);` |
|     3881 | 1840 | `	ph7_create_function(pVm,"__gen_getReturn",vm_builtin_Generator_getReturn,0);` |
|     3881 | 1841 | `	ph7_create_function(pVm,"__gen_destruct",vm_builtin_Generator_destruct,0);` |
...
|     3881 | 1845 | `	PH7_VmInstallReflection(&(*pVm));` |
|     3881 | 1846 | `	PH7_VmInstallDateTime(&(*pVm));` |
|     3881 | 1847 | `	PH7_VmInstallSpl(&(*pVm));` |
|     3881 | 1848 | `	PH7_VmInstallTokenizer(&(*pVm));` |
|     3881 | 1849 | `	PH7_VmInstallSession(&(*pVm));` |
|     3881 | 1850 | `	PH7_VmInstallIni(&(*pVm));` |
...
|     3881 | 1854 | `	PH7_VmInstallLibxml(&(*pVm));` |
|     3881 | 1855 | `	PH7_VmInstallDom(&(*pVm));` |
|     3881 | 1856 | `	PH7_VmInstallXmlWriter(&(*pVm));` |
|        - | 1857 | `#endif` |
|     3881 | 1858 | `	pVm->bCompilingBuiltin = 0;` |
|        - | 1859 | `	/* Reset the code generator */` |
|     3881 | 1860 | `	PH7_ResetCodeGenerator(&(*pVm),pEngine->xConf.xErr,pEngine->xConf.pErrData);` |
|     3881 | 1861 | `	return SXRET_OK;` |
|      ! 0 | 1862 | `Err:` |
...
|        - | 1891 | ` */` |
|    41468 | 1892 | `PH7_PRIVATE void VmTrackOutput(ph7_vm *pVm, sxu32 nLen)` |
|        5 | 1893 | `{` |
|    41473 | 1894 | `	ProcConsumer xCons = pVm->sVmConsumer.xConsumer;` |
|    41473 | 1895 | `	if( xCons != VmObConsumer ){` |
|    12653 | 1896 | `		pVm->nOutputLen += nLen;` |
|    12653 | 1897 | `		if( !pVm->bHeadersSent && xCons != PH7_VmBlobConsumer ){` |
...
|        - | 1951 | ` */` |
|    51134 | 1952 | `static int VmInstrStackEffect(VmInstr *pI, sxu32 pc, int *pPush, int *pN, sxu32 aSucc[2], sxi32 aDelta[2])` |
|        5 | 1953 | `{` |
|    51139 | 1954 | `	int push = 0, n = 0;` |
|        - | 1955 | `	sxi32 d;` |
|    51139 | 1956 | `	switch( pI->iOp ){` |
...
|     8082 | 1959 | `	case PH7_OP_LOADC:` |
|        - | 1960 | `	case PH7_OP_DUP:` |
|    16169 | 1961 | `		push = 1; aSucc[0] = pc + 1; aDelta[0] = 1; n = 1; break;` |
|     5754 | 1962 | `	case PH7_OP_LOAD:` |
|    11513 | 1963 | `		if( pI->p3 ){ push = 1; d = 1; }else{ push = 0; d = 0; }` |
|    11513 | 1964 | `		aSucc[0] = pc + 1; aDelta[0] = d; n = 1; break;` |
...
|     1910 | 2002 | `	case PH7_OP_CALL:` |
|     3825 | 2003 | `		aSucc[0] = pc + 1; aDelta[0] = -(sxi32)pI->iP1; n = 1; break;` |
|        - | 2004 | `	/* Jumps. */` |
|      147 | 2005 | `	case PH7_OP_JMP:` |
|      299 | 2006 | `		aSucc[0] = pI->iP2; aDelta[0] = 0; n = 1; break;` |
|      770 | 2007 | `	case PH7_OP_JZ: case PH7_OP_JNZ:` |
|     1545 | 2008 | `		d = ( pI->iP1 == 0 ) ? -1 : 0; /* pops the condition on BOTH edges unless P1 says peek */` |
|     1545 | 2009 | `		aSucc[0] = pc + 1; aDelta[0] = d; aSucc[1] = pI->iP2; aDelta[1] = d; n = 2; break;` |
|        - | 2010 | `	/* Terminal: ends the path (its optional result pop does not propagate). */` |
|     2962 | 2011 | `	case PH7_OP_DONE:` |
|     5929 | 2012 | `		n = 0; break;` |
|     3105 | 2013 | `	default:` |
|     6215 | 2014 | `		return 0; /* unmodeled opcode -> whole-body fallback */` |
|        - | 2015 | `	}` |
|    44929 | 2016 | `	*pPush = push; *pN = n;` |
|    44929 | 2017 | `	return 1;` |
|    25572 | 2018 | `}` |
|        - | 2019 | `/*` |
...
|        - | 2023 | ` */` |
|     8236 | 2024 | `PH7_PRIVATE sxu32 VmComputeMaxStack(ph7_vm *pVm, VmInstr *aInstr, sxu32 nInstr)` |
|        5 | 2025 | `{` |
|        - | 2026 | `	void *pScratch;` |
...
|     8241 | 2032 | `	if( nInstr == 0 \|\| nInstr > 8192 ){` |
...
|    44571 | 2037 | `	for( i = 0; i < nInstr; i++ ){` |
|    42545 | 2038 | `		if( !VmInstrStackEffect(&aInstr[i], i, &push, &n, succ, delta) ){` |
|     6215 | 2039 | `			return VM_STACK_UNMODELED;` |
|        - | 2040 | `		}` |
|    18170 | 2041 | `	}` |
...
|     2031 | 2045 | `	pScratch = SyMemBackendAlloc(&pVm->sAllocator, nInstr * (sizeof(sxi32) + sizeof(sxu32) + 1));` |
|     2031 | 2046 | `	if( pScratch == 0 ){` |
|      ! 0 | 2047 | `		return VM_STACK_UNMODELED;` |
|        - | 2048 | `	}` |
|     2031 | 2049 | `	aH  = (sxi32 *)pScratch;` |
|     2031 | 2050 | `	aQ  = (sxu32 *)(aH + nInstr);` |
|     2031 | 2051 | `	aIn = (unsigned char *)(aQ + nInstr);` |
|    12347 | 2052 | `	for( i = 0; i < nInstr; i++ ){ aH[i] = -1; aIn[i] = 0; }` |
|     2031 | 2053 | `	aH[0] = 0; aQ[0] = 0; aIn[0] = 1; nQ = 1; iMax = 0;` |
|     2031 | 2054 | `	nIter = 0; nCap = nInstr * 16 + 1024; /* convergence backstop (fallback if hit) */` |
|    10625 | 2055 | `	while( nQ > 0 ){` |
|     8599 | 2056 | `		sxu32 pc = aQ[--nQ];` |
|        - | 2057 | `		sxi32 h;` |
|     8599 | 2058 | `		aIn[pc] = 0;` |
|     8599 | 2059 | `		h = aH[pc];` |
|     8599 | 2060 | `		if( ++nIter > nCap ){ iMax = -1; break; }` |
|     8599 | 2061 | `		(void)VmInstrStackEffect(&aInstr[pc], pc, &push, &n, succ, delta);` |
|     8599 | 2062 | `		if( h + push > iMax ){ iMax = h + push; }` |
|     8599 | 2063 | `		if( iMax > (sxi32)nInstr ){ iMax = -1; break; } /* over the safe bound: not worth it */` |
|    15245 | 2064 | `		for( k = 0; k < n; k++ ){` |
|     6651 | 2065 | `			sxi32 hn = h + delta[k];` |
|     6651 | 2066 | `			sxu32 t = succ[k];` |
|     6651 | 2067 | `			if( t >= nInstr \|\| hn < 0 ){ iMax = -1; break; } /* bad jump / imbalance */` |
|     6651 | 2068 | `			if( hn > aH[t] ){` |
|     6573 | 2069 | `				aH[t] = hn;` |
|     6573 | 2070 | `				if( !aIn[t] ){ aIn[t] = 1; aQ[nQ++] = t; }` |
|     3284 | 2071 | `			}` |
|     3328 | 2072 | `		}` |
|     8599 | 2073 | `		if( iMax < 0 ){ break; }` |
|        5 | 2074 | `	}` |
|     2031 | 2075 | `	SyMemBackendFree(&pVm->sAllocator, pScratch);` |
|     2031 | 2076 | `	return ( iMax < 0 ) ? VM_STACK_UNMODELED : (sxu32)iMax;` |
|     4123 | 2077 | `}` |
|        - | 2078 | `/*` |
...
|        - | 2088 | ` */` |
|   241958 | 2089 | `PH7_PRIVATE ph7_value * VmNewOperandStack(` |
...
|        - | 2101 | `  */` |
|   241963 | 2102 | `	nInstr += VM_STACK_GUARD;` |
|   241963 | 2103 | `	pStack = (ph7_value *)SyMemBackendAlloc(&pVm->sAllocator,nInstr * sizeof(ph7_value));` |
|   241963 | 2104 | `	if( pStack == 0 ){` |
|      ! 0 | 2105 | `		return 0;` |
|        - | 2106 | `	}` |
|        - | 2107 | `	/* Initialize the operand stack */` |
| 23081571 | 2108 | `	while( nInstr > 0 ){` |
| 22839613 | 2109 | `		PH7_MemObjInit(&(*pVm),&pStack[nInstr - 1]);` |
| 22839613 | 2110 | `		--nInstr;` |
|        5 | 2111 | `	}` |
|        - | 2112 | `	/* Ready for bytecode execution */` |
|   241963 | 2113 | `	return pStack;` |
|   121086 | 2114 | `}` |
|        - | 2115 | `/*` |
...
|        - | 2153 | ` */` |
|   104529 | 2154 | `PH7_PRIVATE ph7_value * VmOperandStackAlloc(ph7_vm *pVm, sxu32 nSlots)` |
|        5 | 2155 | `{` |
|   104534 | 2156 | `	VmIdleStack *pIdle = (VmIdleStack *)pVm->pIdleOperandStacks;` |
|   104534 | 2157 | `	sxu32 nCap = nSlots + VM_STACK_GUARD;` |
|   104534 | 2158 | `	if( pIdle && pIdle->nCap == nCap ){` |
...
|        - | 2167 | `	}` |
|    85987 | 2168 | `	return VmNewOperandStack(&(*pVm),nSlots);` |
|    52372 | 2169 | `}` |
|        - | 2170 | `/*` |
...
|        - | 2174 | ` * live value.` |
|        - | 2175 | ` */` |
|   104119 | 2176 | `PH7_PRIVATE void VmOperandStackRecycle(ph7_vm *pVm, ph7_value *pStack, sxu32 nCap)` |
|        5 | 2177 | `{` |
|        - | 2178 | `	VmIdleStack *pIdle;` |
|        - | 2179 | `	sxu32 i;` |
|   104124 | 2180 | `	if( pStack == 0 ){` |
|      ! 0 | 2181 | `		return;` |
|        - | 2182 | `	}` |
|   104124 | 2183 | `	if( pVm->nIdleOperandStacks >= VM_STACK_POOL_MAX \|\| nCap > VM_STACK_POOL_MAXSLOTS ){` |
|    79735 | 2184 | `		SyMemBackendFree(&pVm->sAllocator,pStack);` |
|    79735 | 2185 | `		return;` |
|        - | 2186 | `	}` |
...
|    24394 | 2189 | `	pIdle = (VmIdleStack *)pVm->pIdleStackNodes;` |
|    24394 | 2190 | `	if( pIdle ){` |
|    18552 | 2191 | `		pVm->pIdleStackNodes = pIdle->pNext;` |
|     9279 | 2192 | `	}else{` |
|     5847 | 2193 | `		pIdle = (VmIdleStack *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmIdleStack));` |
|     5847 | 2194 | `		if( pIdle == 0 ){` |
|      ! 0 | 2195 | `			SyMemBackendFree(&pVm->sAllocator,pStack);` |
|      ! 0 | 2196 | `			return;` |
|        - | 2197 | `		}` |
|        - | 2198 | `	}` |
|  1681937 | 2199 | `	for( i = 0; i < nCap; i++ ){` |
|  1657548 | 2200 | `		PH7_MemObjRelease(&pStack[i]);` |
...
|  1657548 | 2206 | `		pStack[i].nIdx = SXU32_HIGH;` |
|   828970 | 2207 | `	}` |
|    24394 | 2208 | `	pIdle->pStack = pStack;` |
|    24394 | 2209 | `	pIdle->nCap = nCap;` |
|    24394 | 2210 | `	pIdle->pNext = (VmIdleStack *)pVm->pIdleOperandStacks;` |
|    24394 | 2211 | `	pVm->pIdleOperandStacks = pIdle;` |
|    24394 | 2212 | `	pVm->nIdleOperandStacks++;` |
|    52167 | 2213 | `}` |
...
|   460347 | 2309 | `	while((pEntry = SyHashGetNextEntry(&pVm->hClass)) != 0 ){` |
|   456941 | 2310 | `		rc = VmMountUserClass(&(*pVm),(ph7_class *)pEntry->pUserData);` |
|   456941 | 2311 | `		if( rc != SXRET_OK ){` |
|        3 | 2312 | `			return rc;` |
|        - | 2313 | `		}` |
|        5 | 2314 | `	}` |
...
|        - | 2701 | ` */` |
|   933940 | 2702 | `PH7_PRIVATE sxi32 VmInitCallContext(` |
...
|        - | 2708 | `	)` |
|        5 | 2709 | `{` |
|   933945 | 2710 | `	pOut->pFunc = pFunc;` |
|   933945 | 2711 | `	pOut->pVm   = pVm;` |
|   933945 | 2712 | `	SySetInit(&pOut->sVar,&pVm->sAllocator,sizeof(ph7_value *));` |
|   933945 | 2713 | `	SySetInit(&pOut->sChunk,&pVm->sAllocator,sizeof(ph7_aux_data));` |
|        - | 2714 | `	/* Assume a null return value */` |
|   933945 | 2715 | `	MemObjSetType(pRet,MEMOBJ_NULL);` |
|   933945 | 2716 | `	pOut->pRet = pRet;` |
|   933945 | 2717 | `	pOut->iFlags = iFlags;` |
|   933945 | 2718 | `	pOut->pArgMap = 0; /* Set by the OP_CALL dispatcher for named-arg-aware builtins */` |
|   933945 | 2719 | `	return SXRET_OK;` |
|        5 | 2720 | `}` |
|        - | 2721 | `/*` |
|        - | 2722 | ` * Release a foreign function call context and cleanup the mess` |
|        - | 2723 | ` * left behind.` |
|        - | 2724 | ` */` |
|   933940 | 2725 | `PH7_PRIVATE void VmReleaseCallContext(ph7_context *pCtx)` |
|        5 | 2726 | `{` |
|        - | 2727 | `	sxu32 n;` |
|   933945 | 2728 | `	if( SySetUsed(&pCtx->sVar) > 0 ){` |
|    11705 | 2729 | `		ph7_value **apObj = (ph7_value **)SySetBasePtr(&pCtx->sVar);` |
|    68338 | 2730 | `		for( n = 0 ; n < SySetUsed(&pCtx->sVar) ; ++n ){` |
|    56638 | 2731 | `			if( apObj[n] == 0 ){` |
|        - | 2732 | `				/* Already released */` |
|      682 | 2733 | `				continue;` |
|        - | 2734 | `			}` |
|    55961 | 2735 | `			PH7_MemObjRelease(apObj[n]);` |
|    55961 | 2736 | `			SyMemBackendPoolFree(&pCtx->pVm->sAllocator,apObj[n]);` |
|    27983 | 2737 | `		}` |
|    11705 | 2738 | `		SySetRelease(&pCtx->sVar);` |
|     5850 | 2739 | `	}` |
|   933945 | 2740 | `	if( SySetUsed(&pCtx->sChunk) > 0 ){` |
...
|        - | 2786 | ` */` |
|  5675951 | 2787 | `PH7_PRIVATE void VmPopOperand(` |
|        - | 2788 | `	ph7_value **ppTos, /* Operand stack */` |
|        - | 2789 | `	sxi32 nPop         /* Total number of memory objects to pop */` |
|        - | 2790 | `	)` |
|        5 | 2791 | `{` |
|  5675956 | 2792 | `	ph7_value *pTos = *ppTos;` |
| 12079990 | 2793 | `	while( nPop > 0 ){` |
|  6404039 | 2794 | `		PH7_MemObjRelease(pTos);` |
|  6404039 | 2795 | `		pTos--;` |
|  6404039 | 2796 | `		nPop--;` |
|        5 | 2797 | `	}` |
|        - | 2798 | `	/* Top of the stack */` |
|  5675956 | 2799 | `	*ppTos = pTos;` |
|  5675956 | 2800 | `}` |
|        - | 2801 | `/*` |
|        - | 2802 | ` * Reserve a memory object.` |
|        - | 2803 | ` * Return a pointer to the raw ph7_value on success. NULL on failure.` |
|        - | 2804 | ` */` |
|  4368011 | 2805 | `PH7_PRIVATE ph7_value * PH7_ReserveMemObj(ph7_vm *pVm)` |
|        5 | 2806 | `{` |
|  4368016 | 2807 | `	ph7_value *pObj = 0;` |
|        - | 2808 | `	VmSlot *pSlot;` |
|        - | 2809 | `	sxu32 nIdx;` |
|        - | 2810 | `	/* Check for a free slot */` |
|  4368016 | 2811 | `	nIdx = SXU32_HIGH; /* cc warning */` |
|  4368016 | 2812 | `	pSlot = (VmSlot *)SySetPop(&pVm->aFreeObj);` |
|  4368016 | 2813 | `	if( pSlot ){` |
|  2130444 | 2814 | `		pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pSlot->nIdx);` |
|  2130444 | 2815 | `		nIdx = pSlot->nIdx;` |
|  1065834 | 2816 | `	}` |
|  4368016 | 2817 | `	if( pObj == 0 ){` |
|        - | 2818 | `		/* Reserve a new memory object */` |
|  2237577 | 2819 | `		pObj = VmReserveMemObj(&(*pVm),&nIdx);` |
|  2237577 | 2820 | `		if( pObj == 0 ){` |
|      ! 0 | 2821 | `			return 0;` |
|        - | 2822 | `		}` |
|  1118786 | 2823 | `	}` |
|        - | 2824 | `	/* Set a null default value */` |
|  4368016 | 2825 | `	PH7_MemObjInit(&(*pVm),pObj);` |
|  4368016 | 2826 | `	pObj->nIdx = nIdx;` |
|  4368016 | 2827 | `	return pObj;` |
|  2184625 | 2828 | `}` |
|        - | 2829 | `/*` |
|        - | 2830 | ` * Insert an entry by reference (not copy) in the given hashmap.` |
|        - | 2831 | ` */` |
|    46294 | 2832 | `PH7_PRIVATE sxi32 VmHashmapRefInsert(` |
...
|        - | 2839 | `	ph7_value sKey;` |
|        - | 2840 | `	sxi32 rc;` |
|    46299 | 2841 | `	PH7_MemObjInitFromString(pMap->pVm,&sKey,0);` |
|    46299 | 2842 | `	PH7_MemObjStringAppend(&sKey,zKey,nByte);` |
|        - | 2843 | `	/* Perform the insertion */` |
|    46299 | 2844 | `	rc = PH7_HashmapInsertByRef(&(*pMap),&sKey,nRefIdx);` |
|    46299 | 2845 | `	PH7_MemObjRelease(&sKey);` |
|    46299 | 2846 | `	return rc;` |
|        5 | 2847 | `}` |
|        - | 2848 | `/*` |
...
|        - | 2959 | ` */` |
|  5811599 | 2960 | `PH7_PRIVATE ph7_value * VmExtractMemObj(` |
...
|        - | 2965 | `	)` |
|        5 | 2966 | `{` |
|  5811604 | 2967 | `	int bNullify = FALSE;` |
...
|  5811604 | 2974 | `	pFrame = pVm->pFrame;` |
|  5811604 | 2975 | `	pFrame = VmSkipExceptionFrames(pFrame);` |
|        - | 2976 | `	/* Perform the lookup */` |
|  5811604 | 2977 | `	if( pName == 0 \|\| pName->nByte < 1 ){` |
...
|  5811604 | 2985 | `	pEntry = SyHashGet(&pVm->hSuper,(const void *)pName->zString,pName->nByte);` |
|  5811604 | 2986 | `	if( pEntry == 0 ){` |
|        - | 2987 | `		/* Query the top active frame */` |
|  5811200 | 2988 | `		pEntry = SyHashGet(&pFrame->hVar,(const void *)pName->zString,pName->nByte);` |
|  5811200 | 2989 | `		if( pEntry == 0 ){` |
|   498929 | 2990 | `			char *zName = (char *)pName->zString;` |
|        - | 2991 | `			VmSlot sLocal;` |
|   498929 | 2992 | `			if( !bCreate ){` |
...
|        - | 2998 | `			 */` |
|   497773 | 2999 | `			pObj = PH7_ReserveMemObj(&(*pVm));` |
|   497773 | 3000 | `			if( pObj == 0 ){` |
|      ! 0 | 3001 | `				return 0;` |
|        - | 3002 | `			}` |
|   497773 | 3003 | `			nIdx = pObj->nIdx;` |
|   497773 | 3004 | `			if( bDup ){` |
|        - | 3005 | `				/* Duplicate name */` |
...
|   497773 | 3012 | `			rc = SyHashInsert(&pFrame->hVar,zName,pName->nByte,SX_INT_TO_PTR(nIdx));` |
|   497773 | 3013 | `			if( rc != SXRET_OK ){` |
...
|      ! 0 | 3018 | `				return 0;` |
|        - | 3019 | `			}` |
|   497773 | 3020 | `			if( pFrame->pParent != 0 ){` |
|        - | 3021 | `				/* Local variable */` |
|   489195 | 3022 | `				sLocal.nIdx = nIdx;` |
|   489195 | 3023 | `				SySetPut(&pFrame->sLocal,(const void *)&sLocal);` |
|   245215 | 3024 | `			}else{` |
|        - | 3025 | `				/* Register in the $GLOBALS array */` |
|     8583 | 3026 | `				VmHashmapRefInsert(pVm->pGlobal,pName->zString,pName->nByte,nIdx);` |
|        - | 3027 | `			}` |
|        - | 3028 | `			/* Install in the reference table */` |
|   497773 | 3029 | `			PH7_VmRefObjInstall(&(*pVm),nIdx,SyHashLastEntry(&pFrame->hVar),0,0);` |
|        - | 3030 | `			/* Save object index */` |
|   497773 | 3031 | `			pObj->nIdx = nIdx;` |
|   249504 | 3032 | `		}else{` |
|        - | 3033 | `			/* Extract variable contents */` |
|  5312276 | 3034 | `			nIdx = (sxu32)SX_PTR_TO_INT(pEntry->pUserData);` |
|  5312276 | 3035 | `			pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|  5312276 | 3036 | `			if( bNullify && pObj ){` |
...
|        - | 4060 | ` */` |
|  1043905 | 4061 | `PH7_PRIVATE VmCallArgMap *VmEffCallArgMap(ph7_vm *pVm, VmInstr *pInstr,` |
|        - | 4062 | `	ph7_value *pArg, sxu32 nActual, VmCallArgMap *pStorage)` |
|        5 | 4063 | `{` |
|  1043910 | 4064 | `	VmCallArgMap *pCompile = (VmCallArgMap *)pInstr->p3;` |
|  1043910 | 4065 | `	if( pInstr->iP2 == 0 ){` |
|  1043628 | 4066 | `		return pCompile; /* no spread: compile map already aligned, nothing captured */` |
|        - | 4067 | `	}` |
...
|        - | 4408 | ` */` |
|    23792 | 4409 | `PH7_PRIVATE void VmForeachStepUnlink(ph7_foreach_info *pInfo,ph7_foreach_step *pStep)` |
|        5 | 4410 | `{` |
|    23797 | 4411 | `	ph7_foreach_step **apStep = (ph7_foreach_step **)SySetBasePtr(&pInfo->aStep);` |
|    23797 | 4412 | `	sxu32 n = SySetUsed(&pInfo->aStep);` |
|        - | 4413 | `	sxu32 i;` |
|    25973 | 4414 | `	for( i = 0 ; i < n ; ++i ){` |
|    25973 | 4415 | `		if( apStep[i] == pStep ){` |
|    23805 | 4416 | `			for( ; i + 1 < n ; ++i ){` |
|        9 | 4417 | `				apStep[i] = apStep[i + 1];` |
|        5 | 4418 | `			}` |
|    23797 | 4419 | `			(void)SySetPop(&pInfo->aStep);` |
|    23797 | 4420 | `			return;` |
|        - | 4421 | `		}` |
|     1093 | 4422 | `	}` |
|    11901 | 4423 | `}` |
...
|        - | 4460 | ` */` |
|   137640 | 4461 | `PH7_PRIVATE sxi32 VmLocalExec(ph7_vm *pVm,SySet *pByteCode,ph7_value *pResult,int bReturnPropagates)` |
|        5 | 4462 | `{` |
|        - | 4463 | `	ph7_value *pStack;` |
|        - | 4464 | `	sxu32 nCap;` |
|        - | 4465 | `	sxi32 rc;` |
|        - | 4466 | `	/* Allocate a new operand stack */` |
|   137645 | 4467 | `	pStack = VmNewOperandStack(&(*pVm),SySetUsed(pByteCode));` |
|   137645 | 4468 | `	if( pStack == 0 ){` |
|      ! 0 | 4469 | `		return SXERR_MEM;` |
|        - | 4470 | `	}` |
|   137645 | 4471 | `	nCap = SySetUsed(pByteCode) + VM_STACK_GUARD; /* what VmNewOperandStack handed out */` |
...
|   137645 | 4474 | `	rc = VmByteCodeExec(&(*pVm),(VmInstr *)SySetBasePtr(pByteCode),pStack,-1,&(*pResult),0,FALSE,0,0,bReturnPropagates,0,&pStack,&nCap,nCap);` |
|        - | 4475 | `	/* Free the operand stack */` |
|   137645 | 4476 | `	SyMemBackendFree(&pVm->sAllocator,pStack);` |
|        - | 4477 | `	/* Execution result */` |
|   137645 | 4478 | `	return rc;` |
|    68825 | 4479 | `}` |
|        - | 4480 | `/*` |
...
|        - | 4514 | ` */` |
|     3412 | 4515 | `static void VmFlushOutputBuffers(ph7_vm *pVm)` |
|        5 | 4516 | `{` |
|     3417 | 4517 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|        - | 4518 | `	sxu32 n,nUsed;` |
|     3417 | 4519 | `	nUsed = SySetUsed(&pVm->aOB);` |
|     3417 | 4520 | `	if( nUsed < 1 ){` |
|     3415 | 4521 | `		return;` |
|        - | 4522 | `	}` |
...
|        - | 4550 | ` */` |
|     3412 | 4551 | `static void VmInvokeShutdownCallbacks(ph7_vm *pVm)` |
|        5 | 4552 | `{` |
...
|     3417 | 4558 | `	nEntry = SySetUsed(&pVm->aShutdown);` |
|    37537 | 4559 | `	for( i = 0 ; i < (int)SX_ARRAYSIZE(apArg) ; i++ ){` |
|    34125 | 4560 | `		apArg[i] = 0;` |
|    17065 | 4561 | `	}` |
...
|        - | 4565 | `	 */` |
|     3417 | 4566 | `	pVm->bHaltRequested = 0;` |
|     3435 | 4567 | `	for( n = 0 ; n < nEntry ; ++n ){` |
...
|        9 | 4594 | `		}` |
|       14 | 4595 | `	}` |
|     3417 | 4596 | `	SySetReset(&pVm->aShutdown);` |
|     3417 | 4597 | `}` |
|        - | 4598 | `/*` |
...
|        - | 4613 | `	{` |
|     3417 | 4614 | `		sxu32 nOpsCap = SySetUsed(pVm->pByteContainer) + VM_STACK_GUARD;` |
|     3417 | 4615 | `		VmByteCodeExec(&(*pVm),(VmInstr *)SySetBasePtr(pVm->pByteContainer),pVm->aOps,-1,&pVm->sExec,0,FALSE,0,0,FALSE,0,&pVm->aOps,&nOpsCap,nOpsCap);` |
|        - | 4616 | `	}` |
|        - | 4617 | `	/* Invoke any shutdown callbacks */` |
|     3417 | 4618 | `	VmInvokeShutdownCallbacks(&(*pVm));` |
...
|     3417 | 4621 | `	VmFlushOutputBuffers(&(*pVm));` |
|        - | 4622 | `	/*` |
...
|        - | 4979 | ` */` |
|     3408 | 4980 | `static sxi32 VmRegisterSpecialFunction(ph7_vm *pVm)` |
|        5 | 4981 | `{` |
|        - | 4982 | `	sxi32 rc;` |
|        - | 4983 | `	sxu32 n;` |
|   426005 | 4984 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVmFunc) ; ++n ){` |
|        - | 4985 | `		/* Note that these special functions have access` |
|        - | 4986 | `		 * to the underlying virtual machine as their` |
|        - | 4987 | `		 * private data.` |
|        - | 4988 | `		 */` |
|   422597 | 4989 | `		rc = ph7_create_function(&(*pVm),aVmFunc[n].zName,aVmFunc[n].xFunc,&(*pVm));` |
|   422597 | 4990 | `		if( rc != SXRET_OK ){` |
|      ! 0 | 4991 | `			return rc;` |
|        - | 4992 | `		}` |
|   211301 | 4993 | `	}` |
|     3413 | 4994 | `	return SXRET_OK;` |
|     1709 | 4995 | `}` |
|        - | 4996 | `/*` |
...
|        - | 5000 | ` */` |
|   768026 | 5001 | `static ph7_class * VmFilterLoadableClass(ph7_class *pClass,sxi32 iLoadable)` |
|        5 | 5002 | `{` |
|   768031 | 5003 | `	if( !iLoadable ){` |
|   761357 | 5004 | `		return pClass;` |
|        - | 5005 | `	}` |
|     6683 | 5006 | `	while(pClass){` |
|     6679 | 5007 | `		if( (pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_ABSTRACT\|PH7_CLASS_TRAIT)) == 0 ){` |
|     6675 | 5008 | `			return pClass;` |
|        - | 5009 | `		}` |
...
|        - | 5081 | ` */` |
|   768272 | 5082 | `PH7_PRIVATE ph7_class * PH7_VmExtractClass(` |
...
|   768277 | 5098 | `	pEntry = SyHashGet(&pVm->hClass,(const void *)zName,nByte);` |
|   768277 | 5099 | `	if( pEntry == 0 ){` |
...
|        - | 5102 | `	}` |
|   768015 | 5103 | `	pClass = (ph7_class *)pEntry->pUserData;` |
|   768015 | 5104 | `	return VmFilterLoadableClass(pClass,iLoadable);` |
|   384141 | 5105 | `}` |
|        - | 5106 | `/*` |
...
|        - | 5119 | ` */` |
|  4364565 | 5120 | `static VmRefObj * VmNewRefObj(ph7_vm *pVm,sxu32 nIdx)` |
|        5 | 5121 | `{` |
|        - | 5122 | `	VmRefObj *pRef;` |
|        - | 5123 | `	/* Allocate a new instance */` |
|  4364570 | 5124 | `	pRef = (VmRefObj *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmRefObj));` |
|  4364570 | 5125 | `	if( pRef == 0 ){` |
|      ! 0 | 5126 | `		return 0;` |
|        - | 5127 | `	}` |
|        - | 5128 | `	/* Zero the structure */` |
|  4364570 | 5129 | `	SyZero(pRef,sizeof(VmRefObj));` |
|        - | 5130 | `	/* Initialize fields */` |
|  4364570 | 5131 | `	SySetInit(&pRef->aReference,&pVm->sAllocator,sizeof(SyHashEntry *));` |
|  4364570 | 5132 | `	SySetInit(&pRef->aArrEntries,&pVm->sAllocator,sizeof(ph7_hashmap_node *));` |
|  4364570 | 5133 | `	pRef->nIdx = nIdx;` |
|  4364570 | 5134 | `	return pRef;` |
|  2182902 | 5135 | `}` |
|        - | 5136 | `/*` |
|        - | 5137 | ` * Default hash function used by the reference table` |
|        - | 5138 | ` * for lookup/insertion operations.` |
|        - | 5139 | ` */` |
| 23448690 | 5140 | `static sxu32 VmRefHash(sxu32 nIdx)` |
|        5 | 5141 | `{` |
|        - | 5142 | `	/* Calculate the hash based on the memory object index */` |
| 23448695 | 5143 | `	return nIdx ^ (nIdx << 8) ^ (nIdx >> 8);` |
|        5 | 5144 | `}` |
|        - | 5145 | `/*` |
...
|        - | 5155 | ` * extension.` |
|        - | 5156 | ` */` |
| 13559693 | 5157 | `PH7_PRIVATE VmRefObj * VmRefObjExtract(ph7_vm *pVm,sxu32 nObjIdx)` |
|        5 | 5158 | `{` |
|        - | 5159 | `	VmRefObj *pRef;` |
|        - | 5160 | `	sxu32 nBucket;` |
|        - | 5161 | `	/* Point to the appropriate bucket */` |
| 13559698 | 5162 | `	nBucket = VmRefHash(nObjIdx) & (pVm->nRefSize - 1);` |
|        - | 5163 | `	/* Perform the lookup */` |
| 13559698 | 5164 | `	pRef = pVm->apRefObj[nBucket];` |
| 29859915 | 5165 | `	for(;;){` |
| 59714233 | 5166 | `		if( pRef == 0 ){` |
|  4853634 | 5167 | `			break;` |
|        - | 5168 | `		}` |
| 54860604 | 5169 | `		if( pRef->nIdx == nObjIdx ){` |
|        - | 5170 | `			/* Entry found */` |
|  8706069 | 5171 | `			return pRef;` |
|        - | 5172 | `		}` |
|        - | 5173 | `		/* Point to the next entry */` |
| 46154540 | 5174 | `		pRef = pRef->pNextCollide;` |
|        5 | 5175 | `	}` |
|        - | 5176 | `	/* No such entry,return NULL */` |
|  4853634 | 5177 | `	return 0;` |
|  6781695 | 5178 | `}` |
|        - | 5179 | `/*` |
...
|        - | 5187 | ` * extension.` |
|        - | 5188 | ` */` |
|  4364565 | 5189 | `static sxi32 VmRefObjInsert(ph7_vm *pVm,VmRefObj *pRef)` |
|        5 | 5190 | `{` |
|        - | 5191 | `	sxu32 nBucket;` |
|  4364570 | 5192 | `	if( pVm->nRefUsed * 3 >= pVm->nRefSize ){` |
|        - | 5193 | `		VmRefObj **apNew;` |
|        - | 5194 | `		sxu32 nNew;` |
|        - | 5195 | `		/* Allocate a larger table */` |
|    10557 | 5196 | `		nNew = pVm->nRefSize << 1;` |
|    10557 | 5197 | `		apNew = (VmRefObj **)SyMemBackendAlloc(&pVm->sAllocator,sizeof(VmRefObj *) * nNew);` |
|    10557 | 5198 | `		if( apNew ){` |
|    10557 | 5199 | `			VmRefObj *pEntry = pVm->pRefList;` |
|        - | 5200 | `			sxu32 n;` |
|        - | 5201 | `			/* Zero the structure */` |
|    10557 | 5202 | `			SyZero((void *)apNew,nNew * sizeof(VmRefObj *));` |
|        - | 5203 | `			/* Rehash all referenced entries */` |
|  2966741 | 5204 | `			for( n = 0 ; n < pVm->nRefUsed ; ++n ){` |
|        - | 5205 | `				/* Remove old collision links */` |
|  2956189 | 5206 | `				pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|        - | 5207 | `				/* Point to the appropriate bucket */` |
|  2956189 | 5208 | `				nBucket = VmRefHash(pEntry->nIdx) & (nNew - 1);` |
|        - | 5209 | `				/* Insert the entry  */` |
|  2956189 | 5210 | `				pEntry->pNextCollide = apNew[nBucket];` |
|  2956189 | 5211 | `				if( apNew[nBucket] ){` |
|  2306069 | 5212 | `					apNew[nBucket]->pPrevCollide = pEntry;` |
|  1153032 | 5213 | `				}` |
|  2956189 | 5214 | `				apNew[nBucket] = pEntry;` |
|        - | 5215 | `				/* Point to the next entry */` |
|  2956189 | 5216 | `				pEntry = pEntry->pNext;` |
|  1478097 | 5217 | `			}` |
|        - | 5218 | `			/* Release the old table */` |
|    10557 | 5219 | `			SyMemBackendFree(&pVm->sAllocator,pVm->apRefObj);` |
|        - | 5220 | `			/* Install the new one */` |
|    10557 | 5221 | `			pVm->apRefObj = apNew;` |
|    10557 | 5222 | `			pVm->nRefSize = nNew;` |
|     5276 | 5223 | `		}` |
|     5276 | 5224 | `	}` |
|        - | 5225 | `	/* Point to the appropriate bucket */` |
|  4364570 | 5226 | `	nBucket = VmRefHash(pRef->nIdx) & (pVm->nRefSize - 1);` |
|        - | 5227 | `	/* Insert the entry */` |
|  4364570 | 5228 | `	pRef->pNextCollide = pVm->apRefObj[nBucket];` |
|  4364570 | 5229 | `	if( pVm->apRefObj[nBucket] ){` |
|  3360043 | 5230 | `		pVm->apRefObj[nBucket]->pPrevCollide = pRef;` |
|  1680558 | 5231 | `	}` |
|  4364570 | 5232 | `	pVm->apRefObj[nBucket] = pRef;` |
|  4364570 | 5233 | `	MACRO_LD_PUSH(pVm->pRefList,pRef);` |
|  4364570 | 5234 | `	pVm->nRefUsed++;` |
|  4364570 | 5235 | `	return SXRET_OK;` |
|        5 | 5236 | `}` |
|        - | 5237 | `/*` |
...
|        - | 5247 | ` * extension.` |
|        - | 5248 | ` */` |
|  4230911 | 5249 | `PH7_PRIVATE sxi32 VmRefObjUnlink(ph7_vm *pVm,VmRefObj *pRef)` |
|        5 | 5250 | `{` |
|        - | 5251 | `	ph7_hashmap_node **apNode;` |
|        - | 5252 | `	SyHashEntry **apEntry;` |
|        - | 5253 | `	sxu32 n;` |
|        - | 5254 | `	/* Point to the reference table */` |
|  4230916 | 5255 | `	apNode = (ph7_hashmap_node **)SySetBasePtr(&pRef->aArrEntries);` |
|  4230916 | 5256 | `	apEntry = (SyHashEntry **)SySetBasePtr(&pRef->aReference);` |
|        - | 5257 | `	/* Unlink the entry from the reference table */` |
|  4726084 | 5258 | `	for( n = 0 ; n < SySetUsed(&pRef->aReference) ; n++ ){` |
|   495173 | 5259 | `		if( apEntry[n] ){` |
|   489293 | 5260 | `			SyHashDeleteEntry2(apEntry[n]);` |
|   245259 | 5261 | `		}` |
|   248204 | 5262 | `	}` |
|  7951141 | 5263 | `	for(n = 0 ; n < SySetUsed(&pRef->aArrEntries) ; ++n ){` |
|  3720230 | 5264 | `		if( apNode[n] ){` |
|     1380 | 5265 | `			PH7_HashmapUnlinkNode(apNode[n],FALSE);` |
|      688 | 5266 | `		}` |
|  1860117 | 5267 | `	}` |
|  4230916 | 5268 | `	if( pRef->pPrevCollide ){` |
|  1662668 | 5269 | `		pRef->pPrevCollide->pNextCollide = pRef->pNextCollide;` |
|   830874 | 5270 | `	}else{` |
|  2568253 | 5271 | `		pVm->apRefObj[VmRefHash(pRef->nIdx) & (pVm->nRefSize - 1)] = pRef->pNextCollide;` |
|        - | 5272 | `	}` |
|  4230916 | 5273 | `	if( pRef->pNextCollide ){` |
|  2247633 | 5274 | `		pRef->pNextCollide->pPrevCollide = pRef->pPrevCollide;` |
|  1124364 | 5275 | `	}` |
|  4230916 | 5276 | `	MACRO_LD_REMOVE(pVm->pRefList,pRef);` |
|        - | 5277 | `	/* Release the node */` |
|  4230916 | 5278 | `	SySetRelease(&pRef->aReference);` |
|  4230916 | 5279 | `	SySetRelease(&pRef->aArrEntries);` |
|  4230916 | 5280 | `	SyMemBackendPoolFree(&pVm->sAllocator,pRef);` |
|  4230916 | 5281 | `	pVm->nRefUsed--;` |
|  4230916 | 5282 | `	return SXRET_OK;` |
|        5 | 5283 | `}` |
|        - | 5284 | `/*` |
...
|        - | 5291 | ` * extension.` |
|        - | 5292 | ` */` |
|  4411113 | 5293 | `PH7_PRIVATE sxi32 PH7_VmRefObjInstall(` |
...
|        - | 5299 | `	)` |
|        5 | 5300 | `{` |
|  4411118 | 5301 | `	VmFrame *pFrame = pVm->pFrame;` |
|        - | 5302 | `	VmRefObj *pRef;` |
|        - | 5303 | `	/* Check if the referenced object already exists */` |
|  4411118 | 5304 | `	pRef = VmRefObjExtract(&(*pVm),nIdx);` |
|  4411118 | 5305 | `	if( pRef == 0 ){` |
|        - | 5306 | `		/* Create a new entry */` |
|  4364570 | 5307 | `		pRef = VmNewRefObj(&(*pVm),nIdx);` |
|  4364570 | 5308 | `		if( pRef == 0 ){` |
|      ! 0 | 5309 | `			return SXERR_MEM;` |
|        - | 5310 | `		}` |
|  4364570 | 5311 | `		pRef->iFlags = iFlags;` |
|        - | 5312 | `		/* Install the entry */` |
|  4364570 | 5313 | `		VmRefObjInsert(&(*pVm),pRef);` |
|  2182897 | 5314 | `	}` |
|  4411118 | 5315 | `	pFrame = VmSkipExceptionFrames(pFrame);` |
|  4411118 | 5316 | `	if( pFrame->pParent != 0 && pEntry ){` |
|        - | 5317 | `		VmSlot sRef;` |
|        - | 5318 | `		/* Local frame,record referenced entry so that it can` |
|        - | 5319 | `		 * be deleted when we leave this frame.` |
|        - | 5320 | `		 */` |
|   489267 | 5321 | `		sRef.nIdx = nIdx;` |
|   489267 | 5322 | `		sRef.pUserData = pEntry;` |
|   489267 | 5323 | `		if( SXRET_OK != SySetPut(&pFrame->sRef,(const void *)&sRef)) {` |
|      ! 0 | 5324 | `			pEntry = 0; /* Do not record this entry */` |
|      ! 0 | 5325 | `		}` |
|   245246 | 5326 | `	}` |
|  4411118 | 5327 | `	if( pEntry ){` |
|        - | 5328 | `		/* Address of the hash-entry */` |
|   535557 | 5329 | `		SySetPut(&pRef->aReference,(const void *)&pEntry);` |
|   268391 | 5330 | `	}` |
|  4411118 | 5331 | `	if( pMapEntry ){` |
|        - | 5332 | `		/* Address of the hashmap node [i.e: Array entry] */` |
|  3822130 | 5333 | `		SySetPut(&pRef->aArrEntries,(const void *)&pMapEntry);` |
|  1911062 | 5334 | `	}` |
|  4411118 | 5335 | `	return SXRET_OK;` |
|  2206176 | 5336 | `}` |
|        - | 5337 | `/*` |
...
|        - | 5344 | ` * extension.` |
|        - | 5345 | ` */` |
|  4202201 | 5346 | `PH7_PRIVATE sxi32 PH7_VmRefObjRemove(` |
...
|  4202206 | 5356 | `	pRef = VmRefObjExtract(&(*pVm),nIdx);` |
|  4202206 | 5357 | `	if( pRef == 0 ){` |
|        - | 5358 | `		/* Not such entry */` |
|   489069 | 5359 | `		return SXERR_NOTFOUND;` |
|        - | 5360 | `	}` |
|        - | 5361 | `	/* Remove the desired entry */` |
|  3713142 | 5362 | `	if( pEntry ){` |
...
|       95 | 5375 | `		}` |
|       41 | 5376 | `	}` |
|  3713142 | 5377 | `	if( pMapEntry ){` |
|        - | 5378 | `		ph7_hashmap_node **apNode;` |
|  3713060 | 5379 | `		apNode = (ph7_hashmap_node **)SySetBasePtr(&pRef->aArrEntries);` |
|  7426379 | 5380 | `		for(n = 0 ; n < SySetUsed(&pRef->aArrEntries) ; n++ ){` |
|  3713324 | 5381 | `			if( apNode[n] == pMapEntry ){` |
|        - | 5382 | `				/* nullify the entry */` |
|  3713060 | 5383 | `				apNode[n] = 0;` |
|  1856527 | 5384 | `			}` |
|  1856664 | 5385 | `		}` |
|  1856527 | 5386 | `	}` |
|  3713142 | 5387 | `	return SXRET_OK;` |
|  2101720 | 5388 | `}` |
...
|        - | 5397 | ` */` |
|    30174 | 5398 | `PH7_PRIVATE const ph7_io_stream * PH7_VmGetStreamDevice(` |
...
|    30179 | 5410 | `	zNext = zCur = zIn = *pzDevice;` |
|    30179 | 5411 | `	zEnd = &zIn[nByte];` |
|  1913212 | 5412 | `	while( zIn < zEnd ){` |
|  1883068 | 5413 | `		if( zIn < &zEnd[-3]/*://*/ && zIn[0] == ':' && zIn[1] == '/' && zIn[2] == '/' ){` |
|        - | 5414 | `			/* Got one */` |
...
|  1883038 | 5419 | `		zIn++;` |
|        5 | 5420 | `	}` |
|    30179 | 5421 | `	if( zIn >= zEnd ){` |
|        - | 5422 | `		/* No such scheme,return the default stream */` |
|    30149 | 5423 | `		return pVm->pDefStream;` |
|        - | 5424 | `	}` |
