...
|        - |   75 | ` */` |
|  1313925 |   76 | `PH7_PRIVATE sxi32 VmIsUnorderedCmp(ph7_value *pLeft,ph7_value *pRight)` |
|        5 |   77 | `{` |
|  1313930 |   78 | `	if( (pLeft->iFlags & MEMOBJ_REAL) && PH7_IS_NAN(pLeft->rVal) ){` |
|       40 |   79 | `		return TRUE;` |
|        - |   80 | `	}` |
|  1313892 |   81 | `	if( (pRight->iFlags & MEMOBJ_REAL) && PH7_IS_NAN(pRight->rVal) ){` |
|       11 |   82 | `		return TRUE;` |
|        - |   83 | `	}` |
|  1313882 |   84 | `	return FALSE;` |
|   657480 |   85 | `}` |
|        - |   86 | `/*` |
...
|        - |   94 | ` */` |
|   367615 |   95 | `PH7_PRIVATE int VmStringWantsPerlIncr(ph7_value *pVal)` |
|        5 |   96 | `{` |
|        - |   97 | `	SyString sStr;` |
|   367620 |   98 | `	sxu8 bReal = FALSE;` |
|   367620 |   99 | `	const char *zTail = 0;` |
|        - |  100 | `	const char *zEnd;` |
|   367620 |  101 | `	if( (pVal->iFlags & MEMOBJ_STRING) == 0 ){` |
|   367606 |  102 | `		return FALSE;` |
|        - |  103 | `	}` |
...
|        - |  149 | ` */` |
|  1518232 |  150 | `PH7_PRIVATE sxi32 PH7_VmRegisterConstantEx(` |
...
|        - |  162 | `	char *zDupName;` |
|        - |  163 | `	sxi32 rc;` |
|  1518237 |  164 | `	pEntry = SyHashGet(&pVm->hConstant,(const void *)pName->zString,pName->nByte);` |
|  1518237 |  165 | `	if( pEntry ){` |
...
|  1518235 |  189 | `	pCons = (ph7_constant *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_constant));` |
|  1518235 |  190 | `	if( pCons == 0 ){` |
|      ! 0 |  191 | `		return 0;` |
|        - |  192 | `	}` |
|        - |  193 | `	/* Duplicate constant name */` |
|  1518235 |  194 | `	zDupName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|  1518235 |  195 | `	if( zDupName == 0 ){` |
|      ! 0 |  196 | `		SyMemBackendPoolFree(&pVm->sAllocator,pCons);` |
|      ! 0 |  197 | `		return 0;` |
|        - |  198 | `	}` |
|  1518235 |  199 | `	SyStringInitFromBuf(&pCons->sFile,0,0);` |
|  1518235 |  200 | `	if( pFile ){` |
|       54 |  201 | `		SyStringDupPtr(&pCons->sFile,pFile);` |
|       25 |  202 | `	}` |
|  1518235 |  203 | `	pCons->nLine = nLine;` |
|  1518235 |  204 | `	pCons->bUserDefined = (sxu8)(bUser ? 1 : 0);` |
|        - |  205 | `	/* Install the constant */` |
|  1518235 |  206 | `	SyStringInitFromBuf(&pCons->sName,zDupName,pName->nByte);` |
|  1518235 |  207 | `	pCons->xExpand = xExpand;` |
|  1518235 |  208 | `	pCons->pUserData = pUserData;` |
|  1518235 |  209 | `	SySetInit(&pCons->aAttrs,&pVm->sAllocator,sizeof(ph7_attribute));` |
|  1518235 |  210 | `	rc = SyHashInsert(&pVm->hConstant,(const void *)zDupName,SyStringLength(&pCons->sName),pCons);` |
|  1518235 |  211 | `	if( rc != SXRET_OK ){` |
...
|        - |  225 | ` */` |
|  2226040 |  226 | `static sxi32 PH7_NewForeignFunction(` |
...
|  2226045 |  237 | `	pFunc = (ph7_user_func *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_user_func));` |
|  2226045 |  238 | `	if( pFunc == 0 ){` |
|      ! 0 |  239 | `		return SXERR_MEM;` |
|        - |  240 | `	}` |
|        - |  241 | `	/* Duplicate function name */` |
|  2226045 |  242 | `	zDup = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|  2226045 |  243 | `	if( zDup == 0 ){` |
|      ! 0 |  244 | `		SyMemBackendPoolFree(&pVm->sAllocator,pFunc);` |
|      ! 0 |  245 | `		return SXERR_MEM;` |
|        - |  246 | `	}` |
|        - |  247 | `	/* Zero the structure */` |
|  2226045 |  248 | `	SyZero(pFunc,sizeof(ph7_user_func));` |
|        - |  249 | `	/* Initialize structure fields */` |
|  2226045 |  250 | `	SyStringInitFromBuf(&pFunc->sName,zDup,pName->nByte);` |
|  2226045 |  251 | `	pFunc->pVm   = pVm;` |
|  2226045 |  252 | `	pFunc->xFunc = xFunc;` |
|  2226045 |  253 | `	pFunc->pUserData = pUserData;` |
|  2226045 |  254 | `	SySetInit(&pFunc->aAux,&pVm->sAllocator,sizeof(ph7_aux_data));` |
|        - |  255 | `	/* Write a pointer to the new function */` |
|  2226045 |  256 | `	*ppOut = pFunc;` |
|  2226045 |  257 | `	return SXRET_OK;` |
|  1113025 |  258 | `}` |
|        - |  259 | `/*` |
...
|        - |  266 | ` */` |
|  2229444 |  267 | `PH7_PRIVATE sxi32 PH7_VmInstallForeignFunction(` |
...
|  2229449 |  278 | `	pEntry = SyHashGet(&pVm->hHostFunction,pName->zString,pName->nByte);` |
|  2229449 |  279 | `	if( pEntry ){` |
...
|  2226045 |  295 | `	rc = PH7_NewForeignFunction(&(*pVm),&(*pName),xFunc,pUserData,&pFunc);` |
|  2226045 |  296 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  297 | `		return rc;` |
|        - |  298 | `	}` |
|        - |  299 | `	/* Install the function in the corresponding hashtable */` |
|  2226045 |  300 | `	rc = SyHashInsert(&pVm->hHostFunction,SyStringData(&pFunc->sName),pName->nByte,pFunc);` |
|  2226045 |  301 | `	if( rc != SXRET_OK ){` |
...
|  2226045 |  307 | `	return SXRET_OK;` |
|  1114727 |  308 | `}` |
|        - |  309 | `/*` |
|        - |  310 | ` * Initialize a VM function.` |
|        - |  311 | ` */` |
|  3411932 |  312 | `PH7_PRIVATE sxi32 PH7_VmInitFuncState(` |
...
|  3411937 |  322 | `	SyZero(pFunc,sizeof(ph7_vm_func));` |
|        - |  323 | `	/* Initialize structure fields */` |
|        - |  324 | `	/* Arguments container */` |
|  3411937 |  325 | `	SySetInit(&pFunc->aArgs,&pVm->sAllocator,sizeof(ph7_vm_func_arg));` |
|        - |  326 | `	/* Static variable container */` |
|  3411937 |  327 | `	SySetInit(&pFunc->aStatic,&pVm->sAllocator,sizeof(ph7_vm_func_static_var));` |
|        - |  328 | `	/* Bytecode container */` |
|  3411937 |  329 | `	SySetInit(&pFunc->aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|        - |  330 | `    /* Preallocate some instruction slots */` |
|  3411937 |  331 | `	SySetAlloc(&pFunc->aByteCode,0x10);` |
|        - |  332 | `	/* Closure environment */` |
|  3411937 |  333 | `	SySetInit(&pFunc->aClosureEnv,&pVm->sAllocator,sizeof(ph7_vm_func_closure_env));` |
|        - |  334 | `	/* Return-type union alternatives (empty unless declared as a union) */` |
|  3411937 |  335 | `	SySetInit(&pFunc->aReturnUnion,&pVm->sAllocator,sizeof(ph7_type_alt));` |
|        - |  336 | `	/* Declared #[...] attributes */` |
|  3411937 |  337 | `	SySetInit(&pFunc->aAttrs,&pVm->sAllocator,sizeof(ph7_attribute));` |
|  3411937 |  338 | `	pFunc->iFlags = iFlags;` |
|  3411937 |  339 | `	pFunc->pUserData = pUserData;` |
...
|  3411937 |  342 | `	pFunc->bStrictTypes = (sxu8)(pVm->sCodeGen.bStrictTypes ? 1 : 0);` |
|  3411937 |  343 | `	if( pVm->bCompilingBuiltin ){` |
...
|     4577 |  350 | `		SyString *pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|     4577 |  351 | `		if( pFile ){` |
|     4577 |  352 | `			SyStringDupPtr(&pFunc->sFile,pFile);` |
|     2286 |  353 | `		}` |
|        - |  354 | `	}` |
|  3411937 |  355 | `	SyStringInitFromBuf(&pFunc->sName,zName,nByte);` |
|  3411937 |  356 | `	return SXRET_OK;` |
|        5 |  357 | `}` |
|        - |  358 | `/*` |
...
|        - |  365 | ` */` |
|  5855120 |  366 | `PH7_PRIVATE sxi32 PH7_VmInstallUserFunction(` |
...
|        - |  373 | `	sxi32 rc;` |
|  5855125 |  374 | `	if( pName == 0 ){` |
|        - |  375 | `		/* Use the built-in name */` |
|   521419 |  376 | `		pName = &pFunc->sName;` |
|   260707 |  377 | `	}` |
|        - |  378 | `	/* Check for duplicates (functions with the same name) first */` |
|  5855125 |  379 | `	pEntry = SyHashGet(&pVm->hFunction,pName->zString,pName->nByte);` |
|  5855125 |  380 | `	if( pEntry ){` |
...
|        - |  388 | `	}` |
|        - |  389 | `	/* First time seen */` |
|  2938681 |  390 | `	pFunc->pNextName = 0;` |
|  2938681 |  391 | `	rc = SyHashInsert(&pVm->hFunction,pName->zString,pName->nByte,pFunc);` |
|  2938681 |  392 | `	return rc;` |
|  2927565 |  393 | `}` |
|        - |  394 | `/*` |
|        - |  395 | ` * Install a user defined class in the corresponding VM container.` |
|        - |  396 | ` */` |
|   528742 |  397 | `PH7_PRIVATE sxi32 PH7_VmInstallClass(` |
|        - |  398 | `	ph7_vm *pVm,      /* Target VM  */` |
|        - |  399 | `	ph7_class *pClass /* Target Class */` |
|        - |  400 | `	)` |
|        5 |  401 | `{` |
|   528747 |  402 | `	SyString *pName = &pClass->sName;` |
|        - |  403 | `	SyHashEntry *pEntry;` |
|        - |  404 | `	sxi32 rc;` |
|        - |  405 | `	/* Check for duplicates */` |
|   528747 |  406 | `	pEntry = SyHashGet(&pVm->hClass,(const void *)pName->zString,pName->nByte);` |
|   528747 |  407 | `	if( pEntry ){` |
...
|        - |  413 | `	}` |
|   528745 |  414 | `	pClass->pNextName = 0;` |
|        - |  415 | `	/* Perform a simple hashtable insertion */` |
|   528745 |  416 | `	rc = SyHashInsert(&pVm->hClass,(const void *)pName->zString,pName->nByte,pClass);` |
|   528745 |  417 | `	return rc;` |
|   264376 |  418 | `}` |
|        - |  419 | `/*` |
|        - |  420 | ` * Instruction builder interface.` |
|        - |  421 | ` */` |
| 98199492 |  422 | `PH7_PRIVATE sxi32 PH7_VmEmitInstr(` |
...
|        5 |  430 | `{` |
|        - |  431 | `	VmInstr sInstr;` |
| 98199497 |  432 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|        - |  433 | `	sxi32 rc;` |
|        - |  434 | `	/* Fill the VM instruction */` |
| 98199497 |  435 | `	sInstr.iOp = (sxu8)iOp;` |
| 98199497 |  436 | `	sInstr.iP1 = iP1;` |
| 98199497 |  437 | `	sInstr.iP2 = iP2;` |
| 98199497 |  438 | `	sInstr.p3  = p3;` |
...
| 98199497 |  443 | `	sInstr.nLine = 0;` |
| 98199497 |  444 | `	if( pGen->pIn && pGen->pEnd && pGen->pIn < pGen->pEnd ){` |
| 41838303 |  445 | `		sInstr.nLine = pGen->pIn->nLine;` |
| 77280348 |  446 | `	}else if( pGen->pIn && pGen->pEnd && pGen->pIn >= pGen->pEnd && pGen->pEnd > (SyToken *)0 ){` |
|        - |  447 | `		/* Past the end (statement tail): blame the last real token. */` |
| 56147053 |  448 | `		sInstr.nLine = pGen->pEnd[-1].nLine;` |
| 28073524 |  449 | `	}` |
| 98199497 |  450 | `	if( pIndex ){` |
|        - |  451 | `		/* Instruction index in the bytecode array */` |
|  6647343 |  452 | `		*pIndex = SySetUsed(pVm->pByteContainer);` |
|  3323669 |  453 | `	}` |
|        - |  454 | `	/* Finally,record the instruction */` |
| 98199497 |  455 | `	rc = SySetPut(pVm->pByteContainer,(const void *)&sInstr);` |
| 98199497 |  456 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  457 | `		PH7_GenCompileError(&pVm->sCodeGen,E_ERROR,1,"Fatal,Cannot emit instruction due to a memory failure");` |
|        - |  458 | `		/* Fall throw */` |
|      ! 0 |  459 | `	}` |
| 98199497 |  460 | `	return rc;` |
|        5 |  461 | `}` |
|        - |  462 | `/*` |
|        - |  463 | ` * Swap the current bytecode container with the given one.` |
|        - |  464 | ` */` |
|  9765616 |  465 | `PH7_PRIVATE sxi32 PH7_VmSetByteCodeContainer(ph7_vm *pVm,SySet *pContainer)` |
|        5 |  466 | `{` |
|  9765621 |  467 | `	if( pContainer == 0 ){` |
|        - |  468 | `		/* Point to the default container */` |
|      ! 0 |  469 | `		pVm->pByteContainer = &pVm->aByteCode;` |
|      ! 0 |  470 | `	}else{` |
|        - |  471 | `		/* Change container */` |
|  9765621 |  472 | `		pVm->pByteContainer = &(*pContainer);` |
|        - |  473 | `	}` |
|  9765621 |  474 | `	return SXRET_OK;` |
|        5 |  475 | `}` |
|        - |  476 | `/*` |
|        - |  477 | ` * Return the current bytecode container.` |
|        - |  478 | ` */` |
|  4882808 |  479 | `PH7_PRIVATE SySet * PH7_VmGetByteCodeContainer(ph7_vm *pVm)` |
|        5 |  480 | `{` |
|  4882813 |  481 | `	return pVm->pByteContainer;` |
|        5 |  482 | `}` |
|        - |  483 | `/*` |
|        - |  484 | ` * Extract the VM instruction rooted at nIndex.` |
|        - |  485 | ` */` |
|  6853034 |  486 | `PH7_PRIVATE VmInstr * PH7_VmGetInstr(ph7_vm *pVm,sxu32 nIndex)` |
|        5 |  487 | `{` |
|        - |  488 | `	VmInstr *pInstr;` |
|  6853039 |  489 | `	pInstr = (VmInstr *)SySetAt(pVm->pByteContainer,nIndex);` |
|  6853039 |  490 | `	return pInstr;` |
|        5 |  491 | `}` |
|        - |  492 | `/*` |
|        - |  493 | ` * Return the total number of VM instructions recorded so far.` |
|        - |  494 | ` */` |
| 54076892 |  495 | `PH7_PRIVATE sxu32 PH7_VmInstrLength(ph7_vm *pVm)` |
|        5 |  496 | `{` |
| 54076897 |  497 | `	return SySetUsed(pVm->pByteContainer);` |
|        5 |  498 | `}` |
|        - |  499 | `/*` |
|        - |  500 | ` * Pop the last VM instruction.` |
|        - |  501 | ` */` |
|  5389440 |  502 | `PH7_PRIVATE VmInstr * PH7_VmPopInstr(ph7_vm *pVm)` |
|        5 |  503 | `{` |
|  5389445 |  504 | `	return (VmInstr *)SySetPop(pVm->pByteContainer);` |
|        5 |  505 | `}` |
|        - |  506 | `/*` |
|        - |  507 | ` * Peek the last VM instruction.` |
|        - |  508 | ` */` |
| 20415532 |  509 | `PH7_PRIVATE VmInstr * PH7_VmPeekInstr(ph7_vm *pVm)` |
|        5 |  510 | `{` |
| 20415537 |  511 | `	return (VmInstr *)SySetPeek(pVm->pByteContainer);` |
|        5 |  512 | `}` |
|  1709272 |  513 | `PH7_PRIVATE VmInstr * PH7_VmPeekNextInstr(ph7_vm *pVm)` |
|        5 |  514 | `{` |
|        - |  515 | `	VmInstr *aInstr;` |
|        - |  516 | `	sxu32 n;` |
|  1709277 |  517 | `	n = SySetUsed(pVm->pByteContainer);` |
|  1709277 |  518 | `	if( n < 2 ){` |
|      ! 0 |  519 | `		return 0;` |
|        - |  520 | `	}` |
|  1709277 |  521 | `	aInstr = (VmInstr *)SySetBasePtr(pVm->pByteContainer);` |
|  1709277 |  522 | `	return &aInstr[n - 2];` |
|   854641 |  523 | `}` |
|        - |  524 | `/*` |
|        - |  525 | ` * Allocate a new virtual machine frame.` |
|        - |  526 | ` */` |
|   114413 |  527 | `PH7_PRIVATE VmFrame * VmNewFrame(` |
...
|   114418 |  535 | `	pFrame = (VmFrame *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmFrame));` |
|   114418 |  536 | `	if( pFrame == 0 ){` |
|      ! 0 |  537 | `		return 0;` |
|        - |  538 | `	}` |
|        - |  539 | `	/* Zero the structure */` |
|   114418 |  540 | `	SyZero(pFrame,sizeof(VmFrame));` |
|        - |  541 | `	/* Initialize frame fields */` |
|   114418 |  542 | `	pFrame->pUserData = pUserData;` |
|   114418 |  543 | `	pFrame->pThis = pThis;` |
|   114418 |  544 | `	pFrame->pVm = pVm;` |
|   114418 |  545 | `	SyHashInit(&pFrame->hVar,&pVm->sAllocator,0,0);` |
|   114418 |  546 | `	SySetInit(&pFrame->sArg,&pVm->sAllocator,sizeof(VmSlot));` |
|   114418 |  547 | `	SySetInit(&pFrame->sLocal,&pVm->sAllocator,sizeof(VmSlot));` |
|   114418 |  548 | `	SySetInit(&pFrame->sRef,&pVm->sAllocator,sizeof(VmSlot));` |
|   114418 |  549 | `	pFrame->nActualArgs = -1; /* unknown until an arg-install site stamps it */` |
...
|   114418 |  552 | `	PH7_MemObjInit(&(*pVm),&pFrame->sRet);` |
|   114418 |  553 | `	return pFrame;` |
|    57314 |  554 | `}` |
...
|        - |  559 | ` */` |
|   113817 |  560 | `PH7_PRIVATE sxi32 VmEnterFrame(` |
...
|   113822 |  569 | `	pFrame = VmNewFrame(&(*pVm),pUserData,pThis);` |
|   113822 |  570 | `	if( pFrame == 0 ){` |
|      ! 0 |  571 | `		return SXERR_MEM;` |
|        - |  572 | `	}` |
|        - |  573 | `	/* The line currently executing IS the call site for the frame being pushed. */` |
|   113822 |  574 | `	pFrame->nCallLine = pVm->nCurLine;` |
|        - |  575 | `	/* Link to the list of active VM frame */` |
|   113822 |  576 | `	pFrame->pParent = pVm->pFrame;` |
|   113822 |  577 | `	pVm->pFrame = pFrame;` |
|   113822 |  578 | `	if( ppFrame ){` |
|        - |  579 | `		/* Write a pointer to the new VM frame */` |
|   109942 |  580 | `		*ppFrame = pFrame;` |
|    55071 |  581 | `	}` |
|   113822 |  582 | `	return SXRET_OK;` |
|    57016 |  583 | `}` |
|        - |  584 | `/*` |
...
|        - |  632 | ` */` |
|   110367 |  633 | `PH7_PRIVATE void VmDropResumeTarget(ph7_vm *pVm, VmFrame *pFrame)` |
|        5 |  634 | `{` |
|   110372 |  635 | `	if( pVm->pResumeFrame == pFrame ){` |
...
|        - |  641 | ` */` |
|   109515 |  642 | `PH7_PRIVATE void VmLeaveFrame(ph7_vm *pVm)` |
|        5 |  643 | `{` |
|   109520 |  644 | `		VmFrame *pCurFrame = pVm->pFrame;` |
|   109520 |  645 | `	if( pCurFrame ){` |
|        - |  646 | `		/* Unlink from the list of active VM frame */` |
|   109520 |  647 | `		pVm->pFrame = pCurFrame->pParent;` |
|   109520 |  648 | `		if( pCurFrame->pParent && (pCurFrame->iFlags & VM_FRAME_EXCEPTION) == 0 ){` |
|        - |  649 | `			VmSlot  *aSlot;` |
|        - |  650 | `			sxu32 n;` |
|        - |  651 | `			/* Restore local variable to the free pool so that they can be reused again */` |
|   104510 |  652 | `			aSlot = (VmSlot *)SySetBasePtr(&pCurFrame->sLocal);` |
|   604996 |  653 | `			for(n = 0 ; n < SySetUsed(&pCurFrame->sLocal) ; ++n ){` |
|        - |  654 | `				/* Unset the local variable */` |
|   500491 |  655 | `				PH7_VmUnsetMemObj(&(*pVm),aSlot[n].nIdx,FALSE);` |
|   250863 |  656 | `			}` |
|        - |  657 | `			/* Remove local reference */` |
|   104510 |  658 | `			aSlot = (VmSlot *)SySetBasePtr(&pCurFrame->sRef);` |
|   605080 |  659 | `			for(n = 0 ; n < SySetUsed(&pCurFrame->sRef) ; ++n ){` |
|   500575 |  660 | `				PH7_VmRefObjRemove(&(*pVm),aSlot[n].nIdx,(SyHashEntry *)aSlot[n].pUserData,0);` |
|   250905 |  661 | `			}` |
|    52355 |  662 | `		}` |
|        - |  663 | `		/* Release internal containers */` |
|   109520 |  664 | `		SyHashRelease(&pCurFrame->hVar);` |
|   109520 |  665 | `		SySetRelease(&pCurFrame->sArg);` |
|   109520 |  666 | `		SySetRelease(&pCurFrame->sLocal);` |
|   109520 |  667 | `		SySetRelease(&pCurFrame->sRef);` |
...
|   109520 |  671 | `		PH7_MemObjRelease(&pCurFrame->sRet);` |
|        - |  672 | `		/* Drop a recorded in-place-catch resume target pointing at this frame (ROOT B). */` |
|   109520 |  673 | `		VmDropResumeTarget(pVm,pCurFrame);` |
|        - |  674 | `		/* Release the whole structure */` |
|   109520 |  675 | `		SyMemBackendPoolFree(&pVm->sAllocator,pCurFrame);` |
|    54860 |  676 | `	}` |
|   109520 |  677 | `}` |
|        - |  678 | `/*` |
...
|        - |  698 | ` */` |
|     6892 |  699 | `PH7_PRIVATE int VmDropFrameLocalSlot(ph7_vm *pVm,sxu32 nIdx)` |
|        5 |  700 | `{` |
|        - |  701 | `	VmFrame *pFrame;` |
|    13819 |  702 | `	for( pFrame = pVm->pFrame ; pFrame ; pFrame = pFrame->pParent ){` |
|     6939 |  703 | `		VmSlot *aSlot = (VmSlot *)SySetBasePtr(&pFrame->sLocal);` |
|        - |  704 | `		sxu32 n;` |
|     6999 |  705 | `		for( n = 0 ; n < SySetUsed(&pFrame->sLocal) ; ++n ){` |
...
|        - |  729 | ` */` |
| 10619178 |  730 | `PH7_PRIVATE VmFrame * VmSkipExceptionFrames(VmFrame *pFrame)` |
|        5 |  731 | `{` |
| 10645453 |  732 | `	while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|    26275 |  733 | `		pFrame = pFrame->pParent;` |
|        5 |  734 | `	}` |
| 10619183 |  735 | `	return pFrame;` |
|        5 |  736 | `}` |
|        - |  737 | `/*` |
...
|      ! 0 |  915 | `	return 0;` |
|       38 |  916 | `}` |
|   261935 |  917 | `PH7_PRIVATE sxi32 VmDrainFinally(ph7_vm *pVm, sxu32 nExceptionBase)` |
|        5 |  918 | `{` |
|        - |  919 | `	sxu32 nUsed;` |
|   261940 |  920 | `	sxi32 rcOut = SXRET_OK;` |
|   262004 |  921 | `	while( (nUsed = SySetUsed(&pVm->aException)) > nExceptionBase ){` |
...
|        - |  958 | ` */` |
|   158990 |  959 | `PH7_PRIVATE void VmClearFrameReturn(VmFrame *pFrame)` |
|        5 |  960 | `{` |
|   158995 |  961 | `	pFrame->bHasRet = 0;` |
|   158995 |  962 | `	PH7_MemObjRelease(&pFrame->sRet);` |
|   158995 |  963 | `}` |
|        - |  964 | `/*` |
...
|        - | 1112 | ` */` |
|    34948 | 1113 | `PH7_PRIVATE sxi32 VmLocalExecIntoObj(ph7_vm *pVm,SySet *pByteCode,ph7_value **ppMemObj,int bReturnPropagates)` |
|        5 | 1114 | `{` |
|        - | 1115 | `	ph7_value sVal;` |
|    34953 | 1116 | `	sxu32 nIdx = (*ppMemObj)->nIdx;` |
|        - | 1117 | `	sxi32 rc;` |
|    34953 | 1118 | `	PH7_MemObjInit(&(*pVm),&sVal);` |
|    34953 | 1119 | `	rc = VmLocalExec(&(*pVm),pByteCode,&sVal,bReturnPropagates);` |
|        - | 1120 | `	/* aMemObj may have moved during the eval — re-fetch by the reserved index. */` |
|    34953 | 1121 | `	*ppMemObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|    34953 | 1122 | `	if( *ppMemObj ){` |
|    34953 | 1123 | `		PH7_MemObjStore(&sVal,*ppMemObj);` |
|    17474 | 1124 | `	}` |
|    34953 | 1125 | `	PH7_MemObjRelease(&sVal);` |
|    34953 | 1126 | `	return rc;` |
|        5 | 1127 | `}` |
|        - | 1128 | `/*` |
...
|        - | 1140 | ` */` |
|   708414 | 1141 | `static sxi32 VmMountUserClassAttrs(` |
...
|   708419 | 1149 | `	SyHashResetLoopCursor(&pClass->hAttr);` |
|        - | 1150 | `	/* Process only static and constant attribute */` |
|  2904471 | 1151 | `	while( (pEntry = SyHashGetNextEntry(&pClass->hAttr)) != 0 ){` |
|        - | 1152 | `		/* Extract the current attribute */` |
|  2196061 | 1153 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|  2196056 | 1154 | `		if( (pAttr->iFlags & PH7_CLASS_ATTR_CONSTANT)` |
|  1440549 | 1155 | `		 && ((pAttr->iFlags & PH7_CLASS_ATTR_TYPED) == 0` |
|   342964 | 1156 | `			\|\| (pAttr->iFlags & PH7_CLASS_ATTR_ENUMCASE) != 0) ){` |
...
|   684141 | 1166 | `			continue;` |
|        - | 1167 | `		}` |
|  1511925 | 1168 | `		if( pAttr->iFlags & (PH7_CLASS_ATTR_STATIC\|PH7_CLASS_ATTR_CONSTANT) ){` |
...
|    11977 | 1250 | `		}` |
|        5 | 1251 | `	}` |
|   708415 | 1252 | `	return SXRET_OK;` |
|   354212 | 1253 | `}` |
|   707322 | 1254 | `PH7_PRIVATE sxi32 VmMountUserClass(` |
...
|   707327 | 1263 | `	rc = VmMountUserClassAttrs(&(*pVm),pClass);` |
|   707327 | 1264 | `	if( rc != SXRET_OK ){` |
|        6 | 1265 | `		return rc;` |
|        - | 1266 | `	}` |
|        - | 1267 | `	/* Install class methods */` |
|   707323 | 1268 | `	if( pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|        - | 1269 | `		/* Do not mount interface/trait methods since they are not directly invocable.` |
|        - | 1270 | `		 */` |
|   310883 | 1271 | `		return SXRET_OK;` |
|        - | 1272 | `	}` |
|        - | 1273 | `	/* Create constructor alias if not yet done */` |
|   396445 | 1274 | `	if( SyHashGet(&pClass->hMethod,"__construct",sizeof("__construct")-1) == 0 ){` |
|        - | 1275 | `		/* User constructor with the same base class name */` |
|    59355 | 1276 | `		pEntry = SyHashGet(&pClass->hMethod,SyStringData(&pClass->sName),SyStringLength(&pClass->sName));` |
|    59355 | 1277 | `		if( pEntry ){` |
...
|   396445 | 1284 | `	SyHashResetLoopCursor(&pClass->hMethod);` |
|  5938605 | 1285 | `	while((pEntry = SyHashGetNextEntry(&pClass->hMethod)) != 0 ){` |
|  5343945 | 1286 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|  5343945 | 1287 | `		if( (pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT) == 0 ){` |
|  5333711 | 1288 | `			rc = PH7_VmInstallUserFunction(&(*pVm),&pMeth->sFunc,&pMeth->sVmName);` |
|  5333711 | 1289 | `			if( rc != SXRET_OK ){` |
|      ! 0 | 1290 | `				return rc;` |
|        - | 1291 | `			}` |
|  2666853 | 1292 | `		}` |
|        5 | 1293 | `	}` |
|        - | 1294 | `	/* Mark class as mounted to avoid redundant mounting */` |
|   396445 | 1295 | `	pClass->bMounted = TRUE;` |
|   396445 | 1296 | `	return SXRET_OK;` |
|   353666 | 1297 | `}` |
|        - | 1298 | `/*` |
|        - | 1299 | ` * Allocate a private frame for attributes of the given` |
|        - | 1300 | ` * class instance (Object in the PHP jargon).` |
|        - | 1301 | ` */` |
|     8806 | 1302 | `PH7_PRIVATE sxi32 PH7_VmCreateClassInstanceFrame(` |
|        - | 1303 | `	ph7_vm *pVm, /* Target VM */` |
|        - | 1304 | `	ph7_class_instance *pObj /* Class instance */` |
|        - | 1305 | `	)` |
|        5 | 1306 | `{` |
|     8811 | 1307 | `	ph7_class *pClass = pObj->pClass;` |
...
|     8811 | 1312 | `	SyHashResetLoopCursor(&pClass->hAttr);` |
|    46421 | 1313 | `	while( (pEntry = SyHashGetNextEntry(&pClass->hAttr)) != 0 ){` |
|        - | 1314 | `		VmClassAttr *pVmAttr;` |
|        - | 1315 | `		/* Extract the current attribute */` |
|    37615 | 1316 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|    37615 | 1317 | `		pVmAttr = (VmClassAttr *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmClassAttr));` |
|    37615 | 1318 | `		if( pVmAttr == 0 ){` |
|      ! 0 | 1319 | `			return SXERR_MEM;` |
|        - | 1320 | `		}` |
|    37615 | 1321 | `		pVmAttr->pAttr = pAttr;` |
|    37615 | 1322 | `		if( (pAttr->iFlags & (PH7_CLASS_ATTR_CONSTANT\|PH7_CLASS_ATTR_STATIC)) == 0 ){` |
|        - | 1323 | `			ph7_value *pMemObj;` |
|        - | 1324 | `			/* Reserve a memory object for this attribute */` |
|    29555 | 1325 | `			pMemObj = PH7_ReserveMemObj(&(*pVm));` |
|    29555 | 1326 | `			if( pMemObj == 0 ){` |
|      ! 0 | 1327 | `				SyMemBackendPoolFree(&pVm->sAllocator,pVmAttr);` |
|      ! 0 | 1328 | `				return SXERR_MEM;` |
|        - | 1329 | `			}` |
|    29555 | 1330 | `			pVmAttr->nIdx = pMemObj->nIdx;` |
|    29555 | 1331 | `			pVmAttr->iState = 0;` |
|    29555 | 1332 | `			pVmAttr->pOwner = pClass;` |
|    29555 | 1333 | `			if( SySetUsed(&pAttr->aByteCode) > 0 ){` |
...
|    24163 | 1341 | `			}else if( pAttr->iFlags & PH7_CLASS_ATTR_TYPED ){` |
...
|      199 | 1345 | `			}` |
|    29555 | 1346 | `			rc = SyHashInsertTail(&pObj->hAttr,SyStringData(&pAttr->sName),SyStringLength(&pAttr->sName),pVmAttr);` |
|    29555 | 1347 | `			if( rc != SXRET_OK ){` |
|        - | 1348 | `				VmSlot sSlot;` |
...
|    29555 | 1357 | `			PH7_VmRefObjInstall(&(*pVm),pMemObj->nIdx,0,0,VM_REF_IDX_KEEP);` |
...
|    29555 | 1361 | `			if( pAttr->iFlags & PH7_CLASS_ATTR_TYPED ){` |
...
|        - | 1558 | ` */` |
|  8552760 | 1559 | `PH7_PRIVATE ph7_value * PH7_ReserveConstObj(ph7_vm *pVm,sxu32 *pIndex)` |
|        5 | 1560 | `{` |
|        - | 1561 | `	ph7_value *pObj;` |
|        - | 1562 | `	sxi32 rc;` |
|  8552765 | 1563 | `	if( pIndex ){` |
|        - | 1564 | `		/* Object index in the object table */` |
|  8541149 | 1565 | `		*pIndex = SySetUsed(&pVm->aLitObj);` |
|  4270572 | 1566 | `	}` |
|        - | 1567 | `	/* Reserve a slot for the new object */` |
|  8552765 | 1568 | `	rc = SySetPut(&pVm->aLitObj,(const void *)zDummy);` |
|  8552765 | 1569 | `	if( rc != SXRET_OK ){` |
...
|      ! 0 | 1573 | `		return 0;` |
|        - | 1574 | `	}` |
|  8552765 | 1575 | `	pObj = (ph7_value *)SySetPeek(&pVm->aLitObj);` |
|  8552765 | 1576 | `	return pObj;` |
|  4276385 | 1577 | `}` |
|        - | 1578 | `/*` |
|        - | 1579 | ` * Reserve a memory object.` |
|        - | 1580 | ` * Return a pointer to the raw ph7_value on success. NULL on failure.` |
|        - | 1581 | ` */` |
|  2237656 | 1582 | `PH7_PRIVATE ph7_value * VmReserveMemObj(ph7_vm *pVm,sxu32 *pIndex)` |
|        5 | 1583 | `{` |
|        - | 1584 | `	ph7_value *pObj;` |
|        - | 1585 | `	sxi32 rc;` |
|  2237661 | 1586 | `	if( pIndex ){` |
|        - | 1587 | `		/* Object index in the object table */` |
|  2237661 | 1588 | `		*pIndex = SySetUsed(&pVm->aMemObj);` |
|  1118828 | 1589 | `	}` |
|        - | 1590 | `	/* Reserve a slot for the new object */` |
|  2237661 | 1591 | `	rc = SySetPut(&pVm->aMemObj,(const void *)zDummy);` |
|  2237661 | 1592 | `	if( rc != SXRET_OK ){` |
...
|      ! 0 | 1596 | `		return 0;` |
|        - | 1597 | `	}` |
|  2237661 | 1598 | `	pObj = (ph7_value *)SySetPeek(&pVm->aMemObj);` |
|  2237661 | 1599 | `	return pObj;` |
|  1118833 | 1600 | `}` |
...
|     3877 | 1755 | `	pObj = PH7_ReserveConstObj(&(*pVm),0);` |
|     3877 | 1756 | `	if( pObj == 0 ){` |
|      ! 0 | 1757 | `		rc = SXERR_MEM;` |
|      ! 0 | 1758 | `		goto Err;` |
|        - | 1759 | `	}` |
|     3877 | 1760 | `	PH7_MemObjInit(pVm,pObj);` |
|        - | 1761 | `	/* Install the boolean TRUE constant */` |
|     3877 | 1762 | `	pObj = PH7_ReserveConstObj(&(*pVm),0);` |
|     3877 | 1763 | `	if( pObj == 0 ){` |
|      ! 0 | 1764 | `		rc = SXERR_MEM;` |
|      ! 0 | 1765 | `		goto Err;` |
|        - | 1766 | `	}` |
|     3877 | 1767 | `	PH7_MemObjInitFromBool(pVm,pObj,1);` |
|        - | 1768 | `	/* Install the boolean FALSE constant */` |
|     3877 | 1769 | `	pObj = PH7_ReserveConstObj(&(*pVm),0);` |
|     3877 | 1770 | `	if( pObj == 0 ){` |
|      ! 0 | 1771 | `		rc = SXERR_MEM;` |
|      ! 0 | 1772 | `		goto Err;` |
|        - | 1773 | `	}` |
|     3877 | 1774 | `	PH7_MemObjInitFromBool(pVm,pObj,0);` |
...
|     3877 | 1778 | `	pObj = PH7_ReserveConstObj(&(*pVm),&pVm->nEmptyStringIdx);` |
|     3877 | 1779 | `	if( pObj == 0 ){` |
|      ! 0 | 1780 | `		rc = SXERR_MEM;` |
|      ! 0 | 1781 | `		goto Err;` |
|        - | 1782 | `	}` |
|     3877 | 1783 | `	PH7_MemObjInitFromString(pVm,pObj,0);` |
|        - | 1784 | `	/* Create the global frame */` |
|     3877 | 1785 | `	rc = VmEnterFrame(&(*pVm),0,0,0);` |
|     3877 | 1786 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 1787 | `		goto Err;` |
|        - | 1788 | `	}` |
|        - | 1789 | `	/* Initialize the code generator */` |
|     3877 | 1790 | `	rc = PH7_InitCodeGenerator(pVm,pEngine->xConf.xErr,pEngine->xConf.pErrData);` |
|     3877 | 1791 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 1792 | `		goto Err;` |
|        - | 1793 | `	}` |
|        - | 1794 | `	/* VM correctly initialized,set the magic number */` |
|     3877 | 1795 | `	pVm->nMagic = PH7_VM_INIT;` |
...
|     3877 | 1804 | `	pVm->pFiberClass = PH7_VmExtractClass(pVm,"Fiber",5,0,0);` |
|        - | 1805 | `	/* Cache built-in interface pointers used on hot dispatch paths */` |
|     3877 | 1806 | `	pVm->pArrayAccessClass = PH7_VmExtractClass(pVm,"ArrayAccess",sizeof("ArrayAccess")-1,0,0);` |
|     3877 | 1807 | `	pVm->pCountableClass   = PH7_VmExtractClass(pVm,"Countable",sizeof("Countable")-1,0,0);` |
|     3877 | 1808 | `	pVm->pStringableClass  = PH7_VmExtractClass(pVm,"Stringable",sizeof("Stringable")-1,0,0);` |
|     3877 | 1809 | `	pVm->pJsonSerializableClass = PH7_VmExtractClass(pVm,"JsonSerializable",sizeof("JsonSerializable")-1,0,0);` |
|     3877 | 1810 | `	pVm->pTraversableClass = PH7_VmExtractClass(pVm,"Traversable",sizeof("Traversable")-1,0,0);` |
|        - | 1811 | `	/* Initialize null-coalesce-assign scratch slot */` |
|     3877 | 1812 | `	pVm->pCoalesceObj = 0;` |
|     3877 | 1813 | `	pVm->bCoalesceArmed = 0;` |
|     3877 | 1814 | `	PH7_MemObjInit(pVm,&pVm->sCoalesceKey);` |
|        - | 1815 | `	/* Register Fiber internal C functions */` |
|     3877 | 1816 | `	ph7_create_function(pVm,"__fiber_suspend",vm_builtin_Fiber_suspend,0);` |
|     3877 | 1817 | `	ph7_create_function(pVm,"__fiber_construct",vm_builtin_Fiber_construct,0);` |
|     3877 | 1818 | `	ph7_create_function(pVm,"__fiber_start",vm_builtin_Fiber_start,0);` |
|     3877 | 1819 | `	ph7_create_function(pVm,"__fiber_resume",vm_builtin_Fiber_resume,0);` |
|     3877 | 1820 | `	ph7_create_function(pVm,"__fiber_getReturn",vm_builtin_Fiber_getReturn,0);` |
|     3877 | 1821 | `	ph7_create_function(pVm,"__fiber_isStarted",vm_builtin_Fiber_isStarted,0);` |
|     3877 | 1822 | `	ph7_create_function(pVm,"__fiber_isRunning",vm_builtin_Fiber_isRunning,0);` |
|     3877 | 1823 | `	ph7_create_function(pVm,"__fiber_isSuspended",vm_builtin_Fiber_isSuspended,0);` |
|     3877 | 1824 | `	ph7_create_function(pVm,"__fiber_isTerminated",vm_builtin_Fiber_isTerminated,0);` |
|     3877 | 1825 | `	ph7_create_function(pVm,"__fiber_destruct",vm_builtin_Fiber_destruct,0);` |
|        - | 1826 | `	/* Cache the Closure class pointer (closures are instances of it) */` |
|     3877 | 1827 | `	pVm->pClosureClass = PH7_VmExtractClass(pVm,"Closure",7,0,0);` |
|     3877 | 1828 | `	pVm->pClosureThis = 0; /* transient bound-$this slot, consumed per call */` |
|     3877 | 1829 | `	pVm->pClosureScope = 0; /* transient bound-scope slot, consumed per call */` |
|        - | 1830 | `	/* Closure::bind/bindTo/call/fromCallable native delegates (Increment 2) */` |
|     3877 | 1831 | `	ph7_create_function(pVm,"__closure_bindTo",vm_builtin_Closure_bindTo,0);` |
|     3877 | 1832 | `	ph7_create_function(pVm,"__closure_fromCallable",vm_builtin_Closure_fromCallable,0);` |
|        - | 1833 | `	/* Cache the stdClass pointer ((object) cast target + dynamic-property owner) */` |
|     3877 | 1834 | `	pVm->pStdClass = PH7_VmExtractClass(pVm,"stdClass",sizeof("stdClass")-1,0,0);` |
|        - | 1835 | `	/* Cache the Generator class pointer and register generator functions */` |
|     3877 | 1836 | `	pVm->pGeneratorClass = PH7_VmExtractClass(pVm,"Generator",9,0,0);` |
|     3877 | 1837 | `	ph7_create_function(pVm,"__gen_rewind",vm_builtin_Generator_rewind,0);` |
|     3877 | 1838 | `	ph7_create_function(pVm,"__gen_valid",vm_builtin_Generator_valid,0);` |
|     3877 | 1839 | `	ph7_create_function(pVm,"__gen_current",vm_builtin_Generator_current,0);` |
|     3877 | 1840 | `	ph7_create_function(pVm,"__gen_key",vm_builtin_Generator_key,0);` |
|     3877 | 1841 | `	ph7_create_function(pVm,"__gen_next",vm_builtin_Generator_next,0);` |
|     3877 | 1842 | `	ph7_create_function(pVm,"__gen_send",vm_builtin_Generator_send,0);` |
|     3877 | 1843 | `	ph7_create_function(pVm,"__gen_throw",vm_builtin_Generator_throw,0);` |
|     3877 | 1844 | `	ph7_create_function(pVm,"__gen_getReturn",vm_builtin_Generator_getReturn,0);` |
|     3877 | 1845 | `	ph7_create_function(pVm,"__gen_destruct",vm_builtin_Generator_destruct,0);` |
...
|     3877 | 1849 | `	PH7_VmInstallReflection(&(*pVm));` |
|     3877 | 1850 | `	PH7_VmInstallDateTime(&(*pVm));` |
|     3877 | 1851 | `	PH7_VmInstallSpl(&(*pVm));` |
|     3877 | 1852 | `	PH7_VmInstallTokenizer(&(*pVm));` |
|     3877 | 1853 | `	PH7_VmInstallSession(&(*pVm));` |
|     3877 | 1854 | `	PH7_VmInstallIni(&(*pVm));` |
...
|     3877 | 1858 | `	PH7_VmInstallLibxml(&(*pVm));` |
|     3877 | 1859 | `	PH7_VmInstallDom(&(*pVm));` |
|     3877 | 1860 | `	PH7_VmInstallXmlWriter(&(*pVm));` |
|        - | 1861 | `#endif` |
|     3877 | 1862 | `	pVm->bCompilingBuiltin = 0;` |
|        - | 1863 | `	/* Reset the code generator */` |
|     3877 | 1864 | `	PH7_ResetCodeGenerator(&(*pVm),pEngine->xConf.xErr,pEngine->xConf.pErrData);` |
|     3877 | 1865 | `	return SXRET_OK;` |
|      ! 0 | 1866 | `Err:` |
...
|        - | 1895 | ` */` |
|    42598 | 1896 | `PH7_PRIVATE void VmTrackOutput(ph7_vm *pVm, sxu32 nLen)` |
|        5 | 1897 | `{` |
|    42603 | 1898 | `	ProcConsumer xCons = pVm->sVmConsumer.xConsumer;` |
|    42603 | 1899 | `	if( xCons != VmObConsumer ){` |
|    12751 | 1900 | `		pVm->nOutputLen += nLen;` |
|    12751 | 1901 | `		if( !pVm->bHeadersSent && xCons != PH7_VmBlobConsumer ){` |
...
|        - | 1955 | ` */` |
|    51334 | 1956 | `static int VmInstrStackEffect(VmInstr *pI, sxu32 pc, int *pPush, int *pN, sxu32 aSucc[2], sxi32 aDelta[2])` |
|        5 | 1957 | `{` |
|    51339 | 1958 | `	int push = 0, n = 0;` |
|        - | 1959 | `	sxi32 d;` |
|    51339 | 1960 | `	switch( pI->iOp ){` |
...
|     8104 | 1963 | `	case PH7_OP_LOADC:` |
|        - | 1964 | `	case PH7_OP_DUP:` |
|    16213 | 1965 | `		push = 1; aSucc[0] = pc + 1; aDelta[0] = 1; n = 1; break;` |
|     5791 | 1966 | `	case PH7_OP_LOAD:` |
|    11587 | 1967 | `		if( pI->p3 ){ push = 1; d = 1; }else{ push = 0; d = 0; }` |
|    11587 | 1968 | `		aSucc[0] = pc + 1; aDelta[0] = d; n = 1; break;` |
...
|     1261 | 2000 | `	case PH7_OP_POP:` |
|        - | 2001 | `	case PH7_OP_CONSUME:` |
|     2527 | 2002 | `		aSucc[0] = pc + 1; aDelta[0] = -(sxi32)pI->iP1; n = 1; break;` |
...
|     5937 | 2016 | `		n = 0; break;` |
|     3124 | 2017 | `	default:` |
|     6253 | 2018 | `		return 0; /* unmodeled opcode -> whole-body fallback */` |
|        - | 2019 | `	}` |
|    45091 | 2020 | `	*pPush = push; *pN = n;` |
|    45091 | 2021 | `	return 1;` |
|    25672 | 2022 | `}` |
|        - | 2023 | `/*` |
...
|        - | 2027 | ` */` |
|     8276 | 2028 | `PH7_PRIVATE sxu32 VmComputeMaxStack(ph7_vm *pVm, VmInstr *aInstr, sxu32 nInstr)` |
|        5 | 2029 | `{` |
|        - | 2030 | `	void *pScratch;` |
...
|     8281 | 2036 | `	if( nInstr == 0 \|\| nInstr > 8192 ){` |
...
|    44765 | 2041 | `	for( i = 0; i < nInstr; i++ ){` |
|    42737 | 2042 | `		if( !VmInstrStackEffect(&aInstr[i], i, &push, &n, succ, delta) ){` |
|     6253 | 2043 | `			return VM_STACK_UNMODELED;` |
|        - | 2044 | `		}` |
|    18247 | 2045 | `	}` |
...
|        - | 2092 | ` */` |
|   246448 | 2093 | `PH7_PRIVATE ph7_value * VmNewOperandStack(` |
...
|        - | 2105 | `  */` |
|   246453 | 2106 | `	nInstr += VM_STACK_GUARD;` |
|   246453 | 2107 | `	pStack = (ph7_value *)SyMemBackendAlloc(&pVm->sAllocator,nInstr * sizeof(ph7_value));` |
|   246453 | 2108 | `	if( pStack == 0 ){` |
|      ! 0 | 2109 | `		return 0;` |
|        - | 2110 | `	}` |
|        - | 2111 | `	/* Initialize the operand stack */` |
| 23414301 | 2112 | `	while( nInstr > 0 ){` |
| 23167853 | 2113 | `		PH7_MemObjInit(&(*pVm),&pStack[nInstr - 1]);` |
| 23167853 | 2114 | `		--nInstr;` |
|        5 | 2115 | `	}` |
|        - | 2116 | `	/* Ready for bytecode execution */` |
|   246453 | 2117 | `	return pStack;` |
|   123331 | 2118 | `}` |
|        - | 2119 | `/*` |
...
|        - | 2157 | ` */` |
|   104781 | 2158 | `PH7_PRIVATE ph7_value * VmOperandStackAlloc(ph7_vm *pVm, sxu32 nSlots)` |
|        5 | 2159 | `{` |
|   104786 | 2160 | `	VmIdleStack *pIdle = (VmIdleStack *)pVm->pIdleOperandStacks;` |
|   104786 | 2161 | `	sxu32 nCap = nSlots + VM_STACK_GUARD;` |
|   104786 | 2162 | `	if( pIdle && pIdle->nCap == nCap ){` |
...
|        - | 2171 | `	}` |
|    86205 | 2172 | `	return VmNewOperandStack(&(*pVm),nSlots);` |
|    52498 | 2173 | `}` |
|        - | 2174 | `/*` |
...
|        - | 2178 | ` * live value.` |
|        - | 2179 | ` */` |
|   104371 | 2180 | `PH7_PRIVATE void VmOperandStackRecycle(ph7_vm *pVm, ph7_value *pStack, sxu32 nCap)` |
|        5 | 2181 | `{` |
|        - | 2182 | `	VmIdleStack *pIdle;` |
|        - | 2183 | `	sxu32 i;` |
|   104376 | 2184 | `	if( pStack == 0 ){` |
|      ! 0 | 2185 | `		return;` |
|        - | 2186 | `	}` |
|   104376 | 2187 | `	if( pVm->nIdleOperandStacks >= VM_STACK_POOL_MAX \|\| nCap > VM_STACK_POOL_MAXSLOTS ){` |
...
|        - | 2201 | `		}` |
|        - | 2202 | `	}` |
|  1688643 | 2203 | `	for( i = 0; i < nCap; i++ ){` |
|  1664158 | 2204 | `		PH7_MemObjRelease(&pStack[i]);` |
...
|  1664158 | 2210 | `		pStack[i].nIdx = SXU32_HIGH;` |
|   832275 | 2211 | `	}` |
...
|   466613 | 2313 | `	while((pEntry = SyHashGetNextEntry(&pVm->hClass)) != 0 ){` |
|   463211 | 2314 | `		rc = VmMountUserClass(&(*pVm),(ph7_class *)pEntry->pUserData);` |
|   463211 | 2315 | `		if( rc != SXRET_OK ){` |
|        3 | 2316 | `			return rc;` |
|        - | 2317 | `		}` |
|        5 | 2318 | `	}` |
...
|        - | 2764 | ` */` |
|   935390 | 2765 | `PH7_PRIVATE sxi32 VmInitCallContext(` |
...
|        - | 2771 | `	)` |
|        5 | 2772 | `{` |
|   935395 | 2773 | `	pOut->pFunc = pFunc;` |
|   935395 | 2774 | `	pOut->pVm   = pVm;` |
|   935395 | 2775 | `	SySetInit(&pOut->sVar,&pVm->sAllocator,sizeof(ph7_value *));` |
|   935395 | 2776 | `	SySetInit(&pOut->sChunk,&pVm->sAllocator,sizeof(ph7_aux_data));` |
|        - | 2777 | `	/* Assume a null return value */` |
|   935395 | 2778 | `	MemObjSetType(pRet,MEMOBJ_NULL);` |
|   935395 | 2779 | `	pOut->pRet = pRet;` |
|   935395 | 2780 | `	pOut->iFlags = iFlags;` |
|   935395 | 2781 | `	pOut->pArgMap = 0; /* Set by the OP_CALL dispatcher for named-arg-aware builtins */` |
|   935395 | 2782 | `	return SXRET_OK;` |
|        5 | 2783 | `}` |
|        - | 2784 | `/*` |
|        - | 2785 | ` * Release a foreign function call context and cleanup the mess` |
|        - | 2786 | ` * left behind.` |
|        - | 2787 | ` */` |
|   935390 | 2788 | `PH7_PRIVATE void VmReleaseCallContext(ph7_context *pCtx)` |
|        5 | 2789 | `{` |
|        - | 2790 | `	sxu32 n;` |
|   935395 | 2791 | `	if( SySetUsed(&pCtx->sVar) > 0 ){` |
|    11777 | 2792 | `		ph7_value **apObj = (ph7_value **)SySetBasePtr(&pCtx->sVar);` |
|    68534 | 2793 | `		for( n = 0 ; n < SySetUsed(&pCtx->sVar) ; ++n ){` |
|    56762 | 2794 | `			if( apObj[n] == 0 ){` |
|        - | 2795 | `				/* Already released */` |
|      682 | 2796 | `				continue;` |
|        - | 2797 | `			}` |
|    56085 | 2798 | `			PH7_MemObjRelease(apObj[n]);` |
|    56085 | 2799 | `			SyMemBackendPoolFree(&pCtx->pVm->sAllocator,apObj[n]);` |
|    28045 | 2800 | `		}` |
|    11777 | 2801 | `		SySetRelease(&pCtx->sVar);` |
|     5886 | 2802 | `	}` |
|   935395 | 2803 | `	if( SySetUsed(&pCtx->sChunk) > 0 ){` |
...
|        - | 2849 | ` */` |
|  5795239 | 2850 | `PH7_PRIVATE void VmPopOperand(` |
|        - | 2851 | `	ph7_value **ppTos, /* Operand stack */` |
|        - | 2852 | `	sxi32 nPop         /* Total number of memory objects to pop */` |
|        - | 2853 | `	)` |
|        5 | 2854 | `{` |
|  5795244 | 2855 | `	ph7_value *pTos = *ppTos;` |
| 12320636 | 2856 | `	while( nPop > 0 ){` |
|  6525397 | 2857 | `		PH7_MemObjRelease(pTos);` |
|  6525397 | 2858 | `		pTos--;` |
|  6525397 | 2859 | `		nPop--;` |
|        5 | 2860 | `	}` |
|        - | 2861 | `	/* Top of the stack */` |
|  5795244 | 2862 | `	*ppTos = pTos;` |
|  5795244 | 2863 | `}` |
|        - | 2864 | `/*` |
|        - | 2865 | ` * Reserve a memory object.` |
|        - | 2866 | ` * Return a pointer to the raw ph7_value on success. NULL on failure.` |
|        - | 2867 | ` */` |
|  4383803 | 2868 | `PH7_PRIVATE ph7_value * PH7_ReserveMemObj(ph7_vm *pVm)` |
|        5 | 2869 | `{` |
|  4383808 | 2870 | `	ph7_value *pObj = 0;` |
|        - | 2871 | `	VmSlot *pSlot;` |
|        - | 2872 | `	sxu32 nIdx;` |
|        - | 2873 | `	/* Check for a free slot */` |
|  4383808 | 2874 | `	nIdx = SXU32_HIGH; /* cc warning */` |
|  4383808 | 2875 | `	pSlot = (VmSlot *)SySetPop(&pVm->aFreeObj);` |
|  4383808 | 2876 | `	if( pSlot ){` |
|  2146178 | 2877 | `		pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pSlot->nIdx);` |
|  2146178 | 2878 | `		nIdx = pSlot->nIdx;` |
|  1073701 | 2879 | `	}` |
|  4383808 | 2880 | `	if( pObj == 0 ){` |
|        - | 2881 | `		/* Reserve a new memory object */` |
|  2237635 | 2882 | `		pObj = VmReserveMemObj(&(*pVm),&nIdx);` |
|  2237635 | 2883 | `		if( pObj == 0 ){` |
|      ! 0 | 2884 | `			return 0;` |
|        - | 2885 | `		}` |
|  1118815 | 2886 | `	}` |
|        - | 2887 | `	/* Set a null default value */` |
|  4383808 | 2888 | `	PH7_MemObjInit(&(*pVm),pObj);` |
|  4383808 | 2889 | `	pObj->nIdx = nIdx;` |
|  4383808 | 2890 | `	return pObj;` |
|  2192521 | 2891 | `}` |
|        - | 2892 | `/*` |
...
|        - | 3022 | ` */` |
|  5882241 | 3023 | `PH7_PRIVATE ph7_value * VmExtractMemObj(` |
...
|        - | 3028 | `	)` |
|        5 | 3029 | `{` |
|  5882246 | 3030 | `	int bNullify = FALSE;` |
...
|  5882246 | 3037 | `	pFrame = pVm->pFrame;` |
|  5882246 | 3038 | `	pFrame = VmSkipExceptionFrames(pFrame);` |
|        - | 3039 | `	/* Perform the lookup */` |
|  5882246 | 3040 | `	if( pName == 0 \|\| pName->nByte < 1 ){` |
...
|  5882246 | 3048 | `	pEntry = SyHashGet(&pVm->hSuper,(const void *)pName->zString,pName->nByte);` |
|  5882246 | 3049 | `	if( pEntry == 0 ){` |
|        - | 3050 | `		/* Query the top active frame */` |
|  5881822 | 3051 | `		pEntry = SyHashGet(&pFrame->hVar,(const void *)pName->zString,pName->nByte);` |
|  5881822 | 3052 | `		if( pEntry == 0 ){` |
|   511201 | 3053 | `			char *zName = (char *)pName->zString;` |
|        - | 3054 | `			VmSlot sLocal;` |
|   511201 | 3055 | `			if( !bCreate ){` |
...
|        - | 3061 | `			 */` |
|   510025 | 3062 | `			pObj = PH7_ReserveMemObj(&(*pVm));` |
|   510025 | 3063 | `			if( pObj == 0 ){` |
|      ! 0 | 3064 | `				return 0;` |
|        - | 3065 | `			}` |
|   510025 | 3066 | `			nIdx = pObj->nIdx;` |
|   510025 | 3067 | `			if( bDup ){` |
|        - | 3068 | `				/* Duplicate name */` |
...
|   510025 | 3075 | `			rc = SyHashInsert(&pFrame->hVar,zName,pName->nByte,SX_INT_TO_PTR(nIdx));` |
|   510025 | 3076 | `			if( rc != SXRET_OK ){` |
...
|      ! 0 | 3081 | `				return 0;` |
|        - | 3082 | `			}` |
|   510025 | 3083 | `			if( pFrame->pParent != 0 ){` |
|        - | 3084 | `				/* Local variable */` |
|   501471 | 3085 | `				sLocal.nIdx = nIdx;` |
|   501471 | 3086 | `				SySetPut(&pFrame->sLocal,(const void *)&sLocal);` |
|   251353 | 3087 | `			}else{` |
...
|   510025 | 3092 | `			PH7_VmRefObjInstall(&(*pVm),nIdx,SyHashLastEntry(&pFrame->hVar),0,0);` |
|        - | 3093 | `			/* Save object index */` |
|   510025 | 3094 | `			pObj->nIdx = nIdx;` |
|   255630 | 3095 | `		}else{` |
|        - | 3096 | `			/* Extract variable contents */` |
|  5370626 | 3097 | `			nIdx = (sxu32)SX_PTR_TO_INT(pEntry->pUserData);` |
|  5370626 | 3098 | `			pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|  5370626 | 3099 | `			if( bNullify && pObj ){` |
...
|        - | 4123 | ` */` |
|  1045609 | 4124 | `PH7_PRIVATE VmCallArgMap *VmEffCallArgMap(ph7_vm *pVm, VmInstr *pInstr,` |
|        - | 4125 | `	ph7_value *pArg, sxu32 nActual, VmCallArgMap *pStorage)` |
|        5 | 4126 | `{` |
|  1045614 | 4127 | `	VmCallArgMap *pCompile = (VmCallArgMap *)pInstr->p3;` |
|  1045614 | 4128 | `	if( pInstr->iP2 == 0 ){` |
|  1045312 | 4129 | `		return pCompile; /* no spread: compile map already aligned, nothing captured */` |
|        - | 4130 | `	}` |
...
|        - | 4471 | ` */` |
|    23866 | 4472 | `PH7_PRIVATE void VmForeachStepUnlink(ph7_foreach_info *pInfo,ph7_foreach_step *pStep)` |
|        5 | 4473 | `{` |
|    23871 | 4474 | `	ph7_foreach_step **apStep = (ph7_foreach_step **)SySetBasePtr(&pInfo->aStep);` |
|    23871 | 4475 | `	sxu32 n = SySetUsed(&pInfo->aStep);` |
|        - | 4476 | `	sxu32 i;` |
|    26047 | 4477 | `	for( i = 0 ; i < n ; ++i ){` |
|    26047 | 4478 | `		if( apStep[i] == pStep ){` |
|    23879 | 4479 | `			for( ; i + 1 < n ; ++i ){` |
|        9 | 4480 | `				apStep[i] = apStep[i + 1];` |
|        5 | 4481 | `			}` |
|    23871 | 4482 | `			(void)SySetPop(&pInfo->aStep);` |
|    23871 | 4483 | `			return;` |
|        - | 4484 | `		}` |
|     1093 | 4485 | `	}` |
|    11938 | 4486 | `}` |
...
|        - | 4505 | ` */` |
|    23630 | 4506 | `PH7_PRIVATE void VmForeachHashmapStepRelease(ph7_vm *pVm,ph7_foreach_info *pInfo,ph7_foreach_step *pStep,int bPop)` |
|        5 | 4507 | `{` |
|    23635 | 4508 | `	ph7_hashmap *pMap = pStep->xIter.pMap;` |
|    23635 | 4509 | `	PH7_HashmapUnregisterForeachStep(pMap,pStep);` |
|    23635 | 4510 | `	if( bPop ){` |
...
|    23635 | 4513 | `		VmForeachStepUnlink(pInfo,pStep);` |
|    11815 | 4514 | `	}` |
|    23635 | 4515 | `	SyMemBackendPoolFree(&pVm->sAllocator,pStep);` |
|    23635 | 4516 | `	PH7_HashmapUnref(pMap);` |
|    23635 | 4517 | `}` |
...
|        - | 4523 | ` */` |
|   141830 | 4524 | `PH7_PRIVATE sxi32 VmLocalExec(ph7_vm *pVm,SySet *pByteCode,ph7_value *pResult,int bReturnPropagates)` |
|        5 | 4525 | `{` |
|        - | 4526 | `	ph7_value *pStack;` |
|        - | 4527 | `	sxu32 nCap;` |
|        - | 4528 | `	sxi32 rc;` |
|        - | 4529 | `	/* Allocate a new operand stack */` |
|   141835 | 4530 | `	pStack = VmNewOperandStack(&(*pVm),SySetUsed(pByteCode));` |
|   141835 | 4531 | `	if( pStack == 0 ){` |
|      ! 0 | 4532 | `		return SXERR_MEM;` |
|        - | 4533 | `	}` |
|   141835 | 4534 | `	nCap = SySetUsed(pByteCode) + VM_STACK_GUARD; /* what VmNewOperandStack handed out */` |
...
|   141835 | 4537 | `	rc = VmByteCodeExec(&(*pVm),(VmInstr *)SySetBasePtr(pByteCode),pStack,-1,&(*pResult),0,FALSE,0,0,bReturnPropagates,0,&pStack,&nCap,nCap);` |
|        - | 4538 | `	/* Free the operand stack */` |
|   141835 | 4539 | `	SyMemBackendFree(&pVm->sAllocator,pStack);` |
|        - | 4540 | `	/* Execution result */` |
|   141835 | 4541 | `	return rc;` |
|    70920 | 4542 | `}` |
|        - | 4543 | `/*` |
...
|        - | 5064 | ` */` |
|   782996 | 5065 | `static ph7_class * VmFilterLoadableClass(ph7_class *pClass,sxi32 iLoadable)` |
|        5 | 5066 | `{` |
|   783001 | 5067 | `	if( !iLoadable ){` |
|   776251 | 5068 | `		return pClass;` |
|        - | 5069 | `	}` |
...
|        - | 5145 | ` */` |
|   783260 | 5146 | `PH7_PRIVATE ph7_class * PH7_VmExtractClass(` |
...
|   783265 | 5162 | `	pEntry = SyHashGet(&pVm->hClass,(const void *)zName,nByte);` |
|   783265 | 5163 | `	if( pEntry == 0 ){` |
...
|        - | 5166 | `	}` |
|   782985 | 5167 | `	pClass = (ph7_class *)pEntry->pUserData;` |
|   782985 | 5168 | `	return VmFilterLoadableClass(pClass,iLoadable);` |
|   391635 | 5169 | `}` |
|        - | 5170 | `/*` |
...
|        - | 5183 | ` */` |
|  4380361 | 5184 | `static VmRefObj * VmNewRefObj(ph7_vm *pVm,sxu32 nIdx)` |
|        5 | 5185 | `{` |
|        - | 5186 | `	VmRefObj *pRef;` |
|        - | 5187 | `	/* Allocate a new instance */` |
|  4380366 | 5188 | `	pRef = (VmRefObj *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmRefObj));` |
|  4380366 | 5189 | `	if( pRef == 0 ){` |
|      ! 0 | 5190 | `		return 0;` |
|        - | 5191 | `	}` |
|        - | 5192 | `	/* Zero the structure */` |
|  4380366 | 5193 | `	SyZero(pRef,sizeof(VmRefObj));` |
|        - | 5194 | `	/* Initialize fields */` |
|  4380366 | 5195 | `	SySetInit(&pRef->aReference,&pVm->sAllocator,sizeof(SyHashEntry *));` |
|  4380366 | 5196 | `	SySetInit(&pRef->aArrEntries,&pVm->sAllocator,sizeof(ph7_hashmap_node *));` |
|  4380366 | 5197 | `	pRef->nIdx = nIdx;` |
|  4380366 | 5198 | `	return pRef;` |
|  2190800 | 5199 | `}` |
|        - | 5200 | `/*` |
|        - | 5201 | ` * Default hash function used by the reference table` |
|        - | 5202 | ` * for lookup/insertion operations.` |
|        - | 5203 | ` */` |
| 23525798 | 5204 | `static sxu32 VmRefHash(sxu32 nIdx)` |
|        5 | 5205 | `{` |
|        - | 5206 | `	/* Calculate the hash based on the memory object index */` |
| 23525803 | 5207 | `	return nIdx ^ (nIdx << 8) ^ (nIdx >> 8);` |
|        5 | 5208 | `}` |
|        - | 5209 | `/*` |
...
|        - | 5219 | ` * extension.` |
|        - | 5220 | ` */` |
| 13608335 | 5221 | `PH7_PRIVATE VmRefObj * VmRefObjExtract(ph7_vm *pVm,sxu32 nObjIdx)` |
|        5 | 5222 | `{` |
|        - | 5223 | `	VmRefObj *pRef;` |
|        - | 5224 | `	sxu32 nBucket;` |
|        - | 5225 | `	/* Point to the appropriate bucket */` |
| 13608340 | 5226 | `	nBucket = VmRefHash(nObjIdx) & (pVm->nRefSize - 1);` |
|        - | 5227 | `	/* Perform the lookup */` |
| 13608340 | 5228 | `	pRef = pVm->apRefObj[nBucket];` |
| 30035251 | 5229 | `	for(;;){` |
| 60029857 | 5230 | `		if( pRef == 0 ){` |
|  4881706 | 5231 | `			break;` |
|        - | 5232 | `		}` |
| 55148156 | 5233 | `		if( pRef->nIdx == nObjIdx ){` |
|        - | 5234 | `			/* Entry found */` |
|  8726639 | 5235 | `			return pRef;` |
|        - | 5236 | `		}` |
|        - | 5237 | `		/* Point to the next entry */` |
| 46421522 | 5238 | `		pRef = pRef->pNextCollide;` |
|        5 | 5239 | `	}` |
|        - | 5240 | `	/* No such entry,return NULL */` |
|  4881706 | 5241 | `	return 0;` |
|  6806016 | 5242 | `}` |
|        - | 5243 | `/*` |
...
|        - | 5251 | ` * extension.` |
|        - | 5252 | ` */` |
|  4380361 | 5253 | `static sxi32 VmRefObjInsert(ph7_vm *pVm,VmRefObj *pRef)` |
|        5 | 5254 | `{` |
|        - | 5255 | `	sxu32 nBucket;` |
|  4380366 | 5256 | `	if( pVm->nRefUsed * 3 >= pVm->nRefSize ){` |
|        - | 5257 | `		VmRefObj **apNew;` |
|        - | 5258 | `		sxu32 nNew;` |
|        - | 5259 | `		/* Allocate a larger table */` |
|    10547 | 5260 | `		nNew = pVm->nRefSize << 1;` |
|    10547 | 5261 | `		apNew = (VmRefObj **)SyMemBackendAlloc(&pVm->sAllocator,sizeof(VmRefObj *) * nNew);` |
|    10547 | 5262 | `		if( apNew ){` |
|    10547 | 5263 | `			VmRefObj *pEntry = pVm->pRefList;` |
|        - | 5264 | `			sxu32 n;` |
|        - | 5265 | `			/* Zero the structure */` |
|    10547 | 5266 | `			SyZero((void *)apNew,nNew * sizeof(VmRefObj *));` |
|        - | 5267 | `			/* Rehash all referenced entries */` |
|  2966661 | 5268 | `			for( n = 0 ; n < pVm->nRefUsed ; ++n ){` |
|        - | 5269 | `				/* Remove old collision links */` |
|  2956119 | 5270 | `				pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|        - | 5271 | `				/* Point to the appropriate bucket */` |
|  2956119 | 5272 | `				nBucket = VmRefHash(pEntry->nIdx) & (nNew - 1);` |
|        - | 5273 | `				/* Insert the entry  */` |
|  2956119 | 5274 | `				pEntry->pNextCollide = apNew[nBucket];` |
|  2956119 | 5275 | `				if( apNew[nBucket] ){` |
|  2306069 | 5276 | `					apNew[nBucket]->pPrevCollide = pEntry;` |
|  1153032 | 5277 | `				}` |
|  2956119 | 5278 | `				apNew[nBucket] = pEntry;` |
|        - | 5279 | `				/* Point to the next entry */` |
|  2956119 | 5280 | `				pEntry = pEntry->pNext;` |
|  1478062 | 5281 | `			}` |
|        - | 5282 | `			/* Release the old table */` |
|    10547 | 5283 | `			SyMemBackendFree(&pVm->sAllocator,pVm->apRefObj);` |
|        - | 5284 | `			/* Install the new one */` |
|    10547 | 5285 | `			pVm->apRefObj = apNew;` |
|    10547 | 5286 | `			pVm->nRefSize = nNew;` |
|     5271 | 5287 | `		}` |
|     5271 | 5288 | `	}` |
|        - | 5289 | `	/* Point to the appropriate bucket */` |
|  4380366 | 5290 | `	nBucket = VmRefHash(pRef->nIdx) & (pVm->nRefSize - 1);` |
|        - | 5291 | `	/* Insert the entry */` |
|  4380366 | 5292 | `	pRef->pNextCollide = pVm->apRefObj[nBucket];` |
|  4380366 | 5293 | `	if( pVm->apRefObj[nBucket] ){` |
|  3373203 | 5294 | `		pVm->apRefObj[nBucket]->pPrevCollide = pRef;` |
|  1687150 | 5295 | `	}` |
|  4380366 | 5296 | `	pVm->apRefObj[nBucket] = pRef;` |
|  4380366 | 5297 | `	MACRO_LD_PUSH(pVm->pRefList,pRef);` |
|  4380366 | 5298 | `	pVm->nRefUsed++;` |
|  4380366 | 5299 | `	return SXRET_OK;` |
|        5 | 5300 | `}` |
|        - | 5301 | `/*` |
...
|        - | 5311 | ` * extension.` |
|        - | 5312 | ` */` |
|  4246755 | 5313 | `PH7_PRIVATE sxi32 VmRefObjUnlink(ph7_vm *pVm,VmRefObj *pRef)` |
|        5 | 5314 | `{` |
|        - | 5315 | `	ph7_hashmap_node **apNode;` |
|        - | 5316 | `	SyHashEntry **apEntry;` |
|        - | 5317 | `	sxu32 n;` |
|        - | 5318 | `	/* Point to the reference table */` |
|  4246760 | 5319 | `	apNode = (ph7_hashmap_node **)SySetBasePtr(&pRef->aArrEntries);` |
|  4246760 | 5320 | `	apEntry = (SyHashEntry **)SySetBasePtr(&pRef->aReference);` |
|        - | 5321 | `	/* Unlink the entry from the reference table */` |
|  4754152 | 5322 | `	for( n = 0 ; n < SySetUsed(&pRef->aReference) ; n++ ){` |
|   507397 | 5323 | `		if( apEntry[n] ){` |
|   501579 | 5324 | `			SyHashDeleteEntry2(apEntry[n]);` |
|   251402 | 5325 | `		}` |
|   254316 | 5326 | `	}` |
|  7970119 | 5327 | `	for(n = 0 ; n < SySetUsed(&pRef->aArrEntries) ; ++n ){` |
|  3723364 | 5328 | `		if( apNode[n] ){` |
|     1390 | 5329 | `			PH7_HashmapUnlinkNode(apNode[n],FALSE);` |
|      693 | 5330 | `		}` |
|  1861684 | 5331 | `	}` |
|  4246760 | 5332 | `	if( pRef->pPrevCollide ){` |
|  1665772 | 5333 | `		pRef->pPrevCollide->pNextCollide = pRef->pNextCollide;` |
|   832859 | 5334 | `	}else{` |
|  2580993 | 5335 | `		pVm->apRefObj[VmRefHash(pRef->nIdx) & (pVm->nRefSize - 1)] = pRef->pNextCollide;` |
|        - | 5336 | `	}` |
|  4246760 | 5337 | `	if( pRef->pNextCollide ){` |
|  2260078 | 5338 | `		pRef->pNextCollide->pPrevCollide = pRef->pPrevCollide;` |
|  1130613 | 5339 | `	}` |
|  4246760 | 5340 | `	MACRO_LD_REMOVE(pVm->pRefList,pRef);` |
|        - | 5341 | `	/* Release the node */` |
|  4246760 | 5342 | `	SySetRelease(&pRef->aReference);` |
|  4246760 | 5343 | `	SySetRelease(&pRef->aArrEntries);` |
|  4246760 | 5344 | `	SyMemBackendPoolFree(&pVm->sAllocator,pRef);` |
|  4246760 | 5345 | `	pVm->nRefUsed--;` |
|  4246760 | 5346 | `	return SXRET_OK;` |
|        5 | 5347 | `}` |
|        - | 5348 | `/*` |
...
|        - | 5355 | ` * extension.` |
|        - | 5356 | ` */` |
|  4426851 | 5357 | `PH7_PRIVATE sxi32 PH7_VmRefObjInstall(` |
...
|        - | 5363 | `	)` |
|        5 | 5364 | `{` |
|  4426856 | 5365 | `	VmFrame *pFrame = pVm->pFrame;` |
|        - | 5366 | `	VmRefObj *pRef;` |
|        - | 5367 | `	/* Check if the referenced object already exists */` |
|  4426856 | 5368 | `	pRef = VmRefObjExtract(&(*pVm),nIdx);` |
|  4426856 | 5369 | `	if( pRef == 0 ){` |
|        - | 5370 | `		/* Create a new entry */` |
|  4380366 | 5371 | `		pRef = VmNewRefObj(&(*pVm),nIdx);` |
|  4380366 | 5372 | `		if( pRef == 0 ){` |
|      ! 0 | 5373 | `			return SXERR_MEM;` |
|        - | 5374 | `		}` |
|  4380366 | 5375 | `		pRef->iFlags = iFlags;` |
|        - | 5376 | `		/* Install the entry */` |
|  4380366 | 5377 | `		VmRefObjInsert(&(*pVm),pRef);` |
|  2190795 | 5378 | `	}` |
|  4426856 | 5379 | `	pFrame = VmSkipExceptionFrames(pFrame);` |
|  4426856 | 5380 | `	if( pFrame->pParent != 0 && pEntry ){` |
|        - | 5381 | `		VmSlot sRef;` |
|        - | 5382 | `		/* Local frame,record referenced entry so that it can` |
|        - | 5383 | `		 * be deleted when we leave this frame.` |
|        - | 5384 | `		 */` |
|   501543 | 5385 | `		sRef.nIdx = nIdx;` |
|   501543 | 5386 | `		sRef.pUserData = pEntry;` |
|   501543 | 5387 | `		if( SXRET_OK != SySetPut(&pFrame->sRef,(const void *)&sRef)) {` |
|      ! 0 | 5388 | `			pEntry = 0; /* Do not record this entry */` |
|      ! 0 | 5389 | `		}` |
|   251384 | 5390 | `	}` |
|  4426856 | 5391 | `	if( pEntry ){` |
|        - | 5392 | `		/* Address of the hash-entry */` |
|   547775 | 5393 | `		SySetPut(&pRef->aReference,(const void *)&pEntry);` |
|   274500 | 5394 | `	}` |
|  4426856 | 5395 | `	if( pMapEntry ){` |
|        - | 5396 | `		/* Address of the hashmap node [i.e: Array entry] */` |
|  3825170 | 5397 | `		SySetPut(&pRef->aArrEntries,(const void *)&pMapEntry);` |
|  1912582 | 5398 | `	}` |
|  4426856 | 5399 | `	return SXRET_OK;` |
|  2214045 | 5400 | `}` |
|        - | 5401 | `/*` |
...
|        - | 5408 | ` * extension.` |
|        - | 5409 | ` */` |
|  4217663 | 5410 | `PH7_PRIVATE sxi32 PH7_VmRefObjRemove(` |
...
|  4217668 | 5420 | `	pRef = VmRefObjExtract(&(*pVm),nIdx);` |
|  4217668 | 5421 | `	if( pRef == 0 ){` |
|        - | 5422 | `		/* Not such entry */` |
|   501345 | 5423 | `		return SXERR_NOTFOUND;` |
|        - | 5424 | `	}` |
|        - | 5425 | `	/* Remove the desired entry */` |
|  3716328 | 5426 | `	if( pEntry ){` |
...
|       95 | 5439 | `		}` |
|       41 | 5440 | `	}` |
|  3716328 | 5441 | `	if( pMapEntry ){` |
|        - | 5442 | `		ph7_hashmap_node **apNode;` |
|  3716246 | 5443 | `		apNode = (ph7_hashmap_node **)SySetBasePtr(&pRef->aArrEntries);` |
|  7432751 | 5444 | `		for(n = 0 ; n < SySetUsed(&pRef->aArrEntries) ; n++ ){` |
|  3716510 | 5445 | `			if( apNode[n] == pMapEntry ){` |
|        - | 5446 | `				/* nullify the entry */` |
|  3716246 | 5447 | `				apNode[n] = 0;` |
|  1858120 | 5448 | `			}` |
|  1858257 | 5449 | `		}` |
|  1858120 | 5450 | `	}` |
|  3716328 | 5451 | `	return SXRET_OK;` |
|  2109451 | 5452 | `}` |
...
|  1906485 | 5476 | `	while( zIn < zEnd ){` |
|  1876435 | 5477 | `		if( zIn < &zEnd[-3]/*://*/ && zIn[0] == ':' && zIn[1] == '/' && zIn[2] == '/' ){` |
|        - | 5478 | `			/* Got one */` |
...
|    30055 | 5487 | `		return pVm->pDefStream;` |
|        - | 5488 | `	}` |
