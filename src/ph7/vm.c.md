...
|        - |   139 | ` */` |
|   910776 |   140 | `static sxi32 VmIsUnorderedCmp(ph7_value *pLeft,ph7_value *pRight)` |
|        2 |   141 |  |
|   910778 |   142 | `	if( (pLeft->iFlags & MEMOBJ_REAL) && PH7_IS_NAN(pLeft->rVal) ){` |
|       35 |   143 | `		return TRUE;` |
|        - |   144 | `	}` |
|   910744 |   145 | `	if( (pRight->iFlags & MEMOBJ_REAL) && PH7_IS_NAN(pRight->rVal) ){` |
|       11 |   146 | `		return TRUE;` |
|        - |   147 | `	}` |
|   910734 |   148 | `	return FALSE;` |
|   455412 |   149 |  |
|        - |   150 | `/*` |
...
|        - |   158 | ` */` |
|   335276 |   159 | `static int VmStringWantsPerlIncr(ph7_value *pVal)` |
|        2 |   160 |  |
|        - |   161 | `	SyString sStr;` |
|   335278 |   162 | `	sxu8 bReal = FALSE;` |
|   335278 |   163 | `	const char *zTail = 0;` |
|        - |   164 | `	const char *zEnd;` |
|   335278 |   165 | `	if( (pVal->iFlags & MEMOBJ_STRING) == 0 ){` |
|   335208 |   166 | `		return FALSE;` |
|        - |   167 | `	}` |
...
|        - |   325 | ` */` |
|   273440 |   326 | `PH7_PRIVATE sxi32 PH7_VmInitFuncState(` |
...
|   273442 |   336 | `	SyZero(pFunc,sizeof(ph7_vm_func));` |
|        - |   337 | `	/* Initialize structure fields */` |
|        - |   338 | `	/* Arguments container */` |
|   273442 |   339 | `	SySetInit(&pFunc->aArgs,&pVm->sAllocator,sizeof(ph7_vm_func_arg));` |
|        - |   340 | `	/* Static variable container */` |
|   273442 |   341 | `	SySetInit(&pFunc->aStatic,&pVm->sAllocator,sizeof(ph7_vm_func_static_var));` |
|        - |   342 | `	/* Bytecode container */` |
|   273442 |   343 | `	SySetInit(&pFunc->aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|        - |   344 | `    /* Preallocate some instruction slots */` |
|   273442 |   345 | `	SySetAlloc(&pFunc->aByteCode,0x10);` |
|        - |   346 | `	/* Closure environment */` |
|   273442 |   347 | `	SySetInit(&pFunc->aClosureEnv,&pVm->sAllocator,sizeof(ph7_vm_func_closure_env));` |
|        - |   348 | `	/* Return-type union alternatives (empty unless declared as a union) */` |
|   273442 |   349 | `	SySetInit(&pFunc->aReturnUnion,&pVm->sAllocator,sizeof(ph7_type_alt));` |
|   273442 |   350 | `	pFunc->iFlags = iFlags;` |
|   273442 |   351 | `	pFunc->pUserData = pUserData;` |
...
|   273442 |   354 | `	pFunc->bStrictTypes = (sxu8)(pVm->sCodeGen.bStrictTypes ? 1 : 0);` |
|   273442 |   355 | `	SyStringInitFromBuf(&pFunc->sName,zName,nByte);` |
|   273442 |   356 | `	return SXRET_OK;` |
|        2 |   357 |  |
|        - |   358 | `/*` |
...
|        - |   365 | ` */` |
|   754470 |   366 | `PH7_PRIVATE sxi32 PH7_VmInstallUserFunction(` |
...
|        - |   373 | `	sxi32 rc;` |
|   754472 |   374 | `	if( pName == 0 ){` |
|        - |   375 | `		/* Use the built-in name */` |
|    41580 |   376 | `		pName = &pFunc->sName;` |
|    20789 |   377 | `	}` |
|        - |   378 | `	/* Check for duplicates (functions with the same name) first */` |
|   754472 |   379 | `	pEntry = SyHashGet(&pVm->hFunction,pName->zString,pName->nByte);` |
|   754472 |   380 | `	if( pEntry ){` |
...
|        - |   388 | `	}` |
|        - |   389 | `	/* First time seen */` |
|   195102 |   390 | `	pFunc->pNextName = 0;` |
|   195102 |   391 | `	rc = SyHashInsert(&pVm->hFunction,pName->zString,pName->nByte,pFunc);` |
|   195102 |   392 | `	return rc;` |
|   377237 |   393 |  |
|        - |   394 | `/*` |
...
|        - |   421 | ` */` |
|  4228874 |   422 | `PH7_PRIVATE sxi32 PH7_VmEmitInstr(` |
...
|  4228876 |   434 | `	sInstr.iOp = (sxu8)iOp;` |
|  4228876 |   435 | `	sInstr.iP1 = iP1;` |
|  4228876 |   436 | `	sInstr.iP2 = iP2;` |
|  4228876 |   437 | `	sInstr.p3  = p3;` |
|  4228876 |   438 | `	if( pIndex ){` |
...
|  4228876 |   443 | `	rc = SySetPut(pVm->pByteContainer,(const void *)&sInstr);` |
|  4228876 |   444 | `	if( rc != SXRET_OK ){` |
|      ! 0 |   445 | `		PH7_GenCompileError(&pVm->sCodeGen,E_ERROR,1,"Fatal,Cannot emit instruction due to a memory failure");` |
|        - |   446 | `		/* Fall throw */` |
|      ! 0 |   447 | `	}` |
|  4228876 |   448 | `	return rc;` |
|        2 |   449 |  |
|        - |   450 | `/*` |
|        - |   451 | ` * Swap the current bytecode container with the given one.` |
|        - |   452 | ` */` |
|   549204 |   453 | `PH7_PRIVATE sxi32 PH7_VmSetByteCodeContainer(ph7_vm *pVm,SySet *pContainer)` |
|        2 |   454 |  |
|   549206 |   455 | `	if( pContainer == 0 ){` |
|        - |   456 | `		/* Point to the default container */` |
|      ! 0 |   457 | `		pVm->pByteContainer = &pVm->aByteCode;` |
|      ! 0 |   458 | `	}else{` |
|        - |   459 | `		/* Change container */` |
|   549206 |   460 | `		pVm->pByteContainer = &(*pContainer);` |
|        - |   461 | `	}` |
|   549206 |   462 | `	return SXRET_OK;` |
|        2 |   463 |  |
|        - |   464 | `/*` |
|        - |   465 | ` * Return the current bytecode container.` |
|        - |   466 | ` */` |
|   274602 |   467 | `PH7_PRIVATE SySet * PH7_VmGetByteCodeContainer(ph7_vm *pVm)` |
|        2 |   468 |  |
|   274604 |   469 | `	return pVm->pByteContainer;` |
|        2 |   470 |  |
|        - |   471 | `/*` |
...
|        - |   482 | ` */` |
|  1271006 |   483 | `PH7_PRIVATE sxu32 PH7_VmInstrLength(ph7_vm *pVm)` |
|        2 |   484 |  |
|  1271008 |   485 | `	return SySetUsed(pVm->pByteContainer);` |
|        2 |   486 |  |
|        - |   487 | `/*` |
|        - |   488 | ` * Pop the last VM instruction.` |
|        - |   489 | ` */` |
|   209620 |   490 | `PH7_PRIVATE VmInstr * PH7_VmPopInstr(ph7_vm *pVm)` |
|        2 |   491 |  |
|   209622 |   492 | `	return (VmInstr *)SySetPop(pVm->pByteContainer);` |
|        2 |   493 |  |
|        - |   494 | `/*` |
|        - |   495 | ` * Peek the last VM instruction.` |
|        - |   496 | ` */` |
|   833138 |   497 | `PH7_PRIVATE VmInstr * PH7_VmPeekInstr(ph7_vm *pVm)` |
|        2 |   498 |  |
|   833140 |   499 | `	return (VmInstr *)SySetPeek(pVm->pByteContainer);` |
|        2 |   500 |  |
...
|        - |   514 | ` */` |
|    21950 |   515 | `static VmFrame * VmNewFrame(` |
...
|    21952 |   523 | `	pFrame = (VmFrame *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmFrame));` |
|    21952 |   524 | `	if( pFrame == 0 ){` |
|      ! 0 |   525 | `		return 0;` |
|        - |   526 | `	}` |
|        - |   527 | `	/* Zero the structure */` |
|    21952 |   528 | `	SyZero(pFrame,sizeof(VmFrame));` |
|        - |   529 | `	/* Initialize frame fields */` |
|    21952 |   530 | `	pFrame->pUserData = pUserData;` |
|    21952 |   531 | `	pFrame->pThis = pThis;` |
|    21952 |   532 | `	pFrame->pVm = pVm;` |
|    21952 |   533 | `	SyHashInit(&pFrame->hVar,&pVm->sAllocator,0,0);` |
|    21952 |   534 | `	SySetInit(&pFrame->sArg,&pVm->sAllocator,sizeof(VmSlot));` |
|    21952 |   535 | `	SySetInit(&pFrame->sLocal,&pVm->sAllocator,sizeof(VmSlot));` |
|    21952 |   536 | `	SySetInit(&pFrame->sRef,&pVm->sAllocator,sizeof(VmSlot));` |
|    21952 |   537 | `	return pFrame;` |
|    10977 |   538 |  |
...
|        - |   543 | ` */` |
|    21904 |   544 | `static sxi32 VmEnterFrame(` |
...
|    21906 |   553 | `	pFrame = VmNewFrame(&(*pVm),pUserData,pThis);` |
|    21906 |   554 | `	if( pFrame == 0 ){` |
|      ! 0 |   555 | `		return SXERR_MEM;` |
|        - |   556 | `	}` |
|        - |   557 | `	/* Link to the list of active VM frame */` |
|    21906 |   558 | `	pFrame->pParent = pVm->pFrame;` |
|    21906 |   559 | `	pVm->pFrame = pFrame;` |
|    21906 |   560 | `	if( ppFrame ){` |
|        - |   561 | `		/* Write a pointer to the new VM frame */` |
|    18784 |   562 | `		*ppFrame = pFrame;` |
|     9391 |   563 | `	}` |
|    21906 |   564 | `	return SXRET_OK;` |
|    10954 |   565 |  |
|        - |   566 | `/*` |
...
|        - |   608 | ` */` |
|    18772 |   609 | `static void VmLeaveFrame(ph7_vm *pVm)` |
|        2 |   610 |  |
|    18774 |   611 | `		VmFrame *pCurFrame = pVm->pFrame;` |
|    18774 |   612 | `	if( pCurFrame ){` |
|        - |   613 | `		/* Unlink from the list of active VM frame */` |
|    18774 |   614 | `		pVm->pFrame = pCurFrame->pParent;` |
|    18774 |   615 | `		if( pCurFrame->pParent && (pCurFrame->iFlags & VM_FRAME_EXCEPTION) == 0 ){` |
|        - |   616 | `			VmSlot  *aSlot;` |
|        - |   617 | `			sxu32 n;` |
|        - |   618 | `			/* Restore local variable to the free pool so that they can be reused again */` |
|    18424 |   619 | `			aSlot = (VmSlot *)SySetBasePtr(&pCurFrame->sLocal);` |
|   122112 |   620 | `			for(n = 0 ; n < SySetUsed(&pCurFrame->sLocal) ; ++n ){` |
|        - |   621 | `				/* Unset the local variable */` |
|   103690 |   622 | `				PH7_VmUnsetMemObj(&(*pVm),aSlot[n].nIdx,FALSE);` |
|    51846 |   623 | `			}` |
|        - |   624 | `			/* Remove local reference */` |
|    18424 |   625 | `			aSlot = (VmSlot *)SySetBasePtr(&pCurFrame->sRef);` |
|   122174 |   626 | `			for(n = 0 ; n < SySetUsed(&pCurFrame->sRef) ; ++n ){` |
|   103752 |   627 | `				PH7_VmRefObjRemove(&(*pVm),aSlot[n].nIdx,(SyHashEntry *)aSlot[n].pUserData,0);` |
|    51877 |   628 | `			}` |
|     9211 |   629 | `		}` |
|        - |   630 | `		/* Release internal containers */` |
|    18774 |   631 | `		SyHashRelease(&pCurFrame->hVar);` |
|    18774 |   632 | `		SySetRelease(&pCurFrame->sArg);` |
|    18774 |   633 | `		SySetRelease(&pCurFrame->sLocal);` |
|    18774 |   634 | `		SySetRelease(&pCurFrame->sRef);` |
|        - |   635 | `		/* Release the whole structure */` |
|    18774 |   636 | `		SyMemBackendPoolFree(&pVm->sAllocator,pCurFrame);` |
|     9386 |   637 | `	}` |
|    18774 |   638 |  |
|        - |   639 | `/*` |
...
|        - |   643 | ` */` |
|  7044100 |   644 | `static VmFrame * VmSkipExceptionFrames(VmFrame *pFrame)` |
|        2 |   645 |  |
|  7046218 |   646 | `	while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|     2118 |   647 | `		pFrame = pFrame->pParent;` |
|        2 |   648 | `	}` |
|  7044102 |   649 | `	return pFrame;` |
|        2 |   650 |  |
|        - |   651 | `/*` |
...
|        - |   787 | ` */` |
|   257610 |   788 | `PH7_PRIVATE sxi32 VmMountUserClass(` |
...
|   257612 |   798 | `	SyHashResetLoopCursor(&pClass->hAttr);` |
|        - |   799 | `	/* Process only static and constant attribute */` |
|   787353 |   800 | `	while( (pEntry = SyHashGetNextEntry(&pClass->hAttr)) != 0 ){` |
|        - |   801 | `		/* Extract the current attribute */` |
|   400938 |   802 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|   400938 |   803 | `		if( pAttr->iFlags & (PH7_CLASS_ATTR_CONSTANT\|PH7_CLASS_ATTR_STATIC) ){` |
|        - |   804 | `			ph7_value *pMemObj;` |
|        - |   805 | `			/* Reserve a memory object for this constant/static attribute */` |
|     1812 |   806 | `			pMemObj = PH7_ReserveMemObj(&(*pVm));` |
|     1812 |   807 | `			if( pMemObj == 0 ){` |
...
|        - |   813 | `			}` |
|     1812 |   814 | `			if( SySetUsed(&pAttr->aByteCode) > 0 ){` |
|        - |   815 | `				/* Initialize attribute default value (any complex expression) */` |
|     1808 |   816 | `				VmLocalExec(&(*pVm),&pAttr->aByteCode,pMemObj);` |
|      903 |   817 | `			}` |
|        - |   818 | `			/* Record attribute index */` |
|     1812 |   819 | `			pAttr->nIdx = pMemObj->nIdx;` |
|        - |   820 | `			/* Install static attribute in the reference table */` |
|     1812 |   821 | `			PH7_VmRefObjInstall(&(*pVm),pMemObj->nIdx,0,0,VM_REF_IDX_KEEP);` |
...
|     1812 |   826 | `			if( pAttr->iFlags & PH7_CLASS_ATTR_TYPED ){` |
...
|   257612 |   848 | `	if( pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|        - |   849 | `		/* Do not mount interface/trait methods since they are not directly invocable.` |
|        - |   850 | `		 */` |
|   173760 |   851 | `		return SXRET_OK;` |
|        - |   852 | `	}` |
...
|        - |   972 | ` */` |
|   452160 |   973 | `PH7_PRIVATE ph7_value * PH7_ReserveConstObj(ph7_vm *pVm,sxu32 *pIndex)` |
|        2 |   974 |  |
|        - |   975 | `	ph7_value *pObj;` |
|        - |   976 | `	sxi32 rc;` |
|   452162 |   977 | `	if( pIndex ){` |
|        - |   978 | `		/* Object index in the object table */` |
|   442796 |   979 | `		*pIndex = SySetUsed(&pVm->aLitObj);` |
|   221397 |   980 | `	}` |
|        - |   981 | `	/* Reserve a slot for the new object */` |
|   452162 |   982 | `	rc = SySetPut(&pVm->aLitObj,(const void *)zDummy);` |
|   452162 |   983 | `	if( rc != SXRET_OK ){` |
...
|      ! 0 |   987 | `		return 0;` |
|        - |   988 | `	}` |
|   452162 |   989 | `	pObj = (ph7_value *)SySetPeek(&pVm->aLitObj);` |
|   452162 |   990 | `	return pObj;` |
|   226082 |   991 |  |
|        - |   992 | `/*` |
|        - |   993 | ` * Reserve a memory object.` |
|        - |   994 | ` * Return a pointer to the raw ph7_value on success. NULL on failure.` |
|        - |   995 | ` */` |
|  2151368 |   996 | `PH7_PRIVATE ph7_value * VmReserveMemObj(ph7_vm *pVm,sxu32 *pIndex)` |
|        2 |   997 |  |
|        - |   998 | `	ph7_value *pObj;` |
|        - |   999 | `	sxi32 rc;` |
|  2151370 |  1000 | `	if( pIndex ){` |
|        - |  1001 | `		/* Object index in the object table */` |
|  2151370 |  1002 | `		*pIndex = SySetUsed(&pVm->aMemObj);` |
|  1075684 |  1003 | `	}` |
|        - |  1004 | `	/* Reserve a slot for the new object */` |
|  2151370 |  1005 | `	rc = SySetPut(&pVm->aMemObj,(const void *)zDummy);` |
|  2151370 |  1006 | `	if( rc != SXRET_OK ){` |
...
|      ! 0 |  1010 | `		return 0;` |
|        - |  1011 | `	}` |
|  2151370 |  1012 | `	pObj = (ph7_value *)SySetPeek(&pVm->aMemObj);` |
|  2151370 |  1013 | `	return pObj;` |
|  1075686 |  1014 |  |
...
|        - |  1682 | ` */` |
|    19648 |  1683 | `static void VmTrackOutput(ph7_vm *pVm, sxu32 nLen)` |
|        2 |  1684 |  |
|    19650 |  1685 | `	ProcConsumer xCons = pVm->sVmConsumer.xConsumer;` |
|    19650 |  1686 | `	if( xCons != VmObConsumer ){` |
|     8094 |  1687 | `		pVm->nOutputLen += nLen;` |
|     8094 |  1688 | `		if( !pVm->bHeadersSent && xCons != PH7_VmBlobConsumer ){` |
...
|        - |  1699 | ` */` |
|    44040 |  1700 | `static ph7_value * VmNewOperandStack(` |
...
|        - |  1712 | `  */` |
|    44042 |  1713 | `	nInstr += VM_STACK_GUARD;` |
|    44042 |  1714 | `	pStack = (ph7_value *)SyMemBackendAlloc(&pVm->sAllocator,nInstr * sizeof(ph7_value));` |
|    44042 |  1715 | `	if( pStack == 0 ){` |
|      ! 0 |  1716 | `		return 0;` |
|        - |  1717 | `	}` |
|        - |  1718 | `	/* Initialize the operand stack */` |
|  2992138 |  1719 | `	while( nInstr > 0 ){` |
|  2948098 |  1720 | `		PH7_MemObjInit(&(*pVm),&pStack[nInstr - 1]);` |
|  2948098 |  1721 | `		--nInstr;` |
|        2 |  1722 | `	}` |
|        - |  1723 | `	/* Ready for bytecode execution */` |
|    44042 |  1724 | `	return pStack;` |
|    22022 |  1725 |  |
...
|        - |  1849 | ` */` |
|   686686 |  1850 | `static sxi32 VmInitCallContext(` |
...
|        - |  1856 | `	)` |
|        2 |  1857 |  |
|   686688 |  1858 | `	pOut->pFunc = pFunc;` |
|   686688 |  1859 | `	pOut->pVm   = pVm;` |
|   686688 |  1860 | `	SySetInit(&pOut->sVar,&pVm->sAllocator,sizeof(ph7_value *));` |
|   686688 |  1861 | `	SySetInit(&pOut->sChunk,&pVm->sAllocator,sizeof(ph7_aux_data));` |
|        - |  1862 | `	/* Assume a null return value */` |
|   686688 |  1863 | `	MemObjSetType(pRet,MEMOBJ_NULL);` |
|   686688 |  1864 | `	pOut->pRet = pRet;` |
|   686688 |  1865 | `	pOut->iFlags = iFlags;` |
|   686688 |  1866 | `	return SXRET_OK;` |
|        2 |  1867 |  |
|        - |  1868 | `/*` |
|        - |  1869 | ` * Release a foreign function call context and cleanup the mess` |
|        - |  1870 | ` * left behind.` |
|        - |  1871 | ` */` |
|   686686 |  1872 | `static void VmReleaseCallContext(ph7_context *pCtx)` |
|        2 |  1873 |  |
|        - |  1874 | `	sxu32 n;` |
|   686688 |  1875 | `	if( SySetUsed(&pCtx->sVar) > 0 ){` |
|     8432 |  1876 | `		ph7_value **apObj = (ph7_value **)SySetBasePtr(&pCtx->sVar);` |
|    24608 |  1877 | `		for( n = 0 ; n < SySetUsed(&pCtx->sVar) ; ++n ){` |
|    16178 |  1878 | `			if( apObj[n] == 0 ){` |
|        - |  1879 | `				/* Already released */` |
|      318 |  1880 | `				continue;` |
|        - |  1881 | `			}` |
|    15862 |  1882 | `			PH7_MemObjRelease(apObj[n]);` |
|    15862 |  1883 | `			SyMemBackendPoolFree(&pCtx->pVm->sAllocator,apObj[n]);` |
|     7932 |  1884 | `		}` |
|     8432 |  1885 | `		SySetRelease(&pCtx->sVar);` |
|     4215 |  1886 | `	}` |
|   686688 |  1887 | `	if( SySetUsed(&pCtx->sChunk) > 0 ){` |
...
|        - |  1933 | ` */` |
|  3905016 |  1934 | `static void VmPopOperand(` |
|        - |  1935 | `	ph7_value **ppTos, /* Operand stack */` |
|        - |  1936 | `	sxi32 nPop         /* Total number of memory objects to pop */` |
|        - |  1937 | `	)` |
|        2 |  1938 |  |
|  3905018 |  1939 | `	ph7_value *pTos = *ppTos;` |
|  8316690 |  1940 | `	while( nPop > 0 ){` |
|  4411674 |  1941 | `		PH7_MemObjRelease(pTos);` |
|  4411674 |  1942 | `		pTos--;` |
|  4411674 |  1943 | `		nPop--;` |
|        2 |  1944 | `	}` |
|        - |  1945 | `	/* Top of the stack */` |
|  3905018 |  1946 | `	*ppTos = pTos;` |
|  3905018 |  1947 |  |
|        - |  1948 | `/*` |
|        - |  1949 | ` * Reserve a memory object.` |
|        - |  1950 | ` * Return a pointer to the raw ph7_value on success. NULL on failure.` |
|        - |  1951 | ` */` |
|  3179054 |  1952 | `PH7_PRIVATE ph7_value * PH7_ReserveMemObj(ph7_vm *pVm)` |
|        2 |  1953 |  |
|  3179056 |  1954 | `	ph7_value *pObj = 0;` |
|        - |  1955 | `	VmSlot *pSlot;` |
|        - |  1956 | `	sxu32 nIdx;` |
|        - |  1957 | `	/* Check for a free slot */` |
|  3179056 |  1958 | `	nIdx = SXU32_HIGH; /* cc warning */` |
|  3179056 |  1959 | `	pSlot = (VmSlot *)SySetPop(&pVm->aFreeObj);` |
|  3179056 |  1960 | `	if( pSlot ){` |
|  1027688 |  1961 | `		pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pSlot->nIdx);` |
|  1027688 |  1962 | `		nIdx = pSlot->nIdx;` |
|   513843 |  1963 | `	}` |
|  3179056 |  1964 | `	if( pObj == 0 ){` |
|        - |  1965 | `		/* Reserve a new memory object */` |
|  2151370 |  1966 | `		pObj = VmReserveMemObj(&(*pVm),&nIdx);` |
|  2151370 |  1967 | `		if( pObj == 0 ){` |
|      ! 0 |  1968 | `			return 0;` |
|        - |  1969 | `		}` |
|  1075684 |  1970 | `	}` |
|        - |  1971 | `	/* Set a null default value */` |
|  3179056 |  1972 | `	PH7_MemObjInit(&(*pVm),pObj);` |
|  3179056 |  1973 | `	pObj->nIdx = nIdx;` |
|  3179056 |  1974 | `	return pObj;` |
|  1589529 |  1975 |  |
|        - |  1976 | `/*` |
|        - |  1977 | ` * Insert an entry by reference (not copy) in the given hashmap.` |
|        - |  1978 | ` */` |
|    35054 |  1979 | `static sxi32 VmHashmapRefInsert(` |
...
|        - |  1986 | `	ph7_value sKey;` |
|        - |  1987 | `	sxi32 rc;` |
|    35056 |  1988 | `	PH7_MemObjInitFromString(pMap->pVm,&sKey,0);` |
|    35056 |  1989 | `	PH7_MemObjStringAppend(&sKey,zKey,nByte);` |
|        - |  1990 | `	/* Perform the insertion */` |
|    35056 |  1991 | `	rc = PH7_HashmapInsertByRef(&(*pMap),&sKey,nRefIdx);` |
|    35056 |  1992 | `	PH7_MemObjRelease(&sKey);` |
|    35056 |  1993 | `	return rc;` |
|        2 |  1994 |  |
|        - |  1995 | `/*` |
...
|        - |  1999 | ` */` |
|  3628366 |  2000 | `static ph7_value * VmExtractMemObj(` |
...
|        - |  2005 | `	)` |
|        2 |  2006 |  |
|  3628368 |  2007 | `	int bNullify = FALSE;` |
...
|  3628368 |  2014 | `	pFrame = pVm->pFrame;` |
|  3628368 |  2015 | `	pFrame = VmSkipExceptionFrames(pFrame);` |
|        - |  2016 | `	/* Perform the lookup */` |
|  3628368 |  2017 | `	if( pName == 0 \|\| pName->nByte < 1 ){` |
...
|  3628368 |  2025 | `	pEntry = SyHashGet(&pVm->hSuper,(const void *)pName->zString,pName->nByte);` |
|  3628368 |  2026 | `	if( pEntry == 0 ){` |
|        - |  2027 | `		/* Query the top active frame */` |
|  3628328 |  2028 | `		pEntry = SyHashGet(&pFrame->hVar,(const void *)pName->zString,pName->nByte);` |
|  3628328 |  2029 | `		if( pEntry == 0 ){` |
|   111612 |  2030 | `			char *zName = (char *)pName->zString;` |
|        - |  2031 | `			VmSlot sLocal;` |
|   111612 |  2032 | `			if( !bCreate ){` |
...
|        - |  2038 | `			 */` |
|   110684 |  2039 | `			pObj = PH7_ReserveMemObj(&(*pVm));` |
|   110684 |  2040 | `			if( pObj == 0 ){` |
|      ! 0 |  2041 | `				return 0;` |
|        - |  2042 | `			}` |
|   110684 |  2043 | `			nIdx = pObj->nIdx;` |
|   110684 |  2044 | `			if( bDup ){` |
|        - |  2045 | `				/* Duplicate name */` |
...
|   110684 |  2052 | `			rc = SyHashInsert(&pFrame->hVar,zName,pName->nByte,SX_INT_TO_PTR(nIdx));` |
|   110684 |  2053 | `			if( rc != SXRET_OK ){` |
...
|      ! 0 |  2058 | `				return 0;` |
|        - |  2059 | `			}` |
|   110684 |  2060 | `			if( pFrame->pParent != 0 ){` |
|        - |  2061 | `				/* Local variable */` |
|   103738 |  2062 | `				sLocal.nIdx = nIdx;` |
|   103738 |  2063 | `				SySetPut(&pFrame->sLocal,(const void *)&sLocal);` |
|    51870 |  2064 | `			}else{` |
|        - |  2065 | `				/* Register in the $GLOBALS array */` |
|     6948 |  2066 | `				VmHashmapRefInsert(pVm->pGlobal,pName->zString,pName->nByte,nIdx);` |
|        - |  2067 | `			}` |
|        - |  2068 | `			/* Install in the reference table */` |
|   110684 |  2069 | `			PH7_VmRefObjInstall(&(*pVm),nIdx,SyHashLastEntry(&pFrame->hVar),0,0);` |
|        - |  2070 | `			/* Save object index */` |
|   110684 |  2071 | `			pObj->nIdx = nIdx;` |
|    55343 |  2072 | `		}else{` |
|        - |  2073 | `			/* Extract variable contents */` |
|  3516718 |  2074 | `			nIdx = (sxu32)SX_PTR_TO_INT(pEntry->pUserData);` |
|  3516718 |  2075 | `			pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|  3516718 |  2076 | `			if( bNullify && pObj ){` |
...
|        - |  3969 | ` */` |
|    44138 |  3970 | `static sxi32 VmByteCodeExec(` |
...
|    44140 |  3989 | `	SySetInit(&aArg,&pVm->sAllocator,sizeof(ph7_value *));` |
|    44140 |  3990 | `	if( nTos < 0 ){` |
|    41100 |  3991 | `		pTos = &pStack[-1];` |
|    20551 |  3992 | `	}else{` |
|     3042 |  3993 | `		pTos = &pStack[nTos];` |
|        - |  3994 | `	}` |
|    44140 |  3995 | `	nExceptionBase = SySetUsed(&pVm->aException);` |
|    44140 |  3996 | `	pc = nPc;` |
|        - |  3997 | `/*` |
...
| 11679752 |  4019 | `		pInstr = &aInstr[pc];` |
| 11679752 |  4020 | `		rc = SXRET_OK;` |
|        - |  4021 | `/*` |
...
|        - |  4027 | ` */` |
| 11679752 |  4028 | `		switch(pInstr->iOp){` |
|        - |  4029 | `/*` |
|        - |  4030 | ` * DONE: P1 * *` |
|        - |  4031 | ` *` |
...
|    43408 |  4040 | `	if( pEnforceRetFunc && pEnforceRetFunc->nReturnType > 0 ){` |
...
|      185 |  4058 | `	}` |
|    43402 |  4059 | `	if( pInstr->iP1 ){` |
|        - |  4060 | `#ifdef UNTRUST` |
|        - |  4061 | `		if( pTos < pStack ){` |
|        - |  4062 | `			goto Abort;` |
|        - |  4063 | `		}` |
|        - |  4064 | `#endif` |
|    26336 |  4065 | `		if( pLastRef ){` |
|    16116 |  4066 | `			*pLastRef = pTos->nIdx;` |
|     8057 |  4067 | `		}` |
|    26336 |  4068 | `		if( pResult ){` |
|        - |  4069 | `			/* Execution result */` |
|    24892 |  4070 | `			PH7_MemObjStore(pTos,pResult);` |
|    12445 |  4071 | `		}` |
|    26336 |  4072 | `		VmPopOperand(&pTos,1);` |
|    30235 |  4073 | `	}else if( pLastRef ){` |
|        - |  4074 | `		/* Nothing referenced */` |
|     1888 |  4075 | `		*pLastRef = SXU32_HIGH;` |
|      943 |  4076 | `	}` |
...
|        - |  4084 | `	 */` |
|    43404 |  4085 | `	while( SySetUsed(&pVm->aException) > nExceptionBase ){` |
...
|        - |  4144 | ` */` |
|   249175 |  4145 | `case PH7_OP_JMP:` |
|   498396 |  4146 | `	pc = pInstr->iP2 - 1;` |
|   498396 |  4147 | `	break;` |
|        - |  4148 | `/*` |
|        - |  4149 | ` * JZ: P1 P2 *` |
|        - |  4150 | ` *` |
...
|  1182860 |  4161 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      172 |  4162 | `		PH7_MemObjToBool(pTos);` |
|       85 |  4163 | `	}` |
|  1182860 |  4164 | `	if( !pTos->x.iVal ){` |
|        - |  4165 | `		/* Take the jump */` |
|   607920 |  4166 | `		pc = pInstr->iP2 - 1;` |
|   303959 |  4167 | `	}` |
|  1182860 |  4168 | `	if( !pInstr->iP1 ){` |
|   938132 |  4169 | `		VmPopOperand(&pTos,1);` |
|   469087 |  4170 | `	}` |
|  1182860 |  4171 | `	break;` |
|        - |  4172 | `/*` |
|        - |  4173 | ` * JNZ: P1 P2 *` |
...
|   122532 |  4185 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      ! 0 |  4186 | `		PH7_MemObjToBool(pTos);` |
|      ! 0 |  4187 | `	}` |
|   122532 |  4188 | `	if( pTos->x.iVal ){` |
|        - |  4189 | `		/* Take the jump */` |
|     5508 |  4190 | `		pc = pInstr->iP2 - 1;` |
|     2753 |  4191 | `	}` |
|   122532 |  4192 | `	if( !pInstr->iP1 ){` |
...
|        - |  4208 | ` */` |
|   455949 |  4209 | `case PH7_OP_POP: {` |
|   911944 |  4210 | `	sxi32 n = pInstr->iP1;` |
|   911944 |  4211 | `	if( &pTos[-n+1] < pStack ){` |
|        - |  4212 | `		/* TICKET 1433-51 Stack underflow must be handled at run-time */` |
|       50 |  4213 | `		n = (sxi32)(pTos - pStack);` |
|       24 |  4214 | `	}` |
|   911944 |  4215 | `	VmPopOperand(&pTos,n);` |
|   911944 |  4216 | `	break;` |
|        - |  4217 | `				 }` |
|        - |  4218 | `/*` |
|        - |  4219 | ` * DUP: * * *` |
...
|        - |  4238 | ` */` |
|     7719 |  4239 | `case PH7_OP_NSSWITCH:` |
|    15440 |  4240 | `	SyBlobReset(&pVm->sNamespace);` |
|    15440 |  4241 | `	if( pInstr->p3 ){` |
...
|    15440 |  4246 | `	SyHashRelease(&pVm->hUseConstImports);` |
|    15440 |  4247 | `	SyHashInit(&pVm->hUseConstImports,&pVm->sAllocator,0,0);` |
|    15440 |  4248 | `	break;` |
...
|        - |  4391 | ` */` |
|    15802 |  4392 | `case PH7_OP_ERR_CTRL:` |
|        - |  4393 | `	/*` |
...
|        - |  4457 | ` */` |
|  1001357 |  4458 | `case PH7_OP_LOADC: {` |
|        - |  4459 | `	ph7_value *pObj;` |
|        - |  4460 | `	/* Reserve a room */` |
|  2002760 |  4461 | `	pTos++;` |
|  2994456 |  4462 | `	if( (pObj = (ph7_value *)SySetAt(&pVm->aLitObj,pInstr->iP2)) != 0 ){` |
|  2002760 |  4463 | `		if( (pInstr->iP1 & PH7_LOADC_EXPAND) && SyBlobLength(&pObj->sBlob) <= 64 ){` |
|        - |  4464 | `			SyHashEntry *pEntry;` |
|        - |  4465 | `			/* Check use const imports first — imports take precedence */` |
|        - |  4466 | `			{` |
|        - |  4467 | `				SyHashEntry *pConstImport;` |
|    29123 |  4468 | `				pConstImport = SyHashGet(&pVm->hUseConstImports,` |
|    19414 |  4469 | `					SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|    19416 |  4470 | `				if( pConstImport ){` |
...
|    19406 |  4485 | `			pEntry = SyHashGet(&pVm->hConstant,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|    19406 |  4486 | `			if( pEntry ){` |
|    19400 |  4487 | `				ph7_constant *pCons = (ph7_constant *)pEntry->pUserData;` |
|        - |  4488 | `				/* Set a NULL default value */` |
|    19400 |  4489 | `				MemObjSetType(pTos,MEMOBJ_NULL);` |
|    19400 |  4490 | `				SyBlobReset(&pTos->sBlob);` |
|        - |  4491 | `				/* Invoke the callback and deal with the expanded value */` |
|    19400 |  4492 | `				pCons->xExpand(pTos,pCons->pUserData);` |
|        - |  4493 | `				/* Mark as constant */` |
|    19400 |  4494 | `				pTos->nIdx = SXU32_HIGH;` |
|    19400 |  4495 | `				break;` |
|        - |  4496 | `			}` |
...
|        - |  4542 | `			}` |
|        2 |  4543 | `		}` |
|  1983350 |  4544 | `		PH7_MemObjLoad(pObj,pTos);` |
|   991698 |  4545 | `	}else{` |
|        - |  4546 | `		/* Set a NULL value */` |
|      ! 0 |  4547 | `		MemObjSetType(pTos,MEMOBJ_NULL);` |
|        - |  4548 | `	}` |
|   991653 |  4549 | `LoadC_Done:` |
|        - |  4550 | `	/* Mark as constant */` |
|  1983352 |  4551 | `	pTos->nIdx = SXU32_HIGH;` |
|  1983352 |  4552 | `	break;` |
|        - |  4553 | `				  }` |
|        - |  4554 | `/*` |
|        - |  4555 | ` * LOAD: P1 * P3` |
...
|        - |  4561 | ` */` |
|  1563058 |  4562 | `case PH7_OP_LOAD:{` |
|        - |  4563 | `	ph7_value *pObj;` |
|        - |  4564 | `	SyString sName;` |
|  3126338 |  4565 | `	if( pInstr->p3 == 0 ){` |
...
|       10 |  4577 | `	}else{` |
|  3126320 |  4578 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - |  4579 | `		/* Reserve a room for the target object */` |
|  3126320 |  4580 | `		pTos++;` |
|        - |  4581 | `	}` |
|        - |  4582 | `	/* Extract the requested memory object */` |
|  3126338 |  4583 | `	pObj = VmExtractMemObj(&(*pVm),&sName,pInstr->p3 ? FALSE : TRUE,pInstr->iP1 != 1);` |
|  3126338 |  4584 | `	if( pObj == 0 ){` |
...
|  3125504 |  4601 | `	PH7_MemObjLoad(pObj,pTos);` |
|  3125504 |  4602 | `	pTos->nIdx = pObj->nIdx;` |
|  3125504 |  4603 | `	break;` |
|        - |  4604 | `				   }` |
|        - |  4605 | `/*` |
|        - |  4606 | ` * LOAD_MAP P1 * *` |
...
|        - |  4611 | ` */` |
|    22375 |  4612 | `case PH7_OP_LOAD_MAP: {` |
|        - |  4613 | `	ph7_hashmap *pMap;` |
|        - |  4614 | `	/* Allocate a new hashmap instance */` |
|    44752 |  4615 | `	pMap = PH7_NewHashmap(&(*pVm),0,0);` |
|    44752 |  4616 | `	if( pMap == 0 ){` |
...
|      ! 0 |  4619 | `		goto Abort;` |
|        - |  4620 | `	}` |
|    44752 |  4621 | `	if( pInstr->iP1 > 0 ){` |
|     2620 |  4622 | `		ph7_value *pEntry = &pTos[-pInstr->iP1+1]; /* Point to the first entry */` |
|     2620 |  4623 | `		sxi32 rcSpread = SXRET_OK;` |
|        - |  4624 | `		/* Perform the insertion */` |
|     7988 |  4625 | `		while( pEntry < pTos ){` |
|     5386 |  4626 | `			if( pEntry[1].iFlags & MEMOBJ_AUX_SPREAD ){` |
...
|       17 |  4644 | `					break;` |
|        1 |  4645 | `				}` |
|     5344 |  4646 | `			}else if( pEntry[1].iFlags & MEMOBJ_REFERENCE ){` |
...
|     7826 |  4654 | `				PH7_HashmapInsert(pMap,` |
|     5216 |  4655 | `					(pEntry->iFlags & MEMOBJ_NULL) ? 0 /* Automatic index assign */ : pEntry,` |
|     2608 |  4656 | `					&pEntry[1]` |
|        - |  4657 | `				);` |
|        - |  4658 | `			}` |
...
|     2620 |  4663 | `		VmPopOperand(&pTos,pInstr->iP1);` |
|     2620 |  4664 | `		if( rcSpread != SXRET_OK ){` |
...
|    44736 |  4681 | `	pTos++;` |
|    44736 |  4682 | `	pTos->nIdx = SXU32_HIGH;` |
|    44736 |  4683 | `	pTos->x.pOther = pMap;` |
|    44736 |  4684 | `	MemObjSetType(pTos,MEMOBJ_HASHMAP);` |
|    44736 |  4685 | `	break;` |
|        - |  4686 | `					  }` |
|        - |  4687 | `/*` |
|        - |  4688 | ` * LOAD_LIST: P1 * *` |
...
|        - |  4772 | ` * instead.` |
|        - |  4773 | ` */` |
|   249867 |  4774 | `case PH7_OP_LOAD_IDX: {` |
|   499780 |  4775 | `	ph7_hashmap_node *pNode = 0; /* cc warning */` |
|   499780 |  4776 | `	ph7_hashmap *pMap = 0;` |
|        - |  4777 | `	ph7_value *pIdx;` |
|   499780 |  4778 | `	pIdx = 0;` |
|   499780 |  4779 | `	if( pInstr->iP1 == 0 ){` |
...
|        - |  4794 | `		}` |
|      ! 0 |  4795 | `	}else{` |
|   499780 |  4796 | `		pIdx = pTos;` |
|   499780 |  4797 | `		pTos--;` |
|        - |  4798 | `	}` |
|   499780 |  4799 | `	if( pTos->iFlags & MEMOBJ_STRING ){` |
|        - |  4800 | `		/* String access */` |
|   387716 |  4801 | `		if( pIdx ){` |
|        - |  4802 | `			sxu32 nOfft;` |
...
|   387716 |  4822 | `		break;` |
|        - |  4823 | `	}` |
|   112066 |  4824 | `	if( pTos->iFlags & MEMOBJ_OBJ ){` |
...
|        - |  4983 | `		}` |
|      ! 0 |  4984 | `	}` |
|   111942 |  4985 | `	if( (pInstr->iP2 == 1 \|\| pInstr->iP2 == 3 \|\| pInstr->iP2 == 5) && (pTos->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
...
|        1 |  4992 | `		}` |
|        1 |  4993 | `	}` |
|   111942 |  4994 | `	rc = SXERR_NOTFOUND; /* Assume the index is invalid */` |
|   111942 |  4995 | `	if( pTos->iFlags & MEMOBJ_HASHMAP ){` |
|   111942 |  4996 | `		if( pInstr->iP2 == 1 \|\| pInstr->iP2 == 5 ){` |
...
|   111942 |  5006 | `		pMap = (ph7_hashmap *)pTos->x.pOther;` |
|   111942 |  5007 | `		if( pIdx ){` |
|        - |  5008 | `			/* Load the desired entry */` |
|   111942 |  5009 | `			rc = PH7_HashmapLookup(pMap,pIdx,&pNode);` |
|    55970 |  5010 | `		}` |
|   111942 |  5011 | `		if( pInstr->iP2 == 3 ){` |
...
|        6 |  5037 | `			}` |
|        9 |  5038 | `		}` |
|   111942 |  5039 | `		if( rc != SXRET_OK && (pInstr->iP2 == 1 \|\| pInstr->iP2 == 3 \|\| pInstr->iP2 == 5) ){` |
...
|      136 |  5046 | `		}` |
|    55970 |  5047 | `	}` |
|   111942 |  5048 | `	if( rc != SXRET_OK && pInstr->iP2 == 2 && pIdx ){` |
...
|      ! 0 |  5056 | `	}` |
|   111942 |  5057 | `	if( pIdx ){` |
|   111942 |  5058 | `		PH7_MemObjRelease(pIdx);` |
|    55970 |  5059 | `	}` |
|   111942 |  5060 | `	if( rc == SXRET_OK ){` |
|        - |  5061 | `		/* Load entry contents */` |
|    49672 |  5062 | `		if( pMap->iRef < 2 ){` |
...
|       15 |  5068 | `		}else{` |
|    49646 |  5069 | `			pTos->nIdx = pNode->nValIdx;` |
|    49646 |  5070 | `			PH7_HashmapExtractNodeValue(pNode,pTos,FALSE);` |
|    49646 |  5071 | `			PH7_HashmapUnref(pMap);` |
|        - |  5072 | `		}` |
|    24837 |  5073 | `	}else{` |
|        - |  5074 | `		/* No such entry,load NULL */` |
|    62272 |  5075 | `		PH7_MemObjRelease(pTos);` |
|    62272 |  5076 | `		pTos->nIdx = SXU32_HIGH;` |
|        - |  5077 | `	}` |
|   111942 |  5078 | `	break;` |
|        - |  5079 | `					  }` |
|        - |  5080 | `/*` |
...
|        - |  5203 | `		}` |
|     5056 |  5204 | `		break;` |
|   277442 |  5205 | `	}else if( pInstr->p3 == 0 ){` |
...
|        - |  5240 | ` */` |
|    95802 |  5241 | `case PH7_OP_STORE_IDX:` |
|        - |  5242 | `case PH7_OP_STORE_IDX_REF: {` |
|   191606 |  5243 | `	ph7_hashmap *pMap = 0; /* cc  warning */` |
|        - |  5244 | `	ph7_value *pKey;` |
|        - |  5245 | `	sxu32 nIdx;` |
|   191606 |  5246 | `	if( pInstr->iP1 ){` |
|        - |  5247 | `		/* Key is next on stack */` |
|    62874 |  5248 | `		pKey = pTos;` |
|    62874 |  5249 | `		pTos--;` |
|    31438 |  5250 | `	}else{` |
|   128734 |  5251 | `		pKey = 0;` |
|        - |  5252 | `	}` |
|   191606 |  5253 | `	nIdx = pTos->nIdx;` |
|        - |  5254 | `	{` |
...
|   191606 |  5258 | `		ph7_class_instance *pInst = 0;` |
|   191606 |  5259 | `		if( pTos->iFlags & MEMOBJ_OBJ ){` |
|       34 |  5260 | `			pInst = (ph7_class_instance *)pTos->x.pOther;` |
|   191590 |  5261 | `		}else if( nIdx != SXU32_HIGH ){` |
|   191574 |  5262 | `			ph7_value *pBacking = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|   191574 |  5263 | `			if( pBacking && (pBacking->iFlags & MEMOBJ_OBJ) ){` |
|      ! 0 |  5264 | `				pInst = (ph7_class_instance *)pBacking->x.pOther;` |
|      ! 0 |  5265 | `			}` |
|    95786 |  5266 | `		}` |
|   191606 |  5267 | `		if( pInst ){` |
...
|        - |  5319 | `		}` |
|        - |  5320 | `	}` |
|   191574 |  5321 | `	if( pTos->iFlags & MEMOBJ_HASHMAP ){` |
...
|   191522 |  5325 | `		if( nIdx != SXU32_HIGH ){` |
|   191522 |  5326 | `			ph7_value *pBacking = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|   287282 |  5327 | `			if( pBacking && (pBacking->iFlags & MEMOBJ_HASHMAP) ){` |
|   191522 |  5328 | `				ph7_hashmap *pCur = (ph7_hashmap *)pTos->x.pOther;` |
...
|   191522 |  5333 | `				if( pBacking->x.pOther == (void *)pCur ){` |
|   191522 |  5334 | `					pCur->iRef--;  /* Undo stack ref to reveal true sharing count */` |
|   191522 |  5335 | `					pMap = PH7_HashmapCowSeparate(&(*pVm),pBacking);` |
|   191522 |  5336 | `					pMap->iRef++;  /* Re-add stack ref */` |
|   191522 |  5337 | `					pTos->x.pOther = pMap;` |
|    95762 |  5338 | `				}else{` |
...
|        - |  5410 | `	}` |
|   191522 |  5411 | `	VmPopOperand(&pTos,1);` |
|        - |  5412 | `	/* Phase#2: Perform the insertion */` |
|   191522 |  5413 | `	if( pInstr->iOp == PH7_OP_STORE_IDX_REF && pTos->nIdx != SXU32_HIGH ){` |
|        - |  5414 | `		/* Insertion by reference */` |
|       15 |  5415 | `		PH7_HashmapInsertByRef(pMap,pKey,pTos->nIdx);` |
|        8 |  5416 | `	}else{` |
|   191508 |  5417 | `		PH7_HashmapInsert(pMap,pKey,pTos);` |
|        - |  5418 | `	}` |
|   191522 |  5419 | `	if( pKey ){` |
|    62798 |  5420 | `		PH7_MemObjRelease(pKey);` |
|    31398 |  5421 | `	}` |
|   191522 |  5422 | `	break;` |
|        - |  5423 | `					   }` |
|        - |  5424 | `/*` |
...
|        - |  5430 | ` */` |
|   167603 |  5431 | `case PH7_OP_INCR:` |
|        - |  5432 | `#ifdef UNTRUST` |
|        - |  5433 | `	if( pTos < pStack ){` |
|        - |  5434 | `		goto Abort;` |
|        - |  5435 | `	}` |
|        - |  5436 | `#endif` |
|   335252 |  5437 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) == 0 ){` |
|   335252 |  5438 | `		if( pTos->nIdx != SXU32_HIGH ){` |
|        - |  5439 | `			ph7_value *pObj;` |
|   335252 |  5440 | `			if( (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pTos->nIdx)) != 0 ){` |
|   335252 |  5441 | `				if( VmStringWantsPerlIncr(pObj) ){` |
...
|   335204 |  5461 | `					if( pInstr->iP1 == 0 && (pTos->iFlags & MEMOBJ_STRING) ){` |
|       13 |  5462 | `						SyBlobNullAppend(&pTos->sBlob);` |
|        6 |  5463 | `					}` |
|        - |  5464 | `					/* Force a numeric cast on the variable */` |
|   335204 |  5465 | `					PH7_MemObjToNumeric(pObj);` |
|   335204 |  5466 | `					if( pObj->iFlags & MEMOBJ_REAL ){` |
|        9 |  5467 | `						pObj->rVal++;` |
...
|        5 |  5473 | `					}else{` |
|   335196 |  5474 | `						pObj->x.iVal++;` |
|        - |  5475 | `					}` |
|   335204 |  5476 | `					if( pInstr->iP1 ){` |
...
|    58538 |  5591 | `	PH7_MemObjToNumeric(pTos);` |
|    58538 |  5592 | `	if( pTos->iFlags & MEMOBJ_REAL ){` |
|       31 |  5593 | `		pTos->rVal = -pTos->rVal;` |
|       15 |  5594 | `	}` |
|    58538 |  5595 | `	if( pTos->iFlags & MEMOBJ_INT ){` |
|    58508 |  5596 | `		pTos->x.iVal = -pTos->x.iVal;` |
|    29253 |  5597 | `	}` |
|    58538 |  5598 | `	break;` |
|        - |  5599 | `/*` |
|        - |  5600 | ` * UPLUS: * * *` |
...
|    89342 |  5632 | `	if( (pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|       23 |  5633 | `		PH7_MemObjToBool(pTos);` |
|       11 |  5634 | `	}` |
|    89342 |  5635 | `	pTos->x.iVal = !pTos->x.iVal;` |
|    89342 |  5636 | `	break;` |
|        - |  5637 | `/*` |
|        - |  5638 | ` * OP_BITNOT: * * *` |
|        - |  5639 | ` *` |
...
|        - |  6366 | ` * back.` |
|        - |  6367 | ` */` |
|    71182 |  6368 | `case PH7_OP_CAT:{` |
|        - |  6369 | `	ph7_value *pNos,*pCur;` |
|   142366 |  6370 | `	if( pInstr->iP1 < 1 ){` |
|   114886 |  6371 | `		pNos = &pTos[-1];` |
|    57444 |  6372 | `	}else{` |
...
|   142366 |  6381 | `	if( (pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|     1644 |  6382 | `		PH7_MemObjToString(pNos);` |
|      821 |  6383 | `	}` |
|   142366 |  6384 | `	pCur = &pNos[1];` |
|   287454 |  6385 | `	while( pCur <= pTos ){` |
|   145090 |  6386 | `		if( (pCur->iFlags & MEMOBJ_STRING) == 0 ){` |
|    50918 |  6387 | `			PH7_MemObjToString(pCur);` |
|    25458 |  6388 | `		}` |
|        - |  6389 | `		/* Perform the concatenation */` |
|   145090 |  6390 | `		if( SyBlobLength(&pCur->sBlob) > 0 ){` |
|   145048 |  6391 | `			PH7_MemObjStringAppend(pNos,(const char *)SyBlobData(&pCur->sBlob),SyBlobLength(&pCur->sBlob));` |
|    72523 |  6392 | `		}` |
|   145090 |  6393 | `		SyBlobRelease(&pCur->sBlob);` |
|   145090 |  6394 | `		pCur++;` |
|        2 |  6395 | `	}` |
|   142366 |  6396 | `	pTos = pNos;` |
|   142366 |  6397 | `	break;` |
|        - |  6398 | `				}` |
|        - |  6399 | `/*  CAT_STORE: * * *` |
|        - |  6400 | ` *` |
...
|        - |  6445 | ` * stack.` |
|        - |  6446 | ` */` |
|   107871 |  6447 | `case PH7_OP_LAND:` |
|        - |  6448 | `case PH7_OP_LOR: {` |
|   215788 |  6449 | `	ph7_value *pNos = &pTos[-1];` |
...
|   215788 |  6457 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|        3 |  6458 | `		PH7_MemObjToBool(pTos);` |
|        1 |  6459 | `	}` |
|   215788 |  6460 | `	if((pNos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      ! 0 |  6461 | `		PH7_MemObjToBool(pNos);` |
|      ! 0 |  6462 | `	}` |
|   215788 |  6463 | `	v1 = pNos->x.iVal == 0 ? 1 : 0;` |
|   215788 |  6464 | `	v2 = pTos->x.iVal == 0 ? 1 : 0;` |
|   215788 |  6465 | `	if( pInstr->iOp == PH7_OP_LAND ){` |
|        - |  6466 | `		static const unsigned char and_logic[] = { 0, 1, 2, 1, 1, 1, 2, 1, 2 };` |
|    98766 |  6467 | `		v1 = and_logic[v1*3+v2];` |
|    49406 |  6468 | `	}else{` |
|        - |  6469 | `		static const unsigned char or_logic[] = { 0, 0, 0, 0, 1, 2, 0, 2, 2 };` |
|   117024 |  6470 | `		v1 = or_logic[v1*3+v2];` |
|        - |  6471 | `	}` |
|   215788 |  6472 | `	if( v1 == 2 ){` |
|      ! 0 |  6473 | `		v1 = 1;` |
|      ! 0 |  6474 | `	}` |
|   215788 |  6475 | `	VmPopOperand(&pTos,1);` |
|   215788 |  6476 | `	pTos->x.iVal = v1 == 0 ? 1 : 0;` |
|   215788 |  6477 | `	MemObjSetType(pTos,MEMOBJ_BOOL);` |
|   215788 |  6478 | `	break;` |
|        - |  6479 | `				 }` |
|        - |  6480 | `/*` |
|        - |  6481 | ` * OP_NULLC: * * *` |
...
|        - |  6710 | ` */` |
|     4508 |  6711 | `case PH7_OP_EQ:` |
|        - |  6712 | `case PH7_OP_NEQ: {` |
|     9018 |  6713 | `	ph7_value *pNos = &pTos[-1];` |
...
|        - |  6718 | `	}` |
|        - |  6719 | `#endif` |
|     9018 |  6720 | `	rc = PH7_MemObjCmp(pNos,pTos,FALSE,0);` |
|     9018 |  6721 | `	if( VmIsUnorderedCmp(pNos,pTos) ){` |
|       19 |  6722 | `		rc = pInstr->iOp == PH7_OP_EQ ? 0 : 1;` |
|     9009 |  6723 | `	}else if( pInstr->iOp == PH7_OP_EQ ){` |
|     8974 |  6724 | `		rc = rc == 0;` |
|     4488 |  6725 | `	}else{` |
|       28 |  6726 | `		rc = rc != 0;` |
|        - |  6727 | `	}` |
|     9018 |  6728 | `	VmPopOperand(&pTos,1);` |
|     9018 |  6729 | `	if( !pInstr->iP2 ){` |
|        - |  6730 | `		/* Push comparison result without taking the jump */` |
|     9018 |  6731 | `		PH7_MemObjRelease(pTos);` |
|     9018 |  6732 | `		pTos->x.iVal = rc;` |
|        - |  6733 | `		/* Invalidate any prior representation */` |
|     9018 |  6734 | `		MemObjSetType(pTos,MEMOBJ_BOOL);` |
|     4510 |  6735 | `	}else{` |
|      ! 0 |  6736 | `		if( rc ){` |
...
|        - |  6750 | ` */` |
|   159771 |  6751 | `case PH7_OP_TEQ: {` |
|   319544 |  6752 | `	ph7_value *pNos = &pTos[-1];` |
...
|        - |  6757 | `	}` |
|        - |  6758 | `#endif` |
|   319544 |  6759 | `	rc = PH7_MemObjCmp(pNos,pTos,TRUE,0);` |
|   319544 |  6760 | `	if( VmIsUnorderedCmp(pNos,pTos) ){` |
|        3 |  6761 | `		rc = 0;` |
|        2 |  6762 | `	}else{` |
|   319542 |  6763 | `		rc = rc == 0;` |
|        - |  6764 | `	}` |
|   319544 |  6765 | `	VmPopOperand(&pTos,1);` |
|   319544 |  6766 | `	if( !pInstr->iP2 ){` |
|        - |  6767 | `		/* Push comparison result without taking the jump */` |
|   319544 |  6768 | `		PH7_MemObjRelease(pTos);` |
|   319544 |  6769 | `		pTos->x.iVal = rc;` |
|        - |  6770 | `		/* Invalidate any prior representation */` |
|   319544 |  6771 | `		MemObjSetType(pTos,MEMOBJ_BOOL);` |
|   159773 |  6772 | `	}else{` |
|      ! 0 |  6773 | `		if( rc ){` |
...
|        - |  6788 | ` *` |
|        - |  6789 | ` */` |
|   123017 |  6790 | `case PH7_OP_TNE: {` |
|   246036 |  6791 | `	ph7_value *pNos = &pTos[-1];` |
...
|        - |  6796 | `	}` |
|        - |  6797 | `#endif` |
|   246036 |  6798 | `	rc = PH7_MemObjCmp(pNos,pTos,TRUE,0);` |
|   246036 |  6799 | `	if( VmIsUnorderedCmp(pNos,pTos) ){` |
|        3 |  6800 | `		rc = 1;` |
|        2 |  6801 | `	}else{` |
|   246034 |  6802 | `		rc = rc != 0;` |
|        - |  6803 | `	}` |
|   246036 |  6804 | `	VmPopOperand(&pTos,1);` |
|   246036 |  6805 | `	if( !pInstr->iP2 ){` |
|        - |  6806 | `		/* Push comparison result without taking the jump */` |
|   246036 |  6807 | `		PH7_MemObjRelease(pTos);` |
|   246036 |  6808 | `		pTos->x.iVal = rc;` |
|        - |  6809 | `		/* Invalidate any prior representation */` |
|   246036 |  6810 | `		MemObjSetType(pTos,MEMOBJ_BOOL);` |
|   123019 |  6811 | `	}else{` |
|      ! 0 |  6812 | `		if( rc ){` |
...
|        - |  7272 | ` */` |
|     6073 |  7273 | `case PH7_OP_FOREACH_INIT: {` |
|    12148 |  7274 | `	ph7_foreach_info *pInfo = (ph7_foreach_info *)pInstr->p3;` |
|        - |  7275 | `	void *pName;` |
|        - |  7276 | `#ifdef UNTRUST` |
|        - |  7277 | `	if( pTos < pStack ){` |
|        - |  7278 | `		goto Abort;` |
|        - |  7279 | `	}` |
|        - |  7280 | `#endif` |
|    12148 |  7281 | `	if( SyStringLength(&pInfo->sValue) < 1 ){` |
...
|      ! 0 |  7293 | `	}` |
|    12148 |  7294 | `	if( (pInfo->iFlags & PH7_4EACH_STEP_KEY) && SyStringLength(&pInfo->sKey) < 1 ){` |
...
|    12148 |  7307 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ)) == 0 \|\| SyStringLength(&pInfo->sValue) < 1 ){` |
...
|    12148 |  7315 | `		pStep = (ph7_foreach_step *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_foreach_step));` |
|    12148 |  7316 | `		if( pStep == 0 ){` |
...
|    12148 |  7322 | `			SyZero(pStep,sizeof(ph7_foreach_step));` |
|        - |  7323 | `			/* Prepare the step */` |
|    12148 |  7324 | `			pStep->iFlags = pInfo->iFlags;` |
|    12148 |  7325 | `			if( pTos->iFlags & MEMOBJ_HASHMAP ){` |
...
|    12114 |  7329 | `				if( (pStep->iFlags & PH7_4EACH_STEP_REF) && pTos->nIdx != SXU32_HIGH ){` |
...
|        4 |  7342 | `					}` |
|        4 |  7343 | `				}` |
|    12114 |  7344 | `				pMap = (ph7_hashmap *)pTos->x.pOther;` |
|        - |  7345 | `				/* Reset the internal loop cursor */` |
|    12114 |  7346 | `				PH7_HashmapResetLoopCursor(pMap);` |
|        - |  7347 | `				/* Mark the step */` |
|    12114 |  7348 | `				pStep->iFlags \|= PH7_4EACH_STEP_HASHMAP;` |
|    12114 |  7349 | `				pStep->xIter.pMap = pMap;` |
|    12114 |  7350 | `				pMap->iRef++;` |
|     6058 |  7351 | `			}else{` |
...
|        - |  7416 | `		}` |
|    12148 |  7417 | `		if( pStep ){` |
|    12148 |  7418 | `			if( SXRET_OK != SySetPut(&pInfo->aStep,(const void *)&pStep) ){` |
...
|     6073 |  7424 | `		}` |
|        - |  7425 | `	}` |
|    12148 |  7426 | `	VmPopOperand(&pTos,1);` |
|    12148 |  7427 | `	break;` |
|        - |  7428 | `						  }` |
|        - |  7429 | `/*` |
...
|        - |  7432 | ` */` |
|    99680 |  7433 | `case PH7_OP_FOREACH_STEP: {` |
|   199362 |  7434 | `	ph7_foreach_info *pInfo = (ph7_foreach_info *)pInstr->p3;` |
|        - |  7435 | `	ph7_foreach_step **apStep,*pStep;` |
|        - |  7436 | `	ph7_value *pValue;` |
|        - |  7437 | `	VmFrame *pFrameLocal;` |
|        - |  7438 | `	/* Peek the last step */` |
|   199362 |  7439 | `	apStep = (ph7_foreach_step **)SySetBasePtr(&pInfo->aStep);` |
|   199362 |  7440 | `	pStep = apStep[SySetUsed(&pInfo->aStep) - 1];` |
|   199362 |  7441 | `	pFrameLocal = pVm->pFrame;` |
|   199362 |  7442 | `	pFrameLocal = VmSkipExceptionFrames(pFrameLocal);` |
|   199362 |  7443 | `	if( pStep->iFlags & PH7_4EACH_STEP_HASHMAP ){` |
|   199228 |  7444 | `		ph7_hashmap *pMap = pStep->xIter.pMap;` |
|        - |  7445 | `		ph7_hashmap_node *pNode;` |
|        - |  7446 | `		/* Extract the current node value */` |
|   199228 |  7447 | `		pNode = PH7_HashmapGetNextEntry(pMap);` |
|   199228 |  7448 | `		if( pNode == 0 ){` |
|        - |  7449 | `			/* No more entry to process */` |
|    12112 |  7450 | `			pc = pInstr->iP2 - 1; /* Jump to this destination */` |
|    12112 |  7451 | `			if( pStep->iFlags & PH7_4EACH_STEP_REF ){` |
...
|    12112 |  7456 | `			PH7_HashmapResetLoopCursor(pMap);` |
|        - |  7457 | `			/* Cleanup the mess left behind */` |
|    12112 |  7458 | `			SyMemBackendPoolFree(&pVm->sAllocator,pStep);` |
|    12112 |  7459 | `			SySetPop(&pInfo->aStep);` |
|    12112 |  7460 | `			PH7_HashmapUnref(pMap);` |
|     6057 |  7461 | `		}else{` |
|   187118 |  7462 | `			if( (pStep->iFlags & PH7_4EACH_STEP_KEY) && SyStringLength(&pInfo->sKey) > 0 ){` |
|      506 |  7463 | `				ph7_value *pKey = VmExtractMemObj(&(*pVm),&pInfo->sKey,FALSE,TRUE);` |
|      506 |  7464 | `				if( pKey ){` |
|      506 |  7465 | `					PH7_HashmapExtractNodeKey(pNode,pKey);` |
|      252 |  7466 | `				}` |
|      252 |  7467 | `			}` |
|   187118 |  7468 | `			if( pStep->iFlags & PH7_4EACH_STEP_REF ){` |
...
|   187096 |  7480 | `				pValue = VmExtractMemObj(&(*pVm),&pInfo->sValue,FALSE,TRUE);` |
|   187096 |  7481 | `				if( pValue ){` |
|   187096 |  7482 | `					PH7_HashmapExtractNodeValue(pNode,pValue,TRUE);` |
|    93547 |  7483 | `				}` |
|        - |  7484 | `			}` |
|        2 |  7485 | `		}` |
|    99749 |  7486 | `	}else if( pStep->iFlags & PH7_4EACH_STEP_ITERATOR ){` |
...
|        - |  8309 | ` */` |
|   352434 |  8310 | `case PH7_OP_CALL: {` |
|   704914 |  8311 | `	sxi32 nCallArgs = pInstr->iP1 + pVm->iSpreadExtra;` |
|        - |  8312 | `	ph7_value *pArg;` |
|   704914 |  8313 | `	pVm->iSpreadExtra = 0; /* Always reset, even if zero */` |
|   704914 |  8314 | `	pArg = &pTos[-nCallArgs];` |
|        - |  8315 | `	SyHashEntry *pEntry;` |
|        - |  8316 | `	SyString sName;` |
|        - |  8317 | `	/* Extract function name */` |
|   704914 |  8318 | `	if( (pTos->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|       66 |  8426 | `		break;` |
|        - |  8427 | `	}` |
|   704830 |  8428 | `	SyStringInitFromBuf(&sName,SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
...
|   704830 |  8432 | `	pEntry = SyHashGet(&pVm->hFunction,(const void *)sName.zString,sName.nByte);` |
...
|        - |  8438 | `	{` |
|   704830 |  8439 | `	VmCallArgMap *pCallMap = (VmCallArgMap *)pInstr->p3;` |
|   704830 |  8440 | `	if( pEntry == 0 && pCallMap && pCallMap->bIsNamespaced ){` |
...
|    18140 |  8473 | `		pVmFunc = (ph7_vm_func *)pEntry->pUserData;` |
|    18140 |  8474 | `		pThis = 0;` |
|    18140 |  8475 | `		pSelf = 0;` |
|    18140 |  8476 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
...
|    18140 |  8544 | `		if( pVm->nRecursionDepth > pVm->nMaxDepth ){` |
...
|       14 |  8554 | `			break;` |
|        - |  8555 | `		}` |
|    18138 |  8556 | `		if( pVmFunc->pNextName ){` |
...
|       69 |  8559 | `		}` |
|    18138 |  8560 | `		if( pVmFunc->iFlags & VM_FUNC_GENERATOR ){` |
...
|    18116 |  8699 | `		aFormalArg = (ph7_vm_func_arg *)SySetBasePtr(&pVmFunc->aArgs);` |
|        - |  8700 | `		/* Create a new VM frame  */` |
|    18116 |  8701 | `		rc = VmEnterFrame(&(*pVm),pVmFunc,pThis,&pFrame);` |
|    18116 |  8702 | `		if( rc != SXRET_OK ){` |
...
|      ! 0 |  8713 | `			break;` |
|        - |  8714 | `		}` |
|    18116 |  8715 | `		if( (pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) && pThis ){` |
...
|     1599 |  8723 | `			}` |
|     1599 |  8724 | `		}` |
|    18116 |  8725 | `		if( SySetUsed(&pVmFunc->aStatic) > 0 ){` |
...
|        - |  8752 | `		{` |
|    18116 |  8753 | `		VmCallArgMap *pCallMap3 = (VmCallArgMap *)pInstr->p3;` |
|        - |  8754 | `		/* Caller file's strict_types mode — governs parameter coercion` |
|        - |  8755 | `		 * (but NOT return coercion, which uses the callee's file). */` |
|    18116 |  8756 | `		int bCallIsStrict = (pCallMap3 && pCallMap3->bStrict) ? 1 : 0;` |
|    18116 |  8757 | `		if( pCallMap3 && pCallMap3->bHasNamed ){` |
|        - |  8758 | `			/* ============================================================` |
...
|        - |  9009 | `		 * ============================================================ */` |
|    18022 |  9010 | `		n = 0;` |
|    48076 |  9011 | `		while( pArg < pTos ){` |
|    30128 |  9012 | `			if( n < SySetUsed(&pVmFunc->aArgs) && (aFormalArg[n].iFlags & VM_FUNC_ARG_VARIADIC) ){` |
...
|        - |  9106 | `			}` |
|    30090 |  9107 | `			if( n < SySetUsed(&pVmFunc->aArgs) ){` |
|    29904 |  9108 | `				if( (pArg->iFlags & MEMOBJ_NULL) && SySetUsed(&aFormalArg[n].aByteCode) > 0` |
...
|    29906 |  9117 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_UNION ){` |
...
|    29872 |  9150 | `				if( aFormalArg[n].nType > 0` |
|    15630 |  9151 | `					&& !((aFormalArg[n].iFlags & VM_FUNC_ARG_NULLABLE) && (pArg->iFlags & MEMOBJ_NULL)) ){` |
...
|        4 |  9207 | `					}` |
|      684 |  9208 | `				}` |
|    29872 |  9209 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_BY_REF ){` |
...
|    29816 |  9235 | `					pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|        - |  9236 | `				}` |
|    14937 |  9237 | `			}else{` |
|        - |  9238 | `				char zName[32];` |
...
|        - |  9245 | `			}` |
|    30056 |  9246 | `			if( pObj ){` |
|    30000 |  9247 | `				PH7_MemObjStore(pArg,pObj);` |
|        - |  9248 | `				/* Insert argument index  */` |
|    30000 |  9249 | `				sArg.nIdx = pObj->nIdx;` |
|    30000 |  9250 | `				sArg.pUserData = 0;` |
|    30000 |  9251 | `				SySetPut(&pFrame->sArg,(const void *)&sArg);` |
|    14999 |  9252 | `			}` |
|    30056 |  9253 | `			PH7_MemObjRelease(pArg);` |
|    30056 |  9254 | `			pArg++;` |
|    30056 |  9255 | `			++n;` |
|        2 |  9256 | `		}` |
|        - |  9257 | `		} /* end named vs positional branch */` |
|        - |  9258 | `		/* Set up closure environment */` |
|    18074 |  9259 | `		if( pVmFunc->iFlags & VM_FUNC_CLOSURE ){` |
...
|    20856 |  9281 | `		while( n < SySetUsed(&pVmFunc->aArgs) ){` |
...
|        - |  9320 | `		 */` |
|    18074 |  9321 | `		PH7_MemObjRelease(pTos);` |
|    18074 |  9322 | `		pTos = &pTos[-nCallArgs];` |
|        - |  9323 | `		/* Allocate a new operand stack and evaluate the function body */` |
|    18074 |  9324 | `		pFrameStack = VmNewOperandStack(&(*pVm),SySetUsed(&pVmFunc->aByteCode));` |
|    18074 |  9325 | `		if( pFrameStack == 0 ){` |
...
|      ! 0 |  9332 | `			break;` |
|        - |  9333 | `		}` |
|     9036 |  9334 | `SkipFuncBody:` |
|    18106 |  9335 | `		if( pSelf ){` |
|        - |  9336 | `			/* Push class name */` |
|     3270 |  9337 | `			SySetPut(&pVm->aSelf,(const void *)&pSelf);` |
|     1634 |  9338 | `		}` |
|        - |  9339 | `		/* Increment nesting level */` |
|    18106 |  9340 | `		pVm->nRecursionDepth++;` |
|    18106 |  9341 | `		if( rc != PH7_EXCEPTION ){` |
|        - |  9342 | `			/* Execute function body */` |
|    27110 |  9343 | `			rc = VmByteCodeExec(&(*pVm),(VmInstr *)SySetBasePtr(&pVmFunc->aByteCode),pFrameStack,-1,pTos,&n,FALSE,0,` |
|    18072 |  9344 | `				pVmFunc->nReturnType > 0 ? pVmFunc : 0);` |
|     9036 |  9345 | `		}` |
|        - |  9346 | `		/* Decrement nesting level */` |
|    18106 |  9347 | `		pVm->nRecursionDepth--;` |
|    18106 |  9348 | `		if( pSelf ){` |
|        - |  9349 | `			/* Pop class name */` |
|     3270 |  9350 | `			(void)SySetPop(&pVm->aSelf);` |
|     1634 |  9351 | `		}` |
|        - |  9352 | `		/* Cleanup the mess left behind */` |
|    18106 |  9353 | `		if( (pVmFunc->iFlags & VM_FUNC_REF_RETURN) && rc == SXRET_OK ){` |
...
|    18106 |  9381 | `		if( rc != PH7_ABORT && ((pFrame->iFlags & VM_FRAME_THROW) \|\| rc == PH7_EXCEPTION) ){` |
...
|    18106 |  9400 | `		if( pFrameStack ){` |
|    18074 |  9401 | `			SyMemBackendFree(&pVm->sAllocator,pFrameStack);` |
|     9036 |  9402 | `		}` |
|        - |  9403 | `		/* Leave the frame */` |
|    18106 |  9404 | `		VmLeaveFrame(&(*pVm));` |
|    18106 |  9405 | `		if( rc == PH7_ABORT ){` |
|        - |  9406 | `			/* Abort processing immeditaley */` |
|       15 |  9407 | `			goto Abort;` |
|    18092 |  9408 | `		}else if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|    18054 |  9416 | `		}else if( rc == PH7_EXCEPTION ){` |
...
|   686692 |  9428 | `		pEntry = SyHashGet(&pVm->hHostFunction,(const void *)sName.zString,sName.nByte);` |
|        - |  9429 | `		{` |
|   686692 |  9430 | `		VmCallArgMap *pCallMap2 = (VmCallArgMap *)pInstr->p3;` |
|   686692 |  9431 | `		if( pEntry == 0 && pCallMap2 && pCallMap2->bIsNamespaced ){` |
...
|       53 |  9455 | `			break;` |
|        - |  9456 | `		}` |
|   686688 |  9457 | `		pFunc = (ph7_user_func *)pEntry->pUserData;` |
|        - |  9458 | `		/* Start collecting function arguments */` |
|   686688 |  9459 | `		SySetReset(&aArg);` |
|  1850384 |  9460 | `		while( pArg < pTos ){` |
|  1163698 |  9461 | `			SySetPut(&aArg,(const void *)&pArg);` |
|  1163698 |  9462 | `			pArg++;` |
|        2 |  9463 | `		}` |
|        - |  9464 | `		/* Assume a null return value */` |
|   686688 |  9465 | `		PH7_MemObjInit(&(*pVm),&sRet);` |
|        - |  9466 | `		/* Init the call context */` |
|   686688 |  9467 | `		VmInitCallContext(&sCtx,&(*pVm),pFunc,&sRet,0);` |
|        - |  9468 | `		/* Call the foreign function */` |
|   686688 |  9469 | `		rc = pFunc->xFunc(&sCtx,(int)SySetUsed(&aArg),(ph7_value **)SySetBasePtr(&aArg));` |
|        - |  9470 | `		/* Release the call context */` |
|   686688 |  9471 | `		VmReleaseCallContext(&sCtx);` |
|   686688 |  9472 | `		if( rc == PH7_ABORT ){` |
|      491 |  9473 | `			goto Abort;` |
|   686198 |  9474 | `		}else if( rc == PH7_EXCEPTION ){` |
...
|       98 |  9493 | `			break;` |
|        - |  9494 | `		}` |
|   686098 |  9495 | `		if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|        - |  9510 | `		}` |
|   686060 |  9511 | `		if( pInstr->iP1 > 0 ){` |
|        - |  9512 | `			/* Pop function name and arguments */` |
|   664476 |  9513 | `			VmPopOperand(&pTos,pInstr->iP1);` |
|   332259 |  9514 | `		}` |
|        - |  9515 | `		/* Save foreign function return value */` |
|   686060 |  9516 | `		PH7_MemObjStore(&sRet,pTos);` |
|   686060 |  9517 | `		PH7_MemObjRelease(&sRet);` |
|        - |  9518 | `	}` |
|   704084 |  9519 | `	break;` |
|        - |  9520 | `				  }` |
|        - |  9521 | `/*` |
...
|        - |  9524 | ` */` |
|    15441 |  9525 | `case PH7_OP_CONSUME: {` |
|    30884 |  9526 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|    30884 |  9527 | `	ph7_value *pCur,*pOut = pTos;` |
|        - |  9528 |  |
|    30884 |  9529 | `	pOut = &pTos[-pInstr->iP1 + 1];` |
|    30884 |  9530 | `	pCur = pOut;` |
|        - |  9531 | `	/* Start the consume process  */` |
|    61772 |  9532 | `	while( pOut <= pTos ){` |
|        - |  9533 | `		/* Force a string cast */` |
|    30890 |  9534 | `		if( (pOut->iFlags & MEMOBJ_STRING) == 0 ){` |
|     1004 |  9535 | `			PH7_MemObjToString(pOut);` |
|      501 |  9536 | `		}` |
|    30890 |  9537 | `		if( SyBlobLength(&pOut->sBlob) > 0 ){` |
|        - |  9538 | `			/*SyBlobNullAppend(&pOut->sBlob);*/` |
|        - |  9539 | `			/* Invoke the output consumer callback */` |
|    18672 |  9540 | `			rc = pCons->xConsumer(SyBlobData(&pOut->sBlob),SyBlobLength(&pOut->sBlob),pCons->pUserData);` |
|    18672 |  9541 | `			VmTrackOutput(pVm, SyBlobLength(&pOut->sBlob));` |
|    18672 |  9542 | `			SyBlobRelease(&pOut->sBlob);` |
|    18672 |  9543 | `			if( rc == SXERR_ABORT ){` |
...
|    30890 |  9548 | `		pOut++;` |
|        2 |  9549 | `	}` |
|    30884 |  9550 | `	pTos = &pCur[-1];` |
|    30882 |  9551 | `	break;` |
|        - |  9552 | `					 }` |
|        - |  9553 |  |
|        - |  9554 | `		} /* Switch() */` |
| 11635614 |  9555 | `		pc++; /* Next instruction in the stream */` |
|        2 |  9556 | `	} /* For(;;) */` |
|    21700 |  9557 | `Done:` |
|    43402 |  9558 | `	SySetRelease(&aArg);` |
|    43402 |  9559 | `	return SXRET_OK;` |
|       72 |  9560 | `Suspend:` |
...
|        - |  9582 | ` */` |
|    20172 |  9583 | `PH7_PRIVATE sxi32 VmLocalExec(ph7_vm *pVm,SySet *pByteCode,ph7_value *pResult)` |
|        2 |  9584 |  |
|        - |  9585 | `	ph7_value *pStack;` |
|        - |  9586 | `	sxi32 rc;` |
|        - |  9587 | `	/* Allocate a new operand stack */` |
|    20174 |  9588 | `	pStack = VmNewOperandStack(&(*pVm),SySetUsed(pByteCode));` |
|    20174 |  9589 | `	if( pStack == 0 ){` |
|      ! 0 |  9590 | `		return SXERR_MEM;` |
|        - |  9591 | `	}` |
|        - |  9592 | `	/* Execute the program */` |
|    20174 |  9593 | `	rc = VmByteCodeExec(&(*pVm),(VmInstr *)SySetBasePtr(pByteCode),pStack,-1,&(*pResult),0,FALSE,0,0);` |
|        - |  9594 | `	/* Free the operand stack */` |
|    20174 |  9595 | `	SyMemBackendFree(&pVm->sAllocator,pStack);` |
|        - |  9596 | `	/* Execution result */` |
|    20174 |  9597 | `	return rc;` |
|    10088 |  9598 |  |
|        - |  9599 | `/*` |
...
|        - | 11104 | ` */` |
|    22792 | 11105 | `PH7_PRIVATE int PH7_VmIsCallable(ph7_vm *pVm,ph7_value *pValue,int CallInvoke)` |
|        2 | 11106 |  |
|    22794 | 11107 | `	int res = 0;` |
|    22794 | 11108 | `	if( pValue->iFlags & MEMOBJ_OBJ ){` |
...
|    22785 | 11118 | `	}else if( pValue->iFlags & MEMOBJ_HASHMAP ){` |
...
|        5 | 11140 | `			}` |
|        7 | 11141 | `		}` |
|    22763 | 11142 | `	}else if( pValue->iFlags & MEMOBJ_STRING ){` |
|        - | 11143 | `		const char *zName;` |
|        - | 11144 | `		int nLen;` |
|        - | 11145 | `		/* Extract the name */` |
|     5734 | 11146 | `		zName = ph7_value_to_string(pValue,&nLen);` |
|        - | 11147 | `		/* Perform the lookup */` |
|     5749 | 11148 | `		if( SyHashGet(&pVm->hFunction,(const void *)zName,(sxu32)nLen) != 0 \|\|` |
|       30 | 11149 | `			SyHashGet(&pVm->hHostFunction,(const void *)zName,(sxu32)nLen) != 0 ){` |
|        - | 11150 | `				/* Function is callable */` |
|     5716 | 11151 | `				res = 1;` |
|     2857 | 11152 | `		}` |
|     2866 | 11153 | `	}` |
|    22794 | 11154 | `	return res;` |
|        2 | 11155 |  |
|        - | 11156 | `/*` |
...
|        - | 11912 | ` */` |
|     2879 | 11913 | `PH7_PRIVATE sxu32 PH7_VmRandomNum(ph7_vm *pVm)` |
|        2 | 11914 |  |
|        - | 11915 | `	sxu32 iNum;` |
|     2881 | 11916 | `	SyRandomness(&pVm->sPrng,(void *)&iNum,sizeof(sxu32));` |
|     2881 | 11917 | `	return iNum;` |
|        2 | 11918 |  |
|        - | 11919 | `/*` |
...
|      225 | 12099 | `	uResult = 0;` |
|      327 | 12100 | `	for( nAttempt = 0 ; nAttempt < 50 ; ++nAttempt ){` |
...
|        - | 12104 | `		sxu64 uDraw;` |
|      327 | 12105 | `		if( SyOSCSPRNG(&uDraw,sizeof(uDraw)) != SXRET_OK ){` |
...
|        - | 12111 | `				);` |
|        - | 12112 | `		}` |
|      327 | 12113 | `		uDraw &= uMask;` |
|      327 | 12114 | `		if( uDraw <= uRange ){` |
...
|        - | 12398 | ` */` |
|    91276 | 12399 | `static int vm_builtin_isset(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 | 12400 |  |
|        - | 12401 | `	ph7_value *pObj;` |
|    91278 | 12402 | `	int res = 0;` |
|        - | 12403 | `	int i;` |
|    91278 | 12404 | `	if( nArg < 1 ){` |
...
|   119352 | 12410 | `	for( i = 0 ; i < nArg ; ++i ){` |
|    91288 | 12411 | `		pObj = apArg[i];` |
|    91288 | 12412 | `		if( pObj->nIdx == SXU32_HIGH ){` |
...
|    62292 | 12416 | `			if( (pObj->iFlags & (MEMOBJ_NULL\|MEMOBJ_BOOL)) == 0 ){` |
...
|      ! 0 | 12419 | `			}` |
|    31145 | 12420 | `		}` |
|    91288 | 12421 | `		res = (pObj->iFlags & MEMOBJ_NULL) ? 0 : 1;` |
|    91288 | 12422 | `		if( !res ){` |
|        - | 12423 | `			/* Variable not set,return FALSE */` |
|    63214 | 12424 | `			ph7_result_bool(pCtx,0);` |
|    63214 | 12425 | `			return SXRET_OK;` |
|        - | 12426 | `		}` |
|    14039 | 12427 | `	}` |
|        - | 12428 | `	/* All given variable are set,return TRUE */` |
|    28066 | 12429 | `	ph7_result_bool(pCtx,1);` |
|    28066 | 12430 | `	return SXRET_OK;` |
|    45640 | 12431 |  |
|        - | 12432 | `/*` |
...
|        - | 12436 | ` */` |
|  3135342 | 12437 | `PH7_PRIVATE sxi32 PH7_VmUnsetMemObj(ph7_vm *pVm,sxu32 nObjIdx,int bForce)` |
|        2 | 12438 |  |
|        - | 12439 | `	ph7_value *pObj;` |
|        - | 12440 | `	VmRefObj *pRef;` |
|  3135344 | 12441 | `	pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nObjIdx);` |
|  3135344 | 12442 | `	if( pObj ){` |
|        - | 12443 | `		/* Release the object */` |
|  3135344 | 12444 | `		PH7_MemObjRelease(pObj);` |
|  1567671 | 12445 | `	}` |
|        - | 12446 | `	/* Remove old reference links */` |
|  3135344 | 12447 | `	pRef = VmRefObjExtract(&(*pVm),nObjIdx);` |
|  3135344 | 12448 | `	if( pRef ){` |
|  3135338 | 12449 | `		sxi32 iFlags = pRef->iFlags;` |
|        - | 12450 | `		/* Unlink from the reference table */` |
|  3135338 | 12451 | `		VmRefObjUnlink(&(*pVm),pRef);` |
|  3135338 | 12452 | `		if( (bForce == TRUE) \|\| (iFlags & VM_REF_IDX_KEEP) == 0 ){` |
|        - | 12453 | `			VmSlot sFree;` |
|        - | 12454 | `			/* Restore to the free list */` |
|  3135330 | 12455 | `			sFree.nIdx = nObjIdx;` |
|  3135330 | 12456 | `			sFree.pUserData = 0;` |
|  3135330 | 12457 | `			SySetPut(&pVm->aFreeObj,(const void *)&sFree);` |
|  1567664 | 12458 | `		}` |
|  1567668 | 12459 | `	}` |
|  3135344 | 12460 | `	return SXRET_OK;` |
|        2 | 12461 |  |
|        - | 12462 | `/*` |
...
|        - | 12468 | ` *  Nothing.` |
|        - | 12469 | ` */` |
|     7500 | 12470 | `static int vm_builtin_unset(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 | 12471 |  |
|        - | 12472 | `	ph7_value *pObj;` |
|        - | 12473 | `	ph7_vm *pVm;` |
|        - | 12474 | `	int i;` |
|        - | 12475 | `	/* Point to the target VM */` |
|     7502 | 12476 | `	pVm = pCtx->pVm;` |
|        - | 12477 | `	/* Iterate and unset */` |
|    15002 | 12478 | `	for( i = 0 ; i < nArg ; ++i ){` |
|     7502 | 12479 | `		pObj = apArg[i];` |
|     7502 | 12480 | `		if( pObj->nIdx == SXU32_HIGH ){` |
...
|      ! 0 | 12484 | `			}` |
|      410 | 12485 | `		}else{` |
|     6686 | 12486 | `			sxu32 nIdx = pObj->nIdx;` |
|        - | 12487 | `			/* TICKET 1433-35: Protect the $GLOBALS array from deletion */` |
|     6686 | 12488 | `			if( nIdx != pVm->nGlobalIdx ){` |
|     6680 | 12489 | `				PH7_VmUnsetMemObj(&(*pVm),nIdx,FALSE);` |
|     3339 | 12490 | `			}` |
|        - | 12491 | `		}` |
|     3752 | 12492 | `	}` |
|     7502 | 12493 | `	return SXRET_OK;` |
|        2 | 12494 |  |
|        - | 12495 | `/*` |
...
|        - | 13161 | ` */` |
|    10652 | 13162 | `static int vm_builtin_set_error_handler(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 | 13163 |  |
|    10654 | 13164 | `	ph7_vm *pVm = pCtx->pVm;` |
|        - | 13165 | `	ph7_value *pOld,*pNew;` |
|        - | 13166 | `	/* Point to the old and the new handler */` |
|    10654 | 13167 | `	pOld = &pVm->aErrCB[0];` |
|    10654 | 13168 | `	pNew = &pVm->aErrCB[1];` |
|        - | 13169 | `	/* Return the old handler */` |
|    10654 | 13170 | `	ph7_result_value(pCtx,pOld); /* Will make it's own copy */` |
|    10654 | 13171 | `	if( nArg > 0 ){` |
|    10654 | 13172 | `		if( !ph7_value_is_callable(apArg[0])) {` |
|        - | 13173 | `			/* Not callable,return TRUE (As requested by the PHP specification) */` |
|     5321 | 13174 | `			PH7_MemObjRelease(pNew);` |
|     5321 | 13175 | `			ph7_result_bool(pCtx,1);` |
|     2661 | 13176 | `		}else{` |
|     5334 | 13177 | `			PH7_MemObjStore(pNew,pOld);` |
|        - | 13178 | `			/* Install the new handler */` |
|     5334 | 13179 | `			PH7_MemObjStore(apArg[0],pNew);` |
|        - | 13180 | `		}` |
|     5326 | 13181 | `	}` |
|    10654 | 13182 | `	return PH7_OK;` |
|        2 | 13183 |  |
|        - | 13184 | `/*` |
...
|        - | 14440 | ` * information.` |
|        - | 14441 | ` */` |
|    12534 | 14442 | `static sxi32 VmEvalChunk(` |
...
|    12536 | 14452 | `	ProcConsumer xErr = 0;` |
|    12536 | 14453 | `	void *pErrData = 0;` |
|        - | 14454 | `	/* Initialize bytecode container */` |
|    12536 | 14455 | `	SySetInit(&aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|    12536 | 14456 | `	SySetAlloc(&aByteCode,0x20);` |
|        - | 14457 | `	/* Reset the code generator */` |
|    12536 | 14458 | `	if( bTrueReturn ){` |
|        - | 14459 | `		/* Included file,log compile-time errors */` |
|     9394 | 14460 | `		xErr = pVm->pEngine->xConf.xErr;` |
|     9394 | 14461 | `		pErrData = pVm->pEngine->xConf.pErrData;` |
|     4696 | 14462 | `	}` |
|    12536 | 14463 | `	PH7_ResetCodeGenerator(pVm,xErr,pErrData);` |
...
|    12536 | 14467 | `	SyBlobInit(&sSavedNs,&pVm->sAllocator);` |
|    12536 | 14468 | `	SyBlobDup(&pVm->sNamespace,&sSavedNs);` |
|    12536 | 14469 | `	if( bTrueReturn ){` |
|        - | 14470 | `		/* Include/require: start in a fresh (global) namespace scope. */` |
|     9394 | 14471 | `		SyBlobReset(&pVm->sNamespace);` |
|     4696 | 14472 | `	}` |
|        - | 14473 | `	/* Swap bytecode container */` |
|    12536 | 14474 | `	pByteCode = pVm->pByteContainer;` |
|    12536 | 14475 | `	pVm->pByteContainer = &aByteCode;` |
|        - | 14476 | `	/* Compile the chunk */` |
|    12536 | 14477 | `	PH7_CompileScript(pVm,pChunk,iFlags);` |
|    18803 | 14478 | `	if( pVm->sCodeGen.nErr > 0 ){` |
...
|        - | 14488 | `		sxi32 rc;` |
|    12534 | 14489 | `		SyHashResetLoopCursor(&pVm->hClass);` |
|   731696 | 14490 | `		while((pEntry = SyHashGetNextEntry(&pVm->hClass)) != 0 ){` |
|   712898 | 14491 | `			pClass = (ph7_class *)pEntry->pUserData;` |
|        - | 14492 | `			/* Only mount classes that haven't been mounted yet */` |
|   712898 | 14493 | `			if( !pClass->bMounted ){` |
|   189876 | 14494 | `				rc = VmMountUserClass(pVm,pClass);` |
|   189876 | 14495 | `				if( rc != SXRET_OK ){` |
...
|    94937 | 14502 | `			}` |
|        2 | 14503 | `		}` |
|    12534 | 14504 | `		if( SXRET_OK != PH7_VmEmitInstr(pVm,PH7_OP_DONE,0,0,0,0) ){` |
|        - | 14505 | `			/* Out of memory */` |
|      ! 0 | 14506 | `			if( pCtx ){` |
...
|        - | 14510 | `		}` |
|    12534 | 14511 | `		if( bTrueReturn ){` |
|        - | 14512 | `			/* Assume a boolean true return value */` |
|     9394 | 14513 | `			PH7_MemObjInitFromBool(pVm,&sResult,1);` |
|     4698 | 14514 | `		}else{` |
|        - | 14515 | `			/* Assume a null return value */` |
|     3142 | 14516 | `			PH7_MemObjInit(pVm,&sResult);` |
|        - | 14517 | `		}` |
|        - | 14518 | `		/* Execute the compiled chunk */` |
|    12534 | 14519 | `		VmLocalExec(pVm,&aByteCode,&sResult);` |
|    12534 | 14520 | `		if( pCtx ){` |
|        - | 14521 | `			/* Set the execution result */` |
|     9412 | 14522 | `			ph7_result_value(pCtx,&sResult);` |
|     4705 | 14523 | `		}` |
|    12534 | 14524 | `		PH7_MemObjRelease(&sResult);` |
|        - | 14525 | `	}` |
|     6267 | 14526 | `Cleanup:` |
|        - | 14527 | `	/* Cleanup the mess left behind */` |
|    12536 | 14528 | `	pVm->pByteContainer = pByteCode;` |
|    12536 | 14529 | `	SySetRelease(&aByteCode);` |
|        - | 14530 | `	/* Restore caller's namespace state */` |
|    12536 | 14531 | `	SyBlobReset(&pVm->sNamespace);` |
|    12536 | 14532 | `	SyBlobDup(&sSavedNs,&pVm->sNamespace);` |
|    12536 | 14533 | `	SyBlobRelease(&sSavedNs);` |
|    12536 | 14534 | `	return SXRET_OK;` |
|        2 | 14535 |  |
|        - | 14536 | `/*` |
...
|        - | 14567 | ` */` |
|    18780 | 14568 | `static int VmIsIncludedFile(ph7_vm *pVm,SyString *pFile)` |
|        2 | 14569 |  |
|        - | 14570 | `	SyString *aEntries;` |
|        - | 14571 | `	sxu32 n;` |
|    18782 | 14572 | `	aEntries = (SyString *)SySetBasePtr(&pVm->aIncluded);` |
|        - | 14573 | `	/* Perform a linear search */` |
| 88116570 | 14574 | `	for( n = 0 ; n < SySetUsed(&pVm->aIncluded) ; ++n ){` |
| 88097796 | 14575 | `		if( SyStringCmp(pFile,&aEntries[n],SyMemcmp) == 0 ){` |
|        - | 14576 | `			/* Already included */` |
|        7 | 14577 | `			return TRUE;` |
|        - | 14578 | `		}` |
| 44048896 | 14579 | `	}` |
|    18776 | 14580 | `	return FALSE;` |
|     9392 | 14581 |  |
|        - | 14582 | `/*` |
|        - | 14583 | ` * Push a file path in the appropriate VM container.` |
|        - | 14584 | ` */` |
|    21894 | 14585 | `PH7_PRIVATE sxi32 PH7_VmPushFilePath(ph7_vm *pVm,const char *zPath,int nLen,sxu8 bMain,sxi32 *pNew)` |
|        2 | 14586 |  |
...
|        - | 14591 | `#endif` |
|        - | 14592 | `	sxi32 rc;` |
|    21896 | 14593 | `	if( nLen < 0 ){` |
|     3116 | 14594 | `		nLen = SyStrlen(zPath);` |
|     1557 | 14595 | `	}` |
|        - | 14596 | `	/* Duplicate the file path first */` |
|    21896 | 14597 | `	zDup = SyMemBackendStrDup(&pVm->sAllocator,zPath,nLen);` |
|    21896 | 14598 | `	if( zDup == 0 ){` |
...
|    21896 | 14620 | `	SyStringInitFromBuf(&sPath,zDup,nLen);` |
|    21896 | 14621 | `	if( !bMain ){` |
|    18782 | 14622 | `		if( VmIsIncludedFile(&(*pVm),&sPath) ){` |
|        - | 14623 | `			/* Already included */` |
|        7 | 14624 | `			*pNew = 0;` |
|        4 | 14625 | `		}else{` |
|        - | 14626 | `			/* Insert in the corresponding container */` |
|    18776 | 14627 | `			rc = SySetPut(&pVm->aIncluded,(const void *)&sPath);` |
|    18776 | 14628 | `			if( rc != SXRET_OK ){` |
...
|        - | 14633 | `		}` |
|     9390 | 14634 | `	}` |
|    21896 | 14635 | `	SySetPut(&pVm->aFiles,(const void *)&sPath);` |
|    21896 | 14636 | `	return SXRET_OK;` |
|    10949 | 14637 |  |
|        - | 14638 | `/*` |
...
|        - | 14649 | ` */` |
|     9402 | 14650 | `static sxi32 VmExecIncludedFile(` |
...
|     9404 | 14664 | `	pVm = pCtx->pVm;` |
|     9404 | 14665 | `	SyBlobInit(&sContents,&pVm->sAllocator);` |
|     9404 | 14666 | `	isNew = 0;` |
|        - | 14667 | `	/* Extract the associated stream */` |
|     9404 | 14668 | `	pStream = PH7_VmGetStreamDevice(pVm,&pPath->zString,pPath->nByte);` |
|        - | 14669 | `	/*` |
|        - | 14670 | `	 * Open the file or the URL [i.e: http://ph7.symisc.net/example/hello.php"]` |
|        - | 14671 | `	 * in a read-only mode.` |
|        - | 14672 | `	 */` |
|     9404 | 14673 | `	pHandle = PH7_StreamOpenHandle(pVm,pStream,pPath->zString,PH7_IO_OPEN_RDONLY,TRUE,0,TRUE,&isNew);` |
|     9404 | 14674 | `	if( pHandle == 0 ){` |
|        8 | 14675 | `		return SXERR_IO;` |
|        - | 14676 | `	}` |
|     9398 | 14677 | `	rc = SXRET_OK; /* Stupid cc warning */` |
|     9398 | 14678 | `	if( IncludeOnce && !isNew ){` |
|        - | 14679 | `		/* Already included */` |
|        5 | 14680 | `		rc = SXERR_EXISTS;` |
|        3 | 14681 | `	}else{` |
|        - | 14682 | `		/* Read the whole file contents */` |
|     9394 | 14683 | `		rc = PH7_StreamReadWholeFile(pHandle,pStream,&sContents);` |
|     9394 | 14684 | `		if( rc == SXRET_OK ){` |
|        - | 14685 | `			SyString sScript;` |
|        - | 14686 | `			/* Compile and execute the script */` |
|     9394 | 14687 | `			SyStringInitFromBuf(&sScript,SyBlobData(&sContents),SyBlobLength(&sContents));` |
|     9394 | 14688 | `			VmEvalChunk(pCtx->pVm,&(*pCtx),&sScript,0,TRUE);` |
|     4696 | 14689 | `		}` |
|        - | 14690 | `	}` |
|        - | 14691 | `	/* Pop from the set of included file */` |
|     9398 | 14692 | `	(void)SySetPop(&pVm->aFiles);` |
|        - | 14693 | `	/* Close the handle */` |
|     9398 | 14694 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|        - | 14695 | `	/* Release the working buffer */` |
|     9398 | 14696 | `	SyBlobRelease(&sContents);` |
|        - | 14697 | `#else` |
...
|     3863 | 14770 | `	while( SXRET_OK == SySetGetNextEntry(pFiles,(void **)&pEntry) ){` |
|        - | 14771 | `		const char *zBase,*zEnd;` |
|        - | 14772 | `		int iLen;` |
|        - | 14773 | `		/* reset the string cursor */` |
|     3861 | 14774 | `		ph7_value_reset_string_cursor(pWorker);` |
|        - | 14775 | `		/* Extract base name */` |
|     3861 | 14776 | `		zEnd = &pEntry->zString[pEntry->nByte - 1];` |
|        - | 14777 | `		/* Ignore trailing '/' */` |
|     5791 | 14778 | `		while( zEnd > pEntry->zString && ( (int)zEnd[0] == c \|\| (int)zEnd[0] == d ) ){` |
|      ! 0 | 14779 | `			zEnd--;` |
|      ! 0 | 14780 | `		}` |
|     3861 | 14781 | `		iLen = (int)(&zEnd[1]-pEntry->zString);` |
|   119173 | 14782 | `		while( zEnd > pEntry->zString && ( (int)zEnd[0] != c && (int)zEnd[0] != d ) ){` |
|   113383 | 14783 | `			zEnd--;` |
|        1 | 14784 | `		}` |
|     3861 | 14785 | `		zBase = (zEnd > pEntry->zString) ? &zEnd[1] : pEntry->zString;` |
|     3861 | 14786 | `		zEnd = &pEntry->zString[iLen];` |
|        - | 14787 | `		/* Copy entry name */` |
|     3861 | 14788 | `		ph7_value_string(pWorker,zBase,(int)(zEnd-zBase));` |
|        - | 14789 | `		/* Perform the insertion */` |
|     3861 | 14790 | `		ph7_array_add_elem(pArray,0/* Automatic index assign*/,pWorker); /* Will make it's own copy */` |
|        1 | 14791 | `	}` |
...
|        - | 14819 | ` */` |
|     9384 | 14820 | `static int vm_builtin_include(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 | 14821 |  |
|        - | 14822 | `	SyString sFile;` |
|        - | 14823 | `	sxi32 rc;` |
|     9386 | 14824 | `	if( nArg < 1 ){` |
|        - | 14825 | `		/* Nothing to evaluate,return NULL */` |
|      ! 0 | 14826 | `		ph7_result_null(pCtx);` |
|      ! 0 | 14827 | `		return SXRET_OK;` |
|        - | 14828 | `	}` |
|        - | 14829 | `	/* File to include */` |
|     9386 | 14830 | `	sFile.zString = ph7_value_to_string(apArg[0],(int *)&sFile.nByte);` |
|     9386 | 14831 | `	if( sFile.nByte < 1 ){` |
...
|     9386 | 14837 | `	rc = VmExecIncludedFile(&(*pCtx),&sFile,FALSE);` |
|     9386 | 14838 | `	if( rc != SXRET_OK ){` |
...
|        - | 15502 | ` */` |
|  3176246 | 15503 | `static VmRefObj * VmNewRefObj(ph7_vm *pVm,sxu32 nIdx)` |
|        2 | 15504 |  |
|        - | 15505 | `	VmRefObj *pRef;` |
|        - | 15506 | `	/* Allocate a new instance */` |
|  3176248 | 15507 | `	pRef = (VmRefObj *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmRefObj));` |
|  3176248 | 15508 | `	if( pRef == 0 ){` |
|      ! 0 | 15509 | `		return 0;` |
|        - | 15510 | `	}` |
|        - | 15511 | `	/* Zero the structure */` |
|  3176248 | 15512 | `	SyZero(pRef,sizeof(VmRefObj));` |
|        - | 15513 | `	/* Initialize fields */` |
|  3176248 | 15514 | `	SySetInit(&pRef->aReference,&pVm->sAllocator,sizeof(SyHashEntry *));` |
|  3176248 | 15515 | `	SySetInit(&pRef->aArrEntries,&pVm->sAllocator,sizeof(ph7_hashmap_node *));` |
|  3176248 | 15516 | `	pRef->nIdx = nIdx;` |
|  3176248 | 15517 | `	return pRef;` |
|  1588125 | 15518 |  |
|        - | 15519 | `/*` |
|        - | 15520 | ` * Default hash function used by the reference table` |
|        - | 15521 | ` * for lookup/insertion operations.` |
|        - | 15522 | ` */` |
| 17428982 | 15523 | `static sxu32 VmRefHash(sxu32 nIdx)` |
|        2 | 15524 |  |
|        - | 15525 | `	/* Calculate the hash based on the memory object index */` |
| 17428984 | 15526 | `	return nIdx ^ (nIdx << 8) ^ (nIdx >> 8);` |
|        2 | 15527 |  |
|        - | 15528 | `/*` |
...
|        - | 15538 | ` * extension.` |
|        - | 15539 | ` */` |
|  9469804 | 15540 | `static VmRefObj * VmRefObjExtract(ph7_vm *pVm,sxu32 nObjIdx)` |
|        2 | 15541 |  |
|        - | 15542 | `	VmRefObj *pRef;` |
|        - | 15543 | `	sxu32 nBucket;` |
|        - | 15544 | `	/* Point to the appropriate bucket */` |
|  9469806 | 15545 | `	nBucket = VmRefHash(nObjIdx) & (pVm->nRefSize - 1);` |
|        - | 15546 | `	/* Perform the lookup */` |
|  9469806 | 15547 | `	pRef = pVm->apRefObj[nBucket];` |
| 20683103 | 15548 | `	for(;;){` |
| 41372871 | 15549 | `		if( pRef == 0 ){` |
|  3279950 | 15550 | `			break;` |
|        - | 15551 | `		}` |
| 38092923 | 15552 | `		if( pRef->nIdx == nObjIdx ){` |
|        - | 15553 | `			/* Entry found */` |
|  6189858 | 15554 | `			return pRef;` |
|        - | 15555 | `		}` |
|        - | 15556 | `		/* Point to the next entry */` |
| 31903067 | 15557 | `		pRef = pRef->pNextCollide;` |
|        2 | 15558 | `	}` |
|        - | 15559 | `	/* No such entry,return NULL */` |
|  3279950 | 15560 | `	return 0;` |
|  4734904 | 15561 |  |
|        - | 15562 | `/*` |
...
|        - | 15570 | ` * extension.` |
|        - | 15571 | ` */` |
|  3176246 | 15572 | `static sxi32 VmRefObjInsert(ph7_vm *pVm,VmRefObj *pRef)` |
|        2 | 15573 |  |
|        - | 15574 | `	sxu32 nBucket;` |
|  3176248 | 15575 | `	if( pVm->nRefUsed * 3 >= pVm->nRefSize ){` |
...
|  3176248 | 15609 | `	nBucket = VmRefHash(pRef->nIdx) & (pVm->nRefSize - 1);` |
|        - | 15610 | `	/* Insert the entry */` |
|  3176248 | 15611 | `	pRef->pNextCollide = pVm->apRefObj[nBucket];` |
|  3176248 | 15612 | `	if( pVm->apRefObj[nBucket] ){` |
|  2594245 | 15613 | `		pVm->apRefObj[nBucket]->pPrevCollide = pRef;` |
|  1297066 | 15614 | `	}` |
|  3176248 | 15615 | `	pVm->apRefObj[nBucket] = pRef;` |
|  3176248 | 15616 | `	MACRO_LD_PUSH(pVm->pRefList,pRef);` |
|  3176248 | 15617 | `	pVm->nRefUsed++;` |
|  3176248 | 15618 | `	return SXRET_OK;` |
|        2 | 15619 |  |
|        - | 15620 | `/*` |
...
|        - | 15630 | ` * extension.` |
|        - | 15631 | ` */` |
|  3135336 | 15632 | `static sxi32 VmRefObjUnlink(ph7_vm *pVm,VmRefObj *pRef)` |
|        2 | 15633 |  |
|        - | 15634 | `	ph7_hashmap_node **apNode;` |
|        - | 15635 | `	SyHashEntry **apEntry;` |
|        - | 15636 | `	sxu32 n;` |
|        - | 15637 | `	/* Point to the reference table */` |
|  3135338 | 15638 | `	apNode = (ph7_hashmap_node **)SySetBasePtr(&pRef->aArrEntries);` |
|  3135338 | 15639 | `	apEntry = (SyHashEntry **)SySetBasePtr(&pRef->aReference);` |
|        - | 15640 | `	/* Unlink the entry from the reference table */` |
|  3244904 | 15641 | `	for( n = 0 ; n < SySetUsed(&pRef->aReference) ; n++ ){` |
|   109568 | 15642 | `		if( apEntry[n] ){` |
|   109518 | 15643 | `			SyHashDeleteEntry2(apEntry[n]);` |
|    54758 | 15644 | `		}` |
|    54785 | 15645 | `	}` |
|  6161336 | 15646 | `	for(n = 0 ; n < SySetUsed(&pRef->aArrEntries) ; ++n ){` |
|  3026000 | 15647 | `		if( apNode[n] ){` |
|     6812 | 15648 | `			PH7_HashmapUnlinkNode(apNode[n],FALSE);` |
|     3405 | 15649 | `		}` |
|  1513001 | 15650 | `	}` |
|  3135338 | 15651 | `	if( pRef->pPrevCollide ){` |
|  1195792 | 15652 | `		pRef->pPrevCollide->pNextCollide = pRef->pNextCollide;` |
|   597830 | 15653 | `	}else{` |
|  1939548 | 15654 | `		pVm->apRefObj[VmRefHash(pRef->nIdx) & (pVm->nRefSize - 1)] = pRef->pNextCollide;` |
|        - | 15655 | `	}` |
|  3135338 | 15656 | `	if( pRef->pNextCollide ){` |
|  1781305 | 15657 | `		pRef->pNextCollide->pPrevCollide = pRef->pPrevCollide;` |
|   890649 | 15658 | `	}` |
|  3135338 | 15659 | `	MACRO_LD_REMOVE(pVm->pRefList,pRef);` |
|        - | 15660 | `	/* Release the node */` |
|  3135338 | 15661 | `	SySetRelease(&pRef->aReference);` |
|  3135338 | 15662 | `	SySetRelease(&pRef->aArrEntries);` |
|  3135338 | 15663 | `	SyMemBackendPoolFree(&pVm->sAllocator,pRef);` |
|  3135338 | 15664 | `	pVm->nRefUsed--;` |
|  3135338 | 15665 | `	return SXRET_OK;` |
|        2 | 15666 |  |
|        - | 15667 | `/*` |
...
|        - | 15674 | ` * extension.` |
|        - | 15675 | ` */` |
|  3211512 | 15676 | `PH7_PRIVATE sxi32 PH7_VmRefObjInstall(` |
...
|        - | 15682 | `	)` |
|        2 | 15683 |  |
|  3211514 | 15684 | `	VmFrame *pFrame = pVm->pFrame;` |
|        - | 15685 | `	VmRefObj *pRef;` |
|        - | 15686 | `	/* Check if the referenced object already exists */` |
|  3211514 | 15687 | `	pRef = VmRefObjExtract(&(*pVm),nIdx);` |
|  3211514 | 15688 | `	if( pRef == 0 ){` |
|        - | 15689 | `		/* Create a new entry */` |
|  3176248 | 15690 | `		pRef = VmNewRefObj(&(*pVm),nIdx);` |
|  3176248 | 15691 | `		if( pRef == 0 ){` |
|      ! 0 | 15692 | `			return SXERR_MEM;` |
|        - | 15693 | `		}` |
|  3176248 | 15694 | `		pRef->iFlags = iFlags;` |
|        - | 15695 | `		/* Install the entry */` |
|  3176248 | 15696 | `		VmRefObjInsert(&(*pVm),pRef);` |
|  1588123 | 15697 | `	}` |
|  3211514 | 15698 | `	pFrame = VmSkipExceptionFrames(pFrame);` |
|  3211514 | 15699 | `	if( pFrame->pParent != 0 && pEntry ){` |
|        - | 15700 | `		VmSlot sRef;` |
|        - | 15701 | `		/* Local frame,record referenced entry so that it can` |
|        - | 15702 | `		 * be deleted when we leave this frame.` |
|        - | 15703 | `		 */` |
|   103800 | 15704 | `		sRef.nIdx = nIdx;` |
|   103800 | 15705 | `		sRef.pUserData = pEntry;` |
|   103800 | 15706 | `		if( SXRET_OK != SySetPut(&pFrame->sRef,(const void *)&sRef)) {` |
|      ! 0 | 15707 | `			pEntry = 0; /* Do not record this entry */` |
|      ! 0 | 15708 | `		}` |
|    51899 | 15709 | `	}` |
|  3211514 | 15710 | `	if( pEntry ){` |
|        - | 15711 | `		/* Address of the hash-entry */` |
|   138854 | 15712 | `		SySetPut(&pRef->aReference,(const void *)&pEntry);` |
|    69426 | 15713 | `	}` |
|  3211514 | 15714 | `	if( pMapEntry ){` |
|        - | 15715 | `		/* Address of the hashmap node [i.e: Array entry] */` |
|  3064518 | 15716 | `		SySetPut(&pRef->aArrEntries,(const void *)&pMapEntry);` |
|  1532258 | 15717 | `	}` |
|  3211514 | 15718 | `	return SXRET_OK;` |
|  1605758 | 15719 |  |
|        - | 15720 | `/*` |
...
|        - | 15727 | ` * extension.` |
|        - | 15728 | ` */` |
|  3122950 | 15729 | `PH7_PRIVATE sxi32 PH7_VmRefObjRemove(` |
...
|  3122952 | 15739 | `	pRef = VmRefObjExtract(&(*pVm),nIdx);` |
|  3122952 | 15740 | `	if( pRef == 0 ){` |
|        - | 15741 | `		/* Not such entry */` |
|   103698 | 15742 | `		return SXERR_NOTFOUND;` |
|        - | 15743 | `	}` |
|        - | 15744 | `	/* Remove the desired entry */` |
|  3019256 | 15745 | `	if( pEntry ){` |
...
|       85 | 15758 | `		}` |
|       30 | 15759 | `	}` |
|  3019256 | 15760 | `	if( pMapEntry ){` |
|        - | 15761 | `		ph7_hashmap_node **apNode;` |
|  3019196 | 15762 | `		apNode = (ph7_hashmap_node **)SySetBasePtr(&pRef->aArrEntries);` |
|  6038484 | 15763 | `		for(n = 0 ; n < SySetUsed(&pRef->aArrEntries) ; n++ ){` |
|  3019290 | 15764 | `			if( apNode[n] == pMapEntry ){` |
|        - | 15765 | `				/* nullify the entry */` |
|  3019196 | 15766 | `				apNode[n] = 0;` |
|  1509597 | 15767 | `			}` |
|  1509646 | 15768 | `		}` |
|  1509597 | 15769 | `	}` |
|  3019256 | 15770 | `	return SXRET_OK;` |
|  1561477 | 15771 |  |
...
|        - | 15780 | ` */` |
|    28622 | 15781 | `PH7_PRIVATE const ph7_io_stream * PH7_VmGetStreamDevice(` |
...
|    28624 | 15793 | `	zNext = zCur = zIn = *pzDevice;` |
|    28624 | 15794 | `	zEnd = &zIn[nByte];` |
|  1826576 | 15795 | `	while( zIn < zEnd ){` |
|  1797956 | 15796 | `		if( zIn < &zEnd[-3]/*://*/ && zIn[0] == ':' && zIn[1] == '/' && zIn[2] == '/' ){` |
|        - | 15797 | `			/* Got one */` |
...
|  1797954 | 15802 | `		zIn++;` |
|        2 | 15803 | `	}` |
|    28624 | 15804 | `	if( zIn >= zEnd ){` |
|        - | 15805 | `		/* No such scheme,return the default stream */` |
|    28622 | 15806 | `		return pVm->pDefStream;` |
|        - | 15807 | `	}` |
