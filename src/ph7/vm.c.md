...
|        - |   75 | ` */` |
|  1282370 |   76 | `PH7_PRIVATE sxi32 VmIsUnorderedCmp(ph7_value *pLeft,ph7_value *pRight)` |
|        5 |   77 | `{` |
|  1282375 |   78 | `	if( (pLeft->iFlags & MEMOBJ_REAL) && PH7_IS_NAN(pLeft->rVal) ){` |
|       40 |   79 | `		return TRUE;` |
|        - |   80 | `	}` |
|  1282337 |   81 | `	if( (pRight->iFlags & MEMOBJ_REAL) && PH7_IS_NAN(pRight->rVal) ){` |
|       11 |   82 | `		return TRUE;` |
|        - |   83 | `	}` |
|  1282327 |   84 | `	return FALSE;` |
|   641705 |   85 | `}` |
|        - |   86 | `/*` |
...
|        - |   94 | ` */` |
|   367508 |   95 | `PH7_PRIVATE int VmStringWantsPerlIncr(ph7_value *pVal)` |
|        5 |   96 | `{` |
|        - |   97 | `	SyString sStr;` |
|   367513 |   98 | `	sxu8 bReal = FALSE;` |
|   367513 |   99 | `	const char *zTail = 0;` |
|        - |  100 | `	const char *zEnd;` |
|   367513 |  101 | `	if( (pVal->iFlags & MEMOBJ_STRING) == 0 ){` |
|   367499 |  102 | `		return FALSE;` |
|        - |  103 | `	}` |
...
|        - |  136 | ` */` |
|  1521748 |  137 | `PH7_PRIVATE sxi32 PH7_VmRegisterConstant(` |
...
|        - |  142 | `	)` |
|        5 |  143 | `{` |
|  1521753 |  144 | `	return PH7_VmRegisterConstantEx(&(*pVm),pName,xExpand,pUserData,0,0,0);` |
|        5 |  145 | `}` |
|        - |  146 | `/*` |
...
|        - |  149 | ` */` |
|  1521800 |  150 | `PH7_PRIVATE sxi32 PH7_VmRegisterConstantEx(` |
...
|        - |  162 | `	char *zDupName;` |
|        - |  163 | `	sxi32 rc;` |
|  1521805 |  164 | `	pEntry = SyHashGet(&pVm->hConstant,(const void *)pName->zString,pName->nByte);` |
|  1521805 |  165 | `	if( pEntry ){` |
...
|  1521803 |  189 | `	pCons = (ph7_constant *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_constant));` |
|  1521803 |  190 | `	if( pCons == 0 ){` |
|      ! 0 |  191 | `		return 0;` |
|        - |  192 | `	}` |
|        - |  193 | `	/* Duplicate constant name */` |
|  1521803 |  194 | `	zDupName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|  1521803 |  195 | `	if( zDupName == 0 ){` |
|      ! 0 |  196 | `		SyMemBackendPoolFree(&pVm->sAllocator,pCons);` |
|      ! 0 |  197 | `		return 0;` |
|        - |  198 | `	}` |
|  1521803 |  199 | `	SyStringInitFromBuf(&pCons->sFile,0,0);` |
|  1521803 |  200 | `	if( pFile ){` |
|       54 |  201 | `		SyStringDupPtr(&pCons->sFile,pFile);` |
|       25 |  202 | `	}` |
|  1521803 |  203 | `	pCons->nLine = nLine;` |
|  1521803 |  204 | `	pCons->bUserDefined = (sxu8)(bUser ? 1 : 0);` |
|        - |  205 | `	/* Install the constant */` |
|  1521803 |  206 | `	SyStringInitFromBuf(&pCons->sName,zDupName,pName->nByte);` |
|  1521803 |  207 | `	pCons->xExpand = xExpand;` |
|  1521803 |  208 | `	pCons->pUserData = pUserData;` |
|  1521803 |  209 | `	SySetInit(&pCons->aAttrs,&pVm->sAllocator,sizeof(ph7_attribute));` |
|  1521803 |  210 | `	rc = SyHashInsert(&pVm->hConstant,(const void *)zDupName,SyStringLength(&pCons->sName),pCons);` |
|  1521803 |  211 | `	if( rc != SXRET_OK ){` |
...
|        - |  225 | ` */` |
|  2227732 |  226 | `static sxi32 PH7_NewForeignFunction(` |
...
|  2227737 |  237 | `	pFunc = (ph7_user_func *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_user_func));` |
|  2227737 |  238 | `	if( pFunc == 0 ){` |
|      ! 0 |  239 | `		return SXERR_MEM;` |
|        - |  240 | `	}` |
|        - |  241 | `	/* Duplicate function name */` |
|  2227737 |  242 | `	zDup = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|  2227737 |  243 | `	if( zDup == 0 ){` |
|      ! 0 |  244 | `		SyMemBackendPoolFree(&pVm->sAllocator,pFunc);` |
|      ! 0 |  245 | `		return SXERR_MEM;` |
|        - |  246 | `	}` |
|        - |  247 | `	/* Zero the structure */` |
|  2227737 |  248 | `	SyZero(pFunc,sizeof(ph7_user_func));` |
|        - |  249 | `	/* Initialize structure fields */` |
|  2227737 |  250 | `	SyStringInitFromBuf(&pFunc->sName,zDup,pName->nByte);` |
|  2227737 |  251 | `	pFunc->pVm   = pVm;` |
|  2227737 |  252 | `	pFunc->xFunc = xFunc;` |
|  2227737 |  253 | `	pFunc->pUserData = pUserData;` |
|  2227737 |  254 | `	SySetInit(&pFunc->aAux,&pVm->sAllocator,sizeof(ph7_aux_data));` |
|        - |  255 | `	/* Write a pointer to the new function */` |
|  2227737 |  256 | `	*ppOut = pFunc;` |
|  2227737 |  257 | `	return SXRET_OK;` |
|  1113871 |  258 | `}` |
|        - |  259 | `/*` |
...
|        - |  266 | ` */` |
|  2231144 |  267 | `PH7_PRIVATE sxi32 PH7_VmInstallForeignFunction(` |
...
|  2231149 |  278 | `	pEntry = SyHashGet(&pVm->hHostFunction,pName->zString,pName->nByte);` |
|  2231149 |  279 | `	if( pEntry ){` |
|     3417 |  280 | `		pFunc = (ph7_user_func *)pEntry->pUserData;` |
|     3417 |  281 | `		pFunc->pUserData = pUserData;` |
|     3417 |  282 | `		pFunc->xFunc = xFunc;` |
|     3417 |  283 | `		SySetReset(&pFunc->aAux);` |
...
|     3417 |  288 | `		pFunc->nMinArg  = 0;` |
|     3417 |  289 | `		pFunc->bAtLeast = 0;` |
|     3417 |  290 | `		return SXRET_OK;` |
|        - |  291 | `	}` |
|        - |  292 | `	/* Create a new user function */` |
|  2227737 |  293 | `	rc = PH7_NewForeignFunction(&(*pVm),&(*pName),xFunc,pUserData,&pFunc);` |
|  2227737 |  294 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  295 | `		return rc;` |
|        - |  296 | `	}` |
|        - |  297 | `	/* Install the function in the corresponding hashtable */` |
|  2227737 |  298 | `	rc = SyHashInsert(&pVm->hHostFunction,SyStringData(&pFunc->sName),pName->nByte,pFunc);` |
|  2227737 |  299 | `	if( rc != SXRET_OK ){` |
...
|  2227737 |  305 | `	return SXRET_OK;` |
|  1115577 |  306 | `}` |
|        - |  307 | `/*` |
|        - |  308 | ` * Initialize a VM function.` |
|        - |  309 | ` */` |
|  3418944 |  310 | `PH7_PRIVATE sxi32 PH7_VmInitFuncState(` |
...
|  3418949 |  320 | `	SyZero(pFunc,sizeof(ph7_vm_func));` |
|        - |  321 | `	/* Initialize structure fields */` |
|        - |  322 | `	/* Arguments container */` |
|  3418949 |  323 | `	SySetInit(&pFunc->aArgs,&pVm->sAllocator,sizeof(ph7_vm_func_arg));` |
|        - |  324 | `	/* Static variable container */` |
|  3418949 |  325 | `	SySetInit(&pFunc->aStatic,&pVm->sAllocator,sizeof(ph7_vm_func_static_var));` |
|        - |  326 | `	/* Bytecode container */` |
|  3418949 |  327 | `	SySetInit(&pFunc->aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|        - |  328 | `    /* Preallocate some instruction slots */` |
|  3418949 |  329 | `	SySetAlloc(&pFunc->aByteCode,0x10);` |
|        - |  330 | `	/* Closure environment */` |
|  3418949 |  331 | `	SySetInit(&pFunc->aClosureEnv,&pVm->sAllocator,sizeof(ph7_vm_func_closure_env));` |
|        - |  332 | `	/* Return-type union alternatives (empty unless declared as a union) */` |
|  3418949 |  333 | `	SySetInit(&pFunc->aReturnUnion,&pVm->sAllocator,sizeof(ph7_type_alt));` |
|        - |  334 | `	/* Declared #[...] attributes */` |
|  3418949 |  335 | `	SySetInit(&pFunc->aAttrs,&pVm->sAllocator,sizeof(ph7_attribute));` |
|  3418949 |  336 | `	pFunc->iFlags = iFlags;` |
|  3418949 |  337 | `	pFunc->pUserData = pUserData;` |
...
|  3418949 |  340 | `	pFunc->bStrictTypes = (sxu8)(pVm->sCodeGen.bStrictTypes ? 1 : 0);` |
|  3418949 |  341 | `	if( pVm->bCompilingBuiltin ){` |
|        - |  342 | `		/* Defined by an embedded builtin chunk: internal, no defining file */` |
|  3414405 |  343 | `		pFunc->iFlags \|= VM_FUNC_INTERNAL;` |
|  1707205 |  344 | `	}else{` |
...
|     4549 |  348 | `		SyString *pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|     4549 |  349 | `		if( pFile ){` |
|     4549 |  350 | `			SyStringDupPtr(&pFunc->sFile,pFile);` |
|     2272 |  351 | `		}` |
|        - |  352 | `	}` |
|  3418949 |  353 | `	SyStringInitFromBuf(&pFunc->sName,zName,nByte);` |
|  3418949 |  354 | `	return SXRET_OK;` |
|        5 |  355 | `}` |
|        - |  356 | `/*` |
...
|        - |  363 | ` */` |
|  5807320 |  364 | `PH7_PRIVATE sxi32 PH7_VmInstallUserFunction(` |
...
|        - |  371 | `	sxi32 rc;` |
|  5807325 |  372 | `	if( pName == 0 ){` |
|        - |  373 | `		/* Use the built-in name */` |
|   522463 |  374 | `		pName = &pFunc->sName;` |
|   261229 |  375 | `	}` |
|        - |  376 | `	/* Check for duplicates (functions with the same name) first */` |
|  5807325 |  377 | `	pEntry = SyHashGet(&pVm->hFunction,pName->zString,pName->nByte);` |
|  5807325 |  378 | `	if( pEntry ){` |
|  2861925 |  379 | `		ph7_vm_func *pLink = (ph7_vm_func *)pEntry->pUserData;` |
|  2861925 |  380 | `		if( pLink != pFunc ){` |
|        - |  381 | `			/* Link */` |
|       35 |  382 | `			pFunc->pNextName = pLink;` |
|       35 |  383 | `			pEntry->pUserData = pFunc;` |
|       16 |  384 | `		}` |
|  2861925 |  385 | `		return SXRET_OK;` |
|        - |  386 | `	}` |
|        - |  387 | `	/* First time seen */` |
|  2945405 |  388 | `	pFunc->pNextName = 0;` |
|  2945405 |  389 | `	rc = SyHashInsert(&pVm->hFunction,pName->zString,pName->nByte,pFunc);` |
|  2945405 |  390 | `	return rc;` |
|  2903665 |  391 | `}` |
|        - |  392 | `/*` |
|        - |  393 | ` * Install a user defined class in the corresponding VM container.` |
|        - |  394 | ` */` |
|   522066 |  395 | `PH7_PRIVATE sxi32 PH7_VmInstallClass(` |
|        - |  396 | `	ph7_vm *pVm,      /* Target VM  */` |
|        - |  397 | `	ph7_class *pClass /* Target Class */` |
|        - |  398 | `	)` |
|        5 |  399 | `{` |
|   522071 |  400 | `	SyString *pName = &pClass->sName;` |
|        - |  401 | `	SyHashEntry *pEntry;` |
|        - |  402 | `	sxi32 rc;` |
|        - |  403 | `	/* Check for duplicates */` |
|   522071 |  404 | `	pEntry = SyHashGet(&pVm->hClass,(const void *)pName->zString,pName->nByte);` |
|   522071 |  405 | `	if( pEntry ){` |
...
|        - |  411 | `	}` |
|   522069 |  412 | `	pClass->pNextName = 0;` |
|        - |  413 | `	/* Perform a simple hashtable insertion */` |
|   522069 |  414 | `	rc = SyHashInsert(&pVm->hClass,(const void *)pName->zString,pName->nByte,pClass);` |
|   522069 |  415 | `	return rc;` |
|   261038 |  416 | `}` |
|        - |  417 | `/*` |
|        - |  418 | ` * Instruction builder interface.` |
|        - |  419 | ` */` |
| 98399738 |  420 | `PH7_PRIVATE sxi32 PH7_VmEmitInstr(` |
...
|        5 |  428 | `{` |
|        - |  429 | `	VmInstr sInstr;` |
| 98399743 |  430 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|        - |  431 | `	sxi32 rc;` |
|        - |  432 | `	/* Fill the VM instruction */` |
| 98399743 |  433 | `	sInstr.iOp = (sxu8)iOp;` |
| 98399743 |  434 | `	sInstr.iP1 = iP1;` |
| 98399743 |  435 | `	sInstr.iP2 = iP2;` |
| 98399743 |  436 | `	sInstr.p3  = p3;` |
...
| 98399743 |  441 | `	sInstr.nLine = 0;` |
| 98399743 |  442 | `	if( pGen->pIn && pGen->pEnd && pGen->pIn < pGen->pEnd ){` |
| 41923303 |  443 | `		sInstr.nLine = pGen->pIn->nLine;` |
| 77438094 |  444 | `	}else if( pGen->pIn && pGen->pEnd && pGen->pIn >= pGen->pEnd && pGen->pEnd > (SyToken *)0 ){` |
|        - |  445 | `		/* Past the end (statement tail): blame the last real token. */` |
| 56261725 |  446 | `		sInstr.nLine = pGen->pEnd[-1].nLine;` |
| 28130860 |  447 | `	}` |
| 98399743 |  448 | `	if( pIndex ){` |
|        - |  449 | `		/* Instruction index in the bytecode array */` |
|  6661117 |  450 | `		*pIndex = SySetUsed(pVm->pByteContainer);` |
|  3330556 |  451 | `	}` |
|        - |  452 | `	/* Finally,record the instruction */` |
| 98399743 |  453 | `	rc = SySetPut(pVm->pByteContainer,(const void *)&sInstr);` |
| 98399743 |  454 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  455 | `		PH7_GenCompileError(&pVm->sCodeGen,E_ERROR,1,"Fatal,Cannot emit instruction due to a memory failure");` |
|        - |  456 | `		/* Fall throw */` |
|      ! 0 |  457 | `	}` |
| 98399743 |  458 | `	return rc;` |
|        5 |  459 | `}` |
|        - |  460 | `/*` |
|        - |  461 | ` * Swap the current bytecode container with the given one.` |
|        - |  462 | ` */` |
|  9785588 |  463 | `PH7_PRIVATE sxi32 PH7_VmSetByteCodeContainer(ph7_vm *pVm,SySet *pContainer)` |
|        5 |  464 | `{` |
|  9785593 |  465 | `	if( pContainer == 0 ){` |
|        - |  466 | `		/* Point to the default container */` |
|      ! 0 |  467 | `		pVm->pByteContainer = &pVm->aByteCode;` |
|      ! 0 |  468 | `	}else{` |
|        - |  469 | `		/* Change container */` |
|  9785593 |  470 | `		pVm->pByteContainer = &(*pContainer);` |
|        - |  471 | `	}` |
|  9785593 |  472 | `	return SXRET_OK;` |
|        5 |  473 | `}` |
|        - |  474 | `/*` |
|        - |  475 | ` * Return the current bytecode container.` |
|        - |  476 | ` */` |
|  4892794 |  477 | `PH7_PRIVATE SySet * PH7_VmGetByteCodeContainer(ph7_vm *pVm)` |
|        5 |  478 | `{` |
|  4892799 |  479 | `	return pVm->pByteContainer;` |
|        5 |  480 | `}` |
|        - |  481 | `/*` |
|        - |  482 | ` * Extract the VM instruction rooted at nIndex.` |
|        - |  483 | ` */` |
|  6867228 |  484 | `PH7_PRIVATE VmInstr * PH7_VmGetInstr(ph7_vm *pVm,sxu32 nIndex)` |
|        5 |  485 | `{` |
|        - |  486 | `	VmInstr *pInstr;` |
|  6867233 |  487 | `	pInstr = (VmInstr *)SySetAt(pVm->pByteContainer,nIndex);` |
|  6867233 |  488 | `	return pInstr;` |
|        5 |  489 | `}` |
|        - |  490 | `/*` |
|        - |  491 | ` * Return the total number of VM instructions recorded so far.` |
|        - |  492 | ` */` |
| 54187880 |  493 | `PH7_PRIVATE sxu32 PH7_VmInstrLength(ph7_vm *pVm)` |
|        5 |  494 | `{` |
| 54187885 |  495 | `	return SySetUsed(pVm->pByteContainer);` |
|        5 |  496 | `}` |
|        - |  497 | `/*` |
|        - |  498 | ` * Pop the last VM instruction.` |
|        - |  499 | ` */` |
|  5400498 |  500 | `PH7_PRIVATE VmInstr * PH7_VmPopInstr(ph7_vm *pVm)` |
|        5 |  501 | `{` |
|  5400503 |  502 | `	return (VmInstr *)SySetPop(pVm->pByteContainer);` |
|        5 |  503 | `}` |
|        - |  504 | `/*` |
|        - |  505 | ` * Peek the last VM instruction.` |
|        - |  506 | ` */` |
| 20457124 |  507 | `PH7_PRIVATE VmInstr * PH7_VmPeekInstr(ph7_vm *pVm)` |
|        5 |  508 | `{` |
| 20457129 |  509 | `	return (VmInstr *)SySetPeek(pVm->pByteContainer);` |
|        5 |  510 | `}` |
|  1712788 |  511 | `PH7_PRIVATE VmInstr * PH7_VmPeekNextInstr(ph7_vm *pVm)` |
|        5 |  512 | `{` |
|        - |  513 | `	VmInstr *aInstr;` |
|        - |  514 | `	sxu32 n;` |
|  1712793 |  515 | `	n = SySetUsed(pVm->pByteContainer);` |
|  1712793 |  516 | `	if( n < 2 ){` |
|      ! 0 |  517 | `		return 0;` |
|        - |  518 | `	}` |
|  1712793 |  519 | `	aInstr = (VmInstr *)SySetBasePtr(pVm->pByteContainer);` |
|  1712793 |  520 | `	return &aInstr[n - 2];` |
|   856399 |  521 | `}` |
|        - |  522 | `/*` |
|        - |  523 | ` * Allocate a new virtual machine frame.` |
|        - |  524 | ` */` |
|   114206 |  525 | `PH7_PRIVATE VmFrame * VmNewFrame(` |
...
|   114211 |  533 | `	pFrame = (VmFrame *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmFrame));` |
|   114211 |  534 | `	if( pFrame == 0 ){` |
|      ! 0 |  535 | `		return 0;` |
|        - |  536 | `	}` |
|        - |  537 | `	/* Zero the structure */` |
|   114211 |  538 | `	SyZero(pFrame,sizeof(VmFrame));` |
|        - |  539 | `	/* Initialize frame fields */` |
|   114211 |  540 | `	pFrame->pUserData = pUserData;` |
|   114211 |  541 | `	pFrame->pThis = pThis;` |
|   114211 |  542 | `	pFrame->pVm = pVm;` |
|   114211 |  543 | `	SyHashInit(&pFrame->hVar,&pVm->sAllocator,0,0);` |
|   114211 |  544 | `	SySetInit(&pFrame->sArg,&pVm->sAllocator,sizeof(VmSlot));` |
|   114211 |  545 | `	SySetInit(&pFrame->sLocal,&pVm->sAllocator,sizeof(VmSlot));` |
|   114211 |  546 | `	SySetInit(&pFrame->sRef,&pVm->sAllocator,sizeof(VmSlot));` |
|   114211 |  547 | `	pFrame->nActualArgs = -1; /* unknown until an arg-install site stamps it */` |
...
|   114211 |  550 | `	PH7_MemObjInit(&(*pVm),&pFrame->sRet);` |
|   114211 |  551 | `	return pFrame;` |
|    57211 |  552 | `}` |
...
|        - |  557 | ` */` |
|   113610 |  558 | `PH7_PRIVATE sxi32 VmEnterFrame(` |
...
|   113615 |  567 | `	pFrame = VmNewFrame(&(*pVm),pUserData,pThis);` |
|   113615 |  568 | `	if( pFrame == 0 ){` |
|      ! 0 |  569 | `		return SXERR_MEM;` |
|        - |  570 | `	}` |
|        - |  571 | `	/* The line currently executing IS the call site for the frame being pushed. */` |
|   113615 |  572 | `	pFrame->nCallLine = pVm->nCurLine;` |
|        - |  573 | `	/* Link to the list of active VM frame */` |
|   113615 |  574 | `	pFrame->pParent = pVm->pFrame;` |
|   113615 |  575 | `	pVm->pFrame = pFrame;` |
|   113615 |  576 | `	if( ppFrame ){` |
|        - |  577 | `		/* Write a pointer to the new VM frame */` |
|   109727 |  578 | `		*ppFrame = pFrame;` |
|    54964 |  579 | `	}` |
|   113615 |  580 | `	return SXRET_OK;` |
|    56913 |  581 | `}` |
|        - |  582 | `/*` |
...
|        - |  630 | ` */` |
|   110152 |  631 | `PH7_PRIVATE void VmDropResumeTarget(ph7_vm *pVm, VmFrame *pFrame)` |
|        5 |  632 | `{` |
|   110157 |  633 | `	if( pVm->pResumeFrame == pFrame ){` |
...
|        - |  639 | ` */` |
|   109300 |  640 | `PH7_PRIVATE void VmLeaveFrame(ph7_vm *pVm)` |
|        5 |  641 | `{` |
|   109305 |  642 | `		VmFrame *pCurFrame = pVm->pFrame;` |
|   109305 |  643 | `	if( pCurFrame ){` |
|        - |  644 | `		/* Unlink from the list of active VM frame */` |
|   109305 |  645 | `		pVm->pFrame = pCurFrame->pParent;` |
|   109305 |  646 | `		if( pCurFrame->pParent && (pCurFrame->iFlags & VM_FRAME_EXCEPTION) == 0 ){` |
|        - |  647 | `			VmSlot  *aSlot;` |
|        - |  648 | `			sxu32 n;` |
|        - |  649 | `			/* Restore local variable to the free pool so that they can be reused again */` |
|   104457 |  650 | `			aSlot = (VmSlot *)SySetBasePtr(&pCurFrame->sLocal);` |
|   593945 |  651 | `			for(n = 0 ; n < SySetUsed(&pCurFrame->sLocal) ; ++n ){` |
|        - |  652 | `				/* Unset the local variable */` |
|   489493 |  653 | `				PH7_VmUnsetMemObj(&(*pVm),aSlot[n].nIdx,FALSE);` |
|   245367 |  654 | `			}` |
|        - |  655 | `			/* Remove local reference */` |
|   104457 |  656 | `			aSlot = (VmSlot *)SySetBasePtr(&pCurFrame->sRef);` |
|   594029 |  657 | `			for(n = 0 ; n < SySetUsed(&pCurFrame->sRef) ; ++n ){` |
|   489577 |  658 | `				PH7_VmRefObjRemove(&(*pVm),aSlot[n].nIdx,(SyHashEntry *)aSlot[n].pUserData,0);` |
|   245409 |  659 | `			}` |
|    52329 |  660 | `		}` |
|        - |  661 | `		/* Release internal containers */` |
|   109305 |  662 | `		SyHashRelease(&pCurFrame->hVar);` |
|   109305 |  663 | `		SySetRelease(&pCurFrame->sArg);` |
|   109305 |  664 | `		SySetRelease(&pCurFrame->sLocal);` |
|   109305 |  665 | `		SySetRelease(&pCurFrame->sRef);` |
...
|   109305 |  669 | `		PH7_MemObjRelease(&pCurFrame->sRet);` |
|        - |  670 | `		/* Drop a recorded in-place-catch resume target pointing at this frame (ROOT B). */` |
|   109305 |  671 | `		VmDropResumeTarget(pVm,pCurFrame);` |
|        - |  672 | `		/* Release the whole structure */` |
|   109305 |  673 | `		SyMemBackendPoolFree(&pVm->sAllocator,pCurFrame);` |
|    54753 |  674 | `	}` |
|   109305 |  675 | `}` |
|        - |  676 | `/*` |
...
|        - |  727 | ` */` |
| 10559439 |  728 | `PH7_PRIVATE VmFrame * VmSkipExceptionFrames(VmFrame *pFrame)` |
|        5 |  729 | `{` |
| 10584714 |  730 | `	while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|    25275 |  731 | `		pFrame = pFrame->pParent;` |
|        5 |  732 | `	}` |
| 10559444 |  733 | `	return pFrame;` |
|        5 |  734 | `}` |
|        - |  735 | `/*` |
...
|        - |  757 | ` */` |
|     2946 |  758 | `PH7_PRIVATE int VmRecordedResume(ph7_vm *pVm,sxi32 *pResumePc,VmFrame *pEntryFrame,VmInstr *aInstr)` |
|        5 |  759 | `{` |
|     2951 |  760 | `	if( pVm->pResumeFrame == 0 ){` |
...
|     2932 |  771 | `	if( VmSkipExceptionFrames(pEntryFrame) != pVm->pResumeFrame` |
|     2458 |  772 | `	 \|\| (void *)aInstr != pVm->pResumeInstr` |
|     1976 |  773 | `	 \|\| pVm->iResumePc == 0 ){` |
...
|     3342 |  802 | `	while( pVm->pFrame != pEntryFrame` |
|     3813 |  803 | `	    && !((pVm->pFrame->iFlags & VM_FRAME_EXCEPTION)` |
|     2423 |  804 | `	         && pVm->pFrame->iExceptionJump == pVm->iResumePc) ){` |
|      815 |  805 | `		VmLeaveFrame(&(*pVm));` |
|        5 |  806 | `	}` |
|     1963 |  807 | `	*pResumePc = (sxi32)pVm->iResumePc - 1;` |
|     1963 |  808 | `	pVm->pResumeFrame = 0; /* one-shot consume */` |
...
|     1963 |  812 | `	pVm->nBoundaryRc = 0;` |
|     1963 |  813 | `	return TRUE;` |
|     1478 |  814 | `}` |
|        - |  815 | `/*` |
...
|        - |  844 | ` * activation.` |
|        - |  845 | ` */` |
|     2694 |  846 | `PH7_PRIVATE ph7_exception * VmExcActivate(ph7_vm *pVm,ph7_exception *pCompiled)` |
|        5 |  847 | `{` |
|     2699 |  848 | `	ph7_exception *pClone = (ph7_exception *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_exception));` |
|     2699 |  849 | `	if( pClone == 0 ){` |
|      ! 0 |  850 | `		return 0;` |
|        - |  851 | `	}` |
|     2699 |  852 | `	*pClone = *pCompiled;` |
|     2699 |  853 | `	pClone->pCompiled = pCompiled;` |
|     2699 |  854 | `	pClone->iFinallyDone = 0;` |
|     2699 |  855 | `	pClone->iInCatch = 0;` |
|     2699 |  856 | `	pClone->pInflight = 0;` |
|     2699 |  857 | `	pClone->pFrame = 0;` |
|     2699 |  858 | `	return pClone;` |
|     1352 |  859 | `}` |
|     5312 |  860 | `PH7_PRIVATE void VmExcRelease(ph7_vm *pVm,ph7_exception *pExc)` |
|        5 |  861 | `{` |
|     5317 |  862 | `	if( pExc && pExc->pCompiled ){` |
...
|     2687 |  867 | `		if( pExc->pInflight ){` |
|      ! 0 |  868 | `			PH7_ClassInstanceUnref(pExc->pInflight);` |
|      ! 0 |  869 | `			pExc->pInflight = 0;` |
|      ! 0 |  870 | `		}` |
|     2687 |  871 | `		SyMemBackendPoolFree(&pVm->sAllocator,pExc);` |
|     1341 |  872 | `	}` |
|     5317 |  873 | `}` |
|        - |  874 | `/*` |
...
|      ! 0 |  913 | `	return 0;` |
|       38 |  914 | `}` |
|   257700 |  915 | `PH7_PRIVATE sxi32 VmDrainFinally(ph7_vm *pVm, sxu32 nExceptionBase)` |
|        5 |  916 | `{` |
|        - |  917 | `	sxu32 nUsed;` |
|   257705 |  918 | `	sxi32 rcOut = SXRET_OK;` |
|   257769 |  919 | `	while( (nUsed = SySetUsed(&pVm->aException)) > nExceptionBase ){` |
|       68 |  920 | `		ph7_exception **apExc = (ph7_exception **)SySetBasePtr(&pVm->aException);` |
|       68 |  921 | `		ph7_exception *pExc = apExc[nUsed - 1];` |
|       68 |  922 | `		(void)SySetPop(&pVm->aException);` |
|       68 |  923 | `		pExc->pFrame = 0;` |
...
|       68 |  929 | `		if( pVm->pFrame->iFlags & VM_FRAME_EXCEPTION ){` |
|       68 |  930 | `			VmLeaveFrame(&(*pVm));` |
|       32 |  931 | `		}` |
|       92 |  932 | `		if( pExc->iHasFinally && !pExc->iFinallyDone ){` |
|        - |  933 | `			sxi32 rcF;` |
...
|        - |  956 | ` */` |
|   154846 |  957 | `PH7_PRIVATE void VmClearFrameReturn(VmFrame *pFrame)` |
|        5 |  958 | `{` |
|   154851 |  959 | `	pFrame->bHasRet = 0;` |
|   154851 |  960 | `	PH7_MemObjRelease(&pFrame->sRet);` |
|   154851 |  961 | `}` |
|        - |  962 | `/*` |
...
|        - | 1110 | ` */` |
|    34836 | 1111 | `PH7_PRIVATE sxi32 VmLocalExecIntoObj(ph7_vm *pVm,SySet *pByteCode,ph7_value **ppMemObj,int bReturnPropagates)` |
|        5 | 1112 | `{` |
|        - | 1113 | `	ph7_value sVal;` |
|    34841 | 1114 | `	sxu32 nIdx = (*ppMemObj)->nIdx;` |
|        - | 1115 | `	sxi32 rc;` |
|    34841 | 1116 | `	PH7_MemObjInit(&(*pVm),&sVal);` |
|    34841 | 1117 | `	rc = VmLocalExec(&(*pVm),pByteCode,&sVal,bReturnPropagates);` |
|        - | 1118 | `	/* aMemObj may have moved during the eval — re-fetch by the reserved index. */` |
|    34841 | 1119 | `	*ppMemObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|    34841 | 1120 | `	if( *ppMemObj ){` |
|    34841 | 1121 | `		PH7_MemObjStore(&sVal,*ppMemObj);` |
|    17418 | 1122 | `	}` |
|    34841 | 1123 | `	PH7_MemObjRelease(&sVal);` |
|    34841 | 1124 | `	return rc;` |
|        5 | 1125 | `}` |
|        - | 1126 | `/*` |
...
|        - | 1138 | ` */` |
|   703740 | 1139 | `static sxi32 VmMountUserClassAttrs(` |
...
|   703745 | 1147 | `	SyHashResetLoopCursor(&pClass->hAttr);` |
|        - | 1148 | `	/* Process only static and constant attribute */` |
|  2864519 | 1149 | `	while( (pEntry = SyHashGetNextEntry(&pClass->hAttr)) != 0 ){` |
|        - | 1150 | `		/* Extract the current attribute */` |
|  2160783 | 1151 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|  2160778 | 1152 | `		if( (pAttr->iFlags & PH7_CLASS_ATTR_CONSTANT)` |
|  1423926 | 1153 | `		 && ((pAttr->iFlags & PH7_CLASS_ATTR_TYPED) == 0` |
|   343980 | 1154 | `			\|\| (pAttr->iFlags & PH7_CLASS_ATTR_ENUMCASE) != 0) ){` |
...
|   686173 | 1164 | `			continue;` |
|        - | 1165 | `		}` |
|  1474615 | 1166 | `		if( pAttr->iFlags & (PH7_CLASS_ATTR_STATIC\|PH7_CLASS_ATTR_CONSTANT) ){` |
|        - | 1167 | `			ph7_value *pMemObj;` |
|    24887 | 1168 | `			if( pAttr->nIdx != SXU32_HIGH ){` |
...
|    24019 | 1175 | `			pMemObj = PH7_ReserveMemObj(&(*pVm));` |
|    24019 | 1176 | `			if( pMemObj == 0 ){` |
...
|        - | 1182 | `			}` |
|    24019 | 1183 | `			if( SySetUsed(&pAttr->aByteCode) > 0 ){` |
...
|    24011 | 1187 | `				ph7_class *pSaveCtx = pVm->pConstEvalClass;` |
|        - | 1188 | `				sxi32 rcExec;` |
|    24011 | 1189 | `				pVm->pConstEvalClass = pAttr->pDeclClass ? pAttr->pDeclClass : pClass;` |
|    24011 | 1190 | `				pAttr->iFlags \|= PH7_CLASS_ATTR_EVALING; /* cycle guard, shared with the on-demand path */` |
|    24011 | 1191 | `				pVm->nConstEvalDepth++;` |
|    24011 | 1192 | `				rcExec = VmLocalExecIntoObj(&(*pVm),&pAttr->aByteCode,&pMemObj,FALSE);` |
|    24011 | 1193 | `				pVm->nConstEvalDepth--;` |
|    24011 | 1194 | `				pAttr->iFlags &= ~PH7_CLASS_ATTR_EVALING;` |
|    24011 | 1195 | `				pVm->pConstEvalClass = pSaveCtx;` |
|    24011 | 1196 | `				if( rcExec == PH7_EXCEPTION \|\| rcExec == PH7_ABORT ){` |
...
|    24011 | 1202 | `				}else if( pVm->pConstCycleAttr && pVm->nConstEvalDepth == 0 ){` |
...
|    24006 | 1210 | `				if( (pAttr->iFlags & (PH7_CLASS_ATTR_CONSTANT\|PH7_CLASS_ATTR_TYPED))` |
|    12008 | 1211 | `					== (PH7_CLASS_ATTR_CONSTANT\|PH7_CLASS_ATTR_TYPED) ){` |
...
|    24015 | 1219 | `			pAttr->nIdx = pMemObj->nIdx;` |
|        - | 1220 | `			/* Install static attribute in the reference table */` |
|    24015 | 1221 | `			PH7_VmRefObjInstall(&(*pVm),pMemObj->nIdx,0,0,VM_REF_IDX_KEEP);` |
...
|    24010 | 1228 | `			if( (pAttr->iFlags & PH7_CLASS_ATTR_TYPED)` |
|    12033 | 1229 | `				&& (pAttr->iFlags & PH7_CLASS_ATTR_CONSTANT) == 0 ){` |
...
|    12005 | 1248 | `		}` |
|        5 | 1249 | `	}` |
|   703741 | 1250 | `	return SXRET_OK;` |
|   351875 | 1251 | `}` |
|   702664 | 1252 | `PH7_PRIVATE sxi32 VmMountUserClass(` |
...
|   702669 | 1261 | `	rc = VmMountUserClassAttrs(&(*pVm),pClass);` |
|   702669 | 1262 | `	if( rc != SXRET_OK ){` |
|        6 | 1263 | `		return rc;` |
|        - | 1264 | `	}` |
|        - | 1265 | `	/* Install class methods */` |
|   702665 | 1266 | `	if( pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|        - | 1267 | `		/* Do not mount interface/trait methods since they are not directly invocable.` |
|        - | 1268 | `		 */` |
|   312121 | 1269 | `		return SXRET_OK;` |
|        - | 1270 | `	}` |
|        - | 1271 | `	/* Create constructor alias if not yet done */` |
|   390549 | 1272 | `	if( SyHashGet(&pClass->hMethod,"__construct",sizeof("__construct")-1) == 0 ){` |
|        - | 1273 | `		/* User constructor with the same base class name */` |
|    59487 | 1274 | `		pEntry = SyHashGet(&pClass->hMethod,SyStringData(&pClass->sName),SyStringLength(&pClass->sName));` |
|    59487 | 1275 | `		if( pEntry ){` |
...
|   390549 | 1282 | `	SyHashResetLoopCursor(&pClass->hMethod);` |
|  5880941 | 1283 | `	while((pEntry = SyHashGetNextEntry(&pClass->hMethod)) != 0 ){` |
|  5295125 | 1284 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|  5295125 | 1285 | `		if( (pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT) == 0 ){` |
|  5284867 | 1286 | `			rc = PH7_VmInstallUserFunction(&(*pVm),&pMeth->sFunc,&pMeth->sVmName);` |
|  5284867 | 1287 | `			if( rc != SXRET_OK ){` |
|      ! 0 | 1288 | `				return rc;` |
|        - | 1289 | `			}` |
|  2642431 | 1290 | `		}` |
|        5 | 1291 | `	}` |
|        - | 1292 | `	/* Mark class as mounted to avoid redundant mounting */` |
|   390549 | 1293 | `	pClass->bMounted = TRUE;` |
|   390549 | 1294 | `	return SXRET_OK;` |
|   351337 | 1295 | `}` |
|        - | 1296 | `/*` |
|        - | 1297 | ` * Allocate a private frame for attributes of the given` |
|        - | 1298 | ` * class instance (Object in the PHP jargon).` |
|        - | 1299 | ` */` |
|     8702 | 1300 | `PH7_PRIVATE sxi32 PH7_VmCreateClassInstanceFrame(` |
|        - | 1301 | `	ph7_vm *pVm, /* Target VM */` |
|        - | 1302 | `	ph7_class_instance *pObj /* Class instance */` |
|        - | 1303 | `	)` |
|        5 | 1304 | `{` |
|     8707 | 1305 | `	ph7_class *pClass = pObj->pClass;` |
...
|     8707 | 1310 | `	SyHashResetLoopCursor(&pClass->hAttr);` |
|    45761 | 1311 | `	while( (pEntry = SyHashGetNextEntry(&pClass->hAttr)) != 0 ){` |
|        - | 1312 | `		VmClassAttr *pVmAttr;` |
|        - | 1313 | `		/* Extract the current attribute */` |
|    37059 | 1314 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|    37059 | 1315 | `		pVmAttr = (VmClassAttr *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmClassAttr));` |
|    37059 | 1316 | `		if( pVmAttr == 0 ){` |
|      ! 0 | 1317 | `			return SXERR_MEM;` |
|        - | 1318 | `		}` |
|    37059 | 1319 | `		pVmAttr->pAttr = pAttr;` |
|    37059 | 1320 | `		if( (pAttr->iFlags & (PH7_CLASS_ATTR_CONSTANT\|PH7_CLASS_ATTR_STATIC)) == 0 ){` |
|        - | 1321 | `			ph7_value *pMemObj;` |
|        - | 1322 | `			/* Reserve a memory object for this attribute */` |
|    29001 | 1323 | `			pMemObj = PH7_ReserveMemObj(&(*pVm));` |
|    29001 | 1324 | `			if( pMemObj == 0 ){` |
|      ! 0 | 1325 | `				SyMemBackendPoolFree(&pVm->sAllocator,pVmAttr);` |
|      ! 0 | 1326 | `				return SXERR_MEM;` |
|        - | 1327 | `			}` |
|    29001 | 1328 | `			pVmAttr->nIdx = pMemObj->nIdx;` |
|    29001 | 1329 | `			pVmAttr->iState = 0;` |
|    29001 | 1330 | `			pVmAttr->pOwner = pClass;` |
|    29001 | 1331 | `			if( SySetUsed(&pAttr->aByteCode) > 0 ){` |
...
|    10623 | 1335 | `				ph7_class *pSaveCtx = pVm->pConstEvalClass;` |
|    10623 | 1336 | `				pVm->pConstEvalClass = pAttr->pDeclClass ? pAttr->pDeclClass : pClass;` |
|    10623 | 1337 | `				VmLocalExecIntoObj(&(*pVm),&pAttr->aByteCode,&pMemObj,FALSE);` |
|    10623 | 1338 | `				pVm->pConstEvalClass = pSaveCtx;` |
|    23692 | 1339 | `			}else if( pAttr->iFlags & PH7_CLASS_ATTR_TYPED ){` |
...
|      199 | 1343 | `			}` |
|    29001 | 1344 | `			rc = SyHashInsertTail(&pObj->hAttr,SyStringData(&pAttr->sName),SyStringLength(&pAttr->sName),pVmAttr);` |
|    29001 | 1345 | `			if( rc != SXRET_OK ){` |
|        - | 1346 | `				VmSlot sSlot;` |
...
|    29001 | 1355 | `			PH7_VmRefObjInstall(&(*pVm),pMemObj->nIdx,0,0,VM_REF_IDX_KEEP);` |
...
|    29001 | 1359 | `			if( pAttr->iFlags & PH7_CLASS_ATTR_TYPED ){` |
...
|     8063 | 1373 | `			pVmAttr->nIdx = pAttr->nIdx;` |
|     8063 | 1374 | `			pVmAttr->iState = 0;` |
|     8063 | 1375 | `			pVmAttr->pOwner = pClass;` |
|     8063 | 1376 | `			rc = SyHashInsertTail(&pObj->hAttr,SyStringData(&pAttr->sName),SyStringLength(&pAttr->sName),pVmAttr);` |
|     8063 | 1377 | `			if( rc != SXRET_OK ){` |
|      ! 0 | 1378 | `				SyMemBackendPoolFree(&pVm->sAllocator,pVmAttr);` |
|      ! 0 | 1379 | `				return SXERR_MEM;` |
|        - | 1380 | `			}` |
|        - | 1381 | `		}` |
|        5 | 1382 | `	}` |
|     8707 | 1383 | `	return SXRET_OK;` |
|     4356 | 1384 | `}` |
|        - | 1385 | `/*` |
...
|        2 | 1391 | `{` |
|       64 | 1392 | `	return pVm->pStdClass != 0 && pClass == pVm->pStdClass;` |
|        2 | 1393 | `}` |
|        - | 1394 | `/*` |
...
|        - | 1430 | ` */` |
|      146 | 1431 | `PH7_PRIVATE ph7_value * PH7_VmCreateDynamicAttr(ph7_vm *pVm,ph7_class_instance *pThis,const char *zName,sxu32 nName,VmClassAttr **ppAttr)` |
|        4 | 1432 | `{` |
|        - | 1433 | `	ph7_class_attr *pAttr;` |
|      150 | 1434 | `	VmClassAttr *pVmAttr = 0;` |
|      150 | 1435 | `	ph7_value *pMemObj = 0;` |
|        - | 1436 | `	char *zCopy;` |
|        - | 1437 | `	/* One block: ph7_class_attr struct + inline NUL-terminated name. */` |
|      150 | 1438 | `	pAttr = (ph7_class_attr *)SyMemBackendAlloc(&pVm->sAllocator,sizeof(ph7_class_attr) + nName + 1);` |
|      150 | 1439 | `	if( pAttr == 0 ){` |
|      ! 0 | 1440 | `		return 0;` |
|        - | 1441 | `	}` |
|      150 | 1442 | `	SyZero(pAttr,sizeof(ph7_class_attr));` |
|      150 | 1443 | `	zCopy = (char *)&pAttr[1];` |
|      150 | 1444 | `	if( nName > 0 ){` |
|      150 | 1445 | `		SyMemcpy((const void *)zName,(void *)zCopy,nName);` |
|       73 | 1446 | `	}` |
|      150 | 1447 | `	zCopy[nName] = 0;` |
|      150 | 1448 | `	SyStringInitFromBuf(&pAttr->sName,zCopy,nName);` |
|      150 | 1449 | `	pAttr->iFlags = PH7_CLASS_ATTR_DYNAMIC;` |
|      150 | 1450 | `	pAttr->iProtection = PH7_CLASS_PROT_PUBLIC;` |
|      150 | 1451 | `	pAttr->pDeclClass = pThis->pClass;` |
|        - | 1452 | `	/* nType / aByteCode / aUnionAlts left zeroed by SyZero: untyped, no default` |
|        - | 1453 | `	 * value, never a union. */` |
|      150 | 1454 | `	pVmAttr = (VmClassAttr *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmClassAttr));` |
|      150 | 1455 | `	if( pVmAttr == 0 ){` |
|      ! 0 | 1456 | `		goto fail_attr;` |
|        - | 1457 | `	}` |
|      150 | 1458 | `	pMemObj = PH7_ReserveMemObj(&(*pVm));` |
|      150 | 1459 | `	if( pMemObj == 0 ){` |
|      ! 0 | 1460 | `		goto fail_vmattr;` |
|        - | 1461 | `	}` |
|      150 | 1462 | `	pVmAttr->pAttr = pAttr;` |
|      150 | 1463 | `	pVmAttr->nIdx = pMemObj->nIdx;` |
|      150 | 1464 | `	pVmAttr->iState = 0;` |
|      150 | 1465 | `	pVmAttr->pOwner = pThis->pClass;` |
|        - | 1466 | `	/* Tail-insert so iteration (json_encode/foreach/(array)/var_dump) follows` |
|        - | 1467 | `	 * property-creation order, matching PHP. */` |
|      150 | 1468 | `	if( SyHashInsertTail(&pThis->hAttr,SyStringData(&pAttr->sName),SyStringLength(&pAttr->sName),pVmAttr) != SXRET_OK ){` |
|      ! 0 | 1469 | `		goto fail_slot;` |
|        - | 1470 | `	}` |
|        - | 1471 | `	/* Install in the reference table so COW/refcount tracks the slot. */` |
|      150 | 1472 | `	PH7_VmRefObjInstall(&(*pVm),pMemObj->nIdx,0,0,VM_REF_IDX_KEEP);` |
|      150 | 1473 | `	if( ppAttr ){` |
|       76 | 1474 | `		*ppAttr = pVmAttr;` |
|       37 | 1475 | `	}` |
|      150 | 1476 | `	return pMemObj;` |
|      ! 0 | 1477 | `fail_slot:` |
|        - | 1478 | `	{` |
|        - | 1479 | `		VmSlot sSlot;` |
...
|        - | 1556 | ` */` |
|  8570138 | 1557 | `PH7_PRIVATE ph7_value * PH7_ReserveConstObj(ph7_vm *pVm,sxu32 *pIndex)` |
|        5 | 1558 | `{` |
|        - | 1559 | `	ph7_value *pObj;` |
|        - | 1560 | `	sxi32 rc;` |
|  8570143 | 1561 | `	if( pIndex ){` |
|        - | 1562 | `		/* Object index in the object table */` |
|  8558503 | 1563 | `		*pIndex = SySetUsed(&pVm->aLitObj);` |
|  4279249 | 1564 | `	}` |
|        - | 1565 | `	/* Reserve a slot for the new object */` |
|  8570143 | 1566 | `	rc = SySetPut(&pVm->aLitObj,(const void *)zDummy);` |
|  8570143 | 1567 | `	if( rc != SXRET_OK ){` |
...
|      ! 0 | 1571 | `		return 0;` |
|        - | 1572 | `	}` |
|  8570143 | 1573 | `	pObj = (ph7_value *)SySetPeek(&pVm->aLitObj);` |
|  8570143 | 1574 | `	return pObj;` |
|  4285074 | 1575 | `}` |
|        - | 1576 | `/*` |
|        - | 1577 | ` * Reserve a memory object.` |
|        - | 1578 | ` * Return a pointer to the raw ph7_value on success. NULL on failure.` |
|        - | 1579 | ` */` |
|  2237676 | 1580 | `PH7_PRIVATE ph7_value * VmReserveMemObj(ph7_vm *pVm,sxu32 *pIndex)` |
|        5 | 1581 | `{` |
|        - | 1582 | `	ph7_value *pObj;` |
|        - | 1583 | `	sxi32 rc;` |
|  2237681 | 1584 | `	if( pIndex ){` |
|        - | 1585 | `		/* Object index in the object table */` |
|  2237681 | 1586 | `		*pIndex = SySetUsed(&pVm->aMemObj);` |
|  1118838 | 1587 | `	}` |
|        - | 1588 | `	/* Reserve a slot for the new object */` |
|  2237681 | 1589 | `	rc = SySetPut(&pVm->aMemObj,(const void *)zDummy);` |
|  2237681 | 1590 | `	if( rc != SXRET_OK ){` |
...
|      ! 0 | 1594 | `		return 0;` |
|        - | 1595 | `	}` |
|  2237681 | 1596 | `	pObj = (ph7_value *)SySetPeek(&pVm->aMemObj);` |
|  2237681 | 1597 | `	return pObj;` |
|  1118843 | 1598 | `}` |
...
|        - | 1611 | ` */` |
|     3880 | 1612 | `PH7_PRIVATE sxi32 PH7_VmInit(` |
...
|     3885 | 1620 | `	SyZero(pVm,sizeof(ph7_vm));` |
|        - | 1621 | `	/* Initialize VM fields */` |
|     3885 | 1622 | `	pVm->pEngine = &(*pEngine);` |
|     3885 | 1623 | `	pVm->bGcEnabled = 1; /* php default: the cycle collector is enabled */` |
|     3885 | 1624 | `	SyMemBackendInitFromParent(&pVm->sAllocator,&pEngine->sAllocator);` |
|        - | 1625 | `	/* Instructions containers */` |
|     3885 | 1626 | `	SySetInit(&pVm->aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|     3885 | 1627 | `	SySetAlloc(&pVm->aByteCode,0xFF);` |
|     3885 | 1628 | `	pVm->pByteContainer = &pVm->aByteCode;` |
|        - | 1629 | `	/* Object containers */` |
|     3885 | 1630 | `	SySetInit(&pVm->aMemObj,&pVm->sAllocator,sizeof(ph7_value));` |
|     3885 | 1631 | `	SySetAlloc(&pVm->aMemObj,0xFF);` |
|        - | 1632 | `	/* Argument-unpacking key capture (see VmSpreadRun/VmSpreadKey in vm.c) */` |
|     3885 | 1633 | `	SySetInit(&pVm->aSpreadRun,&pVm->sAllocator,sizeof(VmSpreadRun));` |
|     3885 | 1634 | `	SySetInit(&pVm->aSpreadKey,&pVm->sAllocator,sizeof(VmSpreadKey));` |
|     3885 | 1635 | `	SyBlobInit(&pVm->sSpreadKeyBlob,&pVm->sAllocator);` |
|     3885 | 1636 | `	SySetInit(&pVm->aEffArgName,&pVm->sAllocator,sizeof(SyString));` |
|        - | 1637 | `	/* Virtual machine internal containers */` |
|     3885 | 1638 | `	SyBlobInit(&pVm->sConsumer,&pVm->sAllocator);` |
|     3885 | 1639 | `	SyBlobInit(&pVm->sWorker,&pVm->sAllocator);` |
|     3885 | 1640 | `	SyBlobInit(&pVm->sLastErrMsg,&pVm->sAllocator);` |
|     3885 | 1641 | `	SyBlobInit(&pVm->sLastErrFile,&pVm->sAllocator);` |
|     3885 | 1642 | `	SyBlobInit(&pVm->sArgv,&pVm->sAllocator);` |
|     3885 | 1643 | `	SySetInit(&pVm->aLitObj,&pVm->sAllocator,sizeof(ph7_value));` |
|     3885 | 1644 | `	SySetAlloc(&pVm->aLitObj,0xFF);` |
|     3885 | 1645 | `	SyHashInit(&pVm->hHostFunction,&pVm->sAllocator,0,0);` |
|     3885 | 1646 | `	SyHashInit(&pVm->hFunction,&pVm->sAllocator,0,0);` |
|     3885 | 1647 | `	SyBlobInit(&pVm->sNamespace,&pVm->sAllocator);` |
|     3885 | 1648 | `	SyHashInit(&pVm->hUseImports,&pVm->sAllocator,0,0);` |
|     3885 | 1649 | `	SyHashInit(&pVm->hUseConstImports,&pVm->sAllocator,0,0);` |
|     3885 | 1650 | `	SyHashInit(&pVm->hClass,&pVm->sAllocator,SyStrHash,SyStrnmicmp);` |
|     3885 | 1651 | `	SyHashInit(&pVm->hConstant,&pVm->sAllocator,0,0);` |
|     3885 | 1652 | `	SyHashInit(&pVm->hSuper,&pVm->sAllocator,0,0);` |
|     3885 | 1653 | `	SyHashInit(&pVm->hPDO,&pVm->sAllocator,0,0);` |
|     3885 | 1654 | `	SySetInit(&pVm->aFreeObj,&pVm->sAllocator,sizeof(VmSlot));` |
|     3885 | 1655 | `	SySetInit(&pVm->aSelf,&pVm->sAllocator,sizeof(ph7_class *));` |
|     3885 | 1656 | `	SySetInit(&pVm->aShutdown,&pVm->sAllocator,sizeof(VmShutdownCB));` |
|     3885 | 1657 | `	SySetInit(&pVm->aIniCli,&pVm->sAllocator,sizeof(VmIniEntry));` |
|     3885 | 1658 | `	SySetInit(&pVm->aAutoload,&pVm->sAllocator,sizeof(VmAutoloadCB));` |
|     3885 | 1659 | `	SyHashInit(&pVm->hAutoloadActive,&pVm->sAllocator,0,0);` |
|     3885 | 1660 | `	SyHashInit(&pVm->hWeakCell,&pVm->sAllocator,0,0);` |
|     3885 | 1661 | `	SyHashInit(&pVm->hTypedSlot,&pVm->sAllocator,0,0);` |
|     3885 | 1662 | `	SySetInit(&pVm->aException,&pVm->sAllocator,sizeof(ph7_exception *));` |
|     3885 | 1663 | `	SySetInit(&pVm->aMagicGuard,&pVm->sAllocator,sizeof(VmMagicGuard));` |
|     3885 | 1664 | `	pVm->pMagicSetThis = 0;` |
|     3885 | 1665 | `	SyBlobInit(&pVm->sMagicSetName,&pVm->sAllocator);` |
|     3885 | 1666 | `	pVm->pHookSetThis = 0;` |
|     3885 | 1667 | `	pVm->pHookSetAttr = 0;` |
|     3885 | 1668 | `	pVm->nHookSetIdx = SXU32_HIGH;` |
|     3885 | 1669 | `	SySetInit(&pVm->aHookRmw,&pVm->sAllocator,sizeof(VmHookRmw));` |
|     3885 | 1670 | `	pVm->pMagicCallThis = 0;` |
|     3885 | 1671 | `	pVm->pMagicCallClass = 0;` |
|     3885 | 1672 | `	SyBlobInit(&pVm->sMagicCallName,&pVm->sAllocator);` |
|     3885 | 1673 | `	pVm->pIdleCallFrames = 0;` |
|     3885 | 1674 | `	pVm->pIdleOperandStacks = 0;` |
|     3885 | 1675 | `	pVm->nIdleOperandStacks = 0;` |
|     3885 | 1676 | `	pVm->pIdleStackNodes = 0;` |
|     3885 | 1677 | `	SySetInit(&pVm->aFinallyAction,&pVm->sAllocator,sizeof(VmFinallyAction));` |
|     3885 | 1678 | `	pVm->bInlineTryCatch = 1; /* ROOT C: enable inline generator try/catch/finally */` |
|     3885 | 1679 | `	pVm->pPendingException = 0;` |
|     3885 | 1680 | `	pVm->pInflightException = 0;` |
|     3885 | 1681 | `	pVm->nInflightExcBase = 0;` |
|     3885 | 1682 | `	pVm->pResumeFrame = 0;` |
|     3885 | 1683 | `	pVm->iResumePc = 0;` |
|     3885 | 1684 | `	pVm->pResumeInstr = 0;` |
|     3885 | 1685 | `	pVm->iResumeStackDepth = 0;` |
|     3885 | 1686 | `	pVm->nBoundaryRc = 0;` |
|     3885 | 1687 | `	pVm->pConstEvalClass = 0;` |
|     3885 | 1688 | `	pVm->nConstEvalDepth = 0;` |
|     3885 | 1689 | `	pVm->pConstCycleAttr = 0;` |
|     3885 | 1690 | `	pVm->pConstCycleClass = 0;` |
|     3885 | 1691 | `	SySetReset(&pVm->aMagicGuard);` |
|     3885 | 1692 | `	if( pVm->pMagicSetThis ){` |
|      ! 0 | 1693 | `		PH7_ClassInstanceUnref(pVm->pMagicSetThis);` |
|      ! 0 | 1694 | `		pVm->pMagicSetThis = 0;` |
|      ! 0 | 1695 | `	}` |
|     3885 | 1696 | `	SyBlobRelease(&pVm->sMagicSetName);` |
|     3885 | 1697 | `	if( pVm->pHookSetThis ){` |
|      ! 0 | 1698 | `		PH7_ClassInstanceUnref(pVm->pHookSetThis);` |
|      ! 0 | 1699 | `		pVm->pHookSetThis = 0;` |
|      ! 0 | 1700 | `	}` |
|     3885 | 1701 | `	pVm->pHookSetAttr = 0;` |
|     3885 | 1702 | `	pVm->nHookSetIdx = SXU32_HIGH;` |
|     3885 | 1703 | `	if( pVm->pMagicCallThis ){` |
|      ! 0 | 1704 | `		PH7_ClassInstanceUnref(pVm->pMagicCallThis);` |
|      ! 0 | 1705 | `		pVm->pMagicCallThis = 0;` |
|      ! 0 | 1706 | `	}` |
|     3885 | 1707 | `	pVm->pMagicCallClass = 0;` |
|     3885 | 1708 | `	SyBlobRelease(&pVm->sMagicCallName);` |
|        - | 1709 | `	/* Configuration containers */` |
|     3885 | 1710 | `	SySetInit(&pVm->aFiles,&pVm->sAllocator,sizeof(SyString));` |
|     3885 | 1711 | `	SySetInit(&pVm->aPaths,&pVm->sAllocator,sizeof(SyString));` |
|     3885 | 1712 | `	SySetInit(&pVm->aIncluded,&pVm->sAllocator,sizeof(SyString));` |
|     3885 | 1713 | `	SySetInit(&pVm->aOB,&pVm->sAllocator,sizeof(VmObEntry));` |
|     3885 | 1714 | `	SySetInit(&pVm->aResponseHeaders,&pVm->sAllocator,sizeof(VmResponseHeader));` |
|     3885 | 1715 | `	pVm->iResponseStatus = 200;` |
|     3885 | 1716 | `	pVm->bHeadersSent = 0;` |
|     3885 | 1717 | `	SySetInit(&pVm->aIOstream,&pVm->sAllocator,sizeof(ph7_io_stream *));` |
|        - | 1718 | `	/* Error callbacks containers */` |
|     3885 | 1719 | `	PH7_MemObjInit(&(*pVm),&pVm->aExceptionCB[0]);` |
|     3885 | 1720 | `	PH7_MemObjInit(&(*pVm),&pVm->aExceptionCB[1]);` |
|     3885 | 1721 | `	PH7_MemObjInit(&(*pVm),&pVm->aErrCB[0]);` |
|     3885 | 1722 | `	PH7_MemObjInit(&(*pVm),&pVm->aErrCB[1]);` |
|     3885 | 1723 | `	PH7_MemObjInit(&(*pVm),&pVm->sAssertCallback);` |
...
|     3885 | 1731 | `	pVm->nMaxDepth = 0;         /* host: unbounded PHP call depth (memory-bound) */` |
|     3885 | 1732 | `	pVm->nMaxNativeDepth = 256; /* host: proven the safe ceiling under ASan (the` |
...
|     3885 | 1745 | `	pVm->iAssertFlags = PH7_ASSERT_ZEND_OFF;` |
|        - | 1746 | `	/* JSON return status */` |
|     3885 | 1747 | `	pVm->json_rc = JSON_ERROR_NONE;` |
|        - | 1748 | `	/* PRNG context */` |
|     3885 | 1749 | `	SyRandomnessInit(&pVm->sPrng,0,0);` |
|        - | 1750 | `	/* Install the null constant */` |
|     3885 | 1751 | `	pObj = PH7_ReserveConstObj(&(*pVm),0);` |
|     3885 | 1752 | `	if( pObj == 0 ){` |
|      ! 0 | 1753 | `		rc = SXERR_MEM;` |
|      ! 0 | 1754 | `		goto Err;` |
|        - | 1755 | `	}` |
|     3885 | 1756 | `	PH7_MemObjInit(pVm,pObj);` |
|        - | 1757 | `	/* Install the boolean TRUE constant */` |
|     3885 | 1758 | `	pObj = PH7_ReserveConstObj(&(*pVm),0);` |
|     3885 | 1759 | `	if( pObj == 0 ){` |
|      ! 0 | 1760 | `		rc = SXERR_MEM;` |
|      ! 0 | 1761 | `		goto Err;` |
|        - | 1762 | `	}` |
|     3885 | 1763 | `	PH7_MemObjInitFromBool(pVm,pObj,1);` |
|        - | 1764 | `	/* Install the boolean FALSE constant */` |
|     3885 | 1765 | `	pObj = PH7_ReserveConstObj(&(*pVm),0);` |
|     3885 | 1766 | `	if( pObj == 0 ){` |
|      ! 0 | 1767 | `		rc = SXERR_MEM;` |
|      ! 0 | 1768 | `		goto Err;` |
|        - | 1769 | `	}` |
|     3885 | 1770 | `	PH7_MemObjInitFromBool(pVm,pObj,0);` |
...
|     3885 | 1774 | `	pObj = PH7_ReserveConstObj(&(*pVm),&pVm->nEmptyStringIdx);` |
|     3885 | 1775 | `	if( pObj == 0 ){` |
|      ! 0 | 1776 | `		rc = SXERR_MEM;` |
|      ! 0 | 1777 | `		goto Err;` |
|        - | 1778 | `	}` |
|     3885 | 1779 | `	PH7_MemObjInitFromString(pVm,pObj,0);` |
|        - | 1780 | `	/* Create the global frame */` |
|     3885 | 1781 | `	rc = VmEnterFrame(&(*pVm),0,0,0);` |
|     3885 | 1782 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 1783 | `		goto Err;` |
|        - | 1784 | `	}` |
|        - | 1785 | `	/* Initialize the code generator */` |
|     3885 | 1786 | `	rc = PH7_InitCodeGenerator(pVm,pEngine->xConf.xErr,pEngine->xConf.pErrData);` |
|     3885 | 1787 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 1788 | `		goto Err;` |
|        - | 1789 | `	}` |
|        - | 1790 | `	/* VM correctly initialized,set the magic number */` |
|     3885 | 1791 | `	pVm->nMagic = PH7_VM_INIT;` |
...
|     3885 | 1800 | `	pVm->pFiberClass = PH7_VmExtractClass(pVm,"Fiber",5,0,0);` |
|        - | 1801 | `	/* Cache built-in interface pointers used on hot dispatch paths */` |
|     3885 | 1802 | `	pVm->pArrayAccessClass = PH7_VmExtractClass(pVm,"ArrayAccess",sizeof("ArrayAccess")-1,0,0);` |
|     3885 | 1803 | `	pVm->pCountableClass   = PH7_VmExtractClass(pVm,"Countable",sizeof("Countable")-1,0,0);` |
|     3885 | 1804 | `	pVm->pStringableClass  = PH7_VmExtractClass(pVm,"Stringable",sizeof("Stringable")-1,0,0);` |
|     3885 | 1805 | `	pVm->pJsonSerializableClass = PH7_VmExtractClass(pVm,"JsonSerializable",sizeof("JsonSerializable")-1,0,0);` |
|     3885 | 1806 | `	pVm->pTraversableClass = PH7_VmExtractClass(pVm,"Traversable",sizeof("Traversable")-1,0,0);` |
|        - | 1807 | `	/* Initialize null-coalesce-assign scratch slot */` |
|     3885 | 1808 | `	pVm->pCoalesceObj = 0;` |
|     3885 | 1809 | `	pVm->bCoalesceArmed = 0;` |
|     3885 | 1810 | `	PH7_MemObjInit(pVm,&pVm->sCoalesceKey);` |
|        - | 1811 | `	/* Register Fiber internal C functions */` |
|     3885 | 1812 | `	ph7_create_function(pVm,"__fiber_suspend",vm_builtin_Fiber_suspend,0);` |
|     3885 | 1813 | `	ph7_create_function(pVm,"__fiber_construct",vm_builtin_Fiber_construct,0);` |
|     3885 | 1814 | `	ph7_create_function(pVm,"__fiber_start",vm_builtin_Fiber_start,0);` |
|     3885 | 1815 | `	ph7_create_function(pVm,"__fiber_resume",vm_builtin_Fiber_resume,0);` |
|     3885 | 1816 | `	ph7_create_function(pVm,"__fiber_getReturn",vm_builtin_Fiber_getReturn,0);` |
|     3885 | 1817 | `	ph7_create_function(pVm,"__fiber_isStarted",vm_builtin_Fiber_isStarted,0);` |
|     3885 | 1818 | `	ph7_create_function(pVm,"__fiber_isRunning",vm_builtin_Fiber_isRunning,0);` |
|     3885 | 1819 | `	ph7_create_function(pVm,"__fiber_isSuspended",vm_builtin_Fiber_isSuspended,0);` |
|     3885 | 1820 | `	ph7_create_function(pVm,"__fiber_isTerminated",vm_builtin_Fiber_isTerminated,0);` |
|     3885 | 1821 | `	ph7_create_function(pVm,"__fiber_destruct",vm_builtin_Fiber_destruct,0);` |
|        - | 1822 | `	/* Cache the Closure class pointer (closures are instances of it) */` |
|     3885 | 1823 | `	pVm->pClosureClass = PH7_VmExtractClass(pVm,"Closure",7,0,0);` |
|     3885 | 1824 | `	pVm->pClosureThis = 0; /* transient bound-$this slot, consumed per call */` |
|     3885 | 1825 | `	pVm->pClosureScope = 0; /* transient bound-scope slot, consumed per call */` |
|        - | 1826 | `	/* Closure::bind/bindTo/call/fromCallable native delegates (Increment 2) */` |
|     3885 | 1827 | `	ph7_create_function(pVm,"__closure_bindTo",vm_builtin_Closure_bindTo,0);` |
|     3885 | 1828 | `	ph7_create_function(pVm,"__closure_fromCallable",vm_builtin_Closure_fromCallable,0);` |
|        - | 1829 | `	/* Cache the stdClass pointer ((object) cast target + dynamic-property owner) */` |
|     3885 | 1830 | `	pVm->pStdClass = PH7_VmExtractClass(pVm,"stdClass",sizeof("stdClass")-1,0,0);` |
|        - | 1831 | `	/* Cache the Generator class pointer and register generator functions */` |
|     3885 | 1832 | `	pVm->pGeneratorClass = PH7_VmExtractClass(pVm,"Generator",9,0,0);` |
|     3885 | 1833 | `	ph7_create_function(pVm,"__gen_rewind",vm_builtin_Generator_rewind,0);` |
|     3885 | 1834 | `	ph7_create_function(pVm,"__gen_valid",vm_builtin_Generator_valid,0);` |
|     3885 | 1835 | `	ph7_create_function(pVm,"__gen_current",vm_builtin_Generator_current,0);` |
|     3885 | 1836 | `	ph7_create_function(pVm,"__gen_key",vm_builtin_Generator_key,0);` |
|     3885 | 1837 | `	ph7_create_function(pVm,"__gen_next",vm_builtin_Generator_next,0);` |
|     3885 | 1838 | `	ph7_create_function(pVm,"__gen_send",vm_builtin_Generator_send,0);` |
|     3885 | 1839 | `	ph7_create_function(pVm,"__gen_throw",vm_builtin_Generator_throw,0);` |
|     3885 | 1840 | `	ph7_create_function(pVm,"__gen_getReturn",vm_builtin_Generator_getReturn,0);` |
|     3885 | 1841 | `	ph7_create_function(pVm,"__gen_destruct",vm_builtin_Generator_destruct,0);` |
...
|     3885 | 1845 | `	PH7_VmInstallReflection(&(*pVm));` |
|     3885 | 1846 | `	PH7_VmInstallDateTime(&(*pVm));` |
|     3885 | 1847 | `	PH7_VmInstallSpl(&(*pVm));` |
|     3885 | 1848 | `	PH7_VmInstallTokenizer(&(*pVm));` |
|     3885 | 1849 | `	PH7_VmInstallSession(&(*pVm));` |
|     3885 | 1850 | `	PH7_VmInstallIni(&(*pVm));` |
...
|     3885 | 1854 | `	PH7_VmInstallLibxml(&(*pVm));` |
|     3885 | 1855 | `	PH7_VmInstallDom(&(*pVm));` |
|     3885 | 1856 | `	PH7_VmInstallXmlWriter(&(*pVm));` |
|        - | 1857 | `#endif` |
|     3885 | 1858 | `	pVm->bCompilingBuiltin = 0;` |
|        - | 1859 | `	/* Reset the code generator */` |
|     3885 | 1860 | `	PH7_ResetCodeGenerator(&(*pVm),pEngine->xConf.xErr,pEngine->xConf.pErrData);` |
|     3885 | 1861 | `	return SXRET_OK;` |
|      ! 0 | 1862 | `Err:` |
...
|        - | 1891 | ` */` |
|    41434 | 1892 | `PH7_PRIVATE void VmTrackOutput(ph7_vm *pVm, sxu32 nLen)` |
|        5 | 1893 | `{` |
|    41439 | 1894 | `	ProcConsumer xCons = pVm->sVmConsumer.xConsumer;` |
|    41439 | 1895 | `	if( xCons != VmObConsumer ){` |
|    12619 | 1896 | `		pVm->nOutputLen += nLen;` |
|    12619 | 1897 | `		if( !pVm->bHeadersSent && xCons != PH7_VmBlobConsumer ){` |
|     1397 | 1898 | `			pVm->bHeadersSent = 1;` |
|      696 | 1899 | `		}` |
|     6307 | 1900 | `	}` |
|    41439 | 1901 | `}` |
|        - | 1902 | `/*` |
...
|        - | 1951 | ` */` |
|    51086 | 1952 | `static int VmInstrStackEffect(VmInstr *pI, sxu32 pc, int *pPush, int *pN, sxu32 aSucc[2], sxi32 aDelta[2])` |
|        5 | 1953 | `{` |
|    51091 | 1954 | `	int push = 0, n = 0;` |
|        - | 1955 | `	sxi32 d;` |
|    51091 | 1956 | `	switch( pI->iOp ){` |
...
|     8073 | 1959 | `	case PH7_OP_LOADC:` |
|        - | 1960 | `	case PH7_OP_DUP:` |
|    16151 | 1961 | `		push = 1; aSucc[0] = pc + 1; aDelta[0] = 1; n = 1; break;` |
|     5750 | 1962 | `	case PH7_OP_LOAD:` |
|    11505 | 1963 | `		if( pI->p3 ){ push = 1; d = 1; }else{ push = 0; d = 0; }` |
|    11505 | 1964 | `		aSucc[0] = pc + 1; aDelta[0] = d; n = 1; break;` |
...
|      815 | 1992 | `	case PH7_OP_STORE:` |
|     1635 | 1993 | `		d = ( pI->iP2 \|\| pI->p3 == 0 ) ? -1 : 0;` |
|     1635 | 1994 | `		aSucc[0] = pc + 1; aDelta[0] = d; n = 1; break;` |
|        - | 1995 | `	/* Explicit multi-slot pops (operand-encoded count). */` |
|     1258 | 1996 | `	case PH7_OP_POP:` |
|        - | 1997 | `	case PH7_OP_CONSUME:` |
|     2521 | 1998 | `		aSucc[0] = pc + 1; aDelta[0] = -(sxi32)pI->iP1; n = 1; break;` |
...
|     1906 | 2002 | `	case PH7_OP_CALL:` |
|     3817 | 2003 | `		aSucc[0] = pc + 1; aDelta[0] = -(sxi32)pI->iP1; n = 1; break;` |
|        - | 2004 | `	/* Jumps. */` |
|      147 | 2005 | `	case PH7_OP_JMP:` |
|      299 | 2006 | `		aSucc[0] = pI->iP2; aDelta[0] = 0; n = 1; break;` |
|      769 | 2007 | `	case PH7_OP_JZ: case PH7_OP_JNZ:` |
|     1543 | 2008 | `		d = ( pI->iP1 == 0 ) ? -1 : 0; /* pops the condition on BOTH edges unless P1 says peek */` |
|     1543 | 2009 | `		aSucc[0] = pc + 1; aDelta[0] = d; aSucc[1] = pI->iP2; aDelta[1] = d; n = 2; break;` |
|        - | 2010 | `	/* Terminal: ends the path (its optional result pop does not propagate). */` |
|     2959 | 2011 | `	case PH7_OP_DONE:` |
|     5923 | 2012 | `		n = 0; break;` |
|     3102 | 2013 | `	default:` |
|     6209 | 2014 | `		return 0; /* unmodeled opcode -> whole-body fallback */` |
|        - | 2015 | `	}` |
|    44887 | 2016 | `	*pPush = push; *pN = n;` |
|    44887 | 2017 | `	return 1;` |
|    25548 | 2018 | `}` |
|        - | 2019 | `/*` |
...
|        - | 2023 | ` */` |
|     8228 | 2024 | `PH7_PRIVATE sxu32 VmComputeMaxStack(ph7_vm *pVm, VmInstr *aInstr, sxu32 nInstr)` |
|        5 | 2025 | `{` |
|        - | 2026 | `	void *pScratch;` |
...
|     8233 | 2032 | `	if( nInstr == 0 \|\| nInstr > 8192 ){` |
...
|    44529 | 2037 | `	for( i = 0; i < nInstr; i++ ){` |
|    42505 | 2038 | `		if( !VmInstrStackEffect(&aInstr[i], i, &push, &n, succ, delta) ){` |
|     6209 | 2039 | `			return VM_STACK_UNMODELED;` |
|        - | 2040 | `		}` |
|    18153 | 2041 | `	}` |
...
|     2029 | 2045 | `	pScratch = SyMemBackendAlloc(&pVm->sAllocator, nInstr * (sizeof(sxi32) + sizeof(sxu32) + 1));` |
|     2029 | 2046 | `	if( pScratch == 0 ){` |
|      ! 0 | 2047 | `		return VM_STACK_UNMODELED;` |
|        - | 2048 | `	}` |
|     2029 | 2049 | `	aH  = (sxi32 *)pScratch;` |
|     2029 | 2050 | `	aQ  = (sxu32 *)(aH + nInstr);` |
|     2029 | 2051 | `	aIn = (unsigned char *)(aQ + nInstr);` |
|    12335 | 2052 | `	for( i = 0; i < nInstr; i++ ){ aH[i] = -1; aIn[i] = 0; }` |
|     2029 | 2053 | `	aH[0] = 0; aQ[0] = 0; aIn[0] = 1; nQ = 1; iMax = 0;` |
|     2029 | 2054 | `	nIter = 0; nCap = nInstr * 16 + 1024; /* convergence backstop (fallback if hit) */` |
|    10615 | 2055 | `	while( nQ > 0 ){` |
|     8591 | 2056 | `		sxu32 pc = aQ[--nQ];` |
|        - | 2057 | `		sxi32 h;` |
|     8591 | 2058 | `		aIn[pc] = 0;` |
|     8591 | 2059 | `		h = aH[pc];` |
|     8591 | 2060 | `		if( ++nIter > nCap ){ iMax = -1; break; }` |
|     8591 | 2061 | `		(void)VmInstrStackEffect(&aInstr[pc], pc, &push, &n, succ, delta);` |
|     8591 | 2062 | `		if( h + push > iMax ){ iMax = h + push; }` |
|     8591 | 2063 | `		if( iMax > (sxi32)nInstr ){ iMax = -1; break; } /* over the safe bound: not worth it */` |
|    15231 | 2064 | `		for( k = 0; k < n; k++ ){` |
|     6645 | 2065 | `			sxi32 hn = h + delta[k];` |
|     6645 | 2066 | `			sxu32 t = succ[k];` |
|     6645 | 2067 | `			if( t >= nInstr \|\| hn < 0 ){ iMax = -1; break; } /* bad jump / imbalance */` |
|     6645 | 2068 | `			if( hn > aH[t] ){` |
|     6567 | 2069 | `				aH[t] = hn;` |
|     6567 | 2070 | `				if( !aIn[t] ){ aIn[t] = 1; aQ[nQ++] = t; }` |
|     3281 | 2071 | `			}` |
|     3325 | 2072 | `		}` |
|     8591 | 2073 | `		if( iMax < 0 ){ break; }` |
|        5 | 2074 | `	}` |
|     2029 | 2075 | `	SyMemBackendFree(&pVm->sAllocator, pScratch);` |
|     2029 | 2076 | `	return ( iMax < 0 ) ? VM_STACK_UNMODELED : (sxu32)iMax;` |
|     4119 | 2077 | `}` |
|        - | 2078 | `/*` |
...
|        - | 2088 | ` */` |
|   242225 | 2089 | `PH7_PRIVATE ph7_value * VmNewOperandStack(` |
...
|        - | 2101 | `  */` |
|   242230 | 2102 | `	nInstr += VM_STACK_GUARD;` |
|   242230 | 2103 | `	pStack = (ph7_value *)SyMemBackendAlloc(&pVm->sAllocator,nInstr * sizeof(ph7_value));` |
|   242230 | 2104 | `	if( pStack == 0 ){` |
|      ! 0 | 2105 | `		return 0;` |
|        - | 2106 | `	}` |
|        - | 2107 | `	/* Initialize the operand stack */` |
| 23164743 | 2108 | `	while( nInstr > 0 ){` |
| 22922518 | 2109 | `		PH7_MemObjInit(&(*pVm),&pStack[nInstr - 1]);` |
| 22922518 | 2110 | `		--nInstr;` |
|        5 | 2111 | `	}` |
|        - | 2112 | `	/* Ready for bytecode execution */` |
|   242230 | 2113 | `	return pStack;` |
|   121220 | 2114 | `}` |
|        - | 2115 | `/*` |
...
|        - | 2153 | ` */` |
|   104728 | 2154 | `PH7_PRIVATE ph7_value * VmOperandStackAlloc(ph7_vm *pVm, sxu32 nSlots)` |
|        5 | 2155 | `{` |
|   104733 | 2156 | `	VmIdleStack *pIdle = (VmIdleStack *)pVm->pIdleOperandStacks;` |
|   104733 | 2157 | `	sxu32 nCap = nSlots + VM_STACK_GUARD;` |
|   104733 | 2158 | `	if( pIdle && pIdle->nCap == nCap ){` |
|    18552 | 2159 | `		ph7_value *pStack = pIdle->pStack;` |
|    18552 | 2160 | `		pVm->pIdleOperandStacks = pIdle->pNext;` |
|    18552 | 2161 | `		pVm->nIdleOperandStacks--;` |
...
|    18552 | 2164 | `		pIdle->pNext = (VmIdleStack *)pVm->pIdleStackNodes;` |
|    18552 | 2165 | `		pVm->pIdleStackNodes = pIdle;` |
|    18552 | 2166 | `		return pStack; /* slots already released -> reusable without re-init */` |
|        - | 2167 | `	}` |
|    86186 | 2168 | `	return VmNewOperandStack(&(*pVm),nSlots);` |
|    52472 | 2169 | `}` |
|        - | 2170 | `/*` |
...
|        - | 2174 | ` * live value.` |
|        - | 2175 | ` */` |
|   104318 | 2176 | `PH7_PRIVATE void VmOperandStackRecycle(ph7_vm *pVm, ph7_value *pStack, sxu32 nCap)` |
|        5 | 2177 | `{` |
|        - | 2178 | `	VmIdleStack *pIdle;` |
|        - | 2179 | `	sxu32 i;` |
|   104323 | 2180 | `	if( pStack == 0 ){` |
|      ! 0 | 2181 | `		return;` |
|        - | 2182 | `	}` |
|   104323 | 2183 | `	if( pVm->nIdleOperandStacks >= VM_STACK_POOL_MAX \|\| nCap > VM_STACK_POOL_MAXSLOTS ){` |
|    79954 | 2184 | `		SyMemBackendFree(&pVm->sAllocator,pStack);` |
|    79954 | 2185 | `		return;` |
|        - | 2186 | `	}` |
...
|    24374 | 2189 | `	pIdle = (VmIdleStack *)pVm->pIdleStackNodes;` |
|    24374 | 2190 | `	if( pIdle ){` |
|    18552 | 2191 | `		pVm->pIdleStackNodes = pIdle->pNext;` |
|     9279 | 2192 | `	}else{` |
|     5827 | 2193 | `		pIdle = (VmIdleStack *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmIdleStack));` |
|     5827 | 2194 | `		if( pIdle == 0 ){` |
|      ! 0 | 2195 | `			SyMemBackendFree(&pVm->sAllocator,pStack);` |
|      ! 0 | 2196 | `			return;` |
|        - | 2197 | `		}` |
|        - | 2198 | `	}` |
|  1681301 | 2199 | `	for( i = 0; i < nCap; i++ ){` |
|  1656932 | 2200 | `		PH7_MemObjRelease(&pStack[i]);` |
...
|  1656932 | 2206 | `		pStack[i].nIdx = SXU32_HIGH;` |
|   828662 | 2207 | `	}` |
|    24374 | 2208 | `	pIdle->pStack = pStack;` |
|    24374 | 2209 | `	pIdle->nCap = nCap;` |
|    24374 | 2210 | `	pIdle->pNext = (VmIdleStack *)pVm->pIdleOperandStacks;` |
|    24374 | 2211 | `	pVm->pIdleOperandStacks = pIdle;` |
|    24374 | 2212 | `	pVm->nIdleOperandStacks++;` |
|    52267 | 2213 | `}` |
...
|     3417 | 2237 | `	PH7_ResetCodeGenerator(pVm,pVm->pEngine->xConf.xErr,pVm->pEngine->xConf.pErrData);` |
|        - | 2238 | `	/* Emit the DONE instruction */` |
|     3417 | 2239 | `	rc = PH7_VmEmitInstr(&(*pVm),PH7_OP_DONE,0,0,0,0);` |
|     3417 | 2240 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 2241 | `		return SXERR_MEM;` |
|        - | 2242 | `	}` |
|        - | 2243 | `	/* Script return value */` |
|     3417 | 2244 | `	PH7_MemObjInit(&(*pVm),&pVm->sExec); /* Assume a NULL return value */` |
|        - | 2245 | `	/* Allocate a new operand stack */` |
|     3417 | 2246 | `	pVm->aOps = VmNewOperandStack(&(*pVm),SySetUsed(pVm->pByteContainer));` |
|     3417 | 2247 | `	if( pVm->aOps == 0 ){` |
|      ! 0 | 2248 | `		return SXERR_MEM;` |
|        - | 2249 | `	}` |
|        - | 2250 | `	/* Set the default VM output consumer callback and it's` |
|        - | 2251 | `	 * private data. */` |
|     3417 | 2252 | `	pVm->sVmConsumer.xConsumer = PH7_VmBlobConsumer;` |
|     3417 | 2253 | `	pVm->sVmConsumer.pUserData = &pVm->sConsumer;` |
|        - | 2254 | `	/* Allocate the reference table */` |
|     3417 | 2255 | `	pVm->nRefSize = 0x10; /* Must be a power of two for fast arithemtic */` |
|     3417 | 2256 | `	pVm->apRefObj = (VmRefObj **)SyMemBackendAlloc(&pVm->sAllocator,sizeof(VmRefObj *) * pVm->nRefSize);` |
|     3417 | 2257 | `	if( pVm->apRefObj == 0 ){` |
...
|     3417 | 2262 | `	SyZero(pVm->apRefObj,sizeof(VmRefObj *) * pVm->nRefSize);` |
|        - | 2263 | `	/* Register special functions first [i.e: print, json_encode(), func_get_args(), die, etc.] */` |
|     3417 | 2264 | `	rc = VmRegisterSpecialFunction(&(*pVm));` |
|     3417 | 2265 | `	if( rc != SXRET_OK ){` |
...
|     3417 | 2274 | `	pVm->nSuperBaseline = SySetUsed(&pVm->aMemObj);` |
|        - | 2275 | `	/* Create superglobals [i.e: $GLOBALS, $_GET, $_POST...] */` |
|     3417 | 2276 | `	rc = PH7_HashmapCreateSuper(&(*pVm));` |
|     3417 | 2277 | `	if( rc != SXRET_OK ){` |
...
|     3417 | 2308 | `	SyHashResetLoopCursor(&pVm->hClass);` |
|   460887 | 2309 | `	while((pEntry = SyHashGetNextEntry(&pVm->hClass)) != 0 ){` |
|   457477 | 2310 | `		rc = VmMountUserClass(&(*pVm),(ph7_class *)pEntry->pUserData);` |
|   457477 | 2311 | `		if( rc != SXRET_OK ){` |
|        3 | 2312 | `			return rc;` |
|        - | 2313 | `		}` |
|        5 | 2314 | `	}` |
|        - | 2315 | `	/* Random number betwwen 0 and 1023 used to generate unique ID */` |
|     3415 | 2316 | `	pVm->unique_id = PH7_VmRandomNum(&(*pVm)) & 1023;` |
|        - | 2317 | `	/* First object handle id handed out is 1 (matches PHP's first userland object #1) */` |
|     3415 | 2318 | `	pVm->nNextObjId = 1;` |
|        - | 2319 | `	/* VM is ready for bytecode execution */` |
|     3415 | 2320 | `	return SXRET_OK;` |
|     1711 | 2321 | `}` |
|        - | 2322 | `/*` |
...
|        - | 2678 | ` */` |
|     3410 | 2679 | `PH7_PRIVATE sxi32 PH7_VmRelease(ph7_vm *pVm)` |
|        5 | 2680 | `{` |
|        - | 2681 | `	/* Set the stale magic number */` |
|     3415 | 2682 | `	pVm->nMagic = PH7_VM_STALE;` |
...
|     3415 | 2686 | `	PH7_LibxmlVmRelease(pVm);` |
|        - | 2687 | `#endif` |
|        - | 2688 | `	/* Release the private memory subsystem */` |
|     3415 | 2689 | `	SyMemBackendRelease(&pVm->sAllocator);` |
|     3415 | 2690 | `	return SXRET_OK;` |
|        5 | 2691 | `}` |
|        - | 2692 | `/*` |
...
|        - | 2701 | ` */` |
|   934754 | 2702 | `PH7_PRIVATE sxi32 VmInitCallContext(` |
...
|        - | 2708 | `	)` |
|        5 | 2709 | `{` |
|   934759 | 2710 | `	pOut->pFunc = pFunc;` |
|   934759 | 2711 | `	pOut->pVm   = pVm;` |
|   934759 | 2712 | `	SySetInit(&pOut->sVar,&pVm->sAllocator,sizeof(ph7_value *));` |
|   934759 | 2713 | `	SySetInit(&pOut->sChunk,&pVm->sAllocator,sizeof(ph7_aux_data));` |
|        - | 2714 | `	/* Assume a null return value */` |
|   934759 | 2715 | `	MemObjSetType(pRet,MEMOBJ_NULL);` |
|   934759 | 2716 | `	pOut->pRet = pRet;` |
|   934759 | 2717 | `	pOut->iFlags = iFlags;` |
|   934759 | 2718 | `	pOut->pArgMap = 0; /* Set by the OP_CALL dispatcher for named-arg-aware builtins */` |
|   934759 | 2719 | `	return SXRET_OK;` |
|        5 | 2720 | `}` |
|        - | 2721 | `/*` |
|        - | 2722 | ` * Release a foreign function call context and cleanup the mess` |
|        - | 2723 | ` * left behind.` |
|        - | 2724 | ` */` |
|   934754 | 2725 | `PH7_PRIVATE void VmReleaseCallContext(ph7_context *pCtx)` |
|        5 | 2726 | `{` |
|        - | 2727 | `	sxu32 n;` |
|   934759 | 2728 | `	if( SySetUsed(&pCtx->sVar) > 0 ){` |
|    11703 | 2729 | `		ph7_value **apObj = (ph7_value **)SySetBasePtr(&pCtx->sVar);` |
|    68334 | 2730 | `		for( n = 0 ; n < SySetUsed(&pCtx->sVar) ; ++n ){` |
|    56636 | 2731 | `			if( apObj[n] == 0 ){` |
|        - | 2732 | `				/* Already released */` |
|      682 | 2733 | `				continue;` |
|        - | 2734 | `			}` |
|    55959 | 2735 | `			PH7_MemObjRelease(apObj[n]);` |
|    55959 | 2736 | `			SyMemBackendPoolFree(&pCtx->pVm->sAllocator,apObj[n]);` |
|    27982 | 2737 | `		}` |
|    11703 | 2738 | `		SySetRelease(&pCtx->sVar);` |
|     5849 | 2739 | `	}` |
|   934759 | 2740 | `	if( SySetUsed(&pCtx->sChunk) > 0 ){` |
...
|        - | 2786 | ` */` |
|  5681948 | 2787 | `PH7_PRIVATE void VmPopOperand(` |
|        - | 2788 | `	ph7_value **ppTos, /* Operand stack */` |
|        - | 2789 | `	sxi32 nPop         /* Total number of memory objects to pop */` |
|        - | 2790 | `	)` |
|        5 | 2791 | `{` |
|  5681953 | 2792 | `	ph7_value *pTos = *ppTos;` |
| 12092179 | 2793 | `	while( nPop > 0 ){` |
|  6410231 | 2794 | `		PH7_MemObjRelease(pTos);` |
|  6410231 | 2795 | `		pTos--;` |
|  6410231 | 2796 | `		nPop--;` |
|        5 | 2797 | `	}` |
|        - | 2798 | `	/* Top of the stack */` |
|  5681953 | 2799 | `	*ppTos = pTos;` |
|  5681953 | 2800 | `}` |
|        - | 2801 | `/*` |
|        - | 2802 | ` * Reserve a memory object.` |
|        - | 2803 | ` * Return a pointer to the raw ph7_value on success. NULL on failure.` |
|        - | 2804 | ` */` |
|  4369307 | 2805 | `PH7_PRIVATE ph7_value * PH7_ReserveMemObj(ph7_vm *pVm)` |
|        5 | 2806 | `{` |
|  4369312 | 2807 | `	ph7_value *pObj = 0;` |
|        - | 2808 | `	VmSlot *pSlot;` |
|        - | 2809 | `	sxu32 nIdx;` |
|        - | 2810 | `	/* Check for a free slot */` |
|  4369312 | 2811 | `	nIdx = SXU32_HIGH; /* cc warning */` |
|  4369312 | 2812 | `	pSlot = (VmSlot *)SySetPop(&pVm->aFreeObj);` |
|  4369312 | 2813 | `	if( pSlot ){` |
|  2131662 | 2814 | `		pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pSlot->nIdx);` |
|  2131662 | 2815 | `		nIdx = pSlot->nIdx;` |
|  1066446 | 2816 | `	}` |
|  4369312 | 2817 | `	if( pObj == 0 ){` |
|        - | 2818 | `		/* Reserve a new memory object */` |
|  2237655 | 2819 | `		pObj = VmReserveMemObj(&(*pVm),&nIdx);` |
|  2237655 | 2820 | `		if( pObj == 0 ){` |
|      ! 0 | 2821 | `			return 0;` |
|        - | 2822 | `		}` |
|  1118825 | 2823 | `	}` |
|        - | 2824 | `	/* Set a null default value */` |
|  4369312 | 2825 | `	PH7_MemObjInit(&(*pVm),pObj);` |
|  4369312 | 2826 | `	pObj->nIdx = nIdx;` |
|  4369312 | 2827 | `	return pObj;` |
|  2185276 | 2828 | `}` |
|        - | 2829 | `/*` |
|        - | 2830 | ` * Insert an entry by reference (not copy) in the given hashmap.` |
|        - | 2831 | ` */` |
|    46336 | 2832 | `PH7_PRIVATE sxi32 VmHashmapRefInsert(` |
...
|        - | 2839 | `	ph7_value sKey;` |
|        - | 2840 | `	sxi32 rc;` |
|    46341 | 2841 | `	PH7_MemObjInitFromString(pMap->pVm,&sKey,0);` |
|    46341 | 2842 | `	PH7_MemObjStringAppend(&sKey,zKey,nByte);` |
|        - | 2843 | `	/* Perform the insertion */` |
|    46341 | 2844 | `	rc = PH7_HashmapInsertByRef(&(*pMap),&sKey,nRefIdx);` |
|    46341 | 2845 | `	PH7_MemObjRelease(&sKey);` |
|    46341 | 2846 | `	return rc;` |
|        5 | 2847 | `}` |
|        - | 2848 | `/*` |
...
|        - | 2959 | ` */` |
|  5819056 | 2960 | `PH7_PRIVATE ph7_value * VmExtractMemObj(` |
...
|        - | 2965 | `	)` |
|        5 | 2966 | `{` |
|  5819061 | 2967 | `	int bNullify = FALSE;` |
...
|  5819061 | 2974 | `	pFrame = pVm->pFrame;` |
|  5819061 | 2975 | `	pFrame = VmSkipExceptionFrames(pFrame);` |
|        - | 2976 | `	/* Perform the lookup */` |
|  5819061 | 2977 | `	if( pName == 0 \|\| pName->nByte < 1 ){` |
...
|  5819061 | 2985 | `	pEntry = SyHashGet(&pVm->hSuper,(const void *)pName->zString,pName->nByte);` |
|  5819061 | 2986 | `	if( pEntry == 0 ){` |
|        - | 2987 | `		/* Query the top active frame */` |
|  5818657 | 2988 | `		pEntry = SyHashGet(&pFrame->hVar,(const void *)pName->zString,pName->nByte);` |
|  5818657 | 2989 | `		if( pEntry == 0 ){` |
|   500205 | 2990 | `			char *zName = (char *)pName->zString;` |
|        - | 2991 | `			VmSlot sLocal;` |
|   500205 | 2992 | `			if( !bCreate ){` |
...
|        - | 2998 | `			 */` |
|   499049 | 2999 | `			pObj = PH7_ReserveMemObj(&(*pVm));` |
|   499049 | 3000 | `			if( pObj == 0 ){` |
|      ! 0 | 3001 | `				return 0;` |
|        - | 3002 | `			}` |
|   499049 | 3003 | `			nIdx = pObj->nIdx;` |
|   499049 | 3004 | `			if( bDup ){` |
|        - | 3005 | `				/* Duplicate name */` |
|      524 | 3006 | `				zName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|      524 | 3007 | `				if( zName == 0 ){` |
|      ! 0 | 3008 | `					return 0;` |
|        - | 3009 | `				}` |
|      260 | 3010 | `			}` |
|        - | 3011 | `			/* Link to the top active VM frame */` |
|   499049 | 3012 | `			rc = SyHashInsert(&pFrame->hVar,zName,pName->nByte,SX_INT_TO_PTR(nIdx));` |
|   499049 | 3013 | `			if( rc != SXRET_OK ){` |
...
|      ! 0 | 3018 | `				return 0;` |
|        - | 3019 | `			}` |
|   499049 | 3020 | `			if( pFrame->pParent != 0 ){` |
|        - | 3021 | `				/* Local variable */` |
|   490473 | 3022 | `				sLocal.nIdx = nIdx;` |
|   490473 | 3023 | `				SySetPut(&pFrame->sLocal,(const void *)&sLocal);` |
|   245857 | 3024 | `			}else{` |
|        - | 3025 | `				/* Register in the $GLOBALS array */` |
|     8581 | 3026 | `				VmHashmapRefInsert(pVm->pGlobal,pName->zString,pName->nByte,nIdx);` |
|        - | 3027 | `			}` |
|        - | 3028 | `			/* Install in the reference table */` |
|   499049 | 3029 | `			PH7_VmRefObjInstall(&(*pVm),nIdx,SyHashLastEntry(&pFrame->hVar),0,0);` |
|        - | 3030 | `			/* Save object index */` |
|   499049 | 3031 | `			pObj->nIdx = nIdx;` |
|   250145 | 3032 | `		}else{` |
|        - | 3033 | `			/* Extract variable contents */` |
|  5318457 | 3034 | `			nIdx = (sxu32)SX_PTR_TO_INT(pEntry->pUserData);` |
|  5318457 | 3035 | `			pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|  5318457 | 3036 | `			if( bNullify && pObj ){` |
|      ! 0 | 3037 | `				PH7_MemObjRelease(pObj);` |
|      ! 0 | 3038 | `			}` |
|        - | 3039 | `		}` |
|  2911440 | 3040 | `	}else{` |
|        - | 3041 | `		/* Superglobal */` |
|      409 | 3042 | `		nIdx = (sxu32)SX_PTR_TO_INT(pEntry->pUserData);` |
|      409 | 3043 | `		pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|        - | 3044 | `	}` |
|  5817905 | 3045 | `	return pObj;` |
|  2912220 | 3046 | `}` |
|        - | 3047 | `/*` |
...
|        - | 3050 | ` */` |
|    31098 | 3051 | `PH7_PRIVATE ph7_value * PH7_VmExtractSuper(` |
...
|    31103 | 3061 | `	pEntry = SyHashGet(&pVm->hSuper,(const void *)zName,nByte);` |
|    31103 | 3062 | `	if( pEntry == 0 ){` |
|        - | 3063 | `		/* No such entry */` |
|      ! 0 | 3064 | `		return 0;` |
|        - | 3065 | `	}` |
|        - | 3066 | `	/* Extract the superglobal index in the global object pool */` |
|    31103 | 3067 | `	nIdx = SX_PTR_TO_INT(pEntry->pUserData);` |
|        - | 3068 | `	/* Extract the variable value  */` |
|    31103 | 3069 | `	pValue = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|    31103 | 3070 | `	return pValue;` |
|    15554 | 3071 | `}` |
|        - | 3072 | `/*` |
|        - | 3073 | ` * Perform a raw hashmap insertion.` |
|        - | 3074 | ` * Refer to the [PH7_VmConfigure()] implementation for additional information.` |
|        - | 3075 | ` */` |
|    24364 | 3076 | `PH7_PRIVATE sxi32 PH7_VmHashmapInsert(` |
...
|        - | 3085 | `	sxi32 rc;` |
|    24369 | 3086 | `	PH7_MemObjInitFromString(pMap->pVm,&sKey,0);` |
|    24369 | 3087 | `	PH7_MemObjInitFromString(pMap->pVm,&sValue,0);` |
|    24369 | 3088 | `	if( zKey ){` |
|    20953 | 3089 | `		if( nKeylen < 0 ){` |
|    20849 | 3090 | `			nKeylen = (int)SyStrlen(zKey);` |
|    10422 | 3091 | `		}` |
|    20953 | 3092 | `		PH7_MemObjStringAppend(&sKey,zKey,(sxu32)nKeylen);` |
|    10474 | 3093 | `	}` |
|    24369 | 3094 | `	if( zData ){` |
|    24369 | 3095 | `		if( nLen < 0 ){` |
|        - | 3096 | `			/* Compute length automatically */` |
|    13827 | 3097 | `			nLen = (int)SyStrlen(zData);` |
|     6911 | 3098 | `		}` |
|    24369 | 3099 | `		PH7_MemObjStringAppend(&sValue,zData,(sxu32)nLen);` |
|    12182 | 3100 | `	}` |
...
|    24369 | 3105 | `	rc = PH7_HashmapInsert(&(*pMap),zKey ? &sKey : 0,&sValue);` |
|    24369 | 3106 | `	PH7_MemObjRelease(&sKey);` |
|    24369 | 3107 | `	PH7_MemObjRelease(&sValue);` |
|    24369 | 3108 | `	return rc;` |
|        5 | 3109 | `}` |
|        - | 3110 | `/*` |
...
|        - | 3122 | ` */` |
|    89290 | 3123 | `PH7_PRIVATE sxi32 PH7_VmConfigure(` |
|        - | 3124 | `	ph7_vm *pVm, /* Target VM */` |
|        - | 3125 | `	sxi32 nOp,   /* Configuration verb */` |
|        - | 3126 | `	va_list ap   /* Subsequent option arguments */` |
|        - | 3127 | `	)` |
|        5 | 3128 | `{` |
|    89295 | 3129 | `	sxi32 rc = SXRET_OK;` |
|    89295 | 3130 | `	switch(nOp){` |
|     1692 | 3131 | `	case PH7_VM_CONFIG_OUTPUT: {` |
|     3389 | 3132 | `		ProcConsumer xConsumer = va_arg(ap,ProcConsumer);` |
|     3389 | 3133 | `		void *pUserData = va_arg(ap,void *);` |
...
|     3389 | 3142 | `		pVm->sVmConsumer.xConsumer = xConsumer;` |
|     3389 | 3143 | `		pVm->sVmConsumer.pUserData = pUserData;` |
|     3389 | 3144 | `		break;` |
|        - | 3145 | `							   }` |
|     1705 | 3146 | `	case PH7_VM_CONFIG_IMPORT_PATH: {` |
|        - | 3147 | `		/* Import path */` |
|        - | 3148 | `		  const char *zPath;` |
|        - | 3149 | `		  SyString sPath;` |
|     3415 | 3150 | `		  zPath = va_arg(ap,const char *);` |
...
|        - | 3155 | `		  }` |
|        - | 3156 | `#endif` |
|     3415 | 3157 | `		  SyStringInitFromBuf(&sPath,zPath,SyStrlen(zPath));` |
|        - | 3158 | `		  /* Remove trailing slashes and backslashes */` |
|        - | 3159 | `#ifdef __WINNT__` |
|        5 | 3160 | `		  SyStringTrimTrailingChar(&sPath,'\\');` |
|        - | 3161 | `#endif` |
|     6825 | 3162 | `		  SyStringTrimTrailingChar(&sPath,'/');` |
|        - | 3163 | `		  /* Remove leading and trailing white spaces */` |
|     3415 | 3164 | `		  SyStringFullTrim(&sPath);` |
|     3415 | 3165 | `		  if( sPath.nByte > 0 ){` |
|        - | 3166 | `			  /* Store the path in the corresponding conatiner */` |
|     3415 | 3167 | `			  rc = SySetPut(&pVm->aPaths,(const void *)&sPath);` |
|     1705 | 3168 | `		  }` |
|     3415 | 3169 | `		  break;` |
|        - | 3170 | `									 }` |
|     1708 | 3171 | `	case PH7_VM_CONFIG_ERR_REPORT:` |
|        - | 3172 | `		/* Run-Time Error report */` |
|     3421 | 3173 | `		pVm->bErrReport = 1;` |
|     3421 | 3174 | `		pVm->iErrMask = 30719; /* E_ALL (php 8: E_STRICT/2048 is no longer part of E_ALL) */` |
|     3421 | 3175 | `		break;` |
...
|        - | 3215 | `							   }` |
|        - | 3216 |  |
|    18792 | 3217 | `	case PH7_VM_CONFIG_CREATE_SUPER:` |
|        - | 3218 | `	case PH7_VM_CONFIG_CREATE_VAR: {` |
|        - | 3219 | `		/* Create a new superglobal/global variable */` |
|    37589 | 3220 | `		const char *zName = va_arg(ap,const char *);` |
|    37589 | 3221 | `		ph7_value *pValue = va_arg(ap,ph7_value *);` |
...
|        - | 3230 | `		}` |
|        - | 3231 | `#endif` |
|    37589 | 3232 | `		nByte = SyStrlen(zName);` |
|    37589 | 3233 | `		if( nOp == PH7_VM_CONFIG_CREATE_SUPER ){` |
|        - | 3234 | `			/* Check if the superglobal is already installed */` |
|    34205 | 3235 | `			pEntry = SyHashGet(&pVm->hSuper,(const void *)zName,nByte);` |
|    17105 | 3236 | `		}else{` |
|        - | 3237 | `			/* Query the top active VM frame */` |
|     3389 | 3238 | `			pEntry = SyHashGet(&pVm->pFrame->hVar,(const void *)zName,nByte);` |
|        - | 3239 | `		}` |
|    37589 | 3240 | `		if( pEntry ){` |
...
|    37589 | 3251 | `			pObj = PH7_ReserveMemObj(&(*pVm));` |
|    37589 | 3252 | `			if( pObj == 0 ){` |
|      ! 0 | 3253 | `				rc = SXERR_MEM;` |
|      ! 0 | 3254 | `				break;` |
|        - | 3255 | `			}` |
|    37589 | 3256 | `			nIdx = pObj->nIdx;` |
|        - | 3257 | `			/* Copy value */` |
|    37589 | 3258 | `			PH7_MemObjStore(pValue,pObj);` |
|    37589 | 3259 | `			if( nOp == PH7_VM_CONFIG_CREATE_SUPER ){` |
|        - | 3260 | `				/* Install the superglobal */` |
|    34205 | 3261 | `				rc = SyHashInsert(&pVm->hSuper,(const void *)zName,nByte,SX_INT_TO_PTR(nIdx));` |
|    17105 | 3262 | `			}else{` |
|        - | 3263 | `				/* Install in the current frame */` |
|     3389 | 3264 | `				rc = SyHashInsert(&pVm->pFrame->hVar,(const void *)zName,nByte,SX_INT_TO_PTR(nIdx));` |
|        - | 3265 | `			}` |
|    37589 | 3266 | `			if( rc == SXRET_OK ){` |
|        - | 3267 | `				SyHashEntry *pRef;` |
|    37589 | 3268 | `				if( nOp == PH7_VM_CONFIG_CREATE_SUPER ){` |
|    34205 | 3269 | `					pRef = SyHashLastEntry(&pVm->hSuper);` |
|    17105 | 3270 | `				}else{` |
|     3389 | 3271 | `					pRef = SyHashLastEntry(&pVm->pFrame->hVar);` |
|        - | 3272 | `				}` |
|        - | 3273 | `				/* Install in the reference table */` |
|    37589 | 3274 | `				PH7_VmRefObjInstall(&(*pVm),nIdx,pRef,0,0);` |
|    37589 | 3275 | `				if( nOp == PH7_VM_CONFIG_CREATE_SUPER \|\| pVm->pFrame->pParent == 0){` |
|        - | 3276 | `					/* Register in the $GLOBALS array */` |
|    37589 | 3277 | `					VmHashmapRefInsert(pVm->pGlobal,zName,nByte,nIdx);` |
|    18792 | 3278 | `				}` |
|    18792 | 3279 | `			}` |
|        - | 3280 | `		}` |
|    37589 | 3281 | `		break;` |
|        - | 3282 | `									}` |
|    10422 | 3283 | `	case PH7_VM_CONFIG_SERVER_ATTR:` |
...
|    20847 | 3315 | `			pValue = PH7_VmExtractSuper(&(*pVm),"_SERVER",sizeof("_SERVER")-1);` |
|        - | 3316 | `		}` |
|    20849 | 3317 | `		if( pValue == 0 \|\| (pValue->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
|        - | 3318 | `			/* No such entry */` |
|      ! 0 | 3319 | `			rc = SXERR_NOTFOUND;` |
|      ! 0 | 3320 | `			break;` |
|        - | 3321 | `		}` |
|        - | 3322 | `		/* Point to the hashmap */` |
|    20849 | 3323 | `		pMap = (ph7_hashmap *)pValue->x.pOther;` |
|        - | 3324 | `		/* Perform the insertion */` |
|    20849 | 3325 | `		rc = PH7_VmHashmapInsert(pMap,zKey,-1,zValue,nLen);` |
|    20849 | 3326 | `		break;` |
|        - | 3327 | `								   }` |
|     1709 | 3328 | `	case PH7_VM_CONFIG_ARGV_ENTRY:{` |
|        - | 3329 | `		/* Script arguments */` |
|     3423 | 3330 | `		const char *zValue = va_arg(ap,const char *);` |
|        - | 3331 | `		ph7_hashmap *pMap;` |
|        - | 3332 | `		ph7_value *pValue;` |
|        - | 3333 | `		sxu32 n;` |
|     3423 | 3334 | `		if( SX_EMPTY_STR(zValue) ){` |
|        2 | 3335 | `			rc = SXERR_EMPTY;` |
|        2 | 3336 | `			break;` |
|        - | 3337 | `		}` |
|        - | 3338 | `		/* Extract the $argv array */` |
|     3421 | 3339 | `		pValue = PH7_VmExtractSuper(&(*pVm),"argv",sizeof("argv")-1);` |
|     3421 | 3340 | `		if( pValue == 0 \|\| (pValue->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
|        - | 3341 | `			/* No such entry */` |
|      ! 0 | 3342 | `			rc = SXERR_NOTFOUND;` |
|      ! 0 | 3343 | `			break;` |
|        - | 3344 | `		}` |
|        - | 3345 | `		/* Point to the hashmap */` |
|     3421 | 3346 | `		pMap = (ph7_hashmap *)pValue->x.pOther;` |
|        - | 3347 | `		/* Perform the insertion */` |
|     3421 | 3348 | `		n = (sxu32)SyStrlen(zValue);` |
|     3421 | 3349 | `		rc = PH7_VmHashmapInsert(pMap,0,0,zValue,(int)n);` |
|     3421 | 3350 | `		if( rc == SXRET_OK ){` |
|     3421 | 3351 | `			if( pMap->nEntry > 1 ){` |
|        - | 3352 | `				/* Append space separator first */` |
|       37 | 3353 | `				SyBlobAppend(&pVm->sArgv,(const void *)" ",sizeof(char));` |
|       16 | 3354 | `			}` |
|     3421 | 3355 | `			SyBlobAppend(&pVm->sArgv,(const void *)zValue,n);` |
|     1708 | 3356 | `		}` |
|     3421 | 3357 | `		break;` |
|        - | 3358 | `								  }` |
|     1692 | 3359 | `	case PH7_VM_CONFIG_SERVER_ARGV: {` |
...
|     3389 | 3367 | `		pArgv   = PH7_VmExtractSuper(&(*pVm),"argv",sizeof("argv")-1);` |
|     3389 | 3368 | `		pServer = PH7_VmExtractSuper(&(*pVm),"_SERVER",sizeof("_SERVER")-1);` |
|     3384 | 3369 | `		if( pArgv == 0 \|\| (pArgv->iFlags & MEMOBJ_HASHMAP) == 0` |
|     3389 | 3370 | `		 \|\| pServer == 0 \|\| (pServer->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
|      ! 0 | 3371 | `			rc = SXERR_NOTFOUND;` |
|      ! 0 | 3372 | `			break;` |
|        - | 3373 | `		}` |
|     3389 | 3374 | `		pArgvMap   = (ph7_hashmap *)pArgv->x.pOther;` |
|     3389 | 3375 | `		pServerMap = (ph7_hashmap *)pServer->x.pOther;` |
|        - | 3376 | `		/* Deep-copy $argv so $_SERVER['argv'] is an independent array. */` |
|     3389 | 3377 | `		pDup = PH7_NewHashmap(&(*pVm),0,0);` |
|     3389 | 3378 | `		if( pDup == 0 ){` |
|      ! 0 | 3379 | `			rc = SXERR_MEM;` |
|      ! 0 | 3380 | `			break;` |
|        - | 3381 | `		}` |
|     3389 | 3382 | `		PH7_HashmapDup(pArgvMap,pDup);` |
|     3389 | 3383 | `		PH7_MemObjInitFromArray(&(*pVm),&sArgvVal,pDup);` |
|     3389 | 3384 | `		PH7_MemObjInitFromString(&(*pVm),&sKey,0);` |
|     3389 | 3385 | `		PH7_MemObjStringAppend(&sKey,"argv",sizeof("argv")-1);` |
|     3389 | 3386 | `		PH7_HashmapInsert(pServerMap,&sKey,&sArgvVal);` |
|     3389 | 3387 | `		PH7_MemObjRelease(&sArgvVal); /* drops the duplicated array */` |
|     3389 | 3388 | `		PH7_MemObjRelease(&sKey);` |
|        - | 3389 | `		/* $_SERVER['argc'] = count($argv). */` |
|     3389 | 3390 | `		PH7_MemObjInitFromInt(&(*pVm),&sCount,(sxi64)pArgvMap->nEntry);` |
|     3389 | 3391 | `		PH7_MemObjInitFromString(&(*pVm),&sKey,0);` |
|     3389 | 3392 | `		PH7_MemObjStringAppend(&sKey,"argc",sizeof("argc")-1);` |
|     3389 | 3393 | `		PH7_HashmapInsert(pServerMap,&sKey,&sCount);` |
|     3389 | 3394 | `		PH7_MemObjRelease(&sCount);` |
|     3389 | 3395 | `		PH7_MemObjRelease(&sKey);` |
|     3389 | 3396 | `		rc = SXRET_OK;` |
|     3389 | 3397 | `		break;` |
|        - | 3398 | `								  }` |
...
|      ! 0 | 3472 | `		break;` |
|        - | 3473 | `								   }` |
|     6825 | 3474 | `	case PH7_VM_CONFIG_IO_STREAM: {` |
|        - | 3475 | `		/* Register an IO stream device */` |
|    13655 | 3476 | `		const ph7_io_stream *pStream = va_arg(ap,const ph7_io_stream *);` |
|        - | 3477 | `		/* Make sure we are dealing with a valid IO stream */` |
|    13650 | 3478 | `		if( pStream == 0 \|\| pStream->zName == 0 \|\| pStream->zName[0] == 0 \|\|` |
|    13655 | 3479 | `			pStream->xOpen == 0 \|\| pStream->xRead == 0 ){` |
|        - | 3480 | `				/* Invalid stream */` |
|      ! 0 | 3481 | `				rc = SXERR_INVALID;` |
|      ! 0 | 3482 | `				break;` |
|        - | 3483 | `		}` |
|    13655 | 3484 | `		if( pVm->pDefStream == 0 && SyStrnicmp(pStream->zName,"file",sizeof("file")-1) == 0 ){` |
|        - | 3485 | `			/* Make the 'file://' stream the defaut stream device */` |
|     3417 | 3486 | `			pVm->pDefStream = pStream;` |
|     1706 | 3487 | `		}` |
|        - | 3488 | `		/* Insert in the appropriate container */` |
|    13655 | 3489 | `		rc = SySetPut(&pVm->aIOstream,(const void *)&pStream);` |
|    13655 | 3490 | `		break;` |
|        - | 3491 | `								  }` |
...
|        4 | 3726 | `{` |
|      306 | 3727 | `	if( (pVal->iFlags & MEMOBJ_OBJ) == 0 \|\| pVal->x.pOther == 0 \|\| pVm->pTraversableClass == 0 ){` |
|      294 | 3728 | `		return 0;` |
|        - | 3729 | `	}` |
...
|        - | 4060 | ` */` |
|  1044918 | 4061 | `PH7_PRIVATE VmCallArgMap *VmEffCallArgMap(ph7_vm *pVm, VmInstr *pInstr,` |
|        - | 4062 | `	ph7_value *pArg, sxu32 nActual, VmCallArgMap *pStorage)` |
|        5 | 4063 | `{` |
|  1044923 | 4064 | `	VmCallArgMap *pCompile = (VmCallArgMap *)pInstr->p3;` |
|  1044923 | 4065 | `	if( pInstr->iP2 == 0 ){` |
|  1044641 | 4066 | `		return pCompile; /* no spread: compile map already aligned, nothing captured */` |
|        - | 4067 | `	}` |
...
|        3 | 4162 | `{` |
|      711 | 4163 | `	switch( pNext->iOp ){` |
|       17 | 4164 | `		case PH7_OP_STORE:` |
|       37 | 4165 | `			return pNext->iP2 != 0;                          /* member store ($o->p = v) */` |
...
|        - | 4274 | ` */` |
|      382 | 4275 | `PH7_PRIVATE sxi32 PH7_VmHookGetAttrValue(ph7_class_instance *pThis,VmClassAttr *pVmAttr,ph7_value *pOut)` |
|        4 | 4276 | `{` |
|      386 | 4277 | `	ph7_vm *pVm = pThis->pVm;` |
|        - | 4278 | `	char zHName[384];` |
|        - | 4279 | `	sxu32 nHName;` |
|        - | 4280 | `	ph7_class_method *pGetHook;` |
|        - | 4281 | `	sxi32 rc;` |
|      382 | 4282 | `	if( (pVmAttr->pAttr->iFlags & PH7_CLASS_ATTR_HOOK_GET) == 0` |
|      260 | 4283 | `	 \|\| VmHookGuardHeld(pVm,(void *)pThis,&pVmAttr->pAttr->sName)` |
|      142 | 4284 | `	 \|\| pVm->nBoundaryRc != 0 ){` |
...
|      248 | 4289 | `		return SXERR_NOTFOUND;` |
|        - | 4290 | `	}` |
...
|        - | 4408 | ` */` |
|    23800 | 4409 | `PH7_PRIVATE void VmForeachStepUnlink(ph7_foreach_info *pInfo,ph7_foreach_step *pStep)` |
|        5 | 4410 | `{` |
|    23805 | 4411 | `	ph7_foreach_step **apStep = (ph7_foreach_step **)SySetBasePtr(&pInfo->aStep);` |
|    23805 | 4412 | `	sxu32 n = SySetUsed(&pInfo->aStep);` |
|        - | 4413 | `	sxu32 i;` |
|    25981 | 4414 | `	for( i = 0 ; i < n ; ++i ){` |
|    25981 | 4415 | `		if( apStep[i] == pStep ){` |
|    23813 | 4416 | `			for( ; i + 1 < n ; ++i ){` |
|        9 | 4417 | `				apStep[i] = apStep[i + 1];` |
|        5 | 4418 | `			}` |
|    23805 | 4419 | `			(void)SySetPop(&pInfo->aStep);` |
|    23805 | 4420 | `			return;` |
|        - | 4421 | `		}` |
|     1093 | 4422 | `	}` |
|    11905 | 4423 | `}` |
...
|        - | 4442 | ` */` |
|    23564 | 4443 | `PH7_PRIVATE void VmForeachHashmapStepRelease(ph7_vm *pVm,ph7_foreach_info *pInfo,ph7_foreach_step *pStep,int bPop)` |
|        5 | 4444 | `{` |
|    23569 | 4445 | `	ph7_hashmap *pMap = pStep->xIter.pMap;` |
|    23569 | 4446 | `	PH7_HashmapUnregisterForeachStep(pMap,pStep);` |
|    23569 | 4447 | `	if( bPop ){` |
...
|    23569 | 4450 | `		VmForeachStepUnlink(pInfo,pStep);` |
|    11782 | 4451 | `	}` |
|    23569 | 4452 | `	SyMemBackendPoolFree(&pVm->sAllocator,pStep);` |
|    23569 | 4453 | `	PH7_HashmapUnref(pMap);` |
|    23569 | 4454 | `}` |
...
|        - | 4460 | ` */` |
|   137712 | 4461 | `PH7_PRIVATE sxi32 VmLocalExec(ph7_vm *pVm,SySet *pByteCode,ph7_value *pResult,int bReturnPropagates)` |
|        5 | 4462 | `{` |
|        - | 4463 | `	ph7_value *pStack;` |
|        - | 4464 | `	sxu32 nCap;` |
|        - | 4465 | `	sxi32 rc;` |
|        - | 4466 | `	/* Allocate a new operand stack */` |
|   137717 | 4467 | `	pStack = VmNewOperandStack(&(*pVm),SySetUsed(pByteCode));` |
|   137717 | 4468 | `	if( pStack == 0 ){` |
|      ! 0 | 4469 | `		return SXERR_MEM;` |
|        - | 4470 | `	}` |
|   137717 | 4471 | `	nCap = SySetUsed(pByteCode) + VM_STACK_GUARD; /* what VmNewOperandStack handed out */` |
...
|   137717 | 4474 | `	rc = VmByteCodeExec(&(*pVm),(VmInstr *)SySetBasePtr(pByteCode),pStack,-1,&(*pResult),0,FALSE,0,0,bReturnPropagates,0,&pStack,&nCap,nCap);` |
|        - | 4475 | `	/* Free the operand stack */` |
|   137717 | 4476 | `	SyMemBackendFree(&pVm->sAllocator,pStack);` |
|        - | 4477 | `	/* Execution result */` |
|   137717 | 4478 | `	return rc;` |
|    68861 | 4479 | `}` |
|        - | 4480 | `/*` |
...
|        - | 4514 | ` */` |
|     3416 | 4515 | `static void VmFlushOutputBuffers(ph7_vm *pVm)` |
|        5 | 4516 | `{` |
|     3421 | 4517 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|        - | 4518 | `	sxu32 n,nUsed;` |
|     3421 | 4519 | `	nUsed = SySetUsed(&pVm->aOB);` |
|     3421 | 4520 | `	if( nUsed < 1 ){` |
|     3419 | 4521 | `		return;` |
|        - | 4522 | `	}` |
...
|        - | 4550 | ` */` |
|     3416 | 4551 | `static void VmInvokeShutdownCallbacks(ph7_vm *pVm)` |
|        5 | 4552 | `{` |
...
|     3421 | 4558 | `	nEntry = SySetUsed(&pVm->aShutdown);` |
|    37581 | 4559 | `	for( i = 0 ; i < (int)SX_ARRAYSIZE(apArg) ; i++ ){` |
|    34165 | 4560 | `		apArg[i] = 0;` |
|    17085 | 4561 | `	}` |
...
|        - | 4565 | `	 */` |
|     3421 | 4566 | `	pVm->bHaltRequested = 0;` |
|     3439 | 4567 | `	for( n = 0 ; n < nEntry ; ++n ){` |
...
|        9 | 4594 | `		}` |
|       14 | 4595 | `	}` |
|     3421 | 4596 | `	SySetReset(&pVm->aShutdown);` |
|     3421 | 4597 | `}` |
|        - | 4598 | `/*` |
...
|        - | 4613 | `	{` |
|     3421 | 4614 | `		sxu32 nOpsCap = SySetUsed(pVm->pByteContainer) + VM_STACK_GUARD;` |
|     3421 | 4615 | `		VmByteCodeExec(&(*pVm),(VmInstr *)SySetBasePtr(pVm->pByteContainer),pVm->aOps,-1,&pVm->sExec,0,FALSE,0,0,FALSE,0,&pVm->aOps,&nOpsCap,nOpsCap);` |
|        - | 4616 | `	}` |
|        - | 4617 | `	/* Invoke any shutdown callbacks */` |
|     3421 | 4618 | `	VmInvokeShutdownCallbacks(&(*pVm));` |
...
|     3421 | 4621 | `	VmFlushOutputBuffers(&(*pVm));` |
|        - | 4622 | `	/*` |
...
|        - | 4635 | ` */` |
|     2218 | 4636 | `PH7_PRIVATE sxi32 PH7_VmOutputConsume(` |
|        - | 4637 | `	ph7_vm *pVm,      /* Target VM */` |
|        - | 4638 | `	SyString *pString /* Message to output */` |
|        - | 4639 | `	)` |
|        5 | 4640 | `{` |
|     2223 | 4641 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|     2223 | 4642 | `	sxi32 rc = SXRET_OK;` |
|        - | 4643 | `	/* Call the output consumer */` |
|     2223 | 4644 | `	if( pString->nByte > 0 ){` |
|     2223 | 4645 | `		rc = pCons->xConsumer((const void *)pString->zString,pString->nByte,pCons->pUserData);` |
|     2223 | 4646 | `		VmTrackOutput(pVm, pString->nByte);` |
|     1109 | 4647 | `	}` |
|     2223 | 4648 | `	return rc;` |
|        5 | 4649 | `}` |
|        - | 4650 | `/*` |
...
|        - | 4979 | ` */` |
|     3412 | 4980 | `static sxi32 VmRegisterSpecialFunction(ph7_vm *pVm)` |
|        5 | 4981 | `{` |
|        - | 4982 | `	sxi32 rc;` |
|        - | 4983 | `	sxu32 n;` |
|   426505 | 4984 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVmFunc) ; ++n ){` |
|        - | 4985 | `		/* Note that these special functions have access` |
|        - | 4986 | `		 * to the underlying virtual machine as their` |
|        - | 4987 | `		 * private data.` |
|        - | 4988 | `		 */` |
|   423093 | 4989 | `		rc = ph7_create_function(&(*pVm),aVmFunc[n].zName,aVmFunc[n].xFunc,&(*pVm));` |
|   423093 | 4990 | `		if( rc != SXRET_OK ){` |
|      ! 0 | 4991 | `			return rc;` |
|        - | 4992 | `		}` |
|   211549 | 4993 | `	}` |
|     3417 | 4994 | `	return SXRET_OK;` |
|     1711 | 4995 | `}` |
|        - | 4996 | `/*` |
...
|        - | 5000 | ` */` |
|   768770 | 5001 | `static ph7_class * VmFilterLoadableClass(ph7_class *pClass,sxi32 iLoadable)` |
|        5 | 5002 | `{` |
|   768775 | 5003 | `	if( !iLoadable ){` |
|   762109 | 5004 | `		return pClass;` |
|        - | 5005 | `	}` |
|     6675 | 5006 | `	while(pClass){` |
|     6671 | 5007 | `		if( (pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_ABSTRACT\|PH7_CLASS_TRAIT)) == 0 ){` |
|     6667 | 5008 | `			return pClass;` |
|        - | 5009 | `		}` |
...
|   769021 | 5098 | `	pEntry = SyHashGet(&pVm->hClass,(const void *)zName,nByte);` |
|   769021 | 5099 | `	if( pEntry == 0 ){` |
...
|        - | 5102 | `	}` |
|   768759 | 5103 | `	pClass = (ph7_class *)pEntry->pUserData;` |
|   768759 | 5104 | `	return VmFilterLoadableClass(pClass,iLoadable);` |
|   384513 | 5105 | `}` |
|        - | 5106 | `/*` |
...
|        - | 5119 | ` */` |
|  4365857 | 5120 | `static VmRefObj * VmNewRefObj(ph7_vm *pVm,sxu32 nIdx)` |
|        5 | 5121 | `{` |
|        - | 5122 | `	VmRefObj *pRef;` |
|        - | 5123 | `	/* Allocate a new instance */` |
|  4365862 | 5124 | `	pRef = (VmRefObj *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmRefObj));` |
|  4365862 | 5125 | `	if( pRef == 0 ){` |
|      ! 0 | 5126 | `		return 0;` |
|        - | 5127 | `	}` |
|        - | 5128 | `	/* Zero the structure */` |
|  4365862 | 5129 | `	SyZero(pRef,sizeof(VmRefObj));` |
|        - | 5130 | `	/* Initialize fields */` |
|  4365862 | 5131 | `	SySetInit(&pRef->aReference,&pVm->sAllocator,sizeof(SyHashEntry *));` |
|  4365862 | 5132 | `	SySetInit(&pRef->aArrEntries,&pVm->sAllocator,sizeof(ph7_hashmap_node *));` |
|  4365862 | 5133 | `	pRef->nIdx = nIdx;` |
|  4365862 | 5134 | `	return pRef;` |
|  2183551 | 5135 | `}` |
|        - | 5136 | `/*` |
|        - | 5137 | ` * Default hash function used by the reference table` |
|        - | 5138 | ` * for lookup/insertion operations.` |
|        - | 5139 | ` */` |
| 23454983 | 5140 | `static sxu32 VmRefHash(sxu32 nIdx)` |
|        5 | 5141 | `{` |
|        - | 5142 | `	/* Calculate the hash based on the memory object index */` |
| 23454988 | 5143 | `	return nIdx ^ (nIdx << 8) ^ (nIdx >> 8);` |
|        5 | 5144 | `}` |
|        - | 5145 | `/*` |
...
|        - | 5155 | ` * extension.` |
|        - | 5156 | ` */` |
| 13563467 | 5157 | `PH7_PRIVATE VmRefObj * VmRefObjExtract(ph7_vm *pVm,sxu32 nObjIdx)` |
|        5 | 5158 | `{` |
|        - | 5159 | `	VmRefObj *pRef;` |
|        - | 5160 | `	sxu32 nBucket;` |
|        - | 5161 | `	/* Point to the appropriate bucket */` |
| 13563472 | 5162 | `	nBucket = VmRefHash(nObjIdx) & (pVm->nRefSize - 1);` |
|        - | 5163 | `	/* Perform the lookup */` |
| 13563472 | 5164 | `	pRef = pVm->apRefObj[nBucket];` |
| 29870751 | 5165 | `	for(;;){` |
| 59738012 | 5166 | `		if( pRef == 0 ){` |
|  4856204 | 5167 | `			break;` |
|        - | 5168 | `		}` |
| 54881813 | 5169 | `		if( pRef->nIdx == nObjIdx ){` |
|        - | 5170 | `			/* Entry found */` |
|  8707273 | 5171 | `			return pRef;` |
|        - | 5172 | `		}` |
|        - | 5173 | `		/* Point to the next entry */` |
| 46174545 | 5174 | `		pRef = pRef->pNextCollide;` |
|        5 | 5175 | `	}` |
|        - | 5176 | `	/* No such entry,return NULL */` |
|  4856204 | 5177 | `	return 0;` |
|  6783591 | 5178 | `}` |
|        - | 5179 | `/*` |
...
|        - | 5187 | ` * extension.` |
|        - | 5188 | ` */` |
|  4365857 | 5189 | `static sxi32 VmRefObjInsert(ph7_vm *pVm,VmRefObj *pRef)` |
|        5 | 5190 | `{` |
|        - | 5191 | `	sxu32 nBucket;` |
|  4365862 | 5192 | `	if( pVm->nRefUsed * 3 >= pVm->nRefSize ){` |
|        - | 5193 | `		VmRefObj **apNew;` |
|        - | 5194 | `		sxu32 nNew;` |
|        - | 5195 | `		/* Allocate a larger table */` |
|    10567 | 5196 | `		nNew = pVm->nRefSize << 1;` |
|    10567 | 5197 | `		apNew = (VmRefObj **)SyMemBackendAlloc(&pVm->sAllocator,sizeof(VmRefObj *) * nNew);` |
|    10567 | 5198 | `		if( apNew ){` |
|    10567 | 5199 | `			VmRefObj *pEntry = pVm->pRefList;` |
|        - | 5200 | `			sxu32 n;` |
|        - | 5201 | `			/* Zero the structure */` |
|    10567 | 5202 | `			SyZero((void *)apNew,nNew * sizeof(VmRefObj *));` |
|        - | 5203 | `			/* Rehash all referenced entries */` |
|  2966821 | 5204 | `			for( n = 0 ; n < pVm->nRefUsed ; ++n ){` |
|        - | 5205 | `				/* Remove old collision links */` |
|  2956259 | 5206 | `				pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|        - | 5207 | `				/* Point to the appropriate bucket */` |
|  2956259 | 5208 | `				nBucket = VmRefHash(pEntry->nIdx) & (nNew - 1);` |
|        - | 5209 | `				/* Insert the entry  */` |
|  2956259 | 5210 | `				pEntry->pNextCollide = apNew[nBucket];` |
|  2956259 | 5211 | `				if( apNew[nBucket] ){` |
|  2306069 | 5212 | `					apNew[nBucket]->pPrevCollide = pEntry;` |
|  1153032 | 5213 | `				}` |
|  2956259 | 5214 | `				apNew[nBucket] = pEntry;` |
|        - | 5215 | `				/* Point to the next entry */` |
|  2956259 | 5216 | `				pEntry = pEntry->pNext;` |
|  1478132 | 5217 | `			}` |
|        - | 5218 | `			/* Release the old table */` |
|    10567 | 5219 | `			SyMemBackendFree(&pVm->sAllocator,pVm->apRefObj);` |
|        - | 5220 | `			/* Install the new one */` |
|    10567 | 5221 | `			pVm->apRefObj = apNew;` |
|    10567 | 5222 | `			pVm->nRefSize = nNew;` |
|     5281 | 5223 | `		}` |
|     5281 | 5224 | `	}` |
|        - | 5225 | `	/* Point to the appropriate bucket */` |
|  4365862 | 5226 | `	nBucket = VmRefHash(pRef->nIdx) & (pVm->nRefSize - 1);` |
|        - | 5227 | `	/* Insert the entry */` |
|  4365862 | 5228 | `	pRef->pNextCollide = pVm->apRefObj[nBucket];` |
|  4365862 | 5229 | `	if( pVm->apRefObj[nBucket] ){` |
|  3361329 | 5230 | `		pVm->apRefObj[nBucket]->pPrevCollide = pRef;` |
|  1681204 | 5231 | `	}` |
|  4365862 | 5232 | `	pVm->apRefObj[nBucket] = pRef;` |
|  4365862 | 5233 | `	MACRO_LD_PUSH(pVm->pRefList,pRef);` |
|  4365862 | 5234 | `	pVm->nRefUsed++;` |
|  4365862 | 5235 | `	return SXRET_OK;` |
|        5 | 5236 | `}` |
|        - | 5237 | `/*` |
...
|        - | 5247 | ` * extension.` |
|        - | 5248 | ` */` |
|  4232109 | 5249 | `PH7_PRIVATE sxi32 VmRefObjUnlink(ph7_vm *pVm,VmRefObj *pRef)` |
|        5 | 5250 | `{` |
|        - | 5251 | `	ph7_hashmap_node **apNode;` |
|        - | 5252 | `	SyHashEntry **apEntry;` |
|        - | 5253 | `	sxu32 n;` |
|        - | 5254 | `	/* Point to the reference table */` |
|  4232114 | 5255 | `	apNode = (ph7_hashmap_node **)SySetBasePtr(&pRef->aArrEntries);` |
|  4232114 | 5256 | `	apEntry = (SyHashEntry **)SySetBasePtr(&pRef->aReference);` |
|        - | 5257 | `	/* Unlink the entry from the reference table */` |
|  4728560 | 5258 | `	for( n = 0 ; n < SySetUsed(&pRef->aReference) ; n++ ){` |
|   496451 | 5259 | `		if( apEntry[n] ){` |
|   490571 | 5260 | `			SyHashDeleteEntry2(apEntry[n]);` |
|   245901 | 5261 | `		}` |
|   248846 | 5262 | `	}` |
|  7952295 | 5263 | `	for(n = 0 ; n < SySetUsed(&pRef->aArrEntries) ; ++n ){` |
|  3720186 | 5264 | `		if( apNode[n] ){` |
|     1380 | 5265 | `			PH7_HashmapUnlinkNode(apNode[n],FALSE);` |
|      688 | 5266 | `		}` |
|  1860095 | 5267 | `	}` |
|  4232114 | 5268 | `	if( pRef->pPrevCollide ){` |
|  1662709 | 5269 | `		pRef->pPrevCollide->pNextCollide = pRef->pNextCollide;` |
|   830825 | 5270 | `	}else{` |
|  2569410 | 5271 | `		pVm->apRefObj[VmRefHash(pRef->nIdx) & (pVm->nRefSize - 1)] = pRef->pNextCollide;` |
|        - | 5272 | `	}` |
|  4232114 | 5273 | `	if( pRef->pNextCollide ){` |
|  2248919 | 5274 | `		pRef->pNextCollide->pPrevCollide = pRef->pPrevCollide;` |
|  1125010 | 5275 | `	}` |
|  4232114 | 5276 | `	MACRO_LD_REMOVE(pVm->pRefList,pRef);` |
|        - | 5277 | `	/* Release the node */` |
|  4232114 | 5278 | `	SySetRelease(&pRef->aReference);` |
|  4232114 | 5279 | `	SySetRelease(&pRef->aArrEntries);` |
|  4232114 | 5280 | `	SyMemBackendPoolFree(&pVm->sAllocator,pRef);` |
|  4232114 | 5281 | `	pVm->nRefUsed--;` |
|  4232114 | 5282 | `	return SXRET_OK;` |
|        5 | 5283 | `}` |
|        - | 5284 | `/*` |
...
|        - | 5291 | ` * extension.` |
|        - | 5292 | ` */` |
|  4412447 | 5293 | `PH7_PRIVATE sxi32 PH7_VmRefObjInstall(` |
...
|        - | 5299 | `	)` |
|        5 | 5300 | `{` |
|  4412452 | 5301 | `	VmFrame *pFrame = pVm->pFrame;` |
|        - | 5302 | `	VmRefObj *pRef;` |
|        - | 5303 | `	/* Check if the referenced object already exists */` |
|  4412452 | 5304 | `	pRef = VmRefObjExtract(&(*pVm),nIdx);` |
|  4412452 | 5305 | `	if( pRef == 0 ){` |
|        - | 5306 | `		/* Create a new entry */` |
|  4365862 | 5307 | `		pRef = VmNewRefObj(&(*pVm),nIdx);` |
|  4365862 | 5308 | `		if( pRef == 0 ){` |
|      ! 0 | 5309 | `			return SXERR_MEM;` |
|        - | 5310 | `		}` |
|  4365862 | 5311 | `		pRef->iFlags = iFlags;` |
|        - | 5312 | `		/* Install the entry */` |
|  4365862 | 5313 | `		VmRefObjInsert(&(*pVm),pRef);` |
|  2183546 | 5314 | `	}` |
|  4412452 | 5315 | `	pFrame = VmSkipExceptionFrames(pFrame);` |
|  4412452 | 5316 | `	if( pFrame->pParent != 0 && pEntry ){` |
|        - | 5317 | `		VmSlot sRef;` |
|        - | 5318 | `		/* Local frame,record referenced entry so that it can` |
|        - | 5319 | `		 * be deleted when we leave this frame.` |
|        - | 5320 | `		 */` |
|   490545 | 5321 | `		sRef.nIdx = nIdx;` |
|   490545 | 5322 | `		sRef.pUserData = pEntry;` |
|   490545 | 5323 | `		if( SXRET_OK != SySetPut(&pFrame->sRef,(const void *)&sRef)) {` |
|      ! 0 | 5324 | `			pEntry = 0; /* Do not record this entry */` |
|      ! 0 | 5325 | `		}` |
|   245888 | 5326 | `	}` |
|  4412452 | 5327 | `	if( pEntry ){` |
|        - | 5328 | `		/* Address of the hash-entry */` |
|   536877 | 5329 | `		SySetPut(&pRef->aReference,(const void *)&pEntry);` |
|   269054 | 5330 | `	}` |
|  4412452 | 5331 | `	if( pMapEntry ){` |
|        - | 5332 | `		/* Address of the hashmap node [i.e: Array entry] */` |
|  3822164 | 5333 | `		SySetPut(&pRef->aArrEntries,(const void *)&pMapEntry);` |
|  1911079 | 5334 | `	}` |
|  4412452 | 5335 | `	return SXRET_OK;` |
|  2206846 | 5336 | `}` |
|        - | 5337 | `/*` |
...
|        - | 5344 | ` * extension.` |
|        - | 5345 | ` */` |
|  4203435 | 5346 | `PH7_PRIVATE sxi32 PH7_VmRefObjRemove(` |
...
|  4203440 | 5356 | `	pRef = VmRefObjExtract(&(*pVm),nIdx);` |
|  4203440 | 5357 | `	if( pRef == 0 ){` |
|        - | 5358 | `		/* Not such entry */` |
|   490347 | 5359 | `		return SXERR_NOTFOUND;` |
|        - | 5360 | `	}` |
|        - | 5361 | `	/* Remove the desired entry */` |
|  3713098 | 5362 | `	if( pEntry ){` |
...
|       95 | 5375 | `		}` |
|       41 | 5376 | `	}` |
|  3713098 | 5377 | `	if( pMapEntry ){` |
|        - | 5378 | `		ph7_hashmap_node **apNode;` |
|  3713016 | 5379 | `		apNode = (ph7_hashmap_node **)SySetBasePtr(&pRef->aArrEntries);` |
|  7426291 | 5380 | `		for(n = 0 ; n < SySetUsed(&pRef->aArrEntries) ; n++ ){` |
|  3713280 | 5381 | `			if( apNode[n] == pMapEntry ){` |
|        - | 5382 | `				/* nullify the entry */` |
|  3713016 | 5383 | `				apNode[n] = 0;` |
|  1856505 | 5384 | `			}` |
|  1856642 | 5385 | `		}` |
|  1856505 | 5386 | `	}` |
|  3713098 | 5387 | `	return SXRET_OK;` |
|  2102340 | 5388 | `}` |
...
|        - | 5397 | ` */` |
|    30178 | 5398 | `PH7_PRIVATE const ph7_io_stream * PH7_VmGetStreamDevice(` |
...
|    30183 | 5410 | `	zNext = zCur = zIn = *pzDevice;` |
|    30183 | 5411 | `	zEnd = &zIn[nByte];` |
|  1913530 | 5412 | `	while( zIn < zEnd ){` |
|  1883382 | 5413 | `		if( zIn < &zEnd[-3]/*://*/ && zIn[0] == ':' && zIn[1] == '/' && zIn[2] == '/' ){` |
|        - | 5414 | `			/* Got one */` |
...
|  1883352 | 5419 | `		zIn++;` |
|        5 | 5420 | `	}` |
|    30183 | 5421 | `	if( zIn >= zEnd ){` |
|        - | 5422 | `		/* No such scheme,return the default stream */` |
|    30153 | 5423 | `		return pVm->pDefStream;` |
|        - | 5424 | `	}` |
