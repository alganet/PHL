...
|        - |   75 | ` */` |
|  1282091 |   76 | `PH7_PRIVATE sxi32 VmIsUnorderedCmp(ph7_value *pLeft,ph7_value *pRight)` |
|        5 |   77 | `{` |
|  1282096 |   78 | `	if( (pLeft->iFlags & MEMOBJ_REAL) && PH7_IS_NAN(pLeft->rVal) ){` |
|       40 |   79 | `		return TRUE;` |
|        - |   80 | `	}` |
|  1282058 |   81 | `	if( (pRight->iFlags & MEMOBJ_REAL) && PH7_IS_NAN(pRight->rVal) ){` |
|       11 |   82 | `		return TRUE;` |
|        - |   83 | `	}` |
|  1282048 |   84 | `	return FALSE;` |
|   641563 |   85 | `}` |
|        - |   86 | `/*` |
...
|        - |   94 | ` */` |
|   367639 |   95 | `PH7_PRIVATE int VmStringWantsPerlIncr(ph7_value *pVal)` |
|        5 |   96 | `{` |
|        - |   97 | `	SyString sStr;` |
|   367644 |   98 | `	sxu8 bReal = FALSE;` |
|   367644 |   99 | `	const char *zTail = 0;` |
|        - |  100 | `	const char *zEnd;` |
|   367644 |  101 | `	if( (pVal->iFlags & MEMOBJ_STRING) == 0 ){` |
|   367630 |  102 | `		return FALSE;` |
|        - |  103 | `	}` |
...
|        - |  136 | ` */` |
|  1526208 |  137 | `PH7_PRIVATE sxi32 PH7_VmRegisterConstant(` |
...
|        - |  142 | `	)` |
|        5 |  143 | `{` |
|  1526213 |  144 | `	return PH7_VmRegisterConstantEx(&(*pVm),pName,xExpand,pUserData,0,0,0);` |
|        5 |  145 | `}` |
|        - |  146 | `/*` |
...
|        - |  149 | ` */` |
|  1526260 |  150 | `PH7_PRIVATE sxi32 PH7_VmRegisterConstantEx(` |
...
|        - |  162 | `	char *zDupName;` |
|        - |  163 | `	sxi32 rc;` |
|  1526265 |  164 | `	pEntry = SyHashGet(&pVm->hConstant,(const void *)pName->zString,pName->nByte);` |
|  1526265 |  165 | `	if( pEntry ){` |
...
|  1526263 |  189 | `	pCons = (ph7_constant *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_constant));` |
|  1526263 |  190 | `	if( pCons == 0 ){` |
|      ! 0 |  191 | `		return 0;` |
|        - |  192 | `	}` |
|        - |  193 | `	/* Duplicate constant name */` |
|  1526263 |  194 | `	zDupName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|  1526263 |  195 | `	if( zDupName == 0 ){` |
|      ! 0 |  196 | `		SyMemBackendPoolFree(&pVm->sAllocator,pCons);` |
|      ! 0 |  197 | `		return 0;` |
|        - |  198 | `	}` |
|  1526263 |  199 | `	SyStringInitFromBuf(&pCons->sFile,0,0);` |
|  1526263 |  200 | `	if( pFile ){` |
|       54 |  201 | `		SyStringDupPtr(&pCons->sFile,pFile);` |
|       25 |  202 | `	}` |
|  1526263 |  203 | `	pCons->nLine = nLine;` |
|  1526263 |  204 | `	pCons->bUserDefined = (sxu8)(bUser ? 1 : 0);` |
|        - |  205 | `	/* Install the constant */` |
|  1526263 |  206 | `	SyStringInitFromBuf(&pCons->sName,zDupName,pName->nByte);` |
|  1526263 |  207 | `	pCons->xExpand = xExpand;` |
|  1526263 |  208 | `	pCons->pUserData = pUserData;` |
|  1526263 |  209 | `	SySetInit(&pCons->aAttrs,&pVm->sAllocator,sizeof(ph7_attribute));` |
|  1526263 |  210 | `	rc = SyHashInsert(&pVm->hConstant,(const void *)zDupName,SyStringLength(&pCons->sName),pCons);` |
|  1526263 |  211 | `	if( rc != SXRET_OK ){` |
...
|        - |  225 | ` */` |
|  2234102 |  226 | `static sxi32 PH7_NewForeignFunction(` |
...
|  2234107 |  237 | `	pFunc = (ph7_user_func *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_user_func));` |
|  2234107 |  238 | `	if( pFunc == 0 ){` |
|      ! 0 |  239 | `		return SXERR_MEM;` |
|        - |  240 | `	}` |
|        - |  241 | `	/* Duplicate function name */` |
|  2234107 |  242 | `	zDup = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|  2234107 |  243 | `	if( zDup == 0 ){` |
|      ! 0 |  244 | `		SyMemBackendPoolFree(&pVm->sAllocator,pFunc);` |
|      ! 0 |  245 | `		return SXERR_MEM;` |
|        - |  246 | `	}` |
|        - |  247 | `	/* Zero the structure */` |
|  2234107 |  248 | `	SyZero(pFunc,sizeof(ph7_user_func));` |
|        - |  249 | `	/* Initialize structure fields */` |
|  2234107 |  250 | `	SyStringInitFromBuf(&pFunc->sName,zDup,pName->nByte);` |
|  2234107 |  251 | `	pFunc->pVm   = pVm;` |
|  2234107 |  252 | `	pFunc->xFunc = xFunc;` |
|  2234107 |  253 | `	pFunc->pUserData = pUserData;` |
|  2234107 |  254 | `	SySetInit(&pFunc->aAux,&pVm->sAllocator,sizeof(ph7_aux_data));` |
|        - |  255 | `	/* Write a pointer to the new function */` |
|  2234107 |  256 | `	*ppOut = pFunc;` |
|  2234107 |  257 | `	return SXRET_OK;` |
|  1117056 |  258 | `}` |
|        - |  259 | `/*` |
...
|        - |  266 | ` */` |
|  2237524 |  267 | `PH7_PRIVATE sxi32 PH7_VmInstallForeignFunction(` |
...
|  2237529 |  278 | `	pEntry = SyHashGet(&pVm->hHostFunction,pName->zString,pName->nByte);` |
|  2237529 |  279 | `	if( pEntry ){` |
|     3427 |  280 | `		pFunc = (ph7_user_func *)pEntry->pUserData;` |
|     3427 |  281 | `		pFunc->pUserData = pUserData;` |
|     3427 |  282 | `		pFunc->xFunc = xFunc;` |
|     3427 |  283 | `		SySetReset(&pFunc->aAux);` |
...
|     3427 |  288 | `		pFunc->nMinArg  = 0;` |
|     3427 |  289 | `		pFunc->bAtLeast = 0;` |
|     3427 |  290 | `		return SXRET_OK;` |
|        - |  291 | `	}` |
|        - |  292 | `	/* Create a new user function */` |
|  2234107 |  293 | `	rc = PH7_NewForeignFunction(&(*pVm),&(*pName),xFunc,pUserData,&pFunc);` |
|  2234107 |  294 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  295 | `		return rc;` |
|        - |  296 | `	}` |
|        - |  297 | `	/* Install the function in the corresponding hashtable */` |
|  2234107 |  298 | `	rc = SyHashInsert(&pVm->hHostFunction,SyStringData(&pFunc->sName),pName->nByte,pFunc);` |
|  2234107 |  299 | `	if( rc != SXRET_OK ){` |
...
|  2234107 |  305 | `	return SXRET_OK;` |
|  1118767 |  306 | `}` |
|        - |  307 | `/*` |
|        - |  308 | ` * Initialize a VM function.` |
|        - |  309 | ` */` |
|  3427744 |  310 | `PH7_PRIVATE sxi32 PH7_VmInitFuncState(` |
...
|  3427749 |  320 | `	SyZero(pFunc,sizeof(ph7_vm_func));` |
|        - |  321 | `	/* Initialize structure fields */` |
|        - |  322 | `	/* Arguments container */` |
|  3427749 |  323 | `	SySetInit(&pFunc->aArgs,&pVm->sAllocator,sizeof(ph7_vm_func_arg));` |
|        - |  324 | `	/* Static variable container */` |
|  3427749 |  325 | `	SySetInit(&pFunc->aStatic,&pVm->sAllocator,sizeof(ph7_vm_func_static_var));` |
|        - |  326 | `	/* Bytecode container */` |
|  3427749 |  327 | `	SySetInit(&pFunc->aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|        - |  328 | `    /* Preallocate some instruction slots */` |
|  3427749 |  329 | `	SySetAlloc(&pFunc->aByteCode,0x10);` |
|        - |  330 | `	/* Closure environment */` |
|  3427749 |  331 | `	SySetInit(&pFunc->aClosureEnv,&pVm->sAllocator,sizeof(ph7_vm_func_closure_env));` |
|        - |  332 | `	/* Return-type union alternatives (empty unless declared as a union) */` |
|  3427749 |  333 | `	SySetInit(&pFunc->aReturnUnion,&pVm->sAllocator,sizeof(ph7_type_alt));` |
|        - |  334 | `	/* Declared #[...] attributes */` |
|  3427749 |  335 | `	SySetInit(&pFunc->aAttrs,&pVm->sAllocator,sizeof(ph7_attribute));` |
|  3427749 |  336 | `	pFunc->iFlags = iFlags;` |
|  3427749 |  337 | `	pFunc->pUserData = pUserData;` |
...
|  3427749 |  340 | `	pFunc->bStrictTypes = (sxu8)(pVm->sCodeGen.bStrictTypes ? 1 : 0);` |
|  3427749 |  341 | `	if( pVm->bCompilingBuiltin ){` |
|        - |  342 | `		/* Defined by an embedded builtin chunk: internal, no defining file */` |
|  3423205 |  343 | `		pFunc->iFlags \|= VM_FUNC_INTERNAL;` |
|  1711605 |  344 | `	}else{` |
...
|     2272 |  351 | `		}` |
|        - |  352 | `	}` |
|  3427749 |  353 | `	SyStringInitFromBuf(&pFunc->sName,zName,nByte);` |
|  3427749 |  354 | `	return SXRET_OK;` |
|        5 |  355 | `}` |
|        - |  356 | `/*` |
...
|        - |  363 | ` */` |
|  5824150 |  364 | `PH7_PRIVATE sxi32 PH7_VmInstallUserFunction(` |
...
|        - |  371 | `	sxi32 rc;` |
|  5824155 |  372 | `	if( pName == 0 ){` |
|        - |  373 | `		/* Use the built-in name */` |
|   523803 |  374 | `		pName = &pFunc->sName;` |
|   261899 |  375 | `	}` |
|        - |  376 | `	/* Check for duplicates (functions with the same name) first */` |
|  5824155 |  377 | `	pEntry = SyHashGet(&pVm->hFunction,pName->zString,pName->nByte);` |
|  5824155 |  378 | `	if( pEntry ){` |
|  2870315 |  379 | `		ph7_vm_func *pLink = (ph7_vm_func *)pEntry->pUserData;` |
|  2870315 |  380 | `		if( pLink != pFunc ){` |
|        - |  381 | `			/* Link */` |
|       35 |  382 | `			pFunc->pNextName = pLink;` |
|       35 |  383 | `			pEntry->pUserData = pFunc;` |
|       16 |  384 | `		}` |
|  2870315 |  385 | `		return SXRET_OK;` |
|        - |  386 | `	}` |
|        - |  387 | `	/* First time seen */` |
|  2953845 |  388 | `	pFunc->pNextName = 0;` |
|  2953845 |  389 | `	rc = SyHashInsert(&pVm->hFunction,pName->zString,pName->nByte,pFunc);` |
|  2953845 |  390 | `	return rc;` |
|  2912080 |  391 | `}` |
|        - |  392 | `/*` |
|        - |  393 | ` * Install a user defined class in the corresponding VM container.` |
|        - |  394 | ` */` |
|   523406 |  395 | `PH7_PRIVATE sxi32 PH7_VmInstallClass(` |
|        - |  396 | `	ph7_vm *pVm,      /* Target VM  */` |
|        - |  397 | `	ph7_class *pClass /* Target Class */` |
|        - |  398 | `	)` |
|        5 |  399 | `{` |
|   523411 |  400 | `	SyString *pName = &pClass->sName;` |
|        - |  401 | `	SyHashEntry *pEntry;` |
|        - |  402 | `	sxi32 rc;` |
|        - |  403 | `	/* Check for duplicates */` |
|   523411 |  404 | `	pEntry = SyHashGet(&pVm->hClass,(const void *)pName->zString,pName->nByte);` |
|   523411 |  405 | `	if( pEntry ){` |
...
|        - |  411 | `	}` |
|   523409 |  412 | `	pClass->pNextName = 0;` |
|        - |  413 | `	/* Perform a simple hashtable insertion */` |
|   523409 |  414 | `	rc = SyHashInsert(&pVm->hClass,(const void *)pName->zString,pName->nByte,pClass);` |
|   523409 |  415 | `	return rc;` |
|   261708 |  416 | `}` |
|        - |  417 | `/*` |
|        - |  418 | ` * Instruction builder interface.` |
|        - |  419 | ` */` |
| 98652452 |  420 | `PH7_PRIVATE sxi32 PH7_VmEmitInstr(` |
...
|        5 |  428 | `{` |
|        - |  429 | `	VmInstr sInstr;` |
| 98652457 |  430 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|        - |  431 | `	sxi32 rc;` |
|        - |  432 | `	/* Fill the VM instruction */` |
| 98652457 |  433 | `	sInstr.iOp = (sxu8)iOp;` |
| 98652457 |  434 | `	sInstr.iP1 = iP1;` |
| 98652457 |  435 | `	sInstr.iP2 = iP2;` |
| 98652457 |  436 | `	sInstr.p3  = p3;` |
...
| 98652457 |  441 | `	sInstr.nLine = 0;` |
| 98652457 |  442 | `	if( pGen->pIn && pGen->pEnd && pGen->pIn < pGen->pEnd ){` |
| 42030961 |  443 | `		sInstr.nLine = pGen->pIn->nLine;` |
| 77636979 |  444 | `	}else if( pGen->pIn && pGen->pEnd && pGen->pIn >= pGen->pEnd && pGen->pEnd > (SyToken *)0 ){` |
|        - |  445 | `		/* Past the end (statement tail): blame the last real token. */` |
| 56406313 |  446 | `		sInstr.nLine = pGen->pEnd[-1].nLine;` |
| 28203154 |  447 | `	}` |
| 98652457 |  448 | `	if( pIndex ){` |
|        - |  449 | `		/* Instruction index in the bytecode array */` |
|  6678253 |  450 | `		*pIndex = SySetUsed(pVm->pByteContainer);` |
|  3339124 |  451 | `	}` |
|        - |  452 | `	/* Finally,record the instruction */` |
| 98652457 |  453 | `	rc = SySetPut(pVm->pByteContainer,(const void *)&sInstr);` |
| 98652457 |  454 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  455 | `		PH7_GenCompileError(&pVm->sCodeGen,E_ERROR,1,"Fatal,Cannot emit instruction due to a memory failure");` |
|        - |  456 | `		/* Fall throw */` |
|      ! 0 |  457 | `	}` |
| 98652457 |  458 | `	return rc;` |
|        5 |  459 | `}` |
|        - |  460 | `/*` |
|        - |  461 | ` * Swap the current bytecode container with the given one.` |
|        - |  462 | ` */` |
|  9810764 |  463 | `PH7_PRIVATE sxi32 PH7_VmSetByteCodeContainer(ph7_vm *pVm,SySet *pContainer)` |
|        5 |  464 | `{` |
|  9810769 |  465 | `	if( pContainer == 0 ){` |
|        - |  466 | `		/* Point to the default container */` |
|      ! 0 |  467 | `		pVm->pByteContainer = &pVm->aByteCode;` |
|      ! 0 |  468 | `	}else{` |
|        - |  469 | `		/* Change container */` |
|  9810769 |  470 | `		pVm->pByteContainer = &(*pContainer);` |
|        - |  471 | `	}` |
|  9810769 |  472 | `	return SXRET_OK;` |
|        5 |  473 | `}` |
|        - |  474 | `/*` |
|        - |  475 | ` * Return the current bytecode container.` |
|        - |  476 | ` */` |
|  4905382 |  477 | `PH7_PRIVATE SySet * PH7_VmGetByteCodeContainer(ph7_vm *pVm)` |
|        5 |  478 | `{` |
|  4905387 |  479 | `	return pVm->pByteContainer;` |
|        5 |  480 | `}` |
|        - |  481 | `/*` |
|        - |  482 | ` * Extract the VM instruction rooted at nIndex.` |
|        - |  483 | ` */` |
|  6884894 |  484 | `PH7_PRIVATE VmInstr * PH7_VmGetInstr(ph7_vm *pVm,sxu32 nIndex)` |
|        5 |  485 | `{` |
|        - |  486 | `	VmInstr *pInstr;` |
|  6884899 |  487 | `	pInstr = (VmInstr *)SySetAt(pVm->pByteContainer,nIndex);` |
|  6884899 |  488 | `	return pInstr;` |
|        5 |  489 | `}` |
|        - |  490 | `/*` |
|        - |  491 | ` * Return the total number of VM instructions recorded so far.` |
|        - |  492 | ` */` |
| 54327244 |  493 | `PH7_PRIVATE sxu32 PH7_VmInstrLength(ph7_vm *pVm)` |
|        5 |  494 | `{` |
| 54327249 |  495 | `	return SySetUsed(pVm->pByteContainer);` |
|        5 |  496 | `}` |
|        - |  497 | `/*` |
|        - |  498 | ` * Pop the last VM instruction.` |
|        - |  499 | ` */` |
|  5414378 |  500 | `PH7_PRIVATE VmInstr * PH7_VmPopInstr(ph7_vm *pVm)` |
|        5 |  501 | `{` |
|  5414383 |  502 | `	return (VmInstr *)SySetPop(pVm->pByteContainer);` |
|        5 |  503 | `}` |
|        - |  504 | `/*` |
|        - |  505 | ` * Peek the last VM instruction.` |
|        - |  506 | ` */` |
| 20509706 |  507 | `PH7_PRIVATE VmInstr * PH7_VmPeekInstr(ph7_vm *pVm)` |
|        5 |  508 | `{` |
| 20509711 |  509 | `	return (VmInstr *)SySetPeek(pVm->pByteContainer);` |
|        5 |  510 | `}` |
|  1717188 |  511 | `PH7_PRIVATE VmInstr * PH7_VmPeekNextInstr(ph7_vm *pVm)` |
|        5 |  512 | `{` |
|        - |  513 | `	VmInstr *aInstr;` |
|        - |  514 | `	sxu32 n;` |
|  1717193 |  515 | `	n = SySetUsed(pVm->pByteContainer);` |
|  1717193 |  516 | `	if( n < 2 ){` |
|      ! 0 |  517 | `		return 0;` |
|        - |  518 | `	}` |
|  1717193 |  519 | `	aInstr = (VmInstr *)SySetBasePtr(pVm->pByteContainer);` |
|  1717193 |  520 | `	return &aInstr[n - 2];` |
|   858599 |  521 | `}` |
|        - |  522 | `/*` |
|        - |  523 | ` * Allocate a new virtual machine frame.` |
|        - |  524 | ` */` |
|   114019 |  525 | `PH7_PRIVATE VmFrame * VmNewFrame(` |
...
|   114024 |  533 | `	pFrame = (VmFrame *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmFrame));` |
|   114024 |  534 | `	if( pFrame == 0 ){` |
|      ! 0 |  535 | `		return 0;` |
|        - |  536 | `	}` |
|        - |  537 | `	/* Zero the structure */` |
|   114024 |  538 | `	SyZero(pFrame,sizeof(VmFrame));` |
|        - |  539 | `	/* Initialize frame fields */` |
|   114024 |  540 | `	pFrame->pUserData = pUserData;` |
|   114024 |  541 | `	pFrame->pThis = pThis;` |
|   114024 |  542 | `	pFrame->pVm = pVm;` |
|   114024 |  543 | `	SyHashInit(&pFrame->hVar,&pVm->sAllocator,0,0);` |
|   114024 |  544 | `	SySetInit(&pFrame->sArg,&pVm->sAllocator,sizeof(VmSlot));` |
|   114024 |  545 | `	SySetInit(&pFrame->sLocal,&pVm->sAllocator,sizeof(VmSlot));` |
|   114024 |  546 | `	SySetInit(&pFrame->sRef,&pVm->sAllocator,sizeof(VmSlot));` |
|   114024 |  547 | `	pFrame->nActualArgs = -1; /* unknown until an arg-install site stamps it */` |
...
|   114024 |  550 | `	PH7_MemObjInit(&(*pVm),&pFrame->sRet);` |
|   114024 |  551 | `	return pFrame;` |
|    57117 |  552 | `}` |
...
|        - |  557 | ` */` |
|   113423 |  558 | `PH7_PRIVATE sxi32 VmEnterFrame(` |
...
|   113428 |  567 | `	pFrame = VmNewFrame(&(*pVm),pUserData,pThis);` |
|   113428 |  568 | `	if( pFrame == 0 ){` |
|      ! 0 |  569 | `		return SXERR_MEM;` |
|        - |  570 | `	}` |
|        - |  571 | `	/* The line currently executing IS the call site for the frame being pushed. */` |
|   113428 |  572 | `	pFrame->nCallLine = pVm->nCurLine;` |
|        - |  573 | `	/* Link to the list of active VM frame */` |
|   113428 |  574 | `	pFrame->pParent = pVm->pFrame;` |
|   113428 |  575 | `	pVm->pFrame = pFrame;` |
|   113428 |  576 | `	if( ppFrame ){` |
|        - |  577 | `		/* Write a pointer to the new VM frame */` |
|   109530 |  578 | `		*ppFrame = pFrame;` |
|    54865 |  579 | `	}` |
|   113428 |  580 | `	return SXRET_OK;` |
|    56819 |  581 | `}` |
|        - |  582 | `/*` |
...
|        - |  630 | ` */` |
|   109955 |  631 | `PH7_PRIVATE void VmDropResumeTarget(ph7_vm *pVm, VmFrame *pFrame)` |
|        5 |  632 | `{` |
|   109960 |  633 | `	if( pVm->pResumeFrame == pFrame ){` |
...
|        - |  639 | ` */` |
|   109103 |  640 | `PH7_PRIVATE void VmLeaveFrame(ph7_vm *pVm)` |
|        5 |  641 | `{` |
|   109108 |  642 | `		VmFrame *pCurFrame = pVm->pFrame;` |
|   109108 |  643 | `	if( pCurFrame ){` |
|        - |  644 | `		/* Unlink from the list of active VM frame */` |
|   109108 |  645 | `		pVm->pFrame = pCurFrame->pParent;` |
|   109108 |  646 | `		if( pCurFrame->pParent && (pCurFrame->iFlags & VM_FRAME_EXCEPTION) == 0 ){` |
|        - |  647 | `			VmSlot  *aSlot;` |
|        - |  648 | `			sxu32 n;` |
|        - |  649 | `			/* Restore local variable to the free pool so that they can be reused again */` |
|   104264 |  650 | `			aSlot = (VmSlot *)SySetBasePtr(&pCurFrame->sLocal);` |
|   592610 |  651 | `			for(n = 0 ; n < SySetUsed(&pCurFrame->sLocal) ; ++n ){` |
|        - |  652 | `				/* Unset the local variable */` |
|   488351 |  653 | `				PH7_VmUnsetMemObj(&(*pVm),aSlot[n].nIdx,FALSE);` |
|   244793 |  654 | `			}` |
|        - |  655 | `			/* Remove local reference */` |
|   104264 |  656 | `			aSlot = (VmSlot *)SySetBasePtr(&pCurFrame->sRef);` |
|   592694 |  657 | `			for(n = 0 ; n < SySetUsed(&pCurFrame->sRef) ; ++n ){` |
|   488435 |  658 | `				PH7_VmRefObjRemove(&(*pVm),aSlot[n].nIdx,(SyHashEntry *)aSlot[n].pUserData,0);` |
|   244835 |  659 | `			}` |
|    52232 |  660 | `		}` |
|        - |  661 | `		/* Release internal containers */` |
|   109108 |  662 | `		SyHashRelease(&pCurFrame->hVar);` |
|   109108 |  663 | `		SySetRelease(&pCurFrame->sArg);` |
|   109108 |  664 | `		SySetRelease(&pCurFrame->sLocal);` |
|   109108 |  665 | `		SySetRelease(&pCurFrame->sRef);` |
...
|   109108 |  669 | `		PH7_MemObjRelease(&pCurFrame->sRet);` |
|        - |  670 | `		/* Drop a recorded in-place-catch resume target pointing at this frame (ROOT B). */` |
|   109108 |  671 | `		VmDropResumeTarget(pVm,pCurFrame);` |
|        - |  672 | `		/* Release the whole structure */` |
|   109108 |  673 | `		SyMemBackendPoolFree(&pVm->sAllocator,pCurFrame);` |
|    54654 |  674 | `	}` |
|   109108 |  675 | `}` |
|        - |  676 | `/*` |
...
|        - |  727 | ` */` |
| 10556304 |  728 | `PH7_PRIVATE VmFrame * VmSkipExceptionFrames(VmFrame *pFrame)` |
|        5 |  729 | `{` |
| 10581551 |  730 | `	while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|    25247 |  731 | `		pFrame = pFrame->pParent;` |
|        5 |  732 | `	}` |
| 10556309 |  733 | `	return pFrame;` |
|        5 |  734 | `}` |
|        - |  735 | `/*` |
...
|      ! 0 |  913 | `	return 0;` |
|       38 |  914 | `}` |
|   257787 |  915 | `PH7_PRIVATE sxi32 VmDrainFinally(ph7_vm *pVm, sxu32 nExceptionBase)` |
|        5 |  916 | `{` |
|        - |  917 | `	sxu32 nUsed;` |
|   257792 |  918 | `	sxi32 rcOut = SXRET_OK;` |
|   257856 |  919 | `	while( (nUsed = SySetUsed(&pVm->aException)) > nExceptionBase ){` |
...
|        - |  956 | ` */` |
|   155128 |  957 | `PH7_PRIVATE void VmClearFrameReturn(VmFrame *pFrame)` |
|        5 |  958 | `{` |
|   155133 |  959 | `	pFrame->bHasRet = 0;` |
|   155133 |  960 | `	PH7_MemObjRelease(&pFrame->sRet);` |
|   155133 |  961 | `}` |
|        - |  962 | `/*` |
...
|        - | 1110 | ` */` |
|    34902 | 1111 | `PH7_PRIVATE sxi32 VmLocalExecIntoObj(ph7_vm *pVm,SySet *pByteCode,ph7_value **ppMemObj,int bReturnPropagates)` |
|        5 | 1112 | `{` |
|        - | 1113 | `	ph7_value sVal;` |
|    34907 | 1114 | `	sxu32 nIdx = (*ppMemObj)->nIdx;` |
|        - | 1115 | `	sxi32 rc;` |
|    34907 | 1116 | `	PH7_MemObjInit(&(*pVm),&sVal);` |
|    34907 | 1117 | `	rc = VmLocalExec(&(*pVm),pByteCode,&sVal,bReturnPropagates);` |
|        - | 1118 | `	/* aMemObj may have moved during the eval — re-fetch by the reserved index. */` |
|    34907 | 1119 | `	*ppMemObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|    34907 | 1120 | `	if( *ppMemObj ){` |
|    34907 | 1121 | `		PH7_MemObjStore(&sVal,*ppMemObj);` |
|    17451 | 1122 | `	}` |
|    34907 | 1123 | `	PH7_MemObjRelease(&sVal);` |
|    34907 | 1124 | `	return rc;` |
|        5 | 1125 | `}` |
|        - | 1126 | `/*` |
...
|        - | 1138 | ` */` |
|   705146 | 1139 | `static sxi32 VmMountUserClassAttrs(` |
...
|   705151 | 1147 | `	SyHashResetLoopCursor(&pClass->hAttr);` |
|        - | 1148 | `	/* Process only static and constant attribute */` |
|  2871707 | 1149 | `	while( (pEntry = SyHashGetNextEntry(&pClass->hAttr)) != 0 ){` |
|        - | 1150 | `		/* Extract the current attribute */` |
|  2166565 | 1151 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|  2166560 | 1152 | `		if( (pAttr->iFlags & PH7_CLASS_ATTR_CONSTANT)` |
|  1427632 | 1153 | `		 && ((pAttr->iFlags & PH7_CLASS_ATTR_TYPED) == 0` |
|   344795 | 1154 | `			\|\| (pAttr->iFlags & PH7_CLASS_ATTR_ENUMCASE) != 0) ){` |
...
|   687803 | 1164 | `			continue;` |
|        - | 1165 | `		}` |
|  1478767 | 1166 | `		if( pAttr->iFlags & (PH7_CLASS_ATTR_STATIC\|PH7_CLASS_ATTR_CONSTANT) ){` |
|        - | 1167 | `			ph7_value *pMemObj;` |
|    24957 | 1168 | `			if( pAttr->nIdx != SXU32_HIGH ){` |
...
|    24089 | 1175 | `			pMemObj = PH7_ReserveMemObj(&(*pVm));` |
|    24089 | 1176 | `			if( pMemObj == 0 ){` |
...
|        - | 1182 | `			}` |
|    24089 | 1183 | `			if( SySetUsed(&pAttr->aByteCode) > 0 ){` |
...
|    24081 | 1187 | `				ph7_class *pSaveCtx = pVm->pConstEvalClass;` |
|        - | 1188 | `				sxi32 rcExec;` |
|    24081 | 1189 | `				pVm->pConstEvalClass = pAttr->pDeclClass ? pAttr->pDeclClass : pClass;` |
|    24081 | 1190 | `				pAttr->iFlags \|= PH7_CLASS_ATTR_EVALING; /* cycle guard, shared with the on-demand path */` |
|    24081 | 1191 | `				pVm->nConstEvalDepth++;` |
|    24081 | 1192 | `				rcExec = VmLocalExecIntoObj(&(*pVm),&pAttr->aByteCode,&pMemObj,FALSE);` |
|    24081 | 1193 | `				pVm->nConstEvalDepth--;` |
|    24081 | 1194 | `				pAttr->iFlags &= ~PH7_CLASS_ATTR_EVALING;` |
|    24081 | 1195 | `				pVm->pConstEvalClass = pSaveCtx;` |
|    24081 | 1196 | `				if( rcExec == PH7_EXCEPTION \|\| rcExec == PH7_ABORT ){` |
...
|    24081 | 1202 | `				}else if( pVm->pConstCycleAttr && pVm->nConstEvalDepth == 0 ){` |
...
|    24076 | 1210 | `				if( (pAttr->iFlags & (PH7_CLASS_ATTR_CONSTANT\|PH7_CLASS_ATTR_TYPED))` |
|    12043 | 1211 | `					== (PH7_CLASS_ATTR_CONSTANT\|PH7_CLASS_ATTR_TYPED) ){` |
...
|    24085 | 1219 | `			pAttr->nIdx = pMemObj->nIdx;` |
|        - | 1220 | `			/* Install static attribute in the reference table */` |
|    24085 | 1221 | `			PH7_VmRefObjInstall(&(*pVm),pMemObj->nIdx,0,0,VM_REF_IDX_KEEP);` |
...
|    24080 | 1228 | `			if( (pAttr->iFlags & PH7_CLASS_ATTR_TYPED)` |
|    12068 | 1229 | `				&& (pAttr->iFlags & PH7_CLASS_ATTR_CONSTANT) == 0 ){` |
...
|    12040 | 1248 | `		}` |
|        5 | 1249 | `	}` |
|   705147 | 1250 | `	return SXRET_OK;` |
|   352578 | 1251 | `}` |
|   704070 | 1252 | `PH7_PRIVATE sxi32 VmMountUserClass(` |
...
|   704075 | 1261 | `	rc = VmMountUserClassAttrs(&(*pVm),pClass);` |
|   704075 | 1262 | `	if( rc != SXRET_OK ){` |
|        6 | 1263 | `		return rc;` |
|        - | 1264 | `	}` |
|        - | 1265 | `	/* Install class methods */` |
|   704071 | 1266 | `	if( pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|        - | 1267 | `		/* Do not mount interface/trait methods since they are not directly invocable.` |
|        - | 1268 | `		 */` |
|   312387 | 1269 | `		return SXRET_OK;` |
|        - | 1270 | `	}` |
|        - | 1271 | `	/* Create constructor alias if not yet done */` |
|   391689 | 1272 | `	if( SyHashGet(&pClass->hMethod,"__construct",sizeof("__construct")-1) == 0 ){` |
|        - | 1273 | `		/* User constructor with the same base class name */` |
|    59657 | 1274 | `		pEntry = SyHashGet(&pClass->hMethod,SyStringData(&pClass->sName),SyStringLength(&pClass->sName));` |
|    59657 | 1275 | `		if( pEntry ){` |
...
|   391689 | 1282 | `	SyHashResetLoopCursor(&pClass->hMethod);` |
|  5898171 | 1283 | `	while((pEntry = SyHashGetNextEntry(&pClass->hMethod)) != 0 ){` |
|  5310645 | 1284 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|  5310645 | 1285 | `		if( (pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT) == 0 ){` |
|  5300357 | 1286 | `			rc = PH7_VmInstallUserFunction(&(*pVm),&pMeth->sFunc,&pMeth->sVmName);` |
|  5300357 | 1287 | `			if( rc != SXRET_OK ){` |
|      ! 0 | 1288 | `				return rc;` |
|        - | 1289 | `			}` |
|  2650176 | 1290 | `		}` |
|        5 | 1291 | `	}` |
|        - | 1292 | `	/* Mark class as mounted to avoid redundant mounting */` |
|   391689 | 1293 | `	pClass->bMounted = TRUE;` |
|   391689 | 1294 | `	return SXRET_OK;` |
|   352040 | 1295 | `}` |
|        - | 1296 | `/*` |
...
|        - | 1556 | ` */` |
|  8592042 | 1557 | `PH7_PRIVATE ph7_value * PH7_ReserveConstObj(ph7_vm *pVm,sxu32 *pIndex)` |
|        5 | 1558 | `{` |
|        - | 1559 | `	ph7_value *pObj;` |
|        - | 1560 | `	sxi32 rc;` |
|  8592047 | 1561 | `	if( pIndex ){` |
|        - | 1562 | `		/* Object index in the object table */` |
|  8580377 | 1563 | `		*pIndex = SySetUsed(&pVm->aLitObj);` |
|  4290186 | 1564 | `	}` |
|        - | 1565 | `	/* Reserve a slot for the new object */` |
|  8592047 | 1566 | `	rc = SySetPut(&pVm->aLitObj,(const void *)zDummy);` |
|  8592047 | 1567 | `	if( rc != SXRET_OK ){` |
...
|      ! 0 | 1571 | `		return 0;` |
|        - | 1572 | `	}` |
|  8592047 | 1573 | `	pObj = (ph7_value *)SySetPeek(&pVm->aLitObj);` |
|  8592047 | 1574 | `	return pObj;` |
|  4296026 | 1575 | `}` |
|        - | 1576 | `/*` |
|        - | 1577 | ` * Reserve a memory object.` |
|        - | 1578 | ` * Return a pointer to the raw ph7_value on success. NULL on failure.` |
|        - | 1579 | ` */` |
|  2237976 | 1580 | `PH7_PRIVATE ph7_value * VmReserveMemObj(ph7_vm *pVm,sxu32 *pIndex)` |
|        5 | 1581 | `{` |
|        - | 1582 | `	ph7_value *pObj;` |
|        - | 1583 | `	sxi32 rc;` |
|  2237981 | 1584 | `	if( pIndex ){` |
|        - | 1585 | `		/* Object index in the object table */` |
|  2237981 | 1586 | `		*pIndex = SySetUsed(&pVm->aMemObj);` |
|  1118988 | 1587 | `	}` |
|        - | 1588 | `	/* Reserve a slot for the new object */` |
|  2237981 | 1589 | `	rc = SySetPut(&pVm->aMemObj,(const void *)zDummy);` |
|  2237981 | 1590 | `	if( rc != SXRET_OK ){` |
...
|      ! 0 | 1594 | `		return 0;` |
|        - | 1595 | `	}` |
|  2237981 | 1596 | `	pObj = (ph7_value *)SySetPeek(&pVm->aMemObj);` |
|  2237981 | 1597 | `	return pObj;` |
|  1118993 | 1598 | `}` |
...
|        - | 1611 | ` */` |
|     3890 | 1612 | `PH7_PRIVATE sxi32 PH7_VmInit(` |
...
|     3895 | 1620 | `	SyZero(pVm,sizeof(ph7_vm));` |
|        - | 1621 | `	/* Initialize VM fields */` |
|     3895 | 1622 | `	pVm->pEngine = &(*pEngine);` |
|     3895 | 1623 | `	pVm->bGcEnabled = 1; /* php default: the cycle collector is enabled */` |
|     3895 | 1624 | `	SyMemBackendInitFromParent(&pVm->sAllocator,&pEngine->sAllocator);` |
|        - | 1625 | `	/* Instructions containers */` |
|     3895 | 1626 | `	SySetInit(&pVm->aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|     3895 | 1627 | `	SySetAlloc(&pVm->aByteCode,0xFF);` |
|     3895 | 1628 | `	pVm->pByteContainer = &pVm->aByteCode;` |
|        - | 1629 | `	/* Object containers */` |
|     3895 | 1630 | `	SySetInit(&pVm->aMemObj,&pVm->sAllocator,sizeof(ph7_value));` |
|     3895 | 1631 | `	SySetAlloc(&pVm->aMemObj,0xFF);` |
|        - | 1632 | `	/* Argument-unpacking key capture (see VmSpreadRun/VmSpreadKey in vm.c) */` |
|     3895 | 1633 | `	SySetInit(&pVm->aSpreadRun,&pVm->sAllocator,sizeof(VmSpreadRun));` |
|     3895 | 1634 | `	SySetInit(&pVm->aSpreadKey,&pVm->sAllocator,sizeof(VmSpreadKey));` |
|     3895 | 1635 | `	SyBlobInit(&pVm->sSpreadKeyBlob,&pVm->sAllocator);` |
|     3895 | 1636 | `	SySetInit(&pVm->aEffArgName,&pVm->sAllocator,sizeof(SyString));` |
|        - | 1637 | `	/* Virtual machine internal containers */` |
|     3895 | 1638 | `	SyBlobInit(&pVm->sConsumer,&pVm->sAllocator);` |
|     3895 | 1639 | `	SyBlobInit(&pVm->sWorker,&pVm->sAllocator);` |
|     3895 | 1640 | `	SyBlobInit(&pVm->sLastErrMsg,&pVm->sAllocator);` |
|     3895 | 1641 | `	SyBlobInit(&pVm->sLastErrFile,&pVm->sAllocator);` |
|     3895 | 1642 | `	SyBlobInit(&pVm->sArgv,&pVm->sAllocator);` |
|     3895 | 1643 | `	SySetInit(&pVm->aLitObj,&pVm->sAllocator,sizeof(ph7_value));` |
|     3895 | 1644 | `	SySetAlloc(&pVm->aLitObj,0xFF);` |
|     3895 | 1645 | `	SyHashInit(&pVm->hHostFunction,&pVm->sAllocator,0,0);` |
|     3895 | 1646 | `	SyHashInit(&pVm->hFunction,&pVm->sAllocator,0,0);` |
|     3895 | 1647 | `	SyBlobInit(&pVm->sNamespace,&pVm->sAllocator);` |
|     3895 | 1648 | `	SyHashInit(&pVm->hUseImports,&pVm->sAllocator,0,0);` |
|     3895 | 1649 | `	SyHashInit(&pVm->hUseConstImports,&pVm->sAllocator,0,0);` |
|     3895 | 1650 | `	SyHashInit(&pVm->hClass,&pVm->sAllocator,SyStrHash,SyStrnmicmp);` |
|     3895 | 1651 | `	SyHashInit(&pVm->hConstant,&pVm->sAllocator,0,0);` |
|     3895 | 1652 | `	SyHashInit(&pVm->hSuper,&pVm->sAllocator,0,0);` |
|     3895 | 1653 | `	SyHashInit(&pVm->hPDO,&pVm->sAllocator,0,0);` |
|     3895 | 1654 | `	SySetInit(&pVm->aFreeObj,&pVm->sAllocator,sizeof(VmSlot));` |
|     3895 | 1655 | `	SySetInit(&pVm->aSelf,&pVm->sAllocator,sizeof(ph7_class *));` |
|     3895 | 1656 | `	SySetInit(&pVm->aShutdown,&pVm->sAllocator,sizeof(VmShutdownCB));` |
|     3895 | 1657 | `	SySetInit(&pVm->aIniCli,&pVm->sAllocator,sizeof(VmIniEntry));` |
|     3895 | 1658 | `	SySetInit(&pVm->aAutoload,&pVm->sAllocator,sizeof(VmAutoloadCB));` |
|     3895 | 1659 | `	SyHashInit(&pVm->hAutoloadActive,&pVm->sAllocator,0,0);` |
|     3895 | 1660 | `	SyHashInit(&pVm->hWeakCell,&pVm->sAllocator,0,0);` |
|     3895 | 1661 | `	SyHashInit(&pVm->hTypedSlot,&pVm->sAllocator,0,0);` |
|     3895 | 1662 | `	SySetInit(&pVm->aException,&pVm->sAllocator,sizeof(ph7_exception *));` |
|     3895 | 1663 | `	SySetInit(&pVm->aMagicGuard,&pVm->sAllocator,sizeof(VmMagicGuard));` |
|     3895 | 1664 | `	pVm->pMagicSetThis = 0;` |
|     3895 | 1665 | `	SyBlobInit(&pVm->sMagicSetName,&pVm->sAllocator);` |
|     3895 | 1666 | `	pVm->pHookSetThis = 0;` |
|     3895 | 1667 | `	pVm->pHookSetAttr = 0;` |
|     3895 | 1668 | `	pVm->nHookSetIdx = SXU32_HIGH;` |
|     3895 | 1669 | `	SySetInit(&pVm->aHookRmw,&pVm->sAllocator,sizeof(VmHookRmw));` |
|     3895 | 1670 | `	pVm->pMagicCallThis = 0;` |
|     3895 | 1671 | `	pVm->pMagicCallClass = 0;` |
|     3895 | 1672 | `	SyBlobInit(&pVm->sMagicCallName,&pVm->sAllocator);` |
|     3895 | 1673 | `	pVm->pIdleCallFrames = 0;` |
|     3895 | 1674 | `	pVm->pIdleOperandStacks = 0;` |
|     3895 | 1675 | `	pVm->nIdleOperandStacks = 0;` |
|     3895 | 1676 | `	pVm->pIdleStackNodes = 0;` |
|     3895 | 1677 | `	SySetInit(&pVm->aFinallyAction,&pVm->sAllocator,sizeof(VmFinallyAction));` |
|     3895 | 1678 | `	pVm->bInlineTryCatch = 1; /* ROOT C: enable inline generator try/catch/finally */` |
|     3895 | 1679 | `	pVm->pPendingException = 0;` |
|     3895 | 1680 | `	pVm->pInflightException = 0;` |
|     3895 | 1681 | `	pVm->nInflightExcBase = 0;` |
|     3895 | 1682 | `	pVm->pResumeFrame = 0;` |
|     3895 | 1683 | `	pVm->iResumePc = 0;` |
|     3895 | 1684 | `	pVm->pResumeInstr = 0;` |
|     3895 | 1685 | `	pVm->iResumeStackDepth = 0;` |
|     3895 | 1686 | `	pVm->nBoundaryRc = 0;` |
|     3895 | 1687 | `	pVm->pConstEvalClass = 0;` |
|     3895 | 1688 | `	pVm->nConstEvalDepth = 0;` |
|     3895 | 1689 | `	pVm->pConstCycleAttr = 0;` |
|     3895 | 1690 | `	pVm->pConstCycleClass = 0;` |
|     3895 | 1691 | `	SySetReset(&pVm->aMagicGuard);` |
|     3895 | 1692 | `	if( pVm->pMagicSetThis ){` |
|      ! 0 | 1693 | `		PH7_ClassInstanceUnref(pVm->pMagicSetThis);` |
|      ! 0 | 1694 | `		pVm->pMagicSetThis = 0;` |
|      ! 0 | 1695 | `	}` |
|     3895 | 1696 | `	SyBlobRelease(&pVm->sMagicSetName);` |
|     3895 | 1697 | `	if( pVm->pHookSetThis ){` |
|      ! 0 | 1698 | `		PH7_ClassInstanceUnref(pVm->pHookSetThis);` |
|      ! 0 | 1699 | `		pVm->pHookSetThis = 0;` |
|      ! 0 | 1700 | `	}` |
|     3895 | 1701 | `	pVm->pHookSetAttr = 0;` |
|     3895 | 1702 | `	pVm->nHookSetIdx = SXU32_HIGH;` |
|     3895 | 1703 | `	if( pVm->pMagicCallThis ){` |
|      ! 0 | 1704 | `		PH7_ClassInstanceUnref(pVm->pMagicCallThis);` |
|      ! 0 | 1705 | `		pVm->pMagicCallThis = 0;` |
|      ! 0 | 1706 | `	}` |
|     3895 | 1707 | `	pVm->pMagicCallClass = 0;` |
|     3895 | 1708 | `	SyBlobRelease(&pVm->sMagicCallName);` |
|        - | 1709 | `	/* Configuration containers */` |
|     3895 | 1710 | `	SySetInit(&pVm->aFiles,&pVm->sAllocator,sizeof(SyString));` |
|     3895 | 1711 | `	SySetInit(&pVm->aPaths,&pVm->sAllocator,sizeof(SyString));` |
|     3895 | 1712 | `	SySetInit(&pVm->aIncluded,&pVm->sAllocator,sizeof(SyString));` |
|     3895 | 1713 | `	SySetInit(&pVm->aOB,&pVm->sAllocator,sizeof(VmObEntry));` |
|     3895 | 1714 | `	SySetInit(&pVm->aResponseHeaders,&pVm->sAllocator,sizeof(VmResponseHeader));` |
|     3895 | 1715 | `	pVm->iResponseStatus = 200;` |
|     3895 | 1716 | `	pVm->bHeadersSent = 0;` |
|     3895 | 1717 | `	SySetInit(&pVm->aIOstream,&pVm->sAllocator,sizeof(ph7_io_stream *));` |
|        - | 1718 | `	/* Error callbacks containers */` |
|     3895 | 1719 | `	PH7_MemObjInit(&(*pVm),&pVm->aExceptionCB[0]);` |
|     3895 | 1720 | `	PH7_MemObjInit(&(*pVm),&pVm->aExceptionCB[1]);` |
|     3895 | 1721 | `	PH7_MemObjInit(&(*pVm),&pVm->aErrCB[0]);` |
|     3895 | 1722 | `	PH7_MemObjInit(&(*pVm),&pVm->aErrCB[1]);` |
|     3895 | 1723 | `	PH7_MemObjInit(&(*pVm),&pVm->sAssertCallback);` |
...
|     3895 | 1731 | `	pVm->nMaxDepth = 0;         /* host: unbounded PHP call depth (memory-bound) */` |
|     3895 | 1732 | `	pVm->nMaxNativeDepth = 256; /* host: proven the safe ceiling under ASan (the` |
...
|     3895 | 1745 | `	pVm->iAssertFlags = PH7_ASSERT_ZEND_OFF;` |
|        - | 1746 | `	/* JSON return status */` |
|     3895 | 1747 | `	pVm->json_rc = JSON_ERROR_NONE;` |
|        - | 1748 | `	/* PRNG context */` |
|     3895 | 1749 | `	SyRandomnessInit(&pVm->sPrng,0,0);` |
|        - | 1750 | `	/* Install the null constant */` |
|     3895 | 1751 | `	pObj = PH7_ReserveConstObj(&(*pVm),0);` |
|     3895 | 1752 | `	if( pObj == 0 ){` |
|      ! 0 | 1753 | `		rc = SXERR_MEM;` |
|      ! 0 | 1754 | `		goto Err;` |
|        - | 1755 | `	}` |
|     3895 | 1756 | `	PH7_MemObjInit(pVm,pObj);` |
|        - | 1757 | `	/* Install the boolean TRUE constant */` |
|     3895 | 1758 | `	pObj = PH7_ReserveConstObj(&(*pVm),0);` |
|     3895 | 1759 | `	if( pObj == 0 ){` |
|      ! 0 | 1760 | `		rc = SXERR_MEM;` |
|      ! 0 | 1761 | `		goto Err;` |
|        - | 1762 | `	}` |
|     3895 | 1763 | `	PH7_MemObjInitFromBool(pVm,pObj,1);` |
|        - | 1764 | `	/* Install the boolean FALSE constant */` |
|     3895 | 1765 | `	pObj = PH7_ReserveConstObj(&(*pVm),0);` |
|     3895 | 1766 | `	if( pObj == 0 ){` |
|      ! 0 | 1767 | `		rc = SXERR_MEM;` |
|      ! 0 | 1768 | `		goto Err;` |
|        - | 1769 | `	}` |
|     3895 | 1770 | `	PH7_MemObjInitFromBool(pVm,pObj,0);` |
...
|     3895 | 1774 | `	pObj = PH7_ReserveConstObj(&(*pVm),&pVm->nEmptyStringIdx);` |
|     3895 | 1775 | `	if( pObj == 0 ){` |
|      ! 0 | 1776 | `		rc = SXERR_MEM;` |
|      ! 0 | 1777 | `		goto Err;` |
|        - | 1778 | `	}` |
|     3895 | 1779 | `	PH7_MemObjInitFromString(pVm,pObj,0);` |
|        - | 1780 | `	/* Create the global frame */` |
|     3895 | 1781 | `	rc = VmEnterFrame(&(*pVm),0,0,0);` |
|     3895 | 1782 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 1783 | `		goto Err;` |
|        - | 1784 | `	}` |
|        - | 1785 | `	/* Initialize the code generator */` |
|     3895 | 1786 | `	rc = PH7_InitCodeGenerator(pVm,pEngine->xConf.xErr,pEngine->xConf.pErrData);` |
|     3895 | 1787 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 1788 | `		goto Err;` |
|        - | 1789 | `	}` |
|        - | 1790 | `	/* VM correctly initialized,set the magic number */` |
|     3895 | 1791 | `	pVm->nMagic = PH7_VM_INIT;` |
...
|     3895 | 1800 | `	pVm->pFiberClass = PH7_VmExtractClass(pVm,"Fiber",5,0,0);` |
|        - | 1801 | `	/* Cache built-in interface pointers used on hot dispatch paths */` |
|     3895 | 1802 | `	pVm->pArrayAccessClass = PH7_VmExtractClass(pVm,"ArrayAccess",sizeof("ArrayAccess")-1,0,0);` |
|     3895 | 1803 | `	pVm->pCountableClass   = PH7_VmExtractClass(pVm,"Countable",sizeof("Countable")-1,0,0);` |
|     3895 | 1804 | `	pVm->pStringableClass  = PH7_VmExtractClass(pVm,"Stringable",sizeof("Stringable")-1,0,0);` |
|     3895 | 1805 | `	pVm->pJsonSerializableClass = PH7_VmExtractClass(pVm,"JsonSerializable",sizeof("JsonSerializable")-1,0,0);` |
|     3895 | 1806 | `	pVm->pTraversableClass = PH7_VmExtractClass(pVm,"Traversable",sizeof("Traversable")-1,0,0);` |
|        - | 1807 | `	/* Initialize null-coalesce-assign scratch slot */` |
|     3895 | 1808 | `	pVm->pCoalesceObj = 0;` |
|     3895 | 1809 | `	pVm->bCoalesceArmed = 0;` |
|     3895 | 1810 | `	PH7_MemObjInit(pVm,&pVm->sCoalesceKey);` |
|        - | 1811 | `	/* Register Fiber internal C functions */` |
|     3895 | 1812 | `	ph7_create_function(pVm,"__fiber_suspend",vm_builtin_Fiber_suspend,0);` |
|     3895 | 1813 | `	ph7_create_function(pVm,"__fiber_construct",vm_builtin_Fiber_construct,0);` |
|     3895 | 1814 | `	ph7_create_function(pVm,"__fiber_start",vm_builtin_Fiber_start,0);` |
|     3895 | 1815 | `	ph7_create_function(pVm,"__fiber_resume",vm_builtin_Fiber_resume,0);` |
|     3895 | 1816 | `	ph7_create_function(pVm,"__fiber_getReturn",vm_builtin_Fiber_getReturn,0);` |
|     3895 | 1817 | `	ph7_create_function(pVm,"__fiber_isStarted",vm_builtin_Fiber_isStarted,0);` |
|     3895 | 1818 | `	ph7_create_function(pVm,"__fiber_isRunning",vm_builtin_Fiber_isRunning,0);` |
|     3895 | 1819 | `	ph7_create_function(pVm,"__fiber_isSuspended",vm_builtin_Fiber_isSuspended,0);` |
|     3895 | 1820 | `	ph7_create_function(pVm,"__fiber_isTerminated",vm_builtin_Fiber_isTerminated,0);` |
|     3895 | 1821 | `	ph7_create_function(pVm,"__fiber_destruct",vm_builtin_Fiber_destruct,0);` |
|        - | 1822 | `	/* Cache the Closure class pointer (closures are instances of it) */` |
|     3895 | 1823 | `	pVm->pClosureClass = PH7_VmExtractClass(pVm,"Closure",7,0,0);` |
|     3895 | 1824 | `	pVm->pClosureThis = 0; /* transient bound-$this slot, consumed per call */` |
|     3895 | 1825 | `	pVm->pClosureScope = 0; /* transient bound-scope slot, consumed per call */` |
|        - | 1826 | `	/* Closure::bind/bindTo/call/fromCallable native delegates (Increment 2) */` |
|     3895 | 1827 | `	ph7_create_function(pVm,"__closure_bindTo",vm_builtin_Closure_bindTo,0);` |
|     3895 | 1828 | `	ph7_create_function(pVm,"__closure_fromCallable",vm_builtin_Closure_fromCallable,0);` |
|        - | 1829 | `	/* Cache the stdClass pointer ((object) cast target + dynamic-property owner) */` |
|     3895 | 1830 | `	pVm->pStdClass = PH7_VmExtractClass(pVm,"stdClass",sizeof("stdClass")-1,0,0);` |
|        - | 1831 | `	/* Cache the Generator class pointer and register generator functions */` |
|     3895 | 1832 | `	pVm->pGeneratorClass = PH7_VmExtractClass(pVm,"Generator",9,0,0);` |
|     3895 | 1833 | `	ph7_create_function(pVm,"__gen_rewind",vm_builtin_Generator_rewind,0);` |
|     3895 | 1834 | `	ph7_create_function(pVm,"__gen_valid",vm_builtin_Generator_valid,0);` |
|     3895 | 1835 | `	ph7_create_function(pVm,"__gen_current",vm_builtin_Generator_current,0);` |
|     3895 | 1836 | `	ph7_create_function(pVm,"__gen_key",vm_builtin_Generator_key,0);` |
|     3895 | 1837 | `	ph7_create_function(pVm,"__gen_next",vm_builtin_Generator_next,0);` |
|     3895 | 1838 | `	ph7_create_function(pVm,"__gen_send",vm_builtin_Generator_send,0);` |
|     3895 | 1839 | `	ph7_create_function(pVm,"__gen_throw",vm_builtin_Generator_throw,0);` |
|     3895 | 1840 | `	ph7_create_function(pVm,"__gen_getReturn",vm_builtin_Generator_getReturn,0);` |
|     3895 | 1841 | `	ph7_create_function(pVm,"__gen_destruct",vm_builtin_Generator_destruct,0);` |
...
|     3895 | 1845 | `	PH7_VmInstallReflection(&(*pVm));` |
|     3895 | 1846 | `	PH7_VmInstallDateTime(&(*pVm));` |
|     3895 | 1847 | `	PH7_VmInstallSpl(&(*pVm));` |
|     3895 | 1848 | `	PH7_VmInstallTokenizer(&(*pVm));` |
|     3895 | 1849 | `	PH7_VmInstallSession(&(*pVm));` |
|     3895 | 1850 | `	PH7_VmInstallIni(&(*pVm));` |
...
|     3895 | 1854 | `	PH7_VmInstallLibxml(&(*pVm));` |
|     3895 | 1855 | `	PH7_VmInstallDom(&(*pVm));` |
|     3895 | 1856 | `	PH7_VmInstallXmlWriter(&(*pVm));` |
|        - | 1857 | `#endif` |
|     3895 | 1858 | `	pVm->bCompilingBuiltin = 0;` |
|        - | 1859 | `	/* Reset the code generator */` |
|     3895 | 1860 | `	PH7_ResetCodeGenerator(&(*pVm),pEngine->xConf.xErr,pEngine->xConf.pErrData);` |
|     3895 | 1861 | `	return SXRET_OK;` |
|      ! 0 | 1862 | `Err:` |
...
|        - | 2088 | ` */` |
|   242312 | 2089 | `PH7_PRIVATE ph7_value * VmNewOperandStack(` |
...
|        - | 2101 | `  */` |
|   242317 | 2102 | `	nInstr += VM_STACK_GUARD;` |
|   242317 | 2103 | `	pStack = (ph7_value *)SyMemBackendAlloc(&pVm->sAllocator,nInstr * sizeof(ph7_value));` |
|   242317 | 2104 | `	if( pStack == 0 ){` |
|      ! 0 | 2105 | `		return 0;` |
|        - | 2106 | `	}` |
|        - | 2107 | `	/* Initialize the operand stack */` |
| 23090831 | 2108 | `	while( nInstr > 0 ){` |
| 22848519 | 2109 | `		PH7_MemObjInit(&(*pVm),&pStack[nInstr - 1]);` |
| 22848519 | 2110 | `		--nInstr;` |
|        5 | 2111 | `	}` |
|        - | 2112 | `	/* Ready for bytecode execution */` |
|   242317 | 2113 | `	return pStack;` |
|   121263 | 2114 | `}` |
|        - | 2115 | `/*` |
...
|        - | 2153 | ` */` |
|   104535 | 2154 | `PH7_PRIVATE ph7_value * VmOperandStackAlloc(ph7_vm *pVm, sxu32 nSlots)` |
|        5 | 2155 | `{` |
|   104540 | 2156 | `	VmIdleStack *pIdle = (VmIdleStack *)pVm->pIdleOperandStacks;` |
|   104540 | 2157 | `	sxu32 nCap = nSlots + VM_STACK_GUARD;` |
|   104540 | 2158 | `	if( pIdle && pIdle->nCap == nCap ){` |
...
|        - | 2167 | `	}` |
|    85993 | 2168 | `	return VmNewOperandStack(&(*pVm),nSlots);` |
|    52375 | 2169 | `}` |
|        - | 2170 | `/*` |
...
|        - | 2174 | ` * live value.` |
|        - | 2175 | ` */` |
|   104125 | 2176 | `PH7_PRIVATE void VmOperandStackRecycle(ph7_vm *pVm, ph7_value *pStack, sxu32 nCap)` |
|        5 | 2177 | `{` |
|        - | 2178 | `	VmIdleStack *pIdle;` |
|        - | 2179 | `	sxu32 i;` |
|   104130 | 2180 | `	if( pStack == 0 ){` |
|      ! 0 | 2181 | `		return;` |
|        - | 2182 | `	}` |
|   104130 | 2183 | `	if( pVm->nIdleOperandStacks >= VM_STACK_POOL_MAX \|\| nCap > VM_STACK_POOL_MAXSLOTS ){` |
|    79761 | 2184 | `		SyMemBackendFree(&pVm->sAllocator,pStack);` |
|    79761 | 2185 | `		return;` |
|        - | 2186 | `	}` |
...
|     3427 | 2237 | `	PH7_ResetCodeGenerator(pVm,pVm->pEngine->xConf.xErr,pVm->pEngine->xConf.pErrData);` |
|        - | 2238 | `	/* Emit the DONE instruction */` |
|     3427 | 2239 | `	rc = PH7_VmEmitInstr(&(*pVm),PH7_OP_DONE,0,0,0,0);` |
|     3427 | 2240 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 2241 | `		return SXERR_MEM;` |
|        - | 2242 | `	}` |
|        - | 2243 | `	/* Script return value */` |
|     3427 | 2244 | `	PH7_MemObjInit(&(*pVm),&pVm->sExec); /* Assume a NULL return value */` |
|        - | 2245 | `	/* Allocate a new operand stack */` |
|     3427 | 2246 | `	pVm->aOps = VmNewOperandStack(&(*pVm),SySetUsed(pVm->pByteContainer));` |
|     3427 | 2247 | `	if( pVm->aOps == 0 ){` |
|      ! 0 | 2248 | `		return SXERR_MEM;` |
|        - | 2249 | `	}` |
|        - | 2250 | `	/* Set the default VM output consumer callback and it's` |
|        - | 2251 | `	 * private data. */` |
|     3427 | 2252 | `	pVm->sVmConsumer.xConsumer = PH7_VmBlobConsumer;` |
|     3427 | 2253 | `	pVm->sVmConsumer.pUserData = &pVm->sConsumer;` |
|        - | 2254 | `	/* Allocate the reference table */` |
|     3427 | 2255 | `	pVm->nRefSize = 0x10; /* Must be a power of two for fast arithemtic */` |
|     3427 | 2256 | `	pVm->apRefObj = (VmRefObj **)SyMemBackendAlloc(&pVm->sAllocator,sizeof(VmRefObj *) * pVm->nRefSize);` |
|     3427 | 2257 | `	if( pVm->apRefObj == 0 ){` |
...
|     3427 | 2262 | `	SyZero(pVm->apRefObj,sizeof(VmRefObj *) * pVm->nRefSize);` |
|        - | 2263 | `	/* Register special functions first [i.e: print, json_encode(), func_get_args(), die, etc.] */` |
|     3427 | 2264 | `	rc = VmRegisterSpecialFunction(&(*pVm));` |
|     3427 | 2265 | `	if( rc != SXRET_OK ){` |
...
|     3427 | 2274 | `	pVm->nSuperBaseline = SySetUsed(&pVm->aMemObj);` |
|        - | 2275 | `	/* Create superglobals [i.e: $GLOBALS, $_GET, $_POST...] */` |
|     3427 | 2276 | `	rc = PH7_HashmapCreateSuper(&(*pVm));` |
|     3427 | 2277 | `	if( rc != SXRET_OK ){` |
...
|     3427 | 2308 | `	SyHashResetLoopCursor(&pVm->hClass);` |
|   462237 | 2309 | `	while((pEntry = SyHashGetNextEntry(&pVm->hClass)) != 0 ){` |
|   458817 | 2310 | `		rc = VmMountUserClass(&(*pVm),(ph7_class *)pEntry->pUserData);` |
|   458817 | 2311 | `		if( rc != SXRET_OK ){` |
|        3 | 2312 | `			return rc;` |
|        - | 2313 | `		}` |
|        5 | 2314 | `	}` |
|        - | 2315 | `	/* Random number betwwen 0 and 1023 used to generate unique ID */` |
|     3425 | 2316 | `	pVm->unique_id = PH7_VmRandomNum(&(*pVm)) & 1023;` |
|        - | 2317 | `	/* First object handle id handed out is 1 (matches PHP's first userland object #1) */` |
|     3425 | 2318 | `	pVm->nNextObjId = 1;` |
|        - | 2319 | `	/* VM is ready for bytecode execution */` |
|     3425 | 2320 | `	return SXRET_OK;` |
|     1716 | 2321 | `}` |
|        - | 2322 | `/*` |
...
|        - | 2678 | ` */` |
|     3420 | 2679 | `PH7_PRIVATE sxi32 PH7_VmRelease(ph7_vm *pVm)` |
|        5 | 2680 | `{` |
|        - | 2681 | `	/* Set the stale magic number */` |
|     3425 | 2682 | `	pVm->nMagic = PH7_VM_STALE;` |
...
|     3425 | 2686 | `	PH7_LibxmlVmRelease(pVm);` |
|        - | 2687 | `#endif` |
|        - | 2688 | `	/* Release the private memory subsystem */` |
|     3425 | 2689 | `	SyMemBackendRelease(&pVm->sAllocator);` |
|     3425 | 2690 | `	return SXRET_OK;` |
|        5 | 2691 | `}` |
|        - | 2692 | `/*` |
...
|        - | 2701 | ` */` |
|   934136 | 2702 | `PH7_PRIVATE sxi32 VmInitCallContext(` |
...
|        - | 2708 | `	)` |
|        5 | 2709 | `{` |
|   934141 | 2710 | `	pOut->pFunc = pFunc;` |
|   934141 | 2711 | `	pOut->pVm   = pVm;` |
|   934141 | 2712 | `	SySetInit(&pOut->sVar,&pVm->sAllocator,sizeof(ph7_value *));` |
|   934141 | 2713 | `	SySetInit(&pOut->sChunk,&pVm->sAllocator,sizeof(ph7_aux_data));` |
|        - | 2714 | `	/* Assume a null return value */` |
|   934141 | 2715 | `	MemObjSetType(pRet,MEMOBJ_NULL);` |
|   934141 | 2716 | `	pOut->pRet = pRet;` |
|   934141 | 2717 | `	pOut->iFlags = iFlags;` |
|   934141 | 2718 | `	pOut->pArgMap = 0; /* Set by the OP_CALL dispatcher for named-arg-aware builtins */` |
|   934141 | 2719 | `	return SXRET_OK;` |
|        5 | 2720 | `}` |
|        - | 2721 | `/*` |
|        - | 2722 | ` * Release a foreign function call context and cleanup the mess` |
|        - | 2723 | ` * left behind.` |
|        - | 2724 | ` */` |
|   934136 | 2725 | `PH7_PRIVATE void VmReleaseCallContext(ph7_context *pCtx)` |
|        5 | 2726 | `{` |
|        - | 2727 | `	sxu32 n;` |
|   934141 | 2728 | `	if( SySetUsed(&pCtx->sVar) > 0 ){` |
...
|     5849 | 2739 | `	}` |
|   934141 | 2740 | `	if( SySetUsed(&pCtx->sChunk) > 0 ){` |
...
|        - | 2786 | ` */` |
|  5679751 | 2787 | `PH7_PRIVATE void VmPopOperand(` |
|        - | 2788 | `	ph7_value **ppTos, /* Operand stack */` |
|        - | 2789 | `	sxi32 nPop         /* Total number of memory objects to pop */` |
|        - | 2790 | `	)` |
|        5 | 2791 | `{` |
|  5679756 | 2792 | `	ph7_value *pTos = *ppTos;` |
| 12087686 | 2793 | `	while( nPop > 0 ){` |
|  6407935 | 2794 | `		PH7_MemObjRelease(pTos);` |
|  6407935 | 2795 | `		pTos--;` |
|  6407935 | 2796 | `		nPop--;` |
|        5 | 2797 | `	}` |
|        - | 2798 | `	/* Top of the stack */` |
|  5679756 | 2799 | `	*ppTos = pTos;` |
|  5679756 | 2800 | `}` |
|        - | 2801 | `/*` |
|        - | 2802 | ` * Reserve a memory object.` |
|        - | 2803 | ` * Return a pointer to the raw ph7_value on success. NULL on failure.` |
|        - | 2804 | ` */` |
|  4368487 | 2805 | `PH7_PRIVATE ph7_value * PH7_ReserveMemObj(ph7_vm *pVm)` |
|        5 | 2806 | `{` |
|  4368492 | 2807 | `	ph7_value *pObj = 0;` |
|        - | 2808 | `	VmSlot *pSlot;` |
|        - | 2809 | `	sxu32 nIdx;` |
|        - | 2810 | `	/* Check for a free slot */` |
|  4368492 | 2811 | `	nIdx = SXU32_HIGH; /* cc warning */` |
|  4368492 | 2812 | `	pSlot = (VmSlot *)SySetPop(&pVm->aFreeObj);` |
|  4368492 | 2813 | `	if( pSlot ){` |
|  2130542 | 2814 | `		pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pSlot->nIdx);` |
|  2130542 | 2815 | `		nIdx = pSlot->nIdx;` |
|  1065883 | 2816 | `	}` |
|  4368492 | 2817 | `	if( pObj == 0 ){` |
|        - | 2818 | `		/* Reserve a new memory object */` |
|  2237955 | 2819 | `		pObj = VmReserveMemObj(&(*pVm),&nIdx);` |
|  2237955 | 2820 | `		if( pObj == 0 ){` |
|      ! 0 | 2821 | `			return 0;` |
|        - | 2822 | `		}` |
|  1118975 | 2823 | `	}` |
|        - | 2824 | `	/* Set a null default value */` |
|  4368492 | 2825 | `	PH7_MemObjInit(&(*pVm),pObj);` |
|  4368492 | 2826 | `	pObj->nIdx = nIdx;` |
|  4368492 | 2827 | `	return pObj;` |
|  2184863 | 2828 | `}` |
|        - | 2829 | `/*` |
|        - | 2830 | ` * Insert an entry by reference (not copy) in the given hashmap.` |
|        - | 2831 | ` */` |
|    46446 | 2832 | `PH7_PRIVATE sxi32 VmHashmapRefInsert(` |
...
|        - | 2839 | `	ph7_value sKey;` |
|        - | 2840 | `	sxi32 rc;` |
|    46451 | 2841 | `	PH7_MemObjInitFromString(pMap->pVm,&sKey,0);` |
|    46451 | 2842 | `	PH7_MemObjStringAppend(&sKey,zKey,nByte);` |
|        - | 2843 | `	/* Perform the insertion */` |
|    46451 | 2844 | `	rc = PH7_HashmapInsertByRef(&(*pMap),&sKey,nRefIdx);` |
|    46451 | 2845 | `	PH7_MemObjRelease(&sKey);` |
|    46451 | 2846 | `	return rc;` |
|        5 | 2847 | `}` |
|        - | 2848 | `/*` |
...
|        - | 2959 | ` */` |
|  5816593 | 2960 | `PH7_PRIVATE ph7_value * VmExtractMemObj(` |
...
|        - | 2965 | `	)` |
|        5 | 2966 | `{` |
|  5816598 | 2967 | `	int bNullify = FALSE;` |
...
|  5816598 | 2974 | `	pFrame = pVm->pFrame;` |
|  5816598 | 2975 | `	pFrame = VmSkipExceptionFrames(pFrame);` |
|        - | 2976 | `	/* Perform the lookup */` |
|  5816598 | 2977 | `	if( pName == 0 \|\| pName->nByte < 1 ){` |
...
|  5816598 | 2985 | `	pEntry = SyHashGet(&pVm->hSuper,(const void *)pName->zString,pName->nByte);` |
|  5816598 | 2986 | `	if( pEntry == 0 ){` |
|        - | 2987 | `		/* Query the top active frame */` |
|  5816194 | 2988 | `		pEntry = SyHashGet(&pFrame->hVar,(const void *)pName->zString,pName->nByte);` |
|  5816194 | 2989 | `		if( pEntry == 0 ){` |
|   499063 | 2990 | `			char *zName = (char *)pName->zString;` |
|        - | 2991 | `			VmSlot sLocal;` |
|   499063 | 2992 | `			if( !bCreate ){` |
...
|        - | 2998 | `			 */` |
|   497907 | 2999 | `			pObj = PH7_ReserveMemObj(&(*pVm));` |
|   497907 | 3000 | `			if( pObj == 0 ){` |
|      ! 0 | 3001 | `				return 0;` |
|        - | 3002 | `			}` |
|   497907 | 3003 | `			nIdx = pObj->nIdx;` |
|   497907 | 3004 | `			if( bDup ){` |
|        - | 3005 | `				/* Duplicate name */` |
...
|   497907 | 3012 | `			rc = SyHashInsert(&pFrame->hVar,zName,pName->nByte,SX_INT_TO_PTR(nIdx));` |
|   497907 | 3013 | `			if( rc != SXRET_OK ){` |
...
|      ! 0 | 3018 | `				return 0;` |
|        - | 3019 | `			}` |
|   497907 | 3020 | `			if( pFrame->pParent != 0 ){` |
|        - | 3021 | `				/* Local variable */` |
|   489331 | 3022 | `				sLocal.nIdx = nIdx;` |
|   489331 | 3023 | `				SySetPut(&pFrame->sLocal,(const void *)&sLocal);` |
|   245283 | 3024 | `			}else{` |
...
|   497907 | 3029 | `			PH7_VmRefObjInstall(&(*pVm),nIdx,SyHashLastEntry(&pFrame->hVar),0,0);` |
|        - | 3030 | `			/* Save object index */` |
|   497907 | 3031 | `			pObj->nIdx = nIdx;` |
|   249571 | 3032 | `		}else{` |
|        - | 3033 | `			/* Extract variable contents */` |
|  5317136 | 3034 | `			nIdx = (sxu32)SX_PTR_TO_INT(pEntry->pUserData);` |
|  5317136 | 3035 | `			pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|  5317136 | 3036 | `			if( bNullify && pObj ){` |
...
|        - | 3050 | ` */` |
|    31188 | 3051 | `PH7_PRIVATE ph7_value * PH7_VmExtractSuper(` |
...
|    31193 | 3061 | `	pEntry = SyHashGet(&pVm->hSuper,(const void *)zName,nByte);` |
|    31193 | 3062 | `	if( pEntry == 0 ){` |
|        - | 3063 | `		/* No such entry */` |
|      ! 0 | 3064 | `		return 0;` |
|        - | 3065 | `	}` |
|        - | 3066 | `	/* Extract the superglobal index in the global object pool */` |
|    31193 | 3067 | `	nIdx = SX_PTR_TO_INT(pEntry->pUserData);` |
|        - | 3068 | `	/* Extract the variable value  */` |
|    31193 | 3069 | `	pValue = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|    31193 | 3070 | `	return pValue;` |
|    15599 | 3071 | `}` |
|        - | 3072 | `/*` |
|        - | 3073 | ` * Perform a raw hashmap insertion.` |
|        - | 3074 | ` * Refer to the [PH7_VmConfigure()] implementation for additional information.` |
|        - | 3075 | ` */` |
|    24434 | 3076 | `PH7_PRIVATE sxi32 PH7_VmHashmapInsert(` |
...
|        - | 3085 | `	sxi32 rc;` |
|    24439 | 3086 | `	PH7_MemObjInitFromString(pMap->pVm,&sKey,0);` |
|    24439 | 3087 | `	PH7_MemObjInitFromString(pMap->pVm,&sValue,0);` |
|    24439 | 3088 | `	if( zKey ){` |
|    21013 | 3089 | `		if( nKeylen < 0 ){` |
|    20909 | 3090 | `			nKeylen = (int)SyStrlen(zKey);` |
|    10452 | 3091 | `		}` |
|    21013 | 3092 | `		PH7_MemObjStringAppend(&sKey,zKey,(sxu32)nKeylen);` |
|    10504 | 3093 | `	}` |
|    24439 | 3094 | `	if( zData ){` |
|    24439 | 3095 | `		if( nLen < 0 ){` |
|        - | 3096 | `			/* Compute length automatically */` |
|    13867 | 3097 | `			nLen = (int)SyStrlen(zData);` |
|     6931 | 3098 | `		}` |
|    24439 | 3099 | `		PH7_MemObjStringAppend(&sValue,zData,(sxu32)nLen);` |
|    12217 | 3100 | `	}` |
...
|    24439 | 3105 | `	rc = PH7_HashmapInsert(&(*pMap),zKey ? &sKey : 0,&sValue);` |
|    24439 | 3106 | `	PH7_MemObjRelease(&sKey);` |
|    24439 | 3107 | `	PH7_MemObjRelease(&sValue);` |
|    24439 | 3108 | `	return rc;` |
|        5 | 3109 | `}` |
|        - | 3110 | `/*` |
...
|        - | 3122 | ` */` |
|    89550 | 3123 | `PH7_PRIVATE sxi32 PH7_VmConfigure(` |
|        - | 3124 | `	ph7_vm *pVm, /* Target VM */` |
|        - | 3125 | `	sxi32 nOp,   /* Configuration verb */` |
|        - | 3126 | `	va_list ap   /* Subsequent option arguments */` |
|        - | 3127 | `	)` |
|        5 | 3128 | `{` |
|    89555 | 3129 | `	sxi32 rc = SXRET_OK;` |
|    89555 | 3130 | `	switch(nOp){` |
|     1697 | 3131 | `	case PH7_VM_CONFIG_OUTPUT: {` |
|     3399 | 3132 | `		ProcConsumer xConsumer = va_arg(ap,ProcConsumer);` |
|     3399 | 3133 | `		void *pUserData = va_arg(ap,void *);` |
...
|     3399 | 3142 | `		pVm->sVmConsumer.xConsumer = xConsumer;` |
|     3399 | 3143 | `		pVm->sVmConsumer.pUserData = pUserData;` |
|     3399 | 3144 | `		break;` |
|        - | 3145 | `							   }` |
|     1710 | 3146 | `	case PH7_VM_CONFIG_IMPORT_PATH: {` |
|        - | 3147 | `		/* Import path */` |
|        - | 3148 | `		  const char *zPath;` |
|        - | 3149 | `		  SyString sPath;` |
|     3425 | 3150 | `		  zPath = va_arg(ap,const char *);` |
...
|        - | 3155 | `		  }` |
|        - | 3156 | `#endif` |
|     3425 | 3157 | `		  SyStringInitFromBuf(&sPath,zPath,SyStrlen(zPath));` |
|        - | 3158 | `		  /* Remove trailing slashes and backslashes */` |
|        - | 3159 | `#ifdef __WINNT__` |
|        5 | 3160 | `		  SyStringTrimTrailingChar(&sPath,'\\');` |
|        - | 3161 | `#endif` |
|     6845 | 3162 | `		  SyStringTrimTrailingChar(&sPath,'/');` |
|        - | 3163 | `		  /* Remove leading and trailing white spaces */` |
|     3425 | 3164 | `		  SyStringFullTrim(&sPath);` |
|     3425 | 3165 | `		  if( sPath.nByte > 0 ){` |
|        - | 3166 | `			  /* Store the path in the corresponding conatiner */` |
|     3425 | 3167 | `			  rc = SySetPut(&pVm->aPaths,(const void *)&sPath);` |
|     1710 | 3168 | `		  }` |
|     3425 | 3169 | `		  break;` |
|        - | 3170 | `									 }` |
|     1713 | 3171 | `	case PH7_VM_CONFIG_ERR_REPORT:` |
|        - | 3172 | `		/* Run-Time Error report */` |
|     3431 | 3173 | `		pVm->bErrReport = 1;` |
|     3431 | 3174 | `		pVm->iErrMask = 30719; /* E_ALL (php 8: E_STRICT/2048 is no longer part of E_ALL) */` |
|     3431 | 3175 | `		break;` |
...
|        - | 3215 | `							   }` |
|        - | 3216 |  |
|    18847 | 3217 | `	case PH7_VM_CONFIG_CREATE_SUPER:` |
|        - | 3218 | `	case PH7_VM_CONFIG_CREATE_VAR: {` |
|        - | 3219 | `		/* Create a new superglobal/global variable */` |
|    37699 | 3220 | `		const char *zName = va_arg(ap,const char *);` |
|    37699 | 3221 | `		ph7_value *pValue = va_arg(ap,ph7_value *);` |
...
|        - | 3230 | `		}` |
|        - | 3231 | `#endif` |
|    37699 | 3232 | `		nByte = SyStrlen(zName);` |
|    37699 | 3233 | `		if( nOp == PH7_VM_CONFIG_CREATE_SUPER ){` |
|        - | 3234 | `			/* Check if the superglobal is already installed */` |
|    34305 | 3235 | `			pEntry = SyHashGet(&pVm->hSuper,(const void *)zName,nByte);` |
|    17155 | 3236 | `		}else{` |
|        - | 3237 | `			/* Query the top active VM frame */` |
|     3399 | 3238 | `			pEntry = SyHashGet(&pVm->pFrame->hVar,(const void *)zName,nByte);` |
|        - | 3239 | `		}` |
|    37699 | 3240 | `		if( pEntry ){` |
...
|    37699 | 3251 | `			pObj = PH7_ReserveMemObj(&(*pVm));` |
|    37699 | 3252 | `			if( pObj == 0 ){` |
|      ! 0 | 3253 | `				rc = SXERR_MEM;` |
|      ! 0 | 3254 | `				break;` |
|        - | 3255 | `			}` |
|    37699 | 3256 | `			nIdx = pObj->nIdx;` |
|        - | 3257 | `			/* Copy value */` |
|    37699 | 3258 | `			PH7_MemObjStore(pValue,pObj);` |
|    37699 | 3259 | `			if( nOp == PH7_VM_CONFIG_CREATE_SUPER ){` |
|        - | 3260 | `				/* Install the superglobal */` |
|    34305 | 3261 | `				rc = SyHashInsert(&pVm->hSuper,(const void *)zName,nByte,SX_INT_TO_PTR(nIdx));` |
|    17155 | 3262 | `			}else{` |
|        - | 3263 | `				/* Install in the current frame */` |
|     3399 | 3264 | `				rc = SyHashInsert(&pVm->pFrame->hVar,(const void *)zName,nByte,SX_INT_TO_PTR(nIdx));` |
|        - | 3265 | `			}` |
|    37699 | 3266 | `			if( rc == SXRET_OK ){` |
|        - | 3267 | `				SyHashEntry *pRef;` |
|    37699 | 3268 | `				if( nOp == PH7_VM_CONFIG_CREATE_SUPER ){` |
|    34305 | 3269 | `					pRef = SyHashLastEntry(&pVm->hSuper);` |
|    17155 | 3270 | `				}else{` |
|     3399 | 3271 | `					pRef = SyHashLastEntry(&pVm->pFrame->hVar);` |
|        - | 3272 | `				}` |
|        - | 3273 | `				/* Install in the reference table */` |
|    37699 | 3274 | `				PH7_VmRefObjInstall(&(*pVm),nIdx,pRef,0,0);` |
|    37699 | 3275 | `				if( nOp == PH7_VM_CONFIG_CREATE_SUPER \|\| pVm->pFrame->pParent == 0){` |
|        - | 3276 | `					/* Register in the $GLOBALS array */` |
|    37699 | 3277 | `					VmHashmapRefInsert(pVm->pGlobal,zName,nByte,nIdx);` |
|    18847 | 3278 | `				}` |
|    18847 | 3279 | `			}` |
|        - | 3280 | `		}` |
|    37699 | 3281 | `		break;` |
|        - | 3282 | `									}` |
|    10452 | 3283 | `	case PH7_VM_CONFIG_SERVER_ATTR:` |
...
|    20907 | 3315 | `			pValue = PH7_VmExtractSuper(&(*pVm),"_SERVER",sizeof("_SERVER")-1);` |
|        - | 3316 | `		}` |
|    20909 | 3317 | `		if( pValue == 0 \|\| (pValue->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
|        - | 3318 | `			/* No such entry */` |
|      ! 0 | 3319 | `			rc = SXERR_NOTFOUND;` |
|      ! 0 | 3320 | `			break;` |
|        - | 3321 | `		}` |
|        - | 3322 | `		/* Point to the hashmap */` |
|    20909 | 3323 | `		pMap = (ph7_hashmap *)pValue->x.pOther;` |
|        - | 3324 | `		/* Perform the insertion */` |
|    20909 | 3325 | `		rc = PH7_VmHashmapInsert(pMap,zKey,-1,zValue,nLen);` |
|    20909 | 3326 | `		break;` |
|        - | 3327 | `								   }` |
|     1714 | 3328 | `	case PH7_VM_CONFIG_ARGV_ENTRY:{` |
|        - | 3329 | `		/* Script arguments */` |
|     3433 | 3330 | `		const char *zValue = va_arg(ap,const char *);` |
|        - | 3331 | `		ph7_hashmap *pMap;` |
|        - | 3332 | `		ph7_value *pValue;` |
|        - | 3333 | `		sxu32 n;` |
|     3433 | 3334 | `		if( SX_EMPTY_STR(zValue) ){` |
|        2 | 3335 | `			rc = SXERR_EMPTY;` |
|        2 | 3336 | `			break;` |
|        - | 3337 | `		}` |
|        - | 3338 | `		/* Extract the $argv array */` |
|     3431 | 3339 | `		pValue = PH7_VmExtractSuper(&(*pVm),"argv",sizeof("argv")-1);` |
|     3431 | 3340 | `		if( pValue == 0 \|\| (pValue->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
|        - | 3341 | `			/* No such entry */` |
|      ! 0 | 3342 | `			rc = SXERR_NOTFOUND;` |
|      ! 0 | 3343 | `			break;` |
|        - | 3344 | `		}` |
|        - | 3345 | `		/* Point to the hashmap */` |
|     3431 | 3346 | `		pMap = (ph7_hashmap *)pValue->x.pOther;` |
|        - | 3347 | `		/* Perform the insertion */` |
|     3431 | 3348 | `		n = (sxu32)SyStrlen(zValue);` |
|     3431 | 3349 | `		rc = PH7_VmHashmapInsert(pMap,0,0,zValue,(int)n);` |
|     3431 | 3350 | `		if( rc == SXRET_OK ){` |
|     3431 | 3351 | `			if( pMap->nEntry > 1 ){` |
|        - | 3352 | `				/* Append space separator first */` |
|       37 | 3353 | `				SyBlobAppend(&pVm->sArgv,(const void *)" ",sizeof(char));` |
|       16 | 3354 | `			}` |
|     3431 | 3355 | `			SyBlobAppend(&pVm->sArgv,(const void *)zValue,n);` |
|     1713 | 3356 | `		}` |
|     3431 | 3357 | `		break;` |
|        - | 3358 | `								  }` |
|     1697 | 3359 | `	case PH7_VM_CONFIG_SERVER_ARGV: {` |
...
|     3399 | 3367 | `		pArgv   = PH7_VmExtractSuper(&(*pVm),"argv",sizeof("argv")-1);` |
|     3399 | 3368 | `		pServer = PH7_VmExtractSuper(&(*pVm),"_SERVER",sizeof("_SERVER")-1);` |
|     3394 | 3369 | `		if( pArgv == 0 \|\| (pArgv->iFlags & MEMOBJ_HASHMAP) == 0` |
|     3399 | 3370 | `		 \|\| pServer == 0 \|\| (pServer->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
|      ! 0 | 3371 | `			rc = SXERR_NOTFOUND;` |
|      ! 0 | 3372 | `			break;` |
|        - | 3373 | `		}` |
|     3399 | 3374 | `		pArgvMap   = (ph7_hashmap *)pArgv->x.pOther;` |
|     3399 | 3375 | `		pServerMap = (ph7_hashmap *)pServer->x.pOther;` |
|        - | 3376 | `		/* Deep-copy $argv so $_SERVER['argv'] is an independent array. */` |
|     3399 | 3377 | `		pDup = PH7_NewHashmap(&(*pVm),0,0);` |
|     3399 | 3378 | `		if( pDup == 0 ){` |
|      ! 0 | 3379 | `			rc = SXERR_MEM;` |
|      ! 0 | 3380 | `			break;` |
|        - | 3381 | `		}` |
|     3399 | 3382 | `		PH7_HashmapDup(pArgvMap,pDup);` |
|     3399 | 3383 | `		PH7_MemObjInitFromArray(&(*pVm),&sArgvVal,pDup);` |
|     3399 | 3384 | `		PH7_MemObjInitFromString(&(*pVm),&sKey,0);` |
|     3399 | 3385 | `		PH7_MemObjStringAppend(&sKey,"argv",sizeof("argv")-1);` |
|     3399 | 3386 | `		PH7_HashmapInsert(pServerMap,&sKey,&sArgvVal);` |
|     3399 | 3387 | `		PH7_MemObjRelease(&sArgvVal); /* drops the duplicated array */` |
|     3399 | 3388 | `		PH7_MemObjRelease(&sKey);` |
|        - | 3389 | `		/* $_SERVER['argc'] = count($argv). */` |
|     3399 | 3390 | `		PH7_MemObjInitFromInt(&(*pVm),&sCount,(sxi64)pArgvMap->nEntry);` |
|     3399 | 3391 | `		PH7_MemObjInitFromString(&(*pVm),&sKey,0);` |
|     3399 | 3392 | `		PH7_MemObjStringAppend(&sKey,"argc",sizeof("argc")-1);` |
|     3399 | 3393 | `		PH7_HashmapInsert(pServerMap,&sKey,&sCount);` |
|     3399 | 3394 | `		PH7_MemObjRelease(&sCount);` |
|     3399 | 3395 | `		PH7_MemObjRelease(&sKey);` |
|     3399 | 3396 | `		rc = SXRET_OK;` |
|     3399 | 3397 | `		break;` |
|        - | 3398 | `								  }` |
...
|      ! 0 | 3472 | `		break;` |
|        - | 3473 | `								   }` |
|     6845 | 3474 | `	case PH7_VM_CONFIG_IO_STREAM: {` |
|        - | 3475 | `		/* Register an IO stream device */` |
|    13695 | 3476 | `		const ph7_io_stream *pStream = va_arg(ap,const ph7_io_stream *);` |
|        - | 3477 | `		/* Make sure we are dealing with a valid IO stream */` |
|    13690 | 3478 | `		if( pStream == 0 \|\| pStream->zName == 0 \|\| pStream->zName[0] == 0 \|\|` |
|    13695 | 3479 | `			pStream->xOpen == 0 \|\| pStream->xRead == 0 ){` |
|        - | 3480 | `				/* Invalid stream */` |
|      ! 0 | 3481 | `				rc = SXERR_INVALID;` |
|      ! 0 | 3482 | `				break;` |
|        - | 3483 | `		}` |
|    13695 | 3484 | `		if( pVm->pDefStream == 0 && SyStrnicmp(pStream->zName,"file",sizeof("file")-1) == 0 ){` |
|        - | 3485 | `			/* Make the 'file://' stream the defaut stream device */` |
|     3427 | 3486 | `			pVm->pDefStream = pStream;` |
|     1711 | 3487 | `		}` |
|        - | 3488 | `		/* Insert in the appropriate container */` |
|    13695 | 3489 | `		rc = SySetPut(&pVm->aIOstream,(const void *)&pStream);` |
|    13695 | 3490 | `		break;` |
|        - | 3491 | `								  }` |
...
|        - | 4060 | ` */` |
|  1044107 | 4061 | `PH7_PRIVATE VmCallArgMap *VmEffCallArgMap(ph7_vm *pVm, VmInstr *pInstr,` |
|        - | 4062 | `	ph7_value *pArg, sxu32 nActual, VmCallArgMap *pStorage)` |
|        5 | 4063 | `{` |
|  1044112 | 4064 | `	VmCallArgMap *pCompile = (VmCallArgMap *)pInstr->p3;` |
|  1044112 | 4065 | `	if( pInstr->iP2 == 0 ){` |
|  1043830 | 4066 | `		return pCompile; /* no spread: compile map already aligned, nothing captured */` |
|        - | 4067 | `	}` |
...
|        - | 4408 | ` */` |
|    23820 | 4409 | `PH7_PRIVATE void VmForeachStepUnlink(ph7_foreach_info *pInfo,ph7_foreach_step *pStep)` |
|        5 | 4410 | `{` |
|    23825 | 4411 | `	ph7_foreach_step **apStep = (ph7_foreach_step **)SySetBasePtr(&pInfo->aStep);` |
|    23825 | 4412 | `	sxu32 n = SySetUsed(&pInfo->aStep);` |
|        - | 4413 | `	sxu32 i;` |
|    26001 | 4414 | `	for( i = 0 ; i < n ; ++i ){` |
|    26001 | 4415 | `		if( apStep[i] == pStep ){` |
|    23833 | 4416 | `			for( ; i + 1 < n ; ++i ){` |
|        9 | 4417 | `				apStep[i] = apStep[i + 1];` |
|        5 | 4418 | `			}` |
|    23825 | 4419 | `			(void)SySetPop(&pInfo->aStep);` |
|    23825 | 4420 | `			return;` |
|        - | 4421 | `		}` |
|     1093 | 4422 | `	}` |
|    11915 | 4423 | `}` |
...
|        - | 4442 | ` */` |
|    23584 | 4443 | `PH7_PRIVATE void VmForeachHashmapStepRelease(ph7_vm *pVm,ph7_foreach_info *pInfo,ph7_foreach_step *pStep,int bPop)` |
|        5 | 4444 | `{` |
|    23589 | 4445 | `	ph7_hashmap *pMap = pStep->xIter.pMap;` |
|    23589 | 4446 | `	PH7_HashmapUnregisterForeachStep(pMap,pStep);` |
|    23589 | 4447 | `	if( bPop ){` |
...
|    23589 | 4450 | `		VmForeachStepUnlink(pInfo,pStep);` |
|    11792 | 4451 | `	}` |
|    23589 | 4452 | `	SyMemBackendPoolFree(&pVm->sAllocator,pStep);` |
|    23589 | 4453 | `	PH7_HashmapUnref(pMap);` |
|    23589 | 4454 | `}` |
...
|        - | 4460 | ` */` |
|   137984 | 4461 | `PH7_PRIVATE sxi32 VmLocalExec(ph7_vm *pVm,SySet *pByteCode,ph7_value *pResult,int bReturnPropagates)` |
|        5 | 4462 | `{` |
|        - | 4463 | `	ph7_value *pStack;` |
|        - | 4464 | `	sxu32 nCap;` |
|        - | 4465 | `	sxi32 rc;` |
|        - | 4466 | `	/* Allocate a new operand stack */` |
|   137989 | 4467 | `	pStack = VmNewOperandStack(&(*pVm),SySetUsed(pByteCode));` |
|   137989 | 4468 | `	if( pStack == 0 ){` |
|      ! 0 | 4469 | `		return SXERR_MEM;` |
|        - | 4470 | `	}` |
|   137989 | 4471 | `	nCap = SySetUsed(pByteCode) + VM_STACK_GUARD; /* what VmNewOperandStack handed out */` |
...
|   137989 | 4474 | `	rc = VmByteCodeExec(&(*pVm),(VmInstr *)SySetBasePtr(pByteCode),pStack,-1,&(*pResult),0,FALSE,0,0,bReturnPropagates,0,&pStack,&nCap,nCap);` |
|        - | 4475 | `	/* Free the operand stack */` |
|   137989 | 4476 | `	SyMemBackendFree(&pVm->sAllocator,pStack);` |
|        - | 4477 | `	/* Execution result */` |
|   137989 | 4478 | `	return rc;` |
|    68997 | 4479 | `}` |
|        - | 4480 | `/*` |
...
|        - | 4514 | ` */` |
|     3426 | 4515 | `static void VmFlushOutputBuffers(ph7_vm *pVm)` |
|        5 | 4516 | `{` |
|     3431 | 4517 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|        - | 4518 | `	sxu32 n,nUsed;` |
|     3431 | 4519 | `	nUsed = SySetUsed(&pVm->aOB);` |
|     3431 | 4520 | `	if( nUsed < 1 ){` |
|     3429 | 4521 | `		return;` |
|        - | 4522 | `	}` |
...
|        - | 4550 | ` */` |
|     3426 | 4551 | `static void VmInvokeShutdownCallbacks(ph7_vm *pVm)` |
|        5 | 4552 | `{` |
...
|     3431 | 4558 | `	nEntry = SySetUsed(&pVm->aShutdown);` |
|    37691 | 4559 | `	for( i = 0 ; i < (int)SX_ARRAYSIZE(apArg) ; i++ ){` |
|    34265 | 4560 | `		apArg[i] = 0;` |
|    17135 | 4561 | `	}` |
...
|        - | 4565 | `	 */` |
|     3431 | 4566 | `	pVm->bHaltRequested = 0;` |
|     3449 | 4567 | `	for( n = 0 ; n < nEntry ; ++n ){` |
...
|        9 | 4594 | `		}` |
|       14 | 4595 | `	}` |
|     3431 | 4596 | `	SySetReset(&pVm->aShutdown);` |
|     3431 | 4597 | `}` |
|        - | 4598 | `/*` |
...
|        - | 4613 | `	{` |
|     3431 | 4614 | `		sxu32 nOpsCap = SySetUsed(pVm->pByteContainer) + VM_STACK_GUARD;` |
|     3431 | 4615 | `		VmByteCodeExec(&(*pVm),(VmInstr *)SySetBasePtr(pVm->pByteContainer),pVm->aOps,-1,&pVm->sExec,0,FALSE,0,0,FALSE,0,&pVm->aOps,&nOpsCap,nOpsCap);` |
|        - | 4616 | `	}` |
|        - | 4617 | `	/* Invoke any shutdown callbacks */` |
|     3431 | 4618 | `	VmInvokeShutdownCallbacks(&(*pVm));` |
...
|     3431 | 4621 | `	VmFlushOutputBuffers(&(*pVm));` |
|        - | 4622 | `	/*` |
...
|        - | 4979 | ` */` |
|     3422 | 4980 | `static sxi32 VmRegisterSpecialFunction(ph7_vm *pVm)` |
|        5 | 4981 | `{` |
|        - | 4982 | `	sxi32 rc;` |
|        - | 4983 | `	sxu32 n;` |
|   427755 | 4984 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVmFunc) ; ++n ){` |
|        - | 4985 | `		/* Note that these special functions have access` |
|        - | 4986 | `		 * to the underlying virtual machine as their` |
|        - | 4987 | `		 * private data.` |
|        - | 4988 | `		 */` |
|   424333 | 4989 | `		rc = ph7_create_function(&(*pVm),aVmFunc[n].zName,aVmFunc[n].xFunc,&(*pVm));` |
|   424333 | 4990 | `		if( rc != SXRET_OK ){` |
|      ! 0 | 4991 | `			return rc;` |
|        - | 4992 | `		}` |
|   212169 | 4993 | `	}` |
|     3427 | 4994 | `	return SXRET_OK;` |
|     1716 | 4995 | `}` |
|        - | 4996 | `/*` |
...
|        - | 5000 | ` */` |
|   770684 | 5001 | `static ph7_class * VmFilterLoadableClass(ph7_class *pClass,sxi32 iLoadable)` |
|        5 | 5002 | `{` |
|   770689 | 5003 | `	if( !iLoadable ){` |
|   764025 | 5004 | `		return pClass;` |
|        - | 5005 | `	}` |
...
|        - | 5081 | ` */` |
|   770930 | 5082 | `PH7_PRIVATE ph7_class * PH7_VmExtractClass(` |
...
|   770935 | 5098 | `	pEntry = SyHashGet(&pVm->hClass,(const void *)zName,nByte);` |
|   770935 | 5099 | `	if( pEntry == 0 ){` |
...
|        - | 5102 | `	}` |
|   770673 | 5103 | `	pClass = (ph7_class *)pEntry->pUserData;` |
|   770673 | 5104 | `	return VmFilterLoadableClass(pClass,iLoadable);` |
|   385470 | 5105 | `}` |
|        - | 5106 | `/*` |
...
|        - | 5119 | ` */` |
|  4365027 | 5120 | `static VmRefObj * VmNewRefObj(ph7_vm *pVm,sxu32 nIdx)` |
|        5 | 5121 | `{` |
|        - | 5122 | `	VmRefObj *pRef;` |
|        - | 5123 | `	/* Allocate a new instance */` |
|  4365032 | 5124 | `	pRef = (VmRefObj *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmRefObj));` |
|  4365032 | 5125 | `	if( pRef == 0 ){` |
|      ! 0 | 5126 | `		return 0;` |
|        - | 5127 | `	}` |
|        - | 5128 | `	/* Zero the structure */` |
|  4365032 | 5129 | `	SyZero(pRef,sizeof(VmRefObj));` |
|        - | 5130 | `	/* Initialize fields */` |
|  4365032 | 5131 | `	SySetInit(&pRef->aReference,&pVm->sAllocator,sizeof(SyHashEntry *));` |
|  4365032 | 5132 | `	SySetInit(&pRef->aArrEntries,&pVm->sAllocator,sizeof(ph7_hashmap_node *));` |
|  4365032 | 5133 | `	pRef->nIdx = nIdx;` |
|  4365032 | 5134 | `	return pRef;` |
|  2183133 | 5135 | `}` |
|        - | 5136 | `/*` |
|        - | 5137 | ` * Default hash function used by the reference table` |
|        - | 5138 | ` * for lookup/insertion operations.` |
|        - | 5139 | ` */` |
| 23450583 | 5140 | `static sxu32 VmRefHash(sxu32 nIdx)` |
|        5 | 5141 | `{` |
|        - | 5142 | `	/* Calculate the hash based on the memory object index */` |
| 23450588 | 5143 | `	return nIdx ^ (nIdx << 8) ^ (nIdx >> 8);` |
|        5 | 5144 | `}` |
|        - | 5145 | `/*` |
...
|        - | 5155 | ` * extension.` |
|        - | 5156 | ` */` |
| 13560539 | 5157 | `PH7_PRIVATE VmRefObj * VmRefObjExtract(ph7_vm *pVm,sxu32 nObjIdx)` |
|        5 | 5158 | `{` |
|        - | 5159 | `	VmRefObj *pRef;` |
|        - | 5160 | `	sxu32 nBucket;` |
|        - | 5161 | `	/* Point to the appropriate bucket */` |
| 13560544 | 5162 | `	nBucket = VmRefHash(nObjIdx) & (pVm->nRefSize - 1);` |
|        - | 5163 | `	/* Perform the lookup */` |
| 13560544 | 5164 | `	pRef = pVm->apRefObj[nBucket];` |
| 29860715 | 5165 | `	for(;;){` |
| 59727456 | 5166 | `		if( pRef == 0 ){` |
|  4854232 | 5167 | `			break;` |
|        - | 5168 | `		}` |
| 54873229 | 5169 | `		if( pRef->nIdx == nObjIdx ){` |
|        - | 5170 | `			/* Entry found */` |
|  8706317 | 5171 | `			return pRef;` |
|        - | 5172 | `		}` |
|        - | 5173 | `		/* Point to the next entry */` |
| 46166917 | 5174 | `		pRef = pRef->pNextCollide;` |
|        5 | 5175 | `	}` |
|        - | 5176 | `	/* No such entry,return NULL */` |
|  4854232 | 5177 | `	return 0;` |
|  6782118 | 5178 | `}` |
|        - | 5179 | `/*` |
...
|        - | 5187 | ` * extension.` |
|        - | 5188 | ` */` |
|  4365027 | 5189 | `static sxi32 VmRefObjInsert(ph7_vm *pVm,VmRefObj *pRef)` |
|        5 | 5190 | `{` |
|        - | 5191 | `	sxu32 nBucket;` |
|  4365032 | 5192 | `	if( pVm->nRefUsed * 3 >= pVm->nRefSize ){` |
|        - | 5193 | `		VmRefObj **apNew;` |
|        - | 5194 | `		sxu32 nNew;` |
|        - | 5195 | `		/* Allocate a larger table */` |
|    10597 | 5196 | `		nNew = pVm->nRefSize << 1;` |
|    10597 | 5197 | `		apNew = (VmRefObj **)SyMemBackendAlloc(&pVm->sAllocator,sizeof(VmRefObj *) * nNew);` |
|    10597 | 5198 | `		if( apNew ){` |
|    10597 | 5199 | `			VmRefObj *pEntry = pVm->pRefList;` |
|        - | 5200 | `			sxu32 n;` |
|        - | 5201 | `			/* Zero the structure */` |
|    10597 | 5202 | `			SyZero((void *)apNew,nNew * sizeof(VmRefObj *));` |
|        - | 5203 | `			/* Rehash all referenced entries */` |
|  2967241 | 5204 | `			for( n = 0 ; n < pVm->nRefUsed ; ++n ){` |
|        - | 5205 | `				/* Remove old collision links */` |
|  2956649 | 5206 | `				pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|        - | 5207 | `				/* Point to the appropriate bucket */` |
|  2956649 | 5208 | `				nBucket = VmRefHash(pEntry->nIdx) & (nNew - 1);` |
|        - | 5209 | `				/* Insert the entry  */` |
|  2956649 | 5210 | `				pEntry->pNextCollide = apNew[nBucket];` |
|  2956649 | 5211 | `				if( apNew[nBucket] ){` |
|  2306069 | 5212 | `					apNew[nBucket]->pPrevCollide = pEntry;` |
|  1153032 | 5213 | `				}` |
|  2956649 | 5214 | `				apNew[nBucket] = pEntry;` |
|        - | 5215 | `				/* Point to the next entry */` |
|  2956649 | 5216 | `				pEntry = pEntry->pNext;` |
|  1478327 | 5217 | `			}` |
|        - | 5218 | `			/* Release the old table */` |
|    10597 | 5219 | `			SyMemBackendFree(&pVm->sAllocator,pVm->apRefObj);` |
|        - | 5220 | `			/* Install the new one */` |
|    10597 | 5221 | `			pVm->apRefObj = apNew;` |
|    10597 | 5222 | `			pVm->nRefSize = nNew;` |
|     5296 | 5223 | `		}` |
|     5296 | 5224 | `	}` |
|        - | 5225 | `	/* Point to the appropriate bucket */` |
|  4365032 | 5226 | `	nBucket = VmRefHash(pRef->nIdx) & (pVm->nRefSize - 1);` |
|        - | 5227 | `	/* Insert the entry */` |
|  4365032 | 5228 | `	pRef->pNextCollide = pVm->apRefObj[nBucket];` |
|  4365032 | 5229 | `	if( pVm->apRefObj[nBucket] ){` |
|  3360249 | 5230 | `		pVm->apRefObj[nBucket]->pPrevCollide = pRef;` |
|  1680661 | 5231 | `	}` |
|  4365032 | 5232 | `	pVm->apRefObj[nBucket] = pRef;` |
|  4365032 | 5233 | `	MACRO_LD_PUSH(pVm->pRefList,pRef);` |
|  4365032 | 5234 | `	pVm->nRefUsed++;` |
|  4365032 | 5235 | `	return SXRET_OK;` |
|        5 | 5236 | `}` |
|        - | 5237 | `/*` |
...
|        - | 5247 | ` * extension.` |
|        - | 5248 | ` */` |
|  4230989 | 5249 | `PH7_PRIVATE sxi32 VmRefObjUnlink(ph7_vm *pVm,VmRefObj *pRef)` |
|        5 | 5250 | `{` |
|        - | 5251 | `	ph7_hashmap_node **apNode;` |
|        - | 5252 | `	SyHashEntry **apEntry;` |
|        - | 5253 | `	sxu32 n;` |
|        - | 5254 | `	/* Point to the reference table */` |
|  4230994 | 5255 | `	apNode = (ph7_hashmap_node **)SySetBasePtr(&pRef->aArrEntries);` |
|  4230994 | 5256 | `	apEntry = (SyHashEntry **)SySetBasePtr(&pRef->aReference);` |
|        - | 5257 | `	/* Unlink the entry from the reference table */` |
|  4726298 | 5258 | `	for( n = 0 ; n < SySetUsed(&pRef->aReference) ; n++ ){` |
|   495309 | 5259 | `		if( apEntry[n] ){` |
|   489429 | 5260 | `			SyHashDeleteEntry2(apEntry[n]);` |
|   245327 | 5261 | `		}` |
|   248272 | 5262 | `	}` |
|  7951209 | 5263 | `	for(n = 0 ; n < SySetUsed(&pRef->aArrEntries) ; ++n ){` |
|  3720220 | 5264 | `		if( apNode[n] ){` |
|     1380 | 5265 | `			PH7_HashmapUnlinkNode(apNode[n],FALSE);` |
|      688 | 5266 | `		}` |
|  1860112 | 5267 | `	}` |
|  4230994 | 5268 | `	if( pRef->pPrevCollide ){` |
|  1662621 | 5269 | `		pRef->pPrevCollide->pNextCollide = pRef->pNextCollide;` |
|   830885 | 5270 | `	}else{` |
|  2568378 | 5271 | `		pVm->apRefObj[VmRefHash(pRef->nIdx) & (pVm->nRefSize - 1)] = pRef->pNextCollide;` |
|        - | 5272 | `	}` |
|  4230994 | 5273 | `	if( pRef->pNextCollide ){` |
|  2247839 | 5274 | `		pRef->pNextCollide->pPrevCollide = pRef->pPrevCollide;` |
|  1124467 | 5275 | `	}` |
|  4230994 | 5276 | `	MACRO_LD_REMOVE(pVm->pRefList,pRef);` |
|        - | 5277 | `	/* Release the node */` |
|  4230994 | 5278 | `	SySetRelease(&pRef->aReference);` |
|  4230994 | 5279 | `	SySetRelease(&pRef->aArrEntries);` |
|  4230994 | 5280 | `	SyMemBackendPoolFree(&pVm->sAllocator,pRef);` |
|  4230994 | 5281 | `	pVm->nRefUsed--;` |
|  4230994 | 5282 | `	return SXRET_OK;` |
|        5 | 5283 | `}` |
|        - | 5284 | `/*` |
...
|        - | 5291 | ` * extension.` |
|        - | 5292 | ` */` |
|  4411727 | 5293 | `PH7_PRIVATE sxi32 PH7_VmRefObjInstall(` |
...
|        - | 5299 | `	)` |
|        5 | 5300 | `{` |
|  4411732 | 5301 | `	VmFrame *pFrame = pVm->pFrame;` |
|        - | 5302 | `	VmRefObj *pRef;` |
|        - | 5303 | `	/* Check if the referenced object already exists */` |
|  4411732 | 5304 | `	pRef = VmRefObjExtract(&(*pVm),nIdx);` |
|  4411732 | 5305 | `	if( pRef == 0 ){` |
|        - | 5306 | `		/* Create a new entry */` |
|  4365032 | 5307 | `		pRef = VmNewRefObj(&(*pVm),nIdx);` |
|  4365032 | 5308 | `		if( pRef == 0 ){` |
|      ! 0 | 5309 | `			return SXERR_MEM;` |
|        - | 5310 | `		}` |
|  4365032 | 5311 | `		pRef->iFlags = iFlags;` |
|        - | 5312 | `		/* Install the entry */` |
|  4365032 | 5313 | `		VmRefObjInsert(&(*pVm),pRef);` |
|  2183128 | 5314 | `	}` |
|  4411732 | 5315 | `	pFrame = VmSkipExceptionFrames(pFrame);` |
|  4411732 | 5316 | `	if( pFrame->pParent != 0 && pEntry ){` |
|        - | 5317 | `		VmSlot sRef;` |
|        - | 5318 | `		/* Local frame,record referenced entry so that it can` |
|        - | 5319 | `		 * be deleted when we leave this frame.` |
|        - | 5320 | `		 */` |
|   489403 | 5321 | `		sRef.nIdx = nIdx;` |
|   489403 | 5322 | `		sRef.pUserData = pEntry;` |
|   489403 | 5323 | `		if( SXRET_OK != SySetPut(&pFrame->sRef,(const void *)&sRef)) {` |
|      ! 0 | 5324 | `			pEntry = 0; /* Do not record this entry */` |
|      ! 0 | 5325 | `		}` |
|   245314 | 5326 | `	}` |
|  4411732 | 5327 | `	if( pEntry ){` |
|        - | 5328 | `		/* Address of the hash-entry */` |
|   535845 | 5329 | `		SySetPut(&pRef->aReference,(const void *)&pEntry);` |
|   268535 | 5330 | `	}` |
|  4411732 | 5331 | `	if( pMapEntry ){` |
|        - | 5332 | `		/* Address of the hashmap node [i.e: Array entry] */` |
|  3822418 | 5333 | `		SySetPut(&pRef->aArrEntries,(const void *)&pMapEntry);` |
|  1911206 | 5334 | `	}` |
|  4411732 | 5335 | `	return SXRET_OK;` |
|  2206483 | 5336 | `}` |
|        - | 5337 | `/*` |
...
|        - | 5344 | ` * extension.` |
|        - | 5345 | ` */` |
|  4202327 | 5346 | `PH7_PRIVATE sxi32 PH7_VmRefObjRemove(` |
...
|  4202332 | 5356 | `	pRef = VmRefObjExtract(&(*pVm),nIdx);` |
|  4202332 | 5357 | `	if( pRef == 0 ){` |
|        - | 5358 | `		/* Not such entry */` |
|   489205 | 5359 | `		return SXERR_NOTFOUND;` |
|        - | 5360 | `	}` |
|        - | 5361 | `	/* Remove the desired entry */` |
|  3713132 | 5362 | `	if( pEntry ){` |
...
|       95 | 5375 | `		}` |
|       41 | 5376 | `	}` |
|  3713132 | 5377 | `	if( pMapEntry ){` |
|        - | 5378 | `		ph7_hashmap_node **apNode;` |
|  3713050 | 5379 | `		apNode = (ph7_hashmap_node **)SySetBasePtr(&pRef->aArrEntries);` |
|  7426359 | 5380 | `		for(n = 0 ; n < SySetUsed(&pRef->aArrEntries) ; n++ ){` |
|  3713314 | 5381 | `			if( apNode[n] == pMapEntry ){` |
|        - | 5382 | `				/* nullify the entry */` |
|  3713050 | 5383 | `				apNode[n] = 0;` |
|  1856522 | 5384 | `			}` |
|  1856659 | 5385 | `		}` |
|  1856522 | 5386 | `	}` |
|  3713132 | 5387 | `	return SXRET_OK;` |
|  2101783 | 5388 | `}` |
...
|        - | 5397 | ` */` |
|    30192 | 5398 | `PH7_PRIVATE const ph7_io_stream * PH7_VmGetStreamDevice(` |
...
|    30197 | 5410 | `	zNext = zCur = zIn = *pzDevice;` |
|    30197 | 5411 | `	zEnd = &zIn[nByte];` |
|  1914342 | 5412 | `	while( zIn < zEnd ){` |
|  1884180 | 5413 | `		if( zIn < &zEnd[-3]/*://*/ && zIn[0] == ':' && zIn[1] == '/' && zIn[2] == '/' ){` |
|        - | 5414 | `			/* Got one */` |
...
|  1884150 | 5419 | `		zIn++;` |
|        5 | 5420 | `	}` |
|    30197 | 5421 | `	if( zIn >= zEnd ){` |
|        - | 5422 | `		/* No such scheme,return the default stream */` |
|    30167 | 5423 | `		return pVm->pDefStream;` |
|        - | 5424 | `	}` |
