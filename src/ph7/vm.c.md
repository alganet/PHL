...
|        - |   114 | ` */` |
|   520472 |   115 | `static sxi32 VmIsUnorderedCmp(ph7_value *pLeft,ph7_value *pRight)` |
|        2 |   116 |  |
|   520474 |   117 | `	if( (pLeft->iFlags & MEMOBJ_REAL) && PH7_IS_NAN(pLeft->rVal) ){` |
|       23 |   118 | `		return TRUE;` |
|        - |   119 | `	}` |
|   520452 |   120 | `	if( (pRight->iFlags & MEMOBJ_REAL) && PH7_IS_NAN(pRight->rVal) ){` |
|        9 |   121 | `		return TRUE;` |
|        - |   122 | `	}` |
|   520444 |   123 | `	return FALSE;` |
|   260260 |   124 |  |
|        - |   125 | `/*` |
...
|        - |   182 | ` */` |
|   214542 |   183 | `PH7_PRIVATE sxi32 PH7_VmRegisterConstant(` |
...
|        - |   192 | `	char *zDupName;` |
|        - |   193 | `	sxi32 rc;` |
|   214544 |   194 | `	pEntry = SyHashGet(&pVm->hConstant,(const void *)pName->zString,pName->nByte);` |
|   214544 |   195 | `	if( pEntry ){` |
...
|   214540 |   203 | `	pCons = (ph7_constant *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_constant));` |
|   214540 |   204 | `	if( pCons == 0 ){` |
|      ! 0 |   205 | `		return 0;` |
|        - |   206 | `	}` |
|        - |   207 | `	/* Duplicate constant name */` |
|   214540 |   208 | `	zDupName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|   214540 |   209 | `	if( zDupName == 0 ){` |
|      ! 0 |   210 | `		SyMemBackendPoolFree(&pVm->sAllocator,pCons);` |
|      ! 0 |   211 | `		return 0;` |
|        - |   212 | `	}` |
|        - |   213 | `	/* Install the constant */` |
|   214540 |   214 | `	SyStringInitFromBuf(&pCons->sName,zDupName,pName->nByte);` |
|   214540 |   215 | `	pCons->xExpand = xExpand;` |
|   214540 |   216 | `	pCons->pUserData = pUserData;` |
|   214540 |   217 | `	rc = SyHashInsert(&pVm->hConstant,(const void *)zDupName,SyStringLength(&pCons->sName),pCons);` |
|   214540 |   218 | `	if( rc != SXRET_OK ){` |
...
|        - |   232 | ` */` |
|   461970 |   233 | `static sxi32 PH7_NewForeignFunction(` |
...
|   461972 |   244 | `	pFunc = (ph7_user_func *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_user_func));` |
|   461972 |   245 | `	if( pFunc == 0 ){` |
|      ! 0 |   246 | `		return SXERR_MEM;` |
|        - |   247 | `	}` |
|        - |   248 | `	/* Duplicate function name */` |
|   461972 |   249 | `	zDup = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|   461972 |   250 | `	if( zDup == 0 ){` |
|      ! 0 |   251 | `		SyMemBackendPoolFree(&pVm->sAllocator,pFunc);` |
|      ! 0 |   252 | `		return SXERR_MEM;` |
|        - |   253 | `	}` |
|        - |   254 | `	/* Zero the structure */` |
|   461972 |   255 | `	SyZero(pFunc,sizeof(ph7_user_func));` |
|        - |   256 | `	/* Initialize structure fields */` |
|   461972 |   257 | `	SyStringInitFromBuf(&pFunc->sName,zDup,pName->nByte);` |
|   461972 |   258 | `	pFunc->pVm   = pVm;` |
|   461972 |   259 | `	pFunc->xFunc = xFunc;` |
|   461972 |   260 | `	pFunc->pUserData = pUserData;` |
|   461972 |   261 | `	SySetInit(&pFunc->aAux,&pVm->sAllocator,sizeof(ph7_aux_data));` |
|        - |   262 | `	/* Write a pointer to the new function */` |
|   461972 |   263 | `	*ppOut = pFunc;` |
|   461972 |   264 | `	return SXRET_OK;` |
|   230987 |   265 |  |
|        - |   266 | `/*` |
...
|        - |   273 | ` */` |
|   463032 |   274 | `PH7_PRIVATE sxi32 PH7_VmInstallForeignFunction(` |
...
|   463034 |   285 | `	pEntry = SyHashGet(&pVm->hHostFunction,pName->zString,pName->nByte);` |
|   463034 |   286 | `	if( pEntry ){` |
|     1064 |   287 | `		pFunc = (ph7_user_func *)pEntry->pUserData;` |
|     1064 |   288 | `		pFunc->pUserData = pUserData;` |
|     1064 |   289 | `		pFunc->xFunc = xFunc;` |
|     1064 |   290 | `		SySetReset(&pFunc->aAux);` |
|     1064 |   291 | `		return SXRET_OK;` |
|        - |   292 | `	}` |
|        - |   293 | `	/* Create a new user function */` |
|   461972 |   294 | `	rc = PH7_NewForeignFunction(&(*pVm),&(*pName),xFunc,pUserData,&pFunc);` |
|   461972 |   295 | `	if( rc != SXRET_OK ){` |
|      ! 0 |   296 | `		return rc;` |
|        - |   297 | `	}` |
|        - |   298 | `	/* Install the function in the corresponding hashtable */` |
|   461972 |   299 | `	rc = SyHashInsert(&pVm->hHostFunction,SyStringData(&pFunc->sName),pName->nByte,pFunc);` |
|   461972 |   300 | `	if( rc != SXRET_OK ){` |
...
|   461972 |   306 | `	return SXRET_OK;` |
|   231518 |   307 |  |
|        - |   308 | `/*` |
|        - |   309 | ` * Initialize a VM function.` |
|        - |   310 | ` */` |
|    56052 |   311 | `PH7_PRIVATE sxi32 PH7_VmInitFuncState(` |
...
|    56054 |   321 | `	SyZero(pFunc,sizeof(ph7_vm_func));` |
|        - |   322 | `	/* Initialize structure fields */` |
|        - |   323 | `	/* Arguments container */` |
|    56054 |   324 | `	SySetInit(&pFunc->aArgs,&pVm->sAllocator,sizeof(ph7_vm_func_arg));` |
|        - |   325 | `	/* Static variable container */` |
|    56054 |   326 | `	SySetInit(&pFunc->aStatic,&pVm->sAllocator,sizeof(ph7_vm_func_static_var));` |
|        - |   327 | `	/* Bytecode container */` |
|    56054 |   328 | `	SySetInit(&pFunc->aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|        - |   329 | `    /* Preallocate some instruction slots */` |
|    56054 |   330 | `	SySetAlloc(&pFunc->aByteCode,0x10);` |
|        - |   331 | `	/* Closure environment */` |
|    56054 |   332 | `	SySetInit(&pFunc->aClosureEnv,&pVm->sAllocator,sizeof(ph7_vm_func_closure_env));` |
|    56054 |   333 | `	pFunc->iFlags = iFlags;` |
|    56054 |   334 | `	pFunc->pUserData = pUserData;` |
|    56054 |   335 | `	SyStringInitFromBuf(&pFunc->sName,zName,nByte);` |
|    56054 |   336 | `	return SXRET_OK;` |
|        2 |   337 |  |
|        - |   338 | `/*` |
|        - |   339 | ` * Install a user defined function in the corresponding VM container.` |
|        - |   340 | ` */` |
|   172620 |   341 | `PH7_PRIVATE sxi32 PH7_VmInstallUserFunction(` |
...
|        - |   348 | `	sxi32 rc;` |
|   172622 |   349 | `	if( pName == 0 ){` |
|        - |   350 | `		/* Use the built-in name */` |
|    17562 |   351 | `		pName = &pFunc->sName;` |
|     8780 |   352 | `	}` |
|        - |   353 | `	/* Check for duplicates (functions with the same name) first */` |
|   172622 |   354 | `	pEntry = SyHashGet(&pVm->hFunction,pName->zString,pName->nByte);` |
|   172622 |   355 | `	if( pEntry ){` |
|   127336 |   356 | `		ph7_vm_func *pLink = (ph7_vm_func *)pEntry->pUserData;` |
|   127336 |   357 | `		if( pLink != pFunc ){` |
|        - |   358 | `			/* Link */` |
|      179 |   359 | `			pFunc->pNextName = pLink;` |
|      179 |   360 | `			pEntry->pUserData = pFunc;` |
|       89 |   361 | `		}` |
|   127336 |   362 | `		return SXRET_OK;` |
|        - |   363 | `	}` |
|        - |   364 | `	/* First time seen */` |
|    45288 |   365 | `	pFunc->pNextName = 0;` |
|    45288 |   366 | `	rc = SyHashInsert(&pVm->hFunction,pName->zString,pName->nByte,pFunc);` |
|    45288 |   367 | `	return rc;` |
|    86312 |   368 |  |
|        - |   369 | `/*` |
|        - |   370 | ` * Install a user defined class in the corresponding VM container.` |
|        - |   371 | ` */` |
|    14774 |   372 | `PH7_PRIVATE sxi32 PH7_VmInstallClass(` |
|        - |   373 | `	ph7_vm *pVm,      /* Target VM  */` |
|        - |   374 | `	ph7_class *pClass /* Target Class */` |
|        - |   375 | `	)` |
|        2 |   376 |  |
|    14776 |   377 | `	SyString *pName = &pClass->sName;` |
|        - |   378 | `	SyHashEntry *pEntry;` |
|        - |   379 | `	sxi32 rc;` |
|        - |   380 | `	/* Check for duplicates */` |
|    14776 |   381 | `	pEntry = SyHashGet(&pVm->hClass,(const void *)pName->zString,pName->nByte);` |
|    14776 |   382 | `	if( pEntry ){` |
|       33 |   383 | `		ph7_class *pLink = (ph7_class *)pEntry->pUserData;` |
|        - |   384 | `		/* Link entry with the same name */` |
|       33 |   385 | `		pClass->pNextName = pLink;` |
|       33 |   386 | `		pEntry->pUserData = pClass;` |
|       33 |   387 | `		return SXRET_OK;` |
|        - |   388 | `	}` |
|    14744 |   389 | `	pClass->pNextName = 0;` |
|        - |   390 | `	/* Perform a simple hashtable insertion */` |
|    14744 |   391 | `	rc = SyHashInsert(&pVm->hClass,(const void *)pName->zString,pName->nByte,pClass);` |
|    14744 |   392 | `	return rc;` |
|     7389 |   393 |  |
|        - |   394 | `/*` |
|        - |   395 | ` * Instruction builder interface.` |
|        - |   396 | ` */` |
|  1407568 |   397 | `PH7_PRIVATE sxi32 PH7_VmEmitInstr(` |
...
|  1407570 |   409 | `	sInstr.iOp = (sxu8)iOp;` |
|  1407570 |   410 | `	sInstr.iP1 = iP1;` |
|  1407570 |   411 | `	sInstr.iP2 = iP2;` |
|  1407570 |   412 | `	sInstr.p3  = p3;` |
|  1407570 |   413 | `	if( pIndex ){` |
|        - |   414 | `		/* Instruction index in the bytecode array */` |
|    84612 |   415 | `		*pIndex = SySetUsed(pVm->pByteContainer);` |
|    42305 |   416 | `	}` |
|        - |   417 | `	/* Finally,record the instruction */` |
|  1407570 |   418 | `	rc = SySetPut(pVm->pByteContainer,(const void *)&sInstr);` |
|  1407570 |   419 | `	if( rc != SXRET_OK ){` |
|      ! 0 |   420 | `		PH7_GenCompileError(&pVm->sCodeGen,E_ERROR,1,"Fatal,Cannot emit instruction due to a memory failure");` |
|        - |   421 | `		/* Fall throw */` |
|      ! 0 |   422 | `	}` |
|  1407570 |   423 | `	return rc;` |
|        2 |   424 |  |
|        - |   425 | `/*` |
|        - |   426 | ` * Swap the current bytecode container with the given one.` |
|        - |   427 | ` */` |
|   136364 |   428 | `PH7_PRIVATE sxi32 PH7_VmSetByteCodeContainer(ph7_vm *pVm,SySet *pContainer)` |
|        2 |   429 |  |
|   136366 |   430 | `	if( pContainer == 0 ){` |
|        - |   431 | `		/* Point to the default container */` |
|      ! 0 |   432 | `		pVm->pByteContainer = &pVm->aByteCode;` |
|      ! 0 |   433 | `	}else{` |
|        - |   434 | `		/* Change container */` |
|   136366 |   435 | `		pVm->pByteContainer = &(*pContainer);` |
|        - |   436 | `	}` |
|   136366 |   437 | `	return SXRET_OK;` |
|        2 |   438 |  |
|        - |   439 | `/*` |
|        - |   440 | ` * Return the current bytecode container.` |
|        - |   441 | ` */` |
|    68182 |   442 | `PH7_PRIVATE SySet * PH7_VmGetByteCodeContainer(ph7_vm *pVm)` |
|        2 |   443 |  |
|    68184 |   444 | `	return pVm->pByteContainer;` |
|        2 |   445 |  |
|        - |   446 | `/*` |
|        - |   447 | ` * Extract the VM instruction rooted at nIndex.` |
|        - |   448 | ` */` |
|    83214 |   449 | `PH7_PRIVATE VmInstr * PH7_VmGetInstr(ph7_vm *pVm,sxu32 nIndex)` |
|        2 |   450 |  |
|        - |   451 | `	VmInstr *pInstr;` |
|    83216 |   452 | `	pInstr = (VmInstr *)SySetAt(pVm->pByteContainer,nIndex);` |
|    83216 |   453 | `	return pInstr;` |
|        2 |   454 |  |
|        - |   455 | `/*` |
|        - |   456 | ` * Return the total number of VM instructions recorded so far.` |
|        - |   457 | ` */` |
|   407938 |   458 | `PH7_PRIVATE sxu32 PH7_VmInstrLength(ph7_vm *pVm)` |
|        2 |   459 |  |
|   407940 |   460 | `	return SySetUsed(pVm->pByteContainer);` |
|        2 |   461 |  |
|        - |   462 | `/*` |
|        - |   463 | ` * Pop the last VM instruction.` |
|        - |   464 | ` */` |
|    79824 |   465 | `PH7_PRIVATE VmInstr * PH7_VmPopInstr(ph7_vm *pVm)` |
|        2 |   466 |  |
|    79826 |   467 | `	return (VmInstr *)SySetPop(pVm->pByteContainer);` |
|        2 |   468 |  |
|        - |   469 | `/*` |
|        - |   470 | ` * Peek the last VM instruction.` |
|        - |   471 | ` */` |
|   213496 |   472 | `PH7_PRIVATE VmInstr * PH7_VmPeekInstr(ph7_vm *pVm)` |
|        2 |   473 |  |
|   213498 |   474 | `	return (VmInstr *)SySetPeek(pVm->pByteContainer);` |
|        2 |   475 |  |
|     2862 |   476 | `PH7_PRIVATE VmInstr * PH7_VmPeekNextInstr(ph7_vm *pVm)` |
|        2 |   477 |  |
|        - |   478 | `	VmInstr *aInstr;` |
|        - |   479 | `	sxu32 n;` |
|     2864 |   480 | `	n = SySetUsed(pVm->pByteContainer);` |
|     2864 |   481 | `	if( n < 2 ){` |
|      ! 0 |   482 | `		return 0;` |
|        - |   483 | `	}` |
|     2864 |   484 | `	aInstr = (VmInstr *)SySetBasePtr(pVm->pByteContainer);` |
|     2864 |   485 | `	return &aInstr[n - 2];` |
|     1433 |   486 |  |
|        - |   487 | `/*` |
|        - |   488 | ` * Allocate a new virtual machine frame.` |
|        - |   489 | ` */` |
|     9422 |   490 | `static VmFrame * VmNewFrame(` |
...
|     9424 |   498 | `	pFrame = (VmFrame *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmFrame));` |
|     9424 |   499 | `	if( pFrame == 0 ){` |
|      ! 0 |   500 | `		return 0;` |
|        - |   501 | `	}` |
|        - |   502 | `	/* Zero the structure */` |
|     9424 |   503 | `	SyZero(pFrame,sizeof(VmFrame));` |
|        - |   504 | `	/* Initialize frame fields */` |
|     9424 |   505 | `	pFrame->pUserData = pUserData;` |
|     9424 |   506 | `	pFrame->pThis = pThis;` |
|     9424 |   507 | `	pFrame->pVm = pVm;` |
|     9424 |   508 | `	SyHashInit(&pFrame->hVar,&pVm->sAllocator,0,0);` |
|     9424 |   509 | `	SySetInit(&pFrame->sArg,&pVm->sAllocator,sizeof(VmSlot));` |
|     9424 |   510 | `	SySetInit(&pFrame->sLocal,&pVm->sAllocator,sizeof(VmSlot));` |
|     9424 |   511 | `	SySetInit(&pFrame->sRef,&pVm->sAllocator,sizeof(VmSlot));` |
|     9424 |   512 | `	return pFrame;` |
|     4713 |   513 |  |
|        - |   514 | `/*` |
|        - |   515 | ` * Enter a VM frame.` |
|        - |   516 | ` */` |
|     9422 |   517 | `static sxi32 VmEnterFrame(` |
...
|     9424 |   526 | `	pFrame = VmNewFrame(&(*pVm),pUserData,pThis);` |
|     9424 |   527 | `	if( pFrame == 0 ){` |
|      ! 0 |   528 | `		return SXERR_MEM;` |
|        - |   529 | `	}` |
|        - |   530 | `	/* Link to the list of active VM frame */` |
|     9424 |   531 | `	pFrame->pParent = pVm->pFrame;` |
|     9424 |   532 | `	pVm->pFrame = pFrame;` |
|     9424 |   533 | `	if( ppFrame ){` |
|        - |   534 | `		/* Write a pointer to the new VM frame */` |
|     8104 |   535 | `		*ppFrame = pFrame;` |
|     4051 |   536 | `	}` |
|     9424 |   537 | `	return SXRET_OK;` |
|     4713 |   538 |  |
|        - |   539 | `/*` |
...
|        - |   584 | ` */` |
|     8100 |   585 | `static void VmLeaveFrame(ph7_vm *pVm)` |
|        2 |   586 |  |
|     8102 |   587 | `		VmFrame *pCurFrame = pVm->pFrame;` |
|     8102 |   588 | `	if( pCurFrame ){` |
|        - |   589 | `		/* Unlink from the list of active VM frame */` |
|     8102 |   590 | `		pVm->pFrame = pCurFrame->pParent;` |
|     8102 |   591 | `		if( pCurFrame->pParent && (pCurFrame->iFlags & VM_FRAME_EXCEPTION) == 0 ){` |
|        - |   592 | `			VmSlot  *aSlot;` |
|        - |   593 | `			sxu32 n;` |
|        - |   594 | `			/* Restore local variable to the free pool so that they can be reused again */` |
|     8084 |   595 | `			aSlot = (VmSlot *)SySetBasePtr(&pCurFrame->sLocal);` |
|    59928 |   596 | `			for(n = 0 ; n < SySetUsed(&pCurFrame->sLocal) ; ++n ){` |
|        - |   597 | `				/* Unset the local variable */` |
|    51846 |   598 | `				PH7_VmUnsetMemObj(&(*pVm),aSlot[n].nIdx,FALSE);` |
|    25924 |   599 | `			}` |
|        - |   600 | `			/* Remove local reference */` |
|     8084 |   601 | `			aSlot = (VmSlot *)SySetBasePtr(&pCurFrame->sRef);` |
|    59962 |   602 | `			for(n = 0 ; n < SySetUsed(&pCurFrame->sRef) ; ++n ){` |
|    51880 |   603 | `				PH7_VmRefObjRemove(&(*pVm),aSlot[n].nIdx,(SyHashEntry *)aSlot[n].pUserData,0);` |
|    25941 |   604 | `			}` |
|     4041 |   605 | `		}` |
|        - |   606 | `		/* Release internal containers */` |
|     8102 |   607 | `		SyHashRelease(&pCurFrame->hVar);` |
|     8102 |   608 | `		SySetRelease(&pCurFrame->sArg);` |
|     8102 |   609 | `		SySetRelease(&pCurFrame->sLocal);` |
|     8102 |   610 | `		SySetRelease(&pCurFrame->sRef);` |
|        - |   611 | `		/* Release the whole structure */` |
|     8102 |   612 | `		SyMemBackendPoolFree(&pVm->sAllocator,pCurFrame);` |
|     4050 |   613 | `	}` |
|     8102 |   614 |  |
|        - |   615 | `/*` |
...
|        - |   731 | ` */` |
|    55232 |   732 | `PH7_PRIVATE sxi32 VmMountUserClass(` |
...
|    55234 |   742 | `	SyHashResetLoopCursor(&pClass->hAttr);` |
|        - |   743 | `	/* Process only static and constant attribute */` |
|   179608 |   744 | `	while( (pEntry = SyHashGetNextEntry(&pClass->hAttr)) != 0 ){` |
|        - |   745 | `		/* Extract the current attribute */` |
|    96760 |   746 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|    96760 |   747 | `		if( pAttr->iFlags & (PH7_CLASS_ATTR_CONSTANT\|PH7_CLASS_ATTR_STATIC) ){` |
...
|    55234 |   769 | `	if( pClass->iFlags & PH7_CLASS_INTERFACE ){` |
|        - |   770 | `		/* Do not mount interface methods since they are signatures only.` |
|        - |   771 | `		 */` |
|    35948 |   772 | `		return SXRET_OK;` |
|        - |   773 | `	}` |
|        - |   774 | `	/* Create constructor alias if not yet done */` |
|    19288 |   775 | `	if( SyHashGet(&pClass->hMethod,"__construct",sizeof("__construct")-1) == 0 ){` |
...
|    19288 |   785 | `	SyHashResetLoopCursor(&pClass->hMethod);` |
|   183997 |   786 | `	while((pEntry = SyHashGetNextEntry(&pClass->hMethod)) != 0 ){` |
|   155068 |   787 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|   155068 |   788 | `		if( (pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT) == 0 ){` |
|   155062 |   789 | `			rc = PH7_VmInstallUserFunction(&(*pVm),&pMeth->sFunc,&pMeth->sVmName);` |
|   155062 |   790 | `			if( rc != SXRET_OK ){` |
|      ! 0 |   791 | `				return rc;` |
|        - |   792 | `			}` |
|    77530 |   793 | `		}` |
|        2 |   794 | `	}` |
|        - |   795 | `	/* Mark class as mounted to avoid redundant mounting */` |
|    19288 |   796 | `	pClass->bMounted = TRUE;` |
|    19288 |   797 | `	return SXRET_OK;` |
|    27618 |   798 |  |
|        - |   799 | `/*` |
|        - |   800 | ` * Allocate a private frame for attributes of the given` |
|        - |   801 | ` * class instance (Object in the PHP jargon).` |
|        - |   802 | ` */` |
|      616 |   803 | `PH7_PRIVATE sxi32 PH7_VmCreateClassInstanceFrame(` |
|        - |   804 | `	ph7_vm *pVm, /* Target VM */` |
|        - |   805 | `	ph7_class_instance *pObj /* Class instance */` |
|        - |   806 | `	)` |
|        2 |   807 |  |
|      618 |   808 | `	ph7_class *pClass = pObj->pClass;` |
...
|      618 |   813 | `	SyHashResetLoopCursor(&pClass->hAttr);` |
|     1630 |   814 | `	while( (pEntry = SyHashGetNextEntry(&pClass->hAttr)) != 0 ){` |
|        - |   815 | `		VmClassAttr *pVmAttr;` |
|        - |   816 | `		/* Extract the current attribute */` |
|     1014 |   817 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|     1014 |   818 | `		pVmAttr = (VmClassAttr *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmClassAttr));` |
|     1014 |   819 | `		if( pVmAttr == 0 ){` |
|      ! 0 |   820 | `			return SXERR_MEM;` |
|        - |   821 | `		}` |
|     1014 |   822 | `		pVmAttr->pAttr = pAttr;` |
|     1014 |   823 | `		if( (pAttr->iFlags & (PH7_CLASS_ATTR_CONSTANT\|PH7_CLASS_ATTR_STATIC)) == 0 ){` |
|        - |   824 | `			ph7_value *pMemObj;` |
|        - |   825 | `			/* Reserve a memory object for this attribute */` |
|     1008 |   826 | `			pMemObj = PH7_ReserveMemObj(&(*pVm));` |
|     1008 |   827 | `			if( pMemObj == 0 ){` |
|      ! 0 |   828 | `				SyMemBackendPoolFree(&pVm->sAllocator,pVmAttr);` |
|      ! 0 |   829 | `				return SXERR_MEM;` |
|        - |   830 | `			}` |
|     1008 |   831 | `			pVmAttr->nIdx = pMemObj->nIdx;` |
|     1008 |   832 | `			if( SySetUsed(&pAttr->aByteCode) > 0 ){` |
|        - |   833 | `				/* Initialize attribute default value (any complex expression) */` |
|      314 |   834 | `				VmLocalExec(&(*pVm),&pAttr->aByteCode,pMemObj);` |
|      156 |   835 | `			}` |
|     1008 |   836 | `			rc = SyHashInsert(&pObj->hAttr,SyStringData(&pAttr->sName),SyStringLength(&pAttr->sName),pVmAttr);` |
|     1008 |   837 | `			if( rc != SXRET_OK ){` |
|        - |   838 | `				VmSlot sSlot;` |
...
|     1008 |   847 | `			PH7_VmRefObjInstall(&(*pVm),pMemObj->nIdx,0,0,VM_REF_IDX_KEEP);` |
|      505 |   848 | `		}else{` |
...
|        - |   870 | ` */` |
|   161458 |   871 | `PH7_PRIVATE ph7_value * PH7_ReserveConstObj(ph7_vm *pVm,sxu32 *pIndex)` |
|        2 |   872 |  |
|        - |   873 | `	ph7_value *pObj;` |
|        - |   874 | `	sxi32 rc;` |
|   161460 |   875 | `	if( pIndex ){` |
|        - |   876 | `		/* Object index in the object table */` |
|   157500 |   877 | `		*pIndex = SySetUsed(&pVm->aLitObj);` |
|    78749 |   878 | `	}` |
|        - |   879 | `	/* Reserve a slot for the new object */` |
|   161460 |   880 | `	rc = SySetPut(&pVm->aLitObj,(const void *)zDummy);` |
|   161460 |   881 | `	if( rc != SXRET_OK ){` |
...
|      ! 0 |   885 | `		return 0;` |
|        - |   886 | `	}` |
|   161460 |   887 | `	pObj = (ph7_value *)SySetPeek(&pVm->aLitObj);` |
|   161460 |   888 | `	return pObj;` |
|    80731 |   889 |  |
|        - |   890 | `/*` |
|        - |   891 | ` * Reserve a memory object.` |
|        - |   892 | ` * Return a pointer to the raw ph7_value on success. NULL on failure.` |
|        - |   893 | ` */` |
|    78434 |   894 | `PH7_PRIVATE ph7_value * VmReserveMemObj(ph7_vm *pVm,sxu32 *pIndex)` |
|        2 |   895 |  |
|        - |   896 | `	ph7_value *pObj;` |
|        - |   897 | `	sxi32 rc;` |
|    78436 |   898 | `	if( pIndex ){` |
|        - |   899 | `		/* Object index in the object table */` |
|    78436 |   900 | `		*pIndex = SySetUsed(&pVm->aMemObj);` |
|    39217 |   901 | `	}` |
|        - |   902 | `	/* Reserve a slot for the new object */` |
|    78436 |   903 | `	rc = SySetPut(&pVm->aMemObj,(const void *)zDummy);` |
|    78436 |   904 | `	if( rc != SXRET_OK ){` |
...
|      ! 0 |   908 | `		return 0;` |
|        - |   909 | `	}` |
|    78436 |   910 | `	pObj = (ph7_value *)SySetPeek(&pVm->aMemObj);` |
|    78436 |   911 | `	return pObj;` |
|    39219 |   912 |  |
...
|        - |  1250 | ` */` |
|     1320 |  1251 | `PH7_PRIVATE sxi32 PH7_VmInit(` |
...
|     1322 |  1260 | `	SyZero(pVm,sizeof(ph7_vm));` |
|        - |  1261 | `	/* Initialize VM fields */` |
|     1322 |  1262 | `	pVm->pEngine = &(*pEngine);` |
|     1322 |  1263 | `	SyMemBackendInitFromParent(&pVm->sAllocator,&pEngine->sAllocator);` |
|        - |  1264 | `	/* Instructions containers */` |
|     1322 |  1265 | `	SySetInit(&pVm->aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|     1322 |  1266 | `	SySetAlloc(&pVm->aByteCode,0xFF);` |
|     1322 |  1267 | `	pVm->pByteContainer = &pVm->aByteCode;` |
|        - |  1268 | `	/* Object containers */` |
|     1322 |  1269 | `	SySetInit(&pVm->aMemObj,&pVm->sAllocator,sizeof(ph7_value));` |
|     1322 |  1270 | `	SySetAlloc(&pVm->aMemObj,0xFF);` |
|        - |  1271 | `	/* Virtual machine internal containers */` |
|     1322 |  1272 | `	SyBlobInit(&pVm->sConsumer,&pVm->sAllocator);` |
|     1322 |  1273 | `	SyBlobInit(&pVm->sWorker,&pVm->sAllocator);` |
|     1322 |  1274 | `	SyBlobInit(&pVm->sArgv,&pVm->sAllocator);` |
|     1322 |  1275 | `	SySetInit(&pVm->aLitObj,&pVm->sAllocator,sizeof(ph7_value));` |
|     1322 |  1276 | `	SySetAlloc(&pVm->aLitObj,0xFF);` |
|     1322 |  1277 | `	SyHashInit(&pVm->hHostFunction,&pVm->sAllocator,0,0);` |
|     1322 |  1278 | `	SyHashInit(&pVm->hFunction,&pVm->sAllocator,0,0);` |
|     1322 |  1279 | `	SyHashInit(&pVm->hClass,&pVm->sAllocator,SyStrHash,SyStrnmicmp);` |
|     1322 |  1280 | `	SyHashInit(&pVm->hConstant,&pVm->sAllocator,0,0);` |
|     1322 |  1281 | `	SyHashInit(&pVm->hSuper,&pVm->sAllocator,0,0);` |
|     1322 |  1282 | `	SyHashInit(&pVm->hPDO,&pVm->sAllocator,0,0);` |
|     1322 |  1283 | `	SySetInit(&pVm->aFreeObj,&pVm->sAllocator,sizeof(VmSlot));` |
|     1322 |  1284 | `	SySetInit(&pVm->aSelf,&pVm->sAllocator,sizeof(ph7_class *));` |
|     1322 |  1285 | `	SySetInit(&pVm->aShutdown,&pVm->sAllocator,sizeof(VmShutdownCB));` |
|     1322 |  1286 | `	SySetInit(&pVm->aException,&pVm->sAllocator,sizeof(ph7_exception *));` |
|        - |  1287 | `	/* Configuration containers */` |
|     1322 |  1288 | `	SySetInit(&pVm->aFiles,&pVm->sAllocator,sizeof(SyString));` |
|     1322 |  1289 | `	SySetInit(&pVm->aPaths,&pVm->sAllocator,sizeof(SyString));` |
|     1322 |  1290 | `	SySetInit(&pVm->aIncluded,&pVm->sAllocator,sizeof(SyString));` |
|     1322 |  1291 | `	SySetInit(&pVm->aOB,&pVm->sAllocator,sizeof(VmObEntry));` |
|     1322 |  1292 | `	SySetInit(&pVm->aIOstream,&pVm->sAllocator,sizeof(ph7_io_stream *));` |
|        - |  1293 | `	/* Error callbacks containers */` |
|     1322 |  1294 | `	PH7_MemObjInit(&(*pVm),&pVm->aExceptionCB[0]);` |
|     1322 |  1295 | `	PH7_MemObjInit(&(*pVm),&pVm->aExceptionCB[1]);` |
|     1322 |  1296 | `	PH7_MemObjInit(&(*pVm),&pVm->aErrCB[0]);` |
|     1322 |  1297 | `	PH7_MemObjInit(&(*pVm),&pVm->aErrCB[1]);` |
|     1322 |  1298 | `	PH7_MemObjInit(&(*pVm),&pVm->sAssertCallback);` |
|        - |  1299 | `	/* Set a default recursion limit */` |
|        - |  1300 | `#if defined(__WINNT__) \|\| defined(__UNIXES__)` |
|     1322 |  1301 | `	pVm->nMaxDepth = 32;` |
|        - |  1302 | `#else` |
|        - |  1303 | `	pVm->nMaxDepth = 16;` |
|        - |  1304 | `#endif` |
|        - |  1305 | `	/* Default assertion flags */` |
|     1322 |  1306 | `	pVm->iAssertFlags = PH7_ASSERT_WARNING; /* Issue a warning for each failed assertion */` |
|        - |  1307 | `	/* JSON return status */` |
|     1322 |  1308 | `	pVm->json_rc = JSON_ERROR_NONE;` |
|        - |  1309 | `	/* PRNG context */` |
|     1322 |  1310 | `	SyRandomnessInit(&pVm->sPrng,0,0);` |
|        - |  1311 | `	/* Install the null constant */` |
|     1322 |  1312 | `	pObj = PH7_ReserveConstObj(&(*pVm),0);` |
|     1322 |  1313 | `	if( pObj == 0 ){` |
|      ! 0 |  1314 | `		rc = SXERR_MEM;` |
|      ! 0 |  1315 | `		goto Err;` |
|        - |  1316 | `	}` |
|     1322 |  1317 | `	PH7_MemObjInit(pVm,pObj);` |
|        - |  1318 | `	/* Install the boolean TRUE constant */` |
|     1322 |  1319 | `	pObj = PH7_ReserveConstObj(&(*pVm),0);` |
|     1322 |  1320 | `	if( pObj == 0 ){` |
|      ! 0 |  1321 | `		rc = SXERR_MEM;` |
|      ! 0 |  1322 | `		goto Err;` |
|        - |  1323 | `	}` |
|     1322 |  1324 | `	PH7_MemObjInitFromBool(pVm,pObj,1);` |
|        - |  1325 | `	/* Install the boolean FALSE constant */` |
|     1322 |  1326 | `	pObj = PH7_ReserveConstObj(&(*pVm),0);` |
|     1322 |  1327 | `	if( pObj == 0 ){` |
|      ! 0 |  1328 | `		rc = SXERR_MEM;` |
|      ! 0 |  1329 | `		goto Err;` |
|        - |  1330 | `	}` |
|     1322 |  1331 | `	PH7_MemObjInitFromBool(pVm,pObj,0);` |
...
|     1322 |  1335 | `	pObj = PH7_ReserveConstObj(&(*pVm),&pVm->nEmptyStringIdx);` |
|     1322 |  1336 | `	if( pObj == 0 ){` |
|      ! 0 |  1337 | `		rc = SXERR_MEM;` |
|      ! 0 |  1338 | `		goto Err;` |
|        - |  1339 | `	}` |
|     1322 |  1340 | `	PH7_MemObjInitFromString(pVm,pObj,0);` |
|        - |  1341 | `	/* Create the global frame */` |
|     1322 |  1342 | `	rc = VmEnterFrame(&(*pVm),0,0,0);` |
|     1322 |  1343 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  1344 | `		goto Err;` |
|        - |  1345 | `	}` |
|        - |  1346 | `	/* Initialize the code generator */` |
|     1322 |  1347 | `	rc = PH7_InitCodeGenerator(pVm,pEngine->xConf.xErr,pEngine->xConf.pErrData);` |
|     1322 |  1348 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  1349 | `		goto Err;` |
|        - |  1350 | `	}` |
|        - |  1351 | `	/* VM correctly initialized,set the magic number */` |
|     1322 |  1352 | `	pVm->nMagic = PH7_VM_INIT;` |
|     1322 |  1353 | `	SyStringInitFromBuf(&sBuiltin,PH7_BUILTIN_LIB,sizeof(PH7_BUILTIN_LIB)-1);` |
|        - |  1354 | `	/* Compile the built-in library */` |
|     1322 |  1355 | `	VmEvalChunk(&(*pVm),0,&sBuiltin,PH7_PHP_ONLY,FALSE);` |
|        - |  1356 | `	/* Reset the code generator */` |
|     1322 |  1357 | `	PH7_ResetCodeGenerator(&(*pVm),pEngine->xConf.xErr,pEngine->xConf.pErrData);` |
|     1322 |  1358 | `	return SXRET_OK;` |
|      ! 0 |  1359 | `Err:` |
...
|        - |  1391 | ` */` |
|    20252 |  1392 | `static ph7_value * VmNewOperandStack(` |
...
|        - |  1404 | `  */` |
|    20254 |  1405 | `	nInstr += VM_STACK_GUARD;` |
|    20254 |  1406 | `	pStack = (ph7_value *)SyMemBackendAlloc(&pVm->sAllocator,nInstr * sizeof(ph7_value));` |
|    20254 |  1407 | `	if( pStack == 0 ){` |
|      ! 0 |  1408 | `		return 0;` |
|        - |  1409 | `	}` |
|        - |  1410 | `	/* Initialize the operand stack */` |
|  1293728 |  1411 | `	while( nInstr > 0 ){` |
|  1273476 |  1412 | `		PH7_MemObjInit(&(*pVm),&pStack[nInstr - 1]);` |
|  1273476 |  1413 | `		--nInstr;` |
|        2 |  1414 | `	}` |
|        - |  1415 | `	/* Ready for bytecode execution */` |
|    20254 |  1416 | `	return pStack;` |
|    10128 |  1417 |  |
...
|        - |  1426 | ` */` |
|     1062 |  1427 | `PH7_PRIVATE sxi32 PH7_VmMakeReady(` |
|        - |  1428 | `	ph7_vm *pVm /* Target VM */` |
|        - |  1429 | `	)` |
|        2 |  1430 |  |
|        - |  1431 | `	SyHashEntry *pEntry;` |
|        - |  1432 | `	sxi32 rc;` |
|     1064 |  1433 | `	if( pVm->nMagic != PH7_VM_INIT ){` |
|        - |  1434 | `		/* Initialize your VM first */` |
|      ! 0 |  1435 | `		return SXERR_CORRUPT;` |
|        - |  1436 | `	}` |
|        - |  1437 | `	/* Mark the VM ready for byte-code execution */` |
|     1064 |  1438 | `	pVm->nMagic = PH7_VM_RUN;` |
|        - |  1439 | `	/* Release the code generator now we have compiled our program */` |
|     1064 |  1440 | `	PH7_ResetCodeGenerator(pVm,0,0);` |
|        - |  1441 | `	/* Emit the DONE instruction */` |
|     1064 |  1442 | `	rc = PH7_VmEmitInstr(&(*pVm),PH7_OP_DONE,0,0,0,0);` |
|     1064 |  1443 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  1444 | `		return SXERR_MEM;` |
|        - |  1445 | `	}` |
|        - |  1446 | `	/* Script return value */` |
|     1064 |  1447 | `	PH7_MemObjInit(&(*pVm),&pVm->sExec); /* Assume a NULL return value */` |
|        - |  1448 | `	/* Allocate a new operand stack */` |
|     1064 |  1449 | `	pVm->aOps = VmNewOperandStack(&(*pVm),SySetUsed(pVm->pByteContainer));` |
|     1064 |  1450 | `	if( pVm->aOps == 0 ){` |
|      ! 0 |  1451 | `		return SXERR_MEM;` |
|        - |  1452 | `	}` |
|        - |  1453 | `	/* Set the default VM output consumer callback and it's` |
|        - |  1454 | `	 * private data. */` |
|     1064 |  1455 | `	pVm->sVmConsumer.xConsumer = PH7_VmBlobConsumer;` |
|     1064 |  1456 | `	pVm->sVmConsumer.pUserData = &pVm->sConsumer;` |
|        - |  1457 | `	/* Allocate the reference table */` |
|     1064 |  1458 | `	pVm->nRefSize = 0x10; /* Must be a power of two for fast arithemtic */` |
|     1064 |  1459 | `	pVm->apRefObj = (VmRefObj **)SyMemBackendAlloc(&pVm->sAllocator,sizeof(VmRefObj *) * pVm->nRefSize);` |
|     1064 |  1460 | `	if( pVm->apRefObj == 0 ){` |
...
|     1064 |  1479 | `	PH7_RegisterBuiltInConstant(&(*pVm));` |
|        - |  1480 | `	/* Register built-in functions [i.e: is_null(), array_diff(), strlen(), etc.] */` |
|     1064 |  1481 | `	PH7_RegisterBuiltInFunction(&(*pVm));` |
|        - |  1482 | `	/* Initialize and install static and constants class attributes */` |
|     1064 |  1483 | `	SyHashResetLoopCursor(&pVm->hClass);` |
|    12770 |  1484 | `	while((pEntry = SyHashGetNextEntry(&pVm->hClass)) != 0 ){` |
|    11708 |  1485 | `		rc = VmMountUserClass(&(*pVm),(ph7_class *)pEntry->pUserData);` |
|    11708 |  1486 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  1487 | `			return rc;` |
|        - |  1488 | `		}` |
|        2 |  1489 | `	}` |
|        - |  1490 | `	/* Random number betwwen 0 and 1023 used to generate unique ID */` |
|     1064 |  1491 | `	pVm->unique_id = PH7_VmRandomNum(&(*pVm)) & 1023;` |
|        - |  1492 | `	/* VM is ready for bytecode execution */` |
|     1064 |  1493 | `	return SXRET_OK;` |
|      533 |  1494 |  |
|        - |  1495 | `/*` |
...
|        - |  1513 | ` */` |
|     1054 |  1514 | `PH7_PRIVATE sxi32 PH7_VmRelease(ph7_vm *pVm)` |
|        2 |  1515 |  |
|        - |  1516 | `	/* Set the stale magic number */` |
|     1056 |  1517 | `	pVm->nMagic = PH7_VM_STALE;` |
|        - |  1518 | `	/* Release the private memory subsystem */` |
|     1056 |  1519 | `	SyMemBackendRelease(&pVm->sAllocator);` |
|     1056 |  1520 | `	return SXRET_OK;` |
|        2 |  1521 |  |
|        - |  1522 | `/*` |
...
|        - |  1531 | ` */` |
|   420480 |  1532 | `static sxi32 VmInitCallContext(` |
...
|        - |  1538 | `	)` |
|        2 |  1539 |  |
|   420482 |  1540 | `	pOut->pFunc = pFunc;` |
|   420482 |  1541 | `	pOut->pVm   = pVm;` |
|   420482 |  1542 | `	SySetInit(&pOut->sVar,&pVm->sAllocator,sizeof(ph7_value *));` |
|   420482 |  1543 | `	SySetInit(&pOut->sChunk,&pVm->sAllocator,sizeof(ph7_aux_data));` |
|        - |  1544 | `	/* Assume a null return value */` |
|   420482 |  1545 | `	MemObjSetType(pRet,MEMOBJ_NULL);` |
|   420482 |  1546 | `	pOut->pRet = pRet;` |
|   420482 |  1547 | `	pOut->iFlags = iFlags;` |
|   420482 |  1548 | `	return SXRET_OK;` |
|        2 |  1549 |  |
|        - |  1550 | `/*` |
|        - |  1551 | ` * Release a foreign function call context and cleanup the mess` |
|        - |  1552 | ` * left behind.` |
|        - |  1553 | ` */` |
|   420480 |  1554 | `static void VmReleaseCallContext(ph7_context *pCtx)` |
|        2 |  1555 |  |
|        - |  1556 | `	sxu32 n;` |
|   420482 |  1557 | `	if( SySetUsed(&pCtx->sVar) > 0 ){` |
|     4640 |  1558 | `		ph7_value **apObj = (ph7_value **)SySetBasePtr(&pCtx->sVar);` |
|    12976 |  1559 | `		for( n = 0 ; n < SySetUsed(&pCtx->sVar) ; ++n ){` |
|     8338 |  1560 | `			if( apObj[n] == 0 ){` |
|        - |  1561 | `				/* Already released */` |
|      250 |  1562 | `				continue;` |
|        - |  1563 | `			}` |
|     8090 |  1564 | `			PH7_MemObjRelease(apObj[n]);` |
|     8090 |  1565 | `			SyMemBackendPoolFree(&pCtx->pVm->sAllocator,apObj[n]);` |
|     4046 |  1566 | `		}` |
|     4640 |  1567 | `		SySetRelease(&pCtx->sVar);` |
|     2319 |  1568 | `	}` |
|   420482 |  1569 | `	if( SySetUsed(&pCtx->sChunk) > 0 ){` |
...
|        - |  1615 | ` */` |
|  2323258 |  1616 | `static void VmPopOperand(` |
|        - |  1617 | `	ph7_value **ppTos, /* Operand stack */` |
|        - |  1618 | `	sxi32 nPop         /* Total number of memory objects to pop */` |
|        - |  1619 | `	)` |
|        2 |  1620 |  |
|  2323260 |  1621 | `	ph7_value *pTos = *ppTos;` |
|  4960762 |  1622 | `	while( nPop > 0 ){` |
|  2637504 |  1623 | `		PH7_MemObjRelease(pTos);` |
|  2637504 |  1624 | `		pTos--;` |
|  2637504 |  1625 | `		nPop--;` |
|        2 |  1626 | `	}` |
|        - |  1627 | `	/* Top of the stack */` |
|  2323260 |  1628 | `	*ppTos = pTos;` |
|  2323260 |  1629 |  |
|        - |  1630 | `/*` |
|        - |  1631 | ` * Reserve a memory object.` |
|        - |  1632 | ` * Return a pointer to the raw ph7_value on success. NULL on failure.` |
|        - |  1633 | ` */` |
|   629610 |  1634 | `PH7_PRIVATE ph7_value * PH7_ReserveMemObj(ph7_vm *pVm)` |
|        2 |  1635 |  |
|   629612 |  1636 | `	ph7_value *pObj = 0;` |
|        - |  1637 | `	VmSlot *pSlot;` |
|        - |  1638 | `	sxu32 nIdx;` |
|        - |  1639 | `	/* Check for a free slot */` |
|   629612 |  1640 | `	nIdx = SXU32_HIGH; /* cc warning */` |
|   629612 |  1641 | `	pSlot = (VmSlot *)SySetPop(&pVm->aFreeObj);` |
|   629612 |  1642 | `	if( pSlot ){` |
|   551178 |  1643 | `		pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pSlot->nIdx);` |
|   551178 |  1644 | `		nIdx = pSlot->nIdx;` |
|   275588 |  1645 | `	}` |
|   629612 |  1646 | `	if( pObj == 0 ){` |
|        - |  1647 | `		/* Reserve a new memory object */` |
|    78436 |  1648 | `		pObj = VmReserveMemObj(&(*pVm),&nIdx);` |
|    78436 |  1649 | `		if( pObj == 0 ){` |
|      ! 0 |  1650 | `			return 0;` |
|        - |  1651 | `		}` |
|    39217 |  1652 | `	}` |
|        - |  1653 | `	/* Set a null default value */` |
|   629612 |  1654 | `	PH7_MemObjInit(&(*pVm),pObj);` |
|   629612 |  1655 | `	pObj->nIdx = nIdx;` |
|   629612 |  1656 | `	return pObj;` |
|   314807 |  1657 |  |
|        - |  1658 | `/*` |
|        - |  1659 | ` * Insert an entry by reference (not copy) in the given hashmap.` |
|        - |  1660 | ` */` |
|    15262 |  1661 | `static sxi32 VmHashmapRefInsert(` |
...
|        - |  1668 | `	ph7_value sKey;` |
|        - |  1669 | `	sxi32 rc;` |
|    15264 |  1670 | `	PH7_MemObjInitFromString(pMap->pVm,&sKey,0);` |
|    15264 |  1671 | `	PH7_MemObjStringAppend(&sKey,zKey,nByte);` |
|        - |  1672 | `	/* Perform the insertion */` |
|    15264 |  1673 | `	rc = PH7_HashmapInsertByRef(&(*pMap),&sKey,nRefIdx);` |
|    15264 |  1674 | `	PH7_MemObjRelease(&sKey);` |
|    15264 |  1675 | `	return rc;` |
|        2 |  1676 |  |
|        - |  1677 | `/*` |
...
|        - |  1681 | ` */` |
|  2109862 |  1682 | `static ph7_value * VmExtractMemObj(` |
...
|        - |  1687 | `	)` |
|        2 |  1688 |  |
|  2109864 |  1689 | `	int bNullify = FALSE;` |
...
|  2109864 |  1696 | `	pFrame = pVm->pFrame;` |
|  2159216 |  1697 | `	while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|        - |  1698 | `		/* Safely ignore the exception frame */` |
|    49353 |  1699 | `		pFrame = pFrame->pParent; /* Parent frame */` |
|        1 |  1700 | `	}` |
|        - |  1701 | `	/* Perform the lookup */` |
|  2109864 |  1702 | `	if( pName == 0 \|\| pName->nByte < 1 ){` |
...
|  2109864 |  1710 | `	pEntry = SyHashGet(&pVm->hSuper,(const void *)pName->zString,pName->nByte);` |
|  2109864 |  1711 | `	if( pEntry == 0 ){` |
|        - |  1712 | `		/* Query the top active frame */` |
|  2109828 |  1713 | `		pEntry = SyHashGet(&pFrame->hVar,(const void *)pName->zString,pName->nByte);` |
|  2109828 |  1714 | `		if( pEntry == 0 ){` |
|    56934 |  1715 | `			char *zName = (char *)pName->zString;` |
|        - |  1716 | `			VmSlot sLocal;` |
|    56934 |  1717 | `			if( !bCreate ){` |
...
|        - |  1723 | `			 */` |
|    56464 |  1724 | `			pObj = PH7_ReserveMemObj(&(*pVm));` |
|    56464 |  1725 | `			if( pObj == 0 ){` |
|      ! 0 |  1726 | `				return 0;` |
|        - |  1727 | `			}` |
|    56464 |  1728 | `			nIdx = pObj->nIdx;` |
|    56464 |  1729 | `			if( bDup ){` |
|        - |  1730 | `				/* Duplicate name */` |
...
|    56464 |  1737 | `			rc = SyHashInsert(&pFrame->hVar,zName,pName->nByte,SX_INT_TO_PTR(nIdx));` |
|    56464 |  1738 | `			if( rc != SXRET_OK ){` |
...
|      ! 0 |  1743 | `				return 0;` |
|        - |  1744 | `			}` |
|    56464 |  1745 | `			if( pFrame->pParent != 0 ){` |
|        - |  1746 | `				/* Local variable */` |
|    51846 |  1747 | `				sLocal.nIdx = nIdx;` |
|    51846 |  1748 | `				SySetPut(&pFrame->sLocal,(const void *)&sLocal);` |
|    25924 |  1749 | `			}else{` |
|        - |  1750 | `				/* Register in the $GLOBALS array */` |
|     4620 |  1751 | `				VmHashmapRefInsert(pVm->pGlobal,pName->zString,pName->nByte,nIdx);` |
|        - |  1752 | `			}` |
|        - |  1753 | `			/* Install in the reference table */` |
|    56464 |  1754 | `			PH7_VmRefObjInstall(&(*pVm),nIdx,SyHashLastEntry(&pFrame->hVar),0,0);` |
|        - |  1755 | `			/* Save object index */` |
|    56464 |  1756 | `			pObj->nIdx = nIdx;` |
|    28233 |  1757 | `		}else{` |
|        - |  1758 | `			/* Extract variable contents */` |
|  2052896 |  1759 | `			nIdx = (sxu32)SX_PTR_TO_INT(pEntry->pUserData);` |
|  2052896 |  1760 | `			pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|  2052896 |  1761 | `			if( bNullify && pObj ){` |
...
|        - |  1775 | ` */` |
|     1088 |  1776 | `static ph7_value * VmExtractSuper(` |
...
|     1090 |  1786 | `	pEntry = SyHashGet(&pVm->hSuper,(const void *)zName,nByte);` |
|     1090 |  1787 | `	if( pEntry == 0 ){` |
|        - |  1788 | `		/* No such entry */` |
|      ! 0 |  1789 | `		return 0;` |
|        - |  1790 | `	}` |
|        - |  1791 | `	/* Extract the superglobal index in the global object pool */` |
|     1090 |  1792 | `	nIdx = SX_PTR_TO_INT(pEntry->pUserData);` |
|        - |  1793 | `	/* Extract the variable value  */` |
|     1090 |  1794 | `	pValue = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|     1090 |  1795 | `	return pValue;` |
|      546 |  1796 |  |
|        - |  1797 | `/*` |
|        - |  1798 | ` * Perform a raw hashmap insertion.` |
|        - |  1799 | ` * Refer to the [PH7_VmConfigure()] implementation for additional information.` |
|        - |  1800 | ` */` |
|     1086 |  1801 | `static sxi32 VmHashmapInsert(` |
...
|        - |  1810 | `	sxi32 rc;` |
|     1088 |  1811 | `	PH7_MemObjInitFromString(pMap->pVm,&sKey,0);` |
|     1088 |  1812 | `	PH7_MemObjInitFromString(pMap->pVm,&sValue,0);` |
|     1088 |  1813 | `	if( zKey ){` |
|     1066 |  1814 | `		if( nKeylen < 0 ){` |
|     1066 |  1815 | `			nKeylen = (int)SyStrlen(zKey);` |
|      532 |  1816 | `		}` |
|     1066 |  1817 | `		PH7_MemObjStringAppend(&sKey,zKey,(sxu32)nKeylen);` |
|      532 |  1818 | `	}` |
|     1088 |  1819 | `	if( zData ){` |
|     1088 |  1820 | `		if( nLen < 0 ){` |
...
|      ! 0 |  1823 | `		}` |
|     1088 |  1824 | `		PH7_MemObjStringAppend(&sValue,zData,(sxu32)nLen);` |
|      543 |  1825 | `	}` |
|        - |  1826 | `	/* Perform the insertion */` |
|     1088 |  1827 | `	rc = PH7_HashmapInsert(&(*pMap),&sKey,&sValue);` |
|     1088 |  1828 | `	PH7_MemObjRelease(&sKey);` |
|     1088 |  1829 | `	PH7_MemObjRelease(&sValue);` |
|     1088 |  1830 | `	return rc;` |
|        2 |  1831 |  |
...
|        - |  1846 | ` */` |
|    17016 |  1847 | `PH7_PRIVATE sxi32 PH7_VmConfigure(` |
|        - |  1848 | `	ph7_vm *pVm, /* Target VM */` |
|        - |  1849 | `	sxi32 nOp,   /* Configuration verb */` |
|        - |  1850 | `	va_list ap   /* Subsequent option arguments */` |
|        - |  1851 | `	)` |
|        2 |  1852 |  |
|    17018 |  1853 | `	sxi32 rc = SXRET_OK;` |
|    17018 |  1854 | `	switch(nOp){` |
|      531 |  1855 | `	case PH7_VM_CONFIG_OUTPUT: {` |
|     1064 |  1856 | `		ProcConsumer xConsumer = va_arg(ap,ProcConsumer);` |
|     1064 |  1857 | `		void *pUserData = va_arg(ap,void *);` |
...
|     1064 |  1866 | `		pVm->sVmConsumer.xConsumer = xConsumer;` |
|     1064 |  1867 | `		pVm->sVmConsumer.pUserData = pUserData;` |
|     1064 |  1868 | `		break;` |
|        - |  1869 | `							   }` |
|      531 |  1870 | `	case PH7_VM_CONFIG_IMPORT_PATH: {` |
|        - |  1871 | `		/* Import path */` |
|        - |  1872 | `		  const char *zPath;` |
|        - |  1873 | `		  SyString sPath;` |
|     1064 |  1874 | `		  zPath = va_arg(ap,const char *);` |
...
|        - |  1879 | `		  }` |
|        - |  1880 | `#endif` |
|     1064 |  1881 | `		  SyStringInitFromBuf(&sPath,zPath,SyStrlen(zPath));` |
|        - |  1882 | `		  /* Remove trailing slashes and backslashes */` |
|        - |  1883 | `#ifdef __WINNT__` |
|        2 |  1884 | `		  SyStringTrimTrailingChar(&sPath,'\\');` |
|        - |  1885 | `#endif` |
|     2126 |  1886 | `		  SyStringTrimTrailingChar(&sPath,'/');` |
|        - |  1887 | `		  /* Remove leading and trailing white spaces */` |
|     1064 |  1888 | `		  SyStringFullTrim(&sPath);` |
|     1064 |  1889 | `		  if( sPath.nByte > 0 ){` |
|        - |  1890 | `			  /* Store the path in the corresponding conatiner */` |
|     1064 |  1891 | `			  rc = SySetPut(&pVm->aPaths,(const void *)&sPath);` |
|      531 |  1892 | `		  }` |
|     1064 |  1893 | `		  break;` |
|        - |  1894 | `									 }` |
|      531 |  1895 | `	case PH7_VM_CONFIG_ERR_REPORT:` |
|        - |  1896 | `		/* Run-Time Error report */` |
|     1064 |  1897 | `		pVm->bErrReport = 1;` |
|     1064 |  1898 | `		break;` |
...
|        - |  1918 | `							   }` |
|        - |  1919 |  |
|     5310 |  1920 | `	case PH7_VM_CONFIG_CREATE_SUPER:` |
|        - |  1921 | `	case PH7_VM_CONFIG_CREATE_VAR: {` |
|        - |  1922 | `		/* Create a new superglobal/global variable */` |
|    10622 |  1923 | `		const char *zName = va_arg(ap,const char *);` |
|    10622 |  1924 | `		ph7_value *pValue = va_arg(ap,ph7_value *);` |
...
|        - |  1933 | `		}` |
|        - |  1934 | `#endif` |
|    10622 |  1935 | `		nByte = SyStrlen(zName);` |
|    10622 |  1936 | `		if( nOp == PH7_VM_CONFIG_CREATE_SUPER ){` |
|        - |  1937 | `			/* Check if the superglobal is already installed */` |
|    10622 |  1938 | `			pEntry = SyHashGet(&pVm->hSuper,(const void *)zName,nByte);` |
|     5312 |  1939 | `		}else{` |
|        - |  1940 | `			/* Query the top active VM frame */` |
|      ! 0 |  1941 | `			pEntry = SyHashGet(&pVm->pFrame->hVar,(const void *)zName,nByte);` |
|        - |  1942 | `		}` |
|    10622 |  1943 | `		if( pEntry ){` |
...
|    10622 |  1954 | `			pObj = PH7_ReserveMemObj(&(*pVm));` |
|    10622 |  1955 | `			if( pObj == 0 ){` |
|      ! 0 |  1956 | `				rc = SXERR_MEM;` |
|      ! 0 |  1957 | `				break;` |
|        - |  1958 | `			}` |
|    10622 |  1959 | `			nIdx = pObj->nIdx;` |
|        - |  1960 | `			/* Copy value */` |
|    10622 |  1961 | `			PH7_MemObjStore(pValue,pObj);` |
|    10622 |  1962 | `			if( nOp == PH7_VM_CONFIG_CREATE_SUPER ){` |
|        - |  1963 | `				/* Install the superglobal */` |
|    10622 |  1964 | `				rc = SyHashInsert(&pVm->hSuper,(const void *)zName,nByte,SX_INT_TO_PTR(nIdx));` |
|     5312 |  1965 | `			}else{` |
|        - |  1966 | `				/* Install in the current frame */` |
|      ! 0 |  1967 | `				rc = SyHashInsert(&pVm->pFrame->hVar,(const void *)zName,nByte,SX_INT_TO_PTR(nIdx));` |
|        - |  1968 | `			}` |
|    10622 |  1969 | `			if( rc == SXRET_OK ){` |
|        - |  1970 | `				SyHashEntry *pRef;` |
|    10622 |  1971 | `				if( nOp == PH7_VM_CONFIG_CREATE_SUPER ){` |
|    10622 |  1972 | `					pRef = SyHashLastEntry(&pVm->hSuper);` |
|     5312 |  1973 | `				}else{` |
|      ! 0 |  1974 | `					pRef = SyHashLastEntry(&pVm->pFrame->hVar);` |
|        - |  1975 | `				}` |
|        - |  1976 | `				/* Install in the reference table */` |
|    10622 |  1977 | `				PH7_VmRefObjInstall(&(*pVm),nIdx,pRef,0,0);` |
|    10622 |  1978 | `				if( nOp == PH7_VM_CONFIG_CREATE_SUPER \|\| pVm->pFrame->pParent == 0){` |
|        - |  1979 | `					/* Register in the $GLOBALS array */` |
|    10622 |  1980 | `					VmHashmapRefInsert(pVm->pGlobal,zName,nByte,nIdx);` |
|     5310 |  1981 | `				}` |
|     5310 |  1982 | `			}` |
|        - |  1983 | `		}` |
|    10622 |  1984 | `		break;` |
|        - |  1985 | `									}` |
|      532 |  1986 | `	case PH7_VM_CONFIG_SERVER_ATTR:` |
...
|     1064 |  2018 | `			pValue = VmExtractSuper(&(*pVm),"_SERVER",sizeof("_SERVER")-1);` |
|        - |  2019 | `		}` |
|     1066 |  2020 | `		if( pValue == 0 \|\| (pValue->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
|        - |  2021 | `			/* No such entry */` |
|      ! 0 |  2022 | `			rc = SXERR_NOTFOUND;` |
|      ! 0 |  2023 | `			break;` |
|        - |  2024 | `		}` |
|        - |  2025 | `		/* Point to the hashmap */` |
|     1066 |  2026 | `		pMap = (ph7_hashmap *)pValue->x.pOther;` |
|        - |  2027 | `		/* Perform the insertion */` |
|     1066 |  2028 | `		rc = VmHashmapInsert(pMap,zKey,-1,zValue,nLen);` |
|     1066 |  2029 | `		break;` |
|        - |  2030 | `								   }` |
...
|      ! 0 |  2078 | `		break;` |
|        - |  2079 | `								   }` |
|     1062 |  2080 | `	case PH7_VM_CONFIG_IO_STREAM: {` |
|        - |  2081 | `		/* Register an IO stream device */` |
|     2126 |  2082 | `		const ph7_io_stream *pStream = va_arg(ap,const ph7_io_stream *);` |
|        - |  2083 | `		/* Make sure we are dealing with a valid IO stream */` |
|     3186 |  2084 | `		if( pStream == 0 \|\| pStream->zName == 0 \|\| pStream->zName[0] == 0 \|\|` |
|     2126 |  2085 | `			pStream->xOpen == 0 \|\| pStream->xRead == 0 ){` |
|        - |  2086 | `				/* Invalid stream */` |
|      ! 0 |  2087 | `				rc = SXERR_INVALID;` |
|      ! 0 |  2088 | `				break;` |
|        - |  2089 | `		}` |
|     2126 |  2090 | `		if( pVm->pDefStream == 0 && SyStrnicmp(pStream->zName,"file",sizeof("file")-1) == 0 ){` |
|        - |  2091 | `			/* Make the 'file://' stream the defaut stream device */` |
|     1064 |  2092 | `			pVm->pDefStream = pStream;` |
|      531 |  2093 | `		}` |
|        - |  2094 | `		/* Insert in the appropriate container */` |
|     2126 |  2095 | `		rc = SySetPut(&pVm->aIOstream,(const void *)&pStream);` |
|     2126 |  2096 | `		break;` |
|        - |  2097 | `								  }` |
...
|        - |  2192 | ` */` |
|      140 |  2193 | `static sxi32 VmCallErrorHandler(ph7_vm *pVm,SyBlob *pMsg)` |
|        2 |  2194 |  |
|      142 |  2195 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|      142 |  2196 | `	sxi32 rc = SXRET_OK;` |
|        - |  2197 | `	/* Append a new line */` |
|        - |  2198 | `#ifdef __WINNT__` |
|        2 |  2199 | `	SyBlobAppend(pMsg,"\r\n",sizeof("\r\n")-1);` |
|        - |  2200 | `#else` |
|      140 |  2201 | `	SyBlobAppend(pMsg,"\n",sizeof(char));` |
|        - |  2202 | `#endif` |
|        - |  2203 | `	/* Invoke the output consumer callback */` |
|      142 |  2204 | `	rc = pCons->xConsumer(SyBlobData(pMsg),SyBlobLength(pMsg),pCons->pUserData);` |
|      142 |  2205 | `	if( pCons->xConsumer != VmObConsumer ){` |
|        - |  2206 | `		/* Increment output length */` |
|      139 |  2207 | `		pVm->nOutputLen += SyBlobLength(pMsg);` |
|       69 |  2208 | `	}` |
|      142 |  2209 | `	return rc;` |
|        2 |  2210 |  |
|        - |  2211 | `/*` |
...
|        - |  2214 | ` * information.` |
|        - |  2215 | ` */` |
|       86 |  2216 | `static sxi32 VmInvokeErrorHandler(ph7_vm *pVm, sxi32 iErr, const char *zMessage, SyString *pFile, sxi32 iLine)` |
|        2 |  2217 |  |
|       88 |  2218 | `	if( ph7_value_is_callable(&pVm->aErrCB[1]) ){` |
|        - |  2219 | `		ph7_value apArg[4];` |
|        - |  2220 | `		ph7_value *apArgPtr[4];` |
|        - |  2221 | `		ph7_value sResult;` |
|        - |  2222 | `		SyString sErr;` |
|        - |  2223 | `		/* Prepare arguments */` |
|        9 |  2224 | `		PH7_MemObjInitFromInt(pVm,&apArg[0],iErr);` |
|        9 |  2225 | `		SyStringInitFromBuf(&sErr,zMessage,SyStrlen(zMessage));` |
|        9 |  2226 | `		PH7_MemObjInitFromString(pVm,&apArg[1],&sErr);` |
|        9 |  2227 | `		if( pFile ){` |
|        9 |  2228 | `			SyStringInitFromBuf(&sErr,pFile->zString,pFile->nByte);` |
|        9 |  2229 | `			PH7_MemObjInitFromString(pVm,&apArg[2],&sErr);` |
|        5 |  2230 | `		}else{` |
|      ! 0 |  2231 | `			PH7_MemObjInit(pVm,&apArg[2]);` |
|        - |  2232 | `		}` |
|        9 |  2233 | `		PH7_MemObjInitFromInt(pVm,&apArg[3],iLine);` |
|        9 |  2234 | `		PH7_MemObjInit(pVm,&sResult);` |
|        - |  2235 | `		/* Set up pointer array */` |
|        9 |  2236 | `		apArgPtr[0] = &apArg[0];` |
|        9 |  2237 | `		apArgPtr[1] = &apArg[1];` |
|        9 |  2238 | `		apArgPtr[2] = &apArg[2];` |
|        9 |  2239 | `		apArgPtr[3] = &apArg[3];` |
|        - |  2240 | `		/* Call the handler */` |
|        9 |  2241 | `		PH7_VmCallUserFunction(pVm,&pVm->aErrCB[1],4,apArgPtr,&sResult);` |
|        - |  2242 | `		/* Check return value */` |
|        9 |  2243 | `		if( (sResult.iFlags & MEMOBJ_BOOL) == 0 ){` |
|      ! 0 |  2244 | `			PH7_MemObjToBool(&sResult);` |
|      ! 0 |  2245 | `		}` |
|        - |  2246 | `		/* Release */` |
|        9 |  2247 | `		PH7_MemObjRelease(&apArg[0]);` |
|        9 |  2248 | `		PH7_MemObjRelease(&apArg[1]);` |
|        9 |  2249 | `		PH7_MemObjRelease(&apArg[2]);` |
|        9 |  2250 | `		PH7_MemObjRelease(&apArg[3]);` |
|        9 |  2251 | `		PH7_MemObjRelease(&sResult);` |
...
|        9 |  2254 | `		return sResult.x.iVal == 0 ? TRUE : FALSE;` |
|        - |  2255 | `	}` |
|        - |  2256 | `	/* No handler, always call error handler */` |
|       79 |  2257 | `	return TRUE;` |
|       45 |  2258 |  |
|       62 |  2259 | `PH7_PRIVATE sxi32 PH7_VmThrowError(` |
...
|        - |  2264 | `	)` |
|        2 |  2265 |  |
|       64 |  2266 | `	SyBlob *pWorker = &pVm->sWorker;` |
|        - |  2267 | `	SyString *pFile;` |
|        - |  2268 | `	char *zErr;` |
|       64 |  2269 | `	sxi32 rc = SXRET_OK;` |
|       64 |  2270 | `	if( !pVm->bErrReport ){` |
|        - |  2271 | `		/* Don't bother reporting errors */` |
|        3 |  2272 | `		return SXRET_OK;` |
|        - |  2273 | `	}` |
|        - |  2274 | `	/* Reset the working buffer */` |
|       62 |  2275 | `	SyBlobReset(pWorker);` |
|        - |  2276 | `	/* Peek the processed file if available */` |
|       62 |  2277 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|       62 |  2278 | `	if( pFile ){` |
|        - |  2279 | `		/* Append file name */` |
|       62 |  2280 | `		SyBlobAppend(pWorker,pFile->zString,pFile->nByte);` |
|       62 |  2281 | `		SyBlobAppend(pWorker,(const void *)" ",sizeof(char));` |
|       30 |  2282 | `	}` |
|       62 |  2283 | `	zErr = "Error: ";` |
|       62 |  2284 | `	switch(iErr){` |
|       27 |  2285 | `	case PH7_CTX_WARNING: zErr = "Warning: "; break;` |
|       14 |  2286 | `	case PH7_CTX_NOTICE:  zErr = "Notice: ";  break;` |
|       11 |  2287 | `	default:` |
|       23 |  2288 | `		iErr = PH7_CTX_ERR;` |
|       22 |  2289 | `		break;` |
|        - |  2290 | `	}` |
|       62 |  2291 | `	SyBlobAppend(pWorker,zErr,SyStrlen(zErr));` |
|       62 |  2292 | `	if( pFuncName ){` |
...
|       14 |  2296 | `	}` |
|       62 |  2297 | `	SyBlobAppend(pWorker,zMessage,SyStrlen(zMessage));` |
|        - |  2298 | `	/* Check for user error handler */` |
|       62 |  2299 | `	if( VmInvokeErrorHandler(pVm, iErr, zMessage, pFile, 0) ){` |
...
|        - |  2394 | ` */` |
|      124 |  2395 | `static void VmGetFrameContext(ph7_vm *pVm,const char **pzFuncName,int *pnFuncLen)` |
|        2 |  2396 |  |
|        - |  2397 | `	VmFrame *pFrame;` |
|        - |  2398 | `	ph7_vm_func *pFunc;` |
|      126 |  2399 | `	*pzFuncName = 0;` |
|      126 |  2400 | `	*pnFuncLen = 0;` |
|      126 |  2401 | `	pFrame = pVm->pFrame;` |
|      126 |  2402 | `	if( pFrame == 0 ){` |
|      ! 0 |  2403 | `		return;` |
|        - |  2404 | `	}` |
|      126 |  2405 | `	while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|      ! 0 |  2406 | `		pFrame = pFrame->pParent;` |
|      ! 0 |  2407 | `	}` |
|      126 |  2408 | `	if( pFrame->pParent == 0 ){` |
|      126 |  2409 | `		return;` |
|        - |  2410 | `	}` |
...
|        - |  2420 | ` */` |
|       62 |  2421 | `static sxi32 VmReportUncaughtException(ph7_vm *pVm,const char *zClass,sxu32 nClass,const char *zMsg,sxu32 nMsg,const char *zFuncName,int nFuncLen)` |
|        2 |  2422 |  |
|        - |  2423 | `	SyBlob sOut;` |
|        - |  2424 | `	SyString *pFile;` |
|       64 |  2425 | `	if( !pVm->bErrReport ){` |
|      ! 0 |  2426 | `		return PH7_OK;` |
|        - |  2427 | `	}` |
|       64 |  2428 | `	if( zClass == 0 \|\| nClass == 0 ){` |
...
|      ! 0 |  2435 | `	}` |
|       64 |  2436 | `	if( zFuncName == 0 \|\| nFuncLen <= 0 ){` |
|       64 |  2437 | `		VmGetFrameContext(pVm,&zFuncName,&nFuncLen);` |
|       31 |  2438 | `	}` |
|       64 |  2439 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|       64 |  2440 | `	SyBlobInit(&sOut,&pVm->sAllocator);` |
|       64 |  2441 | `	SyBlobAppend(&sOut,"PHP Fatal error:  Uncaught ",sizeof("PHP Fatal error:  Uncaught ")-1);` |
|       64 |  2442 | `	SyBlobAppend(&sOut,zClass,nClass);` |
|       64 |  2443 | `	SyBlobAppend(&sOut,": ",sizeof(": ")-1);` |
|       64 |  2444 | `	SyBlobAppend(&sOut,zMsg,nMsg);` |
|       64 |  2445 | `	if( pFile ){` |
|       64 |  2446 | `		SyBlobAppend(&sOut," in ",sizeof(" in ")-1);` |
|       64 |  2447 | `		SyBlobAppend(&sOut,pFile->zString,pFile->nByte);` |
|       64 |  2448 | `		SyBlobAppend(&sOut,":1",sizeof(":1")-1);` |
|       31 |  2449 | `	}` |
|       64 |  2450 | `	SyBlobAppend(&sOut,"\nStack trace:\n",sizeof("\nStack trace:\n")-1);` |
|       64 |  2451 | `	if( pFile ){` |
|       64 |  2452 | `		SyBlobAppend(&sOut,"#0 ",sizeof("#0 ")-1);` |
|       64 |  2453 | `		SyBlobAppend(&sOut,pFile->zString,pFile->nByte);` |
|       64 |  2454 | `		if( zFuncName && nFuncLen > 0 ){` |
|      ! 0 |  2455 | `			SyBlobFormat(&sOut,"(1): %.*s()\n",nFuncLen,zFuncName);` |
|      ! 0 |  2456 | `		}else{` |
|       64 |  2457 | `			SyBlobAppend(&sOut,"(1): {main}\n",sizeof("(1): {main}\n")-1);` |
|        2 |  2458 | `		}` |
|       31 |  2459 | `	}else if( zFuncName && nFuncLen > 0 ){` |
|      ! 0 |  2460 | `		SyBlobFormat(&sOut,"#0 [internal function]: %.*s()\n",nFuncLen,zFuncName);` |
|      ! 0 |  2461 | `	}else{` |
|      ! 0 |  2462 | `		SyBlobAppend(&sOut,"#0 {main}\n",sizeof("#0 {main}\n")-1);` |
|        - |  2463 | `	}` |
|       64 |  2464 | `	SyBlobAppend(&sOut,"#1 {main}",sizeof("#1 {main}")-1);` |
|       64 |  2465 | `	if( pFile ){` |
|       64 |  2466 | `		SyBlobAppend(&sOut,"\n",sizeof("\n")-1);` |
|       64 |  2467 | `		SyBlobAppend(&sOut,"  thrown in ",sizeof("  thrown in ")-1);` |
|       64 |  2468 | `		SyBlobAppend(&sOut,pFile->zString,pFile->nByte);` |
|       64 |  2469 | `		SyBlobAppend(&sOut," on line 1",sizeof(" on line 1")-1);` |
|       31 |  2470 | `	}` |
|       64 |  2471 | `	VmCallErrorHandler(pVm,&sOut);` |
|       64 |  2472 | `	SyBlobRelease(&sOut);` |
|       64 |  2473 | `	return PH7_ABORT;` |
|       33 |  2474 |  |
|        - |  2475 | `/*` |
|        - |  2476 | ` * Throw an internal exception instance that can be intercepted by try/catch.` |
|        - |  2477 | ` */` |
|       62 |  2478 | `PH7_PRIVATE sxi32 PH7_VmThrowException(ph7_context *pCtx,const char *zClass,const char *zFormat,...)` |
|        2 |  2479 |  |
|        - |  2480 | `	ph7_vm *pVm;` |
...
|        - |  2490 | `	sxi32 rc;` |
|        - |  2491 |  |
|       64 |  2492 | `	if( pCtx == 0 \|\| pCtx->pVm == 0 ){` |
|      ! 0 |  2493 | `		return PH7_ABORT;` |
|        - |  2494 | `	}` |
|       64 |  2495 | `	pVm = pCtx->pVm;` |
|       64 |  2496 | `	if( zClass == 0 \|\| zClass[0] == 0 ){` |
|      ! 0 |  2497 | `		zClass = "Error";` |
|      ! 0 |  2498 | `	}` |
|       64 |  2499 | `	pClass = PH7_VmExtractClass(&(*pVm),zClass,SyStrlen(zClass),TRUE,0);` |
|       64 |  2500 | `	if( pClass == 0 ){` |
...
|        - |  2504 | `			);` |
|        - |  2505 | `	}` |
|       64 |  2506 | `	pThis = PH7_NewClassInstance(&(*pVm),pClass);` |
|       64 |  2507 | `	if( pThis == 0 ){` |
...
|        - |  2511 | `	}` |
|        - |  2512 |  |
|       64 |  2513 | `	SyBlobInit(&sMsg,&pVm->sAllocator);` |
|       64 |  2514 | `	va_start(ap,zFormat);` |
|       64 |  2515 | `	SyBlobFormatAp(&sMsg,zFormat,ap);` |
|       64 |  2516 | `	va_end(ap);` |
|        - |  2517 |  |
|       64 |  2518 | `	pCons = PH7_ClassExtractMethod(pClass,"__construct",sizeof("__construct")-1);` |
|       64 |  2519 | `	if( pCons ){` |
|       64 |  2520 | `		SyStringInitFromBuf(&sMsgStr,(const char *)SyBlobData(&sMsg),SyBlobLength(&sMsg));` |
|       64 |  2521 | `		PH7_MemObjInitFromString(&(*pVm),&sArg,&sMsgStr);` |
|       64 |  2522 | `		apArg[0] = &sArg;` |
|       64 |  2523 | `		PH7_VmCallClassMethod(&(*pVm),pThis,pCons,0,1,apArg);` |
|       64 |  2524 | `		PH7_MemObjRelease(&sArg);` |
|       31 |  2525 | `	}` |
|       64 |  2526 | `	SyBlobRelease(&sMsg);` |
|        - |  2527 |  |
|       64 |  2528 | `	pFrame = pVm->pFrame;` |
|       64 |  2529 | `	if( pFrame ){` |
|       66 |  2530 | `		while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|        3 |  2531 | `			pFrame = pFrame->pParent;` |
|        1 |  2532 | `		}` |
|       64 |  2533 | `		pFrame->iFlags \|= VM_FRAME_THROW;` |
|       31 |  2534 | `	}` |
|       64 |  2535 | `	rc = VmThrowException(&(*pVm),pThis);` |
|       64 |  2536 | `	PH7_ClassInstanceUnref(pThis);` |
|       64 |  2537 | `	if( rc == SXERR_ABORT ){` |
|       62 |  2538 | `		return PH7_ABORT;` |
|        - |  2539 | `	}` |
...
|        - |  2593 | ` */` |
|    20252 |  2594 | `static sxi32 VmByteCodeExec(` |
...
|    20254 |  2610 | `	SySetInit(&aArg,&pVm->sAllocator,sizeof(ph7_value *));` |
|    20254 |  2611 | `	if( nTos < 0 ){` |
|    19630 |  2612 | `		pTos = &pStack[-1];` |
|     9816 |  2613 | `	}else{` |
|      626 |  2614 | `		pTos = &pStack[nTos];` |
|        - |  2615 | `	}` |
|    20254 |  2616 | `	pc = 0;` |
|        - |  2617 | `	/* Execute as much as we can */` |
|  3470863 |  2618 | `	for(;;){` |
|        - |  2619 | `		/* Fetch the instruction to execute */` |
|  6941024 |  2620 | `		pInstr = &aInstr[pc];` |
|  6941024 |  2621 | `		rc = SXRET_OK;` |
|        - |  2622 | `/*` |
...
|        - |  2628 | ` */` |
|  6941024 |  2629 | `		switch(pInstr->iOp){` |
|        - |  2630 | `/*` |
|        - |  2631 | ` * DONE: P1 * *` |
|        - |  2632 | ` *` |
...
|        - |  2635 | ` */` |
|    10088 |  2636 | `case PH7_OP_DONE:` |
|    20178 |  2637 | `	if( pInstr->iP1 ){` |
|        - |  2638 | `#ifdef UNTRUST` |
|        - |  2639 | `		if( pTos < pStack ){` |
|        - |  2640 | `			goto Abort;` |
|        - |  2641 | `		}` |
|        - |  2642 | `#endif` |
|    10882 |  2643 | `		if( pLastRef ){` |
|     7638 |  2644 | `			*pLastRef = pTos->nIdx;` |
|     3818 |  2645 | `		}` |
|    10882 |  2646 | `		if( pResult ){` |
|        - |  2647 | `			/* Execution result */` |
|    10534 |  2648 | `			PH7_MemObjStore(pTos,pResult);` |
|     5266 |  2649 | `		}` |
|    10882 |  2650 | `		VmPopOperand(&pTos,1);` |
|    14738 |  2651 | `	}else if( pLastRef ){` |
|        - |  2652 | `		/* Nothing referenced */` |
|      434 |  2653 | `		*pLastRef = SXU32_HIGH;` |
|      216 |  2654 | `	}` |
|    20178 |  2655 | `	goto Done;` |
|        - |  2656 | `/*` |
|        - |  2657 | ` * HALT: P1 * *` |
|        - |  2658 | ` *` |
...
|        - |  2702 | ` */` |
|   155054 |  2703 | `case PH7_OP_JMP:` |
|   310154 |  2704 | `	pc = pInstr->iP2 - 1;` |
|   310154 |  2705 | `	break;` |
|        - |  2706 | `/*` |
|        - |  2707 | ` * JZ: P1 P2 *` |
|        - |  2708 | ` *` |
...
|   696562 |  2719 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|       77 |  2720 | `		PH7_MemObjToBool(pTos);` |
|       38 |  2721 | `	}` |
|   696562 |  2722 | `	if( !pTos->x.iVal ){` |
|        - |  2723 | `		/* Take the jump */` |
|   334736 |  2724 | `		pc = pInstr->iP2 - 1;` |
|   167367 |  2725 | `	}` |
|   696562 |  2726 | `	if( !pInstr->iP1 ){` |
|   544382 |  2727 | `		VmPopOperand(&pTos,1);` |
|   272212 |  2728 | `	}` |
|   696562 |  2729 | `	break;` |
|        - |  2730 | `/*` |
|        - |  2731 | ` * JNZ: P1 P2 *` |
...
|    61366 |  2743 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      ! 0 |  2744 | `		PH7_MemObjToBool(pTos);` |
|      ! 0 |  2745 | `	}` |
|    61366 |  2746 | `	if( pTos->x.iVal ){` |
|        - |  2747 | `		/* Take the jump */` |
|     3162 |  2748 | `		pc = pInstr->iP2 - 1;` |
|     1580 |  2749 | `	}` |
|    61366 |  2750 | `	if( !pInstr->iP1 ){` |
...
|        - |  2766 | ` */` |
|   280995 |  2767 | `case PH7_OP_POP: {` |
|   562036 |  2768 | `	sxi32 n = pInstr->iP1;` |
|   562036 |  2769 | `	if( &pTos[-n+1] < pStack ){` |
|        - |  2770 | `		/* TICKET 1433-51 Stack underflow must be handled at run-time */` |
|      ! 0 |  2771 | `		n = (sxi32)(pTos - pStack);` |
|      ! 0 |  2772 | `	}` |
|   562036 |  2773 | `	VmPopOperand(&pTos,n);` |
|   562036 |  2774 | `	break;` |
|        - |  2775 | `				 }` |
|        - |  2776 | `/*` |
|        - |  2777 | ` * CVT_INT: * * *` |
...
|        - |  2906 | ` */` |
|     9244 |  2907 | `case PH7_OP_ERR_CTRL:` |
|        - |  2908 | `	/*` |
...
|        - |  2960 | ` */` |
|   619084 |  2961 | `case PH7_OP_LOADC: {` |
|        - |  2962 | `	ph7_value *pObj;` |
|        - |  2963 | `	/* Reserve a room */` |
|  1238214 |  2964 | `	pTos++;` |
|  1238214 |  2965 | `	if( (pObj = (ph7_value *)SySetAt(&pVm->aLitObj,pInstr->iP2)) != 0 ){` |
|  1238214 |  2966 | `		if( pInstr->iP1 == 1 && SyBlobLength(&pObj->sBlob) <= 64 ){` |
|        - |  2967 | `			SyHashEntry *pEntry;` |
|        - |  2968 | `			/* Candidate for expansion via user defined callbacks */` |
|    12506 |  2969 | `			pEntry = SyHashGet(&pVm->hConstant,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|    12506 |  2970 | `			if( pEntry ){` |
|    11218 |  2971 | `				ph7_constant *pCons = (ph7_constant *)pEntry->pUserData;` |
|        - |  2972 | `				/* Set a NULL default value */` |
|    11218 |  2973 | `				MemObjSetType(pTos,MEMOBJ_NULL);` |
|    11218 |  2974 | `				SyBlobReset(&pTos->sBlob);` |
|        - |  2975 | `				/* Invoke the callback and deal with the expanded value */` |
|    11218 |  2976 | `				pCons->xExpand(pTos,pCons->pUserData);` |
|        - |  2977 | `				/* Mark as constant */` |
|    11218 |  2978 | `				pTos->nIdx = SXU32_HIGH;` |
|    11218 |  2979 | `				break;` |
|        - |  2980 | `			}` |
|      644 |  2981 | `		}` |
|  1226998 |  2982 | `		PH7_MemObjLoad(pObj,pTos);` |
|   613522 |  2983 | `	}else{` |
|        - |  2984 | `		/* Set a NULL value */` |
|      ! 0 |  2985 | `		MemObjSetType(pTos,MEMOBJ_NULL);` |
|        - |  2986 | `	}` |
|        - |  2987 | `	/* Mark as constant */` |
|  1226998 |  2988 | `	pTos->nIdx = SXU32_HIGH;` |
|  1226998 |  2989 | `	break;` |
|        - |  2990 | `				  }` |
|        - |  2991 | `/*` |
|        - |  2992 | ` * LOAD: P1 * P3` |
...
|        - |  2998 | ` */` |
|   910430 |  2999 | `case PH7_OP_LOAD:{` |
|        - |  3000 | `	ph7_value *pObj;` |
|        - |  3001 | `	SyString sName;` |
|  1821082 |  3002 | `	if( pInstr->p3 == 0 ){` |
...
|       10 |  3014 | `	}else{` |
|  1821064 |  3015 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - |  3016 | `		/* Reserve a room for the target object */` |
|  1821064 |  3017 | `		pTos++;` |
|        - |  3018 | `	}` |
|        - |  3019 | `	/* Extract the requested memory object */` |
|  1821082 |  3020 | `	pObj = VmExtractMemObj(&(*pVm),&sName,pInstr->p3 ? FALSE : TRUE,pInstr->iP1 != 1);` |
|  1821082 |  3021 | `	if( pObj == 0 ){` |
|      462 |  3022 | `		if( pInstr->iP1 ){` |
|        - |  3023 | `			/* Variable not found,load NULL */` |
|      462 |  3024 | `			if( !pInstr->p3 ){` |
|      ! 0 |  3025 | `				PH7_MemObjRelease(pTos);` |
|      ! 0 |  3026 | `			}else{` |
|      462 |  3027 | `				MemObjSetType(pTos,MEMOBJ_NULL);` |
|        - |  3028 | `			}` |
|      462 |  3029 | `			pTos->nIdx = SXU32_HIGH; /* Mark as constant */` |
|   910662 |  3030 | `			break;` |
|      ! 0 |  3031 | `		}else{` |
|        - |  3032 | `			/* Fatal error */` |
...
|  1820622 |  3038 | `	PH7_MemObjLoad(pObj,pTos);` |
|  1820622 |  3039 | `	pTos->nIdx = pObj->nIdx;` |
|  1820622 |  3040 | `	break;` |
|        - |  3041 | `				   }` |
|        - |  3042 | `/*` |
|        - |  3043 | ` * LOAD_MAP P1 * *` |
...
|        - |  3048 | ` */` |
|    13352 |  3049 | `case PH7_OP_LOAD_MAP: {` |
|        - |  3050 | `	ph7_hashmap *pMap;` |
|        - |  3051 | `	/* Allocate a new hashmap instance */` |
|    26706 |  3052 | `	pMap = PH7_NewHashmap(&(*pVm),0,0);` |
|    26706 |  3053 | `	if( pMap == 0 ){` |
...
|      ! 0 |  3056 | `		goto Abort;` |
|        - |  3057 | `	}` |
|    26706 |  3058 | `	if( pInstr->iP1 > 0 ){` |
|     1440 |  3059 | `		ph7_value *pEntry = &pTos[-pInstr->iP1+1]; /* Point to the first entry */` |
|        - |  3060 | `		/* Perform the insertion */` |
|     4104 |  3061 | `		while( pEntry < pTos ){` |
|     2666 |  3062 | `			if( pEntry[1].iFlags & MEMOBJ_REFERENCE ){` |
...
|     3857 |  3070 | `				PH7_HashmapInsert(pMap,` |
|     2570 |  3071 | `					(pEntry->iFlags & MEMOBJ_NULL) ? 0 /* Automatic index assign */ : pEntry,` |
|     1285 |  3072 | `					&pEntry[1]` |
|        - |  3073 | `				);` |
|        - |  3074 | `			}` |
...
|     1440 |  3079 | `		VmPopOperand(&pTos,pInstr->iP1);` |
|      719 |  3080 | `	}` |
|        - |  3081 | `	/* Push the hashmap */` |
|    26706 |  3082 | `	pTos++;` |
|    26706 |  3083 | `	pTos->nIdx = SXU32_HIGH;` |
|    26706 |  3084 | `	pTos->x.pOther = pMap;` |
|    26706 |  3085 | `	MemObjSetType(pTos,MEMOBJ_HASHMAP);` |
|    26706 |  3086 | `	break;` |
|        - |  3087 | `					  }` |
|        - |  3088 | `/*` |
|        - |  3089 | ` * LOAD_LIST: P1 * *` |
...
|        - |  3140 | ` * instead.` |
|        - |  3141 | ` */` |
|   132176 |  3142 | `case PH7_OP_LOAD_IDX: {` |
|   264398 |  3143 | `	ph7_hashmap_node *pNode = 0; /* cc warning */` |
|   264398 |  3144 | `	ph7_hashmap *pMap = 0;` |
|        - |  3145 | `	ph7_value *pIdx;` |
|   264398 |  3146 | `	pIdx = 0;` |
|   264398 |  3147 | `	if( pInstr->iP1 == 0 ){` |
...
|        - |  3162 | `		}` |
|      ! 0 |  3163 | `	}else{` |
|   264398 |  3164 | `		pIdx = pTos;` |
|   264398 |  3165 | `		pTos--;` |
|        - |  3166 | `	}` |
|   264398 |  3167 | `	if( pTos->iFlags & MEMOBJ_STRING ){` |
|        - |  3168 | `		/* String access */` |
|   197962 |  3169 | `		if( pIdx ){` |
|        - |  3170 | `			sxu32 nOfft;` |
|   197962 |  3171 | `			if( (pIdx->iFlags & MEMOBJ_INT) == 0 ){` |
|        - |  3172 | `				/* Force an int cast */` |
|      ! 0 |  3173 | `				PH7_MemObjToInteger(pIdx);` |
|      ! 0 |  3174 | `			}` |
|   197962 |  3175 | `			nOfft = (sxu32)pIdx->x.iVal;` |
|   197962 |  3176 | `			if( nOfft >= SyBlobLength(&pTos->sBlob) ){` |
|        - |  3177 | `				/* Invalid offset,load null */` |
|      ! 0 |  3178 | `				PH7_MemObjRelease(pTos);` |
|      ! 0 |  3179 | `			}else{` |
|   197962 |  3180 | `				const char *zData = (const char *)SyBlobData(&pTos->sBlob);` |
|   197962 |  3181 | `				int c = zData[nOfft];` |
|   197962 |  3182 | `				PH7_MemObjRelease(pTos);` |
|   197962 |  3183 | `				MemObjSetType(pTos,MEMOBJ_STRING);` |
|   197962 |  3184 | `				SyBlobAppend(&pTos->sBlob,(const void *)&c,sizeof(char));` |
|        - |  3185 | `			}` |
|    99004 |  3186 | `		}else{` |
...
|   197962 |  3190 | `		break;` |
|        - |  3191 | `	}` |
|    66438 |  3192 | `	if( pInstr->iP2 && (pTos->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
...
|      ! 0 |  3199 | `		}` |
|      ! 0 |  3200 | `	}` |
|    66438 |  3201 | `	rc = SXERR_NOTFOUND; /* Assume the index is invalid */` |
|    66438 |  3202 | `	if( pTos->iFlags & MEMOBJ_HASHMAP ){` |
|        - |  3203 | `		/* Point to the hashmap */` |
|    66438 |  3204 | `		pMap = (ph7_hashmap *)pTos->x.pOther;` |
|    66438 |  3205 | `		if( pIdx ){` |
|        - |  3206 | `			/* Load the desired entry */` |
|    66438 |  3207 | `			rc = PH7_HashmapLookup(pMap,pIdx,&pNode);` |
|    33218 |  3208 | `		}` |
|    66438 |  3209 | `		if( rc != SXRET_OK && pInstr->iP2 ){` |
...
|    33218 |  3217 | `	}` |
|    66438 |  3218 | `	if( pIdx ){` |
|    66438 |  3219 | `		PH7_MemObjRelease(pIdx);` |
|    33218 |  3220 | `	}` |
|    66438 |  3221 | `	if( rc == SXRET_OK ){` |
|        - |  3222 | `		/* Load entry contents */` |
|    32008 |  3223 | `		if( pMap->iRef < 2 ){` |
...
|        - |  3226 | `			 */` |
|      ! 0 |  3227 | `			pTos->nIdx = SXU32_HIGH;` |
|      ! 0 |  3228 | `			PH7_HashmapExtractNodeValue(pNode,pTos,TRUE);` |
|      ! 0 |  3229 | `		}else{` |
|    32008 |  3230 | `			pTos->nIdx = pNode->nValIdx;` |
|    32008 |  3231 | `			PH7_HashmapExtractNodeValue(pNode,pTos,FALSE);` |
|    32008 |  3232 | `			PH7_HashmapUnref(pMap);` |
|        - |  3233 | `		}` |
|    16005 |  3234 | `	}else{` |
|        - |  3235 | `		/* No such entry,load NULL */` |
|    34432 |  3236 | `		PH7_MemObjRelease(pTos);` |
|    34432 |  3237 | `		pTos->nIdx = SXU32_HIGH;` |
|        - |  3238 | `	}` |
|    66438 |  3239 | `	break;` |
|        - |  3240 | `					  }` |
|        - |  3241 | `/*` |
...
|        - |  3321 | `	}` |
|        - |  3322 | `#endif` |
|   161108 |  3323 | `	if( pInstr->iP2 ){` |
|        - |  3324 | `		sxu32 nIdx;` |
|        - |  3325 | `		/* Member store operation */` |
|      778 |  3326 | `		nIdx = pTos->nIdx;` |
|      778 |  3327 | `		VmPopOperand(&pTos,1);` |
|      778 |  3328 | `		if( nIdx == SXU32_HIGH ){` |
...
|      774 |  3334 | `			pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|      774 |  3335 | `			if( pObj ){` |
|        - |  3336 | `				/* Perform the store operation */` |
|      774 |  3337 | `				PH7_MemObjStore(pTos,pObj);` |
|      386 |  3338 | `			}` |
|        - |  3339 | `		}` |
|    80943 |  3340 | `		break;` |
|   160332 |  3341 | `	}else if( pInstr->p3 == 0 ){` |
...
|        - |  3376 | ` */` |
|    68907 |  3377 | `case PH7_OP_STORE_IDX:` |
|        - |  3378 | `case PH7_OP_STORE_IDX_REF: {` |
|   137816 |  3379 | `	ph7_hashmap *pMap = 0; /* cc  warning */` |
|        - |  3380 | `	ph7_value *pKey;` |
|        - |  3381 | `	sxu32 nIdx;` |
|   137816 |  3382 | `	if( pInstr->iP1 ){` |
|        - |  3383 | `		/* Key is next on stack */` |
|    51102 |  3384 | `		pKey = pTos;` |
|    51102 |  3385 | `		pTos--;` |
|    25552 |  3386 | `	}else{` |
|    86716 |  3387 | `		pKey = 0;` |
|        - |  3388 | `	}` |
|   137816 |  3389 | `	nIdx = pTos->nIdx;` |
|   137816 |  3390 | `	if( pTos->iFlags & MEMOBJ_HASHMAP ){` |
|        - |  3391 | `		/* Hashmap already loaded */` |
|   137764 |  3392 | `		pMap = (ph7_hashmap *)pTos->x.pOther;` |
|   137764 |  3393 | `		if( pMap->iRef < 2 ){` |
...
|        - |  3450 | `	}` |
|   137764 |  3451 | `	VmPopOperand(&pTos,1);` |
|        - |  3452 | `	/* Phase#2: Perform the insertion */` |
|   137764 |  3453 | `	if( pInstr->iOp == PH7_OP_STORE_IDX_REF && pTos->nIdx != SXU32_HIGH ){` |
|        - |  3454 | `		/* Insertion by reference */` |
|       13 |  3455 | `		PH7_HashmapInsertByRef(pMap,pKey,pTos->nIdx);` |
|        7 |  3456 | `	}else{` |
|   137752 |  3457 | `		PH7_HashmapInsert(pMap,pKey,pTos);` |
|        - |  3458 | `	}` |
|   137764 |  3459 | `	if( pKey ){` |
|    51052 |  3460 | `		PH7_MemObjRelease(pKey);` |
|    25525 |  3461 | `	}` |
|   137764 |  3462 | `	break;` |
|        - |  3463 | `					   }` |
|        - |  3464 | `/*` |
...
|        - |  3470 | ` */` |
|   101147 |  3471 | `case PH7_OP_INCR:` |
|        - |  3472 | `#ifdef UNTRUST` |
|        - |  3473 | `	if( pTos < pStack ){` |
|        - |  3474 | `		goto Abort;` |
|        - |  3475 | `	}` |
|        - |  3476 | `#endif` |
|   202340 |  3477 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) == 0 ){` |
|   202340 |  3478 | `		if( pTos->nIdx != SXU32_HIGH ){` |
|        - |  3479 | `			ph7_value *pObj;` |
|   202340 |  3480 | `			if( (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pTos->nIdx)) != 0 ){` |
|        - |  3481 | `				/* Force a numeric cast */` |
|   202340 |  3482 | `				PH7_MemObjToNumeric(pObj);` |
|   202340 |  3483 | `				if( pObj->iFlags & MEMOBJ_REAL ){` |
|      ! 0 |  3484 | `					pObj->rVal++;` |
|        - |  3485 | `					/* Try to get an integer representation */` |
|      ! 0 |  3486 | `					PH7_MemObjTryInteger(pTos);` |
|      ! 0 |  3487 | `				}else{` |
|   202340 |  3488 | `					pObj->x.iVal++;` |
|   202340 |  3489 | `					MemObjSetType(pTos,MEMOBJ_INT);` |
|        - |  3490 | `				}` |
|   202340 |  3491 | `				if( pInstr->iP1 ){` |
|        - |  3492 | `					/* Pre-icrement */` |
...
|    34850 |  3574 | `	PH7_MemObjToNumeric(pTos);` |
|    34850 |  3575 | `	if( pTos->iFlags & MEMOBJ_REAL ){` |
|       23 |  3576 | `		pTos->rVal = -pTos->rVal;` |
|       11 |  3577 | `	}` |
|    34850 |  3578 | `	if( pTos->iFlags & MEMOBJ_INT ){` |
|    34828 |  3579 | `		pTos->x.iVal = -pTos->x.iVal;` |
|    17413 |  3580 | `	}` |
|    34850 |  3581 | `	break;` |
|        - |  3582 | `/*` |
|        - |  3583 | ` * UPLUS: * * *` |
...
|    58490 |  3615 | `	if( (pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|       21 |  3616 | `		PH7_MemObjToBool(pTos);` |
|       10 |  3617 | `	}` |
|    58490 |  3618 | `	pTos->x.iVal = !pTos->x.iVal;` |
|    58490 |  3619 | `	break;` |
|        - |  3620 | `/*` |
|        - |  3621 | ` * OP_BITNOT: * * *` |
|        - |  3622 | ` *` |
...
|        - |  3745 | ` */` |
|      280 |  3746 | `case PH7_OP_SUB: {` |
|      561 |  3747 | `	ph7_value *pNos = &pTos[-1];` |
|        - |  3748 | `#ifdef UNTRUST` |
|        - |  3749 | `	if( pNos < pStack ){` |
|        - |  3750 | `		goto Abort;` |
|        - |  3751 | `	}` |
|        - |  3752 | `#endif` |
|      561 |  3753 | `	if( MEMOBJ_REAL & (pTos->iFlags\|pNos->iFlags) ){` |
...
|        - |  3772 | `		sxi64 a,b,r;` |
|      489 |  3773 | `		a = pNos->x.iVal;` |
|      489 |  3774 | `		b = pTos->x.iVal;` |
|      489 |  3775 | `		r = a - b;` |
|        - |  3776 | `		/* Push the result */` |
|      489 |  3777 | `		pNos->x.iVal = r;` |
|      489 |  3778 | `		MemObjSetType(pNos,MEMOBJ_INT);` |
|        - |  3779 | `	}` |
|      561 |  3780 | `	VmPopOperand(&pTos,1);` |
|      561 |  3781 | `	break;` |
|        - |  3782 | `				 }` |
|        - |  3783 | `/* OP_SUB_STORE * * *` |
|        - |  3784 | ` *` |
...
|        - |  4220 | ` * back.` |
|        - |  4221 | ` */` |
|    51019 |  4222 | `case PH7_OP_CAT:{` |
|        - |  4223 | `	ph7_value *pNos,*pCur;` |
|   102040 |  4224 | `	if( pInstr->iP1 < 1 ){` |
|    75412 |  4225 | `		pNos = &pTos[-1];` |
|    37707 |  4226 | `	}else{` |
|    26630 |  4227 | `		pNos = &pTos[-pInstr->iP1+1];` |
|        - |  4228 | `	}` |
|        - |  4229 | `#ifdef UNTRUST` |
|        - |  4230 | `	if( pNos < pStack ){` |
|        - |  4231 | `		goto Abort;` |
...
|   102040 |  4235 | `	if( (pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|      532 |  4236 | `		PH7_MemObjToString(pNos);` |
|      265 |  4237 | `	}` |
|   102040 |  4238 | `	pCur = &pNos[1];` |
|   205158 |  4239 | `	while( pCur <= pTos ){` |
|   103120 |  4240 | `		if( (pCur->iFlags & MEMOBJ_STRING) == 0 ){` |
|    50144 |  4241 | `			PH7_MemObjToString(pCur);` |
|    25071 |  4242 | `		}` |
|        - |  4243 | `		/* Perform the concatenation */` |
|   103120 |  4244 | `		if( SyBlobLength(&pCur->sBlob) > 0 ){` |
|   103082 |  4245 | `			PH7_MemObjStringAppend(pNos,(const char *)SyBlobData(&pCur->sBlob),SyBlobLength(&pCur->sBlob));` |
|    51540 |  4246 | `		}` |
|   103120 |  4247 | `		SyBlobRelease(&pCur->sBlob);` |
|   103120 |  4248 | `		pCur++;` |
|        2 |  4249 | `	}` |
|   102040 |  4250 | `	pTos = pNos;` |
|   102040 |  4251 | `	break;` |
|        - |  4252 | `				}` |
|        - |  4253 | `/*  CAT_STORE: * * *` |
|        - |  4254 | ` *` |
...
|        - |  4256 | ` * back.` |
|        - |  4257 | ` */` |
|     1377 |  4258 | `case PH7_OP_CAT_STORE:{` |
|     2755 |  4259 | `	ph7_value *pNos = &pTos[-1];` |
|        - |  4260 | `	ph7_value *pObj;` |
|        - |  4261 | `#ifdef UNTRUST` |
|        - |  4262 | `	if( pNos < pStack ){` |
|        - |  4263 | `		goto Abort;` |
|        - |  4264 | `	}` |
|        - |  4265 | `#endif` |
|     2755 |  4266 | `	if((pTos->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - |  4267 | `		/* Force a string cast */` |
|      ! 0 |  4268 | `		PH7_MemObjToString(pTos);` |
|      ! 0 |  4269 | `	}` |
|     2755 |  4270 | `	if((pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - |  4271 | `		/* Force a string cast */` |
|      ! 0 |  4272 | `		PH7_MemObjToString(pNos);` |
|      ! 0 |  4273 | `	}` |
|        - |  4274 | `	/* Perform the concatenation (Reverse order) */` |
|     2755 |  4275 | `	if( SyBlobLength(&pNos->sBlob) > 0 ){` |
|     2755 |  4276 | `		PH7_MemObjStringAppend(pTos,(const char *)SyBlobData(&pNos->sBlob),SyBlobLength(&pNos->sBlob));` |
|     1377 |  4277 | `	}` |
|        - |  4278 | `	/* Perform the store operation */` |
|     2755 |  4279 | `	if( pTos->nIdx == SXU32_HIGH ){` |
|      ! 0 |  4280 | `		PH7_VmThrowError(&(*pVm),0,PH7_CTX_ERR,"Cannot perform assignment on a constant class attribute");` |
|     2755 |  4281 | `	}else if( (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pTos->nIdx)) != 0 ){` |
|     2755 |  4282 | `		PH7_MemObjStore(pTos,pObj);` |
|     1377 |  4283 | `	}` |
|     2755 |  4284 | `	PH7_MemObjStore(pTos,pNos);` |
|     2755 |  4285 | `	VmPopOperand(&pTos,1);` |
|     2755 |  4286 | `	break;` |
|        - |  4287 | `				}` |
|        - |  4288 | `/* OP_AND: * * *` |
|        - |  4289 | ` *` |
...
|        - |  4298 | ` * stack.` |
|        - |  4299 | ` */` |
|    61299 |  4300 | `case PH7_OP_LAND:` |
|        - |  4301 | `case PH7_OP_LOR: {` |
|   122644 |  4302 | `	ph7_value *pNos = &pTos[-1];` |
...
|   122644 |  4310 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|        3 |  4311 | `		PH7_MemObjToBool(pTos);` |
|        1 |  4312 | `	}` |
|   122644 |  4313 | `	if((pNos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      ! 0 |  4314 | `		PH7_MemObjToBool(pNos);` |
|      ! 0 |  4315 | `	}` |
|   122644 |  4316 | `	v1 = pNos->x.iVal == 0 ? 1 : 0;` |
|   122644 |  4317 | `	v2 = pTos->x.iVal == 0 ? 1 : 0;` |
|   122644 |  4318 | `	if( pInstr->iOp == PH7_OP_LAND ){` |
|        - |  4319 | `		static const unsigned char and_logic[] = { 0, 1, 2, 1, 1, 1, 2, 1, 2 };` |
|    64440 |  4320 | `		v1 = and_logic[v1*3+v2];` |
|    32243 |  4321 | `	}else{` |
|        - |  4322 | `		static const unsigned char or_logic[] = { 0, 0, 0, 0, 1, 2, 0, 2, 2 };` |
|    58206 |  4323 | `		v1 = or_logic[v1*3+v2];` |
|        - |  4324 | `	}` |
|   122644 |  4325 | `	if( v1 == 2 ){` |
|      ! 0 |  4326 | `		v1 = 1;` |
|      ! 0 |  4327 | `	}` |
|   122644 |  4328 | `	VmPopOperand(&pTos,1);` |
|   122644 |  4329 | `	pTos->x.iVal = v1 == 0 ? 1 : 0;` |
|   122644 |  4330 | `	MemObjSetType(pTos,MEMOBJ_BOOL);` |
|   122644 |  4331 | `	break;` |
|        - |  4332 | `				 }` |
|        - |  4333 | `/* OP_LXOR: * * *` |
|        - |  4334 | ` *` |
...
|        - |  4378 | ` */` |
|     3098 |  4379 | `case PH7_OP_EQ:` |
|        - |  4380 | `case PH7_OP_NEQ: {` |
|     6198 |  4381 | `	ph7_value *pNos = &pTos[-1];` |
...
|        - |  4386 | `	}` |
|        - |  4387 | `#endif` |
|     6198 |  4388 | `	rc = PH7_MemObjCmp(pNos,pTos,FALSE,0);` |
|     6198 |  4389 | `	if( VmIsUnorderedCmp(pNos,pTos) ){` |
|       11 |  4390 | `		rc = pInstr->iOp == PH7_OP_EQ ? 0 : 1;` |
|     6193 |  4391 | `	}else if( pInstr->iOp == PH7_OP_EQ ){` |
|     6162 |  4392 | `		rc = rc == 0;` |
|     3082 |  4393 | `	}else{` |
|       28 |  4394 | `		rc = rc != 0;` |
|        - |  4395 | `	}` |
|     6198 |  4396 | `	VmPopOperand(&pTos,1);` |
|     6198 |  4397 | `	if( !pInstr->iP2 ){` |
|        - |  4398 | `		/* Push comparison result without taking the jump */` |
|     6198 |  4399 | `		PH7_MemObjRelease(pTos);` |
|     6198 |  4400 | `		pTos->x.iVal = rc;` |
|        - |  4401 | `		/* Invalidate any prior representation */` |
|     6198 |  4402 | `		MemObjSetType(pTos,MEMOBJ_BOOL);` |
|     3100 |  4403 | `	}else{` |
|      ! 0 |  4404 | `		if( rc ){` |
...
|        - |  4418 | ` */` |
|    87376 |  4419 | `case PH7_OP_TEQ: {` |
|   174754 |  4420 | `	ph7_value *pNos = &pTos[-1];` |
...
|        - |  4425 | `	}` |
|        - |  4426 | `#endif` |
|   174754 |  4427 | `	rc = PH7_MemObjCmp(pNos,pTos,TRUE,0);` |
|   174754 |  4428 | `	if( VmIsUnorderedCmp(pNos,pTos) ){` |
|        3 |  4429 | `		rc = 0;` |
|        2 |  4430 | `	}else{` |
|   174752 |  4431 | `		rc = rc == 0;` |
|        - |  4432 | `	}` |
|   174754 |  4433 | `	VmPopOperand(&pTos,1);` |
|   174754 |  4434 | `	if( !pInstr->iP2 ){` |
|        - |  4435 | `		/* Push comparison result without taking the jump */` |
|   174754 |  4436 | `		PH7_MemObjRelease(pTos);` |
|   174754 |  4437 | `		pTos->x.iVal = rc;` |
|        - |  4438 | `		/* Invalidate any prior representation */` |
|   174754 |  4439 | `		MemObjSetType(pTos,MEMOBJ_BOOL);` |
|    87378 |  4440 | `	}else{` |
|      ! 0 |  4441 | `		if( rc ){` |
...
|        - |  4456 | ` *` |
|        - |  4457 | ` */` |
|    68850 |  4458 | `case PH7_OP_TNE: {` |
|   137702 |  4459 | `	ph7_value *pNos = &pTos[-1];` |
...
|        - |  4464 | `	}` |
|        - |  4465 | `#endif` |
|   137702 |  4466 | `	rc = PH7_MemObjCmp(pNos,pTos,TRUE,0);` |
|   137702 |  4467 | `	if( VmIsUnorderedCmp(pNos,pTos) ){` |
|        3 |  4468 | `		rc = 1;` |
|        2 |  4469 | `	}else{` |
|   137700 |  4470 | `		rc = rc != 0;` |
|        - |  4471 | `	}` |
|   137702 |  4472 | `	VmPopOperand(&pTos,1);` |
|   137702 |  4473 | `	if( !pInstr->iP2 ){` |
|        - |  4474 | `		/* Push comparison result without taking the jump */` |
|   137702 |  4475 | `		PH7_MemObjRelease(pTos);` |
|   137702 |  4476 | `		pTos->x.iVal = rc;` |
|        - |  4477 | `		/* Invalidate any prior representation */` |
|   137702 |  4478 | `		MemObjSetType(pTos,MEMOBJ_BOOL);` |
|    68852 |  4479 | `	}else{` |
|      ! 0 |  4480 | `		if( rc ){` |
...
|        - |  4504 | ` *` |
|        - |  4505 | ` */` |
|    74056 |  4506 | `case PH7_OP_LT:` |
|        - |  4507 | `case PH7_OP_LE: {` |
|   148158 |  4508 | `	ph7_value *pNos = &pTos[-1];` |
...
|        - |  4513 | `	}` |
|        - |  4514 | `#endif` |
|   148158 |  4515 | `	rc = PH7_MemObjCmp(pNos,pTos,FALSE,0);` |
|   148158 |  4516 | `	if( VmIsUnorderedCmp(pNos,pTos) ){` |
|        9 |  4517 | `		rc = 0;` |
|   148154 |  4518 | `	}else if( pInstr->iOp == PH7_OP_LE ){` |
|      395 |  4519 | `		rc = rc < 1;` |
|      198 |  4520 | `	}else{` |
|   147756 |  4521 | `		rc = rc < 0;` |
|        - |  4522 | `	}` |
|   148158 |  4523 | `	VmPopOperand(&pTos,1);` |
|   148158 |  4524 | `	if( !pInstr->iP2 ){` |
|        - |  4525 | `		/* Push comparison result without taking the jump */` |
|   148158 |  4526 | `		PH7_MemObjRelease(pTos);` |
|   148158 |  4527 | `		pTos->x.iVal = rc;` |
|        - |  4528 | `		/* Invalidate any prior representation */` |
|   148158 |  4529 | `		MemObjSetType(pTos,MEMOBJ_BOOL);` |
|    74102 |  4530 | `	}else{` |
|      ! 0 |  4531 | `		if( rc ){` |
...
|        - |  4555 | ` *` |
|        - |  4556 | ` */` |
|    26834 |  4557 | `case PH7_OP_GT:` |
|        - |  4558 | `case PH7_OP_GE: {` |
|    53670 |  4559 | `	ph7_value *pNos = &pTos[-1];` |
...
|        - |  4564 | `	}` |
|        - |  4565 | `#endif` |
|    53670 |  4566 | `	rc = PH7_MemObjCmp(pNos,pTos,FALSE,0);` |
|    53670 |  4567 | `	if( VmIsUnorderedCmp(pNos,pTos) ){` |
|        9 |  4568 | `		rc = 0;` |
|    53666 |  4569 | `	}else if( pInstr->iOp == PH7_OP_GE ){` |
|    53514 |  4570 | `		rc = rc >= 0;` |
|    26758 |  4571 | `	}else{` |
|      150 |  4572 | `		rc = rc > 0;` |
|        - |  4573 | `	}` |
|    53670 |  4574 | `	VmPopOperand(&pTos,1);` |
|    53670 |  4575 | `	if( !pInstr->iP2 ){` |
|        - |  4576 | `		/* Push comparison result without taking the jump */` |
|    53670 |  4577 | `		PH7_MemObjRelease(pTos);` |
|    53670 |  4578 | `		pTos->x.iVal = rc;` |
|        - |  4579 | `		/* Invalidate any prior representation */` |
|    53670 |  4580 | `		MemObjSetType(pTos,MEMOBJ_BOOL);` |
|    26836 |  4581 | `	}else{` |
|      ! 0 |  4582 | `		if( rc ){` |
...
|        - |  4879 | ` */` |
|     3543 |  4880 | `case PH7_OP_FOREACH_INIT: {` |
|     7088 |  4881 | `	ph7_foreach_info *pInfo = (ph7_foreach_info *)pInstr->p3;` |
|        - |  4882 | `	void *pName;` |
|        - |  4883 | `#ifdef UNTRUST` |
|        - |  4884 | `	if( pTos < pStack ){` |
|        - |  4885 | `		goto Abort;` |
|        - |  4886 | `	}` |
|        - |  4887 | `#endif` |
|     7088 |  4888 | `	if( SyStringLength(&pInfo->sValue) < 1 ){` |
...
|      ! 0 |  4900 | `	}` |
|     7088 |  4901 | `	if( (pInfo->iFlags & PH7_4EACH_STEP_KEY) && SyStringLength(&pInfo->sKey) < 1 ){` |
...
|     7088 |  4914 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ)) == 0 \|\| SyStringLength(&pInfo->sValue) < 1 ){` |
...
|     7088 |  4922 | `		pStep = (ph7_foreach_step *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_foreach_step));` |
|     7088 |  4923 | `		if( pStep == 0 ){` |
...
|     7088 |  4929 | `			SyZero(pStep,sizeof(ph7_foreach_step));` |
|        - |  4930 | `			/* Prepare the step */` |
|     7088 |  4931 | `			pStep->iFlags = pInfo->iFlags;` |
|     7088 |  4932 | `			if( pTos->iFlags & MEMOBJ_HASHMAP ){` |
|     7080 |  4933 | `				ph7_hashmap *pMap = (ph7_hashmap *)pTos->x.pOther;` |
|        - |  4934 | `				/* Reset the internal loop cursor */` |
|     7080 |  4935 | `				PH7_HashmapResetLoopCursor(pMap);` |
|        - |  4936 | `				/* Mark the step */` |
|     7080 |  4937 | `				pStep->iFlags \|= PH7_4EACH_STEP_HASHMAP;` |
|     7080 |  4938 | `				pStep->xIter.pMap = pMap;` |
|     7080 |  4939 | `				pMap->iRef++;` |
|     3541 |  4940 | `			}else{` |
...
|        - |  4948 | `			}` |
|        - |  4949 | `		}` |
|     7088 |  4950 | `		if( SXRET_OK != SySetPut(&pInfo->aStep,(const void *)&pStep) ){` |
...
|        - |  4963 | ` */` |
|    59548 |  4964 | `case PH7_OP_FOREACH_STEP: {` |
|   119098 |  4965 | `	ph7_foreach_info *pInfo = (ph7_foreach_info *)pInstr->p3;` |
|        - |  4966 | `	ph7_foreach_step **apStep,*pStep;` |
|        - |  4967 | `	ph7_value *pValue;` |
|        - |  4968 | `	VmFrame *pFrameLocal;` |
|        - |  4969 | `	/* Peek the last step */` |
|   119098 |  4970 | `	apStep = (ph7_foreach_step **)SySetBasePtr(&pInfo->aStep);` |
|   119098 |  4971 | `	pStep = apStep[SySetUsed(&pInfo->aStep) - 1];` |
|   119098 |  4972 | `	pFrameLocal = pVm->pFrame;` |
|   124130 |  4973 | `	while( pFrameLocal->pParent && (pFrameLocal->iFlags & VM_FRAME_EXCEPTION) ){` |
|        - |  4974 | `		/* Safely ignore the exception frame */` |
|     5033 |  4975 | `		pFrameLocal = pFrameLocal->pParent;` |
|        1 |  4976 | `	}` |
|   119098 |  4977 | `	if( pStep->iFlags & PH7_4EACH_STEP_HASHMAP ){` |
|   119074 |  4978 | `		ph7_hashmap *pMap = pStep->xIter.pMap;` |
|        - |  4979 | `		ph7_hashmap_node *pNode;` |
|        - |  4980 | `		/* Extract the current node value */` |
|   119074 |  4981 | `		pNode = PH7_HashmapGetNextEntry(pMap);` |
|   119074 |  4982 | `		if( pNode == 0 ){` |
|        - |  4983 | `			/* No more entry to process */` |
|     7080 |  4984 | `			pc = pInstr->iP2 - 1; /* Jump to this destination */` |
|     7080 |  4985 | `			if( pStep->iFlags & PH7_4EACH_STEP_REF ){` |
...
|     7080 |  4990 | `			PH7_HashmapResetLoopCursor(pMap);` |
|        - |  4991 | `			/* Cleanup the mess left behind */` |
|     7080 |  4992 | `			SyMemBackendPoolFree(&pVm->sAllocator,pStep);` |
|     7080 |  4993 | `			SySetPop(&pInfo->aStep);` |
|     7080 |  4994 | `			PH7_HashmapUnref(pMap);` |
|     3541 |  4995 | `		}else{` |
|   111996 |  4996 | `			if( (pStep->iFlags & PH7_4EACH_STEP_KEY) && SyStringLength(&pInfo->sKey) > 0 ){` |
|      135 |  4997 | `				ph7_value *pKey = VmExtractMemObj(&(*pVm),&pInfo->sKey,FALSE,TRUE);` |
|      135 |  4998 | `				if( pKey ){` |
|      135 |  4999 | `					PH7_HashmapExtractNodeKey(pNode,pKey);` |
|       67 |  5000 | `				}` |
|       67 |  5001 | `			}` |
|   111996 |  5002 | `			if( pStep->iFlags & PH7_4EACH_STEP_REF ){` |
...
|   111984 |  5014 | `				pValue = VmExtractMemObj(&(*pVm),&pInfo->sValue,FALSE,TRUE);` |
|   111984 |  5015 | `				if( pValue ){` |
|   111984 |  5016 | `					PH7_HashmapExtractNodeValue(pNode,pValue,TRUE);` |
|    55991 |  5017 | `				}` |
|        - |  5018 | `			}` |
|        - |  5019 | `		}` |
|    59538 |  5020 | `	}else{` |
...
|        - |  5082 | ` */` |
|      600 |  5083 | `case PH7_OP_MEMBER: {` |
|        - |  5084 | `	ph7_class_instance *pThis;` |
|        - |  5085 | `	ph7_value *pNos;` |
|        - |  5086 | `	SyString sName;` |
|     1202 |  5087 | `	if( !pInstr->iP1 ){` |
|     1144 |  5088 | `		pNos = &pTos[-1];` |
|        - |  5089 | `#ifdef UNTRUST` |
|        - |  5090 | `		if( pNos < pStack ){` |
|        - |  5091 | `			goto Abort;` |
|        - |  5092 | `		}` |
|        - |  5093 | `#endif` |
|     1144 |  5094 | `		if( pNos->iFlags & MEMOBJ_OBJ ){` |
|        - |  5095 | `			ph7_class *pClass;` |
|        - |  5096 | `			/* Class already instantiated */` |
|     1144 |  5097 | `			pThis = (ph7_class_instance *)pNos->x.pOther;` |
|        - |  5098 | `			/* Point to the instantiated class */` |
|     1144 |  5099 | `			pClass = pThis->pClass;` |
|        - |  5100 | `			/* Extract attribute name first */` |
|     1144 |  5101 | `			SyStringInitFromBuf(&sName,(const char *)SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
|     1144 |  5102 | `			if( pInstr->iP2 ){` |
|        - |  5103 | `				/* Method call */` |
...
|     1026 |  5127 | `				VmClassAttr *pObjAttr = 0;` |
|        - |  5128 | `				SyHashEntry *pEntry;` |
|        - |  5129 | `				/* Extract the target attribute */` |
|     1026 |  5130 | `				if( sName.nByte > 0 ){` |
|     1026 |  5131 | `					pEntry = SyHashGet(&pThis->hAttr,(const void *)sName.zString,sName.nByte);` |
|     1026 |  5132 | `					if( pEntry ){` |
|        - |  5133 | `						/* Point to the attribute value */` |
|     1024 |  5134 | `						pObjAttr = (VmClassAttr *)pEntry->pUserData;` |
|      511 |  5135 | `					}` |
|      512 |  5136 | `				}` |
|     1026 |  5137 | `				if( pObjAttr == 0 ){` |
...
|        - |  5148 | `				 */` |
|     1026 |  5149 | `				pThis->iRef++;` |
|     1026 |  5150 | `				PH7_MemObjRelease(pTos);` |
|     1026 |  5151 | `				pTos->nIdx = SXU32_HIGH; /* Assume we are loading a constant */` |
|     1026 |  5152 | `				if( pObjAttr ){` |
|     1024 |  5153 | `					ph7_value *pValue = 0; /* cc warning */` |
|        - |  5154 | `					/* Check attribute access */` |
|     1024 |  5155 | `					if( VmClassMemberAccess(&(*pVm),pClass,&pObjAttr->pAttr->sName,pObjAttr->pAttr->iProtection,TRUE) ){` |
|        - |  5156 | `						/* Load attribute */` |
|     1024 |  5157 | `						pValue = (ph7_value *)SySetAt(&pVm->aMemObj,pObjAttr->nIdx);` |
|     1024 |  5158 | `						if( pValue ){` |
|     1024 |  5159 | `							if( pThis->iRef < 2 ){` |
...
|        2 |  5164 | `							}else{` |
|        - |  5165 | `								/* Simple load */` |
|     1022 |  5166 | `								PH7_MemObjLoad(pValue,pTos);` |
|        - |  5167 | `							}` |
|     1024 |  5168 | `							if( (pObjAttr->pAttr->iFlags & PH7_CLASS_ATTR_CONSTANT) == 0 ){` |
|     1022 |  5169 | `								if( pThis->iRef > 1 ){` |
|        - |  5170 | `									/* Load attribute index */` |
|     1020 |  5171 | `									pTos->nIdx = pObjAttr->nIdx;` |
|      509 |  5172 | `								}` |
|      510 |  5173 | `							}` |
|      511 |  5174 | `						}` |
|      511 |  5175 | `					}` |
...
|     1026 |  5178 | `				PH7_ClassInstanceUnref(pThis);` |
|        - |  5179 | `			}` |
|      573 |  5180 | `		}else{` |
...
|        - |  5504 | ` */` |
|   214256 |  5505 | `case PH7_OP_CALL: {` |
|   428558 |  5506 | `	ph7_value *pArg = &pTos[-pInstr->iP1];` |
|        - |  5507 | `	SyHashEntry *pEntry;` |
|        - |  5508 | `	SyString sName;` |
|        - |  5509 | `	/* Extract function name */` |
|   428558 |  5510 | `	if( (pTos->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|   214225 |  5545 | `		break;` |
|        - |  5546 | `	}` |
|   428556 |  5547 | `	SyStringInitFromBuf(&sName,SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
|        - |  5548 | `	/* Check for a compiled function first */` |
|   428556 |  5549 | `	pEntry = SyHashGet(&pVm->hFunction,(const void *)sName.zString,sName.nByte);` |
|   428556 |  5550 | `	if( pEntry ){` |
...
|     8072 |  5561 | `		pVmFunc = (ph7_vm_func *)pEntry->pUserData;` |
|     8072 |  5562 | `		pThis = 0;` |
|     8072 |  5563 | `		pSelf = 0;` |
|     8072 |  5564 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
|        - |  5565 | `			ph7_class_method *pMeth;` |
|        - |  5566 | `			/* Class method call */` |
|      470 |  5567 | `			ph7_value *pTarget = &pTos[-1];` |
|      470 |  5568 | `			if( pTarget >= pStack && (pTarget->iFlags & (MEMOBJ_STRING\|MEMOBJ_OBJ\|MEMOBJ_NULL)) ){` |
|        - |  5569 | `				/* Extract the 'this' pointer */` |
|      470 |  5570 | `				if(pTarget->iFlags & MEMOBJ_OBJ ){` |
|        - |  5571 | `					/* Instance already loaded */` |
|      440 |  5572 | `					pThis = (ph7_class_instance *)pTarget->x.pOther;` |
|      440 |  5573 | `					pThis->iRef++;` |
|      440 |  5574 | `					pSelf = pThis->pClass;` |
|      219 |  5575 | `				}` |
|      470 |  5576 | `				if( pSelf == 0 ){` |
...
|        9 |  5598 | `					}` |
|       15 |  5599 | `				}` |
|      470 |  5600 | `				VmPopOperand(&pTos,1);` |
|      470 |  5601 | `				PH7_MemObjRelease(pTos);` |
|        - |  5602 | `				/* Synchronize pointers */` |
|      470 |  5603 | `				pArg = &pTos[-pInstr->iP1];` |
...
|        - |  5608 | `				 */` |
|      470 |  5609 | `				while( pArg < pStack ){` |
|      ! 0 |  5610 | `					pArg++;` |
|      ! 0 |  5611 | `				}` |
|      470 |  5612 | `				if( pSelf ){ /* Paranoid edition */` |
|        - |  5613 | `					/* Check if the call is allowed */` |
|      470 |  5614 | `					pMeth = PH7_ClassExtractMethod(pSelf,pVmFunc->sName.zString,pVmFunc->sName.nByte);` |
|      470 |  5615 | `					if( pMeth && pMeth->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|     8072 |  5630 | `		if( pVm->nRecursionDepth > pVm->nMaxDepth ){` |
...
|        3 |  5640 | `			break;` |
|        - |  5641 | `		}` |
|     8070 |  5642 | `		if( pVmFunc->pNextName ){` |
...
|     8070 |  5647 | `		aFormalArg = (ph7_vm_func_arg *)SySetBasePtr(&pVmFunc->aArgs);` |
|        - |  5648 | `		/* Create a new VM frame  */` |
|     8070 |  5649 | `		rc = VmEnterFrame(&(*pVm),pVmFunc,pThis,&pFrame);` |
|     8070 |  5650 | `		if( rc != SXRET_OK ){` |
...
|      ! 0 |  5661 | `			break;` |
|        - |  5662 | `		}` |
|     8070 |  5663 | `		if( (pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) && pThis ){` |
|        - |  5664 | `			/* Install the '$this' variable */` |
|        - |  5665 | `			static const SyString sThis = { "this" , sizeof("this") - 1 };` |
|      450 |  5666 | `			pObj = VmExtractMemObj(&(*pVm),&sThis,FALSE,TRUE);` |
|      450 |  5667 | `			if( pObj ){` |
|        - |  5668 | `				/* Reflect the change */` |
|      450 |  5669 | `				pObj->x.pOther = pThis;` |
|      450 |  5670 | `				MemObjSetType(pObj,MEMOBJ_OBJ);` |
|      224 |  5671 | `			}` |
|      224 |  5672 | `		}` |
|     8070 |  5673 | `		if( SySetUsed(&pVmFunc->aStatic) > 0 ){` |
...
|     8070 |  5700 | `		n = 0;` |
|    22992 |  5701 | `		while( pArg < pTos ){` |
|    14924 |  5702 | `			if( n < SySetUsed(&pVmFunc->aArgs) ){` |
|    14824 |  5703 | `				if( (pArg->iFlags & MEMOBJ_NULL) && SySetUsed(&aFormalArg[n].aByteCode) > 0 ){` |
...
|    14824 |  5711 | `				if( aFormalArg[n].nType > 0 ){` |
|      990 |  5712 | `					if ( aFormalArg[n].nType == SXU32_HIGH ){` |
...
|        - |  5736 | `							}` |
|      ! 0 |  5737 | `						}` |
|      990 |  5738 | `					}else if( ((pArg->iFlags & aFormalArg[n].nType) == 0) ){` |
|      ! 0 |  5739 | `						ProcMemObjCast xCast = PH7_MemObjCastMethod(aFormalArg[n].nType);` |
|        - |  5740 | `						/* Cast to the desired type */` |
|      ! 0 |  5741 | `						xCast(pArg);` |
|      ! 0 |  5742 | `					}` |
|      494 |  5743 | `				}` |
|    14824 |  5744 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_BY_REF ){` |
...
|    14800 |  5770 | `					pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|        - |  5771 | `				}` |
|     7413 |  5772 | `			}else{` |
|        - |  5773 | `				char zName[32];` |
...
|        - |  5780 | `			}` |
|    14924 |  5781 | `			if( pObj ){` |
|    14900 |  5782 | `				PH7_MemObjStore(pArg,pObj);` |
|        - |  5783 | `				/* Insert argument index  */` |
|    14900 |  5784 | `				sArg.nIdx = pObj->nIdx;` |
|    14900 |  5785 | `				sArg.pUserData = 0;` |
|    14900 |  5786 | `				SySetPut(&pFrame->sArg,(const void *)&sArg);` |
|     7449 |  5787 | `			}` |
|    14924 |  5788 | `			PH7_MemObjRelease(pArg);` |
|    14924 |  5789 | `			pArg++;` |
|    14924 |  5790 | `			++n;` |
|        2 |  5791 | `		}` |
|        - |  5792 | `		/* Set up closure environment */` |
|     8070 |  5793 | `		if( pVmFunc->iFlags & VM_FUNC_CLOSURE ){` |
...
|     8990 |  5815 | `		while( n < SySetUsed(&pVmFunc->aArgs) ){` |
|      922 |  5816 | `			if( SySetUsed(&aFormalArg[n].aByteCode) > 0 ){` |
|      912 |  5817 | `				pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|      912 |  5818 | `				if( pObj ){` |
|        - |  5819 | `					/* Evaluate the default value and extract it's result */` |
|      912 |  5820 | `					rc = VmLocalExec(&(*pVm),&aFormalArg[n].aByteCode,pObj);` |
|      912 |  5821 | `					if( rc == PH7_ABORT ){` |
|      ! 0 |  5822 | `						goto Abort;` |
|        - |  5823 | `					}` |
|        - |  5824 | `					/* Insert argument index */` |
|      912 |  5825 | `					sArg.nIdx = pObj->nIdx;` |
|      912 |  5826 | `					sArg.pUserData = 0;` |
|      912 |  5827 | `					SySetPut(&pFrame->sArg,(const void *)&sArg);` |
|        - |  5828 | `					/* Make sure the default argument is of the correct type */` |
|      912 |  5829 | `					if( aFormalArg[n].nType > 0 && ((pObj->iFlags & aFormalArg[n].nType) == 0) ){` |
...
|        - |  5840 | `		 */` |
|     8070 |  5841 | `		PH7_MemObjRelease(pTos);` |
|     8070 |  5842 | `		pTos = &pTos[-pInstr->iP1];` |
|        - |  5843 | `		/* Allocate a new operand stack and evaluate the function body */` |
|     8070 |  5844 | `		pFrameStack = VmNewOperandStack(&(*pVm),SySetUsed(&pVmFunc->aByteCode));` |
|     8070 |  5845 | `		if( pFrameStack == 0 ){` |
...
|      468 |  5856 | `			SySetPut(&pVm->aSelf,(const void *)&pSelf);` |
|      233 |  5857 | `		}` |
|        - |  5858 | `		/* Increment nesting level */` |
|     8070 |  5859 | `		pVm->nRecursionDepth++;` |
|        - |  5860 | `		/* Execute function body */` |
|     8070 |  5861 | `		rc = VmByteCodeExec(&(*pVm),(VmInstr *)SySetBasePtr(&pVmFunc->aByteCode),pFrameStack,-1,pTos,&n,FALSE);` |
|        - |  5862 | `		/* Decrement nesting level */` |
|     8070 |  5863 | `		pVm->nRecursionDepth--;` |
|     8070 |  5864 | `		if( pSelf ){` |
|        - |  5865 | `			/* Pop class name */` |
|      468 |  5866 | `			(void)SySetPop(&pVm->aSelf);` |
|      233 |  5867 | `		}` |
|        - |  5868 | `		/* Cleanup the mess left behind */` |
|     8070 |  5869 | `		if( (pVmFunc->iFlags & VM_FUNC_REF_RETURN) && rc == SXRET_OK ){` |
...
|     8070 |  5897 | `		if( rc != PH7_ABORT && ((pFrame->iFlags & VM_FRAME_THROW) \|\| rc == PH7_EXCEPTION) ){` |
...
|     8070 |  5916 | `		SyMemBackendFree(&pVm->sAllocator,pFrameStack);` |
|        - |  5917 | `		/* Leave the frame */` |
|     8070 |  5918 | `		VmLeaveFrame(&(*pVm));` |
|     8070 |  5919 | `		if( rc == PH7_ABORT ){` |
|        - |  5920 | `			/* Abort processing immeditaley */` |
|      ! 0 |  5921 | `			goto Abort;` |
|     8070 |  5922 | `		}else if( rc == PH7_EXCEPTION ){` |
...
|   420486 |  5930 | `		pEntry = SyHashGet(&pVm->hHostFunction,(const void *)sName.zString,sName.nByte);` |
|   420486 |  5931 | `		if( pEntry == 0 ){` |
...
|        5 |  5940 | `			break;` |
|        - |  5941 | `		}` |
|   420482 |  5942 | `		pFunc = (ph7_user_func *)pEntry->pUserData;` |
|        - |  5943 | `		/* Start collecting function arguments */` |
|   420482 |  5944 | `		SySetReset(&aArg);` |
|  1136540 |  5945 | `		while( pArg < pTos ){` |
|   716060 |  5946 | `			SySetPut(&aArg,(const void *)&pArg);` |
|   716060 |  5947 | `			pArg++;` |
|        2 |  5948 | `		}` |
|        - |  5949 | `		/* Assume a null return value */` |
|   420482 |  5950 | `		PH7_MemObjInit(&(*pVm),&sRet);` |
|        - |  5951 | `		/* Init the call context */` |
|   420482 |  5952 | `		VmInitCallContext(&sCtx,&(*pVm),pFunc,&sRet,0);` |
|        - |  5953 | `		/* Call the foreign function */` |
|   420482 |  5954 | `		rc = pFunc->xFunc(&sCtx,(int)SySetUsed(&aArg),(ph7_value **)SySetBasePtr(&aArg));` |
|        - |  5955 | `		/* Release the call context */` |
|   420482 |  5956 | `		VmReleaseCallContext(&sCtx);` |
|   420482 |  5957 | `		if( rc == PH7_ABORT ){` |
|       64 |  5958 | `			goto Abort;` |
|   420420 |  5959 | `		}else if( rc == PH7_EXCEPTION ){` |
|        3 |  5960 | `			goto Exception;` |
|        - |  5961 | `		}` |
|   420418 |  5962 | `		if( pInstr->iP1 > 0 ){` |
|        - |  5963 | `			/* Pop function name and arguments */` |
|   405670 |  5964 | `			VmPopOperand(&pTos,pInstr->iP1);` |
|   202856 |  5965 | `		}` |
|        - |  5966 | `		/* Save foreign function return value */` |
|   420418 |  5967 | `		PH7_MemObjStore(&sRet,pTos);` |
|   420418 |  5968 | `		PH7_MemObjRelease(&sRet);` |
|        - |  5969 | `	}` |
|   428484 |  5970 | `	break;` |
|        - |  5971 | `				  }` |
|        - |  5972 | `/*` |
...
|        - |  5975 | ` */` |
|     8248 |  5976 | `case PH7_OP_CONSUME: {` |
|    16498 |  5977 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|    16498 |  5978 | `	ph7_value *pCur,*pOut = pTos;` |
|        - |  5979 |  |
|    16498 |  5980 | `	pOut = &pTos[-pInstr->iP1 + 1];` |
|    16498 |  5981 | `	pCur = pOut;` |
|        - |  5982 | `	/* Start the consume process  */` |
|    32994 |  5983 | `	while( pOut <= pTos ){` |
|        - |  5984 | `		/* Force a string cast */` |
|    16498 |  5985 | `		if( (pOut->iFlags & MEMOBJ_STRING) == 0 ){` |
|       56 |  5986 | `			PH7_MemObjToString(pOut);` |
|       27 |  5987 | `		}` |
|    16498 |  5988 | `		if( SyBlobLength(&pOut->sBlob) > 0 ){` |
|        - |  5989 | `			/*SyBlobNullAppend(&pOut->sBlob);*/` |
|        - |  5990 | `			/* Invoke the output consumer callback */` |
|     8890 |  5991 | `			rc = pCons->xConsumer(SyBlobData(&pOut->sBlob),SyBlobLength(&pOut->sBlob),pCons->pUserData);` |
|     8890 |  5992 | `			if( pCons->xConsumer != VmObConsumer ){` |
|        - |  5993 | `				/* Increment output length */` |
|     3370 |  5994 | `				pVm->nOutputLen += SyBlobLength(&pOut->sBlob);` |
|     1684 |  5995 | `			}` |
|     8890 |  5996 | `			SyBlobRelease(&pOut->sBlob);` |
|     8890 |  5997 | `			if( rc == SXERR_ABORT ){` |
...
|    16498 |  6002 | `		pOut++;` |
|        2 |  6003 | `	}` |
|    16498 |  6004 | `	pTos = &pCur[-1];` |
|    16496 |  6005 | `	break;` |
|        - |  6006 | `					 }` |
|        - |  6007 |  |
|        - |  6008 | `		} /* Switch() */` |
|  6920772 |  6009 | `		pc++; /* Next instruction in the stream */` |
|        2 |  6010 | `	} /* For(;;) */` |
|    10088 |  6011 | `Done:` |
|    20178 |  6012 | `	SySetRelease(&aArg);` |
|    20178 |  6013 | `	return SXRET_OK;` |
|       32 |  6014 | `Abort:` |
|       66 |  6015 | `	SySetRelease(&aArg);` |
|      216 |  6016 | `	while( pTos >= pStack ){` |
|      152 |  6017 | `		PH7_MemObjRelease(pTos);` |
|      152 |  6018 | `		pTos--;` |
|        2 |  6019 | `	}` |
|       66 |  6020 | `	return PH7_ABORT;` |
|        2 |  6021 | `Exception:` |
...
|        - |  6033 | ` */` |
|    10498 |  6034 | `static sxi32 VmLocalExec(ph7_vm *pVm,SySet *pByteCode,ph7_value *pResult)` |
|        2 |  6035 |  |
|        - |  6036 | `	ph7_value *pStack;` |
|        - |  6037 | `	sxi32 rc;` |
|        - |  6038 | `	/* Allocate a new operand stack */` |
|    10500 |  6039 | `	pStack = VmNewOperandStack(&(*pVm),SySetUsed(pByteCode));` |
|    10500 |  6040 | `	if( pStack == 0 ){` |
|      ! 0 |  6041 | `		return SXERR_MEM;` |
|        - |  6042 | `	}` |
|        - |  6043 | `	/* Execute the program */` |
|    10500 |  6044 | `	rc = VmByteCodeExec(&(*pVm),(VmInstr *)SySetBasePtr(pByteCode),pStack,-1,&(*pResult),0,FALSE);` |
|        - |  6045 | `	/* Free the operand stack */` |
|    10500 |  6046 | `	SyMemBackendFree(&pVm->sAllocator,pStack);` |
|        - |  6047 | `	/* Execution result */` |
|    10500 |  6048 | `	return rc;` |
|     5251 |  6049 |  |
|        - |  6050 | `/*` |
...
|        - |  6058 | ` */` |
|     1054 |  6059 | `static void VmInvokeShutdownCallbacks(ph7_vm *pVm)` |
|        2 |  6060 |  |
...
|     1056 |  6066 | `	nEntry = SySetUsed(&pVm->aShutdown);` |
|    11596 |  6067 | `	for( i = 0 ; i < (int)SX_ARRAYSIZE(apArg) ; i++ ){` |
|    10542 |  6068 | `		apArg[i] = 0;` |
|     5272 |  6069 | `	}` |
|     1058 |  6070 | `	for( n = 0 ; n < nEntry ; ++n ){` |
...
|        1 |  6093 | `		}` |
|        2 |  6094 | `	}` |
|     1056 |  6095 | `	SySetReset(&pVm->aShutdown);` |
|     1056 |  6096 |  |
|        - |  6097 | `/*` |
...
|        - |  6101 | ` */` |
|     1062 |  6102 | `PH7_PRIVATE sxi32 PH7_VmByteCodeExec(ph7_vm *pVm)` |
|        2 |  6103 |  |
|        - |  6104 | `	/* Make sure we are ready to execute this program */` |
|     1064 |  6105 | `	if( pVm->nMagic != PH7_VM_RUN ){` |
|      ! 0 |  6106 | `		return pVm->nMagic == PH7_VM_EXEC ? SXERR_LOCKED /* Locked VM */ : SXERR_CORRUPT; /* Stale VM */` |
|        - |  6107 | `	}` |
|        - |  6108 | `	/* Set the execution magic number  */` |
|     1064 |  6109 | `	pVm->nMagic = PH7_VM_EXEC;` |
|        - |  6110 | `	/* Execute the program */` |
|     1064 |  6111 | `	VmByteCodeExec(&(*pVm),(VmInstr *)SySetBasePtr(pVm->pByteContainer),pVm->aOps,-1,&pVm->sExec,0,FALSE);` |
|        - |  6112 | `	/* Invoke any shutdown callbacks */` |
|     1060 |  6113 | `	VmInvokeShutdownCallbacks(&(*pVm));` |
|        - |  6114 | `	/*` |
...
|        - |  6319 | ` */` |
|      762 |  6320 | `static int vm_builtin_func_num_args(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  6321 |  |
|        - |  6322 | `	VmFrame *pFrame;` |
|        - |  6323 | `	ph7_vm *pVm;` |
|        - |  6324 | `	/* Point to the target VM */` |
|      764 |  6325 | `	pVm = pCtx->pVm;` |
|        - |  6326 | `	/* Current frame */` |
|      764 |  6327 | `	pFrame = pVm->pFrame;` |
|      764 |  6328 | `	while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|        - |  6329 | `		/* Safely ignore the exception frame */` |
|      ! 0 |  6330 | `		pFrame = pFrame->pParent;` |
|      ! 0 |  6331 | `	}` |
|      764 |  6332 | `	if( pFrame->pParent == 0 ){` |
...
|      764 |  6340 | `	nArg = (int)SySetUsed(&pFrame->sArg);` |
|      764 |  6341 | `	ph7_result_int(pCtx,nArg);` |
|      764 |  6342 | `	return SXRET_OK;` |
|      383 |  6343 |  |
|        - |  6344 | `/*` |
...
|        - |  6497 | ` */` |
|     1704 |  6498 | `static int vm_builtin_func_exists(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  6499 |  |
...
|     1706 |  6510 | `	pVm = pCtx->pVm;` |
|        - |  6511 | `	/* Extract the function name */` |
|     1706 |  6512 | `	zName = ph7_value_to_string(apArg[0],&nLen);` |
|        - |  6513 | `	/* Assume the function is not defined */` |
|     1706 |  6514 | `	res = 0;` |
|        - |  6515 | `	/* Perform the lookup */` |
|     2556 |  6516 | `	if( SyHashGet(&pVm->hFunction,(const void *)zName,(sxu32)nLen) != 0 \|\|` |
|     1700 |  6517 | `		SyHashGet(&pVm->hHostFunction,(const void *)zName,(sxu32)nLen) != 0 ){` |
|        - |  6518 | `			/* Function is defined */` |
|      212 |  6519 | `			res = 1;` |
|      105 |  6520 | `	}` |
|     1706 |  6521 | `	ph7_result_bool(pCtx,res);` |
|     1706 |  6522 | `	return SXRET_OK;` |
|      854 |  6523 |  |
...
|        - |  6530 | ` */` |
|    13950 |  6531 | `PH7_PRIVATE int PH7_VmIsCallable(ph7_vm *pVm,ph7_value *pValue,int CallInvoke)` |
|        2 |  6532 |  |
|    13952 |  6533 | `	int res = 0;` |
|    13952 |  6534 | `	if( pValue->iFlags & MEMOBJ_OBJ ){` |
...
|      ! 0 |  6549 | `		}` |
|    13952 |  6550 | `	}else if( pValue->iFlags & MEMOBJ_HASHMAP ){` |
|        7 |  6551 | `		ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|        7 |  6552 | `		if( pMap->nEntry > 1 ){` |
|        - |  6553 | `			ph7_class *pClass;` |
|        - |  6554 | `			ph7_value *pV;` |
|        - |  6555 | `			/* Extract the target class */` |
|        7 |  6556 | `			pV = (ph7_value *)SySetAt(&pVm->aMemObj,pMap->pFirst->nValIdx);` |
|        7 |  6557 | `			if( pV ){` |
|        7 |  6558 | `				pClass = VmExtractClassFromValue(pVm,pV);` |
|        7 |  6559 | `				if( pClass ){` |
...
|        3 |  6572 | `			}` |
|        4 |  6573 | `		}` |
|    13949 |  6574 | `	}else if( pValue->iFlags & MEMOBJ_STRING ){` |
|        - |  6575 | `		const char *zName;` |
|        - |  6576 | `		int nLen;` |
|        - |  6577 | `		/* Extract the name */` |
|     4058 |  6578 | `		zName = ph7_value_to_string(pValue,&nLen);` |
|        - |  6579 | `		/* Perform the lookup */` |
|     4061 |  6580 | `		if( SyHashGet(&pVm->hFunction,(const void *)zName,(sxu32)nLen) != 0 \|\|` |
|        6 |  6581 | `			SyHashGet(&pVm->hHostFunction,(const void *)zName,(sxu32)nLen) != 0 ){` |
|        - |  6582 | `				/* Function is callable */` |
|     4054 |  6583 | `				res = 1;` |
|     2026 |  6584 | `		}` |
|     2028 |  6585 | `	}` |
|    13952 |  6586 | `	return res;` |
|        2 |  6587 |  |
|        - |  6588 | `/*` |
...
|        - |  6621 | ` * defined below.` |
|        - |  6622 | ` */` |
|     1040 |  6623 | `static int VmHashFuncStep(SyHashEntry *pEntry,void *pUserData)` |
|        1 |  6624 |  |
|     1041 |  6625 | `	ph7_value *pArray = (ph7_value *)pUserData;` |
|        - |  6626 | `	ph7_value sName;` |
|        - |  6627 | `	sxi32 rc;` |
|        - |  6628 | `	/* Prepare the function name for insertion */` |
|     1041 |  6629 | `	PH7_MemObjInitFromString(pArray->pVm,&sName,0);` |
|     1041 |  6630 | `	PH7_MemObjStringAppend(&sName,(const char *)pEntry->pKey,pEntry->nKeyLen);` |
|        - |  6631 | `	/* Perform the insertion */` |
|     1041 |  6632 | `	rc = ph7_array_add_elem(pArray,0/* Automatic index assign */,&sName); /* Will make it's own copy */` |
|     1041 |  6633 | `	PH7_MemObjRelease(&sName);` |
|     1041 |  6634 | `	return rc;` |
|        1 |  6635 |  |
|        - |  6636 | `/*` |
...
|        - |  6742 | ` */` |
|      104 |  6743 | `PH7_PRIVATE ph7_class * PH7_VmPeekTopClass(ph7_vm *pVm)` |
|        2 |  6744 |  |
|      106 |  6745 | `	SySet *pSet = &pVm->aSelf;` |
|        - |  6746 | `	ph7_class **apClass;` |
|      106 |  6747 | `	if( SySetUsed(pSet) <= 0 ){` |
|        - |  6748 | `		/* Empty stack,return NULL */` |
|       15 |  6749 | `		return 0;` |
|        - |  6750 | `	}` |
|        - |  6751 | `	/* Peek the last entry */` |
|       92 |  6752 | `	apClass = (ph7_class **)SySetBasePtr(pSet);` |
|       92 |  6753 | `	return apClass[pSet->nUsed - 1];` |
|       54 |  6754 |  |
|        - |  6755 | `/*` |
...
|        - |  6912 | ` */` |
|       78 |  6913 | `static ph7_class * VmExtractClassFromValue(ph7_vm *pVm,ph7_value *pArg)` |
|        2 |  6914 |  |
|       80 |  6915 | `	ph7_class *pClass = 0;` |
|       80 |  6916 | `	if( ph7_value_is_object(pArg) ){` |
|        - |  6917 | `		/* Class instance already loaded,no need to perform a lookup */` |
|       44 |  6918 | `		pClass = ((ph7_class_instance *)pArg->x.pOther)->pClass;` |
|       59 |  6919 | `	}else if( ph7_value_is_string(pArg) ){` |
|        - |  6920 | `		const char *zClass;` |
|        - |  6921 | `		int nLen;` |
|        - |  6922 | `		/* Extract class name */` |
|       35 |  6923 | `		zClass = ph7_value_to_string(pArg,&nLen);` |
|       35 |  6924 | `		if( nLen > 0 ){` |
|        - |  6925 | `			SyHashEntry *pEntry;` |
|        - |  6926 | `			/* Perform a lookup */` |
|       35 |  6927 | `			pEntry = SyHashGet(&pVm->hClass,(const void *)zClass,(sxu32)nLen);` |
|       35 |  6928 | `			if( pEntry ){` |
...
|        - |  7273 | ` */` |
|     1064 |  7274 | `static int VmClassMemberAccess(` |
...
|        - |  7280 | `	)` |
|        2 |  7281 |  |
|     1066 |  7282 | `	if( iProtection != PH7_CLASS_PROT_PUBLIC ){` |
|      502 |  7283 | `		VmFrame *pFrame = pVm->pFrame;` |
|        - |  7284 | `		ph7_vm_func *pVmFunc;` |
|      506 |  7285 | `		while( pFrame->pParent && (pFrame->iFlags & (VM_FRAME_EXCEPTION\|VM_FRAME_CATCH) ) ){` |
|        - |  7286 | `			/* Safely ignore the exception frame */` |
|        5 |  7287 | `			pFrame = pFrame->pParent;` |
|        1 |  7288 | `		}` |
|      502 |  7289 | `		pVmFunc = (ph7_vm_func *)pFrame->pUserData;` |
|      502 |  7290 | `		if( pVmFunc == 0 \|\| (pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) == 0 ){` |
|        9 |  7291 | `			goto dis; /* Access is forbidden */` |
|        - |  7292 | `		}` |
|      494 |  7293 | `		if( iProtection == PH7_CLASS_PROT_PRIVATE ){` |
...
|        4 |  7298 | `		}else{` |
|        - |  7299 | `			/* Protected */` |
|      488 |  7300 | `			ph7_class *pBase = (ph7_class *)pVmFunc->pUserData;` |
|        - |  7301 | `			/* Must be a derived class */` |
|      488 |  7302 | `			if( !VmInstanceOf(pClass,pBase) ){` |
|      ! 0 |  7303 | `				goto dis; /* Access is forbidden */` |
|        - |  7304 | `			}` |
|        - |  7305 | `		}` |
|      246 |  7306 | `	}` |
|     1058 |  7307 | `	return 1; /* Access is granted */` |
|        4 |  7308 | `dis:` |
|        9 |  7309 | `	if( bLog ){` |
...
|        - |  7458 | ` */` |
|      926 |  7459 | `static int VmQueryInterfaceSet(ph7_class *pClass,SySet *pSet)` |
|        2 |  7460 |  |
|        - |  7461 | `	ph7_class **apInterface;` |
|        - |  7462 | `	sxu32 n;` |
|      928 |  7463 | `	if( SySetUsed(pSet) < 1 ){` |
|        - |  7464 | `		/* Empty interface container */` |
|      926 |  7465 | `		return FALSE;` |
|        - |  7466 | `	}` |
...
|        - |  7481 | ` */` |
|      538 |  7482 | `static int VmInstanceOf(ph7_class *pThis,ph7_class *pClass)` |
|        2 |  7483 |  |
|        - |  7484 | `	ph7_class *pParent;` |
|        - |  7485 | `	sxi32 rc;` |
|      540 |  7486 | `	if( pThis == pClass ){` |
|        - |  7487 | `		/* Instance of the same class */` |
|      140 |  7488 | `		return TRUE;` |
|        - |  7489 | `	}` |
|        - |  7490 | `	/* Check implemented interfaces */` |
|      402 |  7491 | `	rc = VmQueryInterfaceSet(pClass,&pThis->aInterface);` |
|      402 |  7492 | `	if( rc ){` |
|        3 |  7493 | `		return TRUE;` |
|        - |  7494 | `	}` |
|        - |  7495 | `	/* Check parent classes */` |
|      400 |  7496 | `	pParent = pThis->pBase;` |
|      926 |  7497 | `	while( pParent ){` |
|      924 |  7498 | `		if( pParent == pClass ){` |
|        - |  7499 | `			/* Same instance */` |
|      398 |  7500 | `			return TRUE;` |
|        - |  7501 | `		}` |
|        - |  7502 | `		/* Check the implemented interfaces */` |
|      528 |  7503 | `		rc = VmQueryInterfaceSet(pClass,&pParent->aInterface);` |
|      528 |  7504 | `		if( rc ){` |
|      ! 0 |  7505 | `			return TRUE;` |
|        - |  7506 | `		}` |
|        - |  7507 | `		/* Point to the parent class */` |
|      528 |  7508 | `		pParent = pParent->pBase;` |
|        2 |  7509 | `	}` |
...
|        - |  7603 | ` */` |
|      326 |  7604 | `PH7_PRIVATE sxi32 PH7_VmCallClassMethod(` |
...
|      328 |  7618 | `	aStack = VmNewOperandStack(&(*pVm),2/* Method name + Aux data */+nArg);` |
|      328 |  7619 | `	if( aStack == 0 ){` |
...
|      462 |  7625 | `	for( i = 0 ; i < nArg ; i++ ){` |
|      136 |  7626 | `		PH7_MemObjLoad(apArg[i],&aStack[i]);` |
|        - |  7627 | `		/*` |
|        - |  7628 | `		 * Symisc eXtension:` |
|        - |  7629 | `		 *  Parameters to [call_user_func()] can be passed by reference.` |
|        - |  7630 | `		 */` |
|      136 |  7631 | `		aStack[i].nIdx = apArg[i]->nIdx;` |
|       69 |  7632 | `	}` |
|      328 |  7633 | `	iCursor = nArg + 1;` |
|      328 |  7634 | `	if( pThis ){` |
|        - |  7635 | `		/*` |
|        - |  7636 | `		 * Push the class instance so that the '$this' variable will be available.` |
|        - |  7637 | `		 */` |
|      322 |  7638 | `		pThis->iRef++; /* Increment reference count */` |
|      322 |  7639 | `		aStack[i].x.pOther = pThis;` |
|      322 |  7640 | `		aStack[i].iFlags = MEMOBJ_OBJ;` |
|      160 |  7641 | `	}` |
|      328 |  7642 | `	aStack[i].nIdx = SXU32_HIGH; /* Mark as constant */` |
|      328 |  7643 | `	i++;` |
|        - |  7644 | `	/* Push method name */` |
|      328 |  7645 | `	SyBlobReset(&aStack[i].sBlob);` |
|      328 |  7646 | `	SyBlobAppend(&aStack[i].sBlob,(const void *)SyStringData(&pMethod->sVmName),SyStringLength(&pMethod->sVmName));` |
|      328 |  7647 | `	aStack[i].iFlags = MEMOBJ_STRING;` |
|      328 |  7648 | `	aStack[i].nIdx = SXU32_HIGH;` |
|        - |  7649 | `	/* Emit the CALL istruction */` |
|      328 |  7650 | `	aInstr[0].iOp = PH7_OP_CALL;` |
|      328 |  7651 | `	aInstr[0].iP1 = nArg; /* Total number of given arguments */` |
|      328 |  7652 | `	aInstr[0].iP2 = 0;` |
|      328 |  7653 | `	aInstr[0].p3  = 0;` |
|        - |  7654 | `	/* Emit the DONE instruction */` |
|      328 |  7655 | `	aInstr[1].iOp = PH7_OP_DONE;` |
|      328 |  7656 | `	aInstr[1].iP1 = 1;   /* Extract method return value */` |
|      328 |  7657 | `	aInstr[1].iP2 = 0;` |
|      328 |  7658 | `	aInstr[1].p3  = 0;` |
|        - |  7659 | `	/* Execute the method body (if available) */` |
|      328 |  7660 | `	VmByteCodeExec(&(*pVm),aInstr,aStack,iCursor,pResult,0,TRUE);` |
|        - |  7661 | `	/* Clean up the mess left behind */` |
|      328 |  7662 | `	SyMemBackendFree(&pVm->sAllocator,aStack);` |
|      328 |  7663 | `	return PH7_OK;` |
|      165 |  7664 |  |
|        - |  7665 | `/*` |
...
|        - |  7671 | ` */` |
|      370 |  7672 | `PH7_PRIVATE sxi32 PH7_VmCallUserFunction(` |
...
|        - |  7682 | `	int i;` |
|      372 |  7683 | `	if((pFunc->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP)) == 0 ){` |
|        - |  7684 | `		/* Don't bother processing,it's invalid anyway */` |
|       64 |  7685 | `		if( pResult ){` |
|        - |  7686 | `			/* Assume a null return value */` |
|      ! 0 |  7687 | `			PH7_MemObjRelease(pResult);` |
|      ! 0 |  7688 | `		}` |
|       64 |  7689 | `		return SXERR_INVALID;` |
|        - |  7690 | `	}` |
|      310 |  7691 | `	if( pFunc->iFlags & MEMOBJ_HASHMAP ){` |
|        - |  7692 | `		/* Class method */` |
...
|      300 |  7743 | `	aStack = VmNewOperandStack(&(*pVm),1+nArg);` |
|      300 |  7744 | `	if( aStack == 0 ){` |
...
|      928 |  7754 | `	for( i = 0 ; i < nArg ; i++ ){` |
|      630 |  7755 | `		PH7_MemObjLoad(apArg[i],&aStack[i]);` |
|        - |  7756 | `		/*` |
|        - |  7757 | `		 * Symisc eXtension:` |
|        - |  7758 | `		 *  Parameters to [call_user_func()] can be passed by reference.` |
|        - |  7759 | `		 */` |
|      630 |  7760 | `		aStack[i].nIdx = apArg[i]->nIdx;` |
|      316 |  7761 | `	}` |
|        - |  7762 | `	/* Push the function name */` |
|      300 |  7763 | `	PH7_MemObjLoad(pFunc,&aStack[i]);` |
|      300 |  7764 | `	aStack[i].nIdx = SXU32_HIGH; /* Mark as constant */` |
|        - |  7765 | `	/* Emit the CALL istruction */` |
|      300 |  7766 | `	aInstr[0].iOp = PH7_OP_CALL;` |
|      300 |  7767 | `	aInstr[0].iP1 = nArg; /* Total number of given arguments */` |
|      300 |  7768 | `	aInstr[0].iP2 = 0;` |
|      300 |  7769 | `	aInstr[0].p3  = 0;` |
|        - |  7770 | `	/* Emit the DONE instruction */` |
|      300 |  7771 | `	aInstr[1].iOp = PH7_OP_DONE;` |
|      300 |  7772 | `	aInstr[1].iP1 = 1;   /* Extract function return value if available */` |
|      300 |  7773 | `	aInstr[1].iP2 = 0;` |
|      300 |  7774 | `	aInstr[1].p3  = 0;` |
|        - |  7775 | `	/* Execute the function body (if available) */` |
|      300 |  7776 | `	VmByteCodeExec(&(*pVm),aInstr,aStack,nArg,pResult,0,TRUE);` |
|        - |  7777 | `	/* Clean up the mess left behind */` |
|      300 |  7778 | `	SyMemBackendFree(&pVm->sAllocator,aStack);` |
|      300 |  7779 | `	return PH7_OK;` |
|      187 |  7780 |  |
|        - |  7781 | `/*` |
...
|        - |  8149 | ` */` |
|     2660 |  8150 | `static int vm_builtin_ob_end_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  8151 |  |
|     2662 |  8152 | `	ph7_vm *pVm = pCtx->pVm;` |
|        - |  8153 | `	VmObEntry *pOb;` |
|        - |  8154 | `	/* Pop the top most OB */` |
|     2662 |  8155 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|     2662 |  8156 | `	if( pOb == 0){` |
...
|      ! 0 |  8161 | `	}else{` |
|        - |  8162 | `		/* Release */` |
|     2662 |  8163 | `		VmObRestore(pVm,pOb);` |
|        - |  8164 | `		/* Return true */` |
|     2662 |  8165 | `		ph7_result_bool(pCtx,1);` |
|        - |  8166 | `	}` |
|     2662 |  8167 | `	return PH7_OK;` |
|        2 |  8168 |  |
|        - |  8169 | `/*` |
...
|        - |  8202 | ` */` |
|     3898 |  8203 | `static int vm_builtin_ob_get_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  8204 |  |
|     3900 |  8205 | `	ph7_vm *pVm = pCtx->pVm;` |
|        - |  8206 | `	VmObEntry *pOb;` |
|        - |  8207 | `	/* Pop the top most OB */` |
|     3900 |  8208 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|     3900 |  8209 | `	if( pOb == 0 ){` |
...
|     3900 |  8216 | `		ph7_result_string(pCtx,(const char *)SyBlobData(&pOb->sOB),(int)SyBlobLength(&pOb->sOB)); /* Will make it's own copy */` |
|        - |  8217 | `		/* Release */` |
|     3900 |  8218 | `		VmObRestore(pVm,pOb);` |
|        - |  8219 | `	}` |
|     3900 |  8220 | `	return PH7_OK;` |
|        2 |  8221 |  |
|        - |  8222 | `/*` |
...
|        - |  8271 | ` */` |
|     5882 |  8272 | `static int VmObConsumer(const void *pData,unsigned int nDataLen,void *pUserData)` |
|        2 |  8273 |  |
|     5884 |  8274 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|        - |  8275 | `	VmObEntry *pEntry;` |
|        - |  8276 | `	ph7_value sResult;` |
|        - |  8277 | `	/* Peek the top most entry */` |
|     5884 |  8278 | `	pEntry = (VmObEntry *)SySetPeek(&pVm->aOB);` |
|     5884 |  8279 | `	if( pEntry == 0 ){` |
|        - |  8280 | `		/* CAN'T HAPPEN */` |
|      ! 0 |  8281 | `		return PH7_OK;` |
|        - |  8282 | `	}` |
|     5884 |  8283 | `	PH7_MemObjInit(pVm,&sResult);` |
|     5884 |  8284 | `	if( ph7_value_is_callable(&pEntry->sCallback) && pVm->nObDepth < 15 ){` |
...
|      ! 0 |  8300 | `	}` |
|     5884 |  8301 | `	if( nDataLen > 0 ){` |
|        - |  8302 | `		/* Redirect the VM output to the internal buffer */` |
|     5884 |  8303 | `		SyBlobAppend(&pEntry->sOB,pData,nDataLen);` |
|     2941 |  8304 | `	}` |
|        - |  8305 | `	/* Release */` |
|     5884 |  8306 | `	PH7_MemObjRelease(&sResult);` |
|     5884 |  8307 | `	return PH7_OK;` |
|     2943 |  8308 |  |
|        - |  8309 | `/*` |
...
|        - |  8312 | ` * information.` |
|        - |  8313 | ` */` |
|     6560 |  8314 | `static void VmObRestore(ph7_vm *pVm,VmObEntry *pEntry)` |
|        2 |  8315 |  |
|     6562 |  8316 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|     6562 |  8317 | `	if( SySetUsed(&pVm->aOB) < 1 ){` |
|        - |  8318 | `		/* No more stackable OB */` |
|     6544 |  8319 | `		pCons->xConsumer = pCons->xDef;` |
|     6544 |  8320 | `		pCons->pUserData = pCons->pDefData;` |
|     3271 |  8321 | `	}` |
|        - |  8322 | `	/* Release OB data */` |
|     6562 |  8323 | `	PH7_MemObjRelease(&pEntry->sCallback);` |
|     6562 |  8324 | `	SyBlobRelease(&pEntry->sOB);` |
|     6562 |  8325 |  |
|        - |  8326 | `/*` |
...
|        - |  8348 | ` */` |
|     6560 |  8349 | `static int vm_builtin_ob_start(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  8350 |  |
|     6562 |  8351 | `	ph7_vm *pVm = pCtx->pVm;` |
|        - |  8352 | `	VmObEntry sOb;` |
|        - |  8353 | `	sxi32 rc;` |
|        - |  8354 | `	/* Initialize the OB entry */` |
|     6562 |  8355 | `	PH7_MemObjInit(pCtx->pVm,&sOb.sCallback);` |
|     6562 |  8356 | `	SyBlobInit(&sOb.sOB,&pVm->sAllocator);` |
|     6562 |  8357 | `	if( nArg > 0 && (apArg[0]->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP)) ){` |
|        - |  8358 | `		/* Save the callback name for later invocation */` |
|      ! 0 |  8359 | `		PH7_MemObjStore(apArg[0],&sOb.sCallback);` |
|      ! 0 |  8360 | `	}` |
|        - |  8361 | `	/* Push in the stack */` |
|     6562 |  8362 | `	rc = SySetPut(&pVm->aOB,(const void *)&sOb);` |
|     6562 |  8363 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  8364 | `		PH7_MemObjRelease(&sOb.sCallback);` |
|      ! 0 |  8365 | `	}else{` |
|     6562 |  8366 | `		ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|        - |  8367 | `		/* Substitute the default VM consumer */` |
|     6562 |  8368 | `		if( pCons->xConsumer != VmObConsumer ){` |
|     6544 |  8369 | `			pCons->xDef = pCons->xConsumer;` |
|     6544 |  8370 | `			pCons->pDefData = pCons->pUserData;` |
|        - |  8371 | `			/* Install the new consumer */` |
|     6544 |  8372 | `			pCons->xConsumer = VmObConsumer;` |
|     6544 |  8373 | `			pCons->pUserData = pVm;` |
|     3271 |  8374 | `		}` |
|        - |  8375 | `	}` |
|     6562 |  8376 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|     6562 |  8377 | `	return PH7_OK;` |
|        2 |  8378 |  |
|        - |  8379 | `/*` |
...
|        - |  8548 | ` */` |
|     1134 |  8549 | `PH7_PRIVATE sxu32 PH7_VmRandomNum(ph7_vm *pVm)` |
|        2 |  8550 |  |
|        - |  8551 | `	sxu32 iNum;` |
|     1136 |  8552 | `	SyRandomness(&pVm->sPrng,(void *)&iNum,sizeof(sxu32));` |
|     1136 |  8553 | `	return iNum;` |
|        2 |  8554 |  |
|        - |  8555 | `/*` |
...
|        - |  8560 | ` */` |
|    38630 |  8561 | `PH7_PRIVATE void PH7_VmRandomString(ph7_vm *pVm,char *zBuf,int nLen)` |
|        2 |  8562 |  |
|        - |  8563 | `	static const char zBase[] = {"abcdefghijklmnopqrstuvwxyz"}; /* English Alphabet */` |
|        - |  8564 | `	int i;` |
|        - |  8565 | `	/* Generate a binary string first */` |
|    38632 |  8566 | `	SyRandomness(&pVm->sPrng,zBuf,(sxu32)nLen);` |
|        - |  8567 | `	/* Turn the binary string into english based alphabet */` |
|   425100 |  8568 | `	for( i = 0 ; i < nLen ; ++i ){` |
|   386470 |  8569 | `		 zBuf[i] = zBase[zBuf[i] % (sizeof(zBase)-1)];` |
|   193236 |  8570 | `	 }` |
|    38632 |  8571 |  |
|        - |  8572 | `/*` |
|        - |  8573 | ` * int rand()` |
...
|        - |  8873 | ` */` |
|    52208 |  8874 | `static int vm_builtin_isset(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  8875 |  |
|        - |  8876 | `	ph7_value *pObj;` |
|    52210 |  8877 | `	int res = 0;` |
|        - |  8878 | `	int i;` |
|    52210 |  8879 | `	if( nArg < 1 ){` |
...
|    70178 |  8885 | `	for( i = 0 ; i < nArg ; ++i ){` |
|    52210 |  8886 | `		pObj = apArg[i];` |
|    52210 |  8887 | `		if( pObj->nIdx == SXU32_HIGH ){` |
|    34158 |  8888 | `			if( (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
|        - |  8889 | `				/* Not so fatal,Throw a warning */` |
|      ! 0 |  8890 | `				ph7_context_throw_error(pCtx,PH7_CTX_WARNING,"Expecting a variable not a constant");` |
|      ! 0 |  8891 | `			}` |
|    17078 |  8892 | `		}` |
|    52210 |  8893 | `		res = (pObj->iFlags & MEMOBJ_NULL) ? 0 : 1;` |
|    52210 |  8894 | `		if( !res ){` |
|        - |  8895 | `			/* Variable not set,return FALSE */` |
|    34242 |  8896 | `			ph7_result_bool(pCtx,0);` |
|    34242 |  8897 | `			return SXRET_OK;` |
|        - |  8898 | `		}` |
|     8986 |  8899 | `	}` |
|        - |  8900 | `	/* All given variable are set,return TRUE */` |
|    17970 |  8901 | `	ph7_result_bool(pCtx,1);` |
|    17970 |  8902 | `	return SXRET_OK;` |
|    26106 |  8903 |  |
|        - |  8904 | `/*` |
...
|        - |  8908 | ` */` |
|   611558 |  8909 | `PH7_PRIVATE sxi32 PH7_VmUnsetMemObj(ph7_vm *pVm,sxu32 nObjIdx,int bForce)` |
|        2 |  8910 |  |
|        - |  8911 | `	ph7_value *pObj;` |
|        - |  8912 | `	VmRefObj *pRef;` |
|   611560 |  8913 | `	pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nObjIdx);` |
|   611560 |  8914 | `	if( pObj ){` |
|        - |  8915 | `		/* Release the object */` |
|   611560 |  8916 | `		PH7_MemObjRelease(pObj);` |
|   305779 |  8917 | `	}` |
|        - |  8918 | `	/* Remove old reference links */` |
|   611560 |  8919 | `	pRef = VmRefObjExtract(&(*pVm),nObjIdx);` |
|   611560 |  8920 | `	if( pRef ){` |
|   611540 |  8921 | `		sxi32 iFlags = pRef->iFlags;` |
|        - |  8922 | `		/* Unlink from the reference table */` |
|   611540 |  8923 | `		VmRefObjUnlink(&(*pVm),pRef);` |
|   611540 |  8924 | `		if( (bForce == TRUE) \|\| (iFlags & VM_REF_IDX_KEEP) == 0 ){` |
|        - |  8925 | `			VmSlot sFree;` |
|        - |  8926 | `			/* Restore to the free list */` |
|   611534 |  8927 | `			sFree.nIdx = nObjIdx;` |
|   611534 |  8928 | `			sFree.pUserData = 0;` |
|   611534 |  8929 | `			SySetPut(&pVm->aFreeObj,(const void *)&sFree);` |
|   305766 |  8930 | `		}` |
|   305769 |  8931 | `	}` |
|   611560 |  8932 | `	return SXRET_OK;` |
|        2 |  8933 |  |
|        - |  8934 | `/*` |
|        - |  8935 | ` * void unset($var,...)` |
...
|        - |  8940 | ` *  Nothing.` |
|        - |  8941 | ` */` |
|     2664 |  8942 | `static int vm_builtin_unset(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  8943 |  |
|        - |  8944 | `	ph7_value *pObj;` |
|        - |  8945 | `	ph7_vm *pVm;` |
|        - |  8946 | `	int i;` |
|        - |  8947 | `	/* Point to the target VM */` |
|     2666 |  8948 | `	pVm = pCtx->pVm;` |
|        - |  8949 | `	/* Iterate and unset */` |
|     8174 |  8950 | `	for( i = 0 ; i < nArg ; ++i ){` |
|     5510 |  8951 | `		pObj = apArg[i];` |
|     5510 |  8952 | `		if( pObj->nIdx == SXU32_HIGH ){` |
|      706 |  8953 | `			if( (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
|        - |  8954 | `				/* Throw an error */` |
|      ! 0 |  8955 | `				ph7_context_throw_error(pCtx,PH7_CTX_ERR,"Expecting a variable not a constant");` |
|      ! 0 |  8956 | `			}` |
|      354 |  8957 | `		}else{` |
|     4805 |  8958 | `			sxu32 nIdx = pObj->nIdx;` |
|        - |  8959 | `			/* TICKET 1433-35: Protect the $GLOBALS array from deletion */` |
|     4805 |  8960 | `			if( nIdx != pVm->nGlobalIdx ){` |
|     4799 |  8961 | `				PH7_VmUnsetMemObj(&(*pVm),nIdx,FALSE);` |
|     2399 |  8962 | `			}` |
|        - |  8963 | `		}` |
|     2756 |  8964 | `	}` |
|     2666 |  8965 | `	return SXRET_OK;` |
|        2 |  8966 |  |
|        - |  8967 | `/*` |
...
|        - |  9031 | ` */` |
|       30 |  9032 | `static int vm_builtin_gettype(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        1 |  9033 |  |
|       31 |  9034 | `	const char *zType = "Empty";` |
|       31 |  9035 | `	if( nArg > 0 ){` |
|       31 |  9036 | `		zType = PH7_MemObjTypeDump(apArg[0]);` |
|       15 |  9037 | `	}` |
|        - |  9038 | `	/* Return the variable type */` |
|       31 |  9039 | `	ph7_result_string(pCtx,zType,-1/*Compute length automatically*/);` |
|       31 |  9040 | `	return SXRET_OK;` |
|        1 |  9041 |  |
|        - |  9042 | `/*` |
...
|        - |  9601 | ` */` |
|     7774 |  9602 | `static int vm_builtin_set_error_handler(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  9603 |  |
|     7776 |  9604 | `	ph7_vm *pVm = pCtx->pVm;` |
|        - |  9605 | `	ph7_value *pOld,*pNew;` |
|        - |  9606 | `	/* Point to the old and the new handler */` |
|     7776 |  9607 | `	pOld = &pVm->aErrCB[0];` |
|     7776 |  9608 | `	pNew = &pVm->aErrCB[1];` |
|        - |  9609 | `	/* Return the old handler */` |
|     7776 |  9610 | `	ph7_result_value(pCtx,pOld); /* Will make it's own copy */` |
|     7776 |  9611 | `	if( nArg > 0 ){` |
|     7776 |  9612 | `		if( !ph7_value_is_callable(apArg[0])) {` |
|        - |  9613 | `			/* Not callable,return TRUE (As requested by the PHP specification) */` |
|     3887 |  9614 | `			PH7_MemObjRelease(pNew);` |
|     3887 |  9615 | `			ph7_result_bool(pCtx,1);` |
|     1944 |  9616 | `		}else{` |
|     3890 |  9617 | `			PH7_MemObjStore(pNew,pOld);` |
|        - |  9618 | `			/* Install the new handler */` |
|     3890 |  9619 | `			PH7_MemObjStore(apArg[0],pNew);` |
|        - |  9620 | `		}` |
|     3887 |  9621 | `	}` |
|     7776 |  9622 | `	return PH7_OK;` |
|        2 |  9623 |  |
|        - |  9624 | `/*` |
...
|        - |  9646 | ` */` |
|       80 |  9647 | `static int vm_builtin_debug_backtrace(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  9648 |  |
|       82 |  9649 | `	ph7_vm *pVm = pCtx->pVm;` |
|        - |  9650 | `	ph7_value *pArray;` |
|        - |  9651 | `	ph7_class *pClass;` |
|        - |  9652 | `	ph7_value *pValue;` |
|        - |  9653 | `	SyString *pFile;` |
|        - |  9654 | `	/* Create a new array */` |
|       82 |  9655 | `	pArray = ph7_context_new_array(pCtx);` |
|       82 |  9656 | `	pValue = ph7_context_new_scalar(pCtx);` |
|       82 |  9657 | `	if( pArray == 0 \|\| pValue == 0 ){` |
...
|       82 |  9666 | `	if( pVm->pFrame->pParent ){` |
|       82 |  9667 | `		VmFrame *pFrame = pVm->pFrame;` |
|        - |  9668 | `		ph7_vm_func *pFunc;` |
|        - |  9669 | `		ph7_value *pArg;` |
|       82 |  9670 | `		while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|        - |  9671 | `			/* Safely ignore the exception frame */` |
|      ! 0 |  9672 | `			pFrame = pFrame->pParent;` |
|      ! 0 |  9673 | `		}` |
|       82 |  9674 | `		pFunc = (ph7_vm_func *)pFrame->pUserData;` |
|       82 |  9675 | `		if( pFrame->pParent && pFunc ){` |
|       82 |  9676 | `			ph7_value_string(pValue,pFunc->sName.zString,(int)pFunc->sName.nByte);` |
|       82 |  9677 | `			ph7_array_add_strkey_elem(pArray,"function",pValue);` |
|       82 |  9678 | `			ph7_value_reset_string_cursor(pValue);` |
|       40 |  9679 | `		}` |
|        - |  9680 | `		/* Function arguments */` |
|       82 |  9681 | `		pArg = ph7_context_new_array(pCtx);` |
|       82 |  9682 | `		if( pArg  ){` |
|        - |  9683 | `			ph7_value *pObj;` |
|        - |  9684 | `			VmSlot *aSlot;` |
|        - |  9685 | `			sxu32 n;` |
|        - |  9686 | `			/* Start filling the array with the given arguments */` |
|       82 |  9687 | `			aSlot = (VmSlot *)SySetBasePtr(&pFrame->sArg);` |
|      314 |  9688 | `			for( n = 0;  n < SySetUsed(&pFrame->sArg) ; n++ ){` |
|      234 |  9689 | `				pObj = (ph7_value *)SySetAt(&pCtx->pVm->aMemObj,aSlot[n].nIdx);` |
|      234 |  9690 | `				if( pObj ){` |
|      234 |  9691 | `					ph7_array_add_elem(pArg,0/* Automatic index assign*/,pObj);` |
|      116 |  9692 | `				}` |
|      118 |  9693 | `			}` |
|        - |  9694 | `			/* Save the array */` |
|       82 |  9695 | `			ph7_array_add_strkey_elem(pArray,"args",pArg);` |
|       40 |  9696 | `		}` |
|       40 |  9697 | `	}` |
|       82 |  9698 | `	ph7_value_int(pValue,1);` |
|        - |  9699 | `	/* Append the current line (which is always 1 since PH7 does not track` |
|        - |  9700 | `	 * line numbers at run-time. )` |
|        - |  9701 | `	 */` |
|       82 |  9702 | `	ph7_array_add_strkey_elem(pArray,"line",pValue);` |
|        - |  9703 | `	/* Current processed script */` |
|       82 |  9704 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|       82 |  9705 | `	if( pFile ){` |
|       82 |  9706 | `		ph7_value_string(pValue,pFile->zString,(int)pFile->nByte);` |
|       82 |  9707 | `		ph7_array_add_strkey_elem(pArray,"file",pValue);` |
|       82 |  9708 | `		ph7_value_reset_string_cursor(pValue);` |
|       40 |  9709 | `	}` |
|        - |  9710 | `	/* Top class */` |
|       82 |  9711 | `	pClass = PH7_VmPeekTopClass(pVm);` |
|       82 |  9712 | `	if( pClass ){` |
|       78 |  9713 | `		ph7_value_reset_string_cursor(pValue);` |
|       78 |  9714 | `		ph7_value_string(pValue,pClass->sName.zString,(int)pClass->sName.nByte);` |
|       78 |  9715 | `		ph7_array_add_strkey_elem(pArray,"class",pValue);` |
|       38 |  9716 | `	}` |
|        - |  9717 | `	/* Return the freshly created array */` |
|       82 |  9718 | `	ph7_result_value(pCtx,pArray);` |
|        - |  9719 | `	/*` |
|        - |  9720 | `	 * Don't worry about freeing memory, everything will be released automatically` |
|        - |  9721 | `	 * as soon we return from this function.` |
|        - |  9722 | `	 */` |
|       82 |  9723 | `	return PH7_OK;` |
|       42 |  9724 |  |
|        - |  9725 | `/*` |
...
|        - |  9822 | ` */` |
|       64 |  9823 | `static sxi32 VmUncaughtException(` |
...
|       66 |  9829 | `	int nArg = 1;` |
|        - |  9830 | `	sxi32 rc;` |
|       66 |  9831 | `	if( pVm->nExceptDepth > 15 ){` |
|        - |  9832 | `		/* Nesting limit reached */` |
|      ! 0 |  9833 | `		return SXRET_OK;` |
|        - |  9834 | `	}` |
|        - |  9835 | `	/* Call any exception handler if available */` |
|       66 |  9836 | `	PH7_MemObjInit(pVm,&sArg);` |
|       66 |  9837 | `	if( pThis ){` |
|        - |  9838 | `		/* Load the exception instance */` |
|       66 |  9839 | `		sArg.x.pOther = pThis;` |
|       66 |  9840 | `		pThis->iRef++;` |
|       66 |  9841 | `		MemObjSetType(&sArg,MEMOBJ_OBJ);` |
|       34 |  9842 | `	}else{` |
|      ! 0 |  9843 | `		nArg = 0;` |
|        - |  9844 | `	}` |
|       66 |  9845 | `	apArg[0] = &sArg;` |
|        - |  9846 | `	/* Call the exception handler if available */` |
|       66 |  9847 | `	pVm->nExceptDepth++;` |
|       66 |  9848 | `	rc = PH7_VmCallUserFunction(&(*pVm),&pVm->aExceptionCB[1],nArg,apArg,0);` |
|       66 |  9849 | `	pVm->nExceptDepth--;` |
|       66 |  9850 | `	if( rc != SXRET_OK ){` |
|        - |  9851 | `		SyBlob sMsgBuf;` |
|       64 |  9852 | `		const char *zClass = "Exception";` |
|       64 |  9853 | `		sxu32 nClass = (sxu32)sizeof("Exception") - 1;` |
|        - |  9854 | `		const char *zMsg;` |
|        - |  9855 | `		sxu32 nMsg;` |
|        - |  9856 | `		const char *zFuncName;` |
|        - |  9857 | `		int nFuncLen;` |
|       64 |  9858 | `		SyBlobInit(&sMsgBuf,&pVm->sAllocator);` |
|       64 |  9859 | `		if( pThis ){` |
|        - |  9860 | `			ph7_class_method *pGetMessage;` |
|        - |  9861 | `			ph7_value sMsg;` |
|        - |  9862 | `			const char *zTmp;` |
|        - |  9863 | `			int nTmp;` |
|       64 |  9864 | `			zClass = pThis->pClass->sName.zString;` |
|       64 |  9865 | `			nClass = pThis->pClass->sName.nByte;` |
|       64 |  9866 | `			pGetMessage = PH7_ClassExtractMethod(pThis->pClass,"getMessage",sizeof("getMessage")-1);` |
|       64 |  9867 | `			if( pGetMessage ){` |
|       64 |  9868 | `				PH7_MemObjInit(pVm,&sMsg);` |
|       64 |  9869 | `				if( PH7_VmCallClassMethod(&(*pVm),pThis,pGetMessage,&sMsg,0,0) == SXRET_OK ){` |
|       64 |  9870 | `					zTmp = ph7_value_to_string(&sMsg,&nTmp);` |
|       64 |  9871 | `					if( zTmp && nTmp > 0 ){` |
|       64 |  9872 | `						SyBlobAppend(&sMsgBuf,zTmp,(sxu32)nTmp);` |
|       31 |  9873 | `					}` |
|       31 |  9874 | `				}` |
|       64 |  9875 | `				PH7_MemObjRelease(&sMsg);` |
|       31 |  9876 | `			}` |
|       31 |  9877 | `		}` |
|       64 |  9878 | `		if( SyBlobLength(&sMsgBuf) == 0 ){` |
|      ! 0 |  9879 | `			SyBlobAppend(&sMsgBuf,"Unknown exception",sizeof("Unknown exception")-1);` |
|      ! 0 |  9880 | `		}` |
|       64 |  9881 | `		zMsg = (const char *)SyBlobData(&sMsgBuf);` |
|       64 |  9882 | `		nMsg = (sxu32)SyBlobLength(&sMsgBuf);` |
|       64 |  9883 | `		VmGetFrameContext(pVm,&zFuncName,&nFuncLen);` |
|       64 |  9884 | `		VmReportUncaughtException(pVm,zClass,nClass,zMsg,nMsg,zFuncName,nFuncLen);` |
|       64 |  9885 | `		SyBlobRelease(&sMsgBuf);` |
|        - |  9886 | `		/* Tell the upper layer to stop VM execution immediately  */` |
|       64 |  9887 | `		rc = SXERR_ABORT;` |
|       31 |  9888 | `	}` |
|       66 |  9889 | `	PH7_MemObjRelease(&sArg);` |
|       66 |  9890 | `	return rc;` |
|       34 |  9891 |  |
|        - |  9892 | `/*` |
|        - |  9893 | ` * Throw an user exception.` |
|        - |  9894 | ` */` |
|       78 |  9895 | `static sxi32 VmThrowException(` |
...
|       80 |  9904 | `	apException = (ph7_exception **)SySetBasePtr(&pVm->aException);` |
|       80 |  9905 | `	pException = 0;` |
|       80 |  9906 | `	pCatch = 0;` |
|       80 |  9907 | `	if( SySetUsed(&pVm->aException) > 0 ){` |
...
|       80 |  9931 | `	if( pCatch == 0 ){` |
|        - |  9932 | `		sxi32 rc;` |
|       66 |  9933 | `		rc = VmUncaughtException(&(*pVm),pThis);` |
|       66 |  9934 | `		if( rc == SXRET_OK && pException ){` |
...
|        - | 10766 | ` * information.` |
|        - | 10767 | ` */` |
|     7878 | 10768 | `static sxi32 VmEvalChunk(` |
...
|     7880 | 10777 | `	ProcConsumer xErr = 0;` |
|     7880 | 10778 | `	void *pErrData = 0;` |
|        - | 10779 | `	/* Initialize bytecode container */` |
|     7880 | 10780 | `	SySetInit(&aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|     7880 | 10781 | `	SySetAlloc(&aByteCode,0x20);` |
|        - | 10782 | `	/* Reset the code generator */` |
|     7880 | 10783 | `	if( bTrueReturn ){` |
|        - | 10784 | `		/* Included file,log compile-time errors */` |
|     6541 | 10785 | `		xErr = pVm->pEngine->xConf.xErr;` |
|     6541 | 10786 | `		pErrData = pVm->pEngine->xConf.pErrData;` |
|     3270 | 10787 | `	}` |
|     7880 | 10788 | `	PH7_ResetCodeGenerator(pVm,xErr,pErrData);` |
|        - | 10789 | `	/* Swap bytecode container */` |
|     7880 | 10790 | `	pByteCode = pVm->pByteContainer;` |
|     7880 | 10791 | `	pVm->pByteContainer = &aByteCode;` |
|        - | 10792 | `	/* Compile the chunk */` |
|     7880 | 10793 | `	PH7_CompileScript(pVm,pChunk,iFlags);` |
|    11819 | 10794 | `	if( pVm->sCodeGen.nErr > 0 ){` |
...
|        - | 10804 | `		sxi32 rc;` |
|     7878 | 10805 | `		SyHashResetLoopCursor(&pVm->hClass);` |
|   235392 | 10806 | `		while((pEntry = SyHashGetNextEntry(&pVm->hClass)) != 0 ){` |
|   223578 | 10807 | `			pClass = (ph7_class *)pEntry->pUserData;` |
|        - | 10808 | `			/* Only mount classes that haven't been mounted yet */` |
|   223578 | 10809 | `			if( !pClass->bMounted ){` |
|    43528 | 10810 | `				rc = VmMountUserClass(pVm,pClass);` |
|    43528 | 10811 | `				if( rc != SXRET_OK ){` |
...
|    21763 | 10818 | `			}` |
|        2 | 10819 | `		}` |
|     7878 | 10820 | `		if( SXRET_OK != PH7_VmEmitInstr(pVm,PH7_OP_DONE,0,0,0,0) ){` |
|        - | 10821 | `			/* Out of memory */` |
|      ! 0 | 10822 | `			if( pCtx ){` |
...
|        - | 10826 | `		}` |
|     7878 | 10827 | `		if( bTrueReturn ){` |
|        - | 10828 | `			/* Assume a boolean true return value */` |
|     6541 | 10829 | `			PH7_MemObjInitFromBool(pVm,&sResult,1);` |
|     3271 | 10830 | `		}else{` |
|        - | 10831 | `			/* Assume a null return value */` |
|     1338 | 10832 | `			PH7_MemObjInit(pVm,&sResult);` |
|        - | 10833 | `		}` |
|        - | 10834 | `		/* Execute the compiled chunk */` |
|     7878 | 10835 | `		VmLocalExec(pVm,&aByteCode,&sResult);` |
|     7878 | 10836 | `		if( pCtx ){` |
|        - | 10837 | `			/* Set the execution result */` |
|     6558 | 10838 | `			ph7_result_value(pCtx,&sResult);` |
|     3278 | 10839 | `		}` |
|     7878 | 10840 | `		PH7_MemObjRelease(&sResult);` |
|        - | 10841 | `	}` |
|     3939 | 10842 | `Cleanup:` |
|        - | 10843 | `	/* Cleanup the mess left behind */` |
|     7880 | 10844 | `	pVm->pByteContainer = pByteCode;` |
|     7880 | 10845 | `	SySetRelease(&aByteCode);` |
|     7880 | 10846 | `	return SXRET_OK;` |
|        2 | 10847 |  |
|        - | 10848 | `/*` |
...
|        - | 10879 | ` */` |
|    13076 | 10880 | `static int VmIsIncludedFile(ph7_vm *pVm,SyString *pFile)` |
|        1 | 10881 |  |
|        - | 10882 | `	SyString *aEntries;` |
|        - | 10883 | `	sxu32 n;` |
|    13077 | 10884 | `	aEntries = (SyString *)SySetBasePtr(&pVm->aIncluded);` |
|        - | 10885 | `	/* Perform a linear search */` |
| 42734273 | 10886 | `	for( n = 0 ; n < SySetUsed(&pVm->aIncluded) ; ++n ){` |
| 42721203 | 10887 | `		if( SyStringCmp(pFile,&aEntries[n],SyMemcmp) == 0 ){` |
|        - | 10888 | `			/* Already included */` |
|        7 | 10889 | `			return TRUE;` |
|        - | 10890 | `		}` |
| 21360599 | 10891 | `	}` |
|    13071 | 10892 | `	return FALSE;` |
|     6539 | 10893 |  |
|        - | 10894 | `/*` |
|        - | 10895 | ` * Push a file path in the appropriate VM container.` |
|        - | 10896 | ` */` |
|    14388 | 10897 | `PH7_PRIVATE sxi32 PH7_VmPushFilePath(ph7_vm *pVm,const char *zPath,int nLen,sxu8 bMain,sxi32 *pNew)` |
|        2 | 10898 |  |
...
|        - | 10903 | `#endif` |
|        - | 10904 | `	sxi32 rc;` |
|    14390 | 10905 | `	if( nLen < 0 ){` |
|     1314 | 10906 | `		nLen = SyStrlen(zPath);` |
|      656 | 10907 | `	}` |
|        - | 10908 | `	/* Duplicate the file path first */` |
|    14390 | 10909 | `	zDup = SyMemBackendStrDup(&pVm->sAllocator,zPath,nLen);` |
|    14390 | 10910 | `	if( zDup == 0 ){` |
...
|    14390 | 10932 | `	SyStringInitFromBuf(&sPath,zDup,nLen);` |
|    14390 | 10933 | `	if( !bMain ){` |
|    13077 | 10934 | `		if( VmIsIncludedFile(&(*pVm),&sPath) ){` |
|        - | 10935 | `			/* Already included */` |
|        7 | 10936 | `			*pNew = 0;` |
|        4 | 10937 | `		}else{` |
|        - | 10938 | `			/* Insert in the corresponding container */` |
|    13071 | 10939 | `			rc = SySetPut(&pVm->aIncluded,(const void *)&sPath);` |
|    13071 | 10940 | `			if( rc != SXRET_OK ){` |
...
|        - | 10945 | `		}` |
|     6538 | 10946 | `	}` |
|    14390 | 10947 | `	SySetPut(&pVm->aFiles,(const void *)&sPath);` |
|    14390 | 10948 | `	return SXRET_OK;` |
|     7196 | 10949 |  |
|        - | 10950 | `/*` |
...
|        - | 10961 | ` */` |
|     6546 | 10962 | `static sxi32 VmExecIncludedFile(` |
...
|     6548 | 10976 | `	pVm = pCtx->pVm;` |
|     6548 | 10977 | `	SyBlobInit(&sContents,&pVm->sAllocator);` |
|     6548 | 10978 | `	isNew = 0;` |
|        - | 10979 | `	/* Extract the associated stream */` |
|     6548 | 10980 | `	pStream = PH7_VmGetStreamDevice(pVm,&pPath->zString,pPath->nByte);` |
|        - | 10981 | `	/*` |
|        - | 10982 | `	 * Open the file or the URL [i.e: http://ph7.symisc.net/example/hello.php"]` |
|        - | 10983 | `	 * in a read-only mode.` |
|        - | 10984 | `	 */` |
|     6548 | 10985 | `	pHandle = PH7_StreamOpenHandle(pVm,pStream,pPath->zString,PH7_IO_OPEN_RDONLY,TRUE,0,TRUE,&isNew);` |
|     6548 | 10986 | `	if( pHandle == 0 ){` |
|        3 | 10987 | `		return SXERR_IO;` |
|        - | 10988 | `	}` |
|     6545 | 10989 | `	rc = SXRET_OK; /* Stupid cc warning */` |
|     6545 | 10990 | `	if( IncludeOnce && !isNew ){` |
|        - | 10991 | `		/* Already included */` |
|        5 | 10992 | `		rc = SXERR_EXISTS;` |
|        3 | 10993 | `	}else{` |
|        - | 10994 | `		/* Read the whole file contents */` |
|     6541 | 10995 | `		rc = PH7_StreamReadWholeFile(pHandle,pStream,&sContents);` |
|     6541 | 10996 | `		if( rc == SXRET_OK ){` |
|        - | 10997 | `			SyString sScript;` |
|        - | 10998 | `			/* Compile and execute the script */` |
|     6541 | 10999 | `			SyStringInitFromBuf(&sScript,SyBlobData(&sContents),SyBlobLength(&sContents));` |
|     6541 | 11000 | `			VmEvalChunk(pCtx->pVm,&(*pCtx),&sScript,0,TRUE);` |
|     3270 | 11001 | `		}` |
|        - | 11002 | `	}` |
|        - | 11003 | `	/* Pop from the set of included file */` |
|     6545 | 11004 | `	(void)SySetPop(&pVm->aFiles);` |
|        - | 11005 | `	/* Close the handle */` |
|     6545 | 11006 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|        - | 11007 | `	/* Release the working buffer */` |
|     6545 | 11008 | `	SyBlobRelease(&sContents);` |
|        - | 11009 | `#else` |
...
|     2755 | 11082 | `	while( SXRET_OK == SySetGetNextEntry(pFiles,(void **)&pEntry) ){` |
|        - | 11083 | `		const char *zBase,*zEnd;` |
|        - | 11084 | `		int iLen;` |
|        - | 11085 | `		/* reset the string cursor */` |
|     2753 | 11086 | `		ph7_value_reset_string_cursor(pWorker);` |
|        - | 11087 | `		/* Extract base name */` |
|     2753 | 11088 | `		zEnd = &pEntry->zString[pEntry->nByte - 1];` |
|        - | 11089 | `		/* Ignore trailing '/' */` |
|     4129 | 11090 | `		while( zEnd > pEntry->zString && ( (int)zEnd[0] == c \|\| (int)zEnd[0] == d ) ){` |
|      ! 0 | 11091 | `			zEnd--;` |
|      ! 0 | 11092 | `		}` |
|     2753 | 11093 | `		iLen = (int)(&zEnd[1]-pEntry->zString);` |
|    77611 | 11094 | `		while( zEnd > pEntry->zString && ( (int)zEnd[0] != c && (int)zEnd[0] != d ) ){` |
|    73483 | 11095 | `			zEnd--;` |
|        1 | 11096 | `		}` |
|     2753 | 11097 | `		zBase = (zEnd > pEntry->zString) ? &zEnd[1] : pEntry->zString;` |
|     2753 | 11098 | `		zEnd = &pEntry->zString[iLen];` |
|        - | 11099 | `		/* Copy entry name */` |
|     2753 | 11100 | `		ph7_value_string(pWorker,zBase,(int)(zEnd-zBase));` |
|        - | 11101 | `		/* Perform the insertion */` |
|     2753 | 11102 | `		ph7_array_add_elem(pArray,0/* Automatic index assign*/,pWorker); /* Will make it's own copy */` |
|        1 | 11103 | `	}` |
...
|        - | 11131 | ` */` |
|     6534 | 11132 | `static int vm_builtin_include(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 | 11133 |  |
|        - | 11134 | `	SyString sFile;` |
|        - | 11135 | `	sxi32 rc;` |
|     6536 | 11136 | `	if( nArg < 1 ){` |
|        - | 11137 | `		/* Nothing to evaluate,return NULL */` |
|      ! 0 | 11138 | `		ph7_result_null(pCtx);` |
|      ! 0 | 11139 | `		return SXRET_OK;` |
|        - | 11140 | `	}` |
|        - | 11141 | `	/* File to include */` |
|     6536 | 11142 | `	sFile.zString = ph7_value_to_string(apArg[0],(int *)&sFile.nByte);` |
|     6536 | 11143 | `	if( sFile.nByte < 1 ){` |
...
|     6536 | 11149 | `	rc = VmExecIncludedFile(&(*pCtx),&sFile,FALSE);` |
|     6536 | 11150 | `	if( rc != SXRET_OK ){` |
...
|        - | 14041 | ` */` |
|     1062 | 14042 | `static sxi32 VmRegisterSpecialFunction(ph7_vm *pVm)` |
|        2 | 14043 |  |
|        - | 14044 | `	sxi32 rc;` |
|        - | 14045 | `	sxu32 n;` |
|   132752 | 14046 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVmFunc) ; ++n ){` |
|        - | 14047 | `		/* Note that these special functions have access` |
|        - | 14048 | `		 * to the underlying virtual machine as their` |
|        - | 14049 | `		 * private data.` |
|        - | 14050 | `		 */` |
|   131690 | 14051 | `		rc = ph7_create_function(&(*pVm),aVmFunc[n].zName,aVmFunc[n].xFunc,&(*pVm));` |
|   131690 | 14052 | `		if( rc != SXRET_OK ){` |
|      ! 0 | 14053 | `			return rc;` |
|        - | 14054 | `		}` |
|    65846 | 14055 | `	}` |
|     1064 | 14056 | `	return SXRET_OK;` |
|      533 | 14057 |  |
|        - | 14058 | `/*` |
|        - | 14059 | ` * Check if the given name refer to an installed class.` |
|        - | 14060 | ` * Return a pointer to that class on success. NULL on failure.` |
|        - | 14061 | ` */` |
|     7350 | 14062 | `PH7_PRIVATE ph7_class * PH7_VmExtractClass(` |
...
|     3675 | 14074 | `		SXUNUSED(iNest);` |
|        - | 14075 | `	/* Perform a hash lookup */` |
|     7352 | 14076 | `	pEntry = SyHashGet(&pVm->hClass,(const void *)zName,nByte);` |
|        - | 14077 |  |
|     7352 | 14078 | `	if( pEntry == 0 ){` |
|        - | 14079 | `		/* No such entry,return NULL */` |
|      ! 0 | 14080 | `		return 0;` |
|        - | 14081 | `	}` |
|     7352 | 14082 | `	pClass = (ph7_class *)pEntry->pUserData;` |
|     7352 | 14083 | `	if( !iLoadable ){` |
|        - | 14084 | `		/* Return the first class seen */` |
|     6764 | 14085 | `		return pClass;` |
|      ! 0 | 14086 | `	}else{` |
|        - | 14087 | `		/* Check the collision list */` |
|      590 | 14088 | `		while(pClass){` |
|      590 | 14089 | `			if( (pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_ABSTRACT)) == 0 ){` |
|        - | 14090 | `				/* Class is loadable */` |
|      590 | 14091 | `				return pClass;` |
|        - | 14092 | `			}` |
...
|        - | 14113 | ` */` |
|   628548 | 14114 | `static VmRefObj * VmNewRefObj(ph7_vm *pVm,sxu32 nIdx)` |
|        2 | 14115 |  |
|        - | 14116 | `	VmRefObj *pRef;` |
|        - | 14117 | `	/* Allocate a new instance */` |
|   628550 | 14118 | `	pRef = (VmRefObj *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmRefObj));` |
|   628550 | 14119 | `	if( pRef == 0 ){` |
|      ! 0 | 14120 | `		return 0;` |
|        - | 14121 | `	}` |
|        - | 14122 | `	/* Zero the structure */` |
|   628550 | 14123 | `	SyZero(pRef,sizeof(VmRefObj));` |
|        - | 14124 | `	/* Initialize fields */` |
|   628550 | 14125 | `	SySetInit(&pRef->aReference,&pVm->sAllocator,sizeof(SyHashEntry *));` |
|   628550 | 14126 | `	SySetInit(&pRef->aArrEntries,&pVm->sAllocator,sizeof(ph7_hashmap_node *));` |
|   628550 | 14127 | `	pRef->nIdx = nIdx;` |
|   628550 | 14128 | `	return pRef;` |
|   314276 | 14129 |  |
|        - | 14130 | `/*` |
|        - | 14131 | ` * Default hash function used by the reference table` |
|        - | 14132 | ` * for lookup/insertion operations.` |
|        - | 14133 | ` */` |
|  2854520 | 14134 | `static sxu32 VmRefHash(sxu32 nIdx)` |
|        2 | 14135 |  |
|        - | 14136 | `	/* Calculate the hash based on the memory object index */` |
|  2854522 | 14137 | `	return nIdx ^ (nIdx << 8) ^ (nIdx >> 8);` |
|        2 | 14138 |  |
|        - | 14139 | `/*` |
...
|        - | 14149 | ` * extension.` |
|        - | 14150 | ` */` |
|  1861596 | 14151 | `static VmRefObj * VmRefObjExtract(ph7_vm *pVm,sxu32 nObjIdx)` |
|        2 | 14152 |  |
|        - | 14153 | `	VmRefObj *pRef;` |
|        - | 14154 | `	sxu32 nBucket;` |
|        - | 14155 | `	/* Point to the appropriate bucket */` |
|  1861598 | 14156 | `	nBucket = VmRefHash(nObjIdx) & (pVm->nRefSize - 1);` |
|        - | 14157 | `	/* Perform the lookup */` |
|  1861598 | 14158 | `	pRef = pVm->apRefObj[nBucket];` |
|  5360012 | 14159 | `	for(;;){` |
| 10722858 | 14160 | `		if( pRef == 0 ){` |
|   680416 | 14161 | `			break;` |
|        - | 14162 | `		}` |
| 10042444 | 14163 | `		if( pRef->nIdx == nObjIdx ){` |
|        - | 14164 | `			/* Entry found */` |
|  1181184 | 14165 | `			return pRef;` |
|        - | 14166 | `		}` |
|        - | 14167 | `		/* Point to the next entry */` |
|  8861262 | 14168 | `		pRef = pRef->pNextCollide;` |
|        2 | 14169 | `	}` |
|        - | 14170 | `	/* No such entry,return NULL */` |
|   680416 | 14171 | `	return 0;` |
|   930800 | 14172 |  |
|        - | 14173 | `/*` |
...
|        - | 14181 | ` * extension.` |
|        - | 14182 | ` */` |
|   628548 | 14183 | `static sxi32 VmRefObjInsert(ph7_vm *pVm,VmRefObj *pRef)` |
|        2 | 14184 |  |
|        - | 14185 | `	sxu32 nBucket;` |
|   628550 | 14186 | `	if( pVm->nRefUsed * 3 >= pVm->nRefSize ){` |
|        - | 14187 | `		VmRefObj **apNew;` |
|        - | 14188 | `		sxu32 nNew;` |
|        - | 14189 | `		/* Allocate a larger table */` |
|     1354 | 14190 | `		nNew = pVm->nRefSize << 1;` |
|     1354 | 14191 | `		apNew = (VmRefObj **)SyMemBackendAlloc(&pVm->sAllocator,sizeof(VmRefObj *) * nNew);` |
|     1354 | 14192 | `		if( apNew ){` |
|     1354 | 14193 | `			VmRefObj *pEntry = pVm->pRefList;` |
|        - | 14194 | `			sxu32 n;` |
|        - | 14195 | `			/* Zero the structure */` |
|     1354 | 14196 | `			SyZero((void *)apNew,nNew * sizeof(VmRefObj *));` |
|        - | 14197 | `			/* Rehash all referenced entries */` |
|   100440 | 14198 | `			for( n = 0 ; n < pVm->nRefUsed ; ++n ){` |
|        - | 14199 | `				/* Remove old collision links */` |
|    99088 | 14200 | `				pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|        - | 14201 | `				/* Point to the appropriate bucket */` |
|    99088 | 14202 | `				nBucket = VmRefHash(pEntry->nIdx) & (nNew - 1);` |
|        - | 14203 | `				/* Insert the entry  */` |
|    99088 | 14204 | `				pEntry->pNextCollide = apNew[nBucket];` |
|    99088 | 14205 | `				if( apNew[nBucket] ){` |
|    82784 | 14206 | `					apNew[nBucket]->pPrevCollide = pEntry;` |
|    41391 | 14207 | `				}` |
|    99088 | 14208 | `				apNew[nBucket] = pEntry;` |
|        - | 14209 | `				/* Point to the next entry */` |
|    99088 | 14210 | `				pEntry = pEntry->pNext;` |
|    49545 | 14211 | `			}` |
|        - | 14212 | `			/* Release the old table */` |
|     1354 | 14213 | `			SyMemBackendFree(&pVm->sAllocator,pVm->apRefObj);` |
|        - | 14214 | `			/* Install the new one */` |
|     1354 | 14215 | `			pVm->apRefObj = apNew;` |
|     1354 | 14216 | `			pVm->nRefSize = nNew;` |
|      676 | 14217 | `		}` |
|      676 | 14218 | `	}` |
|        - | 14219 | `	/* Point to the appropriate bucket */` |
|   628550 | 14220 | `	nBucket = VmRefHash(pRef->nIdx) & (pVm->nRefSize - 1);` |
|        - | 14221 | `	/* Insert the entry */` |
|   628550 | 14222 | `	pRef->pNextCollide = pVm->apRefObj[nBucket];` |
|   628550 | 14223 | `	if( pVm->apRefObj[nBucket] ){` |
|   595526 | 14224 | `		pVm->apRefObj[nBucket]->pPrevCollide = pRef;` |
|   297725 | 14225 | `	}` |
|   628550 | 14226 | `	pVm->apRefObj[nBucket] = pRef;` |
|   628550 | 14227 | `	MACRO_LD_PUSH(pVm->pRefList,pRef);` |
|   628550 | 14228 | `	pVm->nRefUsed++;` |
|   628550 | 14229 | `	return SXRET_OK;` |
|        2 | 14230 |  |
|        - | 14231 | `/*` |
...
|        - | 14241 | ` * extension.` |
|        - | 14242 | ` */` |
|   611538 | 14243 | `static sxi32 VmRefObjUnlink(ph7_vm *pVm,VmRefObj *pRef)` |
|        2 | 14244 |  |
|        - | 14245 | `	ph7_hashmap_node **apNode;` |
|        - | 14246 | `	SyHashEntry **apEntry;` |
|        - | 14247 | `	sxu32 n;` |
|        - | 14248 | `	/* Point to the reference table */` |
|   611540 | 14249 | `	apNode = (ph7_hashmap_node **)SySetBasePtr(&pRef->aArrEntries);` |
|   611540 | 14250 | `	apEntry = (SyHashEntry **)SySetBasePtr(&pRef->aReference);` |
|        - | 14251 | `	/* Unlink the entry from the reference table */` |
|   667618 | 14252 | `	for( n = 0 ; n < SySetUsed(&pRef->aReference) ; n++ ){` |
|    56080 | 14253 | `		if( apEntry[n] ){` |
|    56048 | 14254 | `			SyHashDeleteEntry2(apEntry[n]);` |
|    28023 | 14255 | `		}` |
|    28041 | 14256 | `	}` |
|  1170618 | 14257 | `	for(n = 0 ; n < SySetUsed(&pRef->aArrEntries) ; ++n ){` |
|   559080 | 14258 | `		if( apNode[n] ){` |
|     4901 | 14259 | `			PH7_HashmapUnlinkNode(apNode[n],FALSE);` |
|     2450 | 14260 | `		}` |
|   279541 | 14261 | `	}` |
|   611540 | 14262 | `	if( pRef->pPrevCollide ){` |
|   346250 | 14263 | `		pRef->pPrevCollide->pNextCollide = pRef->pNextCollide;` |
|   173092 | 14264 | `	}else{` |
|   265292 | 14265 | `		pVm->apRefObj[VmRefHash(pRef->nIdx) & (pVm->nRefSize - 1)] = pRef->pNextCollide;` |
|        - | 14266 | `	}` |
|   611540 | 14267 | `	if( pRef->pNextCollide ){` |
|   576726 | 14268 | `		pRef->pNextCollide->pPrevCollide = pRef->pPrevCollide;` |
|   288286 | 14269 | `	}` |
|   611540 | 14270 | `	MACRO_LD_REMOVE(pVm->pRefList,pRef);` |
|        - | 14271 | `	/* Release the node */` |
|   611540 | 14272 | `	SySetRelease(&pRef->aReference);` |
|   611540 | 14273 | `	SySetRelease(&pRef->aArrEntries);` |
|   611540 | 14274 | `	SyMemBackendPoolFree(&pVm->sAllocator,pRef);` |
|   611540 | 14275 | `	pVm->nRefUsed--;` |
|   611540 | 14276 | `	return SXRET_OK;` |
|        2 | 14277 |  |
|        - | 14278 | `/*` |
...
|        - | 14285 | ` * extension.` |
|        - | 14286 | ` */` |
|   643976 | 14287 | `PH7_PRIVATE sxi32 PH7_VmRefObjInstall(` |
...
|        - | 14293 | `	)` |
|        2 | 14294 |  |
|   643978 | 14295 | `	VmFrame *pFrame = pVm->pFrame;` |
|        - | 14296 | `	VmRefObj *pRef;` |
|        - | 14297 | `	/* Check if the referenced object already exists */` |
|   643978 | 14298 | `	pRef = VmRefObjExtract(&(*pVm),nIdx);` |
|   643978 | 14299 | `	if( pRef == 0 ){` |
|        - | 14300 | `		/* Create a new entry */` |
|   628550 | 14301 | `		pRef = VmNewRefObj(&(*pVm),nIdx);` |
|   628550 | 14302 | `		if( pRef == 0 ){` |
|      ! 0 | 14303 | `			return SXERR_MEM;` |
|        - | 14304 | `		}` |
|   628550 | 14305 | `		pRef->iFlags = iFlags;` |
|        - | 14306 | `		/* Install the entry */` |
|   628550 | 14307 | `		VmRefObjInsert(&(*pVm),pRef);` |
|   314274 | 14308 | `	}` |
|   648890 | 14309 | `	while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|        - | 14310 | `		/* Safely ignore the exception frame */` |
|     4914 | 14311 | `		pFrame = pFrame->pParent;` |
|        2 | 14312 | `	}` |
|   643978 | 14313 | `	if( pFrame->pParent != 0 && pEntry ){` |
|        - | 14314 | `		VmSlot sRef;` |
|        - | 14315 | `		/* Local frame,record referenced entry so that it can` |
|        - | 14316 | `		 * be deleted when we leave this frame.` |
|        - | 14317 | `		 */` |
|    51880 | 14318 | `		sRef.nIdx = nIdx;` |
|    51880 | 14319 | `		sRef.pUserData = pEntry;` |
|    51880 | 14320 | `		if( SXRET_OK != SySetPut(&pFrame->sRef,(const void *)&sRef)) {` |
|      ! 0 | 14321 | `			pEntry = 0; /* Do not record this entry */` |
|      ! 0 | 14322 | `		}` |
|    25939 | 14323 | `	}` |
|   643978 | 14324 | `	if( pEntry ){` |
|        - | 14325 | `		/* Address of the hash-entry */` |
|    67142 | 14326 | `		SySetPut(&pRef->aReference,(const void *)&pEntry);` |
|    33570 | 14327 | `	}` |
|   643978 | 14328 | `	if( pMapEntry ){` |
|        - | 14329 | `		/* Address of the hashmap node [i.e: Array entry] */` |
|   574544 | 14330 | `		SySetPut(&pRef->aArrEntries,(const void *)&pMapEntry);` |
|   287271 | 14331 | `	}` |
|   643978 | 14332 | `	return SXRET_OK;` |
|   321990 | 14333 |  |
|        - | 14334 | `/*` |
...
|        - | 14341 | ` * extension.` |
|        - | 14342 | ` */` |
|   606062 | 14343 | `PH7_PRIVATE sxi32 PH7_VmRefObjRemove(` |
...
|   606064 | 14353 | `	pRef = VmRefObjExtract(&(*pVm),nIdx);` |
|   606064 | 14354 | `	if( pRef == 0 ){` |
|        - | 14355 | `		/* Not such entry */` |
|    51848 | 14356 | `		return SXERR_NOTFOUND;` |
|        - | 14357 | `	}` |
|        - | 14358 | `	/* Remove the desired entry */` |
|   554218 | 14359 | `	if( pEntry ){` |
...
|       49 | 14372 | `		}` |
|       16 | 14373 | `	}` |
|   554218 | 14374 | `	if( pMapEntry ){` |
|        - | 14375 | `		ph7_hashmap_node **apNode;` |
|   554186 | 14376 | `		apNode = (ph7_hashmap_node **)SySetBasePtr(&pRef->aArrEntries);` |
|  1108458 | 14377 | `		for(n = 0 ; n < SySetUsed(&pRef->aArrEntries) ; n++ ){` |
|   554274 | 14378 | `			if( apNode[n] == pMapEntry ){` |
|        - | 14379 | `				/* nullify the entry */` |
|   554186 | 14380 | `				apNode[n] = 0;` |
|   277092 | 14381 | `			}` |
|   277138 | 14382 | `		}` |
|   277092 | 14383 | `	}` |
|   554218 | 14384 | `	return SXRET_OK;` |
|   303033 | 14385 |  |
...
|        - | 14394 | ` */` |
|    18628 | 14395 | `PH7_PRIVATE const ph7_io_stream * PH7_VmGetStreamDevice(` |
...
|    18630 | 14407 | `	zNext = zCur = zIn = *pzDevice;` |
|    18630 | 14408 | `	zEnd = &zIn[nByte];` |
|  1133702 | 14409 | `	while( zIn < zEnd ){` |
|  1115076 | 14410 | `		if( zIn < &zEnd[-3]/*://*/ && zIn[0] == ':' && zIn[1] == '/' && zIn[2] == '/' ){` |
|        - | 14411 | `			/* Got one */` |
...
|  1115074 | 14416 | `		zIn++;` |
|        2 | 14417 | `	}` |
|    18630 | 14418 | `	if( zIn >= zEnd ){` |
|        - | 14419 | `		/* No such scheme,return the default stream */` |
|    18628 | 14420 | `		return pVm->pDefStream;` |
|        - | 14421 | `	}` |
