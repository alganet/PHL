...
|        - |   75 | ` */` |
|  1337727 |   76 | `PH7_PRIVATE sxi32 VmIsUnorderedCmp(ph7_value *pLeft,ph7_value *pRight)` |
|        5 |   77 | `{` |
|  1337732 |   78 | `	if( (pLeft->iFlags & MEMOBJ_REAL) && PH7_IS_NAN(pLeft->rVal) ){` |
|       40 |   79 | `		return TRUE;` |
|        - |   80 | `	}` |
|  1337694 |   81 | `	if( (pRight->iFlags & MEMOBJ_REAL) && PH7_IS_NAN(pRight->rVal) ){` |
|       11 |   82 | `		return TRUE;` |
|        - |   83 | `	}` |
|  1337684 |   84 | `	return FALSE;` |
|   669396 |   85 | `}` |
|        - |   86 | `/*` |
...
|        - |   94 | ` */` |
|   375489 |   95 | `PH7_PRIVATE int VmStringWantsPerlIncr(ph7_value *pVal)` |
|        5 |   96 | `{` |
|        - |   97 | `	SyString sStr;` |
|   375494 |   98 | `	sxu8 bReal = FALSE;` |
|   375494 |   99 | `	const char *zTail = 0;` |
|        - |  100 | `	const char *zEnd;` |
|   375494 |  101 | `	if( (pVal->iFlags & MEMOBJ_STRING) == 0 ){` |
|   375480 |  102 | `		return FALSE;` |
|        - |  103 | `	}` |
...
|        - |  136 | ` */` |
|  1514612 |  137 | `PH7_PRIVATE sxi32 PH7_VmRegisterConstant(` |
...
|        - |  142 | `	)` |
|        5 |  143 | `{` |
|  1514617 |  144 | `	return PH7_VmRegisterConstantEx(&(*pVm),pName,xExpand,pUserData,0,0,0);` |
|        5 |  145 | `}` |
|        - |  146 | `/*` |
...
|        - |  149 | ` */` |
|  1514682 |  150 | `PH7_PRIVATE sxi32 PH7_VmRegisterConstantEx(` |
...
|        - |  162 | `	char *zDupName;` |
|        - |  163 | `	sxi32 rc;` |
|  1514687 |  164 | `	pEntry = SyHashGet(&pVm->hConstant,(const void *)pName->zString,pName->nByte);` |
|  1514687 |  165 | `	if( pEntry ){` |
...
|  1514685 |  189 | `	pCons = (ph7_constant *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_constant));` |
|  1514685 |  190 | `	if( pCons == 0 ){` |
|      ! 0 |  191 | `		return 0;` |
|        - |  192 | `	}` |
|        - |  193 | `	/* Duplicate constant name */` |
|  1514685 |  194 | `	zDupName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|  1514685 |  195 | `	if( zDupName == 0 ){` |
|      ! 0 |  196 | `		SyMemBackendPoolFree(&pVm->sAllocator,pCons);` |
|      ! 0 |  197 | `		return 0;` |
|        - |  198 | `	}` |
|  1514685 |  199 | `	SyStringInitFromBuf(&pCons->sFile,0,0);` |
|  1514685 |  200 | `	if( pFile ){` |
|       73 |  201 | `		SyStringDupPtr(&pCons->sFile,pFile);` |
|       34 |  202 | `	}` |
|  1514685 |  203 | `	pCons->nLine = nLine;` |
|  1514685 |  204 | `	pCons->bUserDefined = (sxu8)(bUser ? 1 : 0);` |
|        - |  205 | `	/* Install the constant */` |
|  1514685 |  206 | `	SyStringInitFromBuf(&pCons->sName,zDupName,pName->nByte);` |
|  1514685 |  207 | `	pCons->xExpand = xExpand;` |
|  1514685 |  208 | `	pCons->pUserData = pUserData;` |
|  1514685 |  209 | `	SySetInit(&pCons->aAttrs,&pVm->sAllocator,sizeof(ph7_attribute));` |
|  1514685 |  210 | `	rc = SyHashInsert(&pVm->hConstant,(const void *)zDupName,SyStringLength(&pCons->sName),pCons);` |
|  1514685 |  211 | `	if( rc != SXRET_OK ){` |
...
|        - |  225 | ` */` |
|  2218932 |  226 | `static sxi32 PH7_NewForeignFunction(` |
...
|  2218937 |  237 | `	pFunc = (ph7_user_func *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_user_func));` |
|  2218937 |  238 | `	if( pFunc == 0 ){` |
|      ! 0 |  239 | `		return SXERR_MEM;` |
|        - |  240 | `	}` |
|        - |  241 | `	/* Duplicate function name */` |
|  2218937 |  242 | `	zDup = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|  2218937 |  243 | `	if( zDup == 0 ){` |
|      ! 0 |  244 | `		SyMemBackendPoolFree(&pVm->sAllocator,pFunc);` |
|      ! 0 |  245 | `		return SXERR_MEM;` |
|        - |  246 | `	}` |
|        - |  247 | `	/* Zero the structure */` |
|  2218937 |  248 | `	SyZero(pFunc,sizeof(ph7_user_func));` |
|        - |  249 | `	/* Initialize structure fields */` |
|  2218937 |  250 | `	SyStringInitFromBuf(&pFunc->sName,zDup,pName->nByte);` |
|  2218937 |  251 | `	pFunc->pVm   = pVm;` |
|  2218937 |  252 | `	pFunc->xFunc = xFunc;` |
|  2218937 |  253 | `	pFunc->pUserData = pUserData;` |
|  2218937 |  254 | `	SySetInit(&pFunc->aAux,&pVm->sAllocator,sizeof(ph7_aux_data));` |
|        - |  255 | `	/* Write a pointer to the new function */` |
|  2218937 |  256 | `	*ppOut = pFunc;` |
|  2218937 |  257 | `	return SXRET_OK;` |
|  1109471 |  258 | `}` |
|        - |  259 | `/*` |
...
|        - |  266 | ` */` |
|  2222328 |  267 | `PH7_PRIVATE sxi32 PH7_VmInstallForeignFunction(` |
...
|  2222333 |  278 | `	pEntry = SyHashGet(&pVm->hHostFunction,pName->zString,pName->nByte);` |
|  2222333 |  279 | `	if( pEntry ){` |
|     3401 |  280 | `		pFunc = (ph7_user_func *)pEntry->pUserData;` |
|     3401 |  281 | `		pFunc->pUserData = pUserData;` |
|     3401 |  282 | `		pFunc->xFunc = xFunc;` |
|     3401 |  283 | `		SySetReset(&pFunc->aAux);` |
...
|     3401 |  288 | `		pFunc->nMinArg  = 0;` |
|     3401 |  289 | `		pFunc->nMaxArg  = 0;` |
|     3401 |  290 | `		pFunc->bHasMaxArg = 0; /* no too-many-arguments check until a signature stamps one */` |
|     3401 |  291 | `		pFunc->bAtLeast = 0;` |
|     3401 |  292 | `		return SXRET_OK;` |
|        - |  293 | `	}` |
|        - |  294 | `	/* Create a new user function */` |
|  2218937 |  295 | `	rc = PH7_NewForeignFunction(&(*pVm),&(*pName),xFunc,pUserData,&pFunc);` |
|  2218937 |  296 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  297 | `		return rc;` |
|        - |  298 | `	}` |
|        - |  299 | `	/* Install the function in the corresponding hashtable */` |
|  2218937 |  300 | `	rc = SyHashInsert(&pVm->hHostFunction,SyStringData(&pFunc->sName),pName->nByte,pFunc);` |
|  2218937 |  301 | `	if( rc != SXRET_OK ){` |
...
|  2218937 |  307 | `	return SXRET_OK;` |
|  1111169 |  308 | `}` |
|        - |  309 | `/*` |
|        - |  310 | ` * Initialize a VM function.` |
|        - |  311 | ` */` |
|  3415518 |  312 | `PH7_PRIVATE sxi32 PH7_VmInitFuncState(` |
...
|  3415523 |  322 | `	SyZero(pFunc,sizeof(ph7_vm_func));` |
|        - |  323 | `	/* Initialize structure fields */` |
|        - |  324 | `	/* Arguments container */` |
|  3415523 |  325 | `	SySetInit(&pFunc->aArgs,&pVm->sAllocator,sizeof(ph7_vm_func_arg));` |
|        - |  326 | `	/* Static variable container */` |
|  3415523 |  327 | `	SySetInit(&pFunc->aStatic,&pVm->sAllocator,sizeof(ph7_vm_func_static_var));` |
|        - |  328 | `	/* Bytecode container */` |
|  3415523 |  329 | `	SySetInit(&pFunc->aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|        - |  330 | `    /* Preallocate some instruction slots */` |
|  3415523 |  331 | `	SySetAlloc(&pFunc->aByteCode,0x10);` |
|        - |  332 | `	/* Closure environment */` |
|  3415523 |  333 | `	SySetInit(&pFunc->aClosureEnv,&pVm->sAllocator,sizeof(ph7_vm_func_closure_env));` |
|        - |  334 | `	/* Return-type union alternatives (empty unless declared as a union) */` |
|  3415523 |  335 | `	SySetInit(&pFunc->aReturnUnion,&pVm->sAllocator,sizeof(ph7_type_alt));` |
|        - |  336 | `	/* Declared #[...] attributes */` |
|  3415523 |  337 | `	SySetInit(&pFunc->aAttrs,&pVm->sAllocator,sizeof(ph7_attribute));` |
|  3415523 |  338 | `	pFunc->iFlags = iFlags;` |
|  3415523 |  339 | `	pFunc->pUserData = pUserData;` |
...
|  3415523 |  342 | `	pFunc->bStrictTypes = (sxu8)(pVm->sCodeGen.bStrictTypes ? 1 : 0);` |
|  3415523 |  343 | `	if( pVm->bCompilingBuiltin ){` |
...
|     4643 |  350 | `		SyString *pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|     4643 |  351 | `		if( pFile ){` |
|     4643 |  352 | `			SyStringDupPtr(&pFunc->sFile,pFile);` |
|     2319 |  353 | `		}` |
|        - |  354 | `	}` |
|  3415523 |  355 | `	SyStringInitFromBuf(&pFunc->sName,zName,nByte);` |
|  3415523 |  356 | `	return SXRET_OK;` |
|        5 |  357 | `}` |
|        - |  358 | `/*` |
...
|        - |  365 | ` */` |
|  5843182 |  366 | `PH7_PRIVATE sxi32 PH7_VmInstallUserFunction(` |
...
|        - |  373 | `	sxi32 rc;` |
|  5843187 |  374 | `	if( pName == 0 ){` |
|        - |  375 | `		/* Use the built-in name */` |
|   522009 |  376 | `		pName = &pFunc->sName;` |
|   261002 |  377 | `	}` |
|        - |  378 | `	/* Check for duplicates (functions with the same name) first */` |
|  5843187 |  379 | `	pEntry = SyHashGet(&pVm->hFunction,pName->zString,pName->nByte);` |
|  5843187 |  380 | `	if( pEntry ){` |
|  2909593 |  381 | `		ph7_vm_func *pLink = (ph7_vm_func *)pEntry->pUserData;` |
|  2909593 |  382 | `		if( pLink != pFunc ){` |
|        - |  383 | `			/* Link */` |
|       32 |  384 | `			pFunc->pNextName = pLink;` |
|       32 |  385 | `			pEntry->pUserData = pFunc;` |
|       15 |  386 | `		}` |
|  2909593 |  387 | `		return SXRET_OK;` |
|        - |  388 | `	}` |
|        - |  389 | `	/* First time seen */` |
|  2933599 |  390 | `	pFunc->pNextName = 0;` |
|  2933599 |  391 | `	rc = SyHashInsert(&pVm->hFunction,pName->zString,pName->nByte,pFunc);` |
|  2933599 |  392 | `	return rc;` |
|  2921596 |  393 | `}` |
|        - |  394 | `/*` |
|        - |  395 | ` * Install a user defined class in the corresponding VM container.` |
|        - |  396 | ` */` |
|   529328 |  397 | `PH7_PRIVATE sxi32 PH7_VmInstallClass(` |
|        - |  398 | `	ph7_vm *pVm,      /* Target VM  */` |
|        - |  399 | `	ph7_class *pClass /* Target Class */` |
|        - |  400 | `	)` |
|        5 |  401 | `{` |
|   529333 |  402 | `	SyString *pName = &pClass->sName;` |
|        - |  403 | `	SyHashEntry *pEntry;` |
|        - |  404 | `	sxi32 rc;` |
|        - |  405 | `	/* Check for duplicates */` |
|   529333 |  406 | `	pEntry = SyHashGet(&pVm->hClass,(const void *)pName->zString,pName->nByte);` |
|   529333 |  407 | `	if( pEntry ){` |
...
|        - |  413 | `	}` |
|   529331 |  414 | `	pClass->pNextName = 0;` |
|        - |  415 | `	/* Perform a simple hashtable insertion */` |
|   529331 |  416 | `	rc = SyHashInsert(&pVm->hClass,(const void *)pName->zString,pName->nByte,pClass);` |
|   529331 |  417 | `	return rc;` |
|   264669 |  418 | `}` |
|        - |  419 | `/*` |
|        - |  420 | ` * Instruction builder interface.` |
|        - |  421 | ` */` |
| 98303124 |  422 | `PH7_PRIVATE sxi32 PH7_VmEmitInstr(` |
...
|        5 |  430 | `{` |
|        - |  431 | `	VmInstr sInstr;` |
| 98303129 |  432 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|        - |  433 | `	sxi32 rc;` |
|        - |  434 | `	/* Fill the VM instruction */` |
| 98303129 |  435 | `	sInstr.iOp = (sxu8)iOp;` |
| 98303129 |  436 | `	sInstr.iP1 = iP1;` |
| 98303129 |  437 | `	sInstr.iP2 = iP2;` |
| 98303129 |  438 | `	sInstr.p3  = p3;` |
...
| 98303129 |  443 | `	sInstr.nLine = 0;` |
| 98303129 |  444 | `	if( pGen->pIn && pGen->pEnd && pGen->pIn < pGen->pEnd ){` |
| 41882983 |  445 | `		sInstr.nLine = pGen->pIn->nLine;` |
| 77361640 |  446 | `	}else if( pGen->pIn && pGen->pEnd && pGen->pIn >= pGen->pEnd && pGen->pEnd > (SyToken *)0 ){` |
|        - |  447 | `		/* Past the end (statement tail): blame the last real token. */` |
| 56206281 |  448 | `		sInstr.nLine = pGen->pEnd[-1].nLine;` |
| 28103138 |  449 | `	}` |
| 98303129 |  450 | `	if( pIndex ){` |
|        - |  451 | `		/* Instruction index in the bytecode array */` |
|  6654057 |  452 | `		*pIndex = SySetUsed(pVm->pByteContainer);` |
|  3327026 |  453 | `	}` |
|        - |  454 | `	/* Finally,record the instruction */` |
| 98303129 |  455 | `	rc = SySetPut(pVm->pByteContainer,(const void *)&sInstr);` |
| 98303129 |  456 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  457 | `		PH7_GenCompileError(&pVm->sCodeGen,E_ERROR,1,"Fatal,Cannot emit instruction due to a memory failure");` |
|        - |  458 | `		/* Fall throw */` |
|      ! 0 |  459 | `	}` |
| 98303129 |  460 | `	return rc;` |
|        5 |  461 | `}` |
|        - |  462 | `/*` |
|        - |  463 | ` * Swap the current bytecode container with the given one.` |
|        - |  464 | ` */` |
|  9775920 |  465 | `PH7_PRIVATE sxi32 PH7_VmSetByteCodeContainer(ph7_vm *pVm,SySet *pContainer)` |
|        5 |  466 | `{` |
|  9775925 |  467 | `	if( pContainer == 0 ){` |
|        - |  468 | `		/* Point to the default container */` |
|      ! 0 |  469 | `		pVm->pByteContainer = &pVm->aByteCode;` |
|      ! 0 |  470 | `	}else{` |
|        - |  471 | `		/* Change container */` |
|  9775925 |  472 | `		pVm->pByteContainer = &(*pContainer);` |
|        - |  473 | `	}` |
|  9775925 |  474 | `	return SXRET_OK;` |
|        5 |  475 | `}` |
|        - |  476 | `/*` |
|        - |  477 | ` * Return the current bytecode container.` |
|        - |  478 | ` */` |
|  4887960 |  479 | `PH7_PRIVATE SySet * PH7_VmGetByteCodeContainer(ph7_vm *pVm)` |
|        5 |  480 | `{` |
|  4887965 |  481 | `	return pVm->pByteContainer;` |
|        5 |  482 | `}` |
|        - |  483 | `/*` |
|        - |  484 | ` * Extract the VM instruction rooted at nIndex.` |
|        - |  485 | ` */` |
|  6859972 |  486 | `PH7_PRIVATE VmInstr * PH7_VmGetInstr(ph7_vm *pVm,sxu32 nIndex)` |
|        5 |  487 | `{` |
|        - |  488 | `	VmInstr *pInstr;` |
|  6859977 |  489 | `	pInstr = (VmInstr *)SySetAt(pVm->pByteContainer,nIndex);` |
|  6859977 |  490 | `	return pInstr;` |
|        5 |  491 | `}` |
|        - |  492 | `/*` |
|        - |  493 | ` * Return the total number of VM instructions recorded so far.` |
|        - |  494 | ` */` |
| 54132770 |  495 | `PH7_PRIVATE sxu32 PH7_VmInstrLength(ph7_vm *pVm)` |
|        5 |  496 | `{` |
| 54132775 |  497 | `	return SySetUsed(pVm->pByteContainer);` |
|        5 |  498 | `}` |
|        - |  499 | `/*` |
|        - |  500 | ` * Pop the last VM instruction.` |
|        - |  501 | ` */` |
|  5395108 |  502 | `PH7_PRIVATE VmInstr * PH7_VmPopInstr(ph7_vm *pVm)` |
|        5 |  503 | `{` |
|  5395113 |  504 | `	return (VmInstr *)SySetPop(pVm->pByteContainer);` |
|        5 |  505 | `}` |
|        - |  506 | `/*` |
|        - |  507 | ` * Peek the last VM instruction.` |
|        - |  508 | ` */` |
| 20437176 |  509 | `PH7_PRIVATE VmInstr * PH7_VmPeekInstr(ph7_vm *pVm)` |
|        5 |  510 | `{` |
| 20437181 |  511 | `	return (VmInstr *)SySetPeek(pVm->pByteContainer);` |
|        5 |  512 | `}` |
|  1711052 |  513 | `PH7_PRIVATE VmInstr * PH7_VmPeekNextInstr(ph7_vm *pVm)` |
|        5 |  514 | `{` |
|        - |  515 | `	VmInstr *aInstr;` |
|        - |  516 | `	sxu32 n;` |
|  1711057 |  517 | `	n = SySetUsed(pVm->pByteContainer);` |
|  1711057 |  518 | `	if( n < 2 ){` |
|      ! 0 |  519 | `		return 0;` |
|        - |  520 | `	}` |
|  1711057 |  521 | `	aInstr = (VmInstr *)SySetBasePtr(pVm->pByteContainer);` |
|  1711057 |  522 | `	return &aInstr[n - 2];` |
|   855531 |  523 | `}` |
|        - |  524 | `/*` |
|        - |  525 | ` * Allocate a new virtual machine frame.` |
|        - |  526 | ` */` |
|   115941 |  527 | `PH7_PRIVATE VmFrame * VmNewFrame(` |
...
|   115946 |  535 | `	pFrame = (VmFrame *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmFrame));` |
|   115946 |  536 | `	if( pFrame == 0 ){` |
|      ! 0 |  537 | `		return 0;` |
|        - |  538 | `	}` |
|        - |  539 | `	/* Zero the structure */` |
|   115946 |  540 | `	SyZero(pFrame,sizeof(VmFrame));` |
|        - |  541 | `	/* Initialize frame fields */` |
|   115946 |  542 | `	pFrame->pUserData = pUserData;` |
|   115946 |  543 | `	pFrame->pThis = pThis;` |
|   115946 |  544 | `	pFrame->pVm = pVm;` |
|   115946 |  545 | `	SyHashInit(&pFrame->hVar,&pVm->sAllocator,0,0);` |
|   115946 |  546 | `	SySetInit(&pFrame->sArg,&pVm->sAllocator,sizeof(VmSlot));` |
|   115946 |  547 | `	SySetInit(&pFrame->sLocal,&pVm->sAllocator,sizeof(VmSlot));` |
|   115946 |  548 | `	SySetInit(&pFrame->sRef,&pVm->sAllocator,sizeof(VmSlot));` |
|   115946 |  549 | `	pFrame->nActualArgs = -1; /* unknown until an arg-install site stamps it */` |
...
|   115946 |  552 | `	PH7_MemObjInit(&(*pVm),&pFrame->sRet);` |
|   115946 |  553 | `	return pFrame;` |
|    58081 |  554 | `}` |
...
|        - |  559 | ` */` |
|   115345 |  560 | `PH7_PRIVATE sxi32 VmEnterFrame(` |
...
|   115350 |  569 | `	pFrame = VmNewFrame(&(*pVm),pUserData,pThis);` |
|   115350 |  570 | `	if( pFrame == 0 ){` |
|      ! 0 |  571 | `		return SXERR_MEM;` |
|        - |  572 | `	}` |
|        - |  573 | `	/* The line currently executing IS the call site for the frame being pushed. */` |
|   115350 |  574 | `	pFrame->nCallLine = pVm->nCurLine;` |
|        - |  575 | `	/* Link to the list of active VM frame */` |
|   115350 |  576 | `	pFrame->pParent = pVm->pFrame;` |
|   115350 |  577 | `	pVm->pFrame = pFrame;` |
|   115350 |  578 | `	if( ppFrame ){` |
|        - |  579 | `		/* Write a pointer to the new VM frame */` |
|   111466 |  580 | `		*ppFrame = pFrame;` |
|    55836 |  581 | `	}` |
|   115350 |  582 | `	return SXRET_OK;` |
|    57783 |  583 | `}` |
|        - |  584 | `/*` |
...
|   106018 |  652 | `			aSlot = (VmSlot *)SySetBasePtr(&pCurFrame->sLocal);` |
|   615560 |  653 | `			for(n = 0 ; n < SySetUsed(&pCurFrame->sLocal) ; ++n ){` |
|        - |  654 | `				/* Unset the local variable */` |
|   509547 |  655 | `				PH7_VmUnsetMemObj(&(*pVm),aSlot[n].nIdx,FALSE);` |
|   255409 |  656 | `			}` |
|        - |  657 | `			/* Remove local reference */` |
|   106018 |  658 | `			aSlot = (VmSlot *)SySetBasePtr(&pCurFrame->sRef);` |
|   615644 |  659 | `			for(n = 0 ; n < SySetUsed(&pCurFrame->sRef) ; ++n ){` |
|   509631 |  660 | `				PH7_VmRefObjRemove(&(*pVm),aSlot[n].nIdx,(SyHashEntry *)aSlot[n].pUserData,0);` |
|   255451 |  661 | `			}` |
|    53112 |  662 | `		}` |
...
|        - |  698 | ` */` |
|     6908 |  699 | `PH7_PRIVATE int VmDropFrameLocalSlot(ph7_vm *pVm,sxu32 nIdx)` |
|        4 |  700 | `{` |
|        - |  701 | `	VmFrame *pFrame;` |
|    13850 |  702 | `	for( pFrame = pVm->pFrame ; pFrame ; pFrame = pFrame->pParent ){` |
|     6954 |  703 | `		VmSlot *aSlot = (VmSlot *)SySetBasePtr(&pFrame->sLocal);` |
|        - |  704 | `		sxu32 n;` |
|     7014 |  705 | `		for( n = 0 ; n < SySetUsed(&pFrame->sLocal) ; ++n ){` |
...
|        - |  729 | ` */` |
| 10727068 |  730 | `PH7_PRIVATE VmFrame * VmSkipExceptionFrames(VmFrame *pFrame)` |
|        5 |  731 | `{` |
| 10753513 |  732 | `	while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|    26445 |  733 | `		pFrame = pFrame->pParent;` |
|        5 |  734 | `	}` |
| 10727073 |  735 | `	return pFrame;` |
|        5 |  736 | `}` |
|        - |  737 | `/*` |
...
|        - |  759 | ` */` |
|     3056 |  760 | `PH7_PRIVATE int VmRecordedResume(ph7_vm *pVm,sxi32 *pResumePc,VmFrame *pEntryFrame,VmInstr *aInstr)` |
|        5 |  761 | `{` |
|     3061 |  762 | `	if( pVm->pResumeFrame == 0 ){` |
...
|     3042 |  773 | `	if( VmSkipExceptionFrames(pEntryFrame) != pVm->pResumeFrame` |
|     2561 |  774 | `	 \|\| (void *)aInstr != pVm->pResumeInstr` |
...
|     3971 |  805 | `	    && !((pVm->pFrame->iFlags & VM_FRAME_EXCEPTION)` |
|     2526 |  806 | `	         && pVm->pFrame->iExceptionJump == pVm->iResumePc) ){` |
|      829 |  807 | `		VmLeaveFrame(&(*pVm));` |
|        5 |  808 | `	}` |
...
|      ! 0 |  915 | `	return 0;` |
|       38 |  916 | `}` |
|   263455 |  917 | `PH7_PRIVATE sxi32 VmDrainFinally(ph7_vm *pVm, sxu32 nExceptionBase)` |
|        5 |  918 | `{` |
|        - |  919 | `	sxu32 nUsed;` |
|   263460 |  920 | `	sxi32 rcOut = SXRET_OK;` |
|   263524 |  921 | `	while( (nUsed = SySetUsed(&pVm->aException)) > nExceptionBase ){` |
...
|        - |  958 | ` */` |
|   158982 |  959 | `PH7_PRIVATE void VmClearFrameReturn(VmFrame *pFrame)` |
|        5 |  960 | `{` |
|   158987 |  961 | `	pFrame->bHasRet = 0;` |
|   158987 |  962 | `	PH7_MemObjRelease(&pFrame->sRet);` |
|   158987 |  963 | `}` |
|        - |  964 | `/*` |
...
|        - | 1112 | ` */` |
|    34928 | 1113 | `PH7_PRIVATE sxi32 VmLocalExecIntoObj(ph7_vm *pVm,SySet *pByteCode,ph7_value **ppMemObj,int bReturnPropagates)` |
|        5 | 1114 | `{` |
|        - | 1115 | `	ph7_value sVal;` |
|    34933 | 1116 | `	sxu32 nIdx = (*ppMemObj)->nIdx;` |
|        - | 1117 | `	sxi32 rc;` |
|    34933 | 1118 | `	PH7_MemObjInit(&(*pVm),&sVal);` |
|    34933 | 1119 | `	rc = VmLocalExec(&(*pVm),pByteCode,&sVal,bReturnPropagates);` |
|        - | 1120 | `	/* aMemObj may have moved during the eval — re-fetch by the reserved index. */` |
|    34933 | 1121 | `	*ppMemObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|    34933 | 1122 | `	if( *ppMemObj ){` |
|    34933 | 1123 | `		PH7_MemObjStore(&sVal,*ppMemObj);` |
|    17464 | 1124 | `	}` |
|    34933 | 1125 | `	PH7_MemObjRelease(&sVal);` |
|    34933 | 1126 | `	return rc;` |
|        5 | 1127 | `}` |
|        - | 1128 | `/*` |
...
|        - | 1140 | ` */` |
|   704376 | 1141 | `static sxi32 VmMountUserClassAttrs(` |
...
|   704381 | 1149 | `	SyHashResetLoopCursor(&pClass->hAttr);` |
|        - | 1150 | `	/* Process only static and constant attribute */` |
|  2893367 | 1151 | `	while( (pEntry = SyHashGetNextEntry(&pClass->hAttr)) != 0 ){` |
|        - | 1152 | `		/* Extract the current attribute */` |
|  2188995 | 1153 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|  2188990 | 1154 | `		if( (pAttr->iFlags & PH7_CLASS_ATTR_CONSTANT)` |
|  1435519 | 1155 | `		 && ((pAttr->iFlags & PH7_CLASS_ATTR_TYPED) == 0` |
|   341460 | 1156 | `			\|\| (pAttr->iFlags & PH7_CLASS_ATTR_ENUMCASE) != 0) ){` |
...
|   681161 | 1166 | `			continue;` |
|        - | 1167 | `		}` |
|  1507839 | 1168 | `		if( pAttr->iFlags & (PH7_CLASS_ATTR_STATIC\|PH7_CLASS_ATTR_CONSTANT) ){` |
|        - | 1169 | `			ph7_value *pMemObj;` |
|    24761 | 1170 | `			if( pAttr->nIdx != SXU32_HIGH ){` |
...
|    23907 | 1177 | `			pMemObj = PH7_ReserveMemObj(&(*pVm));` |
|    23907 | 1178 | `			if( pMemObj == 0 ){` |
...
|        - | 1184 | `			}` |
|    23907 | 1185 | `			if( SySetUsed(&pAttr->aByteCode) > 0 ){` |
...
|    23899 | 1189 | `				ph7_class *pSaveCtx = pVm->pConstEvalClass;` |
|        - | 1190 | `				sxi32 rcExec;` |
|    23899 | 1191 | `				pVm->pConstEvalClass = pAttr->pDeclClass ? pAttr->pDeclClass : pClass;` |
|    23899 | 1192 | `				pAttr->iFlags \|= PH7_CLASS_ATTR_EVALING; /* cycle guard, shared with the on-demand path */` |
|    23899 | 1193 | `				pVm->nConstEvalDepth++;` |
|    23899 | 1194 | `				rcExec = VmLocalExecIntoObj(&(*pVm),&pAttr->aByteCode,&pMemObj,FALSE);` |
|    23899 | 1195 | `				pVm->nConstEvalDepth--;` |
|    23899 | 1196 | `				pAttr->iFlags &= ~PH7_CLASS_ATTR_EVALING;` |
|    23899 | 1197 | `				pVm->pConstEvalClass = pSaveCtx;` |
|    23899 | 1198 | `				if( rcExec == PH7_EXCEPTION \|\| rcExec == PH7_ABORT ){` |
...
|    23899 | 1204 | `				}else if( pVm->pConstCycleAttr && pVm->nConstEvalDepth == 0 ){` |
...
|    23894 | 1212 | `				if( (pAttr->iFlags & (PH7_CLASS_ATTR_CONSTANT\|PH7_CLASS_ATTR_TYPED))` |
|    11952 | 1213 | `					== (PH7_CLASS_ATTR_CONSTANT\|PH7_CLASS_ATTR_TYPED) ){` |
...
|    23903 | 1221 | `			pAttr->nIdx = pMemObj->nIdx;` |
|        - | 1222 | `			/* Install static attribute in the reference table */` |
|    23903 | 1223 | `			PH7_VmRefObjInstall(&(*pVm),pMemObj->nIdx,0,0,VM_REF_IDX_KEEP);` |
...
|    23898 | 1230 | `			if( (pAttr->iFlags & PH7_CLASS_ATTR_TYPED)` |
|    11977 | 1231 | `				&& (pAttr->iFlags & PH7_CLASS_ATTR_CONSTANT) == 0 ){` |
...
|    11949 | 1250 | `		}` |
|        5 | 1251 | `	}` |
|   704377 | 1252 | `	return SXRET_OK;` |
|   352193 | 1253 | `}` |
|   703284 | 1254 | `PH7_PRIVATE sxi32 VmMountUserClass(` |
...
|   703289 | 1263 | `	rc = VmMountUserClassAttrs(&(*pVm),pClass);` |
|   703289 | 1264 | `	if( rc != SXRET_OK ){` |
|        6 | 1265 | `		return rc;` |
|        - | 1266 | `	}` |
|        - | 1267 | `	/* Install class methods */` |
|   703285 | 1268 | `	if( pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|        - | 1269 | `		/* Do not mount interface/trait methods since they are not directly invocable.` |
|        - | 1270 | `		 */` |
|   307747 | 1271 | `		return SXRET_OK;` |
|        - | 1272 | `	}` |
|        - | 1273 | `	/* Create constructor alias if not yet done */` |
|   395543 | 1274 | `	if( SyHashGet(&pClass->hMethod,"__construct",sizeof("__construct")-1) == 0 ){` |
|        - | 1275 | `		/* User constructor with the same base class name */` |
|    59245 | 1276 | `		pEntry = SyHashGet(&pClass->hMethod,SyStringData(&pClass->sName),SyStringLength(&pClass->sName));` |
|    59245 | 1277 | `		if( pEntry ){` |
...
|   395543 | 1284 | `	SyHashResetLoopCursor(&pClass->hMethod);` |
|  5924698 | 1285 | `	while((pEntry = SyHashGetNextEntry(&pClass->hMethod)) != 0 ){` |
|  5331391 | 1286 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|  5331391 | 1287 | `		if( (pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT) == 0 ){` |
|  5321183 | 1288 | `			rc = PH7_VmInstallUserFunction(&(*pVm),&pMeth->sFunc,&pMeth->sVmName);` |
|  5321183 | 1289 | `			if( rc != SXRET_OK ){` |
|      ! 0 | 1290 | `				return rc;` |
|        - | 1291 | `			}` |
|  2660589 | 1292 | `		}` |
|        5 | 1293 | `	}` |
|        - | 1294 | `	/* Mark class as mounted to avoid redundant mounting */` |
|   395543 | 1295 | `	pClass->bMounted = TRUE;` |
|   395543 | 1296 | `	return SXRET_OK;` |
|   351647 | 1297 | `}` |
|        - | 1298 | `/*` |
|        - | 1299 | ` * Allocate a private frame for attributes of the given` |
|        - | 1300 | ` * class instance (Object in the PHP jargon).` |
|        - | 1301 | ` */` |
|     8898 | 1302 | `PH7_PRIVATE sxi32 PH7_VmCreateClassInstanceFrame(` |
|        - | 1303 | `	ph7_vm *pVm, /* Target VM */` |
|        - | 1304 | `	ph7_class_instance *pObj /* Class instance */` |
|        - | 1305 | `	)` |
|        5 | 1306 | `{` |
|     8903 | 1307 | `	ph7_class *pClass = pObj->pClass;` |
...
|     8903 | 1312 | `	SyHashResetLoopCursor(&pClass->hAttr);` |
|    46723 | 1313 | `	while( (pEntry = SyHashGetNextEntry(&pClass->hAttr)) != 0 ){` |
|        - | 1314 | `		VmClassAttr *pVmAttr;` |
|        - | 1315 | `		/* Extract the current attribute */` |
|    37825 | 1316 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|    37825 | 1317 | `		pVmAttr = (VmClassAttr *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmClassAttr));` |
|    37825 | 1318 | `		if( pVmAttr == 0 ){` |
|      ! 0 | 1319 | `			return SXERR_MEM;` |
|        - | 1320 | `		}` |
|    37825 | 1321 | `		pVmAttr->pAttr = pAttr;` |
|    37825 | 1322 | `		if( (pAttr->iFlags & (PH7_CLASS_ATTR_CONSTANT\|PH7_CLASS_ATTR_STATIC)) == 0 ){` |
|        - | 1323 | `			ph7_value *pMemObj;` |
|        - | 1324 | `			/* Reserve a memory object for this attribute */` |
|    29763 | 1325 | `			pMemObj = PH7_ReserveMemObj(&(*pVm));` |
|    29763 | 1326 | `			if( pMemObj == 0 ){` |
|      ! 0 | 1327 | `				SyMemBackendPoolFree(&pVm->sAllocator,pVmAttr);` |
|      ! 0 | 1328 | `				return SXERR_MEM;` |
|        - | 1329 | `			}` |
|    29763 | 1330 | `			pVmAttr->nIdx = pMemObj->nIdx;` |
|    29763 | 1331 | `			pVmAttr->iState = 0;` |
|    29763 | 1332 | `			pVmAttr->pOwner = pClass;` |
|    29763 | 1333 | `			if( SySetUsed(&pAttr->aByteCode) > 0 ){` |
...
|    10813 | 1337 | `				ph7_class *pSaveCtx = pVm->pConstEvalClass;` |
|    10813 | 1338 | `				pVm->pConstEvalClass = pAttr->pDeclClass ? pAttr->pDeclClass : pClass;` |
|    10813 | 1339 | `				VmLocalExecIntoObj(&(*pVm),&pAttr->aByteCode,&pMemObj,FALSE);` |
|    10813 | 1340 | `				pVm->pConstEvalClass = pSaveCtx;` |
|    24359 | 1341 | `			}else if( pAttr->iFlags & PH7_CLASS_ATTR_TYPED ){` |
...
|      199 | 1345 | `			}` |
|    29763 | 1346 | `			rc = SyHashInsertTail(&pObj->hAttr,SyStringData(&pAttr->sName),SyStringLength(&pAttr->sName),pVmAttr);` |
|    29763 | 1347 | `			if( rc != SXRET_OK ){` |
|        - | 1348 | `				VmSlot sSlot;` |
...
|    29763 | 1357 | `			PH7_VmRefObjInstall(&(*pVm),pMemObj->nIdx,0,0,VM_REF_IDX_KEEP);` |
...
|    29763 | 1361 | `			if( pAttr->iFlags & PH7_CLASS_ATTR_TYPED ){` |
...
|        - | 1558 | ` */` |
|  8562196 | 1559 | `PH7_PRIVATE ph7_value * PH7_ReserveConstObj(ph7_vm *pVm,sxu32 *pIndex)` |
|        5 | 1560 | `{` |
|        - | 1561 | `	ph7_value *pObj;` |
|        - | 1562 | `	sxi32 rc;` |
|  8562201 | 1563 | `	if( pIndex ){` |
|        - | 1564 | `		/* Object index in the object table */` |
|  8550573 | 1565 | `		*pIndex = SySetUsed(&pVm->aLitObj);` |
|  4275284 | 1566 | `	}` |
|        - | 1567 | `	/* Reserve a slot for the new object */` |
|  8562201 | 1568 | `	rc = SySetPut(&pVm->aLitObj,(const void *)zDummy);` |
|  8562201 | 1569 | `	if( rc != SXRET_OK ){` |
...
|      ! 0 | 1573 | `		return 0;` |
|        - | 1574 | `	}` |
|  8562201 | 1575 | `	pObj = (ph7_value *)SySetPeek(&pVm->aLitObj);` |
|  8562201 | 1576 | `	return pObj;` |
|  4281103 | 1577 | `}` |
|        - | 1578 | `/*` |
|        - | 1579 | ` * Reserve a memory object.` |
|        - | 1580 | ` * Return a pointer to the raw ph7_value on success. NULL on failure.` |
|        - | 1581 | ` */` |
|  2237782 | 1582 | `PH7_PRIVATE ph7_value * VmReserveMemObj(ph7_vm *pVm,sxu32 *pIndex)` |
|        5 | 1583 | `{` |
|        - | 1584 | `	ph7_value *pObj;` |
|        - | 1585 | `	sxi32 rc;` |
|  2237787 | 1586 | `	if( pIndex ){` |
|        - | 1587 | `		/* Object index in the object table */` |
|  2237787 | 1588 | `		*pIndex = SySetUsed(&pVm->aMemObj);` |
|  1118891 | 1589 | `	}` |
|        - | 1590 | `	/* Reserve a slot for the new object */` |
|  2237787 | 1591 | `	rc = SySetPut(&pVm->aMemObj,(const void *)zDummy);` |
|  2237787 | 1592 | `	if( rc != SXRET_OK ){` |
...
|      ! 0 | 1596 | `		return 0;` |
|        - | 1597 | `	}` |
|  2237787 | 1598 | `	pObj = (ph7_value *)SySetPeek(&pVm->aMemObj);` |
|  2237787 | 1599 | `	return pObj;` |
|  1118896 | 1600 | `}` |
...
|     3881 | 1664 | `	SyHashInit(&pVm->hResourceId,&pVm->sAllocator,0,0);` |
|     3881 | 1665 | `	pVm->nResourceIdNext = 1;` |
|     3881 | 1666 | `	SySetInit(&pVm->aException,&pVm->sAllocator,sizeof(ph7_exception *));` |
|     3881 | 1667 | `	SySetInit(&pVm->aMagicGuard,&pVm->sAllocator,sizeof(VmMagicGuard));` |
|     3881 | 1668 | `	pVm->pMagicSetThis = 0;` |
|     3881 | 1669 | `	SyBlobInit(&pVm->sMagicSetName,&pVm->sAllocator);` |
|     3881 | 1670 | `	pVm->pHookSetThis = 0;` |
|     3881 | 1671 | `	pVm->pHookSetAttr = 0;` |
|     3881 | 1672 | `	pVm->nHookSetIdx = SXU32_HIGH;` |
|     3881 | 1673 | `	SySetInit(&pVm->aHookRmw,&pVm->sAllocator,sizeof(VmHookRmw));` |
|     3881 | 1674 | `	pVm->pMagicCallThis = 0;` |
|     3881 | 1675 | `	pVm->pMagicCallClass = 0;` |
|     3881 | 1676 | `	SyBlobInit(&pVm->sMagicCallName,&pVm->sAllocator);` |
|     3881 | 1677 | `	pVm->pIdleCallFrames = 0;` |
|     3881 | 1678 | `	pVm->pIdleOperandStacks = 0;` |
|     3881 | 1679 | `	pVm->nIdleOperandStacks = 0;` |
|     3881 | 1680 | `	pVm->pIdleStackNodes = 0;` |
|     3881 | 1681 | `	SySetInit(&pVm->aFinallyAction,&pVm->sAllocator,sizeof(VmFinallyAction));` |
|     3881 | 1682 | `	pVm->bInlineTryCatch = 1; /* ROOT C: enable inline generator try/catch/finally */` |
|     3881 | 1683 | `	pVm->pPendingException = 0;` |
|     3881 | 1684 | `	pVm->pInflightException = 0;` |
|     3881 | 1685 | `	pVm->nInflightExcBase = 0;` |
|     3881 | 1686 | `	pVm->pResumeFrame = 0;` |
|     3881 | 1687 | `	pVm->iResumePc = 0;` |
|     3881 | 1688 | `	pVm->pResumeInstr = 0;` |
|     3881 | 1689 | `	pVm->iResumeStackDepth = 0;` |
|     3881 | 1690 | `	pVm->nBoundaryRc = 0;` |
|     3881 | 1691 | `	pVm->pConstEvalClass = 0;` |
|     3881 | 1692 | `	pVm->nConstEvalDepth = 0;` |
|     3881 | 1693 | `	pVm->pConstCycleAttr = 0;` |
|     3881 | 1694 | `	pVm->pConstCycleClass = 0;` |
|     3881 | 1695 | `	SySetReset(&pVm->aMagicGuard);` |
|     3881 | 1696 | `	if( pVm->pMagicSetThis ){` |
|      ! 0 | 1697 | `		PH7_ClassInstanceUnref(pVm->pMagicSetThis);` |
|      ! 0 | 1698 | `		pVm->pMagicSetThis = 0;` |
|      ! 0 | 1699 | `	}` |
|     3881 | 1700 | `	SyBlobRelease(&pVm->sMagicSetName);` |
|     3881 | 1701 | `	if( pVm->pHookSetThis ){` |
|      ! 0 | 1702 | `		PH7_ClassInstanceUnref(pVm->pHookSetThis);` |
|      ! 0 | 1703 | `		pVm->pHookSetThis = 0;` |
|      ! 0 | 1704 | `	}` |
|     3881 | 1705 | `	pVm->pHookSetAttr = 0;` |
|     3881 | 1706 | `	pVm->nHookSetIdx = SXU32_HIGH;` |
|     3881 | 1707 | `	if( pVm->pMagicCallThis ){` |
|      ! 0 | 1708 | `		PH7_ClassInstanceUnref(pVm->pMagicCallThis);` |
|      ! 0 | 1709 | `		pVm->pMagicCallThis = 0;` |
|      ! 0 | 1710 | `	}` |
|     3881 | 1711 | `	pVm->pMagicCallClass = 0;` |
|     3881 | 1712 | `	SyBlobRelease(&pVm->sMagicCallName);` |
|        - | 1713 | `	/* Configuration containers */` |
|     3881 | 1714 | `	SySetInit(&pVm->aFiles,&pVm->sAllocator,sizeof(SyString));` |
|     3881 | 1715 | `	SySetInit(&pVm->aPaths,&pVm->sAllocator,sizeof(SyString));` |
|     3881 | 1716 | `	SySetInit(&pVm->aIncluded,&pVm->sAllocator,sizeof(SyString));` |
|     3881 | 1717 | `	SySetInit(&pVm->aOB,&pVm->sAllocator,sizeof(VmObEntry));` |
|     3881 | 1718 | `	SySetInit(&pVm->aResponseHeaders,&pVm->sAllocator,sizeof(VmResponseHeader));` |
|     3881 | 1719 | `	pVm->iResponseStatus = 200;` |
|     3881 | 1720 | `	pVm->bHeadersSent = 0;` |
|     3881 | 1721 | `	SySetInit(&pVm->aIOstream,&pVm->sAllocator,sizeof(ph7_io_stream *));` |
|        - | 1722 | `	/* Error callbacks containers */` |
|     3881 | 1723 | `	PH7_MemObjInit(&(*pVm),&pVm->aExceptionCB[0]);` |
|     3881 | 1724 | `	PH7_MemObjInit(&(*pVm),&pVm->aExceptionCB[1]);` |
|     3881 | 1725 | `	PH7_MemObjInit(&(*pVm),&pVm->aErrCB[0]);` |
|     3881 | 1726 | `	PH7_MemObjInit(&(*pVm),&pVm->aErrCB[1]);` |
|     3881 | 1727 | `	PH7_MemObjInit(&(*pVm),&pVm->sAssertCallback);` |
...
|     3881 | 1735 | `	pVm->nMaxDepth = 0;         /* host: unbounded PHP call depth (memory-bound) */` |
|     3881 | 1736 | `	pVm->nMaxNativeDepth = 256; /* host: proven the safe ceiling under ASan (the` |
...
|     3881 | 1749 | `	pVm->iAssertFlags = PH7_ASSERT_ZEND_OFF;` |
|        - | 1750 | `	/* JSON return status */` |
|     3881 | 1751 | `	pVm->json_rc = JSON_ERROR_NONE;` |
|        - | 1752 | `	/* PRNG context */` |
|     3881 | 1753 | `	SyRandomnessInit(&pVm->sPrng,0,0);` |
...
|      ! 0 | 1761 | `		goto Err;` |
|        - | 1762 | `	}` |
|     3881 | 1763 | `	PH7_MemObjInit(pVm,pObj);` |
...
|      ! 0 | 1768 | `		goto Err;` |
|        - | 1769 | `	}` |
|     3881 | 1770 | `	PH7_MemObjInitFromBool(pVm,pObj,1);` |
|        - | 1771 | `	/* Install the boolean FALSE constant */` |
|     3881 | 1772 | `	pObj = PH7_ReserveConstObj(&(*pVm),0);` |
|     3881 | 1773 | `	if( pObj == 0 ){` |
|      ! 0 | 1774 | `		rc = SXERR_MEM;` |
|      ! 0 | 1775 | `		goto Err;` |
|        - | 1776 | `	}` |
|     3881 | 1777 | `	PH7_MemObjInitFromBool(pVm,pObj,0);` |
...
|     3881 | 1781 | `	pObj = PH7_ReserveConstObj(&(*pVm),&pVm->nEmptyStringIdx);` |
|     3881 | 1782 | `	if( pObj == 0 ){` |
|      ! 0 | 1783 | `		rc = SXERR_MEM;` |
|      ! 0 | 1784 | `		goto Err;` |
|        - | 1785 | `	}` |
|     3881 | 1786 | `	PH7_MemObjInitFromString(pVm,pObj,0);` |
|        - | 1787 | `	/* Create the global frame */` |
|     3881 | 1788 | `	rc = VmEnterFrame(&(*pVm),0,0,0);` |
|     3881 | 1789 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 1790 | `		goto Err;` |
|        - | 1791 | `	}` |
|        - | 1792 | `	/* Initialize the code generator */` |
|     3881 | 1793 | `	rc = PH7_InitCodeGenerator(pVm,pEngine->xConf.xErr,pEngine->xConf.pErrData);` |
|     3881 | 1794 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 1795 | `		goto Err;` |
|        - | 1796 | `	}` |
|        - | 1797 | `	/* VM correctly initialized,set the magic number */` |
|     3881 | 1798 | `	pVm->nMagic = PH7_VM_INIT;` |
...
|     3881 | 1807 | `	pVm->pFiberClass = PH7_VmExtractClass(pVm,"Fiber",5,0,0);` |
|        - | 1808 | `	/* Cache built-in interface pointers used on hot dispatch paths */` |
|     3881 | 1809 | `	pVm->pArrayAccessClass = PH7_VmExtractClass(pVm,"ArrayAccess",sizeof("ArrayAccess")-1,0,0);` |
|     3881 | 1810 | `	pVm->pCountableClass   = PH7_VmExtractClass(pVm,"Countable",sizeof("Countable")-1,0,0);` |
|     3881 | 1811 | `	pVm->pStringableClass  = PH7_VmExtractClass(pVm,"Stringable",sizeof("Stringable")-1,0,0);` |
|     3881 | 1812 | `	pVm->pJsonSerializableClass = PH7_VmExtractClass(pVm,"JsonSerializable",sizeof("JsonSerializable")-1,0,0);` |
|     3881 | 1813 | `	pVm->pTraversableClass = PH7_VmExtractClass(pVm,"Traversable",sizeof("Traversable")-1,0,0);` |
|        - | 1814 | `	/* Initialize null-coalesce-assign scratch slot */` |
|     3881 | 1815 | `	pVm->pCoalesceObj = 0;` |
|     3881 | 1816 | `	pVm->bCoalesceArmed = 0;` |
|     3881 | 1817 | `	PH7_MemObjInit(pVm,&pVm->sCoalesceKey);` |
|        - | 1818 | `	/* Register Fiber internal C functions */` |
|     3881 | 1819 | `	ph7_create_function(pVm,"__fiber_suspend",vm_builtin_Fiber_suspend,0);` |
|     3881 | 1820 | `	ph7_create_function(pVm,"__fiber_construct",vm_builtin_Fiber_construct,0);` |
|     3881 | 1821 | `	ph7_create_function(pVm,"__fiber_start",vm_builtin_Fiber_start,0);` |
|     3881 | 1822 | `	ph7_create_function(pVm,"__fiber_resume",vm_builtin_Fiber_resume,0);` |
|     3881 | 1823 | `	ph7_create_function(pVm,"__fiber_getReturn",vm_builtin_Fiber_getReturn,0);` |
|     3881 | 1824 | `	ph7_create_function(pVm,"__fiber_isStarted",vm_builtin_Fiber_isStarted,0);` |
|     3881 | 1825 | `	ph7_create_function(pVm,"__fiber_isRunning",vm_builtin_Fiber_isRunning,0);` |
|     3881 | 1826 | `	ph7_create_function(pVm,"__fiber_isSuspended",vm_builtin_Fiber_isSuspended,0);` |
|     3881 | 1827 | `	ph7_create_function(pVm,"__fiber_isTerminated",vm_builtin_Fiber_isTerminated,0);` |
|     3881 | 1828 | `	ph7_create_function(pVm,"__fiber_destruct",vm_builtin_Fiber_destruct,0);` |
|        - | 1829 | `	/* Cache the Closure class pointer (closures are instances of it) */` |
|     3881 | 1830 | `	pVm->pClosureClass = PH7_VmExtractClass(pVm,"Closure",7,0,0);` |
|     3881 | 1831 | `	pVm->pClosureThis = 0; /* transient bound-$this slot, consumed per call */` |
|     3881 | 1832 | `	pVm->pClosureScope = 0; /* transient bound-scope slot, consumed per call */` |
|        - | 1833 | `	/* Closure::bind/bindTo/call/fromCallable native delegates (Increment 2) */` |
|     3881 | 1834 | `	ph7_create_function(pVm,"__closure_bindTo",vm_builtin_Closure_bindTo,0);` |
|     3881 | 1835 | `	ph7_create_function(pVm,"__closure_fromCallable",vm_builtin_Closure_fromCallable,0);` |
|        - | 1836 | `	/* Cache the stdClass pointer ((object) cast target + dynamic-property owner) */` |
|     3881 | 1837 | `	pVm->pStdClass = PH7_VmExtractClass(pVm,"stdClass",sizeof("stdClass")-1,0,0);` |
|        - | 1838 | `	/* Cache the Generator class pointer and register generator functions */` |
|     3881 | 1839 | `	pVm->pGeneratorClass = PH7_VmExtractClass(pVm,"Generator",9,0,0);` |
|     3881 | 1840 | `	ph7_create_function(pVm,"__gen_rewind",vm_builtin_Generator_rewind,0);` |
|     3881 | 1841 | `	ph7_create_function(pVm,"__gen_valid",vm_builtin_Generator_valid,0);` |
|     3881 | 1842 | `	ph7_create_function(pVm,"__gen_current",vm_builtin_Generator_current,0);` |
|     3881 | 1843 | `	ph7_create_function(pVm,"__gen_key",vm_builtin_Generator_key,0);` |
|     3881 | 1844 | `	ph7_create_function(pVm,"__gen_next",vm_builtin_Generator_next,0);` |
|     3881 | 1845 | `	ph7_create_function(pVm,"__gen_send",vm_builtin_Generator_send,0);` |
|     3881 | 1846 | `	ph7_create_function(pVm,"__gen_throw",vm_builtin_Generator_throw,0);` |
|     3881 | 1847 | `	ph7_create_function(pVm,"__gen_getReturn",vm_builtin_Generator_getReturn,0);` |
|     3881 | 1848 | `	ph7_create_function(pVm,"__gen_destruct",vm_builtin_Generator_destruct,0);` |
...
|     3881 | 1852 | `	PH7_VmInstallReflection(&(*pVm));` |
|     3881 | 1853 | `	PH7_VmInstallDateTime(&(*pVm));` |
|     3881 | 1854 | `	PH7_VmInstallSpl(&(*pVm));` |
|     3881 | 1855 | `	PH7_VmInstallTokenizer(&(*pVm));` |
|     3881 | 1856 | `	PH7_VmInstallSession(&(*pVm));` |
|     3881 | 1857 | `	PH7_VmInstallIni(&(*pVm));` |
...
|     3881 | 1861 | `	PH7_VmInstallLibxml(&(*pVm));` |
|     3881 | 1862 | `	PH7_VmInstallDom(&(*pVm));` |
|     3881 | 1863 | `	PH7_VmInstallXmlWriter(&(*pVm));` |
|        - | 1864 | `#endif` |
|     3881 | 1865 | `	pVm->bCompilingBuiltin = 0;` |
|        - | 1866 | `	/* Reset the code generator */` |
|     3881 | 1867 | `	PH7_ResetCodeGenerator(&(*pVm),pEngine->xConf.xErr,pEngine->xConf.pErrData);` |
|     3881 | 1868 | `	return SXRET_OK;` |
|      ! 0 | 1869 | `Err:` |
...
|        - | 1898 | ` */` |
|    43384 | 1899 | `PH7_PRIVATE void VmTrackOutput(ph7_vm *pVm, sxu32 nLen)` |
|        5 | 1900 | `{` |
|    43389 | 1901 | `	ProcConsumer xCons = pVm->sVmConsumer.xConsumer;` |
|    43389 | 1902 | `	if( xCons != VmObConsumer ){` |
|    13103 | 1903 | `		pVm->nOutputLen += nLen;` |
|    13103 | 1904 | `		if( !pVm->bHeadersSent && xCons != PH7_VmBlobConsumer ){` |
|     1419 | 1905 | `			pVm->bHeadersSent = 1;` |
|      707 | 1906 | `		}` |
|     6549 | 1907 | `	}` |
|    43389 | 1908 | `}` |
|        - | 1909 | `/*` |
...
|        - | 1958 | ` */` |
|    51630 | 1959 | `static int VmInstrStackEffect(VmInstr *pI, sxu32 pc, int *pPush, int *pN, sxu32 aSucc[2], sxi32 aDelta[2])` |
|        5 | 1960 | `{` |
|    51635 | 1961 | `	int push = 0, n = 0;` |
|        - | 1962 | `	sxi32 d;` |
|    51635 | 1963 | `	switch( pI->iOp ){` |
...
|     8142 | 1966 | `	case PH7_OP_LOADC:` |
|        - | 1967 | `	case PH7_OP_DUP:` |
|    16289 | 1968 | `		push = 1; aSucc[0] = pc + 1; aDelta[0] = 1; n = 1; break;` |
|     5838 | 1969 | `	case PH7_OP_LOAD:` |
|    11681 | 1970 | `		if( pI->p3 ){ push = 1; d = 1; }else{ push = 0; d = 0; }` |
|    11681 | 1971 | `		aSucc[0] = pc + 1; aDelta[0] = d; n = 1; break;` |
...
|     5999 | 2019 | `		n = 0; break;` |
|     3139 | 2020 | `	default:` |
|     6283 | 2021 | `		return 0; /* unmodeled opcode -> whole-body fallback */` |
|        - | 2022 | `	}` |
|    45357 | 2023 | `	*pPush = push; *pN = n;` |
|    45357 | 2024 | `	return 1;` |
|    25820 | 2025 | `}` |
|        - | 2026 | `/*` |
...
|        - | 2030 | ` */` |
|     8326 | 2031 | `PH7_PRIVATE sxu32 VmComputeMaxStack(ph7_vm *pVm, VmInstr *aInstr, sxu32 nInstr)` |
|        5 | 2032 | `{` |
|        - | 2033 | `	void *pScratch;` |
...
|     8331 | 2039 | `	if( nInstr == 0 \|\| nInstr > 8192 ){` |
...
|    45027 | 2044 | `	for( i = 0; i < nInstr; i++ ){` |
|    42979 | 2045 | `		if( !VmInstrStackEffect(&aInstr[i], i, &push, &n, succ, delta) ){` |
|     6283 | 2046 | `			return VM_STACK_UNMODELED;` |
|        - | 2047 | `		}` |
|    18353 | 2048 | `	}` |
...
|        - | 2095 | ` */` |
|   250482 | 2096 | `PH7_PRIVATE ph7_value * VmNewOperandStack(` |
...
|        - | 2108 | `  */` |
|   250487 | 2109 | `	nInstr += VM_STACK_GUARD;` |
|   250487 | 2110 | `	pStack = (ph7_value *)SyMemBackendAlloc(&pVm->sAllocator,nInstr * sizeof(ph7_value));` |
|   250487 | 2111 | `	if( pStack == 0 ){` |
|      ! 0 | 2112 | `		return 0;` |
|        - | 2113 | `	}` |
|        - | 2114 | `	/* Initialize the operand stack */` |
| 24328737 | 2115 | `	while( nInstr > 0 ){` |
| 24078255 | 2116 | `		PH7_MemObjInit(&(*pVm),&pStack[nInstr - 1]);` |
| 24078255 | 2117 | `		--nInstr;` |
|        5 | 2118 | `	}` |
|        - | 2119 | `	/* Ready for bytecode execution */` |
|   250487 | 2120 | `	return pStack;` |
|   125350 | 2121 | `}` |
|        - | 2122 | `/*` |
...
|        - | 2160 | ` */` |
|   106289 | 2161 | `PH7_PRIVATE ph7_value * VmOperandStackAlloc(ph7_vm *pVm, sxu32 nSlots)` |
|        5 | 2162 | `{` |
|   106294 | 2163 | `	VmIdleStack *pIdle = (VmIdleStack *)pVm->pIdleOperandStacks;` |
|   106294 | 2164 | `	sxu32 nCap = nSlots + VM_STACK_GUARD;` |
|   106294 | 2165 | `	if( pIdle && pIdle->nCap == nCap ){` |
|    16066 | 2166 | `		ph7_value *pStack = pIdle->pStack;` |
|    16066 | 2167 | `		pVm->pIdleOperandStacks = pIdle->pNext;` |
|    16066 | 2168 | `		pVm->nIdleOperandStacks--;` |
...
|    16066 | 2171 | `		pIdle->pNext = (VmIdleStack *)pVm->pIdleStackNodes;` |
|    16066 | 2172 | `		pVm->pIdleStackNodes = pIdle;` |
|    16066 | 2173 | `		return pStack; /* slots already released -> reusable without re-init */` |
|        - | 2174 | `	}` |
...
|        - | 2181 | ` * live value.` |
|        - | 2182 | ` */` |
|   105879 | 2183 | `PH7_PRIVATE void VmOperandStackRecycle(ph7_vm *pVm, ph7_value *pStack, sxu32 nCap)` |
|        5 | 2184 | `{` |
|        - | 2185 | `	VmIdleStack *pIdle;` |
|        - | 2186 | `	sxu32 i;` |
|   105884 | 2187 | `	if( pStack == 0 ){` |
|      ! 0 | 2188 | `		return;` |
|        - | 2189 | `	}` |
|   105884 | 2190 | `	if( pVm->nIdleOperandStacks >= VM_STACK_POOL_MAX \|\| nCap > VM_STACK_POOL_MAXSLOTS ){` |
|    83875 | 2191 | `		SyMemBackendFree(&pVm->sAllocator,pStack);` |
|    83875 | 2192 | `		return;` |
|        - | 2193 | `	}` |
...
|    22014 | 2196 | `	pIdle = (VmIdleStack *)pVm->pIdleStackNodes;` |
|    22014 | 2197 | `	if( pIdle ){` |
|    16066 | 2198 | `		pVm->pIdleStackNodes = pIdle->pNext;` |
|     8037 | 2199 | `	}else{` |
|     5953 | 2200 | `		pIdle = (VmIdleStack *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmIdleStack));` |
|     5953 | 2201 | `		if( pIdle == 0 ){` |
|      ! 0 | 2202 | `			SyMemBackendFree(&pVm->sAllocator,pStack);` |
|      ! 0 | 2203 | `			return;` |
|        - | 2204 | `		}` |
|        - | 2205 | `	}` |
|  1316943 | 2206 | `	for( i = 0; i < nCap; i++ ){` |
|  1294934 | 2207 | `		PH7_MemObjRelease(&pStack[i]);` |
...
|  1294934 | 2213 | `		pStack[i].nIdx = SXU32_HIGH;` |
|   648050 | 2214 | `	}` |
|    22014 | 2215 | `	pIdle->pStack = pStack;` |
|    22014 | 2216 | `	pIdle->nCap = nCap;` |
|    22014 | 2217 | `	pIdle->pNext = (VmIdleStack *)pVm->pIdleOperandStacks;` |
|    22014 | 2218 | `	pVm->pIdleOperandStacks = pIdle;` |
|    22014 | 2219 | `	pVm->nIdleOperandStacks++;` |
|    53050 | 2220 | `}` |
...
|     3401 | 2244 | `	PH7_ResetCodeGenerator(pVm,pVm->pEngine->xConf.xErr,pVm->pEngine->xConf.pErrData);` |
|        - | 2245 | `	/* Emit the DONE instruction */` |
|     3401 | 2246 | `	rc = PH7_VmEmitInstr(&(*pVm),PH7_OP_DONE,0,0,0,0);` |
|     3401 | 2247 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 2248 | `		return SXERR_MEM;` |
|        - | 2249 | `	}` |
|        - | 2250 | `	/* Script return value */` |
|     3401 | 2251 | `	PH7_MemObjInit(&(*pVm),&pVm->sExec); /* Assume a NULL return value */` |
|        - | 2252 | `	/* Allocate a new operand stack */` |
|     3401 | 2253 | `	pVm->aOps = VmNewOperandStack(&(*pVm),SySetUsed(pVm->pByteContainer));` |
|     3401 | 2254 | `	if( pVm->aOps == 0 ){` |
|      ! 0 | 2255 | `		return SXERR_MEM;` |
|        - | 2256 | `	}` |
|        - | 2257 | `	/* Set the default VM output consumer callback and it's` |
|        - | 2258 | `	 * private data. */` |
|     3401 | 2259 | `	pVm->sVmConsumer.xConsumer = PH7_VmBlobConsumer;` |
|     3401 | 2260 | `	pVm->sVmConsumer.pUserData = &pVm->sConsumer;` |
|        - | 2261 | `	/* Allocate the reference table */` |
|     3401 | 2262 | `	pVm->nRefSize = 0x10; /* Must be a power of two for fast arithemtic */` |
|     3401 | 2263 | `	pVm->apRefObj = (VmRefObj **)SyMemBackendAlloc(&pVm->sAllocator,sizeof(VmRefObj *) * pVm->nRefSize);` |
|     3401 | 2264 | `	if( pVm->apRefObj == 0 ){` |
...
|     3401 | 2269 | `	SyZero(pVm->apRefObj,sizeof(VmRefObj *) * pVm->nRefSize);` |
|        - | 2270 | `	/* Register special functions first [i.e: print, json_encode(), func_get_args(), die, etc.] */` |
|     3401 | 2271 | `	rc = VmRegisterSpecialFunction(&(*pVm));` |
|     3401 | 2272 | `	if( rc != SXRET_OK ){` |
...
|     3401 | 2281 | `	pVm->nSuperBaseline = SySetUsed(&pVm->aMemObj);` |
|        - | 2282 | `	/* Create superglobals [i.e: $GLOBALS, $_GET, $_POST...] */` |
|     3401 | 2283 | `	rc = PH7_HashmapCreateSuper(&(*pVm));` |
|     3401 | 2284 | `	if( rc != SXRET_OK ){` |
...
|     3401 | 2315 | `	SyHashResetLoopCursor(&pVm->hClass);` |
|   465551 | 2316 | `	while((pEntry = SyHashGetNextEntry(&pVm->hClass)) != 0 ){` |
|   462157 | 2317 | `		rc = VmMountUserClass(&(*pVm),(ph7_class *)pEntry->pUserData);` |
|   462157 | 2318 | `		if( rc != SXRET_OK ){` |
|        3 | 2319 | `			return rc;` |
|        - | 2320 | `		}` |
|        5 | 2321 | `	}` |
|        - | 2322 | `	/* Random number betwwen 0 and 1023 used to generate unique ID */` |
|     3399 | 2323 | `	pVm->unique_id = PH7_VmRandomNum(&(*pVm)) & 1023;` |
|        - | 2324 | `	/* First object handle id handed out is 1 (matches PHP's first userland object #1) */` |
|     3399 | 2325 | `	pVm->nNextObjId = 1;` |
|        - | 2326 | `	/* VM is ready for bytecode execution */` |
|     3399 | 2327 | `	return SXRET_OK;` |
|     1703 | 2328 | `}` |
|        - | 2329 | `/*` |
...
|        - | 2744 | ` */` |
|     3394 | 2745 | `PH7_PRIVATE sxi32 PH7_VmRelease(ph7_vm *pVm)` |
|        5 | 2746 | `{` |
|        - | 2747 | `	/* Set the stale magic number */` |
|     3399 | 2748 | `	pVm->nMagic = PH7_VM_STALE;` |
...
|     3399 | 2752 | `	PH7_LibxmlVmRelease(pVm);` |
|        - | 2753 | `#endif` |
|        - | 2754 | `	/* Release the private memory subsystem */` |
|     3399 | 2755 | `	SyMemBackendRelease(&pVm->sAllocator);` |
|     3399 | 2756 | `	return SXRET_OK;` |
|        5 | 2757 | `}` |
|        - | 2758 | `/*` |
...
|        - | 2767 | ` */` |
|   943065 | 2768 | `PH7_PRIVATE sxi32 VmInitCallContext(` |
...
|        - | 2774 | `	)` |
|        5 | 2775 | `{` |
|   943070 | 2776 | `	pOut->pFunc = pFunc;` |
|   943070 | 2777 | `	pOut->pVm   = pVm;` |
|   943070 | 2778 | `	SySetInit(&pOut->sVar,&pVm->sAllocator,sizeof(ph7_value *));` |
|   943070 | 2779 | `	SySetInit(&pOut->sChunk,&pVm->sAllocator,sizeof(ph7_aux_data));` |
|        - | 2780 | `	/* Assume a null return value */` |
|   943070 | 2781 | `	MemObjSetType(pRet,MEMOBJ_NULL);` |
|   943070 | 2782 | `	pOut->pRet = pRet;` |
|   943070 | 2783 | `	pOut->iFlags = iFlags;` |
|   943070 | 2784 | `	pOut->pArgMap = 0; /* Set by the OP_CALL dispatcher for named-arg-aware builtins */` |
|   943070 | 2785 | `	return SXRET_OK;` |
|        5 | 2786 | `}` |
|        - | 2787 | `/*` |
|        - | 2788 | ` * Release a foreign function call context and cleanup the mess` |
|        - | 2789 | ` * left behind.` |
|        - | 2790 | ` */` |
|   943065 | 2791 | `PH7_PRIVATE void VmReleaseCallContext(ph7_context *pCtx)` |
|        5 | 2792 | `{` |
|        - | 2793 | `	sxu32 n;` |
|   943070 | 2794 | `	if( SySetUsed(&pCtx->sVar) > 0 ){` |
|    11841 | 2795 | `		ph7_value **apObj = (ph7_value **)SySetBasePtr(&pCtx->sVar);` |
|    68784 | 2796 | `		for( n = 0 ; n < SySetUsed(&pCtx->sVar) ; ++n ){` |
|    56948 | 2797 | `			if( apObj[n] == 0 ){` |
|        - | 2798 | `				/* Already released */` |
|      688 | 2799 | `				continue;` |
|        - | 2800 | `			}` |
|    56265 | 2801 | `			PH7_MemObjRelease(apObj[n]);` |
|    56265 | 2802 | `			SyMemBackendPoolFree(&pCtx->pVm->sAllocator,apObj[n]);` |
|    28135 | 2803 | `		}` |
|    11841 | 2804 | `		SySetRelease(&pCtx->sVar);` |
|     5918 | 2805 | `	}` |
|   943070 | 2806 | `	if( SySetUsed(&pCtx->sChunk) > 0 ){` |
...
|        - | 2852 | ` */` |
|  5875068 | 2853 | `PH7_PRIVATE void VmPopOperand(` |
|        - | 2854 | `	ph7_value **ppTos, /* Operand stack */` |
|        - | 2855 | `	sxi32 nPop         /* Total number of memory objects to pop */` |
|        - | 2856 | `	)` |
|        5 | 2857 | `{` |
|  5875073 | 2858 | `	ph7_value *pTos = *ppTos;` |
| 12486414 | 2859 | `	while( nPop > 0 ){` |
|  6611346 | 2860 | `		PH7_MemObjRelease(pTos);` |
|  6611346 | 2861 | `		pTos--;` |
|  6611346 | 2862 | `		nPop--;` |
|        5 | 2863 | `	}` |
|        - | 2864 | `	/* Top of the stack */` |
|  5875073 | 2865 | `	*ppTos = pTos;` |
|  5875073 | 2866 | `}` |
|        - | 2867 | `/*` |
|        - | 2868 | ` * Reserve a memory object.` |
|        - | 2869 | ` * Return a pointer to the raw ph7_value on success. NULL on failure.` |
|        - | 2870 | ` */` |
|  4394607 | 2871 | `PH7_PRIVATE ph7_value * PH7_ReserveMemObj(ph7_vm *pVm)` |
|        5 | 2872 | `{` |
|  4394612 | 2873 | `	ph7_value *pObj = 0;` |
|        - | 2874 | `	VmSlot *pSlot;` |
|        - | 2875 | `	sxu32 nIdx;` |
|        - | 2876 | `	/* Check for a free slot */` |
|  4394612 | 2877 | `	nIdx = SXU32_HIGH; /* cc warning */` |
|  4394612 | 2878 | `	pSlot = (VmSlot *)SySetPop(&pVm->aFreeObj);` |
|  4394612 | 2879 | `	if( pSlot ){` |
|  2156856 | 2880 | `		pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pSlot->nIdx);` |
|  2156856 | 2881 | `		nIdx = pSlot->nIdx;` |
|  1079058 | 2882 | `	}` |
|  4394612 | 2883 | `	if( pObj == 0 ){` |
|        - | 2884 | `		/* Reserve a new memory object */` |
|  2237761 | 2885 | `		pObj = VmReserveMemObj(&(*pVm),&nIdx);` |
|  2237761 | 2886 | `		if( pObj == 0 ){` |
|      ! 0 | 2887 | `			return 0;` |
|        - | 2888 | `		}` |
|  1118878 | 2889 | `	}` |
|        - | 2890 | `	/* Set a null default value */` |
|  4394612 | 2891 | `	PH7_MemObjInit(&(*pVm),pObj);` |
|  4394612 | 2892 | `	pObj->nIdx = nIdx;` |
|  4394612 | 2893 | `	return pObj;` |
|  2197941 | 2894 | `}` |
|        - | 2895 | `/*` |
|        - | 2896 | ` * Insert an entry by reference (not copy) in the given hashmap.` |
|        - | 2897 | ` */` |
|    46234 | 2898 | `PH7_PRIVATE sxi32 VmHashmapRefInsert(` |
...
|        - | 2905 | `	ph7_value sKey;` |
|        - | 2906 | `	sxi32 rc;` |
|    46239 | 2907 | `	PH7_MemObjInitFromString(pMap->pVm,&sKey,0);` |
|    46239 | 2908 | `	PH7_MemObjStringAppend(&sKey,zKey,nByte);` |
|        - | 2909 | `	/* Perform the insertion */` |
|    46239 | 2910 | `	rc = PH7_HashmapInsertByRef(&(*pMap),&sKey,nRefIdx);` |
|    46239 | 2911 | `	PH7_MemObjRelease(&sKey);` |
|    46239 | 2912 | `	return rc;` |
|        5 | 2913 | `}` |
|        - | 2914 | `/*` |
...
|        - | 3025 | ` */` |
|  5976863 | 3026 | `PH7_PRIVATE ph7_value * VmExtractMemObj(` |
...
|        - | 3031 | `	)` |
|        5 | 3032 | `{` |
|  5976868 | 3033 | `	int bNullify = FALSE;` |
...
|  5976868 | 3040 | `	pFrame = pVm->pFrame;` |
|  5976868 | 3041 | `	pFrame = VmSkipExceptionFrames(pFrame);` |
|        - | 3042 | `	/* Perform the lookup */` |
|  5976868 | 3043 | `	if( pName == 0 \|\| pName->nByte < 1 ){` |
...
|  5976868 | 3051 | `	pEntry = SyHashGet(&pVm->hSuper,(const void *)pName->zString,pName->nByte);` |
|  5976868 | 3052 | `	if( pEntry == 0 ){` |
|        - | 3053 | `		/* Query the top active frame */` |
|  5976452 | 3054 | `		pEntry = SyHashGet(&pFrame->hVar,(const void *)pName->zString,pName->nByte);` |
|  5976452 | 3055 | `		if( pEntry == 0 ){` |
|   520427 | 3056 | `			char *zName = (char *)pName->zString;` |
|        - | 3057 | `			VmSlot sLocal;` |
|   520427 | 3058 | `			if( !bCreate ){` |
...
|        - | 3064 | `			 */` |
|   519171 | 3065 | `			pObj = PH7_ReserveMemObj(&(*pVm));` |
|   519171 | 3066 | `			if( pObj == 0 ){` |
|      ! 0 | 3067 | `				return 0;` |
|        - | 3068 | `			}` |
|   519171 | 3069 | `			nIdx = pObj->nIdx;` |
|   519171 | 3070 | `			if( bDup ){` |
|        - | 3071 | `				/* Duplicate name */` |
|      585 | 3072 | `				zName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|      585 | 3073 | `				if( zName == 0 ){` |
|      ! 0 | 3074 | `					return 0;` |
|        - | 3075 | `				}` |
|      290 | 3076 | `			}` |
|        - | 3077 | `			/* Link to the top active VM frame */` |
|   519171 | 3078 | `			rc = SyHashInsert(&pFrame->hVar,zName,pName->nByte,SX_INT_TO_PTR(nIdx));` |
|   519171 | 3079 | `			if( rc != SXRET_OK ){` |
...
|      ! 0 | 3084 | `				return 0;` |
|        - | 3085 | `			}` |
|   519171 | 3086 | `			if( pFrame->pParent != 0 ){` |
|        - | 3087 | `				/* Local variable */` |
|   510527 | 3088 | `				sLocal.nIdx = nIdx;` |
|   510527 | 3089 | `				SySetPut(&pFrame->sLocal,(const void *)&sLocal);` |
|   255899 | 3090 | `			}else{` |
|        - | 3091 | `				/* Register in the $GLOBALS array */` |
|     8649 | 3092 | `				VmHashmapRefInsert(pVm->pGlobal,pName->zString,pName->nByte,nIdx);` |
|        - | 3093 | `			}` |
|        - | 3094 | `			/* Install in the reference table */` |
|   519171 | 3095 | `			PH7_VmRefObjInstall(&(*pVm),nIdx,SyHashLastEntry(&pFrame->hVar),0,0);` |
|        - | 3096 | `			/* Save object index */` |
|   519171 | 3097 | `			pObj->nIdx = nIdx;` |
|   260221 | 3098 | `		}else{` |
|        - | 3099 | `			/* Extract variable contents */` |
|  5456030 | 3100 | `			nIdx = (sxu32)SX_PTR_TO_INT(pEntry->pUserData);` |
|  5456030 | 3101 | `			pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|  5456030 | 3102 | `			if( bNullify && pObj ){` |
...
|        - | 3116 | ` */` |
|    30954 | 3117 | `PH7_PRIVATE ph7_value * PH7_VmExtractSuper(` |
...
|    30959 | 3127 | `	pEntry = SyHashGet(&pVm->hSuper,(const void *)zName,nByte);` |
|    30959 | 3128 | `	if( pEntry == 0 ){` |
|        - | 3129 | `		/* No such entry */` |
|      ! 0 | 3130 | `		return 0;` |
|        - | 3131 | `	}` |
|        - | 3132 | `	/* Extract the superglobal index in the global object pool */` |
|    30959 | 3133 | `	nIdx = SX_PTR_TO_INT(pEntry->pUserData);` |
|        - | 3134 | `	/* Extract the variable value  */` |
|    30959 | 3135 | `	pValue = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|    30959 | 3136 | `	return pValue;` |
|    15482 | 3137 | `}` |
|        - | 3138 | `/*` |
|        - | 3139 | ` * Perform a raw hashmap insertion.` |
|        - | 3140 | ` * Refer to the [PH7_VmConfigure()] implementation for additional information.` |
|        - | 3141 | ` */` |
|    24252 | 3142 | `PH7_PRIVATE sxi32 PH7_VmHashmapInsert(` |
...
|        - | 3151 | `	sxi32 rc;` |
|    24257 | 3152 | `	PH7_MemObjInitFromString(pMap->pVm,&sKey,0);` |
|    24257 | 3153 | `	PH7_MemObjInitFromString(pMap->pVm,&sValue,0);` |
|    24257 | 3154 | `	if( zKey ){` |
|    20857 | 3155 | `		if( nKeylen < 0 ){` |
|    20753 | 3156 | `			nKeylen = (int)SyStrlen(zKey);` |
|    10374 | 3157 | `		}` |
|    20857 | 3158 | `		PH7_MemObjStringAppend(&sKey,zKey,(sxu32)nKeylen);` |
|    10426 | 3159 | `	}` |
|    24257 | 3160 | `	if( zData ){` |
|    24257 | 3161 | `		if( nLen < 0 ){` |
|        - | 3162 | `			/* Compute length automatically */` |
|    13763 | 3163 | `			nLen = (int)SyStrlen(zData);` |
|     6879 | 3164 | `		}` |
|    24257 | 3165 | `		PH7_MemObjStringAppend(&sValue,zData,(sxu32)nLen);` |
|    12126 | 3166 | `	}` |
...
|    24257 | 3171 | `	rc = PH7_HashmapInsert(&(*pMap),zKey ? &sKey : 0,&sValue);` |
|    24257 | 3172 | `	PH7_MemObjRelease(&sKey);` |
|    24257 | 3173 | `	PH7_MemObjRelease(&sValue);` |
|    24257 | 3174 | `	return rc;` |
|        5 | 3175 | `}` |
|        - | 3176 | `/*` |
...
|        - | 3188 | ` */` |
|    88874 | 3189 | `PH7_PRIVATE sxi32 PH7_VmConfigure(` |
|        - | 3190 | `	ph7_vm *pVm, /* Target VM */` |
|        - | 3191 | `	sxi32 nOp,   /* Configuration verb */` |
|        - | 3192 | `	va_list ap   /* Subsequent option arguments */` |
|        - | 3193 | `	)` |
|        5 | 3194 | `{` |
|    88879 | 3195 | `	sxi32 rc = SXRET_OK;` |
|    88879 | 3196 | `	switch(nOp){` |
|     1684 | 3197 | `	case PH7_VM_CONFIG_OUTPUT: {` |
|     3373 | 3198 | `		ProcConsumer xConsumer = va_arg(ap,ProcConsumer);` |
|     3373 | 3199 | `		void *pUserData = va_arg(ap,void *);` |
...
|     3373 | 3208 | `		pVm->sVmConsumer.xConsumer = xConsumer;` |
|     3373 | 3209 | `		pVm->sVmConsumer.pUserData = pUserData;` |
|     3373 | 3210 | `		break;` |
|        - | 3211 | `							   }` |
|     1697 | 3212 | `	case PH7_VM_CONFIG_IMPORT_PATH: {` |
|        - | 3213 | `		/* Import path */` |
|        - | 3214 | `		  const char *zPath;` |
|        - | 3215 | `		  SyString sPath;` |
|     3399 | 3216 | `		  zPath = va_arg(ap,const char *);` |
...
|        - | 3221 | `		  }` |
|        - | 3222 | `#endif` |
|     3399 | 3223 | `		  SyStringInitFromBuf(&sPath,zPath,SyStrlen(zPath));` |
|        - | 3224 | `		  /* Remove trailing slashes and backslashes */` |
|        - | 3225 | `#ifdef __WINNT__` |
|        5 | 3226 | `		  SyStringTrimTrailingChar(&sPath,'\\');` |
|        - | 3227 | `#endif` |
|     6793 | 3228 | `		  SyStringTrimTrailingChar(&sPath,'/');` |
|        - | 3229 | `		  /* Remove leading and trailing white spaces */` |
|     3399 | 3230 | `		  SyStringFullTrim(&sPath);` |
|     3399 | 3231 | `		  if( sPath.nByte > 0 ){` |
|        - | 3232 | `			  /* Store the path in the corresponding conatiner */` |
|     3399 | 3233 | `			  rc = SySetPut(&pVm->aPaths,(const void *)&sPath);` |
|     1697 | 3234 | `		  }` |
|     3399 | 3235 | `		  break;` |
|        - | 3236 | `									 }` |
|     1700 | 3237 | `	case PH7_VM_CONFIG_ERR_REPORT:` |
|        - | 3238 | `		/* Run-Time Error report */` |
|     3405 | 3239 | `		pVm->bErrReport = 1;` |
|     3405 | 3240 | `		pVm->iErrMask = 30719; /* E_ALL (php 8: E_STRICT/2048 is no longer part of E_ALL) */` |
|     3405 | 3241 | `		break;` |
...
|        - | 3281 | `							   }` |
|        - | 3282 |  |
|    18704 | 3283 | `	case PH7_VM_CONFIG_CREATE_SUPER:` |
|        - | 3284 | `	case PH7_VM_CONFIG_CREATE_VAR: {` |
|        - | 3285 | `		/* Create a new superglobal/global variable */` |
|    37413 | 3286 | `		const char *zName = va_arg(ap,const char *);` |
|    37413 | 3287 | `		ph7_value *pValue = va_arg(ap,ph7_value *);` |
...
|        - | 3296 | `		}` |
|        - | 3297 | `#endif` |
|    37413 | 3298 | `		nByte = SyStrlen(zName);` |
|    37413 | 3299 | `		if( nOp == PH7_VM_CONFIG_CREATE_SUPER ){` |
|        - | 3300 | `			/* Check if the superglobal is already installed */` |
|    34045 | 3301 | `			pEntry = SyHashGet(&pVm->hSuper,(const void *)zName,nByte);` |
|    17025 | 3302 | `		}else{` |
|        - | 3303 | `			/* Query the top active VM frame */` |
|     3373 | 3304 | `			pEntry = SyHashGet(&pVm->pFrame->hVar,(const void *)zName,nByte);` |
|        - | 3305 | `		}` |
|    37413 | 3306 | `		if( pEntry ){` |
...
|    37413 | 3317 | `			pObj = PH7_ReserveMemObj(&(*pVm));` |
|    37413 | 3318 | `			if( pObj == 0 ){` |
|      ! 0 | 3319 | `				rc = SXERR_MEM;` |
|      ! 0 | 3320 | `				break;` |
|        - | 3321 | `			}` |
|    37413 | 3322 | `			nIdx = pObj->nIdx;` |
|        - | 3323 | `			/* Copy value */` |
|    37413 | 3324 | `			PH7_MemObjStore(pValue,pObj);` |
|    37413 | 3325 | `			if( nOp == PH7_VM_CONFIG_CREATE_SUPER ){` |
|        - | 3326 | `				/* Install the superglobal */` |
|    34045 | 3327 | `				rc = SyHashInsert(&pVm->hSuper,(const void *)zName,nByte,SX_INT_TO_PTR(nIdx));` |
|    17025 | 3328 | `			}else{` |
|        - | 3329 | `				/* Install in the current frame */` |
|     3373 | 3330 | `				rc = SyHashInsert(&pVm->pFrame->hVar,(const void *)zName,nByte,SX_INT_TO_PTR(nIdx));` |
|        - | 3331 | `			}` |
|    37413 | 3332 | `			if( rc == SXRET_OK ){` |
|        - | 3333 | `				SyHashEntry *pRef;` |
|    37413 | 3334 | `				if( nOp == PH7_VM_CONFIG_CREATE_SUPER ){` |
|    34045 | 3335 | `					pRef = SyHashLastEntry(&pVm->hSuper);` |
|    17025 | 3336 | `				}else{` |
|     3373 | 3337 | `					pRef = SyHashLastEntry(&pVm->pFrame->hVar);` |
|        - | 3338 | `				}` |
|        - | 3339 | `				/* Install in the reference table */` |
|    37413 | 3340 | `				PH7_VmRefObjInstall(&(*pVm),nIdx,pRef,0,0);` |
|    37413 | 3341 | `				if( nOp == PH7_VM_CONFIG_CREATE_SUPER \|\| pVm->pFrame->pParent == 0){` |
|        - | 3342 | `					/* Register in the $GLOBALS array */` |
|    37413 | 3343 | `					VmHashmapRefInsert(pVm->pGlobal,zName,nByte,nIdx);` |
|    18704 | 3344 | `				}` |
|    18704 | 3345 | `			}` |
|        - | 3346 | `		}` |
|    37413 | 3347 | `		break;` |
|        - | 3348 | `									}` |
|    10374 | 3349 | `	case PH7_VM_CONFIG_SERVER_ATTR:` |
...
|    20751 | 3381 | `			pValue = PH7_VmExtractSuper(&(*pVm),"_SERVER",sizeof("_SERVER")-1);` |
|        - | 3382 | `		}` |
|    20753 | 3383 | `		if( pValue == 0 \|\| (pValue->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
|        - | 3384 | `			/* No such entry */` |
|      ! 0 | 3385 | `			rc = SXERR_NOTFOUND;` |
|      ! 0 | 3386 | `			break;` |
|        - | 3387 | `		}` |
|        - | 3388 | `		/* Point to the hashmap */` |
|    20753 | 3389 | `		pMap = (ph7_hashmap *)pValue->x.pOther;` |
|        - | 3390 | `		/* Perform the insertion */` |
|    20753 | 3391 | `		rc = PH7_VmHashmapInsert(pMap,zKey,-1,zValue,nLen);` |
|    20753 | 3392 | `		break;` |
|        - | 3393 | `								   }` |
|     1701 | 3394 | `	case PH7_VM_CONFIG_ARGV_ENTRY:{` |
|        - | 3395 | `		/* Script arguments */` |
|     3407 | 3396 | `		const char *zValue = va_arg(ap,const char *);` |
|        - | 3397 | `		ph7_hashmap *pMap;` |
|        - | 3398 | `		ph7_value *pValue;` |
|        - | 3399 | `		sxu32 n;` |
|     3407 | 3400 | `		if( SX_EMPTY_STR(zValue) ){` |
|        2 | 3401 | `			rc = SXERR_EMPTY;` |
|        2 | 3402 | `			break;` |
|        - | 3403 | `		}` |
|        - | 3404 | `		/* Extract the $argv array */` |
|     3405 | 3405 | `		pValue = PH7_VmExtractSuper(&(*pVm),"argv",sizeof("argv")-1);` |
|     3405 | 3406 | `		if( pValue == 0 \|\| (pValue->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
|        - | 3407 | `			/* No such entry */` |
|      ! 0 | 3408 | `			rc = SXERR_NOTFOUND;` |
|      ! 0 | 3409 | `			break;` |
|        - | 3410 | `		}` |
|        - | 3411 | `		/* Point to the hashmap */` |
|     3405 | 3412 | `		pMap = (ph7_hashmap *)pValue->x.pOther;` |
|        - | 3413 | `		/* Perform the insertion */` |
|     3405 | 3414 | `		n = (sxu32)SyStrlen(zValue);` |
|     3405 | 3415 | `		rc = PH7_VmHashmapInsert(pMap,0,0,zValue,(int)n);` |
|     3405 | 3416 | `		if( rc == SXRET_OK ){` |
|     3405 | 3417 | `			if( pMap->nEntry > 1 ){` |
|        - | 3418 | `				/* Append space separator first */` |
|       37 | 3419 | `				SyBlobAppend(&pVm->sArgv,(const void *)" ",sizeof(char));` |
|       16 | 3420 | `			}` |
|     3405 | 3421 | `			SyBlobAppend(&pVm->sArgv,(const void *)zValue,n);` |
|     1700 | 3422 | `		}` |
|     3405 | 3423 | `		break;` |
|        - | 3424 | `								  }` |
|     1684 | 3425 | `	case PH7_VM_CONFIG_SERVER_ARGV: {` |
...
|     3373 | 3433 | `		pArgv   = PH7_VmExtractSuper(&(*pVm),"argv",sizeof("argv")-1);` |
|     3373 | 3434 | `		pServer = PH7_VmExtractSuper(&(*pVm),"_SERVER",sizeof("_SERVER")-1);` |
|     3368 | 3435 | `		if( pArgv == 0 \|\| (pArgv->iFlags & MEMOBJ_HASHMAP) == 0` |
|     3373 | 3436 | `		 \|\| pServer == 0 \|\| (pServer->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
|      ! 0 | 3437 | `			rc = SXERR_NOTFOUND;` |
|      ! 0 | 3438 | `			break;` |
|        - | 3439 | `		}` |
|     3373 | 3440 | `		pArgvMap   = (ph7_hashmap *)pArgv->x.pOther;` |
|     3373 | 3441 | `		pServerMap = (ph7_hashmap *)pServer->x.pOther;` |
|        - | 3442 | `		/* Deep-copy $argv so $_SERVER['argv'] is an independent array. */` |
|     3373 | 3443 | `		pDup = PH7_NewHashmap(&(*pVm),0,0);` |
|     3373 | 3444 | `		if( pDup == 0 ){` |
|      ! 0 | 3445 | `			rc = SXERR_MEM;` |
|      ! 0 | 3446 | `			break;` |
|        - | 3447 | `		}` |
|     3373 | 3448 | `		PH7_HashmapDup(pArgvMap,pDup);` |
|     3373 | 3449 | `		PH7_MemObjInitFromArray(&(*pVm),&sArgvVal,pDup);` |
|     3373 | 3450 | `		PH7_MemObjInitFromString(&(*pVm),&sKey,0);` |
|     3373 | 3451 | `		PH7_MemObjStringAppend(&sKey,"argv",sizeof("argv")-1);` |
|     3373 | 3452 | `		PH7_HashmapInsert(pServerMap,&sKey,&sArgvVal);` |
|     3373 | 3453 | `		PH7_MemObjRelease(&sArgvVal); /* drops the duplicated array */` |
|     3373 | 3454 | `		PH7_MemObjRelease(&sKey);` |
|        - | 3455 | `		/* $_SERVER['argc'] = count($argv). */` |
|     3373 | 3456 | `		PH7_MemObjInitFromInt(&(*pVm),&sCount,(sxi64)pArgvMap->nEntry);` |
|     3373 | 3457 | `		PH7_MemObjInitFromString(&(*pVm),&sKey,0);` |
|     3373 | 3458 | `		PH7_MemObjStringAppend(&sKey,"argc",sizeof("argc")-1);` |
|     3373 | 3459 | `		PH7_HashmapInsert(pServerMap,&sKey,&sCount);` |
|     3373 | 3460 | `		PH7_MemObjRelease(&sCount);` |
|     3373 | 3461 | `		PH7_MemObjRelease(&sKey);` |
|     3373 | 3462 | `		rc = SXRET_OK;` |
|     3373 | 3463 | `		break;` |
|        - | 3464 | `								  }` |
...
|      ! 0 | 3538 | `		break;` |
|        - | 3539 | `								   }` |
|     6793 | 3540 | `	case PH7_VM_CONFIG_IO_STREAM: {` |
|        - | 3541 | `		/* Register an IO stream device */` |
|    13591 | 3542 | `		const ph7_io_stream *pStream = va_arg(ap,const ph7_io_stream *);` |
|        - | 3543 | `		/* Make sure we are dealing with a valid IO stream */` |
|    13586 | 3544 | `		if( pStream == 0 \|\| pStream->zName == 0 \|\| pStream->zName[0] == 0 \|\|` |
|    13591 | 3545 | `			pStream->xOpen == 0 \|\| pStream->xRead == 0 ){` |
|        - | 3546 | `				/* Invalid stream */` |
|      ! 0 | 3547 | `				rc = SXERR_INVALID;` |
|      ! 0 | 3548 | `				break;` |
|        - | 3549 | `		}` |
|    13591 | 3550 | `		if( pVm->pDefStream == 0 && SyStrnicmp(pStream->zName,"file",sizeof("file")-1) == 0 ){` |
|        - | 3551 | `			/* Make the 'file://' stream the defaut stream device */` |
|     3401 | 3552 | `			pVm->pDefStream = pStream;` |
|     1698 | 3553 | `		}` |
|        - | 3554 | `		/* Insert in the appropriate container */` |
|    13591 | 3555 | `		rc = SySetPut(&pVm->aIOstream,(const void *)&pStream);` |
|    13591 | 3556 | `		break;` |
|        - | 3557 | `								  }` |
...
|        - | 4126 | ` */` |
|  1054828 | 4127 | `PH7_PRIVATE VmCallArgMap *VmEffCallArgMap(ph7_vm *pVm, VmInstr *pInstr,` |
|        - | 4128 | `	ph7_value *pArg, sxu32 nActual, VmCallArgMap *pStorage)` |
|        5 | 4129 | `{` |
|  1054833 | 4130 | `	VmCallArgMap *pCompile = (VmCallArgMap *)pInstr->p3;` |
|  1054833 | 4131 | `	if( pInstr->iP2 == 0 ){` |
|  1054531 | 4132 | `		return pCompile; /* no spread: compile map already aligned, nothing captured */` |
|        - | 4133 | `	}` |
...
|        - | 4474 | ` */` |
|    23946 | 4475 | `PH7_PRIVATE void VmForeachStepUnlink(ph7_foreach_info *pInfo,ph7_foreach_step *pStep)` |
|        5 | 4476 | `{` |
|    23951 | 4477 | `	ph7_foreach_step **apStep = (ph7_foreach_step **)SySetBasePtr(&pInfo->aStep);` |
|    23951 | 4478 | `	sxu32 n = SySetUsed(&pInfo->aStep);` |
|        - | 4479 | `	sxu32 i;` |
|    26127 | 4480 | `	for( i = 0 ; i < n ; ++i ){` |
|    26127 | 4481 | `		if( apStep[i] == pStep ){` |
|    23959 | 4482 | `			for( ; i + 1 < n ; ++i ){` |
|        9 | 4483 | `				apStep[i] = apStep[i + 1];` |
|        5 | 4484 | `			}` |
|    23951 | 4485 | `			(void)SySetPop(&pInfo->aStep);` |
|    23951 | 4486 | `			return;` |
|        - | 4487 | `		}` |
|     1093 | 4488 | `	}` |
|    11978 | 4489 | `}` |
...
|        - | 4508 | ` */` |
|    23710 | 4509 | `PH7_PRIVATE void VmForeachHashmapStepRelease(ph7_vm *pVm,ph7_foreach_info *pInfo,ph7_foreach_step *pStep,int bPop)` |
|        5 | 4510 | `{` |
|    23715 | 4511 | `	ph7_hashmap *pMap = pStep->xIter.pMap;` |
|    23715 | 4512 | `	PH7_HashmapUnregisterForeachStep(pMap,pStep);` |
|    23715 | 4513 | `	if( bPop ){` |
...
|    23715 | 4516 | `		VmForeachStepUnlink(pInfo,pStep);` |
|    11855 | 4517 | `	}` |
|    23715 | 4518 | `	SyMemBackendPoolFree(&pVm->sAllocator,pStep);` |
|    23715 | 4519 | `	PH7_HashmapUnref(pMap);` |
|    23715 | 4520 | `}` |
...
|        - | 4526 | ` */` |
|   141770 | 4527 | `PH7_PRIVATE sxi32 VmLocalExec(ph7_vm *pVm,SySet *pByteCode,ph7_value *pResult,int bReturnPropagates)` |
|        5 | 4528 | `{` |
|        - | 4529 | `	ph7_value *pStack;` |
|        - | 4530 | `	sxu32 nCap;` |
|        - | 4531 | `	sxi32 rc;` |
|        - | 4532 | `	/* Allocate a new operand stack */` |
|   141775 | 4533 | `	pStack = VmNewOperandStack(&(*pVm),SySetUsed(pByteCode));` |
|   141775 | 4534 | `	if( pStack == 0 ){` |
|      ! 0 | 4535 | `		return SXERR_MEM;` |
|        - | 4536 | `	}` |
|   141775 | 4537 | `	nCap = SySetUsed(pByteCode) + VM_STACK_GUARD; /* what VmNewOperandStack handed out */` |
...
|   141775 | 4540 | `	rc = VmByteCodeExec(&(*pVm),(VmInstr *)SySetBasePtr(pByteCode),pStack,-1,&(*pResult),0,FALSE,0,0,bReturnPropagates,0,&pStack,&nCap,nCap);` |
|        - | 4541 | `	/* Free the operand stack */` |
|   141775 | 4542 | `	SyMemBackendFree(&pVm->sAllocator,pStack);` |
|        - | 4543 | `	/* Execution result */` |
|   141775 | 4544 | `	return rc;` |
|    70890 | 4545 | `}` |
|        - | 4546 | `/*` |
...
|        - | 4580 | ` */` |
|     3400 | 4581 | `static void VmFlushOutputBuffers(ph7_vm *pVm)` |
|        5 | 4582 | `{` |
|     3405 | 4583 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|        - | 4584 | `	sxu32 n,nUsed;` |
|     3405 | 4585 | `	nUsed = SySetUsed(&pVm->aOB);` |
|     3405 | 4586 | `	if( nUsed < 1 ){` |
|     3403 | 4587 | `		return;` |
|        - | 4588 | `	}` |
...
|        - | 4616 | ` */` |
|     3400 | 4617 | `static void VmInvokeShutdownCallbacks(ph7_vm *pVm)` |
|        5 | 4618 | `{` |
...
|     3405 | 4624 | `	nEntry = SySetUsed(&pVm->aShutdown);` |
|    37405 | 4625 | `	for( i = 0 ; i < (int)SX_ARRAYSIZE(apArg) ; i++ ){` |
|    34005 | 4626 | `		apArg[i] = 0;` |
|    17005 | 4627 | `	}` |
...
|        - | 4631 | `	 */` |
|     3405 | 4632 | `	pVm->bHaltRequested = 0;` |
|     3423 | 4633 | `	for( n = 0 ; n < nEntry ; ++n ){` |
...
|        9 | 4660 | `		}` |
|       14 | 4661 | `	}` |
|     3405 | 4662 | `	SySetReset(&pVm->aShutdown);` |
|     3405 | 4663 | `}` |
|        - | 4664 | `/*` |
...
|        - | 4679 | `	{` |
|     3405 | 4680 | `		sxu32 nOpsCap = SySetUsed(pVm->pByteContainer) + VM_STACK_GUARD;` |
|     3405 | 4681 | `		VmByteCodeExec(&(*pVm),(VmInstr *)SySetBasePtr(pVm->pByteContainer),pVm->aOps,-1,&pVm->sExec,0,FALSE,0,0,FALSE,0,&pVm->aOps,&nOpsCap,nOpsCap);` |
|        - | 4682 | `	}` |
|        - | 4683 | `	/* Invoke any shutdown callbacks */` |
|     3405 | 4684 | `	VmInvokeShutdownCallbacks(&(*pVm));` |
...
|     3405 | 4687 | `	VmFlushOutputBuffers(&(*pVm));` |
|        - | 4688 | `	/*` |
...
|        - | 4701 | ` */` |
|     2596 | 4702 | `PH7_PRIVATE sxi32 PH7_VmOutputConsume(` |
|        - | 4703 | `	ph7_vm *pVm,      /* Target VM */` |
|        - | 4704 | `	SyString *pString /* Message to output */` |
|        - | 4705 | `	)` |
|        5 | 4706 | `{` |
|     2601 | 4707 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|     2601 | 4708 | `	sxi32 rc = SXRET_OK;` |
|        - | 4709 | `	/* Call the output consumer */` |
|     2601 | 4710 | `	if( pString->nByte > 0 ){` |
|     2601 | 4711 | `		rc = pCons->xConsumer((const void *)pString->zString,pString->nByte,pCons->pUserData);` |
|     2601 | 4712 | `		VmTrackOutput(pVm, pString->nByte);` |
|     1298 | 4713 | `	}` |
|     2601 | 4714 | `	return rc;` |
|        5 | 4715 | `}` |
|        - | 4716 | `/*` |
...
|        - | 5043 | ` */` |
|     3396 | 5044 | `static sxi32 VmRegisterSpecialFunction(ph7_vm *pVm)` |
|        5 | 5045 | `{` |
|        - | 5046 | `	sxi32 rc;` |
|        - | 5047 | `	sxu32 n;` |
|   421109 | 5048 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVmFunc) ; ++n ){` |
|        - | 5049 | `		/* Note that these special functions have access` |
|        - | 5050 | `		 * to the underlying virtual machine as their` |
|        - | 5051 | `		 * private data.` |
|        - | 5052 | `		 */` |
|   417713 | 5053 | `		rc = ph7_create_function(&(*pVm),aVmFunc[n].zName,aVmFunc[n].xFunc,&(*pVm));` |
|   417713 | 5054 | `		if( rc != SXRET_OK ){` |
|      ! 0 | 5055 | `			return rc;` |
|        - | 5056 | `		}` |
|   208859 | 5057 | `	}` |
|     3401 | 5058 | `	return SXRET_OK;` |
|     1703 | 5059 | `}` |
|        - | 5060 | `/*` |
...
|        - | 5064 | ` */` |
|   784058 | 5065 | `static ph7_class * VmFilterLoadableClass(ph7_class *pClass,sxi32 iLoadable)` |
|        5 | 5066 | `{` |
|   784063 | 5067 | `	if( !iLoadable ){` |
|   777271 | 5068 | `		return pClass;` |
|        - | 5069 | `	}` |
|     6801 | 5070 | `	while(pClass){` |
|     6797 | 5071 | `		if( (pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_ABSTRACT\|PH7_CLASS_TRAIT)) == 0 ){` |
|     6793 | 5072 | `			return pClass;` |
|        - | 5073 | `		}` |
...
|        - | 5085 | ` */` |
|      328 | 5086 | `static ph7_class * VmTriggerAutoload(ph7_vm *pVm,const char *zName,sxu32 nByte,sxi32 iLoadable)` |
|        5 | 5087 | `{` |
...
|        - | 5092 | `	sxu32 n,nEntry;` |
|      333 | 5093 | `	nEntry = SySetUsed(&pVm->aAutoload);` |
|      333 | 5094 | `	if( nEntry < 1 ){` |
|      257 | 5095 | `		return 0;` |
|        - | 5096 | `	}` |
...
|        - | 5154 | ` */` |
|   789540 | 5155 | `PH7_PRIVATE void PH7_VmClassNameAnchor(const char **pzName,sxu32 *pnByte)` |
|        5 | 5156 | `{` |
|   789545 | 5157 | `	if( *pnByte > 0 && (*pzName)[0] == '\\' ){` |
|       60 | 5158 | `		(*pzName)++;` |
|       60 | 5159 | `		(*pnByte)--;` |
|       28 | 5160 | `	}` |
|   789545 | 5161 | `}` |
...
|        - | 5165 | ` */` |
|   784328 | 5166 | `PH7_PRIVATE ph7_class * PH7_VmExtractClass(` |
...
|   784333 | 5178 | `	sxu32 nOrig = nByte;` |
|   392164 | 5179 | `	SXUNUSED(iNest);` |
...
|   784333 | 5185 | `	PH7_VmClassNameAnchor(&zName,&nByte);` |
...
|   784333 | 5190 | `	pEntry = nByte > 0 ? SyHashGet(&pVm->hClass,(const void *)zName,nByte) : 0;` |
|   784333 | 5191 | `	if( pEntry == 0 ){` |
|        - | 5192 | `		/* Class not found in hash table — try autoload before giving up */` |
|      291 | 5193 | `		return nOrig > 0 ? VmTriggerAutoload(pVm,zName,nByte,iLoadable) : 0;` |
|        - | 5194 | `	}` |
|   784047 | 5195 | `	pClass = (ph7_class *)pEntry->pUserData;` |
|   784047 | 5196 | `	return VmFilterLoadableClass(pClass,iLoadable);` |
|   392169 | 5197 | `}` |
|        - | 5198 | `/*` |
...
|        - | 5211 | ` */` |
|  4391173 | 5212 | `static VmRefObj * VmNewRefObj(ph7_vm *pVm,sxu32 nIdx)` |
|        5 | 5213 | `{` |
|        - | 5214 | `	VmRefObj *pRef;` |
|        - | 5215 | `	/* Allocate a new instance */` |
|  4391178 | 5216 | `	pRef = (VmRefObj *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmRefObj));` |
|  4391178 | 5217 | `	if( pRef == 0 ){` |
|      ! 0 | 5218 | `		return 0;` |
|        - | 5219 | `	}` |
|        - | 5220 | `	/* Zero the structure */` |
|  4391178 | 5221 | `	SyZero(pRef,sizeof(VmRefObj));` |
|        - | 5222 | `	/* Initialize fields */` |
|  4391178 | 5223 | `	SySetInit(&pRef->aReference,&pVm->sAllocator,sizeof(SyHashEntry *));` |
|  4391178 | 5224 | `	SySetInit(&pRef->aArrEntries,&pVm->sAllocator,sizeof(ph7_hashmap_node *));` |
|  4391178 | 5225 | `	pRef->nIdx = nIdx;` |
|  4391178 | 5226 | `	return pRef;` |
|  2196224 | 5227 | `}` |
|        - | 5228 | `/*` |
|        - | 5229 | ` * Default hash function used by the reference table` |
|        - | 5230 | ` * for lookup/insertion operations.` |
|        - | 5231 | ` */` |
| 23578515 | 5232 | `static sxu32 VmRefHash(sxu32 nIdx)` |
|        5 | 5233 | `{` |
|        - | 5234 | `	/* Calculate the hash based on the memory object index */` |
| 23578520 | 5235 | `	return nIdx ^ (nIdx << 8) ^ (nIdx >> 8);` |
|        5 | 5236 | `}` |
|        - | 5237 | `/*` |
...
|        - | 5247 | ` * extension.` |
|        - | 5248 | ` */` |
| 13637867 | 5249 | `PH7_PRIVATE VmRefObj * VmRefObjExtract(ph7_vm *pVm,sxu32 nObjIdx)` |
|        5 | 5250 | `{` |
|        - | 5251 | `	VmRefObj *pRef;` |
|        - | 5252 | `	sxu32 nBucket;` |
|        - | 5253 | `	/* Point to the appropriate bucket */` |
| 13637872 | 5254 | `	nBucket = VmRefHash(nObjIdx) & (pVm->nRefSize - 1);` |
|        - | 5255 | `	/* Perform the lookup */` |
| 13637872 | 5256 | `	pRef = pVm->apRefObj[nBucket];` |
| 30060135 | 5257 | `	for(;;){` |
| 60096720 | 5258 | `		if( pRef == 0 ){` |
|  4901574 | 5259 | `			break;` |
|        - | 5260 | `		}` |
| 55195151 | 5261 | `		if( pRef->nIdx == nObjIdx ){` |
|        - | 5262 | `			/* Entry found */` |
|  8736303 | 5263 | `			return pRef;` |
|        - | 5264 | `		}` |
|        - | 5265 | `		/* Point to the next entry */` |
| 46458853 | 5266 | `		pRef = pRef->pNextCollide;` |
|        5 | 5267 | `	}` |
|        - | 5268 | `	/* No such entry,return NULL */` |
|  4901574 | 5269 | `	return 0;` |
|  6820836 | 5270 | `}` |
|        - | 5271 | `/*` |
...
|        - | 5279 | ` * extension.` |
|        - | 5280 | ` */` |
|  4391173 | 5281 | `static sxi32 VmRefObjInsert(ph7_vm *pVm,VmRefObj *pRef)` |
|        5 | 5282 | `{` |
|        - | 5283 | `	sxu32 nBucket;` |
|  4391178 | 5284 | `	if( pVm->nRefUsed * 3 >= pVm->nRefSize ){` |
|        - | 5285 | `		VmRefObj **apNew;` |
|        - | 5286 | `		sxu32 nNew;` |
|        - | 5287 | `		/* Allocate a larger table */` |
|    10531 | 5288 | `		nNew = pVm->nRefSize << 1;` |
|    10531 | 5289 | `		apNew = (VmRefObj **)SyMemBackendAlloc(&pVm->sAllocator,sizeof(VmRefObj *) * nNew);` |
|    10531 | 5290 | `		if( apNew ){` |
|    10531 | 5291 | `			VmRefObj *pEntry = pVm->pRefList;` |
|        - | 5292 | `			sxu32 n;` |
|        - | 5293 | `			/* Zero the structure */` |
|    10531 | 5294 | `			SyZero((void *)apNew,nNew * sizeof(VmRefObj *));` |
|        - | 5295 | `			/* Rehash all referenced entries */` |
|  2966677 | 5296 | `			for( n = 0 ; n < pVm->nRefUsed ; ++n ){` |
|        - | 5297 | `				/* Remove old collision links */` |
|  2956151 | 5298 | `				pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|        - | 5299 | `				/* Point to the appropriate bucket */` |
|  2956151 | 5300 | `				nBucket = VmRefHash(pEntry->nIdx) & (nNew - 1);` |
|        - | 5301 | `				/* Insert the entry  */` |
|  2956151 | 5302 | `				pEntry->pNextCollide = apNew[nBucket];` |
|  2956151 | 5303 | `				if( apNew[nBucket] ){` |
|  2306069 | 5304 | `					apNew[nBucket]->pPrevCollide = pEntry;` |
|  1153032 | 5305 | `				}` |
|  2956151 | 5306 | `				apNew[nBucket] = pEntry;` |
|        - | 5307 | `				/* Point to the next entry */` |
|  2956151 | 5308 | `				pEntry = pEntry->pNext;` |
|  1478078 | 5309 | `			}` |
|        - | 5310 | `			/* Release the old table */` |
|    10531 | 5311 | `			SyMemBackendFree(&pVm->sAllocator,pVm->apRefObj);` |
|        - | 5312 | `			/* Install the new one */` |
|    10531 | 5313 | `			pVm->apRefObj = apNew;` |
|    10531 | 5314 | `			pVm->nRefSize = nNew;` |
|     5263 | 5315 | `		}` |
|     5263 | 5316 | `	}` |
|        - | 5317 | `	/* Point to the appropriate bucket */` |
|  4391178 | 5318 | `	nBucket = VmRefHash(pRef->nIdx) & (pVm->nRefSize - 1);` |
|        - | 5319 | `	/* Insert the entry */` |
|  4391178 | 5320 | `	pRef->pNextCollide = pVm->apRefObj[nBucket];` |
|  4391178 | 5321 | `	if( pVm->apRefObj[nBucket] ){` |
|  3383174 | 5322 | `		pVm->apRefObj[nBucket]->pPrevCollide = pRef;` |
|  1692142 | 5323 | `	}` |
|  4391178 | 5324 | `	pVm->apRefObj[nBucket] = pRef;` |
|  4391178 | 5325 | `	MACRO_LD_PUSH(pVm->pRefList,pRef);` |
|  4391178 | 5326 | `	pVm->nRefUsed++;` |
|  4391178 | 5327 | `	return SXRET_OK;` |
|        5 | 5328 | `}` |
|        - | 5329 | `/*` |
...
|        - | 5339 | ` * extension.` |
|        - | 5340 | ` */` |
|  4257459 | 5341 | `PH7_PRIVATE sxi32 VmRefObjUnlink(ph7_vm *pVm,VmRefObj *pRef)` |
|        5 | 5342 | `{` |
|        - | 5343 | `	ph7_hashmap_node **apNode;` |
|        - | 5344 | `	SyHashEntry **apEntry;` |
|        - | 5345 | `	sxu32 n;` |
|        - | 5346 | `	/* Point to the reference table */` |
|  4257464 | 5347 | `	apNode = (ph7_hashmap_node **)SySetBasePtr(&pRef->aArrEntries);` |
|  4257464 | 5348 | `	apEntry = (SyHashEntry **)SySetBasePtr(&pRef->aReference);` |
|        - | 5349 | `	/* Unlink the entry from the reference table */` |
|  4773918 | 5350 | `	for( n = 0 ; n < SySetUsed(&pRef->aReference) ; n++ ){` |
|   516459 | 5351 | `		if( apEntry[n] ){` |
|   510631 | 5352 | `			SyHashDeleteEntry2(apEntry[n]);` |
|   255946 | 5353 | `		}` |
|   258865 | 5354 | `	}` |
|  7982455 | 5355 | `	for(n = 0 ; n < SySetUsed(&pRef->aArrEntries) ; ++n ){` |
|  3724996 | 5356 | `		if( apNode[n] ){` |
|     1388 | 5357 | `			PH7_HashmapUnlinkNode(apNode[n],FALSE);` |
|      692 | 5358 | `		}` |
|  1862500 | 5359 | `	}` |
|  4257464 | 5360 | `	if( pRef->pPrevCollide ){` |
|  1664135 | 5361 | `		pRef->pPrevCollide->pNextCollide = pRef->pNextCollide;` |
|   832131 | 5362 | `	}else{` |
|  2593334 | 5363 | `		pVm->apRefObj[VmRefHash(pRef->nIdx) & (pVm->nRefSize - 1)] = pRef->pNextCollide;` |
|        - | 5364 | `	}` |
|  4257464 | 5365 | `	if( pRef->pNextCollide ){` |
|  2270174 | 5366 | `		pRef->pNextCollide->pPrevCollide = pRef->pPrevCollide;` |
|  1135656 | 5367 | `	}` |
|  4257464 | 5368 | `	MACRO_LD_REMOVE(pVm->pRefList,pRef);` |
|        - | 5369 | `	/* Release the node */` |
|  4257464 | 5370 | `	SySetRelease(&pRef->aReference);` |
|  4257464 | 5371 | `	SySetRelease(&pRef->aArrEntries);` |
|  4257464 | 5372 | `	SyMemBackendPoolFree(&pVm->sAllocator,pRef);` |
|  4257464 | 5373 | `	pVm->nRefUsed--;` |
|  4257464 | 5374 | `	return SXRET_OK;` |
|        5 | 5375 | `}` |
|        - | 5376 | `/*` |
...
|        - | 5383 | ` * extension.` |
|        - | 5384 | ` */` |
|  4437661 | 5385 | `PH7_PRIVATE sxi32 PH7_VmRefObjInstall(` |
...
|        - | 5391 | `	)` |
|        5 | 5392 | `{` |
|  4437666 | 5393 | `	VmFrame *pFrame = pVm->pFrame;` |
|        - | 5394 | `	VmRefObj *pRef;` |
|        - | 5395 | `	/* Check if the referenced object already exists */` |
|  4437666 | 5396 | `	pRef = VmRefObjExtract(&(*pVm),nIdx);` |
|  4437666 | 5397 | `	if( pRef == 0 ){` |
|        - | 5398 | `		/* Create a new entry */` |
|  4391178 | 5399 | `		pRef = VmNewRefObj(&(*pVm),nIdx);` |
|  4391178 | 5400 | `		if( pRef == 0 ){` |
|      ! 0 | 5401 | `			return SXERR_MEM;` |
|        - | 5402 | `		}` |
|  4391178 | 5403 | `		pRef->iFlags = iFlags;` |
|        - | 5404 | `		/* Install the entry */` |
|  4391178 | 5405 | `		VmRefObjInsert(&(*pVm),pRef);` |
|  2196219 | 5406 | `	}` |
|  4437666 | 5407 | `	pFrame = VmSkipExceptionFrames(pFrame);` |
|  4437666 | 5408 | `	if( pFrame->pParent != 0 && pEntry ){` |
|        - | 5409 | `		VmSlot sRef;` |
|        - | 5410 | `		/* Local frame,record referenced entry so that it can` |
|        - | 5411 | `		 * be deleted when we leave this frame.` |
|        - | 5412 | `		 */` |
|   510599 | 5413 | `		sRef.nIdx = nIdx;` |
|   510599 | 5414 | `		sRef.pUserData = pEntry;` |
|   510599 | 5415 | `		if( SXRET_OK != SySetPut(&pFrame->sRef,(const void *)&sRef)) {` |
|      ! 0 | 5416 | `			pEntry = 0; /* Do not record this entry */` |
|      ! 0 | 5417 | `		}` |
|   255930 | 5418 | `	}` |
|  4437666 | 5419 | `	if( pEntry ){` |
|        - | 5420 | `		/* Address of the hash-entry */` |
|   556829 | 5421 | `		SySetPut(&pRef->aReference,(const void *)&pEntry);` |
|   279045 | 5422 | `	}` |
|  4437666 | 5423 | `	if( pMapEntry ){` |
|        - | 5424 | `		/* Address of the hashmap node [i.e: Array entry] */` |
|  3826762 | 5425 | `		SySetPut(&pRef->aArrEntries,(const void *)&pMapEntry);` |
|  1913378 | 5426 | `	}` |
|  4437666 | 5427 | `	return SXRET_OK;` |
|  2219468 | 5428 | `}` |
|        - | 5429 | `/*` |
...
|        - | 5436 | ` * extension.` |
|        - | 5437 | ` */` |
|  4228343 | 5438 | `PH7_PRIVATE sxi32 PH7_VmRefObjRemove(` |
...
|  4228348 | 5448 | `	pRef = VmRefObjExtract(&(*pVm),nIdx);` |
|  4228348 | 5449 | `	if( pRef == 0 ){` |
|        - | 5450 | `		/* Not such entry */` |
|   510401 | 5451 | `		return SXERR_NOTFOUND;` |
|        - | 5452 | `	}` |
|        - | 5453 | `	/* Remove the desired entry */` |
|  3717952 | 5454 | `	if( pEntry ){` |
...
|       95 | 5467 | `		}` |
|       41 | 5468 | `	}` |
|  3717952 | 5469 | `	if( pMapEntry ){` |
|        - | 5470 | `		ph7_hashmap_node **apNode;` |
|  3717870 | 5471 | `		apNode = (ph7_hashmap_node **)SySetBasePtr(&pRef->aArrEntries);` |
|  7435999 | 5472 | `		for(n = 0 ; n < SySetUsed(&pRef->aArrEntries) ; n++ ){` |
|  3718134 | 5473 | `			if( apNode[n] == pMapEntry ){` |
|        - | 5474 | `				/* nullify the entry */` |
|  3717870 | 5475 | `				apNode[n] = 0;` |
|  1858932 | 5476 | `			}` |
|  1859069 | 5477 | `		}` |
|  1858932 | 5478 | `	}` |
|  3717952 | 5479 | `	return SXRET_OK;` |
|  2114809 | 5480 | `}` |
...
|        - | 5489 | ` */` |
|    29882 | 5490 | `PH7_PRIVATE const ph7_io_stream * PH7_VmGetStreamDevice(` |
...
|    29887 | 5502 | `	zNext = zCur = zIn = *pzDevice;` |
|    29887 | 5503 | `	zEnd = &zIn[nByte];` |
|  1893833 | 5504 | `	while( zIn < zEnd ){` |
|  1863983 | 5505 | `		if( zIn < &zEnd[-3]/*://*/ && zIn[0] == ':' && zIn[1] == '/' && zIn[2] == '/' ){` |
|        - | 5506 | `			/* Got one */` |
|       34 | 5507 | `			zNext = &zIn[sizeof("://")-1];` |
|       34 | 5508 | `			break;` |
|        - | 5509 | `		}` |
|        - | 5510 | `		/* Advance the cursor */` |
|  1863951 | 5511 | `		zIn++;` |
|        5 | 5512 | `	}` |
|    29887 | 5513 | `	if( zIn >= zEnd ){` |
|        - | 5514 | `		/* No such scheme,return the default stream */` |
|    29855 | 5515 | `		return pVm->pDefStream;` |
|        - | 5516 | `	}` |
|       34 | 5517 | `	SyStringInitFromBuf(&sDev,zCur,zIn-zCur);` |
|        - | 5518 | `	/* Remove leading and trailing white spaces */` |
|       34 | 5519 | `	SyStringFullTrim(&sDev);` |
|        - | 5520 | `	/* Perform a linear lookup on the installed stream devices */` |
|       34 | 5521 | `	apStream = (ph7_io_stream **)SySetBasePtr(&pVm->aIOstream);` |
|       34 | 5522 | `	nEntry = SySetUsed(&pVm->aIOstream);` |
|       68 | 5523 | `	for( n = 0 ; n < nEntry ; n++ ){` |
|       68 | 5524 | `		pStream = apStream[n];` |
|       68 | 5525 | `		SyStringInitFromBuf(&sCur,pStream->zName,SyStrlen(pStream->zName));` |
|        - | 5526 | `		/* Perfrom a case-insensitive comparison */` |
|       68 | 5527 | `		rc = SyStringCmp(&sDev,&sCur,SyStrnicmp);` |
|       68 | 5528 | `		if( rc == 0 ){` |
|        - | 5529 | `			/* Stream device found */` |
|       34 | 5530 | `			*pzDevice = zNext;` |
|       34 | 5531 | `			return pStream;` |
|        - | 5532 | `		}` |
|       19 | 5533 | `	}` |
