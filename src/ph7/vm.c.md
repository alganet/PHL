...
|        - |   114 | ` */` |
|   586550 |   115 | `static sxi32 VmIsUnorderedCmp(ph7_value *pLeft,ph7_value *pRight)` |
|        2 |   116 |  |
|   586552 |   117 | `	if( (pLeft->iFlags & MEMOBJ_REAL) && PH7_IS_NAN(pLeft->rVal) ){` |
|       23 |   118 | `		return TRUE;` |
|        - |   119 | `	}` |
|   586530 |   120 | `	if( (pRight->iFlags & MEMOBJ_REAL) && PH7_IS_NAN(pRight->rVal) ){` |
|        9 |   121 | `		return TRUE;` |
|        - |   122 | `	}` |
|   586522 |   123 | `	return FALSE;` |
|   293299 |   124 |  |
|        - |   125 | `/*` |
...
|        - |   182 | ` */` |
|   248074 |   183 | `PH7_PRIVATE sxi32 PH7_VmRegisterConstant(` |
...
|        - |   192 | `	char *zDupName;` |
|        - |   193 | `	sxi32 rc;` |
|   248076 |   194 | `	pEntry = SyHashGet(&pVm->hConstant,(const void *)pName->zString,pName->nByte);` |
|   248076 |   195 | `	if( pEntry ){` |
...
|   248072 |   203 | `	pCons = (ph7_constant *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_constant));` |
|   248072 |   204 | `	if( pCons == 0 ){` |
|      ! 0 |   205 | `		return 0;` |
|        - |   206 | `	}` |
|        - |   207 | `	/* Duplicate constant name */` |
|   248072 |   208 | `	zDupName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|   248072 |   209 | `	if( zDupName == 0 ){` |
|      ! 0 |   210 | `		SyMemBackendPoolFree(&pVm->sAllocator,pCons);` |
|      ! 0 |   211 | `		return 0;` |
|        - |   212 | `	}` |
|        - |   213 | `	/* Install the constant */` |
|   248072 |   214 | `	SyStringInitFromBuf(&pCons->sName,zDupName,pName->nByte);` |
|   248072 |   215 | `	pCons->xExpand = xExpand;` |
|   248072 |   216 | `	pCons->pUserData = pUserData;` |
|   248072 |   217 | `	rc = SyHashInsert(&pVm->hConstant,(const void *)zDupName,SyStringLength(&pCons->sName),pCons);` |
|   248072 |   218 | `	if( rc != SXRET_OK ){` |
...
|        - |   232 | ` */` |
|   534180 |   233 | `static sxi32 PH7_NewForeignFunction(` |
...
|   534182 |   244 | `	pFunc = (ph7_user_func *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_user_func));` |
|   534182 |   245 | `	if( pFunc == 0 ){` |
|      ! 0 |   246 | `		return SXERR_MEM;` |
|        - |   247 | `	}` |
|        - |   248 | `	/* Duplicate function name */` |
|   534182 |   249 | `	zDup = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|   534182 |   250 | `	if( zDup == 0 ){` |
|      ! 0 |   251 | `		SyMemBackendPoolFree(&pVm->sAllocator,pFunc);` |
|      ! 0 |   252 | `		return SXERR_MEM;` |
|        - |   253 | `	}` |
|        - |   254 | `	/* Zero the structure */` |
|   534182 |   255 | `	SyZero(pFunc,sizeof(ph7_user_func));` |
|        - |   256 | `	/* Initialize structure fields */` |
|   534182 |   257 | `	SyStringInitFromBuf(&pFunc->sName,zDup,pName->nByte);` |
|   534182 |   258 | `	pFunc->pVm   = pVm;` |
|   534182 |   259 | `	pFunc->xFunc = xFunc;` |
|   534182 |   260 | `	pFunc->pUserData = pUserData;` |
|   534182 |   261 | `	SySetInit(&pFunc->aAux,&pVm->sAllocator,sizeof(ph7_aux_data));` |
|        - |   262 | `	/* Write a pointer to the new function */` |
|   534182 |   263 | `	*ppOut = pFunc;` |
|   534182 |   264 | `	return SXRET_OK;` |
|   267092 |   265 |  |
|        - |   266 | `/*` |
...
|        - |   273 | ` */` |
|   535408 |   274 | `PH7_PRIVATE sxi32 PH7_VmInstallForeignFunction(` |
...
|   535410 |   285 | `	pEntry = SyHashGet(&pVm->hHostFunction,pName->zString,pName->nByte);` |
|   535410 |   286 | `	if( pEntry ){` |
|     1230 |   287 | `		pFunc = (ph7_user_func *)pEntry->pUserData;` |
|     1230 |   288 | `		pFunc->pUserData = pUserData;` |
|     1230 |   289 | `		pFunc->xFunc = xFunc;` |
|     1230 |   290 | `		SySetReset(&pFunc->aAux);` |
|     1230 |   291 | `		return SXRET_OK;` |
|        - |   292 | `	}` |
|        - |   293 | `	/* Create a new user function */` |
|   534182 |   294 | `	rc = PH7_NewForeignFunction(&(*pVm),&(*pName),xFunc,pUserData,&pFunc);` |
|   534182 |   295 | `	if( rc != SXRET_OK ){` |
|      ! 0 |   296 | `		return rc;` |
|        - |   297 | `	}` |
|        - |   298 | `	/* Install the function in the corresponding hashtable */` |
|   534182 |   299 | `	rc = SyHashInsert(&pVm->hHostFunction,SyStringData(&pFunc->sName),pName->nByte,pFunc);` |
|   534182 |   300 | `	if( rc != SXRET_OK ){` |
...
|   534182 |   306 | `	return SXRET_OK;` |
|   267706 |   307 |  |
|        - |   308 | `/*` |
|        - |   309 | ` * Initialize a VM function.` |
|        - |   310 | ` */` |
|    63034 |   311 | `PH7_PRIVATE sxi32 PH7_VmInitFuncState(` |
...
|    63036 |   321 | `	SyZero(pFunc,sizeof(ph7_vm_func));` |
|        - |   322 | `	/* Initialize structure fields */` |
|        - |   323 | `	/* Arguments container */` |
|    63036 |   324 | `	SySetInit(&pFunc->aArgs,&pVm->sAllocator,sizeof(ph7_vm_func_arg));` |
|        - |   325 | `	/* Static variable container */` |
|    63036 |   326 | `	SySetInit(&pFunc->aStatic,&pVm->sAllocator,sizeof(ph7_vm_func_static_var));` |
|        - |   327 | `	/* Bytecode container */` |
|    63036 |   328 | `	SySetInit(&pFunc->aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|        - |   329 | `    /* Preallocate some instruction slots */` |
|    63036 |   330 | `	SySetAlloc(&pFunc->aByteCode,0x10);` |
|        - |   331 | `	/* Closure environment */` |
|    63036 |   332 | `	SySetInit(&pFunc->aClosureEnv,&pVm->sAllocator,sizeof(ph7_vm_func_closure_env));` |
|    63036 |   333 | `	pFunc->iFlags = iFlags;` |
|    63036 |   334 | `	pFunc->pUserData = pUserData;` |
|    63036 |   335 | `	SyStringInitFromBuf(&pFunc->sName,zName,nByte);` |
|    63036 |   336 | `	return SXRET_OK;` |
|        2 |   337 |  |
|        - |   338 | `/*` |
|        - |   339 | ` * Install a user defined function in the corresponding VM container.` |
|        - |   340 | ` */` |
|   196368 |   341 | `PH7_PRIVATE sxi32 PH7_VmInstallUserFunction(` |
...
|        - |   348 | `	sxi32 rc;` |
|   196370 |   349 | `	if( pName == 0 ){` |
|        - |   350 | `		/* Use the built-in name */` |
|    19730 |   351 | `		pName = &pFunc->sName;` |
|     9864 |   352 | `	}` |
|        - |   353 | `	/* Check for duplicates (functions with the same name) first */` |
|   196370 |   354 | `	pEntry = SyHashGet(&pVm->hFunction,pName->zString,pName->nByte);` |
|   196370 |   355 | `	if( pEntry ){` |
|   145430 |   356 | `		ph7_vm_func *pLink = (ph7_vm_func *)pEntry->pUserData;` |
|   145430 |   357 | `		if( pLink != pFunc ){` |
|        - |   358 | `			/* Link */` |
|      179 |   359 | `			pFunc->pNextName = pLink;` |
|      179 |   360 | `			pEntry->pUserData = pFunc;` |
|       89 |   361 | `		}` |
|   145430 |   362 | `		return SXRET_OK;` |
|        - |   363 | `	}` |
|        - |   364 | `	/* First time seen */` |
|    50942 |   365 | `	pFunc->pNextName = 0;` |
|    50942 |   366 | `	rc = SyHashInsert(&pVm->hFunction,pName->zString,pName->nByte,pFunc);` |
|    50942 |   367 | `	return rc;` |
|    98186 |   368 |  |
|        - |   369 | `/*` |
|        - |   370 | ` * Install a user defined class in the corresponding VM container.` |
|        - |   371 | ` */` |
|    16600 |   372 | `PH7_PRIVATE sxi32 PH7_VmInstallClass(` |
|        - |   373 | `	ph7_vm *pVm,      /* Target VM  */` |
|        - |   374 | `	ph7_class *pClass /* Target Class */` |
|        - |   375 | `	)` |
|        2 |   376 |  |
|    16602 |   377 | `	SyString *pName = &pClass->sName;` |
|        - |   378 | `	SyHashEntry *pEntry;` |
|        - |   379 | `	sxi32 rc;` |
|        - |   380 | `	/* Check for duplicates */` |
|    16602 |   381 | `	pEntry = SyHashGet(&pVm->hClass,(const void *)pName->zString,pName->nByte);` |
|    16602 |   382 | `	if( pEntry ){` |
...
|        - |   388 | `	}` |
|    16572 |   389 | `	pClass->pNextName = 0;` |
|        - |   390 | `	/* Perform a simple hashtable insertion */` |
|    16572 |   391 | `	rc = SyHashInsert(&pVm->hClass,(const void *)pName->zString,pName->nByte,pClass);` |
|    16572 |   392 | `	return rc;` |
|     8302 |   393 |  |
|        - |   394 | `/*` |
|        - |   395 | ` * Instruction builder interface.` |
|        - |   396 | ` */` |
|  1570692 |   397 | `PH7_PRIVATE sxi32 PH7_VmEmitInstr(` |
...
|  1570694 |   409 | `	sInstr.iOp = (sxu8)iOp;` |
|  1570694 |   410 | `	sInstr.iP1 = iP1;` |
|  1570694 |   411 | `	sInstr.iP2 = iP2;` |
|  1570694 |   412 | `	sInstr.p3  = p3;` |
|  1570694 |   413 | `	if( pIndex ){` |
|        - |   414 | `		/* Instruction index in the bytecode array */` |
|    94240 |   415 | `		*pIndex = SySetUsed(pVm->pByteContainer);` |
|    47119 |   416 | `	}` |
|        - |   417 | `	/* Finally,record the instruction */` |
|  1570694 |   418 | `	rc = SySetPut(pVm->pByteContainer,(const void *)&sInstr);` |
|  1570694 |   419 | `	if( rc != SXRET_OK ){` |
|      ! 0 |   420 | `		PH7_GenCompileError(&pVm->sCodeGen,E_ERROR,1,"Fatal,Cannot emit instruction due to a memory failure");` |
|        - |   421 | `		/* Fall throw */` |
|      ! 0 |   422 | `	}` |
|  1570694 |   423 | `	return rc;` |
|        2 |   424 |  |
|        - |   425 | `/*` |
|        - |   426 | ` * Swap the current bytecode container with the given one.` |
|        - |   427 | ` */` |
|   153312 |   428 | `PH7_PRIVATE sxi32 PH7_VmSetByteCodeContainer(ph7_vm *pVm,SySet *pContainer)` |
|        2 |   429 |  |
|   153314 |   430 | `	if( pContainer == 0 ){` |
|        - |   431 | `		/* Point to the default container */` |
|      ! 0 |   432 | `		pVm->pByteContainer = &pVm->aByteCode;` |
|      ! 0 |   433 | `	}else{` |
|        - |   434 | `		/* Change container */` |
|   153314 |   435 | `		pVm->pByteContainer = &(*pContainer);` |
|        - |   436 | `	}` |
|   153314 |   437 | `	return SXRET_OK;` |
|        2 |   438 |  |
|        - |   439 | `/*` |
|        - |   440 | ` * Return the current bytecode container.` |
|        - |   441 | ` */` |
|    76656 |   442 | `PH7_PRIVATE SySet * PH7_VmGetByteCodeContainer(ph7_vm *pVm)` |
|        2 |   443 |  |
|    76658 |   444 | `	return pVm->pByteContainer;` |
|        2 |   445 |  |
|        - |   446 | `/*` |
|        - |   447 | ` * Extract the VM instruction rooted at nIndex.` |
|        - |   448 | ` */` |
|    92676 |   449 | `PH7_PRIVATE VmInstr * PH7_VmGetInstr(ph7_vm *pVm,sxu32 nIndex)` |
|        2 |   450 |  |
|        - |   451 | `	VmInstr *pInstr;` |
|    92678 |   452 | `	pInstr = (VmInstr *)SySetAt(pVm->pByteContainer,nIndex);` |
|    92678 |   453 | `	return pInstr;` |
|        2 |   454 |  |
|        - |   455 | `/*` |
|        - |   456 | ` * Return the total number of VM instructions recorded so far.` |
|        - |   457 | ` */` |
|   456320 |   458 | `PH7_PRIVATE sxu32 PH7_VmInstrLength(ph7_vm *pVm)` |
|        2 |   459 |  |
|   456322 |   460 | `	return SySetUsed(pVm->pByteContainer);` |
|        2 |   461 |  |
|        - |   462 | `/*` |
|        - |   463 | ` * Pop the last VM instruction.` |
|        - |   464 | ` */` |
|    89294 |   465 | `PH7_PRIVATE VmInstr * PH7_VmPopInstr(ph7_vm *pVm)` |
|        2 |   466 |  |
|    89296 |   467 | `	return (VmInstr *)SySetPop(pVm->pByteContainer);` |
|        2 |   468 |  |
|        - |   469 | `/*` |
|        - |   470 | ` * Peek the last VM instruction.` |
|        - |   471 | ` */` |
|   238756 |   472 | `PH7_PRIVATE VmInstr * PH7_VmPeekInstr(ph7_vm *pVm)` |
|        2 |   473 |  |
|   238758 |   474 | `	return (VmInstr *)SySetPeek(pVm->pByteContainer);` |
|        2 |   475 |  |
|     3194 |   476 | `PH7_PRIVATE VmInstr * PH7_VmPeekNextInstr(ph7_vm *pVm)` |
|        2 |   477 |  |
|        - |   478 | `	VmInstr *aInstr;` |
|        - |   479 | `	sxu32 n;` |
|     3196 |   480 | `	n = SySetUsed(pVm->pByteContainer);` |
|     3196 |   481 | `	if( n < 2 ){` |
|      ! 0 |   482 | `		return 0;` |
|        - |   483 | `	}` |
|     3196 |   484 | `	aInstr = (VmInstr *)SySetBasePtr(pVm->pByteContainer);` |
|     3196 |   485 | `	return &aInstr[n - 2];` |
|     1599 |   486 |  |
|        - |   487 | `/*` |
|        - |   488 | ` * Allocate a new virtual machine frame.` |
|        - |   489 | ` */` |
|    10300 |   490 | `static VmFrame * VmNewFrame(` |
...
|    10302 |   498 | `	pFrame = (VmFrame *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmFrame));` |
|    10302 |   499 | `	if( pFrame == 0 ){` |
|      ! 0 |   500 | `		return 0;` |
|        - |   501 | `	}` |
|        - |   502 | `	/* Zero the structure */` |
|    10302 |   503 | `	SyZero(pFrame,sizeof(VmFrame));` |
|        - |   504 | `	/* Initialize frame fields */` |
|    10302 |   505 | `	pFrame->pUserData = pUserData;` |
|    10302 |   506 | `	pFrame->pThis = pThis;` |
|    10302 |   507 | `	pFrame->pVm = pVm;` |
|    10302 |   508 | `	SyHashInit(&pFrame->hVar,&pVm->sAllocator,0,0);` |
|    10302 |   509 | `	SySetInit(&pFrame->sArg,&pVm->sAllocator,sizeof(VmSlot));` |
|    10302 |   510 | `	SySetInit(&pFrame->sLocal,&pVm->sAllocator,sizeof(VmSlot));` |
|    10302 |   511 | `	SySetInit(&pFrame->sRef,&pVm->sAllocator,sizeof(VmSlot));` |
|    10302 |   512 | `	return pFrame;` |
|     5152 |   513 |  |
|        - |   514 | `/*` |
|        - |   515 | ` * Enter a VM frame.` |
|        - |   516 | ` */` |
|    10300 |   517 | `static sxi32 VmEnterFrame(` |
...
|    10302 |   526 | `	pFrame = VmNewFrame(&(*pVm),pUserData,pThis);` |
|    10302 |   527 | `	if( pFrame == 0 ){` |
|      ! 0 |   528 | `		return SXERR_MEM;` |
|        - |   529 | `	}` |
|        - |   530 | `	/* Link to the list of active VM frame */` |
|    10302 |   531 | `	pFrame->pParent = pVm->pFrame;` |
|    10302 |   532 | `	pVm->pFrame = pFrame;` |
|    10302 |   533 | `	if( ppFrame ){` |
|        - |   534 | `		/* Write a pointer to the new VM frame */` |
|     8816 |   535 | `		*ppFrame = pFrame;` |
|     4407 |   536 | `	}` |
|    10302 |   537 | `	return SXRET_OK;` |
|     5152 |   538 |  |
|        - |   539 | `/*` |
...
|        - |   584 | ` */` |
|     8812 |   585 | `static void VmLeaveFrame(ph7_vm *pVm)` |
|        2 |   586 |  |
|     8814 |   587 | `		VmFrame *pCurFrame = pVm->pFrame;` |
|     8814 |   588 | `	if( pCurFrame ){` |
|        - |   589 | `		/* Unlink from the list of active VM frame */` |
|     8814 |   590 | `		pVm->pFrame = pCurFrame->pParent;` |
|     8814 |   591 | `		if( pCurFrame->pParent && (pCurFrame->iFlags & VM_FRAME_EXCEPTION) == 0 ){` |
|        - |   592 | `			VmSlot  *aSlot;` |
|        - |   593 | `			sxu32 n;` |
|        - |   594 | `			/* Restore local variable to the free pool so that they can be reused again */` |
|     8796 |   595 | `			aSlot = (VmSlot *)SySetBasePtr(&pCurFrame->sLocal);` |
|    64660 |   596 | `			for(n = 0 ; n < SySetUsed(&pCurFrame->sLocal) ; ++n ){` |
|        - |   597 | `				/* Unset the local variable */` |
|    55866 |   598 | `				PH7_VmUnsetMemObj(&(*pVm),aSlot[n].nIdx,FALSE);` |
|    27934 |   599 | `			}` |
|        - |   600 | `			/* Remove local reference */` |
|     8796 |   601 | `			aSlot = (VmSlot *)SySetBasePtr(&pCurFrame->sRef);` |
|    64694 |   602 | `			for(n = 0 ; n < SySetUsed(&pCurFrame->sRef) ; ++n ){` |
|    55900 |   603 | `				PH7_VmRefObjRemove(&(*pVm),aSlot[n].nIdx,(SyHashEntry *)aSlot[n].pUserData,0);` |
|    27951 |   604 | `			}` |
|     4397 |   605 | `		}` |
|        - |   606 | `		/* Release internal containers */` |
|     8814 |   607 | `		SyHashRelease(&pCurFrame->hVar);` |
|     8814 |   608 | `		SySetRelease(&pCurFrame->sArg);` |
|     8814 |   609 | `		SySetRelease(&pCurFrame->sLocal);` |
|     8814 |   610 | `		SySetRelease(&pCurFrame->sRef);` |
|        - |   611 | `		/* Release the whole structure */` |
|     8814 |   612 | `		SyMemBackendPoolFree(&pVm->sAllocator,pCurFrame);` |
|     4406 |   613 | `	}` |
|     8814 |   614 |  |
|        - |   615 | `/*` |
...
|        - |   731 | ` */` |
|    59394 |   732 | `PH7_PRIVATE sxi32 VmMountUserClass(` |
...
|    59396 |   742 | `	SyHashResetLoopCursor(&pClass->hAttr);` |
|        - |   743 | `	/* Process only static and constant attribute */` |
|   199129 |   744 | `	while( (pEntry = SyHashGetNextEntry(&pClass->hAttr)) != 0 ){` |
|        - |   745 | `		/* Extract the current attribute */` |
|   110038 |   746 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|   110038 |   747 | `		if( pAttr->iFlags & (PH7_CLASS_ATTR_CONSTANT\|PH7_CLASS_ATTR_STATIC) ){` |
...
|    59396 |   769 | `	if( pClass->iFlags & PH7_CLASS_INTERFACE ){` |
|        - |   770 | `		/* Do not mount interface methods since they are signatures only.` |
|        - |   771 | `		 */` |
|    37454 |   772 | `		return SXRET_OK;` |
|        - |   773 | `	}` |
|        - |   774 | `	/* Create constructor alias if not yet done */` |
|    21944 |   775 | `	if( SyHashGet(&pClass->hMethod,"__construct",sizeof("__construct")-1) == 0 ){` |
...
|    21944 |   785 | `	SyHashResetLoopCursor(&pClass->hMethod);` |
|   209561 |   786 | `	while((pEntry = SyHashGetNextEntry(&pClass->hMethod)) != 0 ){` |
|   176648 |   787 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|   176648 |   788 | `		if( (pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT) == 0 ){` |
|   176642 |   789 | `			rc = PH7_VmInstallUserFunction(&(*pVm),&pMeth->sFunc,&pMeth->sVmName);` |
|   176642 |   790 | `			if( rc != SXRET_OK ){` |
|      ! 0 |   791 | `				return rc;` |
|        - |   792 | `			}` |
|    88320 |   793 | `		}` |
|        2 |   794 | `	}` |
|        - |   795 | `	/* Mark class as mounted to avoid redundant mounting */` |
|    21944 |   796 | `	pClass->bMounted = TRUE;` |
|    21944 |   797 | `	return SXRET_OK;` |
|    29699 |   798 |  |
|        - |   799 | `/*` |
...
|        - |   870 | ` */` |
|   178674 |   871 | `PH7_PRIVATE ph7_value * PH7_ReserveConstObj(ph7_vm *pVm,sxu32 *pIndex)` |
|        2 |   872 |  |
|        - |   873 | `	ph7_value *pObj;` |
|        - |   874 | `	sxi32 rc;` |
|   178676 |   875 | `	if( pIndex ){` |
|        - |   876 | `		/* Object index in the object table */` |
|   174218 |   877 | `		*pIndex = SySetUsed(&pVm->aLitObj);` |
|    87108 |   878 | `	}` |
|        - |   879 | `	/* Reserve a slot for the new object */` |
|   178676 |   880 | `	rc = SySetPut(&pVm->aLitObj,(const void *)zDummy);` |
|   178676 |   881 | `	if( rc != SXRET_OK ){` |
...
|      ! 0 |   885 | `		return 0;` |
|        - |   886 | `	}` |
|   178676 |   887 | `	pObj = (ph7_value *)SySetPeek(&pVm->aLitObj);` |
|   178676 |   888 | `	return pObj;` |
|    89339 |   889 |  |
|        - |   890 | `/*` |
|        - |   891 | ` * Reserve a memory object.` |
|        - |   892 | ` * Return a pointer to the raw ph7_value on success. NULL on failure.` |
|        - |   893 | ` */` |
|  2119422 |   894 | `PH7_PRIVATE ph7_value * VmReserveMemObj(ph7_vm *pVm,sxu32 *pIndex)` |
|        2 |   895 |  |
|        - |   896 | `	ph7_value *pObj;` |
|        - |   897 | `	sxi32 rc;` |
|  2119424 |   898 | `	if( pIndex ){` |
|        - |   899 | `		/* Object index in the object table */` |
|  2119424 |   900 | `		*pIndex = SySetUsed(&pVm->aMemObj);` |
|  1059711 |   901 | `	}` |
|        - |   902 | `	/* Reserve a slot for the new object */` |
|  2119424 |   903 | `	rc = SySetPut(&pVm->aMemObj,(const void *)zDummy);` |
|  2119424 |   904 | `	if( rc != SXRET_OK ){` |
...
|      ! 0 |   908 | `		return 0;` |
|        - |   909 | `	}` |
|  2119424 |   910 | `	pObj = (ph7_value *)SySetPeek(&pVm->aMemObj);` |
|  2119424 |   911 | `	return pObj;` |
|  1059713 |   912 |  |
...
|        - |  1250 | ` */` |
|     1486 |  1251 | `PH7_PRIVATE sxi32 PH7_VmInit(` |
...
|     1488 |  1260 | `	SyZero(pVm,sizeof(ph7_vm));` |
|        - |  1261 | `	/* Initialize VM fields */` |
|     1488 |  1262 | `	pVm->pEngine = &(*pEngine);` |
|     1488 |  1263 | `	SyMemBackendInitFromParent(&pVm->sAllocator,&pEngine->sAllocator);` |
|        - |  1264 | `	/* Instructions containers */` |
|     1488 |  1265 | `	SySetInit(&pVm->aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|     1488 |  1266 | `	SySetAlloc(&pVm->aByteCode,0xFF);` |
|     1488 |  1267 | `	pVm->pByteContainer = &pVm->aByteCode;` |
|        - |  1268 | `	/* Object containers */` |
|     1488 |  1269 | `	SySetInit(&pVm->aMemObj,&pVm->sAllocator,sizeof(ph7_value));` |
|     1488 |  1270 | `	SySetAlloc(&pVm->aMemObj,0xFF);` |
|        - |  1271 | `	/* Virtual machine internal containers */` |
|     1488 |  1272 | `	SyBlobInit(&pVm->sConsumer,&pVm->sAllocator);` |
|     1488 |  1273 | `	SyBlobInit(&pVm->sWorker,&pVm->sAllocator);` |
|     1488 |  1274 | `	SyBlobInit(&pVm->sArgv,&pVm->sAllocator);` |
|     1488 |  1275 | `	SySetInit(&pVm->aLitObj,&pVm->sAllocator,sizeof(ph7_value));` |
|     1488 |  1276 | `	SySetAlloc(&pVm->aLitObj,0xFF);` |
|     1488 |  1277 | `	SyHashInit(&pVm->hHostFunction,&pVm->sAllocator,0,0);` |
|     1488 |  1278 | `	SyHashInit(&pVm->hFunction,&pVm->sAllocator,0,0);` |
|     1488 |  1279 | `	SyHashInit(&pVm->hClass,&pVm->sAllocator,SyStrHash,SyStrnmicmp);` |
|     1488 |  1280 | `	SyHashInit(&pVm->hConstant,&pVm->sAllocator,0,0);` |
|     1488 |  1281 | `	SyHashInit(&pVm->hSuper,&pVm->sAllocator,0,0);` |
|     1488 |  1282 | `	SyHashInit(&pVm->hPDO,&pVm->sAllocator,0,0);` |
|     1488 |  1283 | `	SySetInit(&pVm->aFreeObj,&pVm->sAllocator,sizeof(VmSlot));` |
|     1488 |  1284 | `	SySetInit(&pVm->aSelf,&pVm->sAllocator,sizeof(ph7_class *));` |
|     1488 |  1285 | `	SySetInit(&pVm->aShutdown,&pVm->sAllocator,sizeof(VmShutdownCB));` |
|     1488 |  1286 | `	SySetInit(&pVm->aException,&pVm->sAllocator,sizeof(ph7_exception *));` |
|        - |  1287 | `	/* Configuration containers */` |
|     1488 |  1288 | `	SySetInit(&pVm->aFiles,&pVm->sAllocator,sizeof(SyString));` |
|     1488 |  1289 | `	SySetInit(&pVm->aPaths,&pVm->sAllocator,sizeof(SyString));` |
|     1488 |  1290 | `	SySetInit(&pVm->aIncluded,&pVm->sAllocator,sizeof(SyString));` |
|     1488 |  1291 | `	SySetInit(&pVm->aOB,&pVm->sAllocator,sizeof(VmObEntry));` |
|     1488 |  1292 | `	SySetInit(&pVm->aIOstream,&pVm->sAllocator,sizeof(ph7_io_stream *));` |
|        - |  1293 | `	/* Error callbacks containers */` |
|     1488 |  1294 | `	PH7_MemObjInit(&(*pVm),&pVm->aExceptionCB[0]);` |
|     1488 |  1295 | `	PH7_MemObjInit(&(*pVm),&pVm->aExceptionCB[1]);` |
|     1488 |  1296 | `	PH7_MemObjInit(&(*pVm),&pVm->aErrCB[0]);` |
|     1488 |  1297 | `	PH7_MemObjInit(&(*pVm),&pVm->aErrCB[1]);` |
|     1488 |  1298 | `	PH7_MemObjInit(&(*pVm),&pVm->sAssertCallback);` |
|        - |  1299 | `	/* Set a default recursion limit */` |
|        - |  1300 | `#if defined(__WINNT__) \|\| defined(__UNIXES__)` |
|     1488 |  1301 | `	pVm->nMaxDepth = 32;` |
|        - |  1302 | `#else` |
|        - |  1303 | `	pVm->nMaxDepth = 16;` |
|        - |  1304 | `#endif` |
|        - |  1305 | `	/* Default assertion flags */` |
|     1488 |  1306 | `	pVm->iAssertFlags = PH7_ASSERT_WARNING; /* Issue a warning for each failed assertion */` |
|        - |  1307 | `	/* JSON return status */` |
|     1488 |  1308 | `	pVm->json_rc = JSON_ERROR_NONE;` |
|        - |  1309 | `	/* PRNG context */` |
|     1488 |  1310 | `	SyRandomnessInit(&pVm->sPrng,0,0);` |
|        - |  1311 | `	/* Install the null constant */` |
|     1488 |  1312 | `	pObj = PH7_ReserveConstObj(&(*pVm),0);` |
|     1488 |  1313 | `	if( pObj == 0 ){` |
|      ! 0 |  1314 | `		rc = SXERR_MEM;` |
|      ! 0 |  1315 | `		goto Err;` |
|        - |  1316 | `	}` |
|     1488 |  1317 | `	PH7_MemObjInit(pVm,pObj);` |
|        - |  1318 | `	/* Install the boolean TRUE constant */` |
|     1488 |  1319 | `	pObj = PH7_ReserveConstObj(&(*pVm),0);` |
|     1488 |  1320 | `	if( pObj == 0 ){` |
|      ! 0 |  1321 | `		rc = SXERR_MEM;` |
|      ! 0 |  1322 | `		goto Err;` |
|        - |  1323 | `	}` |
|     1488 |  1324 | `	PH7_MemObjInitFromBool(pVm,pObj,1);` |
|        - |  1325 | `	/* Install the boolean FALSE constant */` |
|     1488 |  1326 | `	pObj = PH7_ReserveConstObj(&(*pVm),0);` |
|     1488 |  1327 | `	if( pObj == 0 ){` |
|      ! 0 |  1328 | `		rc = SXERR_MEM;` |
|      ! 0 |  1329 | `		goto Err;` |
|        - |  1330 | `	}` |
|     1488 |  1331 | `	PH7_MemObjInitFromBool(pVm,pObj,0);` |
...
|     1488 |  1335 | `	pObj = PH7_ReserveConstObj(&(*pVm),&pVm->nEmptyStringIdx);` |
|     1488 |  1336 | `	if( pObj == 0 ){` |
|      ! 0 |  1337 | `		rc = SXERR_MEM;` |
|      ! 0 |  1338 | `		goto Err;` |
|        - |  1339 | `	}` |
|     1488 |  1340 | `	PH7_MemObjInitFromString(pVm,pObj,0);` |
|        - |  1341 | `	/* Create the global frame */` |
|     1488 |  1342 | `	rc = VmEnterFrame(&(*pVm),0,0,0);` |
|     1488 |  1343 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  1344 | `		goto Err;` |
|        - |  1345 | `	}` |
|        - |  1346 | `	/* Initialize the code generator */` |
|     1488 |  1347 | `	rc = PH7_InitCodeGenerator(pVm,pEngine->xConf.xErr,pEngine->xConf.pErrData);` |
|     1488 |  1348 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  1349 | `		goto Err;` |
|        - |  1350 | `	}` |
|        - |  1351 | `	/* VM correctly initialized,set the magic number */` |
|     1488 |  1352 | `	pVm->nMagic = PH7_VM_INIT;` |
|     1488 |  1353 | `	SyStringInitFromBuf(&sBuiltin,PH7_BUILTIN_LIB,sizeof(PH7_BUILTIN_LIB)-1);` |
|        - |  1354 | `	/* Compile the built-in library */` |
|     1488 |  1355 | `	VmEvalChunk(&(*pVm),0,&sBuiltin,PH7_PHP_ONLY,FALSE);` |
|        - |  1356 | `	/* Reset the code generator */` |
|     1488 |  1357 | `	PH7_ResetCodeGenerator(&(*pVm),pEngine->xConf.xErr,pEngine->xConf.pErrData);` |
|     1488 |  1358 | `	return SXRET_OK;` |
|      ! 0 |  1359 | `Err:` |
...
|        - |  1391 | ` */` |
|    22042 |  1392 | `static ph7_value * VmNewOperandStack(` |
...
|        - |  1404 | `  */` |
|    22044 |  1405 | `	nInstr += VM_STACK_GUARD;` |
|    22044 |  1406 | `	pStack = (ph7_value *)SyMemBackendAlloc(&pVm->sAllocator,nInstr * sizeof(ph7_value));` |
|    22044 |  1407 | `	if( pStack == 0 ){` |
|      ! 0 |  1408 | `		return 0;` |
|        - |  1409 | `	}` |
|        - |  1410 | `	/* Initialize the operand stack */` |
|  1401876 |  1411 | `	while( nInstr > 0 ){` |
|  1379834 |  1412 | `		PH7_MemObjInit(&(*pVm),&pStack[nInstr - 1]);` |
|  1379834 |  1413 | `		--nInstr;` |
|        2 |  1414 | `	}` |
|        - |  1415 | `	/* Ready for bytecode execution */` |
|    22044 |  1416 | `	return pStack;` |
|    11023 |  1417 |  |
...
|        - |  1426 | ` */` |
|     1228 |  1427 | `PH7_PRIVATE sxi32 PH7_VmMakeReady(` |
|        - |  1428 | `	ph7_vm *pVm /* Target VM */` |
|        - |  1429 | `	)` |
|        2 |  1430 |  |
|        - |  1431 | `	SyHashEntry *pEntry;` |
|        - |  1432 | `	sxi32 rc;` |
|     1230 |  1433 | `	if( pVm->nMagic != PH7_VM_INIT ){` |
|        - |  1434 | `		/* Initialize your VM first */` |
|      ! 0 |  1435 | `		return SXERR_CORRUPT;` |
|        - |  1436 | `	}` |
|        - |  1437 | `	/* Mark the VM ready for byte-code execution */` |
|     1230 |  1438 | `	pVm->nMagic = PH7_VM_RUN;` |
|        - |  1439 | `	/* Release the code generator now we have compiled our program */` |
|     1230 |  1440 | `	PH7_ResetCodeGenerator(pVm,0,0);` |
|        - |  1441 | `	/* Emit the DONE instruction */` |
|     1230 |  1442 | `	rc = PH7_VmEmitInstr(&(*pVm),PH7_OP_DONE,0,0,0,0);` |
|     1230 |  1443 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  1444 | `		return SXERR_MEM;` |
|        - |  1445 | `	}` |
|        - |  1446 | `	/* Script return value */` |
|     1230 |  1447 | `	PH7_MemObjInit(&(*pVm),&pVm->sExec); /* Assume a NULL return value */` |
|        - |  1448 | `	/* Allocate a new operand stack */` |
|     1230 |  1449 | `	pVm->aOps = VmNewOperandStack(&(*pVm),SySetUsed(pVm->pByteContainer));` |
|     1230 |  1450 | `	if( pVm->aOps == 0 ){` |
|      ! 0 |  1451 | `		return SXERR_MEM;` |
|        - |  1452 | `	}` |
|        - |  1453 | `	/* Set the default VM output consumer callback and it's` |
|        - |  1454 | `	 * private data. */` |
|     1230 |  1455 | `	pVm->sVmConsumer.xConsumer = PH7_VmBlobConsumer;` |
|     1230 |  1456 | `	pVm->sVmConsumer.pUserData = &pVm->sConsumer;` |
|        - |  1457 | `	/* Allocate the reference table */` |
|     1230 |  1458 | `	pVm->nRefSize = 0x10; /* Must be a power of two for fast arithemtic */` |
|     1230 |  1459 | `	pVm->apRefObj = (VmRefObj **)SyMemBackendAlloc(&pVm->sAllocator,sizeof(VmRefObj *) * pVm->nRefSize);` |
|     1230 |  1460 | `	if( pVm->apRefObj == 0 ){` |
...
|     1230 |  1479 | `	PH7_RegisterBuiltInConstant(&(*pVm));` |
|        - |  1480 | `	/* Register built-in functions [i.e: is_null(), array_diff(), strlen(), etc.] */` |
|     1230 |  1481 | `	PH7_RegisterBuiltInFunction(&(*pVm));` |
|        - |  1482 | `	/* Initialize and install static and constants class attributes */` |
|     1230 |  1483 | `	SyHashResetLoopCursor(&pVm->hClass);` |
|    14764 |  1484 | `	while((pEntry = SyHashGetNextEntry(&pVm->hClass)) != 0 ){` |
|    13536 |  1485 | `		rc = VmMountUserClass(&(*pVm),(ph7_class *)pEntry->pUserData);` |
|    13536 |  1486 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  1487 | `			return rc;` |
|        - |  1488 | `		}` |
|        2 |  1489 | `	}` |
|        - |  1490 | `	/* Random number betwwen 0 and 1023 used to generate unique ID */` |
|     1230 |  1491 | `	pVm->unique_id = PH7_VmRandomNum(&(*pVm)) & 1023;` |
|        - |  1492 | `	/* VM is ready for bytecode execution */` |
|     1230 |  1493 | `	return SXRET_OK;` |
|      616 |  1494 |  |
|        - |  1495 | `/*` |
...
|        - |  1513 | ` */` |
|     1220 |  1514 | `PH7_PRIVATE sxi32 PH7_VmRelease(ph7_vm *pVm)` |
|        2 |  1515 |  |
|        - |  1516 | `	/* Set the stale magic number */` |
|     1222 |  1517 | `	pVm->nMagic = PH7_VM_STALE;` |
|        - |  1518 | `	/* Release the private memory subsystem */` |
|     1222 |  1519 | `	SyMemBackendRelease(&pVm->sAllocator);` |
|     1222 |  1520 | `	return SXRET_OK;` |
|        2 |  1521 |  |
|        - |  1522 | `/*` |
...
|        - |  1531 | ` */` |
|   448008 |  1532 | `static sxi32 VmInitCallContext(` |
...
|        - |  1538 | `	)` |
|        2 |  1539 |  |
|   448010 |  1540 | `	pOut->pFunc = pFunc;` |
|   448010 |  1541 | `	pOut->pVm   = pVm;` |
|   448010 |  1542 | `	SySetInit(&pOut->sVar,&pVm->sAllocator,sizeof(ph7_value *));` |
|   448010 |  1543 | `	SySetInit(&pOut->sChunk,&pVm->sAllocator,sizeof(ph7_aux_data));` |
|        - |  1544 | `	/* Assume a null return value */` |
|   448010 |  1545 | `	MemObjSetType(pRet,MEMOBJ_NULL);` |
|   448010 |  1546 | `	pOut->pRet = pRet;` |
|   448010 |  1547 | `	pOut->iFlags = iFlags;` |
|   448010 |  1548 | `	return SXRET_OK;` |
|        2 |  1549 |  |
|        - |  1550 | `/*` |
|        - |  1551 | ` * Release a foreign function call context and cleanup the mess` |
|        - |  1552 | ` * left behind.` |
|        - |  1553 | ` */` |
|   448008 |  1554 | `static void VmReleaseCallContext(ph7_context *pCtx)` |
|        2 |  1555 |  |
|        - |  1556 | `	sxu32 n;` |
|   448010 |  1557 | `	if( SySetUsed(&pCtx->sVar) > 0 ){` |
|     5034 |  1558 | `		ph7_value **apObj = (ph7_value **)SySetBasePtr(&pCtx->sVar);` |
|    14118 |  1559 | `		for( n = 0 ; n < SySetUsed(&pCtx->sVar) ; ++n ){` |
|     9086 |  1560 | `			if( apObj[n] == 0 ){` |
|        - |  1561 | `				/* Already released */` |
|      250 |  1562 | `				continue;` |
|        - |  1563 | `			}` |
|     8838 |  1564 | `			PH7_MemObjRelease(apObj[n]);` |
|     8838 |  1565 | `			SyMemBackendPoolFree(&pCtx->pVm->sAllocator,apObj[n]);` |
|     4420 |  1566 | `		}` |
|     5034 |  1567 | `		SySetRelease(&pCtx->sVar);` |
|     2516 |  1568 | `	}` |
|   448010 |  1569 | `	if( SySetUsed(&pCtx->sChunk) > 0 ){` |
...
|        - |  1615 | ` */` |
|  2553438 |  1616 | `static void VmPopOperand(` |
|        - |  1617 | `	ph7_value **ppTos, /* Operand stack */` |
|        - |  1618 | `	sxi32 nPop         /* Total number of memory objects to pop */` |
|        - |  1619 | `	)` |
|        2 |  1620 |  |
|  2553440 |  1621 | `	ph7_value *pTos = *ppTos;` |
|  5434096 |  1622 | `	while( nPop > 0 ){` |
|  2880658 |  1623 | `		PH7_MemObjRelease(pTos);` |
|  2880658 |  1624 | `		pTos--;` |
|  2880658 |  1625 | `		nPop--;` |
|        2 |  1626 | `	}` |
|        - |  1627 | `	/* Top of the stack */` |
|  2553440 |  1628 | `	*ppTos = pTos;` |
|  2553440 |  1629 |  |
|        - |  1630 | `/*` |
|        - |  1631 | ` * Reserve a memory object.` |
|        - |  1632 | ` * Return a pointer to the raw ph7_value on success. NULL on failure.` |
|        - |  1633 | ` */` |
|  2773898 |  1634 | `PH7_PRIVATE ph7_value * PH7_ReserveMemObj(ph7_vm *pVm)` |
|        2 |  1635 |  |
|  2773900 |  1636 | `	ph7_value *pObj = 0;` |
|        - |  1637 | `	VmSlot *pSlot;` |
|        - |  1638 | `	sxu32 nIdx;` |
|        - |  1639 | `	/* Check for a free slot */` |
|  2773900 |  1640 | `	nIdx = SXU32_HIGH; /* cc warning */` |
|  2773900 |  1641 | `	pSlot = (VmSlot *)SySetPop(&pVm->aFreeObj);` |
|  2773900 |  1642 | `	if( pSlot ){` |
|   654478 |  1643 | `		pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pSlot->nIdx);` |
|   654478 |  1644 | `		nIdx = pSlot->nIdx;` |
|   327238 |  1645 | `	}` |
|  2773900 |  1646 | `	if( pObj == 0 ){` |
|        - |  1647 | `		/* Reserve a new memory object */` |
|  2119424 |  1648 | `		pObj = VmReserveMemObj(&(*pVm),&nIdx);` |
|  2119424 |  1649 | `		if( pObj == 0 ){` |
|      ! 0 |  1650 | `			return 0;` |
|        - |  1651 | `		}` |
|  1059711 |  1652 | `	}` |
|        - |  1653 | `	/* Set a null default value */` |
|  2773900 |  1654 | `	PH7_MemObjInit(&(*pVm),pObj);` |
|  2773900 |  1655 | `	pObj->nIdx = nIdx;` |
|  2773900 |  1656 | `	return pObj;` |
|  1386951 |  1657 |  |
|        - |  1658 | `/*` |
|        - |  1659 | ` * Insert an entry by reference (not copy) in the given hashmap.` |
|        - |  1660 | ` */` |
|    17096 |  1661 | `static sxi32 VmHashmapRefInsert(` |
...
|        - |  1668 | `	ph7_value sKey;` |
|        - |  1669 | `	sxi32 rc;` |
|    17098 |  1670 | `	PH7_MemObjInitFromString(pMap->pVm,&sKey,0);` |
|    17098 |  1671 | `	PH7_MemObjStringAppend(&sKey,zKey,nByte);` |
|        - |  1672 | `	/* Perform the insertion */` |
|    17098 |  1673 | `	rc = PH7_HashmapInsertByRef(&(*pMap),&sKey,nRefIdx);` |
|    17098 |  1674 | `	PH7_MemObjRelease(&sKey);` |
|    17098 |  1675 | `	return rc;` |
|        2 |  1676 |  |
|        - |  1677 | `/*` |
...
|        - |  1681 | ` */` |
|  2352146 |  1682 | `static ph7_value * VmExtractMemObj(` |
...
|        - |  1687 | `	)` |
|        2 |  1688 |  |
|  2352148 |  1689 | `	int bNullify = FALSE;` |
...
|  2352148 |  1696 | `	pFrame = pVm->pFrame;` |
|  2401500 |  1697 | `	while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|        - |  1698 | `		/* Safely ignore the exception frame */` |
|    49353 |  1699 | `		pFrame = pFrame->pParent; /* Parent frame */` |
|        1 |  1700 | `	}` |
|        - |  1701 | `	/* Perform the lookup */` |
|  2352148 |  1702 | `	if( pName == 0 \|\| pName->nByte < 1 ){` |
...
|  2352148 |  1710 | `	pEntry = SyHashGet(&pVm->hSuper,(const void *)pName->zString,pName->nByte);` |
|  2352148 |  1711 | `	if( pEntry == 0 ){` |
|        - |  1712 | `		/* Query the top active frame */` |
|  2352112 |  1713 | `		pEntry = SyHashGet(&pFrame->hVar,(const void *)pName->zString,pName->nByte);` |
|  2352112 |  1714 | `		if( pEntry == 0 ){` |
|    61144 |  1715 | `			char *zName = (char *)pName->zString;` |
|        - |  1716 | `			VmSlot sLocal;` |
|    61144 |  1717 | `			if( !bCreate ){` |
...
|        - |  1723 | `			 */` |
|    60658 |  1724 | `			pObj = PH7_ReserveMemObj(&(*pVm));` |
|    60658 |  1725 | `			if( pObj == 0 ){` |
|      ! 0 |  1726 | `				return 0;` |
|        - |  1727 | `			}` |
|    60658 |  1728 | `			nIdx = pObj->nIdx;` |
|    60658 |  1729 | `			if( bDup ){` |
|        - |  1730 | `				/* Duplicate name */` |
...
|    60658 |  1737 | `			rc = SyHashInsert(&pFrame->hVar,zName,pName->nByte,SX_INT_TO_PTR(nIdx));` |
|    60658 |  1738 | `			if( rc != SXRET_OK ){` |
...
|      ! 0 |  1743 | `				return 0;` |
|        - |  1744 | `			}` |
|    60658 |  1745 | `			if( pFrame->pParent != 0 ){` |
|        - |  1746 | `				/* Local variable */` |
|    55866 |  1747 | `				sLocal.nIdx = nIdx;` |
|    55866 |  1748 | `				SySetPut(&pFrame->sLocal,(const void *)&sLocal);` |
|    27934 |  1749 | `			}else{` |
|        - |  1750 | `				/* Register in the $GLOBALS array */` |
|     4794 |  1751 | `				VmHashmapRefInsert(pVm->pGlobal,pName->zString,pName->nByte,nIdx);` |
|        - |  1752 | `			}` |
|        - |  1753 | `			/* Install in the reference table */` |
|    60658 |  1754 | `			PH7_VmRefObjInstall(&(*pVm),nIdx,SyHashLastEntry(&pFrame->hVar),0,0);` |
|        - |  1755 | `			/* Save object index */` |
|    60658 |  1756 | `			pObj->nIdx = nIdx;` |
|    30330 |  1757 | `		}else{` |
|        - |  1758 | `			/* Extract variable contents */` |
|  2290970 |  1759 | `			nIdx = (sxu32)SX_PTR_TO_INT(pEntry->pUserData);` |
|  2290970 |  1760 | `			pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|  2290970 |  1761 | `			if( bNullify && pObj ){` |
...
|        - |  1775 | ` */` |
|     1254 |  1776 | `static ph7_value * VmExtractSuper(` |
...
|     1256 |  1786 | `	pEntry = SyHashGet(&pVm->hSuper,(const void *)zName,nByte);` |
|     1256 |  1787 | `	if( pEntry == 0 ){` |
|        - |  1788 | `		/* No such entry */` |
|      ! 0 |  1789 | `		return 0;` |
|        - |  1790 | `	}` |
|        - |  1791 | `	/* Extract the superglobal index in the global object pool */` |
|     1256 |  1792 | `	nIdx = SX_PTR_TO_INT(pEntry->pUserData);` |
|        - |  1793 | `	/* Extract the variable value  */` |
|     1256 |  1794 | `	pValue = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|     1256 |  1795 | `	return pValue;` |
|      629 |  1796 |  |
|        - |  1797 | `/*` |
|        - |  1798 | ` * Perform a raw hashmap insertion.` |
|        - |  1799 | ` * Refer to the [PH7_VmConfigure()] implementation for additional information.` |
|        - |  1800 | ` */` |
|     1252 |  1801 | `static sxi32 VmHashmapInsert(` |
...
|        - |  1810 | `	sxi32 rc;` |
|     1254 |  1811 | `	PH7_MemObjInitFromString(pMap->pVm,&sKey,0);` |
|     1254 |  1812 | `	PH7_MemObjInitFromString(pMap->pVm,&sValue,0);` |
|     1254 |  1813 | `	if( zKey ){` |
|     1232 |  1814 | `		if( nKeylen < 0 ){` |
|     1232 |  1815 | `			nKeylen = (int)SyStrlen(zKey);` |
|      615 |  1816 | `		}` |
|     1232 |  1817 | `		PH7_MemObjStringAppend(&sKey,zKey,(sxu32)nKeylen);` |
|      615 |  1818 | `	}` |
|     1254 |  1819 | `	if( zData ){` |
|     1254 |  1820 | `		if( nLen < 0 ){` |
...
|      ! 0 |  1823 | `		}` |
|     1254 |  1824 | `		PH7_MemObjStringAppend(&sValue,zData,(sxu32)nLen);` |
|      626 |  1825 | `	}` |
|        - |  1826 | `	/* Perform the insertion */` |
|     1254 |  1827 | `	rc = PH7_HashmapInsert(&(*pMap),&sKey,&sValue);` |
|     1254 |  1828 | `	PH7_MemObjRelease(&sKey);` |
|     1254 |  1829 | `	PH7_MemObjRelease(&sValue);` |
|     1254 |  1830 | `	return rc;` |
|        2 |  1831 |  |
...
|        - |  1846 | ` */` |
|    19672 |  1847 | `PH7_PRIVATE sxi32 PH7_VmConfigure(` |
|        - |  1848 | `	ph7_vm *pVm, /* Target VM */` |
|        - |  1849 | `	sxi32 nOp,   /* Configuration verb */` |
|        - |  1850 | `	va_list ap   /* Subsequent option arguments */` |
|        - |  1851 | `	)` |
|        2 |  1852 |  |
|    19674 |  1853 | `	sxi32 rc = SXRET_OK;` |
|    19674 |  1854 | `	switch(nOp){` |
|      614 |  1855 | `	case PH7_VM_CONFIG_OUTPUT: {` |
|     1230 |  1856 | `		ProcConsumer xConsumer = va_arg(ap,ProcConsumer);` |
|     1230 |  1857 | `		void *pUserData = va_arg(ap,void *);` |
...
|     1230 |  1866 | `		pVm->sVmConsumer.xConsumer = xConsumer;` |
|     1230 |  1867 | `		pVm->sVmConsumer.pUserData = pUserData;` |
|     1230 |  1868 | `		break;` |
|        - |  1869 | `							   }` |
|      614 |  1870 | `	case PH7_VM_CONFIG_IMPORT_PATH: {` |
|        - |  1871 | `		/* Import path */` |
|        - |  1872 | `		  const char *zPath;` |
|        - |  1873 | `		  SyString sPath;` |
|     1230 |  1874 | `		  zPath = va_arg(ap,const char *);` |
...
|        - |  1879 | `		  }` |
|        - |  1880 | `#endif` |
|     1230 |  1881 | `		  SyStringInitFromBuf(&sPath,zPath,SyStrlen(zPath));` |
|        - |  1882 | `		  /* Remove trailing slashes and backslashes */` |
|        - |  1883 | `#ifdef __WINNT__` |
|        2 |  1884 | `		  SyStringTrimTrailingChar(&sPath,'\\');` |
|        - |  1885 | `#endif` |
|     2458 |  1886 | `		  SyStringTrimTrailingChar(&sPath,'/');` |
|        - |  1887 | `		  /* Remove leading and trailing white spaces */` |
|     1230 |  1888 | `		  SyStringFullTrim(&sPath);` |
|     1230 |  1889 | `		  if( sPath.nByte > 0 ){` |
|        - |  1890 | `			  /* Store the path in the corresponding conatiner */` |
|     1230 |  1891 | `			  rc = SySetPut(&pVm->aPaths,(const void *)&sPath);` |
|      614 |  1892 | `		  }` |
|     1230 |  1893 | `		  break;` |
|        - |  1894 | `									 }` |
|      614 |  1895 | `	case PH7_VM_CONFIG_ERR_REPORT:` |
|        - |  1896 | `		/* Run-Time Error report */` |
|     1230 |  1897 | `		pVm->bErrReport = 1;` |
|     1230 |  1898 | `		break;` |
...
|        - |  1918 | `							   }` |
|        - |  1919 |  |
|     6140 |  1920 | `	case PH7_VM_CONFIG_CREATE_SUPER:` |
|        - |  1921 | `	case PH7_VM_CONFIG_CREATE_VAR: {` |
|        - |  1922 | `		/* Create a new superglobal/global variable */` |
|    12282 |  1923 | `		const char *zName = va_arg(ap,const char *);` |
|    12282 |  1924 | `		ph7_value *pValue = va_arg(ap,ph7_value *);` |
...
|        - |  1933 | `		}` |
|        - |  1934 | `#endif` |
|    12282 |  1935 | `		nByte = SyStrlen(zName);` |
|    12282 |  1936 | `		if( nOp == PH7_VM_CONFIG_CREATE_SUPER ){` |
|        - |  1937 | `			/* Check if the superglobal is already installed */` |
|    12282 |  1938 | `			pEntry = SyHashGet(&pVm->hSuper,(const void *)zName,nByte);` |
|     6142 |  1939 | `		}else{` |
|        - |  1940 | `			/* Query the top active VM frame */` |
|      ! 0 |  1941 | `			pEntry = SyHashGet(&pVm->pFrame->hVar,(const void *)zName,nByte);` |
|        - |  1942 | `		}` |
|    12282 |  1943 | `		if( pEntry ){` |
...
|    12282 |  1954 | `			pObj = PH7_ReserveMemObj(&(*pVm));` |
|    12282 |  1955 | `			if( pObj == 0 ){` |
|      ! 0 |  1956 | `				rc = SXERR_MEM;` |
|      ! 0 |  1957 | `				break;` |
|        - |  1958 | `			}` |
|    12282 |  1959 | `			nIdx = pObj->nIdx;` |
|        - |  1960 | `			/* Copy value */` |
|    12282 |  1961 | `			PH7_MemObjStore(pValue,pObj);` |
|    12282 |  1962 | `			if( nOp == PH7_VM_CONFIG_CREATE_SUPER ){` |
|        - |  1963 | `				/* Install the superglobal */` |
|    12282 |  1964 | `				rc = SyHashInsert(&pVm->hSuper,(const void *)zName,nByte,SX_INT_TO_PTR(nIdx));` |
|     6142 |  1965 | `			}else{` |
|        - |  1966 | `				/* Install in the current frame */` |
|      ! 0 |  1967 | `				rc = SyHashInsert(&pVm->pFrame->hVar,(const void *)zName,nByte,SX_INT_TO_PTR(nIdx));` |
|        - |  1968 | `			}` |
|    12282 |  1969 | `			if( rc == SXRET_OK ){` |
|        - |  1970 | `				SyHashEntry *pRef;` |
|    12282 |  1971 | `				if( nOp == PH7_VM_CONFIG_CREATE_SUPER ){` |
|    12282 |  1972 | `					pRef = SyHashLastEntry(&pVm->hSuper);` |
|     6142 |  1973 | `				}else{` |
|      ! 0 |  1974 | `					pRef = SyHashLastEntry(&pVm->pFrame->hVar);` |
|        - |  1975 | `				}` |
|        - |  1976 | `				/* Install in the reference table */` |
|    12282 |  1977 | `				PH7_VmRefObjInstall(&(*pVm),nIdx,pRef,0,0);` |
|    12282 |  1978 | `				if( nOp == PH7_VM_CONFIG_CREATE_SUPER \|\| pVm->pFrame->pParent == 0){` |
|        - |  1979 | `					/* Register in the $GLOBALS array */` |
|    12282 |  1980 | `					VmHashmapRefInsert(pVm->pGlobal,zName,nByte,nIdx);` |
|     6140 |  1981 | `				}` |
|     6140 |  1982 | `			}` |
|        - |  1983 | `		}` |
|    12282 |  1984 | `		break;` |
|        - |  1985 | `									}` |
|      615 |  1986 | `	case PH7_VM_CONFIG_SERVER_ATTR:` |
...
|     1230 |  2018 | `			pValue = VmExtractSuper(&(*pVm),"_SERVER",sizeof("_SERVER")-1);` |
|        - |  2019 | `		}` |
|     1232 |  2020 | `		if( pValue == 0 \|\| (pValue->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
|        - |  2021 | `			/* No such entry */` |
|      ! 0 |  2022 | `			rc = SXERR_NOTFOUND;` |
|      ! 0 |  2023 | `			break;` |
|        - |  2024 | `		}` |
|        - |  2025 | `		/* Point to the hashmap */` |
|     1232 |  2026 | `		pMap = (ph7_hashmap *)pValue->x.pOther;` |
|        - |  2027 | `		/* Perform the insertion */` |
|     1232 |  2028 | `		rc = VmHashmapInsert(pMap,zKey,-1,zValue,nLen);` |
|     1232 |  2029 | `		break;` |
|        - |  2030 | `								   }` |
...
|      ! 0 |  2078 | `		break;` |
|        - |  2079 | `								   }` |
|     1228 |  2080 | `	case PH7_VM_CONFIG_IO_STREAM: {` |
|        - |  2081 | `		/* Register an IO stream device */` |
|     2458 |  2082 | `		const ph7_io_stream *pStream = va_arg(ap,const ph7_io_stream *);` |
|        - |  2083 | `		/* Make sure we are dealing with a valid IO stream */` |
|     3684 |  2084 | `		if( pStream == 0 \|\| pStream->zName == 0 \|\| pStream->zName[0] == 0 \|\|` |
|     2458 |  2085 | `			pStream->xOpen == 0 \|\| pStream->xRead == 0 ){` |
|        - |  2086 | `				/* Invalid stream */` |
|      ! 0 |  2087 | `				rc = SXERR_INVALID;` |
|      ! 0 |  2088 | `				break;` |
|        - |  2089 | `		}` |
|     2458 |  2090 | `		if( pVm->pDefStream == 0 && SyStrnicmp(pStream->zName,"file",sizeof("file")-1) == 0 ){` |
|        - |  2091 | `			/* Make the 'file://' stream the defaut stream device */` |
|     1230 |  2092 | `			pVm->pDefStream = pStream;` |
|      614 |  2093 | `		}` |
|        - |  2094 | `		/* Insert in the appropriate container */` |
|     2458 |  2095 | `		rc = SySetPut(&pVm->aIOstream,(const void *)&pStream);` |
|     2458 |  2096 | `		break;` |
|        - |  2097 | `								  }` |
...
|        1 |  2194 |  |
|      225 |  2195 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|      225 |  2196 | `	sxi32 rc = SXRET_OK;` |
...
|      225 |  2204 | `	rc = pCons->xConsumer(SyBlobData(pMsg),SyBlobLength(pMsg),pCons->pUserData);` |
|      225 |  2205 | `	if( pCons->xConsumer != VmObConsumer ){` |
|        - |  2206 | `		/* Increment output length */` |
|      225 |  2207 | `		pVm->nOutputLen += SyBlobLength(pMsg);` |
|      112 |  2208 | `	}` |
|      225 |  2209 | `	return rc;` |
|        1 |  2210 |  |
|        - |  2211 | `/*` |
...
|        - |  2410 | ` */` |
|      292 |  2411 | `static void VmGetFrameContext(ph7_vm *pVm,const char **pzFuncName,int *pnFuncLen)` |
|        1 |  2412 |  |
|        - |  2413 | `	VmFrame *pFrame;` |
|        - |  2414 | `	ph7_vm_func *pFunc;` |
|      293 |  2415 | `	*pzFuncName = 0;` |
|      293 |  2416 | `	*pnFuncLen = 0;` |
|      293 |  2417 | `	pFrame = pVm->pFrame;` |
|      293 |  2418 | `	if( pFrame == 0 ){` |
|      ! 0 |  2419 | `		return;` |
|        - |  2420 | `	}` |
|      293 |  2421 | `	while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|      ! 0 |  2422 | `		pFrame = pFrame->pParent;` |
|      ! 0 |  2423 | `	}` |
|      293 |  2424 | `	if( pFrame->pParent == 0 ){` |
|      293 |  2425 | `		return;` |
|        - |  2426 | `	}` |
...
|        - |  2436 | ` */` |
|      146 |  2437 | `static sxi32 VmReportUncaughtException(ph7_vm *pVm,const char *zClass,sxu32 nClass,const char *zMsg,sxu32 nMsg,const char *zFuncName,int nFuncLen)` |
|        1 |  2438 |  |
|        - |  2439 | `	SyBlob sOut;` |
|        - |  2440 | `	SyString *pFile;` |
|      147 |  2441 | `	if( !pVm->bErrReport ){` |
|      ! 0 |  2442 | `		return PH7_OK;` |
|        - |  2443 | `	}` |
|      147 |  2444 | `	if( zClass == 0 \|\| nClass == 0 ){` |
...
|      ! 0 |  2451 | `	}` |
|      147 |  2452 | `	if( zFuncName == 0 \|\| nFuncLen <= 0 ){` |
|      147 |  2453 | `		VmGetFrameContext(pVm,&zFuncName,&nFuncLen);` |
|       73 |  2454 | `	}` |
|      147 |  2455 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|      147 |  2456 | `	SyBlobInit(&sOut,&pVm->sAllocator);` |
|      147 |  2457 | `	SyBlobAppend(&sOut,"PHP Fatal error:  Uncaught ",sizeof("PHP Fatal error:  Uncaught ")-1);` |
|      147 |  2458 | `	SyBlobAppend(&sOut,zClass,nClass);` |
|      147 |  2459 | `	SyBlobAppend(&sOut,": ",sizeof(": ")-1);` |
|      147 |  2460 | `	SyBlobAppend(&sOut,zMsg,nMsg);` |
|      147 |  2461 | `	if( pFile ){` |
|      147 |  2462 | `		SyBlobAppend(&sOut," in ",sizeof(" in ")-1);` |
|      147 |  2463 | `		SyBlobAppend(&sOut,pFile->zString,pFile->nByte);` |
|      147 |  2464 | `		SyBlobAppend(&sOut,":1",sizeof(":1")-1);` |
|       73 |  2465 | `	}` |
|      147 |  2466 | `	SyBlobAppend(&sOut,"\nStack trace:\n",sizeof("\nStack trace:\n")-1);` |
|      147 |  2467 | `	if( pFile ){` |
|      147 |  2468 | `		SyBlobAppend(&sOut,"#0 ",sizeof("#0 ")-1);` |
|      147 |  2469 | `		SyBlobAppend(&sOut,pFile->zString,pFile->nByte);` |
|      147 |  2470 | `		if( zFuncName && nFuncLen > 0 ){` |
|      ! 0 |  2471 | `			SyBlobFormat(&sOut,"(1): %.*s()\n",nFuncLen,zFuncName);` |
|      ! 0 |  2472 | `		}else{` |
|      147 |  2473 | `			SyBlobAppend(&sOut,"(1): {main}\n",sizeof("(1): {main}\n")-1);` |
|        1 |  2474 | `		}` |
|       73 |  2475 | `	}else if( zFuncName && nFuncLen > 0 ){` |
|      ! 0 |  2476 | `		SyBlobFormat(&sOut,"#0 [internal function]: %.*s()\n",nFuncLen,zFuncName);` |
|      ! 0 |  2477 | `	}else{` |
|      ! 0 |  2478 | `		SyBlobAppend(&sOut,"#0 {main}\n",sizeof("#0 {main}\n")-1);` |
|        - |  2479 | `	}` |
|      147 |  2480 | `	SyBlobAppend(&sOut,"#1 {main}",sizeof("#1 {main}")-1);` |
|      147 |  2481 | `	if( pFile ){` |
|      147 |  2482 | `		SyBlobAppend(&sOut,"\n",sizeof("\n")-1);` |
|      147 |  2483 | `		SyBlobAppend(&sOut,"  thrown in ",sizeof("  thrown in ")-1);` |
|      147 |  2484 | `		SyBlobAppend(&sOut,pFile->zString,pFile->nByte);` |
|      147 |  2485 | `		SyBlobAppend(&sOut," on line 1",sizeof(" on line 1")-1);` |
|       73 |  2486 | `	}` |
|      147 |  2487 | `	VmCallErrorHandler(pVm,&sOut);` |
|      147 |  2488 | `	SyBlobRelease(&sOut);` |
|      147 |  2489 | `	return PH7_ABORT;` |
|       74 |  2490 |  |
|        - |  2491 | `/*` |
|        - |  2492 | ` * Throw an internal exception instance that can be intercepted by try/catch.` |
|        - |  2493 | ` */` |
|      146 |  2494 | `PH7_PRIVATE sxi32 PH7_VmThrowException(ph7_context *pCtx,const char *zClass,const char *zFormat,...)` |
|        2 |  2495 |  |
|        - |  2496 | `	ph7_vm *pVm;` |
...
|        - |  2506 | `	sxi32 rc;` |
|        - |  2507 |  |
|      148 |  2508 | `	if( pCtx == 0 \|\| pCtx->pVm == 0 ){` |
|      ! 0 |  2509 | `		return PH7_ABORT;` |
|        - |  2510 | `	}` |
|      148 |  2511 | `	pVm = pCtx->pVm;` |
|      148 |  2512 | `	if( zClass == 0 \|\| zClass[0] == 0 ){` |
|      ! 0 |  2513 | `		zClass = "Error";` |
|      ! 0 |  2514 | `	}` |
|      148 |  2515 | `	pClass = PH7_VmExtractClass(&(*pVm),zClass,SyStrlen(zClass),TRUE,0);` |
|      148 |  2516 | `	if( pClass == 0 ){` |
|      ! 0 |  2517 | `		return PH7_VmThrowExceptionTrace(pCtx,zClass,` |
|        - |  2518 | `			"Cannot throw internal exception, class '%s' is not available",` |
|      ! 0 |  2519 | `			zClass` |
|        - |  2520 | `			);` |
|        - |  2521 | `	}` |
|      148 |  2522 | `	pThis = PH7_NewClassInstance(&(*pVm),pClass);` |
|      148 |  2523 | `	if( pThis == 0 ){` |
...
|        - |  2527 | `	}` |
|        - |  2528 |  |
|      148 |  2529 | `	SyBlobInit(&sMsg,&pVm->sAllocator);` |
|      148 |  2530 | `	va_start(ap,zFormat);` |
|      148 |  2531 | `	SyBlobFormatAp(&sMsg,zFormat,ap);` |
|      148 |  2532 | `	va_end(ap);` |
|        - |  2533 |  |
|      148 |  2534 | `	pCons = PH7_ClassExtractMethod(pClass,"__construct",sizeof("__construct")-1);` |
|      148 |  2535 | `	if( pCons ){` |
|      148 |  2536 | `		SyStringInitFromBuf(&sMsgStr,(const char *)SyBlobData(&sMsg),SyBlobLength(&sMsg));` |
|      148 |  2537 | `		PH7_MemObjInitFromString(&(*pVm),&sArg,&sMsgStr);` |
|      148 |  2538 | `		apArg[0] = &sArg;` |
|      148 |  2539 | `		PH7_VmCallClassMethod(&(*pVm),pThis,pCons,0,1,apArg);` |
|      148 |  2540 | `		PH7_MemObjRelease(&sArg);` |
|       73 |  2541 | `	}` |
|      148 |  2542 | `	SyBlobRelease(&sMsg);` |
|        - |  2543 |  |
|      148 |  2544 | `	pFrame = pVm->pFrame;` |
|      148 |  2545 | `	if( pFrame ){` |
|      150 |  2546 | `		while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|        3 |  2547 | `			pFrame = pFrame->pParent;` |
|        1 |  2548 | `		}` |
|      148 |  2549 | `		pFrame->iFlags \|= VM_FRAME_THROW;` |
|       73 |  2550 | `	}` |
|      148 |  2551 | `	rc = VmThrowException(&(*pVm),pThis);` |
|      148 |  2552 | `	PH7_ClassInstanceUnref(pThis);` |
|      148 |  2553 | `	if( rc == SXERR_ABORT ){` |
|      145 |  2554 | `		return PH7_ABORT;` |
|        - |  2555 | `	}` |
...
|        - |  2609 | ` */` |
|    22042 |  2610 | `static sxi32 VmByteCodeExec(` |
...
|    22044 |  2626 | `	SySetInit(&aArg,&pVm->sAllocator,sizeof(ph7_value *));` |
|    22044 |  2627 | `	if( nTos < 0 ){` |
|    21202 |  2628 | `		pTos = &pStack[-1];` |
|    10602 |  2629 | `	}else{` |
|      844 |  2630 | `		pTos = &pStack[nTos];` |
|        - |  2631 | `	}` |
|    22044 |  2632 | `	pc = 0;` |
|        - |  2633 | `	/* Execute as much as we can */` |
|  3819683 |  2634 | `	for(;;){` |
|        - |  2635 | `		/* Fetch the instruction to execute */` |
|  7638664 |  2636 | `		pInstr = &aInstr[pc];` |
|  7638664 |  2637 | `		rc = SXRET_OK;` |
|        - |  2638 | `/*` |
...
|        - |  2644 | ` */` |
|  7638664 |  2645 | `		switch(pInstr->iOp){` |
|        - |  2646 | `/*` |
|        - |  2647 | ` * DONE: P1 * *` |
|        - |  2648 | ` *` |
...
|        - |  2651 | ` */` |
|    10941 |  2652 | `case PH7_OP_DONE:` |
|    21884 |  2653 | `	if( pInstr->iP1 ){` |
|        - |  2654 | `#ifdef UNTRUST` |
|        - |  2655 | `		if( pTos < pStack ){` |
|        - |  2656 | `			goto Abort;` |
|        - |  2657 | `		}` |
|        - |  2658 | `#endif` |
|    12086 |  2659 | `		if( pLastRef ){` |
|     8266 |  2660 | `			*pLastRef = pTos->nIdx;` |
|     4132 |  2661 | `		}` |
|    12086 |  2662 | `		if( pResult ){` |
|        - |  2663 | `			/* Execution result */` |
|    11654 |  2664 | `			PH7_MemObjStore(pTos,pResult);` |
|     5826 |  2665 | `		}` |
|    12086 |  2666 | `		VmPopOperand(&pTos,1);` |
|    15842 |  2667 | `	}else if( pLastRef ){` |
|        - |  2668 | `		/* Nothing referenced */` |
|      518 |  2669 | `		*pLastRef = SXU32_HIGH;` |
|      258 |  2670 | `	}` |
|    21884 |  2671 | `	goto Done;` |
|        - |  2672 | `/*` |
|        - |  2673 | ` * HALT: P1 * *` |
|        - |  2674 | ` *` |
...
|        - |  2718 | ` */` |
|   169767 |  2719 | `case PH7_OP_JMP:` |
|   339580 |  2720 | `	pc = pInstr->iP2 - 1;` |
|   339580 |  2721 | `	break;` |
|        - |  2722 | `/*` |
|        - |  2723 | ` * JZ: P1 P2 *` |
|        - |  2724 | ` *` |
...
|   770104 |  2735 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|       77 |  2736 | `		PH7_MemObjToBool(pTos);` |
|       38 |  2737 | `	}` |
|   770104 |  2738 | `	if( !pTos->x.iVal ){` |
|        - |  2739 | `		/* Take the jump */` |
|   368830 |  2740 | `		pc = pInstr->iP2 - 1;` |
|   184414 |  2741 | `	}` |
|   770104 |  2742 | `	if( !pInstr->iP1 ){` |
|   603434 |  2743 | `		VmPopOperand(&pTos,1);` |
|   301738 |  2744 | `	}` |
|   770104 |  2745 | `	break;` |
|        - |  2746 | `/*` |
|        - |  2747 | ` * JNZ: P1 P2 *` |
...
|    73440 |  2759 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      ! 0 |  2760 | `		PH7_MemObjToBool(pTos);` |
|      ! 0 |  2761 | `	}` |
|    73440 |  2762 | `	if( pTos->x.iVal ){` |
|        - |  2763 | `		/* Take the jump */` |
|     3340 |  2764 | `		pc = pInstr->iP2 - 1;` |
|     1669 |  2765 | `	}` |
|    73440 |  2766 | `	if( !pInstr->iP1 ){` |
...
|        - |  2782 | ` */` |
|   305313 |  2783 | `case PH7_OP_POP: {` |
|   610672 |  2784 | `	sxi32 n = pInstr->iP1;` |
|   610672 |  2785 | `	if( &pTos[-n+1] < pStack ){` |
|        - |  2786 | `		/* TICKET 1433-51 Stack underflow must be handled at run-time */` |
|      ! 0 |  2787 | `		n = (sxi32)(pTos - pStack);` |
|      ! 0 |  2788 | `	}` |
|   610672 |  2789 | `	VmPopOperand(&pTos,n);` |
|   610672 |  2790 | `	break;` |
|        - |  2791 | `				 }` |
|        - |  2792 | `/*` |
|        - |  2793 | ` * CVT_INT: * * *` |
...
|        - |  2922 | ` */` |
|     9735 |  2923 | `case PH7_OP_ERR_CTRL:` |
|        - |  2924 | `	/*` |
...
|        - |  2976 | ` */` |
|   653405 |  2977 | `case PH7_OP_LOADC: {` |
|        - |  2978 | `	ph7_value *pObj;` |
|        - |  2979 | `	/* Reserve a room */` |
|  1306856 |  2980 | `	pTos++;` |
|  1306856 |  2981 | `	if( (pObj = (ph7_value *)SySetAt(&pVm->aLitObj,pInstr->iP2)) != 0 ){` |
|  1306856 |  2982 | `		if( pInstr->iP1 == 1 && SyBlobLength(&pObj->sBlob) <= 64 ){` |
|        - |  2983 | `			SyHashEntry *pEntry;` |
|        - |  2984 | `			/* Candidate for expansion via user defined callbacks */` |
|    13726 |  2985 | `			pEntry = SyHashGet(&pVm->hConstant,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|    13726 |  2986 | `			if( pEntry ){` |
|    11934 |  2987 | `				ph7_constant *pCons = (ph7_constant *)pEntry->pUserData;` |
|        - |  2988 | `				/* Set a NULL default value */` |
|    11934 |  2989 | `				MemObjSetType(pTos,MEMOBJ_NULL);` |
|    11934 |  2990 | `				SyBlobReset(&pTos->sBlob);` |
|        - |  2991 | `				/* Invoke the callback and deal with the expanded value */` |
|    11934 |  2992 | `				pCons->xExpand(pTos,pCons->pUserData);` |
|        - |  2993 | `				/* Mark as constant */` |
|    11934 |  2994 | `				pTos->nIdx = SXU32_HIGH;` |
|    11934 |  2995 | `				break;` |
|        - |  2996 | `			}` |
|      896 |  2997 | `		}` |
|  1294924 |  2998 | `		PH7_MemObjLoad(pObj,pTos);` |
|   647485 |  2999 | `	}else{` |
|        - |  3000 | `		/* Set a NULL value */` |
|      ! 0 |  3001 | `		MemObjSetType(pTos,MEMOBJ_NULL);` |
|        - |  3002 | `	}` |
|        - |  3003 | `	/* Mark as constant */` |
|  1294924 |  3004 | `	pTos->nIdx = SXU32_HIGH;` |
|  1294924 |  3005 | `	break;` |
|        - |  3006 | `				  }` |
|        - |  3007 | `/*` |
|        - |  3008 | ` * LOAD: P1 * P3` |
...
|        - |  3014 | ` */` |
|  1023924 |  3015 | `case PH7_OP_LOAD:{` |
|        - |  3016 | `	ph7_value *pObj;` |
|        - |  3017 | `	SyString sName;` |
|  2048070 |  3018 | `	if( pInstr->p3 == 0 ){` |
...
|       10 |  3030 | `	}else{` |
|  2048052 |  3031 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - |  3032 | `		/* Reserve a room for the target object */` |
|  2048052 |  3033 | `		pTos++;` |
|        - |  3034 | `	}` |
|        - |  3035 | `	/* Extract the requested memory object */` |
|  2048070 |  3036 | `	pObj = VmExtractMemObj(&(*pVm),&sName,pInstr->p3 ? FALSE : TRUE,pInstr->iP1 != 1);` |
|  2048070 |  3037 | `	if( pObj == 0 ){` |
...
|  2047594 |  3054 | `	PH7_MemObjLoad(pObj,pTos);` |
|  2047594 |  3055 | `	pTos->nIdx = pObj->nIdx;` |
|  2047594 |  3056 | `	break;` |
|        - |  3057 | `				   }` |
|        - |  3058 | `/*` |
|        - |  3059 | ` * LOAD_MAP P1 * *` |
...
|        - |  3064 | ` */` |
|    14068 |  3065 | `case PH7_OP_LOAD_MAP: {` |
|        - |  3066 | `	ph7_hashmap *pMap;` |
|        - |  3067 | `	/* Allocate a new hashmap instance */` |
|    28138 |  3068 | `	pMap = PH7_NewHashmap(&(*pVm),0,0);` |
|    28138 |  3069 | `	if( pMap == 0 ){` |
...
|      ! 0 |  3072 | `		goto Abort;` |
|        - |  3073 | `	}` |
|    28138 |  3074 | `	if( pInstr->iP1 > 0 ){` |
|     1550 |  3075 | `		ph7_value *pEntry = &pTos[-pInstr->iP1+1]; /* Point to the first entry */` |
|        - |  3076 | `		/* Perform the insertion */` |
|     4452 |  3077 | `		while( pEntry < pTos ){` |
|     2904 |  3078 | `			if( pEntry[1].iFlags & MEMOBJ_REFERENCE ){` |
...
|     4214 |  3086 | `				PH7_HashmapInsert(pMap,` |
|     2808 |  3087 | `					(pEntry->iFlags & MEMOBJ_NULL) ? 0 /* Automatic index assign */ : pEntry,` |
|     1404 |  3088 | `					&pEntry[1]` |
|        - |  3089 | `				);` |
|        - |  3090 | `			}` |
...
|     1550 |  3095 | `		VmPopOperand(&pTos,pInstr->iP1);` |
|      774 |  3096 | `	}` |
|        - |  3097 | `	/* Push the hashmap */` |
|    28138 |  3098 | `	pTos++;` |
|    28138 |  3099 | `	pTos->nIdx = SXU32_HIGH;` |
|    28138 |  3100 | `	pTos->x.pOther = pMap;` |
|    28138 |  3101 | `	MemObjSetType(pTos,MEMOBJ_HASHMAP);` |
|    28138 |  3102 | `	break;` |
|        - |  3103 | `					  }` |
|        - |  3104 | `/*` |
|        - |  3105 | ` * LOAD_LIST: P1 * *` |
...
|        - |  3156 | ` * instead.` |
|        - |  3157 | ` */` |
|   156368 |  3158 | `case PH7_OP_LOAD_IDX: {` |
|   312782 |  3159 | `	ph7_hashmap_node *pNode = 0; /* cc warning */` |
|   312782 |  3160 | `	ph7_hashmap *pMap = 0;` |
|        - |  3161 | `	ph7_value *pIdx;` |
|   312782 |  3162 | `	pIdx = 0;` |
|   312782 |  3163 | `	if( pInstr->iP1 == 0 ){` |
...
|        - |  3178 | `		}` |
|      ! 0 |  3179 | `	}else{` |
|   312782 |  3180 | `		pIdx = pTos;` |
|   312782 |  3181 | `		pTos--;` |
|        - |  3182 | `	}` |
|   312782 |  3183 | `	if( pTos->iFlags & MEMOBJ_STRING ){` |
|        - |  3184 | `		/* String access */` |
|   242944 |  3185 | `		if( pIdx ){` |
|        - |  3186 | `			sxu32 nOfft;` |
|   242944 |  3187 | `			if( (pIdx->iFlags & MEMOBJ_INT) == 0 ){` |
|        - |  3188 | `				/* Force an int cast */` |
|      ! 0 |  3189 | `				PH7_MemObjToInteger(pIdx);` |
|      ! 0 |  3190 | `			}` |
|   242944 |  3191 | `			nOfft = (sxu32)pIdx->x.iVal;` |
|   242944 |  3192 | `			if( nOfft >= SyBlobLength(&pTos->sBlob) ){` |
|        - |  3193 | `				/* Invalid offset,load null */` |
|      ! 0 |  3194 | `				PH7_MemObjRelease(pTos);` |
|      ! 0 |  3195 | `			}else{` |
|   242944 |  3196 | `				const char *zData = (const char *)SyBlobData(&pTos->sBlob);` |
|   242944 |  3197 | `				int c = zData[nOfft];` |
|   242944 |  3198 | `				PH7_MemObjRelease(pTos);` |
|   242944 |  3199 | `				MemObjSetType(pTos,MEMOBJ_STRING);` |
|   242944 |  3200 | `				SyBlobAppend(&pTos->sBlob,(const void *)&c,sizeof(char));` |
|        - |  3201 | `			}` |
|   121495 |  3202 | `		}else{` |
...
|   242944 |  3206 | `		break;` |
|        - |  3207 | `	}` |
|    69840 |  3208 | `	if( pInstr->iP2 && (pTos->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
...
|      ! 0 |  3215 | `		}` |
|      ! 0 |  3216 | `	}` |
|    69840 |  3217 | `	rc = SXERR_NOTFOUND; /* Assume the index is invalid */` |
|    69840 |  3218 | `	if( pTos->iFlags & MEMOBJ_HASHMAP ){` |
|        - |  3219 | `		/* Point to the hashmap */` |
|    69840 |  3220 | `		pMap = (ph7_hashmap *)pTos->x.pOther;` |
|    69840 |  3221 | `		if( pIdx ){` |
|        - |  3222 | `			/* Load the desired entry */` |
|    69840 |  3223 | `			rc = PH7_HashmapLookup(pMap,pIdx,&pNode);` |
|    34919 |  3224 | `		}` |
|    69840 |  3225 | `		if( rc != SXRET_OK && pInstr->iP2 ){` |
...
|    34919 |  3233 | `	}` |
|    69840 |  3234 | `	if( pIdx ){` |
|    69840 |  3235 | `		PH7_MemObjRelease(pIdx);` |
|    34919 |  3236 | `	}` |
|    69840 |  3237 | `	if( rc == SXRET_OK ){` |
|        - |  3238 | `		/* Load entry contents */` |
|    33234 |  3239 | `		if( pMap->iRef < 2 ){` |
...
|        4 |  3245 | `		}else{` |
|    33228 |  3246 | `			pTos->nIdx = pNode->nValIdx;` |
|    33228 |  3247 | `			PH7_HashmapExtractNodeValue(pNode,pTos,FALSE);` |
|    33228 |  3248 | `			PH7_HashmapUnref(pMap);` |
|        - |  3249 | `		}` |
|    16618 |  3250 | `	}else{` |
|        - |  3251 | `		/* No such entry,load NULL */` |
|    36608 |  3252 | `		PH7_MemObjRelease(pTos);` |
|    36608 |  3253 | `		pTos->nIdx = SXU32_HIGH;` |
|        - |  3254 | `	}` |
|    69840 |  3255 | `	break;` |
|        - |  3256 | `					  }` |
|        - |  3257 | `/*` |
...
|        - |  3337 | `	}` |
|        - |  3338 | `#endif` |
|   170486 |  3339 | `	if( pInstr->iP2 ){` |
|        - |  3340 | `		sxu32 nIdx;` |
|        - |  3341 | `		/* Member store operation */` |
|     1198 |  3342 | `		nIdx = pTos->nIdx;` |
|     1198 |  3343 | `		VmPopOperand(&pTos,1);` |
|     1198 |  3344 | `		if( nIdx == SXU32_HIGH ){` |
...
|     1194 |  3350 | `			pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|     1194 |  3351 | `			if( pObj ){` |
|        - |  3352 | `				/* Perform the store operation */` |
|     1194 |  3353 | `				PH7_MemObjStore(pTos,pObj);` |
|      596 |  3354 | `			}` |
|        - |  3355 | `		}` |
|    85842 |  3356 | `		break;` |
|   169290 |  3357 | `	}else if( pInstr->p3 == 0 ){` |
...
|        - |  3392 | ` */` |
|    70484 |  3393 | `case PH7_OP_STORE_IDX:` |
|        - |  3394 | `case PH7_OP_STORE_IDX_REF: {` |
|   140970 |  3395 | `	ph7_hashmap *pMap = 0; /* cc  warning */` |
|        - |  3396 | `	ph7_value *pKey;` |
|        - |  3397 | `	sxu32 nIdx;` |
|   140970 |  3398 | `	if( pInstr->iP1 ){` |
|        - |  3399 | `		/* Key is next on stack */` |
|    51972 |  3400 | `		pKey = pTos;` |
|    51972 |  3401 | `		pTos--;` |
|    25987 |  3402 | `	}else{` |
|    89000 |  3403 | `		pKey = 0;` |
|        - |  3404 | `	}` |
|   140970 |  3405 | `	nIdx = pTos->nIdx;` |
|   140970 |  3406 | `	if( pTos->iFlags & MEMOBJ_HASHMAP ){` |
|        - |  3407 | `		/* Hashmap already loaded */` |
|   140918 |  3408 | `		pMap = (ph7_hashmap *)pTos->x.pOther;` |
|   140918 |  3409 | `		if( pMap->iRef < 2 ){` |
...
|        - |  3466 | `	}` |
|   140918 |  3467 | `	VmPopOperand(&pTos,1);` |
|        - |  3468 | `	/* Phase#2: Perform the insertion */` |
|   140918 |  3469 | `	if( pInstr->iOp == PH7_OP_STORE_IDX_REF && pTos->nIdx != SXU32_HIGH ){` |
|        - |  3470 | `		/* Insertion by reference */` |
|       13 |  3471 | `		PH7_HashmapInsertByRef(pMap,pKey,pTos->nIdx);` |
|        7 |  3472 | `	}else{` |
|   140906 |  3473 | `		PH7_HashmapInsert(pMap,pKey,pTos);` |
|        - |  3474 | `	}` |
|   140918 |  3475 | `	if( pKey ){` |
|    51922 |  3476 | `		PH7_MemObjRelease(pKey);` |
|    25960 |  3477 | `	}` |
|   140918 |  3478 | `	break;` |
|        - |  3479 | `					   }` |
|        - |  3480 | `/*` |
...
|        - |  3486 | ` */` |
|   117777 |  3487 | `case PH7_OP_INCR:` |
|        - |  3488 | `#ifdef UNTRUST` |
|        - |  3489 | `	if( pTos < pStack ){` |
|        - |  3490 | `		goto Abort;` |
|        - |  3491 | `	}` |
|        - |  3492 | `#endif` |
|   235600 |  3493 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) == 0 ){` |
|   235600 |  3494 | `		if( pTos->nIdx != SXU32_HIGH ){` |
|        - |  3495 | `			ph7_value *pObj;` |
|   235600 |  3496 | `			if( (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pTos->nIdx)) != 0 ){` |
|        - |  3497 | `				/* Force a numeric cast */` |
|   235600 |  3498 | `				PH7_MemObjToNumeric(pObj);` |
|   235600 |  3499 | `				if( pObj->iFlags & MEMOBJ_REAL ){` |
|      ! 0 |  3500 | `					pObj->rVal++;` |
|        - |  3501 | `					/* Try to get an integer representation */` |
|      ! 0 |  3502 | `					PH7_MemObjTryInteger(pTos);` |
|      ! 0 |  3503 | `				}else{` |
|   235600 |  3504 | `					pObj->x.iVal++;` |
|   235600 |  3505 | `					MemObjSetType(pTos,MEMOBJ_INT);` |
|        - |  3506 | `				}` |
|   235600 |  3507 | `				if( pInstr->iP1 ){` |
|        - |  3508 | `					/* Pre-icrement */` |
...
|    36594 |  3590 | `	PH7_MemObjToNumeric(pTos);` |
|    36594 |  3591 | `	if( pTos->iFlags & MEMOBJ_REAL ){` |
|       25 |  3592 | `		pTos->rVal = -pTos->rVal;` |
|       12 |  3593 | `	}` |
|    36594 |  3594 | `	if( pTos->iFlags & MEMOBJ_INT ){` |
|    36570 |  3595 | `		pTos->x.iVal = -pTos->x.iVal;` |
|    18284 |  3596 | `	}` |
|    36594 |  3597 | `	break;` |
|        - |  3598 | `/*` |
|        - |  3599 | ` * UPLUS: * * *` |
...
|    69292 |  3631 | `	if( (pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|       21 |  3632 | `		PH7_MemObjToBool(pTos);` |
|       10 |  3633 | `	}` |
|    69292 |  3634 | `	pTos->x.iVal = !pTos->x.iVal;` |
|    69292 |  3635 | `	break;` |
|        - |  3636 | `/*` |
|        - |  3637 | ` * OP_BITNOT: * * *` |
|        - |  3638 | ` *` |
...
|        - |  4236 | ` * back.` |
|        - |  4237 | ` */` |
|    52548 |  4238 | `case PH7_OP_CAT:{` |
|        - |  4239 | `	ph7_value *pNos,*pCur;` |
|   105098 |  4240 | `	if( pInstr->iP1 < 1 ){` |
|    78446 |  4241 | `		pNos = &pTos[-1];` |
|    39224 |  4242 | `	}else{` |
...
|   105098 |  4251 | `	if( (pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|      572 |  4252 | `		PH7_MemObjToString(pNos);` |
|      285 |  4253 | `	}` |
|   105098 |  4254 | `	pCur = &pNos[1];` |
|   211442 |  4255 | `	while( pCur <= pTos ){` |
|   106346 |  4256 | `		if( (pCur->iFlags & MEMOBJ_STRING) == 0 ){` |
|    50202 |  4257 | `			PH7_MemObjToString(pCur);` |
|    25100 |  4258 | `		}` |
|        - |  4259 | `		/* Perform the concatenation */` |
|   106346 |  4260 | `		if( SyBlobLength(&pCur->sBlob) > 0 ){` |
|   106308 |  4261 | `			PH7_MemObjStringAppend(pNos,(const char *)SyBlobData(&pCur->sBlob),SyBlobLength(&pCur->sBlob));` |
|    53153 |  4262 | `		}` |
|   106346 |  4263 | `		SyBlobRelease(&pCur->sBlob);` |
|   106346 |  4264 | `		pCur++;` |
|        2 |  4265 | `	}` |
|   105098 |  4266 | `	pTos = pNos;` |
|   105098 |  4267 | `	break;` |
|        - |  4268 | `				}` |
|        - |  4269 | `/*  CAT_STORE: * * *` |
|        - |  4270 | ` *` |
...
|        - |  4272 | ` * back.` |
|        - |  4273 | ` */` |
|     1675 |  4274 | `case PH7_OP_CAT_STORE:{` |
|     3351 |  4275 | `	ph7_value *pNos = &pTos[-1];` |
|        - |  4276 | `	ph7_value *pObj;` |
|        - |  4277 | `#ifdef UNTRUST` |
|        - |  4278 | `	if( pNos < pStack ){` |
|        - |  4279 | `		goto Abort;` |
|        - |  4280 | `	}` |
|        - |  4281 | `#endif` |
|     3351 |  4282 | `	if((pTos->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - |  4283 | `		/* Force a string cast */` |
|      ! 0 |  4284 | `		PH7_MemObjToString(pTos);` |
|      ! 0 |  4285 | `	}` |
|     3351 |  4286 | `	if((pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - |  4287 | `		/* Force a string cast */` |
|      ! 0 |  4288 | `		PH7_MemObjToString(pNos);` |
|      ! 0 |  4289 | `	}` |
|        - |  4290 | `	/* Perform the concatenation (Reverse order) */` |
|     3351 |  4291 | `	if( SyBlobLength(&pNos->sBlob) > 0 ){` |
|     3351 |  4292 | `		PH7_MemObjStringAppend(pTos,(const char *)SyBlobData(&pNos->sBlob),SyBlobLength(&pNos->sBlob));` |
|     1675 |  4293 | `	}` |
|        - |  4294 | `	/* Perform the store operation */` |
|     3351 |  4295 | `	if( pTos->nIdx == SXU32_HIGH ){` |
|      ! 0 |  4296 | `		PH7_VmThrowError(&(*pVm),0,PH7_CTX_ERR,"Cannot perform assignment on a constant class attribute");` |
|     3351 |  4297 | `	}else if( (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pTos->nIdx)) != 0 ){` |
|     3351 |  4298 | `		PH7_MemObjStore(pTos,pObj);` |
|     1675 |  4299 | `	}` |
|     3351 |  4300 | `	PH7_MemObjStore(pTos,pNos);` |
|     3351 |  4301 | `	VmPopOperand(&pTos,1);` |
|     3351 |  4302 | `	break;` |
|        - |  4303 | `				}` |
|        - |  4304 | `/* OP_AND: * * *` |
|        - |  4305 | ` *` |
...
|        - |  4314 | ` * stack.` |
|        - |  4315 | ` */` |
|    72736 |  4316 | `case PH7_OP_LAND:` |
|        - |  4317 | `case PH7_OP_LOR: {` |
|   145518 |  4318 | `	ph7_value *pNos = &pTos[-1];` |
...
|   145518 |  4326 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|        3 |  4327 | `		PH7_MemObjToBool(pTos);` |
|        1 |  4328 | `	}` |
|   145518 |  4329 | `	if((pNos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      ! 0 |  4330 | `		PH7_MemObjToBool(pNos);` |
|      ! 0 |  4331 | `	}` |
|   145518 |  4332 | `	v1 = pNos->x.iVal == 0 ? 1 : 0;` |
|   145518 |  4333 | `	v2 = pTos->x.iVal == 0 ? 1 : 0;` |
|   145518 |  4334 | `	if( pInstr->iOp == PH7_OP_LAND ){` |
|        - |  4335 | `		static const unsigned char and_logic[] = { 0, 1, 2, 1, 1, 1, 2, 1, 2 };` |
|    75418 |  4336 | `		v1 = and_logic[v1*3+v2];` |
|    37732 |  4337 | `	}else{` |
|        - |  4338 | `		static const unsigned char or_logic[] = { 0, 0, 0, 0, 1, 2, 0, 2, 2 };` |
|    70102 |  4339 | `		v1 = or_logic[v1*3+v2];` |
|        - |  4340 | `	}` |
|   145518 |  4341 | `	if( v1 == 2 ){` |
|      ! 0 |  4342 | `		v1 = 1;` |
|      ! 0 |  4343 | `	}` |
|   145518 |  4344 | `	VmPopOperand(&pTos,1);` |
|   145518 |  4345 | `	pTos->x.iVal = v1 == 0 ? 1 : 0;` |
|   145518 |  4346 | `	MemObjSetType(pTos,MEMOBJ_BOOL);` |
|   145518 |  4347 | `	break;` |
|        - |  4348 | `				 }` |
|        - |  4349 | `/* OP_LXOR: * * *` |
|        - |  4350 | ` *` |
...
|        - |  4394 | ` */` |
|     3219 |  4395 | `case PH7_OP_EQ:` |
|        - |  4396 | `case PH7_OP_NEQ: {` |
|     6440 |  4397 | `	ph7_value *pNos = &pTos[-1];` |
...
|        - |  4402 | `	}` |
|        - |  4403 | `#endif` |
|     6440 |  4404 | `	rc = PH7_MemObjCmp(pNos,pTos,FALSE,0);` |
|     6440 |  4405 | `	if( VmIsUnorderedCmp(pNos,pTos) ){` |
|       11 |  4406 | `		rc = pInstr->iOp == PH7_OP_EQ ? 0 : 1;` |
|     6435 |  4407 | `	}else if( pInstr->iOp == PH7_OP_EQ ){` |
|     6404 |  4408 | `		rc = rc == 0;` |
|     3203 |  4409 | `	}else{` |
|       28 |  4410 | `		rc = rc != 0;` |
|        - |  4411 | `	}` |
|     6440 |  4412 | `	VmPopOperand(&pTos,1);` |
|     6440 |  4413 | `	if( !pInstr->iP2 ){` |
|        - |  4414 | `		/* Push comparison result without taking the jump */` |
|     6440 |  4415 | `		PH7_MemObjRelease(pTos);` |
|     6440 |  4416 | `		pTos->x.iVal = rc;` |
|        - |  4417 | `		/* Invalidate any prior representation */` |
|     6440 |  4418 | `		MemObjSetType(pTos,MEMOBJ_BOOL);` |
|     3221 |  4419 | `	}else{` |
|      ! 0 |  4420 | `		if( rc ){` |
...
|        - |  4434 | ` */` |
|    96232 |  4435 | `case PH7_OP_TEQ: {` |
|   192466 |  4436 | `	ph7_value *pNos = &pTos[-1];` |
...
|        - |  4441 | `	}` |
|        - |  4442 | `#endif` |
|   192466 |  4443 | `	rc = PH7_MemObjCmp(pNos,pTos,TRUE,0);` |
|   192466 |  4444 | `	if( VmIsUnorderedCmp(pNos,pTos) ){` |
|        3 |  4445 | `		rc = 0;` |
|        2 |  4446 | `	}else{` |
|   192464 |  4447 | `		rc = rc == 0;` |
|        - |  4448 | `	}` |
|   192466 |  4449 | `	VmPopOperand(&pTos,1);` |
|   192466 |  4450 | `	if( !pInstr->iP2 ){` |
|        - |  4451 | `		/* Push comparison result without taking the jump */` |
|   192466 |  4452 | `		PH7_MemObjRelease(pTos);` |
|   192466 |  4453 | `		pTos->x.iVal = rc;` |
|        - |  4454 | `		/* Invalidate any prior representation */` |
|   192466 |  4455 | `		MemObjSetType(pTos,MEMOBJ_BOOL);` |
|    96234 |  4456 | `	}else{` |
|      ! 0 |  4457 | `		if( rc ){` |
...
|        - |  4472 | ` *` |
|        - |  4473 | ` */` |
|    76177 |  4474 | `case PH7_OP_TNE: {` |
|   152356 |  4475 | `	ph7_value *pNos = &pTos[-1];` |
...
|        - |  4480 | `	}` |
|        - |  4481 | `#endif` |
|   152356 |  4482 | `	rc = PH7_MemObjCmp(pNos,pTos,TRUE,0);` |
|   152356 |  4483 | `	if( VmIsUnorderedCmp(pNos,pTos) ){` |
|        3 |  4484 | `		rc = 1;` |
|        2 |  4485 | `	}else{` |
|   152354 |  4486 | `		rc = rc != 0;` |
|        - |  4487 | `	}` |
|   152356 |  4488 | `	VmPopOperand(&pTos,1);` |
|   152356 |  4489 | `	if( !pInstr->iP2 ){` |
|        - |  4490 | `		/* Push comparison result without taking the jump */` |
|   152356 |  4491 | `		PH7_MemObjRelease(pTos);` |
|   152356 |  4492 | `		pTos->x.iVal = rc;` |
|        - |  4493 | `		/* Invalidate any prior representation */` |
|   152356 |  4494 | `		MemObjSetType(pTos,MEMOBJ_BOOL);` |
|    76179 |  4495 | `	}else{` |
|      ! 0 |  4496 | `		if( rc ){` |
...
|        - |  4520 | ` *` |
|        - |  4521 | ` */` |
|    84835 |  4522 | `case PH7_OP_LT:` |
|        - |  4523 | `case PH7_OP_LE: {` |
|   169716 |  4524 | `	ph7_value *pNos = &pTos[-1];` |
...
|        - |  4529 | `	}` |
|        - |  4530 | `#endif` |
|   169716 |  4531 | `	rc = PH7_MemObjCmp(pNos,pTos,FALSE,0);` |
|   169716 |  4532 | `	if( VmIsUnorderedCmp(pNos,pTos) ){` |
|        9 |  4533 | `		rc = 0;` |
|   169712 |  4534 | `	}else if( pInstr->iOp == PH7_OP_LE ){` |
|      395 |  4535 | `		rc = rc < 1;` |
|      198 |  4536 | `	}else{` |
|   169314 |  4537 | `		rc = rc < 0;` |
|        - |  4538 | `	}` |
|   169716 |  4539 | `	VmPopOperand(&pTos,1);` |
|   169716 |  4540 | `	if( !pInstr->iP2 ){` |
|        - |  4541 | `		/* Push comparison result without taking the jump */` |
|   169716 |  4542 | `		PH7_MemObjRelease(pTos);` |
|   169716 |  4543 | `		pTos->x.iVal = rc;` |
|        - |  4544 | `		/* Invalidate any prior representation */` |
|   169716 |  4545 | `		MemObjSetType(pTos,MEMOBJ_BOOL);` |
|    84881 |  4546 | `	}else{` |
|      ! 0 |  4547 | `		if( rc ){` |
...
|        - |  4571 | ` *` |
|        - |  4572 | ` */` |
|    32790 |  4573 | `case PH7_OP_GT:` |
|        - |  4574 | `case PH7_OP_GE: {` |
|    65582 |  4575 | `	ph7_value *pNos = &pTos[-1];` |
...
|        - |  4580 | `	}` |
|        - |  4581 | `#endif` |
|    65582 |  4582 | `	rc = PH7_MemObjCmp(pNos,pTos,FALSE,0);` |
|    65582 |  4583 | `	if( VmIsUnorderedCmp(pNos,pTos) ){` |
|        9 |  4584 | `		rc = 0;` |
|    65578 |  4585 | `	}else if( pInstr->iOp == PH7_OP_GE ){` |
|    65426 |  4586 | `		rc = rc >= 0;` |
|    32714 |  4587 | `	}else{` |
|      150 |  4588 | `		rc = rc > 0;` |
|        - |  4589 | `	}` |
|    65582 |  4590 | `	VmPopOperand(&pTos,1);` |
|    65582 |  4591 | `	if( !pInstr->iP2 ){` |
|        - |  4592 | `		/* Push comparison result without taking the jump */` |
|    65582 |  4593 | `		PH7_MemObjRelease(pTos);` |
|    65582 |  4594 | `		pTos->x.iVal = rc;` |
|        - |  4595 | `		/* Invalidate any prior representation */` |
|    65582 |  4596 | `		MemObjSetType(pTos,MEMOBJ_BOOL);` |
|    32792 |  4597 | `	}else{` |
|      ! 0 |  4598 | `		if( rc ){` |
...
|        - |  4895 | ` */` |
|     3734 |  4896 | `case PH7_OP_FOREACH_INIT: {` |
|     7470 |  4897 | `	ph7_foreach_info *pInfo = (ph7_foreach_info *)pInstr->p3;` |
|        - |  4898 | `	void *pName;` |
|        - |  4899 | `#ifdef UNTRUST` |
|        - |  4900 | `	if( pTos < pStack ){` |
|        - |  4901 | `		goto Abort;` |
|        - |  4902 | `	}` |
|        - |  4903 | `#endif` |
|     7470 |  4904 | `	if( SyStringLength(&pInfo->sValue) < 1 ){` |
...
|      ! 0 |  4916 | `	}` |
|     7470 |  4917 | `	if( (pInfo->iFlags & PH7_4EACH_STEP_KEY) && SyStringLength(&pInfo->sKey) < 1 ){` |
...
|     7470 |  4930 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ)) == 0 \|\| SyStringLength(&pInfo->sValue) < 1 ){` |
...
|     7470 |  4938 | `		pStep = (ph7_foreach_step *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_foreach_step));` |
|     7470 |  4939 | `		if( pStep == 0 ){` |
...
|     7470 |  4945 | `			SyZero(pStep,sizeof(ph7_foreach_step));` |
|        - |  4946 | `			/* Prepare the step */` |
|     7470 |  4947 | `			pStep->iFlags = pInfo->iFlags;` |
|     7470 |  4948 | `			if( pTos->iFlags & MEMOBJ_HASHMAP ){` |
|     7462 |  4949 | `				ph7_hashmap *pMap = (ph7_hashmap *)pTos->x.pOther;` |
|        - |  4950 | `				/* Reset the internal loop cursor */` |
|     7462 |  4951 | `				PH7_HashmapResetLoopCursor(pMap);` |
|        - |  4952 | `				/* Mark the step */` |
|     7462 |  4953 | `				pStep->iFlags \|= PH7_4EACH_STEP_HASHMAP;` |
|     7462 |  4954 | `				pStep->xIter.pMap = pMap;` |
|     7462 |  4955 | `				pMap->iRef++;` |
|     3732 |  4956 | `			}else{` |
...
|        - |  4964 | `			}` |
|        - |  4965 | `		}` |
|     7470 |  4966 | `		if( SXRET_OK != SySetPut(&pInfo->aStep,(const void *)&pStep) ){` |
...
|        - |  4979 | ` */` |
|    62119 |  4980 | `case PH7_OP_FOREACH_STEP: {` |
|   124240 |  4981 | `	ph7_foreach_info *pInfo = (ph7_foreach_info *)pInstr->p3;` |
|        - |  4982 | `	ph7_foreach_step **apStep,*pStep;` |
|        - |  4983 | `	ph7_value *pValue;` |
|        - |  4984 | `	VmFrame *pFrameLocal;` |
|        - |  4985 | `	/* Peek the last step */` |
|   124240 |  4986 | `	apStep = (ph7_foreach_step **)SySetBasePtr(&pInfo->aStep);` |
|   124240 |  4987 | `	pStep = apStep[SySetUsed(&pInfo->aStep) - 1];` |
|   124240 |  4988 | `	pFrameLocal = pVm->pFrame;` |
|   129272 |  4989 | `	while( pFrameLocal->pParent && (pFrameLocal->iFlags & VM_FRAME_EXCEPTION) ){` |
|        - |  4990 | `		/* Safely ignore the exception frame */` |
|     5033 |  4991 | `		pFrameLocal = pFrameLocal->pParent;` |
|        1 |  4992 | `	}` |
|   124240 |  4993 | `	if( pStep->iFlags & PH7_4EACH_STEP_HASHMAP ){` |
|   124216 |  4994 | `		ph7_hashmap *pMap = pStep->xIter.pMap;` |
|        - |  4995 | `		ph7_hashmap_node *pNode;` |
|        - |  4996 | `		/* Extract the current node value */` |
|   124216 |  4997 | `		pNode = PH7_HashmapGetNextEntry(pMap);` |
|   124216 |  4998 | `		if( pNode == 0 ){` |
|        - |  4999 | `			/* No more entry to process */` |
|     7462 |  5000 | `			pc = pInstr->iP2 - 1; /* Jump to this destination */` |
|     7462 |  5001 | `			if( pStep->iFlags & PH7_4EACH_STEP_REF ){` |
...
|     7462 |  5006 | `			PH7_HashmapResetLoopCursor(pMap);` |
|        - |  5007 | `			/* Cleanup the mess left behind */` |
|     7462 |  5008 | `			SyMemBackendPoolFree(&pVm->sAllocator,pStep);` |
|     7462 |  5009 | `			SySetPop(&pInfo->aStep);` |
|     7462 |  5010 | `			PH7_HashmapUnref(pMap);` |
|     3732 |  5011 | `		}else{` |
|   116756 |  5012 | `			if( (pStep->iFlags & PH7_4EACH_STEP_KEY) && SyStringLength(&pInfo->sKey) > 0 ){` |
|      139 |  5013 | `				ph7_value *pKey = VmExtractMemObj(&(*pVm),&pInfo->sKey,FALSE,TRUE);` |
|      139 |  5014 | `				if( pKey ){` |
|      139 |  5015 | `					PH7_HashmapExtractNodeKey(pNode,pKey);` |
|       69 |  5016 | `				}` |
|       69 |  5017 | `			}` |
|   116756 |  5018 | `			if( pStep->iFlags & PH7_4EACH_STEP_REF ){` |
...
|   116744 |  5030 | `				pValue = VmExtractMemObj(&(*pVm),&pInfo->sValue,FALSE,TRUE);` |
|   116744 |  5031 | `				if( pValue ){` |
|   116744 |  5032 | `					PH7_HashmapExtractNodeValue(pNode,pValue,TRUE);` |
|    58371 |  5033 | `				}` |
|        - |  5034 | `			}` |
|        - |  5035 | `		}` |
|    62109 |  5036 | `	}else{` |
...
|        - |  5098 | ` */` |
|      852 |  5099 | `case PH7_OP_MEMBER: {` |
|        - |  5100 | `	ph7_class_instance *pThis;` |
|        - |  5101 | `	ph7_value *pNos;` |
|        - |  5102 | `	SyString sName;` |
|     1706 |  5103 | `	if( !pInstr->iP1 ){` |
|     1648 |  5104 | `		pNos = &pTos[-1];` |
|        - |  5105 | `#ifdef UNTRUST` |
|        - |  5106 | `		if( pNos < pStack ){` |
|        - |  5107 | `			goto Abort;` |
|        - |  5108 | `		}` |
|        - |  5109 | `#endif` |
|     1648 |  5110 | `		if( pNos->iFlags & MEMOBJ_OBJ ){` |
|        - |  5111 | `			ph7_class *pClass;` |
|        - |  5112 | `			/* Class already instantiated */` |
|     1648 |  5113 | `			pThis = (ph7_class_instance *)pNos->x.pOther;` |
|        - |  5114 | `			/* Point to the instantiated class */` |
|     1648 |  5115 | `			pClass = pThis->pClass;` |
|        - |  5116 | `			/* Extract attribute name first */` |
|     1648 |  5117 | `			SyStringInitFromBuf(&sName,(const char *)SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
|     1648 |  5118 | `			if( pInstr->iP2 ){` |
|        - |  5119 | `				/* Method call */` |
...
|     1530 |  5143 | `				VmClassAttr *pObjAttr = 0;` |
|        - |  5144 | `				SyHashEntry *pEntry;` |
|        - |  5145 | `				/* Extract the target attribute */` |
|     1530 |  5146 | `				if( sName.nByte > 0 ){` |
|     1530 |  5147 | `					pEntry = SyHashGet(&pThis->hAttr,(const void *)sName.zString,sName.nByte);` |
|     1530 |  5148 | `					if( pEntry ){` |
|        - |  5149 | `						/* Point to the attribute value */` |
|     1528 |  5150 | `						pObjAttr = (VmClassAttr *)pEntry->pUserData;` |
|      763 |  5151 | `					}` |
|      764 |  5152 | `				}` |
|     1530 |  5153 | `				if( pObjAttr == 0 ){` |
...
|        - |  5164 | `				 */` |
|     1530 |  5165 | `				pThis->iRef++;` |
|     1530 |  5166 | `				PH7_MemObjRelease(pTos);` |
|     1530 |  5167 | `				pTos->nIdx = SXU32_HIGH; /* Assume we are loading a constant */` |
|     1530 |  5168 | `				if( pObjAttr ){` |
|     1528 |  5169 | `					ph7_value *pValue = 0; /* cc warning */` |
|        - |  5170 | `					/* Check attribute access */` |
|     1528 |  5171 | `					if( VmClassMemberAccess(&(*pVm),pClass,&pObjAttr->pAttr->sName,pObjAttr->pAttr->iProtection,TRUE) ){` |
|        - |  5172 | `						/* Load attribute */` |
|     1528 |  5173 | `						pValue = (ph7_value *)SySetAt(&pVm->aMemObj,pObjAttr->nIdx);` |
|     1528 |  5174 | `						if( pValue ){` |
|     1528 |  5175 | `							if( pThis->iRef < 2 ){` |
...
|        2 |  5180 | `							}else{` |
|        - |  5181 | `								/* Simple load */` |
|     1526 |  5182 | `								PH7_MemObjLoad(pValue,pTos);` |
|        - |  5183 | `							}` |
|     1528 |  5184 | `							if( (pObjAttr->pAttr->iFlags & PH7_CLASS_ATTR_CONSTANT) == 0 ){` |
|     1526 |  5185 | `								if( pThis->iRef > 1 ){` |
|        - |  5186 | `									/* Load attribute index */` |
|     1524 |  5187 | `									pTos->nIdx = pObjAttr->nIdx;` |
|      761 |  5188 | `								}` |
|      762 |  5189 | `							}` |
|      763 |  5190 | `						}` |
|      763 |  5191 | `					}` |
...
|     1530 |  5194 | `				PH7_ClassInstanceUnref(pThis);` |
|        - |  5195 | `			}` |
|      825 |  5196 | `		}else{` |
...
|        - |  5520 | ` */` |
|   228376 |  5521 | `case PH7_OP_CALL: {` |
|   456798 |  5522 | `	ph7_value *pArg = &pTos[-pInstr->iP1];` |
|        - |  5523 | `	SyHashEntry *pEntry;` |
|        - |  5524 | `	SyString sName;` |
|        - |  5525 | `	/* Extract function name */` |
|   456798 |  5526 | `	if( (pTos->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|   228303 |  5561 | `		break;` |
|        - |  5562 | `	}` |
|   456796 |  5563 | `	SyStringInitFromBuf(&sName,SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
|        - |  5564 | `	/* Check for a compiled function first */` |
|   456796 |  5565 | `	pEntry = SyHashGet(&pVm->hFunction,(const void *)sName.zString,sName.nByte);` |
|   456796 |  5566 | `	if( pEntry ){` |
...
|     8784 |  5577 | `		pVmFunc = (ph7_vm_func *)pEntry->pUserData;` |
|     8784 |  5578 | `		pThis = 0;` |
|     8784 |  5579 | `		pSelf = 0;` |
|     8784 |  5580 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
|        - |  5581 | `			ph7_class_method *pMeth;` |
|        - |  5582 | `			/* Class method call */` |
|      638 |  5583 | `			ph7_value *pTarget = &pTos[-1];` |
|      638 |  5584 | `			if( pTarget >= pStack && (pTarget->iFlags & (MEMOBJ_STRING\|MEMOBJ_OBJ\|MEMOBJ_NULL)) ){` |
|        - |  5585 | `				/* Extract the 'this' pointer */` |
|      638 |  5586 | `				if(pTarget->iFlags & MEMOBJ_OBJ ){` |
|        - |  5587 | `					/* Instance already loaded */` |
|      608 |  5588 | `					pThis = (ph7_class_instance *)pTarget->x.pOther;` |
|      608 |  5589 | `					pThis->iRef++;` |
|      608 |  5590 | `					pSelf = pThis->pClass;` |
|      303 |  5591 | `				}` |
|      638 |  5592 | `				if( pSelf == 0 ){` |
...
|        9 |  5614 | `					}` |
|       15 |  5615 | `				}` |
|      638 |  5616 | `				VmPopOperand(&pTos,1);` |
|      638 |  5617 | `				PH7_MemObjRelease(pTos);` |
|        - |  5618 | `				/* Synchronize pointers */` |
|      638 |  5619 | `				pArg = &pTos[-pInstr->iP1];` |
...
|        - |  5624 | `				 */` |
|      638 |  5625 | `				while( pArg < pStack ){` |
|      ! 0 |  5626 | `					pArg++;` |
|      ! 0 |  5627 | `				}` |
|      638 |  5628 | `				if( pSelf ){ /* Paranoid edition */` |
|        - |  5629 | `					/* Check if the call is allowed */` |
|      638 |  5630 | `					pMeth = PH7_ClassExtractMethod(pSelf,pVmFunc->sName.zString,pVmFunc->sName.nByte);` |
|      638 |  5631 | `					if( pMeth && pMeth->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|     8784 |  5646 | `		if( pVm->nRecursionDepth > pVm->nMaxDepth ){` |
...
|        3 |  5656 | `			break;` |
|        - |  5657 | `		}` |
|     8782 |  5658 | `		if( pVmFunc->pNextName ){` |
...
|     8782 |  5663 | `		aFormalArg = (ph7_vm_func_arg *)SySetBasePtr(&pVmFunc->aArgs);` |
|        - |  5664 | `		/* Create a new VM frame  */` |
|     8782 |  5665 | `		rc = VmEnterFrame(&(*pVm),pVmFunc,pThis,&pFrame);` |
|     8782 |  5666 | `		if( rc != SXRET_OK ){` |
...
|      ! 0 |  5677 | `			break;` |
|        - |  5678 | `		}` |
|     8782 |  5679 | `		if( (pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) && pThis ){` |
|        - |  5680 | `			/* Install the '$this' variable */` |
|        - |  5681 | `			static const SyString sThis = { "this" , sizeof("this") - 1 };` |
|      618 |  5682 | `			pObj = VmExtractMemObj(&(*pVm),&sThis,FALSE,TRUE);` |
|      618 |  5683 | `			if( pObj ){` |
|        - |  5684 | `				/* Reflect the change */` |
|      618 |  5685 | `				pObj->x.pOther = pThis;` |
|      618 |  5686 | `				MemObjSetType(pObj,MEMOBJ_OBJ);` |
|      308 |  5687 | `			}` |
|      308 |  5688 | `		}` |
|     8782 |  5689 | `		if( SySetUsed(&pVmFunc->aStatic) > 0 ){` |
...
|     8782 |  5716 | `		n = 0;` |
|    24918 |  5717 | `		while( pArg < pTos ){` |
|    16138 |  5718 | `			if( n < SySetUsed(&pVmFunc->aArgs) ){` |
|    16038 |  5719 | `				if( (pArg->iFlags & MEMOBJ_NULL) && SySetUsed(&aFormalArg[n].aByteCode) > 0 ){` |
...
|    16038 |  5727 | `				if( aFormalArg[n].nType > 0 ){` |
|     1014 |  5728 | `					if ( aFormalArg[n].nType == SXU32_HIGH ){` |
...
|        - |  5752 | `							}` |
|      ! 0 |  5753 | `						}` |
|     1014 |  5754 | `					}else if( ((pArg->iFlags & aFormalArg[n].nType) == 0) ){` |
|      ! 0 |  5755 | `						ProcMemObjCast xCast = PH7_MemObjCastMethod(aFormalArg[n].nType);` |
|        - |  5756 | `						/* Cast to the desired type */` |
|      ! 0 |  5757 | `						xCast(pArg);` |
|      ! 0 |  5758 | `					}` |
|      506 |  5759 | `				}` |
|    16038 |  5760 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_BY_REF ){` |
...
|    16014 |  5786 | `					pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|        - |  5787 | `				}` |
|     8020 |  5788 | `			}else{` |
|        - |  5789 | `				char zName[32];` |
...
|        - |  5796 | `			}` |
|    16138 |  5797 | `			if( pObj ){` |
|    16114 |  5798 | `				PH7_MemObjStore(pArg,pObj);` |
|        - |  5799 | `				/* Insert argument index  */` |
|    16114 |  5800 | `				sArg.nIdx = pObj->nIdx;` |
|    16114 |  5801 | `				sArg.pUserData = 0;` |
|    16114 |  5802 | `				SySetPut(&pFrame->sArg,(const void *)&sArg);` |
|     8056 |  5803 | `			}` |
|    16138 |  5804 | `			PH7_MemObjRelease(pArg);` |
|    16138 |  5805 | `			pArg++;` |
|    16138 |  5806 | `			++n;` |
|        2 |  5807 | `		}` |
|        - |  5808 | `		/* Set up closure environment */` |
|     8782 |  5809 | `		if( pVmFunc->iFlags & VM_FUNC_CLOSURE ){` |
...
|     9894 |  5831 | `		while( n < SySetUsed(&pVmFunc->aArgs) ){` |
|     1114 |  5832 | `			if( SySetUsed(&aFormalArg[n].aByteCode) > 0 ){` |
|     1104 |  5833 | `				pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|     1104 |  5834 | `				if( pObj ){` |
|        - |  5835 | `					/* Evaluate the default value and extract it's result */` |
|     1104 |  5836 | `					rc = VmLocalExec(&(*pVm),&aFormalArg[n].aByteCode,pObj);` |
|     1104 |  5837 | `					if( rc == PH7_ABORT ){` |
|      ! 0 |  5838 | `						goto Abort;` |
|        - |  5839 | `					}` |
|        - |  5840 | `					/* Insert argument index */` |
|     1104 |  5841 | `					sArg.nIdx = pObj->nIdx;` |
|     1104 |  5842 | `					sArg.pUserData = 0;` |
|     1104 |  5843 | `					SySetPut(&pFrame->sArg,(const void *)&sArg);` |
|        - |  5844 | `					/* Make sure the default argument is of the correct type */` |
|     1104 |  5845 | `					if( aFormalArg[n].nType > 0 && ((pObj->iFlags & aFormalArg[n].nType) == 0) ){` |
...
|        - |  5856 | `		 */` |
|     8782 |  5857 | `		PH7_MemObjRelease(pTos);` |
|     8782 |  5858 | `		pTos = &pTos[-pInstr->iP1];` |
|        - |  5859 | `		/* Allocate a new operand stack and evaluate the function body */` |
|     8782 |  5860 | `		pFrameStack = VmNewOperandStack(&(*pVm),SySetUsed(&pVmFunc->aByteCode));` |
|     8782 |  5861 | `		if( pFrameStack == 0 ){` |
...
|      636 |  5872 | `			SySetPut(&pVm->aSelf,(const void *)&pSelf);` |
|      317 |  5873 | `		}` |
|        - |  5874 | `		/* Increment nesting level */` |
|     8782 |  5875 | `		pVm->nRecursionDepth++;` |
|        - |  5876 | `		/* Execute function body */` |
|     8782 |  5877 | `		rc = VmByteCodeExec(&(*pVm),(VmInstr *)SySetBasePtr(&pVmFunc->aByteCode),pFrameStack,-1,pTos,&n,FALSE);` |
|        - |  5878 | `		/* Decrement nesting level */` |
|     8782 |  5879 | `		pVm->nRecursionDepth--;` |
|     8782 |  5880 | `		if( pSelf ){` |
|        - |  5881 | `			/* Pop class name */` |
|      636 |  5882 | `			(void)SySetPop(&pVm->aSelf);` |
|      317 |  5883 | `		}` |
|        - |  5884 | `		/* Cleanup the mess left behind */` |
|     8782 |  5885 | `		if( (pVmFunc->iFlags & VM_FUNC_REF_RETURN) && rc == SXRET_OK ){` |
...
|     8782 |  5913 | `		if( rc != PH7_ABORT && ((pFrame->iFlags & VM_FRAME_THROW) \|\| rc == PH7_EXCEPTION) ){` |
...
|     8782 |  5932 | `		SyMemBackendFree(&pVm->sAllocator,pFrameStack);` |
|        - |  5933 | `		/* Leave the frame */` |
|     8782 |  5934 | `		VmLeaveFrame(&(*pVm));` |
|     8782 |  5935 | `		if( rc == PH7_ABORT ){` |
|        - |  5936 | `			/* Abort processing immeditaley */` |
|      ! 0 |  5937 | `			goto Abort;` |
|     8782 |  5938 | `		}else if( rc == PH7_EXCEPTION ){` |
...
|   448014 |  5946 | `		pEntry = SyHashGet(&pVm->hHostFunction,(const void *)sName.zString,sName.nByte);` |
|   448014 |  5947 | `		if( pEntry == 0 ){` |
...
|        5 |  5956 | `			break;` |
|        - |  5957 | `		}` |
|   448010 |  5958 | `		pFunc = (ph7_user_func *)pEntry->pUserData;` |
|        - |  5959 | `		/* Start collecting function arguments */` |
|   448010 |  5960 | `		SySetReset(&aArg);` |
|  1203804 |  5961 | `		while( pArg < pTos ){` |
|   755796 |  5962 | `			SySetPut(&aArg,(const void *)&pArg);` |
|   755796 |  5963 | `			pArg++;` |
|        2 |  5964 | `		}` |
|        - |  5965 | `		/* Assume a null return value */` |
|   448010 |  5966 | `		PH7_MemObjInit(&(*pVm),&sRet);` |
|        - |  5967 | `		/* Init the call context */` |
|   448010 |  5968 | `		VmInitCallContext(&sCtx,&(*pVm),pFunc,&sRet,0);` |
|        - |  5969 | `		/* Call the foreign function */` |
|   448010 |  5970 | `		rc = pFunc->xFunc(&sCtx,(int)SySetUsed(&aArg),(ph7_value **)SySetBasePtr(&aArg));` |
|        - |  5971 | `		/* Release the call context */` |
|   448010 |  5972 | `		VmReleaseCallContext(&sCtx);` |
|   448010 |  5973 | `		if( rc == PH7_ABORT ){` |
|      147 |  5974 | `			goto Abort;` |
|   447864 |  5975 | `		}else if( rc == PH7_EXCEPTION ){` |
|        3 |  5976 | `			goto Exception;` |
|        - |  5977 | `		}` |
|   447862 |  5978 | `		if( pInstr->iP1 > 0 ){` |
|        - |  5979 | `			/* Pop function name and arguments */` |
|   432666 |  5980 | `			VmPopOperand(&pTos,pInstr->iP1);` |
|   216354 |  5981 | `		}` |
|        - |  5982 | `		/* Save foreign function return value */` |
|   447862 |  5983 | `		PH7_MemObjStore(&sRet,pTos);` |
|   447862 |  5984 | `		PH7_MemObjRelease(&sRet);` |
|        - |  5985 | `	}` |
|   456640 |  5986 | `	break;` |
|        - |  5987 | `				  }` |
|        - |  5988 | `/*` |
...
|        - |  5991 | ` */` |
|     8553 |  5992 | `case PH7_OP_CONSUME: {` |
|    17108 |  5993 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|    17108 |  5994 | `	ph7_value *pCur,*pOut = pTos;` |
|        - |  5995 |  |
|    17108 |  5996 | `	pOut = &pTos[-pInstr->iP1 + 1];` |
|    17108 |  5997 | `	pCur = pOut;` |
|        - |  5998 | `	/* Start the consume process  */` |
|    34214 |  5999 | `	while( pOut <= pTos ){` |
|        - |  6000 | `		/* Force a string cast */` |
|    17108 |  6001 | `		if( (pOut->iFlags & MEMOBJ_STRING) == 0 ){` |
|       56 |  6002 | `			PH7_MemObjToString(pOut);` |
|       27 |  6003 | `		}` |
|    17108 |  6004 | `		if( SyBlobLength(&pOut->sBlob) > 0 ){` |
|        - |  6005 | `			/*SyBlobNullAppend(&pOut->sBlob);*/` |
|        - |  6006 | `			/* Invoke the output consumer callback */` |
|     9164 |  6007 | `			rc = pCons->xConsumer(SyBlobData(&pOut->sBlob),SyBlobLength(&pOut->sBlob),pCons->pUserData);` |
|     9164 |  6008 | `			if( pCons->xConsumer != VmObConsumer ){` |
|        - |  6009 | `				/* Increment output length */` |
|     3548 |  6010 | `				pVm->nOutputLen += SyBlobLength(&pOut->sBlob);` |
|     1773 |  6011 | `			}` |
|     9164 |  6012 | `			SyBlobRelease(&pOut->sBlob);` |
|     9164 |  6013 | `			if( rc == SXERR_ABORT ){` |
...
|    17108 |  6018 | `		pOut++;` |
|        2 |  6019 | `	}` |
|    17108 |  6020 | `	pTos = &pCur[-1];` |
|    17106 |  6021 | `	break;` |
|        - |  6022 | `					 }` |
|        - |  6023 |  |
|        - |  6024 | `		} /* Switch() */` |
|  7616622 |  6025 | `		pc++; /* Next instruction in the stream */` |
|        2 |  6026 | `	} /* For(;;) */` |
|    10941 |  6027 | `Done:` |
|    21884 |  6028 | `	SySetRelease(&aArg);` |
|    21884 |  6029 | `	return SXRET_OK;` |
|       74 |  6030 | `Abort:` |
|      149 |  6031 | `	SySetRelease(&aArg);` |
|      515 |  6032 | `	while( pTos >= pStack ){` |
|      367 |  6033 | `		PH7_MemObjRelease(pTos);` |
|      367 |  6034 | `		pTos--;` |
|        1 |  6035 | `	}` |
|      149 |  6036 | `	return PH7_ABORT;` |
|        2 |  6037 | `Exception:` |
...
|        - |  6049 | ` */` |
|    11192 |  6050 | `static sxi32 VmLocalExec(ph7_vm *pVm,SySet *pByteCode,ph7_value *pResult)` |
|        2 |  6051 |  |
|        - |  6052 | `	ph7_value *pStack;` |
|        - |  6053 | `	sxi32 rc;` |
|        - |  6054 | `	/* Allocate a new operand stack */` |
|    11194 |  6055 | `	pStack = VmNewOperandStack(&(*pVm),SySetUsed(pByteCode));` |
|    11194 |  6056 | `	if( pStack == 0 ){` |
|      ! 0 |  6057 | `		return SXERR_MEM;` |
|        - |  6058 | `	}` |
|        - |  6059 | `	/* Execute the program */` |
|    11194 |  6060 | `	rc = VmByteCodeExec(&(*pVm),(VmInstr *)SySetBasePtr(pByteCode),pStack,-1,&(*pResult),0,FALSE);` |
|        - |  6061 | `	/* Free the operand stack */` |
|    11194 |  6062 | `	SyMemBackendFree(&pVm->sAllocator,pStack);` |
|        - |  6063 | `	/* Execution result */` |
|    11194 |  6064 | `	return rc;` |
|     5598 |  6065 |  |
|        - |  6066 | `/*` |
...
|        - |  6074 | ` */` |
|     1220 |  6075 | `static void VmInvokeShutdownCallbacks(ph7_vm *pVm)` |
|        2 |  6076 |  |
...
|     1222 |  6082 | `	nEntry = SySetUsed(&pVm->aShutdown);` |
|    13422 |  6083 | `	for( i = 0 ; i < (int)SX_ARRAYSIZE(apArg) ; i++ ){` |
|    12202 |  6084 | `		apArg[i] = 0;` |
|     6102 |  6085 | `	}` |
|     1224 |  6086 | `	for( n = 0 ; n < nEntry ; ++n ){` |
...
|        1 |  6109 | `		}` |
|        2 |  6110 | `	}` |
|     1222 |  6111 | `	SySetReset(&pVm->aShutdown);` |
|     1222 |  6112 |  |
|        - |  6113 | `/*` |
...
|        - |  6117 | ` */` |
|     1228 |  6118 | `PH7_PRIVATE sxi32 PH7_VmByteCodeExec(ph7_vm *pVm)` |
|        2 |  6119 |  |
|        - |  6120 | `	/* Make sure we are ready to execute this program */` |
|     1230 |  6121 | `	if( pVm->nMagic != PH7_VM_RUN ){` |
|      ! 0 |  6122 | `		return pVm->nMagic == PH7_VM_EXEC ? SXERR_LOCKED /* Locked VM */ : SXERR_CORRUPT; /* Stale VM */` |
|        - |  6123 | `	}` |
|        - |  6124 | `	/* Set the execution magic number  */` |
|     1230 |  6125 | `	pVm->nMagic = PH7_VM_EXEC;` |
|        - |  6126 | `	/* Execute the program */` |
|     1230 |  6127 | `	VmByteCodeExec(&(*pVm),(VmInstr *)SySetBasePtr(pVm->pByteContainer),pVm->aOps,-1,&pVm->sExec,0,FALSE);` |
|        - |  6128 | `	/* Invoke any shutdown callbacks */` |
|     1226 |  6129 | `	VmInvokeShutdownCallbacks(&(*pVm));` |
|        - |  6130 | `	/*` |
...
|        - |  6335 | ` */` |
|      786 |  6336 | `static int vm_builtin_func_num_args(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  6337 |  |
|        - |  6338 | `	VmFrame *pFrame;` |
|        - |  6339 | `	ph7_vm *pVm;` |
|        - |  6340 | `	/* Point to the target VM */` |
|      788 |  6341 | `	pVm = pCtx->pVm;` |
|        - |  6342 | `	/* Current frame */` |
|      788 |  6343 | `	pFrame = pVm->pFrame;` |
|      788 |  6344 | `	while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|        - |  6345 | `		/* Safely ignore the exception frame */` |
|      ! 0 |  6346 | `		pFrame = pFrame->pParent;` |
|      ! 0 |  6347 | `	}` |
|      788 |  6348 | `	if( pFrame->pParent == 0 ){` |
...
|      788 |  6356 | `	nArg = (int)SySetUsed(&pFrame->sArg);` |
|      788 |  6357 | `	ph7_result_int(pCtx,nArg);` |
|      788 |  6358 | `	return SXRET_OK;` |
|      395 |  6359 |  |
|        - |  6360 | `/*` |
...
|        - |  6546 | ` */` |
|    14264 |  6547 | `PH7_PRIVATE int PH7_VmIsCallable(ph7_vm *pVm,ph7_value *pValue,int CallInvoke)` |
|        2 |  6548 |  |
|    14266 |  6549 | `	int res = 0;` |
|    14266 |  6550 | `	if( pValue->iFlags & MEMOBJ_OBJ ){` |
...
|      ! 0 |  6565 | `		}` |
|    14266 |  6566 | `	}else if( pValue->iFlags & MEMOBJ_HASHMAP ){` |
...
|        4 |  6588 | `			}` |
|        6 |  6589 | `		}` |
|    14262 |  6590 | `	}else if( pValue->iFlags & MEMOBJ_STRING ){` |
|        - |  6591 | `		const char *zName;` |
|        - |  6592 | `		int nLen;` |
|        - |  6593 | `		/* Extract the name */` |
|     4194 |  6594 | `		zName = ph7_value_to_string(pValue,&nLen);` |
|        - |  6595 | `		/* Perform the lookup */` |
|     4200 |  6596 | `		if( SyHashGet(&pVm->hFunction,(const void *)zName,(sxu32)nLen) != 0 \|\|` |
|       12 |  6597 | `			SyHashGet(&pVm->hHostFunction,(const void *)zName,(sxu32)nLen) != 0 ){` |
|        - |  6598 | `				/* Function is callable */` |
|     4188 |  6599 | `				res = 1;` |
|     2093 |  6600 | `		}` |
|     2096 |  6601 | `	}` |
|    14266 |  6602 | `	return res;` |
|        2 |  6603 |  |
|        - |  6604 | `/*` |
...
|        - |  6758 | ` */` |
|      188 |  6759 | `PH7_PRIVATE ph7_class * PH7_VmPeekTopClass(ph7_vm *pVm)` |
|        2 |  6760 |  |
|      190 |  6761 | `	SySet *pSet = &pVm->aSelf;` |
|        - |  6762 | `	ph7_class **apClass;` |
|      190 |  6763 | `	if( SySetUsed(pSet) <= 0 ){` |
|        - |  6764 | `		/* Empty stack,return NULL */` |
|       15 |  6765 | `		return 0;` |
|        - |  6766 | `	}` |
|        - |  6767 | `	/* Peek the last entry */` |
|      176 |  6768 | `	apClass = (ph7_class **)SySetBasePtr(pSet);` |
|      176 |  6769 | `	return apClass[pSet->nUsed - 1];` |
|       96 |  6770 |  |
|        - |  6771 | `/*` |
...
|        - |  7289 | ` */` |
|     1568 |  7290 | `static int VmClassMemberAccess(` |
...
|        - |  7296 | `	)` |
|        2 |  7297 |  |
|     1570 |  7298 | `	if( iProtection != PH7_CLASS_PROT_PUBLIC ){` |
|     1006 |  7299 | `		VmFrame *pFrame = pVm->pFrame;` |
|        - |  7300 | `		ph7_vm_func *pVmFunc;` |
|     1010 |  7301 | `		while( pFrame->pParent && (pFrame->iFlags & (VM_FRAME_EXCEPTION\|VM_FRAME_CATCH) ) ){` |
|        - |  7302 | `			/* Safely ignore the exception frame */` |
|        5 |  7303 | `			pFrame = pFrame->pParent;` |
|        1 |  7304 | `		}` |
|     1006 |  7305 | `		pVmFunc = (ph7_vm_func *)pFrame->pUserData;` |
|     1006 |  7306 | `		if( pVmFunc == 0 \|\| (pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) == 0 ){` |
|        9 |  7307 | `			goto dis; /* Access is forbidden */` |
|        - |  7308 | `		}` |
|      998 |  7309 | `		if( iProtection == PH7_CLASS_PROT_PRIVATE ){` |
...
|        4 |  7314 | `		}else{` |
|        - |  7315 | `			/* Protected */` |
|      992 |  7316 | `			ph7_class *pBase = (ph7_class *)pVmFunc->pUserData;` |
|        - |  7317 | `			/* Must be a derived class */` |
|      992 |  7318 | `			if( !VmInstanceOf(pClass,pBase) ){` |
|      ! 0 |  7319 | `				goto dis; /* Access is forbidden */` |
|        - |  7320 | `			}` |
|        - |  7321 | `		}` |
|      498 |  7322 | `	}` |
|     1562 |  7323 | `	return 1; /* Access is granted */` |
|        4 |  7324 | `dis:` |
|        9 |  7325 | `	if( bLog ){` |
...
|        - |  7474 | ` */` |
|     2078 |  7475 | `static int VmQueryInterfaceSet(ph7_class *pClass,SySet *pSet)` |
|        2 |  7476 |  |
|        - |  7477 | `	ph7_class **apInterface;` |
|        - |  7478 | `	sxu32 n;` |
|     2080 |  7479 | `	if( SySetUsed(pSet) < 1 ){` |
|        - |  7480 | `		/* Empty interface container */` |
|     2078 |  7481 | `		return FALSE;` |
|        - |  7482 | `	}` |
...
|        - |  7497 | ` */` |
|     1042 |  7498 | `static int VmInstanceOf(ph7_class *pThis,ph7_class *pClass)` |
|        2 |  7499 |  |
|        - |  7500 | `	ph7_class *pParent;` |
|        - |  7501 | `	sxi32 rc;` |
|     1044 |  7502 | `	if( pThis == pClass ){` |
|        - |  7503 | `		/* Instance of the same class */` |
|      140 |  7504 | `		return TRUE;` |
|        - |  7505 | `	}` |
|        - |  7506 | `	/* Check implemented interfaces */` |
|      906 |  7507 | `	rc = VmQueryInterfaceSet(pClass,&pThis->aInterface);` |
|      906 |  7508 | `	if( rc ){` |
|        3 |  7509 | `		return TRUE;` |
|        - |  7510 | `	}` |
|        - |  7511 | `	/* Check parent classes */` |
|      904 |  7512 | `	pParent = pThis->pBase;` |
|     2078 |  7513 | `	while( pParent ){` |
|     2076 |  7514 | `		if( pParent == pClass ){` |
|        - |  7515 | `			/* Same instance */` |
|      902 |  7516 | `			return TRUE;` |
|        - |  7517 | `		}` |
|        - |  7518 | `		/* Check the implemented interfaces */` |
|     1176 |  7519 | `		rc = VmQueryInterfaceSet(pClass,&pParent->aInterface);` |
|     1176 |  7520 | `		if( rc ){` |
|      ! 0 |  7521 | `			return TRUE;` |
|        - |  7522 | `		}` |
|        - |  7523 | `		/* Point to the parent class */` |
|     1176 |  7524 | `		pParent = pParent->pBase;` |
|        2 |  7525 | `	}` |
...
|        - |  7619 | ` */` |
|      494 |  7620 | `PH7_PRIVATE sxi32 PH7_VmCallClassMethod(` |
...
|      496 |  7634 | `	aStack = VmNewOperandStack(&(*pVm),2/* Method name + Aux data */+nArg);` |
|      496 |  7635 | `	if( aStack == 0 ){` |
...
|      714 |  7641 | `	for( i = 0 ; i < nArg ; i++ ){` |
|      220 |  7642 | `		PH7_MemObjLoad(apArg[i],&aStack[i]);` |
|        - |  7643 | `		/*` |
|        - |  7644 | `		 * Symisc eXtension:` |
|        - |  7645 | `		 *  Parameters to [call_user_func()] can be passed by reference.` |
|        - |  7646 | `		 */` |
|      220 |  7647 | `		aStack[i].nIdx = apArg[i]->nIdx;` |
|      111 |  7648 | `	}` |
|      496 |  7649 | `	iCursor = nArg + 1;` |
|      496 |  7650 | `	if( pThis ){` |
|        - |  7651 | `		/*` |
|        - |  7652 | `		 * Push the class instance so that the '$this' variable will be available.` |
|        - |  7653 | `		 */` |
|      490 |  7654 | `		pThis->iRef++; /* Increment reference count */` |
|      490 |  7655 | `		aStack[i].x.pOther = pThis;` |
|      490 |  7656 | `		aStack[i].iFlags = MEMOBJ_OBJ;` |
|      244 |  7657 | `	}` |
|      496 |  7658 | `	aStack[i].nIdx = SXU32_HIGH; /* Mark as constant */` |
|      496 |  7659 | `	i++;` |
|        - |  7660 | `	/* Push method name */` |
|      496 |  7661 | `	SyBlobReset(&aStack[i].sBlob);` |
|      496 |  7662 | `	SyBlobAppend(&aStack[i].sBlob,(const void *)SyStringData(&pMethod->sVmName),SyStringLength(&pMethod->sVmName));` |
|      496 |  7663 | `	aStack[i].iFlags = MEMOBJ_STRING;` |
|      496 |  7664 | `	aStack[i].nIdx = SXU32_HIGH;` |
|        - |  7665 | `	/* Emit the CALL istruction */` |
|      496 |  7666 | `	aInstr[0].iOp = PH7_OP_CALL;` |
|      496 |  7667 | `	aInstr[0].iP1 = nArg; /* Total number of given arguments */` |
|      496 |  7668 | `	aInstr[0].iP2 = 0;` |
|      496 |  7669 | `	aInstr[0].p3  = 0;` |
|        - |  7670 | `	/* Emit the DONE instruction */` |
|      496 |  7671 | `	aInstr[1].iOp = PH7_OP_DONE;` |
|      496 |  7672 | `	aInstr[1].iP1 = 1;   /* Extract method return value */` |
|      496 |  7673 | `	aInstr[1].iP2 = 0;` |
|      496 |  7674 | `	aInstr[1].p3  = 0;` |
|        - |  7675 | `	/* Execute the method body (if available) */` |
|      496 |  7676 | `	VmByteCodeExec(&(*pVm),aInstr,aStack,iCursor,pResult,0,TRUE);` |
|        - |  7677 | `	/* Clean up the mess left behind */` |
|      496 |  7678 | `	SyMemBackendFree(&pVm->sAllocator,aStack);` |
|      496 |  7679 | `	return PH7_OK;` |
|      249 |  7680 |  |
|        - |  7681 | `/*` |
...
|        - |  7687 | ` */` |
|      504 |  7688 | `PH7_PRIVATE sxi32 PH7_VmCallUserFunction(` |
...
|        - |  8165 | ` */` |
|     2752 |  8166 | `static int vm_builtin_ob_end_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  8167 |  |
|     2754 |  8168 | `	ph7_vm *pVm = pCtx->pVm;` |
|        - |  8169 | `	VmObEntry *pOb;` |
|        - |  8170 | `	/* Pop the top most OB */` |
|     2754 |  8171 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|     2754 |  8172 | `	if( pOb == 0){` |
...
|      ! 0 |  8177 | `	}else{` |
|        - |  8178 | `		/* Release */` |
|     2754 |  8179 | `		VmObRestore(pVm,pOb);` |
|        - |  8180 | `		/* Return true */` |
|     2754 |  8181 | `		ph7_result_bool(pCtx,1);` |
|        - |  8182 | `	}` |
|     2754 |  8183 | `	return PH7_OK;` |
|        2 |  8184 |  |
|        - |  8185 | `/*` |
...
|        - |  8218 | ` */` |
|     3976 |  8219 | `static int vm_builtin_ob_get_clean(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  8220 |  |
|     3978 |  8221 | `	ph7_vm *pVm = pCtx->pVm;` |
|        - |  8222 | `	VmObEntry *pOb;` |
|        - |  8223 | `	/* Pop the top most OB */` |
|     3978 |  8224 | `	pOb = (VmObEntry *)SySetPop(&pVm->aOB);` |
|     3978 |  8225 | `	if( pOb == 0 ){` |
...
|     3978 |  8232 | `		ph7_result_string(pCtx,(const char *)SyBlobData(&pOb->sOB),(int)SyBlobLength(&pOb->sOB)); /* Will make it's own copy */` |
|        - |  8233 | `		/* Release */` |
|     3978 |  8234 | `		VmObRestore(pVm,pOb);` |
|        - |  8235 | `	}` |
|     3978 |  8236 | `	return PH7_OK;` |
|        2 |  8237 |  |
|        - |  8238 | `/*` |
...
|        - |  8287 | ` */` |
|     5976 |  8288 | `static int VmObConsumer(const void *pData,unsigned int nDataLen,void *pUserData)` |
|        2 |  8289 |  |
|     5978 |  8290 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|        - |  8291 | `	VmObEntry *pEntry;` |
|        - |  8292 | `	ph7_value sResult;` |
|        - |  8293 | `	/* Peek the top most entry */` |
|     5978 |  8294 | `	pEntry = (VmObEntry *)SySetPeek(&pVm->aOB);` |
|     5978 |  8295 | `	if( pEntry == 0 ){` |
|        - |  8296 | `		/* CAN'T HAPPEN */` |
|      ! 0 |  8297 | `		return PH7_OK;` |
|        - |  8298 | `	}` |
|     5978 |  8299 | `	PH7_MemObjInit(pVm,&sResult);` |
|     5978 |  8300 | `	if( ph7_value_is_callable(&pEntry->sCallback) && pVm->nObDepth < 15 ){` |
...
|      ! 0 |  8316 | `	}` |
|     5978 |  8317 | `	if( nDataLen > 0 ){` |
|        - |  8318 | `		/* Redirect the VM output to the internal buffer */` |
|     5978 |  8319 | `		SyBlobAppend(&pEntry->sOB,pData,nDataLen);` |
|     2988 |  8320 | `	}` |
|        - |  8321 | `	/* Release */` |
|     5978 |  8322 | `	PH7_MemObjRelease(&sResult);` |
|     5978 |  8323 | `	return PH7_OK;` |
|     2990 |  8324 |  |
|        - |  8325 | `/*` |
...
|        - |  8328 | ` * information.` |
|        - |  8329 | ` */` |
|     6730 |  8330 | `static void VmObRestore(ph7_vm *pVm,VmObEntry *pEntry)` |
|        2 |  8331 |  |
|     6732 |  8332 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|     6732 |  8333 | `	if( SySetUsed(&pVm->aOB) < 1 ){` |
|        - |  8334 | `		/* No more stackable OB */` |
|     6714 |  8335 | `		pCons->xConsumer = pCons->xDef;` |
|     6714 |  8336 | `		pCons->pUserData = pCons->pDefData;` |
|     3356 |  8337 | `	}` |
|        - |  8338 | `	/* Release OB data */` |
|     6732 |  8339 | `	PH7_MemObjRelease(&pEntry->sCallback);` |
|     6732 |  8340 | `	SyBlobRelease(&pEntry->sOB);` |
|     6732 |  8341 |  |
|        - |  8342 | `/*` |
...
|        - |  8364 | ` */` |
|     6730 |  8365 | `static int vm_builtin_ob_start(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  8366 |  |
|     6732 |  8367 | `	ph7_vm *pVm = pCtx->pVm;` |
|        - |  8368 | `	VmObEntry sOb;` |
|        - |  8369 | `	sxi32 rc;` |
|        - |  8370 | `	/* Initialize the OB entry */` |
|     6732 |  8371 | `	PH7_MemObjInit(pCtx->pVm,&sOb.sCallback);` |
|     6732 |  8372 | `	SyBlobInit(&sOb.sOB,&pVm->sAllocator);` |
|     6732 |  8373 | `	if( nArg > 0 && (apArg[0]->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP)) ){` |
|        - |  8374 | `		/* Save the callback name for later invocation */` |
|      ! 0 |  8375 | `		PH7_MemObjStore(apArg[0],&sOb.sCallback);` |
|      ! 0 |  8376 | `	}` |
|        - |  8377 | `	/* Push in the stack */` |
|     6732 |  8378 | `	rc = SySetPut(&pVm->aOB,(const void *)&sOb);` |
|     6732 |  8379 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  8380 | `		PH7_MemObjRelease(&sOb.sCallback);` |
|      ! 0 |  8381 | `	}else{` |
|     6732 |  8382 | `		ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|        - |  8383 | `		/* Substitute the default VM consumer */` |
|     6732 |  8384 | `		if( pCons->xConsumer != VmObConsumer ){` |
|     6714 |  8385 | `			pCons->xDef = pCons->xConsumer;` |
|     6714 |  8386 | `			pCons->pDefData = pCons->pUserData;` |
|        - |  8387 | `			/* Install the new consumer */` |
|     6714 |  8388 | `			pCons->xConsumer = VmObConsumer;` |
|     6714 |  8389 | `			pCons->pUserData = pVm;` |
|     3356 |  8390 | `		}` |
|        - |  8391 | `	}` |
|     6732 |  8392 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|     6732 |  8393 | `	return PH7_OK;` |
|        2 |  8394 |  |
|        - |  8395 | `/*` |
...
|        - |  8564 | ` */` |
|     1298 |  8565 | `PH7_PRIVATE sxu32 PH7_VmRandomNum(ph7_vm *pVm)` |
|        2 |  8566 |  |
|        - |  8567 | `	sxu32 iNum;` |
|     1300 |  8568 | `	SyRandomness(&pVm->sPrng,(void *)&iNum,sizeof(sxu32));` |
|     1300 |  8569 | `	return iNum;` |
|        2 |  8570 |  |
|        - |  8571 | `/*` |
...
|        - |  8576 | ` */` |
|    43444 |  8577 | `PH7_PRIVATE void PH7_VmRandomString(ph7_vm *pVm,char *zBuf,int nLen)` |
|        2 |  8578 |  |
|        - |  8579 | `	static const char zBase[] = {"abcdefghijklmnopqrstuvwxyz"}; /* English Alphabet */` |
|        - |  8580 | `	int i;` |
|        - |  8581 | `	/* Generate a binary string first */` |
|    43446 |  8582 | `	SyRandomness(&pVm->sPrng,zBuf,(sxu32)nLen);` |
|        - |  8583 | `	/* Turn the binary string into english based alphabet */` |
|   478054 |  8584 | `	for( i = 0 ; i < nLen ; ++i ){` |
|   434610 |  8585 | `		 zBuf[i] = zBase[zBuf[i] % (sizeof(zBase)-1)];` |
|   217306 |  8586 | `	 }` |
|    43446 |  8587 |  |
|        - |  8588 | `/*` |
|        - |  8589 | ` * int rand()` |
...
|        - |  8889 | ` */` |
|    55236 |  8890 | `static int vm_builtin_isset(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  8891 |  |
|        - |  8892 | `	ph7_value *pObj;` |
|    55238 |  8893 | `	int res = 0;` |
|        - |  8894 | `	int i;` |
|    55238 |  8895 | `	if( nArg < 1 ){` |
...
|    73974 |  8901 | `	for( i = 0 ; i < nArg ; ++i ){` |
|    55238 |  8902 | `		pObj = apArg[i];` |
|    55238 |  8903 | `		if( pObj->nIdx == SXU32_HIGH ){` |
|    36334 |  8904 | `			if( (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
|        - |  8905 | `				/* Not so fatal,Throw a warning */` |
|      ! 0 |  8906 | `				ph7_context_throw_error(pCtx,PH7_CTX_WARNING,"Expecting a variable not a constant");` |
|      ! 0 |  8907 | `			}` |
|    18166 |  8908 | `		}` |
|    55238 |  8909 | `		res = (pObj->iFlags & MEMOBJ_NULL) ? 0 : 1;` |
|    55238 |  8910 | `		if( !res ){` |
|        - |  8911 | `			/* Variable not set,return FALSE */` |
|    36502 |  8912 | `			ph7_result_bool(pCtx,0);` |
|    36502 |  8913 | `			return SXRET_OK;` |
|        - |  8914 | `		}` |
|     9370 |  8915 | `	}` |
|        - |  8916 | `	/* All given variable are set,return TRUE */` |
|    18738 |  8917 | `	ph7_result_bool(pCtx,1);` |
|    18738 |  8918 | `	return SXRET_OK;` |
|    27620 |  8919 |  |
|        - |  8920 | `/*` |
...
|        - |  8924 | ` */` |
|  2753640 |  8925 | `PH7_PRIVATE sxi32 PH7_VmUnsetMemObj(ph7_vm *pVm,sxu32 nObjIdx,int bForce)` |
|        2 |  8926 |  |
|        - |  8927 | `	ph7_value *pObj;` |
|        - |  8928 | `	VmRefObj *pRef;` |
|  2753642 |  8929 | `	pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nObjIdx);` |
|  2753642 |  8930 | `	if( pObj ){` |
|        - |  8931 | `		/* Release the object */` |
|  2753642 |  8932 | `		PH7_MemObjRelease(pObj);` |
|  1376820 |  8933 | `	}` |
|        - |  8934 | `	/* Remove old reference links */` |
|  2753642 |  8935 | `	pRef = VmRefObjExtract(&(*pVm),nObjIdx);` |
|  2753642 |  8936 | `	if( pRef ){` |
|  2753622 |  8937 | `		sxi32 iFlags = pRef->iFlags;` |
|        - |  8938 | `		/* Unlink from the reference table */` |
|  2753622 |  8939 | `		VmRefObjUnlink(&(*pVm),pRef);` |
|  2753622 |  8940 | `		if( (bForce == TRUE) \|\| (iFlags & VM_REF_IDX_KEEP) == 0 ){` |
|        - |  8941 | `			VmSlot sFree;` |
|        - |  8942 | `			/* Restore to the free list */` |
|  2753616 |  8943 | `			sFree.nIdx = nObjIdx;` |
|  2753616 |  8944 | `			sFree.pUserData = 0;` |
|  2753616 |  8945 | `			SySetPut(&pVm->aFreeObj,(const void *)&sFree);` |
|  1376807 |  8946 | `		}` |
|  1376810 |  8947 | `	}` |
|  2753642 |  8948 | `	return SXRET_OK;` |
|        2 |  8949 |  |
|        - |  8950 | `/*` |
|        - |  8951 | ` * void unset($var,...)` |
...
|        - |  8956 | ` *  Nothing.` |
|        - |  8957 | ` */` |
|     2764 |  8958 | `static int vm_builtin_unset(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  8959 |  |
|        - |  8960 | `	ph7_value *pObj;` |
|        - |  8961 | `	ph7_vm *pVm;` |
|        - |  8962 | `	int i;` |
|        - |  8963 | `	/* Point to the target VM */` |
|     2766 |  8964 | `	pVm = pCtx->pVm;` |
|        - |  8965 | `	/* Iterate and unset */` |
|     8448 |  8966 | `	for( i = 0 ; i < nArg ; ++i ){` |
|     5684 |  8967 | `		pObj = apArg[i];` |
|     5684 |  8968 | `		if( pObj->nIdx == SXU32_HIGH ){` |
|      722 |  8969 | `			if( (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
|        - |  8970 | `				/* Throw an error */` |
|      ! 0 |  8971 | `				ph7_context_throw_error(pCtx,PH7_CTX_ERR,"Expecting a variable not a constant");` |
|      ! 0 |  8972 | `			}` |
|      362 |  8973 | `		}else{` |
|     4963 |  8974 | `			sxu32 nIdx = pObj->nIdx;` |
|        - |  8975 | `			/* TICKET 1433-35: Protect the $GLOBALS array from deletion */` |
|     4963 |  8976 | `			if( nIdx != pVm->nGlobalIdx ){` |
|     4957 |  8977 | `				PH7_VmUnsetMemObj(&(*pVm),nIdx,FALSE);` |
|     2478 |  8978 | `			}` |
|        - |  8979 | `		}` |
|     2843 |  8980 | `	}` |
|     2766 |  8981 | `	return SXRET_OK;` |
|        2 |  8982 |  |
|        - |  8983 | `/*` |
...
|        - |  9617 | ` */` |
|     7930 |  9618 | `static int vm_builtin_set_error_handler(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  9619 |  |
|     7932 |  9620 | `	ph7_vm *pVm = pCtx->pVm;` |
|        - |  9621 | `	ph7_value *pOld,*pNew;` |
|        - |  9622 | `	/* Point to the old and the new handler */` |
|     7932 |  9623 | `	pOld = &pVm->aErrCB[0];` |
|     7932 |  9624 | `	pNew = &pVm->aErrCB[1];` |
|        - |  9625 | `	/* Return the old handler */` |
|     7932 |  9626 | `	ph7_result_value(pCtx,pOld); /* Will make it's own copy */` |
|     7932 |  9627 | `	if( nArg > 0 ){` |
|     7932 |  9628 | `		if( !ph7_value_is_callable(apArg[0])) {` |
|        - |  9629 | `			/* Not callable,return TRUE (As requested by the PHP specification) */` |
|     3965 |  9630 | `			PH7_MemObjRelease(pNew);` |
|     3965 |  9631 | `			ph7_result_bool(pCtx,1);` |
|     1983 |  9632 | `		}else{` |
|     3968 |  9633 | `			PH7_MemObjStore(pNew,pOld);` |
|        - |  9634 | `			/* Install the new handler */` |
|     3968 |  9635 | `			PH7_MemObjStore(apArg[0],pNew);` |
|        - |  9636 | `		}` |
|     3965 |  9637 | `	}` |
|     7932 |  9638 | `	return PH7_OK;` |
|        2 |  9639 |  |
|        - |  9640 | `/*` |
...
|        - |  9662 | ` */` |
|      164 |  9663 | `static int vm_builtin_debug_backtrace(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  9664 |  |
|      166 |  9665 | `	ph7_vm *pVm = pCtx->pVm;` |
|        - |  9666 | `	ph7_value *pArray;` |
|        - |  9667 | `	ph7_class *pClass;` |
|        - |  9668 | `	ph7_value *pValue;` |
|        - |  9669 | `	SyString *pFile;` |
|        - |  9670 | `	/* Create a new array */` |
|      166 |  9671 | `	pArray = ph7_context_new_array(pCtx);` |
|      166 |  9672 | `	pValue = ph7_context_new_scalar(pCtx);` |
|      166 |  9673 | `	if( pArray == 0 \|\| pValue == 0 ){` |
...
|      166 |  9682 | `	if( pVm->pFrame->pParent ){` |
|      166 |  9683 | `		VmFrame *pFrame = pVm->pFrame;` |
|        - |  9684 | `		ph7_vm_func *pFunc;` |
|        - |  9685 | `		ph7_value *pArg;` |
|      166 |  9686 | `		while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|        - |  9687 | `			/* Safely ignore the exception frame */` |
|      ! 0 |  9688 | `			pFrame = pFrame->pParent;` |
|      ! 0 |  9689 | `		}` |
|      166 |  9690 | `		pFunc = (ph7_vm_func *)pFrame->pUserData;` |
|      166 |  9691 | `		if( pFrame->pParent && pFunc ){` |
|      166 |  9692 | `			ph7_value_string(pValue,pFunc->sName.zString,(int)pFunc->sName.nByte);` |
|      166 |  9693 | `			ph7_array_add_strkey_elem(pArray,"function",pValue);` |
|      166 |  9694 | `			ph7_value_reset_string_cursor(pValue);` |
|       82 |  9695 | `		}` |
|        - |  9696 | `		/* Function arguments */` |
|      166 |  9697 | `		pArg = ph7_context_new_array(pCtx);` |
|      166 |  9698 | `		if( pArg  ){` |
|        - |  9699 | `			ph7_value *pObj;` |
|        - |  9700 | `			VmSlot *aSlot;` |
|        - |  9701 | `			sxu32 n;` |
|        - |  9702 | `			/* Start filling the array with the given arguments */` |
|      166 |  9703 | `			aSlot = (VmSlot *)SySetBasePtr(&pFrame->sArg);` |
|      650 |  9704 | `			for( n = 0;  n < SySetUsed(&pFrame->sArg) ; n++ ){` |
|      486 |  9705 | `				pObj = (ph7_value *)SySetAt(&pCtx->pVm->aMemObj,aSlot[n].nIdx);` |
|      486 |  9706 | `				if( pObj ){` |
|      486 |  9707 | `					ph7_array_add_elem(pArg,0/* Automatic index assign*/,pObj);` |
|      242 |  9708 | `				}` |
|      244 |  9709 | `			}` |
|        - |  9710 | `			/* Save the array */` |
|      166 |  9711 | `			ph7_array_add_strkey_elem(pArray,"args",pArg);` |
|       82 |  9712 | `		}` |
|       82 |  9713 | `	}` |
|      166 |  9714 | `	ph7_value_int(pValue,1);` |
|        - |  9715 | `	/* Append the current line (which is always 1 since PH7 does not track` |
|        - |  9716 | `	 * line numbers at run-time. )` |
|        - |  9717 | `	 */` |
|      166 |  9718 | `	ph7_array_add_strkey_elem(pArray,"line",pValue);` |
|        - |  9719 | `	/* Current processed script */` |
|      166 |  9720 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|      166 |  9721 | `	if( pFile ){` |
|      166 |  9722 | `		ph7_value_string(pValue,pFile->zString,(int)pFile->nByte);` |
|      166 |  9723 | `		ph7_array_add_strkey_elem(pArray,"file",pValue);` |
|      166 |  9724 | `		ph7_value_reset_string_cursor(pValue);` |
|       82 |  9725 | `	}` |
|        - |  9726 | `	/* Top class */` |
|      166 |  9727 | `	pClass = PH7_VmPeekTopClass(pVm);` |
|      166 |  9728 | `	if( pClass ){` |
|      162 |  9729 | `		ph7_value_reset_string_cursor(pValue);` |
|      162 |  9730 | `		ph7_value_string(pValue,pClass->sName.zString,(int)pClass->sName.nByte);` |
|      162 |  9731 | `		ph7_array_add_strkey_elem(pArray,"class",pValue);` |
|       80 |  9732 | `	}` |
|        - |  9733 | `	/* Return the freshly created array */` |
|      166 |  9734 | `	ph7_result_value(pCtx,pArray);` |
|        - |  9735 | `	/*` |
|        - |  9736 | `	 * Don't worry about freeing memory, everything will be released automatically` |
|        - |  9737 | `	 * as soon we return from this function.` |
|        - |  9738 | `	 */` |
|      166 |  9739 | `	return PH7_OK;` |
|       84 |  9740 |  |
|        - |  9741 | `/*` |
...
|        - |  9838 | ` */` |
|      148 |  9839 | `static sxi32 VmUncaughtException(` |
...
|      149 |  9845 | `	int nArg = 1;` |
|        - |  9846 | `	sxi32 rc;` |
|      149 |  9847 | `	if( pVm->nExceptDepth > 15 ){` |
|        - |  9848 | `		/* Nesting limit reached */` |
|      ! 0 |  9849 | `		return SXRET_OK;` |
|        - |  9850 | `	}` |
|        - |  9851 | `	/* Call any exception handler if available */` |
|      149 |  9852 | `	PH7_MemObjInit(pVm,&sArg);` |
|      149 |  9853 | `	if( pThis ){` |
|        - |  9854 | `		/* Load the exception instance */` |
|      149 |  9855 | `		sArg.x.pOther = pThis;` |
|      149 |  9856 | `		pThis->iRef++;` |
|      149 |  9857 | `		MemObjSetType(&sArg,MEMOBJ_OBJ);` |
|       75 |  9858 | `	}else{` |
|      ! 0 |  9859 | `		nArg = 0;` |
|        - |  9860 | `	}` |
|      149 |  9861 | `	apArg[0] = &sArg;` |
|        - |  9862 | `	/* Call the exception handler if available */` |
|      149 |  9863 | `	pVm->nExceptDepth++;` |
|      149 |  9864 | `	rc = PH7_VmCallUserFunction(&(*pVm),&pVm->aExceptionCB[1],nArg,apArg,0);` |
|      149 |  9865 | `	pVm->nExceptDepth--;` |
|      149 |  9866 | `	if( rc != SXRET_OK ){` |
|        - |  9867 | `		SyBlob sMsgBuf;` |
|      147 |  9868 | `		const char *zClass = "Exception";` |
|      147 |  9869 | `		sxu32 nClass = (sxu32)sizeof("Exception") - 1;` |
|        - |  9870 | `		const char *zMsg;` |
|        - |  9871 | `		sxu32 nMsg;` |
|        - |  9872 | `		const char *zFuncName;` |
|        - |  9873 | `		int nFuncLen;` |
|      147 |  9874 | `		SyBlobInit(&sMsgBuf,&pVm->sAllocator);` |
|      147 |  9875 | `		if( pThis ){` |
|        - |  9876 | `			ph7_class_method *pGetMessage;` |
|        - |  9877 | `			ph7_value sMsg;` |
|        - |  9878 | `			const char *zTmp;` |
|        - |  9879 | `			int nTmp;` |
|      147 |  9880 | `			zClass = pThis->pClass->sName.zString;` |
|      147 |  9881 | `			nClass = pThis->pClass->sName.nByte;` |
|      147 |  9882 | `			pGetMessage = PH7_ClassExtractMethod(pThis->pClass,"getMessage",sizeof("getMessage")-1);` |
|      147 |  9883 | `			if( pGetMessage ){` |
|      147 |  9884 | `				PH7_MemObjInit(pVm,&sMsg);` |
|      147 |  9885 | `				if( PH7_VmCallClassMethod(&(*pVm),pThis,pGetMessage,&sMsg,0,0) == SXRET_OK ){` |
|      147 |  9886 | `					zTmp = ph7_value_to_string(&sMsg,&nTmp);` |
|      147 |  9887 | `					if( zTmp && nTmp > 0 ){` |
|      147 |  9888 | `						SyBlobAppend(&sMsgBuf,zTmp,(sxu32)nTmp);` |
|       73 |  9889 | `					}` |
|       73 |  9890 | `				}` |
|      147 |  9891 | `				PH7_MemObjRelease(&sMsg);` |
|       73 |  9892 | `			}` |
|       73 |  9893 | `		}` |
|      147 |  9894 | `		if( SyBlobLength(&sMsgBuf) == 0 ){` |
|      ! 0 |  9895 | `			SyBlobAppend(&sMsgBuf,"Unknown exception",sizeof("Unknown exception")-1);` |
|      ! 0 |  9896 | `		}` |
|      147 |  9897 | `		zMsg = (const char *)SyBlobData(&sMsgBuf);` |
|      147 |  9898 | `		nMsg = (sxu32)SyBlobLength(&sMsgBuf);` |
|      147 |  9899 | `		VmGetFrameContext(pVm,&zFuncName,&nFuncLen);` |
|      147 |  9900 | `		VmReportUncaughtException(pVm,zClass,nClass,zMsg,nMsg,zFuncName,nFuncLen);` |
|      147 |  9901 | `		SyBlobRelease(&sMsgBuf);` |
|        - |  9902 | `		/* Tell the upper layer to stop VM execution immediately  */` |
|      147 |  9903 | `		rc = SXERR_ABORT;` |
|       73 |  9904 | `	}` |
|      149 |  9905 | `	PH7_MemObjRelease(&sArg);` |
|      149 |  9906 | `	return rc;` |
|       75 |  9907 |  |
|        - |  9908 | `/*` |
|        - |  9909 | ` * Throw an user exception.` |
|        - |  9910 | ` */` |
|      162 |  9911 | `static sxi32 VmThrowException(` |
...
|      164 |  9920 | `	apException = (ph7_exception **)SySetBasePtr(&pVm->aException);` |
|      164 |  9921 | `	pException = 0;` |
|      164 |  9922 | `	pCatch = 0;` |
|      164 |  9923 | `	if( SySetUsed(&pVm->aException) > 0 ){` |
...
|      164 |  9947 | `	if( pCatch == 0 ){` |
|        - |  9948 | `		sxi32 rc;` |
|      149 |  9949 | `		rc = VmUncaughtException(&(*pVm),pThis);` |
|      149 |  9950 | `		if( rc == SXRET_OK && pException ){` |
...
|        - | 10782 | ` * information.` |
|        - | 10783 | ` */` |
|     8214 | 10784 | `static sxi32 VmEvalChunk(` |
...
|     8216 | 10793 | `	ProcConsumer xErr = 0;` |
|     8216 | 10794 | `	void *pErrData = 0;` |
|        - | 10795 | `	/* Initialize bytecode container */` |
|     8216 | 10796 | `	SySetInit(&aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|     8216 | 10797 | `	SySetAlloc(&aByteCode,0x20);` |
|        - | 10798 | `	/* Reset the code generator */` |
|     8216 | 10799 | `	if( bTrueReturn ){` |
|        - | 10800 | `		/* Included file,log compile-time errors */` |
|     6711 | 10801 | `		xErr = pVm->pEngine->xConf.xErr;` |
|     6711 | 10802 | `		pErrData = pVm->pEngine->xConf.pErrData;` |
|     3355 | 10803 | `	}` |
|     8216 | 10804 | `	PH7_ResetCodeGenerator(pVm,xErr,pErrData);` |
|        - | 10805 | `	/* Swap bytecode container */` |
|     8216 | 10806 | `	pByteCode = pVm->pByteContainer;` |
|     8216 | 10807 | `	pVm->pByteContainer = &aByteCode;` |
|        - | 10808 | `	/* Compile the chunk */` |
|     8216 | 10809 | `	PH7_CompileScript(pVm,pChunk,iFlags);` |
|    12323 | 10810 | `	if( pVm->sCodeGen.nErr > 0 ){` |
...
|        - | 10820 | `		sxi32 rc;` |
|     8214 | 10821 | `		SyHashResetLoopCursor(&pVm->hClass);` |
|   239758 | 10822 | `		while((pEntry = SyHashGetNextEntry(&pVm->hClass)) != 0 ){` |
|   227440 | 10823 | `			pClass = (ph7_class *)pEntry->pUserData;` |
|        - | 10824 | `			/* Only mount classes that haven't been mounted yet */` |
|   227440 | 10825 | `			if( !pClass->bMounted ){` |
|    45862 | 10826 | `				rc = VmMountUserClass(pVm,pClass);` |
|    45862 | 10827 | `				if( rc != SXRET_OK ){` |
...
|    22930 | 10834 | `			}` |
|        2 | 10835 | `		}` |
|     8214 | 10836 | `		if( SXRET_OK != PH7_VmEmitInstr(pVm,PH7_OP_DONE,0,0,0,0) ){` |
|        - | 10837 | `			/* Out of memory */` |
|      ! 0 | 10838 | `			if( pCtx ){` |
...
|        - | 10842 | `		}` |
|     8214 | 10843 | `		if( bTrueReturn ){` |
|        - | 10844 | `			/* Assume a boolean true return value */` |
|     6711 | 10845 | `			PH7_MemObjInitFromBool(pVm,&sResult,1);` |
|     3356 | 10846 | `		}else{` |
|        - | 10847 | `			/* Assume a null return value */` |
|     1504 | 10848 | `			PH7_MemObjInit(pVm,&sResult);` |
|        - | 10849 | `		}` |
|        - | 10850 | `		/* Execute the compiled chunk */` |
|     8214 | 10851 | `		VmLocalExec(pVm,&aByteCode,&sResult);` |
|     8214 | 10852 | `		if( pCtx ){` |
|        - | 10853 | `			/* Set the execution result */` |
|     6728 | 10854 | `			ph7_result_value(pCtx,&sResult);` |
|     3363 | 10855 | `		}` |
|     8214 | 10856 | `		PH7_MemObjRelease(&sResult);` |
|        - | 10857 | `	}` |
|     4107 | 10858 | `Cleanup:` |
|        - | 10859 | `	/* Cleanup the mess left behind */` |
|     8216 | 10860 | `	pVm->pByteContainer = pByteCode;` |
|     8216 | 10861 | `	SySetRelease(&aByteCode);` |
|     8216 | 10862 | `	return SXRET_OK;` |
|        2 | 10863 |  |
|        - | 10864 | `/*` |
...
|        - | 10895 | ` */` |
|    13416 | 10896 | `static int VmIsIncludedFile(ph7_vm *pVm,SyString *pFile)` |
|        1 | 10897 |  |
|        - | 10898 | `	SyString *aEntries;` |
|        - | 10899 | `	sxu32 n;` |
|    13417 | 10900 | `	aEntries = (SyString *)SySetBasePtr(&pVm->aIncluded);` |
|        - | 10901 | `	/* Perform a linear search */` |
| 44986263 | 10902 | `	for( n = 0 ; n < SySetUsed(&pVm->aIncluded) ; ++n ){` |
| 44972853 | 10903 | `		if( SyStringCmp(pFile,&aEntries[n],SyMemcmp) == 0 ){` |
|        - | 10904 | `			/* Already included */` |
|        7 | 10905 | `			return TRUE;` |
|        - | 10906 | `		}` |
| 22486424 | 10907 | `	}` |
|    13411 | 10908 | `	return FALSE;` |
|     6709 | 10909 |  |
|        - | 10910 | `/*` |
|        - | 10911 | ` * Push a file path in the appropriate VM container.` |
|        - | 10912 | ` */` |
|    14894 | 10913 | `PH7_PRIVATE sxi32 PH7_VmPushFilePath(ph7_vm *pVm,const char *zPath,int nLen,sxu8 bMain,sxi32 *pNew)` |
|        2 | 10914 |  |
...
|        - | 10919 | `#endif` |
|        - | 10920 | `	sxi32 rc;` |
|    14896 | 10921 | `	if( nLen < 0 ){` |
|     1480 | 10922 | `		nLen = SyStrlen(zPath);` |
|      739 | 10923 | `	}` |
|        - | 10924 | `	/* Duplicate the file path first */` |
|    14896 | 10925 | `	zDup = SyMemBackendStrDup(&pVm->sAllocator,zPath,nLen);` |
|    14896 | 10926 | `	if( zDup == 0 ){` |
...
|    14896 | 10948 | `	SyStringInitFromBuf(&sPath,zDup,nLen);` |
|    14896 | 10949 | `	if( !bMain ){` |
|    13417 | 10950 | `		if( VmIsIncludedFile(&(*pVm),&sPath) ){` |
|        - | 10951 | `			/* Already included */` |
|        7 | 10952 | `			*pNew = 0;` |
|        4 | 10953 | `		}else{` |
|        - | 10954 | `			/* Insert in the corresponding container */` |
|    13411 | 10955 | `			rc = SySetPut(&pVm->aIncluded,(const void *)&sPath);` |
|    13411 | 10956 | `			if( rc != SXRET_OK ){` |
...
|        - | 10961 | `		}` |
|     6708 | 10962 | `	}` |
|    14896 | 10963 | `	SySetPut(&pVm->aFiles,(const void *)&sPath);` |
|    14896 | 10964 | `	return SXRET_OK;` |
|     7449 | 10965 |  |
|        - | 10966 | `/*` |
...
|        - | 10977 | ` */` |
|     6716 | 10978 | `static sxi32 VmExecIncludedFile(` |
...
|     6718 | 10992 | `	pVm = pCtx->pVm;` |
|     6718 | 10993 | `	SyBlobInit(&sContents,&pVm->sAllocator);` |
|     6718 | 10994 | `	isNew = 0;` |
|        - | 10995 | `	/* Extract the associated stream */` |
|     6718 | 10996 | `	pStream = PH7_VmGetStreamDevice(pVm,&pPath->zString,pPath->nByte);` |
|        - | 10997 | `	/*` |
|        - | 10998 | `	 * Open the file or the URL [i.e: http://ph7.symisc.net/example/hello.php"]` |
|        - | 10999 | `	 * in a read-only mode.` |
|        - | 11000 | `	 */` |
|     6718 | 11001 | `	pHandle = PH7_StreamOpenHandle(pVm,pStream,pPath->zString,PH7_IO_OPEN_RDONLY,TRUE,0,TRUE,&isNew);` |
|     6718 | 11002 | `	if( pHandle == 0 ){` |
|        3 | 11003 | `		return SXERR_IO;` |
|        - | 11004 | `	}` |
|     6715 | 11005 | `	rc = SXRET_OK; /* Stupid cc warning */` |
|     6715 | 11006 | `	if( IncludeOnce && !isNew ){` |
|        - | 11007 | `		/* Already included */` |
|        5 | 11008 | `		rc = SXERR_EXISTS;` |
|        3 | 11009 | `	}else{` |
|        - | 11010 | `		/* Read the whole file contents */` |
|     6711 | 11011 | `		rc = PH7_StreamReadWholeFile(pHandle,pStream,&sContents);` |
|     6711 | 11012 | `		if( rc == SXRET_OK ){` |
|        - | 11013 | `			SyString sScript;` |
|        - | 11014 | `			/* Compile and execute the script */` |
|     6711 | 11015 | `			SyStringInitFromBuf(&sScript,SyBlobData(&sContents),SyBlobLength(&sContents));` |
|     6711 | 11016 | `			VmEvalChunk(pCtx->pVm,&(*pCtx),&sScript,0,TRUE);` |
|     3355 | 11017 | `		}` |
|        - | 11018 | `	}` |
|        - | 11019 | `	/* Pop from the set of included file */` |
|     6715 | 11020 | `	(void)SySetPop(&pVm->aFiles);` |
|        - | 11021 | `	/* Close the handle */` |
|     6715 | 11022 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|        - | 11023 | `	/* Release the working buffer */` |
|     6715 | 11024 | `	SyBlobRelease(&sContents);` |
|        - | 11025 | `#else` |
...
|     2925 | 11098 | `	while( SXRET_OK == SySetGetNextEntry(pFiles,(void **)&pEntry) ){` |
|        - | 11099 | `		const char *zBase,*zEnd;` |
|        - | 11100 | `		int iLen;` |
|        - | 11101 | `		/* reset the string cursor */` |
|     2923 | 11102 | `		ph7_value_reset_string_cursor(pWorker);` |
|        - | 11103 | `		/* Extract base name */` |
|     2923 | 11104 | `		zEnd = &pEntry->zString[pEntry->nByte - 1];` |
|        - | 11105 | `		/* Ignore trailing '/' */` |
|     4384 | 11106 | `		while( zEnd > pEntry->zString && ( (int)zEnd[0] == c \|\| (int)zEnd[0] == d ) ){` |
|      ! 0 | 11107 | `			zEnd--;` |
|      ! 0 | 11108 | `		}` |
|     2923 | 11109 | `		iLen = (int)(&zEnd[1]-pEntry->zString);` |
|    84182 | 11110 | `		while( zEnd > pEntry->zString && ( (int)zEnd[0] != c && (int)zEnd[0] != d ) ){` |
|    79799 | 11111 | `			zEnd--;` |
|        1 | 11112 | `		}` |
|     2923 | 11113 | `		zBase = (zEnd > pEntry->zString) ? &zEnd[1] : pEntry->zString;` |
|     2923 | 11114 | `		zEnd = &pEntry->zString[iLen];` |
|        - | 11115 | `		/* Copy entry name */` |
|     2923 | 11116 | `		ph7_value_string(pWorker,zBase,(int)(zEnd-zBase));` |
|        - | 11117 | `		/* Perform the insertion */` |
|     2923 | 11118 | `		ph7_array_add_elem(pArray,0/* Automatic index assign*/,pWorker); /* Will make it's own copy */` |
|        1 | 11119 | `	}` |
...
|        - | 11147 | ` */` |
|     6704 | 11148 | `static int vm_builtin_include(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 | 11149 |  |
|        - | 11150 | `	SyString sFile;` |
|        - | 11151 | `	sxi32 rc;` |
|     6706 | 11152 | `	if( nArg < 1 ){` |
|        - | 11153 | `		/* Nothing to evaluate,return NULL */` |
|      ! 0 | 11154 | `		ph7_result_null(pCtx);` |
|      ! 0 | 11155 | `		return SXRET_OK;` |
|        - | 11156 | `	}` |
|        - | 11157 | `	/* File to include */` |
|     6706 | 11158 | `	sFile.zString = ph7_value_to_string(apArg[0],(int *)&sFile.nByte);` |
|     6706 | 11159 | `	if( sFile.nByte < 1 ){` |
...
|     6706 | 11165 | `	rc = VmExecIncludedFile(&(*pCtx),&sFile,FALSE);` |
|     6706 | 11166 | `	if( rc != SXRET_OK ){` |
...
|        - | 14057 | ` */` |
|     1228 | 14058 | `static sxi32 VmRegisterSpecialFunction(ph7_vm *pVm)` |
|        2 | 14059 |  |
|        - | 14060 | `	sxi32 rc;` |
|        - | 14061 | `	sxu32 n;` |
|   153502 | 14062 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVmFunc) ; ++n ){` |
|        - | 14063 | `		/* Note that these special functions have access` |
|        - | 14064 | `		 * to the underlying virtual machine as their` |
|        - | 14065 | `		 * private data.` |
|        - | 14066 | `		 */` |
|   152274 | 14067 | `		rc = ph7_create_function(&(*pVm),aVmFunc[n].zName,aVmFunc[n].xFunc,&(*pVm));` |
|   152274 | 14068 | `		if( rc != SXRET_OK ){` |
|      ! 0 | 14069 | `			return rc;` |
|        - | 14070 | `		}` |
|    76138 | 14071 | `	}` |
|     1230 | 14072 | `	return SXRET_OK;` |
|      616 | 14073 |  |
|        - | 14074 | `/*` |
|        - | 14075 | ` * Check if the given name refer to an installed class.` |
|        - | 14076 | ` * Return a pointer to that class on success. NULL on failure.` |
|        - | 14077 | ` */` |
|     8264 | 14078 | `PH7_PRIVATE ph7_class * PH7_VmExtractClass(` |
...
|     4132 | 14090 | `		SXUNUSED(iNest);` |
|        - | 14091 | `	/* Perform a hash lookup */` |
|     8266 | 14092 | `	pEntry = SyHashGet(&pVm->hClass,(const void *)zName,nByte);` |
|        - | 14093 |  |
|     8266 | 14094 | `	if( pEntry == 0 ){` |
|        - | 14095 | `		/* No such entry,return NULL */` |
|      ! 0 | 14096 | `		return 0;` |
|        - | 14097 | `	}` |
|     8266 | 14098 | `	pClass = (ph7_class *)pEntry->pUserData;` |
|     8266 | 14099 | `	if( !iLoadable ){` |
|        - | 14100 | `		/* Return the first class seen */` |
|     7594 | 14101 | `		return pClass;` |
|      ! 0 | 14102 | `	}else{` |
|        - | 14103 | `		/* Check the collision list */` |
|      674 | 14104 | `		while(pClass){` |
|      674 | 14105 | `			if( (pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_ABSTRACT)) == 0 ){` |
|        - | 14106 | `				/* Class is loadable */` |
|      674 | 14107 | `				return pClass;` |
|        - | 14108 | `			}` |
...
|        - | 14129 | ` */` |
|  2772670 | 14130 | `static VmRefObj * VmNewRefObj(ph7_vm *pVm,sxu32 nIdx)` |
|        2 | 14131 |  |
|        - | 14132 | `	VmRefObj *pRef;` |
|        - | 14133 | `	/* Allocate a new instance */` |
|  2772672 | 14134 | `	pRef = (VmRefObj *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmRefObj));` |
|  2772672 | 14135 | `	if( pRef == 0 ){` |
|      ! 0 | 14136 | `		return 0;` |
|        - | 14137 | `	}` |
|        - | 14138 | `	/* Zero the structure */` |
|  2772672 | 14139 | `	SyZero(pRef,sizeof(VmRefObj));` |
|        - | 14140 | `	/* Initialize fields */` |
|  2772672 | 14141 | `	SySetInit(&pRef->aReference,&pVm->sAllocator,sizeof(SyHashEntry *));` |
|  2772672 | 14142 | `	SySetInit(&pRef->aArrEntries,&pVm->sAllocator,sizeof(ph7_hashmap_node *));` |
|  2772672 | 14143 | `	pRef->nIdx = nIdx;` |
|  2772672 | 14144 | `	return pRef;` |
|  1386337 | 14145 |  |
|        - | 14146 | `/*` |
|        - | 14147 | ` * Default hash function used by the reference table` |
|        - | 14148 | ` * for lookup/insertion operations.` |
|        - | 14149 | ` */` |
| 15672082 | 14150 | `static sxu32 VmRefHash(sxu32 nIdx)` |
|        2 | 14151 |  |
|        - | 14152 | `	/* Calculate the hash based on the memory object index */` |
| 15672084 | 14153 | `	return nIdx ^ (nIdx << 8) ^ (nIdx >> 8);` |
|        2 | 14154 |  |
|        - | 14155 | `/*` |
...
|        - | 14165 | ` * extension.` |
|        - | 14166 | ` */` |
|  8291056 | 14167 | `static VmRefObj * VmRefObjExtract(ph7_vm *pVm,sxu32 nObjIdx)` |
|        2 | 14168 |  |
|        - | 14169 | `	VmRefObj *pRef;` |
|        - | 14170 | `	sxu32 nBucket;` |
|        - | 14171 | `	/* Point to the appropriate bucket */` |
|  8291058 | 14172 | `	nBucket = VmRefHash(nObjIdx) & (pVm->nRefSize - 1);` |
|        - | 14173 | `	/* Perform the lookup */` |
|  8291058 | 14174 | `	pRef = pVm->apRefObj[nBucket];` |
| 17076705 | 14175 | `	for(;;){` |
| 34160270 | 14176 | `		if( pRef == 0 ){` |
|  2828558 | 14177 | `			break;` |
|        - | 14178 | `		}` |
| 31331714 | 14179 | `		if( pRef->nIdx == nObjIdx ){` |
|        - | 14180 | `			/* Entry found */` |
|  5462502 | 14181 | `			return pRef;` |
|        - | 14182 | `		}` |
|        - | 14183 | `		/* Point to the next entry */` |
| 25869214 | 14184 | `		pRef = pRef->pNextCollide;` |
|        2 | 14185 | `	}` |
|        - | 14186 | `	/* No such entry,return NULL */` |
|  2828558 | 14187 | `	return 0;` |
|  4145530 | 14188 |  |
|        - | 14189 | `/*` |
...
|        - | 14197 | ` * extension.` |
|        - | 14198 | ` */` |
|  2772670 | 14199 | `static sxi32 VmRefObjInsert(ph7_vm *pVm,VmRefObj *pRef)` |
|        2 | 14200 |  |
|        - | 14201 | `	sxu32 nBucket;` |
|  2772672 | 14202 | `	if( pVm->nRefUsed * 3 >= pVm->nRefSize ){` |
|        - | 14203 | `		VmRefObj **apNew;` |
|        - | 14204 | `		sxu32 nNew;` |
|        - | 14205 | `		/* Allocate a larger table */` |
|     1702 | 14206 | `		nNew = pVm->nRefSize << 1;` |
|     1702 | 14207 | `		apNew = (VmRefObj **)SyMemBackendAlloc(&pVm->sAllocator,sizeof(VmRefObj *) * nNew);` |
|     1702 | 14208 | `		if( apNew ){` |
|     1702 | 14209 | `			VmRefObj *pEntry = pVm->pRefList;` |
|        - | 14210 | `			sxu32 n;` |
|        - | 14211 | `			/* Zero the structure */` |
|     1702 | 14212 | `			SyZero((void *)apNew,nNew * sizeof(VmRefObj *));` |
|        - | 14213 | `			/* Rehash all referenced entries */` |
|  2813448 | 14214 | `			for( n = 0 ; n < pVm->nRefUsed ; ++n ){` |
|        - | 14215 | `				/* Remove old collision links */` |
|  2811748 | 14216 | `				pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|        - | 14217 | `				/* Point to the appropriate bucket */` |
|  2811748 | 14218 | `				nBucket = VmRefHash(pEntry->nIdx) & (nNew - 1);` |
|        - | 14219 | `				/* Insert the entry  */` |
|  2811748 | 14220 | `				pEntry->pNextCollide = apNew[nBucket];` |
|  2811748 | 14221 | `				if( apNew[nBucket] ){` |
|  2298042 | 14222 | `					apNew[nBucket]->pPrevCollide = pEntry;` |
|  1149020 | 14223 | `				}` |
|  2811748 | 14224 | `				apNew[nBucket] = pEntry;` |
|        - | 14225 | `				/* Point to the next entry */` |
|  2811748 | 14226 | `				pEntry = pEntry->pNext;` |
|  1405875 | 14227 | `			}` |
|        - | 14228 | `			/* Release the old table */` |
|     1702 | 14229 | `			SyMemBackendFree(&pVm->sAllocator,pVm->apRefObj);` |
|        - | 14230 | `			/* Install the new one */` |
|     1702 | 14231 | `			pVm->apRefObj = apNew;` |
|     1702 | 14232 | `			pVm->nRefSize = nNew;` |
|      850 | 14233 | `		}` |
|      850 | 14234 | `	}` |
|        - | 14235 | `	/* Point to the appropriate bucket */` |
|  2772672 | 14236 | `	nBucket = VmRefHash(pRef->nIdx) & (pVm->nRefSize - 1);` |
|        - | 14237 | `	/* Insert the entry */` |
|  2772672 | 14238 | `	pRef->pNextCollide = pVm->apRefObj[nBucket];` |
|  2772672 | 14239 | `	if( pVm->apRefObj[nBucket] ){` |
|  2294929 | 14240 | `		pVm->apRefObj[nBucket]->pPrevCollide = pRef;` |
|  1147401 | 14241 | `	}` |
|  2772672 | 14242 | `	pVm->apRefObj[nBucket] = pRef;` |
|  2772672 | 14243 | `	MACRO_LD_PUSH(pVm->pRefList,pRef);` |
|  2772672 | 14244 | `	pVm->nRefUsed++;` |
|  2772672 | 14245 | `	return SXRET_OK;` |
|        2 | 14246 |  |
|        - | 14247 | `/*` |
...
|        - | 14257 | ` * extension.` |
|        - | 14258 | ` */` |
|  2753620 | 14259 | `static sxi32 VmRefObjUnlink(ph7_vm *pVm,VmRefObj *pRef)` |
|        2 | 14260 |  |
|        - | 14261 | `	ph7_hashmap_node **apNode;` |
|        - | 14262 | `	SyHashEntry **apEntry;` |
|        - | 14263 | `	sxu32 n;` |
|        - | 14264 | `	/* Point to the reference table */` |
|  2753622 | 14265 | `	apNode = (ph7_hashmap_node **)SySetBasePtr(&pRef->aArrEntries);` |
|  2753622 | 14266 | `	apEntry = (SyHashEntry **)SySetBasePtr(&pRef->aReference);` |
|        - | 14267 | `	/* Unlink the entry from the reference table */` |
|  2813878 | 14268 | `	for( n = 0 ; n < SySetUsed(&pRef->aReference) ; n++ ){` |
|    60258 | 14269 | `		if( apEntry[n] ){` |
|    60226 | 14270 | `			SyHashDeleteEntry2(apEntry[n]);` |
|    30112 | 14271 | `		}` |
|    30130 | 14272 | `	}` |
|  5450260 | 14273 | `	for(n = 0 ; n < SySetUsed(&pRef->aArrEntries) ; ++n ){` |
|  2696640 | 14274 | `		if( apNode[n] ){` |
|     5059 | 14275 | `			PH7_HashmapUnlinkNode(apNode[n],FALSE);` |
|     2529 | 14276 | `		}` |
|  1348321 | 14277 | `	}` |
|  2753622 | 14278 | `	if( pRef->pPrevCollide ){` |
|   957012 | 14279 | `		pRef->pPrevCollide->pNextCollide = pRef->pNextCollide;` |
|   478467 | 14280 | `	}else{` |
|  1796612 | 14281 | `		pVm->apRefObj[VmRefHash(pRef->nIdx) & (pVm->nRefSize - 1)] = pRef->pNextCollide;` |
|        - | 14282 | `	}` |
|  2753622 | 14283 | `	if( pRef->pNextCollide ){` |
|  1494312 | 14284 | `		pRef->pNextCollide->pPrevCollide = pRef->pPrevCollide;` |
|   747000 | 14285 | `	}` |
|  2753622 | 14286 | `	MACRO_LD_REMOVE(pVm->pRefList,pRef);` |
|        - | 14287 | `	/* Release the node */` |
|  2753622 | 14288 | `	SySetRelease(&pRef->aReference);` |
|  2753622 | 14289 | `	SySetRelease(&pRef->aArrEntries);` |
|  2753622 | 14290 | `	SyMemBackendPoolFree(&pVm->sAllocator,pRef);` |
|  2753622 | 14291 | `	pVm->nRefUsed--;` |
|  2753622 | 14292 | `	return SXRET_OK;` |
|        2 | 14293 |  |
|        - | 14294 | `/*` |
...
|        - | 14301 | ` * extension.` |
|        - | 14302 | ` */` |
|  2789932 | 14303 | `PH7_PRIVATE sxi32 PH7_VmRefObjInstall(` |
...
|        - | 14309 | `	)` |
|        2 | 14310 |  |
|  2789934 | 14311 | `	VmFrame *pFrame = pVm->pFrame;` |
|        - | 14312 | `	VmRefObj *pRef;` |
|        - | 14313 | `	/* Check if the referenced object already exists */` |
|  2789934 | 14314 | `	pRef = VmRefObjExtract(&(*pVm),nIdx);` |
|  2789934 | 14315 | `	if( pRef == 0 ){` |
|        - | 14316 | `		/* Create a new entry */` |
|  2772672 | 14317 | `		pRef = VmNewRefObj(&(*pVm),nIdx);` |
|  2772672 | 14318 | `		if( pRef == 0 ){` |
|      ! 0 | 14319 | `			return SXERR_MEM;` |
|        - | 14320 | `		}` |
|  2772672 | 14321 | `		pRef->iFlags = iFlags;` |
|        - | 14322 | `		/* Install the entry */` |
|  2772672 | 14323 | `		VmRefObjInsert(&(*pVm),pRef);` |
|  1386335 | 14324 | `	}` |
|  2794846 | 14325 | `	while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|        - | 14326 | `		/* Safely ignore the exception frame */` |
|     4914 | 14327 | `		pFrame = pFrame->pParent;` |
|        2 | 14328 | `	}` |
|  2789934 | 14329 | `	if( pFrame->pParent != 0 && pEntry ){` |
|        - | 14330 | `		VmSlot sRef;` |
|        - | 14331 | `		/* Local frame,record referenced entry so that it can` |
|        - | 14332 | `		 * be deleted when we leave this frame.` |
|        - | 14333 | `		 */` |
|    55900 | 14334 | `		sRef.nIdx = nIdx;` |
|    55900 | 14335 | `		sRef.pUserData = pEntry;` |
|    55900 | 14336 | `		if( SXRET_OK != SySetPut(&pFrame->sRef,(const void *)&sRef)) {` |
|      ! 0 | 14337 | `			pEntry = 0; /* Do not record this entry */` |
|      ! 0 | 14338 | `		}` |
|    27949 | 14339 | `	}` |
|  2789934 | 14340 | `	if( pEntry ){` |
|        - | 14341 | `		/* Address of the hash-entry */` |
|    72996 | 14342 | `		SySetPut(&pRef->aReference,(const void *)&pEntry);` |
|    36497 | 14343 | `	}` |
|  2789934 | 14344 | `	if( pMapEntry ){` |
|        - | 14345 | `		/* Address of the hashmap node [i.e: Array entry] */` |
|  2714144 | 14346 | `		SySetPut(&pRef->aArrEntries,(const void *)&pMapEntry);` |
|  1357071 | 14347 | `	}` |
|  2789934 | 14348 | `	return SXRET_OK;` |
|  1394968 | 14349 |  |
|        - | 14350 | `/*` |
...
|        - | 14357 | ` * extension.` |
|        - | 14358 | ` */` |
|  2747484 | 14359 | `PH7_PRIVATE sxi32 PH7_VmRefObjRemove(` |
...
|  2747486 | 14369 | `	pRef = VmRefObjExtract(&(*pVm),nIdx);` |
|  2747486 | 14370 | `	if( pRef == 0 ){` |
|        - | 14371 | `		/* Not such entry */` |
|    55868 | 14372 | `		return SXERR_NOTFOUND;` |
|        - | 14373 | `	}` |
|        - | 14374 | `	/* Remove the desired entry */` |
|  2691620 | 14375 | `	if( pEntry ){` |
...
|       49 | 14388 | `		}` |
|       16 | 14389 | `	}` |
|  2691620 | 14390 | `	if( pMapEntry ){` |
|        - | 14391 | `		ph7_hashmap_node **apNode;` |
|  2691588 | 14392 | `		apNode = (ph7_hashmap_node **)SySetBasePtr(&pRef->aArrEntries);` |
|  5383262 | 14393 | `		for(n = 0 ; n < SySetUsed(&pRef->aArrEntries) ; n++ ){` |
|  2691676 | 14394 | `			if( apNode[n] == pMapEntry ){` |
|        - | 14395 | `				/* nullify the entry */` |
|  2691588 | 14396 | `				apNode[n] = 0;` |
|  1345793 | 14397 | `			}` |
|  1345839 | 14398 | `		}` |
|  1345793 | 14399 | `	}` |
|  2691620 | 14400 | `	return SXRET_OK;` |
|  1373744 | 14401 |  |
...
|        - | 14410 | ` */` |
|    19336 | 14411 | `PH7_PRIVATE const ph7_io_stream * PH7_VmGetStreamDevice(` |
...
|    19338 | 14423 | `	zNext = zCur = zIn = *pzDevice;` |
|    19338 | 14424 | `	zEnd = &zIn[nByte];` |
|  1191412 | 14425 | `	while( zIn < zEnd ){` |
|  1172078 | 14426 | `		if( zIn < &zEnd[-3]/*://*/ && zIn[0] == ':' && zIn[1] == '/' && zIn[2] == '/' ){` |
|        - | 14427 | `			/* Got one */` |
...
|  1172076 | 14432 | `		zIn++;` |
|        2 | 14433 | `	}` |
|    19338 | 14434 | `	if( zIn >= zEnd ){` |
|        - | 14435 | `		/* No such scheme,return the default stream */` |
|    19336 | 14436 | `		return pVm->pDefStream;` |
|        - | 14437 | `	}` |
