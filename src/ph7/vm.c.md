...
Coverage: 4944/6546 lines (75.53%)
...
|        - |    95 | ` */` |
|   785356 |    96 | `static sxi32 VmIsUnorderedCmp(ph7_value *pLeft,ph7_value *pRight)` |
|        2 |    97 |  |
|   785358 |    98 | `	if( (pLeft->iFlags & MEMOBJ_REAL) && PH7_IS_NAN(pLeft->rVal) ){` |
|       32 |    99 | `		return TRUE;` |
|        - |   100 | `	}` |
|   785328 |   101 | `	if( (pRight->iFlags & MEMOBJ_REAL) && PH7_IS_NAN(pRight->rVal) ){` |
|        9 |   102 | `		return TRUE;` |
|        - |   103 | `	}` |
|   785320 |   104 | `	return FALSE;` |
|   392702 |   105 |  |
...
|        - |   119 | ` */` |
|   564652 |   120 | `PH7_PRIVATE sxi32 PH7_VmRegisterConstant(` |
...
|        - |   129 | `	char *zDupName;` |
|        - |   130 | `	sxi32 rc;` |
|   564654 |   131 | `	pEntry = SyHashGet(&pVm->hConstant,(const void *)pName->zString,pName->nByte);` |
|   564654 |   132 | `	if( pEntry ){` |
...
|   564650 |   140 | `	pCons = (ph7_constant *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_constant));` |
|   564650 |   141 | `	if( pCons == 0 ){` |
|      ! 0 |   142 | `		return 0;` |
|        - |   143 | `	}` |
|        - |   144 | `	/* Duplicate constant name */` |
|   564650 |   145 | `	zDupName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|   564650 |   146 | `	if( zDupName == 0 ){` |
|      ! 0 |   147 | `		SyMemBackendPoolFree(&pVm->sAllocator,pCons);` |
|      ! 0 |   148 | `		return 0;` |
|        - |   149 | `	}` |
|        - |   150 | `	/* Install the constant */` |
|   564650 |   151 | `	SyStringInitFromBuf(&pCons->sName,zDupName,pName->nByte);` |
|   564650 |   152 | `	pCons->xExpand = xExpand;` |
|   564650 |   153 | `	pCons->pUserData = pUserData;` |
|   564650 |   154 | `	rc = SyHashInsert(&pVm->hConstant,(const void *)zDupName,SyStringLength(&pCons->sName),pCons);` |
|   564650 |   155 | `	if( rc != SXRET_OK ){` |
...
|        - |   169 | ` */` |
|  1235686 |   170 | `static sxi32 PH7_NewForeignFunction(` |
...
|  1235688 |   181 | `	pFunc = (ph7_user_func *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_user_func));` |
|  1235688 |   182 | `	if( pFunc == 0 ){` |
|      ! 0 |   183 | `		return SXERR_MEM;` |
|        - |   184 | `	}` |
|        - |   185 | `	/* Duplicate function name */` |
|  1235688 |   186 | `	zDup = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|  1235688 |   187 | `	if( zDup == 0 ){` |
|      ! 0 |   188 | `		SyMemBackendPoolFree(&pVm->sAllocator,pFunc);` |
|      ! 0 |   189 | `		return SXERR_MEM;` |
|        - |   190 | `	}` |
|        - |   191 | `	/* Zero the structure */` |
|  1235688 |   192 | `	SyZero(pFunc,sizeof(ph7_user_func));` |
|        - |   193 | `	/* Initialize structure fields */` |
|  1235688 |   194 | `	SyStringInitFromBuf(&pFunc->sName,zDup,pName->nByte);` |
|  1235688 |   195 | `	pFunc->pVm   = pVm;` |
|  1235688 |   196 | `	pFunc->xFunc = xFunc;` |
|  1235688 |   197 | `	pFunc->pUserData = pUserData;` |
|  1235688 |   198 | `	SySetInit(&pFunc->aAux,&pVm->sAllocator,sizeof(ph7_aux_data));` |
|        - |   199 | `	/* Write a pointer to the new function */` |
|  1235688 |   200 | `	*ppOut = pFunc;` |
|  1235688 |   201 | `	return SXRET_OK;` |
|   617845 |   202 |  |
|        - |   203 | `/*` |
...
|        - |   210 | ` */` |
|  1238288 |   211 | `PH7_PRIVATE sxi32 PH7_VmInstallForeignFunction(` |
...
|  1238290 |   222 | `	pEntry = SyHashGet(&pVm->hHostFunction,pName->zString,pName->nByte);` |
|  1238290 |   223 | `	if( pEntry ){` |
|     2604 |   224 | `		pFunc = (ph7_user_func *)pEntry->pUserData;` |
|     2604 |   225 | `		pFunc->pUserData = pUserData;` |
|     2604 |   226 | `		pFunc->xFunc = xFunc;` |
|     2604 |   227 | `		SySetReset(&pFunc->aAux);` |
|     2604 |   228 | `		return SXRET_OK;` |
|        - |   229 | `	}` |
|        - |   230 | `	/* Create a new user function */` |
|  1235688 |   231 | `	rc = PH7_NewForeignFunction(&(*pVm),&(*pName),xFunc,pUserData,&pFunc);` |
|  1235688 |   232 | `	if( rc != SXRET_OK ){` |
|      ! 0 |   233 | `		return rc;` |
|        - |   234 | `	}` |
|        - |   235 | `	/* Install the function in the corresponding hashtable */` |
|  1235688 |   236 | `	rc = SyHashInsert(&pVm->hHostFunction,SyStringData(&pFunc->sName),pName->nByte,pFunc);` |
|  1235688 |   237 | `	if( rc != SXRET_OK ){` |
...
|  1235688 |   243 | `	return SXRET_OK;` |
|   619146 |   244 |  |
|        - |   245 | `/*` |
|        - |   246 | ` * Initialize a VM function.` |
|        - |   247 | ` */` |
|   175674 |   248 | `PH7_PRIVATE sxi32 PH7_VmInitFuncState(` |
...
|   175676 |   258 | `	SyZero(pFunc,sizeof(ph7_vm_func));` |
|        - |   259 | `	/* Initialize structure fields */` |
|        - |   260 | `	/* Arguments container */` |
|   175676 |   261 | `	SySetInit(&pFunc->aArgs,&pVm->sAllocator,sizeof(ph7_vm_func_arg));` |
|        - |   262 | `	/* Static variable container */` |
|   175676 |   263 | `	SySetInit(&pFunc->aStatic,&pVm->sAllocator,sizeof(ph7_vm_func_static_var));` |
|        - |   264 | `	/* Bytecode container */` |
|   175676 |   265 | `	SySetInit(&pFunc->aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|        - |   266 | `    /* Preallocate some instruction slots */` |
|   175676 |   267 | `	SySetAlloc(&pFunc->aByteCode,0x10);` |
|        - |   268 | `	/* Closure environment */` |
|   175676 |   269 | `	SySetInit(&pFunc->aClosureEnv,&pVm->sAllocator,sizeof(ph7_vm_func_closure_env));` |
|   175676 |   270 | `	pFunc->iFlags = iFlags;` |
|   175676 |   271 | `	pFunc->pUserData = pUserData;` |
|   175676 |   272 | `	SyStringInitFromBuf(&pFunc->sName,zName,nByte);` |
|   175676 |   273 | `	return SXRET_OK;` |
|        2 |   274 |  |
|        - |   275 | `/*` |
...
|        - |   282 | ` */` |
|   595628 |   283 | `PH7_PRIVATE sxi32 PH7_VmInstallUserFunction(` |
...
|        - |   290 | `	sxi32 rc;` |
|   595630 |   291 | `	if( pName == 0 ){` |
|        - |   292 | `		/* Use the built-in name */` |
|    37850 |   293 | `		pName = &pFunc->sName;` |
|    18924 |   294 | `	}` |
|        - |   295 | `	/* Check for duplicates (functions with the same name) first */` |
|   595630 |   296 | `	pEntry = SyHashGet(&pVm->hFunction,pName->zString,pName->nByte);` |
|   595630 |   297 | `	if( pEntry ){` |
|   443116 |   298 | `		ph7_vm_func *pLink = (ph7_vm_func *)pEntry->pUserData;` |
|   443116 |   299 | `		if( pLink != pFunc ){` |
|        - |   300 | `			/* Link */` |
|      184 |   301 | `			pFunc->pNextName = pLink;` |
|      184 |   302 | `			pEntry->pUserData = pFunc;` |
|       91 |   303 | `		}` |
|   443116 |   304 | `		return SXRET_OK;` |
|        - |   305 | `	}` |
|        - |   306 | `	/* First time seen */` |
|   152516 |   307 | `	pFunc->pNextName = 0;` |
|   152516 |   308 | `	rc = SyHashInsert(&pVm->hFunction,pName->zString,pName->nByte,pFunc);` |
|   152516 |   309 | `	return rc;` |
|   297816 |   310 |  |
|        - |   311 | `/*` |
|        - |   312 | ` * Install a user defined class in the corresponding VM container.` |
|        - |   313 | ` */` |
|    43408 |   314 | `PH7_PRIVATE sxi32 PH7_VmInstallClass(` |
|        - |   315 | `	ph7_vm *pVm,      /* Target VM  */` |
|        - |   316 | `	ph7_class *pClass /* Target Class */` |
|        - |   317 | `	)` |
|        2 |   318 |  |
|    43410 |   319 | `	SyString *pName = &pClass->sName;` |
|        - |   320 | `	SyHashEntry *pEntry;` |
|        - |   321 | `	sxi32 rc;` |
|        - |   322 | `	/* Check for duplicates */` |
|    43410 |   323 | `	pEntry = SyHashGet(&pVm->hClass,(const void *)pName->zString,pName->nByte);` |
|    43410 |   324 | `	if( pEntry ){` |
...
|        - |   330 | `	}` |
|    43380 |   331 | `	pClass->pNextName = 0;` |
|        - |   332 | `	/* Perform a simple hashtable insertion */` |
|    43380 |   333 | `	rc = SyHashInsert(&pVm->hClass,(const void *)pName->zString,pName->nByte,pClass);` |
|    43380 |   334 | `	return rc;` |
|    21706 |   335 |  |
|        - |   336 | `/*` |
|        - |   337 | ` * Instruction builder interface.` |
|        - |   338 | ` */` |
|  3523944 |   339 | `PH7_PRIVATE sxi32 PH7_VmEmitInstr(` |
...
|  3523946 |   351 | `	sInstr.iOp = (sxu8)iOp;` |
|  3523946 |   352 | `	sInstr.iP1 = iP1;` |
|  3523946 |   353 | `	sInstr.iP2 = iP2;` |
|  3523946 |   354 | `	sInstr.p3  = p3;` |
|  3523946 |   355 | `	if( pIndex ){` |
|        - |   356 | `		/* Instruction index in the bytecode array */` |
|   203664 |   357 | `		*pIndex = SySetUsed(pVm->pByteContainer);` |
|   101831 |   358 | `	}` |
|        - |   359 | `	/* Finally,record the instruction */` |
|  3523946 |   360 | `	rc = SySetPut(pVm->pByteContainer,(const void *)&sInstr);` |
|  3523946 |   361 | `	if( rc != SXRET_OK ){` |
|      ! 0 |   362 | `		PH7_GenCompileError(&pVm->sCodeGen,E_ERROR,1,"Fatal,Cannot emit instruction due to a memory failure");` |
|        - |   363 | `		/* Fall throw */` |
|      ! 0 |   364 | `	}` |
|  3523946 |   365 | `	return rc;` |
|        2 |   366 |  |
|        - |   367 | `/*` |
|        - |   368 | ` * Swap the current bytecode container with the given one.` |
|        - |   369 | ` */` |
|   420616 |   370 | `PH7_PRIVATE sxi32 PH7_VmSetByteCodeContainer(ph7_vm *pVm,SySet *pContainer)` |
|        2 |   371 |  |
|   420618 |   372 | `	if( pContainer == 0 ){` |
|        - |   373 | `		/* Point to the default container */` |
|      ! 0 |   374 | `		pVm->pByteContainer = &pVm->aByteCode;` |
|      ! 0 |   375 | `	}else{` |
|        - |   376 | `		/* Change container */` |
|   420618 |   377 | `		pVm->pByteContainer = &(*pContainer);` |
|        - |   378 | `	}` |
|   420618 |   379 | `	return SXRET_OK;` |
|        2 |   380 |  |
|        - |   381 | `/*` |
|        - |   382 | ` * Return the current bytecode container.` |
|        - |   383 | ` */` |
|   210308 |   384 | `PH7_PRIVATE SySet * PH7_VmGetByteCodeContainer(ph7_vm *pVm)` |
|        2 |   385 |  |
|   210310 |   386 | `	return pVm->pByteContainer;` |
|        2 |   387 |  |
|        - |   388 | `/*` |
|        - |   389 | ` * Extract the VM instruction rooted at nIndex.` |
|        - |   390 | ` */` |
|   200724 |   391 | `PH7_PRIVATE VmInstr * PH7_VmGetInstr(ph7_vm *pVm,sxu32 nIndex)` |
|        2 |   392 |  |
|        - |   393 | `	VmInstr *pInstr;` |
|   200726 |   394 | `	pInstr = (VmInstr *)SySetAt(pVm->pByteContainer,nIndex);` |
|   200726 |   395 | `	return pInstr;` |
|        2 |   396 |  |
|        - |   397 | `/*` |
|        - |   398 | ` * Return the total number of VM instructions recorded so far.` |
|        - |   399 | ` */` |
|  1060248 |   400 | `PH7_PRIVATE sxu32 PH7_VmInstrLength(ph7_vm *pVm)` |
|        2 |   401 |  |
|  1060250 |   402 | `	return SySetUsed(pVm->pByteContainer);` |
|        2 |   403 |  |
|        - |   404 | `/*` |
|        - |   405 | ` * Pop the last VM instruction.` |
|        - |   406 | ` */` |
|   190974 |   407 | `PH7_PRIVATE VmInstr * PH7_VmPopInstr(ph7_vm *pVm)` |
|        2 |   408 |  |
|   190976 |   409 | `	return (VmInstr *)SySetPop(pVm->pByteContainer);` |
|        2 |   410 |  |
|        - |   411 | `/*` |
|        - |   412 | ` * Peek the last VM instruction.` |
|        - |   413 | ` */` |
|   684872 |   414 | `PH7_PRIVATE VmInstr * PH7_VmPeekInstr(ph7_vm *pVm)` |
|        2 |   415 |  |
|   684874 |   416 | `	return (VmInstr *)SySetPeek(pVm->pByteContainer);` |
|        2 |   417 |  |
|    29340 |   418 | `PH7_PRIVATE VmInstr * PH7_VmPeekNextInstr(ph7_vm *pVm)` |
|        2 |   419 |  |
|        - |   420 | `	VmInstr *aInstr;` |
|        - |   421 | `	sxu32 n;` |
|    29342 |   422 | `	n = SySetUsed(pVm->pByteContainer);` |
|    29342 |   423 | `	if( n < 2 ){` |
|      ! 0 |   424 | `		return 0;` |
|        - |   425 | `	}` |
|    29342 |   426 | `	aInstr = (VmInstr *)SySetBasePtr(pVm->pByteContainer);` |
|    29342 |   427 | `	return &aInstr[n - 2];` |
|    14672 |   428 |  |
|        - |   429 | `/*` |
|        - |   430 | ` * Allocate a new virtual machine frame.` |
|        - |   431 | ` */` |
|    16510 |   432 | `static VmFrame * VmNewFrame(` |
...
|    16512 |   440 | `	pFrame = (VmFrame *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmFrame));` |
|    16512 |   441 | `	if( pFrame == 0 ){` |
|      ! 0 |   442 | `		return 0;` |
|        - |   443 | `	}` |
|        - |   444 | `	/* Zero the structure */` |
|    16512 |   445 | `	SyZero(pFrame,sizeof(VmFrame));` |
|        - |   446 | `	/* Initialize frame fields */` |
|    16512 |   447 | `	pFrame->pUserData = pUserData;` |
|    16512 |   448 | `	pFrame->pThis = pThis;` |
|    16512 |   449 | `	pFrame->pVm = pVm;` |
|    16512 |   450 | `	SyHashInit(&pFrame->hVar,&pVm->sAllocator,0,0);` |
|    16512 |   451 | `	SySetInit(&pFrame->sArg,&pVm->sAllocator,sizeof(VmSlot));` |
|    16512 |   452 | `	SySetInit(&pFrame->sLocal,&pVm->sAllocator,sizeof(VmSlot));` |
|    16512 |   453 | `	SySetInit(&pFrame->sRef,&pVm->sAllocator,sizeof(VmSlot));` |
|    16512 |   454 | `	return pFrame;` |
|     8257 |   455 |  |
...
|        - |   460 | ` */` |
|    16468 |   461 | `static sxi32 VmEnterFrame(` |
...
|    16470 |   470 | `	pFrame = VmNewFrame(&(*pVm),pUserData,pThis);` |
|    16470 |   471 | `	if( pFrame == 0 ){` |
|      ! 0 |   472 | `		return SXERR_MEM;` |
|        - |   473 | `	}` |
|        - |   474 | `	/* Link to the list of active VM frame */` |
|    16470 |   475 | `	pFrame->pParent = pVm->pFrame;` |
|    16470 |   476 | `	pVm->pFrame = pFrame;` |
|    16470 |   477 | `	if( ppFrame ){` |
|        - |   478 | `		/* Write a pointer to the new VM frame */` |
|    13608 |   479 | `		*ppFrame = pFrame;` |
|     6803 |   480 | `	}` |
|    16470 |   481 | `	return SXRET_OK;` |
|     8236 |   482 |  |
|        - |   483 | `/*` |
...
|        - |   525 | ` */` |
|    13606 |   526 | `static void VmLeaveFrame(ph7_vm *pVm)` |
|        2 |   527 |  |
|    13608 |   528 | `		VmFrame *pCurFrame = pVm->pFrame;` |
|    13608 |   529 | `	if( pCurFrame ){` |
|        - |   530 | `		/* Unlink from the list of active VM frame */` |
|    13608 |   531 | `		pVm->pFrame = pCurFrame->pParent;` |
|    13608 |   532 | `		if( pCurFrame->pParent && (pCurFrame->iFlags & VM_FRAME_EXCEPTION) == 0 ){` |
|        - |   533 | `			VmSlot  *aSlot;` |
|        - |   534 | `			sxu32 n;` |
|        - |   535 | `			/* Restore local variable to the free pool so that they can be reused again */` |
|    13544 |   536 | `			aSlot = (VmSlot *)SySetBasePtr(&pCurFrame->sLocal);` |
|    94024 |   537 | `			for(n = 0 ; n < SySetUsed(&pCurFrame->sLocal) ; ++n ){` |
|        - |   538 | `				/* Unset the local variable */` |
|    80482 |   539 | `				PH7_VmUnsetMemObj(&(*pVm),aSlot[n].nIdx,FALSE);` |
|    40242 |   540 | `			}` |
|        - |   541 | `			/* Remove local reference */` |
|    13544 |   542 | `			aSlot = (VmSlot *)SySetBasePtr(&pCurFrame->sRef);` |
|    94080 |   543 | `			for(n = 0 ; n < SySetUsed(&pCurFrame->sRef) ; ++n ){` |
|    80538 |   544 | `				PH7_VmRefObjRemove(&(*pVm),aSlot[n].nIdx,(SyHashEntry *)aSlot[n].pUserData,0);` |
|    40270 |   545 | `			}` |
|     6771 |   546 | `		}` |
|        - |   547 | `		/* Release internal containers */` |
|    13608 |   548 | `		SyHashRelease(&pCurFrame->hVar);` |
|    13608 |   549 | `		SySetRelease(&pCurFrame->sArg);` |
|    13608 |   550 | `		SySetRelease(&pCurFrame->sLocal);` |
|    13608 |   551 | `		SySetRelease(&pCurFrame->sRef);` |
|        - |   552 | `		/* Release the whole structure */` |
|    13608 |   553 | `		SyMemBackendPoolFree(&pVm->sAllocator,pCurFrame);` |
|     6803 |   554 | `	}` |
|    13608 |   555 |  |
|        - |   556 | `/*` |
...
|        - |   560 | ` */` |
|  6347984 |   561 | `static VmFrame * VmSkipExceptionFrames(VmFrame *pFrame)` |
|        2 |   562 |  |
|  6348262 |   563 | `	while( pFrame->pParent && (pFrame->iFlags & VM_FRAME_EXCEPTION) ){` |
|      278 |   564 | `		pFrame = pFrame->pParent;` |
|        2 |   565 | `	}` |
|  6347986 |   566 | `	return pFrame;` |
|        2 |   567 |  |
|        - |   568 | `/*` |
...
|        - |   683 | ` */` |
|   114958 |   684 | `PH7_PRIVATE sxi32 VmMountUserClass(` |
...
|   114960 |   694 | `	SyHashResetLoopCursor(&pClass->hAttr);` |
|        - |   695 | `	/* Process only static and constant attribute */` |
|   474487 |   696 | `	while( (pEntry = SyHashGetNextEntry(&pClass->hAttr)) != 0 ){` |
|        - |   697 | `		/* Extract the current attribute */` |
|   302050 |   698 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|   302050 |   699 | `		if( pAttr->iFlags & (PH7_CLASS_ATTR_CONSTANT\|PH7_CLASS_ATTR_STATIC) ){` |
...
|   114960 |   721 | `	if( pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|        - |   722 | `		/* Do not mount interface/trait methods since they are not directly invocable.` |
|        - |   723 | `		 */` |
|    49048 |   724 | `		return SXRET_OK;` |
|        - |   725 | `	}` |
|        - |   726 | `	/* Create constructor alias if not yet done */` |
|    65914 |   727 | `	if( SyHashGet(&pClass->hMethod,"__construct",sizeof("__construct")-1) == 0 ){` |
|        - |   728 | `		/* User constructor with the same base class name */` |
|     5766 |   729 | `		pEntry = SyHashGet(&pClass->hMethod,SyStringData(&pClass->sName),SyStringLength(&pClass->sName));` |
|     5766 |   730 | `		if( pEntry ){` |
...
|    65914 |   737 | `	SyHashResetLoopCursor(&pClass->hMethod);` |
|   656658 |   738 | `	while((pEntry = SyHashGetNextEntry(&pClass->hMethod)) != 0 ){` |
|   557790 |   739 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|   557790 |   740 | `		if( (pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT) == 0 ){` |
|   557782 |   741 | `			rc = PH7_VmInstallUserFunction(&(*pVm),&pMeth->sFunc,&pMeth->sVmName);` |
|   557782 |   742 | `			if( rc != SXRET_OK ){` |
|      ! 0 |   743 | `				return rc;` |
|        - |   744 | `			}` |
|   278890 |   745 | `		}` |
|        2 |   746 | `	}` |
|        - |   747 | `	/* Mark class as mounted to avoid redundant mounting */` |
|    65914 |   748 | `	pClass->bMounted = TRUE;` |
|    65914 |   749 | `	return SXRET_OK;` |
|    57481 |   750 |  |
|        - |   751 | `/*` |
|        - |   752 | ` * Allocate a private frame for attributes of the given` |
|        - |   753 | ` * class instance (Object in the PHP jargon).` |
|        - |   754 | ` */` |
|     1198 |   755 | `PH7_PRIVATE sxi32 PH7_VmCreateClassInstanceFrame(` |
|        - |   756 | `	ph7_vm *pVm, /* Target VM */` |
|        - |   757 | `	ph7_class_instance *pObj /* Class instance */` |
|        - |   758 | `	)` |
|        2 |   759 |  |
|     1200 |   760 | `	ph7_class *pClass = pObj->pClass;` |
...
|     1200 |   765 | `	SyHashResetLoopCursor(&pClass->hAttr);` |
|     4912 |   766 | `	while( (pEntry = SyHashGetNextEntry(&pClass->hAttr)) != 0 ){` |
...
|        - |   822 | ` */` |
|   402122 |   823 | `PH7_PRIVATE ph7_value * PH7_ReserveConstObj(ph7_vm *pVm,sxu32 *pIndex)` |
|        2 |   824 |  |
|        - |   825 | `	ph7_value *pObj;` |
|        - |   826 | `	sxi32 rc;` |
|   402124 |   827 | `	if( pIndex ){` |
|        - |   828 | `		/* Object index in the object table */` |
|   393538 |   829 | `		*pIndex = SySetUsed(&pVm->aLitObj);` |
|   196768 |   830 | `	}` |
|        - |   831 | `	/* Reserve a slot for the new object */` |
|   402124 |   832 | `	rc = SySetPut(&pVm->aLitObj,(const void *)zDummy);` |
|   402124 |   833 | `	if( rc != SXRET_OK ){` |
...
|      ! 0 |   837 | `		return 0;` |
|        - |   838 | `	}` |
|   402124 |   839 | `	pObj = (ph7_value *)SySetPeek(&pVm->aLitObj);` |
|   402124 |   840 | `	return pObj;` |
|   201063 |   841 |  |
|        - |   842 | `/*` |
|        - |   843 | ` * Reserve a memory object.` |
|        - |   844 | ` * Return a pointer to the raw ph7_value on success. NULL on failure.` |
|        - |   845 | ` */` |
|  2146380 |   846 | `PH7_PRIVATE ph7_value * VmReserveMemObj(ph7_vm *pVm,sxu32 *pIndex)` |
|        2 |   847 |  |
|        - |   848 | `	ph7_value *pObj;` |
|        - |   849 | `	sxi32 rc;` |
|  2146382 |   850 | `	if( pIndex ){` |
|        - |   851 | `		/* Object index in the object table */` |
|  2146382 |   852 | `		*pIndex = SySetUsed(&pVm->aMemObj);` |
|  1073190 |   853 | `	}` |
|        - |   854 | `	/* Reserve a slot for the new object */` |
|  2146382 |   855 | `	rc = SySetPut(&pVm->aMemObj,(const void *)zDummy);` |
|  2146382 |   856 | `	if( rc != SXRET_OK ){` |
...
|      ! 0 |   860 | `		return 0;` |
|        - |   861 | `	}` |
|  2146382 |   862 | `	pObj = (ph7_value *)SySetPeek(&pVm->aMemObj);` |
|  2146382 |   863 | `	return pObj;` |
|  1073192 |   864 |  |
...
|        - |  1271 | ` */` |
|     2862 |  1272 | `PH7_PRIVATE sxi32 PH7_VmInit(` |
...
|     2864 |  1281 | `	SyZero(pVm,sizeof(ph7_vm));` |
|        - |  1282 | `	/* Initialize VM fields */` |
|     2864 |  1283 | `	pVm->pEngine = &(*pEngine);` |
|     2864 |  1284 | `	SyMemBackendInitFromParent(&pVm->sAllocator,&pEngine->sAllocator);` |
|        - |  1285 | `	/* Instructions containers */` |
|     2864 |  1286 | `	SySetInit(&pVm->aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|     2864 |  1287 | `	SySetAlloc(&pVm->aByteCode,0xFF);` |
|     2864 |  1288 | `	pVm->pByteContainer = &pVm->aByteCode;` |
|        - |  1289 | `	/* Object containers */` |
|     2864 |  1290 | `	SySetInit(&pVm->aMemObj,&pVm->sAllocator,sizeof(ph7_value));` |
|     2864 |  1291 | `	SySetAlloc(&pVm->aMemObj,0xFF);` |
|        - |  1292 | `	/* Virtual machine internal containers */` |
|     2864 |  1293 | `	SyBlobInit(&pVm->sConsumer,&pVm->sAllocator);` |
|     2864 |  1294 | `	SyBlobInit(&pVm->sWorker,&pVm->sAllocator);` |
|     2864 |  1295 | `	SyBlobInit(&pVm->sArgv,&pVm->sAllocator);` |
|     2864 |  1296 | `	SySetInit(&pVm->aLitObj,&pVm->sAllocator,sizeof(ph7_value));` |
|     2864 |  1297 | `	SySetAlloc(&pVm->aLitObj,0xFF);` |
|     2864 |  1298 | `	SyHashInit(&pVm->hHostFunction,&pVm->sAllocator,0,0);` |
|     2864 |  1299 | `	SyHashInit(&pVm->hFunction,&pVm->sAllocator,0,0);` |
|     2864 |  1300 | `	SyBlobInit(&pVm->sNamespace,&pVm->sAllocator);` |
|     2864 |  1301 | `	SyHashInit(&pVm->hUseImports,&pVm->sAllocator,0,0);` |
|     2864 |  1302 | `	SyHashInit(&pVm->hClass,&pVm->sAllocator,SyStrHash,SyStrnmicmp);` |
|     2864 |  1303 | `	SyHashInit(&pVm->hConstant,&pVm->sAllocator,0,0);` |
|     2864 |  1304 | `	SyHashInit(&pVm->hSuper,&pVm->sAllocator,0,0);` |
|     2864 |  1305 | `	SyHashInit(&pVm->hPDO,&pVm->sAllocator,0,0);` |
|     2864 |  1306 | `	SySetInit(&pVm->aFreeObj,&pVm->sAllocator,sizeof(VmSlot));` |
|     2864 |  1307 | `	SySetInit(&pVm->aSelf,&pVm->sAllocator,sizeof(ph7_class *));` |
|     2864 |  1308 | `	SySetInit(&pVm->aShutdown,&pVm->sAllocator,sizeof(VmShutdownCB));` |
|     2864 |  1309 | `	SySetInit(&pVm->aAutoload,&pVm->sAllocator,sizeof(VmAutoloadCB));` |
|     2864 |  1310 | `	SyHashInit(&pVm->hAutoloadActive,&pVm->sAllocator,0,0);` |
|     2864 |  1311 | `	SySetInit(&pVm->aException,&pVm->sAllocator,sizeof(ph7_exception *));` |
|     2864 |  1312 | `	pVm->pPendingException = 0;` |
|        - |  1313 | `	/* Configuration containers */` |
|     2864 |  1314 | `	SySetInit(&pVm->aFiles,&pVm->sAllocator,sizeof(SyString));` |
|     2864 |  1315 | `	SySetInit(&pVm->aPaths,&pVm->sAllocator,sizeof(SyString));` |
|     2864 |  1316 | `	SySetInit(&pVm->aIncluded,&pVm->sAllocator,sizeof(SyString));` |
|     2864 |  1317 | `	SySetInit(&pVm->aOB,&pVm->sAllocator,sizeof(VmObEntry));` |
|     2864 |  1318 | `	SySetInit(&pVm->aResponseHeaders,&pVm->sAllocator,sizeof(VmResponseHeader));` |
|     2864 |  1319 | `	pVm->iResponseStatus = 200;` |
|     2864 |  1320 | `	pVm->bHeadersSent = 0;` |
|     2864 |  1321 | `	SySetInit(&pVm->aIOstream,&pVm->sAllocator,sizeof(ph7_io_stream *));` |
|        - |  1322 | `	/* Error callbacks containers */` |
|     2864 |  1323 | `	PH7_MemObjInit(&(*pVm),&pVm->aExceptionCB[0]);` |
|     2864 |  1324 | `	PH7_MemObjInit(&(*pVm),&pVm->aExceptionCB[1]);` |
|     2864 |  1325 | `	PH7_MemObjInit(&(*pVm),&pVm->aErrCB[0]);` |
|     2864 |  1326 | `	PH7_MemObjInit(&(*pVm),&pVm->aErrCB[1]);` |
|     2864 |  1327 | `	PH7_MemObjInit(&(*pVm),&pVm->sAssertCallback);` |
|        - |  1328 | `	/* Set a default recursion limit */` |
|        - |  1329 | `#if defined(__WINNT__) \|\| defined(__UNIXES__)` |
|     2864 |  1330 | `	pVm->nMaxDepth = 32;` |
|        - |  1331 | `#else` |
|        - |  1332 | `	pVm->nMaxDepth = 16;` |
|        - |  1333 | `#endif` |
|        - |  1334 | `	/* Default assertion flags */` |
|     2864 |  1335 | `	pVm->iAssertFlags = 0; /* PHP 8: no warning flag by default, AssertionError is thrown */` |
|        - |  1336 | `	/* JSON return status */` |
|     2864 |  1337 | `	pVm->json_rc = JSON_ERROR_NONE;` |
|        - |  1338 | `	/* PRNG context */` |
|     2864 |  1339 | `	SyRandomnessInit(&pVm->sPrng,0,0);` |
|        - |  1340 | `	/* Install the null constant */` |
|     2864 |  1341 | `	pObj = PH7_ReserveConstObj(&(*pVm),0);` |
|     2864 |  1342 | `	if( pObj == 0 ){` |
|      ! 0 |  1343 | `		rc = SXERR_MEM;` |
|      ! 0 |  1344 | `		goto Err;` |
|        - |  1345 | `	}` |
|     2864 |  1346 | `	PH7_MemObjInit(pVm,pObj);` |
|        - |  1347 | `	/* Install the boolean TRUE constant */` |
|     2864 |  1348 | `	pObj = PH7_ReserveConstObj(&(*pVm),0);` |
|     2864 |  1349 | `	if( pObj == 0 ){` |
|      ! 0 |  1350 | `		rc = SXERR_MEM;` |
|      ! 0 |  1351 | `		goto Err;` |
|        - |  1352 | `	}` |
|     2864 |  1353 | `	PH7_MemObjInitFromBool(pVm,pObj,1);` |
|        - |  1354 | `	/* Install the boolean FALSE constant */` |
|     2864 |  1355 | `	pObj = PH7_ReserveConstObj(&(*pVm),0);` |
|     2864 |  1356 | `	if( pObj == 0 ){` |
|      ! 0 |  1357 | `		rc = SXERR_MEM;` |
|      ! 0 |  1358 | `		goto Err;` |
|        - |  1359 | `	}` |
|     2864 |  1360 | `	PH7_MemObjInitFromBool(pVm,pObj,0);` |
...
|     2864 |  1364 | `	pObj = PH7_ReserveConstObj(&(*pVm),&pVm->nEmptyStringIdx);` |
|     2864 |  1365 | `	if( pObj == 0 ){` |
|      ! 0 |  1366 | `		rc = SXERR_MEM;` |
|      ! 0 |  1367 | `		goto Err;` |
|        - |  1368 | `	}` |
|     2864 |  1369 | `	PH7_MemObjInitFromString(pVm,pObj,0);` |
|        - |  1370 | `	/* Create the global frame */` |
|     2864 |  1371 | `	rc = VmEnterFrame(&(*pVm),0,0,0);` |
|     2864 |  1372 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  1373 | `		goto Err;` |
|        - |  1374 | `	}` |
|        - |  1375 | `	/* Initialize the code generator */` |
|     2864 |  1376 | `	rc = PH7_InitCodeGenerator(pVm,pEngine->xConf.xErr,pEngine->xConf.pErrData);` |
|     2864 |  1377 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  1378 | `		goto Err;` |
|        - |  1379 | `	}` |
|        - |  1380 | `	/* VM correctly initialized,set the magic number */` |
|     2864 |  1381 | `	pVm->nMagic = PH7_VM_INIT;` |
|     2864 |  1382 | `	SyStringInitFromBuf(&sBuiltin,PH7_BUILTIN_LIB,sizeof(PH7_BUILTIN_LIB)-1);` |
|        - |  1383 | `	/* Compile the built-in library */` |
|     2864 |  1384 | `	VmEvalChunk(&(*pVm),0,&sBuiltin,PH7_PHP_ONLY,FALSE);` |
|        - |  1385 | `	/* Cache the Fiber class pointer for fast dispatch */` |
|     2864 |  1386 | `	pVm->pFiberClass = PH7_VmExtractClass(pVm,"Fiber",5,0,0);` |
|        - |  1387 | `	/* Register Fiber internal C functions */` |
|     2864 |  1388 | `	ph7_create_function(pVm,"__fiber_suspend",vm_builtin_Fiber_suspend,0);` |
|     2864 |  1389 | `	ph7_create_function(pVm,"__fiber_construct",vm_builtin_Fiber_construct,0);` |
|     2864 |  1390 | `	ph7_create_function(pVm,"__fiber_start",vm_builtin_Fiber_start,0);` |
|     2864 |  1391 | `	ph7_create_function(pVm,"__fiber_resume",vm_builtin_Fiber_resume,0);` |
|     2864 |  1392 | `	ph7_create_function(pVm,"__fiber_getReturn",vm_builtin_Fiber_getReturn,0);` |
|     2864 |  1393 | `	ph7_create_function(pVm,"__fiber_isStarted",vm_builtin_Fiber_isStarted,0);` |
|     2864 |  1394 | `	ph7_create_function(pVm,"__fiber_isRunning",vm_builtin_Fiber_isRunning,0);` |
|     2864 |  1395 | `	ph7_create_function(pVm,"__fiber_isSuspended",vm_builtin_Fiber_isSuspended,0);` |
|     2864 |  1396 | `	ph7_create_function(pVm,"__fiber_isTerminated",vm_builtin_Fiber_isTerminated,0);` |
|     2864 |  1397 | `	ph7_create_function(pVm,"__fiber_destruct",vm_builtin_Fiber_destruct,0);` |
|        - |  1398 | `	/* Cache the Generator class pointer and register generator functions */` |
|     2864 |  1399 | `	pVm->pGeneratorClass = PH7_VmExtractClass(pVm,"Generator",9,0,0);` |
|     2864 |  1400 | `	ph7_create_function(pVm,"__gen_rewind",vm_builtin_Generator_rewind,0);` |
|     2864 |  1401 | `	ph7_create_function(pVm,"__gen_valid",vm_builtin_Generator_valid,0);` |
|     2864 |  1402 | `	ph7_create_function(pVm,"__gen_current",vm_builtin_Generator_current,0);` |
|     2864 |  1403 | `	ph7_create_function(pVm,"__gen_key",vm_builtin_Generator_key,0);` |
|     2864 |  1404 | `	ph7_create_function(pVm,"__gen_next",vm_builtin_Generator_next,0);` |
|     2864 |  1405 | `	ph7_create_function(pVm,"__gen_send",vm_builtin_Generator_send,0);` |
|     2864 |  1406 | `	ph7_create_function(pVm,"__gen_throw",vm_builtin_Generator_throw,0);` |
|     2864 |  1407 | `	ph7_create_function(pVm,"__gen_getReturn",vm_builtin_Generator_getReturn,0);` |
|     2864 |  1408 | `	ph7_create_function(pVm,"__gen_destruct",vm_builtin_Generator_destruct,0);` |
|        - |  1409 | `	/* Reset the code generator */` |
|     2864 |  1410 | `	PH7_ResetCodeGenerator(&(*pVm),pEngine->xConf.xErr,pEngine->xConf.pErrData);` |
|     2864 |  1411 | `	return SXRET_OK;` |
|      ! 0 |  1412 | `Err:` |
...
|        - |  1441 | ` */` |
|    13720 |  1442 | `static void VmTrackOutput(ph7_vm *pVm, sxu32 nLen)` |
|        2 |  1443 |  |
|    13722 |  1444 | `	ProcConsumer xCons = pVm->sVmConsumer.xConsumer;` |
|    13722 |  1445 | `	if( xCons != VmObConsumer ){` |
|     6774 |  1446 | `		pVm->nOutputLen += nLen;` |
|     6774 |  1447 | `		if( !pVm->bHeadersSent && xCons != PH7_VmBlobConsumer ){` |
|      958 |  1448 | `			pVm->bHeadersSent = 1;` |
|      478 |  1449 | `		}` |
|     3386 |  1450 | `	}` |
|    13722 |  1451 |  |
...
|        - |  1458 | ` */` |
|    33260 |  1459 | `static ph7_value * VmNewOperandStack(` |
...
|        - |  1471 | `  */` |
|    33262 |  1472 | `	nInstr += VM_STACK_GUARD;` |
|    33262 |  1473 | `	pStack = (ph7_value *)SyMemBackendAlloc(&pVm->sAllocator,nInstr * sizeof(ph7_value));` |
|    33262 |  1474 | `	if( pStack == 0 ){` |
|      ! 0 |  1475 | `		return 0;` |
|        - |  1476 | `	}` |
|        - |  1477 | `	/* Initialize the operand stack */` |
|  2077188 |  1478 | `	while( nInstr > 0 ){` |
|  2043928 |  1479 | `		PH7_MemObjInit(&(*pVm),&pStack[nInstr - 1]);` |
|  2043928 |  1480 | `		--nInstr;` |
|        2 |  1481 | `	}` |
|        - |  1482 | `	/* Ready for bytecode execution */` |
|    33262 |  1483 | `	return pStack;` |
|    16632 |  1484 |  |
...
|        - |  1491 | ` */` |
|     2602 |  1492 | `PH7_PRIVATE sxi32 PH7_VmMakeReady(` |
|        - |  1493 | `	ph7_vm *pVm /* Target VM */` |
|        - |  1494 | `	)` |
|        2 |  1495 |  |
|        - |  1496 | `	SyHashEntry *pEntry;` |
|        - |  1497 | `	sxi32 rc;` |
|     2604 |  1498 | `	if( pVm->nMagic != PH7_VM_INIT ){` |
|        - |  1499 | `		/* Initialize your VM first */` |
|      ! 0 |  1500 | `		return SXERR_CORRUPT;` |
|        - |  1501 | `	}` |
|        - |  1502 | `	/* Mark the VM ready for byte-code execution */` |
|     2604 |  1503 | `	pVm->nMagic = PH7_VM_RUN;` |
|        - |  1504 | `	/* Release the code generator now we have compiled our program */` |
|     2604 |  1505 | `	PH7_ResetCodeGenerator(pVm,0,0);` |
|        - |  1506 | `	/* Emit the DONE instruction */` |
|     2604 |  1507 | `	rc = PH7_VmEmitInstr(&(*pVm),PH7_OP_DONE,0,0,0,0);` |
|     2604 |  1508 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  1509 | `		return SXERR_MEM;` |
|        - |  1510 | `	}` |
|        - |  1511 | `	/* Script return value */` |
|     2604 |  1512 | `	PH7_MemObjInit(&(*pVm),&pVm->sExec); /* Assume a NULL return value */` |
|        - |  1513 | `	/* Allocate a new operand stack */` |
|     2604 |  1514 | `	pVm->aOps = VmNewOperandStack(&(*pVm),SySetUsed(pVm->pByteContainer));` |
|     2604 |  1515 | `	if( pVm->aOps == 0 ){` |
|      ! 0 |  1516 | `		return SXERR_MEM;` |
|        - |  1517 | `	}` |
|        - |  1518 | `	/* Set the default VM output consumer callback and it's` |
|        - |  1519 | `	 * private data. */` |
|     2604 |  1520 | `	pVm->sVmConsumer.xConsumer = PH7_VmBlobConsumer;` |
|     2604 |  1521 | `	pVm->sVmConsumer.pUserData = &pVm->sConsumer;` |
|        - |  1522 | `	/* Allocate the reference table */` |
|     2604 |  1523 | `	pVm->nRefSize = 0x10; /* Must be a power of two for fast arithemtic */` |
|     2604 |  1524 | `	pVm->apRefObj = (VmRefObj **)SyMemBackendAlloc(&pVm->sAllocator,sizeof(VmRefObj *) * pVm->nRefSize);` |
|     2604 |  1525 | `	if( pVm->apRefObj == 0 ){` |
...
|     2604 |  1544 | `	PH7_RegisterBuiltInConstant(&(*pVm));` |
|        - |  1545 | `	/* Register built-in functions [i.e: is_null(), array_diff(), strlen(), etc.] */` |
|     2604 |  1546 | `	PH7_RegisterBuiltInFunction(&(*pVm));` |
|        - |  1547 | `	/* Register HTTP response functions [i.e: header(), http_response_code(), etc.] */` |
|     2604 |  1548 | `	PH7_RegisterHttpResponseFunctions(&(*pVm));` |
|        - |  1549 | `#ifdef PH7_ENABLE_PCRE` |
|        - |  1550 | `	/* Register PCRE functions [i.e: preg_match(), preg_replace(), etc.] */` |
|     2604 |  1551 | `	PH7_RegisterPcreFunctions(&(*pVm));` |
|     2604 |  1552 | `	PH7_RegisterPcreConstants(&(*pVm));` |
|        - |  1553 | `#endif` |
|        - |  1554 | `	/* Initialize and install static and constants class attributes */` |
|     2604 |  1555 | `	SyHashResetLoopCursor(&pVm->hClass);` |
|    41810 |  1556 | `	while((pEntry = SyHashGetNextEntry(&pVm->hClass)) != 0 ){` |
|    39208 |  1557 | `		rc = VmMountUserClass(&(*pVm),(ph7_class *)pEntry->pUserData);` |
|    39208 |  1558 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  1559 | `			return rc;` |
|        - |  1560 | `		}` |
|        2 |  1561 | `	}` |
|        - |  1562 | `	/* Random number betwwen 0 and 1023 used to generate unique ID */` |
|     2604 |  1563 | `	pVm->unique_id = PH7_VmRandomNum(&(*pVm)) & 1023;` |
|        - |  1564 | `	/* VM is ready for bytecode execution */` |
|     2604 |  1565 | `	return SXRET_OK;` |
|     1303 |  1566 |  |
|        - |  1567 | `/*` |
...
|        - |  1590 | ` */` |
|     2594 |  1591 | `PH7_PRIVATE sxi32 PH7_VmRelease(ph7_vm *pVm)` |
|        2 |  1592 |  |
|        - |  1593 | `	/* Set the stale magic number */` |
|     2596 |  1594 | `	pVm->nMagic = PH7_VM_STALE;` |
|        - |  1595 | `	/* Release the private memory subsystem */` |
|     2596 |  1596 | `	SyMemBackendRelease(&pVm->sAllocator);` |
|     2596 |  1597 | `	return SXRET_OK;` |
|        2 |  1598 |  |
|        - |  1599 | `/*` |
...
|        - |  1608 | ` */` |
|   575344 |  1609 | `static sxi32 VmInitCallContext(` |
...
|        - |  1615 | `	)` |
|        2 |  1616 |  |
|   575346 |  1617 | `	pOut->pFunc = pFunc;` |
|   575346 |  1618 | `	pOut->pVm   = pVm;` |
|   575346 |  1619 | `	SySetInit(&pOut->sVar,&pVm->sAllocator,sizeof(ph7_value *));` |
|   575346 |  1620 | `	SySetInit(&pOut->sChunk,&pVm->sAllocator,sizeof(ph7_aux_data));` |
|        - |  1621 | `	/* Assume a null return value */` |
|   575346 |  1622 | `	MemObjSetType(pRet,MEMOBJ_NULL);` |
|   575346 |  1623 | `	pOut->pRet = pRet;` |
|   575346 |  1624 | `	pOut->iFlags = iFlags;` |
|   575346 |  1625 | `	return SXRET_OK;` |
|        2 |  1626 |  |
|        - |  1627 | `/*` |
|        - |  1628 | ` * Release a foreign function call context and cleanup the mess` |
|        - |  1629 | ` * left behind.` |
|        - |  1630 | ` */` |
|   575344 |  1631 | `static void VmReleaseCallContext(ph7_context *pCtx)` |
|        2 |  1632 |  |
|        - |  1633 | `	sxu32 n;` |
|   575346 |  1634 | `	if( SySetUsed(&pCtx->sVar) > 0 ){` |
|     7006 |  1635 | `		ph7_value **apObj = (ph7_value **)SySetBasePtr(&pCtx->sVar);` |
|    19984 |  1636 | `		for( n = 0 ; n < SySetUsed(&pCtx->sVar) ; ++n ){` |
|    12980 |  1637 | `			if( apObj[n] == 0 ){` |
|        - |  1638 | `				/* Already released */` |
|      298 |  1639 | `				continue;` |
|        - |  1640 | `			}` |
|    12684 |  1641 | `			PH7_MemObjRelease(apObj[n]);` |
|    12684 |  1642 | `			SyMemBackendPoolFree(&pCtx->pVm->sAllocator,apObj[n]);` |
|     6343 |  1643 | `		}` |
|     7006 |  1644 | `		SySetRelease(&pCtx->sVar);` |
|     3502 |  1645 | `	}` |
|   575346 |  1646 | `	if( SySetUsed(&pCtx->sChunk) > 0 ){` |
...
|        - |  1692 | ` */` |
|  3339752 |  1693 | `static void VmPopOperand(` |
|        - |  1694 | `	ph7_value **ppTos, /* Operand stack */` |
|        - |  1695 | `	sxi32 nPop         /* Total number of memory objects to pop */` |
|        - |  1696 | `	)` |
|        2 |  1697 |  |
|  3339754 |  1698 | `	ph7_value *pTos = *ppTos;` |
|  7097802 |  1699 | `	while( nPop > 0 ){` |
|  3758050 |  1700 | `		PH7_MemObjRelease(pTos);` |
|  3758050 |  1701 | `		pTos--;` |
|  3758050 |  1702 | `		nPop--;` |
|        2 |  1703 | `	}` |
|        - |  1704 | `	/* Top of the stack */` |
|  3339754 |  1705 | `	*ppTos = pTos;` |
|  3339754 |  1706 |  |
|        - |  1707 | `/*` |
|        - |  1708 | ` * Reserve a memory object.` |
|        - |  1709 | ` * Return a pointer to the raw ph7_value on success. NULL on failure.` |
|        - |  1710 | ` */` |
|  3037372 |  1711 | `PH7_PRIVATE ph7_value * PH7_ReserveMemObj(ph7_vm *pVm)` |
|        2 |  1712 |  |
|  3037374 |  1713 | `	ph7_value *pObj = 0;` |
|        - |  1714 | `	VmSlot *pSlot;` |
|        - |  1715 | `	sxu32 nIdx;` |
|        - |  1716 | `	/* Check for a free slot */` |
|  3037374 |  1717 | `	nIdx = SXU32_HIGH; /* cc warning */` |
|  3037374 |  1718 | `	pSlot = (VmSlot *)SySetPop(&pVm->aFreeObj);` |
|  3037374 |  1719 | `	if( pSlot ){` |
|   890994 |  1720 | `		pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pSlot->nIdx);` |
|   890994 |  1721 | `		nIdx = pSlot->nIdx;` |
|   445496 |  1722 | `	}` |
|  3037374 |  1723 | `	if( pObj == 0 ){` |
|        - |  1724 | `		/* Reserve a new memory object */` |
|  2146382 |  1725 | `		pObj = VmReserveMemObj(&(*pVm),&nIdx);` |
|  2146382 |  1726 | `		if( pObj == 0 ){` |
|      ! 0 |  1727 | `			return 0;` |
|        - |  1728 | `		}` |
|  1073190 |  1729 | `	}` |
|        - |  1730 | `	/* Set a null default value */` |
|  3037374 |  1731 | `	PH7_MemObjInit(&(*pVm),pObj);` |
|  3037374 |  1732 | `	pObj->nIdx = nIdx;` |
|  3037374 |  1733 | `	return pObj;` |
|  1518688 |  1734 |  |
|        - |  1735 | `/*` |
|        - |  1736 | ` * Insert an entry by reference (not copy) in the given hashmap.` |
|        - |  1737 | ` */` |
|    33046 |  1738 | `static sxi32 VmHashmapRefInsert(` |
...
|        - |  1745 | `	ph7_value sKey;` |
|        - |  1746 | `	sxi32 rc;` |
|    33048 |  1747 | `	PH7_MemObjInitFromString(pMap->pVm,&sKey,0);` |
|    33048 |  1748 | `	PH7_MemObjStringAppend(&sKey,zKey,nByte);` |
|        - |  1749 | `	/* Perform the insertion */` |
|    33048 |  1750 | `	rc = PH7_HashmapInsertByRef(&(*pMap),&sKey,nRefIdx);` |
|    33048 |  1751 | `	PH7_MemObjRelease(&sKey);` |
|    33048 |  1752 | `	return rc;` |
|        2 |  1753 |  |
|        - |  1754 | `/*` |
...
|        - |  1758 | ` */` |
|  3114098 |  1759 | `static ph7_value * VmExtractMemObj(` |
...
|        - |  1764 | `	)` |
|        2 |  1765 |  |
|  3114100 |  1766 | `	int bNullify = FALSE;` |
...
|  3114100 |  1773 | `	pFrame = pVm->pFrame;` |
|  3114100 |  1774 | `	pFrame = VmSkipExceptionFrames(pFrame);` |
|        - |  1775 | `	/* Perform the lookup */` |
|  3114100 |  1776 | `	if( pName == 0 \|\| pName->nByte < 1 ){` |
...
|  3114100 |  1784 | `	pEntry = SyHashGet(&pVm->hSuper,(const void *)pName->zString,pName->nByte);` |
|  3114100 |  1785 | `	if( pEntry == 0 ){` |
|        - |  1786 | `		/* Query the top active frame */` |
|  3114060 |  1787 | `		pEntry = SyHashGet(&pFrame->hVar,(const void *)pName->zString,pName->nByte);` |
|  3114060 |  1788 | `		if( pEntry == 0 ){` |
|    87554 |  1789 | `			char *zName = (char *)pName->zString;` |
|        - |  1790 | `			VmSlot sLocal;` |
|    87554 |  1791 | `			if( !bCreate ){` |
...
|        - |  1797 | `			 */` |
|    87518 |  1798 | `			pObj = PH7_ReserveMemObj(&(*pVm));` |
|    87518 |  1799 | `			if( pObj == 0 ){` |
|      ! 0 |  1800 | `				return 0;` |
|        - |  1801 | `			}` |
|    87518 |  1802 | `			nIdx = pObj->nIdx;` |
|    87518 |  1803 | `			if( bDup ){` |
|        - |  1804 | `				/* Duplicate name */` |
...
|    87518 |  1811 | `			rc = SyHashInsert(&pFrame->hVar,zName,pName->nByte,SX_INT_TO_PTR(nIdx));` |
|    87518 |  1812 | `			if( rc != SXRET_OK ){` |
...
|      ! 0 |  1817 | `				return 0;` |
|        - |  1818 | `			}` |
|    87518 |  1819 | `			if( pFrame->pParent != 0 ){` |
|        - |  1820 | `				/* Local variable */` |
|    80518 |  1821 | `				sLocal.nIdx = nIdx;` |
|    80518 |  1822 | `				SySetPut(&pFrame->sLocal,(const void *)&sLocal);` |
|    40260 |  1823 | `			}else{` |
|        - |  1824 | `				/* Register in the $GLOBALS array */` |
|     7002 |  1825 | `				VmHashmapRefInsert(pVm->pGlobal,pName->zString,pName->nByte,nIdx);` |
|        - |  1826 | `			}` |
|        - |  1827 | `			/* Install in the reference table */` |
|    87518 |  1828 | `			PH7_VmRefObjInstall(&(*pVm),nIdx,SyHashLastEntry(&pFrame->hVar),0,0);` |
|        - |  1829 | `			/* Save object index */` |
|    87518 |  1830 | `			pObj->nIdx = nIdx;` |
|    43760 |  1831 | `		}else{` |
|        - |  1832 | `			/* Extract variable contents */` |
|  3026508 |  1833 | `			nIdx = (sxu32)SX_PTR_TO_INT(pEntry->pUserData);` |
|  3026508 |  1834 | `			pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|  3026508 |  1835 | `			if( bNullify && pObj ){` |
...
|        - |  1849 | ` */` |
|     2906 |  1850 | `PH7_PRIVATE ph7_value * PH7_VmExtractSuper(` |
...
|     2908 |  1860 | `	pEntry = SyHashGet(&pVm->hSuper,(const void *)zName,nByte);` |
|     2908 |  1861 | `	if( pEntry == 0 ){` |
|        - |  1862 | `		/* No such entry */` |
|      ! 0 |  1863 | `		return 0;` |
|        - |  1864 | `	}` |
|        - |  1865 | `	/* Extract the superglobal index in the global object pool */` |
|     2908 |  1866 | `	nIdx = SX_PTR_TO_INT(pEntry->pUserData);` |
|        - |  1867 | `	/* Extract the variable value  */` |
|     2908 |  1868 | `	pValue = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|     2908 |  1869 | `	return pValue;` |
|     1455 |  1870 |  |
|        - |  1871 | `/*` |
|        - |  1872 | ` * Perform a raw hashmap insertion.` |
|        - |  1873 | ` * Refer to the [PH7_VmConfigure()] implementation for additional information.` |
|        - |  1874 | ` */` |
|     2936 |  1875 | `PH7_PRIVATE sxi32 PH7_VmHashmapInsert(` |
...
|        - |  1884 | `	sxi32 rc;` |
|     2938 |  1885 | `	PH7_MemObjInitFromString(pMap->pVm,&sKey,0);` |
|     2938 |  1886 | `	PH7_MemObjInitFromString(pMap->pVm,&sValue,0);` |
|     2938 |  1887 | `	if( zKey ){` |
|     2916 |  1888 | `		if( nKeylen < 0 ){` |
|     2864 |  1889 | `			nKeylen = (int)SyStrlen(zKey);` |
|     1431 |  1890 | `		}` |
|     2916 |  1891 | `		PH7_MemObjStringAppend(&sKey,zKey,(sxu32)nKeylen);` |
|     1457 |  1892 | `	}` |
|     2938 |  1893 | `	if( zData ){` |
|     2938 |  1894 | `		if( nLen < 0 ){` |
...
|       72 |  1897 | `		}` |
|     2938 |  1898 | `		PH7_MemObjStringAppend(&sValue,zData,(sxu32)nLen);` |
|     1468 |  1899 | `	}` |
|        - |  1900 | `	/* Perform the insertion */` |
|     2938 |  1901 | `	rc = PH7_HashmapInsert(&(*pMap),&sKey,&sValue);` |
|     2938 |  1902 | `	PH7_MemObjRelease(&sKey);` |
|     2938 |  1903 | `	PH7_MemObjRelease(&sValue);` |
|     2938 |  1904 | `	return rc;` |
|        2 |  1905 |  |
|        - |  1906 | `/*` |
...
|        - |  1918 | ` */` |
|    41962 |  1919 | `PH7_PRIVATE sxi32 PH7_VmConfigure(` |
|        - |  1920 | `	ph7_vm *pVm, /* Target VM */` |
|        - |  1921 | `	sxi32 nOp,   /* Configuration verb */` |
|        - |  1922 | `	va_list ap   /* Subsequent option arguments */` |
|        - |  1923 | `	)` |
|        2 |  1924 |  |
|    41964 |  1925 | `	sxi32 rc = SXRET_OK;` |
|    41964 |  1926 | `	switch(nOp){` |
|     1293 |  1927 | `	case PH7_VM_CONFIG_OUTPUT: {` |
|     2588 |  1928 | `		ProcConsumer xConsumer = va_arg(ap,ProcConsumer);` |
|     2588 |  1929 | `		void *pUserData = va_arg(ap,void *);` |
...
|     2588 |  1938 | `		pVm->sVmConsumer.xConsumer = xConsumer;` |
|     2588 |  1939 | `		pVm->sVmConsumer.pUserData = pUserData;` |
|     2588 |  1940 | `		break;` |
|        - |  1941 | `							   }` |
|     1301 |  1942 | `	case PH7_VM_CONFIG_IMPORT_PATH: {` |
|        - |  1943 | `		/* Import path */` |
|        - |  1944 | `		  const char *zPath;` |
|        - |  1945 | `		  SyString sPath;` |
|     2604 |  1946 | `		  zPath = va_arg(ap,const char *);` |
...
|        - |  1951 | `		  }` |
|        - |  1952 | `#endif` |
|     2604 |  1953 | `		  SyStringInitFromBuf(&sPath,zPath,SyStrlen(zPath));` |
|        - |  1954 | `		  /* Remove trailing slashes and backslashes */` |
|        - |  1955 | `#ifdef __WINNT__` |
|        2 |  1956 | `		  SyStringTrimTrailingChar(&sPath,'\\');` |
|        - |  1957 | `#endif` |
|     5206 |  1958 | `		  SyStringTrimTrailingChar(&sPath,'/');` |
|        - |  1959 | `		  /* Remove leading and trailing white spaces */` |
|     2604 |  1960 | `		  SyStringFullTrim(&sPath);` |
|     2604 |  1961 | `		  if( sPath.nByte > 0 ){` |
|        - |  1962 | `			  /* Store the path in the corresponding conatiner */` |
|     2604 |  1963 | `			  rc = SySetPut(&pVm->aPaths,(const void *)&sPath);` |
|     1301 |  1964 | `		  }` |
|     2604 |  1965 | `		  break;` |
|        - |  1966 | `									 }` |
|     1301 |  1967 | `	case PH7_VM_CONFIG_ERR_REPORT:` |
|        - |  1968 | `		/* Run-Time Error report */` |
|     2604 |  1969 | `		pVm->bErrReport = 1;` |
|     2604 |  1970 | `		break;` |
...
|        - |  1990 | `							   }` |
|        - |  1991 |  |
|    13010 |  1992 | `	case PH7_VM_CONFIG_CREATE_SUPER:` |
|        - |  1993 | `	case PH7_VM_CONFIG_CREATE_VAR: {` |
|        - |  1994 | `		/* Create a new superglobal/global variable */` |
|    26022 |  1995 | `		const char *zName = va_arg(ap,const char *);` |
|    26022 |  1996 | `		ph7_value *pValue = va_arg(ap,ph7_value *);` |
...
|        - |  2005 | `		}` |
|        - |  2006 | `#endif` |
|    26022 |  2007 | `		nByte = SyStrlen(zName);` |
|    26022 |  2008 | `		if( nOp == PH7_VM_CONFIG_CREATE_SUPER ){` |
|        - |  2009 | `			/* Check if the superglobal is already installed */` |
|    26022 |  2010 | `			pEntry = SyHashGet(&pVm->hSuper,(const void *)zName,nByte);` |
|    13012 |  2011 | `		}else{` |
|        - |  2012 | `			/* Query the top active VM frame */` |
|      ! 0 |  2013 | `			pEntry = SyHashGet(&pVm->pFrame->hVar,(const void *)zName,nByte);` |
|        - |  2014 | `		}` |
|    26022 |  2015 | `		if( pEntry ){` |
...
|    26022 |  2026 | `			pObj = PH7_ReserveMemObj(&(*pVm));` |
|    26022 |  2027 | `			if( pObj == 0 ){` |
|      ! 0 |  2028 | `				rc = SXERR_MEM;` |
|      ! 0 |  2029 | `				break;` |
|        - |  2030 | `			}` |
|    26022 |  2031 | `			nIdx = pObj->nIdx;` |
|        - |  2032 | `			/* Copy value */` |
|    26022 |  2033 | `			PH7_MemObjStore(pValue,pObj);` |
|    26022 |  2034 | `			if( nOp == PH7_VM_CONFIG_CREATE_SUPER ){` |
|        - |  2035 | `				/* Install the superglobal */` |
|    26022 |  2036 | `				rc = SyHashInsert(&pVm->hSuper,(const void *)zName,nByte,SX_INT_TO_PTR(nIdx));` |
|    13012 |  2037 | `			}else{` |
|        - |  2038 | `				/* Install in the current frame */` |
|      ! 0 |  2039 | `				rc = SyHashInsert(&pVm->pFrame->hVar,(const void *)zName,nByte,SX_INT_TO_PTR(nIdx));` |
|        - |  2040 | `			}` |
|    26022 |  2041 | `			if( rc == SXRET_OK ){` |
|        - |  2042 | `				SyHashEntry *pRef;` |
|    26022 |  2043 | `				if( nOp == PH7_VM_CONFIG_CREATE_SUPER ){` |
|    26022 |  2044 | `					pRef = SyHashLastEntry(&pVm->hSuper);` |
|    13012 |  2045 | `				}else{` |
|      ! 0 |  2046 | `					pRef = SyHashLastEntry(&pVm->pFrame->hVar);` |
|        - |  2047 | `				}` |
|        - |  2048 | `				/* Install in the reference table */` |
|    26022 |  2049 | `				PH7_VmRefObjInstall(&(*pVm),nIdx,pRef,0,0);` |
|    26022 |  2050 | `				if( nOp == PH7_VM_CONFIG_CREATE_SUPER \|\| pVm->pFrame->pParent == 0){` |
|        - |  2051 | `					/* Register in the $GLOBALS array */` |
|    26022 |  2052 | `					VmHashmapRefInsert(pVm->pGlobal,zName,nByte,nIdx);` |
|    13010 |  2053 | `				}` |
|    13010 |  2054 | `			}` |
|        - |  2055 | `		}` |
|    26022 |  2056 | `		break;` |
|        - |  2057 | `									}` |
|     1431 |  2058 | `	case PH7_VM_CONFIG_SERVER_ATTR:` |
...
|     2862 |  2090 | `			pValue = PH7_VmExtractSuper(&(*pVm),"_SERVER",sizeof("_SERVER")-1);` |
|        - |  2091 | `		}` |
|     2864 |  2092 | `		if( pValue == 0 \|\| (pValue->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
|        - |  2093 | `			/* No such entry */` |
|      ! 0 |  2094 | `			rc = SXERR_NOTFOUND;` |
|      ! 0 |  2095 | `			break;` |
|        - |  2096 | `		}` |
|        - |  2097 | `		/* Point to the hashmap */` |
|     2864 |  2098 | `		pMap = (ph7_hashmap *)pValue->x.pOther;` |
|        - |  2099 | `		/* Perform the insertion */` |
|     2864 |  2100 | `		rc = PH7_VmHashmapInsert(pMap,zKey,-1,zValue,nLen);` |
|     2864 |  2101 | `		break;` |
|        - |  2102 | `								   }` |
...
|      ! 0 |  2150 | `		break;` |
|        - |  2151 | `								   }` |
|     2602 |  2152 | `	case PH7_VM_CONFIG_IO_STREAM: {` |
|        - |  2153 | `		/* Register an IO stream device */` |
|     5206 |  2154 | `		const ph7_io_stream *pStream = va_arg(ap,const ph7_io_stream *);` |
|        - |  2155 | `		/* Make sure we are dealing with a valid IO stream */` |
|     7806 |  2156 | `		if( pStream == 0 \|\| pStream->zName == 0 \|\| pStream->zName[0] == 0 \|\|` |
|     5206 |  2157 | `			pStream->xOpen == 0 \|\| pStream->xRead == 0 ){` |
|        - |  2158 | `				/* Invalid stream */` |
|      ! 0 |  2159 | `				rc = SXERR_INVALID;` |
|      ! 0 |  2160 | `				break;` |
|        - |  2161 | `		}` |
|     5206 |  2162 | `		if( pVm->pDefStream == 0 && SyStrnicmp(pStream->zName,"file",sizeof("file")-1) == 0 ){` |
|        - |  2163 | `			/* Make the 'file://' stream the defaut stream device */` |
|     2604 |  2164 | `			pVm->pDefStream = pStream;` |
|     1301 |  2165 | `		}` |
|        - |  2166 | `		/* Insert in the appropriate container */` |
|     5206 |  2167 | `		rc = SySetPut(&pVm->aIOstream,(const void *)&pStream);` |
|     5206 |  2168 | `		break;` |
|        - |  2169 | `								  }` |
...
|      133 |  2708 | `	pCtx->pc = pc;` |
|      133 |  2709 | `	pCtx->nTos = nTos;` |
|      133 |  2710 | `	pCtx->iState = PH7_CTX_STATE_SUSPENDED;` |
|      133 |  2711 | `	return PH7_SUSPEND;` |
|        1 |  2712 |  |
|        - |  2713 | `/*` |
...
|        - |  2725 | ` */` |
|    33346 |  2726 | `static sxi32 VmByteCodeExec(` |
...
|    33348 |  2744 | `	SySetInit(&aArg,&pVm->sAllocator,sizeof(ph7_value *));` |
|    33348 |  2745 | `	if( nTos < 0 ){` |
|    31302 |  2746 | `		pTos = &pStack[-1];` |
|    15652 |  2747 | `	}else{` |
|     2048 |  2748 | `		pTos = &pStack[nTos];` |
|        - |  2749 | `	}` |
|    33348 |  2750 | `	nExceptionBase = SySetUsed(&pVm->aException);` |
|    33348 |  2751 | `	pc = nPc;` |
|        - |  2752 | `	/* Execute as much as we can */` |
|  4997331 |  2753 | `	for(;;){` |
|        - |  2754 | `		/* Fetch the instruction to execute */` |
|  9993960 |  2755 | `		pInstr = &aInstr[pc];` |
|  9993960 |  2756 | `		rc = SXRET_OK;` |
|        - |  2757 | `/*` |
...
|        - |  2763 | ` */` |
|  9993960 |  2764 | `		switch(pInstr->iOp){` |
|        - |  2765 | `/*` |
|        - |  2766 | ` * DONE: P1 * *` |
|        - |  2767 | ` *` |
...
|        - |  2770 | ` */` |
|    16362 |  2771 | `case PH7_OP_DONE:` |
|    32726 |  2772 | `	if( pInstr->iP1 ){` |
|        - |  2773 | `#ifdef UNTRUST` |
|        - |  2774 | `		if( pTos < pStack ){` |
|        - |  2775 | `			goto Abort;` |
|        - |  2776 | `		}` |
|        - |  2777 | `#endif` |
|    18946 |  2778 | `		if( pLastRef ){` |
|    12438 |  2779 | `			*pLastRef = pTos->nIdx;` |
|     6218 |  2780 | `		}` |
|    18946 |  2781 | `		if( pResult ){` |
|        - |  2782 | `			/* Execution result */` |
|    18006 |  2783 | `			PH7_MemObjStore(pTos,pResult);` |
|     9002 |  2784 | `		}` |
|    18946 |  2785 | `		VmPopOperand(&pTos,1);` |
|    23254 |  2786 | `	}else if( pLastRef ){` |
|        - |  2787 | `		/* Nothing referenced */` |
|     1024 |  2788 | `		*pLastRef = SXU32_HIGH;` |
|      511 |  2789 | `	}` |
...
|        - |  2797 | `	 */` |
|    32728 |  2798 | `	while( SySetUsed(&pVm->aException) > nExceptionBase ){` |
...
|        - |  2857 | ` */` |
|   215400 |  2858 | `case PH7_OP_JMP:` |
|   430846 |  2859 | `	pc = pInstr->iP2 - 1;` |
|   430846 |  2860 | `	break;` |
|        - |  2861 | `/*` |
|        - |  2862 | ` * JZ: P1 P2 *` |
|        - |  2863 | ` *` |
...
|  1007200 |  2874 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      138 |  2875 | `		PH7_MemObjToBool(pTos);` |
|       68 |  2876 | `	}` |
|  1007200 |  2877 | `	if( !pTos->x.iVal ){` |
|        - |  2878 | `		/* Take the jump */` |
|   509184 |  2879 | `		pc = pInstr->iP2 - 1;` |
|   254591 |  2880 | `	}` |
|  1007200 |  2881 | `	if( !pInstr->iP1 ){` |
|   801716 |  2882 | `		VmPopOperand(&pTos,1);` |
|   400879 |  2883 | `	}` |
|  1007200 |  2884 | `	break;` |
|        - |  2885 | `/*` |
|        - |  2886 | ` * JNZ: P1 P2 *` |
...
|   106982 |  2898 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      ! 0 |  2899 | `		PH7_MemObjToBool(pTos);` |
|      ! 0 |  2900 | `	}` |
|   106982 |  2901 | `	if( pTos->x.iVal ){` |
|        - |  2902 | `		/* Take the jump */` |
|     4510 |  2903 | `		pc = pInstr->iP2 - 1;` |
|     2254 |  2904 | `	}` |
|   106982 |  2905 | `	if( !pInstr->iP1 ){` |
...
|        - |  2921 | ` */` |
|   393083 |  2922 | `case PH7_OP_POP: {` |
|   786212 |  2923 | `	sxi32 n = pInstr->iP1;` |
|   786212 |  2924 | `	if( &pTos[-n+1] < pStack ){` |
|        - |  2925 | `		/* TICKET 1433-51 Stack underflow must be handled at run-time */` |
|      ! 0 |  2926 | `		n = (sxi32)(pTos - pStack);` |
|      ! 0 |  2927 | `	}` |
|   786212 |  2928 | `	VmPopOperand(&pTos,n);` |
|   786212 |  2929 | `	break;` |
|        - |  2930 | `				 }` |
|        - |  2931 | `/*` |
|        - |  2932 | ` * DUP: * * *` |
...
|        - |  2951 | ` */` |
|     6605 |  2952 | `case PH7_OP_NSSWITCH:` |
|    13212 |  2953 | `	SyBlobReset(&pVm->sNamespace);` |
|    13212 |  2954 | `	if( pInstr->p3 ){` |
|       53 |  2955 | `		const char *zNs = (const char *)pInstr->p3;` |
|       53 |  2956 | `		SyBlobAppend(&pVm->sNamespace,zNs,SyStrlen(zNs));` |
|       26 |  2957 | `	}` |
|    13212 |  2958 | `	break;` |
|        - |  2959 | `/*` |
|        - |  2960 | ` * CVT_INT: * * *` |
...
|        - |  3089 | ` */` |
|    12883 |  3090 | `case PH7_OP_ERR_CTRL:` |
|        - |  3091 | `	/*` |
...
|        - |  3155 | ` */` |
|   839248 |  3156 | `case PH7_OP_LOADC: {` |
|        - |  3157 | `	ph7_value *pObj;` |
|        - |  3158 | `	/* Reserve a room */` |
|  1678542 |  3159 | `	pTos++;` |
|  2509495 |  3160 | `	if( (pObj = (ph7_value *)SySetAt(&pVm->aLitObj,pInstr->iP2)) != 0 ){` |
|  1678542 |  3161 | `		if( pInstr->iP1 == 1 && SyBlobLength(&pObj->sBlob) <= 64 ){` |
|        - |  3162 | `			SyHashEntry *pEntry;` |
|        - |  3163 | `			/* Candidate for expansion via user defined callbacks */` |
|    16682 |  3164 | `			pEntry = SyHashGet(&pVm->hConstant,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|    16682 |  3165 | `			if( pEntry ){` |
|    16678 |  3166 | `				ph7_constant *pCons = (ph7_constant *)pEntry->pUserData;` |
|        - |  3167 | `				/* Set a NULL default value */` |
|    16678 |  3168 | `				MemObjSetType(pTos,MEMOBJ_NULL);` |
|    16678 |  3169 | `				SyBlobReset(&pTos->sBlob);` |
|        - |  3170 | `				/* Invoke the callback and deal with the expanded value */` |
|    16678 |  3171 | `				pCons->xExpand(pTos,pCons->pUserData);` |
|        - |  3172 | `				/* Mark as constant */` |
|    16678 |  3173 | `				pTos->nIdx = SXU32_HIGH;` |
|    16678 |  3174 | `				break;` |
|        - |  3175 | `			}` |
...
|        - |  3204 | `			}` |
|        1 |  3205 | `		}` |
|  1661864 |  3206 | `		PH7_MemObjLoad(pObj,pTos);` |
|   830955 |  3207 | `	}else{` |
|        - |  3208 | `		/* Set a NULL value */` |
|      ! 0 |  3209 | `		MemObjSetType(pTos,MEMOBJ_NULL);` |
|        - |  3210 | `	}` |
|   830910 |  3211 | `LoadC_Done:` |
|        - |  3212 | `	/* Mark as constant */` |
|  1661866 |  3213 | `	pTos->nIdx = SXU32_HIGH;` |
|  1661866 |  3214 | `	break;` |
|        - |  3215 | `				  }` |
|        - |  3216 | `/*` |
|        - |  3217 | ` * LOAD: P1 * P3` |
...
|        - |  3223 | ` */` |
|  1352830 |  3224 | `case PH7_OP_LOAD:{` |
|        - |  3225 | `	ph7_value *pObj;` |
|        - |  3226 | `	SyString sName;` |
|  2705882 |  3227 | `	if( pInstr->p3 == 0 ){` |
...
|       10 |  3239 | `	}else{` |
|  2705864 |  3240 | `		SyStringInitFromBuf(&sName,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|        - |  3241 | `		/* Reserve a room for the target object */` |
|  2705864 |  3242 | `		pTos++;` |
|        - |  3243 | `	}` |
|        - |  3244 | `	/* Extract the requested memory object */` |
|  2705882 |  3245 | `	pObj = VmExtractMemObj(&(*pVm),&sName,pInstr->p3 ? FALSE : TRUE,pInstr->iP1 != 1);` |
|  2705882 |  3246 | `	if( pObj == 0 ){` |
...
|  2705858 |  3263 | `	PH7_MemObjLoad(pObj,pTos);` |
|  2705858 |  3264 | `	pTos->nIdx = pObj->nIdx;` |
|  2705858 |  3265 | `	break;` |
|        - |  3266 | `				   }` |
|        - |  3267 | `/*` |
|        - |  3268 | ` * LOAD_MAP P1 * *` |
...
|        - |  3273 | ` */` |
|    18645 |  3274 | `case PH7_OP_LOAD_MAP: {` |
|        - |  3275 | `	ph7_hashmap *pMap;` |
|        - |  3276 | `	/* Allocate a new hashmap instance */` |
|    37292 |  3277 | `	pMap = PH7_NewHashmap(&(*pVm),0,0);` |
|    37292 |  3278 | `	if( pMap == 0 ){` |
...
|      ! 0 |  3281 | `		goto Abort;` |
|        - |  3282 | `	}` |
|    37292 |  3283 | `	if( pInstr->iP1 > 0 ){` |
|     2254 |  3284 | `		ph7_value *pEntry = &pTos[-pInstr->iP1+1]; /* Point to the first entry */` |
|        - |  3285 | `		/* Perform the insertion */` |
|     6894 |  3286 | `		while( pEntry < pTos ){` |
|     4642 |  3287 | `			if( pEntry[1].iFlags & MEMOBJ_REFERENCE ){` |
...
|     6821 |  3295 | `				PH7_HashmapInsert(pMap,` |
|     4546 |  3296 | `					(pEntry->iFlags & MEMOBJ_NULL) ? 0 /* Automatic index assign */ : pEntry,` |
|     2273 |  3297 | `					&pEntry[1]` |
|        - |  3298 | `				);` |
|        - |  3299 | `			}` |
...
|     2254 |  3304 | `		VmPopOperand(&pTos,pInstr->iP1);` |
|     1126 |  3305 | `	}` |
|        - |  3306 | `	/* Push the hashmap */` |
|    37292 |  3307 | `	pTos++;` |
|    37292 |  3308 | `	pTos->nIdx = SXU32_HIGH;` |
|    37292 |  3309 | `	pTos->x.pOther = pMap;` |
|    37292 |  3310 | `	MemObjSetType(pTos,MEMOBJ_HASHMAP);` |
|    37292 |  3311 | `	break;` |
|        - |  3312 | `					  }` |
|        - |  3313 | `/*` |
|        - |  3314 | ` * LOAD_LIST: P1 * *` |
...
|       54 |  3323 | `	if( pInstr->iP1 <= 0 ){` |
|        - |  3324 | `		/* Empty list,break immediately */` |
|      ! 0 |  3325 | `		break;` |
|        - |  3326 | `	}` |
|       54 |  3327 | `	pEntry = &pTos[-pInstr->iP1+1];` |
|        - |  3328 | `#ifdef UNTRUST` |
|        - |  3329 | `	if( &pEntry[-1] < pStack ){` |
|        - |  3330 | `		goto Abort;` |
|        - |  3331 | `	}` |
|        - |  3332 | `#endif` |
|       54 |  3333 | `	if( pEntry[-1].iFlags & MEMOBJ_HASHMAP ){` |
|       50 |  3334 | `		ph7_hashmap *pMap = (ph7_hashmap *)pEntry[-1].x.pOther;` |
|        - |  3335 | `		ph7_hashmap_node *pNode;` |
|        - |  3336 | `		ph7_value sKey,*pObj;` |
|        - |  3337 | `		/* Start Copying */` |
|       50 |  3338 | `		PH7_MemObjInitFromInt(&(*pVm),&sKey,0);` |
|      154 |  3339 | `		while( pEntry <= pTos ){` |
|      106 |  3340 | `			if( pEntry->nIdx != SXU32_HIGH /* Variable not constant */  ){` |
|       98 |  3341 | `				rc = PH7_HashmapLookup(pMap,&sKey,&pNode);` |
|       98 |  3342 | `				if( (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pEntry->nIdx)) != 0 ){` |
|       98 |  3343 | `					if( rc == SXRET_OK ){` |
|        - |  3344 | `						/* Store node value */` |
|       98 |  3345 | `						PH7_HashmapExtractNodeValue(pNode,pObj,TRUE);` |
|       50 |  3346 | `					}else{` |
...
|       48 |  3350 | `				}` |
|       48 |  3351 | `			}` |
|      106 |  3352 | `			sKey.x.iVal++; /* Next numeric index */` |
|      106 |  3353 | `			pEntry++;` |
|        2 |  3354 | `		}` |
|       24 |  3355 | `	}` |
|       54 |  3356 | `	VmPopOperand(&pTos,pInstr->iP1);` |
|       54 |  3357 | `	break;` |
|        - |  3358 | `					   }` |
|        - |  3359 | `/*` |
|        - |  3360 | ` * LOAD_IDX: P1 P2 *` |
...
|        - |  3365 | ` * instead.` |
|        - |  3366 | ` */` |
|   216625 |  3367 | `case PH7_OP_LOAD_IDX: {` |
|   433296 |  3368 | `	ph7_hashmap_node *pNode = 0; /* cc warning */` |
|   433296 |  3369 | `	ph7_hashmap *pMap = 0;` |
|        - |  3370 | `	ph7_value *pIdx;` |
|   433296 |  3371 | `	pIdx = 0;` |
|   433296 |  3372 | `	if( pInstr->iP1 == 0 ){` |
...
|        - |  3387 | `		}` |
|      ! 0 |  3388 | `	}else{` |
|   433296 |  3389 | `		pIdx = pTos;` |
|   433296 |  3390 | `		pTos--;` |
|        - |  3391 | `	}` |
|   433296 |  3392 | `	if( pTos->iFlags & MEMOBJ_STRING ){` |
|        - |  3393 | `		/* String access */` |
|   340676 |  3394 | `		if( pIdx ){` |
|        - |  3395 | `			sxu32 nOfft;` |
...
|   340676 |  3415 | `		break;` |
|        - |  3416 | `	}` |
|    92622 |  3417 | `	if( pInstr->iP2 && (pTos->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
...
|      ! 0 |  3424 | `		}` |
|      ! 0 |  3425 | `	}` |
|    92622 |  3426 | `	rc = SXERR_NOTFOUND; /* Assume the index is invalid */` |
|    92622 |  3427 | `	if( pTos->iFlags & MEMOBJ_HASHMAP ){` |
|    92622 |  3428 | `		if( pInstr->iP2 ){` |
...
|    92622 |  3436 | `		pMap = (ph7_hashmap *)pTos->x.pOther;` |
|    92622 |  3437 | `		if( pIdx ){` |
|        - |  3438 | `			/* Load the desired entry */` |
|    92622 |  3439 | `			rc = PH7_HashmapLookup(pMap,pIdx,&pNode);` |
|    46310 |  3440 | `		}` |
|    92622 |  3441 | `		if( rc != SXRET_OK && pInstr->iP2 ){` |
...
|    46310 |  3449 | `	}` |
|    92622 |  3450 | `	if( pIdx ){` |
|    92622 |  3451 | `		PH7_MemObjRelease(pIdx);` |
|    46310 |  3452 | `	}` |
|    92622 |  3453 | `	if( rc == SXRET_OK ){` |
|        - |  3454 | `		/* Load entry contents */` |
|    42356 |  3455 | `		if( pMap->iRef < 2 ){` |
...
|       13 |  3461 | `		}else{` |
|    42334 |  3462 | `			pTos->nIdx = pNode->nValIdx;` |
|    42334 |  3463 | `			PH7_HashmapExtractNodeValue(pNode,pTos,FALSE);` |
|    42334 |  3464 | `			PH7_HashmapUnref(pMap);` |
|        - |  3465 | `		}` |
|    21179 |  3466 | `	}else{` |
|        - |  3467 | `		/* No such entry,load NULL */` |
|    50268 |  3468 | `		PH7_MemObjRelease(pTos);` |
|    50268 |  3469 | `		pTos->nIdx = SXU32_HIGH;` |
|        - |  3470 | `	}` |
|    92622 |  3471 | `	break;` |
|        - |  3472 | `					  }` |
|        - |  3473 | `/*` |
...
|       10 |  3480 | `	ph7_vm_func *pFunc = (ph7_vm_func *)pInstr->p3;` |
|       10 |  3481 | `	if( pFunc->iFlags & VM_FUNC_CLOSURE ){` |
...
|       10 |  3488 | `		pClosure = (ph7_vm_func *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_vm_func));` |
|        - |  3489 | `		/* Generate an unique closure name */` |
|       10 |  3490 | `		zName = (char *)SyMemBackendAlloc(&pVm->sAllocator,sizeof("[closure_]")+64);` |
|       10 |  3491 | `		if( pClosure == 0 \|\| zName == 0){` |
|      ! 0 |  3492 | `			PH7_VmThrowError(pVm,0,E_ERROR,"Fatal: PH7 is running out of memory while creating closure environment");` |
|      ! 0 |  3493 | `			goto Abort;` |
|        - |  3494 | `		}` |
|       10 |  3495 | `		mLen = SyBufferFormat(zName,sizeof("[closure_]")+64,"[closure_%d]",pVm->closure_cnt++);` |
|       10 |  3496 | `		while( SyHashGet(&pVm->hFunction,zName,mLen) != 0 && mLen < (sizeof("[closure_]")+60/* not 64 */) ){` |
|      ! 0 |  3497 | `			mLen = SyBufferFormat(zName,sizeof("[closure_]")+64,"[closure_%d]",pVm->closure_cnt++);` |
|      ! 0 |  3498 | `		}` |
|        - |  3499 | `		/* Zero the stucture */` |
|       10 |  3500 | `		SyZero(pClosure,sizeof(ph7_vm_func));` |
|        - |  3501 | `		/* Perform a structure assignment on read-only items */` |
|       10 |  3502 | `		pClosure->aArgs = pFunc->aArgs;` |
|       10 |  3503 | `		pClosure->aByteCode = pFunc->aByteCode;` |
|       10 |  3504 | `		pClosure->aStatic = pFunc->aStatic;` |
|       10 |  3505 | `		pClosure->iFlags = pFunc->iFlags;` |
|       10 |  3506 | `		pClosure->pUserData = pFunc->pUserData;` |
|       10 |  3507 | `		pClosure->sSignature = pFunc->sSignature;` |
|       10 |  3508 | `		pClosure->nReturnType = pFunc->nReturnType;` |
|       10 |  3509 | `		pClosure->sReturnClass = pFunc->sReturnClass;` |
|       10 |  3510 | `		SyStringInitFromBuf(&pClosure->sName,zName,mLen);` |
|        - |  3511 | `		/* Register the closure */` |
|       10 |  3512 | `		PH7_VmInstallUserFunction(pVm,pClosure,0);` |
|        - |  3513 | `		/* Set up closure environment */` |
|       10 |  3514 | `		SySetInit(&pClosure->aClosureEnv,&pVm->sAllocator,sizeof(ph7_vm_func_closure_env));` |
|       10 |  3515 | `		aEnv = (ph7_vm_func_closure_env *)SySetBasePtr(&pFunc->aClosureEnv);` |
|       28 |  3516 | `		for( n = 0 ; n < SySetUsed(&pFunc->aClosureEnv) ; ++n ){` |
|        - |  3517 | `			ph7_value *pValue;` |
|       20 |  3518 | `			pEnv = &aEnv[n];` |
|       20 |  3519 | `			sEnv.sName  = pEnv->sName;` |
|       20 |  3520 | `			sEnv.iFlags = pEnv->iFlags;` |
|       20 |  3521 | `			sEnv.nIdx = SXU32_HIGH;` |
|       20 |  3522 | `			PH7_MemObjInit(pVm,&sEnv.sValue);` |
|       20 |  3523 | `			if( sEnv.iFlags & VM_FUNC_ARG_BY_REF ){` |
...
|       20 |  3530 | `			pValue = VmExtractMemObj(pVm,&sEnv.sName,FALSE,FALSE);` |
|       20 |  3531 | `			if( pValue ){` |
|        - |  3532 | `				/* Copy imported value */` |
|       12 |  3533 | `				PH7_MemObjStore(pValue,&sEnv.sValue);` |
|        5 |  3534 | `			}` |
|        - |  3535 | `			/* Insert the imported variable */` |
|       20 |  3536 | `			SySetPut(&pClosure->aClosureEnv,(const void *)&sEnv);` |
|       11 |  3537 | `		}` |
|        - |  3538 | `		/* Finally,load the closure name on the stack */` |
|       10 |  3539 | `		pTos++;` |
|       10 |  3540 | `		PH7_MemObjStringAppend(pTos,zName,mLen);` |
|        4 |  3541 | `	}` |
|       10 |  3542 | `	break;` |
|        - |  3543 | `						 }` |
|        - |  3544 | `/*` |
...
|        - |  3573 | `		}` |
|   117041 |  3574 | `		break;` |
|   228136 |  3575 | `	}else if( pInstr->p3 == 0 ){` |
...
|        - |  3610 | ` */` |
|    82964 |  3611 | `case PH7_OP_STORE_IDX:` |
|        - |  3612 | `case PH7_OP_STORE_IDX_REF: {` |
|   165930 |  3613 | `	ph7_hashmap *pMap = 0; /* cc  warning */` |
|        - |  3614 | `	ph7_value *pKey;` |
|        - |  3615 | `	sxu32 nIdx;` |
|   165930 |  3616 | `	if( pInstr->iP1 ){` |
|        - |  3617 | `		/* Key is next on stack */` |
|    57824 |  3618 | `		pKey = pTos;` |
|    57824 |  3619 | `		pTos--;` |
|    28913 |  3620 | `	}else{` |
|   108108 |  3621 | `		pKey = 0;` |
|        - |  3622 | `	}` |
|   165930 |  3623 | `	nIdx = pTos->nIdx;` |
|   165930 |  3624 | `	if( pTos->iFlags & MEMOBJ_HASHMAP ){` |
...
|   165878 |  3628 | `		if( nIdx != SXU32_HIGH ){` |
|   165878 |  3629 | `			ph7_value *pBacking = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx);` |
|   248816 |  3630 | `			if( pBacking && (pBacking->iFlags & MEMOBJ_HASHMAP) ){` |
|   165878 |  3631 | `				ph7_hashmap *pCur = (ph7_hashmap *)pTos->x.pOther;` |
...
|   165878 |  3636 | `				if( pBacking->x.pOther == (void *)pCur ){` |
|   165878 |  3637 | `					pCur->iRef--;  /* Undo stack ref to reveal true sharing count */` |
|   165878 |  3638 | `					pMap = PH7_HashmapCowSeparate(&(*pVm),pBacking);` |
|   165878 |  3639 | `					pMap->iRef++;  /* Re-add stack ref */` |
|   165878 |  3640 | `					pTos->x.pOther = pMap;` |
|    82940 |  3641 | `				}else{` |
...
|        - |  3713 | `	}` |
|   165878 |  3714 | `	VmPopOperand(&pTos,1);` |
|        - |  3715 | `	/* Phase#2: Perform the insertion */` |
|   165878 |  3716 | `	if( pInstr->iOp == PH7_OP_STORE_IDX_REF && pTos->nIdx != SXU32_HIGH ){` |
|        - |  3717 | `		/* Insertion by reference */` |
|       15 |  3718 | `		PH7_HashmapInsertByRef(pMap,pKey,pTos->nIdx);` |
|        8 |  3719 | `	}else{` |
|   165864 |  3720 | `		PH7_HashmapInsert(pMap,pKey,pTos);` |
|        - |  3721 | `	}` |
|   165878 |  3722 | `	if( pKey ){` |
|    57774 |  3723 | `		PH7_MemObjRelease(pKey);` |
|    28886 |  3724 | `	}` |
|   165878 |  3725 | `	break;` |
|        - |  3726 | `					   }` |
|        - |  3727 | `/*` |
...
|        - |  3733 | ` */` |
|   151386 |  3734 | `case PH7_OP_INCR:` |
|        - |  3735 | `#ifdef UNTRUST` |
|        - |  3736 | `	if( pTos < pStack ){` |
|        - |  3737 | `		goto Abort;` |
|        - |  3738 | `	}` |
|        - |  3739 | `#endif` |
|   302818 |  3740 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES)) == 0 ){` |
|   302818 |  3741 | `		if( pTos->nIdx != SXU32_HIGH ){` |
|        - |  3742 | `			ph7_value *pObj;` |
|   302818 |  3743 | `			if( (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pTos->nIdx)) != 0 ){` |
|        - |  3744 | `				/* Force a numeric cast */` |
|   302818 |  3745 | `				PH7_MemObjToNumeric(pObj);` |
|   302818 |  3746 | `				if( pObj->iFlags & MEMOBJ_REAL ){` |
|      ! 0 |  3747 | `					pObj->rVal++;` |
|        - |  3748 | `					/* Try to get an integer representation */` |
|      ! 0 |  3749 | `					PH7_MemObjTryInteger(pTos);` |
|      ! 0 |  3750 | `				}else{` |
|   302818 |  3751 | `					pObj->x.iVal++;` |
|   302818 |  3752 | `					MemObjSetType(pTos,MEMOBJ_INT);` |
|        - |  3753 | `				}` |
|   302818 |  3754 | `				if( pInstr->iP1 ){` |
|        - |  3755 | `					/* Pre-icrement */` |
...
|    48256 |  3837 | `	PH7_MemObjToNumeric(pTos);` |
|    48256 |  3838 | `	if( pTos->iFlags & MEMOBJ_REAL ){` |
|       32 |  3839 | `		pTos->rVal = -pTos->rVal;` |
|       15 |  3840 | `	}` |
|    48256 |  3841 | `	if( pTos->iFlags & MEMOBJ_INT ){` |
|    48226 |  3842 | `		pTos->x.iVal = -pTos->x.iVal;` |
|    24112 |  3843 | `	}` |
|    48256 |  3844 | `	break;` |
|        - |  3845 | `/*` |
|        - |  3846 | ` * UPLUS: * * *` |
...
|       33 |  3857 | `	PH7_MemObjToNumeric(pTos);` |
|       33 |  3858 | `	if( pTos->iFlags & MEMOBJ_REAL ){` |
|      ! 0 |  3859 | `		pTos->rVal = +pTos->rVal;` |
|      ! 0 |  3860 | `	}` |
|       33 |  3861 | `	if( pTos->iFlags & MEMOBJ_INT ){` |
|       33 |  3862 | `		pTos->x.iVal = +pTos->x.iVal;` |
|       16 |  3863 | `	}` |
|       33 |  3864 | `	break;` |
|        - |  3865 | `/*` |
|        - |  3866 | ` * OP_LNOT: * * *` |
...
|    80700 |  3878 | `	if( (pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|       21 |  3879 | `		PH7_MemObjToBool(pTos);` |
|       10 |  3880 | `	}` |
|    80700 |  3881 | `	pTos->x.iVal = !pTos->x.iVal;` |
|    80700 |  3882 | `	break;` |
|        - |  3883 | `/*` |
|        - |  3884 | ` * OP_BITNOT: * * *` |
|        - |  3885 | ` *` |
...
|       30 |  3896 | `	if( (pTos->iFlags & MEMOBJ_INT) == 0 ){` |
|      ! 0 |  3897 | `		PH7_MemObjToInteger(pTos);` |
|      ! 0 |  3898 | `	}` |
|       30 |  3899 | `	pTos->x.iVal = ~pTos->x.iVal;` |
|       30 |  3900 | `	break;` |
|        - |  3901 | `/* OP_MUL * * *` |
|        - |  3902 | ` * OP_MUL_STORE * * *` |
|        - |  3903 | ` *` |
...
|        - |  3906 | ` */` |
|     1247 |  3907 | `case PH7_OP_MUL:` |
|        - |  3908 | `case PH7_OP_MUL_STORE: {` |
|     2496 |  3909 | `	ph7_value *pNos = &pTos[-1];` |
...
|        - |  3914 | `	}` |
|        - |  3915 | `#endif` |
|     2496 |  3916 | `	PH7_MemObjToNumeric(pTos);` |
|     2496 |  3917 | `	PH7_MemObjToNumeric(pNos);` |
|        - |  3918 | `	/* Perform the requested operation */` |
|     2496 |  3919 | `	if( MEMOBJ_REAL & (pTos->iFlags\|pNos->iFlags) ){` |
...
|        - |  3938 | `		sxi64 a,b,r;` |
|     2480 |  3939 | `		a = pNos->x.iVal;` |
|     2480 |  3940 | `		b = pTos->x.iVal;` |
|     2480 |  3941 | `		r = a * b;` |
|        - |  3942 | `		/* Push the result */` |
|     2480 |  3943 | `		pNos->x.iVal = r;` |
|     2480 |  3944 | `		MemObjSetType(pNos,MEMOBJ_INT);` |
|        - |  3945 | `	}` |
|     2496 |  3946 | `	if( pInstr->iOp == PH7_OP_MUL_STORE ){` |
|        - |  3947 | `		ph7_value *pObj;` |
|       25 |  3948 | `		if( pTos->nIdx == SXU32_HIGH ){` |
|      ! 0 |  3949 | `			PH7_VmThrowError(&(*pVm),0,PH7_CTX_ERR,"Cannot perform assignment on a constant class attribute");` |
|       25 |  3950 | `		}else if( (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pTos->nIdx)) != 0 ){` |
|       25 |  3951 | `			PH7_MemObjStore(pNos,pObj);` |
|       12 |  3952 | `		}` |
|       12 |  3953 | `	}` |
|     2496 |  3954 | `	VmPopOperand(&pTos,1);` |
|     2496 |  3955 | `	break;` |
|        - |  3956 | `				 }` |
|        - |  3957 | `/* OP_ADD * * *` |
|        - |  3958 | ` *` |
...
|        - |  3961 | ` */` |
|      446 |  3962 | `case PH7_OP_ADD:{` |
|      894 |  3963 | `	ph7_value *pNos = &pTos[-1];` |
|        - |  3964 | `#ifdef UNTRUST` |
|        - |  3965 | `	if( pNos < pStack ){` |
|        - |  3966 | `		goto Abort;` |
|        - |  3967 | `	}` |
...
|      894 |  3970 | `	PH7_MemObjAdd(pNos,pTos,FALSE);` |
|      894 |  3971 | `	VmPopOperand(&pTos,1);` |
|      894 |  3972 | `	break;` |
|        - |  3973 | `				}` |
|        - |  3974 | `/*` |
|        - |  3975 | ` * OP_ADD_STORE * * *` |
...
|        - |  3979 | ` */` |
|      494 |  3980 | `case PH7_OP_ADD_STORE:{` |
|      990 |  3981 | `	ph7_value *pNos = &pTos[-1];` |
|        - |  3982 | `	ph7_value *pObj;` |
|        - |  3983 | `	sxu32 nIdx;` |
|        - |  3984 | `#ifdef UNTRUST` |
|        - |  3985 | `	if( pNos < pStack ){` |
...
|      990 |  3990 | `	nIdx = pTos->nIdx;` |
|      990 |  3991 | `	PH7_MemObjAdd(pTos,pNos,TRUE);` |
|        - |  3992 | `	/* Peform the store operation */` |
|      990 |  3993 | `	if( nIdx == SXU32_HIGH ){` |
|      ! 0 |  3994 | `		PH7_VmThrowError(&(*pVm),0,PH7_CTX_ERR,"Cannot perform assignment on a constant class attribute");` |
|      990 |  3995 | `	}else if( (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nIdx)) != 0 ){` |
|      990 |  3996 | `		PH7_MemObjStore(pTos,pObj);` |
|      494 |  3997 | `	}` |
|        - |  3998 | `	/* Ticket 1433-35: Perform a stack dup */` |
|      990 |  3999 | `	PH7_MemObjStore(pTos,pNos);` |
|      990 |  4000 | `	VmPopOperand(&pTos,1);` |
|      990 |  4001 | `	break;` |
|        - |  4002 | `				}` |
|        - |  4003 | `/* OP_SUB * * *` |
|        - |  4004 | ` *` |
...
|        - |  4008 | ` */` |
|      299 |  4009 | `case PH7_OP_SUB: {` |
|      600 |  4010 | `	ph7_value *pNos = &pTos[-1];` |
|        - |  4011 | `#ifdef UNTRUST` |
|        - |  4012 | `	if( pNos < pStack ){` |
|        - |  4013 | `		goto Abort;` |
|        - |  4014 | `	}` |
|        - |  4015 | `#endif` |
|      600 |  4016 | `	if( MEMOBJ_REAL & (pTos->iFlags\|pNos->iFlags) ){` |
...
|        - |  4035 | `		sxi64 a,b,r;` |
|      506 |  4036 | `		a = pNos->x.iVal;` |
|      506 |  4037 | `		b = pTos->x.iVal;` |
|      506 |  4038 | `		r = a - b;` |
|        - |  4039 | `		/* Push the result */` |
|      506 |  4040 | `		pNos->x.iVal = r;` |
|      506 |  4041 | `		MemObjSetType(pNos,MEMOBJ_INT);` |
|        - |  4042 | `	}` |
|      600 |  4043 | `	VmPopOperand(&pTos,1);` |
|      600 |  4044 | `	break;` |
|        - |  4045 | `				 }` |
|        - |  4046 | `/* OP_SUB_STORE * * *` |
|        - |  4047 | ` *` |
...
|        - |  4051 | ` */` |
|        1 |  4052 | `case PH7_OP_SUB_STORE: {` |
|        3 |  4053 | `	ph7_value *pNos = &pTos[-1];` |
|        - |  4054 | `	ph7_value *pObj;` |
|        - |  4055 | `#ifdef UNTRUST` |
|        - |  4056 | `	if( pNos < pStack ){` |
|        - |  4057 | `		goto Abort;` |
|        - |  4058 | `	}` |
|        - |  4059 | `#endif` |
|        3 |  4060 | `	if( MEMOBJ_REAL & (pTos->iFlags\|pNos->iFlags) ){` |
...
|        - |  4079 | `		sxi64 a,b,r;` |
|        3 |  4080 | `		a = pTos->x.iVal;` |
|        3 |  4081 | `		b = pNos->x.iVal;` |
|        3 |  4082 | `		r = a - b;` |
|        - |  4083 | `		/* Push the result */` |
|        3 |  4084 | `		pNos->x.iVal = r;` |
|        3 |  4085 | `		MemObjSetType(pNos,MEMOBJ_INT);` |
|        - |  4086 | `	}` |
|        3 |  4087 | `	if( pTos->nIdx == SXU32_HIGH ){` |
|      ! 0 |  4088 | `		PH7_VmThrowError(&(*pVm),0,PH7_CTX_ERR,"Cannot perform assignment on a constant class attribute");` |
|        3 |  4089 | `	}else if( (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pTos->nIdx)) != 0 ){` |
|        3 |  4090 | `		PH7_MemObjStore(pNos,pObj);` |
|        1 |  4091 | `	}` |
|        3 |  4092 | `	VmPopOperand(&pTos,1);` |
|        3 |  4093 | `	break;` |
|        - |  4094 | `				 }` |
|        - |  4095 |  |
|        - |  4096 | `/*` |
...
|        - |  4104 | ` */` |
|      305 |  4105 | `case PH7_OP_MOD:{` |
|      612 |  4106 | `	ph7_value *pNos = &pTos[-1];` |
|        - |  4107 | `	sxi64 a,b,r;` |
|        - |  4108 | `#ifdef UNTRUST` |
|        - |  4109 | `	if( pNos < pStack ){` |
|        - |  4110 | `		goto Abort;` |
...
|      612 |  4114 | `	if( (pTos->iFlags & MEMOBJ_INT) == 0 ){` |
|      ! 0 |  4115 | `		PH7_MemObjToInteger(pTos);` |
|      ! 0 |  4116 | `	}` |
|      612 |  4117 | `	if( (pNos->iFlags & MEMOBJ_INT) == 0 ){` |
|        5 |  4118 | `		PH7_MemObjToInteger(pNos);` |
|        2 |  4119 | `	}` |
|        - |  4120 | `	/* Perform the requested operation */` |
|      612 |  4121 | `	a = pNos->x.iVal;` |
|      612 |  4122 | `	b = pTos->x.iVal;` |
|      612 |  4123 | `	if( b == 0 ){` |
|        3 |  4124 | `		r = 0;` |
...
|      612 |  4131 | `	pNos->x.iVal = r;` |
|      612 |  4132 | `	MemObjSetType(pNos,MEMOBJ_INT);` |
|      612 |  4133 | `	VmPopOperand(&pTos,1);` |
|      612 |  4134 | `	break;` |
|        - |  4135 | `				}` |
|        - |  4136 | `/*` |
|        - |  4137 | ` * OP_MOD_STORE * * *` |
...
|        - |  4189 | ` */` |
|       28 |  4190 | `case PH7_OP_DIV:{` |
|       58 |  4191 | `	ph7_value *pNos = &pTos[-1];` |
|        - |  4192 | `	ph7_real a,b,r;` |
|        - |  4193 | `#ifdef UNTRUST` |
|        - |  4194 | `	if( pNos < pStack ){` |
|        - |  4195 | `		goto Abort;` |
...
|       58 |  4199 | `	if( (pTos->iFlags & MEMOBJ_REAL) == 0 ){` |
|       54 |  4200 | `		PH7_MemObjToReal(pTos);` |
|       26 |  4201 | `	}` |
|       58 |  4202 | `	if( (pNos->iFlags & MEMOBJ_REAL) == 0 ){` |
|       20 |  4203 | `		PH7_MemObjToReal(pNos);` |
|        9 |  4204 | `	}` |
...
|       55 |  4216 | `		pNos->rVal = r;` |
|       55 |  4217 | `		MemObjSetType(pNos,MEMOBJ_REAL);` |
|        - |  4218 | `		/* Try to get an integer representation */` |
|       55 |  4219 | `		PH7_MemObjTryInteger(pNos);` |
|        - |  4220 | `	}` |
|       58 |  4221 | `	VmPopOperand(&pTos,1);` |
|       58 |  4222 | `	break;` |
|        - |  4223 | `				}` |
|        - |  4224 | `/*` |
|        - |  4225 | ` * OP_DIV_STORE * * *` |
...
|        - |  4288 | ` * two elements.` |
|        - |  4289 | ` */` |
|       30 |  4290 | `case PH7_OP_BAND:` |
|        - |  4291 | `case PH7_OP_BOR:` |
|        - |  4292 | `case PH7_OP_BXOR:{` |
|       62 |  4293 | `	ph7_value *pNos = &pTos[-1];` |
|        - |  4294 | `	sxi64 a,b,r;` |
|        - |  4295 | `#ifdef UNTRUST` |
|        - |  4296 | `	if( pNos < pStack ){` |
|        - |  4297 | `		goto Abort;` |
...
|       62 |  4301 | `	if( (pTos->iFlags & MEMOBJ_INT) == 0 ){` |
|      ! 0 |  4302 | `		PH7_MemObjToInteger(pTos);` |
|      ! 0 |  4303 | `	}` |
|       62 |  4304 | `	if( (pNos->iFlags & MEMOBJ_INT) == 0 ){` |
|      ! 0 |  4305 | `		PH7_MemObjToInteger(pNos);` |
|      ! 0 |  4306 | `	}` |
|        - |  4307 | `	/* Perform the requested operation */` |
|       62 |  4308 | `	a = pNos->x.iVal;` |
|       62 |  4309 | `	b = pTos->x.iVal;` |
|       62 |  4310 | `	switch(pInstr->iOp){` |
|        6 |  4311 | `	case PH7_OP_BOR_STORE:` |
|       13 |  4312 | `	case PH7_OP_BOR:  r = a\|b; break;` |
|        6 |  4313 | `	case PH7_OP_BXOR_STORE:` |
|       13 |  4314 | `	case PH7_OP_BXOR: r = a^b; break;` |
|       18 |  4315 | `	case PH7_OP_BAND_STORE:` |
|       18 |  4316 | `	case PH7_OP_BAND:` |
|       38 |  4317 | `	default:          r = a&b; break;` |
|        - |  4318 | `	}` |
|        - |  4319 | `	/* Push the result */` |
|       62 |  4320 | `	pNos->x.iVal = r;` |
|       62 |  4321 | `	MemObjSetType(pNos,MEMOBJ_INT);` |
|       62 |  4322 | `	VmPopOperand(&pTos,1);` |
|       62 |  4323 | `	break;` |
|        - |  4324 | `				 }` |
|        - |  4325 | `/* OP_BAND_STORE * * *` |
|        - |  4326 | ` *` |
...
|        - |  4341 | ` * two elements.` |
|        - |  4342 | ` */` |
|        7 |  4343 | `case PH7_OP_BAND_STORE:` |
|        - |  4344 | `case PH7_OP_BOR_STORE:` |
|        - |  4345 | `case PH7_OP_BXOR_STORE:{` |
|       15 |  4346 | `	ph7_value *pNos = &pTos[-1];` |
|        - |  4347 | `	ph7_value *pObj;` |
|        - |  4348 | `	sxi64 a,b,r;` |
|        - |  4349 | `#ifdef UNTRUST` |
|        - |  4350 | `	if( pNos < pStack ){` |
...
|       15 |  4355 | `	if( (pTos->iFlags & MEMOBJ_INT) == 0 ){` |
|      ! 0 |  4356 | `		PH7_MemObjToInteger(pTos);` |
|      ! 0 |  4357 | `	}` |
|       15 |  4358 | `	if( (pNos->iFlags & MEMOBJ_INT) == 0 ){` |
|      ! 0 |  4359 | `		PH7_MemObjToInteger(pNos);` |
|      ! 0 |  4360 | `	}` |
|        - |  4361 | `	/* Perform the requested operation */` |
|       15 |  4362 | `	a = pTos->x.iVal;` |
|       15 |  4363 | `	b = pNos->x.iVal;` |
|       15 |  4364 | `	switch(pInstr->iOp){` |
|        2 |  4365 | `	case PH7_OP_BOR_STORE:` |
|        5 |  4366 | `	case PH7_OP_BOR:  r = a\|b; break;` |
|        3 |  4367 | `	case PH7_OP_BXOR_STORE:` |
|        7 |  4368 | `	case PH7_OP_BXOR: r = a^b; break;` |
|        2 |  4369 | `	case PH7_OP_BAND_STORE:` |
|        2 |  4370 | `	case PH7_OP_BAND:` |
|        5 |  4371 | `	default:          r = a&b; break;` |
|        - |  4372 | `	}` |
|        - |  4373 | `	/* Push the result */` |
|       15 |  4374 | `	pNos->x.iVal = r;` |
|       15 |  4375 | `	MemObjSetType(pNos,MEMOBJ_INT);` |
|       15 |  4376 | `	if( pTos->nIdx == SXU32_HIGH ){` |
|      ! 0 |  4377 | `		PH7_VmThrowError(&(*pVm),0,PH7_CTX_ERR,"Cannot perform assignment on a constant class attribute");` |
|       15 |  4378 | `	}else if( (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pTos->nIdx)) != 0 ){` |
|       15 |  4379 | `		PH7_MemObjStore(pNos,pObj);` |
|        7 |  4380 | `	}` |
|       15 |  4381 | `	VmPopOperand(&pTos,1);` |
|       15 |  4382 | `	break;` |
|        - |  4383 | `				 }` |
|        - |  4384 | `/* OP_SHL * * *` |
|        - |  4385 | ` *` |
...
|        - |  4397 | ` */` |
|        9 |  4398 | `case PH7_OP_SHL:` |
|        - |  4399 | `case PH7_OP_SHR: {` |
|       19 |  4400 | `	ph7_value *pNos = &pTos[-1];` |
|        - |  4401 | `	sxi64 a,r;` |
|        - |  4402 | `	sxi32 b;` |
|        - |  4403 | `#ifdef UNTRUST` |
|        - |  4404 | `	if( pNos < pStack ){` |
...
|       19 |  4409 | `	if( (pTos->iFlags & MEMOBJ_INT) == 0 ){` |
|      ! 0 |  4410 | `		PH7_MemObjToInteger(pTos);` |
|      ! 0 |  4411 | `	}` |
|       19 |  4412 | `	if( (pNos->iFlags & MEMOBJ_INT) == 0 ){` |
|      ! 0 |  4413 | `		PH7_MemObjToInteger(pNos);` |
|      ! 0 |  4414 | `	}` |
|        - |  4415 | `	/* Perform the requested operation */` |
|       19 |  4416 | `	a = pNos->x.iVal;` |
|       19 |  4417 | `	b = (sxi32)pTos->x.iVal;` |
|       19 |  4418 | `	if( pInstr->iOp == PH7_OP_SHL ){` |
|       11 |  4419 | `		r = a << b;` |
|        6 |  4420 | `	}else{` |
|        9 |  4421 | `		r = a >> b;` |
|        - |  4422 | `	}` |
|        - |  4423 | `	/* Push the result */` |
|       19 |  4424 | `	pNos->x.iVal = r;` |
|       19 |  4425 | `	MemObjSetType(pNos,MEMOBJ_INT);` |
|       19 |  4426 | `	VmPopOperand(&pTos,1);` |
|       19 |  4427 | `	break;` |
|        - |  4428 | `				 }` |
|        - |  4429 | `/*  OP_SHL_STORE * * *` |
|        - |  4430 | ` *` |
...
|        - |  4442 | ` */` |
|        7 |  4443 | `case PH7_OP_SHL_STORE:` |
|        - |  4444 | `case PH7_OP_SHR_STORE: {` |
|       15 |  4445 | `	ph7_value *pNos = &pTos[-1];` |
|        - |  4446 | `	ph7_value *pObj;` |
|        - |  4447 | `	sxi64 a,r;` |
|        - |  4448 | `	sxi32 b;` |
|        - |  4449 | `#ifdef UNTRUST` |
...
|       15 |  4455 | `	if( (pTos->iFlags & MEMOBJ_INT) == 0 ){` |
|      ! 0 |  4456 | `		PH7_MemObjToInteger(pTos);` |
|      ! 0 |  4457 | `	}` |
|       15 |  4458 | `	if( (pNos->iFlags & MEMOBJ_INT) == 0 ){` |
|      ! 0 |  4459 | `		PH7_MemObjToInteger(pNos);` |
|      ! 0 |  4460 | `	}` |
|        - |  4461 | `	/* Perform the requested operation */` |
|       15 |  4462 | `	a = pTos->x.iVal;` |
|       15 |  4463 | `	b = (sxi32)pNos->x.iVal;` |
|       15 |  4464 | `	if( pInstr->iOp == PH7_OP_SHL_STORE ){` |
|        7 |  4465 | `		r = a << b;` |
|        4 |  4466 | `	}else{` |
|        9 |  4467 | `		r = a >> b;` |
|        - |  4468 | `	}` |
|        - |  4469 | `	/* Push the result */` |
|       15 |  4470 | `	pNos->x.iVal = r;` |
|       15 |  4471 | `	MemObjSetType(pNos,MEMOBJ_INT);` |
|       15 |  4472 | `	if( pTos->nIdx == SXU32_HIGH ){` |
|      ! 0 |  4473 | `		PH7_VmThrowError(&(*pVm),0,PH7_CTX_ERR,"Cannot perform assignment on a constant class attribute");` |
|       15 |  4474 | `	}else if( (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pTos->nIdx)) != 0 ){` |
|       15 |  4475 | `		PH7_MemObjStore(pNos,pObj);` |
|        7 |  4476 | `	}` |
|       15 |  4477 | `	VmPopOperand(&pTos,1);` |
|       15 |  4478 | `	break;` |
|        - |  4479 | `				 }` |
|        - |  4480 | `/* CAT:  P1 * *` |
|        - |  4481 | ` *` |
...
|        - |  4483 | ` * back.` |
|        - |  4484 | ` */` |
|    64055 |  4485 | `case PH7_OP_CAT:{` |
|        - |  4486 | `	ph7_value *pNos,*pCur;` |
|   128112 |  4487 | `	if( pInstr->iP1 < 1 ){` |
|   101062 |  4488 | `		pNos = &pTos[-1];` |
|    50532 |  4489 | `	}else{` |
|    27052 |  4490 | `		pNos = &pTos[-pInstr->iP1+1];` |
|        - |  4491 | `	}` |
|        - |  4492 | `#ifdef UNTRUST` |
|        - |  4493 | `	if( pNos < pStack ){` |
|        - |  4494 | `		goto Abort;` |
...
|   128112 |  4498 | `	if( (pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|     1268 |  4499 | `		PH7_MemObjToString(pNos);` |
|      633 |  4500 | `	}` |
|   128112 |  4501 | `	pCur = &pNos[1];` |
|   258272 |  4502 | `	while( pCur <= pTos ){` |
|   130162 |  4503 | `		if( (pCur->iFlags & MEMOBJ_STRING) == 0 ){` |
|    50644 |  4504 | `			PH7_MemObjToString(pCur);` |
|    25321 |  4505 | `		}` |
|        - |  4506 | `		/* Perform the concatenation */` |
|   130162 |  4507 | `		if( SyBlobLength(&pCur->sBlob) > 0 ){` |
|   130124 |  4508 | `			PH7_MemObjStringAppend(pNos,(const char *)SyBlobData(&pCur->sBlob),SyBlobLength(&pCur->sBlob));` |
|    65061 |  4509 | `		}` |
|   130162 |  4510 | `		SyBlobRelease(&pCur->sBlob);` |
|   130162 |  4511 | `		pCur++;` |
|        2 |  4512 | `	}` |
|   128112 |  4513 | `	pTos = pNos;` |
|   128112 |  4514 | `	break;` |
|        - |  4515 | `				}` |
|        - |  4516 | `/*  CAT_STORE: * * *` |
|        - |  4517 | ` *` |
...
|        - |  4519 | ` * back.` |
|        - |  4520 | ` */` |
|     3766 |  4521 | `case PH7_OP_CAT_STORE:{` |
|     7534 |  4522 | `	ph7_value *pNos = &pTos[-1];` |
|        - |  4523 | `	ph7_value *pObj;` |
|        - |  4524 | `#ifdef UNTRUST` |
|        - |  4525 | `	if( pNos < pStack ){` |
|        - |  4526 | `		goto Abort;` |
|        - |  4527 | `	}` |
|        - |  4528 | `#endif` |
|     7534 |  4529 | `	if((pTos->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - |  4530 | `		/* Force a string cast */` |
|      ! 0 |  4531 | `		PH7_MemObjToString(pTos);` |
|      ! 0 |  4532 | `	}` |
|     7534 |  4533 | `	if((pNos->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - |  4534 | `		/* Force a string cast */` |
|      ! 0 |  4535 | `		PH7_MemObjToString(pNos);` |
|      ! 0 |  4536 | `	}` |
|        - |  4537 | `	/* Perform the concatenation (Reverse order) */` |
|     7534 |  4538 | `	if( SyBlobLength(&pNos->sBlob) > 0 ){` |
|     7534 |  4539 | `		PH7_MemObjStringAppend(pTos,(const char *)SyBlobData(&pNos->sBlob),SyBlobLength(&pNos->sBlob));` |
|     3766 |  4540 | `	}` |
|        - |  4541 | `	/* Perform the store operation */` |
|     7534 |  4542 | `	if( pTos->nIdx == SXU32_HIGH ){` |
|      ! 0 |  4543 | `		PH7_VmThrowError(&(*pVm),0,PH7_CTX_ERR,"Cannot perform assignment on a constant class attribute");` |
|     7534 |  4544 | `	}else if( (pObj = (ph7_value *)SySetAt(&pVm->aMemObj,pTos->nIdx)) != 0 ){` |
|     7534 |  4545 | `		PH7_MemObjStore(pTos,pObj);` |
|     3766 |  4546 | `	}` |
|     7534 |  4547 | `	PH7_MemObjStore(pTos,pNos);` |
|     7534 |  4548 | `	VmPopOperand(&pTos,1);` |
|     7534 |  4549 | `	break;` |
|        - |  4550 | `				}` |
|        - |  4551 | `/* OP_AND: * * *` |
|        - |  4552 | ` *` |
...
|        - |  4561 | ` * stack.` |
|        - |  4562 | ` */` |
|    94760 |  4563 | `case PH7_OP_LAND:` |
|        - |  4564 | `case PH7_OP_LOR: {` |
|   189566 |  4565 | `	ph7_value *pNos = &pTos[-1];` |
...
|   189566 |  4573 | `	if((pTos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|        3 |  4574 | `		PH7_MemObjToBool(pTos);` |
|        1 |  4575 | `	}` |
|   189566 |  4576 | `	if((pNos->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      ! 0 |  4577 | `		PH7_MemObjToBool(pNos);` |
|      ! 0 |  4578 | `	}` |
|   189566 |  4579 | `	v1 = pNos->x.iVal == 0 ? 1 : 0;` |
|   189566 |  4580 | `	v2 = pTos->x.iVal == 0 ? 1 : 0;` |
|   189566 |  4581 | `	if( pInstr->iOp == PH7_OP_LAND ){` |
|        - |  4582 | `		static const unsigned char and_logic[] = { 0, 1, 2, 1, 1, 1, 2, 1, 2 };` |
|    87094 |  4583 | `		v1 = and_logic[v1*3+v2];` |
|    43570 |  4584 | `	}else{` |
|        - |  4585 | `		static const unsigned char or_logic[] = { 0, 0, 0, 0, 1, 2, 0, 2, 2 };` |
|   102474 |  4586 | `		v1 = or_logic[v1*3+v2];` |
|        - |  4587 | `	}` |
|   189566 |  4588 | `	if( v1 == 2 ){` |
|      ! 0 |  4589 | `		v1 = 1;` |
|      ! 0 |  4590 | `	}` |
|   189566 |  4591 | `	VmPopOperand(&pTos,1);` |
|   189566 |  4592 | `	pTos->x.iVal = v1 == 0 ? 1 : 0;` |
|   189566 |  4593 | `	MemObjSetType(pTos,MEMOBJ_BOOL);` |
|   189566 |  4594 | `	break;` |
|        - |  4595 | `				 }` |
|        - |  4596 | `/*` |
|        - |  4597 | ` * OP_NULLC: * * *` |
...
|        - |  4612 | `	}` |
|        - |  4613 | `#endif` |
|       39 |  4614 | `	if( (pTos->iFlags & MEMOBJ_NULL) == 0 ){` |
|        - |  4615 | `		/* Left is not null — keep it and skip the RHS */` |
|       17 |  4616 | `		pc = pInstr->iP2 - 1; /* Jump (will be incremented by the loop) */` |
|        9 |  4617 | `	}else{` |
|        - |  4618 | `		/* Left is null — discard it, fall through to evaluate RHS */` |
|       23 |  4619 | `		VmPopOperand(&pTos, 1);` |
|        - |  4620 | `	}` |
|       39 |  4621 | `	break;` |
|        - |  4622 |  |
|        - |  4623 | `/*` |
...
|        - |  4725 | ` */` |
|     3970 |  4726 | `case PH7_OP_EQ:` |
|        - |  4727 | `case PH7_OP_NEQ: {` |
|     7942 |  4728 | `	ph7_value *pNos = &pTos[-1];` |
...
|        - |  4733 | `	}` |
|        - |  4734 | `#endif` |
|     7942 |  4735 | `	rc = PH7_MemObjCmp(pNos,pTos,FALSE,0);` |
|     7942 |  4736 | `	if( VmIsUnorderedCmp(pNos,pTos) ){` |
|       20 |  4737 | `		rc = pInstr->iOp == PH7_OP_EQ ? 0 : 1;` |
|     7933 |  4738 | `	}else if( pInstr->iOp == PH7_OP_EQ ){` |
|     7898 |  4739 | `		rc = rc == 0;` |
|     3950 |  4740 | `	}else{` |
|       28 |  4741 | `		rc = rc != 0;` |
|        - |  4742 | `	}` |
|     7942 |  4743 | `	VmPopOperand(&pTos,1);` |
|     7942 |  4744 | `	if( !pInstr->iP2 ){` |
|        - |  4745 | `		/* Push comparison result without taking the jump */` |
|     7942 |  4746 | `		PH7_MemObjRelease(pTos);` |
|     7942 |  4747 | `		pTos->x.iVal = rc;` |
|        - |  4748 | `		/* Invalidate any prior representation */` |
|     7942 |  4749 | `		MemObjSetType(pTos,MEMOBJ_BOOL);` |
|     3972 |  4750 | `	}else{` |
|      ! 0 |  4751 | `		if( rc ){` |
...
|        - |  4765 | ` */` |
|   133687 |  4766 | `case PH7_OP_TEQ: {` |
|   267376 |  4767 | `	ph7_value *pNos = &pTos[-1];` |
...
|        - |  4772 | `	}` |
|        - |  4773 | `#endif` |
|   267376 |  4774 | `	rc = PH7_MemObjCmp(pNos,pTos,TRUE,0);` |
|   267376 |  4775 | `	if( VmIsUnorderedCmp(pNos,pTos) ){` |
|        3 |  4776 | `		rc = 0;` |
|        2 |  4777 | `	}else{` |
|   267374 |  4778 | `		rc = rc == 0;` |
|        - |  4779 | `	}` |
|   267376 |  4780 | `	VmPopOperand(&pTos,1);` |
|   267376 |  4781 | `	if( !pInstr->iP2 ){` |
|        - |  4782 | `		/* Push comparison result without taking the jump */` |
|   267376 |  4783 | `		PH7_MemObjRelease(pTos);` |
|   267376 |  4784 | `		pTos->x.iVal = rc;` |
|        - |  4785 | `		/* Invalidate any prior representation */` |
|   267376 |  4786 | `		MemObjSetType(pTos,MEMOBJ_BOOL);` |
|   133689 |  4787 | `	}else{` |
|      ! 0 |  4788 | `		if( rc ){` |
...
|        - |  4803 | ` *` |
|        - |  4804 | ` */` |
|   103775 |  4805 | `case PH7_OP_TNE: {` |
|   207552 |  4806 | `	ph7_value *pNos = &pTos[-1];` |
...
|        - |  4811 | `	}` |
|        - |  4812 | `#endif` |
|   207552 |  4813 | `	rc = PH7_MemObjCmp(pNos,pTos,TRUE,0);` |
|   207552 |  4814 | `	if( VmIsUnorderedCmp(pNos,pTos) ){` |
|        3 |  4815 | `		rc = 1;` |
|        2 |  4816 | `	}else{` |
|   207550 |  4817 | `		rc = rc != 0;` |
|        - |  4818 | `	}` |
|   207552 |  4819 | `	VmPopOperand(&pTos,1);` |
|   207552 |  4820 | `	if( !pInstr->iP2 ){` |
|        - |  4821 | `		/* Push comparison result without taking the jump */` |
|   207552 |  4822 | `		PH7_MemObjRelease(pTos);` |
|   207552 |  4823 | `		pTos->x.iVal = rc;` |
|        - |  4824 | `		/* Invalidate any prior representation */` |
|   207552 |  4825 | `		MemObjSetType(pTos,MEMOBJ_BOOL);` |
|   103777 |  4826 | `	}else{` |
|      ! 0 |  4827 | `		if( rc ){` |
...
|        - |  4851 | ` *` |
|        - |  4852 | ` */` |
|   102453 |  4853 | `case PH7_OP_LT:` |
|        - |  4854 | `case PH7_OP_LE: {` |
|   204952 |  4855 | `	ph7_value *pNos = &pTos[-1];` |
...
|        - |  4860 | `	}` |
|        - |  4861 | `#endif` |
|   204952 |  4862 | `	rc = PH7_MemObjCmp(pNos,pTos,FALSE,0);` |
|   204952 |  4863 | `	if( VmIsUnorderedCmp(pNos,pTos) ){` |
|        9 |  4864 | `		rc = 0;` |
|   204948 |  4865 | `	}else if( pInstr->iOp == PH7_OP_LE ){` |
|      430 |  4866 | `		rc = rc < 1;` |
|      216 |  4867 | `	}else{` |
|   204516 |  4868 | `		rc = rc < 0;` |
|        - |  4869 | `	}` |
|   204952 |  4870 | `	VmPopOperand(&pTos,1);` |
|   204952 |  4871 | `	if( !pInstr->iP2 ){` |
|        - |  4872 | `		/* Push comparison result without taking the jump */` |
|   204952 |  4873 | `		PH7_MemObjRelease(pTos);` |
|   204952 |  4874 | `		pTos->x.iVal = rc;` |
|        - |  4875 | `		/* Invalidate any prior representation */` |
|   204952 |  4876 | `		MemObjSetType(pTos,MEMOBJ_BOOL);` |
|   102499 |  4877 | `	}else{` |
|      ! 0 |  4878 | `		if( rc ){` |
...
|        - |  4902 | ` *` |
|        - |  4903 | ` */` |
|    48771 |  4904 | `case PH7_OP_GT:` |
|        - |  4905 | `case PH7_OP_GE: {` |
|    97544 |  4906 | `	ph7_value *pNos = &pTos[-1];` |
...
|        - |  4911 | `	}` |
|        - |  4912 | `#endif` |
|    97544 |  4913 | `	rc = PH7_MemObjCmp(pNos,pTos,FALSE,0);` |
|    97544 |  4914 | `	if( VmIsUnorderedCmp(pNos,pTos) ){` |
|        9 |  4915 | `		rc = 0;` |
|    97540 |  4916 | `	}else if( pInstr->iOp == PH7_OP_GE ){` |
|    97388 |  4917 | `		rc = rc >= 0;` |
|    48695 |  4918 | `	}else{` |
|      150 |  4919 | `		rc = rc > 0;` |
|        - |  4920 | `	}` |
|    97544 |  4921 | `	VmPopOperand(&pTos,1);` |
|    97544 |  4922 | `	if( !pInstr->iP2 ){` |
|        - |  4923 | `		/* Push comparison result without taking the jump */` |
|    97544 |  4924 | `		PH7_MemObjRelease(pTos);` |
|    97544 |  4925 | `		pTos->x.iVal = rc;` |
|        - |  4926 | `		/* Invalidate any prior representation */` |
|    97544 |  4927 | `		MemObjSetType(pTos,MEMOBJ_BOOL);` |
|    48773 |  4928 | `	}else{` |
|      ! 0 |  4929 | `		if( rc ){` |
...
|       19 |  5167 | `		pException->iFinallyDone = 1;` |
|       19 |  5168 | `		rcFinally = VmLocalExec(&(*pVm),&pException->sFinally,0);` |
|       19 |  5169 | `		if( rcFinally == SXERR_ABORT ){` |
|      ! 0 |  5170 | `			goto Abort;` |
|        - |  5171 | `		}` |
|        9 |  5172 | `	}` |
|       64 |  5173 | `	break;` |
...
|        - |  5229 | ` */` |
|     5033 |  5230 | `case PH7_OP_FOREACH_INIT: {` |
|    10068 |  5231 | `	ph7_foreach_info *pInfo = (ph7_foreach_info *)pInstr->p3;` |
|        - |  5232 | `	void *pName;` |
|        - |  5233 | `#ifdef UNTRUST` |
|        - |  5234 | `	if( pTos < pStack ){` |
|        - |  5235 | `		goto Abort;` |
|        - |  5236 | `	}` |
|        - |  5237 | `#endif` |
|    10068 |  5238 | `	if( SyStringLength(&pInfo->sValue) < 1 ){` |
...
|      ! 0 |  5250 | `	}` |
|    10068 |  5251 | `	if( (pInfo->iFlags & PH7_4EACH_STEP_KEY) && SyStringLength(&pInfo->sKey) < 1 ){` |
...
|    10068 |  5264 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ)) == 0 \|\| SyStringLength(&pInfo->sValue) < 1 ){` |
...
|    10068 |  5272 | `		pStep = (ph7_foreach_step *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_foreach_step));` |
|    10068 |  5273 | `		if( pStep == 0 ){` |
...
|    10068 |  5279 | `			SyZero(pStep,sizeof(ph7_foreach_step));` |
|        - |  5280 | `			/* Prepare the step */` |
|    10068 |  5281 | `			pStep->iFlags = pInfo->iFlags;` |
|    10068 |  5282 | `			if( pTos->iFlags & MEMOBJ_HASHMAP ){` |
...
|    10040 |  5286 | `				if( (pStep->iFlags & PH7_4EACH_STEP_REF) && pTos->nIdx != SXU32_HIGH ){` |
|       10 |  5287 | `					ph7_value *pBacking = (ph7_value *)SySetAt(&pVm->aMemObj,pTos->nIdx);` |
|       10 |  5288 | `					if( pBacking && (pBacking->iFlags & MEMOBJ_HASHMAP) ){` |
|       10 |  5289 | `						ph7_hashmap *pCur = (ph7_hashmap *)pTos->x.pOther;` |
|        - |  5290 | `						/* Only adjust refcounts/separate if the backing` |
|        - |  5291 | `						 * variable still points at the same hashmap as` |
|        - |  5292 | `						 * the stack value. */` |
|       10 |  5293 | `						if( pBacking->x.pOther == (void *)pCur ){` |
|       10 |  5294 | `							pCur->iRef--;` |
|       10 |  5295 | `							PH7_HashmapCowSeparate(&(*pVm),pBacking);` |
|       10 |  5296 | `							pTos->x.pOther = pBacking->x.pOther;` |
|       10 |  5297 | `							((ph7_hashmap *)pTos->x.pOther)->iRef++;` |
|        4 |  5298 | `						}` |
|        4 |  5299 | `					}` |
|        4 |  5300 | `				}` |
|    10040 |  5301 | `				pMap = (ph7_hashmap *)pTos->x.pOther;` |
|        - |  5302 | `				/* Reset the internal loop cursor */` |
|    10040 |  5303 | `				PH7_HashmapResetLoopCursor(pMap);` |
|        - |  5304 | `				/* Mark the step */` |
|    10040 |  5305 | `				pStep->iFlags \|= PH7_4EACH_STEP_HASHMAP;` |
|    10040 |  5306 | `				pStep->xIter.pMap = pMap;` |
|    10040 |  5307 | `				pMap->iRef++;` |
|     5021 |  5308 | `			}else{` |
...
|       19 |  5316 | `					pStep->iFlags \|= PH7_4EACH_STEP_ITERATOR\|PH7_4EACH_STEP_FIRST;` |
|       19 |  5317 | `					pStep->xIter.pThis = pThis;` |
|       19 |  5318 | `					pThis->iRef++;` |
|       19 |  5319 | `					pRewind = PH7_ClassExtractMethod(pThis->pClass,"rewind",sizeof("rewind")-1);` |
|       19 |  5320 | `					if( pRewind ){` |
|       19 |  5321 | `						PH7_VmCallClassMethod(&(*pVm),pThis,pRewind,0,0,0);` |
|        9 |  5322 | `					}` |
|       10 |  5323 | `				}else{` |
...
|        - |  5373 | `		}` |
|    10068 |  5374 | `		if( pStep ){` |
|    10068 |  5375 | `			if( SXRET_OK != SySetPut(&pInfo->aStep,(const void *)&pStep) ){` |
...
|     5033 |  5381 | `		}` |
|        - |  5382 | `	}` |
|    10068 |  5383 | `	VmPopOperand(&pTos,1);` |
|    10068 |  5384 | `	break;` |
|        - |  5385 | `						  }` |
|        - |  5386 | `/*` |
...
|        - |  5389 | ` */` |
|    81277 |  5390 | `case PH7_OP_FOREACH_STEP: {` |
|   162556 |  5391 | `	ph7_foreach_info *pInfo = (ph7_foreach_info *)pInstr->p3;` |
|        - |  5392 | `	ph7_foreach_step **apStep,*pStep;` |
|        - |  5393 | `	ph7_value *pValue;` |
|        - |  5394 | `	VmFrame *pFrameLocal;` |
|        - |  5395 | `	/* Peek the last step */` |
|   162556 |  5396 | `	apStep = (ph7_foreach_step **)SySetBasePtr(&pInfo->aStep);` |
|   162556 |  5397 | `	pStep = apStep[SySetUsed(&pInfo->aStep) - 1];` |
|   162556 |  5398 | `	pFrameLocal = pVm->pFrame;` |
|   162556 |  5399 | `	pFrameLocal = VmSkipExceptionFrames(pFrameLocal);` |
|   162556 |  5400 | `	if( pStep->iFlags & PH7_4EACH_STEP_HASHMAP ){` |
|   162444 |  5401 | `		ph7_hashmap *pMap = pStep->xIter.pMap;` |
|        - |  5402 | `		ph7_hashmap_node *pNode;` |
|        - |  5403 | `		/* Extract the current node value */` |
|   162444 |  5404 | `		pNode = PH7_HashmapGetNextEntry(pMap);` |
|   162444 |  5405 | `		if( pNode == 0 ){` |
|        - |  5406 | `			/* No more entry to process */` |
|    10038 |  5407 | `			pc = pInstr->iP2 - 1; /* Jump to this destination */` |
|    10038 |  5408 | `			if( pStep->iFlags & PH7_4EACH_STEP_REF ){` |
...
|    10038 |  5413 | `			PH7_HashmapResetLoopCursor(pMap);` |
|        - |  5414 | `			/* Cleanup the mess left behind */` |
|    10038 |  5415 | `			SyMemBackendPoolFree(&pVm->sAllocator,pStep);` |
|    10038 |  5416 | `			SySetPop(&pInfo->aStep);` |
|    10038 |  5417 | `			PH7_HashmapUnref(pMap);` |
|     5020 |  5418 | `		}else{` |
|   152408 |  5419 | `			if( (pStep->iFlags & PH7_4EACH_STEP_KEY) && SyStringLength(&pInfo->sKey) > 0 ){` |
|      416 |  5420 | `				ph7_value *pKey = VmExtractMemObj(&(*pVm),&pInfo->sKey,FALSE,TRUE);` |
|      416 |  5421 | `				if( pKey ){` |
|      416 |  5422 | `					PH7_HashmapExtractNodeKey(pNode,pKey);` |
|      207 |  5423 | `				}` |
|      207 |  5424 | `			}` |
|   152408 |  5425 | `			if( pStep->iFlags & PH7_4EACH_STEP_REF ){` |
|        - |  5426 | `				SyHashEntry *pEntry;` |
|        - |  5427 | `				/* Pass by reference */` |
|       24 |  5428 | `				pEntry = SyHashGet(&pFrameLocal->hVar,SyStringData(&pInfo->sValue),SyStringLength(&pInfo->sValue));` |
|       24 |  5429 | `				if( pEntry ){` |
|       22 |  5430 | `					pEntry->pUserData = SX_INT_TO_PTR(pNode->nValIdx);` |
|       12 |  5431 | `				}else{` |
|        4 |  5432 | `					SyHashInsert(&pFrameLocal->hVar,SyStringData(&pInfo->sValue),SyStringLength(&pInfo->sValue),` |
|        2 |  5433 | `						SX_INT_TO_PTR(pNode->nValIdx));` |
|        - |  5434 | `				}` |
|       13 |  5435 | `			}else{` |
|        - |  5436 | `				/* Make a copy of the entry value */` |
|   152386 |  5437 | `				pValue = VmExtractMemObj(&(*pVm),&pInfo->sValue,FALSE,TRUE);` |
|   152386 |  5438 | `				if( pValue ){` |
|   152386 |  5439 | `					PH7_HashmapExtractNodeValue(pNode,pValue,TRUE);` |
|    76192 |  5440 | `				}` |
|        - |  5441 | `			}` |
|        2 |  5442 | `		}` |
|    81335 |  5443 | `	}else if( pStep->iFlags & PH7_4EACH_STEP_ITERATOR ){` |
...
|        - |  5447 | `		 */` |
|       89 |  5448 | `		ph7_class_instance *pThis = pStep->xIter.pThis;` |
|        - |  5449 | `		ph7_class_method *pMethod;` |
|        - |  5450 | `		ph7_value sResult;` |
|       89 |  5451 | `		int isValid = 0;` |
|        - |  5452 | `		/* Call next() to advance — but skip on the first iteration */` |
|       89 |  5453 | `		if( pStep->iFlags & PH7_4EACH_STEP_FIRST ){` |
|       21 |  5454 | `			pStep->iFlags &= ~PH7_4EACH_STEP_FIRST;` |
|       11 |  5455 | `		}else{` |
|       69 |  5456 | `			pMethod = PH7_ClassExtractMethod(pThis->pClass,"next",sizeof("next")-1);` |
|       69 |  5457 | `			if( pMethod ){` |
|       69 |  5458 | `				PH7_VmCallClassMethod(&(*pVm),pThis,pMethod,0,0,0);` |
|       34 |  5459 | `			}` |
|        - |  5460 | `		}` |
|        - |  5461 | `		/* Call valid() */` |
|       89 |  5462 | `		PH7_MemObjInit(pVm,&sResult);` |
|       89 |  5463 | `		pMethod = PH7_ClassExtractMethod(pThis->pClass,"valid",sizeof("valid")-1);` |
|       89 |  5464 | `		if( pMethod ){` |
|       89 |  5465 | `			PH7_VmCallClassMethod(&(*pVm),pThis,pMethod,&sResult,0,0);` |
|       89 |  5466 | `			PH7_MemObjToBool(&sResult);` |
|       89 |  5467 | `			isValid = (sResult.x.iVal != 0);` |
|       44 |  5468 | `		}` |
|       89 |  5469 | `		PH7_MemObjRelease(&sResult);` |
|       89 |  5470 | `		if( !isValid ){` |
|        - |  5471 | `			/* Iterator exhausted */` |
|       19 |  5472 | `			pc = pInstr->iP2 - 1;` |
|        - |  5473 | `			/* Release the aggregate owner if this was an IteratorAggregate foreach */` |
|       19 |  5474 | `			if( pStep->pOwner ){` |
|        3 |  5475 | `				PH7_ClassInstanceUnref(pStep->pOwner);` |
|        1 |  5476 | `			}` |
|       19 |  5477 | `			SyMemBackendPoolFree(&pVm->sAllocator,pStep);` |
|       19 |  5478 | `			SySetPop(&pInfo->aStep);` |
|       19 |  5479 | `			PH7_ClassInstanceUnref(pThis);` |
|       10 |  5480 | `		}else{` |
|        - |  5481 | `			/* Call current() to get value */` |
|       71 |  5482 | `			PH7_MemObjInit(pVm,&sResult);` |
|       71 |  5483 | `			pMethod = PH7_ClassExtractMethod(pThis->pClass,"current",sizeof("current")-1);` |
|       71 |  5484 | `			if( pMethod ){` |
|       71 |  5485 | `				PH7_VmCallClassMethod(&(*pVm),pThis,pMethod,&sResult,0,0);` |
|       35 |  5486 | `			}` |
|       71 |  5487 | `			pValue = VmExtractMemObj(&(*pVm),&pInfo->sValue,FALSE,TRUE);` |
|       71 |  5488 | `			if( pValue ){` |
|       71 |  5489 | `				PH7_MemObjStore(&sResult,pValue);` |
|       35 |  5490 | `			}` |
|       71 |  5491 | `			PH7_MemObjRelease(&sResult);` |
|        - |  5492 | `			/* Call key() if needed */` |
|       71 |  5493 | `			if( (pStep->iFlags & PH7_4EACH_STEP_KEY) && SyStringLength(&pInfo->sKey) > 0 ){` |
|        - |  5494 | `				ph7_value sKey;` |
...
|        - |  5569 | ` */` |
|     2200 |  5570 | `case PH7_OP_MEMBER: {` |
|        - |  5571 | `	ph7_class_instance *pThis;` |
|        - |  5572 | `	ph7_value *pNos;` |
|        - |  5573 | `	SyString sName;` |
|     4402 |  5574 | `	if( !pInstr->iP1 ){` |
|     4266 |  5575 | `		pNos = &pTos[-1];` |
|        - |  5576 | `#ifdef UNTRUST` |
|        - |  5577 | `		if( pNos < pStack ){` |
|        - |  5578 | `			goto Abort;` |
|        - |  5579 | `		}` |
|        - |  5580 | `#endif` |
|     4266 |  5581 | `		if( pNos->iFlags & MEMOBJ_OBJ ){` |
|        - |  5582 | `			ph7_class *pClass;` |
|        - |  5583 | `			/* Class already instantiated */` |
|     4266 |  5584 | `			pThis = (ph7_class_instance *)pNos->x.pOther;` |
|        - |  5585 | `			/* Point to the instantiated class */` |
|     4266 |  5586 | `			pClass = pThis->pClass;` |
|        - |  5587 | `			/* Extract attribute name first */` |
|     4266 |  5588 | `			SyStringInitFromBuf(&sName,(const char *)SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
|     4266 |  5589 | `			if( pInstr->iP2 ){` |
|        - |  5590 | `				/* Method call */` |
|      422 |  5591 | `				ph7_class_method *pMeth = 0;` |
|      422 |  5592 | `				if( sName.nByte > 0 ){` |
|        - |  5593 | `					/* Extract the target method */` |
|      422 |  5594 | `					pMeth = PH7_ClassExtractMethod(pClass,sName.zString,sName.nByte);` |
|      210 |  5595 | `				}` |
|      422 |  5596 | `				if( pMeth == 0 ){` |
...
|      422 |  5607 | `					PH7_MemObjRelease(pTos);` |
|      422 |  5608 | `					SyBlobAppend(&pTos->sBlob,SyStringData(&pMeth->sVmName),SyStringLength(&pMeth->sVmName));` |
|      422 |  5609 | `					MemObjSetType(pTos,MEMOBJ_STRING);` |
|        - |  5610 | `				}` |
|      422 |  5611 | `				pTos->nIdx = SXU32_HIGH;` |
|      212 |  5612 | `			}else{` |
...
|      138 |  5675 | `		pNos = pTos;` |
|      138 |  5676 | `		pThis = 0;` |
|      138 |  5677 | `		if( !pInstr->p3 ){` |
|      126 |  5678 | `			SyStringInitFromBuf(&sName,(const char *)SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
|      126 |  5679 | `			pNos--;` |
|        - |  5680 | `#ifdef UNTRUST` |
|        - |  5681 | `			if( pNos < pStack ){` |
|        - |  5682 | `				goto Abort;` |
...
|        - |  5688 | `		}` |
|      138 |  5689 | `		if( pNos->iFlags & (MEMOBJ_STRING\|MEMOBJ_OBJ) ){` |
|      138 |  5690 | `			ph7_class *pClass = 0;` |
|      138 |  5691 | `			if( pNos->iFlags & MEMOBJ_OBJ ){` |
|        - |  5692 | `				/* Class already instantiated */` |
|      ! 0 |  5693 | `				pThis = (ph7_class_instance *)pNos->x.pOther;` |
|      ! 0 |  5694 | `				pClass = pThis->pClass;` |
|      ! 0 |  5695 | `				pThis->iRef++; /* Deffer garbage collection */` |
|      ! 0 |  5696 | `			}else{` |
|        - |  5697 | `				/* Try to extract the target class */` |
|      138 |  5698 | `				if( SyBlobLength(&pNos->sBlob) > 0 ){` |
|      138 |  5699 | `					const char *zCls = (const char *)SyBlobData(&pNos->sBlob);` |
|      138 |  5700 | `					sxu32 nCls = (sxu32)SyBlobLength(&pNos->sBlob);` |
|        - |  5701 | `					/* Handle self/static/parent keywords */` |
|      138 |  5702 | `					if( nCls == 4 && SyMemcmp(zCls,"self",4) == 0 ){` |
|       30 |  5703 | `						pClass = PH7_VmPeekDeclaringClass(&(*pVm));` |
|       30 |  5704 | `						if( pClass && (pClass->iFlags & PH7_CLASS_TRAIT) ){` |
|        - |  5705 | `							/* In a trait method, self:: resolves to the using class */` |
|       13 |  5706 | `							pClass = PH7_VmPeekTopClass(&(*pVm));` |
|        8 |  5707 | `						}` |
|      124 |  5708 | `					}else if( nCls == 6 && SyMemcmp(zCls,"static",6) == 0 ){` |
|       16 |  5709 | `						pClass = PH7_VmPeekTopClass(&(*pVm));` |
|      109 |  5710 | `					}else if( nCls == 6 && SyMemcmp(zCls,"parent",6) == 0 ){` |
|       14 |  5711 | `						ph7_class *pSelf = PH7_VmPeekDeclaringClass(&(*pVm));` |
|       14 |  5712 | `						if( pSelf && pSelf->pBase ){` |
|       14 |  5713 | `							pClass = pSelf->pBase;` |
|        6 |  5714 | `						}` |
|        8 |  5715 | `					}else{` |
|       84 |  5716 | `						pClass = PH7_VmExtractClass(&(*pVm),zCls,nCls,FALSE,0);` |
|        - |  5717 | `					}` |
|       68 |  5718 | `				}` |
|        - |  5719 | `			}` |
|      138 |  5720 | `			if( pClass == 0 ){` |
...
|       72 |  5764 | `					ph7_class_attr *pAttr = 0;` |
|        - |  5765 | `					/* Check for special ::class pseudo-constant */` |
|      104 |  5766 | `					if( sName.nByte == sizeof("class")-1 &&` |
|       64 |  5767 | `					    SyStrnicmp(sName.zString,"class",sizeof("class")-1) == 0 ){` |
|        - |  5768 | `						/* ::class returns the fully qualified class name */` |
|        - |  5769 | `						/* Pop the attribute name from the stack */` |
|       54 |  5770 | `						if( !pInstr->p3 ){` |
|       54 |  5771 | `							VmPopOperand(&pTos,1);` |
|       26 |  5772 | `						}` |
|       54 |  5773 | `						PH7_MemObjRelease(pTos);` |
|        - |  5774 | `						/* Load the class name */` |
|       54 |  5775 | `						ph7_value_string(pTos,pClass->sName.zString,(int)pClass->sName.nByte);` |
|       54 |  5776 | `						pTos->nIdx = SXU32_HIGH;` |
|       28 |  5777 | `					}else{` |
...
|      ! 0 |  5821 | `					PH7_ClassInstanceUnref(pThis);` |
|      ! 0 |  5822 | `				}` |
|        - |  5823 | `			}` |
|       70 |  5824 | `		}else{` |
|        - |  5825 | `			/* Pop operands */` |
...
|        - |  5839 | ` */` |
|      325 |  5840 | `case PH7_OP_NEW: {` |
|      652 |  5841 | `	ph7_value *pArg = &pTos[-pInstr->iP1]; /* Constructor arguments (if available) */` |
|      652 |  5842 | `	ph7_class *pClass = 0;` |
|        - |  5843 | `	ph7_class_instance *pNew;` |
|      652 |  5844 | `	if( (pTos->iFlags & MEMOBJ_STRING) && SyBlobLength(&pTos->sBlob) > 0 ){` |
|        - |  5845 | `		/* Try to extract the desired class */` |
|      977 |  5846 | `		pClass = PH7_VmExtractClass(&(*pVm),(const char *)SyBlobData(&pTos->sBlob),` |
|      650 |  5847 | `			SyBlobLength(&pTos->sBlob),TRUE /* Only loadable class but not 'interface' or 'abstract' class*/,0);` |
|      325 |  5848 | `	}else if( pTos->iFlags & MEMOBJ_OBJ ){` |
|        - |  5849 | `		/* Take the base class from the loaded instance */` |
|      ! 0 |  5850 | `		pClass = ((ph7_class_instance *)pTos->x.pOther)->pClass;` |
|      ! 0 |  5851 | `	}` |
|      652 |  5852 | `	if( pClass == 0 ){` |
...
|      652 |  5867 | `		pNew = PH7_NewClassInstance(&(*pVm),pClass);` |
|      652 |  5868 | `		if( pNew == 0 ){` |
...
|      652 |  5881 | `		pCons = PH7_ClassExtractMethod(pClass,"__construct",sizeof("__construct")-1);` |
|      652 |  5882 | `		if( pCons == 0 ){` |
|      538 |  5883 | `			SyString *pName = &pClass->sName;` |
|        - |  5884 | `			/* Check for a constructor with the same base class name */` |
|      538 |  5885 | `			pCons = PH7_ClassExtractMethod(pClass,pName->zString,pName->nByte);` |
|      268 |  5886 | `		}` |
|      652 |  5887 | `		if( pCons ){` |
...
|        - |  5896 | `				sxu32 n;` |
|       73 |  5897 | `				n = SySetUsed(&aArg);` |
|        - |  5898 | `				/* Emit a notice for missing arguments */` |
|      137 |  5899 | `				while( n < SySetUsed(&pCons->sFunc.aArgs) ){` |
|       65 |  5900 | `					pFuncArg = (ph7_vm_func_arg *)SySetAt(&pCons->sFunc.aArgs,n);` |
|       65 |  5901 | `					if( pFuncArg ){` |
|       65 |  5902 | `						if( SySetUsed(&pFuncArg->aByteCode) < 1 ){` |
...
|      ! 0 |  5914 | `			}` |
|       57 |  5915 | `		}` |
|      652 |  5916 | `		if( pInstr->iP1 > 0 ){` |
|        - |  5917 | `			/* Pop given arguments */` |
|       98 |  5918 | `			VmPopOperand(&pTos,pInstr->iP1);` |
|       48 |  5919 | `		}` |
|      652 |  5920 | `		PH7_MemObjRelease(pTos);` |
|      652 |  5921 | `		pTos->x.pOther = pNew;` |
|      652 |  5922 | `		MemObjSetType(pTos,MEMOBJ_OBJ);` |
|        - |  5923 | `	}` |
|      652 |  5924 | `	break;` |
|        - |  5925 | `				 }` |
|        - |  5926 | `/*` |
...
|        - |  5970 | ` */` |
|       18 |  5971 | `case PH7_OP_SWITCH: {` |
|       38 |  5972 | `	ph7_switch *pSwitch = (ph7_switch *)pInstr->p3;` |
...
|       38 |  5982 | `	aCase = (ph7_case_expr *)SySetBasePtr(&pSwitch->aCaseExpr);` |
|       38 |  5983 | `	nEntry = SySetUsed(&pSwitch->aCaseExpr);` |
|        - |  5984 | `	/* Select the appropriate case block to execute */` |
|       38 |  5985 | `	PH7_MemObjInit(pVm,&sValue);` |
|       38 |  5986 | `	PH7_MemObjInit(pVm,&sCaseValue);` |
|       92 |  5987 | `	for( n = 0 ; n < nEntry ; ++n ){` |
|       92 |  5988 | `		pCase = &aCase[n];` |
|       92 |  5989 | `		PH7_MemObjLoad(pTos,&sValue);` |
|        - |  5990 | `		/* Execute the case expression first */` |
|       92 |  5991 | `		VmLocalExec(pVm,&pCase->aByteCode,&sCaseValue);` |
|        - |  5992 | `		/* Compare the two expression */` |
|       92 |  5993 | `		rc = PH7_MemObjCmp(&sValue,&sCaseValue,FALSE,0);` |
|       92 |  5994 | `		PH7_MemObjRelease(&sValue);` |
|       92 |  5995 | `		PH7_MemObjRelease(&sCaseValue);` |
|       92 |  5996 | `		if( rc == 0 ){` |
|        - |  5997 | `			/* Value match,jump to this block */` |
|       38 |  5998 | `			pc = pCase->nStart - 1;` |
|       38 |  5999 | `			break;` |
|        - |  6000 | `		}` |
|       29 |  6001 | `	}` |
|       38 |  6002 | `	VmPopOperand(&pTos,1);` |
|       38 |  6003 | `	if( n >= nEntry ){` |
...
|       57 |  6022 | `	if( pVm->pActiveCtx == 0 \|\| pVm->pActiveCtx->pPrivate == 0 ){` |
|      ! 0 |  6023 | `		VmErrorFormat(&(*pVm), PH7_CTX_ERR, "Cannot use yield outside of a generator");` |
|      ! 0 |  6024 | `		goto Abort;` |
|        - |  6025 | `	}` |
|       57 |  6026 | `	pGen = (ph7_generator *)pVm->pActiveCtx->pPrivate;` |
|       57 |  6027 | `	if( pInstr->iP2 ){` |
...
|      ! 0 |  6041 | `			}` |
|        1 |  6042 | `		}` |
|       54 |  6043 | `	}else if( pInstr->iP1 ){` |
|        - |  6044 | `		/* yield $value */` |
|        - |  6045 | `#ifdef UNTRUST` |
|        - |  6046 | `		if( pTos < pStack ) goto Abort;` |
|        - |  6047 | `#endif` |
|       51 |  6048 | `		PH7_MemObjStore(pTos, &pGen->sYieldValue);` |
|       51 |  6049 | `		VmPopOperand(&pTos, 1);` |
|        - |  6050 | `		/* Auto-increment key */` |
|       51 |  6051 | `		PH7_MemObjRelease(&pGen->sYieldKey);` |
|       51 |  6052 | `		pGen->sYieldKey.x.iVal = pGen->iImplicitKey++;` |
|       51 |  6053 | `		MemObjSetType(&pGen->sYieldKey, MEMOBJ_INT);` |
|       26 |  6054 | `	}else{` |
...
|       57 |  6062 | `	VmSuspendCtx(pVm, pVm->pActiveCtx, pc + 1, (sxi32)(pTos - pStack));` |
|       57 |  6063 | `	goto Suspend;` |
|        - |  6064 |  |
|        - |  6065 | `/*` |
|        - |  6066 | ` * OP_CALL P1 * *` |
...
|        - |  6069 | ` */` |
|   294416 |  6070 | `case PH7_OP_CALL: {` |
|   588878 |  6071 | `	sxi32 nCallArgs = pInstr->iP1 + pVm->iSpreadExtra;` |
|        - |  6072 | `	ph7_value *pArg;` |
|   588878 |  6073 | `	pVm->iSpreadExtra = 0; /* Always reset, even if zero */` |
|   588878 |  6074 | `	pArg = &pTos[-nCallArgs];` |
|        - |  6075 | `	SyHashEntry *pEntry;` |
|        - |  6076 | `	SyString sName;` |
|        - |  6077 | `	/* Extract function name */` |
|   588878 |  6078 | `	if( (pTos->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|   294143 |  6113 | `		break;` |
|        - |  6114 | `	}` |
|   588876 |  6115 | `	SyStringInitFromBuf(&sName,SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
...
|   588876 |  6119 | `	pEntry = SyHashGet(&pVm->hFunction,(const void *)sName.zString,sName.nByte);` |
...
|   588876 |  6125 | `	if( pEntry == 0 && pInstr->p3 != 0 ){` |
...
|    13528 |  6157 | `		pVmFunc = (ph7_vm_func *)pEntry->pUserData;` |
|    13528 |  6158 | `		pThis = 0;` |
|    13528 |  6159 | `		pSelf = 0;` |
|    13528 |  6160 | `		if( pVmFunc->iFlags & VM_FUNC_CLASS_METHOD ){` |
|        - |  6161 | `			ph7_class_method *pMeth;` |
|        - |  6162 | `			/* Class method call */` |
|     1976 |  6163 | `			ph7_value *pTarget = &pTos[-1];` |
|     1976 |  6164 | `			if( pTarget >= pStack && (pTarget->iFlags & (MEMOBJ_STRING\|MEMOBJ_OBJ\|MEMOBJ_NULL)) ){` |
|        - |  6165 | `				/* Extract the 'this' pointer */` |
|     1976 |  6166 | `				if(pTarget->iFlags & MEMOBJ_OBJ ){` |
|        - |  6167 | `					/* Instance already loaded */` |
|     1904 |  6168 | `					pThis = (ph7_class_instance *)pTarget->x.pOther;` |
|     1904 |  6169 | `					pThis->iRef++;` |
|     1904 |  6170 | `					pSelf = pThis->pClass;` |
|      951 |  6171 | `				}` |
|     1976 |  6172 | `				if( pSelf == 0 ){` |
...
|       28 |  6191 | `					}` |
|       36 |  6192 | `				}` |
|     1976 |  6193 | `				VmPopOperand(&pTos,1);` |
|     1976 |  6194 | `				PH7_MemObjRelease(pTos);` |
|        - |  6195 | `				/* Synchronize pointers */` |
|     1976 |  6196 | `				pArg = &pTos[-nCallArgs];` |
...
|        - |  6201 | `				 */` |
|     1976 |  6202 | `				while( pArg < pStack ){` |
|      ! 0 |  6203 | `					pArg++;` |
|      ! 0 |  6204 | `				}` |
|     1976 |  6205 | `				if( pSelf ){ /* Paranoid edition */` |
|        - |  6206 | `					/* Check if the call is allowed */` |
|     1976 |  6207 | `					pMeth = PH7_ClassExtractMethod(pSelf,pVmFunc->sName.zString,pVmFunc->sName.nByte);` |
|     1976 |  6208 | `					if( pMeth && pMeth->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|    13528 |  6223 | `		if( pVm->nRecursionDepth > pVm->nMaxDepth ){` |
...
|        3 |  6233 | `			break;` |
|        - |  6234 | `		}` |
|    13526 |  6235 | `		if( pVmFunc->pNextName ){` |
...
|       66 |  6238 | `		}` |
|    13526 |  6239 | `		if( pVmFunc->iFlags & VM_FUNC_GENERATOR ){` |
...
|       19 |  6249 | `			nGenArgs = (int)(pTos - pArg);` |
|       19 |  6250 | `			apCallArgs = 0;` |
|       19 |  6251 | `			if( nGenArgs > 0 ){` |
|        7 |  6252 | `				apCallArgs = (ph7_value **)SyMemBackendAlloc(&pVm->sAllocator,` |
|        2 |  6253 | `					nGenArgs * sizeof(ph7_value *));` |
|        5 |  6254 | `				if( apCallArgs == 0 ){` |
|        - |  6255 | `					/* OOM: fall back to zero args rather than NULL-deref */` |
|      ! 0 |  6256 | `					nGenArgs = 0;` |
|      ! 0 |  6257 | `				}else{` |
|       11 |  6258 | `					for( iArg = 0; iArg < nGenArgs; iArg++ ){` |
|        7 |  6259 | `						apCallArgs[iArg] = &pArg[iArg];` |
|        4 |  6260 | `					}` |
|        - |  6261 | `				}` |
|        2 |  6262 | `			}` |
|        - |  6263 | `			/* Create execution context and generator wrapper */` |
|       19 |  6264 | `			pExecCtx = VmNewExecCtx(pVm, pVmFunc);` |
|       19 |  6265 | `			if( pExecCtx == 0 ){` |
...
|      ! 0 |  6269 | `				break;` |
|        - |  6270 | `			}` |
|       19 |  6271 | `			pGenerator = VmNewGenerator(pVm, pExecCtx);` |
|       19 |  6272 | `			if( pGenerator == 0 ){` |
...
|       19 |  6280 | `			pExecCtx->pFrame->pParent = pVm->pFrame;` |
|       19 |  6281 | `			pVm->pFrame = pExecCtx->pFrame;` |
|       19 |  6282 | `			rc = VmFiberSetupFrame(pVm, pExecCtx, pThis, nGenArgs, apCallArgs);` |
|       19 |  6283 | `			pVm->pFrame = pExecCtx->pFrame->pParent;` |
|       19 |  6284 | `			pExecCtx->pFrame->pParent = 0;` |
|       19 |  6285 | `			if( apCallArgs ){` |
|        5 |  6286 | `				SyMemBackendFree(&pVm->sAllocator, apCallArgs);` |
|        2 |  6287 | `			}` |
|       19 |  6288 | `			if( rc != SXRET_OK ){` |
...
|       19 |  6299 | `			pGenObj = PH7_NewClassInstance(pVm, pVm->pGeneratorClass);` |
|       19 |  6300 | `			if( pGenObj == 0 ){` |
|      ! 0 |  6301 | `				VmReleaseGenerator(pVm, pGenerator);` |
|      ! 0 |  6302 | `				break;` |
|        - |  6303 | `			}` |
|        - |  6304 | `			/* Store generator in __ctx attribute */` |
|       19 |  6305 | `			SyStringInitFromBuf(&sAttrName, "__ctx", 5);` |
|       19 |  6306 | `			pCtxAttr = PH7_ClassInstanceFetchAttr(pGenObj, &sAttrName);` |
|       19 |  6307 | `			if( pCtxAttr ){` |
|       19 |  6308 | `				pCtxAttr->x.pOther = pGenerator;` |
|       19 |  6309 | `				MemObjSetType(pCtxAttr, MEMOBJ_RES);` |
|        9 |  6310 | `			}` |
|        - |  6311 | `			/* Pop args and function name, push Generator object */` |
|       19 |  6312 | `			PH7_MemObjRelease(pTos);` |
|       19 |  6313 | `			pTos = &pTos[-nCallArgs];` |
|       19 |  6314 | `			pTos->x.pOther = pGenObj;` |
|       19 |  6315 | `			MemObjSetType(pTos, MEMOBJ_OBJ);` |
|       19 |  6316 | `			pGenObj->iRef++;` |
|       19 |  6317 | `			if( pThis ){` |
...
|    13508 |  6323 | `		aFormalArg = (ph7_vm_func_arg *)SySetBasePtr(&pVmFunc->aArgs);` |
|        - |  6324 | `		/* Create a new VM frame  */` |
|    13508 |  6325 | `		rc = VmEnterFrame(&(*pVm),pVmFunc,pThis,&pFrame);` |
|    13508 |  6326 | `		if( rc != SXRET_OK ){` |
...
|      ! 0 |  6337 | `			break;` |
|        - |  6338 | `		}` |
|    13508 |  6339 | `		if( (pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) && pThis ){` |
|        - |  6340 | `			/* Install the '$this' variable */` |
|        - |  6341 | `			static const SyString sThis = { "this" , sizeof("this") - 1 };` |
|     1914 |  6342 | `			pObj = VmExtractMemObj(&(*pVm),&sThis,FALSE,TRUE);` |
|     1914 |  6343 | `			if( pObj ){` |
|        - |  6344 | `				/* Reflect the change */` |
|     1914 |  6345 | `				pObj->x.pOther = pThis;` |
|     1914 |  6346 | `				MemObjSetType(pObj,MEMOBJ_OBJ);` |
|      956 |  6347 | `			}` |
|      956 |  6348 | `		}` |
|    13508 |  6349 | `		if( SySetUsed(&pVmFunc->aStatic) > 0 ){` |
...
|    13508 |  6376 | `		n = 0;` |
|    36714 |  6377 | `		while( pArg < pTos ){` |
|    23228 |  6378 | `			if( n < SySetUsed(&pVmFunc->aArgs) && (aFormalArg[n].iFlags & VM_FUNC_ARG_VARIADIC) ){` |
...
|        - |  6404 | `			}` |
|    23208 |  6405 | `			if( n < SySetUsed(&pVmFunc->aArgs) ){` |
|    23052 |  6406 | `				if( (pArg->iFlags & MEMOBJ_NULL) && SySetUsed(&aFormalArg[n].aByteCode) > 0` |
...
|    23064 |  6416 | `				if( aFormalArg[n].nType > 0` |
|    12103 |  6417 | `					&& !((aFormalArg[n].iFlags & VM_FUNC_ARG_NULLABLE) && (pArg->iFlags & MEMOBJ_NULL)) ){` |
...
|      ! 0 |  6448 | `					}` |
|      569 |  6449 | `				}` |
|    23054 |  6450 | `				if( aFormalArg[n].iFlags & VM_FUNC_ARG_BY_REF ){` |
...
|    23002 |  6476 | `					pObj = VmExtractMemObj(&(*pVm),&aFormalArg[n].sName,FALSE,TRUE);` |
|        - |  6477 | `				}` |
|    11528 |  6478 | `			}else{` |
|        - |  6479 | `				char zName[32];` |
...
|        - |  6486 | `			}` |
|    23208 |  6487 | `			if( pObj ){` |
|    23156 |  6488 | `				PH7_MemObjStore(pArg,pObj);` |
|        - |  6489 | `				/* Insert argument index  */` |
|    23156 |  6490 | `				sArg.nIdx = pObj->nIdx;` |
|    23156 |  6491 | `				sArg.pUserData = 0;` |
|    23156 |  6492 | `				SySetPut(&pFrame->sArg,(const void *)&sArg);` |
|    11577 |  6493 | `			}` |
|    23208 |  6494 | `			PH7_MemObjRelease(pArg);` |
|    23208 |  6495 | `			pArg++;` |
|    23208 |  6496 | `			++n;` |
|        2 |  6497 | `		}` |
|        - |  6498 | `		/* Set up closure environment */` |
|    13508 |  6499 | `		if( pVmFunc->iFlags & VM_FUNC_CLOSURE ){` |
...
|    15458 |  6521 | `		while( n < SySetUsed(&pVmFunc->aArgs) ){` |
...
|        - |  6558 | `		 */` |
|    13508 |  6559 | `		PH7_MemObjRelease(pTos);` |
|    13508 |  6560 | `		pTos = &pTos[-nCallArgs];` |
|        - |  6561 | `		/* Allocate a new operand stack and evaluate the function body */` |
|    13508 |  6562 | `		pFrameStack = VmNewOperandStack(&(*pVm),SySetUsed(&pVmFunc->aByteCode));` |
|    13508 |  6563 | `		if( pFrameStack == 0 ){` |
...
|     1974 |  6574 | `			SySetPut(&pVm->aSelf,(const void *)&pSelf);` |
|      986 |  6575 | `		}` |
|        - |  6576 | `		/* Increment nesting level */` |
|    13508 |  6577 | `		pVm->nRecursionDepth++;` |
|        - |  6578 | `		/* Execute function body */` |
|    13508 |  6579 | `		rc = VmByteCodeExec(&(*pVm),(VmInstr *)SySetBasePtr(&pVmFunc->aByteCode),pFrameStack,-1,pTos,&n,FALSE,0);` |
|        - |  6580 | `		/* Decrement nesting level */` |
|    13508 |  6581 | `		pVm->nRecursionDepth--;` |
|    13508 |  6582 | `		if( pSelf ){` |
|        - |  6583 | `			/* Pop class name */` |
|     1974 |  6584 | `			(void)SySetPop(&pVm->aSelf);` |
|      986 |  6585 | `		}` |
|        - |  6586 | `		/* Cleanup the mess left behind */` |
|    13508 |  6587 | `		if( (pVmFunc->iFlags & VM_FUNC_REF_RETURN) && rc == SXRET_OK ){` |
...
|    13508 |  6615 | `		if( rc != PH7_ABORT && ((pFrame->iFlags & VM_FRAME_THROW) \|\| rc == PH7_EXCEPTION) ){` |
...
|    13508 |  6634 | `		SyMemBackendFree(&pVm->sAllocator,pFrameStack);` |
|        - |  6635 | `		/* Leave the frame */` |
|    13508 |  6636 | `		VmLeaveFrame(&(*pVm));` |
|    13508 |  6637 | `		if( rc == PH7_ABORT ){` |
|        - |  6638 | `			/* Abort processing immeditaley */` |
|        7 |  6639 | `			goto Abort;` |
|    13502 |  6640 | `		}else if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|       39 |  6646 | `			VmSuspendCtx(pVm, pVm->pActiveCtx, pc + 1, (sxi32)(pTos - pStack) - 1);` |
|       39 |  6647 | `			goto Suspend;` |
|    13464 |  6648 | `		}else if( rc == PH7_EXCEPTION ){` |
...
|   575350 |  6662 | `		pEntry = SyHashGet(&pVm->hHostFunction,(const void *)sName.zString,sName.nByte);` |
|   575350 |  6663 | `		if( pEntry == 0 && pInstr->p3 != 0 ){` |
...
|        8 |  6686 | `			break;` |
|        - |  6687 | `		}` |
|   575346 |  6688 | `		pFunc = (ph7_user_func *)pEntry->pUserData;` |
|        - |  6689 | `		/* Start collecting function arguments */` |
|   575346 |  6690 | `		SySetReset(&aArg);` |
|  1544386 |  6691 | `		while( pArg < pTos ){` |
|   969042 |  6692 | `			SySetPut(&aArg,(const void *)&pArg);` |
|   969042 |  6693 | `			pArg++;` |
|        2 |  6694 | `		}` |
|        - |  6695 | `		/* Assume a null return value */` |
|   575346 |  6696 | `		PH7_MemObjInit(&(*pVm),&sRet);` |
|        - |  6697 | `		/* Init the call context */` |
|   575346 |  6698 | `		VmInitCallContext(&sCtx,&(*pVm),pFunc,&sRet,0);` |
|        - |  6699 | `		/* Call the foreign function */` |
|   575346 |  6700 | `		rc = pFunc->xFunc(&sCtx,(int)SySetUsed(&aArg),(ph7_value **)SySetBasePtr(&aArg));` |
|        - |  6701 | `		/* Release the call context */` |
|   575346 |  6702 | `		VmReleaseCallContext(&sCtx);` |
|   575346 |  6703 | `		if( rc == PH7_ABORT ){` |
|      463 |  6704 | `			goto Abort;` |
|   574884 |  6705 | `		}else if( rc == PH7_EXCEPTION ){` |
...
|        7 |  6724 | `			break;` |
|        - |  6725 | `		}` |
|   574874 |  6726 | `		if( rc == PH7_SUSPEND && pVm->pActiveCtx ){` |
...
|       39 |  6733 | `			PH7_MemObjRelease(&sRet);` |
|       39 |  6734 | `			if( pInstr->iP1 > 0 ){` |
|       39 |  6735 | `				VmPopOperand(&pTos,pInstr->iP1);` |
|       19 |  6736 | `			}` |
...
|       39 |  6739 | `			VmSuspendCtx(pVm,pVm->pActiveCtx,pc + 1,(sxi32)(pTos - pStack) - 1);` |
|       39 |  6740 | `			goto Suspend;` |
|        - |  6741 | `		}` |
|   574836 |  6742 | `		if( pInstr->iP1 > 0 ){` |
|        - |  6743 | `			/* Pop function name and arguments */` |
|   557088 |  6744 | `			VmPopOperand(&pTos,pInstr->iP1);` |
|   278565 |  6745 | `		}` |
|        - |  6746 | `		/* Save foreign function return value */` |
|   574836 |  6747 | `		PH7_MemObjStore(&sRet,pTos);` |
|   574836 |  6748 | `		PH7_MemObjRelease(&sRet);` |
|        - |  6749 | `	}` |
|   588296 |  6750 | `	break;` |
|        - |  6751 | `				  }` |
|        - |  6752 | `/*` |
...
|        - |  6755 | ` */` |
|    11550 |  6756 | `case PH7_OP_CONSUME: {` |
|    23102 |  6757 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|    23102 |  6758 | `	ph7_value *pCur,*pOut = pTos;` |
|        - |  6759 |  |
|    23102 |  6760 | `	pOut = &pTos[-pInstr->iP1 + 1];` |
|    23102 |  6761 | `	pCur = pOut;` |
|        - |  6762 | `	/* Start the consume process  */` |
|    46202 |  6763 | `	while( pOut <= pTos ){` |
|        - |  6764 | `		/* Force a string cast */` |
|    23102 |  6765 | `		if( (pOut->iFlags & MEMOBJ_STRING) == 0 ){` |
|      304 |  6766 | `			PH7_MemObjToString(pOut);` |
|      151 |  6767 | `		}` |
|    23102 |  6768 | `		if( SyBlobLength(&pOut->sBlob) > 0 ){` |
|        - |  6769 | `			/*SyBlobNullAppend(&pOut->sBlob);*/` |
|        - |  6770 | `			/* Invoke the output consumer callback */` |
|    12820 |  6771 | `			rc = pCons->xConsumer(SyBlobData(&pOut->sBlob),SyBlobLength(&pOut->sBlob),pCons->pUserData);` |
|    12820 |  6772 | `			VmTrackOutput(pVm, SyBlobLength(&pOut->sBlob));` |
|    12820 |  6773 | `			SyBlobRelease(&pOut->sBlob);` |
|    12820 |  6774 | `			if( rc == SXERR_ABORT ){` |
...
|    23102 |  6779 | `		pOut++;` |
|        2 |  6780 | `	}` |
|    23102 |  6781 | `	pTos = &pCur[-1];` |
|    23100 |  6782 | `	break;` |
|        - |  6783 | `					 }` |
|        - |  6784 |  |
|        - |  6785 | `		} /* Switch() */` |
|  9960614 |  6786 | `		pc++; /* Next instruction in the stream */` |
|        2 |  6787 | `	} /* For(;;) */` |
|    16362 |  6788 | `Done:` |
|    32726 |  6789 | `	SySetRelease(&aArg);` |
|    32726 |  6790 | `	return SXRET_OK;` |
|       66 |  6791 | `Suspend:` |
|      133 |  6792 | `	SySetRelease(&aArg);` |
|      133 |  6793 | `	return PH7_SUSPEND;` |
|      238 |  6794 | `Abort:` |
...
|        - |  6813 | ` */` |
|    15150 |  6814 | `PH7_PRIVATE sxi32 VmLocalExec(ph7_vm *pVm,SySet *pByteCode,ph7_value *pResult)` |
|        2 |  6815 |  |
|        - |  6816 | `	ph7_value *pStack;` |
|        - |  6817 | `	sxi32 rc;` |
|        - |  6818 | `	/* Allocate a new operand stack */` |
|    15152 |  6819 | `	pStack = VmNewOperandStack(&(*pVm),SySetUsed(pByteCode));` |
|    15152 |  6820 | `	if( pStack == 0 ){` |
|      ! 0 |  6821 | `		return SXERR_MEM;` |
|        - |  6822 | `	}` |
|        - |  6823 | `	/* Execute the program */` |
|    15152 |  6824 | `	rc = VmByteCodeExec(&(*pVm),(VmInstr *)SySetBasePtr(pByteCode),pStack,-1,&(*pResult),0,FALSE,0);` |
|        - |  6825 | `	/* Free the operand stack */` |
|    15152 |  6826 | `	SyMemBackendFree(&pVm->sAllocator,pStack);` |
|        - |  6827 | `	/* Execution result */` |
|    15152 |  6828 | `	return rc;` |
|     7577 |  6829 |  |
|        - |  6830 | `/*` |
...
|        - |  6838 | ` */` |
|     2594 |  6839 | `static void VmInvokeShutdownCallbacks(ph7_vm *pVm)` |
|        2 |  6840 |  |
...
|     2596 |  6846 | `	nEntry = SySetUsed(&pVm->aShutdown);` |
|    28536 |  6847 | `	for( i = 0 ; i < (int)SX_ARRAYSIZE(apArg) ; i++ ){` |
|    25942 |  6848 | `		apArg[i] = 0;` |
|    12972 |  6849 | `	}` |
|     2598 |  6850 | `	for( n = 0 ; n < nEntry ; ++n ){` |
...
|        1 |  6873 | `		}` |
|        2 |  6874 | `	}` |
|     2596 |  6875 | `	SySetReset(&pVm->aShutdown);` |
|     2596 |  6876 |  |
|        - |  6877 | `/*` |
...
|        - |  6881 | ` */` |
|     2602 |  6882 | `PH7_PRIVATE sxi32 PH7_VmByteCodeExec(ph7_vm *pVm)` |
|        2 |  6883 |  |
|        - |  6884 | `	/* Make sure we are ready to execute this program */` |
|     2604 |  6885 | `	if( pVm->nMagic != PH7_VM_RUN ){` |
|      ! 0 |  6886 | `		return pVm->nMagic == PH7_VM_EXEC ? SXERR_LOCKED /* Locked VM */ : SXERR_CORRUPT; /* Stale VM */` |
|        - |  6887 | `	}` |
|        - |  6888 | `	/* Set the execution magic number  */` |
|     2604 |  6889 | `	pVm->nMagic = PH7_VM_EXEC;` |
|        - |  6890 | `	/* Execute the program */` |
|     2604 |  6891 | `	VmByteCodeExec(&(*pVm),(VmInstr *)SySetBasePtr(pVm->pByteContainer),pVm->aOps,-1,&pVm->sExec,0,FALSE,0);` |
|        - |  6892 | `	/* Invoke any shutdown callbacks */` |
|     2600 |  6893 | `	VmInvokeShutdownCallbacks(&(*pVm));` |
|        - |  6894 | `	/*` |
...
|        - |  6910 | `	VmFrame *pFrame;` |
|       43 |  6911 | `	pCtx = (ph7_exec_ctx *)SyMemBackendPoolAlloc(&pVm->sAllocator, sizeof(ph7_exec_ctx));` |
|       43 |  6912 | `	if( pCtx == 0 ){` |
|      ! 0 |  6913 | `		return 0;` |
|        - |  6914 | `	}` |
|       43 |  6915 | `	SyZero(pCtx, sizeof(ph7_exec_ctx));` |
|       43 |  6916 | `	pCtx->pVm = pVm;` |
|       43 |  6917 | `	pCtx->pFunc = pFunc;` |
|       43 |  6918 | `	pCtx->iState = PH7_CTX_STATE_CREATED;` |
|       43 |  6919 | `	pCtx->nTos = -1; /* Empty stack — matches VmByteCodeExec convention */` |
|       43 |  6920 | `	pCtx->pc = 0;` |
|       43 |  6921 | `	PH7_MemObjInit(pVm, &pCtx->sSuspendValue);` |
|       43 |  6922 | `	PH7_MemObjInit(pVm, &pCtx->sRetValue);` |
|        - |  6923 | `	/* Allocate a private operand stack */` |
|       43 |  6924 | `	pStack = VmNewOperandStack(pVm, SySetUsed(&pFunc->aByteCode));` |
|       43 |  6925 | `	if( pStack == 0 ){` |
|      ! 0 |  6926 | `		SyMemBackendPoolFree(&pVm->sAllocator, pCtx);` |
|      ! 0 |  6927 | `		return 0;` |
|        - |  6928 | `	}` |
|       43 |  6929 | `	pCtx->pStack = pStack;` |
|        - |  6930 | `	/* Create a detached frame for the fiber */` |
|       43 |  6931 | `	pFrame = VmNewFrame(pVm, pFunc, 0);` |
|       43 |  6932 | `	if( pFrame == 0 ){` |
|      ! 0 |  6933 | `		SyMemBackendFree(&pVm->sAllocator, pStack);` |
|      ! 0 |  6934 | `		SyMemBackendPoolFree(&pVm->sAllocator, pCtx);` |
|      ! 0 |  6935 | `		return 0;` |
|        - |  6936 | `	}` |
|       43 |  6937 | `	pCtx->pFrame = pFrame;` |
|       43 |  6938 | `	return pCtx;` |
|       22 |  6939 |  |
|        - |  6940 | `/*` |
...
|        - |  6946 | `	sxi32 rc;` |
|       43 |  6947 | `	if( pCtx->iState != PH7_CTX_STATE_CREATED ){` |
|      ! 0 |  6948 | `		return SXERR_INVALID;` |
|        - |  6949 | `	}` |
|        - |  6950 | `	/* Attach the fiber's frame to the VM frame chain */` |
|       43 |  6951 | `	pCtx->pFrame->pParent = pVm->pFrame;` |
|       43 |  6952 | `	pVm->pFrame = pCtx->pFrame;` |
|        - |  6953 | `	/* Save and set the active context */` |
|       43 |  6954 | `	pOldCtx = pVm->pActiveCtx;` |
|       43 |  6955 | `	pVm->pActiveCtx = pCtx;` |
|       43 |  6956 | `	pCtx->iState = PH7_CTX_STATE_RUNNING;` |
|       43 |  6957 | `	pCtx->nExceptionBase = SySetUsed(&pVm->aException);` |
|       43 |  6958 | `	pVm->nRecursionDepth++;` |
|        - |  6959 | `	/* Execute from the beginning */` |
|       64 |  6960 | `	rc = VmByteCodeExec(pVm, (VmInstr *)SySetBasePtr(&pCtx->pFunc->aByteCode),` |
|       21 |  6961 | `		pCtx->pStack, -1, &pCtx->sRetValue, 0, FALSE, 0);` |
|       43 |  6962 | `	pVm->nRecursionDepth--;` |
|        - |  6963 | `	/* Restore the previous context */` |
|       43 |  6964 | `	pVm->pActiveCtx = pOldCtx;` |
|       43 |  6965 | `	if( rc == PH7_SUSPEND ){` |
|        - |  6966 | `		/* Fiber suspended. Detach the fiber's frame from the VM chain. */` |
|       41 |  6967 | `		pVm->pFrame = pCtx->pFrame->pParent;` |
|       41 |  6968 | `		pCtx->pFrame->pParent = 0;` |
|       41 |  6969 | `		if( pResult ){` |
|       23 |  6970 | `			PH7_MemObjStore(&pCtx->sSuspendValue, pResult);` |
|       11 |  6971 | `		}` |
|       41 |  6972 | `		return SXRET_OK;` |
|        - |  6973 | `	}` |
|        - |  6974 | `	/* Detach frame */` |
...
|        - |  7000 | `	sxi32 rc;` |
|       87 |  7001 | `	if( pCtx->iState != PH7_CTX_STATE_SUSPENDED ){` |
...
|       87 |  7007 | `	if( pResumeValue ){` |
|       39 |  7008 | `		PH7_MemObjStore(pResumeValue, &pCtx->pStack[pCtx->nTos + 1]);` |
|       20 |  7009 | `	}else{` |
|       49 |  7010 | `		PH7_MemObjRelease(&pCtx->pStack[pCtx->nTos + 1]);` |
|        - |  7011 | `	}` |
|       87 |  7012 | `	pCtx->nTos++;` |
|        - |  7013 | `	/* Re-attach the fiber's frame to the VM frame chain */` |
|       87 |  7014 | `	pCtx->pFrame->pParent = pVm->pFrame;` |
|       87 |  7015 | `	pVm->pFrame = pCtx->pFrame;` |
|        - |  7016 | `	/* Save and set the active context */` |
|       87 |  7017 | `	pOldCtx = pVm->pActiveCtx;` |
|       87 |  7018 | `	pVm->pActiveCtx = pCtx;` |
|       87 |  7019 | `	pCtx->iState = PH7_CTX_STATE_RUNNING;` |
|       87 |  7020 | `	pVm->nRecursionDepth++;` |
|        - |  7021 | `	/* Resume execution from saved PC */` |
|      130 |  7022 | `	rc = VmByteCodeExec(pVm, (VmInstr *)SySetBasePtr(&pCtx->pFunc->aByteCode),` |
|       43 |  7023 | `		pCtx->pStack, pCtx->nTos, &pCtx->sRetValue, 0, FALSE, pCtx->pc);` |
|       87 |  7024 | `	pVm->nRecursionDepth--;` |
|        - |  7025 | `	/* Restore the previous context */` |
|       87 |  7026 | `	pVm->pActiveCtx = pOldCtx;` |
|       87 |  7027 | `	if( rc == PH7_SUSPEND ){` |
|        - |  7028 | `		/* Fiber suspended again. Detach the fiber's frame. */` |
|       55 |  7029 | `		pVm->pFrame = pCtx->pFrame->pParent;` |
|       55 |  7030 | `		pCtx->pFrame->pParent = 0;` |
|       55 |  7031 | `		if( pResult ){` |
|       17 |  7032 | `			PH7_MemObjStore(&pCtx->sSuspendValue, pResult);` |
|        8 |  7033 | `		}` |
|       55 |  7034 | `		return SXRET_OK;` |
|        - |  7035 | `	}` |
|        - |  7036 | `	/* Detach frame */` |
|       33 |  7037 | `	if( pVm->pFrame == pCtx->pFrame ){` |
|       33 |  7038 | `		pVm->pFrame = pCtx->pFrame->pParent;` |
|       33 |  7039 | `		pCtx->pFrame->pParent = 0;` |
|       16 |  7040 | `	}` |
|       33 |  7041 | `	if( rc == PH7_ABORT ){` |
|      ! 0 |  7042 | `		pCtx->iState = PH7_CTX_STATE_CLOSED;` |
|      ! 0 |  7043 | `		return PH7_ABORT;` |
|        - |  7044 | `	}` |
|       33 |  7045 | `	if( rc == PH7_EXCEPTION ){` |
|      ! 0 |  7046 | `		pCtx->iState = PH7_CTX_STATE_CLOSED;` |
|      ! 0 |  7047 | `		return PH7_EXCEPTION;` |
|        - |  7048 | `	}` |
|        - |  7049 | `	/* Normal completion */` |
|       33 |  7050 | `	pCtx->iState = PH7_CTX_STATE_COMPLETED;` |
|       33 |  7051 | `	if( pResult ){` |
|       19 |  7052 | `		PH7_MemObjStore(&pCtx->sRetValue, pResult);` |
|        9 |  7053 | `	}` |
|       33 |  7054 | `	return SXRET_OK;` |
|       44 |  7055 |  |
|        - |  7056 | `/*` |
|        - |  7057 | ` * Release an execution context and all its resources.` |
|        - |  7058 | ` */` |
|      ! 0 |  7059 | `static void VmReleaseExecCtx(ph7_vm *pVm, ph7_exec_ctx *pCtx)` |
|      ! 0 |  7060 |  |
|      ! 0 |  7061 | `	if( pCtx == 0 ){` |
|      ! 0 |  7062 | `		return;` |
|        - |  7063 | `	}` |
|      ! 0 |  7064 | `	if( pCtx->iState == PH7_CTX_STATE_RUNNING ){` |
|        - |  7065 | `		/* Cannot destroy a fiber that is currently executing */` |
|      ! 0 |  7066 | `		return;` |
|        - |  7067 | `	}` |
|      ! 0 |  7068 | `	pCtx->iState = PH7_CTX_STATE_CLOSED;` |
|        - |  7069 | `	/* Release values */` |
|      ! 0 |  7070 | `	PH7_MemObjRelease(&pCtx->sSuspendValue);` |
|      ! 0 |  7071 | `	PH7_MemObjRelease(&pCtx->sRetValue);` |
|        - |  7072 | `	/* Release the frame if it's detached (not in the VM chain) */` |
|      ! 0 |  7073 | `	if( pCtx->pFrame ){` |
|        - |  7074 | `		VmSlot *aSlot;` |
|        - |  7075 | `		sxu32 n;` |
|        - |  7076 | `		/* Free local variables */` |
|      ! 0 |  7077 | `		aSlot = (VmSlot *)SySetBasePtr(&pCtx->pFrame->sLocal);` |
|      ! 0 |  7078 | `		for( n = 0; n < SySetUsed(&pCtx->pFrame->sLocal); ++n ){` |
|      ! 0 |  7079 | `			PH7_VmUnsetMemObj(pVm, aSlot[n].nIdx, FALSE);` |
|      ! 0 |  7080 | `		}` |
|        - |  7081 | `		/* Remove local references */` |
|      ! 0 |  7082 | `		aSlot = (VmSlot *)SySetBasePtr(&pCtx->pFrame->sRef);` |
|      ! 0 |  7083 | `		for( n = 0; n < SySetUsed(&pCtx->pFrame->sRef); ++n ){` |
|      ! 0 |  7084 | `			PH7_VmRefObjRemove(pVm, aSlot[n].nIdx, (SyHashEntry *)aSlot[n].pUserData, 0);` |
|      ! 0 |  7085 | `		}` |
|      ! 0 |  7086 | `		SyHashRelease(&pCtx->pFrame->hVar);` |
|      ! 0 |  7087 | `		SySetRelease(&pCtx->pFrame->sArg);` |
|      ! 0 |  7088 | `		SySetRelease(&pCtx->pFrame->sLocal);` |
|      ! 0 |  7089 | `		SySetRelease(&pCtx->pFrame->sRef);` |
|      ! 0 |  7090 | `		SyMemBackendPoolFree(&pVm->sAllocator, pCtx->pFrame);` |
|      ! 0 |  7091 | `		pCtx->pFrame = 0;` |
|      ! 0 |  7092 | `	}` |
...
|      ! 0 |  7096 | `	if( pCtx->pStack ){` |
|      ! 0 |  7097 | `		if( pCtx->nTos >= 0 ){` |
|      ! 0 |  7098 | `			ph7_value *pTos = &pCtx->pStack[pCtx->nTos];` |
|      ! 0 |  7099 | `			while( pTos >= pCtx->pStack ){` |
|      ! 0 |  7100 | `				PH7_MemObjRelease(pTos);` |
|      ! 0 |  7101 | `				pTos--;` |
|      ! 0 |  7102 | `			}` |
|      ! 0 |  7103 | `		}` |
|      ! 0 |  7104 | `		SyMemBackendFree(&pVm->sAllocator, pCtx->pStack);` |
|      ! 0 |  7105 | `		pCtx->pStack = 0;` |
|      ! 0 |  7106 | `	}` |
|        - |  7107 | `	/* Free the context itself */` |
|      ! 0 |  7108 | `	SyMemBackendPoolFree(&pVm->sAllocator, pCtx);` |
|      ! 0 |  7109 |  |
|        - |  7110 | `/*` |
...
|        - |  7113 | ` */` |
|       86 |  7114 | `static ph7_exec_ctx * VmFiberExtractCtx(ph7_vm *pVm, ph7_value *pFiberObj)` |
|        1 |  7115 |  |
|        - |  7116 | `	ph7_class_instance *pThis;` |
|        - |  7117 | `	SyString sAttr;` |
|        - |  7118 | `	ph7_value *pAttr;` |
|       87 |  7119 | `	if( (pFiberObj->iFlags & MEMOBJ_OBJ) == 0 ){` |
|      ! 0 |  7120 | `		return 0;` |
|        - |  7121 | `	}` |
|       87 |  7122 | `	pThis = (ph7_class_instance *)pFiberObj->x.pOther;` |
|       87 |  7123 | `	if( pThis->pClass != pVm->pFiberClass ){` |
|      ! 0 |  7124 | `		return 0;` |
|        - |  7125 | `	}` |
|       87 |  7126 | `	SyStringInitFromBuf(&sAttr, "__ctx", 5);` |
|       87 |  7127 | `	pAttr = PH7_ClassInstanceFetchAttr(pThis, &sAttr);` |
|       87 |  7128 | `	if( pAttr == 0 \|\| (pAttr->iFlags & MEMOBJ_RES) == 0 ){` |
|       31 |  7129 | `		return 0;` |
|        - |  7130 | `	}` |
|       57 |  7131 | `	return (ph7_exec_ctx *)pAttr->x.pOther;` |
|       44 |  7132 |  |
|        - |  7133 | `/*` |
...
|        - |  7164 | `	}` |
|       25 |  7165 | `	if( (apArg[0]->iFlags & MEMOBJ_OBJ) == 0 ){` |
|      ! 0 |  7166 | `		return PH7_VmThrowException(pCtx, "FiberError",` |
|        - |  7167 | `			"Fiber::__construct(): invalid $this");` |
|        - |  7168 | `	}` |
|       25 |  7169 | `	pThis = (ph7_class_instance *)apArg[0]->x.pOther;` |
|       25 |  7170 | `	if( pThis->pClass != pCtx->pVm->pFiberClass ){` |
...
|       25 |  7175 | `	if( (apArg[1]->iFlags & (MEMOBJ_STRING\|MEMOBJ_OBJ)) == 0 ){` |
...
|       25 |  7180 | `	SyStringInitFromBuf(&sAttrName, "__callable", 10);` |
|       25 |  7181 | `	pAttr = PH7_ClassInstanceFetchAttr(pThis, &sAttrName);` |
|       25 |  7182 | `	if( pAttr ){` |
|       25 |  7183 | `		PH7_MemObjStore(apArg[1], pAttr);` |
|       12 |  7184 | `	}` |
|       25 |  7185 | `	return PH7_OK;` |
|       13 |  7186 |  |
|        - |  7187 | `/*` |
...
|        1 |  7195 |  |
|       25 |  7196 | `	ph7_vm *pVm = pCtx->pVm;` |
|        - |  7197 | `	ph7_value *pCallable;` |
|        - |  7198 | `	SyString sAttrName;` |
|       25 |  7199 | `	*ppThis = 0;` |
|       25 |  7200 | `	SyStringInitFromBuf(&sAttrName, "__callable", 10);` |
|       25 |  7201 | `	pCallable = PH7_ClassInstanceFetchAttr(pFiberObj, &sAttrName);` |
|       25 |  7202 | `	if( pCallable == 0 \|\| (pCallable->iFlags & (MEMOBJ_STRING\|MEMOBJ_OBJ)) == 0 ){` |
|      ! 0 |  7203 | `		PH7_VmThrowException(pCtx, "FiberError", "Fiber has no valid callable");` |
|      ! 0 |  7204 | `		return 0;` |
|        - |  7205 | `	}` |
|       25 |  7206 | `	if( pCallable->iFlags & MEMOBJ_STRING ){` |
|        - |  7207 | `		/* String callable — look up in user functions with overload support */` |
|        - |  7208 | `		SyString sName;` |
|        - |  7209 | `		SyHashEntry *pEntry;` |
|        - |  7210 | `		ph7_vm_func *pFunc;` |
|       25 |  7211 | `		SyStringInitFromBuf(&sName, SyBlobData(&pCallable->sBlob), SyBlobLength(&pCallable->sBlob));` |
|       25 |  7212 | `		pEntry = SyHashGet(&pVm->hFunction, sName.zString, sName.nByte);` |
|       25 |  7213 | `		if( pEntry == 0 ){` |
|      ! 0 |  7214 | `			PH7_VmThrowException(pCtx, "FiberError",` |
|      ! 0 |  7215 | `				"Fiber callable '%.*s' not found", (int)sName.nByte, sName.zString);` |
|      ! 0 |  7216 | `			return 0;` |
|        - |  7217 | `		}` |
|       25 |  7218 | `		pFunc = (ph7_vm_func *)pEntry->pUserData;` |
|       25 |  7219 | `		return pFunc;` |
|      ! 0 |  7220 | `	}else{` |
...
|       43 |  7258 | `	if( SySetUsed(&pFunc->aStatic) > 0 ){` |
...
|       43 |  7276 | `	aFormalArg = (ph7_vm_func_arg *)SySetBasePtr(&pFunc->aArgs);` |
|       43 |  7277 | `	nFormal = SySetUsed(&pFunc->aArgs);` |
|       53 |  7278 | `	for( n = 0; n < nFormal; n++ ){` |
|        - |  7279 | `		ph7_value *pObj;` |
|       11 |  7280 | `		if( n < (sxu32)nArg ){` |
|        - |  7281 | `			/* Argument provided — install with type casting */` |
|       11 |  7282 | `			pObj = VmExtractMemObj(pVm, &aFormalArg[n].sName, FALSE, TRUE);` |
|       11 |  7283 | `			if( pObj ){` |
|       11 |  7284 | `				PH7_MemObjStore(apArg[n], pObj);` |
|        - |  7285 | `				/* Type casting */` |
|       11 |  7286 | `				if( aFormalArg[n].nType > 0 && aFormalArg[n].nType != SXU32_HIGH ){` |
...
|      ! 0 |  7292 | `					}` |
|      ! 0 |  7293 | `				}` |
|       11 |  7294 | `				sSlot.nIdx = pObj->nIdx;` |
|       11 |  7295 | `				sSlot.pUserData = 0;` |
|       11 |  7296 | `				SySetPut(&pExecCtx->pFrame->sArg, &sSlot);` |
|        6 |  7297 | `			}` |
...
|       43 |  7321 | `	if( pFunc->iFlags & VM_FUNC_CLOSURE ){` |
...
|        - |  7356 | `	sxi32 rc;` |
|       27 |  7357 | `	if( nArg < 1 \|\| (apArg[0]->iFlags & MEMOBJ_OBJ) == 0 ){` |
|      ! 0 |  7358 | `		return PH7_VmThrowException(pCtx, "FiberError", "Fiber::start() requires $this");` |
|        - |  7359 | `	}` |
|       27 |  7360 | `	pThis = (ph7_class_instance *)apArg[0]->x.pOther;` |
|        - |  7361 | `	/* Check if already started (has a __ctx) */` |
|       27 |  7362 | `	pExecCtx = VmFiberExtractCtx(pVm, apArg[0]);` |
|       27 |  7363 | `	if( pExecCtx != 0 ){` |
...
|       25 |  7368 | `	pFunc = VmFiberResolveCallable(pCtx, pThis, &pClosureThis);` |
|       25 |  7369 | `	if( pFunc == 0 ){` |
|      ! 0 |  7370 | `		return PH7_EXCEPTION;` |
|        - |  7371 | `	}` |
|        - |  7372 | `	/* Create execution context now that we know the function */` |
|       25 |  7373 | `	pExecCtx = VmNewExecCtx(pVm, pFunc);` |
|       25 |  7374 | `	if( pExecCtx == 0 ){` |
|      ! 0 |  7375 | `		return PH7_VmThrowException(pCtx, "FiberError",` |
|        - |  7376 | `			"Fiber::start(): out of memory");` |
|        - |  7377 | `	}` |
|        - |  7378 | `	/* Store context in $this->__ctx */` |
|       25 |  7379 | `	SyStringInitFromBuf(&sAttrName, "__ctx", 5);` |
|       25 |  7380 | `	pCtxAttr = PH7_ClassInstanceFetchAttr(pThis, &sAttrName);` |
|       25 |  7381 | `	if( pCtxAttr ){` |
|       25 |  7382 | `		pCtxAttr->x.pOther = pExecCtx;` |
|       25 |  7383 | `		MemObjSetType(pCtxAttr, MEMOBJ_RES);` |
|       12 |  7384 | `	}` |
...
|       25 |  7388 | `	pExecCtx->pFrame->pParent = pVm->pFrame;` |
|       25 |  7389 | `	pVm->pFrame = pExecCtx->pFrame;` |
|        - |  7390 | `	/* Unpack the args array and install into the frame */` |
|        - |  7391 | `	{` |
|       25 |  7392 | `		ph7_value **apValues = 0;` |
|       25 |  7393 | `		int nActual = 0;` |
|       25 |  7394 | `		if( nArg >= 2 && (apArg[1]->iFlags & MEMOBJ_HASHMAP) ){` |
|       25 |  7395 | `			ph7_hashmap *pMap = (ph7_hashmap *)apArg[1]->x.pOther;` |
|        - |  7396 | `			ph7_hashmap_node *pNode;` |
|       25 |  7397 | `			sxu32 nCount = pMap->nEntry;` |
|       25 |  7398 | `			if( nCount > 0 ){` |
|        3 |  7399 | `				sxu32 idx = 0;` |
...
|        1 |  7411 | `			}` |
|       12 |  7412 | `		}` |
|       25 |  7413 | `		rc = VmFiberSetupFrame(pVm, pExecCtx, pClosureThis, nActual, apValues);` |
|       25 |  7414 | `		if( apValues ){` |
|        3 |  7415 | `			SyMemBackendFree(&pVm->sAllocator, apValues);` |
|        1 |  7416 | `		}` |
|        - |  7417 | `	}` |
|        - |  7418 | `	/* Detach the frame — VmStartCtx will re-attach it */` |
|       25 |  7419 | `	pVm->pFrame = pExecCtx->pFrame->pParent;` |
|       25 |  7420 | `	pExecCtx->pFrame->pParent = 0;` |
|       25 |  7421 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  7422 | `		return PH7_ABORT;` |
|        - |  7423 | `	}` |
|       25 |  7424 | `	PH7_MemObjInit(pVm, &sResult);` |
|       25 |  7425 | `	rc = VmStartCtx(pVm, pExecCtx, &sResult);` |
|       25 |  7426 | `	if( rc == PH7_ABORT ){` |
|      ! 0 |  7427 | `		PH7_MemObjRelease(&sResult);` |
|      ! 0 |  7428 | `		return PH7_ABORT;` |
|        - |  7429 | `	}` |
|       25 |  7430 | `	if( rc == PH7_EXCEPTION ){` |
|      ! 0 |  7431 | `		PH7_MemObjRelease(&sResult);` |
|      ! 0 |  7432 | `		return PH7_EXCEPTION;` |
|        - |  7433 | `	}` |
|       25 |  7434 | `	ph7_result_value(pCtx, &sResult);` |
|       25 |  7435 | `	PH7_MemObjRelease(&sResult);` |
|       25 |  7436 | `	return PH7_OK;` |
|       14 |  7437 |  |
|        - |  7438 | `/*` |
...
|        1 |  7480 |  |
|        7 |  7481 | `	ph7_vm *pVm = pCtx->pVm;` |
|        - |  7482 | `	ph7_exec_ctx *pExecCtx;` |
|        7 |  7483 | `	if( nArg < 1 \|\| (apArg[0]->iFlags & MEMOBJ_OBJ) == 0 ){` |
|      ! 0 |  7484 | `		ph7_result_null(pCtx);` |
|      ! 0 |  7485 | `		return PH7_OK;` |
|        - |  7486 | `	}` |
|        7 |  7487 | `	pExecCtx = VmFiberExtractCtx(pVm, apArg[0]);` |
|        7 |  7488 | `	if( pExecCtx == 0 ){` |
|      ! 0 |  7489 | `		ph7_result_null(pCtx);` |
|      ! 0 |  7490 | `		return PH7_OK;` |
|        - |  7491 | `	}` |
|        7 |  7492 | `	if( pExecCtx->iState != PH7_CTX_STATE_COMPLETED ){` |
...
|        - |  7499 | `	}` |
|        7 |  7500 | `	ph7_result_value(pCtx, &pExecCtx->sRetValue);` |
|        7 |  7501 | `	return PH7_OK;` |
|        4 |  7502 |  |
|        - |  7503 | `/*` |
...
|        - |  7540 | ` */` |
|      ! 0 |  7541 | `static int vm_builtin_Fiber_destruct(ph7_context *pCtx, int nArg, ph7_value **apArg)` |
|      ! 0 |  7542 |  |
|      ! 0 |  7543 | `	ph7_vm *pVm = pCtx->pVm;` |
|        - |  7544 | `	ph7_exec_ctx *pExecCtx;` |
|      ! 0 |  7545 | `	if( nArg < 1 ){` |
|      ! 0 |  7546 | `		return PH7_OK;` |
|        - |  7547 | `	}` |
|      ! 0 |  7548 | `	pExecCtx = VmFiberExtractCtx(pVm, apArg[0]);` |
|      ! 0 |  7549 | `	if( pExecCtx ){` |
|      ! 0 |  7550 | `		VmReleaseExecCtx(pVm, pExecCtx);` |
|        - |  7551 | `		/* Clear the attribute so double-free is prevented */` |
|      ! 0 |  7552 | `		if( apArg[0]->iFlags & MEMOBJ_OBJ ){` |
|      ! 0 |  7553 | `			ph7_class_instance *pThis = (ph7_class_instance *)apArg[0]->x.pOther;` |
|        - |  7554 | `			SyString sAttrName;` |
|        - |  7555 | `			ph7_value *pAttr;` |
|      ! 0 |  7556 | `			SyStringInitFromBuf(&sAttrName, "__ctx", 5);` |
|      ! 0 |  7557 | `			pAttr = PH7_ClassInstanceFetchAttr(pThis, &sAttrName);` |
|      ! 0 |  7558 | `			if( pAttr ){` |
|      ! 0 |  7559 | `				PH7_MemObjRelease(pAttr);` |
|      ! 0 |  7560 | `			}` |
|      ! 0 |  7561 | `		}` |
|      ! 0 |  7562 | `	}` |
...
|       19 |  7668 | `	pGen = (ph7_generator *)SyMemBackendPoolAlloc(&pVm->sAllocator, sizeof(ph7_generator));` |
|       19 |  7669 | `	if( pGen == 0 ){` |
|      ! 0 |  7670 | `		return 0;` |
|        - |  7671 | `	}` |
|       19 |  7672 | `	SyZero(pGen, sizeof(ph7_generator));` |
|       19 |  7673 | `	pGen->pCtx = pCtx;` |
|       19 |  7674 | `	pGen->iImplicitKey = 0;` |
|       19 |  7675 | `	PH7_MemObjInit(pVm, &pGen->sYieldValue);` |
|       19 |  7676 | `	PH7_MemObjInit(pVm, &pGen->sYieldKey);` |
|        - |  7677 | `	/* Link the generator back to the exec context */` |
|       19 |  7678 | `	pCtx->pPrivate = pGen;` |
|       19 |  7679 | `	return pGen;` |
|       10 |  7680 |  |
|        - |  7681 | `/*` |
...
|      193 |  7706 | `	if( (pGenObj->iFlags & MEMOBJ_OBJ) == 0 ){` |
|      ! 0 |  7707 | `		return 0;` |
|        - |  7708 | `	}` |
|      193 |  7709 | `	pThis = (ph7_class_instance *)pGenObj->x.pOther;` |
|      193 |  7710 | `	if( pThis->pClass != pVm->pGeneratorClass ){` |
|      ! 0 |  7711 | `		return 0;` |
|        - |  7712 | `	}` |
|      193 |  7713 | `	SyStringInitFromBuf(&sAttr, "__ctx", 5);` |
|      193 |  7714 | `	pAttr = PH7_ClassInstanceFetchAttr(pThis, &sAttr);` |
|      193 |  7715 | `	if( pAttr == 0 \|\| (pAttr->iFlags & MEMOBJ_RES) == 0 ){` |
|      ! 0 |  7716 | `		return 0;` |
|        - |  7717 | `	}` |
|      193 |  7718 | `	return (ph7_generator *)pAttr->x.pOther;` |
|       97 |  7719 |  |
|        - |  7720 | `/*` |
...
|        - |  7726 | `	sxi32 rc;` |
|       19 |  7727 | `	if( nArg < 1 ) return PH7_OK;` |
|       19 |  7728 | `	pGen = VmGeneratorExtractCtx(pCtx->pVm, apArg[0]);` |
|       19 |  7729 | `	if( pGen == 0 ) return PH7_OK;` |
|       19 |  7730 | `	if( pGen->pCtx->iState == PH7_CTX_STATE_CREATED ){` |
|       19 |  7731 | `		rc = VmStartCtx(pCtx->pVm, pGen->pCtx, 0);` |
|       19 |  7732 | `		if( rc == PH7_ABORT ) return PH7_ABORT;` |
|       19 |  7733 | `		if( rc == PH7_EXCEPTION ) return PH7_EXCEPTION;` |
|        9 |  7734 | `	}` |
|       19 |  7735 | `	return PH7_OK;` |
|       10 |  7736 |  |
|        - |  7737 | `/*` |
...
|       53 |  7743 | `	if( nArg < 1 ){ ph7_result_bool(pCtx, 0); return PH7_OK; }` |
|       53 |  7744 | `	pGen = VmGeneratorExtractCtx(pCtx->pVm, apArg[0]);` |
|       53 |  7745 | `	ph7_result_bool(pCtx, pGen && pGen->pCtx->iState == PH7_CTX_STATE_SUSPENDED);` |
|       53 |  7746 | `	return PH7_OK;` |
|       27 |  7747 |  |
|        - |  7748 | `/*` |
...
|        - |  7755 | `	sxi32 rc;` |
|       57 |  7756 | `	if( nArg < 1 ){ ph7_result_null(pCtx); return PH7_OK; }` |
|       57 |  7757 | `	pGen = VmGeneratorExtractCtx(pCtx->pVm, apArg[0]);` |
|       57 |  7758 | `	if( pGen == 0 ){ ph7_result_null(pCtx); return PH7_OK; }` |
|       57 |  7759 | `	if( pGen->pCtx->iState == PH7_CTX_STATE_CREATED ){` |
...
|      ! 0 |  7763 | `	}` |
|       57 |  7764 | `	if( pGen->pCtx->iState == PH7_CTX_STATE_SUSPENDED ){` |
|       57 |  7765 | `		ph7_result_value(pCtx, &pGen->sYieldValue);` |
|       29 |  7766 | `	}else{` |
|      ! 0 |  7767 | `		ph7_result_null(pCtx);` |
|        - |  7768 | `	}` |
|       57 |  7769 | `	return PH7_OK;` |
|       29 |  7770 |  |
|        - |  7771 | `/*` |
...
|        - |  7800 | `	sxi32 rc;` |
|       49 |  7801 | `	if( nArg < 1 ) return PH7_OK;` |
|       49 |  7802 | `	pGen = VmGeneratorExtractCtx(pCtx->pVm, apArg[0]);` |
|       49 |  7803 | `	if( pGen == 0 ) return PH7_OK;` |
|       49 |  7804 | `	if( pGen->pCtx->iState == PH7_CTX_STATE_CREATED ){` |
|      ! 0 |  7805 | `		rc = VmStartCtx(pCtx->pVm, pGen->pCtx, 0);` |
|       49 |  7806 | `	}else if( pGen->pCtx->iState == PH7_CTX_STATE_SUSPENDED ){` |
|       49 |  7807 | `		rc = VmResumeCtx(pCtx->pVm, pGen->pCtx, 0, 0);` |
|       25 |  7808 | `	}else{` |
|      ! 0 |  7809 | `		return PH7_OK;` |
|        - |  7810 | `	}` |
|       49 |  7811 | `	if( rc == PH7_ABORT ) return PH7_ABORT;` |
|       49 |  7812 | `	if( rc == PH7_EXCEPTION ) return PH7_EXCEPTION;` |
|       49 |  7813 | `	return PH7_OK;` |
|       25 |  7814 |  |
|        - |  7815 | `/*` |
...
|        - |  7938 | ` */` |
|      350 |  7939 | `PH7_PRIVATE sxi32 PH7_VmOutputConsume(` |
|        - |  7940 | `	ph7_vm *pVm,      /* Target VM */` |
|        - |  7941 | `	SyString *pString /* Message to output */` |
|        - |  7942 | `	)` |
|        2 |  7943 |  |
|      352 |  7944 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|      352 |  7945 | `	sxi32 rc = SXRET_OK;` |
|        - |  7946 | `	/* Call the output consumer */` |
|      352 |  7947 | `	if( pString->nByte > 0 ){` |
|      352 |  7948 | `		rc = pCons->xConsumer((const void *)pString->zString,pString->nByte,pCons->pUserData);` |
|      352 |  7949 | `		VmTrackOutput(pVm, pString->nByte);` |
|      175 |  7950 | `	}` |
|      352 |  7951 | `	return rc;` |
|        2 |  7952 |  |
|        - |  7953 | `/*` |
...
|        - |  8295 | ` */` |
|     1684 |  8296 | `static int vm_builtin_func_exists(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  8297 |  |
...
|     1686 |  8308 | `	pVm = pCtx->pVm;` |
|        - |  8309 | `	/* Extract the function name */` |
|     1686 |  8310 | `	zName = ph7_value_to_string(apArg[0],&nLen);` |
|        - |  8311 | `	/* Assume the function is not defined */` |
|     1686 |  8312 | `	res = 0;` |
|        - |  8313 | `	/* Perform the lookup */` |
|     2526 |  8314 | `	if( SyHashGet(&pVm->hFunction,(const void *)zName,(sxu32)nLen) != 0 \|\|` |
|     1680 |  8315 | `		SyHashGet(&pVm->hHostFunction,(const void *)zName,(sxu32)nLen) != 0 ){` |
|        - |  8316 | `			/* Function is defined */` |
|      206 |  8317 | `			res = 1;` |
|      102 |  8318 | `	}` |
|     1686 |  8319 | `	ph7_result_bool(pCtx,res);` |
|     1686 |  8320 | `	return SXRET_OK;` |
|      844 |  8321 |  |
|        - |  8322 | `/*` |
...
|        - |  8326 | ` */` |
|    16334 |  8327 | `PH7_PRIVATE int PH7_VmIsCallable(ph7_vm *pVm,ph7_value *pValue,int CallInvoke)` |
|        2 |  8328 |  |
|    16336 |  8329 | `	int res = 0;` |
|    16336 |  8330 | `	if( pValue->iFlags & MEMOBJ_OBJ ){` |
...
|      ! 0 |  8345 | `		}` |
|    16336 |  8346 | `	}else if( pValue->iFlags & MEMOBJ_HASHMAP ){` |
...
|        5 |  8368 | `			}` |
|        7 |  8369 | `		}` |
|    16323 |  8370 | `	}else if( pValue->iFlags & MEMOBJ_STRING ){` |
|        - |  8371 | `		const char *zName;` |
|        - |  8372 | `		int nLen;` |
|        - |  8373 | `		/* Extract the name */` |
|     4796 |  8374 | `		zName = ph7_value_to_string(pValue,&nLen);` |
|        - |  8375 | `		/* Perform the lookup */` |
|     4811 |  8376 | `		if( SyHashGet(&pVm->hFunction,(const void *)zName,(sxu32)nLen) != 0 \|\|` |
|       30 |  8377 | `			SyHashGet(&pVm->hHostFunction,(const void *)zName,(sxu32)nLen) != 0 ){` |
|        - |  8378 | `				/* Function is callable */` |
|     4778 |  8379 | `				res = 1;` |
|     2388 |  8380 | `		}` |
|     2397 |  8381 | `	}` |
|    16336 |  8382 | `	return res;` |
|        2 |  8383 |  |
|        - |  8384 | `/*` |
...
|        - |  8538 | ` */` |
|      560 |  8539 | `PH7_PRIVATE ph7_class * PH7_VmPeekTopClass(ph7_vm *pVm)` |
|        2 |  8540 |  |
|      562 |  8541 | `	SySet *pSet = &pVm->aSelf;` |
|        - |  8542 | `	ph7_class **apClass;` |
|      562 |  8543 | `	if( SySetUsed(pSet) <= 0 ){` |
|        - |  8544 | `		/* Empty stack,return NULL */` |
|       15 |  8545 | `		return 0;` |
|        - |  8546 | `	}` |
|        - |  8547 | `	/* Peek the last entry */` |
|      548 |  8548 | `	apClass = (ph7_class **)SySetBasePtr(pSet);` |
|      548 |  8549 | `	return apClass[pSet->nUsed - 1];` |
|      282 |  8550 |  |
|        - |  8551 | `/*` |
...
|        - |  8569 | ` */` |
|       52 |  8570 | `PH7_PRIVATE ph7_class * PH7_VmPeekDeclaringClass(ph7_vm *pVm)` |
|        2 |  8571 |  |
|       54 |  8572 | `	VmFrame *pFrame = pVm->pFrame;` |
|        - |  8573 | `	ph7_vm_func *pVmFunc;` |
|        - |  8574 |  |
|        - |  8575 | `	/* Skip exception frames to find the actual method frame */` |
|       54 |  8576 | `	pFrame = VmSkipExceptionFrames(pFrame);` |
|        - |  8577 |  |
|        - |  8578 | `	/* Check if we're in a method context */` |
|       54 |  8579 | `	if( pFrame->pParent ){` |
|       50 |  8580 | `		pVmFunc = (ph7_vm_func *)pFrame->pUserData;` |
|       50 |  8581 | `		if( pVmFunc && (pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) ){` |
|        - |  8582 | `			/* Return the declaring class */` |
|       50 |  8583 | `			return (ph7_class *)pVmFunc->pUserData;` |
|        - |  8584 | `		}` |
|      ! 0 |  8585 | `	}` |
|        - |  8586 |  |
|        5 |  8587 | `	return 0;` |
...
|        - |  8596 | ` */` |
|     1488 |  8597 | `PH7_PRIVATE sxi32 PH7_VmCallClassMethod(` |
...
|     1490 |  8611 | `	aStack = VmNewOperandStack(&(*pVm),2/* Method name + Aux data */+nArg);` |
|     1490 |  8612 | `	if( aStack == 0 ){` |
...
|      305 |  8625 | `	}` |
|     1490 |  8626 | `	iCursor = nArg + 1;` |
|     1490 |  8627 | `	if( pThis ){` |
|        - |  8628 | `		/*` |
|        - |  8629 | `		 * Push the class instance so that the '$this' variable will be available.` |
|        - |  8630 | `		 */` |
|     1484 |  8631 | `		pThis->iRef++; /* Increment reference count */` |
|     1484 |  8632 | `		aStack[i].x.pOther = pThis;` |
|     1484 |  8633 | `		aStack[i].iFlags = MEMOBJ_OBJ;` |
|      741 |  8634 | `	}` |
|     1490 |  8635 | `	aStack[i].nIdx = SXU32_HIGH; /* Mark as constant */` |
|     1490 |  8636 | `	i++;` |
|        - |  8637 | `	/* Push method name */` |
|     1490 |  8638 | `	SyBlobReset(&aStack[i].sBlob);` |
|     1490 |  8639 | `	SyBlobAppend(&aStack[i].sBlob,(const void *)SyStringData(&pMethod->sVmName),SyStringLength(&pMethod->sVmName));` |
|     1490 |  8640 | `	aStack[i].iFlags = MEMOBJ_STRING;` |
|     1490 |  8641 | `	aStack[i].nIdx = SXU32_HIGH;` |
|        - |  8642 | `	/* Emit the CALL istruction */` |
|     1490 |  8643 | `	aInstr[0].iOp = PH7_OP_CALL;` |
|     1490 |  8644 | `	aInstr[0].iP1 = nArg; /* Total number of given arguments */` |
|     1490 |  8645 | `	aInstr[0].iP2 = 0;` |
|     1490 |  8646 | `	aInstr[0].p3  = 0;` |
|        - |  8647 | `	/* Emit the DONE instruction */` |
|     1490 |  8648 | `	aInstr[1].iOp = PH7_OP_DONE;` |
|     1490 |  8649 | `	aInstr[1].iP1 = 1;   /* Extract method return value */` |
|     1490 |  8650 | `	aInstr[1].iP2 = 0;` |
|     1490 |  8651 | `	aInstr[1].p3  = 0;` |
|        - |  8652 | `	/* Execute the method body (if available) */` |
|     1490 |  8653 | `	VmByteCodeExec(&(*pVm),aInstr,aStack,iCursor,pResult,0,TRUE,0);` |
|        - |  8654 | `	/* Clean up the mess left behind */` |
|     1490 |  8655 | `	SyMemBackendFree(&pVm->sAllocator,aStack);` |
|     1490 |  8656 | `	return PH7_OK;` |
|      746 |  8657 |  |
|        - |  8658 | `/*` |
...
|        - |  9024 | ` */` |
|     2675 |  9025 | `PH7_PRIVATE sxu32 PH7_VmRandomNum(ph7_vm *pVm)` |
|        2 |  9026 |  |
|        - |  9027 | `	sxu32 iNum;` |
|     2677 |  9028 | `	SyRandomness(&pVm->sPrng,(void *)&iNum,sizeof(sxu32));` |
|     2677 |  9029 | `	return iNum;` |
|        2 |  9030 |  |
|        - |  9031 | `/*` |
...
|        - |  9036 | ` */` |
|   137964 |  9037 | `PH7_PRIVATE void PH7_VmRandomString(ph7_vm *pVm,char *zBuf,int nLen)` |
|        2 |  9038 |  |
|        - |  9039 | `	static const char zBase[] = {"abcdefghijklmnopqrstuvwxyz"}; /* English Alphabet */` |
|        - |  9040 | `	int i;` |
|        - |  9041 | `	/* Generate a binary string first */` |
|   137966 |  9042 | `	SyRandomness(&pVm->sPrng,zBuf,(sxu32)nLen);` |
|        - |  9043 | `	/* Turn the binary string into english based alphabet */` |
|  1517774 |  9044 | `	for( i = 0 ; i < nLen ; ++i ){` |
|  1379810 |  9045 | `		 zBuf[i] = zBase[zBuf[i] % (sizeof(zBase)-1)];` |
|   689906 |  9046 | `	 }` |
|   137966 |  9047 |  |
|        - |  9048 | `/*` |
|        - |  9049 | ` * int rand()` |
...
|        - |  9343 | ` */` |
|    74510 |  9344 | `static int vm_builtin_isset(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  9345 |  |
|        - |  9346 | `	ph7_value *pObj;` |
|    74512 |  9347 | `	int res = 0;` |
|        - |  9348 | `	int i;` |
|    74512 |  9349 | `	if( nArg < 1 ){` |
...
|    98246 |  9355 | `	for( i = 0 ; i < nArg ; ++i ){` |
|    74512 |  9356 | `		pObj = apArg[i];` |
|    74512 |  9357 | `		if( pObj->nIdx == SXU32_HIGH ){` |
|    50260 |  9358 | `			if( (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
|        - |  9359 | `				/* Not so fatal,Throw a warning */` |
|      ! 0 |  9360 | `				ph7_context_throw_error(pCtx,PH7_CTX_WARNING,"Expecting a variable not a constant");` |
|      ! 0 |  9361 | `			}` |
|    25129 |  9362 | `		}` |
|    74512 |  9363 | `		res = (pObj->iFlags & MEMOBJ_NULL) ? 0 : 1;` |
|    74512 |  9364 | `		if( !res ){` |
|        - |  9365 | `			/* Variable not set,return FALSE */` |
|    50778 |  9366 | `			ph7_result_bool(pCtx,0);` |
|    50778 |  9367 | `			return SXRET_OK;` |
|        - |  9368 | `		}` |
|    11869 |  9369 | `	}` |
|        - |  9370 | `	/* All given variable are set,return TRUE */` |
|    23736 |  9371 | `	ph7_result_bool(pCtx,1);` |
|    23736 |  9372 | `	return SXRET_OK;` |
|    37257 |  9373 |  |
|        - |  9374 | `/*` |
...
|        - |  9378 | ` */` |
|  2997808 |  9379 | `PH7_PRIVATE sxi32 PH7_VmUnsetMemObj(ph7_vm *pVm,sxu32 nObjIdx,int bForce)` |
|        2 |  9380 |  |
|        - |  9381 | `	ph7_value *pObj;` |
|        - |  9382 | `	VmRefObj *pRef;` |
|  2997810 |  9383 | `	pObj = (ph7_value *)SySetAt(&pVm->aMemObj,nObjIdx);` |
|  2997810 |  9384 | `	if( pObj ){` |
|        - |  9385 | `		/* Release the object */` |
|  2997810 |  9386 | `		PH7_MemObjRelease(pObj);` |
|  1498904 |  9387 | `	}` |
|        - |  9388 | `	/* Remove old reference links */` |
|  2997810 |  9389 | `	pRef = VmRefObjExtract(&(*pVm),nObjIdx);` |
|  2997810 |  9390 | `	if( pRef ){` |
|  2997804 |  9391 | `		sxi32 iFlags = pRef->iFlags;` |
|        - |  9392 | `		/* Unlink from the reference table */` |
|  2997804 |  9393 | `		VmRefObjUnlink(&(*pVm),pRef);` |
|  2997804 |  9394 | `		if( (bForce == TRUE) \|\| (iFlags & VM_REF_IDX_KEEP) == 0 ){` |
|        - |  9395 | `			VmSlot sFree;` |
|        - |  9396 | `			/* Restore to the free list */` |
|  2997798 |  9397 | `			sFree.nIdx = nObjIdx;` |
|  2997798 |  9398 | `			sFree.pUserData = 0;` |
|  2997798 |  9399 | `			SySetPut(&pVm->aFreeObj,(const void *)&sFree);` |
|  1498898 |  9400 | `		}` |
|  1498901 |  9401 | `	}` |
|  2997810 |  9402 | `	return SXRET_OK;` |
|        2 |  9403 |  |
|        - |  9404 | `/*` |
|        - |  9405 | ` * void unset($var,...)` |
...
|        - |  9410 | ` *  Nothing.` |
|        - |  9411 | ` */` |
|     6712 |  9412 | `static int vm_builtin_unset(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  9413 |  |
|        - |  9414 | `	ph7_value *pObj;` |
|        - |  9415 | `	ph7_vm *pVm;` |
|        - |  9416 | `	int i;` |
|        - |  9417 | `	/* Point to the target VM */` |
|     6714 |  9418 | `	pVm = pCtx->pVm;` |
|        - |  9419 | `	/* Iterate and unset */` |
|    13426 |  9420 | `	for( i = 0 ; i < nArg ; ++i ){` |
|     6714 |  9421 | `		pObj = apArg[i];` |
|     6714 |  9422 | `		if( pObj->nIdx == SXU32_HIGH ){` |
|      ! 0 |  9423 | `			if( (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
|        - |  9424 | `				/* Throw an error */` |
|      ! 0 |  9425 | `				ph7_context_throw_error(pCtx,PH7_CTX_ERR,"Expecting a variable not a constant");` |
|      ! 0 |  9426 | `			}` |
|      ! 0 |  9427 | `		}else{` |
|     6714 |  9428 | `			sxu32 nIdx = pObj->nIdx;` |
|        - |  9429 | `			/* TICKET 1433-35: Protect the $GLOBALS array from deletion */` |
|     6714 |  9430 | `			if( nIdx != pVm->nGlobalIdx ){` |
|     6708 |  9431 | `				PH7_VmUnsetMemObj(&(*pVm),nIdx,FALSE);` |
|     3353 |  9432 | `			}` |
|        - |  9433 | `		}` |
|     3358 |  9434 | `	}` |
|     6714 |  9435 | `	return SXRET_OK;` |
|        2 |  9436 |  |
|        - |  9437 | `/*` |
...
|        - |  9653 | ` */` |
|       30 |  9654 | `static int vm_builtin_assert_options(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  9655 |  |
|       32 |  9656 | `	ph7_vm *pVm = pCtx->pVm;` |
|        - |  9657 | `	int iOption;` |
...
|       28 |  9666 | `	if( ph7_value_is_array(apArg[0]) \|\| ph7_value_is_object(apArg[0])` |
|       30 |  9667 | `		\|\| ph7_value_is_resource(apArg[0]) ){` |
...
|        - |  9673 | `			);` |
|        - |  9674 | `	}` |
|       30 |  9675 | `	iOption = ph7_value_to_int(apArg[0]);` |
...
|       30 |  9679 | `	switch( iOption ){` |
|        6 |  9680 | `	case 1: /* ASSERT_ACTIVE */` |
|        - |  9681 | `		/* Return old value: 1 if active (not disabled), 0 if disabled */` |
|       14 |  9682 | `		ph7_result_int(pCtx, (pVm->iAssertFlags & PH7_ASSERT_DISABLE) ? 0 : 1);` |
|       14 |  9683 | `		if( nArg > 1 ){` |
...
|        - |  9743 | ` */` |
|       26 |  9744 | `static int vm_builtin_assert(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  9745 |  |
|       28 |  9746 | `	ph7_vm *pVm = pCtx->pVm;` |
...
|        - |  9754 | `			);` |
|        - |  9755 | `	}` |
|       26 |  9756 | `	iFlags = pVm->iAssertFlags;` |
|       26 |  9757 | `	if( iFlags & PH7_ASSERT_DISABLE ){` |
...
|       26 |  9763 | `	iResult = ph7_value_to_bool(apArg[0]);` |
|       26 |  9764 | `	if( !iResult ){` |
...
|       14 |  9811 | `	ph7_result_bool(pCtx,1);` |
|       14 |  9812 | `	return PH7_OK;` |
|       15 |  9813 |  |
|        - |  9814 | `/*` |
|        - |  9815 | ` * Section:` |
...
|        - |  9891 | ` */` |
|       42 |  9892 | `static int vm_builtin_error_reporting(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 |  9893 |  |
|       44 |  9894 | `	ph7_vm *pVm = pCtx->pVm;` |
|        - |  9895 | `	int nOld;` |
|        - |  9896 | `	/* Extract the old reporting level */` |
|       44 |  9897 | `	nOld = pVm->bErrReport ? 32767 /* E_ALL */ : 0;` |
|       44 |  9898 | `	if( nArg > 0 ){` |
|        - |  9899 | `		int nNew;` |
|        - |  9900 | `		/* Extract the desired error reporting level */` |
|       36 |  9901 | `		nNew = ph7_value_to_int(apArg[0]);` |
|       36 |  9902 | `		if( !nNew ){` |
|        - |  9903 | `			/* Do not report errors at all */` |
|        5 |  9904 | `			pVm->bErrReport = 0;` |
|        3 |  9905 | `		}else{` |
|        - |  9906 | `			/* Report all errors */` |
|       32 |  9907 | `			pVm->bErrReport = 1;` |
|        - |  9908 | `		}` |
|       17 |  9909 | `	}` |
|        - |  9910 | `	/* Return the old level */` |
|       44 |  9911 | `	ph7_result_int(pCtx,nOld);` |
|       44 |  9912 | `	return PH7_OK;` |
|        2 |  9913 |  |
|        - |  9914 | `/*` |
...
|        - | 10103 | ` */` |
|     8858 | 10104 | `static int vm_builtin_set_error_handler(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 | 10105 |  |
|     8860 | 10106 | `	ph7_vm *pVm = pCtx->pVm;` |
|        - | 10107 | `	ph7_value *pOld,*pNew;` |
|        - | 10108 | `	/* Point to the old and the new handler */` |
|     8860 | 10109 | `	pOld = &pVm->aErrCB[0];` |
|     8860 | 10110 | `	pNew = &pVm->aErrCB[1];` |
|        - | 10111 | `	/* Return the old handler */` |
|     8860 | 10112 | `	ph7_result_value(pCtx,pOld); /* Will make it's own copy */` |
|     8860 | 10113 | `	if( nArg > 0 ){` |
|     8860 | 10114 | `		if( !ph7_value_is_callable(apArg[0])) {` |
|        - | 10115 | `			/* Not callable,return TRUE (As requested by the PHP specification) */` |
|     4429 | 10116 | `			PH7_MemObjRelease(pNew);` |
|     4429 | 10117 | `			ph7_result_bool(pCtx,1);` |
|     2215 | 10118 | `		}else{` |
|     4432 | 10119 | `			PH7_MemObjStore(pNew,pOld);` |
|        - | 10120 | `			/* Install the new handler */` |
|     4432 | 10121 | `			PH7_MemObjStore(apArg[0],pNew);` |
|        - | 10122 | `		}` |
|     4429 | 10123 | `	}` |
|     8860 | 10124 | `	return PH7_OK;` |
|        2 | 10125 |  |
|        - | 10126 | `/*` |
...
|        6 | 10489 | `				pThis->iRef++;` |
|        6 | 10490 | `				pVm->pPendingException = pThis;` |
|        6 | 10491 | `				return SXRET_OK;` |
|        - | 10492 | `			}` |
|      236 | 10493 | `		}` |
...
|       11 | 10519 | `			apSaved = (ph7_exception **)SyMemBackendAlloc(&pVm->sAllocator,` |
|        3 | 10520 | `				nSavedCount * sizeof(ph7_exception *));` |
|        8 | 10521 | `			if( apSaved ){` |
|       11 | 10522 | `				SyMemcpy(SySetBasePtr(&pVm->aException),apSaved,` |
|        3 | 10523 | `					nSavedCount * sizeof(ph7_exception *));` |
|        8 | 10524 | `				SySetReset(&pVm->aException);` |
|        3 | 10525 | `			}` |
|        3 | 10526 | `		}` |
...
|        - | 10548 | `			 */` |
|        8 | 10549 | `			SySetReset(&pVm->aException);` |
|       14 | 10550 | `			for(k = 0; k < nSavedCount; k++){` |
|        8 | 10551 | `				SySetPut(&pVm->aException,(const void *)&apSaved[k]);` |
|        5 | 10552 | `			}` |
|        8 | 10553 | `			SyMemBackendFree(&pVm->sAllocator,apSaved);` |
|        3 | 10554 | `		}` |
|        - | 10555 | `		/* Execute the finally block after catch */` |
|       38 | 10556 | `		if( pException->iHasFinally ){` |
|       11 | 10557 | `			pException->iFinallyDone = 1;` |
|        - | 10558 | `			{` |
|       11 | 10559 | `				sxi32 rcf = VmLocalExec(&(*pVm),&pException->sFinally,0);` |
|       11 | 10560 | `				if( rcf == SXERR_ABORT ){` |
...
|        6 | 10573 | `			ph7_class_instance *pReThrow = pVm->pPendingException;` |
|        6 | 10574 | `			pVm->pPendingException = 0;` |
|        6 | 10575 | `			return VmThrowException(&(*pVm),pReThrow);` |
|        - | 10576 | `		}` |
|        - | 10577 | `	}` |
...
|        - | 11367 | ` * information.` |
|        - | 11368 | ` */` |
|    10556 | 11369 | `static sxi32 VmEvalChunk(` |
...
|    10558 | 11379 | `	ProcConsumer xErr = 0;` |
|    10558 | 11380 | `	void *pErrData = 0;` |
|        - | 11381 | `	/* Initialize bytecode container */` |
|    10558 | 11382 | `	SySetInit(&aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|    10558 | 11383 | `	SySetAlloc(&aByteCode,0x20);` |
|        - | 11384 | `	/* Reset the code generator */` |
|    10558 | 11385 | `	if( bTrueReturn ){` |
|        - | 11386 | `		/* Included file,log compile-time errors */` |
|     7676 | 11387 | `		xErr = pVm->pEngine->xConf.xErr;` |
|     7676 | 11388 | `		pErrData = pVm->pEngine->xConf.pErrData;` |
|     3837 | 11389 | `	}` |
|    10558 | 11390 | `	PH7_ResetCodeGenerator(pVm,xErr,pErrData);` |
...
|    10558 | 11394 | `	SyBlobInit(&sSavedNs,&pVm->sAllocator);` |
|    10558 | 11395 | `	SyBlobDup(&pVm->sNamespace,&sSavedNs);` |
|    10558 | 11396 | `	if( bTrueReturn ){` |
|        - | 11397 | `		/* Include/require: start in a fresh (global) namespace scope. */` |
|     7676 | 11398 | `		SyBlobReset(&pVm->sNamespace);` |
|     3837 | 11399 | `	}` |
|        - | 11400 | `	/* Swap bytecode container */` |
|    10558 | 11401 | `	pByteCode = pVm->pByteContainer;` |
|    10558 | 11402 | `	pVm->pByteContainer = &aByteCode;` |
|        - | 11403 | `	/* Compile the chunk */` |
|    10558 | 11404 | `	PH7_CompileScript(pVm,pChunk,iFlags);` |
|    15836 | 11405 | `	if( pVm->sCodeGen.nErr > 0 ){` |
...
|        - | 11415 | `		sxi32 rc;` |
|    10556 | 11416 | `		SyHashResetLoopCursor(&pVm->hClass);` |
|   321497 | 11417 | `		while((pEntry = SyHashGetNextEntry(&pVm->hClass)) != 0 ){` |
|   305666 | 11418 | `			pClass = (ph7_class *)pEntry->pUserData;` |
|        - | 11419 | `			/* Only mount classes that haven't been mounted yet */` |
|   305666 | 11420 | `			if( !pClass->bMounted ){` |
|    75754 | 11421 | `				rc = VmMountUserClass(pVm,pClass);` |
|    75754 | 11422 | `				if( rc != SXRET_OK ){` |
...
|    37876 | 11429 | `			}` |
|        2 | 11430 | `		}` |
|    10556 | 11431 | `		if( SXRET_OK != PH7_VmEmitInstr(pVm,PH7_OP_DONE,0,0,0,0) ){` |
|        - | 11432 | `			/* Out of memory */` |
|      ! 0 | 11433 | `			if( pCtx ){` |
...
|        - | 11437 | `		}` |
|    10556 | 11438 | `		if( bTrueReturn ){` |
|        - | 11439 | `			/* Assume a boolean true return value */` |
|     7676 | 11440 | `			PH7_MemObjInitFromBool(pVm,&sResult,1);` |
|     3839 | 11441 | `		}else{` |
|        - | 11442 | `			/* Assume a null return value */` |
|     2882 | 11443 | `			PH7_MemObjInit(pVm,&sResult);` |
|        - | 11444 | `		}` |
|        - | 11445 | `		/* Execute the compiled chunk */` |
|    10556 | 11446 | `		VmLocalExec(pVm,&aByteCode,&sResult);` |
|    10556 | 11447 | `		if( pCtx ){` |
|        - | 11448 | `			/* Set the execution result */` |
|     7694 | 11449 | `			ph7_result_value(pCtx,&sResult);` |
|     3846 | 11450 | `		}` |
|    10556 | 11451 | `		PH7_MemObjRelease(&sResult);` |
|        - | 11452 | `	}` |
|     5278 | 11453 | `Cleanup:` |
|        - | 11454 | `	/* Cleanup the mess left behind */` |
|    10558 | 11455 | `	pVm->pByteContainer = pByteCode;` |
|    10558 | 11456 | `	SySetRelease(&aByteCode);` |
|        - | 11457 | `	/* Restore caller's namespace state */` |
|    10558 | 11458 | `	SyBlobReset(&pVm->sNamespace);` |
|    10558 | 11459 | `	SyBlobDup(&sSavedNs,&pVm->sNamespace);` |
|    10558 | 11460 | `	SyBlobRelease(&sSavedNs);` |
|    10558 | 11461 | `	return SXRET_OK;` |
|        2 | 11462 |  |
|        - | 11463 | `/*` |
...
|        - | 11494 | ` */` |
|    15344 | 11495 | `static int VmIsIncludedFile(ph7_vm *pVm,SyString *pFile)` |
|        2 | 11496 |  |
|        - | 11497 | `	SyString *aEntries;` |
|        - | 11498 | `	sxu32 n;` |
|    15346 | 11499 | `	aEntries = (SyString *)SySetBasePtr(&pVm->aIncluded);` |
|        - | 11500 | `	/* Perform a linear search */` |
| 58817832 | 11501 | `	for( n = 0 ; n < SySetUsed(&pVm->aIncluded) ; ++n ){` |
| 58802494 | 11502 | `		if( SyStringCmp(pFile,&aEntries[n],SyMemcmp) == 0 ){` |
|        - | 11503 | `			/* Already included */` |
|        7 | 11504 | `			return TRUE;` |
|        - | 11505 | `		}` |
| 29401245 | 11506 | `	}` |
|    15340 | 11507 | `	return FALSE;` |
|     7674 | 11508 |  |
|        - | 11509 | `/*` |
|        - | 11510 | ` * Push a file path in the appropriate VM container.` |
|        - | 11511 | ` */` |
|    18198 | 11512 | `PH7_PRIVATE sxi32 PH7_VmPushFilePath(ph7_vm *pVm,const char *zPath,int nLen,sxu8 bMain,sxi32 *pNew)` |
|        2 | 11513 |  |
...
|        - | 11518 | `#endif` |
|        - | 11519 | `	sxi32 rc;` |
|    18200 | 11520 | `	if( nLen < 0 ){` |
|     2856 | 11521 | `		nLen = SyStrlen(zPath);` |
|     1427 | 11522 | `	}` |
|        - | 11523 | `	/* Duplicate the file path first */` |
|    18200 | 11524 | `	zDup = SyMemBackendStrDup(&pVm->sAllocator,zPath,nLen);` |
|    18200 | 11525 | `	if( zDup == 0 ){` |
...
|    18200 | 11547 | `	SyStringInitFromBuf(&sPath,zDup,nLen);` |
|    18200 | 11548 | `	if( !bMain ){` |
|    15346 | 11549 | `		if( VmIsIncludedFile(&(*pVm),&sPath) ){` |
|        - | 11550 | `			/* Already included */` |
|        7 | 11551 | `			*pNew = 0;` |
|        4 | 11552 | `		}else{` |
|        - | 11553 | `			/* Insert in the corresponding container */` |
|    15340 | 11554 | `			rc = SySetPut(&pVm->aIncluded,(const void *)&sPath);` |
|    15340 | 11555 | `			if( rc != SXRET_OK ){` |
...
|        - | 11560 | `		}` |
|     7672 | 11561 | `	}` |
|    18200 | 11562 | `	SySetPut(&pVm->aFiles,(const void *)&sPath);` |
|    18200 | 11563 | `	return SXRET_OK;` |
|     9101 | 11564 |  |
|        - | 11565 | `/*` |
...
|        - | 11576 | ` */` |
|     7684 | 11577 | `static sxi32 VmExecIncludedFile(` |
...
|     7686 | 11591 | `	pVm = pCtx->pVm;` |
|     7686 | 11592 | `	SyBlobInit(&sContents,&pVm->sAllocator);` |
|     7686 | 11593 | `	isNew = 0;` |
|        - | 11594 | `	/* Extract the associated stream */` |
|     7686 | 11595 | `	pStream = PH7_VmGetStreamDevice(pVm,&pPath->zString,pPath->nByte);` |
|        - | 11596 | `	/*` |
|        - | 11597 | `	 * Open the file or the URL [i.e: http://ph7.symisc.net/example/hello.php"]` |
|        - | 11598 | `	 * in a read-only mode.` |
|        - | 11599 | `	 */` |
|     7686 | 11600 | `	pHandle = PH7_StreamOpenHandle(pVm,pStream,pPath->zString,PH7_IO_OPEN_RDONLY,TRUE,0,TRUE,&isNew);` |
|     7686 | 11601 | `	if( pHandle == 0 ){` |
|        8 | 11602 | `		return SXERR_IO;` |
|        - | 11603 | `	}` |
|     7680 | 11604 | `	rc = SXRET_OK; /* Stupid cc warning */` |
|     7680 | 11605 | `	if( IncludeOnce && !isNew ){` |
|        - | 11606 | `		/* Already included */` |
|        5 | 11607 | `		rc = SXERR_EXISTS;` |
|        3 | 11608 | `	}else{` |
|        - | 11609 | `		/* Read the whole file contents */` |
|     7676 | 11610 | `		rc = PH7_StreamReadWholeFile(pHandle,pStream,&sContents);` |
|     7676 | 11611 | `		if( rc == SXRET_OK ){` |
|        - | 11612 | `			SyString sScript;` |
|        - | 11613 | `			/* Compile and execute the script */` |
|     7676 | 11614 | `			SyStringInitFromBuf(&sScript,SyBlobData(&sContents),SyBlobLength(&sContents));` |
|     7676 | 11615 | `			VmEvalChunk(pCtx->pVm,&(*pCtx),&sScript,0,TRUE);` |
|     3837 | 11616 | `		}` |
|        - | 11617 | `	}` |
|        - | 11618 | `	/* Pop from the set of included file */` |
|     7680 | 11619 | `	(void)SySetPop(&pVm->aFiles);` |
|        - | 11620 | `	/* Close the handle */` |
|     7680 | 11621 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|        - | 11622 | `	/* Release the working buffer */` |
|     7680 | 11623 | `	SyBlobRelease(&sContents);` |
|        - | 11624 | `#else` |
...
|     3689 | 11697 | `	while( SXRET_OK == SySetGetNextEntry(pFiles,(void **)&pEntry) ){` |
|        - | 11698 | `		const char *zBase,*zEnd;` |
|        - | 11699 | `		int iLen;` |
|        - | 11700 | `		/* reset the string cursor */` |
|     3687 | 11701 | `		ph7_value_reset_string_cursor(pWorker);` |
|        - | 11702 | `		/* Extract base name */` |
|     3687 | 11703 | `		zEnd = &pEntry->zString[pEntry->nByte - 1];` |
|        - | 11704 | `		/* Ignore trailing '/' */` |
|     5530 | 11705 | `		while( zEnd > pEntry->zString && ( (int)zEnd[0] == c \|\| (int)zEnd[0] == d ) ){` |
|      ! 0 | 11706 | `			zEnd--;` |
|      ! 0 | 11707 | `		}` |
|     3687 | 11708 | `		iLen = (int)(&zEnd[1]-pEntry->zString);` |
|   113770 | 11709 | `		while( zEnd > pEntry->zString && ( (int)zEnd[0] != c && (int)zEnd[0] != d ) ){` |
|   108241 | 11710 | `			zEnd--;` |
|        1 | 11711 | `		}` |
|     3687 | 11712 | `		zBase = (zEnd > pEntry->zString) ? &zEnd[1] : pEntry->zString;` |
|     3687 | 11713 | `		zEnd = &pEntry->zString[iLen];` |
|        - | 11714 | `		/* Copy entry name */` |
|     3687 | 11715 | `		ph7_value_string(pWorker,zBase,(int)(zEnd-zBase));` |
|        - | 11716 | `		/* Perform the insertion */` |
|     3687 | 11717 | `		ph7_array_add_elem(pArray,0/* Automatic index assign*/,pWorker); /* Will make it's own copy */` |
|        1 | 11718 | `	}` |
...
|        - | 11746 | ` */` |
|     7666 | 11747 | `static int vm_builtin_include(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|        2 | 11748 |  |
|        - | 11749 | `	SyString sFile;` |
|        - | 11750 | `	sxi32 rc;` |
|     7668 | 11751 | `	if( nArg < 1 ){` |
|        - | 11752 | `		/* Nothing to evaluate,return NULL */` |
|      ! 0 | 11753 | `		ph7_result_null(pCtx);` |
|      ! 0 | 11754 | `		return SXRET_OK;` |
|        - | 11755 | `	}` |
|        - | 11756 | `	/* File to include */` |
|     7668 | 11757 | `	sFile.zString = ph7_value_to_string(apArg[0],(int *)&sFile.nByte);` |
|     7668 | 11758 | `	if( sFile.nByte < 1 ){` |
...
|     7668 | 11764 | `	rc = VmExecIncludedFile(&(*pCtx),&sFile,FALSE);` |
|     7668 | 11765 | `	if( rc != SXRET_OK ){` |
...
|        - | 12287 | ` */` |
|     2602 | 12288 | `static sxi32 VmRegisterSpecialFunction(ph7_vm *pVm)` |
|        2 | 12289 |  |
|        - | 12290 | `	sxi32 rc;` |
|        - | 12291 | `	sxu32 n;` |
|   335660 | 12292 | `	for( n = 0 ; n < SX_ARRAYSIZE(aVmFunc) ; ++n ){` |
|        - | 12293 | `		/* Note that these special functions have access` |
|        - | 12294 | `		 * to the underlying virtual machine as their` |
|        - | 12295 | `		 * private data.` |
|        - | 12296 | `		 */` |
|   333058 | 12297 | `		rc = ph7_create_function(&(*pVm),aVmFunc[n].zName,aVmFunc[n].xFunc,&(*pVm));` |
|   333058 | 12298 | `		if( rc != SXRET_OK ){` |
|      ! 0 | 12299 | `			return rc;` |
|        - | 12300 | `		}` |
|   166530 | 12301 | `	}` |
|     2604 | 12302 | `	return SXRET_OK;` |
|     1303 | 12303 |  |
|        - | 12304 | `/*` |
...
|        - | 12308 | ` */` |
|    30206 | 12309 | `static ph7_class * VmFilterLoadableClass(ph7_class *pClass,sxi32 iLoadable)` |
|        2 | 12310 |  |
|    30208 | 12311 | `	if( !iLoadable ){` |
|    29010 | 12312 | `		return pClass;` |
|        - | 12313 | `	}` |
|     1200 | 12314 | `	while(pClass){` |
|     1200 | 12315 | `		if( (pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_ABSTRACT\|PH7_CLASS_TRAIT)) == 0 ){` |
|     1200 | 12316 | `			return pClass;` |
|        - | 12317 | `		}` |
...
|        - | 12389 | ` */` |
|    30210 | 12390 | `PH7_PRIVATE ph7_class * PH7_VmExtractClass(` |
...
|    30212 | 12406 | `	pEntry = SyHashGet(&pVm->hClass,(const void *)zName,nByte);` |
|    30212 | 12407 | `	if( pEntry == 0 ){` |
...
|        - | 12410 | `	}` |
|    30200 | 12411 | `	pClass = (ph7_class *)pEntry->pUserData;` |
|    30200 | 12412 | `	return VmFilterLoadableClass(pClass,iLoadable);` |
|    15107 | 12413 |  |
|        - | 12414 | `/*` |
...
|        - | 12427 | ` */` |
|  3034770 | 12428 | `static VmRefObj * VmNewRefObj(ph7_vm *pVm,sxu32 nIdx)` |
|        2 | 12429 |  |
|        - | 12430 | `	VmRefObj *pRef;` |
|        - | 12431 | `	/* Allocate a new instance */` |
|  3034772 | 12432 | `	pRef = (VmRefObj *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(VmRefObj));` |
|  3034772 | 12433 | `	if( pRef == 0 ){` |
|      ! 0 | 12434 | `		return 0;` |
|        - | 12435 | `	}` |
|        - | 12436 | `	/* Zero the structure */` |
|  3034772 | 12437 | `	SyZero(pRef,sizeof(VmRefObj));` |
|        - | 12438 | `	/* Initialize fields */` |
|  3034772 | 12439 | `	SySetInit(&pRef->aReference,&pVm->sAllocator,sizeof(SyHashEntry *));` |
|  3034772 | 12440 | `	SySetInit(&pRef->aArrEntries,&pVm->sAllocator,sizeof(ph7_hashmap_node *));` |
|  3034772 | 12441 | `	pRef->nIdx = nIdx;` |
|  3034772 | 12442 | `	return pRef;` |
|  1517387 | 12443 |  |
|        - | 12444 | `/*` |
|        - | 12445 | ` * Default hash function used by the reference table` |
|        - | 12446 | ` * for lookup/insertion operations.` |
|        - | 12447 | ` */` |
| 16793424 | 12448 | `static sxu32 VmRefHash(sxu32 nIdx)` |
|        2 | 12449 |  |
|        - | 12450 | `	/* Calculate the hash based on the memory object index */` |
| 16793426 | 12451 | `	return nIdx ^ (nIdx << 8) ^ (nIdx >> 8);` |
|        2 | 12452 |  |
|        - | 12453 | `/*` |
...
|        - | 12463 | ` * extension.` |
|        - | 12464 | ` */` |
|  9053650 | 12465 | `static VmRefObj * VmRefObjExtract(ph7_vm *pVm,sxu32 nObjIdx)` |
|        2 | 12466 |  |
|        - | 12467 | `	VmRefObj *pRef;` |
|        - | 12468 | `	sxu32 nBucket;` |
|        - | 12469 | `	/* Point to the appropriate bucket */` |
|  9053652 | 12470 | `	nBucket = VmRefHash(nObjIdx) & (pVm->nRefSize - 1);` |
|        - | 12471 | `	/* Perform the lookup */` |
|  9053652 | 12472 | `	pRef = pVm->apRefObj[nBucket];` |
| 19464676 | 12473 | `	for(;;){` |
| 38919322 | 12474 | `		if( pRef == 0 ){` |
|  3115260 | 12475 | `			break;` |
|        - | 12476 | `		}` |
| 35804064 | 12477 | `		if( pRef->nIdx == nObjIdx ){` |
|        - | 12478 | `			/* Entry found */` |
|  5938394 | 12479 | `			return pRef;` |
|        - | 12480 | `		}` |
|        - | 12481 | `		/* Point to the next entry */` |
| 29865672 | 12482 | `		pRef = pRef->pNextCollide;` |
|        2 | 12483 | `	}` |
|        - | 12484 | `	/* No such entry,return NULL */` |
|  3115260 | 12485 | `	return 0;` |
|  4526827 | 12486 |  |
|        - | 12487 | `/*` |
...
|        - | 12495 | ` * extension.` |
|        - | 12496 | ` */` |
|  3034770 | 12497 | `static sxi32 VmRefObjInsert(ph7_vm *pVm,VmRefObj *pRef)` |
|        2 | 12498 |  |
|        - | 12499 | `	sxu32 nBucket;` |
|  3034772 | 12500 | `	if( pVm->nRefUsed * 3 >= pVm->nRefSize ){` |
|        - | 12501 | `		VmRefObj **apNew;` |
|        - | 12502 | `		sxu32 nNew;` |
|        - | 12503 | `		/* Allocate a larger table */` |
|     4424 | 12504 | `		nNew = pVm->nRefSize << 1;` |
|     4424 | 12505 | `		apNew = (VmRefObj **)SyMemBackendAlloc(&pVm->sAllocator,sizeof(VmRefObj *) * nNew);` |
|     4424 | 12506 | `		if( apNew ){` |
|     4424 | 12507 | `			VmRefObj *pEntry = pVm->pRefList;` |
|        - | 12508 | `			sxu32 n;` |
|        - | 12509 | `			/* Zero the structure */` |
|     4424 | 12510 | `			SyZero((void *)apNew,nNew * sizeof(VmRefObj *));` |
|        - | 12511 | `			/* Rehash all referenced entries */` |
|  2844786 | 12512 | `			for( n = 0 ; n < pVm->nRefUsed ; ++n ){` |
|        - | 12513 | `				/* Remove old collision links */` |
|  2840364 | 12514 | `				pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|        - | 12515 | `				/* Point to the appropriate bucket */` |
|  2840364 | 12516 | `				nBucket = VmRefHash(pEntry->nIdx) & (nNew - 1);` |
|        - | 12517 | `				/* Insert the entry  */` |
|  2840364 | 12518 | `				pEntry->pNextCollide = apNew[nBucket];` |
|  2840364 | 12519 | `				if( apNew[nBucket] ){` |
|  2298896 | 12520 | `					apNew[nBucket]->pPrevCollide = pEntry;` |
|  1149447 | 12521 | `				}` |
|  2840364 | 12522 | `				apNew[nBucket] = pEntry;` |
|        - | 12523 | `				/* Point to the next entry */` |
|  2840364 | 12524 | `				pEntry = pEntry->pNext;` |
|  1420183 | 12525 | `			}` |
|        - | 12526 | `			/* Release the old table */` |
|     4424 | 12527 | `			SyMemBackendFree(&pVm->sAllocator,pVm->apRefObj);` |
|        - | 12528 | `			/* Install the new one */` |
|     4424 | 12529 | `			pVm->apRefObj = apNew;` |
|     4424 | 12530 | `			pVm->nRefSize = nNew;` |
|     2211 | 12531 | `		}` |
|     2211 | 12532 | `	}` |
|        - | 12533 | `	/* Point to the appropriate bucket */` |
|  3034772 | 12534 | `	nBucket = VmRefHash(pRef->nIdx) & (pVm->nRefSize - 1);` |
|        - | 12535 | `	/* Insert the entry */` |
|  3034772 | 12536 | `	pRef->pNextCollide = pVm->apRefObj[nBucket];` |
|  3034772 | 12537 | `	if( pVm->apRefObj[nBucket] ){` |
|  2516701 | 12538 | `		pVm->apRefObj[nBucket]->pPrevCollide = pRef;` |
|  1258351 | 12539 | `	}` |
|  3034772 | 12540 | `	pVm->apRefObj[nBucket] = pRef;` |
|  3034772 | 12541 | `	MACRO_LD_PUSH(pVm->pRefList,pRef);` |
|  3034772 | 12542 | `	pVm->nRefUsed++;` |
|  3034772 | 12543 | `	return SXRET_OK;` |
|        2 | 12544 |  |
|        - | 12545 | `/*` |
...
|        - | 12555 | ` * extension.` |
|        - | 12556 | ` */` |
|  2997802 | 12557 | `static sxi32 VmRefObjUnlink(ph7_vm *pVm,VmRefObj *pRef)` |
|        2 | 12558 |  |
|        - | 12559 | `	ph7_hashmap_node **apNode;` |
|        - | 12560 | `	SyHashEntry **apEntry;` |
|        - | 12561 | `	sxu32 n;` |
|        - | 12562 | `	/* Point to the reference table */` |
|  2997804 | 12563 | `	apNode = (ph7_hashmap_node **)SySetBasePtr(&pRef->aArrEntries);` |
|  2997804 | 12564 | `	apEntry = (SyHashEntry **)SySetBasePtr(&pRef->aReference);` |
|        - | 12565 | `	/* Unlink the entry from the reference table */` |
|  3084192 | 12566 | `	for( n = 0 ; n < SySetUsed(&pRef->aReference) ; n++ ){` |
|    86390 | 12567 | `		if( apEntry[n] ){` |
|    86340 | 12568 | `			SyHashDeleteEntry2(apEntry[n]);` |
|    43169 | 12569 | `		}` |
|    43196 | 12570 | `	}` |
|  5911920 | 12571 | `	for(n = 0 ; n < SySetUsed(&pRef->aArrEntries) ; ++n ){` |
|  2914118 | 12572 | `		if( apNode[n] ){` |
|     6828 | 12573 | `			PH7_HashmapUnlinkNode(apNode[n],FALSE);` |
|     3413 | 12574 | `		}` |
|  1457060 | 12575 | `	}` |
|  2997804 | 12576 | `	if( pRef->pPrevCollide ){` |
|  1133162 | 12577 | `		pRef->pPrevCollide->pNextCollide = pRef->pNextCollide;` |
|   566952 | 12578 | `	}else{` |
|  1864644 | 12579 | `		pVm->apRefObj[VmRefHash(pRef->nIdx) & (pVm->nRefSize - 1)] = pRef->pNextCollide;` |
|        - | 12580 | `	}` |
|  2997804 | 12581 | `	if( pRef->pNextCollide ){` |
|  1705036 | 12582 | `		pRef->pNextCollide->pPrevCollide = pRef->pPrevCollide;` |
|   852500 | 12583 | `	}` |
|  2997804 | 12584 | `	MACRO_LD_REMOVE(pVm->pRefList,pRef);` |
|        - | 12585 | `	/* Release the node */` |
|  2997804 | 12586 | `	SySetRelease(&pRef->aReference);` |
|  2997804 | 12587 | `	SySetRelease(&pRef->aArrEntries);` |
|  2997804 | 12588 | `	SyMemBackendPoolFree(&pVm->sAllocator,pRef);` |
|  2997804 | 12589 | `	pVm->nRefUsed--;` |
|  2997804 | 12590 | `	return SXRET_OK;` |
|        2 | 12591 |  |
|        - | 12592 | `/*` |
...
|        - | 12599 | ` * extension.` |
|        - | 12600 | ` */` |
|  3068008 | 12601 | `PH7_PRIVATE sxi32 PH7_VmRefObjInstall(` |
...
|        - | 12607 | `	)` |
|        2 | 12608 |  |
|  3068010 | 12609 | `	VmFrame *pFrame = pVm->pFrame;` |
|        - | 12610 | `	VmRefObj *pRef;` |
|        - | 12611 | `	/* Check if the referenced object already exists */` |
|  3068010 | 12612 | `	pRef = VmRefObjExtract(&(*pVm),nIdx);` |
|  3068010 | 12613 | `	if( pRef == 0 ){` |
|        - | 12614 | `		/* Create a new entry */` |
|  3034772 | 12615 | `		pRef = VmNewRefObj(&(*pVm),nIdx);` |
|  3034772 | 12616 | `		if( pRef == 0 ){` |
|      ! 0 | 12617 | `			return SXERR_MEM;` |
|        - | 12618 | `		}` |
|  3034772 | 12619 | `		pRef->iFlags = iFlags;` |
|        - | 12620 | `		/* Install the entry */` |
|  3034772 | 12621 | `		VmRefObjInsert(&(*pVm),pRef);` |
|  1517385 | 12622 | `	}` |
|  3068010 | 12623 | `	pFrame = VmSkipExceptionFrames(pFrame);` |
|  3068010 | 12624 | `	if( pFrame->pParent != 0 && pEntry ){` |
|        - | 12625 | `		VmSlot sRef;` |
|        - | 12626 | `		/* Local frame,record referenced entry so that it can` |
|        - | 12627 | `		 * be deleted when we leave this frame.` |
|        - | 12628 | `		 */` |
|    80574 | 12629 | `		sRef.nIdx = nIdx;` |
|    80574 | 12630 | `		sRef.pUserData = pEntry;` |
|    80574 | 12631 | `		if( SXRET_OK != SySetPut(&pFrame->sRef,(const void *)&sRef)) {` |
|      ! 0 | 12632 | `			pEntry = 0; /* Do not record this entry */` |
|      ! 0 | 12633 | `		}` |
|    40286 | 12634 | `	}` |
|  3068010 | 12635 | `	if( pEntry ){` |
|        - | 12636 | `		/* Address of the hash-entry */` |
|   113620 | 12637 | `		SySetPut(&pRef->aReference,(const void *)&pEntry);` |
|    56809 | 12638 | `	}` |
|  3068010 | 12639 | `	if( pMapEntry ){` |
|        - | 12640 | `		/* Address of the hashmap node [i.e: Array entry] */` |
|  2949394 | 12641 | `		SySetPut(&pRef->aArrEntries,(const void *)&pMapEntry);` |
|  1474696 | 12642 | `	}` |
|  3068010 | 12643 | `	return SXRET_OK;` |
|  1534006 | 12644 |  |
|        - | 12645 | `/*` |
...
|        - | 12652 | ` * extension.` |
|        - | 12653 | ` */` |
|  2987834 | 12654 | `PH7_PRIVATE sxi32 PH7_VmRefObjRemove(` |
...
|  2987836 | 12664 | `	pRef = VmRefObjExtract(&(*pVm),nIdx);` |
|  2987836 | 12665 | `	if( pRef == 0 ){` |
|        - | 12666 | `		/* Not such entry */` |
|    80484 | 12667 | `		return SXERR_NOTFOUND;` |
|        - | 12668 | `	}` |
|        - | 12669 | `	/* Remove the desired entry */` |
|  2907354 | 12670 | `	if( pEntry ){` |
...
|       79 | 12683 | `		}` |
|       27 | 12684 | `	}` |
|  2907354 | 12685 | `	if( pMapEntry ){` |
|        - | 12686 | `		ph7_hashmap_node **apNode;` |
|  2907300 | 12687 | `		apNode = (ph7_hashmap_node **)SySetBasePtr(&pRef->aArrEntries);` |
|  5814692 | 12688 | `		for(n = 0 ; n < SySetUsed(&pRef->aArrEntries) ; n++ ){` |
|  2907394 | 12689 | `			if( apNode[n] == pMapEntry ){` |
|        - | 12690 | `				/* nullify the entry */` |
|  2907300 | 12691 | `				apNode[n] = 0;` |
|  1453649 | 12692 | `			}` |
|  1453698 | 12693 | `		}` |
|  1453649 | 12694 | `	}` |
|  2907354 | 12695 | `	return SXRET_OK;` |
|  1493919 | 12696 |  |
...
|        - | 12705 | ` */` |
|    23908 | 12706 | `PH7_PRIVATE const ph7_io_stream * PH7_VmGetStreamDevice(` |
...
|    23910 | 12718 | `	zNext = zCur = zIn = *pzDevice;` |
|    23910 | 12719 | `	zEnd = &zIn[nByte];` |
|  1528125 | 12720 | `	while( zIn < zEnd ){` |
|  1504219 | 12721 | `		if( zIn < &zEnd[-3]/*://*/ && zIn[0] == ':' && zIn[1] == '/' && zIn[2] == '/' ){` |
|        - | 12722 | `			/* Got one */` |
...
|  1504217 | 12727 | `		zIn++;` |
|        2 | 12728 | `	}` |
|    23910 | 12729 | `	if( zIn >= zEnd ){` |
|        - | 12730 | `		/* No such scheme,return the default stream */` |
|    23908 | 12731 | `		return pVm->pDefStream;` |
|        - | 12732 | `	}` |
