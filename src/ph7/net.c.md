...
|    - |  154 | ` */` |
|   69 |  155 | `PH7_PRIVATE ph7_socket PH7_NetAccept(ph7_socket listenSock, struct sockaddr *pAddr, ph7_socklen *pAddrLen)` |
|  ! 0 |  156 | `{` |
|   69 |  157 | `	return accept(listenSock, pAddr, pAddrLen);` |
|  ! 0 |  158 | `}` |
|    - |  159 | `/*` |
|    - |  160 | ` * Receive data from a socket.` |
|    - |  161 | ` * Returns the number of bytes received, or -1 on error.` |
|    - |  162 | ` */` |
|   48 |  163 | `PH7_PRIVATE int PH7_NetRecv(ph7_socket sock, void *pBuf, int nLen, int flags)` |
|  ! 0 |  164 | `{` |
|   48 |  165 | `	return (int)recv(sock, (char *)pBuf, nLen, flags);` |
|  ! 0 |  166 | `}` |
|    - |  167 | `/*` |
