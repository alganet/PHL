...
|    - |   35 | ` */` |
|    6 |   36 | `PH7_PRIVATE int PH7_NetInit(void)` |
|  ! 0 |   37 |  |
|    - |   38 | `#ifdef __WINNT__` |
|    - |   39 | `	WSADATA wsaData;` |
...
|    - |   50 | ` */` |
|    6 |   51 | `PH7_PRIVATE void PH7_NetCleanup(void)` |
|  ! 0 |   52 |  |
|    - |   53 | `#ifdef __WINNT__` |
|  ! 0 |   54 | `	WSACleanup();` |
|    - |   55 | `#endif` |
...
|    - |   60 | ` */` |
|    6 |   61 | `PH7_PRIVATE ph7_socket PH7_NetListen(const char *zHost, int iPort, int iBacklog)` |
|  ! 0 |   62 |  |
|    - |   63 | `	struct sockaddr_in addr;` |
|    - |   64 | `	ph7_socket sock;` |
|    6 |   65 | `	int on = 1;` |
|    6 |   66 | `	memset(&addr, 0, sizeof(addr));` |
|    6 |   67 | `	addr.sin_family = AF_INET;` |
|    6 |   68 | `	addr.sin_port = htons((unsigned short)iPort);` |
|    6 |   69 | `	if( zHost == 0 \|\| zHost[0] == 0 \|\| strcmp(zHost, "0.0.0.0") == 0 ){` |
|  ! 0 |   70 | `		addr.sin_addr.s_addr = htonl(INADDR_ANY);` |
|    6 |   71 | `	}else if( strcmp(zHost, "localhost") == 0 \|\| strcmp(zHost, "127.0.0.1") == 0 ){` |
|    6 |   72 | `		addr.sin_addr.s_addr = htonl(INADDR_LOOPBACK);` |
|    3 |   73 | `	}else{` |
...
|    - |   83 | `	}` |
|    6 |   84 | `	sock = socket(AF_INET, SOCK_STREAM, 0);` |
|    6 |   85 | `	if( sock == PH7_NET_INVALID_SOCKET ){` |
|  ! 0 |   86 | `		return PH7_NET_INVALID_SOCKET;` |
|    - |   87 | `	}` |
|    6 |   88 | `	setsockopt(sock, SOL_SOCKET, SO_REUSEADDR, (const char *)&on, sizeof(on));` |
|    6 |   89 | `	if( bind(sock, (struct sockaddr *)&addr, sizeof(addr)) != 0 ){` |
|  ! 0 |   90 | `		PH7_NetClose(sock);` |
|  ! 0 |   91 | `		return PH7_NET_INVALID_SOCKET;` |
|    - |   92 | `	}` |
|    6 |   93 | `	if( listen(sock, iBacklog) != 0 ){` |
...
|    - |  103 | ` */` |
|   14 |  104 | `PH7_PRIVATE ph7_socket PH7_NetAccept(ph7_socket listenSock, struct sockaddr *pAddr, ph7_socklen *pAddrLen)` |
|  ! 0 |  105 |  |
|   14 |  106 | `	return accept(listenSock, pAddr, pAddrLen);` |
|  ! 0 |  107 |  |
|    - |  108 | `/*` |
|    - |  109 | ` * Receive data from a socket.` |
|    - |  110 | ` * Returns the number of bytes received, or -1 on error.` |
|    - |  111 | ` */` |
|    8 |  112 | `PH7_PRIVATE int PH7_NetRecv(ph7_socket sock, void *pBuf, int nLen, int flags)` |
|  ! 0 |  113 |  |
|    8 |  114 | `	return (int)recv(sock, (char *)pBuf, nLen, flags);` |
|  ! 0 |  115 |  |
|    - |  116 | `/*` |
...
|    - |  127 | ` */` |
|   16 |  128 | `PH7_PRIVATE int PH7_NetSendAll(ph7_socket sock, const void *pBuf, int nLen)` |
|  ! 0 |  129 |  |
|   16 |  130 | `	const char *zBuf = (const char *)pBuf;` |
|    - |  131 | `	int nSent;` |
|   32 |  132 | `	while( nLen > 0 ){` |
|   16 |  133 | `		nSent = (int)send(sock, zBuf, nLen, 0);` |
|   16 |  134 | `		if( nSent <= 0 ){` |
...
|    - |  143 | ` * Close a socket.` |
|    - |  144 | ` */` |
|   14 |  145 | `PH7_PRIVATE void PH7_NetClose(ph7_socket sock)` |
|  ! 0 |  146 |  |
|   14 |  147 | `	if( sock == PH7_NET_INVALID_SOCKET ){` |
|  ! 0 |  148 | `		return;` |
|    - |  149 | `	}` |
|    - |  150 | `#ifdef __WINNT__` |
...
|    - |  158 | ` */` |
|    8 |  159 | `PH7_PRIVATE void PH7_NetSetTimeout(ph7_socket sock, int iMilliseconds)` |
|  ! 0 |  160 |  |
|    - |  161 | `#ifdef __WINNT__` |
...
|    8 |  166 | `	tv.tv_sec = iMilliseconds / 1000;` |
|    8 |  167 | `	tv.tv_usec = (iMilliseconds % 1000) * 1000;` |
|    8 |  168 | `	setsockopt(sock, SOL_SOCKET, SO_RCVTIMEO, (const void *)&tv, sizeof(tv));` |
|    - |  169 | `#endif` |
|    8 |  170 |  |
|    - |  171 | `/*` |
...
|    - |  174 | ` */` |
|    8 |  175 | `PH7_PRIVATE void PH7_NetAddrToString(const struct sockaddr *pAddr, char *zBuf, int nBufLen)` |
|  ! 0 |  176 |  |
|    8 |  177 | `	const struct sockaddr_in *pIn = (const struct sockaddr_in *)pAddr;` |
|    8 |  178 | `	if( pAddr == 0 \|\| pAddr->sa_family != AF_INET ){` |
|  ! 0 |  179 | `		if( nBufLen > 0 ){` |
|  ! 0 |  180 | `			zBuf[0] = 0;` |
|  ! 0 |  181 | `		}` |
|  ! 0 |  182 | `		return;` |
...
|    - |  195 | `	}` |
|    - |  196 | `#else` |
|    8 |  197 | `	inet_ntop(AF_INET, &pIn->sin_addr, zBuf, (ph7_socklen)nBufLen);` |
|    - |  198 | `#endif` |
|    4 |  199 |  |
|    - |  200 | `/*` |
|    - |  201 | ` * Extract the port number from a sockaddr (in host byte order).` |
|    - |  202 | ` */` |
|    8 |  203 | `PH7_PRIVATE int PH7_NetAddrPort(const struct sockaddr *pAddr)` |
|  ! 0 |  204 |  |
|    8 |  205 | `	const struct sockaddr_in *pIn = (const struct sockaddr_in *)pAddr;` |
|    8 |  206 | `	if( pAddr == 0 \|\| pAddr->sa_family != AF_INET ){` |
|  ! 0 |  207 | `		return 0;` |
|    - |  208 | `	}` |
|    8 |  209 | `	return (int)ntohs(pIn->sin_port);` |
|    4 |  210 |  |
|    - |  211 |  |
