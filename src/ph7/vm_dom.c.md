...
|      - | 1270 | ` */` |
|   3868 | 1271 | `PH7_PRIVATE sxi32 PH7_VmInstallDom(ph7_vm *pVm)` |
|      5 | 1272 | `{` |
...
|      - | 1316 | `	sxu32 n;` |
|      - | 1317 | `	sxi32 rc;` |
| 150857 | 1318 | `	for( n = 0 ; n < sizeof(aFunc)/sizeof(aFunc[0]) ; n++ ){` |
| 146989 | 1319 | `		ph7_create_function(&(*pVm),aFunc[n].zName,aFunc[n].xFunc,0);` |
|  73497 | 1320 | `	}` |
|   3873 | 1321 | `	rc = PH7_VmEvalBuiltinChunk(&(*pVm),zDomLib1,sizeof(zDomLib1)-1);` |
|   3873 | 1322 | `	if( rc == SXRET_OK ){` |
|   3873 | 1323 | `		rc = PH7_VmEvalBuiltinChunk(&(*pVm),zDomLib2,sizeof(zDomLib2)-1);` |
|   1934 | 1324 | `	}` |
|   3873 | 1325 | `	if( rc == SXRET_OK ){` |
|   3873 | 1326 | `		rc = PH7_VmEvalBuiltinChunk(&(*pVm),zDomLib3,sizeof(zDomLib3)-1);` |
|   1934 | 1327 | `	}` |
|   3873 | 1328 | `	return rc;` |
|      5 | 1329 | `}` |
|      - | 1330 |  |
