...
|      - | 1270 | ` */` |
|   3862 | 1271 | `PH7_PRIVATE sxi32 PH7_VmInstallDom(ph7_vm *pVm)` |
|      5 | 1272 | `{` |
...
|      - | 1316 | `	sxu32 n;` |
|      - | 1317 | `	sxi32 rc;` |
| 150623 | 1318 | `	for( n = 0 ; n < sizeof(aFunc)/sizeof(aFunc[0]) ; n++ ){` |
| 146761 | 1319 | `		ph7_create_function(&(*pVm),aFunc[n].zName,aFunc[n].xFunc,0);` |
|  73383 | 1320 | `	}` |
|   3867 | 1321 | `	rc = PH7_VmEvalBuiltinChunk(&(*pVm),zDomLib1,sizeof(zDomLib1)-1);` |
|   3867 | 1322 | `	if( rc == SXRET_OK ){` |
|   3867 | 1323 | `		rc = PH7_VmEvalBuiltinChunk(&(*pVm),zDomLib2,sizeof(zDomLib2)-1);` |
|   1931 | 1324 | `	}` |
|   3867 | 1325 | `	if( rc == SXRET_OK ){` |
|   3867 | 1326 | `		rc = PH7_VmEvalBuiltinChunk(&(*pVm),zDomLib3,sizeof(zDomLib3)-1);` |
|   1931 | 1327 | `	}` |
|   3867 | 1328 | `	return rc;` |
|      5 | 1329 | `}` |
|      - | 1330 |  |
