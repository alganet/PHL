...
|      - | 1270 | ` */` |
|   3878 | 1271 | `PH7_PRIVATE sxi32 PH7_VmInstallDom(ph7_vm *pVm)` |
|      5 | 1272 | `{` |
...
|      - | 1316 | `	sxu32 n;` |
|      - | 1317 | `	sxi32 rc;` |
| 151247 | 1318 | `	for( n = 0 ; n < sizeof(aFunc)/sizeof(aFunc[0]) ; n++ ){` |
| 147369 | 1319 | `		ph7_create_function(&(*pVm),aFunc[n].zName,aFunc[n].xFunc,0);` |
|  73687 | 1320 | `	}` |
|   3883 | 1321 | `	rc = PH7_VmEvalBuiltinChunk(&(*pVm),zDomLib1,sizeof(zDomLib1)-1);` |
|   3883 | 1322 | `	if( rc == SXRET_OK ){` |
|   3883 | 1323 | `		rc = PH7_VmEvalBuiltinChunk(&(*pVm),zDomLib2,sizeof(zDomLib2)-1);` |
|   1939 | 1324 | `	}` |
|   3883 | 1325 | `	if( rc == SXRET_OK ){` |
|   3883 | 1326 | `		rc = PH7_VmEvalBuiltinChunk(&(*pVm),zDomLib3,sizeof(zDomLib3)-1);` |
|   1939 | 1327 | `	}` |
|   3883 | 1328 | `	return rc;` |
|      5 | 1329 | `}` |
|      - | 1330 |  |
