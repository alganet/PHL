...
|      - |   35 | `**   changed.` |
|      - |   36 | `*/` |
|  52144 |   37 | `static ph7_hashmap_node * HashmapNodeMerge(ph7_hashmap_node *pA,ph7_hashmap_node *pB,ProcNodeCmp xCmp,void *pCmpData)` |
|      5 |   38 | `{` |
|      - |   39 | `	ph7_hashmap_node result,*pTail;` |
|      - |   40 | `    /* Prevent compiler warning */` |
|  52149 |   41 | `	result.pNext = result.pPrev = 0;` |
|  52149 |   42 | `	pTail = &result;` |
| 129840 |   43 | `	while( pA && pB ){` |
|  77696 |   44 | `		if( xCmp(pA,pB,pCmpData) <= 0 ){` |
|  60970 |   45 | `			pTail->pPrev = pA;` |
|  60970 |   46 | `			pA->pNext = pTail;` |
|  60970 |   47 | `			pTail = pA;` |
|  60970 |   48 | `			pA = pA->pPrev;` |
|  30652 |   49 | `		}else{` |
|  16731 |   50 | `			pTail->pPrev = pB;` |
|  16731 |   51 | `			pB->pNext = pTail;` |
|  16731 |   52 | `			pTail = pB;` |
|  16731 |   53 | `			pB = pB->pPrev;` |
|      - |   54 | `		}` |
|      5 |   55 | `	}` |
|  52149 |   56 | `	if( pA ){` |
...
|  23894 |   62 | `	}else{` |
|    315 |   63 | `		pTail->pPrev = pTail->pNext = 0;` |
|      - |   64 | `	}` |
|  52149 |   65 | `	return result.pPrev;` |
|      5 |   66 | `}` |
|      - |   67 | `/*` |
|      - |   68 | `** Inputs:` |
...
|  16747 |   89 | `		p->pPrev = 0;` |
|  31133 |   90 | `		for(i=0; i<N_SORT_BUCKET-1; i++){` |
|  31133 |   91 | `			if( a[i]==0 ){` |
|  16747 |   92 | `				a[i] = p;` |
|  16747 |   93 | `				break;` |
|    ! 0 |   94 | `			}else{` |
|  14391 |   95 | `				p = HashmapNodeMerge(a[i],p,xCmp,pCmpData);` |
|  14391 |   96 | `				a[i] = 0;` |
|      - |   97 | `			}` |
|   7198 |   98 | `		}` |
...
|    127 |  217 | `	return rc;` |
|     64 |  218 | `}` |
|  77316 |  219 | `static sxi32 HashmapCmpCallback1(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|      5 |  220 | `{` |
|  77321 |  221 | `	if( pCmpData == 0 ){` |
|      - |  222 | `		/* SORT_REGULAR fast path */` |
|  77233 |  223 | `		return HashmapNodeCmp(pA,pB,FALSE);` |
|      - |  224 | `	}` |
