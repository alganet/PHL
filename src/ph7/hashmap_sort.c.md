...
|  61046 |   45 | `			pTail->pPrev = pA;` |
|  61046 |   46 | `			pA->pNext = pTail;` |
|  61046 |   47 | `			pTail = pA;` |
|  61046 |   48 | `			pA = pA->pPrev;` |
|  30673 |   49 | `		}else{` |
|  16757 |   50 | `			pTail->pPrev = pB;` |
|  16757 |   51 | `			pB->pNext = pTail;` |
|  16757 |   52 | `			pTail = pB;` |
|  16757 |   53 | `			pB = pB->pPrev;` |
|      - |   54 | `		}` |
|      5 |   55 | `	}` |
|  52181 |   56 | `	if( pA ){` |
...
|    127 |  217 | `	return rc;` |
|     64 |  218 | `}` |
|  77418 |  219 | `static sxi32 HashmapCmpCallback1(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|      5 |  220 | `{` |
|  77423 |  221 | `	if( pCmpData == 0 ){` |
|      - |  222 | `		/* SORT_REGULAR fast path */` |
|  77335 |  223 | `		return HashmapNodeCmp(pA,pB,FALSE);` |
|      - |  224 | `	}` |
