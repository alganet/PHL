...
|  61042 |   45 | `			pTail->pPrev = pA;` |
|  61042 |   46 | `			pA->pNext = pTail;` |
|  61042 |   47 | `			pTail = pA;` |
|  61042 |   48 | `			pA = pA->pPrev;` |
|  30669 |   49 | `		}else{` |
|  16758 |   50 | `			pTail->pPrev = pB;` |
|  16758 |   51 | `			pB->pNext = pTail;` |
|  16758 |   52 | `			pTail = pB;` |
|  16758 |   53 | `			pB = pB->pPrev;` |
|      - |   54 | `		}` |
|      5 |   55 | `	}` |
|  52181 |   56 | `	if( pA ){` |
|   4330 |   57 | `		pTail->pPrev = pA;` |
|   4330 |   58 | `		pA->pNext = pTail;` |
|  49882 |   59 | `	}else if( pB ){` |
|  47544 |   60 | `		pTail->pPrev = pB;` |
|  47544 |   61 | `		pB->pNext = pTail;` |
|  23911 |   62 | `	}else{` |
...
|    127 |  217 | `	return rc;` |
|     64 |  218 | `}` |
|  77416 |  219 | `static sxi32 HashmapCmpCallback1(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|      5 |  220 | `{` |
|  77421 |  221 | `	if( pCmpData == 0 ){` |
|      - |  222 | `		/* SORT_REGULAR fast path */` |
|  77333 |  223 | `		return HashmapNodeCmp(pA,pB,FALSE);` |
|      - |  224 | `	}` |
