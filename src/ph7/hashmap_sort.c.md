...
| 129876 |   43 | `	while( pA && pB ){` |
|  77728 |   44 | `		if( xCmp(pA,pB,pCmpData) <= 0 ){` |
|  60983 |   45 | `			pTail->pPrev = pA;` |
|  60983 |   46 | `			pA->pNext = pTail;` |
|  60983 |   47 | `			pTail = pA;` |
|  60983 |   48 | `			pA = pA->pPrev;` |
|  30655 |   49 | `		}else{` |
...
|      5 |   55 | `	}` |
|  52153 |   56 | `	if( pA ){` |
|   4350 |   57 | `		pTail->pPrev = pA;` |
|   4350 |   58 | `		pA->pNext = pTail;` |
|  49840 |   59 | `	}else if( pB ){` |
|  47502 |   60 | `		pTail->pPrev = pB;` |
|  47502 |   61 | `		pB->pNext = pTail;` |
|  23894 |   62 | `	}else{` |
...
|    127 |  217 | `	return rc;` |
|     64 |  218 | `}` |
|  77348 |  219 | `static sxi32 HashmapCmpCallback1(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|      5 |  220 | `{` |
|  77353 |  221 | `	if( pCmpData == 0 ){` |
|      - |  222 | `		/* SORT_REGULAR fast path */` |
|  77265 |  223 | `		return HashmapNodeCmp(pA,pB,FALSE);` |
|      - |  224 | `	}` |
