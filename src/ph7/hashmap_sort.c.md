...
|      - |   35 | `**   changed.` |
|      - |   36 | `*/` |
|  52166 |   37 | `static ph7_hashmap_node * HashmapNodeMerge(ph7_hashmap_node *pA,ph7_hashmap_node *pB,ProcNodeCmp xCmp,void *pCmpData)` |
|      5 |   38 | `{` |
|      - |   39 | `	ph7_hashmap_node result,*pTail;` |
|      - |   40 | `    /* Prevent compiler warning */` |
|  52171 |   41 | `	result.pNext = result.pPrev = 0;` |
|  52171 |   42 | `	pTail = &result;` |
| 130156 |   43 | `	while( pA && pB ){` |
|  77990 |   44 | `		if( xCmp(pA,pB,pCmpData) <= 0 ){` |
|  61149 |   45 | `			pTail->pPrev = pA;` |
|  61149 |   46 | `			pA->pNext = pTail;` |
|  61149 |   47 | `			pTail = pA;` |
|  61149 |   48 | `			pA = pA->pPrev;` |
|  30724 |   49 | `		}else{` |
|  16846 |   50 | `			pTail->pPrev = pB;` |
|  16846 |   51 | `			pB->pNext = pTail;` |
|  16846 |   52 | `			pTail = pB;` |
|  16846 |   53 | `			pB = pB->pPrev;` |
|      - |   54 | `		}` |
|      5 |   55 | `	}` |
|  52171 |   56 | `	if( pA ){` |
|   4361 |   57 | `		pTail->pPrev = pA;` |
|   4361 |   58 | `		pA->pNext = pTail;` |
|  49857 |   59 | `	}else if( pB ){` |
|  47485 |   60 | `		pTail->pPrev = pB;` |
|  47485 |   61 | `		pB->pNext = pTail;` |
|  23881 |   62 | `	}else{` |
|    335 |   63 | `		pTail->pPrev = pTail->pNext = 0;` |
|      - |   64 | `	}` |
|  52171 |   65 | `	return result.pPrev;` |
|      5 |   66 | `}` |
|      - |   67 | `/*` |
|      - |   68 | `** Inputs:` |
...
|  18029 |   86 | `	while( pIn ){` |
|  16813 |   87 | `		p = pIn;` |
|  16813 |   88 | `		pIn = p->pPrev;` |
|  16813 |   89 | `		p->pPrev = 0;` |
|  31283 |   90 | `		for(i=0; i<N_SORT_BUCKET-1; i++){` |
|  31283 |   91 | `			if( a[i]==0 ){` |
|  16813 |   92 | `				a[i] = p;` |
|  16813 |   93 | `				break;` |
|    ! 0 |   94 | `			}else{` |
|  14475 |   95 | `				p = HashmapNodeMerge(a[i],p,xCmp,pCmpData);` |
|  14475 |   96 | `				a[i] = 0;` |
|      - |   97 | `			}` |
|   7240 |   98 | `		}` |
|  16813 |   99 | `		if( i==N_SORT_BUCKET-1 ){` |
...
|    127 |  217 | `	return rc;` |
|     64 |  218 | `}` |
|  77606 |  219 | `static sxi32 HashmapCmpCallback1(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|      5 |  220 | `{` |
|  77611 |  221 | `	if( pCmpData == 0 ){` |
|      - |  222 | `		/* SORT_REGULAR fast path */` |
|  77523 |  223 | `		return HashmapNodeCmp(pA,pB,FALSE);` |
|      - |  224 | `	}` |
...
|      - |  470 | ` * used-by: [shuffle()]` |
|      - |  471 | ` */` |
|     23 |  472 | `PH7_PRIVATE sxi32 HashmapCmpCallback7(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|      1 |  473 | `{` |
|      - |  474 | `	sxu32 n;` |
|     10 |  475 | `	SXUNUSED(pB); /* cc warning */` |
|     10 |  476 | `	SXUNUSED(pCmpData);` |
|      - |  477 | `	/* Grab a random number */` |
|     24 |  478 | `	n = PH7_VmRandomNum(pA->pMap->pVm);` |
...
|      - |  481 | `	 */` |
|     24 |  482 | `	return n&1 ? 1 : -1;` |
|      1 |  483 | `}` |
|      - |  484 | `/*` |
|      - |  485 | ` * Rehash all nodes keys after a merge-sort have been applied.` |
|      - |  486 | ` * Used by [sort(),usort() and rsort()].` |
|      - |  487 | ` */` |
|   1140 |  488 | `PH7_PRIVATE void HashmapSortRehash(ph7_hashmap *pMap)` |
|      5 |  489 | `{` |
|      - |  490 | `	ph7_hashmap_node *p,*pLast;` |
|      - |  491 | `	sxu32 i;` |
|      - |  492 | `	/* Rehash all entries */` |
|   1145 |  493 | `	pLast = p = pMap->pFirst;` |
|   1145 |  494 | `	pMap->iNextIdx = 0;` |
|   1145 |  495 | `	pMap->bIntKeySeen = 0; /* Reset the automatic index */` |
|   1145 |  496 | `	i = 0;` |
|   8836 |  497 | `	for( ;; ){` |
|  17677 |  498 | `		if( i >= pMap->nEntry ){` |
|   1145 |  499 | `			pMap->pLast = pLast; /* Fix the last link broken by the merge-sort */` |
|   1145 |  500 | `			break;` |
|      - |  501 | `		}` |
|  16537 |  502 | `		if( p->iType == HASHMAP_BLOB_NODE ){` |
...
|      5 |  507 | `		}` |
|  16537 |  508 | `		HashmapRehashIntNode(p);` |
|      - |  509 | `		/* Point to the next entry */` |
|  16537 |  510 | `		i++;` |
|  16537 |  511 | `		pLast = p;` |
|  16537 |  512 | `		p = p->pPrev; /* Reverse link */` |
|      5 |  513 | `	}` |
|   1145 |  514 | `}` |
|      - |  515 | `/*` |
...
|      - |  534 | ` *` |
|      - |  535 | ` */` |
|   1104 |  536 | `PH7_PRIVATE int ph7_hashmap_sort(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  537 | `{` |
|      - |  538 | `	ph7_hashmap *pMap;` |
|      - |  539 | `	/* Make sure we are dealing with a valid hashmap */` |
|   1109 |  540 | `	if( nArg < 1 \|\| !ph7_value_is_array(apArg[0]) ){` |
...
|   1109 |  546 | `	PH7_HashmapCowSeparate(pCtx->pVm, apArg[0]);` |
|   1109 |  547 | `	pMap = (ph7_hashmap *)apArg[0]->x.pOther;` |
|   1109 |  548 | `	if( pMap->nEntry > 1 ){` |
|   1103 |  549 | `		sxi32 iCmpFlags = 0;` |
|   1103 |  550 | `		if( nArg > 1 ){` |
|      - |  551 | `			/* Extract comparison flags */` |
|     15 |  552 | `			iCmpFlags = ph7_value_to_int(apArg[1]);` |
|      7 |  553 | `		}` |
|      - |  554 | `		/* Do the merge sort */` |
|   1103 |  555 | `		HashmapMergeSort(pMap,HashmapCmpCallback1,SX_INT_TO_PTR(iCmpFlags));` |
|      - |  556 | `		/* Rehash [Do not maintain index association as requested by the PHP specification] */` |
|   1103 |  557 | `		HashmapSortRehash(pMap);` |
|    556 |  558 | `	}else if( pMap->nEntry == 1 ){` |
|      - |  559 | `		/* php reindexes even a single-element array: a string key becomes 0 */` |
|      5 |  560 | `		HashmapSortRehash(pMap);` |
|      2 |  561 | `	}` |
|      - |  562 | `	/* All done,return TRUE */` |
|   1109 |  563 | `	ph7_result_bool(pCtx,1);` |
|   1109 |  564 | `	return PH7_OK;` |
|    557 |  565 | `}` |
|      - |  566 | `/*` |
...
|      - |  580 | ` */` |
|     34 |  581 | `PH7_PRIVATE int ph7_hashmap_asort(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      4 |  582 | `{` |
...
|     38 |  592 | `	if( !ph7_value_is_array(apArg[0]) ){` |
|     12 |  593 | `		return PH7_VmThrowException(pCtx,` |
|      - |  594 | `			"TypeError",` |
|      - |  595 | `			"asort(): Argument #1 ($array) must be of type array, %s given",` |
|      3 |  596 | `			ph7_type_name(apArg[0])` |
|      - |  597 | `			);` |
|      - |  598 | `	}` |
...
|      - |  633 | ` */` |
|     30 |  634 | `PH7_PRIVATE int ph7_hashmap_arsort(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      4 |  635 | `{` |
...
|     34 |  645 | `	if( !ph7_value_is_array(apArg[0]) ){` |
|     12 |  646 | `		return PH7_VmThrowException(pCtx,` |
|      - |  647 | `			"TypeError",` |
|      - |  648 | `			"arsort(): Argument #1 ($array) must be of type array, %s given",` |
|      3 |  649 | `			ph7_type_name(apArg[0])` |
|      - |  650 | `			);` |
|      - |  651 | `	}` |
