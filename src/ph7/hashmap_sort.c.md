...
|      - |   35 | `**   changed.` |
|      - |   36 | `*/` |
|  52148 |   37 | `static ph7_hashmap_node * HashmapNodeMerge(ph7_hashmap_node *pA,ph7_hashmap_node *pB,ProcNodeCmp xCmp,void *pCmpData)` |
|      5 |   38 | `{` |
...
|  61139 |   45 | `			pTail->pPrev = pA;` |
|  61139 |   46 | `			pA->pNext = pTail;` |
|  61139 |   47 | `			pTail = pA;` |
|  61139 |   48 | `			pA = pA->pPrev;` |
|  30734 |   49 | `		}else{` |
|  16805 |   50 | `			pTail->pPrev = pB;` |
|  16805 |   51 | `			pB->pNext = pTail;` |
|  16805 |   52 | `			pTail = pB;` |
|  16805 |   53 | `			pB = pB->pPrev;` |
|      - |   54 | `		}` |
|      5 |   55 | `	}` |
|  52153 |   56 | `	if( pA ){` |
|   4348 |   57 | `		pTail->pPrev = pA;` |
|   4348 |   58 | `		pA->pNext = pTail;` |
|  49839 |   59 | `	}else if( pB ){` |
|  47492 |   60 | `		pTail->pPrev = pB;` |
|  47492 |   61 | `		pB->pNext = pTail;` |
|  23891 |   62 | `	}else{` |
...
|  18021 |   86 | `	while( pIn ){` |
|  16805 |   87 | `		p = pIn;` |
|  16805 |   88 | `		pIn = p->pPrev;` |
|  16805 |   89 | `		p->pPrev = 0;` |
|  31257 |   90 | `		for(i=0; i<N_SORT_BUCKET-1; i++){` |
|  31257 |   91 | `			if( a[i]==0 ){` |
|  16805 |   92 | `				a[i] = p;` |
|  16805 |   93 | `				break;` |
|    ! 0 |   94 | `			}else{` |
|  14457 |   95 | `				p = HashmapNodeMerge(a[i],p,xCmp,pCmpData);` |
|  14457 |   96 | `				a[i] = 0;` |
|      - |   97 | `			}` |
|   7231 |   98 | `		}` |
|  16805 |   99 | `		if( i==N_SORT_BUCKET-1 ){` |
...
|    127 |  217 | `	return rc;` |
|     64 |  218 | `}` |
|  77559 |  219 | `static sxi32 HashmapCmpCallback1(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|      5 |  220 | `{` |
|  77564 |  221 | `	if( pCmpData == 0 ){` |
|      - |  222 | `		/* SORT_REGULAR fast path */` |
|  77476 |  223 | `		return HashmapNodeCmp(pA,pB,FALSE);` |
|      - |  224 | `	}` |
...
|      5 |  507 | `		}` |
|  16529 |  508 | `		HashmapRehashIntNode(p);` |
|      - |  509 | `		/* Point to the next entry */` |
|  16529 |  510 | `		i++;` |
|  16529 |  511 | `		pLast = p;` |
|  16529 |  512 | `		p = p->pPrev; /* Reverse link */` |
|      5 |  513 | `	}` |
|   1145 |  514 | `}` |
|      - |  515 | `/*` |
