...
| 129879 |   43 | `	while( pA && pB ){` |
|  77731 |   44 | `		if( xCmp(pA,pB,pCmpData) <= 0 ){` |
|  60982 |   45 | `			pTail->pPrev = pA;` |
|  60982 |   46 | `			pA->pNext = pTail;` |
|  60982 |   47 | `			pTail = pA;` |
|  60982 |   48 | `			pA = pA->pPrev;` |
|  30658 |   49 | `		}else{` |
|  16754 |   50 | `			pTail->pPrev = pB;` |
|  16754 |   51 | `			pB->pNext = pTail;` |
|  16754 |   52 | `			pTail = pB;` |
|  16754 |   53 | `			pB = pB->pPrev;` |
|      - |   54 | `		}` |
|      5 |   55 | `	}` |
|  52153 |   56 | `	if( pA ){` |
|   4354 |   57 | `		pTail->pPrev = pA;` |
|   4354 |   58 | `		pA->pNext = pTail;` |
|  49836 |   59 | `	}else if( pB ){` |
|  47498 |   60 | `		pTail->pPrev = pB;` |
|  47498 |   61 | `		pB->pNext = pTail;` |
|  23894 |   62 | `	}else{` |
|    311 |   63 | `		pTail->pPrev = pTail->pNext = 0;` |
|      - |   64 | `	}` |
...
|  17973 |   86 | `	while( pIn ){` |
|  16755 |   87 | `		p = pIn;` |
|  16755 |   88 | `		pIn = p->pPrev;` |
|  16755 |   89 | `		p->pPrev = 0;` |
|  31145 |   90 | `		for(i=0; i<N_SORT_BUCKET-1; i++){` |
|  31145 |   91 | `			if( a[i]==0 ){` |
|  16755 |   92 | `				a[i] = p;` |
|  16755 |   93 | `				break;` |
|    ! 0 |   94 | `			}else{` |
|  14395 |   95 | `				p = HashmapNodeMerge(a[i],p,xCmp,pCmpData);` |
|  14395 |   96 | `				a[i] = 0;` |
|      - |   97 | `			}` |
|   7200 |   98 | `		}` |
|  16755 |   99 | `		if( i==N_SORT_BUCKET-1 ){` |
...
|    127 |  217 | `	return rc;` |
|     64 |  218 | `}` |
|  77349 |  219 | `static sxi32 HashmapCmpCallback1(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|      5 |  220 | `{` |
|  77354 |  221 | `	if( pCmpData == 0 ){` |
|      - |  222 | `		/* SORT_REGULAR fast path */` |
|  77266 |  223 | `		return HashmapNodeCmp(pA,pB,FALSE);` |
|      - |  224 | `	}` |
...
|      5 |  507 | `		}` |
|  16479 |  508 | `		HashmapRehashIntNode(p);` |
|      - |  509 | `		/* Point to the next entry */` |
|  16479 |  510 | `		i++;` |
|  16479 |  511 | `		pLast = p;` |
|  16479 |  512 | `		p = p->pPrev; /* Reverse link */` |
|      5 |  513 | `	}` |
|   1147 |  514 | `}` |
|      - |  515 | `/*` |
