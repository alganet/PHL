...
|      - |   35 | `**   changed.` |
|      - |   36 | `*/` |
|  52168 |   37 | `static ph7_hashmap_node * HashmapNodeMerge(ph7_hashmap_node *pA,ph7_hashmap_node *pB,ProcNodeCmp xCmp,void *pCmpData)` |
|      5 |   38 | `{` |
|      - |   39 | `	ph7_hashmap_node result,*pTail;` |
|      - |   40 | `    /* Prevent compiler warning */` |
|  52173 |   41 | `	result.pNext = result.pPrev = 0;` |
|  52173 |   42 | `	pTail = &result;` |
| 130209 |   43 | `	while( pA && pB ){` |
|  78041 |   44 | `		if( xCmp(pA,pB,pCmpData) <= 0 ){` |
|  61204 |   45 | `			pTail->pPrev = pA;` |
|  61204 |   46 | `			pA->pNext = pTail;` |
|  61204 |   47 | `			pTail = pA;` |
|  61204 |   48 | `			pA = pA->pPrev;` |
|  30742 |   49 | `		}else{` |
|  16842 |   50 | `			pTail->pPrev = pB;` |
|  16842 |   51 | `			pB->pNext = pTail;` |
|  16842 |   52 | `			pTail = pB;` |
|  16842 |   53 | `			pB = pB->pPrev;` |
|      - |   54 | `		}` |
|      5 |   55 | `	}` |
|  52173 |   56 | `	if( pA ){` |
|   4320 |   57 | `		pTail->pPrev = pA;` |
|   4320 |   58 | `		pA->pNext = pTail;` |
|  49891 |   59 | `	}else if( pB ){` |
|  47528 |   60 | `		pTail->pPrev = pB;` |
|  47528 |   61 | `		pB->pNext = pTail;` |
|  23891 |   62 | `	}else{` |
|    335 |   63 | `		pTail->pPrev = pTail->pNext = 0;` |
|      - |   64 | `	}` |
|  52173 |   65 | `	return result.pPrev;` |
|      5 |   66 | `}` |
|      - |   67 | `/*` |
|      - |   68 | `** Inputs:` |
...
|  18037 |   86 | `	while( pIn ){` |
|  16821 |   87 | `		p = pIn;` |
|  16821 |   88 | `		pIn = p->pPrev;` |
|  16821 |   89 | `		p->pPrev = 0;` |
|  31293 |   90 | `		for(i=0; i<N_SORT_BUCKET-1; i++){` |
|  31293 |   91 | `			if( a[i]==0 ){` |
|  16821 |   92 | `				a[i] = p;` |
|  16821 |   93 | `				break;` |
|    ! 0 |   94 | `			}else{` |
|  14477 |   95 | `				p = HashmapNodeMerge(a[i],p,xCmp,pCmpData);` |
|  14477 |   96 | `				a[i] = 0;` |
|      - |   97 | `			}` |
|   7241 |   98 | `		}` |
|  16821 |   99 | `		if( i==N_SORT_BUCKET-1 ){` |
...
|    127 |  217 | `	return rc;` |
|     64 |  218 | `}` |
|  77657 |  219 | `static sxi32 HashmapCmpCallback1(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|      5 |  220 | `{` |
|  77662 |  221 | `	if( pCmpData == 0 ){` |
|      - |  222 | `		/* SORT_REGULAR fast path */` |
|  77574 |  223 | `		return HashmapNodeCmp(pA,pB,FALSE);` |
|      - |  224 | `	}` |
...
|      5 |  507 | `		}` |
|  16545 |  508 | `		HashmapRehashIntNode(p);` |
|      - |  509 | `		/* Point to the next entry */` |
|  16545 |  510 | `		i++;` |
|  16545 |  511 | `		pLast = p;` |
|  16545 |  512 | `		p = p->pPrev; /* Reverse link */` |
|      5 |  513 | `	}` |
|   1145 |  514 | `}` |
|      - |  515 | `/*` |
