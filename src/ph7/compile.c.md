...
Coverage: 5535/6894 lines (80.29%)
...
|       - |   130 | ` */` |
|    3668 |   131 | `static GenBlock * GenStateFetchBlock(GenBlock *pCurrent,sxi32 iBlockType,sxi32 iCount)` |
|       5 |   132 |  |
|    3673 |   133 | `	GenBlock *pBlock = pCurrent;` |
|   10421 |   134 | `	for(;;){` |
|   20847 |   135 | `		if( pBlock->iFlags & iBlockType ){` |
|    3565 |   136 | `			iCount--; /* Decrement nesting level */` |
|    3565 |   137 | `			if( iCount < 1 ){` |
|       - |   138 | `				/* Block meet with the desired criteria */` |
|    3539 |   139 | `				return pBlock;` |
|       - |   140 | `			}` |
|      13 |   141 | `		}` |
|       - |   142 | `		/* Point to the upper block */` |
|   17313 |   143 | `		pBlock = pBlock->pParent;` |
|   17313 |   144 | `		if( pBlock == 0 \|\| (pBlock->iFlags & (GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC)) ){` |
|       - |   145 | `			/* Forbidden */` |
|      72 |   146 | `			break;` |
|       - |   147 | `		}` |
|       5 |   148 | `	}` |
...
|       - |   154 | ` */` |
|  800240 |   155 | `static void GenStateInitBlock(` |
...
|  800245 |   164 | `	pBlock->nFirstInstr = nFirstInstr;` |
|  800245 |   165 | `	pBlock->pUserData   = pUserData;` |
|  800245 |   166 | `	pBlock->pGen        = pGen;` |
|  800245 |   167 | `	pBlock->iFlags      = iType;` |
|  800245 |   168 | `	pBlock->pParent     = 0;` |
|  800245 |   169 | `	SySetInit(&pBlock->aJumpFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  800245 |   170 | `	SySetInit(&pBlock->aPostContFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  800245 |   171 |  |
|       - |   172 | `/*` |
...
|       - |   177 | ` */` |
|  796850 |   178 | `static sxi32 GenStateEnterBlock(` |
...
|  796855 |   188 | `	pBlock = (GenBlock *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(GenBlock));` |
|  796855 |   189 | `	if( pBlock == 0 ){` |
...
|  796855 |   198 | `	SyZero(pBlock,sizeof(GenBlock));` |
|  796855 |   199 | `	GenStateInitBlock(&(*pGen),pBlock,iType,nFirstInstr,pUserData);` |
|       - |   200 | `	/* Link to the parent block */` |
|  796855 |   201 | `	pBlock->pParent = pGen->pCurrent;` |
|       - |   202 | `	/* Mark as the current block */` |
|  796855 |   203 | `	pGen->pCurrent = pBlock;` |
|  796855 |   204 | `	if( ppBlock ){` |
|       - |   205 | `		/* Write a pointer to the new instance */` |
|  387051 |   206 | `		*ppBlock = pBlock;` |
|  193523 |   207 | `	}` |
|  796855 |   208 | `	return SXRET_OK;` |
|  398430 |   209 |  |
|       - |   210 | `/*` |
|       - |   211 | ` * Release block fields without freeing the whole instance.` |
|       - |   212 | ` */` |
|  796842 |   213 | `static void GenStateReleaseBlock(GenBlock *pBlock)` |
|       5 |   214 |  |
|  796847 |   215 | `	SySetRelease(&pBlock->aPostContFix);` |
|  796847 |   216 | `	SySetRelease(&pBlock->aJumpFix);` |
|  796847 |   217 |  |
|       - |   218 | `/*` |
|       - |   219 | ` * Release a block.` |
|       - |   220 | ` */` |
|  796842 |   221 | `static void GenStateFreeBlock(GenBlock *pBlock)` |
|       5 |   222 |  |
|  796847 |   223 | `	ph7_gen_state *pGen = pBlock->pGen;` |
|  796847 |   224 | `	GenStateReleaseBlock(&(*pBlock));` |
|       - |   225 | `	/* Free the instance */` |
|  796847 |   226 | `	SyMemBackendPoolFree(&pGen->pVm->sAllocator,pBlock);` |
|  796847 |   227 |  |
|       - |   228 | `/*` |
|       - |   229 | ` * POP and release a block from the stack of compiled blocks.` |
|       - |   230 | ` */` |
|  796842 |   231 | `static sxi32 GenStateLeaveBlock(ph7_gen_state *pGen,GenBlock **ppBlock)` |
|       5 |   232 |  |
|  796847 |   233 | `	GenBlock *pBlock = pGen->pCurrent;` |
|  796847 |   234 | `	if( pBlock == 0 ){` |
|       - |   235 | `		/* No more block to pop */` |
|     ! 0 |   236 | `		return SXERR_EMPTY;` |
|       - |   237 | `	}` |
|       - |   238 | `	/* Point to the upper block */` |
|  796847 |   239 | `	pGen->pCurrent = pBlock->pParent;` |
|  796847 |   240 | `	if( ppBlock ){` |
|       - |   241 | `		/* Write a pointer to the popped block */` |
|     ! 0 |   242 | `		*ppBlock = pBlock;` |
|     ! 0 |   243 | `	}else{` |
|       - |   244 | `		/* Safely release the block */` |
|  796847 |   245 | `		GenStateFreeBlock(&(*pBlock));` |
|       - |   246 | `	}` |
|  796847 |   247 | `	return SXRET_OK;` |
|  398426 |   248 |  |
|       - |   249 | `/*` |
...
|       - |   258 | ` */` |
|  226372 |   259 | `static sxi32 GenStateNewJumpFixup(GenBlock *pBlock,sxi32 nJumpType,sxu32 nInstrIdx)` |
|       5 |   260 |  |
|       - |   261 | `	JumpFixup sJumpFix;` |
|       - |   262 | `	sxi32 rc;` |
|       - |   263 | `	/* Init the JumpFixup structure */` |
|  226377 |   264 | `	sJumpFix.nJumpType = nJumpType;` |
|  226377 |   265 | `	sJumpFix.nInstrIdx = nInstrIdx;` |
|       - |   266 | `	/* Insert in the jump fixup table */` |
|  226377 |   267 | `	rc = SySetPut(&pBlock->aJumpFix,(const void *)&sJumpFix);` |
|  226377 |   268 | `	return rc;` |
|       5 |   269 |  |
|       - |   270 | `/*` |
...
|       - |   280 | ` */` |
|  556898 |   281 | `static sxu32 GenStateFixJumps(GenBlock *pBlock,sxi32 nJumpType,sxu32 nJumpDest)` |
|       5 |   282 |  |
|       - |   283 | `	JumpFixup *aFix;` |
|       - |   284 | `	VmInstr *pInstr;` |
|       - |   285 | `	sxu32 nFixed;` |
...
|  556903 |   288 | `	aFix = (JumpFixup *)SySetBasePtr(&pBlock->aJumpFix);` |
|       - |   289 | `	/* Fix the desired jumps */` |
| 1003107 |   290 | `	for( nFixed = n = 0 ; n < SySetUsed(&pBlock->aJumpFix) ; ++n ){` |
|  446209 |   291 | `		if( aFix[n].nJumpType < 0 ){` |
|       - |   292 | `			/* Already fixed */` |
|  178021 |   293 | `			continue;` |
|       - |   294 | `		}` |
|  268193 |   295 | `		if( nJumpType > 0 && aFix[n].nJumpType != nJumpType ){` |
|       - |   296 | `			/* Not of our interest */` |
|   41823 |   297 | `			continue;` |
|       - |   298 | `		}` |
|       - |   299 | `		/* Point to the instruction to fix */` |
|  226375 |   300 | `		pInstr = PH7_VmGetInstr(pBlock->pGen->pVm,aFix[n].nInstrIdx);` |
|  226375 |   301 | `		if( pInstr ){` |
|  226375 |   302 | `			pInstr->iP2 = nJumpDest;` |
|  226375 |   303 | `			nFixed++;` |
|       - |   304 | `			/* Mark as fixed */` |
|  226375 |   305 | `			aFix[n].nJumpType = -1;` |
|  113185 |   306 | `		}` |
|  113190 |   307 | `	}` |
|       - |   308 | `	/* Total number of fixed jumps */` |
|  556903 |   309 | `	return nFixed;` |
|       5 |   310 |  |
|       - |   311 | `/*` |
...
|       - |   317 | ` */` |
|  226172 |   318 | `static sxi32 GenStateFixGoto(ph7_gen_state *pGen,sxu32 nOfft)` |
|       5 |   319 |  |
...
|  226177 |   326 | `	aJumps = (JumpFixup *)SySetBasePtr(&pGen->aGoto);` |
|       - |   327 | `	/* Fix */` |
|  226323 |   328 | `	for( n = nOfft ; n < SySetUsed(&pGen->aGoto) ; ++n ){` |
...
|      46 |   351 | `		}` |
|      51 |   352 | `	}` |
|  226175 |   353 | `	aLabel = (Label *)SySetBasePtr(&pGen->aLabel);` |
|  226307 |   354 | `	for( n = 0 ; n < SySetUsed(&pGen->aLabel) ; ++n ){` |
...
|      12 |   359 | `		}` |
|      71 |   360 | `	}` |
|  226175 |   361 | `	return SXRET_OK;` |
|  113091 |   362 |  |
|       - |   363 | `/*` |
|       - |   364 | ` * Check if a given token value is installed in the literal table.` |
|       - |   365 | ` */` |
|  715462 |   366 | `static sxi32 GenStateFindLiteral(ph7_gen_state *pGen,const SyString *pValue,sxu32 *pIdx)` |
|       5 |   367 |  |
|       - |   368 | `	SyHashEntry *pEntry;` |
|  715467 |   369 | `	pEntry = SyHashGet(&pGen->hLiteral,(const void *)pValue->zString,pValue->nByte);` |
|  715467 |   370 | `	if( pEntry == 0 ){` |
|  311305 |   371 | `		return SXERR_NOTFOUND;` |
|       - |   372 | `	}` |
|  404167 |   373 | `	*pIdx = (sxu32)SX_PTR_TO_INT(pEntry->pUserData);` |
|  404167 |   374 | `	return SXRET_OK;` |
|  357736 |   375 |  |
|       - |   376 | `/*` |
...
|       - |   385 | ` */` |
|  311300 |   386 | `static sxi32 GenStateInstallLiteral(ph7_gen_state *pGen,ph7_value *pObj,sxu32 nIdx)` |
|       5 |   387 |  |
|  311305 |   388 | `	if( SyBlobLength(&pObj->sBlob) > 0 ){` |
|  311305 |   389 | `		SyHashInsert(&pGen->hLiteral,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob),SX_INT_TO_PTR(nIdx));` |
|  155650 |   390 | `	}` |
|  311305 |   391 | `	return SXRET_OK;` |
|       5 |   392 |  |
|       - |   393 | `/*` |
|       - |   394 | ` * Reserve a room for a numeric constant [i.e: 64-bit integer or real number]` |
|       - |   395 | ` * in the constant table.` |
|       - |   396 | ` */` |
|  119126 |   397 | `static ph7_value * GenStateInstallNumLiteral(ph7_gen_state *pGen,sxu32 *pIdx)` |
|       5 |   398 |  |
|       - |   399 | `	ph7_value *pObj;` |
|  119131 |   400 | `	sxu32 nIdx = 0; /* cc warning */` |
|       - |   401 | `	/* Reserve a new constant */` |
|  119131 |   402 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  119131 |   403 | `	if( pObj == 0 ){` |
|     ! 0 |   404 | `		PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|     ! 0 |   405 | `		return 0;` |
|       - |   406 | `	}` |
|  119131 |   407 | `	*pIdx = nIdx;` |
|       - |   408 | `	/* TODO(chems): Create a numeric table (64bit int keys) same as` |
|       - |   409 | `	 * the constant string iterals table [optimization purposes].` |
|       - |   410 | `	 */` |
|  119131 |   411 | `	return pObj;` |
|   59568 |   412 |  |
|       - |   413 | `/*` |
...
|       - |   426 | ` */` |
|  427726 |   427 | `static void *GenStateAttachStrictFlag(ph7_gen_state *pGen, void *p3)` |
|       5 |   428 |  |
|       - |   429 | `	VmCallArgMap *pMap;` |
|  427731 |   430 | `	if( !pGen->bStrictTypes ) return p3;` |
|      33 |   431 | `	if( p3 == 0 ){` |
...
|       - |   497 | ` */` |
|  119790 |   498 | `static int GenStateFindBadNumericSeparator(` |
|       - |   499 | `	const SyString *pRaw, const char **pBadStart, sxu32 *pBadLen)` |
|       5 |   500 |  |
|  119795 |   501 | `	const char *z = pRaw->zString;` |
|  119795 |   502 | `	sxu32 n = pRaw->nByte;` |
|  119795 |   503 | `	int base = 10;` |
|       - |   504 | `	sxu32 i, start;` |
|  119795 |   505 | `	if( n < 2 ) return 0;` |
|   10025 |   506 | `	if( z[0] == '0' && (z[1] == 'x' \|\| z[1] == 'X') ){` |
|      72 |   507 | `		base = 16;` |
|    9990 |   508 | `	}else if( z[0] == '0' && (z[1] == 'b' \|\| z[1] == 'B') ){` |
|     280 |   509 | `		base = 2;` |
|     139 |   510 | `	}` |
|   36441 |   511 | `	for( i = 0; i < n; ++i ){` |
|   26435 |   512 | `		if( z[i] != '_' ) continue;` |
...
|       - |   538 | ` */` |
|  119790 |   539 | `static sxi32 GenStateValidateNumericSeparator(ph7_gen_state *pGen, SyToken *pToken)` |
|       5 |   540 |  |
|  119795 |   541 | `	const char *zBad = 0;` |
|  119795 |   542 | `	sxu32 nBad = 0;` |
|       - |   543 | `	SyString sBad;` |
|       - |   544 | `	sxi32 rc;` |
|  119795 |   545 | `	if( !GenStateFindBadNumericSeparator(&pToken->sData, &zBad, &nBad) ){` |
|  119781 |   546 | `		return SXRET_OK;` |
|       - |   547 | `	}` |
...
|       - |   571 | ` */` |
|  119776 |   572 | `static sxi32 GenStateStripNumericSeparators(` |
...
|       5 |   577 |  |
|       - |   578 | `	sxu32 i, j;` |
|  119781 |   579 | `	int hasUnderscore = 0;` |
|       - |   580 | `	char *zBuf;` |
|  119781 |   581 | `	*pzAlloc = 0;` |
|  253901 |   582 | `	for( i = 0; i < pToken->nByte; ++i ){` |
|  134377 |   583 | `		if( pToken->zString[i] == '_' ){ hasUnderscore = 1; break; }` |
|   67065 |   584 | `	}` |
|  119781 |   585 | `	if( !hasUnderscore ){` |
|  119529 |   586 | `		SyStringDupPtr(pOut, pToken);` |
|  119529 |   587 | `		return SXRET_OK;` |
|       - |   588 | `	}` |
...
|       - |   619 | ` *  documentation.` |
|       - |   620 | ` */` |
|  119762 |   621 | `static sxi32 PH7_CompileNumLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |   622 |  |
|  119767 |   623 | `	SyToken *pToken = pGen->pIn; /* Raw token */` |
|  119767 |   624 | `	sxu32 nIdx = 0;` |
|       - |   625 | `	char zScratch[GEN_NUM_SCRATCH];` |
|  119767 |   626 | `	char *zAlloc = 0;` |
|       - |   627 | `	SyString sNum;` |
|       - |   628 | `	sxi32 rc;` |
|   59881 |   629 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|  119767 |   630 | `	rc = GenStateValidateNumericSeparator(pGen, pToken);` |
|  119767 |   631 | `	if( rc != SXRET_OK ){` |
|      14 |   632 | `		return rc;` |
|       - |   633 | `	}` |
|  179633 |   634 | `	rc = GenStateStripNumericSeparators(&pGen->pVm->sAllocator, &pToken->sData,` |
|   59876 |   635 | `		zScratch, sizeof(zScratch), &sNum, &zAlloc);` |
|  119757 |   636 | `	if( rc != SXRET_OK ){` |
|     ! 0 |   637 | `		return SXERR_ABORT;` |
|       - |   638 | `	}` |
|  119757 |   639 | `	if( pToken->nType & PH7_TK_INTEGER ){` |
|       - |   640 | `		ph7_value *pObj;` |
|       - |   641 | `		sxi64 iValue;` |
|  119131 |   642 | `		iValue = PH7_TokenValueToInt64(&sNum);` |
|  119131 |   643 | `		pObj = GenStateInstallNumLiteral(&(*pGen),&nIdx);` |
|  119131 |   644 | `		if( pObj == 0 ){` |
|     ! 0 |   645 | `			if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|     ! 0 |   646 | `			return SXERR_ABORT;` |
|       - |   647 | `		}` |
|  119131 |   648 | `		PH7_MemObjInitFromInt(pGen->pVm,pObj,iValue);` |
|   59568 |   649 | `	}else{` |
|       - |   650 | `		/* Real number */` |
|       - |   651 | `		ph7_value *pObj;` |
...
|       - |   661 | `	}` |
|  119757 |   662 | `	if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|       - |   663 | `	/* Emit the load constant instruction */` |
|  119757 |   664 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|       - |   665 | `	/* Node successfully compiled */` |
|  119757 |   666 | `	return SXRET_OK;` |
|   59886 |   667 |  |
|       - |   668 | `/*` |
...
|       - |   677 | ` *` |
|       - |   678 | ` */` |
|   85776 |   679 | `PH7_PRIVATE sxi32 PH7_CompileSimpleString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |   680 |  |
|   85781 |   681 | `	SyString *pStr = &pGen->pIn->sData; /* Constant string literal */` |
|       - |   682 | `	const char *zIn,*zCur,*zEnd;` |
|       - |   683 | `	ph7_value *pObj;` |
|       - |   684 | `	sxu32 nIdx;` |
|   85781 |   685 | `	nIdx = 0; /* Prevent compiler warning */` |
|       - |   686 | `	/* Delimit the string */` |
|   85781 |   687 | `	zIn  = pStr->zString;` |
|   85781 |   688 | `	zEnd = &zIn[pStr->nByte];` |
|   85781 |   689 | `	if( zIn >= zEnd ){` |
|       - |   690 | `		/* Empty string constant: just use the pre‑allocated index from the VM` |
|       - |   691 | `		 * rather than reserving a new object each time. */` |
|    6951 |   692 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,pGen->pVm->nEmptyStringIdx,0,0);` |
|    6951 |   693 | `		return SXRET_OK;` |
|       - |   694 | `	}` |
|   78835 |   695 | `	if( SXRET_OK == GenStateFindLiteral(&(*pGen),pStr,&nIdx) ){` |
|       - |   696 | `		/* Already processed,emit the load constant instruction` |
|       - |   697 | `		 * and return.` |
|       - |   698 | `		 */` |
|   31129 |   699 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   31129 |   700 | `		return SXRET_OK;` |
|       - |   701 | `	}` |
|       - |   702 | `	/* Reserve a new constant */` |
|   47711 |   703 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   47711 |   704 | `	if( pObj == 0 ){` |
...
|       - |   708 | `	}` |
|   47711 |   709 | `	PH7_MemObjInitFromString(pGen->pVm,pObj,0);` |
|       - |   710 | `	/* Compile the node */` |
|   47758 |   711 | `	for(;;){` |
|   95521 |   712 | `		if( zIn >= zEnd ){` |
|       - |   713 | `			/* End of input */` |
|   47711 |   714 | `			break;` |
|       - |   715 | `		}` |
|   47815 |   716 | `		zCur = zIn;` |
|  752851 |   717 | `		while( zIn < zEnd && zIn[0] != '\\' ){` |
|  705041 |   718 | `			zIn++;` |
|       5 |   719 | `		}` |
|   47815 |   720 | `		if( zIn > zCur ){` |
|       - |   721 | `			/* Append raw contents*/` |
|   47791 |   722 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|   23893 |   723 | `		}` |
|   47815 |   724 | `		zIn++;` |
|   47815 |   725 | `		if( zIn < zEnd ){` |
|     126 |   726 | `			if( zIn[0] == '\\' ){` |
...
|   47711 |   743 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   47711 |   744 | `	if( pStr->nByte < 1024 ){` |
|       - |   745 | `		/* Install in the literal table */` |
|   47711 |   746 | `		GenStateInstallLiteral(pGen,pObj,nIdx);` |
|   23853 |   747 | `	}` |
|       - |   748 | `	/* Node successfully compiled */` |
|   47711 |   749 | `	return SXRET_OK;` |
|   42893 |   750 |  |
|       - |   751 | `/*` |
...
|       - |   915 | ` */` |
|    2174 |   916 | `static sxi32 GenStateProcessStringExpression(` |
...
|    2179 |   927 | `	SySetInit(&sToken,&pGen->pVm->sAllocator,sizeof(SyToken));` |
|       - |   928 | `	/* Preallocate some slots */` |
|    2179 |   929 | `	SySetAlloc(&sToken,0x08);` |
|       - |   930 | `	/* Tokenize the text */` |
|    2179 |   931 | `	PH7_TokenizePHP(zIn,(sxu32)(zEnd-zIn),nLine,&sToken);` |
|       - |   932 | `	/* Swap delimiter */` |
|    2179 |   933 | `	pTmpIn  = pGen->pIn;` |
|    2179 |   934 | `	pTmpEnd = pGen->pEnd;` |
|    2179 |   935 | `	pGen->pIn = (SyToken *)SySetBasePtr(&sToken);` |
|    2179 |   936 | `	pGen->pEnd = &pGen->pIn[SySetUsed(&sToken)];` |
|       - |   937 | `	/* Compile the expression */` |
|    2179 |   938 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|       - |   939 | `	/* Restore token stream */` |
|    2179 |   940 | `	pGen->pIn  = pTmpIn;` |
|    2179 |   941 | `	pGen->pEnd = pTmpEnd;` |
|       - |   942 | `	/* Release the token set */` |
|    2179 |   943 | `	SySetRelease(&sToken);` |
...
|       - |   949 | ` */` |
|   23720 |   950 | `static ph7_value * GenStateNewStrObj(ph7_gen_state *pGen,sxi32 *pCount)` |
|       5 |   951 |  |
|       - |   952 | `	ph7_value *pConstObj;` |
|   23725 |   953 | `	sxu32 nIdx = 0;` |
|       - |   954 | `	/* Reserve a new constant */` |
|   23725 |   955 | `	pConstObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   23725 |   956 | `	if( pConstObj == 0 ){` |
|     ! 0 |   957 | `		PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"PH7 engine is running out of memory");` |
|     ! 0 |   958 | `		return 0;` |
|       - |   959 | `	}` |
|   23725 |   960 | `	(*pCount)++;` |
|   23725 |   961 | `	PH7_MemObjInitFromString(pGen->pVm,pConstObj,0);` |
|       - |   962 | `	/* Emit the load constant instruction */` |
|   23725 |   963 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   23725 |   964 | `	return pConstObj;` |
|   11865 |   965 |  |
|       - |   966 | `/*` |
...
|       - |  1003 | ` */` |
|   22260 |  1004 | `static sxi32 GenStateCompileString(ph7_gen_state *pGen)` |
|       5 |  1005 |  |
|   22265 |  1006 | `	SyString *pStr = &pGen->pIn->sData; /* Raw token value */` |
|       - |  1007 | `	const char *zIn,*zCur,*zEnd;` |
|   22265 |  1008 | `	ph7_value *pObj = 0;` |
|       - |  1009 | `	sxi32 iCons;` |
|       - |  1010 | `	sxi32 rc;` |
|       - |  1011 | `	/* Delimit the string */` |
|   22265 |  1012 | `	zIn  = pStr->zString;` |
|   22265 |  1013 | `	zEnd = &zIn[pStr->nByte];` |
|   22265 |  1014 | `	if( zIn >= zEnd ){` |
...
|   12064 |  1025 | `	for(;;){` |
|   36095 |  1026 | `		zCur = zIn;` |
|  173441 |  1027 | `		while( zIn < zEnd && zIn[0] != '\\'  ){` |
|  139525 |  1028 | `			if( zIn[0] == '{' && &zIn[1] < zEnd && zIn[1] == '$' ){` |
|      67 |  1029 | `				break;` |
|  139401 |  1030 | `			}else if(zIn[0] == '$' && &zIn[1] < zEnd &&` |
|    2054 |  1031 | `				(((unsigned char)zIn[1] >= 0xc0 \|\| SyisAlpha(zIn[1]) \|\| zIn[1] == '{' \|\| zIn[1] == '_')) ){` |
|    1028 |  1032 | `					break;` |
|       - |  1033 | `			}` |
|  137351 |  1034 | `			zIn++;` |
|       5 |  1035 | `		}` |
|   36095 |  1036 | `		if( zIn > zCur ){` |
|   16961 |  1037 | `			if( pObj == 0 ){` |
|   16487 |  1038 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|   16487 |  1039 | `				if( pObj == 0 ){` |
|     ! 0 |  1040 | `					return SXERR_ABORT;` |
|       - |  1041 | `				}` |
|    8241 |  1042 | `			}` |
|   16961 |  1043 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|    8478 |  1044 | `		}` |
|   36095 |  1045 | `		if( zIn >= zEnd ){` |
|   21959 |  1046 | `			break;` |
|       - |  1047 | `		}` |
|   14141 |  1048 | `		if( zIn[0] == '\\' ){` |
|   11967 |  1049 | `			const char *zPtr = 0;` |
|       - |  1050 | `			sxu32 n;` |
|   11967 |  1051 | `			zIn++;` |
|   11967 |  1052 | `			if( zIn >= zEnd ){` |
|     ! 0 |  1053 | `				break;` |
|       - |  1054 | `			}` |
|   11967 |  1055 | `			if( pObj == 0 ){` |
|    7243 |  1056 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|    7243 |  1057 | `				if( pObj == 0 ){` |
|     ! 0 |  1058 | `					return SXERR_ABORT;` |
|       - |  1059 | `				}` |
|    3619 |  1060 | `			}` |
|   11967 |  1061 | `			n = sizeof(char); /* size of conversion */` |
|   11967 |  1062 | `			switch( zIn[0] ){` |
|       7 |  1063 | `			case '$':` |
|       - |  1064 | `				/* Dollar sign */` |
...
|   11001 |  1085 | `				PH7_MemObjStringAppend(pObj,"\n",sizeof(char));` |
|   11001 |  1086 | `				break;` |
|      19 |  1087 | `			case 'r':` |
...
|      67 |  1189 | `		}else{` |
|       - |  1190 | `			/* Simple syntax */` |
|    2051 |  1191 | `			const char *zExpr = zIn;` |
|       - |  1192 | `			/* Assemble variable name */` |
|    1032 |  1193 | `			for(;;){` |
|       - |  1194 | `				/* Jump leading dollars */` |
|    4115 |  1195 | `				while( zIn < zEnd && zIn[0] == '$' ){` |
|    2051 |  1196 | `					zIn++;` |
|       5 |  1197 | `				}` |
|    1032 |  1198 | `				for(;;){` |
|   11581 |  1199 | `					while( zIn < zEnd && (unsigned char)zIn[0] < 0xc0 && (SyisAlphaNum(zIn[0]) \|\| zIn[0] == '_' ) ){` |
|    8485 |  1200 | `						zIn++;` |
|       5 |  1201 | `					}` |
|    2069 |  1202 | `					if((unsigned char)zIn[0] >= 0xc0 ){` |
|       - |  1203 | `						/* UTF-8 stream */` |
|     ! 0 |  1204 | `						zIn++;` |
...
|       1 |  1249 | `					}` |
|       6 |  1250 | `					break;` |
|    1887 |  1251 | `				}else if( zIn[0] == '-' && &zIn[1] < zEnd && zIn[1] == '>' ){` |
|       - |  1252 | `					/* Member access operator '->' */` |
|      21 |  1253 | `					zIn += 2;` |
|    1878 |  1254 | `				}else if(zIn[0] == ':' && &zIn[1] < zEnd && zIn[1] == ':'){` |
...
|    2051 |  1262 | `			rc = GenStateProcessStringExpression(&(*pGen),pGen->pIn->nLine,zExpr,zIn);` |
|    2051 |  1263 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  1264 | `				return SXERR_ABORT;` |
|       - |  1265 | `			}` |
|    2051 |  1266 | `			if( rc != SXERR_EMPTY ){` |
|    2049 |  1267 | `				++iCons;` |
|    1022 |  1268 | `			}` |
|       - |  1269 | `		}` |
...
|    2179 |  1271 | `		pObj = 0;` |
|       5 |  1272 | `	}/*for(;;)*/` |
|   21959 |  1273 | `	if( iCons > 1 ){` |
|       - |  1274 | `		/* Concatenate all compiled constants */` |
|    1621 |  1275 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_CAT,iCons,0,0,0);` |
|     808 |  1276 | `	}` |
|       - |  1277 | `	/* Node successfully compiled */` |
|   21959 |  1278 | `	return SXRET_OK;` |
|   11135 |  1279 |  |
|       - |  1280 | `/*` |
|       - |  1281 | ` * Compile a double quoted string.` |
|       - |  1282 | ` *  See the block-comment above for more information.` |
|       - |  1283 | ` */` |
|   22200 |  1284 | `PH7_PRIVATE sxi32 PH7_CompileString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  1285 |  |
|       - |  1286 | `	sxi32 rc;` |
|   22205 |  1287 | `	rc = GenStateCompileString(&(*pGen));` |
|   11100 |  1288 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|       - |  1289 | `	/* Compilation result */` |
|   22205 |  1290 | `	return rc;` |
|       5 |  1291 |  |
|       - |  1292 | `/*` |
...
|       - |  1333 | ` */` |
|   20888 |  1334 | `static sxi32 GenStateCompileArrayEntry(` |
...
|   20893 |  1345 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|       - |  1346 | `	/* Compile the expression*/` |
|   20893 |  1347 | `	rc = PH7_CompileExpr(&(*pGen),iFlags,xValidator);` |
|       - |  1348 | `	/* Restore token stream */` |
|   20893 |  1349 | `	RE_SWAP_DELIMITER(pGen);` |
|   20893 |  1350 | `	return rc;` |
|       5 |  1351 |  |
|       - |  1352 | `/*` |
...
|       - |  1390 | ` */` |
|   23106 |  1391 | `static SyToken * GenStateFindTopLevelArrow(SyToken *pStart,SyToken *pEnd)` |
|       5 |  1392 |  |
|   23111 |  1393 | `	SyToken *pCur = pStart;` |
|   23111 |  1394 | `	sxi32 iNest = 0;` |
|   65351 |  1395 | `	while( pCur < pEnd ){` |
|   47487 |  1396 | `		if( (pCur->nType & PH7_TK_ARRAY_OP) && iNest <= 0 ){` |
|    5243 |  1397 | `			return pCur;` |
|       - |  1398 | `		}` |
...
|       - |  1402 | `		 */` |
|   42249 |  1403 | `		if( iNest == 0 && (pCur->nType & PH7_TK_KEYWORD) ){` |
...
|       - |  1462 | `			}` |
|      43 |  1463 | `		}` |
|   42243 |  1464 | `		if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|     324 |  1465 | `			iNest++;` |
|   42083 |  1466 | `		}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}'*/) ){` |
...
|       - |  1479 | ` */` |
|   29866 |  1480 | `static sxi32 GenStateCompileArrayBody(ph7_gen_state *pGen)` |
|       5 |  1481 |  |
|       - |  1482 | `	sxi32 (*xValidator)(ph7_gen_state *,ph7_expr_node *); /* Expression tree validator callback */` |
|       - |  1483 | `	SyToken *pKey,*pCur;` |
|   29871 |  1484 | `	sxi32 iEmitRef = 0;` |
|   29871 |  1485 | `	sxi32 iSpread = 0;` |
|   29871 |  1486 | `	sxi32 nPair = 0;` |
|       - |  1487 | `	sxi32 rc;` |
|   29871 |  1488 | `	xValidator = 0;` |
|   24492 |  1489 | `	for(;;){` |
|       - |  1490 | `		/* Jump leading commas */` |
|   55625 |  1491 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA) ){` |
|    6641 |  1492 | `			pGen->pIn++;` |
|       5 |  1493 | `		}` |
|   48989 |  1494 | `		pCur = pGen->pIn;` |
|   48989 |  1495 | `		if( SXRET_OK != PH7_GetNextExpr(pGen->pIn,pGen->pEnd,&pGen->pIn) ){` |
|       - |  1496 | `			/* No more entry to process */` |
|   29855 |  1497 | `			break;` |
|       - |  1498 | `		}` |
|   19139 |  1499 | `		if( pCur >= pGen->pIn ){` |
|     ! 0 |  1500 | `			continue;` |
|       - |  1501 | `		}` |
|       - |  1502 | `		/* Compile the key if available */` |
|   19139 |  1503 | `		pKey = pCur;` |
|   19139 |  1504 | `		pCur = GenStateFindTopLevelArrow(pCur,pGen->pIn);` |
|   19139 |  1505 | `		rc = SXERR_EMPTY;` |
|   19139 |  1506 | `		if( pCur < pGen->pIn ){` |
|    1591 |  1507 | `			if( &pCur[1] >= pGen->pIn ){` |
|       - |  1508 | `				/* Missing value */` |
...
|    1581 |  1516 | `			rc = GenStateCompileArrayEntry(&(*pGen),pKey,pCur,` |
|       - |  1517 | `				EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,0);` |
|    1581 |  1518 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  1519 | `				return SXERR_ABORT;` |
|       - |  1520 | `			}` |
|    1581 |  1521 | `			pCur++; /* Jump the '=>' operator */` |
|   18341 |  1522 | `		}else if( pKey == pCur ){` |
...
|   17553 |  1528 | `			pCur = pKey;` |
|       - |  1529 | `		}` |
|   19129 |  1530 | `		if( rc == SXERR_EMPTY ){` |
|       - |  1531 | `			/* No available key,load NULL */` |
|   17555 |  1532 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,0 /* nil index */,0,0);` |
|    8775 |  1533 | `		}` |
|   19129 |  1534 | `		if( pCur->nType & PH7_TK_AMPER /*'&'*/){` |
...
|   19127 |  1553 | `		iSpread = (pCur < pGen->pIn && (pCur->nType & PH7_TK_ELLIPSIS)) ? 1 : 0;` |
|   19127 |  1554 | `		if( iSpread && (rc != SXERR_EMPTY \|\| iEmitRef) ){` |
...
|   19123 |  1567 | `		rc = GenStateCompileArrayEntry(&(*pGen),pCur,pGen->pIn,EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,xValidator);` |
|   19123 |  1568 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  1569 | `			return SXERR_ABORT;` |
|       - |  1570 | `		}` |
|   19123 |  1571 | `		if( iSpread ){` |
...
|   19092 |  1574 | `		}else if( iEmitRef ){` |
|       - |  1575 | `			/* Emit the load reference instruction */` |
|      40 |  1576 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_REF,0,0,0,0);` |
|      18 |  1577 | `		}` |
|   19123 |  1578 | `		xValidator = 0;` |
|   19123 |  1579 | `		iEmitRef = 0;` |
|   19123 |  1580 | `		iSpread = 0;` |
|   19123 |  1581 | `		nPair++;` |
|       5 |  1582 | `	}` |
|       - |  1583 | `	/* Emit the load map instruction */` |
|   29855 |  1584 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_MAP,nPair * 2,0,0,0);` |
|       - |  1585 | `	/* Node successfully compiled */` |
|   29855 |  1586 | `	return SXRET_OK;` |
|   14938 |  1587 |  |
|       - |  1588 | `/*` |
...
|       - |  1596 | ` */` |
|   28928 |  1597 | `PH7_PRIVATE sxi32 PH7_CompileArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  1598 |  |
|       - |  1599 | `	/* Jump the 'array' keyword and the leading '(', exclude trailing ')'. */` |
|   28933 |  1600 | `	pGen->pIn += 2;` |
|   28933 |  1601 | `	pGen->pEnd--;` |
|   14464 |  1602 | `	SXUNUSED(iCompileFlag);` |
|   28933 |  1603 | `	return GenStateCompileArrayBody(pGen);` |
|       5 |  1604 |  |
|       - |  1605 | `/*` |
...
|       - |  1609 | ` */` |
|     938 |  1610 | `PH7_PRIVATE sxi32 PH7_CompileShortArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  1611 |  |
|       - |  1612 | `	/* Jump the leading '[', exclude trailing ']'. */` |
|     943 |  1613 | `	pGen->pIn++;` |
|     943 |  1614 | `	pGen->pEnd--;` |
|     469 |  1615 | `	SXUNUSED(iCompileFlag);` |
|     943 |  1616 | `	return GenStateCompileArrayBody(pGen);` |
|       5 |  1617 |  |
|       - |  1618 | `/*` |
...
|     116 |  2389 | `	pFunc = (ph7_vm_func *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_vm_func));` |
|     116 |  2390 | `	if( pFunc == 0 ){` |
...
|     116 |  2396 | `	nLen = SyBufferFormat(zName,sizeof(zName),"[lambda_%d]",iCnt++);` |
|     218 |  2397 | `	while( SyHashGet(&pGen->pVm->hFunction,zName,nLen) != 0 && nLen < sizeof(zName) - 2 ){` |
|     104 |  2398 | `		nLen = SyBufferFormat(zName,sizeof(zName),"[lambda_%d]",iCnt++);` |
|       2 |  2399 | `	}` |
|     116 |  2400 | `	zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,zName,nLen);` |
|     116 |  2401 | `	if( zDup == 0 ){` |
|     ! 0 |  2402 | `		PH7_GenCompileError(&(*pGen),E_ERROR,nLine,` |
|       - |  2403 | `			"Fatal, PH7 engine is running out of memory");` |
|     ! 0 |  2404 | `		return SXERR_ABORT;` |
|       - |  2405 | `	}` |
|     116 |  2406 | `	PH7_VmInitFuncState(pGen->pVm,pFunc,zDup,nLen,iFlags,0);` |
|       - |  2407 | `	/* Collect function arguments */` |
|     116 |  2408 | `	if( pGen->pIn < pSigEnd ){` |
|      86 |  2409 | `		rc = GenStateCollectFuncArgs(pFunc,&(*pGen),pSigEnd,0,0);` |
|      86 |  2410 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  2411 | `			return SXERR_ABORT;` |
|       - |  2412 | `		}` |
|      42 |  2413 | `	}` |
|       - |  2414 | `	/* Point past ')' and parse optional return type */` |
|     116 |  2415 | `	pGen->pIn = &pSigEnd[1];` |
|     116 |  2416 | `	rc = GenStateParseReturnType(pGen,pFunc);` |
|     116 |  2417 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  2418 | `		return SXERR_ABORT;` |
|     116 |  2419 | `	}else if( rc == SXERR_SYNTAX ){` |
|     ! 0 |  2420 | `		return SXERR_SYNTAX;` |
|       - |  2421 | `	}` |
|       - |  2422 | `	/* Expect '=>' */` |
|     116 |  2423 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ARRAY_OP) == 0 ){` |
...
|       - |  2870 | ` */` |
| 1061622 |  2871 | `PH7_PRIVATE sxi32 PH7_CompileVariable(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  2872 |  |
| 1061627 |  2873 | `	sxu32 nLineLocal = pGen->pIn->nLine;` |
|       - |  2874 | `	sxi32 iVv;` |
|       - |  2875 | `	sxi32 iP1;` |
|       - |  2876 | `	void *p3;` |
|       - |  2877 | `	sxi32 rc;` |
| 1061627 |  2878 | `	iVv = -1; /* Variable variable counter */` |
| 2123261 |  2879 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) ){` |
| 1061639 |  2880 | `		pGen->pIn++;` |
| 1061639 |  2881 | `		iVv++;` |
|       5 |  2882 | `	}` |
| 1061627 |  2883 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_OCB/*'{'*/)) == 0 ){` |
...
|       - |  2891 | `	}` |
| 1061627 |  2892 | `	p3  = 0;` |
| 1061627 |  2893 | `	if( pGen->pIn->nType & PH7_TK_OCB/*'{'*/ ){` |
...
|       - |  2912 | `		SyString *pName;` |
| 1061611 |  2913 | `		char *zName = 0;` |
|       - |  2914 | `		/* Extract variable name */` |
| 1061611 |  2915 | `		pName = &pGen->pIn->sData;` |
|       - |  2916 | `		/* Advance the stream cursor */` |
| 1061611 |  2917 | `		pGen->pIn++;` |
| 1061611 |  2918 | `		pEntry = SyHashGet(&pGen->hVar,(const void *)pName->zString,pName->nByte);` |
| 1061611 |  2919 | `		if( pEntry == 0 ){` |
|       - |  2920 | `			/* Duplicate name */` |
|  142495 |  2921 | `			zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|  142495 |  2922 | `			if( zName == 0 ){` |
...
|  142495 |  2927 | `			SyHashInsert(&pGen->hVar,zName,pName->nByte,zName);` |
|   71250 |  2928 | `		}else{` |
|       - |  2929 | `			/* Name already available */` |
|  919121 |  2930 | `			zName = (char *)pEntry->pUserData;` |
|       - |  2931 | `		}` |
| 1061611 |  2932 | `		p3 = (void *)zName;` |
|       - |  2933 | `	}` |
| 1061623 |  2934 | `	iP1 = 0;` |
| 1061623 |  2935 | `	if( iCompileFlag & EXPR_FLAG_RDONLY_LOAD ){` |
|  386575 |  2936 | `		if( (iCompileFlag & EXPR_FLAG_LOAD_IDX_STORE) == 0 ){` |
|       - |  2937 | `			/* Read-only load.In other words do not create the variable if inexistant */` |
|  386557 |  2938 | `			iP1 = 1;` |
|  193276 |  2939 | `		}` |
|  193285 |  2940 | `	}` |
|       - |  2941 | `	/* Emit the load instruction */` |
| 1061623 |  2942 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,0,p3,0);` |
| 1061635 |  2943 | `	while( iVv > 0 ){` |
|      13 |  2944 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,0,0,0);` |
|      13 |  2945 | `		iVv--;` |
|       1 |  2946 | `	}` |
|       - |  2947 | `	/* Node successfully compiled */` |
| 1061623 |  2948 | `	return SXRET_OK;` |
|  530816 |  2949 |  |
|       - |  2950 | `/*` |
|       - |  2951 | ` * Load a literal.` |
|       - |  2952 | ` */` |
|  747408 |  2953 | `static sxi32 GenStateLoadLiteral(ph7_gen_state *pGen)` |
|       5 |  2954 |  |
|  747413 |  2955 | `	SyToken *pToken = pGen->pIn;` |
|       - |  2956 | `	ph7_value *pObj;` |
|       - |  2957 | `	SyString *pStr;` |
|       - |  2958 | `	sxu32 nIdx;` |
|       - |  2959 | `	/* Extract token value */` |
|  747413 |  2960 | `	pStr = &pToken->sData;` |
|       - |  2961 | `	/* Deal with the reserved literals [i.e: null,false,true,...] first */` |
|  747413 |  2962 | `	if( pStr->nByte == sizeof("NULL") - 1 ){` |
|  158411 |  2963 | `		if( SyStrnicmp(pStr->zString,"null",sizeof("NULL")-1) == 0 ){` |
|       - |  2964 | `			/* NULL constant are always indexed at 0 */` |
|   58357 |  2965 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,0,0,0);` |
|   58357 |  2966 | `			return SXRET_OK;` |
|  100059 |  2967 | `		}else if( SyStrnicmp(pStr->zString,"true",sizeof("TRUE")-1) == 0 ){` |
|       - |  2968 | `			/* TRUE constant are always indexed at 1 */` |
|     669 |  2969 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,1,0,0);` |
|     669 |  2970 | `			return SXRET_OK;` |
|       5 |  2971 | `		}` |
|  697869 |  2972 | `	}else if (pStr->nByte == sizeof("FALSE") - 1 &&` |
|  118334 |  2973 | `		SyStrnicmp(pStr->zString,"false",sizeof("FALSE")-1) == 0 ){` |
|       - |  2974 | `			/* FALSE constant are always indexed at 2 */` |
|   44757 |  2975 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,2,0,0);` |
|   44757 |  2976 | `			return SXRET_OK;` |
|  597343 |  2977 | `	}else if(pStr->nByte == sizeof("__LINE__") - 1 &&` |
|  106176 |  2978 | `		SyMemcmp(pStr->zString,"__LINE__",sizeof("__LINE__")-1) == 0 ){` |
|       - |  2979 | `			/* TICKET 1433-004: __LINE__ constant must be resolved at compile time,not run time */` |
|   10181 |  2980 | `			pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   10181 |  2981 | `			if( pObj == 0 ){` |
|     ! 0 |  2982 | `				PH7_GenCompileError(pGen,E_ERROR,pToken->nLine,"Fatal, PH7 engine is running out of memory");` |
|     ! 0 |  2983 | `				return SXERR_ABORT;` |
|       - |  2984 | `			}` |
|   10181 |  2985 | `			PH7_MemObjInitFromInt(pGen->pVm,pObj,pToken->nLine);` |
|       - |  2986 | `			/* Emit the load constant instruction */` |
|   10181 |  2987 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   10181 |  2988 | `			return SXRET_OK;` |
|  551234 |  2989 | `	}else if( pStr->nByte == sizeof("__NAMESPACE__") - 1 &&` |
|   34310 |  2990 | `		SyMemcmp(pStr->zString,"__NAMESPACE__",sizeof("__NAMESPACE__")-1) == 0 ){` |
...
|  550329 |  3006 | `	}else if( (pStr->nByte == sizeof("__FUNCTION__") - 1 &&` |
|   14321 |  3007 | `		SyMemcmp(pStr->zString,"__FUNCTION__",sizeof("__FUNCTION__")-1) == 0) \|\|` |
|  543164 |  3008 | `		(pStr->nByte == sizeof("__METHOD__") - 1 &&` |
|   18206 |  3009 | `		SyMemcmp(pStr->zString,"__METHOD__",sizeof("__METHOD__")-1) == 0) ){` |
...
|  633453 |  3039 | `	if( SXRET_OK != GenStateFindLiteral(&(*pGen),&pToken->sData,&nIdx) ){` |
|       - |  3040 | `		ph7_value *pLitObj;` |
|       - |  3041 | `		/* Unknown literal,install it in the literal table */` |
|  263127 |  3042 | `		pLitObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  263127 |  3043 | `		if( pLitObj == 0 ){` |
|     ! 0 |  3044 | `			PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|     ! 0 |  3045 | `			return SXERR_ABORT;` |
|       - |  3046 | `		}` |
|  263127 |  3047 | `		PH7_MemObjInitFromString(pGen->pVm,pLitObj,&pToken->sData);` |
|  263127 |  3048 | `		GenStateInstallLiteral(&(*pGen),pLitObj,nIdx);` |
|  131561 |  3049 | `	}` |
|       - |  3050 | `	/* Emit the load constant instruction */` |
|  633453 |  3051 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,1,nIdx,0,0);` |
|  633453 |  3052 | `	return SXRET_OK;` |
|  373709 |  3053 |  |
|       - |  3054 | `/*` |
...
|       - |  3059 | ` */` |
|  747448 |  3060 | `static sxi32 GenStateResolveNamespaceLiteral(ph7_gen_state *pGen)` |
|       5 |  3061 |  |
|       - |  3062 | `	sxi32 rc;` |
|  747453 |  3063 | `	if( pGen->pIn >= pGen->pEnd ){` |
|     ! 0 |  3064 | `		return SXRET_OK;` |
|       - |  3065 | `	}` |
|       - |  3066 | `	/* Check if this is a multi-token namespace path */` |
|  747453 |  3067 | `	if( pGen->pIn < &pGen->pEnd[-1] ){` |
...
|  747413 |  3120 | `	rc = GenStateLoadLiteral(&(*pGen));` |
|  747413 |  3121 | `	return rc;` |
|  373729 |  3122 |  |
|       - |  3123 | `/*` |
|       - |  3124 | ` * Compile a literal which is an identifier(name) for a simple value.` |
|       - |  3125 | ` */` |
|  747448 |  3126 | `PH7_PRIVATE sxi32 PH7_CompileLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  3127 |  |
|       - |  3128 | `	sxi32 rc;` |
|  747453 |  3129 | `	rc = GenStateResolveNamespaceLiteral(&(*pGen));` |
|  747453 |  3130 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  3131 | `		SXUNUSED(iCompileFlag); /* cc warning */` |
|     ! 0 |  3132 | `		return rc;` |
|       - |  3133 | `	}` |
|       - |  3134 | `	/* Node successfully compiled */` |
|  747453 |  3135 | `	return SXRET_OK;` |
|  373729 |  3136 |  |
|       - |  3137 | `/*` |
...
|      31 |  3210 | `	pName = &pGen->pIn->sData;` |
|       - |  3211 | `	/* Make sure the constant name isn't reserved */` |
|      31 |  3212 | `	if( GenStateIsReservedConstant(pName) ){` |
...
|       - |  3295 | ` */` |
|    3530 |  3296 | `static void GenStateEmitExceptionPopForBreak(ph7_gen_state *pGen,GenBlock *pTarget)` |
|       5 |  3297 |  |
|    3535 |  3298 | `	GenBlock *pBlock = pGen->pCurrent;` |
|   20693 |  3299 | `	while( pBlock && pBlock != pTarget ){` |
|   17163 |  3300 | `		if( pBlock->iFlags & GEN_BLOCK_EXCEPTION ){` |
...
|       - |  3310 | `			}` |
|       1 |  3311 | `		}` |
|   17163 |  3312 | `		pBlock = pBlock->pParent;` |
|       5 |  3313 | `	}` |
|    3535 |  3314 |  |
|    3434 |  3315 | `static sxi32 PH7_CompileContinue(ph7_gen_state *pGen)` |
|       5 |  3316 |  |
|       - |  3317 | `	GenBlock *pLoop; /* Target loop */` |
|       - |  3318 | `	sxi32 iLevel;    /* How many nesting loop to skip */` |
|       - |  3319 | `	sxu32 nLineLocal;` |
|       - |  3320 | `	sxi32 rc;` |
|    3439 |  3321 | `	nLineLocal = pGen->pIn->nLine;` |
|    3439 |  3322 | `	iLevel = 0;` |
|       - |  3323 | `	/* Jump the 'continue' keyword */` |
|    3439 |  3324 | `	pGen->pIn++;` |
|    3439 |  3325 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NUM) ){` |
...
|    3439 |  3351 | `	pLoop = GenStateFetchBlock(pGen->pCurrent,GEN_BLOCK_LOOP,iLevel);` |
|    3439 |  3352 | `	if( pLoop == 0 ){` |
...
|       - |  3358 | `		}` |
|       7 |  3359 | `	}else{` |
|    3429 |  3360 | `		sxu32 nInstrIdx = 0;` |
|       - |  3361 | `		/* Emit POP_EXCEPTION for any try blocks between here and the loop */` |
|    3429 |  3362 | `		GenStateEmitExceptionPopForBreak(&(*pGen),pLoop);` |
|    3429 |  3363 | `		if( pLoop->iFlags & GEN_BLOCK_SWITCH ){` |
...
|    3425 |  3375 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pLoop->nFirstInstr,0,&nInstrIdx);` |
|    3425 |  3376 | `			if( pLoop->bPostContinue == TRUE ){` |
...
|       - |  3383 | `		}` |
|       - |  3384 | `	}` |
|    3439 |  3385 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
...
|       - |  3606 | `	 */` |
|      10 |  3607 | `Consume:` |
|      21 |  3608 | `	nRawObj = nObjIdx = 0;` |
|      21 |  3609 | `	while( pGen->pRawIn < pGen->pRawEnd && pGen->pRawIn->nType != PH7_TOKEN_PHP ){` |
...
|      21 |  3655 | `		pGen->pIn = pGen->pEnd;` |
|      21 |  3656 | `		return SXERR_EOF;` |
|       - |  3657 | `	}` |
...
|       - |  3666 | ` * message.` |
|       - |  3667 | ` */` |
|  411478 |  3668 | `static sxi32 PH7_CompileBlock(` |
...
|       - |  3673 | `	sxi32 rc;` |
|       - |  3674 | `	sxu32 nLine;` |
|  411483 |  3675 | `	if( pGen->pIn->nType & PH7_TK_OCB /* '{' */ ){` |
|  409809 |  3676 | `		nLine = pGen->pIn->nLine;` |
|  409809 |  3677 | `		rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_STD,PH7_VmInstrLength(pGen->pVm),0,0);` |
|  409809 |  3678 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  3679 | `			return SXERR_ABORT;` |
|       - |  3680 | `		}` |
|  409809 |  3681 | `		pGen->pIn++;` |
|       - |  3682 | `		/* Compile until we hit the closing braces '}' */` |
|  559709 |  3683 | `		for(;;){` |
| 1119423 |  3684 | `			if( pGen->pIn >= pGen->pEnd ){` |
|      21 |  3685 | `				rc = GenStateNextChunk(&(*pGen));` |
|      21 |  3686 | `				if (rc == SXERR_ABORT ){` |
|     ! 0 |  3687 | `			 	   return SXERR_ABORT;` |
|       - |  3688 | `				}` |
|      21 |  3689 | `				if( rc == SXERR_EOF ){` |
|       - |  3690 | `					/* No more token to process. Missing closing braces */` |
|      21 |  3691 | `					PH7_GenCompileError(&(*pGen),E_ERROR,nLine,"Missing closing braces '}'");` |
|      21 |  3692 | `					break;` |
|       - |  3693 | `				}` |
|     ! 0 |  3694 | `			}` |
| 1119403 |  3695 | `			if( pGen->pIn->nType & PH7_TK_CCB/*'}'*/ ){` |
|       - |  3696 | `				/* Closing braces found,break immediately*/` |
|  409789 |  3697 | `				pGen->pIn++;` |
|  409789 |  3698 | `				break;` |
|       - |  3699 | `			}` |
|       - |  3700 | `			/* Compile a single statement */` |
|  709619 |  3701 | `			rc = GenStateCompileChunk(&(*pGen),PH7_COMPILE_SINGLE_STMT);` |
|  709619 |  3702 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  3703 | `				return SXERR_ABORT;` |
|       - |  3704 | `			}` |
|       5 |  3705 | `		}` |
|  409809 |  3706 | `		GenStateLeaveBlock(&(*pGen),0);` |
|  206581 |  3707 | `	}else if( (pGen->pIn->nType & PH7_TK_COLON /* ':' */) && nKeywordEnd > 0 ){` |
|     ! 0 |  3708 | `		pGen->pIn++;` |
...
|    1679 |  3751 | `		rc = GenStateCompileChunk(&(*pGen),PH7_COMPILE_SINGLE_STMT);` |
|    1679 |  3752 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  3753 | `			return SXERR_ABORT;` |
|       - |  3754 | `		}` |
|       - |  3755 | `	}` |
|       - |  3756 | `	/* Jump trailing semi-colons ';' */` |
|  411483 |  3757 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|     ! 0 |  3758 | `		pGen->pIn++;` |
|     ! 0 |  3759 | `	}` |
|  411483 |  3760 | `	return SXRET_OK;` |
|  205744 |  3761 |  |
|       - |  3762 | `/*` |
...
|       - |  3779 | ` *   endwhile;` |
|       - |  3780 | ` */` |
|   13680 |  3781 | `static sxi32 PH7_CompileWhile(ph7_gen_state *pGen)` |
|       5 |  3782 |  |
|   13685 |  3783 | `	GenBlock *pWhileBlock = 0;` |
|   13685 |  3784 | `	SyToken *pTmp,*pEnd = 0;` |
|       - |  3785 | `	sxu32 nFalseJump;` |
|       - |  3786 | `	sxu32 nLine;` |
|       - |  3787 | `	sxi32 rc;` |
|   13685 |  3788 | `	nLine = pGen->pIn->nLine;` |
|       - |  3789 | `	/* Jump the 'while' keyword */` |
|   13685 |  3790 | `	pGen->pIn++;` |
|   13685 |  3791 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  3792 | `		/* Syntax error */` |
...
|   13685 |  3803 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pWhileBlock);` |
|   13685 |  3804 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  3805 | `		return SXERR_ABORT;` |
|       - |  3806 | `	}` |
|       - |  3807 | `	/* Delimit the condition */` |
|   13685 |  3808 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   13685 |  3809 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|   13685 |  3818 | `	pTmp = pGen->pEnd;` |
|   13685 |  3819 | `	pGen->pEnd = pEnd;` |
|       - |  3820 | `	/* Compile the expression */` |
|   13685 |  3821 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   13685 |  3822 | `	if( rc == SXERR_ABORT ){` |
|       - |  3823 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  3824 | `		return SXERR_ABORT;` |
|       - |  3825 | `	}` |
|       - |  3826 | `	/* Update token stream */` |
|   13685 |  3827 | `	while(pGen->pIn < pEnd ){` |
...
|   13685 |  3835 | `	pGen->pIn  = &pEnd[1];` |
|   13685 |  3836 | `	pGen->pEnd = pTmp;` |
|       - |  3837 | `	/* Emit the false jump */` |
|   13685 |  3838 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nFalseJump);` |
|       - |  3839 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   13685 |  3840 | `	GenStateNewJumpFixup(pWhileBlock,PH7_OP_JZ,nFalseJump);` |
|       - |  3841 | `	/* Compile the loop body */` |
|   13685 |  3842 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDWHILE);` |
|   13685 |  3843 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  3844 | `		return SXERR_ABORT;` |
|       - |  3845 | `	}` |
|       - |  3846 | `	/* Emit the unconditional jump to the start of the loop */` |
|   13685 |  3847 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pWhileBlock->nFirstInstr,0,0);` |
|       - |  3848 | `	/* Fix all jumps now the destination is resolved */` |
|   13685 |  3849 | `	GenStateFixJumps(pWhileBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - |  3850 | `	/* Release the loop block */` |
|   13685 |  3851 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  3852 | `	/* Statement successfully compiled */` |
|   13685 |  3853 | `	return SXRET_OK;` |
|     ! 0 |  3854 | `Synchronize:` |
...
|       - |  4009 | ` */` |
|   13680 |  4010 | `static sxi32 PH7_CompileFor(ph7_gen_state *pGen)` |
|       5 |  4011 |  |
|   13685 |  4012 | `	SyToken *pTmp,*pPostStart,*pEnd = 0;` |
|   13685 |  4013 | `	GenBlock *pForBlock = 0;` |
|       - |  4014 | `	sxu32 nFalseJump;` |
|       - |  4015 | `	sxu32 nLine;` |
|       - |  4016 | `	sxi32 rc;` |
|   13685 |  4017 | `	nLine = pGen->pIn->nLine;` |
|       - |  4018 | `	/* Jump the 'for' keyword */` |
|   13685 |  4019 | `	pGen->pIn++;` |
|   13685 |  4020 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  4021 | `		/* Syntax error */` |
...
|   13685 |  4032 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   13685 |  4033 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|   13685 |  4048 | `	pTmp = pGen->pEnd;` |
|   13685 |  4049 | `	pGen->pEnd = pEnd;` |
|       - |  4050 | `	/* Compile initialization expressions if available */` |
|   13685 |  4051 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|       - |  4052 | `	/* Pop operand lvalues */` |
|   13685 |  4053 | `	if( rc == SXERR_ABORT ){` |
|       - |  4054 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4055 | `		return SXERR_ABORT;` |
|   13685 |  4056 | `	}else if( rc != SXERR_EMPTY ){` |
|   13683 |  4057 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|    6839 |  4058 | `	}` |
|   13685 |  4059 | `	if( (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|       - |  4060 | `		/* Syntax error */` |
...
|   13685 |  4072 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pForBlock);` |
|   13685 |  4073 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  4074 | `		return SXERR_ABORT;` |
|       - |  4075 | `	}` |
|       - |  4076 | `	/* Deffer continue jumps */` |
|   13685 |  4077 | `	pForBlock->bPostContinue = TRUE;` |
|       - |  4078 | `	/* Compile the condition */` |
|   13685 |  4079 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   13685 |  4080 | `	if( rc == SXERR_ABORT ){` |
|       - |  4081 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4082 | `		return SXERR_ABORT;` |
|   13685 |  4083 | `	}else if( rc != SXERR_EMPTY ){` |
|       - |  4084 | `		/* Emit the false jump */` |
|   13683 |  4085 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nFalseJump);` |
|       - |  4086 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   13683 |  4087 | `		GenStateNewJumpFixup(pForBlock,PH7_OP_JZ,nFalseJump);` |
|    6839 |  4088 | `	}` |
|   13685 |  4089 | `	if( (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|       - |  4090 | `		/* Syntax error */` |
...
|   13681 |  4102 | `	pPostStart = pGen->pIn;` |
|       - |  4103 | `	/* Compile the loop body */` |
|   13681 |  4104 | `	pGen->pIn  = &pEnd[1]; /* Jump the trailing parenthesis ')' */` |
|   13681 |  4105 | `	pGen->pEnd = pTmp;` |
|   13681 |  4106 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDFOR);` |
|   13681 |  4107 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  4108 | `		return SXERR_ABORT;` |
|       - |  4109 | `	}` |
|       - |  4110 | `	/* Fix post-continue jumps */` |
|   13681 |  4111 | `	if( SySetUsed(&pForBlock->aPostContFix) > 0 ){` |
...
|   13681 |  4127 | `	while( pPostStart < pEnd && (pPostStart->nType & PH7_TK_SEMI) ){` |
|     ! 0 |  4128 | `		pPostStart++;` |
|     ! 0 |  4129 | `	}` |
|   13681 |  4130 | `	if( pPostStart < pEnd ){` |
|       - |  4131 | `		SyToken *pTmpIn,*pTmpEnd;` |
|   13681 |  4132 | `		SWAP_DELIMITER(pGen,pPostStart,pEnd);` |
|   13681 |  4133 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   13681 |  4134 | `		if( pGen->pIn < pGen->pEnd ){` |
|       - |  4135 | `			/* Syntax error */` |
...
|       - |  4142 | `		}` |
|   13681 |  4143 | `		RE_SWAP_DELIMITER(pGen);` |
|   13681 |  4144 | `		if( rc == SXERR_ABORT ){` |
|       - |  4145 | `			/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4146 | `			return SXERR_ABORT;` |
|   13681 |  4147 | `		}else if( rc != SXERR_EMPTY){` |
|       - |  4148 | `			/* Pop operand lvalue */` |
|   13681 |  4149 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|    6838 |  4150 | `		}` |
|    6838 |  4151 | `	}` |
|       - |  4152 | `	/* Emit the unconditional jump to the start of the loop */` |
|   13681 |  4153 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pForBlock->nFirstInstr,0,0);` |
|       - |  4154 | `	/* Fix all jumps now the destination is resolved */` |
|   13681 |  4155 | `	GenStateFixJumps(pForBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - |  4156 | `	/* Release the loop block */` |
|   13681 |  4157 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  4158 | `	/* Statement successfully compiled */` |
|   13681 |  4159 | `	return SXRET_OK;` |
|    6845 |  4160 |  |
...
|       - |  4163 | ` * are allowed.` |
|       - |  4164 | ` */` |
|    7346 |  4165 | `static sxi32 GenStateForEachNodeValidator(ph7_gen_state *pGen,ph7_expr_node *pRoot)` |
|       5 |  4166 |  |
|    7351 |  4167 | `	sxi32 rc = SXRET_OK; /* Assume a valid expression tree */` |
|    7351 |  4168 | `	if( pRoot->xCode != PH7_CompileVariable ){` |
...
|       - |  4203 | ` */` |
|    3766 |  4204 | `static sxi32 PH7_CompileForeach(ph7_gen_state *pGen)` |
|       5 |  4205 |  |
|    3771 |  4206 | `	SyToken *pCur,*pTmp,*pEnd = 0;` |
|    3771 |  4207 | `	SyToken *pListStart = 0,*pListEnd = 0;` |
|    3771 |  4208 | `	GenBlock *pForeachBlock = 0;` |
|       - |  4209 | `	ph7_foreach_info *pInfo;` |
|       - |  4210 | `	sxu32 nFalseJump;` |
|       - |  4211 | `	VmInstr *pInstr;` |
|       - |  4212 | `	sxu32 nLine;` |
|       - |  4213 | `	sxi32 rc;` |
|    3771 |  4214 | `	nLine = pGen->pIn->nLine;` |
|       - |  4215 | `	/* Jump the 'foreach' keyword */` |
|    3771 |  4216 | `	pGen->pIn++;` |
|    3771 |  4217 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  4218 | `		/* Syntax error */` |
...
|    3771 |  4229 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pForeachBlock);` |
|    3771 |  4230 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  4231 | `		return SXERR_ABORT;` |
|       - |  4232 | `	}` |
|       - |  4233 | `	/* Delimit the expression */` |
|    3771 |  4234 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|    3771 |  4235 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|    3771 |  4250 | `	pCur = pGen->pIn;` |
|   25873 |  4251 | `	while( pCur < pEnd ){` |
|   25873 |  4252 | `		if( pCur->nType & PH7_TK_KEYWORD ){` |
|    3785 |  4253 | `			sxi32 nKeywrd = SX_PTR_TO_INT(pCur->pUserData);` |
|    3785 |  4254 | `			if( nKeywrd == PH7_TKWRD_AS ){` |
...
|    3771 |  4272 | `	pTmp = pGen->pEnd;` |
|    3771 |  4273 | `	pGen->pEnd = pCur;` |
|    3771 |  4274 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|    3771 |  4275 | `	if( rc == SXERR_ABORT ){` |
|       - |  4276 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4277 | `		return SXERR_ABORT;` |
|       - |  4278 | `	}` |
|       - |  4279 | `	/* Update token stream */` |
|    3771 |  4280 | `	while(pGen->pIn < pCur ){` |
...
|     ! 0 |  4286 | `		pGen->pIn++;` |
|     ! 0 |  4287 | `	}` |
|    3771 |  4288 | `	pCur++; /* Jump the 'as' keyword */` |
|    3771 |  4289 | `	pGen->pIn = pCur;` |
|    3771 |  4290 | `	if( pGen->pIn >= pEnd ){` |
...
|    3771 |  4297 | `	pInfo = (ph7_foreach_info *)SyMemBackendAlloc(&pGen->pVm->sAllocator,sizeof(ph7_foreach_info));` |
|    3771 |  4298 | `	if( pInfo == 0 ){` |
...
|    3771 |  4303 | `	SyZero(pInfo,sizeof(ph7_foreach_info));` |
|       - |  4304 | `	/* Initialize structure fields */` |
|    3771 |  4305 | `	SySetInit(&pInfo->aStep,&pGen->pVm->sAllocator,sizeof(ph7_foreach_step *));` |
...
|       - |  4308 | `	 * '=>'. */` |
|    3771 |  4309 | `	pCur = GenStateFindTopLevelArrow(pCur,pEnd);` |
|    3771 |  4310 | `	if( pCur < pEnd ){` |
|       - |  4311 | `		/* Compile the expression holding the key name */` |
|    3597 |  4312 | `		if( pGen->pIn >= pCur ){` |
...
|       - |  4317 | `			}` |
|     ! 0 |  4318 | `		}else{` |
|    3597 |  4319 | `			pGen->pEnd = pCur;` |
|    3597 |  4320 | `			rc = PH7_CompileExpr(&(*pGen),0,GenStateForEachNodeValidator);` |
|    3597 |  4321 | `			if( rc == SXERR_ABORT ){` |
|       - |  4322 | `				/* Don't worry about freeing memory, everything will be released shortly */` |
|     ! 0 |  4323 | `				return SXERR_ABORT;` |
|       - |  4324 | `			}` |
|    3597 |  4325 | `			pInstr = PH7_VmPopInstr(pGen->pVm);` |
|    3597 |  4326 | `			if( pInstr->p3 ){` |
|       - |  4327 | `				/* Record key name */` |
|    3597 |  4328 | `				SyStringInitFromBuf(&pInfo->sKey,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|    1796 |  4329 | `			}` |
|    3597 |  4330 | `			pInfo->iFlags \|= PH7_4EACH_STEP_KEY;` |
|       - |  4331 | `		}` |
|    3597 |  4332 | `		pGen->pIn = &pCur[1]; /* Jump the arrow */` |
|    1796 |  4333 | `	}` |
|    3771 |  4334 | `	pGen->pEnd = pEnd;` |
|    3771 |  4335 | `	if( pGen->pIn >= pEnd ){` |
...
|    3766 |  4390 | `	}else if( pGen->pIn->nType & PH7_TK_OSB ){` |
...
|    3759 |  4423 | `		rc = PH7_CompileExpr(&(*pGen),0,GenStateForEachNodeValidator);` |
|    3759 |  4424 | `		if( rc == SXERR_ABORT ){` |
|       - |  4425 | `			/* Don't worry about freeing memory, everything will be released shortly */` |
|     ! 0 |  4426 | `			return SXERR_ABORT;` |
|       - |  4427 | `		}` |
|    3759 |  4428 | `		pInstr = PH7_VmPopInstr(pGen->pVm);` |
|    3759 |  4429 | `		if( pInstr->p3 ){` |
|       - |  4430 | `			/* Record value name */` |
|    3759 |  4431 | `			SyStringInitFromBuf(&pInfo->sValue,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|    1877 |  4432 | `		}` |
|       - |  4433 | `	}` |
|       - |  4434 | `	/* Emit the 'FOREACH_INIT' instruction */` |
|    3769 |  4435 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_FOREACH_INIT,0,0,pInfo,&nFalseJump);` |
|       - |  4436 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|    3769 |  4437 | `	GenStateNewJumpFixup(pForeachBlock,PH7_OP_FOREACH_INIT,nFalseJump);` |
|       - |  4438 | `	/* Record the first instruction to execute */` |
|    3769 |  4439 | `	pForeachBlock->nFirstInstr = PH7_VmInstrLength(pGen->pVm);` |
|       - |  4440 | `	/* Emit the FOREACH_STEP instruction */` |
|    3769 |  4441 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_FOREACH_STEP,0,0,pInfo,&nFalseJump);` |
|       - |  4442 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|    3769 |  4443 | `	GenStateNewJumpFixup(pForeachBlock,PH7_OP_FOREACH_STEP,nFalseJump);` |
|       - |  4444 | `	/* If list() unpacking, emit bytecode to destructure the temp variable */` |
|    3769 |  4445 | `	if( (pInfo->iFlags & PH7_4EACH_STEP_LIST) && pListStart && pListEnd ){` |
...
|    3769 |  4473 | `	pGen->pIn = &pEnd[1];` |
|    3769 |  4474 | `	pGen->pEnd = pTmp;` |
|    3769 |  4475 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_END4EACH);` |
|    3769 |  4476 | `	if( rc == SXERR_ABORT ){` |
...
|    3769 |  4481 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pForeachBlock->nFirstInstr,0,0);` |
|       - |  4482 | `	/* Fix all jumps now the destination is resolved */` |
|    3769 |  4483 | `	GenStateFixJumps(pForeachBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - |  4484 | `	/* Release the loop block */` |
|    3769 |  4485 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  4486 | `	/* Statement successfully compiled */` |
|    3769 |  4487 | `	return SXRET_OK;` |
|       1 |  4488 | `Synchronize:` |
...
|       - |  4527 | ` *    ?>` |
|       - |  4528 | ` */` |
|  142260 |  4529 | `static sxi32 PH7_CompileIf(ph7_gen_state *pGen)` |
|       5 |  4530 |  |
|  142265 |  4531 | `	SyToken *pToken,*pTmp,*pEnd = 0;` |
|  142265 |  4532 | `	GenBlock *pCondBlock = 0;` |
|       - |  4533 | `	sxu32 nJumpIdx;` |
|       - |  4534 | `	sxu32 nKeyID;` |
|       - |  4535 | `	sxi32 rc;` |
|       - |  4536 | `	/* Jump the 'if' keyword */` |
|  142265 |  4537 | `	pGen->pIn++;` |
|  142265 |  4538 | `	pToken = pGen->pIn;` |
|       - |  4539 | `	/* Create the conditional block */` |
|  142265 |  4540 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_COND,PH7_VmInstrLength(pGen->pVm),0,&pCondBlock);` |
|  142265 |  4541 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  4542 | `		return SXERR_ABORT;` |
|       - |  4543 | `	}` |
|       - |  4544 | `	/* Process as many [if/else if/elseif/else] blocks as we can */` |
|   77967 |  4545 | `	for(;;){` |
|  155939 |  4546 | `		if( pToken >= pGen->pEnd \|\| (pToken->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  4547 | `			/* Syntax error */` |
...
|  155939 |  4561 | `		PH7_DelimitNestedTokens(pToken,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|  155939 |  4562 | `		if( pToken >= pEnd \|\| (pEnd->nType & PH7_TK_RPAREN) == 0 ){` |
|       - |  4563 | `			/* Syntax error */` |
...
|  155939 |  4575 | `		SWAP_TOKEN_STREAM(pGen,pToken,pEnd);` |
|       - |  4576 | `		/* Compile the condition */` |
|  155939 |  4577 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|       - |  4578 | `		/* Update token stream */` |
|  155939 |  4579 | `		while(pGen->pIn < pEnd ){` |
|     ! 0 |  4580 | `			PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Unexpected token '%z'",&pGen->pIn->sData);` |
|     ! 0 |  4581 | `			pGen->pIn++;` |
|     ! 0 |  4582 | `		}` |
|  155939 |  4583 | `		pGen->pIn  = &pEnd[1];` |
|  155939 |  4584 | `		pGen->pEnd = pTmp;` |
|  155939 |  4585 | `		if( rc == SXERR_ABORT ){` |
|       - |  4586 | `			/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4587 | `			return SXERR_ABORT;` |
|       - |  4588 | `		}` |
|       - |  4589 | `		/* Emit the false jump */` |
|  155939 |  4590 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nJumpIdx);` |
|       - |  4591 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|  155939 |  4592 | `		GenStateNewJumpFixup(pCondBlock,PH7_OP_JZ,nJumpIdx);` |
|       - |  4593 | `		/* Compile the body */` |
|  155939 |  4594 | `		rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDIF);` |
|  155939 |  4595 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  4596 | `			return SXERR_ABORT;` |
|       - |  4597 | `		}` |
|  155939 |  4598 | `		if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
|   43474 |  4599 | `			break;` |
|       - |  4600 | `		}` |
|       - |  4601 | `		/* Ensure that the keyword ID is 'else if' or 'else' */` |
|   69001 |  4602 | `		nKeyID = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   69001 |  4603 | `		if( (nKeyID & (PH7_TKWRD_ELSE\|PH7_TKWRD_ELIF)) == 0 ){` |
|   44393 |  4604 | `			break;` |
|       - |  4605 | `		}` |
|       - |  4606 | `		/* Emit the unconditional jump */` |
|   24613 |  4607 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,0,0,&nJumpIdx);` |
|       - |  4608 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   24613 |  4609 | `		GenStateNewJumpFixup(pCondBlock,PH7_OP_JMP,nJumpIdx);` |
|   24613 |  4610 | `		if( nKeyID & PH7_TKWRD_ELSE ){` |
|   17719 |  4611 | `			pToken = &pGen->pIn[1];` |
|   17719 |  4612 | `			if( pToken >= pGen->pEnd \|\| (pToken->nType & PH7_TK_KEYWORD) == 0 \|\|` |
|    6832 |  4613 | `				SX_PTR_TO_INT(pToken->pUserData) != PH7_TKWRD_IF ){` |
|    5472 |  4614 | `					break;` |
|       - |  4615 | `			}` |
|    6785 |  4616 | `			pGen->pIn++; /* Jump the 'else' keyword */` |
|    3390 |  4617 | `		}` |
|   13679 |  4618 | `		pGen->pIn++; /* Jump the 'elseif/if' keyword */` |
|       - |  4619 | `		/* Synchronize cursors */` |
|   13679 |  4620 | `		pToken = pGen->pIn;` |
|       - |  4621 | `		/* Fix the false jump */` |
|   13679 |  4622 | `		GenStateFixJumps(pCondBlock,PH7_OP_JZ,PH7_VmInstrLength(pGen->pVm));` |
|       5 |  4623 | `	} /* For(;;) */` |
|       - |  4624 | `	/* Fix the false jump */` |
|  142265 |  4625 | `	GenStateFixJumps(pCondBlock,PH7_OP_JZ,PH7_VmInstrLength(pGen->pVm));` |
|  142265 |  4626 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|   55322 |  4627 | `		(SX_PTR_TO_INT(pGen->pIn->pUserData) & PH7_TKWRD_ELSE) ){` |
|       - |  4628 | `			/* Compile the else block */` |
|   10939 |  4629 | `			pGen->pIn++;` |
|   10939 |  4630 | `			rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDIF);` |
|   10939 |  4631 | `			if( rc == SXERR_ABORT ){` |
|       - |  4632 |  |
|     ! 0 |  4633 | `				return SXERR_ABORT;` |
|       - |  4634 | `			}` |
|    5467 |  4635 | `	}` |
|  142265 |  4636 | `	nJumpIdx = PH7_VmInstrLength(pGen->pVm);` |
|       - |  4637 | `	/* Fix all unconditional jumps now the destination is resolved */` |
|  142265 |  4638 | `	GenStateFixJumps(pCondBlock,PH7_OP_JMP,nJumpIdx);` |
|       - |  4639 | `	/* Release the conditional block */` |
|  142265 |  4640 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  4641 | `	/* Statement successfully compiled */` |
|  142265 |  4642 | `	return SXRET_OK;` |
|     ! 0 |  4643 | `Synchronize:` |
...
|       - |  4743 | ` */` |
|  224900 |  4744 | `static sxi32 PH7_CompileReturn(ph7_gen_state *pGen)` |
|       5 |  4745 |  |
|  224905 |  4746 | `	sxi32 nRet = 0; /* TRUE if there is a return value */` |
|       - |  4747 | `	sxi32 rc;` |
|       - |  4748 | `	/* Jump the 'return' keyword */` |
|  224905 |  4749 | `	pGen->pIn++;` |
|  224905 |  4750 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|       - |  4751 | `		/* Compile the expression */` |
|  224879 |  4752 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|  224879 |  4753 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  4754 | `			return SXERR_ABORT;` |
|  224879 |  4755 | `		}else if(rc != SXERR_EMPTY ){` |
|  224879 |  4756 | `			nRet = 1;` |
|  112437 |  4757 | `		}` |
|  112437 |  4758 | `	}` |
...
|  224905 |  4764 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,nRet,1,0,0);` |
|  224905 |  4765 | `	return SXRET_OK;` |
|  112455 |  4766 |  |
|       - |  4767 | `/*` |
...
|       - |  4772 | ` */` |
|     130 |  4773 | `PH7_PRIVATE sxi32 PH7_CompileYield(ph7_gen_state *pGen, sxi32 iCompileFlag)` |
|       5 |  4774 |  |
|       - |  4775 | `	SyToken *pTmp, *pSplit;` |
|     135 |  4776 | `	sxi32 iP1 = 0; /* 1 if value present */` |
|     135 |  4777 | `	sxi32 iP2 = 0; /* 1 if key => value */` |
|       - |  4778 | `	sxi32 rc;` |
|      65 |  4779 | `	(void)iCompileFlag;` |
...
|     147 |  4787 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_ID)` |
|      82 |  4788 | `		&& pGen->pIn->sData.nByte == 4` |
...
|       - |  4805 | `	}` |
|     101 |  4806 | `	if( pGen->pIn >= pGen->pEnd ){` |
...
|     101 |  4812 | `	pSplit = 0;` |
|       - |  4813 | `	{` |
|     101 |  4814 | `		SyToken *pCur = pGen->pIn;` |
|     101 |  4815 | `		sxi32 nNest = 0;` |
|     213 |  4816 | `		while( pCur < pGen->pEnd ){` |
|     131 |  4817 | `			if( pCur->nType & (PH7_TK_LPAREN\|PH7_TK_OSB\|PH7_TK_OCB) ){` |
|     ! 0 |  4818 | `				nNest++;` |
|     131 |  4819 | `			}else if( pCur->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB) ){` |
|     ! 0 |  4820 | `				nNest--;` |
|     131 |  4821 | `			}else if( nNest == 0 && (pCur->nType & PH7_TK_ARRAY_OP) ){` |
|      16 |  4822 | `				pSplit = pCur;` |
|      16 |  4823 | `				break;` |
|       - |  4824 | `			}` |
|     117 |  4825 | `			pCur++;` |
...
|       9 |  4840 | `	}else{` |
|       - |  4841 | `		/* yield $value */` |
|      87 |  4842 | `		rc = PH7_CompileExpr(pGen, 0, 0);` |
|      87 |  4843 | `		if( rc == SXERR_ABORT ) return SXERR_ABORT;` |
|      87 |  4844 | `		if( rc != SXERR_EMPTY ){` |
|      87 |  4845 | `			iP1 = 1;` |
|      41 |  4846 | `		}` |
|       - |  4847 | `	}` |
|     101 |  4848 | `	pGen->pEnd = pTmp;` |
|     101 |  4849 | `	PH7_VmEmitInstr(pGen->pVm, PH7_OP_YIELD, iP1, iP2, 0, 0);` |
|     101 |  4850 | `	return SXRET_OK;` |
|      70 |  4851 |  |
|       - |  4852 | `/*` |
...
|       - |  4878 | ` */` |
|   13986 |  4879 | `static sxi32 PH7_CompileEcho(ph7_gen_state *pGen)` |
|       5 |  4880 |  |
|   13991 |  4881 | `	SyToken *pTmp,*pNext = 0;` |
|       - |  4882 | `	sxi32 rc;` |
|       - |  4883 | `	/* Jump the 'echo' keyword */` |
|   13991 |  4884 | `	pGen->pIn++;` |
|       - |  4885 | `	/* Compile arguments one after one */` |
|   13991 |  4886 | `	pTmp = pGen->pEnd;` |
|   30475 |  4887 | `	while( SXRET_OK == PH7_GetNextExpr(pGen->pIn,pTmp,&pNext) ){` |
|   16489 |  4888 | `		if( pGen->pIn < pNext ){` |
|   16489 |  4889 | `			pGen->pEnd = pNext;` |
|   16489 |  4890 | `			rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_RDONLY_LOAD/* Do not create variable if inexistant */,0);` |
|   16489 |  4891 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  4892 | `				return SXERR_ABORT;` |
|   16489 |  4893 | `			}else if( rc != SXERR_EMPTY ){` |
|       - |  4894 | `				/* Emit the consume instruction */` |
|   16465 |  4895 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_CONSUME,1,0,0,0);` |
|    8230 |  4896 | `			}` |
|    8242 |  4897 | `		}` |
|       - |  4898 | `		/* Jump trailing commas */` |
|   18987 |  4899 | `		while( pNext < pTmp && (pNext->nType & PH7_TK_COMMA) ){` |
|    2503 |  4900 | `			pNext++;` |
|       5 |  4901 | `		}` |
|   16489 |  4902 | `		pGen->pIn = pNext;` |
|       5 |  4903 | `	}` |
|       - |  4904 | `	/* Restore token stream */` |
|   13991 |  4905 | `	pGen->pEnd = pTmp;` |
|   13991 |  4906 | `	return SXRET_OK;` |
|    6998 |  4907 |  |
|       - |  4908 | `/*` |
...
|       - |  5073 | ` */` |
|  419894 |  5074 | `static sxu32 GenStateNsQualifyName(ph7_gen_state *pGen,sxu32 nOrigIdx,SyHash *pImports,int *pFromImport)` |
|       5 |  5075 |  |
|       - |  5076 | `	ph7_value *pLit;` |
...
|       - |  5084 | `	ph7_value *pNew;` |
|  419899 |  5085 | `	if( pFromImport ){` |
|  401409 |  5086 | `		*pFromImport = 0;` |
|  200702 |  5087 | `	}` |
|  419899 |  5088 | `	pLit = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,nOrigIdx);` |
|  419899 |  5089 | `	if( !pLit \|\| !(pLit->iFlags & MEMOBJ_STRING) \|\| SyBlobLength(&pLit->sBlob) == 0 ){` |
|     ! 0 |  5090 | `		return nOrigIdx;` |
|       - |  5091 | `	}` |
|  419899 |  5092 | `	zLit = (const char *)SyBlobData(&pLit->sBlob);` |
|  419899 |  5093 | `	nLit = (sxu32)SyBlobLength(&pLit->sBlob);` |
|       - |  5094 | `	/* Skip if already qualified (contains backslash) */` |
|  419899 |  5095 | `	hasNsSep = 0;` |
| 4542547 |  5096 | `	for( k = 0; k < nLit; k++ ){` |
| 4122661 |  5097 | `		if( zLit[k] == '\\' ){ hasNsSep = 1; break; }` |
| 2061329 |  5098 | `	}` |
|  419899 |  5099 | `	if( hasNsSep ){` |
|      11 |  5100 | `		return nOrigIdx;` |
|       - |  5101 | `	}` |
|       - |  5102 | `	/* Check use imports first (works even outside namespaces) */` |
|  419891 |  5103 | `	SyBlobReset(&pGen->sWorker);` |
|  419891 |  5104 | `	pImport = SyHashGet(pImports,(const void *)zLit,nLit);` |
|  419891 |  5105 | `	if( pImport ){` |
...
|       8 |  5110 | `		}` |
|      23 |  5111 | `	}else{` |
|  419855 |  5112 | `		if( SyBlobLength(&pGen->sNamespace) == 0 ){` |
|  419765 |  5113 | `			return nOrigIdx; /* Not in a namespace and no import match */` |
|       - |  5114 | `		}` |
...
|       - |  5136 | ` */` |
|   92290 |  5137 | `static void GenStateResolveName(ph7_gen_state *pGen,const SyString *pName,SyBlob *pOut)` |
|       5 |  5138 |  |
|       - |  5139 | `	SyHashEntry *pImport;` |
|       - |  5140 | `	/* Check use imports first */` |
|   92295 |  5141 | `	pImport = SyHashGet(&pGen->hUseImports,(const void *)pName->zString,pName->nByte);` |
|   92295 |  5142 | `	if( pImport ){` |
...
|       - |  5158 | ` */` |
|  130034 |  5159 | `static void GenStateBuildFQN(ph7_gen_state *pGen,const SyString *pName,SyBlob *pOut)` |
|       5 |  5160 |  |
|  130039 |  5161 | `	if( SyBlobLength(&pGen->sNamespace) > 0 ){` |
|      63 |  5162 | `		SyBlobAppend(pOut,SyBlobData(&pGen->sNamespace),SyBlobLength(&pGen->sNamespace));` |
|      63 |  5163 | `		SyBlobAppend(pOut,"\\",1);` |
|      29 |  5164 | `	}` |
|  130039 |  5165 | `	SyBlobAppend(pOut,pName->zString,pName->nByte);` |
|  130039 |  5166 |  |
|       - |  5167 | `/*` |
...
|       6 |  5471 | `		rc = PH7_GenCompileError(pGen,E_ERROR,nLine,"declare: Expecting opening parenthesis '('");` |
|       6 |  5472 | `		if( rc == SXERR_ABORT ){` |
...
|      16 |  5607 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & (PH7_TK_SEMI/*';'*/\|PH7_TK_OCB/*'{'*/)) == 0 ){` |
|      12 |  5608 | `		pGen->pIn++;` |
|       2 |  5609 | `	}` |
|       6 |  5610 | `	return SXRET_OK;` |
|      25 |  5611 |  |
|       - |  5612 | `/*` |
...
|       - |  5663 | ` */` |
|   64444 |  5664 | `static sxi32 GenStateProcessArgValue(ph7_gen_state *pGen,ph7_vm_func_arg *pArg,SyToken *pIn,SyToken *pEnd)` |
|       5 |  5665 |  |
|       - |  5666 | `	SyToken *pTmpIn,*pTmpEnd;` |
|       - |  5667 | `	SySet *pInstrContainer;` |
|       - |  5668 | `	sxi32 rc;` |
|       - |  5669 | `	/* Swap token stream */` |
|   64449 |  5670 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|   64449 |  5671 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   64449 |  5672 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pArg->aByteCode);` |
|       - |  5673 | `	/* Compile the expression holding the argument value */` |
|   64449 |  5674 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|       - |  5675 | `	/* Emit the done instruction */` |
|   64449 |  5676 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,(rc != SXERR_EMPTY ? 1 : 0),0,0,0);` |
|   64449 |  5677 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|   64449 |  5678 | `	RE_SWAP_DELIMITER(pGen);` |
|   64449 |  5679 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  5680 | `		return SXERR_ABORT;` |
|       - |  5681 | `	}` |
|   64449 |  5682 | `	return SXRET_OK;` |
|   32227 |  5683 |  |
|       - |  5684 | `/*` |
...
|       - |  5720 | ` */` |
|   89358 |  5721 | `static sxi32 GenStateCollectFuncArgs(ph7_vm_func *pFunc,ph7_gen_state *pGen,SyToken *pEnd,int bCtorCtx,int bAbstractCtx)` |
|       5 |  5722 |  |
...
|       - |  5727 | `	sxi32 rc;` |
|       - |  5728 |  |
|   89363 |  5729 | `	pIn = pGen->pIn;` |
|   89363 |  5730 | `	SyBlobInit(&sSig,&pGen->pVm->sAllocator);` |
|       - |  5731 | `	/* Process arguments one after one */` |
|  111751 |  5732 | `	for(;;){` |
|  223507 |  5733 | `		if( pIn >= pEnd ){` |
|       - |  5734 | `			/* No more arguments to process */` |
|   89351 |  5735 | `			break;` |
|       - |  5736 | `		}` |
|  134161 |  5737 | `		SyZero(&sArg,sizeof(ph7_vm_func_arg));` |
|  134161 |  5738 | `		SySetInit(&sArg.aByteCode,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|  134161 |  5739 | `		SySetInit(&sArg.aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|  134161 |  5740 | `		SyStringInitFromBuf(&sArg.sTypeName,0,0);` |
...
|       - |  5746 | `		{` |
|  134161 |  5747 | `			int bReadonly = 0, bVisSeen = 0;` |
|  134161 |  5748 | `			sxi32 iVis = PH7_CLASS_PROT_PUBLIC;` |
|  134161 |  5749 | `			if( pIn < pEnd && GenStateIsReadonly(pIn) ){` |
|       3 |  5750 | `				bReadonly = 1;` |
|       3 |  5751 | `				pIn++;` |
|       1 |  5752 | `			}` |
|  134161 |  5753 | `			if( pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD) ){` |
|   61221 |  5754 | `				sxu32 nKw = (sxu32)SX_PTR_TO_INT(pIn->pUserData);` |
|   61221 |  5755 | `				if( nKw == PH7_TKWRD_PUBLIC \|\| nKw == PH7_TKWRD_PROTECTED \|\| nKw == PH7_TKWRD_PRIVATE ){` |
|      67 |  5756 | `					bVisSeen = 1;` |
...
|      31 |  5765 | `				}` |
|   30608 |  5766 | `			}` |
|  134161 |  5767 | `			if( bVisSeen \|\| bReadonly ){` |
|      69 |  5768 | `				if( !bCtorCtx ){` |
...
|  169877 |  5789 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_DOLLAR) == 0` |
|  104509 |  5790 | `			&& (pIn->nType & PH7_TK_AMPER) == 0` |
|   73163 |  5791 | `			&& (pIn->nType & PH7_TK_ELLIPSIS) == 0 ){` |
|   71433 |  5792 | `			sxu32 nLineLocal = pIn->nLine;` |
|   71433 |  5793 | `			sxi32 iTFlags = 0;` |
|   71433 |  5794 | `			pGen->pIn = pIn;` |
|   71433 |  5795 | `			rc = GenStateParseUnionTypeDecl(` |
|   35714 |  5796 | `				pGen, &sArg.nType, &sArg.sClass, &sArg.aUnionAlts,` |
|   35714 |  5797 | `				&iTFlags, &sArg.sTypeName,` |
|       - |  5798 | `				VM_FUNC_ARG_NULLABLE, VM_FUNC_ARG_UNION,` |
|       - |  5799 | `				/* bAllowVoid */ 0,` |
|   35714 |  5800 | `						nLineLocal);` |
|   71433 |  5801 | `			pIn = pGen->pIn;` |
|   71433 |  5802 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  5803 | `				return SXERR_ABORT;` |
|   71433 |  5804 | `			}else if( rc == SXERR_CORRUPT ){` |
|       - |  5805 | `				/* Error already reported by GenStateParseUnionTypeDecl */` |
|       3 |  5806 | `				return SXERR_SYNTAX;` |
|   71431 |  5807 | `			}else if( rc == SXERR_SYNTAX ){` |
|       6 |  5808 | `				if( pIn < pEnd ){` |
...
|       - |  5817 | `			}` |
|   71427 |  5818 | `			sArg.iFlags \|= iTFlags;` |
|   35711 |  5819 | `		}` |
|  134151 |  5820 | `		if( pIn >= pEnd ){` |
|     ! 0 |  5821 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Missing argument name");` |
|     ! 0 |  5822 | `			return rc;` |
|       - |  5823 | `		}` |
|  134151 |  5824 | `		if( pIn->nType & PH7_TK_AMPER ){` |
|       - |  5825 | `			/* Pass by reference,record that */` |
|    3423 |  5826 | `			sArg.iFlags \|= VM_FUNC_ARG_BY_REF;` |
|    3423 |  5827 | `			pIn++;` |
|    1709 |  5828 | `		}` |
|  134151 |  5829 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_ELLIPSIS) ){` |
|       - |  5830 | `			/* Variadic parameter: ...$args */` |
|      47 |  5831 | `			sArg.iFlags \|= VM_FUNC_ARG_VARIADIC;` |
|      47 |  5832 | `			pIn++;` |
|      21 |  5833 | `		}` |
|  134151 |  5834 | `		if( pIn >= pEnd \|\| (pIn->nType & PH7_TK_DOLLAR) == 0 \|\| &pIn[1] >= pEnd \|\| (pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|       - |  5835 | `			/* Invalid argument */` |
|     ! 0 |  5836 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Invalid argument name");` |
|     ! 0 |  5837 | `			return rc;` |
|       - |  5838 | `		}` |
|  134151 |  5839 | `		pIn++; /* Jump the dollar sign */` |
|       - |  5840 | `		/* Copy argument name */` |
|  134151 |  5841 | `		zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,SyStringData(&pIn->sData),SyStringLength(&pIn->sData));` |
|  134151 |  5842 | `		if( zDup == 0 ){` |
|     ! 0 |  5843 | `			PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"PH7 engine is running out of memory");` |
|     ! 0 |  5844 | `			return SXERR_ABORT;` |
|       - |  5845 | `		}` |
|  134151 |  5846 | `		SyStringInitFromBuf(&sArg.sName,zDup,SyStringLength(&pIn->sData));` |
|  134151 |  5847 | `		pIn++;` |
|  134151 |  5848 | `		if( pIn < pEnd ){` |
|   75347 |  5849 | `			if( pIn->nType & PH7_TK_EQUAL ){` |
|       - |  5850 | `				SyToken *pDefend;` |
|   64451 |  5851 | `				sxi32 iNest = 0;` |
|   64451 |  5852 | `				pIn++; /* Jump the equal sign */` |
|   64451 |  5853 | `				pDefend = pIn;` |
|       - |  5854 | `				/* Process the default value associated with this argument */` |
|  135675 |  5855 | `				while( pDefend < pEnd ){` |
|  105137 |  5856 | `					if( (pDefend->nType & PH7_TK_COMMA) && iNest <= 0 ){` |
|   33913 |  5857 | `						break;` |
|       - |  5858 | `					}` |
|   71229 |  5859 | `					if( pDefend->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*[*/) ){` |
|       - |  5860 | `						/* Increment nesting level */` |
|    3395 |  5861 | `						iNest++;` |
|   69534 |  5862 | `					}else if( pDefend->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CCB/*'}'*/\|PH7_TK_CSB/*]*/) ){` |
|       - |  5863 | `						/* Decrement nesting level */` |
|    3395 |  5864 | `						iNest--;` |
|    1695 |  5865 | `					}` |
|   71229 |  5866 | `					pDefend++;` |
|       5 |  5867 | `				}` |
|   64451 |  5868 | `				if( pIn >= pDefend ){` |
|       3 |  5869 | `					rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Missing argument default value");` |
|       3 |  5870 | `					return rc;` |
|       - |  5871 | `				}` |
|       - |  5872 | `				/* Process default value */` |
|   64449 |  5873 | `				rc = GenStateProcessArgValue(&(*pGen),&sArg,pIn,pDefend);` |
|   64449 |  5874 | `				if( rc != SXRET_OK ){` |
|     ! 0 |  5875 | `					return rc;` |
|       - |  5876 | `				}` |
|       - |  5877 | `				/* Point beyond the default value */` |
|   64449 |  5878 | `				pIn = pDefend;` |
|   32222 |  5879 | `			}` |
|   75345 |  5880 | `			if( pIn < pEnd && (pIn->nType & PH7_TK_COMMA) == 0 ){` |
|     ! 0 |  5881 | `				rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Unexpected token '%z'",&pIn->sData);` |
|     ! 0 |  5882 | `				return rc;` |
|       - |  5883 | `			}` |
|   75345 |  5884 | `			pIn++; /* Jump the trailing comma */` |
|   37670 |  5885 | `		}` |
|       - |  5886 | `		/* Append argument signature */` |
|  134149 |  5887 | `		if( sArg.nType > 0 ){` |
|   71383 |  5888 | `			if( SyStringLength(&sArg.sClass) > 0 ){` |
|       - |  5889 | `				/* Class name — prefix with 'o' so generic object hint is a prefix match */` |
|   10197 |  5890 | `				int marker = 'o';` |
|   10197 |  5891 | `				SyBlobAppend(&sSig,(const void *)&marker,sizeof(char));` |
|   10197 |  5892 | `				SyBlobAppend(&sSig,SyStringData(&sArg.sClass),SyStringLength(&sArg.sClass));` |
|    5101 |  5893 | `			}else{` |
|       - |  5894 | `				int c;` |
|   61191 |  5895 | `				c = 'n'; /* cc warning */` |
|       - |  5896 | `				/* Type leading character */` |
|   61191 |  5897 | `				switch(sArg.nType){` |
|       3 |  5898 | `				case MEMOBJ_HASHMAP:` |
|       - |  5899 | `					/* Hashmap aka 'array' */` |
|       7 |  5900 | `					c = 'h';` |
|       7 |  5901 | `					break;` |
|    8521 |  5902 | `				case MEMOBJ_INT:` |
|       - |  5903 | `					/* Integer */` |
|   17047 |  5904 | `					c = 'i';` |
|   17047 |  5905 | `					break;` |
...
|       2 |  5923 | `					break;` |
|       - |  5924 | `				}` |
|   61191 |  5925 | `				SyBlobAppend(&sSig,(const void *)&c,sizeof(char));` |
|       - |  5926 | `			}` |
|   35694 |  5927 | `		}else{` |
|       - |  5928 | `			/* No type is associated with this parameter which mean` |
|       - |  5929 | `			 * that this function is not condidate for overloading.` |
|       - |  5930 | `			 */` |
|   62771 |  5931 | `			SyBlobRelease(&sSig);` |
|       - |  5932 | `		}` |
|       - |  5933 | `		/* Save in the argument set */` |
|  134149 |  5934 | `		SySetPut(&pFunc->aArgs,(const void *)&sArg);` |
|       5 |  5935 | `	}` |
|   89351 |  5936 | `	if( SyBlobLength(&sSig) > 0 ){` |
|       - |  5937 | `		/* Save function signature */` |
|   44231 |  5938 | `		SyStringInitFromBuf(&pFunc->sSignature,SyBlobData(&sSig),SyBlobLength(&sSig));` |
|   22113 |  5939 | `	}` |
|   89351 |  5940 | `	return SXRET_OK;` |
|   44684 |  5941 |  |
|       - |  5942 | `/*` |
...
|       - |  5946 | ` */` |
|  212246 |  5947 | `static sxi32 GenStateCompileFuncBody(` |
...
|  212251 |  5957 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC,PH7_VmInstrLength(pGen->pVm),pFunc,&pBlock);` |
|  212251 |  5958 | `	if( rc != SXRET_OK ){` |
...
|       - |  5962 | `	}` |
|  212251 |  5963 | `	nGotoOfft = SySetUsed(&pGen->aGoto);` |
|       - |  5964 | `	/* Swap bytecode containers */` |
|  212251 |  5965 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|  212251 |  5966 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pFunc->aByteCode);` |
...
|       - |  5971 | `	{` |
|  212251 |  5972 | `		sxu32 nArg = SySetUsed(&pFunc->aArgs);` |
|       - |  5973 | `		sxu32 i;` |
|  319151 |  5974 | `		for( i = 0; i < nArg; i++ ){` |
|  106905 |  5975 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pFunc->aArgs,i);` |
|       - |  5976 | `			char *zSrc;` |
|       - |  5977 | `			sxu32 nSrc,nName;` |
|       - |  5978 | `			SySet sToken;` |
|       - |  5979 | `			SyToken *pTmpIn,*pTmpEnd;` |
|       - |  5980 | `			sxi32 rcPromote;` |
|  106905 |  5981 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|  106855 |  5982 | `				continue;` |
|       - |  5983 | `			}` |
...
|  212251 |  6030 | `	PH7_CompileBlock(&(*pGen),0);` |
|       - |  6031 | `	/* Fix exception jumps now the destination is resolved */` |
|  212251 |  6032 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|       - |  6033 | `	/* Emit the final return if not yet done */` |
|  212251 |  6034 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|       - |  6035 | `	/* Fix gotos jumps now the destination is resolved */` |
|  212251 |  6036 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),nGotoOfft) ){` |
|     ! 0 |  6037 | `		rc = SXERR_ABORT;` |
|     ! 0 |  6038 | `	}` |
|  212251 |  6039 | `	SySetTruncate(&pGen->aGoto,nGotoOfft);` |
|       - |  6040 | `	/* Restore the default container */` |
|  212251 |  6041 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|       - |  6042 | `	/* Leave function block */` |
|  212251 |  6043 | `	GenStateLeaveBlock(&(*pGen),0);` |
|  212251 |  6044 | `	if( rc == SXERR_ABORT ){` |
...
|       - |  6049 | `	{` |
|  212251 |  6050 | `		VmInstr *aInstr = (VmInstr *)SySetBasePtr(&pFunc->aByteCode);` |
|       - |  6051 | `		sxu32 i;` |
| 4145233 |  6052 | `		for( i = 0; i < SySetUsed(&pFunc->aByteCode); i++ ){` |
| 3933061 |  6053 | `			if( aInstr[i].iOp == PH7_OP_YIELD \|\| aInstr[i].iOp == PH7_OP_YIELD_FROM ){` |
|      79 |  6054 | `				pFunc->iFlags \|= VM_FUNC_GENERATOR;` |
|      79 |  6055 | `				break;` |
|       - |  6056 | `			}` |
| 1966496 |  6057 | `		}` |
|       - |  6058 | `	}` |
|       - |  6059 | `	/* All done, function body compiled */` |
|  212251 |  6060 | `	return SXRET_OK;` |
|  106128 |  6061 |  |
|       - |  6062 | `/*` |
...
|       - |  6124 | ` */` |
|   72114 |  6125 | `static sxi32 GenStateParseOneTypeAtom(ph7_gen_state *pGen, PhlTypeAtom *pOut)` |
|       5 |  6126 |  |
|   72119 |  6127 | `	SyToken *pIn = pGen->pIn;` |
|   72119 |  6128 | `	SyZero(pOut, sizeof(*pOut));` |
|   72119 |  6129 | `	SyStringInitFromBuf(&pOut->sClass, 0, 0);` |
|   72119 |  6130 | `	if( pIn >= pGen->pEnd ){` |
|     ! 0 |  6131 | `		return SXERR_SYNTAX;` |
|       - |  6132 | `	}` |
|       - |  6133 | `	/* Optional leading namespace separator '\' on FQN class types */` |
|   72119 |  6134 | `	if( pIn->nType & PH7_TK_NSSEP ){` |
|       8 |  6135 | `		pIn++;` |
|       8 |  6136 | `		if( pIn >= pGen->pEnd ){` |
|     ! 0 |  6137 | `			return SXERR_SYNTAX;` |
|       - |  6138 | `		}` |
|       3 |  6139 | `	}` |
|   72119 |  6140 | `	if( (pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|     ! 0 |  6141 | `		return SXERR_SYNTAX;` |
|       - |  6142 | `	}` |
|   72119 |  6143 | `	if( pIn->nType & PH7_TK_KEYWORD ){` |
|   61667 |  6144 | `		sxu32 nKey = (sxu32)(SX_PTR_TO_INT(pIn->pUserData));` |
|   61667 |  6145 | `		if( nKey & PH7_TKWRD_ARRAY ){` |
|      30 |  6146 | `			pOut->nType = MEMOBJ_HASHMAP; pOut->zCanon = "array"; pOut->nCanon = 5;` |
|   61654 |  6147 | `		}else if( nKey & PH7_TKWRD_BOOL ){` |
|      69 |  6148 | `			pOut->nType = MEMOBJ_BOOL; pOut->zCanon = "bool"; pOut->nCanon = 4;` |
|   61609 |  6149 | `		}else if( nKey & PH7_TKWRD_INT ){` |
|   17269 |  6150 | `			pOut->nType = MEMOBJ_INT; pOut->zCanon = "int"; pOut->nCanon = 3;` |
|   52945 |  6151 | `		}else if( nKey & PH7_TKWRD_STRING ){` |
|   44255 |  6152 | `			pOut->nType = MEMOBJ_STRING; pOut->zCanon = "string"; pOut->nCanon = 6;` |
|   22188 |  6153 | `		}else if( nKey & PH7_TKWRD_FLOAT ){` |
|      32 |  6154 | `			pOut->nType = MEMOBJ_REAL; pOut->zCanon = "float"; pOut->nCanon = 5;` |
|      47 |  6155 | `		}else if( nKey & PH7_TKWRD_OBJECT ){` |
...
|   10457 |  6168 | `		SyString *pT = &pIn->sData;` |
|   10457 |  6169 | `		if( pT->nByte == 4 && SyMemcmpNoCase(pT->zString, "null", 4) == 0 ){` |
|      18 |  6170 | `			pOut->nType = UTA_NULL_FLAG; pOut->zCanon = "null"; pOut->nCanon = 4;` |
|      18 |  6171 | `			pIn++;` |
|   10449 |  6172 | `		}else if( pT->nByte == 4 && SyMemcmpNoCase(pT->zString, "void", 4) == 0 ){` |
|     133 |  6173 | `			pOut->nType = UTA_VOID_FLAG; pOut->zCanon = "void"; pOut->nCanon = 4;` |
|     133 |  6174 | `			pIn++;` |
|   10377 |  6175 | `		}else if( pT->nByte == 5 && SyMemcmpNoCase(pT->zString, "never", 5) == 0 ){` |
|       3 |  6176 | `			pOut->nType = UTA_NEVER_FLAG; pOut->zCanon = "never"; pOut->nCanon = 5;` |
|       3 |  6177 | `			pIn++;` |
|       2 |  6178 | `		}else{` |
|       - |  6179 | `			/* Class / interface name; consume namespace path a\b\c */` |
|   10311 |  6180 | `			SyToken *pFirst = pIn;` |
|   10311 |  6181 | `			SyToken *pLast = pIn;` |
|   10311 |  6182 | `			pOut->nType = SXU32_HIGH;` |
|   10311 |  6183 | `			pOut->sClass = pIn->sData;` |
|   10311 |  6184 | `			pIn++;` |
|   15462 |  6185 | `			while( pIn + 1 < pGen->pEnd && (pIn->nType & PH7_TK_NSSEP)` |
|   10314 |  6186 | `				&& (pIn[1].nType & PH7_TK_ID) ){` |
|       3 |  6187 | `				pLast = &pIn[1];` |
|       3 |  6188 | `				pIn += 2;` |
|       1 |  6189 | `			}` |
|   10311 |  6190 | `			if( pLast != pFirst ){` |
...
|       - |  6196 | `		}` |
|       - |  6197 | `	}` |
|   72117 |  6198 | `	pGen->pIn = pIn;` |
|   72117 |  6199 | `	return SXRET_OK;` |
|   36062 |  6200 |  |
|       - |  6201 |  |
|       - |  6202 | `/*` |
...
|       - |  6208 | ` */` |
|   72010 |  6209 | `static void GenBuildUnionTypeText(SyBlob *pBlob, PhlTypeAtom *aAtoms, int nAtoms, int bNullable)` |
|       5 |  6210 |  |
|       - |  6211 | `	int i;` |
|   72015 |  6212 | `	int nNonNull = 0;` |
|  144113 |  6213 | `	for( i = 0; i < nAtoms; i++ ){` |
|   72103 |  6214 | `		if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|   72087 |  6215 | `			nNonNull++;` |
|   36041 |  6216 | `		}` |
|   36054 |  6217 | `	}` |
|   72015 |  6218 | `	if( nNonNull == 1 && bNullable ){` |
|       - |  6219 | `		/* Shorthand: ?T */` |
|      66 |  6220 | `		for( i = 0; i < nAtoms; i++ ){` |
|      66 |  6221 | `			if( aAtoms[i].nType == UTA_NULL_FLAG ) continue;` |
|      66 |  6222 | `			SyBlobAppend(pBlob, "?", 1);` |
|      66 |  6223 | `			if( aAtoms[i].nType == SXU32_HIGH ){` |
|      15 |  6224 | `				SyBlobAppend(pBlob, aAtoms[i].sClass.zString, aAtoms[i].sClass.nByte);` |
|       9 |  6225 | `			}else{` |
|      54 |  6226 | `				SyBlobAppend(pBlob, aAtoms[i].zCanon, aAtoms[i].nCanon);` |
|       - |  6227 | `			}` |
|      66 |  6228 | `			return;` |
|     ! 0 |  6229 | `		}` |
|     ! 0 |  6230 | `	}` |
|       - |  6231 | `	{` |
|   71953 |  6232 | `		int bFirst = 1;` |
|       - |  6233 | `		/* 1) Classes in declaration order */` |
|  143983 |  6234 | `		for( i = 0; i < nAtoms; i++ ){` |
|   72035 |  6235 | `			if( aAtoms[i].nType == SXU32_HIGH ){` |
|   10303 |  6236 | `				if( !bFirst ) SyBlobAppend(pBlob, "\|", 1);` |
|   10303 |  6237 | `				SyBlobAppend(pBlob, aAtoms[i].sClass.zString, aAtoms[i].sClass.nByte);` |
|   10303 |  6238 | `				bFirst = 0;` |
|    5149 |  6239 | `			}` |
|   36020 |  6240 | `		}` |
...
|       - |  6245 | `			int k;` |
|  503641 |  6246 | `			for( k = 0; k < (int)(sizeof(aOrder)/sizeof(aOrder[0])); k++ ){` |
|  802181 |  6247 | `				for( i = 0; i < nAtoms; i++ ){` |
|  432089 |  6248 | `					if( aAtoms[i].nType == aOrder[k] ){` |
|   61601 |  6249 | `						if( !bFirst ) SyBlobAppend(pBlob, "\|", 1);` |
|   61601 |  6250 | `						SyBlobAppend(pBlob, aAtoms[i].zCanon, aAtoms[i].nCanon);` |
|   61601 |  6251 | `						bFirst = 0;` |
|   61601 |  6252 | `						break;` |
|       - |  6253 | `					}` |
|  185249 |  6254 | `				}` |
...
|       - |  6282 | ` */` |
|   72020 |  6283 | `static sxi32 GenStateParseUnionTypeDecl(` |
...
|   72025 |  6296 | `	int nAtoms = 0;` |
|   72025 |  6297 | `	int bShortNullable = 0;` |
|   72025 |  6298 | `	int bExplicitNull = 0;` |
|       - |  6299 | `	sxi32 rc;` |
|   72025 |  6300 | `	*pnType = 0;` |
|   72025 |  6301 | `	if( pClass ) SyStringInitFromBuf(pClass, 0, 0);` |
|   72025 |  6302 | `	*piTypeFlags = 0;` |
|   72025 |  6303 | `	if( pTypeText ) SyStringInitFromBuf(pTypeText, 0, 0);` |
|       - |  6304 |  |
|   72025 |  6305 | `	if( pGen->pIn >= pGen->pEnd ){` |
|     ! 0 |  6306 | `		return SXRET_OK;` |
|       - |  6307 | `	}` |
|       - |  6308 | ``	/* Optional `?` shorthand prefix */`` |
|   72020 |  6309 | `	if( (pGen->pIn->nType & PH7_TK_OP) && pGen->pIn->sData.nByte == 1` |
...
|   72025 |  6318 | `	rc = GenStateParseOneTypeAtom(pGen, &aAtoms[0]);` |
|   72025 |  6319 | `	if( rc != SXRET_OK ){` |
|       3 |  6320 | `		return rc;` |
|       - |  6321 | `	}` |
|   72023 |  6322 | `	nAtoms = 1;` |
|       - |  6323 | ``	/* Subsequent atoms separated by `\|` */`` |
|  108170 |  6324 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OP)` |
|   72166 |  6325 | `		&& pGen->pIn->sData.nByte == 1 && pGen->pIn->sData.zString[0] == '\|' ){` |
...
|       - |  6352 | `	{` |
|       - |  6353 | `		int i, j;` |
|   72021 |  6354 | `		int bHasNonNull = 0;` |
|  144125 |  6355 | `		for( i = 0; i < nAtoms; i++ ){` |
|   72115 |  6356 | `			if( aAtoms[i].nType == UTA_VOID_FLAG ){` |
...
|       - |  6371 | `				}` |
|      63 |  6372 | `			}` |
|   72113 |  6373 | `			if( aAtoms[i].nType == UTA_NEVER_FLAG ){` |
...
|       - |  6387 | `			}` |
|   72111 |  6388 | `			if( aAtoms[i].nType == UTA_NULL_FLAG ){` |
|      18 |  6389 | `				bExplicitNull = 1;` |
|      10 |  6390 | `			}else{` |
|   72095 |  6391 | `				bHasNonNull = 1;` |
|       - |  6392 | `			}` |
|       - |  6393 | `			/* Duplicate detection */` |
|   72235 |  6394 | `			for( j = 0; j < i; j++ ){` |
|     131 |  6395 | `				int bDup = 0;` |
...
|      67 |  6422 | `			}` |
|   36057 |  6423 | `		}` |
|   72015 |  6424 | `		if( !bHasNonNull && bExplicitNull ){` |
...
|   72015 |  6439 | `	if( bShortNullable \|\| bExplicitNull ){` |
|      77 |  6440 | `		*piTypeFlags \|= iNullableFlag;` |
|      36 |  6441 | `	}` |
|       - |  6442 | `	/* Build canonical type text */` |
|   72015 |  6443 | `	if( pTypeText ){` |
|       - |  6444 | `		SyBlob sBlob;` |
|   72015 |  6445 | `		SyBlobInit(&sBlob, &pGen->pVm->sAllocator);` |
|  107992 |  6446 | `		GenBuildUnionTypeText(&sBlob, aAtoms, nAtoms,` |
|   36005 |  6447 | `			(bShortNullable \|\| bExplicitNull) ? 1 : 0);` |
|   72015 |  6448 | `		if( SyBlobLength(&sBlob) > 0 ){` |
|  107831 |  6449 | `			char *zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|   71884 |  6450 | `				(const char *)SyBlobData(&sBlob), SyBlobLength(&sBlob));` |
|   71889 |  6451 | `			if( zDup ){` |
|   71889 |  6452 | `				SyStringInitFromBuf(pTypeText, zDup, SyBlobLength(&sBlob));` |
|   35942 |  6453 | `			}` |
|   35942 |  6454 | `		}` |
|   72015 |  6455 | `		SyBlobRelease(&sBlob);` |
|   36005 |  6456 | `	}` |
...
|       - |  6460 | `	{` |
|   72015 |  6461 | `		int nNonNull = 0;` |
|   72015 |  6462 | `		int iNonNullIdx = -1;` |
|       - |  6463 | `		int i;` |
|  144113 |  6464 | `		for( i = 0; i < nAtoms; i++ ){` |
|   72103 |  6465 | `			if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|   72087 |  6466 | `				nNonNull++;` |
|   72087 |  6467 | `				iNonNullIdx = i;` |
|   36041 |  6468 | `			}` |
|   36054 |  6469 | `		}` |
|   72015 |  6470 | `		if( nNonNull <= 1 ){` |
|       - |  6471 | `			/* Fast path: store as single type. */` |
|   71953 |  6472 | `			if( iNonNullIdx >= 0 ){` |
|   71947 |  6473 | `				PhlTypeAtom *pA = &aAtoms[iNonNullIdx];` |
|   71947 |  6474 | `				if( pA->nType == SXU32_HIGH ){` |
|   15428 |  6475 | `					char *zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|    5141 |  6476 | `						pA->sClass.zString, pA->sClass.nByte);` |
|   10287 |  6477 | `					if( zDup == 0 ) return SXERR_ABORT;` |
|   10287 |  6478 | `					*pnType = SXU32_HIGH;` |
|   10287 |  6479 | `					if( pClass ) SyStringInitFromBuf(pClass, zDup, pA->sClass.nByte);` |
|   66806 |  6480 | `				}else if( pA->nType == UTA_VOID_FLAG ){` |
...
|       - |  6519 | ` */` |
|  300568 |  6520 | `static sxi32 GenStateParseReturnType(ph7_gen_state *pGen, ph7_vm_func *pFunc)` |
|       5 |  6521 |  |
|  300573 |  6522 | `	sxi32 iFlags = 0;` |
|       - |  6523 | `	sxi32 rc;` |
|       - |  6524 | `	sxu32 nLine;` |
|  300573 |  6525 | `	pFunc->nReturnType = 0;` |
|  300573 |  6526 | `	SyStringInitFromBuf(&pFunc->sReturnClass, 0, 0);` |
|  300573 |  6527 | `	SyStringInitFromBuf(&pFunc->sReturnTypeName, 0, 0);` |
|  300573 |  6528 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COLON) == 0 ){` |
|  300179 |  6529 | `		return SXRET_OK;` |
|       - |  6530 | `	}` |
...
|  150289 |  6567 |  |
|       - |  6568 |  |
|   45210 |  6569 | `static sxi32 GenStateCompileFunc(` |
...
|   45215 |  6583 | `	nLine = pGen->pIn->nLine;` |
|       - |  6584 | `	/* Jump the left parenthesis '(' */` |
|   45215 |  6585 | `	pGen->pIn++;` |
|       - |  6586 | `	/* Delimit the function signature */` |
|   45215 |  6587 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   45215 |  6588 | `	if( pEnd >= pGen->pEnd ){` |
|       - |  6589 | `		/* Syntax error */` |
...
|   45209 |  6599 | `	pFunc = (ph7_vm_func *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_vm_func));` |
|   45209 |  6600 | `	if( pFunc == 0 ){` |
|     ! 0 |  6601 | `		goto OutOfMem;` |
|       - |  6602 | `	}` |
|       - |  6603 | `	/* Build the function name, prepending namespace if active */` |
|   45216 |  6604 | `	if( SyBlobLength(&pGen->sNamespace) > 0 && !bHandleClosure ){` |
|       - |  6605 | `		SyBlob sFQN;` |
|       - |  6606 | `		sxu32 nLen;` |
...
|       9 |  6618 | `	}else{` |
|   45195 |  6619 | `		zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|   45195 |  6620 | `		if( zName == 0 ){` |
|     ! 0 |  6621 | `			goto OutOfMem;` |
|       - |  6622 | `		}` |
|   45195 |  6623 | `		PH7_VmInitFuncState(pGen->pVm,pFunc,zName,pName->nByte,iFlags,0);` |
|       - |  6624 | `	}` |
|   45209 |  6625 | `	if( pGen->pIn < pEnd ){` |
|       - |  6626 | `		/* Collect function arguments */` |
|   31277 |  6627 | `		rc = GenStateCollectFuncArgs(pFunc,&(*pGen),pEnd,0,0);` |
|   31277 |  6628 | `		if( rc == SXERR_ABORT ){` |
...
|   45209 |  6634 | `	pGen->pIn = &pEnd[1];` |
|       - |  6635 | `	{` |
|   45209 |  6636 | `		sxi32 rcRt = GenStateParseReturnType(pGen, pFunc);` |
|   45209 |  6637 | `		if( rcRt == SXERR_ABORT ){` |
|     ! 0 |  6638 | `			return SXERR_ABORT;` |
|   45209 |  6639 | `		}else if( rcRt == SXERR_SYNTAX ){` |
|       5 |  6640 | `			return SXERR_SYNTAX;` |
|       - |  6641 | `		}` |
|       - |  6642 | `	}` |
|   45205 |  6643 | `	if( bHandleClosure ){` |
|       - |  6644 | `		ph7_vm_func_closure_env sEnv;` |
|     257 |  6645 | `		int got_this = 0; /* TRUE if $this have been seen */` |
|     252 |  6646 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD)` |
|     139 |  6647 | `			&& SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_USE ){` |
...
|   45205 |  6736 | `	rc = GenStateCompileFuncBody(&(*pGen),pFunc);` |
|   45205 |  6737 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  6738 | `		return SXERR_ABORT;` |
|       - |  6739 | `	}` |
|   45205 |  6740 | `	if( ppFunc ){` |
|     257 |  6741 | `		*ppFunc = pFunc;` |
|     126 |  6742 | `	}` |
|   45205 |  6743 | `	rc = SXRET_OK;` |
|   45205 |  6744 | `	if( (pFunc->iFlags & VM_FUNC_CLOSURE) == 0 ){` |
|       - |  6745 | `		/* Finally register the function */` |
|   45189 |  6746 | `		rc = PH7_VmInstallUserFunction(pGen->pVm,pFunc,0);` |
|   22592 |  6747 | `	}` |
|   45205 |  6748 | `	if( rc == SXRET_OK ){` |
|   45205 |  6749 | `		return SXRET_OK;` |
|       - |  6750 | `	}` |
...
|       - |  6762 | ` */` |
|   44966 |  6763 | `static sxi32 PH7_CompileFunction(ph7_gen_state *pGen)` |
|       5 |  6764 |  |
|       - |  6765 | `	SyString *pName;` |
|       - |  6766 | `	sxi32 iFlags;` |
|       - |  6767 | `	sxu32 nLine;` |
|       - |  6768 | `	sxi32 rc;` |
|       - |  6769 |  |
|   44971 |  6770 | `	nLine = pGen->pIn->nLine;` |
|   44971 |  6771 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|   44971 |  6772 | `	iFlags = 0;` |
|   44971 |  6773 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|       - |  6774 | `		/* Return by reference,remember that */` |
|       7 |  6775 | `		iFlags \|= VM_FUNC_REF_RETURN;` |
|       - |  6776 | `		/* Jump the '&' token */` |
|       7 |  6777 | `		pGen->pIn++;` |
|       3 |  6778 | `	}` |
|   44971 |  6779 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|       - |  6790 | `	}` |
|   44965 |  6791 | `	pName = &pGen->pIn->sData;` |
|   44965 |  6792 | `	nLine = pGen->pIn->nLine;` |
|       - |  6793 | `	/* Jump the function name */` |
|   44965 |  6794 | `	pGen->pIn++;` |
|   44965 |  6795 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  6796 | `		/* Syntax error */` |
...
|   44963 |  6809 | `	rc = GenStateCompileFunc(&(*pGen),pName,iFlags,FALSE,0);` |
|   44963 |  6810 | `	return rc;` |
|   22488 |  6811 |  |
|       - |  6812 | `/*` |
...
|       - |  6822 | ` */` |
|  320362 |  6823 | `static sxi32 GetProtectionLevel(sxi32 nKeyword)` |
|       5 |  6824 |  |
|  320367 |  6825 | `	if( nKeyword == PH7_TKWRD_PRIVATE ){` |
|   10281 |  6826 | `		return PH7_CLASS_PROT_PRIVATE;` |
|  310091 |  6827 | `	}else if( nKeyword == PH7_TKWRD_PROTECTED ){` |
|   44127 |  6828 | `		return PH7_CLASS_PROT_PROTECTED;` |
|       - |  6829 | `	}` |
|       - |  6830 | `	/* Assume public by default */` |
|  265969 |  6831 | `	return PH7_CLASS_PROT_PUBLIC;` |
|  160186 |  6832 |  |
|       - |  6833 | `/*` |
...
|       - |  6861 | ` */` |
|      76 |  6862 | `static int GenStateClassConstHasType(ph7_gen_state *pGen)` |
|       5 |  6863 |  |
|       - |  6864 | `	SyToken *p0, *p1;` |
|      81 |  6865 | `	if( pGen->pIn >= pGen->pEnd ){` |
|     ! 0 |  6866 | `		return 0;` |
|       - |  6867 | `	}` |
|      81 |  6868 | `	p0 = pGen->pIn;` |
|       - |  6869 | `	/* A leading '\' (namespaced class type) or '?' (nullable) always starts a type */` |
|      81 |  6870 | `	if( p0->nType & PH7_TK_NSSEP ){` |
|     ! 0 |  6871 | `		return 1;` |
|       - |  6872 | `	}` |
|      81 |  6873 | `	if( (p0->nType & PH7_TK_OP) && p0->sData.nByte == 1 && p0->sData.zString[0] == '?' ){` |
|       5 |  6874 | `		return 1;` |
|       - |  6875 | `	}` |
...
|      77 |  6879 | `	if( p0->nType & (PH7_TK_ID\|PH7_TK_KEYWORD) ){` |
|      77 |  6880 | `		p1 = (pGen->pIn + 1 < pGen->pEnd) ? (pGen->pIn + 1) : 0;` |
|      77 |  6881 | `		if( p1 ){` |
|      77 |  6882 | `			if( p1->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_NSSEP) ){` |
|      24 |  6883 | `				return 1;` |
|       - |  6884 | `			}` |
|      56 |  6885 | `			if( (p1->nType & PH7_TK_OP) && p1->sData.nByte == 1 && p1->sData.zString[0] == '\|' ){` |
|       5 |  6886 | `				return 1;` |
|       - |  6887 | `			}` |
|      24 |  6888 | `		}` |
|      24 |  6889 | `	}` |
...
|       - |  6899 | ` */` |
|     192 |  6900 | `static void GenStateCopyTypeToAttr(ph7_class_attr *pAttr,sxu32 nType,` |
|       - |  6901 | `	const SyString *pClass,const SyString *pTypeName,sxi32 iTypeFlags,SySet *pAlts)` |
|       5 |  6902 |  |
|     197 |  6903 | `	pAttr->nType = nType;` |
|     197 |  6904 | `	pAttr->sClass = *pClass;` |
|     197 |  6905 | `	pAttr->sTypeName = *pTypeName;` |
|     197 |  6906 | `	if( iTypeFlags & PH7_CLASS_ATTR_UNION ){` |
|       - |  6907 | `		sxu32 i;` |
...
|       7 |  6912 | `	}` |
|     197 |  6913 |  |
|      76 |  6914 | `static sxi32 GenStateCompileClassConstant(ph7_gen_state *pGen,sxi32 iProtection,sxi32 iFlags,ph7_class *pClass)` |
|       5 |  6915 |  |
|      81 |  6916 | `	sxu32 nLine = pGen->pIn->nLine;` |
|       - |  6917 | `	SySet *pInstrContainer;` |
|       - |  6918 | `	ph7_class_attr *pCons;` |
|       - |  6919 | `	SyString *pName;` |
|       - |  6920 | `	sxi32 rc;` |
|      81 |  6921 | `	sxu32 nType = 0;` |
|       - |  6922 | `	SyString sTypeClass;` |
|       - |  6923 | `	SyString sTypeText;` |
|       - |  6924 | `	SySet aUnionAlts;` |
|      81 |  6925 | `	sxi32 iTypeFlags = 0;` |
|      81 |  6926 | `	SyStringInitFromBuf(&sTypeClass,0,0);` |
|      81 |  6927 | `	SyStringInitFromBuf(&sTypeText,0,0);` |
|      81 |  6928 | `	SySetInit(&aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|       - |  6929 | `	/* Extract visibility level */` |
|      81 |  6930 | `	iProtection = GetProtectionLevel(iProtection);` |
|       - |  6931 | `	/* Mark as constant */` |
|      81 |  6932 | `	iFlags \|= PH7_CLASS_ATTR_CONSTANT;` |
|      81 |  6933 | `	pGen->pIn++; /* Jump the 'const' keyword */` |
...
|      95 |  6936 | `	if( GenStateClassConstHasType(pGen) ){` |
...
|      14 |  6957 | `	}` |
|      38 |  6958 | `loop:` |
|      83 |  6959 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
...
|      83 |  6969 | `	pName = &pGen->pIn->sData;` |
|       - |  6970 | `	/* Make sure the constant name isn't reserved */` |
|      83 |  6971 | `	if( GenStateIsReservedConstant(pName) ){` |
...
|      83 |  6981 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
...
|      81 |  6992 | `	pGen->pIn++;` |
|      81 |  6993 | `	if(pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_EQUAL /* '=' */) == 0 ){` |
...
|       - |  7001 | `	}` |
|      81 |  7002 | `	pGen->pIn++; /* Jump the equal sign */` |
|       - |  7003 | `	/* Allocate a new class attribute */` |
|      81 |  7004 | `	pCons = PH7_NewClassAttr(pGen->pVm,pName,nLine,iProtection,iFlags\|iTypeFlags);` |
|      81 |  7005 | `	if( pCons == 0 ){` |
|     ! 0 |  7006 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|     ! 0 |  7007 | `		return SXERR_ABORT;` |
|       - |  7008 | `	}` |
|      81 |  7009 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|      29 |  7010 | `		GenStateCopyTypeToAttr(pCons,nType,&sTypeClass,&sTypeText,iTypeFlags,&aUnionAlts);` |
|      13 |  7011 | `	}` |
|       - |  7012 | `	/* Swap bytecode container */` |
|      81 |  7013 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|      81 |  7014 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pCons->aByteCode);` |
|       - |  7015 | `	/* Compile constant value.` |
|       - |  7016 | `	 */` |
|      81 |  7017 | `	rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|      81 |  7018 | `	if( rc == SXERR_EMPTY ){` |
...
|      81 |  7025 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|      81 |  7026 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|      81 |  7027 | `	if( rc == SXERR_ABORT ){` |
...
|      81 |  7032 | `	rc = PH7_ClassInstallAttr(pClass,pCons);` |
|      81 |  7033 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  7034 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|     ! 0 |  7035 | `		return SXERR_ABORT;` |
|       - |  7036 | `	}` |
|      81 |  7037 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA /*','*/) ){` |
...
|       - |  7055 | `		}` |
|     ! 0 |  7056 | `	}` |
|      79 |  7057 | `	SySetRelease(&aUnionAlts);` |
|      79 |  7058 | `	return SXRET_OK;` |
|       1 |  7059 | `Synchronize:` |
...
|       - |  7095 | ` */` |
|  167114 |  7096 | `static int GenStateLooksLikeTypedProperty(SyToken *pStart,SyToken *pEnd)` |
|       5 |  7097 |  |
|  167119 |  7098 | `	SyToken *p = pStart;` |
|  167119 |  7099 | `	if( p >= pEnd ) return 0;` |
|  167119 |  7100 | `	if( (p->nType & PH7_TK_OP) && p->sData.nByte == 1 && p->sData.zString[0] == '?' ){` |
|      18 |  7101 | `		p++;` |
|      18 |  7102 | `		if( p >= pEnd ) return 0;` |
|       8 |  7103 | `	}` |
|  167119 |  7104 | `	if( p->nType & PH7_TK_NSSEP ){` |
|       3 |  7105 | `		p++;` |
|       3 |  7106 | `		if( p >= pEnd ) return 0;` |
|       1 |  7107 | `	}` |
|  167119 |  7108 | `	if( (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|     ! 0 |  7109 | `		return 0;` |
|       - |  7110 | `	}` |
...
|       - |  7114 | `	 * dispatch site. */` |
|  167119 |  7115 | `	if( p->nType & PH7_TK_KEYWORD ){` |
|  167097 |  7116 | `		sxu32 k = (sxu32)(SX_PTR_TO_INT(p->pUserData));` |
|  167166 |  7117 | `		if( k == PH7_TKWRD_FUNCTION \|\| k == PH7_TKWRD_VAR \|\| k == PH7_TKWRD_CONST` |
|    3600 |  7118 | `		 \|\| k == PH7_TKWRD_STATIC \|\| k == PH7_TKWRD_FINAL \|\| k == PH7_TKWRD_ABSTRACT ){` |
|  166949 |  7119 | `			return 0;` |
|       - |  7120 | `		}` |
|      74 |  7121 | `	}` |
|     175 |  7122 | `	p++;` |
|       - |  7123 | `	/* Consume optional namespace path */` |
|     177 |  7124 | `	while( p + 1 < pEnd && (p->nType & PH7_TK_NSSEP) && (p[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|       3 |  7125 | `		p += 2;` |
|       1 |  7126 | `	}` |
|       - |  7127 | ``	/* Consume any `\| Type` union alternatives */`` |
|     273 |  7128 | `	while( p < pEnd && (p->nType & PH7_TK_OP) && p->sData.nByte == 1` |
|     108 |  7129 | `		&& p->sData.zString[0] == '\|' ){` |
|      16 |  7130 | `		p++;` |
...
|     ! 0 |  7136 | `		}` |
|       4 |  7137 | `	}` |
|     175 |  7138 | `	if( p >= pEnd ) return 0;` |
|     175 |  7139 | `	return (p->nType & PH7_TK_DOLLAR) ? 1 : 0;` |
|   83562 |  7140 |  |
|       - |  7141 |  |
|       - |  7142 | `/*` |
...
|       - |  7159 | ` */` |
|     170 |  7160 | `static sxi32 GenStateParsePropertyType(` |
...
|       - |  7166 | `	SySet *pAlts` |
|       5 |  7167 | `){` |
|     175 |  7168 | `	sxi32 iFlags = 0;` |
|       - |  7169 | `	sxi32 rc;` |
|     175 |  7170 | `	if( pGen->pIn >= pGen->pEnd ){` |
|     ! 0 |  7171 | `		return SXRET_OK;` |
|       - |  7172 | `	}` |
|       - |  7173 | `	/* If the first token is '$', there's no type */` |
|     175 |  7174 | `	if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|     ! 0 |  7175 | `		return SXRET_OK;` |
|       - |  7176 | `	}` |
|     175 |  7177 | `	rc = GenStateParseUnionTypeDecl(` |
|      85 |  7178 | `		pGen, pnType, pClass, pAlts, &iFlags, pTypeText,` |
|       - |  7179 | `		PH7_CLASS_ATTR_NULLABLE,` |
|       - |  7180 | `		PH7_CLASS_ATTR_UNION,` |
|       - |  7181 | `		/* bAllowVoid */ 0,` |
|     170 |  7182 | `		pGen->pIn->nLine);` |
|     175 |  7183 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  7184 | `		return rc;` |
|       - |  7185 | `	}` |
|       - |  7186 | `	/* Verify next token is '$' (start of property name) */` |
|     175 |  7187 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
|     ! 0 |  7188 | `		return SXERR_SYNTAX;` |
|       - |  7189 | `	}` |
|     175 |  7190 | `	*piTypeFlags = iFlags \| PH7_CLASS_ATTR_TYPED;` |
|     175 |  7191 | `	return SXRET_OK;` |
|      90 |  7192 |  |
|       - |  7193 |  |
|       - |  7194 | `/*` |
...
|       - |  7204 | ` */` |
|     286 |  7205 | `static int GenStateIsDisallowedPropertyAtom(` |
|       - |  7206 | `	sxu32 nType,` |
...
|       - |  7211 | `	const char *z;` |
|       - |  7212 | `	sxu32 n;` |
|     291 |  7213 | `	if( nType != SXU32_HIGH \|\| pClass == 0 \|\| pClass->nByte == 0 ){` |
|     255 |  7214 | `		return 0;` |
|       - |  7215 | `	}` |
...
|       - |  7237 | ` */` |
|     250 |  7238 | `static sxi32 GenStateValidateMemberType(` |
...
|       - |  7247 | `	sxu32 nLine)` |
|       5 |  7248 |  |
|     255 |  7249 | `	const char *zBad = 0;` |
|     255 |  7250 | `	sxu32 nBad = 0;` |
|       - |  7251 | `	SyString sFallback;` |
|       - |  7252 | `	const SyString *pBad;` |
|       - |  7253 | `	sxi32 rc;` |
|     255 |  7254 | `	int bDisallowed = 0;` |
|     255 |  7255 | `	if( GenStateIsDisallowedPropertyAtom(nType,pTypeClass,&zBad,&nBad) ){` |
|       5 |  7256 | `		bDisallowed = 1;` |
|     253 |  7257 | `	}else if( pUnionAlts ){` |
|       - |  7258 | `		sxu32 i;` |
...
|      21 |  7265 | `		}` |
|       9 |  7266 | `	}` |
|     255 |  7267 | `	if( !bDisallowed ){` |
|     249 |  7268 | `		return SXRET_OK;` |
|       - |  7269 | `	}` |
...
|       - |  7292 | ` */` |
| 1511774 |  7293 | `static int GenStateIsReadonly(SyToken *pTok)` |
|       5 |  7294 |  |
| 1542173 |  7295 | `	return (pTok->nType & PH7_TK_ID)` |
|  786281 |  7296 | `		&& pTok->sData.nByte == sizeof("readonly")-1` |
| 1542168 |  7297 | `		&& SyStrnicmp(pTok->sData.zString,"readonly",sizeof("readonly")-1) == 0;` |
|       5 |  7298 |  |
|   65034 |  7299 | `static sxi32 GenStateCompileClassAttr(ph7_gen_state *pGen,sxi32 iProtection,sxi32 iFlags,ph7_class *pClass)` |
|       5 |  7300 |  |
|   65039 |  7301 | `	sxu32 nLine = pGen->pIn->nLine;` |
|       - |  7302 | `	ph7_class_attr *pAttr;` |
|       - |  7303 | `	SyString *pName;` |
|       - |  7304 | `	sxi32 rc;` |
|   65039 |  7305 | `	sxu32 nType = 0;` |
|       - |  7306 | `	SyString sTypeClass;` |
|       - |  7307 | `	SyString sTypeText;` |
|       - |  7308 | `	SySet aUnionAlts;` |
|   65039 |  7309 | `	sxi32 iTypeFlags = 0;` |
|   65039 |  7310 | `	SyStringInitFromBuf(&sTypeClass,0,0);` |
|   65039 |  7311 | `	SyStringInitFromBuf(&sTypeText,0,0);` |
|   65039 |  7312 | `	SySetInit(&aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
...
|   65039 |  7316 | `	if( pClass->iFlags & PH7_CLASS_READONLY ){` |
|      21 |  7317 | `		iFlags \|= PH7_CLASS_ATTR_READONLY;` |
|       9 |  7318 | `	}` |
|       - |  7319 | `	/* Extract visibility level */` |
|   65039 |  7320 | `	iProtection = GetProtectionLevel(iProtection);` |
|       - |  7321 | `	/* Parse optional type hint (typed properties, PHP 7.4+) */` |
|   65124 |  7322 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
|     175 |  7323 | `		rc = GenStateParsePropertyType(pGen,&nType,&sTypeClass,&iTypeFlags,&sTypeText,&aUnionAlts);` |
|     175 |  7324 | `		if( rc == SXERR_CORRUPT ){` |
|       - |  7325 | `			/* Error already reported by GenStateParseUnionTypeDecl */` |
|     ! 0 |  7326 | `			goto Synchronize;` |
|     175 |  7327 | `		}else if( rc == SXERR_SYNTAX ){` |
...
|     175 |  7335 | `		}else if( rc == SXERR_ABORT ){` |
|     ! 0 |  7336 | `			return SXERR_ABORT;` |
|       - |  7337 | `		}` |
|      85 |  7338 | `	}` |
|     ! 0 |  7339 | `loop:` |
|   65043 |  7340 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
...
|       - |  7346 | `	}` |
|   65043 |  7347 | `	pGen->pIn++; /* Jump the dollar sign */` |
|   65043 |  7348 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_ID)) == 0 ){` |
...
|   65043 |  7358 | `	pName = &pGen->pIn->sData;` |
|       - |  7359 | `	/* Advance the stream cursor */` |
|   65043 |  7360 | `	pGen->pIn++;` |
|   65043 |  7361 | `	if(pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_EQUAL/*'='*/\|PH7_TK_SEMI/*';'*/\|PH7_TK_COMMA/*','*/)) == 0 ){` |
...
|   65041 |  7372 | `	if( iFlags & PH7_CLASS_ATTR_READONLY ){` |
...
|   65031 |  7392 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|     257 |  7393 | `		rc = GenStateValidateMemberType(pGen,pClass,pName,nType,&sTypeClass,` |
|       - |  7394 | `			&sTypeText,` |
|     168 |  7395 | `			(iTypeFlags & PH7_CLASS_ATTR_UNION) ? &aUnionAlts : 0,` |
|      84 |  7396 | `			"Property %z::$%z cannot have type %z",nLine);` |
|     173 |  7397 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  7398 | `			return SXERR_ABORT;` |
|     173 |  7399 | `		}else if( rc != SXRET_OK ){` |
|     ! 0 |  7400 | `			goto Synchronize;` |
|       - |  7401 | `		}` |
|      84 |  7402 | `	}` |
|       - |  7403 | `	/* Reject redeclaration (catches clash with an earlier promoted property). */` |
|   65031 |  7404 | `	if( PH7_ClassExtractAttribute(pClass,pName->zString,pName->nByte) != 0 ){` |
...
|   65029 |  7413 | `	pAttr = PH7_NewClassAttr(pGen->pVm,pName,nLine,iProtection,iFlags\|iTypeFlags);` |
|   65029 |  7414 | `	if( pAttr == 0 ){` |
|     ! 0 |  7415 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 engine is running out of memory");` |
|     ! 0 |  7416 | `		return SXERR_ABORT;` |
|       - |  7417 | `	}` |
|   65029 |  7418 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|     171 |  7419 | `		GenStateCopyTypeToAttr(pAttr,nType,&sTypeClass,&sTypeText,iTypeFlags,&aUnionAlts);` |
|      83 |  7420 | `	}` |
|   65029 |  7421 | `	if( pGen->pIn->nType & PH7_TK_EQUAL /*'='*/ ){` |
|       - |  7422 | `		SySet *pInstrContainer;` |
|   20793 |  7423 | `		pGen->pIn++; /*Jump the equal sign */` |
|       - |  7424 | `		/* Swap bytecode container */` |
|   20793 |  7425 | `		pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   20793 |  7426 | `		PH7_VmSetByteCodeContainer(pGen->pVm,&pAttr->aByteCode);` |
|       - |  7427 | `		/* Compile attribute value.` |
|       - |  7428 | `		 */` |
|   20793 |  7429 | `		rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|   20793 |  7430 | `		if( rc == SXERR_EMPTY ){` |
...
|   20793 |  7437 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|   20793 |  7438 | `		PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|   10394 |  7439 | `	}` |
|       - |  7440 | `	/* All done,install the attribute */` |
|   65029 |  7441 | `	rc = PH7_ClassInstallAttr(pClass,pAttr);` |
|   65029 |  7442 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  7443 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|     ! 0 |  7444 | `		return SXERR_ABORT;` |
|       - |  7445 | `	}` |
|   65029 |  7446 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA /*','*/) ){` |
...
|       - |  7464 | `		}` |
|     ! 0 |  7465 | `	}` |
|   65025 |  7466 | `	SySetRelease(&aUnionAlts);` |
|   65025 |  7467 | `	return SXRET_OK;` |
|       7 |  7468 | `Synchronize:` |
...
|       - |  7483 | ` */` |
|  255252 |  7484 | `static sxi32 GenStateCompileClassMethod(` |
...
|       - |  7490 | `	)` |
|       5 |  7491 |  |
|  255257 |  7492 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|  255257 |  7499 | `	iProtection = GetProtectionLevel(iProtection);` |
|  255257 |  7500 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|  255257 |  7501 | `	iFuncFlags = 0;` |
|  255257 |  7502 | `	if( pGen->pIn >= pGen->pEnd ){` |
...
|       - |  7510 | `	}` |
|  255257 |  7511 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|       - |  7512 | `		/* Return by reference,remember that */` |
|     ! 0 |  7513 | `		iFuncFlags \|= VM_FUNC_REF_RETURN;` |
|       - |  7514 | `		/* Jump the '&' token */` |
|     ! 0 |  7515 | `		pGen->pIn++;` |
|     ! 0 |  7516 | `	}` |
|  255257 |  7517 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|  255257 |  7526 | `	pName = &pGen->pIn->sData;` |
|  255257 |  7527 | `	nLine = pGen->pIn->nLine;` |
|       - |  7528 | `	/* Jump the method name */` |
|  255257 |  7529 | `	pGen->pIn++;` |
|  255257 |  7530 | `	if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|       - |  7531 | `		/* Abstract method */` |
|   88199 |  7532 | `		if( iProtection == PH7_CLASS_PROT_PRIVATE ){` |
...
|   88199 |  7541 | `		doBody = FALSE;` |
|   44097 |  7542 | `	}` |
|  255257 |  7543 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  7544 | `		/* Syntax error */` |
...
|  255257 |  7553 | `	pMeth = PH7_NewClassMethod(pGen->pVm,pClass,pName,nLine,iProtection,iFlags,iFuncFlags);` |
|  255257 |  7554 | `	if( pMeth == 0 ){` |
...
|  255257 |  7559 | `	pGen->pIn++;` |
|  255257 |  7560 | `	pEnd = 0; /* cc warning */` |
|       - |  7561 | `	/* Delimit the method signature */` |
|  255257 |  7562 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|  255257 |  7563 | `	if( pEnd >= pGen->pEnd ){` |
|       - |  7564 | `		/* Syntax error */` |
...
|       - |  7571 | `	}` |
|       - |  7572 | `	{` |
|  255255 |  7573 | `		int bIsCtor = 0;` |
|  255255 |  7574 | `		int bAbstractCtor = 0;` |
|  372629 |  7575 | `		if( (pName->nByte == sizeof("__construct") - 1` |
|  151469 |  7576 | `				&& SyMemcmp(pName->zString,"__construct",sizeof("__construct") - 1) == 0)` |
|  245009 |  7577 | `		 \|\| SyStringCmp(pName,&pClass->sName,SyMemcmp) == 0 ){` |
|   20497 |  7578 | `			if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|       3 |  7579 | `				bAbstractCtor = 1;` |
|       2 |  7580 | `			}else{` |
|   20495 |  7581 | `				bIsCtor = 1;` |
|       - |  7582 | `			}` |
|   10246 |  7583 | `		}` |
|  255255 |  7584 | `		if( pGen->pIn < pEnd ){` |
|       - |  7585 | `			/* Collect method arguments */` |
|   58007 |  7586 | `			rc = GenStateCollectFuncArgs(&pMeth->sFunc,&(*pGen),pEnd,bIsCtor,bAbstractCtor);` |
|   58007 |  7587 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  7588 | `				return SXERR_ABORT;` |
|       - |  7589 | `			}` |
|   29001 |  7590 | `		}` |
|       - |  7591 | `	}` |
|       - |  7592 | `	/* Point past ')' and parse optional return type ': type' */` |
|  255255 |  7593 | `	pGen->pIn = &pEnd[1];` |
|       - |  7594 | `	{` |
|  255255 |  7595 | `		sxi32 rcRt = GenStateParseReturnType(pGen, &pMeth->sFunc);` |
|  255255 |  7596 | `		if( rcRt == SXERR_ABORT ){` |
|     ! 0 |  7597 | `			return SXERR_ABORT;` |
|  255255 |  7598 | `		}else if( rcRt == SXERR_SYNTAX ){` |
...
|       - |  7605 | `	{` |
|  255255 |  7606 | `		sxu32 nArg = SySetUsed(&pMeth->sFunc.aArgs);` |
|       - |  7607 | `		sxu32 i;` |
|  347255 |  7608 | `		for( i = 0; i < nArg; i++ ){` |
|   92015 |  7609 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pMeth->sFunc.aArgs,i);` |
|       - |  7610 | `			ph7_class_attr *pAttr;` |
|   92015 |  7611 | `			sxi32 iAttrFlags = 0;` |
|   92015 |  7612 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|   91955 |  7613 | `				continue;` |
|       - |  7614 | `			}` |
...
|      30 |  7691 | `		}` |
|       - |  7692 | `	}` |
|  255245 |  7693 | `	if( doBody ){` |
|       - |  7694 | `		/* Compile method body */` |
|  167051 |  7695 | `		rc = GenStateCompileFuncBody(&(*pGen),&pMeth->sFunc);` |
|  167051 |  7696 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  7697 | `			return SXERR_ABORT;` |
|       - |  7698 | `		}` |
|   83528 |  7699 | `	}else{` |
|       - |  7700 | `		/* Only method signature is allowed */` |
|   88199 |  7701 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI /* ';'*/) == 0 ){` |
...
|       - |  7734 | ` */` |
|   37342 |  7735 | `static sxi32 PH7_CompileClassInterface(ph7_gen_state *pGen)` |
|       5 |  7736 |  |
|   37347 |  7737 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|   37347 |  7746 | `	pName = &pGen->pIn->sData;` |
|       - |  7747 | `	/* Advance the stream cursor */` |
|   37347 |  7748 | `	pGen->pIn++;` |
|       - |  7749 | `	/* Build FQN and obtain a raw class */ {` |
|       - |  7750 | `		SyBlob sFQN;` |
|       - |  7751 | `		SyString sFQNStr;` |
|   37347 |  7752 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|   37347 |  7753 | `		GenStateBuildFQN(pGen,pName,&sFQN);` |
|   37347 |  7754 | `		SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|   37347 |  7755 | `		pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|   37347 |  7756 | `		SyBlobRelease(&sFQN);` |
|       - |  7757 | `	}` |
|   37347 |  7758 | `	if( pClass == 0 ){` |
...
|   37347 |  7763 | `	pClass->iFlags = PH7_CLASS_INTERFACE;` |
|       - |  7764 | `	/* Assume no base class is given */` |
|   37347 |  7765 | `	pBase = 0;` |
|   37347 |  7766 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|   10183 |  7767 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   10183 |  7768 | `		if( nKwrd == PH7_TKWRD_EXTENDS /* interface b extends a */ ){` |
|       - |  7769 | `			SyBlob sResolved;` |
|       - |  7770 | `			SyString sBaseName;` |
|       - |  7771 | `			sxu32 nRefLine;` |
|       - |  7772 | `			/* Extract base interface */` |
|   10183 |  7773 | `			pGen->pIn++;` |
|   10183 |  7774 | `			nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|   10183 |  7775 | `			SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|   10183 |  7776 | `			if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|       - |  7786 | `			}` |
|   15272 |  7787 | `			pBase = PH7_VmExtractClass(pGen->pVm,` |
|   10178 |  7788 | `				(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|   10183 |  7789 | `			SyStringInitFromBuf(&sBaseName,` |
|       - |  7790 | `				(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|       - |  7791 | `			/* Only interfaces is allowed */` |
|   10183 |  7792 | `			while( pBase && (pBase->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|     ! 0 |  7793 | `				pBase = pBase->pNextName;` |
|     ! 0 |  7794 | `			}` |
|   10183 |  7795 | `			if( pBase == 0 ){` |
...
|       - |  7801 | `				}` |
|     ! 0 |  7802 | `			}` |
|   10183 |  7803 | `			SyBlobRelease(&sResolved);` |
|    5089 |  7804 | `		}` |
|    5089 |  7805 | `	}` |
|   37347 |  7806 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|       - |  7807 | `		/* Syntax error */` |
...
|       - |  7815 | `	}` |
|   37347 |  7816 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|   37347 |  7817 | `	pEnd = 0; /* cc warning */` |
|       - |  7818 | `	/* Delimit the interface body */` |
|   37347 |  7819 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|   37347 |  7820 | `	if( pEnd >= pGen->pEnd ){` |
|       - |  7821 | `		/* Syntax error */` |
...
|   37347 |  7831 | `	pTmp = pGen->pEnd;` |
|   37347 |  7832 | `	pGen->pEnd = pEnd;` |
...
|  213719 |  7840 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|   88191 |  7841 | `			pGen->pIn++;` |
|       5 |  7842 | `		}` |
|  125533 |  7843 | `		if( pGen->pIn >= pGen->pEnd ){` |
|       - |  7844 | `			/* End of interface body */` |
|   37345 |  7845 | `			break;` |
|       - |  7846 | `		}` |
|   88193 |  7847 | `		if( (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|   88193 |  7858 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   88193 |  7859 | `		if( nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
...
|       3 |  7888 | `			goto done;` |
|       - |  7889 | `		}` |
|   88191 |  7890 | `		if( nKwrd != PH7_TKWRD_PUBLIC && nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|     ! 0 |  7897 | `			goto done;` |
|       - |  7898 | `		}` |
|   88191 |  7899 | `		if( nKwrd == PH7_TKWRD_PUBLIC ){` |
|       - |  7900 | `			/* Advance the stream cursor */` |
|   88181 |  7901 | `			pGen->pIn++;` |
|   88181 |  7902 | `			if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|     ! 0 |  7909 | `				goto done;` |
|       - |  7910 | `			}` |
|   88181 |  7911 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   88181 |  7912 | `			if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|       - |  7920 | `			}` |
|   44088 |  7921 | `		}` |
|   88191 |  7922 | `		if( nKwrd == PH7_TKWRD_CONST ){` |
|       - |  7923 | `			/* Parse constant */` |
...
|       - |  7930 | `			}` |
|       4 |  7931 | `		}else{` |
|   88185 |  7932 | `			sxi32 iFlags = PH7_CLASS_ATTR_ABSTRACT; /* Interface methods are implicitly abstract */` |
|   88185 |  7933 | `			if( nKwrd == PH7_TKWRD_STATIC ){` |
|       - |  7934 | `				/* Static method,record that */` |
|   10175 |  7935 | `				iFlags \|= PH7_CLASS_ATTR_STATIC;` |
|       - |  7936 | `				/* Advance the stream cursor */` |
|   10175 |  7937 | `				pGen->pIn++;` |
|   10170 |  7938 | `				if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0` |
|   10175 |  7939 | `					\|\| SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_FUNCTION ){` |
...
|   88185 |  7950 | `			rc = GenStateCompileClassMethod(&(*pGen),0,iFlags,FALSE,pClass);` |
|   88185 |  7951 | `			if( rc != SXRET_OK ){` |
...
|   37345 |  7960 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|   37345 |  7961 | `	if( rc == SXRET_OK && pBase ){` |
|       - |  7962 | `		/* Inherit from the base interface */` |
|   10183 |  7963 | `		rc = PH7_ClassInterfaceInherit(pClass,pBase);` |
|    5089 |  7964 | `	}` |
|   37345 |  7965 | `	if( rc != SXRET_OK ){` |
...
|   37347 |  7971 | `	pGen->pIn  = &pEnd[1];` |
|   37347 |  7972 | `	pGen->pEnd = pTmp;` |
|   37347 |  7973 | `	return PH7_OK;` |
|   18676 |  7974 |  |
|       - |  7975 | `/*` |
...
|       - |  7999 | ` */` |
|   92608 |  8000 | `static sxi32 GenStateCheckInterfaceSignatures(ph7_gen_state *pGen,ph7_class *pClass)` |
|       5 |  8001 |  |
|       - |  8002 | `	ph7_class **apIface;` |
|       - |  8003 | `	sxu32 nIface,i;` |
|       - |  8004 | `	sxi32 rc;` |
|   92613 |  8005 | `	if( pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|     ! 0 |  8006 | `		return SXRET_OK;` |
|       - |  8007 | `	}` |
|   92613 |  8008 | `	apIface = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|   92613 |  8009 | `	nIface = SySetUsed(&pClass->aInterface);` |
|  184353 |  8010 | `	for(i = 0; i < nIface; i++){` |
|   91745 |  8011 | `		ph7_class *pIface = apIface[i];` |
|       - |  8012 | `		SyHashEntry *pEntry;` |
|   91745 |  8013 | `		SyHashResetLoopCursor(&pIface->hMethod);` |
|  244741 |  8014 | `		while((pEntry = SyHashGetNextEntry(&pIface->hMethod)) != 0 ){` |
|  153001 |  8015 | `			ph7_class_method *pIfaceMeth = (ph7_class_method *)pEntry->pUserData;` |
|       - |  8016 | `			ph7_class_method *pImplMeth;` |
|  153001 |  8017 | `			SyString *pMName = &pIfaceMeth->sFunc.sName;` |
|       - |  8018 | `			/* Find the implementing method in the class */` |
|  153001 |  8019 | `			pImplMeth = PH7_ClassExtractMethod(pClass,pMName->zString,pMName->nByte);` |
|  153001 |  8020 | `			if( pImplMeth == 0 \|\| (pImplMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT) ){` |
...
|  152987 |  8024 | `			if( pImplMeth->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|       - |  8034 | `			 */` |
|       - |  8035 | `			{` |
|  152987 |  8036 | `				sxu32 nIfaceArgs = SySetUsed(&pIfaceMeth->sFunc.aArgs);` |
|  152987 |  8037 | `				sxu32 nImplArgs = SySetUsed(&pImplMeth->sFunc.aArgs);` |
|  152987 |  8038 | `				int sigError = 0;` |
|  152987 |  8039 | `				if( nImplArgs < nIfaceArgs ){` |
|       3 |  8040 | `					sigError = 1;` |
|  152986 |  8041 | `				}else if( nImplArgs > nIfaceArgs ){` |
...
|       - |  8092 | ` */` |
|   92608 |  8093 | `static sxi32 GenStateCheckAbstractMethods(ph7_gen_state *pGen,ph7_class *pClass)` |
|       5 |  8094 |  |
...
|   92613 |  8101 | `	if( pClass->iFlags & (PH7_CLASS_ABSTRACT\|PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|      29 |  8102 | `		return SXRET_OK;` |
|       - |  8103 | `	}` |
|       - |  8104 | `	/* Count abstract methods */` |
|   92589 |  8105 | `	nAbstract = 0;` |
|   92589 |  8106 | `	SyHashResetLoopCursor(&pClass->hMethod);` |
|  897537 |  8107 | `	while((pEntry = SyHashGetNextEntry(&pClass->hMethod)) != 0 ){` |
|  804953 |  8108 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|  804953 |  8109 | `		if( pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|      20 |  8110 | `			nAbstract++;` |
|       8 |  8111 | `		}` |
|       5 |  8112 | `	}` |
|   92589 |  8113 | `	if( nAbstract == 0 ){` |
|   92575 |  8114 | `		return SXRET_OK;` |
|       - |  8115 | `	}` |
...
|       - |  8248 | ` */` |
|   92290 |  8249 | `static sxi32 GenStateParseClassReference(ph7_gen_state *pGen,SyBlob *pFqn)` |
|       5 |  8250 |  |
|   92295 |  8251 | `	int isAbsolute = 0;` |
|   92295 |  8252 | `	SyToken *pStart = pGen->pIn;` |
|       - |  8253 | `	SyBlob sName;` |
|   92295 |  8254 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) ){` |
|      60 |  8255 | `		isAbsolute = 1;` |
|      60 |  8256 | `		pGen->pIn++;` |
|      28 |  8257 | `	}` |
|   92295 |  8258 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|       8 |  8259 | `		pGen->pIn = pStart;` |
|       8 |  8260 | `		return SXERR_INVALID;` |
|       - |  8261 | `	}` |
|   92289 |  8262 | `	SyBlobInit(&sName,&pGen->pVm->sAllocator);` |
|   92289 |  8263 | `	SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|   92289 |  8264 | `	pGen->pIn++;` |
|  138444 |  8265 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) &&` |
|   46165 |  8266 | `		&pGen->pIn[1] < pGen->pEnd && (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|      13 |  8267 | `		SyBlobAppend(&sName,"\\",1);` |
|      13 |  8268 | `		pGen->pIn++;` |
|      13 |  8269 | `		SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|      13 |  8270 | `		pGen->pIn++;` |
|       1 |  8271 | `	}` |
|   92289 |  8272 | `	if( isAbsolute ){` |
|      58 |  8273 | `		SyBlobAppend(pFqn,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|      31 |  8274 | `	}else{` |
|       - |  8275 | `		SyString sRaw;` |
|   92235 |  8276 | `		SyStringInitFromBuf(&sRaw,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|   92235 |  8277 | `		GenStateResolveName(pGen,&sRaw,pFqn);` |
|       - |  8278 | `	}` |
|   92289 |  8279 | `	SyBlobRelease(&sName);` |
|   92289 |  8280 | `	return SXRET_OK;` |
|   46150 |  8281 |  |
|       - |  8282 | `/*` |
...
|   10306 |  8290 | `static int GenStateInterfaceIsThrowableAt(ph7_class *pInterface,int iDepth)` |
|       5 |  8291 |  |
|       - |  8292 | `	ph7_class **apParent;` |
|       - |  8293 | `	sxu32 n;` |
|   17259 |  8294 | `	while( pInterface ){` |
|   13743 |  8295 | `		if( iDepth > PH7_THROWABLE_WALK_MAX_DEPTH ){` |
|     ! 0 |  8296 | `			return FALSE;` |
|       - |  8297 | `		}` |
|   17145 |  8298 | `		if( pInterface->sName.nByte == sizeof("Throwable")-1 &&` |
|    6804 |  8299 | `			SyMemcmp(pInterface->sName.zString,"Throwable",sizeof("Throwable")-1) == 0 ){` |
|    6795 |  8300 | `			return TRUE;` |
|       - |  8301 | `		}` |
|    6953 |  8302 | `		apParent = (ph7_class **)SySetBasePtr(&pInterface->aInterface);` |
|    6953 |  8303 | `		for( n = 0 ; n < SySetUsed(&pInterface->aInterface) ; ++n ){` |
|     ! 0 |  8304 | `			if( GenStateInterfaceIsThrowableAt(apParent[n],iDepth+1) ){` |
|     ! 0 |  8305 | `				return TRUE;` |
|       - |  8306 | `			}` |
|     ! 0 |  8307 | `		}` |
|    6953 |  8308 | `		pInterface = pInterface->pBase;` |
|    6953 |  8309 | `		iDepth++;` |
|       5 |  8310 | `	}` |
|    3521 |  8311 | `	return FALSE;` |
|    5158 |  8312 |  |
|   10306 |  8313 | `static int GenStateInterfaceIsThrowable(ph7_class *pInterface)` |
|       5 |  8314 |  |
|   10311 |  8315 | `	return GenStateInterfaceIsThrowableAt(pInterface,0);` |
|       5 |  8316 |  |
|       - |  8317 | `/*` |
...
|       - |  8321 | ` */` |
|    6790 |  8322 | `static int GenStateClassIsExceptionOrError(ph7_class *pBase)` |
|       5 |  8323 |  |
|    6799 |  8324 | `	while( pBase ){` |
...
|       - |  8346 | ` */` |
|   92638 |  8347 | `static sxi32 GenStateCompileClassEx(ph7_gen_state *pGen,sxi32 iFlags,` |
|       - |  8348 | `	SyString *pAnonName,SyToken **ppArgStart,SyToken **ppArgEnd)` |
|       5 |  8349 |  |
|   92643 |  8350 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|      11 |  8377 | `	}else{` |
|   92623 |  8378 | `		if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
|       - |  8379 | `			/* Syntax error */` |
...
|   92623 |  8392 | `		pName = &pGen->pIn->sData;` |
|       - |  8393 | `		/* Advance the stream cursor */` |
|   92623 |  8394 | `		pGen->pIn++;` |
|       - |  8395 | `		/* Build FQN and obtain a raw class */ {` |
|       - |  8396 | `			SyBlob sFQN;` |
|       - |  8397 | `			SyString sFQNStr;` |
|   92623 |  8398 | `			SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|   92623 |  8399 | `			GenStateBuildFQN(pGen,pName,&sFQN);` |
|   92623 |  8400 | `			SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|   92623 |  8401 | `			pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|   92623 |  8402 | `			SyBlobRelease(&sFQN);` |
|       - |  8403 | `		}` |
|       - |  8404 | `	}` |
|   92643 |  8405 | `	if( pClass == 0 ){` |
...
|   92643 |  8410 | `	SySetInit(&aInterfaces,&pGen->pVm->sAllocator,sizeof(ph7_class *));` |
|   92643 |  8411 | `	SySetInit(&aUseEntries,&pGen->pVm->sAllocator,sizeof(TraitUseEntry));` |
|       - |  8412 | `	/* Assume a standalone class */` |
|   92643 |  8413 | `	pBase = 0;` |
|   92643 |  8414 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|   81649 |  8415 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   81649 |  8416 | `		if( nKwrd == PH7_TKWRD_EXTENDS /* class b extends a */ ){` |
|       - |  8417 | `			SyBlob sResolved;` |
|       - |  8418 | `			SyString sBaseName;` |
|       - |  8419 | `			sxu32 nRefLine;` |
|   71351 |  8420 | `			pGen->pIn++; /* Advance past 'extends' */` |
|   71351 |  8421 | `			nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|   71351 |  8422 | `			SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|   71351 |  8423 | `			if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|       - |  8433 | `			}` |
|  107021 |  8434 | `			pBase = PH7_VmExtractClass(pGen->pVm,` |
|   71344 |  8435 | `				(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|   71349 |  8436 | `			SyStringInitFromBuf(&sBaseName,` |
|       - |  8437 | `				(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|       - |  8438 | `			/* Interfaces are not allowed */` |
|   71349 |  8439 | `			while( pBase && (pBase->iFlags & PH7_CLASS_INTERFACE) ){` |
|     ! 0 |  8440 | `				pBase = pBase->pNextName;` |
|     ! 0 |  8441 | `			}` |
|   71349 |  8442 | `			if( pBase == 0 ){` |
...
|       - |  8448 | `				}` |
|     ! 0 |  8449 | `			}else{` |
|   71349 |  8450 | `				if( pBase->iFlags & PH7_CLASS_FINAL ){` |
...
|     ! 0 |  8457 | `				}` |
|       - |  8458 | `			}` |
|   71349 |  8459 | `			SyBlobRelease(&sResolved);` |
|   35672 |  8460 | `		}` |
|   81647 |  8461 | `		if (pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) && SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_IMPLEMENTS ){` |
|       - |  8462 | `			ph7_class *pInterface;` |
|       - |  8463 | `			/* Interface implementation */` |
|   10311 |  8464 | `			pGen->pIn++; /* Advance the stream cursor */` |
|    5153 |  8465 | `			for(;;){` |
|       - |  8466 | `				SyBlob sResolved;` |
|       - |  8467 | `				SyString sIntName;` |
|       - |  8468 | `				sxu32 nRefLine;` |
|   10311 |  8469 | `				nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|   10311 |  8470 | `				SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|   10311 |  8471 | `				if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|     ! 0 |  8479 | `					break;` |
|       - |  8480 | `				}` |
|   20617 |  8481 | `				pInterface = PH7_VmExtractClass(pGen->pVm,` |
|   10306 |  8482 | `					(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|   10311 |  8483 | `				SyStringInitFromBuf(&sIntName,` |
|       - |  8484 | `					(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|       - |  8485 | `				/* Only interfaces are allowed */` |
|   10311 |  8486 | `				while( pInterface && (pInterface->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|     ! 0 |  8487 | `					pInterface = pInterface->pNextName;` |
|     ! 0 |  8488 | `				}` |
|   10311 |  8489 | `				if( pInterface == 0 ){` |
...
|   10311 |  8503 | `					SyString *pFqn = &pClass->sName;` |
|   10311 |  8504 | `					int bIsExceptionOrError =` |
|    8545 |  8505 | `						(pFqn->nByte == sizeof("Exception")-1 &&` |
|   17156 |  8506 | `						 SyMemcmp(pFqn->zString,"Exception",sizeof("Exception")-1) == 0) \|\|` |
|    8616 |  8507 | `						(pFqn->nByte == sizeof("Error")-1 &&` |
|    3400 |  8508 | `						 SyMemcmp(pFqn->zString,"Error",sizeof("Error")-1) == 0);` |
|   17094 |  8509 | `					if( GenStateInterfaceIsThrowable(pInterface) &&` |
|   10188 |  8510 | `						!GenStateClassIsExceptionOrError(pBase) &&` |
|    3393 |  8511 | `						!bIsExceptionOrError ){` |
...
|       6 |  8521 | `					}else{` |
|   10305 |  8522 | `						SySetPut(&aInterfaces,(const void *)&pInterface);` |
|       - |  8523 | `					}` |
|       - |  8524 | `				}` |
|   10311 |  8525 | `				SyBlobRelease(&sResolved);` |
|   10311 |  8526 | `				if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COMMA) == 0 ){` |
|    5158 |  8527 | `					break;` |
|       - |  8528 | `				}` |
...
|    5153 |  8531 | `		}` |
|   40821 |  8532 | `	}` |
|   92641 |  8533 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|       - |  8534 | `		/* Syntax error */` |
...
|       - |  8542 | `	}` |
|   92641 |  8543 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|   92641 |  8544 | `	pEnd = 0; /* cc warning */` |
|       - |  8545 | `	/* Delimit the class body */` |
|   92641 |  8546 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|   92641 |  8547 | `	if( pEnd >= pGen->pEnd ){` |
|       - |  8548 | `		/* Syntax error */` |
...
|   92641 |  8558 | `	pTmp = pGen->pEnd;` |
|   92641 |  8559 | `	pGen->pEnd = pEnd;` |
|       - |  8560 | `	/* Set the inherited flags */` |
|   92641 |  8561 | `	pClass->iFlags = iFlags;` |
|       - |  8562 | `	/* Start the parse process */` |
|  129850 |  8563 | `	for(;;){` |
|       - |  8564 | `		/* Jump leading/trailing semi-colons */` |
|  389881 |  8565 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|   65125 |  8566 | `			pGen->pIn++;` |
|       5 |  8567 | `		}` |
|  324761 |  8568 | `		if( pGen->pIn >= pGen->pEnd ){` |
|       - |  8569 | `			/* End of class body */` |
|   92613 |  8570 | `			break;` |
|       - |  8571 | `		}` |
|  232148 |  8572 | `		if( (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR)) == 0` |
|  116079 |  8573 | ``			&& !GenStateIsReadonly(pGen->pIn) /* allow a leading `readonly` modifier */ ){`` |
...
|  232153 |  8584 | `		iProtection = PH7_TKWRD_PUBLIC;` |
|  232153 |  8585 | `		iAttrflags = 0;` |
...
|  232153 |  8590 | `		if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|     ! 0 |  8591 | `			int bMod = 0;` |
...
|       - |  8612 | `			}` |
|     ! 0 |  8613 | `		}` |
|  232153 |  8614 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|       - |  8615 | `			/* Extract the current keyword */` |
|  232153 |  8616 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  232153 |  8617 | `			if( nKwrd == PH7_TKWRD_USE ){` |
...
|      53 |  8677 | `				continue;` |
|       - |  8678 | `			}` |
|  232105 |  8679 | `			if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|  228471 |  8680 | `				iProtection = nKwrd;` |
|  228471 |  8681 | `				pGen->pIn++; /* Jump the visibility token */` |
|       - |  8682 | ``				/* Optional `readonly` after the visibility: `public readonly int $x`. */`` |
|  228471 |  8683 | `				if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|      20 |  8684 | `					iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|      20 |  8685 | `					pGen->pIn++; /* Jump the 'readonly' modifier */` |
|       8 |  8686 | `				}` |
|  228466 |  8687 | `				if( pGen->pIn >= pGen->pEnd` |
|  228471 |  8688 | `					\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP)) == 0 ){` |
...
|     ! 0 |  8696 | `					goto done;` |
|       - |  8697 | `				}` |
|  228471 |  8698 | `				if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|       - |  8699 | `					/* Attribute declaration (untyped) */` |
|   64847 |  8700 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|   64847 |  8701 | `					if( rc != SXRET_OK ){` |
...
|   64841 |  8707 | `					continue;` |
|       - |  8708 | `				}` |
|  163629 |  8709 | `				if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
|       - |  8710 | `					/* Typed attribute declaration (PHP 7.4+) */` |
|     159 |  8711 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|     159 |  8712 | `					if( rc != SXRET_OK ){` |
...
|  163475 |  8721 | `				nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   81735 |  8722 | `			}` |
|  167109 |  8723 | `			if( nKwrd == PH7_TKWRD_CONST ){` |
|       - |  8724 | `				/* Process constant declaration */` |
|      65 |  8725 | `				rc = GenStateCompileClassConstant(&(*pGen),iProtection,iAttrflags,pClass);` |
|      65 |  8726 | `				if( rc != SXRET_OK ){` |
...
|       - |  8731 | `				}` |
|      34 |  8732 | `			}else{` |
|  167049 |  8733 | `				if( nKwrd == PH7_TKWRD_STATIC ){` |
|       - |  8734 | `					/* Static method or attribute,record that */` |
|    3439 |  8735 | `					iAttrflags \|= PH7_CLASS_ATTR_STATIC;` |
|    3439 |  8736 | `					pGen->pIn++; /* Jump the static keyword */` |
|    3439 |  8737 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|       - |  8738 | `						/* Extract the keyword */` |
|    3433 |  8739 | `						nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    3433 |  8740 | `						if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
...
|    3439 |  8748 | `					if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|     ! 0 |  8749 | `						iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|     ! 0 |  8750 | `						pGen->pIn++; /* Jump the 'readonly' modifier */` |
|     ! 0 |  8751 | `					}` |
|    3434 |  8752 | `					if( pGen->pIn >= pGen->pEnd` |
|    3439 |  8753 | `						\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP)) == 0 ){` |
...
|     ! 0 |  8761 | `						goto done;` |
|       - |  8762 | `					}` |
|    3439 |  8763 | `					if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|       - |  8764 | `						/* Attribute declaration */` |
|       5 |  8765 | `						rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|       5 |  8766 | `						if( rc != SXRET_OK ){` |
...
|       5 |  8772 | `						continue;` |
|       - |  8773 | `					}` |
|    3435 |  8774 | `					if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|    3423 |  8786 | `					nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  165324 |  8787 | `				}else if( nKwrd == PH7_TKWRD_ABSTRACT ){` |
...
|  163610 |  8819 | `				}else if( nKwrd == PH7_TKWRD_FINAL ){` |
...
|       2 |  8863 | `				}` |
|  167023 |  8864 | `				if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_VAR ){` |
...
|     ! 0 |  8872 | `						goto done;` |
|       - |  8873 | `				}` |
|  167023 |  8874 | `				if( nKwrd == PH7_TKWRD_VAR ){` |
...
|  167017 |  8889 | `					rc = GenStateCompileClassMethod(&(*pGen),iProtection,iAttrflags,TRUE,pClass);` |
|       - |  8890 | `				}` |
|  167023 |  8891 | `				if( rc != SXRET_OK ){` |
...
|       - |  8914 | `		sxu32 nU;` |
|   92613 |  8915 | `		apUse = (TraitUseEntry *)SySetBasePtr(&aUseEntries);` |
|   92661 |  8916 | `		for( nU = 0 ; nU < SySetUsed(&aUseEntries) ; nU++ ){` |
...
|   92613 |  9124 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|   92613 |  9125 | `	if( rc == SXRET_OK ){` |
|       - |  9126 | `		ph7_class **apInterface;` |
|       - |  9127 | `		sxu32 n;` |
|   92613 |  9128 | `		if( pBase ){` |
|       - |  9129 | `			/* Inherit from base class and mark as a subclass */` |
|   71349 |  9130 | `			rc = PH7_ClassInherit(&(*pGen),pClass,pBase);` |
|   35672 |  9131 | `		}` |
|   92613 |  9132 | `		apInterface = (ph7_class **)SySetBasePtr(&aInterfaces);` |
|  102913 |  9133 | `		for( n = 0 ; n < SySetUsed(&aInterfaces) ; n++ ){` |
|       - |  9134 | `			/* Implements one or more interface */` |
|   10305 |  9135 | `			rc = PH7_ClassImplement(pClass,apInterface[n]);` |
|   10305 |  9136 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  9137 | `				break;` |
|       - |  9138 | `			}` |
|    5155 |  9139 | `		}` |
...
|  138912 |  9142 | `		if( rc == SXRET_OK` |
|   92608 |  9143 | `		 && (pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT)) == 0` |
|   92613 |  9144 | `		 && SyHashGet(&pClass->hMethod,"__toString",sizeof("__toString")-1) != 0 ){` |
|   81447 |  9145 | `			ph7_class *pStringable = PH7_VmExtractClass(pGen->pVm,` |
|       - |  9146 | `				"Stringable",sizeof("Stringable")-1,FALSE,0);` |
|   81447 |  9147 | `			if( pStringable ){` |
|   81447 |  9148 | `				ph7_class **apImpl = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|   81447 |  9149 | `				sxu32 nImpl = SySetUsed(&pClass->aInterface);` |
|       - |  9150 | `				sxu32 i;` |
|   81447 |  9151 | `				int bAlready = 0;` |
|   88231 |  9152 | `				for( i = 0 ; i < nImpl ; i++ ){` |
|    6791 |  9153 | `					if( apImpl[i] == pStringable ){` |
|       3 |  9154 | `						bAlready = 1;` |
|       3 |  9155 | `						break;` |
|       - |  9156 | `					}` |
|    3397 |  9157 | `				}` |
|   81447 |  9158 | `				if( !bAlready ){` |
|   81445 |  9159 | `					PH7_ClassImplement(pClass,pStringable);` |
|   40720 |  9160 | `				}` |
|   40721 |  9161 | `			}` |
|   40721 |  9162 | `		}` |
|       - |  9163 | `		/* Validate interface method signatures (visibility and parameter count) */` |
|   92613 |  9164 | `		if( rc == SXRET_OK ){` |
|   92613 |  9165 | `			sxi32 rcCheck = GenStateCheckInterfaceSignatures(&(*pGen),pClass);` |
|   92613 |  9166 | `			if( rcCheck == SXERR_ABORT ){` |
...
|   92613 |  9173 | `		if( rc == SXRET_OK ){` |
|   92613 |  9174 | `			sxi32 rcCheck = GenStateCheckAbstractMethods(&(*pGen),pClass);` |
|   92613 |  9175 | `			if( rcCheck == SXERR_ABORT ){` |
...
|   46304 |  9180 | `		}` |
|   46304 |  9181 | `	}` |
|   92613 |  9182 | `	SySetRelease(&aUseEntries);` |
|   92613 |  9183 | `	SySetRelease(&aInterfaces);` |
|   92613 |  9184 | `	if( rc != SXRET_OK ){` |
...
|   92641 |  9190 | `	pGen->pIn = &pEnd[1];` |
|   92641 |  9191 | `	pGen->pEnd = pTmp;` |
|   92641 |  9192 | `	return PH7_OK;` |
|   46324 |  9193 |  |
|       - |  9194 | `/* Compile a named class declaration (the common case). */` |
|   92618 |  9195 | `static sxi32 GenStateCompileClass(ph7_gen_state *pGen,sxi32 iFlags)` |
|       5 |  9196 |  |
|   92623 |  9197 | `	return GenStateCompileClassEx(pGen,iFlags,0,0,0);` |
|       5 |  9198 |  |
|       - |  9199 | `/*` |
...
|       - |  9288 | ` */` |
|  913572 |  9289 | `static int GenStateTokenIsClassModifier(SyToken *pTok,sxi32 *piFlag)` |
|       5 |  9290 |  |
|  913577 |  9291 | `	if( pTok->nType & PH7_TK_KEYWORD ){` |
|  605515 |  9292 | `		sxu32 nKw = (sxu32)SX_PTR_TO_INT(pTok->pUserData);` |
|  605515 |  9293 | `		if( nKw == PH7_TKWRD_FINAL ){ *piFlag = PH7_CLASS_FINAL; return TRUE; }` |
|  605497 |  9294 | `		if( nKw == PH7_TKWRD_ABSTRACT ){ *piFlag = PH7_CLASS_ABSTRACT; return TRUE; }` |
|  302723 |  9295 | `	}` |
|  913513 |  9296 | `	if( GenStateIsReadonly(pTok) ){ *piFlag = PH7_CLASS_READONLY; return TRUE; }` |
|  913453 |  9297 | `	return FALSE;` |
|  456791 |  9298 |  |
|       - |  9299 | `/*` |
...
|       - |  9304 | ` */` |
|  913448 |  9305 | `static sxi32 GenStateScanClassModifiers(SyToken **ppIn,SyToken *pEnd,SyToken **ppDup)` |
|       5 |  9306 |  |
|  913453 |  9307 | `	SyToken *pIn = *ppIn,*pDup = 0;` |
|  913453 |  9308 | `	sxi32 iFlags = 0,iFlag;` |
|  913577 |  9309 | `	while( pIn < pEnd && GenStateTokenIsClassModifier(pIn,&iFlag) ){` |
...
|     129 |  9314 | `		pIn++;` |
|       5 |  9315 | `	}` |
|  913453 |  9316 | `	*ppIn = pIn;` |
|  913453 |  9317 | `	if( ppDup ){ *ppDup = pDup; }` |
|  913453 |  9318 | `	return iFlags;` |
|       5 |  9319 |  |
|       - |  9320 | `/*` |
...
|       - |  9326 | ` */` |
|  913396 |  9327 | `static int GenStateStartsModifiedClass(SyToken *pIn,SyToken *pEnd)` |
|       5 |  9328 |  |
|  913401 |  9329 | `	sxi32 iFlags = GenStateScanClassModifiers(&pIn,pEnd,0);` |
|  456757 |  9330 | `	return iFlags != 0 && pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD)` |
|  913424 |  9331 | `		&& (sxu32)SX_PTR_TO_INT(pIn->pUserData) == PH7_TKWRD_CLASS;` |
|       5 |  9332 |  |
|       - |  9333 | `/*` |
...
|       - |  9350 | `		}` |
|       1 |  9351 | `	}` |
|      78 |  9352 | `	if( (iFlags & (PH7_CLASS_FINAL\|PH7_CLASS_ABSTRACT))` |
...
|       - |  9661 | ` */` |
|   92566 |  9662 | `static sxi32 PH7_CompileClass(ph7_gen_state *pGen)` |
|       5 |  9663 |  |
|       - |  9664 | `	sxi32 rc;` |
|   92571 |  9665 | `	rc = GenStateCompileClass(&(*pGen),0);` |
|   92571 |  9666 | `	return rc;` |
|       5 |  9667 |  |
|       - |  9668 | `/*` |
...
|       - |  9689 | ` */` |
|   10386 |  9690 | `static sxi32 GenStateThrowNodeValidator(ph7_gen_state *pGen,ph7_expr_node *pRoot)` |
|       5 |  9691 |  |
|   10391 |  9692 | `	sxi32 rc = SXRET_OK;` |
|   10391 |  9693 | `	if( pRoot->pOp ){` |
|   10383 |  9694 | `		switch( pRoot->pOp->iOp ){` |
|    5189 |  9695 | `		case EXPR_OP_NEW:            /* new Exception() */` |
...
|     ! 0 |  9711 | `			break;` |
|       - |  9712 | `		}` |
|    5202 |  9713 | `	}else if( pRoot->xCode != PH7_CompileVariable ){` |
...
|       - |  9727 | ` */` |
|   10350 |  9728 | `static sxi32 PH7_CompileThrow(ph7_gen_state *pGen)` |
|       5 |  9729 |  |
|   10355 |  9730 | `	sxu32 nLine = pGen->pIn->nLine;` |
|       - |  9731 | `	GenBlock *pBlock;` |
|       - |  9732 | `	sxu32 nIdx;` |
|       - |  9733 | `	sxi32 rc;` |
|   10355 |  9734 | `	pGen->pIn++; /* Jump the 'throw' keyword */` |
|       - |  9735 | `	/* Compile the expression */` |
|   10355 |  9736 | `	rc = PH7_CompileExpr(&(*pGen),0,GenStateThrowNodeValidator);` |
|   10355 |  9737 | `	if( rc == SXERR_EMPTY ){` |
...
|       - |  9743 | `	}` |
|   10355 |  9744 | `	pBlock = pGen->pCurrent;` |
|       - |  9745 | `	/* Point to the top most function or try block and emit the forward jump */` |
|   47825 |  9746 | `	while(pBlock->pParent){` |
|   47821 |  9747 | `		if( pBlock->iFlags & (GEN_BLOCK_EXCEPTION\|GEN_BLOCK_FUNC) ){` |
|   10351 |  9748 | `			break;` |
|       - |  9749 | `		}` |
|       - |  9750 | `		/* Point to the parent block */` |
|   37475 |  9751 | `		pBlock = pBlock->pParent;` |
|       5 |  9752 | `	}` |
|       - |  9753 | `	/* Emit the throw instruction */` |
|   10355 |  9754 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_THROW,0,0,0,&nIdx);` |
|       - |  9755 | `	/* Emit the jump */` |
|   10355 |  9756 | `	GenStateNewJumpFixup(pBlock,PH7_OP_THROW,nIdx);` |
|   10355 |  9757 | `	return SXRET_OK;` |
|    5180 |  9758 |  |
|       - |  9759 | `/*` |
...
|       - |  9810 | ` */` |
|     434 |  9811 | `static sxi32 PH7_CompileCatch(ph7_gen_state *pGen,ph7_exception *pException)` |
|       5 |  9812 |  |
|     439 |  9813 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|       - |  9820 | `	char *zDup;` |
|       - |  9821 | `	sxi32 rc;` |
|     439 |  9822 | `	pGen->pIn++; /* Jump the 'catch' keyword */` |
|       - |  9823 | `	/* Zero the structure */` |
|     439 |  9824 | `	SyZero(&sCatch,sizeof(ph7_exception_block));` |
|       - |  9825 | `	/* Initialize fields */` |
|     439 |  9826 | `	SySetInit(&sCatch.aClasses,&pException->pVm->sAllocator,sizeof(SyString));` |
|     439 |  9827 | `	SySetInit(&sCatch.sByteCode,&pException->pVm->sAllocator,sizeof(VmInstr));` |
|     439 |  9828 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 /*(*/ ){` |
...
|     439 |  9843 | `	pGen->pIn++; /* Jump the left parenthesis '(' */` |
|     230 |  9844 | `	for(;;){` |
|       - |  9845 | `		SyBlob sResolved;` |
|     465 |  9846 | `		SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|     465 |  9847 | `		if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|     689 |  9863 | `		zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|     456 |  9864 | `			(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|     461 |  9865 | `		SyStringInitFromBuf(&sClassName,zDup,SyBlobLength(&sResolved));` |
|     461 |  9866 | `		SyBlobRelease(&sResolved);` |
|     461 |  9867 | `		if( zDup == 0 ){` |
|     ! 0 |  9868 | `			goto Mem;` |
|       - |  9869 | `		}` |
|     461 |  9870 | `		rc = SySetPut(&sCatch.aClasses,(const void *)&sClassName);` |
|     461 |  9871 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  9872 | `			goto Mem;` |
|       - |  9873 | `		}` |
|       - |  9874 | `		/* Check for '\|' (multi-catch separator) */` |
|     469 |  9875 | `		if( pGen->pIn < pGen->pEnd &&` |
|     456 |  9876 | `			(pGen->pIn->nType & PH7_TK_OP) &&` |
...
|     435 |  9882 | `		break;` |
|     ! 0 |  9883 | `	}` |
|     645 |  9884 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 /*$*/ \|\|` |
|     435 |  9885 | `		&pGen->pIn[1] >= pGen->pEnd \|\| (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|       - |  9898 | `	}` |
|     435 |  9899 | `	pGen->pIn++; /* Jump the dollar sign */` |
|       - |  9900 | `	/* Duplicate instance name */` |
|     435 |  9901 | `	pName = &pGen->pIn->sData;` |
|     435 |  9902 | `	zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|     435 |  9903 | `	if( zDup == 0 ){` |
|     ! 0 |  9904 | `		goto Mem;` |
|       - |  9905 | `	}` |
|     435 |  9906 | `	SyStringInitFromBuf(&sCatch.sThis,zDup,pName->nByte);` |
|     435 |  9907 | `	pGen->pIn++;` |
|     435 |  9908 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_RPAREN) == 0 /*)*/ ){` |
...
|     435 |  9923 | `	pGen->pIn++; /* Jump the right parenthesis */` |
|       - |  9924 | `	/* Create the catch block */` |
|     435 |  9925 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_EXCEPTION,PH7_VmInstrLength(pGen->pVm),0,&pCatch);` |
|     435 |  9926 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  9927 | `		return SXERR_ABORT;` |
|       - |  9928 | `	}` |
|       - |  9929 | `	/* Swap bytecode container */` |
|     435 |  9930 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|     435 |  9931 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&sCatch.sByteCode);` |
|       - |  9932 | `	/* Compile the block */` |
|     435 |  9933 | `	PH7_CompileBlock(&(*pGen),0);` |
|       - |  9934 | `	/* Fix forward jumps now the destination is resolved  */` |
|     435 |  9935 | `	GenStateFixJumps(pCatch,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - |  9936 | `	/* Emit the DONE instruction */` |
|     435 |  9937 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|       - |  9938 | `	/* Leave the block */` |
|     435 |  9939 | `	GenStateLeaveBlock(&(*pGen),0);` |
|       - |  9940 | `	/* Restore the default container */` |
|     435 |  9941 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|       - |  9942 | `	/* Install the catch block */` |
|     435 |  9943 | `	rc = SySetPut(&pException->sEntry,(const void *)&sCatch);` |
|     435 |  9944 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  9945 | `		goto Mem;` |
|       - |  9946 | `	}` |
|     435 |  9947 | `	return SXRET_OK;` |
|     ! 0 |  9948 | `Mem:` |
...
|       - |  9957 | ` * is "thrown".` |
|       - |  9958 | ` */` |
|     448 |  9959 | `static sxi32 PH7_CompileTry(ph7_gen_state *pGen)` |
|       5 |  9960 |  |
|       - |  9961 | `	ph7_exception *pException;` |
|     453 |  9962 | `	sxu32 nLine = pGen->pIn->nLine;` |
|       - |  9963 | `	GenBlock *pTry;` |
|       - |  9964 | `	sxu32 nJmpIdx;` |
|       - |  9965 | `	sxi32 rc;` |
|       - |  9966 | `	/* Create the exception container */` |
|     453 |  9967 | `	pException = (ph7_exception *)SyMemBackendAlloc(&pGen->pVm->sAllocator,sizeof(ph7_exception));` |
|     453 |  9968 | `	if( pException == 0 ){` |
...
|     453 |  9974 | `	SyZero(pException,sizeof(ph7_exception));` |
|       - |  9975 | `	/* Initialize fields */` |
|     453 |  9976 | `	SySetInit(&pException->sEntry,&pGen->pVm->sAllocator,sizeof(ph7_exception_block));` |
|     453 |  9977 | `	SySetInit(&pException->sFinally,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|     453 |  9978 | `	pException->iHasFinally = 0;` |
|     453 |  9979 | `	pException->iFinallyDone = 0;` |
|     453 |  9980 | `	pException->pVm = pGen->pVm;` |
|       - |  9981 | `	/* Create the try block */` |
|     453 |  9982 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_EXCEPTION,PH7_VmInstrLength(pGen->pVm),0,&pTry);` |
|     453 |  9983 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  9984 | `		return SXERR_ABORT;` |
|       - |  9985 | `	}` |
|       - |  9986 | `	/* Store exception pointer so break/continue can emit POP_EXCEPTION */` |
|     453 |  9987 | `	pTry->pUserData = pException;` |
|       - |  9988 | `	/* Emit the 'LOAD_EXCEPTION' instruction */` |
|     453 |  9989 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_EXCEPTION,0,0,pException,&nJmpIdx);` |
|       - |  9990 | `	/* Fix the jump later when the destination is resolved */` |
|     453 |  9991 | `	GenStateNewJumpFixup(pTry,PH7_OP_LOAD_EXCEPTION,nJmpIdx);` |
|     453 |  9992 | `	pGen->pIn++; /* Jump the 'try' keyword */` |
|       - |  9993 | `	/* Compile the block */` |
|     453 |  9994 | `	rc = PH7_CompileBlock(&(*pGen),0);` |
|     453 |  9995 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  9996 | `		return SXERR_ABORT;` |
|       - |  9997 | `	}` |
|       - |  9998 | `	/* Fix forward jumps now the destination is resolved */` |
|     453 |  9999 | `	GenStateFixJumps(pTry,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - | 10000 | `	/* Emit the 'POP_EXCEPTION' instruction */` |
|     453 | 10001 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP_EXCEPTION,0,0,pException,0);` |
|       - | 10002 | `	/* Leave the block */` |
|     453 | 10003 | `	GenStateLeaveBlock(&(*pGen),0);` |
|       - | 10004 | `	/* Compile catch block(s) — at least one catch or finally is required */` |
|     453 | 10005 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|     446 | 10006 | `		SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_CATCH ){` |
|       - | 10007 | `		/* Compile one or more catch blocks */` |
|     430 | 10008 | `		for(;;){` |
|     860 | 10009 | `			if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0` |
|     676 | 10010 | `				\|\| SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_CATCH ){` |
|     218 | 10011 | `					break;` |
|       - | 10012 | `			}` |
|     439 | 10013 | `			rc = PH7_CompileCatch(&(*pGen),pException);` |
|     439 | 10014 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 | 10015 | `				return SXERR_ABORT;` |
|       - | 10016 | `			}` |
|       5 | 10017 | `		}` |
|     213 | 10018 | `	}` |
|       - | 10019 | `	/* Compile optional finally block */` |
|     453 | 10020 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|     222 | 10021 | `		SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_FINALLY ){` |
|       - | 10022 | `		SySet *pInstrContainer;` |
|       - | 10023 | `		GenBlock *pFinBlock;` |
|      52 | 10024 | `		pGen->pIn++; /* Jump the 'finally' keyword */` |
|       - | 10025 | `		/* Create the finally block for jump fixup bookkeeping */` |
|      52 | 10026 | `		rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_EXCEPTION,PH7_VmInstrLength(pGen->pVm),0,&pFinBlock);` |
|      52 | 10027 | `		if( rc != SXRET_OK ){` |
|     ! 0 | 10028 | `			return SXERR_ABORT;` |
|       - | 10029 | `		}` |
|       - | 10030 | `		/* Swap bytecode container */` |
|      52 | 10031 | `		pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|      52 | 10032 | `		PH7_VmSetByteCodeContainer(pGen->pVm,&pException->sFinally);` |
|       - | 10033 | `		/* Compile the finally body */` |
|      52 | 10034 | `		rc = PH7_CompileBlock(&(*pGen),0);` |
|      52 | 10035 | `		if( rc == SXERR_ABORT ){` |
...
|      52 | 10040 | `		GenStateFixJumps(pFinBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - | 10041 | `		/* Emit DONE to terminate the finally block */` |
|      52 | 10042 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|       - | 10043 | `		/* Leave the block */` |
|      52 | 10044 | `		GenStateLeaveBlock(&(*pGen),0);` |
|       - | 10045 | `		/* Restore the default container */` |
|      52 | 10046 | `		PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|      52 | 10047 | `		pException->iHasFinally = 1;` |
|      24 | 10048 | `	}` |
|       - | 10049 | `	/* Must have at least one catch or finally */` |
|     453 | 10050 | `	if( SySetUsed(&pException->sEntry) == 0 && !pException->iHasFinally ){` |
...
|       - | 10413 | ` */` |
| 2476596 | 10414 | `static void GenStatePatchNullsafeJumps(ph7_gen_state *pGen, sxu32 nBaseline)` |
|       5 | 10415 |  |
| 2476601 | 10416 | `	sxu32 nCur = SySetUsed(&pGen->aNullsafeJmp);` |
|       - | 10417 | `	sxu32 nTarget;` |
|       - | 10418 | `	sxu32 *aIdx;` |
|       - | 10419 | `	sxu32 i;` |
| 2476601 | 10420 | `	if( nCur <= nBaseline ){` |
| 2476511 | 10421 | `		return;` |
|       - | 10422 | `	}` |
...
|       - | 10450 | ` */` |
|  402516 | 10451 | `static sxu32 GenStateByRefBuiltinMask(SyString *pName)` |
|       5 | 10452 |  |
...
|       - | 10462 | `	};` |
|       - | 10463 | `	sxu32 i;` |
|  402521 | 10464 | `	if( pName == 0 \|\| pName->zString == 0 \|\| pName->nByte == 0 ){` |
|    1215 | 10465 | `		return 0;` |
|       - | 10466 | `	}` |
| 2006391 | 10467 | `	for( i = 0 ; i < SX_ARRAYSIZE(aByRef) ; ++i ){` |
| 1605126 | 10468 | `		if( pName->nByte == aByRef[i].nByte` |
|  823766 | 10469 | `		 && SyStrnicmp(pName->zString, aByRef[i].zName, pName->nByte) == 0 ){` |
|      51 | 10470 | `			return aByRef[i].mask;` |
|       - | 10471 | `		}` |
|  802545 | 10472 | `	}` |
|  401265 | 10473 | `	return 0;` |
|  201263 | 10474 |  |
|       - | 10475 | `/*` |
...
|       - | 10484 | ` */` |
|  402516 | 10485 | `static void GenStateCallBuiltinName(ph7_expr_node *pLeft, SyString *pOut)` |
|       5 | 10486 |  |
|       - | 10487 | `	SyToken *p, *pEnd;` |
|  402521 | 10488 | `	pOut->zString = 0;` |
|  402521 | 10489 | `	pOut->nByte = 0;` |
|  402521 | 10490 | `	if( pLeft == 0 \|\| pLeft->pStart == 0 \|\| pLeft->pEnd == 0 ){` |
|     ! 0 | 10491 | `		return;` |
|       - | 10492 | `	}` |
|  402521 | 10493 | `	p = pLeft->pStart;` |
|  402521 | 10494 | `	pEnd = pLeft->pEnd;` |
|       - | 10495 | `	/* Optional single leading namespace separator (absolute path). */` |
|  402521 | 10496 | `	if( p < pEnd && (p->nType & PH7_TK_NSSEP) ){` |
|      26 | 10497 | `		p++;` |
|      11 | 10498 | `	}` |
|  402521 | 10499 | `	if( p >= pEnd \|\| (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|    1189 | 10500 | `		return;` |
|       - | 10501 | `	}` |
|       - | 10502 | `	/* Must be a single component: nothing follows the name token. */` |
|  401337 | 10503 | `	if( p + 1 != pEnd ){` |
|      30 | 10504 | `		return;` |
|       - | 10505 | `	}` |
|  401311 | 10506 | `	*pOut = p->sData;` |
|  201263 | 10507 |  |
|       - | 10508 | `/*` |
...
|       - | 10513 | ` * error message.` |
|       - | 10514 | ` */` |
| 3337602 | 10515 | `static sxi32 GenStateEmitExprCode(` |
...
|       - | 10522 | `	sxu32 nJmpIdx;` |
| 3337607 | 10523 | `	sxi32 iP1 = 0;` |
| 3337607 | 10524 | `	sxu32 iP2 = 0;` |
| 3337607 | 10525 | `	void *p3  = 0;` |
|       - | 10526 | `	sxi32 iVmOp;` |
|       - | 10527 | `	sxi32 rc;` |
| 3337607 | 10528 | `	int bIsChainOp = 0; /* Set below once we know pNode->pOp */` |
| 3337607 | 10529 | `	sxu32 nRhsNsBase = 0;` |
| 3337607 | 10530 | `	if( pNode->xCode ){` |
|       - | 10531 | `		SyToken *pTmpIn,*pTmpEnd;` |
|       - | 10532 | `		/* Compile node */` |
| 2067569 | 10533 | `		SWAP_DELIMITER(pGen,pNode->pStart,pNode->pEnd);` |
| 2067569 | 10534 | `		rc = pNode->xCode(&(*pGen),iFlags);` |
| 2067569 | 10535 | `		RE_SWAP_DELIMITER(pGen);` |
| 2067569 | 10536 | `		return rc;` |
|       - | 10537 | `	}` |
| 1270043 | 10538 | `	if( pNode->pOp == 0 ){` |
...
|       - | 10542 | `	}` |
| 1270043 | 10543 | `	iVmOp = pNode->pOp->iVmOp;` |
| 1270043 | 10544 | `	if( pNode->pOp->iOp == EXPR_OP_NULLC_ASSIGN ){` |
...
|       - | 10593 | `	}` |
| 1269987 | 10594 | `	if( pNode->pOp->iOp == EXPR_OP_QUESTY ){` |
...
|    2631 | 10599 | `		nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|    2631 | 10600 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pCond,iFlags);` |
|    2631 | 10601 | `		if( rc != SXRET_OK ){` |
|     ! 0 | 10602 | `			return rc;` |
|       - | 10603 | `		}` |
...
|    2631 | 10607 | `		GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|    2631 | 10608 | `		nJz = nJmp = 0; /* cc -O6 warning */` |
|    2631 | 10609 | `		if( pNode->pLeft ){` |
|       - | 10610 | `			/* Standard ternary: (expr) ? (then) : (else) */` |
|       - | 10611 | `			/* Phase#2: Emit the false jump (pops condition) */` |
|    2563 | 10612 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nJz);` |
|       - | 10613 | `			/* Phase#3: Compile the 'then' expression  */` |
|    2563 | 10614 | `			nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|    2563 | 10615 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pLeft,iFlags);` |
|    2563 | 10616 | `			if( rc != SXRET_OK ){` |
|     ! 0 | 10617 | `				return rc;` |
|       - | 10618 | `			}` |
|    2563 | 10619 | `			GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|    1284 | 10620 | `		}else{` |
...
|    2631 | 10628 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,0,0,&nJmp);` |
|       - | 10629 | `		/* Phase#5: Fix the false jump now the jump destination is resolved. */` |
|    2631 | 10630 | `		pInstr = PH7_VmGetInstr(pGen->pVm,nJz);` |
|    2631 | 10631 | `		if( pInstr ){` |
|    2631 | 10632 | `			pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    1313 | 10633 | `		}` |
|    2631 | 10634 | `		if( !pNode->pLeft ){` |
...
|    2631 | 10639 | `		if( pNode->pRight ){` |
|    2631 | 10640 | `			nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|    2631 | 10641 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pRight,iFlags);` |
|    2631 | 10642 | `			if( rc != SXRET_OK ){` |
|     ! 0 | 10643 | `				return rc;` |
|       - | 10644 | `			}` |
|    2631 | 10645 | `			GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|    1313 | 10646 | `		}` |
|    2631 | 10647 | `		if( nJmp > 0 ){` |
|       - | 10648 | `			/* Phase#7: Fix the unconditional jump */` |
|    2631 | 10649 | `			pInstr = PH7_VmGetInstr(pGen->pVm,nJmp);` |
|    2631 | 10650 | `			if( pInstr ){` |
|    2631 | 10651 | `				pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    1313 | 10652 | `			}` |
|    1313 | 10653 | `		}` |
|       - | 10654 | `		/* All done */` |
|    2631 | 10655 | `		return SXRET_OK;` |
|       - | 10656 | `	}` |
| 1267361 | 10657 | `	bIsChainOp = GEN_IS_CHAIN_OP(pNode->pOp->iOp);` |
|       - | 10658 | `	/* Generate code for the left tree */` |
| 1267361 | 10659 | `	if( pNode->pLeft ){` |
| 1267323 | 10660 | `		sxu32 nLhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
| 1267323 | 10661 | `		if( iVmOp == PH7_OP_CALL ){` |
|       - | 10662 | `			ph7_expr_node **apNode;` |
|  402641 | 10663 | `			int hasSpread = 0;` |
|  402641 | 10664 | `			int hasNamed = 0;` |
|  402641 | 10665 | `			int bAnySpread = 0;` |
|  402641 | 10666 | `			sxu32 byRefMask = 0;` |
|       - | 10667 | `			sxi32 nArgs;` |
|       - | 10668 | `			sxi32 n;` |
|       - | 10669 | `			/* Recurse and generate bytecodes for function arguments */` |
|  402641 | 10670 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  402641 | 10671 | `			nArgs = (sxi32)SySetUsed(&pNode->aNodeArgs);` |
|       - | 10672 | `			/* Validate: no positional arguments after named arguments */` |
|       - | 10673 | `			{` |
|  402641 | 10674 | `				int seenNamed = 0;` |
|  797425 | 10675 | `				for( n = 0; n < nArgs; ++n ){` |
|  394791 | 10676 | `					if( apNode[n]->iFlags & EXPR_NODE_NAMED_ARG ){` |
|     188 | 10677 | `						seenNamed = 1;` |
|     188 | 10678 | `						hasNamed = 1;` |
|  394699 | 10679 | `					}else if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
|      23 | 10680 | `						bAnySpread = 1;` |
|  394597 | 10681 | `					}else if( seenNamed ){` |
...
|  402639 | 10689 | `			iFlags \|= EXPR_FLAG_RDONLY_LOAD;` |
...
|  402639 | 10694 | `			if( pNode->pLeft && pNode->pLeft->pStart ){` |
|  402639 | 10695 | `				SyString *pCallName = &pNode->pLeft->pStart->sData;` |
|  402634 | 10696 | `				if( pCallName->nByte == 5` |
|  220952 | 10697 | `				 && SyStrnicmp(pCallName->zString,"isset",5) == 0 ){` |
|   20643 | 10698 | `					iFlags \|= EXPR_FLAG_LOAD_IDX_ISSET;` |
|  392320 | 10699 | `				}else if( pCallName->nByte == 5` |
|  200314 | 10700 | `				 && SyStrnicmp(pCallName->zString,"empty",5) == 0 ){` |
...
|  402639 | 10709 | `				if( !bAnySpread && !hasNamed ){` |
|       - | 10710 | `					SyString sBuiltin;` |
|  402521 | 10711 | `					GenStateCallBuiltinName(pNode->pLeft, &sBuiltin);` |
|  402521 | 10712 | `					byRefMask = GenStateByRefBuiltinMask(&sBuiltin);` |
|  201258 | 10713 | `				}` |
|  201317 | 10714 | `			}` |
|  797421 | 10715 | `			for( n = 0 ; n < nArgs ; ++n ){` |
|  394787 | 10716 | `				sxu32 nArgNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  394787 | 10717 | `				sxi32 iArgFlags = iFlags & ~EXPR_FLAG_LOAD_IDX_STORE;` |
|       - | 10718 | `				/* For a by-ref argument position, drop the read-only flag so the` |
|       - | 10719 | `				 * variable is created if absent (PH7_OP_LOAD iP1=0 => bCreate). */` |
|  394787 | 10720 | `				if( n < 31 && (byRefMask & (1u<<n)) ){` |
|      31 | 10721 | `					iArgFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|      13 | 10722 | `				}` |
|  394787 | 10723 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iArgFlags);` |
|  394787 | 10724 | `				if( rc != SXRET_OK ){` |
|     ! 0 | 10725 | `					return rc;` |
|       - | 10726 | `				}` |
|       - | 10727 | `				/* Each argument is an independent nullsafe scope. */` |
|  394787 | 10728 | `				GenStatePatchNullsafeJumps(pGen, nArgNsBase);` |
|  394787 | 10729 | `				if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
|       - | 10730 | `					/* Emit spread opcode to unpack this array argument */` |
|      23 | 10731 | `					PH7_VmEmitInstr(pGen->pVm, PH7_OP_SPREAD, 0, 0, 0, 0);` |
|      23 | 10732 | `					hasSpread = 1;` |
|      10 | 10733 | `				}` |
|  197396 | 10734 | `			}` |
|       - | 10735 | `			/* Total number of given arguments */` |
|  402639 | 10736 | `			iP1 = nArgs;` |
|  402639 | 10737 | `			iP2 = hasSpread;` |
|       - | 10738 | `			/* Build VmCallArgMap if named arguments are present.` |
|       - | 10739 | `			 * Deep-copy name strings so they survive token stream cleanup. */` |
|  402639 | 10740 | `			if( hasNamed ){` |
|     101 | 10741 | `				sxu32 nStrBytes = 0;` |
|       - | 10742 | `				char *zBuf;` |
|     297 | 10743 | `				for( n = 0; n < nArgs; ++n ){` |
|     199 | 10744 | `					if( apNode[n]->iFlags & EXPR_NODE_NAMED_ARG ){` |
|     185 | 10745 | `						nStrBytes += (sxu32)apNode[n]->sArgName.nByte;` |
|      91 | 10746 | `					}` |
|     101 | 10747 | `				}` |
|       - | 10748 | `				{` |
|     101 | 10749 | `				sxu32 mapSize = sizeof(VmCallArgMap) + nArgs * sizeof(SyString) + nStrBytes;` |
|     101 | 10750 | `				VmCallArgMap *pMap = (VmCallArgMap *)SyMemBackendAlloc(` |
|      98 | 10751 | `					&pGen->pVm->sAllocator, mapSize);` |
|     101 | 10752 | `				if( pMap ){` |
|     101 | 10753 | `					SyZero(pMap, mapSize);` |
|     101 | 10754 | `					pMap->bHasNamed = 1;` |
|     101 | 10755 | `					pMap->nTotal = (sxu32)nArgs;` |
|     101 | 10756 | `					pMap->aNames = (SyString *)&pMap[1];` |
|     101 | 10757 | `					zBuf = (char *)&pMap->aNames[nArgs]; /* string storage after SyString array */` |
|     297 | 10758 | `					for( n = 0; n < nArgs; ++n ){` |
|     199 | 10759 | `						if( apNode[n]->iFlags & EXPR_NODE_NAMED_ARG ){` |
|     185 | 10760 | `							sxu32 nb = (sxu32)apNode[n]->sArgName.nByte;` |
|     185 | 10761 | `							SyMemcpy(apNode[n]->sArgName.zString, zBuf, nb);` |
|     185 | 10762 | `							SyStringInitFromBuf(&pMap->aNames[n], zBuf, nb);` |
|     185 | 10763 | `							zBuf += nb;` |
|      91 | 10764 | `						}` |
|       - | 10765 | `						/* else: aNames[n] remains {NULL, 0} for positional */` |
|     101 | 10766 | `					}` |
|     101 | 10767 | `					p3 = (void *)pMap;` |
|      49 | 10768 | `				}` |
|       - | 10769 | `				}` |
|      49 | 10770 | `			}` |
|       - | 10771 | `			/* Remove stale flags now */` |
|  402639 | 10772 | `			iFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|  201317 | 10773 | `		}` |
| 1267321 | 10774 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pLeft,iFlags);` |
| 1267321 | 10775 | `		if( rc != SXRET_OK ){` |
|      34 | 10776 | `			return rc;` |
|       - | 10777 | `		}` |
| 1267291 | 10778 | `		if( !bIsChainOp ){` |
|       - | 10779 | `			/* Non-chain parent: any nullsafe jumps produced by the LHS sub-tree` |
|       - | 10780 | `			 * target the end of that LHS chain, which is right here. */` |
|  591865 | 10781 | `			GenStatePatchNullsafeJumps(pGen, nLhsNsBase);` |
|  295930 | 10782 | `		}` |
| 1267291 | 10783 | `		if( iVmOp == PH7_OP_CALL ){` |
|  402639 | 10784 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|  402639 | 10785 | `			if( pInstr ){` |
|  402639 | 10786 | `				if ( pInstr->iOp == PH7_OP_LOADC ){` |
|  401431 | 10787 | `					sxu32 nOrig = (sxu32)pInstr->iP2;` |
|       - | 10788 | `					sxu32 nQual;` |
|  401431 | 10789 | `					int bAbsolute = (pInstr->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|       - | 10790 | `					/* Prevent constant expansion but preserve the absolute flag` |
|       - | 10791 | `					 * so the later NEW handler (if any) can see it. */` |
|  401431 | 10792 | `					pInstr->iP1 &= ~PH7_LOADC_EXPAND;` |
|       - | 10793 | `					/* Namespace-qualify the function name for CALL, unless the` |
|       - | 10794 | ``					 * literal is absolute (`\Foo(...)`). Only check function`` |
|       - | 10795 | `					 * imports — class imports must NOT affect function` |
|       - | 10796 | ``					 * resolution. For `new Foo()`, the CALL handler fires`` |
|       - | 10797 | `					 * before NEW; we store the original literal index in the` |
|       - | 10798 | `					 * CALL instruction's iP2 so the NEW handler can recover` |
|       - | 10799 | `					 * the unqualified name and re-qualify with class imports. */` |
|  401431 | 10800 | `					if( bAbsolute ){` |
|      26 | 10801 | `						pInstr->iP2 = (sxi32)nOrig;` |
|      15 | 10802 | `					}else{` |
|  401409 | 10803 | `						int fromImport = 0;` |
|  401409 | 10804 | `						nQual = GenStateNsQualifyName(pGen,nOrig,&pGen->hUseFuncImports,&fromImport);` |
|  401409 | 10805 | `						pInstr->iP2 = (sxi32)nQual;` |
|  401409 | 10806 | `						if( nQual != nOrig ){` |
|       - | 10807 | `							/* Store original literal index in CALL's iP2 so the` |
|       - | 10808 | `							 * NEW handler can recover the unqualified name. */` |
|      77 | 10809 | `							iP2 = (sxi32)(nOrig + 1); /* +1 to distinguish from default 0 */` |
|      77 | 10810 | `							if( !fromImport ){` |
|       - | 10811 | `								/* Mark as namespace-qualified via VmCallArgMap */` |
|      67 | 10812 | `								if( p3 == 0 ){` |
|      67 | 10813 | `									VmCallArgMap *pMap = (VmCallArgMap *)SyMemBackendAlloc(` |
|      62 | 10814 | `										&pGen->pVm->sAllocator, sizeof(VmCallArgMap));` |
|      67 | 10815 | `									if( pMap ){` |
|      67 | 10816 | `										SyZero(pMap, sizeof(VmCallArgMap));` |
|      67 | 10817 | `										p3 = (void *)pMap;` |
|      31 | 10818 | `									}` |
|      31 | 10819 | `								}` |
|      67 | 10820 | `								if( p3 ){` |
|      67 | 10821 | `									((VmCallArgMap *)p3)->bIsNamespaced = 1;` |
|      31 | 10822 | `								}` |
|      31 | 10823 | `							}` |
|      36 | 10824 | `						}` |
|       5 | 10825 | `					}` |
|  201926 | 10826 | `				}else if( pInstr->iOp == PH7_OP_MEMBER /* $a->b(1,2,3) */ \|\| pInstr->iOp == PH7_OP_NEW ){` |
|       - | 10827 | `					/* Method call,flag that */` |
|     933 | 10828 | `					pInstr->iP2 = 1;` |
|     464 | 10829 | `				}` |
|  201322 | 10830 | `			}` |
| 1065974 | 10831 | `		}else if( iVmOp == PH7_OP_LOAD_IDX ){` |
|       - | 10832 | `			ph7_expr_node **apNode;` |
|       - | 10833 | `			sxi32 n;` |
|   87243 | 10834 | `			sxi32 iChildMask = ~(EXPR_FLAG_LOAD_IDX_STORE` |
|       - | 10835 | `				\|EXPR_FLAG_LOAD_IDX_ISSET\|EXPR_FLAG_LOAD_IDX_UNSET` |
|       - | 10836 | `				\|EXPR_FLAG_LOAD_IDX_EMPTY);` |
|       - | 10837 | `			/* Recurse and generate bytecodes for array index */` |
|   87243 | 10838 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  157437 | 10839 | `			for( n = 0 ; n < (sxi32)SySetUsed(&pNode->aNodeArgs) ; ++n ){` |
|   70199 | 10840 | `				sxu32 nIdxNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|   70199 | 10841 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iFlags&iChildMask);` |
|   70199 | 10842 | `				if( rc != SXRET_OK ){` |
|     ! 0 | 10843 | `					return rc;` |
|       - | 10844 | `				}` |
|       - | 10845 | `				/* Each subscript index is an independent nullsafe scope. */` |
|   70199 | 10846 | `				GenStatePatchNullsafeJumps(pGen, nIdxNsBase);` |
|   35102 | 10847 | `			}` |
|   87243 | 10848 | `			if( SySetUsed(&pNode->aNodeArgs) > 0 ){` |
|   70199 | 10849 | `				iP1 = 1; /* Node have an index associated with it */` |
|   35097 | 10850 | `			}` |
|   87243 | 10851 | `			if( iFlags & EXPR_FLAG_LOAD_IDX_ISSET ){` |
|       - | 10852 | `				/* offsetExists for ArrayAccess; peek-only for arrays */` |
|     243 | 10853 | `				iP2 = 4;` |
|   87124 | 10854 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_UNSET ){` |
|       - | 10855 | `				/* offsetUnset for ArrayAccess; auto-vivify+load for arrays` |
|       - | 10856 | `				 * so the trailing unset() builtin can drop the slot. */` |
|      54 | 10857 | `				iP2 = 5;` |
|   86980 | 10858 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_EMPTY ){` |
|       - | 10859 | `				/* offsetExists+offsetGet for ArrayAccess so empty() can` |
|       - | 10860 | `				 * short-circuit on missing keys without invoking offsetGet` |
|       - | 10861 | `				 * unnecessarily; peek-only for arrays (same as iP2=0). */` |
|      29 | 10862 | `				iP2 = 6;` |
|   86943 | 10863 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_STORE ){` |
|       - | 10864 | `				/* Create an empty entry when the desired index is not found */` |
|   34365 | 10865 | `				iP2 = 1;` |
|   17185 | 10866 | `			}` |
|  821038 | 10867 | `		}else if( pNode->pOp->iOp == EXPR_OP_COMMA ){` |
|       - | 10868 | `			/* POP the left node */` |
|      32 | 10869 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|      15 | 10870 | `		}` |
|  633643 | 10871 | `	}` |
| 1267329 | 10872 | `	rc = SXRET_OK;` |
| 1267329 | 10873 | `	nJmpIdx = 0;` |
|       - | 10874 | `	/* For :: (static member access), namespace-qualify the class name (left operand).` |
|       - | 10875 | `	 * The left child was just compiled; its LOADC is the last instruction.` |
|       - | 10876 | `	 * Skip self/static/parent — these are keywords, not class names. */` |
| 1267329 | 10877 | `	if( iVmOp == PH7_OP_MEMBER && pNode->pOp->iOp == EXPR_OP_DC ){` |
|     327 | 10878 | `		pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|     327 | 10879 | `		if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|     327 | 10880 | `			ph7_value *pLitCheck = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,(sxu32)pInstr->iP2);` |
|     327 | 10881 | `			int isSpecial = 0;` |
|     327 | 10882 | `			if( pLitCheck && (pLitCheck->iFlags & MEMOBJ_STRING) ){` |
|     239 | 10883 | `				const char *z = (const char *)SyBlobData(&pLitCheck->sBlob);` |
|     239 | 10884 | `				sxu32 n = (sxu32)SyBlobLength(&pLitCheck->sBlob);` |
|     249 | 10885 | `				if( (n == 4 && SyMemcmp(z,"self",4) == 0) \|\|` |
|     217 | 10886 | `					(n == 6 && SyMemcmp(z,"static",6) == 0) \|\|` |
|     110 | 10887 | `					(n == 6 && SyMemcmp(z,"parent",6) == 0) ){` |
|      93 | 10888 | `					isSpecial = 1;` |
|      44 | 10889 | `				}` |
|     139 | 10890 | `			}` |
|     371 | 10891 | `			pInstr->iP1 = 0;` |
|     371 | 10892 | `			if( !isSpecial ){` |
|     195 | 10893 | `				pInstr->iP2 = (sxi32)GenStateNsQualifyName(pGen,(sxu32)pInstr->iP2,&pGen->hUseImports,0);` |
|      95 | 10894 | `			}` |
|       - | 10895 | `			/* Foo::class — resolve at compile time. The LOADC already holds the` |
|       - | 10896 | `			 * namespace-qualified name. self/static/parent need runtime resolution. */` |
|     283 | 10897 | `			if( !isSpecial && pNode->pRight && pNode->pRight->pStart ){` |
|     195 | 10898 | `				SyToken *pRightTok = pNode->pRight->pStart;` |
|     195 | 10899 | `				if( (pRightTok->nType & PH7_TK_KEYWORD) &&` |
|      42 | 10900 | `				    SX_PTR_TO_INT(pRightTok->pUserData) == PH7_TKWRD_CLASS ){` |
|      46 | 10901 | `					return SXRET_OK;` |
|       - | 10902 | `				}` |
|      74 | 10903 | `			}` |
|     118 | 10904 | `		}` |
|     194 | 10905 | `	}` |
|       - | 10906 | `	/* Generate code for the right tree */` |
| 1267251 | 10907 | `	if( pNode->pRight ){` |
|  699595 | 10908 | `		if( iVmOp == PH7_OP_LAND ){` |
|       - | 10909 | `			/* Emit the false jump so we can short-circuit the logical and */` |
|   10665 | 10910 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,1/* Keep the value on the stack */,0,0,&nJmpIdx);` |
|  694265 | 10911 | `		}else if (iVmOp == PH7_OP_LOR ){` |
|       - | 10912 | `			/* Emit the true jump so we can short-circuit the logical or*/` |
|    3573 | 10913 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JNZ,1/* Keep the value on the stack */,0,0,&nJmpIdx);` |
|  687151 | 10914 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLC ){` |
|       - | 10915 | `			/* Null coalescing: if LHS is not null, jump past RHS */` |
|     129 | 10916 | `			iVmOp = 0; /* No binary operator to emit */` |
|     129 | 10917 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_NULLC,0,0,0,&nJmpIdx);` |
|  685354 | 10918 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW ){` |
|       - | 10919 | ``			/* Nullsafe operator `?->` (PHP 8.0): if LHS is null, short-circuit`` |
|       - | 10920 | `			 * the entire containing postfix chain to null. The jump target is` |
|       - | 10921 | `			 * patched later by the innermost non-chain ancestor (or by` |
|       - | 10922 | `			 * PH7_CompileExpr at the outer boundary). Leaves NULL on the stack` |
|       - | 10923 | `			 * when taken; otherwise falls through, leaving the object on stack` |
|       - | 10924 | `			 * so the PH7_OP_MEMBER that follows can consume it. */` |
|     101 | 10925 | `			sxu32 nNsJmp = 0;` |
|     101 | 10926 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_NULLSAFE_JMP,0,0,0,&nNsJmp);` |
|     101 | 10927 | `			SySetPut(&pGen->aNullsafeJmp,(const void *)&nNsJmp);` |
|  685194 | 10928 | `		}else if( pNode->pOp->iPrec == 18 /* Combined binary operators [i.e: =,'.=','+=',*=' ...] precedence */ ){` |
|  284013 | 10929 | `			iFlags \|= EXPR_FLAG_LOAD_IDX_STORE;` |
|  142004 | 10930 | `		}` |
|  699595 | 10931 | `		nRhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  699595 | 10932 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pRight,iFlags);` |
|  699595 | 10933 | `		if( !bIsChainOp ){` |
|       - | 10934 | `			/* Non-chain parent: RHS nullsafe chain ends here, before the` |
|       - | 10935 | `			 * operator instruction is emitted. */` |
|  514083 | 10936 | `			GenStatePatchNullsafeJumps(pGen, nRhsNsBase);` |
|  257039 | 10937 | `		}` |
|  699595 | 10938 | `		if( iVmOp == PH7_OP_STORE ){` |
|  280365 | 10939 | `			if( pNode->pRight && (pNode->pRight->xCode == PH7_CompileList \|\|` |
|  280334 | 10940 | `				pNode->pRight->xCode == PH7_CompileShortList) ){` |
|       - | 10941 | `				/* list()/[] destructuring handles assignment internally via LOAD_LIST;` |
|       - | 10942 | `				 * suppress the STORE instruction entirely.  This check uses the node's` |
|       - | 10943 | `				 * compile handler rather than peeking at the last opcode, because nested` |
|       - | 10944 | `				 * list entries emit extra instructions (DUP, LOAD_IDX, POP) after the` |
|       - | 10945 | `				 * outer LOAD_LIST, which would fool an opcode-based check.` |
|       - | 10946 | `				 */` |
|      74 | 10947 | `				iVmOp = 0;` |
|  280330 | 10948 | `			}else if( (pInstr = PH7_VmPeekInstr(pGen->pVm)) != 0 ){` |
|  280295 | 10949 | `				if(pInstr->iOp == PH7_OP_MEMBER ){` |
|       - | 10950 | `					/* Perform a member store operation [i.e: $this->x = 50] */` |
|   78397 | 10951 | `					iP2 = 1;` |
|   39201 | 10952 | `				}else{` |
|  201903 | 10953 | `					if( pInstr->iOp == PH7_OP_LOAD_IDX ){` |
|       - | 10954 | `						/* Transform the STORE instruction to STORE_IDX instruction */` |
|   34317 | 10955 | `						iVmOp = PH7_OP_STORE_IDX;` |
|   34317 | 10956 | `						iP1 = pInstr->iP1;` |
|   17161 | 10957 | `					}else{` |
|  167591 | 10958 | `						p3 = pInstr->p3;` |
|       - | 10959 | `					}` |
|       - | 10960 | `					/* POP the last dynamic load instruction */` |
|  201903 | 10961 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|       - | 10962 | `				}` |
|  140150 | 10963 | `			}` |
|  559415 | 10964 | `		}else if( iVmOp == PH7_OP_STORE_REF ){` |
|      54 | 10965 | `			pInstr = PH7_VmPopInstr(pGen->pVm);` |
|      54 | 10966 | `			if( pInstr ){` |
|      54 | 10967 | `				if( pInstr->iOp == PH7_OP_LOAD_IDX ){` |
|       - | 10968 | `					/* Array insertion by reference [i.e: $pArray[] =& $some_var; ]` |
|       - | 10969 | `					 * We have to convert the STORE_REF instruction into STORE_IDX_REF` |
|       - | 10970 | `					 */` |
|      17 | 10971 | `					iVmOp = PH7_OP_STORE_IDX_REF;` |
|      17 | 10972 | `					iP1 = pInstr->iP1;` |
|      17 | 10973 | `					iP2 = pInstr->iP2;` |
|      17 | 10974 | `					p3  = pInstr->p3;` |
|       9 | 10975 | `				}else{` |
|      38 | 10976 | `					p3 = pInstr->p3;` |
|       - | 10977 | `				}` |
|      26 | 10978 | `			}` |
|      26 | 10979 | `		}` |
|  349795 | 10980 | `	}` |
| 1267246 | 10981 | `	if( iVmOp == PH7_OP_NEW && pNode->pLeft && pNode->pLeft->pOp == 0` |
|    9152 | 10982 | `		&& pNode->pLeft->xCode == PH7_CompileAnnonClass ){` |
|       - | 10983 | ``		/* `new class {…}`: PH7_CompileAnnonClass already emitted the args, the`` |
|       - | 10984 | `		 * class-name constant, and OP_NEW. Suppress this redundant OP_NEW. */` |
|      21 | 10985 | `		iVmOp = 0;` |
|      10 | 10986 | `	}` |
| 1267251 | 10987 | `	if( iVmOp > 0 ){` |
| 1267007 | 10988 | `		if( iVmOp == PH7_OP_INCR \|\| iVmOp == PH7_OP_DECR ){` |
|   13957 | 10989 | `			if( pNode->iFlags & EXPR_NODE_PRE_INCR ){` |
|       - | 10990 | `				/* Pre-increment/decrement operator [i.e: ++$i,--$j ] */` |
|   10195 | 10991 | `				iP1 = 1;` |
|    5100 | 10992 | `			}` |
| 1260031 | 10993 | `		}else if( iVmOp == PH7_OP_NEW ){` |
|       - | 10994 | `			/* Namespace-qualify the class name for NEW */ {` |
|   18181 | 10995 | `				VmInstr *pPeek = PH7_VmPeekInstr(pGen->pVm);` |
|   18181 | 10996 | `				VmInstr *pCallInstr = 0;` |
|   18181 | 10997 | `				if( pPeek && pPeek->iOp == PH7_OP_CALL ){` |
|   18103 | 10998 | `					pCallInstr = pPeek;` |
|   18103 | 10999 | `					pPeek = PH7_VmPeekNextInstr(pGen->pVm);` |
|    9049 | 11000 | `				}` |
|   18181 | 11001 | `				if( pPeek && pPeek->iOp == PH7_OP_LOADC ){` |
|   18179 | 11002 | `					int bAbsolute = (pPeek->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|       - | 11003 | `					sxu32 nLitForClass;` |
|       - | 11004 | `					/* If the CALL handler already qualified the name using` |
|       - | 11005 | `					 * function imports, recover the original unqualified` |
|       - | 11006 | `					 * literal so we can re-qualify with class imports. */` |
|   18179 | 11007 | `					if( pCallInstr && pCallInstr->iP2 > 0 ){` |
|      37 | 11008 | `						nLitForClass = (sxu32)(pCallInstr->iP2 - 1); /* undo +1 encoding */` |
|      21 | 11009 | `					}else{` |
|   18147 | 11010 | `						nLitForClass = (sxu32)pPeek->iP2;` |
|       - | 11011 | `					}` |
|   18179 | 11012 | `					pPeek->iP1 = 0;` |
|   18179 | 11013 | `					if( !bAbsolute ){` |
|   18161 | 11014 | `						pPeek->iP2 = (sxi32)GenStateNsQualifyName(pGen,nLitForClass,&pGen->hUseImports,0);` |
|    9083 | 11015 | `					}else{` |
|      22 | 11016 | `						pPeek->iP2 = (sxi32)nLitForClass;` |
|       - | 11017 | `					}` |
|    9087 | 11018 | `				}` |
|       - | 11019 | `			}` |
|   18181 | 11020 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|   18181 | 11021 | `			if( pInstr && pInstr->iOp == PH7_OP_CALL ){` |
|       - | 11022 | `				VmInstr *pPrev;` |
|   18103 | 11023 | `				pPrev = PH7_VmPeekNextInstr(pGen->pVm);` |
|   18103 | 11024 | `				if( pPrev == 0 \|\| pPrev->iOp != PH7_OP_MEMBER ){` |
|       - | 11025 | `					/* Pop the call instruction, preserve named-arg map */` |
|   18103 | 11026 | `					iP1 = pInstr->iP1;` |
|   18103 | 11027 | `					if( pInstr->p3 ){` |
|      43 | 11028 | `						p3 = pInstr->p3; /* Transfer VmCallArgMap to NEW */` |
|      19 | 11029 | `					}` |
|   18103 | 11030 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|    9049 | 11031 | `				}` |
|    9054 | 11032 | `			}` |
| 1243967 | 11033 | `		}else if( iVmOp == PH7_OP_IS_A ){` |
|       - | 11034 | `			/* instanceof: right operand is a class name, not a constant.` |
|       - | 11035 | `			 * Namespace-qualify it, but skip self/static/parent and absolute refs. */` |
|     169 | 11036 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|     169 | 11037 | `			if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|     169 | 11038 | `				ph7_value *pLitChk = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,(sxu32)pInstr->iP2);` |
|     169 | 11039 | `				int bAbsolute = (pInstr->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|     169 | 11040 | `				int isSpecialIs = 0;` |
|     169 | 11041 | `				if( pLitChk && (pLitChk->iFlags & MEMOBJ_STRING) ){` |
|     165 | 11042 | `					const char *z = (const char *)SyBlobData(&pLitChk->sBlob);` |
|     165 | 11043 | `					sxu32 n = (sxu32)SyBlobLength(&pLitChk->sBlob);` |
|     165 | 11044 | `					if( (n == 4 && SyMemcmp(z,"self",4) == 0) \|\|` |
|     160 | 11045 | `						(n == 6 && SyMemcmp(z,"static",6) == 0) \|\|` |
|      81 | 11046 | `						(n == 6 && SyMemcmp(z,"parent",6) == 0) ){` |
|      12 | 11047 | `						isSpecialIs = 1;` |
|       5 | 11048 | `					}` |
|      81 | 11049 | `				}` |
|     171 | 11050 | `				pInstr->iP1 = 0;` |
|     171 | 11051 | `				if( !isSpecialIs && !bAbsolute ){` |
|     149 | 11052 | `					pInstr->iP2 = (sxi32)GenStateNsQualifyName(pGen,(sxu32)pInstr->iP2,&pGen->hUseImports,0);` |
|      72 | 11053 | `				}` |
|      86 | 11054 | `			}` |
| 1234800 | 11055 | `		}else if( iVmOp == PH7_OP_MEMBER){` |
|       - | 11056 | `			/* Prevent constant expansion for member/property names.` |
|       - | 11057 | `			 * The right child (member name) was just compiled — its LOADC` |
|       - | 11058 | `			 * should not trigger constant lookup. */` |
|  185517 | 11059 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|  185517 | 11060 | `			if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|  185475 | 11061 | `				pInstr->iP1 = 0;` |
|   92735 | 11062 | `			}` |
|  185517 | 11063 | `			if( pNode->pOp->iOp == EXPR_OP_DC /* '::' */){` |
|       - | 11064 | `				/* Static member access,remember that */` |
|     249 | 11065 | `				iP1 = 1;` |
|     249 | 11066 | `				pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|     249 | 11067 | `				if( pInstr && pInstr->iOp == PH7_OP_LOAD ){` |
|      38 | 11068 | `					p3 = pInstr->p3;` |
|      38 | 11069 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|      17 | 11070 | `				}` |
|     122 | 11071 | `			}` |
|   92756 | 11072 | `		}` |
|       - | 11073 | `		/* Tag CALL/NEW sites with the caller file's strict_types flag.` |
|       - | 11074 | `		 * This is the primary emit path for user-visible calls. */` |
| 1267005 | 11075 | `		if( iVmOp == PH7_OP_CALL \|\| iVmOp == PH7_OP_NEW ){` |
|  420815 | 11076 | `			p3 = GenStateAttachStrictFlag(pGen,p3);` |
|  210405 | 11077 | `		}` |
|       - | 11078 | `		/* Finally,emit the VM instruction associated with this operator */` |
| 1267005 | 11079 | `		PH7_VmEmitInstr(pGen->pVm,iVmOp,iP1,iP2,p3,0);` |
|  633500 | 11080 | `	}` |
| 1267249 | 11081 | `	if( nJmpIdx > 0 ){` |
|       - | 11082 | `		/* Fix short-circuited jumps now the destination is resolved */` |
|   14357 | 11083 | `		pInstr = PH7_VmGetInstr(pGen->pVm,nJmpIdx);` |
|   14357 | 11084 | `		if( pInstr ){` |
|   14357 | 11085 | `			pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    7176 | 11086 | `		}` |
|    7176 | 11087 | `	}` |
| 1267249 | 11088 | `	return rc;` |
| 1668787 | 11089 |  |
|       - | 11090 | `/*` |
|       - | 11091 | ` * Compile a PHP expression.` |
|       - | 11092 | ` * According to the PHP language reference manual:` |
|       - | 11093 | ` *  Expressions are the most important building stones of PHP.` |
|       - | 11094 | ` *  In PHP, almost anything you write is an expression.` |
|       - | 11095 | ` *  The simplest yet most accurate way to define an expression` |
|       - | 11096 | ` *  is "anything that has a value".` |
|       - | 11097 | ` * If something goes wrong while compiling the expression,this` |
|       - | 11098 | ` * function takes care of generating the appropriate error` |
|       - | 11099 | ` * message.` |
|       - | 11100 | ` */` |
|  897952 | 11101 | `static sxi32 PH7_CompileExpr(` |
|       - | 11102 | `	ph7_gen_state *pGen, /* Code generator state */` |
|       - | 11103 | `	sxi32 iFlags,        /* Control flags */` |
|       - | 11104 | `	sxi32 (*xTreeValidator)(ph7_gen_state *,ph7_expr_node *) /* Node validator callback.NULL otherwise */` |
|       - | 11105 | `	)` |
|       5 | 11106 |  |
|       - | 11107 | `	ph7_expr_node *pRoot;` |
|       - | 11108 | `	SySet sExprNode;` |
|       - | 11109 | `	SyToken *pEnd;` |
|       - | 11110 | `	sxi32 nExpr;` |
|       - | 11111 | `	sxi32 iNest;` |
|       - | 11112 | `	sxi32 rc;` |
|       - | 11113 | `	sxu32 nNullsafeBase;` |
|       - | 11114 | `	/* Initialize worker variables */` |
|  897957 | 11115 | `	nExpr = 0;` |
|  897957 | 11116 | `	pRoot = 0;` |
|       - | 11117 | `	/* Any nullsafe jumps still pending belong to an outer scope; isolate` |
|       - | 11118 | ``	 * this expression so its `?->` short-circuits don't leak out. */`` |
|  897957 | 11119 | `	nNullsafeBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  897957 | 11120 | `	SySetInit(&sExprNode,&pGen->pVm->sAllocator,sizeof(ph7_expr_node *));` |
|  897957 | 11121 | `	SySetAlloc(&sExprNode,0x10);` |
|  897957 | 11122 | `	rc = SXRET_OK;` |
|       - | 11123 | `	/* Delimit the expression */` |
|  897957 | 11124 | `	pEnd = pGen->pIn;` |
|  897957 | 11125 | `	iNest = 0;` |
| 6007655 | 11126 | `	while( pEnd < pGen->pEnd ){` |
| 5701401 | 11127 | `		if( pEnd->nType & PH7_TK_OCB /* '{' */ ){` |
|       - | 11128 | `			/* Ticket 1433-30: Annonymous/Closure functions body */` |
|     457 | 11129 | `			iNest++;` |
| 5701175 | 11130 | `		}else if(pEnd->nType & PH7_TK_CCB /* '}' */ ){` |
|     465 | 11131 | `			iNest--;` |
| 5700719 | 11132 | `		}else if( pEnd->nType & PH7_TK_SEMI /* ';' */ ){` |
|  592027 | 11133 | `			if( iNest <= 0 ){` |
|  591703 | 11134 | `				break;` |
|       - | 11135 | `			}` |
|     162 | 11136 | `		}` |
| 5109703 | 11137 | `		pEnd++;` |
|       5 | 11138 | `	}` |
|  897957 | 11139 | `	if( iFlags & EXPR_FLAG_COMMA_STATEMENT ){` |
|   20869 | 11140 | `		SyToken *pEnd2 = pGen->pIn;` |
|   20869 | 11141 | `		iNest = 0;` |
|       - | 11142 | `		/* Stop at the first comma */` |
|   42025 | 11143 | `		while( pEnd2 < pEnd ){` |
|   21167 | 11144 | `			if( pEnd2->nType & (PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*'['*/\|PH7_TK_LPAREN/*'('*/) ){` |
|      65 | 11145 | `				iNest++;` |
|   21137 | 11146 | `			}else if(pEnd2->nType & (PH7_TK_CCB/*'}'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_RPAREN/*')'*/)){` |
|      65 | 11147 | `				iNest--;` |
|   21077 | 11148 | `			}else if( pEnd2->nType & PH7_TK_COMMA /*','*/ ){` |
|      57 | 11149 | `				if( iNest <= 0 ){` |
|       7 | 11150 | `					break;` |
|       - | 11151 | `				}` |
|      23 | 11152 | `			}` |
|   21161 | 11153 | `			pEnd2++;` |
|       5 | 11154 | `		}` |
|   20869 | 11155 | `		if( pEnd2 <pEnd ){` |
|       7 | 11156 | `			pEnd = pEnd2;` |
|       3 | 11157 | `		}` |
|   10432 | 11158 | `	}` |
|  897957 | 11159 | `	if( pEnd > pGen->pIn ){` |
|  897947 | 11160 | `		SyToken *pTmp = pGen->pEnd;` |
|       - | 11161 | `		/* Swap delimiter */` |
|  897947 | 11162 | `		pGen->pEnd = pEnd;` |
|       - | 11163 | `		/* Try to get an expression tree */` |
|  897947 | 11164 | `		rc = PH7_ExprMakeTree(&(*pGen),&sExprNode,&pRoot);` |
|  897947 | 11165 | `		if( rc == SXRET_OK && pRoot ){` |
|  897765 | 11166 | `			rc = SXRET_OK;` |
|  897765 | 11167 | `			if( xTreeValidator ){` |
|       - | 11168 | `				/* Call the upper layer validator callback */` |
|   24755 | 11169 | `				rc = xTreeValidator(&(*pGen),pRoot);` |
|   12375 | 11170 | `			}` |
|  897765 | 11171 | `			if( rc != SXERR_ABORT ){` |
|       - | 11172 | `				/* Generate code for the given tree */` |
|  897765 | 11173 | `				rc = GenStateEmitExprCode(&(*pGen),pRoot,iFlags);` |
|       - | 11174 | `				/* Patch any unresolved nullsafe jumps emitted by this` |
|       - | 11175 | `				 * expression so they short-circuit to its end. */` |
|  897765 | 11176 | `				GenStatePatchNullsafeJumps(pGen, nNullsafeBase);` |
|  448880 | 11177 | `			}` |
|  897765 | 11178 | `			nExpr = 1;` |
|  448880 | 11179 | `		}` |
|       - | 11180 | `		/* Release the whole tree */` |
|  897947 | 11181 | `		PH7_ExprFreeTree(&(*pGen),&sExprNode);` |
|       - | 11182 | `		/* Synchronize token stream */` |
|  897947 | 11183 | `		pGen->pEnd = pTmp;` |
|  897947 | 11184 | `		pGen->pIn  = pEnd;` |
|  897947 | 11185 | `		if( rc == SXERR_ABORT ){` |
|      14 | 11186 | `			SySetRelease(&sExprNode);` |
|      14 | 11187 | `			return SXERR_ABORT;` |
|       - | 11188 | `		}` |
|  448966 | 11189 | `	}` |
|  897947 | 11190 | `	SySetRelease(&sExprNode);` |
|  897947 | 11191 | `	return nExpr > 0 ? SXRET_OK : SXERR_EMPTY;` |
|  448981 | 11192 |  |
|       - | 11193 | `/*` |
|       - | 11194 | ` * Return a pointer to the node construct handler associated` |
|       - | 11195 | ` * with a given node type [i.e: string,integer,float,...].` |
|       - | 11196 | ` */` |
|  227950 | 11197 | `PH7_PRIVATE ProcNodeConstruct PH7_GetNodeHandler(sxu32 nNodeType)` |
|       5 | 11198 |  |
|  227955 | 11199 | `	if( nNodeType & PH7_TK_NUM ){` |
|       - | 11200 | `		/* Numeric literal: Either real or integer */` |
|  119857 | 11201 | `		return PH7_CompileNumLiteral;` |
|  108103 | 11202 | `	}else if( nNodeType & PH7_TK_DSTR ){` |
|       - | 11203 | `		/* Double quoted string */` |
|   22211 | 11204 | `		return PH7_CompileString;` |
|   85897 | 11205 | `	}else if( nNodeType & PH7_TK_SSTR ){` |
|       - | 11206 | `		/* Single quoted string */` |
|   85781 | 11207 | `		return PH7_CompileSimpleString;` |
|     121 | 11208 | `	}else if( nNodeType & PH7_TK_HEREDOC ){` |
|       - | 11209 | `		/* Heredoc */` |
|      68 | 11210 | `		return PH7_CompileHereDoc;` |
|      57 | 11211 | `	}else if( nNodeType & PH7_TK_NOWDOC ){` |
|       - | 11212 | `		/* Nowdoc */` |
|      49 | 11213 | `		return PH7_CompileNowDoc;` |
|       9 | 11214 | `	}else if( nNodeType & PH7_TK_BSTR ){` |
|       - | 11215 | `		/* Backtick quoted string */` |
|       6 | 11216 | `		return PH7_CompileBacktic;` |
|       - | 11217 | `	}` |
|       3 | 11218 | `	return 0;` |
|  113980 | 11219 |  |
|       - | 11220 | `/*` |
|       - | 11221 | `` * Tree validator for unset() arguments — rejects any `?->` node in`` |
|       - | 11222 | ` * the argument expression with PHP's "Can't use nullsafe operator` |
|       - | 11223 | ` * in write context" parse error.` |
|       - | 11224 | ` */` |
|    6824 | 11225 | `static sxi32 GenStateUnsetValidator(ph7_gen_state *pGen, ph7_expr_node *pNode)` |
|       5 | 11226 |  |
|       - | 11227 | `	sxi32 rc;` |
|    6829 | 11228 | `	if( !PH7_ExprContainsNullsafe(pNode) ){` |
|    6827 | 11229 | `		return SXRET_OK;` |
|       - | 11230 | `	}` |
|       5 | 11231 | `	rc = PH7_GenCompileError(pGen,E_PARSE,` |
|       2 | 11232 | `		pNode ? pNode->pStart->nLine : 1,` |
|       - | 11233 | `		"Can't use nullsafe operator in write context");` |
|       3 | 11234 | `	return rc == SXERR_ABORT ? SXERR_ABORT : SXERR_SYNTAX;` |
|    3417 | 11235 |  |
|       - | 11236 | `/*` |
|       - | 11237 | ` * Compile an unset() statement.` |
|       - | 11238 | ` * unset($var, $arr[$key], ...);` |
|       - | 11239 | ` * Each argument is compiled with EXPR_FLAG_LOAD_IDX_STORE so that` |
|       - | 11240 | ` * PH7_OP_LOAD_IDX emits iP2=1, triggering COW separation on the` |
|       - | 11241 | ` * parent array before extracting the element to unset.` |
|       - | 11242 | ` */` |
|    2946 | 11243 | `static sxi32 PH7_CompileUnset(ph7_gen_state *pGen)` |
|       5 | 11244 |  |
|    2951 | 11245 | `	SyToken *pTmp,*pEnd,*pNext = 0;` |
|    2951 | 11246 | `	sxu32 nIdx = 0;` |
|       - | 11247 | `	SyString sName;` |
|       - | 11248 | `	sxi32 rc;` |
|       - | 11249 | `	/* Jump the 'unset' keyword */` |
|    2951 | 11250 | `	pGen->pIn++;` |
|       - | 11251 | `	/* Save delimiter */` |
|    2951 | 11252 | `	pTmp = pGen->pEnd;` |
|       - | 11253 | `	/* Skip optional opening parenthesis and find the matching close */` |
|    2951 | 11254 | `	pEnd = pTmp; /* Default: scan to statement end */` |
|    2951 | 11255 | `	if( pGen->pIn < pTmp && (pGen->pIn->nType & PH7_TK_LPAREN) ){` |
|       - | 11256 | `		/* Find matching ')' — start scanning AFTER the '(' */` |
|       - | 11257 | `		SyToken *pClose;` |
|    2951 | 11258 | `		pGen->pIn++;   /* Skip '(' */` |
|    2951 | 11259 | `		PH7_DelimitNestedTokens(pGen->pIn,pTmp,PH7_TK_LPAREN,PH7_TK_RPAREN,&pClose);` |
|    2951 | 11260 | `		pEnd = pClose; /* Stop at ')' */` |
|    1473 | 11261 | `	}` |
|    2951 | 11262 | `	SyStringInitFromBuf(&sName,"unset",sizeof("unset")-1);` |
|       - | 11263 | `	/* Resolve the 'unset' builtin name once */` |
|    2951 | 11264 | `	if( SXRET_OK != GenStateFindLiteral(&(*pGen),&sName,&nIdx) ){` |
|     363 | 11265 | `		ph7_value *pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|     363 | 11266 | `		if( pObj == 0 ){` |
|     ! 0 | 11267 | `			return SXERR_ABORT;` |
|       - | 11268 | `		}` |
|     363 | 11269 | `		PH7_MemObjInitFromString(pGen->pVm,pObj,&sName);` |
|     363 | 11270 | `		GenStateInstallLiteral(&(*pGen),pObj,nIdx);` |
|     179 | 11271 | `	}` |
|       - | 11272 | `	/* Compile each comma-separated argument */` |
|    9777 | 11273 | `	while( SXRET_OK == PH7_GetNextExpr(pGen->pIn,pEnd,&pNext) ){` |
|    6831 | 11274 | `		if( pGen->pIn < pNext ){` |
|    6831 | 11275 | `			pGen->pEnd = pNext;` |
|    6831 | 11276 | `			rc = PH7_CompileExpr(&(*pGen),` |
|       - | 11277 | `				EXPR_FLAG_RDONLY_LOAD\|EXPR_FLAG_LOAD_IDX_UNSET,` |
|       - | 11278 | `				GenStateUnsetValidator);` |
|    6831 | 11279 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 | 11280 | `				return SXERR_ABORT;` |
|       - | 11281 | `			}` |
|    6831 | 11282 | `			if( rc != SXERR_EMPTY ){` |
|       - | 11283 | `				/* Emit call for this single argument */` |
|    6829 | 11284 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|    6829 | 11285 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_CALL,1,0,GenStateAttachStrictFlag(pGen,0),0);` |
|    6829 | 11286 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|    3412 | 11287 | `			}` |
|    3413 | 11288 | `		}` |
|       - | 11289 | `		/* Jump trailing commas */` |
|   10713 | 11290 | `		while( pNext < pEnd && (pNext->nType & PH7_TK_COMMA) ){` |
|    3887 | 11291 | `			pNext++;` |
|       5 | 11292 | `		}` |
|    6831 | 11293 | `		pGen->pIn = pNext;` |
|       5 | 11294 | `	}` |
|       - | 11295 | `	/* Skip past the closing ')' if present */` |
|    2951 | 11296 | `	if( pGen->pIn < pTmp && (pGen->pIn->nType & PH7_TK_RPAREN) ){` |
|    2951 | 11297 | `		pGen->pIn++;` |
|    1473 | 11298 | `	}` |
|       - | 11299 | `	/* Restore token stream */` |
|    2951 | 11300 | `	pGen->pEnd = pTmp;` |
|    2951 | 11301 | `	return SXRET_OK;` |
|    1478 | 11302 |  |
|       - | 11303 | `/*` |
|       - | 11304 | ` * PHP Language construct table.` |
|       - | 11305 | ` */` |
|       - | 11306 | `static const LangConstruct aLangConstruct[] = {` |
|       - | 11307 | `	{ PH7_TKWRD_ECHO,     PH7_CompileEcho     }, /* echo language construct */` |
|       - | 11308 | `	{ PH7_TKWRD_IF,       PH7_CompileIf       }, /* if statement */` |
|       - | 11309 | `	{ PH7_TKWRD_FOR,      PH7_CompileFor      }, /* for statement */` |
|       - | 11310 | `	{ PH7_TKWRD_WHILE,    PH7_CompileWhile    }, /* while statement */` |
|       - | 11311 | `	{ PH7_TKWRD_FOREACH,  PH7_CompileForeach  }, /* foreach statement */` |
|       - | 11312 | `	{ PH7_TKWRD_FUNCTION, PH7_CompileFunction }, /* function statement */` |
|       - | 11313 | `	{ PH7_TKWRD_CONTINUE, PH7_CompileContinue }, /* continue statement */` |
|       - | 11314 | `	{ PH7_TKWRD_BREAK,    PH7_CompileBreak    }, /* break statement */` |
|       - | 11315 | `	{ PH7_TKWRD_RETURN,   PH7_CompileReturn   }, /* return statement */` |
|       - | 11316 | `	{ PH7_TKWRD_SWITCH,   PH7_CompileSwitch   }, /* Switch statement */` |
|       - | 11317 | `	{ PH7_TKWRD_DO,       PH7_CompileDoWhile  }, /* do{ }while(); statement */` |
|       - | 11318 | `	{ PH7_TKWRD_GLOBAL,   PH7_CompileGlobal   }, /* global statement */` |
|       - | 11319 | `	{ PH7_TKWRD_STATIC,   PH7_CompileStatic   }, /* static statement */` |
|       - | 11320 | `	{ PH7_TKWRD_DIE,      PH7_CompileHalt     }, /* die language construct */` |
|       - | 11321 | `	{ PH7_TKWRD_EXIT,     PH7_CompileHalt     }, /* exit language construct */` |
|       - | 11322 | `	{ PH7_TKWRD_TRY,      PH7_CompileTry      }, /* try statement */` |
|       - | 11323 | `	{ PH7_TKWRD_THROW,    PH7_CompileThrow    }, /* throw statement */` |
|       - | 11324 | `	{ PH7_TKWRD_GOTO,     PH7_CompileGoto     }, /* goto statement */` |
|       - | 11325 | `	{ PH7_TKWRD_CONST,    PH7_CompileConstant }, /* const statement */` |
|       - | 11326 | `	{ PH7_TKWRD_VAR,      PH7_CompileVar      }, /* var statement */` |
|       - | 11327 | `	{ PH7_TKWRD_NAMESPACE, PH7_CompileNamespace }, /* namespace statement */` |
|       - | 11328 | `	{ PH7_TKWRD_USE,      PH7_CompileUse      },  /* use statement */` |
|       - | 11329 | `	{ PH7_TKWRD_DECLARE,  PH7_CompileDeclare  },  /* declare statement */` |
|       - | 11330 | `	{ PH7_TKWRD_UNSET,    PH7_CompileUnset   }   /* unset statement */` |
|       - | 11331 | `};` |
|       - | 11332 | `/*` |
|       - | 11333 | ` * Return a pointer to the statement handler routine associated` |
|       - | 11334 | ` * with a given PHP keyword [i.e: if,for,while,...].` |
|       - | 11335 | ` */` |
|  605346 | 11336 | `static ProcLangConstruct GenStateGetStatementHandler(` |
|       - | 11337 | `	sxu32 nKeywordID,   /* Keyword  ID*/` |
|       - | 11338 | `	SyToken *pLookahed  /* Look-ahead token */` |
|       - | 11339 | `	)` |
|       5 | 11340 |  |
|  605351 | 11341 | `	sxu32 n = 0;` |
| 3125907 | 11342 | `	for(;;){` |
| 6251819 | 11343 | `		if( n >= SX_ARRAYSIZE(aLangConstruct) ){` |
|  130219 | 11344 | `			break;` |
|       - | 11345 | `		}` |
| 6121605 | 11346 | `		if( aLangConstruct[n].nID == nKeywordID ){` |
|  475137 | 11347 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed && (pLookahed->nType & PH7_TK_OP)){` |
|     ! 0 | 11348 | `				const ph7_expr_op *pOp = (const ph7_expr_op *)pLookahed->pUserData;` |
|     ! 0 | 11349 | `				if( pOp && pOp->iOp == EXPR_OP_DC /*::*/){` |
|       - | 11350 | `					/* 'static' (class context),return null */` |
|     ! 0 | 11351 | `					return 0;` |
|       - | 11352 | `				}` |
|     ! 0 | 11353 | `			}` |
|  475132 | 11354 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed` |
|       6 | 11355 | `				&& (pLookahed->nType & PH7_TK_KEYWORD)` |
|       8 | 11356 | `				&& SX_PTR_TO_INT(pLookahed->pUserData) == PH7_TKWRD_FN ){` |
|       - | 11357 | `				/* 'static fn(...)' arrow function — compile as expression */` |
|     ! 0 | 11358 | `				return 0;` |
|       - | 11359 | `			}` |
|       - | 11360 | `			/* Return a pointer to the handler.` |
|       - | 11361 | `			*/` |
|  475137 | 11362 | `			return aLangConstruct[n].xConstruct;` |
|       - | 11363 | `		}` |
| 5646473 | 11364 | `		n++;` |
|       5 | 11365 | `	}` |
|  130219 | 11366 | `	if( pLookahed ){` |
|  130219 | 11367 | `		if(nKeywordID == PH7_TKWRD_INTERFACE && (pLookahed->nType & PH7_TK_ID) ){` |
|   37347 | 11368 | `			return PH7_CompileClassInterface;` |
|   92877 | 11369 | `		}else if(nKeywordID == PH7_TKWRD_CLASS && (pLookahed->nType & PH7_TK_ID) ){` |
|   92571 | 11370 | `			return PH7_CompileClass;` |
|     311 | 11371 | `		}else if(nKeywordID == PH7_TKWRD_TRAIT && (pLookahed->nType & PH7_TK_ID) ){` |
|      65 | 11372 | `			return PH7_CompileTrait;` |
|       - | 11373 | `		}` |
|       - | 11374 | ``		/* `final`/`abstract` (and `readonly`, an ID) class modifiers — possibly`` |
|       - | 11375 | `		 * combined — are routed via GenStateStartsModifiedClass in the chunk` |
|       - | 11376 | `		 * compiler, which can scan the whole modifier run (the lookahead here is` |
|       - | 11377 | ``		 * a single token and cannot see past `final readonly …`). */`` |
|     123 | 11378 | `	}` |
|       - | 11379 | `	/* Not a language construct */` |
|     251 | 11380 | `	return 0;` |
|  302678 | 11381 |  |
|       - | 11382 | `/*` |
|       - | 11383 | ` * Check if the given keyword is in fact a PHP language construct.` |
|       - | 11384 | ` * Return TRUE on success. FALSE otheriwse.` |
|       - | 11385 | ` */` |
|     246 | 11386 | `static int GenStateisLangConstruct(sxu32 nKeyword)` |
|       5 | 11387 |  |
|       - | 11388 | `	int rc;` |
|     251 | 11389 | `	rc = PH7_IsLangConstruct(nKeyword,TRUE);` |
|     251 | 11390 | `	if( rc == FALSE ){` |
|     136 | 11391 | `		if( nKeyword == PH7_TKWRD_SELF \|\| nKeyword == PH7_TKWRD_PARENT \|\| nKeyword == PH7_TKWRD_STATIC` |
|     135 | 11392 | `			\|\| nKeyword == PH7_TKWRD_YIELD` |
|       - | 11393 | `			/*\|\| nKeyword == PH7_TKWRD_CLASS \|\| nKeyword == PH7_TKWRD_FINAL \|\| nKeyword == PH7_TKWRD_EXTENDS` |
|       - | 11394 | `			  \|\| nKeyword == PH7_TKWRD_ABSTRACT \|\| nKeyword == PH7_TKWRD_INTERFACE` |
|       - | 11395 | `			  \|\| nKeyword == PH7_TKWRD_PUBLIC \|\| nKeyword == PH7_TKWRD_PROTECTED` |
|       - | 11396 | `			  \|\| nKeyword == PH7_TKWRD_PRIVATE \|\| nKeyword == PH7_TKWRD_IMPLEMENTS` |
|       - | 11397 | `			*/` |
|       - | 11398 | `			){` |
|     133 | 11399 | `				rc = TRUE;` |
|      64 | 11400 | `		}` |
...
|       5 | 11403 |  |
|       - | 11404 | `/*` |
|       - | 11405 | ` * Compile a PHP chunk.` |
|       - | 11406 | ` * If something goes wrong while compiling the PHP chunk,this function` |
|       - | 11407 | ` * takes care of generating the appropriate error message.` |
|       - | 11408 | ` */` |
|  725214 | 11409 | `static sxi32 GenStateCompileChunk(` |
|       - | 11410 | `	ph7_gen_state *pGen, /* Code generator state */` |
|       - | 11411 | `	sxi32 iFlags         /* Compile flags */` |
|       - | 11412 | `	)` |
|       5 | 11413 |  |
|       - | 11414 | `	ProcLangConstruct xCons;` |
|       - | 11415 | `	sxi32 rc;` |
|  725219 | 11416 | `	rc = SXRET_OK; /* Prevent compiler warning */` |
|  564721 | 11417 | `	for(;;){` |
|  927333 | 11418 | `		int bStmtIsDeclare = 0;` |
|  927333 | 11419 | `		if( pGen->pIn >= pGen->pEnd ){` |
|       - | 11420 | `			/* No more input to process */` |
|   13921 | 11421 | `			break;` |
|       - | 11422 | `		}` |
|       - | 11423 | ``		/* Peek to detect a top-level `declare` so the strict_types lock`` |
|       - | 11424 | `		 * below doesn't fire before the directive has a chance to run. */` |
|  913417 | 11425 | `		if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|  605377 | 11426 | `			sxu32 nPeek = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  605377 | 11427 | `			if( nPeek == PH7_TKWRD_DECLARE ){` |
|      45 | 11428 | `				bStmtIsDeclare = 1;` |
|      20 | 11429 | `			}` |
|  302686 | 11430 | `		}` |
|  913417 | 11431 | `		if( !bStmtIsDeclare && pGen->pCurrent == &pGen->sGlobal ){` |
|       - | 11432 | `			/* Any non-declare top-level statement locks the strict_types` |
|       - | 11433 | `			 * directive: it's now too late for declare(strict_types=1). */` |
|  202089 | 11434 | `			pGen->bStrictTypesLocked = 1;` |
|  101042 | 11435 | `		}` |
|  913417 | 11436 | `		if( pGen->pIn->nType & PH7_TK_OCB /* '{' */ ){` |
|       - | 11437 | `			/* Compile block */` |
|      20 | 11438 | `			rc = PH7_CompileBlock(&(*pGen),0);` |
|      20 | 11439 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 | 11440 | `				break;` |
|       - | 11441 | `			}` |
|      12 | 11442 | `		}else{` |
|  913401 | 11443 | `			xCons = 0;` |
|  913401 | 11444 | `			if( GenStateStartsModifiedClass(pGen->pIn,pGen->pEnd) ){` |
|       - | 11445 | ``				/* `final`/`abstract`/`readonly` (any order) before `class`. Handled`` |
|       - | 11446 | `` 				 * here rather than the keyword-only dispatcher because `readonly` `` |
|       - | 11447 | `				 * is a context-sensitive ID and combos need a full-run scan. */` |
|      57 | 11448 | `				xCons = PH7_CompileClassModifiers;` |
|  913375 | 11449 | `			}else if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|  605351 | 11450 | `				sxu32 nKeyword = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|       - | 11451 | `				/* Try to extract a language construct handler */` |
|  605351 | 11452 | `				xCons = GenStateGetStatementHandler(nKeyword,(&pGen->pIn[1] < pGen->pEnd) ? &pGen->pIn[1] : 0);` |
|  605351 | 11453 | `				if( xCons == 0 && GenStateisLangConstruct(nKeyword) == FALSE ){` |
|      13 | 11454 | `					rc = PH7_GenCompileError(pGen,E_ERROR,pGen->pIn->nLine,` |
|       - | 11455 | `						"Syntax error: Unexpected keyword '%z'",` |
|       8 | 11456 | `						&pGen->pIn->sData);` |
|       9 | 11457 | `					if( rc == SXERR_ABORT ){` |
|     ! 0 | 11458 | `						break;` |
|       - | 11459 | `					}` |
|       - | 11460 | `					/* Synchronize with the first semi-colon and avoid compiling` |
|       - | 11461 | `					 * this erroneous statement.` |
|       - | 11462 | `					 */` |
|       9 | 11463 | `					xCons = PH7_ErrorRecover;` |
|       4 | 11464 | `				}` |
|  610676 | 11465 | `			}else if( (pGen->pIn->nType & PH7_TK_ID) && (&pGen->pIn[1] < pGen->pEnd)` |
|   50491 | 11466 | `				&& (pGen->pIn[1].nType & PH7_TK_COLON /*':'*/) ){` |
|       - | 11467 | `				/* Label found [i.e: Out: ],point to the routine responsible of compiling it */` |
|     117 | 11468 | `				xCons = PH7_CompileLabel;` |
|      56 | 11469 | `			}` |
|  913401 | 11470 | `			if( xCons == 0 ){` |
|       - | 11471 | `				/* Assume an expression an try to compile it */` |
|  308129 | 11472 | `				rc = PH7_CompileExpr(&(*pGen),0,0);` |
|  308129 | 11473 | `				if(  rc != SXERR_EMPTY ){` |
|       - | 11474 | `					/* Pop l-value */` |
|  307979 | 11475 | `					PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|  153987 | 11476 | `				}` |
|  154067 | 11477 | `			}else{` |
|       - | 11478 | `				/* Go compile the sucker */` |
|  605277 | 11479 | `				rc = xCons(&(*pGen));` |
|       - | 11480 | `			}` |
|  913401 | 11481 | `			if( rc == SXERR_ABORT ){` |
|       - | 11482 | `				/* Request to abort compilation */` |
|      14 | 11483 | `				break;` |
|       - | 11484 | `			}` |
|       - | 11485 | `		}` |
|       - | 11486 | `		/* Ignore trailing semi-colons ';' */` |
| 1477791 | 11487 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|  564389 | 11488 | `			pGen->pIn++;` |
|       5 | 11489 | `		}` |
|  913407 | 11490 | `		if( iFlags & PH7_COMPILE_SINGLE_STMT ){` |
|       - | 11491 | `			/* Compile a single statement and return */` |
|  711293 | 11492 | `			break;` |
|       - | 11493 | `		}` |
|       - | 11494 | `		/* LOOP ONE */` |
|       - | 11495 | `		/* LOOP TWO */` |
...
|       - | 11497 | `		/* LOOP FOUR */` |
|       5 | 11498 | `	}` |
|       - | 11499 | `	/* Return compilation status */` |
|  725219 | 11500 | `	return rc;` |
|       5 | 11501 |  |
|       - | 11502 | `/*` |
|       - | 11503 | ` * Compile a Raw PHP chunk.` |
|       - | 11504 | ` * If something goes wrong while compiling the PHP chunk,this function` |
|       - | 11505 | ` * takes care of generating the appropriate error message.` |
|       - | 11506 | ` */` |
|   13928 | 11507 | `static sxi32 PH7_CompilePHP(` |
|       - | 11508 | `	ph7_gen_state *pGen,  /* Code generator state */` |
|       - | 11509 | `	SySet *pTokenSet,     /* Token set */` |
|       - | 11510 | `	int is_expr           /* TRUE if we are dealing with a simple expression */` |
|       - | 11511 | `	)` |
|       5 | 11512 |  |
|   13933 | 11513 | `	SyToken *pScript = pGen->pRawIn; /* Script to compile */` |
|       - | 11514 | `	sxi32 rc;` |
|       - | 11515 | `	/* Reset the token set */` |
|   13933 | 11516 | `	SySetReset(&(*pTokenSet));` |
|       - | 11517 | `	/* Mark as the default token set */` |
|   13933 | 11518 | `	pGen->pTokenSet = &(*pTokenSet);` |
|       - | 11519 | `	/* Advance the stream cursor */` |
|   13933 | 11520 | `	pGen->pRawIn++;` |
|       - | 11521 | `	/* Tokenize the PHP chunk first */` |
|   13933 | 11522 | `	PH7_TokenizePHP(SyStringData(&pScript->sData),SyStringLength(&pScript->sData),pScript->nLine,&(*pTokenSet));` |
|       - | 11523 | `	/* Point to the head and tail of the token stream. */` |
|   13933 | 11524 | `	pGen->pIn  = (SyToken *)SySetBasePtr(pTokenSet);` |
|   13933 | 11525 | `	pGen->pEnd = &pGen->pIn[SySetUsed(pTokenSet)];` |
|   13933 | 11526 | `	if( is_expr ){` |
|     ! 0 | 11527 | `		rc = SXERR_EMPTY;` |
|     ! 0 | 11528 | `		if( pGen->pIn < pGen->pEnd ){` |
|       - | 11529 | `			/* A simple expression,compile it */` |
|     ! 0 | 11530 | `			rc = PH7_CompileExpr(pGen,0,0);` |
|     ! 0 | 11531 | `		}` |
|       - | 11532 | `		/* Emit the DONE instruction */` |
|     ! 0 | 11533 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,(rc != SXERR_EMPTY ? 1 : 0),0,0,0);` |
|     ! 0 | 11534 | `		return SXRET_OK;` |
|       - | 11535 | `	}` |
|   13933 | 11536 | `	if( pGen->pIn < pGen->pEnd && ( pGen->pIn->nType & PH7_TK_EQUAL ) ){` |
|       - | 11537 | `		static const sxu32 nKeyID = PH7_TKWRD_ECHO;` |
|       - | 11538 | `		/*` |
|       - | 11539 | `		 * Shortcut syntax for the 'echo' language construct.` |
|       - | 11540 | `		 * According to the PHP reference manual:` |
|       - | 11541 | `		 *  echo() also has a shortcut syntax, where you can` |
|       - | 11542 | `		 *  immediately follow` |
|       - | 11543 | `		 *  the opening tag with an equals sign as follows:` |
|       - | 11544 | `		 *  <?= 4+5?> is the same as <?echo 4+5?>` |
|       - | 11545 | `		 * Symisc extension:` |
|       - | 11546 | `		 *   This short syntax works with all PHP opening` |
|       - | 11547 | `		 *   tags unlike the default PHP engine that handle` |
|       - | 11548 | `		 *   only short tag.` |
|       - | 11549 | `		 */` |
|       - | 11550 | `		/* Ticket 1433-009: Emulate the 'echo' call */` |
|       3 | 11551 | `		pGen->pIn->nType = PH7_TK_KEYWORD;` |
|       3 | 11552 | `		pGen->pIn->pUserData = SX_INT_TO_PTR(nKeyID);` |
|       3 | 11553 | `		SyStringInitFromBuf(&pGen->pIn->sData,"echo",sizeof("echo")-1);` |
|       3 | 11554 | `		rc = PH7_CompileExpr(pGen,0,0);` |
|       3 | 11555 | `		if( rc != SXERR_EMPTY ){` |
|       3 | 11556 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|       1 | 11557 | `		}` |
|       3 | 11558 | `		return SXRET_OK;` |
|       - | 11559 | `	}` |
|       - | 11560 | `	/* Compile the PHP chunk */` |
|   13931 | 11561 | `	rc = GenStateCompileChunk(pGen,0);` |
|       - | 11562 | `	/* Fix exceptions jumps */` |
|   13931 | 11563 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|       - | 11564 | `	/* Fix gotos now, the jump destination is resolved */` |
|   13931 | 11565 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),0) ){` |
|       3 | 11566 | `		rc = SXERR_ABORT;` |
|       1 | 11567 | `	}` |
|       - | 11568 | `	/* Reset container */` |
|   13931 | 11569 | `	SySetReset(&pGen->aGoto);` |
|   13931 | 11570 | `	SySetReset(&pGen->aLabel);` |
|   13931 | 11571 | `	SySetReset(&pGen->aNullsafeJmp);` |
|       - | 11572 | `	/* Compilation result */` |
|   13931 | 11573 | `	return rc;` |
|    6969 | 11574 |  |
|       - | 11575 | `/*` |
|       - | 11576 | ` * Compile a raw chunk. The raw chunk can contain PHP code embedded` |
|       - | 11577 | ` * in HTML, XML and so on. This function handle all the stuff.` |
|       - | 11578 | ` * This is the only compile interface exported from this file.` |
|       - | 11579 | ` */` |
|   16750 | 11580 | `PH7_PRIVATE sxi32 PH7_CompileScript(` |
|       - | 11581 | `	ph7_vm *pVm,        /* Generate PH7 byte-codes for this Virtual Machine */` |
|       - | 11582 | `	SyString *pScript,  /* Script to compile */` |
|       - | 11583 | `	sxi32 iFlags        /* Compile flags */` |
|       - | 11584 | `	)` |
|       5 | 11585 |  |
|       - | 11586 | `	SySet aPhpToken,aRawToken;` |
|       - | 11587 | `	ph7_gen_state *pCodeGen;` |
|       - | 11588 | `	ph7_value *pRawObj;` |
|       - | 11589 | `	sxu32 nObjIdx;` |
|       - | 11590 | `	sxi32 nRawObj;` |
|       - | 11591 | `	int is_expr;` |
|       - | 11592 | `	sxi8 bSavedStrict;` |
|       - | 11593 | `	sxi8 bSavedStrictLocked;` |
|       - | 11594 | `	sxi32 rc;` |
|   16755 | 11595 | `	if( pScript->nByte < 1 ){` |
|       - | 11596 | `		/* Nothing to compile */` |
|     ! 0 | 11597 | `		return PH7_OK;` |
|       - | 11598 | `	}` |
|       - | 11599 | `	/* Each compiled file has its own strict_types scope. Save the outer` |
|       - | 11600 | `	 * file's flags so include/require restore them on return. */` |
|   16755 | 11601 | `	pCodeGen = &pVm->sCodeGen;` |
|   16755 | 11602 | `	bSavedStrict = pCodeGen->bStrictTypes;` |
|   16755 | 11603 | `	bSavedStrictLocked = pCodeGen->bStrictTypesLocked;` |
|   16755 | 11604 | `	pCodeGen->bStrictTypes = 0;` |
|   16755 | 11605 | `	pCodeGen->bStrictTypesLocked = 0;` |
|       - | 11606 | `	/* Initialize the tokens containers */` |
|   16755 | 11607 | `	SySetInit(&aRawToken,&pVm->sAllocator,sizeof(SyToken));` |
|   16755 | 11608 | `	SySetInit(&aPhpToken,&pVm->sAllocator,sizeof(SyToken));` |
|   16755 | 11609 | `	SySetAlloc(&aPhpToken,0xc0);` |
|   16755 | 11610 | `	is_expr = 0;` |
|   16755 | 11611 | `	if( iFlags & PH7_PHP_ONLY ){` |
|       - | 11612 | `		SyToken sTmp;` |
|       - | 11613 | `		/* PHP only: -*/` |
|    3463 | 11614 | `		sTmp.nLine = 1;` |
|    3463 | 11615 | `		sTmp.nType = PH7_TOKEN_PHP;` |
|    3463 | 11616 | `		sTmp.pUserData = 0;` |
|    3463 | 11617 | `		SyStringDupPtr(&sTmp.sData,pScript);` |
|    3463 | 11618 | `		SySetPut(&aRawToken,(const void *)&sTmp);` |
|    3463 | 11619 | `		if( iFlags & PH7_PHP_EXPR ){` |
|       - | 11620 | `			/* A simple PHP expression */` |
|     ! 0 | 11621 | `			is_expr = 1;` |
|     ! 0 | 11622 | `		}` |
|    1734 | 11623 | `	}else{` |
|       - | 11624 | `		/* Tokenize raw text */` |
|   13297 | 11625 | `		SySetAlloc(&aRawToken,32);` |
|   13297 | 11626 | `		PH7_TokenizeRawText(pScript->zString,pScript->nByte,&aRawToken);` |
|       - | 11627 | `	}` |
|       - | 11628 | `	/* Process high-level tokens */` |
|   16755 | 11629 | `	pCodeGen->pRawIn = (SyToken *)SySetBasePtr(&aRawToken);` |
|   16755 | 11630 | `	pCodeGen->pRawEnd = &pCodeGen->pRawIn[SySetUsed(&aRawToken)];` |
|   16755 | 11631 | `	rc = PH7_OK;` |
|   16755 | 11632 | `	if( is_expr ){` |
|       - | 11633 | `		/* Compile the expression */` |
|     ! 0 | 11634 | `		rc = PH7_CompilePHP(pCodeGen,&aPhpToken,TRUE);` |
|     ! 0 | 11635 | `		goto cleanup;` |
|       - | 11636 | `	}` |
|   16755 | 11637 | `	nObjIdx = 0;` |
|       - | 11638 | `	/* Each compilation unit starts in the global namespace.` |
|       - | 11639 | `	 * Emit NSSWITCH(NULL) so the VM resets namespace state at runtime,` |
|       - | 11640 | `	 * preventing namespace bleeding across include()d files. */` |
|   16755 | 11641 | `	PH7_VmEmitInstr(pVm,PH7_OP_NSSWITCH,0,0,0,0);` |
|       - | 11642 | `	/* Start the compilation process */` |
|   15027 | 11643 | `	for(;;){` |
|   43975 | 11644 | `		if( pCodeGen->pRawIn >= pCodeGen->pRawEnd ){` |
|   16743 | 11645 | `			break; /* No more tokens to process */` |
|       - | 11646 | `		}` |
|   27237 | 11647 | `		if( pCodeGen->pRawIn->nType & PH7_TOKEN_PHP ){` |
|       - | 11648 | `			/* Compile the PHP chunk */` |
|   13933 | 11649 | `			rc = PH7_CompilePHP(pCodeGen,&aPhpToken,FALSE);` |
|   13933 | 11650 | `			if( rc == SXERR_ABORT ){` |
|      16 | 11651 | `				break;` |
|       - | 11652 | `			}` |
|   13921 | 11653 | `			continue;` |
|       - | 11654 | `		}` |
|       - | 11655 | `		/* Raw chunk: [i.e: HTML, XML, etc.] */` |
|   13309 | 11656 | `		nRawObj = 0;` |
|   26655 | 11657 | `		while( (pCodeGen->pRawIn < pCodeGen->pRawEnd) && (pCodeGen->pRawIn->nType != PH7_TOKEN_PHP) ){` |
|       - | 11658 | `			/* Consume the raw chunk without any processing */` |
|   13351 | 11659 | `			pRawObj = PH7_ReserveConstObj(&(*pVm),&nObjIdx);` |
|   13351 | 11660 | `			if( pRawObj == 0 ){` |
|     ! 0 | 11661 | `				rc = SXERR_MEM;` |
|     ! 0 | 11662 | `				break;` |
|       - | 11663 | `			}` |
|       - | 11664 | `			/* Mark as constant and emit the load constant instruction */` |
|   13351 | 11665 | `			PH7_MemObjInitFromString(pVm,pRawObj,&pCodeGen->pRawIn->sData);` |
|   13351 | 11666 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_LOADC,0,nObjIdx,0,0);` |
|   13351 | 11667 | `			++nRawObj;` |
|   13351 | 11668 | `			pCodeGen->pRawIn++; /* Next chunk */` |
|       5 | 11669 | `		}` |
|   13309 | 11670 | `		if( nRawObj > 0 ){` |
|       - | 11671 | `			/* Emit the consume instruction */` |
|   13309 | 11672 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_CONSUME,nRawObj,0,0,0);` |
|    6652 | 11673 | `		}` |
|    8380 | 11674 | `	}` |
|    8375 | 11675 | `cleanup:` |
|   16755 | 11676 | `	SySetRelease(&aRawToken);` |
|   16755 | 11677 | `	SySetRelease(&aPhpToken);` |
|       - | 11678 | `	/* Restore outer file's strict_types scope */` |
|   16755 | 11679 | `	pCodeGen->bStrictTypes = bSavedStrict;` |
|   16755 | 11680 | `	pCodeGen->bStrictTypesLocked = bSavedStrictLocked;` |
|   16755 | 11681 | `	return rc;` |
|    8380 | 11682 |  |
|       - | 11683 | `/*` |
|       - | 11684 | ` * Utility routines.Initialize the code generator.` |
|       - | 11685 | ` */` |
|    3390 | 11686 | `PH7_PRIVATE sxi32 PH7_InitCodeGenerator(` |
|       - | 11687 | `	ph7_vm *pVm,       /* Target VM */` |
|       - | 11688 | `	ProcConsumer xErr, /* Error log consumer callabck  */` |
|       - | 11689 | `	void *pErrData     /* Last argument to xErr() */` |
|       - | 11690 | `	)` |
|       5 | 11691 |  |
|    3395 | 11692 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|       - | 11693 | `	/* Zero the structure */` |
|    3395 | 11694 | `	SyZero(pGen,sizeof(ph7_gen_state));` |
|       - | 11695 | `	/* Initial state */` |
|    3395 | 11696 | `	pGen->pVm  = &(*pVm);` |
|    3395 | 11697 | `	pGen->xErr = xErr;` |
|    3395 | 11698 | `	pGen->pErrData = pErrData;` |
|    3395 | 11699 | `	SySetInit(&pGen->aLabel,&pVm->sAllocator,sizeof(Label));` |
|    3395 | 11700 | `	SySetInit(&pGen->aGoto,&pVm->sAllocator,sizeof(JumpFixup));` |
|    3395 | 11701 | `	SySetInit(&pGen->aNullsafeJmp,&pVm->sAllocator,sizeof(sxu32));` |
|    3395 | 11702 | `	SyHashInit(&pGen->hLiteral,&pVm->sAllocator,0,0);` |
|    3395 | 11703 | `	SyHashInit(&pGen->hVar,&pVm->sAllocator,0,0);` |
|       - | 11704 | `	/* Error log buffer */` |
|    3395 | 11705 | `	SyBlobInit(&pGen->sErrBuf,&pVm->sAllocator);` |
|       - | 11706 | `	/* General purpose working buffer */` |
|    3395 | 11707 | `	SyBlobInit(&pGen->sWorker,&pVm->sAllocator);` |
|       - | 11708 | `	/* Namespace state */` |
|    3395 | 11709 | `	SyBlobInit(&pGen->sNamespace,&pVm->sAllocator);` |
|    3395 | 11710 | `	SyHashInit(&pGen->hUseImports,&pVm->sAllocator,0,0);` |
|    3395 | 11711 | `	SyHashInit(&pGen->hUseFuncImports,&pVm->sAllocator,0,0);` |
|    3395 | 11712 | `	SyHashInit(&pGen->hUseConstImports,&pVm->sAllocator,0,0);` |
|       - | 11713 | `	/* Create the global scope */` |
|    3395 | 11714 | `	GenStateInitBlock(pGen,&pGen->sGlobal,GEN_BLOCK_GLOBAL,PH7_VmInstrLength(&(*pVm)),0);` |
|       - | 11715 | `	/* Point to the global scope */` |
|    3395 | 11716 | `	pGen->pCurrent = &pGen->sGlobal;` |
|    3395 | 11717 | `	return SXRET_OK;` |
|       5 | 11718 |  |
|       - | 11719 | `/*` |
|       - | 11720 | ` * Utility routines. Reset the code generator to it's initial state.` |
|       - | 11721 | ` */` |
|   19800 | 11722 | `PH7_PRIVATE sxi32 PH7_ResetCodeGenerator(` |
|       - | 11723 | `	ph7_vm *pVm,       /* Target VM */` |
|       - | 11724 | `	ProcConsumer xErr, /* Error log consumer callabck  */` |
|       - | 11725 | `	void *pErrData     /* Last argument to xErr() */` |
|       - | 11726 | `	)` |
|       5 | 11727 |  |
|   19805 | 11728 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|       - | 11729 | `	GenBlock *pBlock,*pParent;` |
|       - | 11730 | `	/* Reset state */` |
|   19805 | 11731 | `	SySetReset(&pGen->aLabel);` |
|   19805 | 11732 | `	SySetReset(&pGen->aGoto);` |
|   19805 | 11733 | `	SySetReset(&pGen->aNullsafeJmp);` |
|   19805 | 11734 | `	SyBlobRelease(&pGen->sErrBuf);` |
|   19805 | 11735 | `	SyBlobRelease(&pGen->sWorker);` |
|   19805 | 11736 | `	SyBlobRelease(&pGen->sNamespace);` |
|   19805 | 11737 | `	SyBlobInit(&pGen->sNamespace,&pVm->sAllocator);` |
|   19805 | 11738 | `	SyHashRelease(&pGen->hUseImports);` |
|   19805 | 11739 | `	SyHashInit(&pGen->hUseImports,&pVm->sAllocator,0,0);` |
|   19805 | 11740 | `	SyHashRelease(&pGen->hUseFuncImports);` |
|   19805 | 11741 | `	SyHashInit(&pGen->hUseFuncImports,&pVm->sAllocator,0,0);` |
|   19805 | 11742 | `	SyHashRelease(&pGen->hUseConstImports);` |
|   19805 | 11743 | `	SyHashInit(&pGen->hUseConstImports,&pVm->sAllocator,0,0);` |
|       - | 11744 | `	/* Note: pGen->hVar and pGen->hLiteral are intentionally NOT reset here.` |
|       - | 11745 | `	 * They intern variable names and literal strings that are referenced by` |
|       - | 11746 | `	 * compiled bytecode (pInstr->p3) and runtime frame hash tables (pFrame->hVar).` |
|       - | 11747 | `	 * Releasing them would either leak the interned strings or require freeing` |
|       - | 11748 | `	 * memory still in use.  The entries use pool memory but are bounded by the` |
|       - | 11749 | `	 * number of unique names, which is acceptable. */` |
|       - | 11750 | `	/* Point to the global scope */` |
|   19805 | 11751 | `	pBlock = pGen->pCurrent;` |
|   19805 | 11752 | `	while( pBlock->pParent != 0 ){` |
|     ! 0 | 11753 | `		pParent = pBlock->pParent;` |
|     ! 0 | 11754 | `		GenStateFreeBlock(pBlock);` |
|     ! 0 | 11755 | `		pBlock = pParent;` |
|     ! 0 | 11756 | `	}` |
|   19805 | 11757 | `	pGen->xErr = xErr;` |
|   19805 | 11758 | `	pGen->pErrData = pErrData;` |
|   19805 | 11759 | `	pGen->pCurrent = &pGen->sGlobal;` |
|   19805 | 11760 | `	pGen->pRawIn = pGen->pRawEnd = 0;` |
|   19805 | 11761 | `	pGen->pIn = pGen->pEnd = 0;` |
|   19805 | 11762 | `	pGen->nErr = 0;` |
|   19805 | 11763 | `	return SXRET_OK;` |
|       5 | 11764 |  |
|       - | 11765 | `/*` |
|       - | 11766 | ` * Generate a compile-time error message.` |
|       - | 11767 | ` * If the error count limit is reached (usually 15 error message)` |
|       - | 11768 | ` * this function return SXERR_ABORT.In that case upper-layers must` |
|       - | 11769 | ` * abort compilation immediately.` |
|       - | 11770 | ` */` |
|     602 | 11771 | `PH7_PRIVATE sxi32 PH7_GenCompileError(ph7_gen_state *pGen,sxi32 nErrType,sxu32 nLine,const char *zFormat,...)` |
|       5 | 11772 |  |
|     607 | 11773 | `	SyBlob *pWorker = &pGen->sErrBuf;` |
|     607 | 11774 | `	const char *zErr = "Error";` |
|       - | 11775 | `	SyString *pFile;` |
|       - | 11776 | `	va_list ap;` |
|       - | 11777 | `	sxi32 rc;` |
|       - | 11778 | `	/* Reset the working buffer */` |
|     607 | 11779 | `	SyBlobReset(pWorker);` |
|       - | 11780 | `	/* Peek the processed file path if available */` |
|     607 | 11781 | `	pFile = (SyString *)SySetPeek(&pGen->pVm->aFiles);` |
|     607 | 11782 | `	if( nErrType == E_ERROR ){` |
|       - | 11783 | `		/* Increment the error counter */` |
|     501 | 11784 | `		pGen->nErr++;` |
|     501 | 11785 | `		if( pGen->nErr > 15 ){` |
|       - | 11786 | `			/* Error count limit reached */` |
|       6 | 11787 | `			if( pGen->xErr ){` |
|       6 | 11788 | `				SyBlobAppend(pWorker,"PHP ",4);` |
|       6 | 11789 | `				SyBlobFormat(pWorker,"Fatal error:  Error count limit reached,PH7 is aborting compilation");` |
|       6 | 11790 | `				if( pFile ){` |
|       6 | 11791 | `					SyBlobFormat(pWorker," in %.*s on line %u",pFile->nByte,pFile->zString,nLine);` |
|       2 | 11792 | `				}` |
|       6 | 11793 | `				SyBlobAppend(pWorker,(const void *)"\n",sizeof(char));` |
|       6 | 11794 | `				if( SyBlobLength(pWorker) > 0 ){` |
|       6 | 11795 | `					pGen->xErr(SyBlobData(pWorker),SyBlobLength(pWorker),pGen->pErrData);` |
|       2 | 11796 | `				}` |
|       2 | 11797 | `			}` |
|       - | 11798 | `			/* Abort immediately */` |
|       6 | 11799 | `			return SXERR_ABORT;` |
|       - | 11800 | `		}` |
|     246 | 11801 | `	}` |
|     603 | 11802 | `	if( pGen->xErr == 0 ){` |
|       - | 11803 | `		/* No available error consumer,return immediately */` |
|       3 | 11804 | `		return SXRET_OK;` |
|       - | 11805 | `	}` |
|     600 | 11806 | `	switch(nErrType){` |
|     494 | 11807 | `	case E_ERROR:   zErr = "Fatal error"; break;` |
|      30 | 11808 | `	case E_WARNING: zErr = "Warning";     break;` |
|      76 | 11809 | `	case E_PARSE:   zErr = "Parse error"; break;` |
|      12 | 11810 | `	case E_NOTICE:  zErr = "Notice";      break;` |
|     ! 0 | 11811 | `	case E_USER_ERROR:   zErr = "User error";   break;` |
|     ! 0 | 11812 | `	case E_USER_WARNING: zErr = "User warning"; break;` |
|     ! 0 | 11813 | `	case E_USER_NOTICE:  zErr = "User notice";  break;` |
|     ! 0 | 11814 | `	default:` |
|     ! 0 | 11815 | `		break;` |
|       - | 11816 | `	}` |
|     600 | 11817 | `	rc = SXRET_OK;` |
|       - | 11818 | `	/* Format: PHP <severity>:  <message> in <file> on line <line> */` |
|     600 | 11819 | `	SyBlobAppend(pWorker,"PHP ",4);` |
|     600 | 11820 | `	SyBlobFormat(pWorker,"%s:  ",zErr);` |
|     600 | 11821 | `	va_start(ap,zFormat);` |
|     600 | 11822 | `	SyBlobFormatAp(pWorker,zFormat,ap);` |
|     600 | 11823 | `	va_end(ap);` |
|     600 | 11824 | `	if( pFile ){` |
|     600 | 11825 | `		SyBlobFormat(pWorker," in %.*s on line %u",pFile->nByte,pFile->zString,nLine);` |
|     298 | 11826 | `	}` |
|       - | 11827 | `	/* Append a new line */` |
|     600 | 11828 | `	SyBlobAppend(pWorker,(const void *)"\n",sizeof(char));` |
|     600 | 11829 | `	if( SyBlobLength(pWorker) > 0 ){` |
|       - | 11830 | `		/* Consume the generated error message */` |
|     600 | 11831 | `		pGen->xErr(SyBlobData(pWorker),SyBlobLength(pWorker),pGen->pErrData);` |
|     298 | 11832 | `	}` |
|     600 | 11833 | `	return rc;` |
|     306 | 11834 |  |
|       - | 11835 |  |
