...
|       - |   130 | ` */` |
|    3806 |   131 | `static GenBlock * GenStateFetchBlock(GenBlock *pCurrent,sxi32 iBlockType,sxi32 iCount)` |
|       5 |   132 |  |
|    3811 |   133 | `	GenBlock *pBlock = pCurrent;` |
|   10835 |   134 | `	for(;;){` |
|   21675 |   135 | `		if( pBlock->iFlags & iBlockType ){` |
|    3703 |   136 | `			iCount--; /* Decrement nesting level */` |
|    3703 |   137 | `			if( iCount < 1 ){` |
|       - |   138 | `				/* Block meet with the desired criteria */` |
|    3677 |   139 | `				return pBlock;` |
|       - |   140 | `			}` |
|      13 |   141 | `		}` |
|       - |   142 | `		/* Point to the upper block */` |
|   18003 |   143 | `		pBlock = pBlock->pParent;` |
|   18003 |   144 | `		if( pBlock == 0 \|\| (pBlock->iFlags & (GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC)) ){` |
|       - |   145 | `			/* Forbidden */` |
|      72 |   146 | `			break;` |
|       - |   147 | `		}` |
|       5 |   148 | `	}` |
...
|       - |   154 | ` */` |
|  833352 |   155 | `static void GenStateInitBlock(` |
...
|  833357 |   164 | `	pBlock->nFirstInstr = nFirstInstr;` |
|  833357 |   165 | `	pBlock->pUserData   = pUserData;` |
|  833357 |   166 | `	pBlock->pGen        = pGen;` |
|  833357 |   167 | `	pBlock->iFlags      = iType;` |
|  833357 |   168 | `	pBlock->pParent     = 0;` |
|  833357 |   169 | `	SySetInit(&pBlock->aJumpFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  833357 |   170 | `	SySetInit(&pBlock->aPostContFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  833357 |   171 |  |
|       - |   172 | `/*` |
...
|       - |   177 | ` */` |
|  829824 |   178 | `static sxi32 GenStateEnterBlock(` |
...
|  829829 |   188 | `	pBlock = (GenBlock *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(GenBlock));` |
|  829829 |   189 | `	if( pBlock == 0 ){` |
...
|  829829 |   198 | `	SyZero(pBlock,sizeof(GenBlock));` |
|  829829 |   199 | `	GenStateInitBlock(&(*pGen),pBlock,iType,nFirstInstr,pUserData);` |
|       - |   200 | `	/* Link to the parent block */` |
|  829829 |   201 | `	pBlock->pParent = pGen->pCurrent;` |
|       - |   202 | `	/* Mark as the current block */` |
|  829829 |   203 | `	pGen->pCurrent = pBlock;` |
|  829829 |   204 | `	if( ppBlock ){` |
|       - |   205 | `		/* Write a pointer to the new instance */` |
|  403061 |   206 | `		*ppBlock = pBlock;` |
|  201528 |   207 | `	}` |
|  829829 |   208 | `	return SXRET_OK;` |
|  414917 |   209 |  |
|       - |   210 | `/*` |
|       - |   211 | ` * Release block fields without freeing the whole instance.` |
|       - |   212 | ` */` |
|  829816 |   213 | `static void GenStateReleaseBlock(GenBlock *pBlock)` |
|       5 |   214 |  |
|  829821 |   215 | `	SySetRelease(&pBlock->aPostContFix);` |
|  829821 |   216 | `	SySetRelease(&pBlock->aJumpFix);` |
|  829821 |   217 |  |
|       - |   218 | `/*` |
|       - |   219 | ` * Release a block.` |
|       - |   220 | ` */` |
|  829816 |   221 | `static void GenStateFreeBlock(GenBlock *pBlock)` |
|       5 |   222 |  |
|  829821 |   223 | `	ph7_gen_state *pGen = pBlock->pGen;` |
|  829821 |   224 | `	GenStateReleaseBlock(&(*pBlock));` |
|       - |   225 | `	/* Free the instance */` |
|  829821 |   226 | `	SyMemBackendPoolFree(&pGen->pVm->sAllocator,pBlock);` |
|  829821 |   227 |  |
|       - |   228 | `/*` |
|       - |   229 | ` * POP and release a block from the stack of compiled blocks.` |
|       - |   230 | ` */` |
|  829816 |   231 | `static sxi32 GenStateLeaveBlock(ph7_gen_state *pGen,GenBlock **ppBlock)` |
|       5 |   232 |  |
|  829821 |   233 | `	GenBlock *pBlock = pGen->pCurrent;` |
|  829821 |   234 | `	if( pBlock == 0 ){` |
|       - |   235 | `		/* No more block to pop */` |
|     ! 0 |   236 | `		return SXERR_EMPTY;` |
|       - |   237 | `	}` |
|       - |   238 | `	/* Point to the upper block */` |
|  829821 |   239 | `	pGen->pCurrent = pBlock->pParent;` |
|  829821 |   240 | `	if( ppBlock ){` |
|       - |   241 | `		/* Write a pointer to the popped block */` |
|     ! 0 |   242 | `		*ppBlock = pBlock;` |
|     ! 0 |   243 | `	}else{` |
|       - |   244 | `		/* Safely release the block */` |
|  829821 |   245 | `		GenStateFreeBlock(&(*pBlock));` |
|       - |   246 | `	}` |
|  829821 |   247 | `	return SXRET_OK;` |
|  414913 |   248 |  |
|       - |   249 | `/*` |
...
|       - |   258 | ` */` |
|  235596 |   259 | `static sxi32 GenStateNewJumpFixup(GenBlock *pBlock,sxi32 nJumpType,sxu32 nInstrIdx)` |
|       5 |   260 |  |
|       - |   261 | `	JumpFixup sJumpFix;` |
|       - |   262 | `	sxi32 rc;` |
|       - |   263 | `	/* Init the JumpFixup structure */` |
|  235601 |   264 | `	sJumpFix.nJumpType = nJumpType;` |
|  235601 |   265 | `	sJumpFix.nInstrIdx = nInstrIdx;` |
|       - |   266 | `	/* Insert in the jump fixup table */` |
|  235601 |   267 | `	rc = SySetPut(&pBlock->aJumpFix,(const void *)&sJumpFix);` |
|  235601 |   268 | `	return rc;` |
|       5 |   269 |  |
|       - |   270 | `/*` |
...
|       - |   280 | ` */` |
|  579362 |   281 | `static sxu32 GenStateFixJumps(GenBlock *pBlock,sxi32 nJumpType,sxu32 nJumpDest)` |
|       5 |   282 |  |
|       - |   283 | `	JumpFixup *aFix;` |
|       - |   284 | `	VmInstr *pInstr;` |
|       - |   285 | `	sxu32 nFixed;` |
...
|  579367 |   288 | `	aFix = (JumpFixup *)SySetBasePtr(&pBlock->aJumpFix);` |
|       - |   289 | `	/* Fix the desired jumps */` |
| 1043363 |   290 | `	for( nFixed = n = 0 ; n < SySetUsed(&pBlock->aJumpFix) ; ++n ){` |
|  464001 |   291 | `		if( aFix[n].nJumpType < 0 ){` |
|       - |   292 | `			/* Already fixed */` |
|  184933 |   293 | `			continue;` |
|       - |   294 | `		}` |
|  279073 |   295 | `		if( nJumpType > 0 && aFix[n].nJumpType != nJumpType ){` |
|       - |   296 | `			/* Not of our interest */` |
|   43479 |   297 | `			continue;` |
|       - |   298 | `		}` |
|       - |   299 | `		/* Point to the instruction to fix */` |
|  235599 |   300 | `		pInstr = PH7_VmGetInstr(pBlock->pGen->pVm,aFix[n].nInstrIdx);` |
|  235599 |   301 | `		if( pInstr ){` |
|  235599 |   302 | `			pInstr->iP2 = nJumpDest;` |
|  235599 |   303 | `			nFixed++;` |
|       - |   304 | `			/* Mark as fixed */` |
|  235599 |   305 | `			aFix[n].nJumpType = -1;` |
|  117797 |   306 | `		}` |
|  117802 |   307 | `	}` |
|       - |   308 | `	/* Total number of fixed jumps */` |
|  579367 |   309 | `	return nFixed;` |
|       5 |   310 |  |
|       - |   311 | `/*` |
...
|       - |   317 | ` */` |
|  235176 |   318 | `static sxi32 GenStateFixGoto(ph7_gen_state *pGen,sxu32 nOfft)` |
|       5 |   319 |  |
...
|  235181 |   326 | `	aJumps = (JumpFixup *)SySetBasePtr(&pGen->aGoto);` |
|       - |   327 | `	/* Fix */` |
|  235327 |   328 | `	for( n = nOfft ; n < SySetUsed(&pGen->aGoto) ; ++n ){` |
...
|      46 |   351 | `		}` |
|      51 |   352 | `	}` |
|  235179 |   353 | `	aLabel = (Label *)SySetBasePtr(&pGen->aLabel);` |
|  235311 |   354 | `	for( n = 0 ; n < SySetUsed(&pGen->aLabel) ; ++n ){` |
...
|      12 |   359 | `		}` |
|      71 |   360 | `	}` |
|  235179 |   361 | `	return SXRET_OK;` |
|  117593 |   362 |  |
|       - |   363 | `/*` |
|       - |   364 | ` * Check if a given token value is installed in the literal table.` |
|       - |   365 | ` */` |
|  743966 |   366 | `static sxi32 GenStateFindLiteral(ph7_gen_state *pGen,const SyString *pValue,sxu32 *pIdx)` |
|       5 |   367 |  |
|       - |   368 | `	SyHashEntry *pEntry;` |
|  743971 |   369 | `	pEntry = SyHashGet(&pGen->hLiteral,(const void *)pValue->zString,pValue->nByte);` |
|  743971 |   370 | `	if( pEntry == 0 ){` |
|  323961 |   371 | `		return SXERR_NOTFOUND;` |
|       - |   372 | `	}` |
|  420015 |   373 | `	*pIdx = (sxu32)SX_PTR_TO_INT(pEntry->pUserData);` |
|  420015 |   374 | `	return SXRET_OK;` |
|  371988 |   375 |  |
|       - |   376 | `/*` |
...
|       - |   385 | ` */` |
|  323956 |   386 | `static sxi32 GenStateInstallLiteral(ph7_gen_state *pGen,ph7_value *pObj,sxu32 nIdx)` |
|       5 |   387 |  |
|  323961 |   388 | `	if( SyBlobLength(&pObj->sBlob) > 0 ){` |
|  323961 |   389 | `		SyHashInsert(&pGen->hLiteral,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob),SX_INT_TO_PTR(nIdx));` |
|  161978 |   390 | `	}` |
|  323961 |   391 | `	return SXRET_OK;` |
|       5 |   392 |  |
|       - |   393 | `/*` |
|       - |   394 | ` * Reserve a room for a numeric constant [i.e: 64-bit integer or real number]` |
|       - |   395 | ` * in the constant table.` |
|       - |   396 | ` */` |
|  123672 |   397 | `static ph7_value * GenStateInstallNumLiteral(ph7_gen_state *pGen,sxu32 *pIdx)` |
|       5 |   398 |  |
|       - |   399 | `	ph7_value *pObj;` |
|  123677 |   400 | `	sxu32 nIdx = 0; /* cc warning */` |
|       - |   401 | `	/* Reserve a new constant */` |
|  123677 |   402 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  123677 |   403 | `	if( pObj == 0 ){` |
|     ! 0 |   404 | `		PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|     ! 0 |   405 | `		return 0;` |
|       - |   406 | `	}` |
|  123677 |   407 | `	*pIdx = nIdx;` |
|       - |   408 | `	/* TODO(chems): Create a numeric table (64bit int keys) same as` |
|       - |   409 | `	 * the constant string iterals table [optimization purposes].` |
|       - |   410 | `	 */` |
|  123677 |   411 | `	return pObj;` |
|   61841 |   412 |  |
|       - |   413 | `/*` |
...
|       - |   426 | ` */` |
|  444812 |   427 | `static void *GenStateAttachStrictFlag(ph7_gen_state *pGen, void *p3)` |
|       5 |   428 |  |
|       - |   429 | `	VmCallArgMap *pMap;` |
|  444817 |   430 | `	if( !pGen->bStrictTypes ) return p3;` |
|      33 |   431 | `	if( p3 == 0 ){` |
...
|       - |   497 | ` */` |
|  124336 |   498 | `static int GenStateFindBadNumericSeparator(` |
|       - |   499 | `	const SyString *pRaw, const char **pBadStart, sxu32 *pBadLen)` |
|       5 |   500 |  |
|  124341 |   501 | `	const char *z = pRaw->zString;` |
|  124341 |   502 | `	sxu32 n = pRaw->nByte;` |
|  124341 |   503 | `	int base = 10;` |
|       - |   504 | `	sxu32 i, start;` |
|  124341 |   505 | `	if( n < 2 ) return 0;` |
|   10317 |   506 | `	if( z[0] == '0' && (z[1] == 'x' \|\| z[1] == 'X') ){` |
|      72 |   507 | `		base = 16;` |
|   10282 |   508 | `	}else if( z[0] == '0' && (z[1] == 'b' \|\| z[1] == 'B') ){` |
|     280 |   509 | `		base = 2;` |
|     139 |   510 | `	}` |
|   37323 |   511 | `	for( i = 0; i < n; ++i ){` |
|   27025 |   512 | `		if( z[i] != '_' ) continue;` |
...
|       - |   538 | ` */` |
|  124336 |   539 | `static sxi32 GenStateValidateNumericSeparator(ph7_gen_state *pGen, SyToken *pToken)` |
|       5 |   540 |  |
|  124341 |   541 | `	const char *zBad = 0;` |
|  124341 |   542 | `	sxu32 nBad = 0;` |
|       - |   543 | `	SyString sBad;` |
|       - |   544 | `	sxi32 rc;` |
|  124341 |   545 | `	if( !GenStateFindBadNumericSeparator(&pToken->sData, &zBad, &nBad) ){` |
|  124327 |   546 | `		return SXRET_OK;` |
|       - |   547 | `	}` |
...
|       - |   571 | ` */` |
|  124322 |   572 | `static sxi32 GenStateStripNumericSeparators(` |
...
|       5 |   577 |  |
|       - |   578 | `	sxu32 i, j;` |
|  124327 |   579 | `	int hasUnderscore = 0;` |
|       - |   580 | `	char *zBuf;` |
|  124327 |   581 | `	*pzAlloc = 0;` |
|  263291 |   582 | `	for( i = 0; i < pToken->nByte; ++i ){` |
|  139221 |   583 | `		if( pToken->zString[i] == '_' ){ hasUnderscore = 1; break; }` |
|   69487 |   584 | `	}` |
|  124327 |   585 | `	if( !hasUnderscore ){` |
|  124075 |   586 | `		SyStringDupPtr(pOut, pToken);` |
|  124075 |   587 | `		return SXRET_OK;` |
|       - |   588 | `	}` |
...
|       - |   619 | ` *  documentation.` |
|       - |   620 | ` */` |
|  124308 |   621 | `static sxi32 PH7_CompileNumLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |   622 |  |
|  124313 |   623 | `	SyToken *pToken = pGen->pIn; /* Raw token */` |
|  124313 |   624 | `	sxu32 nIdx = 0;` |
|       - |   625 | `	char zScratch[GEN_NUM_SCRATCH];` |
|  124313 |   626 | `	char *zAlloc = 0;` |
|       - |   627 | `	SyString sNum;` |
|       - |   628 | `	sxi32 rc;` |
|   62154 |   629 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|  124313 |   630 | `	rc = GenStateValidateNumericSeparator(pGen, pToken);` |
|  124313 |   631 | `	if( rc != SXRET_OK ){` |
|      14 |   632 | `		return rc;` |
|       - |   633 | `	}` |
|  186452 |   634 | `	rc = GenStateStripNumericSeparators(&pGen->pVm->sAllocator, &pToken->sData,` |
|   62149 |   635 | `		zScratch, sizeof(zScratch), &sNum, &zAlloc);` |
|  124303 |   636 | `	if( rc != SXRET_OK ){` |
|     ! 0 |   637 | `		return SXERR_ABORT;` |
|       - |   638 | `	}` |
|  124303 |   639 | `	if( pToken->nType & PH7_TK_INTEGER ){` |
|       - |   640 | `		ph7_value *pObj;` |
|       - |   641 | `		sxi64 iValue;` |
|  123677 |   642 | `		iValue = PH7_TokenValueToInt64(&sNum);` |
|  123677 |   643 | `		pObj = GenStateInstallNumLiteral(&(*pGen),&nIdx);` |
|  123677 |   644 | `		if( pObj == 0 ){` |
|     ! 0 |   645 | `			if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|     ! 0 |   646 | `			return SXERR_ABORT;` |
|       - |   647 | `		}` |
|  123677 |   648 | `		PH7_MemObjInitFromInt(pGen->pVm,pObj,iValue);` |
|   61841 |   649 | `	}else{` |
|       - |   650 | `		/* Real number */` |
|       - |   651 | `		ph7_value *pObj;` |
...
|       - |   661 | `	}` |
|  124303 |   662 | `	if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|       - |   663 | `	/* Emit the load constant instruction */` |
|  124303 |   664 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|       - |   665 | `	/* Node successfully compiled */` |
|  124303 |   666 | `	return SXRET_OK;` |
|   62159 |   667 |  |
|       - |   668 | `/*` |
...
|       - |   677 | ` *` |
|       - |   678 | ` */` |
|   88968 |   679 | `PH7_PRIVATE sxi32 PH7_CompileSimpleString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |   680 |  |
|   88973 |   681 | `	SyString *pStr = &pGen->pIn->sData; /* Constant string literal */` |
|       - |   682 | `	const char *zIn,*zCur,*zEnd;` |
|       - |   683 | `	ph7_value *pObj;` |
|       - |   684 | `	sxu32 nIdx;` |
|   88973 |   685 | `	nIdx = 0; /* Prevent compiler warning */` |
|       - |   686 | `	/* Delimit the string */` |
|   88973 |   687 | `	zIn  = pStr->zString;` |
|   88973 |   688 | `	zEnd = &zIn[pStr->nByte];` |
|   88973 |   689 | `	if( zIn >= zEnd ){` |
|       - |   690 | `		/* Empty string constant: just use the pre‑allocated index from the VM` |
|       - |   691 | `		 * rather than reserving a new object each time. */` |
|    7227 |   692 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,pGen->pVm->nEmptyStringIdx,0,0);` |
|    7227 |   693 | `		return SXRET_OK;` |
|       - |   694 | `	}` |
|   81751 |   695 | `	if( SXRET_OK == GenStateFindLiteral(&(*pGen),pStr,&nIdx) ){` |
|       - |   696 | `		/* Already processed,emit the load constant instruction` |
|       - |   697 | `		 * and return.` |
|       - |   698 | `		 */` |
|   32209 |   699 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   32209 |   700 | `		return SXRET_OK;` |
|       - |   701 | `	}` |
|       - |   702 | `	/* Reserve a new constant */` |
|   49547 |   703 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   49547 |   704 | `	if( pObj == 0 ){` |
...
|       - |   708 | `	}` |
|   49547 |   709 | `	PH7_MemObjInitFromString(pGen->pVm,pObj,0);` |
|       - |   710 | `	/* Compile the node */` |
|   49597 |   711 | `	for(;;){` |
|   99199 |   712 | `		if( zIn >= zEnd ){` |
|       - |   713 | `			/* End of input */` |
|   49547 |   714 | `			break;` |
|       - |   715 | `		}` |
|   49657 |   716 | `		zCur = zIn;` |
|  782189 |   717 | `		while( zIn < zEnd && zIn[0] != '\\' ){` |
|  732537 |   718 | `			zIn++;` |
|       5 |   719 | `		}` |
|   49657 |   720 | `		if( zIn > zCur ){` |
|       - |   721 | `			/* Append raw contents*/` |
|   49633 |   722 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|   24814 |   723 | `		}` |
|   49657 |   724 | `		zIn++;` |
|   49657 |   725 | `		if( zIn < zEnd ){` |
|     132 |   726 | `			if( zIn[0] == '\\' ){` |
...
|   49547 |   743 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   49547 |   744 | `	if( pStr->nByte < 1024 ){` |
|       - |   745 | `		/* Install in the literal table */` |
|   49547 |   746 | `		GenStateInstallLiteral(pGen,pObj,nIdx);` |
|   24771 |   747 | `	}` |
|       - |   748 | `	/* Node successfully compiled */` |
|   49547 |   749 | `	return SXRET_OK;` |
|   44489 |   750 |  |
|       - |   751 | `/*` |
...
|       - |   949 | ` */` |
|   24318 |   950 | `static ph7_value * GenStateNewStrObj(ph7_gen_state *pGen,sxi32 *pCount)` |
|       5 |   951 |  |
|       - |   952 | `	ph7_value *pConstObj;` |
|   24323 |   953 | `	sxu32 nIdx = 0;` |
|       - |   954 | `	/* Reserve a new constant */` |
|   24323 |   955 | `	pConstObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   24323 |   956 | `	if( pConstObj == 0 ){` |
|     ! 0 |   957 | `		PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"PH7 engine is running out of memory");` |
|     ! 0 |   958 | `		return 0;` |
|       - |   959 | `	}` |
|   24323 |   960 | `	(*pCount)++;` |
|   24323 |   961 | `	PH7_MemObjInitFromString(pGen->pVm,pConstObj,0);` |
|       - |   962 | `	/* Emit the load constant instruction */` |
|   24323 |   963 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   24323 |   964 | `	return pConstObj;` |
|   12164 |   965 |  |
|       - |   966 | `/*` |
...
|       - |  1003 | ` */` |
|   22854 |  1004 | `static sxi32 GenStateCompileString(ph7_gen_state *pGen)` |
|       5 |  1005 |  |
|   22859 |  1006 | `	SyString *pStr = &pGen->pIn->sData; /* Raw token value */` |
|       - |  1007 | `	const char *zIn,*zCur,*zEnd;` |
|   22859 |  1008 | `	ph7_value *pObj = 0;` |
|       - |  1009 | `	sxi32 iCons;` |
|       - |  1010 | `	sxi32 rc;` |
|       - |  1011 | `	/* Delimit the string */` |
|   22859 |  1012 | `	zIn  = pStr->zString;` |
|   22859 |  1013 | `	zEnd = &zIn[pStr->nByte];` |
|   22859 |  1014 | `	if( zIn >= zEnd ){` |
...
|   12379 |  1025 | `	for(;;){` |
|   37029 |  1026 | `		zCur = zIn;` |
|  176137 |  1027 | `		while( zIn < zEnd && zIn[0] != '\\'  ){` |
|  141325 |  1028 | `			if( zIn[0] == '{' && &zIn[1] < zEnd && zIn[1] == '$' ){` |
|      67 |  1029 | `				break;` |
|  141201 |  1030 | `			}else if(zIn[0] == '$' && &zIn[1] < zEnd &&` |
|    2092 |  1031 | `				(((unsigned char)zIn[1] >= 0xc0 \|\| SyisAlpha(zIn[1]) \|\| zIn[1] == '{' \|\| zIn[1] == '_')) ){` |
|    1047 |  1032 | `					break;` |
|       - |  1033 | `			}` |
|  139113 |  1034 | `			zIn++;` |
|       5 |  1035 | `		}` |
|   37029 |  1036 | `		if( zIn > zCur ){` |
|   17349 |  1037 | `			if( pObj == 0 ){` |
|   16875 |  1038 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|   16875 |  1039 | `				if( pObj == 0 ){` |
|     ! 0 |  1040 | `					return SXERR_ABORT;` |
|       - |  1041 | `				}` |
|    8435 |  1042 | `			}` |
|   17349 |  1043 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|    8672 |  1044 | `		}` |
|   37029 |  1045 | `		if( zIn >= zEnd ){` |
|   22551 |  1046 | `			break;` |
|       - |  1047 | `		}` |
|   14483 |  1048 | `		if( zIn[0] == '\\' ){` |
|   12271 |  1049 | `			const char *zPtr = 0;` |
|       - |  1050 | `			sxu32 n;` |
|   12271 |  1051 | `			zIn++;` |
|   12271 |  1052 | `			if( zIn >= zEnd ){` |
|     ! 0 |  1053 | `				break;` |
|       - |  1054 | `			}` |
|   12271 |  1055 | `			if( pObj == 0 ){` |
|    7453 |  1056 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|    7453 |  1057 | `				if( pObj == 0 ){` |
|     ! 0 |  1058 | `					return SXERR_ABORT;` |
|       - |  1059 | `				}` |
|    3724 |  1060 | `			}` |
|   12271 |  1061 | `			n = sizeof(char); /* size of conversion */` |
|   12271 |  1062 | `			switch( zIn[0] ){` |
|       7 |  1063 | `			case '$':` |
|       - |  1064 | `				/* Dollar sign */` |
...
|   11305 |  1085 | `				PH7_MemObjStringAppend(pObj,"\n",sizeof(char));` |
|   11305 |  1086 | `				break;` |
|      19 |  1087 | `			case 'r':` |
...
|   22551 |  1278 | `	return SXRET_OK;` |
|   11432 |  1279 |  |
|       - |  1280 | `/*` |
|       - |  1281 | ` * Compile a double quoted string.` |
|       - |  1282 | ` *  See the block-comment above for more information.` |
|       - |  1283 | ` */` |
|   22794 |  1284 | `PH7_PRIVATE sxi32 PH7_CompileString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  1285 |  |
|       - |  1286 | `	sxi32 rc;` |
|   22799 |  1287 | `	rc = GenStateCompileString(&(*pGen));` |
|   11397 |  1288 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|       - |  1289 | `	/* Compilation result */` |
|   22799 |  1290 | `	return rc;` |
|       5 |  1291 |  |
|       - |  1292 | `/*` |
...
|       - |  1333 | ` */` |
|   21482 |  1334 | `static sxi32 GenStateCompileArrayEntry(` |
...
|   21487 |  1345 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|       - |  1346 | `	/* Compile the expression*/` |
|   21487 |  1347 | `	rc = PH7_CompileExpr(&(*pGen),iFlags,xValidator);` |
|       - |  1348 | `	/* Restore token stream */` |
|   21487 |  1349 | `	RE_SWAP_DELIMITER(pGen);` |
|   21487 |  1350 | `	return rc;` |
|       5 |  1351 |  |
|       - |  1352 | `/*` |
...
|       - |  1390 | ` */` |
|   23830 |  1391 | `static SyToken * GenStateFindTopLevelArrow(SyToken *pStart,SyToken *pEnd)` |
|       5 |  1392 |  |
|   23835 |  1393 | `	SyToken *pCur = pStart;` |
|   23835 |  1394 | `	sxi32 iNest = 0;` |
|   67501 |  1395 | `	while( pCur < pEnd ){` |
|   49067 |  1396 | `		if( (pCur->nType & PH7_TK_ARRAY_OP) && iNest <= 0 ){` |
|    5397 |  1397 | `			return pCur;` |
|       - |  1398 | `		}` |
...
|       - |  1402 | `		 */` |
|   43675 |  1403 | `		if( iNest == 0 && (pCur->nType & PH7_TK_KEYWORD) ){` |
...
|       - |  1462 | `			}` |
|      43 |  1463 | `		}` |
|   43669 |  1464 | `		if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|     326 |  1465 | `			iNest++;` |
|   43508 |  1466 | `		}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}'*/) ){` |
...
|       - |  1479 | ` */` |
|   30994 |  1480 | `static sxi32 GenStateCompileArrayBody(ph7_gen_state *pGen)` |
|       5 |  1481 |  |
|       - |  1482 | `	sxi32 (*xValidator)(ph7_gen_state *,ph7_expr_node *); /* Expression tree validator callback */` |
|       - |  1483 | `	SyToken *pKey,*pCur;` |
|   30999 |  1484 | `	sxi32 iEmitRef = 0;` |
|   30999 |  1485 | `	sxi32 iSpread = 0;` |
|   30999 |  1486 | `	sxi32 nPair = 0;` |
|       - |  1487 | `	sxi32 rc;` |
|   30999 |  1488 | `	xValidator = 0;` |
|   25346 |  1489 | `	for(;;){` |
|       - |  1490 | `		/* Jump leading commas */` |
|   57483 |  1491 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA) ){` |
|    6791 |  1492 | `			pGen->pIn++;` |
|       5 |  1493 | `		}` |
|   50697 |  1494 | `		pCur = pGen->pIn;` |
|   50697 |  1495 | `		if( SXRET_OK != PH7_GetNextExpr(pGen->pIn,pGen->pEnd,&pGen->pIn) ){` |
|       - |  1496 | `			/* No more entry to process */` |
|   30983 |  1497 | `			break;` |
|       - |  1498 | `		}` |
|   19719 |  1499 | `		if( pCur >= pGen->pIn ){` |
|     ! 0 |  1500 | `			continue;` |
|       - |  1501 | `		}` |
|       - |  1502 | `		/* Compile the key if available */` |
|   19719 |  1503 | `		pKey = pCur;` |
|   19719 |  1504 | `		pCur = GenStateFindTopLevelArrow(pCur,pGen->pIn);` |
|   19719 |  1505 | `		rc = SXERR_EMPTY;` |
|   19719 |  1506 | `		if( pCur < pGen->pIn ){` |
...
|   18119 |  1528 | `			pCur = pKey;` |
|       - |  1529 | `		}` |
|   19709 |  1530 | `		if( rc == SXERR_EMPTY ){` |
|       - |  1531 | `			/* No available key,load NULL */` |
|   18121 |  1532 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,0 /* nil index */,0,0);` |
|    9058 |  1533 | `		}` |
|   19709 |  1534 | `		if( pCur->nType & PH7_TK_AMPER /*'&'*/){` |
...
|   19707 |  1553 | `		iSpread = (pCur < pGen->pIn && (pCur->nType & PH7_TK_ELLIPSIS)) ? 1 : 0;` |
|   19707 |  1554 | `		if( iSpread && (rc != SXERR_EMPTY \|\| iEmitRef) ){` |
...
|   19703 |  1567 | `		rc = GenStateCompileArrayEntry(&(*pGen),pCur,pGen->pIn,EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,xValidator);` |
|   19703 |  1568 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  1569 | `			return SXERR_ABORT;` |
|       - |  1570 | `		}` |
|   19703 |  1571 | `		if( iSpread ){` |
...
|   19672 |  1574 | `		}else if( iEmitRef ){` |
|       - |  1575 | `			/* Emit the load reference instruction */` |
|      40 |  1576 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_REF,0,0,0,0);` |
|      18 |  1577 | `		}` |
|   19703 |  1578 | `		xValidator = 0;` |
|   19703 |  1579 | `		iEmitRef = 0;` |
|   19703 |  1580 | `		iSpread = 0;` |
|   19703 |  1581 | `		nPair++;` |
|       5 |  1582 | `	}` |
|       - |  1583 | `	/* Emit the load map instruction */` |
|   30983 |  1584 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_MAP,nPair * 2,0,0,0);` |
|       - |  1585 | `	/* Node successfully compiled */` |
|   30983 |  1586 | `	return SXRET_OK;` |
|   15502 |  1587 |  |
|       - |  1588 | `/*` |
...
|       - |  1596 | ` */` |
|   30032 |  1597 | `PH7_PRIVATE sxi32 PH7_CompileArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  1598 |  |
|       - |  1599 | `	/* Jump the 'array' keyword and the leading '(', exclude trailing ')'. */` |
|   30037 |  1600 | `	pGen->pIn += 2;` |
|   30037 |  1601 | `	pGen->pEnd--;` |
|   15016 |  1602 | `	SXUNUSED(iCompileFlag);` |
|   30037 |  1603 | `	return GenStateCompileArrayBody(pGen);` |
|       5 |  1604 |  |
|       - |  1605 | `/*` |
...
|       - |  2870 | ` */` |
| 1103888 |  2871 | `PH7_PRIVATE sxi32 PH7_CompileVariable(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  2872 |  |
| 1103893 |  2873 | `	sxu32 nLineLocal = pGen->pIn->nLine;` |
|       - |  2874 | `	sxi32 iVv;` |
|       - |  2875 | `	sxi32 iP1;` |
|       - |  2876 | `	void *p3;` |
|       - |  2877 | `	sxi32 rc;` |
| 1103893 |  2878 | `	iVv = -1; /* Variable variable counter */` |
| 2207793 |  2879 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) ){` |
| 1103905 |  2880 | `		pGen->pIn++;` |
| 1103905 |  2881 | `		iVv++;` |
|       5 |  2882 | `	}` |
| 1103893 |  2883 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_OCB/*'{'*/)) == 0 ){` |
...
|       - |  2891 | `	}` |
| 1103893 |  2892 | `	p3  = 0;` |
| 1103893 |  2893 | `	if( pGen->pIn->nType & PH7_TK_OCB/*'{'*/ ){` |
...
|       - |  2912 | `		SyString *pName;` |
| 1103877 |  2913 | `		char *zName = 0;` |
|       - |  2914 | `		/* Extract variable name */` |
| 1103877 |  2915 | `		pName = &pGen->pIn->sData;` |
|       - |  2916 | `		/* Advance the stream cursor */` |
| 1103877 |  2917 | `		pGen->pIn++;` |
| 1103877 |  2918 | `		pEntry = SyHashGet(&pGen->hVar,(const void *)pName->zString,pName->nByte);` |
| 1103877 |  2919 | `		if( pEntry == 0 ){` |
|       - |  2920 | `			/* Duplicate name */` |
|  148239 |  2921 | `			zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|  148239 |  2922 | `			if( zName == 0 ){` |
...
|  148239 |  2927 | `			SyHashInsert(&pGen->hVar,zName,pName->nByte,zName);` |
|   74122 |  2928 | `		}else{` |
|       - |  2929 | `			/* Name already available */` |
|  955643 |  2930 | `			zName = (char *)pEntry->pUserData;` |
|       - |  2931 | `		}` |
| 1103877 |  2932 | `		p3 = (void *)zName;` |
|       - |  2933 | `	}` |
| 1103889 |  2934 | `	iP1 = 0;` |
| 1103889 |  2935 | `	if( iCompileFlag & EXPR_FLAG_RDONLY_LOAD ){` |
|  401747 |  2936 | `		if( (iCompileFlag & EXPR_FLAG_LOAD_IDX_STORE) == 0 ){` |
|       - |  2937 | `			/* Read-only load.In other words do not create the variable if inexistant */` |
|  401729 |  2938 | `			iP1 = 1;` |
|  200862 |  2939 | `		}` |
|  200871 |  2940 | `	}` |
|       - |  2941 | `	/* Emit the load instruction */` |
| 1103889 |  2942 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,0,p3,0);` |
| 1103901 |  2943 | `	while( iVv > 0 ){` |
|      13 |  2944 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,0,0,0);` |
|      13 |  2945 | `		iVv--;` |
|       1 |  2946 | `	}` |
|       - |  2947 | `	/* Node successfully compiled */` |
| 1103889 |  2948 | `	return SXRET_OK;` |
|  551949 |  2949 |  |
|       - |  2950 | `/*` |
|       - |  2951 | ` * Load a literal.` |
|       - |  2952 | ` */` |
|  777572 |  2953 | `static sxi32 GenStateLoadLiteral(ph7_gen_state *pGen)` |
|       5 |  2954 |  |
|  777577 |  2955 | `	SyToken *pToken = pGen->pIn;` |
|       - |  2956 | `	ph7_value *pObj;` |
|       - |  2957 | `	SyString *pStr;` |
|       - |  2958 | `	sxu32 nIdx;` |
|       - |  2959 | `	/* Extract token value */` |
|  777577 |  2960 | `	pStr = &pToken->sData;` |
|       - |  2961 | `	/* Deal with the reserved literals [i.e: null,false,true,...] first */` |
|  777577 |  2962 | `	if( pStr->nByte == sizeof("NULL") - 1 ){` |
|  164831 |  2963 | `		if( SyStrnicmp(pStr->zString,"null",sizeof("NULL")-1) == 0 ){` |
|       - |  2964 | `			/* NULL constant are always indexed at 0 */` |
|   60721 |  2965 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,0,0,0);` |
|   60721 |  2966 | `			return SXRET_OK;` |
|  104115 |  2967 | `		}else if( SyStrnicmp(pStr->zString,"true",sizeof("TRUE")-1) == 0 ){` |
|       - |  2968 | `			/* TRUE constant are always indexed at 1 */` |
|     671 |  2969 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,1,0,0);` |
|     671 |  2970 | `			return SXRET_OK;` |
|       5 |  2971 | `		}` |
|  726012 |  2972 | `	}else if (pStr->nByte == sizeof("FALSE") - 1 &&` |
|  123078 |  2973 | `		SyStrnicmp(pStr->zString,"false",sizeof("FALSE")-1) == 0 ){` |
|       - |  2974 | `			/* FALSE constant are always indexed at 2 */` |
|   46553 |  2975 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,2,0,0);` |
|   46553 |  2976 | `			return SXRET_OK;` |
|  621434 |  2977 | `	}else if(pStr->nByte == sizeof("__LINE__") - 1 &&` |
|  110462 |  2978 | `		SyMemcmp(pStr->zString,"__LINE__",sizeof("__LINE__")-1) == 0 ){` |
|       - |  2979 | `			/* TICKET 1433-004: __LINE__ constant must be resolved at compile time,not run time */` |
|   10595 |  2980 | `			pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   10595 |  2981 | `			if( pObj == 0 ){` |
|     ! 0 |  2982 | `				PH7_GenCompileError(pGen,E_ERROR,pToken->nLine,"Fatal, PH7 engine is running out of memory");` |
|     ! 0 |  2983 | `				return SXERR_ABORT;` |
|       - |  2984 | `			}` |
|   10595 |  2985 | `			PH7_MemObjInitFromInt(pGen->pVm,pObj,pToken->nLine);` |
|       - |  2986 | `			/* Emit the load constant instruction */` |
|   10595 |  2987 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   10595 |  2988 | `			return SXRET_OK;` |
|  573469 |  2989 | `	}else if( pStr->nByte == sizeof("__NAMESPACE__") - 1 &&` |
|   35712 |  2990 | `		SyMemcmp(pStr->zString,"__NAMESPACE__",sizeof("__NAMESPACE__")-1) == 0 ){` |
...
|  572527 |  3006 | `	}else if( (pStr->nByte == sizeof("__FUNCTION__") - 1 &&` |
|   14875 |  3007 | `		SyMemcmp(pStr->zString,"__FUNCTION__",sizeof("__FUNCTION__")-1) == 0) \|\|` |
|  565085 |  3008 | `		(pStr->nByte == sizeof("__METHOD__") - 1 &&` |
|   18980 |  3009 | `		SyMemcmp(pStr->zString,"__METHOD__",sizeof("__METHOD__")-1) == 0) ){` |
...
|  659041 |  3039 | `	if( SXRET_OK != GenStateFindLiteral(&(*pGen),&pToken->sData,&nIdx) ){` |
|       - |  3040 | `		ph7_value *pLitObj;` |
|       - |  3041 | `		/* Unknown literal,install it in the literal table */` |
|  273947 |  3042 | `		pLitObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  273947 |  3043 | `		if( pLitObj == 0 ){` |
|     ! 0 |  3044 | `			PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|     ! 0 |  3045 | `			return SXERR_ABORT;` |
|       - |  3046 | `		}` |
|  273947 |  3047 | `		PH7_MemObjInitFromString(pGen->pVm,pLitObj,&pToken->sData);` |
|  273947 |  3048 | `		GenStateInstallLiteral(&(*pGen),pLitObj,nIdx);` |
|  136971 |  3049 | `	}` |
|       - |  3050 | `	/* Emit the load constant instruction */` |
|  659041 |  3051 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,1,nIdx,0,0);` |
|  659041 |  3052 | `	return SXRET_OK;` |
|  388791 |  3053 |  |
|       - |  3054 | `/*` |
...
|       - |  3059 | ` */` |
|  777612 |  3060 | `static sxi32 GenStateResolveNamespaceLiteral(ph7_gen_state *pGen)` |
|       5 |  3061 |  |
|       - |  3062 | `	sxi32 rc;` |
|  777617 |  3063 | `	if( pGen->pIn >= pGen->pEnd ){` |
|     ! 0 |  3064 | `		return SXRET_OK;` |
|       - |  3065 | `	}` |
|       - |  3066 | `	/* Check if this is a multi-token namespace path */` |
|  777617 |  3067 | `	if( pGen->pIn < &pGen->pEnd[-1] ){` |
...
|  777577 |  3120 | `	rc = GenStateLoadLiteral(&(*pGen));` |
|  777577 |  3121 | `	return rc;` |
|  388811 |  3122 |  |
|       - |  3123 | `/*` |
|       - |  3124 | ` * Compile a literal which is an identifier(name) for a simple value.` |
|       - |  3125 | ` */` |
|  777612 |  3126 | `PH7_PRIVATE sxi32 PH7_CompileLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  3127 |  |
|       - |  3128 | `	sxi32 rc;` |
|  777617 |  3129 | `	rc = GenStateResolveNamespaceLiteral(&(*pGen));` |
|  777617 |  3130 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  3131 | `		SXUNUSED(iCompileFlag); /* cc warning */` |
|     ! 0 |  3132 | `		return rc;` |
|       - |  3133 | `	}` |
|       - |  3134 | `	/* Node successfully compiled */` |
|  777617 |  3135 | `	return SXRET_OK;` |
|  388811 |  3136 |  |
|       - |  3137 | `/*` |
...
|       - |  3295 | ` */` |
|    3668 |  3296 | `static void GenStateEmitExceptionPopForBreak(ph7_gen_state *pGen,GenBlock *pTarget)` |
|       5 |  3297 |  |
|    3673 |  3298 | `	GenBlock *pBlock = pGen->pCurrent;` |
|   21521 |  3299 | `	while( pBlock && pBlock != pTarget ){` |
|   17853 |  3300 | `		if( pBlock->iFlags & GEN_BLOCK_EXCEPTION ){` |
...
|       - |  3310 | `			}` |
|       1 |  3311 | `		}` |
|   17853 |  3312 | `		pBlock = pBlock->pParent;` |
|       5 |  3313 | `	}` |
|    3673 |  3314 |  |
|    3572 |  3315 | `static sxi32 PH7_CompileContinue(ph7_gen_state *pGen)` |
|       5 |  3316 |  |
|       - |  3317 | `	GenBlock *pLoop; /* Target loop */` |
|       - |  3318 | `	sxi32 iLevel;    /* How many nesting loop to skip */` |
|       - |  3319 | `	sxu32 nLineLocal;` |
|       - |  3320 | `	sxi32 rc;` |
|    3577 |  3321 | `	nLineLocal = pGen->pIn->nLine;` |
|    3577 |  3322 | `	iLevel = 0;` |
|       - |  3323 | `	/* Jump the 'continue' keyword */` |
|    3577 |  3324 | `	pGen->pIn++;` |
|    3577 |  3325 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NUM) ){` |
...
|    3577 |  3351 | `	pLoop = GenStateFetchBlock(pGen->pCurrent,GEN_BLOCK_LOOP,iLevel);` |
|    3577 |  3352 | `	if( pLoop == 0 ){` |
...
|       - |  3358 | `		}` |
|       7 |  3359 | `	}else{` |
|    3567 |  3360 | `		sxu32 nInstrIdx = 0;` |
|       - |  3361 | `		/* Emit POP_EXCEPTION for any try blocks between here and the loop */` |
|    3567 |  3362 | `		GenStateEmitExceptionPopForBreak(&(*pGen),pLoop);` |
|    3567 |  3363 | `		if( pLoop->iFlags & GEN_BLOCK_SWITCH ){` |
...
|    3563 |  3375 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pLoop->nFirstInstr,0,&nInstrIdx);` |
|    3563 |  3376 | `			if( pLoop->bPostContinue == TRUE ){` |
...
|       - |  3383 | `		}` |
|       - |  3384 | `	}` |
|    3577 |  3385 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
...
|       5 |  3502 | `		}` |
|     113 |  3503 | `		if( pBlock ){` |
|      22 |  3504 | `			sLabel.pFunc = (ph7_vm_func *)pBlock->pUserData;` |
|      12 |  3505 | `		}else{` |
...
|       - |  3666 | ` * message.` |
|       - |  3667 | ` */` |
|  428452 |  3668 | `static sxi32 PH7_CompileBlock(` |
...
|       - |  3673 | `	sxi32 rc;` |
|       - |  3674 | `	sxu32 nLine;` |
|  428457 |  3675 | `	if( pGen->pIn->nType & PH7_TK_OCB /* '{' */ ){` |
|  426773 |  3676 | `		nLine = pGen->pIn->nLine;` |
|  426773 |  3677 | `		rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_STD,PH7_VmInstrLength(pGen->pVm),0,0);` |
|  426773 |  3678 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  3679 | `			return SXERR_ABORT;` |
|       - |  3680 | `		}` |
|  426773 |  3681 | `		pGen->pIn++;` |
|       - |  3682 | `		/* Compile until we hit the closing braces '}' */` |
|  582752 |  3683 | `		for(;;){` |
| 1165509 |  3684 | `			if( pGen->pIn >= pGen->pEnd ){` |
...
|       - |  3693 | `				}` |
|     ! 0 |  3694 | `			}` |
| 1165489 |  3695 | `			if( pGen->pIn->nType & PH7_TK_CCB/*'}'*/ ){` |
|       - |  3696 | `				/* Closing braces found,break immediately*/` |
|  426753 |  3697 | `				pGen->pIn++;` |
|  426753 |  3698 | `				break;` |
|       - |  3699 | `			}` |
|       - |  3700 | `			/* Compile a single statement */` |
|  738741 |  3701 | `			rc = GenStateCompileChunk(&(*pGen),PH7_COMPILE_SINGLE_STMT);` |
|  738741 |  3702 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  3703 | `				return SXERR_ABORT;` |
|       - |  3704 | `			}` |
|       5 |  3705 | `		}` |
|  426773 |  3706 | `		GenStateLeaveBlock(&(*pGen),0);` |
|  215073 |  3707 | `	}else if( (pGen->pIn->nType & PH7_TK_COLON /* ':' */) && nKeywordEnd > 0 ){` |
|     ! 0 |  3708 | `		pGen->pIn++;` |
...
|  428457 |  3757 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|     ! 0 |  3758 | `		pGen->pIn++;` |
|     ! 0 |  3759 | `	}` |
|  428457 |  3760 | `	return SXRET_OK;` |
|  214231 |  3761 |  |
|       - |  3762 | `/*` |
...
|       - |  3779 | ` *   endwhile;` |
|       - |  3780 | ` */` |
|   14232 |  3781 | `static sxi32 PH7_CompileWhile(ph7_gen_state *pGen)` |
|       5 |  3782 |  |
|   14237 |  3783 | `	GenBlock *pWhileBlock = 0;` |
|   14237 |  3784 | `	SyToken *pTmp,*pEnd = 0;` |
|       - |  3785 | `	sxu32 nFalseJump;` |
|       - |  3786 | `	sxu32 nLine;` |
|       - |  3787 | `	sxi32 rc;` |
|   14237 |  3788 | `	nLine = pGen->pIn->nLine;` |
|       - |  3789 | `	/* Jump the 'while' keyword */` |
|   14237 |  3790 | `	pGen->pIn++;` |
|   14237 |  3791 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  3792 | `		/* Syntax error */` |
...
|   14237 |  3803 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pWhileBlock);` |
|   14237 |  3804 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  3805 | `		return SXERR_ABORT;` |
|       - |  3806 | `	}` |
|       - |  3807 | `	/* Delimit the condition */` |
|   14237 |  3808 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   14237 |  3809 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|   14237 |  3818 | `	pTmp = pGen->pEnd;` |
|   14237 |  3819 | `	pGen->pEnd = pEnd;` |
|       - |  3820 | `	/* Compile the expression */` |
|   14237 |  3821 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   14237 |  3822 | `	if( rc == SXERR_ABORT ){` |
|       - |  3823 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  3824 | `		return SXERR_ABORT;` |
|       - |  3825 | `	}` |
|       - |  3826 | `	/* Update token stream */` |
|   14237 |  3827 | `	while(pGen->pIn < pEnd ){` |
...
|   14237 |  3835 | `	pGen->pIn  = &pEnd[1];` |
|   14237 |  3836 | `	pGen->pEnd = pTmp;` |
|       - |  3837 | `	/* Emit the false jump */` |
|   14237 |  3838 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nFalseJump);` |
|       - |  3839 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   14237 |  3840 | `	GenStateNewJumpFixup(pWhileBlock,PH7_OP_JZ,nFalseJump);` |
|       - |  3841 | `	/* Compile the loop body */` |
|   14237 |  3842 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDWHILE);` |
|   14237 |  3843 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  3844 | `		return SXERR_ABORT;` |
|       - |  3845 | `	}` |
|       - |  3846 | `	/* Emit the unconditional jump to the start of the loop */` |
|   14237 |  3847 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pWhileBlock->nFirstInstr,0,0);` |
|       - |  3848 | `	/* Fix all jumps now the destination is resolved */` |
|   14237 |  3849 | `	GenStateFixJumps(pWhileBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - |  3850 | `	/* Release the loop block */` |
|   14237 |  3851 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  3852 | `	/* Statement successfully compiled */` |
|   14237 |  3853 | `	return SXRET_OK;` |
|     ! 0 |  3854 | `Synchronize:` |
...
|       - |  4009 | ` */` |
|   14232 |  4010 | `static sxi32 PH7_CompileFor(ph7_gen_state *pGen)` |
|       5 |  4011 |  |
|   14237 |  4012 | `	SyToken *pTmp,*pPostStart,*pEnd = 0;` |
|   14237 |  4013 | `	GenBlock *pForBlock = 0;` |
|       - |  4014 | `	sxu32 nFalseJump;` |
|       - |  4015 | `	sxu32 nLine;` |
|       - |  4016 | `	sxi32 rc;` |
|   14237 |  4017 | `	nLine = pGen->pIn->nLine;` |
|       - |  4018 | `	/* Jump the 'for' keyword */` |
|   14237 |  4019 | `	pGen->pIn++;` |
|   14237 |  4020 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  4021 | `		/* Syntax error */` |
...
|   14237 |  4032 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   14237 |  4033 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|   14237 |  4048 | `	pTmp = pGen->pEnd;` |
|   14237 |  4049 | `	pGen->pEnd = pEnd;` |
|       - |  4050 | `	/* Compile initialization expressions if available */` |
|   14237 |  4051 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|       - |  4052 | `	/* Pop operand lvalues */` |
|   14237 |  4053 | `	if( rc == SXERR_ABORT ){` |
|       - |  4054 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4055 | `		return SXERR_ABORT;` |
|   14237 |  4056 | `	}else if( rc != SXERR_EMPTY ){` |
|   14235 |  4057 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|    7115 |  4058 | `	}` |
|   14237 |  4059 | `	if( (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|       - |  4060 | `		/* Syntax error */` |
...
|   14237 |  4072 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pForBlock);` |
|   14237 |  4073 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  4074 | `		return SXERR_ABORT;` |
|       - |  4075 | `	}` |
|       - |  4076 | `	/* Deffer continue jumps */` |
|   14237 |  4077 | `	pForBlock->bPostContinue = TRUE;` |
|       - |  4078 | `	/* Compile the condition */` |
|   14237 |  4079 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   14237 |  4080 | `	if( rc == SXERR_ABORT ){` |
|       - |  4081 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4082 | `		return SXERR_ABORT;` |
|   14237 |  4083 | `	}else if( rc != SXERR_EMPTY ){` |
|       - |  4084 | `		/* Emit the false jump */` |
|   14235 |  4085 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nFalseJump);` |
|       - |  4086 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   14235 |  4087 | `		GenStateNewJumpFixup(pForBlock,PH7_OP_JZ,nFalseJump);` |
|    7115 |  4088 | `	}` |
|   14237 |  4089 | `	if( (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|       - |  4090 | `		/* Syntax error */` |
...
|   14233 |  4102 | `	pPostStart = pGen->pIn;` |
|       - |  4103 | `	/* Compile the loop body */` |
|   14233 |  4104 | `	pGen->pIn  = &pEnd[1]; /* Jump the trailing parenthesis ')' */` |
|   14233 |  4105 | `	pGen->pEnd = pTmp;` |
|   14233 |  4106 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDFOR);` |
|   14233 |  4107 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  4108 | `		return SXERR_ABORT;` |
|       - |  4109 | `	}` |
|       - |  4110 | `	/* Fix post-continue jumps */` |
|   14233 |  4111 | `	if( SySetUsed(&pForBlock->aPostContFix) > 0 ){` |
...
|   14233 |  4127 | `	while( pPostStart < pEnd && (pPostStart->nType & PH7_TK_SEMI) ){` |
|     ! 0 |  4128 | `		pPostStart++;` |
|     ! 0 |  4129 | `	}` |
|   14233 |  4130 | `	if( pPostStart < pEnd ){` |
|       - |  4131 | `		SyToken *pTmpIn,*pTmpEnd;` |
|   14233 |  4132 | `		SWAP_DELIMITER(pGen,pPostStart,pEnd);` |
|   14233 |  4133 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   14233 |  4134 | `		if( pGen->pIn < pGen->pEnd ){` |
|       - |  4135 | `			/* Syntax error */` |
...
|       - |  4142 | `		}` |
|   14233 |  4143 | `		RE_SWAP_DELIMITER(pGen);` |
|   14233 |  4144 | `		if( rc == SXERR_ABORT ){` |
|       - |  4145 | `			/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4146 | `			return SXERR_ABORT;` |
|   14233 |  4147 | `		}else if( rc != SXERR_EMPTY){` |
|       - |  4148 | `			/* Pop operand lvalue */` |
|   14233 |  4149 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|    7114 |  4150 | `		}` |
|    7114 |  4151 | `	}` |
|       - |  4152 | `	/* Emit the unconditional jump to the start of the loop */` |
|   14233 |  4153 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pForBlock->nFirstInstr,0,0);` |
|       - |  4154 | `	/* Fix all jumps now the destination is resolved */` |
|   14233 |  4155 | `	GenStateFixJumps(pForBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - |  4156 | `	/* Release the loop block */` |
|   14233 |  4157 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  4158 | `	/* Statement successfully compiled */` |
|   14233 |  4159 | `	return SXRET_OK;` |
|    7121 |  4160 |  |
...
|       - |  4163 | ` * are allowed.` |
|       - |  4164 | ` */` |
|    7630 |  4165 | `static sxi32 GenStateForEachNodeValidator(ph7_gen_state *pGen,ph7_expr_node *pRoot)` |
|       5 |  4166 |  |
|    7635 |  4167 | `	sxi32 rc = SXRET_OK; /* Assume a valid expression tree */` |
|    7635 |  4168 | `	if( pRoot->xCode != PH7_CompileVariable ){` |
...
|       - |  4203 | ` */` |
|    3910 |  4204 | `static sxi32 PH7_CompileForeach(ph7_gen_state *pGen)` |
|       5 |  4205 |  |
|    3915 |  4206 | `	SyToken *pCur,*pTmp,*pEnd = 0;` |
|    3915 |  4207 | `	SyToken *pListStart = 0,*pListEnd = 0;` |
|    3915 |  4208 | `	GenBlock *pForeachBlock = 0;` |
|       - |  4209 | `	ph7_foreach_info *pInfo;` |
|       - |  4210 | `	sxu32 nFalseJump;` |
|       - |  4211 | `	VmInstr *pInstr;` |
|       - |  4212 | `	sxu32 nLine;` |
|       - |  4213 | `	sxi32 rc;` |
|    3915 |  4214 | `	nLine = pGen->pIn->nLine;` |
|       - |  4215 | `	/* Jump the 'foreach' keyword */` |
|    3915 |  4216 | `	pGen->pIn++;` |
|    3915 |  4217 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  4218 | `		/* Syntax error */` |
...
|    3915 |  4229 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pForeachBlock);` |
|    3915 |  4230 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  4231 | `		return SXERR_ABORT;` |
|       - |  4232 | `	}` |
|       - |  4233 | `	/* Delimit the expression */` |
|    3915 |  4234 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|    3915 |  4235 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|    3915 |  4250 | `	pCur = pGen->pIn;` |
|   26879 |  4251 | `	while( pCur < pEnd ){` |
|   26879 |  4252 | `		if( pCur->nType & PH7_TK_KEYWORD ){` |
|    3929 |  4253 | `			sxi32 nKeywrd = SX_PTR_TO_INT(pCur->pUserData);` |
|    3929 |  4254 | `			if( nKeywrd == PH7_TKWRD_AS ){` |
...
|    3915 |  4272 | `	pTmp = pGen->pEnd;` |
|    3915 |  4273 | `	pGen->pEnd = pCur;` |
|    3915 |  4274 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|    3915 |  4275 | `	if( rc == SXERR_ABORT ){` |
|       - |  4276 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4277 | `		return SXERR_ABORT;` |
|       - |  4278 | `	}` |
|       - |  4279 | `	/* Update token stream */` |
|    3915 |  4280 | `	while(pGen->pIn < pCur ){` |
...
|     ! 0 |  4286 | `		pGen->pIn++;` |
|     ! 0 |  4287 | `	}` |
|    3915 |  4288 | `	pCur++; /* Jump the 'as' keyword */` |
|    3915 |  4289 | `	pGen->pIn = pCur;` |
|    3915 |  4290 | `	if( pGen->pIn >= pEnd ){` |
...
|    3915 |  4297 | `	pInfo = (ph7_foreach_info *)SyMemBackendAlloc(&pGen->pVm->sAllocator,sizeof(ph7_foreach_info));` |
|    3915 |  4298 | `	if( pInfo == 0 ){` |
...
|    3915 |  4303 | `	SyZero(pInfo,sizeof(ph7_foreach_info));` |
|       - |  4304 | `	/* Initialize structure fields */` |
|    3915 |  4305 | `	SySetInit(&pInfo->aStep,&pGen->pVm->sAllocator,sizeof(ph7_foreach_step *));` |
...
|       - |  4308 | `	 * '=>'. */` |
|    3915 |  4309 | `	pCur = GenStateFindTopLevelArrow(pCur,pEnd);` |
|    3915 |  4310 | `	if( pCur < pEnd ){` |
|       - |  4311 | `		/* Compile the expression holding the key name */` |
|    3737 |  4312 | `		if( pGen->pIn >= pCur ){` |
...
|       - |  4317 | `			}` |
|     ! 0 |  4318 | `		}else{` |
|    3737 |  4319 | `			pGen->pEnd = pCur;` |
|    3737 |  4320 | `			rc = PH7_CompileExpr(&(*pGen),0,GenStateForEachNodeValidator);` |
|    3737 |  4321 | `			if( rc == SXERR_ABORT ){` |
|       - |  4322 | `				/* Don't worry about freeing memory, everything will be released shortly */` |
|     ! 0 |  4323 | `				return SXERR_ABORT;` |
|       - |  4324 | `			}` |
|    3737 |  4325 | `			pInstr = PH7_VmPopInstr(pGen->pVm);` |
|    3737 |  4326 | `			if( pInstr->p3 ){` |
|       - |  4327 | `				/* Record key name */` |
|    3737 |  4328 | `				SyStringInitFromBuf(&pInfo->sKey,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|    1866 |  4329 | `			}` |
|    3737 |  4330 | `			pInfo->iFlags \|= PH7_4EACH_STEP_KEY;` |
|       - |  4331 | `		}` |
|    3737 |  4332 | `		pGen->pIn = &pCur[1]; /* Jump the arrow */` |
|    1866 |  4333 | `	}` |
|    3915 |  4334 | `	pGen->pEnd = pEnd;` |
|    3915 |  4335 | `	if( pGen->pIn >= pEnd ){` |
...
|    3910 |  4390 | `	}else if( pGen->pIn->nType & PH7_TK_OSB ){` |
...
|    3903 |  4423 | `		rc = PH7_CompileExpr(&(*pGen),0,GenStateForEachNodeValidator);` |
|    3903 |  4424 | `		if( rc == SXERR_ABORT ){` |
|       - |  4425 | `			/* Don't worry about freeing memory, everything will be released shortly */` |
|     ! 0 |  4426 | `			return SXERR_ABORT;` |
|       - |  4427 | `		}` |
|    3903 |  4428 | `		pInstr = PH7_VmPopInstr(pGen->pVm);` |
|    3903 |  4429 | `		if( pInstr->p3 ){` |
|       - |  4430 | `			/* Record value name */` |
|    3903 |  4431 | `			SyStringInitFromBuf(&pInfo->sValue,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|    1949 |  4432 | `		}` |
|       - |  4433 | `	}` |
|       - |  4434 | `	/* Emit the 'FOREACH_INIT' instruction */` |
|    3913 |  4435 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_FOREACH_INIT,0,0,pInfo,&nFalseJump);` |
|       - |  4436 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|    3913 |  4437 | `	GenStateNewJumpFixup(pForeachBlock,PH7_OP_FOREACH_INIT,nFalseJump);` |
|       - |  4438 | `	/* Record the first instruction to execute */` |
|    3913 |  4439 | `	pForeachBlock->nFirstInstr = PH7_VmInstrLength(pGen->pVm);` |
|       - |  4440 | `	/* Emit the FOREACH_STEP instruction */` |
|    3913 |  4441 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_FOREACH_STEP,0,0,pInfo,&nFalseJump);` |
|       - |  4442 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|    3913 |  4443 | `	GenStateNewJumpFixup(pForeachBlock,PH7_OP_FOREACH_STEP,nFalseJump);` |
|       - |  4444 | `	/* If list() unpacking, emit bytecode to destructure the temp variable */` |
|    3913 |  4445 | `	if( (pInfo->iFlags & PH7_4EACH_STEP_LIST) && pListStart && pListEnd ){` |
...
|    3913 |  4473 | `	pGen->pIn = &pEnd[1];` |
|    3913 |  4474 | `	pGen->pEnd = pTmp;` |
|    3913 |  4475 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_END4EACH);` |
|    3913 |  4476 | `	if( rc == SXERR_ABORT ){` |
...
|    3913 |  4481 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pForeachBlock->nFirstInstr,0,0);` |
|       - |  4482 | `	/* Fix all jumps now the destination is resolved */` |
|    3913 |  4483 | `	GenStateFixJumps(pForeachBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - |  4484 | `	/* Release the loop block */` |
|    3913 |  4485 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  4486 | `	/* Statement successfully compiled */` |
|    3913 |  4487 | `	return SXRET_OK;` |
|       1 |  4488 | `Synchronize:` |
...
|       - |  4527 | ` *    ?>` |
|       - |  4528 | ` */` |
|  147930 |  4529 | `static sxi32 PH7_CompileIf(ph7_gen_state *pGen)` |
|       5 |  4530 |  |
|  147935 |  4531 | `	SyToken *pToken,*pTmp,*pEnd = 0;` |
|  147935 |  4532 | `	GenBlock *pCondBlock = 0;` |
|       - |  4533 | `	sxu32 nJumpIdx;` |
|       - |  4534 | `	sxu32 nKeyID;` |
|       - |  4535 | `	sxi32 rc;` |
|       - |  4536 | `	/* Jump the 'if' keyword */` |
|  147935 |  4537 | `	pGen->pIn++;` |
|  147935 |  4538 | `	pToken = pGen->pIn;` |
|       - |  4539 | `	/* Create the conditional block */` |
|  147935 |  4540 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_COND,PH7_VmInstrLength(pGen->pVm),0,&pCondBlock);` |
|  147935 |  4541 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  4542 | `		return SXERR_ABORT;` |
|       - |  4543 | `	}` |
|       - |  4544 | `	/* Process as many [if/else if/elseif/else] blocks as we can */` |
|   81078 |  4545 | `	for(;;){` |
|  162161 |  4546 | `		if( pToken >= pGen->pEnd \|\| (pToken->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  4547 | `			/* Syntax error */` |
...
|  162161 |  4561 | `		PH7_DelimitNestedTokens(pToken,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|  162161 |  4562 | `		if( pToken >= pEnd \|\| (pEnd->nType & PH7_TK_RPAREN) == 0 ){` |
|       - |  4563 | `			/* Syntax error */` |
...
|  162161 |  4575 | `		SWAP_TOKEN_STREAM(pGen,pToken,pEnd);` |
|       - |  4576 | `		/* Compile the condition */` |
|  162161 |  4577 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|       - |  4578 | `		/* Update token stream */` |
|  162161 |  4579 | `		while(pGen->pIn < pEnd ){` |
|     ! 0 |  4580 | `			PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Unexpected token '%z'",&pGen->pIn->sData);` |
|     ! 0 |  4581 | `			pGen->pIn++;` |
|     ! 0 |  4582 | `		}` |
|  162161 |  4583 | `		pGen->pIn  = &pEnd[1];` |
|  162161 |  4584 | `		pGen->pEnd = pTmp;` |
|  162161 |  4585 | `		if( rc == SXERR_ABORT ){` |
|       - |  4586 | `			/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4587 | `			return SXERR_ABORT;` |
|       - |  4588 | `		}` |
|       - |  4589 | `		/* Emit the false jump */` |
|  162161 |  4590 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nJumpIdx);` |
|       - |  4591 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|  162161 |  4592 | `		GenStateNewJumpFixup(pCondBlock,PH7_OP_JZ,nJumpIdx);` |
|       - |  4593 | `		/* Compile the body */` |
|  162161 |  4594 | `		rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDIF);` |
|  162161 |  4595 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  4596 | `			return SXERR_ABORT;` |
|       - |  4597 | `		}` |
|  162161 |  4598 | `		if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
|   45205 |  4599 | `			break;` |
|       - |  4600 | `		}` |
|       - |  4601 | `		/* Ensure that the keyword ID is 'else if' or 'else' */` |
|   71761 |  4602 | `		nKeyID = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   71761 |  4603 | `		if( (nKeyID & (PH7_TKWRD_ELSE\|PH7_TKWRD_ELIF)) == 0 ){` |
|   46187 |  4604 | `			break;` |
|       - |  4605 | `		}` |
|       - |  4606 | `		/* Emit the unconditional jump */` |
|   25579 |  4607 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,0,0,&nJumpIdx);` |
|       - |  4608 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   25579 |  4609 | `		GenStateNewJumpFixup(pCondBlock,PH7_OP_JMP,nJumpIdx);` |
|   25579 |  4610 | `		if( nKeyID & PH7_TKWRD_ELSE ){` |
|   18409 |  4611 | `			pToken = &pGen->pIn[1];` |
|   18409 |  4612 | `			if( pToken >= pGen->pEnd \|\| (pToken->nType & PH7_TK_KEYWORD) == 0 \|\|` |
|    7108 |  4613 | `				SX_PTR_TO_INT(pToken->pUserData) != PH7_TKWRD_IF ){` |
|    5679 |  4614 | `					break;` |
|       - |  4615 | `			}` |
|    7061 |  4616 | `			pGen->pIn++; /* Jump the 'else' keyword */` |
|    3528 |  4617 | `		}` |
|   14231 |  4618 | `		pGen->pIn++; /* Jump the 'elseif/if' keyword */` |
|       - |  4619 | `		/* Synchronize cursors */` |
|   14231 |  4620 | `		pToken = pGen->pIn;` |
|       - |  4621 | `		/* Fix the false jump */` |
|   14231 |  4622 | `		GenStateFixJumps(pCondBlock,PH7_OP_JZ,PH7_VmInstrLength(pGen->pVm));` |
|       5 |  4623 | `	} /* For(;;) */` |
|       - |  4624 | `	/* Fix the false jump */` |
|  147935 |  4625 | `	GenStateFixJumps(pCondBlock,PH7_OP_JZ,PH7_VmInstrLength(pGen->pVm));` |
|  147935 |  4626 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|   57530 |  4627 | `		(SX_PTR_TO_INT(pGen->pIn->pUserData) & PH7_TKWRD_ELSE) ){` |
|       - |  4628 | `			/* Compile the else block */` |
|   11353 |  4629 | `			pGen->pIn++;` |
|   11353 |  4630 | `			rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDIF);` |
|   11353 |  4631 | `			if( rc == SXERR_ABORT ){` |
|       - |  4632 |  |
|     ! 0 |  4633 | `				return SXERR_ABORT;` |
|       - |  4634 | `			}` |
|    5674 |  4635 | `	}` |
|  147935 |  4636 | `	nJumpIdx = PH7_VmInstrLength(pGen->pVm);` |
|       - |  4637 | `	/* Fix all unconditional jumps now the destination is resolved */` |
|  147935 |  4638 | `	GenStateFixJumps(pCondBlock,PH7_OP_JMP,nJumpIdx);` |
|       - |  4639 | `	/* Release the conditional block */` |
|  147935 |  4640 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  4641 | `	/* Statement successfully compiled */` |
|  147935 |  4642 | `	return SXRET_OK;` |
|     ! 0 |  4643 | `Synchronize:` |
...
|       - |  4743 | ` */` |
|  234174 |  4744 | `static sxi32 PH7_CompileReturn(ph7_gen_state *pGen)` |
|       5 |  4745 |  |
|  234179 |  4746 | `	sxi32 nRet = 0; /* TRUE if there is a return value */` |
|       - |  4747 | `	sxi32 rc;` |
|       - |  4748 | `	/* Jump the 'return' keyword */` |
|  234179 |  4749 | `	pGen->pIn++;` |
|  234179 |  4750 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|       - |  4751 | `		/* Compile the expression */` |
|  234151 |  4752 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|  234151 |  4753 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  4754 | `			return SXERR_ABORT;` |
|  234151 |  4755 | `		}else if(rc != SXERR_EMPTY ){` |
|  234151 |  4756 | `			nRet = 1;` |
|  117073 |  4757 | `		}` |
|  117073 |  4758 | `	}` |
...
|  234179 |  4764 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,nRet,1,0,0);` |
|  234179 |  4765 | `	return SXRET_OK;` |
|  117092 |  4766 |  |
|       - |  4767 | `/*` |
...
|       - |  4772 | ` */` |
|     160 |  4773 | `PH7_PRIVATE sxi32 PH7_CompileYield(ph7_gen_state *pGen, sxi32 iCompileFlag)` |
|       5 |  4774 |  |
|       - |  4775 | `	SyToken *pTmp, *pSplit;` |
|     165 |  4776 | `	sxi32 iP1 = 0; /* 1 if value present */` |
|     165 |  4777 | `	sxi32 iP2 = 0; /* 1 if key => value */` |
|       - |  4778 | `	sxi32 rc;` |
|      80 |  4779 | `	(void)iCompileFlag;` |
...
|     178 |  4787 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_ID)` |
|      97 |  4788 | `		&& pGen->pIn->sData.nByte == 4` |
...
|       - |  4805 | `	}` |
|     129 |  4806 | `	if( pGen->pIn >= pGen->pEnd ){` |
...
|     127 |  4812 | `	pSplit = 0;` |
|       - |  4813 | `	{` |
|     127 |  4814 | `		SyToken *pCur = pGen->pIn;` |
|     127 |  4815 | `		sxi32 nNest = 0;` |
|     265 |  4816 | `		while( pCur < pGen->pEnd ){` |
|     157 |  4817 | `			if( pCur->nType & (PH7_TK_LPAREN\|PH7_TK_OSB\|PH7_TK_OCB) ){` |
|     ! 0 |  4818 | `				nNest++;` |
|     157 |  4819 | `			}else if( pCur->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB) ){` |
|     ! 0 |  4820 | `				nNest--;` |
|     157 |  4821 | `			}else if( nNest == 0 && (pCur->nType & PH7_TK_ARRAY_OP) ){` |
|      16 |  4822 | `				pSplit = pCur;` |
|      16 |  4823 | `				break;` |
|       - |  4824 | `			}` |
|     143 |  4825 | `			pCur++;` |
...
|       9 |  4840 | `	}else{` |
|       - |  4841 | `		/* yield $value */` |
|     113 |  4842 | `		rc = PH7_CompileExpr(pGen, 0, 0);` |
|     113 |  4843 | `		if( rc == SXERR_ABORT ) return SXERR_ABORT;` |
|     113 |  4844 | `		if( rc != SXERR_EMPTY ){` |
|     113 |  4845 | `			iP1 = 1;` |
|      54 |  4846 | `		}` |
|       - |  4847 | `	}` |
|     127 |  4848 | `	pGen->pEnd = pTmp;` |
|     127 |  4849 | `	PH7_VmEmitInstr(pGen->pVm, PH7_OP_YIELD, iP1, iP2, 0, 0);` |
|     127 |  4850 | `	return SXRET_OK;` |
|      85 |  4851 |  |
|       - |  4852 | `/*` |
...
|       - |  4878 | ` */` |
|   14312 |  4879 | `static sxi32 PH7_CompileEcho(ph7_gen_state *pGen)` |
|       5 |  4880 |  |
|   14317 |  4881 | `	SyToken *pTmp,*pNext = 0;` |
|       - |  4882 | `	sxi32 rc;` |
|       - |  4883 | `	/* Jump the 'echo' keyword */` |
|   14317 |  4884 | `	pGen->pIn++;` |
|       - |  4885 | `	/* Compile arguments one after one */` |
|   14317 |  4886 | `	pTmp = pGen->pEnd;` |
|   31329 |  4887 | `	while( SXRET_OK == PH7_GetNextExpr(pGen->pIn,pTmp,&pNext) ){` |
|   17017 |  4888 | `		if( pGen->pIn < pNext ){` |
|   17017 |  4889 | `			pGen->pEnd = pNext;` |
|   17017 |  4890 | `			rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_RDONLY_LOAD/* Do not create variable if inexistant */,0);` |
|   17017 |  4891 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  4892 | `				return SXERR_ABORT;` |
|   17017 |  4893 | `			}else if( rc != SXERR_EMPTY ){` |
|       - |  4894 | `				/* Emit the consume instruction */` |
|   16993 |  4895 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_CONSUME,1,0,0,0);` |
|    8494 |  4896 | `			}` |
|    8506 |  4897 | `		}` |
|       - |  4898 | `		/* Jump trailing commas */` |
|   19717 |  4899 | `		while( pNext < pTmp && (pNext->nType & PH7_TK_COMMA) ){` |
|    2705 |  4900 | `			pNext++;` |
|       5 |  4901 | `		}` |
|   17017 |  4902 | `		pGen->pIn = pNext;` |
|       5 |  4903 | `	}` |
|       - |  4904 | `	/* Restore token stream */` |
|   14317 |  4905 | `	pGen->pEnd = pTmp;` |
|   14317 |  4906 | `	return SXRET_OK;` |
|    7161 |  4907 |  |
|       - |  4908 | `/*` |
...
|       - |  5073 | ` */` |
|  436860 |  5074 | `static sxu32 GenStateNsQualifyName(ph7_gen_state *pGen,sxu32 nOrigIdx,SyHash *pImports,int *pFromImport)` |
|       5 |  5075 |  |
|       - |  5076 | `	ph7_value *pLit;` |
...
|       - |  5084 | `	ph7_value *pNew;` |
|  436865 |  5085 | `	if( pFromImport ){` |
|  417521 |  5086 | `		*pFromImport = 0;` |
|  208758 |  5087 | `	}` |
|  436865 |  5088 | `	pLit = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,nOrigIdx);` |
|  436865 |  5089 | `	if( !pLit \|\| !(pLit->iFlags & MEMOBJ_STRING) \|\| SyBlobLength(&pLit->sBlob) == 0 ){` |
|     ! 0 |  5090 | `		return nOrigIdx;` |
|       - |  5091 | `	}` |
|  436865 |  5092 | `	zLit = (const char *)SyBlobData(&pLit->sBlob);` |
|  436865 |  5093 | `	nLit = (sxu32)SyBlobLength(&pLit->sBlob);` |
|       - |  5094 | `	/* Skip if already qualified (contains backslash) */` |
|  436865 |  5095 | `	hasNsSep = 0;` |
| 4725141 |  5096 | `	for( k = 0; k < nLit; k++ ){` |
| 4288289 |  5097 | `		if( zLit[k] == '\\' ){ hasNsSep = 1; break; }` |
| 2144143 |  5098 | `	}` |
|  436865 |  5099 | `	if( hasNsSep ){` |
|      10 |  5100 | `		return nOrigIdx;` |
|       - |  5101 | `	}` |
|       - |  5102 | `	/* Check use imports first (works even outside namespaces) */` |
|  436857 |  5103 | `	SyBlobReset(&pGen->sWorker);` |
|  436857 |  5104 | `	pImport = SyHashGet(pImports,(const void *)zLit,nLit);` |
|  436857 |  5105 | `	if( pImport ){` |
...
|       8 |  5110 | `		}` |
|      23 |  5111 | `	}else{` |
|  436821 |  5112 | `		if( SyBlobLength(&pGen->sNamespace) == 0 ){` |
|  436731 |  5113 | `			return nOrigIdx; /* Not in a namespace and no import match */` |
|       - |  5114 | `		}` |
...
|       - |  5136 | ` */` |
|   96152 |  5137 | `static void GenStateResolveName(ph7_gen_state *pGen,const SyString *pName,SyBlob *pOut)` |
|       5 |  5138 |  |
|       - |  5139 | `	SyHashEntry *pImport;` |
|       - |  5140 | `	/* Check use imports first */` |
|   96157 |  5141 | `	pImport = SyHashGet(&pGen->hUseImports,(const void *)pName->zString,pName->nByte);` |
|   96157 |  5142 | `	if( pImport ){` |
...
|       - |  5158 | ` */` |
|  135368 |  5159 | `static void GenStateBuildFQN(ph7_gen_state *pGen,const SyString *pName,SyBlob *pOut)` |
|       5 |  5160 |  |
|  135373 |  5161 | `	if( SyBlobLength(&pGen->sNamespace) > 0 ){` |
|      63 |  5162 | `		SyBlobAppend(pOut,SyBlobData(&pGen->sNamespace),SyBlobLength(&pGen->sNamespace));` |
|      63 |  5163 | `		SyBlobAppend(pOut,"\\",1);` |
|      29 |  5164 | `	}` |
|  135373 |  5165 | `	SyBlobAppend(pOut,pName->zString,pName->nByte);` |
|  135373 |  5166 |  |
|       - |  5167 | `/*` |
...
|       - |  5663 | ` */` |
|   67068 |  5664 | `static sxi32 GenStateProcessArgValue(ph7_gen_state *pGen,ph7_vm_func_arg *pArg,SyToken *pIn,SyToken *pEnd)` |
|       5 |  5665 |  |
|       - |  5666 | `	SyToken *pTmpIn,*pTmpEnd;` |
|       - |  5667 | `	SySet *pInstrContainer;` |
|       - |  5668 | `	sxi32 rc;` |
|       - |  5669 | `	/* Swap token stream */` |
|   67073 |  5670 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|   67073 |  5671 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   67073 |  5672 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pArg->aByteCode);` |
|       - |  5673 | `	/* Compile the expression holding the argument value */` |
|   67073 |  5674 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|       - |  5675 | `	/* Emit the done instruction */` |
|   67073 |  5676 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,(rc != SXERR_EMPTY ? 1 : 0),0,0,0);` |
|   67073 |  5677 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|   67073 |  5678 | `	RE_SWAP_DELIMITER(pGen);` |
|   67073 |  5679 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  5680 | `		return SXERR_ABORT;` |
|       - |  5681 | `	}` |
|   67073 |  5682 | `	return SXRET_OK;` |
|   33539 |  5683 |  |
|       - |  5684 | `/*` |
...
|       - |  5720 | ` */` |
|   93016 |  5721 | `static sxi32 GenStateCollectFuncArgs(ph7_vm_func *pFunc,ph7_gen_state *pGen,SyToken *pEnd,int bCtorCtx,int bAbstractCtx)` |
|       5 |  5722 |  |
...
|       - |  5727 | `	sxi32 rc;` |
|       - |  5728 |  |
|   93021 |  5729 | `	pIn = pGen->pIn;` |
|   93021 |  5730 | `	SyBlobInit(&sSig,&pGen->pVm->sAllocator);` |
|       - |  5731 | `	/* Process arguments one after one */` |
|  116306 |  5732 | `	for(;;){` |
|  232617 |  5733 | `		if( pIn >= pEnd ){` |
|       - |  5734 | `			/* No more arguments to process */` |
|   93007 |  5735 | `			break;` |
|       - |  5736 | `		}` |
|  139615 |  5737 | `		SyZero(&sArg,sizeof(ph7_vm_func_arg));` |
|  139615 |  5738 | `		SySetInit(&sArg.aByteCode,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|  139615 |  5739 | `		SySetInit(&sArg.aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|  139615 |  5740 | `		SyStringInitFromBuf(&sArg.sTypeName,0,0);` |
...
|       - |  5746 | `		{` |
|  139615 |  5747 | `			int bReadonly = 0, bVisSeen = 0;` |
|  139615 |  5748 | `			sxi32 iVis = PH7_CLASS_PROT_PUBLIC;` |
|  139615 |  5749 | `			if( pIn < pEnd && GenStateIsReadonly(pIn) ){` |
|       3 |  5750 | `				bReadonly = 1;` |
|       3 |  5751 | `				pIn++;` |
|       1 |  5752 | `			}` |
|  139615 |  5753 | `			if( pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD) ){` |
|   63731 |  5754 | `				sxu32 nKw = (sxu32)SX_PTR_TO_INT(pIn->pUserData);` |
|   63731 |  5755 | `				if( nKw == PH7_TKWRD_PUBLIC \|\| nKw == PH7_TKWRD_PROTECTED \|\| nKw == PH7_TKWRD_PRIVATE ){` |
|      71 |  5756 | `					bVisSeen = 1;` |
...
|      33 |  5765 | `				}` |
|   31863 |  5766 | `			}` |
|  139615 |  5767 | `			if( bVisSeen \|\| bReadonly ){` |
|      73 |  5768 | `				if( !bCtorCtx ){` |
...
|  178565 |  5789 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_DOLLAR) == 0` |
|  110539 |  5790 | `			&& (pIn->nType & PH7_TK_AMPER) == 0` |
|   79700 |  5791 | `			&& (pIn->nType & PH7_TK_ELLIPSIS) == 0 ){` |
|   77901 |  5792 | `			sxu32 nLineLocal = pIn->nLine;` |
|   77901 |  5793 | `			sxi32 iTFlags = 0;` |
|   77901 |  5794 | `			pGen->pIn = pIn;` |
|   77901 |  5795 | `			rc = GenStateParseUnionTypeDecl(` |
|   38948 |  5796 | `				pGen, &sArg.nType, &sArg.sClass, &sArg.aUnionAlts,` |
|   38948 |  5797 | `				&iTFlags, &sArg.sTypeName,` |
|       - |  5798 | `				VM_FUNC_ARG_NULLABLE, VM_FUNC_ARG_UNION,` |
|       - |  5799 | `				/* bAllowVoid */ 0,` |
|   38948 |  5800 | `						nLineLocal);` |
|   77901 |  5801 | `			pIn = pGen->pIn;` |
|   77901 |  5802 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  5803 | `				return SXERR_ABORT;` |
|   77901 |  5804 | `			}else if( rc == SXERR_CORRUPT ){` |
|       - |  5805 | `				/* Error already reported by GenStateParseUnionTypeDecl */` |
|       3 |  5806 | `				return SXERR_SYNTAX;` |
|   77899 |  5807 | `			}else if( rc == SXERR_SYNTAX ){` |
|       9 |  5808 | `				if( pIn < pEnd ){` |
...
|       - |  5817 | `			}` |
|   77893 |  5818 | `			sArg.iFlags \|= iTFlags;` |
|   38944 |  5819 | `		}` |
|  139603 |  5820 | `		if( pIn >= pEnd ){` |
|     ! 0 |  5821 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Missing argument name");` |
|     ! 0 |  5822 | `			return rc;` |
|       - |  5823 | `		}` |
|  139603 |  5824 | `		if( pIn->nType & PH7_TK_AMPER ){` |
|       - |  5825 | `			/* Pass by reference,record that */` |
|    3561 |  5826 | `			sArg.iFlags \|= VM_FUNC_ARG_BY_REF;` |
|    3561 |  5827 | `			pIn++;` |
|    1778 |  5828 | `		}` |
|  139603 |  5829 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_ELLIPSIS) ){` |
|       - |  5830 | `			/* Variadic parameter: ...$args */` |
|      46 |  5831 | `			sArg.iFlags \|= VM_FUNC_ARG_VARIADIC;` |
|      46 |  5832 | `			pIn++;` |
|      21 |  5833 | `		}` |
|  139603 |  5834 | `		if( pIn >= pEnd \|\| (pIn->nType & PH7_TK_DOLLAR) == 0 \|\| &pIn[1] >= pEnd \|\| (pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|       - |  5835 | `			/* Invalid argument */` |
|     ! 0 |  5836 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Invalid argument name");` |
|     ! 0 |  5837 | `			return rc;` |
|       - |  5838 | `		}` |
|  139603 |  5839 | `		pIn++; /* Jump the dollar sign */` |
|       - |  5840 | `		/* Copy argument name */` |
|  139603 |  5841 | `		zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,SyStringData(&pIn->sData),SyStringLength(&pIn->sData));` |
|  139603 |  5842 | `		if( zDup == 0 ){` |
|     ! 0 |  5843 | `			PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"PH7 engine is running out of memory");` |
|     ! 0 |  5844 | `			return SXERR_ABORT;` |
|       - |  5845 | `		}` |
|  139603 |  5846 | `		SyStringInitFromBuf(&sArg.sName,zDup,SyStringLength(&pIn->sData));` |
|  139603 |  5847 | `		pIn++;` |
|  139603 |  5848 | `		if( pIn < pEnd ){` |
|   78387 |  5849 | `			if( pIn->nType & PH7_TK_EQUAL ){` |
|       - |  5850 | `				SyToken *pDefend;` |
|   67075 |  5851 | `				sxi32 iNest = 0;` |
|   67075 |  5852 | `				pIn++; /* Jump the equal sign */` |
|   67075 |  5853 | `				pDefend = pIn;` |
|       - |  5854 | `				/* Process the default value associated with this argument */` |
|  141199 |  5855 | `				while( pDefend < pEnd ){` |
|  109417 |  5856 | `					if( (pDefend->nType & PH7_TK_COMMA) && iNest <= 0 ){` |
|   35293 |  5857 | `						break;` |
|       - |  5858 | `					}` |
|   74129 |  5859 | `					if( pDefend->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*[*/) ){` |
|       - |  5860 | `						/* Increment nesting level */` |
|    3533 |  5861 | `						iNest++;` |
|   72365 |  5862 | `					}else if( pDefend->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CCB/*'}'*/\|PH7_TK_CSB/*]*/) ){` |
|       - |  5863 | `						/* Decrement nesting level */` |
|    3533 |  5864 | `						iNest--;` |
|    1764 |  5865 | `					}` |
|   74129 |  5866 | `					pDefend++;` |
|       5 |  5867 | `				}` |
|   67075 |  5868 | `				if( pIn >= pDefend ){` |
|       3 |  5869 | `					rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Missing argument default value");` |
|       3 |  5870 | `					return rc;` |
|       - |  5871 | `				}` |
|       - |  5872 | `				/* Process default value */` |
|   67073 |  5873 | `				rc = GenStateProcessArgValue(&(*pGen),&sArg,pIn,pDefend);` |
|   67073 |  5874 | `				if( rc != SXRET_OK ){` |
|     ! 0 |  5875 | `					return rc;` |
|       - |  5876 | `				}` |
|       - |  5877 | `				/* Point beyond the default value */` |
|   67073 |  5878 | `				pIn = pDefend;` |
|   33534 |  5879 | `			}` |
|   78385 |  5880 | `			if( pIn < pEnd && (pIn->nType & PH7_TK_COMMA) == 0 ){` |
|     ! 0 |  5881 | `				rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Unexpected token '%z'",&pIn->sData);` |
|     ! 0 |  5882 | `				return rc;` |
|       - |  5883 | `			}` |
|   78385 |  5884 | `			pIn++; /* Jump the trailing comma */` |
|   39190 |  5885 | `		}` |
|       - |  5886 | `		/* Append argument signature */` |
|  139601 |  5887 | `		if( sArg.nType > 0 ){` |
|   77839 |  5888 | `			if( SyStringLength(&sArg.sClass) > 0 ){` |
|       - |  5889 | `				/* Class name — prefix with 'o' so generic object hint is a prefix match */` |
|   14147 |  5890 | `				int marker = 'o';` |
|   14147 |  5891 | `				SyBlobAppend(&sSig,(const void *)&marker,sizeof(char));` |
|   14147 |  5892 | `				SyBlobAppend(&sSig,SyStringData(&sArg.sClass),SyStringLength(&sArg.sClass));` |
|    7076 |  5893 | `			}else{` |
|       - |  5894 | `				int c;` |
|   63697 |  5895 | `				c = 'n'; /* cc warning */` |
|       - |  5896 | `				/* Type leading character */` |
|   63697 |  5897 | `				switch(sArg.nType){` |
|       3 |  5898 | `				case MEMOBJ_HASHMAP:` |
|       - |  5899 | `					/* Hashmap aka 'array' */` |
|       7 |  5900 | `					c = 'h';` |
|       7 |  5901 | `					break;` |
|    8876 |  5902 | `				case MEMOBJ_INT:` |
|       - |  5903 | `					/* Integer */` |
|   17757 |  5904 | `					c = 'i';` |
|   17757 |  5905 | `					break;` |
...
|       2 |  5923 | `					break;` |
|       - |  5924 | `				}` |
|   63697 |  5925 | `				SyBlobAppend(&sSig,(const void *)&c,sizeof(char));` |
|       - |  5926 | `			}` |
|   38922 |  5927 | `		}else{` |
|       - |  5928 | `			/* No type is associated with this parameter which mean` |
|       - |  5929 | `			 * that this function is not condidate for overloading.` |
|       - |  5930 | `			 */` |
|   61767 |  5931 | `			SyBlobRelease(&sSig);` |
|       - |  5932 | `		}` |
|       - |  5933 | `		/* Save in the argument set */` |
|  139601 |  5934 | `		SySetPut(&pFunc->aArgs,(const void *)&sArg);` |
|       5 |  5935 | `	}` |
|   93007 |  5936 | `	if( SyBlobLength(&sSig) > 0 ){` |
|       - |  5937 | `		/* Save function signature */` |
|   49581 |  5938 | `		SyStringInitFromBuf(&pFunc->sSignature,SyBlobData(&sSig),SyBlobLength(&sSig));` |
|   24788 |  5939 | `	}` |
|   93007 |  5940 | `	return SXRET_OK;` |
|   46513 |  5941 |  |
|       - |  5942 | `/*` |
...
|       - |  5946 | ` */` |
|  221018 |  5947 | `static sxi32 GenStateCompileFuncBody(` |
...
|  221023 |  5957 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC,PH7_VmInstrLength(pGen->pVm),pFunc,&pBlock);` |
|  221023 |  5958 | `	if( rc != SXRET_OK ){` |
...
|       - |  5962 | `	}` |
|  221023 |  5963 | `	nGotoOfft = SySetUsed(&pGen->aGoto);` |
|       - |  5964 | `	/* Swap bytecode containers */` |
|  221023 |  5965 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|  221023 |  5966 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pFunc->aByteCode);` |
...
|       - |  5971 | `	{` |
|  221023 |  5972 | `		sxu32 nArg = SySetUsed(&pFunc->aArgs);` |
|       - |  5973 | `		sxu32 i;` |
|  332269 |  5974 | `		for( i = 0; i < nArg; i++ ){` |
|  111251 |  5975 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pFunc->aArgs,i);` |
|       - |  5976 | `			char *zSrc;` |
|       - |  5977 | `			sxu32 nSrc,nName;` |
|       - |  5978 | `			SySet sToken;` |
|       - |  5979 | `			SyToken *pTmpIn,*pTmpEnd;` |
|       - |  5980 | `			sxi32 rcPromote;` |
|  111251 |  5981 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|  111197 |  5982 | `				continue;` |
|       - |  5983 | `			}` |
...
|  221023 |  6030 | `	PH7_CompileBlock(&(*pGen),0);` |
|       - |  6031 | `	/* Fix exception jumps now the destination is resolved */` |
|  221023 |  6032 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|       - |  6033 | `	/* Emit the final return if not yet done */` |
|  221023 |  6034 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|       - |  6035 | `	/* Fix gotos jumps now the destination is resolved */` |
|  221023 |  6036 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),nGotoOfft) ){` |
|     ! 0 |  6037 | `		rc = SXERR_ABORT;` |
|     ! 0 |  6038 | `	}` |
|  221023 |  6039 | `	SySetTruncate(&pGen->aGoto,nGotoOfft);` |
|       - |  6040 | `	/* Restore the default container */` |
|  221023 |  6041 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|       - |  6042 | `	/* Leave function block */` |
|  221023 |  6043 | `	GenStateLeaveBlock(&(*pGen),0);` |
|  221023 |  6044 | `	if( rc == SXERR_ABORT ){` |
...
|       - |  6049 | `	{` |
|  221023 |  6050 | `		VmInstr *aInstr = (VmInstr *)SySetBasePtr(&pFunc->aByteCode);` |
|       - |  6051 | `		sxu32 i;` |
| 4314441 |  6052 | `		for( i = 0; i < SySetUsed(&pFunc->aByteCode); i++ ){` |
| 4093517 |  6053 | `			if( aInstr[i].iOp == PH7_OP_YIELD \|\| aInstr[i].iOp == PH7_OP_YIELD_FROM ){` |
|      99 |  6054 | `				pFunc->iFlags \|= VM_FUNC_GENERATOR;` |
|      99 |  6055 | `				break;` |
|       - |  6056 | `			}` |
| 2046714 |  6057 | `		}` |
|       - |  6058 | `	}` |
|       - |  6059 | `	/* All done, function body compiled */` |
|  221023 |  6060 | `	return SXRET_OK;` |
|  110514 |  6061 |  |
|       - |  6062 | `/*` |
...
|       - |  6123 | ` */` |
|   78716 |  6124 | `static sxi32 GenStateParseOneTypeAtom(ph7_gen_state *pGen, PhlTypeAtom *pOut)` |
|       5 |  6125 |  |
|   78721 |  6126 | `	SyToken *pIn = pGen->pIn;` |
|   78721 |  6127 | `	SyZero(pOut, sizeof(*pOut));` |
|   78721 |  6128 | `	SyStringInitFromBuf(&pOut->sClass, 0, 0);` |
|   78721 |  6129 | `	if( pIn >= pGen->pEnd ){` |
|     ! 0 |  6130 | `		return SXERR_SYNTAX;` |
|       - |  6131 | `	}` |
|       - |  6132 | `	/* Optional leading namespace separator '\' on FQN class types */` |
|   78721 |  6133 | `	if( pIn->nType & PH7_TK_NSSEP ){` |
|       8 |  6134 | `		pIn++;` |
|       8 |  6135 | `		if( pIn >= pGen->pEnd ){` |
|     ! 0 |  6136 | `			return SXERR_SYNTAX;` |
|       - |  6137 | `		}` |
|       3 |  6138 | `	}` |
|   78721 |  6139 | `	if( (pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|     ! 0 |  6140 | `		return SXERR_SYNTAX;` |
|       - |  6141 | `	}` |
|   78721 |  6142 | `	if( pIn->nType & PH7_TK_KEYWORD ){` |
|   64223 |  6143 | `		sxu32 nKey = (sxu32)(SX_PTR_TO_INT(pIn->pUserData));` |
|   64223 |  6144 | `		if( nKey & PH7_TKWRD_ARRAY ){` |
|      32 |  6145 | `			pOut->nType = MEMOBJ_HASHMAP; pOut->zCanon = "array"; pOut->nCanon = 5;` |
|   64209 |  6146 | `		}else if( nKey & PH7_TKWRD_BOOL ){` |
|      69 |  6147 | `			pOut->nType = MEMOBJ_BOOL; pOut->zCanon = "bool"; pOut->nCanon = 4;` |
|   64163 |  6148 | `		}else if( nKey & PH7_TKWRD_INT ){` |
|   18005 |  6149 | `			pOut->nType = MEMOBJ_INT; pOut->zCanon = "int"; pOut->nCanon = 3;` |
|   55131 |  6150 | `		}else if( nKey & PH7_TKWRD_STRING ){` |
|   46069 |  6151 | `			pOut->nType = MEMOBJ_STRING; pOut->zCanon = "string"; pOut->nCanon = 6;` |
|   23099 |  6152 | `		}else if( nKey & PH7_TKWRD_FLOAT ){` |
...
|   14503 |  6167 | `		SyString *pT = &pIn->sData;` |
|   14503 |  6168 | `		if( pT->nByte == 4 && SyMemcmpNoCase(pT->zString, "null", 4) == 0 ){` |
|      32 |  6169 | `			pOut->nType = UTA_NULL_FLAG; pOut->zCanon = "null"; pOut->nCanon = 4;` |
|      32 |  6170 | `			pIn++;` |
|   14489 |  6171 | `		}else if( pT->nByte == 4 && SyMemcmpNoCase(pT->zString, "void", 4) == 0 ){` |
|     157 |  6172 | `			pOut->nType = UTA_VOID_FLAG; pOut->zCanon = "void"; pOut->nCanon = 4;` |
|     157 |  6173 | `			pIn++;` |
|   14399 |  6174 | `		}else if( pT->nByte == 5 && SyMemcmpNoCase(pT->zString, "never", 5) == 0 ){` |
|       3 |  6175 | `			pOut->nType = UTA_NEVER_FLAG; pOut->zCanon = "never"; pOut->nCanon = 5;` |
|       3 |  6176 | `			pIn++;` |
|       2 |  6177 | `		}else{` |
|       - |  6178 | `			/* Class / interface name; consume namespace path a\b\c */` |
|   14321 |  6179 | `			SyToken *pFirst = pIn;` |
|   14321 |  6180 | `			SyToken *pLast = pIn;` |
|   14321 |  6181 | `			pOut->nType = SXU32_HIGH;` |
|   14321 |  6182 | `			pOut->sClass = pIn->sData;` |
|   14321 |  6183 | `			pIn++;` |
|   21477 |  6184 | `			while( pIn + 1 < pGen->pEnd && (pIn->nType & PH7_TK_NSSEP)` |
|   14324 |  6185 | `				&& (pIn[1].nType & PH7_TK_ID) ){` |
|       3 |  6186 | `				pLast = &pIn[1];` |
|       3 |  6187 | `				pIn += 2;` |
|       1 |  6188 | `			}` |
|   14321 |  6189 | `			if( pLast != pFirst ){` |
...
|       - |  6195 | `		}` |
|       - |  6196 | `	}` |
|   78719 |  6197 | `	pGen->pIn = pIn;` |
|   78719 |  6198 | `	return SXRET_OK;` |
|   39363 |  6199 |  |
|       - |  6200 |  |
|       - |  6201 | `/*` |
...
|       - |  6207 | ` */` |
|   78562 |  6208 | `static void GenBuildUnionTypeText(SyBlob *pBlob, PhlTypeAtom *aAtoms, int nAtoms, int bNullable)` |
|       5 |  6209 |  |
|       - |  6210 | `	int i;` |
|   78567 |  6211 | `	int nNonNull = 0;` |
|   78567 |  6212 | `	int bAnyIntersection = 0;` |
|       - |  6213 | `	sxu32 aGroupCount[PHL_UNION_MAX_ALTS];` |
|   78567 |  6214 | `	sxu32 nMaxGroup = 0;` |
| 2592551 |  6215 | `	for( i = 0; i < PHL_UNION_MAX_ALTS; i++ ) aGroupCount[i] = 0;` |
|  157263 |  6216 | `	for( i = 0; i < nAtoms; i++ ){` |
|   78701 |  6217 | `		if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|   78673 |  6218 | `			nNonNull++;` |
|   78673 |  6219 | `			if( aAtoms[i].nGroup < PHL_UNION_MAX_ALTS ){` |
|   78673 |  6220 | `				aGroupCount[aAtoms[i].nGroup]++;` |
|   78673 |  6221 | `				if( aAtoms[i].nGroup > nMaxGroup ) nMaxGroup = aAtoms[i].nGroup;` |
|   39334 |  6222 | `			}` |
|   39334 |  6223 | `		}` |
|   39353 |  6224 | `	}` |
|  157229 |  6225 | `	for( i = 0; i < nAtoms; i++ ){` |
|   78683 |  6226 | `		if( aAtoms[i].nType != UTA_NULL_FLAG && aGroupCount[aAtoms[i].nGroup] >= 2 ){` |
|      19 |  6227 | `			bAnyIntersection = 1;` |
|      19 |  6228 | `			break;` |
|       - |  6229 | `		}` |
|   39336 |  6230 | `	}` |
|   78567 |  6231 | `	if( bAnyIntersection ){` |
...
|      57 |  6266 | `		return;` |
|       - |  6267 | `	}` |
|   78551 |  6268 | `	if( nNonNull == 1 && bNullable ){` |
|       - |  6269 | `		/* Shorthand: ?T */` |
...
|     ! 0 |  6280 | `	}` |
|       - |  6281 | `	{` |
|   78475 |  6282 | `		int bFirst = 1;` |
|       - |  6283 | `		/* 1) Classes in declaration order */` |
|  157047 |  6284 | `		for( i = 0; i < nAtoms; i++ ){` |
|   78577 |  6285 | `			if( aAtoms[i].nType == SXU32_HIGH ){` |
|   14277 |  6286 | `				if( !bFirst ) SyBlobAppend(pBlob, "\|", 1);` |
|   14277 |  6287 | `				SyBlobAppend(pBlob, aAtoms[i].sClass.zString, aAtoms[i].sClass.nByte);` |
|   14277 |  6288 | `				bFirst = 0;` |
|    7136 |  6289 | `			}` |
|   39291 |  6290 | `		}` |
...
|       - |  6295 | `			int k;` |
|  549295 |  6296 | `			for( k = 0; k < (int)(sizeof(aOrder)/sizeof(aOrder[0])); k++ ){` |
|  878015 |  6297 | `				for( i = 0; i < nAtoms; i++ ){` |
|  471329 |  6298 | `					if( aAtoms[i].nType == aOrder[k] ){` |
|   64139 |  6299 | `						if( !bFirst ) SyBlobAppend(pBlob, "\|", 1);` |
|   64139 |  6300 | `						SyBlobAppend(pBlob, aAtoms[i].zCanon, aAtoms[i].nCanon);` |
|   64139 |  6301 | `						bFirst = 0;` |
|   64139 |  6302 | `						break;` |
|       - |  6303 | `					}` |
|  203600 |  6304 | `				}` |
...
|       - |  6328 | ` */` |
|   78698 |  6329 | `static sxi32 GenStateParsePart(` |
|       - |  6330 | `	ph7_gen_state *pGen, PhlTypeAtom *aAtoms, int *pnAtoms, sxu32 iGroup,` |
|       - |  6331 | `	int *pnMembers, int *pbParen, sxu32 nLine)` |
|       5 |  6332 |  |
|       - |  6333 | `	sxi32 rc;` |
|   78703 |  6334 | `	int nMembers = 0;` |
|   78703 |  6335 | `	int bParen = 0;` |
|   78703 |  6336 | `	*pnMembers = 0;` |
|   78703 |  6337 | `	*pbParen = 0;` |
|   78703 |  6338 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_LPAREN) ){` |
|       6 |  6339 | `		bParen = 1;` |
|       6 |  6340 | `		pGen->pIn++; /* skip '(' */` |
|       2 |  6341 | `	}` |
|   39349 |  6342 | `	for(;;){` |
|   78721 |  6343 | `		if( *pnAtoms >= PHL_UNION_MAX_ALTS ){` |
...
|       - |  6347 | `		}` |
|   78721 |  6348 | `		rc = GenStateParseOneTypeAtom(pGen, &aAtoms[*pnAtoms]);` |
|   78721 |  6349 | `		if( rc != SXRET_OK ){` |
|       3 |  6350 | `			return rc;` |
|       - |  6351 | `		}` |
|   78719 |  6352 | `		aAtoms[*pnAtoms].nGroup = iGroup;` |
|   78719 |  6353 | `		(*pnAtoms)++;` |
|   78719 |  6354 | `		nMembers++;` |
|       - |  6355 | ``		/* Continue the intersection while `&` is followed by another type atom. */`` |
|   78719 |  6356 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
...
|       - |  6377 | `		}` |
|       2 |  6378 | `	}` |
|   78701 |  6379 | `	*pnMembers = nMembers;` |
|   78701 |  6380 | `	*pbParen = bParen;` |
|   78701 |  6381 | `	return SXRET_OK;` |
|   39354 |  6382 |  |
|       - |  6383 |  |
|       - |  6384 | `/*` |
...
|       - |  6401 | ` */` |
|   78574 |  6402 | `static sxi32 GenStateParseUnionTypeDecl(` |
...
|   78579 |  6415 | `	int nAtoms = 0;` |
|   78579 |  6416 | `	int bShortNullable = 0;` |
|   78579 |  6417 | `	int bExplicitNull = 0;` |
|       - |  6418 | `	sxi32 rc;` |
|   78579 |  6419 | `	*pnType = 0;` |
|   78579 |  6420 | `	if( pClass ) SyStringInitFromBuf(pClass, 0, 0);` |
|   78579 |  6421 | `	*piTypeFlags = 0;` |
|   78579 |  6422 | `	if( pTypeText ) SyStringInitFromBuf(pTypeText, 0, 0);` |
|       - |  6423 |  |
|   78579 |  6424 | `	if( pGen->pIn >= pGen->pEnd ){` |
|     ! 0 |  6425 | `		return SXRET_OK;` |
|       - |  6426 | `	}` |
|       - |  6427 | ``	/* Optional `?` shorthand prefix */`` |
|   78574 |  6428 | `	if( (pGen->pIn->nType & PH7_TK_OP) && pGen->pIn->sData.nByte == 1` |
...
|   78579 |  6441 | `		sxu32 iGroup = 0;` |
|   78579 |  6442 | `		rc = GenStateParsePart(pGen, aAtoms, &nAtoms, iGroup, &nMembers, &bParen, nLine);` |
|   78579 |  6443 | `		if( rc != SXRET_OK ){` |
|       4 |  6444 | `			return rc;` |
|       - |  6445 | `		}` |
...
|  118046 |  6451 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OP)` |
|   78765 |  6452 | `			&& pGen->pIn->sData.nByte == 1 && pGen->pIn->sData.zString[0] == '\|' ){` |
...
|       - |  6470 | `			}` |
|       5 |  6471 | `		}` |
|   78575 |  6472 | `		if( iGroup > 0 && nMembers >= 2 && !bParen ){` |
...
|       - |  6484 | `	{` |
|       - |  6485 | `		int i, j;` |
|   78575 |  6486 | `		int bHasNonNull = 0;` |
|   78575 |  6487 | `		int bAnyIntersection = 0;` |
...
| 2592815 |  6491 | `		for( i = 0; i < PHL_UNION_MAX_ALTS; i++ ) aGroupCount[i] = 0;` |
|  157287 |  6492 | `		for( i = 0; i < nAtoms; i++ ){` |
|   78717 |  6493 | `			if( aAtoms[i].nGroup < PHL_UNION_MAX_ALTS ) aGroupCount[aAtoms[i].nGroup]++;` |
|   39361 |  6494 | `		}` |
|  157249 |  6495 | `		for( i = 0; i < nAtoms; i++ ){` |
|   78697 |  6496 | `			if( aGroupCount[aAtoms[i].nGroup] >= 2 ){ bAnyIntersection = 1; break; }` |
|   39342 |  6497 | `		}` |
...
|   78575 |  6500 | `		if( bShortNullable && bAnyIntersection ){` |
...
|       - |  6504 | `		}` |
|  157277 |  6505 | `		for( i = 0; i < nAtoms; i++ ){` |
...
|   78715 |  6509 | `			if( aGroupCount[aAtoms[i].nGroup] >= 2 ){` |
...
|       - |  6531 | `				}` |
|      16 |  6532 | `			}` |
|   78713 |  6533 | `			if( aAtoms[i].nType == UTA_VOID_FLAG ){` |
...
|       - |  6548 | `				}` |
|      75 |  6549 | `			}` |
|   78711 |  6550 | `			if( aAtoms[i].nType == UTA_NEVER_FLAG ){` |
...
|       - |  6564 | `			}` |
|   78709 |  6565 | `			if( aAtoms[i].nType == UTA_NULL_FLAG ){` |
|      32 |  6566 | `				bExplicitNull = 1;` |
|      18 |  6567 | `			}else{` |
|   78681 |  6568 | `				bHasNonNull = 1;` |
|       - |  6569 | `			}` |
...
|      91 |  6607 | `			}` |
|   39356 |  6608 | `		}` |
|   78567 |  6609 | `		if( !bHasNonNull && bExplicitNull ){` |
...
|   78567 |  6624 | `	if( bShortNullable \|\| bExplicitNull ){` |
|      97 |  6625 | `		*piTypeFlags \|= iNullableFlag;` |
|      46 |  6626 | `	}` |
|       - |  6627 | `	/* Build canonical type text */` |
|   78567 |  6628 | `	if( pTypeText ){` |
|       - |  6629 | `		SyBlob sBlob;` |
|   78567 |  6630 | `		SyBlobInit(&sBlob, &pGen->pVm->sAllocator);` |
|  117816 |  6631 | `		GenBuildUnionTypeText(&sBlob, aAtoms, nAtoms,` |
|   39281 |  6632 | `			(bShortNullable \|\| bExplicitNull) ? 1 : 0);` |
|   78567 |  6633 | `		if( SyBlobLength(&sBlob) > 0 ){` |
|  117623 |  6634 | `			char *zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|   78412 |  6635 | `				(const char *)SyBlobData(&sBlob), SyBlobLength(&sBlob));` |
|   78417 |  6636 | `			if( zDup ){` |
|   78417 |  6637 | `				SyStringInitFromBuf(pTypeText, zDup, SyBlobLength(&sBlob));` |
|   39206 |  6638 | `			}` |
|   39206 |  6639 | `		}` |
|   78567 |  6640 | `		SyBlobRelease(&sBlob);` |
|   39281 |  6641 | `	}` |
...
|       - |  6645 | `	{` |
|   78567 |  6646 | `		int nNonNull = 0;` |
|   78567 |  6647 | `		int iNonNullIdx = -1;` |
|       - |  6648 | `		int i;` |
|  157263 |  6649 | `		for( i = 0; i < nAtoms; i++ ){` |
|   78701 |  6650 | `			if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|   78673 |  6651 | `				nNonNull++;` |
|   78673 |  6652 | `				iNonNullIdx = i;` |
|   39334 |  6653 | `			}` |
|   39353 |  6654 | `		}` |
|   78567 |  6655 | `		if( nNonNull <= 1 ){` |
|       - |  6656 | `			/* Fast path: store as single type. */` |
|   78475 |  6657 | `			if( iNonNullIdx >= 0 ){` |
|   78469 |  6658 | `				PhlTypeAtom *pA = &aAtoms[iNonNullIdx];` |
|   78469 |  6659 | `				if( pA->nType == SXU32_HIGH ){` |
|   21380 |  6660 | `					char *zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|    7125 |  6661 | `						pA->sClass.zString, pA->sClass.nByte);` |
|   14255 |  6662 | `					if( zDup == 0 ) return SXERR_ABORT;` |
|   14255 |  6663 | `					*pnType = SXU32_HIGH;` |
|   14255 |  6664 | `					if( pClass ) SyStringInitFromBuf(pClass, zDup, pA->sClass.nByte);` |
|   71344 |  6665 | `				}else if( pA->nType == UTA_VOID_FLAG ){` |
...
|       - |  6705 | ` */` |
|  312930 |  6706 | `static sxi32 GenStateParseReturnType(ph7_gen_state *pGen, ph7_vm_func *pFunc)` |
|       5 |  6707 |  |
|  312935 |  6708 | `	sxi32 iFlags = 0;` |
|       - |  6709 | `	sxi32 rc;` |
|       - |  6710 | `	sxu32 nLine;` |
|  312935 |  6711 | `	pFunc->nReturnType = 0;` |
|  312935 |  6712 | `	SyStringInitFromBuf(&pFunc->sReturnClass, 0, 0);` |
|  312935 |  6713 | `	SyStringInitFromBuf(&pFunc->sReturnTypeName, 0, 0);` |
|  312935 |  6714 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COLON) == 0 ){` |
|  312463 |  6715 | `		return SXRET_OK;` |
|       - |  6716 | `	}` |
...
|  156470 |  6754 |  |
|       - |  6755 |  |
|   47138 |  6756 | `static sxi32 GenStateCompileFunc(` |
...
|   47143 |  6770 | `	nLine = pGen->pIn->nLine;` |
|       - |  6771 | `	/* Jump the left parenthesis '(' */` |
|   47143 |  6772 | `	pGen->pIn++;` |
|       - |  6773 | `	/* Delimit the function signature */` |
|   47143 |  6774 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   47143 |  6775 | `	if( pEnd >= pGen->pEnd ){` |
|       - |  6776 | `		/* Syntax error */` |
...
|   47137 |  6786 | `	pFunc = (ph7_vm_func *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_vm_func));` |
|   47137 |  6787 | `	if( pFunc == 0 ){` |
|     ! 0 |  6788 | `		goto OutOfMem;` |
|       - |  6789 | `	}` |
|       - |  6790 | `	/* Build the function name, prepending namespace if active */` |
|   47144 |  6791 | `	if( SyBlobLength(&pGen->sNamespace) > 0 && !bHandleClosure ){` |
|       - |  6792 | `		SyBlob sFQN;` |
|       - |  6793 | `		sxu32 nLen;` |
...
|       9 |  6805 | `	}else{` |
|   47123 |  6806 | `		zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|   47123 |  6807 | `		if( zName == 0 ){` |
|     ! 0 |  6808 | `			goto OutOfMem;` |
|       - |  6809 | `		}` |
|   47123 |  6810 | `		PH7_VmInitFuncState(pGen->pVm,pFunc,zName,pName->nByte,iFlags,0);` |
|       - |  6811 | `	}` |
|   47137 |  6812 | `	if( pGen->pIn < pEnd ){` |
|       - |  6813 | `		/* Collect function arguments */` |
|   32529 |  6814 | `		rc = GenStateCollectFuncArgs(pFunc,&(*pGen),pEnd,0,0);` |
|   32529 |  6815 | `		if( rc == SXERR_ABORT ){` |
...
|   47137 |  6821 | `	pGen->pIn = &pEnd[1];` |
|       - |  6822 | `	{` |
|   47137 |  6823 | `		sxi32 rcRt = GenStateParseReturnType(pGen, pFunc);` |
|   47137 |  6824 | `		if( rcRt == SXERR_ABORT ){` |
|     ! 0 |  6825 | `			return SXERR_ABORT;` |
|   47137 |  6826 | `		}else if( rcRt == SXERR_SYNTAX ){` |
|       6 |  6827 | `			return SXERR_SYNTAX;` |
|       - |  6828 | `		}` |
|       - |  6829 | `	}` |
|   47133 |  6830 | `	if( bHandleClosure ){` |
...
|   47133 |  6923 | `	rc = GenStateCompileFuncBody(&(*pGen),pFunc);` |
|   47133 |  6924 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  6925 | `		return SXERR_ABORT;` |
|       - |  6926 | `	}` |
|   47133 |  6927 | `	if( ppFunc ){` |
|     261 |  6928 | `		*ppFunc = pFunc;` |
|     128 |  6929 | `	}` |
|   47133 |  6930 | `	rc = SXRET_OK;` |
|   47133 |  6931 | `	if( (pFunc->iFlags & VM_FUNC_CLOSURE) == 0 ){` |
|       - |  6932 | `		/* Finally register the function */` |
|   47117 |  6933 | `		rc = PH7_VmInstallUserFunction(pGen->pVm,pFunc,0);` |
|   23556 |  6934 | `	}` |
|   47133 |  6935 | `	if( rc == SXRET_OK ){` |
|   47133 |  6936 | `		return SXRET_OK;` |
|       - |  6937 | `	}` |
...
|       - |  6949 | ` */` |
|   46890 |  6950 | `static sxi32 PH7_CompileFunction(ph7_gen_state *pGen)` |
|       5 |  6951 |  |
|       - |  6952 | `	SyString *pName;` |
|       - |  6953 | `	sxi32 iFlags;` |
|       - |  6954 | `	sxu32 nLine;` |
|       - |  6955 | `	sxi32 rc;` |
|       - |  6956 |  |
|   46895 |  6957 | `	nLine = pGen->pIn->nLine;` |
|   46895 |  6958 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|   46895 |  6959 | `	iFlags = 0;` |
|   46895 |  6960 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|       - |  6961 | `		/* Return by reference,remember that */` |
|       7 |  6962 | `		iFlags \|= VM_FUNC_REF_RETURN;` |
|       - |  6963 | `		/* Jump the '&' token */` |
|       7 |  6964 | `		pGen->pIn++;` |
|       3 |  6965 | `	}` |
|   46895 |  6966 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|       - |  6977 | `	}` |
|   46889 |  6978 | `	pName = &pGen->pIn->sData;` |
|   46889 |  6979 | `	nLine = pGen->pIn->nLine;` |
|       - |  6980 | `	/* Jump the function name */` |
|   46889 |  6981 | `	pGen->pIn++;` |
|   46889 |  6982 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  6983 | `		/* Syntax error */` |
...
|   46887 |  6996 | `	rc = GenStateCompileFunc(&(*pGen),pName,iFlags,FALSE,0);` |
|   46887 |  6997 | `	return rc;` |
|   23450 |  6998 |  |
|       - |  6999 | `/*` |
...
|       - |  7009 | ` */` |
|  333438 |  7010 | `static sxi32 GetProtectionLevel(sxi32 nKeyword)` |
|       5 |  7011 |  |
|  333443 |  7012 | `	if( nKeyword == PH7_TKWRD_PRIVATE ){` |
|   10695 |  7013 | `		return PH7_CLASS_PROT_PRIVATE;` |
|  322753 |  7014 | `	}else if( nKeyword == PH7_TKWRD_PROTECTED ){` |
|   45921 |  7015 | `		return PH7_CLASS_PROT_PROTECTED;` |
|       - |  7016 | `	}` |
|       - |  7017 | `	/* Assume public by default */` |
|  276837 |  7018 | `	return PH7_CLASS_PROT_PUBLIC;` |
|  166724 |  7019 |  |
|       - |  7020 | `/*` |
...
|       - |  7282 | ` */` |
|  173970 |  7283 | `static int GenStateLooksLikeTypedProperty(SyToken *pStart,SyToken *pEnd)` |
|       5 |  7284 |  |
|  173975 |  7285 | `	SyToken *p = pStart;` |
|  173975 |  7286 | `	int bFirst = 1;` |
|  173975 |  7287 | `	if( p >= pEnd ) return 0;` |
|       - |  7288 | ``	/* Optional nullable `?` shorthand. */`` |
|  173975 |  7289 | `	if( (p->nType & PH7_TK_OP) && p->sData.nByte == 1 && p->sData.zString[0] == '?' ){` |
|      18 |  7290 | `		p++;` |
...
|   86985 |  7297 | `	for(;;){` |
|  173993 |  7298 | `		if( p < pEnd && (p->nType & PH7_TK_LPAREN) ){` |
...
|  173991 |  7307 | `			if( p < pEnd && (p->nType & PH7_TK_NSSEP) ){ p++; }` |
|  173991 |  7308 | `			if( p >= pEnd \|\| (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|     ! 0 |  7309 | `				return 0;` |
|       - |  7310 | `			}` |
...
|  173991 |  7314 | `			if( bFirst && (p->nType & PH7_TK_KEYWORD) ){` |
|  173951 |  7315 | `				sxu32 k = (sxu32)(SX_PTR_TO_INT(p->pUserData));` |
|  174023 |  7316 | `				if( k == PH7_TKWRD_FUNCTION \|\| k == PH7_TKWRD_VAR \|\| k == PH7_TKWRD_CONST` |
|    3748 |  7317 | `				 \|\| k == PH7_TKWRD_STATIC \|\| k == PH7_TKWRD_FINAL \|\| k == PH7_TKWRD_ABSTRACT ){` |
|  173797 |  7318 | `					return 0;` |
|       - |  7319 | `				}` |
|      77 |  7320 | `			}` |
|     199 |  7321 | `			p++;` |
...
|       - |  7498 | ` */` |
| 1573026 |  7499 | `static int GenStateIsReadonly(SyToken *pTok)` |
|       5 |  7500 |  |
| 1606408 |  7501 | `	return (pTok->nType & PH7_TK_ID)` |
|  819890 |  7502 | `		&& pTok->sData.nByte == sizeof("readonly")-1` |
| 1606403 |  7503 | `		&& SyStrnicmp(pTok->sData.zString,"readonly",sizeof("readonly")-1) == 0;` |
|       5 |  7504 |  |
|   67676 |  7505 | `static sxi32 GenStateCompileClassAttr(ph7_gen_state *pGen,sxi32 iProtection,sxi32 iFlags,ph7_class *pClass)` |
|       5 |  7506 |  |
|   67681 |  7507 | `	sxu32 nLine = pGen->pIn->nLine;` |
|       - |  7508 | `	ph7_class_attr *pAttr;` |
|       - |  7509 | `	SyString *pName;` |
|       - |  7510 | `	sxi32 rc;` |
|   67681 |  7511 | `	sxu32 nType = 0;` |
|       - |  7512 | `	SyString sTypeClass;` |
|       - |  7513 | `	SyString sTypeText;` |
|       - |  7514 | `	SySet aUnionAlts;` |
|   67681 |  7515 | `	sxi32 iTypeFlags = 0;` |
|   67681 |  7516 | `	SyStringInitFromBuf(&sTypeClass,0,0);` |
|   67681 |  7517 | `	SyStringInitFromBuf(&sTypeText,0,0);` |
|   67681 |  7518 | `	SySetInit(&aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
...
|   67681 |  7522 | `	if( pClass->iFlags & PH7_CLASS_READONLY ){` |
|      21 |  7523 | `		iFlags \|= PH7_CLASS_ATTR_READONLY;` |
|       9 |  7524 | `	}` |
|       - |  7525 | `	/* Extract visibility level */` |
|   67681 |  7526 | `	iProtection = GetProtectionLevel(iProtection);` |
|       - |  7527 | `	/* Parse optional type hint (typed properties, PHP 7.4+) */` |
|   67770 |  7528 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
...
|      89 |  7544 | `	}` |
|     ! 0 |  7545 | `loop:` |
|   67685 |  7546 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
...
|       - |  7552 | `	}` |
|   67685 |  7553 | `	pGen->pIn++; /* Jump the dollar sign */` |
|   67685 |  7554 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_ID)) == 0 ){` |
...
|   67685 |  7564 | `	pName = &pGen->pIn->sData;` |
|       - |  7565 | `	/* Advance the stream cursor */` |
|   67685 |  7566 | `	pGen->pIn++;` |
|   67685 |  7567 | `	if(pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_EQUAL/*'='*/\|PH7_TK_SEMI/*';'*/\|PH7_TK_COMMA/*','*/)) == 0 ){` |
...
|   67683 |  7578 | `	if( iFlags & PH7_CLASS_ATTR_READONLY ){` |
...
|   67673 |  7598 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
...
|   67673 |  7610 | `	if( PH7_ClassExtractAttribute(pClass,pName->zString,pName->nByte) != 0 ){` |
...
|   67671 |  7619 | `	pAttr = PH7_NewClassAttr(pGen->pVm,pName,nLine,iProtection,iFlags\|iTypeFlags);` |
|   67671 |  7620 | `	if( pAttr == 0 ){` |
|     ! 0 |  7621 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 engine is running out of memory");` |
|     ! 0 |  7622 | `		return SXERR_ABORT;` |
|       - |  7623 | `	}` |
|   67671 |  7624 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|     179 |  7625 | `		GenStateCopyTypeToAttr(pAttr,nType,&sTypeClass,&sTypeText,iTypeFlags,&aUnionAlts);` |
|      87 |  7626 | `	}` |
|   67671 |  7627 | `	if( pGen->pIn->nType & PH7_TK_EQUAL /*'='*/ ){` |
|       - |  7628 | `		SySet *pInstrContainer;` |
|   21635 |  7629 | `		pGen->pIn++; /*Jump the equal sign */` |
|       - |  7630 | `		/* Swap bytecode container */` |
|   21635 |  7631 | `		pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   21635 |  7632 | `		PH7_VmSetByteCodeContainer(pGen->pVm,&pAttr->aByteCode);` |
|       - |  7633 | `		/* Compile attribute value.` |
|       - |  7634 | `		 */` |
|   21635 |  7635 | `		rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|   21635 |  7636 | `		if( rc == SXERR_EMPTY ){` |
...
|   21635 |  7643 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|   21635 |  7644 | `		PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|   10815 |  7645 | `	}` |
|       - |  7646 | `	/* All done,install the attribute */` |
|   67671 |  7647 | `	rc = PH7_ClassInstallAttr(pClass,pAttr);` |
|   67671 |  7648 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  7649 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|     ! 0 |  7650 | `		return SXERR_ABORT;` |
|       - |  7651 | `	}` |
|   67671 |  7652 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA /*','*/) ){` |
...
|       - |  7670 | `		}` |
|     ! 0 |  7671 | `	}` |
|   67667 |  7672 | `	SySetRelease(&aUnionAlts);` |
|   67667 |  7673 | `	return SXRET_OK;` |
|       7 |  7674 | `Synchronize:` |
...
|       - |  7689 | ` */` |
|  265684 |  7690 | `static sxi32 GenStateCompileClassMethod(` |
...
|       - |  7696 | `	)` |
|       5 |  7697 |  |
|  265689 |  7698 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|  265689 |  7705 | `	iProtection = GetProtectionLevel(iProtection);` |
|  265689 |  7706 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|  265689 |  7707 | `	iFuncFlags = 0;` |
|  265689 |  7708 | `	if( pGen->pIn >= pGen->pEnd ){` |
...
|       - |  7716 | `	}` |
|  265689 |  7717 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|       - |  7718 | `		/* Return by reference,remember that */` |
|     ! 0 |  7719 | `		iFuncFlags \|= VM_FUNC_REF_RETURN;` |
|       - |  7720 | `		/* Jump the '&' token */` |
|     ! 0 |  7721 | `		pGen->pIn++;` |
|     ! 0 |  7722 | `	}` |
|  265689 |  7723 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|  265689 |  7732 | `	pName = &pGen->pIn->sData;` |
|  265689 |  7733 | `	nLine = pGen->pIn->nLine;` |
|       - |  7734 | `	/* Jump the method name */` |
|  265689 |  7735 | `	pGen->pIn++;` |
|  265689 |  7736 | `	if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|       - |  7737 | `		/* Abstract method */` |
|   91787 |  7738 | `		if( iProtection == PH7_CLASS_PROT_PRIVATE ){` |
...
|   91787 |  7747 | `		doBody = FALSE;` |
|   45891 |  7748 | `	}` |
|  265689 |  7749 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  7750 | `		/* Syntax error */` |
...
|  265689 |  7759 | `	pMeth = PH7_NewClassMethod(pGen->pVm,pClass,pName,nLine,iProtection,iFlags,iFuncFlags);` |
|  265689 |  7760 | `	if( pMeth == 0 ){` |
...
|  265689 |  7765 | `	pGen->pIn++;` |
|  265689 |  7766 | `	pEnd = 0; /* cc warning */` |
|       - |  7767 | `	/* Delimit the method signature */` |
|  265689 |  7768 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|  265689 |  7769 | `	if( pEnd >= pGen->pEnd ){` |
|       - |  7770 | `		/* Syntax error */` |
...
|       - |  7777 | `	}` |
|       - |  7778 | `	{` |
|  265687 |  7779 | `		int bIsCtor = 0;` |
|  265687 |  7780 | `		int bAbstractCtor = 0;` |
|  387859 |  7781 | `		if( (pName->nByte == sizeof("__construct") - 1` |
|  157660 |  7782 | `				&& SyMemcmp(pName->zString,"__construct",sizeof("__construct") - 1) == 0)` |
|  255023 |  7783 | `		 \|\| SyStringCmp(pName,&pClass->sName,SyMemcmp) == 0 ){` |
|   21333 |  7784 | `			if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|       3 |  7785 | `				bAbstractCtor = 1;` |
|       2 |  7786 | `			}else{` |
|   21331 |  7787 | `				bIsCtor = 1;` |
|       - |  7788 | `			}` |
|   10664 |  7789 | `		}` |
|  265687 |  7790 | `		if( pGen->pIn < pEnd ){` |
|       - |  7791 | `			/* Collect method arguments */` |
|   60411 |  7792 | `			rc = GenStateCollectFuncArgs(&pMeth->sFunc,&(*pGen),pEnd,bIsCtor,bAbstractCtor);` |
|   60411 |  7793 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  7794 | `				return SXERR_ABORT;` |
|       - |  7795 | `			}` |
|   30203 |  7796 | `		}` |
|       - |  7797 | `	}` |
|       - |  7798 | `	/* Point past ')' and parse optional return type ': type' */` |
|  265687 |  7799 | `	pGen->pIn = &pEnd[1];` |
|       - |  7800 | `	{` |
|  265687 |  7801 | `		sxi32 rcRt = GenStateParseReturnType(pGen, &pMeth->sFunc);` |
|  265687 |  7802 | `		if( rcRt == SXERR_ABORT ){` |
|     ! 0 |  7803 | `			return SXERR_ABORT;` |
|  265687 |  7804 | `		}else if( rcRt == SXERR_SYNTAX ){` |
...
|       - |  7811 | `	{` |
|  265687 |  7812 | `		sxu32 nArg = SySetUsed(&pMeth->sFunc.aArgs);` |
|       - |  7813 | `		sxu32 i;` |
|  361473 |  7814 | `		for( i = 0; i < nArg; i++ ){` |
|   95801 |  7815 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pMeth->sFunc.aArgs,i);` |
|       - |  7816 | `			ph7_class_attr *pAttr;` |
|   95801 |  7817 | `			sxi32 iAttrFlags = 0;` |
|       - |  7818 | `			int bArgTyped;` |
|   95801 |  7819 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|   95737 |  7820 | `				continue;` |
|       - |  7821 | `			}` |
...
|      32 |  7902 | `		}` |
|       - |  7903 | `	}` |
|  265677 |  7904 | `	if( doBody ){` |
|       - |  7905 | `		/* Compile method body */` |
|  173895 |  7906 | `		rc = GenStateCompileFuncBody(&(*pGen),&pMeth->sFunc);` |
|  173895 |  7907 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  7908 | `			return SXERR_ABORT;` |
|       - |  7909 | `		}` |
|   86950 |  7910 | `	}else{` |
|       - |  7911 | `		/* Only method signature is allowed */` |
|   91787 |  7912 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI /* ';'*/) == 0 ){` |
...
|       - |  7945 | ` */` |
|   38880 |  7946 | `static sxi32 PH7_CompileClassInterface(ph7_gen_state *pGen)` |
|       5 |  7947 |  |
|   38885 |  7948 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|   38885 |  7957 | `	pName = &pGen->pIn->sData;` |
|       - |  7958 | `	/* Advance the stream cursor */` |
|   38885 |  7959 | `	pGen->pIn++;` |
|       - |  7960 | `	/* Build FQN and obtain a raw class */ {` |
|       - |  7961 | `		SyBlob sFQN;` |
|       - |  7962 | `		SyString sFQNStr;` |
|   38885 |  7963 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|   38885 |  7964 | `		GenStateBuildFQN(pGen,pName,&sFQN);` |
|   38885 |  7965 | `		SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|   38885 |  7966 | `		pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|   38885 |  7967 | `		SyBlobRelease(&sFQN);` |
|       - |  7968 | `	}` |
|   38885 |  7969 | `	if( pClass == 0 ){` |
...
|   38885 |  7974 | `	pClass->iFlags = PH7_CLASS_INTERFACE;` |
|       - |  7975 | `	/* Assume no base class is given */` |
|   38885 |  7976 | `	pBase = 0;` |
|   38885 |  7977 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|   10597 |  7978 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   10597 |  7979 | `		if( nKwrd == PH7_TKWRD_EXTENDS /* interface b extends a */ ){` |
|       - |  7980 | `			SyBlob sResolved;` |
|       - |  7981 | `			SyString sBaseName;` |
|       - |  7982 | `			sxu32 nRefLine;` |
|       - |  7983 | `			/* Extract base interface */` |
|   10597 |  7984 | `			pGen->pIn++;` |
|   10597 |  7985 | `			nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|   10597 |  7986 | `			SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|   10597 |  7987 | `			if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|       - |  7997 | `			}` |
|   15893 |  7998 | `			pBase = PH7_VmExtractClass(pGen->pVm,` |
|   10592 |  7999 | `				(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|   10597 |  8000 | `			SyStringInitFromBuf(&sBaseName,` |
|       - |  8001 | `				(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|       - |  8002 | `			/* Only interfaces is allowed */` |
|   10597 |  8003 | `			while( pBase && (pBase->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|     ! 0 |  8004 | `				pBase = pBase->pNextName;` |
|     ! 0 |  8005 | `			}` |
|   10597 |  8006 | `			if( pBase == 0 ){` |
...
|       - |  8012 | `				}` |
|     ! 0 |  8013 | `			}` |
|   10597 |  8014 | `			SyBlobRelease(&sResolved);` |
|    5296 |  8015 | `		}` |
|    5296 |  8016 | `	}` |
|   38885 |  8017 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|       - |  8018 | `		/* Syntax error */` |
...
|       - |  8026 | `	}` |
|   38885 |  8027 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|   38885 |  8028 | `	pEnd = 0; /* cc warning */` |
|       - |  8029 | `	/* Delimit the interface body */` |
|   38885 |  8030 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|   38885 |  8031 | `	if( pEnd >= pGen->pEnd ){` |
|       - |  8032 | `		/* Syntax error */` |
...
|   38885 |  8042 | `	pTmp = pGen->pEnd;` |
|   38885 |  8043 | `	pGen->pEnd = pEnd;` |
...
|  222433 |  8051 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|   91779 |  8052 | `			pGen->pIn++;` |
|       5 |  8053 | `		}` |
|  130659 |  8054 | `		if( pGen->pIn >= pGen->pEnd ){` |
|       - |  8055 | `			/* End of interface body */` |
|   38883 |  8056 | `			break;` |
|       - |  8057 | `		}` |
|   91781 |  8058 | `		if( (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|   91781 |  8069 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   91781 |  8070 | `		if( nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
...
|       3 |  8099 | `			goto done;` |
|       - |  8100 | `		}` |
|   91779 |  8101 | `		if( nKwrd != PH7_TKWRD_PUBLIC && nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|     ! 0 |  8108 | `			goto done;` |
|       - |  8109 | `		}` |
|   91779 |  8110 | `		if( nKwrd == PH7_TKWRD_PUBLIC ){` |
|       - |  8111 | `			/* Advance the stream cursor */` |
|   91769 |  8112 | `			pGen->pIn++;` |
|   91769 |  8113 | `			if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|     ! 0 |  8120 | `				goto done;` |
|       - |  8121 | `			}` |
|   91769 |  8122 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   91769 |  8123 | `			if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|       - |  8131 | `			}` |
|   45882 |  8132 | `		}` |
|   91779 |  8133 | `		if( nKwrd == PH7_TKWRD_CONST ){` |
|       - |  8134 | `			/* Parse constant */` |
...
|       - |  8141 | `			}` |
|       4 |  8142 | `		}else{` |
|   91773 |  8143 | `			sxi32 iFlags = PH7_CLASS_ATTR_ABSTRACT; /* Interface methods are implicitly abstract */` |
|   91773 |  8144 | `			if( nKwrd == PH7_TKWRD_STATIC ){` |
|       - |  8145 | `				/* Static method,record that */` |
|   10589 |  8146 | `				iFlags \|= PH7_CLASS_ATTR_STATIC;` |
|       - |  8147 | `				/* Advance the stream cursor */` |
|   10589 |  8148 | `				pGen->pIn++;` |
|   10584 |  8149 | `				if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0` |
|   10589 |  8150 | `					\|\| SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_FUNCTION ){` |
...
|   91773 |  8161 | `			rc = GenStateCompileClassMethod(&(*pGen),0,iFlags,FALSE,pClass);` |
|   91773 |  8162 | `			if( rc != SXRET_OK ){` |
...
|   38883 |  8171 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|   38883 |  8172 | `	if( rc == SXRET_OK && pBase ){` |
|       - |  8173 | `		/* Inherit from the base interface */` |
|   10597 |  8174 | `		rc = PH7_ClassInterfaceInherit(pClass,pBase);` |
|    5296 |  8175 | `	}` |
|   38883 |  8176 | `	if( rc != SXRET_OK ){` |
...
|   38885 |  8182 | `	pGen->pIn  = &pEnd[1];` |
|   38885 |  8183 | `	pGen->pEnd = pTmp;` |
|   38885 |  8184 | `	return PH7_OK;` |
|   19445 |  8185 |  |
|       - |  8186 | `/*` |
...
|       - |  8210 | ` */` |
|   96410 |  8211 | `static sxi32 GenStateCheckInterfaceSignatures(ph7_gen_state *pGen,ph7_class *pClass)` |
|       5 |  8212 |  |
|       - |  8213 | `	ph7_class **apIface;` |
|       - |  8214 | `	sxu32 nIface,i;` |
|       - |  8215 | `	sxi32 rc;` |
|   96415 |  8216 | `	if( pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|     ! 0 |  8217 | `		return SXRET_OK;` |
|       - |  8218 | `	}` |
|   96415 |  8219 | `	apIface = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|   96415 |  8220 | `	nIface = SySetUsed(&pClass->aInterface);` |
|  191913 |  8221 | `	for(i = 0; i < nIface; i++){` |
|   95503 |  8222 | `		ph7_class *pIface = apIface[i];` |
|       - |  8223 | `		SyHashEntry *pEntry;` |
|   95503 |  8224 | `		SyHashResetLoopCursor(&pIface->hMethod);` |
|  254713 |  8225 | `		while((pEntry = SyHashGetNextEntry(&pIface->hMethod)) != 0 ){` |
|  159215 |  8226 | `			ph7_class_method *pIfaceMeth = (ph7_class_method *)pEntry->pUserData;` |
|       - |  8227 | `			ph7_class_method *pImplMeth;` |
|  159215 |  8228 | `			SyString *pMName = &pIfaceMeth->sFunc.sName;` |
|       - |  8229 | `			/* Find the implementing method in the class */` |
|  159215 |  8230 | `			pImplMeth = PH7_ClassExtractMethod(pClass,pMName->zString,pMName->nByte);` |
|  159215 |  8231 | `			if( pImplMeth == 0 \|\| (pImplMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT) ){` |
...
|  159201 |  8235 | `			if( pImplMeth->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|       - |  8245 | `			 */` |
|       - |  8246 | `			{` |
|  159201 |  8247 | `				sxu32 nIfaceArgs = SySetUsed(&pIfaceMeth->sFunc.aArgs);` |
|  159201 |  8248 | `				sxu32 nImplArgs = SySetUsed(&pImplMeth->sFunc.aArgs);` |
|  159201 |  8249 | `				int sigError = 0;` |
|  159201 |  8250 | `				if( nImplArgs < nIfaceArgs ){` |
|       3 |  8251 | `					sigError = 1;` |
|  159200 |  8252 | `				}else if( nImplArgs > nIfaceArgs ){` |
...
|       - |  8303 | ` */` |
|   96410 |  8304 | `static sxi32 GenStateCheckAbstractMethods(ph7_gen_state *pGen,ph7_class *pClass)` |
|       5 |  8305 |  |
...
|   96415 |  8312 | `	if( pClass->iFlags & (PH7_CLASS_ABSTRACT\|PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|      29 |  8313 | `		return SXRET_OK;` |
|       - |  8314 | `	}` |
|       - |  8315 | `	/* Count abstract methods */` |
|   96391 |  8316 | `	nAbstract = 0;` |
|   96391 |  8317 | `	SyHashResetLoopCursor(&pClass->hMethod);` |
|  934163 |  8318 | `	while((pEntry = SyHashGetNextEntry(&pClass->hMethod)) != 0 ){` |
|  837777 |  8319 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|  837777 |  8320 | `		if( pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|      20 |  8321 | `			nAbstract++;` |
|       8 |  8322 | `		}` |
|       5 |  8323 | `	}` |
|   96391 |  8324 | `	if( nAbstract == 0 ){` |
|   96377 |  8325 | `		return SXRET_OK;` |
|       - |  8326 | `	}` |
...
|       - |  8459 | ` */` |
|   96180 |  8460 | `static sxi32 GenStateParseClassReference(ph7_gen_state *pGen,SyBlob *pFqn)` |
|       5 |  8461 |  |
|   96185 |  8462 | `	int isAbsolute = 0;` |
|   96185 |  8463 | `	SyToken *pStart = pGen->pIn;` |
|       - |  8464 | `	SyBlob sName;` |
|   96185 |  8465 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) ){` |
|      89 |  8466 | `		isAbsolute = 1;` |
|      89 |  8467 | `		pGen->pIn++;` |
|      42 |  8468 | `	}` |
|   96185 |  8469 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|       8 |  8470 | `		pGen->pIn = pStart;` |
|       8 |  8471 | `		return SXERR_INVALID;` |
|       - |  8472 | `	}` |
|   96179 |  8473 | `	SyBlobInit(&sName,&pGen->pVm->sAllocator);` |
|   96179 |  8474 | `	SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|   96179 |  8475 | `	pGen->pIn++;` |
|  144279 |  8476 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) &&` |
|   48110 |  8477 | `		&pGen->pIn[1] < pGen->pEnd && (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|      13 |  8478 | `		SyBlobAppend(&sName,"\\",1);` |
|      13 |  8479 | `		pGen->pIn++;` |
|      13 |  8480 | `		SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|      13 |  8481 | `		pGen->pIn++;` |
|       1 |  8482 | `	}` |
|   96179 |  8483 | `	if( isAbsolute ){` |
|      87 |  8484 | `		SyBlobAppend(pFqn,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|      46 |  8485 | `	}else{` |
|       - |  8486 | `		SyString sRaw;` |
|   96097 |  8487 | `		SyStringInitFromBuf(&sRaw,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|   96097 |  8488 | `		GenStateResolveName(pGen,&sRaw,pFqn);` |
|       - |  8489 | `	}` |
|   96179 |  8490 | `	SyBlobRelease(&sName);` |
|   96179 |  8491 | `	return SXRET_OK;` |
|   48095 |  8492 |  |
|       - |  8493 | `/*` |
...
|   10748 |  8501 | `static int GenStateInterfaceIsThrowableAt(ph7_class *pInterface,int iDepth)` |
|       5 |  8502 |  |
|       - |  8503 | `	ph7_class **apParent;` |
|       - |  8504 | `	sxu32 n;` |
|   18005 |  8505 | `	while( pInterface ){` |
|   14323 |  8506 | `		if( iDepth > PH7_THROWABLE_WALK_MAX_DEPTH ){` |
|     ! 0 |  8507 | `			return FALSE;` |
|       - |  8508 | `		}` |
|   17864 |  8509 | `		if( pInterface->sName.nByte == sizeof("Throwable")-1 &&` |
|    7082 |  8510 | `			SyMemcmp(pInterface->sName.zString,"Throwable",sizeof("Throwable")-1) == 0 ){` |
|    7071 |  8511 | `			return TRUE;` |
|       - |  8512 | `		}` |
|    7257 |  8513 | `		apParent = (ph7_class **)SySetBasePtr(&pInterface->aInterface);` |
|    7257 |  8514 | `		for( n = 0 ; n < SySetUsed(&pInterface->aInterface) ; ++n ){` |
|     ! 0 |  8515 | `			if( GenStateInterfaceIsThrowableAt(apParent[n],iDepth+1) ){` |
|     ! 0 |  8516 | `				return TRUE;` |
|       - |  8517 | `			}` |
|     ! 0 |  8518 | `		}` |
|    7257 |  8519 | `		pInterface = pInterface->pBase;` |
|    7257 |  8520 | `		iDepth++;` |
|       5 |  8521 | `	}` |
|    3687 |  8522 | `	return FALSE;` |
|    5379 |  8523 |  |
|   10748 |  8524 | `static int GenStateInterfaceIsThrowable(ph7_class *pInterface)` |
|       5 |  8525 |  |
|   10753 |  8526 | `	return GenStateInterfaceIsThrowableAt(pInterface,0);` |
|       5 |  8527 |  |
|       - |  8528 | `/*` |
...
|       - |  8532 | ` */` |
|    7066 |  8533 | `static int GenStateClassIsExceptionOrError(ph7_class *pBase)` |
|       5 |  8534 |  |
|    7075 |  8535 | `	while( pBase ){` |
...
|       - |  8557 | ` */` |
|   96440 |  8558 | `static sxi32 GenStateCompileClassEx(ph7_gen_state *pGen,sxi32 iFlags,` |
|       - |  8559 | `	SyString *pAnonName,SyToken **ppArgStart,SyToken **ppArgEnd)` |
|       5 |  8560 |  |
|   96445 |  8561 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|      16 |  8588 | `	}else{` |
|   96419 |  8589 | `		if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
|       - |  8590 | `			/* Syntax error */` |
...
|   96419 |  8603 | `		pName = &pGen->pIn->sData;` |
|       - |  8604 | `		/* Advance the stream cursor */` |
|   96419 |  8605 | `		pGen->pIn++;` |
|       - |  8606 | `		/* Build FQN and obtain a raw class */ {` |
|       - |  8607 | `			SyBlob sFQN;` |
|       - |  8608 | `			SyString sFQNStr;` |
|   96419 |  8609 | `			SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|   96419 |  8610 | `			GenStateBuildFQN(pGen,pName,&sFQN);` |
|   96419 |  8611 | `			SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|   96419 |  8612 | `			pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|   96419 |  8613 | `			SyBlobRelease(&sFQN);` |
|       - |  8614 | `		}` |
|       - |  8615 | `	}` |
|   96445 |  8616 | `	if( pClass == 0 ){` |
...
|   96445 |  8621 | `	SySetInit(&aInterfaces,&pGen->pVm->sAllocator,sizeof(ph7_class *));` |
|   96445 |  8622 | `	SySetInit(&aUseEntries,&pGen->pVm->sAllocator,sizeof(TraitUseEntry));` |
|       - |  8623 | `	/* Assume a standalone class */` |
|   96445 |  8624 | `	pBase = 0;` |
|   96445 |  8625 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|   84993 |  8626 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   84993 |  8627 | `		if( nKwrd == PH7_TKWRD_EXTENDS /* class b extends a */ ){` |
|       - |  8628 | `			SyBlob sResolved;` |
|       - |  8629 | `			SyString sBaseName;` |
|       - |  8630 | `			sxu32 nRefLine;` |
|   74263 |  8631 | `			pGen->pIn++; /* Advance past 'extends' */` |
|   74263 |  8632 | `			nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|   74263 |  8633 | `			SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|   74263 |  8634 | `			if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|       - |  8644 | `			}` |
|  111389 |  8645 | `			pBase = PH7_VmExtractClass(pGen->pVm,` |
|   74256 |  8646 | `				(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|   74261 |  8647 | `			SyStringInitFromBuf(&sBaseName,` |
|       - |  8648 | `				(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|       - |  8649 | `			/* Interfaces are not allowed */` |
|   74261 |  8650 | `			while( pBase && (pBase->iFlags & PH7_CLASS_INTERFACE) ){` |
|     ! 0 |  8651 | `				pBase = pBase->pNextName;` |
|     ! 0 |  8652 | `			}` |
|   74261 |  8653 | `			if( pBase == 0 ){` |
...
|       - |  8659 | `				}` |
|     ! 0 |  8660 | `			}else{` |
|   74261 |  8661 | `				if( pBase->iFlags & PH7_CLASS_FINAL ){` |
...
|     ! 0 |  8668 | `				}` |
|       - |  8669 | `			}` |
|   74261 |  8670 | `			SyBlobRelease(&sResolved);` |
|   37128 |  8671 | `		}` |
|   84991 |  8672 | `		if (pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) && SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_IMPLEMENTS ){` |
|       - |  8673 | `			ph7_class *pInterface;` |
|       - |  8674 | `			/* Interface implementation */` |
|   10743 |  8675 | `			pGen->pIn++; /* Advance the stream cursor */` |
|    5379 |  8676 | `			for(;;){` |
|       - |  8677 | `				SyBlob sResolved;` |
|       - |  8678 | `				SyString sIntName;` |
|       - |  8679 | `				sxu32 nRefLine;` |
|   10753 |  8680 | `				nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|   10753 |  8681 | `				SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|   10753 |  8682 | `				if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|     ! 0 |  8690 | `					break;` |
|       - |  8691 | `				}` |
|   21501 |  8692 | `				pInterface = PH7_VmExtractClass(pGen->pVm,` |
|   10748 |  8693 | `					(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|   10753 |  8694 | `				SyStringInitFromBuf(&sIntName,` |
|       - |  8695 | `					(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|       - |  8696 | `				/* Only interfaces are allowed */` |
|   10753 |  8697 | `				while( pInterface && (pInterface->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|     ! 0 |  8698 | `					pInterface = pInterface->pNextName;` |
|     ! 0 |  8699 | `				}` |
|   10753 |  8700 | `				if( pInterface == 0 ){` |
...
|   10753 |  8714 | `					SyString *pFqn = &pClass->sName;` |
|   10753 |  8715 | `					int bIsExceptionOrError =` |
|    8905 |  8716 | `						(pFqn->nByte == sizeof("Exception")-1 &&` |
|   17889 |  8717 | `						 SyMemcmp(pFqn->zString,"Exception",sizeof("Exception")-1) == 0) \|\|` |
|    8991 |  8718 | `						(pFqn->nByte == sizeof("Error")-1 &&` |
|    3542 |  8719 | `						 SyMemcmp(pFqn->zString,"Error",sizeof("Error")-1) == 0);` |
|   17812 |  8720 | `					if( GenStateInterfaceIsThrowable(pInterface) &&` |
|   10602 |  8721 | `						!GenStateClassIsExceptionOrError(pBase) &&` |
|    3531 |  8722 | `						!bIsExceptionOrError ){` |
...
|       6 |  8732 | `					}else{` |
|   10747 |  8733 | `						SySetPut(&aInterfaces,(const void *)&pInterface);` |
|       - |  8734 | `					}` |
|       - |  8735 | `				}` |
|   10753 |  8736 | `				SyBlobRelease(&sResolved);` |
|   10753 |  8737 | `				if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COMMA) == 0 ){` |
|    5374 |  8738 | `					break;` |
|       - |  8739 | `				}` |
...
|    5369 |  8742 | `		}` |
|   42493 |  8743 | `	}` |
|   96443 |  8744 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|       - |  8745 | `		/* Syntax error */` |
...
|       - |  8753 | `	}` |
|   96443 |  8754 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|   96443 |  8755 | `	pEnd = 0; /* cc warning */` |
|       - |  8756 | `	/* Delimit the class body */` |
|   96443 |  8757 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|   96443 |  8758 | `	if( pEnd >= pGen->pEnd ){` |
|       - |  8759 | `		/* Syntax error */` |
...
|   96443 |  8769 | `	pTmp = pGen->pEnd;` |
|   96443 |  8770 | `	pGen->pEnd = pEnd;` |
|       - |  8771 | `	/* Set the inherited flags */` |
|   96443 |  8772 | `	pClass->iFlags = iFlags;` |
|       - |  8773 | `	/* Start the parse process */` |
|  135174 |  8774 | `	for(;;){` |
|       - |  8775 | `		/* Jump leading/trailing semi-colons */` |
|  405815 |  8776 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|   67769 |  8777 | `			pGen->pIn++;` |
|       5 |  8778 | `		}` |
|  338051 |  8779 | `		if( pGen->pIn >= pGen->pEnd ){` |
|       - |  8780 | `			/* End of class body */` |
|   96415 |  8781 | `			break;` |
|       - |  8782 | `		}` |
|  241636 |  8783 | `		if( (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR)) == 0` |
|  120823 |  8784 | ``			&& !GenStateIsReadonly(pGen->pIn) /* allow a leading `readonly` modifier */ ){`` |
...
|  241641 |  8795 | `		iProtection = PH7_TKWRD_PUBLIC;` |
|  241641 |  8796 | `		iAttrflags = 0;` |
...
|  241641 |  8801 | `		if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|     ! 0 |  8802 | `			int bMod = 0;` |
...
|       - |  8823 | `			}` |
|     ! 0 |  8824 | `		}` |
|  241641 |  8825 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|       - |  8826 | `			/* Extract the current keyword */` |
|  241641 |  8827 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  241641 |  8828 | `			if( nKwrd == PH7_TKWRD_USE ){` |
...
|      53 |  8888 | `				continue;` |
|       - |  8889 | `			}` |
|  241593 |  8890 | `			if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|  237819 |  8891 | `				iProtection = nKwrd;` |
|  237819 |  8892 | `				pGen->pIn++; /* Jump the visibility token */` |
|       - |  8893 | ``				/* Optional `readonly` after the visibility: `public readonly int $x`. */`` |
|  237819 |  8894 | `				if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|      20 |  8895 | `					iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|      20 |  8896 | `					pGen->pIn++; /* Jump the 'readonly' modifier */` |
|       8 |  8897 | `				}` |
|  237814 |  8898 | `				if( pGen->pIn >= pGen->pEnd` |
|  237819 |  8899 | `					\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|     ! 0 |  8907 | `					goto done;` |
|       - |  8908 | `				}` |
|  237819 |  8909 | `				if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|       - |  8910 | `					/* Attribute declaration (untyped) */` |
|   67479 |  8911 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|   67479 |  8912 | `					if( rc != SXRET_OK ){` |
...
|   67473 |  8918 | `					continue;` |
|       - |  8919 | `				}` |
|  170345 |  8920 | `				if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|  170183 |  8932 | `				nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   85089 |  8933 | `			}` |
|  173957 |  8934 | `			if( nKwrd == PH7_TKWRD_CONST ){` |
...
|       - |  8942 | `				}` |
|      35 |  8943 | `			}else{` |
|  173895 |  8944 | `				if( nKwrd == PH7_TKWRD_STATIC ){` |
|       - |  8945 | `					/* Static method or attribute,record that */` |
|    3581 |  8946 | `					iAttrflags \|= PH7_CLASS_ATTR_STATIC;` |
|    3581 |  8947 | `					pGen->pIn++; /* Jump the static keyword */` |
|    3581 |  8948 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|       - |  8949 | `						/* Extract the keyword */` |
|    3573 |  8950 | `						nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    3573 |  8951 | `						if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
...
|    3581 |  8959 | `					if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|     ! 0 |  8960 | `						iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|     ! 0 |  8961 | `						pGen->pIn++; /* Jump the 'readonly' modifier */` |
|     ! 0 |  8962 | `					}` |
|    3576 |  8963 | `					if( pGen->pIn >= pGen->pEnd` |
|    3581 |  8964 | `						\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|     ! 0 |  8972 | `						goto done;` |
|       - |  8973 | `					}` |
|    3581 |  8974 | `					if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
...
|       8 |  8983 | `						continue;` |
|       - |  8984 | `					}` |
|    3575 |  8985 | `					if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|    3563 |  8997 | `					nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  172098 |  8998 | `				}else if( nKwrd == PH7_TKWRD_ABSTRACT ){` |
...
|  170314 |  9030 | `				}else if( nKwrd == PH7_TKWRD_FINAL ){` |
...
|       2 |  9074 | `				}` |
|  173867 |  9075 | `				if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_VAR ){` |
...
|     ! 0 |  9083 | `						goto done;` |
|       - |  9084 | `				}` |
|  173867 |  9085 | `				if( nKwrd == PH7_TKWRD_VAR ){` |
...
|  173861 |  9100 | `					rc = GenStateCompileClassMethod(&(*pGen),iProtection,iAttrflags,TRUE,pClass);` |
|       - |  9101 | `				}` |
|  173867 |  9102 | `				if( rc != SXRET_OK ){` |
...
|       - |  9125 | `		sxu32 nU;` |
|   96415 |  9126 | `		apUse = (TraitUseEntry *)SySetBasePtr(&aUseEntries);` |
|   96463 |  9127 | `		for( nU = 0 ; nU < SySetUsed(&aUseEntries) ; nU++ ){` |
...
|   96415 |  9335 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|   96415 |  9336 | `	if( rc == SXRET_OK ){` |
|       - |  9337 | `		ph7_class **apInterface;` |
|       - |  9338 | `		sxu32 n;` |
|   96415 |  9339 | `		if( pBase ){` |
|       - |  9340 | `			/* Inherit from base class and mark as a subclass */` |
|   74261 |  9341 | `			rc = PH7_ClassInherit(&(*pGen),pClass,pBase);` |
|   37128 |  9342 | `		}` |
|   96415 |  9343 | `		apInterface = (ph7_class **)SySetBasePtr(&aInterfaces);` |
|  107157 |  9344 | `		for( n = 0 ; n < SySetUsed(&aInterfaces) ; n++ ){` |
|       - |  9345 | `			/* Implements one or more interface */` |
|   10747 |  9346 | `			rc = PH7_ClassImplement(pClass,apInterface[n]);` |
|   10747 |  9347 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  9348 | `				break;` |
|       - |  9349 | `			}` |
|    5376 |  9350 | `		}` |
...
|  144615 |  9353 | `		if( rc == SXRET_OK` |
|   96410 |  9354 | `		 && (pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT)) == 0` |
|   96415 |  9355 | `		 && SyHashGet(&pClass->hMethod,"__toString",sizeof("__toString")-1) != 0 ){` |
|   84763 |  9356 | `			ph7_class *pStringable = PH7_VmExtractClass(pGen->pVm,` |
|       - |  9357 | `				"Stringable",sizeof("Stringable")-1,FALSE,0);` |
|   84763 |  9358 | `			if( pStringable ){` |
|   84763 |  9359 | `				ph7_class **apImpl = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|   84763 |  9360 | `				sxu32 nImpl = SySetUsed(&pClass->aInterface);` |
|       - |  9361 | `				sxu32 i;` |
|   84763 |  9362 | `				int bAlready = 0;` |
|   91823 |  9363 | `				for( i = 0 ; i < nImpl ; i++ ){` |
|    7067 |  9364 | `					if( apImpl[i] == pStringable ){` |
|       3 |  9365 | `						bAlready = 1;` |
|       3 |  9366 | `						break;` |
|       - |  9367 | `					}` |
|    3535 |  9368 | `				}` |
|   84763 |  9369 | `				if( !bAlready ){` |
|   84761 |  9370 | `					PH7_ClassImplement(pClass,pStringable);` |
|   42378 |  9371 | `				}` |
|   42379 |  9372 | `			}` |
|   42379 |  9373 | `		}` |
|       - |  9374 | `		/* Validate interface method signatures (visibility and parameter count) */` |
|   96415 |  9375 | `		if( rc == SXRET_OK ){` |
|   96415 |  9376 | `			sxi32 rcCheck = GenStateCheckInterfaceSignatures(&(*pGen),pClass);` |
|   96415 |  9377 | `			if( rcCheck == SXERR_ABORT ){` |
...
|   96415 |  9384 | `		if( rc == SXRET_OK ){` |
|   96415 |  9385 | `			sxi32 rcCheck = GenStateCheckAbstractMethods(&(*pGen),pClass);` |
|   96415 |  9386 | `			if( rcCheck == SXERR_ABORT ){` |
...
|   48205 |  9391 | `		}` |
|   48205 |  9392 | `	}` |
|   96415 |  9393 | `	SySetRelease(&aUseEntries);` |
|   96415 |  9394 | `	SySetRelease(&aInterfaces);` |
|   96415 |  9395 | `	if( rc != SXRET_OK ){` |
...
|   96443 |  9401 | `	pGen->pIn = &pEnd[1];` |
|   96443 |  9402 | `	pGen->pEnd = pTmp;` |
|   96443 |  9403 | `	return PH7_OK;` |
|   48225 |  9404 |  |
|       - |  9405 | `/* Compile a named class declaration (the common case). */` |
|   96414 |  9406 | `static sxi32 GenStateCompileClass(ph7_gen_state *pGen,sxi32 iFlags)` |
|       5 |  9407 |  |
|   96419 |  9408 | `	return GenStateCompileClassEx(pGen,iFlags,0,0,0);` |
|       5 |  9409 |  |
|       - |  9410 | `/*` |
...
|       - |  9499 | ` */` |
|  950388 |  9500 | `static int GenStateTokenIsClassModifier(SyToken *pTok,sxi32 *piFlag)` |
|       5 |  9501 |  |
|  950393 |  9502 | `	if( pTok->nType & PH7_TK_KEYWORD ){` |
|  630101 |  9503 | `		sxu32 nKw = (sxu32)SX_PTR_TO_INT(pTok->pUserData);` |
|  630101 |  9504 | `		if( nKw == PH7_TKWRD_FINAL ){ *piFlag = PH7_CLASS_FINAL; return TRUE; }` |
|  630083 |  9505 | `		if( nKw == PH7_TKWRD_ABSTRACT ){ *piFlag = PH7_CLASS_ABSTRACT; return TRUE; }` |
|  315016 |  9506 | `	}` |
|  950329 |  9507 | `	if( GenStateIsReadonly(pTok) ){ *piFlag = PH7_CLASS_READONLY; return TRUE; }` |
|  950269 |  9508 | `	return FALSE;` |
|  475199 |  9509 |  |
|       - |  9510 | `/*` |
...
|       - |  9515 | ` */` |
|  950264 |  9516 | `static sxi32 GenStateScanClassModifiers(SyToken **ppIn,SyToken *pEnd,SyToken **ppDup)` |
|       5 |  9517 |  |
|  950269 |  9518 | `	SyToken *pIn = *ppIn,*pDup = 0;` |
|  950269 |  9519 | `	sxi32 iFlags = 0,iFlag;` |
|  950393 |  9520 | `	while( pIn < pEnd && GenStateTokenIsClassModifier(pIn,&iFlag) ){` |
...
|     129 |  9525 | `		pIn++;` |
|       5 |  9526 | `	}` |
|  950269 |  9527 | `	*ppIn = pIn;` |
|  950269 |  9528 | `	if( ppDup ){ *ppDup = pDup; }` |
|  950269 |  9529 | `	return iFlags;` |
|       5 |  9530 |  |
|       - |  9531 | `/*` |
...
|       - |  9537 | ` */` |
|  950212 |  9538 | `static int GenStateStartsModifiedClass(SyToken *pIn,SyToken *pEnd)` |
|       5 |  9539 |  |
|  950217 |  9540 | `	sxi32 iFlags = GenStateScanClassModifiers(&pIn,pEnd,0);` |
|  475165 |  9541 | `	return iFlags != 0 && pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD)` |
|  950240 |  9542 | `		&& (sxu32)SX_PTR_TO_INT(pIn->pUserData) == PH7_TKWRD_CLASS;` |
|       5 |  9543 |  |
|       - |  9544 | `/*` |
...
|       - |  9872 | ` */` |
|   96362 |  9873 | `static sxi32 PH7_CompileClass(ph7_gen_state *pGen)` |
|       5 |  9874 |  |
|       - |  9875 | `	sxi32 rc;` |
|   96367 |  9876 | `	rc = GenStateCompileClass(&(*pGen),0);` |
|   96367 |  9877 | `	return rc;` |
|       5 |  9878 |  |
|       - |  9879 | `/*` |
...
|       - |  9900 | ` */` |
|   10886 |  9901 | `static sxi32 GenStateThrowNodeValidator(ph7_gen_state *pGen,ph7_expr_node *pRoot)` |
|       5 |  9902 |  |
|   10891 |  9903 | `	sxi32 rc = SXRET_OK;` |
|   10891 |  9904 | `	if( pRoot->pOp ){` |
|   10881 |  9905 | `		switch( pRoot->pOp->iOp ){` |
|    5438 |  9906 | `		case EXPR_OP_NEW:            /* new Exception() */` |
...
|     ! 0 |  9922 | `			break;` |
|       - |  9923 | `		}` |
|    5453 |  9924 | `	}else if( pRoot->xCode != PH7_CompileVariable ){` |
...
|       - |  9938 | ` */` |
|   10850 |  9939 | `static sxi32 PH7_CompileThrow(ph7_gen_state *pGen)` |
|       5 |  9940 |  |
|   10855 |  9941 | `	sxu32 nLine = pGen->pIn->nLine;` |
|       - |  9942 | `	GenBlock *pBlock;` |
|       - |  9943 | `	sxu32 nIdx;` |
|       - |  9944 | `	sxi32 rc;` |
|   10855 |  9945 | `	pGen->pIn++; /* Jump the 'throw' keyword */` |
|       - |  9946 | `	/* Compile the expression */` |
|   10855 |  9947 | `	rc = PH7_CompileExpr(&(*pGen),0,GenStateThrowNodeValidator);` |
|   10855 |  9948 | `	if( rc == SXERR_EMPTY ){` |
...
|       - |  9954 | `	}` |
|   10855 |  9955 | `	pBlock = pGen->pCurrent;` |
|       - |  9956 | `	/* Point to the top most function or try block and emit the forward jump */` |
|   49929 |  9957 | `	while(pBlock->pParent){` |
|   49925 |  9958 | `		if( pBlock->iFlags & (GEN_BLOCK_EXCEPTION\|GEN_BLOCK_FUNC) ){` |
|   10851 |  9959 | `			break;` |
|       - |  9960 | `		}` |
|       - |  9961 | `		/* Point to the parent block */` |
|   39079 |  9962 | `		pBlock = pBlock->pParent;` |
|       5 |  9963 | `	}` |
|       - |  9964 | `	/* Emit the throw instruction */` |
|   10855 |  9965 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_THROW,0,0,0,&nIdx);` |
|       - |  9966 | `	/* Emit the jump */` |
|   10855 |  9967 | `	GenStateNewJumpFixup(pBlock,PH7_OP_THROW,nIdx);` |
|   10855 |  9968 | `	return SXRET_OK;` |
|    5430 |  9969 |  |
|       - |  9970 | `/*` |
...
|       - | 10021 | ` */` |
|     554 | 10022 | `static sxi32 PH7_CompileCatch(ph7_gen_state *pGen,ph7_exception *pException)` |
|       5 | 10023 |  |
|     559 | 10024 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|       - | 10031 | `	char *zDup;` |
|       - | 10032 | `	sxi32 rc;` |
|     559 | 10033 | `	pGen->pIn++; /* Jump the 'catch' keyword */` |
|       - | 10034 | `	/* Zero the structure */` |
|     559 | 10035 | `	SyZero(&sCatch,sizeof(ph7_exception_block));` |
|       - | 10036 | `	/* Initialize fields */` |
|     559 | 10037 | `	SySetInit(&sCatch.aClasses,&pException->pVm->sAllocator,sizeof(SyString));` |
|     559 | 10038 | `	SySetInit(&sCatch.sByteCode,&pException->pVm->sAllocator,sizeof(VmInstr));` |
|     559 | 10039 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 /*(*/ ){` |
...
|     559 | 10054 | `	pGen->pIn++; /* Jump the left parenthesis '(' */` |
|     291 | 10055 | `	for(;;){` |
|       - | 10056 | `		SyBlob sResolved;` |
|     587 | 10057 | `		SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|     587 | 10058 | `		if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|     872 | 10074 | `		zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|     578 | 10075 | `			(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|     583 | 10076 | `		SyStringInitFromBuf(&sClassName,zDup,SyBlobLength(&sResolved));` |
|     583 | 10077 | `		SyBlobRelease(&sResolved);` |
|     583 | 10078 | `		if( zDup == 0 ){` |
|     ! 0 | 10079 | `			goto Mem;` |
|       - | 10080 | `		}` |
|     583 | 10081 | `		rc = SySetPut(&sCatch.aClasses,(const void *)&sClassName);` |
|     583 | 10082 | `		if( rc != SXRET_OK ){` |
|     ! 0 | 10083 | `			goto Mem;` |
|       - | 10084 | `		}` |
|       - | 10085 | `		/* Check for '\|' (multi-catch separator) */` |
|     592 | 10086 | `		if( pGen->pIn < pGen->pEnd &&` |
|     578 | 10087 | `			(pGen->pIn->nType & PH7_TK_OP) &&` |
...
|     555 | 10093 | `		break;` |
|     ! 0 | 10094 | `	}` |
|     825 | 10095 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 /*$*/ \|\|` |
|     555 | 10096 | `		&pGen->pIn[1] >= pGen->pEnd \|\| (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|       - | 10109 | `	}` |
|     555 | 10110 | `	pGen->pIn++; /* Jump the dollar sign */` |
|       - | 10111 | `	/* Duplicate instance name */` |
|     555 | 10112 | `	pName = &pGen->pIn->sData;` |
|     555 | 10113 | `	zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|     555 | 10114 | `	if( zDup == 0 ){` |
|     ! 0 | 10115 | `		goto Mem;` |
|       - | 10116 | `	}` |
|     555 | 10117 | `	SyStringInitFromBuf(&sCatch.sThis,zDup,pName->nByte);` |
|     555 | 10118 | `	pGen->pIn++;` |
|     555 | 10119 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_RPAREN) == 0 /*)*/ ){` |
...
|     555 | 10134 | `	pGen->pIn++; /* Jump the right parenthesis */` |
|       - | 10135 | `	/* Create the catch block */` |
|     555 | 10136 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_EXCEPTION,PH7_VmInstrLength(pGen->pVm),0,&pCatch);` |
|     555 | 10137 | `	if( rc != SXRET_OK ){` |
|     ! 0 | 10138 | `		return SXERR_ABORT;` |
|       - | 10139 | `	}` |
|       - | 10140 | `	/* Swap bytecode container */` |
|     555 | 10141 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|     555 | 10142 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&sCatch.sByteCode);` |
|       - | 10143 | `	/* Compile the block */` |
|     555 | 10144 | `	PH7_CompileBlock(&(*pGen),0);` |
|       - | 10145 | `	/* Fix forward jumps now the destination is resolved  */` |
|     555 | 10146 | `	GenStateFixJumps(pCatch,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - | 10147 | `	/* Emit the DONE instruction */` |
|     555 | 10148 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|       - | 10149 | `	/* Leave the block */` |
|     555 | 10150 | `	GenStateLeaveBlock(&(*pGen),0);` |
|       - | 10151 | `	/* Restore the default container */` |
|     555 | 10152 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|       - | 10153 | `	/* Install the catch block */` |
|     555 | 10154 | `	rc = SySetPut(&pException->sEntry,(const void *)&sCatch);` |
|     555 | 10155 | `	if( rc != SXRET_OK ){` |
|     ! 0 | 10156 | `		goto Mem;` |
|       - | 10157 | `	}` |
|     555 | 10158 | `	return SXRET_OK;` |
|     ! 0 | 10159 | `Mem:` |
...
|       - | 10168 | ` * is "thrown".` |
|       - | 10169 | ` */` |
|     592 | 10170 | `static sxi32 PH7_CompileTry(ph7_gen_state *pGen)` |
|       5 | 10171 |  |
|       - | 10172 | `	ph7_exception *pException;` |
|     597 | 10173 | `	sxu32 nLine = pGen->pIn->nLine;` |
|       - | 10174 | `	GenBlock *pTry;` |
|       - | 10175 | `	sxu32 nJmpIdx;` |
|       - | 10176 | `	sxi32 rc;` |
|       - | 10177 | `	/* Create the exception container */` |
|     597 | 10178 | `	pException = (ph7_exception *)SyMemBackendAlloc(&pGen->pVm->sAllocator,sizeof(ph7_exception));` |
|     597 | 10179 | `	if( pException == 0 ){` |
...
|     597 | 10185 | `	SyZero(pException,sizeof(ph7_exception));` |
|       - | 10186 | `	/* Initialize fields */` |
|     597 | 10187 | `	SySetInit(&pException->sEntry,&pGen->pVm->sAllocator,sizeof(ph7_exception_block));` |
|     597 | 10188 | `	SySetInit(&pException->sFinally,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|     597 | 10189 | `	pException->iHasFinally = 0;` |
|     597 | 10190 | `	pException->iFinallyDone = 0;` |
|     597 | 10191 | `	pException->pVm = pGen->pVm;` |
|       - | 10192 | `	/* Create the try block */` |
|     597 | 10193 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_EXCEPTION,PH7_VmInstrLength(pGen->pVm),0,&pTry);` |
|     597 | 10194 | `	if( rc != SXRET_OK ){` |
|     ! 0 | 10195 | `		return SXERR_ABORT;` |
|       - | 10196 | `	}` |
|       - | 10197 | `	/* Store exception pointer so break/continue can emit POP_EXCEPTION */` |
|     597 | 10198 | `	pTry->pUserData = pException;` |
|       - | 10199 | `	/* Emit the 'LOAD_EXCEPTION' instruction */` |
|     597 | 10200 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_EXCEPTION,0,0,pException,&nJmpIdx);` |
|       - | 10201 | `	/* Fix the jump later when the destination is resolved */` |
|     597 | 10202 | `	GenStateNewJumpFixup(pTry,PH7_OP_LOAD_EXCEPTION,nJmpIdx);` |
|     597 | 10203 | `	pGen->pIn++; /* Jump the 'try' keyword */` |
|       - | 10204 | `	/* Compile the block */` |
|     597 | 10205 | `	rc = PH7_CompileBlock(&(*pGen),0);` |
|     597 | 10206 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 | 10207 | `		return SXERR_ABORT;` |
|       - | 10208 | `	}` |
|       - | 10209 | `	/* Fix forward jumps now the destination is resolved */` |
|     597 | 10210 | `	GenStateFixJumps(pTry,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - | 10211 | `	/* Emit the 'POP_EXCEPTION' instruction */` |
|     597 | 10212 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP_EXCEPTION,0,0,pException,0);` |
|       - | 10213 | `	/* Leave the block */` |
|     597 | 10214 | `	GenStateLeaveBlock(&(*pGen),0);` |
|       - | 10215 | `	/* Compile catch block(s) — at least one catch or finally is required */` |
|     597 | 10216 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|     590 | 10217 | `		SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_CATCH ){` |
|       - | 10218 | `		/* Compile one or more catch blocks */` |
|     550 | 10219 | `		for(;;){` |
|    1100 | 10220 | `			if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0` |
|     888 | 10221 | `				\|\| SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_CATCH ){` |
|     278 | 10222 | `					break;` |
|       - | 10223 | `			}` |
|     559 | 10224 | `			rc = PH7_CompileCatch(&(*pGen),pException);` |
|     559 | 10225 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 | 10226 | `				return SXERR_ABORT;` |
|       - | 10227 | `			}` |
|       5 | 10228 | `		}` |
|     273 | 10229 | `	}` |
|       - | 10230 | `	/* Compile optional finally block */` |
|     597 | 10231 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|     322 | 10232 | `		SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_FINALLY ){` |
...
|     597 | 10261 | `	if( SySetUsed(&pException->sEntry) == 0 && !pException->iHasFinally ){` |
...
|       - | 10624 | ` */` |
| 2574340 | 10625 | `static void GenStatePatchNullsafeJumps(ph7_gen_state *pGen, sxu32 nBaseline)` |
|       5 | 10626 |  |
| 2574345 | 10627 | `	sxu32 nCur = SySetUsed(&pGen->aNullsafeJmp);` |
|       - | 10628 | `	sxu32 nTarget;` |
|       - | 10629 | `	sxu32 *aIdx;` |
|       - | 10630 | `	sxu32 i;` |
| 2574345 | 10631 | `	if( nCur <= nBaseline ){` |
| 2574251 | 10632 | `		return;` |
|       - | 10633 | `	}` |
...
|       - | 10661 | ` */` |
|  418748 | 10662 | `static sxu32 GenStateByRefBuiltinMask(SyString *pName)` |
|       5 | 10663 |  |
...
|       - | 10673 | `	};` |
|       - | 10674 | `	sxu32 i;` |
|  418753 | 10675 | `	if( pName == 0 \|\| pName->zString == 0 \|\| pName->nByte == 0 ){` |
|    1337 | 10676 | `		return 0;` |
|       - | 10677 | `	}` |
| 2086865 | 10678 | `	for( i = 0 ; i < SX_ARRAYSIZE(aByRef) ; ++i ){` |
| 1669512 | 10679 | `		if( pName->nByte == aByRef[i].nByte` |
|  856817 | 10680 | `		 && SyStrnicmp(pName->zString, aByRef[i].zName, pName->nByte) == 0 ){` |
|      73 | 10681 | `			return aByRef[i].mask;` |
|       - | 10682 | `		}` |
|  834727 | 10683 | `	}` |
|  417353 | 10684 | `	return 0;` |
|  209379 | 10685 |  |
|       - | 10686 | `/*` |
...
|       - | 10695 | ` */` |
|  418748 | 10696 | `static void GenStateCallBuiltinName(ph7_expr_node *pLeft, SyString *pOut)` |
|       5 | 10697 |  |
|       - | 10698 | `	SyToken *p, *pEnd;` |
|  418753 | 10699 | `	pOut->zString = 0;` |
|  418753 | 10700 | `	pOut->nByte = 0;` |
|  418753 | 10701 | `	if( pLeft == 0 \|\| pLeft->pStart == 0 \|\| pLeft->pEnd == 0 ){` |
|     ! 0 | 10702 | `		return;` |
|       - | 10703 | `	}` |
|  418753 | 10704 | `	p = pLeft->pStart;` |
|  418753 | 10705 | `	pEnd = pLeft->pEnd;` |
|       - | 10706 | `	/* Optional single leading namespace separator (absolute path). */` |
|  418753 | 10707 | `	if( p < pEnd && (p->nType & PH7_TK_NSSEP) ){` |
|      26 | 10708 | `		p++;` |
|      11 | 10709 | `	}` |
|  418753 | 10710 | `	if( p >= pEnd \|\| (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|    1309 | 10711 | `		return;` |
|       - | 10712 | `	}` |
|       - | 10713 | `	/* Must be a single component: nothing follows the name token. */` |
|  417449 | 10714 | `	if( p + 1 != pEnd ){` |
|      32 | 10715 | `		return;` |
|       - | 10716 | `	}` |
|  417421 | 10717 | `	*pOut = p->sData;` |
|  209379 | 10718 |  |
|       - | 10719 | `/*` |
...
|       - | 10724 | ` * error message.` |
|       - | 10725 | ` */` |
| 3470374 | 10726 | `static sxi32 GenStateEmitExprCode(` |
...
|       - | 10733 | `	sxu32 nJmpIdx;` |
| 3470379 | 10734 | `	sxi32 iP1 = 0;` |
| 3470379 | 10735 | `	sxu32 iP2 = 0;` |
| 3470379 | 10736 | `	void *p3  = 0;` |
|       - | 10737 | `	sxi32 iVmOp;` |
|       - | 10738 | `	sxi32 rc;` |
| 3470379 | 10739 | `	int bIsChainOp = 0; /* Set below once we know pNode->pOp */` |
| 3470379 | 10740 | `	sxu32 nRhsNsBase = 0;` |
| 3470379 | 10741 | `	if( pNode->xCode ){` |
|       - | 10742 | `		SyToken *pTmpIn,*pTmpEnd;` |
|       - | 10743 | `		/* Compile node */` |
| 2149501 | 10744 | `		SWAP_DELIMITER(pGen,pNode->pStart,pNode->pEnd);` |
| 2149501 | 10745 | `		rc = pNode->xCode(&(*pGen),iFlags);` |
| 2149501 | 10746 | `		RE_SWAP_DELIMITER(pGen);` |
| 2149501 | 10747 | `		return rc;` |
|       - | 10748 | `	}` |
| 1320883 | 10749 | `	if( pNode->pOp == 0 ){` |
...
|       - | 10753 | `	}` |
| 1320883 | 10754 | `	iVmOp = pNode->pOp->iVmOp;` |
| 1320883 | 10755 | `	if( pNode->pOp->iOp == EXPR_OP_NULLC_ASSIGN ){` |
...
|       - | 10804 | `	}` |
| 1320827 | 10805 | `	if( pNode->pOp->iOp == EXPR_OP_QUESTY ){` |
...
|       - | 10867 | `	}` |
| 1318181 | 10868 | `	bIsChainOp = GEN_IS_CHAIN_OP(pNode->pOp->iOp);` |
|       - | 10869 | `	/* Generate code for the left tree */` |
| 1318181 | 10870 | `	if( pNode->pLeft ){` |
| 1318143 | 10871 | `		sxu32 nLhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
| 1318143 | 10872 | `		if( iVmOp == PH7_OP_CALL ){` |
|       - | 10873 | `			ph7_expr_node **apNode;` |
|  418873 | 10874 | `			int hasSpread = 0;` |
|  418873 | 10875 | `			int hasNamed = 0;` |
|  418873 | 10876 | `			int bAnySpread = 0;` |
|  418873 | 10877 | `			sxu32 byRefMask = 0;` |
|       - | 10878 | `			sxi32 nArgs;` |
|       - | 10879 | `			sxi32 n;` |
|       - | 10880 | `			/* Recurse and generate bytecodes for function arguments */` |
|  418873 | 10881 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  418873 | 10882 | `			nArgs = (sxi32)SySetUsed(&pNode->aNodeArgs);` |
|       - | 10883 | `			/* Validate: no positional arguments after named arguments */` |
|       - | 10884 | `			{` |
|  418873 | 10885 | `				int seenNamed = 0;` |
|  829313 | 10886 | `				for( n = 0; n < nArgs; ++n ){` |
|  410447 | 10887 | `					if( apNode[n]->iFlags & EXPR_NODE_NAMED_ARG ){` |
|     188 | 10888 | `						seenNamed = 1;` |
|     188 | 10889 | `						hasNamed = 1;` |
|  410355 | 10890 | `					}else if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
|      23 | 10891 | `						bAnySpread = 1;` |
|  410253 | 10892 | `					}else if( seenNamed ){` |
...
|  418871 | 10900 | `			iFlags \|= EXPR_FLAG_RDONLY_LOAD;` |
...
|  418871 | 10905 | `			if( pNode->pLeft && pNode->pLeft->pStart ){` |
|  418871 | 10906 | `				SyString *pCallName = &pNode->pLeft->pStart->sData;` |
|  418866 | 10907 | `				if( pCallName->nByte == 5` |
|  229832 | 10908 | `				 && SyStrnicmp(pCallName->zString,"isset",5) == 0 ){` |
|   21471 | 10909 | `					iFlags \|= EXPR_FLAG_LOAD_IDX_ISSET;` |
|  408138 | 10910 | `				}else if( pCallName->nByte == 5` |
|  208366 | 10911 | `				 && SyStrnicmp(pCallName->zString,"empty",5) == 0 ){` |
...
|  418871 | 10920 | `				if( !bAnySpread && !hasNamed ){` |
|       - | 10921 | `					SyString sBuiltin;` |
|  418753 | 10922 | `					GenStateCallBuiltinName(pNode->pLeft, &sBuiltin);` |
|  418753 | 10923 | `					byRefMask = GenStateByRefBuiltinMask(&sBuiltin);` |
|  209374 | 10924 | `				}` |
|  209433 | 10925 | `			}` |
|  829309 | 10926 | `			for( n = 0 ; n < nArgs ; ++n ){` |
|  410443 | 10927 | `				sxu32 nArgNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  410443 | 10928 | `				sxi32 iArgFlags = iFlags & ~EXPR_FLAG_LOAD_IDX_STORE;` |
...
|  410443 | 10935 | `				if( n < 31 && (byRefMask & (1u<<n)) ){` |
|      53 | 10936 | `					iArgFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|      53 | 10937 | `					iArgFlags \|= EXPR_FLAG_LOAD_IDX_STORE;` |
|      24 | 10938 | `				}` |
|  410443 | 10939 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iArgFlags);` |
|  410443 | 10940 | `				if( rc != SXRET_OK ){` |
|     ! 0 | 10941 | `					return rc;` |
|       - | 10942 | `				}` |
|       - | 10943 | `				/* Each argument is an independent nullsafe scope. */` |
|  410443 | 10944 | `				GenStatePatchNullsafeJumps(pGen, nArgNsBase);` |
|  410443 | 10945 | `				if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
...
|  418871 | 10988 | `			iFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|  209433 | 10989 | `		}` |
| 1318141 | 10990 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pLeft,iFlags);` |
| 1318141 | 10991 | `		if( rc != SXRET_OK ){` |
|      34 | 10992 | `			return rc;` |
|       - | 10993 | `		}` |
| 1318111 | 10994 | `		if( !bIsChainOp ){` |
...
|  615283 | 10997 | `			GenStatePatchNullsafeJumps(pGen, nLhsNsBase);` |
|  307639 | 10998 | `		}` |
| 1318111 | 10999 | `		if( iVmOp == PH7_OP_CALL ){` |
|  418871 | 11000 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|  418871 | 11001 | `			if( pInstr ){` |
|  418871 | 11002 | `				if ( pInstr->iOp == PH7_OP_LOADC ){` |
|  417543 | 11003 | `					sxu32 nOrig = (sxu32)pInstr->iP2;` |
|       - | 11004 | `					sxu32 nQual;` |
|  417543 | 11005 | `					int bAbsolute = (pInstr->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|       - | 11006 | `					/* Prevent constant expansion but preserve the absolute flag` |
|       - | 11007 | `					 * so the later NEW handler (if any) can see it. */` |
|  417543 | 11008 | `					pInstr->iP1 &= ~PH7_LOADC_EXPAND;` |
...
|  417543 | 11016 | `					if( bAbsolute ){` |
|      26 | 11017 | `						pInstr->iP2 = (sxi32)nOrig;` |
|      15 | 11018 | `					}else{` |
|  417521 | 11019 | `						int fromImport = 0;` |
|  417521 | 11020 | `						nQual = GenStateNsQualifyName(pGen,nOrig,&pGen->hUseFuncImports,&fromImport);` |
|  417521 | 11021 | `						pInstr->iP2 = (sxi32)nQual;` |
|  417521 | 11022 | `						if( nQual != nOrig ){` |
...
|      36 | 11040 | `						}` |
|       5 | 11041 | `					}` |
|  210102 | 11042 | `				}else if( pInstr->iOp == PH7_OP_MEMBER /* $a->b(1,2,3) */ \|\| pInstr->iOp == PH7_OP_NEW ){` |
|       - | 11043 | `					/* Method call,flag that */` |
|    1053 | 11044 | `					pInstr->iP2 = 1;` |
|     524 | 11045 | `				}` |
|  209438 | 11046 | `			}` |
| 1108678 | 11047 | `		}else if( iVmOp == PH7_OP_LOAD_IDX ){` |
|       - | 11048 | `			ph7_expr_node **apNode;` |
|       - | 11049 | `			sxi32 n;` |
|   90787 | 11050 | `			sxi32 iChildMask = ~(EXPR_FLAG_LOAD_IDX_STORE` |
...
|   90787 | 11054 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  163835 | 11055 | `			for( n = 0 ; n < (sxi32)SySetUsed(&pNode->aNodeArgs) ; ++n ){` |
|   73053 | 11056 | `				sxu32 nIdxNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|   73053 | 11057 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iFlags&iChildMask);` |
|   73053 | 11058 | `				if( rc != SXRET_OK ){` |
|     ! 0 | 11059 | `					return rc;` |
|       - | 11060 | `				}` |
|       - | 11061 | `				/* Each subscript index is an independent nullsafe scope. */` |
|   73053 | 11062 | `				GenStatePatchNullsafeJumps(pGen, nIdxNsBase);` |
|   36529 | 11063 | `			}` |
|   90787 | 11064 | `			if( SySetUsed(&pNode->aNodeArgs) > 0 ){` |
|   73053 | 11065 | `				iP1 = 1; /* Node have an index associated with it */` |
|   36524 | 11066 | `			}` |
|   90787 | 11067 | `			if( iFlags & EXPR_FLAG_LOAD_IDX_ISSET ){` |
|       - | 11068 | `				/* offsetExists for ArrayAccess; peek-only for arrays */` |
|     243 | 11069 | `				iP2 = 4;` |
|   90668 | 11070 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_UNSET ){` |
|       - | 11071 | `				/* offsetUnset for ArrayAccess; auto-vivify+load for arrays` |
|       - | 11072 | `				 * so the trailing unset() builtin can drop the slot. */` |
|      54 | 11073 | `				iP2 = 5;` |
|   90524 | 11074 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_EMPTY ){` |
...
|      29 | 11078 | `				iP2 = 6;` |
|   90487 | 11079 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_STORE ){` |
|       - | 11080 | `				/* Create an empty entry when the desired index is not found */` |
|   35769 | 11081 | `				iP2 = 1;` |
|   17887 | 11082 | `			}` |
|  853854 | 11083 | `		}else if( pNode->pOp->iOp == EXPR_OP_COMMA ){` |
|       - | 11084 | `			/* POP the left node */` |
|      32 | 11085 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|      15 | 11086 | `		}` |
|  659053 | 11087 | `	}` |
| 1318149 | 11088 | `	rc = SXRET_OK;` |
| 1318149 | 11089 | `	nJmpIdx = 0;` |
...
| 1318149 | 11093 | `	if( iVmOp == PH7_OP_MEMBER && pNode->pOp->iOp == EXPR_OP_DC ){` |
...
| 1318071 | 11123 | `	if( pNode->pRight ){` |
|  727429 | 11124 | `		if( iVmOp == PH7_OP_LAND ){` |
|       - | 11125 | `			/* Emit the false jump so we can short-circuit the logical and */` |
|   11079 | 11126 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,1/* Keep the value on the stack */,0,0,&nJmpIdx);` |
|  721892 | 11127 | `		}else if (iVmOp == PH7_OP_LOR ){` |
|       - | 11128 | `			/* Emit the true jump so we can short-circuit the logical or*/` |
|    3711 | 11129 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JNZ,1/* Keep the value on the stack */,0,0,&nJmpIdx);` |
|  714502 | 11130 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLC ){` |
...
|  712638 | 11134 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW ){` |
...
|  712474 | 11144 | `		}else if( pNode->pOp->iPrec == 18 /* Combined binary operators [i.e: =,'.=','+=',*=' ...] precedence */ ){` |
|  295309 | 11145 | `			iFlags \|= EXPR_FLAG_LOAD_IDX_STORE;` |
|  147652 | 11146 | `		}` |
|  727429 | 11147 | `		nRhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  727429 | 11148 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pRight,iFlags);` |
|  727429 | 11149 | `		if( !bIsChainOp ){` |
|       - | 11150 | `			/* Non-chain parent: RHS nullsafe chain ends here, before the` |
|       - | 11151 | `			 * operator instruction is emitted. */` |
|  534291 | 11152 | `			GenStatePatchNullsafeJumps(pGen, nRhsNsBase);` |
|  267143 | 11153 | `		}` |
|  727429 | 11154 | `		if( iVmOp == PH7_OP_STORE ){` |
|  291523 | 11155 | `			if( pNode->pRight && (pNode->pRight->xCode == PH7_CompileList \|\|` |
|  291492 | 11156 | `				pNode->pRight->xCode == PH7_CompileShortList) ){` |
...
|       - | 11162 | `				 */` |
|      74 | 11163 | `				iVmOp = 0;` |
|  291488 | 11164 | `			}else if( (pInstr = PH7_VmPeekInstr(pGen->pVm)) != 0 ){` |
|  291453 | 11165 | `				if(pInstr->iOp == PH7_OP_MEMBER ){` |
|       - | 11166 | `					/* Perform a member store operation [i.e: $this->x = 50] */` |
|   81593 | 11167 | `					iP2 = 1;` |
|   40799 | 11168 | `				}else{` |
|  209865 | 11169 | `					if( pInstr->iOp == PH7_OP_LOAD_IDX ){` |
|       - | 11170 | `						/* Transform the STORE instruction to STORE_IDX instruction */` |
|   35697 | 11171 | `						iVmOp = PH7_OP_STORE_IDX;` |
|   35697 | 11172 | `						iP1 = pInstr->iP1;` |
|   17851 | 11173 | `					}else{` |
|  174173 | 11174 | `						p3 = pInstr->p3;` |
|       - | 11175 | `					}` |
|       - | 11176 | `					/* POP the last dynamic load instruction */` |
|  209865 | 11177 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|       - | 11178 | `				}` |
|  145729 | 11179 | `			}` |
|  581670 | 11180 | `		}else if( iVmOp == PH7_OP_STORE_REF ){` |
...
|      26 | 11195 | `		}` |
|  363712 | 11196 | `	}` |
| 1318066 | 11197 | `	if( iVmOp == PH7_OP_NEW && pNode->pLeft && pNode->pLeft->pOp == 0` |
|    9610 | 11198 | `		&& pNode->pLeft->xCode == PH7_CompileAnnonClass ){` |
...
|      29 | 11201 | `		iVmOp = 0;` |
|      13 | 11202 | `	}` |
| 1318071 | 11203 | `	if( iVmOp > 0 ){` |
| 1317821 | 11204 | `		if( iVmOp == PH7_OP_INCR \|\| iVmOp == PH7_OP_DECR ){` |
|   14509 | 11205 | `			if( pNode->iFlags & EXPR_NODE_PRE_INCR ){` |
|       - | 11206 | `				/* Pre-increment/decrement operator [i.e: ++$i,--$j ] */` |
|   10609 | 11207 | `				iP1 = 1;` |
|    5307 | 11208 | `			}` |
| 1310569 | 11209 | `		}else if( iVmOp == PH7_OP_NEW ){` |
|       - | 11210 | `			/* Namespace-qualify the class name for NEW */ {` |
|   19031 | 11211 | `				VmInstr *pPeek = PH7_VmPeekInstr(pGen->pVm);` |
|   19031 | 11212 | `				VmInstr *pCallInstr = 0;` |
|   19031 | 11213 | `				if( pPeek && pPeek->iOp == PH7_OP_CALL ){` |
|   18899 | 11214 | `					pCallInstr = pPeek;` |
|   18899 | 11215 | `					pPeek = PH7_VmPeekNextInstr(pGen->pVm);` |
|    9447 | 11216 | `				}` |
|   19031 | 11217 | `				if( pPeek && pPeek->iOp == PH7_OP_LOADC ){` |
|   19029 | 11218 | `					int bAbsolute = (pPeek->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
...
|   19029 | 11223 | `					if( pCallInstr && pCallInstr->iP2 > 0 ){` |
|      37 | 11224 | `						nLitForClass = (sxu32)(pCallInstr->iP2 - 1); /* undo +1 encoding */` |
|      21 | 11225 | `					}else{` |
|   18997 | 11226 | `						nLitForClass = (sxu32)pPeek->iP2;` |
|       - | 11227 | `					}` |
|   19029 | 11228 | `					pPeek->iP1 = 0;` |
|   19029 | 11229 | `					if( !bAbsolute ){` |
|   19011 | 11230 | `						pPeek->iP2 = (sxi32)GenStateNsQualifyName(pGen,nLitForClass,&pGen->hUseImports,0);` |
|    9508 | 11231 | `					}else{` |
|      22 | 11232 | `						pPeek->iP2 = (sxi32)nLitForClass;` |
|       - | 11233 | `					}` |
|    9512 | 11234 | `				}` |
|       - | 11235 | `			}` |
|   19031 | 11236 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|   19031 | 11237 | `			if( pInstr && pInstr->iOp == PH7_OP_CALL ){` |
|       - | 11238 | `				VmInstr *pPrev;` |
|   18899 | 11239 | `				pPrev = PH7_VmPeekNextInstr(pGen->pVm);` |
|   18899 | 11240 | `				if( pPrev == 0 \|\| pPrev->iOp != PH7_OP_MEMBER ){` |
|       - | 11241 | `					/* Pop the call instruction, preserve named-arg map */` |
|   18899 | 11242 | `					iP1 = pInstr->iP1;` |
|   18899 | 11243 | `					if( pInstr->p3 ){` |
|      43 | 11244 | `						p3 = pInstr->p3; /* Transfer VmCallArgMap to NEW */` |
|      19 | 11245 | `					}` |
|   18899 | 11246 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|    9447 | 11247 | `				}` |
|    9452 | 11248 | `			}` |
| 1293804 | 11249 | `		}else if( iVmOp == PH7_OP_IS_A ){` |
...
|      72 | 11269 | `				}` |
|      86 | 11270 | `			}` |
| 1284212 | 11271 | `		}else if( iVmOp == PH7_OP_MEMBER){` |
...
|  193143 | 11275 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|  193143 | 11276 | `			if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|  193101 | 11277 | `				pInstr->iP1 = 0;` |
|   96548 | 11278 | `			}` |
|  193143 | 11279 | `			if( pNode->pOp->iOp == EXPR_OP_DC /* '::' */){` |
...
| 1317819 | 11291 | `		if( iVmOp == PH7_OP_CALL \|\| iVmOp == PH7_OP_NEW ){` |
|  437897 | 11292 | `			p3 = GenStateAttachStrictFlag(pGen,p3);` |
|  218946 | 11293 | `		}` |
|       - | 11294 | `		/* Finally,emit the VM instruction associated with this operator */` |
| 1317819 | 11295 | `		PH7_VmEmitInstr(pGen->pVm,iVmOp,iP1,iP2,p3,0);` |
|  658907 | 11296 | `	}` |
| 1318069 | 11297 | `	if( nJmpIdx > 0 ){` |
|       - | 11298 | `		/* Fix short-circuited jumps now the destination is resolved */` |
|   14909 | 11299 | `		pInstr = PH7_VmGetInstr(pGen->pVm,nJmpIdx);` |
|   14909 | 11300 | `		if( pInstr ){` |
|   14909 | 11301 | `			pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    7452 | 11302 | `		}` |
|    7452 | 11303 | `	}` |
| 1318069 | 11304 | `	return rc;` |
| 1735173 | 11305 |  |
|       - | 11306 | `/*` |
...
|       - | 11315 | ` * message.` |
|       - | 11316 | ` */` |
|  933500 | 11317 | `static sxi32 PH7_CompileExpr(` |
...
|  933505 | 11331 | `	nExpr = 0;` |
|  933505 | 11332 | `	pRoot = 0;` |
...
|  933505 | 11335 | `	nNullsafeBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  933505 | 11336 | `	SySetInit(&sExprNode,&pGen->pVm->sAllocator,sizeof(ph7_expr_node *));` |
|  933505 | 11337 | `	SySetAlloc(&sExprNode,0x10);` |
|  933505 | 11338 | `	rc = SXRET_OK;` |
|       - | 11339 | `	/* Delimit the expression */` |
|  933505 | 11340 | `	pEnd = pGen->pIn;` |
|  933505 | 11341 | `	iNest = 0;` |
| 6245765 | 11342 | `	while( pEnd < pGen->pEnd ){` |
| 5927941 | 11343 | `		if( pEnd->nType & PH7_TK_OCB /* '{' */ ){` |
|       - | 11344 | `			/* Ticket 1433-30: Annonymous/Closure functions body */` |
|     475 | 11345 | `			iNest++;` |
| 5927706 | 11346 | `		}else if(pEnd->nType & PH7_TK_CCB /* '}' */ ){` |
|     483 | 11347 | `			iNest--;` |
| 5927232 | 11348 | `		}else if( pEnd->nType & PH7_TK_SEMI /* ';' */ ){` |
|  616017 | 11349 | `			if( iNest <= 0 ){` |
|  615681 | 11350 | `				break;` |
|       - | 11351 | `			}` |
|     168 | 11352 | `		}` |
| 5312265 | 11353 | `		pEnd++;` |
|       5 | 11354 | `	}` |
|  933505 | 11355 | `	if( iFlags & EXPR_FLAG_COMMA_STATEMENT ){` |
|   21713 | 11356 | `		SyToken *pEnd2 = pGen->pIn;` |
|   21713 | 11357 | `		iNest = 0;` |
|       - | 11358 | `		/* Stop at the first comma */` |
|   43715 | 11359 | `		while( pEnd2 < pEnd ){` |
|   22013 | 11360 | `			if( pEnd2->nType & (PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*'['*/\|PH7_TK_LPAREN/*'('*/) ){` |
|      67 | 11361 | `				iNest++;` |
|   21982 | 11362 | `			}else if(pEnd2->nType & (PH7_TK_CCB/*'}'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_RPAREN/*')'*/)){` |
|      67 | 11363 | `				iNest--;` |
|   21920 | 11364 | `			}else if( pEnd2->nType & PH7_TK_COMMA /*','*/ ){` |
|      57 | 11365 | `				if( iNest <= 0 ){` |
|       7 | 11366 | `					break;` |
|       - | 11367 | `				}` |
|      23 | 11368 | `			}` |
|   22007 | 11369 | `			pEnd2++;` |
|       5 | 11370 | `		}` |
|   21713 | 11371 | `		if( pEnd2 <pEnd ){` |
|       7 | 11372 | `			pEnd = pEnd2;` |
|       3 | 11373 | `		}` |
|   10854 | 11374 | `	}` |
|  933505 | 11375 | `	if( pEnd > pGen->pIn ){` |
|  933495 | 11376 | `		SyToken *pTmp = pGen->pEnd;` |
|       - | 11377 | `		/* Swap delimiter */` |
|  933495 | 11378 | `		pGen->pEnd = pEnd;` |
|       - | 11379 | `		/* Try to get an expression tree */` |
|  933495 | 11380 | `		rc = PH7_ExprMakeTree(&(*pGen),&sExprNode,&pRoot);` |
|  933495 | 11381 | `		if( rc == SXRET_OK && pRoot ){` |
|  933313 | 11382 | `			rc = SXRET_OK;` |
|  933313 | 11383 | `			if( xTreeValidator ){` |
|       - | 11384 | `				/* Call the upper layer validator callback */` |
|   25537 | 11385 | `				rc = xTreeValidator(&(*pGen),pRoot);` |
|   12766 | 11386 | `			}` |
|  933313 | 11387 | `			if( rc != SXERR_ABORT ){` |
|       - | 11388 | `				/* Generate code for the given tree */` |
|  933313 | 11389 | `				rc = GenStateEmitExprCode(&(*pGen),pRoot,iFlags);` |
|       - | 11390 | `				/* Patch any unresolved nullsafe jumps emitted by this` |
|       - | 11391 | `				 * expression so they short-circuit to its end. */` |
|  933313 | 11392 | `				GenStatePatchNullsafeJumps(pGen, nNullsafeBase);` |
|  466654 | 11393 | `			}` |
|  933313 | 11394 | `			nExpr = 1;` |
|  466654 | 11395 | `		}` |
|       - | 11396 | `		/* Release the whole tree */` |
|  933495 | 11397 | `		PH7_ExprFreeTree(&(*pGen),&sExprNode);` |
|       - | 11398 | `		/* Synchronize token stream */` |
|  933495 | 11399 | `		pGen->pEnd = pTmp;` |
|  933495 | 11400 | `		pGen->pIn  = pEnd;` |
|  933495 | 11401 | `		if( rc == SXERR_ABORT ){` |
|      12 | 11402 | `			SySetRelease(&sExprNode);` |
|      12 | 11403 | `			return SXERR_ABORT;` |
|       - | 11404 | `		}` |
|  466740 | 11405 | `	}` |
|  933495 | 11406 | `	SySetRelease(&sExprNode);` |
|  933495 | 11407 | `	return nExpr > 0 ? SXRET_OK : SXERR_EMPTY;` |
|  466755 | 11408 |  |
|       - | 11409 | `/*` |
|       - | 11410 | ` * Return a pointer to the node construct handler associated` |
|       - | 11411 | ` * with a given node type [i.e: string,integer,float,...].` |
|       - | 11412 | ` */` |
|  236282 | 11413 | `PH7_PRIVATE ProcNodeConstruct PH7_GetNodeHandler(sxu32 nNodeType)` |
|       5 | 11414 |  |
|  236287 | 11415 | `	if( nNodeType & PH7_TK_NUM ){` |
|       - | 11416 | `		/* Numeric literal: Either real or integer */` |
|  124403 | 11417 | `		return PH7_CompileNumLiteral;` |
|  111889 | 11418 | `	}else if( nNodeType & PH7_TK_DSTR ){` |
|       - | 11419 | `		/* Double quoted string */` |
|   22805 | 11420 | `		return PH7_CompileString;` |
|   89089 | 11421 | `	}else if( nNodeType & PH7_TK_SSTR ){` |
|       - | 11422 | `		/* Single quoted string */` |
|   88973 | 11423 | `		return PH7_CompileSimpleString;` |
...
|       - | 11551 | ` */` |
|  629932 | 11552 | `static ProcLangConstruct GenStateGetStatementHandler(` |
|       - | 11553 | `	sxu32 nKeywordID,   /* Keyword  ID*/` |
|       - | 11554 | `	SyToken *pLookahed  /* Look-ahead token */` |
|       - | 11555 | `	)` |
|       5 | 11556 |  |
|  629937 | 11557 | `	sxu32 n = 0;` |
| 3254447 | 11558 | `	for(;;){` |
| 6508899 | 11559 | `		if( n >= SX_ARRAYSIZE(aLangConstruct) ){` |
|  135581 | 11560 | `			break;` |
|       - | 11561 | `		}` |
| 6373323 | 11562 | `		if( aLangConstruct[n].nID == nKeywordID ){` |
|  494361 | 11563 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed && (pLookahed->nType & PH7_TK_OP)){` |
...
|       - | 11568 | `				}` |
|     ! 0 | 11569 | `			}` |
|  494356 | 11570 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed` |
...
|       - | 11577 | `			*/` |
|  494361 | 11578 | `			return aLangConstruct[n].xConstruct;` |
|       - | 11579 | `		}` |
| 5878967 | 11580 | `		n++;` |
|       5 | 11581 | `	}` |
|  135581 | 11582 | `	if( pLookahed ){` |
|  135581 | 11583 | `		if(nKeywordID == PH7_TKWRD_INTERFACE && (pLookahed->nType & PH7_TK_ID) ){` |
|   38885 | 11584 | `			return PH7_CompileClassInterface;` |
|   96701 | 11585 | `		}else if(nKeywordID == PH7_TKWRD_CLASS && (pLookahed->nType & PH7_TK_ID) ){` |
|   96367 | 11586 | `			return PH7_CompileClass;` |
|     339 | 11587 | `		}else if(nKeywordID == PH7_TKWRD_TRAIT && (pLookahed->nType & PH7_TK_ID) ){` |
...
|       - | 11601 | ` */` |
|     274 | 11602 | `static int GenStateisLangConstruct(sxu32 nKeyword)` |
|       5 | 11603 |  |
|       - | 11604 | `	int rc;` |
|     279 | 11605 | `	rc = PH7_IsLangConstruct(nKeyword,TRUE);` |
|     279 | 11606 | `	if( rc == FALSE ){` |
|     164 | 11607 | `		if( nKeyword == PH7_TKWRD_SELF \|\| nKeyword == PH7_TKWRD_PARENT \|\| nKeyword == PH7_TKWRD_STATIC` |
|     163 | 11608 | `			\|\| nKeyword == PH7_TKWRD_YIELD` |
...
|       - | 11624 | ` */` |
|  754578 | 11625 | `static sxi32 GenStateCompileChunk(` |
...
|       - | 11631 | `	sxi32 rc;` |
|  754583 | 11632 | `	rc = SXRET_OK; /* Prevent compiler warning */` |
|  587087 | 11633 | `	for(;;){` |
|  964381 | 11634 | `		int bStmtIsDeclare = 0;` |
|  964381 | 11635 | `		if( pGen->pIn >= pGen->pEnd ){` |
...
|  950233 | 11641 | `		if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|  629963 | 11642 | `			sxu32 nPeek = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  629963 | 11643 | `			if( nPeek == PH7_TKWRD_DECLARE ){` |
|      45 | 11644 | `				bStmtIsDeclare = 1;` |
|      20 | 11645 | `			}` |
|  314979 | 11646 | `		}` |
|  950233 | 11647 | `		if( !bStmtIsDeclare && pGen->pCurrent == &pGen->sGlobal ){` |
...
|  209773 | 11650 | `			pGen->bStrictTypesLocked = 1;` |
|  104884 | 11651 | `		}` |
|  950233 | 11652 | `		if( pGen->pIn->nType & PH7_TK_OCB /* '{' */ ){` |
|       - | 11653 | `			/* Compile block */` |
...
|       - | 11657 | `			}` |
|      13 | 11658 | `		}else{` |
|  950217 | 11659 | `			xCons = 0;` |
|  950217 | 11660 | `			if( GenStateStartsModifiedClass(pGen->pIn,pGen->pEnd) ){` |
...
|  950191 | 11665 | `			}else if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|  629937 | 11666 | `				sxu32 nKeyword = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|       - | 11667 | `				/* Try to extract a language construct handler */` |
|  629937 | 11668 | `				xCons = GenStateGetStatementHandler(nKeyword,(&pGen->pIn[1] < pGen->pEnd) ? &pGen->pIn[1] : 0);` |
|  629937 | 11669 | `				if( xCons == 0 && GenStateisLangConstruct(nKeyword) == FALSE ){` |
...
|       4 | 11680 | `				}` |
|  635199 | 11681 | `			}else if( (pGen->pIn->nType & PH7_TK_ID) && (&pGen->pIn[1] < pGen->pEnd)` |
|   52501 | 11682 | `				&& (pGen->pIn[1].nType & PH7_TK_COLON /*':'*/) ){` |
|       - | 11683 | `				/* Label found [i.e: Out: ],point to the routine responsible of compiling it */` |
|     117 | 11684 | `				xCons = PH7_CompileLabel;` |
|      56 | 11685 | `			}` |
|  950217 | 11686 | `			if( xCons == 0 ){` |
|       - | 11687 | `				/* Assume an expression an try to compile it */` |
|  320387 | 11688 | `				rc = PH7_CompileExpr(&(*pGen),0,0);` |
|  320387 | 11689 | `				if(  rc != SXERR_EMPTY ){` |
|       - | 11690 | `					/* Pop l-value */` |
|  320237 | 11691 | `					PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|  160116 | 11692 | `				}` |
|  160196 | 11693 | `			}else{` |
|       - | 11694 | `				/* Go compile the sucker */` |
|  629835 | 11695 | `				rc = xCons(&(*pGen));` |
|       - | 11696 | `			}` |
|  950217 | 11697 | `			if( rc == SXERR_ABORT ){` |
|       - | 11698 | `				/* Request to abort compilation */` |
|      12 | 11699 | `				break;` |
|       - | 11700 | `			}` |
|       - | 11701 | `		}` |
|       - | 11702 | `		/* Ignore trailing semi-colons ';' */` |
| 1537103 | 11703 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|  586885 | 11704 | `			pGen->pIn++;` |
|       5 | 11705 | `		}` |
|  950223 | 11706 | `		if( iFlags & PH7_COMPILE_SINGLE_STMT ){` |
...
|       - | 11722 | ` */` |
|   14160 | 11723 | `static sxi32 PH7_CompilePHP(` |
...
|       - | 11727 | `	)` |
|       5 | 11728 |  |
|   14165 | 11729 | `	SyToken *pScript = pGen->pRawIn; /* Script to compile */` |
|       - | 11730 | `	sxi32 rc;` |
|       - | 11731 | `	/* Reset the token set */` |
|   14165 | 11732 | `	SySetReset(&(*pTokenSet));` |
|       - | 11733 | `	/* Mark as the default token set */` |
|   14165 | 11734 | `	pGen->pTokenSet = &(*pTokenSet);` |
|       - | 11735 | `	/* Advance the stream cursor */` |
|   14165 | 11736 | `	pGen->pRawIn++;` |
|       - | 11737 | `	/* Tokenize the PHP chunk first */` |
|   14165 | 11738 | `	PH7_TokenizePHP(SyStringData(&pScript->sData),SyStringLength(&pScript->sData),pScript->nLine,&(*pTokenSet));` |
|       - | 11739 | `	/* Point to the head and tail of the token stream. */` |
|   14165 | 11740 | `	pGen->pIn  = (SyToken *)SySetBasePtr(pTokenSet);` |
|   14165 | 11741 | `	pGen->pEnd = &pGen->pIn[SySetUsed(pTokenSet)];` |
|   14165 | 11742 | `	if( is_expr ){` |
...
|       - | 11751 | `	}` |
|   14165 | 11752 | `	if( pGen->pIn < pGen->pEnd && ( pGen->pIn->nType & PH7_TK_EQUAL ) ){` |
...
|   14163 | 11777 | `	rc = GenStateCompileChunk(pGen,0);` |
|       - | 11778 | `	/* Fix exceptions jumps */` |
|   14163 | 11779 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|       - | 11780 | `	/* Fix gotos now, the jump destination is resolved */` |
|   14163 | 11781 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),0) ){` |
|       3 | 11782 | `		rc = SXERR_ABORT;` |
|       1 | 11783 | `	}` |
|       - | 11784 | `	/* Reset container */` |
|   14163 | 11785 | `	SySetReset(&pGen->aGoto);` |
|   14163 | 11786 | `	SySetReset(&pGen->aLabel);` |
|   14163 | 11787 | `	SySetReset(&pGen->aNullsafeJmp);` |
|       - | 11788 | `	/* Compilation result */` |
|   14163 | 11789 | `	return rc;` |
|    7085 | 11790 |  |
|       - | 11791 | `/*` |
...
|       - | 11795 | ` */` |
|   17066 | 11796 | `PH7_PRIVATE sxi32 PH7_CompileScript(` |
...
|       - | 11810 | `	sxi32 rc;` |
|   17071 | 11811 | `	if( pScript->nByte < 1 ){` |
...
|   17071 | 11817 | `	pCodeGen = &pVm->sCodeGen;` |
|   17071 | 11818 | `	bSavedStrict = pCodeGen->bStrictTypes;` |
|   17071 | 11819 | `	bSavedStrictLocked = pCodeGen->bStrictTypesLocked;` |
|   17071 | 11820 | `	pCodeGen->bStrictTypes = 0;` |
|   17071 | 11821 | `	pCodeGen->bStrictTypesLocked = 0;` |
|       - | 11822 | `	/* Initialize the tokens containers */` |
|   17071 | 11823 | `	SySetInit(&aRawToken,&pVm->sAllocator,sizeof(SyToken));` |
|   17071 | 11824 | `	SySetInit(&aPhpToken,&pVm->sAllocator,sizeof(SyToken));` |
|   17071 | 11825 | `	SySetAlloc(&aPhpToken,0xc0);` |
|   17071 | 11826 | `	is_expr = 0;` |
|   17071 | 11827 | `	if( iFlags & PH7_PHP_ONLY ){` |
|       - | 11828 | `		SyToken sTmp;` |
|       - | 11829 | `		/* PHP only: -*/` |
|    3601 | 11830 | `		sTmp.nLine = 1;` |
|    3601 | 11831 | `		sTmp.nType = PH7_TOKEN_PHP;` |
|    3601 | 11832 | `		sTmp.pUserData = 0;` |
|    3601 | 11833 | `		SyStringDupPtr(&sTmp.sData,pScript);` |
|    3601 | 11834 | `		SySetPut(&aRawToken,(const void *)&sTmp);` |
|    3601 | 11835 | `		if( iFlags & PH7_PHP_EXPR ){` |
|       - | 11836 | `			/* A simple PHP expression */` |
|     ! 0 | 11837 | `			is_expr = 1;` |
|     ! 0 | 11838 | `		}` |
|    1803 | 11839 | `	}else{` |
|       - | 11840 | `		/* Tokenize raw text */` |
|   13475 | 11841 | `		SySetAlloc(&aRawToken,32);` |
|   13475 | 11842 | `		PH7_TokenizeRawText(pScript->zString,pScript->nByte,&aRawToken);` |
|       - | 11843 | `	}` |
|       - | 11844 | `	/* Process high-level tokens */` |
|   17071 | 11845 | `	pCodeGen->pRawIn = (SyToken *)SySetBasePtr(&aRawToken);` |
|   17071 | 11846 | `	pCodeGen->pRawEnd = &pCodeGen->pRawIn[SySetUsed(&aRawToken)];` |
|   17071 | 11847 | `	rc = PH7_OK;` |
|   17071 | 11848 | `	if( is_expr ){` |
|       - | 11849 | `		/* Compile the expression */` |
|     ! 0 | 11850 | `		rc = PH7_CompilePHP(pCodeGen,&aPhpToken,TRUE);` |
|     ! 0 | 11851 | `		goto cleanup;` |
|       - | 11852 | `	}` |
|   17071 | 11853 | `	nObjIdx = 0;` |
...
|   17071 | 11857 | `	PH7_VmEmitInstr(pVm,PH7_OP_NSSWITCH,0,0,0,0);` |
|       - | 11858 | `	/* Start the compilation process */` |
|   15274 | 11859 | `	for(;;){` |
|   44701 | 11860 | `		if( pCodeGen->pRawIn >= pCodeGen->pRawEnd ){` |
|   17059 | 11861 | `			break; /* No more tokens to process */` |
|       - | 11862 | `		}` |
|   27647 | 11863 | `		if( pCodeGen->pRawIn->nType & PH7_TOKEN_PHP ){` |
|       - | 11864 | `			/* Compile the PHP chunk */` |
|   14165 | 11865 | `			rc = PH7_CompilePHP(pCodeGen,&aPhpToken,FALSE);` |
|   14165 | 11866 | `			if( rc == SXERR_ABORT ){` |
|      15 | 11867 | `				break;` |
|       - | 11868 | `			}` |
|   14153 | 11869 | `			continue;` |
|       - | 11870 | `		}` |
|       - | 11871 | `		/* Raw chunk: [i.e: HTML, XML, etc.] */` |
|   13487 | 11872 | `		nRawObj = 0;` |
|   27011 | 11873 | `		while( (pCodeGen->pRawIn < pCodeGen->pRawEnd) && (pCodeGen->pRawIn->nType != PH7_TOKEN_PHP) ){` |
|       - | 11874 | `			/* Consume the raw chunk without any processing */` |
|   13529 | 11875 | `			pRawObj = PH7_ReserveConstObj(&(*pVm),&nObjIdx);` |
|   13529 | 11876 | `			if( pRawObj == 0 ){` |
|     ! 0 | 11877 | `				rc = SXERR_MEM;` |
|     ! 0 | 11878 | `				break;` |
|       - | 11879 | `			}` |
|       - | 11880 | `			/* Mark as constant and emit the load constant instruction */` |
|   13529 | 11881 | `			PH7_MemObjInitFromString(pVm,pRawObj,&pCodeGen->pRawIn->sData);` |
|   13529 | 11882 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_LOADC,0,nObjIdx,0,0);` |
|   13529 | 11883 | `			++nRawObj;` |
|   13529 | 11884 | `			pCodeGen->pRawIn++; /* Next chunk */` |
|       5 | 11885 | `		}` |
|   13487 | 11886 | `		if( nRawObj > 0 ){` |
|       - | 11887 | `			/* Emit the consume instruction */` |
|   13487 | 11888 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_CONSUME,nRawObj,0,0,0);` |
|    6741 | 11889 | `		}` |
|    8538 | 11890 | `	}` |
|    8533 | 11891 | `cleanup:` |
|   17071 | 11892 | `	SySetRelease(&aRawToken);` |
|   17071 | 11893 | `	SySetRelease(&aPhpToken);` |
|       - | 11894 | `	/* Restore outer file's strict_types scope */` |
|   17071 | 11895 | `	pCodeGen->bStrictTypes = bSavedStrict;` |
|   17071 | 11896 | `	pCodeGen->bStrictTypesLocked = bSavedStrictLocked;` |
|   17071 | 11897 | `	return rc;` |
|    8538 | 11898 |  |
|       - | 11899 | `/*` |
|       - | 11900 | ` * Utility routines.Initialize the code generator.` |
|       - | 11901 | ` */` |
|    3528 | 11902 | `PH7_PRIVATE sxi32 PH7_InitCodeGenerator(` |
|       - | 11903 | `	ph7_vm *pVm,       /* Target VM */` |
|       - | 11904 | `	ProcConsumer xErr, /* Error log consumer callabck  */` |
|       - | 11905 | `	void *pErrData     /* Last argument to xErr() */` |
|       - | 11906 | `	)` |
|       5 | 11907 |  |
|    3533 | 11908 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|       - | 11909 | `	/* Zero the structure */` |
|    3533 | 11910 | `	SyZero(pGen,sizeof(ph7_gen_state));` |
|       - | 11911 | `	/* Initial state */` |
|    3533 | 11912 | `	pGen->pVm  = &(*pVm);` |
|    3533 | 11913 | `	pGen->xErr = xErr;` |
|    3533 | 11914 | `	pGen->pErrData = pErrData;` |
|    3533 | 11915 | `	SySetInit(&pGen->aLabel,&pVm->sAllocator,sizeof(Label));` |
|    3533 | 11916 | `	SySetInit(&pGen->aGoto,&pVm->sAllocator,sizeof(JumpFixup));` |
|    3533 | 11917 | `	SySetInit(&pGen->aNullsafeJmp,&pVm->sAllocator,sizeof(sxu32));` |
|    3533 | 11918 | `	SyHashInit(&pGen->hLiteral,&pVm->sAllocator,0,0);` |
|    3533 | 11919 | `	SyHashInit(&pGen->hVar,&pVm->sAllocator,0,0);` |
|       - | 11920 | `	/* Error log buffer */` |
|    3533 | 11921 | `	SyBlobInit(&pGen->sErrBuf,&pVm->sAllocator);` |
|       - | 11922 | `	/* General purpose working buffer */` |
|    3533 | 11923 | `	SyBlobInit(&pGen->sWorker,&pVm->sAllocator);` |
|       - | 11924 | `	/* Namespace state */` |
|    3533 | 11925 | `	SyBlobInit(&pGen->sNamespace,&pVm->sAllocator);` |
|    3533 | 11926 | `	SyHashInit(&pGen->hUseImports,&pVm->sAllocator,0,0);` |
|    3533 | 11927 | `	SyHashInit(&pGen->hUseFuncImports,&pVm->sAllocator,0,0);` |
|    3533 | 11928 | `	SyHashInit(&pGen->hUseConstImports,&pVm->sAllocator,0,0);` |
|       - | 11929 | `	/* Create the global scope */` |
|    3533 | 11930 | `	GenStateInitBlock(pGen,&pGen->sGlobal,GEN_BLOCK_GLOBAL,PH7_VmInstrLength(&(*pVm)),0);` |
|       - | 11931 | `	/* Point to the global scope */` |
|    3533 | 11932 | `	pGen->pCurrent = &pGen->sGlobal;` |
|    3533 | 11933 | `	return SXRET_OK;` |
|       5 | 11934 |  |
|       - | 11935 | `/*` |
|       - | 11936 | ` * Utility routines. Reset the code generator to it's initial state.` |
|       - | 11937 | ` */` |
|   20248 | 11938 | `PH7_PRIVATE sxi32 PH7_ResetCodeGenerator(` |
|       - | 11939 | `	ph7_vm *pVm,       /* Target VM */` |
|       - | 11940 | `	ProcConsumer xErr, /* Error log consumer callabck  */` |
|       - | 11941 | `	void *pErrData     /* Last argument to xErr() */` |
|       - | 11942 | `	)` |
|       5 | 11943 |  |
|   20253 | 11944 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|       - | 11945 | `	GenBlock *pBlock,*pParent;` |
|       - | 11946 | `	/* Reset state */` |
|   20253 | 11947 | `	SySetReset(&pGen->aLabel);` |
|   20253 | 11948 | `	SySetReset(&pGen->aGoto);` |
|   20253 | 11949 | `	SySetReset(&pGen->aNullsafeJmp);` |
|   20253 | 11950 | `	SyBlobRelease(&pGen->sErrBuf);` |
|   20253 | 11951 | `	SyBlobRelease(&pGen->sWorker);` |
|   20253 | 11952 | `	SyBlobRelease(&pGen->sNamespace);` |
|   20253 | 11953 | `	SyBlobInit(&pGen->sNamespace,&pVm->sAllocator);` |
|   20253 | 11954 | `	SyHashRelease(&pGen->hUseImports);` |
|   20253 | 11955 | `	SyHashInit(&pGen->hUseImports,&pVm->sAllocator,0,0);` |
|   20253 | 11956 | `	SyHashRelease(&pGen->hUseFuncImports);` |
|   20253 | 11957 | `	SyHashInit(&pGen->hUseFuncImports,&pVm->sAllocator,0,0);` |
|   20253 | 11958 | `	SyHashRelease(&pGen->hUseConstImports);` |
|   20253 | 11959 | `	SyHashInit(&pGen->hUseConstImports,&pVm->sAllocator,0,0);` |
...
|   20253 | 11967 | `	pBlock = pGen->pCurrent;` |
|   20253 | 11968 | `	while( pBlock->pParent != 0 ){` |
|     ! 0 | 11969 | `		pParent = pBlock->pParent;` |
|     ! 0 | 11970 | `		GenStateFreeBlock(pBlock);` |
|     ! 0 | 11971 | `		pBlock = pParent;` |
|     ! 0 | 11972 | `	}` |
|   20253 | 11973 | `	pGen->xErr = xErr;` |
|   20253 | 11974 | `	pGen->pErrData = pErrData;` |
|   20253 | 11975 | `	pGen->pCurrent = &pGen->sGlobal;` |
|   20253 | 11976 | `	pGen->pRawIn = pGen->pRawEnd = 0;` |
|   20253 | 11977 | `	pGen->pIn = pGen->pEnd = 0;` |
|   20253 | 11978 | `	pGen->nErr = 0;` |
|   20253 | 11979 | `	return SXRET_OK;` |
|       5 | 11980 |  |
|       - | 11981 | `/*` |
