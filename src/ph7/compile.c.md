...
|    537997 |  123 | `		pBlock->nLoopId = pGen->nLoopId;` |
|    537997 |  124 | `		pBlock->nOuterLoopId = nParent;` |
...
|         - |  257 | ` */` |
|   4706516 |  258 | `PH7_PRIVATE sxi32 GenStateNewJumpFixup(GenBlock *pBlock,sxi32 nJumpType,sxu32 nInstrIdx)` |
|         5 |  259 | `{` |
|         - |  260 | `	JumpFixup sJumpFix;` |
|         - |  261 | `	sxi32 rc;` |
|         - |  262 | `	/* Init the JumpFixup structure */` |
|   4706521 |  263 | `	sJumpFix.nJumpType = nJumpType;` |
|   4706521 |  264 | `	sJumpFix.nInstrIdx = nInstrIdx;` |
|         - |  265 | `	/* Insert in the jump fixup table */` |
|   4706521 |  266 | `	rc = SySetPut(&pBlock->aJumpFix,(const void *)&sJumpFix);` |
|   4706521 |  267 | `	return rc;` |
|         5 |  268 | `}` |
|         - |  269 | `/*` |
...
|         - |  279 | ` */` |
|   9059704 |  280 | `PH7_PRIVATE sxu32 GenStateFixJumps(GenBlock *pBlock,sxi32 nJumpType,sxu32 nJumpDest)` |
|         5 |  281 | `{` |
|         - |  282 | `	JumpFixup *aFix;` |
|         - |  283 | `	VmInstr *pInstr;` |
|         - |  284 | `	sxu32 nFixed;` |
...
|   9059709 |  287 | `	aFix = (JumpFixup *)SySetBasePtr(&pBlock->aJumpFix);` |
|         - |  288 | `	/* Fix the desired jumps */` |
|  18963553 |  289 | `	for( nFixed = n = 0 ; n < SySetUsed(&pBlock->aJumpFix) ; ++n ){` |
|   9903849 |  290 | `		if( aFix[n].nJumpType < 0 ){` |
|         - |  291 | `			/* Already fixed */` |
|   3697999 |  292 | `			continue;` |
|         - |  293 | `		}` |
|   6205855 |  294 | `		if( nJumpType > 0 && aFix[n].nJumpType != nJumpType ){` |
|         - |  295 | `			/* Not of our interest */` |
|   1499341 |  296 | `			continue;` |
|         - |  297 | `		}` |
|         - |  298 | `		/* Point to the instruction to fix */` |
|   4706519 |  299 | `		pInstr = PH7_VmGetInstr(pBlock->pGen->pVm,aFix[n].nInstrIdx);` |
|   4706519 |  300 | `		if( pInstr ){` |
|   4706519 |  301 | `			pInstr->iP2 = nJumpDest;` |
|   4706519 |  302 | `			nFixed++;` |
|         - |  303 | `			/* Mark as fixed */` |
|   4706519 |  304 | `			aFix[n].nJumpType = -1;` |
|   2353257 |  305 | `		}` |
|   2353262 |  306 | `	}` |
|         - |  307 | `	/* Total number of fixed jumps */` |
|   9059709 |  308 | `	return nFixed;` |
|         5 |  309 | `}` |
|         - |  310 | `/*` |
...
|         - |  316 | ` */` |
|   3354284 |  317 | `PH7_PRIVATE sxi32 GenStateFixGoto(ph7_gen_state *pGen,sxu32 nOfft)` |
|         5 |  318 | `{` |
...
|   3354289 |  325 | `	aJumps = (JumpFixup *)SySetBasePtr(&pGen->aGoto);` |
|         - |  326 | `	/* Fix */` |
|   3354435 |  327 | `	for( n = nOfft ; n < SySetUsed(&pGen->aGoto) ; ++n ){` |
...
|   3354287 |  378 | `	return SXRET_OK;` |
|   1677147 |  379 | `}` |
|         - |  380 | `/*` |
|         - |  381 | ` * Check if a given token value is installed in the literal table.` |
|         - |  382 | ` */` |
|  16803304 |  383 | `PH7_PRIVATE sxi32 GenStateFindLiteral(ph7_gen_state *pGen,const SyString *pValue,sxu32 *pIdx)` |
|         5 |  384 | `{` |
|         - |  385 | `	SyHashEntry *pEntry;` |
|  16803309 |  386 | `	pEntry = SyHashGet(&pGen->hLiteral,(const void *)pValue->zString,pValue->nByte);` |
|  16803309 |  387 | `	if( pEntry == 0 ){` |
|   4479677 |  388 | `		return SXERR_NOTFOUND;` |
|         - |  389 | `	}` |
|  12323637 |  390 | `	*pIdx = (sxu32)SX_PTR_TO_INT(pEntry->pUserData);` |
|  12323637 |  391 | `	return SXRET_OK;` |
|   8401657 |  392 | `}` |
|         - |  393 | `/*` |
...
|         - |  413 | ` */` |
|   3799148 |  414 | `PH7_PRIVATE ph7_value * GenStateInstallNumLiteral(ph7_gen_state *pGen,sxu32 *pIdx)` |
|         5 |  415 | `{` |
|         - |  416 | `	ph7_value *pObj;` |
|   3799153 |  417 | `	sxu32 nIdx = 0; /* cc warning */` |
|         - |  418 | `	/* Reserve a new constant */` |
|   3799153 |  419 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   3799153 |  420 | `	if( pObj == 0 ){` |
|       ! 0 |  421 | `		PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|       ! 0 |  422 | `		return 0;` |
|         - |  423 | `	}` |
|   3799153 |  424 | `	*pIdx = nIdx;` |
|         - |  425 | `	/* TODO(chems): Create a numeric table (64bit int keys) same as` |
|         - |  426 | `	 * the constant string iterals table [optimization purposes].` |
|         - |  427 | `	 */` |
|   3799153 |  428 | `	return pObj;` |
|   1899579 |  429 | `}` |
|         - |  430 | `/*` |
...
|         - |  443 | ` */` |
|   7905494 |  444 | `PH7_PRIVATE void *GenStateAttachStrictFlag(ph7_gen_state *pGen, void *p3)` |
|         5 |  445 | `{` |
|         - |  446 | `	VmCallArgMap *pMap;` |
|   7905499 |  447 | `	if( !pGen->bStrictTypes ) return p3;` |
|        58 |  448 | `	if( p3 == 0 ){` |
...
|         - |  507 | ` */` |
|  53704770 |  508 | `static void GenStatePatchNullsafeJumps(ph7_gen_state *pGen, sxu32 nBaseline)` |
|         5 |  509 | `{` |
|  53704775 |  510 | `	sxu32 nCur = SySetUsed(&pGen->aNullsafeJmp);` |
|         - |  511 | `	sxu32 nTarget;` |
|         - |  512 | `	sxu32 *aIdx;` |
|         - |  513 | `	sxu32 i;` |
|  53704775 |  514 | `	if( nCur <= nBaseline ){` |
|  53704679 |  515 | `		return;` |
|         - |  516 | `	}` |
...
|         - |  544 | ` */` |
|   7021272 |  545 | `static sxu32 GenStateByRefBuiltinMask(SyString *pName)` |
|         5 |  546 | `{` |
...
|         - |  562 | `	};` |
|         - |  563 | `	sxu32 i;` |
|   7021277 |  564 | `	if( pName == 0 \|\| pName->zString == 0 \|\| pName->nByte == 0 ){` |
|   1797507 |  565 | `		return 0;` |
|         - |  566 | `	}` |
|  56981339 |  567 | `	for( i = 0 ; i < SX_ARRAYSIZE(aByRef) ; ++i ){` |
|  51815664 |  568 | `		if( pName->nByte == aByRef[i].nByte` |
|  27415908 |  569 | `		 && SyStrnicmp(pName->zString, aByRef[i].zName, pName->nByte) == 0 ){` |
|     58105 |  570 | `			return aByRef[i].mask;` |
|         - |  571 | `		}` |
|  25878787 |  572 | `	}` |
|   5165675 |  573 | `	return 0;` |
|   3510641 |  574 | `}` |
|         - |  575 | `/*` |
...
|         - |  584 | ` */` |
|   7021272 |  585 | `static void GenStateCallBuiltinName(ph7_expr_node *pLeft, SyString *pOut)` |
|         5 |  586 | `{` |
|         - |  587 | `	SyToken *p, *pEnd;` |
|   7021277 |  588 | `	pOut->zString = 0;` |
|   7021277 |  589 | `	pOut->nByte = 0;` |
|   7021277 |  590 | `	if( pLeft == 0 \|\| pLeft->pStart == 0 \|\| pLeft->pEnd == 0 ){` |
|       ! 0 |  591 | `		return;` |
|         - |  592 | `	}` |
|   7021277 |  593 | `	p = pLeft->pStart;` |
|   7021277 |  594 | `	pEnd = pLeft->pEnd;` |
|         - |  595 | `	/* Optional single leading namespace separator (absolute path). */` |
|   7021277 |  596 | `	if( p < pEnd && (p->nType & PH7_TK_NSSEP) ){` |
|      3905 |  597 | `		p++;` |
|      1950 |  598 | `	}` |
|   7021277 |  599 | `	if( p >= pEnd \|\| (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|   1797457 |  600 | `		return;` |
|         - |  601 | `	}` |
|         - |  602 | `	/* Must be a single component: nothing follows the name token. */` |
|   5223825 |  603 | `	if( p + 1 != pEnd ){` |
|        55 |  604 | `		return;` |
|         - |  605 | `	}` |
|   5223775 |  606 | `	*pOut = p->sData;` |
|   3510641 |  607 | `}` |
|         - |  608 | `/*` |
...
|         - |  613 | ` * error message.` |
|         - |  614 | ` */` |
|  75723206 |  615 | `static sxi32 GenStateEmitExprCode(` |
...
|         - |  621 | `	VmInstr *pInstr;` |
|         - |  622 | `	sxu32 nJmpIdx;` |
|  75723211 |  623 | `	sxi32 iP1 = 0;` |
|  75723211 |  624 | `	sxu32 iP2 = 0;` |
|  75723211 |  625 | `	void *p3  = 0;` |
|         - |  626 | `	sxi32 iVmOp;` |
|         - |  627 | `	sxi32 rc;` |
|  75723211 |  628 | `	int bIsChainOp = 0; /* Set below once we know pNode->pOp */` |
|  75723211 |  629 | ``	int bFcc = 0;       /* First-class callable `f(...)`: emit OP_LOAD_FCC, not OP_CALL */`` |
|  75723211 |  630 | `	sxu32 nRhsNsBase = 0;` |
|  75723211 |  631 | `	if( pNode->xCode ){` |
|         - |  632 | `		SyToken *pTmpIn,*pTmpEnd;` |
|         - |  633 | `		/* Compile node */` |
|  45703377 |  634 | `		SWAP_DELIMITER(pGen,pNode->pStart,pNode->pEnd);` |
|  45703377 |  635 | `		rc = pNode->xCode(&(*pGen),iFlags);` |
|  45703377 |  636 | `		RE_SWAP_DELIMITER(pGen);` |
|  45703377 |  637 | `		return rc;` |
|         - |  638 | `	}` |
|  30019839 |  639 | `	if( pNode->pOp == 0 ){` |
...
|         - |  643 | `	}` |
|  30019839 |  644 | `	iVmOp = pNode->pOp->iVmOp;` |
|  30019839 |  645 | `	if( iVmOp == PH7_OP_CVT_NULL ){` |
...
|         - |  653 | `		}` |
|         1 |  654 | `	}` |
|  30019839 |  655 | `	if( pNode->pOp->iOp == EXPR_OP_NULLC_ASSIGN ){` |
|        93 |  656 | `		sxu32 nJmp = 0;` |
|         - |  657 | `		sxu32 nNcNsBase;` |
...
|         - |  704 | `	}` |
|  30019749 |  705 | `	if( pNode->pOp->iOp == EXPR_OP_QUESTY ){` |
|         - |  706 | `		sxu32 nJz,nJmp;` |
|         - |  707 | `		sxu32 nTernaryNsBase;` |
|         - |  708 | `		/* Ternary operator require special handling */` |
|         - |  709 | `		/* Phase#1: Compile the condition */` |
|    501477 |  710 | `		nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|    501477 |  711 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pCond,iFlags);` |
|    501477 |  712 | `		if( rc != SXRET_OK ){` |
|       ! 0 |  713 | `			return rc;` |
|         - |  714 | `		}` |
...
|    501477 |  718 | `		GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|    501477 |  719 | `		nJz = nJmp = 0; /* cc -O6 warning */` |
|    501477 |  720 | `		if( pNode->pLeft ){` |
|         - |  721 | `			/* Standard ternary: (expr) ? (then) : (else) */` |
|         - |  722 | `			/* Phase#2: Emit the false jump (pops condition) */` |
|    497545 |  723 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nJz);` |
|         - |  724 | `			/* Phase#3: Compile the 'then' expression  */` |
|    497545 |  725 | `			nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|    497545 |  726 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pLeft,iFlags);` |
|    497545 |  727 | `			if( rc != SXRET_OK ){` |
|       ! 0 |  728 | `				return rc;` |
|         - |  729 | `			}` |
|    497545 |  730 | `			GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|    248775 |  731 | `		}else{` |
...
|    501477 |  739 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,0,0,&nJmp);` |
|         - |  740 | `		/* Phase#5: Fix the false jump now the jump destination is resolved. */` |
|    501477 |  741 | `		pInstr = PH7_VmGetInstr(pGen->pVm,nJz);` |
|    501477 |  742 | `		if( pInstr ){` |
|    501477 |  743 | `			pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    250736 |  744 | `		}` |
|    501477 |  745 | `		if( !pNode->pLeft ){` |
...
|    501477 |  750 | `		if( pNode->pRight ){` |
|    501477 |  751 | `			nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|    501477 |  752 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pRight,iFlags);` |
|    501477 |  753 | `			if( rc != SXRET_OK ){` |
|       ! 0 |  754 | `				return rc;` |
|         - |  755 | `			}` |
|    501477 |  756 | `			GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|    250736 |  757 | `		}` |
|    501477 |  758 | `		if( nJmp > 0 ){` |
|         - |  759 | `			/* Phase#7: Fix the unconditional jump */` |
|    501477 |  760 | `			pInstr = PH7_VmGetInstr(pGen->pVm,nJmp);` |
|    501477 |  761 | `			if( pInstr ){` |
|    501477 |  762 | `				pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    250736 |  763 | `			}` |
|    250736 |  764 | `		}` |
|         - |  765 | `		/* All done */` |
|    501477 |  766 | `		return SXRET_OK;` |
|         - |  767 | `	}` |
|  29518277 |  768 | `	if( pNode->pOp->iOp == EXPR_OP_PIPE ){` |
...
|         - |  800 | `	}` |
|  29518251 |  801 | `	bIsChainOp = GEN_IS_CHAIN_OP(pNode->pOp->iOp);` |
|         - |  802 | `	/* Generate code for the left tree */` |
|  29518251 |  803 | `	if( pNode->pLeft ){` |
|  29464371 |  804 | `		sxu32 nLhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  29464371 |  805 | `		if( iVmOp == PH7_OP_CALL ){` |
|         - |  806 | `			ph7_expr_node **apNode;` |
|   7025485 |  807 | `			int hasSpread = 0;` |
|   7025485 |  808 | `			int hasNamed = 0;` |
|   7025485 |  809 | `			int bAnySpread = 0;` |
|   7025485 |  810 | `			sxu32 byRefMask = 0;` |
|         - |  811 | `			sxi32 nArgs;` |
|         - |  812 | `			sxi32 n;` |
|         - |  813 | `			/* Recurse and generate bytecodes for function arguments */` |
|   7025485 |  814 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|   7025485 |  815 | `			nArgs = (sxi32)SySetUsed(&pNode->aNodeArgs);` |
...
|   7025485 |  819 | `			if( nArgs == 1 && apNode[0] && (apNode[0]->iFlags & EXPR_NODE_FCC) ){` |
|        84 |  820 | `				bFcc = 1;` |
|        84 |  821 | `				nArgs = 0;` |
|        41 |  822 | `			}` |
...
|         - |  825 | `			{` |
|   7025485 |  826 | `				int seenNamed = 0;` |
|   7025485 |  827 | `				int seenSpread = 0;` |
|  15003379 |  828 | `				for( n = 0; n < nArgs; ++n ){` |
|   7977901 |  829 | `					if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
...
|         5 |  836 | `						}` |
|   7975871 |  837 | `					}else if( apNode[n]->iFlags & EXPR_NODE_NAMED_ARG ){` |
|       300 |  838 | `						seenNamed = 1;` |
|       300 |  839 | `						hasNamed = 1;` |
|   7973693 |  840 | `					}else if( seenNamed ){` |
...
|   7973543 |  844 | `					}else if( seenSpread ){` |
...
|         - |  850 | `			}` |
|         - |  851 | `			/* Read-only load */` |
|   7025483 |  852 | `			iFlags \|= EXPR_FLAG_RDONLY_LOAD;` |
...
|   7025483 |  857 | `			if( pNode->pLeft && pNode->pLeft->pStart ){` |
|   7025483 |  858 | `				SyString *pCallName = &pNode->pLeft->pStart->sData;` |
|  10929751 |  859 | `				int bIsset = pCallName->nByte == 5` |
|   7025478 |  860 | `					&& SyStrnicmp(pCallName->zString,"isset",5) == 0;` |
|  10929751 |  861 | `				int bEmpty = pCallName->nByte == 5` |
|   7025478 |  862 | `					&& SyStrnicmp(pCallName->zString,"empty",5) == 0;` |
...
|   7025483 |  869 | `				if( (bIsset \|\| bEmpty) && nArgs < 1 ){` |
...
|         - |  879 | `				}` |
|   7025479 |  880 | `				if( bIsset ){` |
|    324841 |  881 | `					iFlags \|= EXPR_FLAG_LOAD_IDX_ISSET;` |
|   6863061 |  882 | `				}else if( bEmpty ){` |
...
|   7025479 |  891 | `				if( !bAnySpread && !hasNamed ){` |
|         - |  892 | `					SyString sBuiltin;` |
|   7021277 |  893 | `					GenStateCallBuiltinName(pNode->pLeft, &sBuiltin);` |
|   7021277 |  894 | `					byRefMask = GenStateByRefBuiltinMask(&sBuiltin);` |
|   3510636 |  895 | `				}` |
|   3512737 |  896 | `			}` |
|  15003369 |  897 | `			for( n = 0 ; n < nArgs ; ++n ){` |
|   7977897 |  898 | `				sxu32 nArgNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|   7977897 |  899 | `				sxi32 iArgFlags = iFlags & ~(EXPR_FLAG_LOAD_IDX_STORE\|EXPR_FLAG_MEMBER_WRITE);` |
...
|   7977897 |  906 | `				if( n < 31 && (byRefMask & (1u<<n)) ){` |
...
|   7977892 |  920 | `				if( (iFlags & (EXPR_FLAG_LOAD_IDX_ISSET\|EXPR_FLAG_LOAD_IDX_EMPTY\|EXPR_FLAG_LOAD_IDX_UNSET)) == 0` |
|   7815399 |  921 | `				 && apNode[n]->pOp == 0 && apNode[n]->xCode == PH7_CompileVariable` |
|   4095849 |  922 | `				 && (apNode[n]->iFlags & (EXPR_NODE_NAMED_ARG\|EXPR_NODE_SPREAD)) == 0 ){` |
|   3347281 |  923 | `					iArgFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|   1673638 |  924 | `				}` |
|   7977897 |  925 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iArgFlags);` |
|   7977897 |  926 | `				if( rc != SXRET_OK ){` |
|         3 |  927 | `					return rc;` |
|         - |  928 | `				}` |
|         - |  929 | `				/* Each argument is an independent nullsafe scope. */` |
|   7977895 |  930 | `				GenStatePatchNullsafeJumps(pGen, nArgNsBase);` |
|   7977895 |  931 | `				if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
...
|   7025477 |  974 | `			iFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|   3512736 |  975 | `		}` |
|         - |  976 | `		{` |
...
|  29464363 |  985 | `			sxi32 iLeftFlags = iFlags;` |
|  29464363 |  986 | `			sxu32 nNullcLhsFirst = PH7_VmInstrLength(pGen->pVm);` |
|  29464363 |  987 | `			int bNullcLhs = 0;` |
|  29464358 |  988 | `			if( pNode->pLeft && pNode->pLeft->pOp` |
|  23923524 |  989 | `				&& (pNode->pLeft->pOp->iOp == EXPR_OP_ARROW` |
|   9191371 |  990 | `					\|\| pNode->pLeft->pOp->iOp == EXPR_OP_NULLSAFE_ARROW` |
|   7912465 |  991 | `					\|\| pNode->pLeft->pOp->iOp == EXPR_OP_DC) ){` |
|   2766983 |  992 | `				iLeftFlags &= ~EXPR_FLAG_LOAD_IDX_UNSET;` |
|   1383489 |  993 | `			}` |
...
|  29464358 | 1001 | `			if( pNode->pOp` |
|  41423859 | 1002 | `				&& (pNode->pOp->iOp == EXPR_OP_ARROW` |
|  26691727 | 1003 | `					\|\| pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW` |
|  23919044 | 1004 | `					\|\| pNode->pOp->iOp == EXPR_OP_DC) ){` |
|   5963541 | 1005 | `				iLeftFlags &= ~EXPR_FLAG_MEMBER_WRITE;` |
|   2981768 | 1006 | `			}` |
...
|  29464358 | 1013 | `			if( pNode->pOp` |
|  29464363 | 1014 | `				&& (pNode->pOp->iVmOp == PH7_OP_INCR \|\| pNode->pOp->iVmOp == PH7_OP_DECR) ){` |
|    216723 | 1015 | `				iLeftFlags \|= EXPR_FLAG_LOAD_IDX_STORE \| EXPR_FLAG_MEMBER_WRITE` |
...
|  29464363 | 1025 | `			if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLC && pNode->pLeft ){` |
...
|        18 | 1043 | `				}` |
|     29058 | 1044 | `			}` |
|  29464363 | 1045 | `			if( iVmOp == PH7_OP_ERR_CTRL ){` |
...
|      7850 | 1049 | `			}` |
|  29464363 | 1050 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pLeft,iLeftFlags\|EXPR_FLAG_RDONLY_LOAD);` |
|  29464363 | 1051 | `			if( rc == SXRET_OK && bNullcLhs ){` |
...
|     29058 | 1068 | `			}` |
|         - | 1069 | `		}` |
|  29464363 | 1070 | `		if( rc != SXRET_OK ){` |
|        32 | 1071 | `			return rc;` |
|         - | 1072 | `		}` |
|  29464335 | 1073 | `		if( !bIsChainOp ){` |
...
|  13463271 | 1076 | `			GenStatePatchNullsafeJumps(pGen, nLhsNsBase);` |
|   6731633 | 1077 | `		}` |
|  29464335 | 1078 | `		if( iVmOp == PH7_OP_CALL ){` |
|   7025477 | 1079 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|   7025477 | 1080 | `			if( pInstr ){` |
|   7025477 | 1081 | `				if ( pInstr->iOp == PH7_OP_LOADC ){` |
|   5224083 | 1082 | `					sxu32 nOrig = (sxu32)pInstr->iP2;` |
|         - | 1083 | `					sxu32 nQual;` |
|   5224083 | 1084 | `					int bAbsolute = (pInstr->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|         - | 1085 | `					/* Prevent constant expansion but preserve the absolute flag` |
|         - | 1086 | `					 * so the later NEW handler (if any) can see it. */` |
|   5224083 | 1087 | `					pInstr->iP1 &= ~PH7_LOADC_EXPAND;` |
...
|   5224083 | 1095 | `					if( bAbsolute ){` |
|      3905 | 1096 | `						pInstr->iP2 = (sxi32)nOrig;` |
|      1955 | 1097 | `					}else{` |
|   5220183 | 1098 | `						int fromImport = 0;` |
|   5220183 | 1099 | `						nQual = GenStateNsQualifyName(pGen,nOrig,&pGen->hUseFuncImports,&fromImport);` |
|   5220183 | 1100 | `						pInstr->iP2 = (sxi32)nQual;` |
|   5220183 | 1101 | `						if( nQual != nOrig ){` |
...
|        49 | 1122 | `						}` |
|         - | 1123 | `					}` |
|   4413438 | 1124 | `				}else if( (pInstr->iOp == PH7_OP_MEMBER /* $a->b(1,2,3) */` |
|   1791381 | 1125 | `						&& !(pNode->pLeft && (pNode->pLeft->iFlags & EXPR_NODE_PARENS)))` |
|    910719 | 1126 | `					\|\| pInstr->iOp == PH7_OP_NEW ){` |
...
|   1781371 | 1142 | `					if( pInstr->iOp == PH7_OP_MEMBER && pInstr->iP1 == 1 && pInstr->p3 ){` |
...
|    890683 | 1148 | `				}` |
|   3512741 | 1149 | `			}` |
|  25951599 | 1150 | `		}else if( iVmOp == PH7_OP_LOAD_IDX ){` |
|         - | 1151 | `			ph7_expr_node **apNode;` |
|         - | 1152 | `			sxi32 n;` |
|   3012061 | 1153 | `			sxi32 iChildMask = ~(EXPR_FLAG_LOAD_IDX_STORE` |
...
|   3012061 | 1158 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|   5788089 | 1159 | `			for( n = 0 ; n < (sxi32)SySetUsed(&pNode->aNodeArgs) ; ++n ){` |
...
|        35 | 1182 | `				iP2 = 6;` |
|   2617748 | 1183 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_STORE ){` |
|         - | 1184 | `				/* Create an empty entry when the desired index is not found */` |
|    553201 | 1185 | `				iP2 = 1;` |
|    276603 | 1186 | `			}` |
|  20932835 | 1187 | `		}else if( pNode->pOp->iOp == EXPR_OP_COMMA ){` |
|         - | 1188 | `			/* POP the left node */` |
|         5 | 1189 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|         2 | 1190 | `		}` |
|  14732165 | 1191 | `	}` |
|  29518215 | 1192 | `	rc = SXRET_OK;` |
|  29518215 | 1193 | `	nJmpIdx = 0;` |
...
|  29518215 | 1197 | `	if( iVmOp == PH7_OP_MEMBER && pNode->pOp->iOp == EXPR_OP_DC ){` |
...
|  29471789 | 1236 | `	if( pNode->pRight ){` |
|  16926417 | 1237 | `		if( iVmOp == PH7_OP_LAND ){` |
...
|  16702171 | 1240 | `		}else if (iVmOp == PH7_OP_LOR ){` |
...
|  16315662 | 1243 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLC ){` |
...
|  16124393 | 1247 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW ){` |
...
|  16095231 | 1257 | `		}else if( pNode->pOp->iPrec == 18 /* Combined binary operators [i.e: =,'.=','+=',*=' ...] precedence */ ){` |
...
|   5191149 | 1261 | `			iFlags \|= EXPR_FLAG_LOAD_IDX_STORE \| EXPR_FLAG_MEMBER_WRITE;` |
|   5191149 | 1262 | `			if( iVmOp != PH7_OP_STORE ){` |
...
|    224177 | 1267 | `			}` |
|   2595572 | 1268 | `		}` |
|  16926417 | 1269 | `		nRhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  16926417 | 1270 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pRight,iFlags\|EXPR_FLAG_RDONLY_LOAD);` |
|  16926417 | 1271 | `		if( !bIsChainOp ){` |
|         - | 1272 | `			/* Non-chain parent: RHS nullsafe chain ends here, before the` |
|         - | 1273 | `			 * operator instruction is emitted. */` |
|  10962955 | 1274 | `			GenStatePatchNullsafeJumps(pGen, nRhsNsBase);` |
|   5481475 | 1275 | `		}` |
|  16926417 | 1276 | `		if( iVmOp == PH7_OP_STORE ){` |
|   4742795 | 1277 | `			if( pNode->pRight && (pNode->pRight->xCode == PH7_CompileList \|\|` |
|   4742758 | 1278 | `				pNode->pRight->xCode == PH7_CompileShortList) ){` |
...
|         - | 1284 | `				 */` |
|        99 | 1285 | `				iVmOp = 0;` |
|   4742748 | 1286 | `			}else if( (pInstr = PH7_VmPeekInstr(pGen->pVm)) != 0 ){` |
|   4742701 | 1287 | `				if(pInstr->iOp == PH7_OP_MEMBER ){` |
|         - | 1288 | `					/* Perform a member store operation [i.e: $this->x = 50] */` |
|    916069 | 1289 | `					iP2 = 1;` |
|    458037 | 1290 | `				}else{` |
|   3826637 | 1291 | `					if( pInstr->iOp == PH7_OP_LOAD_IDX ){` |
|         - | 1292 | `						/* Transform the STORE instruction to STORE_IDX instruction */` |
|    533791 | 1293 | `						iVmOp = PH7_OP_STORE_IDX;` |
|    533791 | 1294 | `						iP1 = pInstr->iP1;` |
|    266898 | 1295 | `					}else{` |
|   3292851 | 1296 | `						p3 = pInstr->p3;` |
|         - | 1297 | `					}` |
|         - | 1298 | `					/* POP the last dynamic load instruction */` |
|   3826637 | 1299 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|         - | 1300 | `				}` |
|   2371353 | 1301 | `			}` |
|  14555022 | 1302 | `		}else if( iVmOp == PH7_OP_STORE_REF ){` |
...
|        35 | 1329 | `		}` |
|   8463206 | 1330 | `	}` |
|  29471784 | 1331 | `	if( iVmOp == PH7_OP_NEW && pNode->pLeft && pNode->pLeft->pOp == 0` |
...
|        34 | 1335 | `		iVmOp = 0;` |
|        15 | 1336 | `	}` |
|  29471789 | 1337 | `	if( iVmOp > 0 ){` |
|  29413545 | 1338 | `		if( iVmOp == PH7_OP_INCR \|\| iVmOp == PH7_OP_DECR ){` |
|    216723 | 1339 | `			if( pNode->iFlags & EXPR_NODE_PRE_INCR ){` |
|         - | 1340 | `				/* Pre-increment/decrement operator [i.e: ++$i,--$j ] */` |
|     15481 | 1341 | `				iP1 = 1;` |
|      7743 | 1342 | `			}` |
|  29305186 | 1343 | `		}else if( iVmOp == PH7_OP_NEW ){` |
...
|    426221 | 1407 | `				}` |
|    426226 | 1408 | `			}` |
|  28760950 | 1409 | `		}else if( iVmOp == PH7_OP_IS_A ){` |
...
|     40695 | 1429 | `				}` |
|     40710 | 1430 | `			}` |
|  28291896 | 1431 | `		}else if( iVmOp == PH7_OP_MEMBER){` |
...
|   5963467 | 1435 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|   5963467 | 1436 | `			if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|   5723921 | 1437 | `				pInstr->iP1 = 0;` |
|   2861958 | 1438 | `			}` |
|   5963467 | 1439 | `			if( pNode->pOp->iOp == EXPR_OP_DC /* '::' */){` |
...
|   5963467 | 1452 | `			if( iP2 == PH7_MEMBER_READ ){` |
|   5963467 | 1453 | `				if( iFlags & EXPR_FLAG_LOAD_IDX_UNSET ){` |
|        42 | 1454 | `					iP2 = PH7_MEMBER_UNSET;` |
|   5963447 | 1455 | `				}else if( iFlags & EXPR_FLAG_LOAD_IDX_ISSET ){` |
|     69659 | 1456 | `					iP2 = PH7_MEMBER_ISSET;` |
|   5928600 | 1457 | `				}else if( iFlags & EXPR_FLAG_LOAD_IDX_EMPTY ){` |
|        17 | 1458 | `					iP2 = PH7_MEMBER_EMPTY;` |
|   5893765 | 1459 | `				}else if( iFlags & EXPR_FLAG_MEMBER_WRITE ){` |
...
|  29406017 | 1492 | `		if( iVmOp == PH7_OP_CALL \|\| iVmOp == PH7_OP_NEW ){` |
|   7882093 | 1493 | `			p3 = GenStateAttachStrictFlag(pGen,p3);` |
|   3941044 | 1494 | `		}` |
|         - | 1495 | `		/* Finally,emit the VM instruction associated with this operator */` |
|  29406017 | 1496 | `		PH7_VmEmitInstr(pGen->pVm,iVmOp,iP1,iP2,p3,0);` |
|  14703006 | 1497 | `	}` |
|  29464261 | 1498 | `	if( nJmpIdx > 0 ){` |
...
|         - | 1528 | ` */` |
| 251190584 | 1529 | `static int GenStateTreeHasComma(ph7_expr_node *pNode)` |
|         5 | 1530 | `{` |
|         - | 1531 | `	ph7_expr_node **apArg;` |
|         - | 1532 | `	sxu32 n;` |
| 251190589 | 1533 | `	if( pNode == 0 ){` |
| 176595961 | 1534 | `		return 0;` |
|         - | 1535 | `	}` |
|  74594633 | 1536 | `	if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_COMMA ){` |
|         6 | 1537 | `		return 1;` |
|         - | 1538 | `	}` |
|  74594624 | 1539 | `	if( GenStateTreeHasComma(pNode->pLeft) \|\| GenStateTreeHasComma(pNode->pRight)` |
|  74594625 | 1540 | `	 \|\| GenStateTreeHasComma(pNode->pCond) ){` |
|         6 | 1541 | `		return 1;` |
|         - | 1542 | `	}` |
|  74594625 | 1543 | `	apArg = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  85325455 | 1544 | `	for( n = 0 ; n < SySetUsed(&pNode->aNodeArgs) ; n++ ){` |
|  10730835 | 1545 | `		if( GenStateTreeHasComma(apArg[n]) ){` |
|       ! 0 | 1546 | `			return 1;` |
|         - | 1547 | `		}` |
|   5365420 | 1548 | `	}` |
|  74594625 | 1549 | `	return 0;` |
| 125595297 | 1550 | `}` |
|  17047288 | 1551 | `PH7_PRIVATE sxi32 PH7_CompileExpr(` |
...
|  17047293 | 1565 | `	nExpr = 0;` |
|  17047293 | 1566 | `	pRoot = 0;` |
...
|  17047293 | 1569 | `	nNullsafeBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  17047293 | 1570 | `	SySetInit(&sExprNode,&pGen->pVm->sAllocator,sizeof(ph7_expr_node *));` |
|  17047293 | 1571 | `	SySetAlloc(&sExprNode,0x10);` |
|  17047293 | 1572 | `	rc = SXRET_OK;` |
|         - | 1573 | `	/* Delimit the expression */` |
|  17047293 | 1574 | `	pEnd = pGen->pIn;` |
|  17047293 | 1575 | `	iNest = 0;` |
| 133451155 | 1576 | `	while( pEnd < pGen->pEnd ){` |
| 126896547 | 1577 | `		if( pEnd->nType & PH7_TK_OCB /* '{' */ ){` |
|         - | 1578 | `			/* Ticket 1433-30: Annonymous/Closure functions body */` |
|      4741 | 1579 | `			iNest++;` |
| 126894179 | 1580 | `		}else if(pEnd->nType & PH7_TK_CCB /* '}' */ ){` |
|      4751 | 1581 | `			iNest--;` |
| 126889438 | 1582 | `		}else if( pEnd->nType & PH7_TK_SEMI /* ';' */ ){` |
|  10493613 | 1583 | `			if( iNest <= 0 ){` |
|  10492685 | 1584 | `				break;` |
|         - | 1585 | `			}` |
|       464 | 1586 | `		}` |
| 116403867 | 1587 | `		pEnd++;` |
|         5 | 1588 | `	}` |
|  17047293 | 1589 | `	if( iFlags & EXPR_FLAG_COMMA_STATEMENT ){` |
...
|         1 | 1607 | `		}` |
|    367466 | 1608 | `	}` |
|  17047293 | 1609 | `	if( pEnd > pGen->pIn ){` |
|  17024113 | 1610 | `		SyToken *pTmp = pGen->pEnd;` |
|         - | 1611 | `		/* Swap delimiter */` |
|  17024113 | 1612 | `		pGen->pEnd = pEnd;` |
|         - | 1613 | `		/* Try to get an expression tree */` |
|  17024113 | 1614 | `		rc = PH7_ExprMakeTree(&(*pGen),&sExprNode,&pRoot);` |
|  17024108 | 1615 | `		if( rc == SXRET_OK && pRoot && pGen->nCommaExprOk < 1` |
|  16849912 | 1616 | `		 && GenStateTreeHasComma(pRoot) ){` |
...
|         - | 1629 | `		}` |
|  17024109 | 1630 | `		if( rc == SXRET_OK && pRoot ){` |
|  17023925 | 1631 | `			rc = SXRET_OK;` |
|  17023925 | 1632 | `			if( xTreeValidator ){` |
|         - | 1633 | `				/* Call the upper layer validator callback */` |
|   1029261 | 1634 | `				rc = xTreeValidator(&(*pGen),pRoot);` |
|    514628 | 1635 | `			}` |
|  17023925 | 1636 | `			if( rc != SXERR_ABORT ){` |
|         - | 1637 | `				/* Generate code for the given tree */` |
|  17023925 | 1638 | `				rc = GenStateEmitExprCode(&(*pGen),pRoot,iFlags);` |
|         - | 1639 | `				/* Patch any unresolved nullsafe jumps emitted by this` |
|         - | 1640 | `				 * expression so they short-circuit to its end. */` |
|  17023925 | 1641 | `				GenStatePatchNullsafeJumps(pGen, nNullsafeBase);` |
|   8511960 | 1642 | `			}` |
|  17023925 | 1643 | `			nExpr = 1;` |
|   8511960 | 1644 | `		}` |
|         - | 1645 | `		/* Release the whole tree */` |
|  17024109 | 1646 | `		PH7_ExprFreeTree(&(*pGen),&sExprNode);` |
|         - | 1647 | `		/* Synchronize token stream */` |
|  17024109 | 1648 | `		pGen->pEnd = pTmp;` |
|  17024109 | 1649 | `		pGen->pIn  = pEnd;` |
|  17024109 | 1650 | `		if( rc == SXERR_ABORT ){` |
|        24 | 1651 | `			SySetRelease(&sExprNode);` |
|        24 | 1652 | `			return SXERR_ABORT;` |
|         - | 1653 | `		}` |
|   8512042 | 1654 | `	}` |
|  17047269 | 1655 | `	SySetRelease(&sExprNode);` |
|  17047269 | 1656 | `	return nExpr > 0 ? SXRET_OK : SXERR_EMPTY;` |
|   8523649 | 1657 | `}` |
|         - | 1658 | `/*` |
|         - | 1659 | ` * Return a pointer to the node construct handler associated` |
|         - | 1660 | ` * with a given node type [i.e: string,integer,float,...].` |
|         - | 1661 | ` */` |
|   9468518 | 1662 | `PH7_PRIVATE ProcNodeConstruct PH7_GetNodeHandler(sxu32 nNodeType)` |
|         5 | 1663 | `{` |
|   9468523 | 1664 | `	if( nNodeType & PH7_TK_NUM ){` |
|         - | 1665 | `		/* Numeric literal: Either real or integer */` |
|   3807969 | 1666 | `		return PH7_CompileNumLiteral;` |
|   5660559 | 1667 | `	}else if( nNodeType & PH7_TK_DSTR ){` |
|         - | 1668 | `		/* Double quoted string */` |
|    124783 | 1669 | `		return PH7_CompileString;` |
...
|         - | 1707 | ` */` |
|     26006 | 1708 | `static sxi32 PH7_CompileUnset(ph7_gen_state *pGen)` |
|         5 | 1709 | `{` |
|     26011 | 1710 | `	SyToken *pTmp,*pEnd,*pNext = 0;` |
|     26011 | 1711 | `	sxu32 nIdx = 0;` |
|         - | 1712 | `	SyString sName;` |
|         - | 1713 | `	sxi32 rc;` |
|         - | 1714 | `	/* Jump the 'unset' keyword */` |
|     26011 | 1715 | `	pGen->pIn++;` |
|         - | 1716 | `	/* Save delimiter */` |
|     26011 | 1717 | `	pTmp = pGen->pEnd;` |
|         - | 1718 | `	/* Skip optional opening parenthesis and find the matching close */` |
|     26011 | 1719 | `	pEnd = pTmp; /* Default: scan to statement end */` |
|     26011 | 1720 | `	if( pGen->pIn < pTmp && (pGen->pIn->nType & PH7_TK_LPAREN) ){` |
|         - | 1721 | `		/* Find matching ')' — start scanning AFTER the '(' */` |
|         - | 1722 | `		SyToken *pClose;` |
|     26011 | 1723 | `		pGen->pIn++;   /* Skip '(' */` |
|     26011 | 1724 | `		PH7_DelimitNestedTokens(pGen->pIn,pTmp,PH7_TK_LPAREN,PH7_TK_RPAREN,&pClose);` |
|     26011 | 1725 | `		pEnd = pClose; /* Stop at ')' */` |
|     13003 | 1726 | `	}` |
|     26011 | 1727 | `	SyStringInitFromBuf(&sName,"unset",sizeof("unset")-1);` |
|         - | 1728 | `	/* Resolve the 'unset' builtin name once */` |
|     26011 | 1729 | `	if( SXRET_OK != GenStateFindLiteral(&(*pGen),&sName,&nIdx) ){` |
...
|     55875 | 1738 | `	while( SXRET_OK == PH7_GetNextExpr(pGen->pIn,pEnd,&pNext) ){` |
|     29869 | 1739 | `		if( pGen->pIn < pNext ){` |
|         - | 1740 | `			/*` |
...
|         - | 1747 | `			 */` |
|     29864 | 1748 | `			if( &pGen->pIn[2] == pNext` |
|     18218 | 1749 | `				&& (pGen->pIn[0].nType & PH7_TK_DOLLAR)` |
...
|     26011 | 1789 | `	if( pGen->pIn < pTmp && (pGen->pIn->nType & PH7_TK_RPAREN) ){` |
|     26011 | 1790 | `		pGen->pIn++;` |
|     13003 | 1791 | `	}` |
|         - | 1792 | `	/* Restore token stream */` |
|     26011 | 1793 | `	pGen->pEnd = pTmp;` |
|     26011 | 1794 | `	return SXRET_OK;` |
|     13008 | 1795 | `}` |
|         - | 1796 | `/*` |
...
|         - | 1828 | ` */` |
|   8420676 | 1829 | `static ProcLangConstruct GenStateGetStatementHandler(` |
|         - | 1830 | `	sxu32 nKeywordID,   /* Keyword  ID*/` |
|         - | 1831 | `	SyToken *pLookahed  /* Look-ahead token */` |
|         - | 1832 | `	)` |
|         5 | 1833 | `{` |
|   8420681 | 1834 | `	sxu32 n = 0;` |
|  34073353 | 1835 | `	for(;;){` |
|  68146711 | 1836 | `		if( n >= SX_ARRAYSIZE(aLangConstruct) ){` |
|    539373 | 1837 | `			break;` |
|         - | 1838 | `		}` |
|  67607343 | 1839 | `		if( aLangConstruct[n].nID == nKeywordID ){` |
|   7881313 | 1840 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed && (pLookahed->nType & PH7_TK_OP)){` |
...
|         - | 1845 | `				}` |
|       ! 0 | 1846 | `			}` |
|   7881308 | 1847 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed` |
...
|         - | 1854 | `			*/` |
|   7881311 | 1855 | `			return aLangConstruct[n].xConstruct;` |
|         - | 1856 | `		}` |
|  59726035 | 1857 | `		n++;` |
|         5 | 1858 | `	}` |
...
|         - | 1909 | ` */` |
|  18063208 | 1910 | `PH7_PRIVATE void GenStateSetPendingDoc(ph7_gen_state *pGen)` |
|         5 | 1911 | `{` |
|  18063213 | 1912 | `	SyToken *pBase = (SyToken *)SySetBasePtr(pGen->pTokenSet);` |
|  18063213 | 1913 | `	ph7_trivia *aT = (ph7_trivia *)SySetBasePtr(&pGen->aTrivia);` |
|  18063213 | 1914 | `	sxu32 nT = SySetUsed(&pGen->aTrivia);` |
|         - | 1915 | `	sxu32 nIdx, n;` |
|  18063208 | 1916 | `	if( nT < 1 \|\| pGen->pTokenSet == 0` |
...
|   1222327 | 2162 | `}` |
|  13247074 | 2163 | `PH7_PRIVATE sxi32 GenStateCompileChunk(` |
...
|         - | 2169 | `	sxi32 rc;` |
|  13247079 | 2170 | `	rc = SXRET_OK; /* Prevent compiler warning */` |
|   7707685 | 2171 | `	for(;;){` |
|  14331227 | 2172 | `		int bStmtIsDeclare = 0;` |
|  14331227 | 2173 | `		if( pGen->pIn >= pGen->pEnd ){` |
|         - | 2174 | `			/* No more input to process */` |
|     90839 | 2175 | `			break;` |
|         - | 2176 | `		}` |
|         - | 2177 | `		/* Bind a directly-preceding docblock to this statement */` |
|  14240393 | 2178 | `		GenStateSetPendingDoc(&(*pGen));` |
|  14240393 | 2179 | `		if( SySetUsed(&pGen->aPendingAttrs) > 0 ){` |
...
|  14240393 | 2211 | `		if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|   8463233 | 2212 | `			sxu32 nPeek = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   8463233 | 2213 | `			if( nPeek == PH7_TKWRD_DECLARE ){` |
|        49 | 2214 | `				bStmtIsDeclare = 1;` |
|        22 | 2215 | `			}` |
|   4231614 | 2216 | `		}` |
|  14240393 | 2217 | `		if( !bStmtIsDeclare && pGen->pCurrent == &pGen->sGlobal ){` |
...
|   1084147 | 2220 | `			pGen->bStrictTypesLocked = 1;` |
|    542071 | 2221 | `		}` |
|  14240393 | 2222 | `		if( pGen->pIn->nType & PH7_TK_OCB /* '{' */ ){` |
|         - | 2223 | `			/* Compile block */` |
...
|         - | 2227 | `			}` |
|      1956 | 2228 | `		}else{` |
|  14236491 | 2229 | `			xCons = 0;` |
|  14236491 | 2230 | `			if( GenStateStartsModifiedClass(pGen->pIn,pGen->pEnd) ){` |
...
|  14215202 | 2235 | `			}else if( GenStateStartsEnumDecl(pGen->pIn,pGen->pEnd) ){` |
...
|  14191964 | 2239 | `			}else if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|   8420681 | 2240 | `				sxu32 nKeyword = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|         - | 2241 | `				/* Try to extract a language construct handler */` |
|   8420681 | 2242 | `				xCons = GenStateGetStatementHandler(nKeyword,(&pGen->pIn[1] < pGen->pEnd) ? &pGen->pIn[1] : 0);` |
|   8420681 | 2243 | `				if( xCons == 0 && GenStateisLangConstruct(nKeyword) == FALSE ){` |
...
|         4 | 2254 | `				}` |
|   9979677 | 2255 | `			}else if( (pGen->pIn->nType & PH7_TK_ID) && (&pGen->pIn[1] < pGen->pEnd)` |
|    426313 | 2256 | `				&& (pGen->pIn[1].nType & PH7_TK_COLON /*':'*/) ){` |
|         - | 2257 | `				/* Label found [i.e: Out: ],point to the routine responsible of compiling it */` |
|       117 | 2258 | `				xCons = PH7_CompileLabel;` |
|        56 | 2259 | `			}` |
|  14236491 | 2260 | `			if( xCons == 0 ){` |
|         - | 2261 | `				/* Assume an expression an try to compile it */` |
|   5827643 | 2262 | `				rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   5827643 | 2263 | `				if(  rc != SXERR_EMPTY ){` |
|         - | 2264 | `					/* Pop l-value */` |
|   5827489 | 2265 | `					PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|   2913742 | 2266 | `				}` |
|   2913824 | 2267 | `			}else{` |
|         - | 2268 | `				/* Go compile the sucker */` |
|   8408853 | 2269 | `				rc = xCons(&(*pGen));` |
|         - | 2270 | `			}` |
|  14236491 | 2271 | `			if( rc == SXERR_ABORT ){` |
|         - | 2272 | `				/* Request to abort compilation */` |
|        42 | 2273 | `				break;` |
|         - | 2274 | `			}` |
|         - | 2275 | `		}` |
|         - | 2276 | `		/* Ignore trailing semi-colons ';' */` |
|  24448203 | 2277 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|  10207853 | 2278 | `			pGen->pIn++;` |
|         5 | 2279 | `		}` |
|  14240355 | 2280 | `		if( iFlags & PH7_COMPILE_SINGLE_STMT ){` |
...
|         - | 2296 | ` */` |
|     90874 | 2297 | `static sxi32 PH7_CompilePHP(` |
...
|         - | 2301 | `	)` |
|         5 | 2302 | `{` |
|     90879 | 2303 | `	SyToken *pScript = pGen->pRawIn; /* Script to compile */` |
|         - | 2304 | `	sxi32 rc;` |
|         - | 2305 | `	/* Reset the token set (and its trivia sidecar) */` |
|     90879 | 2306 | `	SySetReset(&(*pTokenSet));` |
|     90879 | 2307 | `	SySetReset(&pGen->aTrivia);` |
|         - | 2308 | `	/* Mark as the default token set */` |
|     90879 | 2309 | `	pGen->pTokenSet = &(*pTokenSet);` |
|         - | 2310 | `	/* Advance the stream cursor */` |
|     90879 | 2311 | `	pGen->pRawIn++;` |
|         - | 2312 | `	/* Tokenize the PHP chunk first */` |
|     90879 | 2313 | `	PH7_TokenizePHP(SyStringData(&pScript->sData),SyStringLength(&pScript->sData),pScript->nLine,&(*pTokenSet),&pGen->aTrivia);` |
|         - | 2314 | `	/* Point to the head and tail of the token stream. */` |
|     90879 | 2315 | `	pGen->pIn  = (SyToken *)SySetBasePtr(pTokenSet);` |
|     90879 | 2316 | `	pGen->pEnd = &pGen->pIn[SySetUsed(pTokenSet)];` |
|     90879 | 2317 | `	if( is_expr ){` |
...
|         - | 2326 | `	}` |
|     90879 | 2327 | `	if( pGen->pIn < pGen->pEnd && ( pGen->pIn->nType & PH7_TK_EQUAL ) ){` |
...
|     90877 | 2359 | `	rc = GenStateCompileChunk(pGen,0);` |
|         - | 2360 | `	/* Fix exceptions jumps */` |
|     90877 | 2361 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|         - | 2362 | `	/* Fix gotos now, the jump destination is resolved */` |
|     90877 | 2363 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),0) ){` |
|         3 | 2364 | `		rc = SXERR_ABORT;` |
|         1 | 2365 | `	}` |
|         - | 2366 | `	/* Reset container */` |
|     90877 | 2367 | `	SySetReset(&pGen->aGoto);` |
|     90877 | 2368 | `	SySetReset(&pGen->aLabel);` |
|     90877 | 2369 | `	SySetReset(&pGen->aNullsafeJmp);` |
|         - | 2370 | `	/* Compilation result */` |
|     90877 | 2371 | `	return rc;` |
|     45442 | 2372 | `}` |
|         - | 2373 | `/*` |
...
|         - | 2377 | ` */` |
|     94042 | 2378 | `PH7_PRIVATE sxi32 PH7_CompileScript(` |
...
|         - | 2393 | `	sxi32 rc;` |
|     94047 | 2394 | `	sxu32 nBaseLine = 1;` |
|     94047 | 2395 | `	if( pScript->nByte < 1 ){` |
...
|     94047 | 2402 | `	if( pScript->nByte >= 2 && pScript->zString[0]=='#' && pScript->zString[1]=='!' ){` |
...
|     94047 | 2416 | `	pCodeGen = &pVm->sCodeGen;` |
...
|     94047 | 2423 | `	pSavedIn = pCodeGen->pIn;` |
|     94047 | 2424 | `	pSavedEnd = pCodeGen->pEnd;` |
|     94047 | 2425 | `	bSavedStrict = pCodeGen->bStrictTypes;` |
|     94047 | 2426 | `	bSavedStrictLocked = pCodeGen->bStrictTypesLocked;` |
|     94047 | 2427 | `	pCodeGen->bStrictTypes = 0;` |
|     94047 | 2428 | `	pCodeGen->bStrictTypesLocked = 0;` |
|         - | 2429 | `	/* Initialize the tokens containers */` |
|     94047 | 2430 | `	SySetInit(&aRawToken,&pVm->sAllocator,sizeof(SyToken));` |
|     94047 | 2431 | `	SySetInit(&aPhpToken,&pVm->sAllocator,sizeof(SyToken));` |
|     94047 | 2432 | `	SySetAlloc(&aPhpToken,0xc0);` |
|     94047 | 2433 | `	is_expr = 0;` |
|     94047 | 2434 | `	if( iFlags & PH7_PHP_ONLY ){` |
|         - | 2435 | `		SyToken sTmp;` |
|         - | 2436 | `		/* PHP only: -*/` |
...
|     94047 | 2452 | `	pCodeGen->pRawIn = (SyToken *)SySetBasePtr(&aRawToken);` |
|     94047 | 2453 | `	pCodeGen->pRawEnd = &pCodeGen->pRawIn[SySetUsed(&aRawToken)];` |
|     94047 | 2454 | `	rc = PH7_OK;` |
|     94047 | 2455 | `	if( is_expr ){` |
|         - | 2456 | `		/* Compile the expression */` |
|       ! 0 | 2457 | `		rc = PH7_CompilePHP(pCodeGen,&aPhpToken,TRUE);` |
|       ! 0 | 2458 | `		goto cleanup;` |
|         - | 2459 | `	}` |
|     94047 | 2460 | `	nObjIdx = 0;` |
...
|     94047 | 2464 | `	PH7_VmEmitInstr(pVm,PH7_OP_NSSWITCH,0,0,0,0);` |
|         - | 2465 | `	/* Start the compilation process */` |
|     53432 | 2466 | `	for(;;){` |
|    197703 | 2467 | `		if( pCodeGen->pRawIn >= pCodeGen->pRawEnd ){` |
|     94007 | 2468 | `			break; /* No more tokens to process */` |
|         - | 2469 | `		}` |
|    103701 | 2470 | `		if( pCodeGen->pRawIn->nType & PH7_TOKEN_PHP ){` |
|         - | 2471 | `			/* Compile the PHP chunk */` |
|     90879 | 2472 | `			rc = PH7_CompilePHP(pCodeGen,&aPhpToken,FALSE);` |
|     90879 | 2473 | `			if( rc == SXERR_ABORT ){` |
|        44 | 2474 | `				break;` |
|         - | 2475 | `			}` |
|     90839 | 2476 | `			continue;` |
|         - | 2477 | `		}` |
...
|     94047 | 2500 | `	pCodeGen->pIn = pSavedIn;` |
|     94047 | 2501 | `	pCodeGen->pEnd = pSavedEnd;` |
|     94047 | 2502 | `	SySetRelease(&aRawToken);` |
|     94047 | 2503 | `	SySetRelease(&aPhpToken);` |
|         - | 2504 | `	/* Restore outer file's strict_types scope */` |
|     94047 | 2505 | `	pCodeGen->bStrictTypes = bSavedStrict;` |
|     94047 | 2506 | `	pCodeGen->bStrictTypesLocked = bSavedStrictLocked;` |
|     94047 | 2507 | `	return rc;` |
|     47026 | 2508 | `}` |
|         - | 2509 | `/*` |
...
|         - | 2551 | ` */` |
|     97420 | 2552 | `PH7_PRIVATE sxi32 PH7_ResetCodeGenerator(` |
|         - | 2553 | `	ph7_vm *pVm,       /* Target VM */` |
|         - | 2554 | `	ProcConsumer xErr, /* Error log consumer callabck  */` |
|         - | 2555 | `	void *pErrData     /* Last argument to xErr() */` |
|         - | 2556 | `	)` |
|         5 | 2557 | `{` |
|     97425 | 2558 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|         - | 2559 | `	GenBlock *pBlock,*pParent;` |
|         - | 2560 | `	/* Reset state */` |
|     97425 | 2561 | `	SySetReset(&pGen->aLabel);` |
|     97425 | 2562 | `	SySetReset(&pGen->aGoto);` |
|     97425 | 2563 | `	SySetReset(&pGen->aNullsafeJmp);` |
|     97425 | 2564 | `	SySetReset(&pGen->aTrivia);` |
|     97425 | 2565 | `	SySetReset(&pGen->aPendingAttrs);` |
|     97425 | 2566 | `	SyStringInitFromBuf(&pGen->sPendingDoc,0,0);` |
|     97425 | 2567 | `	SyBlobRelease(&pGen->sErrBuf);` |
|     97425 | 2568 | `	SyBlobRelease(&pGen->sWorker);` |
|     97425 | 2569 | `	SyBlobRelease(&pGen->sNamespace);` |
|     97425 | 2570 | `	SyBlobInit(&pGen->sNamespace,&pVm->sAllocator);` |
|     97425 | 2571 | `	SyHashRelease(&pGen->hUseImports);` |
|     97425 | 2572 | `	SyHashInit(&pGen->hUseImports,&pVm->sAllocator,0,0);` |
|     97425 | 2573 | `	SyHashRelease(&pGen->hUseFuncImports);` |
|     97425 | 2574 | `	SyHashInit(&pGen->hUseFuncImports,&pVm->sAllocator,0,0);` |
|     97425 | 2575 | `	SyHashRelease(&pGen->hUseConstImports);` |
|     97425 | 2576 | `	SyHashInit(&pGen->hUseConstImports,&pVm->sAllocator,0,0);` |
...
|     97425 | 2584 | `	pBlock = pGen->pCurrent;` |
|     97425 | 2585 | `	while( pBlock->pParent != 0 ){` |
|       ! 0 | 2586 | `		pParent = pBlock->pParent;` |
|       ! 0 | 2587 | `		GenStateFreeBlock(pBlock);` |
|       ! 0 | 2588 | `		pBlock = pParent;` |
|       ! 0 | 2589 | `	}` |
|     97425 | 2590 | `	pGen->xErr = xErr;` |
|     97425 | 2591 | `	pGen->pErrData = pErrData;` |
|     97425 | 2592 | `	pGen->pCurrent = &pGen->sGlobal;` |
|     97425 | 2593 | `	pGen->pRawIn = pGen->pRawEnd = 0;` |
|     97425 | 2594 | `	pGen->pIn = pGen->pEnd = 0;` |
|     97425 | 2595 | `	pGen->nErr = 0;` |
|     97425 | 2596 | `	return SXRET_OK;` |
|         5 | 2597 | `}` |
|         - | 2598 | `/*` |
