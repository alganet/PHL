...
|         - |   45 | ` */` |
|    178232 |   46 | `PH7_PRIVATE GenBlock * GenStateFetchBlock(GenBlock *pCurrent,sxi32 iBlockType,sxi32 iCount)` |
|         5 |   47 | `{` |
|    178237 |   48 | `	GenBlock *pBlock = pCurrent;` |
|    360157 |   49 | `	for(;;){` |
|    720319 |   50 | `		if( pBlock->iFlags & iBlockType ){` |
|    178213 |   51 | `			iCount--; /* Decrement nesting level */` |
|    178213 |   52 | `			if( iCount < 1 ){` |
|         - |   53 | `				/* Block meet with the desired criteria */` |
|    178187 |   54 | `				return pBlock;` |
|         - |   55 | `			}` |
|        13 |   56 | `		}` |
|         - |   57 | `		/* Point to the upper block */` |
|    542137 |   58 | `		pBlock = pBlock->pParent;` |
|    542137 |   59 | `		if( pBlock == 0 \|\| (pBlock->iFlags & (GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC)) ){` |
|         - |   60 | `			/* Forbidden */` |
|        28 |   61 | `			break;` |
|         - |   62 | `		}` |
|         5 |   63 | `	}` |
...
|         - |   69 | ` */` |
|  13063400 |   70 | `static void GenStateInitBlock(` |
...
|  13063405 |   79 | `	pBlock->nFirstInstr = nFirstInstr;` |
|  13063405 |   80 | `	pBlock->pUserData   = pUserData;` |
|  13063405 |   81 | `	pBlock->pGen        = pGen;` |
|  13063405 |   82 | `	pBlock->iFlags      = iType;` |
|  13063405 |   83 | `	pBlock->pParent     = 0;` |
|  13063405 |   84 | `	SySetInit(&pBlock->aJumpFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  13063405 |   85 | `	SySetInit(&pBlock->aPostContFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  13063405 |   86 | `}` |
|         - |   87 | `/*` |
...
|         - |   92 | ` */` |
|  13059526 |   93 | `PH7_PRIVATE sxi32 GenStateEnterBlock(` |
...
|  13059531 |  103 | `	pBlock = (GenBlock *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(GenBlock));` |
|  13059531 |  104 | `	if( pBlock == 0 ){` |
...
|  13059531 |  113 | `	SyZero(pBlock,sizeof(GenBlock));` |
|  13059531 |  114 | `	GenStateInitBlock(&(*pGen),pBlock,iType,nFirstInstr,pUserData);` |
|         - |  115 | `	/* Link to the parent block */` |
|  13059531 |  116 | `	pBlock->pParent = pGen->pCurrent;` |
...
|  13059531 |  119 | `	if( iType & (GEN_BLOCK_LOOP\|GEN_BLOCK_SWITCH) ){` |
|    539119 |  120 | `		sxu32 nParent = pGen->nCurLoopId;` |
|    539119 |  121 | `		pGen->nLoopId++;` |
|    539119 |  122 | `		SySetPut(&pGen->aLoopParent,(const void *)&nParent);` |
|    539119 |  123 | `		pBlock->nLoopId = pGen->nLoopId;` |
|    539119 |  124 | `		pBlock->nOuterLoopId = nParent;` |
|    539119 |  125 | `		pGen->nCurLoopId = pGen->nLoopId;` |
|    269557 |  126 | `	}` |
|         - |  127 | `	/* Mark as the current block */` |
|  13059531 |  128 | `	pGen->pCurrent = pBlock;` |
|  13059531 |  129 | `	if( ppBlock ){` |
|         - |  130 | `		/* Write a pointer to the new instance */` |
|   6280655 |  131 | `		*ppBlock = pBlock;` |
|   3140325 |  132 | `	}` |
|  13059531 |  133 | `	return SXRET_OK;` |
|   6529768 |  134 | `}` |
|         - |  135 | `/*` |
|         - |  136 | ` * Release block fields without freeing the whole instance.` |
|         - |  137 | ` */` |
|  13059520 |  138 | `static void GenStateReleaseBlock(GenBlock *pBlock)` |
|         5 |  139 | `{` |
|  13059525 |  140 | `	SySetRelease(&pBlock->aPostContFix);` |
|  13059525 |  141 | `	SySetRelease(&pBlock->aJumpFix);` |
|  13059525 |  142 | `}` |
|         - |  143 | `/*` |
|         - |  144 | ` * Release a block.` |
|         - |  145 | ` */` |
|  13059516 |  146 | `static void GenStateFreeBlock(GenBlock *pBlock)` |
|         5 |  147 | `{` |
|  13059521 |  148 | `	ph7_gen_state *pGen = pBlock->pGen;` |
|  13059521 |  149 | `	GenStateReleaseBlock(&(*pBlock));` |
|         - |  150 | `	/* Free the instance */` |
|  13059521 |  151 | `	SyMemBackendPoolFree(&pGen->pVm->sAllocator,pBlock);` |
|  13059521 |  152 | `}` |
|         - |  153 | `/*` |
|         - |  154 | ` * POP and release a block from the stack of compiled blocks.` |
|         - |  155 | ` */` |
|  13059516 |  156 | `PH7_PRIVATE sxi32 GenStateLeaveBlock(ph7_gen_state *pGen,GenBlock **ppBlock)` |
|         5 |  157 | `{` |
|  13059521 |  158 | `	GenBlock *pBlock = pGen->pCurrent;` |
|  13059521 |  159 | `	if( pBlock == 0 ){` |
|         - |  160 | `		/* No more block to pop */` |
|       ! 0 |  161 | `		return SXERR_EMPTY;` |
|         - |  162 | `	}` |
|  13059521 |  163 | `	if( pBlock->iFlags & (GEN_BLOCK_LOOP\|GEN_BLOCK_SWITCH) ){` |
|    539111 |  164 | `		pGen->nCurLoopId = pBlock->nOuterLoopId;` |
|    269553 |  165 | `	}` |
|         - |  166 | `	/* Point to the upper block */` |
|  13059521 |  167 | `	pGen->pCurrent = pBlock->pParent;` |
|  13059521 |  168 | `	if( ppBlock ){` |
|         - |  169 | `		/* Write a pointer to the popped block */` |
|       ! 0 |  170 | `		*ppBlock = pBlock;` |
|       ! 0 |  171 | `	}else{` |
|         - |  172 | `		/* Safely release the block */` |
|  13059521 |  173 | `		GenStateFreeBlock(&(*pBlock));` |
|         - |  174 | `	}` |
|  13059521 |  175 | `	return SXRET_OK;` |
|   6529763 |  176 | `}` |
|         - |  177 | `/*` |
...
|         - |  194 | ` */` |
|   1048522 |  195 | `PH7_PRIVATE int GenStateUnconditionalTopLevel(ph7_gen_state *pGen)` |
|         5 |  196 | `{` |
|   1048527 |  197 | `	GenBlock *pBlock = pGen->pCurrent;` |
|   1052501 |  198 | `	while( pBlock ){` |
|   1052501 |  199 | `		if( pBlock->iFlags & (GEN_BLOCK_COND\|GEN_BLOCK_LOOP\|GEN_BLOCK_FUNC\|GEN_BLOCK_SWITCH\|GEN_BLOCK_EXCEPTION) ){` |
|        77 |  200 | `			return 0; /* conditional / nested */` |
|         - |  201 | `		}` |
|   1052429 |  202 | `		if( pBlock->iFlags & GEN_BLOCK_GLOBAL ){` |
|   1048455 |  203 | `			return 1; /* reached the global block with no conditional ancestor */` |
|         - |  204 | `		}` |
|      3979 |  205 | `		pBlock = pBlock->pParent;` |
|         5 |  206 | `	}` |
|       ! 0 |  207 | `	return 1;` |
|    524266 |  208 | `}` |
|         - |  209 | `/*` |
...
|         - |  211 | ` * guard above.` |
|         - |  212 | ` */` |
|    520000 |  213 | `PH7_PRIVATE sxi32 GenStateGuardFuncRedeclaration(ph7_gen_state *pGen,ph7_vm_func *pFunc)` |
|         5 |  214 | `{` |
|         - |  215 | `	SyHashEntry *pEntry;` |
|    520005 |  216 | `	if( !GenStateUnconditionalTopLevel(pGen) ){` |
|        53 |  217 | `		return SXRET_OK;` |
|         - |  218 | `	}` |
|    519955 |  219 | `	pFunc->iFlags \|= VM_FUNC_BOUND;` |
|    519955 |  220 | `	if( pGen->pVm->bCompilingBuiltin ){` |
|    518585 |  221 | `		return SXRET_OK;` |
|         - |  222 | `	}` |
...
|         - |  257 | ` */` |
|   4716266 |  258 | `PH7_PRIVATE sxi32 GenStateNewJumpFixup(GenBlock *pBlock,sxi32 nJumpType,sxu32 nInstrIdx)` |
|         5 |  259 | `{` |
|         - |  260 | `	JumpFixup sJumpFix;` |
|         - |  261 | `	sxi32 rc;` |
|         - |  262 | `	/* Init the JumpFixup structure */` |
|   4716271 |  263 | `	sJumpFix.nJumpType = nJumpType;` |
|   4716271 |  264 | `	sJumpFix.nInstrIdx = nInstrIdx;` |
|         - |  265 | `	/* Insert in the jump fixup table */` |
|   4716271 |  266 | `	rc = SySetPut(&pBlock->aJumpFix,(const void *)&sJumpFix);` |
|   4716271 |  267 | `	return rc;` |
|         5 |  268 | `}` |
|         - |  269 | `/*` |
...
|         - |  279 | ` */` |
|   9078472 |  280 | `PH7_PRIVATE sxu32 GenStateFixJumps(GenBlock *pBlock,sxi32 nJumpType,sxu32 nJumpDest)` |
|         5 |  281 | `{` |
|         - |  282 | `	JumpFixup *aFix;` |
|         - |  283 | `	VmInstr *pInstr;` |
|         - |  284 | `	sxu32 nFixed;` |
...
|   9078477 |  287 | `	aFix = (JumpFixup *)SySetBasePtr(&pBlock->aJumpFix);` |
|         - |  288 | `	/* Fix the desired jumps */` |
|  19002819 |  289 | `	for( nFixed = n = 0 ; n < SySetUsed(&pBlock->aJumpFix) ; ++n ){` |
|   9924347 |  290 | `		if( aFix[n].nJumpType < 0 ){` |
|         - |  291 | `			/* Already fixed */` |
|   3705643 |  292 | `			continue;` |
|         - |  293 | `		}` |
|   6218709 |  294 | `		if( nJumpType > 0 && aFix[n].nJumpType != nJumpType ){` |
|         - |  295 | `			/* Not of our interest */` |
|   1502445 |  296 | `			continue;` |
|         - |  297 | `		}` |
|         - |  298 | `		/* Point to the instruction to fix */` |
|   4716269 |  299 | `		pInstr = PH7_VmGetInstr(pBlock->pGen->pVm,aFix[n].nInstrIdx);` |
|   4716269 |  300 | `		if( pInstr ){` |
|   4716269 |  301 | `			pInstr->iP2 = nJumpDest;` |
|   4716269 |  302 | `			nFixed++;` |
|         - |  303 | `			/* Mark as fixed */` |
|   4716269 |  304 | `			aFix[n].nJumpType = -1;` |
|   2358132 |  305 | `		}` |
|   2358137 |  306 | `	}` |
|         - |  307 | `	/* Total number of fixed jumps */` |
|   9078477 |  308 | `	return nFixed;` |
|         5 |  309 | `}` |
|         - |  310 | `/*` |
...
|         - |  316 | ` */` |
|   3361232 |  317 | `PH7_PRIVATE sxi32 GenStateFixGoto(ph7_gen_state *pGen,sxu32 nOfft)` |
|         5 |  318 | `{` |
...
|   3361237 |  325 | `	aJumps = (JumpFixup *)SySetBasePtr(&pGen->aGoto);` |
|         - |  326 | `	/* Fix */` |
|   3361383 |  327 | `	for( n = nOfft ; n < SySetUsed(&pGen->aGoto) ; ++n ){` |
...
|   3361235 |  378 | `	return SXRET_OK;` |
|   1680621 |  379 | `}` |
|         - |  380 | `/*` |
|         - |  381 | ` * Check if a given token value is installed in the literal table.` |
|         - |  382 | ` */` |
|  16838468 |  383 | `PH7_PRIVATE sxi32 GenStateFindLiteral(ph7_gen_state *pGen,const SyString *pValue,sxu32 *pIdx)` |
|         5 |  384 | `{` |
|         - |  385 | `	SyHashEntry *pEntry;` |
|  16838473 |  386 | `	pEntry = SyHashGet(&pGen->hLiteral,(const void *)pValue->zString,pValue->nByte);` |
|  16838473 |  387 | `	if( pEntry == 0 ){` |
|   4488975 |  388 | `		return SXERR_NOTFOUND;` |
|         - |  389 | `	}` |
|  12349503 |  390 | `	*pIdx = (sxu32)SX_PTR_TO_INT(pEntry->pUserData);` |
|  12349503 |  391 | `	return SXRET_OK;` |
|   8419239 |  392 | `}` |
|         - |  393 | `/*` |
...
|         - |  402 | ` */` |
|   4488970 |  403 | `PH7_PRIVATE sxi32 GenStateInstallLiteral(ph7_gen_state *pGen,ph7_value *pObj,sxu32 nIdx)` |
|         5 |  404 | `{` |
|   4488975 |  405 | `	if( SyBlobLength(&pObj->sBlob) > 0 ){` |
|   4488975 |  406 | `		SyHashInsert(&pGen->hLiteral,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob),SX_INT_TO_PTR(nIdx));` |
|   2244485 |  407 | `	}` |
|   4488975 |  408 | `	return SXRET_OK;` |
|         5 |  409 | `}` |
|         - |  410 | `/*` |
|         - |  411 | ` * Reserve a room for a numeric constant [i.e: 64-bit integer or real number]` |
|         - |  412 | ` * in the constant table.` |
|         - |  413 | ` */` |
|   3807054 |  414 | `PH7_PRIVATE ph7_value * GenStateInstallNumLiteral(ph7_gen_state *pGen,sxu32 *pIdx)` |
|         5 |  415 | `{` |
|         - |  416 | `	ph7_value *pObj;` |
|   3807059 |  417 | `	sxu32 nIdx = 0; /* cc warning */` |
|         - |  418 | `	/* Reserve a new constant */` |
|   3807059 |  419 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   3807059 |  420 | `	if( pObj == 0 ){` |
|       ! 0 |  421 | `		PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|       ! 0 |  422 | `		return 0;` |
|         - |  423 | `	}` |
|   3807059 |  424 | `	*pIdx = nIdx;` |
|         - |  425 | `	/* TODO(chems): Create a numeric table (64bit int keys) same as` |
|         - |  426 | `	 * the constant string iterals table [optimization purposes].` |
|         - |  427 | `	 */` |
|   3807059 |  428 | `	return pObj;` |
|   1903532 |  429 | `}` |
|         - |  430 | `/*` |
...
|         - |  443 | ` */` |
|   7922170 |  444 | `PH7_PRIVATE void *GenStateAttachStrictFlag(ph7_gen_state *pGen, void *p3)` |
|         5 |  445 | `{` |
|         - |  446 | `	VmCallArgMap *pMap;` |
|   7922175 |  447 | `	if( !pGen->bStrictTypes ) return p3;` |
|        58 |  448 | `	if( p3 == 0 ){` |
...
|         - |  475 | ` */` |
|    340832 |  476 | `PH7_PRIVATE int GenStateIsReservedConstant(SyString *pName)` |
|         5 |  477 | `{` |
|    340837 |  478 | `	if( pName->nByte == sizeof("null") - 1 ){` |
|      3917 |  479 | `		if( SyStrnicmp(pName->zString,"null",sizeof("null")-1) == 0 ){` |
|         3 |  480 | `			return TRUE;` |
|      3915 |  481 | `		}else if( SyStrnicmp(pName->zString,"true",sizeof("true")-1) == 0 ){` |
|         5 |  482 | `			return TRUE;` |
|         5 |  483 | `		}` |
|    338878 |  484 | `	}else if( pName->nByte == sizeof("false") - 1 ){` |
|      7769 |  485 | `		if( SyStrnicmp(pName->zString,"false",sizeof("false")-1) == 0 ){` |
|         3 |  486 | `			return TRUE;` |
|         - |  487 | `		}` |
|      3881 |  488 | `	}` |
|         - |  489 | `	/* Not a reserved constant */` |
|    340829 |  490 | `	return FALSE;` |
|    170421 |  491 | `}` |
|         - |  492 | `/*` |
...
|         - |  507 | ` */` |
|  53816686 |  508 | `static void GenStatePatchNullsafeJumps(ph7_gen_state *pGen, sxu32 nBaseline)` |
|         5 |  509 | `{` |
|  53816691 |  510 | `	sxu32 nCur = SySetUsed(&pGen->aNullsafeJmp);` |
|         - |  511 | `	sxu32 nTarget;` |
|         - |  512 | `	sxu32 *aIdx;` |
|         - |  513 | `	sxu32 i;` |
|  53816691 |  514 | `	if( nCur <= nBaseline ){` |
|  53816595 |  515 | `		return;` |
|         - |  516 | `	}` |
...
|         - |  544 | ` */` |
|   7036094 |  545 | `static sxu32 GenStateByRefBuiltinMask(SyString *pName)` |
|         5 |  546 | `{` |
...
|         - |  562 | `	};` |
|         - |  563 | `	sxu32 i;` |
|   7036099 |  564 | `	if( pName == 0 \|\| pName->zString == 0 \|\| pName->nByte == 0 ){` |
|   1801233 |  565 | `		return 0;` |
|         - |  566 | `	}` |
|  57102403 |  567 | `	for( i = 0 ; i < SX_ARRAYSIZE(aByRef) ; ++i ){` |
|  51925752 |  568 | `		if( pName->nByte == aByRef[i].nByte` |
|  27474108 |  569 | `		 && SyStrnicmp(pName->zString, aByRef[i].zName, pName->nByte) == 0 ){` |
|     58225 |  570 | `			return aByRef[i].mask;` |
|         - |  571 | `		}` |
|  25933771 |  572 | `	}` |
|   5176651 |  573 | `	return 0;` |
|   3518052 |  574 | `}` |
|         - |  575 | `/*` |
...
|         - |  584 | ` */` |
|   7036094 |  585 | `static void GenStateCallBuiltinName(ph7_expr_node *pLeft, SyString *pOut)` |
|         5 |  586 | `{` |
|         - |  587 | `	SyToken *p, *pEnd;` |
|   7036099 |  588 | `	pOut->zString = 0;` |
|   7036099 |  589 | `	pOut->nByte = 0;` |
|   7036099 |  590 | `	if( pLeft == 0 \|\| pLeft->pStart == 0 \|\| pLeft->pEnd == 0 ){` |
|       ! 0 |  591 | `		return;` |
|         - |  592 | `	}` |
|   7036099 |  593 | `	p = pLeft->pStart;` |
|   7036099 |  594 | `	pEnd = pLeft->pEnd;` |
|         - |  595 | `	/* Optional single leading namespace separator (absolute path). */` |
|   7036099 |  596 | `	if( p < pEnd && (p->nType & PH7_TK_NSSEP) ){` |
|      3913 |  597 | `		p++;` |
|      1954 |  598 | `	}` |
|   7036099 |  599 | `	if( p >= pEnd \|\| (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|   1801183 |  600 | `		return;` |
|         - |  601 | `	}` |
|         - |  602 | `	/* Must be a single component: nothing follows the name token. */` |
|   5234921 |  603 | `	if( p + 1 != pEnd ){` |
|        55 |  604 | `		return;` |
|         - |  605 | `	}` |
|   5234871 |  606 | `	*pOut = p->sData;` |
|   3518052 |  607 | `}` |
|         - |  608 | `/*` |
...
|         - |  613 | ` * error message.` |
|         - |  614 | ` */` |
|  75880996 |  615 | `static sxi32 GenStateEmitExprCode(` |
...
|         - |  621 | `	VmInstr *pInstr;` |
|         - |  622 | `	sxu32 nJmpIdx;` |
|  75881001 |  623 | `	sxi32 iP1 = 0;` |
|  75881001 |  624 | `	sxu32 iP2 = 0;` |
|  75881001 |  625 | `	void *p3  = 0;` |
|         - |  626 | `	sxi32 iVmOp;` |
|         - |  627 | `	sxi32 rc;` |
|  75881001 |  628 | `	int bIsChainOp = 0; /* Set below once we know pNode->pOp */` |
|  75881001 |  629 | ``	int bFcc = 0;       /* First-class callable `f(...)`: emit OP_LOAD_FCC, not OP_CALL */`` |
|  75881001 |  630 | `	sxu32 nRhsNsBase = 0;` |
|  75881001 |  631 | `	if( pNode->xCode ){` |
|         - |  632 | `		SyToken *pTmpIn,*pTmpEnd;` |
|         - |  633 | `		/* Compile node */` |
|  45798697 |  634 | `		SWAP_DELIMITER(pGen,pNode->pStart,pNode->pEnd);` |
|  45798697 |  635 | `		rc = pNode->xCode(&(*pGen),iFlags);` |
|  45798697 |  636 | `		RE_SWAP_DELIMITER(pGen);` |
|  45798697 |  637 | `		return rc;` |
|         - |  638 | `	}` |
|  30082309 |  639 | `	if( pNode->pOp == 0 ){` |
...
|         - |  643 | `	}` |
|  30082309 |  644 | `	iVmOp = pNode->pOp->iVmOp;` |
|  30082309 |  645 | `	if( iVmOp == PH7_OP_CVT_NULL ){` |
...
|         - |  653 | `		}` |
|         1 |  654 | `	}` |
|  30082309 |  655 | `	if( pNode->pOp->iOp == EXPR_OP_NULLC_ASSIGN ){` |
|        93 |  656 | `		sxu32 nJmp = 0;` |
|         - |  657 | `		sxu32 nNcNsBase;` |
...
|         - |  704 | `	}` |
|  30082219 |  705 | `	if( pNode->pOp->iOp == EXPR_OP_QUESTY ){` |
|         - |  706 | `		sxu32 nJz,nJmp;` |
|         - |  707 | `		sxu32 nTernaryNsBase;` |
|         - |  708 | `		/* Ternary operator require special handling */` |
|         - |  709 | `		/* Phase#1: Compile the condition */` |
|    502507 |  710 | `		nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|    502507 |  711 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pCond,iFlags);` |
|    502507 |  712 | `		if( rc != SXRET_OK ){` |
|       ! 0 |  713 | `			return rc;` |
|         - |  714 | `		}` |
...
|    502507 |  718 | `		GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|    502507 |  719 | `		nJz = nJmp = 0; /* cc -O6 warning */` |
|    502507 |  720 | `		if( pNode->pLeft ){` |
|         - |  721 | `			/* Standard ternary: (expr) ? (then) : (else) */` |
|         - |  722 | `			/* Phase#2: Emit the false jump (pops condition) */` |
|    498567 |  723 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nJz);` |
|         - |  724 | `			/* Phase#3: Compile the 'then' expression  */` |
|    498567 |  725 | `			nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|    498567 |  726 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pLeft,iFlags);` |
|    498567 |  727 | `			if( rc != SXRET_OK ){` |
|       ! 0 |  728 | `				return rc;` |
|         - |  729 | `			}` |
|    498567 |  730 | `			GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|    249286 |  731 | `		}else{` |
...
|      3945 |  735 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_DUP,0,0,0,0);` |
|      3945 |  736 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nJz);` |
|         - |  737 | `		}` |
|         - |  738 | `		/* Phase#4: Emit the unconditional jump */` |
|    502507 |  739 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,0,0,&nJmp);` |
|         - |  740 | `		/* Phase#5: Fix the false jump now the jump destination is resolved. */` |
|    502507 |  741 | `		pInstr = PH7_VmGetInstr(pGen->pVm,nJz);` |
|    502507 |  742 | `		if( pInstr ){` |
|    502507 |  743 | `			pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    251251 |  744 | `		}` |
|    502507 |  745 | `		if( !pNode->pLeft ){` |
|         - |  746 | `			/* Elvis operator: discard the falsy condition value before evaluating 'else' */` |
|      3945 |  747 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|      1970 |  748 | `		}` |
|         - |  749 | `		/* Phase#6: Compile the 'else' expression */` |
|    502507 |  750 | `		if( pNode->pRight ){` |
|    502507 |  751 | `			nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|    502507 |  752 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pRight,iFlags);` |
|    502507 |  753 | `			if( rc != SXRET_OK ){` |
|       ! 0 |  754 | `				return rc;` |
|         - |  755 | `			}` |
|    502507 |  756 | `			GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|    251251 |  757 | `		}` |
|    502507 |  758 | `		if( nJmp > 0 ){` |
|         - |  759 | `			/* Phase#7: Fix the unconditional jump */` |
|    502507 |  760 | `			pInstr = PH7_VmGetInstr(pGen->pVm,nJmp);` |
|    502507 |  761 | `			if( pInstr ){` |
|    502507 |  762 | `				pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    251251 |  763 | `			}` |
|    251251 |  764 | `		}` |
|         - |  765 | `		/* All done */` |
|    502507 |  766 | `		return SXRET_OK;` |
|         - |  767 | `	}` |
|  29579717 |  768 | `	if( pNode->pOp->iOp == EXPR_OP_PIPE ){` |
...
|         - |  800 | `	}` |
|  29579691 |  801 | `	bIsChainOp = GEN_IS_CHAIN_OP(pNode->pOp->iOp);` |
|         - |  802 | `	/* Generate code for the left tree */` |
|  29579691 |  803 | `	if( pNode->pLeft ){` |
|  29525699 |  804 | `		sxu32 nLhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  29525699 |  805 | `		if( iVmOp == PH7_OP_CALL ){` |
|         - |  806 | `			ph7_expr_node **apNode;` |
|   7040315 |  807 | `			int hasSpread = 0;` |
|   7040315 |  808 | `			int hasNamed = 0;` |
|   7040315 |  809 | `			int bAnySpread = 0;` |
|   7040315 |  810 | `			sxu32 byRefMask = 0;` |
|         - |  811 | `			sxi32 nArgs;` |
|         - |  812 | `			sxi32 n;` |
|         - |  813 | `			/* Recurse and generate bytecodes for function arguments */` |
|   7040315 |  814 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|   7040315 |  815 | `			nArgs = (sxi32)SySetUsed(&pNode->aNodeArgs);` |
...
|   7040315 |  819 | `			if( nArgs == 1 && apNode[0] && (apNode[0]->iFlags & EXPR_NODE_FCC) ){` |
|        84 |  820 | `				bFcc = 1;` |
|        84 |  821 | `				nArgs = 0;` |
|        41 |  822 | `			}` |
...
|         - |  825 | `			{` |
|   7040315 |  826 | `				int seenNamed = 0;` |
|   7040315 |  827 | `				int seenSpread = 0;` |
|  15035155 |  828 | `				for( n = 0; n < nArgs; ++n ){` |
|   7994847 |  829 | `					if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
|      4073 |  830 | `						bAnySpread = 1;` |
|      4073 |  831 | `						seenSpread = 1;` |
|      4073 |  832 | `						if( apNode[n]->iFlags & EXPR_NODE_NAMED_ARG ){` |
...
|         5 |  836 | `						}` |
|   7992813 |  837 | `					}else if( apNode[n]->iFlags & EXPR_NODE_NAMED_ARG ){` |
|       300 |  838 | `						seenNamed = 1;` |
|       300 |  839 | `						hasNamed = 1;` |
|   7990631 |  840 | `					}else if( seenNamed ){` |
...
|   7990481 |  844 | `					}else if( seenSpread ){` |
...
|         - |  850 | `			}` |
|         - |  851 | `			/* Read-only load */` |
|   7040313 |  852 | `			iFlags \|= EXPR_FLAG_RDONLY_LOAD;` |
...
|   7040313 |  857 | `			if( pNode->pLeft && pNode->pLeft->pStart ){` |
|   7040313 |  858 | `				SyString *pCallName = &pNode->pLeft->pStart->sData;` |
|  10952809 |  859 | `				int bIsset = pCallName->nByte == 5` |
|   7040308 |  860 | `					&& SyStrnicmp(pCallName->zString,"isset",5) == 0;` |
|  10952809 |  861 | `				int bEmpty = pCallName->nByte == 5` |
|   7040308 |  862 | `					&& SyStrnicmp(pCallName->zString,"empty",5) == 0;` |
...
|   7040313 |  869 | `				if( (bIsset \|\| bEmpty) && nArgs < 1 ){` |
...
|         - |  879 | `				}` |
|   7040309 |  880 | `				if( bIsset ){` |
|    325513 |  881 | `					iFlags \|= EXPR_FLAG_LOAD_IDX_ISSET;` |
|   6877555 |  882 | `				}else if( bEmpty ){` |
...
|   7040309 |  891 | `				if( !bAnySpread && !hasNamed ){` |
|         - |  892 | `					SyString sBuiltin;` |
|   7036099 |  893 | `					GenStateCallBuiltinName(pNode->pLeft, &sBuiltin);` |
|   7036099 |  894 | `					byRefMask = GenStateByRefBuiltinMask(&sBuiltin);` |
|   3518047 |  895 | `				}` |
|   3520152 |  896 | `			}` |
|  15035145 |  897 | `			for( n = 0 ; n < nArgs ; ++n ){` |
|   7994843 |  898 | `				sxu32 nArgNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|   7994843 |  899 | `				sxi32 iArgFlags = iFlags & ~(EXPR_FLAG_LOAD_IDX_STORE\|EXPR_FLAG_MEMBER_WRITE);` |
...
|   7994843 |  906 | `				if( n < 31 && (byRefMask & (1u<<n)) ){` |
|     38791 |  907 | `					iArgFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|     38791 |  908 | `					iArgFlags \|= EXPR_FLAG_LOAD_IDX_STORE;` |
|     19393 |  909 | `				}` |
...
|   7994838 |  920 | `				if( (iFlags & (EXPR_FLAG_LOAD_IDX_ISSET\|EXPR_FLAG_LOAD_IDX_EMPTY\|EXPR_FLAG_LOAD_IDX_UNSET)) == 0` |
|   7832009 |  921 | `				 && apNode[n]->pOp == 0 && apNode[n]->xCode == PH7_CompileVariable` |
|   4104462 |  922 | `				 && (apNode[n]->iFlags & (EXPR_NODE_NAMED_ARG\|EXPR_NODE_SPREAD)) == 0 ){` |
|   3354197 |  923 | `					iArgFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|   1677096 |  924 | `				}` |
|   7994843 |  925 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iArgFlags);` |
|   7994843 |  926 | `				if( rc != SXRET_OK ){` |
|         3 |  927 | `					return rc;` |
|         - |  928 | `				}` |
|         - |  929 | `				/* Each argument is an independent nullsafe scope. */` |
|   7994841 |  930 | `				GenStatePatchNullsafeJumps(pGen, nArgNsBase);` |
|   7994841 |  931 | `				if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
|         - |  932 | `					/* Emit spread opcode to unpack this array argument */` |
|      4073 |  933 | `					PH7_VmEmitInstr(pGen->pVm, PH7_OP_SPREAD, 0, 0, 0, 0);` |
|      4073 |  934 | `					hasSpread = 1;` |
|      2034 |  935 | `				}` |
|   3997423 |  936 | `			}` |
|         - |  937 | `			/* Total number of given arguments */` |
|   7040307 |  938 | `			iP1 = nArgs;` |
|   7040307 |  939 | `			iP2 = hasSpread;` |
|         - |  940 | `			/* Build VmCallArgMap if named arguments are present.` |
|         - |  941 | `			 * Deep-copy name strings so they survive token stream cleanup. */` |
|   7040307 |  942 | `			if( hasNamed ){` |
...
|   7040307 |  974 | `			iFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|   3520151 |  975 | `		}` |
|         - |  976 | `		{` |
...
|  29525691 |  985 | `			sxi32 iLeftFlags = iFlags;` |
|  29525691 |  986 | `			sxu32 nNullcLhsFirst = PH7_VmInstrLength(pGen->pVm);` |
|  29525691 |  987 | `			int bNullcLhs = 0;` |
|  29525686 |  988 | `			if( pNode->pLeft && pNode->pLeft->pOp` |
|  23973193 |  989 | `				&& (pNode->pLeft->pOp->iOp == EXPR_OP_ARROW` |
|   9210376 |  990 | `					\|\| pNode->pLeft->pOp->iOp == EXPR_OP_NULLSAFE_ARROW` |
|   7928821 |  991 | `					\|\| pNode->pLeft->pOp->iOp == EXPR_OP_DC) ){` |
|   2772713 |  992 | `				iLeftFlags &= ~EXPR_FLAG_LOAD_IDX_UNSET;` |
|   1386354 |  993 | `			}` |
...
|  29525686 | 1001 | `			if( pNode->pOp` |
|  41510109 | 1002 | `				&& (pNode->pOp->iOp == EXPR_OP_ARROW` |
|  26747313 | 1003 | `					\|\| pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW` |
|  23968888 | 1004 | `					\|\| pNode->pOp->iOp == EXPR_OP_DC) ){` |
|   5975889 | 1005 | `				iLeftFlags &= ~EXPR_FLAG_MEMBER_WRITE;` |
|   2987942 | 1006 | `			}` |
...
|  29525686 | 1013 | `			if( pNode->pOp` |
|  29525691 | 1014 | `				&& (pNode->pOp->iVmOp == PH7_OP_INCR \|\| pNode->pOp->iVmOp == PH7_OP_DECR) ){` |
|    217181 | 1015 | `				iLeftFlags \|= EXPR_FLAG_LOAD_IDX_STORE \| EXPR_FLAG_MEMBER_WRITE` |
...
|  29525691 | 1025 | `			if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLC && pNode->pLeft ){` |
...
|     58241 | 1030 | `				iLeftFlags \|= EXPR_FLAG_QUIET_VAR;` |
|     58241 | 1031 | `				bNullcLhs = 1;` |
|     58236 | 1032 | `				if( pNode->pLeft->pOp` |
|     87290 | 1033 | `					&& (pNode->pLeft->pOp->iOp == EXPR_OP_ARROW` |
|     58178 | 1034 | `						\|\| pNode->pLeft->pOp->iOp == EXPR_OP_NULLSAFE_ARROW` |
|     58161 | 1035 | `						\|\| pNode->pLeft->pOp->iOp == EXPR_OP_DC) ){` |
...
|        18 | 1043 | `				}` |
|     29118 | 1044 | `			}` |
|  29525691 | 1045 | `			if( iVmOp == PH7_OP_ERR_CTRL ){` |
...
|     15735 | 1048 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_ERR_CTRL,1,0,0,0);` |
|      7865 | 1049 | `			}` |
|  29525691 | 1050 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pLeft,iLeftFlags\|EXPR_FLAG_RDONLY_LOAD);` |
|  29525691 | 1051 | `			if( rc == SXRET_OK && bNullcLhs ){` |
...
|     58241 | 1060 | `				sxu32 nEnd = PH7_VmInstrLength(pGen->pVm);` |
|         - | 1061 | `				sxu32 nAt;` |
|    325835 | 1062 | `				for( nAt = nNullcLhsFirst ; nAt < nEnd ; ++nAt ){` |
|    267599 | 1063 | `					VmInstr *pFix = PH7_VmGetInstr(pGen->pVm,nAt);` |
|    267599 | 1064 | `					if( pFix && pFix->iOp == PH7_OP_LOAD_IDX && pFix->iP2 == 0 ){` |
|     58143 | 1065 | `						pFix->iP2 = 8;` |
|     29069 | 1066 | `					}` |
|    133802 | 1067 | `				}` |
|     29118 | 1068 | `			}` |
|         - | 1069 | `		}` |
|  29525691 | 1070 | `		if( rc != SXRET_OK ){` |
|        32 | 1071 | `			return rc;` |
|         - | 1072 | `		}` |
|  29525663 | 1073 | `		if( !bIsChainOp ){` |
...
|  13491185 | 1076 | `			GenStatePatchNullsafeJumps(pGen, nLhsNsBase);` |
|   6745590 | 1077 | `		}` |
|  29525663 | 1078 | `		if( iVmOp == PH7_OP_CALL ){` |
|   7040307 | 1079 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|   7040307 | 1080 | `			if( pInstr ){` |
|   7040307 | 1081 | `				if ( pInstr->iOp == PH7_OP_LOADC ){` |
|   5235179 | 1082 | `					sxu32 nOrig = (sxu32)pInstr->iP2;` |
|         - | 1083 | `					sxu32 nQual;` |
|   5235179 | 1084 | `					int bAbsolute = (pInstr->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|         - | 1085 | `					/* Prevent constant expansion but preserve the absolute flag` |
|         - | 1086 | `					 * so the later NEW handler (if any) can see it. */` |
|   5235179 | 1087 | `					pInstr->iP1 &= ~PH7_LOADC_EXPAND;` |
...
|   5235179 | 1095 | `					if( bAbsolute ){` |
|      3913 | 1096 | `						pInstr->iP2 = (sxi32)nOrig;` |
|      1959 | 1097 | `					}else{` |
|   5231271 | 1098 | `						int fromImport = 0;` |
|   5231271 | 1099 | `						nQual = GenStateNsQualifyName(pGen,nOrig,&pGen->hUseFuncImports,&fromImport);` |
|   5231271 | 1100 | `						pInstr->iP2 = (sxi32)nQual;` |
|   5231271 | 1101 | `						if( nQual != nOrig ){` |
...
|        49 | 1122 | `						}` |
|         - | 1123 | `					}` |
|   4422720 | 1124 | `				}else if( (pInstr->iOp == PH7_OP_MEMBER /* $a->b(1,2,3) */` |
|   1795093 | 1125 | `						&& !(pNode->pLeft && (pNode->pLeft->iFlags & EXPR_NODE_PARENS)))` |
|    912608 | 1126 | `					\|\| pInstr->iOp == PH7_OP_NEW ){` |
...
|   1785061 | 1142 | `					if( pInstr->iOp == PH7_OP_MEMBER && pInstr->iP1 == 1 && pInstr->p3 ){` |
...
|    892528 | 1148 | `				}` |
|   3520156 | 1149 | `			}` |
|  26005512 | 1150 | `		}else if( iVmOp == PH7_OP_LOAD_IDX ){` |
|         - | 1151 | `			ph7_expr_node **apNode;` |
|         - | 1152 | `			sxi32 n;` |
|   3018297 | 1153 | `			sxi32 iChildMask = ~(EXPR_FLAG_LOAD_IDX_STORE` |
...
|   3018297 | 1158 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|   5800069 | 1159 | `			for( n = 0 ; n < (sxi32)SySetUsed(&pNode->aNodeArgs) ; ++n ){` |
|   2781777 | 1160 | `				sxu32 nIdxNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|   2781777 | 1161 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iFlags&iChildMask);` |
|   2781777 | 1162 | `				if( rc != SXRET_OK ){` |
|       ! 0 | 1163 | `					return rc;` |
|         - | 1164 | `				}` |
|         - | 1165 | `				/* Each subscript index is an independent nullsafe scope. */` |
|   2781777 | 1166 | `				GenStatePatchNullsafeJumps(pGen, nIdxNsBase);` |
|   1390891 | 1167 | `			}` |
|   3018297 | 1168 | `			if( SySetUsed(&pNode->aNodeArgs) > 0 ){` |
|   2781777 | 1169 | `				iP1 = 1; /* Node have an index associated with it */` |
|   1390886 | 1170 | `			}` |
|   3018297 | 1171 | `			if( iFlags & EXPR_FLAG_LOAD_IDX_ISSET ){` |
|         - | 1172 | `				/* offsetExists for ArrayAccess; peek-only for arrays */` |
|    371821 | 1173 | `				iP2 = 4;` |
|   2832389 | 1174 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_UNSET ){` |
|         - | 1175 | `				/* offsetUnset for ArrayAccess; auto-vivify+load for arrays` |
|         - | 1176 | `				 * so the trailing unset() builtin can drop the slot. */` |
|     23303 | 1177 | `				iP2 = 5;` |
|   2634832 | 1178 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_EMPTY ){` |
...
|        35 | 1182 | `				iP2 = 6;` |
|   2623168 | 1183 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_STORE ){` |
|         - | 1184 | `				/* Create an empty entry when the desired index is not found */` |
|    554349 | 1185 | `				iP2 = 1;` |
|    277177 | 1186 | `			}` |
|  20976215 | 1187 | `		}else if( pNode->pOp->iOp == EXPR_OP_COMMA ){` |
|         - | 1188 | `			/* POP the left node */` |
|         5 | 1189 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|         2 | 1190 | `		}` |
|  14762829 | 1191 | `	}` |
|  29579655 | 1192 | `	rc = SXRET_OK;` |
|  29579655 | 1193 | `	nJmpIdx = 0;` |
...
|  29579655 | 1197 | `	if( iVmOp == PH7_OP_MEMBER && pNode->pOp->iOp == EXPR_OP_DC ){` |
|    465487 | 1198 | `		pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|    465487 | 1199 | `		if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|    465487 | 1200 | `			ph7_value *pLitCheck = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,(sxu32)pInstr->iP2);` |
|    465487 | 1201 | `			int isSpecial = 0;` |
|    465487 | 1202 | `			if( pLitCheck && (pLitCheck->iFlags & MEMOBJ_STRING) ){` |
|    372555 | 1203 | `				const char *z = (const char *)SyBlobData(&pLitCheck->sBlob);` |
|    372555 | 1204 | `				sxu32 n = (sxu32)SyBlobLength(&pLitCheck->sBlob);` |
|    372550 | 1205 | `				if( (n == 4 && SyMemcmp(z,"self",4) == 0) \|\|` |
|    347311 | 1206 | `					(n == 6 && SyMemcmp(z,"static",6) == 0) \|\|` |
|    188166 | 1207 | `					(n == 6 && SyMemcmp(z,"parent",6) == 0) ){` |
|    147261 | 1208 | `					isSpecial = 1;` |
|     73628 | 1209 | `				}` |
|    209508 | 1210 | `			}` |
|    511953 | 1211 | `			pInstr->iP1 = 0;` |
...
|         - | 1217 | `			{` |
|    721461 | 1218 | `				int bAbsolute = (pNode->pLeft && pNode->pLeft->pStart` |
|    628524 | 1219 | `					&& (pNode->pLeft->pStart->nType & PH7_TK_NSSEP));` |
|    419021 | 1220 | `				if( !isSpecial && !bAbsolute ){` |
|    271747 | 1221 | `					pInstr->iP2 = (sxi32)GenStateNsQualifyName(pGen,(sxu32)pInstr->iP2,&pGen->hUseImports,0);` |
|    135871 | 1222 | `				}` |
|         - | 1223 | `			}` |
...
|    419021 | 1226 | `			if( !isSpecial && pNode->pRight && pNode->pRight->pStart ){` |
|    271765 | 1227 | `				SyToken *pRightTok = pNode->pRight->pStart;` |
|    271765 | 1228 | `				if( (pRightTok->nType & PH7_TK_KEYWORD) &&` |
...
|  29533133 | 1236 | `	if( pNode->pRight ){` |
|  16961467 | 1237 | `		if( iVmOp == PH7_OP_LAND ){` |
|         - | 1238 | `			/* Emit the false jump so we can short-circuit the logical and */` |
|    449425 | 1239 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,1/* Keep the value on the stack */,0,0,&nJmpIdx);` |
|  16736757 | 1240 | `		}else if (iVmOp == PH7_OP_LOR ){` |
|         - | 1241 | `			/* Emit the true jump so we can short-circuit the logical or*/` |
|    325203 | 1242 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JNZ,1/* Keep the value on the stack */,0,0,&nJmpIdx);` |
|  16349448 | 1243 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLC ){` |
|         - | 1244 | `			/* Null coalescing: if LHS is not null, jump past RHS */` |
|     58241 | 1245 | `			iVmOp = 0; /* No binary operator to emit */` |
|     58241 | 1246 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_NULLC,0,0,0,&nJmpIdx);` |
|  16157783 | 1247 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW ){` |
...
|  16128561 | 1257 | `		}else if( pNode->pOp->iPrec == 18 /* Combined binary operators [i.e: =,'.=','+=',*=' ...] precedence */ ){` |
...
|   5201913 | 1261 | `			iFlags \|= EXPR_FLAG_LOAD_IDX_STORE \| EXPR_FLAG_MEMBER_WRITE;` |
|   5201913 | 1262 | `			if( iVmOp != PH7_OP_STORE ){` |
...
|    449287 | 1266 | `				iFlags \|= EXPR_FLAG_RMW_LOAD;` |
|    224641 | 1267 | `			}` |
|   2600954 | 1268 | `		}` |
|  16961467 | 1269 | `		nRhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  16961467 | 1270 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pRight,iFlags\|EXPR_FLAG_RDONLY_LOAD);` |
|  16961467 | 1271 | `		if( !bIsChainOp ){` |
|         - | 1272 | `			/* Non-chain parent: RHS nullsafe chain ends here, before the` |
|         - | 1273 | `			 * operator instruction is emitted. */` |
|  10985657 | 1274 | `			GenStatePatchNullsafeJumps(pGen, nRhsNsBase);` |
|   5492826 | 1275 | `		}` |
|  16961467 | 1276 | `		if( iVmOp == PH7_OP_STORE ){` |
|   4752631 | 1277 | `			if( pNode->pRight && (pNode->pRight->xCode == PH7_CompileList \|\|` |
|   4752594 | 1278 | `				pNode->pRight->xCode == PH7_CompileShortList) ){` |
...
|         - | 1284 | `				 */` |
|        99 | 1285 | `				iVmOp = 0;` |
|   4752584 | 1286 | `			}else if( (pInstr = PH7_VmPeekInstr(pGen->pVm)) != 0 ){` |
|   4752537 | 1287 | `				if(pInstr->iOp == PH7_OP_MEMBER ){` |
|         - | 1288 | `					/* Perform a member store operation [i.e: $this->x = 50] */` |
|    917965 | 1289 | `					iP2 = 1;` |
|    458985 | 1290 | `				}else{` |
|   3834577 | 1291 | `					if( pInstr->iOp == PH7_OP_LOAD_IDX ){` |
|         - | 1292 | `						/* Transform the STORE instruction to STORE_IDX instruction */` |
|    534899 | 1293 | `						iVmOp = PH7_OP_STORE_IDX;` |
|    534899 | 1294 | `						iP1 = pInstr->iP1;` |
|    267452 | 1295 | `					}else{` |
|   3299683 | 1296 | `						p3 = pInstr->p3;` |
|         - | 1297 | `					}` |
|         - | 1298 | `					/* POP the last dynamic load instruction */` |
|   3834577 | 1299 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|         - | 1300 | `				}` |
|   2376271 | 1301 | `			}` |
|  14585154 | 1302 | `		}else if( iVmOp == PH7_OP_STORE_REF ){` |
...
|        35 | 1329 | `		}` |
|   8480731 | 1330 | `	}` |
|  29533128 | 1331 | `	if( iVmOp == PH7_OP_NEW && pNode->pLeft && pNode->pLeft->pOp == 0` |
|    431429 | 1332 | `		&& pNode->pLeft->xCode == PH7_CompileAnnonClass ){` |
...
|        34 | 1335 | `		iVmOp = 0;` |
|        15 | 1336 | `	}` |
|  29533133 | 1337 | `	if( iVmOp > 0 ){` |
|  29474769 | 1338 | `		if( iVmOp == PH7_OP_INCR \|\| iVmOp == PH7_OP_DECR ){` |
|    217181 | 1339 | `			if( pNode->iFlags & EXPR_NODE_PRE_INCR ){` |
|         - | 1340 | `				/* Pre-increment/decrement operator [i.e: ++$i,--$j ] */` |
|     15513 | 1341 | `				iP1 = 1;` |
|      7759 | 1342 | `			}` |
|  29366181 | 1343 | `		}else if( iVmOp == PH7_OP_NEW ){` |
|         - | 1344 | `			/* Namespace-qualify the class name for NEW */ {` |
|    866045 | 1345 | `				VmInstr *pPeek = PH7_VmPeekInstr(pGen->pVm);` |
|    866045 | 1346 | `				VmInstr *pCallInstr = 0;` |
|    866045 | 1347 | `				if( pPeek && pPeek->iOp == PH7_OP_CALL ){` |
|    854209 | 1348 | `					pCallInstr = pPeek;` |
|    854209 | 1349 | `					pPeek = PH7_VmPeekNextInstr(pGen->pVm);` |
|    427102 | 1350 | `				}` |
|    866045 | 1351 | `				if( pPeek && pPeek->iOp == PH7_OP_LOADC ){` |
|    850553 | 1352 | `					int bAbsolute = (pPeek->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|         - | 1353 | `					sxu32 nLitForClass;` |
|    850553 | 1354 | `					VmCallArgMap *pCallNsMap = pCallInstr ? (VmCallArgMap *)pCallInstr->p3 : 0;` |
...
|    850553 | 1361 | `					if( pCallNsMap && pCallNsMap->nOrigNameLit > 0 ){` |
|        55 | 1362 | `						nLitForClass = pCallNsMap->nOrigNameLit - 1;` |
|        30 | 1363 | `					}else{` |
|    850503 | 1364 | `						nLitForClass = (sxu32)pPeek->iP2;` |
|         - | 1365 | `					}` |
|    850553 | 1366 | `					pPeek->iP1 = 0;` |
|    850553 | 1367 | `					if( !bAbsolute ){` |
...
|    846655 | 1372 | `						ph7_value *pLitChk = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,nLitForClass);` |
|    846655 | 1373 | `						int isSpecialNew = 0;` |
|    846655 | 1374 | `						if( pLitChk && (pLitChk->iFlags & MEMOBJ_STRING) ){` |
|    831567 | 1375 | `							const char *z = (const char *)SyBlobData(&pLitChk->sBlob);` |
|    831567 | 1376 | `							sxu32 n = (sxu32)SyBlobLength(&pLitChk->sBlob);` |
|    831562 | 1377 | `							if( (n == 4 && SyMemcmp(z,"self",4) == 0) \|\|` |
|    835281 | 1378 | `								(n == 6 && SyMemcmp(z,"static",6) == 0) \|\|` |
|    415729 | 1379 | `								(n == 6 && SyMemcmp(z,"parent",6) == 0) ){` |
|      7779 | 1380 | `								isSpecialNew = 1;` |
|      3887 | 1381 | `							}` |
|    419553 | 1382 | `						}` |
|    854199 | 1383 | `						if( isSpecialNew ){` |
|      7779 | 1384 | `							pPeek->iP2 = (sxi32)nLitForClass;` |
|      3892 | 1385 | `						}else{` |
|    831337 | 1386 | `							pPeek->iP2 = (sxi32)GenStateNsQualifyName(pGen,nLitForClass,&pGen->hUseImports,0);` |
|         - | 1387 | `						}` |
|    419558 | 1388 | `					}else{` |
|      3903 | 1389 | `						pPeek->iP2 = (sxi32)nLitForClass;` |
|         - | 1390 | `					}` |
|    421502 | 1391 | `				}` |
|         - | 1392 | `			}` |
|    858501 | 1393 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|    858501 | 1394 | `			if( pInstr && pInstr->iOp == PH7_OP_CALL ){` |
|         - | 1395 | `				VmInstr *pPrev;` |
|    854209 | 1396 | `				pPrev = PH7_VmPeekNextInstr(pGen->pVm);` |
|    854209 | 1397 | `				if( pPrev == 0 \|\| pPrev->iOp != PH7_OP_MEMBER ){` |
...
|    854209 | 1401 | `					iP1 = pInstr->iP1;` |
|    854209 | 1402 | `					iP2 = pInstr->iP2;` |
|    854209 | 1403 | `					if( pInstr->p3 ){` |
|        65 | 1404 | `						p3 = pInstr->p3; /* Transfer VmCallArgMap to NEW */` |
|        30 | 1405 | `					}` |
|    854209 | 1406 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|    427102 | 1407 | `				}` |
|    427107 | 1408 | `			}` |
|  28820801 | 1409 | `		}else if( iVmOp == PH7_OP_IS_A ){` |
...
|     81585 | 1412 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|     81585 | 1413 | `			if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|     81585 | 1414 | `				ph7_value *pLitChk = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,(sxu32)pInstr->iP2);` |
|     81585 | 1415 | `				int bAbsolute = (pInstr->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|     81585 | 1416 | `				int isSpecialIs = 0;` |
|     81585 | 1417 | `				if( pLitChk && (pLitChk->iFlags & MEMOBJ_STRING) ){` |
|     81585 | 1418 | `					const char *z = (const char *)SyBlobData(&pLitChk->sBlob);` |
|     81585 | 1419 | `					sxu32 n = (sxu32)SyBlobLength(&pLitChk->sBlob);` |
|     81580 | 1420 | `					if( (n == 4 && SyMemcmp(z,"self",4) == 0) \|\|` |
|     81583 | 1421 | `						(n == 6 && SyMemcmp(z,"static",6) == 0) \|\|` |
|     40790 | 1422 | `						(n == 6 && SyMemcmp(z,"parent",6) == 0) ){` |
|        12 | 1423 | `						isSpecialIs = 1;` |
|         5 | 1424 | `					}` |
|     40790 | 1425 | `				}` |
|     81585 | 1426 | `				pInstr->iP1 = 0;` |
|     81585 | 1427 | `				if( !isSpecialIs && !bAbsolute ){` |
|     81565 | 1428 | `					pInstr->iP2 = (sxi32)GenStateNsQualifyName(pGen,(sxu32)pInstr->iP2,&pGen->hUseImports,0);` |
|     40780 | 1429 | `				}` |
|     40795 | 1430 | `			}` |
|  28350763 | 1431 | `		}else if( iVmOp == PH7_OP_MEMBER){` |
...
|   5975815 | 1435 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|   5975815 | 1436 | `			if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|   5735773 | 1437 | `				pInstr->iP1 = 0;` |
|   2867884 | 1438 | `			}` |
|   5975815 | 1439 | `			if( pNode->pOp->iOp == EXPR_OP_DC /* '::' */){` |
|         - | 1440 | `				/* Static member access,remember that */` |
|    418965 | 1441 | `				iP1 = 1;` |
|    418965 | 1442 | `				pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|    418965 | 1443 | `				if( pInstr && pInstr->iOp == PH7_OP_LOAD ){` |
|    236163 | 1444 | `					p3 = pInstr->p3;` |
|    236163 | 1445 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|    118079 | 1446 | `				}` |
|    209480 | 1447 | `			}` |
...
|   5975815 | 1452 | `			if( iP2 == PH7_MEMBER_READ ){` |
|   5975815 | 1453 | `				if( iFlags & EXPR_FLAG_LOAD_IDX_UNSET ){` |
|        42 | 1454 | `					iP2 = PH7_MEMBER_UNSET;` |
|   5975795 | 1455 | `				}else if( iFlags & EXPR_FLAG_LOAD_IDX_ISSET ){` |
|     69803 | 1456 | `					iP2 = PH7_MEMBER_ISSET;` |
|   5940876 | 1457 | `				}else if( iFlags & EXPR_FLAG_LOAD_IDX_EMPTY ){` |
|        17 | 1458 | `					iP2 = PH7_MEMBER_EMPTY;` |
|   5905969 | 1459 | `				}else if( iFlags & EXPR_FLAG_MEMBER_WRITE ){` |
|         - | 1460 | `					/* Write-lvalue base ($o->arr[$k]=v, $o->p ??= v): auto-create a missing prop. */` |
|   1111651 | 1461 | `					iP2 = PH7_MEMBER_WRITE;` |
|    555823 | 1462 | `				}` |
|   2987905 | 1463 | `			}` |
|   2987905 | 1464 | `		}` |
...
|  29467225 | 1492 | `		if( iVmOp == PH7_OP_CALL \|\| iVmOp == PH7_OP_NEW ){` |
|   7898721 | 1493 | `			p3 = GenStateAttachStrictFlag(pGen,p3);` |
|   3949358 | 1494 | `		}` |
|         - | 1495 | `		/* Finally,emit the VM instruction associated with this operator */` |
|  29467225 | 1496 | `		PH7_VmEmitInstr(pGen->pVm,iVmOp,iP1,iP2,p3,0);` |
|  14733610 | 1497 | `	}` |
|  29525589 | 1498 | `	if( nJmpIdx > 0 ){` |
|         - | 1499 | `		/* Fix short-circuited jumps now the destination is resolved */` |
|    832859 | 1500 | `		pInstr = PH7_VmGetInstr(pGen->pVm,nJmpIdx);` |
|    832859 | 1501 | `		if( pInstr ){` |
|    832859 | 1502 | `			pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    416427 | 1503 | `		}` |
|    416427 | 1504 | `	}` |
|  29525589 | 1505 | `	return rc;` |
|  37913507 | 1506 | `}` |
|         - | 1507 | `/*` |
...
|         - | 1528 | ` */` |
| 251714126 | 1529 | `static int GenStateTreeHasComma(ph7_expr_node *pNode)` |
|         5 | 1530 | `{` |
|         - | 1531 | `	ph7_expr_node **apArg;` |
|         - | 1532 | `	sxu32 n;` |
| 251714131 | 1533 | `	if( pNode == 0 ){` |
| 176964129 | 1534 | `		return 0;` |
|         - | 1535 | `	}` |
|  74750007 | 1536 | `	if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_COMMA ){` |
|         6 | 1537 | `		return 1;` |
|         - | 1538 | `	}` |
|  74749998 | 1539 | `	if( GenStateTreeHasComma(pNode->pLeft) \|\| GenStateTreeHasComma(pNode->pRight)` |
|  74749999 | 1540 | `	 \|\| GenStateTreeHasComma(pNode->pCond) ){` |
|         6 | 1541 | `		return 1;` |
|         - | 1542 | `	}` |
|  74749999 | 1543 | `	apArg = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  85503471 | 1544 | `	for( n = 0 ; n < SySetUsed(&pNode->aNodeArgs) ; n++ ){` |
|  10753477 | 1545 | `		if( GenStateTreeHasComma(apArg[n]) ){` |
|       ! 0 | 1546 | `			return 1;` |
|         - | 1547 | `		}` |
|   5376741 | 1548 | `	}` |
|  74749999 | 1549 | `	return 0;` |
| 125857068 | 1550 | `}` |
|  17082864 | 1551 | `PH7_PRIVATE sxi32 PH7_CompileExpr(` |
...
|  17082869 | 1565 | `	nExpr = 0;` |
|  17082869 | 1566 | `	pRoot = 0;` |
...
|  17082869 | 1569 | `	nNullsafeBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  17082869 | 1570 | `	SySetInit(&sExprNode,&pGen->pVm->sAllocator,sizeof(ph7_expr_node *));` |
|  17082869 | 1571 | `	SySetAlloc(&sExprNode,0x10);` |
|  17082869 | 1572 | `	rc = SXRET_OK;` |
|         - | 1573 | `	/* Delimit the expression */` |
|  17082869 | 1574 | `	pEnd = pGen->pIn;` |
|  17082869 | 1575 | `	iNest = 0;` |
| 133729363 | 1576 | `	while( pEnd < pGen->pEnd ){` |
| 127161095 | 1577 | `		if( pEnd->nType & PH7_TK_OCB /* '{' */ ){` |
|         - | 1578 | `			/* Ticket 1433-30: Annonymous/Closure functions body */` |
|      4767 | 1579 | `			iNest++;` |
| 127158714 | 1580 | `		}else if(pEnd->nType & PH7_TK_CCB /* '}' */ ){` |
|      4777 | 1581 | `			iNest--;` |
| 127153947 | 1582 | `		}else if( pEnd->nType & PH7_TK_SEMI /* ';' */ ){` |
|  10515549 | 1583 | `			if( iNest <= 0 ){` |
|  10514601 | 1584 | `				break;` |
|         - | 1585 | `			}` |
|       474 | 1586 | `		}` |
| 116646499 | 1587 | `		pEnd++;` |
|         5 | 1588 | `	}` |
|  17082869 | 1589 | `	if( iFlags & EXPR_FLAG_COMMA_STATEMENT ){` |
|    736459 | 1590 | `		SyToken *pEnd2 = pGen->pIn;` |
|    736459 | 1591 | `		iNest = 0;` |
|         - | 1592 | `		/* Stop at the first comma */` |
|   1617317 | 1593 | `		while( pEnd2 < pEnd ){` |
|    880865 | 1594 | `			if( pEnd2->nType & (PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*'['*/\|PH7_TK_LPAREN/*'('*/) ){` |
|     50441 | 1595 | `				iNest++;` |
|    855647 | 1596 | `			}else if(pEnd2->nType & (PH7_TK_CCB/*'}'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_RPAREN/*')'*/)){` |
|     50441 | 1597 | `				iNest--;` |
|    805211 | 1598 | `			}else if( pEnd2->nType & PH7_TK_COMMA /*','*/ ){` |
...
|    880863 | 1603 | `			pEnd2++;` |
|         5 | 1604 | `		}` |
|    736459 | 1605 | `		if( pEnd2 <pEnd ){` |
|         3 | 1606 | `			pEnd = pEnd2;` |
|         1 | 1607 | `		}` |
|    368227 | 1608 | `	}` |
|  17082869 | 1609 | `	if( pEnd > pGen->pIn ){` |
|  17059641 | 1610 | `		SyToken *pTmp = pGen->pEnd;` |
|         - | 1611 | `		/* Swap delimiter */` |
|  17059641 | 1612 | `		pGen->pEnd = pEnd;` |
|         - | 1613 | `		/* Try to get an expression tree */` |
|  17059641 | 1614 | `		rc = PH7_ExprMakeTree(&(*pGen),&sExprNode,&pRoot);` |
|  17059636 | 1615 | `		if( rc == SXRET_OK && pRoot && pGen->nCommaExprOk < 1` |
|  16885065 | 1616 | `		 && GenStateTreeHasComma(pRoot) ){` |
...
|         - | 1629 | `		}` |
|  17059637 | 1630 | `		if( rc == SXRET_OK && pRoot ){` |
|  17059453 | 1631 | `			rc = SXRET_OK;` |
|  17059453 | 1632 | `			if( xTreeValidator ){` |
|         - | 1633 | `				/* Call the upper layer validator callback */` |
|   1031389 | 1634 | `				rc = xTreeValidator(&(*pGen),pRoot);` |
|    515692 | 1635 | `			}` |
|  17059453 | 1636 | `			if( rc != SXERR_ABORT ){` |
|         - | 1637 | `				/* Generate code for the given tree */` |
|  17059453 | 1638 | `				rc = GenStateEmitExprCode(&(*pGen),pRoot,iFlags);` |
|         - | 1639 | `				/* Patch any unresolved nullsafe jumps emitted by this` |
|         - | 1640 | `				 * expression so they short-circuit to its end. */` |
|  17059453 | 1641 | `				GenStatePatchNullsafeJumps(pGen, nNullsafeBase);` |
|   8529724 | 1642 | `			}` |
|  17059453 | 1643 | `			nExpr = 1;` |
|   8529724 | 1644 | `		}` |
|         - | 1645 | `		/* Release the whole tree */` |
|  17059637 | 1646 | `		PH7_ExprFreeTree(&(*pGen),&sExprNode);` |
|         - | 1647 | `		/* Synchronize token stream */` |
|  17059637 | 1648 | `		pGen->pEnd = pTmp;` |
|  17059637 | 1649 | `		pGen->pIn  = pEnd;` |
|  17059637 | 1650 | `		if( rc == SXERR_ABORT ){` |
|        24 | 1651 | `			SySetRelease(&sExprNode);` |
|        24 | 1652 | `			return SXERR_ABORT;` |
|         - | 1653 | `		}` |
|   8529806 | 1654 | `	}` |
|  17082845 | 1655 | `	SySetRelease(&sExprNode);` |
|  17082845 | 1656 | `	return nExpr > 0 ? SXRET_OK : SXERR_EMPTY;` |
|   8541437 | 1657 | `}` |
|         - | 1658 | `/*` |
|         - | 1659 | ` * Return a pointer to the node construct handler associated` |
|         - | 1660 | ` * with a given node type [i.e: string,integer,float,...].` |
|         - | 1661 | ` */` |
|   9488446 | 1662 | `PH7_PRIVATE ProcNodeConstruct PH7_GetNodeHandler(sxu32 nNodeType)` |
|         5 | 1663 | `{` |
|   9488451 | 1664 | `	if( nNodeType & PH7_TK_NUM ){` |
|         - | 1665 | `		/* Numeric literal: Either real or integer */` |
|   3815927 | 1666 | `		return PH7_CompileNumLiteral;` |
|   5672529 | 1667 | `	}else if( nNodeType & PH7_TK_DSTR ){` |
|         - | 1668 | `		/* Double quoted string */` |
|    125161 | 1669 | `		return PH7_CompileString;` |
|   5547373 | 1670 | `	}else if( nNodeType & PH7_TK_SSTR ){` |
|         - | 1671 | `		/* Single quoted string */` |
|   5547249 | 1672 | `		return PH7_CompileSimpleString;` |
...
|         - | 1689 | ` */` |
|     23340 | 1690 | `static sxi32 GenStateUnsetValidator(ph7_gen_state *pGen, ph7_expr_node *pNode)` |
|         5 | 1691 | `{` |
|         - | 1692 | `	sxi32 rc;` |
|     23345 | 1693 | `	if( !PH7_ExprContainsNullsafe(pNode) ){` |
|     23343 | 1694 | `		return SXRET_OK;` |
|         - | 1695 | `	}` |
...
|         - | 1707 | ` */` |
|     26052 | 1708 | `static sxi32 PH7_CompileUnset(ph7_gen_state *pGen)` |
|         5 | 1709 | `{` |
|     26057 | 1710 | `	SyToken *pTmp,*pEnd,*pNext = 0;` |
|     26057 | 1711 | `	sxu32 nIdx = 0;` |
|         - | 1712 | `	SyString sName;` |
|         - | 1713 | `	sxi32 rc;` |
|         - | 1714 | `	/* Jump the 'unset' keyword */` |
|     26057 | 1715 | `	pGen->pIn++;` |
|         - | 1716 | `	/* Save delimiter */` |
|     26057 | 1717 | `	pTmp = pGen->pEnd;` |
|         - | 1718 | `	/* Skip optional opening parenthesis and find the matching close */` |
|     26057 | 1719 | `	pEnd = pTmp; /* Default: scan to statement end */` |
|     26057 | 1720 | `	if( pGen->pIn < pTmp && (pGen->pIn->nType & PH7_TK_LPAREN) ){` |
|         - | 1721 | `		/* Find matching ')' — start scanning AFTER the '(' */` |
|         - | 1722 | `		SyToken *pClose;` |
|     26057 | 1723 | `		pGen->pIn++;   /* Skip '(' */` |
|     26057 | 1724 | `		PH7_DelimitNestedTokens(pGen->pIn,pTmp,PH7_TK_LPAREN,PH7_TK_RPAREN,&pClose);` |
|     26057 | 1725 | `		pEnd = pClose; /* Stop at ')' */` |
|     13026 | 1726 | `	}` |
|     26057 | 1727 | `	SyStringInitFromBuf(&sName,"unset",sizeof("unset")-1);` |
|         - | 1728 | `	/* Resolve the 'unset' builtin name once */` |
|     26057 | 1729 | `	if( SXRET_OK != GenStateFindLiteral(&(*pGen),&sName,&nIdx) ){` |
|      3875 | 1730 | `		ph7_value *pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|      3875 | 1731 | `		if( pObj == 0 ){` |
|       ! 0 | 1732 | `			return SXERR_ABORT;` |
|         - | 1733 | `		}` |
|      3875 | 1734 | `		PH7_MemObjInitFromString(pGen->pVm,pObj,&sName);` |
|      3875 | 1735 | `		GenStateInstallLiteral(&(*pGen),pObj,nIdx);` |
|      1935 | 1736 | `	}` |
|         - | 1737 | `	/* Compile each comma-separated argument */` |
|     55961 | 1738 | `	while( SXRET_OK == PH7_GetNextExpr(pGen->pIn,pEnd,&pNext) ){` |
|     29909 | 1739 | `		if( pGen->pIn < pNext ){` |
|         - | 1740 | `			/*` |
...
|         - | 1747 | `			 */` |
|     29904 | 1748 | `			if( &pGen->pIn[2] == pNext` |
|     18234 | 1749 | `				&& (pGen->pIn[0].nType & PH7_TK_DOLLAR)` |
...
|      6567 | 1766 | `				continue;` |
|         - | 1767 | `			}` |
|     23347 | 1768 | `			pGen->pEnd = pNext;` |
|     23347 | 1769 | `			rc = PH7_CompileExpr(&(*pGen),` |
|         - | 1770 | `				EXPR_FLAG_RDONLY_LOAD\|EXPR_FLAG_LOAD_IDX_UNSET,` |
|         - | 1771 | `				GenStateUnsetValidator);` |
|     23347 | 1772 | `			if( rc == SXERR_ABORT ){` |
|       ! 0 | 1773 | `				return SXERR_ABORT;` |
|         - | 1774 | `			}` |
|     23347 | 1775 | `			if( rc != SXERR_EMPTY ){` |
|         - | 1776 | `				/* Emit call for this single argument */` |
|     23345 | 1777 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|     23345 | 1778 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_CALL,1,0,GenStateAttachStrictFlag(pGen,0),0);` |
|     23345 | 1779 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|     11670 | 1780 | `			}` |
|     11671 | 1781 | `		}` |
|         - | 1782 | `		/* Jump trailing commas */` |
|     23353 | 1783 | `		while( pNext < pEnd && (pNext->nType & PH7_TK_COMMA) ){` |
|         7 | 1784 | `			pNext++;` |
|         1 | 1785 | `		}` |
|     23347 | 1786 | `		pGen->pIn = pNext;` |
|         5 | 1787 | `	}` |
|         - | 1788 | `	/* Skip past the closing ')' if present */` |
|     26057 | 1789 | `	if( pGen->pIn < pTmp && (pGen->pIn->nType & PH7_TK_RPAREN) ){` |
|     26057 | 1790 | `		pGen->pIn++;` |
|     13026 | 1791 | `	}` |
|         - | 1792 | `	/* Restore token stream */` |
|     26057 | 1793 | `	pGen->pEnd = pTmp;` |
|     26057 | 1794 | `	return SXRET_OK;` |
|     13031 | 1795 | `}` |
|         - | 1796 | `/*` |
...
|         - | 1828 | ` */` |
|   8438204 | 1829 | `static ProcLangConstruct GenStateGetStatementHandler(` |
|         - | 1830 | `	sxu32 nKeywordID,   /* Keyword  ID*/` |
|         - | 1831 | `	SyToken *pLookahed  /* Look-ahead token */` |
|         - | 1832 | `	)` |
|         5 | 1833 | `{` |
|   8438209 | 1834 | `	sxu32 n = 0;` |
|  34144226 | 1835 | `	for(;;){` |
|  68288457 | 1836 | `		if( n >= SX_ARRAYSIZE(aLangConstruct) ){` |
|    540513 | 1837 | `			break;` |
|         - | 1838 | `		}` |
|  67747949 | 1839 | `		if( aLangConstruct[n].nID == nKeywordID ){` |
|   7897701 | 1840 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed && (pLookahed->nType & PH7_TK_OP)){` |
...
|         - | 1845 | `				}` |
|       ! 0 | 1846 | `			}` |
|   7897696 | 1847 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed` |
|     11624 | 1848 | `				&& (pLookahed->nType & PH7_TK_KEYWORD)` |
|      5819 | 1849 | `				&& SX_PTR_TO_INT(pLookahed->pUserData) == PH7_TKWRD_FN ){` |
|         - | 1850 | `				/* 'static fn(...)' arrow function — compile as expression */` |
|         3 | 1851 | `				return 0;` |
|         - | 1852 | `			}` |
|         - | 1853 | `			/* Return a pointer to the handler.` |
|         - | 1854 | `			*/` |
|   7897699 | 1855 | `			return aLangConstruct[n].xConstruct;` |
|         - | 1856 | `		}` |
|  59850253 | 1857 | `		n++;` |
|         5 | 1858 | `	}` |
|    540513 | 1859 | `	if( pLookahed ){` |
|    540513 | 1860 | `		if(nKeywordID == PH7_TKWRD_INTERFACE && (pLookahed->nType & PH7_TK_ID) ){` |
|     69797 | 1861 | `			return PH7_CompileClassInterface;` |
|    470721 | 1862 | `		}else if(nKeywordID == PH7_TKWRD_CLASS && (pLookahed->nType & PH7_TK_ID) ){` |
|    404337 | 1863 | `			return PH7_CompileClass;` |
|     66389 | 1864 | `		}else if(nKeywordID == PH7_TKWRD_TRAIT && (pLookahed->nType & PH7_TK_ID) ){` |
|      7847 | 1865 | `			return PH7_CompileTrait;` |
|         - | 1866 | `		}` |
...
|         - | 1878 | ` */` |
|     58544 | 1879 | `static int GenStateisLangConstruct(sxu32 nKeyword)` |
|         5 | 1880 | `{` |
|         - | 1881 | `	int rc;` |
|     58549 | 1882 | `	rc = PH7_IsLangConstruct(nKeyword,TRUE);` |
|     58549 | 1883 | `	if( rc == FALSE ){` |
|     58434 | 1884 | `		if( nKeyword == PH7_TKWRD_SELF \|\| nKeyword == PH7_TKWRD_PARENT \|\| nKeyword == PH7_TKWRD_STATIC` |
|     15850 | 1885 | `			\|\| nKeyword == PH7_TKWRD_YIELD` |
...
|         - | 1909 | ` */` |
|  18100858 | 1910 | `PH7_PRIVATE void GenStateSetPendingDoc(ph7_gen_state *pGen)` |
|         5 | 1911 | `{` |
|  18100863 | 1912 | `	SyToken *pBase = (SyToken *)SySetBasePtr(pGen->pTokenSet);` |
|  18100863 | 1913 | `	ph7_trivia *aT = (ph7_trivia *)SySetBasePtr(&pGen->aTrivia);` |
|  18100863 | 1914 | `	sxu32 nT = SySetUsed(&pGen->aTrivia);` |
|         - | 1915 | `	sxu32 nIdx, n;` |
|  18100858 | 1916 | `	if( nT < 1 \|\| pGen->pTokenSet == 0` |
|   3420129 | 1917 | `	 \|\| pGen->pIn < pBase \|\| pGen->pIn >= &pBase[SySetUsed(pGen->pTokenSet)] ){` |
|         - | 1918 | `		/* Re-tokenized substream (string interpolation, synthesized code):` |
|         - | 1919 | `		 * indexes do not map to the sidecar */` |
|  14680741 | 1920 | `		return;` |
|         - | 1921 | `	}` |
|   3420127 | 1922 | `	nIdx = (sxu32)(pGen->pIn - pBase);` |
...
|   3420127 | 1925 | `	SySetReset(&pGen->aPendingAttrs);` |
|  10262131 | 1926 | `	for( n = 0 ; n < nT ; n++ ){` |
|   6842009 | 1927 | `		if( aT[n].nTokIdx != nIdx ){` |
|   6834097 | 1928 | `			continue;` |
|         - | 1929 | `		}` |
|      7917 | 1930 | `		if( aT[n].iKind == PH7_TRIVIA_DOC ){` |
|        29 | 1931 | `			pGen->sPendingDoc = aT[n].sText;` |
|      7905 | 1932 | `		}else if( aT[n].iKind == PH7_TRIVIA_ATTR ){` |
|      7893 | 1933 | `			SySetPut(&pGen->aPendingAttrs,(const void *)&aT[n]);` |
|      3944 | 1934 | `		}` |
|      3961 | 1935 | `	}` |
|   9050434 | 1936 | `}` |
|         - | 1937 | `/*` |
...
|         - | 1941 | ` */` |
|   4876000 | 1942 | `PH7_PRIVATE void GenStateConsumeDoc(ph7_gen_state *pGen,SyString *pOut)` |
|         5 | 1943 | `{` |
|         - | 1944 | `	char *zDup;` |
|   4876005 | 1945 | `	if( SyStringLength(&pGen->sPendingDoc) < 1 ){` |
|   4875985 | 1946 | `		return;` |
|         - | 1947 | `	}` |
...
|         - | 1963 | ` */` |
|      7902 | 1964 | `static sxi32 GenStateCompileAttrSpan(ph7_gen_state *pGen,ph7_trivia *pTrivia,SySet *pOut)` |
|         5 | 1965 | `{` |
|         - | 1966 | `	SySet *pToken;` |
|         - | 1967 | `	SyToken *pIn, *pEnd, *pSavedIn, *pSavedEnd;` |
|         - | 1968 | `	char *zSpan;` |
|      7907 | 1969 | `	sxi32 rc = SXRET_OK;` |
|      7907 | 1970 | `	if( SyStringLength(&pTrivia->sText) < 1 ){` |
|       ! 0 | 1971 | `		return SXRET_OK;` |
|         - | 1972 | `	}` |
|     11858 | 1973 | `	zSpan = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|      3951 | 1974 | `		SyStringData(&pTrivia->sText),SyStringLength(&pTrivia->sText));` |
|      7907 | 1975 | `	if( zSpan == 0 ){` |
...
|      7907 | 1981 | `	pToken = (SySet *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(SySet));` |
|      7907 | 1982 | `	if( pToken == 0 ){` |
|       ! 0 | 1983 | `		return SXRET_OK;` |
|         - | 1984 | `	}` |
|      7907 | 1985 | `	SySetInit(pToken,&pGen->pVm->sAllocator,sizeof(SyToken));` |
|      7907 | 1986 | `	PH7_TokenizePHP(zSpan,SyStringLength(&pTrivia->sText),pTrivia->nLine,pToken,0);` |
|      7907 | 1987 | `	pIn = (SyToken *)SySetBasePtr(pToken);` |
|      7907 | 1988 | `	pEnd = &pIn[SySetUsed(pToken)];` |
|      7907 | 1989 | `	pSavedIn = pGen->pIn;` |
|      7907 | 1990 | `	pSavedEnd = pGen->pEnd;` |
|      7911 | 1991 | `	while( pIn < pEnd ){` |
|         - | 1992 | `		ph7_attribute sAttr;` |
|         - | 1993 | `		SyBlob sFQN;` |
|      7911 | 1994 | `		int bAbsolute = 0;` |
|      7911 | 1995 | `		SyZero(&sAttr,sizeof(sAttr));` |
|      7911 | 1996 | `		SySetInit(&sAttr.aArgs,&pGen->pVm->sAllocator,sizeof(ph7_attr_arg));` |
|      7911 | 1997 | `		sAttr.nLine = pIn->nLine;` |
|      7911 | 1998 | `		if( pIn->nType & PH7_TK_NSSEP ){` |
|        75 | 1999 | `			bAbsolute = 1;` |
|        75 | 2000 | `			pIn++;` |
|        35 | 2001 | `		}` |
|      7911 | 2002 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|      7911 | 2003 | `		while( pIn < pEnd && (pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|      7911 | 2004 | `			SyBlobAppend(&sFQN,pIn->sData.zString,pIn->sData.nByte);` |
|      7911 | 2005 | `			pIn++;` |
|      7911 | 2006 | `			if( pIn < pEnd && (pIn->nType & PH7_TK_NSSEP) ){` |
...
|      7911 | 2011 | `			break;` |
|       ! 0 | 2012 | `		}` |
|      7911 | 2013 | `		if( SyBlobLength(&sFQN) < 1 ){` |
...
|         - | 2021 | `		{` |
|      7911 | 2022 | `			const char *zName = (const char *)SyBlobData(&sFQN);` |
|      7911 | 2023 | `			sxu32 nName = SyBlobLength(&sFQN);` |
|      7911 | 2024 | `			char *zDup = 0;` |
|      7911 | 2025 | `			if( !bAbsolute ){` |
|      7841 | 2026 | `				SyHashEntry *pImp = SyHashGet(&pGen->hUseImports,(const void *)zName,nName);` |
|      7841 | 2027 | `				if( pImp ){` |
...
|       ! 0 | 2032 | `					}` |
|      7841 | 2033 | `				}else if( SyBlobLength(&pGen->sNamespace) > 0 ){` |
|         - | 2034 | `					SyBlob sTmp;` |
...
|       ! 0 | 2045 | `				}` |
|      3918 | 2046 | `			}` |
|      7911 | 2047 | `			if( SyStringLength(&sAttr.sName) < 1 ){` |
|      7911 | 2048 | `				zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,zName,nName);` |
|      7911 | 2049 | `				if( zDup ){` |
|      7911 | 2050 | `					SyStringInitFromBuf(&sAttr.sName,zDup,nName);` |
|      3953 | 2051 | `				}` |
|      3953 | 2052 | `			}` |
|         - | 2053 | `		}` |
|      7911 | 2054 | `		SyBlobRelease(&sFQN);` |
|      7911 | 2055 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_LPAREN) ){` |
|         - | 2056 | `			SyToken *pArgsEnd;` |
|      7809 | 2057 | `			pIn++;` |
|      7809 | 2058 | `			PH7_DelimitNestedTokens(pIn,pEnd,PH7_TK_LPAREN,PH7_TK_RPAREN,&pArgsEnd);` |
|     15627 | 2059 | `			while( pIn < pArgsEnd ){` |
|      7823 | 2060 | `				SyToken *pArgStart = pIn, *pArgStop = pIn;` |
|      7823 | 2061 | `				sxi32 iDepth = 0;` |
|         - | 2062 | `				ph7_attr_arg sArgRec;` |
|     77677 | 2063 | `				while( pArgStop < pArgsEnd ){` |
|     69875 | 2064 | `					if( pArgStop->nType & (PH7_TK_LPAREN\|PH7_TK_OSB\|PH7_TK_OCB) ){` |
|        11 | 2065 | `						iDepth++;` |
|     69870 | 2066 | `					}else if( pArgStop->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB) ){` |
|        11 | 2067 | `						iDepth--;` |
|     69860 | 2068 | `					}else if( (pArgStop->nType & PH7_TK_COMMA) && iDepth == 0 ){` |
|        17 | 2069 | `						break;` |
|         - | 2070 | `					}` |
|     69859 | 2071 | `					pArgStop++;` |
|         5 | 2072 | `				}` |
|      7823 | 2073 | `				SyZero(&sArgRec,sizeof(sArgRec));` |
|      7823 | 2074 | `				SySetInit(&sArgRec.aByteCode,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|      7818 | 2075 | `				if( pArgStart < pArgStop && (pArgStart->nType & (PH7_TK_ID\|PH7_TK_KEYWORD))` |
|      7800 | 2076 | `				 && &pArgStart[1] < pArgStop && (pArgStart[1].nType & PH7_TK_COLON) ){` |
...
|        19 | 2082 | `					pArgStart += 2;` |
|         9 | 2083 | `				}` |
|      7823 | 2084 | `				if( pArgStart < pArgStop ){` |
|         - | 2085 | `					SySet *pInstrContainer;` |
|      7823 | 2086 | `					pGen->pIn = pArgStart;` |
|      7823 | 2087 | `					pGen->pEnd = pArgStop;` |
|      7823 | 2088 | `					pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|      7823 | 2089 | `					PH7_VmSetByteCodeContainer(pGen->pVm,&sArgRec.aByteCode);` |
|      7823 | 2090 | `					rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|      7823 | 2091 | `					PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|      7823 | 2092 | `					PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|      7823 | 2093 | `					if( rc == SXERR_ABORT ){` |
|       ! 0 | 2094 | `						pGen->pIn = pSavedIn;` |
|       ! 0 | 2095 | `						pGen->pEnd = pSavedEnd;` |
|       ! 0 | 2096 | `						return SXERR_ABORT;` |
|         - | 2097 | `					}` |
|      7823 | 2098 | `					SySetPut(&sAttr.aArgs,(const void *)&sArgRec);` |
|      3909 | 2099 | `				}` |
|      7823 | 2100 | `				pIn = pArgStop;` |
|      7823 | 2101 | `				if( pIn < pArgsEnd && (pIn->nType & PH7_TK_COMMA) ){` |
|        17 | 2102 | `					pIn++;` |
|         8 | 2103 | `				}` |
|         5 | 2104 | `			}` |
|      7809 | 2105 | `			pIn = (pArgsEnd < pEnd) ? &pArgsEnd[1] : pEnd;` |
|      3902 | 2106 | `		}` |
|      7911 | 2107 | `		SySetPut(pOut,(const void *)&sAttr);` |
|      7911 | 2108 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_COMMA) ){` |
|         5 | 2109 | `			pIn++;` |
|         5 | 2110 | `			continue;` |
|         - | 2111 | `		}` |
|      7907 | 2112 | `		break;` |
|       ! 0 | 2113 | `	}` |
|      7907 | 2114 | `	pGen->pIn = pSavedIn;` |
|      7907 | 2115 | `	pGen->pEnd = pSavedEnd;` |
|      7907 | 2116 | `	return SXRET_OK;` |
|      3956 | 2117 | `}` |
|         - | 2118 | `/*` |
...
|         - | 2121 | ` */` |
|   4876004 | 2122 | `PH7_PRIVATE sxi32 GenStateConsumeAttrs(ph7_gen_state *pGen,SySet *pOut)` |
|         5 | 2123 | `{` |
|   4876009 | 2124 | `	ph7_trivia *aT = (ph7_trivia *)SySetBasePtr(&pGen->aPendingAttrs);` |
|         - | 2125 | `	sxu32 n;` |
|         - | 2126 | `	sxi32 rc;` |
|   4883897 | 2127 | `	for( n = 0 ; n < SySetUsed(&pGen->aPendingAttrs) ; n++ ){` |
|      7893 | 2128 | `		rc = GenStateCompileAttrSpan(&(*pGen),&aT[n],pOut);` |
|      7893 | 2129 | `		if( rc == SXERR_ABORT ){` |
|       ! 0 | 2130 | `			return SXERR_ABORT;` |
|         - | 2131 | `		}` |
|      3949 | 2132 | `	}` |
|   4876009 | 2133 | `	SySetReset(&pGen->aPendingAttrs);` |
|   4876009 | 2134 | `	return SXRET_OK;` |
|   2438007 | 2135 | `}` |
|         - | 2136 | `/*` |
...
|         - | 2140 | ` */` |
|   2449730 | 2141 | `PH7_PRIVATE sxi32 GenStateCollectParamAttrs(ph7_gen_state *pGen,SyToken *pTok,SySet *pOut)` |
|         5 | 2142 | `{` |
|   2449735 | 2143 | `	SyToken *pBase = (SyToken *)SySetBasePtr(pGen->pTokenSet);` |
|   2449735 | 2144 | `	ph7_trivia *aT = (ph7_trivia *)SySetBasePtr(&pGen->aTrivia);` |
|   2449735 | 2145 | `	sxu32 nT = SySetUsed(&pGen->aTrivia);` |
|         - | 2146 | `	sxu32 nIdx, n;` |
|         - | 2147 | `	sxi32 rc;` |
|   2449730 | 2148 | `	if( nT < 1 \|\| pGen->pTokenSet == 0` |
|    553719 | 2149 | `	 \|\| pTok < pBase \|\| pTok >= &pBase[SySetUsed(pGen->pTokenSet)] ){` |
|   1896021 | 2150 | `		return SXRET_OK;` |
|         - | 2151 | `	}` |
|    553719 | 2152 | `	nIdx = (sxu32)(pTok - pBase);` |
|   1661191 | 2153 | `	for( n = 0 ; n < nT ; n++ ){` |
|   1107477 | 2154 | `		if( aT[n].nTokIdx == nIdx && aT[n].iKind == PH7_TRIVIA_ATTR ){` |
...
|         7 | 2159 | `		}` |
|    553741 | 2160 | `	}` |
|    553719 | 2161 | `	return SXRET_OK;` |
|   1224870 | 2162 | `}` |
|  13274520 | 2163 | `PH7_PRIVATE sxi32 GenStateCompileChunk(` |
...
|         - | 2169 | `	sxi32 rc;` |
|  13274525 | 2170 | `	rc = SXRET_OK; /* Prevent compiler warning */` |
|   7723870 | 2171 | `	for(;;){` |
|  14361135 | 2172 | `		int bStmtIsDeclare = 0;` |
|  14361135 | 2173 | `		if( pGen->pIn >= pGen->pEnd ){` |
|         - | 2174 | `			/* No more input to process */` |
|     91013 | 2175 | `			break;` |
|         - | 2176 | `		}` |
|         - | 2177 | `		/* Bind a directly-preceding docblock to this statement */` |
|  14270127 | 2178 | `		GenStateSetPendingDoc(&(*pGen));` |
|  14270127 | 2179 | `		if( SySetUsed(&pGen->aPendingAttrs) > 0 ){` |
...
|      7805 | 2185 | `			int bAttrTarget = 0;` |
|      7800 | 2186 | `			if( GenStateStartsModifiedClass(pGen->pIn,pGen->pEnd)` |
|      3935 | 2187 | `			 \|\| GenStateStartsEnumDecl(pGen->pIn,pGen->pEnd) ){` |
|      7745 | 2188 | `				bAttrTarget = 1;` |
|      3931 | 2189 | `			}else if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
...
|  14270127 | 2211 | `		if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|   8480849 | 2212 | `			sxu32 nPeek = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   8480849 | 2213 | `			if( nPeek == PH7_TKWRD_DECLARE ){` |
|        49 | 2214 | `				bStmtIsDeclare = 1;` |
|        22 | 2215 | `			}` |
|   4240422 | 2216 | `		}` |
|  14270127 | 2217 | `		if( !bStmtIsDeclare && pGen->pCurrent == &pGen->sGlobal ){` |
...
|   1086609 | 2220 | `			pGen->bStrictTypesLocked = 1;` |
|    543302 | 2221 | `		}` |
|  14270127 | 2222 | `		if( pGen->pIn->nType & PH7_TK_OCB /* '{' */ ){` |
|         - | 2223 | `			/* Compile block */` |
|      3915 | 2224 | `			rc = PH7_CompileBlock(&(*pGen),0);` |
|      3915 | 2225 | `			if( rc == SXERR_ABORT ){` |
|       ! 0 | 2226 | `				break;` |
|         - | 2227 | `			}` |
|      1960 | 2228 | `		}else{` |
|  14266217 | 2229 | `			xCons = 0;` |
|  14266217 | 2230 | `			if( GenStateStartsModifiedClass(pGen->pIn,pGen->pEnd) ){` |
...
|     42671 | 2234 | `				xCons = PH7_CompileClassModifiers;` |
|  14244884 | 2235 | `			}else if( GenStateStartsEnumDecl(pGen->pIn,pGen->pEnd) ){` |
|         - | 2236 | ``				/* `enum Name …` (PHP 8.1) — `enum` is a context-sensitive ID,`` |
|         - | 2237 | `				 * so it is detected here rather than the keyword dispatcher. */` |
|      3913 | 2238 | `				xCons = PH7_CompileEnum;` |
|  14221597 | 2239 | `			}else if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|   8438209 | 2240 | `				sxu32 nKeyword = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|         - | 2241 | `				/* Try to extract a language construct handler */` |
|   8438209 | 2242 | `				xCons = GenStateGetStatementHandler(nKeyword,(&pGen->pIn[1] < pGen->pEnd) ? &pGen->pIn[1] : 0);` |
|   8438209 | 2243 | `				if( xCons == 0 && GenStateisLangConstruct(nKeyword) == FALSE ){` |
...
|         4 | 2254 | `				}` |
|  10000541 | 2255 | `			}else if( (pGen->pIn->nType & PH7_TK_ID) && (&pGen->pIn[1] < pGen->pEnd)` |
|    427347 | 2256 | `				&& (pGen->pIn[1].nType & PH7_TK_COLON /*':'*/) ){` |
|         - | 2257 | `				/* Label found [i.e: Out: ],point to the routine responsible of compiling it */` |
|       117 | 2258 | `				xCons = PH7_CompileLabel;` |
|        56 | 2259 | `			}` |
|  14266217 | 2260 | `			if( xCons == 0 ){` |
|         - | 2261 | `				/* Assume an expression an try to compile it */` |
|   5839863 | 2262 | `				rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   5839863 | 2263 | `				if(  rc != SXERR_EMPTY ){` |
|         - | 2264 | `					/* Pop l-value */` |
|   5839709 | 2265 | `					PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|   2919852 | 2266 | `				}` |
|   2919934 | 2267 | `			}else{` |
|         - | 2268 | `				/* Go compile the sucker */` |
|   8426359 | 2269 | `				rc = xCons(&(*pGen));` |
|         - | 2270 | `			}` |
|  14266217 | 2271 | `			if( rc == SXERR_ABORT ){` |
|         - | 2272 | `				/* Request to abort compilation */` |
|        42 | 2273 | `				break;` |
|         - | 2274 | `			}` |
|         - | 2275 | `		}` |
|         - | 2276 | `		/* Ignore trailing semi-colons ';' */` |
|  24499291 | 2277 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|  10229207 | 2278 | `			pGen->pIn++;` |
|         5 | 2279 | `		}` |
|  14270089 | 2280 | `		if( iFlags & PH7_COMPILE_SINGLE_STMT ){` |
...
|         - | 2296 | ` */` |
|     91048 | 2297 | `static sxi32 PH7_CompilePHP(` |
...
|         - | 2301 | `	)` |
|         5 | 2302 | `{` |
|     91053 | 2303 | `	SyToken *pScript = pGen->pRawIn; /* Script to compile */` |
|         - | 2304 | `	sxi32 rc;` |
|         - | 2305 | `	/* Reset the token set (and its trivia sidecar) */` |
|     91053 | 2306 | `	SySetReset(&(*pTokenSet));` |
|     91053 | 2307 | `	SySetReset(&pGen->aTrivia);` |
|         - | 2308 | `	/* Mark as the default token set */` |
|     91053 | 2309 | `	pGen->pTokenSet = &(*pTokenSet);` |
|         - | 2310 | `	/* Advance the stream cursor */` |
|     91053 | 2311 | `	pGen->pRawIn++;` |
|         - | 2312 | `	/* Tokenize the PHP chunk first */` |
|     91053 | 2313 | `	PH7_TokenizePHP(SyStringData(&pScript->sData),SyStringLength(&pScript->sData),pScript->nLine,&(*pTokenSet),&pGen->aTrivia);` |
|         - | 2314 | `	/* Point to the head and tail of the token stream. */` |
|     91053 | 2315 | `	pGen->pIn  = (SyToken *)SySetBasePtr(pTokenSet);` |
|     91053 | 2316 | `	pGen->pEnd = &pGen->pIn[SySetUsed(pTokenSet)];` |
|     91053 | 2317 | `	if( is_expr ){` |
...
|         - | 2326 | `	}` |
|     91053 | 2327 | `	if( pGen->pIn < pGen->pEnd && ( pGen->pIn->nType & PH7_TK_EQUAL ) ){` |
...
|     91051 | 2359 | `	rc = GenStateCompileChunk(pGen,0);` |
|         - | 2360 | `	/* Fix exceptions jumps */` |
|     91051 | 2361 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|         - | 2362 | `	/* Fix gotos now, the jump destination is resolved */` |
|     91051 | 2363 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),0) ){` |
|         3 | 2364 | `		rc = SXERR_ABORT;` |
|         1 | 2365 | `	}` |
|         - | 2366 | `	/* Reset container */` |
|     91051 | 2367 | `	SySetReset(&pGen->aGoto);` |
|     91051 | 2368 | `	SySetReset(&pGen->aLabel);` |
|     91051 | 2369 | `	SySetReset(&pGen->aNullsafeJmp);` |
|         - | 2370 | `	/* Compilation result */` |
|     91051 | 2371 | `	return rc;` |
|     45529 | 2372 | `}` |
|         - | 2373 | `/*` |
...
|         - | 2377 | ` */` |
|     94216 | 2378 | `PH7_PRIVATE sxi32 PH7_CompileScript(` |
...
|         - | 2393 | `	sxi32 rc;` |
|     94221 | 2394 | `	sxu32 nBaseLine = 1;` |
|     94221 | 2395 | `	if( pScript->nByte < 1 ){` |
...
|     94221 | 2402 | `	if( pScript->nByte >= 2 && pScript->zString[0]=='#' && pScript->zString[1]=='!' ){` |
...
|     94221 | 2416 | `	pCodeGen = &pVm->sCodeGen;` |
...
|     94221 | 2423 | `	pSavedIn = pCodeGen->pIn;` |
|     94221 | 2424 | `	pSavedEnd = pCodeGen->pEnd;` |
|     94221 | 2425 | `	bSavedStrict = pCodeGen->bStrictTypes;` |
|     94221 | 2426 | `	bSavedStrictLocked = pCodeGen->bStrictTypesLocked;` |
|     94221 | 2427 | `	pCodeGen->bStrictTypes = 0;` |
|     94221 | 2428 | `	pCodeGen->bStrictTypesLocked = 0;` |
|         - | 2429 | `	/* Initialize the tokens containers */` |
|     94221 | 2430 | `	SySetInit(&aRawToken,&pVm->sAllocator,sizeof(SyToken));` |
|     94221 | 2431 | `	SySetInit(&aPhpToken,&pVm->sAllocator,sizeof(SyToken));` |
|     94221 | 2432 | `	SySetAlloc(&aPhpToken,0xc0);` |
|     94221 | 2433 | `	is_expr = 0;` |
|     94221 | 2434 | `	if( iFlags & PH7_PHP_ONLY ){` |
|         - | 2435 | `		SyToken sTmp;` |
|         - | 2436 | `		/* PHP only: -*/` |
|     81401 | 2437 | `		sTmp.nLine = 1;` |
|     81401 | 2438 | `		sTmp.nType = PH7_TOKEN_PHP;` |
|     81401 | 2439 | `		sTmp.pUserData = 0;` |
|     81401 | 2440 | `		SyStringDupPtr(&sTmp.sData,pScript);` |
|     81401 | 2441 | `		SySetPut(&aRawToken,(const void *)&sTmp);` |
|     81401 | 2442 | `		if( iFlags & PH7_PHP_EXPR ){` |
|         - | 2443 | `			/* A simple PHP expression */` |
|       ! 0 | 2444 | `			is_expr = 1;` |
|       ! 0 | 2445 | `		}` |
|     40703 | 2446 | `	}else{` |
|         - | 2447 | `		/* Tokenize raw text */` |
|     12825 | 2448 | `		SySetAlloc(&aRawToken,32);` |
|     12825 | 2449 | `		PH7_TokenizeRawText(pScript->zString,pScript->nByte,&aRawToken,nBaseLine);` |
|         - | 2450 | `	}` |
|         - | 2451 | `	/* Process high-level tokens */` |
|     94221 | 2452 | `	pCodeGen->pRawIn = (SyToken *)SySetBasePtr(&aRawToken);` |
|     94221 | 2453 | `	pCodeGen->pRawEnd = &pCodeGen->pRawIn[SySetUsed(&aRawToken)];` |
|     94221 | 2454 | `	rc = PH7_OK;` |
|     94221 | 2455 | `	if( is_expr ){` |
|         - | 2456 | `		/* Compile the expression */` |
|       ! 0 | 2457 | `		rc = PH7_CompilePHP(pCodeGen,&aPhpToken,TRUE);` |
|       ! 0 | 2458 | `		goto cleanup;` |
|         - | 2459 | `	}` |
|     94221 | 2460 | `	nObjIdx = 0;` |
...
|     94221 | 2464 | `	PH7_VmEmitInstr(pVm,PH7_OP_NSSWITCH,0,0,0,0);` |
|         - | 2465 | `	/* Start the compilation process */` |
|     53522 | 2466 | `	for(;;){` |
|    198057 | 2467 | `		if( pCodeGen->pRawIn >= pCodeGen->pRawEnd ){` |
|     94181 | 2468 | `			break; /* No more tokens to process */` |
|         - | 2469 | `		}` |
|    103881 | 2470 | `		if( pCodeGen->pRawIn->nType & PH7_TOKEN_PHP ){` |
|         - | 2471 | `			/* Compile the PHP chunk */` |
|     91053 | 2472 | `			rc = PH7_CompilePHP(pCodeGen,&aPhpToken,FALSE);` |
|     91053 | 2473 | `			if( rc == SXERR_ABORT ){` |
|        44 | 2474 | `				break;` |
|         - | 2475 | `			}` |
|     91013 | 2476 | `			continue;` |
|         - | 2477 | `		}` |
|         - | 2478 | `		/* Raw chunk: [i.e: HTML, XML, etc.] */` |
|     12833 | 2479 | `		nRawObj = 0;` |
|     25661 | 2480 | `		while( (pCodeGen->pRawIn < pCodeGen->pRawEnd) && (pCodeGen->pRawIn->nType != PH7_TOKEN_PHP) ){` |
|         - | 2481 | `			/* Consume the raw chunk without any processing */` |
|     12833 | 2482 | `			pRawObj = PH7_ReserveConstObj(&(*pVm),&nObjIdx);` |
|     12833 | 2483 | `			if( pRawObj == 0 ){` |
|       ! 0 | 2484 | `				rc = SXERR_MEM;` |
|       ! 0 | 2485 | `				break;` |
|         - | 2486 | `			}` |
|         - | 2487 | `			/* Mark as constant and emit the load constant instruction */` |
|     12833 | 2488 | `			PH7_MemObjInitFromString(pVm,pRawObj,&pCodeGen->pRawIn->sData);` |
|     12833 | 2489 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_LOADC,0,nObjIdx,0,0);` |
|     12833 | 2490 | `			++nRawObj;` |
|     12833 | 2491 | `			pCodeGen->pRawIn++; /* Next chunk */` |
|         5 | 2492 | `		}` |
|     12833 | 2493 | `		if( nRawObj > 0 ){` |
|         - | 2494 | `			/* Emit the consume instruction */` |
|     12833 | 2495 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_CONSUME,nRawObj,0,0,0);` |
|      6414 | 2496 | `		}` |
|     47113 | 2497 | `	}` |
|     47108 | 2498 | `cleanup:` |
|         - | 2499 | `	/* Drop the cursor into the token set BEFORE the set is freed (see above). */` |
|     94221 | 2500 | `	pCodeGen->pIn = pSavedIn;` |
|     94221 | 2501 | `	pCodeGen->pEnd = pSavedEnd;` |
|     94221 | 2502 | `	SySetRelease(&aRawToken);` |
|     94221 | 2503 | `	SySetRelease(&aPhpToken);` |
|         - | 2504 | `	/* Restore outer file's strict_types scope */` |
|     94221 | 2505 | `	pCodeGen->bStrictTypes = bSavedStrict;` |
|     94221 | 2506 | `	pCodeGen->bStrictTypesLocked = bSavedStrictLocked;` |
|     94221 | 2507 | `	return rc;` |
|     47113 | 2508 | `}` |
|         - | 2509 | `/*` |
|         - | 2510 | ` * Utility routines.Initialize the code generator.` |
|         - | 2511 | ` */` |
|      3870 | 2512 | `PH7_PRIVATE sxi32 PH7_InitCodeGenerator(` |
|         - | 2513 | `	ph7_vm *pVm,       /* Target VM */` |
|         - | 2514 | `	ProcConsumer xErr, /* Error log consumer callabck  */` |
|         - | 2515 | `	void *pErrData     /* Last argument to xErr() */` |
|         - | 2516 | `	)` |
|         5 | 2517 | `{` |
|      3875 | 2518 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|         - | 2519 | `	/* Zero the structure */` |
|      3875 | 2520 | `	SyZero(pGen,sizeof(ph7_gen_state));` |
|         - | 2521 | `	/* Initial state */` |
|      3875 | 2522 | `	pGen->pVm  = &(*pVm);` |
|      3875 | 2523 | `	pGen->xErr = xErr;` |
|      3875 | 2524 | `	pGen->pErrData = pErrData;` |
|      3875 | 2525 | `	SySetInit(&pGen->aLabel,&pVm->sAllocator,sizeof(Label));` |
|      3875 | 2526 | `	SySetInit(&pGen->aGoto,&pVm->sAllocator,sizeof(JumpFixup));` |
|      3875 | 2527 | `	SySetInit(&pGen->aLoopParent,&pVm->sAllocator,sizeof(sxu32));` |
|      3875 | 2528 | `	pGen->nLoopId = pGen->nCurLoopId = 0;` |
|      3875 | 2529 | `	SySetInit(&pGen->aNullsafeJmp,&pVm->sAllocator,sizeof(sxu32));` |
|      3875 | 2530 | `	SySetInit(&pGen->aTrivia,&pVm->sAllocator,sizeof(ph7_trivia));` |
|      3875 | 2531 | `	SySetInit(&pGen->aPendingAttrs,&pVm->sAllocator,sizeof(ph7_trivia));` |
|      3875 | 2532 | `	SyHashInit(&pGen->hLiteral,&pVm->sAllocator,0,0);` |
|      3875 | 2533 | `	SyHashInit(&pGen->hVar,&pVm->sAllocator,0,0);` |
|         - | 2534 | `	/* Error log buffer */` |
|      3875 | 2535 | `	SyBlobInit(&pGen->sErrBuf,&pVm->sAllocator);` |
|         - | 2536 | `	/* General purpose working buffer */` |
|      3875 | 2537 | `	SyBlobInit(&pGen->sWorker,&pVm->sAllocator);` |
|         - | 2538 | `	/* Namespace state */` |
|      3875 | 2539 | `	SyBlobInit(&pGen->sNamespace,&pVm->sAllocator);` |
|      3875 | 2540 | `	SyHashInit(&pGen->hUseImports,&pVm->sAllocator,0,0);` |
|      3875 | 2541 | `	SyHashInit(&pGen->hUseFuncImports,&pVm->sAllocator,0,0);` |
|      3875 | 2542 | `	SyHashInit(&pGen->hUseConstImports,&pVm->sAllocator,0,0);` |
|         - | 2543 | `	/* Create the global scope */` |
|      3875 | 2544 | `	GenStateInitBlock(pGen,&pGen->sGlobal,GEN_BLOCK_GLOBAL,PH7_VmInstrLength(&(*pVm)),0);` |
|         - | 2545 | `	/* Point to the global scope */` |
|      3875 | 2546 | `	pGen->pCurrent = &pGen->sGlobal;` |
|      3875 | 2547 | `	return SXRET_OK;` |
|         5 | 2548 | `}` |
|         - | 2549 | `/*` |
|         - | 2550 | ` * Utility routines. Reset the code generator to it's initial state.` |
|         - | 2551 | ` */` |
|     97602 | 2552 | `PH7_PRIVATE sxi32 PH7_ResetCodeGenerator(` |
|         - | 2553 | `	ph7_vm *pVm,       /* Target VM */` |
|         - | 2554 | `	ProcConsumer xErr, /* Error log consumer callabck  */` |
|         - | 2555 | `	void *pErrData     /* Last argument to xErr() */` |
|         - | 2556 | `	)` |
|         5 | 2557 | `{` |
|     97607 | 2558 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|         - | 2559 | `	GenBlock *pBlock,*pParent;` |
|         - | 2560 | `	/* Reset state */` |
|     97607 | 2561 | `	SySetReset(&pGen->aLabel);` |
|     97607 | 2562 | `	SySetReset(&pGen->aGoto);` |
|     97607 | 2563 | `	SySetReset(&pGen->aNullsafeJmp);` |
|     97607 | 2564 | `	SySetReset(&pGen->aTrivia);` |
|     97607 | 2565 | `	SySetReset(&pGen->aPendingAttrs);` |
|     97607 | 2566 | `	SyStringInitFromBuf(&pGen->sPendingDoc,0,0);` |
|     97607 | 2567 | `	SyBlobRelease(&pGen->sErrBuf);` |
|     97607 | 2568 | `	SyBlobRelease(&pGen->sWorker);` |
|     97607 | 2569 | `	SyBlobRelease(&pGen->sNamespace);` |
|     97607 | 2570 | `	SyBlobInit(&pGen->sNamespace,&pVm->sAllocator);` |
|     97607 | 2571 | `	SyHashRelease(&pGen->hUseImports);` |
|     97607 | 2572 | `	SyHashInit(&pGen->hUseImports,&pVm->sAllocator,0,0);` |
|     97607 | 2573 | `	SyHashRelease(&pGen->hUseFuncImports);` |
|     97607 | 2574 | `	SyHashInit(&pGen->hUseFuncImports,&pVm->sAllocator,0,0);` |
|     97607 | 2575 | `	SyHashRelease(&pGen->hUseConstImports);` |
|     97607 | 2576 | `	SyHashInit(&pGen->hUseConstImports,&pVm->sAllocator,0,0);` |
...
|     97607 | 2584 | `	pBlock = pGen->pCurrent;` |
|     97607 | 2585 | `	while( pBlock->pParent != 0 ){` |
|       ! 0 | 2586 | `		pParent = pBlock->pParent;` |
|       ! 0 | 2587 | `		GenStateFreeBlock(pBlock);` |
|       ! 0 | 2588 | `		pBlock = pParent;` |
|       ! 0 | 2589 | `	}` |
|     97607 | 2590 | `	pGen->xErr = xErr;` |
|     97607 | 2591 | `	pGen->pErrData = pErrData;` |
|     97607 | 2592 | `	pGen->pCurrent = &pGen->sGlobal;` |
|     97607 | 2593 | `	pGen->pRawIn = pGen->pRawEnd = 0;` |
|     97607 | 2594 | `	pGen->pIn = pGen->pEnd = 0;` |
|     97607 | 2595 | `	pGen->nErr = 0;` |
|     97607 | 2596 | `	return SXRET_OK;` |
|         5 | 2597 | `}` |
|         - | 2598 | `/*` |
