...
|       - |   130 | ` */` |
|    3574 |   131 | `static GenBlock * GenStateFetchBlock(GenBlock *pCurrent,sxi32 iBlockType,sxi32 iCount)` |
|       5 |   132 |  |
|    3579 |   133 | `	GenBlock *pBlock = pCurrent;` |
|   10139 |   134 | `	for(;;){` |
|   20283 |   135 | `		if( pBlock->iFlags & iBlockType ){` |
|    3471 |   136 | `			iCount--; /* Decrement nesting level */` |
|    3471 |   137 | `			if( iCount < 1 ){` |
|       - |   138 | `				/* Block meet with the desired criteria */` |
|    3445 |   139 | `				return pBlock;` |
|       - |   140 | `			}` |
|      13 |   141 | `		}` |
|       - |   142 | `		/* Point to the upper block */` |
|   16843 |   143 | `		pBlock = pBlock->pParent;` |
|   16843 |   144 | `		if( pBlock == 0 \|\| (pBlock->iFlags & (GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC)) ){` |
|       - |   145 | `			/* Forbidden */` |
|      72 |   146 | `			break;` |
|       - |   147 | `		}` |
|       5 |   148 | `	}` |
...
|       - |   154 | ` */` |
|  777898 |   155 | `static void GenStateInitBlock(` |
...
|  777903 |   164 | `	pBlock->nFirstInstr = nFirstInstr;` |
|  777903 |   165 | `	pBlock->pUserData   = pUserData;` |
|  777903 |   166 | `	pBlock->pGen        = pGen;` |
|  777903 |   167 | `	pBlock->iFlags      = iType;` |
|  777903 |   168 | `	pBlock->pParent     = 0;` |
|  777903 |   169 | `	SySetInit(&pBlock->aJumpFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  777903 |   170 | `	SySetInit(&pBlock->aPostContFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  777903 |   171 |  |
|       - |   172 | `/*` |
...
|       - |   177 | ` */` |
|  774602 |   178 | `static sxi32 GenStateEnterBlock(` |
...
|  774607 |   188 | `	pBlock = (GenBlock *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(GenBlock));` |
|  774607 |   189 | `	if( pBlock == 0 ){` |
...
|  774607 |   198 | `	SyZero(pBlock,sizeof(GenBlock));` |
|  774607 |   199 | `	GenStateInitBlock(&(*pGen),pBlock,iType,nFirstInstr,pUserData);` |
|       - |   200 | `	/* Link to the parent block */` |
|  774607 |   201 | `	pBlock->pParent = pGen->pCurrent;` |
|       - |   202 | `	/* Mark as the current block */` |
|  774607 |   203 | `	pGen->pCurrent = pBlock;` |
|  774607 |   204 | `	if( ppBlock ){` |
|       - |   205 | `		/* Write a pointer to the new instance */` |
|  376217 |   206 | `		*ppBlock = pBlock;` |
|  188106 |   207 | `	}` |
|  774607 |   208 | `	return SXRET_OK;` |
|  387306 |   209 |  |
|       - |   210 | `/*` |
|       - |   211 | ` * Release block fields without freeing the whole instance.` |
|       - |   212 | ` */` |
|  774594 |   213 | `static void GenStateReleaseBlock(GenBlock *pBlock)` |
|       5 |   214 |  |
|  774599 |   215 | `	SySetRelease(&pBlock->aPostContFix);` |
|  774599 |   216 | `	SySetRelease(&pBlock->aJumpFix);` |
|  774599 |   217 |  |
|       - |   218 | `/*` |
|       - |   219 | ` * Release a block.` |
|       - |   220 | ` */` |
|  774594 |   221 | `static void GenStateFreeBlock(GenBlock *pBlock)` |
|       5 |   222 |  |
|  774599 |   223 | `	ph7_gen_state *pGen = pBlock->pGen;` |
|  774599 |   224 | `	GenStateReleaseBlock(&(*pBlock));` |
|       - |   225 | `	/* Free the instance */` |
|  774599 |   226 | `	SyMemBackendPoolFree(&pGen->pVm->sAllocator,pBlock);` |
|  774599 |   227 |  |
|       - |   228 | `/*` |
|       - |   229 | ` * POP and release a block from the stack of compiled blocks.` |
|       - |   230 | ` */` |
|  774594 |   231 | `static sxi32 GenStateLeaveBlock(ph7_gen_state *pGen,GenBlock **ppBlock)` |
|       5 |   232 |  |
|  774599 |   233 | `	GenBlock *pBlock = pGen->pCurrent;` |
|  774599 |   234 | `	if( pBlock == 0 ){` |
|       - |   235 | `		/* No more block to pop */` |
|     ! 0 |   236 | `		return SXERR_EMPTY;` |
|       - |   237 | `	}` |
|       - |   238 | `	/* Point to the upper block */` |
|  774599 |   239 | `	pGen->pCurrent = pBlock->pParent;` |
|  774599 |   240 | `	if( ppBlock ){` |
|       - |   241 | `		/* Write a pointer to the popped block */` |
|     ! 0 |   242 | `		*ppBlock = pBlock;` |
|     ! 0 |   243 | `	}else{` |
|       - |   244 | `		/* Safely release the block */` |
|  774599 |   245 | `		GenStateFreeBlock(&(*pBlock));` |
|       - |   246 | `	}` |
|  774599 |   247 | `	return SXRET_OK;` |
|  387302 |   248 |  |
|       - |   249 | `/*` |
...
|       - |   258 | ` */` |
|  219862 |   259 | `static sxi32 GenStateNewJumpFixup(GenBlock *pBlock,sxi32 nJumpType,sxu32 nInstrIdx)` |
|       5 |   260 |  |
|       - |   261 | `	JumpFixup sJumpFix;` |
|       - |   262 | `	sxi32 rc;` |
|       - |   263 | `	/* Init the JumpFixup structure */` |
|  219867 |   264 | `	sJumpFix.nJumpType = nJumpType;` |
|  219867 |   265 | `	sJumpFix.nInstrIdx = nInstrIdx;` |
|       - |   266 | `	/* Insert in the jump fixup table */` |
|  219867 |   267 | `	rc = SySetPut(&pBlock->aJumpFix,(const void *)&sJumpFix);` |
|  219867 |   268 | `	return rc;` |
|       5 |   269 |  |
|       - |   270 | `/*` |
...
|       - |   280 | ` */` |
|  541390 |   281 | `static sxu32 GenStateFixJumps(GenBlock *pBlock,sxi32 nJumpType,sxu32 nJumpDest)` |
|       5 |   282 |  |
|       - |   283 | `	JumpFixup *aFix;` |
|       - |   284 | `	VmInstr *pInstr;` |
|       - |   285 | `	sxu32 nFixed;` |
...
|  541395 |   288 | `	aFix = (JumpFixup *)SySetBasePtr(&pBlock->aJumpFix);` |
|       - |   289 | `	/* Fix the desired jumps */` |
|  974431 |   290 | `	for( nFixed = n = 0 ; n < SySetUsed(&pBlock->aJumpFix) ; ++n ){` |
|  433041 |   291 | `		if( aFix[n].nJumpType < 0 ){` |
|       - |   292 | `			/* Already fixed */` |
|  172821 |   293 | `			continue;` |
|       - |   294 | `		}` |
|  260225 |   295 | `		if( nJumpType > 0 && aFix[n].nJumpType != nJumpType ){` |
|       - |   296 | `			/* Not of our interest */` |
|   40365 |   297 | `			continue;` |
|       - |   298 | `		}` |
|       - |   299 | `		/* Point to the instruction to fix */` |
|  219865 |   300 | `		pInstr = PH7_VmGetInstr(pBlock->pGen->pVm,aFix[n].nInstrIdx);` |
|  219865 |   301 | `		if( pInstr ){` |
|  219865 |   302 | `			pInstr->iP2 = nJumpDest;` |
|  219865 |   303 | `			nFixed++;` |
|       - |   304 | `			/* Mark as fixed */` |
|  219865 |   305 | `			aFix[n].nJumpType = -1;` |
|  109930 |   306 | `		}` |
|  109935 |   307 | `	}` |
|       - |   308 | `	/* Total number of fixed jumps */` |
|  541395 |   309 | `	return nFixed;` |
|       5 |   310 |  |
|       - |   311 | `/*` |
...
|       - |   317 | ` */` |
|  219912 |   318 | `static sxi32 GenStateFixGoto(ph7_gen_state *pGen,sxu32 nOfft)` |
|       5 |   319 |  |
...
|  219917 |   326 | `	aJumps = (JumpFixup *)SySetBasePtr(&pGen->aGoto);` |
|       - |   327 | `	/* Fix */` |
|  220063 |   328 | `	for( n = nOfft ; n < SySetUsed(&pGen->aGoto) ; ++n ){` |
...
|      46 |   351 | `		}` |
|      51 |   352 | `	}` |
|  219915 |   353 | `	aLabel = (Label *)SySetBasePtr(&pGen->aLabel);` |
|  220047 |   354 | `	for( n = 0 ; n < SySetUsed(&pGen->aLabel) ; ++n ){` |
...
|      12 |   359 | `		}` |
|      71 |   360 | `	}` |
|  219915 |   361 | `	return SXRET_OK;` |
|  109961 |   362 |  |
|       - |   363 | `/*` |
|       - |   364 | ` * Check if a given token value is installed in the literal table.` |
|       - |   365 | ` */` |
|  695440 |   366 | `static sxi32 GenStateFindLiteral(ph7_gen_state *pGen,const SyString *pValue,sxu32 *pIdx)` |
|       5 |   367 |  |
|       - |   368 | `	SyHashEntry *pEntry;` |
|  695445 |   369 | `	pEntry = SyHashGet(&pGen->hLiteral,(const void *)pValue->zString,pValue->nByte);` |
|  695445 |   370 | `	if( pEntry == 0 ){` |
|  302477 |   371 | `		return SXERR_NOTFOUND;` |
|       - |   372 | `	}` |
|  392973 |   373 | `	*pIdx = (sxu32)SX_PTR_TO_INT(pEntry->pUserData);` |
|  392973 |   374 | `	return SXRET_OK;` |
|  347725 |   375 |  |
|       - |   376 | `/*` |
...
|       - |   385 | ` */` |
|  302472 |   386 | `static sxi32 GenStateInstallLiteral(ph7_gen_state *pGen,ph7_value *pObj,sxu32 nIdx)` |
|       5 |   387 |  |
|  302477 |   388 | `	if( SyBlobLength(&pObj->sBlob) > 0 ){` |
|  302477 |   389 | `		SyHashInsert(&pGen->hLiteral,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob),SX_INT_TO_PTR(nIdx));` |
|  151236 |   390 | `	}` |
|  302477 |   391 | `	return SXRET_OK;` |
|       5 |   392 |  |
|       - |   393 | `/*` |
|       - |   394 | ` * Reserve a room for a numeric constant [i.e: 64-bit integer or real number]` |
|       - |   395 | ` * in the constant table.` |
|       - |   396 | ` */` |
|  115770 |   397 | `static ph7_value * GenStateInstallNumLiteral(ph7_gen_state *pGen,sxu32 *pIdx)` |
|       5 |   398 |  |
|       - |   399 | `	ph7_value *pObj;` |
|  115775 |   400 | `	sxu32 nIdx = 0; /* cc warning */` |
|       - |   401 | `	/* Reserve a new constant */` |
|  115775 |   402 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  115775 |   403 | `	if( pObj == 0 ){` |
|     ! 0 |   404 | `		PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|     ! 0 |   405 | `		return 0;` |
|       - |   406 | `	}` |
|  115775 |   407 | `	*pIdx = nIdx;` |
|       - |   408 | `	/* TODO(chems): Create a numeric table (64bit int keys) same as` |
|       - |   409 | `	 * the constant string iterals table [optimization purposes].` |
|       - |   410 | `	 */` |
|  115775 |   411 | `	return pObj;` |
|   57890 |   412 |  |
|       - |   413 | `/*` |
...
|       - |   426 | ` */` |
|  415786 |   427 | `static void *GenStateAttachStrictFlag(ph7_gen_state *pGen, void *p3)` |
|       5 |   428 |  |
|       - |   429 | `	VmCallArgMap *pMap;` |
|  415791 |   430 | `	if( !pGen->bStrictTypes ) return p3;` |
|      33 |   431 | `	if( p3 == 0 ){` |
...
|       - |   497 | ` */` |
|  116362 |   498 | `static int GenStateFindBadNumericSeparator(` |
|       - |   499 | `	const SyString *pRaw, const char **pBadStart, sxu32 *pBadLen)` |
|       5 |   500 |  |
|  116367 |   501 | `	const char *z = pRaw->zString;` |
|  116367 |   502 | `	sxu32 n = pRaw->nByte;` |
|  116367 |   503 | `	int base = 10;` |
|       - |   504 | `	sxu32 i, start;` |
|  116367 |   505 | `	if( n < 2 ) return 0;` |
|    9715 |   506 | `	if( z[0] == '0' && (z[1] == 'x' \|\| z[1] == 'X') ){` |
|      72 |   507 | `		base = 16;` |
|    9680 |   508 | `	}else if( z[0] == '0' && (z[1] == 'b' \|\| z[1] == 'B') ){` |
|     280 |   509 | `		base = 2;` |
|     139 |   510 | `	}` |
|   35319 |   511 | `	for( i = 0; i < n; ++i ){` |
|   25623 |   512 | `		if( z[i] != '_' ) continue;` |
...
|       - |   538 | ` */` |
|  116362 |   539 | `static sxi32 GenStateValidateNumericSeparator(ph7_gen_state *pGen, SyToken *pToken)` |
|       5 |   540 |  |
|  116367 |   541 | `	const char *zBad = 0;` |
|  116367 |   542 | `	sxu32 nBad = 0;` |
|       - |   543 | `	SyString sBad;` |
|       - |   544 | `	sxi32 rc;` |
|  116367 |   545 | `	if( !GenStateFindBadNumericSeparator(&pToken->sData, &zBad, &nBad) ){` |
|  116353 |   546 | `		return SXRET_OK;` |
|       - |   547 | `	}` |
...
|       - |   571 | ` */` |
|  116348 |   572 | `static sxi32 GenStateStripNumericSeparators(` |
...
|       5 |   577 |  |
|       - |   578 | `	sxu32 i, j;` |
|  116353 |   579 | `	int hasUnderscore = 0;` |
|       - |   580 | `	char *zBuf;` |
|  116353 |   581 | `	*pzAlloc = 0;` |
|  246543 |   582 | `	for( i = 0; i < pToken->nByte; ++i ){` |
|  130447 |   583 | `		if( pToken->zString[i] == '_' ){ hasUnderscore = 1; break; }` |
|   65100 |   584 | `	}` |
|  116353 |   585 | `	if( !hasUnderscore ){` |
|  116101 |   586 | `		SyStringDupPtr(pOut, pToken);` |
|  116101 |   587 | `		return SXRET_OK;` |
|       - |   588 | `	}` |
...
|       - |   619 | ` *  documentation.` |
|       - |   620 | ` */` |
|  116334 |   621 | `static sxi32 PH7_CompileNumLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |   622 |  |
|  116339 |   623 | `	SyToken *pToken = pGen->pIn; /* Raw token */` |
|  116339 |   624 | `	sxu32 nIdx = 0;` |
|       - |   625 | `	char zScratch[GEN_NUM_SCRATCH];` |
|  116339 |   626 | `	char *zAlloc = 0;` |
|       - |   627 | `	SyString sNum;` |
|       - |   628 | `	sxi32 rc;` |
|   58167 |   629 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|  116339 |   630 | `	rc = GenStateValidateNumericSeparator(pGen, pToken);` |
|  116339 |   631 | `	if( rc != SXRET_OK ){` |
|      14 |   632 | `		return rc;` |
|       - |   633 | `	}` |
|  174491 |   634 | `	rc = GenStateStripNumericSeparators(&pGen->pVm->sAllocator, &pToken->sData,` |
|   58162 |   635 | `		zScratch, sizeof(zScratch), &sNum, &zAlloc);` |
|  116329 |   636 | `	if( rc != SXRET_OK ){` |
|     ! 0 |   637 | `		return SXERR_ABORT;` |
|       - |   638 | `	}` |
|  116329 |   639 | `	if( pToken->nType & PH7_TK_INTEGER ){` |
|       - |   640 | `		ph7_value *pObj;` |
|       - |   641 | `		sxi64 iValue;` |
|  115775 |   642 | `		iValue = PH7_TokenValueToInt64(&sNum);` |
|  115775 |   643 | `		pObj = GenStateInstallNumLiteral(&(*pGen),&nIdx);` |
|  115775 |   644 | `		if( pObj == 0 ){` |
|     ! 0 |   645 | `			if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|     ! 0 |   646 | `			return SXERR_ABORT;` |
|       - |   647 | `		}` |
|  115775 |   648 | `		PH7_MemObjInitFromInt(pGen->pVm,pObj,iValue);` |
|   57890 |   649 | `	}else{` |
|       - |   650 | `		/* Real number */` |
|       - |   651 | `		ph7_value *pObj;` |
...
|       - |   661 | `	}` |
|  116329 |   662 | `	if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|       - |   663 | `	/* Emit the load constant instruction */` |
|  116329 |   664 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|       - |   665 | `	/* Node successfully compiled */` |
|  116329 |   666 | `	return SXRET_OK;` |
|   58172 |   667 |  |
|       - |   668 | `/*` |
...
|       - |   677 | ` *` |
|       - |   678 | ` */` |
|   83572 |   679 | `PH7_PRIVATE sxi32 PH7_CompileSimpleString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |   680 |  |
|   83577 |   681 | `	SyString *pStr = &pGen->pIn->sData; /* Constant string literal */` |
|       - |   682 | `	const char *zIn,*zCur,*zEnd;` |
|       - |   683 | `	ph7_value *pObj;` |
|       - |   684 | `	sxu32 nIdx;` |
|   83577 |   685 | `	nIdx = 0; /* Prevent compiler warning */` |
|       - |   686 | `	/* Delimit the string */` |
|   83577 |   687 | `	zIn  = pStr->zString;` |
|   83577 |   688 | `	zEnd = &zIn[pStr->nByte];` |
|   83577 |   689 | `	if( zIn >= zEnd ){` |
|       - |   690 | `		/* Empty string constant: just use the pre‑allocated index from the VM` |
|       - |   691 | `		 * rather than reserving a new object each time. */` |
|    6763 |   692 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,pGen->pVm->nEmptyStringIdx,0,0);` |
|    6763 |   693 | `		return SXRET_OK;` |
|       - |   694 | `	}` |
|   76819 |   695 | `	if( SXRET_OK == GenStateFindLiteral(&(*pGen),pStr,&nIdx) ){` |
|       - |   696 | `		/* Already processed,emit the load constant instruction` |
|       - |   697 | `		 * and return.` |
|       - |   698 | `		 */` |
|   30463 |   699 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   30463 |   700 | `		return SXRET_OK;` |
|       - |   701 | `	}` |
|       - |   702 | `	/* Reserve a new constant */` |
|   46361 |   703 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   46361 |   704 | `	if( pObj == 0 ){` |
...
|       - |   708 | `	}` |
|   46361 |   709 | `	PH7_MemObjInitFromString(pGen->pVm,pObj,0);` |
|       - |   710 | `	/* Compile the node */` |
|   46408 |   711 | `	for(;;){` |
|   92821 |   712 | `		if( zIn >= zEnd ){` |
|       - |   713 | `			/* End of input */` |
|   46361 |   714 | `			break;` |
|       - |   715 | `		}` |
|   46465 |   716 | `		zCur = zIn;` |
|  731419 |   717 | `		while( zIn < zEnd && zIn[0] != '\\' ){` |
|  684959 |   718 | `			zIn++;` |
|       5 |   719 | `		}` |
|   46465 |   720 | `		if( zIn > zCur ){` |
|       - |   721 | `			/* Append raw contents*/` |
|   46441 |   722 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|   23218 |   723 | `		}` |
|   46465 |   724 | `		zIn++;` |
|   46465 |   725 | `		if( zIn < zEnd ){` |
|     126 |   726 | `			if( zIn[0] == '\\' ){` |
...
|   46361 |   743 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   46361 |   744 | `	if( pStr->nByte < 1024 ){` |
|       - |   745 | `		/* Install in the literal table */` |
|   46361 |   746 | `		GenStateInstallLiteral(pGen,pObj,nIdx);` |
|   23178 |   747 | `	}` |
|       - |   748 | `	/* Node successfully compiled */` |
|   46361 |   749 | `	return SXRET_OK;` |
|   41791 |   750 |  |
|       - |   751 | `/*` |
...
|       - |   949 | ` */` |
|   22670 |   950 | `static ph7_value * GenStateNewStrObj(ph7_gen_state *pGen,sxi32 *pCount)` |
|       5 |   951 |  |
|       - |   952 | `	ph7_value *pConstObj;` |
|   22675 |   953 | `	sxu32 nIdx = 0;` |
|       - |   954 | `	/* Reserve a new constant */` |
|   22675 |   955 | `	pConstObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   22675 |   956 | `	if( pConstObj == 0 ){` |
|     ! 0 |   957 | `		PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"PH7 engine is running out of memory");` |
|     ! 0 |   958 | `		return 0;` |
|       - |   959 | `	}` |
|   22675 |   960 | `	(*pCount)++;` |
|   22675 |   961 | `	PH7_MemObjInitFromString(pGen->pVm,pConstObj,0);` |
|       - |   962 | `	/* Emit the load constant instruction */` |
|   22675 |   963 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   22675 |   964 | `	return pConstObj;` |
|   11340 |   965 |  |
|       - |   966 | `/*` |
...
|       - |  1003 | ` */` |
|   21224 |  1004 | `static sxi32 GenStateCompileString(ph7_gen_state *pGen)` |
|       5 |  1005 |  |
|   21229 |  1006 | `	SyString *pStr = &pGen->pIn->sData; /* Raw token value */` |
|       - |  1007 | `	const char *zIn,*zCur,*zEnd;` |
|   21229 |  1008 | `	ph7_value *pObj = 0;` |
|       - |  1009 | `	sxi32 iCons;` |
|       - |  1010 | `	sxi32 rc;` |
|       - |  1011 | `	/* Delimit the string */` |
|   21229 |  1012 | `	zIn  = pStr->zString;` |
|   21229 |  1013 | `	zEnd = &zIn[pStr->nByte];` |
|   21229 |  1014 | `	if( zIn >= zEnd ){` |
...
|       - |  1018 | `		 */` |
|     297 |  1019 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,pGen->pVm->nEmptyStringIdx,0,0);` |
|     297 |  1020 | `		return SXRET_OK;` |
|       - |  1021 | `	}` |
|   20937 |  1022 | `	zCur = 0;` |
...
|   11505 |  1025 | `	for(;;){` |
|   34691 |  1026 | `		zCur = zIn;` |
|  168553 |  1027 | `		while( zIn < zEnd && zIn[0] != '\\'  ){` |
|  135945 |  1028 | `			if( zIn[0] == '{' && &zIn[1] < zEnd && zIn[1] == '$' ){` |
|      67 |  1029 | `				break;` |
|  135819 |  1030 | `			}else if(zIn[0] == '$' && &zIn[1] < zEnd &&` |
|    1954 |  1031 | `				(((unsigned char)zIn[1] >= 0xc0 \|\| SyisAlpha(zIn[1]) \|\| zIn[1] == '{' \|\| zIn[1] == '_')) ){` |
|     980 |  1032 | `					break;` |
|       - |  1033 | `			}` |
|  133867 |  1034 | `			zIn++;` |
|       5 |  1035 | `		}` |
|   34691 |  1036 | `		if( zIn > zCur ){` |
|   16031 |  1037 | `			if( pObj == 0 ){` |
|   15597 |  1038 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|   15597 |  1039 | `				if( pObj == 0 ){` |
|     ! 0 |  1040 | `					return SXERR_ABORT;` |
|       - |  1041 | `				}` |
|    7796 |  1042 | `			}` |
|   16031 |  1043 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|    8013 |  1044 | `		}` |
|   34691 |  1045 | `		if( zIn >= zEnd ){` |
|   20937 |  1046 | `			break;` |
|       - |  1047 | `		}` |
|   13759 |  1048 | `		if( zIn[0] == '\\' ){` |
|   11681 |  1049 | `			const char *zPtr = 0;` |
|       - |  1050 | `			sxu32 n;` |
|   11681 |  1051 | `			zIn++;` |
|   11681 |  1052 | `			if( zIn >= zEnd ){` |
|     ! 0 |  1053 | `				break;` |
|       - |  1054 | `			}` |
|   11681 |  1055 | `			if( pObj == 0 ){` |
|    7083 |  1056 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|    7083 |  1057 | `				if( pObj == 0 ){` |
|     ! 0 |  1058 | `					return SXERR_ABORT;` |
|       - |  1059 | `				}` |
|    3539 |  1060 | `			}` |
|   11681 |  1061 | `			n = sizeof(char); /* size of conversion */` |
|   11681 |  1062 | `			switch( zIn[0] ){` |
|       7 |  1063 | `			case '$':` |
|       - |  1064 | `				/* Dollar sign */` |
...
|   10753 |  1085 | `				PH7_MemObjStringAppend(pObj,"\n",sizeof(char));` |
|   10753 |  1086 | `				break;` |
|      19 |  1087 | `			case 'r':` |
...
|   20937 |  1278 | `	return SXRET_OK;` |
|   10617 |  1279 |  |
|       - |  1280 | `/*` |
|       - |  1281 | ` * Compile a double quoted string.` |
|       - |  1282 | ` *  See the block-comment above for more information.` |
|       - |  1283 | ` */` |
|   21164 |  1284 | `PH7_PRIVATE sxi32 PH7_CompileString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  1285 |  |
|       - |  1286 | `	sxi32 rc;` |
|   21169 |  1287 | `	rc = GenStateCompileString(&(*pGen));` |
|   10582 |  1288 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|       - |  1289 | `	/* Compilation result */` |
|   21169 |  1290 | `	return rc;` |
|       5 |  1291 |  |
|       - |  1292 | `/*` |
...
|       - |  1333 | ` */` |
|   19716 |  1334 | `static sxi32 GenStateCompileArrayEntry(` |
...
|   19721 |  1345 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|       - |  1346 | `	/* Compile the expression*/` |
|   19721 |  1347 | `	rc = PH7_CompileExpr(&(*pGen),iFlags,xValidator);` |
|       - |  1348 | `	/* Restore token stream */` |
|   19721 |  1349 | `	RE_SWAP_DELIMITER(pGen);` |
|   19721 |  1350 | `	return rc;` |
|       5 |  1351 |  |
|       - |  1352 | `/*` |
...
|       - |  1388 | ` */` |
|   28918 |  1389 | `static sxi32 GenStateCompileArrayBody(ph7_gen_state *pGen)` |
|       5 |  1390 |  |
|       - |  1391 | `	sxi32 (*xValidator)(ph7_gen_state *,ph7_expr_node *); /* Expression tree validator callback */` |
|       - |  1392 | `	SyToken *pKey,*pCur;` |
|   28923 |  1393 | `	sxi32 iEmitRef = 0;` |
|   28923 |  1394 | `	sxi32 iSpread = 0;` |
|   28923 |  1395 | `	sxi32 nPair = 0;` |
|       - |  1396 | `	sxi32 iNest;` |
|       - |  1397 | `	sxi32 rc;` |
|   28923 |  1398 | `	xValidator = 0;` |
|   23528 |  1399 | `	for(;;){` |
|       - |  1400 | `		/* Jump leading commas */` |
|   53183 |  1401 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA) ){` |
|    6127 |  1402 | `			pGen->pIn++;` |
|       5 |  1403 | `		}` |
|   47061 |  1404 | `		pCur = pGen->pIn;` |
|   47061 |  1405 | `		if( SXRET_OK != PH7_GetNextExpr(pGen->pIn,pGen->pEnd,&pGen->pIn) ){` |
|       - |  1406 | `			/* No more entry to process */` |
|   28907 |  1407 | `			break;` |
|       - |  1408 | `		}` |
|   18159 |  1409 | `		if( pCur >= pGen->pIn ){` |
|     ! 0 |  1410 | `			continue;` |
|       - |  1411 | `		}` |
|       - |  1412 | `		/* Compile the key if available */` |
|   18159 |  1413 | `		pKey = pCur;` |
|   18159 |  1414 | `		iNest = 0;` |
|   50855 |  1415 | `		while( pCur < pGen->pIn ){` |
|   34165 |  1416 | `			if( (pCur->nType & PH7_TK_ARRAY_OP) && iNest <= 0 ){` |
|    1465 |  1417 | `				break;` |
|       - |  1418 | `			}` |
...
|       - |  1423 | `			 */` |
|   32705 |  1424 | `			if( iNest == 0 && (pCur->nType & PH7_TK_KEYWORD) ){` |
...
|       - |  1486 | `				}` |
|      38 |  1487 | `			}` |
|   32699 |  1488 | `			if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|     265 |  1489 | `				iNest++;` |
|   32568 |  1490 | `			}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}'*/) ){` |
...
|   32699 |  1496 | `			pCur++;` |
|       5 |  1497 | `		}` |
|   18159 |  1498 | `		rc = SXERR_EMPTY;` |
|   18159 |  1499 | `		if( pCur < pGen->pIn ){` |
...
|   16699 |  1521 | `			pCur = pKey;` |
|       - |  1522 | `		}` |
|   18149 |  1523 | `		if( rc == SXERR_EMPTY ){` |
|       - |  1524 | `			/* No available key,load NULL */` |
|   16701 |  1525 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,0 /* nil index */,0,0);` |
|    8348 |  1526 | `		}` |
|   18149 |  1527 | `		if( pCur->nType & PH7_TK_AMPER /*'&'*/){` |
...
|   18147 |  1546 | `		iSpread = (pCur < pGen->pIn && (pCur->nType & PH7_TK_ELLIPSIS)) ? 1 : 0;` |
|   18147 |  1547 | `		if( iSpread && (rc != SXERR_EMPTY \|\| iEmitRef) ){` |
...
|   18143 |  1560 | `		rc = GenStateCompileArrayEntry(&(*pGen),pCur,pGen->pIn,EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,xValidator);` |
|   18143 |  1561 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  1562 | `			return SXERR_ABORT;` |
|       - |  1563 | `		}` |
|   18143 |  1564 | `		if( iSpread ){` |
...
|   18112 |  1567 | `		}else if( iEmitRef ){` |
|       - |  1568 | `			/* Emit the load reference instruction */` |
|      41 |  1569 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_REF,0,0,0,0);` |
|      18 |  1570 | `		}` |
|   18143 |  1571 | `		xValidator = 0;` |
|   18143 |  1572 | `		iEmitRef = 0;` |
|   18143 |  1573 | `		iSpread = 0;` |
|   18143 |  1574 | `		nPair++;` |
|       5 |  1575 | `	}` |
|       - |  1576 | `	/* Emit the load map instruction */` |
|   28907 |  1577 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_MAP,nPair * 2,0,0,0);` |
|       - |  1578 | `	/* Node successfully compiled */` |
|   28907 |  1579 | `	return SXRET_OK;` |
|   14464 |  1580 |  |
|       - |  1581 | `/*` |
...
|       - |  1589 | ` */` |
|   28172 |  1590 | `PH7_PRIVATE sxi32 PH7_CompileArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  1591 |  |
|       - |  1592 | `	/* Jump the 'array' keyword and the leading '(', exclude trailing ')'. */` |
|   28177 |  1593 | `	pGen->pIn += 2;` |
|   28177 |  1594 | `	pGen->pEnd--;` |
|   14086 |  1595 | `	SXUNUSED(iCompileFlag);` |
|   28177 |  1596 | `	return GenStateCompileArrayBody(pGen);` |
|       5 |  1597 |  |
|       - |  1598 | `/*` |
...
|       - |  1602 | ` */` |
|     746 |  1603 | `PH7_PRIVATE sxi32 PH7_CompileShortArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  1604 |  |
|       - |  1605 | `	/* Jump the leading '[', exclude trailing ']'. */` |
|     751 |  1606 | `	pGen->pIn++;` |
|     751 |  1607 | `	pGen->pEnd--;` |
|     373 |  1608 | `	SXUNUSED(iCompileFlag);` |
|     751 |  1609 | `	return GenStateCompileArrayBody(pGen);` |
|       5 |  1610 |  |
|       - |  1611 | `/*` |
...
|       - |  2739 | ` */` |
| 1032422 |  2740 | `PH7_PRIVATE sxi32 PH7_CompileVariable(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  2741 |  |
| 1032427 |  2742 | `	sxu32 nLineLocal = pGen->pIn->nLine;` |
|       - |  2743 | `	sxi32 iVv;` |
|       - |  2744 | `	sxi32 iP1;` |
|       - |  2745 | `	void *p3;` |
|       - |  2746 | `	sxi32 rc;` |
| 1032427 |  2747 | `	iVv = -1; /* Variable variable counter */` |
| 2064861 |  2748 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) ){` |
| 1032439 |  2749 | `		pGen->pIn++;` |
| 1032439 |  2750 | `		iVv++;` |
|       5 |  2751 | `	}` |
| 1032427 |  2752 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_OCB/*'{'*/)) == 0 ){` |
...
|       - |  2760 | `	}` |
| 1032427 |  2761 | `	p3  = 0;` |
| 1032427 |  2762 | `	if( pGen->pIn->nType & PH7_TK_OCB/*'{'*/ ){` |
...
|       - |  2781 | `		SyString *pName;` |
| 1032411 |  2782 | `		char *zName = 0;` |
|       - |  2783 | `		/* Extract variable name */` |
| 1032411 |  2784 | `		pName = &pGen->pIn->sData;` |
|       - |  2785 | `		/* Advance the stream cursor */` |
| 1032411 |  2786 | `		pGen->pIn++;` |
| 1032411 |  2787 | `		pEntry = SyHashGet(&pGen->hVar,(const void *)pName->zString,pName->nByte);` |
| 1032411 |  2788 | `		if( pEntry == 0 ){` |
|       - |  2789 | `			/* Duplicate name */` |
|  138607 |  2790 | `			zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|  138607 |  2791 | `			if( zName == 0 ){` |
...
|  138607 |  2796 | `			SyHashInsert(&pGen->hVar,zName,pName->nByte,zName);` |
|   69306 |  2797 | `		}else{` |
|       - |  2798 | `			/* Name already available */` |
|  893809 |  2799 | `			zName = (char *)pEntry->pUserData;` |
|       - |  2800 | `		}` |
| 1032411 |  2801 | `		p3 = (void *)zName;` |
|       - |  2802 | `	}` |
| 1032423 |  2803 | `	iP1 = 0;` |
| 1032423 |  2804 | `	if( iCompileFlag & EXPR_FLAG_RDONLY_LOAD ){` |
|  376065 |  2805 | `		if( (iCompileFlag & EXPR_FLAG_LOAD_IDX_STORE) == 0 ){` |
|       - |  2806 | `			/* Read-only load.In other words do not create the variable if inexistant */` |
|  376047 |  2807 | `			iP1 = 1;` |
|  188021 |  2808 | `		}` |
|  188030 |  2809 | `	}` |
|       - |  2810 | `	/* Emit the load instruction */` |
| 1032423 |  2811 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,0,p3,0);` |
| 1032435 |  2812 | `	while( iVv > 0 ){` |
|      13 |  2813 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,0,0,0);` |
|      13 |  2814 | `		iVv--;` |
|       1 |  2815 | `	}` |
|       - |  2816 | `	/* Node successfully compiled */` |
| 1032423 |  2817 | `	return SXRET_OK;` |
|  516216 |  2818 |  |
|       - |  2819 | `/*` |
|       - |  2820 | ` * Load a literal.` |
|       - |  2821 | ` */` |
|  726200 |  2822 | `static sxi32 GenStateLoadLiteral(ph7_gen_state *pGen)` |
|       5 |  2823 |  |
|  726205 |  2824 | `	SyToken *pToken = pGen->pIn;` |
|       - |  2825 | `	ph7_value *pObj;` |
|       - |  2826 | `	SyString *pStr;` |
|       - |  2827 | `	sxu32 nIdx;` |
|       - |  2828 | `	/* Extract token value */` |
|  726205 |  2829 | `	pStr = &pToken->sData;` |
|       - |  2830 | `	/* Deal with the reserved literals [i.e: null,false,true,...] first */` |
|  726205 |  2831 | `	if( pStr->nByte == sizeof("NULL") - 1 ){` |
|  153983 |  2832 | `		if( SyStrnicmp(pStr->zString,"null",sizeof("NULL")-1) == 0 ){` |
|       - |  2833 | `			/* NULL constant are always indexed at 0 */` |
|   56721 |  2834 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,0,0,0);` |
|   56721 |  2835 | `			return SXRET_OK;` |
|   97267 |  2836 | `		}else if( SyStrnicmp(pStr->zString,"true",sizeof("TRUE")-1) == 0 ){` |
|       - |  2837 | `			/* TRUE constant are always indexed at 1 */` |
|     615 |  2838 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,1,0,0);` |
|     615 |  2839 | `			return SXRET_OK;` |
|       5 |  2840 | `		}` |
|  678088 |  2841 | `	}else if (pStr->nByte == sizeof("FALSE") - 1 &&` |
|  115070 |  2842 | `		SyStrnicmp(pStr->zString,"false",sizeof("FALSE")-1) == 0 ){` |
|       - |  2843 | `			/* FALSE constant are always indexed at 2 */` |
|   43489 |  2844 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,2,0,0);` |
|   43489 |  2845 | `			return SXRET_OK;` |
|  580363 |  2846 | `	}else if(pStr->nByte == sizeof("__LINE__") - 1 &&` |
|  103240 |  2847 | `		SyMemcmp(pStr->zString,"__LINE__",sizeof("__LINE__")-1) == 0 ){` |
|       - |  2848 | `			/* TICKET 1433-004: __LINE__ constant must be resolved at compile time,not run time */` |
|    9899 |  2849 | `			pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|    9899 |  2850 | `			if( pObj == 0 ){` |
|     ! 0 |  2851 | `				PH7_GenCompileError(pGen,E_ERROR,pToken->nLine,"Fatal, PH7 engine is running out of memory");` |
|     ! 0 |  2852 | `				return SXERR_ABORT;` |
|       - |  2853 | `			}` |
|    9899 |  2854 | `			PH7_MemObjInitFromInt(pGen->pVm,pObj,pToken->nLine);` |
|       - |  2855 | `			/* Emit the load constant instruction */` |
|    9899 |  2856 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|    9899 |  2857 | `			return SXRET_OK;` |
|  535525 |  2858 | `	}else if( pStr->nByte == sizeof("__NAMESPACE__") - 1 &&` |
|   33352 |  2859 | `		SyMemcmp(pStr->zString,"__NAMESPACE__",sizeof("__NAMESPACE__")-1) == 0 ){` |
...
|  534595 |  2875 | `	}else if( (pStr->nByte == sizeof("__FUNCTION__") - 1 &&` |
|   13943 |  2876 | `		SyMemcmp(pStr->zString,"__FUNCTION__",sizeof("__FUNCTION__")-1) == 0) \|\|` |
|  527619 |  2877 | `		(pStr->nByte == sizeof("__METHOD__") - 1 &&` |
|   17576 |  2878 | `		SyMemcmp(pStr->zString,"__METHOD__",sizeof("__METHOD__")-1) == 0) ){` |
...
|  615485 |  2908 | `	if( SXRET_OK != GenStateFindLiteral(&(*pGen),&pToken->sData,&nIdx) ){` |
|       - |  2909 | `		ph7_value *pLitObj;` |
|       - |  2910 | `		/* Unknown literal,install it in the literal table */` |
|  255649 |  2911 | `		pLitObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  255649 |  2912 | `		if( pLitObj == 0 ){` |
|     ! 0 |  2913 | `			PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|     ! 0 |  2914 | `			return SXERR_ABORT;` |
|       - |  2915 | `		}` |
|  255649 |  2916 | `		PH7_MemObjInitFromString(pGen->pVm,pLitObj,&pToken->sData);` |
|  255649 |  2917 | `		GenStateInstallLiteral(&(*pGen),pLitObj,nIdx);` |
|  127822 |  2918 | `	}` |
|       - |  2919 | `	/* Emit the load constant instruction */` |
|  615485 |  2920 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,1,nIdx,0,0);` |
|  615485 |  2921 | `	return SXRET_OK;` |
|  363105 |  2922 |  |
|       - |  2923 | `/*` |
...
|       - |  2928 | ` */` |
|  726236 |  2929 | `static sxi32 GenStateResolveNamespaceLiteral(ph7_gen_state *pGen)` |
|       5 |  2930 |  |
|       - |  2931 | `	sxi32 rc;` |
|  726241 |  2932 | `	if( pGen->pIn >= pGen->pEnd ){` |
|     ! 0 |  2933 | `		return SXRET_OK;` |
|       - |  2934 | `	}` |
|       - |  2935 | `	/* Check if this is a multi-token namespace path */` |
|  726241 |  2936 | `	if( pGen->pIn < &pGen->pEnd[-1] ){` |
...
|  726205 |  2989 | `	rc = GenStateLoadLiteral(&(*pGen));` |
|  726205 |  2990 | `	return rc;` |
|  363123 |  2991 |  |
|       - |  2992 | `/*` |
|       - |  2993 | ` * Compile a literal which is an identifier(name) for a simple value.` |
|       - |  2994 | ` */` |
|  726236 |  2995 | `PH7_PRIVATE sxi32 PH7_CompileLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  2996 |  |
|       - |  2997 | `	sxi32 rc;` |
|  726241 |  2998 | `	rc = GenStateResolveNamespaceLiteral(&(*pGen));` |
|  726241 |  2999 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  3000 | `		SXUNUSED(iCompileFlag); /* cc warning */` |
|     ! 0 |  3001 | `		return rc;` |
|       - |  3002 | `	}` |
|       - |  3003 | `	/* Node successfully compiled */` |
|  726241 |  3004 | `	return SXRET_OK;` |
|  363123 |  3005 |  |
|       - |  3006 | `/*` |
...
|       - |  3164 | ` */` |
|    3436 |  3165 | `static void GenStateEmitExceptionPopForBreak(ph7_gen_state *pGen,GenBlock *pTarget)` |
|       5 |  3166 |  |
|    3441 |  3167 | `	GenBlock *pBlock = pGen->pCurrent;` |
|   20129 |  3168 | `	while( pBlock && pBlock != pTarget ){` |
|   16693 |  3169 | `		if( pBlock->iFlags & GEN_BLOCK_EXCEPTION ){` |
...
|       - |  3179 | `			}` |
|       1 |  3180 | `		}` |
|   16693 |  3181 | `		pBlock = pBlock->pParent;` |
|       5 |  3182 | `	}` |
|    3441 |  3183 |  |
|    3340 |  3184 | `static sxi32 PH7_CompileContinue(ph7_gen_state *pGen)` |
|       5 |  3185 |  |
|       - |  3186 | `	GenBlock *pLoop; /* Target loop */` |
|       - |  3187 | `	sxi32 iLevel;    /* How many nesting loop to skip */` |
|       - |  3188 | `	sxu32 nLineLocal;` |
|       - |  3189 | `	sxi32 rc;` |
|    3345 |  3190 | `	nLineLocal = pGen->pIn->nLine;` |
|    3345 |  3191 | `	iLevel = 0;` |
|       - |  3192 | `	/* Jump the 'continue' keyword */` |
|    3345 |  3193 | `	pGen->pIn++;` |
|    3345 |  3194 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NUM) ){` |
...
|    3345 |  3220 | `	pLoop = GenStateFetchBlock(pGen->pCurrent,GEN_BLOCK_LOOP,iLevel);` |
|    3345 |  3221 | `	if( pLoop == 0 ){` |
...
|       - |  3227 | `		}` |
|       8 |  3228 | `	}else{` |
|    3335 |  3229 | `		sxu32 nInstrIdx = 0;` |
|       - |  3230 | `		/* Emit POP_EXCEPTION for any try blocks between here and the loop */` |
|    3335 |  3231 | `		GenStateEmitExceptionPopForBreak(&(*pGen),pLoop);` |
|    3335 |  3232 | `		if( pLoop->iFlags & GEN_BLOCK_SWITCH ){` |
...
|    3331 |  3244 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pLoop->nFirstInstr,0,&nInstrIdx);` |
|    3331 |  3245 | `			if( pLoop->bPostContinue == TRUE ){` |
...
|       - |  3252 | `		}` |
|       - |  3253 | `	}` |
|    3345 |  3254 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
...
|       - |  3535 | ` * message.` |
|       - |  3536 | ` */` |
|  399876 |  3537 | `static sxi32 PH7_CompileBlock(` |
...
|       - |  3542 | `	sxi32 rc;` |
|       - |  3543 | `	sxu32 nLine;` |
|  399881 |  3544 | `	if( pGen->pIn->nType & PH7_TK_OCB /* '{' */ ){` |
|  398395 |  3545 | `		nLine = pGen->pIn->nLine;` |
|  398395 |  3546 | `		rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_STD,PH7_VmInstrLength(pGen->pVm),0,0);` |
|  398395 |  3547 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  3548 | `			return SXERR_ABORT;` |
|       - |  3549 | `		}` |
|  398395 |  3550 | `		pGen->pIn++;` |
|       - |  3551 | `		/* Compile until we hit the closing braces '}' */` |
|  544132 |  3552 | `		for(;;){` |
| 1088269 |  3553 | `			if( pGen->pIn >= pGen->pEnd ){` |
...
|       - |  3562 | `				}` |
|     ! 0 |  3563 | `			}` |
| 1088249 |  3564 | `			if( pGen->pIn->nType & PH7_TK_CCB/*'}'*/ ){` |
|       - |  3565 | `				/* Closing braces found,break immediately*/` |
|  398375 |  3566 | `				pGen->pIn++;` |
|  398375 |  3567 | `				break;` |
|       - |  3568 | `			}` |
|       - |  3569 | `			/* Compile a single statement */` |
|  689879 |  3570 | `			rc = GenStateCompileChunk(&(*pGen),PH7_COMPILE_SINGLE_STMT);` |
|  689879 |  3571 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  3572 | `				return SXERR_ABORT;` |
|       - |  3573 | `			}` |
|       5 |  3574 | `		}` |
|  398395 |  3575 | `		GenStateLeaveBlock(&(*pGen),0);` |
|  200686 |  3576 | `	}else if( (pGen->pIn->nType & PH7_TK_COLON /* ':' */) && nKeywordEnd > 0 ){` |
|     ! 0 |  3577 | `		pGen->pIn++;` |
...
|  399881 |  3626 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|     ! 0 |  3627 | `		pGen->pIn++;` |
|     ! 0 |  3628 | `	}` |
|  399881 |  3629 | `	return SXRET_OK;` |
|  199943 |  3630 |  |
|       - |  3631 | `/*` |
...
|       - |  3648 | ` *   endwhile;` |
|       - |  3649 | ` */` |
|   13304 |  3650 | `static sxi32 PH7_CompileWhile(ph7_gen_state *pGen)` |
|       5 |  3651 |  |
|   13309 |  3652 | `	GenBlock *pWhileBlock = 0;` |
|   13309 |  3653 | `	SyToken *pTmp,*pEnd = 0;` |
|       - |  3654 | `	sxu32 nFalseJump;` |
|       - |  3655 | `	sxu32 nLine;` |
|       - |  3656 | `	sxi32 rc;` |
|   13309 |  3657 | `	nLine = pGen->pIn->nLine;` |
|       - |  3658 | `	/* Jump the 'while' keyword */` |
|   13309 |  3659 | `	pGen->pIn++;` |
|   13309 |  3660 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  3661 | `		/* Syntax error */` |
...
|   13309 |  3672 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pWhileBlock);` |
|   13309 |  3673 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  3674 | `		return SXERR_ABORT;` |
|       - |  3675 | `	}` |
|       - |  3676 | `	/* Delimit the condition */` |
|   13309 |  3677 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   13309 |  3678 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|   13309 |  3687 | `	pTmp = pGen->pEnd;` |
|   13309 |  3688 | `	pGen->pEnd = pEnd;` |
|       - |  3689 | `	/* Compile the expression */` |
|   13309 |  3690 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   13309 |  3691 | `	if( rc == SXERR_ABORT ){` |
|       - |  3692 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  3693 | `		return SXERR_ABORT;` |
|       - |  3694 | `	}` |
|       - |  3695 | `	/* Update token stream */` |
|   13309 |  3696 | `	while(pGen->pIn < pEnd ){` |
...
|   13309 |  3704 | `	pGen->pIn  = &pEnd[1];` |
|   13309 |  3705 | `	pGen->pEnd = pTmp;` |
|       - |  3706 | `	/* Emit the false jump */` |
|   13309 |  3707 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nFalseJump);` |
|       - |  3708 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   13309 |  3709 | `	GenStateNewJumpFixup(pWhileBlock,PH7_OP_JZ,nFalseJump);` |
|       - |  3710 | `	/* Compile the loop body */` |
|   13309 |  3711 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDWHILE);` |
|   13309 |  3712 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  3713 | `		return SXERR_ABORT;` |
|       - |  3714 | `	}` |
|       - |  3715 | `	/* Emit the unconditional jump to the start of the loop */` |
|   13309 |  3716 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pWhileBlock->nFirstInstr,0,0);` |
|       - |  3717 | `	/* Fix all jumps now the destination is resolved */` |
|   13309 |  3718 | `	GenStateFixJumps(pWhileBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - |  3719 | `	/* Release the loop block */` |
|   13309 |  3720 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  3721 | `	/* Statement successfully compiled */` |
|   13309 |  3722 | `	return SXRET_OK;` |
|     ! 0 |  3723 | `Synchronize:` |
...
|       - |  3878 | ` */` |
|   13304 |  3879 | `static sxi32 PH7_CompileFor(ph7_gen_state *pGen)` |
|       5 |  3880 |  |
|   13309 |  3881 | `	SyToken *pTmp,*pPostStart,*pEnd = 0;` |
|   13309 |  3882 | `	GenBlock *pForBlock = 0;` |
|       - |  3883 | `	sxu32 nFalseJump;` |
|       - |  3884 | `	sxu32 nLine;` |
|       - |  3885 | `	sxi32 rc;` |
|   13309 |  3886 | `	nLine = pGen->pIn->nLine;` |
|       - |  3887 | `	/* Jump the 'for' keyword */` |
|   13309 |  3888 | `	pGen->pIn++;` |
|   13309 |  3889 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  3890 | `		/* Syntax error */` |
...
|   13309 |  3901 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   13309 |  3902 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|   13309 |  3917 | `	pTmp = pGen->pEnd;` |
|   13309 |  3918 | `	pGen->pEnd = pEnd;` |
|       - |  3919 | `	/* Compile initialization expressions if available */` |
|   13309 |  3920 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|       - |  3921 | `	/* Pop operand lvalues */` |
|   13309 |  3922 | `	if( rc == SXERR_ABORT ){` |
|       - |  3923 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  3924 | `		return SXERR_ABORT;` |
|   13309 |  3925 | `	}else if( rc != SXERR_EMPTY ){` |
|   13307 |  3926 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|    6651 |  3927 | `	}` |
|   13309 |  3928 | `	if( (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|       - |  3929 | `		/* Syntax error */` |
...
|   13309 |  3941 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pForBlock);` |
|   13309 |  3942 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  3943 | `		return SXERR_ABORT;` |
|       - |  3944 | `	}` |
|       - |  3945 | `	/* Deffer continue jumps */` |
|   13309 |  3946 | `	pForBlock->bPostContinue = TRUE;` |
|       - |  3947 | `	/* Compile the condition */` |
|   13309 |  3948 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   13309 |  3949 | `	if( rc == SXERR_ABORT ){` |
|       - |  3950 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  3951 | `		return SXERR_ABORT;` |
|   13309 |  3952 | `	}else if( rc != SXERR_EMPTY ){` |
|       - |  3953 | `		/* Emit the false jump */` |
|   13307 |  3954 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nFalseJump);` |
|       - |  3955 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   13307 |  3956 | `		GenStateNewJumpFixup(pForBlock,PH7_OP_JZ,nFalseJump);` |
|    6651 |  3957 | `	}` |
|   13309 |  3958 | `	if( (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|       - |  3959 | `		/* Syntax error */` |
...
|   13305 |  3971 | `	pPostStart = pGen->pIn;` |
|       - |  3972 | `	/* Compile the loop body */` |
|   13305 |  3973 | `	pGen->pIn  = &pEnd[1]; /* Jump the trailing parenthesis ')' */` |
|   13305 |  3974 | `	pGen->pEnd = pTmp;` |
|   13305 |  3975 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDFOR);` |
|   13305 |  3976 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  3977 | `		return SXERR_ABORT;` |
|       - |  3978 | `	}` |
|       - |  3979 | `	/* Fix post-continue jumps */` |
|   13305 |  3980 | `	if( SySetUsed(&pForBlock->aPostContFix) > 0 ){` |
...
|   13305 |  3996 | `	while( pPostStart < pEnd && (pPostStart->nType & PH7_TK_SEMI) ){` |
|     ! 0 |  3997 | `		pPostStart++;` |
|     ! 0 |  3998 | `	}` |
|   13305 |  3999 | `	if( pPostStart < pEnd ){` |
|       - |  4000 | `		SyToken *pTmpIn,*pTmpEnd;` |
|   13305 |  4001 | `		SWAP_DELIMITER(pGen,pPostStart,pEnd);` |
|   13305 |  4002 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   13305 |  4003 | `		if( pGen->pIn < pGen->pEnd ){` |
|       - |  4004 | `			/* Syntax error */` |
...
|       - |  4011 | `		}` |
|   13305 |  4012 | `		RE_SWAP_DELIMITER(pGen);` |
|   13305 |  4013 | `		if( rc == SXERR_ABORT ){` |
|       - |  4014 | `			/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4015 | `			return SXERR_ABORT;` |
|   13305 |  4016 | `		}else if( rc != SXERR_EMPTY){` |
|       - |  4017 | `			/* Pop operand lvalue */` |
|   13305 |  4018 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|    6650 |  4019 | `		}` |
|    6650 |  4020 | `	}` |
|       - |  4021 | `	/* Emit the unconditional jump to the start of the loop */` |
|   13305 |  4022 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pForBlock->nFirstInstr,0,0);` |
|       - |  4023 | `	/* Fix all jumps now the destination is resolved */` |
|   13305 |  4024 | `	GenStateFixJumps(pForBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - |  4025 | `	/* Release the loop block */` |
|   13305 |  4026 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  4027 | `	/* Statement successfully compiled */` |
|   13305 |  4028 | `	return SXRET_OK;` |
|    6657 |  4029 |  |
...
|       - |  4032 | ` * are allowed.` |
|       - |  4033 | ` */` |
|    7100 |  4034 | `static sxi32 GenStateForEachNodeValidator(ph7_gen_state *pGen,ph7_expr_node *pRoot)` |
|       5 |  4035 |  |
|    7105 |  4036 | `	sxi32 rc = SXRET_OK; /* Assume a valid expression tree */` |
|    7105 |  4037 | `	if( pRoot->xCode != PH7_CompileVariable ){` |
...
|       - |  4072 | ` */` |
|    3618 |  4073 | `static sxi32 PH7_CompileForeach(ph7_gen_state *pGen)` |
|       5 |  4074 |  |
|    3623 |  4075 | `	SyToken *pCur,*pTmp,*pEnd = 0;` |
|    3623 |  4076 | `	SyToken *pListStart = 0,*pListEnd = 0;` |
|    3623 |  4077 | `	GenBlock *pForeachBlock = 0;` |
|       - |  4078 | `	ph7_foreach_info *pInfo;` |
|       - |  4079 | `	sxu32 nFalseJump;` |
|       - |  4080 | `	VmInstr *pInstr;` |
|       - |  4081 | `	sxu32 nLine;` |
|       - |  4082 | `	sxi32 rc;` |
|    3623 |  4083 | `	nLine = pGen->pIn->nLine;` |
|       - |  4084 | `	/* Jump the 'foreach' keyword */` |
|    3623 |  4085 | `	pGen->pIn++;` |
|    3623 |  4086 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  4087 | `		/* Syntax error */` |
...
|    3623 |  4098 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pForeachBlock);` |
|    3623 |  4099 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  4100 | `		return SXERR_ABORT;` |
|       - |  4101 | `	}` |
|       - |  4102 | `	/* Delimit the expression */` |
|    3623 |  4103 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|    3623 |  4104 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|    3623 |  4119 | `	pCur = pGen->pIn;` |
|   24317 |  4120 | `	while( pCur < pEnd ){` |
|   24317 |  4121 | `		if( pCur->nType & PH7_TK_KEYWORD ){` |
|    3637 |  4122 | `			sxi32 nKeywrd = SX_PTR_TO_INT(pCur->pUserData);` |
|    3637 |  4123 | `			if( nKeywrd == PH7_TKWRD_AS ){` |
...
|    3623 |  4141 | `	pTmp = pGen->pEnd;` |
|    3623 |  4142 | `	pGen->pEnd = pCur;` |
|    3623 |  4143 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|    3623 |  4144 | `	if( rc == SXERR_ABORT ){` |
|       - |  4145 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4146 | `		return SXERR_ABORT;` |
|       - |  4147 | `	}` |
|       - |  4148 | `	/* Update token stream */` |
|    3623 |  4149 | `	while(pGen->pIn < pCur ){` |
...
|     ! 0 |  4155 | `		pGen->pIn++;` |
|     ! 0 |  4156 | `	}` |
|    3623 |  4157 | `	pCur++; /* Jump the 'as' keyword */` |
|    3623 |  4158 | `	pGen->pIn = pCur;` |
|    3623 |  4159 | `	if( pGen->pIn >= pEnd ){` |
...
|    3623 |  4166 | `	pInfo = (ph7_foreach_info *)SyMemBackendAlloc(&pGen->pVm->sAllocator,sizeof(ph7_foreach_info));` |
|    3623 |  4167 | `	if( pInfo == 0 ){` |
...
|    3623 |  4172 | `	SyZero(pInfo,sizeof(ph7_foreach_info));` |
|       - |  4173 | `	/* Initialize structure fields */` |
|    3623 |  4174 | `	SySetInit(&pInfo->aStep,&pGen->pVm->sAllocator,sizeof(ph7_foreach_step *));` |
|       - |  4175 | `	/* Check if we have a key field */` |
|   10909 |  4176 | `	while( pCur < pEnd && (pCur->nType & PH7_TK_ARRAY_OP) == 0 ){` |
|    7291 |  4177 | `		pCur++;` |
|       5 |  4178 | `	}` |
|    3623 |  4179 | `	if( pCur < pEnd ){` |
|       - |  4180 | `		/* Compile the expression holding the key name */` |
|    3497 |  4181 | `		if( pGen->pIn >= pCur ){` |
...
|       - |  4186 | `			}` |
|     ! 0 |  4187 | `		}else{` |
|    3497 |  4188 | `			pGen->pEnd = pCur;` |
|    3497 |  4189 | `			rc = PH7_CompileExpr(&(*pGen),0,GenStateForEachNodeValidator);` |
|    3497 |  4190 | `			if( rc == SXERR_ABORT ){` |
|       - |  4191 | `				/* Don't worry about freeing memory, everything will be released shortly */` |
|     ! 0 |  4192 | `				return SXERR_ABORT;` |
|       - |  4193 | `			}` |
|    3497 |  4194 | `			pInstr = PH7_VmPopInstr(pGen->pVm);` |
|    3497 |  4195 | `			if( pInstr->p3 ){` |
|       - |  4196 | `				/* Record key name */` |
|    3497 |  4197 | `				SyStringInitFromBuf(&pInfo->sKey,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|    1746 |  4198 | `			}` |
|    3497 |  4199 | `			pInfo->iFlags \|= PH7_4EACH_STEP_KEY;` |
|       - |  4200 | `		}` |
|    3497 |  4201 | `		pGen->pIn = &pCur[1]; /* Jump the arrow */` |
|    1746 |  4202 | `	}` |
|    3623 |  4203 | `	pGen->pEnd = pEnd;` |
|    3623 |  4204 | `	if( pGen->pIn >= pEnd ){` |
...
|    3618 |  4259 | `	}else if( pGen->pIn->nType & PH7_TK_OSB ){` |
...
|    3613 |  4292 | `		rc = PH7_CompileExpr(&(*pGen),0,GenStateForEachNodeValidator);` |
|    3613 |  4293 | `		if( rc == SXERR_ABORT ){` |
|       - |  4294 | `			/* Don't worry about freeing memory, everything will be released shortly */` |
|     ! 0 |  4295 | `			return SXERR_ABORT;` |
|       - |  4296 | `		}` |
|    3613 |  4297 | `		pInstr = PH7_VmPopInstr(pGen->pVm);` |
|    3613 |  4298 | `		if( pInstr->p3 ){` |
|       - |  4299 | `			/* Record value name */` |
|    3613 |  4300 | `			SyStringInitFromBuf(&pInfo->sValue,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|    1804 |  4301 | `		}` |
|       - |  4302 | `	}` |
|       - |  4303 | `	/* Emit the 'FOREACH_INIT' instruction */` |
|    3621 |  4304 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_FOREACH_INIT,0,0,pInfo,&nFalseJump);` |
|       - |  4305 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|    3621 |  4306 | `	GenStateNewJumpFixup(pForeachBlock,PH7_OP_FOREACH_INIT,nFalseJump);` |
|       - |  4307 | `	/* Record the first instruction to execute */` |
|    3621 |  4308 | `	pForeachBlock->nFirstInstr = PH7_VmInstrLength(pGen->pVm);` |
|       - |  4309 | `	/* Emit the FOREACH_STEP instruction */` |
|    3621 |  4310 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_FOREACH_STEP,0,0,pInfo,&nFalseJump);` |
|       - |  4311 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|    3621 |  4312 | `	GenStateNewJumpFixup(pForeachBlock,PH7_OP_FOREACH_STEP,nFalseJump);` |
|       - |  4313 | `	/* If list() unpacking, emit bytecode to destructure the temp variable */` |
|    3621 |  4314 | `	if( (pInfo->iFlags & PH7_4EACH_STEP_LIST) && pListStart && pListEnd ){` |
...
|    3621 |  4342 | `	pGen->pIn = &pEnd[1];` |
|    3621 |  4343 | `	pGen->pEnd = pTmp;` |
|    3621 |  4344 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_END4EACH);` |
|    3621 |  4345 | `	if( rc == SXERR_ABORT ){` |
...
|    3621 |  4350 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pForeachBlock->nFirstInstr,0,0);` |
|       - |  4351 | `	/* Fix all jumps now the destination is resolved */` |
|    3621 |  4352 | `	GenStateFixJumps(pForeachBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - |  4353 | `	/* Release the loop block */` |
|    3621 |  4354 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  4355 | `	/* Statement successfully compiled */` |
|    3621 |  4356 | `	return SXRET_OK;` |
|       1 |  4357 | `Synchronize:` |
...
|       - |  4396 | ` *    ?>` |
|       - |  4397 | ` */` |
|  138334 |  4398 | `static sxi32 PH7_CompileIf(ph7_gen_state *pGen)` |
|       5 |  4399 |  |
|  138339 |  4400 | `	SyToken *pToken,*pTmp,*pEnd = 0;` |
|  138339 |  4401 | `	GenBlock *pCondBlock = 0;` |
|       - |  4402 | `	sxu32 nJumpIdx;` |
|       - |  4403 | `	sxu32 nKeyID;` |
|       - |  4404 | `	sxi32 rc;` |
|       - |  4405 | `	/* Jump the 'if' keyword */` |
|  138339 |  4406 | `	pGen->pIn++;` |
|  138339 |  4407 | `	pToken = pGen->pIn;` |
|       - |  4408 | `	/* Create the conditional block */` |
|  138339 |  4409 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_COND,PH7_VmInstrLength(pGen->pVm),0,&pCondBlock);` |
|  138339 |  4410 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  4411 | `		return SXERR_ABORT;` |
|       - |  4412 | `	}` |
|       - |  4413 | `	/* Process as many [if/else if/elseif/else] blocks as we can */` |
|   75772 |  4414 | `	for(;;){` |
|  151549 |  4415 | `		if( pToken >= pGen->pEnd \|\| (pToken->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  4416 | `			/* Syntax error */` |
...
|  151549 |  4430 | `		PH7_DelimitNestedTokens(pToken,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|  151549 |  4431 | `		if( pToken >= pEnd \|\| (pEnd->nType & PH7_TK_RPAREN) == 0 ){` |
|       - |  4432 | `			/* Syntax error */` |
...
|  151549 |  4444 | `		SWAP_TOKEN_STREAM(pGen,pToken,pEnd);` |
|       - |  4445 | `		/* Compile the condition */` |
|  151549 |  4446 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|       - |  4447 | `		/* Update token stream */` |
|  151549 |  4448 | `		while(pGen->pIn < pEnd ){` |
|     ! 0 |  4449 | `			PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Unexpected token '%z'",&pGen->pIn->sData);` |
|     ! 0 |  4450 | `			pGen->pIn++;` |
|     ! 0 |  4451 | `		}` |
|  151549 |  4452 | `		pGen->pIn  = &pEnd[1];` |
|  151549 |  4453 | `		pGen->pEnd = pTmp;` |
|  151549 |  4454 | `		if( rc == SXERR_ABORT ){` |
|       - |  4455 | `			/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4456 | `			return SXERR_ABORT;` |
|       - |  4457 | `		}` |
|       - |  4458 | `		/* Emit the false jump */` |
|  151549 |  4459 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nJumpIdx);` |
|       - |  4460 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|  151549 |  4461 | `		GenStateNewJumpFixup(pCondBlock,PH7_OP_JZ,nJumpIdx);` |
|       - |  4462 | `		/* Compile the body */` |
|  151549 |  4463 | `		rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDIF);` |
|  151549 |  4464 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  4465 | `			return SXERR_ABORT;` |
|       - |  4466 | `		}` |
|  151549 |  4467 | `		if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
|   42282 |  4468 | `			break;` |
|       - |  4469 | `		}` |
|       - |  4470 | `		/* Ensure that the keyword ID is 'else if' or 'else' */` |
|   66995 |  4471 | `		nKeyID = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   66995 |  4472 | `		if( (nKeyID & (PH7_TKWRD_ELSE\|PH7_TKWRD_ELIF)) == 0 ){` |
|   43155 |  4473 | `			break;` |
|       - |  4474 | `		}` |
|       - |  4475 | `		/* Emit the unconditional jump */` |
|   23845 |  4476 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,0,0,&nJumpIdx);` |
|       - |  4477 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   23845 |  4478 | `		GenStateNewJumpFixup(pCondBlock,PH7_OP_JMP,nJumpIdx);` |
|   23845 |  4479 | `		if( nKeyID & PH7_TKWRD_ELSE ){` |
|   17227 |  4480 | `			pToken = &pGen->pIn[1];` |
|   17227 |  4481 | `			if( pToken >= pGen->pEnd \|\| (pToken->nType & PH7_TK_KEYWORD) == 0 \|\|` |
|    6622 |  4482 | `				SX_PTR_TO_INT(pToken->pUserData) != PH7_TKWRD_IF ){` |
|    5320 |  4483 | `					break;` |
|       - |  4484 | `			}` |
|    6597 |  4485 | `			pGen->pIn++; /* Jump the 'else' keyword */` |
|    3296 |  4486 | `		}` |
|   13215 |  4487 | `		pGen->pIn++; /* Jump the 'elseif/if' keyword */` |
|       - |  4488 | `		/* Synchronize cursors */` |
|   13215 |  4489 | `		pToken = pGen->pIn;` |
|       - |  4490 | `		/* Fix the false jump */` |
|   13215 |  4491 | `		GenStateFixJumps(pCondBlock,PH7_OP_JZ,PH7_VmInstrLength(pGen->pVm));` |
|       5 |  4492 | `	} /* For(;;) */` |
|       - |  4493 | `	/* Fix the false jump */` |
|  138339 |  4494 | `	GenStateFixJumps(pCondBlock,PH7_OP_JZ,PH7_VmInstrLength(pGen->pVm));` |
|  138339 |  4495 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|   53780 |  4496 | `		(SX_PTR_TO_INT(pGen->pIn->pUserData) & PH7_TKWRD_ELSE) ){` |
|       - |  4497 | `			/* Compile the else block */` |
|   10635 |  4498 | `			pGen->pIn++;` |
|   10635 |  4499 | `			rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDIF);` |
|   10635 |  4500 | `			if( rc == SXERR_ABORT ){` |
|       - |  4501 |  |
|     ! 0 |  4502 | `				return SXERR_ABORT;` |
|       - |  4503 | `			}` |
|    5315 |  4504 | `	}` |
|  138339 |  4505 | `	nJumpIdx = PH7_VmInstrLength(pGen->pVm);` |
|       - |  4506 | `	/* Fix all unconditional jumps now the destination is resolved */` |
|  138339 |  4507 | `	GenStateFixJumps(pCondBlock,PH7_OP_JMP,nJumpIdx);` |
|       - |  4508 | `	/* Release the conditional block */` |
|  138339 |  4509 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  4510 | `	/* Statement successfully compiled */` |
|  138339 |  4511 | `	return SXRET_OK;` |
|     ! 0 |  4512 | `Synchronize:` |
...
|       - |  4612 | ` */` |
|  218640 |  4613 | `static sxi32 PH7_CompileReturn(ph7_gen_state *pGen)` |
|       5 |  4614 |  |
|  218645 |  4615 | `	sxi32 nRet = 0; /* TRUE if there is a return value */` |
|       - |  4616 | `	sxi32 rc;` |
|       - |  4617 | `	/* Jump the 'return' keyword */` |
|  218645 |  4618 | `	pGen->pIn++;` |
|  218645 |  4619 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|       - |  4620 | `		/* Compile the expression */` |
|  218619 |  4621 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|  218619 |  4622 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  4623 | `			return SXERR_ABORT;` |
|  218619 |  4624 | `		}else if(rc != SXERR_EMPTY ){` |
|  218619 |  4625 | `			nRet = 1;` |
|  109307 |  4626 | `		}` |
|  109307 |  4627 | `	}` |
...
|  218645 |  4633 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,nRet,1,0,0);` |
|  218645 |  4634 | `	return SXRET_OK;` |
|  109325 |  4635 |  |
|       - |  4636 | `/*` |
...
|       - |  4725 | ` */` |
|   13604 |  4726 | `static sxi32 PH7_CompileEcho(ph7_gen_state *pGen)` |
|       5 |  4727 |  |
|   13609 |  4728 | `	SyToken *pTmp,*pNext = 0;` |
|       - |  4729 | `	sxi32 rc;` |
|       - |  4730 | `	/* Jump the 'echo' keyword */` |
|   13609 |  4731 | `	pGen->pIn++;` |
|       - |  4732 | `	/* Compile arguments one after one */` |
|   13609 |  4733 | `	pTmp = pGen->pEnd;` |
|   29547 |  4734 | `	while( SXRET_OK == PH7_GetNextExpr(pGen->pIn,pTmp,&pNext) ){` |
|   15943 |  4735 | `		if( pGen->pIn < pNext ){` |
|   15943 |  4736 | `			pGen->pEnd = pNext;` |
|   15943 |  4737 | `			rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_RDONLY_LOAD/* Do not create variable if inexistant */,0);` |
|   15943 |  4738 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  4739 | `				return SXERR_ABORT;` |
|   15943 |  4740 | `			}else if( rc != SXERR_EMPTY ){` |
|       - |  4741 | `				/* Emit the consume instruction */` |
|   15919 |  4742 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_CONSUME,1,0,0,0);` |
|    7957 |  4743 | `			}` |
|    7969 |  4744 | `		}` |
|       - |  4745 | `		/* Jump trailing commas */` |
|   18277 |  4746 | `		while( pNext < pTmp && (pNext->nType & PH7_TK_COMMA) ){` |
|    2339 |  4747 | `			pNext++;` |
|       5 |  4748 | `		}` |
|   15943 |  4749 | `		pGen->pIn = pNext;` |
|       5 |  4750 | `	}` |
|       - |  4751 | `	/* Restore token stream */` |
|   13609 |  4752 | `	pGen->pEnd = pTmp;` |
|   13609 |  4753 | `	return SXRET_OK;` |
|    6807 |  4754 |  |
|       - |  4755 | `/*` |
...
|       - |  4920 | ` */` |
|  408056 |  4921 | `static sxu32 GenStateNsQualifyName(ph7_gen_state *pGen,sxu32 nOrigIdx,SyHash *pImports,int *pFromImport)` |
|       5 |  4922 |  |
|       - |  4923 | `	ph7_value *pLit;` |
...
|       - |  4931 | `	ph7_value *pNew;` |
|  408061 |  4932 | `	if( pFromImport ){` |
|  390105 |  4933 | `		*pFromImport = 0;` |
|  195050 |  4934 | `	}` |
|  408061 |  4935 | `	pLit = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,nOrigIdx);` |
|  408061 |  4936 | `	if( !pLit \|\| !(pLit->iFlags & MEMOBJ_STRING) \|\| SyBlobLength(&pLit->sBlob) == 0 ){` |
|     ! 0 |  4937 | `		return nOrigIdx;` |
|       - |  4938 | `	}` |
|  408061 |  4939 | `	zLit = (const char *)SyBlobData(&pLit->sBlob);` |
|  408061 |  4940 | `	nLit = (sxu32)SyBlobLength(&pLit->sBlob);` |
|       - |  4941 | `	/* Skip if already qualified (contains backslash) */` |
|  408061 |  4942 | `	hasNsSep = 0;` |
| 4414665 |  4943 | `	for( k = 0; k < nLit; k++ ){` |
| 4006617 |  4944 | `		if( zLit[k] == '\\' ){ hasNsSep = 1; break; }` |
| 2003307 |  4945 | `	}` |
|  408061 |  4946 | `	if( hasNsSep ){` |
|      11 |  4947 | `		return nOrigIdx;` |
|       - |  4948 | `	}` |
|       - |  4949 | `	/* Check use imports first (works even outside namespaces) */` |
|  408053 |  4950 | `	SyBlobReset(&pGen->sWorker);` |
|  408053 |  4951 | `	pImport = SyHashGet(pImports,(const void *)zLit,nLit);` |
|  408053 |  4952 | `	if( pImport ){` |
...
|       8 |  4957 | `		}` |
|      23 |  4958 | `	}else{` |
|  408017 |  4959 | `		if( SyBlobLength(&pGen->sNamespace) == 0 ){` |
|  407927 |  4960 | `			return nOrigIdx; /* Not in a namespace and no import match */` |
|       - |  4961 | `		}` |
...
|       - |  4983 | ` */` |
|   89730 |  4984 | `static void GenStateResolveName(ph7_gen_state *pGen,const SyString *pName,SyBlob *pOut)` |
|       5 |  4985 |  |
|       - |  4986 | `	SyHashEntry *pImport;` |
|       - |  4987 | `	/* Check use imports first */` |
|   89735 |  4988 | `	pImport = SyHashGet(&pGen->hUseImports,(const void *)pName->zString,pName->nByte);` |
|   89735 |  4989 | `	if( pImport ){` |
...
|       - |  5005 | ` */` |
|  126402 |  5006 | `static void GenStateBuildFQN(ph7_gen_state *pGen,const SyString *pName,SyBlob *pOut)` |
|       5 |  5007 |  |
|  126407 |  5008 | `	if( SyBlobLength(&pGen->sNamespace) > 0 ){` |
|      63 |  5009 | `		SyBlobAppend(pOut,SyBlobData(&pGen->sNamespace),SyBlobLength(&pGen->sNamespace));` |
|      63 |  5010 | `		SyBlobAppend(pOut,"\\",1);` |
|      29 |  5011 | `	}` |
|  126407 |  5012 | `	SyBlobAppend(pOut,pName->zString,pName->nByte);` |
|  126407 |  5013 |  |
|       - |  5014 | `/*` |
...
|       - |  5510 | ` */` |
|   62658 |  5511 | `static sxi32 GenStateProcessArgValue(ph7_gen_state *pGen,ph7_vm_func_arg *pArg,SyToken *pIn,SyToken *pEnd)` |
|       5 |  5512 |  |
|       - |  5513 | `	SyToken *pTmpIn,*pTmpEnd;` |
|       - |  5514 | `	SySet *pInstrContainer;` |
|       - |  5515 | `	sxi32 rc;` |
|       - |  5516 | `	/* Swap token stream */` |
|   62663 |  5517 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|   62663 |  5518 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   62663 |  5519 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pArg->aByteCode);` |
|       - |  5520 | `	/* Compile the expression holding the argument value */` |
|   62663 |  5521 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|       - |  5522 | `	/* Emit the done instruction */` |
|   62663 |  5523 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,(rc != SXERR_EMPTY ? 1 : 0),0,0,0);` |
|   62663 |  5524 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|   62663 |  5525 | `	RE_SWAP_DELIMITER(pGen);` |
|   62663 |  5526 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  5527 | `		return SXERR_ABORT;` |
|       - |  5528 | `	}` |
|   62663 |  5529 | `	return SXRET_OK;` |
|   31334 |  5530 |  |
|       - |  5531 | `/*` |
...
|       - |  5567 | ` */` |
|   86870 |  5568 | `static sxi32 GenStateCollectFuncArgs(ph7_vm_func *pFunc,ph7_gen_state *pGen,SyToken *pEnd,int bCtorCtx,int bAbstractCtx)` |
|       5 |  5569 |  |
...
|       - |  5574 | `	sxi32 rc;` |
|       - |  5575 |  |
|   86875 |  5576 | `	pIn = pGen->pIn;` |
|   86875 |  5577 | `	SyBlobInit(&sSig,&pGen->pVm->sAllocator);` |
|       - |  5578 | `	/* Process arguments one after one */` |
|  108649 |  5579 | `	for(;;){` |
|  217303 |  5580 | `		if( pIn >= pEnd ){` |
|       - |  5581 | `			/* No more arguments to process */` |
|   86863 |  5582 | `			break;` |
|       - |  5583 | `		}` |
|  130445 |  5584 | `		SyZero(&sArg,sizeof(ph7_vm_func_arg));` |
|  130445 |  5585 | `		SySetInit(&sArg.aByteCode,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|  130445 |  5586 | `		SySetInit(&sArg.aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|  130445 |  5587 | `		SyStringInitFromBuf(&sArg.sTypeName,0,0);` |
...
|       - |  5593 | `		{` |
|  130445 |  5594 | `			int bReadonly = 0, bVisSeen = 0;` |
|  130445 |  5595 | `			sxi32 iVis = PH7_CLASS_PROT_PUBLIC;` |
|  130445 |  5596 | `			if( pIn < pEnd && GenStateIsReadonly(pIn) ){` |
|       3 |  5597 | `				bReadonly = 1;` |
|       3 |  5598 | `				pIn++;` |
|       1 |  5599 | `			}` |
|  130445 |  5600 | `			if( pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD) ){` |
|   59521 |  5601 | `				sxu32 nKw = (sxu32)SX_PTR_TO_INT(pIn->pUserData);` |
|   59521 |  5602 | `				if( nKw == PH7_TKWRD_PUBLIC \|\| nKw == PH7_TKWRD_PROTECTED \|\| nKw == PH7_TKWRD_PRIVATE ){` |
|      65 |  5603 | `					bVisSeen = 1;` |
...
|      30 |  5612 | `				}` |
|   29758 |  5613 | `			}` |
|  130445 |  5614 | `			if( bVisSeen \|\| bReadonly ){` |
|      67 |  5615 | `				if( !bCtorCtx ){` |
...
|  165170 |  5636 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_DOLLAR) == 0` |
|  101613 |  5637 | `			&& (pIn->nType & PH7_TK_AMPER) == 0` |
|   71134 |  5638 | `			&& (pIn->nType & PH7_TK_ELLIPSIS) == 0 ){` |
|   69451 |  5639 | `			sxu32 nLineLocal = pIn->nLine;` |
|   69451 |  5640 | `			sxi32 iTFlags = 0;` |
|   69451 |  5641 | `			pGen->pIn = pIn;` |
|   69451 |  5642 | `			rc = GenStateParseUnionTypeDecl(` |
|   34723 |  5643 | `				pGen, &sArg.nType, &sArg.sClass, &sArg.aUnionAlts,` |
|   34723 |  5644 | `				&iTFlags, &sArg.sTypeName,` |
|       - |  5645 | `				VM_FUNC_ARG_NULLABLE, VM_FUNC_ARG_UNION,` |
|       - |  5646 | `				/* bAllowVoid */ 0,` |
|   34723 |  5647 | `						nLineLocal);` |
|   69451 |  5648 | `			pIn = pGen->pIn;` |
|   69451 |  5649 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  5650 | `				return SXERR_ABORT;` |
|   69451 |  5651 | `			}else if( rc == SXERR_CORRUPT ){` |
|       - |  5652 | `				/* Error already reported by GenStateParseUnionTypeDecl */` |
|       3 |  5653 | `				return SXERR_SYNTAX;` |
|   69449 |  5654 | `			}else if( rc == SXERR_SYNTAX ){` |
|       6 |  5655 | `				if( pIn < pEnd ){` |
...
|       - |  5664 | `			}` |
|   69445 |  5665 | `			sArg.iFlags \|= iTFlags;` |
|   34720 |  5666 | `		}` |
|  130435 |  5667 | `		if( pIn >= pEnd ){` |
|     ! 0 |  5668 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Missing argument name");` |
|     ! 0 |  5669 | `			return rc;` |
|       - |  5670 | `		}` |
|  130435 |  5671 | `		if( pIn->nType & PH7_TK_AMPER ){` |
|       - |  5672 | `			/* Pass by reference,record that */` |
|    3329 |  5673 | `			sArg.iFlags \|= VM_FUNC_ARG_BY_REF;` |
|    3329 |  5674 | `			pIn++;` |
|    1662 |  5675 | `		}` |
|  130435 |  5676 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_ELLIPSIS) ){` |
|       - |  5677 | `			/* Variadic parameter: ...$args */` |
|      47 |  5678 | `			sArg.iFlags \|= VM_FUNC_ARG_VARIADIC;` |
|      47 |  5679 | `			pIn++;` |
|      21 |  5680 | `		}` |
|  130435 |  5681 | `		if( pIn >= pEnd \|\| (pIn->nType & PH7_TK_DOLLAR) == 0 \|\| &pIn[1] >= pEnd \|\| (pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|       - |  5682 | `			/* Invalid argument */` |
|     ! 0 |  5683 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Invalid argument name");` |
|     ! 0 |  5684 | `			return rc;` |
|       - |  5685 | `		}` |
|  130435 |  5686 | `		pIn++; /* Jump the dollar sign */` |
|       - |  5687 | `		/* Copy argument name */` |
|  130435 |  5688 | `		zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,SyStringData(&pIn->sData),SyStringLength(&pIn->sData));` |
|  130435 |  5689 | `		if( zDup == 0 ){` |
|     ! 0 |  5690 | `			PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"PH7 engine is running out of memory");` |
|     ! 0 |  5691 | `			return SXERR_ABORT;` |
|       - |  5692 | `		}` |
|  130435 |  5693 | `		SyStringInitFromBuf(&sArg.sName,zDup,SyStringLength(&pIn->sData));` |
|  130435 |  5694 | `		pIn++;` |
|  130435 |  5695 | `		if( pIn < pEnd ){` |
|   73273 |  5696 | `			if( pIn->nType & PH7_TK_EQUAL ){` |
|       - |  5697 | `				SyToken *pDefend;` |
|   62665 |  5698 | `				sxi32 iNest = 0;` |
|   62665 |  5699 | `				pIn++; /* Jump the equal sign */` |
|   62665 |  5700 | `				pDefend = pIn;` |
|       - |  5701 | `				/* Process the default value associated with this argument */` |
|  131915 |  5702 | `				while( pDefend < pEnd ){` |
|  102223 |  5703 | `					if( (pDefend->nType & PH7_TK_COMMA) && iNest <= 0 ){` |
|   32973 |  5704 | `						break;` |
|       - |  5705 | `					}` |
|   69255 |  5706 | `					if( pDefend->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*[*/) ){` |
|       - |  5707 | `						/* Increment nesting level */` |
|    3301 |  5708 | `						iNest++;` |
|   67607 |  5709 | `					}else if( pDefend->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CCB/*'}'*/\|PH7_TK_CSB/*]*/) ){` |
|       - |  5710 | `						/* Decrement nesting level */` |
|    3301 |  5711 | `						iNest--;` |
|    1648 |  5712 | `					}` |
|   69255 |  5713 | `					pDefend++;` |
|       5 |  5714 | `				}` |
|   62665 |  5715 | `				if( pIn >= pDefend ){` |
|       3 |  5716 | `					rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Missing argument default value");` |
|       3 |  5717 | `					return rc;` |
|       - |  5718 | `				}` |
|       - |  5719 | `				/* Process default value */` |
|   62663 |  5720 | `				rc = GenStateProcessArgValue(&(*pGen),&sArg,pIn,pDefend);` |
|   62663 |  5721 | `				if( rc != SXRET_OK ){` |
|     ! 0 |  5722 | `					return rc;` |
|       - |  5723 | `				}` |
|       - |  5724 | `				/* Point beyond the default value */` |
|   62663 |  5725 | `				pIn = pDefend;` |
|   31329 |  5726 | `			}` |
|   73271 |  5727 | `			if( pIn < pEnd && (pIn->nType & PH7_TK_COMMA) == 0 ){` |
|     ! 0 |  5728 | `				rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Unexpected token '%z'",&pIn->sData);` |
|     ! 0 |  5729 | `				return rc;` |
|       - |  5730 | `			}` |
|   73271 |  5731 | `			pIn++; /* Jump the trailing comma */` |
|   36633 |  5732 | `		}` |
|       - |  5733 | `		/* Append argument signature */` |
|  130433 |  5734 | `		if( sArg.nType > 0 ){` |
|   69401 |  5735 | `			if( SyStringLength(&sArg.sClass) > 0 ){` |
|       - |  5736 | `				/* Class name — prefix with 'o' so generic object hint is a prefix match */` |
|    9915 |  5737 | `				int marker = 'o';` |
|    9915 |  5738 | `				SyBlobAppend(&sSig,(const void *)&marker,sizeof(char));` |
|    9915 |  5739 | `				SyBlobAppend(&sSig,SyStringData(&sArg.sClass),SyStringLength(&sArg.sClass));` |
|    4960 |  5740 | `			}else{` |
|       - |  5741 | `				int c;` |
|   59491 |  5742 | `				c = 'n'; /* cc warning */` |
|       - |  5743 | `				/* Type leading character */` |
|   59491 |  5744 | `				switch(sArg.nType){` |
|     ! 0 |  5745 | `				case MEMOBJ_HASHMAP:` |
|       - |  5746 | `					/* Hashmap aka 'array' */` |
|     ! 0 |  5747 | `					c = 'h';` |
|     ! 0 |  5748 | `					break;` |
|    8285 |  5749 | `				case MEMOBJ_INT:` |
|       - |  5750 | `					/* Integer */` |
|   16575 |  5751 | `					c = 'i';` |
|   16575 |  5752 | `					break;` |
...
|       2 |  5770 | `					break;` |
|       - |  5771 | `				}` |
|   59491 |  5772 | `				SyBlobAppend(&sSig,(const void *)&c,sizeof(char));` |
|       - |  5773 | `			}` |
|   34703 |  5774 | `		}else{` |
|       - |  5775 | `			/* No type is associated with this parameter which mean` |
|       - |  5776 | `			 * that this function is not condidate for overloading.` |
|       - |  5777 | `			 */` |
|   61037 |  5778 | `			SyBlobRelease(&sSig);` |
|       - |  5779 | `		}` |
|       - |  5780 | `		/* Save in the argument set */` |
|  130433 |  5781 | `		SySetPut(&pFunc->aArgs,(const void *)&sArg);` |
|       5 |  5782 | `	}` |
|   86863 |  5783 | `	if( SyBlobLength(&sSig) > 0 ){` |
|       - |  5784 | `		/* Save function signature */` |
|   43001 |  5785 | `		SyStringInitFromBuf(&pFunc->sSignature,SyBlobData(&sSig),SyBlobLength(&sSig));` |
|   21498 |  5786 | `	}` |
|   86863 |  5787 | `	return SXRET_OK;` |
|   43440 |  5788 |  |
|       - |  5789 | `/*` |
...
|       - |  5793 | ` */` |
|  206270 |  5794 | `static sxi32 GenStateCompileFuncBody(` |
...
|  206275 |  5804 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC,PH7_VmInstrLength(pGen->pVm),pFunc,&pBlock);` |
|  206275 |  5805 | `	if( rc != SXRET_OK ){` |
...
|       - |  5809 | `	}` |
|  206275 |  5810 | `	nGotoOfft = SySetUsed(&pGen->aGoto);` |
|       - |  5811 | `	/* Swap bytecode containers */` |
|  206275 |  5812 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|  206275 |  5813 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pFunc->aByteCode);` |
...
|       - |  5818 | `	{` |
|  206275 |  5819 | `		sxu32 nArg = SySetUsed(&pFunc->aArgs);` |
|       - |  5820 | `		sxu32 i;` |
|  310211 |  5821 | `		for( i = 0; i < nArg; i++ ){` |
|  103941 |  5822 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pFunc->aArgs,i);` |
|       - |  5823 | `			char *zSrc;` |
|       - |  5824 | `			sxu32 nSrc,nName;` |
|       - |  5825 | `			SySet sToken;` |
|       - |  5826 | `			SyToken *pTmpIn,*pTmpEnd;` |
|       - |  5827 | `			sxi32 rcPromote;` |
|  103941 |  5828 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|  103893 |  5829 | `				continue;` |
|       - |  5830 | `			}` |
...
|  206275 |  5877 | `	PH7_CompileBlock(&(*pGen),0);` |
|       - |  5878 | `	/* Fix exception jumps now the destination is resolved */` |
|  206275 |  5879 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|       - |  5880 | `	/* Emit the final return if not yet done */` |
|  206275 |  5881 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|       - |  5882 | `	/* Fix gotos jumps now the destination is resolved */` |
|  206275 |  5883 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),nGotoOfft) ){` |
|     ! 0 |  5884 | `		rc = SXERR_ABORT;` |
|     ! 0 |  5885 | `	}` |
|  206275 |  5886 | `	SySetTruncate(&pGen->aGoto,nGotoOfft);` |
|       - |  5887 | `	/* Restore the default container */` |
|  206275 |  5888 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|       - |  5889 | `	/* Leave function block */` |
|  206275 |  5890 | `	GenStateLeaveBlock(&(*pGen),0);` |
|  206275 |  5891 | `	if( rc == SXERR_ABORT ){` |
...
|       - |  5896 | `	{` |
|  206275 |  5897 | `		VmInstr *aInstr = (VmInstr *)SySetBasePtr(&pFunc->aByteCode);` |
|       - |  5898 | `		sxu32 i;` |
| 4028865 |  5899 | `		for( i = 0; i < SySetUsed(&pFunc->aByteCode); i++ ){` |
| 3822631 |  5900 | `			if( aInstr[i].iOp == PH7_OP_YIELD ){` |
...
|       - |  5971 | ` */` |
|   70086 |  5972 | `static sxi32 GenStateParseOneTypeAtom(ph7_gen_state *pGen, PhlTypeAtom *pOut)` |
|       5 |  5973 |  |
|   70091 |  5974 | `	SyToken *pIn = pGen->pIn;` |
|   70091 |  5975 | `	SyZero(pOut, sizeof(*pOut));` |
|   70091 |  5976 | `	SyStringInitFromBuf(&pOut->sClass, 0, 0);` |
|   70091 |  5977 | `	if( pIn >= pGen->pEnd ){` |
|     ! 0 |  5978 | `		return SXERR_SYNTAX;` |
|       - |  5979 | `	}` |
|       - |  5980 | `	/* Optional leading namespace separator '\' on FQN class types */` |
|   70091 |  5981 | `	if( pIn->nType & PH7_TK_NSSEP ){` |
|       8 |  5982 | `		pIn++;` |
|       8 |  5983 | `		if( pIn >= pGen->pEnd ){` |
|     ! 0 |  5984 | `			return SXERR_SYNTAX;` |
|       - |  5985 | `		}` |
|       3 |  5986 | `	}` |
|   70091 |  5987 | `	if( (pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|     ! 0 |  5988 | `		return SXERR_SYNTAX;` |
|       - |  5989 | `	}` |
|   70091 |  5990 | `	if( pIn->nType & PH7_TK_KEYWORD ){` |
|   59955 |  5991 | `		sxu32 nKey = (sxu32)(SX_PTR_TO_INT(pIn->pUserData));` |
|   59955 |  5992 | `		if( nKey & PH7_TKWRD_ARRAY ){` |
|      20 |  5993 | `			pOut->nType = MEMOBJ_HASHMAP; pOut->zCanon = "array"; pOut->nCanon = 5;` |
|   59947 |  5994 | `		}else if( nKey & PH7_TKWRD_BOOL ){` |
|      61 |  5995 | `			pOut->nType = MEMOBJ_BOOL; pOut->zCanon = "bool"; pOut->nCanon = 4;` |
|   59911 |  5996 | `		}else if( nKey & PH7_TKWRD_INT ){` |
|   16797 |  5997 | `			pOut->nType = MEMOBJ_INT; pOut->zCanon = "int"; pOut->nCanon = 3;` |
|   51487 |  5998 | `		}else if( nKey & PH7_TKWRD_STRING ){` |
|   43033 |  5999 | `			pOut->nType = MEMOBJ_STRING; pOut->zCanon = "string"; pOut->nCanon = 6;` |
|   21577 |  6000 | `		}else if( nKey & PH7_TKWRD_FLOAT ){` |
...
|   10141 |  6015 | `		SyString *pT = &pIn->sData;` |
|   10141 |  6016 | `		if( pT->nByte == 4 && SyMemcmpNoCase(pT->zString, "null", 4) == 0 ){` |
|      18 |  6017 | `			pOut->nType = UTA_NULL_FLAG; pOut->zCanon = "null"; pOut->nCanon = 4;` |
|      18 |  6018 | `			pIn++;` |
|   10133 |  6019 | `		}else if( pT->nByte == 4 && SyMemcmpNoCase(pT->zString, "void", 4) == 0 ){` |
|     117 |  6020 | `			pOut->nType = UTA_VOID_FLAG; pOut->zCanon = "void"; pOut->nCanon = 4;` |
|     117 |  6021 | `			pIn++;` |
|   10069 |  6022 | `		}else if( pT->nByte == 5 && SyMemcmpNoCase(pT->zString, "never", 5) == 0 ){` |
|       3 |  6023 | `			pOut->nType = UTA_NEVER_FLAG; pOut->zCanon = "never"; pOut->nCanon = 5;` |
|       3 |  6024 | `			pIn++;` |
|       2 |  6025 | `		}else{` |
|       - |  6026 | `			/* Class / interface name; consume namespace path a\b\c */` |
|   10011 |  6027 | `			SyToken *pFirst = pIn;` |
|   10011 |  6028 | `			SyToken *pLast = pIn;` |
|   10011 |  6029 | `			pOut->nType = SXU32_HIGH;` |
|   10011 |  6030 | `			pOut->sClass = pIn->sData;` |
|   10011 |  6031 | `			pIn++;` |
|   15012 |  6032 | `			while( pIn + 1 < pGen->pEnd && (pIn->nType & PH7_TK_NSSEP)` |
|   10014 |  6033 | `				&& (pIn[1].nType & PH7_TK_ID) ){` |
|       3 |  6034 | `				pLast = &pIn[1];` |
|       3 |  6035 | `				pIn += 2;` |
|       1 |  6036 | `			}` |
|   10011 |  6037 | `			if( pLast != pFirst ){` |
...
|       - |  6043 | `		}` |
|       - |  6044 | `	}` |
|   70089 |  6045 | `	pGen->pIn = pIn;` |
|   70089 |  6046 | `	return SXRET_OK;` |
|   35048 |  6047 |  |
|       - |  6048 |  |
|       - |  6049 | `/*` |
...
|       - |  6055 | ` */` |
|   69982 |  6056 | `static void GenBuildUnionTypeText(SyBlob *pBlob, PhlTypeAtom *aAtoms, int nAtoms, int bNullable)` |
|       5 |  6057 |  |
|       - |  6058 | `	int i;` |
|   69987 |  6059 | `	int nNonNull = 0;` |
|  140057 |  6060 | `	for( i = 0; i < nAtoms; i++ ){` |
|   70075 |  6061 | `		if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|   70059 |  6062 | `			nNonNull++;` |
|   35027 |  6063 | `		}` |
|   35040 |  6064 | `	}` |
|   69987 |  6065 | `	if( nNonNull == 1 && bNullable ){` |
|       - |  6066 | `		/* Shorthand: ?T */` |
...
|     ! 0 |  6077 | `	}` |
|       - |  6078 | `	{` |
|   69925 |  6079 | `		int bFirst = 1;` |
|       - |  6080 | `		/* 1) Classes in declaration order */` |
|  139927 |  6081 | `		for( i = 0; i < nAtoms; i++ ){` |
|   70007 |  6082 | `			if( aAtoms[i].nType == SXU32_HIGH ){` |
|   10003 |  6083 | `				if( !bFirst ) SyBlobAppend(pBlob, "\|", 1);` |
|   10003 |  6084 | `				SyBlobAppend(pBlob, aAtoms[i].sClass.zString, aAtoms[i].sClass.nByte);` |
|   10003 |  6085 | `				bFirst = 0;` |
|    4999 |  6086 | `			}` |
|   35006 |  6087 | `		}` |
...
|       - |  6092 | `			int k;` |
|  489445 |  6093 | `			for( k = 0; k < (int)(sizeof(aOrder)/sizeof(aOrder[0])); k++ ){` |
|  779557 |  6094 | `				for( i = 0; i < nAtoms; i++ ){` |
|  419921 |  6095 | `					if( aAtoms[i].nType == aOrder[k] ){` |
|   59889 |  6096 | `						if( !bFirst ) SyBlobAppend(pBlob, "\|", 1);` |
|   59889 |  6097 | `						SyBlobAppend(pBlob, aAtoms[i].zCanon, aAtoms[i].nCanon);` |
|   59889 |  6098 | `						bFirst = 0;` |
|   59889 |  6099 | `						break;` |
|       - |  6100 | `					}` |
|  180021 |  6101 | `				}` |
...
|       - |  6129 | ` */` |
|   69992 |  6130 | `static sxi32 GenStateParseUnionTypeDecl(` |
...
|   69997 |  6143 | `	int nAtoms = 0;` |
|   69997 |  6144 | `	int bShortNullable = 0;` |
|   69997 |  6145 | `	int bExplicitNull = 0;` |
|       - |  6146 | `	sxi32 rc;` |
|   69997 |  6147 | `	*pnType = 0;` |
|   69997 |  6148 | `	if( pClass ) SyStringInitFromBuf(pClass, 0, 0);` |
|   69997 |  6149 | `	*piTypeFlags = 0;` |
|   69997 |  6150 | `	if( pTypeText ) SyStringInitFromBuf(pTypeText, 0, 0);` |
|       - |  6151 |  |
|   69997 |  6152 | `	if( pGen->pIn >= pGen->pEnd ){` |
|     ! 0 |  6153 | `		return SXRET_OK;` |
|       - |  6154 | `	}` |
|       - |  6155 | ``	/* Optional `?` shorthand prefix */`` |
|   69992 |  6156 | `	if( (pGen->pIn->nType & PH7_TK_OP) && pGen->pIn->sData.nByte == 1` |
...
|   69997 |  6165 | `	rc = GenStateParseOneTypeAtom(pGen, &aAtoms[0]);` |
|   69997 |  6166 | `	if( rc != SXRET_OK ){` |
|       3 |  6167 | `		return rc;` |
|       - |  6168 | `	}` |
|   69995 |  6169 | `	nAtoms = 1;` |
|       - |  6170 | ``	/* Subsequent atoms separated by `\|` */`` |
|  105128 |  6171 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OP)` |
|   70138 |  6172 | `		&& pGen->pIn->sData.nByte == 1 && pGen->pIn->sData.zString[0] == '\|' ){` |
...
|       - |  6199 | `	{` |
|       - |  6200 | `		int i, j;` |
|   69993 |  6201 | `		int bHasNonNull = 0;` |
|  140069 |  6202 | `		for( i = 0; i < nAtoms; i++ ){` |
|   70087 |  6203 | `			if( aAtoms[i].nType == UTA_VOID_FLAG ){` |
...
|       - |  6218 | `				}` |
|      55 |  6219 | `			}` |
|   70085 |  6220 | `			if( aAtoms[i].nType == UTA_NEVER_FLAG ){` |
...
|       - |  6234 | `			}` |
|   70083 |  6235 | `			if( aAtoms[i].nType == UTA_NULL_FLAG ){` |
|      18 |  6236 | `				bExplicitNull = 1;` |
|      10 |  6237 | `			}else{` |
|   70067 |  6238 | `				bHasNonNull = 1;` |
|       - |  6239 | `			}` |
|       - |  6240 | `			/* Duplicate detection */` |
|   70207 |  6241 | `			for( j = 0; j < i; j++ ){` |
|     131 |  6242 | `				int bDup = 0;` |
...
|      67 |  6269 | `			}` |
|   35043 |  6270 | `		}` |
|   69987 |  6271 | `		if( !bHasNonNull && bExplicitNull ){` |
...
|   69987 |  6286 | `	if( bShortNullable \|\| bExplicitNull ){` |
|      76 |  6287 | `		*piTypeFlags \|= iNullableFlag;` |
|      36 |  6288 | `	}` |
|       - |  6289 | `	/* Build canonical type text */` |
|   69987 |  6290 | `	if( pTypeText ){` |
|       - |  6291 | `		SyBlob sBlob;` |
|   69987 |  6292 | `		SyBlobInit(&sBlob, &pGen->pVm->sAllocator);` |
|  104950 |  6293 | `		GenBuildUnionTypeText(&sBlob, aAtoms, nAtoms,` |
|   34991 |  6294 | `			(bShortNullable \|\| bExplicitNull) ? 1 : 0);` |
|   69987 |  6295 | `		if( SyBlobLength(&sBlob) > 0 ){` |
|  104813 |  6296 | `			char *zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|   69872 |  6297 | `				(const char *)SyBlobData(&sBlob), SyBlobLength(&sBlob));` |
|   69877 |  6298 | `			if( zDup ){` |
|   69877 |  6299 | `				SyStringInitFromBuf(pTypeText, zDup, SyBlobLength(&sBlob));` |
|   34936 |  6300 | `			}` |
|   34936 |  6301 | `		}` |
|   69987 |  6302 | `		SyBlobRelease(&sBlob);` |
|   34991 |  6303 | `	}` |
...
|       - |  6307 | `	{` |
|   69987 |  6308 | `		int nNonNull = 0;` |
|   69987 |  6309 | `		int iNonNullIdx = -1;` |
|       - |  6310 | `		int i;` |
|  140057 |  6311 | `		for( i = 0; i < nAtoms; i++ ){` |
|   70075 |  6312 | `			if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|   70059 |  6313 | `				nNonNull++;` |
|   70059 |  6314 | `				iNonNullIdx = i;` |
|   35027 |  6315 | `			}` |
|   35040 |  6316 | `		}` |
|   69987 |  6317 | `		if( nNonNull <= 1 ){` |
|       - |  6318 | `			/* Fast path: store as single type. */` |
|   69925 |  6319 | `			if( iNonNullIdx >= 0 ){` |
|   69919 |  6320 | `				PhlTypeAtom *pA = &aAtoms[iNonNullIdx];` |
|   69919 |  6321 | `				if( pA->nType == SXU32_HIGH ){` |
|   14978 |  6322 | `					char *zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|    4991 |  6323 | `						pA->sClass.zString, pA->sClass.nByte);` |
|    9987 |  6324 | `					if( zDup == 0 ) return SXERR_ABORT;` |
|    9987 |  6325 | `					*pnType = SXU32_HIGH;` |
|    9987 |  6326 | `					if( pClass ) SyStringInitFromBuf(pClass, zDup, pA->sClass.nByte);` |
|   64928 |  6327 | `				}else if( pA->nType == UTA_VOID_FLAG ){` |
...
|       - |  6366 | ` */` |
|  292146 |  6367 | `static sxi32 GenStateParseReturnType(ph7_gen_state *pGen, ph7_vm_func *pFunc)` |
|       5 |  6368 |  |
|  292151 |  6369 | `	sxi32 iFlags = 0;` |
|       - |  6370 | `	sxi32 rc;` |
|       - |  6371 | `	sxu32 nLine;` |
|  292151 |  6372 | `	pFunc->nReturnType = 0;` |
|  292151 |  6373 | `	SyStringInitFromBuf(&pFunc->sReturnClass, 0, 0);` |
|  292151 |  6374 | `	SyStringInitFromBuf(&pFunc->sReturnTypeName, 0, 0);` |
|  292151 |  6375 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COLON) == 0 ){` |
|  291803 |  6376 | `		return SXRET_OK;` |
|       - |  6377 | `	}` |
...
|  146078 |  6414 |  |
|       - |  6415 |  |
|   43926 |  6416 | `static sxi32 GenStateCompileFunc(` |
...
|   43931 |  6430 | `	nLine = pGen->pIn->nLine;` |
|       - |  6431 | `	/* Jump the left parenthesis '(' */` |
|   43931 |  6432 | `	pGen->pIn++;` |
|       - |  6433 | `	/* Delimit the function signature */` |
|   43931 |  6434 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   43931 |  6435 | `	if( pEnd >= pGen->pEnd ){` |
|       - |  6436 | `		/* Syntax error */` |
...
|   43925 |  6446 | `	pFunc = (ph7_vm_func *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_vm_func));` |
|   43925 |  6447 | `	if( pFunc == 0 ){` |
|     ! 0 |  6448 | `		goto OutOfMem;` |
|       - |  6449 | `	}` |
|       - |  6450 | `	/* Build the function name, prepending namespace if active */` |
|   43932 |  6451 | `	if( SyBlobLength(&pGen->sNamespace) > 0 && !bHandleClosure ){` |
|       - |  6452 | `		SyBlob sFQN;` |
|       - |  6453 | `		sxu32 nLen;` |
...
|       9 |  6465 | `	}else{` |
|   43911 |  6466 | `		zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|   43911 |  6467 | `		if( zName == 0 ){` |
|     ! 0 |  6468 | `			goto OutOfMem;` |
|       - |  6469 | `		}` |
|   43911 |  6470 | `		PH7_VmInitFuncState(pGen->pVm,pFunc,zName,pName->nByte,iFlags,0);` |
|       - |  6471 | `	}` |
|   43925 |  6472 | `	if( pGen->pIn < pEnd ){` |
|       - |  6473 | `		/* Collect function arguments */` |
|   30403 |  6474 | `		rc = GenStateCollectFuncArgs(pFunc,&(*pGen),pEnd,0,0);` |
|   30403 |  6475 | `		if( rc == SXERR_ABORT ){` |
...
|   43925 |  6481 | `	pGen->pIn = &pEnd[1];` |
|       - |  6482 | `	{` |
|   43925 |  6483 | `		sxi32 rcRt = GenStateParseReturnType(pGen, pFunc);` |
|   43925 |  6484 | `		if( rcRt == SXERR_ABORT ){` |
|     ! 0 |  6485 | `			return SXERR_ABORT;` |
|   43925 |  6486 | `		}else if( rcRt == SXERR_SYNTAX ){` |
|       5 |  6487 | `			return SXERR_SYNTAX;` |
|       - |  6488 | `		}` |
|       - |  6489 | `	}` |
|   43921 |  6490 | `	if( bHandleClosure ){` |
...
|   43921 |  6583 | `	rc = GenStateCompileFuncBody(&(*pGen),pFunc);` |
|   43921 |  6584 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  6585 | `		return SXERR_ABORT;` |
|       - |  6586 | `	}` |
|   43921 |  6587 | `	if( ppFunc ){` |
|     251 |  6588 | `		*ppFunc = pFunc;` |
|     123 |  6589 | `	}` |
|   43921 |  6590 | `	rc = SXRET_OK;` |
|   43921 |  6591 | `	if( (pFunc->iFlags & VM_FUNC_CLOSURE) == 0 ){` |
|       - |  6592 | `		/* Finally register the function */` |
|   43905 |  6593 | `		rc = PH7_VmInstallUserFunction(pGen->pVm,pFunc,0);` |
|   21950 |  6594 | `	}` |
|   43921 |  6595 | `	if( rc == SXRET_OK ){` |
|   43921 |  6596 | `		return SXRET_OK;` |
|       - |  6597 | `	}` |
...
|       - |  6609 | ` */` |
|   43688 |  6610 | `static sxi32 PH7_CompileFunction(ph7_gen_state *pGen)` |
|       5 |  6611 |  |
|       - |  6612 | `	SyString *pName;` |
|       - |  6613 | `	sxi32 iFlags;` |
|       - |  6614 | `	sxu32 nLine;` |
|       - |  6615 | `	sxi32 rc;` |
|       - |  6616 |  |
|   43693 |  6617 | `	nLine = pGen->pIn->nLine;` |
|   43693 |  6618 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|   43693 |  6619 | `	iFlags = 0;` |
|   43693 |  6620 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|       - |  6621 | `		/* Return by reference,remember that */` |
|       7 |  6622 | `		iFlags \|= VM_FUNC_REF_RETURN;` |
|       - |  6623 | `		/* Jump the '&' token */` |
|       7 |  6624 | `		pGen->pIn++;` |
|       3 |  6625 | `	}` |
|   43693 |  6626 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|       - |  6637 | `	}` |
|   43687 |  6638 | `	pName = &pGen->pIn->sData;` |
|   43687 |  6639 | `	nLine = pGen->pIn->nLine;` |
|       - |  6640 | `	/* Jump the function name */` |
|   43687 |  6641 | `	pGen->pIn++;` |
|   43687 |  6642 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  6643 | `		/* Syntax error */` |
...
|   43685 |  6656 | `	rc = GenStateCompileFunc(&(*pGen),pName,iFlags,FALSE,0);` |
|   43685 |  6657 | `	return rc;` |
|   21849 |  6658 |  |
|       - |  6659 | `/*` |
...
|       - |  6669 | ` */` |
|  311364 |  6670 | `static sxi32 GetProtectionLevel(sxi32 nKeyword)` |
|       5 |  6671 |  |
|  311369 |  6672 | `	if( nKeyword == PH7_TKWRD_PRIVATE ){` |
|    9977 |  6673 | `		return PH7_CLASS_PROT_PRIVATE;` |
|  301397 |  6674 | `	}else if( nKeyword == PH7_TKWRD_PROTECTED ){` |
|   42897 |  6675 | `		return PH7_CLASS_PROT_PROTECTED;` |
|       - |  6676 | `	}` |
|       - |  6677 | `	/* Assume public by default */` |
|  258505 |  6678 | `	return PH7_CLASS_PROT_PUBLIC;` |
|  155687 |  6679 |  |
|       - |  6680 | `/*` |
...
|       - |  6942 | ` */` |
|  162506 |  6943 | `static int GenStateLooksLikeTypedProperty(SyToken *pStart,SyToken *pEnd)` |
|       5 |  6944 |  |
|  162511 |  6945 | `	SyToken *p = pStart;` |
|  162511 |  6946 | `	if( p >= pEnd ) return 0;` |
|  162511 |  6947 | `	if( (p->nType & PH7_TK_OP) && p->sData.nByte == 1 && p->sData.zString[0] == '?' ){` |
|      18 |  6948 | `		p++;` |
|      18 |  6949 | `		if( p >= pEnd ) return 0;` |
|       8 |  6950 | `	}` |
|  162511 |  6951 | `	if( p->nType & PH7_TK_NSSEP ){` |
|       3 |  6952 | `		p++;` |
|       3 |  6953 | `		if( p >= pEnd ) return 0;` |
|       1 |  6954 | `	}` |
|  162511 |  6955 | `	if( (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|     ! 0 |  6956 | `		return 0;` |
|       - |  6957 | `	}` |
...
|       - |  6961 | `	 * dispatch site. */` |
|  162511 |  6962 | `	if( p->nType & PH7_TK_KEYWORD ){` |
|  162489 |  6963 | `		sxu32 k = (sxu32)(SX_PTR_TO_INT(p->pUserData));` |
|  162558 |  6964 | `		if( k == PH7_TKWRD_FUNCTION \|\| k == PH7_TKWRD_VAR \|\| k == PH7_TKWRD_CONST` |
|    3506 |  6965 | `		 \|\| k == PH7_TKWRD_STATIC \|\| k == PH7_TKWRD_FINAL \|\| k == PH7_TKWRD_ABSTRACT ){` |
|  162341 |  6966 | `			return 0;` |
|       - |  6967 | `		}` |
|      74 |  6968 | `	}` |
|     175 |  6969 | `	p++;` |
...
|       - |  7139 | ` */` |
| 1469712 |  7140 | `static int GenStateIsReadonly(SyToken *pTok)` |
|       5 |  7141 |  |
| 1499238 |  7142 | `	return (pTok->nType & PH7_TK_ID)` |
|  764377 |  7143 | `		&& pTok->sData.nByte == sizeof("readonly")-1` |
| 1499233 |  7144 | `		&& SyStrnicmp(pTok->sData.zString,"readonly",sizeof("readonly")-1) == 0;` |
|       5 |  7145 |  |
|   63174 |  7146 | `static sxi32 GenStateCompileClassAttr(ph7_gen_state *pGen,sxi32 iProtection,sxi32 iFlags,ph7_class *pClass)` |
|       5 |  7147 |  |
|   63179 |  7148 | `	sxu32 nLine = pGen->pIn->nLine;` |
|       - |  7149 | `	ph7_class_attr *pAttr;` |
|       - |  7150 | `	SyString *pName;` |
|       - |  7151 | `	sxi32 rc;` |
|   63179 |  7152 | `	sxu32 nType = 0;` |
|       - |  7153 | `	SyString sTypeClass;` |
|       - |  7154 | `	SyString sTypeText;` |
|       - |  7155 | `	SySet aUnionAlts;` |
|   63179 |  7156 | `	sxi32 iTypeFlags = 0;` |
|   63179 |  7157 | `	SyStringInitFromBuf(&sTypeClass,0,0);` |
|   63179 |  7158 | `	SyStringInitFromBuf(&sTypeText,0,0);` |
|   63179 |  7159 | `	SySetInit(&aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
...
|   63179 |  7163 | `	if( pClass->iFlags & PH7_CLASS_READONLY ){` |
|      21 |  7164 | `		iFlags \|= PH7_CLASS_ATTR_READONLY;` |
|       9 |  7165 | `	}` |
|       - |  7166 | `	/* Extract visibility level */` |
|   63179 |  7167 | `	iProtection = GetProtectionLevel(iProtection);` |
|       - |  7168 | `	/* Parse optional type hint (typed properties, PHP 7.4+) */` |
|   63264 |  7169 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
...
|      85 |  7185 | `	}` |
|     ! 0 |  7186 | `loop:` |
|   63183 |  7187 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
...
|       - |  7193 | `	}` |
|   63183 |  7194 | `	pGen->pIn++; /* Jump the dollar sign */` |
|   63183 |  7195 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_ID)) == 0 ){` |
...
|   63183 |  7205 | `	pName = &pGen->pIn->sData;` |
|       - |  7206 | `	/* Advance the stream cursor */` |
|   63183 |  7207 | `	pGen->pIn++;` |
|   63183 |  7208 | `	if(pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_EQUAL/*'='*/\|PH7_TK_SEMI/*';'*/\|PH7_TK_COMMA/*','*/)) == 0 ){` |
...
|   63181 |  7219 | `	if( iFlags & PH7_CLASS_ATTR_READONLY ){` |
...
|   63171 |  7239 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
...
|   63171 |  7251 | `	if( PH7_ClassExtractAttribute(pClass,pName->zString,pName->nByte) != 0 ){` |
...
|   63169 |  7260 | `	pAttr = PH7_NewClassAttr(pGen->pVm,pName,nLine,iProtection,iFlags\|iTypeFlags);` |
|   63169 |  7261 | `	if( pAttr == 0 ){` |
|     ! 0 |  7262 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 engine is running out of memory");` |
|     ! 0 |  7263 | `		return SXERR_ABORT;` |
|       - |  7264 | `	}` |
|   63169 |  7265 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|     171 |  7266 | `		GenStateCopyTypeToAttr(pAttr,nType,&sTypeClass,&sTypeText,iTypeFlags,&aUnionAlts);` |
|      83 |  7267 | `	}` |
|   63169 |  7268 | `	if( pGen->pIn->nType & PH7_TK_EQUAL /*'='*/ ){` |
|       - |  7269 | `		SySet *pInstrContainer;` |
|   20177 |  7270 | `		pGen->pIn++; /*Jump the equal sign */` |
|       - |  7271 | `		/* Swap bytecode container */` |
|   20177 |  7272 | `		pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   20177 |  7273 | `		PH7_VmSetByteCodeContainer(pGen->pVm,&pAttr->aByteCode);` |
|       - |  7274 | `		/* Compile attribute value.` |
|       - |  7275 | `		 */` |
|   20177 |  7276 | `		rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|   20177 |  7277 | `		if( rc == SXERR_EMPTY ){` |
...
|   20177 |  7284 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|   20177 |  7285 | `		PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|   10086 |  7286 | `	}` |
|       - |  7287 | `	/* All done,install the attribute */` |
|   63169 |  7288 | `	rc = PH7_ClassInstallAttr(pClass,pAttr);` |
|   63169 |  7289 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  7290 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|     ! 0 |  7291 | `		return SXERR_ABORT;` |
|       - |  7292 | `	}` |
|   63169 |  7293 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA /*','*/) ){` |
...
|       - |  7311 | `		}` |
|     ! 0 |  7312 | `	}` |
|   63165 |  7313 | `	SySetRelease(&aUnionAlts);` |
|   63165 |  7314 | `	return SXRET_OK;` |
|       7 |  7315 | `Synchronize:` |
...
|       - |  7330 | ` */` |
|  248114 |  7331 | `static sxi32 GenStateCompileClassMethod(` |
...
|       - |  7337 | `	)` |
|       5 |  7338 |  |
|  248119 |  7339 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|  248119 |  7346 | `	iProtection = GetProtectionLevel(iProtection);` |
|  248119 |  7347 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|  248119 |  7348 | `	iFuncFlags = 0;` |
|  248119 |  7349 | `	if( pGen->pIn >= pGen->pEnd ){` |
...
|       - |  7357 | `	}` |
|  248119 |  7358 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|       - |  7359 | `		/* Return by reference,remember that */` |
|     ! 0 |  7360 | `		iFuncFlags \|= VM_FUNC_REF_RETURN;` |
|       - |  7361 | `		/* Jump the '&' token */` |
|     ! 0 |  7362 | `		pGen->pIn++;` |
|     ! 0 |  7363 | `	}` |
|  248119 |  7364 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|  248119 |  7373 | `	pName = &pGen->pIn->sData;` |
|  248119 |  7374 | `	nLine = pGen->pIn->nLine;` |
|       - |  7375 | `	/* Jump the method name */` |
|  248119 |  7376 | `	pGen->pIn++;` |
|  248119 |  7377 | `	if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|       - |  7378 | `		/* Abstract method */` |
|   85753 |  7379 | `		if( iProtection == PH7_CLASS_PROT_PRIVATE ){` |
...
|   85753 |  7388 | `		doBody = FALSE;` |
|   42874 |  7389 | `	}` |
|  248119 |  7390 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  7391 | `		/* Syntax error */` |
...
|  248119 |  7400 | `	pMeth = PH7_NewClassMethod(pGen->pVm,pClass,pName,nLine,iProtection,iFlags,iFuncFlags);` |
|  248119 |  7401 | `	if( pMeth == 0 ){` |
...
|  248119 |  7406 | `	pGen->pIn++;` |
|  248119 |  7407 | `	pEnd = 0; /* cc warning */` |
|       - |  7408 | `	/* Delimit the method signature */` |
|  248119 |  7409 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|  248119 |  7410 | `	if( pEnd >= pGen->pEnd ){` |
|       - |  7411 | `		/* Syntax error */` |
...
|       - |  7418 | `	}` |
|       - |  7419 | `	{` |
|  248117 |  7420 | `		int bIsCtor = 0;` |
|  248117 |  7421 | `		int bAbstractCtor = 0;` |
|  362211 |  7422 | `		if( (pName->nByte == sizeof("__construct") - 1` |
|  147231 |  7423 | `				&& SyMemcmp(pName->zString,"__construct",sizeof("__construct") - 1) == 0)` |
|  238160 |  7424 | `		 \|\| SyStringCmp(pName,&pClass->sName,SyMemcmp) == 0 ){` |
|   19919 |  7425 | `			if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|       3 |  7426 | `				bAbstractCtor = 1;` |
|       2 |  7427 | `			}else{` |
|   19917 |  7428 | `				bIsCtor = 1;` |
|       - |  7429 | `			}` |
|    9957 |  7430 | `		}` |
|  248117 |  7431 | `		if( pGen->pIn < pEnd ){` |
|       - |  7432 | `			/* Collect method arguments */` |
|   56393 |  7433 | `			rc = GenStateCollectFuncArgs(&pMeth->sFunc,&(*pGen),pEnd,bIsCtor,bAbstractCtor);` |
|   56393 |  7434 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  7435 | `				return SXERR_ABORT;` |
|       - |  7436 | `			}` |
|   28194 |  7437 | `		}` |
|       - |  7438 | `	}` |
|       - |  7439 | `	/* Point past ')' and parse optional return type ': type' */` |
|  248117 |  7440 | `	pGen->pIn = &pEnd[1];` |
|       - |  7441 | `	{` |
|  248117 |  7442 | `		sxi32 rcRt = GenStateParseReturnType(pGen, &pMeth->sFunc);` |
|  248117 |  7443 | `		if( rcRt == SXERR_ABORT ){` |
|     ! 0 |  7444 | `			return SXERR_ABORT;` |
|  248117 |  7445 | `		}else if( rcRt == SXERR_SYNTAX ){` |
...
|       - |  7452 | `	{` |
|  248117 |  7453 | `		sxu32 nArg = SySetUsed(&pMeth->sFunc.aArgs);` |
|       - |  7454 | `		sxu32 i;` |
|  337563 |  7455 | `		for( i = 0; i < nArg; i++ ){` |
|   89461 |  7456 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pMeth->sFunc.aArgs,i);` |
|       - |  7457 | `			ph7_class_attr *pAttr;` |
|   89461 |  7458 | `			sxi32 iAttrFlags = 0;` |
|   89461 |  7459 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|   89403 |  7460 | `				continue;` |
|       - |  7461 | `			}` |
...
|      29 |  7538 | `		}` |
|       - |  7539 | `	}` |
|  248107 |  7540 | `	if( doBody ){` |
|       - |  7541 | `		/* Compile method body */` |
|  162359 |  7542 | `		rc = GenStateCompileFuncBody(&(*pGen),&pMeth->sFunc);` |
|  162359 |  7543 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  7544 | `			return SXERR_ABORT;` |
|       - |  7545 | `		}` |
|   81182 |  7546 | `	}else{` |
|       - |  7547 | `		/* Only method signature is allowed */` |
|   85753 |  7548 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI /* ';'*/) == 0 ){` |
...
|       - |  7581 | ` */` |
|   36304 |  7582 | `static sxi32 PH7_CompileClassInterface(ph7_gen_state *pGen)` |
|       5 |  7583 |  |
|   36309 |  7584 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|   36309 |  7593 | `	pName = &pGen->pIn->sData;` |
|       - |  7594 | `	/* Advance the stream cursor */` |
|   36309 |  7595 | `	pGen->pIn++;` |
|       - |  7596 | `	/* Build FQN and obtain a raw class */ {` |
|       - |  7597 | `		SyBlob sFQN;` |
|       - |  7598 | `		SyString sFQNStr;` |
|   36309 |  7599 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|   36309 |  7600 | `		GenStateBuildFQN(pGen,pName,&sFQN);` |
|   36309 |  7601 | `		SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|   36309 |  7602 | `		pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|   36309 |  7603 | `		SyBlobRelease(&sFQN);` |
|       - |  7604 | `	}` |
|   36309 |  7605 | `	if( pClass == 0 ){` |
...
|   36309 |  7610 | `	pClass->iFlags = PH7_CLASS_INTERFACE;` |
|       - |  7611 | `	/* Assume no base class is given */` |
|   36309 |  7612 | `	pBase = 0;` |
|   36309 |  7613 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|    9901 |  7614 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    9901 |  7615 | `		if( nKwrd == PH7_TKWRD_EXTENDS /* interface b extends a */ ){` |
|       - |  7616 | `			SyBlob sResolved;` |
|       - |  7617 | `			SyString sBaseName;` |
|       - |  7618 | `			sxu32 nRefLine;` |
|       - |  7619 | `			/* Extract base interface */` |
|    9901 |  7620 | `			pGen->pIn++;` |
|    9901 |  7621 | `			nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|    9901 |  7622 | `			SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|    9901 |  7623 | `			if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|       - |  7633 | `			}` |
|   14849 |  7634 | `			pBase = PH7_VmExtractClass(pGen->pVm,` |
|    9896 |  7635 | `				(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|    9901 |  7636 | `			SyStringInitFromBuf(&sBaseName,` |
|       - |  7637 | `				(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|       - |  7638 | `			/* Only interfaces is allowed */` |
|    9901 |  7639 | `			while( pBase && (pBase->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|     ! 0 |  7640 | `				pBase = pBase->pNextName;` |
|     ! 0 |  7641 | `			}` |
|    9901 |  7642 | `			if( pBase == 0 ){` |
...
|       - |  7648 | `				}` |
|     ! 0 |  7649 | `			}` |
|    9901 |  7650 | `			SyBlobRelease(&sResolved);` |
|    4948 |  7651 | `		}` |
|    4948 |  7652 | `	}` |
|   36309 |  7653 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|       - |  7654 | `		/* Syntax error */` |
...
|       - |  7662 | `	}` |
|   36309 |  7663 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|   36309 |  7664 | `	pEnd = 0; /* cc warning */` |
|       - |  7665 | `	/* Delimit the interface body */` |
|   36309 |  7666 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|   36309 |  7667 | `	if( pEnd >= pGen->pEnd ){` |
|       - |  7668 | `		/* Syntax error */` |
...
|   36309 |  7678 | `	pTmp = pGen->pEnd;` |
|   36309 |  7679 | `	pGen->pEnd = pEnd;` |
...
|  207789 |  7687 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|   85745 |  7688 | `			pGen->pIn++;` |
|       5 |  7689 | `		}` |
|  122049 |  7690 | `		if( pGen->pIn >= pGen->pEnd ){` |
|       - |  7691 | `			/* End of interface body */` |
|   36307 |  7692 | `			break;` |
|       - |  7693 | `		}` |
|   85747 |  7694 | `		if( (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|   85747 |  7705 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   85747 |  7706 | `		if( nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
...
|       3 |  7735 | `			goto done;` |
|       - |  7736 | `		}` |
|   85745 |  7737 | `		if( nKwrd != PH7_TKWRD_PUBLIC && nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|     ! 0 |  7744 | `			goto done;` |
|       - |  7745 | `		}` |
|   85745 |  7746 | `		if( nKwrd == PH7_TKWRD_PUBLIC ){` |
|       - |  7747 | `			/* Advance the stream cursor */` |
|   85737 |  7748 | `			pGen->pIn++;` |
|   85737 |  7749 | `			if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|     ! 0 |  7756 | `				goto done;` |
|       - |  7757 | `			}` |
|   85737 |  7758 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   85737 |  7759 | `			if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|       - |  7767 | `			}` |
|   42866 |  7768 | `		}` |
|   85745 |  7769 | `		if( nKwrd == PH7_TKWRD_CONST ){` |
|       - |  7770 | `			/* Parse constant */` |
...
|       - |  7777 | `			}` |
|       4 |  7778 | `		}else{` |
|   85739 |  7779 | `			sxi32 iFlags = PH7_CLASS_ATTR_ABSTRACT; /* Interface methods are implicitly abstract */` |
|   85739 |  7780 | `			if( nKwrd == PH7_TKWRD_STATIC ){` |
|       - |  7781 | `				/* Static method,record that */` |
|    9893 |  7782 | `				iFlags \|= PH7_CLASS_ATTR_STATIC;` |
|       - |  7783 | `				/* Advance the stream cursor */` |
|    9893 |  7784 | `				pGen->pIn++;` |
|    9888 |  7785 | `				if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0` |
|    9893 |  7786 | `					\|\| SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_FUNCTION ){` |
...
|   85739 |  7797 | `			rc = GenStateCompileClassMethod(&(*pGen),0,iFlags,FALSE,pClass);` |
|   85739 |  7798 | `			if( rc != SXRET_OK ){` |
...
|   36307 |  7807 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|   36307 |  7808 | `	if( rc == SXRET_OK && pBase ){` |
|       - |  7809 | `		/* Inherit from the base interface */` |
|    9901 |  7810 | `		rc = PH7_ClassInterfaceInherit(pClass,pBase);` |
|    4948 |  7811 | `	}` |
|   36307 |  7812 | `	if( rc != SXRET_OK ){` |
...
|   36309 |  7818 | `	pGen->pIn  = &pEnd[1];` |
|   36309 |  7819 | `	pGen->pEnd = pTmp;` |
|   36309 |  7820 | `	return PH7_OK;` |
|   18157 |  7821 |  |
|       - |  7822 | `/*` |
...
|       - |  7846 | ` */` |
|   89998 |  7847 | `static sxi32 GenStateCheckInterfaceSignatures(ph7_gen_state *pGen,ph7_class *pClass)` |
|       5 |  7848 |  |
|       - |  7849 | `	ph7_class **apIface;` |
|       - |  7850 | `	sxu32 nIface,i;` |
|       - |  7851 | `	sxi32 rc;` |
|   90003 |  7852 | `	if( pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|     ! 0 |  7853 | `		return SXRET_OK;` |
|       - |  7854 | `	}` |
|   90003 |  7855 | `	apIface = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|   90003 |  7856 | `	nIface = SySetUsed(&pClass->aInterface);` |
|  179191 |  7857 | `	for(i = 0; i < nIface; i++){` |
|   89193 |  7858 | `		ph7_class *pIface = apIface[i];` |
|       - |  7859 | `		SyHashEntry *pEntry;` |
|   89193 |  7860 | `		SyHashResetLoopCursor(&pIface->hMethod);` |
|  237915 |  7861 | `		while((pEntry = SyHashGetNextEntry(&pIface->hMethod)) != 0 ){` |
|  148727 |  7862 | `			ph7_class_method *pIfaceMeth = (ph7_class_method *)pEntry->pUserData;` |
|       - |  7863 | `			ph7_class_method *pImplMeth;` |
|  148727 |  7864 | `			SyString *pMName = &pIfaceMeth->sFunc.sName;` |
|       - |  7865 | `			/* Find the implementing method in the class */` |
|  148727 |  7866 | `			pImplMeth = PH7_ClassExtractMethod(pClass,pMName->zString,pMName->nByte);` |
|  148727 |  7867 | `			if( pImplMeth == 0 \|\| (pImplMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT) ){` |
...
|  148713 |  7871 | `			if( pImplMeth->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|       - |  7881 | `			 */` |
|       - |  7882 | `			{` |
|  148713 |  7883 | `				sxu32 nIfaceArgs = SySetUsed(&pIfaceMeth->sFunc.aArgs);` |
|  148713 |  7884 | `				sxu32 nImplArgs = SySetUsed(&pImplMeth->sFunc.aArgs);` |
|  148713 |  7885 | `				int sigError = 0;` |
|  148713 |  7886 | `				if( nImplArgs < nIfaceArgs ){` |
|       3 |  7887 | `					sigError = 1;` |
|  148712 |  7888 | `				}else if( nImplArgs > nIfaceArgs ){` |
...
|       - |  7939 | ` */` |
|   89998 |  7940 | `static sxi32 GenStateCheckAbstractMethods(ph7_gen_state *pGen,ph7_class *pClass)` |
|       5 |  7941 |  |
...
|   90003 |  7948 | `	if( pClass->iFlags & (PH7_CLASS_ABSTRACT\|PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|      29 |  7949 | `		return SXRET_OK;` |
|       - |  7950 | `	}` |
|       - |  7951 | `	/* Count abstract methods */` |
|   89979 |  7952 | `	nAbstract = 0;` |
|   89979 |  7953 | `	SyHashResetLoopCursor(&pClass->hMethod);` |
|  872559 |  7954 | `	while((pEntry = SyHashGetNextEntry(&pClass->hMethod)) != 0 ){` |
|  782585 |  7955 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|  782585 |  7956 | `		if( pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|      20 |  7957 | `			nAbstract++;` |
|       8 |  7958 | `		}` |
|       5 |  7959 | `	}` |
|   89979 |  7960 | `	if( nAbstract == 0 ){` |
|   89965 |  7961 | `		return SXRET_OK;` |
|       - |  7962 | `	}` |
...
|       - |  8095 | ` */` |
|   89718 |  8096 | `static sxi32 GenStateParseClassReference(ph7_gen_state *pGen,SyBlob *pFqn)` |
|       5 |  8097 |  |
|   89723 |  8098 | `	int isAbsolute = 0;` |
|   89723 |  8099 | `	SyToken *pStart = pGen->pIn;` |
|       - |  8100 | `	SyBlob sName;` |
|   89723 |  8101 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) ){` |
|      43 |  8102 | `		isAbsolute = 1;` |
|      43 |  8103 | `		pGen->pIn++;` |
|      20 |  8104 | `	}` |
|   89723 |  8105 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|       9 |  8106 | `		pGen->pIn = pStart;` |
|       9 |  8107 | `		return SXERR_INVALID;` |
|       - |  8108 | `	}` |
|   89717 |  8109 | `	SyBlobInit(&sName,&pGen->pVm->sAllocator);` |
|   89717 |  8110 | `	SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|   89717 |  8111 | `	pGen->pIn++;` |
|  134586 |  8112 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) &&` |
|   44879 |  8113 | `		&pGen->pIn[1] < pGen->pEnd && (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|      13 |  8114 | `		SyBlobAppend(&sName,"\\",1);` |
|      13 |  8115 | `		pGen->pIn++;` |
|      13 |  8116 | `		SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|      13 |  8117 | `		pGen->pIn++;` |
|       1 |  8118 | `	}` |
|   89717 |  8119 | `	if( isAbsolute ){` |
|      41 |  8120 | `		SyBlobAppend(pFqn,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|      22 |  8121 | `	}else{` |
|       - |  8122 | `		SyString sRaw;` |
|   89679 |  8123 | `		SyStringInitFromBuf(&sRaw,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|   89679 |  8124 | `		GenStateResolveName(pGen,&sRaw,pFqn);` |
|       - |  8125 | `	}` |
|   89717 |  8126 | `	SyBlobRelease(&sName);` |
|   89717 |  8127 | `	return SXRET_OK;` |
|   44864 |  8128 |  |
|       - |  8129 | `/*` |
...
|   10010 |  8137 | `static int GenStateInterfaceIsThrowableAt(ph7_class *pInterface,int iDepth)` |
|       5 |  8138 |  |
|       - |  8139 | `	ph7_class **apParent;` |
|       - |  8140 | `	sxu32 n;` |
|   16751 |  8141 | `	while( pInterface ){` |
|   13343 |  8142 | `		if( iDepth > PH7_THROWABLE_WALK_MAX_DEPTH ){` |
|     ! 0 |  8143 | `			return FALSE;` |
|       - |  8144 | `		}` |
|   16651 |  8145 | `		if( pInterface->sName.nByte == sizeof("Throwable")-1 &&` |
|    6616 |  8146 | `			SyMemcmp(pInterface->sName.zString,"Throwable",sizeof("Throwable")-1) == 0 ){` |
|    6607 |  8147 | `			return TRUE;` |
|       - |  8148 | `		}` |
|    6741 |  8149 | `		apParent = (ph7_class **)SySetBasePtr(&pInterface->aInterface);` |
|    6741 |  8150 | `		for( n = 0 ; n < SySetUsed(&pInterface->aInterface) ; ++n ){` |
|     ! 0 |  8151 | `			if( GenStateInterfaceIsThrowableAt(apParent[n],iDepth+1) ){` |
|     ! 0 |  8152 | `				return TRUE;` |
|       - |  8153 | `			}` |
|     ! 0 |  8154 | `		}` |
|    6741 |  8155 | `		pInterface = pInterface->pBase;` |
|    6741 |  8156 | `		iDepth++;` |
|       5 |  8157 | `	}` |
|    3413 |  8158 | `	return FALSE;` |
|    5010 |  8159 |  |
|   10010 |  8160 | `static int GenStateInterfaceIsThrowable(ph7_class *pInterface)` |
|       5 |  8161 |  |
|   10015 |  8162 | `	return GenStateInterfaceIsThrowableAt(pInterface,0);` |
|       5 |  8163 |  |
|       - |  8164 | `/*` |
...
|       - |  8168 | ` */` |
|    6602 |  8169 | `static int GenStateClassIsExceptionOrError(ph7_class *pBase)` |
|       5 |  8170 |  |
|    6611 |  8171 | `	while( pBase ){` |
...
|       1 |  8181 | `	}` |
|    6603 |  8182 | `	return FALSE;` |
|    3306 |  8183 |  |
|   90028 |  8184 | `static sxi32 GenStateCompileClass(ph7_gen_state *pGen,sxi32 iFlags)` |
|       5 |  8185 |  |
|   90033 |  8186 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|   90033 |  8197 | `	pGen->pIn++;` |
|   90033 |  8198 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
|       - |  8199 | `		/* Syntax error */` |
...
|   90033 |  8212 | `	pName = &pGen->pIn->sData;` |
|       - |  8213 | `	/* Advance the stream cursor */` |
|   90033 |  8214 | `	pGen->pIn++;` |
|       - |  8215 | `	/* Build FQN and obtain a raw class */ {` |
|       - |  8216 | `		SyBlob sFQN;` |
|       - |  8217 | `		SyString sFQNStr;` |
|   90033 |  8218 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|   90033 |  8219 | `		GenStateBuildFQN(pGen,pName,&sFQN);` |
|   90033 |  8220 | `		SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|   90033 |  8221 | `		pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|   90033 |  8222 | `		SyBlobRelease(&sFQN);` |
|       - |  8223 | `	}` |
|   90033 |  8224 | `	if( pClass == 0 ){` |
...
|   90033 |  8229 | `	SySetInit(&aInterfaces,&pGen->pVm->sAllocator,sizeof(ph7_class *));` |
|   90033 |  8230 | `	SySetInit(&aUseEntries,&pGen->pVm->sAllocator,sizeof(TraitUseEntry));` |
|       - |  8231 | `	/* Assume a standalone class */` |
|   90033 |  8232 | `	pBase = 0;` |
|   90033 |  8233 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|   79377 |  8234 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   79377 |  8235 | `		if( nKwrd == PH7_TKWRD_EXTENDS /* class b extends a */ ){` |
|       - |  8236 | `			SyBlob sResolved;` |
|       - |  8237 | `			SyString sBaseName;` |
|       - |  8238 | `			sxu32 nRefLine;` |
|   69373 |  8239 | `			pGen->pIn++; /* Advance past 'extends' */` |
|   69373 |  8240 | `			nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|   69373 |  8241 | `			SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|   69373 |  8242 | `			if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|       - |  8252 | `			}` |
|  104054 |  8253 | `			pBase = PH7_VmExtractClass(pGen->pVm,` |
|   69366 |  8254 | `				(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|   69371 |  8255 | `			SyStringInitFromBuf(&sBaseName,` |
|       - |  8256 | `				(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|       - |  8257 | `			/* Interfaces are not allowed */` |
|   69371 |  8258 | `			while( pBase && (pBase->iFlags & PH7_CLASS_INTERFACE) ){` |
|     ! 0 |  8259 | `				pBase = pBase->pNextName;` |
|     ! 0 |  8260 | `			}` |
|   69371 |  8261 | `			if( pBase == 0 ){` |
...
|       - |  8267 | `				}` |
|     ! 0 |  8268 | `			}else{` |
|   69371 |  8269 | `				if( pBase->iFlags & PH7_CLASS_FINAL ){` |
...
|     ! 0 |  8276 | `				}` |
|       - |  8277 | `			}` |
|   69371 |  8278 | `			SyBlobRelease(&sResolved);` |
|   34683 |  8279 | `		}` |
|   79375 |  8280 | `		if (pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) && SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_IMPLEMENTS ){` |
|       - |  8281 | `			ph7_class *pInterface;` |
|       - |  8282 | `			/* Interface implementation */` |
|   10015 |  8283 | `			pGen->pIn++; /* Advance the stream cursor */` |
|    5005 |  8284 | `			for(;;){` |
|       - |  8285 | `				SyBlob sResolved;` |
|       - |  8286 | `				SyString sIntName;` |
|       - |  8287 | `				sxu32 nRefLine;` |
|   10015 |  8288 | `				nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|   10015 |  8289 | `				SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|   10015 |  8290 | `				if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|     ! 0 |  8298 | `					break;` |
|       - |  8299 | `				}` |
|   20025 |  8300 | `				pInterface = PH7_VmExtractClass(pGen->pVm,` |
|   10010 |  8301 | `					(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|   10015 |  8302 | `				SyStringInitFromBuf(&sIntName,` |
|       - |  8303 | `					(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|       - |  8304 | `				/* Only interfaces are allowed */` |
|   10015 |  8305 | `				while( pInterface && (pInterface->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|     ! 0 |  8306 | `					pInterface = pInterface->pNextName;` |
|     ! 0 |  8307 | `				}` |
|   10015 |  8308 | `				if( pInterface == 0 ){` |
...
|   10015 |  8322 | `					SyString *pFqn = &pClass->sName;` |
|   10015 |  8323 | `					int bIsExceptionOrError =` |
|    8303 |  8324 | `						(pFqn->nByte == sizeof("Exception")-1 &&` |
|   16665 |  8325 | `						 SyMemcmp(pFqn->zString,"Exception",sizeof("Exception")-1) == 0) \|\|` |
|    8367 |  8326 | `						(pFqn->nByte == sizeof("Error")-1 &&` |
|    3306 |  8327 | `						 SyMemcmp(pFqn->zString,"Error",sizeof("Error")-1) == 0);` |
|   16610 |  8328 | `					if( GenStateInterfaceIsThrowable(pInterface) &&` |
|    9906 |  8329 | `						!GenStateClassIsExceptionOrError(pBase) &&` |
|    3299 |  8330 | `						!bIsExceptionOrError ){` |
...
|       6 |  8340 | `					}else{` |
|   10009 |  8341 | `						SySetPut(&aInterfaces,(const void *)&pInterface);` |
|       - |  8342 | `					}` |
|       - |  8343 | `				}` |
|   10015 |  8344 | `				SyBlobRelease(&sResolved);` |
|   10015 |  8345 | `				if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COMMA) == 0 ){` |
|    5010 |  8346 | `					break;` |
|       - |  8347 | `				}` |
...
|    5005 |  8350 | `		}` |
|   39685 |  8351 | `	}` |
|   90031 |  8352 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|       - |  8353 | `		/* Syntax error */` |
...
|       - |  8361 | `	}` |
|   90031 |  8362 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|   90031 |  8363 | `	pEnd = 0; /* cc warning */` |
|       - |  8364 | `	/* Delimit the class body */` |
|   90031 |  8365 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|   90031 |  8366 | `	if( pEnd >= pGen->pEnd ){` |
|       - |  8367 | `		/* Syntax error */` |
...
|   90031 |  8377 | `	pTmp = pGen->pEnd;` |
|   90031 |  8378 | `	pGen->pEnd = pEnd;` |
|       - |  8379 | `	/* Set the inherited flags */` |
|   90031 |  8380 | `	pClass->iFlags = iFlags;` |
|       - |  8381 | `	/* Start the parse process */` |
|  126201 |  8382 | `	for(;;){` |
|       - |  8383 | `		/* Jump leading/trailing semi-colons */` |
|  378857 |  8384 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|   63263 |  8385 | `			pGen->pIn++;` |
|       5 |  8386 | `		}` |
|  315599 |  8387 | `		if( pGen->pIn >= pGen->pEnd ){` |
|       - |  8388 | `			/* End of class body */` |
|   90003 |  8389 | `			break;` |
|       - |  8390 | `		}` |
|  225596 |  8391 | `		if( (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR)) == 0` |
|  112803 |  8392 | ``			&& !GenStateIsReadonly(pGen->pIn) /* allow a leading `readonly` modifier */ ){`` |
...
|  225601 |  8403 | `		iProtection = PH7_TKWRD_PUBLIC;` |
|  225601 |  8404 | `		iAttrflags = 0;` |
...
|  225601 |  8409 | `		if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|     ! 0 |  8410 | `			int bMod = 0;` |
...
|       - |  8431 | `			}` |
|     ! 0 |  8432 | `		}` |
|  225601 |  8433 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|       - |  8434 | `			/* Extract the current keyword */` |
|  225601 |  8435 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  225601 |  8436 | `			if( nKwrd == PH7_TKWRD_USE ){` |
...
|      49 |  8496 | `				continue;` |
|       - |  8497 | `			}` |
|  225557 |  8498 | `			if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|  222099 |  8499 | `				iProtection = nKwrd;` |
|  222099 |  8500 | `				pGen->pIn++; /* Jump the visibility token */` |
|       - |  8501 | ``				/* Optional `readonly` after the visibility: `public readonly int $x`. */`` |
|  222099 |  8502 | `				if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|      20 |  8503 | `					iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|      20 |  8504 | `					pGen->pIn++; /* Jump the 'readonly' modifier */` |
|       8 |  8505 | `				}` |
|  222094 |  8506 | `				if( pGen->pIn >= pGen->pEnd` |
|  222099 |  8507 | `					\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP)) == 0 ){` |
...
|     ! 0 |  8515 | `					goto done;` |
|       - |  8516 | `				}` |
|  222099 |  8517 | `				if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|       - |  8518 | `					/* Attribute declaration (untyped) */` |
|   62987 |  8519 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|   62987 |  8520 | `					if( rc != SXRET_OK ){` |
...
|   62981 |  8526 | `					continue;` |
|       - |  8527 | `				}` |
|  159117 |  8528 | `				if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|  158963 |  8540 | `				nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   79479 |  8541 | `			}` |
|  162421 |  8542 | `			if( nKwrd == PH7_TKWRD_CONST ){` |
...
|       - |  8550 | `				}` |
|      34 |  8551 | `			}else{` |
|  162361 |  8552 | `				if( nKwrd == PH7_TKWRD_STATIC ){` |
|       - |  8553 | `					/* Static method or attribute,record that */` |
|    3343 |  8554 | `					iAttrflags \|= PH7_CLASS_ATTR_STATIC;` |
|    3343 |  8555 | `					pGen->pIn++; /* Jump the static keyword */` |
|    3343 |  8556 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|       - |  8557 | `						/* Extract the keyword */` |
|    3337 |  8558 | `						nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    3337 |  8559 | `						if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
...
|    3343 |  8567 | `					if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|     ! 0 |  8568 | `						iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|     ! 0 |  8569 | `						pGen->pIn++; /* Jump the 'readonly' modifier */` |
|     ! 0 |  8570 | `					}` |
|    3338 |  8571 | `					if( pGen->pIn >= pGen->pEnd` |
|    3343 |  8572 | `						\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP)) == 0 ){` |
...
|     ! 0 |  8580 | `						goto done;` |
|       - |  8581 | `					}` |
|    3343 |  8582 | `					if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
...
|       5 |  8591 | `						continue;` |
|       - |  8592 | `					}` |
|    3339 |  8593 | `					if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|    3327 |  8605 | `					nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  160684 |  8606 | `				}else if( nKwrd == PH7_TKWRD_ABSTRACT ){` |
...
|  159018 |  8638 | `				}else if( nKwrd == PH7_TKWRD_FINAL ){` |
...
|       2 |  8682 | `				}` |
|  162335 |  8683 | `				if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_VAR ){` |
...
|     ! 0 |  8691 | `						goto done;` |
|       - |  8692 | `				}` |
|  162335 |  8693 | `				if( nKwrd == PH7_TKWRD_VAR ){` |
...
|  162329 |  8708 | `					rc = GenStateCompileClassMethod(&(*pGen),iProtection,iAttrflags,TRUE,pClass);` |
|       - |  8709 | `				}` |
|  162335 |  8710 | `				if( rc != SXRET_OK ){` |
...
|       - |  8733 | `		sxu32 nU;` |
|   90003 |  8734 | `		apUse = (TraitUseEntry *)SySetBasePtr(&aUseEntries);` |
|   90047 |  8735 | `		for( nU = 0 ; nU < SySetUsed(&aUseEntries) ; nU++ ){` |
...
|   90003 |  8943 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|   90003 |  8944 | `	if( rc == SXRET_OK ){` |
|       - |  8945 | `		ph7_class **apInterface;` |
|       - |  8946 | `		sxu32 n;` |
|   90003 |  8947 | `		if( pBase ){` |
|       - |  8948 | `			/* Inherit from base class and mark as a subclass */` |
|   69371 |  8949 | `			rc = PH7_ClassInherit(&(*pGen),pClass,pBase);` |
|   34683 |  8950 | `		}` |
|   90003 |  8951 | `		apInterface = (ph7_class **)SySetBasePtr(&aInterfaces);` |
|  100007 |  8952 | `		for( n = 0 ; n < SySetUsed(&aInterfaces) ; n++ ){` |
|       - |  8953 | `			/* Implements one or more interface */` |
|   10009 |  8954 | `			rc = PH7_ClassImplement(pClass,apInterface[n]);` |
|   10009 |  8955 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  8956 | `				break;` |
|       - |  8957 | `			}` |
|    5007 |  8958 | `		}` |
...
|  134997 |  8961 | `		if( rc == SXRET_OK` |
|   89998 |  8962 | `		 && (pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT)) == 0` |
|   90003 |  8963 | `		 && SyHashGet(&pClass->hMethod,"__toString",sizeof("__toString")-1) != 0 ){` |
|   79191 |  8964 | `			ph7_class *pStringable = PH7_VmExtractClass(pGen->pVm,` |
|       - |  8965 | `				"Stringable",sizeof("Stringable")-1,FALSE,0);` |
|   79191 |  8966 | `			if( pStringable ){` |
|   79191 |  8967 | `				ph7_class **apImpl = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|   79191 |  8968 | `				sxu32 nImpl = SySetUsed(&pClass->aInterface);` |
|       - |  8969 | `				sxu32 i;` |
|   79191 |  8970 | `				int bAlready = 0;` |
|   85787 |  8971 | `				for( i = 0 ; i < nImpl ; i++ ){` |
|    6603 |  8972 | `					if( apImpl[i] == pStringable ){` |
|       3 |  8973 | `						bAlready = 1;` |
|       3 |  8974 | `						break;` |
|       - |  8975 | `					}` |
|    3303 |  8976 | `				}` |
|   79191 |  8977 | `				if( !bAlready ){` |
|   79189 |  8978 | `					PH7_ClassImplement(pClass,pStringable);` |
|   39592 |  8979 | `				}` |
|   39593 |  8980 | `			}` |
|   39593 |  8981 | `		}` |
|       - |  8982 | `		/* Validate interface method signatures (visibility and parameter count) */` |
|   90003 |  8983 | `		if( rc == SXRET_OK ){` |
|   90003 |  8984 | `			sxi32 rcCheck = GenStateCheckInterfaceSignatures(&(*pGen),pClass);` |
|   90003 |  8985 | `			if( rcCheck == SXERR_ABORT ){` |
...
|   90003 |  8992 | `		if( rc == SXRET_OK ){` |
|   90003 |  8993 | `			sxi32 rcCheck = GenStateCheckAbstractMethods(&(*pGen),pClass);` |
|   90003 |  8994 | `			if( rcCheck == SXERR_ABORT ){` |
...
|   44999 |  8999 | `		}` |
|   44999 |  9000 | `	}` |
|   90003 |  9001 | `	SySetRelease(&aUseEntries);` |
|   90003 |  9002 | `	SySetRelease(&aInterfaces);` |
|   90003 |  9003 | `	if( rc != SXRET_OK ){` |
...
|   90031 |  9009 | `	pGen->pIn = &pEnd[1];` |
|   90031 |  9010 | `	pGen->pEnd = pTmp;` |
|   90031 |  9011 | `	return PH7_OK;` |
|   45019 |  9012 |  |
|       - |  9013 | `/*` |
...
|       - |  9033 | ` */` |
|  888248 |  9034 | `static int GenStateTokenIsClassModifier(SyToken *pTok,sxi32 *piFlag)` |
|       5 |  9035 |  |
|  888253 |  9036 | `	if( pTok->nType & PH7_TK_KEYWORD ){` |
|  588649 |  9037 | `		sxu32 nKw = (sxu32)SX_PTR_TO_INT(pTok->pUserData);` |
|  588649 |  9038 | `		if( nKw == PH7_TKWRD_FINAL ){ *piFlag = PH7_CLASS_FINAL; return TRUE; }` |
|  588631 |  9039 | `		if( nKw == PH7_TKWRD_ABSTRACT ){ *piFlag = PH7_CLASS_ABSTRACT; return TRUE; }` |
|  294290 |  9040 | `	}` |
|  888189 |  9041 | `	if( GenStateIsReadonly(pTok) ){ *piFlag = PH7_CLASS_READONLY; return TRUE; }` |
|  888129 |  9042 | `	return FALSE;` |
|  444129 |  9043 |  |
|       - |  9044 | `/*` |
...
|       - |  9049 | ` */` |
|  888124 |  9050 | `static sxi32 GenStateScanClassModifiers(SyToken **ppIn,SyToken *pEnd,SyToken **ppDup)` |
|       5 |  9051 |  |
|  888129 |  9052 | `	SyToken *pIn = *ppIn,*pDup = 0;` |
|  888129 |  9053 | `	sxi32 iFlags = 0,iFlag;` |
|  888253 |  9054 | `	while( pIn < pEnd && GenStateTokenIsClassModifier(pIn,&iFlag) ){` |
...
|     129 |  9059 | `		pIn++;` |
|       5 |  9060 | `	}` |
|  888129 |  9061 | `	*ppIn = pIn;` |
|  888129 |  9062 | `	if( ppDup ){ *ppDup = pDup; }` |
|  888129 |  9063 | `	return iFlags;` |
|       5 |  9064 |  |
|       - |  9065 | `/*` |
...
|       - |  9071 | ` */` |
|  888072 |  9072 | `static int GenStateStartsModifiedClass(SyToken *pIn,SyToken *pEnd)` |
|       5 |  9073 |  |
|  888077 |  9074 | `	sxi32 iFlags = GenStateScanClassModifiers(&pIn,pEnd,0);` |
|  444095 |  9075 | `	return iFlags != 0 && pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD)` |
|  888100 |  9076 | `		&& (sxu32)SX_PTR_TO_INT(pIn->pUserData) == PH7_TKWRD_CLASS;` |
|       5 |  9077 |  |
|       - |  9078 | `/*` |
...
|       - |  9406 | ` */` |
|   89976 |  9407 | `static sxi32 PH7_CompileClass(ph7_gen_state *pGen)` |
|       5 |  9408 |  |
|       - |  9409 | `	sxi32 rc;` |
|   89981 |  9410 | `	rc = GenStateCompileClass(&(*pGen),0);` |
|   89981 |  9411 | `	return rc;` |
|       5 |  9412 |  |
|       - |  9413 | `/*` |
...
|       - |  9434 | ` */` |
|   10098 |  9435 | `static sxi32 GenStateThrowNodeValidator(ph7_gen_state *pGen,ph7_expr_node *pRoot)` |
|       5 |  9436 |  |
|   10103 |  9437 | `	sxi32 rc = SXRET_OK;` |
|   10103 |  9438 | `	if( pRoot->pOp ){` |
|   10095 |  9439 | `		switch( pRoot->pOp->iOp ){` |
|    5045 |  9440 | `		case EXPR_OP_NEW:            /* new Exception() */` |
...
|     ! 0 |  9456 | `			break;` |
|       - |  9457 | `		}` |
|    5058 |  9458 | `	}else if( pRoot->xCode != PH7_CompileVariable ){` |
...
|       - |  9472 | ` */` |
|   10062 |  9473 | `static sxi32 PH7_CompileThrow(ph7_gen_state *pGen)` |
|       5 |  9474 |  |
|   10067 |  9475 | `	sxu32 nLine = pGen->pIn->nLine;` |
|       - |  9476 | `	GenBlock *pBlock;` |
|       - |  9477 | `	sxu32 nIdx;` |
|       - |  9478 | `	sxi32 rc;` |
|   10067 |  9479 | `	pGen->pIn++; /* Jump the 'throw' keyword */` |
|       - |  9480 | `	/* Compile the expression */` |
|   10067 |  9481 | `	rc = PH7_CompileExpr(&(*pGen),0,GenStateThrowNodeValidator);` |
|   10067 |  9482 | `	if( rc == SXERR_EMPTY ){` |
...
|       - |  9488 | `	}` |
|   10067 |  9489 | `	pBlock = pGen->pCurrent;` |
|       - |  9490 | `	/* Point to the top most function or try block and emit the forward jump */` |
|   46497 |  9491 | `	while(pBlock->pParent){` |
|   46493 |  9492 | `		if( pBlock->iFlags & (GEN_BLOCK_EXCEPTION\|GEN_BLOCK_FUNC) ){` |
|   10063 |  9493 | `			break;` |
|       - |  9494 | `		}` |
|       - |  9495 | `		/* Point to the parent block */` |
|   36435 |  9496 | `		pBlock = pBlock->pParent;` |
|       5 |  9497 | `	}` |
|       - |  9498 | `	/* Emit the throw instruction */` |
|   10067 |  9499 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_THROW,0,0,0,&nIdx);` |
|       - |  9500 | `	/* Emit the jump */` |
|   10067 |  9501 | `	GenStateNewJumpFixup(pBlock,PH7_OP_THROW,nIdx);` |
|   10067 |  9502 | `	return SXRET_OK;` |
|    5036 |  9503 |  |
|       - |  9504 | `/*` |
...
|     453 |  9620 | `		if( pGen->pIn < pGen->pEnd &&` |
...
|     419 |  9627 | `		break;` |
|     ! 0 |  9628 | `	}` |
|     621 |  9629 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 /*$*/ \|\|` |
...
|       - | 10158 | ` */` |
| 2407504 | 10159 | `static void GenStatePatchNullsafeJumps(ph7_gen_state *pGen, sxu32 nBaseline)` |
|       5 | 10160 |  |
| 2407509 | 10161 | `	sxu32 nCur = SySetUsed(&pGen->aNullsafeJmp);` |
|       - | 10162 | `	sxu32 nTarget;` |
|       - | 10163 | `	sxu32 *aIdx;` |
|       - | 10164 | `	sxu32 i;` |
| 2407509 | 10165 | `	if( nCur <= nBaseline ){` |
| 2407419 | 10166 | `		return;` |
|       - | 10167 | `	}` |
...
|       - | 10195 | ` */` |
|  391170 | 10196 | `static sxu32 GenStateByRefBuiltinMask(SyString *pName)` |
|       5 | 10197 |  |
...
|       - | 10207 | `	};` |
|       - | 10208 | `	sxu32 i;` |
|  391175 | 10209 | `	if( pName == 0 \|\| pName->zString == 0 \|\| pName->nByte == 0 ){` |
|    1175 | 10210 | `		return 0;` |
|       - | 10211 | `	}` |
| 1949861 | 10212 | `	for( i = 0 ; i < SX_ARRAYSIZE(aByRef) ; ++i ){` |
| 1559902 | 10213 | `		if( pName->nByte == aByRef[i].nByte` |
|  800512 | 10214 | `		 && SyStrnicmp(pName->zString, aByRef[i].zName, pName->nByte) == 0 ){` |
|      51 | 10215 | `			return aByRef[i].mask;` |
|       - | 10216 | `		}` |
|  779933 | 10217 | `	}` |
|  389959 | 10218 | `	return 0;` |
|  195590 | 10219 |  |
|       - | 10220 | `/*` |
...
|       - | 10229 | ` */` |
|  391170 | 10230 | `static void GenStateCallBuiltinName(ph7_expr_node *pLeft, SyString *pOut)` |
|       5 | 10231 |  |
|       - | 10232 | `	SyToken *p, *pEnd;` |
|  391175 | 10233 | `	pOut->zString = 0;` |
|  391175 | 10234 | `	pOut->nByte = 0;` |
|  391175 | 10235 | `	if( pLeft == 0 \|\| pLeft->pStart == 0 \|\| pLeft->pEnd == 0 ){` |
|     ! 0 | 10236 | `		return;` |
|       - | 10237 | `	}` |
|  391175 | 10238 | `	p = pLeft->pStart;` |
|  391175 | 10239 | `	pEnd = pLeft->pEnd;` |
|       - | 10240 | `	/* Optional single leading namespace separator (absolute path). */` |
|  391175 | 10241 | `	if( p < pEnd && (p->nType & PH7_TK_NSSEP) ){` |
|      24 | 10242 | `		p++;` |
|      10 | 10243 | `	}` |
|  391175 | 10244 | `	if( p >= pEnd \|\| (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|    1149 | 10245 | `		return;` |
|       - | 10246 | `	}` |
|       - | 10247 | `	/* Must be a single component: nothing follows the name token. */` |
|  390031 | 10248 | `	if( p + 1 != pEnd ){` |
|      30 | 10249 | `		return;` |
|       - | 10250 | `	}` |
|  390005 | 10251 | `	*pOut = p->sData;` |
|  195590 | 10252 |  |
|       - | 10253 | `/*` |
...
|       - | 10258 | ` * error message.` |
|       - | 10259 | ` */` |
| 3244316 | 10260 | `static sxi32 GenStateEmitExprCode(` |
...
|       - | 10267 | `	sxu32 nJmpIdx;` |
| 3244321 | 10268 | `	sxi32 iP1 = 0;` |
| 3244321 | 10269 | `	sxu32 iP2 = 0;` |
| 3244321 | 10270 | `	void *p3  = 0;` |
|       - | 10271 | `	sxi32 iVmOp;` |
|       - | 10272 | `	sxi32 rc;` |
| 3244321 | 10273 | `	int bIsChainOp = 0; /* Set below once we know pNode->pOp */` |
| 3244321 | 10274 | `	sxu32 nRhsNsBase = 0;` |
| 3244321 | 10275 | `	if( pNode->xCode ){` |
|       - | 10276 | `		SyToken *pTmpIn,*pTmpEnd;` |
|       - | 10277 | `		/* Compile node */` |
| 2009439 | 10278 | `		SWAP_DELIMITER(pGen,pNode->pStart,pNode->pEnd);` |
| 2009439 | 10279 | `		rc = pNode->xCode(&(*pGen),iFlags);` |
| 2009439 | 10280 | `		RE_SWAP_DELIMITER(pGen);` |
| 2009439 | 10281 | `		return rc;` |
|       - | 10282 | `	}` |
| 1234887 | 10283 | `	if( pNode->pOp == 0 ){` |
...
|       - | 10287 | `	}` |
| 1234887 | 10288 | `	iVmOp = pNode->pOp->iVmOp;` |
| 1234887 | 10289 | `	if( pNode->pOp->iOp == EXPR_OP_NULLC_ASSIGN ){` |
...
|       - | 10338 | `	}` |
| 1234831 | 10339 | `	if( pNode->pOp->iOp == EXPR_OP_QUESTY ){` |
...
|    2587 | 10344 | `		nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|    2587 | 10345 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pCond,iFlags);` |
|    2587 | 10346 | `		if( rc != SXRET_OK ){` |
|     ! 0 | 10347 | `			return rc;` |
|       - | 10348 | `		}` |
...
|    2587 | 10352 | `		GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|    2587 | 10353 | `		nJz = nJmp = 0; /* cc -O6 warning */` |
|    2587 | 10354 | `		if( pNode->pLeft ){` |
|       - | 10355 | `			/* Standard ternary: (expr) ? (then) : (else) */` |
|       - | 10356 | `			/* Phase#2: Emit the false jump (pops condition) */` |
|    2519 | 10357 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nJz);` |
|       - | 10358 | `			/* Phase#3: Compile the 'then' expression  */` |
|    2519 | 10359 | `			nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|    2519 | 10360 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pLeft,iFlags);` |
|    2519 | 10361 | `			if( rc != SXRET_OK ){` |
|     ! 0 | 10362 | `				return rc;` |
|       - | 10363 | `			}` |
|    2519 | 10364 | `			GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|    1262 | 10365 | `		}else{` |
...
|    2587 | 10373 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,0,0,&nJmp);` |
|       - | 10374 | `		/* Phase#5: Fix the false jump now the jump destination is resolved. */` |
|    2587 | 10375 | `		pInstr = PH7_VmGetInstr(pGen->pVm,nJz);` |
|    2587 | 10376 | `		if( pInstr ){` |
|    2587 | 10377 | `			pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    1291 | 10378 | `		}` |
|    2587 | 10379 | `		if( !pNode->pLeft ){` |
...
|    2587 | 10384 | `		if( pNode->pRight ){` |
|    2587 | 10385 | `			nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|    2587 | 10386 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pRight,iFlags);` |
|    2587 | 10387 | `			if( rc != SXRET_OK ){` |
|     ! 0 | 10388 | `				return rc;` |
|       - | 10389 | `			}` |
|    2587 | 10390 | `			GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|    1291 | 10391 | `		}` |
|    2587 | 10392 | `		if( nJmp > 0 ){` |
|       - | 10393 | `			/* Phase#7: Fix the unconditional jump */` |
|    2587 | 10394 | `			pInstr = PH7_VmGetInstr(pGen->pVm,nJmp);` |
|    2587 | 10395 | `			if( pInstr ){` |
|    2587 | 10396 | `				pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    1291 | 10397 | `			}` |
|    1291 | 10398 | `		}` |
|       - | 10399 | `		/* All done */` |
|    2587 | 10400 | `		return SXRET_OK;` |
|       - | 10401 | `	}` |
| 1232249 | 10402 | `	bIsChainOp = GEN_IS_CHAIN_OP(pNode->pOp->iOp);` |
|       - | 10403 | `	/* Generate code for the left tree */` |
| 1232249 | 10404 | `	if( pNode->pLeft ){` |
| 1232211 | 10405 | `		sxu32 nLhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
| 1232211 | 10406 | `		if( iVmOp == PH7_OP_CALL ){` |
|       - | 10407 | `			ph7_expr_node **apNode;` |
|  391295 | 10408 | `			int hasSpread = 0;` |
|  391295 | 10409 | `			int hasNamed = 0;` |
|  391295 | 10410 | `			int bAnySpread = 0;` |
|  391295 | 10411 | `			sxu32 byRefMask = 0;` |
|       - | 10412 | `			sxi32 nArgs;` |
|       - | 10413 | `			sxi32 n;` |
|       - | 10414 | `			/* Recurse and generate bytecodes for function arguments */` |
|  391295 | 10415 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  391295 | 10416 | `			nArgs = (sxi32)SySetUsed(&pNode->aNodeArgs);` |
|       - | 10417 | `			/* Validate: no positional arguments after named arguments */` |
|       - | 10418 | `			{` |
|  391295 | 10419 | `				int seenNamed = 0;` |
|  774819 | 10420 | `				for( n = 0; n < nArgs; ++n ){` |
|  383531 | 10421 | `					if( apNode[n]->iFlags & EXPR_NODE_NAMED_ARG ){` |
|     188 | 10422 | `						seenNamed = 1;` |
|     188 | 10423 | `						hasNamed = 1;` |
|  383439 | 10424 | `					}else if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
|      23 | 10425 | `						bAnySpread = 1;` |
|  383337 | 10426 | `					}else if( seenNamed ){` |
...
|  391293 | 10434 | `			iFlags \|= EXPR_FLAG_RDONLY_LOAD;` |
...
|  391293 | 10439 | `			if( pNode->pLeft && pNode->pLeft->pStart ){` |
|  391293 | 10440 | `				SyString *pCallName = &pNode->pLeft->pStart->sData;` |
|  391288 | 10441 | `				if( pCallName->nByte == 5` |
|  214758 | 10442 | `				 && SyStrnicmp(pCallName->zString,"isset",5) == 0 ){` |
|   20079 | 10443 | `					iFlags \|= EXPR_FLAG_LOAD_IDX_ISSET;` |
|  381256 | 10444 | `				}else if( pCallName->nByte == 5` |
|  194684 | 10445 | `				 && SyStrnicmp(pCallName->zString,"empty",5) == 0 ){` |
...
|  391293 | 10454 | `				if( !bAnySpread && !hasNamed ){` |
|       - | 10455 | `					SyString sBuiltin;` |
|  391175 | 10456 | `					GenStateCallBuiltinName(pNode->pLeft, &sBuiltin);` |
|  391175 | 10457 | `					byRefMask = GenStateByRefBuiltinMask(&sBuiltin);` |
|  195585 | 10458 | `				}` |
|  195644 | 10459 | `			}` |
|  774815 | 10460 | `			for( n = 0 ; n < nArgs ; ++n ){` |
|  383527 | 10461 | `				sxu32 nArgNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  383527 | 10462 | `				sxi32 iArgFlags = iFlags & ~EXPR_FLAG_LOAD_IDX_STORE;` |
...
|  383527 | 10465 | `				if( n < 31 && (byRefMask & (1u<<n)) ){` |
|      31 | 10466 | `					iArgFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|      13 | 10467 | `				}` |
|  383527 | 10468 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iArgFlags);` |
|  383527 | 10469 | `				if( rc != SXRET_OK ){` |
|     ! 0 | 10470 | `					return rc;` |
|       - | 10471 | `				}` |
|       - | 10472 | `				/* Each argument is an independent nullsafe scope. */` |
|  383527 | 10473 | `				GenStatePatchNullsafeJumps(pGen, nArgNsBase);` |
|  383527 | 10474 | `				if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
...
|  391293 | 10517 | `			iFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|  195644 | 10518 | `		}` |
| 1232209 | 10519 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pLeft,iFlags);` |
| 1232209 | 10520 | `		if( rc != SXRET_OK ){` |
|      34 | 10521 | `			return rc;` |
|       - | 10522 | `		}` |
| 1232179 | 10523 | `		if( !bIsChainOp ){` |
...
|  575719 | 10526 | `			GenStatePatchNullsafeJumps(pGen, nLhsNsBase);` |
|  287857 | 10527 | `		}` |
| 1232179 | 10528 | `		if( iVmOp == PH7_OP_CALL ){` |
|  391293 | 10529 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|  391293 | 10530 | `			if( pInstr ){` |
|  391293 | 10531 | `				if ( pInstr->iOp == PH7_OP_LOADC ){` |
|  390125 | 10532 | `					sxu32 nOrig = (sxu32)pInstr->iP2;` |
|       - | 10533 | `					sxu32 nQual;` |
|  390125 | 10534 | `					int bAbsolute = (pInstr->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|       - | 10535 | `					/* Prevent constant expansion but preserve the absolute flag` |
|       - | 10536 | `					 * so the later NEW handler (if any) can see it. */` |
|  390125 | 10537 | `					pInstr->iP1 &= ~PH7_LOADC_EXPAND;` |
...
|  390125 | 10545 | `					if( bAbsolute ){` |
|      24 | 10546 | `						pInstr->iP2 = (sxi32)nOrig;` |
|      14 | 10547 | `					}else{` |
|  390105 | 10548 | `						int fromImport = 0;` |
|  390105 | 10549 | `						nQual = GenStateNsQualifyName(pGen,nOrig,&pGen->hUseFuncImports,&fromImport);` |
|  390105 | 10550 | `						pInstr->iP2 = (sxi32)nQual;` |
|  390105 | 10551 | `						if( nQual != nOrig ){` |
...
|      36 | 10569 | `						}` |
|       5 | 10570 | `					}` |
|  196233 | 10571 | `				}else if( pInstr->iOp == PH7_OP_MEMBER /* $a->b(1,2,3) */ \|\| pInstr->iOp == PH7_OP_NEW ){` |
|       - | 10572 | `					/* Method call,flag that */` |
|     893 | 10573 | `					pInstr->iP2 = 1;` |
|     444 | 10574 | `				}` |
|  195649 | 10575 | `			}` |
| 1036535 | 10576 | `		}else if( iVmOp == PH7_OP_LOAD_IDX ){` |
|       - | 10577 | `			ph7_expr_node **apNode;` |
|       - | 10578 | `			sxi32 n;` |
|   84851 | 10579 | `			sxi32 iChildMask = ~(EXPR_FLAG_LOAD_IDX_STORE` |
...
|   84851 | 10583 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  153123 | 10584 | `			for( n = 0 ; n < (sxi32)SySetUsed(&pNode->aNodeArgs) ; ++n ){` |
|   68277 | 10585 | `				sxu32 nIdxNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|   68277 | 10586 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iFlags&iChildMask);` |
|   68277 | 10587 | `				if( rc != SXRET_OK ){` |
|     ! 0 | 10588 | `					return rc;` |
|       - | 10589 | `				}` |
|       - | 10590 | `				/* Each subscript index is an independent nullsafe scope. */` |
|   68277 | 10591 | `				GenStatePatchNullsafeJumps(pGen, nIdxNsBase);` |
|   34141 | 10592 | `			}` |
|   84851 | 10593 | `			if( SySetUsed(&pNode->aNodeArgs) > 0 ){` |
|   68277 | 10594 | `				iP1 = 1; /* Node have an index associated with it */` |
|   34136 | 10595 | `			}` |
|   84851 | 10596 | `			if( iFlags & EXPR_FLAG_LOAD_IDX_ISSET ){` |
|       - | 10597 | `				/* offsetExists for ArrayAccess; peek-only for arrays */` |
|     243 | 10598 | `				iP2 = 4;` |
|   84732 | 10599 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_UNSET ){` |
|       - | 10600 | `				/* offsetUnset for ArrayAccess; auto-vivify+load for arrays` |
|       - | 10601 | `				 * so the trailing unset() builtin can drop the slot. */` |
|      54 | 10602 | `				iP2 = 5;` |
|   84588 | 10603 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_EMPTY ){` |
...
|      29 | 10607 | `				iP2 = 6;` |
|   84551 | 10608 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_STORE ){` |
|       - | 10609 | `				/* Create an empty entry when the desired index is not found */` |
|   33423 | 10610 | `				iP2 = 1;` |
|   16714 | 10611 | `			}` |
|  798468 | 10612 | `		}else if( pNode->pOp->iOp == EXPR_OP_COMMA ){` |
|       - | 10613 | `			/* POP the left node */` |
|      32 | 10614 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|      15 | 10615 | `		}` |
|  616087 | 10616 | `	}` |
| 1232217 | 10617 | `	rc = SXRET_OK;` |
| 1232217 | 10618 | `	nJmpIdx = 0;` |
...
| 1232217 | 10622 | `	if( iVmOp == PH7_OP_MEMBER && pNode->pOp->iOp == EXPR_OP_DC ){` |
...
| 1232139 | 10652 | `	if( pNode->pRight ){` |
|  680409 | 10653 | `		if( iVmOp == PH7_OP_LAND ){` |
|       - | 10654 | `			/* Emit the false jump so we can short-circuit the logical and */` |
|   10351 | 10655 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,1/* Keep the value on the stack */,0,0,&nJmpIdx);` |
|  675236 | 10656 | `		}else if (iVmOp == PH7_OP_LOR ){` |
|       - | 10657 | `			/* Emit the true jump so we can short-circuit the logical or*/` |
|    3479 | 10658 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JNZ,1/* Keep the value on the stack */,0,0,&nJmpIdx);` |
|  668326 | 10659 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLC ){` |
...
|  666576 | 10663 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW ){` |
...
|  666416 | 10673 | `		}else if( pNode->pOp->iPrec == 18 /* Combined binary operators [i.e: =,'.=','+=',*=' ...] precedence */ ){` |
|  276277 | 10674 | `			iFlags \|= EXPR_FLAG_LOAD_IDX_STORE;` |
|  138136 | 10675 | `		}` |
|  680409 | 10676 | `		nRhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  680409 | 10677 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pRight,iFlags);` |
|  680409 | 10678 | `		if( !bIsChainOp ){` |
|       - | 10679 | `			/* Non-chain parent: RHS nullsafe chain ends here, before the` |
|       - | 10680 | `			 * operator instruction is emitted. */` |
|  500125 | 10681 | `			GenStatePatchNullsafeJumps(pGen, nRhsNsBase);` |
|  250060 | 10682 | `		}` |
|  680409 | 10683 | `		if( iVmOp == PH7_OP_STORE ){` |
|  272723 | 10684 | `			if( pNode->pRight && (pNode->pRight->xCode == PH7_CompileList \|\|` |
|  272694 | 10685 | `				pNode->pRight->xCode == PH7_CompileShortList) ){` |
...
|       - | 10691 | `				 */` |
|      56 | 10692 | `				iVmOp = 0;` |
|  272697 | 10693 | `			}else if( (pInstr = PH7_VmPeekInstr(pGen->pVm)) != 0 ){` |
|  272671 | 10694 | `				if(pInstr->iOp == PH7_OP_MEMBER ){` |
|       - | 10695 | `					/* Perform a member store operation [i.e: $this->x = 50] */` |
|   76199 | 10696 | `					iP2 = 1;` |
|   38102 | 10697 | `				}else{` |
|  196477 | 10698 | `					if( pInstr->iOp == PH7_OP_LOAD_IDX ){` |
|       - | 10699 | `						/* Transform the STORE instruction to STORE_IDX instruction */` |
|   33377 | 10700 | `						iVmOp = PH7_OP_STORE_IDX;` |
|   33377 | 10701 | `						iP1 = pInstr->iP1;` |
|   16691 | 10702 | `					}else{` |
|  163105 | 10703 | `						p3 = pInstr->p3;` |
|       - | 10704 | `					}` |
|       - | 10705 | `					/* POP the last dynamic load instruction */` |
|  196477 | 10706 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|       - | 10707 | `				}` |
|  136338 | 10708 | `			}` |
|  544050 | 10709 | `		}else if( iVmOp == PH7_OP_STORE_REF ){` |
...
|      25 | 10724 | `		}` |
|  340202 | 10725 | `	}` |
| 1232139 | 10726 | `	if( iVmOp > 0 ){` |
| 1231933 | 10727 | `		if( iVmOp == PH7_OP_INCR \|\| iVmOp == PH7_OP_DECR ){` |
|   13577 | 10728 | `			if( pNode->iFlags & EXPR_NODE_PRE_INCR ){` |
|       - | 10729 | `				/* Pre-increment/decrement operator [i.e: ++$i,--$j ] */` |
|    9913 | 10730 | `				iP1 = 1;` |
|    4959 | 10731 | `			}` |
| 1225147 | 10732 | `		}else if( iVmOp == PH7_OP_NEW ){` |
|       - | 10733 | `			/* Namespace-qualify the class name for NEW */ {` |
|   17655 | 10734 | `				VmInstr *pPeek = PH7_VmPeekInstr(pGen->pVm);` |
|   17655 | 10735 | `				VmInstr *pCallInstr = 0;` |
|   17655 | 10736 | `				if( pPeek && pPeek->iOp == PH7_OP_CALL ){` |
|   17617 | 10737 | `					pCallInstr = pPeek;` |
|   17617 | 10738 | `					pPeek = PH7_VmPeekNextInstr(pGen->pVm);` |
|    8806 | 10739 | `				}` |
|   17655 | 10740 | `				if( pPeek && pPeek->iOp == PH7_OP_LOADC ){` |
|   17653 | 10741 | `					int bAbsolute = (pPeek->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
...
|   17653 | 10746 | `					if( pCallInstr && pCallInstr->iP2 > 0 ){` |
|      37 | 10747 | `						nLitForClass = (sxu32)(pCallInstr->iP2 - 1); /* undo +1 encoding */` |
|      21 | 10748 | `					}else{` |
|   17621 | 10749 | `						nLitForClass = (sxu32)pPeek->iP2;` |
|       - | 10750 | `					}` |
|   17653 | 10751 | `					pPeek->iP1 = 0;` |
|   17653 | 10752 | `					if( !bAbsolute ){` |
|   17637 | 10753 | `						pPeek->iP2 = (sxi32)GenStateNsQualifyName(pGen,nLitForClass,&pGen->hUseImports,0);` |
|    8821 | 10754 | `					}else{` |
|      20 | 10755 | `						pPeek->iP2 = (sxi32)nLitForClass;` |
|       - | 10756 | `					}` |
|    8824 | 10757 | `				}` |
|       - | 10758 | `			}` |
|   17655 | 10759 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|   17655 | 10760 | `			if( pInstr && pInstr->iOp == PH7_OP_CALL ){` |
|       - | 10761 | `				VmInstr *pPrev;` |
|   17617 | 10762 | `				pPrev = PH7_VmPeekNextInstr(pGen->pVm);` |
|   17617 | 10763 | `				if( pPrev == 0 \|\| pPrev->iOp != PH7_OP_MEMBER ){` |
|       - | 10764 | `					/* Pop the call instruction, preserve named-arg map */` |
|   17617 | 10765 | `					iP1 = pInstr->iP1;` |
|   17617 | 10766 | `					if( pInstr->p3 ){` |
|      43 | 10767 | `						p3 = pInstr->p3; /* Transfer VmCallArgMap to NEW */` |
|      19 | 10768 | `					}` |
|   17617 | 10769 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|    8806 | 10770 | `				}` |
|    8811 | 10771 | `			}` |
| 1209536 | 10772 | `		}else if( iVmOp == PH7_OP_IS_A ){` |
...
|      68 | 10792 | `				}` |
|      82 | 10793 | `			}` |
| 1200636 | 10794 | `		}else if( iVmOp == PH7_OP_MEMBER){` |
...
|  180289 | 10798 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|  180289 | 10799 | `			if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|  180247 | 10800 | `				pInstr->iP1 = 0;` |
|   90121 | 10801 | `			}` |
|  180289 | 10802 | `			if( pNode->pOp->iOp == EXPR_OP_DC /* '::' */){` |
...
| 1231931 | 10814 | `		if( iVmOp == PH7_OP_CALL \|\| iVmOp == PH7_OP_NEW ){` |
|  408943 | 10815 | `			p3 = GenStateAttachStrictFlag(pGen,p3);` |
|  204469 | 10816 | `		}` |
|       - | 10817 | `		/* Finally,emit the VM instruction associated with this operator */` |
| 1231931 | 10818 | `		PH7_VmEmitInstr(pGen->pVm,iVmOp,iP1,iP2,p3,0);` |
|  615963 | 10819 | `	}` |
| 1232137 | 10820 | `	if( nJmpIdx > 0 ){` |
|       - | 10821 | `		/* Fix short-circuited jumps now the destination is resolved */` |
|   13949 | 10822 | `		pInstr = PH7_VmGetInstr(pGen->pVm,nJmpIdx);` |
|   13949 | 10823 | `		if( pInstr ){` |
|   13949 | 10824 | `			pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    6972 | 10825 | `		}` |
|    6972 | 10826 | `	}` |
| 1232137 | 10827 | `	return rc;` |
| 1622144 | 10828 |  |
|       - | 10829 | `/*` |
...
|       - | 10838 | ` * message.` |
|       - | 10839 | ` */` |
|  872278 | 10840 | `static sxi32 PH7_CompileExpr(` |
...
|  872283 | 10854 | `	nExpr = 0;` |
|  872283 | 10855 | `	pRoot = 0;` |
...
|  872283 | 10858 | `	nNullsafeBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  872283 | 10859 | `	SySetInit(&sExprNode,&pGen->pVm->sAllocator,sizeof(ph7_expr_node *));` |
|  872283 | 10860 | `	SySetAlloc(&sExprNode,0x10);` |
|  872283 | 10861 | `	rc = SXRET_OK;` |
|       - | 10862 | `	/* Delimit the expression */` |
|  872283 | 10863 | `	pEnd = pGen->pIn;` |
|  872283 | 10864 | `	iNest = 0;` |
| 5837809 | 10865 | `	while( pEnd < pGen->pEnd ){` |
| 5540799 | 10866 | `		if( pEnd->nType & PH7_TK_OCB /* '{' */ ){` |
|       - | 10867 | `			/* Ticket 1433-30: Annonymous/Closure functions body */` |
|     411 | 10868 | `			iNest++;` |
| 5540596 | 10869 | `		}else if(pEnd->nType & PH7_TK_CCB /* '}' */ ){` |
|     419 | 10870 | `			iNest--;` |
| 5540186 | 10871 | `		}else if( pEnd->nType & PH7_TK_SEMI /* ';' */ ){` |
|  575571 | 10872 | `			if( iNest <= 0 ){` |
|  575273 | 10873 | `				break;` |
|       - | 10874 | `			}` |
|     149 | 10875 | `		}` |
| 4965531 | 10876 | `		pEnd++;` |
|       5 | 10877 | `	}` |
|  872283 | 10878 | `	if( iFlags & EXPR_FLAG_COMMA_STATEMENT ){` |
|   20253 | 10879 | `		SyToken *pEnd2 = pGen->pIn;` |
|   20253 | 10880 | `		iNest = 0;` |
|       - | 10881 | `		/* Stop at the first comma */` |
|   40777 | 10882 | `		while( pEnd2 < pEnd ){` |
|   20535 | 10883 | `			if( pEnd2->nType & (PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*'['*/\|PH7_TK_LPAREN/*'('*/) ){` |
|      61 | 10884 | `				iNest++;` |
|   20507 | 10885 | `			}else if(pEnd2->nType & (PH7_TK_CCB/*'}'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_RPAREN/*')'*/)){` |
|      61 | 10886 | `				iNest--;` |
|   20451 | 10887 | `			}else if( pEnd2->nType & PH7_TK_COMMA /*','*/ ){` |
|      53 | 10888 | `				if( iNest <= 0 ){` |
|       7 | 10889 | `					break;` |
|       - | 10890 | `				}` |
|      21 | 10891 | `			}` |
|   20529 | 10892 | `			pEnd2++;` |
|       5 | 10893 | `		}` |
|   20253 | 10894 | `		if( pEnd2 <pEnd ){` |
|       7 | 10895 | `			pEnd = pEnd2;` |
|       3 | 10896 | `		}` |
|   10124 | 10897 | `	}` |
|  872283 | 10898 | `	if( pEnd > pGen->pIn ){` |
|  872273 | 10899 | `		SyToken *pTmp = pGen->pEnd;` |
|       - | 10900 | `		/* Swap delimiter */` |
|  872273 | 10901 | `		pGen->pEnd = pEnd;` |
|       - | 10902 | `		/* Try to get an expression tree */` |
|  872273 | 10903 | `		rc = PH7_ExprMakeTree(&(*pGen),&sExprNode,&pRoot);` |
|  872273 | 10904 | `		if( rc == SXRET_OK && pRoot ){` |
|  872091 | 10905 | `			rc = SXRET_OK;` |
|  872091 | 10906 | `			if( xTreeValidator ){` |
|       - | 10907 | `				/* Call the upper layer validator callback */` |
|   24143 | 10908 | `				rc = xTreeValidator(&(*pGen),pRoot);` |
|   12069 | 10909 | `			}` |
|  872091 | 10910 | `			if( rc != SXERR_ABORT ){` |
|       - | 10911 | `				/* Generate code for the given tree */` |
|  872091 | 10912 | `				rc = GenStateEmitExprCode(&(*pGen),pRoot,iFlags);` |
|       - | 10913 | `				/* Patch any unresolved nullsafe jumps emitted by this` |
|       - | 10914 | `				 * expression so they short-circuit to its end. */` |
|  872091 | 10915 | `				GenStatePatchNullsafeJumps(pGen, nNullsafeBase);` |
|  436043 | 10916 | `			}` |
|  872091 | 10917 | `			nExpr = 1;` |
|  436043 | 10918 | `		}` |
|       - | 10919 | `		/* Release the whole tree */` |
|  872273 | 10920 | `		PH7_ExprFreeTree(&(*pGen),&sExprNode);` |
|       - | 10921 | `		/* Synchronize token stream */` |
|  872273 | 10922 | `		pGen->pEnd = pTmp;` |
|  872273 | 10923 | `		pGen->pIn  = pEnd;` |
|  872273 | 10924 | `		if( rc == SXERR_ABORT ){` |
|      14 | 10925 | `			SySetRelease(&sExprNode);` |
|      14 | 10926 | `			return SXERR_ABORT;` |
|       - | 10927 | `		}` |
|  436129 | 10928 | `	}` |
|  872273 | 10929 | `	SySetRelease(&sExprNode);` |
|  872273 | 10930 | `	return nExpr > 0 ? SXRET_OK : SXERR_EMPTY;` |
|  436144 | 10931 |  |
|       - | 10932 | `/*` |
|       - | 10933 | ` * Return a pointer to the node construct handler associated` |
|       - | 10934 | ` * with a given node type [i.e: string,integer,float,...].` |
|       - | 10935 | ` */` |
|  221282 | 10936 | `PH7_PRIVATE ProcNodeConstruct PH7_GetNodeHandler(sxu32 nNodeType)` |
|       5 | 10937 |  |
|  221287 | 10938 | `	if( nNodeType & PH7_TK_NUM ){` |
|       - | 10939 | `		/* Numeric literal: Either real or integer */` |
|  116429 | 10940 | `		return PH7_CompileNumLiteral;` |
|  104863 | 10941 | `	}else if( nNodeType & PH7_TK_DSTR ){` |
|       - | 10942 | `		/* Double quoted string */` |
|   21175 | 10943 | `		return PH7_CompileString;` |
|   83693 | 10944 | `	}else if( nNodeType & PH7_TK_SSTR ){` |
|       - | 10945 | `		/* Single quoted string */` |
|   83577 | 10946 | `		return PH7_CompileSimpleString;` |
...
|       - | 11074 | ` */` |
|  588480 | 11075 | `static ProcLangConstruct GenStateGetStatementHandler(` |
|       - | 11076 | `	sxu32 nKeywordID,   /* Keyword  ID*/` |
|       - | 11077 | `	SyToken *pLookahed  /* Look-ahead token */` |
|       - | 11078 | `	)` |
|       5 | 11079 |  |
|  588485 | 11080 | `	sxu32 n = 0;` |
| 3038687 | 11081 | `	for(;;){` |
| 6077379 | 11082 | `		if( n >= SX_ARRAYSIZE(aLangConstruct) ){` |
|  126531 | 11083 | `			break;` |
|       - | 11084 | `		}` |
| 5950853 | 11085 | `		if( aLangConstruct[n].nID == nKeywordID ){` |
|  461959 | 11086 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed && (pLookahed->nType & PH7_TK_OP)){` |
...
|       - | 11091 | `				}` |
|     ! 0 | 11092 | `			}` |
|  461954 | 11093 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed` |
...
|       - | 11100 | `			*/` |
|  461959 | 11101 | `			return aLangConstruct[n].xConstruct;` |
|       - | 11102 | `		}` |
| 5488899 | 11103 | `		n++;` |
|       5 | 11104 | `	}` |
|  126531 | 11105 | `	if( pLookahed ){` |
|  126531 | 11106 | `		if(nKeywordID == PH7_TKWRD_INTERFACE && (pLookahed->nType & PH7_TK_ID) ){` |
|   36309 | 11107 | `			return PH7_CompileClassInterface;` |
|   90227 | 11108 | `		}else if(nKeywordID == PH7_TKWRD_CLASS && (pLookahed->nType & PH7_TK_ID) ){` |
|   89981 | 11109 | `			return PH7_CompileClass;` |
...
|       - | 11147 | ` */` |
|  705002 | 11148 | `static sxi32 GenStateCompileChunk(` |
...
|       - | 11154 | `	sxi32 rc;` |
|  705007 | 11155 | `	rc = SXRET_OK; /* Prevent compiler warning */` |
|  549219 | 11156 | `	for(;;){` |
|  901725 | 11157 | `		int bStmtIsDeclare = 0;` |
|  901725 | 11158 | `		if( pGen->pIn >= pGen->pEnd ){` |
...
|  888093 | 11164 | `		if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|  588511 | 11165 | `			sxu32 nPeek = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  588511 | 11166 | `			if( nPeek == PH7_TKWRD_DECLARE ){` |
|      45 | 11167 | `				bStmtIsDeclare = 1;` |
|      20 | 11168 | `			}` |
|  294253 | 11169 | `		}` |
|  888093 | 11170 | `		if( !bStmtIsDeclare && pGen->pCurrent == &pGen->sGlobal ){` |
...
|  196693 | 11173 | `			pGen->bStrictTypesLocked = 1;` |
|   98344 | 11174 | `		}` |
|  888093 | 11175 | `		if( pGen->pIn->nType & PH7_TK_OCB /* '{' */ ){` |
|       - | 11176 | `			/* Compile block */` |
...
|       - | 11180 | `			}` |
|      13 | 11181 | `		}else{` |
|  888077 | 11182 | `			xCons = 0;` |
|  888077 | 11183 | `			if( GenStateStartsModifiedClass(pGen->pIn,pGen->pEnd) ){` |
...
|  888051 | 11188 | `			}else if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|  588485 | 11189 | `				sxu32 nKeyword = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|       - | 11190 | `				/* Try to extract a language construct handler */` |
|  588485 | 11191 | `				xCons = GenStateGetStatementHandler(nKeyword,(&pGen->pIn[1] < pGen->pEnd) ? &pGen->pIn[1] : 0);` |
|  588485 | 11192 | `				if( xCons == 0 && GenStateisLangConstruct(nKeyword) == FALSE ){` |
...
|       4 | 11203 | `				}` |
|  593785 | 11204 | `			}else if( (pGen->pIn->nType & PH7_TK_ID) && (&pGen->pIn[1] < pGen->pEnd)` |
|   49027 | 11205 | `				&& (pGen->pIn[1].nType & PH7_TK_COLON /*':'*/) ){` |
|       - | 11206 | `				/* Label found [i.e: Out: ],point to the routine responsible of compiling it */` |
|     117 | 11207 | `				xCons = PH7_CompileLabel;` |
|      56 | 11208 | `			}` |
|  888077 | 11209 | `			if( xCons == 0 ){` |
|       - | 11210 | `				/* Assume an expression an try to compile it */` |
|  299615 | 11211 | `				rc = PH7_CompileExpr(&(*pGen),0,0);` |
|  299615 | 11212 | `				if(  rc != SXERR_EMPTY ){` |
|       - | 11213 | `					/* Pop l-value */` |
|  299465 | 11214 | `					PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|  149730 | 11215 | `				}` |
|  149810 | 11216 | `			}else{` |
|       - | 11217 | `				/* Go compile the sucker */` |
|  588467 | 11218 | `				rc = xCons(&(*pGen));` |
|       - | 11219 | `			}` |
|  888077 | 11220 | `			if( rc == SXERR_ABORT ){` |
|       - | 11221 | `				/* Request to abort compilation */` |
|      14 | 11222 | `				break;` |
|       - | 11223 | `			}` |
|       - | 11224 | `		}` |
|       - | 11225 | `		/* Ignore trailing semi-colons ';' */` |
| 1436895 | 11226 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|  548817 | 11227 | `			pGen->pIn++;` |
|       5 | 11228 | `		}` |
|  888083 | 11229 | `		if( iFlags & PH7_COMPILE_SINGLE_STMT ){` |
...
|       - | 11245 | ` */` |
|   13644 | 11246 | `static sxi32 PH7_CompilePHP(` |
...
|       - | 11250 | `	)` |
|       5 | 11251 |  |
|   13649 | 11252 | `	SyToken *pScript = pGen->pRawIn; /* Script to compile */` |
|       - | 11253 | `	sxi32 rc;` |
|       - | 11254 | `	/* Reset the token set */` |
|   13649 | 11255 | `	SySetReset(&(*pTokenSet));` |
|       - | 11256 | `	/* Mark as the default token set */` |
|   13649 | 11257 | `	pGen->pTokenSet = &(*pTokenSet);` |
|       - | 11258 | `	/* Advance the stream cursor */` |
|   13649 | 11259 | `	pGen->pRawIn++;` |
|       - | 11260 | `	/* Tokenize the PHP chunk first */` |
|   13649 | 11261 | `	PH7_TokenizePHP(SyStringData(&pScript->sData),SyStringLength(&pScript->sData),pScript->nLine,&(*pTokenSet));` |
|       - | 11262 | `	/* Point to the head and tail of the token stream. */` |
|   13649 | 11263 | `	pGen->pIn  = (SyToken *)SySetBasePtr(pTokenSet);` |
|   13649 | 11264 | `	pGen->pEnd = &pGen->pIn[SySetUsed(pTokenSet)];` |
|   13649 | 11265 | `	if( is_expr ){` |
...
|       - | 11274 | `	}` |
|   13649 | 11275 | `	if( pGen->pIn < pGen->pEnd && ( pGen->pIn->nType & PH7_TK_EQUAL ) ){` |
...
|   13647 | 11300 | `	rc = GenStateCompileChunk(pGen,0);` |
|       - | 11301 | `	/* Fix exceptions jumps */` |
|   13647 | 11302 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|       - | 11303 | `	/* Fix gotos now, the jump destination is resolved */` |
|   13647 | 11304 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),0) ){` |
|       3 | 11305 | `		rc = SXERR_ABORT;` |
|       1 | 11306 | `	}` |
|       - | 11307 | `	/* Reset container */` |
|   13647 | 11308 | `	SySetReset(&pGen->aGoto);` |
|   13647 | 11309 | `	SySetReset(&pGen->aLabel);` |
|   13647 | 11310 | `	SySetReset(&pGen->aNullsafeJmp);` |
|       - | 11311 | `	/* Compilation result */` |
|   13647 | 11312 | `	return rc;` |
|    6827 | 11313 |  |
|       - | 11314 | `/*` |
...
|       - | 11318 | ` */` |
|   16424 | 11319 | `PH7_PRIVATE sxi32 PH7_CompileScript(` |
...
|       - | 11333 | `	sxi32 rc;` |
|   16429 | 11334 | `	if( pScript->nByte < 1 ){` |
...
|   16429 | 11340 | `	pCodeGen = &pVm->sCodeGen;` |
|   16429 | 11341 | `	bSavedStrict = pCodeGen->bStrictTypes;` |
|   16429 | 11342 | `	bSavedStrictLocked = pCodeGen->bStrictTypesLocked;` |
|   16429 | 11343 | `	pCodeGen->bStrictTypes = 0;` |
|   16429 | 11344 | `	pCodeGen->bStrictTypesLocked = 0;` |
|       - | 11345 | `	/* Initialize the tokens containers */` |
|   16429 | 11346 | `	SySetInit(&aRawToken,&pVm->sAllocator,sizeof(SyToken));` |
|   16429 | 11347 | `	SySetInit(&aPhpToken,&pVm->sAllocator,sizeof(SyToken));` |
|   16429 | 11348 | `	SySetAlloc(&aPhpToken,0xc0);` |
|   16429 | 11349 | `	is_expr = 0;` |
|   16429 | 11350 | `	if( iFlags & PH7_PHP_ONLY ){` |
|       - | 11351 | `		SyToken sTmp;` |
|       - | 11352 | `		/* PHP only: -*/` |
|    3367 | 11353 | `		sTmp.nLine = 1;` |
|    3367 | 11354 | `		sTmp.nType = PH7_TOKEN_PHP;` |
|    3367 | 11355 | `		sTmp.pUserData = 0;` |
|    3367 | 11356 | `		SyStringDupPtr(&sTmp.sData,pScript);` |
|    3367 | 11357 | `		SySetPut(&aRawToken,(const void *)&sTmp);` |
|    3367 | 11358 | `		if( iFlags & PH7_PHP_EXPR ){` |
|       - | 11359 | `			/* A simple PHP expression */` |
|     ! 0 | 11360 | `			is_expr = 1;` |
|     ! 0 | 11361 | `		}` |
|    1686 | 11362 | `	}else{` |
|       - | 11363 | `		/* Tokenize raw text */` |
|   13067 | 11364 | `		SySetAlloc(&aRawToken,32);` |
|   13067 | 11365 | `		PH7_TokenizeRawText(pScript->zString,pScript->nByte,&aRawToken);` |
|       - | 11366 | `	}` |
|       - | 11367 | `	/* Process high-level tokens */` |
|   16429 | 11368 | `	pCodeGen->pRawIn = (SyToken *)SySetBasePtr(&aRawToken);` |
|   16429 | 11369 | `	pCodeGen->pRawEnd = &pCodeGen->pRawIn[SySetUsed(&aRawToken)];` |
|   16429 | 11370 | `	rc = PH7_OK;` |
|   16429 | 11371 | `	if( is_expr ){` |
|       - | 11372 | `		/* Compile the expression */` |
|     ! 0 | 11373 | `		rc = PH7_CompilePHP(pCodeGen,&aPhpToken,TRUE);` |
|     ! 0 | 11374 | `		goto cleanup;` |
|       - | 11375 | `	}` |
|   16429 | 11376 | `	nObjIdx = 0;` |
...
|   16429 | 11380 | `	PH7_VmEmitInstr(pVm,PH7_OP_NSSWITCH,0,0,0,0);` |
|       - | 11381 | `	/* Start the compilation process */` |
|   14749 | 11382 | `	for(;;){` |
|   43135 | 11383 | `		if( pCodeGen->pRawIn >= pCodeGen->pRawEnd ){` |
|   16417 | 11384 | `			break; /* No more tokens to process */` |
|       - | 11385 | `		}` |
|   26723 | 11386 | `		if( pCodeGen->pRawIn->nType & PH7_TOKEN_PHP ){` |
|       - | 11387 | `			/* Compile the PHP chunk */` |
|   13649 | 11388 | `			rc = PH7_CompilePHP(pCodeGen,&aPhpToken,FALSE);` |
|   13649 | 11389 | `			if( rc == SXERR_ABORT ){` |
|      16 | 11390 | `				break;` |
|       - | 11391 | `			}` |
|   13637 | 11392 | `			continue;` |
|       - | 11393 | `		}` |
|       - | 11394 | `		/* Raw chunk: [i.e: HTML, XML, etc.] */` |
|   13079 | 11395 | `		nRawObj = 0;` |
|   26195 | 11396 | `		while( (pCodeGen->pRawIn < pCodeGen->pRawEnd) && (pCodeGen->pRawIn->nType != PH7_TOKEN_PHP) ){` |
|       - | 11397 | `			/* Consume the raw chunk without any processing */` |
|   13121 | 11398 | `			pRawObj = PH7_ReserveConstObj(&(*pVm),&nObjIdx);` |
|   13121 | 11399 | `			if( pRawObj == 0 ){` |
|     ! 0 | 11400 | `				rc = SXERR_MEM;` |
|     ! 0 | 11401 | `				break;` |
|       - | 11402 | `			}` |
|       - | 11403 | `			/* Mark as constant and emit the load constant instruction */` |
|   13121 | 11404 | `			PH7_MemObjInitFromString(pVm,pRawObj,&pCodeGen->pRawIn->sData);` |
|   13121 | 11405 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_LOADC,0,nObjIdx,0,0);` |
|   13121 | 11406 | `			++nRawObj;` |
|   13121 | 11407 | `			pCodeGen->pRawIn++; /* Next chunk */` |
|       5 | 11408 | `		}` |
|   13079 | 11409 | `		if( nRawObj > 0 ){` |
|       - | 11410 | `			/* Emit the consume instruction */` |
|   13079 | 11411 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_CONSUME,nRawObj,0,0,0);` |
|    6537 | 11412 | `		}` |
|    8217 | 11413 | `	}` |
|    8212 | 11414 | `cleanup:` |
|   16429 | 11415 | `	SySetRelease(&aRawToken);` |
|   16429 | 11416 | `	SySetRelease(&aPhpToken);` |
|       - | 11417 | `	/* Restore outer file's strict_types scope */` |
|   16429 | 11418 | `	pCodeGen->bStrictTypes = bSavedStrict;` |
|   16429 | 11419 | `	pCodeGen->bStrictTypesLocked = bSavedStrictLocked;` |
|   16429 | 11420 | `	return rc;` |
|    8217 | 11421 |  |
|       - | 11422 | `/*` |
|       - | 11423 | ` * Utility routines.Initialize the code generator.` |
|       - | 11424 | ` */` |
|    3296 | 11425 | `PH7_PRIVATE sxi32 PH7_InitCodeGenerator(` |
|       - | 11426 | `	ph7_vm *pVm,       /* Target VM */` |
|       - | 11427 | `	ProcConsumer xErr, /* Error log consumer callabck  */` |
|       - | 11428 | `	void *pErrData     /* Last argument to xErr() */` |
|       - | 11429 | `	)` |
|       5 | 11430 |  |
|    3301 | 11431 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|       - | 11432 | `	/* Zero the structure */` |
|    3301 | 11433 | `	SyZero(pGen,sizeof(ph7_gen_state));` |
|       - | 11434 | `	/* Initial state */` |
|    3301 | 11435 | `	pGen->pVm  = &(*pVm);` |
|    3301 | 11436 | `	pGen->xErr = xErr;` |
|    3301 | 11437 | `	pGen->pErrData = pErrData;` |
|    3301 | 11438 | `	SySetInit(&pGen->aLabel,&pVm->sAllocator,sizeof(Label));` |
|    3301 | 11439 | `	SySetInit(&pGen->aGoto,&pVm->sAllocator,sizeof(JumpFixup));` |
|    3301 | 11440 | `	SySetInit(&pGen->aNullsafeJmp,&pVm->sAllocator,sizeof(sxu32));` |
|    3301 | 11441 | `	SyHashInit(&pGen->hLiteral,&pVm->sAllocator,0,0);` |
|    3301 | 11442 | `	SyHashInit(&pGen->hVar,&pVm->sAllocator,0,0);` |
|       - | 11443 | `	/* Error log buffer */` |
|    3301 | 11444 | `	SyBlobInit(&pGen->sErrBuf,&pVm->sAllocator);` |
|       - | 11445 | `	/* General purpose working buffer */` |
|    3301 | 11446 | `	SyBlobInit(&pGen->sWorker,&pVm->sAllocator);` |
|       - | 11447 | `	/* Namespace state */` |
|    3301 | 11448 | `	SyBlobInit(&pGen->sNamespace,&pVm->sAllocator);` |
|    3301 | 11449 | `	SyHashInit(&pGen->hUseImports,&pVm->sAllocator,0,0);` |
|    3301 | 11450 | `	SyHashInit(&pGen->hUseFuncImports,&pVm->sAllocator,0,0);` |
|    3301 | 11451 | `	SyHashInit(&pGen->hUseConstImports,&pVm->sAllocator,0,0);` |
|       - | 11452 | `	/* Create the global scope */` |
|    3301 | 11453 | `	GenStateInitBlock(pGen,&pGen->sGlobal,GEN_BLOCK_GLOBAL,PH7_VmInstrLength(&(*pVm)),0);` |
|       - | 11454 | `	/* Point to the global scope */` |
|    3301 | 11455 | `	pGen->pCurrent = &pGen->sGlobal;` |
|    3301 | 11456 | `	return SXRET_OK;` |
|       5 | 11457 |  |
|       - | 11458 | `/*` |
|       - | 11459 | ` * Utility routines. Reset the code generator to it's initial state.` |
|       - | 11460 | ` */` |
|   19380 | 11461 | `PH7_PRIVATE sxi32 PH7_ResetCodeGenerator(` |
|       - | 11462 | `	ph7_vm *pVm,       /* Target VM */` |
|       - | 11463 | `	ProcConsumer xErr, /* Error log consumer callabck  */` |
|       - | 11464 | `	void *pErrData     /* Last argument to xErr() */` |
|       - | 11465 | `	)` |
|       5 | 11466 |  |
|   19385 | 11467 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|       - | 11468 | `	GenBlock *pBlock,*pParent;` |
|       - | 11469 | `	/* Reset state */` |
|   19385 | 11470 | `	SySetReset(&pGen->aLabel);` |
|   19385 | 11471 | `	SySetReset(&pGen->aGoto);` |
|   19385 | 11472 | `	SySetReset(&pGen->aNullsafeJmp);` |
|   19385 | 11473 | `	SyBlobRelease(&pGen->sErrBuf);` |
|   19385 | 11474 | `	SyBlobRelease(&pGen->sWorker);` |
|   19385 | 11475 | `	SyBlobRelease(&pGen->sNamespace);` |
|   19385 | 11476 | `	SyBlobInit(&pGen->sNamespace,&pVm->sAllocator);` |
|   19385 | 11477 | `	SyHashRelease(&pGen->hUseImports);` |
|   19385 | 11478 | `	SyHashInit(&pGen->hUseImports,&pVm->sAllocator,0,0);` |
|   19385 | 11479 | `	SyHashRelease(&pGen->hUseFuncImports);` |
|   19385 | 11480 | `	SyHashInit(&pGen->hUseFuncImports,&pVm->sAllocator,0,0);` |
|   19385 | 11481 | `	SyHashRelease(&pGen->hUseConstImports);` |
|   19385 | 11482 | `	SyHashInit(&pGen->hUseConstImports,&pVm->sAllocator,0,0);` |
...
|   19385 | 11490 | `	pBlock = pGen->pCurrent;` |
|   19385 | 11491 | `	while( pBlock->pParent != 0 ){` |
|     ! 0 | 11492 | `		pParent = pBlock->pParent;` |
|     ! 0 | 11493 | `		GenStateFreeBlock(pBlock);` |
|     ! 0 | 11494 | `		pBlock = pParent;` |
|     ! 0 | 11495 | `	}` |
|   19385 | 11496 | `	pGen->xErr = xErr;` |
|   19385 | 11497 | `	pGen->pErrData = pErrData;` |
|   19385 | 11498 | `	pGen->pCurrent = &pGen->sGlobal;` |
|   19385 | 11499 | `	pGen->pRawIn = pGen->pRawEnd = 0;` |
|   19385 | 11500 | `	pGen->pIn = pGen->pEnd = 0;` |
|   19385 | 11501 | `	pGen->nErr = 0;` |
|   19385 | 11502 | `	return SXRET_OK;` |
|       5 | 11503 |  |
|       - | 11504 | `/*` |
