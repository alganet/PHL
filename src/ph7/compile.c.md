...
|       - |   127 | ` */` |
|    3266 |   128 | `static GenBlock * GenStateFetchBlock(GenBlock *pCurrent,sxi32 iBlockType,sxi32 iCount)` |
|       2 |   129 |  |
|    3268 |   130 | `	GenBlock *pBlock = pCurrent;` |
|    9225 |   131 | `	for(;;){` |
|   18452 |   132 | `		if( pBlock->iFlags & iBlockType ){` |
|    3160 |   133 | `			iCount--; /* Decrement nesting level */` |
|    3160 |   134 | `			if( iCount < 1 ){` |
|       - |   135 | `				/* Block meet with the desired criteria */` |
|    3134 |   136 | `				return pBlock;` |
|       - |   137 | `			}` |
|      13 |   138 | `		}` |
|       - |   139 | `		/* Point to the upper block */` |
|   15320 |   140 | `		pBlock = pBlock->pParent;` |
|   15320 |   141 | `		if( pBlock == 0 \|\| (pBlock->iFlags & (GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC)) ){` |
|       - |   142 | `			/* Forbidden */` |
|      69 |   143 | `			break;` |
|       - |   144 | `		}` |
|       2 |   145 | `	}` |
...
|       - |   151 | ` */` |
|  705460 |   152 | `static void GenStateInitBlock(` |
...
|  705462 |   161 | `	pBlock->nFirstInstr = nFirstInstr;` |
|  705462 |   162 | `	pBlock->pUserData   = pUserData;` |
|  705462 |   163 | `	pBlock->pGen        = pGen;` |
|  705462 |   164 | `	pBlock->iFlags      = iType;` |
|  705462 |   165 | `	pBlock->pParent     = 0;` |
|  705462 |   166 | `	SySetInit(&pBlock->aJumpFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  705462 |   167 | `	SySetInit(&pBlock->aPostContFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  705462 |   168 |  |
|       - |   169 | `/*` |
...
|       - |   174 | ` */` |
|  702468 |   175 | `static sxi32 GenStateEnterBlock(` |
...
|  702470 |   185 | `	pBlock = (GenBlock *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(GenBlock));` |
|  702470 |   186 | `	if( pBlock == 0 ){` |
...
|  702470 |   195 | `	SyZero(pBlock,sizeof(GenBlock));` |
|  702470 |   196 | `	GenStateInitBlock(&(*pGen),pBlock,iType,nFirstInstr,pUserData);` |
|       - |   197 | `	/* Link to the parent block */` |
|  702470 |   198 | `	pBlock->pParent = pGen->pCurrent;` |
|       - |   199 | `	/* Mark as the current block */` |
|  702470 |   200 | `	pGen->pCurrent = pBlock;` |
|  702470 |   201 | `	if( ppBlock ){` |
|       - |   202 | `		/* Write a pointer to the new instance */` |
|  341186 |   203 | `		*ppBlock = pBlock;` |
|  170592 |   204 | `	}` |
|  702470 |   205 | `	return SXRET_OK;` |
|  351236 |   206 |  |
|       - |   207 | `/*` |
|       - |   208 | ` * Release block fields without freeing the whole instance.` |
|       - |   209 | ` */` |
|  702460 |   210 | `static void GenStateReleaseBlock(GenBlock *pBlock)` |
|       2 |   211 |  |
|  702462 |   212 | `	SySetRelease(&pBlock->aPostContFix);` |
|  702462 |   213 | `	SySetRelease(&pBlock->aJumpFix);` |
|  702462 |   214 |  |
|       - |   215 | `/*` |
|       - |   216 | ` * Release a block.` |
|       - |   217 | ` */` |
|  702460 |   218 | `static void GenStateFreeBlock(GenBlock *pBlock)` |
|       2 |   219 |  |
|  702462 |   220 | `	ph7_gen_state *pGen = pBlock->pGen;` |
|  702462 |   221 | `	GenStateReleaseBlock(&(*pBlock));` |
|       - |   222 | `	/* Free the instance */` |
|  702462 |   223 | `	SyMemBackendPoolFree(&pGen->pVm->sAllocator,pBlock);` |
|  702462 |   224 |  |
|       - |   225 | `/*` |
|       - |   226 | ` * POP and release a block from the stack of compiled blocks.` |
|       - |   227 | ` */` |
|  702460 |   228 | `static sxi32 GenStateLeaveBlock(ph7_gen_state *pGen,GenBlock **ppBlock)` |
|       2 |   229 |  |
|  702462 |   230 | `	GenBlock *pBlock = pGen->pCurrent;` |
|  702462 |   231 | `	if( pBlock == 0 ){` |
|       - |   232 | `		/* No more block to pop */` |
|     ! 0 |   233 | `		return SXERR_EMPTY;` |
|       - |   234 | `	}` |
|       - |   235 | `	/* Point to the upper block */` |
|  702462 |   236 | `	pGen->pCurrent = pBlock->pParent;` |
|  702462 |   237 | `	if( ppBlock ){` |
|       - |   238 | `		/* Write a pointer to the popped block */` |
|     ! 0 |   239 | `		*ppBlock = pBlock;` |
|     ! 0 |   240 | `	}else{` |
|       - |   241 | `		/* Safely release the block */` |
|  702462 |   242 | `		GenStateFreeBlock(&(*pBlock));` |
|       - |   243 | `	}` |
|  702462 |   244 | `	return SXRET_OK;` |
|  351232 |   245 |  |
|       - |   246 | `/*` |
...
|       - |   255 | ` */` |
|  199618 |   256 | `static sxi32 GenStateNewJumpFixup(GenBlock *pBlock,sxi32 nJumpType,sxu32 nInstrIdx)` |
|       2 |   257 |  |
|       - |   258 | `	JumpFixup sJumpFix;` |
|       - |   259 | `	sxi32 rc;` |
|       - |   260 | `	/* Init the JumpFixup structure */` |
|  199620 |   261 | `	sJumpFix.nJumpType = nJumpType;` |
|  199620 |   262 | `	sJumpFix.nInstrIdx = nInstrIdx;` |
|       - |   263 | `	/* Insert in the jump fixup table */` |
|  199620 |   264 | `	rc = SySetPut(&pBlock->aJumpFix,(const void *)&sJumpFix);` |
|  199620 |   265 | `	return rc;` |
|       2 |   266 |  |
|       - |   267 | `/*` |
...
|       - |   277 | ` */` |
|  491714 |   278 | `static sxu32 GenStateFixJumps(GenBlock *pBlock,sxi32 nJumpType,sxu32 nJumpDest)` |
|       2 |   279 |  |
|       - |   280 | `	JumpFixup *aFix;` |
|       - |   281 | `	VmInstr *pInstr;` |
|       - |   282 | `	sxu32 nFixed;` |
...
|  491716 |   285 | `	aFix = (JumpFixup *)SySetBasePtr(&pBlock->aJumpFix);` |
|       - |   286 | `	/* Fix the desired jumps */` |
|  885314 |   287 | `	for( nFixed = n = 0 ; n < SySetUsed(&pBlock->aJumpFix) ; ++n ){` |
|  393600 |   288 | `		if( aFix[n].nJumpType < 0 ){` |
|       - |   289 | `			/* Already fixed */` |
|  157286 |   290 | `			continue;` |
|       - |   291 | `		}` |
|  236316 |   292 | `		if( nJumpType > 0 && aFix[n].nJumpType != nJumpType ){` |
|       - |   293 | `			/* Not of our interest */` |
|   36700 |   294 | `			continue;` |
|       - |   295 | `		}` |
|       - |   296 | `		/* Point to the instruction to fix */` |
|  199618 |   297 | `		pInstr = PH7_VmGetInstr(pBlock->pGen->pVm,aFix[n].nInstrIdx);` |
|  199618 |   298 | `		if( pInstr ){` |
|  199618 |   299 | `			pInstr->iP2 = nJumpDest;` |
|  199618 |   300 | `			nFixed++;` |
|       - |   301 | `			/* Mark as fixed */` |
|  199618 |   302 | `			aFix[n].nJumpType = -1;` |
|   99808 |   303 | `		}` |
|   99810 |   304 | `	}` |
|       - |   305 | `	/* Total number of fixed jumps */` |
|  491716 |   306 | `	return nFixed;` |
|       2 |   307 |  |
|       - |   308 | `/*` |
...
|       - |   314 | ` */` |
|  199716 |   315 | `static sxi32 GenStateFixGoto(ph7_gen_state *pGen,sxu32 nOfft)` |
|       2 |   316 |  |
...
|  199718 |   323 | `	aJumps = (JumpFixup *)SySetBasePtr(&pGen->aGoto);` |
|       - |   324 | `	/* Fix */` |
|  199864 |   325 | `	for( n = nOfft ; n < SySetUsed(&pGen->aGoto) ; ++n ){` |
...
|      46 |   348 | `		}` |
|      48 |   349 | `	}` |
|  199716 |   350 | `	aLabel = (Label *)SySetBasePtr(&pGen->aLabel);` |
|  199848 |   351 | `	for( n = 0 ; n < SySetUsed(&pGen->aLabel) ; ++n ){` |
...
|      12 |   356 | `		}` |
|      68 |   357 | `	}` |
|  199716 |   358 | `	return SXRET_OK;` |
|   99860 |   359 |  |
|       - |   360 | `/*` |
|       - |   361 | ` * Check if a given token value is installed in the literal table.` |
|       - |   362 | ` */` |
|  631388 |   363 | `static sxi32 GenStateFindLiteral(ph7_gen_state *pGen,const SyString *pValue,sxu32 *pIdx)` |
|       2 |   364 |  |
|       - |   365 | `	SyHashEntry *pEntry;` |
|  631390 |   366 | `	pEntry = SyHashGet(&pGen->hLiteral,(const void *)pValue->zString,pValue->nByte);` |
|  631390 |   367 | `	if( pEntry == 0 ){` |
|  274370 |   368 | `		return SXERR_NOTFOUND;` |
|       - |   369 | `	}` |
|  357022 |   370 | `	*pIdx = (sxu32)SX_PTR_TO_INT(pEntry->pUserData);` |
|  357022 |   371 | `	return SXRET_OK;` |
|  315696 |   372 |  |
|       - |   373 | `/*` |
...
|       - |   382 | ` */` |
|  274368 |   383 | `static sxi32 GenStateInstallLiteral(ph7_gen_state *pGen,ph7_value *pObj,sxu32 nIdx)` |
|       2 |   384 |  |
|  274370 |   385 | `	if( SyBlobLength(&pObj->sBlob) > 0 ){` |
|  274370 |   386 | `		SyHashInsert(&pGen->hLiteral,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob),SX_INT_TO_PTR(nIdx));` |
|  137184 |   387 | `	}` |
|  274370 |   388 | `	return SXRET_OK;` |
|       2 |   389 |  |
|       - |   390 | `/*` |
|       - |   391 | ` * Reserve a room for a numeric constant [i.e: 64-bit integer or real number]` |
|       - |   392 | ` * in the constant table.` |
|       - |   393 | ` */` |
|  104956 |   394 | `static ph7_value * GenStateInstallNumLiteral(ph7_gen_state *pGen,sxu32 *pIdx)` |
|       2 |   395 |  |
|       - |   396 | `	ph7_value *pObj;` |
|  104958 |   397 | `	sxu32 nIdx = 0; /* cc warning */` |
|       - |   398 | `	/* Reserve a new constant */` |
|  104958 |   399 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  104958 |   400 | `	if( pObj == 0 ){` |
|     ! 0 |   401 | `		PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|     ! 0 |   402 | `		return 0;` |
|       - |   403 | `	}` |
|  104958 |   404 | `	*pIdx = nIdx;` |
|       - |   405 | `	/* TODO(chems): Create a numeric table (64bit int keys) same as` |
|       - |   406 | `	 * the constant string iterals table [optimization purposes].` |
|       - |   407 | `	 */` |
|  104958 |   408 | `	return pObj;` |
|   52480 |   409 |  |
|       - |   410 | `/*` |
...
|       - |   423 | ` */` |
|  377430 |   424 | `static void *GenStateAttachStrictFlag(ph7_gen_state *pGen, void *p3)` |
|       2 |   425 |  |
|       - |   426 | `	VmCallArgMap *pMap;` |
|  377432 |   427 | `	if( !pGen->bStrictTypes ) return p3;` |
|      28 |   428 | `	if( p3 == 0 ){` |
...
|       - |   494 | ` */` |
|  105500 |   495 | `static int GenStateFindBadNumericSeparator(` |
|       - |   496 | `	const SyString *pRaw, const char **pBadStart, sxu32 *pBadLen)` |
|       2 |   497 |  |
|  105502 |   498 | `	const char *z = pRaw->zString;` |
|  105502 |   499 | `	sxu32 n = pRaw->nByte;` |
|  105502 |   500 | `	int base = 10;` |
|       - |   501 | `	sxu32 i, start;` |
|  105502 |   502 | `	if( n < 2 ) return 0;` |
|    8892 |   503 | `	if( z[0] == '0' && (z[1] == 'x' \|\| z[1] == 'X') ){` |
|      72 |   504 | `		base = 16;` |
|    8857 |   505 | `	}else if( z[0] == '0' && (z[1] == 'b' \|\| z[1] == 'B') ){` |
|     280 |   506 | `		base = 2;` |
|     139 |   507 | `	}` |
|   32712 |   508 | `	for( i = 0; i < n; ++i ){` |
|   23836 |   509 | `		if( z[i] != '_' ) continue;` |
...
|       - |   535 | ` */` |
|  105500 |   536 | `static sxi32 GenStateValidateNumericSeparator(ph7_gen_state *pGen, SyToken *pToken)` |
|       2 |   537 |  |
|  105502 |   538 | `	const char *zBad = 0;` |
|  105502 |   539 | `	sxu32 nBad = 0;` |
|       - |   540 | `	SyString sBad;` |
|       - |   541 | `	sxi32 rc;` |
|  105502 |   542 | `	if( !GenStateFindBadNumericSeparator(&pToken->sData, &zBad, &nBad) ){` |
|  105488 |   543 | `		return SXRET_OK;` |
|       - |   544 | `	}` |
...
|       - |   568 | ` */` |
|  105486 |   569 | `static sxi32 GenStateStripNumericSeparators(` |
...
|       2 |   574 |  |
|       - |   575 | `	sxu32 i, j;` |
|  105488 |   576 | `	int hasUnderscore = 0;` |
|       - |   577 | `	char *zBuf;` |
|  105488 |   578 | `	*pzAlloc = 0;` |
|  223852 |   579 | `	for( i = 0; i < pToken->nByte; ++i ){` |
|  118618 |   580 | `		if( pToken->zString[i] == '_' ){ hasUnderscore = 1; break; }` |
|   59184 |   581 | `	}` |
|  105488 |   582 | `	if( !hasUnderscore ){` |
|  105236 |   583 | `		SyStringDupPtr(pOut, pToken);` |
|  105236 |   584 | `		return SXRET_OK;` |
|       - |   585 | `	}` |
...
|       - |   616 | ` *  documentation.` |
|       - |   617 | ` */` |
|  105472 |   618 | `static sxi32 PH7_CompileNumLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       2 |   619 |  |
|  105474 |   620 | `	SyToken *pToken = pGen->pIn; /* Raw token */` |
|  105474 |   621 | `	sxu32 nIdx = 0;` |
|       - |   622 | `	char zScratch[GEN_NUM_SCRATCH];` |
|  105474 |   623 | `	char *zAlloc = 0;` |
|       - |   624 | `	SyString sNum;` |
|       - |   625 | `	sxi32 rc;` |
|   52736 |   626 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|  105474 |   627 | `	rc = GenStateValidateNumericSeparator(pGen, pToken);` |
|  105474 |   628 | `	if( rc != SXRET_OK ){` |
|      11 |   629 | `		return rc;` |
|       - |   630 | `	}` |
|  158195 |   631 | `	rc = GenStateStripNumericSeparators(&pGen->pVm->sAllocator, &pToken->sData,` |
|   52731 |   632 | `		zScratch, sizeof(zScratch), &sNum, &zAlloc);` |
|  105464 |   633 | `	if( rc != SXRET_OK ){` |
|     ! 0 |   634 | `		return SXERR_ABORT;` |
|       - |   635 | `	}` |
|  105464 |   636 | `	if( pToken->nType & PH7_TK_INTEGER ){` |
|       - |   637 | `		ph7_value *pObj;` |
|       - |   638 | `		sxi64 iValue;` |
|  104958 |   639 | `		iValue = PH7_TokenValueToInt64(&sNum);` |
|  104958 |   640 | `		pObj = GenStateInstallNumLiteral(&(*pGen),&nIdx);` |
|  104958 |   641 | `		if( pObj == 0 ){` |
|     ! 0 |   642 | `			if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|     ! 0 |   643 | `			return SXERR_ABORT;` |
|       - |   644 | `		}` |
|  104958 |   645 | `		PH7_MemObjInitFromInt(pGen->pVm,pObj,iValue);` |
|   52480 |   646 | `	}else{` |
|       - |   647 | `		/* Real number */` |
|       - |   648 | `		ph7_value *pObj;` |
|       - |   649 | `		/* Reserve a new constant */` |
|     508 |   650 | `		pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|     508 |   651 | `		if( pObj == 0 ){` |
...
|       - |   655 | `		}` |
|     508 |   656 | `		PH7_MemObjInitFromString(pGen->pVm,pObj,&sNum);` |
|     508 |   657 | `		PH7_MemObjToReal(pObj);` |
|       - |   658 | `	}` |
|  105464 |   659 | `	if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|       - |   660 | `	/* Emit the load constant instruction */` |
|  105464 |   661 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|       - |   662 | `	/* Node successfully compiled */` |
|  105464 |   663 | `	return SXRET_OK;` |
|   52738 |   664 |  |
|       - |   665 | `/*` |
...
|       - |   674 | ` *` |
|       - |   675 | ` */` |
|   76116 |   676 | `PH7_PRIVATE sxi32 PH7_CompileSimpleString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       2 |   677 |  |
|   76118 |   678 | `	SyString *pStr = &pGen->pIn->sData; /* Constant string literal */` |
|       - |   679 | `	const char *zIn,*zCur,*zEnd;` |
|       - |   680 | `	ph7_value *pObj;` |
|       - |   681 | `	sxu32 nIdx;` |
|   76118 |   682 | `	nIdx = 0; /* Prevent compiler warning */` |
|       - |   683 | `	/* Delimit the string */` |
|   76118 |   684 | `	zIn  = pStr->zString;` |
|   76118 |   685 | `	zEnd = &zIn[pStr->nByte];` |
|   76118 |   686 | `	if( zIn >= zEnd ){` |
|       - |   687 | `		/* Empty string constant: just use the pre‑allocated index from the VM` |
|       - |   688 | `		 * rather than reserving a new object each time. */` |
|    6128 |   689 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,pGen->pVm->nEmptyStringIdx,0,0);` |
|    6128 |   690 | `		return SXRET_OK;` |
|       - |   691 | `	}` |
|   69992 |   692 | `	if( SXRET_OK == GenStateFindLiteral(&(*pGen),pStr,&nIdx) ){` |
|       - |   693 | `		/* Already processed,emit the load constant instruction` |
|       - |   694 | `		 * and return.` |
|       - |   695 | `		 */` |
|   27908 |   696 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   27908 |   697 | `		return SXRET_OK;` |
|       - |   698 | `	}` |
|       - |   699 | `	/* Reserve a new constant */` |
|   42086 |   700 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   42086 |   701 | `	if( pObj == 0 ){` |
...
|       - |   705 | `	}` |
|   42086 |   706 | `	PH7_MemObjInitFromString(pGen->pVm,pObj,0);` |
|       - |   707 | `	/* Compile the node */` |
|   42126 |   708 | `	for(;;){` |
|   84254 |   709 | `		if( zIn >= zEnd ){` |
|       - |   710 | `			/* End of input */` |
|   42086 |   711 | `			break;` |
|       - |   712 | `		}` |
|   42170 |   713 | `		zCur = zIn;` |
|  663980 |   714 | `		while( zIn < zEnd && zIn[0] != '\\' ){` |
|  621812 |   715 | `			zIn++;` |
|       2 |   716 | `		}` |
|   42170 |   717 | `		if( zIn > zCur ){` |
|       - |   718 | `			/* Append raw contents*/` |
|   42150 |   719 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|   21074 |   720 | `		}` |
|   42170 |   721 | `		zIn++;` |
|   42170 |   722 | `		if( zIn < zEnd ){` |
|     105 |   723 | `			if( zIn[0] == '\\' ){` |
...
|   42086 |   740 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   42086 |   741 | `	if( pStr->nByte < 1024 ){` |
|       - |   742 | `		/* Install in the literal table */` |
|   42086 |   743 | `		GenStateInstallLiteral(pGen,pObj,nIdx);` |
|   21042 |   744 | `	}` |
|       - |   745 | `	/* Node successfully compiled */` |
|   42086 |   746 | `	return SXRET_OK;` |
|   38060 |   747 |  |
|       - |   748 | `/*` |
...
|       - |   912 | ` */` |
|    1960 |   913 | `static sxi32 GenStateProcessStringExpression(` |
...
|    1962 |   924 | `	SySetInit(&sToken,&pGen->pVm->sAllocator,sizeof(SyToken));` |
|       - |   925 | `	/* Preallocate some slots */` |
|    1962 |   926 | `	SySetAlloc(&sToken,0x08);` |
|       - |   927 | `	/* Tokenize the text */` |
|    1962 |   928 | `	PH7_TokenizePHP(zIn,(sxu32)(zEnd-zIn),nLine,&sToken);` |
|       - |   929 | `	/* Swap delimiter */` |
|    1962 |   930 | `	pTmpIn  = pGen->pIn;` |
|    1962 |   931 | `	pTmpEnd = pGen->pEnd;` |
|    1962 |   932 | `	pGen->pIn = (SyToken *)SySetBasePtr(&sToken);` |
|    1962 |   933 | `	pGen->pEnd = &pGen->pIn[SySetUsed(&sToken)];` |
|       - |   934 | `	/* Compile the expression */` |
|    1962 |   935 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|       - |   936 | `	/* Restore token stream */` |
|    1962 |   937 | `	pGen->pIn  = pTmpIn;` |
|    1962 |   938 | `	pGen->pEnd = pTmpEnd;` |
|       - |   939 | `	/* Release the token set */` |
|    1962 |   940 | `	SySetRelease(&sToken);` |
...
|       - |   946 | ` */` |
|   19796 |   947 | `static ph7_value * GenStateNewStrObj(ph7_gen_state *pGen,sxi32 *pCount)` |
|       2 |   948 |  |
|       - |   949 | `	ph7_value *pConstObj;` |
|   19798 |   950 | `	sxu32 nIdx = 0;` |
|       - |   951 | `	/* Reserve a new constant */` |
|   19798 |   952 | `	pConstObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   19798 |   953 | `	if( pConstObj == 0 ){` |
|     ! 0 |   954 | `		PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"PH7 engine is running out of memory");` |
|     ! 0 |   955 | `		return 0;` |
|       - |   956 | `	}` |
|   19798 |   957 | `	(*pCount)++;` |
|   19798 |   958 | `	PH7_MemObjInitFromString(pGen->pVm,pConstObj,0);` |
|       - |   959 | `	/* Emit the load constant instruction */` |
|   19798 |   960 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   19798 |   961 | `	return pConstObj;` |
|    9900 |   962 |  |
|       - |   963 | `/*` |
...
|       - |  1000 | ` */` |
|   18430 |  1001 | `static sxi32 GenStateCompileString(ph7_gen_state *pGen)` |
|       2 |  1002 |  |
|   18432 |  1003 | `	SyString *pStr = &pGen->pIn->sData; /* Raw token value */` |
|       - |  1004 | `	const char *zIn,*zCur,*zEnd;` |
|   18432 |  1005 | `	ph7_value *pObj = 0;` |
|       - |  1006 | `	sxi32 iCons;` |
|       - |  1007 | `	sxi32 rc;` |
|       - |  1008 | `	/* Delimit the string */` |
|   18432 |  1009 | `	zIn  = pStr->zString;` |
|   18432 |  1010 | `	zEnd = &zIn[pStr->nByte];` |
|   18432 |  1011 | `	if( zIn >= zEnd ){` |
...
|       - |  1015 | `		 */` |
|     264 |  1016 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,pGen->pVm->nEmptyStringIdx,0,0);` |
|     264 |  1017 | `		return SXRET_OK;` |
|       - |  1018 | `	}` |
|   18170 |  1019 | `	zCur = 0;` |
...
|   10064 |  1022 | `	for(;;){` |
|   30470 |  1023 | `		zCur = zIn;` |
|  151378 |  1024 | `		while( zIn < zEnd && zIn[0] != '\\'  ){` |
|  122870 |  1025 | `			if( zIn[0] == '{' && &zIn[1] < zEnd && zIn[1] == '$' ){` |
|      63 |  1026 | `				break;` |
|  122750 |  1027 | `			}else if(zIn[0] == '$' && &zIn[1] < zEnd &&` |
|    1842 |  1028 | `				(((unsigned char)zIn[1] >= 0xc0 \|\| SyisAlpha(zIn[1]) \|\| zIn[1] == '{' \|\| zIn[1] == '_')) ){` |
|     921 |  1029 | `					break;` |
|       - |  1030 | `			}` |
|  120910 |  1031 | `			zIn++;` |
|       2 |  1032 | `		}` |
|   30470 |  1033 | `		if( zIn > zCur ){` |
|   13792 |  1034 | `			if( pObj == 0 ){` |
|   13480 |  1035 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|   13480 |  1036 | `				if( pObj == 0 ){` |
|     ! 0 |  1037 | `					return SXERR_ABORT;` |
|       - |  1038 | `				}` |
|    6739 |  1039 | `			}` |
|   13792 |  1040 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|    6895 |  1041 | `		}` |
|   30470 |  1042 | `		if( zIn >= zEnd ){` |
|   18170 |  1043 | `			break;` |
|       - |  1044 | `		}` |
|   12302 |  1045 | `		if( zIn[0] == '\\' ){` |
|   10342 |  1046 | `			const char *zPtr = 0;` |
|       - |  1047 | `			sxu32 n;` |
|   10342 |  1048 | `			zIn++;` |
|   10342 |  1049 | `			if( zIn >= zEnd ){` |
|     ! 0 |  1050 | `				break;` |
|       - |  1051 | `			}` |
|   10342 |  1052 | `			if( pObj == 0 ){` |
|    6320 |  1053 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|    6320 |  1054 | `				if( pObj == 0 ){` |
|     ! 0 |  1055 | `					return SXERR_ABORT;` |
|       - |  1056 | `				}` |
|    3159 |  1057 | `			}` |
|   10342 |  1058 | `			n = sizeof(char); /* size of conversion */` |
|   10342 |  1059 | `			switch( zIn[0] ){` |
|       3 |  1060 | `			case '$':` |
|       - |  1061 | `				/* Dollar sign */` |
...
|    9548 |  1082 | `				PH7_MemObjStringAppend(pObj,"\n",sizeof(char));` |
|    9548 |  1083 | `				break;` |
|      19 |  1084 | `			case 'r':` |
...
|      13 |  1107 | `				break;` |
|     219 |  1108 | `			case 'x':` |
|     439 |  1109 | `				if((unsigned char)zIn[1] < 0xc0 && SyisHex(zIn[1]) ){` |
|       - |  1110 | `					int c;` |
|       - |  1111 | `					/* Hex digit */` |
|     425 |  1112 | `					c = SyHexToint(zIn[1]) << 4;` |
|     425 |  1113 | `					if( &zIn[2] < zEnd ){` |
|     425 |  1114 | `						c +=  SyHexToint(zIn[2]);` |
|     212 |  1115 | `					}` |
|       - |  1116 | `					/* Output char */` |
|     425 |  1117 | `					PH7_MemObjStringAppend(pObj,(const char *)&c,sizeof(char));` |
|     425 |  1118 | `					n += sizeof(char) * 2;` |
|     213 |  1119 | `				}else{` |
...
|      63 |  1186 | `		}else{` |
|       - |  1187 | `			/* Simple syntax */` |
|    1840 |  1188 | `			const char *zExpr = zIn;` |
|       - |  1189 | `			/* Assemble variable name */` |
|     925 |  1190 | `			for(;;){` |
|       - |  1191 | `				/* Jump leading dollars */` |
|    3690 |  1192 | `				while( zIn < zEnd && zIn[0] == '$' ){` |
|    1840 |  1193 | `					zIn++;` |
|       2 |  1194 | `				}` |
|     925 |  1195 | `				for(;;){` |
|   10825 |  1196 | `					while( zIn < zEnd && (unsigned char)zIn[0] < 0xc0 && (SyisAlphaNum(zIn[0]) \|\| zIn[0] == '_' ) ){` |
|    8050 |  1197 | `						zIn++;` |
|       2 |  1198 | `					}` |
|    1852 |  1199 | `					if((unsigned char)zIn[0] >= 0xc0 ){` |
|       - |  1200 | `						/* UTF-8 stream */` |
|     ! 0 |  1201 | `						zIn++;` |
...
|       1 |  1246 | `					}` |
|       6 |  1247 | `					break;` |
|    1720 |  1248 | `				}else if( zIn[0] == '-' && &zIn[1] < zEnd && zIn[1] == '>' ){` |
|       - |  1249 | `					/* Member access operator '->' */` |
|      13 |  1250 | `					zIn += 2;` |
|    1714 |  1251 | `				}else if(zIn[0] == ':' && &zIn[1] < zEnd && zIn[1] == ':'){` |
...
|    1840 |  1259 | `			rc = GenStateProcessStringExpression(&(*pGen),pGen->pIn->nLine,zExpr,zIn);` |
|    1840 |  1260 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  1261 | `				return SXERR_ABORT;` |
|       - |  1262 | `			}` |
|    1840 |  1263 | `			if( rc != SXERR_EMPTY ){` |
|    1838 |  1264 | `				++iCons;` |
|     918 |  1265 | `			}` |
|       - |  1266 | `		}` |
...
|    1962 |  1268 | `		pObj = 0;` |
|       2 |  1269 | `	}/*for(;;)*/` |
|   18170 |  1270 | `	if( iCons > 1 ){` |
|       - |  1271 | `		/* Concatenate all compiled constants */` |
|    1450 |  1272 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_CAT,iCons,0,0,0);` |
|     724 |  1273 | `	}` |
|       - |  1274 | `	/* Node successfully compiled */` |
|   18170 |  1275 | `	return SXRET_OK;` |
|    9217 |  1276 |  |
|       - |  1277 | `/*` |
|       - |  1278 | ` * Compile a double quoted string.` |
|       - |  1279 | ` *  See the block-comment above for more information.` |
|       - |  1280 | ` */` |
|   18370 |  1281 | `PH7_PRIVATE sxi32 PH7_CompileString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       2 |  1282 |  |
|       - |  1283 | `	sxi32 rc;` |
|   18372 |  1284 | `	rc = GenStateCompileString(&(*pGen));` |
|    9185 |  1285 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|       - |  1286 | `	/* Compilation result */` |
|   18372 |  1287 | `	return rc;` |
|       2 |  1288 |  |
|       - |  1289 | `/*` |
...
|       - |  1330 | ` */` |
|   17442 |  1331 | `static sxi32 GenStateCompileArrayEntry(` |
...
|   17444 |  1342 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|       - |  1343 | `	/* Compile the expression*/` |
|   17444 |  1344 | `	rc = PH7_CompileExpr(&(*pGen),iFlags,xValidator);` |
|       - |  1345 | `	/* Restore token stream */` |
|   17444 |  1346 | `	RE_SWAP_DELIMITER(pGen);` |
|   17444 |  1347 | `	return rc;` |
|       2 |  1348 |  |
|       - |  1349 | `/*` |
...
|       - |  1385 | ` */` |
|   26034 |  1386 | `static sxi32 GenStateCompileArrayBody(ph7_gen_state *pGen)` |
|       2 |  1387 |  |
|       - |  1388 | `	sxi32 (*xValidator)(ph7_gen_state *,ph7_expr_node *); /* Expression tree validator callback */` |
|       - |  1389 | `	SyToken *pKey,*pCur;` |
|   26036 |  1390 | `	sxi32 iEmitRef = 0;` |
|   26036 |  1391 | `	sxi32 nPair = 0;` |
|       - |  1392 | `	sxi32 iNest;` |
|       - |  1393 | `	sxi32 rc;` |
|   26036 |  1394 | `	xValidator = 0;` |
|   21071 |  1395 | `	for(;;){` |
|       - |  1396 | `		/* Jump leading commas */` |
|   47554 |  1397 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA) ){` |
|    5412 |  1398 | `			pGen->pIn++;` |
|       2 |  1399 | `		}` |
|   42144 |  1400 | `		pCur = pGen->pIn;` |
|   42144 |  1401 | `		if( SXRET_OK != PH7_GetNextExpr(pGen->pIn,pGen->pEnd,&pGen->pIn) ){` |
|       - |  1402 | `			/* No more entry to process */` |
|   26024 |  1403 | `			break;` |
|       - |  1404 | `		}` |
|   16122 |  1405 | `		if( pCur >= pGen->pIn ){` |
|     ! 0 |  1406 | `			continue;` |
|       - |  1407 | `		}` |
|       - |  1408 | `		/* Compile the key if available */` |
|   16122 |  1409 | `		pKey = pCur;` |
|   16122 |  1410 | `		iNest = 0;` |
|   44940 |  1411 | `		while( pCur < pGen->pIn ){` |
|   30040 |  1412 | `			if( (pCur->nType & PH7_TK_ARRAY_OP) && iNest <= 0 ){` |
|    1218 |  1413 | `				break;` |
|       - |  1414 | `			}` |
...
|       - |  1419 | `			 */` |
|   28824 |  1420 | `			if( iNest == 0 && (pCur->nType & PH7_TK_KEYWORD) ){` |
...
|       - |  1482 | `				}` |
|      34 |  1483 | `			}` |
|   28818 |  1484 | `			if( pCur->nType & PH7_TK_LPAREN /*'('*/ ){` |
|      86 |  1485 | `				iNest++;` |
|   28776 |  1486 | `			}else if( pCur->nType & PH7_TK_RPAREN /*')'*/ ){` |
...
|   28818 |  1492 | `			pCur++;` |
|       2 |  1493 | `		}` |
|   16122 |  1494 | `		rc = SXERR_EMPTY;` |
|   16122 |  1495 | `		if( pCur < pGen->pIn ){` |
...
|   14906 |  1517 | `			pCur = pKey;` |
|       - |  1518 | `		}` |
|   16112 |  1519 | `		if( rc == SXERR_EMPTY ){` |
|       - |  1520 | `			/* No available key,load NULL */` |
|   14908 |  1521 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,0 /* nil index */,0,0);` |
|    7453 |  1522 | `		}` |
|   16112 |  1523 | `		if( pCur->nType & PH7_TK_AMPER /*'&'*/){` |
...
|   16110 |  1538 | `		rc = GenStateCompileArrayEntry(&(*pGen),pCur,pGen->pIn,EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,xValidator);` |
|   16110 |  1539 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  1540 | `			return SXERR_ABORT;` |
|       - |  1541 | `		}` |
|   16110 |  1542 | `		if( iEmitRef ){` |
|       - |  1543 | `			/* Emit the load reference instruction */` |
|      32 |  1544 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_REF,0,0,0,0);` |
|      15 |  1545 | `		}` |
|   16110 |  1546 | `		xValidator = 0;` |
|   16110 |  1547 | `		iEmitRef = 0;` |
|   16110 |  1548 | `		nPair++;` |
|       2 |  1549 | `	}` |
|       - |  1550 | `	/* Emit the load map instruction */` |
|   26024 |  1551 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_MAP,nPair * 2,0,0,0);` |
|       - |  1552 | `	/* Node successfully compiled */` |
|   26024 |  1553 | `	return SXRET_OK;` |
|   13019 |  1554 |  |
|       - |  1555 | `/*` |
...
|       - |  1563 | ` */` |
|   25724 |  1564 | `PH7_PRIVATE sxi32 PH7_CompileArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       2 |  1565 |  |
|       - |  1566 | `	/* Jump the 'array' keyword and the leading '(', exclude trailing ')'. */` |
|   25726 |  1567 | `	pGen->pIn += 2;` |
|   25726 |  1568 | `	pGen->pEnd--;` |
|   12862 |  1569 | `	SXUNUSED(iCompileFlag);` |
|   25726 |  1570 | `	return GenStateCompileArrayBody(pGen);` |
|       2 |  1571 |  |
|       - |  1572 | `/*` |
...
|       - |  1576 | ` */` |
|     310 |  1577 | `PH7_PRIVATE sxi32 PH7_CompileShortArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       2 |  1578 |  |
|       - |  1579 | `	/* Jump the leading '[', exclude trailing ']'. */` |
|     312 |  1580 | `	pGen->pIn++;` |
|     312 |  1581 | `	pGen->pEnd--;` |
|     155 |  1582 | `	SXUNUSED(iCompileFlag);` |
|     312 |  1583 | `	return GenStateCompileArrayBody(pGen);` |
|       2 |  1584 |  |
|       - |  1585 | `/*` |
...
|       - |  1791 | ` */` |
|     186 |  1792 | `PH7_PRIVATE sxi32 PH7_CompileAnnonFunc(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       2 |  1793 |  |
...
|       - |  1803 | `	sxi32 rc;` |
|       - |  1804 |  |
|     188 |  1805 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|     188 |  1806 | `	if( pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD) ){` |
|     ! 0 |  1807 | `		pGen->pIn++;` |
|     ! 0 |  1808 | `	}` |
|       - |  1809 | `	/* Reserve a constant for the lambda */` |
|     188 |  1810 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|     188 |  1811 | `	if( pObj == 0 ){` |
...
|     188 |  1817 | `	nLen = SyBufferFormat(zName,sizeof(zName),"[lambda_%d]",iCnt++);` |
|       - |  1818 | `	/* Make sure the generated name is unique */` |
|     188 |  1819 | `	while( SyHashGet(&pGen->pVm->hFunction,zName,nLen) != 0 && nLen < sizeof(zName) - 2 ){` |
|     ! 0 |  1820 | `		nLen = SyBufferFormat(zName,sizeof(zName),"[lambda_%d]",iCnt++);` |
|     ! 0 |  1821 | `	}` |
|     188 |  1822 | `	SyStringInitFromBuf(&sName,zName,nLen);` |
|     188 |  1823 | `	PH7_MemObjInitFromString(pGen->pVm,pObj,&sName);` |
|       - |  1824 | `	/* Compile the lambda body */` |
|     188 |  1825 | `	rc = GenStateCompileFunc(&(*pGen),&sName,0,TRUE,&pAnnonFunc);` |
|     188 |  1826 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  1827 | `		return SXERR_ABORT;` |
|       - |  1828 | `	}` |
|     188 |  1829 | `	if( pAnnonFunc->iFlags & VM_FUNC_CLOSURE ){` |
|       - |  1830 | `		/* Emit the load closure instruction */` |
|      18 |  1831 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_CLOSURE,0,0,pAnnonFunc,0);` |
|      10 |  1832 | `	}else{` |
|       - |  1833 | `		/* Emit the load constant instruction */` |
|     172 |  1834 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|       - |  1835 | `	}` |
|       - |  1836 | `	/* Node successfully compiled */` |
|     188 |  1837 | `	return SXRET_OK;` |
|      95 |  1838 |  |
|       - |  1839 | `/*` |
...
|       - |  1843 | ` */` |
|     124 |  1844 | `static sxi32 GenStateArrowAddCapture(` |
...
|       - |  1858 | `	}` |
|     124 |  1859 | `	if( nByte == sizeof("this")-1` |
|      68 |  1860 | `		&& SyMemcmp(zName,"this",sizeof("this")-1) == 0 ){` |
|       3 |  1861 | `		return SXRET_OK;` |
|       - |  1862 | `	}` |
|     150 |  1863 | `	for( n = 0 ; n < nShadow ; n++ ){` |
|      96 |  1864 | `		if( SyStringLength(&aShadow[n]) == nByte` |
|      93 |  1865 | `			&& SyMemcmp(SyStringData(&aShadow[n]),zName,nByte) == 0 ){` |
|      72 |  1866 | `			return SXRET_OK;` |
|       - |  1867 | `		}` |
|      14 |  1868 | `	}` |
...
|       - |  1955 | ` */` |
|     106 |  1956 | `static sxi32 GenStateArrowCaptureScan(` |
...
|       - |  1962 | `	sxu32 nShadow)` |
|       2 |  1963 |  |
|     108 |  1964 | `	SyToken *pScan = pStart;` |
|       - |  1965 | `	sxi32 rc;` |
|     398 |  1966 | `	while( pScan < pEnd ){` |
|     292 |  1967 | `		if( pScan->nType & (PH7_TK_DSTR\|PH7_TK_HEREDOC) ){` |
...
|      15 |  1976 | `			continue;` |
|       - |  1977 | `		}` |
|     278 |  1978 | `		if( pScan->nType & PH7_TK_KEYWORD ){` |
...
|       - |  2128 | `			}` |
|       1 |  2129 | `		}` |
|     260 |  2130 | `		if( (pScan->nType & PH7_TK_DOLLAR) == 0 ){` |
|     148 |  2131 | `			pScan++;` |
|     148 |  2132 | `			continue;` |
|       - |  2133 | `		}` |
|       - |  2134 | `		{` |
|       - |  2135 | `			/* Walk past variable-variable chains ($$x) to the base name. */` |
|     114 |  2136 | `			SyToken *pDollar = pScan;` |
|     168 |  2137 | `			while( &pDollar[1] < pEnd` |
|     114 |  2138 | `				&& (pDollar[1].nType & PH7_TK_DOLLAR) ){` |
|     ! 0 |  2139 | `				pDollar++;` |
|     ! 0 |  2140 | `			}` |
|     114 |  2141 | `			if( &pDollar[1] >= pEnd ){` |
|     ! 0 |  2142 | `				break;` |
|       - |  2143 | `			}` |
|     114 |  2144 | `			if( (pDollar[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|     ! 0 |  2145 | `				pScan = pDollar + 1;` |
|     ! 0 |  2146 | `				continue;` |
|       - |  2147 | `			}` |
|     170 |  2148 | `			rc = GenStateArrowAddCapture(pGen,pFunc,` |
|     112 |  2149 | `				pDollar[1].sData.zString,pDollar[1].sData.nByte,` |
|      56 |  2150 | `				aShadow,nShadow);` |
|     114 |  2151 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  2152 | `				return SXERR_ABORT;` |
|       - |  2153 | `			}` |
|     114 |  2154 | `			pScan = pDollar + 2;` |
|       - |  2155 | `		}` |
|       2 |  2156 | `	}` |
|     108 |  2157 | `	return SXRET_OK;` |
|      55 |  2158 |  |
|       - |  2159 | `/*` |
...
|       - |  2165 | ` */` |
|      88 |  2166 | `PH7_PRIVATE sxi32 PH7_CompileArrowFunc(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       2 |  2167 |  |
...
|       - |  2180 | `	sxu32 nLen;` |
|       - |  2181 | `	sxu32 nLine;` |
|      90 |  2182 | `	sxi32 iFlags = 0;` |
|      90 |  2183 | `	int bStatic = 0;` |
|       - |  2184 | `	sxi32 rc;` |
|       - |  2185 | `	sxu32 n;` |
|      44 |  2186 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|       - |  2187 |  |
|      90 |  2188 | `	nLine = pGen->pIn->nLine;` |
|       - |  2189 | `	/* Optional 'static' prefix */` |
|      88 |  2190 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD)` |
|      90 |  2191 | `		&& SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_STATIC ){` |
|       3 |  2192 | `		bStatic = 1;` |
|       3 |  2193 | `		pGen->pIn++;` |
|       1 |  2194 | `	}` |
|       - |  2195 | `	/* 'fn' keyword (guaranteed by ExprExtractNode's dispatch) */` |
|      88 |  2196 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0` |
|      90 |  2197 | `		\|\| SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_FN ){` |
|     ! 0 |  2198 | `		PH7_GenCompileError(&(*pGen),E_ERROR,nLine,` |
|       - |  2199 | `			"Arrow function: expected 'fn' keyword");` |
|     ! 0 |  2200 | `		return SXERR_SYNTAX;` |
|       - |  2201 | `	}` |
|      90 |  2202 | `	pGen->pIn++; /* Jump 'fn' */` |
|       - |  2203 | `	/* Optional '&' — return by reference */` |
|      90 |  2204 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|     ! 0 |  2205 | `		iFlags \|= VM_FUNC_REF_RETURN;` |
|     ! 0 |  2206 | `		pGen->pIn++;` |
|     ! 0 |  2207 | `	}` |
|       - |  2208 | `	/* Expect '(' */` |
|      90 |  2209 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
...
|       - |  2219 | `	}` |
|      88 |  2220 | `	pGen->pIn++; /* Jump '(' */` |
|       - |  2221 | `	/* Delimit the parameter list */` |
|      88 |  2222 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN,PH7_TK_RPAREN,&pSigEnd);` |
|      88 |  2223 | `	if( pSigEnd >= pGen->pEnd ){` |
...
|      86 |  2229 | `	pFunc = (ph7_vm_func *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_vm_func));` |
|      86 |  2230 | `	if( pFunc == 0 ){` |
...
|      86 |  2236 | `	nLen = SyBufferFormat(zName,sizeof(zName),"[lambda_%d]",iCnt++);` |
|     178 |  2237 | `	while( SyHashGet(&pGen->pVm->hFunction,zName,nLen) != 0 && nLen < sizeof(zName) - 2 ){` |
|      94 |  2238 | `		nLen = SyBufferFormat(zName,sizeof(zName),"[lambda_%d]",iCnt++);` |
|       2 |  2239 | `	}` |
|      86 |  2240 | `	zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,zName,nLen);` |
|      86 |  2241 | `	if( zDup == 0 ){` |
|     ! 0 |  2242 | `		PH7_GenCompileError(&(*pGen),E_ERROR,nLine,` |
|       - |  2243 | `			"Fatal, PH7 engine is running out of memory");` |
|     ! 0 |  2244 | `		return SXERR_ABORT;` |
|       - |  2245 | `	}` |
|      86 |  2246 | `	PH7_VmInitFuncState(pGen->pVm,pFunc,zDup,nLen,iFlags,0);` |
|       - |  2247 | `	/* Collect function arguments */` |
|      86 |  2248 | `	if( pGen->pIn < pSigEnd ){` |
|      56 |  2249 | `		rc = GenStateCollectFuncArgs(pFunc,&(*pGen),pSigEnd,0,0);` |
|      56 |  2250 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  2251 | `			return SXERR_ABORT;` |
|       - |  2252 | `		}` |
|      27 |  2253 | `	}` |
|       - |  2254 | `	/* Point past ')' and parse optional return type */` |
|      86 |  2255 | `	pGen->pIn = &pSigEnd[1];` |
|      86 |  2256 | `	rc = GenStateParseReturnType(pGen,pFunc);` |
|      86 |  2257 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  2258 | `		return SXERR_ABORT;` |
|      86 |  2259 | `	}else if( rc == SXERR_SYNTAX ){` |
|     ! 0 |  2260 | `		return SXERR_SYNTAX;` |
|       - |  2261 | `	}` |
|       - |  2262 | `	/* Expect '=>' */` |
|      86 |  2263 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ARRAY_OP) == 0 ){` |
...
|       - |  2273 | `	}` |
|      84 |  2274 | `	pGen->pIn++; /* Jump '=>' */` |
|      84 |  2275 | `	pBodyStart = pGen->pIn;` |
|      84 |  2276 | `	pBodyEnd = pGen->pEnd;` |
...
|      84 |  2281 | `	aArgs = (ph7_vm_func_arg *)SySetBasePtr(&pFunc->aArgs);` |
|       - |  2282 | `	{` |
|      84 |  2283 | `		SyString *aShadow = 0;` |
|      84 |  2284 | `		sxu32 nShadow = SySetUsed(&pFunc->aArgs);` |
|      84 |  2285 | `		if( nShadow > 0 ){` |
|      54 |  2286 | `			aShadow = (SyString *)SyMemBackendPoolAlloc(` |
|      52 |  2287 | `				&pGen->pVm->sAllocator,sizeof(SyString) * nShadow);` |
|      54 |  2288 | `			if( aShadow == 0 ){` |
|     ! 0 |  2289 | `				PH7_GenCompileError(&(*pGen),E_ERROR,nLine,` |
|       - |  2290 | `					"Fatal, PH7 engine is running out of memory");` |
|     ! 0 |  2291 | `				return SXERR_ABORT;` |
|       - |  2292 | `			}` |
|     112 |  2293 | `			for( n = 0 ; n < nShadow ; n++ ){` |
|      60 |  2294 | `				aShadow[n] = aArgs[n].sName;` |
|      31 |  2295 | `			}` |
|      26 |  2296 | `		}` |
|     125 |  2297 | `		rc = GenStateArrowCaptureScan(pGen,pFunc,pBodyStart,pBodyEnd,` |
|      41 |  2298 | `			aShadow,nShadow);` |
|      84 |  2299 | `		if( rc == SXERR_ABORT ){` |
...
|      84 |  2307 | `	if( !bStatic ){` |
|       - |  2308 | `		char *zThisDup;` |
|      82 |  2309 | `		zThisDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,"this",sizeof("this")-1);` |
|      82 |  2310 | `		if( zThisDup == 0 ){` |
|     ! 0 |  2311 | `			PH7_GenCompileError(&(*pGen),E_ERROR,nLine,` |
|       - |  2312 | `				"Fatal, PH7 engine is running out of memory");` |
|     ! 0 |  2313 | `			return SXERR_ABORT;` |
|       - |  2314 | `		}` |
|      82 |  2315 | `		SyZero(&sEnv,sizeof(ph7_vm_func_closure_env));` |
|      82 |  2316 | `		sEnv.iFlags = VM_FUNC_ARG_IGNORE;` |
|      82 |  2317 | `		PH7_MemObjInit(pGen->pVm,&sEnv.sValue);` |
|      82 |  2318 | `		SyStringInitFromBuf(&sEnv.sName,zThisDup,sizeof("this")-1);` |
|      82 |  2319 | `		SySetPut(&pFunc->aClosureEnv,(const void *)&sEnv);` |
|      40 |  2320 | `	}` |
|       - |  2321 | `	/* Arrow functions are always closures */` |
|      84 |  2322 | `	pFunc->iFlags \|= VM_FUNC_CLOSURE;` |
|       - |  2323 | `	/* Compile the body expression as an implicit return */` |
|     125 |  2324 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC,` |
|      41 |  2325 | `		PH7_VmInstrLength(pGen->pVm),pFunc,&pBlock);` |
|      84 |  2326 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  2327 | `		PH7_GenCompileError(&(*pGen),E_ERROR,nLine,` |
|       - |  2328 | `			"PH7 engine is running out-of-memory");` |
|     ! 0 |  2329 | `		return SXERR_ABORT;` |
|       - |  2330 | `	}` |
|      84 |  2331 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|      84 |  2332 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pFunc->aByteCode);` |
|      84 |  2333 | `	pSavedEnd = pGen->pEnd;` |
|      84 |  2334 | `	pGen->pIn = pBodyStart;` |
|      84 |  2335 | `	pGen->pEnd = pBodyEnd;` |
|      84 |  2336 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|      84 |  2337 | `	if( rc == SXERR_ABORT ){` |
...
|      84 |  2344 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,(rc != SXERR_EMPTY ? 1 : 0),0,0,0);` |
|      84 |  2345 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|      84 |  2346 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|      84 |  2347 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|      84 |  2348 | `	GenStateLeaveBlock(&(*pGen),0);` |
|       - |  2349 | `	/* Restore cursors; caller will re-synchronize via the node's pEnd */` |
|      84 |  2350 | `	pGen->pIn = pBodyEnd;` |
|      84 |  2351 | `	pGen->pEnd = pSavedEnd;` |
|       - |  2352 | `	/* Emit the load-closure instruction */` |
|      84 |  2353 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_CLOSURE,0,0,pFunc,0);` |
|      84 |  2354 | `	return SXRET_OK;` |
|      46 |  2355 |  |
|       - |  2356 | `/*` |
...
|       - |  2710 | ` */` |
|  937068 |  2711 | `PH7_PRIVATE sxi32 PH7_CompileVariable(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       2 |  2712 |  |
|  937070 |  2713 | `	sxu32 nLineLocal = pGen->pIn->nLine;` |
|       - |  2714 | `	sxi32 iVv;` |
|       - |  2715 | `	sxi32 iP1;` |
|       - |  2716 | `	void *p3;` |
|       - |  2717 | `	sxi32 rc;` |
|  937070 |  2718 | `	iVv = -1; /* Variable variable counter */` |
| 1874150 |  2719 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) ){` |
|  937082 |  2720 | `		pGen->pIn++;` |
|  937082 |  2721 | `		iVv++;` |
|       2 |  2722 | `	}` |
|  937070 |  2723 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_OCB/*'{'*/)) == 0 ){` |
...
|       - |  2731 | `	}` |
|  937070 |  2732 | `	p3  = 0;` |
|  937070 |  2733 | `	if( pGen->pIn->nType & PH7_TK_OCB/*'{'*/ ){` |
...
|       - |  2752 | `		SyString *pName;` |
|  937054 |  2753 | `		char *zName = 0;` |
|       - |  2754 | `		/* Extract variable name */` |
|  937054 |  2755 | `		pName = &pGen->pIn->sData;` |
|       - |  2756 | `		/* Advance the stream cursor */` |
|  937054 |  2757 | `		pGen->pIn++;` |
|  937054 |  2758 | `		pEntry = SyHashGet(&pGen->hVar,(const void *)pName->zString,pName->nByte);` |
|  937054 |  2759 | `		if( pEntry == 0 ){` |
|       - |  2760 | `			/* Duplicate name */` |
|  125752 |  2761 | `			zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|  125752 |  2762 | `			if( zName == 0 ){` |
...
|  125752 |  2767 | `			SyHashInsert(&pGen->hVar,zName,pName->nByte,zName);` |
|   62877 |  2768 | `		}else{` |
|       - |  2769 | `			/* Name already available */` |
|  811304 |  2770 | `			zName = (char *)pEntry->pUserData;` |
|       - |  2771 | `		}` |
|  937054 |  2772 | `		p3 = (void *)zName;` |
|       - |  2773 | `	}` |
|  937066 |  2774 | `	iP1 = 0;` |
|  937066 |  2775 | `	if( iCompileFlag & EXPR_FLAG_RDONLY_LOAD ){` |
|  341528 |  2776 | `		if( (iCompileFlag & EXPR_FLAG_LOAD_IDX_STORE) == 0 ){` |
|       - |  2777 | `			/* Read-only load.In other words do not create the variable if inexistant */` |
|  335032 |  2778 | `			iP1 = 1;` |
|  167515 |  2779 | `		}` |
|  170763 |  2780 | `	}` |
|       - |  2781 | `	/* Emit the load instruction */` |
|  937066 |  2782 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,0,p3,0);` |
|  937078 |  2783 | `	while( iVv > 0 ){` |
|      13 |  2784 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,0,0,0);` |
|      13 |  2785 | `		iVv--;` |
|       1 |  2786 | `	}` |
|       - |  2787 | `	/* Node successfully compiled */` |
|  937066 |  2788 | `	return SXRET_OK;` |
|  468536 |  2789 |  |
|       - |  2790 | `/*` |
|       - |  2791 | ` * Load a literal.` |
|       - |  2792 | ` */` |
|  658810 |  2793 | `static sxi32 GenStateLoadLiteral(ph7_gen_state *pGen)` |
|       2 |  2794 |  |
|  658812 |  2795 | `	SyToken *pToken = pGen->pIn;` |
|       - |  2796 | `	ph7_value *pObj;` |
|       - |  2797 | `	SyString *pStr;` |
|       - |  2798 | `	sxu32 nIdx;` |
|       - |  2799 | `	/* Extract token value */` |
|  658812 |  2800 | `	pStr = &pToken->sData;` |
|       - |  2801 | `	/* Deal with the reserved literals [i.e: null,false,true,...] first */` |
|  658812 |  2802 | `	if( pStr->nByte == sizeof("NULL") - 1 ){` |
|  139616 |  2803 | `		if( SyStrnicmp(pStr->zString,"null",sizeof("NULL")-1) == 0 ){` |
|       - |  2804 | `			/* NULL constant are always indexed at 0 */` |
|   51428 |  2805 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,0,0,0);` |
|   51428 |  2806 | `			return SXRET_OK;` |
|   88190 |  2807 | `		}else if( SyStrnicmp(pStr->zString,"true",sizeof("TRUE")-1) == 0 ){` |
|       - |  2808 | `			/* TRUE constant are always indexed at 1 */` |
|     544 |  2809 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,1,0,0);` |
|     544 |  2810 | `			return SXRET_OK;` |
|       2 |  2811 | `		}` |
|  615249 |  2812 | `	}else if (pStr->nByte == sizeof("FALSE") - 1 &&` |
|  104456 |  2813 | `		SyStrnicmp(pStr->zString,"false",sizeof("FALSE")-1) == 0 ){` |
|       - |  2814 | `			/* FALSE constant are always indexed at 2 */` |
|   39498 |  2815 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,2,0,0);` |
|   39498 |  2816 | `			return SXRET_OK;` |
|  526560 |  2817 | `	}else if(pStr->nByte == sizeof("__LINE__") - 1 &&` |
|   93716 |  2818 | `		SyMemcmp(pStr->zString,"__LINE__",sizeof("__LINE__")-1) == 0 ){` |
|       - |  2819 | `			/* TICKET 1433-004: __LINE__ constant must be resolved at compile time,not run time */` |
|    8980 |  2820 | `			pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|    8980 |  2821 | `			if( pObj == 0 ){` |
|     ! 0 |  2822 | `				PH7_GenCompileError(pGen,E_ERROR,pToken->nLine,"Fatal, PH7 engine is running out of memory");` |
|     ! 0 |  2823 | `				return SXERR_ABORT;` |
|       - |  2824 | `			}` |
|    8980 |  2825 | `			PH7_MemObjInitFromInt(pGen->pVm,pObj,pToken->nLine);` |
|       - |  2826 | `			/* Emit the load constant instruction */` |
|    8980 |  2827 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|    8980 |  2828 | `			return SXRET_OK;` |
|  485858 |  2829 | `	}else if( pStr->nByte == sizeof("__NAMESPACE__") - 1 &&` |
|   30268 |  2830 | `		SyMemcmp(pStr->zString,"__NAMESPACE__",sizeof("__NAMESPACE__")-1) == 0 ){` |
...
|  485001 |  2846 | `	}else if( (pStr->nByte == sizeof("__FUNCTION__") - 1 &&` |
|   12672 |  2847 | `		SyMemcmp(pStr->zString,"__FUNCTION__",sizeof("__FUNCTION__")-1) == 0) \|\|` |
|  478659 |  2848 | `		(pStr->nByte == sizeof("__METHOD__") - 1 &&` |
|   15900 |  2849 | `		SyMemcmp(pStr->zString,"__METHOD__",sizeof("__METHOD__")-1) == 0) ){` |
...
|  558354 |  2879 | `	if( SXRET_OK != GenStateFindLiteral(&(*pGen),&pToken->sData,&nIdx) ){` |
|       - |  2880 | `		ph7_value *pLitObj;` |
|       - |  2881 | `		/* Unknown literal,install it in the literal table */` |
|  231840 |  2882 | `		pLitObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  231840 |  2883 | `		if( pLitObj == 0 ){` |
|     ! 0 |  2884 | `			PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|     ! 0 |  2885 | `			return SXERR_ABORT;` |
|       - |  2886 | `		}` |
|  231840 |  2887 | `		PH7_MemObjInitFromString(pGen->pVm,pLitObj,&pToken->sData);` |
|  231840 |  2888 | `		GenStateInstallLiteral(&(*pGen),pLitObj,nIdx);` |
|  115919 |  2889 | `	}` |
|       - |  2890 | `	/* Emit the load constant instruction */` |
|  558354 |  2891 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,1,nIdx,0,0);` |
|  558354 |  2892 | `	return SXRET_OK;` |
|  329407 |  2893 |  |
|       - |  2894 | `/*` |
...
|       - |  2899 | ` */` |
|  658844 |  2900 | `static sxi32 GenStateResolveNamespaceLiteral(ph7_gen_state *pGen)` |
|       2 |  2901 |  |
|       - |  2902 | `	sxi32 rc;` |
|  658846 |  2903 | `	if( pGen->pIn >= pGen->pEnd ){` |
|     ! 0 |  2904 | `		return SXRET_OK;` |
|       - |  2905 | `	}` |
|       - |  2906 | `	/* Check if this is a multi-token namespace path */` |
|  658846 |  2907 | `	if( pGen->pIn < &pGen->pEnd[-1] ){` |
...
|  658812 |  2960 | `	rc = GenStateLoadLiteral(&(*pGen));` |
|  658812 |  2961 | `	return rc;` |
|  329424 |  2962 |  |
|       - |  2963 | `/*` |
|       - |  2964 | ` * Compile a literal which is an identifier(name) for a simple value.` |
|       - |  2965 | ` */` |
|  658844 |  2966 | `PH7_PRIVATE sxi32 PH7_CompileLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       2 |  2967 |  |
|       - |  2968 | `	sxi32 rc;` |
|  658846 |  2969 | `	rc = GenStateResolveNamespaceLiteral(&(*pGen));` |
|  658846 |  2970 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  2971 | `		SXUNUSED(iCompileFlag); /* cc warning */` |
|     ! 0 |  2972 | `		return rc;` |
|       - |  2973 | `	}` |
|       - |  2974 | `	/* Node successfully compiled */` |
|  658846 |  2975 | `	return SXRET_OK;` |
|  329424 |  2976 |  |
|       - |  2977 | `/*` |
...
|       - |  3135 | ` */` |
|    3128 |  3136 | `static void GenStateEmitExceptionPopForBreak(ph7_gen_state *pGen,GenBlock *pTarget)` |
|       2 |  3137 |  |
|    3130 |  3138 | `	GenBlock *pBlock = pGen->pCurrent;` |
|   18298 |  3139 | `	while( pBlock && pBlock != pTarget ){` |
|   15170 |  3140 | `		if( pBlock->iFlags & GEN_BLOCK_EXCEPTION ){` |
...
|       - |  3150 | `			}` |
|       1 |  3151 | `		}` |
|   15170 |  3152 | `		pBlock = pBlock->pParent;` |
|       2 |  3153 | `	}` |
|    3130 |  3154 |  |
|    3036 |  3155 | `static sxi32 PH7_CompileContinue(ph7_gen_state *pGen)` |
|       2 |  3156 |  |
|       - |  3157 | `	GenBlock *pLoop; /* Target loop */` |
|       - |  3158 | `	sxi32 iLevel;    /* How many nesting loop to skip */` |
|       - |  3159 | `	sxu32 nLineLocal;` |
|       - |  3160 | `	sxi32 rc;` |
|    3038 |  3161 | `	nLineLocal = pGen->pIn->nLine;` |
|    3038 |  3162 | `	iLevel = 0;` |
|       - |  3163 | `	/* Jump the 'continue' keyword */` |
|    3038 |  3164 | `	pGen->pIn++;` |
|    3038 |  3165 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NUM) ){` |
...
|    3038 |  3191 | `	pLoop = GenStateFetchBlock(pGen->pCurrent,GEN_BLOCK_LOOP,iLevel);` |
|    3038 |  3192 | `	if( pLoop == 0 ){` |
...
|       - |  3198 | `		}` |
|       6 |  3199 | `	}else{` |
|    3028 |  3200 | `		sxu32 nInstrIdx = 0;` |
|       - |  3201 | `		/* Emit POP_EXCEPTION for any try blocks between here and the loop */` |
|    3028 |  3202 | `		GenStateEmitExceptionPopForBreak(&(*pGen),pLoop);` |
|    3028 |  3203 | `		if( pLoop->iFlags & GEN_BLOCK_SWITCH ){` |
...
|    3024 |  3215 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pLoop->nFirstInstr,0,&nInstrIdx);` |
|    3024 |  3216 | `			if( pLoop->bPostContinue == TRUE ){` |
...
|       - |  3223 | `		}` |
|       - |  3224 | `	}` |
|    3038 |  3225 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
...
|       - |  3239 | ` */` |
|     118 |  3240 | `static sxi32 PH7_CompileBreak(ph7_gen_state *pGen)` |
|       2 |  3241 |  |
...
|     120 |  3247 | `	pGen->pIn++;` |
|     120 |  3248 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NUM) ){` |
...
|     120 |  3274 | `	pLoop = GenStateFetchBlock(pGen->pCurrent,GEN_BLOCK_LOOP,iLevel);` |
|     120 |  3275 | `	if( pLoop == 0 ){` |
|       - |  3276 | `		/* Illegal break */` |
...
|     104 |  3285 | `		GenStateEmitExceptionPopForBreak(&(*pGen),pLoop);` |
|     104 |  3286 | `		rc = PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,0,0,&nInstrIdx);` |
|     104 |  3287 | `		if( rc == SXRET_OK ){` |
|       - |  3288 | `			/* Fix the jump later when the jump destination is resolved */` |
|     104 |  3289 | `			GenStateNewJumpFixup(pLoop,PH7_OP_JMP,nInstrIdx);` |
|      51 |  3290 | `		}` |
|       - |  3291 | `	}` |
|     120 |  3292 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
...
|       - |  3506 | ` * message.` |
|       - |  3507 | ` */` |
|  362692 |  3508 | `static sxi32 PH7_CompileBlock(` |
...
|       - |  3513 | `	sxi32 rc;` |
|       - |  3514 | `	sxu32 nLine;` |
|  362694 |  3515 | `	if( pGen->pIn->nType & PH7_TK_OCB /* '{' */ ){` |
|  361286 |  3516 | `		nLine = pGen->pIn->nLine;` |
|  361286 |  3517 | `		rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_STD,PH7_VmInstrLength(pGen->pVm),0,0);` |
|  361286 |  3518 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  3519 | `			return SXERR_ABORT;` |
|       - |  3520 | `		}` |
|  361286 |  3521 | `		pGen->pIn++;` |
|       - |  3522 | `		/* Compile until we hit the closing braces '}' */` |
|  493572 |  3523 | `		for(;;){` |
|  987146 |  3524 | `			if( pGen->pIn >= pGen->pEnd ){` |
...
|       - |  3533 | `				}` |
|     ! 0 |  3534 | `			}` |
|  987126 |  3535 | `			if( pGen->pIn->nType & PH7_TK_CCB/*'}'*/ ){` |
|       - |  3536 | `				/* Closing braces found,break immediately*/` |
|  361266 |  3537 | `				pGen->pIn++;` |
|  361266 |  3538 | `				break;` |
|       - |  3539 | `			}` |
|       - |  3540 | `			/* Compile a single statement */` |
|  625862 |  3541 | `			rc = GenStateCompileChunk(&(*pGen),PH7_COMPILE_SINGLE_STMT);` |
|  625862 |  3542 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  3543 | `				return SXERR_ABORT;` |
|       - |  3544 | `			}` |
|       2 |  3545 | `		}` |
|  361286 |  3546 | `		GenStateLeaveBlock(&(*pGen),0);` |
|  182052 |  3547 | `	}else if( (pGen->pIn->nType & PH7_TK_COLON /* ':' */) && nKeywordEnd > 0 ){` |
|     ! 0 |  3548 | `		pGen->pIn++;` |
...
|  362694 |  3597 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|     ! 0 |  3598 | `		pGen->pIn++;` |
|     ! 0 |  3599 | `	}` |
|  362694 |  3600 | `	return SXRET_OK;` |
|  181348 |  3601 |  |
|       - |  3602 | `/*` |
...
|       - |  3619 | ` *   endwhile;` |
|       - |  3620 | ` */` |
|   12070 |  3621 | `static sxi32 PH7_CompileWhile(ph7_gen_state *pGen)` |
|       2 |  3622 |  |
|   12072 |  3623 | `	GenBlock *pWhileBlock = 0;` |
|   12072 |  3624 | `	SyToken *pTmp,*pEnd = 0;` |
|       - |  3625 | `	sxu32 nFalseJump;` |
|       - |  3626 | `	sxu32 nLine;` |
|       - |  3627 | `	sxi32 rc;` |
|   12072 |  3628 | `	nLine = pGen->pIn->nLine;` |
|       - |  3629 | `	/* Jump the 'while' keyword */` |
|   12072 |  3630 | `	pGen->pIn++;` |
|   12072 |  3631 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  3632 | `		/* Syntax error */` |
...
|   12072 |  3643 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pWhileBlock);` |
|   12072 |  3644 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  3645 | `		return SXERR_ABORT;` |
|       - |  3646 | `	}` |
|       - |  3647 | `	/* Delimit the condition */` |
|   12072 |  3648 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   12072 |  3649 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|   12072 |  3658 | `	pTmp = pGen->pEnd;` |
|   12072 |  3659 | `	pGen->pEnd = pEnd;` |
|       - |  3660 | `	/* Compile the expression */` |
|   12072 |  3661 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   12072 |  3662 | `	if( rc == SXERR_ABORT ){` |
|       - |  3663 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  3664 | `		return SXERR_ABORT;` |
|       - |  3665 | `	}` |
|       - |  3666 | `	/* Update token stream */` |
|   12072 |  3667 | `	while(pGen->pIn < pEnd ){` |
...
|   12072 |  3675 | `	pGen->pIn  = &pEnd[1];` |
|   12072 |  3676 | `	pGen->pEnd = pTmp;` |
|       - |  3677 | `	/* Emit the false jump */` |
|   12072 |  3678 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nFalseJump);` |
|       - |  3679 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   12072 |  3680 | `	GenStateNewJumpFixup(pWhileBlock,PH7_OP_JZ,nFalseJump);` |
|       - |  3681 | `	/* Compile the loop body */` |
|   12072 |  3682 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDWHILE);` |
|   12072 |  3683 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  3684 | `		return SXERR_ABORT;` |
|       - |  3685 | `	}` |
|       - |  3686 | `	/* Emit the unconditional jump to the start of the loop */` |
|   12072 |  3687 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pWhileBlock->nFirstInstr,0,0);` |
|       - |  3688 | `	/* Fix all jumps now the destination is resolved */` |
|   12072 |  3689 | `	GenStateFixJumps(pWhileBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - |  3690 | `	/* Release the loop block */` |
|   12072 |  3691 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  3692 | `	/* Statement successfully compiled */` |
|   12072 |  3693 | `	return SXRET_OK;` |
|     ! 0 |  3694 | `Synchronize:` |
...
|       - |  3849 | ` */` |
|   12082 |  3850 | `static sxi32 PH7_CompileFor(ph7_gen_state *pGen)` |
|       2 |  3851 |  |
|   12084 |  3852 | `	SyToken *pTmp,*pPostStart,*pEnd = 0;` |
|   12084 |  3853 | `	GenBlock *pForBlock = 0;` |
|       - |  3854 | `	sxu32 nFalseJump;` |
|       - |  3855 | `	sxu32 nLine;` |
|       - |  3856 | `	sxi32 rc;` |
|   12084 |  3857 | `	nLine = pGen->pIn->nLine;` |
|       - |  3858 | `	/* Jump the 'for' keyword */` |
|   12084 |  3859 | `	pGen->pIn++;` |
|   12084 |  3860 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  3861 | `		/* Syntax error */` |
...
|   12084 |  3872 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   12084 |  3873 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|   12084 |  3888 | `	pTmp = pGen->pEnd;` |
|   12084 |  3889 | `	pGen->pEnd = pEnd;` |
|       - |  3890 | `	/* Compile initialization expressions if available */` |
|   12084 |  3891 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|       - |  3892 | `	/* Pop operand lvalues */` |
|   12084 |  3893 | `	if( rc == SXERR_ABORT ){` |
|       - |  3894 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  3895 | `		return SXERR_ABORT;` |
|   12084 |  3896 | `	}else if( rc != SXERR_EMPTY ){` |
|   12082 |  3897 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|    6040 |  3898 | `	}` |
|   12084 |  3899 | `	if( (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|       - |  3900 | `		/* Syntax error */` |
...
|   12084 |  3912 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pForBlock);` |
|   12084 |  3913 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  3914 | `		return SXERR_ABORT;` |
|       - |  3915 | `	}` |
|       - |  3916 | `	/* Deffer continue jumps */` |
|   12084 |  3917 | `	pForBlock->bPostContinue = TRUE;` |
|       - |  3918 | `	/* Compile the condition */` |
|   12084 |  3919 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   12084 |  3920 | `	if( rc == SXERR_ABORT ){` |
|       - |  3921 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  3922 | `		return SXERR_ABORT;` |
|   12084 |  3923 | `	}else if( rc != SXERR_EMPTY ){` |
|       - |  3924 | `		/* Emit the false jump */` |
|   12082 |  3925 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nFalseJump);` |
|       - |  3926 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   12082 |  3927 | `		GenStateNewJumpFixup(pForBlock,PH7_OP_JZ,nFalseJump);` |
|    6040 |  3928 | `	}` |
|   12084 |  3929 | `	if( (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|       - |  3930 | `		/* Syntax error */` |
...
|   12080 |  3942 | `	pPostStart = pGen->pIn;` |
|       - |  3943 | `	/* Compile the loop body */` |
|   12080 |  3944 | `	pGen->pIn  = &pEnd[1]; /* Jump the trailing parenthesis ')' */` |
|   12080 |  3945 | `	pGen->pEnd = pTmp;` |
|   12080 |  3946 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDFOR);` |
|   12080 |  3947 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  3948 | `		return SXERR_ABORT;` |
|       - |  3949 | `	}` |
|       - |  3950 | `	/* Fix post-continue jumps */` |
|   12080 |  3951 | `	if( SySetUsed(&pForBlock->aPostContFix) > 0 ){` |
...
|   12080 |  3967 | `	while( pPostStart < pEnd && (pPostStart->nType & PH7_TK_SEMI) ){` |
|     ! 0 |  3968 | `		pPostStart++;` |
|     ! 0 |  3969 | `	}` |
|   12080 |  3970 | `	if( pPostStart < pEnd ){` |
|       - |  3971 | `		SyToken *pTmpIn,*pTmpEnd;` |
|   12080 |  3972 | `		SWAP_DELIMITER(pGen,pPostStart,pEnd);` |
|   12080 |  3973 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   12080 |  3974 | `		if( pGen->pIn < pGen->pEnd ){` |
|       - |  3975 | `			/* Syntax error */` |
...
|       - |  3982 | `		}` |
|   12080 |  3983 | `		RE_SWAP_DELIMITER(pGen);` |
|   12080 |  3984 | `		if( rc == SXERR_ABORT ){` |
|       - |  3985 | `			/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  3986 | `			return SXERR_ABORT;` |
|   12080 |  3987 | `		}else if( rc != SXERR_EMPTY){` |
|       - |  3988 | `			/* Pop operand lvalue */` |
|   12080 |  3989 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|    6039 |  3990 | `		}` |
|    6039 |  3991 | `	}` |
|       - |  3992 | `	/* Emit the unconditional jump to the start of the loop */` |
|   12080 |  3993 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pForBlock->nFirstInstr,0,0);` |
|       - |  3994 | `	/* Fix all jumps now the destination is resolved */` |
|   12080 |  3995 | `	GenStateFixJumps(pForBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - |  3996 | `	/* Release the loop block */` |
|   12080 |  3997 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  3998 | `	/* Statement successfully compiled */` |
|   12080 |  3999 | `	return SXRET_OK;` |
|    6043 |  4000 |  |
...
|       - |  4003 | ` * are allowed.` |
|       - |  4004 | ` */` |
|    6404 |  4005 | `static sxi32 GenStateForEachNodeValidator(ph7_gen_state *pGen,ph7_expr_node *pRoot)` |
|       2 |  4006 |  |
|    6406 |  4007 | `	sxi32 rc = SXRET_OK; /* Assume a valid expression tree */` |
|    6406 |  4008 | `	if( pRoot->xCode != PH7_CompileVariable ){` |
...
|       - |  4043 | ` */` |
|    3260 |  4044 | `static sxi32 PH7_CompileForeach(ph7_gen_state *pGen)` |
|       2 |  4045 |  |
|    3262 |  4046 | `	SyToken *pCur,*pTmp,*pEnd = 0;` |
|    3262 |  4047 | `	SyToken *pListStart = 0,*pListEnd = 0;` |
|    3262 |  4048 | `	GenBlock *pForeachBlock = 0;` |
|       - |  4049 | `	ph7_foreach_info *pInfo;` |
|       - |  4050 | `	sxu32 nFalseJump;` |
|       - |  4051 | `	VmInstr *pInstr;` |
|       - |  4052 | `	sxu32 nLine;` |
|       - |  4053 | `	sxi32 rc;` |
|    3262 |  4054 | `	nLine = pGen->pIn->nLine;` |
|       - |  4055 | `	/* Jump the 'foreach' keyword */` |
|    3262 |  4056 | `	pGen->pIn++;` |
|    3262 |  4057 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  4058 | `		/* Syntax error */` |
...
|    3262 |  4069 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pForeachBlock);` |
|    3262 |  4070 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  4071 | `		return SXERR_ABORT;` |
|       - |  4072 | `	}` |
|       - |  4073 | `	/* Delimit the expression */` |
|    3262 |  4074 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|    3262 |  4075 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|    3262 |  4090 | `	pCur = pGen->pIn;` |
|   21934 |  4091 | `	while( pCur < pEnd ){` |
|   21934 |  4092 | `		if( pCur->nType & PH7_TK_KEYWORD ){` |
|    3274 |  4093 | `			sxi32 nKeywrd = SX_PTR_TO_INT(pCur->pUserData);` |
|    3274 |  4094 | `			if( nKeywrd == PH7_TKWRD_AS ){` |
...
|    3262 |  4112 | `	pTmp = pGen->pEnd;` |
|    3262 |  4113 | `	pGen->pEnd = pCur;` |
|    3262 |  4114 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|    3262 |  4115 | `	if( rc == SXERR_ABORT ){` |
|       - |  4116 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4117 | `		return SXERR_ABORT;` |
|       - |  4118 | `	}` |
|       - |  4119 | `	/* Update token stream */` |
|    3262 |  4120 | `	while(pGen->pIn < pCur ){` |
...
|     ! 0 |  4126 | `		pGen->pIn++;` |
|     ! 0 |  4127 | `	}` |
|    3262 |  4128 | `	pCur++; /* Jump the 'as' keyword */` |
|    3262 |  4129 | `	pGen->pIn = pCur;` |
|    3262 |  4130 | `	if( pGen->pIn >= pEnd ){` |
...
|    3262 |  4137 | `	pInfo = (ph7_foreach_info *)SyMemBackendAlloc(&pGen->pVm->sAllocator,sizeof(ph7_foreach_info));` |
|    3262 |  4138 | `	if( pInfo == 0 ){` |
...
|    3262 |  4143 | `	SyZero(pInfo,sizeof(ph7_foreach_info));` |
|       - |  4144 | `	/* Initialize structure fields */` |
|    3262 |  4145 | `	SySetInit(&pInfo->aStep,&pGen->pVm->sAllocator,sizeof(ph7_foreach_step *));` |
|       - |  4146 | `	/* Check if we have a key field */` |
|    9832 |  4147 | `	while( pCur < pEnd && (pCur->nType & PH7_TK_ARRAY_OP) == 0 ){` |
|    6572 |  4148 | `		pCur++;` |
|       2 |  4149 | `	}` |
|    3262 |  4150 | `	if( pCur < pEnd ){` |
|       - |  4151 | `		/* Compile the expression holding the key name */` |
|    3156 |  4152 | `		if( pGen->pIn >= pCur ){` |
...
|       - |  4157 | `			}` |
|     ! 0 |  4158 | `		}else{` |
|    3156 |  4159 | `			pGen->pEnd = pCur;` |
|    3156 |  4160 | `			rc = PH7_CompileExpr(&(*pGen),0,GenStateForEachNodeValidator);` |
|    3156 |  4161 | `			if( rc == SXERR_ABORT ){` |
|       - |  4162 | `				/* Don't worry about freeing memory, everything will be released shortly */` |
|     ! 0 |  4163 | `				return SXERR_ABORT;` |
|       - |  4164 | `			}` |
|    3156 |  4165 | `			pInstr = PH7_VmPopInstr(pGen->pVm);` |
|    3156 |  4166 | `			if( pInstr->p3 ){` |
|       - |  4167 | `				/* Record key name */` |
|    3156 |  4168 | `				SyStringInitFromBuf(&pInfo->sKey,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|    1577 |  4169 | `			}` |
|    3156 |  4170 | `			pInfo->iFlags \|= PH7_4EACH_STEP_KEY;` |
|       - |  4171 | `		}` |
|    3156 |  4172 | `		pGen->pIn = &pCur[1]; /* Jump the arrow */` |
|    1577 |  4173 | `	}` |
|    3262 |  4174 | `	pGen->pEnd = pEnd;` |
|    3262 |  4175 | `	if( pGen->pIn >= pEnd ){` |
...
|    3257 |  4230 | `	}else if( pGen->pIn->nType & PH7_TK_OSB ){` |
...
|    3252 |  4263 | `		rc = PH7_CompileExpr(&(*pGen),0,GenStateForEachNodeValidator);` |
|    3252 |  4264 | `		if( rc == SXERR_ABORT ){` |
|       - |  4265 | `			/* Don't worry about freeing memory, everything will be released shortly */` |
|     ! 0 |  4266 | `			return SXERR_ABORT;` |
|       - |  4267 | `		}` |
|    3252 |  4268 | `		pInstr = PH7_VmPopInstr(pGen->pVm);` |
|    3252 |  4269 | `		if( pInstr->p3 ){` |
|       - |  4270 | `			/* Record value name */` |
|    3252 |  4271 | `			SyStringInitFromBuf(&pInfo->sValue,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|    1625 |  4272 | `		}` |
|       - |  4273 | `	}` |
|       - |  4274 | `	/* Emit the 'FOREACH_INIT' instruction */` |
|    3260 |  4275 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_FOREACH_INIT,0,0,pInfo,&nFalseJump);` |
|       - |  4276 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|    3260 |  4277 | `	GenStateNewJumpFixup(pForeachBlock,PH7_OP_FOREACH_INIT,nFalseJump);` |
|       - |  4278 | `	/* Record the first instruction to execute */` |
|    3260 |  4279 | `	pForeachBlock->nFirstInstr = PH7_VmInstrLength(pGen->pVm);` |
|       - |  4280 | `	/* Emit the FOREACH_STEP instruction */` |
|    3260 |  4281 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_FOREACH_STEP,0,0,pInfo,&nFalseJump);` |
|       - |  4282 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|    3260 |  4283 | `	GenStateNewJumpFixup(pForeachBlock,PH7_OP_FOREACH_STEP,nFalseJump);` |
|       - |  4284 | `	/* If list() unpacking, emit bytecode to destructure the temp variable */` |
|    3260 |  4285 | `	if( (pInfo->iFlags & PH7_4EACH_STEP_LIST) && pListStart && pListEnd ){` |
...
|    3260 |  4313 | `	pGen->pIn = &pEnd[1];` |
|    3260 |  4314 | `	pGen->pEnd = pTmp;` |
|    3260 |  4315 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_END4EACH);` |
|    3260 |  4316 | `	if( rc == SXERR_ABORT ){` |
...
|    3260 |  4321 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pForeachBlock->nFirstInstr,0,0);` |
|       - |  4322 | `	/* Fix all jumps now the destination is resolved */` |
|    3260 |  4323 | `	GenStateFixJumps(pForeachBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - |  4324 | `	/* Release the loop block */` |
|    3260 |  4325 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  4326 | `	/* Statement successfully compiled */` |
|    3260 |  4327 | `	return SXRET_OK;` |
|       1 |  4328 | `Synchronize:` |
...
|       - |  4367 | ` *    ?>` |
|       - |  4368 | ` */` |
|  125770 |  4369 | `static sxi32 PH7_CompileIf(ph7_gen_state *pGen)` |
|       2 |  4370 |  |
|  125772 |  4371 | `	SyToken *pToken,*pTmp,*pEnd = 0;` |
|  125772 |  4372 | `	GenBlock *pCondBlock = 0;` |
|       - |  4373 | `	sxu32 nJumpIdx;` |
|       - |  4374 | `	sxu32 nKeyID;` |
|       - |  4375 | `	sxi32 rc;` |
|       - |  4376 | `	/* Jump the 'if' keyword */` |
|  125772 |  4377 | `	pGen->pIn++;` |
|  125772 |  4378 | `	pToken = pGen->pIn;` |
|       - |  4379 | `	/* Create the conditional block */` |
|  125772 |  4380 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_COND,PH7_VmInstrLength(pGen->pVm),0,&pCondBlock);` |
|  125772 |  4381 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  4382 | `		return SXERR_ABORT;` |
|       - |  4383 | `	}` |
|       - |  4384 | `	/* Process as many [if/else if/elseif/else] blocks as we can */` |
|   68882 |  4385 | `	for(;;){` |
|  137766 |  4386 | `		if( pToken >= pGen->pEnd \|\| (pToken->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  4387 | `			/* Syntax error */` |
...
|  137766 |  4401 | `		PH7_DelimitNestedTokens(pToken,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|  137766 |  4402 | `		if( pToken >= pEnd \|\| (pEnd->nType & PH7_TK_RPAREN) == 0 ){` |
|       - |  4403 | `			/* Syntax error */` |
...
|  137766 |  4415 | `		SWAP_TOKEN_STREAM(pGen,pToken,pEnd);` |
|       - |  4416 | `		/* Compile the condition */` |
|  137766 |  4417 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|       - |  4418 | `		/* Update token stream */` |
|  137766 |  4419 | `		while(pGen->pIn < pEnd ){` |
|     ! 0 |  4420 | `			PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Unexpected token '%z'",&pGen->pIn->sData);` |
|     ! 0 |  4421 | `			pGen->pIn++;` |
|     ! 0 |  4422 | `		}` |
|  137766 |  4423 | `		pGen->pIn  = &pEnd[1];` |
|  137766 |  4424 | `		pGen->pEnd = pTmp;` |
|  137766 |  4425 | `		if( rc == SXERR_ABORT ){` |
|       - |  4426 | `			/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4427 | `			return SXERR_ABORT;` |
|       - |  4428 | `		}` |
|       - |  4429 | `		/* Emit the false jump */` |
|  137766 |  4430 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nJumpIdx);` |
|       - |  4431 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|  137766 |  4432 | `		GenStateNewJumpFixup(pCondBlock,PH7_OP_JZ,nJumpIdx);` |
|       - |  4433 | `		/* Compile the body */` |
|  137766 |  4434 | `		rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDIF);` |
|  137766 |  4435 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  4436 | `			return SXERR_ABORT;` |
|       - |  4437 | `		}` |
|  137766 |  4438 | `		if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
|   38441 |  4439 | `			break;` |
|       - |  4440 | `		}` |
|       - |  4441 | `		/* Ensure that the keyword ID is 'else if' or 'else' */` |
|   60888 |  4442 | `		nKeyID = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   60888 |  4443 | `		if( (nKeyID & (PH7_TKWRD_ELSE\|PH7_TKWRD_ELIF)) == 0 ){` |
|   39190 |  4444 | `			break;` |
|       - |  4445 | `		}` |
|       - |  4446 | `		/* Emit the unconditional jump */` |
|   21700 |  4447 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,0,0,&nJumpIdx);` |
|       - |  4448 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   21700 |  4449 | `		GenStateNewJumpFixup(pCondBlock,PH7_OP_JMP,nJumpIdx);` |
|   21700 |  4450 | `		if( nKeyID & PH7_TKWRD_ELSE ){` |
|   15690 |  4451 | `			pToken = &pGen->pIn[1];` |
|   15690 |  4452 | `			if( pToken >= pGen->pEnd \|\| (pToken->nType & PH7_TK_KEYWORD) == 0 \|\|` |
|    6014 |  4453 | `				SX_PTR_TO_INT(pToken->pUserData) != PH7_TKWRD_IF ){` |
|    4854 |  4454 | `					break;` |
|       - |  4455 | `			}` |
|    5986 |  4456 | `			pGen->pIn++; /* Jump the 'else' keyword */` |
|    2992 |  4457 | `		}` |
|   11996 |  4458 | `		pGen->pIn++; /* Jump the 'elseif/if' keyword */` |
|       - |  4459 | `		/* Synchronize cursors */` |
|   11996 |  4460 | `		pToken = pGen->pIn;` |
|       - |  4461 | `		/* Fix the false jump */` |
|   11996 |  4462 | `		GenStateFixJumps(pCondBlock,PH7_OP_JZ,PH7_VmInstrLength(pGen->pVm));` |
|       2 |  4463 | `	} /* For(;;) */` |
|       - |  4464 | `	/* Fix the false jump */` |
|  125772 |  4465 | `	GenStateFixJumps(pCondBlock,PH7_OP_JZ,PH7_VmInstrLength(pGen->pVm));` |
|  125772 |  4466 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|   48892 |  4467 | `		(SX_PTR_TO_INT(pGen->pIn->pUserData) & PH7_TKWRD_ELSE) ){` |
|       - |  4468 | `			/* Compile the else block */` |
|    9706 |  4469 | `			pGen->pIn++;` |
|    9706 |  4470 | `			rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDIF);` |
|    9706 |  4471 | `			if( rc == SXERR_ABORT ){` |
|       - |  4472 |  |
|     ! 0 |  4473 | `				return SXERR_ABORT;` |
|       - |  4474 | `			}` |
|    4852 |  4475 | `	}` |
|  125772 |  4476 | `	nJumpIdx = PH7_VmInstrLength(pGen->pVm);` |
|       - |  4477 | `	/* Fix all unconditional jumps now the destination is resolved */` |
|  125772 |  4478 | `	GenStateFixJumps(pCondBlock,PH7_OP_JMP,nJumpIdx);` |
|       - |  4479 | `	/* Release the conditional block */` |
|  125772 |  4480 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  4481 | `	/* Statement successfully compiled */` |
|  125772 |  4482 | `	return SXRET_OK;` |
|     ! 0 |  4483 | `Synchronize:` |
...
|       - |  4583 | ` */` |
|  198312 |  4584 | `static sxi32 PH7_CompileReturn(ph7_gen_state *pGen)` |
|       2 |  4585 |  |
|  198314 |  4586 | `	sxi32 nRet = 0; /* TRUE if there is a return value */` |
|       - |  4587 | `	sxi32 rc;` |
|       - |  4588 | `	/* Jump the 'return' keyword */` |
|  198314 |  4589 | `	pGen->pIn++;` |
|  198314 |  4590 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|       - |  4591 | `		/* Compile the expression */` |
|  198290 |  4592 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|  198290 |  4593 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  4594 | `			return SXERR_ABORT;` |
|  198290 |  4595 | `		}else if(rc != SXERR_EMPTY ){` |
|  198290 |  4596 | `			nRet = 1;` |
|   99144 |  4597 | `		}` |
|   99144 |  4598 | `	}` |
|       - |  4599 | `	/* Emit the done instruction */` |
|  198314 |  4600 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,nRet,0,0,0);` |
|  198314 |  4601 | `	return SXRET_OK;` |
|   99158 |  4602 |  |
|       - |  4603 | `/*` |
...
|       - |  4692 | ` */` |
|   12430 |  4693 | `static sxi32 PH7_CompileEcho(ph7_gen_state *pGen)` |
|       2 |  4694 |  |
|   12432 |  4695 | `	SyToken *pTmp,*pNext = 0;` |
|       - |  4696 | `	sxi32 rc;` |
|       - |  4697 | `	/* Jump the 'echo' keyword */` |
|   12432 |  4698 | `	pGen->pIn++;` |
|       - |  4699 | `	/* Compile arguments one after one */` |
|   12432 |  4700 | `	pTmp = pGen->pEnd;` |
|   26198 |  4701 | `	while( SXRET_OK == PH7_GetNextExpr(pGen->pIn,pTmp,&pNext) ){` |
|   13768 |  4702 | `		if( pGen->pIn < pNext ){` |
|   13768 |  4703 | `			pGen->pEnd = pNext;` |
|   13768 |  4704 | `			rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_RDONLY_LOAD/* Do not create variable if inexistant */,0);` |
|   13768 |  4705 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  4706 | `				return SXERR_ABORT;` |
|   13768 |  4707 | `			}else if( rc != SXERR_EMPTY ){` |
|       - |  4708 | `				/* Emit the consume instruction */` |
|   13744 |  4709 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_CONSUME,1,0,0,0);` |
|    6871 |  4710 | `			}` |
|    6883 |  4711 | `		}` |
|       - |  4712 | `		/* Jump trailing commas */` |
|   15104 |  4713 | `		while( pNext < pTmp && (pNext->nType & PH7_TK_COMMA) ){` |
|    1338 |  4714 | `			pNext++;` |
|       2 |  4715 | `		}` |
|   13768 |  4716 | `		pGen->pIn = pNext;` |
|       2 |  4717 | `	}` |
|       - |  4718 | `	/* Restore token stream */` |
|   12432 |  4719 | `	pGen->pEnd = pTmp;` |
|   12432 |  4720 | `	return SXRET_OK;` |
|    6217 |  4721 |  |
|       - |  4722 | `/*` |
...
|       - |  4887 | ` */` |
|  370046 |  4888 | `static sxu32 GenStateNsQualifyName(ph7_gen_state *pGen,sxu32 nOrigIdx,SyHash *pImports,int *pFromImport)` |
|       2 |  4889 |  |
|       - |  4890 | `	ph7_value *pLit;` |
...
|       - |  4898 | `	ph7_value *pNew;` |
|  370048 |  4899 | `	if( pFromImport ){` |
|  354038 |  4900 | `		*pFromImport = 0;` |
|  177018 |  4901 | `	}` |
|  370048 |  4902 | `	pLit = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,nOrigIdx);` |
|  370048 |  4903 | `	if( !pLit \|\| !(pLit->iFlags & MEMOBJ_STRING) \|\| SyBlobLength(&pLit->sBlob) == 0 ){` |
|     ! 0 |  4904 | `		return nOrigIdx;` |
|       - |  4905 | `	}` |
|  370048 |  4906 | `	zLit = (const char *)SyBlobData(&pLit->sBlob);` |
|  370048 |  4907 | `	nLit = (sxu32)SyBlobLength(&pLit->sBlob);` |
|       - |  4908 | `	/* Skip if already qualified (contains backslash) */` |
|  370048 |  4909 | `	hasNsSep = 0;` |
| 4003572 |  4910 | `	for( k = 0; k < nLit; k++ ){` |
| 3633534 |  4911 | `		if( zLit[k] == '\\' ){ hasNsSep = 1; break; }` |
| 1816764 |  4912 | `	}` |
|  370048 |  4913 | `	if( hasNsSep ){` |
|       9 |  4914 | `		return nOrigIdx;` |
|       - |  4915 | `	}` |
|       - |  4916 | `	/* Check use imports first (works even outside namespaces) */` |
|  370040 |  4917 | `	SyBlobReset(&pGen->sWorker);` |
|  370040 |  4918 | `	pImport = SyHashGet(pImports,(const void *)zLit,nLit);` |
|  370040 |  4919 | `	if( pImport ){` |
...
|       8 |  4924 | `		}` |
|      20 |  4925 | `	}else{` |
|  370004 |  4926 | `		if( SyBlobLength(&pGen->sNamespace) == 0 ){` |
|  369914 |  4927 | `			return nOrigIdx; /* Not in a namespace and no import match */` |
|       - |  4928 | `		}` |
...
|       - |  4950 | ` */` |
|   33442 |  4951 | `static void GenStateResolveName(ph7_gen_state *pGen,const SyString *pName,SyBlob *pOut)` |
|       2 |  4952 |  |
|       - |  4953 | `	SyHashEntry *pImport;` |
|       - |  4954 | `	/* Check use imports first */` |
|   33444 |  4955 | `	pImport = SyHashGet(&pGen->hUseImports,(const void *)pName->zString,pName->nByte);` |
|   33444 |  4956 | `	if( pImport ){` |
...
|       - |  4972 | ` */` |
|   54786 |  4973 | `static void GenStateBuildFQN(ph7_gen_state *pGen,const SyString *pName,SyBlob *pOut)` |
|       2 |  4974 |  |
|   54788 |  4975 | `	if( SyBlobLength(&pGen->sNamespace) > 0 ){` |
|      60 |  4976 | `		SyBlobAppend(pOut,SyBlobData(&pGen->sNamespace),SyBlobLength(&pGen->sNamespace));` |
|      60 |  4977 | `		SyBlobAppend(pOut,"\\",1);` |
|      29 |  4978 | `	}` |
|   54788 |  4979 | `	SyBlobAppend(pOut,pName->zString,pName->nByte);` |
|   54788 |  4980 |  |
|       - |  4981 | `/*` |
...
|       - |  5477 | ` */` |
|   56880 |  5478 | `static sxi32 GenStateProcessArgValue(ph7_gen_state *pGen,ph7_vm_func_arg *pArg,SyToken *pIn,SyToken *pEnd)` |
|       2 |  5479 |  |
|       - |  5480 | `	SyToken *pTmpIn,*pTmpEnd;` |
|       - |  5481 | `	SySet *pInstrContainer;` |
|       - |  5482 | `	sxi32 rc;` |
|       - |  5483 | `	/* Swap token stream */` |
|   56882 |  5484 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|   56882 |  5485 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   56882 |  5486 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pArg->aByteCode);` |
|       - |  5487 | `	/* Compile the expression holding the argument value */` |
|   56882 |  5488 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|       - |  5489 | `	/* Emit the done instruction */` |
|   56882 |  5490 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,(rc != SXERR_EMPTY ? 1 : 0),0,0,0);` |
|   56882 |  5491 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|   56882 |  5492 | `	RE_SWAP_DELIMITER(pGen);` |
|   56882 |  5493 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  5494 | `		return SXERR_ABORT;` |
|       - |  5495 | `	}` |
|   56882 |  5496 | `	return SXRET_OK;` |
|   28442 |  5497 |  |
|       - |  5498 | `/*` |
...
|       - |  5534 | ` */` |
|   60746 |  5535 | `static sxi32 GenStateCollectFuncArgs(ph7_vm_func *pFunc,ph7_gen_state *pGen,SyToken *pEnd,int bCtorCtx,int bAbstractCtx)` |
|       2 |  5536 |  |
...
|       - |  5541 | `	sxi32 rc;` |
|       - |  5542 |  |
|   60748 |  5543 | `	pIn = pGen->pIn;` |
|   60748 |  5544 | `	SyBlobInit(&sSig,&pGen->pVm->sAllocator);` |
|       - |  5545 | `	/* Process arguments one after one */` |
|   79005 |  5546 | `	for(;;){` |
|  158012 |  5547 | `		if( pIn >= pEnd ){` |
|       - |  5548 | `			/* No more arguments to process */` |
|   60736 |  5549 | `			break;` |
|       - |  5550 | `		}` |
|   97278 |  5551 | `		SyZero(&sArg,sizeof(ph7_vm_func_arg));` |
|   97278 |  5552 | `		SySetInit(&sArg.aByteCode,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|   97278 |  5553 | `		SySetInit(&sArg.aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|   97278 |  5554 | `		SyStringInitFromBuf(&sArg.sTypeName,0,0);` |
|       - |  5555 | `		/* Parse optional visibility modifier (constructor property promotion, PHP 8.0+) */` |
|   97278 |  5556 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD) ){` |
|   54008 |  5557 | `			sxu32 nKw = (sxu32)SX_PTR_TO_INT(pIn->pUserData);` |
|   54008 |  5558 | `			if( nKw == PH7_TKWRD_PUBLIC \|\| nKw == PH7_TKWRD_PROTECTED \|\| nKw == PH7_TKWRD_PRIVATE ){` |
|      42 |  5559 | `				if( !bCtorCtx ){` |
...
|  128791 |  5584 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_DOLLAR) == 0` |
|   81664 |  5585 | `			&& (pIn->nType & PH7_TK_AMPER) == 0` |
|   64549 |  5586 | `			&& (pIn->nType & PH7_TK_ELLIPSIS) == 0 ){` |
|   63020 |  5587 | `			sxu32 nLineLocal = pIn->nLine;` |
|   63020 |  5588 | `			sxi32 iTFlags = 0;` |
|   63020 |  5589 | `			pGen->pIn = pIn;` |
|   63020 |  5590 | `			rc = GenStateParseUnionTypeDecl(` |
|   31509 |  5591 | `				pGen, &sArg.nType, &sArg.sClass, &sArg.aUnionAlts,` |
|   31509 |  5592 | `				&iTFlags, &sArg.sTypeName,` |
|       - |  5593 | `				VM_FUNC_ARG_NULLABLE, VM_FUNC_ARG_UNION,` |
|       - |  5594 | `				/* bAllowVoid */ 0,` |
|   31509 |  5595 | `						nLineLocal);` |
|   63020 |  5596 | `			pIn = pGen->pIn;` |
|   63020 |  5597 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  5598 | `				return SXERR_ABORT;` |
|   63020 |  5599 | `			}else if( rc == SXERR_CORRUPT ){` |
|       - |  5600 | `				/* Error already reported by GenStateParseUnionTypeDecl */` |
|       3 |  5601 | `				return SXERR_SYNTAX;` |
|   63018 |  5602 | `			}else if( rc == SXERR_SYNTAX ){` |
|       5 |  5603 | `				if( pIn < pEnd ){` |
...
|       - |  5612 | `			}` |
|   63014 |  5613 | `			sArg.iFlags \|= iTFlags;` |
|   31506 |  5614 | `		}` |
|   97268 |  5615 | `		if( pIn >= pEnd ){` |
|     ! 0 |  5616 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Missing argument name");` |
|     ! 0 |  5617 | `			return rc;` |
|       - |  5618 | `		}` |
|   97268 |  5619 | `		if( pIn->nType & PH7_TK_AMPER ){` |
|       - |  5620 | `			/* Pass by reference,record that */` |
|    3022 |  5621 | `			sArg.iFlags \|= VM_FUNC_ARG_BY_REF;` |
|    3022 |  5622 | `			pIn++;` |
|    1510 |  5623 | `		}` |
|   97268 |  5624 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_ELLIPSIS) ){` |
|       - |  5625 | `			/* Variadic parameter: ...$args */` |
|      42 |  5626 | `			sArg.iFlags \|= VM_FUNC_ARG_VARIADIC;` |
|      42 |  5627 | `			pIn++;` |
|      20 |  5628 | `		}` |
|   97268 |  5629 | `		if( pIn >= pEnd \|\| (pIn->nType & PH7_TK_DOLLAR) == 0 \|\| &pIn[1] >= pEnd \|\| (pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|       - |  5630 | `			/* Invalid argument */` |
|     ! 0 |  5631 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Invalid argument name");` |
|     ! 0 |  5632 | `			return rc;` |
|       - |  5633 | `		}` |
|   97268 |  5634 | `		pIn++; /* Jump the dollar sign */` |
|       - |  5635 | `		/* Copy argument name */` |
|   97268 |  5636 | `		zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,SyStringData(&pIn->sData),SyStringLength(&pIn->sData));` |
|   97268 |  5637 | `		if( zDup == 0 ){` |
|     ! 0 |  5638 | `			PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"PH7 engine is running out of memory");` |
|     ! 0 |  5639 | `			return SXERR_ABORT;` |
|       - |  5640 | `		}` |
|   97268 |  5641 | `		SyStringInitFromBuf(&sArg.sName,zDup,SyStringLength(&pIn->sData));` |
|   97268 |  5642 | `		pIn++;` |
|   97268 |  5643 | `		if( pIn < pEnd ){` |
|   63490 |  5644 | `			if( pIn->nType & PH7_TK_EQUAL ){` |
|       - |  5645 | `				SyToken *pDefend;` |
|   56884 |  5646 | `				sxi32 iNest = 0;` |
|   56884 |  5647 | `				pIn++; /* Jump the equal sign */` |
|   56884 |  5648 | `				pDefend = pIn;` |
|       - |  5649 | `				/* Process the default value associated with this argument */` |
|  119748 |  5650 | `				while( pDefend < pEnd ){` |
|   92794 |  5651 | `					if( (pDefend->nType & PH7_TK_COMMA) && iNest <= 0 ){` |
|   29930 |  5652 | `						break;` |
|       - |  5653 | `					}` |
|   62866 |  5654 | `					if( pDefend->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*[*/) ){` |
|       - |  5655 | `						/* Increment nesting level */` |
|    2994 |  5656 | `						iNest++;` |
|   61370 |  5657 | `					}else if( pDefend->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CCB/*'}'*/\|PH7_TK_CSB/*]*/) ){` |
|       - |  5658 | `						/* Decrement nesting level */` |
|    2994 |  5659 | `						iNest--;` |
|    1496 |  5660 | `					}` |
|   62866 |  5661 | `					pDefend++;` |
|       2 |  5662 | `				}` |
|   56884 |  5663 | `				if( pIn >= pDefend ){` |
|       3 |  5664 | `					rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Missing argument default value");` |
|       3 |  5665 | `					return rc;` |
|       - |  5666 | `				}` |
|       - |  5667 | `				/* Process default value */` |
|   56882 |  5668 | `				rc = GenStateProcessArgValue(&(*pGen),&sArg,pIn,pDefend);` |
|   56882 |  5669 | `				if( rc != SXRET_OK ){` |
|     ! 0 |  5670 | `					return rc;` |
|       - |  5671 | `				}` |
|       - |  5672 | `				/* Point beyond the default value */` |
|   56882 |  5673 | `				pIn = pDefend;` |
|   28440 |  5674 | `			}` |
|   63488 |  5675 | `			if( pIn < pEnd && (pIn->nType & PH7_TK_COMMA) == 0 ){` |
|     ! 0 |  5676 | `				rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Unexpected token '%z'",&pIn->sData);` |
|     ! 0 |  5677 | `				return rc;` |
|       - |  5678 | `			}` |
|   63488 |  5679 | `			pIn++; /* Jump the trailing comma */` |
|   31743 |  5680 | `		}` |
|       - |  5681 | `		/* Append argument signature */` |
|   97266 |  5682 | `		if( sArg.nType > 0 ){` |
|   62972 |  5683 | `			if( SyStringLength(&sArg.sClass) > 0 ){` |
|       - |  5684 | `				/* Class name — prefix with 'o' so generic object hint is a prefix match */` |
|    8994 |  5685 | `				int marker = 'o';` |
|    8994 |  5686 | `				SyBlobAppend(&sSig,(const void *)&marker,sizeof(char));` |
|    8994 |  5687 | `				SyBlobAppend(&sSig,SyStringData(&sArg.sClass),SyStringLength(&sArg.sClass));` |
|    4498 |  5688 | `			}else{` |
|       - |  5689 | `				int c;` |
|   53980 |  5690 | `				c = 'n'; /* cc warning */` |
|       - |  5691 | `				/* Type leading character */` |
|   53980 |  5692 | `				switch(sArg.nType){` |
|     ! 0 |  5693 | `				case MEMOBJ_HASHMAP:` |
|       - |  5694 | `					/* Hashmap aka 'array' */` |
|     ! 0 |  5695 | `					c = 'h';` |
|     ! 0 |  5696 | `					break;` |
|    7514 |  5697 | `				case MEMOBJ_INT:` |
|       - |  5698 | `					/* Integer */` |
|   15030 |  5699 | `					c = 'i';` |
|   15030 |  5700 | `					break;` |
...
|     ! 0 |  5718 | `					break;` |
|       - |  5719 | `				}` |
|   53980 |  5720 | `				SyBlobAppend(&sSig,(const void *)&c,sizeof(char));` |
|       - |  5721 | `			}` |
|   31487 |  5722 | `		}else{` |
|       - |  5723 | `			/* No type is associated with this parameter which mean` |
|       - |  5724 | `			 * that this function is not condidate for overloading.` |
|       - |  5725 | `			 */` |
|   34296 |  5726 | `			SyBlobRelease(&sSig);` |
|       - |  5727 | `		}` |
|       - |  5728 | `		/* Save in the argument set */` |
|   97266 |  5729 | `		SySetPut(&pFunc->aArgs,(const void *)&sArg);` |
|       2 |  5730 | `	}` |
|   60736 |  5731 | `	if( SyBlobLength(&sSig) > 0 ){` |
|       - |  5732 | `		/* Save function signature */` |
|   39016 |  5733 | `		SyStringInitFromBuf(&pFunc->sSignature,SyBlobData(&sSig),SyBlobLength(&sSig));` |
|   19507 |  5734 | `	}` |
|   60736 |  5735 | `	return SXRET_OK;` |
|   30375 |  5736 |  |
|       - |  5737 | `/*` |
...
|       - |  5741 | ` */` |
|  186942 |  5742 | `static sxi32 GenStateCompileFuncBody(` |
...
|  186944 |  5752 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC,PH7_VmInstrLength(pGen->pVm),pFunc,&pBlock);` |
|  186944 |  5753 | `	if( rc != SXRET_OK ){` |
...
|       - |  5757 | `	}` |
|  186944 |  5758 | `	nGotoOfft = SySetUsed(&pGen->aGoto);` |
|       - |  5759 | `	/* Swap bytecode containers */` |
|  186944 |  5760 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|  186944 |  5761 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pFunc->aByteCode);` |
...
|       - |  5766 | `	{` |
|  186944 |  5767 | `		sxu32 nArg = SySetUsed(&pFunc->aArgs);` |
|       - |  5768 | `		sxu32 i;` |
|  281136 |  5769 | `		for( i = 0; i < nArg; i++ ){` |
|   94194 |  5770 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pFunc->aArgs,i);` |
|       - |  5771 | `			char *zSrc;` |
|       - |  5772 | `			sxu32 nSrc,nName;` |
|       - |  5773 | `			SySet sToken;` |
|       - |  5774 | `			SyToken *pTmpIn,*pTmpEnd;` |
|       - |  5775 | `			sxi32 rcPromote;` |
|   94194 |  5776 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|   94166 |  5777 | `				continue;` |
|       - |  5778 | `			}` |
...
|  186944 |  5825 | `	PH7_CompileBlock(&(*pGen),0);` |
|       - |  5826 | `	/* Fix exception jumps now the destination is resolved */` |
|  186944 |  5827 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|       - |  5828 | `	/* Emit the final return if not yet done */` |
|  186944 |  5829 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|       - |  5830 | `	/* Fix gotos jumps now the destination is resolved */` |
|  186944 |  5831 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),nGotoOfft) ){` |
|     ! 0 |  5832 | `		rc = SXERR_ABORT;` |
|     ! 0 |  5833 | `	}` |
|  186944 |  5834 | `	SySetTruncate(&pGen->aGoto,nGotoOfft);` |
|       - |  5835 | `	/* Restore the default container */` |
|  186944 |  5836 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|       - |  5837 | `	/* Leave function block */` |
|  186944 |  5838 | `	GenStateLeaveBlock(&(*pGen),0);` |
|  186944 |  5839 | `	if( rc == SXERR_ABORT ){` |
...
|       - |  5844 | `	{` |
|  186944 |  5845 | `		VmInstr *aInstr = (VmInstr *)SySetBasePtr(&pFunc->aByteCode);` |
|       - |  5846 | `		sxu32 i;` |
| 3654980 |  5847 | `		for( i = 0; i < SySetUsed(&pFunc->aByteCode); i++ ){` |
| 3468056 |  5848 | `			if( aInstr[i].iOp == PH7_OP_YIELD ){` |
...
|       - |  5919 | ` */` |
|   63364 |  5920 | `static sxi32 GenStateParseOneTypeAtom(ph7_gen_state *pGen, PhlTypeAtom *pOut)` |
|       2 |  5921 |  |
|   63366 |  5922 | `	SyToken *pIn = pGen->pIn;` |
|   63366 |  5923 | `	SyZero(pOut, sizeof(*pOut));` |
|   63366 |  5924 | `	SyStringInitFromBuf(&pOut->sClass, 0, 0);` |
|   63366 |  5925 | `	if( pIn >= pGen->pEnd ){` |
|     ! 0 |  5926 | `		return SXERR_SYNTAX;` |
|       - |  5927 | `	}` |
|       - |  5928 | `	/* Optional leading namespace separator '\' on FQN class types */` |
|   63366 |  5929 | `	if( pIn->nType & PH7_TK_NSSEP ){` |
|       8 |  5930 | `		pIn++;` |
|       8 |  5931 | `		if( pIn >= pGen->pEnd ){` |
|     ! 0 |  5932 | `			return SXERR_SYNTAX;` |
|       - |  5933 | `		}` |
|       3 |  5934 | `	}` |
|   63366 |  5935 | `	if( (pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|     ! 0 |  5936 | `		return SXERR_SYNTAX;` |
|       - |  5937 | `	}` |
|   63366 |  5938 | `	if( pIn->nType & PH7_TK_KEYWORD ){` |
|   54304 |  5939 | `		sxu32 nKey = (sxu32)(SX_PTR_TO_INT(pIn->pUserData));` |
|   54304 |  5940 | `		if( nKey & PH7_TKWRD_ARRAY ){` |
|      16 |  5941 | `			pOut->nType = MEMOBJ_HASHMAP; pOut->zCanon = "array"; pOut->nCanon = 5;` |
|   54297 |  5942 | `		}else if( nKey & PH7_TKWRD_BOOL ){` |
|      12 |  5943 | `			pOut->nType = MEMOBJ_BOOL; pOut->zCanon = "bool"; pOut->nCanon = 4;` |
|   54285 |  5944 | `		}else if( nKey & PH7_TKWRD_INT ){` |
|   15184 |  5945 | `			pOut->nType = MEMOBJ_INT; pOut->zCanon = "int"; pOut->nCanon = 3;` |
|   46689 |  5946 | `		}else if( nKey & PH7_TKWRD_STRING ){` |
|   39044 |  5947 | `			pOut->nType = MEMOBJ_STRING; pOut->zCanon = "string"; pOut->nCanon = 6;` |
|   19577 |  5948 | `		}else if( nKey & PH7_TKWRD_FLOAT ){` |
...
|    9064 |  5963 | `		SyString *pT = &pIn->sData;` |
|    9064 |  5964 | `		if( pT->nByte == 4 && SyMemcmpNoCase(pT->zString, "null", 4) == 0 ){` |
|      12 |  5965 | `			pOut->nType = UTA_NULL_FLAG; pOut->zCanon = "null"; pOut->nCanon = 4;` |
|      12 |  5966 | `			pIn++;` |
|    9059 |  5967 | `		}else if( pT->nByte == 4 && SyMemcmpNoCase(pT->zString, "void", 4) == 0 ){` |
|      18 |  5968 | `			pOut->nType = UTA_VOID_FLAG; pOut->zCanon = "void"; pOut->nCanon = 4;` |
|      18 |  5969 | `			pIn++;` |
|    9046 |  5970 | `		}else if( pT->nByte == 5 && SyMemcmpNoCase(pT->zString, "never", 5) == 0 ){` |
|       3 |  5971 | `			pOut->nType = UTA_NEVER_FLAG; pOut->zCanon = "never"; pOut->nCanon = 5;` |
|       3 |  5972 | `			pIn++;` |
|       2 |  5973 | `		}else{` |
|       - |  5974 | `			/* Class / interface name; consume namespace path a\b\c */` |
|    9036 |  5975 | `			SyToken *pFirst = pIn;` |
|    9036 |  5976 | `			SyToken *pLast = pIn;` |
|    9036 |  5977 | `			pOut->nType = SXU32_HIGH;` |
|    9036 |  5978 | `			pOut->sClass = pIn->sData;` |
|    9036 |  5979 | `			pIn++;` |
|   13554 |  5980 | `			while( pIn + 1 < pGen->pEnd && (pIn->nType & PH7_TK_NSSEP)` |
|    9039 |  5981 | `				&& (pIn[1].nType & PH7_TK_ID) ){` |
|       3 |  5982 | `				pLast = &pIn[1];` |
|       3 |  5983 | `				pIn += 2;` |
|       1 |  5984 | `			}` |
|    9036 |  5985 | `			if( pLast != pFirst ){` |
...
|       - |  5991 | `		}` |
|       - |  5992 | `	}` |
|   63364 |  5993 | `	pGen->pIn = pIn;` |
|   63364 |  5994 | `	return SXRET_OK;` |
|   31684 |  5995 |  |
|       - |  5996 |  |
|       - |  5997 | `/*` |
...
|       - |  6003 | ` */` |
|   63266 |  6004 | `static void GenBuildUnionTypeText(SyBlob *pBlob, PhlTypeAtom *aAtoms, int nAtoms, int bNullable)` |
|       2 |  6005 |  |
|       - |  6006 | `	int i;` |
|   63268 |  6007 | `	int nNonNull = 0;` |
|  126616 |  6008 | `	for( i = 0; i < nAtoms; i++ ){` |
|   63350 |  6009 | `		if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|   63340 |  6010 | `			nNonNull++;` |
|   31669 |  6011 | `		}` |
|   31676 |  6012 | `	}` |
|   63268 |  6013 | `	if( nNonNull == 1 && bNullable ){` |
|       - |  6014 | `		/* Shorthand: ?T */` |
...
|     ! 0 |  6025 | `	}` |
|       - |  6026 | `	{` |
|   63214 |  6027 | `		int bFirst = 1;` |
|       - |  6028 | `		/* 1) Classes in declaration order */` |
|  126502 |  6029 | `		for( i = 0; i < nAtoms; i++ ){` |
|   63290 |  6030 | `			if( aAtoms[i].nType == SXU32_HIGH ){` |
|    9030 |  6031 | `				if( !bFirst ) SyBlobAppend(pBlob, "\|", 1);` |
|    9030 |  6032 | `				SyBlobAppend(pBlob, aAtoms[i].sClass.zString, aAtoms[i].sClass.nByte);` |
|    9030 |  6033 | `				bFirst = 0;` |
|    4514 |  6034 | `			}` |
|   31646 |  6035 | `		}` |
...
|       - |  6040 | `			int k;` |
|  442486 |  6041 | `			for( k = 0; k < (int)(sizeof(aOrder)/sizeof(aOrder[0])); k++ ){` |
|  704668 |  6042 | `				for( i = 0; i < nAtoms; i++ ){` |
|  379638 |  6043 | `					if( aAtoms[i].nType == aOrder[k] ){` |
|   54244 |  6044 | `						if( !bFirst ) SyBlobAppend(pBlob, "\|", 1);` |
|   54244 |  6045 | `						SyBlobAppend(pBlob, aAtoms[i].zCanon, aAtoms[i].nCanon);` |
|   54244 |  6046 | `						bFirst = 0;` |
|   54244 |  6047 | `						break;` |
|       - |  6048 | `					}` |
|  162699 |  6049 | `				}` |
...
|       - |  6077 | ` */` |
|   63276 |  6078 | `static sxi32 GenStateParseUnionTypeDecl(` |
...
|   63278 |  6091 | `	int nAtoms = 0;` |
|   63278 |  6092 | `	int bShortNullable = 0;` |
|   63278 |  6093 | `	int bExplicitNull = 0;` |
|       - |  6094 | `	sxi32 rc;` |
|   63278 |  6095 | `	*pnType = 0;` |
|   63278 |  6096 | `	if( pClass ) SyStringInitFromBuf(pClass, 0, 0);` |
|   63278 |  6097 | `	*piTypeFlags = 0;` |
|   63278 |  6098 | `	if( pTypeText ) SyStringInitFromBuf(pTypeText, 0, 0);` |
|       - |  6099 |  |
|   63278 |  6100 | `	if( pGen->pIn >= pGen->pEnd ){` |
|     ! 0 |  6101 | `		return SXRET_OK;` |
|       - |  6102 | `	}` |
|       - |  6103 | ``	/* Optional `?` shorthand prefix */`` |
|   63276 |  6104 | `	if( (pGen->pIn->nType & PH7_TK_OP) && pGen->pIn->sData.nByte == 1` |
...
|   63278 |  6113 | `	rc = GenStateParseOneTypeAtom(pGen, &aAtoms[0]);` |
|   63278 |  6114 | `	if( rc != SXRET_OK ){` |
|       3 |  6115 | `		return rc;` |
|       - |  6116 | `	}` |
|   63276 |  6117 | `	nAtoms = 1;` |
|       - |  6118 | ``	/* Subsequent atoms separated by `\|` */`` |
|   95045 |  6119 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OP)` |
|   63410 |  6120 | `		&& pGen->pIn->sData.nByte == 1 && pGen->pIn->sData.zString[0] == '\|' ){` |
...
|       - |  6147 | `	{` |
|       - |  6148 | `		int i, j;` |
|   63274 |  6149 | `		int bHasNonNull = 0;` |
|  126628 |  6150 | `		for( i = 0; i < nAtoms; i++ ){` |
|   63362 |  6151 | `			if( aAtoms[i].nType == UTA_VOID_FLAG ){` |
|      18 |  6152 | `				if( nAtoms > 1 ){` |
...
|       - |  6166 | `				}` |
|       7 |  6167 | `			}` |
|   63360 |  6168 | `			if( aAtoms[i].nType == UTA_NEVER_FLAG ){` |
...
|       - |  6182 | `			}` |
|   63358 |  6183 | `			if( aAtoms[i].nType == UTA_NULL_FLAG ){` |
|      12 |  6184 | `				bExplicitNull = 1;` |
|       7 |  6185 | `			}else{` |
|   63348 |  6186 | `				bHasNonNull = 1;` |
|       - |  6187 | `			}` |
|       - |  6188 | `			/* Duplicate detection */` |
|   63476 |  6189 | `			for( j = 0; j < i; j++ ){` |
|     122 |  6190 | `				int bDup = 0;` |
...
|      61 |  6217 | `			}` |
|   31679 |  6218 | `		}` |
|   63268 |  6219 | `		if( !bHasNonNull && bExplicitNull ){` |
...
|   63268 |  6226 | `	if( bShortNullable \|\| bExplicitNull ){` |
|      60 |  6227 | `		*piTypeFlags \|= iNullableFlag;` |
|      29 |  6228 | `	}` |
|       - |  6229 | `	/* Build canonical type text */` |
|   63268 |  6230 | `	if( pTypeText ){` |
|       - |  6231 | `		SyBlob sBlob;` |
|   63268 |  6232 | `		SyBlobInit(&sBlob, &pGen->pVm->sAllocator);` |
|   94877 |  6233 | `		GenBuildUnionTypeText(&sBlob, aAtoms, nAtoms,` |
|   31633 |  6234 | `			(bShortNullable \|\| bExplicitNull) ? 1 : 0);` |
|   63268 |  6235 | `		if( SyBlobLength(&sBlob) > 0 ){` |
|   94880 |  6236 | `			char *zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|   63252 |  6237 | `				(const char *)SyBlobData(&sBlob), SyBlobLength(&sBlob));` |
|   63254 |  6238 | `			if( zDup ){` |
|   63254 |  6239 | `				SyStringInitFromBuf(pTypeText, zDup, SyBlobLength(&sBlob));` |
|   31626 |  6240 | `			}` |
|   31626 |  6241 | `		}` |
|   63268 |  6242 | `		SyBlobRelease(&sBlob);` |
|   31633 |  6243 | `	}` |
...
|       - |  6247 | `	{` |
|   63268 |  6248 | `		int nNonNull = 0;` |
|   63268 |  6249 | `		int iNonNullIdx = -1;` |
|       - |  6250 | `		int i;` |
|  126616 |  6251 | `		for( i = 0; i < nAtoms; i++ ){` |
|   63350 |  6252 | `			if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|   63340 |  6253 | `				nNonNull++;` |
|   63340 |  6254 | `				iNonNullIdx = i;` |
|   31669 |  6255 | `			}` |
|   31676 |  6256 | `		}` |
|   63268 |  6257 | `		if( nNonNull <= 1 ){` |
|       - |  6258 | `			/* Fast path: store as single type. */` |
|   63212 |  6259 | `			if( iNonNullIdx >= 0 ){` |
|   63212 |  6260 | `				PhlTypeAtom *pA = &aAtoms[iNonNullIdx];` |
|   63212 |  6261 | `				if( pA->nType == SXU32_HIGH ){` |
|   13520 |  6262 | `					char *zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|    4506 |  6263 | `						pA->sClass.zString, pA->sClass.nByte);` |
|    9014 |  6264 | `					if( zDup == 0 ) return SXERR_ABORT;` |
|    9014 |  6265 | `					*pnType = SXU32_HIGH;` |
|    9014 |  6266 | `					if( pClass ) SyStringInitFromBuf(pClass, zDup, pA->sClass.nByte);` |
|   58706 |  6267 | `				}else if( pA->nType == UTA_VOID_FLAG ){` |
...
|       - |  6306 | ` */` |
|  234960 |  6307 | `static sxi32 GenStateParseReturnType(ph7_gen_state *pGen, ph7_vm_func *pFunc)` |
|       2 |  6308 |  |
|  234962 |  6309 | `	sxi32 iFlags = 0;` |
|       - |  6310 | `	sxi32 rc;` |
|       - |  6311 | `	sxu32 nLine;` |
|  234962 |  6312 | `	pFunc->nReturnType = 0;` |
|  234962 |  6313 | `	SyStringInitFromBuf(&pFunc->sReturnClass, 0, 0);` |
|  234962 |  6314 | `	SyStringInitFromBuf(&pFunc->sReturnTypeName, 0, 0);` |
|  234962 |  6315 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COLON) == 0 ){` |
|  234826 |  6316 | `		return SXRET_OK;` |
|       - |  6317 | `	}` |
|     138 |  6318 | `	pGen->pIn++; /* Skip ':' */` |
|     138 |  6319 | `	if( pGen->pIn >= pGen->pEnd ){` |
|     ! 0 |  6320 | `		return SXRET_OK;` |
|       - |  6321 | `	}` |
|     138 |  6322 | `	nLine = pGen->pIn->nLine;` |
|     138 |  6323 | `	rc = GenStateParseUnionTypeDecl(` |
|      68 |  6324 | `		pGen,` |
|      68 |  6325 | `		&pFunc->nReturnType,` |
|      68 |  6326 | `		&pFunc->sReturnClass,` |
|      68 |  6327 | `		&pFunc->aReturnUnion,` |
|       - |  6328 | `		&iFlags,` |
|      68 |  6329 | `		&pFunc->sReturnTypeName,` |
|       - |  6330 | `		/* iNullableFlag */ 0, /* nullability for returns rides on aReturnUnion contents only */` |
|       - |  6331 | `		/* iUnionFlag */ 0,` |
|       - |  6332 | `		/* bAllowVoid */ 1,` |
|      68 |  6333 | `		nLine);` |
|      68 |  6334 | `	(void)iFlags;` |
|     138 |  6335 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  6336 | `		return SXERR_ABORT;` |
|       - |  6337 | `	}` |
|     138 |  6338 | `	if( rc == SXERR_CORRUPT ){` |
|       - |  6339 | `		/* Error already reported */` |
|     ! 0 |  6340 | `		return SXERR_SYNTAX;` |
|       - |  6341 | `	}` |
|     138 |  6342 | `	if( rc == SXERR_SYNTAX ){` |
...
|       - |  6352 | `	}` |
|     134 |  6353 | `	return SXRET_OK;` |
|  117482 |  6354 |  |
|       - |  6355 |  |
|   39784 |  6356 | `static sxi32 GenStateCompileFunc(` |
...
|   39786 |  6370 | `	nLine = pGen->pIn->nLine;` |
|       - |  6371 | `	/* Jump the left parenthesis '(' */` |
|   39786 |  6372 | `	pGen->pIn++;` |
|       - |  6373 | `	/* Delimit the function signature */` |
|   39786 |  6374 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   39786 |  6375 | `	if( pEnd >= pGen->pEnd ){` |
|       - |  6376 | `		/* Syntax error */` |
...
|   39780 |  6386 | `	pFunc = (ph7_vm_func *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_vm_func));` |
|   39780 |  6387 | `	if( pFunc == 0 ){` |
|     ! 0 |  6388 | `		goto OutOfMem;` |
|       - |  6389 | `	}` |
|       - |  6390 | `	/* Build the function name, prepending namespace if active */` |
|   39787 |  6391 | `	if( SyBlobLength(&pGen->sNamespace) > 0 && !bHandleClosure ){` |
|       - |  6392 | `		SyBlob sFQN;` |
|       - |  6393 | `		sxu32 nLen;` |
...
|       9 |  6405 | `	}else{` |
|   39766 |  6406 | `		zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|   39766 |  6407 | `		if( zName == 0 ){` |
|     ! 0 |  6408 | `			goto OutOfMem;` |
|       - |  6409 | `		}` |
|   39766 |  6410 | `		PH7_VmInitFuncState(pGen->pVm,pFunc,zName,pName->nByte,iFlags,0);` |
|       - |  6411 | `	}` |
|   39780 |  6412 | `	if( pGen->pIn < pEnd ){` |
|       - |  6413 | `		/* Collect function arguments */` |
|   27604 |  6414 | `		rc = GenStateCollectFuncArgs(pFunc,&(*pGen),pEnd,0,0);` |
|   27604 |  6415 | `		if( rc == SXERR_ABORT ){` |
...
|   39780 |  6421 | `	pGen->pIn = &pEnd[1];` |
|       - |  6422 | `	{` |
|   39780 |  6423 | `		sxi32 rcRt = GenStateParseReturnType(pGen, pFunc);` |
|   39780 |  6424 | `		if( rcRt == SXERR_ABORT ){` |
|     ! 0 |  6425 | `			return SXERR_ABORT;` |
|   39780 |  6426 | `		}else if( rcRt == SXERR_SYNTAX ){` |
|       5 |  6427 | `			return SXERR_SYNTAX;` |
|       - |  6428 | `		}` |
|       - |  6429 | `	}` |
|   39776 |  6430 | `	if( bHandleClosure ){` |
|       - |  6431 | `		ph7_vm_func_closure_env sEnv;` |
|     188 |  6432 | `		int got_this = 0; /* TRUE if $this have been seen */` |
|     186 |  6433 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD)` |
|     103 |  6434 | `			&& SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_USE ){` |
|      18 |  6435 | `				sxu32 nLineLocal = pGen->pIn->nLine;` |
|       - |  6436 | `				/* Closure,record environment variable */` |
|      18 |  6437 | `				pGen->pIn++;` |
|      18 |  6438 | `				if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
...
|       - |  6442 | `					}` |
|     ! 0 |  6443 | `				}` |
|      18 |  6444 | `				pGen->pIn++; /* Jump the left parenthesis or any other unexpected token */` |
|       - |  6445 | `				/* Compile until we hit the first closing parenthesis */` |
|      38 |  6446 | `				while( pGen->pIn < pGen->pEnd ){` |
|      38 |  6447 | `					int iFlagsLocal = 0;` |
|      38 |  6448 | `					if( pGen->pIn->nType & PH7_TK_RPAREN ){` |
|      18 |  6449 | `						pGen->pIn++; /* Jump the closing parenthesis */` |
|      18 |  6450 | `						break;` |
|       - |  6451 | `					}` |
|      22 |  6452 | `					nLineLocal = pGen->pIn->nLine;` |
|      22 |  6453 | `					if( pGen->pIn->nType & PH7_TK_AMPER ){` |
...
|     ! 0 |  6459 | `						pGen->pIn++;` |
|     ! 0 |  6460 | `					}` |
|      20 |  6461 | `					if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 \|\| &pGen->pIn[1] >= pGen->pEnd` |
|      22 |  6462 | `						\|\| (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|      22 |  6481 | `						pNameLocal = &pGen->pIn[1].sData;` |
|      22 |  6482 | `						zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,pNameLocal->zString,pNameLocal->nByte);` |
|      22 |  6483 | `						if( zDup ){` |
|       - |  6484 | `							/* Zero the structure */` |
|      22 |  6485 | `							SyZero(&sEnv,sizeof(ph7_vm_func_closure_env));` |
|      22 |  6486 | `							sEnv.iFlags = iFlagsLocal;` |
|      22 |  6487 | `							PH7_MemObjInit(pGen->pVm,&sEnv.sValue);` |
|      22 |  6488 | `							SyStringInitFromBuf(&sEnv.sName,zDup,pNameLocal->nByte);` |
|      22 |  6489 | `							if( !got_this && pNameLocal->nByte == sizeof("this")-1 &&` |
|     ! 0 |  6490 | `								SyMemcmp((const void *)zDup,(const void *)"this",sizeof("this")-1) == 0 ){` |
|     ! 0 |  6491 | `									got_this = 1;` |
|     ! 0 |  6492 | `							}` |
|       - |  6493 | `							/* Save imported variable */` |
|      22 |  6494 | `							SySetPut(&pFunc->aClosureEnv,(const void *)&sEnv);` |
|      12 |  6495 | `						}else{` |
|     ! 0 |  6496 | `							 PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|     ! 0 |  6497 | `							 return SXERR_ABORT;` |
|       - |  6498 | `						}` |
|       - |  6499 | `					}` |
|      22 |  6500 | `					pGen->pIn += 2; /* $ + variable name or any other unexpected token */` |
|      28 |  6501 | `					while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA /*','*/) ){` |
...
|       - |  6509 | `					 */` |
|      18 |  6510 | `					SyZero(&sEnv,sizeof(ph7_vm_func_closure_env));` |
|      18 |  6511 | `					sEnv.iFlags = VM_FUNC_ARG_IGNORE; /* Do not install if NULL */` |
|      18 |  6512 | `					PH7_MemObjInit(pGen->pVm,&sEnv.sValue);` |
|      18 |  6513 | `					SyStringInitFromBuf(&sEnv.sName,"this",sizeof("this")-1);` |
|      18 |  6514 | `					SySetPut(&pFunc->aClosureEnv,(const void *)&sEnv);` |
|       8 |  6515 | `				}` |
|      18 |  6516 | `				if( SySetUsed(&pFunc->aClosureEnv) > 0 ){` |
|       - |  6517 | `					/* Mark as closure */` |
|      18 |  6518 | `					pFunc->iFlags \|= VM_FUNC_CLOSURE;` |
|       8 |  6519 | `				}` |
|       8 |  6520 | `		}` |
|      93 |  6521 | `	}` |
|       - |  6522 | `	/* Compile the body */` |
|   39776 |  6523 | `	rc = GenStateCompileFuncBody(&(*pGen),pFunc);` |
|   39776 |  6524 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  6525 | `		return SXERR_ABORT;` |
|       - |  6526 | `	}` |
|   39776 |  6527 | `	if( ppFunc ){` |
|     188 |  6528 | `		*ppFunc = pFunc;` |
|      93 |  6529 | `	}` |
|   39776 |  6530 | `	rc = SXRET_OK;` |
|   39776 |  6531 | `	if( (pFunc->iFlags & VM_FUNC_CLOSURE) == 0 ){` |
|       - |  6532 | `		/* Finally register the function */` |
|   39760 |  6533 | `		rc = PH7_VmInstallUserFunction(pGen->pVm,pFunc,0);` |
|   19879 |  6534 | `	}` |
|   39776 |  6535 | `	if( rc == SXRET_OK ){` |
|   39776 |  6536 | `		return SXRET_OK;` |
|       - |  6537 | `	}` |
...
|       - |  6549 | ` */` |
|   39604 |  6550 | `static sxi32 PH7_CompileFunction(ph7_gen_state *pGen)` |
|       2 |  6551 |  |
|       - |  6552 | `	SyString *pName;` |
|       - |  6553 | `	sxi32 iFlags;` |
|       - |  6554 | `	sxu32 nLine;` |
|       - |  6555 | `	sxi32 rc;` |
|       - |  6556 |  |
|   39606 |  6557 | `	nLine = pGen->pIn->nLine;` |
|   39606 |  6558 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|   39606 |  6559 | `	iFlags = 0;` |
|   39606 |  6560 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|       - |  6561 | `		/* Return by reference,remember that */` |
|       7 |  6562 | `		iFlags \|= VM_FUNC_REF_RETURN;` |
|       - |  6563 | `		/* Jump the '&' token */` |
|       7 |  6564 | `		pGen->pIn++;` |
|       3 |  6565 | `	}` |
|   39606 |  6566 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|       - |  6577 | `	}` |
|   39602 |  6578 | `	pName = &pGen->pIn->sData;` |
|   39602 |  6579 | `	nLine = pGen->pIn->nLine;` |
|       - |  6580 | `	/* Jump the function name */` |
|   39602 |  6581 | `	pGen->pIn++;` |
|   39602 |  6582 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  6583 | `		/* Syntax error */` |
...
|   39600 |  6596 | `	rc = GenStateCompileFunc(&(*pGen),pName,iFlags,FALSE,0);` |
|   39600 |  6597 | `	return rc;` |
|   19804 |  6598 |  |
|       - |  6599 | `/*` |
...
|       - |  6609 | ` */` |
|  252414 |  6610 | `static sxi32 GetProtectionLevel(sxi32 nKeyword)` |
|       2 |  6611 |  |
|  252416 |  6612 | `	if( nKeyword == PH7_TKWRD_PRIVATE ){` |
|    9050 |  6613 | `		return PH7_CLASS_PROT_PRIVATE;` |
|  243368 |  6614 | `	}else if( nKeyword == PH7_TKWRD_PROTECTED ){` |
|   38940 |  6615 | `		return PH7_CLASS_PROT_PROTECTED;` |
|       - |  6616 | `	}` |
|       - |  6617 | `	/* Assume public by default */` |
|  204430 |  6618 | `	return PH7_CLASS_PROT_PUBLIC;` |
|  126209 |  6619 |  |
|       - |  6620 | `/*` |
...
|       - |  6774 | ` */` |
|  147266 |  6775 | `static int GenStateLooksLikeTypedProperty(SyToken *pStart,SyToken *pEnd)` |
|       2 |  6776 |  |
|  147268 |  6777 | `	SyToken *p = pStart;` |
|  147268 |  6778 | `	if( p >= pEnd ) return 0;` |
|  147268 |  6779 | `	if( (p->nType & PH7_TK_OP) && p->sData.nByte == 1 && p->sData.zString[0] == '?' ){` |
|      16 |  6780 | `		p++;` |
|      16 |  6781 | `		if( p >= pEnd ) return 0;` |
|       7 |  6782 | `	}` |
|  147268 |  6783 | `	if( p->nType & PH7_TK_NSSEP ){` |
|       3 |  6784 | `		p++;` |
|       3 |  6785 | `		if( p >= pEnd ) return 0;` |
|       1 |  6786 | `	}` |
|  147268 |  6787 | `	if( (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|     ! 0 |  6788 | `		return 0;` |
|       - |  6789 | `	}` |
...
|       - |  6793 | `	 * dispatch site. */` |
|  147268 |  6794 | `	if( p->nType & PH7_TK_KEYWORD ){` |
|  147250 |  6795 | `		sxu32 k = (sxu32)(SX_PTR_TO_INT(p->pUserData));` |
|  147300 |  6796 | `		if( k == PH7_TKWRD_FUNCTION \|\| k == PH7_TKWRD_VAR \|\| k == PH7_TKWRD_CONST` |
|    3149 |  6797 | `		 \|\| k == PH7_TKWRD_STATIC \|\| k == PH7_TKWRD_FINAL \|\| k == PH7_TKWRD_ABSTRACT ){` |
|  147146 |  6798 | `			return 0;` |
|       - |  6799 | `		}` |
|      52 |  6800 | `	}` |
|     124 |  6801 | `	p++;` |
|       - |  6802 | `	/* Consume optional namespace path */` |
|     126 |  6803 | `	while( p + 1 < pEnd && (p->nType & PH7_TK_NSSEP) && (p[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|       3 |  6804 | `		p += 2;` |
|       1 |  6805 | `	}` |
|       - |  6806 | ``	/* Consume any `\| Type` union alternatives */`` |
|     201 |  6807 | `	while( p < pEnd && (p->nType & PH7_TK_OP) && p->sData.nByte == 1` |
|      81 |  6808 | `		&& p->sData.zString[0] == '\|' ){` |
|      14 |  6809 | `		p++;` |
...
|     ! 0 |  6815 | `		}` |
|       2 |  6816 | `	}` |
|     124 |  6817 | `	if( p >= pEnd ) return 0;` |
|     124 |  6818 | `	return (p->nType & PH7_TK_DOLLAR) ? 1 : 0;` |
|   73635 |  6819 |  |
|       - |  6820 |  |
|       - |  6821 | `/*` |
...
|       - |  6838 | ` */` |
|     122 |  6839 | `static sxi32 GenStateParsePropertyType(` |
...
|       - |  6845 | `	SySet *pAlts` |
|       2 |  6846 | `){` |
|     124 |  6847 | `	sxi32 iFlags = 0;` |
|       - |  6848 | `	sxi32 rc;` |
|     124 |  6849 | `	if( pGen->pIn >= pGen->pEnd ){` |
|     ! 0 |  6850 | `		return SXRET_OK;` |
|       - |  6851 | `	}` |
|       - |  6852 | `	/* If the first token is '$', there's no type */` |
|     124 |  6853 | `	if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|     ! 0 |  6854 | `		return SXRET_OK;` |
|       - |  6855 | `	}` |
|     124 |  6856 | `	rc = GenStateParseUnionTypeDecl(` |
|      61 |  6857 | `		pGen, pnType, pClass, pAlts, &iFlags, pTypeText,` |
|       - |  6858 | `		PH7_CLASS_ATTR_NULLABLE,` |
|       - |  6859 | `		PH7_CLASS_ATTR_UNION,` |
|       - |  6860 | `		/* bAllowVoid */ 0,` |
|     122 |  6861 | `		pGen->pIn->nLine);` |
|     124 |  6862 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  6863 | `		return rc;` |
|       - |  6864 | `	}` |
|       - |  6865 | `	/* Verify next token is '$' (start of property name) */` |
|     124 |  6866 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
|     ! 0 |  6867 | `		return SXERR_SYNTAX;` |
|       - |  6868 | `	}` |
|     124 |  6869 | `	*piTypeFlags = iFlags \| PH7_CLASS_ATTR_TYPED;` |
|     124 |  6870 | `	return SXRET_OK;` |
|      63 |  6871 |  |
|       - |  6872 |  |
|       - |  6873 | `/*` |
...
|       - |  6883 | ` */` |
|     188 |  6884 | `static int GenStateIsDisallowedPropertyAtom(` |
|       - |  6885 | `	sxu32 nType,` |
...
|       - |  6890 | `	const char *z;` |
|       - |  6891 | `	sxu32 n;` |
|     190 |  6892 | `	if( nType != SXU32_HIGH \|\| pClass == 0 \|\| pClass->nByte == 0 ){` |
|     160 |  6893 | `		return 0;` |
|       - |  6894 | `	}` |
...
|       - |  6918 | ` */` |
|     160 |  6919 | `static sxi32 GenStateValidatePropertyType(` |
...
|       - |  6927 | `	sxu32 nLine)` |
|       2 |  6928 |  |
|     162 |  6929 | `	const char *zBad = 0;` |
|     162 |  6930 | `	sxu32 nBad = 0;` |
|       - |  6931 | `	SyString sFallback;` |
|       - |  6932 | `	const SyString *pBad;` |
|       - |  6933 | `	sxi32 rc;` |
|     162 |  6934 | `	int bDisallowed = 0;` |
|     162 |  6935 | `	if( GenStateIsDisallowedPropertyAtom(nType,pTypeClass,&zBad,&nBad) ){` |
|       3 |  6936 | `		bDisallowed = 1;` |
|     161 |  6937 | `	}else if( pUnionAlts ){` |
|       - |  6938 | `		sxu32 i;` |
...
|      15 |  6945 | `		}` |
|       7 |  6946 | `	}` |
|     162 |  6947 | `	if( !bDisallowed ){` |
|     158 |  6948 | `		return SXRET_OK;` |
|       - |  6949 | `	}` |
...
|      82 |  6966 |  |
|       - |  6967 |  |
|   57284 |  6968 | `static sxi32 GenStateCompileClassAttr(ph7_gen_state *pGen,sxi32 iProtection,sxi32 iFlags,ph7_class *pClass)` |
|       2 |  6969 |  |
|   57286 |  6970 | `	sxu32 nLine = pGen->pIn->nLine;` |
|       - |  6971 | `	ph7_class_attr *pAttr;` |
|       - |  6972 | `	SyString *pName;` |
|       - |  6973 | `	sxi32 rc;` |
|   57286 |  6974 | `	sxu32 nType = 0;` |
|       - |  6975 | `	SyString sTypeClass;` |
|       - |  6976 | `	SyString sTypeText;` |
|       - |  6977 | `	SySet aUnionAlts;` |
|   57286 |  6978 | `	sxi32 iTypeFlags = 0;` |
|   57286 |  6979 | `	SyStringInitFromBuf(&sTypeClass,0,0);` |
|   57286 |  6980 | `	SyStringInitFromBuf(&sTypeText,0,0);` |
|   57286 |  6981 | `	SySetInit(&aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|       - |  6982 | `	/* Extract visibility level */` |
|   57286 |  6983 | `	iProtection = GetProtectionLevel(iProtection);` |
|       - |  6984 | `	/* Parse optional type hint (typed properties, PHP 7.4+) */` |
|   57347 |  6985 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
|     124 |  6986 | `		rc = GenStateParsePropertyType(pGen,&nType,&sTypeClass,&iTypeFlags,&sTypeText,&aUnionAlts);` |
|     124 |  6987 | `		if( rc == SXERR_CORRUPT ){` |
|       - |  6988 | `			/* Error already reported by GenStateParseUnionTypeDecl */` |
|     ! 0 |  6989 | `			goto Synchronize;` |
|     124 |  6990 | `		}else if( rc == SXERR_SYNTAX ){` |
...
|     124 |  6998 | `		}else if( rc == SXERR_ABORT ){` |
|     ! 0 |  6999 | `			return SXERR_ABORT;` |
|       - |  7000 | `		}` |
|      61 |  7001 | `	}` |
|     ! 0 |  7002 | `loop:` |
|   57290 |  7003 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
...
|       - |  7009 | `	}` |
|   57290 |  7010 | `	pGen->pIn++; /* Jump the dollar sign */` |
|   57290 |  7011 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_ID)) == 0 ){` |
...
|   57290 |  7021 | `	pName = &pGen->pIn->sData;` |
|       - |  7022 | `	/* Advance the stream cursor */` |
|   57290 |  7023 | `	pGen->pIn++;` |
|   57290 |  7024 | `	if(pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_EQUAL/*'='*/\|PH7_TK_SEMI/*';'*/\|PH7_TK_COMMA/*','*/)) == 0 ){` |
...
|   57288 |  7036 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|     191 |  7037 | `		rc = GenStateValidatePropertyType(pGen,pClass,pName,nType,&sTypeClass,` |
|       - |  7038 | `			&sTypeText,` |
|     126 |  7039 | `			(iTypeFlags & PH7_CLASS_ATTR_UNION) ? &aUnionAlts : 0,nLine);` |
|     128 |  7040 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  7041 | `			return SXERR_ABORT;` |
|     128 |  7042 | `		}else if( rc != SXRET_OK ){` |
|     ! 0 |  7043 | `			goto Synchronize;` |
|       - |  7044 | `		}` |
|      63 |  7045 | `	}` |
|       - |  7046 | `	/* Reject redeclaration (catches clash with an earlier promoted property). */` |
|   57288 |  7047 | `	if( PH7_ClassExtractAttribute(pClass,pName->zString,pName->nByte) != 0 ){` |
...
|   57286 |  7056 | `	pAttr = PH7_NewClassAttr(pGen->pVm,pName,nLine,iProtection,iFlags\|iTypeFlags);` |
|   57286 |  7057 | `	if( pAttr == 0 ){` |
|     ! 0 |  7058 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 engine is running out of memory");` |
|     ! 0 |  7059 | `		return SXERR_ABORT;` |
|       - |  7060 | `	}` |
|   57286 |  7061 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|     126 |  7062 | `		pAttr->nType = nType;` |
|     126 |  7063 | `		pAttr->sClass = sTypeClass;` |
|     126 |  7064 | `		pAttr->sTypeName = sTypeText;` |
|     126 |  7065 | `		if( iTypeFlags & PH7_CLASS_ATTR_UNION ){` |
...
|       5 |  7076 | `		}` |
|      62 |  7077 | `	}` |
|   57286 |  7078 | `	if( pGen->pIn->nType & PH7_TK_EQUAL /*'='*/ ){` |
|       - |  7079 | `		SySet *pInstrContainer;` |
|   18284 |  7080 | `		pGen->pIn++; /*Jump the equal sign */` |
|       - |  7081 | `		/* Swap bytecode container */` |
|   18284 |  7082 | `		pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   18284 |  7083 | `		PH7_VmSetByteCodeContainer(pGen->pVm,&pAttr->aByteCode);` |
|       - |  7084 | `		/* Compile attribute value.` |
|       - |  7085 | `		 */` |
|   18284 |  7086 | `		rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|   18284 |  7087 | `		if( rc == SXERR_EMPTY ){` |
...
|   18284 |  7094 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|   18284 |  7095 | `		PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|    9141 |  7096 | `	}` |
|       - |  7097 | `	/* All done,install the attribute */` |
|   57286 |  7098 | `	rc = PH7_ClassInstallAttr(pClass,pAttr);` |
|   57286 |  7099 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  7100 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|     ! 0 |  7101 | `		return SXERR_ABORT;` |
|       - |  7102 | `	}` |
|   57286 |  7103 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA /*','*/) ){` |
...
|       - |  7121 | `		}` |
|     ! 0 |  7122 | `	}` |
|   57282 |  7123 | `	SySetRelease(&aUnionAlts);` |
|   57282 |  7124 | `	return SXRET_OK;` |
|       2 |  7125 | `Synchronize:` |
...
|       - |  7140 | ` */` |
|  195100 |  7141 | `static sxi32 GenStateCompileClassMethod(` |
...
|       - |  7147 | `	)` |
|       2 |  7148 |  |
|  195102 |  7149 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|  195102 |  7156 | `	iProtection = GetProtectionLevel(iProtection);` |
|  195102 |  7157 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|  195102 |  7158 | `	iFuncFlags = 0;` |
|  195102 |  7159 | `	if( pGen->pIn >= pGen->pEnd ){` |
...
|       - |  7167 | `	}` |
|  195102 |  7168 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|       - |  7169 | `		/* Return by reference,remember that */` |
|     ! 0 |  7170 | `		iFuncFlags \|= VM_FUNC_REF_RETURN;` |
|       - |  7171 | `		/* Jump the '&' token */` |
|     ! 0 |  7172 | `		pGen->pIn++;` |
|     ! 0 |  7173 | `	}` |
|  195102 |  7174 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|  195102 |  7183 | `	pName = &pGen->pIn->sData;` |
|  195102 |  7184 | `	nLine = pGen->pIn->nLine;` |
|       - |  7185 | `	/* Jump the method name */` |
|  195102 |  7186 | `	pGen->pIn++;` |
|  195102 |  7187 | `	if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|       - |  7188 | `		/* Abstract method */` |
|   47924 |  7189 | `		if( iProtection == PH7_CLASS_PROT_PRIVATE ){` |
...
|   47924 |  7198 | `		doBody = FALSE;` |
|   23961 |  7199 | `	}` |
|  195102 |  7200 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  7201 | `		/* Syntax error */` |
...
|  195102 |  7210 | `	pMeth = PH7_NewClassMethod(pGen->pVm,pClass,pName,nLine,iProtection,iFlags,iFuncFlags);` |
|  195102 |  7211 | `	if( pMeth == 0 ){` |
...
|  195102 |  7216 | `	pGen->pIn++;` |
|  195102 |  7217 | `	pEnd = 0; /* cc warning */` |
|       - |  7218 | `	/* Delimit the method signature */` |
|  195102 |  7219 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|  195102 |  7220 | `	if( pEnd >= pGen->pEnd ){` |
|       - |  7221 | `		/* Syntax error */` |
...
|       - |  7228 | `	}` |
|       - |  7229 | `	{` |
|  195100 |  7230 | `		int bIsCtor = 0;` |
|  195100 |  7231 | `		int bAbstractCtor = 0;` |
|  283624 |  7232 | `		if( (pName->nByte == sizeof("__construct") - 1` |
|  117057 |  7233 | `				&& SyMemcmp(pName->zString,"__construct",sizeof("__construct") - 1) == 0)` |
|  186077 |  7234 | `		 \|\| SyStringCmp(pName,&pClass->sName,SyMemcmp) == 0 ){` |
|   18048 |  7235 | `			if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|       3 |  7236 | `				bAbstractCtor = 1;` |
|       2 |  7237 | `			}else{` |
|   18046 |  7238 | `				bIsCtor = 1;` |
|       - |  7239 | `			}` |
|    9023 |  7240 | `		}` |
|  195100 |  7241 | `		if( pGen->pIn < pEnd ){` |
|       - |  7242 | `			/* Collect method arguments */` |
|   33092 |  7243 | `			rc = GenStateCollectFuncArgs(&pMeth->sFunc,&(*pGen),pEnd,bIsCtor,bAbstractCtor);` |
|   33092 |  7244 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  7245 | `				return SXERR_ABORT;` |
|       - |  7246 | `			}` |
|   16545 |  7247 | `		}` |
|       - |  7248 | `	}` |
|       - |  7249 | `	/* Point past ')' and parse optional return type ': type' */` |
|  195100 |  7250 | `	pGen->pIn = &pEnd[1];` |
|       - |  7251 | `	{` |
|  195100 |  7252 | `		sxi32 rcRt = GenStateParseReturnType(pGen, &pMeth->sFunc);` |
|  195100 |  7253 | `		if( rcRt == SXERR_ABORT ){` |
|     ! 0 |  7254 | `			return SXERR_ABORT;` |
|  195100 |  7255 | `		}else if( rcRt == SXERR_SYNTAX ){` |
...
|       - |  7262 | `	{` |
|  195100 |  7263 | `		sxu32 nArg = SySetUsed(&pMeth->sFunc.aArgs);` |
|       - |  7264 | `		sxu32 i;` |
|  255168 |  7265 | `		for( i = 0; i < nArg; i++ ){` |
|   60078 |  7266 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pMeth->sFunc.aArgs,i);` |
|       - |  7267 | `			ph7_class_attr *pAttr;` |
|   60078 |  7268 | `			sxi32 iAttrFlags = 0;` |
|   60078 |  7269 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|   60042 |  7270 | `				continue;` |
|       - |  7271 | `			}` |
...
|      16 |  7335 | `		}` |
|       - |  7336 | `	}` |
|  195092 |  7337 | `	if( doBody ){` |
|       - |  7338 | `		/* Compile method body */` |
|  147170 |  7339 | `		rc = GenStateCompileFuncBody(&(*pGen),&pMeth->sFunc);` |
|  147170 |  7340 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  7341 | `			return SXERR_ABORT;` |
|       - |  7342 | `		}` |
|   73586 |  7343 | `	}else{` |
|       - |  7344 | `		/* Only method signature is allowed */` |
|   47924 |  7345 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI /* ';'*/) == 0 ){` |
...
|       - |  7378 | ` */` |
|   12010 |  7379 | `static sxi32 PH7_CompileClassInterface(ph7_gen_state *pGen)` |
|       2 |  7380 |  |
|   12012 |  7381 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|   12012 |  7390 | `	pName = &pGen->pIn->sData;` |
|       - |  7391 | `	/* Advance the stream cursor */` |
|   12012 |  7392 | `	pGen->pIn++;` |
|       - |  7393 | `	/* Build FQN and obtain a raw class */ {` |
|       - |  7394 | `		SyBlob sFQN;` |
|       - |  7395 | `		SyString sFQNStr;` |
|   12012 |  7396 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|   12012 |  7397 | `		GenStateBuildFQN(pGen,pName,&sFQN);` |
|   12012 |  7398 | `		SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|   12012 |  7399 | `		pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|   12012 |  7400 | `		SyBlobRelease(&sFQN);` |
|       - |  7401 | `	}` |
|   12012 |  7402 | `	if( pClass == 0 ){` |
...
|   12012 |  7407 | `	pClass->iFlags = PH7_CLASS_INTERFACE;` |
|       - |  7408 | `	/* Assume no base class is given */` |
|   12012 |  7409 | `	pBase = 0;` |
|   12012 |  7410 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
...
|       3 |  7448 | `		}` |
|       3 |  7449 | `	}` |
|   12012 |  7450 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|       - |  7451 | `		/* Syntax error */` |
...
|       - |  7459 | `	}` |
|   12012 |  7460 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|   12012 |  7461 | `	pEnd = 0; /* cc warning */` |
|       - |  7462 | `	/* Delimit the interface body */` |
|   12012 |  7463 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|   12012 |  7464 | `	if( pEnd >= pGen->pEnd ){` |
|       - |  7465 | `		/* Syntax error */` |
...
|   12012 |  7475 | `	pTmp = pGen->pEnd;` |
|   12012 |  7476 | `	pGen->pEnd = pEnd;` |
...
|  107832 |  7484 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|   47912 |  7485 | `			pGen->pIn++;` |
|       2 |  7486 | `		}` |
|   59922 |  7487 | `		if( pGen->pIn >= pGen->pEnd ){` |
|       - |  7488 | `			/* End of interface body */` |
|   12010 |  7489 | `			break;` |
|       - |  7490 | `		}` |
|   47914 |  7491 | `		if( (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|   47914 |  7502 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   47914 |  7503 | `		if( nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
...
|       3 |  7532 | `			goto done;` |
|       - |  7533 | `		}` |
|   47912 |  7534 | `		if( nKwrd != PH7_TKWRD_PUBLIC && nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|     ! 0 |  7541 | `			goto done;` |
|       - |  7542 | `		}` |
|   47912 |  7543 | `		if( nKwrd == PH7_TKWRD_PUBLIC ){` |
|       - |  7544 | `			/* Advance the stream cursor */` |
|   47908 |  7545 | `			pGen->pIn++;` |
|   47908 |  7546 | `			if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|     ! 0 |  7553 | `				goto done;` |
|       - |  7554 | `			}` |
|   47908 |  7555 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   47908 |  7556 | `			if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|       - |  7564 | `			}` |
|   23953 |  7565 | `		}` |
|   47912 |  7566 | `		if( nKwrd == PH7_TKWRD_CONST ){` |
|       - |  7567 | `			/* Parse constant */` |
...
|       - |  7574 | `			}` |
|       2 |  7575 | `		}else{` |
|   47910 |  7576 | `			sxi32 iFlags = PH7_CLASS_ATTR_ABSTRACT; /* Interface methods are implicitly abstract */` |
|   47910 |  7577 | `			if( nKwrd == PH7_TKWRD_STATIC ){` |
...
|   47910 |  7594 | `			rc = GenStateCompileClassMethod(&(*pGen),0,iFlags,FALSE,pClass);` |
|   47910 |  7595 | `			if( rc != SXRET_OK ){` |
...
|   12010 |  7604 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|   12010 |  7605 | `	if( rc == SXRET_OK && pBase ){` |
|       - |  7606 | `		/* Inherit from the base interface */` |
|       8 |  7607 | `		rc = PH7_ClassInterfaceInherit(pClass,pBase);` |
|       3 |  7608 | `	}` |
|   12010 |  7609 | `	if( rc != SXRET_OK ){` |
...
|   12012 |  7615 | `	pGen->pIn  = &pEnd[1];` |
|   12012 |  7616 | `	pGen->pEnd = pTmp;` |
|   12012 |  7617 | `	return PH7_OK;` |
|    6007 |  7618 |  |
|       - |  7619 | `/*` |
...
|       - |  7643 | ` */` |
|   42692 |  7644 | `static sxi32 GenStateCheckInterfaceSignatures(ph7_gen_state *pGen,ph7_class *pClass)` |
|       2 |  7645 |  |
|       - |  7646 | `	ph7_class **apIface;` |
|       - |  7647 | `	sxu32 nIface,i;` |
|       - |  7648 | `	sxi32 rc;` |
|   42694 |  7649 | `	if( pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|     ! 0 |  7650 | `		return SXRET_OK;` |
|       - |  7651 | `	}` |
|   42694 |  7652 | `	apIface = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|   42694 |  7653 | `	nIface = SySetUsed(&pClass->aInterface);` |
|   51712 |  7654 | `	for(i = 0; i < nIface; i++){` |
|    9020 |  7655 | `		ph7_class *pIface = apIface[i];` |
|       - |  7656 | `		SyHashEntry *pEntry;` |
|    9020 |  7657 | `		SyHashResetLoopCursor(&pIface->hMethod);` |
|   71962 |  7658 | `		while((pEntry = SyHashGetNextEntry(&pIface->hMethod)) != 0 ){` |
|   62944 |  7659 | `			ph7_class_method *pIfaceMeth = (ph7_class_method *)pEntry->pUserData;` |
|       - |  7660 | `			ph7_class_method *pImplMeth;` |
|   62944 |  7661 | `			SyString *pMName = &pIfaceMeth->sFunc.sName;` |
|       - |  7662 | `			/* Find the implementing method in the class */` |
|   62944 |  7663 | `			pImplMeth = PH7_ClassExtractMethod(pClass,pMName->zString,pMName->nByte);` |
|   62944 |  7664 | `			if( pImplMeth == 0 \|\| (pImplMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT) ){` |
...
|   62930 |  7668 | `			if( pImplMeth->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|       - |  7678 | `			 */` |
|       - |  7679 | `			{` |
|   62930 |  7680 | `				sxu32 nIfaceArgs = SySetUsed(&pIfaceMeth->sFunc.aArgs);` |
|   62930 |  7681 | `				sxu32 nImplArgs = SySetUsed(&pImplMeth->sFunc.aArgs);` |
|   62930 |  7682 | `				int sigError = 0;` |
|   62930 |  7683 | `				if( nImplArgs < nIfaceArgs ){` |
|       3 |  7684 | `					sigError = 1;` |
|   62929 |  7685 | `				}else if( nImplArgs > nIfaceArgs ){` |
...
|       - |  7736 | ` */` |
|   42692 |  7737 | `static sxi32 GenStateCheckAbstractMethods(ph7_gen_state *pGen,ph7_class *pClass)` |
|       2 |  7738 |  |
...
|   42694 |  7745 | `	if( pClass->iFlags & (PH7_CLASS_ABSTRACT\|PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|      22 |  7746 | `		return SXRET_OK;` |
|       - |  7747 | `	}` |
|       - |  7748 | `	/* Count abstract methods */` |
|   42674 |  7749 | `	nAbstract = 0;` |
|   42674 |  7750 | `	SyHashResetLoopCursor(&pClass->hMethod);` |
|  402848 |  7751 | `	while((pEntry = SyHashGetNextEntry(&pClass->hMethod)) != 0 ){` |
|  360176 |  7752 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|  360176 |  7753 | `		if( pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|      17 |  7754 | `			nAbstract++;` |
|       8 |  7755 | `		}` |
|       2 |  7756 | `	}` |
|   42674 |  7757 | `	if( nAbstract == 0 ){` |
|   42660 |  7758 | `		return SXRET_OK;` |
|       - |  7759 | `	}` |
...
|       - |  7892 | ` */` |
|   33418 |  7893 | `static sxi32 GenStateParseClassReference(ph7_gen_state *pGen,SyBlob *pFqn)` |
|       2 |  7894 |  |
|   33420 |  7895 | `	int isAbsolute = 0;` |
|   33420 |  7896 | `	SyToken *pStart = pGen->pIn;` |
|       - |  7897 | `	SyBlob sName;` |
|   33420 |  7898 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) ){` |
|      28 |  7899 | `		isAbsolute = 1;` |
|      28 |  7900 | `		pGen->pIn++;` |
|      13 |  7901 | `	}` |
|   33420 |  7902 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|       7 |  7903 | `		pGen->pIn = pStart;` |
|       7 |  7904 | `		return SXERR_INVALID;` |
|       - |  7905 | `	}` |
|   33414 |  7906 | `	SyBlobInit(&sName,&pGen->pVm->sAllocator);` |
|   33414 |  7907 | `	SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|   33414 |  7908 | `	pGen->pIn++;` |
|   50136 |  7909 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) &&` |
|   16726 |  7910 | `		&pGen->pIn[1] < pGen->pEnd && (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|      13 |  7911 | `		SyBlobAppend(&sName,"\\",1);` |
|      13 |  7912 | `		pGen->pIn++;` |
|      13 |  7913 | `		SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|      13 |  7914 | `		pGen->pIn++;` |
|       1 |  7915 | `	}` |
|   33414 |  7916 | `	if( isAbsolute ){` |
|      25 |  7917 | `		SyBlobAppend(pFqn,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|      13 |  7918 | `	}else{` |
|       - |  7919 | `		SyString sRaw;` |
|   33390 |  7920 | `		SyStringInitFromBuf(&sRaw,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|   33390 |  7921 | `		GenStateResolveName(pGen,&sRaw,pFqn);` |
|       - |  7922 | `	}` |
|   33414 |  7923 | `	SyBlobRelease(&sName);` |
|   33414 |  7924 | `	return SXRET_OK;` |
|   16711 |  7925 |  |
|       - |  7926 | `/*` |
...
|    9024 |  7934 | `static int GenStateInterfaceIsThrowableAt(ph7_class *pInterface,int iDepth)` |
|       2 |  7935 |  |
|       - |  7936 | `	ph7_class **apParent;` |
|       - |  7937 | `	sxu32 n;` |
|   12062 |  7938 | `	while( pInterface ){` |
|    9032 |  7939 | `		if( iDepth > PH7_THROWABLE_WALK_MAX_DEPTH ){` |
|     ! 0 |  7940 | `			return FALSE;` |
|       - |  7941 | `		}` |
|   12032 |  7942 | `		if( pInterface->sName.nByte == sizeof("Throwable")-1 &&` |
|    6000 |  7943 | `			SyMemcmp(pInterface->sName.zString,"Throwable",sizeof("Throwable")-1) == 0 ){` |
|    5996 |  7944 | `			return TRUE;` |
|       - |  7945 | `		}` |
|    3038 |  7946 | `		apParent = (ph7_class **)SySetBasePtr(&pInterface->aInterface);` |
|    3038 |  7947 | `		for( n = 0 ; n < SySetUsed(&pInterface->aInterface) ; ++n ){` |
|     ! 0 |  7948 | `			if( GenStateInterfaceIsThrowableAt(apParent[n],iDepth+1) ){` |
|     ! 0 |  7949 | `				return TRUE;` |
|       - |  7950 | `			}` |
|     ! 0 |  7951 | `		}` |
|    3038 |  7952 | `		pInterface = pInterface->pBase;` |
|    3038 |  7953 | `		iDepth++;` |
|       2 |  7954 | `	}` |
|    3032 |  7955 | `	return FALSE;` |
|    4514 |  7956 |  |
|    9024 |  7957 | `static int GenStateInterfaceIsThrowable(ph7_class *pInterface)` |
|       2 |  7958 |  |
|    9026 |  7959 | `	return GenStateInterfaceIsThrowableAt(pInterface,0);` |
|       2 |  7960 |  |
|       - |  7961 | `/*` |
...
|       - |  7965 | ` */` |
|    5994 |  7966 | `static int GenStateClassIsExceptionOrError(ph7_class *pBase)` |
|       2 |  7967 |  |
|    6000 |  7968 | `	while( pBase ){` |
...
|       1 |  7978 | `	}` |
|    5992 |  7979 | `	return FALSE;` |
|    2999 |  7980 |  |
|   42708 |  7981 | `static sxi32 GenStateCompileClass(ph7_gen_state *pGen,sxi32 iFlags)` |
|       2 |  7982 |  |
|   42710 |  7983 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|   42710 |  7994 | `	pGen->pIn++;` |
|   42710 |  7995 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
|       - |  7996 | `		/* Syntax error */` |
...
|   42710 |  8009 | `	pName = &pGen->pIn->sData;` |
|       - |  8010 | `	/* Advance the stream cursor */` |
|   42710 |  8011 | `	pGen->pIn++;` |
|       - |  8012 | `	/* Build FQN and obtain a raw class */ {` |
|       - |  8013 | `		SyBlob sFQN;` |
|       - |  8014 | `		SyString sFQNStr;` |
|   42710 |  8015 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|   42710 |  8016 | `		GenStateBuildFQN(pGen,pName,&sFQN);` |
|   42710 |  8017 | `		SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|   42710 |  8018 | `		pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|   42710 |  8019 | `		SyBlobRelease(&sFQN);` |
|       - |  8020 | `	}` |
|   42710 |  8021 | `	if( pClass == 0 ){` |
...
|   42710 |  8026 | `	SySetInit(&aInterfaces,&pGen->pVm->sAllocator,sizeof(ph7_class *));` |
|   42710 |  8027 | `	SySetInit(&aUseEntries,&pGen->pVm->sAllocator,sizeof(TraitUseEntry));` |
|       - |  8028 | `	/* Assume a standalone class */` |
|   42710 |  8029 | `	pBase = 0;` |
|   42710 |  8030 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|   33096 |  8031 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   33096 |  8032 | `		if( nKwrd == PH7_TKWRD_EXTENDS /* class b extends a */ ){` |
|       - |  8033 | `			SyBlob sResolved;` |
|       - |  8034 | `			SyString sBaseName;` |
|       - |  8035 | `			sxu32 nRefLine;` |
|   24078 |  8036 | `			pGen->pIn++; /* Advance past 'extends' */` |
|   24078 |  8037 | `			nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|   24078 |  8038 | `			SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|   24078 |  8039 | `			if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|       - |  8049 | `			}` |
|   36113 |  8050 | `			pBase = PH7_VmExtractClass(pGen->pVm,` |
|   24074 |  8051 | `				(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|   24076 |  8052 | `			SyStringInitFromBuf(&sBaseName,` |
|       - |  8053 | `				(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|       - |  8054 | `			/* Interfaces are not allowed */` |
|   24076 |  8055 | `			while( pBase && (pBase->iFlags & PH7_CLASS_INTERFACE) ){` |
|     ! 0 |  8056 | `				pBase = pBase->pNextName;` |
|     ! 0 |  8057 | `			}` |
|   24076 |  8058 | `			if( pBase == 0 ){` |
...
|       - |  8064 | `				}` |
|     ! 0 |  8065 | `			}else{` |
|   24076 |  8066 | `				if( pBase->iFlags & PH7_CLASS_FINAL ){` |
...
|     ! 0 |  8073 | `				}` |
|       - |  8074 | `			}` |
|   24076 |  8075 | `			SyBlobRelease(&sResolved);` |
|   12037 |  8076 | `		}` |
|   33094 |  8077 | `		if (pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) && SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_IMPLEMENTS ){` |
|       - |  8078 | `			ph7_class *pInterface;` |
|       - |  8079 | `			/* Interface implementation */` |
|    9026 |  8080 | `			pGen->pIn++; /* Advance the stream cursor */` |
|    4512 |  8081 | `			for(;;){` |
|       - |  8082 | `				SyBlob sResolved;` |
|       - |  8083 | `				SyString sIntName;` |
|       - |  8084 | `				sxu32 nRefLine;` |
|    9026 |  8085 | `				nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|    9026 |  8086 | `				SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|    9026 |  8087 | `				if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|     ! 0 |  8095 | `					break;` |
|       - |  8096 | `				}` |
|   18050 |  8097 | `				pInterface = PH7_VmExtractClass(pGen->pVm,` |
|    9024 |  8098 | `					(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|    9026 |  8099 | `				SyStringInitFromBuf(&sIntName,` |
|       - |  8100 | `					(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|       - |  8101 | `				/* Only interfaces are allowed */` |
|    9026 |  8102 | `				while( pInterface && (pInterface->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|     ! 0 |  8103 | `					pInterface = pInterface->pNextName;` |
|     ! 0 |  8104 | `				}` |
|    9026 |  8105 | `				if( pInterface == 0 ){` |
...
|    9026 |  8119 | `					SyString *pFqn = &pClass->sName;` |
|    9026 |  8120 | `					int bIsExceptionOrError =` |
|    7504 |  8121 | `						(pFqn->nByte == sizeof("Exception")-1 &&` |
|   15032 |  8122 | `						 SyMemcmp(pFqn->zString,"Exception",sizeof("Exception")-1) == 0) \|\|` |
|    7531 |  8123 | `						(pFqn->nByte == sizeof("Error")-1 &&` |
|    2998 |  8124 | `						 SyMemcmp(pFqn->zString,"Error",sizeof("Error")-1) == 0);` |
|   15016 |  8125 | `					if( GenStateInterfaceIsThrowable(pInterface) &&` |
|    8991 |  8126 | `						!GenStateClassIsExceptionOrError(pBase) &&` |
|    2995 |  8127 | `						!bIsExceptionOrError ){` |
...
|       4 |  8137 | `					}else{` |
|    9020 |  8138 | `						SySetPut(&aInterfaces,(const void *)&pInterface);` |
|       - |  8139 | `					}` |
|       - |  8140 | `				}` |
|    9026 |  8141 | `				SyBlobRelease(&sResolved);` |
|    9026 |  8142 | `				if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COMMA) == 0 ){` |
|    4514 |  8143 | `					break;` |
|       - |  8144 | `				}` |
...
|    4512 |  8147 | `		}` |
|   16546 |  8148 | `	}` |
|   42708 |  8149 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|       - |  8150 | `		/* Syntax error */` |
...
|       - |  8158 | `	}` |
|   42708 |  8159 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|   42708 |  8160 | `	pEnd = 0; /* cc warning */` |
|       - |  8161 | `	/* Delimit the class body */` |
|   42708 |  8162 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|   42708 |  8163 | `	if( pEnd >= pGen->pEnd ){` |
|       - |  8164 | `		/* Syntax error */` |
...
|   42708 |  8174 | `	pTmp = pGen->pEnd;` |
|   42708 |  8175 | `	pGen->pEnd = pEnd;` |
|       - |  8176 | `	/* Set the inherited flags */` |
|   42708 |  8177 | `	pClass->iFlags = iFlags;` |
|       - |  8178 | `	/* Start the parse process */` |
|   94934 |  8179 | `	for(;;){` |
|       - |  8180 | `		/* Jump leading/trailing semi-colons */` |
|  304506 |  8181 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|   57338 |  8182 | `			pGen->pIn++;` |
|       2 |  8183 | `		}` |
|  247170 |  8184 | `		if( pGen->pIn >= pGen->pEnd ){` |
|       - |  8185 | `			/* End of class body */` |
|   42694 |  8186 | `			break;` |
|       - |  8187 | `		}` |
|  204478 |  8188 | `		if( (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR)) == 0 ){` |
...
|  204478 |  8199 | `		iProtection = PH7_TKWRD_PUBLIC;` |
|  204478 |  8200 | `		iAttrflags = 0;` |
|  204478 |  8201 | `		if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|       - |  8202 | `			/* Extract the current keyword */` |
|  204478 |  8203 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  204478 |  8204 | `			if( nKwrd == PH7_TKWRD_USE ){` |
...
|      44 |  8264 | `				continue;` |
|       - |  8265 | `			}` |
|  204436 |  8266 | `			if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|  201324 |  8267 | `				iProtection = nKwrd;` |
|  201324 |  8268 | `				pGen->pIn++; /* Jump the visibility token */` |
|  201322 |  8269 | `				if( pGen->pIn >= pGen->pEnd` |
|  201324 |  8270 | `					\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP)) == 0 ){` |
...
|     ! 0 |  8278 | `					goto done;` |
|       - |  8279 | `				}` |
|  201324 |  8280 | `				if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|       - |  8281 | `					/* Attribute declaration (untyped) */` |
|   57142 |  8282 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|   57142 |  8283 | `					if( rc != SXRET_OK ){` |
...
|   57140 |  8289 | `					continue;` |
|       - |  8290 | `				}` |
|  144184 |  8291 | `				if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
|       - |  8292 | `					/* Typed attribute declaration (PHP 7.4+) */` |
|     112 |  8293 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|     112 |  8294 | `					if( rc != SXRET_OK ){` |
...
|  144074 |  8303 | `				nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   72036 |  8304 | `			}` |
|  147186 |  8305 | `			if( nKwrd == PH7_TKWRD_CONST ){` |
...
|       - |  8313 | `				}` |
|      16 |  8314 | `			}else{` |
|  147158 |  8315 | `				if( nKwrd == PH7_TKWRD_STATIC ){` |
|       - |  8316 | `					/* Static method or attribute,record that */` |
|    3032 |  8317 | `					iAttrflags \|= PH7_CLASS_ATTR_STATIC;` |
|    3032 |  8318 | `					pGen->pIn++; /* Jump the static keyword */` |
|    3032 |  8319 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|       - |  8320 | `						/* Extract the keyword */` |
|    3026 |  8321 | `						nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    3026 |  8322 | `						if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|     ! 0 |  8323 | `							iProtection = nKwrd;` |
|     ! 0 |  8324 | `							pGen->pIn++; /* Jump the visibility token */` |
|     ! 0 |  8325 | `						}` |
|    1512 |  8326 | `					}` |
|    3030 |  8327 | `					if( pGen->pIn >= pGen->pEnd` |
|    3032 |  8328 | `						\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP)) == 0 ){` |
...
|     ! 0 |  8336 | `						goto done;` |
|       - |  8337 | `					}` |
|    3032 |  8338 | `					if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
...
|       5 |  8347 | `						continue;` |
|       - |  8348 | `					}` |
|    3028 |  8349 | `					if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|    3020 |  8361 | `					nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  145637 |  8362 | `				}else if( nKwrd == PH7_TKWRD_ABSTRACT ){` |
...
|  144123 |  8394 | `				}else if( nKwrd == PH7_TKWRD_FINAL ){` |
...
|       2 |  8424 | `				}` |
|  147146 |  8425 | `				if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_VAR ){` |
...
|     ! 0 |  8433 | `						goto done;` |
|       - |  8434 | `				}` |
|  147146 |  8435 | `				if( nKwrd == PH7_TKWRD_VAR ){` |
...
|  147140 |  8450 | `					rc = GenStateCompileClassMethod(&(*pGen),iProtection,iAttrflags,TRUE,pClass);` |
|       - |  8451 | `				}` |
|  147146 |  8452 | `				if( rc != SXRET_OK ){` |
...
|       - |  8475 | `		sxu32 nU;` |
|   42694 |  8476 | `		apUse = (TraitUseEntry *)SySetBasePtr(&aUseEntries);` |
|   42736 |  8477 | `		for( nU = 0 ; nU < SySetUsed(&aUseEntries) ; nU++ ){` |
...
|   42694 |  8685 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|   42694 |  8686 | `	if( rc == SXRET_OK ){` |
|       - |  8687 | `		ph7_class **apInterface;` |
|       - |  8688 | `		sxu32 n;` |
|   42694 |  8689 | `		if( pBase ){` |
|       - |  8690 | `			/* Inherit from base class and mark as a subclass */` |
|   24076 |  8691 | `			rc = PH7_ClassInherit(&(*pGen),pClass,pBase);` |
|   12037 |  8692 | `		}` |
|   42694 |  8693 | `		apInterface = (ph7_class **)SySetBasePtr(&aInterfaces);` |
|   51712 |  8694 | `		for( n = 0 ; n < SySetUsed(&aInterfaces) ; n++ ){` |
|       - |  8695 | `			/* Implements one or more interface */` |
|    9020 |  8696 | `			rc = PH7_ClassImplement(pClass,apInterface[n]);` |
|    9020 |  8697 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  8698 | `				break;` |
|       - |  8699 | `			}` |
|    4511 |  8700 | `		}` |
|       - |  8701 | `		/* Validate interface method signatures (visibility and parameter count) */` |
|   42694 |  8702 | `		if( rc == SXRET_OK ){` |
|   42694 |  8703 | `			sxi32 rcCheck = GenStateCheckInterfaceSignatures(&(*pGen),pClass);` |
|   42694 |  8704 | `			if( rcCheck == SXERR_ABORT ){` |
...
|   42694 |  8711 | `		if( rc == SXRET_OK ){` |
|   42694 |  8712 | `			sxi32 rcCheck = GenStateCheckAbstractMethods(&(*pGen),pClass);` |
|   42694 |  8713 | `			if( rcCheck == SXERR_ABORT ){` |
...
|   21346 |  8718 | `		}` |
|   21346 |  8719 | `	}` |
|   42694 |  8720 | `	SySetRelease(&aUseEntries);` |
|   42694 |  8721 | `	SySetRelease(&aInterfaces);` |
|   42694 |  8722 | `	if( rc != SXRET_OK ){` |
...
|   42708 |  8728 | `	pGen->pIn = &pEnd[1];` |
|   42708 |  8729 | `	pGen->pEnd = pTmp;` |
|   42708 |  8730 | `	return PH7_OK;` |
|   21356 |  8731 |  |
|       - |  8732 | `/*` |
...
|       - |  9068 | ` */` |
|   42688 |  9069 | `static sxi32 PH7_CompileClass(ph7_gen_state *pGen)` |
|       2 |  9070 |  |
|       - |  9071 | `	sxi32 rc;` |
|   42690 |  9072 | `	rc = GenStateCompileClass(&(*pGen),0);` |
|   42690 |  9073 | `	return rc;` |
|       2 |  9074 |  |
|       - |  9075 | `/*` |
...
|       - |  9096 | ` */` |
|    9094 |  9097 | `static sxi32 GenStateThrowNodeValidator(ph7_gen_state *pGen,ph7_expr_node *pRoot)` |
|       2 |  9098 |  |
|    9096 |  9099 | `	sxi32 rc = SXRET_OK;` |
|    9096 |  9100 | `	if( pRoot->pOp ){` |
|    9088 |  9101 | `		switch( pRoot->pOp->iOp ){` |
|    4543 |  9102 | `		case EXPR_OP_NEW:            /* new Exception() */` |
...
|     ! 0 |  9118 | `			break;` |
|       - |  9119 | `		}` |
|    4553 |  9120 | `	}else if( pRoot->xCode != PH7_CompileVariable ){` |
...
|       - |  9134 | ` */` |
|    9058 |  9135 | `static sxi32 PH7_CompileThrow(ph7_gen_state *pGen)` |
|       2 |  9136 |  |
|    9060 |  9137 | `	sxu32 nLine = pGen->pIn->nLine;` |
|       - |  9138 | `	GenBlock *pBlock;` |
|       - |  9139 | `	sxu32 nIdx;` |
|       - |  9140 | `	sxi32 rc;` |
|    9060 |  9141 | `	pGen->pIn++; /* Jump the 'throw' keyword */` |
|       - |  9142 | `	/* Compile the expression */` |
|    9060 |  9143 | `	rc = PH7_CompileExpr(&(*pGen),0,GenStateThrowNodeValidator);` |
|    9060 |  9144 | `	if( rc == SXERR_EMPTY ){` |
...
|       - |  9150 | `	}` |
|    9060 |  9151 | `	pBlock = pGen->pCurrent;` |
|       - |  9152 | `	/* Point to the top most function or try block and emit the forward jump */` |
|   42054 |  9153 | `	while(pBlock->pParent){` |
|   42050 |  9154 | `		if( pBlock->iFlags & (GEN_BLOCK_EXCEPTION\|GEN_BLOCK_FUNC) ){` |
|    9056 |  9155 | `			break;` |
|       - |  9156 | `		}` |
|       - |  9157 | `		/* Point to the parent block */` |
|   32996 |  9158 | `		pBlock = pBlock->pParent;` |
|       2 |  9159 | `	}` |
|       - |  9160 | `	/* Emit the throw instruction */` |
|    9060 |  9161 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_THROW,0,0,0,&nIdx);` |
|       - |  9162 | `	/* Emit the jump */` |
|    9060 |  9163 | `	GenStateNewJumpFixup(pBlock,PH7_OP_THROW,nIdx);` |
|    9060 |  9164 | `	return SXRET_OK;` |
|    4531 |  9165 |  |
|       - |  9166 | `/*` |
...
|       - |  9217 | ` */` |
|     286 |  9218 | `static sxi32 PH7_CompileCatch(ph7_gen_state *pGen,ph7_exception *pException)` |
|       2 |  9219 |  |
|     288 |  9220 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|       - |  9227 | `	char *zDup;` |
|       - |  9228 | `	sxi32 rc;` |
|     288 |  9229 | `	pGen->pIn++; /* Jump the 'catch' keyword */` |
|       - |  9230 | `	/* Zero the structure */` |
|     288 |  9231 | `	SyZero(&sCatch,sizeof(ph7_exception_block));` |
|       - |  9232 | `	/* Initialize fields */` |
|     288 |  9233 | `	SySetInit(&sCatch.aClasses,&pException->pVm->sAllocator,sizeof(SyString));` |
|     288 |  9234 | `	SySetInit(&sCatch.sByteCode,&pException->pVm->sAllocator,sizeof(VmInstr));` |
|     288 |  9235 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 /*(*/ ){` |
...
|     288 |  9250 | `	pGen->pIn++; /* Jump the left parenthesis '(' */` |
|     156 |  9251 | `	for(;;){` |
|       - |  9252 | `		SyBlob sResolved;` |
|     314 |  9253 | `		SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|     314 |  9254 | `		if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|     464 |  9270 | `		zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|     308 |  9271 | `			(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|     310 |  9272 | `		SyStringInitFromBuf(&sClassName,zDup,SyBlobLength(&sResolved));` |
|     310 |  9273 | `		SyBlobRelease(&sResolved);` |
|     310 |  9274 | `		if( zDup == 0 ){` |
|     ! 0 |  9275 | `			goto Mem;` |
|       - |  9276 | `		}` |
|     310 |  9277 | `		rc = SySetPut(&sCatch.aClasses,(const void *)&sClassName);` |
|     310 |  9278 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  9279 | `			goto Mem;` |
|       - |  9280 | `		}` |
|       - |  9281 | `		/* Check for '\|' (multi-catch separator) */` |
|     321 |  9282 | `		if( pGen->pIn < pGen->pEnd &&` |
|     308 |  9283 | `			(pGen->pIn->nType & PH7_TK_OP) &&` |
...
|     284 |  9289 | `		break;` |
|     ! 0 |  9290 | `	}` |
|     423 |  9291 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 /*$*/ \|\|` |
|     284 |  9292 | `		&pGen->pIn[1] >= pGen->pEnd \|\| (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|       - |  9305 | `	}` |
|     284 |  9306 | `	pGen->pIn++; /* Jump the dollar sign */` |
|       - |  9307 | `	/* Duplicate instance name */` |
|     284 |  9308 | `	pName = &pGen->pIn->sData;` |
|     284 |  9309 | `	zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|     284 |  9310 | `	if( zDup == 0 ){` |
|     ! 0 |  9311 | `		goto Mem;` |
|       - |  9312 | `	}` |
|     284 |  9313 | `	SyStringInitFromBuf(&sCatch.sThis,zDup,pName->nByte);` |
|     284 |  9314 | `	pGen->pIn++;` |
|     284 |  9315 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_RPAREN) == 0 /*)*/ ){` |
...
|     284 |  9330 | `	pGen->pIn++; /* Jump the right parenthesis */` |
|       - |  9331 | `	/* Create the catch block */` |
|     284 |  9332 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_EXCEPTION,PH7_VmInstrLength(pGen->pVm),0,&pCatch);` |
|     284 |  9333 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  9334 | `		return SXERR_ABORT;` |
|       - |  9335 | `	}` |
|       - |  9336 | `	/* Swap bytecode container */` |
|     284 |  9337 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|     284 |  9338 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&sCatch.sByteCode);` |
|       - |  9339 | `	/* Compile the block */` |
|     284 |  9340 | `	PH7_CompileBlock(&(*pGen),0);` |
|       - |  9341 | `	/* Fix forward jumps now the destination is resolved  */` |
|     284 |  9342 | `	GenStateFixJumps(pCatch,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - |  9343 | `	/* Emit the DONE instruction */` |
|     284 |  9344 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|       - |  9345 | `	/* Leave the block */` |
|     284 |  9346 | `	GenStateLeaveBlock(&(*pGen),0);` |
|       - |  9347 | `	/* Restore the default container */` |
|     284 |  9348 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|       - |  9349 | `	/* Install the catch block */` |
|     284 |  9350 | `	rc = SySetPut(&pException->sEntry,(const void *)&sCatch);` |
|     284 |  9351 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  9352 | `		goto Mem;` |
|       - |  9353 | `	}` |
|     284 |  9354 | `	return SXRET_OK;` |
|     ! 0 |  9355 | `Mem:` |
...
|       - |  9364 | ` * is "thrown".` |
|       - |  9365 | ` */` |
|     290 |  9366 | `static sxi32 PH7_CompileTry(ph7_gen_state *pGen)` |
|       2 |  9367 |  |
|       - |  9368 | `	ph7_exception *pException;` |
|     292 |  9369 | `	sxu32 nLine = pGen->pIn->nLine;` |
|       - |  9370 | `	GenBlock *pTry;` |
|       - |  9371 | `	sxu32 nJmpIdx;` |
|       - |  9372 | `	sxi32 rc;` |
|       - |  9373 | `	/* Create the exception container */` |
|     292 |  9374 | `	pException = (ph7_exception *)SyMemBackendAlloc(&pGen->pVm->sAllocator,sizeof(ph7_exception));` |
|     292 |  9375 | `	if( pException == 0 ){` |
...
|     292 |  9381 | `	SyZero(pException,sizeof(ph7_exception));` |
|       - |  9382 | `	/* Initialize fields */` |
|     292 |  9383 | `	SySetInit(&pException->sEntry,&pGen->pVm->sAllocator,sizeof(ph7_exception_block));` |
|     292 |  9384 | `	SySetInit(&pException->sFinally,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|     292 |  9385 | `	pException->iHasFinally = 0;` |
|     292 |  9386 | `	pException->iFinallyDone = 0;` |
|     292 |  9387 | `	pException->pVm = pGen->pVm;` |
|       - |  9388 | `	/* Create the try block */` |
|     292 |  9389 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_EXCEPTION,PH7_VmInstrLength(pGen->pVm),0,&pTry);` |
|     292 |  9390 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  9391 | `		return SXERR_ABORT;` |
|       - |  9392 | `	}` |
|       - |  9393 | `	/* Store exception pointer so break/continue can emit POP_EXCEPTION */` |
|     292 |  9394 | `	pTry->pUserData = pException;` |
|       - |  9395 | `	/* Emit the 'LOAD_EXCEPTION' instruction */` |
|     292 |  9396 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_EXCEPTION,0,0,pException,&nJmpIdx);` |
|       - |  9397 | `	/* Fix the jump later when the destination is resolved */` |
|     292 |  9398 | `	GenStateNewJumpFixup(pTry,PH7_OP_LOAD_EXCEPTION,nJmpIdx);` |
|     292 |  9399 | `	pGen->pIn++; /* Jump the 'try' keyword */` |
|       - |  9400 | `	/* Compile the block */` |
|     292 |  9401 | `	rc = PH7_CompileBlock(&(*pGen),0);` |
|     292 |  9402 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  9403 | `		return SXERR_ABORT;` |
|       - |  9404 | `	}` |
|       - |  9405 | `	/* Fix forward jumps now the destination is resolved */` |
|     292 |  9406 | `	GenStateFixJumps(pTry,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - |  9407 | `	/* Emit the 'POP_EXCEPTION' instruction */` |
|     292 |  9408 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP_EXCEPTION,0,0,pException,0);` |
|       - |  9409 | `	/* Leave the block */` |
|     292 |  9410 | `	GenStateLeaveBlock(&(*pGen),0);` |
|       - |  9411 | `	/* Compile catch block(s) — at least one catch or finally is required */` |
|     292 |  9412 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|     288 |  9413 | `		SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_CATCH ){` |
|       - |  9414 | `		/* Compile one or more catch blocks */` |
|     282 |  9415 | `		for(;;){` |
|     564 |  9416 | `			if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0` |
|     438 |  9417 | `				\|\| SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_CATCH ){` |
|     141 |  9418 | `					break;` |
|       - |  9419 | `			}` |
|     288 |  9420 | `			rc = PH7_CompileCatch(&(*pGen),pException);` |
|     288 |  9421 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  9422 | `				return SXERR_ABORT;` |
|       - |  9423 | `			}` |
|       2 |  9424 | `		}` |
|     139 |  9425 | `	}` |
|       - |  9426 | `	/* Compile optional finally block */` |
|     292 |  9427 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|     136 |  9428 | `		SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_FINALLY ){` |
...
|     292 |  9457 | `	if( SySetUsed(&pException->sEntry) == 0 && !pException->iHasFinally ){` |
...
|       - |  9820 | ` */` |
| 2184228 |  9821 | `static void GenStatePatchNullsafeJumps(ph7_gen_state *pGen, sxu32 nBaseline)` |
|       2 |  9822 |  |
| 2184230 |  9823 | `	sxu32 nCur = SySetUsed(&pGen->aNullsafeJmp);` |
|       - |  9824 | `	sxu32 nTarget;` |
|       - |  9825 | `	sxu32 *aIdx;` |
|       - |  9826 | `	sxu32 i;` |
| 2184230 |  9827 | `	if( nCur <= nBaseline ){` |
| 2184140 |  9828 | `		return;` |
|       - |  9829 | `	}` |
...
|       - |  9846 | ` * error message.` |
|       - |  9847 | ` */` |
| 2942920 |  9848 | `static sxi32 GenStateEmitExprCode(` |
...
|       - |  9854 | `	VmInstr *pInstr;` |
|       - |  9855 | `	sxu32 nJmpIdx;` |
| 2942922 |  9856 | `	sxi32 iP1 = 0;` |
| 2942922 |  9857 | `	sxu32 iP2 = 0;` |
| 2942922 |  9858 | `	void *p3  = 0;` |
|       - |  9859 | `	sxi32 iVmOp;` |
|       - |  9860 | `	sxi32 rc;` |
| 2942922 |  9861 | `	int bIsChainOp = 0; /* Set below once we know pNode->pOp */` |
| 2942922 |  9862 | `	sxu32 nRhsNsBase = 0;` |
| 2942922 |  9863 | `	if( pNode->xCode ){` |
|       - |  9864 | `		SyToken *pTmpIn,*pTmpEnd;` |
|       - |  9865 | `		/* Compile node */` |
| 1822556 |  9866 | `		SWAP_DELIMITER(pGen,pNode->pStart,pNode->pEnd);` |
| 1822556 |  9867 | `		rc = pNode->xCode(&(*pGen),iFlags);` |
| 1822556 |  9868 | `		RE_SWAP_DELIMITER(pGen);` |
| 1822556 |  9869 | `		return rc;` |
|       - |  9870 | `	}` |
| 1120368 |  9871 | `	if( pNode->pOp == 0 ){` |
...
|       - |  9875 | `	}` |
| 1120368 |  9876 | `	iVmOp = pNode->pOp->iVmOp;` |
| 1120368 |  9877 | `	if( pNode->pOp->iOp == EXPR_OP_NULLC_ASSIGN ){` |
...
|       - |  9926 | `	}` |
| 1120322 |  9927 | `	if( pNode->pOp->iOp == EXPR_OP_QUESTY ){` |
|       - |  9928 | `		sxu32 nJz,nJmp;` |
|       - |  9929 | `		sxu32 nTernaryNsBase;` |
|       - |  9930 | `		/* Ternary operator require special handling */` |
|       - |  9931 | `		/* Phase#1: Compile the condition */` |
|    2290 |  9932 | `		nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|    2290 |  9933 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pCond,iFlags);` |
|    2290 |  9934 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  9935 | `			return rc;` |
|       - |  9936 | `		}` |
...
|    2290 |  9940 | `		GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|    2290 |  9941 | `		nJz = nJmp = 0; /* cc -O6 warning */` |
|    2290 |  9942 | `		if( pNode->pLeft ){` |
|       - |  9943 | `			/* Standard ternary: (expr) ? (then) : (else) */` |
|       - |  9944 | `			/* Phase#2: Emit the false jump (pops condition) */` |
|    2222 |  9945 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nJz);` |
|       - |  9946 | `			/* Phase#3: Compile the 'then' expression  */` |
|    2222 |  9947 | `			nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|    2222 |  9948 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pLeft,iFlags);` |
|    2222 |  9949 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  9950 | `				return rc;` |
|       - |  9951 | `			}` |
|    2222 |  9952 | `			GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|    1112 |  9953 | `		}else{` |
...
|    2290 |  9961 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,0,0,&nJmp);` |
|       - |  9962 | `		/* Phase#5: Fix the false jump now the jump destination is resolved. */` |
|    2290 |  9963 | `		pInstr = PH7_VmGetInstr(pGen->pVm,nJz);` |
|    2290 |  9964 | `		if( pInstr ){` |
|    2290 |  9965 | `			pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    1144 |  9966 | `		}` |
|    2290 |  9967 | `		if( !pNode->pLeft ){` |
...
|    2290 |  9972 | `		if( pNode->pRight ){` |
|    2290 |  9973 | `			nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|    2290 |  9974 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pRight,iFlags);` |
|    2290 |  9975 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  9976 | `				return rc;` |
|       - |  9977 | `			}` |
|    2290 |  9978 | `			GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|    1144 |  9979 | `		}` |
|    2290 |  9980 | `		if( nJmp > 0 ){` |
|       - |  9981 | `			/* Phase#7: Fix the unconditional jump */` |
|    2290 |  9982 | `			pInstr = PH7_VmGetInstr(pGen->pVm,nJmp);` |
|    2290 |  9983 | `			if( pInstr ){` |
|    2290 |  9984 | `				pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    1144 |  9985 | `			}` |
|    1144 |  9986 | `		}` |
|       - |  9987 | `		/* All done */` |
|    2290 |  9988 | `		return SXRET_OK;` |
|       - |  9989 | `	}` |
| 1118034 |  9990 | `	bIsChainOp = GEN_IS_CHAIN_OP(pNode->pOp->iOp);` |
|       - |  9991 | `	/* Generate code for the left tree */` |
| 1118034 |  9992 | `	if( pNode->pLeft ){` |
| 1117996 |  9993 | `		sxu32 nLhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
| 1117996 |  9994 | `		if( iVmOp == PH7_OP_CALL ){` |
|       - |  9995 | `			ph7_expr_node **apNode;` |
|  355050 |  9996 | `			int hasSpread = 0;` |
|  355050 |  9997 | `			int hasNamed = 0;` |
|       - |  9998 | `			sxi32 nArgs;` |
|       - |  9999 | `			sxi32 n;` |
|       - | 10000 | `			/* Recurse and generate bytecodes for function arguments */` |
|  355050 | 10001 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  355050 | 10002 | `			nArgs = (sxi32)SySetUsed(&pNode->aNodeArgs);` |
|       - | 10003 | `			/* Validate: no positional arguments after named arguments */` |
|       - | 10004 | `			{` |
|  355050 | 10005 | `				int seenNamed = 0;` |
|  703114 | 10006 | `				for( n = 0; n < nArgs; ++n ){` |
|  348068 | 10007 | `					if( apNode[n]->iFlags & EXPR_NODE_NAMED_ARG ){` |
|     186 | 10008 | `						seenNamed = 1;` |
|     186 | 10009 | `						hasNamed = 1;` |
|  347976 | 10010 | `					}else if( seenNamed && !(apNode[n]->iFlags & EXPR_NODE_SPREAD) ){` |
...
|  355048 | 10018 | `			iFlags \|= EXPR_FLAG_RDONLY_LOAD;` |
|  703110 | 10019 | `			for( n = 0 ; n < nArgs ; ++n ){` |
|  348064 | 10020 | `				sxu32 nArgNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  348064 | 10021 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iFlags&~EXPR_FLAG_LOAD_IDX_STORE);` |
|  348064 | 10022 | `				if( rc != SXRET_OK ){` |
|     ! 0 | 10023 | `					return rc;` |
|       - | 10024 | `				}` |
|       - | 10025 | `				/* Each argument is an independent nullsafe scope. */` |
|  348064 | 10026 | `				GenStatePatchNullsafeJumps(pGen, nArgNsBase);` |
|  348064 | 10027 | `				if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
...
|  355048 | 10034 | `			iP1 = nArgs;` |
|  355048 | 10035 | `			iP2 = hasSpread;` |
|       - | 10036 | `			/* Build VmCallArgMap if named arguments are present.` |
|       - | 10037 | `			 * Deep-copy name strings so they survive token stream cleanup. */` |
|  355048 | 10038 | `			if( hasNamed ){` |
|     100 | 10039 | `				sxu32 nStrBytes = 0;` |
|       - | 10040 | `				char *zBuf;` |
|     296 | 10041 | `				for( n = 0; n < nArgs; ++n ){` |
|     198 | 10042 | `					if( apNode[n]->iFlags & EXPR_NODE_NAMED_ARG ){` |
|     184 | 10043 | `						nStrBytes += (sxu32)apNode[n]->sArgName.nByte;` |
|      91 | 10044 | `					}` |
|     100 | 10045 | `				}` |
|       - | 10046 | `				{` |
|     100 | 10047 | `				sxu32 mapSize = sizeof(VmCallArgMap) + nArgs * sizeof(SyString) + nStrBytes;` |
|     100 | 10048 | `				VmCallArgMap *pMap = (VmCallArgMap *)SyMemBackendAlloc(` |
|      98 | 10049 | `					&pGen->pVm->sAllocator, mapSize);` |
|     100 | 10050 | `				if( pMap ){` |
|     100 | 10051 | `					SyZero(pMap, mapSize);` |
|     100 | 10052 | `					pMap->bHasNamed = 1;` |
|     100 | 10053 | `					pMap->nTotal = (sxu32)nArgs;` |
|     100 | 10054 | `					pMap->aNames = (SyString *)&pMap[1];` |
|     100 | 10055 | `					zBuf = (char *)&pMap->aNames[nArgs]; /* string storage after SyString array */` |
|     296 | 10056 | `					for( n = 0; n < nArgs; ++n ){` |
|     198 | 10057 | `						if( apNode[n]->iFlags & EXPR_NODE_NAMED_ARG ){` |
|     184 | 10058 | `							sxu32 nb = (sxu32)apNode[n]->sArgName.nByte;` |
|     184 | 10059 | `							SyMemcpy(apNode[n]->sArgName.zString, zBuf, nb);` |
|     184 | 10060 | `							SyStringInitFromBuf(&pMap->aNames[n], zBuf, nb);` |
|     184 | 10061 | `							zBuf += nb;` |
|      91 | 10062 | `						}` |
|       - | 10063 | `						/* else: aNames[n] remains {NULL, 0} for positional */` |
|     100 | 10064 | `					}` |
|     100 | 10065 | `					p3 = (void *)pMap;` |
|      49 | 10066 | `				}` |
|       - | 10067 | `				}` |
|      49 | 10068 | `			}` |
|       - | 10069 | `			/* Remove stale flags now */` |
|  355048 | 10070 | `			iFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|  177523 | 10071 | `		}` |
| 1117994 | 10072 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pLeft,iFlags);` |
| 1117994 | 10073 | `		if( rc != SXRET_OK ){` |
|      31 | 10074 | `			return rc;` |
|       - | 10075 | `		}` |
| 1117964 | 10076 | `		if( !bIsChainOp ){` |
...
|  522756 | 10079 | `			GenStatePatchNullsafeJumps(pGen, nLhsNsBase);` |
|  261377 | 10080 | `		}` |
| 1117964 | 10081 | `		if( iVmOp == PH7_OP_CALL ){` |
|  355048 | 10082 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|  355048 | 10083 | `			if( pInstr ){` |
|  355048 | 10084 | `				if ( pInstr->iOp == PH7_OP_LOADC ){` |
|  354056 | 10085 | `					sxu32 nOrig = (sxu32)pInstr->iP2;` |
|       - | 10086 | `					sxu32 nQual;` |
|  354056 | 10087 | `					int bAbsolute = (pInstr->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|       - | 10088 | `					/* Prevent constant expansion but preserve the absolute flag` |
|       - | 10089 | `					 * so the later NEW handler (if any) can see it. */` |
|  354056 | 10090 | `					pInstr->iP1 &= ~PH7_LOADC_EXPAND;` |
...
|  354056 | 10098 | `					if( bAbsolute ){` |
|      20 | 10099 | `						pInstr->iP2 = (sxi32)nOrig;` |
|      11 | 10100 | `					}else{` |
|  354038 | 10101 | `						int fromImport = 0;` |
|  354038 | 10102 | `						nQual = GenStateNsQualifyName(pGen,nOrig,&pGen->hUseFuncImports,&fromImport);` |
|  354038 | 10103 | `						pInstr->iP2 = (sxi32)nQual;` |
|  354038 | 10104 | `						if( nQual != nOrig ){` |
...
|      36 | 10122 | `						}` |
|       2 | 10123 | `					}` |
|  178021 | 10124 | `				}else if( pInstr->iOp == PH7_OP_MEMBER /* $a->b(1,2,3) */ \|\| pInstr->iOp == PH7_OP_NEW ){` |
|       - | 10125 | `					/* Method call,flag that */` |
|     798 | 10126 | `					pInstr->iP2 = 1;` |
|     398 | 10127 | `				}` |
|  177525 | 10128 | `			}` |
|  940441 | 10129 | `		}else if( iVmOp == PH7_OP_LOAD_IDX ){` |
|       - | 10130 | `			ph7_expr_node **apNode;` |
|       - | 10131 | `			sxi32 n;` |
|       - | 10132 | `			/* Recurse and generate bytecodes for array index */` |
|   76706 | 10133 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  138380 | 10134 | `			for( n = 0 ; n < (sxi32)SySetUsed(&pNode->aNodeArgs) ; ++n ){` |
|   61676 | 10135 | `				sxu32 nIdxNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|   61676 | 10136 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iFlags&~EXPR_FLAG_LOAD_IDX_STORE);` |
|   61676 | 10137 | `				if( rc != SXRET_OK ){` |
|     ! 0 | 10138 | `					return rc;` |
|       - | 10139 | `				}` |
|       - | 10140 | `				/* Each subscript index is an independent nullsafe scope. */` |
|   61676 | 10141 | `				GenStatePatchNullsafeJumps(pGen, nIdxNsBase);` |
|   30839 | 10142 | `			}` |
|   76706 | 10143 | `			if( SySetUsed(&pNode->aNodeArgs) > 0 ){` |
|   61676 | 10144 | `				iP1 = 1; /* Node have an index associated with it */` |
|   30837 | 10145 | `			}` |
|   76706 | 10146 | `			if( iFlags & EXPR_FLAG_LOAD_IDX_STORE ){` |
|       - | 10147 | `				/* Create an empty entry when the desired index is not found */` |
|   30322 | 10148 | `				iP2 = 1;` |
|   15162 | 10149 | `			}` |
|  724566 | 10150 | `		}else if( pNode->pOp->iOp == EXPR_OP_COMMA ){` |
|       - | 10151 | `			/* POP the left node */` |
|      32 | 10152 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|      15 | 10153 | `		}` |
|  558981 | 10154 | `	}` |
| 1118002 | 10155 | `	rc = SXRET_OK;` |
| 1118002 | 10156 | `	nJmpIdx = 0;` |
...
| 1118002 | 10160 | `	if( iVmOp == PH7_OP_MEMBER && pNode->pOp->iOp == EXPR_OP_DC ){` |
...
| 1117924 | 10190 | `	if( pNode->pRight ){` |
|  617800 | 10191 | `		if( iVmOp == PH7_OP_LAND ){` |
|       - | 10192 | `			/* Emit the false jump so we can short-circuit the logical and */` |
|    9410 | 10193 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,1/* Keep the value on the stack */,0,0,&nJmpIdx);` |
|  613096 | 10194 | `		}else if (iVmOp == PH7_OP_LOR ){` |
|       - | 10195 | `			/* Emit the true jump so we can short-circuit the logical or*/` |
|    3154 | 10196 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JNZ,1/* Keep the value on the stack */,0,0,&nJmpIdx);` |
|  606816 | 10197 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLC ){` |
...
|  605248 | 10201 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW ){` |
...
|  605109 | 10211 | `		}else if( pNode->pOp->iPrec == 18 /* Combined binary operators [i.e: =,'.=','+=',*=' ...] precedence */ ){` |
|  250734 | 10212 | `			iFlags \|= EXPR_FLAG_LOAD_IDX_STORE;` |
|  125366 | 10213 | `		}` |
|  617800 | 10214 | `		nRhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  617800 | 10215 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pRight,iFlags);` |
|  617800 | 10216 | `		if( !bIsChainOp ){` |
|       - | 10217 | `			/* Non-chain parent: RHS nullsafe chain ends here, before the` |
|       - | 10218 | `			 * operator instruction is emitted. */` |
|  454384 | 10219 | `			GenStatePatchNullsafeJumps(pGen, nRhsNsBase);` |
|  227191 | 10220 | `		}` |
|  617800 | 10221 | `		if( iVmOp == PH7_OP_STORE ){` |
|  247536 | 10222 | `			if( pNode->pRight && (pNode->pRight->xCode == PH7_CompileList \|\|` |
|  247510 | 10223 | `				pNode->pRight->xCode == PH7_CompileShortList) ){` |
...
|       - | 10229 | `				 */` |
|      54 | 10230 | `				iVmOp = 0;` |
|  247510 | 10231 | `			}else if( (pInstr = PH7_VmPeekInstr(pGen->pVm)) != 0 ){` |
|  247484 | 10232 | `				if(pInstr->iOp == PH7_OP_MEMBER ){` |
|       - | 10233 | `					/* Perform a member store operation [i.e: $this->x = 50] */` |
|   69118 | 10234 | `					iP2 = 1;` |
|   34560 | 10235 | `				}else{` |
|  178368 | 10236 | `					if( pInstr->iOp == PH7_OP_LOAD_IDX ){` |
|       - | 10237 | `						/* Transform the STORE instruction to STORE_IDX instruction */` |
|   30258 | 10238 | `						iVmOp = PH7_OP_STORE_IDX;` |
|   30258 | 10239 | `						iP1 = pInstr->iP1;` |
|   15130 | 10240 | `					}else{` |
|  148112 | 10241 | `						p3 = pInstr->p3;` |
|       - | 10242 | `					}` |
|       - | 10243 | `					/* POP the last dynamic load instruction */` |
|  178368 | 10244 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|       - | 10245 | `				}` |
|  123743 | 10246 | `			}` |
|  494033 | 10247 | `		}else if( iVmOp == PH7_OP_STORE_REF ){` |
...
|      23 | 10262 | `		}` |
|  308899 | 10263 | `	}` |
| 1117924 | 10264 | `	if( iVmOp > 0 ){` |
| 1117760 | 10265 | `		if( iVmOp == PH7_OP_INCR \|\| iVmOp == PH7_OP_DECR ){` |
|   12240 | 10266 | `			if( pNode->iFlags & EXPR_NODE_PRE_INCR ){` |
|       - | 10267 | `				/* Pre-increment/decrement operator [i.e: ++$i,--$j ] */` |
|    8986 | 10268 | `				iP1 = 1;` |
|    4494 | 10269 | `			}` |
| 1111641 | 10270 | `		}else if( iVmOp == PH7_OP_NEW ){` |
|       - | 10271 | `			/* Namespace-qualify the class name for NEW */ {` |
|   15828 | 10272 | `				VmInstr *pPeek = PH7_VmPeekInstr(pGen->pVm);` |
|   15828 | 10273 | `				VmInstr *pCallInstr = 0;` |
|   15828 | 10274 | `				if( pPeek && pPeek->iOp == PH7_OP_CALL ){` |
|   15812 | 10275 | `					pCallInstr = pPeek;` |
|   15812 | 10276 | `					pPeek = PH7_VmPeekNextInstr(pGen->pVm);` |
|    7905 | 10277 | `				}` |
|   15828 | 10278 | `				if( pPeek && pPeek->iOp == PH7_OP_LOADC ){` |
|   15826 | 10279 | `					int bAbsolute = (pPeek->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
...
|   15826 | 10284 | `					if( pCallInstr && pCallInstr->iP2 > 0 ){` |
|      34 | 10285 | `						nLitForClass = (sxu32)(pCallInstr->iP2 - 1); /* undo +1 encoding */` |
|      18 | 10286 | `					}else{` |
|   15794 | 10287 | `						nLitForClass = (sxu32)pPeek->iP2;` |
|       - | 10288 | `					}` |
|   15826 | 10289 | `					pPeek->iP1 = 0;` |
|   15826 | 10290 | `					if( !bAbsolute ){` |
|   15810 | 10291 | `						pPeek->iP2 = (sxi32)GenStateNsQualifyName(pGen,nLitForClass,&pGen->hUseImports,0);` |
|    7906 | 10292 | `					}else{` |
|      18 | 10293 | `						pPeek->iP2 = (sxi32)nLitForClass;` |
|       - | 10294 | `					}` |
|    7912 | 10295 | `				}` |
|       - | 10296 | `			}` |
|   15828 | 10297 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|   15828 | 10298 | `			if( pInstr && pInstr->iOp == PH7_OP_CALL ){` |
|       - | 10299 | `				VmInstr *pPrev;` |
|   15812 | 10300 | `				pPrev = PH7_VmPeekNextInstr(pGen->pVm);` |
|   15812 | 10301 | `				if( pPrev == 0 \|\| pPrev->iOp != PH7_OP_MEMBER ){` |
|       - | 10302 | `					/* Pop the call instruction, preserve named-arg map */` |
|   15812 | 10303 | `					iP1 = pInstr->iP1;` |
|   15812 | 10304 | `					if( pInstr->p3 ){` |
|      38 | 10305 | `						p3 = pInstr->p3; /* Transfer VmCallArgMap to NEW */` |
|      18 | 10306 | `					}` |
|   15812 | 10307 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|    7905 | 10308 | `				}` |
|    7907 | 10309 | `			}` |
| 1097609 | 10310 | `		}else if( iVmOp == PH7_OP_IS_A ){` |
...
|      33 | 10330 | `				}` |
|      44 | 10331 | `			}` |
| 1089656 | 10332 | `		}else if( iVmOp == PH7_OP_MEMBER){` |
...
|  163418 | 10336 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|  163418 | 10337 | `			if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|  163380 | 10338 | `				pInstr->iP1 = 0;` |
|   81689 | 10339 | `			}` |
|  163418 | 10340 | `			if( pNode->pOp->iOp == EXPR_OP_DC /* '::' */){` |
...
| 1117758 | 10352 | `		if( iVmOp == PH7_OP_CALL \|\| iVmOp == PH7_OP_NEW ){` |
|  370874 | 10353 | `			p3 = GenStateAttachStrictFlag(pGen,p3);` |
|  185436 | 10354 | `		}` |
|       - | 10355 | `		/* Finally,emit the VM instruction associated with this operator */` |
| 1117758 | 10356 | `		PH7_VmEmitInstr(pGen->pVm,iVmOp,iP1,iP2,p3,0);` |
|  558878 | 10357 | `	}` |
| 1117922 | 10358 | `	if( nJmpIdx > 0 ){` |
|       - | 10359 | `		/* Fix short-circuited jumps now the destination is resolved */` |
|   12644 | 10360 | `		pInstr = PH7_VmGetInstr(pGen->pVm,nJmpIdx);` |
|   12644 | 10361 | `		if( pInstr ){` |
|   12644 | 10362 | `			pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    6321 | 10363 | `		}` |
|    6321 | 10364 | `	}` |
| 1117922 | 10365 | `	return rc;` |
| 1471443 | 10366 |  |
|       - | 10367 | `/*` |
...
|       - | 10376 | ` * message.` |
|       - | 10377 | ` */` |
|  790660 | 10378 | `static sxi32 PH7_CompileExpr(` |
...
|  790662 | 10392 | `	nExpr = 0;` |
|  790662 | 10393 | `	pRoot = 0;` |
...
|  790662 | 10396 | `	nNullsafeBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  790662 | 10397 | `	SySetInit(&sExprNode,&pGen->pVm->sAllocator,sizeof(ph7_expr_node *));` |
|  790662 | 10398 | `	SySetAlloc(&sExprNode,0x10);` |
|  790662 | 10399 | `	rc = SXRET_OK;` |
|       - | 10400 | `	/* Delimit the expression */` |
|  790662 | 10401 | `	pEnd = pGen->pIn;` |
|  790662 | 10402 | `	iNest = 0;` |
| 5293356 | 10403 | `	while( pEnd < pGen->pEnd ){` |
| 5024380 | 10404 | `		if( pEnd->nType & PH7_TK_OCB /* '{' */ ){` |
|       - | 10405 | `			/* Ticket 1433-30: Annonymous/Closure functions body */` |
|     340 | 10406 | `			iNest++;` |
| 5024211 | 10407 | `		}else if(pEnd->nType & PH7_TK_CCB /* '}' */ ){` |
|     348 | 10408 | `			iNest--;` |
| 5023869 | 10409 | `		}else if( pEnd->nType & PH7_TK_SEMI /* ';' */ ){` |
|  521916 | 10410 | `			if( iNest <= 0 ){` |
|  521686 | 10411 | `				break;` |
|       - | 10412 | `			}` |
|     115 | 10413 | `		}` |
| 4502696 | 10414 | `		pEnd++;` |
|       2 | 10415 | `	}` |
|  790662 | 10416 | `	if( iFlags & EXPR_FLAG_COMMA_STATEMENT ){` |
|   18314 | 10417 | `		SyToken *pEnd2 = pGen->pIn;` |
|   18314 | 10418 | `		iNest = 0;` |
|       - | 10419 | `		/* Stop at the first comma */` |
|   36676 | 10420 | `		while( pEnd2 < pEnd ){` |
|   18368 | 10421 | `			if( pEnd2->nType & (PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*'['*/\|PH7_TK_LPAREN/*'('*/) ){` |
|      16 | 10422 | `				iNest++;` |
|   18361 | 10423 | `			}else if(pEnd2->nType & (PH7_TK_CCB/*'}'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_RPAREN/*')'*/)){` |
|      16 | 10424 | `				iNest--;` |
|   18347 | 10425 | `			}else if( pEnd2->nType & PH7_TK_COMMA /*','*/ ){` |
|      13 | 10426 | `				if( iNest <= 0 ){` |
|       5 | 10427 | `					break;` |
|       - | 10428 | `				}` |
|       4 | 10429 | `			}` |
|   18364 | 10430 | `			pEnd2++;` |
|       2 | 10431 | `		}` |
|   18314 | 10432 | `		if( pEnd2 <pEnd ){` |
|       5 | 10433 | `			pEnd = pEnd2;` |
|       2 | 10434 | `		}` |
|    9156 | 10435 | `	}` |
|  790662 | 10436 | `	if( pEnd > pGen->pIn ){` |
|  790652 | 10437 | `		SyToken *pTmp = pGen->pEnd;` |
|       - | 10438 | `		/* Swap delimiter */` |
|  790652 | 10439 | `		pGen->pEnd = pEnd;` |
|       - | 10440 | `		/* Try to get an expression tree */` |
|  790652 | 10441 | `		rc = PH7_ExprMakeTree(&(*pGen),&sExprNode,&pRoot);` |
|  790652 | 10442 | `		if( rc == SXRET_OK && pRoot ){` |
|  790470 | 10443 | `			rc = SXRET_OK;` |
|  790470 | 10444 | `			if( xTreeValidator ){` |
|       - | 10445 | `				/* Call the upper layer validator callback */` |
|   22150 | 10446 | `				rc = xTreeValidator(&(*pGen),pRoot);` |
|   11074 | 10447 | `			}` |
|  790470 | 10448 | `			if( rc != SXERR_ABORT ){` |
|       - | 10449 | `				/* Generate code for the given tree */` |
|  790470 | 10450 | `				rc = GenStateEmitExprCode(&(*pGen),pRoot,iFlags);` |
|       - | 10451 | `				/* Patch any unresolved nullsafe jumps emitted by this` |
|       - | 10452 | `				 * expression so they short-circuit to its end. */` |
|  790470 | 10453 | `				GenStatePatchNullsafeJumps(pGen, nNullsafeBase);` |
|  395234 | 10454 | `			}` |
|  790470 | 10455 | `			nExpr = 1;` |
|  395234 | 10456 | `		}` |
|       - | 10457 | `		/* Release the whole tree */` |
|  790652 | 10458 | `		PH7_ExprFreeTree(&(*pGen),&sExprNode);` |
|       - | 10459 | `		/* Synchronize token stream */` |
|  790652 | 10460 | `		pGen->pEnd = pTmp;` |
|  790652 | 10461 | `		pGen->pIn  = pEnd;` |
|  790652 | 10462 | `		if( rc == SXERR_ABORT ){` |
|      11 | 10463 | `			SySetRelease(&sExprNode);` |
|      11 | 10464 | `			return SXERR_ABORT;` |
|       - | 10465 | `		}` |
|  395320 | 10466 | `	}` |
|  790652 | 10467 | `	SySetRelease(&sExprNode);` |
|  790652 | 10468 | `	return nExpr > 0 ? SXRET_OK : SXERR_EMPTY;` |
|  395332 | 10469 |  |
|       - | 10470 | `/*` |
|       - | 10471 | ` * Return a pointer to the node construct handler associated` |
|       - | 10472 | ` * with a given node type [i.e: string,integer,float,...].` |
|       - | 10473 | ` */` |
|  200166 | 10474 | `PH7_PRIVATE ProcNodeConstruct PH7_GetNodeHandler(sxu32 nNodeType)` |
|       2 | 10475 |  |
|  200168 | 10476 | `	if( nNodeType & PH7_TK_NUM ){` |
|       - | 10477 | `		/* Numeric literal: Either real or integer */` |
|  105564 | 10478 | `		return PH7_CompileNumLiteral;` |
|   94606 | 10479 | `	}else if( nNodeType & PH7_TK_DSTR ){` |
|       - | 10480 | `		/* Double quoted string */` |
|   18378 | 10481 | `		return PH7_CompileString;` |
|   76230 | 10482 | `	}else if( nNodeType & PH7_TK_SSTR ){` |
|       - | 10483 | `		/* Single quoted string */` |
|   76118 | 10484 | `		return PH7_CompileSimpleString;` |
...
|       - | 10501 | ` */` |
|    6492 | 10502 | `static sxi32 GenStateUnsetValidator(ph7_gen_state *pGen, ph7_expr_node *pNode)` |
|       2 | 10503 |  |
|       - | 10504 | `	sxi32 rc;` |
|    6494 | 10505 | `	if( !PH7_ExprContainsNullsafe(pNode) ){` |
|    6492 | 10506 | `		return SXRET_OK;` |
|       - | 10507 | `	}` |
...
|       - | 10519 | ` */` |
|    2820 | 10520 | `static sxi32 PH7_CompileUnset(ph7_gen_state *pGen)` |
|       2 | 10521 |  |
|    2822 | 10522 | `	SyToken *pTmp,*pEnd,*pNext = 0;` |
|    2822 | 10523 | `	sxu32 nIdx = 0;` |
|       - | 10524 | `	SyString sName;` |
|       - | 10525 | `	sxi32 rc;` |
|       - | 10526 | `	/* Jump the 'unset' keyword */` |
|    2822 | 10527 | `	pGen->pIn++;` |
|       - | 10528 | `	/* Save delimiter */` |
|    2822 | 10529 | `	pTmp = pGen->pEnd;` |
|       - | 10530 | `	/* Skip optional opening parenthesis and find the matching close */` |
|    2822 | 10531 | `	pEnd = pTmp; /* Default: scan to statement end */` |
|    2822 | 10532 | `	if( pGen->pIn < pTmp && (pGen->pIn->nType & PH7_TK_LPAREN) ){` |
|       - | 10533 | `		/* Find matching ')' — start scanning AFTER the '(' */` |
|       - | 10534 | `		SyToken *pClose;` |
|    2822 | 10535 | `		pGen->pIn++;   /* Skip '(' */` |
|    2822 | 10536 | `		PH7_DelimitNestedTokens(pGen->pIn,pTmp,PH7_TK_LPAREN,PH7_TK_RPAREN,&pClose);` |
|    2822 | 10537 | `		pEnd = pClose; /* Stop at ')' */` |
|    1410 | 10538 | `	}` |
|    2822 | 10539 | `	SyStringInitFromBuf(&sName,"unset",sizeof("unset")-1);` |
|       - | 10540 | `	/* Resolve the 'unset' builtin name once */` |
|    2822 | 10541 | `	if( SXRET_OK != GenStateFindLiteral(&(*pGen),&sName,&nIdx) ){` |
|     340 | 10542 | `		ph7_value *pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|     340 | 10543 | `		if( pObj == 0 ){` |
|     ! 0 | 10544 | `			return SXERR_ABORT;` |
|       - | 10545 | `		}` |
|     340 | 10546 | `		PH7_MemObjInitFromString(pGen->pVm,pObj,&sName);` |
|     340 | 10547 | `		GenStateInstallLiteral(&(*pGen),pObj,nIdx);` |
|     169 | 10548 | `	}` |
|       - | 10549 | `	/* Compile each comma-separated argument */` |
|    9316 | 10550 | `	while( SXRET_OK == PH7_GetNextExpr(pGen->pIn,pEnd,&pNext) ){` |
|    6496 | 10551 | `		if( pGen->pIn < pNext ){` |
|    6496 | 10552 | `			pGen->pEnd = pNext;` |
|    6496 | 10553 | `			rc = PH7_CompileExpr(&(*pGen),` |
|       - | 10554 | `				EXPR_FLAG_RDONLY_LOAD\|EXPR_FLAG_LOAD_IDX_STORE,` |
|       - | 10555 | `				GenStateUnsetValidator);` |
|    6496 | 10556 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 | 10557 | `				return SXERR_ABORT;` |
|       - | 10558 | `			}` |
|    6496 | 10559 | `			if( rc != SXERR_EMPTY ){` |
|       - | 10560 | `				/* Emit call for this single argument */` |
|    6494 | 10561 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|    6494 | 10562 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_CALL,1,0,GenStateAttachStrictFlag(pGen,0),0);` |
|    6494 | 10563 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|    3246 | 10564 | `			}` |
|    3247 | 10565 | `		}` |
|       - | 10566 | `		/* Jump trailing commas */` |
|   10172 | 10567 | `		while( pNext < pEnd && (pNext->nType & PH7_TK_COMMA) ){` |
|    3678 | 10568 | `			pNext++;` |
|       2 | 10569 | `		}` |
|    6496 | 10570 | `		pGen->pIn = pNext;` |
|       2 | 10571 | `	}` |
|       - | 10572 | `	/* Skip past the closing ')' if present */` |
|    2822 | 10573 | `	if( pGen->pIn < pTmp && (pGen->pIn->nType & PH7_TK_RPAREN) ){` |
|    2822 | 10574 | `		pGen->pIn++;` |
|    1410 | 10575 | `	}` |
|       - | 10576 | `	/* Restore token stream */` |
|    2822 | 10577 | `	pGen->pEnd = pTmp;` |
|    2822 | 10578 | `	return SXRET_OK;` |
|    1412 | 10579 |  |
|       - | 10580 | `/*` |
...
|       - | 10612 | ` */` |
|  474312 | 10613 | `static ProcLangConstruct GenStateGetStatementHandler(` |
|       - | 10614 | `	sxu32 nKeywordID,   /* Keyword  ID*/` |
|       - | 10615 | `	SyToken *pLookahed  /* Look-ahead token */` |
|       - | 10616 | `	)` |
|       2 | 10617 |  |
|  474314 | 10618 | `	sxu32 n = 0;` |
| 2009259 | 10619 | `	for(;;){` |
| 4018520 | 10620 | `		if( n >= SX_ARRAYSIZE(aLangConstruct) ){` |
|   54914 | 10621 | `			break;` |
|       - | 10622 | `		}` |
| 3963608 | 10623 | `		if( aLangConstruct[n].nID == nKeywordID ){` |
|  419402 | 10624 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed && (pLookahed->nType & PH7_TK_OP)){` |
...
|       - | 10629 | `				}` |
|     ! 0 | 10630 | `			}` |
|  419400 | 10631 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed` |
...
|       - | 10638 | `			*/` |
|  419402 | 10639 | `			return aLangConstruct[n].xConstruct;` |
|       - | 10640 | `		}` |
| 3544208 | 10641 | `		n++;` |
|       2 | 10642 | `	}` |
|   54914 | 10643 | `	if( pLookahed ){` |
|   54914 | 10644 | `		if(nKeywordID == PH7_TKWRD_INTERFACE && (pLookahed->nType & PH7_TK_ID) ){` |
|   12012 | 10645 | `			return PH7_CompileClassInterface;` |
|   42904 | 10646 | `		}else if(nKeywordID == PH7_TKWRD_CLASS && (pLookahed->nType & PH7_TK_ID) ){` |
|   42690 | 10647 | `			return PH7_CompileClass;` |
...
|       - | 10687 | ` */` |
|  640042 | 10688 | `static sxi32 GenStateCompileChunk(` |
...
|       - | 10694 | `	sxi32 rc;` |
|  640044 | 10695 | `	rc = SXRET_OK; /* Prevent compiler warning */` |
|  438823 | 10696 | `	for(;;){` |
|  758846 | 10697 | `		int bStmtIsDeclare = 0;` |
|  758846 | 10698 | `		if( pGen->pIn >= pGen->pEnd ){` |
...
|  746082 | 10704 | `		if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|  474314 | 10705 | `			sxu32 nPeek = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  474314 | 10706 | `			if( nPeek == PH7_TKWRD_DECLARE ){` |
|      40 | 10707 | `				bStmtIsDeclare = 1;` |
|      19 | 10708 | `			}` |
|  237156 | 10709 | `		}` |
|  746082 | 10710 | `		if( !bStmtIsDeclare && pGen->pCurrent == &pGen->sGlobal ){` |
...
|  118776 | 10713 | `			pGen->bStrictTypesLocked = 1;` |
|   59387 | 10714 | `		}` |
|  746082 | 10715 | `		if( pGen->pIn->nType & PH7_TK_OCB /* '{' */ ){` |
|       - | 10716 | `			/* Compile block */` |
...
|       - | 10720 | `			}` |
|      10 | 10721 | `		}else{` |
|  746066 | 10722 | `			xCons = 0;` |
|  746066 | 10723 | `			if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|  474314 | 10724 | `				sxu32 nKeyword = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|       - | 10725 | `				/* Try to extract a language construct handler */` |
|  474314 | 10726 | `				xCons = GenStateGetStatementHandler(nKeyword,(&pGen->pIn[1] < pGen->pEnd) ? &pGen->pIn[1] : 0);` |
|  474314 | 10727 | `				if( xCons == 0 && GenStateisLangConstruct(nKeyword) == FALSE ){` |
...
|       4 | 10738 | `				}` |
|  508910 | 10739 | `			}else if( (pGen->pIn->nType & PH7_TK_ID) && (&pGen->pIn[1] < pGen->pEnd)` |
|   44496 | 10740 | `				&& (pGen->pIn[1].nType & PH7_TK_COLON /*':'*/) ){` |
|       - | 10741 | `				/* Label found [i.e: Out: ],point to the routine responsible of compiling it */` |
|     114 | 10742 | `				xCons = PH7_CompileLabel;` |
|      56 | 10743 | `			}` |
|  746066 | 10744 | `			if( xCons == 0 ){` |
|       - | 10745 | `				/* Assume an expression an try to compile it */` |
|  271774 | 10746 | `				rc = PH7_CompileExpr(&(*pGen),0,0);` |
|  271774 | 10747 | `				if(  rc != SXERR_EMPTY ){` |
|       - | 10748 | `					/* Pop l-value */` |
|  271624 | 10749 | `					PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|  135811 | 10750 | `				}` |
|  135888 | 10751 | `			}else{` |
|       - | 10752 | `				/* Go compile the sucker */` |
|  474294 | 10753 | `				rc = xCons(&(*pGen));` |
|       - | 10754 | `			}` |
|  746066 | 10755 | `			if( rc == SXERR_ABORT ){` |
|       - | 10756 | `				/* Request to abort compilation */` |
|      11 | 10757 | `				break;` |
|       - | 10758 | `			}` |
|       - | 10759 | `		}` |
|       - | 10760 | `		/* Ignore trailing semi-colons ';' */` |
| 1244096 | 10761 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|  498026 | 10762 | `			pGen->pIn++;` |
|       2 | 10763 | `		}` |
|  746072 | 10764 | `		if( iFlags & PH7_COMPILE_SINGLE_STMT ){` |
...
|       - | 10780 | ` */` |
|   12776 | 10781 | `static sxi32 PH7_CompilePHP(` |
...
|       - | 10785 | `	)` |
|       2 | 10786 |  |
|   12778 | 10787 | `	SyToken *pScript = pGen->pRawIn; /* Script to compile */` |
|       - | 10788 | `	sxi32 rc;` |
|       - | 10789 | `	/* Reset the token set */` |
|   12778 | 10790 | `	SySetReset(&(*pTokenSet));` |
|       - | 10791 | `	/* Mark as the default token set */` |
|   12778 | 10792 | `	pGen->pTokenSet = &(*pTokenSet);` |
|       - | 10793 | `	/* Advance the stream cursor */` |
|   12778 | 10794 | `	pGen->pRawIn++;` |
|       - | 10795 | `	/* Tokenize the PHP chunk first */` |
|   12778 | 10796 | `	PH7_TokenizePHP(SyStringData(&pScript->sData),SyStringLength(&pScript->sData),pScript->nLine,&(*pTokenSet));` |
|       - | 10797 | `	/* Point to the head and tail of the token stream. */` |
|   12778 | 10798 | `	pGen->pIn  = (SyToken *)SySetBasePtr(pTokenSet);` |
|   12778 | 10799 | `	pGen->pEnd = &pGen->pIn[SySetUsed(pTokenSet)];` |
|   12778 | 10800 | `	if( is_expr ){` |
...
|       - | 10809 | `	}` |
|   12778 | 10810 | `	if( pGen->pIn < pGen->pEnd && ( pGen->pIn->nType & PH7_TK_EQUAL ) ){` |
...
|   12776 | 10835 | `	rc = GenStateCompileChunk(pGen,0);` |
|       - | 10836 | `	/* Fix exceptions jumps */` |
|   12776 | 10837 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|       - | 10838 | `	/* Fix gotos now, the jump destination is resolved */` |
|   12776 | 10839 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),0) ){` |
|       3 | 10840 | `		rc = SXERR_ABORT;` |
|       1 | 10841 | `	}` |
|       - | 10842 | `	/* Reset container */` |
|   12776 | 10843 | `	SySetReset(&pGen->aGoto);` |
|   12776 | 10844 | `	SySetReset(&pGen->aLabel);` |
|   12776 | 10845 | `	SySetReset(&pGen->aNullsafeJmp);` |
|       - | 10846 | `	/* Compilation result */` |
|   12776 | 10847 | `	return rc;` |
|    6390 | 10848 |  |
|       - | 10849 | `/*` |
...
|       - | 10853 | ` */` |
|   15272 | 10854 | `PH7_PRIVATE sxi32 PH7_CompileScript(` |
...
|       - | 10868 | `	sxi32 rc;` |
|   15274 | 10869 | `	if( pScript->nByte < 1 ){` |
...
|   15274 | 10875 | `	pCodeGen = &pVm->sCodeGen;` |
|   15274 | 10876 | `	bSavedStrict = pCodeGen->bStrictTypes;` |
|   15274 | 10877 | `	bSavedStrictLocked = pCodeGen->bStrictTypesLocked;` |
|   15274 | 10878 | `	pCodeGen->bStrictTypes = 0;` |
|   15274 | 10879 | `	pCodeGen->bStrictTypesLocked = 0;` |
|       - | 10880 | `	/* Initialize the tokens containers */` |
|   15274 | 10881 | `	SySetInit(&aRawToken,&pVm->sAllocator,sizeof(SyToken));` |
|   15274 | 10882 | `	SySetInit(&aPhpToken,&pVm->sAllocator,sizeof(SyToken));` |
|   15274 | 10883 | `	SySetAlloc(&aPhpToken,0xc0);` |
|   15274 | 10884 | `	is_expr = 0;` |
|   15274 | 10885 | `	if( iFlags & PH7_PHP_ONLY ){` |
|       - | 10886 | `		SyToken sTmp;` |
|       - | 10887 | `		/* PHP only: -*/` |
|    3022 | 10888 | `		sTmp.nLine = 1;` |
|    3022 | 10889 | `		sTmp.nType = PH7_TOKEN_PHP;` |
|    3022 | 10890 | `		sTmp.pUserData = 0;` |
|    3022 | 10891 | `		SyStringDupPtr(&sTmp.sData,pScript);` |
|    3022 | 10892 | `		SySetPut(&aRawToken,(const void *)&sTmp);` |
|    3022 | 10893 | `		if( iFlags & PH7_PHP_EXPR ){` |
|       - | 10894 | `			/* A simple PHP expression */` |
|     ! 0 | 10895 | `			is_expr = 1;` |
|     ! 0 | 10896 | `		}` |
|    1512 | 10897 | `	}else{` |
|       - | 10898 | `		/* Tokenize raw text */` |
|   12254 | 10899 | `		SySetAlloc(&aRawToken,32);` |
|   12254 | 10900 | `		PH7_TokenizeRawText(pScript->zString,pScript->nByte,&aRawToken);` |
|       - | 10901 | `	}` |
|       - | 10902 | `	/* Process high-level tokens */` |
|   15274 | 10903 | `	pCodeGen->pRawIn = (SyToken *)SySetBasePtr(&aRawToken);` |
|   15274 | 10904 | `	pCodeGen->pRawEnd = &pCodeGen->pRawIn[SySetUsed(&aRawToken)];` |
|   15274 | 10905 | `	rc = PH7_OK;` |
|   15274 | 10906 | `	if( is_expr ){` |
|       - | 10907 | `		/* Compile the expression */` |
|     ! 0 | 10908 | `		rc = PH7_CompilePHP(pCodeGen,&aPhpToken,TRUE);` |
|     ! 0 | 10909 | `		goto cleanup;` |
|       - | 10910 | `	}` |
|   15274 | 10911 | `	nObjIdx = 0;` |
...
|   15274 | 10915 | `	PH7_VmEmitInstr(pVm,PH7_OP_NSSWITCH,0,0,0,0);` |
|       - | 10916 | `	/* Start the compilation process */` |
|   13766 | 10917 | `	for(;;){` |
|   40298 | 10918 | `		if( pCodeGen->pRawIn >= pCodeGen->pRawEnd ){` |
|   15262 | 10919 | `			break; /* No more tokens to process */` |
|       - | 10920 | `		}` |
|   25038 | 10921 | `		if( pCodeGen->pRawIn->nType & PH7_TOKEN_PHP ){` |
|       - | 10922 | `			/* Compile the PHP chunk */` |
|   12778 | 10923 | `			rc = PH7_CompilePHP(pCodeGen,&aPhpToken,FALSE);` |
|   12778 | 10924 | `			if( rc == SXERR_ABORT ){` |
|      13 | 10925 | `				break;` |
|       - | 10926 | `			}` |
|   12766 | 10927 | `			continue;` |
|       - | 10928 | `		}` |
|       - | 10929 | `		/* Raw chunk: [i.e: HTML, XML, etc.] */` |
|   12262 | 10930 | `		nRawObj = 0;` |
|   24522 | 10931 | `		while( (pCodeGen->pRawIn < pCodeGen->pRawEnd) && (pCodeGen->pRawIn->nType != PH7_TOKEN_PHP) ){` |
|       - | 10932 | `			/* Consume the raw chunk without any processing */` |
|   12262 | 10933 | `			pRawObj = PH7_ReserveConstObj(&(*pVm),&nObjIdx);` |
|   12262 | 10934 | `			if( pRawObj == 0 ){` |
|     ! 0 | 10935 | `				rc = SXERR_MEM;` |
|     ! 0 | 10936 | `				break;` |
|       - | 10937 | `			}` |
|       - | 10938 | `			/* Mark as constant and emit the load constant instruction */` |
|   12262 | 10939 | `			PH7_MemObjInitFromString(pVm,pRawObj,&pCodeGen->pRawIn->sData);` |
|   12262 | 10940 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_LOADC,0,nObjIdx,0,0);` |
|   12262 | 10941 | `			++nRawObj;` |
|   12262 | 10942 | `			pCodeGen->pRawIn++; /* Next chunk */` |
|       2 | 10943 | `		}` |
|   12262 | 10944 | `		if( nRawObj > 0 ){` |
|       - | 10945 | `			/* Emit the consume instruction */` |
|   12262 | 10946 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_CONSUME,nRawObj,0,0,0);` |
|    6130 | 10947 | `		}` |
|    7638 | 10948 | `	}` |
|    7636 | 10949 | `cleanup:` |
|   15274 | 10950 | `	SySetRelease(&aRawToken);` |
|   15274 | 10951 | `	SySetRelease(&aPhpToken);` |
|       - | 10952 | `	/* Restore outer file's strict_types scope */` |
|   15274 | 10953 | `	pCodeGen->bStrictTypes = bSavedStrict;` |
|   15274 | 10954 | `	pCodeGen->bStrictTypesLocked = bSavedStrictLocked;` |
|   15274 | 10955 | `	return rc;` |
|    7638 | 10956 |  |
|       - | 10957 | `/*` |
|       - | 10958 | ` * Utility routines.Initialize the code generator.` |
|       - | 10959 | ` */` |
|    2992 | 10960 | `PH7_PRIVATE sxi32 PH7_InitCodeGenerator(` |
|       - | 10961 | `	ph7_vm *pVm,       /* Target VM */` |
|       - | 10962 | `	ProcConsumer xErr, /* Error log consumer callabck  */` |
|       - | 10963 | `	void *pErrData     /* Last argument to xErr() */` |
|       - | 10964 | `	)` |
|       2 | 10965 |  |
|    2994 | 10966 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|       - | 10967 | `	/* Zero the structure */` |
|    2994 | 10968 | `	SyZero(pGen,sizeof(ph7_gen_state));` |
|       - | 10969 | `	/* Initial state */` |
|    2994 | 10970 | `	pGen->pVm  = &(*pVm);` |
|    2994 | 10971 | `	pGen->xErr = xErr;` |
|    2994 | 10972 | `	pGen->pErrData = pErrData;` |
|    2994 | 10973 | `	SySetInit(&pGen->aLabel,&pVm->sAllocator,sizeof(Label));` |
|    2994 | 10974 | `	SySetInit(&pGen->aGoto,&pVm->sAllocator,sizeof(JumpFixup));` |
|    2994 | 10975 | `	SySetInit(&pGen->aNullsafeJmp,&pVm->sAllocator,sizeof(sxu32));` |
|    2994 | 10976 | `	SyHashInit(&pGen->hLiteral,&pVm->sAllocator,0,0);` |
|    2994 | 10977 | `	SyHashInit(&pGen->hVar,&pVm->sAllocator,0,0);` |
|       - | 10978 | `	/* Error log buffer */` |
|    2994 | 10979 | `	SyBlobInit(&pGen->sErrBuf,&pVm->sAllocator);` |
|       - | 10980 | `	/* General purpose working buffer */` |
|    2994 | 10981 | `	SyBlobInit(&pGen->sWorker,&pVm->sAllocator);` |
|       - | 10982 | `	/* Namespace state */` |
|    2994 | 10983 | `	SyBlobInit(&pGen->sNamespace,&pVm->sAllocator);` |
|    2994 | 10984 | `	SyHashInit(&pGen->hUseImports,&pVm->sAllocator,0,0);` |
|    2994 | 10985 | `	SyHashInit(&pGen->hUseFuncImports,&pVm->sAllocator,0,0);` |
|    2994 | 10986 | `	SyHashInit(&pGen->hUseConstImports,&pVm->sAllocator,0,0);` |
|       - | 10987 | `	/* Create the global scope */` |
|    2994 | 10988 | `	GenStateInitBlock(pGen,&pGen->sGlobal,GEN_BLOCK_GLOBAL,PH7_VmInstrLength(&(*pVm)),0);` |
|       - | 10989 | `	/* Point to the global scope */` |
|    2994 | 10990 | `	pGen->pCurrent = &pGen->sGlobal;` |
|    2994 | 10991 | `	return SXRET_OK;` |
|       2 | 10992 |  |
|       - | 10993 | `/*` |
|       - | 10994 | ` * Utility routines. Reset the code generator to it's initial state.` |
|       - | 10995 | ` */` |
|   17950 | 10996 | `PH7_PRIVATE sxi32 PH7_ResetCodeGenerator(` |
|       - | 10997 | `	ph7_vm *pVm,       /* Target VM */` |
|       - | 10998 | `	ProcConsumer xErr, /* Error log consumer callabck  */` |
|       - | 10999 | `	void *pErrData     /* Last argument to xErr() */` |
|       - | 11000 | `	)` |
|       2 | 11001 |  |
|   17952 | 11002 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|       - | 11003 | `	GenBlock *pBlock,*pParent;` |
|       - | 11004 | `	/* Reset state */` |
|   17952 | 11005 | `	SySetReset(&pGen->aLabel);` |
|   17952 | 11006 | `	SySetReset(&pGen->aGoto);` |
|   17952 | 11007 | `	SySetReset(&pGen->aNullsafeJmp);` |
|   17952 | 11008 | `	SyBlobRelease(&pGen->sErrBuf);` |
|   17952 | 11009 | `	SyBlobRelease(&pGen->sWorker);` |
|   17952 | 11010 | `	SyBlobRelease(&pGen->sNamespace);` |
|   17952 | 11011 | `	SyBlobInit(&pGen->sNamespace,&pVm->sAllocator);` |
|   17952 | 11012 | `	SyHashRelease(&pGen->hUseImports);` |
|   17952 | 11013 | `	SyHashInit(&pGen->hUseImports,&pVm->sAllocator,0,0);` |
|   17952 | 11014 | `	SyHashRelease(&pGen->hUseFuncImports);` |
|   17952 | 11015 | `	SyHashInit(&pGen->hUseFuncImports,&pVm->sAllocator,0,0);` |
|   17952 | 11016 | `	SyHashRelease(&pGen->hUseConstImports);` |
|   17952 | 11017 | `	SyHashInit(&pGen->hUseConstImports,&pVm->sAllocator,0,0);` |
...
|   17952 | 11025 | `	pBlock = pGen->pCurrent;` |
|   17952 | 11026 | `	while( pBlock->pParent != 0 ){` |
|     ! 0 | 11027 | `		pParent = pBlock->pParent;` |
|     ! 0 | 11028 | `		GenStateFreeBlock(pBlock);` |
|     ! 0 | 11029 | `		pBlock = pParent;` |
|     ! 0 | 11030 | `	}` |
|   17952 | 11031 | `	pGen->xErr = xErr;` |
|   17952 | 11032 | `	pGen->pErrData = pErrData;` |
|   17952 | 11033 | `	pGen->pCurrent = &pGen->sGlobal;` |
|   17952 | 11034 | `	pGen->pRawIn = pGen->pRawEnd = 0;` |
|   17952 | 11035 | `	pGen->pIn = pGen->pEnd = 0;` |
|   17952 | 11036 | `	pGen->nErr = 0;` |
|   17952 | 11037 | `	return SXRET_OK;` |
|       2 | 11038 |  |
|       - | 11039 | `/*` |
