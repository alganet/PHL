...
|         - |   138 | ` */` |
|    154500 |   139 | `static GenBlock * GenStateFetchBlock(GenBlock *pCurrent,sxi32 iBlockType,sxi32 iCount)` |
|         5 |   140 | `{` |
|    154505 |   141 | `	GenBlock *pBlock = pCurrent;` |
|    347439 |   142 | `	for(;;){` |
|    694883 |   143 | `		if( pBlock->iFlags & iBlockType ){` |
|    154505 |   144 | `			iCount--; /* Decrement nesting level */` |
|    154505 |   145 | `			if( iCount < 1 ){` |
|         - |   146 | `				/* Block meet with the desired criteria */` |
|    154479 |   147 | `				return pBlock;` |
|         - |   148 | `			}` |
|        13 |   149 | `		}` |
|         - |   150 | `		/* Point to the upper block */` |
|    540409 |   151 | `		pBlock = pBlock->pParent;` |
|    540409 |   152 | `		if( pBlock == 0 \|\| (pBlock->iFlags & (GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC)) ){` |
|         - |   153 | `			/* Forbidden */` |
|        16 |   154 | `			break;` |
|         - |   155 | `		}` |
|         5 |   156 | `	}` |
...
|         - |   162 | ` */` |
|  12112648 |   163 | `static void GenStateInitBlock(` |
...
|  12112653 |   172 | `	pBlock->nFirstInstr = nFirstInstr;` |
|  12112653 |   173 | `	pBlock->pUserData   = pUserData;` |
|  12112653 |   174 | `	pBlock->pGen        = pGen;` |
|  12112653 |   175 | `	pBlock->iFlags      = iType;` |
|  12112653 |   176 | `	pBlock->pParent     = 0;` |
|  12112653 |   177 | `	SySetInit(&pBlock->aJumpFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  12112653 |   178 | `	SySetInit(&pBlock->aPostContFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  12112653 |   179 | `}` |
|         - |   180 | `/*` |
...
|         - |   185 | ` */` |
|  12108786 |   186 | `static sxi32 GenStateEnterBlock(` |
...
|  12108791 |   196 | `	pBlock = (GenBlock *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(GenBlock));` |
|  12108791 |   197 | `	if( pBlock == 0 ){` |
...
|  12108791 |   206 | `	SyZero(pBlock,sizeof(GenBlock));` |
|  12108791 |   207 | `	GenStateInitBlock(&(*pGen),pBlock,iType,nFirstInstr,pUserData);` |
|         - |   208 | `	/* Link to the parent block */` |
|  12108791 |   209 | `	pBlock->pParent = pGen->pCurrent;` |
...
|  12108791 |   212 | `	if( iType & (GEN_BLOCK_LOOP\|GEN_BLOCK_SWITCH) ){` |
|    514221 |   213 | `		sxu32 nParent = pGen->nCurLoopId;` |
|    514221 |   214 | `		pGen->nLoopId++;` |
|    514221 |   215 | `		SySetPut(&pGen->aLoopParent,(const void *)&nParent);` |
|    514221 |   216 | `		pBlock->nLoopId = pGen->nLoopId;` |
|    514221 |   217 | `		pBlock->nOuterLoopId = nParent;` |
|    514221 |   218 | `		pGen->nCurLoopId = pGen->nLoopId;` |
|    257108 |   219 | `	}` |
|         - |   220 | `	/* Mark as the current block */` |
|  12108791 |   221 | `	pGen->pCurrent = pBlock;` |
|  12108791 |   222 | `	if( ppBlock ){` |
|         - |   223 | `		/* Write a pointer to the new instance */` |
|   5806125 |   224 | `		*ppBlock = pBlock;` |
|   2903060 |   225 | `	}` |
|  12108791 |   226 | `	return SXRET_OK;` |
|   6054398 |   227 | `}` |
|         - |   228 | `/*` |
|         - |   229 | ` * Release block fields without freeing the whole instance.` |
|         - |   230 | ` */` |
|  12108774 |   231 | `static void GenStateReleaseBlock(GenBlock *pBlock)` |
|         5 |   232 | `{` |
|  12108779 |   233 | `	SySetRelease(&pBlock->aPostContFix);` |
|  12108779 |   234 | `	SySetRelease(&pBlock->aJumpFix);` |
|  12108779 |   235 | `}` |
|         - |   236 | `/*` |
|         - |   237 | ` * Release a block.` |
|         - |   238 | ` */` |
|  12108770 |   239 | `static void GenStateFreeBlock(GenBlock *pBlock)` |
|         5 |   240 | `{` |
|  12108775 |   241 | `	ph7_gen_state *pGen = pBlock->pGen;` |
|  12108775 |   242 | `	GenStateReleaseBlock(&(*pBlock));` |
|         - |   243 | `	/* Free the instance */` |
|  12108775 |   244 | `	SyMemBackendPoolFree(&pGen->pVm->sAllocator,pBlock);` |
|  12108775 |   245 | `}` |
|         - |   246 | `/*` |
|         - |   247 | ` * POP and release a block from the stack of compiled blocks.` |
|         - |   248 | ` */` |
|  12108770 |   249 | `static sxi32 GenStateLeaveBlock(ph7_gen_state *pGen,GenBlock **ppBlock)` |
|         5 |   250 | `{` |
|  12108775 |   251 | `	GenBlock *pBlock = pGen->pCurrent;` |
|  12108775 |   252 | `	if( pBlock == 0 ){` |
|         - |   253 | `		/* No more block to pop */` |
|       ! 0 |   254 | `		return SXERR_EMPTY;` |
|         - |   255 | `	}` |
|  12108775 |   256 | `	if( pBlock->iFlags & (GEN_BLOCK_LOOP\|GEN_BLOCK_SWITCH) ){` |
|    514213 |   257 | `		pGen->nCurLoopId = pBlock->nOuterLoopId;` |
|    257104 |   258 | `	}` |
|         - |   259 | `	/* Point to the upper block */` |
|  12108775 |   260 | `	pGen->pCurrent = pBlock->pParent;` |
|  12108775 |   261 | `	if( ppBlock ){` |
|         - |   262 | `		/* Write a pointer to the popped block */` |
|       ! 0 |   263 | `		*ppBlock = pBlock;` |
|       ! 0 |   264 | `	}else{` |
|         - |   265 | `		/* Safely release the block */` |
|  12108775 |   266 | `		GenStateFreeBlock(&(*pBlock));` |
|         - |   267 | `	}` |
|  12108775 |   268 | `	return SXRET_OK;` |
|   6054390 |   269 | `}` |
|         - |   270 | `/*` |
...
|         - |   279 | ` */` |
|   4474254 |   280 | `static sxi32 GenStateNewJumpFixup(GenBlock *pBlock,sxi32 nJumpType,sxu32 nInstrIdx)` |
|         5 |   281 | `{` |
|         - |   282 | `	JumpFixup sJumpFix;` |
|         - |   283 | `	sxi32 rc;` |
|         - |   284 | `	/* Init the JumpFixup structure */` |
|   4474259 |   285 | `	sJumpFix.nJumpType = nJumpType;` |
|   4474259 |   286 | `	sJumpFix.nInstrIdx = nInstrIdx;` |
|         - |   287 | `	/* Insert in the jump fixup table */` |
|   4474259 |   288 | `	rc = SySetPut(&pBlock->aJumpFix,(const void *)&sJumpFix);` |
|   4474259 |   289 | `	return rc;` |
|         5 |   290 | `}` |
|         - |   291 | `/*` |
...
|         - |   301 | ` */` |
|   8434344 |   302 | `static sxu32 GenStateFixJumps(GenBlock *pBlock,sxi32 nJumpType,sxu32 nJumpDest)` |
|         5 |   303 | `{` |
|         - |   304 | `	JumpFixup *aFix;` |
|         - |   305 | `	VmInstr *pInstr;` |
|         - |   306 | `	sxu32 nFixed;` |
...
|   8434349 |   309 | `	aFix = (JumpFixup *)SySetBasePtr(&pBlock->aJumpFix);` |
|         - |   310 | `	/* Fix the desired jumps */` |
|  17947935 |   311 | `	for( nFixed = n = 0 ; n < SySetUsed(&pBlock->aJumpFix) ; ++n ){` |
|   9513591 |   312 | `		if( aFix[n].nJumpType < 0 ){` |
|         - |   313 | `			/* Already fixed */` |
|   3553161 |   314 | `			continue;` |
|         - |   315 | `		}` |
|   5960435 |   316 | `		if( nJumpType > 0 && aFix[n].nJumpType != nJumpType ){` |
|         - |   317 | `			/* Not of our interest */` |
|   1486183 |   318 | `			continue;` |
|         - |   319 | `		}` |
|         - |   320 | `		/* Point to the instruction to fix */` |
|   4474257 |   321 | `		pInstr = PH7_VmGetInstr(pBlock->pGen->pVm,aFix[n].nInstrIdx);` |
|   4474257 |   322 | `		if( pInstr ){` |
|   4474257 |   323 | `			pInstr->iP2 = nJumpDest;` |
|   4474257 |   324 | `			nFixed++;` |
|         - |   325 | `			/* Mark as fixed */` |
|   4474257 |   326 | `			aFix[n].nJumpType = -1;` |
|   2237126 |   327 | `		}` |
|   2237131 |   328 | `	}` |
|         - |   329 | `	/* Total number of fixed jumps */` |
|   8434349 |   330 | `	return nFixed;` |
|         5 |   331 | `}` |
|         - |   332 | `/*` |
...
|         - |   338 | ` */` |
|   3031252 |   339 | `static sxi32 GenStateFixGoto(ph7_gen_state *pGen,sxu32 nOfft)` |
|         5 |   340 | `{` |
...
|   3031257 |   347 | `	aJumps = (JumpFixup *)SySetBasePtr(&pGen->aGoto);` |
|         - |   348 | `	/* Fix */` |
|   3031403 |   349 | `	for( n = nOfft ; n < SySetUsed(&pGen->aGoto) ; ++n ){` |
...
|   3031255 |   400 | `	return SXRET_OK;` |
|   1515631 |   401 | `}` |
|         - |   402 | `/*` |
|         - |   403 | ` * Check if a given token value is installed in the literal table.` |
|         - |   404 | ` */` |
|  15323680 |   405 | `static sxi32 GenStateFindLiteral(ph7_gen_state *pGen,const SyString *pValue,sxu32 *pIdx)` |
|         5 |   406 | `{` |
|         - |   407 | `	SyHashEntry *pEntry;` |
|  15323685 |   408 | `	pEntry = SyHashGet(&pGen->hLiteral,(const void *)pValue->zString,pValue->nByte);` |
|  15323685 |   409 | `	if( pEntry == 0 ){` |
|   3926919 |   410 | `		return SXERR_NOTFOUND;` |
|         - |   411 | `	}` |
|  11396771 |   412 | `	*pIdx = (sxu32)SX_PTR_TO_INT(pEntry->pUserData);` |
|  11396771 |   413 | `	return SXRET_OK;` |
|   7661845 |   414 | `}` |
|         - |   415 | `/*` |
...
|         - |   424 | ` */` |
|   3926914 |   425 | `static sxi32 GenStateInstallLiteral(ph7_gen_state *pGen,ph7_value *pObj,sxu32 nIdx)` |
|         5 |   426 | `{` |
|   3926919 |   427 | `	if( SyBlobLength(&pObj->sBlob) > 0 ){` |
|   3926919 |   428 | `		SyHashInsert(&pGen->hLiteral,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob),SX_INT_TO_PTR(nIdx));` |
|   1963457 |   429 | `	}` |
|   3926919 |   430 | `	return SXRET_OK;` |
|         5 |   431 | `}` |
|         - |   432 | `/*` |
|         - |   433 | ` * Reserve a room for a numeric constant [i.e: 64-bit integer or real number]` |
|         - |   434 | ` * in the constant table.` |
|         - |   435 | ` */` |
|   3702264 |   436 | `static ph7_value * GenStateInstallNumLiteral(ph7_gen_state *pGen,sxu32 *pIdx)` |
|         5 |   437 | `{` |
|         - |   438 | `	ph7_value *pObj;` |
|   3702269 |   439 | `	sxu32 nIdx = 0; /* cc warning */` |
|         - |   440 | `	/* Reserve a new constant */` |
|   3702269 |   441 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   3702269 |   442 | `	if( pObj == 0 ){` |
|       ! 0 |   443 | `		PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|       ! 0 |   444 | `		return 0;` |
|         - |   445 | `	}` |
|   3702269 |   446 | `	*pIdx = nIdx;` |
|         - |   447 | `	/* TODO(chems): Create a numeric table (64bit int keys) same as` |
|         - |   448 | `	 * the constant string iterals table [optimization purposes].` |
|         - |   449 | `	 */` |
|   3702269 |   450 | `	return pObj;` |
|   1851137 |   451 | `}` |
|         - |   452 | `/*` |
...
|         - |   465 | ` */` |
|   7283592 |   466 | `static void *GenStateAttachStrictFlag(ph7_gen_state *pGen, void *p3)` |
|         5 |   467 | `{` |
|         - |   468 | `	VmCallArgMap *pMap;` |
|   7283597 |   469 | `	if( !pGen->bStrictTypes ) return p3;` |
|        39 |   470 | `	if( p3 == 0 ){` |
...
|         - |   541 | ` */` |
|   3711020 |   542 | `static int GenStateFindBadNumericSeparator(` |
|         - |   543 | `	const SyString *pRaw, const char **pBadStart, sxu32 *pBadLen)` |
|         5 |   544 | `{` |
|   3711025 |   545 | `	const char *z = pRaw->zString;` |
|   3711025 |   546 | `	sxu32 n = pRaw->nByte;` |
|   3711025 |   547 | `	int base = 10;` |
|         - |   548 | `	sxu32 i, start;` |
|   3711025 |   549 | `	if( n < 2 ) return 0;` |
|    797461 |   550 | `	if( z[0] == '0' && (z[1] == 'x' \|\| z[1] == 'X') ){` |
|    104263 |   551 | `		base = 16;` |
|    745332 |   552 | `	}else if( z[0] == '0' && (z[1] == 'b' \|\| z[1] == 'B') ){` |
|       286 |   553 | `		base = 2;` |
|       142 |   554 | `	}` |
|   3036029 |   555 | `	for( i = 0; i < n; ++i ){` |
|   2238587 |   556 | `		if( z[i] != '_' ) continue;` |
...
|         - |   582 | ` */` |
|   3711020 |   583 | `static sxi32 GenStateValidateNumericSeparator(ph7_gen_state *pGen, SyToken *pToken)` |
|         5 |   584 | `{` |
|   3711025 |   585 | `	const char *zBad = 0;` |
|   3711025 |   586 | `	sxu32 nBad = 0;` |
|         - |   587 | `	SyString sBad;` |
|         - |   588 | `	sxi32 rc;` |
|   3711025 |   589 | `	if( !GenStateFindBadNumericSeparator(&pToken->sData, &zBad, &nBad) ){` |
|   3711011 |   590 | `		return SXRET_OK;` |
|         - |   591 | `	}` |
...
|         - |   615 | ` */` |
|   3711006 |   616 | `static sxi32 GenStateStripNumericSeparators(` |
...
|         5 |   621 | `{` |
|         - |   622 | `	sxu32 i, j;` |
|   3711011 |   623 | `	int hasUnderscore = 0;` |
|         - |   624 | `	char *zBuf;` |
|   3711011 |   625 | `	*pzAlloc = 0;` |
|   8861067 |   626 | `	for( i = 0; i < pToken->nByte; ++i ){` |
|   5150315 |   627 | `		if( pToken->zString[i] == '_' ){ hasUnderscore = 1; break; }` |
|   2575033 |   628 | `	}` |
|   3711011 |   629 | `	if( !hasUnderscore ){` |
|   3710757 |   630 | `		SyStringDupPtr(pOut, pToken);` |
|   3710757 |   631 | `		return SXRET_OK;` |
|         - |   632 | `	}` |
...
|         - |   683 | ` */` |
|   3702298 |   684 | `static int GenStateIntLiteralOverflows(const SyString *pNum, ph7_real *pReal, int *pbDecimal)` |
|         5 |   685 | `{` |
|   3702303 |   686 | `	const char *z = pNum->zString;` |
|   3702303 |   687 | `	const char *zEnd = z + pNum->nByte;` |
|         - |   688 | `	const char *p, *q;` |
|         - |   689 | `	int n;` |
|   3702303 |   690 | `	*pbDecimal = FALSE;` |
|   3702303 |   691 | `	if( z >= zEnd ){` |
|       ! 0 |   692 | `		return FALSE;` |
|         - |   693 | `	}` |
|   3702303 |   694 | `	if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'x' \|\| z[1] == 'X') ){` |
|         - |   695 | `		/* Hexadecimal: INT64_MAX == 0x7FFF...F (16 digits, leading nibble 7). */` |
|    104261 |   696 | `		p = z + 2;` |
|    131275 |   697 | `		while( p < zEnd && p[0] == '0' ){ p++; }` |
|    424949 |   698 | `		for( q = p, n = 0; q < zEnd && (unsigned char)q[0] < 0xc0 && SyisHex(q[0]); q++ ){ n++; }` |
|    104261 |   699 | `		if( n < 16 \|\| (n == 16 && SyHexToint(p[0]) < 8) ){` |
|    104255 |   700 | `			return FALSE;` |
|         - |   701 | `		}` |
|         7 |   702 | `		{ ph7_real dv = 0;` |
...
|         - |   707 | `		}` |
|         7 |   708 | `		return TRUE;` |
|   3598047 |   709 | `	}else if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'b' \|\| z[1] == 'B') ){` |
...
|         - |   722 | `		}` |
|         3 |   723 | `		return TRUE;` |
|   3597765 |   724 | `	}else if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'o' \|\| z[1] == 'O') ){` |
...
|   1344995 |   743 | `		p = z;` |
|   2689987 |   744 | `		while( p < zEnd && p[0] == '0' ){ p++; }` |
|   1356825 |   745 | `		for( q = p, n = 0; q < zEnd && q[0] >= '0' && q[0] <= '7'; q++ ){ n++; }` |
|   1344995 |   746 | `		if( n <= 21 ){` |
|   1344993 |   747 | `			return FALSE;` |
|         - |   748 | `		}` |
|         3 |   749 | `		{ ph7_real dv = 0;` |
...
|   2252759 |   760 | `	p = z;` |
|   2252759 |   761 | `	while( p < zEnd && p[0] == '0' ){ p++; }` |
|   5460651 |   762 | `	for( q = p, n = 0; q < zEnd && (unsigned char)q[0] < 0xc0 && SyisDigit(q[0]); q++ ){ n++; }` |
|   2252759 |   763 | `	if( n > 19 \|\| (n == 19 && SyMemcmp(p, "9223372036854775807", 19) > 0) ){` |
|        25 |   764 | `		*pbDecimal = TRUE;` |
|        25 |   765 | `		return TRUE;` |
|         - |   766 | `	}` |
|   2252735 |   767 | `	return FALSE;` |
|   1851154 |   768 | `}` |
|   3710992 |   769 | `static sxi32 PH7_CompileNumLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|         5 |   770 | `{` |
|   3710997 |   771 | `	SyToken *pToken = pGen->pIn; /* Raw token */` |
|   3710997 |   772 | `	sxu32 nIdx = 0;` |
|         - |   773 | `	char zScratch[GEN_NUM_SCRATCH];` |
|   3710997 |   774 | `	char *zAlloc = 0;` |
|         - |   775 | `	SyString sNum;` |
|         - |   776 | `	sxi32 rc;` |
|   1855496 |   777 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|   3710997 |   778 | `	rc = GenStateValidateNumericSeparator(pGen, pToken);` |
|   3710997 |   779 | `	if( rc != SXRET_OK ){` |
|        14 |   780 | `		return rc;` |
|         - |   781 | `	}` |
|   5566478 |   782 | `	rc = GenStateStripNumericSeparators(&pGen->pVm->sAllocator, &pToken->sData,` |
|   1855491 |   783 | `		zScratch, sizeof(zScratch), &sNum, &zAlloc);` |
|   3710987 |   784 | `	if( rc != SXRET_OK ){` |
|       ! 0 |   785 | `		return SXERR_ABORT;` |
|         - |   786 | `	}` |
|   3710987 |   787 | `	if( pToken->nType & PH7_TK_INTEGER ){` |
|         - |   788 | `		ph7_value *pObj;` |
|         - |   789 | `		sxi64 iValue;` |
|   3702303 |   790 | `		ph7_real rOverflow = 0;` |
|   3702303 |   791 | `		int bDecimalOverflow = 0;` |
|   3702303 |   792 | `		if( GenStateIntLiteralOverflows(&sNum,&rOverflow,&bDecimalOverflow) ){` |
...
|         - |   807 | `			}` |
|        18 |   808 | `		}else{` |
|   3702269 |   809 | `			iValue = PH7_TokenValueToInt64(&sNum);` |
|   3702269 |   810 | `			pObj = GenStateInstallNumLiteral(&(*pGen),&nIdx);` |
|   3702269 |   811 | `			if( pObj == 0 ){` |
|       ! 0 |   812 | `				if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|       ! 0 |   813 | `				return SXERR_ABORT;` |
|         - |   814 | `			}` |
|   3702269 |   815 | `			PH7_MemObjInitFromInt(pGen->pVm,pObj,iValue);` |
|         - |   816 | `		}` |
|   1851154 |   817 | `	}else{` |
|         - |   818 | `		/* Real number */` |
|         - |   819 | `		ph7_value *pObj;` |
|         - |   820 | `		/* Reserve a new constant */` |
|      8689 |   821 | `		pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|      8689 |   822 | `		if( pObj == 0 ){` |
...
|         - |   826 | `		}` |
|      8689 |   827 | `		PH7_MemObjInitFromString(pGen->pVm,pObj,&sNum);` |
|      8689 |   828 | `		PH7_MemObjToReal(pObj);` |
|         - |   829 | `	}` |
|   3710987 |   830 | `	if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|         - |   831 | `	/* Emit the load constant instruction */` |
|   3710987 |   832 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|         - |   833 | `	/* Node successfully compiled */` |
|   3710987 |   834 | `	return SXRET_OK;` |
|   1855501 |   835 | `}` |
|         - |   836 | `/*` |
...
|         - |   845 | ` *` |
|         - |   846 | ` */` |
|   5225462 |   847 | `PH7_PRIVATE sxi32 PH7_CompileSimpleString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|         5 |   848 | `{` |
|   5225467 |   849 | `	SyString *pStr = &pGen->pIn->sData; /* Constant string literal */` |
|         - |   850 | `	const char *zIn,*zCur,*zEnd;` |
|         - |   851 | `	ph7_value *pObj;` |
|         - |   852 | `	sxu32 nIdx;` |
|         - |   853 | `	sxi32 bHasEsc;` |
|   5225467 |   854 | `	nIdx = 0; /* Prevent compiler warning */` |
|         - |   855 | `	/* Delimit the string */` |
|   5225467 |   856 | `	zIn  = pStr->zString;` |
|   5225467 |   857 | `	zEnd = &zIn[pStr->nByte];` |
|   5225467 |   858 | `	if( zIn >= zEnd ){` |
|         - |   859 | `		/* Empty string constant: just use the pre‑allocated index from the VM` |
|         - |   860 | `		 * rather than reserving a new object each time. */` |
|    374449 |   861 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,pGen->pVm->nEmptyStringIdx,0,0);` |
|    374449 |   862 | `		return SXRET_OK;` |
|         - |   863 | `	}` |
...
|   4851023 |   871 | `	bHasEsc = 0;` |
|         - |   872 | `	{` |
|         - |   873 | `		const char *zScan;` |
|  58099859 |   874 | `		for( zScan = zIn ; zScan < zEnd ; zScan++ ){` |
|  53330043 |   875 | `			if( zScan[0] == '\\' ){ bHasEsc = 1; break; }` |
|  26624423 |   876 | `		}` |
|         - |   877 | `	}` |
|   4851023 |   878 | `	if( !bHasEsc && SXRET_OK == GenStateFindLiteral(&(*pGen),pStr,&nIdx) ){` |
|         - |   879 | `		/* Already processed,emit the load constant instruction` |
|         - |   880 | `		 * and return.` |
|         - |   881 | `		 */` |
|   2878983 |   882 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   2878983 |   883 | `		return SXRET_OK;` |
|         - |   884 | `	}` |
|         - |   885 | `	/* Reserve a new constant */` |
|   1972045 |   886 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   1972045 |   887 | `	if( pObj == 0 ){` |
...
|         - |   891 | `	}` |
|   1972045 |   892 | `	PH7_MemObjInitFromString(pGen->pVm,pObj,0);` |
|         - |   893 | `	/* Compile the node */` |
|   2024232 |   894 | `	for(;;){` |
|   4048469 |   895 | `		if( zIn >= zEnd ){` |
|         - |   896 | `			/* End of input */` |
|   1972045 |   897 | `			break;` |
|         - |   898 | `		}` |
|   2076429 |   899 | `		zCur = zIn;` |
|  40944845 |   900 | `		while( zIn < zEnd && zIn[0] != '\\' ){` |
|  38868421 |   901 | `			zIn++;` |
|         5 |   902 | `		}` |
|   2076429 |   903 | `		if( zIn > zCur ){` |
|         - |   904 | `			/* Append raw contents*/` |
|   2033913 |   905 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|   1016954 |   906 | `		}` |
|   2076429 |   907 | `		zIn++;` |
|   2076429 |   908 | `		if( zIn < zEnd ){` |
|    143017 |   909 | `			if( zIn[0] == '\\' ){` |
|         - |   910 | `				/* A literal backslash */` |
|     34795 |   911 | `				PH7_MemObjStringAppend(pObj,"\\",sizeof(char));` |
|    125622 |   912 | `			}else if( zIn[0] == '\'' ){` |
|         - |   913 | `				/* A single quote */` |
|        15 |   914 | `				PH7_MemObjStringAppend(pObj,"'",sizeof(char));` |
|         8 |   915 | `			}else{` |
|         - |   916 | `				/* verbatim copy */` |
|    108213 |   917 | `				zIn--;` |
|    108213 |   918 | `				PH7_MemObjStringAppend(pObj,zIn,sizeof(char)*2);` |
|    108213 |   919 | `				zIn++;` |
|         - |   920 | `			}` |
|     71506 |   921 | `		}` |
...
|   1972045 |   926 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   1972045 |   927 | `	if( !bHasEsc && pStr->nByte < 1024 ){` |
|         - |   928 | `		/* Install in the literal table (only when value == source; see above) */` |
|   1890843 |   929 | `		GenStateInstallLiteral(pGen,pObj,nIdx);` |
|    945419 |   930 | `	}` |
|         - |   931 | `	/* Node successfully compiled */` |
|   1972045 |   932 | `	return SXRET_OK;` |
|   2612736 |   933 | `}` |
|         - |   934 | `/*` |
...
|         - |  1133 | ` */` |
|    123182 |  1134 | `static ph7_value * GenStateNewStrObj(ph7_gen_state *pGen,sxi32 *pCount)` |
|         5 |  1135 | `{` |
|         - |  1136 | `	ph7_value *pConstObj;` |
|    123187 |  1137 | `	sxu32 nIdx = 0;` |
|         - |  1138 | `	/* Reserve a new constant */` |
|    123187 |  1139 | `	pConstObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|    123187 |  1140 | `	if( pConstObj == 0 ){` |
|       ! 0 |  1141 | `		PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"PH7 engine is running out of memory");` |
|       ! 0 |  1142 | `		return 0;` |
|         - |  1143 | `	}` |
|    123187 |  1144 | `	(*pCount)++;` |
|    123187 |  1145 | `	PH7_MemObjInitFromString(pGen->pVm,pConstObj,0);` |
|         - |  1146 | `	/* Emit the load constant instruction */` |
|    123187 |  1147 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|    123187 |  1148 | `	return pConstObj;` |
|     61596 |  1149 | `}` |
|         - |  1150 | `/*` |
...
|    121612 |  1212 | `static sxi32 GenStateCompileString(ph7_gen_state *pGen,int bHeredoc)` |
|         5 |  1213 | `{` |
|    121617 |  1214 | `	SyString *pStr = &pGen->pIn->sData; /* Raw token value */` |
|         - |  1215 | `	const char *zIn,*zCur,*zEnd;` |
|    121617 |  1216 | `	ph7_value *pObj = 0;` |
|         - |  1217 | `	sxi32 iCons;` |
|         - |  1218 | `	sxi32 rc;` |
|         - |  1219 | `	/* Delimit the string */` |
|    121617 |  1220 | `	zIn  = pStr->zString;` |
|    121617 |  1221 | `	zEnd = &zIn[pStr->nByte];` |
|    121617 |  1222 | `	if( zIn >= zEnd ){` |
...
|    121207 |  1232 | `	iCons = 0;` |
|     61923 |  1233 | `	for(;;){` |
|    164837 |  1234 | `		zCur = zIn;` |
|   1675719 |  1235 | `		while( zIn < zEnd && zIn[0] != '\\'  ){` |
|   1513535 |  1236 | `			if( zIn[0] == '{' && &zIn[1] < zEnd && zIn[1] == '$' ){` |
|        69 |  1237 | `				break;` |
|   1513408 |  1238 | `			}else if(zIn[0] == '$' && &zIn[1] < zEnd &&` |
|      2526 |  1239 | `				(((unsigned char)zIn[1] >= 0xc0 \|\| SyisAlpha(zIn[1]) \|\| zIn[1] == '{' \|\| zIn[1] == '_')) ){` |
|      1263 |  1240 | `					break;` |
|         - |  1241 | `			}` |
|   1510887 |  1242 | `			zIn++;` |
|         5 |  1243 | `		}` |
|    164837 |  1244 | `		if( zIn > zCur ){` |
|     96079 |  1245 | `			if( pObj == 0 ){` |
|     95453 |  1246 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|     95453 |  1247 | `				if( pObj == 0 ){` |
|       ! 0 |  1248 | `					return SXERR_ABORT;` |
|         - |  1249 | `				}` |
|     47724 |  1250 | `			}` |
|     96079 |  1251 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|     48037 |  1252 | `		}` |
|    164837 |  1253 | `		if( zIn >= zEnd ){` |
|    121205 |  1254 | `			break;` |
|         - |  1255 | `		}` |
|     43637 |  1256 | `		if( zIn[0] == '\\' ){` |
|     40989 |  1257 | `			const char *zPtr = 0;` |
|         - |  1258 | `			sxu32 n;` |
|     40989 |  1259 | `			zIn++;` |
|     40989 |  1260 | `			if( pObj == 0 ){` |
|     27739 |  1261 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|     27739 |  1262 | `				if( pObj == 0 ){` |
|       ! 0 |  1263 | `					return SXERR_ABORT;` |
|         - |  1264 | `				}` |
|     13867 |  1265 | `			}` |
|     40989 |  1266 | `			if( zIn >= zEnd ){` |
|         - |  1267 | `				/* Lone backslash at the very end of the body: php keeps it */` |
|         3 |  1268 | `				PH7_MemObjStringAppend(pObj,"\\",sizeof(char));` |
|         3 |  1269 | `				break;` |
|         - |  1270 | `			}` |
|     40987 |  1271 | `			n = sizeof(char); /* size of conversion */` |
|     40987 |  1272 | `			switch( zIn[0] ){` |
|        15 |  1273 | `			case '$':` |
|         - |  1274 | `				/* Dollar sign */` |
...
|     35763 |  1291 | `				PH7_MemObjStringAppend(pObj,"\n",sizeof(char));` |
|     35763 |  1292 | `				break;` |
|        27 |  1293 | `			case 'r':` |
...
|      3925 |  1299 | `				PH7_MemObjStringAppend(pObj,"\t",sizeof(char));` |
|      3925 |  1300 | `				break;` |
|         3 |  1301 | `			case 'v':` |
...
|    121207 |  1628 | `	return SXRET_OK;` |
|     60811 |  1629 | `}` |
|         - |  1630 | `/*` |
|         - |  1631 | ` * Compile a double quoted string.` |
|         - |  1632 | ` *  See the block-comment above for more information.` |
|         - |  1633 | ` */` |
|    121550 |  1634 | `PH7_PRIVATE sxi32 PH7_CompileString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|         5 |  1635 | `{` |
|         - |  1636 | `	sxi32 rc;` |
|    121555 |  1637 | `	rc = GenStateCompileString(&(*pGen),0/*bHeredoc*/);` |
|     60775 |  1638 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|         - |  1639 | `	/* Compilation result */` |
|    121555 |  1640 | `	return rc;` |
|         5 |  1641 | `}` |
|         - |  1642 | `/*` |
...
|         - |  1683 | ` */` |
|   1452360 |  1684 | `static sxi32 GenStateCompileArrayEntry(` |
...
|   1452365 |  1695 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|         - |  1696 | `	/* Compile the expression*/` |
|   1452365 |  1697 | `	rc = PH7_CompileExpr(&(*pGen),iFlags,xValidator);` |
|         - |  1698 | `	/* Restore token stream */` |
|   1452365 |  1699 | `	RE_SWAP_DELIMITER(pGen);` |
|   1452365 |  1700 | `	return rc;` |
|         5 |  1701 | `}` |
|         - |  1702 | `/*` |
...
|         - |  1738 | ` */` |
|   1393166 |  1739 | `static SyToken * GenStateFindTopLevelArrow(SyToken *pStart,SyToken *pEnd)` |
|         5 |  1740 | `{` |
|   1393171 |  1741 | `	SyToken *pCur = pStart;` |
|   1393171 |  1742 | `	sxi32 iNest = 0;` |
|   3596573 |  1743 | `	while( pCur < pEnd ){` |
|   2711279 |  1744 | `		if( (pCur->nType & PH7_TK_ARRAY_OP) && iNest <= 0 ){` |
|    507873 |  1745 | `			return pCur;` |
|         - |  1746 | `		}` |
...
|         - |  1750 | `		 */` |
|   2203411 |  1751 | `		if( iNest == 0 && (pCur->nType & PH7_TK_KEYWORD) ){` |
|     23259 |  1752 | `			sxu32 nKw = (sxu32)SX_PTR_TO_INT(pCur->pUserData);` |
|     23259 |  1753 | `			SyToken *pFn = pCur;` |
|     23254 |  1754 | `			if( nKw == PH7_TKWRD_STATIC && &pCur[1] < pEnd` |
|       ! 0 |  1755 | `				&& (pCur[1].nType & PH7_TK_KEYWORD)` |
|         5 |  1756 | `				&& SX_PTR_TO_INT(pCur[1].pUserData) == PH7_TKWRD_FN ){` |
|       ! 0 |  1757 | `				pFn = &pCur[1];` |
|       ! 0 |  1758 | `				nKw = PH7_TKWRD_FN;` |
|       ! 0 |  1759 | `			}` |
|     23259 |  1760 | `			if( nKw == PH7_TKWRD_FN ){` |
...
|     23255 |  1791 | `			if( nKw == PH7_TKWRD_MATCH ){` |
...
|         - |  1810 | `			}` |
|     11624 |  1811 | `		}` |
|   2203405 |  1812 | `		if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|     54593 |  1813 | `			iNest++;` |
|   2176111 |  1814 | `		}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}'*/) ){` |
...
|         - |  1827 | ` */` |
|    629204 |  1828 | `static sxi32 GenStateCompileArrayBody(ph7_gen_state *pGen)` |
|         5 |  1829 | `{` |
|         - |  1830 | `	sxi32 (*xValidator)(ph7_gen_state *,ph7_expr_node *); /* Expression tree validator callback */` |
|         - |  1831 | `	SyToken *pKey,*pCur;` |
|    629209 |  1832 | `	sxi32 iEmitRef = 0;` |
|    629209 |  1833 | `	sxi32 iSpread = 0;` |
|    629209 |  1834 | `	sxi32 nPair = 0;` |
|         - |  1835 | `	sxi32 rc;` |
|    629209 |  1836 | `	xValidator = 0;` |
|    854407 |  1837 | `	for(;;){` |
...
|    539805 |  1842 | `		{` |
|   1708819 |  1843 | `			int nSkip = 0;` |
|   2538047 |  1844 | `			while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA) ){` |
|    829233 |  1845 | `				nSkip++;` |
|    829233 |  1846 | `				pGen->pIn++;` |
|         5 |  1847 | `			}` |
|   1708819 |  1848 | `			if( nSkip > 1 \|\| (nSkip > 0 && nPair < 1) ){` |
...
|         - |  1855 | `			}` |
|         - |  1856 | `		}` |
|   1708819 |  1857 | `		pCur = pGen->pIn;` |
|   1708819 |  1858 | `		if( SXRET_OK != PH7_GetNextExpr(pGen->pIn,pGen->pEnd,&pGen->pIn) ){` |
|         - |  1859 | `			/* No more entry to process */` |
|    629191 |  1860 | `			break;` |
|         - |  1861 | `		}` |
|   1079633 |  1862 | `		if( pCur >= pGen->pIn ){` |
|       ! 0 |  1863 | `			continue;` |
|         - |  1864 | `		}` |
|         - |  1865 | `		/* Compile the key if available */` |
|   1079633 |  1866 | `		pKey = pCur;` |
|   1079633 |  1867 | `		pCur = GenStateFindTopLevelArrow(pCur,pGen->pIn);` |
|   1079633 |  1868 | `		rc = SXERR_EMPTY;` |
|   1079633 |  1869 | `		if( pCur < pGen->pIn ){` |
|    372479 |  1870 | `			if( pKey == pCur ){` |
...
|         - |  1883 | `			}` |
|    372477 |  1884 | `			if( &pCur[1] >= pGen->pIn ){` |
...
|    372467 |  1895 | `			rc = GenStateCompileArrayEntry(&(*pGen),pKey,pCur,` |
|         - |  1896 | `				EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,0);` |
|    372467 |  1897 | `			if( rc == SXERR_ABORT ){` |
|       ! 0 |  1898 | `				return SXERR_ABORT;` |
|         - |  1899 | `			}` |
|    372467 |  1900 | `			pCur++; /* Jump the '=>' operator */` |
|    186236 |  1901 | `		}else{` |
|         - |  1902 | `			/* Reset back the cursor and point to the entry value */` |
|    707159 |  1903 | `			pCur = pKey;` |
|         - |  1904 | `		}` |
|   1079621 |  1905 | `		if( rc == SXERR_EMPTY ){` |
...
|    707159 |  1908 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,PH7_LOADC_NOKEY,0 /* nil index */,0,0);` |
|    353577 |  1909 | `		}` |
|   1079621 |  1910 | `		if( pCur->nType & PH7_TK_AMPER /*'&'*/){` |
...
|   1079619 |  1929 | `		iSpread = (pCur < pGen->pIn && (pCur->nType & PH7_TK_ELLIPSIS)) ? 1 : 0;` |
|   1079619 |  1930 | `		if( iSpread && (rc != SXERR_EMPTY \|\| iEmitRef) ){` |
...
|   1619420 |  1947 | `		rc = GenStateCompileArrayEntry(&(*pGen),pCur,pGen->pIn,` |
|    539805 |  1948 | `			iEmitRef ? EXPR_FLAG_LOAD_IDX_STORE` |
|         - |  1949 | `			         : EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,` |
|    539805 |  1950 | `			xValidator);` |
|   1079615 |  1951 | `		if( rc == SXERR_ABORT ){` |
|       ! 0 |  1952 | `			return SXERR_ABORT;` |
|         - |  1953 | `		}` |
|   1079615 |  1954 | `		if( iSpread ){` |
...
|   1079580 |  1957 | `		}else if( iEmitRef ){` |
|         - |  1958 | `			/* Emit the load reference instruction */` |
|        41 |  1959 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_REF,0,0,0,0);` |
|        18 |  1960 | `		}` |
|   1079615 |  1961 | `		xValidator = 0;` |
|   1079615 |  1962 | `		iEmitRef = 0;` |
|   1079615 |  1963 | `		iSpread = 0;` |
|   1079615 |  1964 | `		nPair++;` |
|         5 |  1965 | `	}` |
|         - |  1966 | `	/* Emit the load map instruction */` |
|    629191 |  1967 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_MAP,nPair * 2,0,0,0);` |
|         - |  1968 | `	/* Node successfully compiled */` |
|    629191 |  1969 | `	return SXRET_OK;` |
|    314607 |  1970 | `}` |
|         - |  1971 | `/*` |
...
|         - |  1979 | ` */` |
|    410804 |  1980 | `PH7_PRIVATE sxi32 PH7_CompileArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|         5 |  1981 | `{` |
|         - |  1982 | `	/* Jump the 'array' keyword and the leading '(', exclude trailing ')'. */` |
|    410809 |  1983 | `	pGen->pIn += 2;` |
|    410809 |  1984 | `	pGen->pEnd--;` |
|    205402 |  1985 | `	SXUNUSED(iCompileFlag);` |
|    410809 |  1986 | `	return GenStateCompileArrayBody(pGen);` |
|         5 |  1987 | `}` |
|         - |  1988 | `/*` |
...
|         - |  2084 | ` */` |
|    218400 |  2085 | `PH7_PRIVATE sxi32 PH7_CompileShortArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|         5 |  2086 | `{` |
|         - |  2087 | `	/* Jump the leading '[', exclude trailing ']'. */` |
|    218405 |  2088 | `	pGen->pIn++;` |
|    218405 |  2089 | `	pGen->pEnd--;` |
|    109200 |  2090 | `	SXUNUSED(iCompileFlag);` |
|    218405 |  2091 | `	return GenStateCompileArrayBody(pGen);` |
|         5 |  2092 | `}` |
|         - |  2093 | `/*` |
...
|         - |  3390 | ` */` |
|  20058464 |  3391 | `PH7_PRIVATE sxi32 PH7_CompileVariable(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|         5 |  3392 | `{` |
|  20058469 |  3393 | `	sxu32 nLineLocal = pGen->pIn->nLine;` |
|         - |  3394 | `	sxi32 iVv;` |
|         - |  3395 | `	sxi32 iP1;` |
|         - |  3396 | `	void *p3;` |
|         - |  3397 | `	sxi32 rc;` |
|  20058469 |  3398 | `	iVv = -1; /* Variable variable counter */` |
|  40116945 |  3399 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) ){` |
|  20058481 |  3400 | `		pGen->pIn++;` |
|  20058481 |  3401 | `		iVv++;` |
|         5 |  3402 | `	}` |
|  20058469 |  3403 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_OCB/*'{'*/)) == 0 ){` |
...
|         - |  3411 | `	}` |
|  20058469 |  3412 | `	p3  = 0;` |
|  20058469 |  3413 | `	if( pGen->pIn->nType & PH7_TK_OCB/*'{'*/ ){` |
...
|         - |  3438 | `		SyString *pName;` |
|  20058453 |  3439 | `		char *zName = 0;` |
|         - |  3440 | `		/* Extract variable name */` |
|  20058453 |  3441 | `		pName = &pGen->pIn->sData;` |
|         - |  3442 | `		/* Advance the stream cursor */` |
|  20058453 |  3443 | `		pGen->pIn++;` |
|  20058453 |  3444 | `		pEntry = SyHashGet(&pGen->hVar,(const void *)pName->zString,pName->nByte);` |
|  20058453 |  3445 | `		if( pEntry == 0 ){` |
|         - |  3446 | `			/* Duplicate name */` |
|   1191195 |  3447 | `			zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|   1191195 |  3448 | `			if( zName == 0 ){` |
...
|   1191195 |  3453 | `			SyHashInsert(&pGen->hVar,zName,pName->nByte,zName);` |
|    595600 |  3454 | `		}else{` |
|         - |  3455 | `			/* Name already available */` |
|  18867263 |  3456 | `			zName = (char *)pEntry->pUserData;` |
|         - |  3457 | `		}` |
|  20058453 |  3458 | `		p3 = (void *)zName;` |
|         - |  3459 | `	}` |
|  20058465 |  3460 | `	iP1 = 0;` |
|  20058465 |  3461 | `	if( iCompileFlag & EXPR_FLAG_RDONLY_LOAD ){` |
|   5927801 |  3462 | `		if( (iCompileFlag & EXPR_FLAG_LOAD_IDX_STORE) == 0 ){` |
|         - |  3463 | `			/* Read-only load.In other words do not create the variable if inexistant */` |
|   5923919 |  3464 | `			iP1 = 1;` |
|   2961957 |  3465 | `		}` |
|   2963898 |  3466 | `	}` |
|         - |  3467 | `	/* Emit the load instruction */` |
|  20058465 |  3468 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,0,p3,0);` |
|  20058477 |  3469 | `	while( iVv > 0 ){` |
|        13 |  3470 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,0,0,0);` |
|        13 |  3471 | `		iVv--;` |
|         1 |  3472 | `	}` |
|         - |  3473 | `	/* Node successfully compiled */` |
|  20058465 |  3474 | `	return SXRET_OK;` |
|  10029237 |  3475 | `}` |
|         - |  3476 | `/*` |
|         - |  3477 | ` * Load a literal.` |
|         - |  3478 | ` */` |
|  12590652 |  3479 | `static sxi32 GenStateLoadLiteral(ph7_gen_state *pGen)` |
|         5 |  3480 | `{` |
|  12590657 |  3481 | `	SyToken *pToken = pGen->pIn;` |
|         - |  3482 | `	ph7_value *pObj;` |
|         - |  3483 | `	SyString *pStr;` |
|         - |  3484 | `	sxu32 nIdx;` |
|         - |  3485 | `	/* Extract token value */` |
|  12590657 |  3486 | `	pStr = &pToken->sData;` |
...
|  12590657 |  3491 | `	if( pToken->nType & PH7_TK_MEMBER_NAME ){` |
|         - |  3492 | `		/* fall through to the plain-string literal path */` |
|  10040741 |  3493 | `	}else if( pStr->nByte == sizeof("NULL") - 1 ){` |
|   1492797 |  3494 | `		if( SyStrnicmp(pStr->zString,"null",sizeof("NULL")-1) == 0 ){` |
|         - |  3495 | `			/* NULL constant are always indexed at 0 */` |
|    992491 |  3496 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,0,0,0);` |
|    992491 |  3497 | `			return SXRET_OK;` |
|    500311 |  3498 | `		}else if( SyStrnicmp(pStr->zString,"true",sizeof("TRUE")-1) == 0 ){` |
|         - |  3499 | `			/* TRUE constant are always indexed at 1 */` |
|    329227 |  3500 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,1,0,0);` |
|    329227 |  3501 | `			return SXRET_OK;` |
|         5 |  3502 | `		}` |
|   6839667 |  3503 | `	}else if (pStr->nByte == sizeof("FALSE") - 1 &&` |
|   1512184 |  3504 | `		SyStrnicmp(pStr->zString,"false",sizeof("FALSE")-1) == 0 ){` |
|         - |  3505 | `			/* FALSE constant are always indexed at 2 */` |
|    737553 |  3506 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,2,0,0);` |
|    737553 |  3507 | `			return SXRET_OK;` |
|   5402224 |  3508 | `	}else if(pStr->nByte == sizeof("__LINE__") - 1 &&` |
|    283478 |  3509 | `		SyMemcmp(pStr->zString,"__LINE__",sizeof("__LINE__")-1) == 0 ){` |
|         - |  3510 | `			/* TICKET 1433-004: __LINE__ constant must be resolved at compile time,not run time */` |
|      3871 |  3511 | `			pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|      3871 |  3512 | `			if( pObj == 0 ){` |
|       ! 0 |  3513 | `				PH7_GenCompileError(pGen,E_ERROR,pToken->nLine,"Fatal, PH7 engine is running out of memory");` |
|       ! 0 |  3514 | `				return SXERR_ABORT;` |
|         - |  3515 | `			}` |
|      3871 |  3516 | `			PH7_MemObjInitFromInt(pGen->pVm,pObj,pToken->nLine);` |
|         - |  3517 | `			/* Emit the load constant instruction */` |
|      3871 |  3518 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|      3871 |  3519 | `			return SXRET_OK;` |
|   5396420 |  3520 | `	}else if( (pStr->nByte == sizeof("__FILE__") - 1 &&` |
|    497299 |  3521 | `		SyMemcmp(pStr->zString,"__FILE__",sizeof("__FILE__")-1) == 0) \|\|` |
|   5470370 |  3522 | `		(pStr->nByte == sizeof("__DIR__") - 1 &&` |
|    435364 |  3523 | `		SyMemcmp(pStr->zString,"__DIR__",sizeof("__DIR__")-1) == 0) ){` |
...
|      3953 |  3530 | `			int bDir = (pStr->zString[2] == 'D'); /* __DIR__ vs __FILE__ */` |
|      3953 |  3531 | `			SyString *pFile = (SyString *)SySetPeek(&pGen->pVm->aFiles);` |
|      3953 |  3532 | `			pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|      3953 |  3533 | `			if( pObj == 0 ){` |
|       ! 0 |  3534 | `				PH7_GenCompileError(pGen,E_ERROR,pToken->nLine,"Fatal, PH7 engine is running out of memory");` |
|       ! 0 |  3535 | `				return SXERR_ABORT;` |
|         - |  3536 | `			}` |
|      3953 |  3537 | `			if( pFile && pFile->nByte > 0 ){` |
|        95 |  3538 | `				if( bDir ){` |
...
|        50 |  3548 | `			}else{` |
|         - |  3549 | `				SyString sMem;` |
|      3863 |  3550 | `				SyStringInitFromBuf(&sMem,":MEMORY:",sizeof(":MEMORY:")-1);` |
|      3863 |  3551 | `				PH7_MemObjInitFromString(pGen->pVm,pObj,&sMem);` |
|         - |  3552 | `			}` |
|      3953 |  3553 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|      3953 |  3554 | `			return SXRET_OK;` |
|   5355254 |  3555 | `	}else if( pStr->nByte == sizeof("__NAMESPACE__") - 1 &&` |
|    205166 |  3556 | `		SyMemcmp(pStr->zString,"__NAMESPACE__",sizeof("__NAMESPACE__")-1) == 0 ){` |
...
|   5367045 |  3572 | `	}else if( (pStr->nByte == sizeof("__FUNCTION__") - 1 &&` |
|    380237 |  3573 | `		SyMemcmp(pStr->zString,"__FUNCTION__",sizeof("__FUNCTION__")-1) == 0) \|\|` |
|   5404115 |  3574 | `		(pStr->nByte == sizeof("__METHOD__") - 1 &&` |
|    302924 |  3575 | `		SyMemcmp(pStr->zString,"__METHOD__",sizeof("__METHOD__")-1) == 0) ){` |
...
|  10523571 |  3618 | `	if( SXRET_OK != GenStateFindLiteral(&(*pGen),&pToken->sData,&nIdx) ){` |
|         - |  3619 | `		ph7_value *pLitObj;` |
|         - |  3620 | `		/* Unknown literal,install it in the literal table */` |
|   2028211 |  3621 | `		pLitObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   2028211 |  3622 | `		if( pLitObj == 0 ){` |
|       ! 0 |  3623 | `			PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|       ! 0 |  3624 | `			return SXERR_ABORT;` |
|         - |  3625 | `		}` |
|   2028211 |  3626 | `		PH7_MemObjInitFromString(pGen->pVm,pLitObj,&pToken->sData);` |
|   2028211 |  3627 | `		GenStateInstallLiteral(&(*pGen),pLitObj,nIdx);` |
|   1014103 |  3628 | `	}` |
|         - |  3629 | `	/* Emit the load constant instruction */` |
|  10523571 |  3630 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,1,nIdx,0,0);` |
|  10523571 |  3631 | `	return SXRET_OK;` |
|   6295331 |  3632 | `}` |
|         - |  3633 | `/*` |
...
|         - |  3638 | ` */` |
|  12594594 |  3639 | `static sxi32 GenStateResolveNamespaceLiteral(ph7_gen_state *pGen)` |
|         5 |  3640 | `{` |
|         - |  3641 | `	sxi32 rc;` |
|  12594599 |  3642 | `	if( pGen->pIn >= pGen->pEnd ){` |
|       ! 0 |  3643 | `		return SXRET_OK;` |
|         - |  3644 | `	}` |
|         - |  3645 | `	/* Check if this is a multi-token namespace path */` |
|  12594599 |  3646 | `	if( pGen->pIn < &pGen->pEnd[-1] ){` |
|         - |  3647 | `		/* Multiple tokens: assemble the full path into sWorker */` |
|      3947 |  3648 | `		SyBlob *pWorker = &pGen->sWorker;` |
|      3947 |  3649 | `		int isAbsolute = 0;` |
|      3947 |  3650 | `		SyBlobReset(pWorker);` |
|         - |  3651 | `		/* Check for leading backslash (absolute path) */` |
|      3947 |  3652 | `		if( pGen->pIn->nType & PH7_TK_NSSEP ){` |
|      3931 |  3653 | `			isAbsolute = 1;` |
|      3931 |  3654 | `			pGen->pIn++; /* Skip leading backslash */` |
|      1963 |  3655 | `		}` |
...
|         - |  3661 | `		{` |
|         - |  3662 | `			SyBlob sRaw;` |
|      3947 |  3663 | `			SyBlobInit(&sRaw,&pGen->pVm->sAllocator);` |
|      4099 |  3664 | `			while( pGen->pIn <= &pGen->pEnd[-1] ){` |
|      4099 |  3665 | `				if( pGen->pIn->nType & PH7_TK_NSSEP ){` |
|        81 |  3666 | `					SyBlobAppend(&sRaw,"\\",1);` |
|        43 |  3667 | `				}else{` |
|      4023 |  3668 | `					SyBlobAppend(&sRaw,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|         - |  3669 | `				}` |
|      4099 |  3670 | `				if( pGen->pIn == &pGen->pEnd[-1] ){` |
|      3947 |  3671 | `					pGen->pIn++;` |
|      3947 |  3672 | `					break;` |
|         - |  3673 | `				}` |
|       157 |  3674 | `				pGen->pIn++;` |
|         5 |  3675 | `			}` |
|      3947 |  3676 | `			if( isAbsolute ){` |
|      3931 |  3677 | `				SyBlobAppend(pWorker,SyBlobData(&sRaw),SyBlobLength(&sRaw)); /* FQN as written */` |
|      1968 |  3678 | `			}else{` |
...
|         - |  3696 | `				}` |
|         - |  3697 | `			}` |
|      3947 |  3698 | `			SyBlobRelease(&sRaw);` |
|         - |  3699 | `		}` |
|      3947 |  3700 | `		if( SyBlobLength(pWorker) > 0 ){` |
|         - |  3701 | `			ph7_value *pObj;` |
|         - |  3702 | `			SyString sPath;` |
|         - |  3703 | `			sxu32 nIdx;` |
|      3947 |  3704 | `			SyStringInitFromBuf(&sPath,(const char *)SyBlobData(pWorker),SyBlobLength(pWorker));` |
|         - |  3705 | `			/* Install in the literal table */` |
|      3947 |  3706 | `			if( SXRET_OK != GenStateFindLiteral(&(*pGen),&sPath,&nIdx) ){` |
|      3895 |  3707 | `				pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|      3895 |  3708 | `				if( pObj == 0 ){` |
|       ! 0 |  3709 | `					PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|       ! 0 |  3710 | `					return SXERR_ABORT;` |
|         - |  3711 | `				}` |
|      3895 |  3712 | `				PH7_MemObjInitFromString(pGen->pVm,pObj,&sPath);` |
|      3895 |  3713 | `				GenStateInstallLiteral(&(*pGen),pObj,nIdx);` |
|      1945 |  3714 | `			}` |
...
|      5918 |  3718 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,` |
|      1971 |  3719 | `				isAbsolute ? (PH7_LOADC_EXPAND\|PH7_LOADC_ABSOLUTE) : PH7_LOADC_EXPAND,` |
|      1971 |  3720 | `				nIdx,0,0);` |
|      3947 |  3721 | `			return SXRET_OK;` |
|         - |  3722 | `		}` |
|       ! 0 |  3723 | `	}` |
|         - |  3724 | `	/* Single-token literal: load directly */` |
|  12590657 |  3725 | `	rc = GenStateLoadLiteral(&(*pGen));` |
|  12590657 |  3726 | `	return rc;` |
|   6297302 |  3727 | `}` |
|         - |  3728 | `/*` |
...
|       ! 0 |  3743 | `}` |
|  12594594 |  3744 | `PH7_PRIVATE sxi32 PH7_CompileLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|         5 |  3745 | `{` |
|         - |  3746 | `	sxi32 rc;` |
|  12594599 |  3747 | `	rc = GenStateResolveNamespaceLiteral(&(*pGen));` |
|  12594599 |  3748 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  3749 | `		SXUNUSED(iCompileFlag); /* cc warning */` |
|       ! 0 |  3750 | `		return rc;` |
|         - |  3751 | `	}` |
|         - |  3752 | `	/* Node successfully compiled */` |
|  12594599 |  3753 | `	return SXRET_OK;` |
|   6297302 |  3754 | `}` |
|         - |  3755 | `/*` |
...
|         - |  3770 | ` */` |
|    339736 |  3771 | `static int GenStateIsReservedConstant(SyString *pName)` |
|         5 |  3772 | `{` |
|    339741 |  3773 | `	if( pName->nByte == sizeof("null") - 1 ){` |
|      3907 |  3774 | `		if( SyStrnicmp(pName->zString,"null",sizeof("null")-1) == 0 ){` |
|         3 |  3775 | `			return TRUE;` |
|      3905 |  3776 | `		}else if( SyStrnicmp(pName->zString,"true",sizeof("true")-1) == 0 ){` |
|         6 |  3777 | `			return TRUE;` |
|         5 |  3778 | `		}` |
|    337787 |  3779 | `	}else if( pName->nByte == sizeof("false") - 1 ){` |
|      7741 |  3780 | `		if( SyStrnicmp(pName->zString,"false",sizeof("false")-1) == 0 ){` |
|         3 |  3781 | `			return TRUE;` |
|         - |  3782 | `		}` |
|      3867 |  3783 | `	}` |
|         - |  3784 | `	/* Not a reserved constant */` |
|    339733 |  3785 | `	return FALSE;` |
|    169873 |  3786 | `}` |
|         - |  3787 | `/*` |
...
|         - |  3927 | ` */` |
|    154474 |  3928 | `static int GenStateEmitExceptionPopForBreak(ph7_gen_state *pGen,GenBlock *pTarget)` |
|         5 |  3929 | `{` |
|    154479 |  3930 | `	GenBlock *pBlock = pGen->pCurrent;` |
|    154479 |  3931 | `	int nInlineTry = 0;` |
|    694845 |  3932 | `	while( pBlock && pBlock != pTarget ){` |
|    540371 |  3933 | `		if( pBlock->iFlags & GEN_BLOCK_EXCEPTION ){` |
...
|         - |  3948 | `			}` |
|         2 |  3949 | `		}` |
|    540371 |  3950 | `		pBlock = pBlock->pParent;` |
|         5 |  3951 | `	}` |
|    154479 |  3952 | `	return nInlineTry;` |
|         5 |  3953 | `}` |
|     88784 |  3954 | `static sxi32 PH7_CompileContinue(ph7_gen_state *pGen)` |
|         5 |  3955 | `{` |
|         - |  3956 | `	GenBlock *pLoop; /* Target loop */` |
|         - |  3957 | `	sxi32 iLevel;    /* How many nesting loop to skip */` |
|         - |  3958 | `	sxu32 nLineLocal;` |
|         - |  3959 | `	sxi32 rc;` |
|     88789 |  3960 | `	nLineLocal = pGen->pIn->nLine;` |
|     88789 |  3961 | `	iLevel = 0;` |
|         - |  3962 | `	/* Jump the 'continue' keyword */` |
|     88789 |  3963 | `	pGen->pIn++;` |
|     88789 |  3964 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NUM) ){` |
...
|     88789 |  3990 | `	pLoop = GenStateFetchBlock(pGen->pCurrent,GEN_BLOCK_LOOP,iLevel);` |
|     88789 |  3991 | `	if( pLoop == 0 ){` |
...
|         - |  3997 | `		}` |
|         7 |  3998 | `	}else{` |
|     88779 |  3999 | `		sxu32 nInstrIdx = 0;` |
|         - |  4000 | `		/* Emit POP_EXCEPTION (legacy) for crossed try blocks, or count them (generator). */` |
|     88779 |  4001 | `		int nCross = GenStateEmitExceptionPopForBreak(&(*pGen),pLoop);` |
...
|     88779 |  4004 | `		sxi32 iJmpOp = nCross > 0 ? PH7_OP_SET_FINALLY_JMP : PH7_OP_JMP;` |
|     88779 |  4005 | `		if( pLoop->iFlags & GEN_BLOCK_SWITCH ){` |
...
|     88775 |  4021 | `			PH7_VmEmitInstr(pGen->pVm,iJmpOp,nCross,pLoop->nFirstInstr,0,&nInstrIdx);` |
|     88775 |  4022 | `			if( pLoop->bPostContinue == TRUE ){` |
|         - |  4023 | `				JumpFixup sJumpFix;` |
|         - |  4024 | `				/* Post-continue */` |
|     27023 |  4025 | `				sJumpFix.nJumpType = PH7_OP_JMP;` |
|     27023 |  4026 | `				sJumpFix.nInstrIdx = nInstrIdx;` |
|     27023 |  4027 | `				SySetPut(&pLoop->aPostContFix,(const void *)&sJumpFix);` |
|     13509 |  4028 | `			}` |
|         - |  4029 | `		}` |
|         - |  4030 | `	}` |
|     88789 |  4031 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
...
|         - |  4045 | ` */` |
|     65716 |  4046 | `static sxi32 PH7_CompileBreak(ph7_gen_state *pGen)` |
|         5 |  4047 | `{` |
...
|     65721 |  4053 | `	pGen->pIn++;` |
|     65721 |  4054 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NUM) ){` |
...
|     65721 |  4080 | `	pLoop = GenStateFetchBlock(pGen->pCurrent,GEN_BLOCK_LOOP,iLevel);` |
|     65721 |  4081 | `	if( pLoop == 0 ){` |
|         - |  4082 | `		/* Illegal break */` |
...
|     65705 |  4091 | `		int nCross = GenStateEmitExceptionPopForBreak(&(*pGen),pLoop);` |
|         - |  4092 | `		/* ROOT C: OP_SET_FINALLY_JMP runs the crossed inline finallys before the break jump. */` |
|     65705 |  4093 | `		rc = PH7_VmEmitInstr(pGen->pVm,nCross > 0 ? PH7_OP_SET_FINALLY_JMP : PH7_OP_JMP,nCross,0,0,&nInstrIdx);` |
|     65705 |  4094 | `		if( rc == SXRET_OK ){` |
|         - |  4095 | `			/* Fix the jump later when the jump destination is resolved */` |
|     65705 |  4096 | `			GenStateNewJumpFixup(pLoop,PH7_OP_JMP,nInstrIdx);` |
|     32850 |  4097 | `		}` |
|         - |  4098 | `	}` |
|     65721 |  4099 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
...
|         - |  4307 | ` * message.` |
|         - |  4308 | ` */` |
|   6326906 |  4309 | `static sxi32 PH7_CompileBlock(` |
...
|         - |  4314 | `	sxi32 rc;` |
|         - |  4315 | `	sxu32 nLine;` |
|   6326911 |  4316 | `	if( pGen->pIn->nType & PH7_TK_OCB /* '{' */ ){` |
|   6302671 |  4317 | `		nLine = pGen->pIn->nLine;` |
|   6302671 |  4318 | `		rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_STD,PH7_VmInstrLength(pGen->pVm),0,0);` |
|   6302671 |  4319 | `		if( rc != SXRET_OK ){` |
|       ! 0 |  4320 | `			return SXERR_ABORT;` |
|         - |  4321 | `		}` |
|   6302671 |  4322 | `		pGen->pIn++;` |
|         - |  4323 | `		/* Compile until we hit the closing braces '}' */` |
|   9278489 |  4324 | `		for(;;){` |
|  18556983 |  4325 | `			if( pGen->pIn >= pGen->pEnd ){` |
...
|         - |  4335 | `				}` |
|       ! 0 |  4336 | `			}` |
|  18556963 |  4337 | `			if( pGen->pIn->nType & PH7_TK_CCB/*'}'*/ ){` |
|         - |  4338 | `				/* Closing braces found,break immediately*/` |
|   6302651 |  4339 | `				pGen->pIn++;` |
|   6302651 |  4340 | `				break;` |
|         - |  4341 | `			}` |
|         - |  4342 | `			/* Compile a single statement */` |
|  12254317 |  4343 | `			rc = GenStateCompileChunk(&(*pGen),PH7_COMPILE_SINGLE_STMT);` |
|  12254317 |  4344 | `			if( rc == SXERR_ABORT ){` |
|       ! 0 |  4345 | `				return SXERR_ABORT;` |
|         - |  4346 | `			}` |
|         5 |  4347 | `		}` |
|   6302671 |  4348 | `		GenStateLeaveBlock(&(*pGen),0);` |
|   3175578 |  4349 | `	}else if( (pGen->pIn->nType & PH7_TK_COLON /* ':' */) && nKeywordEnd > 0 ){` |
|       ! 0 |  4350 | `		pGen->pIn++;` |
...
|     24245 |  4393 | `		rc = GenStateCompileChunk(&(*pGen),PH7_COMPILE_SINGLE_STMT);` |
|     24245 |  4394 | `		if( rc == SXERR_ABORT ){` |
|       ! 0 |  4395 | `			return SXERR_ABORT;` |
|         - |  4396 | `		}` |
|         - |  4397 | `	}` |
|         - |  4398 | `	/* Jump trailing semi-colons ';' */` |
|   6326911 |  4399 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|       ! 0 |  4400 | `		pGen->pIn++;` |
|       ! 0 |  4401 | `	}` |
|   6326911 |  4402 | `	return SXRET_OK;` |
|   3163458 |  4403 | `}` |
|         - |  4404 | `/*` |
...
|         - |  4421 | ` *   endwhile;` |
|         - |  4422 | ` */` |
|     73448 |  4423 | `static sxi32 PH7_CompileWhile(ph7_gen_state *pGen)` |
|         5 |  4424 | `{` |
|     73453 |  4425 | `	GenBlock *pWhileBlock = 0;` |
|     73453 |  4426 | `	SyToken *pTmp,*pEnd = 0;` |
|         - |  4427 | `	sxu32 nFalseJump;` |
|         - |  4428 | `	sxu32 nLine;` |
|         - |  4429 | `	sxi32 rc;` |
|     73453 |  4430 | `	nLine = pGen->pIn->nLine;` |
|         - |  4431 | `	/* Jump the 'while' keyword */` |
|     73453 |  4432 | `	pGen->pIn++;` |
|     73453 |  4433 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|         - |  4434 | `		/* Syntax error */` |
...
|     73453 |  4445 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pWhileBlock);` |
|     73453 |  4446 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  4447 | `		return SXERR_ABORT;` |
|         - |  4448 | `	}` |
|         - |  4449 | `	/* Delimit the condition */` |
|     73453 |  4450 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|     73453 |  4451 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|     73453 |  4460 | `	pTmp = pGen->pEnd;` |
|     73453 |  4461 | `	pGen->pEnd = pEnd;` |
|         - |  4462 | `	/* Compile the expression */` |
|     73453 |  4463 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|     73453 |  4464 | `	if( rc == SXERR_ABORT ){` |
|         - |  4465 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|       ! 0 |  4466 | `		return SXERR_ABORT;` |
|         - |  4467 | `	}` |
|         - |  4468 | `	/* Update token stream */` |
|     73453 |  4469 | `	while(pGen->pIn < pEnd ){` |
...
|     73453 |  4477 | `	pGen->pIn  = &pEnd[1];` |
|     73453 |  4478 | `	pGen->pEnd = pTmp;` |
|         - |  4479 | `	/* Emit the false jump */` |
|     73453 |  4480 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nFalseJump);` |
|         - |  4481 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|     73453 |  4482 | `	GenStateNewJumpFixup(pWhileBlock,PH7_OP_JZ,nFalseJump);` |
|         - |  4483 | `	/* Compile the loop body */` |
|     73453 |  4484 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDWHILE);` |
|     73453 |  4485 | `	if( rc == SXERR_ABORT ){` |
|       ! 0 |  4486 | `		return SXERR_ABORT;` |
|         - |  4487 | `	}` |
|         - |  4488 | `	/* Emit the unconditional jump to the start of the loop */` |
|     73453 |  4489 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pWhileBlock->nFirstInstr,0,0);` |
|         - |  4490 | `	/* Fix all jumps now the destination is resolved */` |
|     73453 |  4491 | `	GenStateFixJumps(pWhileBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|         - |  4492 | `	/* Release the loop block */` |
|     73453 |  4493 | `	GenStateLeaveBlock(pGen,0);` |
|         - |  4494 | `	/* Statement successfully compiled */` |
|     73453 |  4495 | `	return SXRET_OK;` |
|       ! 0 |  4496 | `Synchronize:` |
...
|         - |  4651 | ` */` |
|    123604 |  4652 | `static sxi32 PH7_CompileFor(ph7_gen_state *pGen)` |
|         5 |  4653 | `{` |
|    123609 |  4654 | `	SyToken *pTmp,*pPostStart,*pEnd = 0;` |
|    123609 |  4655 | `	GenBlock *pForBlock = 0;` |
|         - |  4656 | `	sxu32 nFalseJump;` |
|         - |  4657 | `	sxu32 nLine;` |
|         - |  4658 | `	sxi32 rc;` |
|    123609 |  4659 | `	nLine = pGen->pIn->nLine;` |
|         - |  4660 | `	/* Jump the 'for' keyword */` |
|    123609 |  4661 | `	pGen->pIn++;` |
|    123609 |  4662 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|         - |  4663 | `		/* Syntax error */` |
...
|    123609 |  4672 | `	pGen->pIn++;` |
|         - |  4673 | `	/* Delimit the init-expr;condition;post-expr */` |
|    123609 |  4674 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|    123609 |  4675 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|    123609 |  4690 | `	pTmp = pGen->pEnd;` |
|    123609 |  4691 | `	pGen->pEnd = pEnd;` |
...
|    123609 |  4696 | `	pGen->nCommaExprOk++;` |
|         - |  4697 | `	/* Compile initialization expressions if available */` |
|    123609 |  4698 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|         - |  4699 | `	/* Pop operand lvalues */` |
|    123609 |  4700 | `	if( rc == SXERR_ABORT ){` |
|         - |  4701 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|       ! 0 |  4702 | `		return SXERR_ABORT;` |
|    123609 |  4703 | `	}else if( rc != SXERR_EMPTY ){` |
|    112033 |  4704 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|     56014 |  4705 | `	}` |
|    123609 |  4706 | `	if( (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|         - |  4707 | `		/* Syntax error */` |
...
|    123609 |  4716 | `	pGen->pIn++;` |
|         - |  4717 | `	/* Create the loop block */` |
|    123609 |  4718 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pForBlock);` |
|    123609 |  4719 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  4720 | `		return SXERR_ABORT;` |
|         - |  4721 | `	}` |
|         - |  4722 | `	/* Deffer continue jumps */` |
|    123609 |  4723 | `	pForBlock->bPostContinue = TRUE;` |
|         - |  4724 | `	/* Compile the condition */` |
|    123609 |  4725 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|    123609 |  4726 | `	if( rc == SXERR_ABORT ){` |
|         - |  4727 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|       ! 0 |  4728 | `		return SXERR_ABORT;` |
|    123609 |  4729 | `	}else if( rc != SXERR_EMPTY ){` |
|         - |  4730 | `		/* Emit the false jump */` |
|    112033 |  4731 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nFalseJump);` |
|         - |  4732 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|    112033 |  4733 | `		GenStateNewJumpFixup(pForBlock,PH7_OP_JZ,nFalseJump);` |
|     56014 |  4734 | `	}` |
|    123609 |  4735 | `	if( (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|         - |  4736 | `		/* Syntax error */` |
...
|    123605 |  4745 | `	pGen->pIn++;` |
|         - |  4746 | `	/* Save the post condition stream */` |
|    123605 |  4747 | `	pPostStart = pGen->pIn;` |
...
|    123605 |  4750 | `	pGen->nCommaExprOk--;` |
|    123605 |  4751 | `	pGen->pIn  = &pEnd[1]; /* Jump the trailing parenthesis ')' */` |
|    123605 |  4752 | `	pGen->pEnd = pTmp;` |
|    123605 |  4753 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDFOR);` |
|    123605 |  4754 | `	if( rc == SXERR_ABORT ){` |
|       ! 0 |  4755 | `		return SXERR_ABORT;` |
|         - |  4756 | `	}` |
|         - |  4757 | `	/* Fix post-continue jumps */` |
|    123605 |  4758 | `	if( SySetUsed(&pForBlock->aPostContFix) > 0 ){` |
|         - |  4759 | `		JumpFixup *aPost;` |
|         - |  4760 | `		VmInstr *pInstr;` |
|         - |  4761 | `		sxu32 nJumpDest;` |
|         - |  4762 | `		sxu32 n;` |
|     11591 |  4763 | `		aPost = (JumpFixup *)SySetBasePtr(&pForBlock->aPostContFix);` |
|     11591 |  4764 | `		nJumpDest = PH7_VmInstrLength(pGen->pVm);` |
|     38609 |  4765 | `		for( n = 0 ; n < SySetUsed(&pForBlock->aPostContFix) ; ++n ){` |
|     27023 |  4766 | `			pInstr = PH7_VmGetInstr(pGen->pVm,aPost[n].nInstrIdx);` |
|     27023 |  4767 | `			if( pInstr ){` |
|         - |  4768 | `				/* Fix jump */` |
|     27023 |  4769 | `				pInstr->iP2 = nJumpDest;` |
|     13509 |  4770 | `			}` |
|     13514 |  4771 | `		}` |
|      5793 |  4772 | `	}` |
|         - |  4773 | `	/* compile the post-expressions if available */` |
|    123605 |  4774 | `	while( pPostStart < pEnd && (pPostStart->nType & PH7_TK_SEMI) ){` |
|       ! 0 |  4775 | `		pPostStart++;` |
|       ! 0 |  4776 | `	}` |
|    123605 |  4777 | `	if( pPostStart < pEnd ){` |
|         - |  4778 | `		SyToken *pTmpIn,*pTmpEnd;` |
|    112031 |  4779 | `		SWAP_DELIMITER(pGen,pPostStart,pEnd);` |
|    112031 |  4780 | `		pGen->nCommaExprOk++; /* post-expressions are a clause list again */` |
|    112031 |  4781 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|    112031 |  4782 | `		pGen->nCommaExprOk--;` |
|    112031 |  4783 | `		if( pGen->pIn < pGen->pEnd ){` |
|         - |  4784 | `			/* Syntax error */` |
...
|         - |  4791 | `		}` |
|    112031 |  4792 | `		RE_SWAP_DELIMITER(pGen);` |
|    112031 |  4793 | `		if( rc == SXERR_ABORT ){` |
|         - |  4794 | `			/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|       ! 0 |  4795 | `			return SXERR_ABORT;` |
|    112031 |  4796 | `		}else if( rc != SXERR_EMPTY){` |
|         - |  4797 | `			/* Pop operand lvalue */` |
|    112031 |  4798 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|     56013 |  4799 | `		}` |
|     56013 |  4800 | `	}` |
|         - |  4801 | `	/* Emit the unconditional jump to the start of the loop */` |
|    123605 |  4802 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pForBlock->nFirstInstr,0,0);` |
|         - |  4803 | `	/* Fix all jumps now the destination is resolved */` |
|    123605 |  4804 | `	GenStateFixJumps(pForBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|         - |  4805 | `	/* Release the loop block */` |
|    123605 |  4806 | `	GenStateLeaveBlock(pGen,0);` |
|         - |  4807 | `	/* Statement successfully compiled */` |
|    123605 |  4808 | `	return SXRET_OK;` |
|     61807 |  4809 | `}` |
...
|         - |  4812 | ` * are allowed.` |
|         - |  4813 | ` */` |
|    448588 |  4814 | `static sxi32 GenStateForEachNodeValidator(ph7_gen_state *pGen,ph7_expr_node *pRoot)` |
|         5 |  4815 | `{` |
|    448593 |  4816 | `	sxi32 rc = SXRET_OK; /* Assume a valid expression tree */` |
|    448593 |  4817 | `	if( pRoot->xCode != PH7_CompileVariable ){` |
...
|         - |  4852 | ` */` |
|    313276 |  4853 | `static sxi32 PH7_CompileForeach(ph7_gen_state *pGen)` |
|         5 |  4854 | `{` |
|    313281 |  4855 | `	SyToken *pCur,*pTmp,*pEnd = 0;` |
|    313281 |  4856 | `	SyToken *pListStart = 0,*pListEnd = 0;` |
|    313281 |  4857 | `	GenBlock *pForeachBlock = 0;` |
|         - |  4858 | `	ph7_foreach_info *pInfo;` |
|         - |  4859 | `	sxu32 nFalseJump;` |
|         - |  4860 | `	VmInstr *pInstr;` |
|         - |  4861 | `	sxu32 nLine;` |
|         - |  4862 | `	sxi32 rc;` |
|    313281 |  4863 | `	nLine = pGen->pIn->nLine;` |
|         - |  4864 | `	/* Jump the 'foreach' keyword */` |
|    313281 |  4865 | `	pGen->pIn++;` |
|    313281 |  4866 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|         - |  4867 | `		/* Syntax error */` |
...
|    313281 |  4876 | `	pGen->pIn++;` |
|         - |  4877 | `	/* Create the loop block */` |
|    313281 |  4878 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pForeachBlock);` |
|    313281 |  4879 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  4880 | `		return SXERR_ABORT;` |
|         - |  4881 | `	}` |
|         - |  4882 | `	/* Delimit the expression */` |
|    313281 |  4883 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|    313281 |  4884 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|    313281 |  4899 | `	pCur = pGen->pIn;` |
|   1802325 |  4900 | `	while( pCur < pEnd ){` |
|   1802325 |  4901 | `		if( pCur->nType & PH7_TK_KEYWORD ){` |
|    344159 |  4902 | `			sxi32 nKeywrd = SX_PTR_TO_INT(pCur->pUserData);` |
|    344159 |  4903 | `			if( nKeywrd == PH7_TKWRD_AS ){` |
...
|    313281 |  4921 | `	pTmp = pGen->pEnd;` |
|    313281 |  4922 | `	pGen->pEnd = pCur;` |
|    313281 |  4923 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|    313281 |  4924 | `	if( rc == SXERR_ABORT ){` |
|         - |  4925 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|       ! 0 |  4926 | `		return SXERR_ABORT;` |
|         - |  4927 | `	}` |
|         - |  4928 | `	/* Update token stream */` |
|    313281 |  4929 | `	while(pGen->pIn < pCur ){` |
...
|       ! 0 |  4935 | `		pGen->pIn++;` |
|       ! 0 |  4936 | `	}` |
|    313281 |  4937 | `	pCur++; /* Jump the 'as' keyword */` |
|    313281 |  4938 | `	pGen->pIn = pCur;` |
|    313281 |  4939 | `	if( pGen->pIn >= pEnd ){` |
...
|    313281 |  4946 | `	pInfo = (ph7_foreach_info *)SyMemBackendAlloc(&pGen->pVm->sAllocator,sizeof(ph7_foreach_info));` |
|    313281 |  4947 | `	if( pInfo == 0 ){` |
...
|    313281 |  4952 | `	SyZero(pInfo,sizeof(ph7_foreach_info));` |
|         - |  4953 | `	/* Initialize structure fields */` |
|    313281 |  4954 | `	SySetInit(&pInfo->aStep,&pGen->pVm->sAllocator,sizeof(ph7_foreach_step *));` |
...
|         - |  4957 | `	 * '=>'. */` |
|    313281 |  4958 | `	pCur = GenStateFindTopLevelArrow(pCur,pEnd);` |
|    313281 |  4959 | `	if( pCur < pEnd ){` |
|         - |  4960 | `		/* Compile the expression holding the key name */` |
|    135339 |  4961 | `		if( pGen->pIn >= pCur ){` |
...
|         - |  4966 | `			}` |
|       ! 0 |  4967 | `		}else{` |
|    135339 |  4968 | `			pGen->pEnd = pCur;` |
|    135339 |  4969 | `			rc = PH7_CompileExpr(&(*pGen),0,GenStateForEachNodeValidator);` |
|    135339 |  4970 | `			if( rc == SXERR_ABORT ){` |
|         - |  4971 | `				/* Don't worry about freeing memory, everything will be released shortly */` |
|       ! 0 |  4972 | `				return SXERR_ABORT;` |
|         - |  4973 | `			}` |
|    135339 |  4974 | `			pInstr = PH7_VmPopInstr(pGen->pVm);` |
|    135339 |  4975 | `			if( pInstr->p3 ){` |
|         - |  4976 | `				/* Record key name */` |
|    135339 |  4977 | `				SyStringInitFromBuf(&pInfo->sKey,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|     67667 |  4978 | `			}` |
|    135339 |  4979 | `			pInfo->iFlags \|= PH7_4EACH_STEP_KEY;` |
|         - |  4980 | `		}` |
|    135339 |  4981 | `		pGen->pIn = &pCur[1]; /* Jump the arrow */` |
|     67667 |  4982 | `	}` |
|    313281 |  4983 | `	pGen->pEnd = pEnd;` |
|    313281 |  4984 | `	if( pGen->pIn >= pEnd ){` |
...
|    313276 |  5039 | `	}else if( pGen->pIn->nType & PH7_TK_OSB ){` |
...
|    313259 |  5072 | `		rc = PH7_CompileExpr(&(*pGen),0,GenStateForEachNodeValidator);` |
|    313259 |  5073 | `		if( rc == SXERR_ABORT ){` |
|         - |  5074 | `			/* Don't worry about freeing memory, everything will be released shortly */` |
|       ! 0 |  5075 | `			return SXERR_ABORT;` |
|         - |  5076 | `		}` |
|    313259 |  5077 | `		pInstr = PH7_VmPopInstr(pGen->pVm);` |
|    313259 |  5078 | `		if( pInstr->p3 ){` |
|         - |  5079 | `			/* Record value name */` |
|    313259 |  5080 | `			SyStringInitFromBuf(&pInfo->sValue,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|    156627 |  5081 | `		}` |
|         - |  5082 | `	}` |
|         - |  5083 | `	/* Emit the 'FOREACH_INIT' instruction */` |
|    313279 |  5084 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_FOREACH_INIT,0,0,pInfo,&nFalseJump);` |
|         - |  5085 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|    313279 |  5086 | `	GenStateNewJumpFixup(pForeachBlock,PH7_OP_FOREACH_INIT,nFalseJump);` |
|         - |  5087 | `	/* Record the first instruction to execute */` |
|    313279 |  5088 | `	pForeachBlock->nFirstInstr = PH7_VmInstrLength(pGen->pVm);` |
|         - |  5089 | `	/* Emit the FOREACH_STEP instruction */` |
|    313279 |  5090 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_FOREACH_STEP,0,0,pInfo,&nFalseJump);` |
|         - |  5091 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|    313279 |  5092 | `	GenStateNewJumpFixup(pForeachBlock,PH7_OP_FOREACH_STEP,nFalseJump);` |
|         - |  5093 | `	/* If list() unpacking, emit bytecode to destructure the temp variable */` |
|    313279 |  5094 | `	if( (pInfo->iFlags & PH7_4EACH_STEP_LIST) && pListStart && pListEnd ){` |
...
|    313279 |  5122 | `	pGen->pIn = &pEnd[1];` |
|    313279 |  5123 | `	pGen->pEnd = pTmp;` |
|    313279 |  5124 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_END4EACH);` |
|    313279 |  5125 | `	if( rc == SXERR_ABORT ){` |
...
|    313279 |  5130 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pForeachBlock->nFirstInstr,0,0);` |
|         - |  5131 | `	/* Fix all jumps now the destination is resolved */` |
|    313279 |  5132 | `	GenStateFixJumps(pForeachBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|         - |  5133 | `	/* Release the loop block */` |
|    313279 |  5134 | `	GenStateLeaveBlock(pGen,0);` |
|         - |  5135 | `	/* Statement successfully compiled */` |
|    313279 |  5136 | `	return SXRET_OK;` |
|         1 |  5137 | `Synchronize:` |
...
|         - |  5176 | ` *    ?>` |
|         - |  5177 | ` */` |
|   2278232 |  5178 | `static sxi32 PH7_CompileIf(ph7_gen_state *pGen)` |
|         5 |  5179 | `{` |
|   2278237 |  5180 | `	SyToken *pToken,*pTmp,*pEnd = 0;` |
|   2278237 |  5181 | `	GenBlock *pCondBlock = 0;` |
|         - |  5182 | `	sxu32 nJumpIdx;` |
|         - |  5183 | `	sxu32 nKeyID;` |
|         - |  5184 | `	sxi32 rc;` |
|         - |  5185 | `	/* Jump the 'if' keyword */` |
|   2278237 |  5186 | `	pGen->pIn++;` |
|   2278237 |  5187 | `	pToken = pGen->pIn;` |
|         - |  5188 | `	/* Create the conditional block */` |
|   2278237 |  5189 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_COND,PH7_VmInstrLength(pGen->pVm),0,&pCondBlock);` |
|   2278237 |  5190 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  5191 | `		return SXERR_ABORT;` |
|         - |  5192 | `	}` |
|         - |  5193 | `	/* Process as many [if/else if/elseif/else] blocks as we can */` |
|   1279994 |  5194 | `	for(;;){` |
|   2559993 |  5195 | `		if( pToken >= pGen->pEnd \|\| (pToken->nType & PH7_TK_LPAREN) == 0 ){` |
|         - |  5196 | `			/* Syntax error */` |
...
|   2559993 |  5210 | `		PH7_DelimitNestedTokens(pToken,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   2559993 |  5211 | `		if( pToken >= pEnd \|\| (pEnd->nType & PH7_TK_RPAREN) == 0 ){` |
|         - |  5212 | `			/* Syntax error */` |
...
|   2559985 |  5224 | `		SWAP_TOKEN_STREAM(pGen,pToken,pEnd);` |
|         - |  5225 | `		/* Compile the condition */` |
|   2559985 |  5226 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|         - |  5227 | `		/* Update token stream */` |
|   2559985 |  5228 | `		while(pGen->pIn < pEnd ){` |
|       ! 0 |  5229 | `			PH7_GenSyntaxError(&(*pGen),pGen->pIn,0);` |
|       ! 0 |  5230 | `			pGen->pIn++;` |
|       ! 0 |  5231 | `		}` |
|   2559985 |  5232 | `		pGen->pIn  = &pEnd[1];` |
|   2559985 |  5233 | `		pGen->pEnd = pTmp;` |
|   2559985 |  5234 | `		if( rc == SXERR_ABORT ){` |
|         - |  5235 | `			/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|       ! 0 |  5236 | `			return SXERR_ABORT;` |
|         - |  5237 | `		}` |
|         - |  5238 | `		/* Emit the false jump */` |
|   2559985 |  5239 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nJumpIdx);` |
|         - |  5240 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   2559985 |  5241 | `		GenStateNewJumpFixup(pCondBlock,PH7_OP_JZ,nJumpIdx);` |
|         - |  5242 | `		/* Compile the body */` |
|   2559985 |  5243 | `		rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDIF);` |
|   2559985 |  5244 | `		if( rc == SXERR_ABORT ){` |
|       ! 0 |  5245 | `			return SXERR_ABORT;` |
|         - |  5246 | `		}` |
|   2559985 |  5247 | `		if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
|    506026 |  5248 | `			break;` |
|         - |  5249 | `		}` |
|         - |  5250 | `		/* Ensure that the keyword ID is 'else if' or 'else' */` |
|   1547943 |  5251 | `		nKeyID = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   1547943 |  5252 | `		if( (nKeyID & (PH7_TKWRD_ELSE\|PH7_TKWRD_ELIF)) == 0 ){` |
|   1049685 |  5253 | `			break;` |
|         - |  5254 | `		}` |
|         - |  5255 | `		/* Emit the unconditional jump */` |
|    498263 |  5256 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,0,0,&nJumpIdx);` |
|         - |  5257 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|    498263 |  5258 | `		GenStateNewJumpFixup(pCondBlock,PH7_OP_JMP,nJumpIdx);` |
|    498263 |  5259 | `		if( nKeyID & PH7_TKWRD_ELSE ){` |
|    301383 |  5260 | `			pToken = &pGen->pIn[1];` |
|    301383 |  5261 | `			if( pToken >= pGen->pEnd \|\| (pToken->nType & PH7_TK_KEYWORD) == 0 \|\|` |
|     84914 |  5262 | `				SX_PTR_TO_INT(pToken->pUserData) != PH7_TKWRD_IF ){` |
|    108256 |  5263 | `					break;` |
|         - |  5264 | `			}` |
|     84881 |  5265 | `			pGen->pIn++; /* Jump the 'else' keyword */` |
|     42438 |  5266 | `		}` |
|    281761 |  5267 | `		pGen->pIn++; /* Jump the 'elseif/if' keyword */` |
|         - |  5268 | `		/* Synchronize cursors */` |
|    281761 |  5269 | `		pToken = pGen->pIn;` |
|         - |  5270 | `		/* Fix the false jump */` |
|    281761 |  5271 | `		GenStateFixJumps(pCondBlock,PH7_OP_JZ,PH7_VmInstrLength(pGen->pVm));` |
|         5 |  5272 | `	} /* For(;;) */` |
|         - |  5273 | `	/* Fix the false jump */` |
|   2278229 |  5274 | `	GenStateFixJumps(pCondBlock,PH7_OP_JZ,PH7_VmInstrLength(pGen->pVm));` |
|   2278229 |  5275 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|   1266182 |  5276 | `		(SX_PTR_TO_INT(pGen->pIn->pUserData) & PH7_TKWRD_ELSE) ){` |
|         - |  5277 | `			/* Compile the else block */` |
|    216507 |  5278 | `			pGen->pIn++;` |
|    216507 |  5279 | `			rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDIF);` |
|    216507 |  5280 | `			if( rc == SXERR_ABORT ){` |
|         - |  5281 |  |
|       ! 0 |  5282 | `				return SXERR_ABORT;` |
|         - |  5283 | `			}` |
|    108251 |  5284 | `	}` |
|   2278229 |  5285 | `	nJumpIdx = PH7_VmInstrLength(pGen->pVm);` |
|         - |  5286 | `	/* Fix all unconditional jumps now the destination is resolved */` |
|   2278229 |  5287 | `	GenStateFixJumps(pCondBlock,PH7_OP_JMP,nJumpIdx);` |
|         - |  5288 | `	/* Release the conditional block */` |
|   2278229 |  5289 | `	GenStateLeaveBlock(pGen,0);` |
|         - |  5290 | `	/* Statement successfully compiled */` |
|   2278229 |  5291 | `	return SXRET_OK;` |
|         4 |  5292 | `Synchronize:` |
...
|         - |  5392 | ` */` |
|   3181386 |  5393 | `static sxi32 PH7_CompileReturn(ph7_gen_state *pGen)` |
|         5 |  5394 | `{` |
|   3181391 |  5395 | `	sxi32 nRet = 0; /* TRUE if there is a return value */` |
|         - |  5396 | `	sxi32 rc;` |
|   3181391 |  5397 | `	sxu32 nLine = pGen->pIn->nLine;` |
|   3181391 |  5398 | `	GenBlock *pFuncBlock = pGen->pCurrent;` |
...
|   8323463 |  5404 | `	while( pFuncBlock && (pFuncBlock->iFlags & GEN_BLOCK_FUNC) == 0 ){` |
|   5142077 |  5405 | `		pFuncBlock = pFuncBlock->pParent;` |
|         5 |  5406 | `	}` |
|   3181386 |  5407 | `	if( pFuncBlock && pFuncBlock->pUserData` |
|   3181357 |  5408 | `	 && ((ph7_vm_func *)pFuncBlock->pUserData)->nReturnType == MEMOBJ_NEVER ){` |
...
|   3181391 |  5416 | `	pGen->pIn++;` |
|   3181391 |  5417 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|         - |  5418 | `		/* Compile the expression */` |
|   3084909 |  5419 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   3084909 |  5420 | `		if( rc == SXERR_ABORT ){` |
|       ! 0 |  5421 | `			return SXERR_ABORT;` |
|   3084909 |  5422 | `		}else if(rc != SXERR_EMPTY ){` |
|   3084909 |  5423 | `			nRet = 1;` |
|   1542452 |  5424 | `		}` |
|   1542452 |  5425 | `	}` |
...
|   3181391 |  5430 | `	if( pGen->bInGenerator ){` |
|      3891 |  5431 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_SET_FINALLY_RET,nRet,0,0,0);` |
|      3891 |  5432 | `		return SXRET_OK;` |
|         - |  5433 | `	}` |
...
|   3177505 |  5439 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,nRet,1,0,0);` |
|   3177505 |  5440 | `	return SXRET_OK;` |
|   1590698 |  5441 | `}` |
|         - |  5442 | `/*` |
...
|         - |  5447 | ` */` |
|     15818 |  5448 | `PH7_PRIVATE sxi32 PH7_CompileYield(ph7_gen_state *pGen, sxi32 iCompileFlag)` |
|         5 |  5449 | `{` |
|         - |  5450 | `	SyToken *pTmp, *pSplit;` |
|     15823 |  5451 | `	sxi32 iP1 = 0; /* 1 if value present */` |
|     15823 |  5452 | `	sxi32 iP2 = 0; /* 1 if key => value */` |
|         - |  5453 | `	sxi32 rc;` |
|      7909 |  5454 | `	(void)iCompileFlag;` |
...
|     15818 |  5462 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_ID)` |
|      7944 |  5463 | `		&& pGen->pIn->sData.nByte == 4` |
...
|         - |  5480 | `	}` |
|     15761 |  5481 | `	if( pGen->pIn >= pGen->pEnd ){` |
...
|     15759 |  5487 | `	pSplit = 0;` |
|         - |  5488 | `	{` |
|     15759 |  5489 | `		SyToken *pCur = pGen->pIn;` |
|     15759 |  5490 | `		sxi32 nNest = 0;` |
|     47081 |  5491 | `		while( pCur < pGen->pEnd ){` |
|     46773 |  5492 | `			if( pCur->nType & (PH7_TK_LPAREN\|PH7_TK_OSB\|PH7_TK_OCB) ){` |
|        18 |  5493 | `				nNest++;` |
|     46765 |  5494 | `			}else if( pCur->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB) ){` |
|        18 |  5495 | `				nNest--;` |
|     46749 |  5496 | `			}else if( nNest == 0 && (pCur->nType & PH7_TK_ARRAY_OP) ){` |
|     15451 |  5497 | `				pSplit = pCur;` |
|     15451 |  5498 | `				break;` |
|         - |  5499 | `			}` |
|     31327 |  5500 | `			pCur++;` |
|         5 |  5501 | `		}` |
|         - |  5502 | `	}` |
|     15759 |  5503 | `	pTmp = pGen->pEnd;` |
|     15759 |  5504 | `	if( pSplit ){` |
|         - |  5505 | `		/* yield $key => $value */` |
|     15451 |  5506 | `		pGen->pEnd = pSplit;` |
|     15451 |  5507 | `		rc = PH7_CompileExpr(pGen, 0, 0);` |
|     15451 |  5508 | `		if( rc == SXERR_ABORT ) return SXERR_ABORT;` |
|     15451 |  5509 | `		pGen->pIn = pSplit + 1; /* Skip '=>' */` |
|     15451 |  5510 | `		pGen->pEnd = pTmp;` |
|     15451 |  5511 | `		rc = PH7_CompileExpr(pGen, 0, 0);` |
|     15451 |  5512 | `		if( rc == SXERR_ABORT ) return SXERR_ABORT;` |
|     15451 |  5513 | `		iP1 = 1;` |
|     15451 |  5514 | `		iP2 = 1;` |
|      7728 |  5515 | `	}else{` |
|         - |  5516 | `		/* yield $value */` |
...
|       154 |  5521 | `		}` |
|         - |  5522 | `	}` |
|     15759 |  5523 | `	pGen->pEnd = pTmp;` |
|     15759 |  5524 | `	PH7_VmEmitInstr(pGen->pVm, PH7_OP_YIELD, iP1, iP2, 0, 0);` |
|     15759 |  5525 | `	return SXRET_OK;` |
|      7914 |  5526 | `}` |
|         - |  5527 | `/*` |
...
|         - |  5553 | ` */` |
|     18122 |  5554 | `static sxi32 PH7_CompileEcho(ph7_gen_state *pGen)` |
|         5 |  5555 | `{` |
|     18127 |  5556 | `	SyToken *pTmp,*pNext = 0;` |
|     18127 |  5557 | `	sxu32 nLine = pGen->pIn->nLine;` |
|     18127 |  5558 | `	int nExpr = 0;      /* expressions actually compiled */` |
|     18127 |  5559 | `	int bExpectMore = 1;/* after 'echo' or a comma an expression is REQUIRED */` |
|         - |  5560 | `	sxi32 rc;` |
|         - |  5561 | `	/* Jump the 'echo' keyword */` |
|     18127 |  5562 | `	pGen->pIn++;` |
|         - |  5563 | `	/* Compile arguments one after one */` |
|     18127 |  5564 | `	pTmp = pGen->pEnd;` |
|     46033 |  5565 | `	while( SXRET_OK == PH7_GetNextExpr(pGen->pIn,pTmp,&pNext) ){` |
|     27913 |  5566 | `		if( pGen->pIn < pNext ){` |
|     27913 |  5567 | `			pGen->pEnd = pNext;` |
|     27913 |  5568 | `			rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_RDONLY_LOAD/* Do not create variable if inexistant */,0);` |
|     27913 |  5569 | `			if( rc == SXERR_ABORT ){` |
|       ! 0 |  5570 | `				return SXERR_ABORT;` |
|     27913 |  5571 | `			}else if( rc != SXERR_EMPTY ){` |
|         - |  5572 | `				/* Emit the consume instruction */` |
|     27887 |  5573 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_CONSUME,1,0,0,0);` |
|     27887 |  5574 | `				nExpr++;` |
|     27887 |  5575 | `				bExpectMore = 0;` |
|     13941 |  5576 | `			}` |
|     13954 |  5577 | `		}` |
...
|     37705 |  5580 | `		while( pNext < pTmp && (pNext->nType & PH7_TK_COMMA) ){` |
|      9799 |  5581 | `			if( bExpectMore ){` |
...
|         - |  5586 | `			}` |
|      9797 |  5587 | `			bExpectMore = 1;` |
|      9797 |  5588 | `			pNext++;` |
|         5 |  5589 | `		}` |
|     27911 |  5590 | `		pGen->pIn = pNext;` |
|         5 |  5591 | `	}` |
|         - |  5592 | `	/* Restore token stream */` |
|     18125 |  5593 | `	pGen->pEnd = pTmp;` |
|     18125 |  5594 | `	if( nExpr == 0 \|\| bExpectMore ){` |
...
|         - |  5615 | ` */` |
|     11586 |  5616 | `static sxi32 PH7_CompileStatic(ph7_gen_state *pGen)` |
|         5 |  5617 | `{` |
...
|     11586 |  5628 | `	if( &pGen->pIn[1] < pGen->pEnd && (pGen->pIn[1].nType & PH7_TK_KEYWORD)` |
|      5799 |  5629 | `	 && (SX_PTR_TO_INT(pGen->pIn[1].pUserData) == PH7_TKWRD_FUNCTION` |
...
|     11589 |  5640 | `	nLine = pGen->pIn->nLine;` |
|     11589 |  5641 | `	pGen->pIn++;` |
|         - |  5642 | `	/* Extract the enclosing function if any */` |
|     11589 |  5643 | `	pBlock = pGen->pCurrent;` |
|     23173 |  5644 | `	while( pBlock ){` |
|     23173 |  5645 | `		if( pBlock->iFlags & GEN_BLOCK_FUNC){` |
|     11589 |  5646 | `			break;` |
|         - |  5647 | `		}` |
|         - |  5648 | `		/* Point to the upper block */` |
|     11589 |  5649 | `		pBlock = pBlock->pParent;` |
|         5 |  5650 | `	}` |
|     11589 |  5651 | `	if( pBlock == 0 ){` |
...
|         - |  5669 | `	}` |
|     11589 |  5670 | `	pFunc = (ph7_vm_func *)pBlock->pUserData;` |
|         - |  5671 | `	/* Make sure we are dealing with a valid statement */` |
|     11589 |  5672 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 \|\| &pGen->pIn[1] >= pGen->pEnd \|\|` |
|     11582 |  5673 | `		(pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|     11587 |  5682 | `	pName = &pGen->pIn->sData;` |
|     11587 |  5683 | `	pGen->pIn++; /* Jump the var name */` |
|     11587 |  5684 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & (PH7_TK_SEMI/*';'*/\|PH7_TK_EQUAL/*'='*/)) == 0 ){` |
...
|     11587 |  5689 | `	SySetInit(&sStatic.aByteCode,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|     11587 |  5690 | `	sStatic.nIdx = SXU32_HIGH; /* Not yet created */` |
|         - |  5691 | `	/* Duplicate variable name */` |
|     11587 |  5692 | `	zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|     11587 |  5693 | `	if( zDup == 0 ){` |
|       ! 0 |  5694 | `		PH7_GenCompileError(&(*pGen),E_ERROR,nLine,"Fatal, PH7 engine is running out of memory");` |
|       ! 0 |  5695 | `		return SXERR_ABORT;` |
|         - |  5696 | `	}` |
|     11587 |  5697 | `	SyStringInitFromBuf(&sStatic.sName,zDup,pName->nByte);` |
|         - |  5698 | `	/* Check if we have an expression to compile */` |
|     11587 |  5699 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_EQUAL) ){` |
...
|         - |  5706 | `		 */` |
|     11587 |  5707 | `		pGen->pIn++; /* Jump the equal '=' sign */` |
|         - |  5708 | `		/* Swap bytecode container */` |
|     11587 |  5709 | `		pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|     11587 |  5710 | `		PH7_VmSetByteCodeContainer(pGen->pVm,&sStatic.aByteCode);` |
|         - |  5711 | `		/* Compile the expression */` |
|     11587 |  5712 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|         - |  5713 | `		/* Emit the done instruction */` |
|     11587 |  5714 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,(rc != SXERR_EMPTY ? 1 : 0),0,0,0);` |
|         - |  5715 | `		/* Restore default bytecode container */` |
|     11587 |  5716 | `		PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|      5791 |  5717 | `	}` |
|         - |  5718 | `	/* Finally save the compiled static variable in the appropriate container */` |
|     11587 |  5719 | `	SySetPut(&pFunc->aStatic,(const void *)&sStatic);` |
|     11587 |  5720 | `	return SXRET_OK;` |
|         1 |  5721 | `Synchronize:` |
...
|         - |  5781 | ` */` |
|   5832610 |  5782 | `static sxu32 GenStateNsQualifyName(ph7_gen_state *pGen,sxu32 nOrigIdx,SyHash *pImports,int *pFromImport)` |
|         5 |  5783 | `{` |
|         - |  5784 | `	ph7_value *pLit;` |
...
|         - |  5792 | `	ph7_value *pNew;` |
|   5832615 |  5793 | `	if( pFromImport ){` |
|   4732893 |  5794 | `		*pFromImport = 0;` |
|   2366444 |  5795 | `	}` |
|   5832615 |  5796 | `	pLit = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,nOrigIdx);` |
|   5832615 |  5797 | `	if( !pLit \|\| !(pLit->iFlags & MEMOBJ_STRING) \|\| SyBlobLength(&pLit->sBlob) == 0 ){` |
|       ! 0 |  5798 | `		return nOrigIdx;` |
|         - |  5799 | `	}` |
|   5832615 |  5800 | `	zLit = (const char *)SyBlobData(&pLit->sBlob);` |
|   5832615 |  5801 | `	nLit = (sxu32)SyBlobLength(&pLit->sBlob);` |
|         - |  5802 | `	/* Skip if already qualified (contains backslash) */` |
|   5832615 |  5803 | `	hasNsSep = 0;` |
|  68629123 |  5804 | `	for( k = 0; k < nLit; k++ ){` |
|  62796531 |  5805 | `		if( zLit[k] == '\\' ){ hasNsSep = 1; break; }` |
|  31398259 |  5806 | `	}` |
|   5832615 |  5807 | `	if( hasNsSep ){` |
|        20 |  5808 | `		return nOrigIdx;` |
|         - |  5809 | `	}` |
|         - |  5810 | `	/* Check use imports first (works even outside namespaces) */` |
|   5832597 |  5811 | `	SyBlobReset(&pGen->sWorker);` |
|   5832597 |  5812 | `	pImport = SyHashGet(pImports,(const void *)zLit,nLit);` |
|   5832597 |  5813 | `	if( pImport ){` |
...
|         8 |  5818 | `		}` |
|        23 |  5819 | `	}else{` |
|   5832561 |  5820 | `		if( SyBlobLength(&pGen->sNamespace) == 0 ){` |
|   5832431 |  5821 | `			return nOrigIdx; /* Not in a namespace and no import match */` |
|         - |  5822 | `		}` |
...
|         - |  5844 | ` */` |
|    491816 |  5845 | `static void GenStateResolveName(ph7_gen_state *pGen,const SyString *pName,SyBlob *pOut)` |
|         5 |  5846 | `{` |
|         - |  5847 | `	SyHashEntry *pImport;` |
|         - |  5848 | `	/* Check use imports first */` |
|    491821 |  5849 | `	pImport = SyHashGet(&pGen->hUseImports,(const void *)pName->zString,pName->nByte);` |
|    491821 |  5850 | `	if( pImport ){` |
...
|         - |  5866 | ` */` |
|    457354 |  5867 | `static void GenStateBuildFQN(ph7_gen_state *pGen,const SyString *pName,SyBlob *pOut)` |
|         5 |  5868 | `{` |
|    457359 |  5869 | `	if( SyBlobLength(&pGen->sNamespace) > 0 ){` |
|      3943 |  5870 | `		SyBlobAppend(pOut,SyBlobData(&pGen->sNamespace),SyBlobLength(&pGen->sNamespace));` |
|      3943 |  5871 | `		SyBlobAppend(pOut,"\\",1);` |
|      1969 |  5872 | `	}` |
|    457359 |  5873 | `	SyBlobAppend(pOut,pName->zString,pName->nByte);` |
|    457359 |  5874 | `}` |
|         - |  5875 | `/*` |
...
|         3 |  5919 | `	return "token";` |
|        11 |  5920 | `}` |
|      3986 |  5921 | `static sxi32 PH7_CompileNamespace(ph7_gen_state *pGen)` |
|         5 |  5922 | `{` |
|         - |  5923 | `	sxu32 nLine;` |
|         - |  5924 | `	sxi32 rc;` |
|      3991 |  5925 | `	nLine = pGen->pIn->nLine;` |
|      3991 |  5926 | `	pGen->pIn++; /* Jump the 'namespace' keyword */` |
|         - |  5927 | `	/* Reset namespace and clear previous use imports */` |
|      3991 |  5928 | `	SyBlobReset(&pGen->sNamespace);` |
|      3991 |  5929 | `	SyHashRelease(&pGen->hUseImports);` |
|      3991 |  5930 | `	SyHashInit(&pGen->hUseImports,&pGen->pVm->sAllocator,0,0);` |
|      3991 |  5931 | `	SyHashRelease(&pGen->hUseFuncImports);` |
|      3991 |  5932 | `	SyHashInit(&pGen->hUseFuncImports,&pGen->pVm->sAllocator,0,0);` |
|      3991 |  5933 | `	SyHashRelease(&pGen->hUseConstImports);` |
|      3991 |  5934 | `	SyHashInit(&pGen->hUseConstImports,&pGen->pVm->sAllocator,0,0);` |
|      3991 |  5935 | `	if( pGen->pIn >= pGen->pEnd ){` |
|         - |  5936 | `		/* Global namespace (bare "namespace;") */` |
|       ! 0 |  5937 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_NSSWITCH,0,0,0,0);` |
|       ! 0 |  5938 | `		return SXRET_OK;` |
|         - |  5939 | `	}` |
|      3991 |  5940 | `	if( pGen->pIn->nType & PH7_TK_SEMI ){` |
|         - |  5941 | `		/* namespace; — switch to global namespace */` |
|       ! 0 |  5942 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_NSSWITCH,0,0,0,0);` |
|       ! 0 |  5943 | `		return SXRET_OK;` |
|         - |  5944 | `	}` |
|      3991 |  5945 | `	if( pGen->pIn->nType & PH7_TK_OCB ){` |
...
|      8043 |  5951 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & (PH7_TK_NSSEP\|PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|      4061 |  5952 | `		if( pGen->pIn->nType & PH7_TK_NSSEP ){` |
...
|      4023 |  5959 | `			SyBlobAppend(&pGen->sNamespace,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|         - |  5960 | `		}` |
|      4061 |  5961 | `		pGen->pIn++;` |
|         5 |  5962 | `	}` |
...
|         - |  5965 | `	{` |
|      3987 |  5966 | `		char *zNsDup = 0;` |
|      3987 |  5967 | `		if( SyBlobLength(&pGen->sNamespace) > 0 ){` |
|      5975 |  5968 | `			zNsDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|      3980 |  5969 | `				(const char *)SyBlobData(&pGen->sNamespace),SyBlobLength(&pGen->sNamespace));` |
|      1990 |  5970 | `		}` |
|      3987 |  5971 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_NSSWITCH,0,0,zNsDup,0);` |
|         - |  5972 | `	}` |
|      3987 |  5973 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & (PH7_TK_SEMI\|PH7_TK_OCB)) == 0 ){` |
...
|         - |  6371 | ` */` |
|    578864 |  6372 | `static sxi32 GenStateProcessArgValue(ph7_gen_state *pGen,ph7_vm_func_arg *pArg,SyToken *pIn,SyToken *pEnd)` |
|         5 |  6373 | `{` |
|         - |  6374 | `	SyToken *pTmpIn,*pTmpEnd;` |
|         - |  6375 | `	SySet *pInstrContainer;` |
|         - |  6376 | `	sxi32 rc;` |
|         - |  6377 | `	/* Swap token stream */` |
|    578869 |  6378 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|    578869 |  6379 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|    578869 |  6380 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pArg->aByteCode);` |
|         - |  6381 | `	/* Compile the expression holding the argument value */` |
|    578869 |  6382 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|         - |  6383 | `	/* Emit the done instruction */` |
|    578869 |  6384 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,(rc != SXERR_EMPTY ? 1 : 0),0,0,0);` |
|    578869 |  6385 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|    578869 |  6386 | `	RE_SWAP_DELIMITER(pGen);` |
|    578869 |  6387 | `	if( rc == SXERR_ABORT ){` |
|       ! 0 |  6388 | `		return SXERR_ABORT;` |
|         - |  6389 | `	}` |
|    578869 |  6390 | `	return SXRET_OK;` |
|    289437 |  6391 | `}` |
|         - |  6392 | `/*` |
...
|         - |  6428 | ` */` |
|   1333044 |  6429 | `static sxi32 GenStateCollectFuncArgs(ph7_vm_func *pFunc,ph7_gen_state *pGen,SyToken *pEnd,int bCtorCtx,int bAbstractCtx)` |
|         5 |  6430 | `{` |
...
|         - |  6435 | `	sxi32 rc;` |
|         - |  6436 |  |
|   1333049 |  6437 | `	pIn = pGen->pIn;` |
|   1333049 |  6438 | `	SyBlobInit(&sSig,&pGen->pVm->sAllocator);` |
|         - |  6439 | `	/* Process arguments one after one */` |
|   1721274 |  6440 | `	for(;;){` |
|   3442553 |  6441 | `		if( pIn >= pEnd ){` |
|         - |  6442 | `			/* No more arguments to process */` |
|   1333033 |  6443 | `			break;` |
|         - |  6444 | `		}` |
|   2109525 |  6445 | `		SyZero(&sArg,sizeof(ph7_vm_func_arg));` |
|   2109525 |  6446 | `		SySetInit(&sArg.aByteCode,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|   2109525 |  6447 | `		SySetInit(&sArg.aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|   2109525 |  6448 | `		SySetInit(&sArg.aAttrs,&pGen->pVm->sAllocator,sizeof(ph7_attribute));` |
|   2109525 |  6449 | `		SyStringInitFromBuf(&sArg.sTypeName,0,0);` |
|         - |  6450 | `		/* Parameter #[...] attributes: the group precedes the parameter's` |
|         - |  6451 | `		 * first token inside the main token stream */` |
|   2109525 |  6452 | `		if( GenStateCollectParamAttrs(&(*pGen),pIn,&sArg.aAttrs) == SXERR_ABORT ){` |
...
|         - |  6460 | `		{` |
|   2109525 |  6461 | `			int bReadonly = 0, bVisSeen = 0;` |
|   2109525 |  6462 | `			sxi32 iVis = PH7_CLASS_PROT_PUBLIC;` |
|   2109525 |  6463 | `			sxi32 iSetVisFlag = 0;` |
|         - |  6464 | `			int nSetTok;` |
|         - |  6465 | `			sxi32 nSetVis;` |
|   2109525 |  6466 | `			if( pIn < pEnd && GenStateIsReadonly(pIn) ){` |
|         3 |  6467 | `				bReadonly = 1;` |
|         3 |  6468 | `				pIn++;` |
|         1 |  6469 | `			}` |
|   2109525 |  6470 | `			nSetVis = GenStatePeekSetVisibility(pIn,pEnd,&nSetTok);` |
|   2109525 |  6471 | `			if( nSetVis ){` |
...
|       ! 0 |  6478 | `					pIn++;` |
|         1 |  6479 | `				}` |
|   2109524 |  6480 | `			}else if( pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD) ){` |
|     89169 |  6481 | `				sxu32 nKw = (sxu32)SX_PTR_TO_INT(pIn->pUserData);` |
|     89169 |  6482 | `				if( nKw == PH7_TKWRD_PUBLIC \|\| nKw == PH7_TKWRD_PROTECTED \|\| nKw == PH7_TKWRD_PRIVATE ){` |
|        91 |  6483 | `					bVisSeen = 1;` |
...
|        43 |  6498 | `				}` |
|     44582 |  6499 | `			}` |
|   2109525 |  6500 | `			if( iSetVisFlag == PH7_CLASS_ATTR_PRIVATE_SET ){` |
|         5 |  6501 | `				sArg.iFlags \|= VM_FUNC_ARG_PRIV_SET;` |
|   2109523 |  6502 | `			}else if( iSetVisFlag == PH7_CLASS_ATTR_PROTECTED_SET ){` |
|       ! 0 |  6503 | `				sArg.iFlags \|= VM_FUNC_ARG_PROT_SET;` |
|       ! 0 |  6504 | `			}` |
|   2109525 |  6505 | `			if( bVisSeen \|\| bReadonly ){` |
|        95 |  6506 | `				if( !bCtorCtx ){` |
...
|   2109516 |  6527 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_DOLLAR) == 0` |
|   1138047 |  6528 | `			&& (pIn->nType & PH7_TK_AMPER) == 0` |
|    154992 |  6529 | `			&& (pIn->nType & PH7_TK_ELLIPSIS) == 0 ){` |
|    120171 |  6530 | `			sxu32 nLineLocal = pIn->nLine;` |
|    120171 |  6531 | `			sxi32 iTFlags = 0;` |
|    120171 |  6532 | `			pGen->pIn = pIn;` |
|    120171 |  6533 | `			rc = GenStateParseUnionTypeDecl(` |
|     60083 |  6534 | `				pGen, &sArg.nType, &sArg.sClass, &sArg.aUnionAlts,` |
|     60083 |  6535 | `				&iTFlags, &sArg.sTypeName,` |
|         - |  6536 | `				VM_FUNC_ARG_NULLABLE, VM_FUNC_ARG_UNION,` |
|         - |  6537 | `				/* bAllowVoid */ 0,` |
|     60083 |  6538 | `						nLineLocal);` |
|    120171 |  6539 | `			pIn = pGen->pIn;` |
|    120171 |  6540 | `			if( rc == SXERR_ABORT ){` |
|       ! 0 |  6541 | `				return SXERR_ABORT;` |
|    120171 |  6542 | `			}else if( rc == SXERR_CORRUPT ){` |
|         - |  6543 | `				/* Error already reported by GenStateParseUnionTypeDecl */` |
|         3 |  6544 | `				return SXERR_SYNTAX;` |
|    120169 |  6545 | `			}else if( rc == SXERR_SYNTAX ){` |
|        11 |  6546 | `				if( pIn < pEnd ){` |
...
|         - |  6555 | `			}` |
|    120161 |  6556 | `			sArg.iFlags \|= iTFlags;` |
|     60078 |  6557 | `		}` |
|   2109511 |  6558 | `		if( pIn >= pEnd ){` |
|       ! 0 |  6559 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Missing argument name");` |
|       ! 0 |  6560 | `			return rc;` |
|         - |  6561 | `		}` |
|   2109511 |  6562 | `		if( pIn->nType & PH7_TK_AMPER ){` |
|         - |  6563 | `			/* Pass by reference,record that */` |
|     23195 |  6564 | `			sArg.iFlags \|= VM_FUNC_ARG_BY_REF;` |
|     23195 |  6565 | `			pIn++;` |
|     11595 |  6566 | `		}` |
|   2109511 |  6567 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_ELLIPSIS) ){` |
|         - |  6568 | `			/* Variadic parameter: ...$args */` |
|     23257 |  6569 | `			sArg.iFlags \|= VM_FUNC_ARG_VARIADIC;` |
|     23257 |  6570 | `			pIn++;` |
|     11626 |  6571 | `		}` |
|   2109511 |  6572 | `		if( pIn >= pEnd \|\| (pIn->nType & PH7_TK_DOLLAR) == 0 \|\| &pIn[1] >= pEnd \|\| (pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|         - |  6573 | `			/* Invalid argument */` |
|       ! 0 |  6574 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Invalid argument name");` |
|       ! 0 |  6575 | `			return rc;` |
|         - |  6576 | `		}` |
|   2109511 |  6577 | `		pIn++; /* Jump the dollar sign */` |
|         - |  6578 | `		/* Copy argument name */` |
|   2109511 |  6579 | `		zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,SyStringData(&pIn->sData),SyStringLength(&pIn->sData));` |
|   2109511 |  6580 | `		if( zDup == 0 ){` |
|       ! 0 |  6581 | `			PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"PH7 engine is running out of memory");` |
|       ! 0 |  6582 | `			return SXERR_ABORT;` |
|         - |  6583 | `		}` |
|   2109511 |  6584 | `		SyStringInitFromBuf(&sArg.sName,zDup,SyStringLength(&pIn->sData));` |
|   2109511 |  6585 | `		pIn++;` |
|   2109511 |  6586 | `		if( pIn < pEnd ){` |
|   1166257 |  6587 | `			if( pIn->nType & PH7_TK_EQUAL ){` |
|         - |  6588 | `				SyToken *pDefend;` |
|    578871 |  6589 | `				sxi32 iNest = 0;` |
|    578871 |  6590 | `				pIn++; /* Jump the equal sign */` |
|    578871 |  6591 | `				pDefend = pIn;` |
|         - |  6592 | `				/* Process the default value associated with this argument */` |
|   1215641 |  6593 | `				while( pDefend < pEnd ){` |
|    825871 |  6594 | `					if( (pDefend->nType & PH7_TK_COMMA) && iNest <= 0 ){` |
|    189101 |  6595 | `						break;` |
|         - |  6596 | `					}` |
|    636775 |  6597 | `					if( pDefend->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*[*/) ){` |
|         - |  6598 | `						/* Increment nesting level */` |
|     27023 |  6599 | `						iNest++;` |
|    623266 |  6600 | `					}else if( pDefend->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CCB/*'}'*/\|PH7_TK_CSB/*]*/) ){` |
|         - |  6601 | `						/* Decrement nesting level */` |
|     27023 |  6602 | `						iNest--;` |
|     13509 |  6603 | `					}` |
|    636775 |  6604 | `					pDefend++;` |
|         5 |  6605 | `				}` |
|    578871 |  6606 | `				if( pIn >= pDefend ){` |
|         3 |  6607 | `					rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Missing argument default value");` |
|         3 |  6608 | `					return rc;` |
|         - |  6609 | `				}` |
|         - |  6610 | `				/* Process default value */` |
|    578869 |  6611 | `				rc = GenStateProcessArgValue(&(*pGen),&sArg,pIn,pDefend);` |
|    578869 |  6612 | `				if( rc != SXRET_OK ){` |
|       ! 0 |  6613 | `					return rc;` |
|         - |  6614 | `				}` |
...
|    578864 |  6620 | `				if( (sArg.nType > 0 \|\| (sArg.iFlags & VM_FUNC_ARG_UNION))` |
|    314532 |  6621 | `					&& (sArg.iFlags & VM_FUNC_ARG_NULLABLE) == 0` |
|    314529 |  6622 | `					&& &pIn[1] == pDefend` |
|     46335 |  6623 | `					&& pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)` |
|     34744 |  6624 | `					&& pIn->sData.nByte == sizeof("null")-1` |
|     21230 |  6625 | `					&& SyStrnicmp(SyStringData(&pIn->sData),"null",sizeof("null")-1) == 0 ){` |
|     15443 |  6626 | `					sArg.iFlags \|= VM_FUNC_ARG_NULLABLE;` |
...
|         - |  6631 | `					{` |
|     15443 |  6632 | `						const char *zSep = "";` |
|     15443 |  6633 | `						SyString sCls = { "", 0 };` |
|     15443 |  6634 | `						if( (pFunc->iFlags & VM_FUNC_CLASS_METHOD) && pFunc->pUserData ){` |
|     15437 |  6635 | `							sCls = ((ph7_class *)pFunc->pUserData)->sName;` |
|     15437 |  6636 | `							zSep = "::";` |
|      7716 |  6637 | `						}` |
|     23162 |  6638 | `						PH7_GenCompileError(&(*pGen),8192 /* E_DEPRECATED */,pIn->nLine,` |
|         - |  6639 | `							"%z%s%z(): Implicitly marking parameter $%z as nullable is deprecated, the explicit nullable type must be used instead",` |
|      7719 |  6640 | `							&sCls,zSep,&pFunc->sName,&sArg.sName);` |
|         - |  6641 | `					}` |
|      7719 |  6642 | `				}` |
|         - |  6643 | `				/* Point beyond the default value */` |
|    578869 |  6644 | `				pIn = pDefend;` |
|    289432 |  6645 | `			}` |
|   1166255 |  6646 | `			if( pIn < pEnd && (pIn->nType & PH7_TK_COMMA) == 0 ){` |
|       ! 0 |  6647 | `				rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Unexpected token '%z'",&pIn->sData);` |
|       ! 0 |  6648 | `				return rc;` |
|         - |  6649 | `			}` |
|   1166255 |  6650 | `			pIn++; /* Jump the trailing comma */` |
|    583125 |  6651 | `		}` |
|         - |  6652 | `		/* Append argument signature */` |
|   2109509 |  6653 | `		if( sArg.nType > 0 ){` |
|    120099 |  6654 | `			if( SyStringLength(&sArg.sClass) > 0 ){` |
|         - |  6655 | `				/* Class name — prefix with 'o' so generic object hint is a prefix match */` |
|     30971 |  6656 | `				int marker = 'o';` |
|     30971 |  6657 | `				SyBlobAppend(&sSig,(const void *)&marker,sizeof(char));` |
|     30971 |  6658 | `				SyBlobAppend(&sSig,SyStringData(&sArg.sClass),SyStringLength(&sArg.sClass));` |
|     15488 |  6659 | `			}else{` |
|         - |  6660 | `				int c;` |
|     89133 |  6661 | `				c = 'n'; /* cc warning */` |
|         - |  6662 | `				/* Type leading character */` |
|     89133 |  6663 | `				switch(sArg.nType){` |
|      5795 |  6664 | `				case MEMOBJ_HASHMAP:` |
|         - |  6665 | `					/* Hashmap aka 'array' */` |
|     11595 |  6666 | `					c = 'h';` |
|     11595 |  6667 | `					break;` |
|      9775 |  6668 | `				case MEMOBJ_INT:` |
|         - |  6669 | `					/* Integer */` |
|     19555 |  6670 | `					c = 'i';` |
|     19555 |  6671 | `					break;` |
...
|         2 |  6689 | `					break;` |
|         - |  6690 | `				}` |
|     89133 |  6691 | `				SyBlobAppend(&sSig,(const void *)&c,sizeof(char));` |
|         - |  6692 | `			}` |
|     60052 |  6693 | `		}else{` |
|         - |  6694 | `			/* No type is associated with this parameter which mean` |
|         - |  6695 | `			 * that this function is not condidate for overloading.` |
|         - |  6696 | `			 */` |
|   1989415 |  6697 | `			SyBlobRelease(&sSig);` |
|         - |  6698 | `		}` |
|         - |  6699 | `		/* Save in the argument set */` |
|   2109509 |  6700 | `		SySetPut(&pFunc->aArgs,(const void *)&sArg);` |
|         5 |  6701 | `	}` |
|   1333033 |  6702 | `	if( SyBlobLength(&sSig) > 0 ){` |
|         - |  6703 | `		/* Save function signature */` |
|     89149 |  6704 | `		SyStringInitFromBuf(&pFunc->sSignature,SyBlobData(&sSig),SyBlobLength(&sSig));` |
|     44572 |  6705 | `	}` |
|   1333033 |  6706 | `	return SXRET_OK;` |
|    666527 |  6707 | `}` |
|         - |  6708 | `/*` |
...
|         - |  6712 | ` */` |
|     34768 |  6713 | `static SyToken * GenStateSkipNestedFunc(SyToken *pIn, SyToken *pEnd)` |
|         5 |  6714 | `{` |
|     34773 |  6715 | `	sxi32 iParen = 0;` |
|     34773 |  6716 | `	pIn++; /* past 'function'/'fn' */` |
...
|    154575 |  6720 | `	while( pIn < pEnd ){` |
|    154575 |  6721 | `		sxu32 t = pIn->nType;` |
|    154575 |  6722 | `		if( t & PH7_TK_LPAREN ){ iParen++; }` |
|    150659 |  6723 | `		else if( t & PH7_TK_RPAREN ){ iParen--; }` |
|    104305 |  6724 | `		else if( (t & PH7_TK_OCB) && iParen <= 0 ){ break; }` |
|     84969 |  6725 | `		else if( (t & PH7_TK_SEMI) && iParen <= 0 ){ return pIn; }` |
|    119807 |  6726 | `		pIn++;` |
|         5 |  6727 | `	}` |
|     19341 |  6728 | `	if( pIn >= pEnd ){ return pIn; }` |
|         - |  6729 | `	/* pIn at the body '{' — skip the balanced brace block. */` |
|         - |  6730 | `	{` |
|     19341 |  6731 | `		sxi32 d = 0;` |
|    768263 |  6732 | `		while( pIn < pEnd ){` |
|    768263 |  6733 | `			sxu32 t = pIn->nType;` |
|    768263 |  6734 | `			if( t & PH7_TK_OCB ){ d++; }` |
|    737345 |  6735 | `			else if( t & PH7_TK_CCB ){ d--; if( d <= 0 ){ pIn++; break; } }` |
|    748927 |  6736 | `			pIn++;` |
|         5 |  6737 | `		}` |
|         - |  6738 | `	}` |
|     19341 |  6739 | `	return pIn;` |
|     17389 |  6740 | `}` |
|         - |  6741 | `/*` |
...
|         - |  6752 | ` * mixed, object.` |
|         - |  6753 | ` */` |
|     11598 |  6754 | `static int GenStateGenRetNameOk(const char *zName,sxu32 nName)` |
|         5 |  6755 | `{` |
...
|         - |  6759 | `	};` |
|         - |  6760 | `	sxu32 i;` |
|     11603 |  6761 | `	if( nName > 0 && zName[0] == '\\' ){` |
|       ! 0 |  6762 | `		zName++;` |
|       ! 0 |  6763 | `		nName--;` |
|       ! 0 |  6764 | `	}` |
|     11611 |  6765 | `	for( i = 0; i < SX_ARRAYSIZE(aOk); i++ ){` |
|     11611 |  6766 | `		if( nName == aOk[i].nLen && SyStrnicmp(zName,aOk[i].zName,nName) == 0 ){` |
|     11603 |  6767 | `			return 1;` |
|         - |  6768 | `		}` |
|         5 |  6769 | `	}` |
|       ! 0 |  6770 | `	return 0;` |
...
|         - |  6783 | ` */` |
|     11600 |  6784 | `static int GenStateGenRetAtomOk(ph7_gen_state *pGen,sxu32 nType,const SyString *pName)` |
|         5 |  6785 | `{` |
|     11605 |  6786 | `	if( nType == MEMOBJ_OBJ ){` |
|       ! 0 |  6787 | ``		return 1; /* bare `object` */`` |
|         - |  6788 | `	}` |
|     11605 |  6789 | `	if( nType != SXU32_HIGH ){` |
|         3 |  6790 | `		return 0; /* scalar/array/void/never/null/... */` |
|         - |  6791 | `	}` |
|     11603 |  6792 | `	if( GenStateGenRetNameOk(pName->zString,pName->nByte) ){` |
|     11603 |  6793 | `		return 1;` |
|         - |  6794 | `	}` |
...
|         - |  6818 | ` */` |
|     11840 |  6819 | `static sxi32 GenStateValidateGeneratorReturnType(ph7_gen_state *pGen,ph7_vm_func *pFunc)` |
|         5 |  6820 | `{` |
|     11845 |  6821 | `	int bOk = 0;` |
|         - |  6822 | `	sxu32 nLine;` |
|         - |  6823 | `	sxi32 rc;` |
|     11845 |  6824 | `	if( pFunc->nReturnType < 1 && SySetUsed(&pFunc->aReturnUnion) < 1 ){` |
|       245 |  6825 | `		return SXRET_OK; /* untyped: nothing to validate */` |
|         - |  6826 | `	}` |
|     11605 |  6827 | `	if( SySetUsed(&pFunc->aReturnUnion) > 0 ){` |
...
|       ! 0 |  6844 | `		}` |
|       ! 0 |  6845 | `	}else{` |
|     11605 |  6846 | `		bOk = GenStateGenRetAtomOk(&(*pGen),pFunc->nReturnType,&pFunc->sReturnClass);` |
|         - |  6847 | `	}` |
|     11605 |  6848 | `	if( bOk ){` |
|     11603 |  6849 | `		return SXRET_OK;` |
|         - |  6850 | `	}` |
...
|      5925 |  6875 | `}` |
|   2962992 |  6876 | `static int GenStateFuncBodyHasYield(ph7_gen_state *pGen)` |
|         5 |  6877 | `{` |
|   2962997 |  6878 | `	SyToken *pIn = pGen->pIn;   /* expected at the body's opening '{' */` |
|   2962997 |  6879 | `	SyToken *pEnd = pGen->pEnd;` |
|   2962997 |  6880 | `	sxi32 iDepth = 0;` |
|   2962997 |  6881 | `	int bStarted = 0;` |
| 138741339 |  6882 | `	while( pIn < pEnd ){` |
| 138741339 |  6883 | `		sxu32 t = pIn->nType;` |
| 138741339 |  6884 | `		if( t & PH7_TK_OCB ){ iDepth++; bStarted = 1; pIn++; continue; }` |
| 132478719 |  6885 | `		if( t & PH7_TK_CCB ){ iDepth--; pIn++; if( bStarted && iDepth <= 0 ){ break; } continue; }` |
| 126251203 |  6886 | `		if( t & PH7_TK_KEYWORD ){` |
|   9376935 |  6887 | `			int kw = SX_PTR_TO_INT(pIn->pUserData);` |
|   9376935 |  6888 | `			if( kw == PH7_TKWRD_YIELD ){ return TRUE; }` |
|   9365095 |  6889 | `			if( kw == PH7_TKWRD_FUNCTION ){ pIn = GenStateSkipNestedFunc(pIn,pEnd); continue; }` |
|         - |  6890 | ``			/* `fn` arrow bodies are single expressions and cannot contain a valid yield. */`` |
|   4665161 |  6891 | `		}` |
| 126204595 |  6892 | `		pIn++;` |
|         5 |  6893 | `	}` |
|   2951157 |  6894 | `	return FALSE;` |
|   1481501 |  6895 | `}` |
|         - |  6896 | `/*` |
...
|         - |  6900 | ` */` |
|   2962992 |  6901 | `static sxi32 GenStateCompileFuncBody(` |
...
|   2962997 |  6911 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC,PH7_VmInstrLength(pGen->pVm),pFunc,&pBlock);` |
|   2962997 |  6912 | `	if( rc != SXRET_OK ){` |
...
|         - |  6916 | `	}` |
|   2962997 |  6917 | `	nGotoOfft = SySetUsed(&pGen->aGoto);` |
|         - |  6918 | `	/* Swap bytecode containers */` |
|   2962997 |  6919 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   2962997 |  6920 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pFunc->aByteCode);` |
...
|         - |  6925 | `	{` |
|   2962997 |  6926 | `		sxu32 nArg = SySetUsed(&pFunc->aArgs);` |
|         - |  6927 | `		sxu32 i;` |
|   5018337 |  6928 | `		for( i = 0; i < nArg; i++ ){` |
|   2055345 |  6929 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pFunc->aArgs,i);` |
|         - |  6930 | `			char *zSrc;` |
|         - |  6931 | `			sxu32 nSrc,nName;` |
|         - |  6932 | `			SySet sToken;` |
|         - |  6933 | `			SyToken *pTmpIn,*pTmpEnd;` |
|         - |  6934 | `			sxi32 rcPromote;` |
|   2055345 |  6935 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|   2055269 |  6936 | `				continue;` |
|         - |  6937 | `			}` |
...
|         - |  6987 | `	{` |
|   2962997 |  6988 | `		sxi8 bSavedGen = pGen->bInGenerator;` |
|   2962997 |  6989 | `		pGen->bInGenerator = (sxi8)GenStateFuncBodyHasYield(&(*pGen));` |
|         - |  6990 | `		/* Compile the body */` |
|   2962997 |  6991 | `		PH7_CompileBlock(&(*pGen),0);` |
|   2962997 |  6992 | `		pGen->bInGenerator = bSavedGen;` |
|         - |  6993 | `	}` |
|         - |  6994 | `	/* Fix exception jumps now the destination is resolved */` |
|   2962997 |  6995 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|         - |  6996 | `	/* Emit the final return if not yet done */` |
|   2962997 |  6997 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|         - |  6998 | `	/* Fix gotos jumps now the destination is resolved */` |
|   2962997 |  6999 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),nGotoOfft) ){` |
|       ! 0 |  7000 | `		rc = SXERR_ABORT;` |
|       ! 0 |  7001 | `	}` |
|   2962997 |  7002 | `	SySetTruncate(&pGen->aGoto,nGotoOfft);` |
|         - |  7003 | `	/* Restore the default container */` |
|   2962997 |  7004 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|         - |  7005 | `	/* Leave function block */` |
|   2962997 |  7006 | `	GenStateLeaveBlock(&(*pGen),0);` |
|   2962997 |  7007 | `	if( rc == SXERR_ABORT ){` |
...
|         - |  7012 | `	{` |
|   2962997 |  7013 | `		VmInstr *aInstr = (VmInstr *)SySetBasePtr(&pFunc->aByteCode);` |
|         - |  7014 | `		sxu32 i;` |
|  84993725 |  7015 | `		for( i = 0; i < SySetUsed(&pFunc->aByteCode); i++ ){` |
|  82042573 |  7016 | `			if( aInstr[i].iOp == PH7_OP_YIELD \|\| aInstr[i].iOp == PH7_OP_YIELD_FROM ){` |
|     11845 |  7017 | `				pFunc->iFlags \|= VM_FUNC_GENERATOR;` |
|     11845 |  7018 | `				break;` |
|         - |  7019 | `			}` |
|  41015369 |  7020 | `		}` |
|         - |  7021 | `	}` |
|   2962997 |  7022 | `	if( pFunc->iFlags & VM_FUNC_GENERATOR ){` |
|         - |  7023 | `		/* php-exact definition-time check; see the helper's block comment. */` |
|     11845 |  7024 | `		if( SXERR_ABORT == GenStateValidateGeneratorReturnType(&(*pGen),pFunc) ){` |
|       ! 0 |  7025 | `			return SXERR_ABORT;` |
|         - |  7026 | `		}` |
|      5920 |  7027 | `	}` |
|         - |  7028 | `	/* All done, function body compiled */` |
|   2962997 |  7029 | `	return SXRET_OK;` |
|   1481501 |  7030 | `}` |
|         - |  7031 | `/*` |
...
|         - |  7100 | ` */` |
|     42778 |  7101 | `static int GenStateIsReservedTypeWord(const SyString *pName)` |
|         5 |  7102 | `{` |
...
|         - |  7107 | `	};` |
|         - |  7108 | `	sxu32 i;` |
|    896437 |  7109 | `	for( i = 0 ; i < SX_ARRAYSIZE(azWords) ; i++ ){` |
|    853767 |  7110 | `		sxu32 n = (sxu32)SyStrlen(azWords[i]);` |
|    853767 |  7111 | `		if( pName->nByte == n && SyStrnicmp(pName->zString,azWords[i],n) == 0 ){` |
|       113 |  7112 | `			return 1;` |
|         - |  7113 | `		}` |
|    426832 |  7114 | `	}` |
|     42675 |  7115 | `	return 0;` |
|     21394 |  7116 | `}` |
|    133124 |  7117 | `static sxi32 GenStateParseOneTypeAtom(ph7_gen_state *pGen, PhlTypeAtom *pOut)` |
|         5 |  7118 | `{` |
|    133129 |  7119 | `	SyToken *pIn = pGen->pIn;` |
|    133129 |  7120 | `	int bAbsolute = 0;` |
|    133129 |  7121 | `	SyZero(pOut, sizeof(*pOut));` |
|    133129 |  7122 | `	SyStringInitFromBuf(&pOut->sClass, 0, 0);` |
|    133129 |  7123 | `	if( pIn >= pGen->pEnd ){` |
|       ! 0 |  7124 | `		return SXERR_SYNTAX;` |
|         - |  7125 | `	}` |
|         - |  7126 | `	/* Optional leading namespace separator '\' on FQN class types */` |
|    133129 |  7127 | `	if( pIn->nType & PH7_TK_NSSEP ){` |
...
|         - |  7132 | `		}` |
|         4 |  7133 | `	}` |
|    133129 |  7134 | `	if( (pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|       ! 0 |  7135 | `		return SXERR_SYNTAX;` |
|         - |  7136 | `	}` |
|    133129 |  7137 | `	if( pIn->nType & PH7_TK_KEYWORD ){` |
|     90113 |  7138 | `		sxu32 nKey = (sxu32)(SX_PTR_TO_INT(pIn->pUserData));` |
|     90113 |  7139 | `		if( nKey & PH7_TKWRD_ARRAY ){` |
|     11659 |  7140 | `			pOut->nType = MEMOBJ_HASHMAP; pOut->zCanon = "array"; pOut->nCanon = 5;` |
|     84286 |  7141 | `		}else if( nKey & PH7_TKWRD_BOOL ){` |
|        87 |  7142 | `			pOut->nType = MEMOBJ_BOOL; pOut->zCanon = "bool"; pOut->nCanon = 4;` |
|     78418 |  7143 | `		}else if( nKey & PH7_TKWRD_INT ){` |
|     19983 |  7144 | `			pOut->nType = MEMOBJ_INT; pOut->zCanon = "int"; pOut->nCanon = 3;` |
|     68388 |  7145 | `		}else if( nKey & PH7_TKWRD_STRING ){` |
|     58301 |  7146 | `			pOut->nType = MEMOBJ_STRING; pOut->zCanon = "string"; pOut->nCanon = 6;` |
|     29251 |  7147 | `		}else if( nKey & PH7_TKWRD_FLOAT ){` |
...
|     43021 |  7162 | `		SyString *pT = &pIn->sData;` |
|     43021 |  7163 | `		if( pT->nByte == 4 && SyMemcmpNoCase(pT->zString, "null", 4) == 0 ){` |
|        34 |  7164 | `			pOut->nType = UTA_NULL_FLAG; pOut->zCanon = "null"; pOut->nCanon = 4;` |
|        34 |  7165 | `			pIn++;` |
|     43006 |  7166 | `		}else if( pT->nByte == 4 && SyMemcmpNoCase(pT->zString, "void", 4) == 0 ){` |
|       183 |  7167 | `			pOut->nType = UTA_VOID_FLAG; pOut->zCanon = "void"; pOut->nCanon = 4;` |
|       183 |  7168 | `			pIn++;` |
|     42902 |  7169 | `		}else if( pT->nByte == 5 && SyMemcmpNoCase(pT->zString, "never", 5) == 0 ){` |
|        27 |  7170 | `			pOut->nType = UTA_NEVER_FLAG; pOut->zCanon = "never"; pOut->nCanon = 5;` |
|        27 |  7171 | `			pIn++;` |
|        16 |  7172 | `		}else{` |
|         - |  7173 | `			/* Class / interface name; consume namespace path a\b\c */` |
|     42791 |  7174 | `			SyToken *pFirst = pIn;` |
|     42791 |  7175 | `			SyToken *pLast = pIn;` |
|     42791 |  7176 | `			pOut->nType = SXU32_HIGH;` |
|     42791 |  7177 | `			pOut->sClass = pIn->sData;` |
|     42791 |  7178 | `			pIn++;` |
|     64182 |  7179 | `			while( pIn + 1 < pGen->pEnd && (pIn->nType & PH7_TK_NSSEP)` |
|     42794 |  7180 | `				&& (pIn[1].nType & PH7_TK_ID) ){` |
|         3 |  7181 | `				pLast = &pIn[1];` |
|         3 |  7182 | `				pIn += 2;` |
|         1 |  7183 | `			}` |
|     42791 |  7184 | `			if( pLast != pFirst ){` |
...
|     42791 |  7198 | `			if( !bAbsolute && pLast == pFirst && !GenStateIsReservedTypeWord(&pOut->sClass) ){` |
|         - |  7199 | `				SyBlob sFqn;` |
|     42675 |  7200 | `				SyBlobInit(&sFqn,&pGen->pVm->sAllocator);` |
|     42675 |  7201 | `				GenStateResolveName(pGen,&pOut->sClass,&sFqn);` |
|     42670 |  7202 | `				if( SyBlobLength(&sFqn) != pOut->sClass.nByte` |
|     42670 |  7203 | `				 \|\| SyMemcmp(SyBlobData(&sFqn),(const void *)pOut->sClass.zString,pOut->sClass.nByte) != 0 ){` |
...
|         5 |  7208 | `					}` |
|         5 |  7209 | `				}` |
|     42675 |  7210 | `				SyBlobRelease(&sFqn);` |
|     21335 |  7211 | `			}` |
|         - |  7212 | `		}` |
|         - |  7213 | `	}` |
|    133127 |  7214 | `	pGen->pIn = pIn;` |
|    133127 |  7215 | `	return SXRET_OK;` |
|     66567 |  7216 | `}` |
|         - |  7217 |  |
|         - |  7218 | `/*` |
...
|         - |  7224 | ` */` |
|    132946 |  7225 | `static void GenBuildUnionTypeText(SyBlob *pBlob, PhlTypeAtom *aAtoms, int nAtoms, int bNullable)` |
|         5 |  7226 | `{` |
|         - |  7227 | `	int i;` |
|    132951 |  7228 | `	int nNonNull = 0;` |
|    132951 |  7229 | `	int bAnyIntersection = 0;` |
|         - |  7230 | `	sxu32 aGroupCount[PHL_UNION_MAX_ALTS];` |
|    132951 |  7231 | `	sxu32 nMaxGroup = 0;` |
|   4387223 |  7232 | `	for( i = 0; i < PHL_UNION_MAX_ALTS; i++ ) aGroupCount[i] = 0;` |
|    266049 |  7233 | `	for( i = 0; i < nAtoms; i++ ){` |
|    133103 |  7234 | `		if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|    133073 |  7235 | `			nNonNull++;` |
|    133073 |  7236 | `			if( aAtoms[i].nGroup < PHL_UNION_MAX_ALTS ){` |
|    133073 |  7237 | `				aGroupCount[aAtoms[i].nGroup]++;` |
|    133073 |  7238 | `				if( aAtoms[i].nGroup > nMaxGroup ) nMaxGroup = aAtoms[i].nGroup;` |
|     66534 |  7239 | `			}` |
|     66534 |  7240 | `		}` |
|     66554 |  7241 | `	}` |
|    265997 |  7242 | `	for( i = 0; i < nAtoms; i++ ){` |
|    133075 |  7243 | `		if( aAtoms[i].nType != UTA_NULL_FLAG && aGroupCount[aAtoms[i].nGroup] >= 2 ){` |
|        29 |  7244 | `			bAnyIntersection = 1;` |
|        29 |  7245 | `			break;` |
|         - |  7246 | `		}` |
|     66528 |  7247 | `	}` |
|    132951 |  7248 | `	if( bAnyIntersection ){` |
...
|        87 |  7283 | `		return;` |
|         - |  7284 | `	}` |
|    132927 |  7285 | `	if( nNonNull == 1 && bNullable ){` |
|         - |  7286 | `		/* Shorthand: ?T */` |
...
|       ! 0 |  7297 | `	}` |
|         - |  7298 | `	{` |
|    132811 |  7299 | `		int bFirst = 1;` |
|         - |  7300 | `		/* 1) Classes in declaration order */` |
|    265725 |  7301 | `		for( i = 0; i < nAtoms; i++ ){` |
|    132919 |  7302 | `			if( aAtoms[i].nType == SXU32_HIGH ){` |
|     42747 |  7303 | `				if( !bFirst ) SyBlobAppend(pBlob, "\|", 1);` |
|     42747 |  7304 | `				SyBlobAppend(pBlob, aAtoms[i].sClass.zString, aAtoms[i].sClass.nByte);` |
|     42747 |  7305 | `				bFirst = 0;` |
|     21371 |  7306 | `			}` |
|     66462 |  7307 | `		}` |
...
|         - |  7312 | `			int k;` |
|    929647 |  7313 | `			for( k = 0; k < (int)(sizeof(aOrder)/sizeof(aOrder[0])); k++ ){` |
|   1504249 |  7314 | `				for( i = 0; i < nAtoms; i++ ){` |
|    797377 |  7315 | `					if( aAtoms[i].nType == aOrder[k] ){` |
|     89969 |  7316 | `						if( !bFirst ) SyBlobAppend(pBlob, "\|", 1);` |
|     89969 |  7317 | `						SyBlobAppend(pBlob, aAtoms[i].zCanon, aAtoms[i].nCanon);` |
|     89969 |  7318 | `						bFirst = 0;` |
|     89969 |  7319 | `						break;` |
|         - |  7320 | `					}` |
|    353709 |  7321 | `				}` |
...
|         - |  7345 | ` */` |
|    133098 |  7346 | `static sxi32 GenStateParsePart(` |
|         - |  7347 | `	ph7_gen_state *pGen, PhlTypeAtom *aAtoms, int *pnAtoms, sxu32 iGroup,` |
|         - |  7348 | `	int *pnMembers, int *pbParen, sxu32 nLine)` |
|         5 |  7349 | `{` |
|         - |  7350 | `	sxi32 rc;` |
|    133103 |  7351 | `	int nMembers = 0;` |
|    133103 |  7352 | `	int bParen = 0;` |
|    133103 |  7353 | `	*pnMembers = 0;` |
|    133103 |  7354 | `	*pbParen = 0;` |
|    133103 |  7355 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_LPAREN) ){` |
|         9 |  7356 | `		bParen = 1;` |
|         9 |  7357 | `		pGen->pIn++; /* skip '(' */` |
|         3 |  7358 | `	}` |
|     66549 |  7359 | `	for(;;){` |
|    133129 |  7360 | `		if( *pnAtoms >= PHL_UNION_MAX_ALTS ){` |
...
|         - |  7364 | `		}` |
|    133129 |  7365 | `		rc = GenStateParseOneTypeAtom(pGen, &aAtoms[*pnAtoms]);` |
|    133129 |  7366 | `		if( rc != SXRET_OK ){` |
|         3 |  7367 | `			return rc;` |
|         - |  7368 | `		}` |
|    133127 |  7369 | `		aAtoms[*pnAtoms].nGroup = iGroup;` |
|    133127 |  7370 | `		(*pnAtoms)++;` |
|    133127 |  7371 | `		nMembers++;` |
|         - |  7372 | ``		/* Continue the intersection while `&` is followed by another type atom. */`` |
|    133127 |  7373 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
...
|         - |  7394 | `		}` |
|         3 |  7395 | `	}` |
|    133101 |  7396 | `	*pnMembers = nMembers;` |
|    133101 |  7397 | `	*pbParen = bParen;` |
|    133101 |  7398 | `	return SXRET_OK;` |
|     66554 |  7399 | `}` |
|         - |  7400 |  |
|         - |  7401 | `/*` |
...
|         - |  7418 | ` */` |
|    132962 |  7419 | `static sxi32 GenStateParseUnionTypeDecl(` |
...
|    132967 |  7432 | `	int nAtoms = 0;` |
|    132967 |  7433 | `	int bShortNullable = 0;` |
|    132967 |  7434 | `	int bExplicitNull = 0;` |
|         - |  7435 | `	sxi32 rc;` |
|    132967 |  7436 | `	*pnType = 0;` |
|    132967 |  7437 | `	if( pClass ) SyStringInitFromBuf(pClass, 0, 0);` |
|    132967 |  7438 | `	*piTypeFlags = 0;` |
|    132967 |  7439 | `	if( pTypeText ) SyStringInitFromBuf(pTypeText, 0, 0);` |
|         - |  7440 |  |
|    132967 |  7441 | `	if( pGen->pIn >= pGen->pEnd ){` |
|       ! 0 |  7442 | `		return SXRET_OK;` |
|         - |  7443 | `	}` |
|         - |  7444 | ``	/* Optional `?` shorthand prefix */`` |
|    132962 |  7445 | `	if( (pGen->pIn->nType & PH7_TK_OP) && pGen->pIn->sData.nByte == 1` |
...
|    132967 |  7458 | `		sxu32 iGroup = 0;` |
|    132967 |  7459 | `		rc = GenStateParsePart(pGen, aAtoms, &nAtoms, iGroup, &nMembers, &bParen, nLine);` |
|    132967 |  7460 | `		if( rc != SXRET_OK ){` |
|         4 |  7461 | `			return rc;` |
|         - |  7462 | `		}` |
...
|    199649 |  7468 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OP)` |
|    133174 |  7469 | `			&& pGen->pIn->sData.nByte == 1 && pGen->pIn->sData.zString[0] == '\|' ){` |
...
|         - |  7487 | `			}` |
|         5 |  7488 | `		}` |
|    132963 |  7489 | `		if( iGroup > 0 && nMembers >= 2 && !bParen ){` |
...
|         - |  7501 | `	{` |
|         - |  7502 | `		int i, j;` |
|    132963 |  7503 | `		int bHasNonNull = 0;` |
|    132963 |  7504 | `		int bAnyIntersection = 0;` |
...
|   4387619 |  7508 | `		for( i = 0; i < PHL_UNION_MAX_ALTS; i++ ) aGroupCount[i] = 0;` |
|    266083 |  7509 | `		for( i = 0; i < nAtoms; i++ ){` |
|    133125 |  7510 | `			if( aAtoms[i].nGroup < PHL_UNION_MAX_ALTS ) aGroupCount[aAtoms[i].nGroup]++;` |
|     66565 |  7511 | `		}` |
|    266027 |  7512 | `		for( i = 0; i < nAtoms; i++ ){` |
|    133095 |  7513 | `			if( aGroupCount[aAtoms[i].nGroup] >= 2 ){ bAnyIntersection = 1; break; }` |
|     66537 |  7514 | `		}` |
...
|    132963 |  7517 | `		if( bShortNullable && bAnyIntersection ){` |
...
|         - |  7521 | `		}` |
|    266069 |  7522 | `		for( i = 0; i < nAtoms; i++ ){` |
...
|    133123 |  7526 | `			if( aGroupCount[aAtoms[i].nGroup] >= 2 ){` |
...
|         - |  7548 | `				}` |
|        24 |  7549 | `			}` |
|    133121 |  7550 | `			if( aAtoms[i].nType == UTA_VOID_FLAG ){` |
...
|         - |  7565 | `				}` |
|        88 |  7566 | `			}` |
|    133119 |  7567 | `			if( aAtoms[i].nType == UTA_NEVER_FLAG ){` |
...
|         - |  7584 | `				}` |
|         8 |  7585 | `			}` |
|    133113 |  7586 | `			if( aAtoms[i].nType == UTA_NULL_FLAG ){` |
|        34 |  7587 | `				bExplicitNull = 1;` |
|        19 |  7588 | `			}else{` |
|    133083 |  7589 | `				bHasNonNull = 1;` |
|         - |  7590 | `			}` |
...
|        99 |  7628 | `			}` |
|     66558 |  7629 | `		}` |
|    132951 |  7630 | `		if( !bHasNonNull && bExplicitNull ){` |
...
|    132951 |  7645 | `	if( bShortNullable \|\| bExplicitNull ){` |
|       137 |  7646 | `		*piTypeFlags \|= iNullableFlag;` |
|        66 |  7647 | `	}` |
|         - |  7648 | `	/* Build canonical type text */` |
|    132951 |  7649 | `	if( pTypeText ){` |
|         - |  7650 | `		SyBlob sBlob;` |
|    132951 |  7651 | `		SyBlobInit(&sBlob, &pGen->pVm->sAllocator);` |
|    199373 |  7652 | `		GenBuildUnionTypeText(&sBlob, aAtoms, nAtoms,` |
|     66473 |  7653 | `			(bShortNullable \|\| bExplicitNull) ? 1 : 0);` |
|    132951 |  7654 | `		if( SyBlobLength(&sBlob) > 0 ){` |
|    199136 |  7655 | `			char *zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|    132754 |  7656 | `				(const char *)SyBlobData(&sBlob), SyBlobLength(&sBlob));` |
|    132759 |  7657 | `			if( zDup ){` |
|    132759 |  7658 | `				SyStringInitFromBuf(pTypeText, zDup, SyBlobLength(&sBlob));` |
|     66377 |  7659 | `			}` |
|     66377 |  7660 | `		}` |
|    132951 |  7661 | `		SyBlobRelease(&sBlob);` |
|     66473 |  7662 | `	}` |
...
|         - |  7666 | `	{` |
|    132951 |  7667 | `		int nNonNull = 0;` |
|    132951 |  7668 | `		int iNonNullIdx = -1;` |
|         - |  7669 | `		int i;` |
|    266049 |  7670 | `		for( i = 0; i < nAtoms; i++ ){` |
|    133103 |  7671 | `			if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|    133073 |  7672 | `				nNonNull++;` |
|    133073 |  7673 | `				iNonNullIdx = i;` |
|     66534 |  7674 | `			}` |
|     66554 |  7675 | `		}` |
|    132951 |  7676 | `		if( nNonNull <= 1 ){` |
|         - |  7677 | `			/* Fast path: store as single type. */` |
|    132845 |  7678 | `			if( iNonNullIdx >= 0 ){` |
|    132839 |  7679 | `				PhlTypeAtom *pA = &aAtoms[iNonNullIdx];` |
|    132839 |  7680 | `				if( pA->nType == SXU32_HIGH ){` |
|     64091 |  7681 | `					char *zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|     21362 |  7682 | `						pA->sClass.zString, pA->sClass.nByte);` |
|     42729 |  7683 | `					if( zDup == 0 ) return SXERR_ABORT;` |
|     42729 |  7684 | `					*pnType = SXU32_HIGH;` |
|     42729 |  7685 | `					if( pClass ) SyStringInitFromBuf(pClass, zDup, pA->sClass.nByte);` |
|    111477 |  7686 | `				}else if( pA->nType == UTA_VOID_FLAG ){` |
|       181 |  7687 | `					*pnType = MEMOBJ_VOID;` |
|     90027 |  7688 | `				}else if( pA->nType == UTA_NEVER_FLAG ){` |
|        18 |  7689 | `					*pnType = MEMOBJ_NEVER;` |
|        10 |  7690 | `				}else{` |
|     89923 |  7691 | `					*pnType = pA->nType;` |
|         - |  7692 | `				}` |
|     66417 |  7693 | `			}` |
|     66425 |  7694 | `		}else{` |
...
|         - |  7726 | ` */` |
|   3102400 |  7727 | `static sxi32 GenStateParseReturnType(ph7_gen_state *pGen, ph7_vm_func *pFunc)` |
|         5 |  7728 | `{` |
|   3102405 |  7729 | `	sxi32 iFlags = 0;` |
|         - |  7730 | `	sxi32 rc;` |
|         - |  7731 | `	sxu32 nLine;` |
|   3102405 |  7732 | `	pFunc->nReturnType = 0;` |
|   3102405 |  7733 | `	SyStringInitFromBuf(&pFunc->sReturnClass, 0, 0);` |
|   3102405 |  7734 | `	SyStringInitFromBuf(&pFunc->sReturnTypeName, 0, 0);` |
...
|   3102405 |  7740 | `	SySetReset(&pFunc->aReturnUnion);` |
|   3102405 |  7741 | `	pFunc->iFlags &= ~VM_FUNC_RETURN_NULLABLE;` |
|   3102405 |  7742 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COLON) == 0 ){` |
|   3090007 |  7743 | `		return SXRET_OK;` |
|         - |  7744 | `	}` |
|     12403 |  7745 | `	pGen->pIn++; /* Skip ':' */` |
|     12403 |  7746 | `	if( pGen->pIn >= pGen->pEnd ){` |
|       ! 0 |  7747 | `		return SXRET_OK;` |
|         - |  7748 | `	}` |
|     12403 |  7749 | `	nLine = pGen->pIn->nLine;` |
|     12403 |  7750 | `	rc = GenStateParseUnionTypeDecl(` |
|      6199 |  7751 | `		pGen,` |
|      6199 |  7752 | `		&pFunc->nReturnType,` |
|      6199 |  7753 | `		&pFunc->sReturnClass,` |
|      6199 |  7754 | `		&pFunc->aReturnUnion,` |
|         - |  7755 | `		&iFlags,` |
|      6199 |  7756 | `		&pFunc->sReturnTypeName,` |
...
|         - |  7760 | `		/* bAllowVoid */ 1,` |
|      6199 |  7761 | `		nLine);` |
|     12403 |  7762 | `	if( rc == SXERR_ABORT ){` |
|       ! 0 |  7763 | `		return SXERR_ABORT;` |
|         - |  7764 | `	}` |
|     12403 |  7765 | `	if( rc == SXERR_CORRUPT ){` |
|         - |  7766 | `		/* Error already reported */` |
|       ! 0 |  7767 | `		return SXERR_SYNTAX;` |
|         - |  7768 | `	}` |
|     12403 |  7769 | `	if( rc == SXERR_SYNTAX ){` |
...
|         - |  7779 | `	}` |
|     12397 |  7780 | `	pFunc->iFlags \|= (iFlags & VM_FUNC_RETURN_NULLABLE);` |
|     12397 |  7781 | `	return SXRET_OK;` |
|   1551205 |  7782 | `}` |
|         - |  7783 |  |
|    495948 |  7784 | `static sxi32 GenStateCompileFunc(` |
...
|    495953 |  7798 | `	nLine = pGen->pIn->nLine;` |
|         - |  7799 | `	/* Jump the left parenthesis '(' */` |
|    495953 |  7800 | `	pGen->pIn++;` |
|         - |  7801 | `	/* Delimit the function signature */` |
|    495953 |  7802 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|    495953 |  7803 | `	if( pEnd >= pGen->pEnd ){` |
|         - |  7804 | `		/* Syntax error */` |
...
|    495947 |  7815 | `	pFunc = (ph7_vm_func *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_vm_func));` |
|    495947 |  7816 | `	if( pFunc == 0 ){` |
|       ! 0 |  7817 | `		goto OutOfMem;` |
|         - |  7818 | `	}` |
|         - |  7819 | `	/* Build the function name, prepending namespace if active */` |
|    495955 |  7820 | `	if( SyBlobLength(&pGen->sNamespace) > 0 && !bHandleClosure ){` |
|         - |  7821 | `		SyBlob sFQN;` |
|         - |  7822 | `		sxu32 nLen;` |
...
|        10 |  7834 | `	}else{` |
|    495931 |  7835 | `		zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|    495931 |  7836 | `		if( zName == 0 ){` |
|       ! 0 |  7837 | `			goto OutOfMem;` |
|         - |  7838 | `		}` |
|    495931 |  7839 | `		PH7_VmInitFuncState(pGen->pVm,pFunc,zName,pName->nByte,iFlags,0);` |
|         - |  7840 | `	}` |
...
|    495947 |  7843 | `	pFunc->nLine = nLine;` |
|    495947 |  7844 | `	GenStateConsumeDoc(&(*pGen),&pFunc->sDoc);` |
|    495947 |  7845 | `	if( GenStateConsumeAttrs(&(*pGen),&pFunc->aAttrs) == SXERR_ABORT ){` |
|       ! 0 |  7846 | `		return SXERR_ABORT;` |
|         - |  7847 | `	}` |
|    495947 |  7848 | `	if( pGen->pIn < pEnd ){` |
|         - |  7849 | `		/* Collect function arguments */` |
|    429397 |  7850 | `		rc = GenStateCollectFuncArgs(pFunc,&(*pGen),pEnd,0,0);` |
|    429397 |  7851 | `		if( rc == SXERR_ABORT ){` |
...
|    495947 |  7857 | `	pGen->pIn = &pEnd[1];` |
|         - |  7858 | `	{` |
|    495947 |  7859 | `		sxi32 rcRt = GenStateParseReturnType(pGen, pFunc);` |
|    495947 |  7860 | `		if( rcRt == SXERR_ABORT ){` |
|       ! 0 |  7861 | `			return SXERR_ABORT;` |
|    495947 |  7862 | `		}else if( rcRt == SXERR_SYNTAX ){` |
|         9 |  7863 | `			return SXERR_SYNTAX;` |
|         - |  7864 | `		}` |
|         - |  7865 | `	}` |
|    495941 |  7866 | `	if( bHandleClosure ){` |
...
|    495941 |  7976 | `	rc = GenStateCompileFuncBody(&(*pGen),pFunc);` |
|    495941 |  7977 | `	if( rc == SXERR_ABORT ){` |
|       ! 0 |  7978 | `		return SXERR_ABORT;` |
|         - |  7979 | `	}` |
|         - |  7980 | `	/* The cursor sits just past the body's closing brace */` |
|    495941 |  7981 | `	pFunc->nEndLine = pGen->pIn[-1].nLine;` |
|    495941 |  7982 | `	if( ppFunc ){` |
|    495941 |  7983 | `		*ppFunc = pFunc;` |
|    247968 |  7984 | `	}` |
|    495941 |  7985 | `	rc = SXRET_OK;` |
|    495941 |  7986 | `	if( (pFunc->iFlags & VM_FUNC_CLOSURE) == 0 ){` |
|         - |  7987 | `		/* Finally register the function */` |
|    495369 |  7988 | `		rc = PH7_VmInstallUserFunction(pGen->pVm,pFunc,0);` |
|    247682 |  7989 | `	}` |
|    495941 |  7990 | `	if( rc == SXRET_OK ){` |
|    495941 |  7991 | `		return SXRET_OK;` |
|         - |  7992 | `	}` |
...
|         - |  8004 | ` */` |
|    495376 |  8005 | `static sxi32 PH7_CompileFunction(ph7_gen_state *pGen)` |
|         5 |  8006 | `{` |
|         - |  8007 | `	SyString *pName;` |
|         - |  8008 | `	sxi32 iFlags;` |
|         - |  8009 | `	sxu32 nKwLine;` |
...
|         - |  8011 | `	sxi32 rc;` |
|         - |  8012 |  |
|    495381 |  8013 | `	nLine = pGen->pIn->nLine;` |
|    495381 |  8014 | `	nKwLine = nLine; /* Line of the 'function' keyword (Reflection getStartLine) */` |
|    495381 |  8015 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|    495381 |  8016 | `	iFlags = 0;` |
|    495381 |  8017 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|         - |  8018 | `		/* Return by reference,remember that */` |
|        12 |  8019 | `		iFlags \|= VM_FUNC_REF_RETURN;` |
|         - |  8020 | `		/* Jump the '&' token */` |
|        12 |  8021 | `		pGen->pIn++;` |
|         5 |  8022 | `	}` |
|    495381 |  8023 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|         - |  8034 | `	}` |
|    495375 |  8035 | `	pName = &pGen->pIn->sData;` |
|    495375 |  8036 | `	nLine = pGen->pIn->nLine;` |
|         - |  8037 | `	/* Jump the function name */` |
|    495375 |  8038 | `	pGen->pIn++;` |
|    495375 |  8039 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|         - |  8040 | `		/* Syntax error */` |
...
|         - |  8053 | `	{` |
|    495373 |  8054 | `		ph7_vm_func *pFuncState = 0;` |
|    495373 |  8055 | `		rc = GenStateCompileFunc(&(*pGen),pName,iFlags,FALSE,&pFuncState);` |
|    495373 |  8056 | `		if( pFuncState ){` |
|         - |  8057 | `			/* Reflection getStartLine(): line of the 'function' keyword */` |
|    495361 |  8058 | `			pFuncState->nLine = nKwLine;` |
|    247678 |  8059 | `		}` |
|         - |  8060 | `	}` |
|    495373 |  8061 | `	return rc;` |
|    247693 |  8062 | `}` |
|         - |  8063 | `/*` |
...
|         - |  8073 | ` */` |
|   3432804 |  8074 | `static sxi32 GetProtectionLevel(sxi32 nKeyword)` |
|         5 |  8075 | `{` |
|   3432809 |  8076 | `	if( nKeyword == PH7_TKWRD_PRIVATE ){` |
|    258703 |  8077 | `		return PH7_CLASS_PROT_PRIVATE;` |
|   3174111 |  8078 | `	}else if( nKeyword == PH7_TKWRD_PROTECTED ){` |
|    231583 |  8079 | `		return PH7_CLASS_PROT_PROTECTED;` |
|         - |  8080 | `	}` |
|         - |  8081 | `	/* Assume public by default */` |
|   2942533 |  8082 | `	return PH7_CLASS_PROT_PUBLIC;` |
|   1716407 |  8083 | `}` |
|         - |  8084 | `/*` |
...
|         - |  8112 | ` */` |
|    339690 |  8113 | `static int GenStateClassConstHasType(ph7_gen_state *pGen)` |
|         5 |  8114 | `{` |
|         - |  8115 | `	SyToken *p0, *p1;` |
|    339695 |  8116 | `	if( pGen->pIn >= pGen->pEnd ){` |
|       ! 0 |  8117 | `		return 0;` |
|         - |  8118 | `	}` |
|    339695 |  8119 | `	p0 = pGen->pIn;` |
|         - |  8120 | `	/* A leading '\' (namespaced class type) or '?' (nullable) always starts a type */` |
|    339695 |  8121 | `	if( p0->nType & PH7_TK_NSSEP ){` |
|       ! 0 |  8122 | `		return 1;` |
|         - |  8123 | `	}` |
|    339695 |  8124 | `	if( (p0->nType & PH7_TK_OP) && p0->sData.nByte == 1 && p0->sData.zString[0] == '?' ){` |
|         5 |  8125 | `		return 1;` |
|         - |  8126 | `	}` |
...
|    339691 |  8130 | `	if( p0->nType & (PH7_TK_ID\|PH7_TK_KEYWORD) ){` |
|    339691 |  8131 | `		p1 = (pGen->pIn + 1 < pGen->pEnd) ? (pGen->pIn + 1) : 0;` |
|    339691 |  8132 | `		if( p1 ){` |
|    339691 |  8133 | `			if( p1->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_NSSEP) ){` |
|        34 |  8134 | `				return 1;` |
|         - |  8135 | `			}` |
|    339661 |  8136 | `			if( (p1->nType & PH7_TK_OP) && p1->sData.nByte == 1 && p1->sData.zString[0] == '\|' ){` |
|         5 |  8137 | `				return 1;` |
|         - |  8138 | `			}` |
|    169826 |  8139 | `		}` |
|    169826 |  8140 | `	}` |
|    339657 |  8141 | `	return 0;` |
|    169850 |  8142 | `}` |
|         - |  8143 | `/*` |
...
|         - |  8196 | ` */` |
|    703060 |  8197 | `static int GenStateInitHasNewExpr(ph7_gen_state *pGen)` |
|         5 |  8198 | `{` |
|    703065 |  8199 | `	SyToken *p = pGen->pIn;` |
|    703065 |  8200 | `	int iDepth = 0;` |
|   1843651 |  8201 | `	while( p < pGen->pEnd ){` |
|   1843651 |  8202 | `		if( iDepth == 0 && (p->nType & (PH7_TK_SEMI\|PH7_TK_COMMA)) ){` |
|    703013 |  8203 | `			break; /* end of this initializer */` |
|         - |  8204 | `		}` |
|   1140638 |  8205 | `		if( (p->nType & PH7_TK_KEYWORD)` |
|    576128 |  8206 | `			&& ( SX_PTR_TO_INT(p->pUserData) == PH7_TKWRD_FUNCTION` |
|     11608 |  8207 | `				\|\| SX_PTR_TO_INT(p->pUserData) == PH7_TKWRD_FN ) ){` |
...
|         3 |  8265 | `			continue;` |
|         - |  8266 | `		}` |
|   1140641 |  8267 | `		if( p->nType & PH7_TK_OCB ){` |
|        45 |  8268 | `			if( iDepth == 0 ){` |
...
|         - |  8274 | `			}` |
|       ! 0 |  8275 | `			iDepth++;` |
|   1140597 |  8276 | `		}else if( p->nType & (PH7_TK_LPAREN\|PH7_TK_OSB) ){` |
|     46393 |  8277 | `			iDepth++;` |
|   1117403 |  8278 | `		}else if( p->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB) ){` |
|     46391 |  8279 | `			if( iDepth > 0 ){` |
|     46391 |  8280 | `				iDepth--;` |
|     23193 |  8281 | `			}` |
|   1071016 |  8282 | `		}else if( (p->nType & PH7_TK_OP) && p->pUserData` |
|    373335 |  8283 | `			&& ((const ph7_expr_op *)p->pUserData)->iOp == EXPR_OP_NEW ){` |
...
|        11 |  8315 | `	}` |
|       393 |  8316 | `}` |
|    339690 |  8317 | `static sxi32 GenStateCompileClassConstant(ph7_gen_state *pGen,sxi32 iProtection,sxi32 iFlags,ph7_class *pClass)` |
|         5 |  8318 | `{` |
|    339695 |  8319 | `	sxu32 nLine = pGen->pIn->nLine;` |
|         - |  8320 | `	SySet *pInstrContainer;` |
|         - |  8321 | `	ph7_class_attr *pCons;` |
|         - |  8322 | `	SyString *pName;` |
|         - |  8323 | `	sxi32 rc;` |
|    339695 |  8324 | `	sxu32 nType = 0;` |
|         - |  8325 | `	SyString sTypeClass;` |
|         - |  8326 | `	SyString sTypeText;` |
|         - |  8327 | `	SySet aUnionAlts;` |
|    339695 |  8328 | `	sxi32 iTypeFlags = 0;` |
|    339695 |  8329 | `	SyStringInitFromBuf(&sTypeClass,0,0);` |
|    339695 |  8330 | `	SyStringInitFromBuf(&sTypeText,0,0);` |
|    339695 |  8331 | `	SySetInit(&aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|         - |  8332 | `	/* Extract visibility level */` |
|    339695 |  8333 | `	iProtection = GetProtectionLevel(iProtection);` |
|         - |  8334 | `	/* Mark as constant */` |
|    339695 |  8335 | `	iFlags \|= PH7_CLASS_ATTR_CONSTANT;` |
|    339695 |  8336 | `	pGen->pIn++; /* Jump the 'const' keyword */` |
...
|    339714 |  8339 | `	if( GenStateClassConstHasType(pGen) ){` |
...
|        19 |  8360 | `	}` |
|    169845 |  8361 | `loop:` |
|    339697 |  8362 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
...
|    339697 |  8372 | `	pName = &pGen->pIn->sData;` |
|         - |  8373 | `	/* Make sure the constant name isn't reserved */` |
|    339697 |  8374 | `	if( GenStateIsReservedConstant(pName) ){` |
...
|    339697 |  8384 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
...
|    339695 |  8395 | `	pGen->pIn++;` |
|    339695 |  8396 | `	if(pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_EQUAL /* '=' */) == 0 ){` |
...
|         - |  8404 | `	}` |
|    339695 |  8405 | `	pGen->pIn++; /* Jump the equal sign */` |
...
|    339690 |  8410 | `	if( (iTypeFlags & PH7_CLASS_ATTR_TYPED) && !(iTypeFlags & PH7_CLASS_ATTR_UNION)` |
...
|    339691 |  8423 | `	if( GenStateInitHasNewExpr(pGen) ){` |
...
|    339687 |  8432 | `	pCons = PH7_NewClassAttr(pGen->pVm,pName,nLine,iProtection,iFlags\|iTypeFlags);` |
|    339687 |  8433 | `	if( pCons ){` |
|    339687 |  8434 | `		GenStateConsumeDoc(&(*pGen),&pCons->sDoc);` |
|    339687 |  8435 | `		if( GenStateConsumeAttrs(&(*pGen),&pCons->aAttrs) == SXERR_ABORT ){` |
|       ! 0 |  8436 | `			return SXERR_ABORT;` |
|         - |  8437 | `		}` |
|    169841 |  8438 | `	}` |
|    339687 |  8439 | `	if( pCons == 0 ){` |
|       ! 0 |  8440 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|       ! 0 |  8441 | `		return SXERR_ABORT;` |
|         - |  8442 | `	}` |
|    339687 |  8443 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|        35 |  8444 | `		GenStateCopyTypeToAttr(pCons,nType,&sTypeClass,&sTypeText,iTypeFlags,&aUnionAlts);` |
|        16 |  8445 | `	}` |
|         - |  8446 | `	/* Swap bytecode container */` |
|    339687 |  8447 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|    339687 |  8448 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pCons->aByteCode);` |
|         - |  8449 | `	/* Compile constant value.` |
|         - |  8450 | `	 */` |
|    339687 |  8451 | `	rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|    339687 |  8452 | `	if( rc == SXERR_EMPTY ){` |
...
|    339687 |  8459 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|    339687 |  8460 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|    339687 |  8461 | `	if( rc == SXERR_ABORT ){` |
...
|    339687 |  8466 | `	rc = PH7_ClassInstallAttr(pClass,pCons);` |
|    339687 |  8467 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  8468 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|       ! 0 |  8469 | `		return SXERR_ABORT;` |
|         - |  8470 | `	}` |
|    339687 |  8471 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA /*','*/) ){` |
...
|         - |  8489 | `		}` |
|       ! 0 |  8490 | `	}` |
|    339685 |  8491 | `	SySetRelease(&aUnionAlts);` |
|    339685 |  8492 | `	return SXRET_OK;` |
|         5 |  8493 | `Synchronize:` |
...
|         - |  8529 | ` */` |
|   2559764 |  8530 | `static int GenStateLooksLikeTypedProperty(SyToken *pStart,SyToken *pEnd)` |
|         5 |  8531 | `{` |
|   2559769 |  8532 | `	SyToken *p = pStart;` |
|   2559769 |  8533 | `	int bFirst = 1;` |
|   2559769 |  8534 | `	if( p >= pEnd ) return 0;` |
|         - |  8535 | ``	/* Optional nullable `?` shorthand. */`` |
|   2559769 |  8536 | `	if( (p->nType & PH7_TK_OP) && p->sData.nByte == 1 && p->sData.zString[0] == '?' ){` |
|        41 |  8537 | `		p++;` |
...
|   1279882 |  8544 | `	for(;;){` |
|   2559789 |  8545 | `		if( p < pEnd && (p->nType & PH7_TK_LPAREN) ){` |
...
|   2559787 |  8554 | `			if( p < pEnd && (p->nType & PH7_TK_NSSEP) ){ p++; }` |
|   2559787 |  8555 | `			if( p >= pEnd \|\| (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|       ! 0 |  8556 | `				return 0;` |
|         - |  8557 | `			}` |
...
|   2559787 |  8561 | `			if( bFirst && (p->nType & PH7_TK_KEYWORD) ){` |
|   2559735 |  8562 | `				sxu32 k = (sxu32)(SX_PTR_TO_INT(p->pUserData));` |
|   2559730 |  8563 | `				if( k == PH7_TKWRD_FUNCTION \|\| k == PH7_TKWRD_VAR \|\| k == PH7_TKWRD_CONST` |
|    104654 |  8564 | `				 \|\| k == PH7_TKWRD_STATIC \|\| k == PH7_TKWRD_FINAL \|\| k == PH7_TKWRD_ABSTRACT ){` |
|   2559419 |  8565 | `					return 0;` |
|         - |  8566 | `				}` |
|       158 |  8567 | `			}` |
|       373 |  8568 | `			p++;` |
...
|         - |  8745 | ` */` |
|  21592758 |  8746 | `static int GenStateIsReadonly(SyToken *pTok)` |
|         5 |  8747 | `{` |
|  21817339 |  8748 | `	return (pTok->nType & PH7_TK_ID)` |
|  11020955 |  8749 | `		&& pTok->sData.nByte == sizeof("readonly")-1` |
|  21817334 |  8750 | `		&& SyStrnicmp(pTok->sData.zString,"readonly",sizeof("readonly")-1) == 0;` |
|         5 |  8751 | `}` |
|         - |  8752 | `/*` |
...
|         - |  8757 | ` */` |
|   7808756 |  8758 | `static sxi32 GenStatePeekSetVisibility(SyToken *pTok,SyToken *pEnd,int *pnTok)` |
|         5 |  8759 | `{` |
|   7808761 |  8760 | `	*pnTok = 0;` |
|   7808756 |  8761 | `	if( &pTok[3] < pEnd` |
|   7337162 |  8762 | `	 && (pTok->nType & PH7_TK_KEYWORD)` |
|   6087299 |  8763 | `	 && (pTok[1].nType & PH7_TK_LPAREN)` |
|   2654523 |  8764 | `	 && (pTok[2].nType & (PH7_TK_ID\|PH7_TK_KEYWORD))` |
...
|         9 |  8786 | `}` |
|    487150 |  8787 | `static sxi32 GenStateCompileClassAttr(ph7_gen_state *pGen,sxi32 iProtection,sxi32 iFlags,ph7_class *pClass)` |
|         5 |  8788 | `{` |
|    487155 |  8789 | `	sxu32 nLine = pGen->pIn->nLine;` |
|         - |  8790 | `	ph7_class_attr *pAttr;` |
|         - |  8791 | `	SyString *pName;` |
|         - |  8792 | `	sxi32 rc;` |
|    487155 |  8793 | `	sxu32 nType = 0;` |
|         - |  8794 | `	SyString sTypeClass;` |
|         - |  8795 | `	SyString sTypeText;` |
|         - |  8796 | `	SySet aUnionAlts;` |
|    487155 |  8797 | `	sxi32 iTypeFlags = 0;` |
|    487155 |  8798 | `	SyStringInitFromBuf(&sTypeClass,0,0);` |
|    487155 |  8799 | `	SyStringInitFromBuf(&sTypeText,0,0);` |
|    487155 |  8800 | `	SySetInit(&aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
...
|    487155 |  8804 | `	if( pClass->iFlags & PH7_CLASS_READONLY ){` |
|        21 |  8805 | `		iFlags \|= PH7_CLASS_ATTR_READONLY;` |
|         9 |  8806 | `	}` |
|         - |  8807 | `	/* Extract visibility level */` |
|    487155 |  8808 | `	iProtection = GetProtectionLevel(iProtection);` |
|         - |  8809 | `	/* Parse optional type hint (typed properties, PHP 7.4+) */` |
|    487335 |  8810 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
...
|       180 |  8826 | `	}` |
|       ! 0 |  8827 | `loop:` |
|    487159 |  8828 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
...
|         - |  8834 | `	}` |
|    487159 |  8835 | `	pGen->pIn++; /* Jump the dollar sign */` |
|    487159 |  8836 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_ID)) == 0 ){` |
...
|    487159 |  8846 | `	pName = &pGen->pIn->sData;` |
|         - |  8847 | `	/* Advance the stream cursor */` |
|    487159 |  8848 | `	pGen->pIn++;` |
|    487159 |  8849 | `	if(pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_EQUAL/*'='*/\|PH7_TK_SEMI/*';'*/\|PH7_TK_COMMA/*','*/\|PH7_TK_OCB/*'{' hooks*/)) == 0 ){` |
...
|    487157 |  8860 | `	if( iFlags & (PH7_CLASS_ATTR_PRIVATE_SET\|PH7_CLASS_ATTR_PROTECTED_SET\|PH7_CLASS_ATTR_PUBLIC_SET) ){` |
...
|    487157 |  8880 | `	if( iFlags & PH7_CLASS_ATTR_READONLY ){` |
...
|    487147 |  8900 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
...
|    487147 |  8912 | `	if( PH7_ClassExtractAttribute(pClass,pName->zString,pName->nByte) != 0 ){` |
...
|    487145 |  8926 | `	if( (pGen->pIn->nType & PH7_TK_EQUAL /*'='*/) && GenStateInitHasNewExpr(pGen) ){` |
...
|    487141 |  8935 | `	pAttr = PH7_NewClassAttr(pGen->pVm,pName,nLine,iProtection,iFlags\|iTypeFlags);` |
|    487141 |  8936 | `	if( pAttr ){` |
|    487141 |  8937 | `		GenStateConsumeDoc(&(*pGen),&pAttr->sDoc);` |
|    487141 |  8938 | `		if( GenStateConsumeAttrs(&(*pGen),&pAttr->aAttrs) == SXERR_ABORT ){` |
|       ! 0 |  8939 | `			return SXERR_ABORT;` |
|         - |  8940 | `		}` |
|    243568 |  8941 | `	}` |
|    487141 |  8942 | `	if( pAttr == 0 ){` |
|       ! 0 |  8943 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 engine is running out of memory");` |
|       ! 0 |  8944 | `		return SXERR_ABORT;` |
|         - |  8945 | `	}` |
|    487141 |  8946 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|       361 |  8947 | `		GenStateCopyTypeToAttr(pAttr,nType,&sTypeClass,&sTypeText,iTypeFlags,&aUnionAlts);` |
|       178 |  8948 | `	}` |
|    487141 |  8949 | `	if( pGen->pIn->nType & PH7_TK_EQUAL /*'='*/ ){` |
|         - |  8950 | `		SySet *pInstrContainer;` |
|    363375 |  8951 | `		SyToken *pSavedDefEnd = pGen->pEnd;` |
|    363375 |  8952 | `		pGen->pIn++; /*Jump the equal sign */` |
|         - |  8953 | `		{` |
...
|    363375 |  8958 | `			SyToken *pScan = pGen->pIn;` |
|    363375 |  8959 | `			sxi32 iNest = 0;` |
|    796819 |  8960 | `			while( pScan < pGen->pEnd ){` |
|    796819 |  8961 | `				if( pScan->nType & (PH7_TK_LPAREN\|PH7_TK_OSB) ){` |
|     46387 |  8962 | `					iNest++;` |
|    773628 |  8963 | `				}else if( pScan->nType & (PH7_TK_RPAREN\|PH7_TK_CSB) ){` |
|     46387 |  8964 | `					iNest--;` |
|    727246 |  8965 | `				}else if( iNest <= 0 && (pScan->nType & (PH7_TK_SEMI\|PH7_TK_COMMA\|PH7_TK_OCB)) ){` |
|    363375 |  8966 | `					break;` |
|         - |  8967 | `				}` |
|    433449 |  8968 | `				pScan++;` |
|         5 |  8969 | `			}` |
|    363375 |  8970 | `			pGen->pEnd = pScan;` |
|         - |  8971 | `		}` |
|         - |  8972 | `		/* Swap bytecode container */` |
|    363375 |  8973 | `		pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|    363375 |  8974 | `		PH7_VmSetByteCodeContainer(pGen->pVm,&pAttr->aByteCode);` |
|         - |  8975 | `		/* Compile attribute value.` |
|         - |  8976 | `		 */` |
|    363375 |  8977 | `		rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|    363375 |  8978 | `		if( rc == SXERR_EMPTY ){` |
...
|    363375 |  8985 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|    363375 |  8986 | `		PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|    363375 |  8987 | `		pGen->pIn = pGen->pEnd;   /* land exactly on the delimiter */` |
|    363375 |  8988 | `		pGen->pEnd = pSavedDefEnd;` |
|    181685 |  8989 | `	}` |
|         - |  8990 | `	/* All done,install the attribute */` |
|    487141 |  8991 | `	rc = PH7_ClassInstallAttr(pClass,pAttr);` |
|    487141 |  8992 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  8993 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|       ! 0 |  8994 | `		return SXERR_ABORT;` |
|         - |  8995 | `	}` |
|    487141 |  8996 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) ){` |
...
|         - |  9008 | `	}` |
|    487047 |  9009 | `	if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
...
|         - |  9020 | `	}` |
|    487047 |  9021 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA /*','*/) ){` |
...
|         - |  9039 | `		}` |
|       ! 0 |  9040 | `	}` |
|    487043 |  9041 | `	SySetRelease(&aUnionAlts);` |
|    487043 |  9042 | `	return SXRET_OK;` |
|         9 |  9043 | `Synchronize:` |
...
|         - |  9058 | ` */` |
|   2605964 |  9059 | `static sxi32 GenStateCompileClassMethod(` |
...
|         - |  9065 | `	)` |
|         5 |  9066 | `{` |
|   2605969 |  9067 | `	sxu32 nLine = pGen->pIn->nLine;` |
|   2605969 |  9068 | `	sxu32 nKwLine = nLine; /* Line of the 'function' keyword (Reflection getStartLine) */` |
...
|   2605969 |  9075 | `	iProtection = GetProtectionLevel(iProtection);` |
|   2605969 |  9076 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|   2605969 |  9077 | `	iFuncFlags = 0;` |
|   2605969 |  9078 | `	if( pGen->pIn >= pGen->pEnd ){` |
...
|         - |  9086 | `	}` |
|   2605969 |  9087 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|         - |  9088 | `		/* Return by reference,remember that */` |
|       ! 0 |  9089 | `		iFuncFlags \|= VM_FUNC_REF_RETURN;` |
|         - |  9090 | `		/* Jump the '&' token */` |
|       ! 0 |  9091 | `		pGen->pIn++;` |
|       ! 0 |  9092 | `	}` |
|   2605969 |  9093 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|   2605969 |  9102 | `	pName = &pGen->pIn->sData;` |
|   2605969 |  9103 | `	nLine = pGen->pIn->nLine;` |
|         - |  9104 | `	/* Jump the method name */` |
|   2605969 |  9105 | `	pGen->pIn++;` |
|   2605969 |  9106 | `	if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|         - |  9107 | `		/* Abstract method */` |
|    138969 |  9108 | `		if( iProtection == PH7_CLASS_PROT_PRIVATE ){` |
...
|    138969 |  9117 | `		doBody = FALSE;` |
|     69482 |  9118 | `	}` |
|   2605969 |  9119 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|         - |  9120 | `		/* Syntax error */` |
...
|   2605969 |  9129 | `	pMeth = PH7_NewClassMethod(pGen->pVm,pClass,pName,nLine,iProtection,iFlags,iFuncFlags);` |
|   2605969 |  9130 | `	if( pMeth == 0 ){` |
|       ! 0 |  9131 | `		PH7_GenCompileError(&(*pGen),E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|       ! 0 |  9132 | `		return SXERR_ABORT;` |
|         - |  9133 | `	}` |
|   2605969 |  9134 | `	pMeth->sFunc.nLine = nKwLine;` |
|   2605969 |  9135 | `	GenStateConsumeDoc(&(*pGen),&pMeth->sFunc.sDoc);` |
|   2605969 |  9136 | `	if( GenStateConsumeAttrs(&(*pGen),&pMeth->sFunc.aAttrs) == SXERR_ABORT ){` |
|       ! 0 |  9137 | `		return SXERR_ABORT;` |
|         - |  9138 | `	}` |
|         - |  9139 | `	/* Jump the left parenthesis '(' */` |
|   2605969 |  9140 | `	pGen->pIn++;` |
|   2605969 |  9141 | `	pEnd = 0; /* cc warning */` |
|         - |  9142 | `	/* Delimit the method signature */` |
|   2605969 |  9143 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   2605969 |  9144 | `	if( pEnd >= pGen->pEnd ){` |
|         - |  9145 | `		/* Syntax error */` |
...
|         - |  9152 | `	}` |
|         - |  9153 | `	{` |
|   2605967 |  9154 | `		int bIsCtor = 0;` |
|   2605967 |  9155 | `		int bAbstractCtor = 0;` |
|   2605962 |  9156 | `		if( (pName->nByte == sizeof("__construct") - 1` |
|   1534627 |  9157 | `				&& SyMemcmp(pName->zString,"__construct",sizeof("__construct") - 1) == 0)` |
|   2515193 |  9158 | `		 \|\| SyStringCmp(pName,&pClass->sName,SyMemcmp) == 0 ){` |
|    181553 |  9159 | `			if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|         3 |  9160 | `				bAbstractCtor = 1;` |
|         2 |  9161 | `			}else{` |
|    181551 |  9162 | `				bIsCtor = 1;` |
|         - |  9163 | `			}` |
|     90774 |  9164 | `		}` |
|   2605967 |  9165 | `		if( pGen->pIn < pEnd ){` |
|         - |  9166 | `			/* Collect method arguments */` |
|    903505 |  9167 | `			rc = GenStateCollectFuncArgs(&pMeth->sFunc,&(*pGen),pEnd,bIsCtor,bAbstractCtor);` |
|    903505 |  9168 | `			if( rc == SXERR_ABORT ){` |
|       ! 0 |  9169 | `				return SXERR_ABORT;` |
|         - |  9170 | `			}` |
|    451750 |  9171 | `		}` |
|         - |  9172 | `	}` |
|         - |  9173 | `	/* Point past ')' and parse optional return type ': type' */` |
|   2605967 |  9174 | `	pGen->pIn = &pEnd[1];` |
|         - |  9175 | `	{` |
|   2605967 |  9176 | `		sxi32 rcRt = GenStateParseReturnType(pGen, &pMeth->sFunc);` |
|   2605967 |  9177 | `		if( rcRt == SXERR_ABORT ){` |
|       ! 0 |  9178 | `			return SXERR_ABORT;` |
|   2605967 |  9179 | `		}else if( rcRt == SXERR_SYNTAX ){` |
...
|         - |  9186 | `	{` |
|   2605967 |  9187 | `		sxu32 nArg = SySetUsed(&pMeth->sFunc.aArgs);` |
|         - |  9188 | `		sxu32 i;` |
|   3945611 |  9189 | `		for( i = 0; i < nArg; i++ ){` |
|   1339659 |  9190 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pMeth->sFunc.aArgs,i);` |
|         - |  9191 | `			ph7_class_attr *pAttr;` |
|   1339659 |  9192 | `			sxi32 iAttrFlags = 0;` |
|         - |  9193 | `			int bArgTyped;` |
|   1339659 |  9194 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|   1339573 |  9195 | `				continue;` |
|         - |  9196 | `			}` |
...
|        43 |  9291 | `		}` |
|         - |  9292 | `	}` |
|   2605957 |  9293 | `	if( doBody ){` |
|         - |  9294 | `		/* Compile method body */` |
|   2466993 |  9295 | `		rc = GenStateCompileFuncBody(&(*pGen),&pMeth->sFunc);` |
|   2466993 |  9296 | `		if( rc == SXERR_ABORT ){` |
|       ! 0 |  9297 | `			return SXERR_ABORT;` |
|         - |  9298 | `		}` |
|         - |  9299 | `		/* The cursor sits just past the body's closing brace */` |
|   2466993 |  9300 | `		pMeth->sFunc.nEndLine = pGen->pIn[-1].nLine;` |
|   1233499 |  9301 | `	}else{` |
|         - |  9302 | `		/* Abstract/interface method: declaration ends at the ';' */` |
|    138969 |  9303 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI /* ';'*/) ){` |
|    138969 |  9304 | `			pMeth->sFunc.nEndLine = pGen->pIn->nLine;` |
|     69482 |  9305 | `		}` |
|         - |  9306 | `		/* Only method signature is allowed */` |
|    138969 |  9307 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI /* ';'*/) == 0 ){` |
...
|   2605957 |  9318 | `	rc = PH7_ClassInstallMethod(pClass,pMeth);` |
|   2605957 |  9319 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  9320 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|       ! 0 |  9321 | `		return SXERR_ABORT;` |
|         - |  9322 | `	}` |
|   2605957 |  9323 | `	return SXRET_OK;` |
|         6 |  9324 | `Synchronize:` |
...
|         - |  9779 | ` */` |
|     69562 |  9780 | `static sxi32 PH7_CompileClassInterface(ph7_gen_state *pGen)` |
|         5 |  9781 | `{` |
|     69567 |  9782 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|     69567 |  9791 | `	pName = &pGen->pIn->sData;` |
|         - |  9792 | `	/* Advance the stream cursor */` |
|     69567 |  9793 | `	pGen->pIn++;` |
|         - |  9794 | `	/* Build FQN and obtain a raw class */ {` |
|         - |  9795 | `		SyBlob sFQN;` |
|         - |  9796 | `		SyString sFQNStr;` |
|     69567 |  9797 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|     69567 |  9798 | `		GenStateBuildFQN(pGen,pName,&sFQN);` |
|     69567 |  9799 | `		SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|     69567 |  9800 | `		pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|     69567 |  9801 | `		SyBlobRelease(&sFQN);` |
|         - |  9802 | `	}` |
|     69567 |  9803 | `	if( pClass == 0 ){` |
|       ! 0 |  9804 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|       ! 0 |  9805 | `		return SXERR_ABORT;` |
|         - |  9806 | `	}` |
|     69567 |  9807 | `	GenStateConsumeDoc(&(*pGen),&pClass->sDoc);` |
|     69567 |  9808 | `	if( GenStateConsumeAttrs(&(*pGen),&pClass->aAttrs) == SXERR_ABORT ){` |
|       ! 0 |  9809 | `		return SXERR_ABORT;` |
|         - |  9810 | `	}` |
|         - |  9811 | `	/* Mark as an interface (PH7_NewRawClass may have set INTERNAL) */` |
|     69567 |  9812 | `	pClass->iFlags \|= PH7_CLASS_INTERFACE;` |
|         - |  9813 | `	/* Assume no base class is given */` |
|     69567 |  9814 | `	pBase = 0;` |
|     69567 |  9815 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|     27023 |  9816 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|     27023 |  9817 | `		if( nKwrd == PH7_TKWRD_EXTENDS /* interface b extends a, c, … */ ){` |
...
|     27025 |  9828 | `				nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|     27025 |  9829 | `				SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|     27025 |  9830 | `				if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|         - |  9840 | `				}` |
|     40535 |  9841 | `				pParent = PH7_VmExtractClass(pGen->pVm,` |
|     27020 |  9842 | `					(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|     27025 |  9843 | `				SyStringInitFromBuf(&sBaseName,` |
|         - |  9844 | `					(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|         - |  9845 | `				/* Only interfaces is allowed */` |
|     27025 |  9846 | `				while( pParent && (pParent->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|       ! 0 |  9847 | `					pParent = pParent->pNextName;` |
|       ! 0 |  9848 | `				}` |
|     27025 |  9849 | `				if( pParent == 0 ){` |
...
|       ! 0 |  9855 | `					}` |
|     27025 |  9856 | `				}else if( pBase == 0 ){` |
|         - |  9857 | `					/* First parent → single-inheritance base */` |
|     27023 |  9858 | `					pBase = pParent;` |
|     13514 |  9859 | `				}else{` |
...
|         - |  9863 | `				}` |
|     27025 |  9864 | `				SyBlobRelease(&sResolved);` |
|         - |  9865 | `				/* Continue on a comma-separated list */` |
|     27025 |  9866 | `				if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA) ){` |
|         3 |  9867 | `					pGen->pIn++;` |
|         3 |  9868 | `					continue;` |
|         - |  9869 | `				}` |
|     27023 |  9870 | `				break;` |
...
|     13509 |  9872 | `		}` |
|     13509 |  9873 | `	}` |
|     69567 |  9874 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|         - |  9875 | `		/* Syntax error */` |
...
|         - |  9883 | `	}` |
|     69567 |  9884 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|     69567 |  9885 | `	pEnd = 0; /* cc warning */` |
|         - |  9886 | `	/* Delimit the interface body */` |
|     69567 |  9887 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|     69567 |  9888 | `	if( pEnd >= pGen->pEnd ){` |
|         - |  9889 | `		/* Syntax error */` |
...
|     69567 |  9899 | `	pClass->nEndLine = pEnd->nLine;` |
|         - |  9900 | `	/* Swap token stream */` |
|     69567 |  9901 | `	pTmp = pGen->pEnd;` |
|     69567 |  9902 | `	pGen->pEnd = pEnd;` |
...
|    440071 |  9910 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|    185255 |  9911 | `			pGen->pIn++;` |
|         5 |  9912 | `		}` |
|    254821 |  9913 | `		if( pGen->pIn >= pGen->pEnd ){` |
|         - |  9914 | `			/* End of interface body */` |
|     69563 |  9915 | `			break;` |
|         - |  9916 | `		}` |
|         - |  9917 | `		/* Bind a directly-preceding docblock to this member */` |
|    185263 |  9918 | `		GenStateSetPendingDoc(&(*pGen));` |
|    185263 |  9919 | `		if( (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|    185263 |  9930 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    185263 |  9931 | `		if( nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
...
|         3 |  9960 | `			goto done;` |
|         - |  9961 | `		}` |
|    185261 |  9962 | `		if( nKwrd != PH7_TKWRD_PUBLIC && nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|       ! 0 |  9969 | `			goto done;` |
|         - |  9970 | `		}` |
|    185261 |  9971 | `		if( nKwrd == PH7_TKWRD_PUBLIC ){` |
|         - |  9972 | `			/* Advance the stream cursor */` |
|    131231 |  9973 | `			pGen->pIn++;` |
|    131226 |  9974 | `			if( pGen->pIn < pGen->pEnd` |
|    131231 |  9975 | `			 && ((pGen->pIn->nType & PH7_TK_DOLLAR) != 0` |
|    131226 |  9976 | `			  \|\| (pGen->pIn->sData.nByte == 1 && pGen->pIn->sData.zString[0] == '?')) ){` |
...
|       ! 0 |  9990 | `				continue;` |
|         - |  9991 | `			}` |
|    131231 |  9992 | `			if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|       ! 0 | 10014 | `				goto done;` |
|         - | 10015 | `			}` |
|    131231 | 10016 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    131231 | 10017 | `			if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|         - | 10039 | `			}` |
|     65611 | 10040 | `		}` |
|    185257 | 10041 | `		if( nKwrd == PH7_TKWRD_CONST ){` |
|         - | 10042 | `			/* Parse constant */` |
|     54031 | 10043 | `			rc = GenStateCompileClassConstant(&(*pGen),0,0,pClass);` |
|     54031 | 10044 | `			if( rc != SXRET_OK ){` |
...
|         - | 10049 | `			}` |
|     27017 | 10050 | `		}else{` |
|    131231 | 10051 | `			sxi32 iFlags = PH7_CLASS_ATTR_ABSTRACT; /* Interface methods are implicitly abstract */` |
|    131231 | 10052 | `			if( nKwrd == PH7_TKWRD_STATIC ){` |
|         - | 10053 | `				/* Static method,record that */` |
|     11579 | 10054 | `				iFlags \|= PH7_CLASS_ATTR_STATIC;` |
|         - | 10055 | `				/* Advance the stream cursor */` |
|     11579 | 10056 | `				pGen->pIn++;` |
|     11574 | 10057 | `				if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0` |
|     11579 | 10058 | `					\|\| SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_FUNCTION ){` |
...
|    131231 | 10069 | `			rc = GenStateCompileClassMethod(&(*pGen),0,iFlags,FALSE,pClass);` |
|    131231 | 10070 | `			if( rc != SXRET_OK ){` |
...
|     69563 | 10079 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|     69563 | 10080 | `	if( rc == SXRET_OK && pBase ){` |
|         - | 10081 | `		/* Inherit from the base interface */` |
|     27023 | 10082 | `		rc = PH7_ClassInterfaceInherit(pClass,pBase);` |
|     13509 | 10083 | `	}` |
|     69563 | 10084 | `	if( rc != SXRET_OK ){` |
...
|     69567 | 10090 | `	pGen->pIn  = &pEnd[1];` |
|     69567 | 10091 | `	pGen->pEnd = pTmp;` |
|     69567 | 10092 | `	return PH7_OK;` |
|     34786 | 10093 | `}` |
|         - | 10094 | `/*` |
...
|         - | 10118 | ` */` |
|    379940 | 10119 | `static sxi32 GenStateCheckInterfaceSignatures(ph7_gen_state *pGen,ph7_class *pClass)` |
|         5 | 10120 | `{` |
|         - | 10121 | `	ph7_class **apIface;` |
|         - | 10122 | `	sxu32 nIface,i;` |
|         - | 10123 | `	sxi32 rc;` |
|    379945 | 10124 | `	if( pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|       ! 0 | 10125 | `		return SXRET_OK;` |
|         - | 10126 | `	}` |
|    379945 | 10127 | `	apIface = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|    379945 | 10128 | `	nIface = SySetUsed(&pClass->aInterface);` |
|    769951 | 10129 | `	for(i = 0; i < nIface; i++){` |
|    390011 | 10130 | `		ph7_class *pIface = apIface[i];` |
|         - | 10131 | `		SyHashEntry *pEntry;` |
|    390011 | 10132 | `		SyHashResetLoopCursor(&pIface->hMethod);` |
|   1162213 | 10133 | `		while((pEntry = SyHashGetNextEntry(&pIface->hMethod)) != 0 ){` |
|    772207 | 10134 | `			ph7_class_method *pIfaceMeth = (ph7_class_method *)pEntry->pUserData;` |
|         - | 10135 | `			ph7_class_method *pImplMeth;` |
|    772207 | 10136 | `			SyString *pMName = &pIfaceMeth->sFunc.sName;` |
|         - | 10137 | `			/* Find the implementing method in the class */` |
|    772207 | 10138 | `			pImplMeth = PH7_ClassExtractMethod(pClass,pMName->zString,pMName->nByte);` |
|    772207 | 10139 | `			if( pImplMeth == 0 \|\| (pImplMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT) ){` |
...
|    772189 | 10143 | `			if( pImplMeth->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|         - | 10153 | `			 */` |
|         - | 10154 | `			{` |
|    772189 | 10155 | `				sxu32 nIfaceArgs = SySetUsed(&pIfaceMeth->sFunc.aArgs);` |
|    772189 | 10156 | `				sxu32 nImplArgs = SySetUsed(&pImplMeth->sFunc.aArgs);` |
|    772189 | 10157 | `				int sigError = 0;` |
|    772189 | 10158 | `				if( nImplArgs < nIfaceArgs ){` |
|         3 | 10159 | `					sigError = 1;` |
|    772188 | 10160 | `				}else if( nImplArgs > nIfaceArgs ){` |
|         - | 10161 | `					/* Extra parameters must all have default values */` |
|      3867 | 10162 | `					ph7_vm_func_arg *aImplArgs = (ph7_vm_func_arg *)SySetBasePtr(&pImplMeth->sFunc.aArgs);` |
|         - | 10163 | `					sxu32 k;` |
|      7727 | 10164 | `					for(k = nIfaceArgs; k < nImplArgs; k++){` |
|      3867 | 10165 | `						if( SySetUsed(&aImplArgs[k].aByteCode) == 0 ){` |
|         3 | 10166 | `							sigError = 1;` |
|         3 | 10167 | `							break;` |
|         - | 10168 | `						}` |
|      1935 | 10169 | `					}` |
|      1931 | 10170 | `				}` |
|    772189 | 10171 | `				if( sigError ){` |
...
|         - | 10251 | ` */` |
|    379940 | 10252 | `static sxi32 GenStateCheckAbstractMethods(ph7_gen_state *pGen,ph7_class *pClass)` |
|         5 | 10253 | `{` |
...
|    379945 | 10260 | `	if( pClass->iFlags & (PH7_CLASS_ABSTRACT\|PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|     19349 | 10261 | `		return SXRET_OK;` |
|         - | 10262 | `	}` |
|         - | 10263 | `	/* Count abstract methods */` |
|    360601 | 10264 | `	nAbstract = 0;` |
|    360601 | 10265 | `	SyHashResetLoopCursor(&pClass->hMethod);` |
|   5582179 | 10266 | `	while((pEntry = SyHashGetNextEntry(&pClass->hMethod)) != 0 ){` |
|   5041285 | 10267 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|   5041285 | 10268 | `		if( pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
...
|         8 | 10273 | `		}` |
|         5 | 10274 | `	}` |
|    360601 | 10275 | `	if( nAbstract == 0 ){` |
|    360587 | 10276 | `		return SXRET_OK;` |
|         - | 10277 | `	}` |
...
|         - | 10414 | ` */` |
|    453608 | 10415 | `static sxi32 GenStateParseClassReference(ph7_gen_state *pGen,SyBlob *pFqn)` |
|         5 | 10416 | `{` |
|    453613 | 10417 | `	int isAbsolute = 0;` |
|    453613 | 10418 | `	SyToken *pStart = pGen->pIn;` |
|         - | 10419 | `	SyBlob sName;` |
|    453613 | 10420 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) ){` |
|      4467 | 10421 | `		isAbsolute = 1;` |
|      4467 | 10422 | `		pGen->pIn++;` |
|      2231 | 10423 | `	}` |
|    453613 | 10424 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|         9 | 10425 | `		pGen->pIn = pStart;` |
|         9 | 10426 | `		return SXERR_INVALID;` |
|         - | 10427 | `	}` |
|    453607 | 10428 | `	SyBlobInit(&sName,&pGen->pVm->sAllocator);` |
|    453607 | 10429 | `	SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|    453607 | 10430 | `	pGen->pIn++;` |
|    680436 | 10431 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) &&` |
|    226839 | 10432 | `		&pGen->pIn[1] < pGen->pEnd && (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|        24 | 10433 | `		SyBlobAppend(&sName,"\\",1);` |
|        24 | 10434 | `		pGen->pIn++;` |
|        24 | 10435 | `		SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|        24 | 10436 | `		pGen->pIn++;` |
|         2 | 10437 | `	}` |
|    453607 | 10438 | `	if( isAbsolute ){` |
|      4465 | 10439 | `		SyBlobAppend(pFqn,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|      2235 | 10440 | `	}else{` |
|         - | 10441 | `		SyString sRaw;` |
|    449147 | 10442 | `		SyStringInitFromBuf(&sRaw,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|    449147 | 10443 | `		GenStateResolveName(pGen,&sRaw,pFqn);` |
|         - | 10444 | `	}` |
|    453607 | 10445 | `	SyBlobRelease(&sName);` |
|    453607 | 10446 | `	return SXRET_OK;` |
|    226809 | 10447 | `}` |
|         - | 10448 | `/*` |
...
|    181536 | 10456 | `static int GenStateInterfaceIsThrowableAt(ph7_class *pInterface,int iDepth)` |
|         5 | 10457 | `{` |
|         - | 10458 | `	ph7_class **apParent;` |
|         - | 10459 | `	sxu32 n;` |
|    486573 | 10460 | `	while( pInterface ){` |
|    312763 | 10461 | `		if( iDepth > PH7_THROWABLE_WALK_MAX_DEPTH ){` |
|       ! 0 | 10462 | `			return FALSE;` |
|         - | 10463 | `		}` |
|    347505 | 10464 | `		if( pInterface->sName.nByte == sizeof("Throwable")-1 &&` |
|     69484 | 10465 | `			SyMemcmp(pInterface->sName.zString,"Throwable",sizeof("Throwable")-1) == 0 ){` |
|      7731 | 10466 | `			return TRUE;` |
|         - | 10467 | `		}` |
|    305037 | 10468 | `		apParent = (ph7_class **)SySetBasePtr(&pInterface->aInterface);` |
|    305039 | 10469 | `		for( n = 0 ; n < SySetUsed(&pInterface->aInterface) ; ++n ){` |
|         3 | 10470 | `			if( GenStateInterfaceIsThrowableAt(apParent[n],iDepth+1) ){` |
|       ! 0 | 10471 | `				return TRUE;` |
|         - | 10472 | `			}` |
|         2 | 10473 | `		}` |
|    305037 | 10474 | `		pInterface = pInterface->pBase;` |
|    305037 | 10475 | `		iDepth++;` |
|         5 | 10476 | `	}` |
|    173815 | 10477 | `	return FALSE;` |
|     90773 | 10478 | `}` |
|    181534 | 10479 | `static int GenStateInterfaceIsThrowable(ph7_class *pInterface)` |
|         5 | 10480 | `{` |
|    181539 | 10481 | `	return GenStateInterfaceIsThrowableAt(pInterface,0);` |
|         5 | 10482 | `}` |
|         - | 10483 | `/*` |
...
|         - | 10487 | ` */` |
|      7726 | 10488 | `static int GenStateClassIsExceptionOrError(ph7_class *pBase)` |
|         5 | 10489 | `{` |
|      7735 | 10490 | `	while( pBase ){` |
...
|         - | 10511 | ` */` |
|      7770 | 10512 | `static sxi32 GenStateCompileEnumCase(ph7_gen_state *pGen,ph7_class *pClass)` |
|         5 | 10513 | `{` |
|      7775 | 10514 | `	sxu32 nLine = pGen->pIn->nLine;` |
|         - | 10515 | `	SySet *pInstrContainer;` |
|         - | 10516 | `	ph7_class_attr *pCase;` |
|         - | 10517 | `	SyString *pName;` |
|         - | 10518 | `	sxi32 rc;` |
|      7775 | 10519 | `	pGen->pIn++; /* Jump the 'case' keyword */` |
|      7775 | 10520 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|         - | 10527 | `	}` |
|      7775 | 10528 | `	pName = &pGen->pIn->sData;` |
|         - | 10529 | `	/* Cases share the class-constant namespace (php: "Cannot redefine class constant") */` |
|      7775 | 10530 | `	if( SyHashGet(&pClass->hAttr,(const void *)pName->zString,pName->nByte) != 0 ){` |
...
|         - | 10537 | `	}` |
|      7775 | 10538 | `	pCase = PH7_NewClassAttr(pGen->pVm,pName,pGen->pIn->nLine,PH7_CLASS_PROT_PUBLIC,` |
|         - | 10539 | `		PH7_CLASS_ATTR_CONSTANT\|PH7_CLASS_ATTR_ENUMCASE);` |
|      7775 | 10540 | `	if( pCase == 0 ){` |
|       ! 0 | 10541 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|       ! 0 | 10542 | `		return SXERR_ABORT;` |
|         - | 10543 | `	}` |
|      7775 | 10544 | `	GenStateConsumeDoc(&(*pGen),&pCase->sDoc);` |
|      7775 | 10545 | `	if( GenStateConsumeAttrs(&(*pGen),&pCase->aAttrs) == SXERR_ABORT ){` |
|       ! 0 | 10546 | `		return SXERR_ABORT;` |
|         - | 10547 | `	}` |
|      7775 | 10548 | `	pGen->pIn++; /* Jump the case name */` |
|      7775 | 10549 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_EQUAL /* '=' */) ){` |
|      7761 | 10550 | `		if( pClass->nEnumBacking == 0 ){` |
...
|         - | 10557 | `		}` |
|      7757 | 10558 | `		pGen->pIn++; /* Jump the equal sign */` |
|         - | 10559 | `		/* Compile the backing value expression into the case's own container` |
|         - | 10560 | `		 * (same technique as class constants). */` |
|      7757 | 10561 | `		pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|      7757 | 10562 | `		PH7_VmSetByteCodeContainer(pGen->pVm,&pCase->aByteCode);` |
|      7757 | 10563 | `		rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|      7757 | 10564 | `		if( rc == SXERR_EMPTY ){` |
|       ! 0 | 10565 | `			rc = PH7_GenCompileError(pGen,E_ERROR,nLine,` |
|       ! 0 | 10566 | `				"Empty value for enum case %z::%z",&pClass->sName,pName);` |
|       ! 0 | 10567 | `		}` |
|      7757 | 10568 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|      7757 | 10569 | `		PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|      7757 | 10570 | `		if( rc == SXERR_ABORT ){` |
...
|         - | 10581 | `		}` |
|         - | 10582 | `	}` |
|      7771 | 10583 | `	rc = PH7_ClassInstallAttr(pClass,pCase);` |
|      7771 | 10584 | `	if( rc != SXRET_OK ){` |
|       ! 0 | 10585 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|       ! 0 | 10586 | `		return SXERR_ABORT;` |
|         - | 10587 | `	}` |
|      7771 | 10588 | `	SySetPut(&pClass->aEnumCases,(const void *)&pCase);` |
|      7771 | 10589 | `	return SXRET_OK;` |
|         2 | 10590 | `Synchronize:` |
...
|         - | 10605 | ` */` |
|      3886 | 10606 | `static sxi32 GenStateCompileEnumMethods(ph7_gen_state *pGen,ph7_class *pClass)` |
|         5 | 10607 | `{` |
...
|      3891 | 10613 | `	sxi32 rc = SXRET_OK;` |
|      3891 | 10614 | `	nMax = 3*(sxu32)sizeof("function tryFrom(string $value){return __phl_enum_tryfrom('',$value);}")` |
|      3886 | 10615 | `		+ 3*SyStringLength(&pClass->sName) + 64;` |
|      3891 | 10616 | `	zSrc = (char *)SyMemBackendAlloc(&pGen->pVm->sAllocator,nMax);` |
|      3891 | 10617 | `	if( zSrc == 0 ){` |
|       ! 0 | 10618 | `		PH7_GenCompileError(pGen,E_ERROR,pClass->nLine,"Fatal, PH7 is running out of memory");` |
|       ! 0 | 10619 | `		return SXERR_ABORT;` |
|         - | 10620 | `	}` |
|      3891 | 10621 | `	zBack = (pClass->nEnumBacking == MEMOBJ_INT) ? "int" : "string";` |
|      3891 | 10622 | `	if( pClass->nEnumBacking != 0 ){` |
|      5813 | 10623 | `		nSrc = SyBufferFormat(zSrc,nMax,` |
...
|      1936 | 10627 | `			&pClass->sName,zBack,&pClass->sName,zBack,&pClass->sName);` |
|      1941 | 10628 | `	}else{` |
|        24 | 10629 | `		nSrc = SyBufferFormat(zSrc,nMax,` |
|         7 | 10630 | `			"function cases(){return __phl_enum_cases('%z');}",&pClass->sName);` |
|         - | 10631 | `	}` |
|      3891 | 10632 | `	SySetInit(&sToken,&pGen->pVm->sAllocator,sizeof(SyToken));` |
|      3891 | 10633 | `	PH7_TokenizePHP(zSrc,nSrc,pClass->nLine,&sToken,0);` |
|      3891 | 10634 | `	pSaveIn = pGen->pIn;` |
|      3891 | 10635 | `	pSaveEnd = pGen->pEnd;` |
|      3891 | 10636 | `	pGen->pIn = (SyToken *)SySetBasePtr(&sToken);` |
|      3891 | 10637 | `	pGen->pEnd = &pGen->pIn[SySetUsed(&sToken)];` |
|     15521 | 10638 | `	while( pGen->pIn < pGen->pEnd && rc != SXERR_ABORT ){` |
|     11635 | 10639 | `		rc = GenStateCompileClassMethod(&(*pGen),PH7_TKWRD_PUBLIC,PH7_CLASS_ATTR_STATIC,TRUE,pClass);` |
|         5 | 10640 | `	}` |
|      3891 | 10641 | `	pGen->pIn = pSaveIn;` |
|      3891 | 10642 | `	pGen->pEnd = pSaveEnd;` |
|      3891 | 10643 | `	SySetRelease(&sToken);` |
|      3891 | 10644 | `	return (rc == SXERR_ABORT) ? SXERR_ABORT : SXRET_OK;` |
|      1948 | 10645 | `}` |
|         - | 10646 | `/*` |
...
|         - | 10660 | ` */` |
|      3886 | 10661 | `static sxi32 GenStateEnumFinalize(ph7_gen_state *pGen,ph7_class *pClass,sxu32 nLine)` |
|         5 | 10662 | `{` |
|         - | 10663 | `	SyHashEntry *pEntry;` |
|         - | 10664 | `	sxi32 rc;` |
|         - | 10665 | `	sxu32 n;` |
|         - | 10666 | `	/* php: "Enum %s cannot include properties" */` |
|      3891 | 10667 | `	SyHashResetLoopCursor(&pClass->hAttr);` |
|     11661 | 10668 | `	while( (pEntry = SyHashGetNextEntry(&pClass->hAttr)) != 0 ){` |
|      7777 | 10669 | `		ph7_class_attr *pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|      7777 | 10670 | `		if( (pAttr->iFlags & PH7_CLASS_ATTR_CONSTANT) == 0 ){` |
...
|     54409 | 10680 | `	for( n = 0 ; n < SX_ARRAYSIZE(azEnumBannedMagic) ; n++ ){` |
|     75777 | 10681 | `		if( SyHashGet(&pClass->hMethod,(const void *)azEnumBannedMagic[n],` |
|     50523 | 10682 | `			SyStrlen(azEnumBannedMagic[n])) != 0 ){` |
...
|      3891 | 10698 | `		pAttr = PH7_NewClassAttr(pGen->pVm,&sNameProp,nLine,PH7_CLASS_PROT_PUBLIC,` |
|         - | 10699 | `			PH7_CLASS_ATTR_READONLY\|PH7_CLASS_ATTR_TYPED);` |
|      3891 | 10700 | `		if( pAttr == 0 ){` |
|       ! 0 | 10701 | `			PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|       ! 0 | 10702 | `			return SXERR_ABORT;` |
|         - | 10703 | `		}` |
|      3891 | 10704 | `		pAttr->nType = MEMOBJ_STRING;` |
|      3891 | 10705 | `		SyStringInitFromBuf(&pAttr->sTypeName,"string",sizeof("string")-1);` |
|      3891 | 10706 | `		PH7_ClassInstallAttr(pClass,pAttr);` |
|      3891 | 10707 | `		if( pClass->nEnumBacking != 0 ){` |
|      3877 | 10708 | `			pAttr = PH7_NewClassAttr(pGen->pVm,&sValueProp,nLine,PH7_CLASS_PROT_PUBLIC,` |
|         - | 10709 | `				PH7_CLASS_ATTR_READONLY\|PH7_CLASS_ATTR_TYPED);` |
|      3877 | 10710 | `			if( pAttr == 0 ){` |
|       ! 0 | 10711 | `				PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|       ! 0 | 10712 | `				return SXERR_ABORT;` |
|         - | 10713 | `			}` |
|      3877 | 10714 | `			pAttr->nType = pClass->nEnumBacking;` |
|      3877 | 10715 | `			if( pClass->nEnumBacking == MEMOBJ_INT ){` |
|         7 | 10716 | `				SyStringInitFromBuf(&pAttr->sTypeName,"int",sizeof("int")-1);` |
|         4 | 10717 | `			}else{` |
|      3871 | 10718 | `				SyStringInitFromBuf(&pAttr->sTypeName,"string",sizeof("string")-1);` |
|         - | 10719 | `			}` |
|      3877 | 10720 | `			PH7_ClassInstallAttr(pClass,pAttr);` |
|      1936 | 10721 | `		}` |
|         - | 10722 | `	}` |
|      3891 | 10723 | `	return GenStateCompileEnumMethods(&(*pGen),pClass);` |
|      1948 | 10724 | `}` |
|         - | 10725 | `/*` |
...
|         - | 10734 | ` */` |
|    379984 | 10735 | `static sxi32 GenStateCompileClassEx(ph7_gen_state *pGen,sxi32 iFlags,` |
|         - | 10736 | `	SyString *pAnonName,SyToken **ppArgStart,SyToken **ppArgEnd)` |
|         5 | 10737 | `{` |
|    379989 | 10738 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|    379989 | 10749 | `	pGen->pIn++;` |
|    379989 | 10750 | `	if( pAnonName ){` |
...
|        18 | 10765 | `	}else{` |
|    379961 | 10766 | `		if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
|         - | 10767 | `			/* Syntax error */` |
...
|    379961 | 10780 | `		pName = &pGen->pIn->sData;` |
|         - | 10781 | `		/* Advance the stream cursor */` |
|    379961 | 10782 | `		pGen->pIn++;` |
|         - | 10783 | `		/* Build FQN and obtain a raw class */ {` |
|         - | 10784 | `			SyBlob sFQN;` |
|         - | 10785 | `			SyString sFQNStr;` |
|    379961 | 10786 | `			SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|    379961 | 10787 | `			GenStateBuildFQN(pGen,pName,&sFQN);` |
|    379961 | 10788 | `			SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|    379961 | 10789 | `			pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|    379961 | 10790 | `			SyBlobRelease(&sFQN);` |
|         - | 10791 | `		}` |
|         - | 10792 | `	}` |
|    379989 | 10793 | `	if( pClass == 0 ){` |
|       ! 0 | 10794 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|       ! 0 | 10795 | `		return SXERR_ABORT;` |
|         - | 10796 | `	}` |
|    379984 | 10797 | `	if( (iFlags & PH7_CLASS_ENUM) && pGen->pIn < pGen->pEnd` |
|      3895 | 10798 | `		&& (pGen->pIn->nType & PH7_TK_COLON /* ':' */) ){` |
|         - | 10799 | ``		/* Backed enum: `enum Name: int\|string` (PHP 8.1) */`` |
|      3879 | 10800 | `		pGen->pIn++; /* Jump ':' */` |
|      3874 | 10801 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD)` |
|      3879 | 10802 | `			&& SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_INT ){` |
|         7 | 10803 | `			pClass->nEnumBacking = MEMOBJ_INT;` |
|         7 | 10804 | `			pGen->pIn++;` |
|      3872 | 10805 | `		}else if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD)` |
|      3873 | 10806 | `			&& SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_STRING ){` |
|      3871 | 10807 | `			pClass->nEnumBacking = MEMOBJ_STRING;` |
|      3871 | 10808 | `			pGen->pIn++;` |
|      1938 | 10809 | `		}else{` |
...
|         - | 10820 | `		}` |
|      1937 | 10821 | `	}` |
|    379989 | 10822 | `	GenStateConsumeDoc(&(*pGen),&pClass->sDoc);` |
|    379989 | 10823 | `	if( GenStateConsumeAttrs(&(*pGen),&pClass->aAttrs) == SXERR_ABORT ){` |
|       ! 0 | 10824 | `		return SXERR_ABORT;` |
|         - | 10825 | `	}` |
|         - | 10826 | `	/* implemented interfaces and per-use-statement trait containers */` |
|    379989 | 10827 | `	SySetInit(&aInterfaces,&pGen->pVm->sAllocator,sizeof(ph7_class *));` |
|    379989 | 10828 | `	SySetInit(&aUseEntries,&pGen->pVm->sAllocator,sizeof(TraitUseEntry));` |
|         - | 10829 | `	/* Assume a standalone class */` |
|    379989 | 10830 | `	pBase = 0;` |
|    379989 | 10831 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|    312965 | 10832 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    312965 | 10833 | `		if( nKwrd == PH7_TKWRD_EXTENDS /* class b extends a */ ){` |
|         - | 10834 | `			SyBlob sResolved;` |
|         - | 10835 | `			SyString sBaseName;` |
|         - | 10836 | `			sxu32 nRefLine;` |
|    204761 | 10837 | `			if( iFlags & PH7_CLASS_ENUM ){` |
...
|         - | 10843 | `				}` |
|       ! 0 | 10844 | `			}` |
|    204761 | 10845 | `			pGen->pIn++; /* Advance past 'extends' */` |
|    204761 | 10846 | `			nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|    204761 | 10847 | `			SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|    204761 | 10848 | `			if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|         - | 10858 | `			}` |
|    307136 | 10859 | `			pBase = PH7_VmExtractClass(pGen->pVm,` |
|    204754 | 10860 | `				(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|    204759 | 10861 | `			SyStringInitFromBuf(&sBaseName,` |
|         - | 10862 | `				(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|         - | 10863 | `			/* Interfaces are not allowed */` |
|    204759 | 10864 | `			while( pBase && (pBase->iFlags & PH7_CLASS_INTERFACE) ){` |
|       ! 0 | 10865 | `				pBase = pBase->pNextName;` |
|       ! 0 | 10866 | `			}` |
|    204759 | 10867 | `			if( pBase == 0 ){` |
...
|         - | 10873 | `				}` |
|       ! 0 | 10874 | `			}else{` |
|    204759 | 10875 | `				if( pBase->iFlags & PH7_CLASS_ENUM ){` |
...
|    204758 | 10883 | `				}else if( pBase->iFlags & PH7_CLASS_FINAL ){` |
...
|       ! 0 | 10890 | `				}` |
|         - | 10891 | `			}` |
|    204759 | 10892 | `			SyBlobRelease(&sResolved);` |
|    204759 | 10893 | `			if( iFlags & PH7_CLASS_ENUM ){` |
|       ! 0 | 10894 | `				pBase = 0; /* Error already reported: enums have no base class */` |
|       ! 0 | 10895 | `			}` |
|    102377 | 10896 | `		}` |
|    312963 | 10897 | `		if (pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) && SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_IMPLEMENTS ){` |
|         - | 10898 | `			ph7_class *pInterface;` |
|         - | 10899 | `			/* Interface implementation */` |
|    123655 | 10900 | `			pGen->pIn++; /* Advance the stream cursor */` |
|    119709 | 10901 | `			for(;;){` |
|         - | 10902 | `				SyBlob sResolved;` |
|         - | 10903 | `				SyString sIntName;` |
|         - | 10904 | `				sxu32 nRefLine;` |
|    181539 | 10905 | `				nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|    181539 | 10906 | `				SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|    181539 | 10907 | `				if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|       ! 0 | 10915 | `					break;` |
|         - | 10916 | `				}` |
|    363073 | 10917 | `				pInterface = PH7_VmExtractClass(pGen->pVm,` |
|    181534 | 10918 | `					(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|    181539 | 10919 | `				SyStringInitFromBuf(&sIntName,` |
|         - | 10920 | `					(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|         - | 10921 | `				/* Only interfaces are allowed */` |
|    181539 | 10922 | `				while( pInterface && (pInterface->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|       ! 0 | 10923 | `					pInterface = pInterface->pNextName;` |
|       ! 0 | 10924 | `				}` |
|    181539 | 10925 | `				if( pInterface == 0 ){` |
...
|    181539 | 10939 | `					SyString *pFqn = &pClass->sName;` |
|    181539 | 10940 | `					int bIsExceptionOrError =` |
|     94629 | 10941 | `						(pFqn->nByte == sizeof("Exception")-1 &&` |
|    274234 | 10942 | `						 SyMemcmp(pFqn->zString,"Exception",sizeof("Exception")-1) == 0) \|\|` |
|    179612 | 10943 | `						(pFqn->nByte == sizeof("Error")-1 &&` |
|      3872 | 10944 | `						 SyMemcmp(pFqn->zString,"Error",sizeof("Error")-1) == 0);` |
|    185397 | 10945 | `					if( GenStateInterfaceIsThrowable(pInterface) &&` |
|     11592 | 10946 | `						!GenStateClassIsExceptionOrError(pBase) &&` |
|      3861 | 10947 | `						!bIsExceptionOrError ){` |
...
|         6 | 10957 | `					}else{` |
|    181533 | 10958 | `						SySetPut(&aInterfaces,(const void *)&pInterface);` |
|         - | 10959 | `					}` |
|         - | 10960 | `				}` |
|    181539 | 10961 | `				SyBlobRelease(&sResolved);` |
|    181539 | 10962 | `				if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COMMA) == 0 ){` |
|     61830 | 10963 | `					break;` |
|         - | 10964 | `				}` |
|     57889 | 10965 | `				pGen->pIn++;/* Jump the comma */` |
|         5 | 10966 | `			}` |
|     61825 | 10967 | `		}` |
|    156479 | 10968 | `	}` |
|    379987 | 10969 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|         - | 10970 | `		/* Syntax error */` |
...
|         - | 10978 | `	}` |
|    379987 | 10979 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|    379987 | 10980 | `	pEnd = 0; /* cc warning */` |
|         - | 10981 | `	/* Delimit the class body */` |
|    379987 | 10982 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|    379987 | 10983 | `	if( pEnd >= pGen->pEnd ){` |
|         - | 10984 | `		/* Syntax error */` |
...
|    379987 | 10994 | `	pClass->nEndLine = pEnd->nLine;` |
|         - | 10995 | `	/* Swap token stream */` |
|    379987 | 10996 | `	pTmp = pGen->pEnd;` |
|    379987 | 10997 | `	pGen->pEnd = pEnd;` |
|         - | 10998 | `	/* Merge the inherited flags (PH7_NewRawClass may have set INTERNAL) */` |
|    379987 | 10999 | `	pClass->iFlags \|= iFlags;` |
|         - | 11000 | `	/* Start the parse process */` |
|   1512235 | 11001 | `	for(;;){` |
|         - | 11002 | `		/* Jump leading/trailing semi-colons */` |
|   4292245 | 11003 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|    780531 | 11004 | `			pGen->pIn++;` |
|         5 | 11005 | `		}` |
|   3511719 | 11006 | `		if( pGen->pIn >= pGen->pEnd ){` |
|         - | 11007 | `			/* End of class body */` |
|    379945 | 11008 | `			break;` |
|         - | 11009 | `		}` |
|         - | 11010 | `		/* Bind a directly-preceding docblock to this member */` |
|   3131779 | 11011 | `		GenStateSetPendingDoc(&(*pGen));` |
|   3131774 | 11012 | `		if( (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR)) == 0` |
|   1565892 | 11013 | ``			&& !GenStateIsReadonly(pGen->pIn) /* allow a leading `readonly` modifier */ ){`` |
...
|   3131779 | 11024 | `		iProtection = PH7_TKWRD_PUBLIC;` |
|   3131779 | 11025 | `		iAttrflags = 0;` |
...
|   3131779 | 11030 | `		if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|       ! 0 | 11031 | `			int bMod = 0;` |
...
|         - | 11052 | `			}` |
|       ! 0 | 11053 | `		}` |
|   3131779 | 11054 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|         - | 11055 | `			/* Extract the current keyword */` |
|   3131779 | 11056 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   3131779 | 11057 | `			if( nKwrd == PH7_TKWRD_CASE && (pClass->iFlags & PH7_CLASS_ENUM) ){` |
|         - | 11058 | ``				/* Enum case declaration: `case NAME [= value];` */`` |
|      7775 | 11059 | `				rc = GenStateCompileEnumCase(&(*pGen),pClass);` |
|      7775 | 11060 | `				if( rc != SXRET_OK ){` |
...
|      7771 | 11066 | `				continue;` |
|         - | 11067 | `			}` |
|   3124009 | 11068 | `			if( nKwrd == PH7_TKWRD_USE ){` |
|         - | 11069 | `				/* Trait use: use TraitA, TraitB [{ ... }]; */` |
|         - | 11070 | `				TraitUseEntry sUse;` |
|     15517 | 11071 | `				SySetInit(&sUse.aTraits,&pGen->pVm->sAllocator,sizeof(ph7_class *));` |
|     15517 | 11072 | `				sUse.pResolvStart = sUse.pResolvEnd = 0;` |
|     15517 | 11073 | `				pGen->pIn++; /* Jump the 'use' keyword */` |
|      7764 | 11074 | `				for(;;){` |
|         - | 11075 | `					ph7_class *pTrait;` |
|         - | 11076 | `					SyBlob sResolved;` |
|         - | 11077 | `					SyString sTraitName;` |
|     15525 | 11078 | `					sxu32 nUseLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
...
|     15525 | 11085 | `					SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|     15525 | 11086 | `					if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|       ! 0 | 11093 | `						break;` |
|         - | 11094 | `					}` |
|     31045 | 11095 | `					pTrait = PH7_VmExtractClass(pGen->pVm,` |
|     15520 | 11096 | `						(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|     15525 | 11097 | `					SyStringInitFromBuf(&sTraitName,` |
|         - | 11098 | `						(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|         - | 11099 | `					/* Only traits are allowed */` |
|     15525 | 11100 | `					while( pTrait && (pTrait->iFlags & PH7_CLASS_TRAIT) == 0 ){` |
|       ! 0 | 11101 | `						pTrait = pTrait->pNextName;` |
|       ! 0 | 11102 | `					}` |
|     15525 | 11103 | `					if( pTrait == 0 ){` |
...
|         - | 11109 | `						}` |
|       ! 0 | 11110 | `					}else{` |
|     15525 | 11111 | `						SySetPut(&sUse.aTraits,(const void *)&pTrait);` |
|         - | 11112 | `					}` |
|     15525 | 11113 | `					SyBlobRelease(&sResolved);` |
...
|     15525 | 11116 | `					if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COMMA) == 0 ){` |
|      7761 | 11117 | `						break;` |
|         - | 11118 | `					}` |
|        10 | 11119 | `					pGen->pIn++; /* Jump the comma */` |
|         2 | 11120 | `				}` |
|         - | 11121 | `				/* Expect semicolon or opening brace (for conflict resolution) */` |
|     15517 | 11122 | `				if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OCB) ){` |
...
|         - | 11132 | `					}` |
|         5 | 11133 | `				}` |
|     15517 | 11134 | `				SySetPut(&aUseEntries,(const void *)&sUse);` |
|         - | 11135 | `				/* The semicolon will be consumed by the outer loop */` |
|     15517 | 11136 | `				continue;` |
|         - | 11137 | `			}` |
|   3108497 | 11138 | `			if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|         - | 11139 | `				int nSetTok;` |
|   2814787 | 11140 | `				sxi32 nSetVis = GenStatePeekSetVisibility(pGen->pIn,pGen->pEnd,&nSetTok);` |
|   2814787 | 11141 | `				if( nSetVis ){` |
...
|         2 | 11146 | `				}else{` |
|   2814785 | 11147 | `					iProtection = nKwrd;` |
|   2814785 | 11148 | `					pGen->pIn++; /* Jump the visibility token */` |
|         - | 11149 | `					/* Optional asymmetric set-visibility after the read` |
|         - | 11150 | ``					 * visibility: `public private(set) int $x`. */`` |
|   2814785 | 11151 | `					nSetVis = GenStatePeekSetVisibility(pGen->pIn,pGen->pEnd,&nSetTok);` |
|   2814785 | 11152 | `					if( nSetVis ){` |
...
|   2814787 | 11159 | `				if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|        28 | 11160 | `					iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|        28 | 11161 | `					pGen->pIn++; /* Jump the 'readonly' modifier */` |
|        12 | 11162 | `				}` |
|   2814782 | 11163 | `				if( pGen->pIn >= pGen->pEnd` |
|   2814787 | 11164 | `					\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|       ! 0 | 11172 | `					goto done;` |
|         - | 11173 | `				}` |
|   2814787 | 11174 | `				if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|         - | 11175 | `					/* Attribute declaration (untyped) */` |
|    436587 | 11176 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|    436587 | 11177 | `					if( rc != SXRET_OK ){` |
|        11 | 11178 | `						if( rc == SXERR_ABORT ){` |
|       ! 0 | 11179 | `							return SXERR_ABORT;` |
|         - | 11180 | `						}` |
|        11 | 11181 | `						goto done;` |
|         - | 11182 | `					}` |
|    436740 | 11183 | `					continue;` |
|         - | 11184 | `				}` |
|   2378205 | 11185 | `				if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|   2377877 | 11197 | `				nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   1188936 | 11198 | `			}` |
|   2671587 | 11199 | `			if( nKwrd == PH7_TKWRD_CONST ){` |
|         - | 11200 | `				/* Process constant declaration */` |
|    285657 | 11201 | `				rc = GenStateCompileClassConstant(&(*pGen),iProtection,iAttrflags,pClass);` |
|    285657 | 11202 | `				if( rc != SXRET_OK ){` |
...
|         - | 11207 | `				}` |
|    142827 | 11208 | `			}else{` |
|   2385935 | 11209 | `				if( nKwrd == PH7_TKWRD_STATIC ){` |
|         - | 11210 | `					/* Static method or attribute,record that */` |
|     96637 | 11211 | `					iAttrflags \|= PH7_CLASS_ATTR_STATIC;` |
|     96637 | 11212 | `					pGen->pIn++; /* Jump the static keyword */` |
|     96637 | 11213 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|         - | 11214 | `						int nSetTok;` |
|     69593 | 11215 | `						sxi32 nSetVis = GenStatePeekSetVisibility(pGen->pIn,pGen->pEnd,&nSetTok);` |
|     69593 | 11216 | `						if( nSetVis ){` |
...
|     69591 | 11222 | `							nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|     69591 | 11223 | `							if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
...
|     96637 | 11237 | `					if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|       ! 0 | 11238 | `						iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|       ! 0 | 11239 | `						pGen->pIn++; /* Jump the 'readonly' modifier */` |
|       ! 0 | 11240 | `					}` |
|     96632 | 11241 | `					if( pGen->pIn >= pGen->pEnd` |
|     96637 | 11242 | `						\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|       ! 0 | 11250 | `						goto done;` |
|         - | 11251 | `					}` |
|     96637 | 11252 | `					if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|         - | 11253 | `						/* Attribute declaration */` |
|     27045 | 11254 | `						rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|     27045 | 11255 | `						if( rc != SXRET_OK ){` |
|         3 | 11256 | `							if( rc == SXERR_ABORT ){` |
|       ! 0 | 11257 | `								return SXERR_ABORT;` |
|         - | 11258 | `							}` |
|         3 | 11259 | `							goto done;` |
|         - | 11260 | `						}` |
|     27043 | 11261 | `						continue;` |
|         - | 11262 | `					}` |
|     69597 | 11263 | `					if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|     69581 | 11275 | `					nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   2324091 | 11276 | `				}else if( nKwrd == PH7_TKWRD_ABSTRACT ){` |
|         - | 11277 | `					/* Abstract method,record that */` |
|      7743 | 11278 | `					iAttrflags \|= PH7_CLASS_ATTR_ABSTRACT;` |
|         - | 11279 | `					/* Mark the whole class as abstract */` |
|      7743 | 11280 | `					pClass->iFlags \|= PH7_CLASS_ABSTRACT;` |
|         - | 11281 | `					/* Advance the stream cursor */` |
|      7743 | 11282 | `					pGen->pIn++;` |
|      7743 | 11283 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|      7743 | 11284 | `						nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|      7743 | 11285 | `						if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|      7741 | 11286 | `							iProtection = nKwrd;` |
|      7741 | 11287 | `							pGen->pIn++; /* Jump the visibility token */` |
|      3868 | 11288 | `						}` |
|      3869 | 11289 | `					}` |
|      7743 | 11290 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|      7738 | 11291 | `						SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_STATIC ){` |
|         - | 11292 | `							/* Static method */` |
|       ! 0 | 11293 | `							iAttrflags \|= PH7_CLASS_ATTR_STATIC;` |
|       ! 0 | 11294 | `							pGen->pIn++; /* Jump the static keyword */` |
|       ! 0 | 11295 | `					}` |
|      7743 | 11296 | `					if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 \|\|` |
|      7738 | 11297 | `						SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_FUNCTION ){` |
...
|       ! 0 | 11322 | `							goto done;` |
|         - | 11323 | `					}` |
|      7737 | 11324 | `					nKwrd = PH7_TKWRD_FUNCTION;` |
|   2285431 | 11325 | `				}else if( nKwrd == PH7_TKWRD_FINAL ){` |
...
|         3 | 11369 | `				}` |
|   2358861 | 11370 | `				if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_VAR ){` |
...
|       ! 0 | 11378 | `						goto done;` |
|         - | 11379 | `				}` |
|   2358861 | 11380 | `				if( nKwrd == PH7_TKWRD_VAR ){` |
...
|   2358855 | 11395 | `					rc = GenStateCompileClassMethod(&(*pGen),iProtection,iAttrflags,TRUE,pClass);` |
|         - | 11396 | `				}` |
|   2358861 | 11397 | `				if( rc != SXRET_OK ){` |
...
|         - | 11420 | `		sxu32 nU;` |
|    379945 | 11421 | `		apUse = (TraitUseEntry *)SySetBasePtr(&aUseEntries);` |
|    395457 | 11422 | `		for( nU = 0 ; nU < SySetUsed(&aUseEntries) ; nU++ ){` |
|     15517 | 11423 | `			TraitUseEntry *pUse = &apUse[nU];` |
|     15517 | 11424 | `			ph7_class **apTrait = (ph7_class **)SySetBasePtr(&pUse->aTraits);` |
|     15517 | 11425 | `			sxu32 nTraits = SySetUsed(&pUse->aTraits);` |
|     15517 | 11426 | `			int hasResolution = (pUse->pResolvStart && pUse->pResolvStart < pUse->pResolvEnd) ? 1 : 0;` |
|         - | 11427 | `			sxu32 nT;` |
|     15517 | 11428 | `			if( !hasResolution ){` |
|         - | 11429 | `				/* No conflict resolution block: use standard trait application */` |
|     31015 | 11430 | `				for( nT = 0 ; nT < nTraits ; nT++ ){` |
|     15513 | 11431 | `					rc = PH7_ClassUseTrait(&(*pGen),pClass,apTrait[nT]);` |
|     15513 | 11432 | `					if( rc != SXRET_OK ){` |
|       ! 0 | 11433 | `						break;` |
|         - | 11434 | `					}` |
|      7759 | 11435 | `				}` |
|      7756 | 11436 | `			}else{` |
...
|         3 | 11624 | `				}` |
|         - | 11625 | `			}` |
|     15517 | 11626 | `			SySetRelease(&pUse->aTraits);` |
|      7761 | 11627 | `		}` |
|         - | 11628 | `	}` |
|    379945 | 11629 | `	if( pClass->iFlags & PH7_CLASS_ENUM ){` |
...
|      3891 | 11632 | `		rc = GenStateEnumFinalize(&(*pGen),pClass,nLine);` |
|      3891 | 11633 | `		if( rc == SXERR_ABORT ){` |
...
|    379945 | 11640 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|    379945 | 11641 | `	if( rc == SXRET_OK ){` |
|         - | 11642 | `		ph7_class **apInterface;` |
|         - | 11643 | `		sxu32 n;` |
|    379945 | 11644 | `		if( pBase ){` |
|         - | 11645 | `			/* Inherit from base class and mark as a subclass */` |
|    204757 | 11646 | `			rc = PH7_ClassInherit(&(*pGen),pClass,pBase);` |
|    102376 | 11647 | `		}` |
|    379945 | 11648 | `		apInterface = (ph7_class **)SySetBasePtr(&aInterfaces);` |
|    561473 | 11649 | `		for( n = 0 ; n < SySetUsed(&aInterfaces) ; n++ ){` |
|         - | 11650 | `			/* Implements one or more interface */` |
|    181533 | 11651 | `			rc = PH7_ClassImplement(pClass,apInterface[n]);` |
|    181533 | 11652 | `			if( rc != SXRET_OK ){` |
|       ! 0 | 11653 | `				break;` |
|         - | 11654 | `			}` |
|     90769 | 11655 | `		}` |
...
|    379945 | 11658 | `		if( rc == SXRET_OK && (pClass->iFlags & PH7_CLASS_ENUM) ){` |
|      3891 | 11659 | `			ph7_class *pIntf = PH7_VmExtractClass(pGen->pVm,"UnitEnum",sizeof("UnitEnum")-1,FALSE,0);` |
|      3891 | 11660 | `			while( pIntf && (pIntf->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|       ! 0 | 11661 | `				pIntf = pIntf->pNextName;` |
|       ! 0 | 11662 | `			}` |
|      3891 | 11663 | `			if( pIntf ){` |
|      3891 | 11664 | `				PH7_ClassImplement(pClass,pIntf);` |
|      1943 | 11665 | `			}` |
|      3891 | 11666 | `			if( pClass->nEnumBacking != 0 ){` |
|      3877 | 11667 | `				pIntf = PH7_VmExtractClass(pGen->pVm,"BackedEnum",sizeof("BackedEnum")-1,FALSE,0);` |
|      3877 | 11668 | `				while( pIntf && (pIntf->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|       ! 0 | 11669 | `					pIntf = pIntf->pNextName;` |
|       ! 0 | 11670 | `				}` |
|      3877 | 11671 | `				if( pIntf ){` |
|      3877 | 11672 | `					PH7_ClassImplement(pClass,pIntf);` |
|      1936 | 11673 | `				}` |
|      1936 | 11674 | `			}` |
|      1943 | 11675 | `		}` |
...
|    379940 | 11678 | `		if( rc == SXRET_OK` |
|    379940 | 11679 | `		 && (pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT)) == 0` |
|    379945 | 11680 | `		 && SyHashGet(&pClass->hMethod,"__toString",sizeof("__toString")-1) != 0 ){` |
|    208443 | 11681 | `			ph7_class *pStringable = PH7_VmExtractClass(pGen->pVm,` |
|         - | 11682 | `				"Stringable",sizeof("Stringable")-1,FALSE,0);` |
|    208443 | 11683 | `			if( pStringable ){` |
|    208443 | 11684 | `				ph7_class **apImpl = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|    208443 | 11685 | `				sxu32 nImpl = SySetUsed(&pClass->aInterface);` |
|         - | 11686 | `				sxu32 i;` |
|    208443 | 11687 | `				int bAlready = 0;` |
|    254743 | 11688 | `				for( i = 0 ; i < nImpl ; i++ ){` |
|     54023 | 11689 | `					if( apImpl[i] == pStringable ){` |
|      7723 | 11690 | `						bAlready = 1;` |
|      7723 | 11691 | `						break;` |
|         - | 11692 | `					}` |
|     23155 | 11693 | `				}` |
|    208443 | 11694 | `				if( !bAlready ){` |
|    200725 | 11695 | `					PH7_ClassImplement(pClass,pStringable);` |
|    100360 | 11696 | `				}` |
|    104219 | 11697 | `			}` |
|    104219 | 11698 | `		}` |
|         - | 11699 | `		/* Validate interface method signatures (visibility and parameter count) */` |
|    379945 | 11700 | `		if( rc == SXRET_OK ){` |
|    379945 | 11701 | `			sxi32 rcCheck = GenStateCheckInterfaceSignatures(&(*pGen),pClass);` |
|    379945 | 11702 | `			if( rcCheck == SXERR_ABORT ){` |
...
|    379945 | 11709 | `		if( rc == SXRET_OK ){` |
|    379945 | 11710 | `			sxi32 rcCheck = GenStateCheckAbstractMethods(&(*pGen),pClass);` |
|    379945 | 11711 | `			if( rcCheck == SXERR_ABORT ){` |
...
|    189970 | 11716 | `		}` |
|    189970 | 11717 | `	}` |
|    379945 | 11718 | `	SySetRelease(&aUseEntries);` |
|    379945 | 11719 | `	SySetRelease(&aInterfaces);` |
|    379945 | 11720 | `	if( rc != SXRET_OK ){` |
...
|    379987 | 11726 | `	pGen->pIn = &pEnd[1];` |
|    379987 | 11727 | `	pGen->pEnd = pTmp;` |
|    379987 | 11728 | `	return PH7_OK;` |
|    189997 | 11729 | `}` |
|         - | 11730 | `/* Compile a named class declaration (the common case). */` |
|    379956 | 11731 | `static sxi32 GenStateCompileClass(ph7_gen_state *pGen,sxi32 iFlags)` |
|         5 | 11732 | `{` |
|    379961 | 11733 | `	return GenStateCompileClassEx(pGen,iFlags,0,0,0);` |
|         5 | 11734 | `}` |
|         - | 11735 | `/*` |
...
|         - | 11834 | ` */` |
|  13397582 | 11835 | `static int GenStateTokenIsClassModifier(SyToken *pTok,sxi32 *piFlag)` |
|         5 | 11836 | `{` |
|  13397587 | 11837 | `	if( pTok->nType & PH7_TK_KEYWORD ){` |
|   7857929 | 11838 | `		sxu32 nKw = (sxu32)SX_PTR_TO_INT(pTok->pUserData);` |
|   7857929 | 11839 | `		if( nKw == PH7_TKWRD_FINAL ){ *piFlag = PH7_CLASS_FINAL; return TRUE; }` |
|   7811587 | 11840 | `		if( nKw == PH7_TKWRD_ABSTRACT ){ *piFlag = PH7_CLASS_ABSTRACT; return TRUE; }` |
|   3886448 | 11841 | `	}` |
|  13312559 | 11842 | `	if( GenStateIsReadonly(pTok) ){ *piFlag = PH7_CLASS_READONLY; return TRUE; }` |
|  13312499 | 11843 | `	return FALSE;` |
|   6698796 | 11844 | `}` |
|         - | 11845 | `/*` |
...
|         - | 11850 | ` */` |
|  13312494 | 11851 | `static sxi32 GenStateScanClassModifiers(SyToken **ppIn,SyToken *pEnd,SyToken **ppDup)` |
|         5 | 11852 | `{` |
|  13312499 | 11853 | `	SyToken *pIn = *ppIn,*pDup = 0;` |
|  13312499 | 11854 | `	sxi32 iFlags = 0,iFlag;` |
|  13397587 | 11855 | `	while( pIn < pEnd && GenStateTokenIsClassModifier(pIn,&iFlag) ){` |
|     85093 | 11856 | `		if( (iFlags & iFlag) && pDup == 0 ){` |
|         5 | 11857 | `			pDup = pIn;` |
|         2 | 11858 | `		}` |
|     85093 | 11859 | `		iFlags \|= iFlag;` |
|     85093 | 11860 | `		pIn++;` |
|         5 | 11861 | `	}` |
|  13312499 | 11862 | `	*ppIn = pIn;` |
|  13312499 | 11863 | `	if( ppDup ){ *ppDup = pDup; }` |
|  13312499 | 11864 | `	return iFlags;` |
|         5 | 11865 | `}` |
|         - | 11866 | `/*` |
...
|         - | 11872 | ` */` |
|  13273818 | 11873 | `static int GenStateStartsModifiedClass(SyToken *pIn,SyToken *pEnd)` |
|         5 | 11874 | `{` |
|  13273823 | 11875 | `	sxi32 iFlags = GenStateScanClassModifiers(&pIn,pEnd,0);` |
|   6683308 | 11876 | `	return iFlags != 0 && pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD)` |
|  13297016 | 11877 | `		&& (sxu32)SX_PTR_TO_INT(pIn->pUserData) == PH7_TKWRD_CLASS;` |
|         5 | 11878 | `}` |
|         - | 11879 | `/*` |
...
|         - | 11885 | ` */` |
|     38676 | 11886 | `static sxi32 PH7_CompileClassModifiers(ph7_gen_state *pGen)` |
|         5 | 11887 | `{` |
|         - | 11888 | `	SyToken *pDup;` |
|     38681 | 11889 | `	sxi32 iFlags = GenStateScanClassModifiers(&pGen->pIn,pGen->pEnd,&pDup);` |
|         - | 11890 | `	sxi32 rc;` |
|     38681 | 11891 | `	if( pDup ){` |
...
|         - | 11896 | `		}` |
|         1 | 11897 | `	}` |
|     38676 | 11898 | `	if( (iFlags & (PH7_CLASS_FINAL\|PH7_CLASS_ABSTRACT))` |
|     19343 | 11899 | `		== (PH7_CLASS_FINAL\|PH7_CLASS_ABSTRACT) ){` |
...
|         - | 11904 | `		}` |
|         1 | 11905 | `	}` |
|     38681 | 11906 | `	return GenStateCompileClass(&(*pGen),iFlags);` |
|     19343 | 11907 | `}` |
|         - | 11908 | `/*` |
...
|         - | 11913 | ` */` |
|      7804 | 11914 | `static sxi32 PH7_CompileTrait(ph7_gen_state *pGen)` |
|         5 | 11915 | `{` |
|      7809 | 11916 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|      7809 | 11925 | `	pGen->pIn++;` |
|      7809 | 11926 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
...
|      7809 | 11937 | `	pName = &pGen->pIn->sData;` |
|      7809 | 11938 | `	pGen->pIn++;` |
|         - | 11939 | `	/* Build FQN and obtain a raw class */ {` |
|         - | 11940 | `		SyBlob sFQN;` |
|         - | 11941 | `		SyString sFQNStr;` |
|      7809 | 11942 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|      7809 | 11943 | `		GenStateBuildFQN(pGen,pName,&sFQN);` |
|      7809 | 11944 | `		SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|      7809 | 11945 | `		pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|      7809 | 11946 | `		SyBlobRelease(&sFQN);` |
|         - | 11947 | `	}` |
|      7809 | 11948 | `	if( pClass == 0 ){` |
|       ! 0 | 11949 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|       ! 0 | 11950 | `		return SXERR_ABORT;` |
|         - | 11951 | `	}` |
|      7809 | 11952 | `	GenStateConsumeDoc(&(*pGen),&pClass->sDoc);` |
|      7809 | 11953 | `	if( GenStateConsumeAttrs(&(*pGen),&pClass->aAttrs) == SXERR_ABORT ){` |
|       ! 0 | 11954 | `		return SXERR_ABORT;` |
|         - | 11955 | `	}` |
|         - | 11956 | `	/* Traits cannot extend or implement; expect opening brace directly */` |
|      7809 | 11957 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_OCB) == 0 ){` |
...
|         - | 11964 | `	}` |
|      7809 | 11965 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|      7809 | 11966 | `	pEnd = 0;` |
|      7809 | 11967 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB,PH7_TK_CCB,&pEnd);` |
|      7809 | 11968 | `	if( pEnd >= pGen->pEnd ){` |
...
|      7809 | 11977 | `	pClass->nEndLine = pEnd->nLine;` |
|         - | 11978 | `	/* Swap token stream */` |
|      7809 | 11979 | `	pTmp = pGen->pEnd;` |
|      7809 | 11980 | `	pGen->pEnd = pEnd;` |
|         - | 11981 | `	/* Mark as trait (PH7_NewRawClass may have set INTERNAL) */` |
|      7809 | 11982 | `	pClass->iFlags \|= PH7_CLASS_TRAIT;` |
|         - | 11983 | `	/* Parse the body: same as a normal class (methods, attributes, visibility modifiers) */` |
|     56031 | 11984 | `	for(;;){` |
|    158417 | 11985 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|     23183 | 11986 | `			pGen->pIn++;` |
|         5 | 11987 | `		}` |
|    135239 | 11988 | `		if( pGen->pIn >= pGen->pEnd ){` |
|      7809 | 11989 | `			break;` |
|         - | 11990 | `		}` |
|         - | 11991 | `		/* Bind a directly-preceding docblock to this member */` |
|    127435 | 11992 | `		GenStateSetPendingDoc(&(*pGen));` |
|    127435 | 11993 | `		if( (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR)) == 0 ){` |
...
|       ! 0 | 12000 | `			goto done;` |
|         - | 12001 | `		}` |
|    127435 | 12002 | `		iProtection = PH7_TKWRD_PUBLIC;` |
|    127435 | 12003 | `		iAttrflags = 0;` |
|    127435 | 12004 | `		if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|    127435 | 12005 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    127435 | 12006 | `			if( nKwrd == PH7_TKWRD_USE ){` |
...
|         5 | 12047 | `				continue;` |
|         - | 12048 | `			}` |
|    127431 | 12049 | `			if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|    127413 | 12050 | `				iProtection = nKwrd;` |
|    127413 | 12051 | `				pGen->pIn++;` |
...
|    127413 | 12055 | `				if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|         3 | 12056 | `					iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|         3 | 12057 | `					pGen->pIn++; /* Jump the 'readonly' modifier */` |
|         1 | 12058 | `				}` |
|    127408 | 12059 | `				if( pGen->pIn >= pGen->pEnd` |
|    127413 | 12060 | `					\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|       ! 0 | 12067 | `					goto done;` |
|         - | 12068 | `				}` |
|    127413 | 12069 | `				if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|     23165 | 12070 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|     23165 | 12071 | `					if( rc != SXRET_OK ){` |
|       ! 0 | 12072 | `						if( rc == SXERR_ABORT ){` |
|       ! 0 | 12073 | `							return SXERR_ABORT;` |
|         - | 12074 | `						}` |
|       ! 0 | 12075 | `						goto done;` |
|         - | 12076 | `					}` |
|     23165 | 12077 | `					continue;` |
|         - | 12078 | `				}` |
|    104253 | 12079 | `				if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|         7 | 12087 | `					continue;` |
|         - | 12088 | `				}` |
|    104247 | 12089 | `				nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|     52121 | 12090 | `			}` |
|    104265 | 12091 | `			if( nKwrd == PH7_TKWRD_CONST ){` |
...
|       ! 0 | 12097 | `				goto done;` |
|       ! 0 | 12098 | `			}else{` |
|    104265 | 12099 | `				if( nKwrd == PH7_TKWRD_STATIC ){` |
|      7731 | 12100 | `					iAttrflags \|= PH7_CLASS_ATTR_STATIC;` |
|      7731 | 12101 | `					pGen->pIn++;` |
|      7731 | 12102 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|      7729 | 12103 | `						nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|      7729 | 12104 | `						if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|       ! 0 | 12105 | `							iProtection = nKwrd;` |
|       ! 0 | 12106 | `							pGen->pIn++;` |
|       ! 0 | 12107 | `						}` |
|      3862 | 12108 | `					}` |
|      7726 | 12109 | `					if( pGen->pIn >= pGen->pEnd` |
|      7731 | 12110 | `						\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|       ! 0 | 12117 | `						goto done;` |
|         - | 12118 | `					}` |
|      7731 | 12119 | `					if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
...
|         3 | 12127 | `						continue;` |
|         - | 12128 | `					}` |
|      7729 | 12129 | `					if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|       ! 0 | 12137 | `						continue;` |
|         - | 12138 | `					}` |
|      7729 | 12139 | `					nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    100401 | 12140 | `				}else if( nKwrd == PH7_TKWRD_ABSTRACT ){` |
...
|         3 | 12161 | `				}` |
|    104263 | 12162 | `				if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_VAR ){` |
...
|       ! 0 | 12169 | `					goto done;` |
|         - | 12170 | `				}` |
|    104263 | 12171 | `				if( nKwrd == PH7_TKWRD_VAR ){` |
|       ! 0 | 12172 | `					pGen->pIn++;` |
...
|       ! 0 | 12182 | `				}else{` |
|    104263 | 12183 | `					rc = GenStateCompileClassMethod(&(*pGen),iProtection,iAttrflags,TRUE,pClass);` |
|         - | 12184 | `				}` |
|    104263 | 12185 | `				if( rc != SXRET_OK ){` |
...
|      7809 | 12203 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|      7809 | 12204 | `	if( rc != SXRET_OK ){` |
...
|      7809 | 12210 | `	pGen->pIn = &pEnd[1];` |
|      7809 | 12211 | `	pGen->pEnd = pTmp;` |
|      7809 | 12212 | `	return PH7_OK;` |
|      3907 | 12213 | `}` |
|         - | 12214 | `/*` |
...
|         - | 12222 | ` */` |
|    337390 | 12223 | `static sxi32 PH7_CompileClass(ph7_gen_state *pGen)` |
|         5 | 12224 | `{` |
|         - | 12225 | `	sxi32 rc;` |
|    337395 | 12226 | `	rc = GenStateCompileClass(&(*pGen),0);` |
|    337395 | 12227 | `	return rc;` |
|         5 | 12228 | `}` |
|         - | 12229 | `/*` |
...
|         - | 12235 | ` */` |
|  13227426 | 12236 | `static int GenStateStartsEnumDecl(SyToken *pIn,SyToken *pEnd)` |
|         5 | 12237 | `{` |
|  13436461 | 12238 | `	return (pIn->nType & PH7_TK_ID)` |
|   6822743 | 12239 | `		&& pIn->sData.nByte == sizeof("enum")-1` |
|    218813 | 12240 | `		&& SyStrnicmp(pIn->sData.zString,"enum",sizeof("enum")-1) == 0` |
|  13436456 | 12241 | `		&& &pIn[1] < pEnd && (pIn[1].nType & PH7_TK_ID);` |
|         5 | 12242 | `}` |
|         - | 12243 | `/*` |
...
|         - | 12248 | ` */` |
|      3890 | 12249 | `static sxi32 PH7_CompileEnum(ph7_gen_state *pGen)` |
|         5 | 12250 | `{` |
|      3895 | 12251 | `	return GenStateCompileClass(&(*pGen),PH7_CLASS_ENUM\|PH7_CLASS_FINAL);` |
|         5 | 12252 | `}` |
|         - | 12253 | `/*` |
...
|         - | 12274 | ` */` |
|    513538 | 12275 | `static sxi32 GenStateThrowNodeValidator(ph7_gen_state *pGen,ph7_expr_node *pRoot)` |
|         5 | 12276 | `{` |
|    513543 | 12277 | `	sxi32 rc = SXRET_OK;` |
|    513543 | 12278 | `	if( pRoot->pOp ){` |
|    513531 | 12279 | `		switch( pRoot->pOp->iOp ){` |
|    256763 | 12280 | `		case EXPR_OP_NEW:            /* new Exception() */` |
...
|       ! 0 | 12296 | `			break;` |
|         - | 12297 | `		}` |
|    256780 | 12298 | `	}else if( pRoot->xCode != PH7_CompileVariable ){` |
...
|         - | 12312 | ` */` |
|    513502 | 12313 | `static sxi32 PH7_CompileThrow(ph7_gen_state *pGen)` |
|         5 | 12314 | `{` |
|    513507 | 12315 | `	sxu32 nLine = pGen->pIn->nLine;` |
|         - | 12316 | `	GenBlock *pBlock;` |
|         - | 12317 | `	sxu32 nIdx;` |
|         - | 12318 | `	sxi32 rc;` |
|    513507 | 12319 | `	pGen->pIn++; /* Jump the 'throw' keyword */` |
|         - | 12320 | `	/* Compile the expression */` |
|    513507 | 12321 | `	rc = PH7_CompileExpr(&(*pGen),0,GenStateThrowNodeValidator);` |
|    513507 | 12322 | `	if( rc == SXERR_EMPTY ){` |
...
|         - | 12328 | `	}` |
|    513507 | 12329 | `	pBlock = pGen->pCurrent;` |
|         - | 12330 | `	/* Point to the top most function or try block and emit the forward jump */` |
|   2045541 | 12331 | `	while(pBlock->pParent){` |
|   2045537 | 12332 | `		if( pBlock->iFlags & (GEN_BLOCK_EXCEPTION\|GEN_BLOCK_FUNC) ){` |
|    513503 | 12333 | `			break;` |
|         - | 12334 | `		}` |
|         - | 12335 | `		/* Point to the parent block */` |
|   1532039 | 12336 | `		pBlock = pBlock->pParent;` |
|         5 | 12337 | `	}` |
|         - | 12338 | `	/* Emit the throw instruction */` |
|    513507 | 12339 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_THROW,0,0,0,&nIdx);` |
|         - | 12340 | `	/* Emit the jump */` |
|    513507 | 12341 | `	GenStateNewJumpFixup(pBlock,PH7_OP_THROW,nIdx);` |
|    513507 | 12342 | `	return SXRET_OK;` |
|    256756 | 12343 | `}` |
|         - | 12344 | `/*` |
...
|         - | 12588 | ` */` |
|     24692 | 12589 | `static sxi32 PH7_CompileCatch(ph7_gen_state *pGen,ph7_exception *pException)` |
|         5 | 12590 | `{` |
|     24697 | 12591 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|         - | 12598 | `	char *zDup;` |
|         - | 12599 | `	sxi32 rc;` |
|     24697 | 12600 | `	pGen->pIn++; /* Jump the 'catch' keyword */` |
|         - | 12601 | `	/* Zero the structure */` |
|     24697 | 12602 | `	SyZero(&sCatch,sizeof(ph7_exception_block));` |
|         - | 12603 | `	/* Initialize fields */` |
|     24697 | 12604 | `	SySetInit(&sCatch.aClasses,&pException->pVm->sAllocator,sizeof(SyString));` |
|     24697 | 12605 | `	SySetInit(&sCatch.sByteCode,&pException->pVm->sAllocator,sizeof(VmInstr));` |
|     24697 | 12606 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 /*(*/ ){` |
...
|     24697 | 12621 | `	pGen->pIn++; /* Jump the left parenthesis '(' */` |
|     12361 | 12622 | `	for(;;){` |
|         - | 12623 | `		SyBlob sResolved;` |
|     24727 | 12624 | `		SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|     24727 | 12625 | `		if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|     37082 | 12641 | `		zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|     24718 | 12642 | `			(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|     24723 | 12643 | `		SyStringInitFromBuf(&sClassName,zDup,SyBlobLength(&sResolved));` |
|     24723 | 12644 | `		SyBlobRelease(&sResolved);` |
|     24723 | 12645 | `		if( zDup == 0 ){` |
|       ! 0 | 12646 | `			goto Mem;` |
|         - | 12647 | `		}` |
|     24723 | 12648 | `		rc = SySetPut(&sCatch.aClasses,(const void *)&sClassName);` |
|     24723 | 12649 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 12650 | `			goto Mem;` |
|         - | 12651 | `		}` |
|         - | 12652 | `		/* Check for '\|' (multi-catch separator) */` |
|     24718 | 12653 | `		if( pGen->pIn < pGen->pEnd &&` |
|     24718 | 12654 | `			(pGen->pIn->nType & PH7_TK_OP) &&` |
...
|     24693 | 12665 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_RPAREN) /*)*/ ){` |
|         5 | 12666 | `		goto CatchBody;` |
|         - | 12667 | `	}` |
|     24684 | 12668 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 /*$*/ \|\|` |
|     24689 | 12669 | `		&pGen->pIn[1] >= pGen->pEnd \|\| (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|         - | 12682 | `	}` |
|     24689 | 12683 | `	pGen->pIn++; /* Jump the dollar sign */` |
|         - | 12684 | `	/* Duplicate instance name */` |
|     24689 | 12685 | `	pName = &pGen->pIn->sData;` |
|     24689 | 12686 | `	zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|     24689 | 12687 | `	if( zDup == 0 ){` |
|       ! 0 | 12688 | `		goto Mem;` |
|         - | 12689 | `	}` |
|     24689 | 12690 | `	SyStringInitFromBuf(&sCatch.sThis,zDup,pName->nByte);` |
|     24689 | 12691 | `	pGen->pIn++;` |
|     12344 | 12692 | `CatchBody:` |
|     24693 | 12693 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_RPAREN) == 0 /*)*/ ){` |
...
|     24693 | 12708 | `	pGen->pIn++; /* Jump the right parenthesis */` |
|         - | 12709 | `	/* Create the catch block */` |
|     24693 | 12710 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_EXCEPTION,PH7_VmInstrLength(pGen->pVm),0,&pCatch);` |
|     24693 | 12711 | `	if( rc != SXRET_OK ){` |
|       ! 0 | 12712 | `		return SXERR_ABORT;` |
|         - | 12713 | `	}` |
|         - | 12714 | `	/* Swap bytecode container */` |
|     24693 | 12715 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|     24693 | 12716 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&sCatch.sByteCode);` |
|         - | 12717 | `	/* Compile the block */` |
|     24693 | 12718 | `	PH7_CompileBlock(&(*pGen),0);` |
|         - | 12719 | `	/* Fix forward jumps now the destination is resolved  */` |
|     24693 | 12720 | `	GenStateFixJumps(pCatch,-1,PH7_VmInstrLength(pGen->pVm));` |
|         - | 12721 | `	/* Emit the DONE instruction */` |
|     24693 | 12722 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|         - | 12723 | `	/* Leave the block */` |
|     24693 | 12724 | `	GenStateLeaveBlock(&(*pGen),0);` |
|         - | 12725 | `	/* Restore the default container */` |
|     24693 | 12726 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|         - | 12727 | `	/* Install the catch block */` |
|     24693 | 12728 | `	rc = SySetPut(&pException->sEntry,(const void *)&sCatch);` |
|     24693 | 12729 | `	if( rc != SXRET_OK ){` |
|       ! 0 | 12730 | `		goto Mem;` |
|         - | 12731 | `	}` |
|     24693 | 12732 | `	return SXRET_OK;` |
|       ! 0 | 12733 | `Mem:` |
...
|         - | 12742 | ` * is "thrown".` |
|         - | 12743 | ` */` |
|     24850 | 12744 | `static sxi32 PH7_CompileTry(ph7_gen_state *pGen)` |
|         5 | 12745 | `{` |
|         - | 12746 | `	ph7_exception *pException;` |
|     24855 | 12747 | `	sxu32 nLine = pGen->pIn->nLine;` |
|         - | 12748 | `	GenBlock *pTry;` |
|         - | 12749 | `	sxu32 nJmpIdx;` |
|         - | 12750 | `	sxi32 rc;` |
|         - | 12751 | `	/* Create the exception container */` |
|     24855 | 12752 | `	pException = (ph7_exception *)SyMemBackendAlloc(&pGen->pVm->sAllocator,sizeof(ph7_exception));` |
|     24855 | 12753 | `	if( pException == 0 ){` |
...
|     24855 | 12759 | `	SyZero(pException,sizeof(ph7_exception));` |
|         - | 12760 | `	/* Initialize fields */` |
|     24855 | 12761 | `	SySetInit(&pException->sEntry,&pGen->pVm->sAllocator,sizeof(ph7_exception_block));` |
|     24855 | 12762 | `	SySetInit(&pException->sFinally,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|     24855 | 12763 | `	pException->iHasFinally = 0;` |
|     24855 | 12764 | `	pException->iFinallyDone = 0;` |
|     24855 | 12765 | `	pException->pVm = pGen->pVm;` |
...
|     24855 | 12772 | `	if( pGen->bInGenerator && pGen->pVm->bInlineTryCatch ){` |
|       105 | 12773 | `		return PH7_CompileTryInline(&(*pGen),pException);` |
|         - | 12774 | `	}` |
|         - | 12775 | `	/* Create the try block */` |
|     24755 | 12776 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_EXCEPTION,PH7_VmInstrLength(pGen->pVm),0,&pTry);` |
|     24755 | 12777 | `	if( rc != SXRET_OK ){` |
|       ! 0 | 12778 | `		return SXERR_ABORT;` |
|         - | 12779 | `	}` |
|         - | 12780 | `	/* Store exception pointer so break/continue can emit POP_EXCEPTION */` |
|     24755 | 12781 | `	pTry->pUserData = pException;` |
|         - | 12782 | `	/* Emit the 'LOAD_EXCEPTION' instruction */` |
|     24755 | 12783 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_EXCEPTION,0,0,pException,&nJmpIdx);` |
|         - | 12784 | `	/* Fix the jump later when the destination is resolved */` |
|     24755 | 12785 | `	GenStateNewJumpFixup(pTry,PH7_OP_LOAD_EXCEPTION,nJmpIdx);` |
|     24755 | 12786 | `	pGen->pIn++; /* Jump the 'try' keyword */` |
|         - | 12787 | `	/* Compile the block */` |
|     24755 | 12788 | `	rc = PH7_CompileBlock(&(*pGen),0);` |
|     24755 | 12789 | `	if( rc == SXERR_ABORT ){` |
|       ! 0 | 12790 | `		return SXERR_ABORT;` |
|         - | 12791 | `	}` |
|         - | 12792 | `	/* Fix forward jumps now the destination is resolved */` |
|     24755 | 12793 | `	GenStateFixJumps(pTry,-1,PH7_VmInstrLength(pGen->pVm));` |
|         - | 12794 | `	/* Emit the 'POP_EXCEPTION' instruction */` |
|     24755 | 12795 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP_EXCEPTION,0,0,pException,0);` |
|         - | 12796 | `	/* Leave the block */` |
|     24755 | 12797 | `	GenStateLeaveBlock(&(*pGen),0);` |
|         - | 12798 | `	/* Compile catch block(s) — at least one catch or finally is required */` |
|     24755 | 12799 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|     24748 | 12800 | `		SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_CATCH ){` |
|         - | 12801 | `		/* Compile one or more catch blocks */` |
|     24688 | 12802 | `		for(;;){` |
|     49376 | 12803 | `			if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0` |
|     37089 | 12804 | `				\|\| SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_CATCH ){` |
|     12347 | 12805 | `					break;` |
|         - | 12806 | `			}` |
|     24697 | 12807 | `			rc = PH7_CompileCatch(&(*pGen),pException);` |
|     24697 | 12808 | `			if( rc == SXERR_ABORT ){` |
|       ! 0 | 12809 | `				return SXERR_ABORT;` |
|         - | 12810 | `			}` |
|         5 | 12811 | `		}` |
|     12342 | 12812 | `	}` |
|         - | 12813 | `	/* Compile optional finally block */` |
|     24755 | 12814 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
...
|     24755 | 12844 | `	if( SySetUsed(&pException->sEntry) == 0 && !pException->iHasFinally ){` |
...
|         - | 12849 | `		}` |
|         3 | 12850 | `	}` |
|     24755 | 12851 | `	return SXRET_OK;` |
|     12430 | 12852 | `}` |
|         - | 12853 | `/*` |
|         - | 12854 | ` * Compile a switch block.` |
|         - | 12855 | ` *  (See block-comment below for more information)` |
|         - | 12856 | ` */` |
|     54124 | 12857 | `static sxi32 GenStateCompileSwitchBlock(ph7_gen_state *pGen,sxu32 iTokenDelim,sxu32 *pBlockStart)` |
|         5 | 12858 | `{` |
|     54129 | 12859 | `	sxi32 rc = SXRET_OK;` |
|     54129 | 12860 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & (PH7_TK_SEMI/*';'*/\|PH7_TK_COLON/*':'*/)) == 0 ){` |
...
|       ! 0 | 12866 | `		pGen->pIn++;` |
|       ! 0 | 12867 | `	}` |
|     54129 | 12868 | `	pGen->pIn++;` |
|         - | 12869 | `	/* First instruction to execute in this block. */` |
|     54129 | 12870 | `	*pBlockStart = PH7_VmInstrLength(pGen->pVm);` |
|         - | 12871 | `	/* Compile the block until we hit a case/default/endswitch keyword` |
|         - | 12872 | `	 * or the '}' token */` |
|     38786 | 12873 | `	for(;;){` |
|     77577 | 12874 | `		if( pGen->pIn >= pGen->pEnd ){` |
|         - | 12875 | `			/* No more input to process */` |
|       ! 0 | 12876 | `			break;` |
|         - | 12877 | `		}` |
|     77577 | 12878 | `		rc = SXRET_OK;` |
|     77577 | 12879 | `		if( (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
|      3943 | 12880 | `			if( pGen->pIn->nType & PH7_TK_CCB /*'}' */ ){` |
|      3889 | 12881 | `				if( iTokenDelim != PH7_TK_CCB ){` |
...
|         - | 12888 | `					/* FALL THROUGH */` |
|       ! 0 | 12889 | `				}` |
|      3889 | 12890 | `				rc = SXERR_EOF;` |
|      3889 | 12891 | `				break;` |
|         - | 12892 | `			}` |
|        32 | 12893 | `		}else{` |
|         - | 12894 | `			sxi32 nKwrd;` |
|         - | 12895 | `			/* Extract the keyword */` |
|     73639 | 12896 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|     73639 | 12897 | `			if( nKwrd == PH7_TKWRD_CASE \|\| nKwrd == PH7_TKWRD_DEFAULT ){` |
|     25124 | 12898 | `				break;` |
|         - | 12899 | `			}` |
|     23401 | 12900 | `			if( nKwrd == PH7_TKWRD_ENDSWITCH /* endswitch; */){` |
...
|         - | 12913 | `		}` |
|         - | 12914 | `		/* Compile block */` |
|     23453 | 12915 | `		rc = PH7_CompileBlock(&(*pGen),0);` |
|     23453 | 12916 | `		if( rc == SXERR_ABORT ){` |
|       ! 0 | 12917 | `			return SXERR_ABORT;` |
|         - | 12918 | `		}` |
|         5 | 12919 | `	}` |
|     54129 | 12920 | `	return rc;` |
|     27067 | 12921 | `}` |
|         - | 12922 | `/*` |
|         - | 12923 | ` * Compile a case eXpression.` |
|         - | 12924 | ` *  (See block-comment below for more information)` |
|         - | 12925 | ` */` |
|     54104 | 12926 | `static sxi32 GenStateCompileCaseExpr(ph7_gen_state *pGen,ph7_case_expr *pExpr)` |
|         5 | 12927 | `{` |
|         - | 12928 | `	SySet *pInstrContainer;` |
|         - | 12929 | `	SyToken *pEnd,*pTmp;` |
|     54109 | 12930 | `	sxi32 iNest = 0;` |
|         - | 12931 | `	sxi32 rc;` |
|         - | 12932 | `	/* Delimit the expression */` |
|     54109 | 12933 | `	pEnd = pGen->pIn;` |
|    108221 | 12934 | `	while( pEnd < pGen->pEnd ){` |
|    108221 | 12935 | `		if( pEnd->nType & PH7_TK_LPAREN /*(*/ ){` |
|         - | 12936 | `			/* Increment nesting level */` |
|         3 | 12937 | `			iNest++;` |
|    108220 | 12938 | `		}else if( pEnd->nType & PH7_TK_RPAREN /*)*/ ){` |
|         - | 12939 | `			/* Decrement nesting level */` |
|         3 | 12940 | `			iNest--;` |
|    108218 | 12941 | `		}else if( pEnd->nType & (PH7_TK_SEMI/*';'*/\|PH7_TK_COLON/*;'*/) && iNest < 1 ){` |
|     54109 | 12942 | `			break;` |
|         - | 12943 | `		}` |
|     54117 | 12944 | `		pEnd++;` |
|         5 | 12945 | `	}` |
|     54109 | 12946 | `	if( pGen->pIn >= pEnd ){` |
...
|     54109 | 12954 | `	pTmp = pGen->pEnd;` |
|     54109 | 12955 | `	pGen->pEnd = pEnd;` |
|     54109 | 12956 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|     54109 | 12957 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pExpr->aByteCode);` |
|     54109 | 12958 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|         - | 12959 | `	/* Emit the done instruction */` |
|     54109 | 12960 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,(rc != SXERR_EMPTY ? 1 : 0),0,0,0);` |
|     54109 | 12961 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|         - | 12962 | `	/* Update token stream */` |
|     54109 | 12963 | `	pGen->pIn  = pEnd;` |
|     54109 | 12964 | `	pGen->pEnd = pTmp;` |
|     54109 | 12965 | `	if( rc == SXERR_ABORT ){` |
|       ! 0 | 12966 | `		return SXERR_ABORT;` |
|         - | 12967 | `	}` |
|     54109 | 12968 | `	return SXRET_OK;` |
|     27057 | 12969 | `}` |
|         - | 12970 | `/*` |
...
|         - | 12994 | ` */` |
|      3886 | 12995 | `static sxi32 PH7_CompileSwitch(ph7_gen_state *pGen)` |
|         5 | 12996 | `{` |
...
|         - | 13001 | `	sxu32 nLine;` |
|         - | 13002 | `	sxi32 rc;` |
|      3891 | 13003 | `	nLine = pGen->pIn->nLine;` |
|         - | 13004 | `	/* Jump the 'switch' keyword */` |
|      3891 | 13005 | `	pGen->pIn++;` |
|      3891 | 13006 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|         - | 13007 | `		/* Syntax error */` |
...
|      3891 | 13016 | `	pGen->pIn++;` |
|      3891 | 13017 | `	pEnd = 0; /* cc warning */` |
|         - | 13018 | `	/* Create the loop block */` |
|      5834 | 13019 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP\|GEN_BLOCK_SWITCH,` |
|      1943 | 13020 | `		PH7_VmInstrLength(pGen->pVm),0,&pSwitchBlock);` |
|      3891 | 13021 | `	if( rc != SXRET_OK ){` |
|       ! 0 | 13022 | `		return SXERR_ABORT;` |
|         - | 13023 | `	}` |
|         - | 13024 | `	/* Delimit the condition */` |
|      3891 | 13025 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|      3891 | 13026 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|       ! 0 | 13050 | `		pGen->pIn++;` |
|       ! 0 | 13051 | `	}` |
|      3891 | 13052 | `	pGen->pIn  = &pEnd[1];` |
|      3891 | 13053 | `	pGen->pEnd = pTmp;` |
|      3891 | 13054 | `	if( pGen->pIn >= pGen->pEnd \|\| &pGen->pIn[1] >= pGen->pEnd \|\|` |
|      3886 | 13055 | `		(pGen->pIn->nType & (PH7_TK_OCB/*'{'*/\|PH7_TK_COLON/*:*/)) == 0 ){` |
...
|      3891 | 13068 | `	if( pGen->pIn->nType & PH7_TK_COLON ){` |
|         3 | 13069 | `		nToken = PH7_TK_KEYWORD;` |
|         - | 13070 | `		/* Stop compilation when the 'endswitch;' keyword is seen */` |
|         2 | 13071 | `	}else{` |
|      3889 | 13072 | `		nToken = PH7_TK_CCB; /* '}' */` |
|         - | 13073 | `	}` |
|      3891 | 13074 | `	pGen->pIn++; /* Jump the leading curly braces/colons */` |
|         - | 13075 | `	/* Create the switch blocks container */` |
|      3891 | 13076 | `	pSwitch = (ph7_switch *)SyMemBackendAlloc(&pGen->pVm->sAllocator,sizeof(ph7_switch));` |
|      3891 | 13077 | `	if( pSwitch == 0 ){` |
...
|      3891 | 13083 | `	SyZero(pSwitch,sizeof(ph7_switch));` |
|         - | 13084 | `	/* Initialize fields */` |
|      3891 | 13085 | `	SySetInit(&pSwitch->aCaseExpr,&pGen->pVm->sAllocator,sizeof(ph7_case_expr));` |
|         - | 13086 | `	/* Emit the switch instruction */` |
|      3891 | 13087 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_SWITCH,0,0,pSwitch,0);` |
|         - | 13088 | `	/* Compile case blocks */` |
|     52183 | 13089 | `	for(;;){` |
|         - | 13090 | `		sxu32 nKwrd;` |
|     54131 | 13091 | `		if( pGen->pIn >= pGen->pEnd ){` |
|         - | 13092 | `			/* No more input to process */` |
|       ! 0 | 13093 | `			break;` |
|         - | 13094 | `		}` |
|     54131 | 13095 | `		if( (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|     54131 | 13109 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|     54131 | 13110 | `		if( nKwrd == PH7_TKWRD_ENDSWITCH /* endswitch; */){` |
...
|         3 | 13121 | `			break;` |
|         - | 13122 | `		}` |
|     54129 | 13123 | `		if( nKwrd == PH7_TKWRD_DEFAULT ){` |
|         - | 13124 | `			/*` |
...
|        23 | 13142 | `				break;` |
|         1 | 13143 | `			}` |
|     54110 | 13144 | `		}else if( nKwrd == PH7_TKWRD_CASE ){` |
|         - | 13145 | `			ph7_case_expr sCase;` |
|         - | 13146 | `			/* Standard case block */` |
|     54109 | 13147 | `			pGen->pIn++; /* Jump the 'case' keyword */` |
|         - | 13148 | `			/* initialize the structure */` |
|     54109 | 13149 | `			SySetInit(&sCase.aByteCode,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|         - | 13150 | `			/* Compile the case expression */` |
|     54109 | 13151 | `			rc = GenStateCompileCaseExpr(pGen,&sCase);` |
|     54109 | 13152 | `			if( rc == SXERR_ABORT ){` |
|       ! 0 | 13153 | `				return SXERR_ABORT;` |
|         - | 13154 | `			}` |
|         - | 13155 | `			/* Compile the case block */` |
|     54109 | 13156 | `			rc = GenStateCompileSwitchBlock(pGen,nToken,&sCase.nStart);` |
|         - | 13157 | `			/* Insert in the switch container */` |
|     54109 | 13158 | `			SySetPut(&pSwitch->aCaseExpr,(const void *)&sCase);` |
|     54109 | 13159 | `			if( rc == SXERR_ABORT){` |
|       ! 0 | 13160 | `				return SXERR_ABORT;` |
|     54109 | 13161 | `			}else if( rc == SXERR_EOF ){` |
|      3871 | 13162 | `				break;` |
|         - | 13163 | `			}` |
|     25124 | 13164 | `		}else{` |
...
|      3891 | 13175 | `	pSwitch->nOut = PH7_VmInstrLength(pGen->pVm);` |
|      3891 | 13176 | `	GenStateFixJumps(pSwitchBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|         - | 13177 | `	/* Release the loop block */` |
|      3891 | 13178 | `	GenStateLeaveBlock(pGen,0);` |
|      3891 | 13179 | `	if( pGen->pIn < pGen->pEnd ){` |
|         - | 13180 | `		/* Jump the trailing curly braces or the endswitch keyword*/` |
|      3891 | 13181 | `		pGen->pIn++;` |
|      1943 | 13182 | `	}` |
|         - | 13183 | `	/* Statement successfully compiled */` |
|      3891 | 13184 | `	return SXRET_OK;` |
|       ! 0 | 13185 | `Synchronize:` |
...
|         - | 13207 | ` */` |
|  50217602 | 13208 | `static void GenStatePatchNullsafeJumps(ph7_gen_state *pGen, sxu32 nBaseline)` |
|         5 | 13209 | `{` |
|  50217607 | 13210 | `	sxu32 nCur = SySetUsed(&pGen->aNullsafeJmp);` |
|         - | 13211 | `	sxu32 nTarget;` |
|         - | 13212 | `	sxu32 *aIdx;` |
|         - | 13213 | `	sxu32 i;` |
|  50217607 | 13214 | `	if( nCur <= nBaseline ){` |
|  50217511 | 13215 | `		return;` |
|         - | 13216 | `	}` |
...
|         - | 13244 | ` */` |
|   6477590 | 13245 | `static sxu32 GenStateByRefBuiltinMask(SyString *pName)` |
|         5 | 13246 | `{` |
...
|         - | 13262 | `	};` |
|         - | 13263 | `	sxu32 i;` |
|   6477595 | 13264 | `	if( pName == 0 \|\| pName->zString == 0 \|\| pName->nByte == 0 ){` |
|   1741103 | 13265 | `		return 0;` |
|         - | 13266 | `	}` |
|  51621901 | 13267 | `	for( i = 0 ; i < SX_ARRAYSIZE(aByRef) ; ++i ){` |
|  46943428 | 13268 | `		if( pName->nByte == aByRef[i].nByte` |
|  24858637 | 13269 | `		 && SyStrnicmp(pName->zString, aByRef[i].zName, pName->nByte) == 0 ){` |
|     58029 | 13270 | `			return aByRef[i].mask;` |
|         - | 13271 | `		}` |
|  23442707 | 13272 | `	}` |
|   4678473 | 13273 | `	return 0;` |
|   3238800 | 13274 | `}` |
|         - | 13275 | `/*` |
...
|         - | 13284 | ` */` |
|   6477590 | 13285 | `static void GenStateCallBuiltinName(ph7_expr_node *pLeft, SyString *pOut)` |
|         5 | 13286 | `{` |
|         - | 13287 | `	SyToken *p, *pEnd;` |
|   6477595 | 13288 | `	pOut->zString = 0;` |
|   6477595 | 13289 | `	pOut->nByte = 0;` |
|   6477595 | 13290 | `	if( pLeft == 0 \|\| pLeft->pStart == 0 \|\| pLeft->pEnd == 0 ){` |
|       ! 0 | 13291 | `		return;` |
|         - | 13292 | `	}` |
|   6477595 | 13293 | `	p = pLeft->pStart;` |
|   6477595 | 13294 | `	pEnd = pLeft->pEnd;` |
|         - | 13295 | `	/* Optional single leading namespace separator (absolute path). */` |
|   6477595 | 13296 | `	if( p < pEnd && (p->nType & PH7_TK_NSSEP) ){` |
|      3901 | 13297 | `		p++;` |
|      1948 | 13298 | `	}` |
|   6477595 | 13299 | `	if( p >= pEnd \|\| (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|   1741059 | 13300 | `		return;` |
|         - | 13301 | `	}` |
|         - | 13302 | `	/* Must be a single component: nothing follows the name token. */` |
|   4736541 | 13303 | `	if( p + 1 != pEnd ){` |
|        49 | 13304 | `		return;` |
|         - | 13305 | `	}` |
|   4736497 | 13306 | `	*pOut = p->sData;` |
|   3238800 | 13307 | `}` |
|         - | 13308 | `/*` |
...
|         - | 13313 | ` * error message.` |
|         - | 13314 | ` */` |
|  70324676 | 13315 | `static sxi32 GenStateEmitExprCode(` |
...
|         - | 13322 | `	sxu32 nJmpIdx;` |
|  70324681 | 13323 | `	sxi32 iP1 = 0;` |
|  70324681 | 13324 | `	sxu32 iP2 = 0;` |
|  70324681 | 13325 | `	void *p3  = 0;` |
|         - | 13326 | `	sxi32 iVmOp;` |
|         - | 13327 | `	sxi32 rc;` |
|  70324681 | 13328 | `	int bIsChainOp = 0; /* Set below once we know pNode->pOp */` |
|  70324681 | 13329 | ``	int bFcc = 0;       /* First-class callable `f(...)`: emit OP_LOAD_FCC, not OP_CALL */`` |
|  70324681 | 13330 | `	sxu32 nRhsNsBase = 0;` |
|  70324681 | 13331 | `	if( pNode->xCode ){` |
|         - | 13332 | `		SyToken *pTmpIn,*pTmpEnd;` |
|         - | 13333 | `		/* Compile node */` |
|  42357591 | 13334 | `		SWAP_DELIMITER(pGen,pNode->pStart,pNode->pEnd);` |
|  42357591 | 13335 | `		rc = pNode->xCode(&(*pGen),iFlags);` |
|  42357591 | 13336 | `		RE_SWAP_DELIMITER(pGen);` |
|  42357591 | 13337 | `		return rc;` |
|         - | 13338 | `	}` |
|  27967095 | 13339 | `	if( pNode->pOp == 0 ){` |
...
|         - | 13343 | `	}` |
|  27967095 | 13344 | `	iVmOp = pNode->pOp->iVmOp;` |
|  27967095 | 13345 | `	if( iVmOp == PH7_OP_CVT_NULL ){` |
...
|         - | 13353 | `		}` |
|         1 | 13354 | `	}` |
|  27967095 | 13355 | `	if( pNode->pOp->iOp == EXPR_OP_NULLC_ASSIGN ){` |
...
|         - | 13404 | `	}` |
|  27967005 | 13405 | `	if( pNode->pOp->iOp == EXPR_OP_QUESTY ){` |
...
|    466351 | 13410 | `		nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|    466351 | 13411 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pCond,iFlags);` |
|    466351 | 13412 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 13413 | `			return rc;` |
|         - | 13414 | `		}` |
...
|    466351 | 13418 | `		GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|    466351 | 13419 | `		nJz = nJmp = 0; /* cc -O6 warning */` |
|    466351 | 13420 | `		if( pNode->pLeft ){` |
|         - | 13421 | `			/* Standard ternary: (expr) ? (then) : (else) */` |
|         - | 13422 | `			/* Phase#2: Emit the false jump (pops condition) */` |
|    462423 | 13423 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nJz);` |
|         - | 13424 | `			/* Phase#3: Compile the 'then' expression  */` |
|    462423 | 13425 | `			nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|    462423 | 13426 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pLeft,iFlags);` |
|    462423 | 13427 | `			if( rc != SXRET_OK ){` |
|       ! 0 | 13428 | `				return rc;` |
|         - | 13429 | `			}` |
|    462423 | 13430 | `			GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|    231214 | 13431 | `		}else{` |
...
|      3933 | 13435 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_DUP,0,0,0,0);` |
|      3933 | 13436 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nJz);` |
|         - | 13437 | `		}` |
|         - | 13438 | `		/* Phase#4: Emit the unconditional jump */` |
|    466351 | 13439 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,0,0,&nJmp);` |
|         - | 13440 | `		/* Phase#5: Fix the false jump now the jump destination is resolved. */` |
|    466351 | 13441 | `		pInstr = PH7_VmGetInstr(pGen->pVm,nJz);` |
|    466351 | 13442 | `		if( pInstr ){` |
|    466351 | 13443 | `			pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    233173 | 13444 | `		}` |
|    466351 | 13445 | `		if( !pNode->pLeft ){` |
|         - | 13446 | `			/* Elvis operator: discard the falsy condition value before evaluating 'else' */` |
|      3933 | 13447 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|      1964 | 13448 | `		}` |
|         - | 13449 | `		/* Phase#6: Compile the 'else' expression */` |
|    466351 | 13450 | `		if( pNode->pRight ){` |
|    466351 | 13451 | `			nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|    466351 | 13452 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pRight,iFlags);` |
|    466351 | 13453 | `			if( rc != SXRET_OK ){` |
|       ! 0 | 13454 | `				return rc;` |
|         - | 13455 | `			}` |
|    466351 | 13456 | `			GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|    233173 | 13457 | `		}` |
|    466351 | 13458 | `		if( nJmp > 0 ){` |
|         - | 13459 | `			/* Phase#7: Fix the unconditional jump */` |
|    466351 | 13460 | `			pInstr = PH7_VmGetInstr(pGen->pVm,nJmp);` |
|    466351 | 13461 | `			if( pInstr ){` |
|    466351 | 13462 | `				pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    233173 | 13463 | `			}` |
|    233173 | 13464 | `		}` |
|         - | 13465 | `		/* All done */` |
|    466351 | 13466 | `		return SXRET_OK;` |
|         - | 13467 | `	}` |
|  27500659 | 13468 | `	if( pNode->pOp->iOp == EXPR_OP_PIPE ){` |
...
|         - | 13500 | `	}` |
|  27500633 | 13501 | `	bIsChainOp = GEN_IS_CHAIN_OP(pNode->pOp->iOp);` |
|         - | 13502 | `	/* Generate code for the left tree */` |
|  27500633 | 13503 | `	if( pNode->pLeft ){` |
|  27462261 | 13504 | `		sxu32 nLhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  27462261 | 13505 | `		if( iVmOp == PH7_OP_CALL ){` |
|         - | 13506 | `			ph7_expr_node **apNode;` |
|   6481779 | 13507 | `			int hasSpread = 0;` |
|   6481779 | 13508 | `			int hasNamed = 0;` |
|   6481779 | 13509 | `			int bAnySpread = 0;` |
|   6481779 | 13510 | `			sxu32 byRefMask = 0;` |
|         - | 13511 | `			sxi32 nArgs;` |
|         - | 13512 | `			sxi32 n;` |
|         - | 13513 | `			/* Recurse and generate bytecodes for function arguments */` |
|   6481779 | 13514 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|   6481779 | 13515 | `			nArgs = (sxi32)SySetUsed(&pNode->aNodeArgs);` |
...
|   6481779 | 13519 | `			if( nArgs == 1 && apNode[0] && (apNode[0]->iFlags & EXPR_NODE_FCC) ){` |
|        81 | 13520 | `				bFcc = 1;` |
|        81 | 13521 | `				nArgs = 0;` |
|        40 | 13522 | `			}` |
...
|         - | 13525 | `			{` |
|   6481779 | 13526 | `				int seenNamed = 0;` |
|   6481779 | 13527 | `				int seenSpread = 0;` |
|  13560395 | 13528 | `				for( n = 0; n < nArgs; ++n ){` |
|   7078623 | 13529 | `					if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
|      4057 | 13530 | `						bAnySpread = 1;` |
|      4057 | 13531 | `						seenSpread = 1;` |
|      4057 | 13532 | `						if( apNode[n]->iFlags & EXPR_NODE_NAMED_ARG ){` |
...
|         5 | 13536 | `						}` |
|   7076597 | 13537 | `					}else if( apNode[n]->iFlags & EXPR_NODE_NAMED_ARG ){` |
|       289 | 13538 | `						seenNamed = 1;` |
|       289 | 13539 | `						hasNamed = 1;` |
|   7074429 | 13540 | `					}else if( seenNamed ){` |
...
|   7074285 | 13544 | `					}else if( seenSpread ){` |
...
|   6481777 | 13552 | `			iFlags \|= EXPR_FLAG_RDONLY_LOAD;` |
...
|   6481777 | 13557 | `			if( pNode->pLeft && pNode->pLeft->pStart ){` |
|   6481777 | 13558 | `				SyString *pCallName = &pNode->pLeft->pStart->sData;` |
|   6481772 | 13559 | `				if( pCallName->nByte == 5` |
|   3626205 | 13560 | `				 && SyStrnicmp(pCallName->zString,"isset",5) == 0 ){` |
|    316751 | 13561 | `					iFlags \|= EXPR_FLAG_LOAD_IDX_ISSET;` |
|   6323404 | 13562 | `				}else if( pCallName->nByte == 5` |
|   3309459 | 13563 | `				 && SyStrnicmp(pCallName->zString,"empty",5) == 0 ){` |
...
|   6481777 | 13572 | `				if( !bAnySpread && !hasNamed ){` |
|         - | 13573 | `					SyString sBuiltin;` |
|   6477595 | 13574 | `					GenStateCallBuiltinName(pNode->pLeft, &sBuiltin);` |
|   6477595 | 13575 | `					byRefMask = GenStateByRefBuiltinMask(&sBuiltin);` |
|   3238795 | 13576 | `				}` |
|   3240886 | 13577 | `			}` |
|  13560391 | 13578 | `			for( n = 0 ; n < nArgs ; ++n ){` |
|   7078619 | 13579 | `				sxu32 nArgNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|   7078619 | 13580 | `				sxi32 iArgFlags = iFlags & ~(EXPR_FLAG_LOAD_IDX_STORE\|EXPR_FLAG_MEMBER_WRITE);` |
...
|   7078619 | 13587 | `				if( n < 31 && (byRefMask & (1u<<n)) ){` |
|     38671 | 13588 | `					iArgFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|     38671 | 13589 | `					iArgFlags \|= EXPR_FLAG_LOAD_IDX_STORE;` |
|     19333 | 13590 | `				}` |
|   7078619 | 13591 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iArgFlags);` |
|   7078619 | 13592 | `				if( rc != SXRET_OK ){` |
|       ! 0 | 13593 | `					return rc;` |
|         - | 13594 | `				}` |
|         - | 13595 | `				/* Each argument is an independent nullsafe scope. */` |
|   7078619 | 13596 | `				GenStatePatchNullsafeJumps(pGen, nArgNsBase);` |
|   7078619 | 13597 | `				if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
|         - | 13598 | `					/* Emit spread opcode to unpack this array argument */` |
|      4057 | 13599 | `					PH7_VmEmitInstr(pGen->pVm, PH7_OP_SPREAD, 0, 0, 0, 0);` |
|      4057 | 13600 | `					hasSpread = 1;` |
|      2026 | 13601 | `				}` |
|   3539312 | 13602 | `			}` |
|         - | 13603 | `			/* Total number of given arguments */` |
|   6481777 | 13604 | `			iP1 = nArgs;` |
|   6481777 | 13605 | `			iP2 = hasSpread;` |
|         - | 13606 | `			/* Build VmCallArgMap if named arguments are present.` |
|         - | 13607 | `			 * Deep-copy name strings so they survive token stream cleanup. */` |
|   6481777 | 13608 | `			if( hasNamed ){` |
...
|   6481777 | 13640 | `			iFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|   3240886 | 13641 | `		}` |
|         - | 13642 | `		{` |
...
|  27462259 | 13651 | `			sxi32 iLeftFlags = iFlags;` |
|  27462254 | 13652 | `			if( pNode->pLeft && pNode->pLeft->pOp` |
|  22529402 | 13653 | `				&& (pNode->pLeft->pOp->iOp == EXPR_OP_ARROW` |
|   8798301 | 13654 | `					\|\| pNode->pLeft->pOp->iOp == EXPR_OP_NULLSAFE_ARROW` |
|   7592375 | 13655 | `					\|\| pNode->pLeft->pOp->iOp == EXPR_OP_DC) ){` |
|   2605335 | 13656 | `				iLeftFlags &= ~EXPR_FLAG_LOAD_IDX_UNSET;` |
|   1302665 | 13657 | `			}` |
...
|  27462254 | 13665 | `			if( pNode->pOp` |
|  38726821 | 13666 | `				&& (pNode->pOp->iOp == EXPR_OP_ARROW` |
|  24995741 | 13667 | `					\|\| pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW` |
|  22529176 | 13668 | `					\|\| pNode->pOp->iOp == EXPR_OP_DC) ){` |
|   5335361 | 13669 | `				iLeftFlags &= ~EXPR_FLAG_MEMBER_WRITE;` |
|   2667678 | 13670 | `			}` |
...
|  27462254 | 13677 | `			if( pNode->pOp` |
|  27462259 | 13678 | `				&& (pNode->pOp->iVmOp == PH7_OP_INCR \|\| pNode->pOp->iVmOp == PH7_OP_DECR) ){` |
|    208837 | 13679 | `				iLeftFlags \|= EXPR_FLAG_LOAD_IDX_STORE \| EXPR_FLAG_MEMBER_WRITE;` |
|    104416 | 13680 | `			}` |
...
|  27462254 | 13688 | `			if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLC` |
|  13760144 | 13689 | `				&& pNode->pLeft && pNode->pLeft->pOp` |
|     86988 | 13690 | `				&& (pNode->pLeft->pOp->iOp == EXPR_OP_ARROW` |
|     57977 | 13691 | `					\|\| pNode->pLeft->pOp->iOp == EXPR_OP_NULLSAFE_ARROW` |
|     57959 | 13692 | `					\|\| pNode->pLeft->pOp->iOp == EXPR_OP_DC) ){` |
|        39 | 13693 | `				iLeftFlags \|= EXPR_FLAG_LOAD_IDX_ISSET;` |
|        19 | 13694 | `			}` |
|  27462259 | 13695 | `			if( iVmOp == PH7_OP_ERR_CTRL ){` |
...
|     15675 | 13698 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_ERR_CTRL,1,0,0,0);` |
|      7835 | 13699 | `			}` |
|  27462259 | 13700 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pLeft,iLeftFlags);` |
|         - | 13701 | `		}` |
|  27462259 | 13702 | `		if( rc != SXRET_OK ){` |
|        34 | 13703 | `			return rc;` |
|         - | 13704 | `		}` |
|  27462229 | 13705 | `		if( !bIsChainOp ){` |
...
|  12728847 | 13708 | `			GenStatePatchNullsafeJumps(pGen, nLhsNsBase);` |
|   6364421 | 13709 | `		}` |
|  27462229 | 13710 | `		if( iVmOp == PH7_OP_CALL ){` |
|   6481777 | 13711 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|   6481777 | 13712 | `			if( pInstr ){` |
|   6481777 | 13713 | `				if ( pInstr->iOp == PH7_OP_LOADC ){` |
|   4736789 | 13714 | `					sxu32 nOrig = (sxu32)pInstr->iP2;` |
|         - | 13715 | `					sxu32 nQual;` |
|   4736789 | 13716 | `					int bAbsolute = (pInstr->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|         - | 13717 | `					/* Prevent constant expansion but preserve the absolute flag` |
|         - | 13718 | `					 * so the later NEW handler (if any) can see it. */` |
|   4736789 | 13719 | `					pInstr->iP1 &= ~PH7_LOADC_EXPAND;` |
...
|   4736789 | 13727 | `					if( bAbsolute ){` |
|      3901 | 13728 | `						pInstr->iP2 = (sxi32)nOrig;` |
|      1953 | 13729 | `					}else{` |
|   4732893 | 13730 | `						int fromImport = 0;` |
|   4732893 | 13731 | `						nQual = GenStateNsQualifyName(pGen,nOrig,&pGen->hUseFuncImports,&fromImport);` |
|   4732893 | 13732 | `						pInstr->iP2 = (sxi32)nQual;` |
|   4732893 | 13733 | `						if( nQual != nOrig ){` |
...
|        46 | 13754 | `						}` |
|         - | 13755 | `					}` |
|   4113385 | 13756 | `				}else if( (pInstr->iOp == PH7_OP_MEMBER /* $a->b(1,2,3) */` |
|   1735002 | 13757 | `						&& !(pNode->pLeft && (pNode->pLeft->iFlags & EXPR_NODE_PARENS)))` |
|    882487 | 13758 | `					\|\| pInstr->iOp == PH7_OP_NEW ){` |
...
|   1725023 | 13774 | `					if( pInstr->iOp == PH7_OP_MEMBER && pInstr->iP1 == 1 && pInstr->p3 ){` |
...
|    862509 | 13780 | `				}` |
|   3240891 | 13781 | `			}` |
|  24221343 | 13782 | `		}else if( iVmOp == PH7_OP_LOAD_IDX ){` |
|         - | 13783 | `			ph7_expr_node **apNode;` |
|         - | 13784 | `			sxi32 n;` |
|   2916259 | 13785 | `			sxi32 iChildMask = ~(EXPR_FLAG_LOAD_IDX_STORE` |
...
|   2916259 | 13789 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|   5604471 | 13790 | `			for( n = 0 ; n < (sxi32)SySetUsed(&pNode->aNodeArgs) ; ++n ){` |
|   2688217 | 13791 | `				sxu32 nIdxNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|   2688217 | 13792 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iFlags&iChildMask);` |
|   2688217 | 13793 | `				if( rc != SXRET_OK ){` |
|       ! 0 | 13794 | `					return rc;` |
|         - | 13795 | `				}` |
|         - | 13796 | `				/* Each subscript index is an independent nullsafe scope. */` |
|   2688217 | 13797 | `				GenStatePatchNullsafeJumps(pGen, nIdxNsBase);` |
|   1344111 | 13798 | `			}` |
|   2916259 | 13799 | `			if( SySetUsed(&pNode->aNodeArgs) > 0 ){` |
|   2688217 | 13800 | `				iP1 = 1; /* Node have an index associated with it */` |
|   1344106 | 13801 | `			}` |
|   2916259 | 13802 | `			if( iFlags & EXPR_FLAG_LOAD_IDX_ISSET ){` |
|         - | 13803 | `				/* offsetExists for ArrayAccess; peek-only for arrays */` |
|    355221 | 13804 | `				iP2 = 4;` |
|   2738651 | 13805 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_UNSET ){` |
|         - | 13806 | `				/* offsetUnset for ArrayAccess; auto-vivify+load for arrays` |
|         - | 13807 | `				 * so the trailing unset() builtin can drop the slot. */` |
|     23229 | 13808 | `				iP2 = 5;` |
|   2549431 | 13809 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_EMPTY ){` |
...
|        31 | 13813 | `				iP2 = 6;` |
|   2537806 | 13814 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_STORE ){` |
|         - | 13815 | `				/* Create an empty entry when the desired index is not found */` |
|    541089 | 13816 | `				iP2 = 1;` |
|    270547 | 13817 | `			}` |
|  19522330 | 13818 | `		}else if( pNode->pOp->iOp == EXPR_OP_COMMA ){` |
|         - | 13819 | `			/* POP the left node */` |
|         5 | 13820 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|         2 | 13821 | `		}` |
|  13731112 | 13822 | `	}` |
|  27500601 | 13823 | `	rc = SXRET_OK;` |
|  27500601 | 13824 | `	nJmpIdx = 0;` |
...
|  27500601 | 13828 | `	if( iVmOp == PH7_OP_MEMBER && pNode->pOp->iOp == EXPR_OP_DC ){` |
|    436941 | 13829 | `		pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|    436941 | 13830 | `		if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|    436941 | 13831 | `			ph7_value *pLitCheck = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,(sxu32)pInstr->iP2);` |
|    436941 | 13832 | `			int isSpecial = 0;` |
|    436941 | 13833 | `			if( pLitCheck && (pLitCheck->iFlags & MEMOBJ_STRING) ){` |
|    367485 | 13834 | `				const char *z = (const char *)SyBlobData(&pLitCheck->sBlob);` |
|    367485 | 13835 | `				sxu32 n = (sxu32)SyBlobLength(&pLitCheck->sBlob);` |
|    367480 | 13836 | `				if( (n == 4 && SyMemcmp(z,"self",4) == 0) \|\|` |
|    328812 | 13837 | `					(n == 6 && SyMemcmp(z,"static",6) == 0) \|\|` |
|    177910 | 13838 | `					(n == 6 && SyMemcmp(z,"parent",6) == 0) ){` |
|    135201 | 13839 | `					isSpecial = 1;` |
|     67598 | 13840 | `				}` |
|    201104 | 13841 | `			}` |
|    471669 | 13842 | `			pInstr->iP1 = 0;` |
...
|         - | 13848 | `			{` |
|    672773 | 13849 | `				int bAbsolute = (pNode->pLeft && pNode->pLeft->pStart` |
|    603312 | 13850 | `					&& (pNode->pLeft->pStart->nType & PH7_TK_NSSEP));` |
|    402213 | 13851 | `				if( !isSpecial && !bAbsolute ){` |
|    266999 | 13852 | `					pInstr->iP2 = (sxi32)GenStateNsQualifyName(pGen,(sxu32)pInstr->iP2,&pGen->hUseImports,0);` |
|    133497 | 13853 | `				}` |
|         - | 13854 | `			}` |
...
|    402213 | 13857 | `			if( !isSpecial && pNode->pRight && pNode->pRight->pStart ){` |
|    267017 | 13858 | `				SyToken *pRightTok = pNode->pRight->pStart;` |
|    267017 | 13859 | `				if( (pRightTok->nType & PH7_TK_KEYWORD) &&` |
...
|  27465825 | 13867 | `	if( pNode->pRight ){` |
|  15840203 | 13868 | `		if( iVmOp == PH7_OP_LAND ){` |
|         - | 13869 | `			/* Emit the false jump so we can short-circuit the logical and */` |
|    440345 | 13870 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,1/* Keep the value on the stack */,0,0,&nJmpIdx);` |
|  15620033 | 13871 | `		}else if (iVmOp == PH7_OP_LOR ){` |
|         - | 13872 | `			/* Emit the true jump so we can short-circuit the logical or*/` |
|    304953 | 13873 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JNZ,1/* Keep the value on the stack */,0,0,&nJmpIdx);` |
|  15247389 | 13874 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLC ){` |
|         - | 13875 | `			/* Null coalescing: if LHS is not null, jump past RHS */` |
|     58039 | 13876 | `			iVmOp = 0; /* No binary operator to emit */` |
|     58039 | 13877 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_NULLC,0,0,0,&nJmpIdx);` |
|  15065950 | 13878 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW ){` |
...
|  15036829 | 13888 | `		}else if( pNode->pOp->iPrec == 18 /* Combined binary operators [i.e: =,'.=','+=',*=' ...] precedence */ ){` |
...
|   4969925 | 13892 | `			iFlags \|= EXPR_FLAG_LOAD_IDX_STORE \| EXPR_FLAG_MEMBER_WRITE;` |
|   2484960 | 13893 | `		}` |
|  15840203 | 13894 | `		nRhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  15840203 | 13895 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pRight,iFlags);` |
|  15840203 | 13896 | `		if( !bIsChainOp ){` |
|         - | 13897 | `			/* Non-chain parent: RHS nullsafe chain ends here, before the` |
|         - | 13898 | `			 * operator instruction is emitted. */` |
|  10504913 | 13899 | `			GenStatePatchNullsafeJumps(pGen, nRhsNsBase);` |
|   5252454 | 13900 | `		}` |
|  15840203 | 13901 | `		if( iVmOp == PH7_OP_STORE ){` |
|   4529771 | 13902 | `			if( pNode->pRight && (pNode->pRight->xCode == PH7_CompileList \|\|` |
|   4529734 | 13903 | `				pNode->pRight->xCode == PH7_CompileShortList) ){` |
...
|         - | 13909 | `				 */` |
|        91 | 13910 | `				iVmOp = 0;` |
|   4529728 | 13911 | `			}else if( (pInstr = PH7_VmPeekInstr(pGen->pVm)) != 0 ){` |
|   4529685 | 13912 | `				if(pInstr->iOp == PH7_OP_MEMBER ){` |
|         - | 13913 | `					/* Perform a member store operation [i.e: $this->x = 50] */` |
|    834067 | 13914 | `					iP2 = 1;` |
|    417036 | 13915 | `				}else{` |
|   3695623 | 13916 | `					if( pInstr->iOp == PH7_OP_LOAD_IDX ){` |
|         - | 13917 | `						/* Transform the STORE instruction to STORE_IDX instruction */` |
|    521701 | 13918 | `						iVmOp = PH7_OP_STORE_IDX;` |
|    521701 | 13919 | `						iP1 = pInstr->iP1;` |
|    260853 | 13920 | `					}else{` |
|   3173927 | 13921 | `						p3 = pInstr->p3;` |
|         - | 13922 | `					}` |
|         - | 13923 | `					/* POP the last dynamic load instruction */` |
|   3695623 | 13924 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|         - | 13925 | `				}` |
|   2264845 | 13926 | `			}` |
|  13575320 | 13927 | `		}else if( iVmOp == PH7_OP_STORE_REF ){` |
...
|        30 | 13942 | `		}` |
|   7920099 | 13943 | `	}` |
|  27465820 | 13944 | `	if( iVmOp == PH7_OP_NEW && pNode->pLeft && pNode->pLeft->pOp == 0` |
|    389450 | 13945 | `		&& pNode->pLeft->xCode == PH7_CompileAnnonClass ){` |
...
|        32 | 13948 | `		iVmOp = 0;` |
|        14 | 13949 | `	}` |
|  27465825 | 13950 | `	if( iVmOp > 0 ){` |
|  27407673 | 13951 | `		if( iVmOp == PH7_OP_INCR \|\| iVmOp == PH7_OP_DECR ){` |
|    208837 | 13952 | `			if( pNode->iFlags & EXPR_NODE_PRE_INCR ){` |
|         - | 13953 | `				/* Pre-increment/decrement operator [i.e: ++$i,--$j ] */` |
|     15469 | 13954 | `				iP1 = 1;` |
|      7737 | 13955 | `			}` |
|  27303257 | 13956 | `		}else if( iVmOp == PH7_OP_NEW ){` |
|         - | 13957 | `			/* Namespace-qualify the class name for NEW */ {` |
|    782183 | 13958 | `				VmInstr *pPeek = PH7_VmPeekInstr(pGen->pVm);` |
|    782183 | 13959 | `				VmInstr *pCallInstr = 0;` |
|    782183 | 13960 | `				if( pPeek && pPeek->iOp == PH7_OP_CALL ){` |
|    778203 | 13961 | `					pCallInstr = pPeek;` |
|    778203 | 13962 | `					pPeek = PH7_VmPeekNextInstr(pGen->pVm);` |
|    389099 | 13963 | `				}` |
|    782183 | 13964 | `				if( pPeek && pPeek->iOp == PH7_OP_LOADC ){` |
|    766745 | 13965 | `					int bAbsolute = (pPeek->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|         - | 13966 | `					sxu32 nLitForClass;` |
|    766745 | 13967 | `					VmCallArgMap *pCallNsMap = pCallInstr ? (VmCallArgMap *)pCallInstr->p3 : 0;` |
...
|    766745 | 13974 | `					if( pCallNsMap && pCallNsMap->nOrigNameLit > 0 ){` |
|        53 | 13975 | `						nLitForClass = pCallNsMap->nOrigNameLit - 1;` |
|        29 | 13976 | `					}else{` |
|    766697 | 13977 | `						nLitForClass = (sxu32)pPeek->iP2;` |
|         - | 13978 | `					}` |
|    766745 | 13979 | `					pPeek->iP1 = 0;` |
|    766745 | 13980 | `					if( !bAbsolute ){` |
...
|    762859 | 13985 | `						ph7_value *pLitChk = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,nLitForClass);` |
|    762859 | 13986 | `						int isSpecialNew = 0;` |
|    762859 | 13987 | `						if( pLitChk && (pLitChk->iFlags & MEMOBJ_STRING) ){` |
|    755535 | 13988 | `							const char *z = (const char *)SyBlobData(&pLitChk->sBlob);` |
|    755535 | 13989 | `							sxu32 n = (sxu32)SyBlobLength(&pLitChk->sBlob);` |
|    755530 | 13990 | `							if( (n == 4 && SyMemcmp(z,"self",4) == 0) \|\|` |
|    757307 | 13991 | `								(n == 6 && SyMemcmp(z,"static",6) == 0) \|\|` |
|    377712 | 13992 | `								(n == 6 && SyMemcmp(z,"parent",6) == 0) ){` |
|      3895 | 13993 | `								isSpecialNew = 1;` |
|      1945 | 13994 | `							}` |
|    379596 | 13995 | `						}` |
|    766521 | 13996 | `						if( isSpecialNew ){` |
|      3895 | 13997 | `							pPeek->iP2 = (sxi32)nLitForClass;` |
|      1950 | 13998 | `						}else{` |
|    755307 | 13999 | `							pPeek->iP2 = (sxi32)GenStateNsQualifyName(pGen,nLitForClass,&pGen->hUseImports,0);` |
|         - | 14000 | `						}` |
|    379601 | 14001 | `					}else{` |
|      3891 | 14002 | `						pPeek->iP2 = (sxi32)nLitForClass;` |
|         - | 14003 | `					}` |
|    381539 | 14004 | `				}` |
|         - | 14005 | `			}` |
|    778521 | 14006 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|    778521 | 14007 | `			if( pInstr && pInstr->iOp == PH7_OP_CALL ){` |
|         - | 14008 | `				VmInstr *pPrev;` |
|    778203 | 14009 | `				pPrev = PH7_VmPeekNextInstr(pGen->pVm);` |
|    778203 | 14010 | `				if( pPrev == 0 \|\| pPrev->iOp != PH7_OP_MEMBER ){` |
...
|    778203 | 14014 | `					iP1 = pInstr->iP1;` |
|    778203 | 14015 | `					iP2 = pInstr->iP2;` |
|    778203 | 14016 | `					if( pInstr->p3 ){` |
|        63 | 14017 | `						p3 = pInstr->p3; /* Transfer VmCallArgMap to NEW */` |
|        29 | 14018 | `					}` |
|    778203 | 14019 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|    389099 | 14020 | `				}` |
|    389104 | 14021 | `			}` |
|  26805921 | 14022 | `		}else if( iVmOp == PH7_OP_IS_A ){` |
...
|     77451 | 14025 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|     77451 | 14026 | `			if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|     77451 | 14027 | `				ph7_value *pLitChk = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,(sxu32)pInstr->iP2);` |
|     77451 | 14028 | `				int bAbsolute = (pInstr->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|     77451 | 14029 | `				int isSpecialIs = 0;` |
|     77451 | 14030 | `				if( pLitChk && (pLitChk->iFlags & MEMOBJ_STRING) ){` |
|     77451 | 14031 | `					const char *z = (const char *)SyBlobData(&pLitChk->sBlob);` |
|     77451 | 14032 | `					sxu32 n = (sxu32)SyBlobLength(&pLitChk->sBlob);` |
|     77446 | 14033 | `					if( (n == 4 && SyMemcmp(z,"self",4) == 0) \|\|` |
|     77449 | 14034 | `						(n == 6 && SyMemcmp(z,"static",6) == 0) \|\|` |
|     38723 | 14035 | `						(n == 6 && SyMemcmp(z,"parent",6) == 0) ){` |
|        12 | 14036 | `						isSpecialIs = 1;` |
|         5 | 14037 | `					}` |
|     38723 | 14038 | `				}` |
|     77451 | 14039 | `				pInstr->iP1 = 0;` |
|     77451 | 14040 | `				if( !isSpecialIs && !bAbsolute ){` |
|     77431 | 14041 | `					pInstr->iP2 = (sxi32)GenStateNsQualifyName(pGen,(sxu32)pInstr->iP2,&pGen->hUseImports,0);` |
|     38713 | 14042 | `				}` |
|     38728 | 14043 | `			}` |
|  26377940 | 14044 | `		}else if( iVmOp == PH7_OP_MEMBER){` |
...
|   5335295 | 14048 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|   5335295 | 14049 | `			if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|   5099861 | 14050 | `				pInstr->iP1 = 0;` |
|   2549928 | 14051 | `			}` |
|   5335295 | 14052 | `			if( pNode->pOp->iOp == EXPR_OP_DC /* '::' */){` |
|         - | 14053 | `				/* Static member access,remember that */` |
|    402165 | 14054 | `				iP1 = 1;` |
|    402165 | 14055 | `				pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|    402165 | 14056 | `				if( pInstr && pInstr->iOp == PH7_OP_LOAD ){` |
|    231565 | 14057 | `					p3 = pInstr->p3;` |
|    231565 | 14058 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|    115780 | 14059 | `				}` |
|    201080 | 14060 | `			}` |
...
|   5335295 | 14065 | `			if( iP2 == PH7_MEMBER_READ ){` |
|   5335295 | 14066 | `				if( iFlags & EXPR_FLAG_LOAD_IDX_UNSET ){` |
|        42 | 14067 | `					iP2 = PH7_MEMBER_UNSET;` |
|   5335275 | 14068 | `				}else if( iFlags & EXPR_FLAG_LOAD_IDX_ISSET ){` |
|     61873 | 14069 | `					iP2 = PH7_MEMBER_ISSET;` |
|   5304321 | 14070 | `				}else if( iFlags & EXPR_FLAG_LOAD_IDX_EMPTY ){` |
|        17 | 14071 | `					iP2 = PH7_MEMBER_EMPTY;` |
|   5273379 | 14072 | `				}else if( iFlags & EXPR_FLAG_MEMBER_WRITE ){` |
|         - | 14073 | `					/* Write-lvalue base ($o->arr[$k]=v, $o->p ??= v): auto-create a missing prop. */` |
|   1019437 | 14074 | `					iP2 = PH7_MEMBER_WRITE;` |
|    509716 | 14075 | `				}` |
|   2667645 | 14076 | `			}` |
|   2667645 | 14077 | `		}` |
...
|  27404011 | 14105 | `		if( iVmOp == PH7_OP_CALL \|\| iVmOp == PH7_OP_NEW ){` |
|   7260213 | 14106 | `			p3 = GenStateAttachStrictFlag(pGen,p3);` |
|   3630104 | 14107 | `		}` |
|         - | 14108 | `		/* Finally,emit the VM instruction associated with this operator */` |
|  27404011 | 14109 | `		PH7_VmEmitInstr(pGen->pVm,iVmOp,iP1,iP2,p3,0);` |
|  13702003 | 14110 | `	}` |
|  27462163 | 14111 | `	if( nJmpIdx > 0 ){` |
|         - | 14112 | `		/* Fix short-circuited jumps now the destination is resolved */` |
|    803327 | 14113 | `		pInstr = PH7_VmGetInstr(pGen->pVm,nJmpIdx);` |
|    803327 | 14114 | `		if( pInstr ){` |
|    803327 | 14115 | `			pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    401661 | 14116 | `		}` |
|    401661 | 14117 | `	}` |
|  27462163 | 14118 | `	return rc;` |
|  35143157 | 14119 | `}` |
|         - | 14120 | `/*` |
...
|         - | 14141 | ` */` |
| 232960216 | 14142 | `static int GenStateTreeHasComma(ph7_expr_node *pNode)` |
|         5 | 14143 | `{` |
|         - | 14144 | `	ph7_expr_node **apArg;` |
|         - | 14145 | `	sxu32 n;` |
| 232960221 | 14146 | `	if( pNode == 0 ){` |
| 163716597 | 14147 | `		return 0;` |
|         - | 14148 | `	}` |
|  69243629 | 14149 | `	if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_COMMA ){` |
|         6 | 14150 | `		return 1;` |
|         - | 14151 | `	}` |
|  69243620 | 14152 | `	if( GenStateTreeHasComma(pNode->pLeft) \|\| GenStateTreeHasComma(pNode->pRight)` |
|  69243621 | 14153 | `	 \|\| GenStateTreeHasComma(pNode->pCond) ){` |
|         6 | 14154 | `		return 1;` |
|         - | 14155 | `	}` |
|  69243621 | 14156 | `	apArg = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  78987379 | 14157 | `	for( n = 0 ; n < SySetUsed(&pNode->aNodeArgs) ; n++ ){` |
|   9743763 | 14158 | `		if( GenStateTreeHasComma(apArg[n]) ){` |
|       ! 0 | 14159 | `			return 1;` |
|         - | 14160 | `		}` |
|   4871884 | 14161 | `	}` |
|  69243621 | 14162 | `	return 0;` |
| 116480113 | 14163 | `}` |
|  15845028 | 14164 | `static sxi32 PH7_CompileExpr(` |
...
|  15845033 | 14178 | `	nExpr = 0;` |
|  15845033 | 14179 | `	pRoot = 0;` |
...
|  15845033 | 14182 | `	nNullsafeBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  15845033 | 14183 | `	SySetInit(&sExprNode,&pGen->pVm->sAllocator,sizeof(ph7_expr_node *));` |
|  15845033 | 14184 | `	SySetAlloc(&sExprNode,0x10);` |
|  15845033 | 14185 | `	rc = SXRET_OK;` |
|         - | 14186 | `	/* Delimit the expression */` |
|  15845033 | 14187 | `	pEnd = pGen->pIn;` |
|  15845033 | 14188 | `	iNest = 0;` |
| 123958391 | 14189 | `	while( pEnd < pGen->pEnd ){` |
| 117904431 | 14190 | `		if( pEnd->nType & PH7_TK_OCB /* '{' */ ){` |
|         - | 14191 | `			/* Ticket 1433-30: Annonymous/Closure functions body */` |
|      4699 | 14192 | `			iNest++;` |
| 117902084 | 14193 | `		}else if(pEnd->nType & PH7_TK_CCB /* '}' */ ){` |
|      4707 | 14194 | `			iNest--;` |
| 117897386 | 14195 | `		}else if( pEnd->nType & PH7_TK_SEMI /* ';' */ ){` |
|   9791945 | 14196 | `			if( iNest <= 0 ){` |
|   9791073 | 14197 | `				break;` |
|         - | 14198 | `			}` |
|       436 | 14199 | `		}` |
| 108113363 | 14200 | `		pEnd++;` |
|         5 | 14201 | `	}` |
|  15845033 | 14202 | `	if( iFlags & EXPR_FLAG_COMMA_STATEMENT ){` |
|    718655 | 14203 | `		SyToken *pEnd2 = pGen->pIn;` |
|    718655 | 14204 | `		iNest = 0;` |
|         - | 14205 | `		/* Stop at the first comma */` |
|   1573505 | 14206 | `		while( pEnd2 < pEnd ){` |
|    854857 | 14207 | `			if( pEnd2->nType & (PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*'['*/\|PH7_TK_LPAREN/*'('*/) ){` |
|     46413 | 14208 | `				iNest++;` |
|    831653 | 14209 | `			}else if(pEnd2->nType & (PH7_TK_CCB/*'}'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_RPAREN/*')'*/)){` |
|     46413 | 14210 | `				iNest--;` |
|    785245 | 14211 | `			}else if( pEnd2->nType & PH7_TK_COMMA /*','*/ ){` |
...
|    854855 | 14216 | `			pEnd2++;` |
|         5 | 14217 | `		}` |
|    718655 | 14218 | `		if( pEnd2 <pEnd ){` |
|         3 | 14219 | `			pEnd = pEnd2;` |
|         1 | 14220 | `		}` |
|    359325 | 14221 | `	}` |
|  15845033 | 14222 | `	if( pEnd > pGen->pIn ){` |
|  15821877 | 14223 | `		SyToken *pTmp = pGen->pEnd;` |
|         - | 14224 | `		/* Swap delimiter */` |
|  15821877 | 14225 | `		pGen->pEnd = pEnd;` |
|         - | 14226 | `		/* Try to get an expression tree */` |
|  15821877 | 14227 | `		rc = PH7_ExprMakeTree(&(*pGen),&sExprNode,&pRoot);` |
|  15821872 | 14228 | `		if( rc == SXRET_OK && pRoot && pGen->nCommaExprOk < 1` |
|  15653652 | 14229 | `		 && GenStateTreeHasComma(pRoot) ){` |
...
|         - | 14242 | `		}` |
|  15821873 | 14243 | `		if( rc == SXRET_OK && pRoot ){` |
|  15821689 | 14244 | `			rc = SXRET_OK;` |
|  15821689 | 14245 | `			if( xTreeValidator ){` |
|         - | 14246 | `				/* Call the upper layer validator callback */` |
|    985647 | 14247 | `				rc = xTreeValidator(&(*pGen),pRoot);` |
|    492821 | 14248 | `			}` |
|  15821689 | 14249 | `			if( rc != SXERR_ABORT ){` |
|         - | 14250 | `				/* Generate code for the given tree */` |
|  15821689 | 14251 | `				rc = GenStateEmitExprCode(&(*pGen),pRoot,iFlags);` |
|         - | 14252 | `				/* Patch any unresolved nullsafe jumps emitted by this` |
|         - | 14253 | `				 * expression so they short-circuit to its end. */` |
|  15821689 | 14254 | `				GenStatePatchNullsafeJumps(pGen, nNullsafeBase);` |
|   7910842 | 14255 | `			}` |
|  15821689 | 14256 | `			nExpr = 1;` |
|   7910842 | 14257 | `		}` |
|         - | 14258 | `		/* Release the whole tree */` |
|  15821873 | 14259 | `		PH7_ExprFreeTree(&(*pGen),&sExprNode);` |
|         - | 14260 | `		/* Synchronize token stream */` |
|  15821873 | 14261 | `		pGen->pEnd = pTmp;` |
|  15821873 | 14262 | `		pGen->pIn  = pEnd;` |
|  15821873 | 14263 | `		if( rc == SXERR_ABORT ){` |
|        12 | 14264 | `			SySetRelease(&sExprNode);` |
|        12 | 14265 | `			return SXERR_ABORT;` |
|         - | 14266 | `		}` |
|   7910929 | 14267 | `	}` |
|  15845019 | 14268 | `	SySetRelease(&sExprNode);` |
|  15845019 | 14269 | `	return nExpr > 0 ? SXRET_OK : SXERR_EMPTY;` |
|   7922519 | 14270 | `}` |
|         - | 14271 | `/*` |
|         - | 14272 | ` * Return a pointer to the node construct handler associated` |
|         - | 14273 | ` * with a given node type [i.e: string,integer,float,...].` |
|         - | 14274 | ` */` |
|   9058222 | 14275 | `PH7_PRIVATE ProcNodeConstruct PH7_GetNodeHandler(sxu32 nNodeType)` |
|         5 | 14276 | `{` |
|   9058227 | 14277 | `	if( nNodeType & PH7_TK_NUM ){` |
|         - | 14278 | `		/* Numeric literal: Either real or integer */` |
|   3711093 | 14279 | `		return PH7_CompileNumLiteral;` |
|   5347139 | 14280 | `	}else if( nNodeType & PH7_TK_DSTR ){` |
|         - | 14281 | `		/* Double quoted string */` |
|    121557 | 14282 | `		return PH7_CompileString;` |
|   5225587 | 14283 | `	}else if( nNodeType & PH7_TK_SSTR ){` |
|         - | 14284 | `		/* Single quoted string */` |
|   5225467 | 14285 | `		return PH7_CompileSimpleString;` |
...
|         - | 14302 | ` */` |
|     23266 | 14303 | `static sxi32 GenStateUnsetValidator(ph7_gen_state *pGen, ph7_expr_node *pNode)` |
|         5 | 14304 | `{` |
|         - | 14305 | `	sxi32 rc;` |
|     23271 | 14306 | `	if( !PH7_ExprContainsNullsafe(pNode) ){` |
|     23269 | 14307 | `		return SXRET_OK;` |
|         - | 14308 | `	}` |
...
|         - | 14320 | ` */` |
|     26126 | 14321 | `static sxi32 PH7_CompileUnset(ph7_gen_state *pGen)` |
|         5 | 14322 | `{` |
|     26131 | 14323 | `	SyToken *pTmp,*pEnd,*pNext = 0;` |
|     26131 | 14324 | `	sxu32 nIdx = 0;` |
|         - | 14325 | `	SyString sName;` |
|         - | 14326 | `	sxi32 rc;` |
|         - | 14327 | `	/* Jump the 'unset' keyword */` |
|     26131 | 14328 | `	pGen->pIn++;` |
|         - | 14329 | `	/* Save delimiter */` |
|     26131 | 14330 | `	pTmp = pGen->pEnd;` |
|         - | 14331 | `	/* Skip optional opening parenthesis and find the matching close */` |
|     26131 | 14332 | `	pEnd = pTmp; /* Default: scan to statement end */` |
|     26131 | 14333 | `	if( pGen->pIn < pTmp && (pGen->pIn->nType & PH7_TK_LPAREN) ){` |
|         - | 14334 | `		/* Find matching ')' — start scanning AFTER the '(' */` |
|         - | 14335 | `		SyToken *pClose;` |
|     26131 | 14336 | `		pGen->pIn++;   /* Skip '(' */` |
|     26131 | 14337 | `		PH7_DelimitNestedTokens(pGen->pIn,pTmp,PH7_TK_LPAREN,PH7_TK_RPAREN,&pClose);` |
|     26131 | 14338 | `		pEnd = pClose; /* Stop at ')' */` |
|     13063 | 14339 | `	}` |
|     26131 | 14340 | `	SyStringInitFromBuf(&sName,"unset",sizeof("unset")-1);` |
|         - | 14341 | `	/* Resolve the 'unset' builtin name once */` |
|     26131 | 14342 | `	if( SXRET_OK != GenStateFindLiteral(&(*pGen),&sName,&nIdx) ){` |
|      3863 | 14343 | `		ph7_value *pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|      3863 | 14344 | `		if( pObj == 0 ){` |
|       ! 0 | 14345 | `			return SXERR_ABORT;` |
|         - | 14346 | `		}` |
|      3863 | 14347 | `		PH7_MemObjInitFromString(pGen->pVm,pObj,&sName);` |
|      3863 | 14348 | `		GenStateInstallLiteral(&(*pGen),pObj,nIdx);` |
|      1929 | 14349 | `	}` |
|         - | 14350 | `	/* Compile each comma-separated argument */` |
|     56489 | 14351 | `	while( SXRET_OK == PH7_GetNextExpr(pGen->pIn,pEnd,&pNext) ){` |
|     30363 | 14352 | `		if( pGen->pIn < pNext ){` |
|         - | 14353 | `			/*` |
...
|         - | 14360 | `			 */` |
|     30358 | 14361 | `			if( &pGen->pIn[2] == pNext` |
|     18725 | 14362 | `				&& (pGen->pIn[0].nType & PH7_TK_DOLLAR)` |
...
|      7095 | 14379 | `				continue;` |
|         - | 14380 | `			}` |
|     23273 | 14381 | `			pGen->pEnd = pNext;` |
|     23273 | 14382 | `			rc = PH7_CompileExpr(&(*pGen),` |
|         - | 14383 | `				EXPR_FLAG_RDONLY_LOAD\|EXPR_FLAG_LOAD_IDX_UNSET,` |
|         - | 14384 | `				GenStateUnsetValidator);` |
|     23273 | 14385 | `			if( rc == SXERR_ABORT ){` |
|       ! 0 | 14386 | `				return SXERR_ABORT;` |
|         - | 14387 | `			}` |
|     23273 | 14388 | `			if( rc != SXERR_EMPTY ){` |
|         - | 14389 | `				/* Emit call for this single argument */` |
|     23271 | 14390 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|     23271 | 14391 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_CALL,1,0,GenStateAttachStrictFlag(pGen,0),0);` |
|     23271 | 14392 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|     11633 | 14393 | `			}` |
|     11634 | 14394 | `		}` |
|         - | 14395 | `		/* Jump trailing commas */` |
|     23279 | 14396 | `		while( pNext < pEnd && (pNext->nType & PH7_TK_COMMA) ){` |
|         7 | 14397 | `			pNext++;` |
|         1 | 14398 | `		}` |
|     23273 | 14399 | `		pGen->pIn = pNext;` |
|         5 | 14400 | `	}` |
|         - | 14401 | `	/* Skip past the closing ')' if present */` |
|     26131 | 14402 | `	if( pGen->pIn < pTmp && (pGen->pIn->nType & PH7_TK_RPAREN) ){` |
|     26131 | 14403 | `		pGen->pIn++;` |
|     13063 | 14404 | `	}` |
|         - | 14405 | `	/* Restore token stream */` |
|     26131 | 14406 | `	pGen->pEnd = pTmp;` |
|     26131 | 14407 | `	return SXRET_OK;` |
|     13068 | 14408 | `}` |
|         - | 14409 | `/*` |
...
|         - | 14441 | ` */` |
|   7687774 | 14442 | `static ProcLangConstruct GenStateGetStatementHandler(` |
|         - | 14443 | `	sxu32 nKeywordID,   /* Keyword  ID*/` |
|         - | 14444 | `	SyToken *pLookahed  /* Look-ahead token */` |
|         - | 14445 | `	)` |
|         5 | 14446 | `{` |
|   7687779 | 14447 | `	sxu32 n = 0;` |
|  30614299 | 14448 | `	for(;;){` |
|  61228603 | 14449 | `		if( n >= SX_ARRAYSIZE(aLangConstruct) ){` |
|    465399 | 14450 | `			break;` |
|         - | 14451 | `		}` |
|  60763209 | 14452 | `		if( aLangConstruct[n].nID == nKeywordID ){` |
|   7222385 | 14453 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed && (pLookahed->nType & PH7_TK_OP)){` |
...
|         - | 14458 | `				}` |
|       ! 0 | 14459 | `			}` |
|   7222380 | 14460 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed` |
|     11588 | 14461 | `				&& (pLookahed->nType & PH7_TK_KEYWORD)` |
|      5801 | 14462 | `				&& SX_PTR_TO_INT(pLookahed->pUserData) == PH7_TKWRD_FN ){` |
|         - | 14463 | `				/* 'static fn(...)' arrow function — compile as expression */` |
|         3 | 14464 | `				return 0;` |
|         - | 14465 | `			}` |
|         - | 14466 | `			/* Return a pointer to the handler.` |
|         - | 14467 | `			*/` |
|   7222383 | 14468 | `			return aLangConstruct[n].xConstruct;` |
|         - | 14469 | `		}` |
|  53540829 | 14470 | `		n++;` |
|         5 | 14471 | `	}` |
|    465399 | 14472 | `	if( pLookahed ){` |
|    465399 | 14473 | `		if(nKeywordID == PH7_TKWRD_INTERFACE && (pLookahed->nType & PH7_TK_ID) ){` |
|     69567 | 14474 | `			return PH7_CompileClassInterface;` |
|    395837 | 14475 | `		}else if(nKeywordID == PH7_TKWRD_CLASS && (pLookahed->nType & PH7_TK_ID) ){` |
|    337395 | 14476 | `			return PH7_CompileClass;` |
|     58447 | 14477 | `		}else if(nKeywordID == PH7_TKWRD_TRAIT && (pLookahed->nType & PH7_TK_ID) ){` |
|      7809 | 14478 | `			return PH7_CompileTrait;` |
|         - | 14479 | `		}` |
...
|     50643 | 14486 | `	return 0;` |
|   3843892 | 14487 | `}` |
|         - | 14488 | `/*` |
|         - | 14489 | ` * Check if the given keyword is in fact a PHP language construct.` |
|         - | 14490 | ` * Return TRUE on success. FALSE otheriwse.` |
|         - | 14491 | ` */` |
|     50640 | 14492 | `static int GenStateisLangConstruct(sxu32 nKeyword)` |
|         5 | 14493 | `{` |
|         - | 14494 | `	int rc;` |
|     50645 | 14495 | `	rc = PH7_IsLangConstruct(nKeyword,TRUE);` |
|     50645 | 14496 | `	if( rc == FALSE ){` |
|     50532 | 14497 | `		if( nKeyword == PH7_TKWRD_SELF \|\| nKeyword == PH7_TKWRD_PARENT \|\| nKeyword == PH7_TKWRD_STATIC` |
|     15800 | 14498 | `			\|\| nKeyword == PH7_TKWRD_YIELD` |
...
|         - | 14522 | ` */` |
|  16714400 | 14523 | `static void GenStateSetPendingDoc(ph7_gen_state *pGen)` |
|         5 | 14524 | `{` |
|  16714405 | 14525 | `	SyToken *pBase = (SyToken *)SySetBasePtr(pGen->pTokenSet);` |
|  16714405 | 14526 | `	ph7_trivia *aT = (ph7_trivia *)SySetBasePtr(&pGen->aTrivia);` |
|  16714405 | 14527 | `	sxu32 nT = SySetUsed(&pGen->aTrivia);` |
|         - | 14528 | `	sxu32 nIdx, n;` |
|  16714400 | 14529 | `	if( nT < 1 \|\| pGen->pTokenSet == 0` |
|   3417279 | 14530 | `	 \|\| pGen->pIn < pBase \|\| pGen->pIn >= &pBase[SySetUsed(pGen->pTokenSet)] ){` |
|         - | 14531 | `		/* Re-tokenized substream (string interpolation, synthesized code):` |
|         - | 14532 | `		 * indexes do not map to the sidecar */` |
|  13297133 | 14533 | `		return;` |
|         - | 14534 | `	}` |
|   3417277 | 14535 | `	nIdx = (sxu32)(pGen->pIn - pBase);` |
...
|   3417277 | 14538 | `	SySetReset(&pGen->aPendingAttrs);` |
|  10253315 | 14539 | `	for( n = 0 ; n < nT ; n++ ){` |
|   6836043 | 14540 | `		if( aT[n].nTokIdx != nIdx ){` |
|   6828163 | 14541 | `			continue;` |
|         - | 14542 | `		}` |
|      7885 | 14543 | `		if( aT[n].iKind == PH7_TRIVIA_DOC ){` |
|        29 | 14544 | `			pGen->sPendingDoc = aT[n].sText;` |
|      7873 | 14545 | `		}else if( aT[n].iKind == PH7_TRIVIA_ATTR ){` |
|      7861 | 14546 | `			SySetPut(&pGen->aPendingAttrs,(const void *)&aT[n]);` |
|      3928 | 14547 | `		}` |
|      3945 | 14548 | `	}` |
|   8357205 | 14549 | `}` |
|         - | 14550 | `/*` |
...
|         - | 14554 | ` */` |
|   4393844 | 14555 | `static void GenStateConsumeDoc(ph7_gen_state *pGen,SyString *pOut)` |
|         5 | 14556 | `{` |
|         - | 14557 | `	char *zDup;` |
|   4393849 | 14558 | `	if( SyStringLength(&pGen->sPendingDoc) < 1 ){` |
|   4393829 | 14559 | `		return;` |
|         - | 14560 | `	}` |
...
|         - | 14576 | ` */` |
|      7868 | 14577 | `static sxi32 GenStateCompileAttrSpan(ph7_gen_state *pGen,ph7_trivia *pTrivia,SySet *pOut)` |
|         5 | 14578 | `{` |
|         - | 14579 | `	SySet *pToken;` |
|         - | 14580 | `	SyToken *pIn, *pEnd, *pSavedIn, *pSavedEnd;` |
|         - | 14581 | `	char *zSpan;` |
|      7873 | 14582 | `	sxi32 rc = SXRET_OK;` |
|      7873 | 14583 | `	if( SyStringLength(&pTrivia->sText) < 1 ){` |
|       ! 0 | 14584 | `		return SXRET_OK;` |
|         - | 14585 | `	}` |
|     11807 | 14586 | `	zSpan = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|      3934 | 14587 | `		SyStringData(&pTrivia->sText),SyStringLength(&pTrivia->sText));` |
|      7873 | 14588 | `	if( zSpan == 0 ){` |
...
|      7873 | 14594 | `	pToken = (SySet *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(SySet));` |
|      7873 | 14595 | `	if( pToken == 0 ){` |
|       ! 0 | 14596 | `		return SXRET_OK;` |
|         - | 14597 | `	}` |
|      7873 | 14598 | `	SySetInit(pToken,&pGen->pVm->sAllocator,sizeof(SyToken));` |
|      7873 | 14599 | `	PH7_TokenizePHP(zSpan,SyStringLength(&pTrivia->sText),pTrivia->nLine,pToken,0);` |
|      7873 | 14600 | `	pIn = (SyToken *)SySetBasePtr(pToken);` |
|      7873 | 14601 | `	pEnd = &pIn[SySetUsed(pToken)];` |
|      7873 | 14602 | `	pSavedIn = pGen->pIn;` |
|      7873 | 14603 | `	pSavedEnd = pGen->pEnd;` |
|      7877 | 14604 | `	while( pIn < pEnd ){` |
|         - | 14605 | `		ph7_attribute sAttr;` |
|         - | 14606 | `		SyBlob sFQN;` |
|      7877 | 14607 | `		int bAbsolute = 0;` |
|      7877 | 14608 | `		SyZero(&sAttr,sizeof(sAttr));` |
|      7877 | 14609 | `		SySetInit(&sAttr.aArgs,&pGen->pVm->sAllocator,sizeof(ph7_attr_arg));` |
|      7877 | 14610 | `		sAttr.nLine = pIn->nLine;` |
|      7877 | 14611 | `		if( pIn->nType & PH7_TK_NSSEP ){` |
|        75 | 14612 | `			bAbsolute = 1;` |
|        75 | 14613 | `			pIn++;` |
|        35 | 14614 | `		}` |
|      7877 | 14615 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|      7877 | 14616 | `		while( pIn < pEnd && (pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|      7877 | 14617 | `			SyBlobAppend(&sFQN,pIn->sData.zString,pIn->sData.nByte);` |
|      7877 | 14618 | `			pIn++;` |
|      7877 | 14619 | `			if( pIn < pEnd && (pIn->nType & PH7_TK_NSSEP) ){` |
...
|      7877 | 14624 | `			break;` |
|       ! 0 | 14625 | `		}` |
|      7877 | 14626 | `		if( SyBlobLength(&sFQN) < 1 ){` |
...
|         - | 14634 | `		{` |
|      7877 | 14635 | `			const char *zName = (const char *)SyBlobData(&sFQN);` |
|      7877 | 14636 | `			sxu32 nName = SyBlobLength(&sFQN);` |
|      7877 | 14637 | `			char *zDup = 0;` |
|      7877 | 14638 | `			if( !bAbsolute ){` |
|      7807 | 14639 | `				SyHashEntry *pImp = SyHashGet(&pGen->hUseImports,(const void *)zName,nName);` |
|      7807 | 14640 | `				if( pImp ){` |
...
|       ! 0 | 14645 | `					}` |
|      7807 | 14646 | `				}else if( SyBlobLength(&pGen->sNamespace) > 0 ){` |
|         - | 14647 | `					SyBlob sTmp;` |
...
|       ! 0 | 14658 | `				}` |
|      3901 | 14659 | `			}` |
|      7877 | 14660 | `			if( SyStringLength(&sAttr.sName) < 1 ){` |
|      7877 | 14661 | `				zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,zName,nName);` |
|      7877 | 14662 | `				if( zDup ){` |
|      7877 | 14663 | `					SyStringInitFromBuf(&sAttr.sName,zDup,nName);` |
|      3936 | 14664 | `				}` |
|      3936 | 14665 | `			}` |
|         - | 14666 | `		}` |
|      7877 | 14667 | `		SyBlobRelease(&sFQN);` |
|      7877 | 14668 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_LPAREN) ){` |
|         - | 14669 | `			SyToken *pArgsEnd;` |
|      7775 | 14670 | `			pIn++;` |
|      7775 | 14671 | `			PH7_DelimitNestedTokens(pIn,pEnd,PH7_TK_LPAREN,PH7_TK_RPAREN,&pArgsEnd);` |
|     15559 | 14672 | `			while( pIn < pArgsEnd ){` |
|      7789 | 14673 | `				SyToken *pArgStart = pIn, *pArgStop = pIn;` |
|      7789 | 14674 | `				sxi32 iDepth = 0;` |
|         - | 14675 | `				ph7_attr_arg sArgRec;` |
|     77405 | 14676 | `				while( pArgStop < pArgsEnd ){` |
|     69637 | 14677 | `					if( pArgStop->nType & (PH7_TK_LPAREN\|PH7_TK_OSB\|PH7_TK_OCB) ){` |
|        11 | 14678 | `						iDepth++;` |
|     69632 | 14679 | `					}else if( pArgStop->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB) ){` |
|        11 | 14680 | `						iDepth--;` |
|     69622 | 14681 | `					}else if( (pArgStop->nType & PH7_TK_COMMA) && iDepth == 0 ){` |
|        17 | 14682 | `						break;` |
|         - | 14683 | `					}` |
|     69621 | 14684 | `					pArgStop++;` |
|         5 | 14685 | `				}` |
|      7789 | 14686 | `				SyZero(&sArgRec,sizeof(sArgRec));` |
|      7789 | 14687 | `				SySetInit(&sArgRec.aByteCode,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|      7784 | 14688 | `				if( pArgStart < pArgStop && (pArgStart->nType & (PH7_TK_ID\|PH7_TK_KEYWORD))` |
|      7768 | 14689 | `				 && &pArgStart[1] < pArgStop && (pArgStart[1].nType & PH7_TK_COLON) ){` |
...
|         9 | 14696 | `				}` |
|      7789 | 14697 | `				if( pArgStart < pArgStop ){` |
|         - | 14698 | `					SySet *pInstrContainer;` |
|      7789 | 14699 | `					pGen->pIn = pArgStart;` |
|      7789 | 14700 | `					pGen->pEnd = pArgStop;` |
|      7789 | 14701 | `					pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|      7789 | 14702 | `					PH7_VmSetByteCodeContainer(pGen->pVm,&sArgRec.aByteCode);` |
|      7789 | 14703 | `					rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|      7789 | 14704 | `					PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|      7789 | 14705 | `					PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|      7789 | 14706 | `					if( rc == SXERR_ABORT ){` |
|       ! 0 | 14707 | `						pGen->pIn = pSavedIn;` |
|       ! 0 | 14708 | `						pGen->pEnd = pSavedEnd;` |
|       ! 0 | 14709 | `						return SXERR_ABORT;` |
|         - | 14710 | `					}` |
|      7789 | 14711 | `					SySetPut(&sAttr.aArgs,(const void *)&sArgRec);` |
|      3892 | 14712 | `				}` |
|      7789 | 14713 | `				pIn = pArgStop;` |
|      7789 | 14714 | `				if( pIn < pArgsEnd && (pIn->nType & PH7_TK_COMMA) ){` |
|        17 | 14715 | `					pIn++;` |
|         8 | 14716 | `				}` |
|         5 | 14717 | `			}` |
|      7775 | 14718 | `			pIn = (pArgsEnd < pEnd) ? &pArgsEnd[1] : pEnd;` |
|      3885 | 14719 | `		}` |
|      7877 | 14720 | `		SySetPut(pOut,(const void *)&sAttr);` |
|      7877 | 14721 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_COMMA) ){` |
|         5 | 14722 | `			pIn++;` |
|         5 | 14723 | `			continue;` |
|         - | 14724 | `		}` |
|      7873 | 14725 | `		break;` |
|       ! 0 | 14726 | `	}` |
|      7873 | 14727 | `	pGen->pIn = pSavedIn;` |
|      7873 | 14728 | `	pGen->pEnd = pSavedEnd;` |
|      7873 | 14729 | `	return SXRET_OK;` |
|      3939 | 14730 | `}` |
|         - | 14731 | `/*` |
...
|         - | 14734 | ` */` |
|   4393848 | 14735 | `static sxi32 GenStateConsumeAttrs(ph7_gen_state *pGen,SySet *pOut)` |
|         5 | 14736 | `{` |
|   4393853 | 14737 | `	ph7_trivia *aT = (ph7_trivia *)SySetBasePtr(&pGen->aPendingAttrs);` |
|         - | 14738 | `	sxu32 n;` |
|         - | 14739 | `	sxi32 rc;` |
|   4401709 | 14740 | `	for( n = 0 ; n < SySetUsed(&pGen->aPendingAttrs) ; n++ ){` |
|      7861 | 14741 | `		rc = GenStateCompileAttrSpan(&(*pGen),&aT[n],pOut);` |
|      7861 | 14742 | `		if( rc == SXERR_ABORT ){` |
|       ! 0 | 14743 | `			return SXERR_ABORT;` |
|         - | 14744 | `		}` |
|      3933 | 14745 | `	}` |
|   4393853 | 14746 | `	SySetReset(&pGen->aPendingAttrs);` |
|   4393853 | 14747 | `	return SXRET_OK;` |
|   2196929 | 14748 | `}` |
|         - | 14749 | `/*` |
...
|         - | 14753 | ` */` |
|   2110618 | 14754 | `static sxi32 GenStateCollectParamAttrs(ph7_gen_state *pGen,SyToken *pTok,SySet *pOut)` |
|         5 | 14755 | `{` |
|   2110623 | 14756 | `	SyToken *pBase = (SyToken *)SySetBasePtr(pGen->pTokenSet);` |
|   2110623 | 14757 | `	ph7_trivia *aT = (ph7_trivia *)SySetBasePtr(&pGen->aTrivia);` |
|   2110623 | 14758 | `	sxu32 nT = SySetUsed(&pGen->aTrivia);` |
|         - | 14759 | `	sxu32 nIdx, n;` |
|         - | 14760 | `	sxi32 rc;` |
|   2110618 | 14761 | `	if( nT < 1 \|\| pGen->pTokenSet == 0` |
|    552033 | 14762 | `	 \|\| pTok < pBase \|\| pTok >= &pBase[SySetUsed(pGen->pTokenSet)] ){` |
|   1558595 | 14763 | `		return SXRET_OK;` |
|         - | 14764 | `	}` |
|    552033 | 14765 | `	nIdx = (sxu32)(pTok - pBase);` |
|   1656087 | 14766 | `	for( n = 0 ; n < nT ; n++ ){` |
|   1104059 | 14767 | `		if( aT[n].nTokIdx == nIdx && aT[n].iKind == PH7_TRIVIA_ATTR ){` |
...
|         6 | 14772 | `		}` |
|    552032 | 14773 | `	}` |
|    552033 | 14774 | `	return SXRET_OK;` |
|   1055314 | 14775 | `}` |
|  12346812 | 14776 | `static sxi32 GenStateCompileChunk(` |
...
|         - | 14782 | `	sxi32 rc;` |
|  12346817 | 14783 | `	rc = SXRET_OK; /* Prevent compiler warning */` |
|   7164782 | 14784 | `	for(;;){` |
|  13338193 | 14785 | `		int bStmtIsDeclare = 0;` |
|  13338193 | 14786 | `		if( pGen->pIn >= pGen->pEnd ){` |
|         - | 14787 | `			/* No more input to process */` |
|     68255 | 14788 | `			break;` |
|         - | 14789 | `		}` |
|         - | 14790 | `		/* Bind a directly-preceding docblock to this statement */` |
|  13269943 | 14791 | `		GenStateSetPendingDoc(&(*pGen));` |
|  13269943 | 14792 | `		if( SySetUsed(&pGen->aPendingAttrs) > 0 ){` |
...
|      7779 | 14798 | `			int bAttrTarget = 0;` |
|      7774 | 14799 | `			if( GenStateStartsModifiedClass(pGen->pIn,pGen->pEnd)` |
|      3921 | 14800 | `			 \|\| GenStateStartsEnumDecl(pGen->pIn,pGen->pEnd) ){` |
|      7721 | 14801 | `				bAttrTarget = 1;` |
|      3917 | 14802 | `			}else if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
...
|  13269943 | 14824 | `		if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|   7726429 | 14825 | `			sxu32 nPeek = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   7726429 | 14826 | `			if( nPeek == PH7_TKWRD_DECLARE ){` |
|        47 | 14827 | `				bStmtIsDeclare = 1;` |
|        21 | 14828 | `			}` |
|   3863212 | 14829 | `		}` |
|  13269943 | 14830 | `		if( !bStmtIsDeclare && pGen->pCurrent == &pGen->sGlobal ){` |
...
|    991349 | 14833 | `			pGen->bStrictTypesLocked = 1;` |
|    495672 | 14834 | `		}` |
|  13269943 | 14835 | `		if( pGen->pIn->nType & PH7_TK_OCB /* '{' */ ){` |
|         - | 14836 | `			/* Compile block */` |
|      3899 | 14837 | `			rc = PH7_CompileBlock(&(*pGen),0);` |
|      3899 | 14838 | `			if( rc == SXERR_ABORT ){` |
|       ! 0 | 14839 | `				break;` |
|         - | 14840 | `			}` |
|      1952 | 14841 | `		}else{` |
|  13266049 | 14842 | `			xCons = 0;` |
|  13266049 | 14843 | `			if( GenStateStartsModifiedClass(pGen->pIn,pGen->pEnd) ){` |
...
|     38681 | 14847 | `				xCons = PH7_CompileClassModifiers;` |
|  13246711 | 14848 | `			}else if( GenStateStartsEnumDecl(pGen->pIn,pGen->pEnd) ){` |
|         - | 14849 | ``				/* `enum Name …` (PHP 8.1) — `enum` is a context-sensitive ID,`` |
|         - | 14850 | `				 * so it is detected here rather than the keyword dispatcher. */` |
|      3895 | 14851 | `				xCons = PH7_CompileEnum;` |
|  13225428 | 14852 | `			}else if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|   7687779 | 14853 | `				sxu32 nKeyword = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|         - | 14854 | `				/* Try to extract a language construct handler */` |
|   7687779 | 14855 | `				xCons = GenStateGetStatementHandler(nKeyword,(&pGen->pIn[1] < pGen->pEnd) ? &pGen->pIn[1] : 0);` |
|   7687779 | 14856 | `				if( xCons == 0 && GenStateisLangConstruct(nKeyword) == FALSE ){` |
...
|         4 | 14867 | `				}` |
|   9379596 | 14868 | `			}else if( (pGen->pIn->nType & PH7_TK_ID) && (&pGen->pIn[1] < pGen->pEnd)` |
|    414175 | 14869 | `				&& (pGen->pIn[1].nType & PH7_TK_COLON /*':'*/) ){` |
|         - | 14870 | `				/* Label found [i.e: Out: ],point to the routine responsible of compiling it */` |
|       117 | 14871 | `				xCons = PH7_CompileLabel;` |
|        56 | 14872 | `			}` |
|  13266049 | 14873 | `			if( xCons == 0 ){` |
|         - | 14874 | `				/* Assume an expression an try to compile it */` |
|   5586229 | 14875 | `				rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   5586229 | 14876 | `				if(  rc != SXERR_EMPTY ){` |
|         - | 14877 | `					/* Pop l-value */` |
|   5586079 | 14878 | `					PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|   2793037 | 14879 | `				}` |
|   2793117 | 14880 | `			}else{` |
|         - | 14881 | `				/* Go compile the sucker */` |
|   7679825 | 14882 | `				rc = xCons(&(*pGen));` |
|         - | 14883 | `			}` |
|  13266049 | 14884 | `			if( rc == SXERR_ABORT ){` |
|         - | 14885 | `				/* Request to abort compilation */` |
|        12 | 14886 | `				break;` |
|         - | 14887 | `			}` |
|         - | 14888 | `		}` |
|         - | 14889 | `		/* Ignore trailing semi-colons ';' */` |
|  22761949 | 14890 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|   9492021 | 14891 | `			pGen->pIn++;` |
|         5 | 14892 | `		}` |
|  13269933 | 14893 | `		if( iFlags & PH7_COMPILE_SINGLE_STMT ){` |
|         - | 14894 | `			/* Compile a single statement and return */` |
|  12278557 | 14895 | `			break;` |
|         - | 14896 | `		}` |
|         - | 14897 | `		/* LOOP ONE */` |
|         - | 14898 | `		/* LOOP TWO */` |
|         - | 14899 | `		/* LOOP THREE */` |
...
|         - | 14909 | ` */` |
|     68262 | 14910 | `static sxi32 PH7_CompilePHP(` |
...
|         - | 14914 | `	)` |
|         5 | 14915 | `{` |
|     68267 | 14916 | `	SyToken *pScript = pGen->pRawIn; /* Script to compile */` |
|         - | 14917 | `	sxi32 rc;` |
|         - | 14918 | `	/* Reset the token set (and its trivia sidecar) */` |
|     68267 | 14919 | `	SySetReset(&(*pTokenSet));` |
|     68267 | 14920 | `	SySetReset(&pGen->aTrivia);` |
|         - | 14921 | `	/* Mark as the default token set */` |
|     68267 | 14922 | `	pGen->pTokenSet = &(*pTokenSet);` |
|         - | 14923 | `	/* Advance the stream cursor */` |
|     68267 | 14924 | `	pGen->pRawIn++;` |
|         - | 14925 | `	/* Tokenize the PHP chunk first */` |
|     68267 | 14926 | `	PH7_TokenizePHP(SyStringData(&pScript->sData),SyStringLength(&pScript->sData),pScript->nLine,&(*pTokenSet),&pGen->aTrivia);` |
|         - | 14927 | `	/* Point to the head and tail of the token stream. */` |
|     68267 | 14928 | `	pGen->pIn  = (SyToken *)SySetBasePtr(pTokenSet);` |
|     68267 | 14929 | `	pGen->pEnd = &pGen->pIn[SySetUsed(pTokenSet)];` |
|     68267 | 14930 | `	if( is_expr ){` |
...
|         - | 14939 | `	}` |
|     68267 | 14940 | `	if( pGen->pIn < pGen->pEnd && ( pGen->pIn->nType & PH7_TK_EQUAL ) ){` |
...
|     68265 | 14965 | `	rc = GenStateCompileChunk(pGen,0);` |
|         - | 14966 | `	/* Fix exceptions jumps */` |
|     68265 | 14967 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|         - | 14968 | `	/* Fix gotos now, the jump destination is resolved */` |
|     68265 | 14969 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),0) ){` |
|         3 | 14970 | `		rc = SXERR_ABORT;` |
|         1 | 14971 | `	}` |
|         - | 14972 | `	/* Reset container */` |
|     68265 | 14973 | `	SySetReset(&pGen->aGoto);` |
|     68265 | 14974 | `	SySetReset(&pGen->aLabel);` |
|     68265 | 14975 | `	SySetReset(&pGen->aNullsafeJmp);` |
|         - | 14976 | `	/* Compilation result */` |
|     68265 | 14977 | `	return rc;` |
|     34136 | 14978 | `}` |
|         - | 14979 | `/*` |
...
|         - | 14983 | ` */` |
|     71488 | 14984 | `PH7_PRIVATE sxi32 PH7_CompileScript(` |
...
|         - | 14999 | `	sxi32 rc;` |
|     71493 | 15000 | `	sxu32 nBaseLine = 1;` |
|     71493 | 15001 | `	if( pScript->nByte < 1 ){` |
...
|     71493 | 15008 | `	if( pScript->nByte >= 2 && pScript->zString[0]=='#' && pScript->zString[1]=='!' ){` |
...
|     71493 | 15022 | `	pCodeGen = &pVm->sCodeGen;` |
...
|     71493 | 15029 | `	pSavedIn = pCodeGen->pIn;` |
|     71493 | 15030 | `	pSavedEnd = pCodeGen->pEnd;` |
|     71493 | 15031 | `	bSavedStrict = pCodeGen->bStrictTypes;` |
|     71493 | 15032 | `	bSavedStrictLocked = pCodeGen->bStrictTypesLocked;` |
|     71493 | 15033 | `	pCodeGen->bStrictTypes = 0;` |
|     71493 | 15034 | `	pCodeGen->bStrictTypesLocked = 0;` |
|         - | 15035 | `	/* Initialize the tokens containers */` |
|     71493 | 15036 | `	SySetInit(&aRawToken,&pVm->sAllocator,sizeof(SyToken));` |
|     71493 | 15037 | `	SySetInit(&aPhpToken,&pVm->sAllocator,sizeof(SyToken));` |
|     71493 | 15038 | `	SySetAlloc(&aPhpToken,0xc0);` |
|     71493 | 15039 | `	is_expr = 0;` |
|     71493 | 15040 | `	if( iFlags & PH7_PHP_ONLY ){` |
|         - | 15041 | `		SyToken sTmp;` |
|         - | 15042 | `		/* PHP only: -*/` |
|     57995 | 15043 | `		sTmp.nLine = 1;` |
|     57995 | 15044 | `		sTmp.nType = PH7_TOKEN_PHP;` |
|     57995 | 15045 | `		sTmp.pUserData = 0;` |
|     57995 | 15046 | `		SyStringDupPtr(&sTmp.sData,pScript);` |
|     57995 | 15047 | `		SySetPut(&aRawToken,(const void *)&sTmp);` |
|     57995 | 15048 | `		if( iFlags & PH7_PHP_EXPR ){` |
|         - | 15049 | `			/* A simple PHP expression */` |
|       ! 0 | 15050 | `			is_expr = 1;` |
|       ! 0 | 15051 | `		}` |
|     29000 | 15052 | `	}else{` |
|         - | 15053 | `		/* Tokenize raw text */` |
|     13503 | 15054 | `		SySetAlloc(&aRawToken,32);` |
|     13503 | 15055 | `		PH7_TokenizeRawText(pScript->zString,pScript->nByte,&aRawToken,nBaseLine);` |
|         - | 15056 | `	}` |
|         - | 15057 | `	/* Process high-level tokens */` |
|     71493 | 15058 | `	pCodeGen->pRawIn = (SyToken *)SySetBasePtr(&aRawToken);` |
|     71493 | 15059 | `	pCodeGen->pRawEnd = &pCodeGen->pRawIn[SySetUsed(&aRawToken)];` |
|     71493 | 15060 | `	rc = PH7_OK;` |
|     71493 | 15061 | `	if( is_expr ){` |
|         - | 15062 | `		/* Compile the expression */` |
|       ! 0 | 15063 | `		rc = PH7_CompilePHP(pCodeGen,&aPhpToken,TRUE);` |
|       ! 0 | 15064 | `		goto cleanup;` |
|         - | 15065 | `	}` |
|     71493 | 15066 | `	nObjIdx = 0;` |
...
|     71493 | 15070 | `	PH7_VmEmitInstr(pVm,PH7_OP_NSSWITCH,0,0,0,0);` |
|         - | 15071 | `	/* Start the compilation process */` |
|     42498 | 15072 | `	for(;;){` |
|    153251 | 15073 | `		if( pCodeGen->pRawIn >= pCodeGen->pRawEnd ){` |
|     71481 | 15074 | `			break; /* No more tokens to process */` |
|         - | 15075 | `		}` |
|     81775 | 15076 | `		if( pCodeGen->pRawIn->nType & PH7_TOKEN_PHP ){` |
|         - | 15077 | `			/* Compile the PHP chunk */` |
|     68267 | 15078 | `			rc = PH7_CompilePHP(pCodeGen,&aPhpToken,FALSE);` |
|     68267 | 15079 | `			if( rc == SXERR_ABORT ){` |
|        15 | 15080 | `				break;` |
|         - | 15081 | `			}` |
|     68255 | 15082 | `			continue;` |
|         - | 15083 | `		}` |
|         - | 15084 | `		/* Raw chunk: [i.e: HTML, XML, etc.] */` |
|     13513 | 15085 | `		nRawObj = 0;` |
|     27021 | 15086 | `		while( (pCodeGen->pRawIn < pCodeGen->pRawEnd) && (pCodeGen->pRawIn->nType != PH7_TOKEN_PHP) ){` |
|         - | 15087 | `			/* Consume the raw chunk without any processing */` |
|     13513 | 15088 | `			pRawObj = PH7_ReserveConstObj(&(*pVm),&nObjIdx);` |
|     13513 | 15089 | `			if( pRawObj == 0 ){` |
|       ! 0 | 15090 | `				rc = SXERR_MEM;` |
|       ! 0 | 15091 | `				break;` |
|         - | 15092 | `			}` |
|         - | 15093 | `			/* Mark as constant and emit the load constant instruction */` |
|     13513 | 15094 | `			PH7_MemObjInitFromString(pVm,pRawObj,&pCodeGen->pRawIn->sData);` |
|     13513 | 15095 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_LOADC,0,nObjIdx,0,0);` |
|     13513 | 15096 | `			++nRawObj;` |
|     13513 | 15097 | `			pCodeGen->pRawIn++; /* Next chunk */` |
|         5 | 15098 | `		}` |
|     13513 | 15099 | `		if( nRawObj > 0 ){` |
|         - | 15100 | `			/* Emit the consume instruction */` |
|     13513 | 15101 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_CONSUME,nRawObj,0,0,0);` |
|      6754 | 15102 | `		}` |
|     35749 | 15103 | `	}` |
|     35744 | 15104 | `cleanup:` |
|         - | 15105 | `	/* Drop the cursor into the token set BEFORE the set is freed (see above). */` |
|     71493 | 15106 | `	pCodeGen->pIn = pSavedIn;` |
|     71493 | 15107 | `	pCodeGen->pEnd = pSavedEnd;` |
|     71493 | 15108 | `	SySetRelease(&aRawToken);` |
|     71493 | 15109 | `	SySetRelease(&aPhpToken);` |
|         - | 15110 | `	/* Restore outer file's strict_types scope */` |
|     71493 | 15111 | `	pCodeGen->bStrictTypes = bSavedStrict;` |
|     71493 | 15112 | `	pCodeGen->bStrictTypesLocked = bSavedStrictLocked;` |
|     71493 | 15113 | `	return rc;` |
|     35749 | 15114 | `}` |
|         - | 15115 | `/*` |
|         - | 15116 | ` * Utility routines.Initialize the code generator.` |
|         - | 15117 | ` */` |
|      3858 | 15118 | `PH7_PRIVATE sxi32 PH7_InitCodeGenerator(` |
|         - | 15119 | `	ph7_vm *pVm,       /* Target VM */` |
|         - | 15120 | `	ProcConsumer xErr, /* Error log consumer callabck  */` |
|         - | 15121 | `	void *pErrData     /* Last argument to xErr() */` |
|         - | 15122 | `	)` |
|         5 | 15123 | `{` |
|      3863 | 15124 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|         - | 15125 | `	/* Zero the structure */` |
|      3863 | 15126 | `	SyZero(pGen,sizeof(ph7_gen_state));` |
|         - | 15127 | `	/* Initial state */` |
|      3863 | 15128 | `	pGen->pVm  = &(*pVm);` |
|      3863 | 15129 | `	pGen->xErr = xErr;` |
|      3863 | 15130 | `	pGen->pErrData = pErrData;` |
|      3863 | 15131 | `	SySetInit(&pGen->aLabel,&pVm->sAllocator,sizeof(Label));` |
|      3863 | 15132 | `	SySetInit(&pGen->aGoto,&pVm->sAllocator,sizeof(JumpFixup));` |
|      3863 | 15133 | `	SySetInit(&pGen->aLoopParent,&pVm->sAllocator,sizeof(sxu32));` |
|      3863 | 15134 | `	pGen->nLoopId = pGen->nCurLoopId = 0;` |
|      3863 | 15135 | `	SySetInit(&pGen->aNullsafeJmp,&pVm->sAllocator,sizeof(sxu32));` |
|      3863 | 15136 | `	SySetInit(&pGen->aTrivia,&pVm->sAllocator,sizeof(ph7_trivia));` |
|      3863 | 15137 | `	SySetInit(&pGen->aPendingAttrs,&pVm->sAllocator,sizeof(ph7_trivia));` |
|      3863 | 15138 | `	SyHashInit(&pGen->hLiteral,&pVm->sAllocator,0,0);` |
|      3863 | 15139 | `	SyHashInit(&pGen->hVar,&pVm->sAllocator,0,0);` |
|         - | 15140 | `	/* Error log buffer */` |
|      3863 | 15141 | `	SyBlobInit(&pGen->sErrBuf,&pVm->sAllocator);` |
|         - | 15142 | `	/* General purpose working buffer */` |
|      3863 | 15143 | `	SyBlobInit(&pGen->sWorker,&pVm->sAllocator);` |
|         - | 15144 | `	/* Namespace state */` |
|      3863 | 15145 | `	SyBlobInit(&pGen->sNamespace,&pVm->sAllocator);` |
|      3863 | 15146 | `	SyHashInit(&pGen->hUseImports,&pVm->sAllocator,0,0);` |
|      3863 | 15147 | `	SyHashInit(&pGen->hUseFuncImports,&pVm->sAllocator,0,0);` |
|      3863 | 15148 | `	SyHashInit(&pGen->hUseConstImports,&pVm->sAllocator,0,0);` |
|         - | 15149 | `	/* Create the global scope */` |
|      3863 | 15150 | `	GenStateInitBlock(pGen,&pGen->sGlobal,GEN_BLOCK_GLOBAL,PH7_VmInstrLength(&(*pVm)),0);` |
|         - | 15151 | `	/* Point to the global scope */` |
|      3863 | 15152 | `	pGen->pCurrent = &pGen->sGlobal;` |
|      3863 | 15153 | `	return SXRET_OK;` |
|         5 | 15154 | `}` |
|         - | 15155 | `/*` |
|         - | 15156 | ` * Utility routines. Reset the code generator to it's initial state.` |
|         - | 15157 | ` */` |
|     74886 | 15158 | `PH7_PRIVATE sxi32 PH7_ResetCodeGenerator(` |
|         - | 15159 | `	ph7_vm *pVm,       /* Target VM */` |
|         - | 15160 | `	ProcConsumer xErr, /* Error log consumer callabck  */` |
|         - | 15161 | `	void *pErrData     /* Last argument to xErr() */` |
|         - | 15162 | `	)` |
|         5 | 15163 | `{` |
|     74891 | 15164 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|         - | 15165 | `	GenBlock *pBlock,*pParent;` |
|         - | 15166 | `	/* Reset state */` |
|     74891 | 15167 | `	SySetReset(&pGen->aLabel);` |
|     74891 | 15168 | `	SySetReset(&pGen->aGoto);` |
|     74891 | 15169 | `	SySetReset(&pGen->aNullsafeJmp);` |
|     74891 | 15170 | `	SySetReset(&pGen->aTrivia);` |
|     74891 | 15171 | `	SySetReset(&pGen->aPendingAttrs);` |
|     74891 | 15172 | `	SyStringInitFromBuf(&pGen->sPendingDoc,0,0);` |
|     74891 | 15173 | `	SyBlobRelease(&pGen->sErrBuf);` |
|     74891 | 15174 | `	SyBlobRelease(&pGen->sWorker);` |
|     74891 | 15175 | `	SyBlobRelease(&pGen->sNamespace);` |
|     74891 | 15176 | `	SyBlobInit(&pGen->sNamespace,&pVm->sAllocator);` |
|     74891 | 15177 | `	SyHashRelease(&pGen->hUseImports);` |
|     74891 | 15178 | `	SyHashInit(&pGen->hUseImports,&pVm->sAllocator,0,0);` |
|     74891 | 15179 | `	SyHashRelease(&pGen->hUseFuncImports);` |
|     74891 | 15180 | `	SyHashInit(&pGen->hUseFuncImports,&pVm->sAllocator,0,0);` |
|     74891 | 15181 | `	SyHashRelease(&pGen->hUseConstImports);` |
|     74891 | 15182 | `	SyHashInit(&pGen->hUseConstImports,&pVm->sAllocator,0,0);` |
...
|     74891 | 15190 | `	pBlock = pGen->pCurrent;` |
|     74891 | 15191 | `	while( pBlock->pParent != 0 ){` |
|       ! 0 | 15192 | `		pParent = pBlock->pParent;` |
|       ! 0 | 15193 | `		GenStateFreeBlock(pBlock);` |
|       ! 0 | 15194 | `		pBlock = pParent;` |
|       ! 0 | 15195 | `	}` |
|     74891 | 15196 | `	pGen->xErr = xErr;` |
|     74891 | 15197 | `	pGen->pErrData = pErrData;` |
|     74891 | 15198 | `	pGen->pCurrent = &pGen->sGlobal;` |
|     74891 | 15199 | `	pGen->pRawIn = pGen->pRawEnd = 0;` |
|     74891 | 15200 | `	pGen->pIn = pGen->pEnd = 0;` |
|     74891 | 15201 | `	pGen->nErr = 0;` |
|     74891 | 15202 | `	return SXRET_OK;` |
|         5 | 15203 | `}` |
|         - | 15204 | `/*` |
...
|         9 | 15350 | `		zNoun = "variable";` |
|       171 | 15351 | `	}else if( pTok->nType & PH7_TK_INTEGER ){` |
|        23 | 15352 | `		zNoun = "integer";` |
...
|         - | 15368 | ` */` |
|     16108 | 15369 | `PH7_PRIVATE sxi32 PH7_GenCompileError(ph7_gen_state *pGen,sxi32 nErrType,sxu32 nLine,const char *zFormat,...)` |
|         5 | 15370 | `{` |
|     16113 | 15371 | `	SyBlob *pWorker = &pGen->sErrBuf;` |
|     16113 | 15372 | `	const char *zErr = "Error";` |
|         - | 15373 | `	SyString *pFile;` |
|         - | 15374 | `	va_list ap;` |
|         - | 15375 | `	sxi32 rc;` |
|         - | 15376 | `	/* Reset the working buffer */` |
|     16113 | 15377 | `	SyBlobReset(pWorker);` |
|         - | 15378 | `	/* Peek the processed file path if available */` |
|     16113 | 15379 | `	pFile = (SyString *)SySetPeek(&pGen->pVm->aFiles);` |
|     16113 | 15380 | `	if( nErrType == E_ERROR \|\| nErrType == E_PARSE ){` |
...
|         - | 15401 | `		}` |
|       325 | 15402 | `	}` |
|     16109 | 15403 | `	if( pGen->xErr == 0 ){` |
|         - | 15404 | `		/* No available error consumer,return immediately */` |
|     15439 | 15405 | `		return SXRET_OK;` |
|         - | 15406 | `	}` |
