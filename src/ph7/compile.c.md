...
|       - |   136 | ` */` |
|    3822 |   137 | `static GenBlock * GenStateFetchBlock(GenBlock *pCurrent,sxi32 iBlockType,sxi32 iCount)` |
|       5 |   138 |  |
|    3827 |   139 | `	GenBlock *pBlock = pCurrent;` |
|   10883 |   140 | `	for(;;){` |
|   21771 |   141 | `		if( pBlock->iFlags & iBlockType ){` |
|    3719 |   142 | `			iCount--; /* Decrement nesting level */` |
|    3719 |   143 | `			if( iCount < 1 ){` |
|       - |   144 | `				/* Block meet with the desired criteria */` |
|    3693 |   145 | `				return pBlock;` |
|       - |   146 | `			}` |
|      13 |   147 | `		}` |
|       - |   148 | `		/* Point to the upper block */` |
|   18083 |   149 | `		pBlock = pBlock->pParent;` |
|   18083 |   150 | `		if( pBlock == 0 \|\| (pBlock->iFlags & (GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC)) ){` |
|       - |   151 | `			/* Forbidden */` |
|      72 |   152 | `			break;` |
|       - |   153 | `		}` |
|       5 |   154 | `	}` |
...
|       - |   160 | ` */` |
|  837448 |   161 | `static void GenStateInitBlock(` |
...
|  837453 |   170 | `	pBlock->nFirstInstr = nFirstInstr;` |
|  837453 |   171 | `	pBlock->pUserData   = pUserData;` |
|  837453 |   172 | `	pBlock->pGen        = pGen;` |
|  837453 |   173 | `	pBlock->iFlags      = iType;` |
|  837453 |   174 | `	pBlock->pParent     = 0;` |
|  837453 |   175 | `	SySetInit(&pBlock->aJumpFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  837453 |   176 | `	SySetInit(&pBlock->aPostContFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  837453 |   177 |  |
|       - |   178 | `/*` |
...
|       - |   183 | ` */` |
|  833904 |   184 | `static sxi32 GenStateEnterBlock(` |
...
|  833909 |   194 | `	pBlock = (GenBlock *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(GenBlock));` |
|  833909 |   195 | `	if( pBlock == 0 ){` |
...
|  833909 |   204 | `	SyZero(pBlock,sizeof(GenBlock));` |
|  833909 |   205 | `	GenStateInitBlock(&(*pGen),pBlock,iType,nFirstInstr,pUserData);` |
|       - |   206 | `	/* Link to the parent block */` |
|  833909 |   207 | `	pBlock->pParent = pGen->pCurrent;` |
|       - |   208 | `	/* Mark as the current block */` |
|  833909 |   209 | `	pGen->pCurrent = pBlock;` |
|  833909 |   210 | `	if( ppBlock ){` |
|       - |   211 | `		/* Write a pointer to the new instance */` |
|  405065 |   212 | `		*ppBlock = pBlock;` |
|  202530 |   213 | `	}` |
|  833909 |   214 | `	return SXRET_OK;` |
|  416957 |   215 |  |
|       - |   216 | `/*` |
|       - |   217 | ` * Release block fields without freeing the whole instance.` |
|       - |   218 | ` */` |
|  833896 |   219 | `static void GenStateReleaseBlock(GenBlock *pBlock)` |
|       5 |   220 |  |
|  833901 |   221 | `	SySetRelease(&pBlock->aPostContFix);` |
|  833901 |   222 | `	SySetRelease(&pBlock->aJumpFix);` |
|  833901 |   223 |  |
|       - |   224 | `/*` |
|       - |   225 | ` * Release a block.` |
|       - |   226 | ` */` |
|  833896 |   227 | `static void GenStateFreeBlock(GenBlock *pBlock)` |
|       5 |   228 |  |
|  833901 |   229 | `	ph7_gen_state *pGen = pBlock->pGen;` |
|  833901 |   230 | `	GenStateReleaseBlock(&(*pBlock));` |
|       - |   231 | `	/* Free the instance */` |
|  833901 |   232 | `	SyMemBackendPoolFree(&pGen->pVm->sAllocator,pBlock);` |
|  833901 |   233 |  |
|       - |   234 | `/*` |
|       - |   235 | ` * POP and release a block from the stack of compiled blocks.` |
|       - |   236 | ` */` |
|  833896 |   237 | `static sxi32 GenStateLeaveBlock(ph7_gen_state *pGen,GenBlock **ppBlock)` |
|       5 |   238 |  |
|  833901 |   239 | `	GenBlock *pBlock = pGen->pCurrent;` |
|  833901 |   240 | `	if( pBlock == 0 ){` |
|       - |   241 | `		/* No more block to pop */` |
|     ! 0 |   242 | `		return SXERR_EMPTY;` |
|       - |   243 | `	}` |
|       - |   244 | `	/* Point to the upper block */` |
|  833901 |   245 | `	pGen->pCurrent = pBlock->pParent;` |
|  833901 |   246 | `	if( ppBlock ){` |
|       - |   247 | `		/* Write a pointer to the popped block */` |
|     ! 0 |   248 | `		*ppBlock = pBlock;` |
|     ! 0 |   249 | `	}else{` |
|       - |   250 | `		/* Safely release the block */` |
|  833901 |   251 | `		GenStateFreeBlock(&(*pBlock));` |
|       - |   252 | `	}` |
|  833901 |   253 | `	return SXRET_OK;` |
|  416953 |   254 |  |
|       - |   255 | `/*` |
...
|       - |   264 | ` */` |
|  240208 |   265 | `static sxi32 GenStateNewJumpFixup(GenBlock *pBlock,sxi32 nJumpType,sxu32 nInstrIdx)` |
|       5 |   266 |  |
|       - |   267 | `	JumpFixup sJumpFix;` |
|       - |   268 | `	sxi32 rc;` |
|       - |   269 | `	/* Init the JumpFixup structure */` |
|  240213 |   270 | `	sJumpFix.nJumpType = nJumpType;` |
|  240213 |   271 | `	sJumpFix.nInstrIdx = nInstrIdx;` |
|       - |   272 | `	/* Insert in the jump fixup table */` |
|  240213 |   273 | `	rc = SySetPut(&pBlock->aJumpFix,(const void *)&sJumpFix);` |
|  240213 |   274 | `	return rc;` |
|       5 |   275 |  |
|       - |   276 | `/*` |
...
|       - |   286 | ` */` |
|  582186 |   287 | `static sxu32 GenStateFixJumps(GenBlock *pBlock,sxi32 nJumpType,sxu32 nJumpDest)` |
|       5 |   288 |  |
|       - |   289 | `	JumpFixup *aFix;` |
|       - |   290 | `	VmInstr *pInstr;` |
|       - |   291 | `	sxu32 nFixed;` |
...
|  582191 |   294 | `	aFix = (JumpFixup *)SySetBasePtr(&pBlock->aJumpFix);` |
|       - |   295 | `	/* Fix the desired jumps */` |
| 1051845 |   296 | `	for( nFixed = n = 0 ; n < SySetUsed(&pBlock->aJumpFix) ; ++n ){` |
|  469659 |   297 | `		if( aFix[n].nJumpType < 0 ){` |
|       - |   298 | `			/* Already fixed */` |
|  185787 |   299 | `			continue;` |
|       - |   300 | `		}` |
|  283877 |   301 | `		if( nJumpType > 0 && aFix[n].nJumpType != nJumpType ){` |
|       - |   302 | `			/* Not of our interest */` |
|   43671 |   303 | `			continue;` |
|       - |   304 | `		}` |
|       - |   305 | `		/* Point to the instruction to fix */` |
|  240211 |   306 | `		pInstr = PH7_VmGetInstr(pBlock->pGen->pVm,aFix[n].nInstrIdx);` |
|  240211 |   307 | `		if( pInstr ){` |
|  240211 |   308 | `			pInstr->iP2 = nJumpDest;` |
|  240211 |   309 | `			nFixed++;` |
|       - |   310 | `			/* Mark as fixed */` |
|  240211 |   311 | `			aFix[n].nJumpType = -1;` |
|  120103 |   312 | `		}` |
|  120108 |   313 | `	}` |
|       - |   314 | `	/* Total number of fixed jumps */` |
|  582191 |   315 | `	return nFixed;` |
|       5 |   316 |  |
|       - |   317 | `/*` |
...
|       - |   323 | ` */` |
|  236396 |   324 | `static sxi32 GenStateFixGoto(ph7_gen_state *pGen,sxu32 nOfft)` |
|       5 |   325 |  |
...
|  236401 |   332 | `	aJumps = (JumpFixup *)SySetBasePtr(&pGen->aGoto);` |
|       - |   333 | `	/* Fix */` |
|  236547 |   334 | `	for( n = nOfft ; n < SySetUsed(&pGen->aGoto) ; ++n ){` |
...
|      46 |   357 | `		}` |
|      51 |   358 | `	}` |
|  236399 |   359 | `	aLabel = (Label *)SySetBasePtr(&pGen->aLabel);` |
|  236531 |   360 | `	for( n = 0 ; n < SySetUsed(&pGen->aLabel) ; ++n ){` |
...
|      12 |   365 | `		}` |
|      71 |   366 | `	}` |
|  236399 |   367 | `	return SXRET_OK;` |
|  118203 |   368 |  |
|       - |   369 | `/*` |
|       - |   370 | ` * Check if a given token value is installed in the literal table.` |
|       - |   371 | ` */` |
|  762308 |   372 | `static sxi32 GenStateFindLiteral(ph7_gen_state *pGen,const SyString *pValue,sxu32 *pIdx)` |
|       5 |   373 |  |
|       - |   374 | `	SyHashEntry *pEntry;` |
|  762313 |   375 | `	pEntry = SyHashGet(&pGen->hLiteral,(const void *)pValue->zString,pValue->nByte);` |
|  762313 |   376 | `	if( pEntry == 0 ){` |
|  343261 |   377 | `		return SXERR_NOTFOUND;` |
|       - |   378 | `	}` |
|  419057 |   379 | `	*pIdx = (sxu32)SX_PTR_TO_INT(pEntry->pUserData);` |
|  419057 |   380 | `	return SXRET_OK;` |
|  381159 |   381 |  |
|       - |   382 | `/*` |
...
|       - |   391 | ` */` |
|  343256 |   392 | `static sxi32 GenStateInstallLiteral(ph7_gen_state *pGen,ph7_value *pObj,sxu32 nIdx)` |
|       5 |   393 |  |
|  343261 |   394 | `	if( SyBlobLength(&pObj->sBlob) > 0 ){` |
|  343261 |   395 | `		SyHashInsert(&pGen->hLiteral,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob),SX_INT_TO_PTR(nIdx));` |
|  171628 |   396 | `	}` |
|  343261 |   397 | `	return SXRET_OK;` |
|       5 |   398 |  |
|       - |   399 | `/*` |
|       - |   400 | ` * Reserve a room for a numeric constant [i.e: 64-bit integer or real number]` |
|       - |   401 | ` * in the constant table.` |
|       - |   402 | ` */` |
|  124432 |   403 | `static ph7_value * GenStateInstallNumLiteral(ph7_gen_state *pGen,sxu32 *pIdx)` |
|       5 |   404 |  |
|       - |   405 | `	ph7_value *pObj;` |
|  124437 |   406 | `	sxu32 nIdx = 0; /* cc warning */` |
|       - |   407 | `	/* Reserve a new constant */` |
|  124437 |   408 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  124437 |   409 | `	if( pObj == 0 ){` |
|     ! 0 |   410 | `		PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|     ! 0 |   411 | `		return 0;` |
|       - |   412 | `	}` |
|  124437 |   413 | `	*pIdx = nIdx;` |
|       - |   414 | `	/* TODO(chems): Create a numeric table (64bit int keys) same as` |
|       - |   415 | `	 * the constant string iterals table [optimization purposes].` |
|       - |   416 | `	 */` |
|  124437 |   417 | `	return pObj;` |
|   62221 |   418 |  |
|       - |   419 | `/*` |
...
|       - |   432 | ` */` |
|  475900 |   433 | `static void *GenStateAttachStrictFlag(ph7_gen_state *pGen, void *p3)` |
|       5 |   434 |  |
|       - |   435 | `	VmCallArgMap *pMap;` |
|  475905 |   436 | `	if( !pGen->bStrictTypes ) return p3;` |
|      33 |   437 | `	if( p3 == 0 ){` |
...
|       - |   503 | ` */` |
|  125096 |   504 | `static int GenStateFindBadNumericSeparator(` |
|       - |   505 | `	const SyString *pRaw, const char **pBadStart, sxu32 *pBadLen)` |
|       5 |   506 |  |
|  125101 |   507 | `	const char *z = pRaw->zString;` |
|  125101 |   508 | `	sxu32 n = pRaw->nByte;` |
|  125101 |   509 | `	int base = 10;` |
|       - |   510 | `	sxu32 i, start;` |
|  125101 |   511 | `	if( n < 2 ) return 0;` |
|   10389 |   512 | `	if( z[0] == '0' && (z[1] == 'x' \|\| z[1] == 'X') ){` |
|      72 |   513 | `		base = 16;` |
|   10354 |   514 | `	}else if( z[0] == '0' && (z[1] == 'b' \|\| z[1] == 'B') ){` |
|     280 |   515 | `		base = 2;` |
|     139 |   516 | `	}` |
|   37545 |   517 | `	for( i = 0; i < n; ++i ){` |
|   27175 |   518 | `		if( z[i] != '_' ) continue;` |
...
|       - |   544 | ` */` |
|  125096 |   545 | `static sxi32 GenStateValidateNumericSeparator(ph7_gen_state *pGen, SyToken *pToken)` |
|       5 |   546 |  |
|  125101 |   547 | `	const char *zBad = 0;` |
|  125101 |   548 | `	sxu32 nBad = 0;` |
|       - |   549 | `	SyString sBad;` |
|       - |   550 | `	sxi32 rc;` |
|  125101 |   551 | `	if( !GenStateFindBadNumericSeparator(&pToken->sData, &zBad, &nBad) ){` |
|  125087 |   552 | `		return SXRET_OK;` |
|       - |   553 | `	}` |
...
|       - |   577 | ` */` |
|  125082 |   578 | `static sxi32 GenStateStripNumericSeparators(` |
...
|       5 |   583 |  |
|       - |   584 | `	sxu32 i, j;` |
|  125087 |   585 | `	int hasUnderscore = 0;` |
|       - |   586 | `	char *zBuf;` |
|  125087 |   587 | `	*pzAlloc = 0;` |
|  264889 |   588 | `	for( i = 0; i < pToken->nByte; ++i ){` |
|  140059 |   589 | `		if( pToken->zString[i] == '_' ){ hasUnderscore = 1; break; }` |
|   69906 |   590 | `	}` |
|  125087 |   591 | `	if( !hasUnderscore ){` |
|  124835 |   592 | `		SyStringDupPtr(pOut, pToken);` |
|  124835 |   593 | `		return SXRET_OK;` |
|       - |   594 | `	}` |
...
|       - |   625 | ` *  documentation.` |
|       - |   626 | ` */` |
|  125068 |   627 | `static sxi32 PH7_CompileNumLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |   628 |  |
|  125073 |   629 | `	SyToken *pToken = pGen->pIn; /* Raw token */` |
|  125073 |   630 | `	sxu32 nIdx = 0;` |
|       - |   631 | `	char zScratch[GEN_NUM_SCRATCH];` |
|  125073 |   632 | `	char *zAlloc = 0;` |
|       - |   633 | `	SyString sNum;` |
|       - |   634 | `	sxi32 rc;` |
|   62534 |   635 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|  125073 |   636 | `	rc = GenStateValidateNumericSeparator(pGen, pToken);` |
|  125073 |   637 | `	if( rc != SXRET_OK ){` |
|      14 |   638 | `		return rc;` |
|       - |   639 | `	}` |
|  187592 |   640 | `	rc = GenStateStripNumericSeparators(&pGen->pVm->sAllocator, &pToken->sData,` |
|   62529 |   641 | `		zScratch, sizeof(zScratch), &sNum, &zAlloc);` |
|  125063 |   642 | `	if( rc != SXRET_OK ){` |
|     ! 0 |   643 | `		return SXERR_ABORT;` |
|       - |   644 | `	}` |
|  125063 |   645 | `	if( pToken->nType & PH7_TK_INTEGER ){` |
|       - |   646 | `		ph7_value *pObj;` |
|       - |   647 | `		sxi64 iValue;` |
|  124437 |   648 | `		iValue = PH7_TokenValueToInt64(&sNum);` |
|  124437 |   649 | `		pObj = GenStateInstallNumLiteral(&(*pGen),&nIdx);` |
|  124437 |   650 | `		if( pObj == 0 ){` |
|     ! 0 |   651 | `			if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|     ! 0 |   652 | `			return SXERR_ABORT;` |
|       - |   653 | `		}` |
|  124437 |   654 | `		PH7_MemObjInitFromInt(pGen->pVm,pObj,iValue);` |
|   62221 |   655 | `	}else{` |
|       - |   656 | `		/* Real number */` |
|       - |   657 | `		ph7_value *pObj;` |
...
|       - |   667 | `	}` |
|  125063 |   668 | `	if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|       - |   669 | `	/* Emit the load constant instruction */` |
|  125063 |   670 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|       - |   671 | `	/* Node successfully compiled */` |
|  125063 |   672 | `	return SXRET_OK;` |
|   62539 |   673 |  |
|       - |   674 | `/*` |
...
|       - |   683 | ` *` |
|       - |   684 | ` */` |
|   99960 |   685 | `PH7_PRIVATE sxi32 PH7_CompileSimpleString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |   686 |  |
|   99965 |   687 | `	SyString *pStr = &pGen->pIn->sData; /* Constant string literal */` |
|       - |   688 | `	const char *zIn,*zCur,*zEnd;` |
|       - |   689 | `	ph7_value *pObj;` |
|       - |   690 | `	sxu32 nIdx;` |
|   99965 |   691 | `	nIdx = 0; /* Prevent compiler warning */` |
|       - |   692 | `	/* Delimit the string */` |
|   99965 |   693 | `	zIn  = pStr->zString;` |
|   99965 |   694 | `	zEnd = &zIn[pStr->nByte];` |
|   99965 |   695 | `	if( zIn >= zEnd ){` |
|       - |   696 | `		/* Empty string constant: just use the pre‑allocated index from the VM` |
|       - |   697 | `		 * rather than reserving a new object each time. */` |
|    7259 |   698 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,pGen->pVm->nEmptyStringIdx,0,0);` |
|    7259 |   699 | `		return SXRET_OK;` |
|       - |   700 | `	}` |
|   92711 |   701 | `	if( SXRET_OK == GenStateFindLiteral(&(*pGen),pStr,&nIdx) ){` |
|       - |   702 | `		/* Already processed,emit the load constant instruction` |
|       - |   703 | `		 * and return.` |
|       - |   704 | `		 */` |
|   35861 |   705 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   35861 |   706 | `		return SXRET_OK;` |
|       - |   707 | `	}` |
|       - |   708 | `	/* Reserve a new constant */` |
|   56855 |   709 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   56855 |   710 | `	if( pObj == 0 ){` |
...
|       - |   714 | `	}` |
|   56855 |   715 | `	PH7_MemObjInitFromString(pGen->pVm,pObj,0);` |
|       - |   716 | `	/* Compile the node */` |
|   56905 |   717 | `	for(;;){` |
|  113815 |   718 | `		if( zIn >= zEnd ){` |
|       - |   719 | `			/* End of input */` |
|   56855 |   720 | `			break;` |
|       - |   721 | `		}` |
|   56965 |   722 | `		zCur = zIn;` |
|  973413 |   723 | `		while( zIn < zEnd && zIn[0] != '\\' ){` |
|  916453 |   724 | `			zIn++;` |
|       5 |   725 | `		}` |
|   56965 |   726 | `		if( zIn > zCur ){` |
|       - |   727 | `			/* Append raw contents*/` |
|   56941 |   728 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|   28468 |   729 | `		}` |
|   56965 |   730 | `		zIn++;` |
|   56965 |   731 | `		if( zIn < zEnd ){` |
|     132 |   732 | `			if( zIn[0] == '\\' ){` |
...
|   56855 |   749 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   56855 |   750 | `	if( pStr->nByte < 1024 ){` |
|       - |   751 | `		/* Install in the literal table */` |
|   56855 |   752 | `		GenStateInstallLiteral(pGen,pObj,nIdx);` |
|   28425 |   753 | `	}` |
|       - |   754 | `	/* Node successfully compiled */` |
|   56855 |   755 | `	return SXRET_OK;` |
|   49985 |   756 |  |
|       - |   757 | `/*` |
...
|       - |   955 | ` */` |
|   25074 |   956 | `static ph7_value * GenStateNewStrObj(ph7_gen_state *pGen,sxi32 *pCount)` |
|       5 |   957 |  |
|       - |   958 | `	ph7_value *pConstObj;` |
|   25079 |   959 | `	sxu32 nIdx = 0;` |
|       - |   960 | `	/* Reserve a new constant */` |
|   25079 |   961 | `	pConstObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   25079 |   962 | `	if( pConstObj == 0 ){` |
|     ! 0 |   963 | `		PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"PH7 engine is running out of memory");` |
|     ! 0 |   964 | `		return 0;` |
|       - |   965 | `	}` |
|   25079 |   966 | `	(*pCount)++;` |
|   25079 |   967 | `	PH7_MemObjInitFromString(pGen->pVm,pConstObj,0);` |
|       - |   968 | `	/* Emit the load constant instruction */` |
|   25079 |   969 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   25079 |   970 | `	return pConstObj;` |
|   12542 |   971 |  |
|       - |   972 | `/*` |
...
|       - |  1009 | ` */` |
|   23594 |  1010 | `static sxi32 GenStateCompileString(ph7_gen_state *pGen)` |
|       5 |  1011 |  |
|   23599 |  1012 | `	SyString *pStr = &pGen->pIn->sData; /* Raw token value */` |
|       - |  1013 | `	const char *zIn,*zCur,*zEnd;` |
|   23599 |  1014 | `	ph7_value *pObj = 0;` |
|       - |  1015 | `	sxi32 iCons;` |
|       - |  1016 | `	sxi32 rc;` |
|       - |  1017 | `	/* Delimit the string */` |
|   23599 |  1018 | `	zIn  = pStr->zString;` |
|   23599 |  1019 | `	zEnd = &zIn[pStr->nByte];` |
|   23599 |  1020 | `	if( zIn >= zEnd ){` |
...
|   12770 |  1031 | `	for(;;){` |
|   38193 |  1032 | `		zCur = zIn;` |
|  178395 |  1033 | `		while( zIn < zEnd && zIn[0] != '\\'  ){` |
|  142461 |  1034 | `			if( zIn[0] == '{' && &zIn[1] < zEnd && zIn[1] == '$' ){` |
|      67 |  1035 | `				break;` |
|  142337 |  1036 | `			}else if(zIn[0] == '$' && &zIn[1] < zEnd &&` |
|    2134 |  1037 | `				(((unsigned char)zIn[1] >= 0xc0 \|\| SyisAlpha(zIn[1]) \|\| zIn[1] == '{' \|\| zIn[1] == '_')) ){` |
|    1068 |  1038 | `					break;` |
|       - |  1039 | `			}` |
|  140207 |  1040 | `			zIn++;` |
|       5 |  1041 | `		}` |
|   38193 |  1042 | `		if( zIn > zCur ){` |
|   17731 |  1043 | `			if( pObj == 0 ){` |
|   17257 |  1044 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|   17257 |  1045 | `				if( pObj == 0 ){` |
|     ! 0 |  1046 | `					return SXERR_ABORT;` |
|       - |  1047 | `				}` |
|    8626 |  1048 | `			}` |
|   17731 |  1049 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|    8863 |  1050 | `		}` |
|   38193 |  1051 | `		if( zIn >= zEnd ){` |
|   23291 |  1052 | `			break;` |
|       - |  1053 | `		}` |
|   14907 |  1054 | `		if( zIn[0] == '\\' ){` |
|   12653 |  1055 | `			const char *zPtr = 0;` |
|       - |  1056 | `			sxu32 n;` |
|   12653 |  1057 | `			zIn++;` |
|   12653 |  1058 | `			if( zIn >= zEnd ){` |
|     ! 0 |  1059 | `				break;` |
|       - |  1060 | `			}` |
|   12653 |  1061 | `			if( pObj == 0 ){` |
|    7827 |  1062 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|    7827 |  1063 | `				if( pObj == 0 ){` |
|     ! 0 |  1064 | `					return SXERR_ABORT;` |
|       - |  1065 | `				}` |
|    3911 |  1066 | `			}` |
|   12653 |  1067 | `			n = sizeof(char); /* size of conversion */` |
|   12653 |  1068 | `			switch( zIn[0] ){` |
|       7 |  1069 | `			case '$':` |
|       - |  1070 | `				/* Dollar sign */` |
...
|     102 |  1075 | `				PH7_MemObjStringAppend(pObj,"\\",sizeof(char));` |
|     102 |  1076 | `				break;` |
|       2 |  1077 | `			case 'a':` |
...
|   11687 |  1091 | `				PH7_MemObjStringAppend(pObj,"\n",sizeof(char));` |
|   11687 |  1092 | `				break;` |
|      19 |  1093 | `			case 'r':` |
...
|   23291 |  1284 | `	return SXRET_OK;` |
|   11802 |  1285 |  |
|       - |  1286 | `/*` |
|       - |  1287 | ` * Compile a double quoted string.` |
|       - |  1288 | ` *  See the block-comment above for more information.` |
|       - |  1289 | ` */` |
|   23534 |  1290 | `PH7_PRIVATE sxi32 PH7_CompileString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  1291 |  |
|       - |  1292 | `	sxi32 rc;` |
|   23539 |  1293 | `	rc = GenStateCompileString(&(*pGen));` |
|   11767 |  1294 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|       - |  1295 | `	/* Compilation result */` |
|   23539 |  1296 | `	return rc;` |
|       5 |  1297 |  |
|       - |  1298 | `/*` |
...
|       - |  1339 | ` */` |
|   21702 |  1340 | `static sxi32 GenStateCompileArrayEntry(` |
...
|   21707 |  1351 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|       - |  1352 | `	/* Compile the expression*/` |
|   21707 |  1353 | `	rc = PH7_CompileExpr(&(*pGen),iFlags,xValidator);` |
|       - |  1354 | `	/* Restore token stream */` |
|   21707 |  1355 | `	RE_SWAP_DELIMITER(pGen);` |
|   21707 |  1356 | `	return rc;` |
|       5 |  1357 |  |
|       - |  1358 | `/*` |
...
|       - |  1396 | ` */` |
|   24034 |  1397 | `static SyToken * GenStateFindTopLevelArrow(SyToken *pStart,SyToken *pEnd)` |
|       5 |  1398 |  |
|   24039 |  1399 | `	SyToken *pCur = pStart;` |
|   24039 |  1400 | `	sxi32 iNest = 0;` |
|   67999 |  1401 | `	while( pCur < pEnd ){` |
|   49429 |  1402 | `		if( (pCur->nType & PH7_TK_ARRAY_OP) && iNest <= 0 ){` |
|    5465 |  1403 | `			return pCur;` |
|       - |  1404 | `		}` |
...
|       - |  1408 | `		 */` |
|   43969 |  1409 | `		if( iNest == 0 && (pCur->nType & PH7_TK_KEYWORD) ){` |
...
|       - |  1468 | `			}` |
|      43 |  1469 | `		}` |
|   43963 |  1470 | `		if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|     326 |  1471 | `			iNest++;` |
|   43802 |  1472 | `		}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}'*/) ){` |
...
|       - |  1485 | ` */` |
|   31168 |  1486 | `static sxi32 GenStateCompileArrayBody(ph7_gen_state *pGen)` |
|       5 |  1487 |  |
|       - |  1488 | `	sxi32 (*xValidator)(ph7_gen_state *,ph7_expr_node *); /* Expression tree validator callback */` |
|       - |  1489 | `	SyToken *pKey,*pCur;` |
|   31173 |  1490 | `	sxi32 iEmitRef = 0;` |
|   31173 |  1491 | `	sxi32 iSpread = 0;` |
|   31173 |  1492 | `	sxi32 nPair = 0;` |
|       - |  1493 | `	sxi32 rc;` |
|   31173 |  1494 | `	xValidator = 0;` |
|   25519 |  1495 | `	for(;;){` |
|       - |  1496 | `		/* Jump leading commas */` |
|   57907 |  1497 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA) ){` |
|    6869 |  1498 | `			pGen->pIn++;` |
|       5 |  1499 | `		}` |
|   51043 |  1500 | `		pCur = pGen->pIn;` |
|   51043 |  1501 | `		if( SXRET_OK != PH7_GetNextExpr(pGen->pIn,pGen->pEnd,&pGen->pIn) ){` |
|       - |  1502 | `			/* No more entry to process */` |
|   31157 |  1503 | `			break;` |
|       - |  1504 | `		}` |
|   19891 |  1505 | `		if( pCur >= pGen->pIn ){` |
|     ! 0 |  1506 | `			continue;` |
|       - |  1507 | `		}` |
|       - |  1508 | `		/* Compile the key if available */` |
|   19891 |  1509 | `		pKey = pCur;` |
|   19891 |  1510 | `		pCur = GenStateFindTopLevelArrow(pCur,pGen->pIn);` |
|   19891 |  1511 | `		rc = SXERR_EMPTY;` |
|   19891 |  1512 | `		if( pCur < pGen->pIn ){` |
...
|   18255 |  1534 | `			pCur = pKey;` |
|       - |  1535 | `		}` |
|   19881 |  1536 | `		if( rc == SXERR_EMPTY ){` |
|       - |  1537 | `			/* No available key,load NULL */` |
|   18257 |  1538 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,0 /* nil index */,0,0);` |
|    9126 |  1539 | `		}` |
|   19881 |  1540 | `		if( pCur->nType & PH7_TK_AMPER /*'&'*/){` |
...
|   19879 |  1559 | `		iSpread = (pCur < pGen->pIn && (pCur->nType & PH7_TK_ELLIPSIS)) ? 1 : 0;` |
|   19879 |  1560 | `		if( iSpread && (rc != SXERR_EMPTY \|\| iEmitRef) ){` |
...
|   19875 |  1573 | `		rc = GenStateCompileArrayEntry(&(*pGen),pCur,pGen->pIn,EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,xValidator);` |
|   19875 |  1574 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  1575 | `			return SXERR_ABORT;` |
|       - |  1576 | `		}` |
|   19875 |  1577 | `		if( iSpread ){` |
...
|   19844 |  1580 | `		}else if( iEmitRef ){` |
|       - |  1581 | `			/* Emit the load reference instruction */` |
|      40 |  1582 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_REF,0,0,0,0);` |
|      18 |  1583 | `		}` |
|   19875 |  1584 | `		xValidator = 0;` |
|   19875 |  1585 | `		iEmitRef = 0;` |
|   19875 |  1586 | `		iSpread = 0;` |
|   19875 |  1587 | `		nPair++;` |
|       5 |  1588 | `	}` |
|       - |  1589 | `	/* Emit the load map instruction */` |
|   31157 |  1590 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_MAP,nPair * 2,0,0,0);` |
|       - |  1591 | `	/* Node successfully compiled */` |
|   31157 |  1592 | `	return SXRET_OK;` |
|   15589 |  1593 |  |
|       - |  1594 | `/*` |
...
|       - |  1602 | ` */` |
|   30160 |  1603 | `PH7_PRIVATE sxi32 PH7_CompileArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  1604 |  |
|       - |  1605 | `	/* Jump the 'array' keyword and the leading '(', exclude trailing ')'. */` |
|   30165 |  1606 | `	pGen->pIn += 2;` |
|   30165 |  1607 | `	pGen->pEnd--;` |
|   15080 |  1608 | `	SXUNUSED(iCompileFlag);` |
|   30165 |  1609 | `	return GenStateCompileArrayBody(pGen);` |
|       5 |  1610 |  |
|       - |  1611 | `/*` |
...
|       - |  2866 | ` */` |
| 1134534 |  2867 | `PH7_PRIVATE sxi32 PH7_CompileVariable(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  2868 |  |
| 1134539 |  2869 | `	sxu32 nLineLocal = pGen->pIn->nLine;` |
|       - |  2870 | `	sxi32 iVv;` |
|       - |  2871 | `	sxi32 iP1;` |
|       - |  2872 | `	void *p3;` |
|       - |  2873 | `	sxi32 rc;` |
| 1134539 |  2874 | `	iVv = -1; /* Variable variable counter */` |
| 2269085 |  2875 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) ){` |
| 1134551 |  2876 | `		pGen->pIn++;` |
| 1134551 |  2877 | `		iVv++;` |
|       5 |  2878 | `	}` |
| 1134539 |  2879 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_OCB/*'{'*/)) == 0 ){` |
...
|       - |  2887 | `	}` |
| 1134539 |  2888 | `	p3  = 0;` |
| 1134539 |  2889 | `	if( pGen->pIn->nType & PH7_TK_OCB/*'{'*/ ){` |
...
|       - |  2908 | `		SyString *pName;` |
| 1134523 |  2909 | `		char *zName = 0;` |
|       - |  2910 | `		/* Extract variable name */` |
| 1134523 |  2911 | `		pName = &pGen->pIn->sData;` |
|       - |  2912 | `		/* Advance the stream cursor */` |
| 1134523 |  2913 | `		pGen->pIn++;` |
| 1134523 |  2914 | `		pEntry = SyHashGet(&pGen->hVar,(const void *)pName->zString,pName->nByte);` |
| 1134523 |  2915 | `		if( pEntry == 0 ){` |
|       - |  2916 | `			/* Duplicate name */` |
|  163217 |  2917 | `			zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|  163217 |  2918 | `			if( zName == 0 ){` |
...
|  163217 |  2923 | `			SyHashInsert(&pGen->hVar,zName,pName->nByte,zName);` |
|   81611 |  2924 | `		}else{` |
|       - |  2925 | `			/* Name already available */` |
|  971311 |  2926 | `			zName = (char *)pEntry->pUserData;` |
|       - |  2927 | `		}` |
| 1134523 |  2928 | `		p3 = (void *)zName;` |
|       - |  2929 | `	}` |
| 1134535 |  2930 | `	iP1 = 0;` |
| 1134535 |  2931 | `	if( iCompileFlag & EXPR_FLAG_RDONLY_LOAD ){` |
|  442773 |  2932 | `		if( (iCompileFlag & EXPR_FLAG_LOAD_IDX_STORE) == 0 ){` |
|       - |  2933 | `			/* Read-only load.In other words do not create the variable if inexistant */` |
|  442755 |  2934 | `			iP1 = 1;` |
|  221375 |  2935 | `		}` |
|  221384 |  2936 | `	}` |
|       - |  2937 | `	/* Emit the load instruction */` |
| 1134535 |  2938 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,0,p3,0);` |
| 1134547 |  2939 | `	while( iVv > 0 ){` |
|      13 |  2940 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,0,0,0);` |
|      13 |  2941 | `		iVv--;` |
|       1 |  2942 | `	}` |
|       - |  2943 | `	/* Node successfully compiled */` |
| 1134535 |  2944 | `	return SXRET_OK;` |
|  567272 |  2945 |  |
|       - |  2946 | `/*` |
|       - |  2947 | ` * Load a literal.` |
|       - |  2948 | ` */` |
|  782006 |  2949 | `static sxi32 GenStateLoadLiteral(ph7_gen_state *pGen)` |
|       5 |  2950 |  |
|  782011 |  2951 | `	SyToken *pToken = pGen->pIn;` |
|       - |  2952 | `	ph7_value *pObj;` |
|       - |  2953 | `	SyString *pStr;` |
|       - |  2954 | `	sxu32 nIdx;` |
|       - |  2955 | `	/* Extract token value */` |
|  782011 |  2956 | `	pStr = &pToken->sData;` |
|       - |  2957 | `	/* Deal with the reserved literals [i.e: null,false,true,...] first */` |
|  782011 |  2958 | `	if( pStr->nByte == sizeof("NULL") - 1 ){` |
|  165725 |  2959 | `		if( SyStrnicmp(pStr->zString,"null",sizeof("NULL")-1) == 0 ){` |
|       - |  2960 | `			/* NULL constant are always indexed at 0 */` |
|   61003 |  2961 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,0,0,0);` |
|   61003 |  2962 | `			return SXRET_OK;` |
|  104727 |  2963 | `		}else if( SyStrnicmp(pStr->zString,"true",sizeof("TRUE")-1) == 0 ){` |
|       - |  2964 | `			/* TRUE constant are always indexed at 1 */` |
|     761 |  2965 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,1,0,0);` |
|     761 |  2966 | `			return SXRET_OK;` |
|       5 |  2967 | `		}` |
|  721249 |  2968 | `	}else if (pStr->nByte == sizeof("FALSE") - 1 &&` |
|  105950 |  2969 | `		SyStrnicmp(pStr->zString,"false",sizeof("FALSE")-1) == 0 ){` |
|       - |  2970 | `			/* FALSE constant are always indexed at 2 */` |
|   46763 |  2971 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,2,0,0);` |
|   46763 |  2972 | `			return SXRET_OK;` |
|  625056 |  2973 | `	}else if(pStr->nByte == sizeof("__LINE__") - 1 &&` |
|  111046 |  2974 | `		SyMemcmp(pStr->zString,"__LINE__",sizeof("__LINE__")-1) == 0 ){` |
|       - |  2975 | `			/* TICKET 1433-004: __LINE__ constant must be resolved at compile time,not run time */` |
|   10643 |  2976 | `			pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   10643 |  2977 | `			if( pObj == 0 ){` |
|     ! 0 |  2978 | `				PH7_GenCompileError(pGen,E_ERROR,pToken->nLine,"Fatal, PH7 engine is running out of memory");` |
|     ! 0 |  2979 | `				return SXERR_ABORT;` |
|       - |  2980 | `			}` |
|   10643 |  2981 | `			PH7_MemObjInitFromInt(pGen->pVm,pObj,pToken->nLine);` |
|       - |  2982 | `			/* Emit the load constant instruction */` |
|   10643 |  2983 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   10643 |  2984 | `			return SXRET_OK;` |
|  576832 |  2985 | `	}else if( pStr->nByte == sizeof("__NAMESPACE__") - 1 &&` |
|   35874 |  2986 | `		SyMemcmp(pStr->zString,"__NAMESPACE__",sizeof("__NAMESPACE__")-1) == 0 ){` |
...
|  575956 |  3002 | `	}else if( (pStr->nByte == sizeof("__FUNCTION__") - 1 &&` |
|   14959 |  3003 | `		SyMemcmp(pStr->zString,"__FUNCTION__",sizeof("__FUNCTION__")-1) == 0) \|\|` |
|  568472 |  3004 | `		(pStr->nByte == sizeof("__METHOD__") - 1 &&` |
|   19190 |  3005 | `		SyMemcmp(pStr->zString,"__METHOD__",sizeof("__METHOD__")-1) == 0) ){` |
...
|  662845 |  3035 | `	if( SXRET_OK != GenStateFindLiteral(&(*pGen),&pToken->sData,&nIdx) ){` |
|       - |  3036 | `		ph7_value *pLitObj;` |
|       - |  3037 | `		/* Unknown literal,install it in the literal table */` |
|  282393 |  3038 | `		pLitObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  282393 |  3039 | `		if( pLitObj == 0 ){` |
|     ! 0 |  3040 | `			PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|     ! 0 |  3041 | `			return SXERR_ABORT;` |
|       - |  3042 | `		}` |
|  282393 |  3043 | `		PH7_MemObjInitFromString(pGen->pVm,pLitObj,&pToken->sData);` |
|  282393 |  3044 | `		GenStateInstallLiteral(&(*pGen),pLitObj,nIdx);` |
|  141194 |  3045 | `	}` |
|       - |  3046 | `	/* Emit the load constant instruction */` |
|  662845 |  3047 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,1,nIdx,0,0);` |
|  662845 |  3048 | `	return SXRET_OK;` |
|  391008 |  3049 |  |
|       - |  3050 | `/*` |
...
|       - |  3055 | ` */` |
|  785590 |  3056 | `static sxi32 GenStateResolveNamespaceLiteral(ph7_gen_state *pGen)` |
|       5 |  3057 |  |
|       - |  3058 | `	sxi32 rc;` |
|  785595 |  3059 | `	if( pGen->pIn >= pGen->pEnd ){` |
|     ! 0 |  3060 | `		return SXRET_OK;` |
|       - |  3061 | `	}` |
|       - |  3062 | `	/* Check if this is a multi-token namespace path */` |
|  785595 |  3063 | `	if( pGen->pIn < &pGen->pEnd[-1] ){` |
|       - |  3064 | `		/* Multiple tokens: assemble the full path into sWorker */` |
|    3589 |  3065 | `		SyBlob *pWorker = &pGen->sWorker;` |
|    3589 |  3066 | `		int isAbsolute = 0;` |
|    3589 |  3067 | `		SyBlobReset(pWorker);` |
|       - |  3068 | `		/* Check for leading backslash (absolute path) */` |
|    3589 |  3069 | `		if( pGen->pIn->nType & PH7_TK_NSSEP ){` |
|    3587 |  3070 | `			isAbsolute = 1;` |
|    3587 |  3071 | `			pGen->pIn++; /* Skip leading backslash */` |
|    1791 |  3072 | `		}` |
|       - |  3073 | `		/* For relative qualified names in a namespace, prepend the NS */` |
|    3589 |  3074 | `		if( !isAbsolute && SyBlobLength(&pGen->sNamespace) > 0 ){` |
...
|    3685 |  3079 | `		while( pGen->pIn <= &pGen->pEnd[-1] ){` |
|    3685 |  3080 | `			if( pGen->pIn->nType & PH7_TK_NSSEP ){` |
|      53 |  3081 | `				SyBlobAppend(pWorker,"\\",1);` |
|      29 |  3082 | `			}else{` |
|    3637 |  3083 | `				SyBlobAppend(pWorker,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|       - |  3084 | `			}` |
|    3685 |  3085 | `			if( pGen->pIn == &pGen->pEnd[-1] ){` |
|    3589 |  3086 | `				pGen->pIn++;` |
|    3589 |  3087 | `				break;` |
|       - |  3088 | `			}` |
|     101 |  3089 | `			pGen->pIn++;` |
|       5 |  3090 | `		}` |
|    3589 |  3091 | `		if( SyBlobLength(pWorker) > 0 ){` |
|       - |  3092 | `			ph7_value *pObj;` |
|       - |  3093 | `			SyString sPath;` |
|       - |  3094 | `			sxu32 nIdx;` |
|    3589 |  3095 | `			SyStringInitFromBuf(&sPath,(const char *)SyBlobData(pWorker),SyBlobLength(pWorker));` |
|       - |  3096 | `			/* Install in the literal table */` |
|    3589 |  3097 | `			if( SXRET_OK != GenStateFindLiteral(&(*pGen),&sPath,&nIdx) ){` |
|    3565 |  3098 | `				pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|    3565 |  3099 | `				if( pObj == 0 ){` |
|     ! 0 |  3100 | `					PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|     ! 0 |  3101 | `					return SXERR_ABORT;` |
|       - |  3102 | `				}` |
|    3565 |  3103 | `				PH7_MemObjInitFromString(pGen->pVm,pObj,&sPath);` |
|    3565 |  3104 | `				GenStateInstallLiteral(&(*pGen),pObj,nIdx);` |
|    1780 |  3105 | `			}` |
...
|    5381 |  3109 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,` |
|    1792 |  3110 | `				isAbsolute ? (PH7_LOADC_EXPAND\|PH7_LOADC_ABSOLUTE) : PH7_LOADC_EXPAND,` |
|    1792 |  3111 | `				nIdx,0,0);` |
|    3589 |  3112 | `			return SXRET_OK;` |
|       - |  3113 | `		}` |
|     ! 0 |  3114 | `	}` |
|       - |  3115 | `	/* Single-token literal: load directly */` |
|  782011 |  3116 | `	rc = GenStateLoadLiteral(&(*pGen));` |
|  782011 |  3117 | `	return rc;` |
|  392800 |  3118 |  |
|       - |  3119 | `/*` |
...
|     ! 0 |  3134 |  |
|  785590 |  3135 | `PH7_PRIVATE sxi32 PH7_CompileLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  3136 |  |
|       - |  3137 | `	sxi32 rc;` |
|  785595 |  3138 | `	rc = GenStateResolveNamespaceLiteral(&(*pGen));` |
|  785595 |  3139 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  3140 | `		SXUNUSED(iCompileFlag); /* cc warning */` |
|     ! 0 |  3141 | `		return rc;` |
|       - |  3142 | `	}` |
|       - |  3143 | `	/* Node successfully compiled */` |
|  785595 |  3144 | `	return SXRET_OK;` |
|  392800 |  3145 |  |
|       - |  3146 | `/*` |
...
|       - |  3304 | ` */` |
|    3684 |  3305 | `static void GenStateEmitExceptionPopForBreak(ph7_gen_state *pGen,GenBlock *pTarget)` |
|       5 |  3306 |  |
|    3689 |  3307 | `	GenBlock *pBlock = pGen->pCurrent;` |
|   21617 |  3308 | `	while( pBlock && pBlock != pTarget ){` |
|   17933 |  3309 | `		if( pBlock->iFlags & GEN_BLOCK_EXCEPTION ){` |
...
|       - |  3319 | `			}` |
|       1 |  3320 | `		}` |
|   17933 |  3321 | `		pBlock = pBlock->pParent;` |
|       5 |  3322 | `	}` |
|    3689 |  3323 |  |
|    3588 |  3324 | `static sxi32 PH7_CompileContinue(ph7_gen_state *pGen)` |
|       5 |  3325 |  |
|       - |  3326 | `	GenBlock *pLoop; /* Target loop */` |
|       - |  3327 | `	sxi32 iLevel;    /* How many nesting loop to skip */` |
|       - |  3328 | `	sxu32 nLineLocal;` |
|       - |  3329 | `	sxi32 rc;` |
|    3593 |  3330 | `	nLineLocal = pGen->pIn->nLine;` |
|    3593 |  3331 | `	iLevel = 0;` |
|       - |  3332 | `	/* Jump the 'continue' keyword */` |
|    3593 |  3333 | `	pGen->pIn++;` |
|    3593 |  3334 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NUM) ){` |
...
|    3593 |  3360 | `	pLoop = GenStateFetchBlock(pGen->pCurrent,GEN_BLOCK_LOOP,iLevel);` |
|    3593 |  3361 | `	if( pLoop == 0 ){` |
...
|       - |  3367 | `		}` |
|       7 |  3368 | `	}else{` |
|    3583 |  3369 | `		sxu32 nInstrIdx = 0;` |
|       - |  3370 | `		/* Emit POP_EXCEPTION for any try blocks between here and the loop */` |
|    3583 |  3371 | `		GenStateEmitExceptionPopForBreak(&(*pGen),pLoop);` |
|    3583 |  3372 | `		if( pLoop->iFlags & GEN_BLOCK_SWITCH ){` |
...
|    3579 |  3384 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pLoop->nFirstInstr,0,&nInstrIdx);` |
|    3579 |  3385 | `			if( pLoop->bPostContinue == TRUE ){` |
...
|       - |  3392 | `		}` |
|       - |  3393 | `	}` |
|    3593 |  3394 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
...
|       5 |  3511 | `		}` |
|     113 |  3512 | `		if( pBlock ){` |
|      22 |  3513 | `			sLabel.pFunc = (ph7_vm_func *)pBlock->pUserData;` |
|      12 |  3514 | `		}else{` |
...
|       - |  3675 | ` * message.` |
|       - |  3676 | ` */` |
|  430528 |  3677 | `static sxi32 PH7_CompileBlock(` |
...
|       - |  3682 | `	sxi32 rc;` |
|       - |  3683 | `	sxu32 nLine;` |
|  430533 |  3684 | `	if( pGen->pIn->nType & PH7_TK_OCB /* '{' */ ){` |
|  428849 |  3685 | `		nLine = pGen->pIn->nLine;` |
|  428849 |  3686 | `		rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_STD,PH7_VmInstrLength(pGen->pVm),0,0);` |
|  428849 |  3687 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  3688 | `			return SXERR_ABORT;` |
|       - |  3689 | `		}` |
|  428849 |  3690 | `		pGen->pIn++;` |
|       - |  3691 | `		/* Compile until we hit the closing braces '}' */` |
|  587310 |  3692 | `		for(;;){` |
| 1174625 |  3693 | `			if( pGen->pIn >= pGen->pEnd ){` |
...
|       - |  3702 | `				}` |
|     ! 0 |  3703 | `			}` |
| 1174605 |  3704 | `			if( pGen->pIn->nType & PH7_TK_CCB/*'}'*/ ){` |
|       - |  3705 | `				/* Closing braces found,break immediately*/` |
|  428829 |  3706 | `				pGen->pIn++;` |
|  428829 |  3707 | `				break;` |
|       - |  3708 | `			}` |
|       - |  3709 | `			/* Compile a single statement */` |
|  745781 |  3710 | `			rc = GenStateCompileChunk(&(*pGen),PH7_COMPILE_SINGLE_STMT);` |
|  745781 |  3711 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  3712 | `				return SXERR_ABORT;` |
|       - |  3713 | `			}` |
|       5 |  3714 | `		}` |
|  428849 |  3715 | `		GenStateLeaveBlock(&(*pGen),0);` |
|  216111 |  3716 | `	}else if( (pGen->pIn->nType & PH7_TK_COLON /* ':' */) && nKeywordEnd > 0 ){` |
|     ! 0 |  3717 | `		pGen->pIn++;` |
...
|  430533 |  3766 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|     ! 0 |  3767 | `		pGen->pIn++;` |
|     ! 0 |  3768 | `	}` |
|  430533 |  3769 | `	return SXRET_OK;` |
|  215269 |  3770 |  |
|       - |  3771 | `/*` |
...
|       - |  3788 | ` *   endwhile;` |
|       - |  3789 | ` */` |
|   14296 |  3790 | `static sxi32 PH7_CompileWhile(ph7_gen_state *pGen)` |
|       5 |  3791 |  |
|   14301 |  3792 | `	GenBlock *pWhileBlock = 0;` |
|   14301 |  3793 | `	SyToken *pTmp,*pEnd = 0;` |
|       - |  3794 | `	sxu32 nFalseJump;` |
|       - |  3795 | `	sxu32 nLine;` |
|       - |  3796 | `	sxi32 rc;` |
|   14301 |  3797 | `	nLine = pGen->pIn->nLine;` |
|       - |  3798 | `	/* Jump the 'while' keyword */` |
|   14301 |  3799 | `	pGen->pIn++;` |
|   14301 |  3800 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  3801 | `		/* Syntax error */` |
...
|   14301 |  3812 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pWhileBlock);` |
|   14301 |  3813 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  3814 | `		return SXERR_ABORT;` |
|       - |  3815 | `	}` |
|       - |  3816 | `	/* Delimit the condition */` |
|   14301 |  3817 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   14301 |  3818 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|   14301 |  3827 | `	pTmp = pGen->pEnd;` |
|   14301 |  3828 | `	pGen->pEnd = pEnd;` |
|       - |  3829 | `	/* Compile the expression */` |
|   14301 |  3830 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   14301 |  3831 | `	if( rc == SXERR_ABORT ){` |
|       - |  3832 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  3833 | `		return SXERR_ABORT;` |
|       - |  3834 | `	}` |
|       - |  3835 | `	/* Update token stream */` |
|   14301 |  3836 | `	while(pGen->pIn < pEnd ){` |
...
|   14301 |  3844 | `	pGen->pIn  = &pEnd[1];` |
|   14301 |  3845 | `	pGen->pEnd = pTmp;` |
|       - |  3846 | `	/* Emit the false jump */` |
|   14301 |  3847 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nFalseJump);` |
|       - |  3848 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   14301 |  3849 | `	GenStateNewJumpFixup(pWhileBlock,PH7_OP_JZ,nFalseJump);` |
|       - |  3850 | `	/* Compile the loop body */` |
|   14301 |  3851 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDWHILE);` |
|   14301 |  3852 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  3853 | `		return SXERR_ABORT;` |
|       - |  3854 | `	}` |
|       - |  3855 | `	/* Emit the unconditional jump to the start of the loop */` |
|   14301 |  3856 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pWhileBlock->nFirstInstr,0,0);` |
|       - |  3857 | `	/* Fix all jumps now the destination is resolved */` |
|   14301 |  3858 | `	GenStateFixJumps(pWhileBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - |  3859 | `	/* Release the loop block */` |
|   14301 |  3860 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  3861 | `	/* Statement successfully compiled */` |
|   14301 |  3862 | `	return SXRET_OK;` |
|     ! 0 |  3863 | `Synchronize:` |
...
|       - |  4018 | ` */` |
|   14296 |  4019 | `static sxi32 PH7_CompileFor(ph7_gen_state *pGen)` |
|       5 |  4020 |  |
|   14301 |  4021 | `	SyToken *pTmp,*pPostStart,*pEnd = 0;` |
|   14301 |  4022 | `	GenBlock *pForBlock = 0;` |
|       - |  4023 | `	sxu32 nFalseJump;` |
|       - |  4024 | `	sxu32 nLine;` |
|       - |  4025 | `	sxi32 rc;` |
|   14301 |  4026 | `	nLine = pGen->pIn->nLine;` |
|       - |  4027 | `	/* Jump the 'for' keyword */` |
|   14301 |  4028 | `	pGen->pIn++;` |
|   14301 |  4029 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  4030 | `		/* Syntax error */` |
...
|   14301 |  4041 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   14301 |  4042 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|   14301 |  4057 | `	pTmp = pGen->pEnd;` |
|   14301 |  4058 | `	pGen->pEnd = pEnd;` |
|       - |  4059 | `	/* Compile initialization expressions if available */` |
|   14301 |  4060 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|       - |  4061 | `	/* Pop operand lvalues */` |
|   14301 |  4062 | `	if( rc == SXERR_ABORT ){` |
|       - |  4063 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4064 | `		return SXERR_ABORT;` |
|   14301 |  4065 | `	}else if( rc != SXERR_EMPTY ){` |
|   14299 |  4066 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|    7147 |  4067 | `	}` |
|   14301 |  4068 | `	if( (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|       - |  4069 | `		/* Syntax error */` |
...
|   14301 |  4081 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pForBlock);` |
|   14301 |  4082 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  4083 | `		return SXERR_ABORT;` |
|       - |  4084 | `	}` |
|       - |  4085 | `	/* Deffer continue jumps */` |
|   14301 |  4086 | `	pForBlock->bPostContinue = TRUE;` |
|       - |  4087 | `	/* Compile the condition */` |
|   14301 |  4088 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   14301 |  4089 | `	if( rc == SXERR_ABORT ){` |
|       - |  4090 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4091 | `		return SXERR_ABORT;` |
|   14301 |  4092 | `	}else if( rc != SXERR_EMPTY ){` |
|       - |  4093 | `		/* Emit the false jump */` |
|   14299 |  4094 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nFalseJump);` |
|       - |  4095 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   14299 |  4096 | `		GenStateNewJumpFixup(pForBlock,PH7_OP_JZ,nFalseJump);` |
|    7147 |  4097 | `	}` |
|   14301 |  4098 | `	if( (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|       - |  4099 | `		/* Syntax error */` |
...
|   14297 |  4111 | `	pPostStart = pGen->pIn;` |
|       - |  4112 | `	/* Compile the loop body */` |
|   14297 |  4113 | `	pGen->pIn  = &pEnd[1]; /* Jump the trailing parenthesis ')' */` |
|   14297 |  4114 | `	pGen->pEnd = pTmp;` |
|   14297 |  4115 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDFOR);` |
|   14297 |  4116 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  4117 | `		return SXERR_ABORT;` |
|       - |  4118 | `	}` |
|       - |  4119 | `	/* Fix post-continue jumps */` |
|   14297 |  4120 | `	if( SySetUsed(&pForBlock->aPostContFix) > 0 ){` |
...
|   14297 |  4136 | `	while( pPostStart < pEnd && (pPostStart->nType & PH7_TK_SEMI) ){` |
|     ! 0 |  4137 | `		pPostStart++;` |
|     ! 0 |  4138 | `	}` |
|   14297 |  4139 | `	if( pPostStart < pEnd ){` |
|       - |  4140 | `		SyToken *pTmpIn,*pTmpEnd;` |
|   14297 |  4141 | `		SWAP_DELIMITER(pGen,pPostStart,pEnd);` |
|   14297 |  4142 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   14297 |  4143 | `		if( pGen->pIn < pGen->pEnd ){` |
|       - |  4144 | `			/* Syntax error */` |
...
|       - |  4151 | `		}` |
|   14297 |  4152 | `		RE_SWAP_DELIMITER(pGen);` |
|   14297 |  4153 | `		if( rc == SXERR_ABORT ){` |
|       - |  4154 | `			/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4155 | `			return SXERR_ABORT;` |
|   14297 |  4156 | `		}else if( rc != SXERR_EMPTY){` |
|       - |  4157 | `			/* Pop operand lvalue */` |
|   14297 |  4158 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|    7146 |  4159 | `		}` |
|    7146 |  4160 | `	}` |
|       - |  4161 | `	/* Emit the unconditional jump to the start of the loop */` |
|   14297 |  4162 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pForBlock->nFirstInstr,0,0);` |
|       - |  4163 | `	/* Fix all jumps now the destination is resolved */` |
|   14297 |  4164 | `	GenStateFixJumps(pForBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - |  4165 | `	/* Release the loop block */` |
|   14297 |  4166 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  4167 | `	/* Statement successfully compiled */` |
|   14297 |  4168 | `	return SXRET_OK;` |
|    7153 |  4169 |  |
...
|       - |  4172 | ` * are allowed.` |
|       - |  4173 | ` */` |
|    7670 |  4174 | `static sxi32 GenStateForEachNodeValidator(ph7_gen_state *pGen,ph7_expr_node *pRoot)` |
|       5 |  4175 |  |
|    7675 |  4176 | `	sxi32 rc = SXRET_OK; /* Assume a valid expression tree */` |
|    7675 |  4177 | `	if( pRoot->xCode != PH7_CompileVariable ){` |
...
|       - |  4212 | ` */` |
|    3930 |  4213 | `static sxi32 PH7_CompileForeach(ph7_gen_state *pGen)` |
|       5 |  4214 |  |
|    3935 |  4215 | `	SyToken *pCur,*pTmp,*pEnd = 0;` |
|    3935 |  4216 | `	SyToken *pListStart = 0,*pListEnd = 0;` |
|    3935 |  4217 | `	GenBlock *pForeachBlock = 0;` |
|       - |  4218 | `	ph7_foreach_info *pInfo;` |
|       - |  4219 | `	sxu32 nFalseJump;` |
|       - |  4220 | `	VmInstr *pInstr;` |
|       - |  4221 | `	sxu32 nLine;` |
|       - |  4222 | `	sxi32 rc;` |
|    3935 |  4223 | `	nLine = pGen->pIn->nLine;` |
|       - |  4224 | `	/* Jump the 'foreach' keyword */` |
|    3935 |  4225 | `	pGen->pIn++;` |
|    3935 |  4226 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  4227 | `		/* Syntax error */` |
...
|    3935 |  4238 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pForeachBlock);` |
|    3935 |  4239 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  4240 | `		return SXERR_ABORT;` |
|       - |  4241 | `	}` |
|       - |  4242 | `	/* Delimit the expression */` |
|    3935 |  4243 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|    3935 |  4244 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|    3935 |  4259 | `	pCur = pGen->pIn;` |
|   27003 |  4260 | `	while( pCur < pEnd ){` |
|   27003 |  4261 | `		if( pCur->nType & PH7_TK_KEYWORD ){` |
|    3949 |  4262 | `			sxi32 nKeywrd = SX_PTR_TO_INT(pCur->pUserData);` |
|    3949 |  4263 | `			if( nKeywrd == PH7_TKWRD_AS ){` |
...
|    3935 |  4281 | `	pTmp = pGen->pEnd;` |
|    3935 |  4282 | `	pGen->pEnd = pCur;` |
|    3935 |  4283 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|    3935 |  4284 | `	if( rc == SXERR_ABORT ){` |
|       - |  4285 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4286 | `		return SXERR_ABORT;` |
|       - |  4287 | `	}` |
|       - |  4288 | `	/* Update token stream */` |
|    3935 |  4289 | `	while(pGen->pIn < pCur ){` |
...
|     ! 0 |  4295 | `		pGen->pIn++;` |
|     ! 0 |  4296 | `	}` |
|    3935 |  4297 | `	pCur++; /* Jump the 'as' keyword */` |
|    3935 |  4298 | `	pGen->pIn = pCur;` |
|    3935 |  4299 | `	if( pGen->pIn >= pEnd ){` |
...
|    3935 |  4306 | `	pInfo = (ph7_foreach_info *)SyMemBackendAlloc(&pGen->pVm->sAllocator,sizeof(ph7_foreach_info));` |
|    3935 |  4307 | `	if( pInfo == 0 ){` |
...
|    3935 |  4312 | `	SyZero(pInfo,sizeof(ph7_foreach_info));` |
|       - |  4313 | `	/* Initialize structure fields */` |
|    3935 |  4314 | `	SySetInit(&pInfo->aStep,&pGen->pVm->sAllocator,sizeof(ph7_foreach_step *));` |
...
|       - |  4317 | `	 * '=>'. */` |
|    3935 |  4318 | `	pCur = GenStateFindTopLevelArrow(pCur,pEnd);` |
|    3935 |  4319 | `	if( pCur < pEnd ){` |
|       - |  4320 | `		/* Compile the expression holding the key name */` |
|    3757 |  4321 | `		if( pGen->pIn >= pCur ){` |
...
|       - |  4326 | `			}` |
|     ! 0 |  4327 | `		}else{` |
|    3757 |  4328 | `			pGen->pEnd = pCur;` |
|    3757 |  4329 | `			rc = PH7_CompileExpr(&(*pGen),0,GenStateForEachNodeValidator);` |
|    3757 |  4330 | `			if( rc == SXERR_ABORT ){` |
|       - |  4331 | `				/* Don't worry about freeing memory, everything will be released shortly */` |
|     ! 0 |  4332 | `				return SXERR_ABORT;` |
|       - |  4333 | `			}` |
|    3757 |  4334 | `			pInstr = PH7_VmPopInstr(pGen->pVm);` |
|    3757 |  4335 | `			if( pInstr->p3 ){` |
|       - |  4336 | `				/* Record key name */` |
|    3757 |  4337 | `				SyStringInitFromBuf(&pInfo->sKey,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|    1876 |  4338 | `			}` |
|    3757 |  4339 | `			pInfo->iFlags \|= PH7_4EACH_STEP_KEY;` |
|       - |  4340 | `		}` |
|    3757 |  4341 | `		pGen->pIn = &pCur[1]; /* Jump the arrow */` |
|    1876 |  4342 | `	}` |
|    3935 |  4343 | `	pGen->pEnd = pEnd;` |
|    3935 |  4344 | `	if( pGen->pIn >= pEnd ){` |
...
|    3930 |  4399 | `	}else if( pGen->pIn->nType & PH7_TK_OSB ){` |
...
|    3923 |  4432 | `		rc = PH7_CompileExpr(&(*pGen),0,GenStateForEachNodeValidator);` |
|    3923 |  4433 | `		if( rc == SXERR_ABORT ){` |
|       - |  4434 | `			/* Don't worry about freeing memory, everything will be released shortly */` |
|     ! 0 |  4435 | `			return SXERR_ABORT;` |
|       - |  4436 | `		}` |
|    3923 |  4437 | `		pInstr = PH7_VmPopInstr(pGen->pVm);` |
|    3923 |  4438 | `		if( pInstr->p3 ){` |
|       - |  4439 | `			/* Record value name */` |
|    3923 |  4440 | `			SyStringInitFromBuf(&pInfo->sValue,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|    1959 |  4441 | `		}` |
|       - |  4442 | `	}` |
|       - |  4443 | `	/* Emit the 'FOREACH_INIT' instruction */` |
|    3933 |  4444 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_FOREACH_INIT,0,0,pInfo,&nFalseJump);` |
|       - |  4445 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|    3933 |  4446 | `	GenStateNewJumpFixup(pForeachBlock,PH7_OP_FOREACH_INIT,nFalseJump);` |
|       - |  4447 | `	/* Record the first instruction to execute */` |
|    3933 |  4448 | `	pForeachBlock->nFirstInstr = PH7_VmInstrLength(pGen->pVm);` |
|       - |  4449 | `	/* Emit the FOREACH_STEP instruction */` |
|    3933 |  4450 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_FOREACH_STEP,0,0,pInfo,&nFalseJump);` |
|       - |  4451 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|    3933 |  4452 | `	GenStateNewJumpFixup(pForeachBlock,PH7_OP_FOREACH_STEP,nFalseJump);` |
|       - |  4453 | `	/* If list() unpacking, emit bytecode to destructure the temp variable */` |
|    3933 |  4454 | `	if( (pInfo->iFlags & PH7_4EACH_STEP_LIST) && pListStart && pListEnd ){` |
...
|    3933 |  4482 | `	pGen->pIn = &pEnd[1];` |
|    3933 |  4483 | `	pGen->pEnd = pTmp;` |
|    3933 |  4484 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_END4EACH);` |
|    3933 |  4485 | `	if( rc == SXERR_ABORT ){` |
...
|    3933 |  4490 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pForeachBlock->nFirstInstr,0,0);` |
|       - |  4491 | `	/* Fix all jumps now the destination is resolved */` |
|    3933 |  4492 | `	GenStateFixJumps(pForeachBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - |  4493 | `	/* Release the loop block */` |
|    3933 |  4494 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  4495 | `	/* Statement successfully compiled */` |
|    3933 |  4496 | `	return SXRET_OK;` |
|       1 |  4497 | `Synchronize:` |
...
|       - |  4536 | ` *    ?>` |
|       - |  4537 | ` */` |
|  148584 |  4538 | `static sxi32 PH7_CompileIf(ph7_gen_state *pGen)` |
|       5 |  4539 |  |
|  148589 |  4540 | `	SyToken *pToken,*pTmp,*pEnd = 0;` |
|  148589 |  4541 | `	GenBlock *pCondBlock = 0;` |
|       - |  4542 | `	sxu32 nJumpIdx;` |
|       - |  4543 | `	sxu32 nKeyID;` |
|       - |  4544 | `	sxi32 rc;` |
|       - |  4545 | `	/* Jump the 'if' keyword */` |
|  148589 |  4546 | `	pGen->pIn++;` |
|  148589 |  4547 | `	pToken = pGen->pIn;` |
|       - |  4548 | `	/* Create the conditional block */` |
|  148589 |  4549 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_COND,PH7_VmInstrLength(pGen->pVm),0,&pCondBlock);` |
|  148589 |  4550 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  4551 | `		return SXERR_ABORT;` |
|       - |  4552 | `	}` |
|       - |  4553 | `	/* Process as many [if/else if/elseif/else] blocks as we can */` |
|   81437 |  4554 | `	for(;;){` |
|  162879 |  4555 | `		if( pToken >= pGen->pEnd \|\| (pToken->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  4556 | `			/* Syntax error */` |
...
|  162879 |  4570 | `		PH7_DelimitNestedTokens(pToken,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|  162879 |  4571 | `		if( pToken >= pEnd \|\| (pEnd->nType & PH7_TK_RPAREN) == 0 ){` |
|       - |  4572 | `			/* Syntax error */` |
...
|  162879 |  4584 | `		SWAP_TOKEN_STREAM(pGen,pToken,pEnd);` |
|       - |  4585 | `		/* Compile the condition */` |
|  162879 |  4586 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|       - |  4587 | `		/* Update token stream */` |
|  162879 |  4588 | `		while(pGen->pIn < pEnd ){` |
|     ! 0 |  4589 | `			PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Unexpected token '%z'",&pGen->pIn->sData);` |
|     ! 0 |  4590 | `			pGen->pIn++;` |
|     ! 0 |  4591 | `		}` |
|  162879 |  4592 | `		pGen->pIn  = &pEnd[1];` |
|  162879 |  4593 | `		pGen->pEnd = pTmp;` |
|  162879 |  4594 | `		if( rc == SXERR_ABORT ){` |
|       - |  4595 | `			/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4596 | `			return SXERR_ABORT;` |
|       - |  4597 | `		}` |
|       - |  4598 | `		/* Emit the false jump */` |
|  162879 |  4599 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nJumpIdx);` |
|       - |  4600 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|  162879 |  4601 | `		GenStateNewJumpFixup(pCondBlock,PH7_OP_JZ,nJumpIdx);` |
|       - |  4602 | `		/* Compile the body */` |
|  162879 |  4603 | `		rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDIF);` |
|  162879 |  4604 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  4605 | `			return SXERR_ABORT;` |
|       - |  4606 | `		}` |
|  162879 |  4607 | `		if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
|   45404 |  4608 | `			break;` |
|       - |  4609 | `		}` |
|       - |  4610 | `		/* Ensure that the keyword ID is 'else if' or 'else' */` |
|   72081 |  4611 | `		nKeyID = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   72081 |  4612 | `		if( (nKeyID & (PH7_TKWRD_ELSE\|PH7_TKWRD_ELIF)) == 0 ){` |
|   46395 |  4613 | `			break;` |
|       - |  4614 | `		}` |
|       - |  4615 | `		/* Emit the unconditional jump */` |
|   25691 |  4616 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,0,0,&nJumpIdx);` |
|       - |  4617 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   25691 |  4618 | `		GenStateNewJumpFixup(pCondBlock,PH7_OP_JMP,nJumpIdx);` |
|   25691 |  4619 | `		if( nKeyID & PH7_TKWRD_ELSE ){` |
|   18489 |  4620 | `			pToken = &pGen->pIn[1];` |
|   18489 |  4621 | `			if( pToken >= pGen->pEnd \|\| (pToken->nType & PH7_TK_KEYWORD) == 0 \|\|` |
|    7140 |  4622 | `				SX_PTR_TO_INT(pToken->pUserData) != PH7_TKWRD_IF ){` |
|    5703 |  4623 | `					break;` |
|       - |  4624 | `			}` |
|    7093 |  4625 | `			pGen->pIn++; /* Jump the 'else' keyword */` |
|    3544 |  4626 | `		}` |
|   14295 |  4627 | `		pGen->pIn++; /* Jump the 'elseif/if' keyword */` |
|       - |  4628 | `		/* Synchronize cursors */` |
|   14295 |  4629 | `		pToken = pGen->pIn;` |
|       - |  4630 | `		/* Fix the false jump */` |
|   14295 |  4631 | `		GenStateFixJumps(pCondBlock,PH7_OP_JZ,PH7_VmInstrLength(pGen->pVm));` |
|       5 |  4632 | `	} /* For(;;) */` |
|       - |  4633 | `	/* Fix the false jump */` |
|  148589 |  4634 | `	GenStateFixJumps(pCondBlock,PH7_OP_JZ,PH7_VmInstrLength(pGen->pVm));` |
|  148589 |  4635 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|   57786 |  4636 | `		(SX_PTR_TO_INT(pGen->pIn->pUserData) & PH7_TKWRD_ELSE) ){` |
|       - |  4637 | `			/* Compile the else block */` |
|   11401 |  4638 | `			pGen->pIn++;` |
|   11401 |  4639 | `			rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDIF);` |
|   11401 |  4640 | `			if( rc == SXERR_ABORT ){` |
|       - |  4641 |  |
|     ! 0 |  4642 | `				return SXERR_ABORT;` |
|       - |  4643 | `			}` |
|    5698 |  4644 | `	}` |
|  148589 |  4645 | `	nJumpIdx = PH7_VmInstrLength(pGen->pVm);` |
|       - |  4646 | `	/* Fix all unconditional jumps now the destination is resolved */` |
|  148589 |  4647 | `	GenStateFixJumps(pCondBlock,PH7_OP_JMP,nJumpIdx);` |
|       - |  4648 | `	/* Release the conditional block */` |
|  148589 |  4649 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  4650 | `	/* Statement successfully compiled */` |
|  148589 |  4651 | `	return SXRET_OK;` |
|     ! 0 |  4652 | `Synchronize:` |
...
|       - |  4752 | ` */` |
|  235348 |  4753 | `static sxi32 PH7_CompileReturn(ph7_gen_state *pGen)` |
|       5 |  4754 |  |
|  235353 |  4755 | `	sxi32 nRet = 0; /* TRUE if there is a return value */` |
|       - |  4756 | `	sxi32 rc;` |
|       - |  4757 | `	/* Jump the 'return' keyword */` |
|  235353 |  4758 | `	pGen->pIn++;` |
|  235353 |  4759 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|       - |  4760 | `		/* Compile the expression */` |
|  235325 |  4761 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|  235325 |  4762 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  4763 | `			return SXERR_ABORT;` |
|  235325 |  4764 | `		}else if(rc != SXERR_EMPTY ){` |
|  235325 |  4765 | `			nRet = 1;` |
|  117660 |  4766 | `		}` |
|  117660 |  4767 | `	}` |
...
|  235353 |  4773 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,nRet,1,0,0);` |
|  235353 |  4774 | `	return SXRET_OK;` |
|  117679 |  4775 |  |
|       - |  4776 | `/*` |
...
|     188 |  4796 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_ID)` |
...
|       - |  4887 | ` */` |
|   14696 |  4888 | `static sxi32 PH7_CompileEcho(ph7_gen_state *pGen)` |
|       5 |  4889 |  |
|   14701 |  4890 | `	SyToken *pTmp,*pNext = 0;` |
|       - |  4891 | `	sxi32 rc;` |
|       - |  4892 | `	/* Jump the 'echo' keyword */` |
|   14701 |  4893 | `	pGen->pIn++;` |
|       - |  4894 | `	/* Compile arguments one after one */` |
|   14701 |  4895 | `	pTmp = pGen->pEnd;` |
|   32501 |  4896 | `	while( SXRET_OK == PH7_GetNextExpr(pGen->pIn,pTmp,&pNext) ){` |
|   17805 |  4897 | `		if( pGen->pIn < pNext ){` |
|   17805 |  4898 | `			pGen->pEnd = pNext;` |
|   17805 |  4899 | `			rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_RDONLY_LOAD/* Do not create variable if inexistant */,0);` |
|   17805 |  4900 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  4901 | `				return SXERR_ABORT;` |
|   17805 |  4902 | `			}else if( rc != SXERR_EMPTY ){` |
|       - |  4903 | `				/* Emit the consume instruction */` |
|   17781 |  4904 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_CONSUME,1,0,0,0);` |
|    8888 |  4905 | `			}` |
|    8900 |  4906 | `		}` |
|       - |  4907 | `		/* Jump trailing commas */` |
|   20909 |  4908 | `		while( pNext < pTmp && (pNext->nType & PH7_TK_COMMA) ){` |
|    3109 |  4909 | `			pNext++;` |
|       5 |  4910 | `		}` |
|   17805 |  4911 | `		pGen->pIn = pNext;` |
|       5 |  4912 | `	}` |
|       - |  4913 | `	/* Restore token stream */` |
|   14701 |  4914 | `	pGen->pEnd = pTmp;` |
|   14701 |  4915 | `	return SXRET_OK;` |
|    7353 |  4916 |  |
|       - |  4917 | `/*` |
...
|       - |  5082 | ` */` |
|  457138 |  5083 | `static sxu32 GenStateNsQualifyName(ph7_gen_state *pGen,sxu32 nOrigIdx,SyHash *pImports,int *pFromImport)` |
|       5 |  5084 |  |
|       - |  5085 | `	ph7_value *pLit;` |
...
|       - |  5093 | `	ph7_value *pNew;` |
|  457143 |  5094 | `	if( pFromImport ){` |
|  437515 |  5095 | `		*pFromImport = 0;` |
|  218755 |  5096 | `	}` |
|  457143 |  5097 | `	pLit = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,nOrigIdx);` |
|  457143 |  5098 | `	if( !pLit \|\| !(pLit->iFlags & MEMOBJ_STRING) \|\| SyBlobLength(&pLit->sBlob) == 0 ){` |
|     ! 0 |  5099 | `		return nOrigIdx;` |
|       - |  5100 | `	}` |
|  457143 |  5101 | `	zLit = (const char *)SyBlobData(&pLit->sBlob);` |
|  457143 |  5102 | `	nLit = (sxu32)SyBlobLength(&pLit->sBlob);` |
|       - |  5103 | `	/* Skip if already qualified (contains backslash) */` |
|  457143 |  5104 | `	hasNsSep = 0;` |
| 5049313 |  5105 | `	for( k = 0; k < nLit; k++ ){` |
| 4592183 |  5106 | `		if( zLit[k] == '\\' ){ hasNsSep = 1; break; }` |
| 2296090 |  5107 | `	}` |
|  457143 |  5108 | `	if( hasNsSep ){` |
|      10 |  5109 | `		return nOrigIdx;` |
|       - |  5110 | `	}` |
|       - |  5111 | `	/* Check use imports first (works even outside namespaces) */` |
|  457135 |  5112 | `	SyBlobReset(&pGen->sWorker);` |
|  457135 |  5113 | `	pImport = SyHashGet(pImports,(const void *)zLit,nLit);` |
|  457135 |  5114 | `	if( pImport ){` |
...
|       8 |  5119 | `		}` |
|      23 |  5120 | `	}else{` |
|  457099 |  5121 | `		if( SyBlobLength(&pGen->sNamespace) == 0 ){` |
|  457009 |  5122 | `			return nOrigIdx; /* Not in a namespace and no import match */` |
|       - |  5123 | `		}` |
...
|       - |  5145 | ` */` |
|   96624 |  5146 | `static void GenStateResolveName(ph7_gen_state *pGen,const SyString *pName,SyBlob *pOut)` |
|       5 |  5147 |  |
|       - |  5148 | `	SyHashEntry *pImport;` |
|       - |  5149 | `	/* Check use imports first */` |
|   96629 |  5150 | `	pImport = SyHashGet(&pGen->hUseImports,(const void *)pName->zString,pName->nByte);` |
|   96629 |  5151 | `	if( pImport ){` |
...
|       - |  5167 | ` */` |
|  139618 |  5168 | `static void GenStateBuildFQN(ph7_gen_state *pGen,const SyString *pName,SyBlob *pOut)` |
|       5 |  5169 |  |
|  139623 |  5170 | `	if( SyBlobLength(&pGen->sNamespace) > 0 ){` |
|      63 |  5171 | `		SyBlobAppend(pOut,SyBlobData(&pGen->sNamespace),SyBlobLength(&pGen->sNamespace));` |
|      63 |  5172 | `		SyBlobAppend(pOut,"\\",1);` |
|      29 |  5173 | `	}` |
|  139623 |  5174 | `	SyBlobAppend(pOut,pName->zString,pName->nByte);` |
|  139623 |  5175 |  |
|       - |  5176 | `/*` |
...
|       3 |  5213 |  |
|      17 |  5214 | `	if( nType & PH7_TK_INTEGER ){ return "integer"; }` |
|      10 |  5215 | `	if( nType & PH7_TK_REAL ){ return "float"; }` |
|      10 |  5216 | `	if( nType & (PH7_TK_DSTR\|PH7_TK_SSTR\|PH7_TK_HEREDOC\|PH7_TK_NOWDOC) ){ return "string"; }` |
|      10 |  5217 | `	if( nType & PH7_TK_KEYWORD ){ return "keyword"; }` |
|      10 |  5218 | `	if( nType & PH7_TK_ID ){ return "identifier"; }` |
|      10 |  5219 | `	if( nType & PH7_TK_DOLLAR ){ return "variable"; }` |
|       3 |  5220 | `	return "token";` |
|      10 |  5221 |  |
...
|      27 |  5255 | `			if( SyBlobLength(&pGen->sNamespace) > 0 ){` |
|      27 |  5256 | `				SyBlobAppend(&pGen->sNamespace,"\\",1);` |
|      11 |  5257 | `			}` |
|      16 |  5258 | `		}else{` |
...
|      19 |  5366 | `			pGen->pIn++; /* Jump 'as' */` |
|      19 |  5367 | `			if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_ID) ){` |
|      19 |  5368 | `				sAlias = pGen->pIn->sData;` |
|      19 |  5369 | `				pGen->pIn++;` |
|       8 |  5370 | `			}` |
|       8 |  5371 | `		}` |
...
|       - |  5672 | ` */` |
|   74464 |  5673 | `static sxi32 GenStateProcessArgValue(ph7_gen_state *pGen,ph7_vm_func_arg *pArg,SyToken *pIn,SyToken *pEnd)` |
|       5 |  5674 |  |
|       - |  5675 | `	SyToken *pTmpIn,*pTmpEnd;` |
|       - |  5676 | `	SySet *pInstrContainer;` |
|       - |  5677 | `	sxi32 rc;` |
|       - |  5678 | `	/* Swap token stream */` |
|   74469 |  5679 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|   74469 |  5680 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   74469 |  5681 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pArg->aByteCode);` |
|       - |  5682 | `	/* Compile the expression holding the argument value */` |
|   74469 |  5683 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|       - |  5684 | `	/* Emit the done instruction */` |
|   74469 |  5685 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,(rc != SXERR_EMPTY ? 1 : 0),0,0,0);` |
|   74469 |  5686 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|   74469 |  5687 | `	RE_SWAP_DELIMITER(pGen);` |
|   74469 |  5688 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  5689 | `		return SXERR_ABORT;` |
|       - |  5690 | `	}` |
|   74469 |  5691 | `	return SXRET_OK;` |
|   37237 |  5692 |  |
|       - |  5693 | `/*` |
...
|       - |  5729 | ` */` |
|  104160 |  5730 | `static sxi32 GenStateCollectFuncArgs(ph7_vm_func *pFunc,ph7_gen_state *pGen,SyToken *pEnd,int bCtorCtx,int bAbstractCtx)` |
|       5 |  5731 |  |
...
|       - |  5736 | `	sxi32 rc;` |
|       - |  5737 |  |
|  104165 |  5738 | `	pIn = pGen->pIn;` |
|  104165 |  5739 | `	SyBlobInit(&sSig,&pGen->pVm->sAllocator);` |
|       - |  5740 | `	/* Process arguments one after one */` |
|  134653 |  5741 | `	for(;;){` |
|  269311 |  5742 | `		if( pIn >= pEnd ){` |
|       - |  5743 | `			/* No more arguments to process */` |
|  104151 |  5744 | `			break;` |
|       - |  5745 | `		}` |
|  165165 |  5746 | `		SyZero(&sArg,sizeof(ph7_vm_func_arg));` |
|  165165 |  5747 | `		SySetInit(&sArg.aByteCode,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|  165165 |  5748 | `		SySetInit(&sArg.aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|  165165 |  5749 | `		SyStringInitFromBuf(&sArg.sTypeName,0,0);` |
...
|       - |  5755 | `		{` |
|  165165 |  5756 | `			int bReadonly = 0, bVisSeen = 0;` |
|  165165 |  5757 | `			sxi32 iVis = PH7_CLASS_PROT_PUBLIC;` |
|  165165 |  5758 | `			if( pIn < pEnd && GenStateIsReadonly(pIn) ){` |
|       3 |  5759 | `				bReadonly = 1;` |
|       3 |  5760 | `				pIn++;` |
|       1 |  5761 | `			}` |
|  165165 |  5762 | `			if( pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD) ){` |
|   64029 |  5763 | `				sxu32 nKw = (sxu32)SX_PTR_TO_INT(pIn->pUserData);` |
|   64029 |  5764 | `				if( nKw == PH7_TKWRD_PUBLIC \|\| nKw == PH7_TKWRD_PROTECTED \|\| nKw == PH7_TKWRD_PRIVATE ){` |
|      71 |  5765 | `					bVisSeen = 1;` |
...
|      33 |  5774 | `				}` |
|   32012 |  5775 | `			}` |
|  165165 |  5776 | `			if( bVisSeen \|\| bReadonly ){` |
|      73 |  5777 | `				if( !bCtorCtx ){` |
...
|  206078 |  5798 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_DOLLAR) == 0` |
|  125285 |  5799 | `			&& (pIn->nType & PH7_TK_AMPER) == 0` |
|   83634 |  5800 | `			&& (pIn->nType & PH7_TK_ELLIPSIS) == 0 ){` |
|   78281 |  5801 | `			sxu32 nLineLocal = pIn->nLine;` |
|   78281 |  5802 | `			sxi32 iTFlags = 0;` |
|   78281 |  5803 | `			pGen->pIn = pIn;` |
|   78281 |  5804 | `			rc = GenStateParseUnionTypeDecl(` |
|   39138 |  5805 | `				pGen, &sArg.nType, &sArg.sClass, &sArg.aUnionAlts,` |
|   39138 |  5806 | `				&iTFlags, &sArg.sTypeName,` |
|       - |  5807 | `				VM_FUNC_ARG_NULLABLE, VM_FUNC_ARG_UNION,` |
|       - |  5808 | `				/* bAllowVoid */ 0,` |
|   39138 |  5809 | `						nLineLocal);` |
|   78281 |  5810 | `			pIn = pGen->pIn;` |
|   78281 |  5811 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  5812 | `				return SXERR_ABORT;` |
|   78281 |  5813 | `			}else if( rc == SXERR_CORRUPT ){` |
|       - |  5814 | `				/* Error already reported by GenStateParseUnionTypeDecl */` |
|       3 |  5815 | `				return SXERR_SYNTAX;` |
|   78279 |  5816 | `			}else if( rc == SXERR_SYNTAX ){` |
|       9 |  5817 | `				if( pIn < pEnd ){` |
|      12 |  5818 | `					PH7_GenCompileError(pGen,E_PARSE,pIn->nLine,` |
...
|       - |  5824 | `				}` |
|       9 |  5825 | `				return SXERR_SYNTAX;` |
|       - |  5826 | `			}` |
|   78273 |  5827 | `			sArg.iFlags \|= iTFlags;` |
|   39134 |  5828 | `		}` |
|  165153 |  5829 | `		if( pIn >= pEnd ){` |
|     ! 0 |  5830 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Missing argument name");` |
|     ! 0 |  5831 | `			return rc;` |
|       - |  5832 | `		}` |
|  165153 |  5833 | `		if( pIn->nType & PH7_TK_AMPER ){` |
|       - |  5834 | `			/* Pass by reference,record that */` |
|    3577 |  5835 | `			sArg.iFlags \|= VM_FUNC_ARG_BY_REF;` |
|    3577 |  5836 | `			pIn++;` |
|    1786 |  5837 | `		}` |
|  165153 |  5838 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_ELLIPSIS) ){` |
|       - |  5839 | `			/* Variadic parameter: ...$args */` |
|    3593 |  5840 | `			sArg.iFlags \|= VM_FUNC_ARG_VARIADIC;` |
|    3593 |  5841 | `			pIn++;` |
|    1794 |  5842 | `		}` |
|  165153 |  5843 | `		if( pIn >= pEnd \|\| (pIn->nType & PH7_TK_DOLLAR) == 0 \|\| &pIn[1] >= pEnd \|\| (pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|       - |  5844 | `			/* Invalid argument */` |
|     ! 0 |  5845 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Invalid argument name");` |
|     ! 0 |  5846 | `			return rc;` |
|       - |  5847 | `		}` |
|  165153 |  5848 | `		pIn++; /* Jump the dollar sign */` |
|       - |  5849 | `		/* Copy argument name */` |
|  165153 |  5850 | `		zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,SyStringData(&pIn->sData),SyStringLength(&pIn->sData));` |
|  165153 |  5851 | `		if( zDup == 0 ){` |
|     ! 0 |  5852 | `			PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"PH7 engine is running out of memory");` |
|     ! 0 |  5853 | `			return SXERR_ABORT;` |
|       - |  5854 | `		}` |
|  165153 |  5855 | `		SyStringInitFromBuf(&sArg.sName,zDup,SyStringLength(&pIn->sData));` |
|  165153 |  5856 | `		pIn++;` |
|  165153 |  5857 | `		if( pIn < pEnd ){` |
|  100027 |  5858 | `			if( pIn->nType & PH7_TK_EQUAL ){` |
|       - |  5859 | `				SyToken *pDefend;` |
|   74471 |  5860 | `				sxi32 iNest = 0;` |
|   74471 |  5861 | `				pIn++; /* Jump the equal sign */` |
|   74471 |  5862 | `				pDefend = pIn;` |
|       - |  5863 | `				/* Process the default value associated with this argument */` |
|  156023 |  5864 | `				while( pDefend < pEnd ){` |
|  117007 |  5865 | `					if( (pDefend->nType & PH7_TK_COMMA) && iNest <= 0 ){` |
|   35455 |  5866 | `						break;` |
|       - |  5867 | `					}` |
|   81557 |  5868 | `					if( pDefend->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*[*/) ){` |
|       - |  5869 | `						/* Increment nesting level */` |
|    3549 |  5870 | `						iNest++;` |
|   79785 |  5871 | `					}else if( pDefend->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CCB/*'}'*/\|PH7_TK_CSB/*]*/) ){` |
|       - |  5872 | `						/* Decrement nesting level */` |
|    3549 |  5873 | `						iNest--;` |
|    1772 |  5874 | `					}` |
|   81557 |  5875 | `					pDefend++;` |
|       5 |  5876 | `				}` |
|   74471 |  5877 | `				if( pIn >= pDefend ){` |
|       3 |  5878 | `					rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Missing argument default value");` |
|       3 |  5879 | `					return rc;` |
|       - |  5880 | `				}` |
|       - |  5881 | `				/* Process default value */` |
|   74469 |  5882 | `				rc = GenStateProcessArgValue(&(*pGen),&sArg,pIn,pDefend);` |
|   74469 |  5883 | `				if( rc != SXRET_OK ){` |
|     ! 0 |  5884 | `					return rc;` |
|       - |  5885 | `				}` |
|       - |  5886 | `				/* Point beyond the default value */` |
|   74469 |  5887 | `				pIn = pDefend;` |
|   37232 |  5888 | `			}` |
|  100025 |  5889 | `			if( pIn < pEnd && (pIn->nType & PH7_TK_COMMA) == 0 ){` |
|     ! 0 |  5890 | `				rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Unexpected token '%z'",&pIn->sData);` |
|     ! 0 |  5891 | `				return rc;` |
|       - |  5892 | `			}` |
|  100025 |  5893 | `			pIn++; /* Jump the trailing comma */` |
|   50010 |  5894 | `		}` |
|       - |  5895 | `		/* Append argument signature */` |
|  165151 |  5896 | `		if( sArg.nType > 0 ){` |
|   78219 |  5897 | `			if( SyStringLength(&sArg.sClass) > 0 ){` |
|       - |  5898 | `				/* Class name — prefix with 'o' so generic object hint is a prefix match */` |
|   14237 |  5899 | `				int marker = 'o';` |
|   14237 |  5900 | `				SyBlobAppend(&sSig,(const void *)&marker,sizeof(char));` |
|   14237 |  5901 | `				SyBlobAppend(&sSig,SyStringData(&sArg.sClass),SyStringLength(&sArg.sClass));` |
|    7121 |  5902 | `			}else{` |
|       - |  5903 | `				int c;` |
|   63987 |  5904 | `				c = 'n'; /* cc warning */` |
|       - |  5905 | `				/* Type leading character */` |
|   63987 |  5906 | `				switch(sArg.nType){` |
|       3 |  5907 | `				case MEMOBJ_HASHMAP:` |
|       - |  5908 | `					/* Hashmap aka 'array' */` |
|       7 |  5909 | `					c = 'h';` |
|       7 |  5910 | `					break;` |
|    8916 |  5911 | `				case MEMOBJ_INT:` |
|       - |  5912 | `					/* Integer */` |
|   17837 |  5913 | `					c = 'i';` |
|   17837 |  5914 | `					break;` |
...
|       2 |  5932 | `					break;` |
|       - |  5933 | `				}` |
|   63987 |  5934 | `				SyBlobAppend(&sSig,(const void *)&c,sizeof(char));` |
|       - |  5935 | `			}` |
|   39112 |  5936 | `		}else{` |
|       - |  5937 | `			/* No type is associated with this parameter which mean` |
|       - |  5938 | `			 * that this function is not condidate for overloading.` |
|       - |  5939 | `			 */` |
|   86937 |  5940 | `			SyBlobRelease(&sSig);` |
|       - |  5941 | `		}` |
|       - |  5942 | `		/* Save in the argument set */` |
|  165151 |  5943 | `		SySetPut(&pFunc->aArgs,(const void *)&sArg);` |
|       5 |  5944 | `	}` |
|  104151 |  5945 | `	if( SyBlobLength(&sSig) > 0 ){` |
|       - |  5946 | `		/* Save function signature */` |
|   49833 |  5947 | `		SyStringInitFromBuf(&pFunc->sSignature,SyBlobData(&sSig),SyBlobLength(&sSig));` |
|   24914 |  5948 | `	}` |
|  104151 |  5949 | `	return SXRET_OK;` |
|   52085 |  5950 |  |
|       - |  5951 | `/*` |
...
|       - |  5955 | ` */` |
|  222136 |  5956 | `static sxi32 GenStateCompileFuncBody(` |
...
|  222141 |  5966 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC,PH7_VmInstrLength(pGen->pVm),pFunc,&pBlock);` |
|  222141 |  5967 | `	if( rc != SXRET_OK ){` |
...
|       - |  5971 | `	}` |
|  222141 |  5972 | `	nGotoOfft = SySetUsed(&pGen->aGoto);` |
|       - |  5973 | `	/* Swap bytecode containers */` |
|  222141 |  5974 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|  222141 |  5975 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pFunc->aByteCode);` |
...
|       - |  5980 | `	{` |
|  222141 |  5981 | `		sxu32 nArg = SySetUsed(&pFunc->aArgs);` |
|       - |  5982 | `		sxu32 i;` |
|  358793 |  5983 | `		for( i = 0; i < nArg; i++ ){` |
|  136657 |  5984 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pFunc->aArgs,i);` |
|       - |  5985 | `			char *zSrc;` |
|       - |  5986 | `			sxu32 nSrc,nName;` |
|       - |  5987 | `			SySet sToken;` |
|       - |  5988 | `			SyToken *pTmpIn,*pTmpEnd;` |
|       - |  5989 | `			sxi32 rcPromote;` |
|  136657 |  5990 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|  136603 |  5991 | `				continue;` |
|       - |  5992 | `			}` |
...
|  222141 |  6039 | `	PH7_CompileBlock(&(*pGen),0);` |
|       - |  6040 | `	/* Fix exception jumps now the destination is resolved */` |
|  222141 |  6041 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|       - |  6042 | `	/* Emit the final return if not yet done */` |
|  222141 |  6043 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|       - |  6044 | `	/* Fix gotos jumps now the destination is resolved */` |
|  222141 |  6045 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),nGotoOfft) ){` |
|     ! 0 |  6046 | `		rc = SXERR_ABORT;` |
|     ! 0 |  6047 | `	}` |
|  222141 |  6048 | `	SySetTruncate(&pGen->aGoto,nGotoOfft);` |
|       - |  6049 | `	/* Restore the default container */` |
|  222141 |  6050 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|       - |  6051 | `	/* Leave function block */` |
|  222141 |  6052 | `	GenStateLeaveBlock(&(*pGen),0);` |
|  222141 |  6053 | `	if( rc == SXERR_ABORT ){` |
...
|       - |  6058 | `	{` |
|  222141 |  6059 | `		VmInstr *aInstr = (VmInstr *)SySetBasePtr(&pFunc->aByteCode);` |
|       - |  6060 | `		sxu32 i;` |
| 4363087 |  6061 | `		for( i = 0; i < SySetUsed(&pFunc->aByteCode); i++ ){` |
| 4141051 |  6062 | `			if( aInstr[i].iOp == PH7_OP_YIELD \|\| aInstr[i].iOp == PH7_OP_YIELD_FROM ){` |
...
|       - |  6132 | ` */` |
|   79114 |  6133 | `static sxi32 GenStateParseOneTypeAtom(ph7_gen_state *pGen, PhlTypeAtom *pOut)` |
|       5 |  6134 |  |
|   79119 |  6135 | `	SyToken *pIn = pGen->pIn;` |
|   79119 |  6136 | `	SyZero(pOut, sizeof(*pOut));` |
|   79119 |  6137 | `	SyStringInitFromBuf(&pOut->sClass, 0, 0);` |
|   79119 |  6138 | `	if( pIn >= pGen->pEnd ){` |
|     ! 0 |  6139 | `		return SXERR_SYNTAX;` |
|       - |  6140 | `	}` |
|       - |  6141 | `	/* Optional leading namespace separator '\' on FQN class types */` |
|   79119 |  6142 | `	if( pIn->nType & PH7_TK_NSSEP ){` |
|       8 |  6143 | `		pIn++;` |
|       8 |  6144 | `		if( pIn >= pGen->pEnd ){` |
|     ! 0 |  6145 | `			return SXERR_SYNTAX;` |
|       - |  6146 | `		}` |
|       3 |  6147 | `	}` |
|   79119 |  6148 | `	if( (pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|     ! 0 |  6149 | `		return SXERR_SYNTAX;` |
|       - |  6150 | `	}` |
|   79119 |  6151 | `	if( pIn->nType & PH7_TK_KEYWORD ){` |
|   64529 |  6152 | `		sxu32 nKey = (sxu32)(SX_PTR_TO_INT(pIn->pUserData));` |
|   64529 |  6153 | `		if( nKey & PH7_TKWRD_ARRAY ){` |
|      32 |  6154 | `			pOut->nType = MEMOBJ_HASHMAP; pOut->zCanon = "array"; pOut->nCanon = 5;` |
|   64515 |  6155 | `		}else if( nKey & PH7_TKWRD_BOOL ){` |
|      71 |  6156 | `			pOut->nType = MEMOBJ_BOOL; pOut->zCanon = "bool"; pOut->nCanon = 4;` |
|   64468 |  6157 | `		}else if( nKey & PH7_TKWRD_INT ){` |
|   18085 |  6158 | `			pOut->nType = MEMOBJ_INT; pOut->zCanon = "int"; pOut->nCanon = 3;` |
|   55395 |  6159 | `		}else if( nKey & PH7_TKWRD_STRING ){` |
|   46285 |  6160 | `			pOut->nType = MEMOBJ_STRING; pOut->zCanon = "string"; pOut->nCanon = 6;` |
|   23215 |  6161 | `		}else if( nKey & PH7_TKWRD_FLOAT ){` |
...
|   14595 |  6176 | `		SyString *pT = &pIn->sData;` |
|   14595 |  6177 | `		if( pT->nByte == 4 && SyMemcmpNoCase(pT->zString, "null", 4) == 0 ){` |
|      32 |  6178 | `			pOut->nType = UTA_NULL_FLAG; pOut->zCanon = "null"; pOut->nCanon = 4;` |
|      32 |  6179 | `			pIn++;` |
|   14581 |  6180 | `		}else if( pT->nByte == 4 && SyMemcmpNoCase(pT->zString, "void", 4) == 0 ){` |
|     157 |  6181 | `			pOut->nType = UTA_VOID_FLAG; pOut->zCanon = "void"; pOut->nCanon = 4;` |
|     157 |  6182 | `			pIn++;` |
|   14491 |  6183 | `		}else if( pT->nByte == 5 && SyMemcmpNoCase(pT->zString, "never", 5) == 0 ){` |
|       3 |  6184 | `			pOut->nType = UTA_NEVER_FLAG; pOut->zCanon = "never"; pOut->nCanon = 5;` |
|       3 |  6185 | `			pIn++;` |
|       2 |  6186 | `		}else{` |
|       - |  6187 | `			/* Class / interface name; consume namespace path a\b\c */` |
|   14413 |  6188 | `			SyToken *pFirst = pIn;` |
|   14413 |  6189 | `			SyToken *pLast = pIn;` |
|   14413 |  6190 | `			pOut->nType = SXU32_HIGH;` |
|   14413 |  6191 | `			pOut->sClass = pIn->sData;` |
|   14413 |  6192 | `			pIn++;` |
|   21615 |  6193 | `			while( pIn + 1 < pGen->pEnd && (pIn->nType & PH7_TK_NSSEP)` |
|   14416 |  6194 | `				&& (pIn[1].nType & PH7_TK_ID) ){` |
|       3 |  6195 | `				pLast = &pIn[1];` |
|       3 |  6196 | `				pIn += 2;` |
|       1 |  6197 | `			}` |
|   14413 |  6198 | `			if( pLast != pFirst ){` |
...
|       - |  6204 | `		}` |
|       - |  6205 | `	}` |
|   79117 |  6206 | `	pGen->pIn = pIn;` |
|   79117 |  6207 | `	return SXRET_OK;` |
|   39562 |  6208 |  |
|       - |  6209 |  |
|       - |  6210 | `/*` |
...
|       - |  6216 | ` */` |
|   78960 |  6217 | `static void GenBuildUnionTypeText(SyBlob *pBlob, PhlTypeAtom *aAtoms, int nAtoms, int bNullable)` |
|       5 |  6218 |  |
|       - |  6219 | `	int i;` |
|   78965 |  6220 | `	int nNonNull = 0;` |
|   78965 |  6221 | `	int bAnyIntersection = 0;` |
|       - |  6222 | `	sxu32 aGroupCount[PHL_UNION_MAX_ALTS];` |
|   78965 |  6223 | `	sxu32 nMaxGroup = 0;` |
| 2605685 |  6224 | `	for( i = 0; i < PHL_UNION_MAX_ALTS; i++ ) aGroupCount[i] = 0;` |
|  158059 |  6225 | `	for( i = 0; i < nAtoms; i++ ){` |
|   79099 |  6226 | `		if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|   79071 |  6227 | `			nNonNull++;` |
|   79071 |  6228 | `			if( aAtoms[i].nGroup < PHL_UNION_MAX_ALTS ){` |
|   79071 |  6229 | `				aGroupCount[aAtoms[i].nGroup]++;` |
|   79071 |  6230 | `				if( aAtoms[i].nGroup > nMaxGroup ) nMaxGroup = aAtoms[i].nGroup;` |
|   39533 |  6231 | `			}` |
|   39533 |  6232 | `		}` |
|   39552 |  6233 | `	}` |
|  158025 |  6234 | `	for( i = 0; i < nAtoms; i++ ){` |
|   79081 |  6235 | `		if( aAtoms[i].nType != UTA_NULL_FLAG && aGroupCount[aAtoms[i].nGroup] >= 2 ){` |
|      19 |  6236 | `			bAnyIntersection = 1;` |
|      19 |  6237 | `			break;` |
|       - |  6238 | `		}` |
|   39535 |  6239 | `	}` |
|   78965 |  6240 | `	if( bAnyIntersection ){` |
...
|      57 |  6275 | `		return;` |
|       - |  6276 | `	}` |
|   78949 |  6277 | `	if( nNonNull == 1 && bNullable ){` |
|       - |  6278 | `		/* Shorthand: ?T */` |
...
|     ! 0 |  6289 | `	}` |
|       - |  6290 | `	{` |
|   78873 |  6291 | `		int bFirst = 1;` |
|       - |  6292 | `		/* 1) Classes in declaration order */` |
|  157843 |  6293 | `		for( i = 0; i < nAtoms; i++ ){` |
|   78975 |  6294 | `			if( aAtoms[i].nType == SXU32_HIGH ){` |
|   14377 |  6295 | `				if( !bFirst ) SyBlobAppend(pBlob, "\|", 1);` |
|   14377 |  6296 | `				SyBlobAppend(pBlob, aAtoms[i].sClass.zString, aAtoms[i].sClass.nByte);` |
|   14377 |  6297 | `				bFirst = 0;` |
|    7186 |  6298 | `			}` |
|   39490 |  6299 | `		}` |
...
|       - |  6304 | `			int k;` |
|  552081 |  6305 | `			for( k = 0; k < (int)(sizeof(aOrder)/sizeof(aOrder[0])); k++ ){` |
|  882493 |  6306 | `				for( i = 0; i < nAtoms; i++ ){` |
|  473717 |  6307 | `					if( aAtoms[i].nType == aOrder[k] ){` |
|   64437 |  6308 | `						if( !bFirst ) SyBlobAppend(pBlob, "\|", 1);` |
|   64437 |  6309 | `						SyBlobAppend(pBlob, aAtoms[i].zCanon, aAtoms[i].nCanon);` |
|   64437 |  6310 | `						bFirst = 0;` |
|   64437 |  6311 | `						break;` |
|       - |  6312 | `					}` |
|  204645 |  6313 | `				}` |
...
|       - |  6337 | ` */` |
|   79096 |  6338 | `static sxi32 GenStateParsePart(` |
|       - |  6339 | `	ph7_gen_state *pGen, PhlTypeAtom *aAtoms, int *pnAtoms, sxu32 iGroup,` |
|       - |  6340 | `	int *pnMembers, int *pbParen, sxu32 nLine)` |
|       5 |  6341 |  |
|       - |  6342 | `	sxi32 rc;` |
|   79101 |  6343 | `	int nMembers = 0;` |
|   79101 |  6344 | `	int bParen = 0;` |
|   79101 |  6345 | `	*pnMembers = 0;` |
|   79101 |  6346 | `	*pbParen = 0;` |
|   79101 |  6347 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_LPAREN) ){` |
|       6 |  6348 | `		bParen = 1;` |
|       6 |  6349 | `		pGen->pIn++; /* skip '(' */` |
|       2 |  6350 | `	}` |
|   39548 |  6351 | `	for(;;){` |
|   79119 |  6352 | `		if( *pnAtoms >= PHL_UNION_MAX_ALTS ){` |
...
|       - |  6356 | `		}` |
|   79119 |  6357 | `		rc = GenStateParseOneTypeAtom(pGen, &aAtoms[*pnAtoms]);` |
|   79119 |  6358 | `		if( rc != SXRET_OK ){` |
|       3 |  6359 | `			return rc;` |
|       - |  6360 | `		}` |
|   79117 |  6361 | `		aAtoms[*pnAtoms].nGroup = iGroup;` |
|   79117 |  6362 | `		(*pnAtoms)++;` |
|   79117 |  6363 | `		nMembers++;` |
|       - |  6364 | ``		/* Continue the intersection while `&` is followed by another type atom. */`` |
|   79117 |  6365 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
...
|       - |  6386 | `		}` |
|       2 |  6387 | `	}` |
|   79099 |  6388 | `	*pnMembers = nMembers;` |
|   79099 |  6389 | `	*pbParen = bParen;` |
|   79099 |  6390 | `	return SXRET_OK;` |
|   39553 |  6391 |  |
|       - |  6392 |  |
|       - |  6393 | `/*` |
...
|       - |  6410 | ` */` |
|   78972 |  6411 | `static sxi32 GenStateParseUnionTypeDecl(` |
...
|   78977 |  6424 | `	int nAtoms = 0;` |
|   78977 |  6425 | `	int bShortNullable = 0;` |
|   78977 |  6426 | `	int bExplicitNull = 0;` |
|       - |  6427 | `	sxi32 rc;` |
|   78977 |  6428 | `	*pnType = 0;` |
|   78977 |  6429 | `	if( pClass ) SyStringInitFromBuf(pClass, 0, 0);` |
|   78977 |  6430 | `	*piTypeFlags = 0;` |
|   78977 |  6431 | `	if( pTypeText ) SyStringInitFromBuf(pTypeText, 0, 0);` |
|       - |  6432 |  |
|   78977 |  6433 | `	if( pGen->pIn >= pGen->pEnd ){` |
|     ! 0 |  6434 | `		return SXRET_OK;` |
|       - |  6435 | `	}` |
|       - |  6436 | ``	/* Optional `?` shorthand prefix */`` |
|   78972 |  6437 | `	if( (pGen->pIn->nType & PH7_TK_OP) && pGen->pIn->sData.nByte == 1` |
...
|   78977 |  6450 | `		sxu32 iGroup = 0;` |
|   78977 |  6451 | `		rc = GenStateParsePart(pGen, aAtoms, &nAtoms, iGroup, &nMembers, &bParen, nLine);` |
|   78977 |  6452 | `		if( rc != SXRET_OK ){` |
|       4 |  6453 | `			return rc;` |
|       - |  6454 | `		}` |
...
|  118643 |  6460 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OP)` |
|   79163 |  6461 | `			&& pGen->pIn->sData.nByte == 1 && pGen->pIn->sData.zString[0] == '\|' ){` |
...
|       - |  6479 | `			}` |
|       5 |  6480 | `		}` |
|   78973 |  6481 | `		if( iGroup > 0 && nMembers >= 2 && !bParen ){` |
...
|       - |  6493 | `	{` |
|       - |  6494 | `		int i, j;` |
|   78973 |  6495 | `		int bHasNonNull = 0;` |
|   78973 |  6496 | `		int bAnyIntersection = 0;` |
...
| 2605949 |  6500 | `		for( i = 0; i < PHL_UNION_MAX_ALTS; i++ ) aGroupCount[i] = 0;` |
|  158083 |  6501 | `		for( i = 0; i < nAtoms; i++ ){` |
|   79115 |  6502 | `			if( aAtoms[i].nGroup < PHL_UNION_MAX_ALTS ) aGroupCount[aAtoms[i].nGroup]++;` |
|   39560 |  6503 | `		}` |
|  158045 |  6504 | `		for( i = 0; i < nAtoms; i++ ){` |
|   79095 |  6505 | `			if( aGroupCount[aAtoms[i].nGroup] >= 2 ){ bAnyIntersection = 1; break; }` |
|   39541 |  6506 | `		}` |
...
|   78973 |  6509 | `		if( bShortNullable && bAnyIntersection ){` |
...
|       - |  6513 | `		}` |
|  158073 |  6514 | `		for( i = 0; i < nAtoms; i++ ){` |
...
|   79113 |  6518 | `			if( aGroupCount[aAtoms[i].nGroup] >= 2 ){` |
...
|       - |  6540 | `				}` |
|      16 |  6541 | `			}` |
|   79111 |  6542 | `			if( aAtoms[i].nType == UTA_VOID_FLAG ){` |
...
|       - |  6557 | `				}` |
|      75 |  6558 | `			}` |
|   79109 |  6559 | `			if( aAtoms[i].nType == UTA_NEVER_FLAG ){` |
...
|       - |  6573 | `			}` |
|   79107 |  6574 | `			if( aAtoms[i].nType == UTA_NULL_FLAG ){` |
|      32 |  6575 | `				bExplicitNull = 1;` |
|      18 |  6576 | `			}else{` |
|   79079 |  6577 | `				bHasNonNull = 1;` |
|       - |  6578 | `			}` |
...
|      91 |  6616 | `			}` |
|   39555 |  6617 | `		}` |
|   78965 |  6618 | `		if( !bHasNonNull && bExplicitNull ){` |
...
|   78965 |  6633 | `	if( bShortNullable \|\| bExplicitNull ){` |
|      97 |  6634 | `		*piTypeFlags \|= iNullableFlag;` |
|      46 |  6635 | `	}` |
|       - |  6636 | `	/* Build canonical type text */` |
|   78965 |  6637 | `	if( pTypeText ){` |
|       - |  6638 | `		SyBlob sBlob;` |
|   78965 |  6639 | `		SyBlobInit(&sBlob, &pGen->pVm->sAllocator);` |
|  118413 |  6640 | `		GenBuildUnionTypeText(&sBlob, aAtoms, nAtoms,` |
|   39480 |  6641 | `			(bShortNullable \|\| bExplicitNull) ? 1 : 0);` |
|   78965 |  6642 | `		if( SyBlobLength(&sBlob) > 0 ){` |
|  118220 |  6643 | `			char *zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|   78810 |  6644 | `				(const char *)SyBlobData(&sBlob), SyBlobLength(&sBlob));` |
|   78815 |  6645 | `			if( zDup ){` |
|   78815 |  6646 | `				SyStringInitFromBuf(pTypeText, zDup, SyBlobLength(&sBlob));` |
|   39405 |  6647 | `			}` |
|   39405 |  6648 | `		}` |
|   78965 |  6649 | `		SyBlobRelease(&sBlob);` |
|   39480 |  6650 | `	}` |
...
|       - |  6654 | `	{` |
|   78965 |  6655 | `		int nNonNull = 0;` |
|   78965 |  6656 | `		int iNonNullIdx = -1;` |
|       - |  6657 | `		int i;` |
|  158059 |  6658 | `		for( i = 0; i < nAtoms; i++ ){` |
|   79099 |  6659 | `			if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|   79071 |  6660 | `				nNonNull++;` |
|   79071 |  6661 | `				iNonNullIdx = i;` |
|   39533 |  6662 | `			}` |
|   39552 |  6663 | `		}` |
|   78965 |  6664 | `		if( nNonNull <= 1 ){` |
|       - |  6665 | `			/* Fast path: store as single type. */` |
|   78873 |  6666 | `			if( iNonNullIdx >= 0 ){` |
|   78867 |  6667 | `				PhlTypeAtom *pA = &aAtoms[iNonNullIdx];` |
|   78867 |  6668 | `				if( pA->nType == SXU32_HIGH ){` |
|   21530 |  6669 | `					char *zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|    7175 |  6670 | `						pA->sClass.zString, pA->sClass.nByte);` |
|   14355 |  6671 | `					if( zDup == 0 ) return SXERR_ABORT;` |
|   14355 |  6672 | `					*pnType = SXU32_HIGH;` |
|   14355 |  6673 | `					if( pClass ) SyStringInitFromBuf(pClass, zDup, pA->sClass.nByte);` |
|   71692 |  6674 | `				}else if( pA->nType == UTA_VOID_FLAG ){` |
...
|       - |  6714 | ` */` |
|  314504 |  6715 | `static sxi32 GenStateParseReturnType(ph7_gen_state *pGen, ph7_vm_func *pFunc)` |
|       5 |  6716 |  |
|  314509 |  6717 | `	sxi32 iFlags = 0;` |
|       - |  6718 | `	sxi32 rc;` |
|       - |  6719 | `	sxu32 nLine;` |
|  314509 |  6720 | `	pFunc->nReturnType = 0;` |
|  314509 |  6721 | `	SyStringInitFromBuf(&pFunc->sReturnClass, 0, 0);` |
|  314509 |  6722 | `	SyStringInitFromBuf(&pFunc->sReturnTypeName, 0, 0);` |
|  314509 |  6723 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COLON) == 0 ){` |
|  314025 |  6724 | `		return SXRET_OK;` |
|       - |  6725 | `	}` |
...
|  157257 |  6763 |  |
|       - |  6764 |  |
|   47420 |  6765 | `static sxi32 GenStateCompileFunc(` |
...
|   47425 |  6779 | `	nLine = pGen->pIn->nLine;` |
|       - |  6780 | `	/* Jump the left parenthesis '(' */` |
|   47425 |  6781 | `	pGen->pIn++;` |
|       - |  6782 | `	/* Delimit the function signature */` |
|   47425 |  6783 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   47425 |  6784 | `	if( pEnd >= pGen->pEnd ){` |
|       - |  6785 | `		/* Syntax error */` |
|       8 |  6786 | `		rc = PH7_GenCompileError(pGen,E_ERROR,nLine,"Missing ')' after function '%z' signature",pName);` |
|       8 |  6787 | `		if( rc == SXERR_ABORT ){` |
|       - |  6788 | `			/* Error count limit reached,abort immediately */` |
|     ! 0 |  6789 | `			return SXERR_ABORT;` |
|       - |  6790 | `		}` |
|       8 |  6791 | `		pGen->pIn = pGen->pEnd;` |
|       8 |  6792 | `		return SXRET_OK;` |
|       - |  6793 | `	}` |
|       - |  6794 | `	/* Create the function state */` |
|   47419 |  6795 | `	pFunc = (ph7_vm_func *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_vm_func));` |
|   47419 |  6796 | `	if( pFunc == 0 ){` |
|     ! 0 |  6797 | `		goto OutOfMem;` |
|       - |  6798 | `	}` |
|       - |  6799 | `	/* Build the function name, prepending namespace if active */` |
|   47426 |  6800 | `	if( SyBlobLength(&pGen->sNamespace) > 0 && !bHandleClosure ){` |
|       - |  6801 | `		SyBlob sFQN;` |
|       - |  6802 | `		sxu32 nLen;` |
...
|       9 |  6814 | `	}else{` |
|   47405 |  6815 | `		zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|   47405 |  6816 | `		if( zName == 0 ){` |
|     ! 0 |  6817 | `			goto OutOfMem;` |
|       - |  6818 | `		}` |
|   47405 |  6819 | `		PH7_VmInitFuncState(pGen->pVm,pFunc,zName,pName->nByte,iFlags,0);` |
|       - |  6820 | `	}` |
|   47419 |  6821 | `	if( pGen->pIn < pEnd ){` |
|       - |  6822 | `		/* Collect function arguments */` |
|   32717 |  6823 | `		rc = GenStateCollectFuncArgs(pFunc,&(*pGen),pEnd,0,0);` |
|   32717 |  6824 | `		if( rc == SXERR_ABORT ){` |
...
|   47419 |  6830 | `	pGen->pIn = &pEnd[1];` |
|       - |  6831 | `	{` |
|   47419 |  6832 | `		sxi32 rcRt = GenStateParseReturnType(pGen, pFunc);` |
|   47419 |  6833 | `		if( rcRt == SXERR_ABORT ){` |
|     ! 0 |  6834 | `			return SXERR_ABORT;` |
|   47419 |  6835 | `		}else if( rcRt == SXERR_SYNTAX ){` |
|       6 |  6836 | `			return SXERR_SYNTAX;` |
|       - |  6837 | `		}` |
|       - |  6838 | `	}` |
|   47415 |  6839 | `	if( bHandleClosure ){` |
...
|   47415 |  6932 | `	rc = GenStateCompileFuncBody(&(*pGen),pFunc);` |
|   47415 |  6933 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  6934 | `		return SXERR_ABORT;` |
|       - |  6935 | `	}` |
|   47415 |  6936 | `	if( ppFunc ){` |
|     297 |  6937 | `		*ppFunc = pFunc;` |
|     146 |  6938 | `	}` |
|   47415 |  6939 | `	rc = SXRET_OK;` |
|   47415 |  6940 | `	if( (pFunc->iFlags & VM_FUNC_CLOSURE) == 0 ){` |
|       - |  6941 | `		/* Finally register the function */` |
|   47397 |  6942 | `		rc = PH7_VmInstallUserFunction(pGen->pVm,pFunc,0);` |
|   23696 |  6943 | `	}` |
|   47415 |  6944 | `	if( rc == SXRET_OK ){` |
|   47415 |  6945 | `		return SXRET_OK;` |
|       - |  6946 | `	}` |
...
|       - |  6958 | ` */` |
|   47136 |  6959 | `static sxi32 PH7_CompileFunction(ph7_gen_state *pGen)` |
|       5 |  6960 |  |
|       - |  6961 | `	SyString *pName;` |
|       - |  6962 | `	sxi32 iFlags;` |
|       - |  6963 | `	sxu32 nLine;` |
|       - |  6964 | `	sxi32 rc;` |
|       - |  6965 |  |
|   47141 |  6966 | `	nLine = pGen->pIn->nLine;` |
|   47141 |  6967 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|   47141 |  6968 | `	iFlags = 0;` |
|   47141 |  6969 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|       - |  6970 | `		/* Return by reference,remember that */` |
|       7 |  6971 | `		iFlags \|= VM_FUNC_REF_RETURN;` |
|       - |  6972 | `		/* Jump the '&' token */` |
|       7 |  6973 | `		pGen->pIn++;` |
|       3 |  6974 | `	}` |
|   47141 |  6975 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|       - |  6976 | `		/* Invalid function name */` |
|       8 |  6977 | `		rc = PH7_GenCompileError(&(*pGen),E_ERROR,nLine,"Invalid function name");` |
|       8 |  6978 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  6979 | `			return SXERR_ABORT;` |
|       - |  6980 | `		}` |
|       - |  6981 | `		/* Sychronize with the next semi-colon or braces*/` |
|      22 |  6982 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & (PH7_TK_SEMI\|PH7_TK_OCB)) == 0 ){` |
|      16 |  6983 | `			pGen->pIn++;` |
|       2 |  6984 | `		}` |
|       8 |  6985 | `		return SXRET_OK;` |
|       - |  6986 | `	}` |
|   47135 |  6987 | `	pName = &pGen->pIn->sData;` |
|   47135 |  6988 | `	nLine = pGen->pIn->nLine;` |
|       - |  6989 | `	/* Jump the function name */` |
|   47135 |  6990 | `	pGen->pIn++;` |
|   47135 |  6991 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  6992 | `		/* Syntax error */` |
...
|   47133 |  7005 | `	rc = GenStateCompileFunc(&(*pGen),pName,iFlags,FALSE,0);` |
|   47133 |  7006 | `	return rc;` |
|   23573 |  7007 |  |
|       - |  7008 | `/*` |
...
|       - |  7018 | ` */` |
|  342128 |  7019 | `static sxi32 GetProtectionLevel(sxi32 nKeyword)` |
|       5 |  7020 |  |
|  342133 |  7021 | `	if( nKeyword == PH7_TKWRD_PRIVATE ){` |
|   21379 |  7022 | `		return PH7_CLASS_PROT_PRIVATE;` |
|  320759 |  7023 | `	}else if( nKeyword == PH7_TKWRD_PROTECTED ){` |
|   46131 |  7024 | `		return PH7_CLASS_PROT_PROTECTED;` |
|       - |  7025 | `	}` |
|       - |  7026 | `	/* Assume public by default */` |
|  274633 |  7027 | `	return PH7_CLASS_PROT_PUBLIC;` |
|  171069 |  7028 |  |
|       - |  7029 | `/*` |
...
|       - |  7291 | ` */` |
|  185406 |  7292 | `static int GenStateLooksLikeTypedProperty(SyToken *pStart,SyToken *pEnd)` |
|       5 |  7293 |  |
|  185411 |  7294 | `	SyToken *p = pStart;` |
|  185411 |  7295 | `	int bFirst = 1;` |
|  185411 |  7296 | `	if( p >= pEnd ) return 0;` |
|       - |  7297 | ``	/* Optional nullable `?` shorthand. */`` |
|  185411 |  7298 | `	if( (p->nType & PH7_TK_OP) && p->sData.nByte == 1 && p->sData.zString[0] == '?' ){` |
|      18 |  7299 | `		p++;` |
...
|   92703 |  7306 | `	for(;;){` |
|  185429 |  7307 | `		if( p < pEnd && (p->nType & PH7_TK_LPAREN) ){` |
...
|  185427 |  7316 | `			if( p < pEnd && (p->nType & PH7_TK_NSSEP) ){ p++; }` |
|  185427 |  7317 | `			if( p >= pEnd \|\| (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|     ! 0 |  7318 | `				return 0;` |
|       - |  7319 | `			}` |
...
|  185427 |  7323 | `			if( bFirst && (p->nType & PH7_TK_KEYWORD) ){` |
|  185381 |  7324 | `				sxu32 k = (sxu32)(SX_PTR_TO_INT(p->pUserData));` |
|  185453 |  7325 | `				if( k == PH7_TKWRD_FUNCTION \|\| k == PH7_TKWRD_VAR \|\| k == PH7_TKWRD_CONST` |
|   10852 |  7326 | `				 \|\| k == PH7_TKWRD_STATIC \|\| k == PH7_TKWRD_FINAL \|\| k == PH7_TKWRD_ABSTRACT ){` |
|  185227 |  7327 | `					return 0;` |
|       - |  7328 | `				}` |
|      77 |  7329 | `			}` |
|     205 |  7330 | `			p++;` |
...
|       - |  7507 | ` */` |
| 1641544 |  7508 | `static int GenStateIsReadonly(SyToken *pTok)` |
|       5 |  7509 |  |
| 1675090 |  7510 | `	return (pTok->nType & PH7_TK_ID)` |
|  854313 |  7511 | `		&& pTok->sData.nByte == sizeof("readonly")-1` |
| 1675085 |  7512 | `		&& SyStrnicmp(pTok->sData.zString,"readonly",sizeof("readonly")-1) == 0;` |
|       5 |  7513 |  |
|   75114 |  7514 | `static sxi32 GenStateCompileClassAttr(ph7_gen_state *pGen,sxi32 iProtection,sxi32 iFlags,ph7_class *pClass)` |
|       5 |  7515 |  |
|   75119 |  7516 | `	sxu32 nLine = pGen->pIn->nLine;` |
|       - |  7517 | `	ph7_class_attr *pAttr;` |
|       - |  7518 | `	SyString *pName;` |
|       - |  7519 | `	sxi32 rc;` |
|   75119 |  7520 | `	sxu32 nType = 0;` |
|       - |  7521 | `	SyString sTypeClass;` |
|       - |  7522 | `	SyString sTypeText;` |
|       - |  7523 | `	SySet aUnionAlts;` |
|   75119 |  7524 | `	sxi32 iTypeFlags = 0;` |
|   75119 |  7525 | `	SyStringInitFromBuf(&sTypeClass,0,0);` |
|   75119 |  7526 | `	SyStringInitFromBuf(&sTypeText,0,0);` |
|   75119 |  7527 | `	SySetInit(&aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
...
|   75119 |  7531 | `	if( pClass->iFlags & PH7_CLASS_READONLY ){` |
|      21 |  7532 | `		iFlags \|= PH7_CLASS_ATTR_READONLY;` |
|       9 |  7533 | `	}` |
|       - |  7534 | `	/* Extract visibility level */` |
|   75119 |  7535 | `	iProtection = GetProtectionLevel(iProtection);` |
|       - |  7536 | `	/* Parse optional type hint (typed properties, PHP 7.4+) */` |
|   75211 |  7537 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
...
|      92 |  7553 | `	}` |
|     ! 0 |  7554 | `loop:` |
|   75123 |  7555 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
...
|       - |  7561 | `	}` |
|   75123 |  7562 | `	pGen->pIn++; /* Jump the dollar sign */` |
|   75123 |  7563 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_ID)) == 0 ){` |
...
|   75123 |  7573 | `	pName = &pGen->pIn->sData;` |
|       - |  7574 | `	/* Advance the stream cursor */` |
|   75123 |  7575 | `	pGen->pIn++;` |
|   75123 |  7576 | `	if(pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_EQUAL/*'='*/\|PH7_TK_SEMI/*';'*/\|PH7_TK_COMMA/*','*/)) == 0 ){` |
...
|   75121 |  7587 | `	if( iFlags & PH7_CLASS_ATTR_READONLY ){` |
...
|   75111 |  7607 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
...
|   75111 |  7619 | `	if( PH7_ClassExtractAttribute(pClass,pName->zString,pName->nByte) != 0 ){` |
...
|   75109 |  7628 | `	pAttr = PH7_NewClassAttr(pGen->pVm,pName,nLine,iProtection,iFlags\|iTypeFlags);` |
|   75109 |  7629 | `	if( pAttr == 0 ){` |
|     ! 0 |  7630 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 engine is running out of memory");` |
|     ! 0 |  7631 | `		return SXERR_ABORT;` |
|       - |  7632 | `	}` |
|   75109 |  7633 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|     185 |  7634 | `		GenStateCopyTypeToAttr(pAttr,nType,&sTypeClass,&sTypeText,iTypeFlags,&aUnionAlts);` |
|      90 |  7635 | `	}` |
|   75109 |  7636 | `	if( pGen->pIn->nType & PH7_TK_EQUAL /*'='*/ ){` |
|       - |  7637 | `		SySet *pInstrContainer;` |
|   21761 |  7638 | `		pGen->pIn++; /*Jump the equal sign */` |
|       - |  7639 | `		/* Swap bytecode container */` |
|   21761 |  7640 | `		pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   21761 |  7641 | `		PH7_VmSetByteCodeContainer(pGen->pVm,&pAttr->aByteCode);` |
|       - |  7642 | `		/* Compile attribute value.` |
|       - |  7643 | `		 */` |
|   21761 |  7644 | `		rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|   21761 |  7645 | `		if( rc == SXERR_EMPTY ){` |
...
|   21761 |  7652 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|   21761 |  7653 | `		PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|   10878 |  7654 | `	}` |
|       - |  7655 | `	/* All done,install the attribute */` |
|   75109 |  7656 | `	rc = PH7_ClassInstallAttr(pClass,pAttr);` |
|   75109 |  7657 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  7658 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|     ! 0 |  7659 | `		return SXERR_ABORT;` |
|       - |  7660 | `	}` |
|   75109 |  7661 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA /*','*/) ){` |
...
|       - |  7679 | `		}` |
|     ! 0 |  7680 | `	}` |
|   75105 |  7681 | `	SySetRelease(&aUnionAlts);` |
|   75105 |  7682 | `	return SXRET_OK;` |
|       7 |  7683 | `Synchronize:` |
...
|       - |  7698 | ` */` |
|  266936 |  7699 | `static sxi32 GenStateCompileClassMethod(` |
...
|       - |  7705 | `	)` |
|       5 |  7706 |  |
|  266941 |  7707 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|  266941 |  7714 | `	iProtection = GetProtectionLevel(iProtection);` |
|  266941 |  7715 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|  266941 |  7716 | `	iFuncFlags = 0;` |
|  266941 |  7717 | `	if( pGen->pIn >= pGen->pEnd ){` |
...
|       - |  7725 | `	}` |
|  266941 |  7726 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|       - |  7727 | `		/* Return by reference,remember that */` |
|     ! 0 |  7728 | `		iFuncFlags \|= VM_FUNC_REF_RETURN;` |
|       - |  7729 | `		/* Jump the '&' token */` |
|     ! 0 |  7730 | `		pGen->pIn++;` |
|     ! 0 |  7731 | `	}` |
|  266941 |  7732 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|  266941 |  7741 | `	pName = &pGen->pIn->sData;` |
|  266941 |  7742 | `	nLine = pGen->pIn->nLine;` |
|       - |  7743 | `	/* Jump the method name */` |
|  266941 |  7744 | `	pGen->pIn++;` |
|  266941 |  7745 | `	if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|       - |  7746 | `		/* Abstract method */` |
|   92203 |  7747 | `		if( iProtection == PH7_CLASS_PROT_PRIVATE ){` |
...
|   92203 |  7756 | `		doBody = FALSE;` |
|   46099 |  7757 | `	}` |
|  266941 |  7758 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  7759 | `		/* Syntax error */` |
...
|  266941 |  7768 | `	pMeth = PH7_NewClassMethod(pGen->pVm,pClass,pName,nLine,iProtection,iFlags,iFuncFlags);` |
|  266941 |  7769 | `	if( pMeth == 0 ){` |
...
|  266941 |  7774 | `	pGen->pIn++;` |
|  266941 |  7775 | `	pEnd = 0; /* cc warning */` |
|       - |  7776 | `	/* Delimit the method signature */` |
|  266941 |  7777 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|  266941 |  7778 | `	if( pEnd >= pGen->pEnd ){` |
|       - |  7779 | `		/* Syntax error */` |
...
|       - |  7786 | `	}` |
|       - |  7787 | `	{` |
|  266939 |  7788 | `		int bIsCtor = 0;` |
|  266939 |  7789 | `		int bAbstractCtor = 0;` |
|  389687 |  7790 | `		if( (pName->nByte == sizeof("__construct") - 1` |
|  158401 |  7791 | `				&& SyMemcmp(pName->zString,"__construct",sizeof("__construct") - 1) == 0)` |
|  256225 |  7792 | `		 \|\| SyStringCmp(pName,&pClass->sName,SyMemcmp) == 0 ){` |
|   21433 |  7793 | `			if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|       3 |  7794 | `				bAbstractCtor = 1;` |
|       2 |  7795 | `			}else{` |
|   21431 |  7796 | `				bIsCtor = 1;` |
|       - |  7797 | `			}` |
|   10714 |  7798 | `		}` |
|  266939 |  7799 | `		if( pGen->pIn < pEnd ){` |
|       - |  7800 | `			/* Collect method arguments */` |
|   71355 |  7801 | `			rc = GenStateCollectFuncArgs(&pMeth->sFunc,&(*pGen),pEnd,bIsCtor,bAbstractCtor);` |
|   71355 |  7802 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  7803 | `				return SXERR_ABORT;` |
|       - |  7804 | `			}` |
|   35675 |  7805 | `		}` |
|       - |  7806 | `	}` |
|       - |  7807 | `	/* Point past ')' and parse optional return type ': type' */` |
|  266939 |  7808 | `	pGen->pIn = &pEnd[1];` |
|       - |  7809 | `	{` |
|  266939 |  7810 | `		sxi32 rcRt = GenStateParseReturnType(pGen, &pMeth->sFunc);` |
|  266939 |  7811 | `		if( rcRt == SXERR_ABORT ){` |
|     ! 0 |  7812 | `			return SXERR_ABORT;` |
|  266939 |  7813 | `		}else if( rcRt == SXERR_SYNTAX ){` |
...
|       - |  7820 | `	{` |
|  266939 |  7821 | `		sxu32 nArg = SySetUsed(&pMeth->sFunc.aArgs);` |
|       - |  7822 | `		sxu32 i;` |
|  388015 |  7823 | `		for( i = 0; i < nArg; i++ ){` |
|  121091 |  7824 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pMeth->sFunc.aArgs,i);` |
|       - |  7825 | `			ph7_class_attr *pAttr;` |
|  121091 |  7826 | `			sxi32 iAttrFlags = 0;` |
|       - |  7827 | `			int bArgTyped;` |
|  121091 |  7828 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|  121027 |  7829 | `				continue;` |
|       - |  7830 | `			}` |
...
|      32 |  7911 | `		}` |
|       - |  7912 | `	}` |
|  266929 |  7913 | `	if( doBody ){` |
|       - |  7914 | `		/* Compile method body */` |
|  174731 |  7915 | `		rc = GenStateCompileFuncBody(&(*pGen),&pMeth->sFunc);` |
|  174731 |  7916 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  7917 | `			return SXERR_ABORT;` |
|       - |  7918 | `		}` |
|   87368 |  7919 | `	}else{` |
|       - |  7920 | `		/* Only method signature is allowed */` |
|   92203 |  7921 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI /* ';'*/) == 0 ){` |
...
|       - |  7954 | ` */` |
|   39064 |  7955 | `static sxi32 PH7_CompileClassInterface(ph7_gen_state *pGen)` |
|       5 |  7956 |  |
|   39069 |  7957 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|   39069 |  7966 | `	pName = &pGen->pIn->sData;` |
|       - |  7967 | `	/* Advance the stream cursor */` |
|   39069 |  7968 | `	pGen->pIn++;` |
|       - |  7969 | `	/* Build FQN and obtain a raw class */ {` |
|       - |  7970 | `		SyBlob sFQN;` |
|       - |  7971 | `		SyString sFQNStr;` |
|   39069 |  7972 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|   39069 |  7973 | `		GenStateBuildFQN(pGen,pName,&sFQN);` |
|   39069 |  7974 | `		SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|   39069 |  7975 | `		pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|   39069 |  7976 | `		SyBlobRelease(&sFQN);` |
|       - |  7977 | `	}` |
|   39069 |  7978 | `	if( pClass == 0 ){` |
...
|   39069 |  7983 | `	pClass->iFlags = PH7_CLASS_INTERFACE;` |
|       - |  7984 | `	/* Assume no base class is given */` |
|   39069 |  7985 | `	pBase = 0;` |
|   39069 |  7986 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|   10645 |  7987 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   10645 |  7988 | `		if( nKwrd == PH7_TKWRD_EXTENDS /* interface b extends a */ ){` |
|       - |  7989 | `			SyBlob sResolved;` |
|       - |  7990 | `			SyString sBaseName;` |
|       - |  7991 | `			sxu32 nRefLine;` |
|       - |  7992 | `			/* Extract base interface */` |
|   10645 |  7993 | `			pGen->pIn++;` |
|   10645 |  7994 | `			nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|   10645 |  7995 | `			SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|   10645 |  7996 | `			if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|       - |  8006 | `			}` |
|   15965 |  8007 | `			pBase = PH7_VmExtractClass(pGen->pVm,` |
|   10640 |  8008 | `				(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|   10645 |  8009 | `			SyStringInitFromBuf(&sBaseName,` |
|       - |  8010 | `				(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|       - |  8011 | `			/* Only interfaces is allowed */` |
|   10645 |  8012 | `			while( pBase && (pBase->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|     ! 0 |  8013 | `				pBase = pBase->pNextName;` |
|     ! 0 |  8014 | `			}` |
|   10645 |  8015 | `			if( pBase == 0 ){` |
...
|       - |  8021 | `				}` |
|     ! 0 |  8022 | `			}` |
|   10645 |  8023 | `			SyBlobRelease(&sResolved);` |
|    5320 |  8024 | `		}` |
|    5320 |  8025 | `	}` |
|   39069 |  8026 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|       - |  8027 | `		/* Syntax error */` |
...
|       - |  8035 | `	}` |
|   39069 |  8036 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|   39069 |  8037 | `	pEnd = 0; /* cc warning */` |
|       - |  8038 | `	/* Delimit the interface body */` |
|   39069 |  8039 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|   39069 |  8040 | `	if( pEnd >= pGen->pEnd ){` |
|       - |  8041 | `		/* Syntax error */` |
...
|   39069 |  8051 | `	pTmp = pGen->pEnd;` |
|   39069 |  8052 | `	pGen->pEnd = pEnd;` |
...
|  223449 |  8060 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|   92195 |  8061 | `			pGen->pIn++;` |
|       5 |  8062 | `		}` |
|  131259 |  8063 | `		if( pGen->pIn >= pGen->pEnd ){` |
|       - |  8064 | `			/* End of interface body */` |
|   39067 |  8065 | `			break;` |
|       - |  8066 | `		}` |
|   92197 |  8067 | `		if( (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|   92197 |  8078 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   92197 |  8079 | `		if( nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
...
|       3 |  8108 | `			goto done;` |
|       - |  8109 | `		}` |
|   92195 |  8110 | `		if( nKwrd != PH7_TKWRD_PUBLIC && nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|     ! 0 |  8117 | `			goto done;` |
|       - |  8118 | `		}` |
|   92195 |  8119 | `		if( nKwrd == PH7_TKWRD_PUBLIC ){` |
|       - |  8120 | `			/* Advance the stream cursor */` |
|   92185 |  8121 | `			pGen->pIn++;` |
|   92185 |  8122 | `			if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|     ! 0 |  8129 | `				goto done;` |
|       - |  8130 | `			}` |
|   92185 |  8131 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   92185 |  8132 | `			if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|       - |  8140 | `			}` |
|   46090 |  8141 | `		}` |
|   92195 |  8142 | `		if( nKwrd == PH7_TKWRD_CONST ){` |
|       - |  8143 | `			/* Parse constant */` |
...
|       - |  8150 | `			}` |
|       4 |  8151 | `		}else{` |
|   92189 |  8152 | `			sxi32 iFlags = PH7_CLASS_ATTR_ABSTRACT; /* Interface methods are implicitly abstract */` |
|   92189 |  8153 | `			if( nKwrd == PH7_TKWRD_STATIC ){` |
|       - |  8154 | `				/* Static method,record that */` |
|   10637 |  8155 | `				iFlags \|= PH7_CLASS_ATTR_STATIC;` |
|       - |  8156 | `				/* Advance the stream cursor */` |
|   10637 |  8157 | `				pGen->pIn++;` |
|   10632 |  8158 | `				if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0` |
|   10637 |  8159 | `					\|\| SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_FUNCTION ){` |
...
|   92189 |  8170 | `			rc = GenStateCompileClassMethod(&(*pGen),0,iFlags,FALSE,pClass);` |
|   92189 |  8171 | `			if( rc != SXRET_OK ){` |
...
|   39067 |  8180 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|   39067 |  8181 | `	if( rc == SXRET_OK && pBase ){` |
|       - |  8182 | `		/* Inherit from the base interface */` |
|   10645 |  8183 | `		rc = PH7_ClassInterfaceInherit(pClass,pBase);` |
|    5320 |  8184 | `	}` |
|   39067 |  8185 | `	if( rc != SXRET_OK ){` |
...
|   39069 |  8191 | `	pGen->pIn  = &pEnd[1];` |
|   39069 |  8192 | `	pGen->pEnd = pTmp;` |
|   39069 |  8193 | `	return PH7_OK;` |
|   19537 |  8194 |  |
|       - |  8195 | `/*` |
...
|       - |  8219 | ` */` |
|  100472 |  8220 | `static sxi32 GenStateCheckInterfaceSignatures(ph7_gen_state *pGen,ph7_class *pClass)` |
|       5 |  8221 |  |
|       - |  8222 | `	ph7_class **apIface;` |
|       - |  8223 | `	sxu32 nIface,i;` |
|       - |  8224 | `	sxi32 rc;` |
|  100477 |  8225 | `	if( pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|     ! 0 |  8226 | `		return SXRET_OK;` |
|       - |  8227 | `	}` |
|  100477 |  8228 | `	apIface = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|  100477 |  8229 | `	nIface = SySetUsed(&pClass->aInterface);` |
|  192871 |  8230 | `	for(i = 0; i < nIface; i++){` |
|   92399 |  8231 | `		ph7_class *pIface = apIface[i];` |
|       - |  8232 | `		SyHashEntry *pEntry;` |
|   92399 |  8233 | `		SyHashResetLoopCursor(&pIface->hMethod);` |
|  248785 |  8234 | `		while((pEntry = SyHashGetNextEntry(&pIface->hMethod)) != 0 ){` |
|  156391 |  8235 | `			ph7_class_method *pIfaceMeth = (ph7_class_method *)pEntry->pUserData;` |
|       - |  8236 | `			ph7_class_method *pImplMeth;` |
|  156391 |  8237 | `			SyString *pMName = &pIfaceMeth->sFunc.sName;` |
|       - |  8238 | `			/* Find the implementing method in the class */` |
|  156391 |  8239 | `			pImplMeth = PH7_ClassExtractMethod(pClass,pMName->zString,pMName->nByte);` |
|  156391 |  8240 | `			if( pImplMeth == 0 \|\| (pImplMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT) ){` |
...
|  156377 |  8244 | `			if( pImplMeth->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|       - |  8254 | `			 */` |
|       - |  8255 | `			{` |
|  156377 |  8256 | `				sxu32 nIfaceArgs = SySetUsed(&pIfaceMeth->sFunc.aArgs);` |
|  156377 |  8257 | `				sxu32 nImplArgs = SySetUsed(&pImplMeth->sFunc.aArgs);` |
|  156377 |  8258 | `				int sigError = 0;` |
|  156377 |  8259 | `				if( nImplArgs < nIfaceArgs ){` |
|       3 |  8260 | `					sigError = 1;` |
|  156376 |  8261 | `				}else if( nImplArgs > nIfaceArgs ){` |
...
|       - |  8312 | ` */` |
|  100472 |  8313 | `static sxi32 GenStateCheckAbstractMethods(ph7_gen_state *pGen,ph7_class *pClass)` |
|       5 |  8314 |  |
...
|  100477 |  8321 | `	if( pClass->iFlags & (PH7_CLASS_ABSTRACT\|PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|      35 |  8322 | `		return SXRET_OK;` |
|       - |  8323 | `	}` |
|       - |  8324 | `	/* Count abstract methods */` |
|  100447 |  8325 | `	nAbstract = 0;` |
|  100447 |  8326 | `	SyHashResetLoopCursor(&pClass->hMethod);` |
|  942069 |  8327 | `	while((pEntry = SyHashGetNextEntry(&pClass->hMethod)) != 0 ){` |
|  841627 |  8328 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|  841627 |  8329 | `		if( pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|      20 |  8330 | `			nAbstract++;` |
|       8 |  8331 | `		}` |
|       5 |  8332 | `	}` |
|  100447 |  8333 | `	if( nAbstract == 0 ){` |
|  100433 |  8334 | `		return SXRET_OK;` |
|       - |  8335 | `	}` |
...
|       - |  8468 | ` */` |
|   96658 |  8469 | `static sxi32 GenStateParseClassReference(ph7_gen_state *pGen,SyBlob *pFqn)` |
|       5 |  8470 |  |
|   96663 |  8471 | `	int isAbsolute = 0;` |
|   96663 |  8472 | `	SyToken *pStart = pGen->pIn;` |
|       - |  8473 | `	SyBlob sName;` |
|   96663 |  8474 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) ){` |
|      99 |  8475 | `		isAbsolute = 1;` |
|      99 |  8476 | `		pGen->pIn++;` |
|      47 |  8477 | `	}` |
|   96663 |  8478 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|       8 |  8479 | `		pGen->pIn = pStart;` |
|       8 |  8480 | `		return SXERR_INVALID;` |
|       - |  8481 | `	}` |
|   96657 |  8482 | `	SyBlobInit(&sName,&pGen->pVm->sAllocator);` |
|   96657 |  8483 | `	SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|   96657 |  8484 | `	pGen->pIn++;` |
|  144996 |  8485 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) &&` |
|   48349 |  8486 | `		&pGen->pIn[1] < pGen->pEnd && (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|      13 |  8487 | `		SyBlobAppend(&sName,"\\",1);` |
|      13 |  8488 | `		pGen->pIn++;` |
|      13 |  8489 | `		SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|      13 |  8490 | `		pGen->pIn++;` |
|       1 |  8491 | `	}` |
|   96657 |  8492 | `	if( isAbsolute ){` |
|      97 |  8493 | `		SyBlobAppend(pFqn,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|      51 |  8494 | `	}else{` |
|       - |  8495 | `		SyString sRaw;` |
|   96565 |  8496 | `		SyStringInitFromBuf(&sRaw,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|   96565 |  8497 | `		GenStateResolveName(pGen,&sRaw,pFqn);` |
|       - |  8498 | `	}` |
|   96657 |  8499 | `	SyBlobRelease(&sName);` |
|   96657 |  8500 | `	return SXRET_OK;` |
|   48334 |  8501 |  |
|       - |  8502 | `/*` |
...
|   10804 |  8510 | `static int GenStateInterfaceIsThrowableAt(ph7_class *pInterface,int iDepth)` |
|       5 |  8511 |  |
|       - |  8512 | `	ph7_class **apParent;` |
|       - |  8513 | `	sxu32 n;` |
|   18101 |  8514 | `	while( pInterface ){` |
|   14395 |  8515 | `		if( iDepth > PH7_THROWABLE_WALK_MAX_DEPTH ){` |
|     ! 0 |  8516 | `			return FALSE;` |
|       - |  8517 | `		}` |
|   17953 |  8518 | `		if( pInterface->sName.nByte == sizeof("Throwable")-1 &&` |
|    7116 |  8519 | `			SyMemcmp(pInterface->sName.zString,"Throwable",sizeof("Throwable")-1) == 0 ){` |
|    7103 |  8520 | `			return TRUE;` |
|       - |  8521 | `		}` |
|    7297 |  8522 | `		apParent = (ph7_class **)SySetBasePtr(&pInterface->aInterface);` |
|    7297 |  8523 | `		for( n = 0 ; n < SySetUsed(&pInterface->aInterface) ; ++n ){` |
|     ! 0 |  8524 | `			if( GenStateInterfaceIsThrowableAt(apParent[n],iDepth+1) ){` |
|     ! 0 |  8525 | `				return TRUE;` |
|       - |  8526 | `			}` |
|     ! 0 |  8527 | `		}` |
|    7297 |  8528 | `		pInterface = pInterface->pBase;` |
|    7297 |  8529 | `		iDepth++;` |
|       5 |  8530 | `	}` |
|    3711 |  8531 | `	return FALSE;` |
|    5407 |  8532 |  |
|   10804 |  8533 | `static int GenStateInterfaceIsThrowable(ph7_class *pInterface)` |
|       5 |  8534 |  |
|   10809 |  8535 | `	return GenStateInterfaceIsThrowableAt(pInterface,0);` |
|       5 |  8536 |  |
|       - |  8537 | `/*` |
...
|       - |  8541 | ` */` |
|    7098 |  8542 | `static int GenStateClassIsExceptionOrError(ph7_class *pBase)` |
|       5 |  8543 |  |
|    7107 |  8544 | `	while( pBase ){` |
...
|       - |  8566 | ` */` |
|  100502 |  8567 | `static sxi32 GenStateCompileClassEx(ph7_gen_state *pGen,sxi32 iFlags,` |
|       - |  8568 | `	SyString *pAnonName,SyToken **ppArgStart,SyToken **ppArgEnd)` |
|       5 |  8569 |  |
|  100507 |  8570 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|  100507 |  8581 | `	pGen->pIn++;` |
|  100507 |  8582 | `	if( pAnonName ){` |
...
|      16 |  8597 | `	}else{` |
|  100481 |  8598 | `		if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
|       - |  8599 | `			/* Syntax error */` |
...
|  100481 |  8612 | `		pName = &pGen->pIn->sData;` |
|       - |  8613 | `		/* Advance the stream cursor */` |
|  100481 |  8614 | `		pGen->pIn++;` |
|       - |  8615 | `		/* Build FQN and obtain a raw class */ {` |
|       - |  8616 | `			SyBlob sFQN;` |
|       - |  8617 | `			SyString sFQNStr;` |
|  100481 |  8618 | `			SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|  100481 |  8619 | `			GenStateBuildFQN(pGen,pName,&sFQN);` |
|  100481 |  8620 | `			SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|  100481 |  8621 | `			pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|  100481 |  8622 | `			SyBlobRelease(&sFQN);` |
|       - |  8623 | `		}` |
|       - |  8624 | `	}` |
|  100507 |  8625 | `	if( pClass == 0 ){` |
...
|  100507 |  8630 | `	SySetInit(&aInterfaces,&pGen->pVm->sAllocator,sizeof(ph7_class *));` |
|  100507 |  8631 | `	SySetInit(&aUseEntries,&pGen->pVm->sAllocator,sizeof(TraitUseEntry));` |
|       - |  8632 | `	/* Assume a standalone class */` |
|  100507 |  8633 | `	pBase = 0;` |
|  100507 |  8634 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|   85401 |  8635 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   85401 |  8636 | `		if( nKwrd == PH7_TKWRD_EXTENDS /* class b extends a */ ){` |
|       - |  8637 | `			SyBlob sResolved;` |
|       - |  8638 | `			SyString sBaseName;` |
|       - |  8639 | `			sxu32 nRefLine;` |
|   74615 |  8640 | `			pGen->pIn++; /* Advance past 'extends' */` |
|   74615 |  8641 | `			nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|   74615 |  8642 | `			SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|   74615 |  8643 | `			if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|       - |  8653 | `			}` |
|  111917 |  8654 | `			pBase = PH7_VmExtractClass(pGen->pVm,` |
|   74608 |  8655 | `				(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|   74613 |  8656 | `			SyStringInitFromBuf(&sBaseName,` |
|       - |  8657 | `				(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|       - |  8658 | `			/* Interfaces are not allowed */` |
|   74613 |  8659 | `			while( pBase && (pBase->iFlags & PH7_CLASS_INTERFACE) ){` |
|     ! 0 |  8660 | `				pBase = pBase->pNextName;` |
|     ! 0 |  8661 | `			}` |
|   74613 |  8662 | `			if( pBase == 0 ){` |
...
|       - |  8668 | `				}` |
|     ! 0 |  8669 | `			}else{` |
|   74613 |  8670 | `				if( pBase->iFlags & PH7_CLASS_FINAL ){` |
...
|     ! 0 |  8677 | `				}` |
|       - |  8678 | `			}` |
|   74613 |  8679 | `			SyBlobRelease(&sResolved);` |
|   37304 |  8680 | `		}` |
|   85399 |  8681 | `		if (pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) && SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_IMPLEMENTS ){` |
|       - |  8682 | `			ph7_class *pInterface;` |
|       - |  8683 | `			/* Interface implementation */` |
|   10799 |  8684 | `			pGen->pIn++; /* Advance the stream cursor */` |
|    5407 |  8685 | `			for(;;){` |
|       - |  8686 | `				SyBlob sResolved;` |
|       - |  8687 | `				SyString sIntName;` |
|       - |  8688 | `				sxu32 nRefLine;` |
|   10809 |  8689 | `				nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|   10809 |  8690 | `				SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|   10809 |  8691 | `				if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|     ! 0 |  8699 | `					break;` |
|       - |  8700 | `				}` |
|   21613 |  8701 | `				pInterface = PH7_VmExtractClass(pGen->pVm,` |
|   10804 |  8702 | `					(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|   10809 |  8703 | `				SyStringInitFromBuf(&sIntName,` |
|       - |  8704 | `					(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|       - |  8705 | `				/* Only interfaces are allowed */` |
|   10809 |  8706 | `				while( pInterface && (pInterface->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|     ! 0 |  8707 | `					pInterface = pInterface->pNextName;` |
|     ! 0 |  8708 | `				}` |
|   10809 |  8709 | `				if( pInterface == 0 ){` |
...
|   10809 |  8723 | `					SyString *pFqn = &pClass->sName;` |
|   10809 |  8724 | `					int bIsExceptionOrError =` |
|    8950 |  8725 | `						(pFqn->nByte == sizeof("Exception")-1 &&` |
|   17982 |  8726 | `						 SyMemcmp(pFqn->zString,"Exception",sizeof("Exception")-1) == 0) \|\|` |
|    9039 |  8727 | `						(pFqn->nByte == sizeof("Error")-1 &&` |
|    3558 |  8728 | `						 SyMemcmp(pFqn->zString,"Error",sizeof("Error")-1) == 0);` |
|   17900 |  8729 | `					if( GenStateInterfaceIsThrowable(pInterface) &&` |
|   10650 |  8730 | `						!GenStateClassIsExceptionOrError(pBase) &&` |
|    3547 |  8731 | `						!bIsExceptionOrError ){` |
...
|       6 |  8741 | `					}else{` |
|   10803 |  8742 | `						SySetPut(&aInterfaces,(const void *)&pInterface);` |
|       - |  8743 | `					}` |
|       - |  8744 | `				}` |
|   10809 |  8745 | `				SyBlobRelease(&sResolved);` |
|   10809 |  8746 | `				if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COMMA) == 0 ){` |
|    5402 |  8747 | `					break;` |
|       - |  8748 | `				}` |
...
|    5397 |  8751 | `		}` |
|   42697 |  8752 | `	}` |
|  100505 |  8753 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|       - |  8754 | `		/* Syntax error */` |
...
|       - |  8762 | `	}` |
|  100505 |  8763 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|  100505 |  8764 | `	pEnd = 0; /* cc warning */` |
|       - |  8765 | `	/* Delimit the class body */` |
|  100505 |  8766 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|  100505 |  8767 | `	if( pEnd >= pGen->pEnd ){` |
|       - |  8768 | `		/* Syntax error */` |
...
|  100505 |  8778 | `	pTmp = pGen->pEnd;` |
|  100505 |  8779 | `	pGen->pEnd = pEnd;` |
|       - |  8780 | `	/* Set the inherited flags */` |
|  100505 |  8781 | `	pClass->iFlags = iFlags;` |
|       - |  8782 | `	/* Start the parse process */` |
|  137621 |  8783 | `	for(;;){` |
|       - |  8784 | `		/* Jump leading/trailing semi-colons */` |
|  425593 |  8785 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|   75211 |  8786 | `			pGen->pIn++;` |
|       5 |  8787 | `		}` |
|  350387 |  8788 | `		if( pGen->pIn >= pGen->pEnd ){` |
|       - |  8789 | `			/* End of class body */` |
|  100477 |  8790 | `			break;` |
|       - |  8791 | `		}` |
|  249910 |  8792 | `		if( (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR)) == 0` |
|  124960 |  8793 | ``			&& !GenStateIsReadonly(pGen->pIn) /* allow a leading `readonly` modifier */ ){`` |
...
|  249915 |  8804 | `		iProtection = PH7_TKWRD_PUBLIC;` |
|  249915 |  8805 | `		iAttrflags = 0;` |
...
|  249915 |  8810 | `		if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|     ! 0 |  8811 | `			int bMod = 0;` |
...
|       - |  8832 | `			}` |
|     ! 0 |  8833 | `		}` |
|  249915 |  8834 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|       - |  8835 | `			/* Extract the current keyword */` |
|  249915 |  8836 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  249915 |  8837 | `			if( nKwrd == PH7_TKWRD_USE ){` |
...
|      57 |  8897 | `				continue;` |
|       - |  8898 | `			}` |
|  249863 |  8899 | `			if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|  249571 |  8900 | `				iProtection = nKwrd;` |
|  249571 |  8901 | `				pGen->pIn++; /* Jump the visibility token */` |
|       - |  8902 | ``				/* Optional `readonly` after the visibility: `public readonly int $x`. */`` |
|  249571 |  8903 | `				if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|      20 |  8904 | `					iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|      20 |  8905 | `					pGen->pIn++; /* Jump the 'readonly' modifier */` |
|       8 |  8906 | `				}` |
|  249566 |  8907 | `				if( pGen->pIn >= pGen->pEnd` |
|  249571 |  8908 | `					\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|     ! 0 |  8916 | `					goto done;` |
|       - |  8917 | `				}` |
|  249571 |  8918 | `				if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|       - |  8919 | `					/* Attribute declaration (untyped) */` |
|   74911 |  8920 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|   74911 |  8921 | `					if( rc != SXRET_OK ){` |
...
|   74905 |  8927 | `					continue;` |
|       - |  8928 | `				}` |
|  174665 |  8929 | `				if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|  174497 |  8941 | `				nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   87246 |  8942 | `			}` |
|  174789 |  8943 | `			if( nKwrd == PH7_TKWRD_CONST ){` |
...
|       - |  8951 | `				}` |
|      35 |  8952 | `			}else{` |
|  174727 |  8953 | `				if( nKwrd == PH7_TKWRD_STATIC ){` |
|       - |  8954 | `					/* Static method or attribute,record that */` |
|   10697 |  8955 | `					iAttrflags \|= PH7_CLASS_ATTR_STATIC;` |
|   10697 |  8956 | `					pGen->pIn++; /* Jump the static keyword */` |
|   10697 |  8957 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|       - |  8958 | `						/* Extract the keyword */` |
|   10689 |  8959 | `						nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   10689 |  8960 | `						if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
...
|   10697 |  8968 | `					if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|     ! 0 |  8969 | `						iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|     ! 0 |  8970 | `						pGen->pIn++; /* Jump the 'readonly' modifier */` |
|     ! 0 |  8971 | `					}` |
|   10692 |  8972 | `					if( pGen->pIn >= pGen->pEnd` |
|   10697 |  8973 | `						\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|     ! 0 |  8981 | `						goto done;` |
|       - |  8982 | `					}` |
|   10697 |  8983 | `					if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
...
|       8 |  8992 | `						continue;` |
|       - |  8993 | `					}` |
|   10691 |  8994 | `					if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|   10679 |  9006 | `					nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  169372 |  9007 | `				}else if( nKwrd == PH7_TKWRD_ABSTRACT ){` |
...
|  164030 |  9039 | `				}else if( nKwrd == PH7_TKWRD_FINAL ){` |
...
|       9 |  9047 | `							iProtection = nKwrd;` |
|       9 |  9048 | `							pGen->pIn++; /* Jump the visibility token */` |
|       3 |  9049 | `						}` |
|       7 |  9050 | `					}` |
...
|      12 |  9063 | `							continue;` |
|       - |  9064 | `					}` |
|       6 |  9065 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
...
|     ! 0 |  9070 | `					}` |
|       6 |  9071 | `					if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 \|\|` |
...
|     ! 0 |  9080 | `							goto done;` |
|       - |  9081 | `					}` |
|       6 |  9082 | `					nKwrd = PH7_TKWRD_FUNCTION;` |
|       2 |  9083 | `				}` |
|  174699 |  9084 | `				if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_VAR ){` |
...
|     ! 0 |  9092 | `						goto done;` |
|       - |  9093 | `				}` |
|  174699 |  9094 | `				if( nKwrd == PH7_TKWRD_VAR ){` |
...
|  174693 |  9109 | `					rc = GenStateCompileClassMethod(&(*pGen),iProtection,iAttrflags,TRUE,pClass);` |
|       - |  9110 | `				}` |
|  174699 |  9111 | `				if( rc != SXRET_OK ){` |
...
|       - |  9134 | `		sxu32 nU;` |
|  100477 |  9135 | `		apUse = (TraitUseEntry *)SySetBasePtr(&aUseEntries);` |
|  100529 |  9136 | `		for( nU = 0 ; nU < SySetUsed(&aUseEntries) ; nU++ ){` |
...
|  100477 |  9344 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|  100477 |  9345 | `	if( rc == SXRET_OK ){` |
|       - |  9346 | `		ph7_class **apInterface;` |
|       - |  9347 | `		sxu32 n;` |
|  100477 |  9348 | `		if( pBase ){` |
|       - |  9349 | `			/* Inherit from base class and mark as a subclass */` |
|   74613 |  9350 | `			rc = PH7_ClassInherit(&(*pGen),pClass,pBase);` |
|   37304 |  9351 | `		}` |
|  100477 |  9352 | `		apInterface = (ph7_class **)SySetBasePtr(&aInterfaces);` |
|  111275 |  9353 | `		for( n = 0 ; n < SySetUsed(&aInterfaces) ; n++ ){` |
|       - |  9354 | `			/* Implements one or more interface */` |
|   10803 |  9355 | `			rc = PH7_ClassImplement(pClass,apInterface[n]);` |
|   10803 |  9356 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  9357 | `				break;` |
|       - |  9358 | `			}` |
|    5404 |  9359 | `		}` |
...
|  150708 |  9362 | `		if( rc == SXRET_OK` |
|  100472 |  9363 | `		 && (pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT)) == 0` |
|  100477 |  9364 | `		 && SyHashGet(&pClass->hMethod,"__toString",sizeof("__toString")-1) != 0 ){` |
|   81603 |  9365 | `			ph7_class *pStringable = PH7_VmExtractClass(pGen->pVm,` |
|       - |  9366 | `				"Stringable",sizeof("Stringable")-1,FALSE,0);` |
|   81603 |  9367 | `			if( pStringable ){` |
|   81603 |  9368 | `				ph7_class **apImpl = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|   81603 |  9369 | `				sxu32 nImpl = SySetUsed(&pClass->aInterface);` |
|       - |  9370 | `				sxu32 i;` |
|   81603 |  9371 | `				int bAlready = 0;` |
|   88695 |  9372 | `				for( i = 0 ; i < nImpl ; i++ ){` |
|    7099 |  9373 | `					if( apImpl[i] == pStringable ){` |
|       3 |  9374 | `						bAlready = 1;` |
|       3 |  9375 | `						break;` |
|       - |  9376 | `					}` |
|    3551 |  9377 | `				}` |
|   81603 |  9378 | `				if( !bAlready ){` |
|   81601 |  9379 | `					PH7_ClassImplement(pClass,pStringable);` |
|   40798 |  9380 | `				}` |
|   40799 |  9381 | `			}` |
|   40799 |  9382 | `		}` |
|       - |  9383 | `		/* Validate interface method signatures (visibility and parameter count) */` |
|  100477 |  9384 | `		if( rc == SXRET_OK ){` |
|  100477 |  9385 | `			sxi32 rcCheck = GenStateCheckInterfaceSignatures(&(*pGen),pClass);` |
|  100477 |  9386 | `			if( rcCheck == SXERR_ABORT ){` |
...
|  100477 |  9393 | `		if( rc == SXRET_OK ){` |
|  100477 |  9394 | `			sxi32 rcCheck = GenStateCheckAbstractMethods(&(*pGen),pClass);` |
|  100477 |  9395 | `			if( rcCheck == SXERR_ABORT ){` |
...
|   50236 |  9400 | `		}` |
|   50236 |  9401 | `	}` |
|  100477 |  9402 | `	SySetRelease(&aUseEntries);` |
|  100477 |  9403 | `	SySetRelease(&aInterfaces);` |
|  100477 |  9404 | `	if( rc != SXRET_OK ){` |
...
|  100505 |  9410 | `	pGen->pIn = &pEnd[1];` |
|  100505 |  9411 | `	pGen->pEnd = pTmp;` |
|  100505 |  9412 | `	return PH7_OK;` |
|   50256 |  9413 |  |
|       - |  9414 | `/* Compile a named class declaration (the common case). */` |
|  100476 |  9415 | `static sxi32 GenStateCompileClass(ph7_gen_state *pGen,sxi32 iFlags)` |
|       5 |  9416 |  |
|  100481 |  9417 | `	return GenStateCompileClassEx(pGen,iFlags,0,0,0);` |
|       5 |  9418 |  |
|       - |  9419 | `/*` |
...
|       - |  9508 | ` */` |
|  973314 |  9509 | `static int GenStateTokenIsClassModifier(SyToken *pTok,sxi32 *piFlag)` |
|       5 |  9510 |  |
|  973319 |  9511 | `	if( pTok->nType & PH7_TK_KEYWORD ){` |
|  651281 |  9512 | `		sxu32 nKw = (sxu32)SX_PTR_TO_INT(pTok->pUserData);` |
|  651281 |  9513 | `		if( nKw == PH7_TKWRD_FINAL ){ *piFlag = PH7_CLASS_FINAL; return TRUE; }` |
|  644175 |  9514 | `		if( nKw == PH7_TKWRD_ABSTRACT ){ *piFlag = PH7_CLASS_ABSTRACT; return TRUE; }` |
|  322056 |  9515 | `	}` |
|  966155 |  9516 | `	if( GenStateIsReadonly(pTok) ){ *piFlag = PH7_CLASS_READONLY; return TRUE; }` |
|  966095 |  9517 | `	return FALSE;` |
|  486662 |  9518 |  |
|       - |  9519 | `/*` |
...
|       - |  9524 | ` */` |
|  966090 |  9525 | `static sxi32 GenStateScanClassModifiers(SyToken **ppIn,SyToken *pEnd,SyToken **ppDup)` |
|       5 |  9526 |  |
|  966095 |  9527 | `	SyToken *pIn = *ppIn,*pDup = 0;` |
|  966095 |  9528 | `	sxi32 iFlags = 0,iFlag;` |
|  973319 |  9529 | `	while( pIn < pEnd && GenStateTokenIsClassModifier(pIn,&iFlag) ){` |
|    7229 |  9530 | `		if( (iFlags & iFlag) && pDup == 0 ){` |
|       5 |  9531 | `			pDup = pIn;` |
|       2 |  9532 | `		}` |
|    7229 |  9533 | `		iFlags \|= iFlag;` |
|    7229 |  9534 | `		pIn++;` |
|       5 |  9535 | `	}` |
|  966095 |  9536 | `	*ppIn = pIn;` |
|  966095 |  9537 | `	if( ppDup ){ *ppDup = pDup; }` |
|  966095 |  9538 | `	return iFlags;` |
|       5 |  9539 |  |
|       - |  9540 | `/*` |
...
|       - |  9546 | ` */` |
|  962488 |  9547 | `static int GenStateStartsModifiedClass(SyToken *pIn,SyToken *pEnd)` |
|       5 |  9548 |  |
|  962493 |  9549 | `	sxi32 iFlags = GenStateScanClassModifiers(&pIn,pEnd,0);` |
|  484853 |  9550 | `	return iFlags != 0 && pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD)` |
|  964291 |  9551 | `		&& (sxu32)SX_PTR_TO_INT(pIn->pUserData) == PH7_TKWRD_CLASS;` |
|       5 |  9552 |  |
|       - |  9553 | `/*` |
...
|       - |  9559 | ` */` |
|    3602 |  9560 | `static sxi32 PH7_CompileClassModifiers(ph7_gen_state *pGen)` |
|       5 |  9561 |  |
|       - |  9562 | `	SyToken *pDup;` |
|    3607 |  9563 | `	sxi32 iFlags = GenStateScanClassModifiers(&pGen->pIn,pGen->pEnd,&pDup);` |
|       - |  9564 | `	sxi32 rc;` |
|    3607 |  9565 | `	if( pDup ){` |
...
|       - |  9570 | `		}` |
|       1 |  9571 | `	}` |
|    5403 |  9572 | `	if( (iFlags & (PH7_CLASS_FINAL\|PH7_CLASS_ABSTRACT))` |
|    1806 |  9573 | `		== (PH7_CLASS_FINAL\|PH7_CLASS_ABSTRACT) ){` |
...
|       - |  9578 | `		}` |
|       1 |  9579 | `	}` |
|    3607 |  9580 | `	return GenStateCompileClass(&(*pGen),iFlags);` |
|    1806 |  9581 |  |
|       - |  9582 | `/*` |
...
|       - |  9881 | ` */` |
|   96874 |  9882 | `static sxi32 PH7_CompileClass(ph7_gen_state *pGen)` |
|       5 |  9883 |  |
|       - |  9884 | `	sxi32 rc;` |
|   96879 |  9885 | `	rc = GenStateCompileClass(&(*pGen),0);` |
|   96879 |  9886 | `	return rc;` |
|       5 |  9887 |  |
|       - |  9888 | `/*` |
...
|       - |  9909 | ` */` |
|   14478 |  9910 | `static sxi32 GenStateThrowNodeValidator(ph7_gen_state *pGen,ph7_expr_node *pRoot)` |
|       5 |  9911 |  |
|   14483 |  9912 | `	sxi32 rc = SXRET_OK;` |
|   14483 |  9913 | `	if( pRoot->pOp ){` |
|   14473 |  9914 | `		switch( pRoot->pOp->iOp ){` |
|    7234 |  9915 | `		case EXPR_OP_NEW:            /* new Exception() */` |
...
|     ! 0 |  9931 | `			break;` |
|       - |  9932 | `		}` |
|    7249 |  9933 | `	}else if( pRoot->xCode != PH7_CompileVariable ){` |
...
|       - |  9947 | ` */` |
|   14442 |  9948 | `static sxi32 PH7_CompileThrow(ph7_gen_state *pGen)` |
|       5 |  9949 |  |
|   14447 |  9950 | `	sxu32 nLine = pGen->pIn->nLine;` |
|       - |  9951 | `	GenBlock *pBlock;` |
|       - |  9952 | `	sxu32 nIdx;` |
|       - |  9953 | `	sxi32 rc;` |
|   14447 |  9954 | `	pGen->pIn++; /* Jump the 'throw' keyword */` |
|       - |  9955 | `	/* Compile the expression */` |
|   14447 |  9956 | `	rc = PH7_CompileExpr(&(*pGen),0,GenStateThrowNodeValidator);` |
|   14447 |  9957 | `	if( rc == SXERR_EMPTY ){` |
...
|       - |  9963 | `	}` |
|   14447 |  9964 | `	pBlock = pGen->pCurrent;` |
|       - |  9965 | `	/* Point to the top most function or try block and emit the forward jump */` |
|   57241 |  9966 | `	while(pBlock->pParent){` |
|   57237 |  9967 | `		if( pBlock->iFlags & (GEN_BLOCK_EXCEPTION\|GEN_BLOCK_FUNC) ){` |
|   14443 |  9968 | `			break;` |
|       - |  9969 | `		}` |
|       - |  9970 | `		/* Point to the parent block */` |
|   42799 |  9971 | `		pBlock = pBlock->pParent;` |
|       5 |  9972 | `	}` |
|       - |  9973 | `	/* Emit the throw instruction */` |
|   14447 |  9974 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_THROW,0,0,0,&nIdx);` |
|       - |  9975 | `	/* Emit the jump */` |
|   14447 |  9976 | `	GenStateNewJumpFixup(pBlock,PH7_OP_THROW,nIdx);` |
|   14447 |  9977 | `	return SXRET_OK;` |
|    7226 |  9978 |  |
|       - |  9979 | `/*` |
...
|       - | 10030 | ` */` |
|     576 | 10031 | `static sxi32 PH7_CompileCatch(ph7_gen_state *pGen,ph7_exception *pException)` |
|       5 | 10032 |  |
|     581 | 10033 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|       - | 10040 | `	char *zDup;` |
|       - | 10041 | `	sxi32 rc;` |
|     581 | 10042 | `	pGen->pIn++; /* Jump the 'catch' keyword */` |
|       - | 10043 | `	/* Zero the structure */` |
|     581 | 10044 | `	SyZero(&sCatch,sizeof(ph7_exception_block));` |
|       - | 10045 | `	/* Initialize fields */` |
|     581 | 10046 | `	SySetInit(&sCatch.aClasses,&pException->pVm->sAllocator,sizeof(SyString));` |
|     581 | 10047 | `	SySetInit(&sCatch.sByteCode,&pException->pVm->sAllocator,sizeof(VmInstr));` |
|     581 | 10048 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 /*(*/ ){` |
...
|     581 | 10063 | `	pGen->pIn++; /* Jump the left parenthesis '(' */` |
|     302 | 10064 | `	for(;;){` |
|       - | 10065 | `		SyBlob sResolved;` |
|     609 | 10066 | `		SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|     609 | 10067 | `		if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|     905 | 10083 | `		zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|     600 | 10084 | `			(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|     605 | 10085 | `		SyStringInitFromBuf(&sClassName,zDup,SyBlobLength(&sResolved));` |
|     605 | 10086 | `		SyBlobRelease(&sResolved);` |
|     605 | 10087 | `		if( zDup == 0 ){` |
|     ! 0 | 10088 | `			goto Mem;` |
|       - | 10089 | `		}` |
|     605 | 10090 | `		rc = SySetPut(&sCatch.aClasses,(const void *)&sClassName);` |
|     605 | 10091 | `		if( rc != SXRET_OK ){` |
|     ! 0 | 10092 | `			goto Mem;` |
|       - | 10093 | `		}` |
|       - | 10094 | `		/* Check for '\|' (multi-catch separator) */` |
|     614 | 10095 | `		if( pGen->pIn < pGen->pEnd &&` |
|     600 | 10096 | `			(pGen->pIn->nType & PH7_TK_OP) &&` |
...
|     577 | 10102 | `		break;` |
|     ! 0 | 10103 | `	}` |
|     858 | 10104 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 /*$*/ \|\|` |
|     577 | 10105 | `		&pGen->pIn[1] >= pGen->pEnd \|\| (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|       - | 10118 | `	}` |
|     577 | 10119 | `	pGen->pIn++; /* Jump the dollar sign */` |
|       - | 10120 | `	/* Duplicate instance name */` |
|     577 | 10121 | `	pName = &pGen->pIn->sData;` |
|     577 | 10122 | `	zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|     577 | 10123 | `	if( zDup == 0 ){` |
|     ! 0 | 10124 | `		goto Mem;` |
|       - | 10125 | `	}` |
|     577 | 10126 | `	SyStringInitFromBuf(&sCatch.sThis,zDup,pName->nByte);` |
|     577 | 10127 | `	pGen->pIn++;` |
|     577 | 10128 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_RPAREN) == 0 /*)*/ ){` |
...
|     577 | 10143 | `	pGen->pIn++; /* Jump the right parenthesis */` |
|       - | 10144 | `	/* Create the catch block */` |
|     577 | 10145 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_EXCEPTION,PH7_VmInstrLength(pGen->pVm),0,&pCatch);` |
|     577 | 10146 | `	if( rc != SXRET_OK ){` |
|     ! 0 | 10147 | `		return SXERR_ABORT;` |
|       - | 10148 | `	}` |
|       - | 10149 | `	/* Swap bytecode container */` |
|     577 | 10150 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|     577 | 10151 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&sCatch.sByteCode);` |
|       - | 10152 | `	/* Compile the block */` |
|     577 | 10153 | `	PH7_CompileBlock(&(*pGen),0);` |
|       - | 10154 | `	/* Fix forward jumps now the destination is resolved  */` |
|     577 | 10155 | `	GenStateFixJumps(pCatch,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - | 10156 | `	/* Emit the DONE instruction */` |
|     577 | 10157 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|       - | 10158 | `	/* Leave the block */` |
|     577 | 10159 | `	GenStateLeaveBlock(&(*pGen),0);` |
|       - | 10160 | `	/* Restore the default container */` |
|     577 | 10161 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|       - | 10162 | `	/* Install the catch block */` |
|     577 | 10163 | `	rc = SySetPut(&pException->sEntry,(const void *)&sCatch);` |
|     577 | 10164 | `	if( rc != SXRET_OK ){` |
|     ! 0 | 10165 | `		goto Mem;` |
|       - | 10166 | `	}` |
|     577 | 10167 | `	return SXRET_OK;` |
|     ! 0 | 10168 | `Mem:` |
...
|       - | 10177 | ` * is "thrown".` |
|       - | 10178 | ` */` |
|     614 | 10179 | `static sxi32 PH7_CompileTry(ph7_gen_state *pGen)` |
|       5 | 10180 |  |
|       - | 10181 | `	ph7_exception *pException;` |
|     619 | 10182 | `	sxu32 nLine = pGen->pIn->nLine;` |
|       - | 10183 | `	GenBlock *pTry;` |
|       - | 10184 | `	sxu32 nJmpIdx;` |
|       - | 10185 | `	sxi32 rc;` |
|       - | 10186 | `	/* Create the exception container */` |
|     619 | 10187 | `	pException = (ph7_exception *)SyMemBackendAlloc(&pGen->pVm->sAllocator,sizeof(ph7_exception));` |
|     619 | 10188 | `	if( pException == 0 ){` |
...
|     619 | 10194 | `	SyZero(pException,sizeof(ph7_exception));` |
|       - | 10195 | `	/* Initialize fields */` |
|     619 | 10196 | `	SySetInit(&pException->sEntry,&pGen->pVm->sAllocator,sizeof(ph7_exception_block));` |
|     619 | 10197 | `	SySetInit(&pException->sFinally,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|     619 | 10198 | `	pException->iHasFinally = 0;` |
|     619 | 10199 | `	pException->iFinallyDone = 0;` |
|     619 | 10200 | `	pException->pVm = pGen->pVm;` |
|       - | 10201 | `	/* Create the try block */` |
|     619 | 10202 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_EXCEPTION,PH7_VmInstrLength(pGen->pVm),0,&pTry);` |
|     619 | 10203 | `	if( rc != SXRET_OK ){` |
|     ! 0 | 10204 | `		return SXERR_ABORT;` |
|       - | 10205 | `	}` |
|       - | 10206 | `	/* Store exception pointer so break/continue can emit POP_EXCEPTION */` |
|     619 | 10207 | `	pTry->pUserData = pException;` |
|       - | 10208 | `	/* Emit the 'LOAD_EXCEPTION' instruction */` |
|     619 | 10209 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_EXCEPTION,0,0,pException,&nJmpIdx);` |
|       - | 10210 | `	/* Fix the jump later when the destination is resolved */` |
|     619 | 10211 | `	GenStateNewJumpFixup(pTry,PH7_OP_LOAD_EXCEPTION,nJmpIdx);` |
|     619 | 10212 | `	pGen->pIn++; /* Jump the 'try' keyword */` |
|       - | 10213 | `	/* Compile the block */` |
|     619 | 10214 | `	rc = PH7_CompileBlock(&(*pGen),0);` |
|     619 | 10215 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 | 10216 | `		return SXERR_ABORT;` |
|       - | 10217 | `	}` |
|       - | 10218 | `	/* Fix forward jumps now the destination is resolved */` |
|     619 | 10219 | `	GenStateFixJumps(pTry,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - | 10220 | `	/* Emit the 'POP_EXCEPTION' instruction */` |
|     619 | 10221 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP_EXCEPTION,0,0,pException,0);` |
|       - | 10222 | `	/* Leave the block */` |
|     619 | 10223 | `	GenStateLeaveBlock(&(*pGen),0);` |
|       - | 10224 | `	/* Compile catch block(s) — at least one catch or finally is required */` |
|     619 | 10225 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|     612 | 10226 | `		SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_CATCH ){` |
|       - | 10227 | `		/* Compile one or more catch blocks */` |
|     572 | 10228 | `		for(;;){` |
|    1144 | 10229 | `			if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0` |
|     926 | 10230 | `				\|\| SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_CATCH ){` |
|     289 | 10231 | `					break;` |
|       - | 10232 | `			}` |
|     581 | 10233 | `			rc = PH7_CompileCatch(&(*pGen),pException);` |
|     581 | 10234 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 | 10235 | `				return SXERR_ABORT;` |
|       - | 10236 | `			}` |
|       5 | 10237 | `		}` |
|     284 | 10238 | `	}` |
|       - | 10239 | `	/* Compile optional finally block */` |
|     619 | 10240 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|     336 | 10241 | `		SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_FINALLY ){` |
|       - | 10242 | `		SySet *pInstrContainer;` |
|       - | 10243 | `		GenBlock *pFinBlock;` |
|     107 | 10244 | `		pGen->pIn++; /* Jump the 'finally' keyword */` |
|       - | 10245 | `		/* Create the finally block for jump fixup bookkeeping */` |
|     107 | 10246 | `		rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_EXCEPTION,PH7_VmInstrLength(pGen->pVm),0,&pFinBlock);` |
|     107 | 10247 | `		if( rc != SXRET_OK ){` |
|     ! 0 | 10248 | `			return SXERR_ABORT;` |
|       - | 10249 | `		}` |
|       - | 10250 | `		/* Swap bytecode container */` |
|     107 | 10251 | `		pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|     107 | 10252 | `		PH7_VmSetByteCodeContainer(pGen->pVm,&pException->sFinally);` |
|       - | 10253 | `		/* Compile the finally body */` |
|     107 | 10254 | `		rc = PH7_CompileBlock(&(*pGen),0);` |
|     107 | 10255 | `		if( rc == SXERR_ABORT ){` |
...
|     107 | 10260 | `		GenStateFixJumps(pFinBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - | 10261 | `		/* Emit DONE to terminate the finally block */` |
|     107 | 10262 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|       - | 10263 | `		/* Leave the block */` |
|     107 | 10264 | `		GenStateLeaveBlock(&(*pGen),0);` |
|       - | 10265 | `		/* Restore the default container */` |
|     107 | 10266 | `		PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|     107 | 10267 | `		pException->iHasFinally = 1;` |
|      51 | 10268 | `	}` |
|       - | 10269 | `	/* Must have at least one catch or finally */` |
|     619 | 10270 | `	if( SySetUsed(&pException->sEntry) == 0 && !pException->iHasFinally ){` |
|       8 | 10271 | `		rc = PH7_GenCompileError(&(*pGen),E_ERROR,nLine,` |
|       - | 10272 | `			"Cannot use try without catch or finally");` |
|       8 | 10273 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 | 10274 | `			return SXERR_ABORT;` |
|       - | 10275 | `		}` |
|       3 | 10276 | `	}` |
|     619 | 10277 | `	return SXRET_OK;` |
|     312 | 10278 |  |
|       - | 10279 | `/*` |
...
|       - | 10633 | ` */` |
| 2634954 | 10634 | `static void GenStatePatchNullsafeJumps(ph7_gen_state *pGen, sxu32 nBaseline)` |
|       5 | 10635 |  |
| 2634959 | 10636 | `	sxu32 nCur = SySetUsed(&pGen->aNullsafeJmp);` |
|       - | 10637 | `	sxu32 nTarget;` |
|       - | 10638 | `	sxu32 *aIdx;` |
|       - | 10639 | `	sxu32 i;` |
| 2634959 | 10640 | `	if( nCur <= nBaseline ){` |
| 2634865 | 10641 | `		return;` |
|       - | 10642 | `	}` |
...
|       - | 10670 | ` */` |
|  442512 | 10671 | `static sxu32 GenStateByRefBuiltinMask(SyString *pName)` |
|       5 | 10672 |  |
...
|       - | 10682 | `	};` |
|       - | 10683 | `	sxu32 i;` |
|  442517 | 10684 | `	if( pName == 0 \|\| pName->zString == 0 \|\| pName->nByte == 0 ){` |
|    1563 | 10685 | `		return 0;` |
|       - | 10686 | `	}` |
| 2204555 | 10687 | `	for( i = 0 ; i < SX_ARRAYSIZE(aByRef) ; ++i ){` |
| 1763664 | 10688 | `		if( pName->nByte == aByRef[i].nByte` |
|  904050 | 10689 | `		 && SyStrnicmp(pName->zString, aByRef[i].zName, pName->nByte) == 0 ){` |
|      73 | 10690 | `			return aByRef[i].mask;` |
|       - | 10691 | `		}` |
|  881803 | 10692 | `	}` |
|  440891 | 10693 | `	return 0;` |
|  221261 | 10694 |  |
|       - | 10695 | `/*` |
...
|       - | 10704 | ` */` |
|  442512 | 10705 | `static void GenStateCallBuiltinName(ph7_expr_node *pLeft, SyString *pOut)` |
|       5 | 10706 |  |
|       - | 10707 | `	SyToken *p, *pEnd;` |
|  442517 | 10708 | `	pOut->zString = 0;` |
|  442517 | 10709 | `	pOut->nByte = 0;` |
|  442517 | 10710 | `	if( pLeft == 0 \|\| pLeft->pStart == 0 \|\| pLeft->pEnd == 0 ){` |
|     ! 0 | 10711 | `		return;` |
|       - | 10712 | `	}` |
|  442517 | 10713 | `	p = pLeft->pStart;` |
|  442517 | 10714 | `	pEnd = pLeft->pEnd;` |
|       - | 10715 | `	/* Optional single leading namespace separator (absolute path). */` |
|  442517 | 10716 | `	if( p < pEnd && (p->nType & PH7_TK_NSSEP) ){` |
|    3571 | 10717 | `		p++;` |
|    1783 | 10718 | `	}` |
|  442517 | 10719 | `	if( p >= pEnd \|\| (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|    1535 | 10720 | `		return;` |
|       - | 10721 | `	}` |
|       - | 10722 | `	/* Must be a single component: nothing follows the name token. */` |
|  440987 | 10723 | `	if( p + 1 != pEnd ){` |
|      32 | 10724 | `		return;` |
|       - | 10725 | `	}` |
|  440959 | 10726 | `	*pOut = p->sData;` |
|  221261 | 10727 |  |
|       - | 10728 | `/*` |
...
|       - | 10733 | ` * error message.` |
|       - | 10734 | ` */` |
| 3525716 | 10735 | `static sxi32 GenStateEmitExprCode(` |
...
|       - | 10742 | `	sxu32 nJmpIdx;` |
| 3525721 | 10743 | `	sxi32 iP1 = 0;` |
| 3525721 | 10744 | `	sxu32 iP2 = 0;` |
| 3525721 | 10745 | `	void *p3  = 0;` |
|       - | 10746 | `	sxi32 iVmOp;` |
|       - | 10747 | `	sxi32 rc;` |
| 3525721 | 10748 | `	int bIsChainOp = 0; /* Set below once we know pNode->pOp */` |
| 3525721 | 10749 | ``	int bFcc = 0;       /* First-class callable `f(...)`: emit OP_LOAD_FCC, not OP_CALL */`` |
| 3525721 | 10750 | `	sxu32 nRhsNsBase = 0;` |
| 3525721 | 10751 | `	if( pNode->xCode ){` |
|       - | 10752 | `		SyToken *pTmpIn,*pTmpEnd;` |
|       - | 10753 | `		/* Compile node */` |
| 2200883 | 10754 | `		SWAP_DELIMITER(pGen,pNode->pStart,pNode->pEnd);` |
| 2200883 | 10755 | `		rc = pNode->xCode(&(*pGen),iFlags);` |
| 2200883 | 10756 | `		RE_SWAP_DELIMITER(pGen);` |
| 2200883 | 10757 | `		return rc;` |
|       - | 10758 | `	}` |
| 1324843 | 10759 | `	if( pNode->pOp == 0 ){` |
...
|       - | 10763 | `	}` |
| 1324843 | 10764 | `	iVmOp = pNode->pOp->iVmOp;` |
| 1324843 | 10765 | `	if( pNode->pOp->iOp == EXPR_OP_NULLC_ASSIGN ){` |
...
|       - | 10814 | `	}` |
| 1324781 | 10815 | `	if( pNode->pOp->iOp == EXPR_OP_QUESTY ){` |
...
|       - | 10877 | `	}` |
| 1322119 | 10878 | `	bIsChainOp = GEN_IS_CHAIN_OP(pNode->pOp->iOp);` |
|       - | 10879 | `	/* Generate code for the left tree */` |
| 1322119 | 10880 | `	if( pNode->pLeft ){` |
| 1322079 | 10881 | `		sxu32 nLhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
| 1322079 | 10882 | `		if( iVmOp == PH7_OP_CALL ){` |
|       - | 10883 | `			ph7_expr_node **apNode;` |
|  446203 | 10884 | `			int hasSpread = 0;` |
|  446203 | 10885 | `			int hasNamed = 0;` |
|  446203 | 10886 | `			int bAnySpread = 0;` |
|  446203 | 10887 | `			sxu32 byRefMask = 0;` |
|       - | 10888 | `			sxi32 nArgs;` |
|       - | 10889 | `			sxi32 n;` |
|       - | 10890 | `			/* Recurse and generate bytecodes for function arguments */` |
|  446203 | 10891 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  446203 | 10892 | `			nArgs = (sxi32)SySetUsed(&pNode->aNodeArgs);` |
...
|  446203 | 10896 | `			if( nArgs == 1 && apNode[0] && (apNode[0]->iFlags & EXPR_NODE_FCC) ){` |
|      65 | 10897 | `				bFcc = 1;` |
|      65 | 10898 | `				nArgs = 0;` |
|      32 | 10899 | `			}` |
|       - | 10900 | `			/* Validate: no positional arguments after named arguments */` |
|       - | 10901 | `			{` |
|  446203 | 10902 | `				int seenNamed = 0;` |
|  905149 | 10903 | `				for( n = 0; n < nArgs; ++n ){` |
|  458953 | 10904 | `					if( apNode[n]->iFlags & EXPR_NODE_NAMED_ARG ){` |
|     216 | 10905 | `						seenNamed = 1;` |
|     216 | 10906 | `						hasNamed = 1;` |
|  458847 | 10907 | `					}else if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
|    3573 | 10908 | `						bAnySpread = 1;` |
|  456957 | 10909 | `					}else if( seenNamed ){` |
...
|  446201 | 10917 | `			iFlags \|= EXPR_FLAG_RDONLY_LOAD;` |
...
|  446201 | 10922 | `			if( pNode->pLeft && pNode->pLeft->pStart ){` |
|  446201 | 10923 | `				SyString *pCallName = &pNode->pLeft->pStart->sData;` |
|  446196 | 10924 | `				if( pCallName->nByte == 5` |
|  243608 | 10925 | `				 && SyStrnicmp(pCallName->zString,"isset",5) == 0 ){` |
|   21597 | 10926 | `					iFlags \|= EXPR_FLAG_LOAD_IDX_ISSET;` |
|  435405 | 10927 | `				}else if( pCallName->nByte == 5` |
|  222016 | 10928 | `				 && SyStrnicmp(pCallName->zString,"empty",5) == 0 ){` |
...
|  446201 | 10937 | `				if( !bAnySpread && !hasNamed ){` |
|       - | 10938 | `					SyString sBuiltin;` |
|  442517 | 10939 | `					GenStateCallBuiltinName(pNode->pLeft, &sBuiltin);` |
|  442517 | 10940 | `					byRefMask = GenStateByRefBuiltinMask(&sBuiltin);` |
|  221256 | 10941 | `				}` |
|  223098 | 10942 | `			}` |
|  905145 | 10943 | `			for( n = 0 ; n < nArgs ; ++n ){` |
|  458949 | 10944 | `				sxu32 nArgNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  458949 | 10945 | `				sxi32 iArgFlags = iFlags & ~(EXPR_FLAG_LOAD_IDX_STORE\|EXPR_FLAG_MEMBER_WRITE);` |
...
|  458949 | 10952 | `				if( n < 31 && (byRefMask & (1u<<n)) ){` |
|      53 | 10953 | `					iArgFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|      53 | 10954 | `					iArgFlags \|= EXPR_FLAG_LOAD_IDX_STORE;` |
|      24 | 10955 | `				}` |
|  458949 | 10956 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iArgFlags);` |
|  458949 | 10957 | `				if( rc != SXRET_OK ){` |
|     ! 0 | 10958 | `					return rc;` |
|       - | 10959 | `				}` |
|       - | 10960 | `				/* Each argument is an independent nullsafe scope. */` |
|  458949 | 10961 | `				GenStatePatchNullsafeJumps(pGen, nArgNsBase);` |
|  458949 | 10962 | `				if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
|       - | 10963 | `					/* Emit spread opcode to unpack this array argument */` |
|    3573 | 10964 | `					PH7_VmEmitInstr(pGen->pVm, PH7_OP_SPREAD, 0, 0, 0, 0);` |
|    3573 | 10965 | `					hasSpread = 1;` |
|    1784 | 10966 | `				}` |
|  229477 | 10967 | `			}` |
|       - | 10968 | `			/* Total number of given arguments */` |
|  446201 | 10969 | `			iP1 = nArgs;` |
|  446201 | 10970 | `			iP2 = hasSpread;` |
|       - | 10971 | `			/* Build VmCallArgMap if named arguments are present.` |
|       - | 10972 | `			 * Deep-copy name strings so they survive token stream cleanup. */` |
|  446201 | 10973 | `			if( hasNamed ){` |
...
|  446201 | 11005 | `			iFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|  223098 | 11006 | `		}` |
|       - | 11007 | `		{` |
...
| 1322077 | 11016 | `			sxi32 iLeftFlags = iFlags;` |
| 1492586 | 11017 | `			if( pNode->pLeft && pNode->pLeft->pOp` |
|  839381 | 11018 | `				&& (pNode->pLeft->pOp->iOp == EXPR_OP_ARROW` |
|  348884 | 11019 | `					\|\| pNode->pLeft->pOp->iOp == EXPR_OP_NULLSAFE_ARROW` |
|  341058 | 11020 | `					\|\| pNode->pLeft->pOp->iOp == EXPR_OP_DC) ){` |
|   15845 | 11021 | `				iLeftFlags &= ~EXPR_FLAG_LOAD_IDX_UNSET;` |
|    7920 | 11022 | `			}` |
...
| 1894934 | 11030 | `			if( pNode->pOp` |
| 1322077 | 11031 | `				&& (pNode->pOp->iOp == EXPR_OP_ARROW` |
| 1233949 | 11032 | `					\|\| pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW` |
| 1145775 | 11033 | `					\|\| pNode->pOp->iOp == EXPR_OP_DC) ){` |
|  176671 | 11034 | `				iLeftFlags &= ~EXPR_FLAG_MEMBER_WRITE;` |
|   88333 | 11035 | `			}` |
| 1322077 | 11036 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pLeft,iLeftFlags);` |
|       - | 11037 | `		}` |
| 1322077 | 11038 | `		if( rc != SXRET_OK ){` |
|      34 | 11039 | `			return rc;` |
|       - | 11040 | `		}` |
| 1322047 | 11041 | `		if( !bIsChainOp ){` |
...
|  607977 | 11044 | `			GenStatePatchNullsafeJumps(pGen, nLhsNsBase);` |
|  303986 | 11045 | `		}` |
| 1322047 | 11046 | `		if( iVmOp == PH7_OP_CALL ){` |
|  446201 | 11047 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|  446201 | 11048 | `			if( pInstr ){` |
|  446201 | 11049 | `				if ( pInstr->iOp == PH7_OP_LOADC ){` |
|  441081 | 11050 | `					sxu32 nOrig = (sxu32)pInstr->iP2;` |
|       - | 11051 | `					sxu32 nQual;` |
|  441081 | 11052 | `					int bAbsolute = (pInstr->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|       - | 11053 | `					/* Prevent constant expansion but preserve the absolute flag` |
|       - | 11054 | `					 * so the later NEW handler (if any) can see it. */` |
|  441081 | 11055 | `					pInstr->iP1 &= ~PH7_LOADC_EXPAND;` |
...
|  441081 | 11063 | `					if( bAbsolute ){` |
|    3571 | 11064 | `						pInstr->iP2 = (sxi32)nOrig;` |
|    1788 | 11065 | `					}else{` |
|  437515 | 11066 | `						int fromImport = 0;` |
|  437515 | 11067 | `						nQual = GenStateNsQualifyName(pGen,nOrig,&pGen->hUseFuncImports,&fromImport);` |
|  437515 | 11068 | `						pInstr->iP2 = (sxi32)nQual;` |
|  437515 | 11069 | `						if( nQual != nOrig ){` |
...
|      36 | 11087 | `						}` |
|       5 | 11088 | `					}` |
|  225663 | 11089 | `				}else if( pInstr->iOp == PH7_OP_MEMBER /* $a->b(1,2,3) */ \|\| pInstr->iOp == PH7_OP_NEW ){` |
|       - | 11090 | `					/* Method call,flag that */` |
|    1181 | 11091 | `					pInstr->iP2 = 1;` |
|     588 | 11092 | `				}` |
|  223103 | 11093 | `			}` |
| 1098949 | 11094 | `		}else if( iVmOp == PH7_OP_LOAD_IDX ){` |
|       - | 11095 | `			ph7_expr_node **apNode;` |
|       - | 11096 | `			sxi32 n;` |
|   91213 | 11097 | `			sxi32 iChildMask = ~(EXPR_FLAG_LOAD_IDX_STORE` |
...
|   91213 | 11101 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  164601 | 11102 | `			for( n = 0 ; n < (sxi32)SySetUsed(&pNode->aNodeArgs) ; ++n ){` |
|   73393 | 11103 | `				sxu32 nIdxNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|   73393 | 11104 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iFlags&iChildMask);` |
|   73393 | 11105 | `				if( rc != SXRET_OK ){` |
|     ! 0 | 11106 | `					return rc;` |
|       - | 11107 | `				}` |
|       - | 11108 | `				/* Each subscript index is an independent nullsafe scope. */` |
|   73393 | 11109 | `				GenStatePatchNullsafeJumps(pGen, nIdxNsBase);` |
|   36699 | 11110 | `			}` |
|   91213 | 11111 | `			if( SySetUsed(&pNode->aNodeArgs) > 0 ){` |
|   73393 | 11112 | `				iP1 = 1; /* Node have an index associated with it */` |
|   36694 | 11113 | `			}` |
|   91213 | 11114 | `			if( iFlags & EXPR_FLAG_LOAD_IDX_ISSET ){` |
|       - | 11115 | `				/* offsetExists for ArrayAccess; peek-only for arrays */` |
|     243 | 11116 | `				iP2 = 4;` |
|   91094 | 11117 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_UNSET ){` |
|       - | 11118 | `				/* offsetUnset for ArrayAccess; auto-vivify+load for arrays` |
|       - | 11119 | `				 * so the trailing unset() builtin can drop the slot. */` |
|      56 | 11120 | `				iP2 = 5;` |
|   90949 | 11121 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_EMPTY ){` |
...
|      29 | 11125 | `				iP2 = 6;` |
|   90911 | 11126 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_STORE ){` |
|       - | 11127 | `				/* Create an empty entry when the desired index is not found */` |
|   35947 | 11128 | `				iP2 = 1;` |
|   17976 | 11129 | `			}` |
|  830247 | 11130 | `		}else if( pNode->pOp->iOp == EXPR_OP_COMMA ){` |
|       - | 11131 | `			/* POP the left node */` |
|      32 | 11132 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|      15 | 11133 | `		}` |
|  661021 | 11134 | `	}` |
| 1322087 | 11135 | `	rc = SXRET_OK;` |
| 1322087 | 11136 | `	nJmpIdx = 0;` |
...
| 1322087 | 11140 | `	if( iVmOp == PH7_OP_MEMBER && pNode->pOp->iOp == EXPR_OP_DC ){` |
...
|     277 | 11148 | `				if( (n == 4 && SyMemcmp(z,"self",4) == 0) \|\|` |
|     243 | 11149 | `					(n == 6 && SyMemcmp(z,"static",6) == 0) \|\|` |
...
| 1322005 | 11170 | `	if( pNode->pRight ){` |
|  713703 | 11171 | `		if( iVmOp == PH7_OP_LAND ){` |
|       - | 11172 | `			/* Emit the false jump so we can short-circuit the logical and */` |
|   11131 | 11173 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,1/* Keep the value on the stack */,0,0,&nJmpIdx);` |
|  708140 | 11174 | `		}else if (iVmOp == PH7_OP_LOR ){` |
|       - | 11175 | `			/* Emit the true jump so we can short-circuit the logical or*/` |
|    3727 | 11176 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JNZ,1/* Keep the value on the stack */,0,0,&nJmpIdx);` |
|  700716 | 11177 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLC ){` |
...
|  698844 | 11181 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW ){` |
...
|  698680 | 11191 | `		}else if( pNode->pOp->iPrec == 18 /* Combined binary operators [i.e: =,'.=','+=',*=' ...] precedence */ ){` |
...
|  296925 | 11195 | `			iFlags \|= EXPR_FLAG_LOAD_IDX_STORE \| EXPR_FLAG_MEMBER_WRITE;` |
|  148460 | 11196 | `		}` |
|  713703 | 11197 | `		nRhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  713703 | 11198 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pRight,iFlags);` |
|  713703 | 11199 | `		if( !bIsChainOp ){` |
|       - | 11200 | `			/* Non-chain parent: RHS nullsafe chain ends here, before the` |
|       - | 11201 | `			 * operator instruction is emitted. */` |
|  537081 | 11202 | `			GenStatePatchNullsafeJumps(pGen, nRhsNsBase);` |
|  268538 | 11203 | `		}` |
|  713703 | 11204 | `		if( iVmOp == PH7_OP_STORE ){` |
|  293123 | 11205 | `			if( pNode->pRight && (pNode->pRight->xCode == PH7_CompileList \|\|` |
|  293092 | 11206 | `				pNode->pRight->xCode == PH7_CompileShortList) ){` |
...
|       - | 11212 | `				 */` |
|      80 | 11213 | `				iVmOp = 0;` |
|  293085 | 11214 | `			}else if( (pInstr = PH7_VmPeekInstr(pGen->pVm)) != 0 ){` |
|  293047 | 11215 | `				if(pInstr->iOp == PH7_OP_MEMBER ){` |
|       - | 11216 | `					/* Perform a member store operation [i.e: $this->x = 50] */` |
|   78475 | 11217 | `					iP2 = 1;` |
|   39240 | 11218 | `				}else{` |
|  214577 | 11219 | `					if( pInstr->iOp == PH7_OP_LOAD_IDX ){` |
|       - | 11220 | `						/* Transform the STORE instruction to STORE_IDX instruction */` |
|   35871 | 11221 | `						iVmOp = PH7_OP_STORE_IDX;` |
|   35871 | 11222 | `						iP1 = pInstr->iP1;` |
|   17938 | 11223 | `					}else{` |
|  178711 | 11224 | `						p3 = pInstr->p3;` |
|       - | 11225 | `					}` |
|       - | 11226 | `					/* POP the last dynamic load instruction */` |
|  214577 | 11227 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|       - | 11228 | `				}` |
|  146526 | 11229 | `			}` |
|  567144 | 11230 | `		}else if( iVmOp == PH7_OP_STORE_REF ){` |
...
|      26 | 11245 | `		}` |
|  356849 | 11246 | `	}` |
| 1322000 | 11247 | `	if( iVmOp == PH7_OP_NEW && pNode->pLeft && pNode->pLeft->pOp == 0` |
|   11528 | 11248 | `		&& pNode->pLeft->xCode == PH7_CompileAnnonClass ){` |
...
|      29 | 11251 | `		iVmOp = 0;` |
|      13 | 11252 | `	}` |
| 1322005 | 11253 | `	if( iVmOp > 0 ){` |
| 1321749 | 11254 | `		if( iVmOp == PH7_OP_INCR \|\| iVmOp == PH7_OP_DECR ){` |
|   14573 | 11255 | `			if( pNode->iFlags & EXPR_NODE_PRE_INCR ){` |
|       - | 11256 | `				/* Pre-increment/decrement operator [i.e: ++$i,--$j ] */` |
|   10657 | 11257 | `				iP1 = 1;` |
|    5331 | 11258 | `			}` |
| 1314465 | 11259 | `		}else if( iVmOp == PH7_OP_NEW ){` |
|       - | 11260 | `			/* Namespace-qualify the class name for NEW */ {` |
|   22807 | 11261 | `				VmInstr *pPeek = PH7_VmPeekInstr(pGen->pVm);` |
|   22807 | 11262 | `				VmInstr *pCallInstr = 0;` |
|   22807 | 11263 | `				if( pPeek && pPeek->iOp == PH7_OP_CALL ){` |
|   22615 | 11264 | `					pCallInstr = pPeek;` |
|   22615 | 11265 | `					pPeek = PH7_VmPeekNextInstr(pGen->pVm);` |
|   11305 | 11266 | `				}` |
|   22807 | 11267 | `				if( pPeek && pPeek->iOp == PH7_OP_LOADC ){` |
|   22805 | 11268 | `					int bAbsolute = (pPeek->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
...
|   22805 | 11273 | `					if( pCallInstr && pCallInstr->iP2 > 0 ){` |
|      37 | 11274 | `						nLitForClass = (sxu32)(pCallInstr->iP2 - 1); /* undo +1 encoding */` |
|      21 | 11275 | `					}else{` |
|   22773 | 11276 | `						nLitForClass = (sxu32)pPeek->iP2;` |
|       - | 11277 | `					}` |
|   22805 | 11278 | `					pPeek->iP1 = 0;` |
|   22805 | 11279 | `					if( !bAbsolute ){` |
|   19243 | 11280 | `						pPeek->iP2 = (sxi32)GenStateNsQualifyName(pGen,nLitForClass,&pGen->hUseImports,0);` |
|    9624 | 11281 | `					}else{` |
|    3567 | 11282 | `						pPeek->iP2 = (sxi32)nLitForClass;` |
|       - | 11283 | `					}` |
|   11400 | 11284 | `				}` |
|       - | 11285 | `			}` |
|   22807 | 11286 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|   22807 | 11287 | `			if( pInstr && pInstr->iOp == PH7_OP_CALL ){` |
|       - | 11288 | `				VmInstr *pPrev;` |
|   22615 | 11289 | `				pPrev = PH7_VmPeekNextInstr(pGen->pVm);` |
|   22615 | 11290 | `				if( pPrev == 0 \|\| pPrev->iOp != PH7_OP_MEMBER ){` |
|       - | 11291 | `					/* Pop the call instruction, preserve named-arg map */` |
|   22615 | 11292 | `					iP1 = pInstr->iP1;` |
|   22615 | 11293 | `					if( pInstr->p3 ){` |
|      43 | 11294 | `						p3 = pInstr->p3; /* Transfer VmCallArgMap to NEW */` |
|      19 | 11295 | `					}` |
|   22615 | 11296 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|   11305 | 11297 | `				}` |
|   11310 | 11298 | `			}` |
| 1295780 | 11299 | `		}else if( iVmOp == PH7_OP_IS_A ){` |
...
|     197 | 11310 | `					if( (n == 4 && SyMemcmp(z,"self",4) == 0) \|\|` |
|     192 | 11311 | `						(n == 6 && SyMemcmp(z,"static",6) == 0) \|\|` |
...
|      88 | 11319 | `				}` |
|     102 | 11320 | `			}` |
| 1284284 | 11321 | `		}else if( iVmOp == PH7_OP_MEMBER){` |
...
|  176627 | 11325 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|  176627 | 11326 | `			if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|  176581 | 11327 | `				pInstr->iP1 = 0;` |
|   88288 | 11328 | `			}` |
|  176627 | 11329 | `			if( pNode->pOp->iOp == EXPR_OP_DC /* '::' */){` |
...
|  176627 | 11342 | `			if( iP2 == PH7_MEMBER_READ ){` |
|  176627 | 11343 | `				if( iFlags & EXPR_FLAG_LOAD_IDX_UNSET ){` |
|      30 | 11344 | `					iP2 = PH7_MEMBER_UNSET;` |
|  176613 | 11345 | `				}else if( iFlags & EXPR_FLAG_LOAD_IDX_ISSET ){` |
|      77 | 11346 | `					iP2 = PH7_MEMBER_ISSET;` |
|  176563 | 11347 | `				}else if( iFlags & EXPR_FLAG_LOAD_IDX_EMPTY ){` |
|      13 | 11348 | `					iP2 = PH7_MEMBER_EMPTY;` |
|  176521 | 11349 | `				}else if( iFlags & EXPR_FLAG_MEMBER_WRITE ){` |
|       - | 11350 | `					/* Write-lvalue base ($o->arr[$k]=v, $o->p ??= v): auto-create a missing prop. */` |
|   78555 | 11351 | `					iP2 = PH7_MEMBER_WRITE;` |
|   39275 | 11352 | `				}` |
|   88311 | 11353 | `			}` |
|   88311 | 11354 | `		}` |
...
| 1321747 | 11382 | `		if( iVmOp == PH7_OP_CALL \|\| iVmOp == PH7_OP_NEW ){` |
|  468939 | 11383 | `			p3 = GenStateAttachStrictFlag(pGen,p3);` |
|  234467 | 11384 | `		}` |
|       - | 11385 | `		/* Finally,emit the VM instruction associated with this operator */` |
| 1321747 | 11386 | `		PH7_VmEmitInstr(pGen->pVm,iVmOp,iP1,iP2,p3,0);` |
|  660871 | 11387 | `	}` |
| 1322003 | 11388 | `	if( nJmpIdx > 0 ){` |
|       - | 11389 | `		/* Fix short-circuited jumps now the destination is resolved */` |
|   14977 | 11390 | `		pInstr = PH7_VmGetInstr(pGen->pVm,nJmpIdx);` |
|   14977 | 11391 | `		if( pInstr ){` |
|   14977 | 11392 | `			pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    7486 | 11393 | `		}` |
|    7486 | 11394 | `	}` |
| 1322003 | 11395 | `	return rc;` |
| 1762843 | 11396 |  |
|       - | 11397 | `/*` |
...
|       - | 11406 | ` * message.` |
|       - | 11407 | ` */` |
|  949724 | 11408 | `static sxi32 PH7_CompileExpr(` |
...
|  949729 | 11422 | `	nExpr = 0;` |
|  949729 | 11423 | `	pRoot = 0;` |
...
|  949729 | 11426 | `	nNullsafeBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  949729 | 11427 | `	SySetInit(&sExprNode,&pGen->pVm->sAllocator,sizeof(ph7_expr_node *));` |
|  949729 | 11428 | `	SySetAlloc(&sExprNode,0x10);` |
|  949729 | 11429 | `	rc = SXRET_OK;` |
|       - | 11430 | `	/* Delimit the expression */` |
|  949729 | 11431 | `	pEnd = pGen->pIn;` |
|  949729 | 11432 | `	iNest = 0;` |
| 6406319 | 11433 | `	while( pEnd < pGen->pEnd ){` |
| 6079047 | 11434 | `		if( pEnd->nType & PH7_TK_OCB /* '{' */ ){` |
|       - | 11435 | `			/* Ticket 1433-30: Annonymous/Closure functions body */` |
|     515 | 11436 | `			iNest++;` |
| 6078792 | 11437 | `		}else if(pEnd->nType & PH7_TK_CCB /* '}' */ ){` |
|     523 | 11438 | `			iNest--;` |
| 6078278 | 11439 | `		}else if( pEnd->nType & PH7_TK_SEMI /* ';' */ ){` |
|  622827 | 11440 | `			if( iNest <= 0 ){` |
|  622457 | 11441 | `				break;` |
|       - | 11442 | `			}` |
|     185 | 11443 | `		}` |
| 5456595 | 11444 | `		pEnd++;` |
|       5 | 11445 | `	}` |
|  949729 | 11446 | `	if( iFlags & EXPR_FLAG_COMMA_STATEMENT ){` |
|   21839 | 11447 | `		SyToken *pEnd2 = pGen->pIn;` |
|   21839 | 11448 | `		iNest = 0;` |
|       - | 11449 | `		/* Stop at the first comma */` |
|   43967 | 11450 | `		while( pEnd2 < pEnd ){` |
|   22139 | 11451 | `			if( pEnd2->nType & (PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*'['*/\|PH7_TK_LPAREN/*'('*/) ){` |
|      67 | 11452 | `				iNest++;` |
|   22108 | 11453 | `			}else if(pEnd2->nType & (PH7_TK_CCB/*'}'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_RPAREN/*')'*/)){` |
|      67 | 11454 | `				iNest--;` |
|   22046 | 11455 | `			}else if( pEnd2->nType & PH7_TK_COMMA /*','*/ ){` |
|      57 | 11456 | `				if( iNest <= 0 ){` |
|       7 | 11457 | `					break;` |
|       - | 11458 | `				}` |
|      23 | 11459 | `			}` |
|   22133 | 11460 | `			pEnd2++;` |
|       5 | 11461 | `		}` |
|   21839 | 11462 | `		if( pEnd2 <pEnd ){` |
|       7 | 11463 | `			pEnd = pEnd2;` |
|       3 | 11464 | `		}` |
|   10917 | 11465 | `	}` |
|  949729 | 11466 | `	if( pEnd > pGen->pIn ){` |
|  949719 | 11467 | `		SyToken *pTmp = pGen->pEnd;` |
|       - | 11468 | `		/* Swap delimiter */` |
|  949719 | 11469 | `		pGen->pEnd = pEnd;` |
|       - | 11470 | `		/* Try to get an expression tree */` |
|  949719 | 11471 | `		rc = PH7_ExprMakeTree(&(*pGen),&sExprNode,&pRoot);` |
|  949719 | 11472 | `		if( rc == SXRET_OK && pRoot ){` |
|  949537 | 11473 | `			rc = SXRET_OK;` |
|  949537 | 11474 | `			if( xTreeValidator ){` |
|       - | 11475 | `				/* Call the upper layer validator callback */` |
|   29221 | 11476 | `				rc = xTreeValidator(&(*pGen),pRoot);` |
|   14608 | 11477 | `			}` |
|  949537 | 11478 | `			if( rc != SXERR_ABORT ){` |
|       - | 11479 | `				/* Generate code for the given tree */` |
|  949537 | 11480 | `				rc = GenStateEmitExprCode(&(*pGen),pRoot,iFlags);` |
|       - | 11481 | `				/* Patch any unresolved nullsafe jumps emitted by this` |
|       - | 11482 | `				 * expression so they short-circuit to its end. */` |
|  949537 | 11483 | `				GenStatePatchNullsafeJumps(pGen, nNullsafeBase);` |
|  474766 | 11484 | `			}` |
|  949537 | 11485 | `			nExpr = 1;` |
|  474766 | 11486 | `		}` |
|       - | 11487 | `		/* Release the whole tree */` |
|  949719 | 11488 | `		PH7_ExprFreeTree(&(*pGen),&sExprNode);` |
|       - | 11489 | `		/* Synchronize token stream */` |
|  949719 | 11490 | `		pGen->pEnd = pTmp;` |
|  949719 | 11491 | `		pGen->pIn  = pEnd;` |
|  949719 | 11492 | `		if( rc == SXERR_ABORT ){` |
|      12 | 11493 | `			SySetRelease(&sExprNode);` |
|      12 | 11494 | `			return SXERR_ABORT;` |
|       - | 11495 | `		}` |
|  474852 | 11496 | `	}` |
|  949719 | 11497 | `	SySetRelease(&sExprNode);` |
|  949719 | 11498 | `	return nExpr > 0 ? SXRET_OK : SXERR_EMPTY;` |
|  474867 | 11499 |  |
|       - | 11500 | `/*` |
|       - | 11501 | ` * Return a pointer to the node construct handler associated` |
|       - | 11502 | ` * with a given node type [i.e: string,integer,float,...].` |
|       - | 11503 | ` */` |
|  248774 | 11504 | `PH7_PRIVATE ProcNodeConstruct PH7_GetNodeHandler(sxu32 nNodeType)` |
|       5 | 11505 |  |
|  248779 | 11506 | `	if( nNodeType & PH7_TK_NUM ){` |
|       - | 11507 | `		/* Numeric literal: Either real or integer */` |
|  125163 | 11508 | `		return PH7_CompileNumLiteral;` |
|  123621 | 11509 | `	}else if( nNodeType & PH7_TK_DSTR ){` |
|       - | 11510 | `		/* Double quoted string */` |
|   23545 | 11511 | `		return PH7_CompileString;` |
|  100081 | 11512 | `	}else if( nNodeType & PH7_TK_SSTR ){` |
|       - | 11513 | `		/* Single quoted string */` |
|   99965 | 11514 | `		return PH7_CompileSimpleString;` |
|     120 | 11515 | `	}else if( nNodeType & PH7_TK_HEREDOC ){` |
|       - | 11516 | `		/* Heredoc */` |
|      68 | 11517 | `		return PH7_CompileHereDoc;` |
|      56 | 11518 | `	}else if( nNodeType & PH7_TK_NOWDOC ){` |
|       - | 11519 | `		/* Nowdoc */` |
...
|       - | 11642 | ` */` |
|  636912 | 11643 | `static ProcLangConstruct GenStateGetStatementHandler(` |
|       - | 11644 | `	sxu32 nKeywordID,   /* Keyword  ID*/` |
|       - | 11645 | `	SyToken *pLookahed  /* Look-ahead token */` |
|       - | 11646 | `	)` |
|       5 | 11647 |  |
|  636917 | 11648 | `	sxu32 n = 0;` |
| 3301635 | 11649 | `	for(;;){` |
| 6603275 | 11650 | `		if( n >= SX_ARRAYSIZE(aLangConstruct) ){` |
|  136291 | 11651 | `			break;` |
|       - | 11652 | `		}` |
| 6466989 | 11653 | `		if( aLangConstruct[n].nID == nKeywordID ){` |
|  500631 | 11654 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed && (pLookahed->nType & PH7_TK_OP)){` |
...
|       - | 11659 | `				}` |
|     ! 0 | 11660 | `			}` |
|  500626 | 11661 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed` |
...
|       - | 11668 | `			*/` |
|  500631 | 11669 | `			return aLangConstruct[n].xConstruct;` |
|       - | 11670 | `		}` |
| 5966363 | 11671 | `		n++;` |
|       5 | 11672 | `	}` |
|  136291 | 11673 | `	if( pLookahed ){` |
|  136291 | 11674 | `		if(nKeywordID == PH7_TKWRD_INTERFACE && (pLookahed->nType & PH7_TK_ID) ){` |
|   39069 | 11675 | `			return PH7_CompileClassInterface;` |
|   97227 | 11676 | `		}else if(nKeywordID == PH7_TKWRD_CLASS && (pLookahed->nType & PH7_TK_ID) ){` |
|   96879 | 11677 | `			return PH7_CompileClass;` |
...
|       - | 11715 | ` */` |
|  761720 | 11716 | `static sxi32 GenStateCompileChunk(` |
...
|       - | 11722 | `	sxi32 rc;` |
|  761725 | 11723 | `	rc = SXRET_OK; /* Prevent compiler warning */` |
|  595894 | 11724 | `	for(;;){` |
|  976759 | 11725 | `		int bStmtIsDeclare = 0;` |
|  976759 | 11726 | `		if( pGen->pIn >= pGen->pEnd ){` |
...
|  962509 | 11732 | `		if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|  640493 | 11733 | `			sxu32 nPeek = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  640493 | 11734 | `			if( nPeek == PH7_TKWRD_DECLARE ){` |
|      45 | 11735 | `				bStmtIsDeclare = 1;` |
|      20 | 11736 | `			}` |
|  320244 | 11737 | `		}` |
|  962509 | 11738 | `		if( !bStmtIsDeclare && pGen->pCurrent == &pGen->sGlobal ){` |
...
|  215009 | 11741 | `			pGen->bStrictTypesLocked = 1;` |
|  107502 | 11742 | `		}` |
|  962509 | 11743 | `		if( pGen->pIn->nType & PH7_TK_OCB /* '{' */ ){` |
|       - | 11744 | `			/* Compile block */` |
|      21 | 11745 | `			rc = PH7_CompileBlock(&(*pGen),0);` |
|      21 | 11746 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 | 11747 | `				break;` |
|       - | 11748 | `			}` |
|      13 | 11749 | `		}else{` |
|  962493 | 11750 | `			xCons = 0;` |
|  962493 | 11751 | `			if( GenStateStartsModifiedClass(pGen->pIn,pGen->pEnd) ){` |
...
|    3607 | 11755 | `				xCons = PH7_CompileClassModifiers;` |
|  960692 | 11756 | `			}else if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|  636917 | 11757 | `				sxu32 nKeyword = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|       - | 11758 | `				/* Try to extract a language construct handler */` |
|  636917 | 11759 | `				xCons = GenStateGetStatementHandler(nKeyword,(&pGen->pIn[1] < pGen->pEnd) ? &pGen->pIn[1] : 0);` |
|  636917 | 11760 | `				if( xCons == 0 && GenStateisLangConstruct(nKeyword) == FALSE ){` |
...
|       4 | 11771 | `				}` |
|  640435 | 11772 | `			}else if( (pGen->pIn->nType & PH7_TK_ID) && (&pGen->pIn[1] < pGen->pEnd)` |
|   52741 | 11773 | `				&& (pGen->pIn[1].nType & PH7_TK_COLON /*':'*/) ){` |
|       - | 11774 | `				/* Label found [i.e: Out: ],point to the routine responsible of compiling it */` |
|     117 | 11775 | `				xCons = PH7_CompileLabel;` |
|      56 | 11776 | `			}` |
|  962493 | 11777 | `			if( xCons == 0 ){` |
|       - | 11778 | `				/* Assume an expression an try to compile it */` |
|  322143 | 11779 | `				rc = PH7_CompileExpr(&(*pGen),0,0);` |
|  322143 | 11780 | `				if(  rc != SXERR_EMPTY ){` |
|       - | 11781 | `					/* Pop l-value */` |
|  321993 | 11782 | `					PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|  160994 | 11783 | `				}` |
|  161074 | 11784 | `			}else{` |
|       - | 11785 | `				/* Go compile the sucker */` |
|  640355 | 11786 | `				rc = xCons(&(*pGen));` |
|       - | 11787 | `			}` |
|  962493 | 11788 | `			if( rc == SXERR_ABORT ){` |
|       - | 11789 | `				/* Request to abort compilation */` |
|      12 | 11790 | `				break;` |
|       - | 11791 | `			}` |
|       - | 11792 | `		}` |
|       - | 11793 | `		/* Ignore trailing semi-colons ';' */` |
| 1556335 | 11794 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|  593841 | 11795 | `			pGen->pIn++;` |
|       5 | 11796 | `		}` |
|  962499 | 11797 | `		if( iFlags & PH7_COMPILE_SINGLE_STMT ){` |
...
|       - | 11813 | ` */` |
|   14262 | 11814 | `static sxi32 PH7_CompilePHP(` |
...
|       - | 11818 | `	)` |
|       5 | 11819 |  |
|   14267 | 11820 | `	SyToken *pScript = pGen->pRawIn; /* Script to compile */` |
|       - | 11821 | `	sxi32 rc;` |
|       - | 11822 | `	/* Reset the token set */` |
|   14267 | 11823 | `	SySetReset(&(*pTokenSet));` |
|       - | 11824 | `	/* Mark as the default token set */` |
|   14267 | 11825 | `	pGen->pTokenSet = &(*pTokenSet);` |
|       - | 11826 | `	/* Advance the stream cursor */` |
|   14267 | 11827 | `	pGen->pRawIn++;` |
|       - | 11828 | `	/* Tokenize the PHP chunk first */` |
|   14267 | 11829 | `	PH7_TokenizePHP(SyStringData(&pScript->sData),SyStringLength(&pScript->sData),pScript->nLine,&(*pTokenSet));` |
|       - | 11830 | `	/* Point to the head and tail of the token stream. */` |
|   14267 | 11831 | `	pGen->pIn  = (SyToken *)SySetBasePtr(pTokenSet);` |
|   14267 | 11832 | `	pGen->pEnd = &pGen->pIn[SySetUsed(pTokenSet)];` |
|   14267 | 11833 | `	if( is_expr ){` |
...
|       - | 11842 | `	}` |
|   14267 | 11843 | `	if( pGen->pIn < pGen->pEnd && ( pGen->pIn->nType & PH7_TK_EQUAL ) ){` |
...
|   14265 | 11868 | `	rc = GenStateCompileChunk(pGen,0);` |
|       - | 11869 | `	/* Fix exceptions jumps */` |
|   14265 | 11870 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|       - | 11871 | `	/* Fix gotos now, the jump destination is resolved */` |
|   14265 | 11872 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),0) ){` |
|       3 | 11873 | `		rc = SXERR_ABORT;` |
|       1 | 11874 | `	}` |
|       - | 11875 | `	/* Reset container */` |
|   14265 | 11876 | `	SySetReset(&pGen->aGoto);` |
|   14265 | 11877 | `	SySetReset(&pGen->aLabel);` |
|   14265 | 11878 | `	SySetReset(&pGen->aNullsafeJmp);` |
|       - | 11879 | `	/* Compilation result */` |
|   14265 | 11880 | `	return rc;` |
|    7136 | 11881 |  |
|       - | 11882 | `/*` |
...
|       - | 11886 | ` */` |
|   17224 | 11887 | `PH7_PRIVATE sxi32 PH7_CompileScript(` |
...
|       - | 11901 | `	sxi32 rc;` |
|   17229 | 11902 | `	if( pScript->nByte < 1 ){` |
...
|   17229 | 11908 | `	pCodeGen = &pVm->sCodeGen;` |
|   17229 | 11909 | `	bSavedStrict = pCodeGen->bStrictTypes;` |
|   17229 | 11910 | `	bSavedStrictLocked = pCodeGen->bStrictTypesLocked;` |
|   17229 | 11911 | `	pCodeGen->bStrictTypes = 0;` |
|   17229 | 11912 | `	pCodeGen->bStrictTypesLocked = 0;` |
|       - | 11913 | `	/* Initialize the tokens containers */` |
|   17229 | 11914 | `	SySetInit(&aRawToken,&pVm->sAllocator,sizeof(SyToken));` |
|   17229 | 11915 | `	SySetInit(&aPhpToken,&pVm->sAllocator,sizeof(SyToken));` |
|   17229 | 11916 | `	SySetAlloc(&aPhpToken,0xc0);` |
|   17229 | 11917 | `	is_expr = 0;` |
|   17229 | 11918 | `	if( iFlags & PH7_PHP_ONLY ){` |
|       - | 11919 | `		SyToken sTmp;` |
|       - | 11920 | `		/* PHP only: -*/` |
|    3617 | 11921 | `		sTmp.nLine = 1;` |
|    3617 | 11922 | `		sTmp.nType = PH7_TOKEN_PHP;` |
|    3617 | 11923 | `		sTmp.pUserData = 0;` |
|    3617 | 11924 | `		SyStringDupPtr(&sTmp.sData,pScript);` |
|    3617 | 11925 | `		SySetPut(&aRawToken,(const void *)&sTmp);` |
|    3617 | 11926 | `		if( iFlags & PH7_PHP_EXPR ){` |
|       - | 11927 | `			/* A simple PHP expression */` |
|     ! 0 | 11928 | `			is_expr = 1;` |
|     ! 0 | 11929 | `		}` |
|    1811 | 11930 | `	}else{` |
|       - | 11931 | `		/* Tokenize raw text */` |
|   13617 | 11932 | `		SySetAlloc(&aRawToken,32);` |
|   13617 | 11933 | `		PH7_TokenizeRawText(pScript->zString,pScript->nByte,&aRawToken);` |
|       - | 11934 | `	}` |
|       - | 11935 | `	/* Process high-level tokens */` |
|   17229 | 11936 | `	pCodeGen->pRawIn = (SyToken *)SySetBasePtr(&aRawToken);` |
|   17229 | 11937 | `	pCodeGen->pRawEnd = &pCodeGen->pRawIn[SySetUsed(&aRawToken)];` |
|   17229 | 11938 | `	rc = PH7_OK;` |
|   17229 | 11939 | `	if( is_expr ){` |
|       - | 11940 | `		/* Compile the expression */` |
|     ! 0 | 11941 | `		rc = PH7_CompilePHP(pCodeGen,&aPhpToken,TRUE);` |
|     ! 0 | 11942 | `		goto cleanup;` |
|       - | 11943 | `	}` |
|   17229 | 11944 | `	nObjIdx = 0;` |
...
|   17229 | 11948 | `	PH7_VmEmitInstr(pVm,PH7_OP_NSSWITCH,0,0,0,0);` |
|       - | 11949 | `	/* Start the compilation process */` |
|   15424 | 11950 | `	for(;;){` |
|   45103 | 11951 | `		if( pCodeGen->pRawIn >= pCodeGen->pRawEnd ){` |
|   17217 | 11952 | `			break; /* No more tokens to process */` |
|       - | 11953 | `		}` |
|   27891 | 11954 | `		if( pCodeGen->pRawIn->nType & PH7_TOKEN_PHP ){` |
|       - | 11955 | `			/* Compile the PHP chunk */` |
|   14267 | 11956 | `			rc = PH7_CompilePHP(pCodeGen,&aPhpToken,FALSE);` |
|   14267 | 11957 | `			if( rc == SXERR_ABORT ){` |
|      15 | 11958 | `				break;` |
|       - | 11959 | `			}` |
|   14255 | 11960 | `			continue;` |
|       - | 11961 | `		}` |
|       - | 11962 | `		/* Raw chunk: [i.e: HTML, XML, etc.] */` |
|   13629 | 11963 | `		nRawObj = 0;` |
|   27295 | 11964 | `		while( (pCodeGen->pRawIn < pCodeGen->pRawEnd) && (pCodeGen->pRawIn->nType != PH7_TOKEN_PHP) ){` |
|       - | 11965 | `			/* Consume the raw chunk without any processing */` |
|   13671 | 11966 | `			pRawObj = PH7_ReserveConstObj(&(*pVm),&nObjIdx);` |
|   13671 | 11967 | `			if( pRawObj == 0 ){` |
|     ! 0 | 11968 | `				rc = SXERR_MEM;` |
|     ! 0 | 11969 | `				break;` |
|       - | 11970 | `			}` |
|       - | 11971 | `			/* Mark as constant and emit the load constant instruction */` |
|   13671 | 11972 | `			PH7_MemObjInitFromString(pVm,pRawObj,&pCodeGen->pRawIn->sData);` |
|   13671 | 11973 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_LOADC,0,nObjIdx,0,0);` |
|   13671 | 11974 | `			++nRawObj;` |
|   13671 | 11975 | `			pCodeGen->pRawIn++; /* Next chunk */` |
|       5 | 11976 | `		}` |
|   13629 | 11977 | `		if( nRawObj > 0 ){` |
|       - | 11978 | `			/* Emit the consume instruction */` |
|   13629 | 11979 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_CONSUME,nRawObj,0,0,0);` |
|    6812 | 11980 | `		}` |
|    8617 | 11981 | `	}` |
|    8612 | 11982 | `cleanup:` |
|   17229 | 11983 | `	SySetRelease(&aRawToken);` |
|   17229 | 11984 | `	SySetRelease(&aPhpToken);` |
|       - | 11985 | `	/* Restore outer file's strict_types scope */` |
|   17229 | 11986 | `	pCodeGen->bStrictTypes = bSavedStrict;` |
|   17229 | 11987 | `	pCodeGen->bStrictTypesLocked = bSavedStrictLocked;` |
|   17229 | 11988 | `	return rc;` |
|    8617 | 11989 |  |
|       - | 11990 | `/*` |
|       - | 11991 | ` * Utility routines.Initialize the code generator.` |
|       - | 11992 | ` */` |
|    3544 | 11993 | `PH7_PRIVATE sxi32 PH7_InitCodeGenerator(` |
|       - | 11994 | `	ph7_vm *pVm,       /* Target VM */` |
|       - | 11995 | `	ProcConsumer xErr, /* Error log consumer callabck  */` |
|       - | 11996 | `	void *pErrData     /* Last argument to xErr() */` |
|       - | 11997 | `	)` |
|       5 | 11998 |  |
|    3549 | 11999 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|       - | 12000 | `	/* Zero the structure */` |
|    3549 | 12001 | `	SyZero(pGen,sizeof(ph7_gen_state));` |
|       - | 12002 | `	/* Initial state */` |
|    3549 | 12003 | `	pGen->pVm  = &(*pVm);` |
|    3549 | 12004 | `	pGen->xErr = xErr;` |
|    3549 | 12005 | `	pGen->pErrData = pErrData;` |
|    3549 | 12006 | `	SySetInit(&pGen->aLabel,&pVm->sAllocator,sizeof(Label));` |
|    3549 | 12007 | `	SySetInit(&pGen->aGoto,&pVm->sAllocator,sizeof(JumpFixup));` |
|    3549 | 12008 | `	SySetInit(&pGen->aNullsafeJmp,&pVm->sAllocator,sizeof(sxu32));` |
|    3549 | 12009 | `	SyHashInit(&pGen->hLiteral,&pVm->sAllocator,0,0);` |
|    3549 | 12010 | `	SyHashInit(&pGen->hVar,&pVm->sAllocator,0,0);` |
|       - | 12011 | `	/* Error log buffer */` |
|    3549 | 12012 | `	SyBlobInit(&pGen->sErrBuf,&pVm->sAllocator);` |
|       - | 12013 | `	/* General purpose working buffer */` |
|    3549 | 12014 | `	SyBlobInit(&pGen->sWorker,&pVm->sAllocator);` |
|       - | 12015 | `	/* Namespace state */` |
|    3549 | 12016 | `	SyBlobInit(&pGen->sNamespace,&pVm->sAllocator);` |
|    3549 | 12017 | `	SyHashInit(&pGen->hUseImports,&pVm->sAllocator,0,0);` |
|    3549 | 12018 | `	SyHashInit(&pGen->hUseFuncImports,&pVm->sAllocator,0,0);` |
|    3549 | 12019 | `	SyHashInit(&pGen->hUseConstImports,&pVm->sAllocator,0,0);` |
|       - | 12020 | `	/* Create the global scope */` |
|    3549 | 12021 | `	GenStateInitBlock(pGen,&pGen->sGlobal,GEN_BLOCK_GLOBAL,PH7_VmInstrLength(&(*pVm)),0);` |
|       - | 12022 | `	/* Point to the global scope */` |
|    3549 | 12023 | `	pGen->pCurrent = &pGen->sGlobal;` |
|    3549 | 12024 | `	return SXRET_OK;` |
|       5 | 12025 |  |
|       - | 12026 | `/*` |
|       - | 12027 | ` * Utility routines. Reset the code generator to it's initial state.` |
|       - | 12028 | ` */` |
|   20422 | 12029 | `PH7_PRIVATE sxi32 PH7_ResetCodeGenerator(` |
|       - | 12030 | `	ph7_vm *pVm,       /* Target VM */` |
|       - | 12031 | `	ProcConsumer xErr, /* Error log consumer callabck  */` |
|       - | 12032 | `	void *pErrData     /* Last argument to xErr() */` |
|       - | 12033 | `	)` |
|       5 | 12034 |  |
|   20427 | 12035 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|       - | 12036 | `	GenBlock *pBlock,*pParent;` |
|       - | 12037 | `	/* Reset state */` |
|   20427 | 12038 | `	SySetReset(&pGen->aLabel);` |
|   20427 | 12039 | `	SySetReset(&pGen->aGoto);` |
|   20427 | 12040 | `	SySetReset(&pGen->aNullsafeJmp);` |
|   20427 | 12041 | `	SyBlobRelease(&pGen->sErrBuf);` |
|   20427 | 12042 | `	SyBlobRelease(&pGen->sWorker);` |
|   20427 | 12043 | `	SyBlobRelease(&pGen->sNamespace);` |
|   20427 | 12044 | `	SyBlobInit(&pGen->sNamespace,&pVm->sAllocator);` |
|   20427 | 12045 | `	SyHashRelease(&pGen->hUseImports);` |
|   20427 | 12046 | `	SyHashInit(&pGen->hUseImports,&pVm->sAllocator,0,0);` |
|   20427 | 12047 | `	SyHashRelease(&pGen->hUseFuncImports);` |
|   20427 | 12048 | `	SyHashInit(&pGen->hUseFuncImports,&pVm->sAllocator,0,0);` |
|   20427 | 12049 | `	SyHashRelease(&pGen->hUseConstImports);` |
|   20427 | 12050 | `	SyHashInit(&pGen->hUseConstImports,&pVm->sAllocator,0,0);` |
...
|   20427 | 12058 | `	pBlock = pGen->pCurrent;` |
|   20427 | 12059 | `	while( pBlock->pParent != 0 ){` |
|     ! 0 | 12060 | `		pParent = pBlock->pParent;` |
|     ! 0 | 12061 | `		GenStateFreeBlock(pBlock);` |
|     ! 0 | 12062 | `		pBlock = pParent;` |
|     ! 0 | 12063 | `	}` |
|   20427 | 12064 | `	pGen->xErr = xErr;` |
|   20427 | 12065 | `	pGen->pErrData = pErrData;` |
|   20427 | 12066 | `	pGen->pCurrent = &pGen->sGlobal;` |
|   20427 | 12067 | `	pGen->pRawIn = pGen->pRawEnd = 0;` |
|   20427 | 12068 | `	pGen->pIn = pGen->pEnd = 0;` |
|   20427 | 12069 | `	pGen->nErr = 0;` |
|   20427 | 12070 | `	return SXRET_OK;` |
|       5 | 12071 |  |
|       - | 12072 | `/*` |
...
|      30 | 12115 | `	case E_WARNING: zErr = "Warning";     break;` |
