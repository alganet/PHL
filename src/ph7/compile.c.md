...
|         - |   162 | ` */` |
|  12331258 |   163 | `static void GenStateInitBlock(` |
...
|  12331263 |   172 | `	pBlock->nFirstInstr = nFirstInstr;` |
|  12331263 |   173 | `	pBlock->pUserData   = pUserData;` |
|  12331263 |   174 | `	pBlock->pGen        = pGen;` |
|  12331263 |   175 | `	pBlock->iFlags      = iType;` |
|  12331263 |   176 | `	pBlock->pParent     = 0;` |
|  12331263 |   177 | `	SySetInit(&pBlock->aJumpFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  12331263 |   178 | `	SySetInit(&pBlock->aPostContFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  12331263 |   179 | `}` |
|         - |   180 | `/*` |
...
|         - |   185 | ` */` |
|  12327366 |   186 | `static sxi32 GenStateEnterBlock(` |
...
|  12327371 |   196 | `	pBlock = (GenBlock *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(GenBlock));` |
|  12327371 |   197 | `	if( pBlock == 0 ){` |
...
|  12327371 |   206 | `	SyZero(pBlock,sizeof(GenBlock));` |
|  12327371 |   207 | `	GenStateInitBlock(&(*pGen),pBlock,iType,nFirstInstr,pUserData);` |
|         - |   208 | `	/* Link to the parent block */` |
|  12327371 |   209 | `	pBlock->pParent = pGen->pCurrent;` |
...
|  12327371 |   212 | `	if( iType & (GEN_BLOCK_LOOP\|GEN_BLOCK_SWITCH) ){` |
...
|  12327371 |   221 | `	pGen->pCurrent = pBlock;` |
|  12327371 |   222 | `	if( ppBlock ){` |
|         - |   223 | `		/* Write a pointer to the new instance */` |
|   5909599 |   224 | `		*ppBlock = pBlock;` |
|   2954797 |   225 | `	}` |
|  12327371 |   226 | `	return SXRET_OK;` |
|   6163688 |   227 | `}` |
|         - |   228 | `/*` |
|         - |   229 | ` * Release block fields without freeing the whole instance.` |
|         - |   230 | ` */` |
|  12327354 |   231 | `static void GenStateReleaseBlock(GenBlock *pBlock)` |
|         5 |   232 | `{` |
|  12327359 |   233 | `	SySetRelease(&pBlock->aPostContFix);` |
|  12327359 |   234 | `	SySetRelease(&pBlock->aJumpFix);` |
|  12327359 |   235 | `}` |
|         - |   236 | `/*` |
|         - |   237 | ` * Release a block.` |
|         - |   238 | ` */` |
|  12327350 |   239 | `static void GenStateFreeBlock(GenBlock *pBlock)` |
|         5 |   240 | `{` |
|  12327355 |   241 | `	ph7_gen_state *pGen = pBlock->pGen;` |
|  12327355 |   242 | `	GenStateReleaseBlock(&(*pBlock));` |
|         - |   243 | `	/* Free the instance */` |
|  12327355 |   244 | `	SyMemBackendPoolFree(&pGen->pVm->sAllocator,pBlock);` |
|  12327355 |   245 | `}` |
|         - |   246 | `/*` |
|         - |   247 | ` * POP and release a block from the stack of compiled blocks.` |
|         - |   248 | ` */` |
|  12327350 |   249 | `static sxi32 GenStateLeaveBlock(ph7_gen_state *pGen,GenBlock **ppBlock)` |
|         5 |   250 | `{` |
|  12327355 |   251 | `	GenBlock *pBlock = pGen->pCurrent;` |
|  12327355 |   252 | `	if( pBlock == 0 ){` |
|         - |   253 | `		/* No more block to pop */` |
|       ! 0 |   254 | `		return SXERR_EMPTY;` |
|         - |   255 | `	}` |
|  12327355 |   256 | `	if( pBlock->iFlags & (GEN_BLOCK_LOOP\|GEN_BLOCK_SWITCH) ){` |
|    525987 |   257 | `		pGen->nCurLoopId = pBlock->nOuterLoopId;` |
|    262991 |   258 | `	}` |
|         - |   259 | `	/* Point to the upper block */` |
|  12327355 |   260 | `	pGen->pCurrent = pBlock->pParent;` |
|  12327355 |   261 | `	if( ppBlock ){` |
|         - |   262 | `		/* Write a pointer to the popped block */` |
|       ! 0 |   263 | `		*ppBlock = pBlock;` |
|       ! 0 |   264 | `	}else{` |
|         - |   265 | `		/* Safely release the block */` |
|  12327355 |   266 | `		GenStateFreeBlock(&(*pBlock));` |
|         - |   267 | `	}` |
|  12327355 |   268 | `	return SXRET_OK;` |
|   6163680 |   269 | `}` |
|         - |   270 | `/*` |
...
|         - |   301 | ` */` |
|   8593192 |   302 | `static sxu32 GenStateFixJumps(GenBlock *pBlock,sxi32 nJumpType,sxu32 nJumpDest)` |
|         5 |   303 | `{` |
|         - |   304 | `	JumpFixup *aFix;` |
|         - |   305 | `	VmInstr *pInstr;` |
|         - |   306 | `	sxu32 nFixed;` |
...
|   8593197 |   309 | `	aFix = (JumpFixup *)SySetBasePtr(&pBlock->aJumpFix);` |
|         - |   310 | `	/* Fix the desired jumps */` |
|  18281783 |   311 | `	for( nFixed = n = 0 ; n < SySetUsed(&pBlock->aJumpFix) ; ++n ){` |
|   9688591 |   312 | `		if( aFix[n].nJumpType < 0 ){` |
|         - |   313 | `			/* Already fixed */` |
|   3615759 |   314 | `			continue;` |
|         - |   315 | `		}` |
...
|         - |   338 | ` */` |
|   3082038 |   339 | `static sxi32 GenStateFixGoto(ph7_gen_state *pGen,sxu32 nOfft)` |
|         5 |   340 | `{` |
...
|   3082043 |   347 | `	aJumps = (JumpFixup *)SySetBasePtr(&pGen->aGoto);` |
|         - |   348 | `	/* Fix */` |
|   3082189 |   349 | `	for( n = nOfft ; n < SySetUsed(&pGen->aGoto) ; ++n ){` |
...
|   3082041 |   400 | `	return SXRET_OK;` |
|   1541024 |   401 | `}` |
|         - |   402 | `/*` |
|         - |   403 | ` * Check if a given token value is installed in the literal table.` |
|         - |   404 | ` */` |
|  15598604 |   405 | `static sxi32 GenStateFindLiteral(ph7_gen_state *pGen,const SyString *pValue,sxu32 *pIdx)` |
|         5 |   406 | `{` |
|         - |   407 | `	SyHashEntry *pEntry;` |
|  15598609 |   408 | `	pEntry = SyHashGet(&pGen->hLiteral,(const void *)pValue->zString,pValue->nByte);` |
|  15598609 |   409 | `	if( pEntry == 0 ){` |
|   4000375 |   410 | `		return SXERR_NOTFOUND;` |
|         - |   411 | `	}` |
|  11598239 |   412 | `	*pIdx = (sxu32)SX_PTR_TO_INT(pEntry->pUserData);` |
|  11598239 |   413 | `	return SXRET_OK;` |
|   7799307 |   414 | `}` |
|         - |   415 | `/*` |
...
|         - |   424 | ` */` |
|   4000370 |   425 | `static sxi32 GenStateInstallLiteral(ph7_gen_state *pGen,ph7_value *pObj,sxu32 nIdx)` |
|         5 |   426 | `{` |
|   4000375 |   427 | `	if( SyBlobLength(&pObj->sBlob) > 0 ){` |
|   4000375 |   428 | `		SyHashInsert(&pGen->hLiteral,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob),SX_INT_TO_PTR(nIdx));` |
|   2000185 |   429 | `	}` |
|   4000375 |   430 | `	return SXRET_OK;` |
|         5 |   431 | `}` |
|         - |   432 | `/*` |
|         - |   433 | ` * Reserve a room for a numeric constant [i.e: 64-bit integer or real number]` |
|         - |   434 | ` * in the constant table.` |
|         - |   435 | ` */` |
|   3765938 |   436 | `static ph7_value * GenStateInstallNumLiteral(ph7_gen_state *pGen,sxu32 *pIdx)` |
|         5 |   437 | `{` |
|         - |   438 | `	ph7_value *pObj;` |
|   3765943 |   439 | `	sxu32 nIdx = 0; /* cc warning */` |
|         - |   440 | `	/* Reserve a new constant */` |
|   3765943 |   441 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   3765943 |   442 | `	if( pObj == 0 ){` |
|       ! 0 |   443 | `		PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|       ! 0 |   444 | `		return 0;` |
|         - |   445 | `	}` |
|   3765943 |   446 | `	*pIdx = nIdx;` |
|         - |   447 | `	/* TODO(chems): Create a numeric table (64bit int keys) same as` |
|         - |   448 | `	 * the constant string iterals table [optimization purposes].` |
|         - |   449 | `	 */` |
|   3765943 |   450 | `	return pObj;` |
|   1882974 |   451 | `}` |
|         - |   452 | `/*` |
...
|         - |   465 | ` */` |
|   7394738 |   466 | `static void *GenStateAttachStrictFlag(ph7_gen_state *pGen, void *p3)` |
|         5 |   467 | `{` |
|         - |   468 | `	VmCallArgMap *pMap;` |
|   7394743 |   469 | `	if( !pGen->bStrictTypes ) return p3;` |
|        39 |   470 | `	if( p3 == 0 ){` |
...
|         - |   541 | ` */` |
|   3774754 |   542 | `static int GenStateFindBadNumericSeparator(` |
|         - |   543 | `	const SyString *pRaw, const char **pBadStart, sxu32 *pBadLen)` |
|         5 |   544 | `{` |
|   3774759 |   545 | `	const char *z = pRaw->zString;` |
|   3774759 |   546 | `	sxu32 n = pRaw->nByte;` |
|   3774759 |   547 | `	int base = 10;` |
|         - |   548 | `	sxu32 i, start;` |
|   3774759 |   549 | `	if( n < 2 ) return 0;` |
|    807475 |   550 | `	if( z[0] == '0' && (z[1] == 'x' \|\| z[1] == 'X') ){` |
|    105073 |   551 | `		base = 16;` |
|    754941 |   552 | `	}else if( z[0] == '0' && (z[1] == 'b' \|\| z[1] == 'B') ){` |
|       286 |   553 | `		base = 2;` |
|       142 |   554 | `	}` |
|   3074849 |   555 | `	for( i = 0; i < n; ++i ){` |
|   2267393 |   556 | `		if( z[i] != '_' ) continue;` |
...
|         - |   582 | ` */` |
|   3774754 |   583 | `static sxi32 GenStateValidateNumericSeparator(ph7_gen_state *pGen, SyToken *pToken)` |
|         5 |   584 | `{` |
|   3774759 |   585 | `	const char *zBad = 0;` |
|   3774759 |   586 | `	sxu32 nBad = 0;` |
|         - |   587 | `	SyString sBad;` |
|         - |   588 | `	sxi32 rc;` |
|   3774759 |   589 | `	if( !GenStateFindBadNumericSeparator(&pToken->sData, &zBad, &nBad) ){` |
|   3774745 |   590 | `		return SXRET_OK;` |
|         - |   591 | `	}` |
...
|         - |   615 | ` */` |
|   3774740 |   616 | `static sxi32 GenStateStripNumericSeparators(` |
...
|         5 |   621 | `{` |
|         - |   622 | `	sxu32 i, j;` |
|   3774745 |   623 | `	int hasUnderscore = 0;` |
|         - |   624 | `	char *zBuf;` |
|   3774745 |   625 | `	*pzAlloc = 0;` |
|   9007327 |   626 | `	for( i = 0; i < pToken->nByte; ++i ){` |
|   5232841 |   627 | `		if( pToken->zString[i] == '_' ){ hasUnderscore = 1; break; }` |
|   2616296 |   628 | `	}` |
|   3774745 |   629 | `	if( !hasUnderscore ){` |
|   3774491 |   630 | `		SyStringDupPtr(pOut, pToken);` |
|   3774491 |   631 | `		return SXRET_OK;` |
|         - |   632 | `	}` |
...
|         - |   683 | ` */` |
|   3765972 |   684 | `static int GenStateIntLiteralOverflows(const SyString *pNum, ph7_real *pReal, int *pbDecimal)` |
|         5 |   685 | `{` |
|   3765977 |   686 | `	const char *z = pNum->zString;` |
|   3765977 |   687 | `	const char *zEnd = z + pNum->nByte;` |
|         - |   688 | `	const char *p, *q;` |
|         - |   689 | `	int n;` |
|   3765977 |   690 | `	*pbDecimal = FALSE;` |
|   3765977 |   691 | `	if( z >= zEnd ){` |
|       ! 0 |   692 | `		return FALSE;` |
|         - |   693 | `	}` |
|   3765977 |   694 | `	if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'x' \|\| z[1] == 'X') ){` |
...
|         - |   707 | `		}` |
|         7 |   708 | `		return TRUE;` |
|   3660911 |   709 | `	}else if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'b' \|\| z[1] == 'B') ){` |
...
|         - |   722 | `		}` |
|         3 |   723 | `		return TRUE;` |
|   3660629 |   724 | `	}else if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'o' \|\| z[1] == 'O') ){` |
...
|   2293499 |   760 | `	p = z;` |
|   2293499 |   761 | `	while( p < zEnd && p[0] == '0' ){ p++; }` |
|   5557203 |   762 | `	for( q = p, n = 0; q < zEnd && (unsigned char)q[0] < 0xc0 && SyisDigit(q[0]); q++ ){ n++; }` |
|   2293499 |   763 | `	if( n > 19 \|\| (n == 19 && SyMemcmp(p, "9223372036854775807", 19) > 0) ){` |
|        25 |   764 | `		*pbDecimal = TRUE;` |
|        25 |   765 | `		return TRUE;` |
|         - |   766 | `	}` |
|   2293475 |   767 | `	return FALSE;` |
|   1882991 |   768 | `}` |
|   3774726 |   769 | `static sxi32 PH7_CompileNumLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|         5 |   770 | `{` |
|   3774731 |   771 | `	SyToken *pToken = pGen->pIn; /* Raw token */` |
|   3774731 |   772 | `	sxu32 nIdx = 0;` |
|         - |   773 | `	char zScratch[GEN_NUM_SCRATCH];` |
|   3774731 |   774 | `	char *zAlloc = 0;` |
|         - |   775 | `	SyString sNum;` |
|         - |   776 | `	sxi32 rc;` |
|   1887363 |   777 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|   3774731 |   778 | `	rc = GenStateValidateNumericSeparator(pGen, pToken);` |
|   3774731 |   779 | `	if( rc != SXRET_OK ){` |
|        14 |   780 | `		return rc;` |
|         - |   781 | `	}` |
|   5662079 |   782 | `	rc = GenStateStripNumericSeparators(&pGen->pVm->sAllocator, &pToken->sData,` |
|   1887358 |   783 | `		zScratch, sizeof(zScratch), &sNum, &zAlloc);` |
|   3774721 |   784 | `	if( rc != SXRET_OK ){` |
|       ! 0 |   785 | `		return SXERR_ABORT;` |
|         - |   786 | `	}` |
|   3774721 |   787 | `	if( pToken->nType & PH7_TK_INTEGER ){` |
|         - |   788 | `		ph7_value *pObj;` |
|         - |   789 | `		sxi64 iValue;` |
|   3765977 |   790 | `		ph7_real rOverflow = 0;` |
|   3765977 |   791 | `		int bDecimalOverflow = 0;` |
|   3765977 |   792 | `		if( GenStateIntLiteralOverflows(&sNum,&rOverflow,&bDecimalOverflow) ){` |
...
|         - |   807 | `			}` |
|        18 |   808 | `		}else{` |
|   3765943 |   809 | `			iValue = PH7_TokenValueToInt64(&sNum);` |
|   3765943 |   810 | `			pObj = GenStateInstallNumLiteral(&(*pGen),&nIdx);` |
|   3765943 |   811 | `			if( pObj == 0 ){` |
|       ! 0 |   812 | `				if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|       ! 0 |   813 | `				return SXERR_ABORT;` |
|         - |   814 | `			}` |
|   3765943 |   815 | `			PH7_MemObjInitFromInt(pGen->pVm,pObj,iValue);` |
|         - |   816 | `		}` |
|   1882991 |   817 | `	}else{` |
|         - |   818 | `		/* Real number */` |
|         - |   819 | `		ph7_value *pObj;` |
...
|         - |   829 | `	}` |
|   3774721 |   830 | `	if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|         - |   831 | `	/* Emit the load constant instruction */` |
|   3774721 |   832 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|         - |   833 | `	/* Node successfully compiled */` |
|   3774721 |   834 | `	return SXRET_OK;` |
|   1887368 |   835 | `}` |
|         - |   836 | `/*` |
...
|         - |   845 | ` *` |
|         - |   846 | ` */` |
|   5301254 |   847 | `PH7_PRIVATE sxi32 PH7_CompileSimpleString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|         5 |   848 | `{` |
|   5301259 |   849 | `	SyString *pStr = &pGen->pIn->sData; /* Constant string literal */` |
|         - |   850 | `	const char *zIn,*zCur,*zEnd;` |
|         - |   851 | `	ph7_value *pObj;` |
|         - |   852 | `	sxu32 nIdx;` |
|         - |   853 | `	sxi32 bHasEsc;` |
|   5301259 |   854 | `	nIdx = 0; /* Prevent compiler warning */` |
|         - |   855 | `	/* Delimit the string */` |
|   5301259 |   856 | `	zIn  = pStr->zString;` |
|   5301259 |   857 | `	zEnd = &zIn[pStr->nByte];` |
|   5301259 |   858 | `	if( zIn >= zEnd ){` |
...
|   4916125 |   871 | `	bHasEsc = 0;` |
|         - |   872 | `	{` |
|         - |   873 | `		const char *zScan;` |
|  58716169 |   874 | `		for( zScan = zIn ; zScan < zEnd ; zScan++ ){` |
|  53881883 |   875 | `			if( zScan[0] == '\\' ){ bHasEsc = 1; break; }` |
|  26900027 |   876 | `		}` |
|         - |   877 | `	}` |
|   4916125 |   878 | `	if( !bHasEsc && SXRET_OK == GenStateFindLiteral(&(*pGen),pStr,&nIdx) ){` |
|         - |   879 | `		/* Already processed,emit the load constant instruction` |
|         - |   880 | `		 * and return.` |
|         - |   881 | `		 */` |
|   2920871 |   882 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   2920871 |   883 | `		return SXRET_OK;` |
|         - |   884 | `	}` |
...
|         - |  1099 | ` */` |
|      2662 |  1100 | `static sxi32 GenStateProcessStringExpression(` |
...
|      2667 |  1111 | `	SySetInit(&sToken,&pGen->pVm->sAllocator,sizeof(SyToken));` |
|         - |  1112 | `	/* Preallocate some slots */` |
|      2667 |  1113 | `	SySetAlloc(&sToken,0x08);` |
|         - |  1114 | `	/* Tokenize the text */` |
|      2667 |  1115 | `	PH7_TokenizePHP(zIn,(sxu32)(zEnd-zIn),nLine,&sToken,0);` |
|         - |  1116 | `	/* Swap delimiter */` |
|      2667 |  1117 | `	pTmpIn  = pGen->pIn;` |
|      2667 |  1118 | `	pTmpEnd = pGen->pEnd;` |
|      2667 |  1119 | `	pGen->pIn = (SyToken *)SySetBasePtr(&sToken);` |
|      2667 |  1120 | `	pGen->pEnd = &pGen->pIn[SySetUsed(&sToken)];` |
|         - |  1121 | `	/* Compile the expression */` |
|      2667 |  1122 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|         - |  1123 | `	/* Restore token stream */` |
|      2667 |  1124 | `	pGen->pIn  = pTmpIn;` |
|      2667 |  1125 | `	pGen->pEnd = pTmpEnd;` |
|         - |  1126 | `	/* Release the token set */` |
|      2667 |  1127 | `	SySetRelease(&sToken);` |
...
|         - |  1133 | ` */` |
|    127936 |  1134 | `static ph7_value * GenStateNewStrObj(ph7_gen_state *pGen,sxi32 *pCount)` |
|         5 |  1135 | `{` |
|         - |  1136 | `	ph7_value *pConstObj;` |
|    127941 |  1137 | `	sxu32 nIdx = 0;` |
|         - |  1138 | `	/* Reserve a new constant */` |
|    127941 |  1139 | `	pConstObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|    127941 |  1140 | `	if( pConstObj == 0 ){` |
|       ! 0 |  1141 | `		PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"PH7 engine is running out of memory");` |
|       ! 0 |  1142 | `		return 0;` |
|         - |  1143 | `	}` |
|    127941 |  1144 | `	(*pCount)++;` |
|    127941 |  1145 | `	PH7_MemObjInitFromString(pGen->pVm,pConstObj,0);` |
|         - |  1146 | `	/* Emit the load constant instruction */` |
|    127941 |  1147 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|    127941 |  1148 | `	return pConstObj;` |
|     63973 |  1149 | `}` |
|         - |  1150 | `/*` |
...
|    126352 |  1212 | `static sxi32 GenStateCompileString(ph7_gen_state *pGen,int bHeredoc)` |
|         5 |  1213 | `{` |
|    126357 |  1214 | `	SyString *pStr = &pGen->pIn->sData; /* Raw token value */` |
|         - |  1215 | `	const char *zIn,*zCur,*zEnd;` |
|    126357 |  1216 | `	ph7_value *pObj = 0;` |
|         - |  1217 | `	sxi32 iCons;` |
|         - |  1218 | `	sxi32 rc;` |
|         - |  1219 | `	/* Delimit the string */` |
|    126357 |  1220 | `	zIn  = pStr->zString;` |
|    126357 |  1221 | `	zEnd = &zIn[pStr->nByte];` |
|    126357 |  1222 | `	if( zIn >= zEnd ){` |
...
|    125947 |  1232 | `	iCons = 0;` |
|     64300 |  1233 | `	for(;;){` |
|    173817 |  1234 | `		zCur = zIn;` |
|   1695861 |  1235 | `		while( zIn < zEnd && zIn[0] != '\\'  ){` |
|   1524711 |  1236 | `			if( zIn[0] == '{' && &zIn[1] < zEnd && zIn[1] == '$' ){` |
|        75 |  1237 | `				break;` |
|   1524572 |  1238 | `			}else if(zIn[0] == '$' && &zIn[1] < zEnd &&` |
|      2528 |  1239 | `				(((unsigned char)zIn[1] >= 0xc0 \|\| SyisAlpha(zIn[1]) \|\| zIn[1] == '{' \|\| zIn[1] == '_')) ){` |
|      1264 |  1240 | `					break;` |
|         - |  1241 | `			}` |
|   1522049 |  1242 | `			zIn++;` |
|         5 |  1243 | `		}` |
|    173817 |  1244 | `		if( zIn > zCur ){` |
|     96733 |  1245 | `			if( pObj == 0 ){` |
|     96087 |  1246 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|     96087 |  1247 | `				if( pObj == 0 ){` |
|       ! 0 |  1248 | `					return SXERR_ABORT;` |
|         - |  1249 | `				}` |
|     48041 |  1250 | `			}` |
|     96733 |  1251 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|     48364 |  1252 | `		}` |
|    173817 |  1253 | `		if( zIn >= zEnd ){` |
|    125945 |  1254 | `			break;` |
|         - |  1255 | `		}` |
|     47877 |  1256 | `		if( zIn[0] == '\\' ){` |
|     45215 |  1257 | `			const char *zPtr = 0;` |
|         - |  1258 | `			sxu32 n;` |
|     45215 |  1259 | `			zIn++;` |
|     45215 |  1260 | `			if( pObj == 0 ){` |
|     31859 |  1261 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|     31859 |  1262 | `				if( pObj == 0 ){` |
|       ! 0 |  1263 | `					return SXERR_ABORT;` |
|         - |  1264 | `				}` |
|     15927 |  1265 | `			}` |
|     45215 |  1266 | `			if( zIn >= zEnd ){` |
|         - |  1267 | `				/* Lone backslash at the very end of the body: php keeps it */` |
|         3 |  1268 | `				PH7_MemObjStringAppend(pObj,"\\",sizeof(char));` |
|         3 |  1269 | `				break;` |
|         - |  1270 | `			}` |
|     45213 |  1271 | `			n = sizeof(char); /* size of conversion */` |
|     45213 |  1272 | `			switch( zIn[0] ){` |
|        17 |  1273 | `			case '$':` |
|         - |  1274 | `				/* Dollar sign */` |
...
|     39929 |  1291 | `				PH7_MemObjStringAppend(pObj,"\n",sizeof(char));` |
|     39929 |  1292 | `				break;` |
|        27 |  1293 | `			case 'r':` |
...
|       147 |  1439 | `			rc = GenStateProcessStringExpression(&(*pGen),pGen->pIn->nLine,zExpr,zIn);` |
|       147 |  1440 | `			if( rc == SXERR_ABORT ){` |
|       ! 0 |  1441 | `				return SXERR_ABORT;` |
|         - |  1442 | `			}` |
|       147 |  1443 | `			if( rc != SXERR_EMPTY ){` |
|       147 |  1444 | `				++iCons;` |
|        72 |  1445 | `			}` |
|       147 |  1446 | `			if( zIn < zEnd ){` |
...
|      2663 |  1621 | `		pObj = 0;` |
|         5 |  1622 | `	}/*for(;;)*/` |
|    125947 |  1623 | `	if( iCons > 1 ){` |
|         - |  1624 | `		/* Concatenate all compiled constants */` |
|      1923 |  1625 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_CAT,iCons,0,0,0);` |
|       959 |  1626 | `	}` |
|         - |  1627 | `	/* Node successfully compiled */` |
|    125947 |  1628 | `	return SXRET_OK;` |
|     63181 |  1629 | `}` |
|         - |  1630 | `/*` |
|         - |  1631 | ` * Compile a double quoted string.` |
|         - |  1632 | ` *  See the block-comment above for more information.` |
|         - |  1633 | ` */` |
|    126288 |  1634 | `PH7_PRIVATE sxi32 PH7_CompileString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|         5 |  1635 | `{` |
|         - |  1636 | `	sxi32 rc;` |
|    126293 |  1637 | `	rc = GenStateCompileString(&(*pGen),0/*bHeredoc*/);` |
|     63144 |  1638 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|         - |  1639 | `	/* Compilation result */` |
|    126293 |  1640 | `	return rc;` |
|         5 |  1641 | `}` |
|         - |  1642 | `/*` |
...
|         - |  3390 | ` */` |
|  20482700 |  3391 | `PH7_PRIVATE sxi32 PH7_CompileVariable(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|         5 |  3392 | `{` |
|  20482705 |  3393 | `	sxu32 nLineLocal = pGen->pIn->nLine;` |
|         - |  3394 | `	sxi32 iVv;` |
|         - |  3395 | `	sxi32 iP1;` |
|         - |  3396 | `	void *p3;` |
|         - |  3397 | `	sxi32 rc;` |
|  20482705 |  3398 | `	iVv = -1; /* Variable variable counter */` |
|  40965417 |  3399 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) ){` |
|  20482717 |  3400 | `		pGen->pIn++;` |
|  20482717 |  3401 | `		iVv++;` |
|         5 |  3402 | `	}` |
|  20482705 |  3403 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_OCB/*'{'*/)) == 0 ){` |
...
|         - |  3411 | `	}` |
|  20482705 |  3412 | `	p3  = 0;` |
|  20482705 |  3413 | `	if( pGen->pIn->nType & PH7_TK_OCB/*'{'*/ ){` |
...
|         - |  3438 | `		SyString *pName;` |
|  20482689 |  3439 | `		char *zName = 0;` |
|         - |  3440 | `		/* Extract variable name */` |
|  20482689 |  3441 | `		pName = &pGen->pIn->sData;` |
|         - |  3442 | `		/* Advance the stream cursor */` |
|  20482689 |  3443 | `		pGen->pIn++;` |
|  20482689 |  3444 | `		pEntry = SyHashGet(&pGen->hVar,(const void *)pName->zString,pName->nByte);` |
|  20482689 |  3445 | `		if( pEntry == 0 ){` |
|         - |  3446 | `			/* Duplicate name */` |
...
|  19266671 |  3456 | `			zName = (char *)pEntry->pUserData;` |
|         - |  3457 | `		}` |
|  20482689 |  3458 | `		p3 = (void *)zName;` |
|         - |  3459 | `	}` |
|  20482701 |  3460 | `	iP1 = 0;` |
|  20482701 |  3461 | `	if( iCompileFlag & EXPR_FLAG_RDONLY_LOAD ){` |
|   6039987 |  3462 | `		if( (iCompileFlag & EXPR_FLAG_LOAD_IDX_STORE) == 0 ){` |
|         - |  3463 | `			/* Read-only load.In other words do not create the variable if inexistant */` |
|   6036075 |  3464 | `			iP1 = 1;` |
|   3018035 |  3465 | `		}` |
|   3019991 |  3466 | `	}` |
|         - |  3467 | `	/* Emit the load instruction */` |
|  20482701 |  3468 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,0,p3,0);` |
|  20482713 |  3469 | `	while( iVv > 0 ){` |
|        13 |  3470 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,0,0,0);` |
|        13 |  3471 | `		iVv--;` |
|         1 |  3472 | `	}` |
|         - |  3473 | `	/* Node successfully compiled */` |
|  20482701 |  3474 | `	return SXRET_OK;` |
|  10241355 |  3475 | `}` |
|         - |  3476 | `/*` |
|         - |  3477 | ` * Load a literal.` |
|         - |  3478 | ` */` |
|  12832504 |  3479 | `static sxi32 GenStateLoadLiteral(ph7_gen_state *pGen)` |
|         5 |  3480 | `{` |
|  12832509 |  3481 | `	SyToken *pToken = pGen->pIn;` |
|         - |  3482 | `	ph7_value *pObj;` |
|         - |  3483 | `	SyString *pStr;` |
|         - |  3484 | `	sxu32 nIdx;` |
|         - |  3485 | `	/* Extract token value */` |
|  12832509 |  3486 | `	pStr = &pToken->sData;` |
...
|  12832509 |  3491 | `	if( pToken->nType & PH7_TK_MEMBER_NAME ){` |
|         - |  3492 | `		/* fall through to the plain-string literal path */` |
|  10231630 |  3493 | `	}else if( pStr->nByte == sizeof("NULL") - 1 ){` |
...
|         5 |  3502 | `		}` |
|   6968695 |  3503 | `	}else if (pStr->nByte == sizeof("FALSE") - 1 &&` |
...
|   5514248 |  3508 | `	}else if(pStr->nByte == sizeof("__LINE__") - 1 &&` |
...
|   5508399 |  3520 | `	}else if( (pStr->nByte == sizeof("__FILE__") - 1 &&` |
|    508951 |  3521 | `		SyMemcmp(pStr->zString,"__FILE__",sizeof("__FILE__")-1) == 0) \|\|` |
|   5579032 |  3522 | `		(pStr->nByte == sizeof("__DIR__") - 1 &&` |
...
|   5466897 |  3555 | `	}else if( pStr->nByte == sizeof("__NAMESPACE__") - 1 &&` |
...
|   5478783 |  3572 | `	}else if( (pStr->nByte == sizeof("__FUNCTION__") - 1 &&` |
|    394860 |  3573 | `		SyMemcmp(pStr->zString,"__FUNCTION__",sizeof("__FUNCTION__")-1) == 0) \|\|` |
|   5516142 |  3574 | `		(pStr->nByte == sizeof("__METHOD__") - 1 &&` |
...
|  10733791 |  3618 | `	if( SXRET_OK != GenStateFindLiteral(&(*pGen),&pToken->sData,&nIdx) ){` |
|         - |  3619 | `		ph7_value *pLitObj;` |
|         - |  3620 | `		/* Unknown literal,install it in the literal table */` |
|   2079007 |  3621 | `		pLitObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   2079007 |  3622 | `		if( pLitObj == 0 ){` |
|       ! 0 |  3623 | `			PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|       ! 0 |  3624 | `			return SXERR_ABORT;` |
|         - |  3625 | `		}` |
|   2079007 |  3626 | `		PH7_MemObjInitFromString(pGen->pVm,pLitObj,&pToken->sData);` |
|   2079007 |  3627 | `		GenStateInstallLiteral(&(*pGen),pLitObj,nIdx);` |
|   1039501 |  3628 | `	}` |
|         - |  3629 | `	/* Emit the load constant instruction */` |
|  10733791 |  3630 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,1,nIdx,0,0);` |
|  10733791 |  3631 | `	return SXRET_OK;` |
|   6416257 |  3632 | `}` |
|         - |  3633 | `/*` |
...
|         - |  3638 | ` */` |
|  12836482 |  3639 | `static sxi32 GenStateResolveNamespaceLiteral(ph7_gen_state *pGen)` |
|         5 |  3640 | `{` |
|         - |  3641 | `	sxi32 rc;` |
|  12836487 |  3642 | `	if( pGen->pIn >= pGen->pEnd ){` |
|       ! 0 |  3643 | `		return SXRET_OK;` |
|         - |  3644 | `	}` |
|         - |  3645 | `	/* Check if this is a multi-token namespace path */` |
|  12836487 |  3646 | `	if( pGen->pIn < &pGen->pEnd[-1] ){` |
...
|  12832509 |  3725 | `	rc = GenStateLoadLiteral(&(*pGen));` |
|  12832509 |  3726 | `	return rc;` |
|   6418246 |  3727 | `}` |
|         - |  3728 | `/*` |
...
|       ! 0 |  3743 | `}` |
|  12836482 |  3744 | `PH7_PRIVATE sxi32 PH7_CompileLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|         5 |  3745 | `{` |
|         - |  3746 | `	sxi32 rc;` |
|  12836487 |  3747 | `	rc = GenStateResolveNamespaceLiteral(&(*pGen));` |
|  12836487 |  3748 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  3749 | `		SXUNUSED(iCompileFlag); /* cc warning */` |
|       ! 0 |  3750 | `		return rc;` |
|         - |  3751 | `	}` |
|         - |  3752 | `	/* Node successfully compiled */` |
|  12836487 |  3753 | `	return SXRET_OK;` |
|   6418246 |  3754 | `}` |
|         - |  3755 | `/*` |
...
|         - |  4307 | ` * message.` |
|         - |  4308 | ` */` |
|   6442196 |  4309 | `static sxi32 PH7_CompileBlock(` |
...
|         - |  4314 | `	sxi32 rc;` |
|         - |  4315 | `	sxu32 nLine;` |
|   6442201 |  4316 | `	if( pGen->pIn->nType & PH7_TK_OCB /* '{' */ ){` |
|   6417777 |  4317 | `		nLine = pGen->pIn->nLine;` |
|   6417777 |  4318 | `		rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_STD,PH7_VmInstrLength(pGen->pVm),0,0);` |
|   6417777 |  4319 | `		if( rc != SXRET_OK ){` |
|       ! 0 |  4320 | `			return SXERR_ABORT;` |
|         - |  4321 | `		}` |
|   6417777 |  4322 | `		pGen->pIn++;` |
|         - |  4323 | `		/* Compile until we hit the closing braces '}' */` |
|   9457555 |  4324 | `		for(;;){` |
|  18915115 |  4325 | `			if( pGen->pIn >= pGen->pEnd ){` |
...
|         - |  4335 | `				}` |
|       ! 0 |  4336 | `			}` |
|  18915095 |  4337 | `			if( pGen->pIn->nType & PH7_TK_CCB/*'}'*/ ){` |
|         - |  4338 | `				/* Closing braces found,break immediately*/` |
|   6417757 |  4339 | `				pGen->pIn++;` |
|   6417757 |  4340 | `				break;` |
|         - |  4341 | `			}` |
|         - |  4342 | `			/* Compile a single statement */` |
|  12497343 |  4343 | `			rc = GenStateCompileChunk(&(*pGen),PH7_COMPILE_SINGLE_STMT);` |
|  12497343 |  4344 | `			if( rc == SXERR_ABORT ){` |
|       ! 0 |  4345 | `				return SXERR_ABORT;` |
|         - |  4346 | `			}` |
|         5 |  4347 | `		}` |
|   6417777 |  4348 | `		GenStateLeaveBlock(&(*pGen),0);` |
|   3233315 |  4349 | `	}else if( (pGen->pIn->nType & PH7_TK_COLON /* ':' */) && nKeywordEnd > 0 ){` |
|       ! 0 |  4350 | `		pGen->pIn++;` |
...
|   6442201 |  4399 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|       ! 0 |  4400 | `		pGen->pIn++;` |
|       ! 0 |  4401 | `	}` |
|   6442201 |  4402 | `	return SXRET_OK;` |
|   3221103 |  4403 | `}` |
|         - |  4404 | `/*` |
...
|         - |  5553 | ` */` |
|     18248 |  5554 | `static sxi32 PH7_CompileEcho(ph7_gen_state *pGen)` |
|         5 |  5555 | `{` |
|     18253 |  5556 | `	SyToken *pTmp,*pNext = 0;` |
|     18253 |  5557 | `	sxu32 nLine = pGen->pIn->nLine;` |
|     18253 |  5558 | `	int nExpr = 0;      /* expressions actually compiled */` |
|     18253 |  5559 | `	int bExpectMore = 1;/* after 'echo' or a comma an expression is REQUIRED */` |
|         - |  5560 | `	sxi32 rc;` |
|         - |  5561 | `	/* Jump the 'echo' keyword */` |
|     18253 |  5562 | `	pGen->pIn++;` |
|         - |  5563 | `	/* Compile arguments one after one */` |
|     18253 |  5564 | `	pTmp = pGen->pEnd;` |
|     46445 |  5565 | `	while( SXRET_OK == PH7_GetNextExpr(pGen->pIn,pTmp,&pNext) ){` |
|     28199 |  5566 | `		if( pGen->pIn < pNext ){` |
|     28199 |  5567 | `			pGen->pEnd = pNext;` |
|     28199 |  5568 | `			rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_RDONLY_LOAD/* Do not create variable if inexistant */,0);` |
|     28199 |  5569 | `			if( rc == SXERR_ABORT ){` |
|       ! 0 |  5570 | `				return SXERR_ABORT;` |
|     28199 |  5571 | `			}else if( rc != SXERR_EMPTY ){` |
|         - |  5572 | `				/* Emit the consume instruction */` |
|     28173 |  5573 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_CONSUME,1,0,0,0);` |
|     28173 |  5574 | `				nExpr++;` |
|     28173 |  5575 | `				bExpectMore = 0;` |
|     14084 |  5576 | `			}` |
|     14097 |  5577 | `		}` |
...
|     38151 |  5580 | `		while( pNext < pTmp && (pNext->nType & PH7_TK_COMMA) ){` |
...
|      9957 |  5588 | `			pNext++;` |
|         5 |  5589 | `		}` |
|     28197 |  5590 | `		pGen->pIn = pNext;` |
|         5 |  5591 | `	}` |
|         - |  5592 | `	/* Restore token stream */` |
|     18251 |  5593 | `	pGen->pEnd = pTmp;` |
|     18251 |  5594 | `	if( nExpr == 0 \|\| bExpectMore ){` |
...
|         - |  5781 | ` */` |
|   5928538 |  5782 | `static sxu32 GenStateNsQualifyName(ph7_gen_state *pGen,sxu32 nOrigIdx,SyHash *pImports,int *pFromImport)` |
|         5 |  5783 | `{` |
|         - |  5784 | `	ph7_value *pLit;` |
...
|         - |  5792 | `	ph7_value *pNew;` |
|   5928543 |  5793 | `	if( pFromImport ){` |
|   4820249 |  5794 | `		*pFromImport = 0;` |
|   2410122 |  5795 | `	}` |
|   5928543 |  5796 | `	pLit = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,nOrigIdx);` |
|   5928543 |  5797 | `	if( !pLit \|\| !(pLit->iFlags & MEMOBJ_STRING) \|\| SyBlobLength(&pLit->sBlob) == 0 ){` |
|       ! 0 |  5798 | `		return nOrigIdx;` |
|         - |  5799 | `	}` |
|   5928543 |  5800 | `	zLit = (const char *)SyBlobData(&pLit->sBlob);` |
|   5928543 |  5801 | `	nLit = (sxu32)SyBlobLength(&pLit->sBlob);` |
|         - |  5802 | `	/* Skip if already qualified (contains backslash) */` |
|   5928543 |  5803 | `	hasNsSep = 0;` |
|  69590577 |  5804 | `	for( k = 0; k < nLit; k++ ){` |
|  63662065 |  5805 | `		if( zLit[k] == '\\' ){ hasNsSep = 1; break; }` |
|  31831022 |  5806 | `	}` |
|   5928543 |  5807 | `	if( hasNsSep ){` |
|        28 |  5808 | `		return nOrigIdx;` |
|         - |  5809 | `	}` |
|         - |  5810 | `	/* Check use imports first (works even outside namespaces) */` |
|   5928517 |  5811 | `	SyBlobReset(&pGen->sWorker);` |
|   5928517 |  5812 | `	pImport = SyHashGet(pImports,(const void *)zLit,nLit);` |
|   5928517 |  5813 | `	if( pImport ){` |
...
|         8 |  5818 | `		}` |
|        23 |  5819 | `	}else{` |
|   5928481 |  5820 | `		if( SyBlobLength(&pGen->sNamespace) == 0 ){` |
|   5928343 |  5821 | `			return nOrigIdx; /* Not in a namespace and no import match */` |
|         - |  5822 | `		}` |
...
|         - |  5877 | ` */` |
|    464820 |  5878 | `static void GenStateBuildFQN(ph7_gen_state *pGen,const SyString *pName,SyBlob *pOut)` |
|         5 |  5879 | `{` |
|    464825 |  5880 | `	if( SyBlobLength(&pGen->sNamespace) > 0 ){` |
|      3981 |  5881 | `		SyBlobAppend(pOut,SyBlobData(&pGen->sNamespace),SyBlobLength(&pGen->sNamespace));` |
|      3981 |  5882 | `		SyBlobAppend(pOut,"\\",1);` |
|      1988 |  5883 | `	}` |
|    464825 |  5884 | `	SyBlobAppend(pOut,pName->zString,pName->nByte);` |
|    464825 |  5885 | `}` |
|         - |  5886 | `/*` |
...
|         - |  6439 | ` */` |
|   1355084 |  6440 | `static sxi32 GenStateCollectFuncArgs(ph7_vm_func *pFunc,ph7_gen_state *pGen,SyToken *pEnd,int bCtorCtx,int bAbstractCtx)` |
|         5 |  6441 | `{` |
...
|         - |  6446 | `	sxi32 rc;` |
|         - |  6447 |  |
|   1355089 |  6448 | `	pIn = pGen->pIn;` |
|   1355089 |  6449 | `	SyBlobInit(&sSig,&pGen->pVm->sAllocator);` |
|         - |  6450 | `	/* Process arguments one after one */` |
|   1754110 |  6451 | `	for(;;){` |
|   3508225 |  6452 | `		if( pIn >= pEnd ){` |
|         - |  6453 | `			/* No more arguments to process */` |
|   1355073 |  6454 | `			break;` |
|         - |  6455 | `		}` |
|   2153157 |  6456 | `		SyZero(&sArg,sizeof(ph7_vm_func_arg));` |
|   2153157 |  6457 | `		SySetInit(&sArg.aByteCode,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|   2153157 |  6458 | `		SySetInit(&sArg.aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|   2153157 |  6459 | `		SySetInit(&sArg.aAttrs,&pGen->pVm->sAllocator,sizeof(ph7_attribute));` |
|   2153157 |  6460 | `		SyStringInitFromBuf(&sArg.sTypeName,0,0);` |
|         - |  6461 | `		/* Parameter #[...] attributes: the group precedes the parameter's` |
|         - |  6462 | `		 * first token inside the main token stream */` |
|   2153157 |  6463 | `		if( GenStateCollectParamAttrs(&(*pGen),pIn,&sArg.aAttrs) == SXERR_ABORT ){` |
...
|         - |  6471 | `		{` |
|   2153157 |  6472 | `			int bReadonly = 0, bVisSeen = 0;` |
|   2153157 |  6473 | `			sxi32 iVis = PH7_CLASS_PROT_PUBLIC;` |
|   2153157 |  6474 | `			sxi32 iSetVisFlag = 0;` |
|         - |  6475 | `			int nSetTok;` |
|         - |  6476 | `			sxi32 nSetVis;` |
|   2153157 |  6477 | `			if( pIn < pEnd && GenStateIsReadonly(pIn) ){` |
|         3 |  6478 | `				bReadonly = 1;` |
|         3 |  6479 | `				pIn++;` |
|         1 |  6480 | `			}` |
|   2153157 |  6481 | `			nSetVis = GenStatePeekSetVisibility(pIn,pEnd,&nSetTok);` |
|   2153157 |  6482 | `			if( nSetVis ){` |
...
|       ! 0 |  6489 | `					pIn++;` |
|         1 |  6490 | `				}` |
|   2153156 |  6491 | `			}else if( pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD) ){` |
...
|        43 |  6509 | `				}` |
|     56596 |  6510 | `			}` |
|   2153157 |  6511 | `			if( iSetVisFlag == PH7_CLASS_ATTR_PRIVATE_SET ){` |
|         5 |  6512 | `				sArg.iFlags \|= VM_FUNC_ARG_PRIV_SET;` |
|   2153155 |  6513 | `			}else if( iSetVisFlag == PH7_CLASS_ATTR_PROTECTED_SET ){` |
|       ! 0 |  6514 | `				sArg.iFlags \|= VM_FUNC_ARG_PROT_SET;` |
|       ! 0 |  6515 | `			}` |
|   2153157 |  6516 | `			if( bVisSeen \|\| bReadonly ){` |
|        95 |  6517 | `				if( !bCtorCtx ){` |
...
|   2153148 |  6538 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_DOLLAR) == 0` |
|   1172179 |  6539 | `			&& (pIn->nType & PH7_TK_AMPER) == 0` |
|    179534 |  6540 | `			&& (pIn->nType & PH7_TK_ELLIPSIS) == 0 ){` |
...
|     72214 |  6568 | `		}` |
|   2153143 |  6569 | `		if( pIn >= pEnd ){` |
|       ! 0 |  6570 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Missing argument name");` |
|       ! 0 |  6571 | `			return rc;` |
|         - |  6572 | `		}` |
|   2153143 |  6573 | `		if( pIn->nType & PH7_TK_AMPER ){` |
|         - |  6574 | `			/* Pass by reference,record that */` |
|     23375 |  6575 | `			sArg.iFlags \|= VM_FUNC_ARG_BY_REF;` |
|     23375 |  6576 | `			pIn++;` |
|     11685 |  6577 | `		}` |
|   2153143 |  6578 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_ELLIPSIS) ){` |
|         - |  6579 | `			/* Variadic parameter: ...$args */` |
|     23439 |  6580 | `			sArg.iFlags \|= VM_FUNC_ARG_VARIADIC;` |
|     23439 |  6581 | `			pIn++;` |
|     11717 |  6582 | `		}` |
|   2153143 |  6583 | `		if( pIn >= pEnd \|\| (pIn->nType & PH7_TK_DOLLAR) == 0 \|\| &pIn[1] >= pEnd \|\| (pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|         - |  6584 | `			/* Invalid argument */` |
|       ! 0 |  6585 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Invalid argument name");` |
|       ! 0 |  6586 | `			return rc;` |
|         - |  6587 | `		}` |
|   2153143 |  6588 | `		pIn++; /* Jump the dollar sign */` |
|         - |  6589 | `		/* Copy argument name */` |
|   2153143 |  6590 | `		zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,SyStringData(&pIn->sData),SyStringLength(&pIn->sData));` |
|   2153143 |  6591 | `		if( zDup == 0 ){` |
|       ! 0 |  6592 | `			PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"PH7 engine is running out of memory");` |
|       ! 0 |  6593 | `			return SXERR_ABORT;` |
|         - |  6594 | `		}` |
|   2153143 |  6595 | `		SyStringInitFromBuf(&sArg.sName,zDup,SyStringLength(&pIn->sData));` |
|   2153143 |  6596 | `		pIn++;` |
|   2153143 |  6597 | `		if( pIn < pEnd ){` |
...
|         - |  6711 | `			 */` |
|   2008775 |  6712 | `			SyBlobRelease(&sSig);` |
|         - |  6713 | `		}` |
|         - |  6714 | `		/* Save in the argument set */` |
|   2153141 |  6715 | `		SySetPut(&pFunc->aArgs,(const void *)&sArg);` |
|         5 |  6716 | `	}` |
|   1355073 |  6717 | `	if( SyBlobLength(&sSig) > 0 ){` |
|         - |  6718 | `		/* Save function signature */` |
|     97625 |  6719 | `		SyStringInitFromBuf(&pFunc->sSignature,SyBlobData(&sSig),SyBlobLength(&sSig));` |
|     48810 |  6720 | `	}` |
|   1355073 |  6721 | `	return SXRET_OK;` |
|    677547 |  6722 | `}` |
|         - |  6723 | `/*` |
...
|      5970 |  6890 | `}` |
|   3009394 |  6891 | `static int GenStateFuncBodyHasYield(ph7_gen_state *pGen)` |
|         5 |  6892 | `{` |
|   3009399 |  6893 | `	SyToken *pIn = pGen->pIn;   /* expected at the body's opening '{' */` |
|   3009399 |  6894 | `	SyToken *pEnd = pGen->pEnd;` |
|   3009399 |  6895 | `	sxi32 iDepth = 0;` |
|   3009399 |  6896 | `	int bStarted = 0;` |
| 141426051 |  6897 | `	while( pIn < pEnd ){` |
| 141426051 |  6898 | `		sxu32 t = pIn->nType;` |
| 141426051 |  6899 | `		if( t & PH7_TK_OCB ){ iDepth++; bStarted = 1; pIn++; continue; }` |
| 135048611 |  6900 | `		if( t & PH7_TK_CCB ){ iDepth--; pIn++; if( bStarted && iDepth <= 0 ){ break; } continue; }` |
| 128706545 |  6901 | `		if( t & PH7_TK_KEYWORD ){` |
...
|         - |  6915 | ` */` |
|   3009394 |  6916 | `static sxi32 GenStateCompileFuncBody(` |
...
|   3009399 |  6926 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC,PH7_VmInstrLength(pGen->pVm),pFunc,&pBlock);` |
|   3009399 |  6927 | `	if( rc != SXRET_OK ){` |
...
|         - |  6931 | `	}` |
|   3009399 |  6932 | `	nGotoOfft = SySetUsed(&pGen->aGoto);` |
|         - |  6933 | `	/* Swap bytecode containers */` |
|   3009399 |  6934 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   3009399 |  6935 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pFunc->aByteCode);` |
...
|         - |  6940 | `	{` |
|   3009399 |  6941 | `		sxu32 nArg = SySetUsed(&pFunc->aArgs);` |
|         - |  6942 | `		sxu32 i;` |
|   5107933 |  6943 | `		for( i = 0; i < nArg; i++ ){` |
|   2098539 |  6944 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pFunc->aArgs,i);` |
|         - |  6945 | `			char *zSrc;` |
|         - |  6946 | `			sxu32 nSrc,nName;` |
|         - |  6947 | `			SySet sToken;` |
|         - |  6948 | `			SyToken *pTmpIn,*pTmpEnd;` |
|         - |  6949 | `			sxi32 rcPromote;` |
|   2098539 |  6950 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|   2098463 |  6951 | `				continue;` |
|         - |  6952 | `			}` |
...
|         - |  7002 | `	{` |
|   3009399 |  7003 | `		sxi8 bSavedGen = pGen->bInGenerator;` |
|   3009399 |  7004 | `		pGen->bInGenerator = (sxi8)GenStateFuncBodyHasYield(&(*pGen));` |
|         - |  7005 | `		/* Compile the body */` |
|   3009399 |  7006 | `		PH7_CompileBlock(&(*pGen),0);` |
|   3009399 |  7007 | `		pGen->bInGenerator = bSavedGen;` |
|         - |  7008 | `	}` |
|         - |  7009 | `	/* Fix exception jumps now the destination is resolved */` |
|   3009399 |  7010 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|         - |  7011 | `	/* Emit the final return if not yet done */` |
|   3009399 |  7012 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|         - |  7013 | `	/* Fix gotos jumps now the destination is resolved */` |
|   3009399 |  7014 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),nGotoOfft) ){` |
|       ! 0 |  7015 | `		rc = SXERR_ABORT;` |
|       ! 0 |  7016 | `	}` |
|   3009399 |  7017 | `	SySetTruncate(&pGen->aGoto,nGotoOfft);` |
|         - |  7018 | `	/* Restore the default container */` |
|   3009399 |  7019 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|         - |  7020 | `	/* Leave function block */` |
|   3009399 |  7021 | `	GenStateLeaveBlock(&(*pGen),0);` |
|   3009399 |  7022 | `	if( rc == SXERR_ABORT ){` |
...
|         - |  7027 | `	{` |
|   3009399 |  7028 | `		VmInstr *aInstr = (VmInstr *)SySetBasePtr(&pFunc->aByteCode);` |
|         - |  7029 | `		sxu32 i;` |
|  86618973 |  7030 | `		for( i = 0; i < SySetUsed(&pFunc->aByteCode); i++ ){` |
|  83621509 |  7031 | `			if( aInstr[i].iOp == PH7_OP_YIELD \|\| aInstr[i].iOp == PH7_OP_YIELD_FROM ){` |
|     11935 |  7032 | `				pFunc->iFlags \|= VM_FUNC_GENERATOR;` |
|     11935 |  7033 | `				break;` |
|         - |  7034 | `			}` |
|  41804792 |  7035 | `		}` |
|         - |  7036 | `	}` |
|   3009399 |  7037 | `	if( pFunc->iFlags & VM_FUNC_GENERATOR ){` |
...
|     43007 |  7130 | `	return 0;` |
|     21561 |  7131 | `}` |
|    192482 |  7132 | `static sxi32 GenStateParseOneTypeAtom(ph7_gen_state *pGen, PhlTypeAtom *pOut)` |
|         5 |  7133 | `{` |
|    192487 |  7134 | `	SyToken *pIn = pGen->pIn;` |
|    192487 |  7135 | `	int bAbsolute = 0;` |
|    192487 |  7136 | `	SyZero(pOut, sizeof(*pOut));` |
|    192487 |  7137 | `	SyStringInitFromBuf(&pOut->sClass, 0, 0);` |
|    192487 |  7138 | `	if( pIn >= pGen->pEnd ){` |
|       ! 0 |  7139 | `		return SXERR_SYNTAX;` |
|         - |  7140 | `	}` |
|         - |  7141 | `	/* Optional leading namespace separator '\' on FQN class types */` |
|    192487 |  7142 | `	if( pIn->nType & PH7_TK_NSSEP ){` |
...
|         - |  7147 | `		}` |
|         4 |  7148 | `	}` |
|    192487 |  7149 | `	if( (pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|       ! 0 |  7150 | `		return SXERR_SYNTAX;` |
|         - |  7151 | `	}` |
|    192487 |  7152 | `	if( pIn->nType & PH7_TK_KEYWORD ){` |
...
|         - |  7227 | `		}` |
|         - |  7228 | `	}` |
|    192485 |  7229 | `	pGen->pIn = pIn;` |
|    192485 |  7230 | `	return SXRET_OK;` |
|     96246 |  7231 | `}` |
|         - |  7232 |  |
|         - |  7233 | `/*` |
...
|         - |  7239 | ` */` |
|    192304 |  7240 | `static void GenBuildUnionTypeText(SyBlob *pBlob, PhlTypeAtom *aAtoms, int nAtoms, int bNullable)` |
|         5 |  7241 | `{` |
|         - |  7242 | `	int i;` |
|    192309 |  7243 | `	int nNonNull = 0;` |
|    192309 |  7244 | `	int bAnyIntersection = 0;` |
|         - |  7245 | `	sxu32 aGroupCount[PHL_UNION_MAX_ALTS];` |
|    192309 |  7246 | `	sxu32 nMaxGroup = 0;` |
|   6346037 |  7247 | `	for( i = 0; i < PHL_UNION_MAX_ALTS; i++ ) aGroupCount[i] = 0;` |
|    384765 |  7248 | `	for( i = 0; i < nAtoms; i++ ){` |
|    192461 |  7249 | `		if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|    192431 |  7250 | `			nNonNull++;` |
|    192431 |  7251 | `			if( aAtoms[i].nGroup < PHL_UNION_MAX_ALTS ){` |
|    192431 |  7252 | `				aGroupCount[aAtoms[i].nGroup]++;` |
|    192431 |  7253 | `				if( aAtoms[i].nGroup > nMaxGroup ) nMaxGroup = aAtoms[i].nGroup;` |
|     96213 |  7254 | `			}` |
|     96213 |  7255 | `		}` |
|     96233 |  7256 | `	}` |
|    384713 |  7257 | `	for( i = 0; i < nAtoms; i++ ){` |
|    192433 |  7258 | `		if( aAtoms[i].nType != UTA_NULL_FLAG && aGroupCount[aAtoms[i].nGroup] >= 2 ){` |
|        29 |  7259 | `			bAnyIntersection = 1;` |
|        29 |  7260 | `			break;` |
|         - |  7261 | `		}` |
|     96207 |  7262 | `	}` |
|    192309 |  7263 | `	if( bAnyIntersection ){` |
...
|      2031 |  7298 | `		return;` |
|         - |  7299 | `	}` |
|    192285 |  7300 | `	if( nNonNull == 1 && bNullable ){` |
|         - |  7301 | `		/* Shorthand: ?T */` |
...
|       ! 0 |  7312 | `	}` |
|         - |  7313 | `	{` |
|    188281 |  7314 | `		int bFirst = 1;` |
|         - |  7315 | `		/* 1) Classes in declaration order */` |
|    376665 |  7316 | `		for( i = 0; i < nAtoms; i++ ){` |
|    188389 |  7317 | `			if( aAtoms[i].nType == SXU32_HIGH ){` |
...
|         - |  7327 | `			int k;` |
|   1317937 |  7328 | `			for( k = 0; k < (int)(sizeof(aOrder)/sizeof(aOrder[0])); k++ ){` |
|   2114753 |  7329 | `				for( i = 0; i < nAtoms; i++ ){` |
|   1130197 |  7330 | `					if( aAtoms[i].nType == aOrder[k] ){` |
...
|         - |  7360 | ` */` |
|    192456 |  7361 | `static sxi32 GenStateParsePart(` |
|         - |  7362 | `	ph7_gen_state *pGen, PhlTypeAtom *aAtoms, int *pnAtoms, sxu32 iGroup,` |
|         - |  7363 | `	int *pnMembers, int *pbParen, sxu32 nLine)` |
|         5 |  7364 | `{` |
|         - |  7365 | `	sxi32 rc;` |
|    192461 |  7366 | `	int nMembers = 0;` |
|    192461 |  7367 | `	int bParen = 0;` |
|    192461 |  7368 | `	*pnMembers = 0;` |
|    192461 |  7369 | `	*pbParen = 0;` |
|    192461 |  7370 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_LPAREN) ){` |
|         9 |  7371 | `		bParen = 1;` |
|         9 |  7372 | `		pGen->pIn++; /* skip '(' */` |
|         3 |  7373 | `	}` |
|     96228 |  7374 | `	for(;;){` |
|    192487 |  7375 | `		if( *pnAtoms >= PHL_UNION_MAX_ALTS ){` |
...
|         - |  7379 | `		}` |
|    192487 |  7380 | `		rc = GenStateParseOneTypeAtom(pGen, &aAtoms[*pnAtoms]);` |
|    192487 |  7381 | `		if( rc != SXRET_OK ){` |
|         3 |  7382 | `			return rc;` |
|         - |  7383 | `		}` |
|    192485 |  7384 | `		aAtoms[*pnAtoms].nGroup = iGroup;` |
|    192485 |  7385 | `		(*pnAtoms)++;` |
|    192485 |  7386 | `		nMembers++;` |
|         - |  7387 | ``		/* Continue the intersection while `&` is followed by another type atom. */`` |
|    192485 |  7388 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
...
|         - |  7409 | `		}` |
|         3 |  7410 | `	}` |
|    192459 |  7411 | `	*pnMembers = nMembers;` |
|    192459 |  7412 | `	*pbParen = bParen;` |
|    192459 |  7413 | `	return SXRET_OK;` |
|     96233 |  7414 | `}` |
|         - |  7415 |  |
|         - |  7416 | `/*` |
...
|         - |  7433 | ` */` |
|    192320 |  7434 | `static sxi32 GenStateParseUnionTypeDecl(` |
...
|    192325 |  7447 | `	int nAtoms = 0;` |
|    192325 |  7448 | `	int bShortNullable = 0;` |
|    192325 |  7449 | `	int bExplicitNull = 0;` |
|         - |  7450 | `	sxi32 rc;` |
|    192325 |  7451 | `	*pnType = 0;` |
|    192325 |  7452 | `	if( pClass ) SyStringInitFromBuf(pClass, 0, 0);` |
|    192325 |  7453 | `	*piTypeFlags = 0;` |
|    192325 |  7454 | `	if( pTypeText ) SyStringInitFromBuf(pTypeText, 0, 0);` |
|         - |  7455 |  |
|    192325 |  7456 | `	if( pGen->pIn >= pGen->pEnd ){` |
|       ! 0 |  7457 | `		return SXRET_OK;` |
|         - |  7458 | `	}` |
|         - |  7459 | ``	/* Optional `?` shorthand prefix */`` |
|    192320 |  7460 | `	if( (pGen->pIn->nType & PH7_TK_OP) && pGen->pIn->sData.nByte == 1` |
...
|    192325 |  7473 | `		sxu32 iGroup = 0;` |
|    192325 |  7474 | `		rc = GenStateParsePart(pGen, aAtoms, &nAtoms, iGroup, &nMembers, &bParen, nLine);` |
|    192325 |  7475 | `		if( rc != SXRET_OK ){` |
|         4 |  7476 | `			return rc;` |
|         - |  7477 | `		}` |
...
|    288686 |  7483 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OP)` |
|    192532 |  7484 | `			&& pGen->pIn->sData.nByte == 1 && pGen->pIn->sData.zString[0] == '\|' ){` |
...
|         - |  7502 | `			}` |
|         5 |  7503 | `		}` |
|    192321 |  7504 | `		if( iGroup > 0 && nMembers >= 2 && !bParen ){` |
...
|         - |  7516 | `	{` |
|         - |  7517 | `		int i, j;` |
|    192321 |  7518 | `		int bHasNonNull = 0;` |
|    192321 |  7519 | `		int bAnyIntersection = 0;` |
...
|   6346433 |  7523 | `		for( i = 0; i < PHL_UNION_MAX_ALTS; i++ ) aGroupCount[i] = 0;` |
|    384799 |  7524 | `		for( i = 0; i < nAtoms; i++ ){` |
|    192483 |  7525 | `			if( aAtoms[i].nGroup < PHL_UNION_MAX_ALTS ) aGroupCount[aAtoms[i].nGroup]++;` |
|     96244 |  7526 | `		}` |
|    384743 |  7527 | `		for( i = 0; i < nAtoms; i++ ){` |
|    192453 |  7528 | `			if( aGroupCount[aAtoms[i].nGroup] >= 2 ){ bAnyIntersection = 1; break; }` |
|     96216 |  7529 | `		}` |
...
|    192321 |  7532 | `		if( bShortNullable && bAnyIntersection ){` |
...
|         - |  7536 | `		}` |
|    384785 |  7537 | `		for( i = 0; i < nAtoms; i++ ){` |
...
|    192481 |  7541 | `			if( aGroupCount[aAtoms[i].nGroup] >= 2 ){` |
...
|         - |  7563 | `				}` |
|        24 |  7564 | `			}` |
|    192479 |  7565 | `			if( aAtoms[i].nType == UTA_VOID_FLAG ){` |
...
|         - |  7580 | `				}` |
|        88 |  7581 | `			}` |
|    192477 |  7582 | `			if( aAtoms[i].nType == UTA_NEVER_FLAG ){` |
...
|         - |  7599 | `				}` |
|         8 |  7600 | `			}` |
|    192471 |  7601 | `			if( aAtoms[i].nType == UTA_NULL_FLAG ){` |
|        34 |  7602 | `				bExplicitNull = 1;` |
|        19 |  7603 | `			}else{` |
|    192441 |  7604 | `				bHasNonNull = 1;` |
|         - |  7605 | `			}` |
...
|        99 |  7643 | `			}` |
|     96237 |  7644 | `		}` |
|    192309 |  7645 | `		if( !bHasNonNull && bExplicitNull ){` |
...
|    192309 |  7660 | `	if( bShortNullable \|\| bExplicitNull ){` |
|      4025 |  7661 | `		*piTypeFlags \|= iNullableFlag;` |
|      2010 |  7662 | `	}` |
|         - |  7663 | `	/* Build canonical type text */` |
|    192309 |  7664 | `	if( pTypeText ){` |
|         - |  7665 | `		SyBlob sBlob;` |
|    192309 |  7666 | `		SyBlobInit(&sBlob, &pGen->pVm->sAllocator);` |
|    286466 |  7667 | `		GenBuildUnionTypeText(&sBlob, aAtoms, nAtoms,` |
|     96152 |  7668 | `			(bShortNullable \|\| bExplicitNull) ? 1 : 0);` |
|    192309 |  7669 | `		if( SyBlobLength(&sBlob) > 0 ){` |
|    288173 |  7670 | `			char *zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|    192112 |  7671 | `				(const char *)SyBlobData(&sBlob), SyBlobLength(&sBlob));` |
|    192117 |  7672 | `			if( zDup ){` |
|    192117 |  7673 | `				SyStringInitFromBuf(pTypeText, zDup, SyBlobLength(&sBlob));` |
|     96056 |  7674 | `			}` |
|     96056 |  7675 | `		}` |
|    192309 |  7676 | `		SyBlobRelease(&sBlob);` |
|     96152 |  7677 | `	}` |
...
|         - |  7681 | `	{` |
|    192309 |  7682 | `		int nNonNull = 0;` |
|    192309 |  7683 | `		int iNonNullIdx = -1;` |
|         - |  7684 | `		int i;` |
|    384765 |  7685 | `		for( i = 0; i < nAtoms; i++ ){` |
|    192461 |  7686 | `			if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|    192431 |  7687 | `				nNonNull++;` |
|    192431 |  7688 | `				iNonNullIdx = i;` |
|     96213 |  7689 | `			}` |
|     96233 |  7690 | `		}` |
|    192309 |  7691 | `		if( nNonNull <= 1 ){` |
|         - |  7692 | `			/* Fast path: store as single type. */` |
|    192203 |  7693 | `			if( iNonNullIdx >= 0 ){` |
|    192197 |  7694 | `				PhlTypeAtom *pA = &aAtoms[iNonNullIdx];` |
|    192197 |  7695 | `				if( pA->nType == SXU32_HIGH ){` |
...
|    170668 |  7701 | `				}else if( pA->nType == UTA_VOID_FLAG ){` |
...
|         - |  7741 | ` */` |
|   3149896 |  7742 | `static sxi32 GenStateParseReturnType(ph7_gen_state *pGen, ph7_vm_func *pFunc)` |
|         5 |  7743 | `{` |
|   3149901 |  7744 | `	sxi32 iFlags = 0;` |
|         - |  7745 | `	sxi32 rc;` |
|         - |  7746 | `	sxu32 nLine;` |
|   3149901 |  7747 | `	pFunc->nReturnType = 0;` |
|   3149901 |  7748 | `	SyStringInitFromBuf(&pFunc->sReturnClass, 0, 0);` |
|   3149901 |  7749 | `	SyStringInitFromBuf(&pFunc->sReturnTypeName, 0, 0);` |
...
|   3149901 |  7755 | `	SySetReset(&pFunc->aReturnUnion);` |
|   3149901 |  7756 | `	pFunc->iFlags &= ~VM_FUNC_RETURN_NULLABLE;` |
|   3149901 |  7757 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COLON) == 0 ){` |
|   3117971 |  7758 | `		return SXRET_OK;` |
|         - |  7759 | `	}` |
...
|         - |  8088 | ` */` |
|   3498418 |  8089 | `static sxi32 GetProtectionLevel(sxi32 nKeyword)` |
|         5 |  8090 | `{` |
|   3498423 |  8091 | `	if( nKeyword == PH7_TKWRD_PRIVATE ){` |
|    260721 |  8092 | `		return PH7_CLASS_PROT_PRIVATE;` |
|   3237707 |  8093 | `	}else if( nKeyword == PH7_TKWRD_PROTECTED ){` |
|    233385 |  8094 | `		return PH7_CLASS_PROT_PROTECTED;` |
|         - |  8095 | `	}` |
|         - |  8096 | `	/* Assume public by default */` |
|   3004327 |  8097 | `	return PH7_CLASS_PROT_PUBLIC;` |
|   1749214 |  8098 | `}` |
|         - |  8099 | `/*` |
...
|         - |  8317 | ` */` |
|     15942 |  8318 | `static void GenStateCopyTypeToAttr(ph7_class_attr *pAttr,sxu32 nType,` |
|         - |  8319 | `	const SyString *pClass,const SyString *pTypeName,sxi32 iTypeFlags,SySet *pAlts)` |
|         5 |  8320 | `{` |
|     15947 |  8321 | `	pAttr->nType = nType;` |
|     15947 |  8322 | `	pAttr->sClass = *pClass;` |
|     15947 |  8323 | `	pAttr->sTypeName = *pTypeName;` |
|     15947 |  8324 | `	if( iTypeFlags & PH7_CLASS_ATTR_UNION ){` |
|         - |  8325 | `		sxu32 i;` |
...
|         - |  8544 | ` */` |
|   2622476 |  8545 | `static int GenStateLooksLikeTypedProperty(SyToken *pStart,SyToken *pEnd)` |
|         5 |  8546 | `{` |
|   2622481 |  8547 | `	SyToken *p = pStart;` |
|   2622481 |  8548 | `	int bFirst = 1;` |
|   2622481 |  8549 | `	if( p >= pEnd ) return 0;` |
|         - |  8550 | ``	/* Optional nullable `?` shorthand. */`` |
|   2622481 |  8551 | `	if( (p->nType & PH7_TK_OP) && p->sData.nByte == 1 && p->sData.zString[0] == '?' ){` |
|        41 |  8552 | `		p++;` |
...
|   1311238 |  8559 | `	for(;;){` |
|   2622501 |  8560 | `		if( p < pEnd && (p->nType & PH7_TK_LPAREN) ){` |
...
|   2622499 |  8569 | `			if( p < pEnd && (p->nType & PH7_TK_NSSEP) ){ p++; }` |
|   2622499 |  8570 | `			if( p >= pEnd \|\| (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|       ! 0 |  8571 | `				return 0;` |
|         - |  8572 | `			}` |
...
|   2622499 |  8576 | `			if( bFirst && (p->nType & PH7_TK_KEYWORD) ){` |
|   2622447 |  8577 | `				sxu32 k = (sxu32)(SX_PTR_TO_INT(p->pUserData));` |
|   2622442 |  8578 | `				if( k == PH7_TKWRD_FUNCTION \|\| k == PH7_TKWRD_VAR \|\| k == PH7_TKWRD_CONST` |
|    124914 |  8579 | `				 \|\| k == PH7_TKWRD_STATIC \|\| k == PH7_TKWRD_FINAL \|\| k == PH7_TKWRD_ABSTRACT ){` |
|   2606577 |  8580 | `					return 0;` |
|         - |  8581 | `				}` |
|      7935 |  8582 | `			}` |
|     15927 |  8583 | `			p++;` |
|     15929 |  8584 | `			while( p + 1 < pEnd && (p->nType & PH7_TK_NSSEP) && (p[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|         3 |  8585 | `				p += 2;` |
|         1 |  8586 | `			}` |
|     23886 |  8587 | `			while( p + 1 < pEnd && (p->nType & PH7_TK_AMPER)` |
|     15930 |  8588 | `				&& (p[1].nType & (PH7_TK_NSSEP\|PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|         3 |  8589 | `				p++; /* skip '&' */` |
...
|         - |  8597 | `		}` |
|     15929 |  8598 | `		bFirst = 0;` |
|     15924 |  8599 | `		if( p < pEnd && (p->nType & PH7_TK_OP) && p->sData.nByte == 1` |
...
|     15909 |  8604 | `		break;` |
|       ! 0 |  8605 | `	}` |
|     15909 |  8606 | `	if( p >= pEnd ) return 0;` |
|     15909 |  8607 | `	return (p->nType & PH7_TK_DOLLAR) ? 1 : 0;` |
|   1311243 |  8608 | `}` |
|         - |  8609 |  |
|         - |  8610 | `/*` |
...
|         - |  8627 | ` */` |
|     15914 |  8628 | `static sxi32 GenStateParsePropertyType(` |
...
|         - |  8634 | `	SySet *pAlts` |
|         5 |  8635 | `){` |
|     15919 |  8636 | `	sxi32 iFlags = 0;` |
|         - |  8637 | `	sxi32 rc;` |
|     15919 |  8638 | `	if( pGen->pIn >= pGen->pEnd ){` |
|       ! 0 |  8639 | `		return SXRET_OK;` |
|         - |  8640 | `	}` |
|         - |  8641 | `	/* If the first token is '$', there's no type */` |
|     15919 |  8642 | `	if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|       ! 0 |  8643 | `		return SXRET_OK;` |
|         - |  8644 | `	}` |
|     15919 |  8645 | `	rc = GenStateParseUnionTypeDecl(` |
|      7957 |  8646 | `		pGen, pnType, pClass, pAlts, &iFlags, pTypeText,` |
|         - |  8647 | `		PH7_CLASS_ATTR_NULLABLE,` |
|         - |  8648 | `		PH7_CLASS_ATTR_UNION,` |
|         - |  8649 | `		/* bAllowVoid */ 0,` |
|     15914 |  8650 | `		pGen->pIn->nLine);` |
|     15919 |  8651 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  8652 | `		return rc;` |
|         - |  8653 | `	}` |
|         - |  8654 | `	/* Verify next token is '$' (start of property name) */` |
|     15919 |  8655 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
|       ! 0 |  8656 | `		return SXERR_SYNTAX;` |
|         - |  8657 | `	}` |
|     15919 |  8658 | `	*piTypeFlags = iFlags \| PH7_CLASS_ATTR_TYPED;` |
|     15919 |  8659 | `	return SXRET_OK;` |
|      7962 |  8660 | `}` |
|         - |  8661 |  |
|         - |  8662 | `/*` |
...
|         - |  8672 | ` */` |
|     16092 |  8673 | `static int GenStateIsDisallowedPropertyAtom(` |
|         - |  8674 | `	sxu32 nType,` |
...
|         - |  8679 | `	const char *z;` |
|         - |  8680 | `	sxu32 n;` |
|     16097 |  8681 | `	if( nType != SXU32_HIGH \|\| pClass == 0 \|\| pClass->nByte == 0 ){` |
|     16035 |  8682 | `		return 0;` |
|         - |  8683 | `	}` |
...
|         - |  8705 | ` */` |
|     16030 |  8706 | `static sxi32 GenStateValidateMemberType(` |
...
|         - |  8715 | `	sxu32 nLine)` |
|         5 |  8716 | `{` |
|     16035 |  8717 | `	const char *zBad = 0;` |
|     16035 |  8718 | `	sxu32 nBad = 0;` |
|         - |  8719 | `	SyString sFallback;` |
|         - |  8720 | `	const SyString *pBad;` |
|         - |  8721 | `	sxi32 rc;` |
|     16035 |  8722 | `	int bDisallowed = 0;` |
|     16035 |  8723 | `	if( GenStateIsDisallowedPropertyAtom(nType,pTypeClass,&zBad,&nBad) ){` |
|         5 |  8724 | `		bDisallowed = 1;` |
|     16033 |  8725 | `	}else if( pUnionAlts ){` |
|         - |  8726 | `		sxu32 i;` |
...
|        35 |  8733 | `		}` |
|        15 |  8734 | `	}` |
|     16035 |  8735 | `	if( !bDisallowed ){` |
|     16029 |  8736 | `		return SXRET_OK;` |
|         - |  8737 | `	}` |
...
|         - |  8760 | ` */` |
|  22025124 |  8761 | `static int GenStateIsReadonly(SyToken *pTok)` |
|         5 |  8762 | `{` |
|  22251451 |  8763 | `	return (pTok->nType & PH7_TK_ID)` |
|  11238884 |  8764 | `		&& pTok->sData.nByte == sizeof("readonly")-1` |
|  22251446 |  8765 | `		&& SyStrnicmp(pTok->sData.zString,"readonly",sizeof("readonly")-1) == 0;` |
|         5 |  8766 | `}` |
|         - |  8767 | `/*` |
...
|         - |  8772 | ` */` |
|   7978426 |  8773 | `static sxi32 GenStatePeekSetVisibility(SyToken *pTok,SyToken *pEnd,int *pnTok)` |
|         5 |  8774 | `{` |
|   7978431 |  8775 | `	*pnTok = 0;` |
|   7978426 |  8776 | `	if( &pTok[3] < pEnd` |
|   7501218 |  8777 | `	 && (pTok->nType & PH7_TK_KEYWORD)` |
|   6239687 |  8778 | `	 && (pTok[1].nType & PH7_TK_LPAREN)` |
|   2727690 |  8779 | `	 && (pTok[2].nType & (PH7_TK_ID\|PH7_TK_KEYWORD))` |
...
|         9 |  8801 | `}` |
|    506496 |  8802 | `static sxi32 GenStateCompileClassAttr(ph7_gen_state *pGen,sxi32 iProtection,sxi32 iFlags,ph7_class *pClass)` |
|         5 |  8803 | `{` |
|    506501 |  8804 | `	sxu32 nLine = pGen->pIn->nLine;` |
|         - |  8805 | `	ph7_class_attr *pAttr;` |
|         - |  8806 | `	SyString *pName;` |
|         - |  8807 | `	sxi32 rc;` |
|    506501 |  8808 | `	sxu32 nType = 0;` |
|         - |  8809 | `	SyString sTypeClass;` |
|         - |  8810 | `	SyString sTypeText;` |
|         - |  8811 | `	SySet aUnionAlts;` |
|    506501 |  8812 | `	sxi32 iTypeFlags = 0;` |
|    506501 |  8813 | `	SyStringInitFromBuf(&sTypeClass,0,0);` |
|    506501 |  8814 | `	SyStringInitFromBuf(&sTypeText,0,0);` |
|    506501 |  8815 | `	SySetInit(&aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
...
|    506501 |  8819 | `	if( pClass->iFlags & PH7_CLASS_READONLY ){` |
|        21 |  8820 | `		iFlags \|= PH7_CLASS_ATTR_READONLY;` |
|         9 |  8821 | `	}` |
|         - |  8822 | `	/* Extract visibility level */` |
|    506501 |  8823 | `	iProtection = GetProtectionLevel(iProtection);` |
|         - |  8824 | `	/* Parse optional type hint (typed properties, PHP 7.4+) */` |
|    514458 |  8825 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
|     15919 |  8826 | `		rc = GenStateParsePropertyType(pGen,&nType,&sTypeClass,&iTypeFlags,&sTypeText,&aUnionAlts);` |
|     15919 |  8827 | `		if( rc == SXERR_CORRUPT ){` |
|         - |  8828 | `			/* Error already reported by GenStateParseUnionTypeDecl */` |
|       ! 0 |  8829 | `			goto Synchronize;` |
|     15919 |  8830 | `		}else if( rc == SXERR_SYNTAX ){` |
...
|     15919 |  8838 | `		}else if( rc == SXERR_ABORT ){` |
|       ! 0 |  8839 | `			return SXERR_ABORT;` |
|         - |  8840 | `		}` |
|      7957 |  8841 | `	}` |
|       ! 0 |  8842 | `loop:` |
|    506505 |  8843 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
...
|         - |  8849 | `	}` |
|    506505 |  8850 | `	pGen->pIn++; /* Jump the dollar sign */` |
|    506505 |  8851 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_ID)) == 0 ){` |
...
|    506505 |  8861 | `	pName = &pGen->pIn->sData;` |
|         - |  8862 | `	/* Advance the stream cursor */` |
|    506505 |  8863 | `	pGen->pIn++;` |
|    506505 |  8864 | `	if(pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_EQUAL/*'='*/\|PH7_TK_SEMI/*';'*/\|PH7_TK_COMMA/*','*/\|PH7_TK_OCB/*'{' hooks*/)) == 0 ){` |
...
|    506503 |  8875 | `	if( iFlags & (PH7_CLASS_ATTR_PRIVATE_SET\|PH7_CLASS_ATTR_PROTECTED_SET\|PH7_CLASS_ATTR_PUBLIC_SET) ){` |
...
|    506503 |  8895 | `	if( iFlags & PH7_CLASS_ATTR_READONLY ){` |
...
|    506493 |  8915 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|     23873 |  8916 | `		rc = GenStateValidateMemberType(pGen,pClass,pName,nType,&sTypeClass,` |
|         - |  8917 | `			&sTypeText,` |
|     15912 |  8918 | `			(iTypeFlags & PH7_CLASS_ATTR_UNION) ? &aUnionAlts : 0,` |
|      7956 |  8919 | `			"Property %z::$%z cannot have type %z",nLine);` |
|     15917 |  8920 | `		if( rc == SXERR_ABORT ){` |
|       ! 0 |  8921 | `			return SXERR_ABORT;` |
|     15917 |  8922 | `		}else if( rc != SXRET_OK ){` |
|       ! 0 |  8923 | `			goto Synchronize;` |
|         - |  8924 | `		}` |
|      7956 |  8925 | `	}` |
|         - |  8926 | `	/* Reject redeclaration (catches clash with an earlier promoted property). */` |
|    506493 |  8927 | `	if( PH7_ClassExtractAttribute(pClass,pName->zString,pName->nByte) != 0 ){` |
...
|    506491 |  8941 | `	if( (pGen->pIn->nType & PH7_TK_EQUAL /*'='*/) && GenStateInitHasNewExpr(pGen) ){` |
...
|    506487 |  8950 | `	pAttr = PH7_NewClassAttr(pGen->pVm,pName,nLine,iProtection,iFlags\|iTypeFlags);` |
|    506487 |  8951 | `	if( pAttr ){` |
|    506487 |  8952 | `		GenStateConsumeDoc(&(*pGen),&pAttr->sDoc);` |
|    506487 |  8953 | `		if( GenStateConsumeAttrs(&(*pGen),&pAttr->aAttrs) == SXERR_ABORT ){` |
|       ! 0 |  8954 | `			return SXERR_ABORT;` |
|         - |  8955 | `		}` |
|    253241 |  8956 | `	}` |
|    506487 |  8957 | `	if( pAttr == 0 ){` |
|       ! 0 |  8958 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 engine is running out of memory");` |
|       ! 0 |  8959 | `		return SXERR_ABORT;` |
|         - |  8960 | `	}` |
|    506487 |  8961 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|     15915 |  8962 | `		GenStateCopyTypeToAttr(pAttr,nType,&sTypeClass,&sTypeText,iTypeFlags,&aUnionAlts);` |
|      7955 |  8963 | `	}` |
|    506487 |  8964 | `	if( pGen->pIn->nType & PH7_TK_EQUAL /*'='*/ ){` |
...
|    506487 |  9006 | `	rc = PH7_ClassInstallAttr(pClass,pAttr);` |
|    506487 |  9007 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  9008 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|       ! 0 |  9009 | `		return SXERR_ABORT;` |
|         - |  9010 | `	}` |
|    506487 |  9011 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) ){` |
...
|         - |  9023 | `	}` |
|    506393 |  9024 | `	if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
...
|         - |  9035 | `	}` |
|    506393 |  9036 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA /*','*/) ){` |
...
|         - |  9054 | `		}` |
|       ! 0 |  9055 | `	}` |
|    506389 |  9056 | `	SySetRelease(&aUnionAlts);` |
|    506389 |  9057 | `	return SXRET_OK;` |
|         9 |  9058 | `Synchronize:` |
...
|         - |  9073 | ` */` |
|   2649586 |  9074 | `static sxi32 GenStateCompileClassMethod(` |
...
|         - |  9080 | `	)` |
|         5 |  9081 | `{` |
|   2649591 |  9082 | `	sxu32 nLine = pGen->pIn->nLine;` |
|   2649591 |  9083 | `	sxu32 nKwLine = nLine; /* Line of the 'function' keyword (Reflection getStartLine) */` |
...
|   2649591 |  9090 | `	iProtection = GetProtectionLevel(iProtection);` |
|   2649591 |  9091 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|   2649591 |  9092 | `	iFuncFlags = 0;` |
|   2649591 |  9093 | `	if( pGen->pIn >= pGen->pEnd ){` |
...
|         - |  9101 | `	}` |
|   2649591 |  9102 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|         - |  9103 | `		/* Return by reference,remember that */` |
|       ! 0 |  9104 | `		iFuncFlags \|= VM_FUNC_REF_RETURN;` |
|         - |  9105 | `		/* Jump the '&' token */` |
|       ! 0 |  9106 | `		pGen->pIn++;` |
|       ! 0 |  9107 | `	}` |
|   2649591 |  9108 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|   2649591 |  9117 | `	pName = &pGen->pIn->sData;` |
|   2649591 |  9118 | `	nLine = pGen->pIn->nLine;` |
|         - |  9119 | `	/* Jump the method name */` |
|   2649591 |  9120 | `	pGen->pIn++;` |
|   2649591 |  9121 | `	if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
...
|     70022 |  9133 | `	}` |
|   2649591 |  9134 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|         - |  9135 | `		/* Syntax error */` |
...
|   2649591 |  9144 | `	pMeth = PH7_NewClassMethod(pGen->pVm,pClass,pName,nLine,iProtection,iFlags,iFuncFlags);` |
|   2649591 |  9145 | `	if( pMeth == 0 ){` |
|       ! 0 |  9146 | `		PH7_GenCompileError(&(*pGen),E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|       ! 0 |  9147 | `		return SXERR_ABORT;` |
|         - |  9148 | `	}` |
|   2649591 |  9149 | `	pMeth->sFunc.nLine = nKwLine;` |
|   2649591 |  9150 | `	GenStateConsumeDoc(&(*pGen),&pMeth->sFunc.sDoc);` |
|   2649591 |  9151 | `	if( GenStateConsumeAttrs(&(*pGen),&pMeth->sFunc.aAttrs) == SXERR_ABORT ){` |
|       ! 0 |  9152 | `		return SXERR_ABORT;` |
|         - |  9153 | `	}` |
|         - |  9154 | `	/* Jump the left parenthesis '(' */` |
|   2649591 |  9155 | `	pGen->pIn++;` |
|   2649591 |  9156 | `	pEnd = 0; /* cc warning */` |
|         - |  9157 | `	/* Delimit the method signature */` |
|   2649591 |  9158 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   2649591 |  9159 | `	if( pEnd >= pGen->pEnd ){` |
|         - |  9160 | `		/* Syntax error */` |
...
|         - |  9167 | `	}` |
|         - |  9168 | `	{` |
|   2649589 |  9169 | `		int bIsCtor = 0;` |
|   2649589 |  9170 | `		int bAbstractCtor = 0;` |
|   2649584 |  9171 | `		if( (pName->nByte == sizeof("__construct") - 1` |
|   1562129 |  9172 | `				&& SyMemcmp(pName->zString,"__construct",sizeof("__construct") - 1) == 0)` |
|   2556165 |  9173 | `		 \|\| SyStringCmp(pName,&pClass->sName,SyMemcmp) == 0 ){` |
...
|         - |  9178 | `			}` |
|     93424 |  9179 | `		}` |
|   2649589 |  9180 | `		if( pGen->pIn < pEnd ){` |
|         - |  9181 | `			/* Collect method arguments */` |
|    922197 |  9182 | `			rc = GenStateCollectFuncArgs(&pMeth->sFunc,&(*pGen),pEnd,bIsCtor,bAbstractCtor);` |
|    922197 |  9183 | `			if( rc == SXERR_ABORT ){` |
|       ! 0 |  9184 | `				return SXERR_ABORT;` |
|         - |  9185 | `			}` |
|    461096 |  9186 | `		}` |
|         - |  9187 | `	}` |
|         - |  9188 | `	/* Point past ')' and parse optional return type ': type' */` |
|   2649589 |  9189 | `	pGen->pIn = &pEnd[1];` |
|         - |  9190 | `	{` |
|   2649589 |  9191 | `		sxi32 rcRt = GenStateParseReturnType(pGen, &pMeth->sFunc);` |
|   2649589 |  9192 | `		if( rcRt == SXERR_ABORT ){` |
|       ! 0 |  9193 | `			return SXERR_ABORT;` |
|   2649589 |  9194 | `		}else if( rcRt == SXERR_SYNTAX ){` |
...
|         - |  9201 | `	{` |
|   2649589 |  9202 | `		sxu32 nArg = SySetUsed(&pMeth->sFunc.aArgs);` |
|         - |  9203 | `		sxu32 i;` |
|   4026871 |  9204 | `		for( i = 0; i < nArg; i++ ){` |
|   1377297 |  9205 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pMeth->sFunc.aArgs,i);` |
|         - |  9206 | `			ph7_class_attr *pAttr;` |
|   1377297 |  9207 | `			sxi32 iAttrFlags = 0;` |
|         - |  9208 | `			int bArgTyped;` |
|   1377297 |  9209 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|   1377211 |  9210 | `				continue;` |
|         - |  9211 | `			}` |
...
|        43 |  9306 | `		}` |
|         - |  9307 | `	}` |
|   2649579 |  9308 | `	if( doBody ){` |
|         - |  9309 | `		/* Compile method body */` |
|   2509535 |  9310 | `		rc = GenStateCompileFuncBody(&(*pGen),&pMeth->sFunc);` |
|   2509535 |  9311 | `		if( rc == SXERR_ABORT ){` |
|       ! 0 |  9312 | `			return SXERR_ABORT;` |
|         - |  9313 | `		}` |
|         - |  9314 | `		/* The cursor sits just past the body's closing brace */` |
|   2509535 |  9315 | `		pMeth->sFunc.nEndLine = pGen->pIn[-1].nLine;` |
|   1254770 |  9316 | `	}else{` |
...
|   2649579 |  9333 | `	rc = PH7_ClassInstallMethod(pClass,pMeth);` |
|   2649579 |  9334 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  9335 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|       ! 0 |  9336 | `		return SXERR_ABORT;` |
|         - |  9337 | `	}` |
|   2649579 |  9338 | `	return SXRET_OK;` |
|         6 |  9339 | `Synchronize:` |
...
|         - | 10133 | ` */` |
|    386802 | 10134 | `static sxi32 GenStateCheckInterfaceSignatures(ph7_gen_state *pGen,ph7_class *pClass)` |
|         5 | 10135 | `{` |
|         - | 10136 | `	ph7_class **apIface;` |
|         - | 10137 | `	sxu32 nIface,i;` |
|         - | 10138 | `	sxi32 rc;` |
|    386807 | 10139 | `	if( pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|       ! 0 | 10140 | `		return SXRET_OK;` |
|         - | 10141 | `	}` |
|    386807 | 10142 | `	apIface = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|    386807 | 10143 | `	nIface = SySetUsed(&pClass->aInterface);` |
|    783733 | 10144 | `	for(i = 0; i < nIface; i++){` |
...
|         - | 10266 | ` */` |
|    386802 | 10267 | `static sxi32 GenStateCheckAbstractMethods(ph7_gen_state *pGen,ph7_class *pClass)` |
|         5 | 10268 | `{` |
...
|    386807 | 10275 | `	if( pClass->iFlags & (PH7_CLASS_ABSTRACT\|PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|     19499 | 10276 | `		return SXRET_OK;` |
|         - | 10277 | `	}` |
|         - | 10278 | `	/* Count abstract methods */` |
|    367313 | 10279 | `	nAbstract = 0;` |
|    367313 | 10280 | `	SyHashResetLoopCursor(&pClass->hMethod);` |
|   5654813 | 10281 | `	while((pEntry = SyHashGetNextEntry(&pClass->hMethod)) != 0 ){` |
|   5103851 | 10282 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|   5103851 | 10283 | `		if( pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
...
|         8 | 10288 | `		}` |
|         5 | 10289 | `	}` |
|    367313 | 10290 | `	if( nAbstract == 0 ){` |
|    367299 | 10291 | `		return SXRET_OK;` |
|         - | 10292 | `	}` |
...
|         - | 10749 | ` */` |
|    386846 | 10750 | `static sxi32 GenStateCompileClassEx(ph7_gen_state *pGen,sxi32 iFlags,` |
|         - | 10751 | `	SyString *pAnonName,SyToken **ppArgStart,SyToken **ppArgEnd)` |
|         5 | 10752 | `{` |
|    386851 | 10753 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|    386851 | 10764 | `	pGen->pIn++;` |
|    386851 | 10765 | `	if( pAnonName ){` |
...
|        19 | 10780 | `	}else{` |
|    386821 | 10781 | `		if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
|         - | 10782 | `			/* Syntax error */` |
...
|    386821 | 10795 | `		pName = &pGen->pIn->sData;` |
|         - | 10796 | `		/* Advance the stream cursor */` |
|    386821 | 10797 | `		pGen->pIn++;` |
|         - | 10798 | `		/* Build FQN and obtain a raw class */ {` |
|         - | 10799 | `			SyBlob sFQN;` |
|         - | 10800 | `			SyString sFQNStr;` |
|    386821 | 10801 | `			SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|    386821 | 10802 | `			GenStateBuildFQN(pGen,pName,&sFQN);` |
|    386821 | 10803 | `			SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|    386821 | 10804 | `			pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|    386821 | 10805 | `			SyBlobRelease(&sFQN);` |
|         - | 10806 | `		}` |
|         - | 10807 | `	}` |
|    386851 | 10808 | `	if( pClass == 0 ){` |
|       ! 0 | 10809 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|       ! 0 | 10810 | `		return SXERR_ABORT;` |
|         - | 10811 | `	}` |
|    386846 | 10812 | `	if( (iFlags & PH7_CLASS_ENUM) && pGen->pIn < pGen->pEnd` |
...
|         - | 10835 | `		}` |
|      1952 | 10836 | `	}` |
|    386851 | 10837 | `	GenStateConsumeDoc(&(*pGen),&pClass->sDoc);` |
|    386851 | 10838 | `	if( GenStateConsumeAttrs(&(*pGen),&pClass->aAttrs) == SXERR_ABORT ){` |
|       ! 0 | 10839 | `		return SXERR_ABORT;` |
|         - | 10840 | `	}` |
|         - | 10841 | `	/* implemented interfaces and per-use-statement trait containers */` |
|    386851 | 10842 | `	SySetInit(&aInterfaces,&pGen->pVm->sAllocator,sizeof(ph7_class *));` |
|    386851 | 10843 | `	SySetInit(&aUseEntries,&pGen->pVm->sAllocator,sizeof(TraitUseEntry));` |
|         - | 10844 | `	/* Assume a standalone class */` |
|    386851 | 10845 | `	pBase = 0;` |
|    386851 | 10846 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
...
|     64250 | 10982 | `		}` |
|    159643 | 10983 | `	}` |
|    386849 | 10984 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|         - | 10985 | `		/* Syntax error */` |
...
|         - | 10993 | `	}` |
|    386849 | 10994 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|    386849 | 10995 | `	pEnd = 0; /* cc warning */` |
|         - | 10996 | `	/* Delimit the class body */` |
|    386849 | 10997 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|    386849 | 10998 | `	if( pEnd >= pGen->pEnd ){` |
|         - | 10999 | `		/* Syntax error */` |
...
|    386849 | 11009 | `	pClass->nEndLine = pEnd->nLine;` |
|         - | 11010 | `	/* Swap token stream */` |
|    386849 | 11011 | `	pTmp = pGen->pEnd;` |
|    386849 | 11012 | `	pGen->pEnd = pEnd;` |
|         - | 11013 | `	/* Merge the inherited flags (PH7_NewRawClass may have set INTERNAL) */` |
|    386849 | 11014 | `	pClass->iFlags \|= iFlags;` |
|         - | 11015 | `	/* Start the parse process */` |
|   1537628 | 11016 | `	for(;;){` |
|         - | 11017 | `		/* Jump leading/trailing semi-colons */` |
|   4384013 | 11018 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|    802165 | 11019 | `			pGen->pIn++;` |
|         5 | 11020 | `		}` |
|   3581853 | 11021 | `		if( pGen->pIn >= pGen->pEnd ){` |
|         - | 11022 | `			/* End of class body */` |
|    386807 | 11023 | `			break;` |
|         - | 11024 | `		}` |
|         - | 11025 | `		/* Bind a directly-preceding docblock to this member */` |
|   3195051 | 11026 | `		GenStateSetPendingDoc(&(*pGen));` |
|   3195046 | 11027 | `		if( (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR)) == 0` |
|   1597528 | 11028 | ``			&& !GenStateIsReadonly(pGen->pIn) /* allow a leading `readonly` modifier */ ){`` |
...
|   3195051 | 11039 | `		iProtection = PH7_TKWRD_PUBLIC;` |
|   3195051 | 11040 | `		iAttrflags = 0;` |
...
|   3195051 | 11045 | `		if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|       ! 0 | 11046 | `			int bMod = 0;` |
...
|         - | 11067 | `			}` |
|       ! 0 | 11068 | `		}` |
|   3195051 | 11069 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|         - | 11070 | `			/* Extract the current keyword */` |
|   3195051 | 11071 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   3195051 | 11072 | `			if( nKwrd == PH7_TKWRD_CASE && (pClass->iFlags & PH7_CLASS_ENUM) ){` |
...
|      7831 | 11081 | `				continue;` |
|         - | 11082 | `			}` |
|   3187221 | 11083 | `			if( nKwrd == PH7_TKWRD_USE ){` |
...
|         - | 11152 | `			}` |
|   3171585 | 11153 | `			if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|         - | 11154 | `				int nSetTok;` |
|   2875589 | 11155 | `				sxi32 nSetVis = GenStatePeekSetVisibility(pGen->pIn,pGen->pEnd,&nSetTok);` |
|   2875589 | 11156 | `				if( nSetVis ){` |
...
|         2 | 11161 | `				}else{` |
|   2875587 | 11162 | `					iProtection = nKwrd;` |
|   2875587 | 11163 | `					pGen->pIn++; /* Jump the visibility token */` |
|         - | 11164 | `					/* Optional asymmetric set-visibility after the read` |
|         - | 11165 | ``					 * visibility: `public private(set) int $x`. */`` |
|   2875587 | 11166 | `					nSetVis = GenStatePeekSetVisibility(pGen->pIn,pGen->pEnd,&nSetTok);` |
|   2875587 | 11167 | `					if( nSetVis ){` |
...
|   2875589 | 11174 | `				if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|        28 | 11175 | `					iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|        28 | 11176 | `					pGen->pIn++; /* Jump the 'readonly' modifier */` |
|        12 | 11177 | `				}` |
|   2875584 | 11178 | `				if( pGen->pIn >= pGen->pEnd` |
|   2875589 | 11179 | `					\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|       ! 0 | 11187 | `					goto done;` |
|         - | 11188 | `				}` |
|   2875589 | 11189 | `				if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
...
|         - | 11199 | `				}` |
|   2435607 | 11200 | `				if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|   2419727 | 11212 | `				nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   1209861 | 11213 | `			}` |
|   2715723 | 11214 | `			if( nKwrd == PH7_TKWRD_CONST ){` |
...
|         - | 11222 | `				}` |
|    143940 | 11223 | `			}else{` |
|   2427845 | 11224 | `				if( nKwrd == PH7_TKWRD_STATIC ){` |
|         - | 11225 | `					/* Static method or attribute,record that */` |
|    101283 | 11226 | `					iAttrflags \|= PH7_CLASS_ATTR_STATIC;` |
|    101283 | 11227 | `					pGen->pIn++; /* Jump the static keyword */` |
|    101283 | 11228 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|         - | 11229 | `						int nSetTok;` |
...
|    101283 | 11252 | `					if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|       ! 0 | 11253 | `						iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|       ! 0 | 11254 | `						pGen->pIn++; /* Jump the 'readonly' modifier */` |
|       ! 0 | 11255 | `					}` |
|    101278 | 11256 | `					if( pGen->pIn >= pGen->pEnd` |
|    101283 | 11257 | `						\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|       ! 0 | 11265 | `						goto done;` |
|         - | 11266 | `					}` |
|    101283 | 11267 | `					if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
...
|   2363572 | 11291 | `				}else if( nKwrd == PH7_TKWRD_ABSTRACT ){` |
...
|   2322665 | 11340 | `				}else if( nKwrd == PH7_TKWRD_FINAL ){` |
...
|         3 | 11384 | `				}` |
|   2400559 | 11385 | `				if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_VAR ){` |
...
|       ! 0 | 11393 | `						goto done;` |
|         - | 11394 | `				}` |
|   2400559 | 11395 | `				if( nKwrd == PH7_TKWRD_VAR ){` |
...
|   2400553 | 11410 | `					rc = GenStateCompileClassMethod(&(*pGen),iProtection,iAttrflags,TRUE,pClass);` |
|         - | 11411 | `				}` |
|   2400559 | 11412 | `				if( rc != SXRET_OK ){` |
...
|         - | 11435 | `		sxu32 nU;` |
|    386807 | 11436 | `		apUse = (TraitUseEntry *)SySetBasePtr(&aUseEntries);` |
|    402443 | 11437 | `		for( nU = 0 ; nU < SySetUsed(&aUseEntries) ; nU++ ){` |
...
|      7823 | 11642 | `		}` |
|         - | 11643 | `	}` |
|    386807 | 11644 | `	if( pClass->iFlags & PH7_CLASS_ENUM ){` |
...
|    386807 | 11655 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|    386807 | 11656 | `	if( rc == SXRET_OK ){` |
|         - | 11657 | `		ph7_class **apInterface;` |
|         - | 11658 | `		sxu32 n;` |
|    386807 | 11659 | `		if( pBase ){` |
|         - | 11660 | `			/* Inherit from base class and mark as a subclass */` |
|    206357 | 11661 | `			rc = PH7_ClassInherit(&(*pGen),pClass,pBase);` |
|    103176 | 11662 | `		}` |
|    386807 | 11663 | `		apInterface = (ph7_class **)SySetBasePtr(&aInterfaces);` |
|    573635 | 11664 | `		for( n = 0 ; n < SySetUsed(&aInterfaces) ; n++ ){` |
...
|    386807 | 11673 | `		if( rc == SXRET_OK && (pClass->iFlags & PH7_CLASS_ENUM) ){` |
...
|    386802 | 11693 | `		if( rc == SXRET_OK` |
|    386802 | 11694 | `		 && (pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT)) == 0` |
|    386807 | 11695 | `		 && SyHashGet(&pClass->hMethod,"__toString",sizeof("__toString")-1) != 0 ){` |
...
|    386807 | 11715 | `		if( rc == SXRET_OK ){` |
|    386807 | 11716 | `			sxi32 rcCheck = GenStateCheckInterfaceSignatures(&(*pGen),pClass);` |
|    386807 | 11717 | `			if( rcCheck == SXERR_ABORT ){` |
...
|    386807 | 11724 | `		if( rc == SXRET_OK ){` |
|    386807 | 11725 | `			sxi32 rcCheck = GenStateCheckAbstractMethods(&(*pGen),pClass);` |
|    386807 | 11726 | `			if( rcCheck == SXERR_ABORT ){` |
...
|    193401 | 11731 | `		}` |
|    193401 | 11732 | `	}` |
|    386807 | 11733 | `	SySetRelease(&aUseEntries);` |
|    386807 | 11734 | `	SySetRelease(&aInterfaces);` |
|    386807 | 11735 | `	if( rc != SXRET_OK ){` |
...
|    386849 | 11741 | `	pGen->pIn = &pEnd[1];` |
|    386849 | 11742 | `	pGen->pEnd = pTmp;` |
|    386849 | 11743 | `	return PH7_OK;` |
|    193428 | 11744 | `}` |
|         - | 11745 | `/* Compile a named class declaration (the common case). */` |
|    386816 | 11746 | `static sxi32 GenStateCompileClass(ph7_gen_state *pGen,sxi32 iFlags)` |
|         5 | 11747 | `{` |
|    386821 | 11748 | `	return GenStateCompileClassEx(pGen,iFlags,0,0,0);` |
|         5 | 11749 | `}` |
|         - | 11750 | `/*` |
...
|         - | 11849 | ` */` |
|  13665036 | 11850 | `static int GenStateTokenIsClassModifier(SyToken *pTok,sxi32 *piFlag)` |
|         5 | 11851 | `{` |
|  13665041 | 11852 | `	if( pTok->nType & PH7_TK_KEYWORD ){` |
|   8012327 | 11853 | `		sxu32 nKw = (sxu32)SX_PTR_TO_INT(pTok->pUserData);` |
|   8012327 | 11854 | `		if( nKw == PH7_TKWRD_FINAL ){ *piFlag = PH7_CLASS_FINAL; return TRUE; }` |
|   7957849 | 11855 | `		if( nKw == PH7_TKWRD_ABSTRACT ){ *piFlag = PH7_CLASS_ABSTRACT; return TRUE; }` |
|   3959429 | 11856 | `	}` |
|  13571577 | 11857 | `	if( GenStateIsReadonly(pTok) ){ *piFlag = PH7_CLASS_READONLY; return TRUE; }` |
|  13571517 | 11858 | `	return FALSE;` |
|   6832523 | 11859 | `}` |
|         - | 11860 | `/*` |
...
|         - | 11865 | ` */` |
|  13571512 | 11866 | `static sxi32 GenStateScanClassModifiers(SyToken **ppIn,SyToken *pEnd,SyToken **ppDup)` |
|         5 | 11867 | `{` |
|  13571517 | 11868 | `	SyToken *pIn = *ppIn,*pDup = 0;` |
|  13571517 | 11869 | `	sxi32 iFlags = 0,iFlag;` |
|  13665041 | 11870 | `	while( pIn < pEnd && GenStateTokenIsClassModifier(pIn,&iFlag) ){` |
...
|     93529 | 11875 | `		pIn++;` |
|         5 | 11876 | `	}` |
|  13571517 | 11877 | `	*ppIn = pIn;` |
|  13571517 | 11878 | `	if( ppDup ){ *ppDup = pDup; }` |
|  13571517 | 11879 | `	return iFlags;` |
|         5 | 11880 | `}` |
|         - | 11881 | `/*` |
...
|         - | 11887 | ` */` |
|  13528648 | 11888 | `static int GenStateStartsModifiedClass(SyToken *pIn,SyToken *pEnd)` |
|         5 | 11889 | `{` |
|  13528653 | 11890 | `	sxi32 iFlags = GenStateScanClassModifiers(&pIn,pEnd,0);` |
|   6814971 | 11891 | `	return iFlags != 0 && pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD)` |
|  13553970 | 11892 | `		&& (sxu32)SX_PTR_TO_INT(pIn->pUserData) == PH7_TKWRD_CLASS;` |
|         5 | 11893 | `}` |
|         - | 11894 | `/*` |
...
|         - | 12237 | ` */` |
|    340032 | 12238 | `static sxi32 PH7_CompileClass(ph7_gen_state *pGen)` |
|         5 | 12239 | `{` |
|         - | 12240 | `	sxi32 rc;` |
|    340037 | 12241 | `	rc = GenStateCompileClass(&(*pGen),0);` |
|    340037 | 12242 | `	return rc;` |
|         5 | 12243 | `}` |
|         - | 12244 | `/*` |
...
|         - | 12250 | ` */` |
|  13478008 | 12251 | `static int GenStateStartsEnumDecl(SyToken *pIn,SyToken *pEnd)` |
|         5 | 12252 | `{` |
|  13688666 | 12253 | `	return (pIn->nType & PH7_TK_ID)` |
|   6949657 | 12254 | `		&& pIn->sData.nByte == sizeof("enum")-1` |
|    220511 | 12255 | `		&& SyStrnicmp(pIn->sData.zString,"enum",sizeof("enum")-1) == 0` |
|  13688661 | 12256 | `		&& &pIn[1] < pEnd && (pIn[1].nType & PH7_TK_ID);` |
|         5 | 12257 | `}` |
|         - | 12258 | `/*` |
...
|         - | 13222 | ` */` |
|  51195142 | 13223 | `static void GenStatePatchNullsafeJumps(ph7_gen_state *pGen, sxu32 nBaseline)` |
|         5 | 13224 | `{` |
|  51195147 | 13225 | `	sxu32 nCur = SySetUsed(&pGen->aNullsafeJmp);` |
|         - | 13226 | `	sxu32 nTarget;` |
|         - | 13227 | `	sxu32 *aIdx;` |
|         - | 13228 | `	sxu32 i;` |
|  51195147 | 13229 | `	if( nCur <= nBaseline ){` |
|  51195051 | 13230 | `		return;` |
|         - | 13231 | `	}` |
...
|         - | 13259 | ` */` |
|   6578560 | 13260 | `static sxu32 GenStateByRefBuiltinMask(SyString *pName)` |
|         5 | 13261 | `{` |
...
|         - | 13277 | `	};` |
|         - | 13278 | `	sxu32 i;` |
|   6578565 | 13279 | `	if( pName == 0 \|\| pName->zString == 0 \|\| pName->nByte == 0 ){` |
|   1754689 | 13280 | `		return 0;` |
|         - | 13281 | `	}` |
...
|         - | 13299 | ` */` |
|   6578560 | 13300 | `static void GenStateCallBuiltinName(ph7_expr_node *pLeft, SyString *pOut)` |
|         5 | 13301 | `{` |
|         - | 13302 | `	SyToken *p, *pEnd;` |
|   6578565 | 13303 | `	pOut->zString = 0;` |
|   6578565 | 13304 | `	pOut->nByte = 0;` |
|   6578565 | 13305 | `	if( pLeft == 0 \|\| pLeft->pStart == 0 \|\| pLeft->pEnd == 0 ){` |
|       ! 0 | 13306 | `		return;` |
|         - | 13307 | `	}` |
|   6578565 | 13308 | `	p = pLeft->pStart;` |
|   6578565 | 13309 | `	pEnd = pLeft->pEnd;` |
|         - | 13310 | `	/* Optional single leading namespace separator (absolute path). */` |
|   6578565 | 13311 | `	if( p < pEnd && (p->nType & PH7_TK_NSSEP) ){` |
|      3931 | 13312 | `		p++;` |
|      1963 | 13313 | `	}` |
|   6578565 | 13314 | `	if( p >= pEnd \|\| (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|   1754643 | 13315 | `		return;` |
|         - | 13316 | `	}` |
...
|         - | 13328 | ` * error message.` |
|         - | 13329 | ` */` |
|  71676506 | 13330 | `static sxi32 GenStateEmitExprCode(` |
...
|         - | 13337 | `	sxu32 nJmpIdx;` |
|  71676511 | 13338 | `	sxi32 iP1 = 0;` |
|  71676511 | 13339 | `	sxu32 iP2 = 0;` |
|  71676511 | 13340 | `	void *p3  = 0;` |
|         - | 13341 | `	sxi32 iVmOp;` |
|         - | 13342 | `	sxi32 rc;` |
|  71676511 | 13343 | `	int bIsChainOp = 0; /* Set below once we know pNode->pOp */` |
|  71676511 | 13344 | ``	int bFcc = 0;       /* First-class callable `f(...)`: emit OP_LOAD_FCC, not OP_CALL */`` |
|  71676511 | 13345 | `	sxu32 nRhsNsBase = 0;` |
|  71676511 | 13346 | `	if( pNode->xCode ){` |
|         - | 13347 | `		SyToken *pTmpIn,*pTmpEnd;` |
|         - | 13348 | `		/* Compile node */` |
|  43176919 | 13349 | `		SWAP_DELIMITER(pGen,pNode->pStart,pNode->pEnd);` |
|  43176919 | 13350 | `		rc = pNode->xCode(&(*pGen),iFlags);` |
|  43176919 | 13351 | `		RE_SWAP_DELIMITER(pGen);` |
|  43176919 | 13352 | `		return rc;` |
|         - | 13353 | `	}` |
|  28499597 | 13354 | `	if( pNode->pOp == 0 ){` |
...
|         - | 13358 | `	}` |
|  28499597 | 13359 | `	iVmOp = pNode->pOp->iVmOp;` |
|  28499597 | 13360 | `	if( iVmOp == PH7_OP_CVT_NULL ){` |
...
|         - | 13368 | `		}` |
|         1 | 13369 | `	}` |
|  28499597 | 13370 | `	if( pNode->pOp->iOp == EXPR_OP_NULLC_ASSIGN ){` |
...
|         - | 13419 | `	}` |
|  28499507 | 13420 | `	if( pNode->pOp->iOp == EXPR_OP_QUESTY ){` |
...
|         - | 13482 | `	}` |
|  28021773 | 13483 | `	if( pNode->pOp->iOp == EXPR_OP_PIPE ){` |
...
|         - | 13515 | `	}` |
|  28021747 | 13516 | `	bIsChainOp = GEN_IS_CHAIN_OP(pNode->pOp->iOp);` |
|         - | 13517 | `	/* Generate code for the left tree */` |
|  28021747 | 13518 | `	if( pNode->pLeft ){` |
|  27979175 | 13519 | `		sxu32 nLhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  27979175 | 13520 | `		if( iVmOp == PH7_OP_CALL ){` |
|         - | 13521 | `			ph7_expr_node **apNode;` |
|   6582779 | 13522 | `			int hasSpread = 0;` |
|   6582779 | 13523 | `			int hasNamed = 0;` |
|   6582779 | 13524 | `			int bAnySpread = 0;` |
|   6582779 | 13525 | `			sxu32 byRefMask = 0;` |
|         - | 13526 | `			sxi32 nArgs;` |
|         - | 13527 | `			sxi32 n;` |
|         - | 13528 | `			/* Recurse and generate bytecodes for function arguments */` |
|   6582779 | 13529 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|   6582779 | 13530 | `			nArgs = (sxi32)SySetUsed(&pNode->aNodeArgs);` |
...
|   6582779 | 13534 | `			if( nArgs == 1 && apNode[0] && (apNode[0]->iFlags & EXPR_NODE_FCC) ){` |
|        81 | 13535 | `				bFcc = 1;` |
|        81 | 13536 | `				nArgs = 0;` |
|        40 | 13537 | `			}` |
...
|         - | 13540 | `			{` |
|   6582779 | 13541 | `				int seenNamed = 0;` |
|   6582779 | 13542 | `				int seenSpread = 0;` |
|  13786421 | 13543 | `				for( n = 0; n < nArgs; ++n ){` |
|   7203649 | 13544 | `					if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
...
|         5 | 13551 | `						}` |
|   7201608 | 13552 | `					}else if( apNode[n]->iFlags & EXPR_NODE_NAMED_ARG ){` |
|       289 | 13553 | `						seenNamed = 1;` |
|       289 | 13554 | `						hasNamed = 1;` |
|   7199425 | 13555 | `					}else if( seenNamed ){` |
...
|   7199281 | 13559 | `					}else if( seenSpread ){` |
...
|   6582777 | 13567 | `			iFlags \|= EXPR_FLAG_RDONLY_LOAD;` |
...
|   6582777 | 13572 | `			if( pNode->pLeft && pNode->pLeft->pStart ){` |
|   6582777 | 13573 | `				SyString *pCallName = &pNode->pLeft->pStart->sData;` |
|   6582772 | 13574 | `				if( pCallName->nByte == 5` |
|   3683589 | 13575 | `				 && SyStrnicmp(pCallName->zString,"isset",5) == 0 ){` |
|    326985 | 13576 | `					iFlags \|= EXPR_FLAG_LOAD_IDX_ISSET;` |
|   6419287 | 13577 | `				}else if( pCallName->nByte == 5` |
|   3356609 | 13578 | `				 && SyStrnicmp(pCallName->zString,"empty",5) == 0 ){` |
...
|   6582777 | 13587 | `				if( !bAnySpread && !hasNamed ){` |
|         - | 13588 | `					SyString sBuiltin;` |
|   6578565 | 13589 | `					GenStateCallBuiltinName(pNode->pLeft, &sBuiltin);` |
|   6578565 | 13590 | `					byRefMask = GenStateByRefBuiltinMask(&sBuiltin);` |
|   3289280 | 13591 | `				}` |
|   3291386 | 13592 | `			}` |
|  13786417 | 13593 | `			for( n = 0 ; n < nArgs ; ++n ){` |
|   7203645 | 13594 | `				sxu32 nArgNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|   7203645 | 13595 | `				sxi32 iArgFlags = iFlags & ~(EXPR_FLAG_LOAD_IDX_STORE\|EXPR_FLAG_MEMBER_WRITE);` |
...
|   7203645 | 13602 | `				if( n < 31 && (byRefMask & (1u<<n)) ){` |
|     38971 | 13603 | `					iArgFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|     38971 | 13604 | `					iArgFlags \|= EXPR_FLAG_LOAD_IDX_STORE;` |
|     19483 | 13605 | `				}` |
|   7203645 | 13606 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iArgFlags);` |
|   7203645 | 13607 | `				if( rc != SXRET_OK ){` |
|       ! 0 | 13608 | `					return rc;` |
|         - | 13609 | `				}` |
|         - | 13610 | `				/* Each argument is an independent nullsafe scope. */` |
|   7203645 | 13611 | `				GenStatePatchNullsafeJumps(pGen, nArgNsBase);` |
|   7203645 | 13612 | `				if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
...
|   6582777 | 13655 | `			iFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|   3291386 | 13656 | `		}` |
|         - | 13657 | `		{` |
...
|  27979173 | 13666 | `			sxi32 iLeftFlags = iFlags;` |
|  27979168 | 13667 | `			if( pNode->pLeft && pNode->pLeft->pOp` |
|  22941869 | 13668 | `				&& (pNode->pLeft->pOp->iOp == EXPR_OP_ARROW` |
|   8952311 | 13669 | `					\|\| pNode->pLeft->pOp->iOp == EXPR_OP_NULLSAFE_ARROW` |
|   7717553 | 13670 | `					\|\| pNode->pLeft->pOp->iOp == EXPR_OP_DC) ){` |
|   2664515 | 13671 | `				iLeftFlags &= ~EXPR_FLAG_LOAD_IDX_UNSET;` |
|   1332255 | 13672 | `			}` |
...
|  27979168 | 13680 | `			if( pNode->pOp` |
|  39451888 | 13681 | `				&& (pNode->pOp->iOp == EXPR_OP_ARROW` |
|  25462351 | 13682 | `					\|\| pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW` |
|  22945482 | 13683 | `					\|\| pNode->pOp->iOp == EXPR_OP_DC) ){` |
|   5439127 | 13684 | `				iLeftFlags &= ~EXPR_FLAG_MEMBER_WRITE;` |
|   2719561 | 13685 | `			}` |
...
|  27979168 | 13692 | `			if( pNode->pOp` |
|  27979173 | 13693 | `				&& (pNode->pOp->iVmOp == PH7_OP_INCR \|\| pNode->pOp->iVmOp == PH7_OP_DECR) ){` |
...
|  27979168 | 13703 | `			if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLC` |
|  14018827 | 13704 | `				&& pNode->pLeft && pNode->pLeft->pOp` |
...
|        19 | 13709 | `			}` |
|  27979173 | 13710 | `			if( iVmOp == PH7_OP_ERR_CTRL ){` |
...
|      7906 | 13714 | `			}` |
|  27979173 | 13715 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pLeft,iLeftFlags);` |
|         - | 13716 | `		}` |
|  27979173 | 13717 | `		if( rc != SXRET_OK ){` |
|        34 | 13718 | `			return rc;` |
|         - | 13719 | `		}` |
|  27979143 | 13720 | `		if( !bIsChainOp ){` |
...
|  12979429 | 13723 | `			GenStatePatchNullsafeJumps(pGen, nLhsNsBase);` |
|   6489712 | 13724 | `		}` |
|  27979143 | 13725 | `		if( iVmOp == PH7_OP_CALL ){` |
|   6582777 | 13726 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|   6582777 | 13727 | `			if( pInstr ){` |
|   6582777 | 13728 | `				if ( pInstr->iOp == PH7_OP_LOADC ){` |
...
|        49 | 13769 | `						}` |
|         - | 13770 | `					}` |
|   4170692 | 13771 | `				}else if( (pInstr->iOp == PH7_OP_MEMBER /* $a->b(1,2,3) */` |
|   1748532 | 13772 | `						&& !(pNode->pLeft && (pNode->pLeft->iFlags & EXPR_NODE_PARENS)))` |
|    889378 | 13773 | `					\|\| pInstr->iOp == PH7_OP_NEW ){` |
...
|   1738469 | 13789 | `					if( pInstr->iOp == PH7_OP_MEMBER && pInstr->iP1 == 1 && pInstr->p3 ){` |
...
|    869232 | 13795 | `				}` |
|   3291391 | 13796 | `			}` |
|  24687757 | 13797 | `		}else if( iVmOp == PH7_OP_LOAD_IDX ){` |
...
|    549185 | 13831 | `				iP2 = 1;` |
|    274595 | 13832 | `			}` |
|  19907461 | 13833 | `		}else if( pNode->pOp->iOp == EXPR_OP_COMMA ){` |
|         - | 13834 | `			/* POP the left node */` |
|         5 | 13835 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|         2 | 13836 | `		}` |
|  13989569 | 13837 | `	}` |
|  28021715 | 13838 | `	rc = SXRET_OK;` |
|  28021715 | 13839 | `	nJmpIdx = 0;` |
...
|  28021715 | 13843 | `	if( iVmOp == PH7_OP_MEMBER && pNode->pOp->iOp == EXPR_OP_DC ){` |
|    440383 | 13844 | `		pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|    440383 | 13845 | `		if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|    440383 | 13846 | `			ph7_value *pLitCheck = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,(sxu32)pInstr->iP2);` |
|    440383 | 13847 | `			int isSpecial = 0;` |
|    440383 | 13848 | `			if( pLitCheck && (pLitCheck->iFlags & MEMOBJ_STRING) ){` |
|    370359 | 13849 | `				const char *z = (const char *)SyBlobData(&pLitCheck->sBlob);` |
|    370359 | 13850 | `				sxu32 n = (sxu32)SyBlobLength(&pLitCheck->sBlob);` |
|    370354 | 13851 | `				if( (n == 4 && SyMemcmp(z,"self",4) == 0) \|\|` |
|    331386 | 13852 | `					(n == 6 && SyMemcmp(z,"static",6) == 0) \|\|` |
|    179299 | 13853 | `					(n == 6 && SyMemcmp(z,"parent",6) == 0) ){` |
|    136273 | 13854 | `					isSpecial = 1;` |
|     68134 | 13855 | `				}` |
|    202683 | 13856 | `			}` |
|    475395 | 13857 | `			pInstr->iP1 = 0;` |
...
|         - | 13863 | `			{` |
|    678078 | 13864 | `				int bAbsolute = (pNode->pLeft && pNode->pLeft->pStart` |
|    608049 | 13865 | `					&& (pNode->pLeft->pStart->nType & PH7_TK_NSSEP));` |
|    405371 | 13866 | `				if( !isSpecial && !bAbsolute ){` |
|    269085 | 13867 | `					pInstr->iP2 = (sxi32)GenStateNsQualifyName(pGen,(sxu32)pInstr->iP2,&pGen->hUseImports,0);` |
|    134540 | 13868 | `				}` |
|         - | 13869 | `			}` |
...
|    405371 | 13872 | `			if( !isSpecial && pNode->pRight && pNode->pRight->pStart ){` |
|    269103 | 13873 | `				SyToken *pRightTok = pNode->pRight->pStart;` |
|    269103 | 13874 | `				if( (pRightTok->nType & PH7_TK_KEYWORD) &&` |
...
|  27986647 | 13882 | `	if( pNode->pRight ){` |
|  16161681 | 13883 | `		if( iVmOp == PH7_OP_LAND ){` |
...
|  15939803 | 13886 | `		}else if (iVmOp == PH7_OP_LOR ){` |
...
|  15558436 | 13889 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLC ){` |
...
|  15369756 | 13893 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW ){` |
...
|  15340409 | 13903 | `		}else if( pNode->pOp->iPrec == 18 /* Combined binary operators [i.e: =,'.=','+=',*=' ...] precedence */ ){` |
...
|   5078545 | 13907 | `			iFlags \|= EXPR_FLAG_LOAD_IDX_STORE \| EXPR_FLAG_MEMBER_WRITE;` |
|   2539270 | 13908 | `		}` |
|  16161681 | 13909 | `		nRhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  16161681 | 13910 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pRight,iFlags);` |
|  16161681 | 13911 | `		if( !bIsChainOp ){` |
|         - | 13912 | `			/* Non-chain parent: RHS nullsafe chain ends here, before the` |
|         - | 13913 | `			 * operator instruction is emitted. */` |
|  10722633 | 13914 | `			GenStatePatchNullsafeJumps(pGen, nRhsNsBase);` |
|   5361314 | 13915 | `		}` |
|  16161681 | 13916 | `		if( iVmOp == PH7_OP_STORE ){` |
|   4627193 | 13917 | `			if( pNode->pRight && (pNode->pRight->xCode == PH7_CompileList \|\|` |
|   4627156 | 13918 | `				pNode->pRight->xCode == PH7_CompileShortList) ){` |
...
|         - | 13924 | `				 */` |
|        91 | 13925 | `				iVmOp = 0;` |
|   4627150 | 13926 | `			}else if( (pInstr = PH7_VmPeekInstr(pGen->pVm)) != 0 ){` |
|   4627107 | 13927 | `				if(pInstr->iOp == PH7_OP_MEMBER ){` |
|         - | 13928 | `					/* Perform a member store operation [i.e: $this->x = 50] */` |
|    856107 | 13929 | `					iP2 = 1;` |
|    428056 | 13930 | `				}else{` |
|   3771005 | 13931 | `					if( pInstr->iOp == PH7_OP_LOAD_IDX ){` |
...
|    264826 | 13935 | `					}else{` |
|   3241363 | 13936 | `						p3 = pInstr->p3;` |
|         - | 13937 | `					}` |
|         - | 13938 | `					/* POP the last dynamic load instruction */` |
|   3771005 | 13939 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|         - | 13940 | `				}` |
|   2313556 | 13941 | `			}` |
|  13848087 | 13942 | `		}else if( iVmOp == PH7_OP_STORE_REF ){` |
...
|        30 | 13957 | `		}` |
|   8080838 | 13958 | `	}` |
|  27986642 | 13959 | `	if( iVmOp == PH7_OP_NEW && pNode->pLeft && pNode->pLeft->pOp == 0` |
|    394430 | 13960 | `		&& pNode->pLeft->xCode == PH7_CompileAnnonClass ){` |
...
|        34 | 13963 | `		iVmOp = 0;` |
|        15 | 13964 | `	}` |
|  27986647 | 13965 | `	if( iVmOp > 0 ){` |
|  27928041 | 13966 | `		if( iVmOp == PH7_OP_INCR \|\| iVmOp == PH7_OP_DECR ){` |
|    210457 | 13967 | `			if( pNode->iFlags & EXPR_NODE_PRE_INCR ){` |
|         - | 13968 | `				/* Pre-increment/decrement operator [i.e: ++$i,--$j ] */` |
|     15589 | 13969 | `				iP1 = 1;` |
|      7797 | 13970 | `			}` |
|  27822815 | 13971 | `		}else if( iVmOp == PH7_OP_NEW ){` |
|         - | 13972 | `			/* Namespace-qualify the class name for NEW */ {` |
|    796053 | 13973 | `				VmInstr *pPeek = PH7_VmPeekInstr(pGen->pVm);` |
|    796053 | 13974 | `				VmInstr *pCallInstr = 0;` |
|    796053 | 13975 | `				if( pPeek && pPeek->iOp == PH7_OP_CALL ){` |
|    788155 | 13976 | `					pCallInstr = pPeek;` |
|    788155 | 13977 | `					pPeek = PH7_VmPeekNextInstr(pGen->pVm);` |
|    394075 | 13978 | `				}` |
|    796053 | 13979 | `				if( pPeek && pPeek->iOp == PH7_OP_LOADC ){` |
|    780495 | 13980 | `					int bAbsolute = (pPeek->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|         - | 13981 | `					sxu32 nLitForClass;` |
|    780495 | 13982 | `					VmCallArgMap *pCallNsMap = pCallInstr ? (VmCallArgMap *)pCallInstr->p3 : 0;` |
...
|    780495 | 13989 | `					if( pCallNsMap && pCallNsMap->nOrigNameLit > 0 ){` |
|        55 | 13990 | `						nLitForClass = pCallNsMap->nOrigNameLit - 1;` |
|        30 | 13991 | `					}else{` |
|    780445 | 13992 | `						nLitForClass = (sxu32)pPeek->iP2;` |
|         - | 13993 | `					}` |
|    780495 | 13994 | `					pPeek->iP1 = 0;` |
|    780495 | 13995 | `					if( !bAbsolute ){` |
...
|    776579 | 14000 | `						ph7_value *pLitChk = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,nLitForClass);` |
|    776579 | 14001 | `						int isSpecialNew = 0;` |
|    776579 | 14002 | `						if( pLitChk && (pLitChk->iFlags & MEMOBJ_STRING) ){` |
|    761423 | 14003 | `							const char *z = (const char *)SyBlobData(&pLitChk->sBlob);` |
|    761423 | 14004 | `							sxu32 n = (sxu32)SyBlobLength(&pLitChk->sBlob);` |
|    761418 | 14005 | `							if( (n == 4 && SyMemcmp(z,"self",4) == 0) \|\|` |
|    765153 | 14006 | `								(n == 6 && SyMemcmp(z,"static",6) == 0) \|\|` |
|    380656 | 14007 | `								(n == 6 && SyMemcmp(z,"parent",6) == 0) ){` |
|      7815 | 14008 | `								isSpecialNew = 1;` |
|      3905 | 14009 | `							}` |
|    384498 | 14010 | `						}` |
|    784157 | 14011 | `						if( isSpecialNew ){` |
|      7815 | 14012 | `							pPeek->iP2 = (sxi32)nLitForClass;` |
|      3910 | 14013 | `						}else{` |
|    761191 | 14014 | `							pPeek->iP2 = (sxi32)GenStateNsQualifyName(pGen,nLitForClass,&pGen->hUseImports,0);` |
|         - | 14015 | `						}` |
|    384503 | 14016 | `					}else{` |
...
|    386456 | 14019 | `				}` |
|         - | 14020 | `			}` |
|    788475 | 14021 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|    788475 | 14022 | `			if( pInstr && pInstr->iOp == PH7_OP_CALL ){` |
|         - | 14023 | `				VmInstr *pPrev;` |
|    788155 | 14024 | `				pPrev = PH7_VmPeekNextInstr(pGen->pVm);` |
|    788155 | 14025 | `				if( pPrev == 0 \|\| pPrev->iOp != PH7_OP_MEMBER ){` |
...
|    788155 | 14029 | `					iP1 = pInstr->iP1;` |
|    788155 | 14030 | `					iP2 = pInstr->iP2;` |
|    788155 | 14031 | `					if( pInstr->p3 ){` |
|        65 | 14032 | `						p3 = pInstr->p3; /* Transfer VmCallArgMap to NEW */` |
|        30 | 14033 | `					}` |
|    788155 | 14034 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|    394075 | 14035 | `				}` |
|    394080 | 14036 | `			}` |
|  27315776 | 14037 | `		}else if( iVmOp == PH7_OP_IS_A ){` |
...
|     39014 | 14057 | `				}` |
|     39029 | 14058 | `			}` |
|  26882517 | 14059 | `		}else if( iVmOp == PH7_OP_MEMBER){` |
...
|   5439053 | 14063 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|   5439053 | 14064 | `			if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|   5201787 | 14065 | `				pInstr->iP1 = 0;` |
|   2600891 | 14066 | `			}` |
|   5439053 | 14067 | `			if( pNode->pOp->iOp == EXPR_OP_DC /* '::' */){` |
|         - | 14068 | `				/* Static member access,remember that */` |
|    405315 | 14069 | `				iP1 = 1;` |
|    405315 | 14070 | `				pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|    405315 | 14071 | `				if( pInstr && pInstr->iOp == PH7_OP_LOAD ){` |
...
|   5439053 | 14080 | `			if( iP2 == PH7_MEMBER_READ ){` |
|   5439053 | 14081 | `				if( iFlags & EXPR_FLAG_LOAD_IDX_UNSET ){` |
|        42 | 14082 | `					iP2 = PH7_MEMBER_UNSET;` |
|   5439033 | 14083 | `				}else if( iFlags & EXPR_FLAG_LOAD_IDX_ISSET ){` |
|     62353 | 14084 | `					iP2 = PH7_MEMBER_ISSET;` |
|   5407839 | 14085 | `				}else if( iFlags & EXPR_FLAG_LOAD_IDX_EMPTY ){` |
|        17 | 14086 | `					iP2 = PH7_MEMBER_EMPTY;` |
|   5376657 | 14087 | `				}else if( iFlags & EXPR_FLAG_MEMBER_WRITE ){` |
|         - | 14088 | `					/* Write-lvalue base ($o->arr[$k]=v, $o->p ??= v): auto-create a missing prop. */` |
|   1042917 | 14089 | `					iP2 = PH7_MEMBER_WRITE;` |
|    521456 | 14090 | `				}` |
|   2719524 | 14091 | `			}` |
|   2719524 | 14092 | `		}` |
...
|  27920463 | 14120 | `		if( iVmOp == PH7_OP_CALL \|\| iVmOp == PH7_OP_NEW ){` |
|   7371167 | 14121 | `			p3 = GenStateAttachStrictFlag(pGen,p3);` |
|   3685581 | 14122 | `		}` |
|         - | 14123 | `		/* Finally,emit the VM instruction associated with this operator */` |
|  27920463 | 14124 | `		PH7_VmEmitInstr(pGen->pVm,iVmOp,iP1,iP2,p3,0);` |
|  13960229 | 14125 | `	}` |
|  27979069 | 14126 | `	if( nJmpIdx > 0 ){` |
...
|         - | 14156 | ` */` |
| 237451144 | 14157 | `static int GenStateTreeHasComma(ph7_expr_node *pNode)` |
|         5 | 14158 | `{` |
|         - | 14159 | `	ph7_expr_node **apArg;` |
|         - | 14160 | `	sxu32 n;` |
| 237451149 | 14161 | `	if( pNode == 0 ){` |
| 166867987 | 14162 | `		return 0;` |
|         - | 14163 | `	}` |
|  70583167 | 14164 | `	if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_COMMA ){` |
|         6 | 14165 | `		return 1;` |
|         - | 14166 | `	}` |
|  70583158 | 14167 | `	if( GenStateTreeHasComma(pNode->pLeft) \|\| GenStateTreeHasComma(pNode->pRight)` |
|  70583159 | 14168 | `	 \|\| GenStateTreeHasComma(pNode->pCond) ){` |
|         6 | 14169 | `		return 1;` |
|         - | 14170 | `	}` |
|  70583159 | 14171 | `	apArg = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  80507667 | 14172 | `	for( n = 0 ; n < SySetUsed(&pNode->aNodeArgs) ; n++ ){` |
|   9924513 | 14173 | `		if( GenStateTreeHasComma(apArg[n]) ){` |
|       ! 0 | 14174 | `			return 1;` |
|         - | 14175 | `		}` |
|   4962259 | 14176 | `	}` |
|  70583159 | 14177 | `	return 0;` |
| 118725577 | 14178 | `}` |
|  16139382 | 14179 | `static sxi32 PH7_CompileExpr(` |
...
|  16139387 | 14193 | `	nExpr = 0;` |
|  16139387 | 14194 | `	pRoot = 0;` |
...
|  16139387 | 14197 | `	nNullsafeBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  16139387 | 14198 | `	SySetInit(&sExprNode,&pGen->pVm->sAllocator,sizeof(ph7_expr_node *));` |
|  16139387 | 14199 | `	SySetAlloc(&sExprNode,0x10);` |
|  16139387 | 14200 | `	rc = SXRET_OK;` |
|         - | 14201 | `	/* Delimit the expression */` |
|  16139387 | 14202 | `	pEnd = pGen->pIn;` |
|  16139387 | 14203 | `	iNest = 0;` |
| 126303049 | 14204 | `	while( pEnd < pGen->pEnd ){` |
| 120143651 | 14205 | `		if( pEnd->nType & PH7_TK_OCB /* '{' */ ){` |
|         - | 14206 | `			/* Ticket 1433-30: Annonymous/Closure functions body */` |
|      4745 | 14207 | `			iNest++;` |
| 120141281 | 14208 | `		}else if(pEnd->nType & PH7_TK_CCB /* '}' */ ){` |
|      4753 | 14209 | `			iNest--;` |
| 120136537 | 14210 | `		}else if( pEnd->nType & PH7_TK_SEMI /* ';' */ ){` |
|   9980877 | 14211 | `			if( iNest <= 0 ){` |
|   9979989 | 14212 | `				break;` |
|         - | 14213 | `			}` |
|       444 | 14214 | `		}` |
| 110163667 | 14215 | `		pEnd++;` |
|         5 | 14216 | `	}` |
|  16139387 | 14217 | `	if( iFlags & EXPR_FLAG_COMMA_STATEMENT ){` |
...
|         1 | 14235 | `		}` |
|    362128 | 14236 | `	}` |
|  16139387 | 14237 | `	if( pEnd > pGen->pIn ){` |
|  16116051 | 14238 | `		SyToken *pTmp = pGen->pEnd;` |
|         - | 14239 | `		/* Swap delimiter */` |
|  16116051 | 14240 | `		pGen->pEnd = pEnd;` |
|         - | 14241 | `		/* Try to get an expression tree */` |
|  16116051 | 14242 | `		rc = PH7_ExprMakeTree(&(*pGen),&sExprNode,&pRoot);` |
|  16116046 | 14243 | `		if( rc == SXRET_OK && pRoot && pGen->nCommaExprOk < 1` |
|  15946521 | 14244 | `		 && GenStateTreeHasComma(pRoot) ){` |
...
|         - | 14257 | `		}` |
|  16116047 | 14258 | `		if( rc == SXRET_OK && pRoot ){` |
|  16115863 | 14259 | `			rc = SXRET_OK;` |
|  16115863 | 14260 | `			if( xTreeValidator ){` |
|         - | 14261 | `				/* Call the upper layer validator callback */` |
|   1001081 | 14262 | `				rc = xTreeValidator(&(*pGen),pRoot);` |
|    500538 | 14263 | `			}` |
|  16115863 | 14264 | `			if( rc != SXERR_ABORT ){` |
|         - | 14265 | `				/* Generate code for the given tree */` |
|  16115863 | 14266 | `				rc = GenStateEmitExprCode(&(*pGen),pRoot,iFlags);` |
|         - | 14267 | `				/* Patch any unresolved nullsafe jumps emitted by this` |
|         - | 14268 | `				 * expression so they short-circuit to its end. */` |
|  16115863 | 14269 | `				GenStatePatchNullsafeJumps(pGen, nNullsafeBase);` |
|   8057929 | 14270 | `			}` |
|  16115863 | 14271 | `			nExpr = 1;` |
|   8057929 | 14272 | `		}` |
|         - | 14273 | `		/* Release the whole tree */` |
|  16116047 | 14274 | `		PH7_ExprFreeTree(&(*pGen),&sExprNode);` |
|         - | 14275 | `		/* Synchronize token stream */` |
|  16116047 | 14276 | `		pGen->pEnd = pTmp;` |
|  16116047 | 14277 | `		pGen->pIn  = pEnd;` |
|  16116047 | 14278 | `		if( rc == SXERR_ABORT ){` |
|        13 | 14279 | `			SySetRelease(&sExprNode);` |
|        13 | 14280 | `			return SXERR_ABORT;` |
|         - | 14281 | `		}` |
|   8058016 | 14282 | `	}` |
|  16139373 | 14283 | `	SySetRelease(&sExprNode);` |
|  16139373 | 14284 | `	return nExpr > 0 ? SXRET_OK : SXERR_EMPTY;` |
|   8069696 | 14285 | `}` |
|         - | 14286 | `/*` |
|         - | 14287 | ` * Return a pointer to the node construct handler associated` |
|         - | 14288 | ` * with a given node type [i.e: string,integer,float,...].` |
|         - | 14289 | ` */` |
|   9202490 | 14290 | `PH7_PRIVATE ProcNodeConstruct PH7_GetNodeHandler(sxu32 nNodeType)` |
|         5 | 14291 | `{` |
|   9202495 | 14292 | `	if( nNodeType & PH7_TK_NUM ){` |
|         - | 14293 | `		/* Numeric literal: Either real or integer */` |
|   3774827 | 14294 | `		return PH7_CompileNumLiteral;` |
|   5427673 | 14295 | `	}else if( nNodeType & PH7_TK_DSTR ){` |
|         - | 14296 | `		/* Double quoted string */` |
|    126295 | 14297 | `		return PH7_CompileString;` |
|   5301383 | 14298 | `	}else if( nNodeType & PH7_TK_SSTR ){` |
|         - | 14299 | `		/* Single quoted string */` |
|   5301259 | 14300 | `		return PH7_CompileSimpleString;` |
...
|         - | 14456 | ` */` |
|   7825296 | 14457 | `static ProcLangConstruct GenStateGetStatementHandler(` |
|         - | 14458 | `	sxu32 nKeywordID,   /* Keyword  ID*/` |
|         - | 14459 | `	SyToken *pLookahed  /* Look-ahead token */` |
|         - | 14460 | `	)` |
|         5 | 14461 | `{` |
|   7825301 | 14462 | `	sxu32 n = 0;` |
|  31091535 | 14463 | `	for(;;){` |
|  62183075 | 14464 | `		if( n >= SX_ARRAYSIZE(aLangConstruct) ){` |
|    469045 | 14465 | `			break;` |
|         - | 14466 | `		}` |
|  61714035 | 14467 | `		if( aLangConstruct[n].nID == nKeywordID ){` |
|   7356261 | 14468 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed && (pLookahed->nType & PH7_TK_OP)){` |
...
|         - | 14473 | `				}` |
|       ! 0 | 14474 | `			}` |
|   7356256 | 14475 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed` |
...
|         - | 14482 | `			*/` |
|   7356259 | 14483 | `			return aLangConstruct[n].xConstruct;` |
|         - | 14484 | `		}` |
|  54357779 | 14485 | `		n++;` |
|         5 | 14486 | `	}` |
|    469045 | 14487 | `	if( pLookahed ){` |
|    469045 | 14488 | `		if(nKeywordID == PH7_TKWRD_INTERFACE && (pLookahed->nType & PH7_TK_ID) ){` |
|     70109 | 14489 | `			return PH7_CompileClassInterface;` |
|    398941 | 14490 | `		}else if(nKeywordID == PH7_TKWRD_CLASS && (pLookahed->nType & PH7_TK_ID) ){` |
|    340037 | 14491 | `			return PH7_CompileClass;` |
|     58909 | 14492 | `		}else if(nKeywordID == PH7_TKWRD_TRAIT && (pLookahed->nType & PH7_TK_ID) ){` |
|      7873 | 14493 | `			return PH7_CompileTrait;` |
|         - | 14494 | `		}` |
...
|         - | 14537 | ` */` |
|  17034908 | 14538 | `static void GenStateSetPendingDoc(ph7_gen_state *pGen)` |
|         5 | 14539 | `{` |
|  17034913 | 14540 | `	SyToken *pBase = (SyToken *)SySetBasePtr(pGen->pTokenSet);` |
|  17034913 | 14541 | `	ph7_trivia *aT = (ph7_trivia *)SySetBasePtr(&pGen->aTrivia);` |
|  17034913 | 14542 | `	sxu32 nT = SySetUsed(&pGen->aTrivia);` |
|         - | 14543 | `	sxu32 nIdx, n;` |
|  17034908 | 14544 | `	if( nT < 1 \|\| pGen->pTokenSet == 0` |
...
|         - | 14569 | ` */` |
|   4470846 | 14570 | `static void GenStateConsumeDoc(ph7_gen_state *pGen,SyString *pOut)` |
|         5 | 14571 | `{` |
|         - | 14572 | `	char *zDup;` |
|   4470851 | 14573 | `	if( SyStringLength(&pGen->sPendingDoc) < 1 ){` |
|   4470831 | 14574 | `		return;` |
|         - | 14575 | `	}` |
...
|         - | 14749 | ` */` |
|   4470850 | 14750 | `static sxi32 GenStateConsumeAttrs(ph7_gen_state *pGen,SySet *pOut)` |
|         5 | 14751 | `{` |
|   4470855 | 14752 | `	ph7_trivia *aT = (ph7_trivia *)SySetBasePtr(&pGen->aPendingAttrs);` |
|         - | 14753 | `	sxu32 n;` |
|         - | 14754 | `	sxi32 rc;` |
|   4478781 | 14755 | `	for( n = 0 ; n < SySetUsed(&pGen->aPendingAttrs) ; n++ ){` |
|      7931 | 14756 | `		rc = GenStateCompileAttrSpan(&(*pGen),&aT[n],pOut);` |
|      7931 | 14757 | `		if( rc == SXERR_ABORT ){` |
|       ! 0 | 14758 | `			return SXERR_ABORT;` |
|         - | 14759 | `		}` |
|      3968 | 14760 | `	}` |
|   4470855 | 14761 | `	SySetReset(&pGen->aPendingAttrs);` |
|   4470855 | 14762 | `	return SXRET_OK;` |
|   2235430 | 14763 | `}` |
|         - | 14764 | `/*` |
...
|         - | 14768 | ` */` |
|   2154280 | 14769 | `static sxi32 GenStateCollectParamAttrs(ph7_gen_state *pGen,SyToken *pTok,SySet *pOut)` |
|         5 | 14770 | `{` |
|   2154285 | 14771 | `	SyToken *pBase = (SyToken *)SySetBasePtr(pGen->pTokenSet);` |
|   2154285 | 14772 | `	ph7_trivia *aT = (ph7_trivia *)SySetBasePtr(&pGen->aTrivia);` |
|   2154285 | 14773 | `	sxu32 nT = SySetUsed(&pGen->aTrivia);` |
|         - | 14774 | `	sxu32 nIdx, n;` |
|         - | 14775 | `	sxi32 rc;` |
|   2154280 | 14776 | `	if( nT < 1 \|\| pGen->pTokenSet == 0` |
|    556327 | 14777 | `	 \|\| pTok < pBase \|\| pTok >= &pBase[SySetUsed(pGen->pTokenSet)] ){` |
|   1597963 | 14778 | `		return SXRET_OK;` |
|         - | 14779 | `	}` |
...
|   1077145 | 14790 | `}` |
|  12594406 | 14791 | `static sxi32 GenStateCompileChunk(` |
...
|         - | 14797 | `	sxi32 rc;` |
|  12594411 | 14798 | `	rc = SXRET_OK; /* Prevent compiler warning */` |
|   7300169 | 14799 | `	for(;;){` |
|  13597377 | 14800 | `		int bStmtIsDeclare = 0;` |
|  13597377 | 14801 | `		if( pGen->pIn >= pGen->pEnd ){` |
|         - | 14802 | `			/* No more input to process */` |
|     72639 | 14803 | `			break;` |
|         - | 14804 | `		}` |
|         - | 14805 | `		/* Bind a directly-preceding docblock to this statement */` |
|  13524743 | 14806 | `		GenStateSetPendingDoc(&(*pGen));` |
|  13524743 | 14807 | `		if( SySetUsed(&pGen->aPendingAttrs) > 0 ){` |
...
|  13524743 | 14839 | `		if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|   7868139 | 14840 | `			sxu32 nPeek = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   7868139 | 14841 | `			if( nPeek == PH7_TKWRD_DECLARE ){` |
|        47 | 14842 | `				bStmtIsDeclare = 1;` |
|        21 | 14843 | `			}` |
|   3934067 | 14844 | `		}` |
|  13524743 | 14845 | `		if( !bStmtIsDeclare && pGen->pCurrent == &pGen->sGlobal ){` |
...
|   1002939 | 14848 | `			pGen->bStrictTypesLocked = 1;` |
|    501467 | 14849 | `		}` |
|  13524743 | 14850 | `		if( pGen->pIn->nType & PH7_TK_OCB /* '{' */ ){` |
|         - | 14851 | `			/* Compile block */` |
...
|         - | 14855 | `			}` |
|      1969 | 14856 | `		}else{` |
|  13520815 | 14857 | `			xCons = 0;` |
|  13520815 | 14858 | `			if( GenStateStartsModifiedClass(pGen->pIn,pGen->pEnd) ){` |
...
|  13499383 | 14863 | `			}else if( GenStateStartsEnumDecl(pGen->pIn,pGen->pEnd) ){` |
...
|  13475991 | 14867 | `			}else if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|   7825301 | 14868 | `				sxu32 nKeyword = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|         - | 14869 | `				/* Try to extract a language construct handler */` |
|   7825301 | 14870 | `				xCons = GenStateGetStatementHandler(nKeyword,(&pGen->pIn[1] < pGen->pEnd) ? &pGen->pIn[1] : 0);` |
|   7825301 | 14871 | `				if( xCons == 0 && GenStateisLangConstruct(nKeyword) == FALSE ){` |
...
|         4 | 14882 | `				}` |
|   9561383 | 14883 | `			}else if( (pGen->pIn->nType & PH7_TK_ID) && (&pGen->pIn[1] < pGen->pEnd)` |
|    417391 | 14884 | `				&& (pGen->pIn[1].nType & PH7_TK_COLON /*':'*/) ){` |
|         - | 14885 | `				/* Label found [i.e: Out: ],point to the routine responsible of compiling it */` |
|       117 | 14886 | `				xCons = PH7_CompileLabel;` |
|        56 | 14887 | `			}` |
|  13520815 | 14888 | `			if( xCons == 0 ){` |
|         - | 14889 | `				/* Assume an expression an try to compile it */` |
|   5699653 | 14890 | `				rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   5699653 | 14891 | `				if(  rc != SXERR_EMPTY ){` |
|         - | 14892 | `					/* Pop l-value */` |
|   5699503 | 14893 | `					PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|   2849749 | 14894 | `				}` |
|   2849829 | 14895 | `			}else{` |
|         - | 14896 | `				/* Go compile the sucker */` |
|   7821167 | 14897 | `				rc = xCons(&(*pGen));` |
|         - | 14898 | `			}` |
|  13520815 | 14899 | `			if( rc == SXERR_ABORT ){` |
|         - | 14900 | `				/* Request to abort compilation */` |
|        13 | 14901 | `				break;` |
|         - | 14902 | `			}` |
|         - | 14903 | `		}` |
|         - | 14904 | `		/* Ignore trailing semi-colons ';' */` |
|  23203297 | 14905 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|   9678569 | 14906 | `			pGen->pIn++;` |
|         5 | 14907 | `		}` |
|  13524733 | 14908 | `		if( iFlags & PH7_COMPILE_SINGLE_STMT ){` |
|         - | 14909 | `			/* Compile a single statement and return */` |
|  12521767 | 14910 | `			break;` |
|         - | 14911 | `		}` |
|         - | 14912 | `		/* LOOP ONE */` |
|         - | 14913 | `		/* LOOP TWO */` |
|         - | 14914 | `		/* LOOP THREE */` |
...
|         - | 14924 | ` */` |
|     72646 | 14925 | `static sxi32 PH7_CompilePHP(` |
...
|         - | 14929 | `	)` |
|         5 | 14930 | `{` |
|     72651 | 14931 | `	SyToken *pScript = pGen->pRawIn; /* Script to compile */` |
|         - | 14932 | `	sxi32 rc;` |
|         - | 14933 | `	/* Reset the token set (and its trivia sidecar) */` |
|     72651 | 14934 | `	SySetReset(&(*pTokenSet));` |
|     72651 | 14935 | `	SySetReset(&pGen->aTrivia);` |
|         - | 14936 | `	/* Mark as the default token set */` |
|     72651 | 14937 | `	pGen->pTokenSet = &(*pTokenSet);` |
|         - | 14938 | `	/* Advance the stream cursor */` |
|     72651 | 14939 | `	pGen->pRawIn++;` |
|         - | 14940 | `	/* Tokenize the PHP chunk first */` |
|     72651 | 14941 | `	PH7_TokenizePHP(SyStringData(&pScript->sData),SyStringLength(&pScript->sData),pScript->nLine,&(*pTokenSet),&pGen->aTrivia);` |
|         - | 14942 | `	/* Point to the head and tail of the token stream. */` |
|     72651 | 14943 | `	pGen->pIn  = (SyToken *)SySetBasePtr(pTokenSet);` |
|     72651 | 14944 | `	pGen->pEnd = &pGen->pIn[SySetUsed(pTokenSet)];` |
|     72651 | 14945 | `	if( is_expr ){` |
...
|         - | 14954 | `	}` |
|     72651 | 14955 | `	if( pGen->pIn < pGen->pEnd && ( pGen->pIn->nType & PH7_TK_EQUAL ) ){` |
...
|     72649 | 14980 | `	rc = GenStateCompileChunk(pGen,0);` |
|         - | 14981 | `	/* Fix exceptions jumps */` |
|     72649 | 14982 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|         - | 14983 | `	/* Fix gotos now, the jump destination is resolved */` |
|     72649 | 14984 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),0) ){` |
|         3 | 14985 | `		rc = SXERR_ABORT;` |
|         1 | 14986 | `	}` |
|         - | 14987 | `	/* Reset container */` |
|     72649 | 14988 | `	SySetReset(&pGen->aGoto);` |
|     72649 | 14989 | `	SySetReset(&pGen->aLabel);` |
|     72649 | 14990 | `	SySetReset(&pGen->aNullsafeJmp);` |
|         - | 14991 | `	/* Compilation result */` |
|     72649 | 14992 | `	return rc;` |
|     36328 | 14993 | `}` |
|         - | 14994 | `/*` |
...
|         - | 14998 | ` */` |
|     75892 | 14999 | `PH7_PRIVATE sxi32 PH7_CompileScript(` |
...
|         - | 15014 | `	sxi32 rc;` |
|     75897 | 15015 | `	sxu32 nBaseLine = 1;` |
|     75897 | 15016 | `	if( pScript->nByte < 1 ){` |
...
|     75897 | 15023 | `	if( pScript->nByte >= 2 && pScript->zString[0]=='#' && pScript->zString[1]=='!' ){` |
...
|     75897 | 15037 | `	pCodeGen = &pVm->sCodeGen;` |
...
|     75897 | 15044 | `	pSavedIn = pCodeGen->pIn;` |
|     75897 | 15045 | `	pSavedEnd = pCodeGen->pEnd;` |
|     75897 | 15046 | `	bSavedStrict = pCodeGen->bStrictTypes;` |
|     75897 | 15047 | `	bSavedStrictLocked = pCodeGen->bStrictTypesLocked;` |
|     75897 | 15048 | `	pCodeGen->bStrictTypes = 0;` |
|     75897 | 15049 | `	pCodeGen->bStrictTypesLocked = 0;` |
|         - | 15050 | `	/* Initialize the tokens containers */` |
|     75897 | 15051 | `	SySetInit(&aRawToken,&pVm->sAllocator,sizeof(SyToken));` |
|     75897 | 15052 | `	SySetInit(&aPhpToken,&pVm->sAllocator,sizeof(SyToken));` |
|     75897 | 15053 | `	SySetAlloc(&aPhpToken,0xc0);` |
|     75897 | 15054 | `	is_expr = 0;` |
|     75897 | 15055 | `	if( iFlags & PH7_PHP_ONLY ){` |
|         - | 15056 | `		SyToken sTmp;` |
|         - | 15057 | `		/* PHP only: -*/` |
...
|     13567 | 15069 | `		SySetAlloc(&aRawToken,32);` |
|     13567 | 15070 | `		PH7_TokenizeRawText(pScript->zString,pScript->nByte,&aRawToken,nBaseLine);` |
|         - | 15071 | `	}` |
|         - | 15072 | `	/* Process high-level tokens */` |
|     75897 | 15073 | `	pCodeGen->pRawIn = (SyToken *)SySetBasePtr(&aRawToken);` |
|     75897 | 15074 | `	pCodeGen->pRawEnd = &pCodeGen->pRawIn[SySetUsed(&aRawToken)];` |
|     75897 | 15075 | `	rc = PH7_OK;` |
|     75897 | 15076 | `	if( is_expr ){` |
|         - | 15077 | `		/* Compile the expression */` |
|       ! 0 | 15078 | `		rc = PH7_CompilePHP(pCodeGen,&aPhpToken,TRUE);` |
|       ! 0 | 15079 | `		goto cleanup;` |
|         - | 15080 | `	}` |
|     75897 | 15081 | `	nObjIdx = 0;` |
...
|     75897 | 15085 | `	PH7_VmEmitInstr(pVm,PH7_OP_NSSWITCH,0,0,0,0);` |
|         - | 15086 | `	/* Start the compilation process */` |
|     44732 | 15087 | `	for(;;){` |
|    162103 | 15088 | `		if( pCodeGen->pRawIn >= pCodeGen->pRawEnd ){` |
|     75885 | 15089 | `			break; /* No more tokens to process */` |
|         - | 15090 | `		}` |
|     86223 | 15091 | `		if( pCodeGen->pRawIn->nType & PH7_TOKEN_PHP ){` |
|         - | 15092 | `			/* Compile the PHP chunk */` |
|     72651 | 15093 | `			rc = PH7_CompilePHP(pCodeGen,&aPhpToken,FALSE);` |
|     72651 | 15094 | `			if( rc == SXERR_ABORT ){` |
|        16 | 15095 | `				break;` |
|         - | 15096 | `			}` |
|     72639 | 15097 | `			continue;` |
|         - | 15098 | `		}` |
|         - | 15099 | `		/* Raw chunk: [i.e: HTML, XML, etc.] */` |
|     13577 | 15100 | `		nRawObj = 0;` |
|     27149 | 15101 | `		while( (pCodeGen->pRawIn < pCodeGen->pRawEnd) && (pCodeGen->pRawIn->nType != PH7_TOKEN_PHP) ){` |
|         - | 15102 | `			/* Consume the raw chunk without any processing */` |
|     13577 | 15103 | `			pRawObj = PH7_ReserveConstObj(&(*pVm),&nObjIdx);` |
|     13577 | 15104 | `			if( pRawObj == 0 ){` |
|       ! 0 | 15105 | `				rc = SXERR_MEM;` |
|       ! 0 | 15106 | `				break;` |
|         - | 15107 | `			}` |
|         - | 15108 | `			/* Mark as constant and emit the load constant instruction */` |
|     13577 | 15109 | `			PH7_MemObjInitFromString(pVm,pRawObj,&pCodeGen->pRawIn->sData);` |
|     13577 | 15110 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_LOADC,0,nObjIdx,0,0);` |
|     13577 | 15111 | `			++nRawObj;` |
|     13577 | 15112 | `			pCodeGen->pRawIn++; /* Next chunk */` |
|         5 | 15113 | `		}` |
|     13577 | 15114 | `		if( nRawObj > 0 ){` |
|         - | 15115 | `			/* Emit the consume instruction */` |
|     13577 | 15116 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_CONSUME,nRawObj,0,0,0);` |
|      6786 | 15117 | `		}` |
|     37951 | 15118 | `	}` |
|     37946 | 15119 | `cleanup:` |
|         - | 15120 | `	/* Drop the cursor into the token set BEFORE the set is freed (see above). */` |
|     75897 | 15121 | `	pCodeGen->pIn = pSavedIn;` |
|     75897 | 15122 | `	pCodeGen->pEnd = pSavedEnd;` |
|     75897 | 15123 | `	SySetRelease(&aRawToken);` |
|     75897 | 15124 | `	SySetRelease(&aPhpToken);` |
|         - | 15125 | `	/* Restore outer file's strict_types scope */` |
|     75897 | 15126 | `	pCodeGen->bStrictTypes = bSavedStrict;` |
|     75897 | 15127 | `	pCodeGen->bStrictTypesLocked = bSavedStrictLocked;` |
|     75897 | 15128 | `	return rc;` |
|     37951 | 15129 | `}` |
|         - | 15130 | `/*` |
...
|         - | 15172 | ` */` |
|     79320 | 15173 | `PH7_PRIVATE sxi32 PH7_ResetCodeGenerator(` |
|         - | 15174 | `	ph7_vm *pVm,       /* Target VM */` |
|         - | 15175 | `	ProcConsumer xErr, /* Error log consumer callabck  */` |
|         - | 15176 | `	void *pErrData     /* Last argument to xErr() */` |
|         - | 15177 | `	)` |
|         5 | 15178 | `{` |
|     79325 | 15179 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|         - | 15180 | `	GenBlock *pBlock,*pParent;` |
|         - | 15181 | `	/* Reset state */` |
|     79325 | 15182 | `	SySetReset(&pGen->aLabel);` |
|     79325 | 15183 | `	SySetReset(&pGen->aGoto);` |
|     79325 | 15184 | `	SySetReset(&pGen->aNullsafeJmp);` |
|     79325 | 15185 | `	SySetReset(&pGen->aTrivia);` |
|     79325 | 15186 | `	SySetReset(&pGen->aPendingAttrs);` |
|     79325 | 15187 | `	SyStringInitFromBuf(&pGen->sPendingDoc,0,0);` |
|     79325 | 15188 | `	SyBlobRelease(&pGen->sErrBuf);` |
|     79325 | 15189 | `	SyBlobRelease(&pGen->sWorker);` |
|     79325 | 15190 | `	SyBlobRelease(&pGen->sNamespace);` |
|     79325 | 15191 | `	SyBlobInit(&pGen->sNamespace,&pVm->sAllocator);` |
|     79325 | 15192 | `	SyHashRelease(&pGen->hUseImports);` |
|     79325 | 15193 | `	SyHashInit(&pGen->hUseImports,&pVm->sAllocator,0,0);` |
|     79325 | 15194 | `	SyHashRelease(&pGen->hUseFuncImports);` |
|     79325 | 15195 | `	SyHashInit(&pGen->hUseFuncImports,&pVm->sAllocator,0,0);` |
|     79325 | 15196 | `	SyHashRelease(&pGen->hUseConstImports);` |
|     79325 | 15197 | `	SyHashInit(&pGen->hUseConstImports,&pVm->sAllocator,0,0);` |
...
|     79325 | 15205 | `	pBlock = pGen->pCurrent;` |
|     79325 | 15206 | `	while( pBlock->pParent != 0 ){` |
|       ! 0 | 15207 | `		pParent = pBlock->pParent;` |
|       ! 0 | 15208 | `		GenStateFreeBlock(pBlock);` |
|       ! 0 | 15209 | `		pBlock = pParent;` |
|       ! 0 | 15210 | `	}` |
|     79325 | 15211 | `	pGen->xErr = xErr;` |
|     79325 | 15212 | `	pGen->pErrData = pErrData;` |
|     79325 | 15213 | `	pGen->pCurrent = &pGen->sGlobal;` |
|     79325 | 15214 | `	pGen->pRawIn = pGen->pRawEnd = 0;` |
|     79325 | 15215 | `	pGen->pIn = pGen->pEnd = 0;` |
|     79325 | 15216 | `	pGen->nErr = 0;` |
|     79325 | 15217 | `	return SXRET_OK;` |
|         5 | 15218 | `}` |
|         - | 15219 | `/*` |
