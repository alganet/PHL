...
|         - |   45 | ` */` |
|    179032 |   46 | `PH7_PRIVATE GenBlock * GenStateFetchBlock(GenBlock *pCurrent,sxi32 iBlockType,sxi32 iCount)` |
|         5 |   47 | `{` |
|    179037 |   48 | `	GenBlock *pBlock = pCurrent;` |
|    361811 |   49 | `	for(;;){` |
|    723627 |   50 | `		if( pBlock->iFlags & iBlockType ){` |
|    179037 |   51 | `			iCount--; /* Decrement nesting level */` |
|    179037 |   52 | `			if( iCount < 1 ){` |
|         - |   53 | `				/* Block meet with the desired criteria */` |
|    179011 |   54 | `				return pBlock;` |
|         - |   55 | `			}` |
|        13 |   56 | `		}` |
|         - |   57 | `		/* Point to the upper block */` |
|    544621 |   58 | `		pBlock = pBlock->pParent;` |
|    544621 |   59 | `		if( pBlock == 0 \|\| (pBlock->iFlags & (GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC)) ){` |
|         - |   60 | `			/* Forbidden */` |
|        16 |   61 | `			break;` |
|         - |   62 | `		}` |
|         5 |   63 | `	}` |
...
|         - |   69 | ` */` |
|  13123962 |   70 | `static void GenStateInitBlock(` |
...
|  13123967 |   79 | `	pBlock->nFirstInstr = nFirstInstr;` |
|  13123967 |   80 | `	pBlock->pUserData   = pUserData;` |
|  13123967 |   81 | `	pBlock->pGen        = pGen;` |
|  13123967 |   82 | `	pBlock->iFlags      = iType;` |
|  13123967 |   83 | `	pBlock->pParent     = 0;` |
|  13123967 |   84 | `	SySetInit(&pBlock->aJumpFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  13123967 |   85 | `	SySetInit(&pBlock->aPostContFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  13123967 |   86 | `}` |
|         - |   87 | `/*` |
...
|         - |   92 | ` */` |
|  13120070 |   93 | `PH7_PRIVATE sxi32 GenStateEnterBlock(` |
...
|  13120075 |  103 | `	pBlock = (GenBlock *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(GenBlock));` |
|  13120075 |  104 | `	if( pBlock == 0 ){` |
...
|  13120075 |  113 | `	SyZero(pBlock,sizeof(GenBlock));` |
|  13120075 |  114 | `	GenStateInitBlock(&(*pGen),pBlock,iType,nFirstInstr,pUserData);` |
|         - |  115 | `	/* Link to the parent block */` |
|  13120075 |  116 | `	pBlock->pParent = pGen->pCurrent;` |
...
|  13120075 |  119 | `	if( iType & (GEN_BLOCK_LOOP\|GEN_BLOCK_SWITCH) ){` |
|    541587 |  120 | `		sxu32 nParent = pGen->nCurLoopId;` |
|    541587 |  121 | `		pGen->nLoopId++;` |
|    541587 |  122 | `		SySetPut(&pGen->aLoopParent,(const void *)&nParent);` |
|    541587 |  123 | `		pBlock->nLoopId = pGen->nLoopId;` |
|    541587 |  124 | `		pBlock->nOuterLoopId = nParent;` |
|    541587 |  125 | `		pGen->nCurLoopId = pGen->nLoopId;` |
|    270791 |  126 | `	}` |
|         - |  127 | `	/* Mark as the current block */` |
|  13120075 |  128 | `	pGen->pCurrent = pBlock;` |
|  13120075 |  129 | `	if( ppBlock ){` |
|         - |  130 | `		/* Write a pointer to the new instance */` |
|   6309851 |  131 | `		*ppBlock = pBlock;` |
|   3154923 |  132 | `	}` |
|  13120075 |  133 | `	return SXRET_OK;` |
|   6560040 |  134 | `}` |
|         - |  135 | `/*` |
|         - |  136 | ` * Release block fields without freeing the whole instance.` |
|         - |  137 | ` */` |
|  13120062 |  138 | `static void GenStateReleaseBlock(GenBlock *pBlock)` |
|         5 |  139 | `{` |
|  13120067 |  140 | `	SySetRelease(&pBlock->aPostContFix);` |
|  13120067 |  141 | `	SySetRelease(&pBlock->aJumpFix);` |
|  13120067 |  142 | `}` |
|         - |  143 | `/*` |
|         - |  144 | ` * Release a block.` |
|         - |  145 | ` */` |
|  13120058 |  146 | `static void GenStateFreeBlock(GenBlock *pBlock)` |
|         5 |  147 | `{` |
|  13120063 |  148 | `	ph7_gen_state *pGen = pBlock->pGen;` |
|  13120063 |  149 | `	GenStateReleaseBlock(&(*pBlock));` |
|         - |  150 | `	/* Free the instance */` |
|  13120063 |  151 | `	SyMemBackendPoolFree(&pGen->pVm->sAllocator,pBlock);` |
|  13120063 |  152 | `}` |
|         - |  153 | `/*` |
|         - |  154 | ` * POP and release a block from the stack of compiled blocks.` |
|         - |  155 | ` */` |
|  13120058 |  156 | `PH7_PRIVATE sxi32 GenStateLeaveBlock(ph7_gen_state *pGen,GenBlock **ppBlock)` |
|         5 |  157 | `{` |
|  13120063 |  158 | `	GenBlock *pBlock = pGen->pCurrent;` |
|  13120063 |  159 | `	if( pBlock == 0 ){` |
|         - |  160 | `		/* No more block to pop */` |
|       ! 0 |  161 | `		return SXERR_EMPTY;` |
|         - |  162 | `	}` |
|  13120063 |  163 | `	if( pBlock->iFlags & (GEN_BLOCK_LOOP\|GEN_BLOCK_SWITCH) ){` |
|    541579 |  164 | `		pGen->nCurLoopId = pBlock->nOuterLoopId;` |
|    270787 |  165 | `	}` |
|         - |  166 | `	/* Point to the upper block */` |
|  13120063 |  167 | `	pGen->pCurrent = pBlock->pParent;` |
|  13120063 |  168 | `	if( ppBlock ){` |
|         - |  169 | `		/* Write a pointer to the popped block */` |
|       ! 0 |  170 | `		*ppBlock = pBlock;` |
|       ! 0 |  171 | `	}else{` |
|         - |  172 | `		/* Safely release the block */` |
|  13120063 |  173 | `		GenStateFreeBlock(&(*pBlock));` |
|         - |  174 | `	}` |
|  13120063 |  175 | `	return SXRET_OK;` |
|   6560034 |  176 | `}` |
|         - |  177 | `/*` |
...
|         - |  194 | ` */` |
|   1045542 |  195 | `PH7_PRIVATE int GenStateUnconditionalTopLevel(ph7_gen_state *pGen)` |
|         5 |  196 | `{` |
|   1045547 |  197 | `	GenBlock *pBlock = pGen->pCurrent;` |
|   1049539 |  198 | `	while( pBlock ){` |
|   1049539 |  199 | `		if( pBlock->iFlags & (GEN_BLOCK_COND\|GEN_BLOCK_LOOP\|GEN_BLOCK_FUNC\|GEN_BLOCK_SWITCH\|GEN_BLOCK_EXCEPTION) ){` |
|        77 |  200 | `			return 0; /* conditional / nested */` |
|         - |  201 | `		}` |
|   1049467 |  202 | `		if( pBlock->iFlags & GEN_BLOCK_GLOBAL ){` |
|   1045475 |  203 | `			return 1; /* reached the global block with no conditional ancestor */` |
|         - |  204 | `		}` |
...
|         - |  211 | ` * guard above.` |
|         - |  212 | ` */` |
|    522398 |  213 | `PH7_PRIVATE sxi32 GenStateGuardFuncRedeclaration(ph7_gen_state *pGen,ph7_vm_func *pFunc)` |
|         5 |  214 | `{` |
|         - |  215 | `	SyHashEntry *pEntry;` |
|    522403 |  216 | `	if( !GenStateUnconditionalTopLevel(pGen) ){` |
|        52 |  217 | `		return SXRET_OK;` |
|         - |  218 | `	}` |
|    522353 |  219 | `	pFunc->iFlags \|= VM_FUNC_BOUND;` |
|    522353 |  220 | `	if( pGen->pVm->bCompilingBuiltin ){` |
...
|         - |  257 | ` */` |
|   4738296 |  258 | `PH7_PRIVATE sxi32 GenStateNewJumpFixup(GenBlock *pBlock,sxi32 nJumpType,sxu32 nInstrIdx)` |
|         5 |  259 | `{` |
|         - |  260 | `	JumpFixup sJumpFix;` |
|         - |  261 | `	sxi32 rc;` |
|         - |  262 | `	/* Init the JumpFixup structure */` |
|   4738301 |  263 | `	sJumpFix.nJumpType = nJumpType;` |
|   4738301 |  264 | `	sJumpFix.nInstrIdx = nInstrIdx;` |
|         - |  265 | `	/* Insert in the jump fixup table */` |
|   4738301 |  266 | `	rc = SySetPut(&pBlock->aJumpFix,(const void *)&sJumpFix);` |
|   4738301 |  267 | `	return rc;` |
|         5 |  268 | `}` |
|         - |  269 | `/*` |
...
|         - |  279 | ` */` |
|   9121076 |  280 | `PH7_PRIVATE sxu32 GenStateFixJumps(GenBlock *pBlock,sxi32 nJumpType,sxu32 nJumpDest)` |
|         5 |  281 | `{` |
|         - |  282 | `	JumpFixup *aFix;` |
|         - |  283 | `	VmInstr *pInstr;` |
|         - |  284 | `	sxu32 nFixed;` |
...
|   9121081 |  287 | `	aFix = (JumpFixup *)SySetBasePtr(&pBlock->aJumpFix);` |
|         - |  288 | `	/* Fix the desired jumps */` |
|  19091871 |  289 | `	for( nFixed = n = 0 ; n < SySetUsed(&pBlock->aJumpFix) ; ++n ){` |
|   9970795 |  290 | `		if( aFix[n].nJumpType < 0 ){` |
|         - |  291 | `			/* Already fixed */` |
|   3723131 |  292 | `			continue;` |
|         - |  293 | `		}` |
|   6247669 |  294 | `		if( nJumpType > 0 && aFix[n].nJumpType != nJumpType ){` |
|         - |  295 | `			/* Not of our interest */` |
|   1509375 |  296 | `			continue;` |
|         - |  297 | `		}` |
|         - |  298 | `		/* Point to the instruction to fix */` |
|   4738299 |  299 | `		pInstr = PH7_VmGetInstr(pBlock->pGen->pVm,aFix[n].nInstrIdx);` |
|   4738299 |  300 | `		if( pInstr ){` |
|   4738299 |  301 | `			pInstr->iP2 = nJumpDest;` |
|   4738299 |  302 | `			nFixed++;` |
|         - |  303 | `			/* Mark as fixed */` |
|   4738299 |  304 | `			aFix[n].nJumpType = -1;` |
|   2369147 |  305 | `		}` |
|   2369152 |  306 | `	}` |
|         - |  307 | `	/* Total number of fixed jumps */` |
|   9121081 |  308 | `	return nFixed;` |
|         5 |  309 | `}` |
|         - |  310 | `/*` |
...
|         - |  316 | ` */` |
|   3376926 |  317 | `PH7_PRIVATE sxi32 GenStateFixGoto(ph7_gen_state *pGen,sxu32 nOfft)` |
|         5 |  318 | `{` |
...
|   3376931 |  325 | `	aJumps = (JumpFixup *)SySetBasePtr(&pGen->aGoto);` |
|         - |  326 | `	/* Fix */` |
|   3377077 |  327 | `	for( n = nOfft ; n < SySetUsed(&pGen->aGoto) ; ++n ){` |
...
|   3376929 |  378 | `	return SXRET_OK;` |
|   1688468 |  379 | `}` |
|         - |  380 | `/*` |
|         - |  381 | ` * Check if a given token value is installed in the literal table.` |
|         - |  382 | ` */` |
|  16915666 |  383 | `PH7_PRIVATE sxi32 GenStateFindLiteral(ph7_gen_state *pGen,const SyString *pValue,sxu32 *pIdx)` |
|         5 |  384 | `{` |
|         - |  385 | `	SyHashEntry *pEntry;` |
|  16915671 |  386 | `	pEntry = SyHashGet(&pGen->hLiteral,(const void *)pValue->zString,pValue->nByte);` |
|  16915671 |  387 | `	if( pEntry == 0 ){` |
|   4509625 |  388 | `		return SXERR_NOTFOUND;` |
|         - |  389 | `	}` |
|  12406051 |  390 | `	*pIdx = (sxu32)SX_PTR_TO_INT(pEntry->pUserData);` |
|  12406051 |  391 | `	return SXRET_OK;` |
|   8457838 |  392 | `}` |
|         - |  393 | `/*` |
...
|         - |  402 | ` */` |
|   4509620 |  403 | `PH7_PRIVATE sxi32 GenStateInstallLiteral(ph7_gen_state *pGen,ph7_value *pObj,sxu32 nIdx)` |
|         5 |  404 | `{` |
|   4509625 |  405 | `	if( SyBlobLength(&pObj->sBlob) > 0 ){` |
|   4509625 |  406 | `		SyHashInsert(&pGen->hLiteral,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob),SX_INT_TO_PTR(nIdx));` |
|   2254810 |  407 | `	}` |
|   4509625 |  408 | `	return SXRET_OK;` |
|         5 |  409 | `}` |
|         - |  410 | `/*` |
|         - |  411 | ` * Reserve a room for a numeric constant [i.e: 64-bit integer or real number]` |
|         - |  412 | ` * in the constant table.` |
|         - |  413 | ` */` |
|   3824288 |  414 | `PH7_PRIVATE ph7_value * GenStateInstallNumLiteral(ph7_gen_state *pGen,sxu32 *pIdx)` |
|         5 |  415 | `{` |
|         - |  416 | `	ph7_value *pObj;` |
|   3824293 |  417 | `	sxu32 nIdx = 0; /* cc warning */` |
|         - |  418 | `	/* Reserve a new constant */` |
|   3824293 |  419 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   3824293 |  420 | `	if( pObj == 0 ){` |
|       ! 0 |  421 | `		PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|       ! 0 |  422 | `		return 0;` |
|         - |  423 | `	}` |
|   3824293 |  424 | `	*pIdx = nIdx;` |
|         - |  425 | `	/* TODO(chems): Create a numeric table (64bit int keys) same as` |
|         - |  426 | `	 * the constant string iterals table [optimization purposes].` |
|         - |  427 | `	 */` |
|   3824293 |  428 | `	return pObj;` |
|   1912149 |  429 | `}` |
|         - |  430 | `/*` |
...
|         - |  443 | ` */` |
|   7958072 |  444 | `PH7_PRIVATE void *GenStateAttachStrictFlag(ph7_gen_state *pGen, void *p3)` |
|         5 |  445 | `{` |
|         - |  446 | `	VmCallArgMap *pMap;` |
|   7958077 |  447 | `	if( !pGen->bStrictTypes ) return p3;` |
|        58 |  448 | `	if( p3 == 0 ){` |
...
|         - |  507 | ` */` |
|  54063390 |  508 | `static void GenStatePatchNullsafeJumps(ph7_gen_state *pGen, sxu32 nBaseline)` |
|         5 |  509 | `{` |
|  54063395 |  510 | `	sxu32 nCur = SySetUsed(&pGen->aNullsafeJmp);` |
|         - |  511 | `	sxu32 nTarget;` |
|         - |  512 | `	sxu32 *aIdx;` |
|         - |  513 | `	sxu32 i;` |
|  54063395 |  514 | `	if( nCur <= nBaseline ){` |
|  54063299 |  515 | `		return;` |
|         - |  516 | `	}` |
...
|         - |  544 | ` */` |
|   7067940 |  545 | `static sxu32 GenStateByRefBuiltinMask(SyString *pName)` |
|         5 |  546 | `{` |
...
|         - |  562 | `	};` |
|         - |  563 | `	sxu32 i;` |
|   7067945 |  564 | `	if( pName == 0 \|\| pName->zString == 0 \|\| pName->nByte == 0 ){` |
|   1809505 |  565 | `		return 0;` |
|         - |  566 | `	}` |
|  57359521 |  567 | `	for( i = 0 ; i < SX_ARRAYSIZE(aByRef) ; ++i ){` |
|  52159562 |  568 | `		if( pName->nByte == aByRef[i].nByte` |
|  27597798 |  569 | `		 && SyStrnicmp(pName->zString, aByRef[i].zName, pName->nByte) == 0 ){` |
|     58491 |  570 | `			return aByRef[i].mask;` |
|         - |  571 | `		}` |
|  26050543 |  572 | `	}` |
|   5199959 |  573 | `	return 0;` |
|   3533975 |  574 | `}` |
|         - |  575 | `/*` |
...
|         - |  584 | ` */` |
|   7067940 |  585 | `static void GenStateCallBuiltinName(ph7_expr_node *pLeft, SyString *pOut)` |
|         5 |  586 | `{` |
|         - |  587 | `	SyToken *p, *pEnd;` |
|   7067945 |  588 | `	pOut->zString = 0;` |
|   7067945 |  589 | `	pOut->nByte = 0;` |
|   7067945 |  590 | `	if( pLeft == 0 \|\| pLeft->pStart == 0 \|\| pLeft->pEnd == 0 ){` |
|       ! 0 |  591 | `		return;` |
|         - |  592 | `	}` |
|   7067945 |  593 | `	p = pLeft->pStart;` |
|   7067945 |  594 | `	pEnd = pLeft->pEnd;` |
|         - |  595 | `	/* Optional single leading namespace separator (absolute path). */` |
|   7067945 |  596 | `	if( p < pEnd && (p->nType & PH7_TK_NSSEP) ){` |
|      3931 |  597 | `		p++;` |
|      1963 |  598 | `	}` |
|   7067945 |  599 | `	if( p >= pEnd \|\| (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|   1809459 |  600 | `		return;` |
|         - |  601 | `	}` |
|         - |  602 | `	/* Must be a single component: nothing follows the name token. */` |
|   5258491 |  603 | `	if( p + 1 != pEnd ){` |
|        51 |  604 | `		return;` |
|         - |  605 | `	}` |
|   5258445 |  606 | `	*pOut = p->sData;` |
|   3533975 |  607 | `}` |
|         - |  608 | `/*` |
...
|         - |  613 | ` * error message.` |
|         - |  614 | ` */` |
|  76229018 |  615 | `static sxi32 GenStateEmitExprCode(` |
...
|         - |  621 | `	VmInstr *pInstr;` |
|         - |  622 | `	sxu32 nJmpIdx;` |
|  76229023 |  623 | `	sxi32 iP1 = 0;` |
|  76229023 |  624 | `	sxu32 iP2 = 0;` |
|  76229023 |  625 | `	void *p3  = 0;` |
|         - |  626 | `	sxi32 iVmOp;` |
|         - |  627 | `	sxi32 rc;` |
|  76229023 |  628 | `	int bIsChainOp = 0; /* Set below once we know pNode->pOp */` |
|  76229023 |  629 | ``	int bFcc = 0;       /* First-class callable `f(...)`: emit OP_LOAD_FCC, not OP_CALL */`` |
|  76229023 |  630 | `	sxu32 nRhsNsBase = 0;` |
|  76229023 |  631 | `	if( pNode->xCode ){` |
|         - |  632 | `		SyToken *pTmpIn,*pTmpEnd;` |
|         - |  633 | `		/* Compile node */` |
|  46008225 |  634 | `		SWAP_DELIMITER(pGen,pNode->pStart,pNode->pEnd);` |
|  46008225 |  635 | `		rc = pNode->xCode(&(*pGen),iFlags);` |
|  46008225 |  636 | `		RE_SWAP_DELIMITER(pGen);` |
|  46008225 |  637 | `		return rc;` |
|         - |  638 | `	}` |
|  30220803 |  639 | `	if( pNode->pOp == 0 ){` |
...
|         - |  643 | `	}` |
|  30220803 |  644 | `	iVmOp = pNode->pOp->iVmOp;` |
|  30220803 |  645 | `	if( iVmOp == PH7_OP_CVT_NULL ){` |
...
|         - |  653 | `		}` |
|         1 |  654 | `	}` |
|  30220803 |  655 | `	if( pNode->pOp->iOp == EXPR_OP_NULLC_ASSIGN ){` |
|        93 |  656 | `		sxu32 nJmp = 0;` |
|         - |  657 | `		sxu32 nNcNsBase;` |
...
|         - |  704 | `	}` |
|  30220713 |  705 | `	if( pNode->pOp->iOp == EXPR_OP_QUESTY ){` |
|         - |  706 | `		sxu32 nJz,nJmp;` |
|         - |  707 | `		sxu32 nTernaryNsBase;` |
|         - |  708 | `		/* Ternary operator require special handling */` |
|         - |  709 | `		/* Phase#1: Compile the condition */` |
|    504857 |  710 | `		nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|    504857 |  711 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pCond,iFlags);` |
|    504857 |  712 | `		if( rc != SXRET_OK ){` |
|       ! 0 |  713 | `			return rc;` |
|         - |  714 | `		}` |
...
|    504857 |  718 | `		GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|    504857 |  719 | `		nJz = nJmp = 0; /* cc -O6 warning */` |
|    504857 |  720 | `		if( pNode->pLeft ){` |
|         - |  721 | `			/* Standard ternary: (expr) ? (then) : (else) */` |
|         - |  722 | `			/* Phase#2: Emit the false jump (pops condition) */` |
|    500899 |  723 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nJz);` |
|         - |  724 | `			/* Phase#3: Compile the 'then' expression  */` |
|    500899 |  725 | `			nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|    500899 |  726 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pLeft,iFlags);` |
|    500899 |  727 | `			if( rc != SXRET_OK ){` |
|       ! 0 |  728 | `				return rc;` |
|         - |  729 | `			}` |
|    500899 |  730 | `			GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|    250452 |  731 | `		}else{` |
...
|    504857 |  739 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,0,0,&nJmp);` |
|         - |  740 | `		/* Phase#5: Fix the false jump now the jump destination is resolved. */` |
|    504857 |  741 | `		pInstr = PH7_VmGetInstr(pGen->pVm,nJz);` |
|    504857 |  742 | `		if( pInstr ){` |
|    504857 |  743 | `			pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    252426 |  744 | `		}` |
|    504857 |  745 | `		if( !pNode->pLeft ){` |
...
|    504857 |  750 | `		if( pNode->pRight ){` |
|    504857 |  751 | `			nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|    504857 |  752 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pRight,iFlags);` |
|    504857 |  753 | `			if( rc != SXRET_OK ){` |
|       ! 0 |  754 | `				return rc;` |
|         - |  755 | `			}` |
|    504857 |  756 | `			GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|    252426 |  757 | `		}` |
|    504857 |  758 | `		if( nJmp > 0 ){` |
|         - |  759 | `			/* Phase#7: Fix the unconditional jump */` |
|    504857 |  760 | `			pInstr = PH7_VmGetInstr(pGen->pVm,nJmp);` |
|    504857 |  761 | `			if( pInstr ){` |
|    504857 |  762 | `				pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    252426 |  763 | `			}` |
|    252426 |  764 | `		}` |
|         - |  765 | `		/* All done */` |
|    504857 |  766 | `		return SXRET_OK;` |
|         - |  767 | `	}` |
|  29715861 |  768 | `	if( pNode->pOp->iOp == EXPR_OP_PIPE ){` |
...
|         - |  800 | `	}` |
|  29715835 |  801 | `	bIsChainOp = GEN_IS_CHAIN_OP(pNode->pOp->iOp);` |
|         - |  802 | `	/* Generate code for the left tree */` |
|  29715835 |  803 | `	if( pNode->pLeft ){` |
|  29661591 |  804 | `		sxu32 nLhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  29661591 |  805 | `		if( iVmOp == PH7_OP_CALL ){` |
|         - |  806 | `			ph7_expr_node **apNode;` |
|   7072173 |  807 | `			int hasSpread = 0;` |
|   7072173 |  808 | `			int hasNamed = 0;` |
|   7072173 |  809 | `			int bAnySpread = 0;` |
|   7072173 |  810 | `			sxu32 byRefMask = 0;` |
|         - |  811 | `			sxi32 nArgs;` |
|         - |  812 | `			sxi32 n;` |
|         - |  813 | `			/* Recurse and generate bytecodes for function arguments */` |
|   7072173 |  814 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|   7072173 |  815 | `			nArgs = (sxi32)SySetUsed(&pNode->aNodeArgs);` |
...
|   7072173 |  819 | `			if( nArgs == 1 && apNode[0] && (apNode[0]->iFlags & EXPR_NODE_FCC) ){` |
|        81 |  820 | `				bFcc = 1;` |
|        81 |  821 | `				nArgs = 0;` |
|        40 |  822 | `			}` |
...
|         - |  825 | `			{` |
|   7072173 |  826 | `				int seenNamed = 0;` |
|   7072173 |  827 | `				int seenSpread = 0;` |
|  15102953 |  828 | `				for( n = 0; n < nArgs; ++n ){` |
|   8030787 |  829 | `					if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
...
|         5 |  836 | `						}` |
|   8028745 |  837 | `					}else if( apNode[n]->iFlags & EXPR_NODE_NAMED_ARG ){` |
|       300 |  838 | `						seenNamed = 1;` |
|       300 |  839 | `						hasNamed = 1;` |
|   8026555 |  840 | `					}else if( seenNamed ){` |
...
|   8026405 |  844 | `					}else if( seenSpread ){` |
...
|         - |  850 | `			}` |
|         - |  851 | `			/* Read-only load */` |
|   7072171 |  852 | `			iFlags \|= EXPR_FLAG_RDONLY_LOAD;` |
...
|   7072171 |  857 | `			if( pNode->pLeft && pNode->pLeft->pStart ){` |
|   7072171 |  858 | `				SyString *pCallName = &pNode->pLeft->pStart->sData;` |
|   7072166 |  859 | `				if( pCallName->nByte == 5` |
|   3930211 |  860 | `				 && SyStrnicmp(pCallName->zString,"isset",5) == 0 ){` |
|    326983 |  861 | `					iFlags \|= EXPR_FLAG_LOAD_IDX_ISSET;` |
|   6908682 |  862 | `				}else if( pCallName->nByte == 5` |
|   3603233 |  863 | `				 && SyStrnicmp(pCallName->zString,"empty",5) == 0 ){` |
...
|   7072171 |  872 | `				if( !bAnySpread && !hasNamed ){` |
|         - |  873 | `					SyString sBuiltin;` |
|   7067945 |  874 | `					GenStateCallBuiltinName(pNode->pLeft, &sBuiltin);` |
|   7067945 |  875 | `					byRefMask = GenStateByRefBuiltinMask(&sBuiltin);` |
|   3533970 |  876 | `				}` |
|   3536083 |  877 | `			}` |
|  15102949 |  878 | `			for( n = 0 ; n < nArgs ; ++n ){` |
|   8030783 |  879 | `				sxu32 nArgNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|   8030783 |  880 | `				sxi32 iArgFlags = iFlags & ~(EXPR_FLAG_LOAD_IDX_STORE\|EXPR_FLAG_MEMBER_WRITE);` |
...
|   8030783 |  887 | `				if( n < 31 && (byRefMask & (1u<<n)) ){` |
|     38971 |  888 | `					iArgFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|     38971 |  889 | `					iArgFlags \|= EXPR_FLAG_LOAD_IDX_STORE;` |
|     19483 |  890 | `				}` |
...
|   8030778 |  901 | `				if( (iFlags & (EXPR_FLAG_LOAD_IDX_ISSET\|EXPR_FLAG_LOAD_IDX_EMPTY\|EXPR_FLAG_LOAD_IDX_UNSET)) == 0` |
|   7867222 |  902 | `				 && apNode[n]->pOp == 0 && apNode[n]->xCode == PH7_CompileVariable` |
|   4123098 |  903 | `				 && (apNode[n]->iFlags & (EXPR_NODE_NAMED_ARG\|EXPR_NODE_SPREAD)) == 0 ){` |
|   3369617 |  904 | `					iArgFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|   1684806 |  905 | `				}` |
|   8030783 |  906 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iArgFlags);` |
|   8030783 |  907 | `				if( rc != SXRET_OK ){` |
|       ! 0 |  908 | `					return rc;` |
|         - |  909 | `				}` |
|         - |  910 | `				/* Each argument is an independent nullsafe scope. */` |
|   8030783 |  911 | `				GenStatePatchNullsafeJumps(pGen, nArgNsBase);` |
|   8030783 |  912 | `				if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
|         - |  913 | `					/* Emit spread opcode to unpack this array argument */` |
|      4089 |  914 | `					PH7_VmEmitInstr(pGen->pVm, PH7_OP_SPREAD, 0, 0, 0, 0);` |
|      4089 |  915 | `					hasSpread = 1;` |
|      2042 |  916 | `				}` |
|   4015394 |  917 | `			}` |
|         - |  918 | `			/* Total number of given arguments */` |
|   7072171 |  919 | `			iP1 = nArgs;` |
|   7072171 |  920 | `			iP2 = hasSpread;` |
|         - |  921 | `			/* Build VmCallArgMap if named arguments are present.` |
|         - |  922 | `			 * Deep-copy name strings so they survive token stream cleanup. */` |
|   7072171 |  923 | `			if( hasNamed ){` |
...
|   7072171 |  955 | `			iFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|   3536083 |  956 | `		}` |
|         - |  957 | `		{` |
...
|  29661589 |  966 | `			sxi32 iLeftFlags = iFlags;` |
|  29661584 |  967 | `			if( pNode->pLeft && pNode->pLeft->pOp` |
|  24083927 |  968 | `				&& (pNode->pLeft->pOp->iOp == EXPR_OP_ARROW` |
|   9253161 |  969 | `					\|\| pNode->pLeft->pOp->iOp == EXPR_OP_NULLSAFE_ARROW` |
|   7965689 |  970 | `					\|\| pNode->pLeft->pOp->iOp == EXPR_OP_DC) ){` |
|   2785507 |  971 | `				iLeftFlags &= ~EXPR_FLAG_LOAD_IDX_UNSET;` |
|   1392751 |  972 | `			}` |
...
|  29661584 |  980 | `			if( pNode->pOp` |
|  41701085 |  981 | `				&& (pNode->pOp->iOp == EXPR_OP_ARROW` |
|  26870340 |  982 | `					\|\| pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW` |
|  24079044 |  983 | `					\|\| pNode->pOp->iOp == EXPR_OP_DC) ){` |
|   6003553 |  984 | `				iLeftFlags &= ~EXPR_FLAG_MEMBER_WRITE;` |
|   3001774 |  985 | `			}` |
...
|  29661584 |  992 | `			if( pNode->pOp` |
|  29661589 |  993 | `				&& (pNode->pOp->iVmOp == PH7_OP_INCR \|\| pNode->pOp->iVmOp == PH7_OP_DECR) ){` |
|    218171 |  994 | `				iLeftFlags \|= EXPR_FLAG_LOAD_IDX_STORE \| EXPR_FLAG_MEMBER_WRITE;` |
|    109083 |  995 | `			}` |
...
|  29661584 | 1003 | `			if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLC` |
|  14860034 | 1004 | `				&& pNode->pLeft && pNode->pLeft->pOp` |
|     87664 | 1005 | `				&& (pNode->pLeft->pOp->iOp == EXPR_OP_ARROW` |
|     58428 | 1006 | `					\|\| pNode->pLeft->pOp->iOp == EXPR_OP_NULLSAFE_ARROW` |
|     58411 | 1007 | `					\|\| pNode->pLeft->pOp->iOp == EXPR_OP_DC) ){` |
|        37 | 1008 | `				iLeftFlags \|= EXPR_FLAG_LOAD_IDX_ISSET;` |
|        18 | 1009 | `			}` |
|  29661589 | 1010 | `			if( iVmOp == PH7_OP_ERR_CTRL ){` |
...
|     15793 | 1013 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_ERR_CTRL,1,0,0,0);` |
|      7894 | 1014 | `			}` |
|  29661589 | 1015 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pLeft,iLeftFlags);` |
|         - | 1016 | `		}` |
|  29661589 | 1017 | `		if( rc != SXRET_OK ){` |
|        34 | 1018 | `			return rc;` |
|         - | 1019 | `		}` |
|  29661559 | 1020 | `		if( !bIsChainOp ){` |
...
|  13553679 | 1023 | `			GenStatePatchNullsafeJumps(pGen, nLhsNsBase);` |
|   6776837 | 1024 | `		}` |
|  29661559 | 1025 | `		if( iVmOp == PH7_OP_CALL ){` |
|   7072171 | 1026 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|   7072171 | 1027 | `			if( pInstr ){` |
|   7072171 | 1028 | `				if ( pInstr->iOp == PH7_OP_LOADC ){` |
|   5258753 | 1029 | `					sxu32 nOrig = (sxu32)pInstr->iP2;` |
|         - | 1030 | `					sxu32 nQual;` |
|   5258753 | 1031 | `					int bAbsolute = (pInstr->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|         - | 1032 | `					/* Prevent constant expansion but preserve the absolute flag` |
|         - | 1033 | `					 * so the later NEW handler (if any) can see it. */` |
|   5258753 | 1034 | `					pInstr->iP1 &= ~PH7_LOADC_EXPAND;` |
...
|   5258753 | 1042 | `					if( bAbsolute ){` |
|      3931 | 1043 | `						pInstr->iP2 = (sxi32)nOrig;` |
|      1968 | 1044 | `					}else{` |
|   5254827 | 1045 | `						int fromImport = 0;` |
|   5254827 | 1046 | `						nQual = GenStateNsQualifyName(pGen,nOrig,&pGen->hUseFuncImports,&fromImport);` |
|   5254827 | 1047 | `						pInstr->iP2 = (sxi32)nQual;` |
|   5254827 | 1048 | `						if( nQual != nOrig ){` |
...
|        49 | 1069 | `						}` |
|         - | 1070 | `					}` |
|   4442797 | 1071 | `				}else if( (pInstr->iOp == PH7_OP_MEMBER /* $a->b(1,2,3) */` |
|   1803344 | 1072 | `						&& !(pNode->pLeft && (pNode->pLeft->iFlags & EXPR_NODE_PARENS)))` |
|    916790 | 1073 | `					\|\| pInstr->iOp == PH7_OP_NEW ){` |
...
|   1793277 | 1089 | `					if( pInstr->iOp == PH7_OP_MEMBER && pInstr->iP1 == 1 && pInstr->p3 ){` |
...
|    896636 | 1095 | `				}` |
|   3536088 | 1096 | `			}` |
|  26125476 | 1097 | `		}else if( iVmOp == PH7_OP_LOAD_IDX ){` |
|         - | 1098 | `			ph7_expr_node **apNode;` |
|         - | 1099 | `			sxi32 n;` |
|   3032171 | 1100 | `			sxi32 iChildMask = ~(EXPR_FLAG_LOAD_IDX_STORE` |
...
|   3032171 | 1104 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|   5826735 | 1105 | `			for( n = 0 ; n < (sxi32)SySetUsed(&pNode->aNodeArgs) ; ++n ){` |
|   2794569 | 1106 | `				sxu32 nIdxNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|   2794569 | 1107 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iFlags&iChildMask);` |
|   2794569 | 1108 | `				if( rc != SXRET_OK ){` |
|       ! 0 | 1109 | `					return rc;` |
|         - | 1110 | `				}` |
|         - | 1111 | `				/* Each subscript index is an independent nullsafe scope. */` |
|   2794569 | 1112 | `				GenStatePatchNullsafeJumps(pGen, nIdxNsBase);` |
|   1397287 | 1113 | `			}` |
|   3032171 | 1114 | `			if( SySetUsed(&pNode->aNodeArgs) > 0 ){` |
|   2794569 | 1115 | `				iP1 = 1; /* Node have an index associated with it */` |
|   1397282 | 1116 | `			}` |
|   3032171 | 1117 | `			if( iFlags & EXPR_FLAG_LOAD_IDX_ISSET ){` |
|         - | 1118 | `				/* offsetExists for ArrayAccess; peek-only for arrays */` |
|    373529 | 1119 | `				iP2 = 4;` |
|   2845409 | 1120 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_UNSET ){` |
|         - | 1121 | `				/* offsetUnset for ArrayAccess; auto-vivify+load for arrays` |
|         - | 1122 | `				 * so the trailing unset() builtin can drop the slot. */` |
|     23409 | 1123 | `				iP2 = 5;` |
|   2646945 | 1124 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_EMPTY ){` |
...
|        29 | 1128 | `				iP2 = 6;` |
|   2635231 | 1129 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_STORE ){` |
|         - | 1130 | `				/* Create an empty entry when the desired index is not found */` |
|    556899 | 1131 | `				iP2 = 1;` |
|    278452 | 1132 | `			}` |
|  21073310 | 1133 | `		}else if( pNode->pOp->iOp == EXPR_OP_COMMA ){` |
|         - | 1134 | `			/* POP the left node */` |
|         5 | 1135 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|         2 | 1136 | `		}` |
|  14830777 | 1137 | `	}` |
|  29715803 | 1138 | `	rc = SXRET_OK;` |
|  29715803 | 1139 | `	nJmpIdx = 0;` |
...
|  29715803 | 1143 | `	if( iVmOp == PH7_OP_MEMBER && pNode->pOp->iOp == EXPR_OP_DC ){` |
|    467625 | 1144 | `		pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|    467625 | 1145 | `		if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|    467625 | 1146 | `			ph7_value *pLitCheck = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,(sxu32)pInstr->iP2);` |
|    467625 | 1147 | `			int isSpecial = 0;` |
|    467625 | 1148 | `			if( pLitCheck && (pLitCheck->iFlags & MEMOBJ_STRING) ){` |
|    374261 | 1149 | `				const char *z = (const char *)SyBlobData(&pLitCheck->sBlob);` |
|    374261 | 1150 | `				sxu32 n = (sxu32)SyBlobLength(&pLitCheck->sBlob);` |
|    374256 | 1151 | `				if( (n == 4 && SyMemcmp(z,"self",4) == 0) \|\|` |
|    348902 | 1152 | `					(n == 6 && SyMemcmp(z,"static",6) == 0) \|\|` |
|    189029 | 1153 | `					(n == 6 && SyMemcmp(z,"parent",6) == 0) ){` |
|    147943 | 1154 | `					isSpecial = 1;` |
|     73969 | 1155 | `				}` |
|    210469 | 1156 | `			}` |
|    514307 | 1157 | `			pInstr->iP1 = 0;` |
...
|         - | 1163 | `			{` |
|    724776 | 1164 | `				int bAbsolute = (pNode->pLeft && pNode->pLeft->pStart` |
|    631407 | 1165 | `					&& (pNode->pLeft->pStart->nType & PH7_TK_NSSEP));` |
|    420943 | 1166 | `				if( !isSpecial && !bAbsolute ){` |
|    272987 | 1167 | `					pInstr->iP2 = (sxi32)GenStateNsQualifyName(pGen,(sxu32)pInstr->iP2,&pGen->hUseImports,0);` |
|    136491 | 1168 | `				}` |
|         - | 1169 | `			}` |
...
|    420943 | 1172 | `			if( !isSpecial && pNode->pRight && pNode->pRight->pStart ){` |
|    273005 | 1173 | `				SyToken *pRightTok = pNode->pRight->pStart;` |
|    273005 | 1174 | `				if( (pRightTok->nType & PH7_TK_KEYWORD) &&` |
...
|  29669065 | 1182 | `	if( pNode->pRight ){` |
|  17039931 | 1183 | `		if( iVmOp == PH7_OP_LAND ){` |
|         - | 1184 | `			/* Emit the false jump so we can short-circuit the logical and */` |
|    451515 | 1185 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,1/* Keep the value on the stack */,0,0,&nJmpIdx);` |
|  16814176 | 1186 | `		}else if (iVmOp == PH7_OP_LOR ){` |
|         - | 1187 | `			/* Emit the true jump so we can short-circuit the logical or*/` |
|    326755 | 1188 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JNZ,1/* Keep the value on the stack */,0,0,&nJmpIdx);` |
|  16425046 | 1189 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLC ){` |
|         - | 1190 | `			/* Null coalescing: if LHS is not null, jump past RHS */` |
|     58489 | 1191 | `			iVmOp = 0; /* No binary operator to emit */` |
|     58489 | 1192 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_NULLC,0,0,0,&nJmpIdx);` |
|  16232481 | 1193 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW ){` |
...
|  16203135 | 1203 | `		}else if( pNode->pOp->iPrec == 18 /* Combined binary operators [i.e: =,'.=','+=',*=' ...] precedence */ ){` |
...
|   5225897 | 1207 | `			iFlags \|= EXPR_FLAG_LOAD_IDX_STORE \| EXPR_FLAG_MEMBER_WRITE;` |
|   2612946 | 1208 | `		}` |
|  17039931 | 1209 | `		nRhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  17039931 | 1210 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pRight,iFlags);` |
|  17039931 | 1211 | `		if( !bIsChainOp ){` |
|         - | 1212 | `			/* Non-chain parent: RHS nullsafe chain ends here, before the` |
|         - | 1213 | `			 * operator instruction is emitted. */` |
|  11036457 | 1214 | `			GenStatePatchNullsafeJumps(pGen, nRhsNsBase);` |
|   5518226 | 1215 | `		}` |
|  17039931 | 1216 | `		if( iVmOp == PH7_OP_STORE ){` |
|   4774543 | 1217 | `			if( pNode->pRight && (pNode->pRight->xCode == PH7_CompileList \|\|` |
|   4774506 | 1218 | `				pNode->pRight->xCode == PH7_CompileShortList) ){` |
...
|         - | 1224 | `				 */` |
|        91 | 1225 | `				iVmOp = 0;` |
|   4774500 | 1226 | `			}else if( (pInstr = PH7_VmPeekInstr(pGen->pVm)) != 0 ){` |
|   4774457 | 1227 | `				if(pInstr->iOp == PH7_OP_MEMBER ){` |
|         - | 1228 | `					/* Perform a member store operation [i.e: $this->x = 50] */` |
|    922231 | 1229 | `					iP2 = 1;` |
|    461118 | 1230 | `				}else{` |
|   3852231 | 1231 | `					if( pInstr->iOp == PH7_OP_LOAD_IDX ){` |
|         - | 1232 | `						/* Transform the STORE instruction to STORE_IDX instruction */` |
|    537359 | 1233 | `						iVmOp = PH7_OP_STORE_IDX;` |
|    537359 | 1234 | `						iP1 = pInstr->iP1;` |
|    268682 | 1235 | `					}else{` |
|   3314877 | 1236 | `						p3 = pInstr->p3;` |
|         - | 1237 | `					}` |
|         - | 1238 | `					/* POP the last dynamic load instruction */` |
|   3852231 | 1239 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|         - | 1240 | `				}` |
|   2387231 | 1241 | `			}` |
|  14652662 | 1242 | `		}else if( iVmOp == PH7_OP_STORE_REF ){` |
...
|        35 | 1269 | `		}` |
|   8519963 | 1270 | `	}` |
|  29669060 | 1271 | `	if( iVmOp == PH7_OP_NEW && pNode->pLeft && pNode->pLeft->pOp == 0` |
|    433390 | 1272 | `		&& pNode->pLeft->xCode == PH7_CompileAnnonClass ){` |
...
|        34 | 1275 | `		iVmOp = 0;` |
|        15 | 1276 | `	}` |
|  29669065 | 1277 | `	if( iVmOp > 0 ){` |
|  29610461 | 1278 | `		if( iVmOp == PH7_OP_INCR \|\| iVmOp == PH7_OP_DECR ){` |
|    218171 | 1279 | `			if( pNode->iFlags & EXPR_NODE_PRE_INCR ){` |
|         - | 1280 | `				/* Pre-increment/decrement operator [i.e: ++$i,--$j ] */` |
|     15585 | 1281 | `				iP1 = 1;` |
|      7795 | 1282 | `			}` |
|  29501378 | 1283 | `		}else if( iVmOp == PH7_OP_NEW ){` |
|         - | 1284 | `			/* Namespace-qualify the class name for NEW */ {` |
|    870011 | 1285 | `				VmInstr *pPeek = PH7_VmPeekInstr(pGen->pVm);` |
|    870011 | 1286 | `				VmInstr *pCallInstr = 0;` |
|    870011 | 1287 | `				if( pPeek && pPeek->iOp == PH7_OP_CALL ){` |
|    858147 | 1288 | `					pCallInstr = pPeek;` |
|    858147 | 1289 | `					pPeek = PH7_VmPeekNextInstr(pGen->pVm);` |
|    429071 | 1290 | `				}` |
|    870011 | 1291 | `				if( pPeek && pPeek->iOp == PH7_OP_LOADC ){` |
|    854451 | 1292 | `					int bAbsolute = (pPeek->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|         - | 1293 | `					sxu32 nLitForClass;` |
|    854451 | 1294 | `					VmCallArgMap *pCallNsMap = pCallInstr ? (VmCallArgMap *)pCallInstr->p3 : 0;` |
...
|    854451 | 1301 | `					if( pCallNsMap && pCallNsMap->nOrigNameLit > 0 ){` |
|        55 | 1302 | `						nLitForClass = pCallNsMap->nOrigNameLit - 1;` |
|        30 | 1303 | `					}else{` |
|    854401 | 1304 | `						nLitForClass = (sxu32)pPeek->iP2;` |
|         - | 1305 | `					}` |
|    854451 | 1306 | `					pPeek->iP1 = 0;` |
|    854451 | 1307 | `					if( !bAbsolute ){` |
...
|    850535 | 1312 | `						ph7_value *pLitChk = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,nLitForClass);` |
|    850535 | 1313 | `						int isSpecialNew = 0;` |
|    850535 | 1314 | `						if( pLitChk && (pLitChk->iFlags & MEMOBJ_STRING) ){` |
|    835375 | 1315 | `							const char *z = (const char *)SyBlobData(&pLitChk->sBlob);` |
|    835375 | 1316 | `							sxu32 n = (sxu32)SyBlobLength(&pLitChk->sBlob);` |
|    835370 | 1317 | `							if( (n == 4 && SyMemcmp(z,"self",4) == 0) \|\|` |
|    839107 | 1318 | `								(n == 6 && SyMemcmp(z,"static",6) == 0) \|\|` |
|    417633 | 1319 | `								(n == 6 && SyMemcmp(z,"parent",6) == 0) ){` |
|      7815 | 1320 | `								isSpecialNew = 1;` |
|      3905 | 1321 | `							}` |
|    421475 | 1322 | `						}` |
|    858115 | 1323 | `						if( isSpecialNew ){` |
|      7815 | 1324 | `							pPeek->iP2 = (sxi32)nLitForClass;` |
|      3910 | 1325 | `						}else{` |
|    835145 | 1326 | `							pPeek->iP2 = (sxi32)GenStateNsQualifyName(pGen,nLitForClass,&pGen->hUseImports,0);` |
|         - | 1327 | `						}` |
|    421480 | 1328 | `					}else{` |
|      3921 | 1329 | `						pPeek->iP2 = (sxi32)nLitForClass;` |
|         - | 1330 | `					}` |
|    423433 | 1331 | `				}` |
|         - | 1332 | `			}` |
|    862431 | 1333 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|    862431 | 1334 | `			if( pInstr && pInstr->iOp == PH7_OP_CALL ){` |
|         - | 1335 | `				VmInstr *pPrev;` |
|    858147 | 1336 | `				pPrev = PH7_VmPeekNextInstr(pGen->pVm);` |
|    858147 | 1337 | `				if( pPrev == 0 \|\| pPrev->iOp != PH7_OP_MEMBER ){` |
...
|    858147 | 1341 | `					iP1 = pInstr->iP1;` |
|    858147 | 1342 | `					iP2 = pInstr->iP2;` |
|    858147 | 1343 | `					if( pInstr->p3 ){` |
|        65 | 1344 | `						p3 = pInstr->p3; /* Transfer VmCallArgMap to NEW */` |
|        30 | 1345 | `					}` |
|    858147 | 1346 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|    429071 | 1347 | `				}` |
|    429076 | 1348 | `			}` |
|  28953502 | 1349 | `		}else if( iVmOp == PH7_OP_IS_A ){` |
...
|     81961 | 1352 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|     81961 | 1353 | `			if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|     81961 | 1354 | `				ph7_value *pLitChk = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,(sxu32)pInstr->iP2);` |
|     81961 | 1355 | `				int bAbsolute = (pInstr->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|     81961 | 1356 | `				int isSpecialIs = 0;` |
|     81961 | 1357 | `				if( pLitChk && (pLitChk->iFlags & MEMOBJ_STRING) ){` |
|     81961 | 1358 | `					const char *z = (const char *)SyBlobData(&pLitChk->sBlob);` |
|     81961 | 1359 | `					sxu32 n = (sxu32)SyBlobLength(&pLitChk->sBlob);` |
|     81956 | 1360 | `					if( (n == 4 && SyMemcmp(z,"self",4) == 0) \|\|` |
|     81959 | 1361 | `						(n == 6 && SyMemcmp(z,"static",6) == 0) \|\|` |
|     40978 | 1362 | `						(n == 6 && SyMemcmp(z,"parent",6) == 0) ){` |
|        12 | 1363 | `						isSpecialIs = 1;` |
|         5 | 1364 | `					}` |
|     40978 | 1365 | `				}` |
|     81961 | 1366 | `				pInstr->iP1 = 0;` |
|     81961 | 1367 | `				if( !isSpecialIs && !bAbsolute ){` |
|     81941 | 1368 | `					pInstr->iP2 = (sxi32)GenStateNsQualifyName(pGen,(sxu32)pInstr->iP2,&pGen->hUseImports,0);` |
|     40968 | 1369 | `				}` |
|     40983 | 1370 | `			}` |
|  28481311 | 1371 | `		}else if( iVmOp == PH7_OP_MEMBER){` |
...
|   6003479 | 1375 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|   6003479 | 1376 | `			if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|   5762321 | 1377 | `				pInstr->iP1 = 0;` |
|   2881158 | 1378 | `			}` |
|   6003479 | 1379 | `			if( pNode->pOp->iOp == EXPR_OP_DC /* '::' */){` |
|         - | 1380 | `				/* Static member access,remember that */` |
|    420887 | 1381 | `				iP1 = 1;` |
|    420887 | 1382 | `				pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|    420887 | 1383 | `				if( pInstr && pInstr->iOp == PH7_OP_LOAD ){` |
|    237261 | 1384 | `					p3 = pInstr->p3;` |
|    237261 | 1385 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|    118628 | 1386 | `				}` |
|    210441 | 1387 | `			}` |
...
|   6003479 | 1392 | `			if( iP2 == PH7_MEMBER_READ ){` |
|   6003479 | 1393 | `				if( iFlags & EXPR_FLAG_LOAD_IDX_UNSET ){` |
|        42 | 1394 | `					iP2 = PH7_MEMBER_UNSET;` |
|   6003459 | 1395 | `				}else if( iFlags & EXPR_FLAG_LOAD_IDX_ISSET ){` |
|     70127 | 1396 | `					iP2 = PH7_MEMBER_ISSET;` |
|   5968378 | 1397 | `				}else if( iFlags & EXPR_FLAG_LOAD_IDX_EMPTY ){` |
|        17 | 1398 | `					iP2 = PH7_MEMBER_EMPTY;` |
|   5933309 | 1399 | `				}else if( iFlags & EXPR_FLAG_MEMBER_WRITE ){` |
|         - | 1400 | `					/* Write-lvalue base ($o->arr[$k]=v, $o->p ??= v): auto-create a missing prop. */` |
|   1116817 | 1401 | `					iP2 = PH7_MEMBER_WRITE;` |
|    558406 | 1402 | `				}` |
|   3001737 | 1403 | `			}` |
|   3001737 | 1404 | `		}` |
...
|  29602881 | 1432 | `		if( iVmOp == PH7_OP_CALL \|\| iVmOp == PH7_OP_NEW ){` |
|   7934517 | 1433 | `			p3 = GenStateAttachStrictFlag(pGen,p3);` |
|   3967256 | 1434 | `		}` |
|         - | 1435 | `		/* Finally,emit the VM instruction associated with this operator */` |
|  29602881 | 1436 | `		PH7_VmEmitInstr(pGen->pVm,iVmOp,iP1,iP2,p3,0);` |
|  14801438 | 1437 | `	}` |
|  29661485 | 1438 | `	if( nJmpIdx > 0 ){` |
|         - | 1439 | `		/* Fix short-circuited jumps now the destination is resolved */` |
|    836749 | 1440 | `		pInstr = PH7_VmGetInstr(pGen->pVm,nJmpIdx);` |
|    836749 | 1441 | `		if( pInstr ){` |
|    836749 | 1442 | `			pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    418372 | 1443 | `		}` |
|    418372 | 1444 | `	}` |
|  29661485 | 1445 | `	return rc;` |
|  38087392 | 1446 | `}` |
|         - | 1447 | `/*` |
...
|         - | 1468 | ` */` |
| 252867376 | 1469 | `static int GenStateTreeHasComma(ph7_expr_node *pNode)` |
|         5 | 1470 | `{` |
|         - | 1471 | `	ph7_expr_node **apArg;` |
|         - | 1472 | `	sxu32 n;` |
| 252867381 | 1473 | `	if( pNode == 0 ){` |
| 177774523 | 1474 | `		return 0;` |
|         - | 1475 | `	}` |
|  75092863 | 1476 | `	if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_COMMA ){` |
|         6 | 1477 | `		return 1;` |
|         - | 1478 | `	}` |
|  75092854 | 1479 | `	if( GenStateTreeHasComma(pNode->pLeft) \|\| GenStateTreeHasComma(pNode->pRight)` |
|  75092855 | 1480 | `	 \|\| GenStateTreeHasComma(pNode->pCond) ){` |
|         6 | 1481 | `		return 1;` |
|         - | 1482 | `	}` |
|  75092855 | 1483 | `	apArg = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  85894949 | 1484 | `	for( n = 0 ; n < SySetUsed(&pNode->aNodeArgs) ; n++ ){` |
|  10802099 | 1485 | `		if( GenStateTreeHasComma(apArg[n]) ){` |
|       ! 0 | 1486 | `			return 1;` |
|         - | 1487 | `		}` |
|   5401052 | 1488 | `	}` |
|  75092855 | 1489 | `	return 0;` |
| 126433693 | 1490 | `}` |
|  17160612 | 1491 | `PH7_PRIVATE sxi32 PH7_CompileExpr(` |
...
|  17160617 | 1505 | `	nExpr = 0;` |
|  17160617 | 1506 | `	pRoot = 0;` |
...
|  17160617 | 1509 | `	nNullsafeBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  17160617 | 1510 | `	SySetInit(&sExprNode,&pGen->pVm->sAllocator,sizeof(ph7_expr_node *));` |
|  17160617 | 1511 | `	SySetAlloc(&sExprNode,0x10);` |
|  17160617 | 1512 | `	rc = SXRET_OK;` |
|         - | 1513 | `	/* Delimit the expression */` |
|  17160617 | 1514 | `	pEnd = pGen->pIn;` |
|  17160617 | 1515 | `	iNest = 0;` |
| 134339843 | 1516 | `	while( pEnd < pGen->pEnd ){` |
| 127741911 | 1517 | `		if( pEnd->nType & PH7_TK_OCB /* '{' */ ){` |
|         - | 1518 | `			/* Ticket 1433-30: Annonymous/Closure functions body */` |
|      4731 | 1519 | `			iNest++;` |
| 127739548 | 1520 | `		}else if(pEnd->nType & PH7_TK_CCB /* '}' */ ){` |
|      4741 | 1521 | `			iNest--;` |
| 127734817 | 1522 | `		}else if( pEnd->nType & PH7_TK_SEMI /* ';' */ ){` |
|  10563555 | 1523 | `			if( iNest <= 0 ){` |
|  10562685 | 1524 | `				break;` |
|         - | 1525 | `			}` |
|       435 | 1526 | `		}` |
| 117179231 | 1527 | `		pEnd++;` |
|         5 | 1528 | `	}` |
|  17160617 | 1529 | `	if( iFlags & EXPR_FLAG_COMMA_STATEMENT ){` |
|    739849 | 1530 | `		SyToken *pEnd2 = pGen->pIn;` |
|    739849 | 1531 | `		iNest = 0;` |
|         - | 1532 | `		/* Stop at the first comma */` |
|   1624641 | 1533 | `		while( pEnd2 < pEnd ){` |
|    884799 | 1534 | `			if( pEnd2->nType & (PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*'['*/\|PH7_TK_LPAREN/*'('*/) ){` |
|     50661 | 1535 | `				iNest++;` |
|    859471 | 1536 | `			}else if(pEnd2->nType & (PH7_TK_CCB/*'}'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_RPAREN/*')'*/)){` |
|     50661 | 1537 | `				iNest--;` |
|    808815 | 1538 | `			}else if( pEnd2->nType & PH7_TK_COMMA /*','*/ ){` |
...
|    884797 | 1543 | `			pEnd2++;` |
|         5 | 1544 | `		}` |
|    739849 | 1545 | `		if( pEnd2 <pEnd ){` |
|         3 | 1546 | `			pEnd = pEnd2;` |
|         1 | 1547 | `		}` |
|    369922 | 1548 | `	}` |
|  17160617 | 1549 | `	if( pEnd > pGen->pIn ){` |
|  17137281 | 1550 | `		SyToken *pTmp = pGen->pEnd;` |
|         - | 1551 | `		/* Swap delimiter */` |
|  17137281 | 1552 | `		pGen->pEnd = pEnd;` |
|         - | 1553 | `		/* Try to get an expression tree */` |
|  17137281 | 1554 | `		rc = PH7_ExprMakeTree(&(*pGen),&sExprNode,&pRoot);` |
|  17137276 | 1555 | `		if( rc == SXRET_OK && pRoot && pGen->nCommaExprOk < 1` |
|  16961917 | 1556 | `		 && GenStateTreeHasComma(pRoot) ){` |
...
|         - | 1569 | `		}` |
|  17137277 | 1570 | `		if( rc == SXRET_OK && pRoot ){` |
|  17137097 | 1571 | `			rc = SXRET_OK;` |
|  17137097 | 1572 | `			if( xTreeValidator ){` |
|         - | 1573 | `				/* Call the upper layer validator callback */` |
|   1036137 | 1574 | `				rc = xTreeValidator(&(*pGen),pRoot);` |
|    518066 | 1575 | `			}` |
|  17137097 | 1576 | `			if( rc != SXERR_ABORT ){` |
|         - | 1577 | `				/* Generate code for the given tree */` |
|  17137097 | 1578 | `				rc = GenStateEmitExprCode(&(*pGen),pRoot,iFlags);` |
|         - | 1579 | `				/* Patch any unresolved nullsafe jumps emitted by this` |
|         - | 1580 | `				 * expression so they short-circuit to its end. */` |
|  17137097 | 1581 | `				GenStatePatchNullsafeJumps(pGen, nNullsafeBase);` |
|   8568546 | 1582 | `			}` |
|  17137097 | 1583 | `			nExpr = 1;` |
|   8568546 | 1584 | `		}` |
|         - | 1585 | `		/* Release the whole tree */` |
|  17137277 | 1586 | `		PH7_ExprFreeTree(&(*pGen),&sExprNode);` |
|         - | 1587 | `		/* Synchronize token stream */` |
|  17137277 | 1588 | `		pGen->pEnd = pTmp;` |
|  17137277 | 1589 | `		pGen->pIn  = pEnd;` |
|  17137277 | 1590 | `		if( rc == SXERR_ABORT ){` |
|        18 | 1591 | `			SySetRelease(&sExprNode);` |
|        18 | 1592 | `			return SXERR_ABORT;` |
|         - | 1593 | `		}` |
|   8568629 | 1594 | `	}` |
|  17160599 | 1595 | `	SySetRelease(&sExprNode);` |
|  17160599 | 1596 | `	return nExpr > 0 ? SXRET_OK : SXERR_EMPTY;` |
|   8580311 | 1597 | `}` |
|         - | 1598 | `/*` |
|         - | 1599 | ` * Return a pointer to the node construct handler associated` |
|         - | 1600 | ` * with a given node type [i.e: string,integer,float,...].` |
|         - | 1601 | ` */` |
|   9531312 | 1602 | `PH7_PRIVATE ProcNodeConstruct PH7_GetNodeHandler(sxu32 nNodeType)` |
|         5 | 1603 | `{` |
|   9531317 | 1604 | `	if( nNodeType & PH7_TK_NUM ){` |
|         - | 1605 | `		/* Numeric literal: Either real or integer */` |
|   3833163 | 1606 | `		return PH7_CompileNumLiteral;` |
|   5698159 | 1607 | `	}else if( nNodeType & PH7_TK_DSTR ){` |
|         - | 1608 | `		/* Double quoted string */` |
|    125157 | 1609 | `		return PH7_CompileString;` |
|   5573007 | 1610 | `	}else if( nNodeType & PH7_TK_SSTR ){` |
|         - | 1611 | `		/* Single quoted string */` |
|   5572883 | 1612 | `		return PH7_CompileSimpleString;` |
...
|         - | 1629 | ` */` |
|     23446 | 1630 | `static sxi32 GenStateUnsetValidator(ph7_gen_state *pGen, ph7_expr_node *pNode)` |
|         5 | 1631 | `{` |
|         - | 1632 | `	sxi32 rc;` |
|     23451 | 1633 | `	if( !PH7_ExprContainsNullsafe(pNode) ){` |
|     23449 | 1634 | `		return SXRET_OK;` |
|         - | 1635 | `	}` |
...
|         - | 1647 | ` */` |
|     26156 | 1648 | `static sxi32 PH7_CompileUnset(ph7_gen_state *pGen)` |
|         5 | 1649 | `{` |
|     26161 | 1650 | `	SyToken *pTmp,*pEnd,*pNext = 0;` |
|     26161 | 1651 | `	sxu32 nIdx = 0;` |
|         - | 1652 | `	SyString sName;` |
|         - | 1653 | `	sxi32 rc;` |
|         - | 1654 | `	/* Jump the 'unset' keyword */` |
|     26161 | 1655 | `	pGen->pIn++;` |
|         - | 1656 | `	/* Save delimiter */` |
|     26161 | 1657 | `	pTmp = pGen->pEnd;` |
|         - | 1658 | `	/* Skip optional opening parenthesis and find the matching close */` |
|     26161 | 1659 | `	pEnd = pTmp; /* Default: scan to statement end */` |
|     26161 | 1660 | `	if( pGen->pIn < pTmp && (pGen->pIn->nType & PH7_TK_LPAREN) ){` |
|         - | 1661 | `		/* Find matching ')' — start scanning AFTER the '(' */` |
|         - | 1662 | `		SyToken *pClose;` |
|     26161 | 1663 | `		pGen->pIn++;   /* Skip '(' */` |
|     26161 | 1664 | `		PH7_DelimitNestedTokens(pGen->pIn,pTmp,PH7_TK_LPAREN,PH7_TK_RPAREN,&pClose);` |
|     26161 | 1665 | `		pEnd = pClose; /* Stop at ')' */` |
|     13078 | 1666 | `	}` |
|     26161 | 1667 | `	SyStringInitFromBuf(&sName,"unset",sizeof("unset")-1);` |
|         - | 1668 | `	/* Resolve the 'unset' builtin name once */` |
|     26161 | 1669 | `	if( SXRET_OK != GenStateFindLiteral(&(*pGen),&sName,&nIdx) ){` |
|      3893 | 1670 | `		ph7_value *pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|      3893 | 1671 | `		if( pObj == 0 ){` |
|       ! 0 | 1672 | `			return SXERR_ABORT;` |
|         - | 1673 | `		}` |
|      3893 | 1674 | `		PH7_MemObjInitFromString(pGen->pVm,pObj,&sName);` |
|      3893 | 1675 | `		GenStateInstallLiteral(&(*pGen),pObj,nIdx);` |
|      1944 | 1676 | `	}` |
|         - | 1677 | `	/* Compile each comma-separated argument */` |
|     56197 | 1678 | `	while( SXRET_OK == PH7_GetNextExpr(pGen->pIn,pEnd,&pNext) ){` |
|     30041 | 1679 | `		if( pGen->pIn < pNext ){` |
|         - | 1680 | `			/*` |
...
|         - | 1687 | `			 */` |
|     30036 | 1688 | `			if( &pGen->pIn[2] == pNext` |
|     18313 | 1689 | `				&& (pGen->pIn[0].nType & PH7_TK_DOLLAR)` |
...
|      6593 | 1706 | `				continue;` |
|         - | 1707 | `			}` |
|     23453 | 1708 | `			pGen->pEnd = pNext;` |
|     23453 | 1709 | `			rc = PH7_CompileExpr(&(*pGen),` |
|         - | 1710 | `				EXPR_FLAG_RDONLY_LOAD\|EXPR_FLAG_LOAD_IDX_UNSET,` |
|         - | 1711 | `				GenStateUnsetValidator);` |
|     23453 | 1712 | `			if( rc == SXERR_ABORT ){` |
|       ! 0 | 1713 | `				return SXERR_ABORT;` |
|         - | 1714 | `			}` |
|     23453 | 1715 | `			if( rc != SXERR_EMPTY ){` |
|         - | 1716 | `				/* Emit call for this single argument */` |
|     23451 | 1717 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|     23451 | 1718 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_CALL,1,0,GenStateAttachStrictFlag(pGen,0),0);` |
|     23451 | 1719 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|     11723 | 1720 | `			}` |
|     11724 | 1721 | `		}` |
|         - | 1722 | `		/* Jump trailing commas */` |
|     23459 | 1723 | `		while( pNext < pEnd && (pNext->nType & PH7_TK_COMMA) ){` |
|         7 | 1724 | `			pNext++;` |
|         1 | 1725 | `		}` |
|     23453 | 1726 | `		pGen->pIn = pNext;` |
|         5 | 1727 | `	}` |
|         - | 1728 | `	/* Skip past the closing ')' if present */` |
|     26161 | 1729 | `	if( pGen->pIn < pTmp && (pGen->pIn->nType & PH7_TK_RPAREN) ){` |
|     26161 | 1730 | `		pGen->pIn++;` |
|     13078 | 1731 | `	}` |
|         - | 1732 | `	/* Restore token stream */` |
|     26161 | 1733 | `	pGen->pEnd = pTmp;` |
|     26161 | 1734 | `	return SXRET_OK;` |
|     13083 | 1735 | `}` |
|         - | 1736 | `/*` |
...
|         - | 1768 | ` */` |
|   8469620 | 1769 | `static ProcLangConstruct GenStateGetStatementHandler(` |
|         - | 1770 | `	sxu32 nKeywordID,   /* Keyword  ID*/` |
|         - | 1771 | `	SyToken *pLookahed  /* Look-ahead token */` |
|         - | 1772 | `	)` |
|         5 | 1773 | `{` |
|   8469625 | 1774 | `	sxu32 n = 0;` |
|  34203964 | 1775 | `	for(;;){` |
|  68407933 | 1776 | `		if( n >= SX_ARRAYSIZE(aLangConstruct) ){` |
|    535183 | 1777 | `			break;` |
|         - | 1778 | `		}` |
|  67872755 | 1779 | `		if( aLangConstruct[n].nID == nKeywordID ){` |
|   7934447 | 1780 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed && (pLookahed->nType & PH7_TK_OP)){` |
...
|         - | 1785 | `				}` |
|       ! 0 | 1786 | `			}` |
|   7934442 | 1787 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed` |
|     11678 | 1788 | `				&& (pLookahed->nType & PH7_TK_KEYWORD)` |
|      5846 | 1789 | `				&& SX_PTR_TO_INT(pLookahed->pUserData) == PH7_TKWRD_FN ){` |
|         - | 1790 | `				/* 'static fn(...)' arrow function — compile as expression */` |
|         3 | 1791 | `				return 0;` |
|         - | 1792 | `			}` |
|         - | 1793 | `			/* Return a pointer to the handler.` |
|         - | 1794 | `			*/` |
|   7934445 | 1795 | `			return aLangConstruct[n].xConstruct;` |
|         - | 1796 | `		}` |
|  59938313 | 1797 | `		n++;` |
|         5 | 1798 | `	}` |
|    535183 | 1799 | `	if( pLookahed ){` |
|    535183 | 1800 | `		if(nKeywordID == PH7_TKWRD_INTERFACE && (pLookahed->nType & PH7_TK_ID) ){` |
|     70113 | 1801 | `			return PH7_CompileClassInterface;` |
|    465075 | 1802 | `		}else if(nKeywordID == PH7_TKWRD_CLASS && (pLookahed->nType & PH7_TK_ID) ){` |
|    398395 | 1803 | `			return PH7_CompileClass;` |
|     66685 | 1804 | `		}else if(nKeywordID == PH7_TKWRD_TRAIT && (pLookahed->nType & PH7_TK_ID) ){` |
|      7881 | 1805 | `			return PH7_CompileTrait;` |
|         - | 1806 | `		}` |
...
|         - | 1818 | ` */` |
|     58806 | 1819 | `static int GenStateisLangConstruct(sxu32 nKeyword)` |
|         5 | 1820 | `{` |
|         - | 1821 | `	int rc;` |
|     58811 | 1822 | `	rc = PH7_IsLangConstruct(nKeyword,TRUE);` |
|     58811 | 1823 | `	if( rc == FALSE ){` |
|     58704 | 1824 | `		if( nKeyword == PH7_TKWRD_SELF \|\| nKeyword == PH7_TKWRD_PARENT \|\| nKeyword == PH7_TKWRD_STATIC` |
|     15922 | 1825 | `			\|\| nKeyword == PH7_TKWRD_YIELD` |
...
|         - | 1849 | ` */` |
|  18176458 | 1850 | `PH7_PRIVATE void GenStateSetPendingDoc(ph7_gen_state *pGen)` |
|         5 | 1851 | `{` |
|  18176463 | 1852 | `	SyToken *pBase = (SyToken *)SySetBasePtr(pGen->pTokenSet);` |
|  18176463 | 1853 | `	ph7_trivia *aT = (ph7_trivia *)SySetBasePtr(&pGen->aTrivia);` |
|  18176463 | 1854 | `	sxu32 nT = SySetUsed(&pGen->aTrivia);` |
|         - | 1855 | `	sxu32 nIdx, n;` |
|  18176458 | 1856 | `	if( nT < 1 \|\| pGen->pTokenSet == 0` |
|   3428139 | 1857 | `	 \|\| pGen->pIn < pBase \|\| pGen->pIn >= &pBase[SySetUsed(pGen->pTokenSet)] ){` |
|         - | 1858 | `		/* Re-tokenized substream (string interpolation, synthesized code):` |
|         - | 1859 | `		 * indexes do not map to the sidecar */` |
|  14748331 | 1860 | `		return;` |
|         - | 1861 | `	}` |
|   3428137 | 1862 | `	nIdx = (sxu32)(pGen->pIn - pBase);` |
...
|   3428137 | 1865 | `	SySetReset(&pGen->aPendingAttrs);` |
|  10286161 | 1866 | `	for( n = 0 ; n < nT ; n++ ){` |
|   6858029 | 1867 | `		if( aT[n].nTokIdx != nIdx ){` |
|   6850081 | 1868 | `			continue;` |
|         - | 1869 | `		}` |
|      7953 | 1870 | `		if( aT[n].iKind == PH7_TRIVIA_DOC ){` |
|        29 | 1871 | `			pGen->sPendingDoc = aT[n].sText;` |
|      7941 | 1872 | `		}else if( aT[n].iKind == PH7_TRIVIA_ATTR ){` |
|      7929 | 1873 | `			SySetPut(&pGen->aPendingAttrs,(const void *)&aT[n]);` |
|      3962 | 1874 | `		}` |
|      3979 | 1875 | `	}` |
|   9088234 | 1876 | `}` |
|         - | 1877 | `/*` |
...
|         - | 1881 | ` */` |
|   4890708 | 1882 | `PH7_PRIVATE void GenStateConsumeDoc(ph7_gen_state *pGen,SyString *pOut)` |
|         5 | 1883 | `{` |
|         - | 1884 | `	char *zDup;` |
|   4890713 | 1885 | `	if( SyStringLength(&pGen->sPendingDoc) < 1 ){` |
|   4890693 | 1886 | `		return;` |
|         - | 1887 | `	}` |
...
|         - | 1903 | ` */` |
|      7938 | 1904 | `static sxi32 GenStateCompileAttrSpan(ph7_gen_state *pGen,ph7_trivia *pTrivia,SySet *pOut)` |
|         5 | 1905 | `{` |
|         - | 1906 | `	SySet *pToken;` |
|         - | 1907 | `	SyToken *pIn, *pEnd, *pSavedIn, *pSavedEnd;` |
|         - | 1908 | `	char *zSpan;` |
|      7943 | 1909 | `	sxi32 rc = SXRET_OK;` |
|      7943 | 1910 | `	if( SyStringLength(&pTrivia->sText) < 1 ){` |
|       ! 0 | 1911 | `		return SXRET_OK;` |
|         - | 1912 | `	}` |
|     11912 | 1913 | `	zSpan = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|      3969 | 1914 | `		SyStringData(&pTrivia->sText),SyStringLength(&pTrivia->sText));` |
|      7943 | 1915 | `	if( zSpan == 0 ){` |
...
|      7943 | 1921 | `	pToken = (SySet *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(SySet));` |
|      7943 | 1922 | `	if( pToken == 0 ){` |
|       ! 0 | 1923 | `		return SXRET_OK;` |
|         - | 1924 | `	}` |
|      7943 | 1925 | `	SySetInit(pToken,&pGen->pVm->sAllocator,sizeof(SyToken));` |
|      7943 | 1926 | `	PH7_TokenizePHP(zSpan,SyStringLength(&pTrivia->sText),pTrivia->nLine,pToken,0);` |
|      7943 | 1927 | `	pIn = (SyToken *)SySetBasePtr(pToken);` |
|      7943 | 1928 | `	pEnd = &pIn[SySetUsed(pToken)];` |
|      7943 | 1929 | `	pSavedIn = pGen->pIn;` |
|      7943 | 1930 | `	pSavedEnd = pGen->pEnd;` |
|      7947 | 1931 | `	while( pIn < pEnd ){` |
|         - | 1932 | `		ph7_attribute sAttr;` |
|         - | 1933 | `		SyBlob sFQN;` |
|      7947 | 1934 | `		int bAbsolute = 0;` |
|      7947 | 1935 | `		SyZero(&sAttr,sizeof(sAttr));` |
|      7947 | 1936 | `		SySetInit(&sAttr.aArgs,&pGen->pVm->sAllocator,sizeof(ph7_attr_arg));` |
|      7947 | 1937 | `		sAttr.nLine = pIn->nLine;` |
|      7947 | 1938 | `		if( pIn->nType & PH7_TK_NSSEP ){` |
|        75 | 1939 | `			bAbsolute = 1;` |
|        75 | 1940 | `			pIn++;` |
|        35 | 1941 | `		}` |
|      7947 | 1942 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|      7947 | 1943 | `		while( pIn < pEnd && (pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|      7947 | 1944 | `			SyBlobAppend(&sFQN,pIn->sData.zString,pIn->sData.nByte);` |
|      7947 | 1945 | `			pIn++;` |
|      7947 | 1946 | `			if( pIn < pEnd && (pIn->nType & PH7_TK_NSSEP) ){` |
...
|      7947 | 1951 | `			break;` |
|       ! 0 | 1952 | `		}` |
|      7947 | 1953 | `		if( SyBlobLength(&sFQN) < 1 ){` |
...
|         - | 1961 | `		{` |
|      7947 | 1962 | `			const char *zName = (const char *)SyBlobData(&sFQN);` |
|      7947 | 1963 | `			sxu32 nName = SyBlobLength(&sFQN);` |
|      7947 | 1964 | `			char *zDup = 0;` |
|      7947 | 1965 | `			if( !bAbsolute ){` |
|      7877 | 1966 | `				SyHashEntry *pImp = SyHashGet(&pGen->hUseImports,(const void *)zName,nName);` |
|      7877 | 1967 | `				if( pImp ){` |
...
|       ! 0 | 1972 | `					}` |
|      7877 | 1973 | `				}else if( SyBlobLength(&pGen->sNamespace) > 0 ){` |
|         - | 1974 | `					SyBlob sTmp;` |
...
|       ! 0 | 1985 | `				}` |
|      3936 | 1986 | `			}` |
|      7947 | 1987 | `			if( SyStringLength(&sAttr.sName) < 1 ){` |
|      7947 | 1988 | `				zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,zName,nName);` |
|      7947 | 1989 | `				if( zDup ){` |
|      7947 | 1990 | `					SyStringInitFromBuf(&sAttr.sName,zDup,nName);` |
|      3971 | 1991 | `				}` |
|      3971 | 1992 | `			}` |
|         - | 1993 | `		}` |
|      7947 | 1994 | `		SyBlobRelease(&sFQN);` |
|      7947 | 1995 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_LPAREN) ){` |
|         - | 1996 | `			SyToken *pArgsEnd;` |
|      7845 | 1997 | `			pIn++;` |
|      7845 | 1998 | `			PH7_DelimitNestedTokens(pIn,pEnd,PH7_TK_LPAREN,PH7_TK_RPAREN,&pArgsEnd);` |
|     15699 | 1999 | `			while( pIn < pArgsEnd ){` |
|      7859 | 2000 | `				SyToken *pArgStart = pIn, *pArgStop = pIn;` |
|      7859 | 2001 | `				sxi32 iDepth = 0;` |
|         - | 2002 | `				ph7_attr_arg sArgRec;` |
|     78037 | 2003 | `				while( pArgStop < pArgsEnd ){` |
|     70199 | 2004 | `					if( pArgStop->nType & (PH7_TK_LPAREN\|PH7_TK_OSB\|PH7_TK_OCB) ){` |
|        11 | 2005 | `						iDepth++;` |
|     70194 | 2006 | `					}else if( pArgStop->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB) ){` |
|        11 | 2007 | `						iDepth--;` |
|     70184 | 2008 | `					}else if( (pArgStop->nType & PH7_TK_COMMA) && iDepth == 0 ){` |
|        17 | 2009 | `						break;` |
|         - | 2010 | `					}` |
|     70183 | 2011 | `					pArgStop++;` |
|         5 | 2012 | `				}` |
|      7859 | 2013 | `				SyZero(&sArgRec,sizeof(sArgRec));` |
|      7859 | 2014 | `				SySetInit(&sArgRec.aByteCode,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|      7854 | 2015 | `				if( pArgStart < pArgStop && (pArgStart->nType & (PH7_TK_ID\|PH7_TK_KEYWORD))` |
|      7836 | 2016 | `				 && &pArgStart[1] < pArgStop && (pArgStart[1].nType & PH7_TK_COLON) ){` |
...
|        19 | 2022 | `					pArgStart += 2;` |
|         9 | 2023 | `				}` |
|      7859 | 2024 | `				if( pArgStart < pArgStop ){` |
|         - | 2025 | `					SySet *pInstrContainer;` |
|      7859 | 2026 | `					pGen->pIn = pArgStart;` |
|      7859 | 2027 | `					pGen->pEnd = pArgStop;` |
|      7859 | 2028 | `					pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|      7859 | 2029 | `					PH7_VmSetByteCodeContainer(pGen->pVm,&sArgRec.aByteCode);` |
|      7859 | 2030 | `					rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|      7859 | 2031 | `					PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|      7859 | 2032 | `					PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|      7859 | 2033 | `					if( rc == SXERR_ABORT ){` |
|       ! 0 | 2034 | `						pGen->pIn = pSavedIn;` |
|       ! 0 | 2035 | `						pGen->pEnd = pSavedEnd;` |
|       ! 0 | 2036 | `						return SXERR_ABORT;` |
|         - | 2037 | `					}` |
|      7859 | 2038 | `					SySetPut(&sAttr.aArgs,(const void *)&sArgRec);` |
|      3927 | 2039 | `				}` |
|      7859 | 2040 | `				pIn = pArgStop;` |
|      7859 | 2041 | `				if( pIn < pArgsEnd && (pIn->nType & PH7_TK_COMMA) ){` |
|        17 | 2042 | `					pIn++;` |
|         8 | 2043 | `				}` |
|         5 | 2044 | `			}` |
|      7845 | 2045 | `			pIn = (pArgsEnd < pEnd) ? &pArgsEnd[1] : pEnd;` |
|      3920 | 2046 | `		}` |
|      7947 | 2047 | `		SySetPut(pOut,(const void *)&sAttr);` |
|      7947 | 2048 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_COMMA) ){` |
|         5 | 2049 | `			pIn++;` |
|         5 | 2050 | `			continue;` |
|         - | 2051 | `		}` |
|      7943 | 2052 | `		break;` |
|       ! 0 | 2053 | `	}` |
|      7943 | 2054 | `	pGen->pIn = pSavedIn;` |
|      7943 | 2055 | `	pGen->pEnd = pSavedEnd;` |
|      7943 | 2056 | `	return SXRET_OK;` |
|      3974 | 2057 | `}` |
|         - | 2058 | `/*` |
...
|         - | 2061 | ` */` |
|   4890712 | 2062 | `PH7_PRIVATE sxi32 GenStateConsumeAttrs(ph7_gen_state *pGen,SySet *pOut)` |
|         5 | 2063 | `{` |
|   4890717 | 2064 | `	ph7_trivia *aT = (ph7_trivia *)SySetBasePtr(&pGen->aPendingAttrs);` |
|         - | 2065 | `	sxu32 n;` |
|         - | 2066 | `	sxi32 rc;` |
|   4898641 | 2067 | `	for( n = 0 ; n < SySetUsed(&pGen->aPendingAttrs) ; n++ ){` |
|      7929 | 2068 | `		rc = GenStateCompileAttrSpan(&(*pGen),&aT[n],pOut);` |
|      7929 | 2069 | `		if( rc == SXERR_ABORT ){` |
|       ! 0 | 2070 | `			return SXERR_ABORT;` |
|         - | 2071 | `		}` |
|      3967 | 2072 | `	}` |
|   4890717 | 2073 | `	SySetReset(&pGen->aPendingAttrs);` |
|   4890717 | 2074 | `	return SXRET_OK;` |
|   2445361 | 2075 | `}` |
|         - | 2076 | `/*` |
...
|         - | 2080 | ` */` |
|   2460988 | 2081 | `PH7_PRIVATE sxi32 GenStateCollectParamAttrs(ph7_gen_state *pGen,SyToken *pTok,SySet *pOut)` |
|         5 | 2082 | `{` |
|   2460993 | 2083 | `	SyToken *pBase = (SyToken *)SySetBasePtr(pGen->pTokenSet);` |
|   2460993 | 2084 | `	ph7_trivia *aT = (ph7_trivia *)SySetBasePtr(&pGen->aTrivia);` |
|   2460993 | 2085 | `	sxu32 nT = SySetUsed(&pGen->aTrivia);` |
|         - | 2086 | `	sxu32 nIdx, n;` |
|         - | 2087 | `	sxi32 rc;` |
|   2460988 | 2088 | `	if( nT < 1 \|\| pGen->pTokenSet == 0` |
|    556285 | 2089 | `	 \|\| pTok < pBase \|\| pTok >= &pBase[SySetUsed(pGen->pTokenSet)] ){` |
|   1904713 | 2090 | `		return SXRET_OK;` |
|         - | 2091 | `	}` |
|    556285 | 2092 | `	nIdx = (sxu32)(pTok - pBase);` |
|   1668889 | 2093 | `	for( n = 0 ; n < nT ; n++ ){` |
|   1112609 | 2094 | `		if( aT[n].nTokIdx == nIdx && aT[n].iKind == PH7_TRIVIA_ATTR ){` |
...
|         7 | 2099 | `		}` |
|    556307 | 2100 | `	}` |
|    556285 | 2101 | `	return SXRET_OK;` |
|   1230499 | 2102 | `}` |
|  13336270 | 2103 | `PH7_PRIVATE sxi32 GenStateCompileChunk(` |
...
|         - | 2109 | `	sxi32 rc;` |
|  13336275 | 2110 | `	rc = SXRET_OK; /* Prevent compiler warning */` |
|   7751425 | 2111 | `	for(;;){` |
|  14419565 | 2112 | `		int bStmtIsDeclare = 0;` |
|  14419565 | 2113 | `		if( pGen->pIn >= pGen->pEnd ){` |
|         - | 2114 | `			/* No more input to process */` |
|     91603 | 2115 | `			break;` |
|         - | 2116 | `		}` |
|         - | 2117 | `		/* Bind a directly-preceding docblock to this statement */` |
|  14327967 | 2118 | `		GenStateSetPendingDoc(&(*pGen));` |
|  14327967 | 2119 | `		if( SySetUsed(&pGen->aPendingAttrs) > 0 ){` |
...
|      7841 | 2125 | `			int bAttrTarget = 0;` |
|      7836 | 2126 | `			if( GenStateStartsModifiedClass(pGen->pIn,pGen->pEnd)` |
|      3953 | 2127 | `			 \|\| GenStateStartsEnumDecl(pGen->pIn,pGen->pEnd) ){` |
|      7781 | 2128 | `				bAttrTarget = 1;` |
|      3949 | 2129 | `			}else if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
...
|  14327967 | 2151 | `		if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|   8512463 | 2152 | `			sxu32 nPeek = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   8512463 | 2153 | `			if( nPeek == PH7_TKWRD_DECLARE ){` |
|        49 | 2154 | `				bStmtIsDeclare = 1;` |
|        22 | 2155 | `			}` |
|   4256229 | 2156 | `		}` |
|  14327967 | 2157 | `		if( !bStmtIsDeclare && pGen->pCurrent == &pGen->sGlobal ){` |
...
|   1083281 | 2160 | `			pGen->bStrictTypesLocked = 1;` |
|    541638 | 2161 | `		}` |
|  14327967 | 2162 | `		if( pGen->pIn->nType & PH7_TK_OCB /* '{' */ ){` |
|         - | 2163 | `			/* Compile block */` |
|      3933 | 2164 | `			rc = PH7_CompileBlock(&(*pGen),0);` |
|      3933 | 2165 | `			if( rc == SXERR_ABORT ){` |
|       ! 0 | 2166 | `				break;` |
|         - | 2167 | `			}` |
|      1969 | 2168 | `		}else{` |
|  14324039 | 2169 | `			xCons = 0;` |
|  14324039 | 2170 | `			if( GenStateStartsModifiedClass(pGen->pIn,pGen->pEnd) ){` |
...
|     42869 | 2174 | `				xCons = PH7_CompileClassModifiers;` |
|  14302607 | 2175 | `			}else if( GenStateStartsEnumDecl(pGen->pIn,pGen->pEnd) ){` |
|         - | 2176 | ``				/* `enum Name …` (PHP 8.1) — `enum` is a context-sensitive ID,`` |
|         - | 2177 | `				 * so it is detected here rather than the keyword dispatcher. */` |
|      3929 | 2178 | `				xCons = PH7_CompileEnum;` |
|  14279213 | 2179 | `			}else if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|   8469625 | 2180 | `				sxu32 nKeyword = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|         - | 2181 | `				/* Try to extract a language construct handler */` |
|   8469625 | 2182 | `				xCons = GenStateGetStatementHandler(nKeyword,(&pGen->pIn[1] < pGen->pEnd) ? &pGen->pIn[1] : 0);` |
|   8469625 | 2183 | `				if( xCons == 0 && GenStateisLangConstruct(nKeyword) == FALSE ){` |
...
|         4 | 2194 | `				}` |
|  10042441 | 2195 | `			}else if( (pGen->pIn->nType & PH7_TK_ID) && (&pGen->pIn[1] < pGen->pEnd)` |
|    428859 | 2196 | `				&& (pGen->pIn[1].nType & PH7_TK_COLON /*':'*/) ){` |
|         - | 2197 | `				/* Label found [i.e: Out: ],point to the routine responsible of compiling it */` |
|       117 | 2198 | `				xCons = PH7_CompileLabel;` |
|        56 | 2199 | `			}` |
|  14324039 | 2200 | `			if( xCons == 0 ){` |
|         - | 2201 | `				/* Assume an expression an try to compile it */` |
|   5866317 | 2202 | `				rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   5866317 | 2203 | `				if(  rc != SXERR_EMPTY ){` |
|         - | 2204 | `					/* Pop l-value */` |
|   5866167 | 2205 | `					PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|   2933081 | 2206 | `				}` |
|   2933161 | 2207 | `			}else{` |
|         - | 2208 | `				/* Go compile the sucker */` |
|   8457727 | 2209 | `				rc = xCons(&(*pGen));` |
|         - | 2210 | `			}` |
|  14324039 | 2211 | `			if( rc == SXERR_ABORT ){` |
|         - | 2212 | `				/* Request to abort compilation */` |
|        34 | 2213 | `				break;` |
|         - | 2214 | `			}` |
|         - | 2215 | `		}` |
|         - | 2216 | `		/* Ignore trailing semi-colons ';' */` |
|  24603895 | 2217 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|  10275963 | 2218 | `			pGen->pIn++;` |
|         5 | 2219 | `		}` |
|  14327937 | 2220 | `		if( iFlags & PH7_COMPILE_SINGLE_STMT ){` |
...
|         - | 2236 | ` */` |
|     91630 | 2237 | `static sxi32 PH7_CompilePHP(` |
...
|         - | 2241 | `	)` |
|         5 | 2242 | `{` |
|     91635 | 2243 | `	SyToken *pScript = pGen->pRawIn; /* Script to compile */` |
|         - | 2244 | `	sxi32 rc;` |
|         - | 2245 | `	/* Reset the token set (and its trivia sidecar) */` |
|     91635 | 2246 | `	SySetReset(&(*pTokenSet));` |
|     91635 | 2247 | `	SySetReset(&pGen->aTrivia);` |
|         - | 2248 | `	/* Mark as the default token set */` |
|     91635 | 2249 | `	pGen->pTokenSet = &(*pTokenSet);` |
|         - | 2250 | `	/* Advance the stream cursor */` |
|     91635 | 2251 | `	pGen->pRawIn++;` |
|         - | 2252 | `	/* Tokenize the PHP chunk first */` |
|     91635 | 2253 | `	PH7_TokenizePHP(SyStringData(&pScript->sData),SyStringLength(&pScript->sData),pScript->nLine,&(*pTokenSet),&pGen->aTrivia);` |
|         - | 2254 | `	/* Point to the head and tail of the token stream. */` |
|     91635 | 2255 | `	pGen->pIn  = (SyToken *)SySetBasePtr(pTokenSet);` |
|     91635 | 2256 | `	pGen->pEnd = &pGen->pIn[SySetUsed(pTokenSet)];` |
|     91635 | 2257 | `	if( is_expr ){` |
...
|         - | 2266 | `	}` |
|     91635 | 2267 | `	if( pGen->pIn < pGen->pEnd && ( pGen->pIn->nType & PH7_TK_EQUAL ) ){` |
...
|     91633 | 2292 | `	rc = GenStateCompileChunk(pGen,0);` |
|         - | 2293 | `	/* Fix exceptions jumps */` |
|     91633 | 2294 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|         - | 2295 | `	/* Fix gotos now, the jump destination is resolved */` |
|     91633 | 2296 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),0) ){` |
|         3 | 2297 | `		rc = SXERR_ABORT;` |
|         1 | 2298 | `	}` |
|         - | 2299 | `	/* Reset container */` |
|     91633 | 2300 | `	SySetReset(&pGen->aGoto);` |
|     91633 | 2301 | `	SySetReset(&pGen->aLabel);` |
|     91633 | 2302 | `	SySetReset(&pGen->aNullsafeJmp);` |
|         - | 2303 | `	/* Compilation result */` |
|     91633 | 2304 | `	return rc;` |
|     45820 | 2305 | `}` |
|         - | 2306 | `/*` |
...
|         - | 2310 | ` */` |
|     94780 | 2311 | `PH7_PRIVATE sxi32 PH7_CompileScript(` |
...
|         - | 2326 | `	sxi32 rc;` |
|     94785 | 2327 | `	sxu32 nBaseLine = 1;` |
|     94785 | 2328 | `	if( pScript->nByte < 1 ){` |
...
|     94785 | 2335 | `	if( pScript->nByte >= 2 && pScript->zString[0]=='#' && pScript->zString[1]=='!' ){` |
...
|     94785 | 2349 | `	pCodeGen = &pVm->sCodeGen;` |
...
|     94785 | 2356 | `	pSavedIn = pCodeGen->pIn;` |
|     94785 | 2357 | `	pSavedEnd = pCodeGen->pEnd;` |
|     94785 | 2358 | `	bSavedStrict = pCodeGen->bStrictTypes;` |
|     94785 | 2359 | `	bSavedStrictLocked = pCodeGen->bStrictTypesLocked;` |
|     94785 | 2360 | `	pCodeGen->bStrictTypes = 0;` |
|     94785 | 2361 | `	pCodeGen->bStrictTypesLocked = 0;` |
|         - | 2362 | `	/* Initialize the tokens containers */` |
|     94785 | 2363 | `	SySetInit(&aRawToken,&pVm->sAllocator,sizeof(SyToken));` |
|     94785 | 2364 | `	SySetInit(&aPhpToken,&pVm->sAllocator,sizeof(SyToken));` |
|     94785 | 2365 | `	SySetAlloc(&aPhpToken,0xc0);` |
|     94785 | 2366 | `	is_expr = 0;` |
|     94785 | 2367 | `	if( iFlags & PH7_PHP_ONLY ){` |
|         - | 2368 | `		SyToken sTmp;` |
|         - | 2369 | `		/* PHP only: -*/` |
|     81773 | 2370 | `		sTmp.nLine = 1;` |
|     81773 | 2371 | `		sTmp.nType = PH7_TOKEN_PHP;` |
|     81773 | 2372 | `		sTmp.pUserData = 0;` |
|     81773 | 2373 | `		SyStringDupPtr(&sTmp.sData,pScript);` |
|     81773 | 2374 | `		SySetPut(&aRawToken,(const void *)&sTmp);` |
|     81773 | 2375 | `		if( iFlags & PH7_PHP_EXPR ){` |
|         - | 2376 | `			/* A simple PHP expression */` |
|       ! 0 | 2377 | `			is_expr = 1;` |
|       ! 0 | 2378 | `		}` |
|     40889 | 2379 | `	}else{` |
|         - | 2380 | `		/* Tokenize raw text */` |
|     13017 | 2381 | `		SySetAlloc(&aRawToken,32);` |
|     13017 | 2382 | `		PH7_TokenizeRawText(pScript->zString,pScript->nByte,&aRawToken,nBaseLine);` |
|         - | 2383 | `	}` |
|         - | 2384 | `	/* Process high-level tokens */` |
|     94785 | 2385 | `	pCodeGen->pRawIn = (SyToken *)SySetBasePtr(&aRawToken);` |
|     94785 | 2386 | `	pCodeGen->pRawEnd = &pCodeGen->pRawIn[SySetUsed(&aRawToken)];` |
|     94785 | 2387 | `	rc = PH7_OK;` |
|     94785 | 2388 | `	if( is_expr ){` |
|         - | 2389 | `		/* Compile the expression */` |
|       ! 0 | 2390 | `		rc = PH7_CompilePHP(pCodeGen,&aPhpToken,TRUE);` |
|       ! 0 | 2391 | `		goto cleanup;` |
|         - | 2392 | `	}` |
|     94785 | 2393 | `	nObjIdx = 0;` |
...
|     94785 | 2397 | `	PH7_VmEmitInstr(pVm,PH7_OP_NSSWITCH,0,0,0,0);` |
|         - | 2398 | `	/* Start the compilation process */` |
|     53901 | 2399 | `	for(;;){` |
|    199405 | 2400 | `		if( pCodeGen->pRawIn >= pCodeGen->pRawEnd ){` |
|     94753 | 2401 | `			break; /* No more tokens to process */` |
|         - | 2402 | `		}` |
|    104657 | 2403 | `		if( pCodeGen->pRawIn->nType & PH7_TOKEN_PHP ){` |
|         - | 2404 | `			/* Compile the PHP chunk */` |
|     91635 | 2405 | `			rc = PH7_CompilePHP(pCodeGen,&aPhpToken,FALSE);` |
|     91635 | 2406 | `			if( rc == SXERR_ABORT ){` |
|        36 | 2407 | `				break;` |
|         - | 2408 | `			}` |
|     91603 | 2409 | `			continue;` |
|         - | 2410 | `		}` |
|         - | 2411 | `		/* Raw chunk: [i.e: HTML, XML, etc.] */` |
|     13027 | 2412 | `		nRawObj = 0;` |
|     26049 | 2413 | `		while( (pCodeGen->pRawIn < pCodeGen->pRawEnd) && (pCodeGen->pRawIn->nType != PH7_TOKEN_PHP) ){` |
|         - | 2414 | `			/* Consume the raw chunk without any processing */` |
|     13027 | 2415 | `			pRawObj = PH7_ReserveConstObj(&(*pVm),&nObjIdx);` |
|     13027 | 2416 | `			if( pRawObj == 0 ){` |
|       ! 0 | 2417 | `				rc = SXERR_MEM;` |
|       ! 0 | 2418 | `				break;` |
|         - | 2419 | `			}` |
|         - | 2420 | `			/* Mark as constant and emit the load constant instruction */` |
|     13027 | 2421 | `			PH7_MemObjInitFromString(pVm,pRawObj,&pCodeGen->pRawIn->sData);` |
|     13027 | 2422 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_LOADC,0,nObjIdx,0,0);` |
|     13027 | 2423 | `			++nRawObj;` |
|     13027 | 2424 | `			pCodeGen->pRawIn++; /* Next chunk */` |
|         5 | 2425 | `		}` |
|     13027 | 2426 | `		if( nRawObj > 0 ){` |
|         - | 2427 | `			/* Emit the consume instruction */` |
|     13027 | 2428 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_CONSUME,nRawObj,0,0,0);` |
|      6511 | 2429 | `		}` |
|     47395 | 2430 | `	}` |
|     47390 | 2431 | `cleanup:` |
|         - | 2432 | `	/* Drop the cursor into the token set BEFORE the set is freed (see above). */` |
|     94785 | 2433 | `	pCodeGen->pIn = pSavedIn;` |
|     94785 | 2434 | `	pCodeGen->pEnd = pSavedEnd;` |
|     94785 | 2435 | `	SySetRelease(&aRawToken);` |
|     94785 | 2436 | `	SySetRelease(&aPhpToken);` |
|         - | 2437 | `	/* Restore outer file's strict_types scope */` |
|     94785 | 2438 | `	pCodeGen->bStrictTypes = bSavedStrict;` |
|     94785 | 2439 | `	pCodeGen->bStrictTypesLocked = bSavedStrictLocked;` |
|     94785 | 2440 | `	return rc;` |
|     47395 | 2441 | `}` |
|         - | 2442 | `/*` |
|         - | 2443 | ` * Utility routines.Initialize the code generator.` |
|         - | 2444 | ` */` |
|      3888 | 2445 | `PH7_PRIVATE sxi32 PH7_InitCodeGenerator(` |
|         - | 2446 | `	ph7_vm *pVm,       /* Target VM */` |
|         - | 2447 | `	ProcConsumer xErr, /* Error log consumer callabck  */` |
|         - | 2448 | `	void *pErrData     /* Last argument to xErr() */` |
|         - | 2449 | `	)` |
|         5 | 2450 | `{` |
|      3893 | 2451 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|         - | 2452 | `	/* Zero the structure */` |
|      3893 | 2453 | `	SyZero(pGen,sizeof(ph7_gen_state));` |
|         - | 2454 | `	/* Initial state */` |
|      3893 | 2455 | `	pGen->pVm  = &(*pVm);` |
|      3893 | 2456 | `	pGen->xErr = xErr;` |
|      3893 | 2457 | `	pGen->pErrData = pErrData;` |
|      3893 | 2458 | `	SySetInit(&pGen->aLabel,&pVm->sAllocator,sizeof(Label));` |
|      3893 | 2459 | `	SySetInit(&pGen->aGoto,&pVm->sAllocator,sizeof(JumpFixup));` |
|      3893 | 2460 | `	SySetInit(&pGen->aLoopParent,&pVm->sAllocator,sizeof(sxu32));` |
|      3893 | 2461 | `	pGen->nLoopId = pGen->nCurLoopId = 0;` |
|      3893 | 2462 | `	SySetInit(&pGen->aNullsafeJmp,&pVm->sAllocator,sizeof(sxu32));` |
|      3893 | 2463 | `	SySetInit(&pGen->aTrivia,&pVm->sAllocator,sizeof(ph7_trivia));` |
|      3893 | 2464 | `	SySetInit(&pGen->aPendingAttrs,&pVm->sAllocator,sizeof(ph7_trivia));` |
|      3893 | 2465 | `	SyHashInit(&pGen->hLiteral,&pVm->sAllocator,0,0);` |
|      3893 | 2466 | `	SyHashInit(&pGen->hVar,&pVm->sAllocator,0,0);` |
|         - | 2467 | `	/* Error log buffer */` |
|      3893 | 2468 | `	SyBlobInit(&pGen->sErrBuf,&pVm->sAllocator);` |
|         - | 2469 | `	/* General purpose working buffer */` |
|      3893 | 2470 | `	SyBlobInit(&pGen->sWorker,&pVm->sAllocator);` |
|         - | 2471 | `	/* Namespace state */` |
|      3893 | 2472 | `	SyBlobInit(&pGen->sNamespace,&pVm->sAllocator);` |
|      3893 | 2473 | `	SyHashInit(&pGen->hUseImports,&pVm->sAllocator,0,0);` |
|      3893 | 2474 | `	SyHashInit(&pGen->hUseFuncImports,&pVm->sAllocator,0,0);` |
|      3893 | 2475 | `	SyHashInit(&pGen->hUseConstImports,&pVm->sAllocator,0,0);` |
|         - | 2476 | `	/* Create the global scope */` |
|      3893 | 2477 | `	GenStateInitBlock(pGen,&pGen->sGlobal,GEN_BLOCK_GLOBAL,PH7_VmInstrLength(&(*pVm)),0);` |
|         - | 2478 | `	/* Point to the global scope */` |
|      3893 | 2479 | `	pGen->pCurrent = &pGen->sGlobal;` |
|      3893 | 2480 | `	return SXRET_OK;` |
|         5 | 2481 | `}` |
|         - | 2482 | `/*` |
|         - | 2483 | ` * Utility routines. Reset the code generator to it's initial state.` |
|         - | 2484 | ` */` |
|     98196 | 2485 | `PH7_PRIVATE sxi32 PH7_ResetCodeGenerator(` |
|         - | 2486 | `	ph7_vm *pVm,       /* Target VM */` |
|         - | 2487 | `	ProcConsumer xErr, /* Error log consumer callabck  */` |
|         - | 2488 | `	void *pErrData     /* Last argument to xErr() */` |
|         - | 2489 | `	)` |
|         5 | 2490 | `{` |
|     98201 | 2491 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|         - | 2492 | `	GenBlock *pBlock,*pParent;` |
|         - | 2493 | `	/* Reset state */` |
|     98201 | 2494 | `	SySetReset(&pGen->aLabel);` |
|     98201 | 2495 | `	SySetReset(&pGen->aGoto);` |
|     98201 | 2496 | `	SySetReset(&pGen->aNullsafeJmp);` |
|     98201 | 2497 | `	SySetReset(&pGen->aTrivia);` |
|     98201 | 2498 | `	SySetReset(&pGen->aPendingAttrs);` |
|     98201 | 2499 | `	SyStringInitFromBuf(&pGen->sPendingDoc,0,0);` |
|     98201 | 2500 | `	SyBlobRelease(&pGen->sErrBuf);` |
|     98201 | 2501 | `	SyBlobRelease(&pGen->sWorker);` |
|     98201 | 2502 | `	SyBlobRelease(&pGen->sNamespace);` |
|     98201 | 2503 | `	SyBlobInit(&pGen->sNamespace,&pVm->sAllocator);` |
|     98201 | 2504 | `	SyHashRelease(&pGen->hUseImports);` |
|     98201 | 2505 | `	SyHashInit(&pGen->hUseImports,&pVm->sAllocator,0,0);` |
|     98201 | 2506 | `	SyHashRelease(&pGen->hUseFuncImports);` |
|     98201 | 2507 | `	SyHashInit(&pGen->hUseFuncImports,&pVm->sAllocator,0,0);` |
|     98201 | 2508 | `	SyHashRelease(&pGen->hUseConstImports);` |
|     98201 | 2509 | `	SyHashInit(&pGen->hUseConstImports,&pVm->sAllocator,0,0);` |
...
|     98201 | 2517 | `	pBlock = pGen->pCurrent;` |
|     98201 | 2518 | `	while( pBlock->pParent != 0 ){` |
|       ! 0 | 2519 | `		pParent = pBlock->pParent;` |
|       ! 0 | 2520 | `		GenStateFreeBlock(pBlock);` |
|       ! 0 | 2521 | `		pBlock = pParent;` |
|       ! 0 | 2522 | `	}` |
|     98201 | 2523 | `	pGen->xErr = xErr;` |
|     98201 | 2524 | `	pGen->pErrData = pErrData;` |
|     98201 | 2525 | `	pGen->pCurrent = &pGen->sGlobal;` |
|     98201 | 2526 | `	pGen->pRawIn = pGen->pRawEnd = 0;` |
|     98201 | 2527 | `	pGen->pIn = pGen->pEnd = 0;` |
|     98201 | 2528 | `	pGen->nErr = 0;` |
|     98201 | 2529 | `	return SXRET_OK;` |
|         5 | 2530 | `}` |
|         - | 2531 | `/*` |
