...
Coverage: 5187/6529 lines (79.45%)
...
|       - |   130 | ` */` |
|    3396 |   131 | `static GenBlock * GenStateFetchBlock(GenBlock *pCurrent,sxi32 iBlockType,sxi32 iCount)` |
|       2 |   132 |  |
|    3398 |   133 | `	GenBlock *pBlock = pCurrent;` |
|    9615 |   134 | `	for(;;){` |
|   19232 |   135 | `		if( pBlock->iFlags & iBlockType ){` |
|    3290 |   136 | `			iCount--; /* Decrement nesting level */` |
|    3290 |   137 | `			if( iCount < 1 ){` |
|       - |   138 | `				/* Block meet with the desired criteria */` |
|    3264 |   139 | `				return pBlock;` |
|       - |   140 | `			}` |
|      13 |   141 | `		}` |
|       - |   142 | `		/* Point to the upper block */` |
|   15970 |   143 | `		pBlock = pBlock->pParent;` |
|   15970 |   144 | `		if( pBlock == 0 \|\| (pBlock->iFlags & (GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC)) ){` |
|       - |   145 | `			/* Forbidden */` |
|      69 |   146 | `			break;` |
|       - |   147 | `		}` |
|       2 |   148 | `	}` |
...
|       - |   154 | ` */` |
|  736192 |   155 | `static void GenStateInitBlock(` |
...
|  736194 |   164 | `	pBlock->nFirstInstr = nFirstInstr;` |
|  736194 |   165 | `	pBlock->pUserData   = pUserData;` |
|  736194 |   166 | `	pBlock->pGen        = pGen;` |
|  736194 |   167 | `	pBlock->iFlags      = iType;` |
|  736194 |   168 | `	pBlock->pParent     = 0;` |
|  736194 |   169 | `	SySetInit(&pBlock->aJumpFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  736194 |   170 | `	SySetInit(&pBlock->aPostContFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  736194 |   171 |  |
|       - |   172 | `/*` |
...
|       - |   177 | ` */` |
|  733070 |   178 | `static sxi32 GenStateEnterBlock(` |
...
|  733072 |   188 | `	pBlock = (GenBlock *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(GenBlock));` |
|  733072 |   189 | `	if( pBlock == 0 ){` |
...
|  733072 |   198 | `	SyZero(pBlock,sizeof(GenBlock));` |
|  733072 |   199 | `	GenStateInitBlock(&(*pGen),pBlock,iType,nFirstInstr,pUserData);` |
|       - |   200 | `	/* Link to the parent block */` |
|  733072 |   201 | `	pBlock->pParent = pGen->pCurrent;` |
|       - |   202 | `	/* Mark as the current block */` |
|  733072 |   203 | `	pGen->pCurrent = pBlock;` |
|  733072 |   204 | `	if( ppBlock ){` |
|       - |   205 | `		/* Write a pointer to the new instance */` |
|  356028 |   206 | `		*ppBlock = pBlock;` |
|  178013 |   207 | `	}` |
|  733072 |   208 | `	return SXRET_OK;` |
|  366537 |   209 |  |
|       - |   210 | `/*` |
|       - |   211 | ` * Release block fields without freeing the whole instance.` |
|       - |   212 | ` */` |
|  733062 |   213 | `static void GenStateReleaseBlock(GenBlock *pBlock)` |
|       2 |   214 |  |
|  733064 |   215 | `	SySetRelease(&pBlock->aPostContFix);` |
|  733064 |   216 | `	SySetRelease(&pBlock->aJumpFix);` |
|  733064 |   217 |  |
|       - |   218 | `/*` |
|       - |   219 | ` * Release a block.` |
|       - |   220 | ` */` |
|  733062 |   221 | `static void GenStateFreeBlock(GenBlock *pBlock)` |
|       2 |   222 |  |
|  733064 |   223 | `	ph7_gen_state *pGen = pBlock->pGen;` |
|  733064 |   224 | `	GenStateReleaseBlock(&(*pBlock));` |
|       - |   225 | `	/* Free the instance */` |
|  733064 |   226 | `	SyMemBackendPoolFree(&pGen->pVm->sAllocator,pBlock);` |
|  733064 |   227 |  |
|       - |   228 | `/*` |
|       - |   229 | ` * POP and release a block from the stack of compiled blocks.` |
|       - |   230 | ` */` |
|  733062 |   231 | `static sxi32 GenStateLeaveBlock(ph7_gen_state *pGen,GenBlock **ppBlock)` |
|       2 |   232 |  |
|  733064 |   233 | `	GenBlock *pBlock = pGen->pCurrent;` |
|  733064 |   234 | `	if( pBlock == 0 ){` |
|       - |   235 | `		/* No more block to pop */` |
|     ! 0 |   236 | `		return SXERR_EMPTY;` |
|       - |   237 | `	}` |
|       - |   238 | `	/* Point to the upper block */` |
|  733064 |   239 | `	pGen->pCurrent = pBlock->pParent;` |
|  733064 |   240 | `	if( ppBlock ){` |
|       - |   241 | `		/* Write a pointer to the popped block */` |
|     ! 0 |   242 | `		*ppBlock = pBlock;` |
|     ! 0 |   243 | `	}else{` |
|       - |   244 | `		/* Safely release the block */` |
|  733064 |   245 | `		GenStateFreeBlock(&(*pBlock));` |
|       - |   246 | `	}` |
|  733064 |   247 | `	return SXRET_OK;` |
|  366533 |   248 |  |
|       - |   249 | `/*` |
...
|       - |   258 | ` */` |
|  208188 |   259 | `static sxi32 GenStateNewJumpFixup(GenBlock *pBlock,sxi32 nJumpType,sxu32 nInstrIdx)` |
|       2 |   260 |  |
|       - |   261 | `	JumpFixup sJumpFix;` |
|       - |   262 | `	sxi32 rc;` |
|       - |   263 | `	/* Init the JumpFixup structure */` |
|  208190 |   264 | `	sJumpFix.nJumpType = nJumpType;` |
|  208190 |   265 | `	sJumpFix.nInstrIdx = nInstrIdx;` |
|       - |   266 | `	/* Insert in the jump fixup table */` |
|  208190 |   267 | `	rc = SySetPut(&pBlock->aJumpFix,(const void *)&sJumpFix);` |
|  208190 |   268 | `	return rc;` |
|       2 |   269 |  |
|       - |   270 | `/*` |
...
|       - |   280 | ` */` |
|  512678 |   281 | `static sxu32 GenStateFixJumps(GenBlock *pBlock,sxi32 nJumpType,sxu32 nJumpDest)` |
|       2 |   282 |  |
|       - |   283 | `	JumpFixup *aFix;` |
|       - |   284 | `	VmInstr *pInstr;` |
|       - |   285 | `	sxu32 nFixed;` |
...
|  512680 |   288 | `	aFix = (JumpFixup *)SySetBasePtr(&pBlock->aJumpFix);` |
|       - |   289 | `	/* Fix the desired jumps */` |
|  922980 |   290 | `	for( nFixed = n = 0 ; n < SySetUsed(&pBlock->aJumpFix) ; ++n ){` |
|  410302 |   291 | `		if( aFix[n].nJumpType < 0 ){` |
|       - |   292 | `			/* Already fixed */` |
|  163844 |   293 | `			continue;` |
|       - |   294 | `		}` |
|  246460 |   295 | `		if( nJumpType > 0 && aFix[n].nJumpType != nJumpType ){` |
|       - |   296 | `			/* Not of our interest */` |
|   38274 |   297 | `			continue;` |
|       - |   298 | `		}` |
|       - |   299 | `		/* Point to the instruction to fix */` |
|  208188 |   300 | `		pInstr = PH7_VmGetInstr(pBlock->pGen->pVm,aFix[n].nInstrIdx);` |
|  208188 |   301 | `		if( pInstr ){` |
|  208188 |   302 | `			pInstr->iP2 = nJumpDest;` |
|  208188 |   303 | `			nFixed++;` |
|       - |   304 | `			/* Mark as fixed */` |
|  208188 |   305 | `			aFix[n].nJumpType = -1;` |
|  104093 |   306 | `		}` |
|  104095 |   307 | `	}` |
|       - |   308 | `	/* Total number of fixed jumps */` |
|  512680 |   309 | `	return nFixed;` |
|       2 |   310 |  |
|       - |   311 | `/*` |
...
|       - |   317 | ` */` |
|  208230 |   318 | `static sxi32 GenStateFixGoto(ph7_gen_state *pGen,sxu32 nOfft)` |
|       2 |   319 |  |
...
|  208232 |   326 | `	aJumps = (JumpFixup *)SySetBasePtr(&pGen->aGoto);` |
|       - |   327 | `	/* Fix */` |
|  208378 |   328 | `	for( n = nOfft ; n < SySetUsed(&pGen->aGoto) ; ++n ){` |
...
|      46 |   351 | `		}` |
|      48 |   352 | `	}` |
|  208230 |   353 | `	aLabel = (Label *)SySetBasePtr(&pGen->aLabel);` |
|  208362 |   354 | `	for( n = 0 ; n < SySetUsed(&pGen->aLabel) ; ++n ){` |
...
|      12 |   359 | `		}` |
|      68 |   360 | `	}` |
|  208230 |   361 | `	return SXRET_OK;` |
|  104117 |   362 |  |
|       - |   363 | `/*` |
|       - |   364 | ` * Check if a given token value is installed in the literal table.` |
|       - |   365 | ` */` |
|  658086 |   366 | `static sxi32 GenStateFindLiteral(ph7_gen_state *pGen,const SyString *pValue,sxu32 *pIdx)` |
|       2 |   367 |  |
|       - |   368 | `	SyHashEntry *pEntry;` |
|  658088 |   369 | `	pEntry = SyHashGet(&pGen->hLiteral,(const void *)pValue->zString,pValue->nByte);` |
|  658088 |   370 | `	if( pEntry == 0 ){` |
|  286150 |   371 | `		return SXERR_NOTFOUND;` |
|       - |   372 | `	}` |
|  371940 |   373 | `	*pIdx = (sxu32)SX_PTR_TO_INT(pEntry->pUserData);` |
|  371940 |   374 | `	return SXRET_OK;` |
|  329045 |   375 |  |
|       - |   376 | `/*` |
...
|       - |   385 | ` */` |
|  286148 |   386 | `static sxi32 GenStateInstallLiteral(ph7_gen_state *pGen,ph7_value *pObj,sxu32 nIdx)` |
|       2 |   387 |  |
|  286150 |   388 | `	if( SyBlobLength(&pObj->sBlob) > 0 ){` |
|  286150 |   389 | `		SyHashInsert(&pGen->hLiteral,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob),SX_INT_TO_PTR(nIdx));` |
|  143074 |   390 | `	}` |
|  286150 |   391 | `	return SXRET_OK;` |
|       2 |   392 |  |
|       - |   393 | `/*` |
|       - |   394 | ` * Reserve a room for a numeric constant [i.e: 64-bit integer or real number]` |
|       - |   395 | ` * in the constant table.` |
|       - |   396 | ` */` |
|  109410 |   397 | `static ph7_value * GenStateInstallNumLiteral(ph7_gen_state *pGen,sxu32 *pIdx)` |
|       2 |   398 |  |
|       - |   399 | `	ph7_value *pObj;` |
|  109412 |   400 | `	sxu32 nIdx = 0; /* cc warning */` |
|       - |   401 | `	/* Reserve a new constant */` |
|  109412 |   402 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  109412 |   403 | `	if( pObj == 0 ){` |
|     ! 0 |   404 | `		PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|     ! 0 |   405 | `		return 0;` |
|       - |   406 | `	}` |
|  109412 |   407 | `	*pIdx = nIdx;` |
|       - |   408 | `	/* TODO(chems): Create a numeric table (64bit int keys) same as` |
|       - |   409 | `	 * the constant string iterals table [optimization purposes].` |
|       - |   410 | `	 */` |
|  109412 |   411 | `	return pObj;` |
|   54707 |   412 |  |
|       - |   413 | `/*` |
...
|       - |   426 | ` */` |
|  393442 |   427 | `static void *GenStateAttachStrictFlag(ph7_gen_state *pGen, void *p3)` |
|       2 |   428 |  |
|       - |   429 | `	VmCallArgMap *pMap;` |
|  393444 |   430 | `	if( !pGen->bStrictTypes ) return p3;` |
|      28 |   431 | `	if( p3 == 0 ){` |
|      28 |   432 | `		pMap = (VmCallArgMap *)SyMemBackendAlloc(&pGen->pVm->sAllocator,sizeof(VmCallArgMap));` |
|      28 |   433 | `		if( pMap == 0 ) return 0;` |
|      28 |   434 | `		SyZero(pMap,sizeof(VmCallArgMap));` |
|      28 |   435 | `		p3 = (void *)pMap;` |
|      13 |   436 | `	}` |
|      28 |   437 | `	((VmCallArgMap *)p3)->bStrict = 1;` |
|      28 |   438 | `	return p3;` |
|  196723 |   439 |  |
...
|       - |   497 | ` */` |
|  109960 |   498 | `static int GenStateFindBadNumericSeparator(` |
|       - |   499 | `	const SyString *pRaw, const char **pBadStart, sxu32 *pBadLen)` |
|       2 |   500 |  |
|  109962 |   501 | `	const char *z = pRaw->zString;` |
|  109962 |   502 | `	sxu32 n = pRaw->nByte;` |
|  109962 |   503 | `	int base = 10;` |
|       - |   504 | `	sxu32 i, start;` |
|  109962 |   505 | `	if( n < 2 ) return 0;` |
|    9216 |   506 | `	if( z[0] == '0' && (z[1] == 'x' \|\| z[1] == 'X') ){` |
|      72 |   507 | `		base = 16;` |
|    9181 |   508 | `	}else if( z[0] == '0' && (z[1] == 'b' \|\| z[1] == 'B') ){` |
|     280 |   509 | `		base = 2;` |
|     139 |   510 | `	}` |
|   33698 |   511 | `	for( i = 0; i < n; ++i ){` |
|   24498 |   512 | `		if( z[i] != '_' ) continue;` |
...
|       - |   538 | ` */` |
|  109960 |   539 | `static sxi32 GenStateValidateNumericSeparator(ph7_gen_state *pGen, SyToken *pToken)` |
|       2 |   540 |  |
|  109962 |   541 | `	const char *zBad = 0;` |
|  109962 |   542 | `	sxu32 nBad = 0;` |
|       - |   543 | `	SyString sBad;` |
|       - |   544 | `	sxi32 rc;` |
|  109962 |   545 | `	if( !GenStateFindBadNumericSeparator(&pToken->sData, &zBad, &nBad) ){` |
|  109948 |   546 | `		return SXRET_OK;` |
|       - |   547 | `	}` |
...
|       - |   571 | ` */` |
|  109946 |   572 | `static sxi32 GenStateStripNumericSeparators(` |
...
|       2 |   577 |  |
|       - |   578 | `	sxu32 i, j;` |
|  109948 |   579 | `	int hasUnderscore = 0;` |
|       - |   580 | `	char *zBuf;` |
|  109948 |   581 | `	*pzAlloc = 0;` |
|  233110 |   582 | `	for( i = 0; i < pToken->nByte; ++i ){` |
|  123416 |   583 | `		if( pToken->zString[i] == '_' ){ hasUnderscore = 1; break; }` |
|   61583 |   584 | `	}` |
|  109948 |   585 | `	if( !hasUnderscore ){` |
|  109696 |   586 | `		SyStringDupPtr(pOut, pToken);` |
|  109696 |   587 | `		return SXRET_OK;` |
|       - |   588 | `	}` |
...
|       - |   619 | ` *  documentation.` |
|       - |   620 | ` */` |
|  109932 |   621 | `static sxi32 PH7_CompileNumLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       2 |   622 |  |
|  109934 |   623 | `	SyToken *pToken = pGen->pIn; /* Raw token */` |
|  109934 |   624 | `	sxu32 nIdx = 0;` |
|       - |   625 | `	char zScratch[GEN_NUM_SCRATCH];` |
|  109934 |   626 | `	char *zAlloc = 0;` |
|       - |   627 | `	SyString sNum;` |
|       - |   628 | `	sxi32 rc;` |
|   54966 |   629 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|  109934 |   630 | `	rc = GenStateValidateNumericSeparator(pGen, pToken);` |
|  109934 |   631 | `	if( rc != SXRET_OK ){` |
|      11 |   632 | `		return rc;` |
|       - |   633 | `	}` |
|  164885 |   634 | `	rc = GenStateStripNumericSeparators(&pGen->pVm->sAllocator, &pToken->sData,` |
|   54961 |   635 | `		zScratch, sizeof(zScratch), &sNum, &zAlloc);` |
|  109924 |   636 | `	if( rc != SXRET_OK ){` |
|     ! 0 |   637 | `		return SXERR_ABORT;` |
|       - |   638 | `	}` |
|  109924 |   639 | `	if( pToken->nType & PH7_TK_INTEGER ){` |
|       - |   640 | `		ph7_value *pObj;` |
|       - |   641 | `		sxi64 iValue;` |
|  109412 |   642 | `		iValue = PH7_TokenValueToInt64(&sNum);` |
|  109412 |   643 | `		pObj = GenStateInstallNumLiteral(&(*pGen),&nIdx);` |
|  109412 |   644 | `		if( pObj == 0 ){` |
|     ! 0 |   645 | `			if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|     ! 0 |   646 | `			return SXERR_ABORT;` |
|       - |   647 | `		}` |
|  109412 |   648 | `		PH7_MemObjInitFromInt(pGen->pVm,pObj,iValue);` |
|   54707 |   649 | `	}else{` |
|       - |   650 | `		/* Real number */` |
|       - |   651 | `		ph7_value *pObj;` |
|       - |   652 | `		/* Reserve a new constant */` |
|     514 |   653 | `		pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|     514 |   654 | `		if( pObj == 0 ){` |
...
|       - |   658 | `		}` |
|     514 |   659 | `		PH7_MemObjInitFromString(pGen->pVm,pObj,&sNum);` |
|     514 |   660 | `		PH7_MemObjToReal(pObj);` |
|       - |   661 | `	}` |
|  109924 |   662 | `	if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|       - |   663 | `	/* Emit the load constant instruction */` |
|  109924 |   664 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|       - |   665 | `	/* Node successfully compiled */` |
|  109924 |   666 | `	return SXRET_OK;` |
|   54968 |   667 |  |
|       - |   668 | `/*` |
...
|       - |   677 | ` *` |
|       - |   678 | ` */` |
|   78990 |   679 | `PH7_PRIVATE sxi32 PH7_CompileSimpleString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       2 |   680 |  |
|   78992 |   681 | `	SyString *pStr = &pGen->pIn->sData; /* Constant string literal */` |
|       - |   682 | `	const char *zIn,*zCur,*zEnd;` |
|       - |   683 | `	ph7_value *pObj;` |
|       - |   684 | `	sxu32 nIdx;` |
|   78992 |   685 | `	nIdx = 0; /* Prevent compiler warning */` |
|       - |   686 | `	/* Delimit the string */` |
|   78992 |   687 | `	zIn  = pStr->zString;` |
|   78992 |   688 | `	zEnd = &zIn[pStr->nByte];` |
|   78992 |   689 | `	if( zIn >= zEnd ){` |
|       - |   690 | `		/* Empty string constant: just use the pre‑allocated index from the VM` |
|       - |   691 | `		 * rather than reserving a new object each time. */` |
|    6388 |   692 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,pGen->pVm->nEmptyStringIdx,0,0);` |
|    6388 |   693 | `		return SXRET_OK;` |
|       - |   694 | `	}` |
|   72606 |   695 | `	if( SXRET_OK == GenStateFindLiteral(&(*pGen),pStr,&nIdx) ){` |
|       - |   696 | `		/* Already processed,emit the load constant instruction` |
|       - |   697 | `		 * and return.` |
|       - |   698 | `		 */` |
|   28820 |   699 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   28820 |   700 | `		return SXRET_OK;` |
|       - |   701 | `	}` |
|       - |   702 | `	/* Reserve a new constant */` |
|   43788 |   703 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   43788 |   704 | `	if( pObj == 0 ){` |
...
|       - |   708 | `	}` |
|   43788 |   709 | `	PH7_MemObjInitFromString(pGen->pVm,pObj,0);` |
|       - |   710 | `	/* Compile the node */` |
|   43828 |   711 | `	for(;;){` |
|   87658 |   712 | `		if( zIn >= zEnd ){` |
|       - |   713 | `			/* End of input */` |
|   43788 |   714 | `			break;` |
|       - |   715 | `		}` |
|   43872 |   716 | `		zCur = zIn;` |
|  691282 |   717 | `		while( zIn < zEnd && zIn[0] != '\\' ){` |
|  647412 |   718 | `			zIn++;` |
|       2 |   719 | `		}` |
|   43872 |   720 | `		if( zIn > zCur ){` |
|       - |   721 | `			/* Append raw contents*/` |
|   43852 |   722 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|   21925 |   723 | `		}` |
|   43872 |   724 | `		zIn++;` |
|   43872 |   725 | `		if( zIn < zEnd ){` |
|     105 |   726 | `			if( zIn[0] == '\\' ){` |
|       - |   727 | `				/* A literal backslash */` |
|      23 |   728 | `				PH7_MemObjStringAppend(pObj,"\\",sizeof(char));` |
|      94 |   729 | `			}else if( zIn[0] == '\'' ){` |
|       - |   730 | `				/* A single quote */` |
|      11 |   731 | `				PH7_MemObjStringAppend(pObj,"'",sizeof(char));` |
|       6 |   732 | `			}else{` |
|       - |   733 | `				/* verbatim copy */` |
|      73 |   734 | `				zIn--;` |
|      73 |   735 | `				PH7_MemObjStringAppend(pObj,zIn,sizeof(char)*2);` |
|      73 |   736 | `				zIn++;` |
|       - |   737 | `			}` |
|      52 |   738 | `		}` |
...
|   43788 |   743 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   43788 |   744 | `	if( pStr->nByte < 1024 ){` |
|       - |   745 | `		/* Install in the literal table */` |
|   43788 |   746 | `		GenStateInstallLiteral(pGen,pObj,nIdx);` |
|   21893 |   747 | `	}` |
|       - |   748 | `	/* Node successfully compiled */` |
|   43788 |   749 | `	return SXRET_OK;` |
|   39497 |   750 |  |
|       - |   751 | `/*` |
...
|       - |   768 | ` */` |
|     106 |   769 | `static sxi32 GenStateStripHeredocIndent(ph7_gen_state *pGen, SyString *pOut)` |
|       2 |   770 |  |
|     108 |   771 | `	SyString *pIn = &pGen->pIn->sData;` |
|     108 |   772 | `	sxu32 nIndent = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|       - |   773 | `	const char *zPrefix;` |
|       - |   774 | `	const char *z, *zEnd;` |
|       - |   775 | `	char *zBuf, *zDst;` |
|     108 |   776 | `	if( nIndent == 0 ){` |
|       - |   777 | `		/* Legacy column-0 marker: zero-copy fast path */` |
|      64 |   778 | `		*pOut = *pIn;` |
|      64 |   779 | `		return SXRET_OK;` |
|       - |   780 | `	}` |
...
|       - |   861 | ` */` |
|      42 |   862 | `PH7_PRIVATE sxi32 PH7_CompileNowDoc(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       2 |   863 |  |
...
|       - |   867 | `	sxu32 nIdx;` |
|       - |   868 | `	sxi32 rc;` |
|      44 |   869 | `	rc = GenStateStripHeredocIndent(&(*pGen), &sStripped);` |
|      44 |   870 | `	if( rc != SXRET_OK ){` |
|       5 |   871 | `		return rc;` |
|       - |   872 | `	}` |
|      40 |   873 | `	pStr = &sStripped;` |
|      40 |   874 | `	nIdx = 0; /* Prevent compiler warning */` |
|      40 |   875 | `	if( pStr->nByte <= 0 ){` |
...
|      34 |   881 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|      34 |   882 | `	if( pObj == 0 ){` |
...
|      34 |   888 | `	PH7_MemObjInitFromString(pGen->pVm,pObj,pStr);` |
|       - |   889 | `	/* Emit the load constant instruction */` |
|      34 |   890 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|       - |   891 | `	/* Node successfully compiled */` |
|      34 |   892 | `	return SXRET_OK;` |
|      23 |   893 |  |
|       - |   894 | `/*` |
...
|       - |   915 | ` */` |
|    2036 |   916 | `static sxi32 GenStateProcessStringExpression(` |
...
|    2038 |   927 | `	SySetInit(&sToken,&pGen->pVm->sAllocator,sizeof(SyToken));` |
|       - |   928 | `	/* Preallocate some slots */` |
|    2038 |   929 | `	SySetAlloc(&sToken,0x08);` |
|       - |   930 | `	/* Tokenize the text */` |
|    2038 |   931 | `	PH7_TokenizePHP(zIn,(sxu32)(zEnd-zIn),nLine,&sToken);` |
|       - |   932 | `	/* Swap delimiter */` |
|    2038 |   933 | `	pTmpIn  = pGen->pIn;` |
|    2038 |   934 | `	pTmpEnd = pGen->pEnd;` |
|    2038 |   935 | `	pGen->pIn = (SyToken *)SySetBasePtr(&sToken);` |
|    2038 |   936 | `	pGen->pEnd = &pGen->pIn[SySetUsed(&sToken)];` |
|       - |   937 | `	/* Compile the expression */` |
|    2038 |   938 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|       - |   939 | `	/* Restore token stream */` |
|    2038 |   940 | `	pGen->pIn  = pTmpIn;` |
|    2038 |   941 | `	pGen->pEnd = pTmpEnd;` |
|       - |   942 | `	/* Release the token set */` |
|    2038 |   943 | `	SySetRelease(&sToken);` |
...
|       - |   949 | ` */` |
|   21106 |   950 | `static ph7_value * GenStateNewStrObj(ph7_gen_state *pGen,sxi32 *pCount)` |
|       2 |   951 |  |
|       - |   952 | `	ph7_value *pConstObj;` |
|   21108 |   953 | `	sxu32 nIdx = 0;` |
|       - |   954 | `	/* Reserve a new constant */` |
|   21108 |   955 | `	pConstObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   21108 |   956 | `	if( pConstObj == 0 ){` |
|     ! 0 |   957 | `		PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"PH7 engine is running out of memory");` |
|     ! 0 |   958 | `		return 0;` |
|       - |   959 | `	}` |
|   21108 |   960 | `	(*pCount)++;` |
|   21108 |   961 | `	PH7_MemObjInitFromString(pGen->pVm,pConstObj,0);` |
|       - |   962 | `	/* Emit the load constant instruction */` |
|   21108 |   963 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   21108 |   964 | `	return pConstObj;` |
|   10555 |   965 |  |
|       - |   966 | `/*` |
...
|       - |  1003 | ` */` |
|   19676 |  1004 | `static sxi32 GenStateCompileString(ph7_gen_state *pGen)` |
|       2 |  1005 |  |
|   19678 |  1006 | `	SyString *pStr = &pGen->pIn->sData; /* Raw token value */` |
|       - |  1007 | `	const char *zIn,*zCur,*zEnd;` |
|   19678 |  1008 | `	ph7_value *pObj = 0;` |
|       - |  1009 | `	sxi32 iCons;` |
|       - |  1010 | `	sxi32 rc;` |
|       - |  1011 | `	/* Delimit the string */` |
|   19678 |  1012 | `	zIn  = pStr->zString;` |
|   19678 |  1013 | `	zEnd = &zIn[pStr->nByte];` |
|   19678 |  1014 | `	if( zIn >= zEnd ){` |
...
|       - |  1018 | `		 */` |
|     270 |  1019 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,pGen->pVm->nEmptyStringIdx,0,0);` |
|     270 |  1020 | `		return SXRET_OK;` |
|       - |  1021 | `	}` |
|   19410 |  1022 | `	zCur = 0;` |
...
|   10722 |  1025 | `	for(;;){` |
|   32124 |  1026 | `		zCur = zIn;` |
|  157300 |  1027 | `		while( zIn < zEnd && zIn[0] != '\\'  ){` |
|  127214 |  1028 | `			if( zIn[0] == '{' && &zIn[1] < zEnd && zIn[1] == '$' ){` |
|      64 |  1029 | `				break;` |
|  127092 |  1030 | `			}else if(zIn[0] == '$' && &zIn[1] < zEnd &&` |
|    1916 |  1031 | `				(((unsigned char)zIn[1] >= 0xc0 \|\| SyisAlpha(zIn[1]) \|\| zIn[1] == '{' \|\| zIn[1] == '_')) ){` |
|     958 |  1032 | `					break;` |
|       - |  1033 | `			}` |
|  125178 |  1034 | `			zIn++;` |
|       2 |  1035 | `		}` |
|   32124 |  1036 | `		if( zIn > zCur ){` |
|   14840 |  1037 | `			if( pObj == 0 ){` |
|   14514 |  1038 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|   14514 |  1039 | `				if( pObj == 0 ){` |
|     ! 0 |  1040 | `					return SXERR_ABORT;` |
|       - |  1041 | `				}` |
|    7256 |  1042 | `			}` |
|   14840 |  1043 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|    7419 |  1044 | `		}` |
|   32124 |  1045 | `		if( zIn >= zEnd ){` |
|   19410 |  1046 | `			break;` |
|       - |  1047 | `		}` |
|   12716 |  1048 | `		if( zIn[0] == '\\' ){` |
|   10680 |  1049 | `			const char *zPtr = 0;` |
|       - |  1050 | `			sxu32 n;` |
|   10680 |  1051 | `			zIn++;` |
|   10680 |  1052 | `			if( zIn >= zEnd ){` |
|     ! 0 |  1053 | `				break;` |
|       - |  1054 | `			}` |
|   10680 |  1055 | `			if( pObj == 0 ){` |
|    6596 |  1056 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|    6596 |  1057 | `				if( pObj == 0 ){` |
|     ! 0 |  1058 | `					return SXERR_ABORT;` |
|       - |  1059 | `				}` |
|    3297 |  1060 | `			}` |
|   10680 |  1061 | `			n = sizeof(char); /* size of conversion */` |
|   10680 |  1062 | `			switch( zIn[0] ){` |
|       3 |  1063 | `			case '$':` |
|       - |  1064 | `				/* Dollar sign */` |
...
|      78 |  1069 | `				PH7_MemObjStringAppend(pObj,"\\",sizeof(char));` |
|      78 |  1070 | `				break;` |
|       2 |  1071 | `			case 'a':` |
...
|    9852 |  1085 | `				PH7_MemObjStringAppend(pObj,"\n",sizeof(char));` |
|    9852 |  1086 | `				break;` |
|      19 |  1087 | `			case 'r':` |
...
|      54 |  1103 | `			case '"':` |
|       - |  1104 | `				/* Double quote */` |
|     110 |  1105 | `				PH7_MemObjStringAppend(pObj,"\"",sizeof(char));` |
|     110 |  1106 | `				break;` |
|       6 |  1107 | `			case '0':` |
|       - |  1108 | `				/* NUL byte */` |
...
|      13 |  1110 | `				break;` |
|     232 |  1111 | `			case 'x':` |
|     465 |  1112 | `				if((unsigned char)zIn[1] < 0xc0 && SyisHex(zIn[1]) ){` |
|       - |  1113 | `					int c;` |
|       - |  1114 | `					/* Hex digit */` |
|     451 |  1115 | `					c = SyHexToint(zIn[1]) << 4;` |
|     451 |  1116 | `					if( &zIn[2] < zEnd ){` |
|     451 |  1117 | `						c +=  SyHexToint(zIn[2]);` |
|     225 |  1118 | `					}` |
|       - |  1119 | `					/* Output char */` |
|     451 |  1120 | `					PH7_MemObjStringAppend(pObj,(const char *)&c,sizeof(char));` |
|     451 |  1121 | `					n += sizeof(char) * 2;` |
|     226 |  1122 | `				}else{` |
...
|     126 |  1178 | `			rc = GenStateProcessStringExpression(&(*pGen),pGen->pIn->nLine,zExpr,zIn);` |
|     126 |  1179 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  1180 | `				return SXERR_ABORT;` |
|       - |  1181 | `			}` |
|     126 |  1182 | `			if( rc != SXERR_EMPTY ){` |
|     126 |  1183 | `				++iCons;` |
|      62 |  1184 | `			}` |
|     126 |  1185 | `			if( zIn < zEnd ){` |
|       - |  1186 | `				/* Jump the trailing curly */` |
|     126 |  1187 | `				zIn++;` |
|      62 |  1188 | `			}` |
|      64 |  1189 | `		}else{` |
|       - |  1190 | `			/* Simple syntax */` |
|    1914 |  1191 | `			const char *zExpr = zIn;` |
|       - |  1192 | `			/* Assemble variable name */` |
|     962 |  1193 | `			for(;;){` |
|       - |  1194 | `				/* Jump leading dollars */` |
|    3838 |  1195 | `				while( zIn < zEnd && zIn[0] == '$' ){` |
|    1914 |  1196 | `					zIn++;` |
|       2 |  1197 | `				}` |
|     962 |  1198 | `				for(;;){` |
|   11040 |  1199 | `					while( zIn < zEnd && (unsigned char)zIn[0] < 0xc0 && (SyisAlphaNum(zIn[0]) \|\| zIn[0] == '_' ) ){` |
|    8154 |  1200 | `						zIn++;` |
|       2 |  1201 | `					}` |
|    1926 |  1202 | `					if((unsigned char)zIn[0] >= 0xc0 ){` |
|       - |  1203 | `						/* UTF-8 stream */` |
|     ! 0 |  1204 | `						zIn++;` |
...
|       1 |  1249 | `					}` |
|       6 |  1250 | `					break;` |
|    1792 |  1251 | `				}else if( zIn[0] == '-' && &zIn[1] < zEnd && zIn[1] == '>' ){` |
|       - |  1252 | `					/* Member access operator '->' */` |
|      13 |  1253 | `					zIn += 2;` |
|    1786 |  1254 | `				}else if(zIn[0] == ':' && &zIn[1] < zEnd && zIn[1] == ':'){` |
...
|    1914 |  1262 | `			rc = GenStateProcessStringExpression(&(*pGen),pGen->pIn->nLine,zExpr,zIn);` |
|    1914 |  1263 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  1264 | `				return SXERR_ABORT;` |
|       - |  1265 | `			}` |
|    1914 |  1266 | `			if( rc != SXERR_EMPTY ){` |
|    1912 |  1267 | `				++iCons;` |
|     955 |  1268 | `			}` |
|       - |  1269 | `		}` |
...
|    2038 |  1271 | `		pObj = 0;` |
|       2 |  1272 | `	}/*for(;;)*/` |
|   19410 |  1273 | `	if( iCons > 1 ){` |
|       - |  1274 | `		/* Concatenate all compiled constants */` |
|    1514 |  1275 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_CAT,iCons,0,0,0);` |
|     756 |  1276 | `	}` |
|       - |  1277 | `	/* Node successfully compiled */` |
|   19410 |  1278 | `	return SXRET_OK;` |
|    9840 |  1279 |  |
|       - |  1280 | `/*` |
|       - |  1281 | ` * Compile a double quoted string.` |
|       - |  1282 | ` *  See the block-comment above for more information.` |
|       - |  1283 | ` */` |
|   19616 |  1284 | `PH7_PRIVATE sxi32 PH7_CompileString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       2 |  1285 |  |
|       - |  1286 | `	sxi32 rc;` |
|   19618 |  1287 | `	rc = GenStateCompileString(&(*pGen));` |
|    9808 |  1288 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|       - |  1289 | `	/* Compilation result */` |
|   19618 |  1290 | `	return rc;` |
|       2 |  1291 |  |
|       - |  1292 | `/*` |
...
|       - |  1333 | ` */` |
|   18410 |  1334 | `static sxi32 GenStateCompileArrayEntry(` |
...
|   18412 |  1345 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|       - |  1346 | `	/* Compile the expression*/` |
|   18412 |  1347 | `	rc = PH7_CompileExpr(&(*pGen),iFlags,xValidator);` |
|       - |  1348 | `	/* Restore token stream */` |
|   18412 |  1349 | `	RE_SWAP_DELIMITER(pGen);` |
|   18412 |  1350 | `	return rc;` |
|       2 |  1351 |  |
|       - |  1352 | `/*` |
...
|       - |  1359 | ` */` |
|      30 |  1360 | `static sxi32 GenStateArrayNodeValidator(ph7_gen_state *pGen,ph7_expr_node *pRoot)` |
|       2 |  1361 |  |
|      32 |  1362 | `	sxi32 rc = SXRET_OK;` |
|      32 |  1363 | `	if( pRoot->pOp ){` |
...
|       5 |  1372 | `			}` |
|       7 |  1373 | `		}` |
|      25 |  1374 | `	}else if( pRoot->xCode != PH7_CompileVariable ){` |
...
|       - |  1388 | ` */` |
|   27270 |  1389 | `static sxi32 GenStateCompileArrayBody(ph7_gen_state *pGen)` |
|       2 |  1390 |  |
|       - |  1391 | `	sxi32 (*xValidator)(ph7_gen_state *,ph7_expr_node *); /* Expression tree validator callback */` |
|       - |  1392 | `	SyToken *pKey,*pCur;` |
|   27272 |  1393 | `	sxi32 iEmitRef = 0;` |
|   27272 |  1394 | `	sxi32 iSpread = 0;` |
|   27272 |  1395 | `	sxi32 nPair = 0;` |
|       - |  1396 | `	sxi32 iNest;` |
|       - |  1397 | `	sxi32 rc;` |
|   27272 |  1398 | `	xValidator = 0;` |
|   22107 |  1399 | `	for(;;){` |
|       - |  1400 | `		/* Jump leading commas */` |
|   49902 |  1401 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA) ){` |
|    5688 |  1402 | `			pGen->pIn++;` |
|       2 |  1403 | `		}` |
|   44216 |  1404 | `		pCur = pGen->pIn;` |
|   44216 |  1405 | `		if( SXRET_OK != PH7_GetNextExpr(pGen->pIn,pGen->pEnd,&pGen->pIn) ){` |
|       - |  1406 | `			/* No more entry to process */` |
|   27256 |  1407 | `			break;` |
|       - |  1408 | `		}` |
|   16962 |  1409 | `		if( pCur >= pGen->pIn ){` |
|     ! 0 |  1410 | `			continue;` |
|       - |  1411 | `		}` |
|       - |  1412 | `		/* Compile the key if available */` |
|   16962 |  1413 | `		pKey = pCur;` |
|   16962 |  1414 | `		iNest = 0;` |
|   47500 |  1415 | `		while( pCur < pGen->pIn ){` |
|   31892 |  1416 | `			if( (pCur->nType & PH7_TK_ARRAY_OP) && iNest <= 0 ){` |
|    1350 |  1417 | `				break;` |
|       - |  1418 | `			}` |
...
|       - |  1423 | `			 */` |
|   30544 |  1424 | `			if( iNest == 0 && (pCur->nType & PH7_TK_KEYWORD) ){` |
...
|       - |  1486 | `				}` |
|      38 |  1487 | `			}` |
|   30538 |  1488 | `			if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|     210 |  1489 | `				iNest++;` |
|   30434 |  1490 | `			}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}'*/) ){` |
...
|   30538 |  1496 | `			pCur++;` |
|       2 |  1497 | `		}` |
|   16962 |  1498 | `		rc = SXERR_EMPTY;` |
|   16962 |  1499 | `		if( pCur < pGen->pIn ){` |
|    1350 |  1500 | `			if( &pCur[1] >= pGen->pIn ){` |
|       - |  1501 | `				/* Missing value */` |
...
|    1340 |  1509 | `			rc = GenStateCompileArrayEntry(&(*pGen),pKey,pCur,` |
|       - |  1510 | `				EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,0);` |
|    1340 |  1511 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  1512 | `				return SXERR_ABORT;` |
|       - |  1513 | `			}` |
|    1340 |  1514 | `			pCur++; /* Jump the '=>' operator */` |
|   16283 |  1515 | `		}else if( pKey == pCur ){` |
...
|   15614 |  1521 | `			pCur = pKey;` |
|       - |  1522 | `		}` |
|   16952 |  1523 | `		if( rc == SXERR_EMPTY ){` |
|       - |  1524 | `			/* No available key,load NULL */` |
|   15616 |  1525 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,0 /* nil index */,0,0);` |
|    7807 |  1526 | `		}` |
|   16952 |  1527 | `		if( pCur->nType & PH7_TK_AMPER /*'&'*/){` |
|       - |  1528 | `			/* Insertion by reference, [i.e: $a = array(&$x);] */` |
|      36 |  1529 | `			xValidator = GenStateArrayNodeValidator; /* Only variable are allowed */` |
|      36 |  1530 | `			iEmitRef = 1;` |
|      36 |  1531 | `			pCur++; /* Jump the '&' token */` |
|      36 |  1532 | `			if( pCur >= pGen->pIn ){` |
|       - |  1533 | `				/* Missing value */` |
...
|   16950 |  1546 | `		iSpread = (pCur < pGen->pIn && (pCur->nType & PH7_TK_ELLIPSIS)) ? 1 : 0;` |
|   16950 |  1547 | `		if( iSpread && (rc != SXERR_EMPTY \|\| iEmitRef) ){` |
...
|   16946 |  1560 | `		rc = GenStateCompileArrayEntry(&(*pGen),pCur,pGen->pIn,EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,xValidator);` |
|   16946 |  1561 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  1562 | `			return SXERR_ABORT;` |
|       - |  1563 | `		}` |
|   16946 |  1564 | `		if( iSpread ){` |
|       - |  1565 | `			/* Mark the value on TOS as a spread source; LOAD_MAP merges it. */` |
|      52 |  1566 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_FLAG_SPREAD,0,0,0,0);` |
|   16921 |  1567 | `		}else if( iEmitRef ){` |
|       - |  1568 | `			/* Emit the load reference instruction */` |
|      32 |  1569 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_REF,0,0,0,0);` |
|      15 |  1570 | `		}` |
|   16946 |  1571 | `		xValidator = 0;` |
|   16946 |  1572 | `		iEmitRef = 0;` |
|   16946 |  1573 | `		iSpread = 0;` |
|   16946 |  1574 | `		nPair++;` |
|       2 |  1575 | `	}` |
|       - |  1576 | `	/* Emit the load map instruction */` |
|   27256 |  1577 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_MAP,nPair * 2,0,0,0);` |
|       - |  1578 | `	/* Node successfully compiled */` |
|   27256 |  1579 | `	return SXRET_OK;` |
|   13637 |  1580 |  |
|       - |  1581 | `/*` |
...
|       - |  1589 | ` */` |
|   26774 |  1590 | `PH7_PRIVATE sxi32 PH7_CompileArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       2 |  1591 |  |
|       - |  1592 | `	/* Jump the 'array' keyword and the leading '(', exclude trailing ')'. */` |
|   26776 |  1593 | `	pGen->pIn += 2;` |
|   26776 |  1594 | `	pGen->pEnd--;` |
|   13387 |  1595 | `	SXUNUSED(iCompileFlag);` |
|   26776 |  1596 | `	return GenStateCompileArrayBody(pGen);` |
|       2 |  1597 |  |
|       - |  1598 | `/*` |
...
|       - |  1602 | ` */` |
|     496 |  1603 | `PH7_PRIVATE sxi32 PH7_CompileShortArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       2 |  1604 |  |
|       - |  1605 | `	/* Jump the leading '[', exclude trailing ']'. */` |
|     498 |  1606 | `	pGen->pIn++;` |
|     498 |  1607 | `	pGen->pEnd--;` |
|     248 |  1608 | `	SXUNUSED(iCompileFlag);` |
|     498 |  1609 | `	return GenStateCompileArrayBody(pGen);` |
|       2 |  1610 |  |
|       - |  1611 | `/*` |
...
|       - |  1817 | ` */` |
|     190 |  1818 | `PH7_PRIVATE sxi32 PH7_CompileAnnonFunc(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       2 |  1819 |  |
...
|       - |  1829 | `	sxi32 rc;` |
|       - |  1830 |  |
|     192 |  1831 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|     192 |  1832 | `	if( pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD) ){` |
|     ! 0 |  1833 | `		pGen->pIn++;` |
|     ! 0 |  1834 | `	}` |
|       - |  1835 | `	/* Reserve a constant for the lambda */` |
|     192 |  1836 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|     192 |  1837 | `	if( pObj == 0 ){` |
...
|     192 |  1843 | `	nLen = SyBufferFormat(zName,sizeof(zName),"[lambda_%d]",iCnt++);` |
|       - |  1844 | `	/* Make sure the generated name is unique */` |
|     192 |  1845 | `	while( SyHashGet(&pGen->pVm->hFunction,zName,nLen) != 0 && nLen < sizeof(zName) - 2 ){` |
|     ! 0 |  1846 | `		nLen = SyBufferFormat(zName,sizeof(zName),"[lambda_%d]",iCnt++);` |
|     ! 0 |  1847 | `	}` |
|     192 |  1848 | `	SyStringInitFromBuf(&sName,zName,nLen);` |
|     192 |  1849 | `	PH7_MemObjInitFromString(pGen->pVm,pObj,&sName);` |
|       - |  1850 | `	/* Compile the lambda body */` |
|     192 |  1851 | `	rc = GenStateCompileFunc(&(*pGen),&sName,0,TRUE,&pAnnonFunc);` |
|     192 |  1852 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  1853 | `		return SXERR_ABORT;` |
|       - |  1854 | `	}` |
|     192 |  1855 | `	if( pAnnonFunc->iFlags & VM_FUNC_CLOSURE ){` |
...
|     176 |  1860 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|       - |  1861 | `	}` |
|       - |  1862 | `	/* Node successfully compiled */` |
|     192 |  1863 | `	return SXRET_OK;` |
|      97 |  1864 |  |
|       - |  1865 | `/*` |
...
|       - |  1869 | ` */` |
|     124 |  1870 | `static sxi32 GenStateArrowAddCapture(` |
...
|       - |  1884 | `	}` |
|     124 |  1885 | `	if( nByte == sizeof("this")-1` |
|      68 |  1886 | `		&& SyMemcmp(zName,"this",sizeof("this")-1) == 0 ){` |
|       3 |  1887 | `		return SXRET_OK;` |
|       - |  1888 | `	}` |
|     150 |  1889 | `	for( n = 0 ; n < nShadow ; n++ ){` |
|      96 |  1890 | `		if( SyStringLength(&aShadow[n]) == nByte` |
|      93 |  1891 | `			&& SyMemcmp(SyStringData(&aShadow[n]),zName,nByte) == 0 ){` |
|      72 |  1892 | `			return SXRET_OK;` |
|       - |  1893 | `		}` |
|      14 |  1894 | `	}` |
...
|       - |  1981 | ` */` |
|     106 |  1982 | `static sxi32 GenStateArrowCaptureScan(` |
...
|       - |  1988 | `	sxu32 nShadow)` |
|       2 |  1989 |  |
|     108 |  1990 | `	SyToken *pScan = pStart;` |
|       - |  1991 | `	sxi32 rc;` |
|     398 |  1992 | `	while( pScan < pEnd ){` |
|     292 |  1993 | `		if( pScan->nType & (PH7_TK_DSTR\|PH7_TK_HEREDOC) ){` |
...
|      15 |  2002 | `			continue;` |
|       - |  2003 | `		}` |
|     278 |  2004 | `		if( pScan->nType & PH7_TK_KEYWORD ){` |
...
|       - |  2154 | `			}` |
|       1 |  2155 | `		}` |
|     260 |  2156 | `		if( (pScan->nType & PH7_TK_DOLLAR) == 0 ){` |
|     148 |  2157 | `			pScan++;` |
|     148 |  2158 | `			continue;` |
|       - |  2159 | `		}` |
|       - |  2160 | `		{` |
|       - |  2161 | `			/* Walk past variable-variable chains ($$x) to the base name. */` |
|     114 |  2162 | `			SyToken *pDollar = pScan;` |
|     168 |  2163 | `			while( &pDollar[1] < pEnd` |
|     114 |  2164 | `				&& (pDollar[1].nType & PH7_TK_DOLLAR) ){` |
|     ! 0 |  2165 | `				pDollar++;` |
|     ! 0 |  2166 | `			}` |
|     114 |  2167 | `			if( &pDollar[1] >= pEnd ){` |
|     ! 0 |  2168 | `				break;` |
|       - |  2169 | `			}` |
|     114 |  2170 | `			if( (pDollar[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|     ! 0 |  2171 | `				pScan = pDollar + 1;` |
|     ! 0 |  2172 | `				continue;` |
|       - |  2173 | `			}` |
|     170 |  2174 | `			rc = GenStateArrowAddCapture(pGen,pFunc,` |
|     112 |  2175 | `				pDollar[1].sData.zString,pDollar[1].sData.nByte,` |
|      56 |  2176 | `				aShadow,nShadow);` |
|     114 |  2177 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  2178 | `				return SXERR_ABORT;` |
|       - |  2179 | `			}` |
|     114 |  2180 | `			pScan = pDollar + 2;` |
|       - |  2181 | `		}` |
|       2 |  2182 | `	}` |
|     108 |  2183 | `	return SXRET_OK;` |
|      55 |  2184 |  |
|       - |  2185 | `/*` |
...
|       - |  2191 | ` */` |
|      88 |  2192 | `PH7_PRIVATE sxi32 PH7_CompileArrowFunc(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       2 |  2193 |  |
...
|       - |  2206 | `	sxu32 nLen;` |
|       - |  2207 | `	sxu32 nLine;` |
|      90 |  2208 | `	sxi32 iFlags = 0;` |
|      90 |  2209 | `	int bStatic = 0;` |
|       - |  2210 | `	sxi32 rc;` |
|       - |  2211 | `	sxu32 n;` |
|      44 |  2212 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|       - |  2213 |  |
|      90 |  2214 | `	nLine = pGen->pIn->nLine;` |
|       - |  2215 | `	/* Optional 'static' prefix */` |
|      88 |  2216 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD)` |
|      90 |  2217 | `		&& SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_STATIC ){` |
|       3 |  2218 | `		bStatic = 1;` |
|       3 |  2219 | `		pGen->pIn++;` |
|       1 |  2220 | `	}` |
|       - |  2221 | `	/* 'fn' keyword (guaranteed by ExprExtractNode's dispatch) */` |
|      88 |  2222 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0` |
|      90 |  2223 | `		\|\| SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_FN ){` |
|     ! 0 |  2224 | `		PH7_GenCompileError(&(*pGen),E_ERROR,nLine,` |
|       - |  2225 | `			"Arrow function: expected 'fn' keyword");` |
|     ! 0 |  2226 | `		return SXERR_SYNTAX;` |
|       - |  2227 | `	}` |
|      90 |  2228 | `	pGen->pIn++; /* Jump 'fn' */` |
|       - |  2229 | `	/* Optional '&' — return by reference */` |
|      90 |  2230 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|     ! 0 |  2231 | `		iFlags \|= VM_FUNC_REF_RETURN;` |
|     ! 0 |  2232 | `		pGen->pIn++;` |
|     ! 0 |  2233 | `	}` |
|       - |  2234 | `	/* Expect '(' */` |
|      90 |  2235 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
...
|       - |  2245 | `	}` |
|      88 |  2246 | `	pGen->pIn++; /* Jump '(' */` |
|       - |  2247 | `	/* Delimit the parameter list */` |
|      88 |  2248 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN,PH7_TK_RPAREN,&pSigEnd);` |
|      88 |  2249 | `	if( pSigEnd >= pGen->pEnd ){` |
...
|      86 |  2255 | `	pFunc = (ph7_vm_func *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_vm_func));` |
|      86 |  2256 | `	if( pFunc == 0 ){` |
...
|      86 |  2262 | `	nLen = SyBufferFormat(zName,sizeof(zName),"[lambda_%d]",iCnt++);` |
|     178 |  2263 | `	while( SyHashGet(&pGen->pVm->hFunction,zName,nLen) != 0 && nLen < sizeof(zName) - 2 ){` |
|      94 |  2264 | `		nLen = SyBufferFormat(zName,sizeof(zName),"[lambda_%d]",iCnt++);` |
|       2 |  2265 | `	}` |
|      86 |  2266 | `	zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,zName,nLen);` |
|      86 |  2267 | `	if( zDup == 0 ){` |
|     ! 0 |  2268 | `		PH7_GenCompileError(&(*pGen),E_ERROR,nLine,` |
|       - |  2269 | `			"Fatal, PH7 engine is running out of memory");` |
|     ! 0 |  2270 | `		return SXERR_ABORT;` |
|       - |  2271 | `	}` |
|      86 |  2272 | `	PH7_VmInitFuncState(pGen->pVm,pFunc,zDup,nLen,iFlags,0);` |
|       - |  2273 | `	/* Collect function arguments */` |
|      86 |  2274 | `	if( pGen->pIn < pSigEnd ){` |
|      56 |  2275 | `		rc = GenStateCollectFuncArgs(pFunc,&(*pGen),pSigEnd,0,0);` |
|      56 |  2276 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  2277 | `			return SXERR_ABORT;` |
|       - |  2278 | `		}` |
|      27 |  2279 | `	}` |
|       - |  2280 | `	/* Point past ')' and parse optional return type */` |
|      86 |  2281 | `	pGen->pIn = &pSigEnd[1];` |
|      86 |  2282 | `	rc = GenStateParseReturnType(pGen,pFunc);` |
|      86 |  2283 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  2284 | `		return SXERR_ABORT;` |
|      86 |  2285 | `	}else if( rc == SXERR_SYNTAX ){` |
|     ! 0 |  2286 | `		return SXERR_SYNTAX;` |
|       - |  2287 | `	}` |
|       - |  2288 | `	/* Expect '=>' */` |
|      86 |  2289 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ARRAY_OP) == 0 ){` |
...
|       - |  2299 | `	}` |
|      84 |  2300 | `	pGen->pIn++; /* Jump '=>' */` |
|      84 |  2301 | `	pBodyStart = pGen->pIn;` |
|      84 |  2302 | `	pBodyEnd = pGen->pEnd;` |
...
|      84 |  2307 | `	aArgs = (ph7_vm_func_arg *)SySetBasePtr(&pFunc->aArgs);` |
|       - |  2308 | `	{` |
|      84 |  2309 | `		SyString *aShadow = 0;` |
|      84 |  2310 | `		sxu32 nShadow = SySetUsed(&pFunc->aArgs);` |
|      84 |  2311 | `		if( nShadow > 0 ){` |
|      54 |  2312 | `			aShadow = (SyString *)SyMemBackendPoolAlloc(` |
|      52 |  2313 | `				&pGen->pVm->sAllocator,sizeof(SyString) * nShadow);` |
|      54 |  2314 | `			if( aShadow == 0 ){` |
|     ! 0 |  2315 | `				PH7_GenCompileError(&(*pGen),E_ERROR,nLine,` |
|       - |  2316 | `					"Fatal, PH7 engine is running out of memory");` |
|     ! 0 |  2317 | `				return SXERR_ABORT;` |
|       - |  2318 | `			}` |
|     112 |  2319 | `			for( n = 0 ; n < nShadow ; n++ ){` |
|      60 |  2320 | `				aShadow[n] = aArgs[n].sName;` |
|      31 |  2321 | `			}` |
|      26 |  2322 | `		}` |
|     125 |  2323 | `		rc = GenStateArrowCaptureScan(pGen,pFunc,pBodyStart,pBodyEnd,` |
|      41 |  2324 | `			aShadow,nShadow);` |
|      84 |  2325 | `		if( rc == SXERR_ABORT ){` |
...
|      84 |  2333 | `	if( !bStatic ){` |
|       - |  2334 | `		char *zThisDup;` |
|      82 |  2335 | `		zThisDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,"this",sizeof("this")-1);` |
|      82 |  2336 | `		if( zThisDup == 0 ){` |
|     ! 0 |  2337 | `			PH7_GenCompileError(&(*pGen),E_ERROR,nLine,` |
|       - |  2338 | `				"Fatal, PH7 engine is running out of memory");` |
|     ! 0 |  2339 | `			return SXERR_ABORT;` |
|       - |  2340 | `		}` |
|      82 |  2341 | `		SyZero(&sEnv,sizeof(ph7_vm_func_closure_env));` |
|      82 |  2342 | `		sEnv.iFlags = VM_FUNC_ARG_IGNORE;` |
|      82 |  2343 | `		PH7_MemObjInit(pGen->pVm,&sEnv.sValue);` |
|      82 |  2344 | `		SyStringInitFromBuf(&sEnv.sName,zThisDup,sizeof("this")-1);` |
|      82 |  2345 | `		SySetPut(&pFunc->aClosureEnv,(const void *)&sEnv);` |
|      40 |  2346 | `	}` |
|       - |  2347 | `	/* Arrow functions are always closures */` |
|      84 |  2348 | `	pFunc->iFlags \|= VM_FUNC_CLOSURE;` |
|       - |  2349 | `	/* Compile the body expression as an implicit return */` |
|     125 |  2350 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC,` |
|      41 |  2351 | `		PH7_VmInstrLength(pGen->pVm),pFunc,&pBlock);` |
|      84 |  2352 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  2353 | `		PH7_GenCompileError(&(*pGen),E_ERROR,nLine,` |
|       - |  2354 | `			"PH7 engine is running out-of-memory");` |
|     ! 0 |  2355 | `		return SXERR_ABORT;` |
|       - |  2356 | `	}` |
|      84 |  2357 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|      84 |  2358 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pFunc->aByteCode);` |
|      84 |  2359 | `	pSavedEnd = pGen->pEnd;` |
|      84 |  2360 | `	pGen->pIn = pBodyStart;` |
|      84 |  2361 | `	pGen->pEnd = pBodyEnd;` |
|      84 |  2362 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|      84 |  2363 | `	if( rc == SXERR_ABORT ){` |
...
|      84 |  2370 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,(rc != SXERR_EMPTY ? 1 : 0),0,0,0);` |
|      84 |  2371 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|      84 |  2372 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|      84 |  2373 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|      84 |  2374 | `	GenStateLeaveBlock(&(*pGen),0);` |
|       - |  2375 | `	/* Restore cursors; caller will re-synchronize via the node's pEnd */` |
|      84 |  2376 | `	pGen->pIn = pBodyEnd;` |
|      84 |  2377 | `	pGen->pEnd = pSavedEnd;` |
|       - |  2378 | `	/* Emit the load-closure instruction */` |
|      84 |  2379 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_CLOSURE,0,0,pFunc,0);` |
|      84 |  2380 | `	return SXRET_OK;` |
|      46 |  2381 |  |
|       - |  2382 | `/*` |
...
|       - |  2642 | ` * construct.` |
|       - |  2643 | ` */` |
|      74 |  2644 | `PH7_PRIVATE sxi32 PH7_CompileLangConstruct(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       2 |  2645 |  |
|       - |  2646 | `	SyString *pName;` |
|       - |  2647 | `	sxu32 nKeyID;` |
|       - |  2648 | `	sxi32 rc;` |
|       - |  2649 | `	/* Name of the language construct [i.e: echo,die...]*/` |
|      76 |  2650 | `	pName = &pGen->pIn->sData;` |
|      76 |  2651 | `	nKeyID = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|      76 |  2652 | `	pGen->pIn++; /* Jump the language construct keyword */` |
|      76 |  2653 | `	if( nKeyID == PH7_TKWRD_ECHO ){` |
...
|       5 |  2687 | `	}else{` |
|      68 |  2688 | `		sxi32 nArg = 0;` |
|      68 |  2689 | `		sxu32 nIdx = 0;` |
|      68 |  2690 | `		rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_RDONLY_LOAD,0);` |
|      68 |  2691 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  2692 | `			return SXERR_ABORT;` |
|      68 |  2693 | `		}else if(rc != SXERR_EMPTY ){` |
|      68 |  2694 | `			nArg = 1;` |
|      33 |  2695 | `		}` |
|      68 |  2696 | `		if( SXRET_OK != GenStateFindLiteral(&(*pGen),pName,&nIdx) ){` |
|       - |  2697 | `			ph7_value *pObj;` |
|       - |  2698 | `			/* Emit the call instruction */` |
|      20 |  2699 | `			pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|      20 |  2700 | `			if( pObj == 0 ){` |
...
|       - |  2704 | `			}` |
|      20 |  2705 | `			PH7_MemObjInitFromString(pGen->pVm,pObj,pName);` |
|       - |  2706 | `			/* Install in the literal table */` |
|      20 |  2707 | `			GenStateInstallLiteral(&(*pGen),pObj,nIdx);` |
|       9 |  2708 | `		}` |
|       - |  2709 | `		/* Emit the call instruction */` |
|      68 |  2710 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|      68 |  2711 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_CALL,nArg,0,GenStateAttachStrictFlag(pGen,0),0);` |
|       - |  2712 | `	}` |
|       - |  2713 | `	/* Node successfully compiled */` |
|      76 |  2714 | `	return SXRET_OK;` |
|      39 |  2715 |  |
|       - |  2716 | `/*` |
...
|       - |  2736 | ` */` |
|  977796 |  2737 | `PH7_PRIVATE sxi32 PH7_CompileVariable(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       2 |  2738 |  |
|  977798 |  2739 | `	sxu32 nLineLocal = pGen->pIn->nLine;` |
|       - |  2740 | `	sxi32 iVv;` |
|       - |  2741 | `	sxi32 iP1;` |
|       - |  2742 | `	void *p3;` |
|       - |  2743 | `	sxi32 rc;` |
|  977798 |  2744 | `	iVv = -1; /* Variable variable counter */` |
| 1955606 |  2745 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) ){` |
|  977810 |  2746 | `		pGen->pIn++;` |
|  977810 |  2747 | `		iVv++;` |
|       2 |  2748 | `	}` |
|  977798 |  2749 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_OCB/*'{'*/)) == 0 ){` |
...
|       - |  2757 | `	}` |
|  977798 |  2758 | `	p3  = 0;` |
|  977798 |  2759 | `	if( pGen->pIn->nType & PH7_TK_OCB/*'{'*/ ){` |
...
|       - |  2778 | `		SyString *pName;` |
|  977782 |  2779 | `		char *zName = 0;` |
|       - |  2780 | `		/* Extract variable name */` |
|  977782 |  2781 | `		pName = &pGen->pIn->sData;` |
|       - |  2782 | `		/* Advance the stream cursor */` |
|  977782 |  2783 | `		pGen->pIn++;` |
|  977782 |  2784 | `		pEntry = SyHashGet(&pGen->hVar,(const void *)pName->zString,pName->nByte);` |
|  977782 |  2785 | `		if( pEntry == 0 ){` |
|       - |  2786 | `			/* Duplicate name */` |
|  131228 |  2787 | `			zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|  131228 |  2788 | `			if( zName == 0 ){` |
...
|  131228 |  2793 | `			SyHashInsert(&pGen->hVar,zName,pName->nByte,zName);` |
|   65615 |  2794 | `		}else{` |
|       - |  2795 | `			/* Name already available */` |
|  846556 |  2796 | `			zName = (char *)pEntry->pUserData;` |
|       - |  2797 | `		}` |
|  977782 |  2798 | `		p3 = (void *)zName;` |
|       - |  2799 | `	}` |
|  977794 |  2800 | `	iP1 = 0;` |
|  977794 |  2801 | `	if( iCompileFlag & EXPR_FLAG_RDONLY_LOAD ){` |
|  356286 |  2802 | `		if( (iCompileFlag & EXPR_FLAG_LOAD_IDX_STORE) == 0 ){` |
|       - |  2803 | `			/* Read-only load.In other words do not create the variable if inexistant */` |
|  356282 |  2804 | `			iP1 = 1;` |
|  178140 |  2805 | `		}` |
|  178142 |  2806 | `	}` |
|       - |  2807 | `	/* Emit the load instruction */` |
|  977794 |  2808 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,0,p3,0);` |
|  977806 |  2809 | `	while( iVv > 0 ){` |
|      13 |  2810 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,0,0,0);` |
|      13 |  2811 | `		iVv--;` |
|       1 |  2812 | `	}` |
|       - |  2813 | `	/* Node successfully compiled */` |
|  977794 |  2814 | `	return SXRET_OK;` |
|  488900 |  2815 |  |
|       - |  2816 | `/*` |
|       - |  2817 | ` * Load a literal.` |
|       - |  2818 | ` */` |
|  687216 |  2819 | `static sxi32 GenStateLoadLiteral(ph7_gen_state *pGen)` |
|       2 |  2820 |  |
|  687218 |  2821 | `	SyToken *pToken = pGen->pIn;` |
|       - |  2822 | `	ph7_value *pObj;` |
|       - |  2823 | `	SyString *pStr;` |
|       - |  2824 | `	sxu32 nIdx;` |
|       - |  2825 | `	/* Extract token value */` |
|  687218 |  2826 | `	pStr = &pToken->sData;` |
|       - |  2827 | `	/* Deal with the reserved literals [i.e: null,false,true,...] first */` |
|  687218 |  2828 | `	if( pStr->nByte == sizeof("NULL") - 1 ){` |
|  145780 |  2829 | `		if( SyStrnicmp(pStr->zString,"null",sizeof("NULL")-1) == 0 ){` |
|       - |  2830 | `			/* NULL constant are always indexed at 0 */` |
|   53702 |  2831 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,0,0,0);` |
|   53702 |  2832 | `			return SXRET_OK;` |
|   92080 |  2833 | `		}else if( SyStrnicmp(pStr->zString,"true",sizeof("TRUE")-1) == 0 ){` |
|       - |  2834 | `			/* TRUE constant are always indexed at 1 */` |
|     550 |  2835 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,1,0,0);` |
|     550 |  2836 | `			return SXRET_OK;` |
|       2 |  2837 | `		}` |
|  641707 |  2838 | `	}else if (pStr->nByte == sizeof("FALSE") - 1 &&` |
|  109004 |  2839 | `		SyStrnicmp(pStr->zString,"false",sizeof("FALSE")-1) == 0 ){` |
|       - |  2840 | `			/* FALSE constant are always indexed at 2 */` |
|   41196 |  2841 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,2,0,0);` |
|   41196 |  2842 | `			return SXRET_OK;` |
|  549126 |  2843 | `	}else if(pStr->nByte == sizeof("__LINE__") - 1 &&` |
|   97760 |  2844 | `		SyMemcmp(pStr->zString,"__LINE__",sizeof("__LINE__")-1) == 0 ){` |
|       - |  2845 | `			/* TICKET 1433-004: __LINE__ constant must be resolved at compile time,not run time */` |
|    9370 |  2846 | `			pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|    9370 |  2847 | `			if( pObj == 0 ){` |
|     ! 0 |  2848 | `				PH7_GenCompileError(pGen,E_ERROR,pToken->nLine,"Fatal, PH7 engine is running out of memory");` |
|     ! 0 |  2849 | `				return SXERR_ABORT;` |
|       - |  2850 | `			}` |
|    9370 |  2851 | `			PH7_MemObjInitFromInt(pGen->pVm,pObj,pToken->nLine);` |
|       - |  2852 | `			/* Emit the load constant instruction */` |
|    9370 |  2853 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|    9370 |  2854 | `			return SXRET_OK;` |
|  506662 |  2855 | `	}else if( pStr->nByte == sizeof("__NAMESPACE__") - 1 &&` |
|   31568 |  2856 | `		SyMemcmp(pStr->zString,"__NAMESPACE__",sizeof("__NAMESPACE__")-1) == 0 ){` |
...
|  505764 |  2872 | `	}else if( (pStr->nByte == sizeof("__FUNCTION__") - 1 &&` |
|   13196 |  2873 | `		SyMemcmp(pStr->zString,"__FUNCTION__",sizeof("__FUNCTION__")-1) == 0) \|\|` |
|  499160 |  2874 | `		(pStr->nByte == sizeof("__METHOD__") - 1 &&` |
|   16594 |  2875 | `		SyMemcmp(pStr->zString,"__METHOD__",sizeof("__METHOD__")-1) == 0) ){` |
...
|  582392 |  2905 | `	if( SXRET_OK != GenStateFindLiteral(&(*pGen),&pToken->sData,&nIdx) ){` |
|       - |  2906 | `		ph7_value *pLitObj;` |
|       - |  2907 | `		/* Unknown literal,install it in the literal table */` |
|  241904 |  2908 | `		pLitObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  241904 |  2909 | `		if( pLitObj == 0 ){` |
|     ! 0 |  2910 | `			PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|     ! 0 |  2911 | `			return SXERR_ABORT;` |
|       - |  2912 | `		}` |
|  241904 |  2913 | `		PH7_MemObjInitFromString(pGen->pVm,pLitObj,&pToken->sData);` |
|  241904 |  2914 | `		GenStateInstallLiteral(&(*pGen),pLitObj,nIdx);` |
|  120951 |  2915 | `	}` |
|       - |  2916 | `	/* Emit the load constant instruction */` |
|  582392 |  2917 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,1,nIdx,0,0);` |
|  582392 |  2918 | `	return SXRET_OK;` |
|  343610 |  2919 |  |
|       - |  2920 | `/*` |
...
|       - |  2925 | ` */` |
|  687250 |  2926 | `static sxi32 GenStateResolveNamespaceLiteral(ph7_gen_state *pGen)` |
|       2 |  2927 |  |
|       - |  2928 | `	sxi32 rc;` |
|  687252 |  2929 | `	if( pGen->pIn >= pGen->pEnd ){` |
|     ! 0 |  2930 | `		return SXRET_OK;` |
|       - |  2931 | `	}` |
|       - |  2932 | `	/* Check if this is a multi-token namespace path */` |
|  687252 |  2933 | `	if( pGen->pIn < &pGen->pEnd[-1] ){` |
|       - |  2934 | `		/* Multiple tokens: assemble the full path into sWorker */` |
|      36 |  2935 | `		SyBlob *pWorker = &pGen->sWorker;` |
|      36 |  2936 | `		int isAbsolute = 0;` |
|      36 |  2937 | `		SyBlobReset(pWorker);` |
|       - |  2938 | `		/* Check for leading backslash (absolute path) */` |
|      36 |  2939 | `		if( pGen->pIn->nType & PH7_TK_NSSEP ){` |
|      34 |  2940 | `			isAbsolute = 1;` |
|      34 |  2941 | `			pGen->pIn++; /* Skip leading backslash */` |
|      16 |  2942 | `		}` |
|       - |  2943 | `		/* For relative qualified names in a namespace, prepend the NS */` |
|      36 |  2944 | `		if( !isAbsolute && SyBlobLength(&pGen->sNamespace) > 0 ){` |
...
|     132 |  2949 | `		while( pGen->pIn <= &pGen->pEnd[-1] ){` |
|     132 |  2950 | `			if( pGen->pIn->nType & PH7_TK_NSSEP ){` |
|      50 |  2951 | `				SyBlobAppend(pWorker,"\\",1);` |
|      26 |  2952 | `			}else{` |
|      84 |  2953 | `				SyBlobAppend(pWorker,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|       - |  2954 | `			}` |
|     132 |  2955 | `			if( pGen->pIn == &pGen->pEnd[-1] ){` |
|      36 |  2956 | `				pGen->pIn++;` |
|      36 |  2957 | `				break;` |
|       - |  2958 | `			}` |
|      98 |  2959 | `			pGen->pIn++;` |
|       2 |  2960 | `		}` |
|      36 |  2961 | `		if( SyBlobLength(pWorker) > 0 ){` |
|       - |  2962 | `			ph7_value *pObj;` |
|       - |  2963 | `			SyString sPath;` |
|       - |  2964 | `			sxu32 nIdx;` |
|      36 |  2965 | `			SyStringInitFromBuf(&sPath,(const char *)SyBlobData(pWorker),SyBlobLength(pWorker));` |
|       - |  2966 | `			/* Install in the literal table */` |
|      36 |  2967 | `			if( SXRET_OK != GenStateFindLiteral(&(*pGen),&sPath,&nIdx) ){` |
...
|      53 |  2979 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,` |
|      17 |  2980 | `				isAbsolute ? (PH7_LOADC_EXPAND\|PH7_LOADC_ABSOLUTE) : PH7_LOADC_EXPAND,` |
|      17 |  2981 | `				nIdx,0,0);` |
|      36 |  2982 | `			return SXRET_OK;` |
|       - |  2983 | `		}` |
|     ! 0 |  2984 | `	}` |
|       - |  2985 | `	/* Single-token literal: load directly */` |
|  687218 |  2986 | `	rc = GenStateLoadLiteral(&(*pGen));` |
|  687218 |  2987 | `	return rc;` |
|  343627 |  2988 |  |
|       - |  2989 | `/*` |
|       - |  2990 | ` * Compile a literal which is an identifier(name) for a simple value.` |
|       - |  2991 | ` */` |
|  687250 |  2992 | `PH7_PRIVATE sxi32 PH7_CompileLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       2 |  2993 |  |
|       - |  2994 | `	sxi32 rc;` |
|  687252 |  2995 | `	rc = GenStateResolveNamespaceLiteral(&(*pGen));` |
|  687252 |  2996 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  2997 | `		SXUNUSED(iCompileFlag); /* cc warning */` |
|     ! 0 |  2998 | `		return rc;` |
|       - |  2999 | `	}` |
|       - |  3000 | `	/* Node successfully compiled */` |
|  687252 |  3001 | `	return SXRET_OK;` |
|  343627 |  3002 |  |
|       - |  3003 | `/*` |
...
|       - |  3161 | ` */` |
|    3258 |  3162 | `static void GenStateEmitExceptionPopForBreak(ph7_gen_state *pGen,GenBlock *pTarget)` |
|       2 |  3163 |  |
|    3260 |  3164 | `	GenBlock *pBlock = pGen->pCurrent;` |
|   19078 |  3165 | `	while( pBlock && pBlock != pTarget ){` |
|   15820 |  3166 | `		if( pBlock->iFlags & GEN_BLOCK_EXCEPTION ){` |
...
|       - |  3176 | `			}` |
|       1 |  3177 | `		}` |
|   15820 |  3178 | `		pBlock = pBlock->pParent;` |
|       2 |  3179 | `	}` |
|    3260 |  3180 |  |
|    3166 |  3181 | `static sxi32 PH7_CompileContinue(ph7_gen_state *pGen)` |
|       2 |  3182 |  |
|       - |  3183 | `	GenBlock *pLoop; /* Target loop */` |
|       - |  3184 | `	sxi32 iLevel;    /* How many nesting loop to skip */` |
|       - |  3185 | `	sxu32 nLineLocal;` |
|       - |  3186 | `	sxi32 rc;` |
|    3168 |  3187 | `	nLineLocal = pGen->pIn->nLine;` |
|    3168 |  3188 | `	iLevel = 0;` |
|       - |  3189 | `	/* Jump the 'continue' keyword */` |
|    3168 |  3190 | `	pGen->pIn++;` |
|    3168 |  3191 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NUM) ){` |
...
|    3168 |  3217 | `	pLoop = GenStateFetchBlock(pGen->pCurrent,GEN_BLOCK_LOOP,iLevel);` |
|    3168 |  3218 | `	if( pLoop == 0 ){` |
...
|       - |  3224 | `		}` |
|       6 |  3225 | `	}else{` |
|    3158 |  3226 | `		sxu32 nInstrIdx = 0;` |
|       - |  3227 | `		/* Emit POP_EXCEPTION for any try blocks between here and the loop */` |
|    3158 |  3228 | `		GenStateEmitExceptionPopForBreak(&(*pGen),pLoop);` |
|    3158 |  3229 | `		if( pLoop->iFlags & GEN_BLOCK_SWITCH ){` |
...
|    3154 |  3241 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pLoop->nFirstInstr,0,&nInstrIdx);` |
|    3154 |  3242 | `			if( pLoop->bPostContinue == TRUE ){` |
...
|       - |  3249 | `		}` |
|       - |  3250 | `	}` |
|    3168 |  3251 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
...
|       - |  3532 | ` * message.` |
|       - |  3533 | ` */` |
|  378458 |  3534 | `static sxi32 PH7_CompileBlock(` |
...
|       - |  3539 | `	sxi32 rc;` |
|       - |  3540 | `	sxu32 nLine;` |
|  378460 |  3541 | `	if( pGen->pIn->nType & PH7_TK_OCB /* '{' */ ){` |
|  377046 |  3542 | `		nLine = pGen->pIn->nLine;` |
|  377046 |  3543 | `		rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_STD,PH7_VmInstrLength(pGen->pVm),0,0);` |
|  377046 |  3544 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  3545 | `			return SXERR_ABORT;` |
|       - |  3546 | `		}` |
|  377046 |  3547 | `		pGen->pIn++;` |
|       - |  3548 | `		/* Compile until we hit the closing braces '}' */` |
|  515053 |  3549 | `		for(;;){` |
| 1030108 |  3550 | `			if( pGen->pIn >= pGen->pEnd ){` |
...
|       - |  3559 | `				}` |
|     ! 0 |  3560 | `			}` |
| 1030088 |  3561 | `			if( pGen->pIn->nType & PH7_TK_CCB/*'}'*/ ){` |
|       - |  3562 | `				/* Closing braces found,break immediately*/` |
|  377026 |  3563 | `				pGen->pIn++;` |
|  377026 |  3564 | `				break;` |
|       - |  3565 | `			}` |
|       - |  3566 | `			/* Compile a single statement */` |
|  653064 |  3567 | `			rc = GenStateCompileChunk(&(*pGen),PH7_COMPILE_SINGLE_STMT);` |
|  653064 |  3568 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  3569 | `				return SXERR_ABORT;` |
|       - |  3570 | `			}` |
|       2 |  3571 | `		}` |
|  377046 |  3572 | `		GenStateLeaveBlock(&(*pGen),0);` |
|  189938 |  3573 | `	}else if( (pGen->pIn->nType & PH7_TK_COLON /* ':' */) && nKeywordEnd > 0 ){` |
|     ! 0 |  3574 | `		pGen->pIn++;` |
...
|    1416 |  3617 | `		rc = GenStateCompileChunk(&(*pGen),PH7_COMPILE_SINGLE_STMT);` |
|    1416 |  3618 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  3619 | `			return SXERR_ABORT;` |
|       - |  3620 | `		}` |
|       - |  3621 | `	}` |
|       - |  3622 | `	/* Jump trailing semi-colons ';' */` |
|  378460 |  3623 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|     ! 0 |  3624 | `		pGen->pIn++;` |
|     ! 0 |  3625 | `	}` |
|  378460 |  3626 | `	return SXRET_OK;` |
|  189231 |  3627 |  |
|       - |  3628 | `/*` |
...
|       - |  3645 | ` *   endwhile;` |
|       - |  3646 | ` */` |
|   12590 |  3647 | `static sxi32 PH7_CompileWhile(ph7_gen_state *pGen)` |
|       2 |  3648 |  |
|   12592 |  3649 | `	GenBlock *pWhileBlock = 0;` |
|   12592 |  3650 | `	SyToken *pTmp,*pEnd = 0;` |
|       - |  3651 | `	sxu32 nFalseJump;` |
|       - |  3652 | `	sxu32 nLine;` |
|       - |  3653 | `	sxi32 rc;` |
|   12592 |  3654 | `	nLine = pGen->pIn->nLine;` |
|       - |  3655 | `	/* Jump the 'while' keyword */` |
|   12592 |  3656 | `	pGen->pIn++;` |
|   12592 |  3657 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  3658 | `		/* Syntax error */` |
...
|   12592 |  3669 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pWhileBlock);` |
|   12592 |  3670 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  3671 | `		return SXERR_ABORT;` |
|       - |  3672 | `	}` |
|       - |  3673 | `	/* Delimit the condition */` |
|   12592 |  3674 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   12592 |  3675 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|   12592 |  3684 | `	pTmp = pGen->pEnd;` |
|   12592 |  3685 | `	pGen->pEnd = pEnd;` |
|       - |  3686 | `	/* Compile the expression */` |
|   12592 |  3687 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   12592 |  3688 | `	if( rc == SXERR_ABORT ){` |
|       - |  3689 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  3690 | `		return SXERR_ABORT;` |
|       - |  3691 | `	}` |
|       - |  3692 | `	/* Update token stream */` |
|   12592 |  3693 | `	while(pGen->pIn < pEnd ){` |
...
|   12592 |  3701 | `	pGen->pIn  = &pEnd[1];` |
|   12592 |  3702 | `	pGen->pEnd = pTmp;` |
|       - |  3703 | `	/* Emit the false jump */` |
|   12592 |  3704 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nFalseJump);` |
|       - |  3705 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   12592 |  3706 | `	GenStateNewJumpFixup(pWhileBlock,PH7_OP_JZ,nFalseJump);` |
|       - |  3707 | `	/* Compile the loop body */` |
|   12592 |  3708 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDWHILE);` |
|   12592 |  3709 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  3710 | `		return SXERR_ABORT;` |
|       - |  3711 | `	}` |
|       - |  3712 | `	/* Emit the unconditional jump to the start of the loop */` |
|   12592 |  3713 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pWhileBlock->nFirstInstr,0,0);` |
|       - |  3714 | `	/* Fix all jumps now the destination is resolved */` |
|   12592 |  3715 | `	GenStateFixJumps(pWhileBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - |  3716 | `	/* Release the loop block */` |
|   12592 |  3717 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  3718 | `	/* Statement successfully compiled */` |
|   12592 |  3719 | `	return SXRET_OK;` |
|     ! 0 |  3720 | `Synchronize:` |
...
|       - |  3875 | ` */` |
|   12602 |  3876 | `static sxi32 PH7_CompileFor(ph7_gen_state *pGen)` |
|       2 |  3877 |  |
|   12604 |  3878 | `	SyToken *pTmp,*pPostStart,*pEnd = 0;` |
|   12604 |  3879 | `	GenBlock *pForBlock = 0;` |
|       - |  3880 | `	sxu32 nFalseJump;` |
|       - |  3881 | `	sxu32 nLine;` |
|       - |  3882 | `	sxi32 rc;` |
|   12604 |  3883 | `	nLine = pGen->pIn->nLine;` |
|       - |  3884 | `	/* Jump the 'for' keyword */` |
|   12604 |  3885 | `	pGen->pIn++;` |
|   12604 |  3886 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  3887 | `		/* Syntax error */` |
...
|   12604 |  3898 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   12604 |  3899 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|   12604 |  3914 | `	pTmp = pGen->pEnd;` |
|   12604 |  3915 | `	pGen->pEnd = pEnd;` |
|       - |  3916 | `	/* Compile initialization expressions if available */` |
|   12604 |  3917 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|       - |  3918 | `	/* Pop operand lvalues */` |
|   12604 |  3919 | `	if( rc == SXERR_ABORT ){` |
|       - |  3920 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  3921 | `		return SXERR_ABORT;` |
|   12604 |  3922 | `	}else if( rc != SXERR_EMPTY ){` |
|   12602 |  3923 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|    6300 |  3924 | `	}` |
|   12604 |  3925 | `	if( (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|       - |  3926 | `		/* Syntax error */` |
...
|   12604 |  3938 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pForBlock);` |
|   12604 |  3939 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  3940 | `		return SXERR_ABORT;` |
|       - |  3941 | `	}` |
|       - |  3942 | `	/* Deffer continue jumps */` |
|   12604 |  3943 | `	pForBlock->bPostContinue = TRUE;` |
|       - |  3944 | `	/* Compile the condition */` |
|   12604 |  3945 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   12604 |  3946 | `	if( rc == SXERR_ABORT ){` |
|       - |  3947 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  3948 | `		return SXERR_ABORT;` |
|   12604 |  3949 | `	}else if( rc != SXERR_EMPTY ){` |
|       - |  3950 | `		/* Emit the false jump */` |
|   12602 |  3951 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nFalseJump);` |
|       - |  3952 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   12602 |  3953 | `		GenStateNewJumpFixup(pForBlock,PH7_OP_JZ,nFalseJump);` |
|    6300 |  3954 | `	}` |
|   12604 |  3955 | `	if( (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|       - |  3956 | `		/* Syntax error */` |
...
|   12600 |  3968 | `	pPostStart = pGen->pIn;` |
|       - |  3969 | `	/* Compile the loop body */` |
|   12600 |  3970 | `	pGen->pIn  = &pEnd[1]; /* Jump the trailing parenthesis ')' */` |
|   12600 |  3971 | `	pGen->pEnd = pTmp;` |
|   12600 |  3972 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDFOR);` |
|   12600 |  3973 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  3974 | `		return SXERR_ABORT;` |
|       - |  3975 | `	}` |
|       - |  3976 | `	/* Fix post-continue jumps */` |
|   12600 |  3977 | `	if( SySetUsed(&pForBlock->aPostContFix) > 0 ){` |
...
|   12600 |  3993 | `	while( pPostStart < pEnd && (pPostStart->nType & PH7_TK_SEMI) ){` |
|     ! 0 |  3994 | `		pPostStart++;` |
|     ! 0 |  3995 | `	}` |
|   12600 |  3996 | `	if( pPostStart < pEnd ){` |
|       - |  3997 | `		SyToken *pTmpIn,*pTmpEnd;` |
|   12600 |  3998 | `		SWAP_DELIMITER(pGen,pPostStart,pEnd);` |
|   12600 |  3999 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   12600 |  4000 | `		if( pGen->pIn < pGen->pEnd ){` |
|       - |  4001 | `			/* Syntax error */` |
...
|       - |  4008 | `		}` |
|   12600 |  4009 | `		RE_SWAP_DELIMITER(pGen);` |
|   12600 |  4010 | `		if( rc == SXERR_ABORT ){` |
|       - |  4011 | `			/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4012 | `			return SXERR_ABORT;` |
|   12600 |  4013 | `		}else if( rc != SXERR_EMPTY){` |
|       - |  4014 | `			/* Pop operand lvalue */` |
|   12600 |  4015 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|    6299 |  4016 | `		}` |
|    6299 |  4017 | `	}` |
|       - |  4018 | `	/* Emit the unconditional jump to the start of the loop */` |
|   12600 |  4019 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pForBlock->nFirstInstr,0,0);` |
|       - |  4020 | `	/* Fix all jumps now the destination is resolved */` |
|   12600 |  4021 | `	GenStateFixJumps(pForBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - |  4022 | `	/* Release the loop block */` |
|   12600 |  4023 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  4024 | `	/* Statement successfully compiled */` |
|   12600 |  4025 | `	return SXRET_OK;` |
|    6303 |  4026 |  |
...
|       - |  4029 | ` * are allowed.` |
|       - |  4030 | ` */` |
|    6728 |  4031 | `static sxi32 GenStateForEachNodeValidator(ph7_gen_state *pGen,ph7_expr_node *pRoot)` |
|       2 |  4032 |  |
|    6730 |  4033 | `	sxi32 rc = SXRET_OK; /* Assume a valid expression tree */` |
|    6730 |  4034 | `	if( pRoot->xCode != PH7_CompileVariable ){` |
...
|       - |  4069 | ` */` |
|    3426 |  4070 | `static sxi32 PH7_CompileForeach(ph7_gen_state *pGen)` |
|       2 |  4071 |  |
|    3428 |  4072 | `	SyToken *pCur,*pTmp,*pEnd = 0;` |
|    3428 |  4073 | `	SyToken *pListStart = 0,*pListEnd = 0;` |
|    3428 |  4074 | `	GenBlock *pForeachBlock = 0;` |
|       - |  4075 | `	ph7_foreach_info *pInfo;` |
|       - |  4076 | `	sxu32 nFalseJump;` |
|       - |  4077 | `	VmInstr *pInstr;` |
|       - |  4078 | `	sxu32 nLine;` |
|       - |  4079 | `	sxi32 rc;` |
|    3428 |  4080 | `	nLine = pGen->pIn->nLine;` |
|       - |  4081 | `	/* Jump the 'foreach' keyword */` |
|    3428 |  4082 | `	pGen->pIn++;` |
|    3428 |  4083 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  4084 | `		/* Syntax error */` |
...
|    3428 |  4095 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pForeachBlock);` |
|    3428 |  4096 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  4097 | `		return SXERR_ABORT;` |
|       - |  4098 | `	}` |
|       - |  4099 | `	/* Delimit the expression */` |
|    3428 |  4100 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|    3428 |  4101 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|    3428 |  4116 | `	pCur = pGen->pIn;` |
|   22986 |  4117 | `	while( pCur < pEnd ){` |
|   22986 |  4118 | `		if( pCur->nType & PH7_TK_KEYWORD ){` |
|    3440 |  4119 | `			sxi32 nKeywrd = SX_PTR_TO_INT(pCur->pUserData);` |
|    3440 |  4120 | `			if( nKeywrd == PH7_TKWRD_AS ){` |
...
|    3428 |  4138 | `	pTmp = pGen->pEnd;` |
|    3428 |  4139 | `	pGen->pEnd = pCur;` |
|    3428 |  4140 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|    3428 |  4141 | `	if( rc == SXERR_ABORT ){` |
|       - |  4142 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4143 | `		return SXERR_ABORT;` |
|       - |  4144 | `	}` |
|       - |  4145 | `	/* Update token stream */` |
|    3428 |  4146 | `	while(pGen->pIn < pCur ){` |
...
|     ! 0 |  4152 | `		pGen->pIn++;` |
|     ! 0 |  4153 | `	}` |
|    3428 |  4154 | `	pCur++; /* Jump the 'as' keyword */` |
|    3428 |  4155 | `	pGen->pIn = pCur;` |
|    3428 |  4156 | `	if( pGen->pIn >= pEnd ){` |
...
|    3428 |  4163 | `	pInfo = (ph7_foreach_info *)SyMemBackendAlloc(&pGen->pVm->sAllocator,sizeof(ph7_foreach_info));` |
|    3428 |  4164 | `	if( pInfo == 0 ){` |
...
|    3428 |  4169 | `	SyZero(pInfo,sizeof(ph7_foreach_info));` |
|       - |  4170 | `	/* Initialize structure fields */` |
|    3428 |  4171 | `	SySetInit(&pInfo->aStep,&pGen->pVm->sAllocator,sizeof(ph7_foreach_step *));` |
|       - |  4172 | `	/* Check if we have a key field */` |
|   10330 |  4173 | `	while( pCur < pEnd && (pCur->nType & PH7_TK_ARRAY_OP) == 0 ){` |
|    6904 |  4174 | `		pCur++;` |
|       2 |  4175 | `	}` |
|    3428 |  4176 | `	if( pCur < pEnd ){` |
|       - |  4177 | `		/* Compile the expression holding the key name */` |
|    3314 |  4178 | `		if( pGen->pIn >= pCur ){` |
...
|       - |  4183 | `			}` |
|     ! 0 |  4184 | `		}else{` |
|    3314 |  4185 | `			pGen->pEnd = pCur;` |
|    3314 |  4186 | `			rc = PH7_CompileExpr(&(*pGen),0,GenStateForEachNodeValidator);` |
|    3314 |  4187 | `			if( rc == SXERR_ABORT ){` |
|       - |  4188 | `				/* Don't worry about freeing memory, everything will be released shortly */` |
|     ! 0 |  4189 | `				return SXERR_ABORT;` |
|       - |  4190 | `			}` |
|    3314 |  4191 | `			pInstr = PH7_VmPopInstr(pGen->pVm);` |
|    3314 |  4192 | `			if( pInstr->p3 ){` |
|       - |  4193 | `				/* Record key name */` |
|    3314 |  4194 | `				SyStringInitFromBuf(&pInfo->sKey,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|    1656 |  4195 | `			}` |
|    3314 |  4196 | `			pInfo->iFlags \|= PH7_4EACH_STEP_KEY;` |
|       - |  4197 | `		}` |
|    3314 |  4198 | `		pGen->pIn = &pCur[1]; /* Jump the arrow */` |
|    1656 |  4199 | `	}` |
|    3428 |  4200 | `	pGen->pEnd = pEnd;` |
|    3428 |  4201 | `	if( pGen->pIn >= pEnd ){` |
...
|    3423 |  4256 | `	}else if( pGen->pIn->nType & PH7_TK_OSB ){` |
...
|    3418 |  4289 | `		rc = PH7_CompileExpr(&(*pGen),0,GenStateForEachNodeValidator);` |
|    3418 |  4290 | `		if( rc == SXERR_ABORT ){` |
|       - |  4291 | `			/* Don't worry about freeing memory, everything will be released shortly */` |
|     ! 0 |  4292 | `			return SXERR_ABORT;` |
|       - |  4293 | `		}` |
|    3418 |  4294 | `		pInstr = PH7_VmPopInstr(pGen->pVm);` |
|    3418 |  4295 | `		if( pInstr->p3 ){` |
|       - |  4296 | `			/* Record value name */` |
|    3418 |  4297 | `			SyStringInitFromBuf(&pInfo->sValue,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|    1708 |  4298 | `		}` |
|       - |  4299 | `	}` |
|       - |  4300 | `	/* Emit the 'FOREACH_INIT' instruction */` |
|    3426 |  4301 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_FOREACH_INIT,0,0,pInfo,&nFalseJump);` |
|       - |  4302 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|    3426 |  4303 | `	GenStateNewJumpFixup(pForeachBlock,PH7_OP_FOREACH_INIT,nFalseJump);` |
|       - |  4304 | `	/* Record the first instruction to execute */` |
|    3426 |  4305 | `	pForeachBlock->nFirstInstr = PH7_VmInstrLength(pGen->pVm);` |
|       - |  4306 | `	/* Emit the FOREACH_STEP instruction */` |
|    3426 |  4307 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_FOREACH_STEP,0,0,pInfo,&nFalseJump);` |
|       - |  4308 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|    3426 |  4309 | `	GenStateNewJumpFixup(pForeachBlock,PH7_OP_FOREACH_STEP,nFalseJump);` |
|       - |  4310 | `	/* If list() unpacking, emit bytecode to destructure the temp variable */` |
|    3426 |  4311 | `	if( (pInfo->iFlags & PH7_4EACH_STEP_LIST) && pListStart && pListEnd ){` |
...
|    3426 |  4339 | `	pGen->pIn = &pEnd[1];` |
|    3426 |  4340 | `	pGen->pEnd = pTmp;` |
|    3426 |  4341 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_END4EACH);` |
|    3426 |  4342 | `	if( rc == SXERR_ABORT ){` |
...
|    3426 |  4347 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pForeachBlock->nFirstInstr,0,0);` |
|       - |  4348 | `	/* Fix all jumps now the destination is resolved */` |
|    3426 |  4349 | `	GenStateFixJumps(pForeachBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - |  4350 | `	/* Release the loop block */` |
|    3426 |  4351 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  4352 | `	/* Statement successfully compiled */` |
|    3426 |  4353 | `	return SXRET_OK;` |
|       1 |  4354 | `Synchronize:` |
...
|       - |  4393 | ` *    ?>` |
|       - |  4394 | ` */` |
|  131118 |  4395 | `static sxi32 PH7_CompileIf(ph7_gen_state *pGen)` |
|       2 |  4396 |  |
|  131120 |  4397 | `	SyToken *pToken,*pTmp,*pEnd = 0;` |
|  131120 |  4398 | `	GenBlock *pCondBlock = 0;` |
|       - |  4399 | `	sxu32 nJumpIdx;` |
|       - |  4400 | `	sxu32 nKeyID;` |
|       - |  4401 | `	sxi32 rc;` |
|       - |  4402 | `	/* Jump the 'if' keyword */` |
|  131120 |  4403 | `	pGen->pIn++;` |
|  131120 |  4404 | `	pToken = pGen->pIn;` |
|       - |  4405 | `	/* Create the conditional block */` |
|  131120 |  4406 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_COND,PH7_VmInstrLength(pGen->pVm),0,&pCondBlock);` |
|  131120 |  4407 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  4408 | `		return SXERR_ABORT;` |
|       - |  4409 | `	}` |
|       - |  4410 | `	/* Process as many [if/else if/elseif/else] blocks as we can */` |
|   71816 |  4411 | `	for(;;){` |
|  143634 |  4412 | `		if( pToken >= pGen->pEnd \|\| (pToken->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  4413 | `			/* Syntax error */` |
...
|  143634 |  4427 | `		PH7_DelimitNestedTokens(pToken,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|  143634 |  4428 | `		if( pToken >= pEnd \|\| (pEnd->nType & PH7_TK_RPAREN) == 0 ){` |
|       - |  4429 | `			/* Syntax error */` |
...
|  143634 |  4441 | `		SWAP_TOKEN_STREAM(pGen,pToken,pEnd);` |
|       - |  4442 | `		/* Compile the condition */` |
|  143634 |  4443 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|       - |  4444 | `		/* Update token stream */` |
|  143634 |  4445 | `		while(pGen->pIn < pEnd ){` |
|     ! 0 |  4446 | `			PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Unexpected token '%z'",&pGen->pIn->sData);` |
|     ! 0 |  4447 | `			pGen->pIn++;` |
|     ! 0 |  4448 | `		}` |
|  143634 |  4449 | `		pGen->pIn  = &pEnd[1];` |
|  143634 |  4450 | `		pGen->pEnd = pTmp;` |
|  143634 |  4451 | `		if( rc == SXERR_ABORT ){` |
|       - |  4452 | `			/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4453 | `			return SXERR_ABORT;` |
|       - |  4454 | `		}` |
|       - |  4455 | `		/* Emit the false jump */` |
|  143634 |  4456 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nJumpIdx);` |
|       - |  4457 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|  143634 |  4458 | `		GenStateNewJumpFixup(pCondBlock,PH7_OP_JZ,nJumpIdx);` |
|       - |  4459 | `		/* Compile the body */` |
|  143634 |  4460 | `		rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDIF);` |
|  143634 |  4461 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  4462 | `			return SXERR_ABORT;` |
|       - |  4463 | `		}` |
|  143634 |  4464 | `		if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
|   40067 |  4465 | `			break;` |
|       - |  4466 | `		}` |
|       - |  4467 | `		/* Ensure that the keyword ID is 'else if' or 'else' */` |
|   63504 |  4468 | `		nKeyID = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   63504 |  4469 | `		if( (nKeyID & (PH7_TKWRD_ELSE\|PH7_TKWRD_ELIF)) == 0 ){` |
|   40882 |  4470 | `			break;` |
|       - |  4471 | `		}` |
|       - |  4472 | `		/* Emit the unconditional jump */` |
|   22624 |  4473 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,0,0,&nJumpIdx);` |
|       - |  4474 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   22624 |  4475 | `		GenStateNewJumpFixup(pCondBlock,PH7_OP_JMP,nJumpIdx);` |
|   22624 |  4476 | `		if( nKeyID & PH7_TKWRD_ELSE ){` |
|   16354 |  4477 | `			pToken = &pGen->pIn[1];` |
|   16354 |  4478 | `			if( pToken >= pGen->pEnd \|\| (pToken->nType & PH7_TK_KEYWORD) == 0 \|\|` |
|    6274 |  4479 | `				SX_PTR_TO_INT(pToken->pUserData) != PH7_TKWRD_IF ){` |
|    5056 |  4480 | `					break;` |
|       - |  4481 | `			}` |
|    6246 |  4482 | `			pGen->pIn++; /* Jump the 'else' keyword */` |
|    3122 |  4483 | `		}` |
|   12516 |  4484 | `		pGen->pIn++; /* Jump the 'elseif/if' keyword */` |
|       - |  4485 | `		/* Synchronize cursors */` |
|   12516 |  4486 | `		pToken = pGen->pIn;` |
|       - |  4487 | `		/* Fix the false jump */` |
|   12516 |  4488 | `		GenStateFixJumps(pCondBlock,PH7_OP_JZ,PH7_VmInstrLength(pGen->pVm));` |
|       2 |  4489 | `	} /* For(;;) */` |
|       - |  4490 | `	/* Fix the false jump */` |
|  131120 |  4491 | `	GenStateFixJumps(pCondBlock,PH7_OP_JZ,PH7_VmInstrLength(pGen->pVm));` |
|  131120 |  4492 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|   50988 |  4493 | `		(SX_PTR_TO_INT(pGen->pIn->pUserData) & PH7_TKWRD_ELSE) ){` |
|       - |  4494 | `			/* Compile the else block */` |
|   10110 |  4495 | `			pGen->pIn++;` |
|   10110 |  4496 | `			rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDIF);` |
|   10110 |  4497 | `			if( rc == SXERR_ABORT ){` |
|       - |  4498 |  |
|     ! 0 |  4499 | `				return SXERR_ABORT;` |
|       - |  4500 | `			}` |
|    5054 |  4501 | `	}` |
|  131120 |  4502 | `	nJumpIdx = PH7_VmInstrLength(pGen->pVm);` |
|       - |  4503 | `	/* Fix all unconditional jumps now the destination is resolved */` |
|  131120 |  4504 | `	GenStateFixJumps(pCondBlock,PH7_OP_JMP,nJumpIdx);` |
|       - |  4505 | `	/* Release the conditional block */` |
|  131120 |  4506 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  4507 | `	/* Statement successfully compiled */` |
|  131120 |  4508 | `	return SXRET_OK;` |
|     ! 0 |  4509 | `Synchronize:` |
...
|       - |  4537 | ` */` |
|      32 |  4538 | `static sxi32 PH7_CompileGlobal(ph7_gen_state *pGen)` |
|       2 |  4539 |  |
|      34 |  4540 | `	SyToken *pTmp,*pNext = 0;` |
|       - |  4541 | `	sxi32 nExpr;` |
|       - |  4542 | `	sxi32 rc;` |
|       - |  4543 | `	/* Jump the 'global' keyword */` |
|      34 |  4544 | `	pGen->pIn++;` |
|      34 |  4545 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|       - |  4546 | `		/* Nothing to process */` |
|     ! 0 |  4547 | `		return SXRET_OK;` |
|       - |  4548 | `	}` |
|      34 |  4549 | `	pTmp = pGen->pEnd;` |
|      34 |  4550 | `	nExpr = 0;` |
|      68 |  4551 | `	while( SXRET_OK == PH7_GetNextExpr(pGen->pIn,pTmp,&pNext) ){` |
|      36 |  4552 | `		if( pGen->pIn < pNext ){` |
|      36 |  4553 | `			pGen->pEnd = pNext;` |
|      36 |  4554 | `			if( (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
...
|     ! 0 |  4559 | `			}else{` |
|      36 |  4560 | `				pGen->pIn++;` |
|      36 |  4561 | `				if( pGen->pIn >= pGen->pEnd ){` |
|       - |  4562 | `					/* Emit a warning */` |
|     ! 0 |  4563 | `					PH7_GenCompileError(&(*pGen),E_WARNING,pGen->pIn[-1].nLine,"global: Empty variable name");` |
|     ! 0 |  4564 | `				}else{` |
|      36 |  4565 | `					rc = PH7_CompileExpr(&(*pGen),0,0);` |
|      36 |  4566 | `					if( rc == SXERR_ABORT ){` |
|     ! 0 |  4567 | `						return SXERR_ABORT;` |
|      36 |  4568 | `					}else if(rc != SXERR_EMPTY ){` |
|      36 |  4569 | `						VmInstr *pLast = PH7_VmPeekInstr(pGen->pVm);` |
|      36 |  4570 | `						if( pLast && pLast->iOp == PH7_OP_LOADC ){` |
...
|      36 |  4580 | `		pGen->pIn = pNext;` |
|       - |  4581 | `		/* Jump trailing commas */` |
|      38 |  4582 | `		while( pGen->pIn < pTmp && (pGen->pIn->nType & PH7_TK_COMMA) ){` |
|       3 |  4583 | `			pGen->pIn++;` |
|       1 |  4584 | `		}` |
|       2 |  4585 | `	}` |
|       - |  4586 | `	/* Restore token stream */` |
|      34 |  4587 | `	pGen->pEnd = pTmp;` |
|      34 |  4588 | `	if( nExpr > 0 ){` |
|       - |  4589 | `		/* Emit the uplink instruction */` |
|      34 |  4590 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_UPLINK,nExpr,0,0,0);` |
|      16 |  4591 | `	}` |
|      34 |  4592 | `	return SXRET_OK;` |
|      18 |  4593 |  |
|       - |  4594 | `/*` |
...
|       - |  4609 | ` */` |
|  207006 |  4610 | `static sxi32 PH7_CompileReturn(ph7_gen_state *pGen)` |
|       2 |  4611 |  |
|  207008 |  4612 | `	sxi32 nRet = 0; /* TRUE if there is a return value */` |
|       - |  4613 | `	sxi32 rc;` |
|       - |  4614 | `	/* Jump the 'return' keyword */` |
|  207008 |  4615 | `	pGen->pIn++;` |
|  207008 |  4616 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|       - |  4617 | `		/* Compile the expression */` |
|  206984 |  4618 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|  206984 |  4619 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  4620 | `			return SXERR_ABORT;` |
|  206984 |  4621 | `		}else if(rc != SXERR_EMPTY ){` |
|  206984 |  4622 | `			nRet = 1;` |
|  103491 |  4623 | `		}` |
|  103491 |  4624 | `	}` |
|       - |  4625 | `	/* Emit the done instruction */` |
|  207008 |  4626 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,nRet,0,0,0);` |
|  207008 |  4627 | `	return SXRET_OK;` |
|  103505 |  4628 |  |
|       - |  4629 | `/*` |
...
|       - |  4696 | ` */` |
|      88 |  4697 | `static sxi32 PH7_CompileHalt(ph7_gen_state *pGen)` |
|       2 |  4698 |  |
|      90 |  4699 | `	sxi32 nExpr = 0;` |
|       - |  4700 | `	sxi32 rc;` |
|       - |  4701 | `	/* Jump the die/exit keyword */` |
|      90 |  4702 | `	pGen->pIn++;` |
|      90 |  4703 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|       - |  4704 | `		/* Compile the expression */` |
|      90 |  4705 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|      90 |  4706 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  4707 | `			return SXERR_ABORT;` |
|      90 |  4708 | `		}else if(rc != SXERR_EMPTY ){` |
|      90 |  4709 | `			nExpr = 1;` |
|      44 |  4710 | `		}` |
|      44 |  4711 | `	}` |
|       - |  4712 | `	/* Emit the HALT instruction */` |
|      90 |  4713 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_HALT,nExpr,0,0,0);` |
|      90 |  4714 | `	return SXRET_OK;` |
|      46 |  4715 |  |
|       - |  4716 | `/*` |
|       - |  4717 | ` * Compile the 'echo' language construct.` |
|       - |  4718 | ` */` |
|   12748 |  4719 | `static sxi32 PH7_CompileEcho(ph7_gen_state *pGen)` |
|       2 |  4720 |  |
|   12750 |  4721 | `	SyToken *pTmp,*pNext = 0;` |
|       - |  4722 | `	sxi32 rc;` |
|       - |  4723 | `	/* Jump the 'echo' keyword */` |
|   12750 |  4724 | `	pGen->pIn++;` |
|       - |  4725 | `	/* Compile arguments one after one */` |
|   12750 |  4726 | `	pTmp = pGen->pEnd;` |
|   27242 |  4727 | `	while( SXRET_OK == PH7_GetNextExpr(pGen->pIn,pTmp,&pNext) ){` |
|   14494 |  4728 | `		if( pGen->pIn < pNext ){` |
|   14494 |  4729 | `			pGen->pEnd = pNext;` |
|   14494 |  4730 | `			rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_RDONLY_LOAD/* Do not create variable if inexistant */,0);` |
|   14494 |  4731 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  4732 | `				return SXERR_ABORT;` |
|   14494 |  4733 | `			}else if( rc != SXERR_EMPTY ){` |
|       - |  4734 | `				/* Emit the consume instruction */` |
|   14470 |  4735 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_CONSUME,1,0,0,0);` |
|    7234 |  4736 | `			}` |
|    7246 |  4737 | `		}` |
|       - |  4738 | `		/* Jump trailing commas */` |
|   16238 |  4739 | `		while( pNext < pTmp && (pNext->nType & PH7_TK_COMMA) ){` |
|    1746 |  4740 | `			pNext++;` |
|       2 |  4741 | `		}` |
|   14494 |  4742 | `		pGen->pIn = pNext;` |
|       2 |  4743 | `	}` |
|       - |  4744 | `	/* Restore token stream */` |
|   12750 |  4745 | `	pGen->pEnd = pTmp;` |
|   12750 |  4746 | `	return SXRET_OK;` |
|    6376 |  4747 |  |
|       - |  4748 | `/*` |
...
|       - |  4761 | ` */` |
|       2 |  4762 | `static sxi32 PH7_CompileStatic(ph7_gen_state *pGen)` |
|       1 |  4763 |  |
...
|       3 |  4772 | `	nLine = pGen->pIn->nLine;` |
|       3 |  4773 | `	pGen->pIn++;` |
|       - |  4774 | `	/* Extract the enclosing function if any */` |
|       3 |  4775 | `	pBlock = pGen->pCurrent;` |
|       5 |  4776 | `	while( pBlock ){` |
|       5 |  4777 | `		if( pBlock->iFlags & GEN_BLOCK_FUNC){` |
|       3 |  4778 | `			break;` |
|       - |  4779 | `		}` |
|       - |  4780 | `		/* Point to the upper block */` |
|       3 |  4781 | `		pBlock = pBlock->pParent;` |
|       1 |  4782 | `	}` |
|       3 |  4783 | `	if( pBlock == 0 ){` |
...
|       - |  4801 | `	}` |
|       3 |  4802 | `	pFunc = (ph7_vm_func *)pBlock->pUserData;` |
|       - |  4803 | `	/* Make sure we are dealing with a valid statement */` |
|       3 |  4804 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 \|\| &pGen->pIn[1] >= pGen->pEnd \|\|` |
|     ! 0 |  4805 | `		(pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|     ! 0 |  4814 | `	pName = &pGen->pIn->sData;` |
|     ! 0 |  4815 | `	pGen->pIn++; /* Jump the var name */` |
|     ! 0 |  4816 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & (PH7_TK_SEMI/*';'*/\|PH7_TK_EQUAL/*'='*/)) == 0 ){` |
...
|     ! 0 |  4821 | `	SySetInit(&sStatic.aByteCode,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|     ! 0 |  4822 | `	sStatic.nIdx = SXU32_HIGH; /* Not yet created */` |
|       - |  4823 | `	/* Duplicate variable name */` |
|     ! 0 |  4824 | `	zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|     ! 0 |  4825 | `	if( zDup == 0 ){` |
|     ! 0 |  4826 | `		PH7_GenCompileError(&(*pGen),E_ERROR,nLine,"Fatal, PH7 engine is running out of memory");` |
|     ! 0 |  4827 | `		return SXERR_ABORT;` |
|       - |  4828 | `	}` |
|     ! 0 |  4829 | `	SyStringInitFromBuf(&sStatic.sName,zDup,pName->nByte);` |
|       - |  4830 | `	/* Check if we have an expression to compile */` |
|     ! 0 |  4831 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_EQUAL) ){` |
...
|       - |  4838 | `		 */` |
|     ! 0 |  4839 | `		pGen->pIn++; /* Jump the equal '=' sign */` |
|       - |  4840 | `		/* Swap bytecode container */` |
|     ! 0 |  4841 | `		pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|     ! 0 |  4842 | `		PH7_VmSetByteCodeContainer(pGen->pVm,&sStatic.aByteCode);` |
|       - |  4843 | `		/* Compile the expression */` |
|     ! 0 |  4844 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|       - |  4845 | `		/* Emit the done instruction */` |
|     ! 0 |  4846 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,(rc != SXERR_EMPTY ? 1 : 0),0,0,0);` |
|       - |  4847 | `		/* Restore default bytecode container */` |
|     ! 0 |  4848 | `		PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|     ! 0 |  4849 | `	}` |
|       - |  4850 | `	/* Finally save the compiled static variable in the appropriate container */` |
|     ! 0 |  4851 | `	SySetPut(&pFunc->aStatic,(const void *)&sStatic);` |
|     ! 0 |  4852 | `	return SXRET_OK;` |
|       1 |  4853 | `Synchronize:` |
...
|       - |  4913 | ` */` |
|  385968 |  4914 | `static sxu32 GenStateNsQualifyName(ph7_gen_state *pGen,sxu32 nOrigIdx,SyHash *pImports,int *pFromImport)` |
|       2 |  4915 |  |
|       - |  4916 | `	ph7_value *pLit;` |
...
|       - |  4924 | `	ph7_value *pNew;` |
|  385970 |  4925 | `	if( pFromImport ){` |
|  369170 |  4926 | `		*pFromImport = 0;` |
|  184584 |  4927 | `	}` |
|  385970 |  4928 | `	pLit = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,nOrigIdx);` |
|  385970 |  4929 | `	if( !pLit \|\| !(pLit->iFlags & MEMOBJ_STRING) \|\| SyBlobLength(&pLit->sBlob) == 0 ){` |
|     ! 0 |  4930 | `		return nOrigIdx;` |
|       - |  4931 | `	}` |
|  385970 |  4932 | `	zLit = (const char *)SyBlobData(&pLit->sBlob);` |
|  385970 |  4933 | `	nLit = (sxu32)SyBlobLength(&pLit->sBlob);` |
|       - |  4934 | `	/* Skip if already qualified (contains backslash) */` |
|  385970 |  4935 | `	hasNsSep = 0;` |
| 4175228 |  4936 | `	for( k = 0; k < nLit; k++ ){` |
| 3789268 |  4937 | `		if( zLit[k] == '\\' ){ hasNsSep = 1; break; }` |
| 1894631 |  4938 | `	}` |
|  385970 |  4939 | `	if( hasNsSep ){` |
|       9 |  4940 | `		return nOrigIdx;` |
|       - |  4941 | `	}` |
|       - |  4942 | `	/* Check use imports first (works even outside namespaces) */` |
|  385962 |  4943 | `	SyBlobReset(&pGen->sWorker);` |
|  385962 |  4944 | `	pImport = SyHashGet(pImports,(const void *)zLit,nLit);` |
|  385962 |  4945 | `	if( pImport ){` |
...
|       8 |  4950 | `		}` |
|      20 |  4951 | `	}else{` |
|  385926 |  4952 | `		if( SyBlobLength(&pGen->sNamespace) == 0 ){` |
|  385836 |  4953 | `			return nOrigIdx; /* Not in a namespace and no import match */` |
|       - |  4954 | `		}` |
...
|       - |  4976 | ` */` |
|   44312 |  4977 | `static void GenStateResolveName(ph7_gen_state *pGen,const SyString *pName,SyBlob *pOut)` |
|       2 |  4978 |  |
|       - |  4979 | `	SyHashEntry *pImport;` |
|       - |  4980 | `	/* Check use imports first */` |
|   44314 |  4981 | `	pImport = SyHashGet(&pGen->hUseImports,(const void *)pName->zString,pName->nByte);` |
|   44314 |  4982 | `	if( pImport ){` |
...
|       - |  4998 | ` */` |
|   75940 |  4999 | `static void GenStateBuildFQN(ph7_gen_state *pGen,const SyString *pName,SyBlob *pOut)` |
|       2 |  5000 |  |
|   75942 |  5001 | `	if( SyBlobLength(&pGen->sNamespace) > 0 ){` |
|      60 |  5002 | `		SyBlobAppend(pOut,SyBlobData(&pGen->sNamespace),SyBlobLength(&pGen->sNamespace));` |
|      60 |  5003 | `		SyBlobAppend(pOut,"\\",1);` |
|      29 |  5004 | `	}` |
|   75942 |  5005 | `	SyBlobAppend(pOut,pName->zString,pName->nByte);` |
|   75942 |  5006 |  |
|       - |  5007 | `/*` |
...
|       3 |  5051 | `	return "token";` |
|       8 |  5052 |  |
|     104 |  5053 | `static sxi32 PH7_CompileNamespace(ph7_gen_state *pGen)` |
|       2 |  5054 |  |
|       - |  5055 | `	sxu32 nLine;` |
|       - |  5056 | `	sxi32 rc;` |
|     106 |  5057 | `	nLine = pGen->pIn->nLine;` |
|     106 |  5058 | `	pGen->pIn++; /* Jump the 'namespace' keyword */` |
|       - |  5059 | `	/* Reset namespace and clear previous use imports */` |
|     106 |  5060 | `	SyBlobReset(&pGen->sNamespace);` |
|     106 |  5061 | `	SyHashRelease(&pGen->hUseImports);` |
|     106 |  5062 | `	SyHashInit(&pGen->hUseImports,&pGen->pVm->sAllocator,0,0);` |
|     106 |  5063 | `	SyHashRelease(&pGen->hUseFuncImports);` |
|     106 |  5064 | `	SyHashInit(&pGen->hUseFuncImports,&pGen->pVm->sAllocator,0,0);` |
|     106 |  5065 | `	SyHashRelease(&pGen->hUseConstImports);` |
|     106 |  5066 | `	SyHashInit(&pGen->hUseConstImports,&pGen->pVm->sAllocator,0,0);` |
|     106 |  5067 | `	if( pGen->pIn >= pGen->pEnd ){` |
|       - |  5068 | `		/* Global namespace (bare "namespace;") */` |
|     ! 0 |  5069 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_NSSWITCH,0,0,0,0);` |
|     ! 0 |  5070 | `		return SXRET_OK;` |
|       - |  5071 | `	}` |
|     106 |  5072 | `	if( pGen->pIn->nType & PH7_TK_SEMI ){` |
|       - |  5073 | `		/* namespace; — switch to global namespace */` |
|     ! 0 |  5074 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_NSSWITCH,0,0,0,0);` |
|     ! 0 |  5075 | `		return SXRET_OK;` |
|       - |  5076 | `	}` |
|     106 |  5077 | `	if( pGen->pIn->nType & PH7_TK_OCB ){` |
...
|     252 |  5083 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & (PH7_TK_NSSEP\|PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|     148 |  5084 | `		if( pGen->pIn->nType & PH7_TK_NSSEP ){` |
...
|     126 |  5091 | `			SyBlobAppend(&pGen->sNamespace,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|       - |  5092 | `		}` |
|     148 |  5093 | `		pGen->pIn++;` |
|       2 |  5094 | `	}` |
...
|       - |  5097 | `	{` |
|     106 |  5098 | `		char *zNsDup = 0;` |
|     106 |  5099 | `		if( SyBlobLength(&pGen->sNamespace) > 0 ){` |
|     155 |  5100 | `			zNsDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|     102 |  5101 | `				(const char *)SyBlobData(&pGen->sNamespace),SyBlobLength(&pGen->sNamespace));` |
|      51 |  5102 | `		}` |
|     106 |  5103 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_NSSWITCH,0,0,zNsDup,0);` |
|       - |  5104 | `	}` |
|     106 |  5105 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & (PH7_TK_SEMI\|PH7_TK_OCB)) == 0 ){` |
...
|       - |  5292 | ` */` |
|      64 |  5293 | `static int DeclareNameIs(SyString *pName, const char *zWant, sxu32 nWant)` |
|       2 |  5294 |  |
|      94 |  5295 | `	return SyStringLength(pName) == nWant` |
|      64 |  5296 | `	    && SyStrnicmp(SyStringData(pName), zWant, nWant) == 0;` |
|       2 |  5297 |  |
|       - |  5298 |  |
|      38 |  5299 | `static sxi32 PH7_CompileDeclare(ph7_gen_state *pGen)` |
|       2 |  5300 |  |
|      40 |  5301 | `	sxu32 nLine = pGen->pIn->nLine;` |
|      40 |  5302 | `	SyToken *pBodyEnd = 0;` |
...
|       - |  5308 | `	sxi32 rc;` |
|      40 |  5309 | `	pGen->pIn++; /* Jump the 'declare' keyword */` |
|      40 |  5310 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 /*'('*/ ){` |
...
|       5 |  5315 | `		goto Synchro;` |
|       - |  5316 | `	}` |
|      36 |  5317 | `	pGen->pIn++; /* Jump the left parenthesis */` |
|      36 |  5318 | `	pBodyStart = pGen->pIn;` |
|       - |  5319 | `	/* Delimit the directive body (between the outer '(' and its matching ')'). */` |
|      36 |  5320 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN/*'('*/,PH7_TK_RPAREN/*')'*/,&pBodyEnd);` |
|      36 |  5321 | `	if( pBodyEnd >= pGen->pEnd ){` |
...
|      36 |  5330 | `	pGen->pIn = &pBodyEnd[1];` |
|      36 |  5331 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_SEMI/*';'*/\|PH7_TK_OCB/*'{'*/)) == 0 ){` |
...
|       - |  5335 | `		}` |
|     ! 0 |  5336 | `	}` |
|      36 |  5337 | `	bBlockForm = ( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OCB) ) ? 1 : 0;` |
|      36 |  5338 | `	bPlacementOk = ( pGen->pCurrent == &pGen->sGlobal && !pGen->bStrictTypesLocked );` |
|      36 |  5339 | `	bHasStrictTypes = 0;` |
...
|      36 |  5343 | `	pCursor = pBodyStart;` |
|      48 |  5344 | `	while( pCursor < pBodyEnd ){` |
|      44 |  5345 | `		if( (pCursor->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) != 0 ){` |
|      36 |  5346 | `			if( DeclareNameIs(&pCursor->sData, "strict_types", sizeof("strict_types")-1) ){` |
|      32 |  5347 | `				bHasStrictTypes = 1;` |
|      32 |  5348 | `				break;` |
|       - |  5349 | `			}` |
|       2 |  5350 | `		}` |
|      13 |  5351 | `		pCursor++;` |
|       1 |  5352 | `	}` |
|      36 |  5353 | `	if( bHasStrictTypes && bBlockForm ){` |
...
|       - |  5358 | `	}` |
|      34 |  5359 | `	if( bHasStrictTypes && !bPlacementOk ){` |
...
|      30 |  5366 | `	pCursor = pBodyStart;` |
|      58 |  5367 | `	while( pCursor < pBodyEnd ){` |
...
|      32 |  5374 | `		pNameTok = pCursor;` |
|      32 |  5375 | `		if( (pNameTok->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|       - |  5380 | `		}` |
|      32 |  5381 | `		pEqTok = pNameTok + 1;` |
|      32 |  5382 | `		if( pEqTok >= pBodyEnd \|\| (pEqTok->nType & PH7_TK_EQUAL) == 0 ){` |
...
|       - |  5387 | `		}` |
|      32 |  5388 | `		pValTok = pEqTok + 1;` |
|      32 |  5389 | `		if( pValTok >= pBodyEnd ){` |
...
|       - |  5394 | `		}` |
|      32 |  5395 | `		pDirName = &pNameTok->sData;` |
|      32 |  5396 | `		bIsStrict = DeclareNameIs(pDirName, "strict_types", sizeof("strict_types")-1);` |
|      32 |  5397 | `		if( bIsStrict ){` |
...
|      28 |  5400 | `			if( (pValTok->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) != 0 ){` |
...
|       - |  5405 | `			}` |
|      28 |  5406 | `			iStrictValue = -1;` |
|      28 |  5407 | `			if( pValTok->nType & PH7_TK_INTEGER ){` |
|      28 |  5408 | `				const char *zv = SyStringData(&pValTok->sData);` |
|      28 |  5409 | `				sxu32 nv = SyStringLength(&pValTok->sData);` |
|      28 |  5410 | `				if( nv == 1 && zv[0] == '0' ) iStrictValue = 0;` |
|      26 |  5411 | `				else if( nv == 1 && zv[0] == '1' ) iStrictValue = 1;` |
|      13 |  5412 | `			}` |
|      28 |  5413 | `			if( iStrictValue != 0 && iStrictValue != 1 ){` |
...
|       - |  5418 | `			}` |
|      26 |  5419 | `			pGen->bStrictTypes = (sxi8)iStrictValue;` |
|      14 |  5420 | `		}else{` |
...
|       - |  5427 | `				);` |
|       - |  5428 | `		}` |
|      30 |  5429 | `		pCursor = pValTok + 1;` |
|       - |  5430 | `		/* Consume separating comma (or end). */` |
|      30 |  5431 | `		if( pCursor < pBodyEnd ){` |
...
|       - |  5503 | ` */` |
|   59350 |  5504 | `static sxi32 GenStateProcessArgValue(ph7_gen_state *pGen,ph7_vm_func_arg *pArg,SyToken *pIn,SyToken *pEnd)` |
|       2 |  5505 |  |
|       - |  5506 | `	SyToken *pTmpIn,*pTmpEnd;` |
|       - |  5507 | `	SySet *pInstrContainer;` |
|       - |  5508 | `	sxi32 rc;` |
|       - |  5509 | `	/* Swap token stream */` |
|   59352 |  5510 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|   59352 |  5511 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   59352 |  5512 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pArg->aByteCode);` |
|       - |  5513 | `	/* Compile the expression holding the argument value */` |
|   59352 |  5514 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|       - |  5515 | `	/* Emit the done instruction */` |
|   59352 |  5516 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,(rc != SXERR_EMPTY ? 1 : 0),0,0,0);` |
|   59352 |  5517 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|   59352 |  5518 | `	RE_SWAP_DELIMITER(pGen);` |
|   59352 |  5519 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  5520 | `		return SXERR_ABORT;` |
|       - |  5521 | `	}` |
|   59352 |  5522 | `	return SXRET_OK;` |
|   29677 |  5523 |  |
|       - |  5524 | `/*` |
...
|       - |  5560 | ` */` |
|   82228 |  5561 | `static sxi32 GenStateCollectFuncArgs(ph7_vm_func *pFunc,ph7_gen_state *pGen,SyToken *pEnd,int bCtorCtx,int bAbstractCtx)` |
|       2 |  5562 |  |
...
|       - |  5567 | `	sxi32 rc;` |
|       - |  5568 |  |
|   82230 |  5569 | `	pIn = pGen->pIn;` |
|   82230 |  5570 | `	SyBlobInit(&sSig,&pGen->pVm->sAllocator);` |
|       - |  5571 | `	/* Process arguments one after one */` |
|  102848 |  5572 | `	for(;;){` |
|  205698 |  5573 | `		if( pIn >= pEnd ){` |
|       - |  5574 | `			/* No more arguments to process */` |
|   82218 |  5575 | `			break;` |
|       - |  5576 | `		}` |
|  123482 |  5577 | `		SyZero(&sArg,sizeof(ph7_vm_func_arg));` |
|  123482 |  5578 | `		SySetInit(&sArg.aByteCode,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|  123482 |  5579 | `		SySetInit(&sArg.aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|  123482 |  5580 | `		SyStringInitFromBuf(&sArg.sTypeName,0,0);` |
|       - |  5581 | `		/* Parse optional visibility modifier (constructor property promotion, PHP 8.0+) */` |
|  123482 |  5582 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD) ){` |
|   56352 |  5583 | `			sxu32 nKw = (sxu32)SX_PTR_TO_INT(pIn->pUserData);` |
|   56352 |  5584 | `			if( nKw == PH7_TKWRD_PUBLIC \|\| nKw == PH7_TKWRD_PROTECTED \|\| nKw == PH7_TKWRD_PRIVATE ){` |
|      42 |  5585 | `				if( !bCtorCtx ){` |
...
|       - |  5597 | `				}` |
|      38 |  5598 | `				sArg.iFlags \|= VM_FUNC_ARG_PROMOTED;` |
|      38 |  5599 | `				if( nKw == PH7_TKWRD_PRIVATE ){` |
|       3 |  5600 | `					sArg.iPromoteVis = PH7_CLASS_PROT_PRIVATE;` |
|      37 |  5601 | `				}else if( nKw == PH7_TKWRD_PROTECTED ){` |
|       3 |  5602 | `					sArg.iPromoteVis = PH7_CLASS_PROT_PROTECTED;` |
|       2 |  5603 | `				}else{` |
|      34 |  5604 | `					sArg.iPromoteVis = PH7_CLASS_PROT_PUBLIC;` |
|       - |  5605 | `				}` |
|      38 |  5606 | `				pIn++;` |
|      18 |  5607 | `			}` |
|   28173 |  5608 | `		}` |
|       - |  5609 | `		/* Parse optional type hint (single, nullable shorthand, or union) */` |
|  156362 |  5610 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_DOLLAR) == 0` |
|   96198 |  5611 | `			&& (pIn->nType & PH7_TK_AMPER) == 0` |
|   67348 |  5612 | `			&& (pIn->nType & PH7_TK_ELLIPSIS) == 0 ){` |
|   65754 |  5613 | `			sxu32 nLineLocal = pIn->nLine;` |
|   65754 |  5614 | `			sxi32 iTFlags = 0;` |
|   65754 |  5615 | `			pGen->pIn = pIn;` |
|   65754 |  5616 | `			rc = GenStateParseUnionTypeDecl(` |
|   32876 |  5617 | `				pGen, &sArg.nType, &sArg.sClass, &sArg.aUnionAlts,` |
|   32876 |  5618 | `				&iTFlags, &sArg.sTypeName,` |
|       - |  5619 | `				VM_FUNC_ARG_NULLABLE, VM_FUNC_ARG_UNION,` |
|       - |  5620 | `				/* bAllowVoid */ 0,` |
|   32876 |  5621 | `						nLineLocal);` |
|   65754 |  5622 | `			pIn = pGen->pIn;` |
|   65754 |  5623 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  5624 | `				return SXERR_ABORT;` |
|   65754 |  5625 | `			}else if( rc == SXERR_CORRUPT ){` |
|       - |  5626 | `				/* Error already reported by GenStateParseUnionTypeDecl */` |
|       3 |  5627 | `				return SXERR_SYNTAX;` |
|   65752 |  5628 | `			}else if( rc == SXERR_SYNTAX ){` |
|       5 |  5629 | `				if( pIn < pEnd ){` |
...
|       - |  5638 | `			}` |
|   65748 |  5639 | `			sArg.iFlags \|= iTFlags;` |
|   32873 |  5640 | `		}` |
|  123472 |  5641 | `		if( pIn >= pEnd ){` |
|     ! 0 |  5642 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Missing argument name");` |
|     ! 0 |  5643 | `			return rc;` |
|       - |  5644 | `		}` |
|  123472 |  5645 | `		if( pIn->nType & PH7_TK_AMPER ){` |
|       - |  5646 | `			/* Pass by reference,record that */` |
|    3152 |  5647 | `			sArg.iFlags \|= VM_FUNC_ARG_BY_REF;` |
|    3152 |  5648 | `			pIn++;` |
|    1575 |  5649 | `		}` |
|  123472 |  5650 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_ELLIPSIS) ){` |
|       - |  5651 | `			/* Variadic parameter: ...$args */` |
|      42 |  5652 | `			sArg.iFlags \|= VM_FUNC_ARG_VARIADIC;` |
|      42 |  5653 | `			pIn++;` |
|      20 |  5654 | `		}` |
|  123472 |  5655 | `		if( pIn >= pEnd \|\| (pIn->nType & PH7_TK_DOLLAR) == 0 \|\| &pIn[1] >= pEnd \|\| (pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|       - |  5656 | `			/* Invalid argument */` |
|     ! 0 |  5657 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Invalid argument name");` |
|     ! 0 |  5658 | `			return rc;` |
|       - |  5659 | `		}` |
|  123472 |  5660 | `		pIn++; /* Jump the dollar sign */` |
|       - |  5661 | `		/* Copy argument name */` |
|  123472 |  5662 | `		zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,SyStringData(&pIn->sData),SyStringLength(&pIn->sData));` |
|  123472 |  5663 | `		if( zDup == 0 ){` |
|     ! 0 |  5664 | `			PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"PH7 engine is running out of memory");` |
|     ! 0 |  5665 | `			return SXERR_ABORT;` |
|       - |  5666 | `		}` |
|  123472 |  5667 | `		SyStringInitFromBuf(&sArg.sName,zDup,SyStringLength(&pIn->sData));` |
|  123472 |  5668 | `		pIn++;` |
|  123472 |  5669 | `		if( pIn < pEnd ){` |
|   69382 |  5670 | `			if( pIn->nType & PH7_TK_EQUAL ){` |
|       - |  5671 | `				SyToken *pDefend;` |
|   59354 |  5672 | `				sxi32 iNest = 0;` |
|   59354 |  5673 | `				pIn++; /* Jump the equal sign */` |
|   59354 |  5674 | `				pDefend = pIn;` |
|       - |  5675 | `				/* Process the default value associated with this argument */` |
|  124948 |  5676 | `				while( pDefend < pEnd ){` |
|   96824 |  5677 | `					if( (pDefend->nType & PH7_TK_COMMA) && iNest <= 0 ){` |
|   31230 |  5678 | `						break;` |
|       - |  5679 | `					}` |
|   65596 |  5680 | `					if( pDefend->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*[*/) ){` |
|       - |  5681 | `						/* Increment nesting level */` |
|    3124 |  5682 | `						iNest++;` |
|   64035 |  5683 | `					}else if( pDefend->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CCB/*'}'*/\|PH7_TK_CSB/*]*/) ){` |
|       - |  5684 | `						/* Decrement nesting level */` |
|    3124 |  5685 | `						iNest--;` |
|    1561 |  5686 | `					}` |
|   65596 |  5687 | `					pDefend++;` |
|       2 |  5688 | `				}` |
|   59354 |  5689 | `				if( pIn >= pDefend ){` |
|       3 |  5690 | `					rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Missing argument default value");` |
|       3 |  5691 | `					return rc;` |
|       - |  5692 | `				}` |
|       - |  5693 | `				/* Process default value */` |
|   59352 |  5694 | `				rc = GenStateProcessArgValue(&(*pGen),&sArg,pIn,pDefend);` |
|   59352 |  5695 | `				if( rc != SXRET_OK ){` |
|     ! 0 |  5696 | `					return rc;` |
|       - |  5697 | `				}` |
|       - |  5698 | `				/* Point beyond the default value */` |
|   59352 |  5699 | `				pIn = pDefend;` |
|   29675 |  5700 | `			}` |
|   69380 |  5701 | `			if( pIn < pEnd && (pIn->nType & PH7_TK_COMMA) == 0 ){` |
|     ! 0 |  5702 | `				rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Unexpected token '%z'",&pIn->sData);` |
|     ! 0 |  5703 | `				return rc;` |
|       - |  5704 | `			}` |
|   69380 |  5705 | `			pIn++; /* Jump the trailing comma */` |
|   34689 |  5706 | `		}` |
|       - |  5707 | `		/* Append argument signature */` |
|  123470 |  5708 | `		if( sArg.nType > 0 ){` |
|   65706 |  5709 | `			if( SyStringLength(&sArg.sClass) > 0 ){` |
|       - |  5710 | `				/* Class name — prefix with 'o' so generic object hint is a prefix match */` |
|    9384 |  5711 | `				int marker = 'o';` |
|    9384 |  5712 | `				SyBlobAppend(&sSig,(const void *)&marker,sizeof(char));` |
|    9384 |  5713 | `				SyBlobAppend(&sSig,SyStringData(&sArg.sClass),SyStringLength(&sArg.sClass));` |
|    4693 |  5714 | `			}else{` |
|       - |  5715 | `				int c;` |
|   56324 |  5716 | `				c = 'n'; /* cc warning */` |
|       - |  5717 | `				/* Type leading character */` |
|   56324 |  5718 | `				switch(sArg.nType){` |
|     ! 0 |  5719 | `				case MEMOBJ_HASHMAP:` |
|       - |  5720 | `					/* Hashmap aka 'array' */` |
|     ! 0 |  5721 | `					c = 'h';` |
|     ! 0 |  5722 | `					break;` |
|    7840 |  5723 | `				case MEMOBJ_INT:` |
|       - |  5724 | `					/* Integer */` |
|   15682 |  5725 | `					c = 'i';` |
|   15682 |  5726 | `					break;` |
...
|     ! 0 |  5744 | `					break;` |
|       - |  5745 | `				}` |
|   56324 |  5746 | `				SyBlobAppend(&sSig,(const void *)&c,sizeof(char));` |
|       - |  5747 | `			}` |
|   32854 |  5748 | `		}else{` |
|       - |  5749 | `			/* No type is associated with this parameter which mean` |
|       - |  5750 | `			 * that this function is not condidate for overloading.` |
|       - |  5751 | `			 */` |
|   57766 |  5752 | `			SyBlobRelease(&sSig);` |
|       - |  5753 | `		}` |
|       - |  5754 | `		/* Save in the argument set */` |
|  123470 |  5755 | `		SySetPut(&pFunc->aArgs,(const void *)&sArg);` |
|       2 |  5756 | `	}` |
|   82218 |  5757 | `	if( SyBlobLength(&sSig) > 0 ){` |
|       - |  5758 | `		/* Save function signature */` |
|   40708 |  5759 | `		SyStringInitFromBuf(&pFunc->sSignature,SyBlobData(&sSig),SyBlobLength(&sSig));` |
|   20353 |  5760 | `	}` |
|   82218 |  5761 | `	return SXRET_OK;` |
|   41116 |  5762 |  |
|       - |  5763 | `/*` |
...
|       - |  5767 | ` */` |
|  195202 |  5768 | `static sxi32 GenStateCompileFuncBody(` |
...
|  195204 |  5778 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC,PH7_VmInstrLength(pGen->pVm),pFunc,&pBlock);` |
|  195204 |  5779 | `	if( rc != SXRET_OK ){` |
...
|       - |  5783 | `	}` |
|  195204 |  5784 | `	nGotoOfft = SySetUsed(&pGen->aGoto);` |
|       - |  5785 | `	/* Swap bytecode containers */` |
|  195204 |  5786 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|  195204 |  5787 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pFunc->aByteCode);` |
...
|       - |  5792 | `	{` |
|  195204 |  5793 | `		sxu32 nArg = SySetUsed(&pFunc->aArgs);` |
|       - |  5794 | `		sxu32 i;` |
|  293616 |  5795 | `		for( i = 0; i < nArg; i++ ){` |
|   98414 |  5796 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pFunc->aArgs,i);` |
|       - |  5797 | `			char *zSrc;` |
|       - |  5798 | `			sxu32 nSrc,nName;` |
|       - |  5799 | `			SySet sToken;` |
|       - |  5800 | `			SyToken *pTmpIn,*pTmpEnd;` |
|       - |  5801 | `			sxi32 rcPromote;` |
|   98414 |  5802 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|   98386 |  5803 | `				continue;` |
|       - |  5804 | `			}` |
...
|      30 |  5810 | `			nName = SyStringLength(&pArg->sName);` |
|      30 |  5811 | `			nSrc = (sizeof("$this->") - 1) + nName + (sizeof(" = $") - 1) + nName;` |
|      30 |  5812 | `			zSrc = (char *)SyMemBackendAlloc(&pGen->pVm->sAllocator,nSrc + 1);` |
|      30 |  5813 | `			if( zSrc == 0 ){` |
...
|       - |  5819 | `			{` |
|      30 |  5820 | `				char *z = zSrc;` |
|      30 |  5821 | `				SyMemcpy("$this->",z,sizeof("$this->")-1);` |
|      30 |  5822 | `				z += sizeof("$this->")-1;` |
|      30 |  5823 | `				SyMemcpy(SyStringData(&pArg->sName),z,nName);` |
|      30 |  5824 | `				z += nName;` |
|      30 |  5825 | `				SyMemcpy(" = $",z,sizeof(" = $")-1);` |
|      30 |  5826 | `				z += sizeof(" = $")-1;` |
|      30 |  5827 | `				SyMemcpy(SyStringData(&pArg->sName),z,nName);` |
|      30 |  5828 | `				z += nName;` |
|      30 |  5829 | `				*z = 0;` |
|       - |  5830 | `			}` |
|      30 |  5831 | `			SySetInit(&sToken,&pGen->pVm->sAllocator,sizeof(SyToken));` |
|      30 |  5832 | `			PH7_TokenizePHP(zSrc,nSrc,1,&sToken);` |
|      30 |  5833 | `			pTmpIn = pGen->pIn;` |
|      30 |  5834 | `			pTmpEnd = pGen->pEnd;` |
|      30 |  5835 | `			pGen->pIn = (SyToken *)SySetBasePtr(&sToken);` |
|      30 |  5836 | `			pGen->pEnd = &pGen->pIn[SySetUsed(&sToken)];` |
|      30 |  5837 | `			rcPromote = PH7_CompileExpr(&(*pGen),0,0);` |
|      30 |  5838 | `			pGen->pIn = pTmpIn;` |
|      30 |  5839 | `			pGen->pEnd = pTmpEnd;` |
|      30 |  5840 | `			SySetRelease(&sToken);` |
|      30 |  5841 | `			if( rcPromote == SXERR_ABORT ){` |
...
|      30 |  5847 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|      16 |  5848 | `		}` |
|       - |  5849 | `	}` |
|       - |  5850 | `	/* Compile the body */` |
|  195204 |  5851 | `	PH7_CompileBlock(&(*pGen),0);` |
|       - |  5852 | `	/* Fix exception jumps now the destination is resolved */` |
|  195204 |  5853 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|       - |  5854 | `	/* Emit the final return if not yet done */` |
|  195204 |  5855 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|       - |  5856 | `	/* Fix gotos jumps now the destination is resolved */` |
|  195204 |  5857 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),nGotoOfft) ){` |
|     ! 0 |  5858 | `		rc = SXERR_ABORT;` |
|     ! 0 |  5859 | `	}` |
|  195204 |  5860 | `	SySetTruncate(&pGen->aGoto,nGotoOfft);` |
|       - |  5861 | `	/* Restore the default container */` |
|  195204 |  5862 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|       - |  5863 | `	/* Leave function block */` |
|  195204 |  5864 | `	GenStateLeaveBlock(&(*pGen),0);` |
|  195204 |  5865 | `	if( rc == SXERR_ABORT ){` |
...
|       - |  5870 | `	{` |
|  195204 |  5871 | `		VmInstr *aInstr = (VmInstr *)SySetBasePtr(&pFunc->aByteCode);` |
|       - |  5872 | `		sxu32 i;` |
| 3814862 |  5873 | `		for( i = 0; i < SySetUsed(&pFunc->aByteCode); i++ ){` |
| 3619678 |  5874 | `			if( aInstr[i].iOp == PH7_OP_YIELD ){` |
...
|       - |  5902 | ` */` |
|     252 |  5903 | `static int SyMemcmpNoCase(const char *zA, const char *zB, sxu32 n)` |
|       2 |  5904 |  |
|       - |  5905 | `	sxu32 i;` |
|     766 |  5906 | `	for( i = 0; i < n; i++ ){` |
|     652 |  5907 | `		int a = zA[i], b = zB[i];` |
|     652 |  5908 | `		if( a >= 'A' && a <= 'Z' ) a += 0x20;` |
|     652 |  5909 | `		if( b >= 'A' && b <= 'Z' ) b += 0x20;` |
|     652 |  5910 | `		if( a != b ) return a - b;` |
|     258 |  5911 | `	}` |
|     116 |  5912 | `	return 0;` |
|     128 |  5913 |  |
|       - |  5914 | `/*` |
...
|       - |  5945 | ` */` |
|   66248 |  5946 | `static sxi32 GenStateParseOneTypeAtom(ph7_gen_state *pGen, PhlTypeAtom *pOut)` |
|       2 |  5947 |  |
|   66250 |  5948 | `	SyToken *pIn = pGen->pIn;` |
|   66250 |  5949 | `	SyZero(pOut, sizeof(*pOut));` |
|   66250 |  5950 | `	SyStringInitFromBuf(&pOut->sClass, 0, 0);` |
|   66250 |  5951 | `	if( pIn >= pGen->pEnd ){` |
|     ! 0 |  5952 | `		return SXERR_SYNTAX;` |
|       - |  5953 | `	}` |
|       - |  5954 | `	/* Optional leading namespace separator '\' on FQN class types */` |
|   66250 |  5955 | `	if( pIn->nType & PH7_TK_NSSEP ){` |
|       8 |  5956 | `		pIn++;` |
|       8 |  5957 | `		if( pIn >= pGen->pEnd ){` |
|     ! 0 |  5958 | `			return SXERR_SYNTAX;` |
|       - |  5959 | `		}` |
|       3 |  5960 | `	}` |
|   66250 |  5961 | `	if( (pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|     ! 0 |  5962 | `		return SXERR_SYNTAX;` |
|       - |  5963 | `	}` |
|   66250 |  5964 | `	if( pIn->nType & PH7_TK_KEYWORD ){` |
|   56712 |  5965 | `		sxu32 nKey = (sxu32)(SX_PTR_TO_INT(pIn->pUserData));` |
|   56712 |  5966 | `		if( nKey & PH7_TKWRD_ARRAY ){` |
|      16 |  5967 | `			pOut->nType = MEMOBJ_HASHMAP; pOut->zCanon = "array"; pOut->nCanon = 5;` |
|   56705 |  5968 | `		}else if( nKey & PH7_TKWRD_BOOL ){` |
|      52 |  5969 | `			pOut->nType = MEMOBJ_BOOL; pOut->zCanon = "bool"; pOut->nCanon = 4;` |
|   56673 |  5970 | `		}else if( nKey & PH7_TKWRD_INT ){` |
|   15848 |  5971 | `			pOut->nType = MEMOBJ_INT; pOut->zCanon = "int"; pOut->nCanon = 3;` |
|   48725 |  5972 | `		}else if( nKey & PH7_TKWRD_STRING ){` |
|   40748 |  5973 | `			pOut->nType = MEMOBJ_STRING; pOut->zCanon = "string"; pOut->nCanon = 6;` |
|   20429 |  5974 | `		}else if( nKey & PH7_TKWRD_FLOAT ){` |
...
|    9540 |  5989 | `		SyString *pT = &pIn->sData;` |
|    9540 |  5990 | `		if( pT->nByte == 4 && SyMemcmpNoCase(pT->zString, "null", 4) == 0 ){` |
|      12 |  5991 | `			pOut->nType = UTA_NULL_FLAG; pOut->zCanon = "null"; pOut->nCanon = 4;` |
|      12 |  5992 | `			pIn++;` |
|    9535 |  5993 | `		}else if( pT->nByte == 4 && SyMemcmpNoCase(pT->zString, "void", 4) == 0 ){` |
|     100 |  5994 | `			pOut->nType = UTA_VOID_FLAG; pOut->zCanon = "void"; pOut->nCanon = 4;` |
|     100 |  5995 | `			pIn++;` |
|    9481 |  5996 | `		}else if( pT->nByte == 5 && SyMemcmpNoCase(pT->zString, "never", 5) == 0 ){` |
|       3 |  5997 | `			pOut->nType = UTA_NEVER_FLAG; pOut->zCanon = "never"; pOut->nCanon = 5;` |
|       3 |  5998 | `			pIn++;` |
|       2 |  5999 | `		}else{` |
|       - |  6000 | `			/* Class / interface name; consume namespace path a\b\c */` |
|    9430 |  6001 | `			SyToken *pFirst = pIn;` |
|    9430 |  6002 | `			SyToken *pLast = pIn;` |
|    9430 |  6003 | `			pOut->nType = SXU32_HIGH;` |
|    9430 |  6004 | `			pOut->sClass = pIn->sData;` |
|    9430 |  6005 | `			pIn++;` |
|   14145 |  6006 | `			while( pIn + 1 < pGen->pEnd && (pIn->nType & PH7_TK_NSSEP)` |
|    9433 |  6007 | `				&& (pIn[1].nType & PH7_TK_ID) ){` |
|       3 |  6008 | `				pLast = &pIn[1];` |
|       3 |  6009 | `				pIn += 2;` |
|       1 |  6010 | `			}` |
|    9430 |  6011 | `			if( pLast != pFirst ){` |
...
|       - |  6017 | `		}` |
|       - |  6018 | `	}` |
|   66248 |  6019 | `	pGen->pIn = pIn;` |
|   66248 |  6020 | `	return SXRET_OK;` |
|   33126 |  6021 |  |
|       - |  6022 |  |
|       - |  6023 | `/*` |
...
|       - |  6029 | ` */` |
|   66150 |  6030 | `static void GenBuildUnionTypeText(SyBlob *pBlob, PhlTypeAtom *aAtoms, int nAtoms, int bNullable)` |
|       2 |  6031 |  |
|       - |  6032 | `	int i;` |
|   66152 |  6033 | `	int nNonNull = 0;` |
|  132384 |  6034 | `	for( i = 0; i < nAtoms; i++ ){` |
|   66234 |  6035 | `		if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|   66224 |  6036 | `			nNonNull++;` |
|   33111 |  6037 | `		}` |
|   33118 |  6038 | `	}` |
|   66152 |  6039 | `	if( nNonNull == 1 && bNullable ){` |
|       - |  6040 | `		/* Shorthand: ?T */` |
...
|     ! 0 |  6051 | `	}` |
|       - |  6052 | `	{` |
|   66098 |  6053 | `		int bFirst = 1;` |
|       - |  6054 | `		/* 1) Classes in declaration order */` |
|  132270 |  6055 | `		for( i = 0; i < nAtoms; i++ ){` |
|   66174 |  6056 | `			if( aAtoms[i].nType == SXU32_HIGH ){` |
|    9424 |  6057 | `				if( !bFirst ) SyBlobAppend(pBlob, "\|", 1);` |
|    9424 |  6058 | `				SyBlobAppend(pBlob, aAtoms[i].sClass.zString, aAtoms[i].sClass.nByte);` |
|    9424 |  6059 | `				bFirst = 0;` |
|    4711 |  6060 | `			}` |
|   33088 |  6061 | `		}` |
...
|       - |  6066 | `			int k;` |
|  462674 |  6067 | `			for( k = 0; k < (int)(sizeof(aOrder)/sizeof(aOrder[0])); k++ ){` |
|  736868 |  6068 | `				for( i = 0; i < nAtoms; i++ ){` |
|  396942 |  6069 | `					if( aAtoms[i].nType == aOrder[k] ){` |
|   56652 |  6070 | `						if( !bFirst ) SyBlobAppend(pBlob, "\|", 1);` |
|   56652 |  6071 | `						SyBlobAppend(pBlob, aAtoms[i].zCanon, aAtoms[i].nCanon);` |
|   56652 |  6072 | `						bFirst = 0;` |
|   56652 |  6073 | `						break;` |
|       - |  6074 | `					}` |
|  170147 |  6075 | `				}` |
...
|       - |  6103 | ` */` |
|   66160 |  6104 | `static sxi32 GenStateParseUnionTypeDecl(` |
...
|   66162 |  6117 | `	int nAtoms = 0;` |
|   66162 |  6118 | `	int bShortNullable = 0;` |
|   66162 |  6119 | `	int bExplicitNull = 0;` |
|       - |  6120 | `	sxi32 rc;` |
|   66162 |  6121 | `	*pnType = 0;` |
|   66162 |  6122 | `	if( pClass ) SyStringInitFromBuf(pClass, 0, 0);` |
|   66162 |  6123 | `	*piTypeFlags = 0;` |
|   66162 |  6124 | `	if( pTypeText ) SyStringInitFromBuf(pTypeText, 0, 0);` |
|       - |  6125 |  |
|   66162 |  6126 | `	if( pGen->pIn >= pGen->pEnd ){` |
|     ! 0 |  6127 | `		return SXRET_OK;` |
|       - |  6128 | `	}` |
|       - |  6129 | ``	/* Optional `?` shorthand prefix */`` |
|   66160 |  6130 | `	if( (pGen->pIn->nType & PH7_TK_OP) && pGen->pIn->sData.nByte == 1` |
...
|   66162 |  6139 | `	rc = GenStateParseOneTypeAtom(pGen, &aAtoms[0]);` |
|   66162 |  6140 | `	if( rc != SXRET_OK ){` |
|       3 |  6141 | `		return rc;` |
|       - |  6142 | `	}` |
|   66160 |  6143 | `	nAtoms = 1;` |
|       - |  6144 | ``	/* Subsequent atoms separated by `\|` */`` |
|   99371 |  6145 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OP)` |
|   66294 |  6146 | `		&& pGen->pIn->sData.nByte == 1 && pGen->pIn->sData.zString[0] == '\|' ){` |
...
|       - |  6173 | `	{` |
|       - |  6174 | `		int i, j;` |
|   66158 |  6175 | `		int bHasNonNull = 0;` |
|  132396 |  6176 | `		for( i = 0; i < nAtoms; i++ ){` |
|   66246 |  6177 | `			if( aAtoms[i].nType == UTA_VOID_FLAG ){` |
...
|       - |  6192 | `				}` |
|      48 |  6193 | `			}` |
|   66244 |  6194 | `			if( aAtoms[i].nType == UTA_NEVER_FLAG ){` |
...
|       - |  6208 | `			}` |
|   66242 |  6209 | `			if( aAtoms[i].nType == UTA_NULL_FLAG ){` |
|      12 |  6210 | `				bExplicitNull = 1;` |
|       7 |  6211 | `			}else{` |
|   66232 |  6212 | `				bHasNonNull = 1;` |
|       - |  6213 | `			}` |
|       - |  6214 | `			/* Duplicate detection */` |
|   66360 |  6215 | `			for( j = 0; j < i; j++ ){` |
|     122 |  6216 | `				int bDup = 0;` |
...
|      61 |  6243 | `			}` |
|   33121 |  6244 | `		}` |
|   66152 |  6245 | `		if( !bHasNonNull && bExplicitNull ){` |
...
|   66152 |  6252 | `	if( bShortNullable \|\| bExplicitNull ){` |
|      60 |  6253 | `		*piTypeFlags \|= iNullableFlag;` |
|      29 |  6254 | `	}` |
|       - |  6255 | `	/* Build canonical type text */` |
|   66152 |  6256 | `	if( pTypeText ){` |
|       - |  6257 | `		SyBlob sBlob;` |
|   66152 |  6258 | `		SyBlobInit(&sBlob, &pGen->pVm->sAllocator);` |
|   99203 |  6259 | `		GenBuildUnionTypeText(&sBlob, aAtoms, nAtoms,` |
|   33075 |  6260 | `			(bShortNullable \|\| bExplicitNull) ? 1 : 0);` |
|   66152 |  6261 | `		if( SyBlobLength(&sBlob) > 0 ){` |
|   99083 |  6262 | `			char *zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|   66054 |  6263 | `				(const char *)SyBlobData(&sBlob), SyBlobLength(&sBlob));` |
|   66056 |  6264 | `			if( zDup ){` |
|   66056 |  6265 | `				SyStringInitFromBuf(pTypeText, zDup, SyBlobLength(&sBlob));` |
|   33027 |  6266 | `			}` |
|   33027 |  6267 | `		}` |
|   66152 |  6268 | `		SyBlobRelease(&sBlob);` |
|   33075 |  6269 | `	}` |
...
|       - |  6273 | `	{` |
|   66152 |  6274 | `		int nNonNull = 0;` |
|   66152 |  6275 | `		int iNonNullIdx = -1;` |
|       - |  6276 | `		int i;` |
|  132384 |  6277 | `		for( i = 0; i < nAtoms; i++ ){` |
|   66234 |  6278 | `			if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|   66224 |  6279 | `				nNonNull++;` |
|   66224 |  6280 | `				iNonNullIdx = i;` |
|   33111 |  6281 | `			}` |
|   33118 |  6282 | `		}` |
|   66152 |  6283 | `		if( nNonNull <= 1 ){` |
|       - |  6284 | `			/* Fast path: store as single type. */` |
|   66096 |  6285 | `			if( iNonNullIdx >= 0 ){` |
|   66096 |  6286 | `				PhlTypeAtom *pA = &aAtoms[iNonNullIdx];` |
|   66096 |  6287 | `				if( pA->nType == SXU32_HIGH ){` |
|   14111 |  6288 | `					char *zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|    4703 |  6289 | `						pA->sClass.zString, pA->sClass.nByte);` |
|    9408 |  6290 | `					if( zDup == 0 ) return SXERR_ABORT;` |
|    9408 |  6291 | `					*pnType = SXU32_HIGH;` |
|    9408 |  6292 | `					if( pClass ) SyStringInitFromBuf(pClass, zDup, pA->sClass.nByte);` |
|   61393 |  6293 | `				}else if( pA->nType == UTA_VOID_FLAG ){` |
...
|       - |  6332 | ` */` |
|  273400 |  6333 | `static sxi32 GenStateParseReturnType(ph7_gen_state *pGen, ph7_vm_func *pFunc)` |
|       2 |  6334 |  |
|  273402 |  6335 | `	sxi32 iFlags = 0;` |
|       - |  6336 | `	sxi32 rc;` |
|       - |  6337 | `	sxu32 nLine;` |
|  273402 |  6338 | `	pFunc->nReturnType = 0;` |
|  273402 |  6339 | `	SyStringInitFromBuf(&pFunc->sReturnClass, 0, 0);` |
|  273402 |  6340 | `	SyStringInitFromBuf(&pFunc->sReturnTypeName, 0, 0);` |
|  273402 |  6341 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COLON) == 0 ){` |
|  273120 |  6342 | `		return SXRET_OK;` |
|       - |  6343 | `	}` |
|     284 |  6344 | `	pGen->pIn++; /* Skip ':' */` |
|     284 |  6345 | `	if( pGen->pIn >= pGen->pEnd ){` |
|     ! 0 |  6346 | `		return SXRET_OK;` |
|       - |  6347 | `	}` |
|     284 |  6348 | `	nLine = pGen->pIn->nLine;` |
|     284 |  6349 | `	rc = GenStateParseUnionTypeDecl(` |
|     141 |  6350 | `		pGen,` |
|     141 |  6351 | `		&pFunc->nReturnType,` |
|     141 |  6352 | `		&pFunc->sReturnClass,` |
|     141 |  6353 | `		&pFunc->aReturnUnion,` |
|       - |  6354 | `		&iFlags,` |
|     141 |  6355 | `		&pFunc->sReturnTypeName,` |
|       - |  6356 | `		/* iNullableFlag */ 0, /* nullability for returns rides on aReturnUnion contents only */` |
|       - |  6357 | `		/* iUnionFlag */ 0,` |
|       - |  6358 | `		/* bAllowVoid */ 1,` |
|     141 |  6359 | `		nLine);` |
|     141 |  6360 | `	(void)iFlags;` |
|     284 |  6361 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  6362 | `		return SXERR_ABORT;` |
|       - |  6363 | `	}` |
|     284 |  6364 | `	if( rc == SXERR_CORRUPT ){` |
|       - |  6365 | `		/* Error already reported */` |
|     ! 0 |  6366 | `		return SXERR_SYNTAX;` |
|       - |  6367 | `	}` |
|     284 |  6368 | `	if( rc == SXERR_SYNTAX ){` |
...
|       - |  6378 | `	}` |
|     280 |  6379 | `	return SXRET_OK;` |
|  136702 |  6380 |  |
|       - |  6381 |  |
|   41486 |  6382 | `static sxi32 GenStateCompileFunc(` |
...
|   41488 |  6396 | `	nLine = pGen->pIn->nLine;` |
|       - |  6397 | `	/* Jump the left parenthesis '(' */` |
|   41488 |  6398 | `	pGen->pIn++;` |
|       - |  6399 | `	/* Delimit the function signature */` |
|   41488 |  6400 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   41488 |  6401 | `	if( pEnd >= pGen->pEnd ){` |
|       - |  6402 | `		/* Syntax error */` |
...
|   41482 |  6412 | `	pFunc = (ph7_vm_func *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_vm_func));` |
|   41482 |  6413 | `	if( pFunc == 0 ){` |
|     ! 0 |  6414 | `		goto OutOfMem;` |
|       - |  6415 | `	}` |
|       - |  6416 | `	/* Build the function name, prepending namespace if active */` |
|   41489 |  6417 | `	if( SyBlobLength(&pGen->sNamespace) > 0 && !bHandleClosure ){` |
|       - |  6418 | `		SyBlob sFQN;` |
|       - |  6419 | `		sxu32 nLen;` |
...
|       9 |  6431 | `	}else{` |
|   41468 |  6432 | `		zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|   41468 |  6433 | `		if( zName == 0 ){` |
|     ! 0 |  6434 | `			goto OutOfMem;` |
|       - |  6435 | `		}` |
|   41468 |  6436 | `		PH7_VmInitFuncState(pGen->pVm,pFunc,zName,pName->nByte,iFlags,0);` |
|       - |  6437 | `	}` |
|   41482 |  6438 | `	if( pGen->pIn < pEnd ){` |
|       - |  6439 | `		/* Collect function arguments */` |
|   28778 |  6440 | `		rc = GenStateCollectFuncArgs(pFunc,&(*pGen),pEnd,0,0);` |
|   28778 |  6441 | `		if( rc == SXERR_ABORT ){` |
...
|   41482 |  6447 | `	pGen->pIn = &pEnd[1];` |
|       - |  6448 | `	{` |
|   41482 |  6449 | `		sxi32 rcRt = GenStateParseReturnType(pGen, pFunc);` |
|   41482 |  6450 | `		if( rcRt == SXERR_ABORT ){` |
|     ! 0 |  6451 | `			return SXERR_ABORT;` |
|   41482 |  6452 | `		}else if( rcRt == SXERR_SYNTAX ){` |
|       5 |  6453 | `			return SXERR_SYNTAX;` |
|       - |  6454 | `		}` |
|       - |  6455 | `	}` |
|   41478 |  6456 | `	if( bHandleClosure ){` |
|       - |  6457 | `		ph7_vm_func_closure_env sEnv;` |
|     192 |  6458 | `		int got_this = 0; /* TRUE if $this have been seen */` |
|     190 |  6459 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD)` |
|     105 |  6460 | `			&& SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_USE ){` |
...
|   41478 |  6549 | `	rc = GenStateCompileFuncBody(&(*pGen),pFunc);` |
|   41478 |  6550 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  6551 | `		return SXERR_ABORT;` |
|       - |  6552 | `	}` |
|   41478 |  6553 | `	if( ppFunc ){` |
|     192 |  6554 | `		*ppFunc = pFunc;` |
|      95 |  6555 | `	}` |
|   41478 |  6556 | `	rc = SXRET_OK;` |
|   41478 |  6557 | `	if( (pFunc->iFlags & VM_FUNC_CLOSURE) == 0 ){` |
|       - |  6558 | `		/* Finally register the function */` |
|   41462 |  6559 | `		rc = PH7_VmInstallUserFunction(pGen->pVm,pFunc,0);` |
|   20730 |  6560 | `	}` |
|   41478 |  6561 | `	if( rc == SXRET_OK ){` |
|   41478 |  6562 | `		return SXRET_OK;` |
|       - |  6563 | `	}` |
...
|       - |  6575 | ` */` |
|   41302 |  6576 | `static sxi32 PH7_CompileFunction(ph7_gen_state *pGen)` |
|       2 |  6577 |  |
|       - |  6578 | `	SyString *pName;` |
|       - |  6579 | `	sxi32 iFlags;` |
|       - |  6580 | `	sxu32 nLine;` |
|       - |  6581 | `	sxi32 rc;` |
|       - |  6582 |  |
|   41304 |  6583 | `	nLine = pGen->pIn->nLine;` |
|   41304 |  6584 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|   41304 |  6585 | `	iFlags = 0;` |
|   41304 |  6586 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|       - |  6587 | `		/* Return by reference,remember that */` |
|       7 |  6588 | `		iFlags \|= VM_FUNC_REF_RETURN;` |
|       - |  6589 | `		/* Jump the '&' token */` |
|       7 |  6590 | `		pGen->pIn++;` |
|       3 |  6591 | `	}` |
|   41304 |  6592 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|       - |  6603 | `	}` |
|   41300 |  6604 | `	pName = &pGen->pIn->sData;` |
|   41300 |  6605 | `	nLine = pGen->pIn->nLine;` |
|       - |  6606 | `	/* Jump the function name */` |
|   41300 |  6607 | `	pGen->pIn++;` |
|   41300 |  6608 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  6609 | `		/* Syntax error */` |
...
|   41298 |  6622 | `	rc = GenStateCompileFunc(&(*pGen),pName,iFlags,FALSE,0);` |
|   41298 |  6623 | `	return rc;` |
|   20653 |  6624 |  |
|       - |  6625 | `/*` |
...
|       - |  6635 | ` */` |
|  291664 |  6636 | `static sxi32 GetProtectionLevel(sxi32 nKeyword)` |
|       2 |  6637 |  |
|  291666 |  6638 | `	if( nKeyword == PH7_TKWRD_PRIVATE ){` |
|    9446 |  6639 | `		return PH7_CLASS_PROT_PRIVATE;` |
|  282222 |  6640 | `	}else if( nKeyword == PH7_TKWRD_PROTECTED ){` |
|   40632 |  6641 | `		return PH7_CLASS_PROT_PROTECTED;` |
|       - |  6642 | `	}` |
|       - |  6643 | `	/* Assume public by default */` |
|  241592 |  6644 | `	return PH7_CLASS_PROT_PUBLIC;` |
|  145834 |  6645 |  |
|       - |  6646 | `/*` |
...
|       - |  6666 | ` */` |
|      30 |  6667 | `static sxi32 GenStateCompileClassConstant(ph7_gen_state *pGen,sxi32 iProtection,sxi32 iFlags,ph7_class *pClass)` |
|       2 |  6668 |  |
|      32 |  6669 | `	sxu32 nLine = pGen->pIn->nLine;` |
|       - |  6670 | `	SySet *pInstrContainer;` |
|       - |  6671 | `	ph7_class_attr *pCons;` |
|       - |  6672 | `	SyString *pName;` |
|       - |  6673 | `	sxi32 rc;` |
|       - |  6674 | `	/* Extract visibility level */` |
|      32 |  6675 | `	iProtection = GetProtectionLevel(iProtection);` |
|      32 |  6676 | `	pGen->pIn++; /* Jump the 'const' keyword */` |
|      15 |  6677 | `loop:` |
|       - |  6678 | `	/* Mark as constant */` |
|      32 |  6679 | `	iFlags \|= PH7_CLASS_ATTR_CONSTANT;` |
|      32 |  6680 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
...
|      32 |  6690 | `	pName = &pGen->pIn->sData;` |
|       - |  6691 | `	/* Make sure the constant name isn't reserved */` |
|      32 |  6692 | `	if( GenStateIsReservedConstant(pName) ){` |
...
|      32 |  6702 | `	pGen->pIn++;` |
|      32 |  6703 | `	if(pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_EQUAL /* '=' */) == 0 ){` |
...
|       - |  6711 | `	}` |
|      32 |  6712 | `	pGen->pIn++; /* Jump the equal sign */` |
|       - |  6713 | `	/* Allocate a new class attribute */` |
|      32 |  6714 | `	pCons = PH7_NewClassAttr(pGen->pVm,pName,nLine,iProtection,iFlags);` |
|      32 |  6715 | `	if( pCons == 0 ){` |
...
|      32 |  6720 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|      32 |  6721 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pCons->aByteCode);` |
|       - |  6722 | `	/* Compile constant value.` |
|       - |  6723 | `	 */` |
|      32 |  6724 | `	rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|      32 |  6725 | `	if( rc == SXERR_EMPTY ){` |
...
|      32 |  6732 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|      32 |  6733 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|      32 |  6734 | `	if( rc == SXERR_ABORT ){` |
...
|      32 |  6739 | `	rc = PH7_ClassInstallAttr(pClass,pCons);` |
|      32 |  6740 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  6741 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|     ! 0 |  6742 | `		return SXERR_ABORT;` |
|       - |  6743 | `	}` |
|      32 |  6744 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA /*','*/) ){` |
...
|       - |  6800 | ` */` |
|  153828 |  6801 | `static int GenStateLooksLikeTypedProperty(SyToken *pStart,SyToken *pEnd)` |
|       2 |  6802 |  |
|  153830 |  6803 | `	SyToken *p = pStart;` |
|  153830 |  6804 | `	if( p >= pEnd ) return 0;` |
|  153830 |  6805 | `	if( (p->nType & PH7_TK_OP) && p->sData.nByte == 1 && p->sData.zString[0] == '?' ){` |
|      16 |  6806 | `		p++;` |
|      16 |  6807 | `		if( p >= pEnd ) return 0;` |
|       7 |  6808 | `	}` |
|  153830 |  6809 | `	if( p->nType & PH7_TK_NSSEP ){` |
|       3 |  6810 | `		p++;` |
|       3 |  6811 | `		if( p >= pEnd ) return 0;` |
|       1 |  6812 | `	}` |
|  153830 |  6813 | `	if( (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|     ! 0 |  6814 | `		return 0;` |
|       - |  6815 | `	}` |
...
|       - |  6819 | `	 * dispatch site. */` |
|  153830 |  6820 | `	if( p->nType & PH7_TK_KEYWORD ){` |
|  153812 |  6821 | `		sxu32 k = (sxu32)(SX_PTR_TO_INT(p->pUserData));` |
|  153864 |  6822 | `		if( k == PH7_TKWRD_FUNCTION \|\| k == PH7_TKWRD_VAR \|\| k == PH7_TKWRD_CONST` |
|    3283 |  6823 | `		 \|\| k == PH7_TKWRD_STATIC \|\| k == PH7_TKWRD_FINAL \|\| k == PH7_TKWRD_ABSTRACT ){` |
|  153704 |  6824 | `			return 0;` |
|       - |  6825 | `		}` |
|      54 |  6826 | `	}` |
|     128 |  6827 | `	p++;` |
|       - |  6828 | `	/* Consume optional namespace path */` |
|     130 |  6829 | `	while( p + 1 < pEnd && (p->nType & PH7_TK_NSSEP) && (p[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|       3 |  6830 | `		p += 2;` |
|       1 |  6831 | `	}` |
|       - |  6832 | ``	/* Consume any `\| Type` union alternatives */`` |
|     207 |  6833 | `	while( p < pEnd && (p->nType & PH7_TK_OP) && p->sData.nByte == 1` |
|      83 |  6834 | `		&& p->sData.zString[0] == '\|' ){` |
|      14 |  6835 | `		p++;` |
...
|     ! 0 |  6841 | `		}` |
|       2 |  6842 | `	}` |
|     128 |  6843 | `	if( p >= pEnd ) return 0;` |
|     128 |  6844 | `	return (p->nType & PH7_TK_DOLLAR) ? 1 : 0;` |
|   76916 |  6845 |  |
|       - |  6846 |  |
|       - |  6847 | `/*` |
...
|       - |  6864 | ` */` |
|     126 |  6865 | `static sxi32 GenStateParsePropertyType(` |
...
|       - |  6871 | `	SySet *pAlts` |
|       2 |  6872 | `){` |
|     128 |  6873 | `	sxi32 iFlags = 0;` |
|       - |  6874 | `	sxi32 rc;` |
|     128 |  6875 | `	if( pGen->pIn >= pGen->pEnd ){` |
|     ! 0 |  6876 | `		return SXRET_OK;` |
|       - |  6877 | `	}` |
|       - |  6878 | `	/* If the first token is '$', there's no type */` |
|     128 |  6879 | `	if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|     ! 0 |  6880 | `		return SXRET_OK;` |
|       - |  6881 | `	}` |
|     128 |  6882 | `	rc = GenStateParseUnionTypeDecl(` |
|      63 |  6883 | `		pGen, pnType, pClass, pAlts, &iFlags, pTypeText,` |
|       - |  6884 | `		PH7_CLASS_ATTR_NULLABLE,` |
|       - |  6885 | `		PH7_CLASS_ATTR_UNION,` |
|       - |  6886 | `		/* bAllowVoid */ 0,` |
|     126 |  6887 | `		pGen->pIn->nLine);` |
|     128 |  6888 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  6889 | `		return rc;` |
|       - |  6890 | `	}` |
|       - |  6891 | `	/* Verify next token is '$' (start of property name) */` |
|     128 |  6892 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
|     ! 0 |  6893 | `		return SXERR_SYNTAX;` |
|       - |  6894 | `	}` |
|     128 |  6895 | `	*piTypeFlags = iFlags \| PH7_CLASS_ATTR_TYPED;` |
|     128 |  6896 | `	return SXRET_OK;` |
|      65 |  6897 |  |
|       - |  6898 |  |
|       - |  6899 | `/*` |
...
|       - |  6909 | ` */` |
|     192 |  6910 | `static int GenStateIsDisallowedPropertyAtom(` |
|       - |  6911 | `	sxu32 nType,` |
...
|       - |  6916 | `	const char *z;` |
|       - |  6917 | `	sxu32 n;` |
|     194 |  6918 | `	if( nType != SXU32_HIGH \|\| pClass == 0 \|\| pClass->nByte == 0 ){` |
|     164 |  6919 | `		return 0;` |
|       - |  6920 | `	}` |
...
|       - |  6944 | ` */` |
|     164 |  6945 | `static sxi32 GenStateValidatePropertyType(` |
...
|       - |  6953 | `	sxu32 nLine)` |
|       2 |  6954 |  |
|     166 |  6955 | `	const char *zBad = 0;` |
|     166 |  6956 | `	sxu32 nBad = 0;` |
|       - |  6957 | `	SyString sFallback;` |
|       - |  6958 | `	const SyString *pBad;` |
|       - |  6959 | `	sxi32 rc;` |
|     166 |  6960 | `	int bDisallowed = 0;` |
|     166 |  6961 | `	if( GenStateIsDisallowedPropertyAtom(nType,pTypeClass,&zBad,&nBad) ){` |
|       3 |  6962 | `		bDisallowed = 1;` |
|     165 |  6963 | `	}else if( pUnionAlts ){` |
|       - |  6964 | `		sxu32 i;` |
...
|      15 |  6971 | `		}` |
|       7 |  6972 | `	}` |
|     166 |  6973 | `	if( !bDisallowed ){` |
|     162 |  6974 | `		return SXRET_OK;` |
|       - |  6975 | `	}` |
...
|      84 |  6992 |  |
|       - |  6993 |  |
|   59796 |  6994 | `static sxi32 GenStateCompileClassAttr(ph7_gen_state *pGen,sxi32 iProtection,sxi32 iFlags,ph7_class *pClass)` |
|       2 |  6995 |  |
|   59798 |  6996 | `	sxu32 nLine = pGen->pIn->nLine;` |
|       - |  6997 | `	ph7_class_attr *pAttr;` |
|       - |  6998 | `	SyString *pName;` |
|       - |  6999 | `	sxi32 rc;` |
|   59798 |  7000 | `	sxu32 nType = 0;` |
|       - |  7001 | `	SyString sTypeClass;` |
|       - |  7002 | `	SyString sTypeText;` |
|       - |  7003 | `	SySet aUnionAlts;` |
|   59798 |  7004 | `	sxi32 iTypeFlags = 0;` |
|   59798 |  7005 | `	SyStringInitFromBuf(&sTypeClass,0,0);` |
|   59798 |  7006 | `	SyStringInitFromBuf(&sTypeText,0,0);` |
|   59798 |  7007 | `	SySetInit(&aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|       - |  7008 | `	/* Extract visibility level */` |
|   59798 |  7009 | `	iProtection = GetProtectionLevel(iProtection);` |
|       - |  7010 | `	/* Parse optional type hint (typed properties, PHP 7.4+) */` |
|   59861 |  7011 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
|     128 |  7012 | `		rc = GenStateParsePropertyType(pGen,&nType,&sTypeClass,&iTypeFlags,&sTypeText,&aUnionAlts);` |
|     128 |  7013 | `		if( rc == SXERR_CORRUPT ){` |
|       - |  7014 | `			/* Error already reported by GenStateParseUnionTypeDecl */` |
|     ! 0 |  7015 | `			goto Synchronize;` |
|     128 |  7016 | `		}else if( rc == SXERR_SYNTAX ){` |
...
|     128 |  7024 | `		}else if( rc == SXERR_ABORT ){` |
|     ! 0 |  7025 | `			return SXERR_ABORT;` |
|       - |  7026 | `		}` |
|      63 |  7027 | `	}` |
|     ! 0 |  7028 | `loop:` |
|   59802 |  7029 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
...
|       - |  7035 | `	}` |
|   59802 |  7036 | `	pGen->pIn++; /* Jump the dollar sign */` |
|   59802 |  7037 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_ID)) == 0 ){` |
...
|   59802 |  7047 | `	pName = &pGen->pIn->sData;` |
|       - |  7048 | `	/* Advance the stream cursor */` |
|   59802 |  7049 | `	pGen->pIn++;` |
|   59802 |  7050 | `	if(pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_EQUAL/*'='*/\|PH7_TK_SEMI/*';'*/\|PH7_TK_COMMA/*','*/)) == 0 ){` |
...
|   59800 |  7062 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|     197 |  7063 | `		rc = GenStateValidatePropertyType(pGen,pClass,pName,nType,&sTypeClass,` |
|       - |  7064 | `			&sTypeText,` |
|     130 |  7065 | `			(iTypeFlags & PH7_CLASS_ATTR_UNION) ? &aUnionAlts : 0,nLine);` |
|     132 |  7066 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  7067 | `			return SXERR_ABORT;` |
|     132 |  7068 | `		}else if( rc != SXRET_OK ){` |
|     ! 0 |  7069 | `			goto Synchronize;` |
|       - |  7070 | `		}` |
|      65 |  7071 | `	}` |
|       - |  7072 | `	/* Reject redeclaration (catches clash with an earlier promoted property). */` |
|   59800 |  7073 | `	if( PH7_ClassExtractAttribute(pClass,pName->zString,pName->nByte) != 0 ){` |
...
|   59798 |  7082 | `	pAttr = PH7_NewClassAttr(pGen->pVm,pName,nLine,iProtection,iFlags\|iTypeFlags);` |
|   59798 |  7083 | `	if( pAttr == 0 ){` |
|     ! 0 |  7084 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 engine is running out of memory");` |
|     ! 0 |  7085 | `		return SXERR_ABORT;` |
|       - |  7086 | `	}` |
|   59798 |  7087 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|     130 |  7088 | `		pAttr->nType = nType;` |
|     130 |  7089 | `		pAttr->sClass = sTypeClass;` |
|     130 |  7090 | `		pAttr->sTypeName = sTypeText;` |
|     130 |  7091 | `		if( iTypeFlags & PH7_CLASS_ATTR_UNION ){` |
...
|       5 |  7102 | `		}` |
|      64 |  7103 | `	}` |
|   59798 |  7104 | `	if( pGen->pIn->nType & PH7_TK_EQUAL /*'='*/ ){` |
|       - |  7105 | `		SySet *pInstrContainer;` |
|   19104 |  7106 | `		pGen->pIn++; /*Jump the equal sign */` |
|       - |  7107 | `		/* Swap bytecode container */` |
|   19104 |  7108 | `		pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   19104 |  7109 | `		PH7_VmSetByteCodeContainer(pGen->pVm,&pAttr->aByteCode);` |
|       - |  7110 | `		/* Compile attribute value.` |
|       - |  7111 | `		 */` |
|   19104 |  7112 | `		rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|   19104 |  7113 | `		if( rc == SXERR_EMPTY ){` |
...
|   19104 |  7120 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|   19104 |  7121 | `		PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|    9551 |  7122 | `	}` |
|       - |  7123 | `	/* All done,install the attribute */` |
|   59798 |  7124 | `	rc = PH7_ClassInstallAttr(pClass,pAttr);` |
|   59798 |  7125 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  7126 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|     ! 0 |  7127 | `		return SXERR_ABORT;` |
|       - |  7128 | `	}` |
|   59798 |  7129 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA /*','*/) ){` |
...
|       - |  7147 | `		}` |
|     ! 0 |  7148 | `	}` |
|   59794 |  7149 | `	SySetRelease(&aUnionAlts);` |
|   59794 |  7150 | `	return SXRET_OK;` |
|       2 |  7151 | `Synchronize:` |
...
|       - |  7166 | ` */` |
|  231838 |  7167 | `static sxi32 GenStateCompileClassMethod(` |
...
|       - |  7173 | `	)` |
|       2 |  7174 |  |
|  231840 |  7175 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|  231840 |  7182 | `	iProtection = GetProtectionLevel(iProtection);` |
|  231840 |  7183 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|  231840 |  7184 | `	iFuncFlags = 0;` |
|  231840 |  7185 | `	if( pGen->pIn >= pGen->pEnd ){` |
...
|       - |  7193 | `	}` |
|  231840 |  7194 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|       - |  7195 | `		/* Return by reference,remember that */` |
|     ! 0 |  7196 | `		iFuncFlags \|= VM_FUNC_REF_RETURN;` |
|       - |  7197 | `		/* Jump the '&' token */` |
|     ! 0 |  7198 | `		pGen->pIn++;` |
|     ! 0 |  7199 | `	}` |
|  231840 |  7200 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|  231840 |  7209 | `	pName = &pGen->pIn->sData;` |
|  231840 |  7210 | `	nLine = pGen->pIn->nLine;` |
|       - |  7211 | `	/* Jump the method name */` |
|  231840 |  7212 | `	pGen->pIn++;` |
|  231840 |  7213 | `	if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|       - |  7214 | `		/* Abstract method */` |
|   78104 |  7215 | `		if( iProtection == PH7_CLASS_PROT_PRIVATE ){` |
...
|   78104 |  7224 | `		doBody = FALSE;` |
|   39051 |  7225 | `	}` |
|  231840 |  7226 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  7227 | `		/* Syntax error */` |
...
|  231840 |  7236 | `	pMeth = PH7_NewClassMethod(pGen->pVm,pClass,pName,nLine,iProtection,iFlags,iFuncFlags);` |
|  231840 |  7237 | `	if( pMeth == 0 ){` |
...
|  231840 |  7242 | `	pGen->pIn++;` |
|  231840 |  7243 | `	pEnd = 0; /* cc warning */` |
|       - |  7244 | `	/* Delimit the method signature */` |
|  231840 |  7245 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|  231840 |  7246 | `	if( pEnd >= pGen->pEnd ){` |
|       - |  7247 | `		/* Syntax error */` |
...
|       - |  7254 | `	}` |
|       - |  7255 | `	{` |
|  231838 |  7256 | `		int bIsCtor = 0;` |
|  231838 |  7257 | `		int bAbstractCtor = 0;` |
|  338340 |  7258 | `		if( (pName->nByte == sizeof("__construct") - 1` |
|  137853 |  7259 | `				&& SyMemcmp(pName->zString,"__construct",sizeof("__construct") - 1) == 0)` |
|  222424 |  7260 | `		 \|\| SyStringCmp(pName,&pClass->sName,SyMemcmp) == 0 ){` |
|   18830 |  7261 | `			if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|       3 |  7262 | `				bAbstractCtor = 1;` |
|       2 |  7263 | `			}else{` |
|   18828 |  7264 | `				bIsCtor = 1;` |
|       - |  7265 | `			}` |
|    9414 |  7266 | `		}` |
|  231838 |  7267 | `		if( pGen->pIn < pEnd ){` |
|       - |  7268 | `			/* Collect method arguments */` |
|   53400 |  7269 | `			rc = GenStateCollectFuncArgs(&pMeth->sFunc,&(*pGen),pEnd,bIsCtor,bAbstractCtor);` |
|   53400 |  7270 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  7271 | `				return SXERR_ABORT;` |
|       - |  7272 | `			}` |
|   26699 |  7273 | `		}` |
|       - |  7274 | `	}` |
|       - |  7275 | `	/* Point past ')' and parse optional return type ': type' */` |
|  231838 |  7276 | `	pGen->pIn = &pEnd[1];` |
|       - |  7277 | `	{` |
|  231838 |  7278 | `		sxi32 rcRt = GenStateParseReturnType(pGen, &pMeth->sFunc);` |
|  231838 |  7279 | `		if( rcRt == SXERR_ABORT ){` |
|     ! 0 |  7280 | `			return SXERR_ABORT;` |
|  231838 |  7281 | `		}else if( rcRt == SXERR_SYNTAX ){` |
...
|       - |  7288 | `	{` |
|  231838 |  7289 | `		sxu32 nArg = SySetUsed(&pMeth->sFunc.aArgs);` |
|       - |  7290 | `		sxu32 i;` |
|  316542 |  7291 | `		for( i = 0; i < nArg; i++ ){` |
|   84714 |  7292 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pMeth->sFunc.aArgs,i);` |
|       - |  7293 | `			ph7_class_attr *pAttr;` |
|   84714 |  7294 | `			sxi32 iAttrFlags = 0;` |
|   84714 |  7295 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|   84678 |  7296 | `				continue;` |
|       - |  7297 | `			}` |
|      38 |  7298 | `			if( pArg->iFlags & VM_FUNC_ARG_VARIADIC ){` |
...
|      34 |  7309 | `			if( pArg->nType > 0 \|\| SyStringLength(&pArg->sClass) > 0` |
|       6 |  7310 | `			 \|\| (pArg->iFlags & VM_FUNC_ARG_UNION) ){` |
...
|      32 |  7322 | `			if( PH7_ClassExtractAttribute(pClass,SyStringData(&pArg->sName),SyStringLength(&pArg->sName)) != 0 ){` |
...
|       - |  7329 | `			}` |
|      30 |  7330 | `			if( pArg->nType > 0 \|\| SyStringLength(&pArg->sClass) > 0 ){` |
|      28 |  7331 | `				iAttrFlags \|= PH7_CLASS_ATTR_TYPED;` |
|      13 |  7332 | `			}` |
|      30 |  7333 | `			if( pArg->iFlags & VM_FUNC_ARG_NULLABLE ){` |
|       3 |  7334 | `				iAttrFlags \|= PH7_CLASS_ATTR_NULLABLE;` |
|       1 |  7335 | `			}` |
|      30 |  7336 | `			if( pArg->iFlags & VM_FUNC_ARG_UNION ){` |
|       3 |  7337 | `				iAttrFlags \|= PH7_CLASS_ATTR_UNION;` |
|       1 |  7338 | `			}` |
|      30 |  7339 | `			pAttr = PH7_NewClassAttr(pGen->pVm,&pArg->sName,nLine,pArg->iPromoteVis,iAttrFlags);` |
|      30 |  7340 | `			if( pAttr == 0 ){` |
|     ! 0 |  7341 | `				PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|     ! 0 |  7342 | `				return SXERR_ABORT;` |
|       - |  7343 | `			}` |
|      30 |  7344 | `			if( iAttrFlags & PH7_CLASS_ATTR_TYPED ){` |
...
|     ! 0 |  7354 | `				}` |
|      13 |  7355 | `			}` |
|      30 |  7356 | `			rc = PH7_ClassInstallAttr(pClass,pAttr);` |
|      30 |  7357 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  7358 | `				PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|     ! 0 |  7359 | `				return SXERR_ABORT;` |
|       - |  7360 | `			}` |
|      16 |  7361 | `		}` |
|       - |  7362 | `	}` |
|  231830 |  7363 | `	if( doBody ){` |
|       - |  7364 | `		/* Compile method body */` |
|  153728 |  7365 | `		rc = GenStateCompileFuncBody(&(*pGen),&pMeth->sFunc);` |
|  153728 |  7366 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  7367 | `			return SXERR_ABORT;` |
|       - |  7368 | `		}` |
|   76865 |  7369 | `	}else{` |
|       - |  7370 | `		/* Only method signature is allowed */` |
|   78104 |  7371 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI /* ';'*/) == 0 ){` |
...
|       - |  7404 | ` */` |
|   31264 |  7405 | `static sxi32 PH7_CompileClassInterface(ph7_gen_state *pGen)` |
|       2 |  7406 |  |
|   31266 |  7407 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|   31266 |  7416 | `	pName = &pGen->pIn->sData;` |
|       - |  7417 | `	/* Advance the stream cursor */` |
|   31266 |  7418 | `	pGen->pIn++;` |
|       - |  7419 | `	/* Build FQN and obtain a raw class */ {` |
|       - |  7420 | `		SyBlob sFQN;` |
|       - |  7421 | `		SyString sFQNStr;` |
|   31266 |  7422 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|   31266 |  7423 | `		GenStateBuildFQN(pGen,pName,&sFQN);` |
|   31266 |  7424 | `		SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|   31266 |  7425 | `		pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|   31266 |  7426 | `		SyBlobRelease(&sFQN);` |
|       - |  7427 | `	}` |
|   31266 |  7428 | `	if( pClass == 0 ){` |
...
|   31266 |  7433 | `	pClass->iFlags = PH7_CLASS_INTERFACE;` |
|       - |  7434 | `	/* Assume no base class is given */` |
|   31266 |  7435 | `	pBase = 0;` |
|   31266 |  7436 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|    9376 |  7437 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    9376 |  7438 | `		if( nKwrd == PH7_TKWRD_EXTENDS /* interface b extends a */ ){` |
|       - |  7439 | `			SyBlob sResolved;` |
|       - |  7440 | `			SyString sBaseName;` |
|       - |  7441 | `			sxu32 nRefLine;` |
|       - |  7442 | `			/* Extract base interface */` |
|    9376 |  7443 | `			pGen->pIn++;` |
|    9376 |  7444 | `			nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|    9376 |  7445 | `			SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|    9376 |  7446 | `			if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|       - |  7456 | `			}` |
|   14063 |  7457 | `			pBase = PH7_VmExtractClass(pGen->pVm,` |
|    9374 |  7458 | `				(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|    9376 |  7459 | `			SyStringInitFromBuf(&sBaseName,` |
|       - |  7460 | `				(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|       - |  7461 | `			/* Only interfaces is allowed */` |
|    9376 |  7462 | `			while( pBase && (pBase->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|     ! 0 |  7463 | `				pBase = pBase->pNextName;` |
|     ! 0 |  7464 | `			}` |
|    9376 |  7465 | `			if( pBase == 0 ){` |
...
|       - |  7471 | `				}` |
|     ! 0 |  7472 | `			}` |
|    9376 |  7473 | `			SyBlobRelease(&sResolved);` |
|    4687 |  7474 | `		}` |
|    4687 |  7475 | `	}` |
|   31266 |  7476 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|       - |  7477 | `		/* Syntax error */` |
...
|       - |  7485 | `	}` |
|   31266 |  7486 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|   31266 |  7487 | `	pEnd = 0; /* cc warning */` |
|       - |  7488 | `	/* Delimit the interface body */` |
|   31266 |  7489 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|   31266 |  7490 | `	if( pEnd >= pGen->pEnd ){` |
|       - |  7491 | `		/* Syntax error */` |
...
|   31266 |  7501 | `	pTmp = pGen->pEnd;` |
|   31266 |  7502 | `	pGen->pEnd = pEnd;` |
...
|  187446 |  7510 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|   78092 |  7511 | `			pGen->pIn++;` |
|       2 |  7512 | `		}` |
|  109356 |  7513 | `		if( pGen->pIn >= pGen->pEnd ){` |
|       - |  7514 | `			/* End of interface body */` |
|   31264 |  7515 | `			break;` |
|       - |  7516 | `		}` |
|   78094 |  7517 | `		if( (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|   78094 |  7528 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   78094 |  7529 | `		if( nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
...
|       3 |  7558 | `			goto done;` |
|       - |  7559 | `		}` |
|   78092 |  7560 | `		if( nKwrd != PH7_TKWRD_PUBLIC && nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|     ! 0 |  7567 | `			goto done;` |
|       - |  7568 | `		}` |
|   78092 |  7569 | `		if( nKwrd == PH7_TKWRD_PUBLIC ){` |
|       - |  7570 | `			/* Advance the stream cursor */` |
|   78088 |  7571 | `			pGen->pIn++;` |
|   78088 |  7572 | `			if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|     ! 0 |  7579 | `				goto done;` |
|       - |  7580 | `			}` |
|   78088 |  7581 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   78088 |  7582 | `			if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|       - |  7590 | `			}` |
|   39043 |  7591 | `		}` |
|   78092 |  7592 | `		if( nKwrd == PH7_TKWRD_CONST ){` |
|       - |  7593 | `			/* Parse constant */` |
...
|       - |  7600 | `			}` |
|       2 |  7601 | `		}else{` |
|   78090 |  7602 | `			sxi32 iFlags = PH7_CLASS_ATTR_ABSTRACT; /* Interface methods are implicitly abstract */` |
|   78090 |  7603 | `			if( nKwrd == PH7_TKWRD_STATIC ){` |
|       - |  7604 | `				/* Static method,record that */` |
|    9368 |  7605 | `				iFlags \|= PH7_CLASS_ATTR_STATIC;` |
|       - |  7606 | `				/* Advance the stream cursor */` |
|    9368 |  7607 | `				pGen->pIn++;` |
|    9366 |  7608 | `				if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0` |
|    9368 |  7609 | `					\|\| SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_FUNCTION ){` |
...
|   78090 |  7620 | `			rc = GenStateCompileClassMethod(&(*pGen),0,iFlags,FALSE,pClass);` |
|   78090 |  7621 | `			if( rc != SXRET_OK ){` |
...
|   31264 |  7630 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|   31264 |  7631 | `	if( rc == SXRET_OK && pBase ){` |
|       - |  7632 | `		/* Inherit from the base interface */` |
|    9376 |  7633 | `		rc = PH7_ClassInterfaceInherit(pClass,pBase);` |
|    4687 |  7634 | `	}` |
|   31264 |  7635 | `	if( rc != SXRET_OK ){` |
...
|   31266 |  7641 | `	pGen->pIn  = &pEnd[1];` |
|   31266 |  7642 | `	pGen->pEnd = pTmp;` |
|   31266 |  7643 | `	return PH7_OK;` |
|   15634 |  7644 |  |
|       - |  7645 | `/*` |
...
|       - |  7669 | ` */` |
|   44590 |  7670 | `static sxi32 GenStateCheckInterfaceSignatures(ph7_gen_state *pGen,ph7_class *pClass)` |
|       2 |  7671 |  |
|       - |  7672 | `	ph7_class **apIface;` |
|       - |  7673 | `	sxu32 nIface,i;` |
|       - |  7674 | `	sxi32 rc;` |
|   44592 |  7675 | `	if( pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|     ! 0 |  7676 | `		return SXRET_OK;` |
|       - |  7677 | `	}` |
|   44592 |  7678 | `	apIface = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|   44592 |  7679 | `	nIface = SySetUsed(&pClass->aInterface);` |
|   88476 |  7680 | `	for(i = 0; i < nIface; i++){` |
|   43886 |  7681 | `		ph7_class *pIface = apIface[i];` |
|       - |  7682 | `		SyHashEntry *pEntry;` |
|   43886 |  7683 | `		SyHashResetLoopCursor(&pIface->hMethod);` |
|  144160 |  7684 | `		while((pEntry = SyHashGetNextEntry(&pIface->hMethod)) != 0 ){` |
|  100276 |  7685 | `			ph7_class_method *pIfaceMeth = (ph7_class_method *)pEntry->pUserData;` |
|       - |  7686 | `			ph7_class_method *pImplMeth;` |
|  100276 |  7687 | `			SyString *pMName = &pIfaceMeth->sFunc.sName;` |
|       - |  7688 | `			/* Find the implementing method in the class */` |
|  100276 |  7689 | `			pImplMeth = PH7_ClassExtractMethod(pClass,pMName->zString,pMName->nByte);` |
|  100276 |  7690 | `			if( pImplMeth == 0 \|\| (pImplMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT) ){` |
...
|  100262 |  7694 | `			if( pImplMeth->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|       - |  7704 | `			 */` |
|       - |  7705 | `			{` |
|  100262 |  7706 | `				sxu32 nIfaceArgs = SySetUsed(&pIfaceMeth->sFunc.aArgs);` |
|  100262 |  7707 | `				sxu32 nImplArgs = SySetUsed(&pImplMeth->sFunc.aArgs);` |
|  100262 |  7708 | `				int sigError = 0;` |
|  100262 |  7709 | `				if( nImplArgs < nIfaceArgs ){` |
|       3 |  7710 | `					sigError = 1;` |
|  100261 |  7711 | `				}else if( nImplArgs > nIfaceArgs ){` |
...
|       - |  7762 | ` */` |
|   44590 |  7763 | `static sxi32 GenStateCheckAbstractMethods(ph7_gen_state *pGen,ph7_class *pClass)` |
|       2 |  7764 |  |
...
|   44592 |  7771 | `	if( pClass->iFlags & (PH7_CLASS_ABSTRACT\|PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|      24 |  7772 | `		return SXRET_OK;` |
|       - |  7773 | `	}` |
|       - |  7774 | `	/* Count abstract methods */` |
|   44570 |  7775 | `	nAbstract = 0;` |
|   44570 |  7776 | `	SyHashResetLoopCursor(&pClass->hMethod);` |
|  420534 |  7777 | `	while((pEntry = SyHashGetNextEntry(&pClass->hMethod)) != 0 ){` |
|  375966 |  7778 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|  375966 |  7779 | `		if( pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|      17 |  7780 | `			nAbstract++;` |
|       8 |  7781 | `		}` |
|       2 |  7782 | `	}` |
|   44570 |  7783 | `	if( nAbstract == 0 ){` |
|   44556 |  7784 | `		return SXRET_OK;` |
|       - |  7785 | `	}` |
...
|       - |  7918 | ` */` |
|   44288 |  7919 | `static sxi32 GenStateParseClassReference(ph7_gen_state *pGen,SyBlob *pFqn)` |
|       2 |  7920 |  |
|   44290 |  7921 | `	int isAbsolute = 0;` |
|   44290 |  7922 | `	SyToken *pStart = pGen->pIn;` |
|       - |  7923 | `	SyBlob sName;` |
|   44290 |  7924 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) ){` |
|      30 |  7925 | `		isAbsolute = 1;` |
|      30 |  7926 | `		pGen->pIn++;` |
|      14 |  7927 | `	}` |
|   44290 |  7928 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|       7 |  7929 | `		pGen->pIn = pStart;` |
|       7 |  7930 | `		return SXERR_INVALID;` |
|       - |  7931 | `	}` |
|   44284 |  7932 | `	SyBlobInit(&sName,&pGen->pVm->sAllocator);` |
|   44284 |  7933 | `	SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|   44284 |  7934 | `	pGen->pIn++;` |
|   66441 |  7935 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) &&` |
|   22161 |  7936 | `		&pGen->pIn[1] < pGen->pEnd && (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|      13 |  7937 | `		SyBlobAppend(&sName,"\\",1);` |
|      13 |  7938 | `		pGen->pIn++;` |
|      13 |  7939 | `		SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|      13 |  7940 | `		pGen->pIn++;` |
|       1 |  7941 | `	}` |
|   44284 |  7942 | `	if( isAbsolute ){` |
|      28 |  7943 | `		SyBlobAppend(pFqn,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|      15 |  7944 | `	}else{` |
|       - |  7945 | `		SyString sRaw;` |
|   44258 |  7946 | `		SyStringInitFromBuf(&sRaw,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|   44258 |  7947 | `		GenStateResolveName(pGen,&sRaw,pFqn);` |
|       - |  7948 | `	}` |
|   44284 |  7949 | `	SyBlobRelease(&sName);` |
|   44284 |  7950 | `	return SXRET_OK;` |
|   22146 |  7951 |  |
|       - |  7952 | `/*` |
...
|    9468 |  7960 | `static int GenStateInterfaceIsThrowableAt(ph7_class *pInterface,int iDepth)` |
|       2 |  7961 |  |
|       - |  7962 | `	ph7_class **apParent;` |
|       - |  7963 | `	sxu32 n;` |
|   15832 |  7964 | `	while( pInterface ){` |
|   12618 |  7965 | `		if( iDepth > PH7_THROWABLE_WALK_MAX_DEPTH ){` |
|     ! 0 |  7966 | `			return FALSE;` |
|       - |  7967 | `		}` |
|   15752 |  7968 | `		if( pInterface->sName.nByte == sizeof("Throwable")-1 &&` |
|    6268 |  7969 | `			SyMemcmp(pInterface->sName.zString,"Throwable",sizeof("Throwable")-1) == 0 ){` |
|    6256 |  7970 | `			return TRUE;` |
|       - |  7971 | `		}` |
|    6364 |  7972 | `		apParent = (ph7_class **)SySetBasePtr(&pInterface->aInterface);` |
|    6364 |  7973 | `		for( n = 0 ; n < SySetUsed(&pInterface->aInterface) ; ++n ){` |
|     ! 0 |  7974 | `			if( GenStateInterfaceIsThrowableAt(apParent[n],iDepth+1) ){` |
|     ! 0 |  7975 | `				return TRUE;` |
|       - |  7976 | `			}` |
|     ! 0 |  7977 | `		}` |
|    6364 |  7978 | `		pInterface = pInterface->pBase;` |
|    6364 |  7979 | `		iDepth++;` |
|       2 |  7980 | `	}` |
|    3216 |  7981 | `	return FALSE;` |
|    4736 |  7982 |  |
|    9468 |  7983 | `static int GenStateInterfaceIsThrowable(ph7_class *pInterface)` |
|       2 |  7984 |  |
|    9470 |  7985 | `	return GenStateInterfaceIsThrowableAt(pInterface,0);` |
|       2 |  7986 |  |
|       - |  7987 | `/*` |
...
|       - |  7991 | ` */` |
|    6254 |  7992 | `static int GenStateClassIsExceptionOrError(ph7_class *pBase)` |
|       2 |  7993 |  |
|    6260 |  7994 | `	while( pBase ){` |
...
|       1 |  8004 | `	}` |
|    6252 |  8005 | `	return FALSE;` |
|    3129 |  8006 |  |
|   44606 |  8007 | `static sxi32 GenStateCompileClass(ph7_gen_state *pGen,sxi32 iFlags)` |
|       2 |  8008 |  |
|   44608 |  8009 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|   44608 |  8020 | `	pGen->pIn++;` |
|   44608 |  8021 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
|       - |  8022 | `		/* Syntax error */` |
...
|   44608 |  8035 | `	pName = &pGen->pIn->sData;` |
|       - |  8036 | `	/* Advance the stream cursor */` |
|   44608 |  8037 | `	pGen->pIn++;` |
|       - |  8038 | `	/* Build FQN and obtain a raw class */ {` |
|       - |  8039 | `		SyBlob sFQN;` |
|       - |  8040 | `		SyString sFQNStr;` |
|   44608 |  8041 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|   44608 |  8042 | `		GenStateBuildFQN(pGen,pName,&sFQN);` |
|   44608 |  8043 | `		SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|   44608 |  8044 | `		pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|   44608 |  8045 | `		SyBlobRelease(&sFQN);` |
|       - |  8046 | `	}` |
|   44608 |  8047 | `	if( pClass == 0 ){` |
...
|   44608 |  8052 | `	SySetInit(&aInterfaces,&pGen->pVm->sAllocator,sizeof(ph7_class *));` |
|   44608 |  8053 | `	SySetInit(&aUseEntries,&pGen->pVm->sAllocator,sizeof(TraitUseEntry));` |
|       - |  8054 | `	/* Assume a standalone class */` |
|   44608 |  8055 | `	pBase = 0;` |
|   44608 |  8056 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|   34584 |  8057 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   34584 |  8058 | `		if( nKwrd == PH7_TKWRD_EXTENDS /* class b extends a */ ){` |
|       - |  8059 | `			SyBlob sResolved;` |
|       - |  8060 | `			SyString sBaseName;` |
|       - |  8061 | `			sxu32 nRefLine;` |
|   25122 |  8062 | `			pGen->pIn++; /* Advance past 'extends' */` |
|   25122 |  8063 | `			nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|   25122 |  8064 | `			SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|   25122 |  8065 | `			if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|       - |  8075 | `			}` |
|   37679 |  8076 | `			pBase = PH7_VmExtractClass(pGen->pVm,` |
|   25118 |  8077 | `				(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|   25120 |  8078 | `			SyStringInitFromBuf(&sBaseName,` |
|       - |  8079 | `				(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|       - |  8080 | `			/* Interfaces are not allowed */` |
|   25120 |  8081 | `			while( pBase && (pBase->iFlags & PH7_CLASS_INTERFACE) ){` |
|     ! 0 |  8082 | `				pBase = pBase->pNextName;` |
|     ! 0 |  8083 | `			}` |
|   25120 |  8084 | `			if( pBase == 0 ){` |
...
|       - |  8090 | `				}` |
|     ! 0 |  8091 | `			}else{` |
|   25120 |  8092 | `				if( pBase->iFlags & PH7_CLASS_FINAL ){` |
...
|     ! 0 |  8099 | `				}` |
|       - |  8100 | `			}` |
|   25120 |  8101 | `			SyBlobRelease(&sResolved);` |
|   12559 |  8102 | `		}` |
|   34582 |  8103 | `		if (pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) && SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_IMPLEMENTS ){` |
|       - |  8104 | `			ph7_class *pInterface;` |
|       - |  8105 | `			/* Interface implementation */` |
|    9470 |  8106 | `			pGen->pIn++; /* Advance the stream cursor */` |
|    4734 |  8107 | `			for(;;){` |
|       - |  8108 | `				SyBlob sResolved;` |
|       - |  8109 | `				SyString sIntName;` |
|       - |  8110 | `				sxu32 nRefLine;` |
|    9470 |  8111 | `				nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|    9470 |  8112 | `				SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|    9470 |  8113 | `				if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|     ! 0 |  8121 | `					break;` |
|       - |  8122 | `				}` |
|   18938 |  8123 | `				pInterface = PH7_VmExtractClass(pGen->pVm,` |
|    9468 |  8124 | `					(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|    9470 |  8125 | `				SyStringInitFromBuf(&sIntName,` |
|       - |  8126 | `					(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|       - |  8127 | `				/* Only interfaces are allowed */` |
|    9470 |  8128 | `				while( pInterface && (pInterface->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|     ! 0 |  8129 | `					pInterface = pInterface->pNextName;` |
|     ! 0 |  8130 | `				}` |
|    9470 |  8131 | `				if( pInterface == 0 ){` |
...
|    9470 |  8145 | `					SyString *pFqn = &pClass->sName;` |
|    9470 |  8146 | `					int bIsExceptionOrError =` |
|    7858 |  8147 | `						(pFqn->nByte == sizeof("Exception")-1 &&` |
|   15765 |  8148 | `						 SyMemcmp(pFqn->zString,"Exception",sizeof("Exception")-1) == 0) \|\|` |
|    7912 |  8149 | `						(pFqn->nByte == sizeof("Error")-1 &&` |
|    3132 |  8150 | `						 SyMemcmp(pFqn->zString,"Error",sizeof("Error")-1) == 0);` |
|   15720 |  8151 | `					if( GenStateInterfaceIsThrowable(pInterface) &&` |
|    9381 |  8152 | `						!GenStateClassIsExceptionOrError(pBase) &&` |
|    3125 |  8153 | `						!bIsExceptionOrError ){` |
...
|       4 |  8163 | `					}else{` |
|    9464 |  8164 | `						SySetPut(&aInterfaces,(const void *)&pInterface);` |
|       - |  8165 | `					}` |
|       - |  8166 | `				}` |
|    9470 |  8167 | `				SyBlobRelease(&sResolved);` |
|    9470 |  8168 | `				if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COMMA) == 0 ){` |
|    4736 |  8169 | `					break;` |
|       - |  8170 | `				}` |
...
|    4734 |  8173 | `		}` |
|   17290 |  8174 | `	}` |
|   44606 |  8175 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|       - |  8176 | `		/* Syntax error */` |
...
|       - |  8184 | `	}` |
|   44606 |  8185 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|   44606 |  8186 | `	pEnd = 0; /* cc warning */` |
|       - |  8187 | `	/* Delimit the class body */` |
|   44606 |  8188 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|   44606 |  8189 | `	if( pEnd >= pGen->pEnd ){` |
|       - |  8190 | `		/* Syntax error */` |
...
|   44606 |  8200 | `	pTmp = pGen->pEnd;` |
|   44606 |  8201 | `	pGen->pEnd = pEnd;` |
|       - |  8202 | `	/* Set the inherited flags */` |
|   44606 |  8203 | `	pClass->iFlags = iFlags;` |
|       - |  8204 | `	/* Start the parse process */` |
|   99161 |  8205 | `	for(;;){` |
|       - |  8206 | `		/* Jump leading/trailing semi-colons */` |
|  317988 |  8207 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|   59852 |  8208 | `			pGen->pIn++;` |
|       2 |  8209 | `		}` |
|  258138 |  8210 | `		if( pGen->pIn >= pGen->pEnd ){` |
|       - |  8211 | `			/* End of class body */` |
|   44592 |  8212 | `			break;` |
|       - |  8213 | `		}` |
|  213548 |  8214 | `		if( (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR)) == 0 ){` |
...
|  213548 |  8225 | `		iProtection = PH7_TKWRD_PUBLIC;` |
|  213548 |  8226 | `		iAttrflags = 0;` |
|  213548 |  8227 | `		if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|       - |  8228 | `			/* Extract the current keyword */` |
|  213548 |  8229 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  213548 |  8230 | `			if( nKwrd == PH7_TKWRD_USE ){` |
...
|      46 |  8290 | `				continue;` |
|       - |  8291 | `			}` |
|  213504 |  8292 | `			if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|  210262 |  8293 | `				iProtection = nKwrd;` |
|  210262 |  8294 | `				pGen->pIn++; /* Jump the visibility token */` |
|  210260 |  8295 | `				if( pGen->pIn >= pGen->pEnd` |
|  210262 |  8296 | `					\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP)) == 0 ){` |
...
|     ! 0 |  8304 | `					goto done;` |
|       - |  8305 | `				}` |
|  210262 |  8306 | `				if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|       - |  8307 | `					/* Attribute declaration (untyped) */` |
|   59650 |  8308 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|   59650 |  8309 | `					if( rc != SXRET_OK ){` |
...
|   59648 |  8315 | `					continue;` |
|       - |  8316 | `				}` |
|  150614 |  8317 | `				if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
|       - |  8318 | `					/* Typed attribute declaration (PHP 7.4+) */` |
|     116 |  8319 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|     116 |  8320 | `					if( rc != SXRET_OK ){` |
...
|  150500 |  8329 | `				nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   75249 |  8330 | `			}` |
|  153742 |  8331 | `			if( nKwrd == PH7_TKWRD_CONST ){` |
|       - |  8332 | `				/* Process constant declaration */` |
|      30 |  8333 | `				rc = GenStateCompileClassConstant(&(*pGen),iProtection,iAttrflags,pClass);` |
|      30 |  8334 | `				if( rc != SXRET_OK ){` |
...
|       - |  8339 | `				}` |
|      16 |  8340 | `			}else{` |
|  153714 |  8341 | `				if( nKwrd == PH7_TKWRD_STATIC ){` |
|       - |  8342 | `					/* Static method or attribute,record that */` |
|    3162 |  8343 | `					iAttrflags \|= PH7_CLASS_ATTR_STATIC;` |
|    3162 |  8344 | `					pGen->pIn++; /* Jump the static keyword */` |
|    3162 |  8345 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|       - |  8346 | `						/* Extract the keyword */` |
|    3156 |  8347 | `						nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    3156 |  8348 | `						if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|     ! 0 |  8349 | `							iProtection = nKwrd;` |
|     ! 0 |  8350 | `							pGen->pIn++; /* Jump the visibility token */` |
|     ! 0 |  8351 | `						}` |
|    1577 |  8352 | `					}` |
|    3160 |  8353 | `					if( pGen->pIn >= pGen->pEnd` |
|    3162 |  8354 | `						\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP)) == 0 ){` |
...
|     ! 0 |  8362 | `						goto done;` |
|       - |  8363 | `					}` |
|    3162 |  8364 | `					if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
...
|       5 |  8373 | `						continue;` |
|       - |  8374 | `					}` |
|    3158 |  8375 | `					if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
|       - |  8376 | `						/* Typed static attribute declaration */` |
|      10 |  8377 | `						rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|      10 |  8378 | `						if( rc != SXRET_OK ){` |
...
|    3150 |  8387 | `					nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  152128 |  8388 | `				}else if( nKwrd == PH7_TKWRD_ABSTRACT ){` |
...
|  150549 |  8420 | `				}else if( nKwrd == PH7_TKWRD_FINAL ){` |
...
|       2 |  8450 | `				}` |
|  153702 |  8451 | `				if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_VAR ){` |
...
|     ! 0 |  8459 | `						goto done;` |
|       - |  8460 | `				}` |
|  153702 |  8461 | `				if( nKwrd == PH7_TKWRD_VAR ){` |
...
|  153696 |  8476 | `					rc = GenStateCompileClassMethod(&(*pGen),iProtection,iAttrflags,TRUE,pClass);` |
|       - |  8477 | `				}` |
|  153702 |  8478 | `				if( rc != SXRET_OK ){` |
...
|       - |  8501 | `		sxu32 nU;` |
|   44592 |  8502 | `		apUse = (TraitUseEntry *)SySetBasePtr(&aUseEntries);` |
|   44636 |  8503 | `		for( nU = 0 ; nU < SySetUsed(&aUseEntries) ; nU++ ){` |
...
|   44592 |  8711 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|   44592 |  8712 | `	if( rc == SXRET_OK ){` |
|       - |  8713 | `		ph7_class **apInterface;` |
|       - |  8714 | `		sxu32 n;` |
|   44592 |  8715 | `		if( pBase ){` |
|       - |  8716 | `			/* Inherit from base class and mark as a subclass */` |
|   25120 |  8717 | `			rc = PH7_ClassInherit(&(*pGen),pClass,pBase);` |
|   12559 |  8718 | `		}` |
|   44592 |  8719 | `		apInterface = (ph7_class **)SySetBasePtr(&aInterfaces);` |
|   54054 |  8720 | `		for( n = 0 ; n < SySetUsed(&aInterfaces) ; n++ ){` |
|       - |  8721 | `			/* Implements one or more interface */` |
|    9464 |  8722 | `			rc = PH7_ClassImplement(pClass,apInterface[n]);` |
|    9464 |  8723 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  8724 | `				break;` |
|       - |  8725 | `			}` |
|    4733 |  8726 | `		}` |
...
|   66885 |  8729 | `		if( rc == SXRET_OK` |
|   44590 |  8730 | `		 && (pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT)) == 0` |
|   44592 |  8731 | `		 && SyHashGet(&pClass->hMethod,"__toString",sizeof("__toString")-1) != 0 ){` |
|   34426 |  8732 | `			ph7_class *pStringable = PH7_VmExtractClass(pGen->pVm,` |
|       - |  8733 | `				"Stringable",sizeof("Stringable")-1,FALSE,0);` |
|   34426 |  8734 | `			if( pStringable ){` |
|   34426 |  8735 | `				ph7_class **apImpl = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|   34426 |  8736 | `				sxu32 nImpl = SySetUsed(&pClass->aInterface);` |
|       - |  8737 | `				sxu32 i;` |
|   34426 |  8738 | `				int bAlready = 0;` |
|   40674 |  8739 | `				for( i = 0 ; i < nImpl ; i++ ){` |
|    6252 |  8740 | `					if( apImpl[i] == pStringable ){` |
|       3 |  8741 | `						bAlready = 1;` |
|       3 |  8742 | `						break;` |
|       - |  8743 | `					}` |
|    3126 |  8744 | `				}` |
|   34426 |  8745 | `				if( !bAlready ){` |
|   34424 |  8746 | `					PH7_ClassImplement(pClass,pStringable);` |
|   17211 |  8747 | `				}` |
|   17212 |  8748 | `			}` |
|   17212 |  8749 | `		}` |
|       - |  8750 | `		/* Validate interface method signatures (visibility and parameter count) */` |
|   44592 |  8751 | `		if( rc == SXRET_OK ){` |
|   44592 |  8752 | `			sxi32 rcCheck = GenStateCheckInterfaceSignatures(&(*pGen),pClass);` |
|   44592 |  8753 | `			if( rcCheck == SXERR_ABORT ){` |
...
|   44592 |  8760 | `		if( rc == SXRET_OK ){` |
|   44592 |  8761 | `			sxi32 rcCheck = GenStateCheckAbstractMethods(&(*pGen),pClass);` |
|   44592 |  8762 | `			if( rcCheck == SXERR_ABORT ){` |
...
|   22295 |  8767 | `		}` |
|   22295 |  8768 | `	}` |
|   44592 |  8769 | `	SySetRelease(&aUseEntries);` |
|   44592 |  8770 | `	SySetRelease(&aInterfaces);` |
|   44592 |  8771 | `	if( rc != SXRET_OK ){` |
...
|   44606 |  8777 | `	pGen->pIn = &pEnd[1];` |
|   44606 |  8778 | `	pGen->pEnd = pTmp;` |
|   44606 |  8779 | `	return PH7_OK;` |
|   22305 |  8780 |  |
|       - |  8781 | `/*` |
...
|       - |  9117 | ` */` |
|   44584 |  9118 | `static sxi32 PH7_CompileClass(ph7_gen_state *pGen)` |
|       2 |  9119 |  |
|       - |  9120 | `	sxi32 rc;` |
|   44586 |  9121 | `	rc = GenStateCompileClass(&(*pGen),0);` |
|   44586 |  9122 | `	return rc;` |
|       2 |  9123 |  |
|       - |  9124 | `/*` |
...
|       - |  9145 | ` */` |
|    9486 |  9146 | `static sxi32 GenStateThrowNodeValidator(ph7_gen_state *pGen,ph7_expr_node *pRoot)` |
|       2 |  9147 |  |
|    9488 |  9148 | `	sxi32 rc = SXRET_OK;` |
|    9488 |  9149 | `	if( pRoot->pOp ){` |
|    9480 |  9150 | `		switch( pRoot->pOp->iOp ){` |
|    4739 |  9151 | `		case EXPR_OP_NEW:            /* new Exception() */` |
...
|     ! 0 |  9167 | `			break;` |
|       - |  9168 | `		}` |
|    4749 |  9169 | `	}else if( pRoot->xCode != PH7_CompileVariable ){` |
...
|       - |  9183 | ` */` |
|    9450 |  9184 | `static sxi32 PH7_CompileThrow(ph7_gen_state *pGen)` |
|       2 |  9185 |  |
|    9452 |  9186 | `	sxu32 nLine = pGen->pIn->nLine;` |
|       - |  9187 | `	GenBlock *pBlock;` |
|       - |  9188 | `	sxu32 nIdx;` |
|       - |  9189 | `	sxi32 rc;` |
|    9452 |  9190 | `	pGen->pIn++; /* Jump the 'throw' keyword */` |
|       - |  9191 | `	/* Compile the expression */` |
|    9452 |  9192 | `	rc = PH7_CompileExpr(&(*pGen),0,GenStateThrowNodeValidator);` |
|    9452 |  9193 | `	if( rc == SXERR_EMPTY ){` |
...
|       - |  9199 | `	}` |
|    9452 |  9200 | `	pBlock = pGen->pCurrent;` |
|       - |  9201 | `	/* Point to the top most function or try block and emit the forward jump */` |
|   43878 |  9202 | `	while(pBlock->pParent){` |
|   43874 |  9203 | `		if( pBlock->iFlags & (GEN_BLOCK_EXCEPTION\|GEN_BLOCK_FUNC) ){` |
|    9448 |  9204 | `			break;` |
|       - |  9205 | `		}` |
|       - |  9206 | `		/* Point to the parent block */` |
|   34428 |  9207 | `		pBlock = pBlock->pParent;` |
|       2 |  9208 | `	}` |
|       - |  9209 | `	/* Emit the throw instruction */` |
|    9452 |  9210 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_THROW,0,0,0,&nIdx);` |
|       - |  9211 | `	/* Emit the jump */` |
|    9452 |  9212 | `	GenStateNewJumpFixup(pBlock,PH7_OP_THROW,nIdx);` |
|    9452 |  9213 | `	return SXRET_OK;` |
|    4727 |  9214 |  |
|       - |  9215 | `/*` |
...
|       - |  9266 | ` */` |
|     300 |  9267 | `static sxi32 PH7_CompileCatch(ph7_gen_state *pGen,ph7_exception *pException)` |
|       2 |  9268 |  |
|     302 |  9269 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|       - |  9276 | `	char *zDup;` |
|       - |  9277 | `	sxi32 rc;` |
|     302 |  9278 | `	pGen->pIn++; /* Jump the 'catch' keyword */` |
|       - |  9279 | `	/* Zero the structure */` |
|     302 |  9280 | `	SyZero(&sCatch,sizeof(ph7_exception_block));` |
|       - |  9281 | `	/* Initialize fields */` |
|     302 |  9282 | `	SySetInit(&sCatch.aClasses,&pException->pVm->sAllocator,sizeof(SyString));` |
|     302 |  9283 | `	SySetInit(&sCatch.sByteCode,&pException->pVm->sAllocator,sizeof(VmInstr));` |
|     302 |  9284 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 /*(*/ ){` |
...
|     302 |  9299 | `	pGen->pIn++; /* Jump the left parenthesis '(' */` |
|     163 |  9300 | `	for(;;){` |
|       - |  9301 | `		SyBlob sResolved;` |
|     328 |  9302 | `		SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|     328 |  9303 | `		if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|     485 |  9319 | `		zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|     322 |  9320 | `			(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|     324 |  9321 | `		SyStringInitFromBuf(&sClassName,zDup,SyBlobLength(&sResolved));` |
|     324 |  9322 | `		SyBlobRelease(&sResolved);` |
|     324 |  9323 | `		if( zDup == 0 ){` |
|     ! 0 |  9324 | `			goto Mem;` |
|       - |  9325 | `		}` |
|     324 |  9326 | `		rc = SySetPut(&sCatch.aClasses,(const void *)&sClassName);` |
|     324 |  9327 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  9328 | `			goto Mem;` |
|       - |  9329 | `		}` |
|       - |  9330 | `		/* Check for '\|' (multi-catch separator) */` |
|     335 |  9331 | `		if( pGen->pIn < pGen->pEnd &&` |
|     322 |  9332 | `			(pGen->pIn->nType & PH7_TK_OP) &&` |
...
|     298 |  9338 | `		break;` |
|     ! 0 |  9339 | `	}` |
|     444 |  9340 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 /*$*/ \|\|` |
|     298 |  9341 | `		&pGen->pIn[1] >= pGen->pEnd \|\| (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|       - |  9354 | `	}` |
|     298 |  9355 | `	pGen->pIn++; /* Jump the dollar sign */` |
|       - |  9356 | `	/* Duplicate instance name */` |
|     298 |  9357 | `	pName = &pGen->pIn->sData;` |
|     298 |  9358 | `	zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|     298 |  9359 | `	if( zDup == 0 ){` |
|     ! 0 |  9360 | `		goto Mem;` |
|       - |  9361 | `	}` |
|     298 |  9362 | `	SyStringInitFromBuf(&sCatch.sThis,zDup,pName->nByte);` |
|     298 |  9363 | `	pGen->pIn++;` |
|     298 |  9364 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_RPAREN) == 0 /*)*/ ){` |
...
|     298 |  9379 | `	pGen->pIn++; /* Jump the right parenthesis */` |
|       - |  9380 | `	/* Create the catch block */` |
|     298 |  9381 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_EXCEPTION,PH7_VmInstrLength(pGen->pVm),0,&pCatch);` |
|     298 |  9382 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  9383 | `		return SXERR_ABORT;` |
|       - |  9384 | `	}` |
|       - |  9385 | `	/* Swap bytecode container */` |
|     298 |  9386 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|     298 |  9387 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&sCatch.sByteCode);` |
|       - |  9388 | `	/* Compile the block */` |
|     298 |  9389 | `	PH7_CompileBlock(&(*pGen),0);` |
|       - |  9390 | `	/* Fix forward jumps now the destination is resolved  */` |
|     298 |  9391 | `	GenStateFixJumps(pCatch,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - |  9392 | `	/* Emit the DONE instruction */` |
|     298 |  9393 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|       - |  9394 | `	/* Leave the block */` |
|     298 |  9395 | `	GenStateLeaveBlock(&(*pGen),0);` |
|       - |  9396 | `	/* Restore the default container */` |
|     298 |  9397 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|       - |  9398 | `	/* Install the catch block */` |
|     298 |  9399 | `	rc = SySetPut(&pException->sEntry,(const void *)&sCatch);` |
|     298 |  9400 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  9401 | `		goto Mem;` |
|       - |  9402 | `	}` |
|     298 |  9403 | `	return SXRET_OK;` |
|     ! 0 |  9404 | `Mem:` |
...
|       - |  9413 | ` * is "thrown".` |
|       - |  9414 | ` */` |
|     304 |  9415 | `static sxi32 PH7_CompileTry(ph7_gen_state *pGen)` |
|       2 |  9416 |  |
|       - |  9417 | `	ph7_exception *pException;` |
|     306 |  9418 | `	sxu32 nLine = pGen->pIn->nLine;` |
|       - |  9419 | `	GenBlock *pTry;` |
|       - |  9420 | `	sxu32 nJmpIdx;` |
|       - |  9421 | `	sxi32 rc;` |
|       - |  9422 | `	/* Create the exception container */` |
|     306 |  9423 | `	pException = (ph7_exception *)SyMemBackendAlloc(&pGen->pVm->sAllocator,sizeof(ph7_exception));` |
|     306 |  9424 | `	if( pException == 0 ){` |
...
|     306 |  9430 | `	SyZero(pException,sizeof(ph7_exception));` |
|       - |  9431 | `	/* Initialize fields */` |
|     306 |  9432 | `	SySetInit(&pException->sEntry,&pGen->pVm->sAllocator,sizeof(ph7_exception_block));` |
|     306 |  9433 | `	SySetInit(&pException->sFinally,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|     306 |  9434 | `	pException->iHasFinally = 0;` |
|     306 |  9435 | `	pException->iFinallyDone = 0;` |
|     306 |  9436 | `	pException->pVm = pGen->pVm;` |
|       - |  9437 | `	/* Create the try block */` |
|     306 |  9438 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_EXCEPTION,PH7_VmInstrLength(pGen->pVm),0,&pTry);` |
|     306 |  9439 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  9440 | `		return SXERR_ABORT;` |
|       - |  9441 | `	}` |
|       - |  9442 | `	/* Store exception pointer so break/continue can emit POP_EXCEPTION */` |
|     306 |  9443 | `	pTry->pUserData = pException;` |
|       - |  9444 | `	/* Emit the 'LOAD_EXCEPTION' instruction */` |
|     306 |  9445 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_EXCEPTION,0,0,pException,&nJmpIdx);` |
|       - |  9446 | `	/* Fix the jump later when the destination is resolved */` |
|     306 |  9447 | `	GenStateNewJumpFixup(pTry,PH7_OP_LOAD_EXCEPTION,nJmpIdx);` |
|     306 |  9448 | `	pGen->pIn++; /* Jump the 'try' keyword */` |
|       - |  9449 | `	/* Compile the block */` |
|     306 |  9450 | `	rc = PH7_CompileBlock(&(*pGen),0);` |
|     306 |  9451 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  9452 | `		return SXERR_ABORT;` |
|       - |  9453 | `	}` |
|       - |  9454 | `	/* Fix forward jumps now the destination is resolved */` |
|     306 |  9455 | `	GenStateFixJumps(pTry,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - |  9456 | `	/* Emit the 'POP_EXCEPTION' instruction */` |
|     306 |  9457 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP_EXCEPTION,0,0,pException,0);` |
|       - |  9458 | `	/* Leave the block */` |
|     306 |  9459 | `	GenStateLeaveBlock(&(*pGen),0);` |
|       - |  9460 | `	/* Compile catch block(s) — at least one catch or finally is required */` |
|     306 |  9461 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|     302 |  9462 | `		SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_CATCH ){` |
|       - |  9463 | `		/* Compile one or more catch blocks */` |
|     296 |  9464 | `		for(;;){` |
|     592 |  9465 | `			if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0` |
|     454 |  9466 | `				\|\| SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_CATCH ){` |
|     148 |  9467 | `					break;` |
|       - |  9468 | `			}` |
|     302 |  9469 | `			rc = PH7_CompileCatch(&(*pGen),pException);` |
|     302 |  9470 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  9471 | `				return SXERR_ABORT;` |
|       - |  9472 | `			}` |
|       2 |  9473 | `		}` |
|     146 |  9474 | `	}` |
|       - |  9475 | `	/* Compile optional finally block */` |
|     306 |  9476 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|     136 |  9477 | `		SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_FINALLY ){` |
...
|     306 |  9506 | `	if( SySetUsed(&pException->sEntry) == 0 && !pException->iHasFinally ){` |
...
|       - |  9534 | `	 * or the '}' token */` |
|     182 |  9535 | `	for(;;){` |
|     366 |  9536 | `		if( pGen->pIn >= pGen->pEnd ){` |
|       - |  9537 | `			/* No more input to process */` |
|     ! 0 |  9538 | `			break;` |
|       - |  9539 | `		}` |
|     366 |  9540 | `		rc = SXRET_OK;` |
|     366 |  9541 | `		if( (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|     298 |  9558 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|     298 |  9559 | `			if( nKwrd == PH7_TKWRD_CASE \|\| nKwrd == PH7_TKWRD_DEFAULT ){` |
|      42 |  9560 | `				break;` |
|       - |  9561 | `			}` |
|     218 |  9562 | `			if( nKwrd == PH7_TKWRD_ENDSWITCH /* endswitch; */){` |
...
|       - |  9575 | `		}` |
|       - |  9576 | `		/* Compile block */` |
|     258 |  9577 | `		rc = PH7_CompileBlock(&(*pGen),0);` |
|     258 |  9578 | `		if( rc == SXERR_ABORT ){` |
...
|       - |  9869 | ` */` |
| 2278456 |  9870 | `static void GenStatePatchNullsafeJumps(ph7_gen_state *pGen, sxu32 nBaseline)` |
|       2 |  9871 |  |
| 2278458 |  9872 | `	sxu32 nCur = SySetUsed(&pGen->aNullsafeJmp);` |
|       - |  9873 | `	sxu32 nTarget;` |
|       - |  9874 | `	sxu32 *aIdx;` |
|       - |  9875 | `	sxu32 i;` |
| 2278458 |  9876 | `	if( nCur <= nBaseline ){` |
| 2278368 |  9877 | `		return;` |
|       - |  9878 | `	}` |
...
|       - |  9889 |  |
|       - |  9890 | `/*` |
|       - |  9891 | ` * Generate bytecode for a given expression tree.` |
|       - |  9892 | ` * If something goes wrong while generating bytecode` |
|       - |  9893 | ` * for the expression tree (A very unlikely scenario)` |
|       - |  9894 | ` * this function takes care of generating the appropriate` |
|       - |  9895 | ` * error message.` |
|       - |  9896 | ` */` |
| 3070236 |  9897 | `static sxi32 GenStateEmitExprCode(` |
|       - |  9898 | `	ph7_gen_state *pGen,  /* Code generator state */` |
|       - |  9899 | `	ph7_expr_node *pNode, /* Root of the expression tree */` |
|       - |  9900 | `	sxi32 iFlags /* Control flags */` |
|       - |  9901 | `	)` |
|       2 |  9902 |  |
|       - |  9903 | `	VmInstr *pInstr;` |
|       - |  9904 | `	sxu32 nJmpIdx;` |
| 3070238 |  9905 | `	sxi32 iP1 = 0;` |
| 3070238 |  9906 | `	sxu32 iP2 = 0;` |
| 3070238 |  9907 | `	void *p3  = 0;` |
|       - |  9908 | `	sxi32 iVmOp;` |
|       - |  9909 | `	sxi32 rc;` |
| 3070238 |  9910 | `	int bIsChainOp = 0; /* Set below once we know pNode->pOp */` |
| 3070238 |  9911 | `	sxu32 nRhsNsBase = 0;` |
| 3070238 |  9912 | `	if( pNode->xCode ){` |
|       - |  9913 | `		SyToken *pTmpIn,*pTmpEnd;` |
|       - |  9914 | `		/* Compile node */` |
| 1901510 |  9915 | `		SWAP_DELIMITER(pGen,pNode->pStart,pNode->pEnd);` |
| 1901510 |  9916 | `		rc = pNode->xCode(&(*pGen),iFlags);` |
| 1901510 |  9917 | `		RE_SWAP_DELIMITER(pGen);` |
| 1901510 |  9918 | `		return rc;` |
|       - |  9919 | `	}` |
| 1168730 |  9920 | `	if( pNode->pOp == 0 ){` |
|     ! 0 |  9921 | `		PH7_GenCompileError(&(*pGen),E_ERROR,pNode->pStart->nLine,` |
|       - |  9922 | `			"Invalid expression node,PH7 is aborting compilation");` |
|     ! 0 |  9923 | `		return SXERR_ABORT;` |
|       - |  9924 | `	}` |
| 1168730 |  9925 | `	iVmOp = pNode->pOp->iVmOp;` |
| 1168730 |  9926 | `	if( pNode->pOp->iOp == EXPR_OP_NULLC_ASSIGN ){` |
|      58 |  9927 | `		sxu32 nJmp = 0;` |
|       - |  9928 | `		sxu32 nNcNsBase;` |
|       - |  9929 | `		VmInstr *pInstrFix;` |
|       - |  9930 | `		/* Null coalescing assignment requires a custom compile order: the LHS` |
|       - |  9931 | `		 * target (pRight for prec-18 right-assoc ops) must be evaluated first` |
|       - |  9932 | `		 * so we can short-circuit the RHS when LHS is non-null. Pass` |
|       - |  9933 | `		 * EXPR_FLAG_LOAD_IDX_STORE so subscript LHS auto-vivifies and the` |
|       - |  9934 | `		 * stack slot carries a writable nIdx. */` |
|      58 |  9935 | `		if( pNode->pRight ){` |
|      58 |  9936 | `			nNcNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|      58 |  9937 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pRight,iFlags\|EXPR_FLAG_LOAD_IDX_STORE);` |
|      58 |  9938 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  9939 | `				return rc;` |
|       - |  9940 | `			}` |
|      58 |  9941 | `			GenStatePatchNullsafeJumps(pGen, nNcNsBase);` |
|       - |  9942 | `			/* Optimisation: if the outermost LHS access is a subscript, demote` |
|       - |  9943 | `			 * its LOAD_IDX from write-context (iP2=1, eager COW separation +` |
|       - |  9944 | `			 * insert) to peek-mode (iP2=3, separate-only-on-null/missing). On` |
|       - |  9945 | `			 * the common "already set" path the upcoming NULLC_JMP will skip` |
|       - |  9946 | `			 * the store, so the parent array does not need to be copied at` |
|       - |  9947 | `			 * all. Inner levels of a nested LHS keep iP2=1 so the separation` |
|       - |  9948 | `			 * cascade for the actual write path stays correct. */` |
|      58 |  9949 | `			pInstrFix = PH7_VmPeekInstr(pGen->pVm);` |
|      58 |  9950 | `			if( pInstrFix && pInstrFix->iOp == PH7_OP_LOAD_IDX && pInstrFix->iP2 == 1 ){` |
|      28 |  9951 | `				pInstrFix->iP2 = 3;` |
|      13 |  9952 | `			}` |
|      28 |  9953 | `		}` |
|       - |  9954 | `		/* Short-circuit: if LHS is non-null, jump past the RHS + store. */` |
|      58 |  9955 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_NULLC_JMP,0,0,0,&nJmp);` |
|       - |  9956 | `		/* Compile the RHS value (pLeft for prec-18 right-assoc). */` |
|      58 |  9957 | `		if( pNode->pLeft ){` |
|      58 |  9958 | `			nNcNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|      58 |  9959 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pLeft,iFlags);` |
|      58 |  9960 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  9961 | `				return rc;` |
|       - |  9962 | `			}` |
|      58 |  9963 | `			GenStatePatchNullsafeJumps(pGen, nNcNsBase);` |
|      28 |  9964 | `		}` |
|       - |  9965 | `		/* Store RHS into LHS's memobj slot; leave RHS as the result on stack. */` |
|      58 |  9966 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_NULLC_STORE,0,0,0,0);` |
|       - |  9967 | `		/* Patch the short-circuit jump to land after the store. */` |
|      58 |  9968 | `		if( nJmp > 0 ){` |
|      58 |  9969 | `			pInstrFix = PH7_VmGetInstr(pGen->pVm,nJmp);` |
|      58 |  9970 | `			if( pInstrFix ){` |
|      58 |  9971 | `				pInstrFix->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|      28 |  9972 | `			}` |
|      28 |  9973 | `		}` |
|      58 |  9974 | `		return SXRET_OK;` |
|       - |  9975 | `	}` |
| 1168674 |  9976 | `	if( pNode->pOp->iOp == EXPR_OP_QUESTY ){` |
|       - |  9977 | `		sxu32 nJz,nJmp;` |
|       - |  9978 | `		sxu32 nTernaryNsBase;` |
|       - |  9979 | `		/* Ternary operator require special handling */` |
|       - |  9980 | `		/* Phase#1: Compile the condition */` |
|    2382 |  9981 | `		nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|    2382 |  9982 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pCond,iFlags);` |
|    2382 |  9983 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  9984 | `			return rc;` |
|       - |  9985 | `		}` |
|       - |  9986 | `		/* Ternary is not a chain operator: any nullsafe jumps emitted while` |
|       - |  9987 | `		 * compiling the condition must short-circuit to the end of the` |
|       - |  9988 | `		 * condition expression, not leak past the ternary. */` |
|    2382 |  9989 | `		GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|    2382 |  9990 | `		nJz = nJmp = 0; /* cc -O6 warning */` |
|    2382 |  9991 | `		if( pNode->pLeft ){` |
|       - |  9992 | `			/* Standard ternary: (expr) ? (then) : (else) */` |
|       - |  9993 | `			/* Phase#2: Emit the false jump (pops condition) */` |
|    2314 |  9994 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nJz);` |
|       - |  9995 | `			/* Phase#3: Compile the 'then' expression  */` |
|    2314 |  9996 | `			nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|    2314 |  9997 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pLeft,iFlags);` |
|    2314 |  9998 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  9999 | `				return rc;` |
|       - | 10000 | `			}` |
|    2314 | 10001 | `			GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|    1158 | 10002 | `		}else{` |
|       - | 10003 | `			/* Elvis operator: (expr) ?: (else)` |
|       - | 10004 | `			 * Duplicate condition so original value is the 'then' result.` |
|       - | 10005 | `			 * JZ consumes the copy; original stays on stack if truthy. */` |
|      70 | 10006 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_DUP,0,0,0,0);` |
|      70 | 10007 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nJz);` |
|       - | 10008 | `		}` |
|       - | 10009 | `		/* Phase#4: Emit the unconditional jump */` |
|    2382 | 10010 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,0,0,&nJmp);` |
|       - | 10011 | `		/* Phase#5: Fix the false jump now the jump destination is resolved. */` |
|    2382 | 10012 | `		pInstr = PH7_VmGetInstr(pGen->pVm,nJz);` |
|    2382 | 10013 | `		if( pInstr ){` |
|    2382 | 10014 | `			pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    1190 | 10015 | `		}` |
|    2382 | 10016 | `		if( !pNode->pLeft ){` |
|       - | 10017 | `			/* Elvis operator: discard the falsy condition value before evaluating 'else' */` |
|      70 | 10018 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|      34 | 10019 | `		}` |
|       - | 10020 | `		/* Phase#6: Compile the 'else' expression */` |
|    2382 | 10021 | `		if( pNode->pRight ){` |
|    2382 | 10022 | `			nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|    2382 | 10023 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pRight,iFlags);` |
|    2382 | 10024 | `			if( rc != SXRET_OK ){` |
|     ! 0 | 10025 | `				return rc;` |
|       - | 10026 | `			}` |
|    2382 | 10027 | `			GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|    1190 | 10028 | `		}` |
|    2382 | 10029 | `		if( nJmp > 0 ){` |
|       - | 10030 | `			/* Phase#7: Fix the unconditional jump */` |
|    2382 | 10031 | `			pInstr = PH7_VmGetInstr(pGen->pVm,nJmp);` |
|    2382 | 10032 | `			if( pInstr ){` |
|    2382 | 10033 | `				pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    1190 | 10034 | `			}` |
|    1190 | 10035 | `		}` |
|       - | 10036 | `		/* All done */` |
|    2382 | 10037 | `		return SXRET_OK;` |
|       - | 10038 | `	}` |
| 1166294 | 10039 | `	bIsChainOp = GEN_IS_CHAIN_OP(pNode->pOp->iOp);` |
|       - | 10040 | `	/* Generate code for the left tree */` |
| 1166294 | 10041 | `	if( pNode->pLeft ){` |
| 1166256 | 10042 | `		sxu32 nLhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
| 1166256 | 10043 | `		if( iVmOp == PH7_OP_CALL ){` |
|       - | 10044 | `			ph7_expr_node **apNode;` |
|  370202 | 10045 | `			int hasSpread = 0;` |
|  370202 | 10046 | `			int hasNamed = 0;` |
|       - | 10047 | `			sxi32 nArgs;` |
|       - | 10048 | `			sxi32 n;` |
|       - | 10049 | `			/* Recurse and generate bytecodes for function arguments */` |
|  370202 | 10050 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  370202 | 10051 | `			nArgs = (sxi32)SySetUsed(&pNode->aNodeArgs);` |
|       - | 10052 | `			/* Validate: no positional arguments after named arguments */` |
|       - | 10053 | `			{` |
|  370202 | 10054 | `				int seenNamed = 0;` |
|  733114 | 10055 | `				for( n = 0; n < nArgs; ++n ){` |
|  362916 | 10056 | `					if( apNode[n]->iFlags & EXPR_NODE_NAMED_ARG ){` |
|     186 | 10057 | `						seenNamed = 1;` |
|     186 | 10058 | `						hasNamed = 1;` |
|  362824 | 10059 | `					}else if( seenNamed && !(apNode[n]->iFlags & EXPR_NODE_SPREAD) ){` |
|       3 | 10060 | `						rc = PH7_GenCompileError(&(*pGen),E_ERROR,apNode[n]->pStart->nLine,` |
|       - | 10061 | `							"Cannot use positional argument after named argument");` |
|       3 | 10062 | `						return SXERR_SYNTAX;` |
|       - | 10063 | `					}` |
|  181458 | 10064 | `				}` |
|       - | 10065 | `			}` |
|       - | 10066 | `			/* Read-only load */` |
|  370200 | 10067 | `			iFlags \|= EXPR_FLAG_RDONLY_LOAD;` |
|       - | 10068 | `			/* Route subscript-argument LOAD_IDX through a special iP2 code` |
|       - | 10069 | ``			 * for the language constructs `isset` and `empty` so ArrayAccess`` |
|       - | 10070 | `			 * objects dispatch to the right method (offsetExists for both;` |
|       - | 10071 | `			 * empty also needs offsetGet to evaluate emptiness on hits). */` |
|  370200 | 10072 | `			if( pNode->pLeft && pNode->pLeft->pStart ){` |
|  370200 | 10073 | `				SyString *pCallName = &pNode->pLeft->pStart->sData;` |
|  370198 | 10074 | `				if( pCallName->nByte == 5` |
|  203196 | 10075 | `				 && SyStrnicmp(pCallName->zString,"isset",5) == 0 ){` |
|   19026 | 10076 | `					iFlags \|= EXPR_FLAG_LOAD_IDX_ISSET;` |
|  360688 | 10077 | `				}else if( pCallName->nByte == 5` |
|  184172 | 10078 | `				 && SyStrnicmp(pCallName->zString,"empty",5) == 0 ){` |
|      80 | 10079 | `					iFlags \|= EXPR_FLAG_LOAD_IDX_EMPTY;` |
|      39 | 10080 | `				}` |
|  185099 | 10081 | `			}` |
|  733110 | 10082 | `			for( n = 0 ; n < nArgs ; ++n ){` |
|  362912 | 10083 | `				sxu32 nArgNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  362912 | 10084 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iFlags&~EXPR_FLAG_LOAD_IDX_STORE);` |
|  362912 | 10085 | `				if( rc != SXRET_OK ){` |
|     ! 0 | 10086 | `					return rc;` |
|       - | 10087 | `				}` |
|       - | 10088 | `				/* Each argument is an independent nullsafe scope. */` |
|  362912 | 10089 | `				GenStatePatchNullsafeJumps(pGen, nArgNsBase);` |
|  362912 | 10090 | `				if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
|       - | 10091 | `					/* Emit spread opcode to unpack this array argument */` |
|      20 | 10092 | `					PH7_VmEmitInstr(pGen->pVm, PH7_OP_SPREAD, 0, 0, 0, 0);` |
|      20 | 10093 | `					hasSpread = 1;` |
|       9 | 10094 | `				}` |
|  181457 | 10095 | `			}` |
|       - | 10096 | `			/* Total number of given arguments */` |
|  370200 | 10097 | `			iP1 = nArgs;` |
|  370200 | 10098 | `			iP2 = hasSpread;` |
|       - | 10099 | `			/* Build VmCallArgMap if named arguments are present.` |
|       - | 10100 | `			 * Deep-copy name strings so they survive token stream cleanup. */` |
|  370200 | 10101 | `			if( hasNamed ){` |
|     100 | 10102 | `				sxu32 nStrBytes = 0;` |
|       - | 10103 | `				char *zBuf;` |
|     296 | 10104 | `				for( n = 0; n < nArgs; ++n ){` |
|     198 | 10105 | `					if( apNode[n]->iFlags & EXPR_NODE_NAMED_ARG ){` |
|     184 | 10106 | `						nStrBytes += (sxu32)apNode[n]->sArgName.nByte;` |
|      91 | 10107 | `					}` |
|     100 | 10108 | `				}` |
|       - | 10109 | `				{` |
|     100 | 10110 | `				sxu32 mapSize = sizeof(VmCallArgMap) + nArgs * sizeof(SyString) + nStrBytes;` |
|     100 | 10111 | `				VmCallArgMap *pMap = (VmCallArgMap *)SyMemBackendAlloc(` |
|      98 | 10112 | `					&pGen->pVm->sAllocator, mapSize);` |
|     100 | 10113 | `				if( pMap ){` |
|     100 | 10114 | `					SyZero(pMap, mapSize);` |
|     100 | 10115 | `					pMap->bHasNamed = 1;` |
|     100 | 10116 | `					pMap->nTotal = (sxu32)nArgs;` |
|     100 | 10117 | `					pMap->aNames = (SyString *)&pMap[1];` |
|     100 | 10118 | `					zBuf = (char *)&pMap->aNames[nArgs]; /* string storage after SyString array */` |
|     296 | 10119 | `					for( n = 0; n < nArgs; ++n ){` |
|     198 | 10120 | `						if( apNode[n]->iFlags & EXPR_NODE_NAMED_ARG ){` |
|     184 | 10121 | `							sxu32 nb = (sxu32)apNode[n]->sArgName.nByte;` |
|     184 | 10122 | `							SyMemcpy(apNode[n]->sArgName.zString, zBuf, nb);` |
|     184 | 10123 | `							SyStringInitFromBuf(&pMap->aNames[n], zBuf, nb);` |
|     184 | 10124 | `							zBuf += nb;` |
|      91 | 10125 | `						}` |
|       - | 10126 | `						/* else: aNames[n] remains {NULL, 0} for positional */` |
|     100 | 10127 | `					}` |
|     100 | 10128 | `					p3 = (void *)pMap;` |
|      49 | 10129 | `				}` |
|       - | 10130 | `				}` |
|      49 | 10131 | `			}` |
|       - | 10132 | `			/* Remove stale flags now */` |
|  370200 | 10133 | `			iFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|  185099 | 10134 | `		}` |
| 1166254 | 10135 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pLeft,iFlags);` |
| 1166254 | 10136 | `		if( rc != SXRET_OK ){` |
|      31 | 10137 | `			return rc;` |
|       - | 10138 | `		}` |
| 1166224 | 10139 | `		if( !bIsChainOp ){` |
|       - | 10140 | `			/* Non-chain parent: any nullsafe jumps produced by the LHS sub-tree` |
|       - | 10141 | `			 * target the end of that LHS chain, which is right here. */` |
|  545090 | 10142 | `			GenStatePatchNullsafeJumps(pGen, nLhsNsBase);` |
|  272544 | 10143 | `		}` |
| 1166224 | 10144 | `		if( iVmOp == PH7_OP_CALL ){` |
|  370200 | 10145 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|  370200 | 10146 | `			if( pInstr ){` |
|  370200 | 10147 | `				if ( pInstr->iOp == PH7_OP_LOADC ){` |
|  369188 | 10148 | `					sxu32 nOrig = (sxu32)pInstr->iP2;` |
|       - | 10149 | `					sxu32 nQual;` |
|  369188 | 10150 | `					int bAbsolute = (pInstr->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|       - | 10151 | `					/* Prevent constant expansion but preserve the absolute flag` |
|       - | 10152 | `					 * so the later NEW handler (if any) can see it. */` |
|  369188 | 10153 | `					pInstr->iP1 &= ~PH7_LOADC_EXPAND;` |
|       - | 10154 | `					/* Namespace-qualify the function name for CALL, unless the` |
|       - | 10155 | ``					 * literal is absolute (`\Foo(...)`). Only check function`` |
|       - | 10156 | `					 * imports — class imports must NOT affect function` |
|       - | 10157 | ``					 * resolution. For `new Foo()`, the CALL handler fires`` |
|       - | 10158 | `					 * before NEW; we store the original literal index in the` |
|       - | 10159 | `					 * CALL instruction's iP2 so the NEW handler can recover` |
|       - | 10160 | `					 * the unqualified name and re-qualify with class imports. */` |
|  369188 | 10161 | `					if( bAbsolute ){` |
|      20 | 10162 | `						pInstr->iP2 = (sxi32)nOrig;` |
|      11 | 10163 | `					}else{` |
|  369170 | 10164 | `						int fromImport = 0;` |
|  369170 | 10165 | `						nQual = GenStateNsQualifyName(pGen,nOrig,&pGen->hUseFuncImports,&fromImport);` |
|  369170 | 10166 | `						pInstr->iP2 = (sxi32)nQual;` |
|  369170 | 10167 | `						if( nQual != nOrig ){` |
|       - | 10168 | `							/* Store original literal index in CALL's iP2 so the` |
|       - | 10169 | `							 * NEW handler can recover the unqualified name. */` |
|      74 | 10170 | `							iP2 = (sxi32)(nOrig + 1); /* +1 to distinguish from default 0 */` |
|      74 | 10171 | `							if( !fromImport ){` |
|       - | 10172 | `								/* Mark as namespace-qualified via VmCallArgMap */` |
|      64 | 10173 | `								if( p3 == 0 ){` |
|      64 | 10174 | `									VmCallArgMap *pMap = (VmCallArgMap *)SyMemBackendAlloc(` |
|      62 | 10175 | `										&pGen->pVm->sAllocator, sizeof(VmCallArgMap));` |
|      64 | 10176 | `									if( pMap ){` |
|      64 | 10177 | `										SyZero(pMap, sizeof(VmCallArgMap));` |
|      64 | 10178 | `										p3 = (void *)pMap;` |
|      31 | 10179 | `									}` |
|      31 | 10180 | `								}` |
|      64 | 10181 | `								if( p3 ){` |
|      64 | 10182 | `									((VmCallArgMap *)p3)->bIsNamespaced = 1;` |
|      31 | 10183 | `								}` |
|      31 | 10184 | `							}` |
|      36 | 10185 | `						}` |
|       2 | 10186 | `					}` |
|  185607 | 10187 | `				}else if( pInstr->iOp == PH7_OP_MEMBER /* $a->b(1,2,3) */ \|\| pInstr->iOp == PH7_OP_NEW ){` |
|       - | 10188 | `					/* Method call,flag that */` |
|     814 | 10189 | `					pInstr->iP2 = 1;` |
|     406 | 10190 | `				}` |
|  185101 | 10191 | `			}` |
|  981125 | 10192 | `		}else if( iVmOp == PH7_OP_LOAD_IDX ){` |
|       - | 10193 | `			ph7_expr_node **apNode;` |
|       - | 10194 | `			sxi32 n;` |
|   80318 | 10195 | `			sxi32 iChildMask = ~(EXPR_FLAG_LOAD_IDX_STORE` |
|       - | 10196 | `				\|EXPR_FLAG_LOAD_IDX_ISSET\|EXPR_FLAG_LOAD_IDX_UNSET` |
|       - | 10197 | `				\|EXPR_FLAG_LOAD_IDX_EMPTY);` |
|       - | 10198 | `			/* Recurse and generate bytecodes for array index */` |
|   80318 | 10199 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  144936 | 10200 | `			for( n = 0 ; n < (sxi32)SySetUsed(&pNode->aNodeArgs) ; ++n ){` |
|   64620 | 10201 | `				sxu32 nIdxNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|   64620 | 10202 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iFlags&iChildMask);` |
|   64620 | 10203 | `				if( rc != SXRET_OK ){` |
|     ! 0 | 10204 | `					return rc;` |
|       - | 10205 | `				}` |
|       - | 10206 | `				/* Each subscript index is an independent nullsafe scope. */` |
|   64620 | 10207 | `				GenStatePatchNullsafeJumps(pGen, nIdxNsBase);` |
|   32311 | 10208 | `			}` |
|   80318 | 10209 | `			if( SySetUsed(&pNode->aNodeArgs) > 0 ){` |
|   64620 | 10210 | `				iP1 = 1; /* Node have an index associated with it */` |
|   32309 | 10211 | `			}` |
|   80318 | 10212 | `			if( iFlags & EXPR_FLAG_LOAD_IDX_ISSET ){` |
|       - | 10213 | `				/* offsetExists for ArrayAccess; peek-only for arrays */` |
|     238 | 10214 | `				iP2 = 4;` |
|   80200 | 10215 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_UNSET ){` |
|       - | 10216 | `				/* offsetUnset for ArrayAccess; auto-vivify+load for arrays` |
|       - | 10217 | `				 * so the trailing unset() builtin can drop the slot. */` |
|      52 | 10218 | `				iP2 = 5;` |
|   80057 | 10219 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_EMPTY ){` |
|       - | 10220 | `				/* offsetExists+offsetGet for ArrayAccess so empty() can` |
|       - | 10221 | `				 * short-circuit on missing keys without invoking offsetGet` |
|       - | 10222 | `				 * unnecessarily; peek-only for arrays (same as iP2=0). */` |
|      26 | 10223 | `				iP2 = 6;` |
|   80020 | 10224 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_STORE ){` |
|       - | 10225 | `				/* Create an empty entry when the desired index is not found */` |
|   31672 | 10226 | `				iP2 = 1;` |
|   15837 | 10227 | `			}` |
|  755868 | 10228 | `		}else if( pNode->pOp->iOp == EXPR_OP_COMMA ){` |
|       - | 10229 | `			/* POP the left node */` |
|      32 | 10230 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|      15 | 10231 | `		}` |
|  583111 | 10232 | `	}` |
| 1166262 | 10233 | `	rc = SXRET_OK;` |
| 1166262 | 10234 | `	nJmpIdx = 0;` |
|       - | 10235 | `	/* For :: (static member access), namespace-qualify the class name (left operand).` |
|       - | 10236 | `	 * The left child was just compiled; its LOADC is the last instruction.` |
|       - | 10237 | `	 * Skip self/static/parent — these are keywords, not class names. */` |
| 1166262 | 10238 | `	if( iVmOp == PH7_OP_MEMBER && pNode->pOp->iOp == EXPR_OP_DC ){` |
|     270 | 10239 | `		pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|     270 | 10240 | `		if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|     270 | 10241 | `			ph7_value *pLitCheck = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,(sxu32)pInstr->iP2);` |
|     270 | 10242 | `			int isSpecial = 0;` |
|     270 | 10243 | `			if( pLitCheck && (pLitCheck->iFlags & MEMOBJ_STRING) ){` |
|     182 | 10244 | `				const char *z = (const char *)SyBlobData(&pLitCheck->sBlob);` |
|     182 | 10245 | `				sxu32 n = (sxu32)SyBlobLength(&pLitCheck->sBlob);` |
|     195 | 10246 | `				if( (n == 4 && SyMemcmp(z,"self",4) == 0) \|\|` |
|     160 | 10247 | `					(n == 6 && SyMemcmp(z,"static",6) == 0) \|\|` |
|      83 | 10248 | `					(n == 6 && SyMemcmp(z,"parent",6) == 0) ){` |
|      90 | 10249 | `					isSpecial = 1;` |
|      44 | 10250 | `				}` |
|     112 | 10251 | `			}` |
|     314 | 10252 | `			pInstr->iP1 = 0;` |
|     314 | 10253 | `			if( !isSpecial ){` |
|     138 | 10254 | `				pInstr->iP2 = (sxi32)GenStateNsQualifyName(pGen,(sxu32)pInstr->iP2,&pGen->hUseImports,0);` |
|      68 | 10255 | `			}` |
|       - | 10256 | `			/* Foo::class — resolve at compile time. The LOADC already holds the` |
|       - | 10257 | `			 * namespace-qualified name. self/static/parent need runtime resolution. */` |
|     226 | 10258 | `			if( !isSpecial && pNode->pRight && pNode->pRight->pStart ){` |
|     138 | 10259 | `				SyToken *pRightTok = pNode->pRight->pStart;` |
|     138 | 10260 | `				if( (pRightTok->nType & PH7_TK_KEYWORD) &&` |
|      42 | 10261 | `				    SX_PTR_TO_INT(pRightTok->pUserData) == PH7_TKWRD_CLASS ){` |
|      44 | 10262 | `					return SXRET_OK;` |
|       - | 10263 | `				}` |
|      47 | 10264 | `			}` |
|      91 | 10265 | `		}` |
|     167 | 10266 | `	}` |
|       - | 10267 | `	/* Generate code for the right tree */` |
| 1166184 | 10268 | `	if( pNode->pRight ){` |
|  644274 | 10269 | `		if( iVmOp == PH7_OP_LAND ){` |
|       - | 10270 | `			/* Emit the false jump so we can short-circuit the logical and */` |
|    9802 | 10271 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,1/* Keep the value on the stack */,0,0,&nJmpIdx);` |
|  639374 | 10272 | `		}else if (iVmOp == PH7_OP_LOR ){` |
|       - | 10273 | `			/* Emit the true jump so we can short-circuit the logical or*/` |
|    3284 | 10274 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JNZ,1/* Keep the value on the stack */,0,0,&nJmpIdx);` |
|  632833 | 10275 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLC ){` |
|       - | 10276 | `			/* Null coalescing: if LHS is not null, jump past RHS */` |
|     122 | 10277 | `			iVmOp = 0; /* No binary operator to emit */` |
|     122 | 10278 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_NULLC,0,0,0,&nJmpIdx);` |
|  631181 | 10279 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW ){` |
|       - | 10280 | ``			/* Nullsafe operator `?->` (PHP 8.0): if LHS is null, short-circuit`` |
|       - | 10281 | `			 * the entire containing postfix chain to null. The jump target is` |
|       - | 10282 | `			 * patched later by the innermost non-chain ancestor (or by` |
|       - | 10283 | `			 * PH7_CompileExpr at the outer boundary). Leaves NULL on the stack` |
|       - | 10284 | `			 * when taken; otherwise falls through, leaving the object on stack` |
|       - | 10285 | `			 * so the PH7_OP_MEMBER that follows can consume it. */` |
|     100 | 10286 | `			sxu32 nNsJmp = 0;` |
|     100 | 10287 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_NULLSAFE_JMP,0,0,0,&nNsJmp);` |
|     100 | 10288 | `			SySetPut(&pGen->aNullsafeJmp,(const void *)&nNsJmp);` |
|  631023 | 10289 | `		}else if( pNode->pOp->iPrec == 18 /* Combined binary operators [i.e: =,'.=','+=',*=' ...] precedence */ ){` |
|  261606 | 10290 | `			iFlags \|= EXPR_FLAG_LOAD_IDX_STORE;` |
|  130802 | 10291 | `		}` |
|  644274 | 10292 | `		nRhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  644274 | 10293 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pRight,iFlags);` |
|  644274 | 10294 | `		if( !bIsChainOp ){` |
|       - | 10295 | `			/* Non-chain parent: RHS nullsafe chain ends here, before the` |
|       - | 10296 | `			 * operator instruction is emitted. */` |
|  473696 | 10297 | `			GenStatePatchNullsafeJumps(pGen, nRhsNsBase);` |
|  236847 | 10298 | `		}` |
|  644274 | 10299 | `		if( iVmOp == PH7_OP_STORE ){` |
|  258278 | 10300 | `			if( pNode->pRight && (pNode->pRight->xCode == PH7_CompileList \|\|` |
|  258252 | 10301 | `				pNode->pRight->xCode == PH7_CompileShortList) ){` |
|       - | 10302 | `				/* list()/[] destructuring handles assignment internally via LOAD_LIST;` |
|       - | 10303 | `				 * suppress the STORE instruction entirely.  This check uses the node's` |
|       - | 10304 | `				 * compile handler rather than peeking at the last opcode, because nested` |
|       - | 10305 | `				 * list entries emit extra instructions (DUP, LOAD_IDX, POP) after the` |
|       - | 10306 | `				 * outer LOAD_LIST, which would fool an opcode-based check.` |
|       - | 10307 | `				 */` |
|      54 | 10308 | `				iVmOp = 0;` |
|  258252 | 10309 | `			}else if( (pInstr = PH7_VmPeekInstr(pGen->pVm)) != 0 ){` |
|  258226 | 10310 | `				if(pInstr->iOp == PH7_OP_MEMBER ){` |
|       - | 10311 | `					/* Perform a member store operation [i.e: $this->x = 50] */` |
|   72112 | 10312 | `					iP2 = 1;` |
|   36057 | 10313 | `				}else{` |
|  186116 | 10314 | `					if( pInstr->iOp == PH7_OP_LOAD_IDX ){` |
|       - | 10315 | `						/* Transform the STORE instruction to STORE_IDX instruction */` |
|   31628 | 10316 | `						iVmOp = PH7_OP_STORE_IDX;` |
|   31628 | 10317 | `						iP1 = pInstr->iP1;` |
|   15815 | 10318 | `					}else{` |
|  154490 | 10319 | `						p3 = pInstr->p3;` |
|       - | 10320 | `					}` |
|       - | 10321 | `					/* POP the last dynamic load instruction */` |
|  186116 | 10322 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|       - | 10323 | `				}` |
|  129114 | 10324 | `			}` |
|  515136 | 10325 | `		}else if( iVmOp == PH7_OP_STORE_REF ){` |
|      48 | 10326 | `			pInstr = PH7_VmPopInstr(pGen->pVm);` |
|      48 | 10327 | `			if( pInstr ){` |
|      48 | 10328 | `				if( pInstr->iOp == PH7_OP_LOAD_IDX ){` |
|       - | 10329 | `					/* Array insertion by reference [i.e: $pArray[] =& $some_var; ]` |
|       - | 10330 | `					 * We have to convert the STORE_REF instruction into STORE_IDX_REF` |
|       - | 10331 | `					 */` |
|      15 | 10332 | `					iVmOp = PH7_OP_STORE_IDX_REF;` |
|      15 | 10333 | `					iP1 = pInstr->iP1;` |
|      15 | 10334 | `					iP2 = pInstr->iP2;` |
|      15 | 10335 | `					p3  = pInstr->p3;` |
|       8 | 10336 | `				}else{` |
|      34 | 10337 | `					p3 = pInstr->p3;` |
|       - | 10338 | `				}` |
|      23 | 10339 | `			}` |
|      23 | 10340 | `		}` |
|  322136 | 10341 | `	}` |
| 1166184 | 10342 | `	if( iVmOp > 0 ){` |
| 1165982 | 10343 | `		if( iVmOp == PH7_OP_INCR \|\| iVmOp == PH7_OP_DECR ){` |
|   12820 | 10344 | `			if( pNode->iFlags & EXPR_NODE_PRE_INCR ){` |
|       - | 10345 | `				/* Pre-increment/decrement operator [i.e: ++$i,--$j ] */` |
|    9380 | 10346 | `				iP1 = 1;` |
|    4691 | 10347 | `			}` |
| 1159573 | 10348 | `		}else if( iVmOp == PH7_OP_NEW ){` |
|       - | 10349 | `			/* Namespace-qualify the class name for NEW */ {` |
|   16574 | 10350 | `				VmInstr *pPeek = PH7_VmPeekInstr(pGen->pVm);` |
|   16574 | 10351 | `				VmInstr *pCallInstr = 0;` |
|   16574 | 10352 | `				if( pPeek && pPeek->iOp == PH7_OP_CALL ){` |
|   16556 | 10353 | `					pCallInstr = pPeek;` |
|   16556 | 10354 | `					pPeek = PH7_VmPeekNextInstr(pGen->pVm);` |
|    8277 | 10355 | `				}` |
|   16574 | 10356 | `				if( pPeek && pPeek->iOp == PH7_OP_LOADC ){` |
|   16572 | 10357 | `					int bAbsolute = (pPeek->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|       - | 10358 | `					sxu32 nLitForClass;` |
|       - | 10359 | `					/* If the CALL handler already qualified the name using` |
|       - | 10360 | `					 * function imports, recover the original unqualified` |
|       - | 10361 | `					 * literal so we can re-qualify with class imports. */` |
|   16572 | 10362 | `					if( pCallInstr && pCallInstr->iP2 > 0 ){` |
|      34 | 10363 | `						nLitForClass = (sxu32)(pCallInstr->iP2 - 1); /* undo +1 encoding */` |
|      18 | 10364 | `					}else{` |
|   16540 | 10365 | `						nLitForClass = (sxu32)pPeek->iP2;` |
|       - | 10366 | `					}` |
|   16572 | 10367 | `					pPeek->iP1 = 0;` |
|   16572 | 10368 | `					if( !bAbsolute ){` |
|   16556 | 10369 | `						pPeek->iP2 = (sxi32)GenStateNsQualifyName(pGen,nLitForClass,&pGen->hUseImports,0);` |
|    8279 | 10370 | `					}else{` |
|      18 | 10371 | `						pPeek->iP2 = (sxi32)nLitForClass;` |
|       - | 10372 | `					}` |
|    8285 | 10373 | `				}` |
|       - | 10374 | `			}` |
|   16574 | 10375 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|   16574 | 10376 | `			if( pInstr && pInstr->iOp == PH7_OP_CALL ){` |
|       - | 10377 | `				VmInstr *pPrev;` |
|   16556 | 10378 | `				pPrev = PH7_VmPeekNextInstr(pGen->pVm);` |
|   16556 | 10379 | `				if( pPrev == 0 \|\| pPrev->iOp != PH7_OP_MEMBER ){` |
|       - | 10380 | `					/* Pop the call instruction, preserve named-arg map */` |
|   16556 | 10381 | `					iP1 = pInstr->iP1;` |
|   16556 | 10382 | `					if( pInstr->p3 ){` |
|      38 | 10383 | `						p3 = pInstr->p3; /* Transfer VmCallArgMap to NEW */` |
|      18 | 10384 | `					}` |
|   16556 | 10385 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|    8277 | 10386 | `				}` |
|    8279 | 10387 | `			}` |
| 1144878 | 10388 | `		}else if( iVmOp == PH7_OP_IS_A ){` |
|       - | 10389 | `			/* instanceof: right operand is a class name, not a constant.` |
|       - | 10390 | `			 * Namespace-qualify it, but skip self/static/parent and absolute refs. */` |
|     132 | 10391 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|     132 | 10392 | `			if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|     132 | 10393 | `				ph7_value *pLitChk = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,(sxu32)pInstr->iP2);` |
|     132 | 10394 | `				int bAbsolute = (pInstr->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|     132 | 10395 | `				int isSpecialIs = 0;` |
|     132 | 10396 | `				if( pLitChk && (pLitChk->iFlags & MEMOBJ_STRING) ){` |
|     128 | 10397 | `					const char *z = (const char *)SyBlobData(&pLitChk->sBlob);` |
|     128 | 10398 | `					sxu32 n = (sxu32)SyBlobLength(&pLitChk->sBlob);` |
|     131 | 10399 | `					if( (n == 4 && SyMemcmp(z,"self",4) == 0) \|\|` |
|     123 | 10400 | `						(n == 6 && SyMemcmp(z,"static",6) == 0) \|\|` |
|      64 | 10401 | `						(n == 6 && SyMemcmp(z,"parent",6) == 0) ){` |
|      11 | 10402 | `						isSpecialIs = 1;` |
|       5 | 10403 | `					}` |
|      64 | 10404 | `				}` |
|     134 | 10405 | `				pInstr->iP1 = 0;` |
|     134 | 10406 | `				if( !isSpecialIs && !bAbsolute ){` |
|     112 | 10407 | `					pInstr->iP2 = (sxi32)GenStateNsQualifyName(pGen,(sxu32)pInstr->iP2,&pGen->hUseImports,0);` |
|      55 | 10408 | `				}` |
|      66 | 10409 | `			}` |
| 1136530 | 10410 | `		}else if( iVmOp == PH7_OP_MEMBER){` |
|       - | 10411 | `			/* Prevent constant expansion for member/property names.` |
|       - | 10412 | `			 * The right child (member name) was just compiled — its LOADC` |
|       - | 10413 | `			 * should not trigger constant lookup. */` |
|  170580 | 10414 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|  170580 | 10415 | `			if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|  170542 | 10416 | `				pInstr->iP1 = 0;` |
|   85270 | 10417 | `			}` |
|  170580 | 10418 | `			if( pNode->pOp->iOp == EXPR_OP_DC /* '::' */){` |
|       - | 10419 | `				/* Static member access,remember that */` |
|     192 | 10420 | `				iP1 = 1;` |
|     192 | 10421 | `				pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|     192 | 10422 | `				if( pInstr && pInstr->iOp == PH7_OP_LOAD ){` |
|      32 | 10423 | `					p3 = pInstr->p3;` |
|      32 | 10424 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|      15 | 10425 | `				}` |
|      95 | 10426 | `			}` |
|   85289 | 10427 | `		}` |
|       - | 10428 | `		/* Tag CALL/NEW sites with the caller file's strict_types flag.` |
|       - | 10429 | `		 * This is the primary emit path for user-visible calls. */` |
| 1165980 | 10430 | `		if( iVmOp == PH7_OP_CALL \|\| iVmOp == PH7_OP_NEW ){` |
|  386772 | 10431 | `			p3 = GenStateAttachStrictFlag(pGen,p3);` |
|  193385 | 10432 | `		}` |
|       - | 10433 | `		/* Finally,emit the VM instruction associated with this operator */` |
| 1165980 | 10434 | `		PH7_VmEmitInstr(pGen->pVm,iVmOp,iP1,iP2,p3,0);` |
|  582989 | 10435 | `	}` |
| 1166182 | 10436 | `	if( nJmpIdx > 0 ){` |
|       - | 10437 | `		/* Fix short-circuited jumps now the destination is resolved */` |
|   13204 | 10438 | `		pInstr = PH7_VmGetInstr(pGen->pVm,nJmpIdx);` |
|   13204 | 10439 | `		if( pInstr ){` |
|   13204 | 10440 | `			pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    6601 | 10441 | `		}` |
|    6601 | 10442 | `	}` |
| 1166182 | 10443 | `	return rc;` |
| 1535101 | 10444 |  |
|       - | 10445 | `/*` |
|       - | 10446 | ` * Compile a PHP expression.` |
|       - | 10447 | ` * According to the PHP language reference manual:` |
|       - | 10448 | ` *  Expressions are the most important building stones of PHP.` |
|       - | 10449 | ` *  In PHP, almost anything you write is an expression.` |
|       - | 10450 | ` *  The simplest yet most accurate way to define an expression` |
|       - | 10451 | ` *  is "anything that has a value".` |
|       - | 10452 | ` * If something goes wrong while compiling the expression,this` |
|       - | 10453 | ` * function takes care of generating the appropriate error` |
|       - | 10454 | ` * message.` |
|       - | 10455 | ` */` |
|  825154 | 10456 | `static sxi32 PH7_CompileExpr(` |
|       - | 10457 | `	ph7_gen_state *pGen, /* Code generator state */` |
|       - | 10458 | `	sxi32 iFlags,        /* Control flags */` |
|       - | 10459 | `	sxi32 (*xTreeValidator)(ph7_gen_state *,ph7_expr_node *) /* Node validator callback.NULL otherwise */` |
|       - | 10460 | `	)` |
|       2 | 10461 |  |
|       - | 10462 | `	ph7_expr_node *pRoot;` |
|       - | 10463 | `	SySet sExprNode;` |
|       - | 10464 | `	SyToken *pEnd;` |
|       - | 10465 | `	sxi32 nExpr;` |
|       - | 10466 | `	sxi32 iNest;` |
|       - | 10467 | `	sxi32 rc;` |
|       - | 10468 | `	sxu32 nNullsafeBase;` |
|       - | 10469 | `	/* Initialize worker variables */` |
|  825156 | 10470 | `	nExpr = 0;` |
|  825156 | 10471 | `	pRoot = 0;` |
|       - | 10472 | `	/* Any nullsafe jumps still pending belong to an outer scope; isolate` |
|       - | 10473 | ``	 * this expression so its `?->` short-circuits don't leak out. */`` |
|  825156 | 10474 | `	nNullsafeBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  825156 | 10475 | `	SySetInit(&sExprNode,&pGen->pVm->sAllocator,sizeof(ph7_expr_node *));` |
|  825156 | 10476 | `	SySetAlloc(&sExprNode,0x10);` |
|  825156 | 10477 | `	rc = SXRET_OK;` |
|       - | 10478 | `	/* Delimit the expression */` |
|  825156 | 10479 | `	pEnd = pGen->pIn;` |
|  825156 | 10480 | `	iNest = 0;` |
| 5523340 | 10481 | `	while( pEnd < pGen->pEnd ){` |
| 5242612 | 10482 | `		if( pEnd->nType & PH7_TK_OCB /* '{' */ ){` |
|       - | 10483 | `			/* Ticket 1433-30: Annonymous/Closure functions body */` |
|     352 | 10484 | `			iNest++;` |
| 5242437 | 10485 | `		}else if(pEnd->nType & PH7_TK_CCB /* '}' */ ){` |
|     360 | 10486 | `			iNest--;` |
| 5242083 | 10487 | `		}else if( pEnd->nType & PH7_TK_SEMI /* ';' */ ){` |
|  544666 | 10488 | `			if( iNest <= 0 ){` |
|  544428 | 10489 | `				break;` |
|       - | 10490 | `			}` |
|     119 | 10491 | `		}` |
| 4698186 | 10492 | `		pEnd++;` |
|       2 | 10493 | `	}` |
|  825156 | 10494 | `	if( iFlags & EXPR_FLAG_COMMA_STATEMENT ){` |
|   19134 | 10495 | `		SyToken *pEnd2 = pGen->pIn;` |
|   19134 | 10496 | `		iNest = 0;` |
|       - | 10497 | `		/* Stop at the first comma */` |
|   38528 | 10498 | `		while( pEnd2 < pEnd ){` |
|   19400 | 10499 | `			if( pEnd2->nType & (PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*'['*/\|PH7_TK_LPAREN/*'('*/) ){` |
|      54 | 10500 | `				iNest++;` |
|   19374 | 10501 | `			}else if(pEnd2->nType & (PH7_TK_CCB/*'}'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_RPAREN/*')'*/)){` |
|      54 | 10502 | `				iNest--;` |
|   19322 | 10503 | `			}else if( pEnd2->nType & PH7_TK_COMMA /*','*/ ){` |
|      46 | 10504 | `				if( iNest <= 0 ){` |
|       5 | 10505 | `					break;` |
|       - | 10506 | `				}` |
|      20 | 10507 | `			}` |
|   19396 | 10508 | `			pEnd2++;` |
|       2 | 10509 | `		}` |
|   19134 | 10510 | `		if( pEnd2 <pEnd ){` |
|       5 | 10511 | `			pEnd = pEnd2;` |
|       2 | 10512 | `		}` |
|    9566 | 10513 | `	}` |
|  825156 | 10514 | `	if( pEnd > pGen->pIn ){` |
|  825146 | 10515 | `		SyToken *pTmp = pGen->pEnd;` |
|       - | 10516 | `		/* Swap delimiter */` |
|  825146 | 10517 | `		pGen->pEnd = pEnd;` |
|       - | 10518 | `		/* Try to get an expression tree */` |
|  825146 | 10519 | `		rc = PH7_ExprMakeTree(&(*pGen),&sExprNode,&pRoot);` |
|  825146 | 10520 | `		if( rc == SXRET_OK && pRoot ){` |
|  824964 | 10521 | `			rc = SXRET_OK;` |
|  824964 | 10522 | `			if( xTreeValidator ){` |
|       - | 10523 | `				/* Call the upper layer validator callback */` |
|   22980 | 10524 | `				rc = xTreeValidator(&(*pGen),pRoot);` |
|   11489 | 10525 | `			}` |
|  824964 | 10526 | `			if( rc != SXERR_ABORT ){` |
|       - | 10527 | `				/* Generate code for the given tree */` |
|  824964 | 10528 | `				rc = GenStateEmitExprCode(&(*pGen),pRoot,iFlags);` |
|       - | 10529 | `				/* Patch any unresolved nullsafe jumps emitted by this` |
|       - | 10530 | `				 * expression so they short-circuit to its end. */` |
|  824964 | 10531 | `				GenStatePatchNullsafeJumps(pGen, nNullsafeBase);` |
|  412481 | 10532 | `			}` |
|  824964 | 10533 | `			nExpr = 1;` |
|  412481 | 10534 | `		}` |
|       - | 10535 | `		/* Release the whole tree */` |
|  825146 | 10536 | `		PH7_ExprFreeTree(&(*pGen),&sExprNode);` |
|       - | 10537 | `		/* Synchronize token stream */` |
|  825146 | 10538 | `		pGen->pEnd = pTmp;` |
|  825146 | 10539 | `		pGen->pIn  = pEnd;` |
|  825146 | 10540 | `		if( rc == SXERR_ABORT ){` |
|      11 | 10541 | `			SySetRelease(&sExprNode);` |
|      11 | 10542 | `			return SXERR_ABORT;` |
|       - | 10543 | `		}` |
|  412567 | 10544 | `	}` |
|  825146 | 10545 | `	SySetRelease(&sExprNode);` |
|  825146 | 10546 | `	return nExpr > 0 ? SXRET_OK : SXERR_EMPTY;` |
|  412579 | 10547 |  |
|       - | 10548 | `/*` |
|       - | 10549 | ` * Return a pointer to the node construct handler associated` |
|       - | 10550 | ` * with a given node type [i.e: string,integer,float,...].` |
|       - | 10551 | ` */` |
|  208746 | 10552 | `PH7_PRIVATE ProcNodeConstruct PH7_GetNodeHandler(sxu32 nNodeType)` |
|       2 | 10553 |  |
|  208748 | 10554 | `	if( nNodeType & PH7_TK_NUM ){` |
|       - | 10555 | `		/* Numeric literal: Either real or integer */` |
|  110024 | 10556 | `		return PH7_CompileNumLiteral;` |
|   98726 | 10557 | `	}else if( nNodeType & PH7_TK_DSTR ){` |
|       - | 10558 | `		/* Double quoted string */` |
|   19624 | 10559 | `		return PH7_CompileString;` |
|   79104 | 10560 | `	}else if( nNodeType & PH7_TK_SSTR ){` |
|       - | 10561 | `		/* Single quoted string */` |
|   78992 | 10562 | `		return PH7_CompileSimpleString;` |
|     114 | 10563 | `	}else if( nNodeType & PH7_TK_HEREDOC ){` |
|       - | 10564 | `		/* Heredoc */` |
|      66 | 10565 | `		return PH7_CompileHereDoc;` |
|      50 | 10566 | `	}else if( nNodeType & PH7_TK_NOWDOC ){` |
|       - | 10567 | `		/* Nowdoc */` |
|      44 | 10568 | `		return PH7_CompileNowDoc;` |
|       7 | 10569 | `	}else if( nNodeType & PH7_TK_BSTR ){` |
|       - | 10570 | `		/* Backtick quoted string */` |
|       5 | 10571 | `		return PH7_CompileBacktic;` |
|       - | 10572 | `	}` |
|       3 | 10573 | `	return 0;` |
|  104375 | 10574 |  |
|       - | 10575 | `/*` |
|       - | 10576 | `` * Tree validator for unset() arguments — rejects any `?->` node in`` |
|       - | 10577 | ` * the argument expression with PHP's "Can't use nullsafe operator` |
|       - | 10578 | ` * in write context" parse error.` |
|       - | 10579 | ` */` |
|    6606 | 10580 | `static sxi32 GenStateUnsetValidator(ph7_gen_state *pGen, ph7_expr_node *pNode)` |
|       2 | 10581 |  |
|       - | 10582 | `	sxi32 rc;` |
|    6608 | 10583 | `	if( !PH7_ExprContainsNullsafe(pNode) ){` |
|    6606 | 10584 | `		return SXRET_OK;` |
|       - | 10585 | `	}` |
|       5 | 10586 | `	rc = PH7_GenCompileError(pGen,E_PARSE,` |
|       2 | 10587 | `		pNode ? pNode->pStart->nLine : 1,` |
|       - | 10588 | `		"Can't use nullsafe operator in write context");` |
|       3 | 10589 | `	return rc == SXERR_ABORT ? SXERR_ABORT : SXERR_SYNTAX;` |
|    3305 | 10590 |  |
|       - | 10591 | `/*` |
|       - | 10592 | ` * Compile an unset() statement.` |
|       - | 10593 | ` * unset($var, $arr[$key], ...);` |
|       - | 10594 | ` * Each argument is compiled with EXPR_FLAG_LOAD_IDX_STORE so that` |
|       - | 10595 | ` * PH7_OP_LOAD_IDX emits iP2=1, triggering COW separation on the` |
|       - | 10596 | ` * parent array before extracting the element to unset.` |
|       - | 10597 | ` */` |
|    2866 | 10598 | `static sxi32 PH7_CompileUnset(ph7_gen_state *pGen)` |
|       2 | 10599 |  |
|    2868 | 10600 | `	SyToken *pTmp,*pEnd,*pNext = 0;` |
|    2868 | 10601 | `	sxu32 nIdx = 0;` |
|       - | 10602 | `	SyString sName;` |
|       - | 10603 | `	sxi32 rc;` |
|       - | 10604 | `	/* Jump the 'unset' keyword */` |
|    2868 | 10605 | `	pGen->pIn++;` |
|       - | 10606 | `	/* Save delimiter */` |
|    2868 | 10607 | `	pTmp = pGen->pEnd;` |
|       - | 10608 | `	/* Skip optional opening parenthesis and find the matching close */` |
|    2868 | 10609 | `	pEnd = pTmp; /* Default: scan to statement end */` |
|    2868 | 10610 | `	if( pGen->pIn < pTmp && (pGen->pIn->nType & PH7_TK_LPAREN) ){` |
|       - | 10611 | `		/* Find matching ')' — start scanning AFTER the '(' */` |
|       - | 10612 | `		SyToken *pClose;` |
|    2868 | 10613 | `		pGen->pIn++;   /* Skip '(' */` |
|    2868 | 10614 | `		PH7_DelimitNestedTokens(pGen->pIn,pTmp,PH7_TK_LPAREN,PH7_TK_RPAREN,&pClose);` |
|    2868 | 10615 | `		pEnd = pClose; /* Stop at ')' */` |
|    1433 | 10616 | `	}` |
|    2868 | 10617 | `	SyStringInitFromBuf(&sName,"unset",sizeof("unset")-1);` |
|       - | 10618 | `	/* Resolve the 'unset' builtin name once */` |
|    2868 | 10619 | `	if( SXRET_OK != GenStateFindLiteral(&(*pGen),&sName,&nIdx) ){` |
|     354 | 10620 | `		ph7_value *pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|     354 | 10621 | `		if( pObj == 0 ){` |
|     ! 0 | 10622 | `			return SXERR_ABORT;` |
|       - | 10623 | `		}` |
|     354 | 10624 | `		PH7_MemObjInitFromString(pGen->pVm,pObj,&sName);` |
|     354 | 10625 | `		GenStateInstallLiteral(&(*pGen),pObj,nIdx);` |
|     176 | 10626 | `	}` |
|       - | 10627 | `	/* Compile each comma-separated argument */` |
|    9476 | 10628 | `	while( SXRET_OK == PH7_GetNextExpr(pGen->pIn,pEnd,&pNext) ){` |
|    6610 | 10629 | `		if( pGen->pIn < pNext ){` |
|    6610 | 10630 | `			pGen->pEnd = pNext;` |
|    6610 | 10631 | `			rc = PH7_CompileExpr(&(*pGen),` |
|       - | 10632 | `				EXPR_FLAG_RDONLY_LOAD\|EXPR_FLAG_LOAD_IDX_UNSET,` |
|       - | 10633 | `				GenStateUnsetValidator);` |
|    6610 | 10634 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 | 10635 | `				return SXERR_ABORT;` |
|       - | 10636 | `			}` |
|    6610 | 10637 | `			if( rc != SXERR_EMPTY ){` |
|       - | 10638 | `				/* Emit call for this single argument */` |
|    6608 | 10639 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|    6608 | 10640 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_CALL,1,0,GenStateAttachStrictFlag(pGen,0),0);` |
|    6608 | 10641 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|    3303 | 10642 | `			}` |
|    3304 | 10643 | `		}` |
|       - | 10644 | `		/* Jump trailing commas */` |
|   10354 | 10645 | `		while( pNext < pEnd && (pNext->nType & PH7_TK_COMMA) ){` |
|    3746 | 10646 | `			pNext++;` |
|       2 | 10647 | `		}` |
|    6610 | 10648 | `		pGen->pIn = pNext;` |
|       2 | 10649 | `	}` |
|       - | 10650 | `	/* Skip past the closing ')' if present */` |
|    2868 | 10651 | `	if( pGen->pIn < pTmp && (pGen->pIn->nType & PH7_TK_RPAREN) ){` |
|    2868 | 10652 | `		pGen->pIn++;` |
|    1433 | 10653 | `	}` |
|       - | 10654 | `	/* Restore token stream */` |
|    2868 | 10655 | `	pGen->pEnd = pTmp;` |
|    2868 | 10656 | `	return SXRET_OK;` |
|    1435 | 10657 |  |
|       - | 10658 | `/*` |
|       - | 10659 | ` * PHP Language construct table.` |
|       - | 10660 | ` */` |
|       - | 10661 | `static const LangConstruct aLangConstruct[] = {` |
|       - | 10662 | `	{ PH7_TKWRD_ECHO,     PH7_CompileEcho     }, /* echo language construct */` |
|       - | 10663 | `	{ PH7_TKWRD_IF,       PH7_CompileIf       }, /* if statement */` |
|       - | 10664 | `	{ PH7_TKWRD_FOR,      PH7_CompileFor      }, /* for statement */` |
|       - | 10665 | `	{ PH7_TKWRD_WHILE,    PH7_CompileWhile    }, /* while statement */` |
|       - | 10666 | `	{ PH7_TKWRD_FOREACH,  PH7_CompileForeach  }, /* foreach statement */` |
|       - | 10667 | `	{ PH7_TKWRD_FUNCTION, PH7_CompileFunction }, /* function statement */` |
|       - | 10668 | `	{ PH7_TKWRD_CONTINUE, PH7_CompileContinue }, /* continue statement */` |
|       - | 10669 | `	{ PH7_TKWRD_BREAK,    PH7_CompileBreak    }, /* break statement */` |
|       - | 10670 | `	{ PH7_TKWRD_RETURN,   PH7_CompileReturn   }, /* return statement */` |
|       - | 10671 | `	{ PH7_TKWRD_SWITCH,   PH7_CompileSwitch   }, /* Switch statement */` |
|       - | 10672 | `	{ PH7_TKWRD_DO,       PH7_CompileDoWhile  }, /* do{ }while(); statement */` |
|       - | 10673 | `	{ PH7_TKWRD_GLOBAL,   PH7_CompileGlobal   }, /* global statement */` |
|       - | 10674 | `	{ PH7_TKWRD_STATIC,   PH7_CompileStatic   }, /* static statement */` |
|       - | 10675 | `	{ PH7_TKWRD_DIE,      PH7_CompileHalt     }, /* die language construct */` |
|       - | 10676 | `	{ PH7_TKWRD_EXIT,     PH7_CompileHalt     }, /* exit language construct */` |
|       - | 10677 | `	{ PH7_TKWRD_TRY,      PH7_CompileTry      }, /* try statement */` |
|       - | 10678 | `	{ PH7_TKWRD_THROW,    PH7_CompileThrow    }, /* throw statement */` |
|       - | 10679 | `	{ PH7_TKWRD_GOTO,     PH7_CompileGoto     }, /* goto statement */` |
|       - | 10680 | `	{ PH7_TKWRD_CONST,    PH7_CompileConstant }, /* const statement */` |
|       - | 10681 | `	{ PH7_TKWRD_VAR,      PH7_CompileVar      }, /* var statement */` |
|       - | 10682 | `	{ PH7_TKWRD_NAMESPACE, PH7_CompileNamespace }, /* namespace statement */` |
|       - | 10683 | `	{ PH7_TKWRD_USE,      PH7_CompileUse      },  /* use statement */` |
|       - | 10684 | `	{ PH7_TKWRD_DECLARE,  PH7_CompileDeclare  },  /* declare statement */` |
|       - | 10685 | `	{ PH7_TKWRD_UNSET,    PH7_CompileUnset   }   /* unset statement */` |
|       - | 10686 | `};` |
|       - | 10687 | `/*` |
|       - | 10688 | ` * Return a pointer to the statement handler routine associated` |
|       - | 10689 | ` * with a given PHP keyword [i.e: if,for,while,...].` |
|       - | 10690 | ` */` |
|  513312 | 10691 | `static ProcLangConstruct GenStateGetStatementHandler(` |
|       - | 10692 | `	sxu32 nKeywordID,   /* Keyword  ID*/` |
|       - | 10693 | `	SyToken *pLookahed  /* Look-ahead token */` |
|       - | 10694 | `	)` |
|       2 | 10695 |  |
|  513314 | 10696 | `	sxu32 n = 0;` |
| 2330094 | 10697 | `	for(;;){` |
| 4660190 | 10698 | `		if( n >= SX_ARRAYSIZE(aLangConstruct) ){` |
|   76068 | 10699 | `			break;` |
|       - | 10700 | `		}` |
| 4584124 | 10701 | `		if( aLangConstruct[n].nID == nKeywordID ){` |
|  437248 | 10702 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed && (pLookahed->nType & PH7_TK_OP)){` |
|     ! 0 | 10703 | `				const ph7_expr_op *pOp = (const ph7_expr_op *)pLookahed->pUserData;` |
|     ! 0 | 10704 | `				if( pOp && pOp->iOp == EXPR_OP_DC /*::*/){` |
|       - | 10705 | `					/* 'static' (class context),return null */` |
|     ! 0 | 10706 | `					return 0;` |
|       - | 10707 | `				}` |
|     ! 0 | 10708 | `			}` |
|  437246 | 10709 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed` |
|       2 | 10710 | `				&& (pLookahed->nType & PH7_TK_KEYWORD)` |
|       3 | 10711 | `				&& SX_PTR_TO_INT(pLookahed->pUserData) == PH7_TKWRD_FN ){` |
|       - | 10712 | `				/* 'static fn(...)' arrow function — compile as expression */` |
|     ! 0 | 10713 | `				return 0;` |
|       - | 10714 | `			}` |
|       - | 10715 | `			/* Return a pointer to the handler.` |
|       - | 10716 | `			*/` |
|  437248 | 10717 | `			return aLangConstruct[n].xConstruct;` |
|       - | 10718 | `		}` |
| 4146878 | 10719 | `		n++;` |
|       2 | 10720 | `	}` |
|   76068 | 10721 | `	if( pLookahed ){` |
|   76068 | 10722 | `		if(nKeywordID == PH7_TKWRD_INTERFACE && (pLookahed->nType & PH7_TK_ID) ){` |
|   31266 | 10723 | `			return PH7_CompileClassInterface;` |
|   44804 | 10724 | `		}else if(nKeywordID == PH7_TKWRD_CLASS && (pLookahed->nType & PH7_TK_ID) ){` |
|   44586 | 10725 | `			return PH7_CompileClass;` |
|     220 | 10726 | `		}else if(nKeywordID == PH7_TKWRD_TRAIT && (pLookahed->nType & PH7_TK_ID) ){` |
|      58 | 10727 | `			return PH7_CompileTrait;` |
|     162 | 10728 | `		}else if( nKeywordID == PH7_TKWRD_ABSTRACT && (pLookahed->nType & PH7_TK_KEYWORD)` |
|      23 | 10729 | `			&& SX_PTR_TO_INT(pLookahed->pUserData) == PH7_TKWRD_CLASS ){` |
|      22 | 10730 | `				return PH7_CompileAbstractClass;` |
|     142 | 10731 | `		}else if( nKeywordID == PH7_TKWRD_FINAL && (pLookahed->nType & PH7_TK_KEYWORD)` |
|       5 | 10732 | `			&& SX_PTR_TO_INT(pLookahed->pUserData) == PH7_TKWRD_CLASS ){` |
|       3 | 10733 | `				return PH7_CompileFinalClass;` |
|       - | 10734 | `		}` |
|      70 | 10735 | `	}` |
|       - | 10736 | `	/* Not a language construct */` |
|     142 | 10737 | `	return 0;` |
|  256658 | 10738 |  |
|       - | 10739 | `/*` |
|       - | 10740 | ` * Check if the given keyword is in fact a PHP language construct.` |
|       - | 10741 | ` * Return TRUE on success. FALSE otheriwse.` |
|       - | 10742 | ` */` |
|     140 | 10743 | `static int GenStateisLangConstruct(sxu32 nKeyword)` |
|       2 | 10744 |  |
|       - | 10745 | `	int rc;` |
|     142 | 10746 | `	rc = PH7_IsLangConstruct(nKeyword,TRUE);` |
|     142 | 10747 | `	if( rc == FALSE ){` |
|      44 | 10748 | `		if( nKeyword == PH7_TKWRD_SELF \|\| nKeyword == PH7_TKWRD_PARENT \|\| nKeyword == PH7_TKWRD_STATIC` |
|      40 | 10749 | `			\|\| nKeyword == PH7_TKWRD_YIELD` |
|       - | 10750 | `			/*\|\| nKeyword == PH7_TKWRD_CLASS \|\| nKeyword == PH7_TKWRD_FINAL \|\| nKeyword == PH7_TKWRD_EXTENDS` |
|       - | 10751 | `			  \|\| nKeyword == PH7_TKWRD_ABSTRACT \|\| nKeyword == PH7_TKWRD_INTERFACE` |
|       - | 10752 | `			  \|\| nKeyword == PH7_TKWRD_PUBLIC \|\| nKeyword == PH7_TKWRD_PROTECTED` |
|       - | 10753 | `			  \|\| nKeyword == PH7_TKWRD_PRIVATE \|\| nKeyword == PH7_TKWRD_IMPLEMENTS` |
|       - | 10754 | `			*/` |
|       - | 10755 | `			){` |
|      38 | 10756 | `				rc = TRUE;` |
|      18 | 10757 | `		}` |
...
|       2 | 10760 |  |
|       - | 10761 | `/*` |
|       - | 10762 | ` * Compile a PHP chunk.` |
|       - | 10763 | ` * If something goes wrong while compiling the PHP chunk,this function` |
|       - | 10764 | ` * takes care of generating the appropriate error message.` |
|       - | 10765 | ` */` |
|  667504 | 10766 | `static sxi32 GenStateCompileChunk(` |
|       - | 10767 | `	ph7_gen_state *pGen, /* Code generator state */` |
|       - | 10768 | `	sxi32 iFlags         /* Compile flags */` |
|       - | 10769 | `	)` |
|       2 | 10770 |  |
|       - | 10771 | `	ProcLangConstruct xCons;` |
|       - | 10772 | `	sxi32 rc;` |
|  667506 | 10773 | `	rc = SXRET_OK; /* Prevent compiler warning */` |
|  476142 | 10774 | `	for(;;){` |
|  809896 | 10775 | `		int bStmtIsDeclare = 0;` |
|  809896 | 10776 | `		if( pGen->pIn >= pGen->pEnd ){` |
|       - | 10777 | `			/* No more input to process */` |
|   13020 | 10778 | `			break;` |
|       - | 10779 | `		}` |
|       - | 10780 | ``		/* Peek to detect a top-level `declare` so the strict_types lock`` |
|       - | 10781 | `		 * below doesn't fire before the directive has a chance to run. */` |
|  796878 | 10782 | `		if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|  513314 | 10783 | `			sxu32 nPeek = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  513314 | 10784 | `			if( nPeek == PH7_TKWRD_DECLARE ){` |
|      40 | 10785 | `				bStmtIsDeclare = 1;` |
|      19 | 10786 | `			}` |
|  256656 | 10787 | `		}` |
|  796878 | 10788 | `		if( !bStmtIsDeclare && pGen->pCurrent == &pGen->sGlobal ){` |
|       - | 10789 | `			/* Any non-declare top-level statement locks the strict_types` |
|       - | 10790 | `			 * directive: it's now too late for declare(strict_types=1). */` |
|  142364 | 10791 | `			pGen->bStrictTypesLocked = 1;` |
|   71181 | 10792 | `		}` |
|  796878 | 10793 | `		if( pGen->pIn->nType & PH7_TK_OCB /* '{' */ ){` |
|       - | 10794 | `			/* Compile block */` |
|      18 | 10795 | `			rc = PH7_CompileBlock(&(*pGen),0);` |
|      18 | 10796 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 | 10797 | `				break;` |
|       - | 10798 | `			}` |
|      10 | 10799 | `		}else{` |
|  796862 | 10800 | `			xCons = 0;` |
|  796862 | 10801 | `			if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|  513314 | 10802 | `				sxu32 nKeyword = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|       - | 10803 | `				/* Try to extract a language construct handler */` |
|  513314 | 10804 | `				xCons = GenStateGetStatementHandler(nKeyword,(&pGen->pIn[1] < pGen->pEnd) ? &pGen->pIn[1] : 0);` |
|  513314 | 10805 | `				if( xCons == 0 && GenStateisLangConstruct(nKeyword) == FALSE ){` |
|      13 | 10806 | `					rc = PH7_GenCompileError(pGen,E_ERROR,pGen->pIn->nLine,` |
|       - | 10807 | `						"Syntax error: Unexpected keyword '%z'",` |
|       8 | 10808 | `						&pGen->pIn->sData);` |
|       9 | 10809 | `					if( rc == SXERR_ABORT ){` |
|     ! 0 | 10810 | `						break;` |
|       - | 10811 | `					}` |
|       - | 10812 | `					/* Synchronize with the first semi-colon and avoid compiling` |
|       - | 10813 | `					 * this erroneous statement.` |
|       - | 10814 | `					 */` |
|       9 | 10815 | `					xCons = PH7_ErrorRecover;` |
|       4 | 10816 | `				}` |
|  540206 | 10817 | `			}else if( (pGen->pIn->nType & PH7_TK_ID) && (&pGen->pIn[1] < pGen->pEnd)` |
|   46404 | 10818 | `				&& (pGen->pIn[1].nType & PH7_TK_COLON /*':'*/) ){` |
|       - | 10819 | `				/* Label found [i.e: Out: ],point to the routine responsible of compiling it */` |
|     114 | 10820 | `				xCons = PH7_CompileLabel;` |
|      56 | 10821 | `			}` |
|  796862 | 10822 | `			if( xCons == 0 ){` |
|       - | 10823 | `				/* Assume an expression an try to compile it */` |
|  283570 | 10824 | `				rc = PH7_CompileExpr(&(*pGen),0,0);` |
|  283570 | 10825 | `				if(  rc != SXERR_EMPTY ){` |
|       - | 10826 | `					/* Pop l-value */` |
|  283420 | 10827 | `					PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|  141709 | 10828 | `				}` |
|  141786 | 10829 | `			}else{` |
|       - | 10830 | `				/* Go compile the sucker */` |
|  513294 | 10831 | `				rc = xCons(&(*pGen));` |
|       - | 10832 | `			}` |
|  796862 | 10833 | `			if( rc == SXERR_ABORT ){` |
|       - | 10834 | `				/* Request to abort compilation */` |
|      11 | 10835 | `				break;` |
|       - | 10836 | `			}` |
|       - | 10837 | `		}` |
|       - | 10838 | `		/* Ignore trailing semi-colons ';' */` |
| 1316268 | 10839 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|  519402 | 10840 | `			pGen->pIn++;` |
|       2 | 10841 | `		}` |
|  796868 | 10842 | `		if( iFlags & PH7_COMPILE_SINGLE_STMT ){` |
|       - | 10843 | `			/* Compile a single statement and return */` |
|  654478 | 10844 | `			break;` |
|       - | 10845 | `		}` |
|       - | 10846 | `		/* LOOP ONE */` |
|       - | 10847 | `		/* LOOP TWO */` |
...
|       - | 10849 | `		/* LOOP FOUR */` |
|       2 | 10850 | `	}` |
|       - | 10851 | `	/* Return compilation status */` |
|  667506 | 10852 | `	return rc;` |
|       2 | 10853 |  |
|       - | 10854 | `/*` |
|       - | 10855 | ` * Compile a Raw PHP chunk.` |
|       - | 10856 | ` * If something goes wrong while compiling the PHP chunk,this function` |
|       - | 10857 | ` * takes care of generating the appropriate error message.` |
|       - | 10858 | ` */` |
|   13030 | 10859 | `static sxi32 PH7_CompilePHP(` |
|       - | 10860 | `	ph7_gen_state *pGen,  /* Code generator state */` |
|       - | 10861 | `	SySet *pTokenSet,     /* Token set */` |
|       - | 10862 | `	int is_expr           /* TRUE if we are dealing with a simple expression */` |
|       - | 10863 | `	)` |
|       2 | 10864 |  |
|   13032 | 10865 | `	SyToken *pScript = pGen->pRawIn; /* Script to compile */` |
|       - | 10866 | `	sxi32 rc;` |
|       - | 10867 | `	/* Reset the token set */` |
|   13032 | 10868 | `	SySetReset(&(*pTokenSet));` |
|       - | 10869 | `	/* Mark as the default token set */` |
|   13032 | 10870 | `	pGen->pTokenSet = &(*pTokenSet);` |
|       - | 10871 | `	/* Advance the stream cursor */` |
|   13032 | 10872 | `	pGen->pRawIn++;` |
|       - | 10873 | `	/* Tokenize the PHP chunk first */` |
|   13032 | 10874 | `	PH7_TokenizePHP(SyStringData(&pScript->sData),SyStringLength(&pScript->sData),pScript->nLine,&(*pTokenSet));` |
|       - | 10875 | `	/* Point to the head and tail of the token stream. */` |
|   13032 | 10876 | `	pGen->pIn  = (SyToken *)SySetBasePtr(pTokenSet);` |
|   13032 | 10877 | `	pGen->pEnd = &pGen->pIn[SySetUsed(pTokenSet)];` |
|   13032 | 10878 | `	if( is_expr ){` |
|     ! 0 | 10879 | `		rc = SXERR_EMPTY;` |
|     ! 0 | 10880 | `		if( pGen->pIn < pGen->pEnd ){` |
|       - | 10881 | `			/* A simple expression,compile it */` |
|     ! 0 | 10882 | `			rc = PH7_CompileExpr(pGen,0,0);` |
|     ! 0 | 10883 | `		}` |
|       - | 10884 | `		/* Emit the DONE instruction */` |
|     ! 0 | 10885 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,(rc != SXERR_EMPTY ? 1 : 0),0,0,0);` |
|     ! 0 | 10886 | `		return SXRET_OK;` |
|       - | 10887 | `	}` |
|   13032 | 10888 | `	if( pGen->pIn < pGen->pEnd && ( pGen->pIn->nType & PH7_TK_EQUAL ) ){` |
|       - | 10889 | `		static const sxu32 nKeyID = PH7_TKWRD_ECHO;` |
|       - | 10890 | `		/*` |
|       - | 10891 | `		 * Shortcut syntax for the 'echo' language construct.` |
|       - | 10892 | `		 * According to the PHP reference manual:` |
|       - | 10893 | `		 *  echo() also has a shortcut syntax, where you can` |
|       - | 10894 | `		 *  immediately follow` |
|       - | 10895 | `		 *  the opening tag with an equals sign as follows:` |
|       - | 10896 | `		 *  <?= 4+5?> is the same as <?echo 4+5?>` |
|       - | 10897 | `		 * Symisc extension:` |
|       - | 10898 | `		 *   This short syntax works with all PHP opening` |
|       - | 10899 | `		 *   tags unlike the default PHP engine that handle` |
|       - | 10900 | `		 *   only short tag.` |
|       - | 10901 | `		 */` |
|       - | 10902 | `		/* Ticket 1433-009: Emulate the 'echo' call */` |
|       3 | 10903 | `		pGen->pIn->nType = PH7_TK_KEYWORD;` |
|       3 | 10904 | `		pGen->pIn->pUserData = SX_INT_TO_PTR(nKeyID);` |
|       3 | 10905 | `		SyStringInitFromBuf(&pGen->pIn->sData,"echo",sizeof("echo")-1);` |
|       3 | 10906 | `		rc = PH7_CompileExpr(pGen,0,0);` |
|       3 | 10907 | `		if( rc != SXERR_EMPTY ){` |
|       3 | 10908 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|       1 | 10909 | `		}` |
|       3 | 10910 | `		return SXRET_OK;` |
|       - | 10911 | `	}` |
|       - | 10912 | `	/* Compile the PHP chunk */` |
|   13030 | 10913 | `	rc = GenStateCompileChunk(pGen,0);` |
|       - | 10914 | `	/* Fix exceptions jumps */` |
|   13030 | 10915 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|       - | 10916 | `	/* Fix gotos now, the jump destination is resolved */` |
|   13030 | 10917 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),0) ){` |
|       3 | 10918 | `		rc = SXERR_ABORT;` |
|       1 | 10919 | `	}` |
|       - | 10920 | `	/* Reset container */` |
|   13030 | 10921 | `	SySetReset(&pGen->aGoto);` |
|   13030 | 10922 | `	SySetReset(&pGen->aLabel);` |
|   13030 | 10923 | `	SySetReset(&pGen->aNullsafeJmp);` |
|       - | 10924 | `	/* Compilation result */` |
|   13030 | 10925 | `	return rc;` |
|    6517 | 10926 |  |
|       - | 10927 | `/*` |
|       - | 10928 | ` * Compile a raw chunk. The raw chunk can contain PHP code embedded` |
|       - | 10929 | ` * in HTML, XML and so on. This function handle all the stuff.` |
|       - | 10930 | ` * This is the only compile interface exported from this file.` |
|       - | 10931 | ` */` |
|   15596 | 10932 | `PH7_PRIVATE sxi32 PH7_CompileScript(` |
|       - | 10933 | `	ph7_vm *pVm,        /* Generate PH7 byte-codes for this Virtual Machine */` |
|       - | 10934 | `	SyString *pScript,  /* Script to compile */` |
|       - | 10935 | `	sxi32 iFlags        /* Compile flags */` |
|       - | 10936 | `	)` |
|       2 | 10937 |  |
|       - | 10938 | `	SySet aPhpToken,aRawToken;` |
|       - | 10939 | `	ph7_gen_state *pCodeGen;` |
|       - | 10940 | `	ph7_value *pRawObj;` |
|       - | 10941 | `	sxu32 nObjIdx;` |
|       - | 10942 | `	sxi32 nRawObj;` |
|       - | 10943 | `	int is_expr;` |
|       - | 10944 | `	sxi8 bSavedStrict;` |
|       - | 10945 | `	sxi8 bSavedStrictLocked;` |
|       - | 10946 | `	sxi32 rc;` |
|   15598 | 10947 | `	if( pScript->nByte < 1 ){` |
|       - | 10948 | `		/* Nothing to compile */` |
|     ! 0 | 10949 | `		return PH7_OK;` |
|       - | 10950 | `	}` |
|       - | 10951 | `	/* Each compiled file has its own strict_types scope. Save the outer` |
|       - | 10952 | `	 * file's flags so include/require restore them on return. */` |
|   15598 | 10953 | `	pCodeGen = &pVm->sCodeGen;` |
|   15598 | 10954 | `	bSavedStrict = pCodeGen->bStrictTypes;` |
|   15598 | 10955 | `	bSavedStrictLocked = pCodeGen->bStrictTypesLocked;` |
|   15598 | 10956 | `	pCodeGen->bStrictTypes = 0;` |
|   15598 | 10957 | `	pCodeGen->bStrictTypesLocked = 0;` |
|       - | 10958 | `	/* Initialize the tokens containers */` |
|   15598 | 10959 | `	SySetInit(&aRawToken,&pVm->sAllocator,sizeof(SyToken));` |
|   15598 | 10960 | `	SySetInit(&aPhpToken,&pVm->sAllocator,sizeof(SyToken));` |
|   15598 | 10961 | `	SySetAlloc(&aPhpToken,0xc0);` |
|   15598 | 10962 | `	is_expr = 0;` |
|   15598 | 10963 | `	if( iFlags & PH7_PHP_ONLY ){` |
|       - | 10964 | `		SyToken sTmp;` |
|       - | 10965 | `		/* PHP only: -*/` |
|    3152 | 10966 | `		sTmp.nLine = 1;` |
|    3152 | 10967 | `		sTmp.nType = PH7_TOKEN_PHP;` |
|    3152 | 10968 | `		sTmp.pUserData = 0;` |
|    3152 | 10969 | `		SyStringDupPtr(&sTmp.sData,pScript);` |
|    3152 | 10970 | `		SySetPut(&aRawToken,(const void *)&sTmp);` |
|    3152 | 10971 | `		if( iFlags & PH7_PHP_EXPR ){` |
|       - | 10972 | `			/* A simple PHP expression */` |
|     ! 0 | 10973 | `			is_expr = 1;` |
|     ! 0 | 10974 | `		}` |
|    1577 | 10975 | `	}else{` |
|       - | 10976 | `		/* Tokenize raw text */` |
|   12448 | 10977 | `		SySetAlloc(&aRawToken,32);` |
|   12448 | 10978 | `		PH7_TokenizeRawText(pScript->zString,pScript->nByte,&aRawToken);` |
|       - | 10979 | `	}` |
|       - | 10980 | `	/* Process high-level tokens */` |
|   15598 | 10981 | `	pCodeGen->pRawIn = (SyToken *)SySetBasePtr(&aRawToken);` |
|   15598 | 10982 | `	pCodeGen->pRawEnd = &pCodeGen->pRawIn[SySetUsed(&aRawToken)];` |
|   15598 | 10983 | `	rc = PH7_OK;` |
|   15598 | 10984 | `	if( is_expr ){` |
|       - | 10985 | `		/* Compile the expression */` |
|     ! 0 | 10986 | `		rc = PH7_CompilePHP(pCodeGen,&aPhpToken,TRUE);` |
|     ! 0 | 10987 | `		goto cleanup;` |
|       - | 10988 | `	}` |
|   15598 | 10989 | `	nObjIdx = 0;` |
|       - | 10990 | `	/* Each compilation unit starts in the global namespace.` |
|       - | 10991 | `	 * Emit NSSWITCH(NULL) so the VM resets namespace state at runtime,` |
|       - | 10992 | `	 * preventing namespace bleeding across include()d files. */` |
|   15598 | 10993 | `	PH7_VmEmitInstr(pVm,PH7_OP_NSSWITCH,0,0,0,0);` |
|       - | 10994 | `	/* Start the compilation process */` |
|   14025 | 10995 | `	for(;;){` |
|   41070 | 10996 | `		if( pCodeGen->pRawIn >= pCodeGen->pRawEnd ){` |
|   15586 | 10997 | `			break; /* No more tokens to process */` |
|       - | 10998 | `		}` |
|   25486 | 10999 | `		if( pCodeGen->pRawIn->nType & PH7_TOKEN_PHP ){` |
|       - | 11000 | `			/* Compile the PHP chunk */` |
|   13032 | 11001 | `			rc = PH7_CompilePHP(pCodeGen,&aPhpToken,FALSE);` |
|   13032 | 11002 | `			if( rc == SXERR_ABORT ){` |
|      13 | 11003 | `				break;` |
|       - | 11004 | `			}` |
|   13020 | 11005 | `			continue;` |
|       - | 11006 | `		}` |
|       - | 11007 | `		/* Raw chunk: [i.e: HTML, XML, etc.] */` |
|   12456 | 11008 | `		nRawObj = 0;` |
|   24910 | 11009 | `		while( (pCodeGen->pRawIn < pCodeGen->pRawEnd) && (pCodeGen->pRawIn->nType != PH7_TOKEN_PHP) ){` |
|       - | 11010 | `			/* Consume the raw chunk without any processing */` |
|   12456 | 11011 | `			pRawObj = PH7_ReserveConstObj(&(*pVm),&nObjIdx);` |
|   12456 | 11012 | `			if( pRawObj == 0 ){` |
|     ! 0 | 11013 | `				rc = SXERR_MEM;` |
|     ! 0 | 11014 | `				break;` |
|       - | 11015 | `			}` |
|       - | 11016 | `			/* Mark as constant and emit the load constant instruction */` |
|   12456 | 11017 | `			PH7_MemObjInitFromString(pVm,pRawObj,&pCodeGen->pRawIn->sData);` |
|   12456 | 11018 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_LOADC,0,nObjIdx,0,0);` |
|   12456 | 11019 | `			++nRawObj;` |
|   12456 | 11020 | `			pCodeGen->pRawIn++; /* Next chunk */` |
|       2 | 11021 | `		}` |
|   12456 | 11022 | `		if( nRawObj > 0 ){` |
|       - | 11023 | `			/* Emit the consume instruction */` |
|   12456 | 11024 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_CONSUME,nRawObj,0,0,0);` |
|    6227 | 11025 | `		}` |
|    7800 | 11026 | `	}` |
|    7798 | 11027 | `cleanup:` |
|   15598 | 11028 | `	SySetRelease(&aRawToken);` |
|   15598 | 11029 | `	SySetRelease(&aPhpToken);` |
|       - | 11030 | `	/* Restore outer file's strict_types scope */` |
|   15598 | 11031 | `	pCodeGen->bStrictTypes = bSavedStrict;` |
|   15598 | 11032 | `	pCodeGen->bStrictTypesLocked = bSavedStrictLocked;` |
|   15598 | 11033 | `	return rc;` |
|    7800 | 11034 |  |
|       - | 11035 | `/*` |
|       - | 11036 | ` * Utility routines.Initialize the code generator.` |
|       - | 11037 | ` */` |
|    3122 | 11038 | `PH7_PRIVATE sxi32 PH7_InitCodeGenerator(` |
|       - | 11039 | `	ph7_vm *pVm,       /* Target VM */` |
|       - | 11040 | `	ProcConsumer xErr, /* Error log consumer callabck  */` |
|       - | 11041 | `	void *pErrData     /* Last argument to xErr() */` |
|       - | 11042 | `	)` |
|       2 | 11043 |  |
|    3124 | 11044 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|       - | 11045 | `	/* Zero the structure */` |
|    3124 | 11046 | `	SyZero(pGen,sizeof(ph7_gen_state));` |
|       - | 11047 | `	/* Initial state */` |
|    3124 | 11048 | `	pGen->pVm  = &(*pVm);` |
|    3124 | 11049 | `	pGen->xErr = xErr;` |
|    3124 | 11050 | `	pGen->pErrData = pErrData;` |
|    3124 | 11051 | `	SySetInit(&pGen->aLabel,&pVm->sAllocator,sizeof(Label));` |
|    3124 | 11052 | `	SySetInit(&pGen->aGoto,&pVm->sAllocator,sizeof(JumpFixup));` |
|    3124 | 11053 | `	SySetInit(&pGen->aNullsafeJmp,&pVm->sAllocator,sizeof(sxu32));` |
|    3124 | 11054 | `	SyHashInit(&pGen->hLiteral,&pVm->sAllocator,0,0);` |
|    3124 | 11055 | `	SyHashInit(&pGen->hVar,&pVm->sAllocator,0,0);` |
|       - | 11056 | `	/* Error log buffer */` |
|    3124 | 11057 | `	SyBlobInit(&pGen->sErrBuf,&pVm->sAllocator);` |
|       - | 11058 | `	/* General purpose working buffer */` |
|    3124 | 11059 | `	SyBlobInit(&pGen->sWorker,&pVm->sAllocator);` |
|       - | 11060 | `	/* Namespace state */` |
|    3124 | 11061 | `	SyBlobInit(&pGen->sNamespace,&pVm->sAllocator);` |
|    3124 | 11062 | `	SyHashInit(&pGen->hUseImports,&pVm->sAllocator,0,0);` |
|    3124 | 11063 | `	SyHashInit(&pGen->hUseFuncImports,&pVm->sAllocator,0,0);` |
|    3124 | 11064 | `	SyHashInit(&pGen->hUseConstImports,&pVm->sAllocator,0,0);` |
|       - | 11065 | `	/* Create the global scope */` |
|    3124 | 11066 | `	GenStateInitBlock(pGen,&pGen->sGlobal,GEN_BLOCK_GLOBAL,PH7_VmInstrLength(&(*pVm)),0);` |
|       - | 11067 | `	/* Point to the global scope */` |
|    3124 | 11068 | `	pGen->pCurrent = &pGen->sGlobal;` |
|    3124 | 11069 | `	return SXRET_OK;` |
|       2 | 11070 |  |
|       - | 11071 | `/*` |
|       - | 11072 | ` * Utility routines. Reset the code generator to it's initial state.` |
|       - | 11073 | ` */` |
|   18404 | 11074 | `PH7_PRIVATE sxi32 PH7_ResetCodeGenerator(` |
|       - | 11075 | `	ph7_vm *pVm,       /* Target VM */` |
|       - | 11076 | `	ProcConsumer xErr, /* Error log consumer callabck  */` |
|       - | 11077 | `	void *pErrData     /* Last argument to xErr() */` |
|       - | 11078 | `	)` |
|       2 | 11079 |  |
|   18406 | 11080 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|       - | 11081 | `	GenBlock *pBlock,*pParent;` |
|       - | 11082 | `	/* Reset state */` |
|   18406 | 11083 | `	SySetReset(&pGen->aLabel);` |
|   18406 | 11084 | `	SySetReset(&pGen->aGoto);` |
|   18406 | 11085 | `	SySetReset(&pGen->aNullsafeJmp);` |
|   18406 | 11086 | `	SyBlobRelease(&pGen->sErrBuf);` |
|   18406 | 11087 | `	SyBlobRelease(&pGen->sWorker);` |
|   18406 | 11088 | `	SyBlobRelease(&pGen->sNamespace);` |
|   18406 | 11089 | `	SyBlobInit(&pGen->sNamespace,&pVm->sAllocator);` |
|   18406 | 11090 | `	SyHashRelease(&pGen->hUseImports);` |
|   18406 | 11091 | `	SyHashInit(&pGen->hUseImports,&pVm->sAllocator,0,0);` |
|   18406 | 11092 | `	SyHashRelease(&pGen->hUseFuncImports);` |
|   18406 | 11093 | `	SyHashInit(&pGen->hUseFuncImports,&pVm->sAllocator,0,0);` |
|   18406 | 11094 | `	SyHashRelease(&pGen->hUseConstImports);` |
|   18406 | 11095 | `	SyHashInit(&pGen->hUseConstImports,&pVm->sAllocator,0,0);` |
|       - | 11096 | `	/* Note: pGen->hVar and pGen->hLiteral are intentionally NOT reset here.` |
|       - | 11097 | `	 * They intern variable names and literal strings that are referenced by` |
|       - | 11098 | `	 * compiled bytecode (pInstr->p3) and runtime frame hash tables (pFrame->hVar).` |
|       - | 11099 | `	 * Releasing them would either leak the interned strings or require freeing` |
|       - | 11100 | `	 * memory still in use.  The entries use pool memory but are bounded by the` |
|       - | 11101 | `	 * number of unique names, which is acceptable. */` |
|       - | 11102 | `	/* Point to the global scope */` |
|   18406 | 11103 | `	pBlock = pGen->pCurrent;` |
|   18406 | 11104 | `	while( pBlock->pParent != 0 ){` |
|     ! 0 | 11105 | `		pParent = pBlock->pParent;` |
|     ! 0 | 11106 | `		GenStateFreeBlock(pBlock);` |
|     ! 0 | 11107 | `		pBlock = pParent;` |
|     ! 0 | 11108 | `	}` |
|   18406 | 11109 | `	pGen->xErr = xErr;` |
|   18406 | 11110 | `	pGen->pErrData = pErrData;` |
|   18406 | 11111 | `	pGen->pCurrent = &pGen->sGlobal;` |
|   18406 | 11112 | `	pGen->pRawIn = pGen->pRawEnd = 0;` |
|   18406 | 11113 | `	pGen->pIn = pGen->pEnd = 0;` |
|   18406 | 11114 | `	pGen->nErr = 0;` |
|   18406 | 11115 | `	return SXRET_OK;` |
|       2 | 11116 |  |
|       - | 11117 | `/*` |
|       - | 11118 | ` * Generate a compile-time error message.` |
|       - | 11119 | ` * If the error count limit is reached (usually 15 error message)` |
|       - | 11120 | ` * this function return SXERR_ABORT.In that case upper-layers must` |
|       - | 11121 | ` * abort compilation immediately.` |
|       - | 11122 | ` */` |
|     574 | 11123 | `PH7_PRIVATE sxi32 PH7_GenCompileError(ph7_gen_state *pGen,sxi32 nErrType,sxu32 nLine,const char *zFormat,...)` |
|       2 | 11124 |  |
|     576 | 11125 | `	SyBlob *pWorker = &pGen->sErrBuf;` |
|     576 | 11126 | `	const char *zErr = "Error";` |
|       - | 11127 | `	SyString *pFile;` |
|       - | 11128 | `	va_list ap;` |
|       - | 11129 | `	sxi32 rc;` |
|       - | 11130 | `	/* Reset the working buffer */` |
|     576 | 11131 | `	SyBlobReset(pWorker);` |
|       - | 11132 | `	/* Peek the processed file path if available */` |
|     576 | 11133 | `	pFile = (SyString *)SySetPeek(&pGen->pVm->aFiles);` |
|     576 | 11134 | `	if( nErrType == E_ERROR ){` |
|       - | 11135 | `		/* Increment the error counter */` |
|     470 | 11136 | `		pGen->nErr++;` |
|     470 | 11137 | `		if( pGen->nErr > 15 ){` |
|       - | 11138 | `			/* Error count limit reached */` |
|       5 | 11139 | `			if( pGen->xErr ){` |
|       5 | 11140 | `				SyBlobAppend(pWorker,"PHP ",4);` |
|       5 | 11141 | `				SyBlobFormat(pWorker,"Fatal error:  Error count limit reached,PH7 is aborting compilation");` |
|       5 | 11142 | `				if( pFile ){` |
|       5 | 11143 | `					SyBlobFormat(pWorker," in %.*s on line %u",pFile->nByte,pFile->zString,nLine);` |
|       2 | 11144 | `				}` |
|       5 | 11145 | `				SyBlobAppend(pWorker,(const void *)"\n",sizeof(char));` |
|       5 | 11146 | `				if( SyBlobLength(pWorker) > 0 ){` |
|       5 | 11147 | `					pGen->xErr(SyBlobData(pWorker),SyBlobLength(pWorker),pGen->pErrData);` |
|       2 | 11148 | `				}` |
|       2 | 11149 | `			}` |
|       - | 11150 | `			/* Abort immediately */` |
|       5 | 11151 | `			return SXERR_ABORT;` |
|       - | 11152 | `		}` |
|     232 | 11153 | `	}` |
|     572 | 11154 | `	if( pGen->xErr == 0 ){` |
|       - | 11155 | `		/* No available error consumer,return immediately */` |
|       3 | 11156 | `		return SXRET_OK;` |
|       - | 11157 | `	}` |
|     569 | 11158 | `	switch(nErrType){` |
|     463 | 11159 | `	case E_ERROR:   zErr = "Fatal error"; break;` |
|      27 | 11160 | `	case E_WARNING: zErr = "Warning";     break;` |
|      73 | 11161 | `	case E_PARSE:   zErr = "Parse error"; break;` |
|       9 | 11162 | `	case E_NOTICE:  zErr = "Notice";      break;` |
|     ! 0 | 11163 | `	case E_USER_ERROR:   zErr = "User error";   break;` |
|     ! 0 | 11164 | `	case E_USER_WARNING: zErr = "User warning"; break;` |
|     ! 0 | 11165 | `	case E_USER_NOTICE:  zErr = "User notice";  break;` |
|     ! 0 | 11166 | `	default:` |
|     ! 0 | 11167 | `		break;` |
|       - | 11168 | `	}` |
|     569 | 11169 | `	rc = SXRET_OK;` |
|       - | 11170 | `	/* Format: PHP <severity>:  <message> in <file> on line <line> */` |
|     569 | 11171 | `	SyBlobAppend(pWorker,"PHP ",4);` |
|     569 | 11172 | `	SyBlobFormat(pWorker,"%s:  ",zErr);` |
|     569 | 11173 | `	va_start(ap,zFormat);` |
|     569 | 11174 | `	SyBlobFormatAp(pWorker,zFormat,ap);` |
|     569 | 11175 | `	va_end(ap);` |
|     569 | 11176 | `	if( pFile ){` |
|     569 | 11177 | `		SyBlobFormat(pWorker," in %.*s on line %u",pFile->nByte,pFile->zString,nLine);` |
|     284 | 11178 | `	}` |
|       - | 11179 | `	/* Append a new line */` |
|     569 | 11180 | `	SyBlobAppend(pWorker,(const void *)"\n",sizeof(char));` |
|     569 | 11181 | `	if( SyBlobLength(pWorker) > 0 ){` |
|       - | 11182 | `		/* Consume the generated error message */` |
|     569 | 11183 | `		pGen->xErr(SyBlobData(pWorker),SyBlobLength(pWorker),pGen->pErrData);` |
|     284 | 11184 | `	}` |
|     569 | 11185 | `	return rc;` |
|     289 | 11186 |  |
|       - | 11187 |  |
