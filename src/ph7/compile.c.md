...
|       - |   130 | ` */` |
|    3558 |   131 | `static GenBlock * GenStateFetchBlock(GenBlock *pCurrent,sxi32 iBlockType,sxi32 iCount)` |
|       5 |   132 |  |
|    3563 |   133 | `	GenBlock *pBlock = pCurrent;` |
|   10091 |   134 | `	for(;;){` |
|   20187 |   135 | `		if( pBlock->iFlags & iBlockType ){` |
|    3455 |   136 | `			iCount--; /* Decrement nesting level */` |
|    3455 |   137 | `			if( iCount < 1 ){` |
|       - |   138 | `				/* Block meet with the desired criteria */` |
|    3429 |   139 | `				return pBlock;` |
|       - |   140 | `			}` |
|      13 |   141 | `		}` |
|       - |   142 | `		/* Point to the upper block */` |
|   16763 |   143 | `		pBlock = pBlock->pParent;` |
|   16763 |   144 | `		if( pBlock == 0 \|\| (pBlock->iFlags & (GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC)) ){` |
|       - |   145 | `			/* Forbidden */` |
|      72 |   146 | `			break;` |
|       - |   147 | `		}` |
|       5 |   148 | `	}` |
...
|       - |   154 | ` */` |
|  774170 |   155 | `static void GenStateInitBlock(` |
...
|  774175 |   164 | `	pBlock->nFirstInstr = nFirstInstr;` |
|  774175 |   165 | `	pBlock->pUserData   = pUserData;` |
|  774175 |   166 | `	pBlock->pGen        = pGen;` |
|  774175 |   167 | `	pBlock->iFlags      = iType;` |
|  774175 |   168 | `	pBlock->pParent     = 0;` |
|  774175 |   169 | `	SySetInit(&pBlock->aJumpFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  774175 |   170 | `	SySetInit(&pBlock->aPostContFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  774175 |   171 |  |
|       - |   172 | `/*` |
...
|       - |   177 | ` */` |
|  770890 |   178 | `static sxi32 GenStateEnterBlock(` |
...
|  770895 |   188 | `	pBlock = (GenBlock *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(GenBlock));` |
|  770895 |   189 | `	if( pBlock == 0 ){` |
...
|  770895 |   198 | `	SyZero(pBlock,sizeof(GenBlock));` |
|  770895 |   199 | `	GenStateInitBlock(&(*pGen),pBlock,iType,nFirstInstr,pUserData);` |
|       - |   200 | `	/* Link to the parent block */` |
|  770895 |   201 | `	pBlock->pParent = pGen->pCurrent;` |
|       - |   202 | `	/* Mark as the current block */` |
|  770895 |   203 | `	pGen->pCurrent = pBlock;` |
|  770895 |   204 | `	if( ppBlock ){` |
|       - |   205 | `		/* Write a pointer to the new instance */` |
|  374417 |   206 | `		*ppBlock = pBlock;` |
|  187206 |   207 | `	}` |
|  770895 |   208 | `	return SXRET_OK;` |
|  385450 |   209 |  |
|       - |   210 | `/*` |
|       - |   211 | ` * Release block fields without freeing the whole instance.` |
|       - |   212 | ` */` |
|  770882 |   213 | `static void GenStateReleaseBlock(GenBlock *pBlock)` |
|       5 |   214 |  |
|  770887 |   215 | `	SySetRelease(&pBlock->aPostContFix);` |
|  770887 |   216 | `	SySetRelease(&pBlock->aJumpFix);` |
|  770887 |   217 |  |
|       - |   218 | `/*` |
|       - |   219 | ` * Release a block.` |
|       - |   220 | ` */` |
|  770882 |   221 | `static void GenStateFreeBlock(GenBlock *pBlock)` |
|       5 |   222 |  |
|  770887 |   223 | `	ph7_gen_state *pGen = pBlock->pGen;` |
|  770887 |   224 | `	GenStateReleaseBlock(&(*pBlock));` |
|       - |   225 | `	/* Free the instance */` |
|  770887 |   226 | `	SyMemBackendPoolFree(&pGen->pVm->sAllocator,pBlock);` |
|  770887 |   227 |  |
|       - |   228 | `/*` |
|       - |   229 | ` * POP and release a block from the stack of compiled blocks.` |
|       - |   230 | ` */` |
|  770882 |   231 | `static sxi32 GenStateLeaveBlock(ph7_gen_state *pGen,GenBlock **ppBlock)` |
|       5 |   232 |  |
|  770887 |   233 | `	GenBlock *pBlock = pGen->pCurrent;` |
|  770887 |   234 | `	if( pBlock == 0 ){` |
|       - |   235 | `		/* No more block to pop */` |
|     ! 0 |   236 | `		return SXERR_EMPTY;` |
|       - |   237 | `	}` |
|       - |   238 | `	/* Point to the upper block */` |
|  770887 |   239 | `	pGen->pCurrent = pBlock->pParent;` |
|  770887 |   240 | `	if( ppBlock ){` |
|       - |   241 | `		/* Write a pointer to the popped block */` |
|     ! 0 |   242 | `		*ppBlock = pBlock;` |
|     ! 0 |   243 | `	}else{` |
|       - |   244 | `		/* Safely release the block */` |
|  770887 |   245 | `		GenStateFreeBlock(&(*pBlock));` |
|       - |   246 | `	}` |
|  770887 |   247 | `	return SXRET_OK;` |
|  385446 |   248 |  |
|       - |   249 | `/*` |
...
|       - |   258 | ` */` |
|  218808 |   259 | `static sxi32 GenStateNewJumpFixup(GenBlock *pBlock,sxi32 nJumpType,sxu32 nInstrIdx)` |
|       5 |   260 |  |
|       - |   261 | `	JumpFixup sJumpFix;` |
|       - |   262 | `	sxi32 rc;` |
|       - |   263 | `	/* Init the JumpFixup structure */` |
|  218813 |   264 | `	sJumpFix.nJumpType = nJumpType;` |
|  218813 |   265 | `	sJumpFix.nInstrIdx = nInstrIdx;` |
|       - |   266 | `	/* Insert in the jump fixup table */` |
|  218813 |   267 | `	rc = SySetPut(&pBlock->aJumpFix,(const void *)&sJumpFix);` |
|  218813 |   268 | `	return rc;` |
|       5 |   269 |  |
|       - |   270 | `/*` |
...
|       - |   280 | ` */` |
|  538830 |   281 | `static sxu32 GenStateFixJumps(GenBlock *pBlock,sxi32 nJumpType,sxu32 nJumpDest)` |
|       5 |   282 |  |
|       - |   283 | `	JumpFixup *aFix;` |
|       - |   284 | `	VmInstr *pInstr;` |
|       - |   285 | `	sxu32 nFixed;` |
...
|  538835 |   288 | `	aFix = (JumpFixup *)SySetBasePtr(&pBlock->aJumpFix);` |
|       - |   289 | `	/* Fix the desired jumps */` |
|  969823 |   290 | `	for( nFixed = n = 0 ; n < SySetUsed(&pBlock->aJumpFix) ; ++n ){` |
|  430993 |   291 | `		if( aFix[n].nJumpType < 0 ){` |
|       - |   292 | `			/* Already fixed */` |
|  172019 |   293 | `			continue;` |
|       - |   294 | `		}` |
|  258979 |   295 | `		if( nJumpType > 0 && aFix[n].nJumpType != nJumpType ){` |
|       - |   296 | `			/* Not of our interest */` |
|   40173 |   297 | `			continue;` |
|       - |   298 | `		}` |
|       - |   299 | `		/* Point to the instruction to fix */` |
|  218811 |   300 | `		pInstr = PH7_VmGetInstr(pBlock->pGen->pVm,aFix[n].nInstrIdx);` |
|  218811 |   301 | `		if( pInstr ){` |
|  218811 |   302 | `			pInstr->iP2 = nJumpDest;` |
|  218811 |   303 | `			nFixed++;` |
|       - |   304 | `			/* Mark as fixed */` |
|  218811 |   305 | `			aFix[n].nJumpType = -1;` |
|  109403 |   306 | `		}` |
|  109408 |   307 | `	}` |
|       - |   308 | `	/* Total number of fixed jumps */` |
|  538835 |   309 | `	return nFixed;` |
|       5 |   310 |  |
|       - |   311 | `/*` |
...
|       - |   317 | ` */` |
|  218882 |   318 | `static sxi32 GenStateFixGoto(ph7_gen_state *pGen,sxu32 nOfft)` |
|       5 |   319 |  |
...
|  218887 |   326 | `	aJumps = (JumpFixup *)SySetBasePtr(&pGen->aGoto);` |
|       - |   327 | `	/* Fix */` |
|  219033 |   328 | `	for( n = nOfft ; n < SySetUsed(&pGen->aGoto) ; ++n ){` |
...
|      46 |   351 | `		}` |
|      51 |   352 | `	}` |
|  218885 |   353 | `	aLabel = (Label *)SySetBasePtr(&pGen->aLabel);` |
|  219017 |   354 | `	for( n = 0 ; n < SySetUsed(&pGen->aLabel) ; ++n ){` |
...
|      12 |   359 | `		}` |
|      71 |   360 | `	}` |
|  218885 |   361 | `	return SXRET_OK;` |
|  109446 |   362 |  |
|       - |   363 | `/*` |
|       - |   364 | ` * Check if a given token value is installed in the literal table.` |
|       - |   365 | ` */` |
|  692112 |   366 | `static sxi32 GenStateFindLiteral(ph7_gen_state *pGen,const SyString *pValue,sxu32 *pIdx)` |
|       5 |   367 |  |
|       - |   368 | `	SyHashEntry *pEntry;` |
|  692117 |   369 | `	pEntry = SyHashGet(&pGen->hLiteral,(const void *)pValue->zString,pValue->nByte);` |
|  692117 |   370 | `	if( pEntry == 0 ){` |
|  301029 |   371 | `		return SXERR_NOTFOUND;` |
|       - |   372 | `	}` |
|  391093 |   373 | `	*pIdx = (sxu32)SX_PTR_TO_INT(pEntry->pUserData);` |
|  391093 |   374 | `	return SXRET_OK;` |
|  346061 |   375 |  |
|       - |   376 | `/*` |
...
|       - |   385 | ` */` |
|  301024 |   386 | `static sxi32 GenStateInstallLiteral(ph7_gen_state *pGen,ph7_value *pObj,sxu32 nIdx)` |
|       5 |   387 |  |
|  301029 |   388 | `	if( SyBlobLength(&pObj->sBlob) > 0 ){` |
|  301029 |   389 | `		SyHashInsert(&pGen->hLiteral,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob),SX_INT_TO_PTR(nIdx));` |
|  150512 |   390 | `	}` |
|  301029 |   391 | `	return SXRET_OK;` |
|       5 |   392 |  |
|       - |   393 | `/*` |
|       - |   394 | ` * Reserve a room for a numeric constant [i.e: 64-bit integer or real number]` |
|       - |   395 | ` * in the constant table.` |
|       - |   396 | ` */` |
|  115246 |   397 | `static ph7_value * GenStateInstallNumLiteral(ph7_gen_state *pGen,sxu32 *pIdx)` |
|       5 |   398 |  |
|       - |   399 | `	ph7_value *pObj;` |
|  115251 |   400 | `	sxu32 nIdx = 0; /* cc warning */` |
|       - |   401 | `	/* Reserve a new constant */` |
|  115251 |   402 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  115251 |   403 | `	if( pObj == 0 ){` |
|     ! 0 |   404 | `		PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|     ! 0 |   405 | `		return 0;` |
|       - |   406 | `	}` |
|  115251 |   407 | `	*pIdx = nIdx;` |
|       - |   408 | `	/* TODO(chems): Create a numeric table (64bit int keys) same as` |
|       - |   409 | `	 * the constant string iterals table [optimization purposes].` |
|       - |   410 | `	 */` |
|  115251 |   411 | `	return pObj;` |
|   57628 |   412 |  |
|       - |   413 | `/*` |
...
|       - |   426 | ` */` |
|  413794 |   427 | `static void *GenStateAttachStrictFlag(ph7_gen_state *pGen, void *p3)` |
|       5 |   428 |  |
|       - |   429 | `	VmCallArgMap *pMap;` |
|  413799 |   430 | `	if( !pGen->bStrictTypes ) return p3;` |
|      33 |   431 | `	if( p3 == 0 ){` |
...
|       - |   497 | ` */` |
|  115838 |   498 | `static int GenStateFindBadNumericSeparator(` |
|       - |   499 | `	const SyString *pRaw, const char **pBadStart, sxu32 *pBadLen)` |
|       5 |   500 |  |
|  115843 |   501 | `	const char *z = pRaw->zString;` |
|  115843 |   502 | `	sxu32 n = pRaw->nByte;` |
|  115843 |   503 | `	int base = 10;` |
|       - |   504 | `	sxu32 i, start;` |
|  115843 |   505 | `	if( n < 2 ) return 0;` |
|    9677 |   506 | `	if( z[0] == '0' && (z[1] == 'x' \|\| z[1] == 'X') ){` |
|      72 |   507 | `		base = 16;` |
|    9642 |   508 | `	}else if( z[0] == '0' && (z[1] == 'b' \|\| z[1] == 'B') ){` |
|     280 |   509 | `		base = 2;` |
|     139 |   510 | `	}` |
|   35199 |   511 | `	for( i = 0; i < n; ++i ){` |
|   25541 |   512 | `		if( z[i] != '_' ) continue;` |
...
|       - |   538 | ` */` |
|  115838 |   539 | `static sxi32 GenStateValidateNumericSeparator(ph7_gen_state *pGen, SyToken *pToken)` |
|       5 |   540 |  |
|  115843 |   541 | `	const char *zBad = 0;` |
|  115843 |   542 | `	sxu32 nBad = 0;` |
|       - |   543 | `	SyString sBad;` |
|       - |   544 | `	sxi32 rc;` |
|  115843 |   545 | `	if( !GenStateFindBadNumericSeparator(&pToken->sData, &zBad, &nBad) ){` |
|  115829 |   546 | `		return SXRET_OK;` |
|       - |   547 | `	}` |
...
|       - |   571 | ` */` |
|  115824 |   572 | `static sxi32 GenStateStripNumericSeparators(` |
...
|       5 |   577 |  |
|       - |   578 | `	sxu32 i, j;` |
|  115829 |   579 | `	int hasUnderscore = 0;` |
|       - |   580 | `	char *zBuf;` |
|  115829 |   581 | `	*pzAlloc = 0;` |
|  245451 |   582 | `	for( i = 0; i < pToken->nByte; ++i ){` |
|  129879 |   583 | `		if( pToken->zString[i] == '_' ){ hasUnderscore = 1; break; }` |
|   64816 |   584 | `	}` |
|  115829 |   585 | `	if( !hasUnderscore ){` |
|  115577 |   586 | `		SyStringDupPtr(pOut, pToken);` |
|  115577 |   587 | `		return SXRET_OK;` |
|       - |   588 | `	}` |
...
|       - |   619 | ` *  documentation.` |
|       - |   620 | ` */` |
|  115810 |   621 | `static sxi32 PH7_CompileNumLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |   622 |  |
|  115815 |   623 | `	SyToken *pToken = pGen->pIn; /* Raw token */` |
|  115815 |   624 | `	sxu32 nIdx = 0;` |
|       - |   625 | `	char zScratch[GEN_NUM_SCRATCH];` |
|  115815 |   626 | `	char *zAlloc = 0;` |
|       - |   627 | `	SyString sNum;` |
|       - |   628 | `	sxi32 rc;` |
|   57905 |   629 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|  115815 |   630 | `	rc = GenStateValidateNumericSeparator(pGen, pToken);` |
|  115815 |   631 | `	if( rc != SXRET_OK ){` |
|      14 |   632 | `		return rc;` |
|       - |   633 | `	}` |
|  173705 |   634 | `	rc = GenStateStripNumericSeparators(&pGen->pVm->sAllocator, &pToken->sData,` |
|   57900 |   635 | `		zScratch, sizeof(zScratch), &sNum, &zAlloc);` |
|  115805 |   636 | `	if( rc != SXRET_OK ){` |
|     ! 0 |   637 | `		return SXERR_ABORT;` |
|       - |   638 | `	}` |
|  115805 |   639 | `	if( pToken->nType & PH7_TK_INTEGER ){` |
|       - |   640 | `		ph7_value *pObj;` |
|       - |   641 | `		sxi64 iValue;` |
|  115251 |   642 | `		iValue = PH7_TokenValueToInt64(&sNum);` |
|  115251 |   643 | `		pObj = GenStateInstallNumLiteral(&(*pGen),&nIdx);` |
|  115251 |   644 | `		if( pObj == 0 ){` |
|     ! 0 |   645 | `			if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|     ! 0 |   646 | `			return SXERR_ABORT;` |
|       - |   647 | `		}` |
|  115251 |   648 | `		PH7_MemObjInitFromInt(pGen->pVm,pObj,iValue);` |
|   57628 |   649 | `	}else{` |
|       - |   650 | `		/* Real number */` |
|       - |   651 | `		ph7_value *pObj;` |
|       - |   652 | `		/* Reserve a new constant */` |
|     559 |   653 | `		pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|     559 |   654 | `		if( pObj == 0 ){` |
...
|       - |   658 | `		}` |
|     559 |   659 | `		PH7_MemObjInitFromString(pGen->pVm,pObj,&sNum);` |
|     559 |   660 | `		PH7_MemObjToReal(pObj);` |
|       - |   661 | `	}` |
|  115805 |   662 | `	if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|       - |   663 | `	/* Emit the load constant instruction */` |
|  115805 |   664 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|       - |   665 | `	/* Node successfully compiled */` |
|  115805 |   666 | `	return SXRET_OK;` |
|   57910 |   667 |  |
|       - |   668 | `/*` |
...
|       - |   677 | ` *` |
|       - |   678 | ` */` |
|   83196 |   679 | `PH7_PRIVATE sxi32 PH7_CompileSimpleString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |   680 |  |
|   83201 |   681 | `	SyString *pStr = &pGen->pIn->sData; /* Constant string literal */` |
|       - |   682 | `	const char *zIn,*zCur,*zEnd;` |
|       - |   683 | `	ph7_value *pObj;` |
|       - |   684 | `	sxu32 nIdx;` |
|   83201 |   685 | `	nIdx = 0; /* Prevent compiler warning */` |
|       - |   686 | `	/* Delimit the string */` |
|   83201 |   687 | `	zIn  = pStr->zString;` |
|   83201 |   688 | `	zEnd = &zIn[pStr->nByte];` |
|   83201 |   689 | `	if( zIn >= zEnd ){` |
|       - |   690 | `		/* Empty string constant: just use the pre‑allocated index from the VM` |
|       - |   691 | `		 * rather than reserving a new object each time. */` |
|    6731 |   692 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,pGen->pVm->nEmptyStringIdx,0,0);` |
|    6731 |   693 | `		return SXRET_OK;` |
|       - |   694 | `	}` |
|   76475 |   695 | `	if( SXRET_OK == GenStateFindLiteral(&(*pGen),pStr,&nIdx) ){` |
|       - |   696 | `		/* Already processed,emit the load constant instruction` |
|       - |   697 | `		 * and return.` |
|       - |   698 | `		 */` |
|   30339 |   699 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   30339 |   700 | `		return SXRET_OK;` |
|       - |   701 | `	}` |
|       - |   702 | `	/* Reserve a new constant */` |
|   46141 |   703 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   46141 |   704 | `	if( pObj == 0 ){` |
...
|       - |   708 | `	}` |
|   46141 |   709 | `	PH7_MemObjInitFromString(pGen->pVm,pObj,0);` |
|       - |   710 | `	/* Compile the node */` |
|   46188 |   711 | `	for(;;){` |
|   92381 |   712 | `		if( zIn >= zEnd ){` |
|       - |   713 | `			/* End of input */` |
|   46141 |   714 | `			break;` |
|       - |   715 | `		}` |
|   46245 |   716 | `		zCur = zIn;` |
|  728001 |   717 | `		while( zIn < zEnd && zIn[0] != '\\' ){` |
|  681761 |   718 | `			zIn++;` |
|       5 |   719 | `		}` |
|   46245 |   720 | `		if( zIn > zCur ){` |
|       - |   721 | `			/* Append raw contents*/` |
|   46221 |   722 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|   23108 |   723 | `		}` |
|   46245 |   724 | `		zIn++;` |
|   46245 |   725 | `		if( zIn < zEnd ){` |
|     126 |   726 | `			if( zIn[0] == '\\' ){` |
...
|   46141 |   743 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   46141 |   744 | `	if( pStr->nByte < 1024 ){` |
|       - |   745 | `		/* Install in the literal table */` |
|   46141 |   746 | `		GenStateInstallLiteral(pGen,pObj,nIdx);` |
|   23068 |   747 | `	}` |
|       - |   748 | `	/* Node successfully compiled */` |
|   46141 |   749 | `	return SXRET_OK;` |
|   41603 |   750 |  |
|       - |   751 | `/*` |
...
|       - |   915 | ` */` |
|    2078 |   916 | `static sxi32 GenStateProcessStringExpression(` |
...
|    2083 |   927 | `	SySetInit(&sToken,&pGen->pVm->sAllocator,sizeof(SyToken));` |
|       - |   928 | `	/* Preallocate some slots */` |
|    2083 |   929 | `	SySetAlloc(&sToken,0x08);` |
|       - |   930 | `	/* Tokenize the text */` |
|    2083 |   931 | `	PH7_TokenizePHP(zIn,(sxu32)(zEnd-zIn),nLine,&sToken);` |
|       - |   932 | `	/* Swap delimiter */` |
|    2083 |   933 | `	pTmpIn  = pGen->pIn;` |
|    2083 |   934 | `	pTmpEnd = pGen->pEnd;` |
|    2083 |   935 | `	pGen->pIn = (SyToken *)SySetBasePtr(&sToken);` |
|    2083 |   936 | `	pGen->pEnd = &pGen->pIn[SySetUsed(&sToken)];` |
|       - |   937 | `	/* Compile the expression */` |
|    2083 |   938 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|       - |   939 | `	/* Restore token stream */` |
|    2083 |   940 | `	pGen->pIn  = pTmpIn;` |
|    2083 |   941 | `	pGen->pEnd = pTmpEnd;` |
|       - |   942 | `	/* Release the token set */` |
|    2083 |   943 | `	SySetRelease(&sToken);` |
...
|       - |   949 | ` */` |
|   22496 |   950 | `static ph7_value * GenStateNewStrObj(ph7_gen_state *pGen,sxi32 *pCount)` |
|       5 |   951 |  |
|       - |   952 | `	ph7_value *pConstObj;` |
|   22501 |   953 | `	sxu32 nIdx = 0;` |
|       - |   954 | `	/* Reserve a new constant */` |
|   22501 |   955 | `	pConstObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   22501 |   956 | `	if( pConstObj == 0 ){` |
|     ! 0 |   957 | `		PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"PH7 engine is running out of memory");` |
|     ! 0 |   958 | `		return 0;` |
|       - |   959 | `	}` |
|   22501 |   960 | `	(*pCount)++;` |
|   22501 |   961 | `	PH7_MemObjInitFromString(pGen->pVm,pConstObj,0);` |
|       - |   962 | `	/* Emit the load constant instruction */` |
|   22501 |   963 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   22501 |   964 | `	return pConstObj;` |
|   11253 |   965 |  |
|       - |   966 | `/*` |
...
|       - |  1003 | ` */` |
|   21032 |  1004 | `static sxi32 GenStateCompileString(ph7_gen_state *pGen)` |
|       5 |  1005 |  |
|   21037 |  1006 | `	SyString *pStr = &pGen->pIn->sData; /* Raw token value */` |
|       - |  1007 | `	const char *zIn,*zCur,*zEnd;` |
|   21037 |  1008 | `	ph7_value *pObj = 0;` |
|       - |  1009 | `	sxi32 iCons;` |
|       - |  1010 | `	sxi32 rc;` |
|       - |  1011 | `	/* Delimit the string */` |
|   21037 |  1012 | `	zIn  = pStr->zString;` |
|   21037 |  1013 | `	zEnd = &zIn[pStr->nByte];` |
|   21037 |  1014 | `	if( zIn >= zEnd ){` |
...
|       - |  1018 | `		 */` |
|     279 |  1019 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,pGen->pVm->nEmptyStringIdx,0,0);` |
|     279 |  1020 | `		return SXRET_OK;` |
|       - |  1021 | `	}` |
|   20763 |  1022 | `	zCur = 0;` |
...
|   11418 |  1025 | `	for(;;){` |
|   34449 |  1026 | `		zCur = zIn;` |
|  167695 |  1027 | `		while( zIn < zEnd && zIn[0] != '\\'  ){` |
|  135329 |  1028 | `			if( zIn[0] == '{' && &zIn[1] < zEnd && zIn[1] == '$' ){` |
|      67 |  1029 | `				break;` |
|  135203 |  1030 | `			}else if(zIn[0] == '$' && &zIn[1] < zEnd &&` |
|    1954 |  1031 | `				(((unsigned char)zIn[1] >= 0xc0 \|\| SyisAlpha(zIn[1]) \|\| zIn[1] == '{' \|\| zIn[1] == '_')) ){` |
|     980 |  1032 | `					break;` |
|       - |  1033 | `			}` |
|  133251 |  1034 | `			zIn++;` |
|       5 |  1035 | `		}` |
|   34449 |  1036 | `		if( zIn > zCur ){` |
|   15889 |  1037 | `			if( pObj == 0 ){` |
|   15455 |  1038 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|   15455 |  1039 | `				if( pObj == 0 ){` |
|     ! 0 |  1040 | `					return SXERR_ABORT;` |
|       - |  1041 | `				}` |
|    7725 |  1042 | `			}` |
|   15889 |  1043 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|    7942 |  1044 | `		}` |
|   34449 |  1045 | `		if( zIn >= zEnd ){` |
|   20763 |  1046 | `			break;` |
|       - |  1047 | `		}` |
|   13691 |  1048 | `		if( zIn[0] == '\\' ){` |
|   11613 |  1049 | `			const char *zPtr = 0;` |
|       - |  1050 | `			sxu32 n;` |
|   11613 |  1051 | `			zIn++;` |
|   11613 |  1052 | `			if( zIn >= zEnd ){` |
|     ! 0 |  1053 | `				break;` |
|       - |  1054 | `			}` |
|   11613 |  1055 | `			if( pObj == 0 ){` |
|    7051 |  1056 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|    7051 |  1057 | `				if( pObj == 0 ){` |
|     ! 0 |  1058 | `					return SXERR_ABORT;` |
|       - |  1059 | `				}` |
|    3523 |  1060 | `			}` |
|   11613 |  1061 | `			n = sizeof(char); /* size of conversion */` |
|   11613 |  1062 | `			switch( zIn[0] ){` |
|       7 |  1063 | `			case '$':` |
|       - |  1064 | `				/* Dollar sign */` |
...
|   10685 |  1085 | `				PH7_MemObjStringAppend(pObj,"\n",sizeof(char));` |
|   10685 |  1086 | `				break;` |
|      19 |  1087 | `			case 'r':` |
...
|      96 |  1103 | `			case '"':` |
|       - |  1104 | `				/* Double quote */` |
|     197 |  1105 | `				PH7_MemObjStringAppend(pObj,"\"",sizeof(char));` |
|     197 |  1106 | `				break;` |
|       6 |  1107 | `			case '0':` |
|       - |  1108 | `				/* NUL byte */` |
...
|      67 |  1189 | `		}else{` |
|       - |  1190 | `			/* Simple syntax */` |
|    1955 |  1191 | `			const char *zExpr = zIn;` |
|       - |  1192 | `			/* Assemble variable name */` |
|     981 |  1193 | `			for(;;){` |
|       - |  1194 | `				/* Jump leading dollars */` |
|    3917 |  1195 | `				while( zIn < zEnd && zIn[0] == '$' ){` |
|    1955 |  1196 | `					zIn++;` |
|       5 |  1197 | `				}` |
|     981 |  1198 | `				for(;;){` |
|   11290 |  1199 | `					while( zIn < zEnd && (unsigned char)zIn[0] < 0xc0 && (SyisAlphaNum(zIn[0]) \|\| zIn[0] == '_' ) ){` |
|    8347 |  1200 | `						zIn++;` |
|       5 |  1201 | `					}` |
|    1967 |  1202 | `					if((unsigned char)zIn[0] >= 0xc0 ){` |
|       - |  1203 | `						/* UTF-8 stream */` |
|     ! 0 |  1204 | `						zIn++;` |
...
|       1 |  1249 | `					}` |
|       6 |  1250 | `					break;` |
|    1831 |  1251 | `				}else if( zIn[0] == '-' && &zIn[1] < zEnd && zIn[1] == '>' ){` |
|       - |  1252 | `					/* Member access operator '->' */` |
|      14 |  1253 | `					zIn += 2;` |
|    1825 |  1254 | `				}else if(zIn[0] == ':' && &zIn[1] < zEnd && zIn[1] == ':'){` |
...
|    1955 |  1262 | `			rc = GenStateProcessStringExpression(&(*pGen),pGen->pIn->nLine,zExpr,zIn);` |
|    1955 |  1263 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  1264 | `				return SXERR_ABORT;` |
|       - |  1265 | `			}` |
|    1955 |  1266 | `			if( rc != SXERR_EMPTY ){` |
|    1953 |  1267 | `				++iCons;` |
|     974 |  1268 | `			}` |
|       - |  1269 | `		}` |
...
|    2083 |  1271 | `		pObj = 0;` |
|       5 |  1272 | `	}/*for(;;)*/` |
|   20763 |  1273 | `	if( iCons > 1 ){` |
|       - |  1274 | `		/* Concatenate all compiled constants */` |
|    1547 |  1275 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_CAT,iCons,0,0,0);` |
|     771 |  1276 | `	}` |
|       - |  1277 | `	/* Node successfully compiled */` |
|   20763 |  1278 | `	return SXRET_OK;` |
|   10521 |  1279 |  |
|       - |  1280 | `/*` |
|       - |  1281 | ` * Compile a double quoted string.` |
|       - |  1282 | ` *  See the block-comment above for more information.` |
|       - |  1283 | ` */` |
|   20972 |  1284 | `PH7_PRIVATE sxi32 PH7_CompileString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  1285 |  |
|       - |  1286 | `	sxi32 rc;` |
|   20977 |  1287 | `	rc = GenStateCompileString(&(*pGen));` |
|   10486 |  1288 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|       - |  1289 | `	/* Compilation result */` |
|   20977 |  1290 | `	return rc;` |
|       5 |  1291 |  |
|       - |  1292 | `/*` |
...
|       - |  1333 | ` */` |
|   19626 |  1334 | `static sxi32 GenStateCompileArrayEntry(` |
...
|   19631 |  1345 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|       - |  1346 | `	/* Compile the expression*/` |
|   19631 |  1347 | `	rc = PH7_CompileExpr(&(*pGen),iFlags,xValidator);` |
|       - |  1348 | `	/* Restore token stream */` |
|   19631 |  1349 | `	RE_SWAP_DELIMITER(pGen);` |
|   19631 |  1350 | `	return rc;` |
|       5 |  1351 |  |
|       - |  1352 | `/*` |
...
|       - |  1388 | ` */` |
|   28784 |  1389 | `static sxi32 GenStateCompileArrayBody(ph7_gen_state *pGen)` |
|       5 |  1390 |  |
|       - |  1391 | `	sxi32 (*xValidator)(ph7_gen_state *,ph7_expr_node *); /* Expression tree validator callback */` |
|       - |  1392 | `	SyToken *pKey,*pCur;` |
|   28789 |  1393 | `	sxi32 iEmitRef = 0;` |
|   28789 |  1394 | `	sxi32 iSpread = 0;` |
|   28789 |  1395 | `	sxi32 nPair = 0;` |
|       - |  1396 | `	sxi32 iNest;` |
|       - |  1397 | `	sxi32 rc;` |
|   28789 |  1398 | `	xValidator = 0;` |
|   23416 |  1399 | `	for(;;){` |
|       - |  1400 | `		/* Jump leading commas */` |
|   52923 |  1401 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA) ){` |
|    6091 |  1402 | `			pGen->pIn++;` |
|       5 |  1403 | `		}` |
|   46837 |  1404 | `		pCur = pGen->pIn;` |
|   46837 |  1405 | `		if( SXRET_OK != PH7_GetNextExpr(pGen->pIn,pGen->pEnd,&pGen->pIn) ){` |
|       - |  1406 | `			/* No more entry to process */` |
|   28773 |  1407 | `			break;` |
|       - |  1408 | `		}` |
|   18069 |  1409 | `		if( pCur >= pGen->pIn ){` |
|     ! 0 |  1410 | `			continue;` |
|       - |  1411 | `		}` |
|       - |  1412 | `		/* Compile the key if available */` |
|   18069 |  1413 | `		pKey = pCur;` |
|   18069 |  1414 | `		iNest = 0;` |
|   50611 |  1415 | `		while( pCur < pGen->pIn ){` |
|   34011 |  1416 | `			if( (pCur->nType & PH7_TK_ARRAY_OP) && iNest <= 0 ){` |
|    1465 |  1417 | `				break;` |
|       - |  1418 | `			}` |
...
|       - |  1423 | `			 */` |
|   32551 |  1424 | `			if( iNest == 0 && (pCur->nType & PH7_TK_KEYWORD) ){` |
...
|       - |  1486 | `				}` |
|      38 |  1487 | `			}` |
|   32545 |  1488 | `			if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|     265 |  1489 | `				iNest++;` |
|   32414 |  1490 | `			}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}'*/) ){` |
...
|   32545 |  1496 | `			pCur++;` |
|       5 |  1497 | `		}` |
|   18069 |  1498 | `		rc = SXERR_EMPTY;` |
|   18069 |  1499 | `		if( pCur < pGen->pIn ){` |
...
|   16609 |  1521 | `			pCur = pKey;` |
|       - |  1522 | `		}` |
|   18059 |  1523 | `		if( rc == SXERR_EMPTY ){` |
|       - |  1524 | `			/* No available key,load NULL */` |
|   16611 |  1525 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,0 /* nil index */,0,0);` |
|    8303 |  1526 | `		}` |
|   18059 |  1527 | `		if( pCur->nType & PH7_TK_AMPER /*'&'*/){` |
...
|   18057 |  1546 | `		iSpread = (pCur < pGen->pIn && (pCur->nType & PH7_TK_ELLIPSIS)) ? 1 : 0;` |
|   18057 |  1547 | `		if( iSpread && (rc != SXERR_EMPTY \|\| iEmitRef) ){` |
...
|   18053 |  1560 | `		rc = GenStateCompileArrayEntry(&(*pGen),pCur,pGen->pIn,EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,xValidator);` |
|   18053 |  1561 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  1562 | `			return SXERR_ABORT;` |
|       - |  1563 | `		}` |
|   18053 |  1564 | `		if( iSpread ){` |
...
|   18022 |  1567 | `		}else if( iEmitRef ){` |
|       - |  1568 | `			/* Emit the load reference instruction */` |
|      41 |  1569 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_REF,0,0,0,0);` |
|      18 |  1570 | `		}` |
|   18053 |  1571 | `		xValidator = 0;` |
|   18053 |  1572 | `		iEmitRef = 0;` |
|   18053 |  1573 | `		iSpread = 0;` |
|   18053 |  1574 | `		nPair++;` |
|       5 |  1575 | `	}` |
|       - |  1576 | `	/* Emit the load map instruction */` |
|   28773 |  1577 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_MAP,nPair * 2,0,0,0);` |
|       - |  1578 | `	/* Node successfully compiled */` |
|   28773 |  1579 | `	return SXRET_OK;` |
|   14397 |  1580 |  |
|       - |  1581 | `/*` |
...
|       - |  1589 | ` */` |
|   28044 |  1590 | `PH7_PRIVATE sxi32 PH7_CompileArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  1591 |  |
|       - |  1592 | `	/* Jump the 'array' keyword and the leading '(', exclude trailing ')'. */` |
|   28049 |  1593 | `	pGen->pIn += 2;` |
|   28049 |  1594 | `	pGen->pEnd--;` |
|   14022 |  1595 | `	SXUNUSED(iCompileFlag);` |
|   28049 |  1596 | `	return GenStateCompileArrayBody(pGen);` |
|       5 |  1597 |  |
|       - |  1598 | `/*` |
...
|       - |  1820 | ` */` |
|     246 |  1821 | `PH7_PRIVATE sxi32 PH7_CompileAnnonFunc(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  1822 |  |
...
|       - |  1832 | `	sxi32 rc;` |
|       - |  1833 |  |
|     251 |  1834 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|     251 |  1835 | `	if( pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD) ){` |
|     ! 0 |  1836 | `		pGen->pIn++;` |
|     ! 0 |  1837 | `	}` |
|       - |  1838 | `	/* Reserve a constant for the lambda */` |
|     251 |  1839 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|     251 |  1840 | `	if( pObj == 0 ){` |
...
|     251 |  1846 | `	nLen = SyBufferFormat(zName,sizeof(zName),"[lambda_%d]",iCnt++);` |
|       - |  1847 | `	/* Make sure the generated name is unique */` |
|     251 |  1848 | `	while( SyHashGet(&pGen->pVm->hFunction,zName,nLen) != 0 && nLen < sizeof(zName) - 2 ){` |
|     ! 0 |  1849 | `		nLen = SyBufferFormat(zName,sizeof(zName),"[lambda_%d]",iCnt++);` |
|     ! 0 |  1850 | `	}` |
|     251 |  1851 | `	SyStringInitFromBuf(&sName,zName,nLen);` |
|     251 |  1852 | `	PH7_MemObjInitFromString(pGen->pVm,pObj,&sName);` |
|       - |  1853 | `	/* Compile the lambda body */` |
|     251 |  1854 | `	rc = GenStateCompileFunc(&(*pGen),&sName,0,TRUE,&pAnnonFunc);` |
|     251 |  1855 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  1856 | `		return SXERR_ABORT;` |
|       - |  1857 | `	}` |
|     251 |  1858 | `	if( pAnnonFunc->iFlags & VM_FUNC_CLOSURE ){` |
...
|     235 |  1863 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|       - |  1864 | `	}` |
|       - |  1865 | `	/* Node successfully compiled */` |
|     251 |  1866 | `	return SXRET_OK;` |
|     128 |  1867 |  |
|       - |  1868 | `/*` |
...
|     215 |  2266 | `	while( SyHashGet(&pGen->pVm->hFunction,zName,nLen) != 0 && nLen < sizeof(zName) - 2 ){` |
|     100 |  2267 | `		nLen = SyBufferFormat(zName,sizeof(zName),"[lambda_%d]",iCnt++);` |
|       2 |  2268 | `	}` |
...
|       - |  2739 | ` */` |
| 1027534 |  2740 | `PH7_PRIVATE sxi32 PH7_CompileVariable(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  2741 |  |
| 1027539 |  2742 | `	sxu32 nLineLocal = pGen->pIn->nLine;` |
|       - |  2743 | `	sxi32 iVv;` |
|       - |  2744 | `	sxi32 iP1;` |
|       - |  2745 | `	void *p3;` |
|       - |  2746 | `	sxi32 rc;` |
| 1027539 |  2747 | `	iVv = -1; /* Variable variable counter */` |
| 2055085 |  2748 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) ){` |
| 1027551 |  2749 | `		pGen->pIn++;` |
| 1027551 |  2750 | `		iVv++;` |
|       5 |  2751 | `	}` |
| 1027539 |  2752 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_OCB/*'{'*/)) == 0 ){` |
...
|       - |  2760 | `	}` |
| 1027539 |  2761 | `	p3  = 0;` |
| 1027539 |  2762 | `	if( pGen->pIn->nType & PH7_TK_OCB/*'{'*/ ){` |
...
|       - |  2781 | `		SyString *pName;` |
| 1027523 |  2782 | `		char *zName = 0;` |
|       - |  2783 | `		/* Extract variable name */` |
| 1027523 |  2784 | `		pName = &pGen->pIn->sData;` |
|       - |  2785 | `		/* Advance the stream cursor */` |
| 1027523 |  2786 | `		pGen->pIn++;` |
| 1027523 |  2787 | `		pEntry = SyHashGet(&pGen->hVar,(const void *)pName->zString,pName->nByte);` |
| 1027523 |  2788 | `		if( pEntry == 0 ){` |
|       - |  2789 | `			/* Duplicate name */` |
|  137947 |  2790 | `			zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|  137947 |  2791 | `			if( zName == 0 ){` |
...
|  137947 |  2796 | `			SyHashInsert(&pGen->hVar,zName,pName->nByte,zName);` |
|   68976 |  2797 | `		}else{` |
|       - |  2798 | `			/* Name already available */` |
|  889581 |  2799 | `			zName = (char *)pEntry->pUserData;` |
|       - |  2800 | `		}` |
| 1027523 |  2801 | `		p3 = (void *)zName;` |
|       - |  2802 | `	}` |
| 1027535 |  2803 | `	iP1 = 0;` |
| 1027535 |  2804 | `	if( iCompileFlag & EXPR_FLAG_RDONLY_LOAD ){` |
|  374297 |  2805 | `		if( (iCompileFlag & EXPR_FLAG_LOAD_IDX_STORE) == 0 ){` |
|       - |  2806 | `			/* Read-only load.In other words do not create the variable if inexistant */` |
|  374279 |  2807 | `			iP1 = 1;` |
|  187137 |  2808 | `		}` |
|  187146 |  2809 | `	}` |
|       - |  2810 | `	/* Emit the load instruction */` |
| 1027535 |  2811 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,0,p3,0);` |
| 1027547 |  2812 | `	while( iVv > 0 ){` |
|      13 |  2813 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,0,0,0);` |
|      13 |  2814 | `		iVv--;` |
|       1 |  2815 | `	}` |
|       - |  2816 | `	/* Node successfully compiled */` |
| 1027535 |  2817 | `	return SXRET_OK;` |
|  513772 |  2818 |  |
|       - |  2819 | `/*` |
|       - |  2820 | ` * Load a literal.` |
|       - |  2821 | ` */` |
|  722668 |  2822 | `static sxi32 GenStateLoadLiteral(ph7_gen_state *pGen)` |
|       5 |  2823 |  |
|  722673 |  2824 | `	SyToken *pToken = pGen->pIn;` |
|       - |  2825 | `	ph7_value *pObj;` |
|       - |  2826 | `	SyString *pStr;` |
|       - |  2827 | `	sxu32 nIdx;` |
|       - |  2828 | `	/* Extract token value */` |
|  722673 |  2829 | `	pStr = &pToken->sData;` |
|       - |  2830 | `	/* Deal with the reserved literals [i.e: null,false,true,...] first */` |
|  722673 |  2831 | `	if( pStr->nByte == sizeof("NULL") - 1 ){` |
|  153201 |  2832 | `		if( SyStrnicmp(pStr->zString,"null",sizeof("NULL")-1) == 0 ){` |
|       - |  2833 | `			/* NULL constant are always indexed at 0 */` |
|   56449 |  2834 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,0,0,0);` |
|   56449 |  2835 | `			return SXRET_OK;` |
|   96757 |  2836 | `		}else if( SyStrnicmp(pStr->zString,"true",sizeof("TRUE")-1) == 0 ){` |
|       - |  2837 | `			/* TRUE constant are always indexed at 1 */` |
|     597 |  2838 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,1,0,0);` |
|     597 |  2839 | `			return SXRET_OK;` |
|       5 |  2840 | `		}` |
|  674819 |  2841 | `	}else if (pStr->nByte == sizeof("FALSE") - 1 &&` |
|  114524 |  2842 | `		SyStrnicmp(pStr->zString,"false",sizeof("FALSE")-1) == 0 ){` |
|       - |  2843 | `			/* FALSE constant are always indexed at 2 */` |
|   43279 |  2844 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,2,0,0);` |
|   43279 |  2845 | `			return SXRET_OK;` |
|  577574 |  2846 | `	}else if(pStr->nByte == sizeof("__LINE__") - 1 &&` |
|  102742 |  2847 | `		SyMemcmp(pStr->zString,"__LINE__",sizeof("__LINE__")-1) == 0 ){` |
|       - |  2848 | `			/* TICKET 1433-004: __LINE__ constant must be resolved at compile time,not run time */` |
|    9851 |  2849 | `			pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|    9851 |  2850 | `			if( pObj == 0 ){` |
|     ! 0 |  2851 | `				PH7_GenCompileError(pGen,E_ERROR,pToken->nLine,"Fatal, PH7 engine is running out of memory");` |
|     ! 0 |  2852 | `				return SXERR_ABORT;` |
|       - |  2853 | `			}` |
|    9851 |  2854 | `			PH7_MemObjInitFromInt(pGen->pVm,pObj,pToken->nLine);` |
|       - |  2855 | `			/* Emit the load constant instruction */` |
|    9851 |  2856 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|    9851 |  2857 | `			return SXRET_OK;` |
|  532953 |  2858 | `	}else if( pStr->nByte == sizeof("__NAMESPACE__") - 1 &&` |
|   33192 |  2859 | `		SyMemcmp(pStr->zString,"__NAMESPACE__",sizeof("__NAMESPACE__")-1) == 0 ){` |
...
|  523283 |  2875 | `	}else if( (pStr->nByte == sizeof("__FUNCTION__") - 1 &&` |
|   22624 |  2876 | `		SyMemcmp(pStr->zString,"__FUNCTION__",sizeof("__FUNCTION__")-1) == 0) \|\|` |
|  525084 |  2877 | `		(pStr->nByte == sizeof("__METHOD__") - 1 &&` |
|   17490 |  2878 | `		SyMemcmp(pStr->zString,"__METHOD__",sizeof("__METHOD__")-1) == 0) ){` |
...
|  612501 |  2908 | `	if( SXRET_OK != GenStateFindLiteral(&(*pGen),&pToken->sData,&nIdx) ){` |
|       - |  2909 | `		ph7_value *pLitObj;` |
|       - |  2910 | `		/* Unknown literal,install it in the literal table */` |
|  254421 |  2911 | `		pLitObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  254421 |  2912 | `		if( pLitObj == 0 ){` |
|     ! 0 |  2913 | `			PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|     ! 0 |  2914 | `			return SXERR_ABORT;` |
|       - |  2915 | `		}` |
|  254421 |  2916 | `		PH7_MemObjInitFromString(pGen->pVm,pLitObj,&pToken->sData);` |
|  254421 |  2917 | `		GenStateInstallLiteral(&(*pGen),pLitObj,nIdx);` |
|  127208 |  2918 | `	}` |
|       - |  2919 | `	/* Emit the load constant instruction */` |
|  612501 |  2920 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,1,nIdx,0,0);` |
|  612501 |  2921 | `	return SXRET_OK;` |
|  361339 |  2922 |  |
|       - |  2923 | `/*` |
...
|       - |  2928 | ` */` |
|  722704 |  2929 | `static sxi32 GenStateResolveNamespaceLiteral(ph7_gen_state *pGen)` |
|       5 |  2930 |  |
|       - |  2931 | `	sxi32 rc;` |
|  722709 |  2932 | `	if( pGen->pIn >= pGen->pEnd ){` |
|     ! 0 |  2933 | `		return SXRET_OK;` |
|       - |  2934 | `	}` |
|       - |  2935 | `	/* Check if this is a multi-token namespace path */` |
|  722709 |  2936 | `	if( pGen->pIn < &pGen->pEnd[-1] ){` |
|       - |  2937 | `		/* Multiple tokens: assemble the full path into sWorker */` |
|      41 |  2938 | `		SyBlob *pWorker = &pGen->sWorker;` |
|      41 |  2939 | `		int isAbsolute = 0;` |
|      41 |  2940 | `		SyBlobReset(pWorker);` |
|       - |  2941 | `		/* Check for leading backslash (absolute path) */` |
|      41 |  2942 | `		if( pGen->pIn->nType & PH7_TK_NSSEP ){` |
|      39 |  2943 | `			isAbsolute = 1;` |
|      39 |  2944 | `			pGen->pIn++; /* Skip leading backslash */` |
|      17 |  2945 | `		}` |
|       - |  2946 | `		/* For relative qualified names in a namespace, prepend the NS */` |
|      41 |  2947 | `		if( !isAbsolute && SyBlobLength(&pGen->sNamespace) > 0 ){` |
...
|     137 |  2952 | `		while( pGen->pIn <= &pGen->pEnd[-1] ){` |
|     137 |  2953 | `			if( pGen->pIn->nType & PH7_TK_NSSEP ){` |
|      53 |  2954 | `				SyBlobAppend(pWorker,"\\",1);` |
|      29 |  2955 | `			}else{` |
|      89 |  2956 | `				SyBlobAppend(pWorker,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|       - |  2957 | `			}` |
|     137 |  2958 | `			if( pGen->pIn == &pGen->pEnd[-1] ){` |
|      41 |  2959 | `				pGen->pIn++;` |
|      41 |  2960 | `				break;` |
|       - |  2961 | `			}` |
|     101 |  2962 | `			pGen->pIn++;` |
|       5 |  2963 | `		}` |
|      41 |  2964 | `		if( SyBlobLength(pWorker) > 0 ){` |
|       - |  2965 | `			ph7_value *pObj;` |
|       - |  2966 | `			SyString sPath;` |
|       - |  2967 | `			sxu32 nIdx;` |
|      41 |  2968 | `			SyStringInitFromBuf(&sPath,(const char *)SyBlobData(pWorker),SyBlobLength(pWorker));` |
|       - |  2969 | `			/* Install in the literal table */` |
|      41 |  2970 | `			if( SXRET_OK != GenStateFindLiteral(&(*pGen),&sPath,&nIdx) ){` |
...
|      59 |  2982 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,` |
|      18 |  2983 | `				isAbsolute ? (PH7_LOADC_EXPAND\|PH7_LOADC_ABSOLUTE) : PH7_LOADC_EXPAND,` |
|      18 |  2984 | `				nIdx,0,0);` |
|      41 |  2985 | `			return SXRET_OK;` |
|       - |  2986 | `		}` |
|     ! 0 |  2987 | `	}` |
|       - |  2988 | `	/* Single-token literal: load directly */` |
|  722673 |  2989 | `	rc = GenStateLoadLiteral(&(*pGen));` |
|  722673 |  2990 | `	return rc;` |
|  361357 |  2991 |  |
|       - |  2992 | `/*` |
|       - |  2993 | ` * Compile a literal which is an identifier(name) for a simple value.` |
|       - |  2994 | ` */` |
|  722704 |  2995 | `PH7_PRIVATE sxi32 PH7_CompileLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  2996 |  |
|       - |  2997 | `	sxi32 rc;` |
|  722709 |  2998 | `	rc = GenStateResolveNamespaceLiteral(&(*pGen));` |
|  722709 |  2999 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  3000 | `		SXUNUSED(iCompileFlag); /* cc warning */` |
|     ! 0 |  3001 | `		return rc;` |
|       - |  3002 | `	}` |
|       - |  3003 | `	/* Node successfully compiled */` |
|  722709 |  3004 | `	return SXRET_OK;` |
|  361357 |  3005 |  |
|       - |  3006 | `/*` |
...
|       8 |  3071 | `		rc = PH7_GenCompileError(pGen,E_ERROR,nLineLocal,"const: Invalid constant name");` |
|       8 |  3072 | `		if( rc == SXERR_ABORT ){` |
|       - |  3073 | `			/* Error count limit reached,abort immediately */` |
|     ! 0 |  3074 | `			return SXERR_ABORT;` |
|       - |  3075 | `		}` |
|       8 |  3076 | `		goto Synchronize;` |
|       - |  3077 | `	}` |
...
|       - |  3164 | ` */` |
|    3420 |  3165 | `static void GenStateEmitExceptionPopForBreak(ph7_gen_state *pGen,GenBlock *pTarget)` |
|       5 |  3166 |  |
|    3425 |  3167 | `	GenBlock *pBlock = pGen->pCurrent;` |
|   20033 |  3168 | `	while( pBlock && pBlock != pTarget ){` |
|   16613 |  3169 | `		if( pBlock->iFlags & GEN_BLOCK_EXCEPTION ){` |
...
|       - |  3179 | `			}` |
|       1 |  3180 | `		}` |
|   16613 |  3181 | `		pBlock = pBlock->pParent;` |
|       5 |  3182 | `	}` |
|    3425 |  3183 |  |
|    3324 |  3184 | `static sxi32 PH7_CompileContinue(ph7_gen_state *pGen)` |
|       5 |  3185 |  |
|       - |  3186 | `	GenBlock *pLoop; /* Target loop */` |
|       - |  3187 | `	sxi32 iLevel;    /* How many nesting loop to skip */` |
|       - |  3188 | `	sxu32 nLineLocal;` |
|       - |  3189 | `	sxi32 rc;` |
|    3329 |  3190 | `	nLineLocal = pGen->pIn->nLine;` |
|    3329 |  3191 | `	iLevel = 0;` |
|       - |  3192 | `	/* Jump the 'continue' keyword */` |
|    3329 |  3193 | `	pGen->pIn++;` |
|    3329 |  3194 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NUM) ){` |
...
|    3329 |  3220 | `	pLoop = GenStateFetchBlock(pGen->pCurrent,GEN_BLOCK_LOOP,iLevel);` |
|    3329 |  3221 | `	if( pLoop == 0 ){` |
|       - |  3222 | `		/* Illegal continue */` |
|      13 |  3223 | `		rc = PH7_GenCompileError(pGen,E_ERROR,nLineLocal,"A 'continue' statement may only be used within a loop or switch");` |
|      13 |  3224 | `		if( rc == SXERR_ABORT ){` |
|       - |  3225 | `			/* Error count limit reached,abort immediately */` |
|     ! 0 |  3226 | `			return SXERR_ABORT;` |
|       - |  3227 | `		}` |
|       8 |  3228 | `	}else{` |
|    3319 |  3229 | `		sxu32 nInstrIdx = 0;` |
|       - |  3230 | `		/* Emit POP_EXCEPTION for any try blocks between here and the loop */` |
|    3319 |  3231 | `		GenStateEmitExceptionPopForBreak(&(*pGen),pLoop);` |
|    3319 |  3232 | `		if( pLoop->iFlags & GEN_BLOCK_SWITCH ){` |
...
|    3315 |  3244 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pLoop->nFirstInstr,0,&nInstrIdx);` |
|    3315 |  3245 | `			if( pLoop->bPostContinue == TRUE ){` |
...
|       - |  3252 | `		}` |
|       - |  3253 | `	}` |
|    3329 |  3254 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
...
|     127 |  3304 | `	if( pLoop == 0 ){` |
|       - |  3305 | `		/* Illegal break */` |
|      18 |  3306 | `		rc = PH7_GenCompileError(pGen,E_ERROR,pGen->pIn->nLine,"A 'break' statement may only be used within a loop or switch");` |
|      18 |  3307 | `		if( rc == SXERR_ABORT ){` |
...
|       5 |  3371 | `		}` |
|     113 |  3372 | `		if( pBlock ){` |
|      24 |  3373 | `			sLabel.pFunc = (ph7_vm_func *)pBlock->pUserData;` |
|      14 |  3374 | `		}else{` |
...
|      29 |  3447 | `			sJump.pFunc = (ph7_vm_func *)pBlock->pUserData;` |
|      16 |  3448 | `		}else{` |
...
|       - |  3535 | ` * message.` |
|       - |  3536 | ` */` |
|  397964 |  3537 | `static sxi32 PH7_CompileBlock(` |
...
|       - |  3542 | `	sxi32 rc;` |
|       - |  3543 | `	sxu32 nLine;` |
|  397969 |  3544 | `	if( pGen->pIn->nType & PH7_TK_OCB /* '{' */ ){` |
|  396483 |  3545 | `		nLine = pGen->pIn->nLine;` |
|  396483 |  3546 | `		rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_STD,PH7_VmInstrLength(pGen->pVm),0,0);` |
|  396483 |  3547 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  3548 | `			return SXERR_ABORT;` |
|       - |  3549 | `		}` |
|  396483 |  3550 | `		pGen->pIn++;` |
|       - |  3551 | `		/* Compile until we hit the closing braces '}' */` |
|  541515 |  3552 | `		for(;;){` |
| 1083035 |  3553 | `			if( pGen->pIn >= pGen->pEnd ){` |
...
|       - |  3562 | `				}` |
|     ! 0 |  3563 | `			}` |
| 1083015 |  3564 | `			if( pGen->pIn->nType & PH7_TK_CCB/*'}'*/ ){` |
|       - |  3565 | `				/* Closing braces found,break immediately*/` |
|  396463 |  3566 | `				pGen->pIn++;` |
|  396463 |  3567 | `				break;` |
|       - |  3568 | `			}` |
|       - |  3569 | `			/* Compile a single statement */` |
|  686557 |  3570 | `			rc = GenStateCompileChunk(&(*pGen),PH7_COMPILE_SINGLE_STMT);` |
|  686557 |  3571 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  3572 | `				return SXERR_ABORT;` |
|       - |  3573 | `			}` |
|       5 |  3574 | `		}` |
|  396483 |  3575 | `		GenStateLeaveBlock(&(*pGen),0);` |
|  199730 |  3576 | `	}else if( (pGen->pIn->nType & PH7_TK_COLON /* ':' */) && nKeywordEnd > 0 ){` |
|     ! 0 |  3577 | `		pGen->pIn++;` |
...
|    1491 |  3620 | `		rc = GenStateCompileChunk(&(*pGen),PH7_COMPILE_SINGLE_STMT);` |
|    1491 |  3621 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  3622 | `			return SXERR_ABORT;` |
|       - |  3623 | `		}` |
|       - |  3624 | `	}` |
|       - |  3625 | `	/* Jump trailing semi-colons ';' */` |
|  397969 |  3626 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|     ! 0 |  3627 | `		pGen->pIn++;` |
|     ! 0 |  3628 | `	}` |
|  397969 |  3629 | `	return SXRET_OK;` |
|  198987 |  3630 |  |
|       - |  3631 | `/*` |
...
|       - |  3648 | ` *   endwhile;` |
|       - |  3649 | ` */` |
|   13240 |  3650 | `static sxi32 PH7_CompileWhile(ph7_gen_state *pGen)` |
|       5 |  3651 |  |
|   13245 |  3652 | `	GenBlock *pWhileBlock = 0;` |
|   13245 |  3653 | `	SyToken *pTmp,*pEnd = 0;` |
|       - |  3654 | `	sxu32 nFalseJump;` |
|       - |  3655 | `	sxu32 nLine;` |
|       - |  3656 | `	sxi32 rc;` |
|   13245 |  3657 | `	nLine = pGen->pIn->nLine;` |
|       - |  3658 | `	/* Jump the 'while' keyword */` |
|   13245 |  3659 | `	pGen->pIn++;` |
|   13245 |  3660 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  3661 | `		/* Syntax error */` |
...
|   13245 |  3672 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pWhileBlock);` |
|   13245 |  3673 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  3674 | `		return SXERR_ABORT;` |
|       - |  3675 | `	}` |
|       - |  3676 | `	/* Delimit the condition */` |
|   13245 |  3677 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   13245 |  3678 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|   13245 |  3687 | `	pTmp = pGen->pEnd;` |
|   13245 |  3688 | `	pGen->pEnd = pEnd;` |
|       - |  3689 | `	/* Compile the expression */` |
|   13245 |  3690 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   13245 |  3691 | `	if( rc == SXERR_ABORT ){` |
|       - |  3692 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  3693 | `		return SXERR_ABORT;` |
|       - |  3694 | `	}` |
|       - |  3695 | `	/* Update token stream */` |
|   13245 |  3696 | `	while(pGen->pIn < pEnd ){` |
...
|   13245 |  3704 | `	pGen->pIn  = &pEnd[1];` |
|   13245 |  3705 | `	pGen->pEnd = pTmp;` |
|       - |  3706 | `	/* Emit the false jump */` |
|   13245 |  3707 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nFalseJump);` |
|       - |  3708 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   13245 |  3709 | `	GenStateNewJumpFixup(pWhileBlock,PH7_OP_JZ,nFalseJump);` |
|       - |  3710 | `	/* Compile the loop body */` |
|   13245 |  3711 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDWHILE);` |
|   13245 |  3712 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  3713 | `		return SXERR_ABORT;` |
|       - |  3714 | `	}` |
|       - |  3715 | `	/* Emit the unconditional jump to the start of the loop */` |
|   13245 |  3716 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pWhileBlock->nFirstInstr,0,0);` |
|       - |  3717 | `	/* Fix all jumps now the destination is resolved */` |
|   13245 |  3718 | `	GenStateFixJumps(pWhileBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - |  3719 | `	/* Release the loop block */` |
|   13245 |  3720 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  3721 | `	/* Statement successfully compiled */` |
|   13245 |  3722 | `	return SXRET_OK;` |
|     ! 0 |  3723 | `Synchronize:` |
...
|       - |  3878 | ` */` |
|   13240 |  3879 | `static sxi32 PH7_CompileFor(ph7_gen_state *pGen)` |
|       5 |  3880 |  |
|   13245 |  3881 | `	SyToken *pTmp,*pPostStart,*pEnd = 0;` |
|   13245 |  3882 | `	GenBlock *pForBlock = 0;` |
|       - |  3883 | `	sxu32 nFalseJump;` |
|       - |  3884 | `	sxu32 nLine;` |
|       - |  3885 | `	sxi32 rc;` |
|   13245 |  3886 | `	nLine = pGen->pIn->nLine;` |
|       - |  3887 | `	/* Jump the 'for' keyword */` |
|   13245 |  3888 | `	pGen->pIn++;` |
|   13245 |  3889 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  3890 | `		/* Syntax error */` |
...
|   13245 |  3901 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   13245 |  3902 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|   13245 |  3917 | `	pTmp = pGen->pEnd;` |
|   13245 |  3918 | `	pGen->pEnd = pEnd;` |
|       - |  3919 | `	/* Compile initialization expressions if available */` |
|   13245 |  3920 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|       - |  3921 | `	/* Pop operand lvalues */` |
|   13245 |  3922 | `	if( rc == SXERR_ABORT ){` |
|       - |  3923 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  3924 | `		return SXERR_ABORT;` |
|   13245 |  3925 | `	}else if( rc != SXERR_EMPTY ){` |
|   13243 |  3926 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|    6619 |  3927 | `	}` |
|   13245 |  3928 | `	if( (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|       - |  3929 | `		/* Syntax error */` |
...
|   13245 |  3941 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pForBlock);` |
|   13245 |  3942 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  3943 | `		return SXERR_ABORT;` |
|       - |  3944 | `	}` |
|       - |  3945 | `	/* Deffer continue jumps */` |
|   13245 |  3946 | `	pForBlock->bPostContinue = TRUE;` |
|       - |  3947 | `	/* Compile the condition */` |
|   13245 |  3948 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   13245 |  3949 | `	if( rc == SXERR_ABORT ){` |
|       - |  3950 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  3951 | `		return SXERR_ABORT;` |
|   13245 |  3952 | `	}else if( rc != SXERR_EMPTY ){` |
|       - |  3953 | `		/* Emit the false jump */` |
|   13243 |  3954 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nFalseJump);` |
|       - |  3955 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   13243 |  3956 | `		GenStateNewJumpFixup(pForBlock,PH7_OP_JZ,nFalseJump);` |
|    6619 |  3957 | `	}` |
|   13245 |  3958 | `	if( (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|       - |  3959 | `		/* Syntax error */` |
...
|   13241 |  3971 | `	pPostStart = pGen->pIn;` |
|       - |  3972 | `	/* Compile the loop body */` |
|   13241 |  3973 | `	pGen->pIn  = &pEnd[1]; /* Jump the trailing parenthesis ')' */` |
|   13241 |  3974 | `	pGen->pEnd = pTmp;` |
|   13241 |  3975 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDFOR);` |
|   13241 |  3976 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  3977 | `		return SXERR_ABORT;` |
|       - |  3978 | `	}` |
|       - |  3979 | `	/* Fix post-continue jumps */` |
|   13241 |  3980 | `	if( SySetUsed(&pForBlock->aPostContFix) > 0 ){` |
...
|   13241 |  3996 | `	while( pPostStart < pEnd && (pPostStart->nType & PH7_TK_SEMI) ){` |
|     ! 0 |  3997 | `		pPostStart++;` |
|     ! 0 |  3998 | `	}` |
|   13241 |  3999 | `	if( pPostStart < pEnd ){` |
|       - |  4000 | `		SyToken *pTmpIn,*pTmpEnd;` |
|   13241 |  4001 | `		SWAP_DELIMITER(pGen,pPostStart,pEnd);` |
|   13241 |  4002 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   13241 |  4003 | `		if( pGen->pIn < pGen->pEnd ){` |
|       - |  4004 | `			/* Syntax error */` |
...
|       - |  4011 | `		}` |
|   13241 |  4012 | `		RE_SWAP_DELIMITER(pGen);` |
|   13241 |  4013 | `		if( rc == SXERR_ABORT ){` |
|       - |  4014 | `			/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4015 | `			return SXERR_ABORT;` |
|   13241 |  4016 | `		}else if( rc != SXERR_EMPTY){` |
|       - |  4017 | `			/* Pop operand lvalue */` |
|   13241 |  4018 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|    6618 |  4019 | `		}` |
|    6618 |  4020 | `	}` |
|       - |  4021 | `	/* Emit the unconditional jump to the start of the loop */` |
|   13241 |  4022 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pForBlock->nFirstInstr,0,0);` |
|       - |  4023 | `	/* Fix all jumps now the destination is resolved */` |
|   13241 |  4024 | `	GenStateFixJumps(pForBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - |  4025 | `	/* Release the loop block */` |
|   13241 |  4026 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  4027 | `	/* Statement successfully compiled */` |
|   13241 |  4028 | `	return SXRET_OK;` |
|    6625 |  4029 |  |
...
|       - |  4032 | ` * are allowed.` |
|       - |  4033 | ` */` |
|    7062 |  4034 | `static sxi32 GenStateForEachNodeValidator(ph7_gen_state *pGen,ph7_expr_node *pRoot)` |
|       5 |  4035 |  |
|    7067 |  4036 | `	sxi32 rc = SXRET_OK; /* Assume a valid expression tree */` |
|    7067 |  4037 | `	if( pRoot->xCode != PH7_CompileVariable ){` |
...
|       - |  4072 | ` */` |
|    3596 |  4073 | `static sxi32 PH7_CompileForeach(ph7_gen_state *pGen)` |
|       5 |  4074 |  |
|    3601 |  4075 | `	SyToken *pCur,*pTmp,*pEnd = 0;` |
|    3601 |  4076 | `	SyToken *pListStart = 0,*pListEnd = 0;` |
|    3601 |  4077 | `	GenBlock *pForeachBlock = 0;` |
|       - |  4078 | `	ph7_foreach_info *pInfo;` |
|       - |  4079 | `	sxu32 nFalseJump;` |
|       - |  4080 | `	VmInstr *pInstr;` |
|       - |  4081 | `	sxu32 nLine;` |
|       - |  4082 | `	sxi32 rc;` |
|    3601 |  4083 | `	nLine = pGen->pIn->nLine;` |
|       - |  4084 | `	/* Jump the 'foreach' keyword */` |
|    3601 |  4085 | `	pGen->pIn++;` |
|    3601 |  4086 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  4087 | `		/* Syntax error */` |
...
|    3601 |  4098 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pForeachBlock);` |
|    3601 |  4099 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  4100 | `		return SXERR_ABORT;` |
|       - |  4101 | `	}` |
|       - |  4102 | `	/* Delimit the expression */` |
|    3601 |  4103 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|    3601 |  4104 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|    3601 |  4119 | `	pCur = pGen->pIn;` |
|   24143 |  4120 | `	while( pCur < pEnd ){` |
|   24143 |  4121 | `		if( pCur->nType & PH7_TK_KEYWORD ){` |
|    3615 |  4122 | `			sxi32 nKeywrd = SX_PTR_TO_INT(pCur->pUserData);` |
|    3615 |  4123 | `			if( nKeywrd == PH7_TKWRD_AS ){` |
...
|    3601 |  4141 | `	pTmp = pGen->pEnd;` |
|    3601 |  4142 | `	pGen->pEnd = pCur;` |
|    3601 |  4143 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|    3601 |  4144 | `	if( rc == SXERR_ABORT ){` |
|       - |  4145 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4146 | `		return SXERR_ABORT;` |
|       - |  4147 | `	}` |
|       - |  4148 | `	/* Update token stream */` |
|    3601 |  4149 | `	while(pGen->pIn < pCur ){` |
...
|     ! 0 |  4155 | `		pGen->pIn++;` |
|     ! 0 |  4156 | `	}` |
|    3601 |  4157 | `	pCur++; /* Jump the 'as' keyword */` |
|    3601 |  4158 | `	pGen->pIn = pCur;` |
|    3601 |  4159 | `	if( pGen->pIn >= pEnd ){` |
...
|    3601 |  4166 | `	pInfo = (ph7_foreach_info *)SyMemBackendAlloc(&pGen->pVm->sAllocator,sizeof(ph7_foreach_info));` |
|    3601 |  4167 | `	if( pInfo == 0 ){` |
...
|    3601 |  4172 | `	SyZero(pInfo,sizeof(ph7_foreach_info));` |
|       - |  4173 | `	/* Initialize structure fields */` |
|    3601 |  4174 | `	SySetInit(&pInfo->aStep,&pGen->pVm->sAllocator,sizeof(ph7_foreach_step *));` |
|       - |  4175 | `	/* Check if we have a key field */` |
|   10843 |  4176 | `	while( pCur < pEnd && (pCur->nType & PH7_TK_ARRAY_OP) == 0 ){` |
|    7247 |  4177 | `		pCur++;` |
|       5 |  4178 | `	}` |
|    3601 |  4179 | `	if( pCur < pEnd ){` |
|       - |  4180 | `		/* Compile the expression holding the key name */` |
|    3481 |  4181 | `		if( pGen->pIn >= pCur ){` |
...
|       - |  4186 | `			}` |
|     ! 0 |  4187 | `		}else{` |
|    3481 |  4188 | `			pGen->pEnd = pCur;` |
|    3481 |  4189 | `			rc = PH7_CompileExpr(&(*pGen),0,GenStateForEachNodeValidator);` |
|    3481 |  4190 | `			if( rc == SXERR_ABORT ){` |
|       - |  4191 | `				/* Don't worry about freeing memory, everything will be released shortly */` |
|     ! 0 |  4192 | `				return SXERR_ABORT;` |
|       - |  4193 | `			}` |
|    3481 |  4194 | `			pInstr = PH7_VmPopInstr(pGen->pVm);` |
|    3481 |  4195 | `			if( pInstr->p3 ){` |
|       - |  4196 | `				/* Record key name */` |
|    3481 |  4197 | `				SyStringInitFromBuf(&pInfo->sKey,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|    1738 |  4198 | `			}` |
|    3481 |  4199 | `			pInfo->iFlags \|= PH7_4EACH_STEP_KEY;` |
|       - |  4200 | `		}` |
|    3481 |  4201 | `		pGen->pIn = &pCur[1]; /* Jump the arrow */` |
|    1738 |  4202 | `	}` |
|    3601 |  4203 | `	pGen->pEnd = pEnd;` |
|    3601 |  4204 | `	if( pGen->pIn >= pEnd ){` |
...
|    3596 |  4259 | `	}else if( pGen->pIn->nType & PH7_TK_OSB ){` |
...
|    3591 |  4292 | `		rc = PH7_CompileExpr(&(*pGen),0,GenStateForEachNodeValidator);` |
|    3591 |  4293 | `		if( rc == SXERR_ABORT ){` |
|       - |  4294 | `			/* Don't worry about freeing memory, everything will be released shortly */` |
|     ! 0 |  4295 | `			return SXERR_ABORT;` |
|       - |  4296 | `		}` |
|    3591 |  4297 | `		pInstr = PH7_VmPopInstr(pGen->pVm);` |
|    3591 |  4298 | `		if( pInstr->p3 ){` |
|       - |  4299 | `			/* Record value name */` |
|    3591 |  4300 | `			SyStringInitFromBuf(&pInfo->sValue,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|    1793 |  4301 | `		}` |
|       - |  4302 | `	}` |
|       - |  4303 | `	/* Emit the 'FOREACH_INIT' instruction */` |
|    3599 |  4304 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_FOREACH_INIT,0,0,pInfo,&nFalseJump);` |
|       - |  4305 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|    3599 |  4306 | `	GenStateNewJumpFixup(pForeachBlock,PH7_OP_FOREACH_INIT,nFalseJump);` |
|       - |  4307 | `	/* Record the first instruction to execute */` |
|    3599 |  4308 | `	pForeachBlock->nFirstInstr = PH7_VmInstrLength(pGen->pVm);` |
|       - |  4309 | `	/* Emit the FOREACH_STEP instruction */` |
|    3599 |  4310 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_FOREACH_STEP,0,0,pInfo,&nFalseJump);` |
|       - |  4311 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|    3599 |  4312 | `	GenStateNewJumpFixup(pForeachBlock,PH7_OP_FOREACH_STEP,nFalseJump);` |
|       - |  4313 | `	/* If list() unpacking, emit bytecode to destructure the temp variable */` |
|    3599 |  4314 | `	if( (pInfo->iFlags & PH7_4EACH_STEP_LIST) && pListStart && pListEnd ){` |
...
|    3599 |  4342 | `	pGen->pIn = &pEnd[1];` |
|    3599 |  4343 | `	pGen->pEnd = pTmp;` |
|    3599 |  4344 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_END4EACH);` |
|    3599 |  4345 | `	if( rc == SXERR_ABORT ){` |
...
|    3599 |  4350 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pForeachBlock->nFirstInstr,0,0);` |
|       - |  4351 | `	/* Fix all jumps now the destination is resolved */` |
|    3599 |  4352 | `	GenStateFixJumps(pForeachBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - |  4353 | `	/* Release the loop block */` |
|    3599 |  4354 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  4355 | `	/* Statement successfully compiled */` |
|    3599 |  4356 | `	return SXRET_OK;` |
|       1 |  4357 | `Synchronize:` |
...
|       - |  4396 | ` *    ?>` |
|       - |  4397 | ` */` |
|  137676 |  4398 | `static sxi32 PH7_CompileIf(ph7_gen_state *pGen)` |
|       5 |  4399 |  |
|  137681 |  4400 | `	SyToken *pToken,*pTmp,*pEnd = 0;` |
|  137681 |  4401 | `	GenBlock *pCondBlock = 0;` |
|       - |  4402 | `	sxu32 nJumpIdx;` |
|       - |  4403 | `	sxu32 nKeyID;` |
|       - |  4404 | `	sxi32 rc;` |
|       - |  4405 | `	/* Jump the 'if' keyword */` |
|  137681 |  4406 | `	pGen->pIn++;` |
|  137681 |  4407 | `	pToken = pGen->pIn;` |
|       - |  4408 | `	/* Create the conditional block */` |
|  137681 |  4409 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_COND,PH7_VmInstrLength(pGen->pVm),0,&pCondBlock);` |
|  137681 |  4410 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  4411 | `		return SXERR_ABORT;` |
|       - |  4412 | `	}` |
|       - |  4413 | `	/* Process as many [if/else if/elseif/else] blocks as we can */` |
|   75411 |  4414 | `	for(;;){` |
|  150827 |  4415 | `		if( pToken >= pGen->pEnd \|\| (pToken->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  4416 | `			/* Syntax error */` |
...
|  150827 |  4430 | `		PH7_DelimitNestedTokens(pToken,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|  150827 |  4431 | `		if( pToken >= pEnd \|\| (pEnd->nType & PH7_TK_RPAREN) == 0 ){` |
|       - |  4432 | `			/* Syntax error */` |
...
|  150827 |  4444 | `		SWAP_TOKEN_STREAM(pGen,pToken,pEnd);` |
|       - |  4445 | `		/* Compile the condition */` |
|  150827 |  4446 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|       - |  4447 | `		/* Update token stream */` |
|  150827 |  4448 | `		while(pGen->pIn < pEnd ){` |
|     ! 0 |  4449 | `			PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Unexpected token '%z'",&pGen->pIn->sData);` |
|     ! 0 |  4450 | `			pGen->pIn++;` |
|     ! 0 |  4451 | `		}` |
|  150827 |  4452 | `		pGen->pIn  = &pEnd[1];` |
|  150827 |  4453 | `		pGen->pEnd = pTmp;` |
|  150827 |  4454 | `		if( rc == SXERR_ABORT ){` |
|       - |  4455 | `			/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4456 | `			return SXERR_ABORT;` |
|       - |  4457 | `		}` |
|       - |  4458 | `		/* Emit the false jump */` |
|  150827 |  4459 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nJumpIdx);` |
|       - |  4460 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|  150827 |  4461 | `		GenStateNewJumpFixup(pCondBlock,PH7_OP_JZ,nJumpIdx);` |
|       - |  4462 | `		/* Compile the body */` |
|  150827 |  4463 | `		rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDIF);` |
|  150827 |  4464 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  4465 | `			return SXERR_ABORT;` |
|       - |  4466 | `		}` |
|  150827 |  4467 | `		if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
|   42081 |  4468 | `			break;` |
|       - |  4469 | `		}` |
|       - |  4470 | `		/* Ensure that the keyword ID is 'else if' or 'else' */` |
|   66675 |  4471 | `		nKeyID = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   66675 |  4472 | `		if( (nKeyID & (PH7_TKWRD_ELSE\|PH7_TKWRD_ELIF)) == 0 ){` |
|   42947 |  4473 | `			break;` |
|       - |  4474 | `		}` |
|       - |  4475 | `		/* Emit the unconditional jump */` |
|   23733 |  4476 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,0,0,&nJumpIdx);` |
|       - |  4477 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   23733 |  4478 | `		GenStateNewJumpFixup(pCondBlock,PH7_OP_JMP,nJumpIdx);` |
|   23733 |  4479 | `		if( nKeyID & PH7_TKWRD_ELSE ){` |
|   17147 |  4480 | `			pToken = &pGen->pIn[1];` |
|   17147 |  4481 | `			if( pToken >= pGen->pEnd \|\| (pToken->nType & PH7_TK_KEYWORD) == 0 \|\|` |
|    6590 |  4482 | `				SX_PTR_TO_INT(pToken->pUserData) != PH7_TKWRD_IF ){` |
|    5296 |  4483 | `					break;` |
|       - |  4484 | `			}` |
|    6565 |  4485 | `			pGen->pIn++; /* Jump the 'else' keyword */` |
|    3280 |  4486 | `		}` |
|   13151 |  4487 | `		pGen->pIn++; /* Jump the 'elseif/if' keyword */` |
|       - |  4488 | `		/* Synchronize cursors */` |
|   13151 |  4489 | `		pToken = pGen->pIn;` |
|       - |  4490 | `		/* Fix the false jump */` |
|   13151 |  4491 | `		GenStateFixJumps(pCondBlock,PH7_OP_JZ,PH7_VmInstrLength(pGen->pVm));` |
|       5 |  4492 | `	} /* For(;;) */` |
|       - |  4493 | `	/* Fix the false jump */` |
|  137681 |  4494 | `	GenStateFixJumps(pCondBlock,PH7_OP_JZ,PH7_VmInstrLength(pGen->pVm));` |
|  137681 |  4495 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|   53524 |  4496 | `		(SX_PTR_TO_INT(pGen->pIn->pUserData) & PH7_TKWRD_ELSE) ){` |
|       - |  4497 | `			/* Compile the else block */` |
|   10587 |  4498 | `			pGen->pIn++;` |
|   10587 |  4499 | `			rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDIF);` |
|   10587 |  4500 | `			if( rc == SXERR_ABORT ){` |
|       - |  4501 |  |
|     ! 0 |  4502 | `				return SXERR_ABORT;` |
|       - |  4503 | `			}` |
|    5291 |  4504 | `	}` |
|  137681 |  4505 | `	nJumpIdx = PH7_VmInstrLength(pGen->pVm);` |
|       - |  4506 | `	/* Fix all unconditional jumps now the destination is resolved */` |
|  137681 |  4507 | `	GenStateFixJumps(pCondBlock,PH7_OP_JMP,nJumpIdx);` |
|       - |  4508 | `	/* Release the conditional block */` |
|  137681 |  4509 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  4510 | `	/* Statement successfully compiled */` |
|  137681 |  4511 | `	return SXRET_OK;` |
|     ! 0 |  4512 | `Synchronize:` |
...
|       - |  4612 | ` */` |
|  217584 |  4613 | `static sxi32 PH7_CompileReturn(ph7_gen_state *pGen)` |
|       5 |  4614 |  |
|  217589 |  4615 | `	sxi32 nRet = 0; /* TRUE if there is a return value */` |
|       - |  4616 | `	sxi32 rc;` |
|       - |  4617 | `	/* Jump the 'return' keyword */` |
|  217589 |  4618 | `	pGen->pIn++;` |
|  217589 |  4619 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|       - |  4620 | `		/* Compile the expression */` |
|  217563 |  4621 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|  217563 |  4622 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  4623 | `			return SXERR_ABORT;` |
|  217563 |  4624 | `		}else if(rc != SXERR_EMPTY ){` |
|  217563 |  4625 | `			nRet = 1;` |
|  108779 |  4626 | `		}` |
|  108779 |  4627 | `	}` |
...
|  217589 |  4633 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,nRet,1,0,0);` |
|  217589 |  4634 | `	return SXRET_OK;` |
|  108797 |  4635 |  |
|       - |  4636 | `/*` |
...
|       - |  4725 | ` */` |
|   13554 |  4726 | `static sxi32 PH7_CompileEcho(ph7_gen_state *pGen)` |
|       5 |  4727 |  |
|   13559 |  4728 | `	SyToken *pTmp,*pNext = 0;` |
|       - |  4729 | `	sxi32 rc;` |
|       - |  4730 | `	/* Jump the 'echo' keyword */` |
|   13559 |  4731 | `	pGen->pIn++;` |
|       - |  4732 | `	/* Compile arguments one after one */` |
|   13559 |  4733 | `	pTmp = pGen->pEnd;` |
|   29399 |  4734 | `	while( SXRET_OK == PH7_GetNextExpr(pGen->pIn,pTmp,&pNext) ){` |
|   15845 |  4735 | `		if( pGen->pIn < pNext ){` |
|   15845 |  4736 | `			pGen->pEnd = pNext;` |
|   15845 |  4737 | `			rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_RDONLY_LOAD/* Do not create variable if inexistant */,0);` |
|   15845 |  4738 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  4739 | `				return SXERR_ABORT;` |
|   15845 |  4740 | `			}else if( rc != SXERR_EMPTY ){` |
|       - |  4741 | `				/* Emit the consume instruction */` |
|   15821 |  4742 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_CONSUME,1,0,0,0);` |
|    7908 |  4743 | `			}` |
|    7920 |  4744 | `		}` |
|       - |  4745 | `		/* Jump trailing commas */` |
|   18131 |  4746 | `		while( pNext < pTmp && (pNext->nType & PH7_TK_COMMA) ){` |
|    2291 |  4747 | `			pNext++;` |
|       5 |  4748 | `		}` |
|   15845 |  4749 | `		pGen->pIn = pNext;` |
|       5 |  4750 | `	}` |
|       - |  4751 | `	/* Restore token stream */` |
|   13559 |  4752 | `	pGen->pEnd = pTmp;` |
|   13559 |  4753 | `	return SXRET_OK;` |
|    6782 |  4754 |  |
|       - |  4755 | `/*` |
...
|       - |  4920 | ` */` |
|  406064 |  4921 | `static sxu32 GenStateNsQualifyName(ph7_gen_state *pGen,sxu32 nOrigIdx,SyHash *pImports,int *pFromImport)` |
|       5 |  4922 |  |
|       - |  4923 | `	ph7_value *pLit;` |
...
|       - |  4931 | `	ph7_value *pNew;` |
|  406069 |  4932 | `	if( pFromImport ){` |
|  388193 |  4933 | `		*pFromImport = 0;` |
|  194094 |  4934 | `	}` |
|  406069 |  4935 | `	pLit = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,nOrigIdx);` |
|  406069 |  4936 | `	if( !pLit \|\| !(pLit->iFlags & MEMOBJ_STRING) \|\| SyBlobLength(&pLit->sBlob) == 0 ){` |
|     ! 0 |  4937 | `		return nOrigIdx;` |
|       - |  4938 | `	}` |
|  406069 |  4939 | `	zLit = (const char *)SyBlobData(&pLit->sBlob);` |
|  406069 |  4940 | `	nLit = (sxu32)SyBlobLength(&pLit->sBlob);` |
|       - |  4941 | `	/* Skip if already qualified (contains backslash) */` |
|  406069 |  4942 | `	hasNsSep = 0;` |
| 4393355 |  4943 | `	for( k = 0; k < nLit; k++ ){` |
| 3987299 |  4944 | `		if( zLit[k] == '\\' ){ hasNsSep = 1; break; }` |
| 1993648 |  4945 | `	}` |
|  406069 |  4946 | `	if( hasNsSep ){` |
|      11 |  4947 | `		return nOrigIdx;` |
|       - |  4948 | `	}` |
|       - |  4949 | `	/* Check use imports first (works even outside namespaces) */` |
|  406061 |  4950 | `	SyBlobReset(&pGen->sWorker);` |
|  406061 |  4951 | `	pImport = SyHashGet(pImports,(const void *)zLit,nLit);` |
|  406061 |  4952 | `	if( pImport ){` |
...
|       8 |  4957 | `		}` |
|      23 |  4958 | `	}else{` |
|  406025 |  4959 | `		if( SyBlobLength(&pGen->sNamespace) == 0 ){` |
|  405935 |  4960 | `			return nOrigIdx; /* Not in a namespace and no import match */` |
|       - |  4961 | `		}` |
...
|       - |  4983 | ` */` |
|   89298 |  4984 | `static void GenStateResolveName(ph7_gen_state *pGen,const SyString *pName,SyBlob *pOut)` |
|       5 |  4985 |  |
|       - |  4986 | `	SyHashEntry *pImport;` |
|       - |  4987 | `	/* Check use imports first */` |
|   89303 |  4988 | `	pImport = SyHashGet(&pGen->hUseImports,(const void *)pName->zString,pName->nByte);` |
|   89303 |  4989 | `	if( pImport ){` |
...
|       - |  5005 | ` */` |
|  125794 |  5006 | `static void GenStateBuildFQN(ph7_gen_state *pGen,const SyString *pName,SyBlob *pOut)` |
|       5 |  5007 |  |
|  125799 |  5008 | `	if( SyBlobLength(&pGen->sNamespace) > 0 ){` |
|      63 |  5009 | `		SyBlobAppend(pOut,SyBlobData(&pGen->sNamespace),SyBlobLength(&pGen->sNamespace));` |
|      63 |  5010 | `		SyBlobAppend(pOut,"\\",1);` |
|      29 |  5011 | `	}` |
|  125799 |  5012 | `	SyBlobAppend(pOut,pName->zString,pName->nByte);` |
|  125799 |  5013 |  |
|       - |  5014 | `/*` |
...
|       - |  5510 | ` */` |
|   62354 |  5511 | `static sxi32 GenStateProcessArgValue(ph7_gen_state *pGen,ph7_vm_func_arg *pArg,SyToken *pIn,SyToken *pEnd)` |
|       5 |  5512 |  |
|       - |  5513 | `	SyToken *pTmpIn,*pTmpEnd;` |
|       - |  5514 | `	SySet *pInstrContainer;` |
|       - |  5515 | `	sxi32 rc;` |
|       - |  5516 | `	/* Swap token stream */` |
|   62359 |  5517 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|   62359 |  5518 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   62359 |  5519 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pArg->aByteCode);` |
|       - |  5520 | `	/* Compile the expression holding the argument value */` |
|   62359 |  5521 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|       - |  5522 | `	/* Emit the done instruction */` |
|   62359 |  5523 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,(rc != SXERR_EMPTY ? 1 : 0),0,0,0);` |
|   62359 |  5524 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|   62359 |  5525 | `	RE_SWAP_DELIMITER(pGen);` |
|   62359 |  5526 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  5527 | `		return SXERR_ABORT;` |
|       - |  5528 | `	}` |
|   62359 |  5529 | `	return SXRET_OK;` |
|   31182 |  5530 |  |
|       - |  5531 | `/*` |
...
|       - |  5567 | ` */` |
|   86454 |  5568 | `static sxi32 GenStateCollectFuncArgs(ph7_vm_func *pFunc,ph7_gen_state *pGen,SyToken *pEnd,int bCtorCtx,int bAbstractCtx)` |
|       5 |  5569 |  |
...
|       - |  5574 | `	sxi32 rc;` |
|       - |  5575 |  |
|   86459 |  5576 | `	pIn = pGen->pIn;` |
|   86459 |  5577 | `	SyBlobInit(&sSig,&pGen->pVm->sAllocator);` |
|       - |  5578 | `	/* Process arguments one after one */` |
|  108129 |  5579 | `	for(;;){` |
|  216263 |  5580 | `		if( pIn >= pEnd ){` |
|       - |  5581 | `			/* No more arguments to process */` |
|   86447 |  5582 | `			break;` |
|       - |  5583 | `		}` |
|  129821 |  5584 | `		SyZero(&sArg,sizeof(ph7_vm_func_arg));` |
|  129821 |  5585 | `		SySetInit(&sArg.aByteCode,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|  129821 |  5586 | `		SySetInit(&sArg.aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|  129821 |  5587 | `		SyStringInitFromBuf(&sArg.sTypeName,0,0);` |
...
|       - |  5593 | `		{` |
|  129821 |  5594 | `			int bReadonly = 0, bVisSeen = 0;` |
|  129821 |  5595 | `			sxi32 iVis = PH7_CLASS_PROT_PUBLIC;` |
|  129821 |  5596 | `			if( pIn < pEnd && GenStateIsReadonly(pIn) ){` |
|       3 |  5597 | `				bReadonly = 1;` |
|       3 |  5598 | `				pIn++;` |
|       1 |  5599 | `			}` |
|  129821 |  5600 | `			if( pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD) ){` |
|   59233 |  5601 | `				sxu32 nKw = (sxu32)SX_PTR_TO_INT(pIn->pUserData);` |
|   59233 |  5602 | `				if( nKw == PH7_TKWRD_PUBLIC \|\| nKw == PH7_TKWRD_PROTECTED \|\| nKw == PH7_TKWRD_PRIVATE ){` |
|      65 |  5603 | `					bVisSeen = 1;` |
...
|      30 |  5612 | `				}` |
|   29614 |  5613 | `			}` |
|  129821 |  5614 | `			if( bVisSeen \|\| bReadonly ){` |
|      67 |  5615 | `				if( !bCtorCtx ){` |
...
|  129812 |  5636 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_DOLLAR) == 0` |
|  101125 |  5637 | `			&& (pIn->nType & PH7_TK_AMPER) == 0` |
|   70790 |  5638 | `			&& (pIn->nType & PH7_TK_ELLIPSIS) == 0 ){` |
|   69115 |  5639 | `			sxu32 nLineLocal = pIn->nLine;` |
|   69115 |  5640 | `			sxi32 iTFlags = 0;` |
|   69115 |  5641 | `			pGen->pIn = pIn;` |
|   69115 |  5642 | `			rc = GenStateParseUnionTypeDecl(` |
|   34555 |  5643 | `				pGen, &sArg.nType, &sArg.sClass, &sArg.aUnionAlts,` |
|   34555 |  5644 | `				&iTFlags, &sArg.sTypeName,` |
|       - |  5645 | `				VM_FUNC_ARG_NULLABLE, VM_FUNC_ARG_UNION,` |
|       - |  5646 | `				/* bAllowVoid */ 0,` |
|   34555 |  5647 | `						nLineLocal);` |
|   69115 |  5648 | `			pIn = pGen->pIn;` |
|   69115 |  5649 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  5650 | `				return SXERR_ABORT;` |
|   69115 |  5651 | `			}else if( rc == SXERR_CORRUPT ){` |
|       - |  5652 | `				/* Error already reported by GenStateParseUnionTypeDecl */` |
|       3 |  5653 | `				return SXERR_SYNTAX;` |
|   69113 |  5654 | `			}else if( rc == SXERR_SYNTAX ){` |
|       6 |  5655 | `				if( pIn < pEnd ){` |
...
|       - |  5664 | `			}` |
|   69109 |  5665 | `			sArg.iFlags \|= iTFlags;` |
|   34552 |  5666 | `		}` |
|  129811 |  5667 | `		if( pIn >= pEnd ){` |
|     ! 0 |  5668 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Missing argument name");` |
|     ! 0 |  5669 | `			return rc;` |
|       - |  5670 | `		}` |
|  129811 |  5671 | `		if( pIn->nType & PH7_TK_AMPER ){` |
|       - |  5672 | `			/* Pass by reference,record that */` |
|    3313 |  5673 | `			sArg.iFlags \|= VM_FUNC_ARG_BY_REF;` |
|    3313 |  5674 | `			pIn++;` |
|    1654 |  5675 | `		}` |
|  129811 |  5676 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_ELLIPSIS) ){` |
|       - |  5677 | `			/* Variadic parameter: ...$args */` |
|      47 |  5678 | `			sArg.iFlags \|= VM_FUNC_ARG_VARIADIC;` |
|      47 |  5679 | `			pIn++;` |
|      21 |  5680 | `		}` |
|  129811 |  5681 | `		if( pIn >= pEnd \|\| (pIn->nType & PH7_TK_DOLLAR) == 0 \|\| &pIn[1] >= pEnd \|\| (pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|       - |  5682 | `			/* Invalid argument */` |
|     ! 0 |  5683 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Invalid argument name");` |
|     ! 0 |  5684 | `			return rc;` |
|       - |  5685 | `		}` |
|  129811 |  5686 | `		pIn++; /* Jump the dollar sign */` |
|       - |  5687 | `		/* Copy argument name */` |
|  129811 |  5688 | `		zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,SyStringData(&pIn->sData),SyStringLength(&pIn->sData));` |
|  129811 |  5689 | `		if( zDup == 0 ){` |
|     ! 0 |  5690 | `			PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"PH7 engine is running out of memory");` |
|     ! 0 |  5691 | `			return SXERR_ABORT;` |
|       - |  5692 | `		}` |
|  129811 |  5693 | `		SyStringInitFromBuf(&sArg.sName,zDup,SyStringLength(&pIn->sData));` |
|  129811 |  5694 | `		pIn++;` |
|  129811 |  5695 | `		if( pIn < pEnd ){` |
|   72921 |  5696 | `			if( pIn->nType & PH7_TK_EQUAL ){` |
|       - |  5697 | `				SyToken *pDefend;` |
|   62361 |  5698 | `				sxi32 iNest = 0;` |
|   62361 |  5699 | `				pIn++; /* Jump the equal sign */` |
|   62361 |  5700 | `				pDefend = pIn;` |
|       - |  5701 | `				/* Process the default value associated with this argument */` |
|  131275 |  5702 | `				while( pDefend < pEnd ){` |
|  101727 |  5703 | `					if( (pDefend->nType & PH7_TK_COMMA) && iNest <= 0 ){` |
|   32813 |  5704 | `						break;` |
|       - |  5705 | `					}` |
|   68919 |  5706 | `					if( pDefend->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*[*/) ){` |
|       - |  5707 | `						/* Increment nesting level */` |
|    3285 |  5708 | `						iNest++;` |
|   67279 |  5709 | `					}else if( pDefend->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CCB/*'}'*/\|PH7_TK_CSB/*]*/) ){` |
|       - |  5710 | `						/* Decrement nesting level */` |
|    3285 |  5711 | `						iNest--;` |
|    1640 |  5712 | `					}` |
|   68919 |  5713 | `					pDefend++;` |
|       5 |  5714 | `				}` |
|   62361 |  5715 | `				if( pIn >= pDefend ){` |
|       3 |  5716 | `					rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Missing argument default value");` |
|       3 |  5717 | `					return rc;` |
|       - |  5718 | `				}` |
|       - |  5719 | `				/* Process default value */` |
|   62359 |  5720 | `				rc = GenStateProcessArgValue(&(*pGen),&sArg,pIn,pDefend);` |
|   62359 |  5721 | `				if( rc != SXRET_OK ){` |
|     ! 0 |  5722 | `					return rc;` |
|       - |  5723 | `				}` |
|       - |  5724 | `				/* Point beyond the default value */` |
|   62359 |  5725 | `				pIn = pDefend;` |
|   31177 |  5726 | `			}` |
|   72919 |  5727 | `			if( pIn < pEnd && (pIn->nType & PH7_TK_COMMA) == 0 ){` |
|     ! 0 |  5728 | `				rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Unexpected token '%z'",&pIn->sData);` |
|     ! 0 |  5729 | `				return rc;` |
|       - |  5730 | `			}` |
|   72919 |  5731 | `			pIn++; /* Jump the trailing comma */` |
|   36457 |  5732 | `		}` |
|       - |  5733 | `		/* Append argument signature */` |
|  129809 |  5734 | `		if( sArg.nType > 0 ){` |
|   69065 |  5735 | `			if( SyStringLength(&sArg.sClass) > 0 ){` |
|       - |  5736 | `				/* Class name — prefix with 'o' so generic object hint is a prefix match */` |
|    9867 |  5737 | `				int marker = 'o';` |
|    9867 |  5738 | `				SyBlobAppend(&sSig,(const void *)&marker,sizeof(char));` |
|    9867 |  5739 | `				SyBlobAppend(&sSig,SyStringData(&sArg.sClass),SyStringLength(&sArg.sClass));` |
|    4936 |  5740 | `			}else{` |
|       - |  5741 | `				int c;` |
|   59203 |  5742 | `				c = 'n'; /* cc warning */` |
|       - |  5743 | `				/* Type leading character */` |
|   59203 |  5744 | `				switch(sArg.nType){` |
|     ! 0 |  5745 | `				case MEMOBJ_HASHMAP:` |
|       - |  5746 | `					/* Hashmap aka 'array' */` |
|     ! 0 |  5747 | `					c = 'h';` |
|     ! 0 |  5748 | `					break;` |
|    8245 |  5749 | `				case MEMOBJ_INT:` |
|       - |  5750 | `					/* Integer */` |
|   16495 |  5751 | `					c = 'i';` |
|   16495 |  5752 | `					break;` |
...
|       2 |  5770 | `					break;` |
|       - |  5771 | `				}` |
|   59203 |  5772 | `				SyBlobAppend(&sSig,(const void *)&c,sizeof(char));` |
|       - |  5773 | `			}` |
|   34535 |  5774 | `		}else{` |
|       - |  5775 | `			/* No type is associated with this parameter which mean` |
|       - |  5776 | `			 * that this function is not condidate for overloading.` |
|       - |  5777 | `			 */` |
|   60749 |  5778 | `			SyBlobRelease(&sSig);` |
|       - |  5779 | `		}` |
|       - |  5780 | `		/* Save in the argument set */` |
|  129809 |  5781 | `		SySetPut(&pFunc->aArgs,(const void *)&sArg);` |
|       5 |  5782 | `	}` |
|   86447 |  5783 | `	if( SyBlobLength(&sSig) > 0 ){` |
|       - |  5784 | `		/* Save function signature */` |
|   42793 |  5785 | `		SyStringInitFromBuf(&pFunc->sSignature,SyBlobData(&sSig),SyBlobLength(&sSig));` |
|   21394 |  5786 | `	}` |
|   86447 |  5787 | `	return SXRET_OK;` |
|   43232 |  5788 |  |
|       - |  5789 | `/*` |
...
|       - |  5793 | ` */` |
|  205278 |  5794 | `static sxi32 GenStateCompileFuncBody(` |
...
|  205283 |  5804 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC,PH7_VmInstrLength(pGen->pVm),pFunc,&pBlock);` |
|  205283 |  5805 | `	if( rc != SXRET_OK ){` |
...
|       - |  5809 | `	}` |
|  205283 |  5810 | `	nGotoOfft = SySetUsed(&pGen->aGoto);` |
|       - |  5811 | `	/* Swap bytecode containers */` |
|  205283 |  5812 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|  205283 |  5813 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pFunc->aByteCode);` |
...
|       - |  5818 | `	{` |
|  205283 |  5819 | `		sxu32 nArg = SySetUsed(&pFunc->aArgs);` |
|       - |  5820 | `		sxu32 i;` |
|  308723 |  5821 | `		for( i = 0; i < nArg; i++ ){` |
|  103445 |  5822 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pFunc->aArgs,i);` |
|       - |  5823 | `			char *zSrc;` |
|       - |  5824 | `			sxu32 nSrc,nName;` |
|       - |  5825 | `			SySet sToken;` |
|       - |  5826 | `			SyToken *pTmpIn,*pTmpEnd;` |
|       - |  5827 | `			sxi32 rcPromote;` |
|  103445 |  5828 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|  103397 |  5829 | `				continue;` |
|       - |  5830 | `			}` |
...
|  205283 |  5877 | `	PH7_CompileBlock(&(*pGen),0);` |
|       - |  5878 | `	/* Fix exception jumps now the destination is resolved */` |
|  205283 |  5879 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|       - |  5880 | `	/* Emit the final return if not yet done */` |
|  205283 |  5881 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|       - |  5882 | `	/* Fix gotos jumps now the destination is resolved */` |
|  205283 |  5883 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),nGotoOfft) ){` |
|     ! 0 |  5884 | `		rc = SXERR_ABORT;` |
|     ! 0 |  5885 | `	}` |
|  205283 |  5886 | `	SySetTruncate(&pGen->aGoto,nGotoOfft);` |
|       - |  5887 | `	/* Restore the default container */` |
|  205283 |  5888 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|       - |  5889 | `	/* Leave function block */` |
|  205283 |  5890 | `	GenStateLeaveBlock(&(*pGen),0);` |
|  205283 |  5891 | `	if( rc == SXERR_ABORT ){` |
...
|       - |  5896 | `	{` |
|  205283 |  5897 | `		VmInstr *aInstr = (VmInstr *)SySetBasePtr(&pFunc->aByteCode);` |
|       - |  5898 | `		sxu32 i;` |
| 4009393 |  5899 | `		for( i = 0; i < SySetUsed(&pFunc->aByteCode); i++ ){` |
| 3804151 |  5900 | `			if( aInstr[i].iOp == PH7_OP_YIELD ){` |
...
|       - |  5971 | ` */` |
|   69750 |  5972 | `static sxi32 GenStateParseOneTypeAtom(ph7_gen_state *pGen, PhlTypeAtom *pOut)` |
|       5 |  5973 |  |
|   69755 |  5974 | `	SyToken *pIn = pGen->pIn;` |
|   69755 |  5975 | `	SyZero(pOut, sizeof(*pOut));` |
|   69755 |  5976 | `	SyStringInitFromBuf(&pOut->sClass, 0, 0);` |
|   69755 |  5977 | `	if( pIn >= pGen->pEnd ){` |
|     ! 0 |  5978 | `		return SXERR_SYNTAX;` |
|       - |  5979 | `	}` |
|       - |  5980 | `	/* Optional leading namespace separator '\' on FQN class types */` |
|   69755 |  5981 | `	if( pIn->nType & PH7_TK_NSSEP ){` |
|       8 |  5982 | `		pIn++;` |
|       8 |  5983 | `		if( pIn >= pGen->pEnd ){` |
|     ! 0 |  5984 | `			return SXERR_SYNTAX;` |
|       - |  5985 | `		}` |
|       3 |  5986 | `	}` |
|   69755 |  5987 | `	if( (pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|     ! 0 |  5988 | `		return SXERR_SYNTAX;` |
|       - |  5989 | `	}` |
|   69755 |  5990 | `	if( pIn->nType & PH7_TK_KEYWORD ){` |
|   59667 |  5991 | `		sxu32 nKey = (sxu32)(SX_PTR_TO_INT(pIn->pUserData));` |
|   59667 |  5992 | `		if( nKey & PH7_TKWRD_ARRAY ){` |
|      20 |  5993 | `			pOut->nType = MEMOBJ_HASHMAP; pOut->zCanon = "array"; pOut->nCanon = 5;` |
|   59659 |  5994 | `		}else if( nKey & PH7_TKWRD_BOOL ){` |
|      61 |  5995 | `			pOut->nType = MEMOBJ_BOOL; pOut->zCanon = "bool"; pOut->nCanon = 4;` |
|   59623 |  5996 | `		}else if( nKey & PH7_TKWRD_INT ){` |
|   16717 |  5997 | `			pOut->nType = MEMOBJ_INT; pOut->zCanon = "int"; pOut->nCanon = 3;` |
|   51239 |  5998 | `		}else if( nKey & PH7_TKWRD_STRING ){` |
|   42825 |  5999 | `			pOut->nType = MEMOBJ_STRING; pOut->zCanon = "string"; pOut->nCanon = 6;` |
|   21473 |  6000 | `		}else if( nKey & PH7_TKWRD_FLOAT ){` |
...
|   10093 |  6015 | `		SyString *pT = &pIn->sData;` |
|   10093 |  6016 | `		if( pT->nByte == 4 && SyMemcmpNoCase(pT->zString, "null", 4) == 0 ){` |
|      18 |  6017 | `			pOut->nType = UTA_NULL_FLAG; pOut->zCanon = "null"; pOut->nCanon = 4;` |
|      18 |  6018 | `			pIn++;` |
|   10085 |  6019 | `		}else if( pT->nByte == 4 && SyMemcmpNoCase(pT->zString, "void", 4) == 0 ){` |
|     117 |  6020 | `			pOut->nType = UTA_VOID_FLAG; pOut->zCanon = "void"; pOut->nCanon = 4;` |
|     117 |  6021 | `			pIn++;` |
|   10021 |  6022 | `		}else if( pT->nByte == 5 && SyMemcmpNoCase(pT->zString, "never", 5) == 0 ){` |
|       3 |  6023 | `			pOut->nType = UTA_NEVER_FLAG; pOut->zCanon = "never"; pOut->nCanon = 5;` |
|       3 |  6024 | `			pIn++;` |
|       2 |  6025 | `		}else{` |
|       - |  6026 | `			/* Class / interface name; consume namespace path a\b\c */` |
|    9963 |  6027 | `			SyToken *pFirst = pIn;` |
|    9963 |  6028 | `			SyToken *pLast = pIn;` |
|    9963 |  6029 | `			pOut->nType = SXU32_HIGH;` |
|    9963 |  6030 | `			pOut->sClass = pIn->sData;` |
|    9963 |  6031 | `			pIn++;` |
|   14940 |  6032 | `			while( pIn + 1 < pGen->pEnd && (pIn->nType & PH7_TK_NSSEP)` |
|    9966 |  6033 | `				&& (pIn[1].nType & PH7_TK_ID) ){` |
|       3 |  6034 | `				pLast = &pIn[1];` |
|       3 |  6035 | `				pIn += 2;` |
|       1 |  6036 | `			}` |
|    9963 |  6037 | `			if( pLast != pFirst ){` |
...
|       - |  6043 | `		}` |
|       - |  6044 | `	}` |
|   69753 |  6045 | `	pGen->pIn = pIn;` |
|   69753 |  6046 | `	return SXRET_OK;` |
|   34880 |  6047 |  |
|       - |  6048 |  |
|       - |  6049 | `/*` |
...
|       - |  6055 | ` */` |
|   69646 |  6056 | `static void GenBuildUnionTypeText(SyBlob *pBlob, PhlTypeAtom *aAtoms, int nAtoms, int bNullable)` |
|       5 |  6057 |  |
|       - |  6058 | `	int i;` |
|   69651 |  6059 | `	int nNonNull = 0;` |
|  139385 |  6060 | `	for( i = 0; i < nAtoms; i++ ){` |
|   69739 |  6061 | `		if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|   69723 |  6062 | `			nNonNull++;` |
|   34859 |  6063 | `		}` |
|   34872 |  6064 | `	}` |
|   69651 |  6065 | `	if( nNonNull == 1 && bNullable ){` |
|       - |  6066 | `		/* Shorthand: ?T */` |
...
|     ! 0 |  6077 | `	}` |
|       - |  6078 | `	{` |
|   69589 |  6079 | `		int bFirst = 1;` |
|       - |  6080 | `		/* 1) Classes in declaration order */` |
|  139255 |  6081 | `		for( i = 0; i < nAtoms; i++ ){` |
|   69671 |  6082 | `			if( aAtoms[i].nType == SXU32_HIGH ){` |
|    9955 |  6083 | `				if( !bFirst ) SyBlobAppend(pBlob, "\|", 1);` |
|    9955 |  6084 | `				SyBlobAppend(pBlob, aAtoms[i].sClass.zString, aAtoms[i].sClass.nByte);` |
|    9955 |  6085 | `				bFirst = 0;` |
|    4975 |  6086 | `			}` |
|   34838 |  6087 | `		}` |
...
|       - |  6092 | `			int k;` |
|  487093 |  6093 | `			for( k = 0; k < (int)(sizeof(aOrder)/sizeof(aOrder[0])); k++ ){` |
|  775813 |  6094 | `				for( i = 0; i < nAtoms; i++ ){` |
|  417905 |  6095 | `					if( aAtoms[i].nType == aOrder[k] ){` |
|   59601 |  6096 | `						if( !bFirst ) SyBlobAppend(pBlob, "\|", 1);` |
|   59601 |  6097 | `						SyBlobAppend(pBlob, aAtoms[i].zCanon, aAtoms[i].nCanon);` |
|   59601 |  6098 | `						bFirst = 0;` |
|   59601 |  6099 | `						break;` |
|       - |  6100 | `					}` |
|  179157 |  6101 | `				}` |
...
|       - |  6129 | ` */` |
|   69656 |  6130 | `static sxi32 GenStateParseUnionTypeDecl(` |
...
|   69661 |  6143 | `	int nAtoms = 0;` |
|   69661 |  6144 | `	int bShortNullable = 0;` |
|   69661 |  6145 | `	int bExplicitNull = 0;` |
|       - |  6146 | `	sxi32 rc;` |
|   69661 |  6147 | `	*pnType = 0;` |
|   69661 |  6148 | `	if( pClass ) SyStringInitFromBuf(pClass, 0, 0);` |
|   69661 |  6149 | `	*piTypeFlags = 0;` |
|   69661 |  6150 | `	if( pTypeText ) SyStringInitFromBuf(pTypeText, 0, 0);` |
|       - |  6151 |  |
|   69661 |  6152 | `	if( pGen->pIn >= pGen->pEnd ){` |
|     ! 0 |  6153 | `		return SXRET_OK;` |
|       - |  6154 | `	}` |
|       - |  6155 | ``	/* Optional `?` shorthand prefix */`` |
|   69656 |  6156 | `	if( (pGen->pIn->nType & PH7_TK_OP) && pGen->pIn->sData.nByte == 1` |
...
|   69661 |  6165 | `	rc = GenStateParseOneTypeAtom(pGen, &aAtoms[0]);` |
|   69661 |  6166 | `	if( rc != SXRET_OK ){` |
|       3 |  6167 | `		return rc;` |
|       - |  6168 | `	}` |
|   69659 |  6169 | `	nAtoms = 1;` |
|       - |  6170 | ``	/* Subsequent atoms separated by `\|` */`` |
|  104624 |  6171 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OP)` |
|   69802 |  6172 | `		&& pGen->pIn->sData.nByte == 1 && pGen->pIn->sData.zString[0] == '\|' ){` |
...
|       - |  6199 | `	{` |
|       - |  6200 | `		int i, j;` |
|   69657 |  6201 | `		int bHasNonNull = 0;` |
|  139397 |  6202 | `		for( i = 0; i < nAtoms; i++ ){` |
|   69751 |  6203 | `			if( aAtoms[i].nType == UTA_VOID_FLAG ){` |
...
|       - |  6218 | `				}` |
|      55 |  6219 | `			}` |
|   69749 |  6220 | `			if( aAtoms[i].nType == UTA_NEVER_FLAG ){` |
...
|       - |  6234 | `			}` |
|   69747 |  6235 | `			if( aAtoms[i].nType == UTA_NULL_FLAG ){` |
|      18 |  6236 | `				bExplicitNull = 1;` |
|      10 |  6237 | `			}else{` |
|   69731 |  6238 | `				bHasNonNull = 1;` |
|       - |  6239 | `			}` |
|       - |  6240 | `			/* Duplicate detection */` |
|   69871 |  6241 | `			for( j = 0; j < i; j++ ){` |
|     131 |  6242 | `				int bDup = 0;` |
...
|      67 |  6269 | `			}` |
|   34875 |  6270 | `		}` |
|   69651 |  6271 | `		if( !bHasNonNull && bExplicitNull ){` |
...
|   69651 |  6286 | `	if( bShortNullable \|\| bExplicitNull ){` |
|      76 |  6287 | `		*piTypeFlags \|= iNullableFlag;` |
|      36 |  6288 | `	}` |
|       - |  6289 | `	/* Build canonical type text */` |
|   69651 |  6290 | `	if( pTypeText ){` |
|       - |  6291 | `		SyBlob sBlob;` |
|   69651 |  6292 | `		SyBlobInit(&sBlob, &pGen->pVm->sAllocator);` |
|  104446 |  6293 | `		GenBuildUnionTypeText(&sBlob, aAtoms, nAtoms,` |
|   34823 |  6294 | `			(bShortNullable \|\| bExplicitNull) ? 1 : 0);` |
|   69651 |  6295 | `		if( SyBlobLength(&sBlob) > 0 ){` |
|  104309 |  6296 | `			char *zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|   69536 |  6297 | `				(const char *)SyBlobData(&sBlob), SyBlobLength(&sBlob));` |
|   69541 |  6298 | `			if( zDup ){` |
|   69541 |  6299 | `				SyStringInitFromBuf(pTypeText, zDup, SyBlobLength(&sBlob));` |
|   34768 |  6300 | `			}` |
|   34768 |  6301 | `		}` |
|   69651 |  6302 | `		SyBlobRelease(&sBlob);` |
|   34823 |  6303 | `	}` |
...
|       - |  6307 | `	{` |
|   69651 |  6308 | `		int nNonNull = 0;` |
|   69651 |  6309 | `		int iNonNullIdx = -1;` |
|       - |  6310 | `		int i;` |
|  139385 |  6311 | `		for( i = 0; i < nAtoms; i++ ){` |
|   69739 |  6312 | `			if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|   69723 |  6313 | `				nNonNull++;` |
|   69723 |  6314 | `				iNonNullIdx = i;` |
|   34859 |  6315 | `			}` |
|   34872 |  6316 | `		}` |
|   69651 |  6317 | `		if( nNonNull <= 1 ){` |
|       - |  6318 | `			/* Fast path: store as single type. */` |
|   69589 |  6319 | `			if( iNonNullIdx >= 0 ){` |
|   69583 |  6320 | `				PhlTypeAtom *pA = &aAtoms[iNonNullIdx];` |
|   69583 |  6321 | `				if( pA->nType == SXU32_HIGH ){` |
|   14906 |  6322 | `					char *zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|    4967 |  6323 | `						pA->sClass.zString, pA->sClass.nByte);` |
|    9939 |  6324 | `					if( zDup == 0 ) return SXERR_ABORT;` |
|    9939 |  6325 | `					*pnType = SXU32_HIGH;` |
|    9939 |  6326 | `					if( pClass ) SyStringInitFromBuf(pClass, zDup, pA->sClass.nByte);` |
|   64616 |  6327 | `				}else if( pA->nType == UTA_VOID_FLAG ){` |
...
|       - |  6366 | ` */` |
|  290738 |  6367 | `static sxi32 GenStateParseReturnType(ph7_gen_state *pGen, ph7_vm_func *pFunc)` |
|       5 |  6368 |  |
|  290743 |  6369 | `	sxi32 iFlags = 0;` |
|       - |  6370 | `	sxi32 rc;` |
|       - |  6371 | `	sxu32 nLine;` |
|  290743 |  6372 | `	pFunc->nReturnType = 0;` |
|  290743 |  6373 | `	SyStringInitFromBuf(&pFunc->sReturnClass, 0, 0);` |
|  290743 |  6374 | `	SyStringInitFromBuf(&pFunc->sReturnTypeName, 0, 0);` |
|  290743 |  6375 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COLON) == 0 ){` |
|  290395 |  6376 | `		return SXRET_OK;` |
|       - |  6377 | `	}` |
|     353 |  6378 | `	pGen->pIn++; /* Skip ':' */` |
|     353 |  6379 | `	if( pGen->pIn >= pGen->pEnd ){` |
|     ! 0 |  6380 | `		return SXRET_OK;` |
|       - |  6381 | `	}` |
|     353 |  6382 | `	nLine = pGen->pIn->nLine;` |
|     353 |  6383 | `	rc = GenStateParseUnionTypeDecl(` |
|     174 |  6384 | `		pGen,` |
|     174 |  6385 | `		&pFunc->nReturnType,` |
|     174 |  6386 | `		&pFunc->sReturnClass,` |
|     174 |  6387 | `		&pFunc->aReturnUnion,` |
|       - |  6388 | `		&iFlags,` |
|     174 |  6389 | `		&pFunc->sReturnTypeName,` |
|       - |  6390 | `		/* iNullableFlag */ 0, /* nullability for returns rides on aReturnUnion contents only */` |
|       - |  6391 | `		/* iUnionFlag */ 0,` |
|       - |  6392 | `		/* bAllowVoid */ 1,` |
|     174 |  6393 | `		nLine);` |
|     174 |  6394 | `	(void)iFlags;` |
|     353 |  6395 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  6396 | `		return SXERR_ABORT;` |
|       - |  6397 | `	}` |
|     353 |  6398 | `	if( rc == SXERR_CORRUPT ){` |
|       - |  6399 | `		/* Error already reported */` |
|     ! 0 |  6400 | `		return SXERR_SYNTAX;` |
|       - |  6401 | `	}` |
|     353 |  6402 | `	if( rc == SXERR_SYNTAX ){` |
...
|       - |  6412 | `	}` |
|     349 |  6413 | `	return SXRET_OK;` |
|  145374 |  6414 |  |
|       - |  6415 |  |
|   43718 |  6416 | `static sxi32 GenStateCompileFunc(` |
...
|   43723 |  6430 | `	nLine = pGen->pIn->nLine;` |
|       - |  6431 | `	/* Jump the left parenthesis '(' */` |
|   43723 |  6432 | `	pGen->pIn++;` |
|       - |  6433 | `	/* Delimit the function signature */` |
|   43723 |  6434 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   43723 |  6435 | `	if( pEnd >= pGen->pEnd ){` |
|       - |  6436 | `		/* Syntax error */` |
|       8 |  6437 | `		rc = PH7_GenCompileError(pGen,E_ERROR,nLine,"Missing ')' after function '%z' signature",pName);` |
|       8 |  6438 | `		if( rc == SXERR_ABORT ){` |
|       - |  6439 | `			/* Error count limit reached,abort immediately */` |
|     ! 0 |  6440 | `			return SXERR_ABORT;` |
|       - |  6441 | `		}` |
|       8 |  6442 | `		pGen->pIn = pGen->pEnd;` |
|       8 |  6443 | `		return SXRET_OK;` |
|       - |  6444 | `	}` |
|       - |  6445 | `	/* Create the function state */` |
|   43717 |  6446 | `	pFunc = (ph7_vm_func *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_vm_func));` |
|   43717 |  6447 | `	if( pFunc == 0 ){` |
|     ! 0 |  6448 | `		goto OutOfMem;` |
|       - |  6449 | `	}` |
|       - |  6450 | `	/* Build the function name, prepending namespace if active */` |
|   43724 |  6451 | `	if( SyBlobLength(&pGen->sNamespace) > 0 && !bHandleClosure ){` |
|       - |  6452 | `		SyBlob sFQN;` |
|       - |  6453 | `		sxu32 nLen;` |
...
|       9 |  6465 | `	}else{` |
|   43703 |  6466 | `		zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|   43703 |  6467 | `		if( zName == 0 ){` |
|     ! 0 |  6468 | `			goto OutOfMem;` |
|       - |  6469 | `		}` |
|   43703 |  6470 | `		PH7_VmInitFuncState(pGen->pVm,pFunc,zName,pName->nByte,iFlags,0);` |
|       - |  6471 | `	}` |
|   43717 |  6472 | `	if( pGen->pIn < pEnd ){` |
|       - |  6473 | `		/* Collect function arguments */` |
|   30259 |  6474 | `		rc = GenStateCollectFuncArgs(pFunc,&(*pGen),pEnd,0,0);` |
|   30259 |  6475 | `		if( rc == SXERR_ABORT ){` |
...
|   43717 |  6481 | `	pGen->pIn = &pEnd[1];` |
|       - |  6482 | `	{` |
|   43717 |  6483 | `		sxi32 rcRt = GenStateParseReturnType(pGen, pFunc);` |
|   43717 |  6484 | `		if( rcRt == SXERR_ABORT ){` |
|     ! 0 |  6485 | `			return SXERR_ABORT;` |
|   43717 |  6486 | `		}else if( rcRt == SXERR_SYNTAX ){` |
|       5 |  6487 | `			return SXERR_SYNTAX;` |
|       - |  6488 | `		}` |
|       - |  6489 | `	}` |
|   43713 |  6490 | `	if( bHandleClosure ){` |
|       - |  6491 | `		ph7_vm_func_closure_env sEnv;` |
|     251 |  6492 | `		int got_this = 0; /* TRUE if $this have been seen */` |
|     246 |  6493 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD)` |
|     136 |  6494 | `			&& SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_USE ){` |
...
|   43713 |  6583 | `	rc = GenStateCompileFuncBody(&(*pGen),pFunc);` |
|   43713 |  6584 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  6585 | `		return SXERR_ABORT;` |
|       - |  6586 | `	}` |
|   43713 |  6587 | `	if( ppFunc ){` |
|     251 |  6588 | `		*ppFunc = pFunc;` |
|     123 |  6589 | `	}` |
|   43713 |  6590 | `	rc = SXRET_OK;` |
|   43713 |  6591 | `	if( (pFunc->iFlags & VM_FUNC_CLOSURE) == 0 ){` |
|       - |  6592 | `		/* Finally register the function */` |
|   43697 |  6593 | `		rc = PH7_VmInstallUserFunction(pGen->pVm,pFunc,0);` |
|   21846 |  6594 | `	}` |
|   43713 |  6595 | `	if( rc == SXRET_OK ){` |
|   43713 |  6596 | `		return SXRET_OK;` |
|       - |  6597 | `	}` |
...
|       - |  6609 | ` */` |
|   43480 |  6610 | `static sxi32 PH7_CompileFunction(ph7_gen_state *pGen)` |
|       5 |  6611 |  |
|       - |  6612 | `	SyString *pName;` |
|       - |  6613 | `	sxi32 iFlags;` |
|       - |  6614 | `	sxu32 nLine;` |
|       - |  6615 | `	sxi32 rc;` |
|       - |  6616 |  |
|   43485 |  6617 | `	nLine = pGen->pIn->nLine;` |
|   43485 |  6618 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|   43485 |  6619 | `	iFlags = 0;` |
|   43485 |  6620 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|       - |  6621 | `		/* Return by reference,remember that */` |
|       7 |  6622 | `		iFlags \|= VM_FUNC_REF_RETURN;` |
|       - |  6623 | `		/* Jump the '&' token */` |
|       7 |  6624 | `		pGen->pIn++;` |
|       3 |  6625 | `	}` |
|   43485 |  6626 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|       - |  6627 | `		/* Invalid function name */` |
|       7 |  6628 | `		rc = PH7_GenCompileError(&(*pGen),E_ERROR,nLine,"Invalid function name");` |
|       7 |  6629 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  6630 | `			return SXERR_ABORT;` |
|       - |  6631 | `		}` |
|       - |  6632 | `		/* Sychronize with the next semi-colon or braces*/` |
|      21 |  6633 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & (PH7_TK_SEMI\|PH7_TK_OCB)) == 0 ){` |
|      15 |  6634 | `			pGen->pIn++;` |
|       1 |  6635 | `		}` |
|       7 |  6636 | `		return SXRET_OK;` |
|       - |  6637 | `	}` |
|   43479 |  6638 | `	pName = &pGen->pIn->sData;` |
|   43479 |  6639 | `	nLine = pGen->pIn->nLine;` |
|       - |  6640 | `	/* Jump the function name */` |
|   43479 |  6641 | `	pGen->pIn++;` |
|   43479 |  6642 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  6643 | `		/* Syntax error */` |
...
|   43477 |  6656 | `	rc = GenStateCompileFunc(&(*pGen),pName,iFlags,FALSE,0);` |
|   43477 |  6657 | `	return rc;` |
|   21745 |  6658 |  |
|       - |  6659 | `/*` |
...
|       - |  6669 | ` */` |
|  309860 |  6670 | `static sxi32 GetProtectionLevel(sxi32 nKeyword)` |
|       5 |  6671 |  |
|  309865 |  6672 | `	if( nKeyword == PH7_TKWRD_PRIVATE ){` |
|    9929 |  6673 | `		return PH7_CLASS_PROT_PRIVATE;` |
|  299941 |  6674 | `	}else if( nKeyword == PH7_TKWRD_PROTECTED ){` |
|   42689 |  6675 | `		return PH7_CLASS_PROT_PROTECTED;` |
|       - |  6676 | `	}` |
|       - |  6677 | `	/* Assume public by default */` |
|  257257 |  6678 | `	return PH7_CLASS_PROT_PUBLIC;` |
|  154935 |  6679 |  |
|       - |  6680 | `/*` |
...
|       - |  6942 | ` */` |
|  161722 |  6943 | `static int GenStateLooksLikeTypedProperty(SyToken *pStart,SyToken *pEnd)` |
|       5 |  6944 |  |
|  161727 |  6945 | `	SyToken *p = pStart;` |
|  161727 |  6946 | `	if( p >= pEnd ) return 0;` |
|  161727 |  6947 | `	if( (p->nType & PH7_TK_OP) && p->sData.nByte == 1 && p->sData.zString[0] == '?' ){` |
|      18 |  6948 | `		p++;` |
|      18 |  6949 | `		if( p >= pEnd ) return 0;` |
|       8 |  6950 | `	}` |
|  161727 |  6951 | `	if( p->nType & PH7_TK_NSSEP ){` |
|       3 |  6952 | `		p++;` |
|       3 |  6953 | `		if( p >= pEnd ) return 0;` |
|       1 |  6954 | `	}` |
|  161727 |  6955 | `	if( (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|     ! 0 |  6956 | `		return 0;` |
|       - |  6957 | `	}` |
...
|       - |  6961 | `	 * dispatch site. */` |
|  161727 |  6962 | `	if( p->nType & PH7_TK_KEYWORD ){` |
|  161705 |  6963 | `		sxu32 k = (sxu32)(SX_PTR_TO_INT(p->pUserData));` |
|  161700 |  6964 | `		if( k == PH7_TKWRD_FUNCTION \|\| k == PH7_TKWRD_VAR \|\| k == PH7_TKWRD_CONST` |
|    3490 |  6965 | `		 \|\| k == PH7_TKWRD_STATIC \|\| k == PH7_TKWRD_FINAL \|\| k == PH7_TKWRD_ABSTRACT ){` |
|  161557 |  6966 | `			return 0;` |
|       - |  6967 | `		}` |
|      74 |  6968 | `	}` |
|     175 |  6969 | `	p++;` |
...
|       - |  7139 | ` */` |
| 1462710 |  7140 | `static int GenStateIsReadonly(SyToken *pTok)` |
|       5 |  7141 |  |
| 1492096 |  7142 | `	return (pTok->nType & PH7_TK_ID)` |
|  760736 |  7143 | `		&& pTok->sData.nByte == sizeof("readonly")-1` |
| 1492091 |  7144 | `		&& SyStrnicmp(pTok->sData.zString,"readonly",sizeof("readonly")-1) == 0;` |
|       5 |  7145 |  |
|   62870 |  7146 | `static sxi32 GenStateCompileClassAttr(ph7_gen_state *pGen,sxi32 iProtection,sxi32 iFlags,ph7_class *pClass)` |
|       5 |  7147 |  |
|   62875 |  7148 | `	sxu32 nLine = pGen->pIn->nLine;` |
|       - |  7149 | `	ph7_class_attr *pAttr;` |
|       - |  7150 | `	SyString *pName;` |
|       - |  7151 | `	sxi32 rc;` |
|   62875 |  7152 | `	sxu32 nType = 0;` |
|       - |  7153 | `	SyString sTypeClass;` |
|       - |  7154 | `	SyString sTypeText;` |
|       - |  7155 | `	SySet aUnionAlts;` |
|   62875 |  7156 | `	sxi32 iTypeFlags = 0;` |
|   62875 |  7157 | `	SyStringInitFromBuf(&sTypeClass,0,0);` |
|   62875 |  7158 | `	SyStringInitFromBuf(&sTypeText,0,0);` |
|   62875 |  7159 | `	SySetInit(&aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
...
|   62875 |  7163 | `	if( pClass->iFlags & PH7_CLASS_READONLY ){` |
|      21 |  7164 | `		iFlags \|= PH7_CLASS_ATTR_READONLY;` |
|       9 |  7165 | `	}` |
|       - |  7166 | `	/* Extract visibility level */` |
|   62875 |  7167 | `	iProtection = GetProtectionLevel(iProtection);` |
|       - |  7168 | `	/* Parse optional type hint (typed properties, PHP 7.4+) */` |
|   62960 |  7169 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
...
|      85 |  7185 | `	}` |
|     ! 0 |  7186 | `loop:` |
|   62879 |  7187 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
...
|       - |  7193 | `	}` |
|   62879 |  7194 | `	pGen->pIn++; /* Jump the dollar sign */` |
|   62879 |  7195 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_ID)) == 0 ){` |
...
|   62879 |  7205 | `	pName = &pGen->pIn->sData;` |
|       - |  7206 | `	/* Advance the stream cursor */` |
|   62879 |  7207 | `	pGen->pIn++;` |
|   62879 |  7208 | `	if(pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_EQUAL/*'='*/\|PH7_TK_SEMI/*';'*/\|PH7_TK_COMMA/*','*/)) == 0 ){` |
...
|   62877 |  7219 | `	if( iFlags & PH7_CLASS_ATTR_READONLY ){` |
...
|   62867 |  7239 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
...
|   62867 |  7251 | `	if( PH7_ClassExtractAttribute(pClass,pName->zString,pName->nByte) != 0 ){` |
...
|   62865 |  7260 | `	pAttr = PH7_NewClassAttr(pGen->pVm,pName,nLine,iProtection,iFlags\|iTypeFlags);` |
|   62865 |  7261 | `	if( pAttr == 0 ){` |
|     ! 0 |  7262 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 engine is running out of memory");` |
|     ! 0 |  7263 | `		return SXERR_ABORT;` |
|       - |  7264 | `	}` |
|   62865 |  7265 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|     171 |  7266 | `		GenStateCopyTypeToAttr(pAttr,nType,&sTypeClass,&sTypeText,iTypeFlags,&aUnionAlts);` |
|      83 |  7267 | `	}` |
|   62865 |  7268 | `	if( pGen->pIn->nType & PH7_TK_EQUAL /*'='*/ ){` |
|       - |  7269 | `		SySet *pInstrContainer;` |
|   20081 |  7270 | `		pGen->pIn++; /*Jump the equal sign */` |
|       - |  7271 | `		/* Swap bytecode container */` |
|   20081 |  7272 | `		pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   20081 |  7273 | `		PH7_VmSetByteCodeContainer(pGen->pVm,&pAttr->aByteCode);` |
|       - |  7274 | `		/* Compile attribute value.` |
|       - |  7275 | `		 */` |
|   20081 |  7276 | `		rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|   20081 |  7277 | `		if( rc == SXERR_EMPTY ){` |
...
|   20081 |  7284 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|   20081 |  7285 | `		PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|   10038 |  7286 | `	}` |
|       - |  7287 | `	/* All done,install the attribute */` |
|   62865 |  7288 | `	rc = PH7_ClassInstallAttr(pClass,pAttr);` |
|   62865 |  7289 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  7290 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|     ! 0 |  7291 | `		return SXERR_ABORT;` |
|       - |  7292 | `	}` |
|   62865 |  7293 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA /*','*/) ){` |
...
|       - |  7311 | `		}` |
|     ! 0 |  7312 | `	}` |
|   62861 |  7313 | `	SySetRelease(&aUnionAlts);` |
|   62861 |  7314 | `	return SXRET_OK;` |
|       7 |  7315 | `Synchronize:` |
...
|       - |  7330 | ` */` |
|  246914 |  7331 | `static sxi32 GenStateCompileClassMethod(` |
...
|       - |  7337 | `	)` |
|       5 |  7338 |  |
|  246919 |  7339 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|  246919 |  7346 | `	iProtection = GetProtectionLevel(iProtection);` |
|  246919 |  7347 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|  246919 |  7348 | `	iFuncFlags = 0;` |
|  246919 |  7349 | `	if( pGen->pIn >= pGen->pEnd ){` |
...
|       - |  7357 | `	}` |
|  246919 |  7358 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|       - |  7359 | `		/* Return by reference,remember that */` |
|     ! 0 |  7360 | `		iFuncFlags \|= VM_FUNC_REF_RETURN;` |
|       - |  7361 | `		/* Jump the '&' token */` |
|     ! 0 |  7362 | `		pGen->pIn++;` |
|     ! 0 |  7363 | `	}` |
|  246919 |  7364 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|  246919 |  7373 | `	pName = &pGen->pIn->sData;` |
|  246919 |  7374 | `	nLine = pGen->pIn->nLine;` |
|       - |  7375 | `	/* Jump the method name */` |
|  246919 |  7376 | `	pGen->pIn++;` |
|  246919 |  7377 | `	if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|       - |  7378 | `		/* Abstract method */` |
|   85337 |  7379 | `		if( iProtection == PH7_CLASS_PROT_PRIVATE ){` |
...
|   85337 |  7388 | `		doBody = FALSE;` |
|   42666 |  7389 | `	}` |
|  246919 |  7390 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  7391 | `		/* Syntax error */` |
...
|  246919 |  7400 | `	pMeth = PH7_NewClassMethod(pGen->pVm,pClass,pName,nLine,iProtection,iFlags,iFuncFlags);` |
|  246919 |  7401 | `	if( pMeth == 0 ){` |
...
|  246919 |  7406 | `	pGen->pIn++;` |
|  246919 |  7407 | `	pEnd = 0; /* cc warning */` |
|       - |  7408 | `	/* Delimit the method signature */` |
|  246919 |  7409 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|  246919 |  7410 | `	if( pEnd >= pGen->pEnd ){` |
|       - |  7411 | `		/* Syntax error */` |
...
|       - |  7418 | `	}` |
|       - |  7419 | `	{` |
|  246917 |  7420 | `		int bIsCtor = 0;` |
|  246917 |  7421 | `		int bAbstractCtor = 0;` |
|  246912 |  7422 | `		if( (pName->nByte == sizeof("__construct") - 1` |
|  146519 |  7423 | `				&& SyMemcmp(pName->zString,"__construct",sizeof("__construct") - 1) == 0)` |
|  237008 |  7424 | `		 \|\| SyStringCmp(pName,&pClass->sName,SyMemcmp) == 0 ){` |
|   19823 |  7425 | `			if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|       3 |  7426 | `				bAbstractCtor = 1;` |
|       2 |  7427 | `			}else{` |
|   19821 |  7428 | `				bIsCtor = 1;` |
|       - |  7429 | `			}` |
|    9909 |  7430 | `		}` |
|  246917 |  7431 | `		if( pGen->pIn < pEnd ){` |
|       - |  7432 | `			/* Collect method arguments */` |
|   56121 |  7433 | `			rc = GenStateCollectFuncArgs(&pMeth->sFunc,&(*pGen),pEnd,bIsCtor,bAbstractCtor);` |
|   56121 |  7434 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  7435 | `				return SXERR_ABORT;` |
|       - |  7436 | `			}` |
|   28058 |  7437 | `		}` |
|       - |  7438 | `	}` |
|       - |  7439 | `	/* Point past ')' and parse optional return type ': type' */` |
|  246917 |  7440 | `	pGen->pIn = &pEnd[1];` |
|       - |  7441 | `	{` |
|  246917 |  7442 | `		sxi32 rcRt = GenStateParseReturnType(pGen, &pMeth->sFunc);` |
|  246917 |  7443 | `		if( rcRt == SXERR_ABORT ){` |
|     ! 0 |  7444 | `			return SXERR_ABORT;` |
|  246917 |  7445 | `		}else if( rcRt == SXERR_SYNTAX ){` |
...
|       - |  7452 | `	{` |
|  246917 |  7453 | `		sxu32 nArg = SySetUsed(&pMeth->sFunc.aArgs);` |
|       - |  7454 | `		sxu32 i;` |
|  335931 |  7455 | `		for( i = 0; i < nArg; i++ ){` |
|   89029 |  7456 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pMeth->sFunc.aArgs,i);` |
|       - |  7457 | `			ph7_class_attr *pAttr;` |
|   89029 |  7458 | `			sxi32 iAttrFlags = 0;` |
|   89029 |  7459 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|   88971 |  7460 | `				continue;` |
|       - |  7461 | `			}` |
...
|      29 |  7538 | `		}` |
|       - |  7539 | `	}` |
|  246907 |  7540 | `	if( doBody ){` |
|       - |  7541 | `		/* Compile method body */` |
|  161575 |  7542 | `		rc = GenStateCompileFuncBody(&(*pGen),&pMeth->sFunc);` |
|  161575 |  7543 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  7544 | `			return SXERR_ABORT;` |
|       - |  7545 | `		}` |
|   80790 |  7546 | `	}else{` |
|       - |  7547 | `		/* Only method signature is allowed */` |
|   85337 |  7548 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI /* ';'*/) == 0 ){` |
...
|       - |  7581 | ` */` |
|   36128 |  7582 | `static sxi32 PH7_CompileClassInterface(ph7_gen_state *pGen)` |
|       5 |  7583 |  |
|   36133 |  7584 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|   36133 |  7593 | `	pName = &pGen->pIn->sData;` |
|       - |  7594 | `	/* Advance the stream cursor */` |
|   36133 |  7595 | `	pGen->pIn++;` |
|       - |  7596 | `	/* Build FQN and obtain a raw class */ {` |
|       - |  7597 | `		SyBlob sFQN;` |
|       - |  7598 | `		SyString sFQNStr;` |
|   36133 |  7599 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|   36133 |  7600 | `		GenStateBuildFQN(pGen,pName,&sFQN);` |
|   36133 |  7601 | `		SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|   36133 |  7602 | `		pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|   36133 |  7603 | `		SyBlobRelease(&sFQN);` |
|       - |  7604 | `	}` |
|   36133 |  7605 | `	if( pClass == 0 ){` |
...
|   36133 |  7610 | `	pClass->iFlags = PH7_CLASS_INTERFACE;` |
|       - |  7611 | `	/* Assume no base class is given */` |
|   36133 |  7612 | `	pBase = 0;` |
|   36133 |  7613 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|    9853 |  7614 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    9853 |  7615 | `		if( nKwrd == PH7_TKWRD_EXTENDS /* interface b extends a */ ){` |
|       - |  7616 | `			SyBlob sResolved;` |
|       - |  7617 | `			SyString sBaseName;` |
|       - |  7618 | `			sxu32 nRefLine;` |
|       - |  7619 | `			/* Extract base interface */` |
|    9853 |  7620 | `			pGen->pIn++;` |
|    9853 |  7621 | `			nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|    9853 |  7622 | `			SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|    9853 |  7623 | `			if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|       - |  7633 | `			}` |
|   14777 |  7634 | `			pBase = PH7_VmExtractClass(pGen->pVm,` |
|    9848 |  7635 | `				(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|    9853 |  7636 | `			SyStringInitFromBuf(&sBaseName,` |
|       - |  7637 | `				(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|       - |  7638 | `			/* Only interfaces is allowed */` |
|    9853 |  7639 | `			while( pBase && (pBase->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|     ! 0 |  7640 | `				pBase = pBase->pNextName;` |
|     ! 0 |  7641 | `			}` |
|    9853 |  7642 | `			if( pBase == 0 ){` |
...
|       - |  7648 | `				}` |
|     ! 0 |  7649 | `			}` |
|    9853 |  7650 | `			SyBlobRelease(&sResolved);` |
|    4924 |  7651 | `		}` |
|    4924 |  7652 | `	}` |
|   36133 |  7653 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|       - |  7654 | `		/* Syntax error */` |
...
|       - |  7662 | `	}` |
|   36133 |  7663 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|   36133 |  7664 | `	pEnd = 0; /* cc warning */` |
|       - |  7665 | `	/* Delimit the interface body */` |
|   36133 |  7666 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|   36133 |  7667 | `	if( pEnd >= pGen->pEnd ){` |
|       - |  7668 | `		/* Syntax error */` |
...
|   36133 |  7678 | `	pTmp = pGen->pEnd;` |
|   36133 |  7679 | `	pGen->pEnd = pEnd;` |
...
|  206781 |  7687 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|   85329 |  7688 | `			pGen->pIn++;` |
|       5 |  7689 | `		}` |
|  121457 |  7690 | `		if( pGen->pIn >= pGen->pEnd ){` |
|       - |  7691 | `			/* End of interface body */` |
|   36131 |  7692 | `			break;` |
|       - |  7693 | `		}` |
|   85331 |  7694 | `		if( (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|   85331 |  7705 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   85331 |  7706 | `		if( nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
...
|       3 |  7735 | `			goto done;` |
|       - |  7736 | `		}` |
|   85329 |  7737 | `		if( nKwrd != PH7_TKWRD_PUBLIC && nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|     ! 0 |  7744 | `			goto done;` |
|       - |  7745 | `		}` |
|   85329 |  7746 | `		if( nKwrd == PH7_TKWRD_PUBLIC ){` |
|       - |  7747 | `			/* Advance the stream cursor */` |
|   85321 |  7748 | `			pGen->pIn++;` |
|   85321 |  7749 | `			if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|     ! 0 |  7756 | `				goto done;` |
|       - |  7757 | `			}` |
|   85321 |  7758 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   85321 |  7759 | `			if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|       - |  7767 | `			}` |
|   42658 |  7768 | `		}` |
|   85329 |  7769 | `		if( nKwrd == PH7_TKWRD_CONST ){` |
|       - |  7770 | `			/* Parse constant */` |
...
|       - |  7777 | `			}` |
|       4 |  7778 | `		}else{` |
|   85323 |  7779 | `			sxi32 iFlags = PH7_CLASS_ATTR_ABSTRACT; /* Interface methods are implicitly abstract */` |
|   85323 |  7780 | `			if( nKwrd == PH7_TKWRD_STATIC ){` |
|       - |  7781 | `				/* Static method,record that */` |
|    9845 |  7782 | `				iFlags \|= PH7_CLASS_ATTR_STATIC;` |
|       - |  7783 | `				/* Advance the stream cursor */` |
|    9845 |  7784 | `				pGen->pIn++;` |
|    9840 |  7785 | `				if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0` |
|    9845 |  7786 | `					\|\| SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_FUNCTION ){` |
...
|   85323 |  7797 | `			rc = GenStateCompileClassMethod(&(*pGen),0,iFlags,FALSE,pClass);` |
|   85323 |  7798 | `			if( rc != SXRET_OK ){` |
...
|   36131 |  7807 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|   36131 |  7808 | `	if( rc == SXRET_OK && pBase ){` |
|       - |  7809 | `		/* Inherit from the base interface */` |
|    9853 |  7810 | `		rc = PH7_ClassInterfaceInherit(pClass,pBase);` |
|    4924 |  7811 | `	}` |
|   36131 |  7812 | `	if( rc != SXRET_OK ){` |
...
|   36133 |  7818 | `	pGen->pIn  = &pEnd[1];` |
|   36133 |  7819 | `	pGen->pEnd = pTmp;` |
|   36133 |  7820 | `	return PH7_OK;` |
|   18069 |  7821 |  |
|       - |  7822 | `/*` |
...
|       - |  7846 | ` */` |
|   89566 |  7847 | `static sxi32 GenStateCheckInterfaceSignatures(ph7_gen_state *pGen,ph7_class *pClass)` |
|       5 |  7848 |  |
|       - |  7849 | `	ph7_class **apIface;` |
|       - |  7850 | `	sxu32 nIface,i;` |
|       - |  7851 | `	sxi32 rc;` |
|   89571 |  7852 | `	if( pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|     ! 0 |  7853 | `		return SXRET_OK;` |
|       - |  7854 | `	}` |
|   89571 |  7855 | `	apIface = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|   89571 |  7856 | `	nIface = SySetUsed(&pClass->aInterface);` |
|  178327 |  7857 | `	for(i = 0; i < nIface; i++){` |
|   88761 |  7858 | `		ph7_class *pIface = apIface[i];` |
|       - |  7859 | `		SyHashEntry *pEntry;` |
|   88761 |  7860 | `		SyHashResetLoopCursor(&pIface->hMethod);` |
|  236763 |  7861 | `		while((pEntry = SyHashGetNextEntry(&pIface->hMethod)) != 0 ){` |
|  148007 |  7862 | `			ph7_class_method *pIfaceMeth = (ph7_class_method *)pEntry->pUserData;` |
|       - |  7863 | `			ph7_class_method *pImplMeth;` |
|  148007 |  7864 | `			SyString *pMName = &pIfaceMeth->sFunc.sName;` |
|       - |  7865 | `			/* Find the implementing method in the class */` |
|  148007 |  7866 | `			pImplMeth = PH7_ClassExtractMethod(pClass,pMName->zString,pMName->nByte);` |
|  148007 |  7867 | `			if( pImplMeth == 0 \|\| (pImplMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT) ){` |
...
|  147993 |  7871 | `			if( pImplMeth->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|       - |  7881 | `			 */` |
|       - |  7882 | `			{` |
|  147993 |  7883 | `				sxu32 nIfaceArgs = SySetUsed(&pIfaceMeth->sFunc.aArgs);` |
|  147993 |  7884 | `				sxu32 nImplArgs = SySetUsed(&pImplMeth->sFunc.aArgs);` |
|  147993 |  7885 | `				int sigError = 0;` |
|  147993 |  7886 | `				if( nImplArgs < nIfaceArgs ){` |
|       3 |  7887 | `					sigError = 1;` |
|  147992 |  7888 | `				}else if( nImplArgs > nIfaceArgs ){` |
...
|       - |  7939 | ` */` |
|   89566 |  7940 | `static sxi32 GenStateCheckAbstractMethods(ph7_gen_state *pGen,ph7_class *pClass)` |
|       5 |  7941 |  |
...
|   89571 |  7948 | `	if( pClass->iFlags & (PH7_CLASS_ABSTRACT\|PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|      29 |  7949 | `		return SXRET_OK;` |
|       - |  7950 | `	}` |
|       - |  7951 | `	/* Count abstract methods */` |
|   89547 |  7952 | `	nAbstract = 0;` |
|   89547 |  7953 | `	SyHashResetLoopCursor(&pClass->hMethod);` |
|  868335 |  7954 | `	while((pEntry = SyHashGetNextEntry(&pClass->hMethod)) != 0 ){` |
|  778793 |  7955 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|  778793 |  7956 | `		if( pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|      20 |  7957 | `			nAbstract++;` |
|       8 |  7958 | `		}` |
|       5 |  7959 | `	}` |
|   89547 |  7960 | `	if( nAbstract == 0 ){` |
|   89533 |  7961 | `		return SXRET_OK;` |
|       - |  7962 | `	}` |
...
|       - |  8095 | ` */` |
|   89286 |  8096 | `static sxi32 GenStateParseClassReference(ph7_gen_state *pGen,SyBlob *pFqn)` |
|       5 |  8097 |  |
|   89291 |  8098 | `	int isAbsolute = 0;` |
|   89291 |  8099 | `	SyToken *pStart = pGen->pIn;` |
|       - |  8100 | `	SyBlob sName;` |
|   89291 |  8101 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) ){` |
|      43 |  8102 | `		isAbsolute = 1;` |
|      43 |  8103 | `		pGen->pIn++;` |
|      20 |  8104 | `	}` |
|   89291 |  8105 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|       9 |  8106 | `		pGen->pIn = pStart;` |
|       9 |  8107 | `		return SXERR_INVALID;` |
|       - |  8108 | `	}` |
|   89285 |  8109 | `	SyBlobInit(&sName,&pGen->pVm->sAllocator);` |
|   89285 |  8110 | `	SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|   89285 |  8111 | `	pGen->pIn++;` |
|  133938 |  8112 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) &&` |
|   44663 |  8113 | `		&pGen->pIn[1] < pGen->pEnd && (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|      13 |  8114 | `		SyBlobAppend(&sName,"\\",1);` |
|      13 |  8115 | `		pGen->pIn++;` |
|      13 |  8116 | `		SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|      13 |  8117 | `		pGen->pIn++;` |
|       1 |  8118 | `	}` |
|   89285 |  8119 | `	if( isAbsolute ){` |
|      41 |  8120 | `		SyBlobAppend(pFqn,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|      22 |  8121 | `	}else{` |
|       - |  8122 | `		SyString sRaw;` |
|   89247 |  8123 | `		SyStringInitFromBuf(&sRaw,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|   89247 |  8124 | `		GenStateResolveName(pGen,&sRaw,pFqn);` |
|       - |  8125 | `	}` |
|   89285 |  8126 | `	SyBlobRelease(&sName);` |
|   89285 |  8127 | `	return SXRET_OK;` |
|   44648 |  8128 |  |
|       - |  8129 | `/*` |
...
|    9962 |  8137 | `static int GenStateInterfaceIsThrowableAt(ph7_class *pInterface,int iDepth)` |
|       5 |  8138 |  |
|       - |  8139 | `	ph7_class **apParent;` |
|       - |  8140 | `	sxu32 n;` |
|   16671 |  8141 | `	while( pInterface ){` |
|   13279 |  8142 | `		if( iDepth > PH7_THROWABLE_WALK_MAX_DEPTH ){` |
|     ! 0 |  8143 | `			return FALSE;` |
|       - |  8144 | `		}` |
|   16571 |  8145 | `		if( pInterface->sName.nByte == sizeof("Throwable")-1 &&` |
|    6584 |  8146 | `			SyMemcmp(pInterface->sName.zString,"Throwable",sizeof("Throwable")-1) == 0 ){` |
|    6575 |  8147 | `			return TRUE;` |
|       - |  8148 | `		}` |
|    6709 |  8149 | `		apParent = (ph7_class **)SySetBasePtr(&pInterface->aInterface);` |
|    6709 |  8150 | `		for( n = 0 ; n < SySetUsed(&pInterface->aInterface) ; ++n ){` |
|     ! 0 |  8151 | `			if( GenStateInterfaceIsThrowableAt(apParent[n],iDepth+1) ){` |
|     ! 0 |  8152 | `				return TRUE;` |
|       - |  8153 | `			}` |
|     ! 0 |  8154 | `		}` |
|    6709 |  8155 | `		pInterface = pInterface->pBase;` |
|    6709 |  8156 | `		iDepth++;` |
|       5 |  8157 | `	}` |
|    3397 |  8158 | `	return FALSE;` |
|    4986 |  8159 |  |
|    9962 |  8160 | `static int GenStateInterfaceIsThrowable(ph7_class *pInterface)` |
|       5 |  8161 |  |
|    9967 |  8162 | `	return GenStateInterfaceIsThrowableAt(pInterface,0);` |
|       5 |  8163 |  |
|       - |  8164 | `/*` |
...
|       - |  8168 | ` */` |
|    6570 |  8169 | `static int GenStateClassIsExceptionOrError(ph7_class *pBase)` |
|       5 |  8170 |  |
|    6579 |  8171 | `	while( pBase ){` |
...
|       1 |  8181 | `	}` |
|    6571 |  8182 | `	return FALSE;` |
|    3290 |  8183 |  |
|   89596 |  8184 | `static sxi32 GenStateCompileClass(ph7_gen_state *pGen,sxi32 iFlags)` |
|       5 |  8185 |  |
|   89601 |  8186 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|   89601 |  8197 | `	pGen->pIn++;` |
|   89601 |  8198 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
|       - |  8199 | `		/* Syntax error */` |
...
|   89601 |  8212 | `	pName = &pGen->pIn->sData;` |
|       - |  8213 | `	/* Advance the stream cursor */` |
|   89601 |  8214 | `	pGen->pIn++;` |
|       - |  8215 | `	/* Build FQN and obtain a raw class */ {` |
|       - |  8216 | `		SyBlob sFQN;` |
|       - |  8217 | `		SyString sFQNStr;` |
|   89601 |  8218 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|   89601 |  8219 | `		GenStateBuildFQN(pGen,pName,&sFQN);` |
|   89601 |  8220 | `		SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|   89601 |  8221 | `		pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|   89601 |  8222 | `		SyBlobRelease(&sFQN);` |
|       - |  8223 | `	}` |
|   89601 |  8224 | `	if( pClass == 0 ){` |
...
|   89601 |  8229 | `	SySetInit(&aInterfaces,&pGen->pVm->sAllocator,sizeof(ph7_class *));` |
|   89601 |  8230 | `	SySetInit(&aUseEntries,&pGen->pVm->sAllocator,sizeof(TraitUseEntry));` |
|       - |  8231 | `	/* Assume a standalone class */` |
|   89601 |  8232 | `	pBase = 0;` |
|   89601 |  8233 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|   78993 |  8234 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   78993 |  8235 | `		if( nKwrd == PH7_TKWRD_EXTENDS /* class b extends a */ ){` |
|       - |  8236 | `			SyBlob sResolved;` |
|       - |  8237 | `			SyString sBaseName;` |
|       - |  8238 | `			sxu32 nRefLine;` |
|   69037 |  8239 | `			pGen->pIn++; /* Advance past 'extends' */` |
|   69037 |  8240 | `			nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|   69037 |  8241 | `			SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|   69037 |  8242 | `			if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|       - |  8252 | `			}` |
|  103550 |  8253 | `			pBase = PH7_VmExtractClass(pGen->pVm,` |
|   69030 |  8254 | `				(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|   69035 |  8255 | `			SyStringInitFromBuf(&sBaseName,` |
|       - |  8256 | `				(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|       - |  8257 | `			/* Interfaces are not allowed */` |
|   69035 |  8258 | `			while( pBase && (pBase->iFlags & PH7_CLASS_INTERFACE) ){` |
|     ! 0 |  8259 | `				pBase = pBase->pNextName;` |
|     ! 0 |  8260 | `			}` |
|   69035 |  8261 | `			if( pBase == 0 ){` |
...
|       - |  8267 | `				}` |
|     ! 0 |  8268 | `			}else{` |
|   69035 |  8269 | `				if( pBase->iFlags & PH7_CLASS_FINAL ){` |
...
|     ! 0 |  8276 | `				}` |
|       - |  8277 | `			}` |
|   69035 |  8278 | `			SyBlobRelease(&sResolved);` |
|   34515 |  8279 | `		}` |
|   78991 |  8280 | `		if (pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) && SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_IMPLEMENTS ){` |
|       - |  8281 | `			ph7_class *pInterface;` |
|       - |  8282 | `			/* Interface implementation */` |
|    9967 |  8283 | `			pGen->pIn++; /* Advance the stream cursor */` |
|    4981 |  8284 | `			for(;;){` |
|       - |  8285 | `				SyBlob sResolved;` |
|       - |  8286 | `				SyString sIntName;` |
|       - |  8287 | `				sxu32 nRefLine;` |
|    9967 |  8288 | `				nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|    9967 |  8289 | `				SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|    9967 |  8290 | `				if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|     ! 0 |  8298 | `					break;` |
|       - |  8299 | `				}` |
|   19929 |  8300 | `				pInterface = PH7_VmExtractClass(pGen->pVm,` |
|    9962 |  8301 | `					(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|    9967 |  8302 | `				SyStringInitFromBuf(&sIntName,` |
|       - |  8303 | `					(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|       - |  8304 | `				/* Only interfaces are allowed */` |
|    9967 |  8305 | `				while( pInterface && (pInterface->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|     ! 0 |  8306 | `					pInterface = pInterface->pNextName;` |
|     ! 0 |  8307 | `				}` |
|    9967 |  8308 | `				if( pInterface == 0 ){` |
...
|    9967 |  8322 | `					SyString *pFqn = &pClass->sName;` |
|    9967 |  8323 | `					int bIsExceptionOrError =` |
|    8263 |  8324 | `						(pFqn->nByte == sizeof("Exception")-1 &&` |
|   16585 |  8325 | `						 SyMemcmp(pFqn->zString,"Exception",sizeof("Exception")-1) == 0) \|\|` |
|    8327 |  8326 | `						(pFqn->nByte == sizeof("Error")-1 &&` |
|    3290 |  8327 | `						 SyMemcmp(pFqn->zString,"Error",sizeof("Error")-1) == 0);` |
|   13247 |  8328 | `					if( GenStateInterfaceIsThrowable(pInterface) &&` |
|    9858 |  8329 | `						!GenStateClassIsExceptionOrError(pBase) &&` |
|    3283 |  8330 | `						!bIsExceptionOrError ){` |
...
|       6 |  8340 | `					}else{` |
|    9961 |  8341 | `						SySetPut(&aInterfaces,(const void *)&pInterface);` |
|       - |  8342 | `					}` |
|       - |  8343 | `				}` |
|    9967 |  8344 | `				SyBlobRelease(&sResolved);` |
|    9967 |  8345 | `				if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COMMA) == 0 ){` |
|    4986 |  8346 | `					break;` |
|       - |  8347 | `				}` |
...
|    4981 |  8350 | `		}` |
|   39493 |  8351 | `	}` |
|   89599 |  8352 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|       - |  8353 | `		/* Syntax error */` |
...
|       - |  8361 | `	}` |
|   89599 |  8362 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|   89599 |  8363 | `	pEnd = 0; /* cc warning */` |
|       - |  8364 | `	/* Delimit the class body */` |
|   89599 |  8365 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|   89599 |  8366 | `	if( pEnd >= pGen->pEnd ){` |
|       - |  8367 | `		/* Syntax error */` |
...
|   89599 |  8377 | `	pTmp = pGen->pEnd;` |
|   89599 |  8378 | `	pGen->pEnd = pEnd;` |
|       - |  8379 | `	/* Set the inherited flags */` |
|   89599 |  8380 | `	pClass->iFlags = iFlags;` |
|       - |  8381 | `	/* Start the parse process */` |
|  125593 |  8382 | `	for(;;){` |
|       - |  8383 | `		/* Jump leading/trailing semi-colons */` |
|  377033 |  8384 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|   62959 |  8385 | `			pGen->pIn++;` |
|       5 |  8386 | `		}` |
|  314079 |  8387 | `		if( pGen->pIn >= pGen->pEnd ){` |
|       - |  8388 | `			/* End of class body */` |
|   89571 |  8389 | `			break;` |
|       - |  8390 | `		}` |
|  224508 |  8391 | `		if( (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR)) == 0` |
|  112259 |  8392 | ``			&& !GenStateIsReadonly(pGen->pIn) /* allow a leading `readonly` modifier */ ){`` |
...
|  224513 |  8403 | `		iProtection = PH7_TKWRD_PUBLIC;` |
|  224513 |  8404 | `		iAttrflags = 0;` |
...
|  224513 |  8409 | `		if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|     ! 0 |  8410 | `			int bMod = 0;` |
...
|       - |  8431 | `			}` |
|     ! 0 |  8432 | `		}` |
|  224513 |  8433 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|       - |  8434 | `			/* Extract the current keyword */` |
|  224513 |  8435 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  224513 |  8436 | `			if( nKwrd == PH7_TKWRD_USE ){` |
...
|      49 |  8496 | `				continue;` |
|       - |  8497 | `			}` |
|  224469 |  8498 | `			if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|  221027 |  8499 | `				iProtection = nKwrd;` |
|  221027 |  8500 | `				pGen->pIn++; /* Jump the visibility token */` |
|       - |  8501 | ``				/* Optional `readonly` after the visibility: `public readonly int $x`. */`` |
|  221027 |  8502 | `				if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|      20 |  8503 | `					iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|      20 |  8504 | `					pGen->pIn++; /* Jump the 'readonly' modifier */` |
|       8 |  8505 | `				}` |
|  221022 |  8506 | `				if( pGen->pIn >= pGen->pEnd` |
|  221027 |  8507 | `					\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP)) == 0 ){` |
...
|     ! 0 |  8515 | `					goto done;` |
|       - |  8516 | `				}` |
|  221027 |  8517 | `				if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|       - |  8518 | `					/* Attribute declaration (untyped) */` |
|   62683 |  8519 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|   62683 |  8520 | `					if( rc != SXRET_OK ){` |
...
|   62677 |  8526 | `					continue;` |
|       - |  8527 | `				}` |
|  158349 |  8528 | `				if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|  158195 |  8540 | `				nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   79095 |  8541 | `			}` |
|  161637 |  8542 | `			if( nKwrd == PH7_TKWRD_CONST ){` |
...
|       - |  8550 | `				}` |
|      34 |  8551 | `			}else{` |
|  161577 |  8552 | `				if( nKwrd == PH7_TKWRD_STATIC ){` |
|       - |  8553 | `					/* Static method or attribute,record that */` |
|    3327 |  8554 | `					iAttrflags \|= PH7_CLASS_ATTR_STATIC;` |
|    3327 |  8555 | `					pGen->pIn++; /* Jump the static keyword */` |
|    3327 |  8556 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|       - |  8557 | `						/* Extract the keyword */` |
|    3321 |  8558 | `						nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    3321 |  8559 | `						if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
...
|    3327 |  8567 | `					if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|     ! 0 |  8568 | `						iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|     ! 0 |  8569 | `						pGen->pIn++; /* Jump the 'readonly' modifier */` |
|     ! 0 |  8570 | `					}` |
|    3322 |  8571 | `					if( pGen->pIn >= pGen->pEnd` |
|    3327 |  8572 | `						\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP)) == 0 ){` |
...
|     ! 0 |  8580 | `						goto done;` |
|       - |  8581 | `					}` |
|    3327 |  8582 | `					if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
...
|       5 |  8591 | `						continue;` |
|       - |  8592 | `					}` |
|    3323 |  8593 | `					if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|    3311 |  8605 | `					nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  159908 |  8606 | `				}else if( nKwrd == PH7_TKWRD_ABSTRACT ){` |
...
|  158250 |  8638 | `				}else if( nKwrd == PH7_TKWRD_FINAL ){` |
|       - |  8639 | `					/* final method ,record that */` |
|      18 |  8640 | `					iAttrflags \|= PH7_CLASS_ATTR_FINAL;` |
|      18 |  8641 | `					pGen->pIn++; /* Jump the final keyword */` |
|      18 |  8642 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|       - |  8643 | `						/* Extract the keyword */` |
|      18 |  8644 | `						nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|      18 |  8645 | `						if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|       9 |  8646 | `							iProtection = nKwrd;` |
|       9 |  8647 | `							pGen->pIn++; /* Jump the visibility token */` |
|       3 |  8648 | `						}` |
|       7 |  8649 | `					}` |
|      18 |  8650 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
...
|       2 |  8682 | `				}` |
|  161551 |  8683 | `				if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_VAR ){` |
...
|     ! 0 |  8691 | `						goto done;` |
|       - |  8692 | `				}` |
|  161551 |  8693 | `				if( nKwrd == PH7_TKWRD_VAR ){` |
...
|  161545 |  8708 | `					rc = GenStateCompileClassMethod(&(*pGen),iProtection,iAttrflags,TRUE,pClass);` |
|       - |  8709 | `				}` |
|  161551 |  8710 | `				if( rc != SXRET_OK ){` |
...
|       - |  8733 | `		sxu32 nU;` |
|   89571 |  8734 | `		apUse = (TraitUseEntry *)SySetBasePtr(&aUseEntries);` |
|   89615 |  8735 | `		for( nU = 0 ; nU < SySetUsed(&aUseEntries) ; nU++ ){` |
...
|   89571 |  8943 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|   89571 |  8944 | `	if( rc == SXRET_OK ){` |
|       - |  8945 | `		ph7_class **apInterface;` |
|       - |  8946 | `		sxu32 n;` |
|   89571 |  8947 | `		if( pBase ){` |
|       - |  8948 | `			/* Inherit from base class and mark as a subclass */` |
|   69035 |  8949 | `			rc = PH7_ClassInherit(&(*pGen),pClass,pBase);` |
|   34515 |  8950 | `		}` |
|   89571 |  8951 | `		apInterface = (ph7_class **)SySetBasePtr(&aInterfaces);` |
|   99527 |  8952 | `		for( n = 0 ; n < SySetUsed(&aInterfaces) ; n++ ){` |
|       - |  8953 | `			/* Implements one or more interface */` |
|    9961 |  8954 | `			rc = PH7_ClassImplement(pClass,apInterface[n]);` |
|    9961 |  8955 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  8956 | `				break;` |
|       - |  8957 | `			}` |
|    4983 |  8958 | `		}` |
...
|   89566 |  8961 | `		if( rc == SXRET_OK` |
|   89566 |  8962 | `		 && (pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT)) == 0` |
|   89571 |  8963 | `		 && SyHashGet(&pClass->hMethod,"__toString",sizeof("__toString")-1) != 0 ){` |
|   78807 |  8964 | `			ph7_class *pStringable = PH7_VmExtractClass(pGen->pVm,` |
|       - |  8965 | `				"Stringable",sizeof("Stringable")-1,FALSE,0);` |
|   78807 |  8966 | `			if( pStringable ){` |
|   78807 |  8967 | `				ph7_class **apImpl = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|   78807 |  8968 | `				sxu32 nImpl = SySetUsed(&pClass->aInterface);` |
|       - |  8969 | `				sxu32 i;` |
|   78807 |  8970 | `				int bAlready = 0;` |
|   85371 |  8971 | `				for( i = 0 ; i < nImpl ; i++ ){` |
|    6571 |  8972 | `					if( apImpl[i] == pStringable ){` |
|       3 |  8973 | `						bAlready = 1;` |
|       3 |  8974 | `						break;` |
|       - |  8975 | `					}` |
|    3287 |  8976 | `				}` |
|   78807 |  8977 | `				if( !bAlready ){` |
|   78805 |  8978 | `					PH7_ClassImplement(pClass,pStringable);` |
|   39400 |  8979 | `				}` |
|   39401 |  8980 | `			}` |
|   39401 |  8981 | `		}` |
|       - |  8982 | `		/* Validate interface method signatures (visibility and parameter count) */` |
|   89571 |  8983 | `		if( rc == SXRET_OK ){` |
|   89571 |  8984 | `			sxi32 rcCheck = GenStateCheckInterfaceSignatures(&(*pGen),pClass);` |
|   89571 |  8985 | `			if( rcCheck == SXERR_ABORT ){` |
...
|   89571 |  8992 | `		if( rc == SXRET_OK ){` |
|   89571 |  8993 | `			sxi32 rcCheck = GenStateCheckAbstractMethods(&(*pGen),pClass);` |
|   89571 |  8994 | `			if( rcCheck == SXERR_ABORT ){` |
...
|   44783 |  8999 | `		}` |
|   44783 |  9000 | `	}` |
|   89571 |  9001 | `	SySetRelease(&aUseEntries);` |
|   89571 |  9002 | `	SySetRelease(&aInterfaces);` |
|   89571 |  9003 | `	if( rc != SXRET_OK ){` |
...
|   89599 |  9009 | `	pGen->pIn = &pEnd[1];` |
|   89599 |  9010 | `	pGen->pEnd = pTmp;` |
|   89599 |  9011 | `	return PH7_OK;` |
|   44803 |  9012 |  |
|       - |  9013 | `/*` |
...
|       - |  9033 | ` */` |
|  884046 |  9034 | `static int GenStateTokenIsClassModifier(SyToken *pTok,sxi32 *piFlag)` |
|       5 |  9035 |  |
|  884051 |  9036 | `	if( pTok->nType & PH7_TK_KEYWORD ){` |
|  585855 |  9037 | `		sxu32 nKw = (sxu32)SX_PTR_TO_INT(pTok->pUserData);` |
|  585855 |  9038 | `		if( nKw == PH7_TKWRD_FINAL ){ *piFlag = PH7_CLASS_FINAL; return TRUE; }` |
|  585837 |  9039 | `		if( nKw == PH7_TKWRD_ABSTRACT ){ *piFlag = PH7_CLASS_ABSTRACT; return TRUE; }` |
|  292893 |  9040 | `	}` |
|  883987 |  9041 | `	if( GenStateIsReadonly(pTok) ){ *piFlag = PH7_CLASS_READONLY; return TRUE; }` |
|  883927 |  9042 | `	return FALSE;` |
|  442028 |  9043 |  |
|       - |  9044 | `/*` |
...
|       - |  9049 | ` */` |
|  883922 |  9050 | `static sxi32 GenStateScanClassModifiers(SyToken **ppIn,SyToken *pEnd,SyToken **ppDup)` |
|       5 |  9051 |  |
|  883927 |  9052 | `	SyToken *pIn = *ppIn,*pDup = 0;` |
|  883927 |  9053 | `	sxi32 iFlags = 0,iFlag;` |
|  884051 |  9054 | `	while( pIn < pEnd && GenStateTokenIsClassModifier(pIn,&iFlag) ){` |
...
|     129 |  9059 | `		pIn++;` |
|       5 |  9060 | `	}` |
|  883927 |  9061 | `	*ppIn = pIn;` |
|  883927 |  9062 | `	if( ppDup ){ *ppDup = pDup; }` |
|  883927 |  9063 | `	return iFlags;` |
|       5 |  9064 |  |
|       - |  9065 | `/*` |
...
|       - |  9071 | ` */` |
|  883870 |  9072 | `static int GenStateStartsModifiedClass(SyToken *pIn,SyToken *pEnd)` |
|       5 |  9073 |  |
|  883875 |  9074 | `	sxi32 iFlags = GenStateScanClassModifiers(&pIn,pEnd,0);` |
|  441994 |  9075 | `	return iFlags != 0 && pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD)` |
|  883898 |  9076 | `		&& (sxu32)SX_PTR_TO_INT(pIn->pUserData) == PH7_TKWRD_CLASS;` |
|       5 |  9077 |  |
|       - |  9078 | `/*` |
...
|       - |  9095 | `		}` |
|       1 |  9096 | `	}` |
|      52 |  9097 | `	if( (iFlags & (PH7_CLASS_FINAL\|PH7_CLASS_ABSTRACT))` |
...
|       - |  9406 | ` */` |
|   89544 |  9407 | `static sxi32 PH7_CompileClass(ph7_gen_state *pGen)` |
|       5 |  9408 |  |
|       - |  9409 | `	sxi32 rc;` |
|   89549 |  9410 | `	rc = GenStateCompileClass(&(*pGen),0);` |
|   89549 |  9411 | `	return rc;` |
|       5 |  9412 |  |
|       - |  9413 | `/*` |
...
|       - |  9434 | ` */` |
|   10050 |  9435 | `static sxi32 GenStateThrowNodeValidator(ph7_gen_state *pGen,ph7_expr_node *pRoot)` |
|       5 |  9436 |  |
|   10055 |  9437 | `	sxi32 rc = SXRET_OK;` |
|   10055 |  9438 | `	if( pRoot->pOp ){` |
|   10047 |  9439 | `		switch( pRoot->pOp->iOp ){` |
|    5021 |  9440 | `		case EXPR_OP_NEW:            /* new Exception() */` |
...
|     ! 0 |  9456 | `			break;` |
|       - |  9457 | `		}` |
|    5034 |  9458 | `	}else if( pRoot->xCode != PH7_CompileVariable ){` |
...
|       - |  9472 | ` */` |
|   10014 |  9473 | `static sxi32 PH7_CompileThrow(ph7_gen_state *pGen)` |
|       5 |  9474 |  |
|   10019 |  9475 | `	sxu32 nLine = pGen->pIn->nLine;` |
|       - |  9476 | `	GenBlock *pBlock;` |
|       - |  9477 | `	sxu32 nIdx;` |
|       - |  9478 | `	sxi32 rc;` |
|   10019 |  9479 | `	pGen->pIn++; /* Jump the 'throw' keyword */` |
|       - |  9480 | `	/* Compile the expression */` |
|   10019 |  9481 | `	rc = PH7_CompileExpr(&(*pGen),0,GenStateThrowNodeValidator);` |
|   10019 |  9482 | `	if( rc == SXERR_EMPTY ){` |
...
|       - |  9488 | `	}` |
|   10019 |  9489 | `	pBlock = pGen->pCurrent;` |
|       - |  9490 | `	/* Point to the top most function or try block and emit the forward jump */` |
|   46273 |  9491 | `	while(pBlock->pParent){` |
|   46269 |  9492 | `		if( pBlock->iFlags & (GEN_BLOCK_EXCEPTION\|GEN_BLOCK_FUNC) ){` |
|   10015 |  9493 | `			break;` |
|       - |  9494 | `		}` |
|       - |  9495 | `		/* Point to the parent block */` |
|   36259 |  9496 | `		pBlock = pBlock->pParent;` |
|       5 |  9497 | `	}` |
|       - |  9498 | `	/* Emit the throw instruction */` |
|   10019 |  9499 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_THROW,0,0,0,&nIdx);` |
|       - |  9500 | `	/* Emit the jump */` |
|   10019 |  9501 | `	GenStateNewJumpFixup(pBlock,PH7_OP_THROW,nIdx);` |
|   10019 |  9502 | `	return SXRET_OK;` |
|    5012 |  9503 |  |
|       - |  9504 | `/*` |
...
|       - |  9555 | ` */` |
|     418 |  9556 | `static sxi32 PH7_CompileCatch(ph7_gen_state *pGen,ph7_exception *pException)` |
|       5 |  9557 |  |
|     423 |  9558 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|       - |  9565 | `	char *zDup;` |
|       - |  9566 | `	sxi32 rc;` |
|     423 |  9567 | `	pGen->pIn++; /* Jump the 'catch' keyword */` |
|       - |  9568 | `	/* Zero the structure */` |
|     423 |  9569 | `	SyZero(&sCatch,sizeof(ph7_exception_block));` |
|       - |  9570 | `	/* Initialize fields */` |
|     423 |  9571 | `	SySetInit(&sCatch.aClasses,&pException->pVm->sAllocator,sizeof(SyString));` |
|     423 |  9572 | `	SySetInit(&sCatch.sByteCode,&pException->pVm->sAllocator,sizeof(VmInstr));` |
|     423 |  9573 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 /*(*/ ){` |
...
|     423 |  9588 | `	pGen->pIn++; /* Jump the left parenthesis '(' */` |
|     222 |  9589 | `	for(;;){` |
|       - |  9590 | `		SyBlob sResolved;` |
|     449 |  9591 | `		SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|     449 |  9592 | `		if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|     665 |  9608 | `		zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|     440 |  9609 | `			(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|     445 |  9610 | `		SyStringInitFromBuf(&sClassName,zDup,SyBlobLength(&sResolved));` |
|     445 |  9611 | `		SyBlobRelease(&sResolved);` |
|     445 |  9612 | `		if( zDup == 0 ){` |
|     ! 0 |  9613 | `			goto Mem;` |
|       - |  9614 | `		}` |
|     445 |  9615 | `		rc = SySetPut(&sCatch.aClasses,(const void *)&sClassName);` |
|     445 |  9616 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  9617 | `			goto Mem;` |
|       - |  9618 | `		}` |
|       - |  9619 | `		/* Check for '\|' (multi-catch separator) */` |
|     440 |  9620 | `		if( pGen->pIn < pGen->pEnd &&` |
|     440 |  9621 | `			(pGen->pIn->nType & PH7_TK_OP) &&` |
...
|     419 |  9627 | `		break;` |
|     ! 0 |  9628 | `	}` |
|     414 |  9629 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 /*$*/ \|\|` |
|     419 |  9630 | `		&pGen->pIn[1] >= pGen->pEnd \|\| (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|       - |  9643 | `	}` |
|     419 |  9644 | `	pGen->pIn++; /* Jump the dollar sign */` |
|       - |  9645 | `	/* Duplicate instance name */` |
|     419 |  9646 | `	pName = &pGen->pIn->sData;` |
|     419 |  9647 | `	zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|     419 |  9648 | `	if( zDup == 0 ){` |
|     ! 0 |  9649 | `		goto Mem;` |
|       - |  9650 | `	}` |
|     419 |  9651 | `	SyStringInitFromBuf(&sCatch.sThis,zDup,pName->nByte);` |
|     419 |  9652 | `	pGen->pIn++;` |
|     419 |  9653 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_RPAREN) == 0 /*)*/ ){` |
...
|     419 |  9668 | `	pGen->pIn++; /* Jump the right parenthesis */` |
|       - |  9669 | `	/* Create the catch block */` |
|     419 |  9670 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_EXCEPTION,PH7_VmInstrLength(pGen->pVm),0,&pCatch);` |
|     419 |  9671 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  9672 | `		return SXERR_ABORT;` |
|       - |  9673 | `	}` |
|       - |  9674 | `	/* Swap bytecode container */` |
|     419 |  9675 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|     419 |  9676 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&sCatch.sByteCode);` |
|       - |  9677 | `	/* Compile the block */` |
|     419 |  9678 | `	PH7_CompileBlock(&(*pGen),0);` |
|       - |  9679 | `	/* Fix forward jumps now the destination is resolved  */` |
|     419 |  9680 | `	GenStateFixJumps(pCatch,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - |  9681 | `	/* Emit the DONE instruction */` |
|     419 |  9682 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|       - |  9683 | `	/* Leave the block */` |
|     419 |  9684 | `	GenStateLeaveBlock(&(*pGen),0);` |
|       - |  9685 | `	/* Restore the default container */` |
|     419 |  9686 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|       - |  9687 | `	/* Install the catch block */` |
|     419 |  9688 | `	rc = SySetPut(&pException->sEntry,(const void *)&sCatch);` |
|     419 |  9689 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  9690 | `		goto Mem;` |
|       - |  9691 | `	}` |
|     419 |  9692 | `	return SXRET_OK;` |
|     ! 0 |  9693 | `Mem:` |
...
|       - |  9702 | ` * is "thrown".` |
|       - |  9703 | ` */` |
|     432 |  9704 | `static sxi32 PH7_CompileTry(ph7_gen_state *pGen)` |
|       5 |  9705 |  |
|       - |  9706 | `	ph7_exception *pException;` |
|     437 |  9707 | `	sxu32 nLine = pGen->pIn->nLine;` |
|       - |  9708 | `	GenBlock *pTry;` |
|       - |  9709 | `	sxu32 nJmpIdx;` |
|       - |  9710 | `	sxi32 rc;` |
|       - |  9711 | `	/* Create the exception container */` |
|     437 |  9712 | `	pException = (ph7_exception *)SyMemBackendAlloc(&pGen->pVm->sAllocator,sizeof(ph7_exception));` |
|     437 |  9713 | `	if( pException == 0 ){` |
...
|     437 |  9719 | `	SyZero(pException,sizeof(ph7_exception));` |
|       - |  9720 | `	/* Initialize fields */` |
|     437 |  9721 | `	SySetInit(&pException->sEntry,&pGen->pVm->sAllocator,sizeof(ph7_exception_block));` |
|     437 |  9722 | `	SySetInit(&pException->sFinally,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|     437 |  9723 | `	pException->iHasFinally = 0;` |
|     437 |  9724 | `	pException->iFinallyDone = 0;` |
|     437 |  9725 | `	pException->pVm = pGen->pVm;` |
|       - |  9726 | `	/* Create the try block */` |
|     437 |  9727 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_EXCEPTION,PH7_VmInstrLength(pGen->pVm),0,&pTry);` |
|     437 |  9728 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  9729 | `		return SXERR_ABORT;` |
|       - |  9730 | `	}` |
|       - |  9731 | `	/* Store exception pointer so break/continue can emit POP_EXCEPTION */` |
|     437 |  9732 | `	pTry->pUserData = pException;` |
|       - |  9733 | `	/* Emit the 'LOAD_EXCEPTION' instruction */` |
|     437 |  9734 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_EXCEPTION,0,0,pException,&nJmpIdx);` |
|       - |  9735 | `	/* Fix the jump later when the destination is resolved */` |
|     437 |  9736 | `	GenStateNewJumpFixup(pTry,PH7_OP_LOAD_EXCEPTION,nJmpIdx);` |
|     437 |  9737 | `	pGen->pIn++; /* Jump the 'try' keyword */` |
|       - |  9738 | `	/* Compile the block */` |
|     437 |  9739 | `	rc = PH7_CompileBlock(&(*pGen),0);` |
|     437 |  9740 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  9741 | `		return SXERR_ABORT;` |
|       - |  9742 | `	}` |
|       - |  9743 | `	/* Fix forward jumps now the destination is resolved */` |
|     437 |  9744 | `	GenStateFixJumps(pTry,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - |  9745 | `	/* Emit the 'POP_EXCEPTION' instruction */` |
|     437 |  9746 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP_EXCEPTION,0,0,pException,0);` |
|       - |  9747 | `	/* Leave the block */` |
|     437 |  9748 | `	GenStateLeaveBlock(&(*pGen),0);` |
|       - |  9749 | `	/* Compile catch block(s) — at least one catch or finally is required */` |
|     437 |  9750 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|     430 |  9751 | `		SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_CATCH ){` |
|       - |  9752 | `		/* Compile one or more catch blocks */` |
|     414 |  9753 | `		for(;;){` |
|     828 |  9754 | `			if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0` |
|     654 |  9755 | `				\|\| SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_CATCH ){` |
|     210 |  9756 | `					break;` |
|       - |  9757 | `			}` |
|     423 |  9758 | `			rc = PH7_CompileCatch(&(*pGen),pException);` |
|     423 |  9759 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  9760 | `				return SXERR_ABORT;` |
|       - |  9761 | `			}` |
|       5 |  9762 | `		}` |
|     205 |  9763 | `	}` |
|       - |  9764 | `	/* Compile optional finally block */` |
|     437 |  9765 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
...
|     437 |  9795 | `	if( SySetUsed(&pException->sEntry) == 0 && !pException->iHasFinally ){` |
|       8 |  9796 | `		rc = PH7_GenCompileError(&(*pGen),E_ERROR,nLine,` |
|       - |  9797 | `			"Cannot use try without catch or finally");` |
|       8 |  9798 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  9799 | `			return SXERR_ABORT;` |
|       - |  9800 | `		}` |
|       3 |  9801 | `	}` |
|     437 |  9802 | `	return SXRET_OK;` |
|     221 |  9803 |  |
|       - |  9804 | `/*` |
...
|       - | 10158 | ` */` |
| 2396020 | 10159 | `static void GenStatePatchNullsafeJumps(ph7_gen_state *pGen, sxu32 nBaseline)` |
|       5 | 10160 |  |
| 2396025 | 10161 | `	sxu32 nCur = SySetUsed(&pGen->aNullsafeJmp);` |
|       - | 10162 | `	sxu32 nTarget;` |
|       - | 10163 | `	sxu32 *aIdx;` |
|       - | 10164 | `	sxu32 i;` |
| 2396025 | 10165 | `	if( nCur <= nBaseline ){` |
| 2395935 | 10166 | `		return;` |
|       - | 10167 | `	}` |
...
|       - | 10195 | ` */` |
|  389258 | 10196 | `static sxu32 GenStateByRefBuiltinMask(SyString *pName)` |
|       5 | 10197 |  |
...
|       - | 10207 | `	};` |
|       - | 10208 | `	sxu32 i;` |
|  389263 | 10209 | `	if( pName == 0 \|\| pName->zString == 0 \|\| pName->nByte == 0 ){` |
|    1175 | 10210 | `		return 0;` |
|       - | 10211 | `	}` |
| 1940301 | 10212 | `	for( i = 0 ; i < SX_ARRAYSIZE(aByRef) ; ++i ){` |
| 1552254 | 10213 | `		if( pName->nByte == aByRef[i].nByte` |
|  796589 | 10214 | `		 && SyStrnicmp(pName->zString, aByRef[i].zName, pName->nByte) == 0 ){` |
|      51 | 10215 | `			return aByRef[i].mask;` |
|       - | 10216 | `		}` |
|  776109 | 10217 | `	}` |
|  388047 | 10218 | `	return 0;` |
|  194634 | 10219 |  |
|       - | 10220 | `/*` |
...
|       - | 10229 | ` */` |
|  389258 | 10230 | `static void GenStateCallBuiltinName(ph7_expr_node *pLeft, SyString *pOut)` |
|       5 | 10231 |  |
|       - | 10232 | `	SyToken *p, *pEnd;` |
|  389263 | 10233 | `	pOut->zString = 0;` |
|  389263 | 10234 | `	pOut->nByte = 0;` |
|  389263 | 10235 | `	if( pLeft == 0 \|\| pLeft->pStart == 0 \|\| pLeft->pEnd == 0 ){` |
|     ! 0 | 10236 | `		return;` |
|       - | 10237 | `	}` |
|  389263 | 10238 | `	p = pLeft->pStart;` |
|  389263 | 10239 | `	pEnd = pLeft->pEnd;` |
|       - | 10240 | `	/* Optional single leading namespace separator (absolute path). */` |
|  389263 | 10241 | `	if( p < pEnd && (p->nType & PH7_TK_NSSEP) ){` |
|      24 | 10242 | `		p++;` |
|      10 | 10243 | `	}` |
|  389263 | 10244 | `	if( p >= pEnd \|\| (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|    1149 | 10245 | `		return;` |
|       - | 10246 | `	}` |
|       - | 10247 | `	/* Must be a single component: nothing follows the name token. */` |
|  388119 | 10248 | `	if( p + 1 != pEnd ){` |
|      30 | 10249 | `		return;` |
|       - | 10250 | `	}` |
|  388093 | 10251 | `	*pOut = p->sData;` |
|  194634 | 10252 |  |
|       - | 10253 | `/*` |
...
|       - | 10258 | ` * error message.` |
|       - | 10259 | ` */` |
| 3228792 | 10260 | `static sxi32 GenStateEmitExprCode(` |
...
|       - | 10267 | `	sxu32 nJmpIdx;` |
| 3228797 | 10268 | `	sxi32 iP1 = 0;` |
| 3228797 | 10269 | `	sxu32 iP2 = 0;` |
| 3228797 | 10270 | `	void *p3  = 0;` |
|       - | 10271 | `	sxi32 iVmOp;` |
|       - | 10272 | `	sxi32 rc;` |
| 3228797 | 10273 | `	int bIsChainOp = 0; /* Set below once we know pNode->pOp */` |
| 3228797 | 10274 | `	sxu32 nRhsNsBase = 0;` |
| 3228797 | 10275 | `	if( pNode->xCode ){` |
|       - | 10276 | `		SyToken *pTmpIn,*pTmpEnd;` |
|       - | 10277 | `		/* Compile node */` |
| 1999793 | 10278 | `		SWAP_DELIMITER(pGen,pNode->pStart,pNode->pEnd);` |
| 1999793 | 10279 | `		rc = pNode->xCode(&(*pGen),iFlags);` |
| 1999793 | 10280 | `		RE_SWAP_DELIMITER(pGen);` |
| 1999793 | 10281 | `		return rc;` |
|       - | 10282 | `	}` |
| 1229009 | 10283 | `	if( pNode->pOp == 0 ){` |
...
|       - | 10287 | `	}` |
| 1229009 | 10288 | `	iVmOp = pNode->pOp->iVmOp;` |
| 1229009 | 10289 | `	if( pNode->pOp->iOp == EXPR_OP_NULLC_ASSIGN ){` |
...
|       - | 10338 | `	}` |
| 1228953 | 10339 | `	if( pNode->pOp->iOp == EXPR_OP_QUESTY ){` |
...
|    2569 | 10344 | `		nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|    2569 | 10345 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pCond,iFlags);` |
|    2569 | 10346 | `		if( rc != SXRET_OK ){` |
|     ! 0 | 10347 | `			return rc;` |
|       - | 10348 | `		}` |
...
|    2569 | 10352 | `		GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|    2569 | 10353 | `		nJz = nJmp = 0; /* cc -O6 warning */` |
|    2569 | 10354 | `		if( pNode->pLeft ){` |
|       - | 10355 | `			/* Standard ternary: (expr) ? (then) : (else) */` |
|       - | 10356 | `			/* Phase#2: Emit the false jump (pops condition) */` |
|    2501 | 10357 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nJz);` |
|       - | 10358 | `			/* Phase#3: Compile the 'then' expression  */` |
|    2501 | 10359 | `			nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|    2501 | 10360 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pLeft,iFlags);` |
|    2501 | 10361 | `			if( rc != SXRET_OK ){` |
|     ! 0 | 10362 | `				return rc;` |
|       - | 10363 | `			}` |
|    2501 | 10364 | `			GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|    1253 | 10365 | `		}else{` |
...
|    2569 | 10373 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,0,0,&nJmp);` |
|       - | 10374 | `		/* Phase#5: Fix the false jump now the jump destination is resolved. */` |
|    2569 | 10375 | `		pInstr = PH7_VmGetInstr(pGen->pVm,nJz);` |
|    2569 | 10376 | `		if( pInstr ){` |
|    2569 | 10377 | `			pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    1282 | 10378 | `		}` |
|    2569 | 10379 | `		if( !pNode->pLeft ){` |
...
|    2569 | 10384 | `		if( pNode->pRight ){` |
|    2569 | 10385 | `			nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|    2569 | 10386 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pRight,iFlags);` |
|    2569 | 10387 | `			if( rc != SXRET_OK ){` |
|     ! 0 | 10388 | `				return rc;` |
|       - | 10389 | `			}` |
|    2569 | 10390 | `			GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|    1282 | 10391 | `		}` |
|    2569 | 10392 | `		if( nJmp > 0 ){` |
|       - | 10393 | `			/* Phase#7: Fix the unconditional jump */` |
|    2569 | 10394 | `			pInstr = PH7_VmGetInstr(pGen->pVm,nJmp);` |
|    2569 | 10395 | `			if( pInstr ){` |
|    2569 | 10396 | `				pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    1282 | 10397 | `			}` |
|    1282 | 10398 | `		}` |
|       - | 10399 | `		/* All done */` |
|    2569 | 10400 | `		return SXRET_OK;` |
|       - | 10401 | `	}` |
| 1226389 | 10402 | `	bIsChainOp = GEN_IS_CHAIN_OP(pNode->pOp->iOp);` |
|       - | 10403 | `	/* Generate code for the left tree */` |
| 1226389 | 10404 | `	if( pNode->pLeft ){` |
| 1226351 | 10405 | `		sxu32 nLhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
| 1226351 | 10406 | `		if( iVmOp == PH7_OP_CALL ){` |
|       - | 10407 | `			ph7_expr_node **apNode;` |
|  389383 | 10408 | `			int hasSpread = 0;` |
|  389383 | 10409 | `			int hasNamed = 0;` |
|  389383 | 10410 | `			int bAnySpread = 0;` |
|  389383 | 10411 | `			sxu32 byRefMask = 0;` |
|       - | 10412 | `			sxi32 nArgs;` |
|       - | 10413 | `			sxi32 n;` |
|       - | 10414 | `			/* Recurse and generate bytecodes for function arguments */` |
|  389383 | 10415 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  389383 | 10416 | `			nArgs = (sxi32)SySetUsed(&pNode->aNodeArgs);` |
|       - | 10417 | `			/* Validate: no positional arguments after named arguments */` |
|       - | 10418 | `			{` |
|  389383 | 10419 | `				int seenNamed = 0;` |
|  770951 | 10420 | `				for( n = 0; n < nArgs; ++n ){` |
|  381575 | 10421 | `					if( apNode[n]->iFlags & EXPR_NODE_NAMED_ARG ){` |
|     188 | 10422 | `						seenNamed = 1;` |
|     188 | 10423 | `						hasNamed = 1;` |
|  381483 | 10424 | `					}else if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
|      23 | 10425 | `						bAnySpread = 1;` |
|  381381 | 10426 | `					}else if( seenNamed ){` |
...
|  389381 | 10434 | `			iFlags \|= EXPR_FLAG_RDONLY_LOAD;` |
...
|  389381 | 10439 | `			if( pNode->pLeft && pNode->pLeft->pStart ){` |
|  389381 | 10440 | `				SyString *pCallName = &pNode->pLeft->pStart->sData;` |
|  389376 | 10441 | `				if( pCallName->nByte == 5` |
|  213714 | 10442 | `				 && SyStrnicmp(pCallName->zString,"isset",5) == 0 ){` |
|   19983 | 10443 | `					iFlags \|= EXPR_FLAG_LOAD_IDX_ISSET;` |
|  379392 | 10444 | `				}else if( pCallName->nByte == 5` |
|  193736 | 10445 | `				 && SyStrnicmp(pCallName->zString,"empty",5) == 0 ){` |
...
|  389381 | 10454 | `				if( !bAnySpread && !hasNamed ){` |
|       - | 10455 | `					SyString sBuiltin;` |
|  389263 | 10456 | `					GenStateCallBuiltinName(pNode->pLeft, &sBuiltin);` |
|  389263 | 10457 | `					byRefMask = GenStateByRefBuiltinMask(&sBuiltin);` |
|  194629 | 10458 | `				}` |
|  194688 | 10459 | `			}` |
|  770947 | 10460 | `			for( n = 0 ; n < nArgs ; ++n ){` |
|  381571 | 10461 | `				sxu32 nArgNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  381571 | 10462 | `				sxi32 iArgFlags = iFlags & ~EXPR_FLAG_LOAD_IDX_STORE;` |
...
|  381571 | 10465 | `				if( n < 31 && (byRefMask & (1u<<n)) ){` |
|      31 | 10466 | `					iArgFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|      13 | 10467 | `				}` |
|  381571 | 10468 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iArgFlags);` |
|  381571 | 10469 | `				if( rc != SXRET_OK ){` |
|     ! 0 | 10470 | `					return rc;` |
|       - | 10471 | `				}` |
|       - | 10472 | `				/* Each argument is an independent nullsafe scope. */` |
|  381571 | 10473 | `				GenStatePatchNullsafeJumps(pGen, nArgNsBase);` |
|  381571 | 10474 | `				if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
...
|  389381 | 10517 | `			iFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|  194688 | 10518 | `		}` |
| 1226349 | 10519 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pLeft,iFlags);` |
| 1226349 | 10520 | `		if( rc != SXRET_OK ){` |
|      34 | 10521 | `			return rc;` |
|       - | 10522 | `		}` |
| 1226319 | 10523 | `		if( !bIsChainOp ){` |
...
|  573035 | 10526 | `			GenStatePatchNullsafeJumps(pGen, nLhsNsBase);` |
|  286515 | 10527 | `		}` |
| 1226319 | 10528 | `		if( iVmOp == PH7_OP_CALL ){` |
|  389381 | 10529 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|  389381 | 10530 | `			if( pInstr ){` |
|  389381 | 10531 | `				if ( pInstr->iOp == PH7_OP_LOADC ){` |
|  388213 | 10532 | `					sxu32 nOrig = (sxu32)pInstr->iP2;` |
|       - | 10533 | `					sxu32 nQual;` |
|  388213 | 10534 | `					int bAbsolute = (pInstr->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|       - | 10535 | `					/* Prevent constant expansion but preserve the absolute flag` |
|       - | 10536 | `					 * so the later NEW handler (if any) can see it. */` |
|  388213 | 10537 | `					pInstr->iP1 &= ~PH7_LOADC_EXPAND;` |
...
|  388213 | 10545 | `					if( bAbsolute ){` |
|      24 | 10546 | `						pInstr->iP2 = (sxi32)nOrig;` |
|      14 | 10547 | `					}else{` |
|  388193 | 10548 | `						int fromImport = 0;` |
|  388193 | 10549 | `						nQual = GenStateNsQualifyName(pGen,nOrig,&pGen->hUseFuncImports,&fromImport);` |
|  388193 | 10550 | `						pInstr->iP2 = (sxi32)nQual;` |
|  388193 | 10551 | `						if( nQual != nOrig ){` |
...
|      36 | 10569 | `						}` |
|       5 | 10570 | `					}` |
|  195277 | 10571 | `				}else if( pInstr->iOp == PH7_OP_MEMBER /* $a->b(1,2,3) */ \|\| pInstr->iOp == PH7_OP_NEW ){` |
|       - | 10572 | `					/* Method call,flag that */` |
|     893 | 10573 | `					pInstr->iP2 = 1;` |
|     444 | 10574 | `				}` |
|  194693 | 10575 | `			}` |
| 1031631 | 10576 | `		}else if( iVmOp == PH7_OP_LOAD_IDX ){` |
|       - | 10577 | `			ph7_expr_node **apNode;` |
|       - | 10578 | `			sxi32 n;` |
|   84451 | 10579 | `			sxi32 iChildMask = ~(EXPR_FLAG_LOAD_IDX_STORE` |
...
|   84451 | 10583 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  152403 | 10584 | `			for( n = 0 ; n < (sxi32)SySetUsed(&pNode->aNodeArgs) ; ++n ){` |
|   67957 | 10585 | `				sxu32 nIdxNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|   67957 | 10586 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iFlags&iChildMask);` |
|   67957 | 10587 | `				if( rc != SXRET_OK ){` |
|     ! 0 | 10588 | `					return rc;` |
|       - | 10589 | `				}` |
|       - | 10590 | `				/* Each subscript index is an independent nullsafe scope. */` |
|   67957 | 10591 | `				GenStatePatchNullsafeJumps(pGen, nIdxNsBase);` |
|   33981 | 10592 | `			}` |
|   84451 | 10593 | `			if( SySetUsed(&pNode->aNodeArgs) > 0 ){` |
|   67957 | 10594 | `				iP1 = 1; /* Node have an index associated with it */` |
|   33976 | 10595 | `			}` |
|   84451 | 10596 | `			if( iFlags & EXPR_FLAG_LOAD_IDX_ISSET ){` |
|       - | 10597 | `				/* offsetExists for ArrayAccess; peek-only for arrays */` |
|     243 | 10598 | `				iP2 = 4;` |
|   84332 | 10599 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_UNSET ){` |
|       - | 10600 | `				/* offsetUnset for ArrayAccess; auto-vivify+load for arrays` |
|       - | 10601 | `				 * so the trailing unset() builtin can drop the slot. */` |
|      54 | 10602 | `				iP2 = 5;` |
|   84188 | 10603 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_EMPTY ){` |
...
|      29 | 10607 | `				iP2 = 6;` |
|   84151 | 10608 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_STORE ){` |
|       - | 10609 | `				/* Create an empty entry when the desired index is not found */` |
|   33263 | 10610 | `				iP2 = 1;` |
|   16634 | 10611 | `			}` |
|  794720 | 10612 | `		}else if( pNode->pOp->iOp == EXPR_OP_COMMA ){` |
|       - | 10613 | `			/* POP the left node */` |
|      32 | 10614 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|      15 | 10615 | `		}` |
|  613157 | 10616 | `	}` |
| 1226357 | 10617 | `	rc = SXRET_OK;` |
| 1226357 | 10618 | `	nJmpIdx = 0;` |
...
| 1226357 | 10622 | `	if( iVmOp == PH7_OP_MEMBER && pNode->pOp->iOp == EXPR_OP_DC ){` |
...
|     232 | 10630 | `				if( (n == 4 && SyMemcmp(z,"self",4) == 0) \|\|` |
|     230 | 10631 | `					(n == 6 && SyMemcmp(z,"static",6) == 0) \|\|` |
...
| 1226279 | 10652 | `	if( pNode->pRight ){` |
|  677213 | 10653 | `		if( iVmOp == PH7_OP_LAND ){` |
|       - | 10654 | `			/* Emit the false jump so we can short-circuit the logical and */` |
|   10303 | 10655 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,1/* Keep the value on the stack */,0,0,&nJmpIdx);` |
|  672064 | 10656 | `		}else if (iVmOp == PH7_OP_LOR ){` |
|       - | 10657 | `			/* Emit the true jump so we can short-circuit the logical or*/` |
|    3463 | 10658 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JNZ,1/* Keep the value on the stack */,0,0,&nJmpIdx);` |
|  665186 | 10659 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLC ){` |
...
|  663444 | 10663 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW ){` |
...
|  663284 | 10673 | `		}else if( pNode->pOp->iPrec == 18 /* Combined binary operators [i.e: =,'.=','+=',*=' ...] precedence */ ){` |
|  274973 | 10674 | `			iFlags \|= EXPR_FLAG_LOAD_IDX_STORE;` |
|  137484 | 10675 | `		}` |
|  677213 | 10676 | `		nRhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  677213 | 10677 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pRight,iFlags);` |
|  677213 | 10678 | `		if( !bIsChainOp ){` |
|       - | 10679 | `			/* Non-chain parent: RHS nullsafe chain ends here, before the` |
|       - | 10680 | `			 * operator instruction is emitted. */` |
|  497793 | 10681 | `			GenStatePatchNullsafeJumps(pGen, nRhsNsBase);` |
|  248894 | 10682 | `		}` |
|  677213 | 10683 | `		if( iVmOp == PH7_OP_STORE ){` |
|  271435 | 10684 | `			if( pNode->pRight && (pNode->pRight->xCode == PH7_CompileList \|\|` |
|  271406 | 10685 | `				pNode->pRight->xCode == PH7_CompileShortList) ){` |
...
|       - | 10691 | `				 */` |
|      56 | 10692 | `				iVmOp = 0;` |
|  271409 | 10693 | `			}else if( (pInstr = PH7_VmPeekInstr(pGen->pVm)) != 0 ){` |
|  271383 | 10694 | `				if(pInstr->iOp == PH7_OP_MEMBER ){` |
|       - | 10695 | `					/* Perform a member store operation [i.e: $this->x = 50] */` |
|   75831 | 10696 | `					iP2 = 1;` |
|   37918 | 10697 | `				}else{` |
|  195557 | 10698 | `					if( pInstr->iOp == PH7_OP_LOAD_IDX ){` |
|       - | 10699 | `						/* Transform the STORE instruction to STORE_IDX instruction */` |
|   33217 | 10700 | `						iVmOp = PH7_OP_STORE_IDX;` |
|   33217 | 10701 | `						iP1 = pInstr->iP1;` |
|   16611 | 10702 | `					}else{` |
|  162345 | 10703 | `						p3 = pInstr->p3;` |
|       - | 10704 | `					}` |
|       - | 10705 | `					/* POP the last dynamic load instruction */` |
|  195557 | 10706 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|       - | 10707 | `				}` |
|  135694 | 10708 | `			}` |
|  541498 | 10709 | `		}else if( iVmOp == PH7_OP_STORE_REF ){` |
...
|      25 | 10724 | `		}` |
|  338604 | 10725 | `	}` |
| 1226279 | 10726 | `	if( iVmOp > 0 ){` |
| 1226073 | 10727 | `		if( iVmOp == PH7_OP_INCR \|\| iVmOp == PH7_OP_DECR ){` |
|   13513 | 10728 | `			if( pNode->iFlags & EXPR_NODE_PRE_INCR ){` |
|       - | 10729 | `				/* Pre-increment/decrement operator [i.e: ++$i,--$j ] */` |
|    9865 | 10730 | `				iP1 = 1;` |
|    4935 | 10731 | `			}` |
| 1219319 | 10732 | `		}else if( iVmOp == PH7_OP_NEW ){` |
|       - | 10733 | `			/* Namespace-qualify the class name for NEW */ {` |
|   17575 | 10734 | `				VmInstr *pPeek = PH7_VmPeekInstr(pGen->pVm);` |
|   17575 | 10735 | `				VmInstr *pCallInstr = 0;` |
|   17575 | 10736 | `				if( pPeek && pPeek->iOp == PH7_OP_CALL ){` |
|   17537 | 10737 | `					pCallInstr = pPeek;` |
|   17537 | 10738 | `					pPeek = PH7_VmPeekNextInstr(pGen->pVm);` |
|    8766 | 10739 | `				}` |
|   17575 | 10740 | `				if( pPeek && pPeek->iOp == PH7_OP_LOADC ){` |
|   17573 | 10741 | `					int bAbsolute = (pPeek->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
...
|   17573 | 10746 | `					if( pCallInstr && pCallInstr->iP2 > 0 ){` |
|      37 | 10747 | `						nLitForClass = (sxu32)(pCallInstr->iP2 - 1); /* undo +1 encoding */` |
|      21 | 10748 | `					}else{` |
|   17541 | 10749 | `						nLitForClass = (sxu32)pPeek->iP2;` |
|       - | 10750 | `					}` |
|   17573 | 10751 | `					pPeek->iP1 = 0;` |
|   17573 | 10752 | `					if( !bAbsolute ){` |
|   17557 | 10753 | `						pPeek->iP2 = (sxi32)GenStateNsQualifyName(pGen,nLitForClass,&pGen->hUseImports,0);` |
|    8781 | 10754 | `					}else{` |
|      20 | 10755 | `						pPeek->iP2 = (sxi32)nLitForClass;` |
|       - | 10756 | `					}` |
|    8784 | 10757 | `				}` |
|       - | 10758 | `			}` |
|   17575 | 10759 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|   17575 | 10760 | `			if( pInstr && pInstr->iOp == PH7_OP_CALL ){` |
|       - | 10761 | `				VmInstr *pPrev;` |
|   17537 | 10762 | `				pPrev = PH7_VmPeekNextInstr(pGen->pVm);` |
|   17537 | 10763 | `				if( pPrev == 0 \|\| pPrev->iOp != PH7_OP_MEMBER ){` |
|       - | 10764 | `					/* Pop the call instruction, preserve named-arg map */` |
|   17537 | 10765 | `					iP1 = pInstr->iP1;` |
|   17537 | 10766 | `					if( pInstr->p3 ){` |
|      43 | 10767 | `						p3 = pInstr->p3; /* Transfer VmCallArgMap to NEW */` |
|      19 | 10768 | `					}` |
|   17537 | 10769 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|    8766 | 10770 | `				}` |
|    8771 | 10771 | `			}` |
| 1203780 | 10772 | `		}else if( iVmOp == PH7_OP_IS_A ){` |
...
|     152 | 10783 | `					if( (n == 4 && SyMemcmp(z,"self",4) == 0) \|\|` |
|     157 | 10784 | `						(n == 6 && SyMemcmp(z,"static",6) == 0) \|\|` |
...
|      68 | 10792 | `				}` |
|      82 | 10793 | `			}` |
| 1194920 | 10794 | `		}else if( iVmOp == PH7_OP_MEMBER){` |
...
|  179425 | 10798 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|  179425 | 10799 | `			if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|  179383 | 10800 | `				pInstr->iP1 = 0;` |
|   89689 | 10801 | `			}` |
|  179425 | 10802 | `			if( pNode->pOp->iOp == EXPR_OP_DC /* '::' */){` |
...
| 1226071 | 10814 | `		if( iVmOp == PH7_OP_CALL \|\| iVmOp == PH7_OP_NEW ){` |
|  406951 | 10815 | `			p3 = GenStateAttachStrictFlag(pGen,p3);` |
|  203473 | 10816 | `		}` |
|       - | 10817 | `		/* Finally,emit the VM instruction associated with this operator */` |
| 1226071 | 10818 | `		PH7_VmEmitInstr(pGen->pVm,iVmOp,iP1,iP2,p3,0);` |
|  613033 | 10819 | `	}` |
| 1226277 | 10820 | `	if( nJmpIdx > 0 ){` |
|       - | 10821 | `		/* Fix short-circuited jumps now the destination is resolved */` |
|   13885 | 10822 | `		pInstr = PH7_VmGetInstr(pGen->pVm,nJmpIdx);` |
|   13885 | 10823 | `		if( pInstr ){` |
|   13885 | 10824 | `			pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    6940 | 10825 | `		}` |
|    6940 | 10826 | `	}` |
| 1226277 | 10827 | `	return rc;` |
| 1614382 | 10828 |  |
|       - | 10829 | `/*` |
...
|       - | 10838 | ` * message.` |
|       - | 10839 | ` */` |
|  868140 | 10840 | `static sxi32 PH7_CompileExpr(` |
...
|  868145 | 10854 | `	nExpr = 0;` |
|  868145 | 10855 | `	pRoot = 0;` |
...
|  868145 | 10858 | `	nNullsafeBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  868145 | 10859 | `	SySetInit(&sExprNode,&pGen->pVm->sAllocator,sizeof(ph7_expr_node *));` |
|  868145 | 10860 | `	SySetAlloc(&sExprNode,0x10);` |
|  868145 | 10861 | `	rc = SXRET_OK;` |
|       - | 10862 | `	/* Delimit the expression */` |
|  868145 | 10863 | `	pEnd = pGen->pIn;` |
|  868145 | 10864 | `	iNest = 0;` |
| 5809935 | 10865 | `	while( pEnd < pGen->pEnd ){` |
| 5514327 | 10866 | `		if( pEnd->nType & PH7_TK_OCB /* '{' */ ){` |
|       - | 10867 | `			/* Ticket 1433-30: Annonymous/Closure functions body */` |
|     411 | 10868 | `			iNest++;` |
| 5514124 | 10869 | `		}else if(pEnd->nType & PH7_TK_CCB /* '}' */ ){` |
|     419 | 10870 | `			iNest--;` |
| 5513714 | 10871 | `		}else if( pEnd->nType & PH7_TK_SEMI /* ';' */ ){` |
|  572835 | 10872 | `			if( iNest <= 0 ){` |
|  572537 | 10873 | `				break;` |
|       - | 10874 | `			}` |
|     149 | 10875 | `		}` |
| 4941795 | 10876 | `		pEnd++;` |
|       5 | 10877 | `	}` |
|  868145 | 10878 | `	if( iFlags & EXPR_FLAG_COMMA_STATEMENT ){` |
|   20157 | 10879 | `		SyToken *pEnd2 = pGen->pIn;` |
|   20157 | 10880 | `		iNest = 0;` |
|       - | 10881 | `		/* Stop at the first comma */` |
|   40585 | 10882 | `		while( pEnd2 < pEnd ){` |
|   20439 | 10883 | `			if( pEnd2->nType & (PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*'['*/\|PH7_TK_LPAREN/*'('*/) ){` |
|      61 | 10884 | `				iNest++;` |
|   20411 | 10885 | `			}else if(pEnd2->nType & (PH7_TK_CCB/*'}'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_RPAREN/*')'*/)){` |
|      61 | 10886 | `				iNest--;` |
|   20355 | 10887 | `			}else if( pEnd2->nType & PH7_TK_COMMA /*','*/ ){` |
|      53 | 10888 | `				if( iNest <= 0 ){` |
|       7 | 10889 | `					break;` |
|       - | 10890 | `				}` |
|      21 | 10891 | `			}` |
|   20433 | 10892 | `			pEnd2++;` |
|       5 | 10893 | `		}` |
|   20157 | 10894 | `		if( pEnd2 <pEnd ){` |
|       7 | 10895 | `			pEnd = pEnd2;` |
|       3 | 10896 | `		}` |
|   10076 | 10897 | `	}` |
|  868145 | 10898 | `	if( pEnd > pGen->pIn ){` |
|  868135 | 10899 | `		SyToken *pTmp = pGen->pEnd;` |
|       - | 10900 | `		/* Swap delimiter */` |
|  868135 | 10901 | `		pGen->pEnd = pEnd;` |
|       - | 10902 | `		/* Try to get an expression tree */` |
|  868135 | 10903 | `		rc = PH7_ExprMakeTree(&(*pGen),&sExprNode,&pRoot);` |
|  868135 | 10904 | `		if( rc == SXRET_OK && pRoot ){` |
|  867953 | 10905 | `			rc = SXRET_OK;` |
|  867953 | 10906 | `			if( xTreeValidator ){` |
|       - | 10907 | `				/* Call the upper layer validator callback */` |
|   24057 | 10908 | `				rc = xTreeValidator(&(*pGen),pRoot);` |
|   12026 | 10909 | `			}` |
|  867953 | 10910 | `			if( rc != SXERR_ABORT ){` |
|       - | 10911 | `				/* Generate code for the given tree */` |
|  867953 | 10912 | `				rc = GenStateEmitExprCode(&(*pGen),pRoot,iFlags);` |
|       - | 10913 | `				/* Patch any unresolved nullsafe jumps emitted by this` |
|       - | 10914 | `				 * expression so they short-circuit to its end. */` |
|  867953 | 10915 | `				GenStatePatchNullsafeJumps(pGen, nNullsafeBase);` |
|  433974 | 10916 | `			}` |
|  867953 | 10917 | `			nExpr = 1;` |
|  433974 | 10918 | `		}` |
|       - | 10919 | `		/* Release the whole tree */` |
|  868135 | 10920 | `		PH7_ExprFreeTree(&(*pGen),&sExprNode);` |
|       - | 10921 | `		/* Synchronize token stream */` |
|  868135 | 10922 | `		pGen->pEnd = pTmp;` |
|  868135 | 10923 | `		pGen->pIn  = pEnd;` |
|  868135 | 10924 | `		if( rc == SXERR_ABORT ){` |
|      14 | 10925 | `			SySetRelease(&sExprNode);` |
|      14 | 10926 | `			return SXERR_ABORT;` |
|       - | 10927 | `		}` |
|  434060 | 10928 | `	}` |
|  868135 | 10929 | `	SySetRelease(&sExprNode);` |
|  868135 | 10930 | `	return nExpr > 0 ? SXRET_OK : SXERR_EMPTY;` |
|  434075 | 10931 |  |
|       - | 10932 | `/*` |
|       - | 10933 | ` * Return a pointer to the node construct handler associated` |
|       - | 10934 | ` * with a given node type [i.e: string,integer,float,...].` |
|       - | 10935 | ` */` |
|  220190 | 10936 | `PH7_PRIVATE ProcNodeConstruct PH7_GetNodeHandler(sxu32 nNodeType)` |
|       5 | 10937 |  |
|  220195 | 10938 | `	if( nNodeType & PH7_TK_NUM ){` |
|       - | 10939 | `		/* Numeric literal: Either real or integer */` |
|  115905 | 10940 | `		return PH7_CompileNumLiteral;` |
|  104295 | 10941 | `	}else if( nNodeType & PH7_TK_DSTR ){` |
|       - | 10942 | `		/* Double quoted string */` |
|   20983 | 10943 | `		return PH7_CompileString;` |
|   83317 | 10944 | `	}else if( nNodeType & PH7_TK_SSTR ){` |
|       - | 10945 | `		/* Single quoted string */` |
|   83201 | 10946 | `		return PH7_CompileSimpleString;` |
...
|       - | 10963 | ` */` |
|    6776 | 10964 | `static sxi32 GenStateUnsetValidator(ph7_gen_state *pGen, ph7_expr_node *pNode)` |
|       5 | 10965 |  |
|       - | 10966 | `	sxi32 rc;` |
|    6781 | 10967 | `	if( !PH7_ExprContainsNullsafe(pNode) ){` |
|    6779 | 10968 | `		return SXRET_OK;` |
|       - | 10969 | `	}` |
...
|    9695 | 11012 | `	while( SXRET_OK == PH7_GetNextExpr(pGen->pIn,pEnd,&pNext) ){` |
|    6783 | 11013 | `		if( pGen->pIn < pNext ){` |
|    6783 | 11014 | `			pGen->pEnd = pNext;` |
|    6783 | 11015 | `			rc = PH7_CompileExpr(&(*pGen),` |
|       - | 11016 | `				EXPR_FLAG_RDONLY_LOAD\|EXPR_FLAG_LOAD_IDX_UNSET,` |
|       - | 11017 | `				GenStateUnsetValidator);` |
|    6783 | 11018 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 | 11019 | `				return SXERR_ABORT;` |
|       - | 11020 | `			}` |
|    6783 | 11021 | `			if( rc != SXERR_EMPTY ){` |
|       - | 11022 | `				/* Emit call for this single argument */` |
|    6781 | 11023 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|    6781 | 11024 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_CALL,1,0,GenStateAttachStrictFlag(pGen,0),0);` |
|    6781 | 11025 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|    3388 | 11026 | `			}` |
|    3389 | 11027 | `		}` |
|       - | 11028 | `		/* Jump trailing commas */` |
|   10651 | 11029 | `		while( pNext < pEnd && (pNext->nType & PH7_TK_COMMA) ){` |
|    3873 | 11030 | `			pNext++;` |
|       5 | 11031 | `		}` |
|    6783 | 11032 | `		pGen->pIn = pNext;` |
|       5 | 11033 | `	}` |
...
|       - | 11074 | ` */` |
|  585686 | 11075 | `static ProcLangConstruct GenStateGetStatementHandler(` |
|       - | 11076 | `	sxu32 nKeywordID,   /* Keyword  ID*/` |
|       - | 11077 | `	SyToken *pLookahed  /* Look-ahead token */` |
|       - | 11078 | `	)` |
|       5 | 11079 |  |
|  585691 | 11080 | `	sxu32 n = 0;` |
| 3024285 | 11081 | `	for(;;){` |
| 6048575 | 11082 | `		if( n >= SX_ARRAYSIZE(aLangConstruct) ){` |
|  125923 | 11083 | `			break;` |
|       - | 11084 | `		}` |
| 5922657 | 11085 | `		if( aLangConstruct[n].nID == nKeywordID ){` |
|  459773 | 11086 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed && (pLookahed->nType & PH7_TK_OP)){` |
...
|       - | 11091 | `				}` |
|     ! 0 | 11092 | `			}` |
|  459768 | 11093 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed` |
...
|       - | 11100 | `			*/` |
|  459773 | 11101 | `			return aLangConstruct[n].xConstruct;` |
|       - | 11102 | `		}` |
| 5462889 | 11103 | `		n++;` |
|       5 | 11104 | `	}` |
|  125923 | 11105 | `	if( pLookahed ){` |
|  125923 | 11106 | `		if(nKeywordID == PH7_TKWRD_INTERFACE && (pLookahed->nType & PH7_TK_ID) ){` |
|   36133 | 11107 | `			return PH7_CompileClassInterface;` |
|   89795 | 11108 | `		}else if(nKeywordID == PH7_TKWRD_CLASS && (pLookahed->nType & PH7_TK_ID) ){` |
|   89549 | 11109 | `			return PH7_CompileClass;` |
...
|       - | 11147 | ` */` |
|  701642 | 11148 | `static sxi32 GenStateCompileChunk(` |
...
|       - | 11154 | `	sxi32 rc;` |
|  701647 | 11155 | `	rc = SXRET_OK; /* Prevent compiler warning */` |
|  546659 | 11156 | `	for(;;){` |
|  897485 | 11157 | `		int bStmtIsDeclare = 0;` |
|  897485 | 11158 | `		if( pGen->pIn >= pGen->pEnd ){` |
...
|  883891 | 11164 | `		if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|  585717 | 11165 | `			sxu32 nPeek = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  585717 | 11166 | `			if( nPeek == PH7_TKWRD_DECLARE ){` |
|      45 | 11167 | `				bStmtIsDeclare = 1;` |
|      20 | 11168 | `			}` |
|  292856 | 11169 | `		}` |
|  883891 | 11170 | `		if( !bStmtIsDeclare && pGen->pCurrent == &pGen->sGlobal ){` |
...
|  195813 | 11173 | `			pGen->bStrictTypesLocked = 1;` |
|   97904 | 11174 | `		}` |
|  883891 | 11175 | `		if( pGen->pIn->nType & PH7_TK_OCB /* '{' */ ){` |
|       - | 11176 | `			/* Compile block */` |
...
|       - | 11180 | `			}` |
|      13 | 11181 | `		}else{` |
|  883875 | 11182 | `			xCons = 0;` |
|  883875 | 11183 | `			if( GenStateStartsModifiedClass(pGen->pIn,pGen->pEnd) ){` |
...
|  883849 | 11188 | `			}else if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|  585691 | 11189 | `				sxu32 nKeyword = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|       - | 11190 | `				/* Try to extract a language construct handler */` |
|  585691 | 11191 | `				xCons = GenStateGetStatementHandler(nKeyword,(&pGen->pIn[1] < pGen->pEnd) ? &pGen->pIn[1] : 0);` |
|  585691 | 11192 | `				if( xCons == 0 && GenStateisLangConstruct(nKeyword) == FALSE ){` |
...
|       4 | 11203 | `				}` |
|  590980 | 11204 | `			}else if( (pGen->pIn->nType & PH7_TK_ID) && (&pGen->pIn[1] < pGen->pEnd)` |
|   48795 | 11205 | `				&& (pGen->pIn[1].nType & PH7_TK_COLON /*':'*/) ){` |
|       - | 11206 | `				/* Label found [i.e: Out: ],point to the routine responsible of compiling it */` |
|     117 | 11207 | `				xCons = PH7_CompileLabel;` |
|      56 | 11208 | `			}` |
|  883875 | 11209 | `			if( xCons == 0 ){` |
|       - | 11210 | `				/* Assume an expression an try to compile it */` |
|  298207 | 11211 | `				rc = PH7_CompileExpr(&(*pGen),0,0);` |
|  298207 | 11212 | `				if(  rc != SXERR_EMPTY ){` |
|       - | 11213 | `					/* Pop l-value */` |
|  298057 | 11214 | `					PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|  149026 | 11215 | `				}` |
|  149106 | 11216 | `			}else{` |
|       - | 11217 | `				/* Go compile the sucker */` |
|  585673 | 11218 | `				rc = xCons(&(*pGen));` |
|       - | 11219 | `			}` |
|  883875 | 11220 | `			if( rc == SXERR_ABORT ){` |
|       - | 11221 | `				/* Request to abort compilation */` |
|      14 | 11222 | `				break;` |
|       - | 11223 | `			}` |
|       - | 11224 | `		}` |
|       - | 11225 | `		/* Ignore trailing semi-colons ';' */` |
| 1430115 | 11226 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|  546239 | 11227 | `			pGen->pIn++;` |
|       5 | 11228 | `		}` |
|  883881 | 11229 | `		if( iFlags & PH7_COMPILE_SINGLE_STMT ){` |
...
|       - | 11245 | ` */` |
|   13606 | 11246 | `static sxi32 PH7_CompilePHP(` |
...
|       - | 11250 | `	)` |
|       5 | 11251 |  |
|   13611 | 11252 | `	SyToken *pScript = pGen->pRawIn; /* Script to compile */` |
|       - | 11253 | `	sxi32 rc;` |
|       - | 11254 | `	/* Reset the token set */` |
|   13611 | 11255 | `	SySetReset(&(*pTokenSet));` |
|       - | 11256 | `	/* Mark as the default token set */` |
|   13611 | 11257 | `	pGen->pTokenSet = &(*pTokenSet);` |
|       - | 11258 | `	/* Advance the stream cursor */` |
|   13611 | 11259 | `	pGen->pRawIn++;` |
|       - | 11260 | `	/* Tokenize the PHP chunk first */` |
|   13611 | 11261 | `	PH7_TokenizePHP(SyStringData(&pScript->sData),SyStringLength(&pScript->sData),pScript->nLine,&(*pTokenSet));` |
|       - | 11262 | `	/* Point to the head and tail of the token stream. */` |
|   13611 | 11263 | `	pGen->pIn  = (SyToken *)SySetBasePtr(pTokenSet);` |
|   13611 | 11264 | `	pGen->pEnd = &pGen->pIn[SySetUsed(pTokenSet)];` |
|   13611 | 11265 | `	if( is_expr ){` |
...
|       - | 11274 | `	}` |
|   13611 | 11275 | `	if( pGen->pIn < pGen->pEnd && ( pGen->pIn->nType & PH7_TK_EQUAL ) ){` |
...
|   13609 | 11300 | `	rc = GenStateCompileChunk(pGen,0);` |
|       - | 11301 | `	/* Fix exceptions jumps */` |
|   13609 | 11302 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|       - | 11303 | `	/* Fix gotos now, the jump destination is resolved */` |
|   13609 | 11304 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),0) ){` |
|       3 | 11305 | `		rc = SXERR_ABORT;` |
|       1 | 11306 | `	}` |
|       - | 11307 | `	/* Reset container */` |
|   13609 | 11308 | `	SySetReset(&pGen->aGoto);` |
|   13609 | 11309 | `	SySetReset(&pGen->aLabel);` |
|   13609 | 11310 | `	SySetReset(&pGen->aNullsafeJmp);` |
|       - | 11311 | `	/* Compilation result */` |
|   13609 | 11312 | `	return rc;` |
|    6808 | 11313 |  |
|       - | 11314 | `/*` |
...
|       - | 11318 | ` */` |
|   16364 | 11319 | `PH7_PRIVATE sxi32 PH7_CompileScript(` |
...
|       - | 11333 | `	sxi32 rc;` |
|   16369 | 11334 | `	if( pScript->nByte < 1 ){` |
...
|   16369 | 11340 | `	pCodeGen = &pVm->sCodeGen;` |
|   16369 | 11341 | `	bSavedStrict = pCodeGen->bStrictTypes;` |
|   16369 | 11342 | `	bSavedStrictLocked = pCodeGen->bStrictTypesLocked;` |
|   16369 | 11343 | `	pCodeGen->bStrictTypes = 0;` |
|   16369 | 11344 | `	pCodeGen->bStrictTypesLocked = 0;` |
|       - | 11345 | `	/* Initialize the tokens containers */` |
|   16369 | 11346 | `	SySetInit(&aRawToken,&pVm->sAllocator,sizeof(SyToken));` |
|   16369 | 11347 | `	SySetInit(&aPhpToken,&pVm->sAllocator,sizeof(SyToken));` |
|   16369 | 11348 | `	SySetAlloc(&aPhpToken,0xc0);` |
|   16369 | 11349 | `	is_expr = 0;` |
|   16369 | 11350 | `	if( iFlags & PH7_PHP_ONLY ){` |
|       - | 11351 | `		SyToken sTmp;` |
|       - | 11352 | `		/* PHP only: -*/` |
|    3351 | 11353 | `		sTmp.nLine = 1;` |
|    3351 | 11354 | `		sTmp.nType = PH7_TOKEN_PHP;` |
|    3351 | 11355 | `		sTmp.pUserData = 0;` |
|    3351 | 11356 | `		SyStringDupPtr(&sTmp.sData,pScript);` |
|    3351 | 11357 | `		SySetPut(&aRawToken,(const void *)&sTmp);` |
|    3351 | 11358 | `		if( iFlags & PH7_PHP_EXPR ){` |
|       - | 11359 | `			/* A simple PHP expression */` |
|     ! 0 | 11360 | `			is_expr = 1;` |
|     ! 0 | 11361 | `		}` |
|    1678 | 11362 | `	}else{` |
|       - | 11363 | `		/* Tokenize raw text */` |
|   13023 | 11364 | `		SySetAlloc(&aRawToken,32);` |
|   13023 | 11365 | `		PH7_TokenizeRawText(pScript->zString,pScript->nByte,&aRawToken);` |
|       - | 11366 | `	}` |
|       - | 11367 | `	/* Process high-level tokens */` |
|   16369 | 11368 | `	pCodeGen->pRawIn = (SyToken *)SySetBasePtr(&aRawToken);` |
|   16369 | 11369 | `	pCodeGen->pRawEnd = &pCodeGen->pRawIn[SySetUsed(&aRawToken)];` |
|   16369 | 11370 | `	rc = PH7_OK;` |
|   16369 | 11371 | `	if( is_expr ){` |
|       - | 11372 | `		/* Compile the expression */` |
|     ! 0 | 11373 | `		rc = PH7_CompilePHP(pCodeGen,&aPhpToken,TRUE);` |
|     ! 0 | 11374 | `		goto cleanup;` |
|       - | 11375 | `	}` |
|   16369 | 11376 | `	nObjIdx = 0;` |
...
|   16369 | 11380 | `	PH7_VmEmitInstr(pVm,PH7_OP_NSSWITCH,0,0,0,0);` |
|       - | 11381 | `	/* Start the compilation process */` |
|   14697 | 11382 | `	for(;;){` |
|   42993 | 11383 | `		if( pCodeGen->pRawIn >= pCodeGen->pRawEnd ){` |
|   16357 | 11384 | `			break; /* No more tokens to process */` |
|       - | 11385 | `		}` |
|   26641 | 11386 | `		if( pCodeGen->pRawIn->nType & PH7_TOKEN_PHP ){` |
|       - | 11387 | `			/* Compile the PHP chunk */` |
|   13611 | 11388 | `			rc = PH7_CompilePHP(pCodeGen,&aPhpToken,FALSE);` |
|   13611 | 11389 | `			if( rc == SXERR_ABORT ){` |
|      16 | 11390 | `				break;` |
|       - | 11391 | `			}` |
|   13599 | 11392 | `			continue;` |
|       - | 11393 | `		}` |
|       - | 11394 | `		/* Raw chunk: [i.e: HTML, XML, etc.] */` |
|   13035 | 11395 | `		nRawObj = 0;` |
|   26107 | 11396 | `		while( (pCodeGen->pRawIn < pCodeGen->pRawEnd) && (pCodeGen->pRawIn->nType != PH7_TOKEN_PHP) ){` |
|       - | 11397 | `			/* Consume the raw chunk without any processing */` |
|   13077 | 11398 | `			pRawObj = PH7_ReserveConstObj(&(*pVm),&nObjIdx);` |
|   13077 | 11399 | `			if( pRawObj == 0 ){` |
|     ! 0 | 11400 | `				rc = SXERR_MEM;` |
|     ! 0 | 11401 | `				break;` |
|       - | 11402 | `			}` |
|       - | 11403 | `			/* Mark as constant and emit the load constant instruction */` |
|   13077 | 11404 | `			PH7_MemObjInitFromString(pVm,pRawObj,&pCodeGen->pRawIn->sData);` |
|   13077 | 11405 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_LOADC,0,nObjIdx,0,0);` |
|   13077 | 11406 | `			++nRawObj;` |
|   13077 | 11407 | `			pCodeGen->pRawIn++; /* Next chunk */` |
|       5 | 11408 | `		}` |
|   13035 | 11409 | `		if( nRawObj > 0 ){` |
|       - | 11410 | `			/* Emit the consume instruction */` |
|   13035 | 11411 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_CONSUME,nRawObj,0,0,0);` |
|    6515 | 11412 | `		}` |
|    8187 | 11413 | `	}` |
|    8182 | 11414 | `cleanup:` |
|   16369 | 11415 | `	SySetRelease(&aRawToken);` |
|   16369 | 11416 | `	SySetRelease(&aPhpToken);` |
|       - | 11417 | `	/* Restore outer file's strict_types scope */` |
|   16369 | 11418 | `	pCodeGen->bStrictTypes = bSavedStrict;` |
|   16369 | 11419 | `	pCodeGen->bStrictTypesLocked = bSavedStrictLocked;` |
|   16369 | 11420 | `	return rc;` |
|    8187 | 11421 |  |
|       - | 11422 | `/*` |
|       - | 11423 | ` * Utility routines.Initialize the code generator.` |
|       - | 11424 | ` */` |
|    3280 | 11425 | `PH7_PRIVATE sxi32 PH7_InitCodeGenerator(` |
|       - | 11426 | `	ph7_vm *pVm,       /* Target VM */` |
|       - | 11427 | `	ProcConsumer xErr, /* Error log consumer callabck  */` |
|       - | 11428 | `	void *pErrData     /* Last argument to xErr() */` |
|       - | 11429 | `	)` |
|       5 | 11430 |  |
|    3285 | 11431 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|       - | 11432 | `	/* Zero the structure */` |
|    3285 | 11433 | `	SyZero(pGen,sizeof(ph7_gen_state));` |
|       - | 11434 | `	/* Initial state */` |
|    3285 | 11435 | `	pGen->pVm  = &(*pVm);` |
|    3285 | 11436 | `	pGen->xErr = xErr;` |
|    3285 | 11437 | `	pGen->pErrData = pErrData;` |
|    3285 | 11438 | `	SySetInit(&pGen->aLabel,&pVm->sAllocator,sizeof(Label));` |
|    3285 | 11439 | `	SySetInit(&pGen->aGoto,&pVm->sAllocator,sizeof(JumpFixup));` |
|    3285 | 11440 | `	SySetInit(&pGen->aNullsafeJmp,&pVm->sAllocator,sizeof(sxu32));` |
|    3285 | 11441 | `	SyHashInit(&pGen->hLiteral,&pVm->sAllocator,0,0);` |
|    3285 | 11442 | `	SyHashInit(&pGen->hVar,&pVm->sAllocator,0,0);` |
|       - | 11443 | `	/* Error log buffer */` |
|    3285 | 11444 | `	SyBlobInit(&pGen->sErrBuf,&pVm->sAllocator);` |
|       - | 11445 | `	/* General purpose working buffer */` |
|    3285 | 11446 | `	SyBlobInit(&pGen->sWorker,&pVm->sAllocator);` |
|       - | 11447 | `	/* Namespace state */` |
|    3285 | 11448 | `	SyBlobInit(&pGen->sNamespace,&pVm->sAllocator);` |
|    3285 | 11449 | `	SyHashInit(&pGen->hUseImports,&pVm->sAllocator,0,0);` |
|    3285 | 11450 | `	SyHashInit(&pGen->hUseFuncImports,&pVm->sAllocator,0,0);` |
|    3285 | 11451 | `	SyHashInit(&pGen->hUseConstImports,&pVm->sAllocator,0,0);` |
|       - | 11452 | `	/* Create the global scope */` |
|    3285 | 11453 | `	GenStateInitBlock(pGen,&pGen->sGlobal,GEN_BLOCK_GLOBAL,PH7_VmInstrLength(&(*pVm)),0);` |
|       - | 11454 | `	/* Point to the global scope */` |
|    3285 | 11455 | `	pGen->pCurrent = &pGen->sGlobal;` |
|    3285 | 11456 | `	return SXRET_OK;` |
|       5 | 11457 |  |
|       - | 11458 | `/*` |
|       - | 11459 | ` * Utility routines. Reset the code generator to it's initial state.` |
|       - | 11460 | ` */` |
|   19304 | 11461 | `PH7_PRIVATE sxi32 PH7_ResetCodeGenerator(` |
|       - | 11462 | `	ph7_vm *pVm,       /* Target VM */` |
|       - | 11463 | `	ProcConsumer xErr, /* Error log consumer callabck  */` |
|       - | 11464 | `	void *pErrData     /* Last argument to xErr() */` |
|       - | 11465 | `	)` |
|       5 | 11466 |  |
|   19309 | 11467 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|       - | 11468 | `	GenBlock *pBlock,*pParent;` |
|       - | 11469 | `	/* Reset state */` |
|   19309 | 11470 | `	SySetReset(&pGen->aLabel);` |
|   19309 | 11471 | `	SySetReset(&pGen->aGoto);` |
|   19309 | 11472 | `	SySetReset(&pGen->aNullsafeJmp);` |
|   19309 | 11473 | `	SyBlobRelease(&pGen->sErrBuf);` |
|   19309 | 11474 | `	SyBlobRelease(&pGen->sWorker);` |
|   19309 | 11475 | `	SyBlobRelease(&pGen->sNamespace);` |
|   19309 | 11476 | `	SyBlobInit(&pGen->sNamespace,&pVm->sAllocator);` |
|   19309 | 11477 | `	SyHashRelease(&pGen->hUseImports);` |
|   19309 | 11478 | `	SyHashInit(&pGen->hUseImports,&pVm->sAllocator,0,0);` |
|   19309 | 11479 | `	SyHashRelease(&pGen->hUseFuncImports);` |
|   19309 | 11480 | `	SyHashInit(&pGen->hUseFuncImports,&pVm->sAllocator,0,0);` |
|   19309 | 11481 | `	SyHashRelease(&pGen->hUseConstImports);` |
|   19309 | 11482 | `	SyHashInit(&pGen->hUseConstImports,&pVm->sAllocator,0,0);` |
...
|   19309 | 11490 | `	pBlock = pGen->pCurrent;` |
|   19309 | 11491 | `	while( pBlock->pParent != 0 ){` |
|     ! 0 | 11492 | `		pParent = pBlock->pParent;` |
|     ! 0 | 11493 | `		GenStateFreeBlock(pBlock);` |
|     ! 0 | 11494 | `		pBlock = pParent;` |
|     ! 0 | 11495 | `	}` |
|   19309 | 11496 | `	pGen->xErr = xErr;` |
|   19309 | 11497 | `	pGen->pErrData = pErrData;` |
|   19309 | 11498 | `	pGen->pCurrent = &pGen->sGlobal;` |
|   19309 | 11499 | `	pGen->pRawIn = pGen->pRawEnd = 0;` |
|   19309 | 11500 | `	pGen->pIn = pGen->pEnd = 0;` |
|   19309 | 11501 | `	pGen->nErr = 0;` |
|   19309 | 11502 | `	return SXRET_OK;` |
|       5 | 11503 |  |
|       - | 11504 | `/*` |
