...
|         - |   138 | ` */` |
|    153220 |   139 | `static GenBlock * GenStateFetchBlock(GenBlock *pCurrent,sxi32 iBlockType,sxi32 iCount)` |
|         5 |   140 | `{` |
|    153225 |   141 | `	GenBlock *pBlock = pCurrent;` |
|    344559 |   142 | `	for(;;){` |
|    689123 |   143 | `		if( pBlock->iFlags & iBlockType ){` |
|    153225 |   144 | `			iCount--; /* Decrement nesting level */` |
|    153225 |   145 | `			if( iCount < 1 ){` |
|         - |   146 | `				/* Block meet with the desired criteria */` |
|    153199 |   147 | `				return pBlock;` |
|         - |   148 | `			}` |
|        13 |   149 | `		}` |
|         - |   150 | `		/* Point to the upper block */` |
|    535929 |   151 | `		pBlock = pBlock->pParent;` |
|    535929 |   152 | `		if( pBlock == 0 \|\| (pBlock->iFlags & (GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC)) ){` |
|         - |   153 | `			/* Forbidden */` |
|        17 |   154 | `			break;` |
|         - |   155 | `		}` |
|         5 |   156 | `	}` |
...
|         - |   162 | ` */` |
|  12012318 |   163 | `static void GenStateInitBlock(` |
...
|  12012323 |   172 | `	pBlock->nFirstInstr = nFirstInstr;` |
|  12012323 |   173 | `	pBlock->pUserData   = pUserData;` |
|  12012323 |   174 | `	pBlock->pGen        = pGen;` |
|  12012323 |   175 | `	pBlock->iFlags      = iType;` |
|  12012323 |   176 | `	pBlock->pParent     = 0;` |
|  12012323 |   177 | `	SySetInit(&pBlock->aJumpFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  12012323 |   178 | `	SySetInit(&pBlock->aPostContFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  12012323 |   179 | `}` |
|         - |   180 | `/*` |
...
|         - |   185 | ` */` |
|  12008488 |   186 | `static sxi32 GenStateEnterBlock(` |
...
|  12008493 |   196 | `	pBlock = (GenBlock *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(GenBlock));` |
|  12008493 |   197 | `	if( pBlock == 0 ){` |
...
|  12008493 |   206 | `	SyZero(pBlock,sizeof(GenBlock));` |
|  12008493 |   207 | `	GenStateInitBlock(&(*pGen),pBlock,iType,nFirstInstr,pUserData);` |
|         - |   208 | `	/* Link to the parent block */` |
|  12008493 |   209 | `	pBlock->pParent = pGen->pCurrent;` |
...
|  12008493 |   212 | `	if( iType & (GEN_BLOCK_LOOP\|GEN_BLOCK_SWITCH) ){` |
|    509965 |   213 | `		sxu32 nParent = pGen->nCurLoopId;` |
|    509965 |   214 | `		pGen->nLoopId++;` |
|    509965 |   215 | `		SySetPut(&pGen->aLoopParent,(const void *)&nParent);` |
|    509965 |   216 | `		pBlock->nLoopId = pGen->nLoopId;` |
|    509965 |   217 | `		pBlock->nOuterLoopId = nParent;` |
|    509965 |   218 | `		pGen->nCurLoopId = pGen->nLoopId;` |
|    254980 |   219 | `	}` |
|         - |   220 | `	/* Mark as the current block */` |
|  12008493 |   221 | `	pGen->pCurrent = pBlock;` |
|  12008493 |   222 | `	if( ppBlock ){` |
|         - |   223 | `		/* Write a pointer to the new instance */` |
|   5758039 |   224 | `		*ppBlock = pBlock;` |
|   2879017 |   225 | `	}` |
|  12008493 |   226 | `	return SXRET_OK;` |
|   6004249 |   227 | `}` |
|         - |   228 | `/*` |
|         - |   229 | ` * Release block fields without freeing the whole instance.` |
|         - |   230 | ` */` |
|  12008476 |   231 | `static void GenStateReleaseBlock(GenBlock *pBlock)` |
|         5 |   232 | `{` |
|  12008481 |   233 | `	SySetRelease(&pBlock->aPostContFix);` |
|  12008481 |   234 | `	SySetRelease(&pBlock->aJumpFix);` |
|  12008481 |   235 | `}` |
|         - |   236 | `/*` |
|         - |   237 | ` * Release a block.` |
|         - |   238 | ` */` |
|  12008472 |   239 | `static void GenStateFreeBlock(GenBlock *pBlock)` |
|         5 |   240 | `{` |
|  12008477 |   241 | `	ph7_gen_state *pGen = pBlock->pGen;` |
|  12008477 |   242 | `	GenStateReleaseBlock(&(*pBlock));` |
|         - |   243 | `	/* Free the instance */` |
|  12008477 |   244 | `	SyMemBackendPoolFree(&pGen->pVm->sAllocator,pBlock);` |
|  12008477 |   245 | `}` |
|         - |   246 | `/*` |
|         - |   247 | ` * POP and release a block from the stack of compiled blocks.` |
|         - |   248 | ` */` |
|  12008472 |   249 | `static sxi32 GenStateLeaveBlock(ph7_gen_state *pGen,GenBlock **ppBlock)` |
|         5 |   250 | `{` |
|  12008477 |   251 | `	GenBlock *pBlock = pGen->pCurrent;` |
|  12008477 |   252 | `	if( pBlock == 0 ){` |
|         - |   253 | `		/* No more block to pop */` |
|       ! 0 |   254 | `		return SXERR_EMPTY;` |
|         - |   255 | `	}` |
|  12008477 |   256 | `	if( pBlock->iFlags & (GEN_BLOCK_LOOP\|GEN_BLOCK_SWITCH) ){` |
|    509957 |   257 | `		pGen->nCurLoopId = pBlock->nOuterLoopId;` |
|    254976 |   258 | `	}` |
|         - |   259 | `	/* Point to the upper block */` |
|  12008477 |   260 | `	pGen->pCurrent = pBlock->pParent;` |
|  12008477 |   261 | `	if( ppBlock ){` |
|         - |   262 | `		/* Write a pointer to the popped block */` |
|       ! 0 |   263 | `		*ppBlock = pBlock;` |
|       ! 0 |   264 | `	}else{` |
|         - |   265 | `		/* Safely release the block */` |
|  12008477 |   266 | `		GenStateFreeBlock(&(*pBlock));` |
|         - |   267 | `	}` |
|  12008477 |   268 | `	return SXRET_OK;` |
|   6004241 |   269 | `}` |
|         - |   270 | `/*` |
...
|         - |   279 | ` */` |
|   4437184 |   280 | `static sxi32 GenStateNewJumpFixup(GenBlock *pBlock,sxi32 nJumpType,sxu32 nInstrIdx)` |
|         5 |   281 | `{` |
|         - |   282 | `	JumpFixup sJumpFix;` |
|         - |   283 | `	sxi32 rc;` |
|         - |   284 | `	/* Init the JumpFixup structure */` |
|   4437189 |   285 | `	sJumpFix.nJumpType = nJumpType;` |
|   4437189 |   286 | `	sJumpFix.nInstrIdx = nInstrIdx;` |
|         - |   287 | `	/* Insert in the jump fixup table */` |
|   4437189 |   288 | `	rc = SySetPut(&pBlock->aJumpFix,(const void *)&sJumpFix);` |
|   4437189 |   289 | `	return rc;` |
|         5 |   290 | `}` |
|         - |   291 | `/*` |
...
|         - |   301 | ` */` |
|   8364514 |   302 | `static sxu32 GenStateFixJumps(GenBlock *pBlock,sxi32 nJumpType,sxu32 nJumpDest)` |
|         5 |   303 | `{` |
|         - |   304 | `	JumpFixup *aFix;` |
|         - |   305 | `	VmInstr *pInstr;` |
|         - |   306 | `	sxu32 nFixed;` |
...
|   8364519 |   309 | `	aFix = (JumpFixup *)SySetBasePtr(&pBlock->aJumpFix);` |
|         - |   310 | `	/* Fix the desired jumps */` |
|  17799293 |   311 | `	for( nFixed = n = 0 ; n < SySetUsed(&pBlock->aJumpFix) ; ++n ){` |
|   9434779 |   312 | `		if( aFix[n].nJumpType < 0 ){` |
|         - |   313 | `			/* Already fixed */` |
|   3523739 |   314 | `			continue;` |
|         - |   315 | `		}` |
|   5911045 |   316 | `		if( nJumpType > 0 && aFix[n].nJumpType != nJumpType ){` |
|         - |   317 | `			/* Not of our interest */` |
|   1473863 |   318 | `			continue;` |
|         - |   319 | `		}` |
|         - |   320 | `		/* Point to the instruction to fix */` |
|   4437187 |   321 | `		pInstr = PH7_VmGetInstr(pBlock->pGen->pVm,aFix[n].nInstrIdx);` |
|   4437187 |   322 | `		if( pInstr ){` |
|   4437187 |   323 | `			pInstr->iP2 = nJumpDest;` |
|   4437187 |   324 | `			nFixed++;` |
|         - |   325 | `			/* Mark as fixed */` |
|   4437187 |   326 | `			aFix[n].nJumpType = -1;` |
|   2218591 |   327 | `		}` |
|   2218596 |   328 | `	}` |
|         - |   329 | `	/* Total number of fixed jumps */` |
|   8364519 |   330 | `	return nFixed;` |
|         5 |   331 | `}` |
|         - |   332 | `/*` |
...
|         - |   338 | ` */` |
|   3006186 |   339 | `static sxi32 GenStateFixGoto(ph7_gen_state *pGen,sxu32 nOfft)` |
|         5 |   340 | `{` |
...
|   3006191 |   347 | `	aJumps = (JumpFixup *)SySetBasePtr(&pGen->aGoto);` |
|         - |   348 | `	/* Fix */` |
|   3006337 |   349 | `	for( n = nOfft ; n < SySetUsed(&pGen->aGoto) ; ++n ){` |
...
|   3006189 |   400 | `	return SXRET_OK;` |
|   1503098 |   401 | `}` |
|         - |   402 | `/*` |
|         - |   403 | ` * Check if a given token value is installed in the literal table.` |
|         - |   404 | ` */` |
|  15196768 |   405 | `static sxi32 GenStateFindLiteral(ph7_gen_state *pGen,const SyString *pValue,sxu32 *pIdx)` |
|         5 |   406 | `{` |
|         - |   407 | `	SyHashEntry *pEntry;` |
|  15196773 |   408 | `	pEntry = SyHashGet(&pGen->hLiteral,(const void *)pValue->zString,pValue->nByte);` |
|  15196773 |   409 | `	if( pEntry == 0 ){` |
|   3894335 |   410 | `		return SXERR_NOTFOUND;` |
|         - |   411 | `	}` |
|  11302443 |   412 | `	*pIdx = (sxu32)SX_PTR_TO_INT(pEntry->pUserData);` |
|  11302443 |   413 | `	return SXRET_OK;` |
|   7598389 |   414 | `}` |
|         - |   415 | `/*` |
...
|         - |   424 | ` */` |
|   3894330 |   425 | `static sxi32 GenStateInstallLiteral(ph7_gen_state *pGen,ph7_value *pObj,sxu32 nIdx)` |
|         5 |   426 | `{` |
|   3894335 |   427 | `	if( SyBlobLength(&pObj->sBlob) > 0 ){` |
|   3894335 |   428 | `		SyHashInsert(&pGen->hLiteral,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob),SX_INT_TO_PTR(nIdx));` |
|   1947165 |   429 | `	}` |
|   3894335 |   430 | `	return SXRET_OK;` |
|         5 |   431 | `}` |
|         - |   432 | `/*` |
|         - |   433 | ` * Reserve a room for a numeric constant [i.e: 64-bit integer or real number]` |
|         - |   434 | ` * in the constant table.` |
|         - |   435 | ` */` |
|   3671704 |   436 | `static ph7_value * GenStateInstallNumLiteral(ph7_gen_state *pGen,sxu32 *pIdx)` |
|         5 |   437 | `{` |
|         - |   438 | `	ph7_value *pObj;` |
|   3671709 |   439 | `	sxu32 nIdx = 0; /* cc warning */` |
|         - |   440 | `	/* Reserve a new constant */` |
|   3671709 |   441 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   3671709 |   442 | `	if( pObj == 0 ){` |
|       ! 0 |   443 | `		PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|       ! 0 |   444 | `		return 0;` |
|         - |   445 | `	}` |
|   3671709 |   446 | `	*pIdx = nIdx;` |
|         - |   447 | `	/* TODO(chems): Create a numeric table (64bit int keys) same as` |
|         - |   448 | `	 * the constant string iterals table [optimization purposes].` |
|         - |   449 | `	 */` |
|   3671709 |   450 | `	return pObj;` |
|   1835857 |   451 | `}` |
|         - |   452 | `/*` |
...
|         - |   465 | ` */` |
|   7223326 |   466 | `static void *GenStateAttachStrictFlag(ph7_gen_state *pGen, void *p3)` |
|         5 |   467 | `{` |
|         - |   468 | `	VmCallArgMap *pMap;` |
|   7223331 |   469 | `	if( !pGen->bStrictTypes ) return p3;` |
|        39 |   470 | `	if( p3 == 0 ){` |
...
|         - |   541 | ` */` |
|   3680394 |   542 | `static int GenStateFindBadNumericSeparator(` |
|         - |   543 | `	const SyString *pRaw, const char **pBadStart, sxu32 *pBadLen)` |
|         5 |   544 | `{` |
|   3680399 |   545 | `	const char *z = pRaw->zString;` |
|   3680399 |   546 | `	sxu32 n = pRaw->nByte;` |
|   3680399 |   547 | `	int base = 10;` |
|         - |   548 | `	sxu32 i, start;` |
|   3680399 |   549 | `	if( n < 2 ) return 0;` |
|    790929 |   550 | `	if( z[0] == '0' && (z[1] == 'x' \|\| z[1] == 'X') ){` |
|    103399 |   551 | `		base = 16;` |
|    739232 |   552 | `	}else if( z[0] == '0' && (z[1] == 'b' \|\| z[1] == 'B') ){` |
|       286 |   553 | `		base = 2;` |
|       142 |   554 | `	}` |
|   3011215 |   555 | `	for( i = 0; i < n; ++i ){` |
|   2220305 |   556 | `		if( z[i] != '_' ) continue;` |
...
|         - |   582 | ` */` |
|   3680394 |   583 | `static sxi32 GenStateValidateNumericSeparator(ph7_gen_state *pGen, SyToken *pToken)` |
|         5 |   584 | `{` |
|   3680399 |   585 | `	const char *zBad = 0;` |
|   3680399 |   586 | `	sxu32 nBad = 0;` |
|         - |   587 | `	SyString sBad;` |
|         - |   588 | `	sxi32 rc;` |
|   3680399 |   589 | `	if( !GenStateFindBadNumericSeparator(&pToken->sData, &zBad, &nBad) ){` |
|   3680385 |   590 | `		return SXRET_OK;` |
|         - |   591 | `	}` |
...
|         - |   615 | ` */` |
|   3680380 |   616 | `static sxi32 GenStateStripNumericSeparators(` |
...
|         5 |   621 | `{` |
|         - |   622 | `	sxu32 i, j;` |
|   3680385 |   623 | `	int hasUnderscore = 0;` |
|         - |   624 | `	char *zBuf;` |
|   3680385 |   625 | `	*pzAlloc = 0;` |
|   8788065 |   626 | `	for( i = 0; i < pToken->nByte; ++i ){` |
|   5107939 |   627 | `		if( pToken->zString[i] == '_' ){ hasUnderscore = 1; break; }` |
|   2553845 |   628 | `	}` |
|   3680385 |   629 | `	if( !hasUnderscore ){` |
|   3680131 |   630 | `		SyStringDupPtr(pOut, pToken);` |
|   3680131 |   631 | `		return SXRET_OK;` |
|         - |   632 | `	}` |
...
|         - |   683 | ` */` |
|   3671738 |   684 | `static int GenStateIntLiteralOverflows(const SyString *pNum, ph7_real *pReal, int *pbDecimal)` |
|         5 |   685 | `{` |
|   3671743 |   686 | `	const char *z = pNum->zString;` |
|   3671743 |   687 | `	const char *zEnd = z + pNum->nByte;` |
|         - |   688 | `	const char *p, *q;` |
|         - |   689 | `	int n;` |
|   3671743 |   690 | `	*pbDecimal = FALSE;` |
|   3671743 |   691 | `	if( z >= zEnd ){` |
|       ! 0 |   692 | `		return FALSE;` |
|         - |   693 | `	}` |
|   3671743 |   694 | `	if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'x' \|\| z[1] == 'X') ){` |
|         - |   695 | `		/* Hexadecimal: INT64_MAX == 0x7FFF...F (16 digits, leading nibble 7). */` |
|    103397 |   696 | `		p = z + 2;` |
|    130187 |   697 | `		while( p < zEnd && p[0] == '0' ){ p++; }` |
|    421429 |   698 | `		for( q = p, n = 0; q < zEnd && (unsigned char)q[0] < 0xc0 && SyisHex(q[0]); q++ ){ n++; }` |
|    103397 |   699 | `		if( n < 16 \|\| (n == 16 && SyHexToint(p[0]) < 8) ){` |
|    103391 |   700 | `			return FALSE;` |
|         - |   701 | `		}` |
|         7 |   702 | `		{ ph7_real dv = 0;` |
...
|         - |   707 | `		}` |
|         7 |   708 | `		return TRUE;` |
|   3568351 |   709 | `	}else if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'b' \|\| z[1] == 'B') ){` |
...
|         - |   722 | `		}` |
|         3 |   723 | `		return TRUE;` |
|   3568069 |   724 | `	}else if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'o' \|\| z[1] == 'O') ){` |
...
|   1333853 |   743 | `		p = z;` |
|   2667703 |   744 | `		while( p < zEnd && p[0] == '0' ){ p++; }` |
|   1345587 |   745 | `		for( q = p, n = 0; q < zEnd && q[0] >= '0' && q[0] <= '7'; q++ ){ n++; }` |
|   1333853 |   746 | `		if( n <= 21 ){` |
|   1333851 |   747 | `			return FALSE;` |
|         - |   748 | `		}` |
|         3 |   749 | `		{ ph7_real dv = 0;` |
...
|   2234205 |   760 | `	p = z;` |
|   2234205 |   761 | `	while( p < zEnd && p[0] == '0' ){ p++; }` |
|   5415765 |   762 | `	for( q = p, n = 0; q < zEnd && (unsigned char)q[0] < 0xc0 && SyisDigit(q[0]); q++ ){ n++; }` |
|   2234205 |   763 | `	if( n > 19 \|\| (n == 19 && SyMemcmp(p, "9223372036854775807", 19) > 0) ){` |
|        25 |   764 | `		*pbDecimal = TRUE;` |
|        25 |   765 | `		return TRUE;` |
|         - |   766 | `	}` |
|   2234181 |   767 | `	return FALSE;` |
|   1835874 |   768 | `}` |
|   3680366 |   769 | `static sxi32 PH7_CompileNumLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|         5 |   770 | `{` |
|   3680371 |   771 | `	SyToken *pToken = pGen->pIn; /* Raw token */` |
|   3680371 |   772 | `	sxu32 nIdx = 0;` |
|         - |   773 | `	char zScratch[GEN_NUM_SCRATCH];` |
|   3680371 |   774 | `	char *zAlloc = 0;` |
|         - |   775 | `	SyString sNum;` |
|         - |   776 | `	sxi32 rc;` |
|   1840183 |   777 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|   3680371 |   778 | `	rc = GenStateValidateNumericSeparator(pGen, pToken);` |
|   3680371 |   779 | `	if( rc != SXRET_OK ){` |
|        14 |   780 | `		return rc;` |
|         - |   781 | `	}` |
|   5520539 |   782 | `	rc = GenStateStripNumericSeparators(&pGen->pVm->sAllocator, &pToken->sData,` |
|   1840178 |   783 | `		zScratch, sizeof(zScratch), &sNum, &zAlloc);` |
|   3680361 |   784 | `	if( rc != SXRET_OK ){` |
|       ! 0 |   785 | `		return SXERR_ABORT;` |
|         - |   786 | `	}` |
|   3680361 |   787 | `	if( pToken->nType & PH7_TK_INTEGER ){` |
|         - |   788 | `		ph7_value *pObj;` |
|         - |   789 | `		sxi64 iValue;` |
|   3671743 |   790 | `		ph7_real rOverflow = 0;` |
|   3671743 |   791 | `		int bDecimalOverflow = 0;` |
|   3671743 |   792 | `		if( GenStateIntLiteralOverflows(&sNum,&rOverflow,&bDecimalOverflow) ){` |
...
|         - |   807 | `			}` |
|        18 |   808 | `		}else{` |
|   3671709 |   809 | `			iValue = PH7_TokenValueToInt64(&sNum);` |
|   3671709 |   810 | `			pObj = GenStateInstallNumLiteral(&(*pGen),&nIdx);` |
|   3671709 |   811 | `			if( pObj == 0 ){` |
|       ! 0 |   812 | `				if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|       ! 0 |   813 | `				return SXERR_ABORT;` |
|         - |   814 | `			}` |
|   3671709 |   815 | `			PH7_MemObjInitFromInt(pGen->pVm,pObj,iValue);` |
|         - |   816 | `		}` |
|   1835874 |   817 | `	}else{` |
|         - |   818 | `		/* Real number */` |
|         - |   819 | `		ph7_value *pObj;` |
|         - |   820 | `		/* Reserve a new constant */` |
|      8623 |   821 | `		pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|      8623 |   822 | `		if( pObj == 0 ){` |
...
|         - |   826 | `		}` |
|      8623 |   827 | `		PH7_MemObjInitFromString(pGen->pVm,pObj,&sNum);` |
|      8623 |   828 | `		PH7_MemObjToReal(pObj);` |
|         - |   829 | `	}` |
|   3680361 |   830 | `	if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|         - |   831 | `	/* Emit the load constant instruction */` |
|   3680361 |   832 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|         - |   833 | `	/* Node successfully compiled */` |
|   3680361 |   834 | `	return SXRET_OK;` |
|   1840188 |   835 | `}` |
|         - |   836 | `/*` |
...
|         - |   845 | ` *` |
|         - |   846 | ` */` |
|   5182162 |   847 | `PH7_PRIVATE sxi32 PH7_CompileSimpleString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|         5 |   848 | `{` |
|   5182167 |   849 | `	SyString *pStr = &pGen->pIn->sData; /* Constant string literal */` |
|         - |   850 | `	const char *zIn,*zCur,*zEnd;` |
|         - |   851 | `	ph7_value *pObj;` |
|         - |   852 | `	sxu32 nIdx;` |
|         - |   853 | `	sxi32 bHasEsc;` |
|   5182167 |   854 | `	nIdx = 0; /* Prevent compiler warning */` |
|         - |   855 | `	/* Delimit the string */` |
|   5182167 |   856 | `	zIn  = pStr->zString;` |
|   5182167 |   857 | `	zEnd = &zIn[pStr->nByte];` |
|   5182167 |   858 | `	if( zIn >= zEnd ){` |
|         - |   859 | `		/* Empty string constant: just use the pre‑allocated index from the VM` |
|         - |   860 | `		 * rather than reserving a new object each time. */` |
|    371343 |   861 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,pGen->pVm->nEmptyStringIdx,0,0);` |
|    371343 |   862 | `		return SXRET_OK;` |
|         - |   863 | `	}` |
...
|   4810829 |   871 | `	bHasEsc = 0;` |
|         - |   872 | `	{` |
|         - |   873 | `		const char *zScan;` |
|  57617965 |   874 | `		for( zScan = zIn ; zScan < zEnd ; zScan++ ){` |
|  52887671 |   875 | `			if( zScan[0] == '\\' ){ bHasEsc = 1; break; }` |
|  26403573 |   876 | `		}` |
|         - |   877 | `	}` |
|   4810829 |   878 | `	if( !bHasEsc && SXRET_OK == GenStateFindLiteral(&(*pGen),pStr,&nIdx) ){` |
|         - |   879 | `		/* Already processed,emit the load constant instruction` |
|         - |   880 | `		 * and return.` |
|         - |   881 | `		 */` |
|   2855149 |   882 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   2855149 |   883 | `		return SXRET_OK;` |
|         - |   884 | `	}` |
|         - |   885 | `	/* Reserve a new constant */` |
|   1955685 |   886 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   1955685 |   887 | `	if( pObj == 0 ){` |
...
|         - |   891 | `	}` |
|   1955685 |   892 | `	PH7_MemObjInitFromString(pGen->pVm,pObj,0);` |
|         - |   893 | `	/* Compile the node */` |
|   2007440 |   894 | `	for(;;){` |
|   4014885 |   895 | `		if( zIn >= zEnd ){` |
|         - |   896 | `			/* End of input */` |
|   1955685 |   897 | `			break;` |
|         - |   898 | `		}` |
|   2059205 |   899 | `		zCur = zIn;` |
|  40604949 |   900 | `		while( zIn < zEnd && zIn[0] != '\\' ){` |
|  38545749 |   901 | `			zIn++;` |
|         5 |   902 | `		}` |
|   2059205 |   903 | `		if( zIn > zCur ){` |
|         - |   904 | `			/* Append raw contents*/` |
|   2017041 |   905 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|   1008518 |   906 | `		}` |
|   2059205 |   907 | `		zIn++;` |
|   2059205 |   908 | `		if( zIn < zEnd ){` |
|    141833 |   909 | `			if( zIn[0] == '\\' ){` |
|         - |   910 | `				/* A literal backslash */` |
|     34507 |   911 | `				PH7_MemObjStringAppend(pObj,"\\",sizeof(char));` |
|    124582 |   912 | `			}else if( zIn[0] == '\'' ){` |
|         - |   913 | `				/* A single quote */` |
|        15 |   914 | `				PH7_MemObjStringAppend(pObj,"'",sizeof(char));` |
|         8 |   915 | `			}else{` |
|         - |   916 | `				/* verbatim copy */` |
|    107317 |   917 | `				zIn--;` |
|    107317 |   918 | `				PH7_MemObjStringAppend(pObj,zIn,sizeof(char)*2);` |
|    107317 |   919 | `				zIn++;` |
|         - |   920 | `			}` |
|     70914 |   921 | `		}` |
...
|   1955685 |   926 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   1955685 |   927 | `	if( !bHasEsc && pStr->nByte < 1024 ){` |
|         - |   928 | `		/* Install in the literal table (only when value == source; see above) */` |
|   1875155 |   929 | `		GenStateInstallLiteral(pGen,pObj,nIdx);` |
|    937575 |   930 | `	}` |
|         - |   931 | `	/* Node successfully compiled */` |
|   1955685 |   932 | `	return SXRET_OK;` |
|   2591086 |   933 | `}` |
|         - |   934 | `/*` |
...
|         - |  1133 | ` */` |
|    122376 |  1134 | `static ph7_value * GenStateNewStrObj(ph7_gen_state *pGen,sxi32 *pCount)` |
|         5 |  1135 | `{` |
|         - |  1136 | `	ph7_value *pConstObj;` |
|    122381 |  1137 | `	sxu32 nIdx = 0;` |
|         - |  1138 | `	/* Reserve a new constant */` |
|    122381 |  1139 | `	pConstObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|    122381 |  1140 | `	if( pConstObj == 0 ){` |
|       ! 0 |  1141 | `		PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"PH7 engine is running out of memory");` |
|       ! 0 |  1142 | `		return 0;` |
|         - |  1143 | `	}` |
|    122381 |  1144 | `	(*pCount)++;` |
|    122381 |  1145 | `	PH7_MemObjInitFromString(pGen->pVm,pConstObj,0);` |
|         - |  1146 | `	/* Emit the load constant instruction */` |
|    122381 |  1147 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|    122381 |  1148 | `	return pConstObj;` |
|     61193 |  1149 | `}` |
|         - |  1150 | `/*` |
...
|    120812 |  1212 | `static sxi32 GenStateCompileString(ph7_gen_state *pGen,int bHeredoc)` |
|         5 |  1213 | `{` |
|    120817 |  1214 | `	SyString *pStr = &pGen->pIn->sData; /* Raw token value */` |
|         - |  1215 | `	const char *zIn,*zCur,*zEnd;` |
|    120817 |  1216 | `	ph7_value *pObj = 0;` |
|         - |  1217 | `	sxi32 iCons;` |
|         - |  1218 | `	sxi32 rc;` |
|         - |  1219 | `	/* Delimit the string */` |
|    120817 |  1220 | `	zIn  = pStr->zString;` |
|    120817 |  1221 | `	zEnd = &zIn[pStr->nByte];` |
|    120817 |  1222 | `	if( zIn >= zEnd ){` |
...
|    120407 |  1232 | `	iCons = 0;` |
|     61520 |  1233 | `	for(;;){` |
|    163813 |  1234 | `		zCur = zIn;` |
|   1663305 |  1235 | `		while( zIn < zEnd && zIn[0] != '\\'  ){` |
|   1502139 |  1236 | `			if( zIn[0] == '{' && &zIn[1] < zEnd && zIn[1] == '$' ){` |
|        69 |  1237 | `				break;` |
|   1502012 |  1238 | `			}else if(zIn[0] == '$' && &zIn[1] < zEnd &&` |
|      2520 |  1239 | `				(((unsigned char)zIn[1] >= 0xc0 \|\| SyisAlpha(zIn[1]) \|\| zIn[1] == '{' \|\| zIn[1] == '_')) ){` |
|      1260 |  1240 | `					break;` |
|         - |  1241 | `			}` |
|   1499497 |  1242 | `			zIn++;` |
|         5 |  1243 | `		}` |
|    163813 |  1244 | `		if( zIn > zCur ){` |
|     95425 |  1245 | `			if( pObj == 0 ){` |
|     94799 |  1246 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|     94799 |  1247 | `				if( pObj == 0 ){` |
|       ! 0 |  1248 | `					return SXERR_ABORT;` |
|         - |  1249 | `				}` |
|     47397 |  1250 | `			}` |
|     95425 |  1251 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|     47710 |  1252 | `		}` |
|    163813 |  1253 | `		if( zIn >= zEnd ){` |
|    120405 |  1254 | `			break;` |
|         - |  1255 | `		}` |
|     43413 |  1256 | `		if( zIn[0] == '\\' ){` |
|     40771 |  1257 | `			const char *zPtr = 0;` |
|         - |  1258 | `			sxu32 n;` |
|     40771 |  1259 | `			zIn++;` |
|     40771 |  1260 | `			if( pObj == 0 ){` |
|     27587 |  1261 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|     27587 |  1262 | `				if( pObj == 0 ){` |
|       ! 0 |  1263 | `					return SXERR_ABORT;` |
|         - |  1264 | `				}` |
|     13791 |  1265 | `			}` |
|     40771 |  1266 | `			if( zIn >= zEnd ){` |
|         - |  1267 | `				/* Lone backslash at the very end of the body: php keeps it */` |
|         3 |  1268 | `				PH7_MemObjStringAppend(pObj,"\\",sizeof(char));` |
|         3 |  1269 | `				break;` |
|         - |  1270 | `			}` |
|     40769 |  1271 | `			n = sizeof(char); /* size of conversion */` |
|     40769 |  1272 | `			switch( zIn[0] ){` |
|        15 |  1273 | `			case '$':` |
|         - |  1274 | `				/* Dollar sign */` |
...
|     35577 |  1291 | `				PH7_MemObjStringAppend(pObj,"\n",sizeof(char));` |
|     35577 |  1292 | `				break;` |
|        27 |  1293 | `			case 'r':` |
...
|      3893 |  1299 | `				PH7_MemObjStringAppend(pObj,"\t",sizeof(char));` |
|      3893 |  1300 | `				break;` |
|         3 |  1301 | `			case 'v':` |
...
|    120407 |  1628 | `	return SXRET_OK;` |
|     60411 |  1629 | `}` |
|         - |  1630 | `/*` |
|         - |  1631 | ` * Compile a double quoted string.` |
|         - |  1632 | ` *  See the block-comment above for more information.` |
|         - |  1633 | ` */` |
|    120750 |  1634 | `PH7_PRIVATE sxi32 PH7_CompileString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|         5 |  1635 | `{` |
|         - |  1636 | `	sxi32 rc;` |
|    120755 |  1637 | `	rc = GenStateCompileString(&(*pGen),0/*bHeredoc*/);` |
|     60375 |  1638 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|         - |  1639 | `	/* Compilation result */` |
|    120755 |  1640 | `	return rc;` |
|         5 |  1641 | `}` |
|         - |  1642 | `/*` |
...
|         - |  1683 | ` */` |
|   1440422 |  1684 | `static sxi32 GenStateCompileArrayEntry(` |
...
|   1440427 |  1695 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|         - |  1696 | `	/* Compile the expression*/` |
|   1440427 |  1697 | `	rc = PH7_CompileExpr(&(*pGen),iFlags,xValidator);` |
|         - |  1698 | `	/* Restore token stream */` |
|   1440427 |  1699 | `	RE_SWAP_DELIMITER(pGen);` |
|   1440427 |  1700 | `	return rc;` |
|         5 |  1701 | `}` |
|         - |  1702 | `/*` |
...
|         - |  1738 | ` */` |
|   1381714 |  1739 | `static SyToken * GenStateFindTopLevelArrow(SyToken *pStart,SyToken *pEnd)` |
|         5 |  1740 | `{` |
|   1381719 |  1741 | `	SyToken *pCur = pStart;` |
|   1381719 |  1742 | `	sxi32 iNest = 0;` |
|   3566981 |  1743 | `	while( pCur < pEnd ){` |
|   2688941 |  1744 | `		if( (pCur->nType & PH7_TK_ARRAY_OP) && iNest <= 0 ){` |
|    503675 |  1745 | `			return pCur;` |
|         - |  1746 | `		}` |
...
|         - |  1750 | `		 */` |
|   2185271 |  1751 | `		if( iNest == 0 && (pCur->nType & PH7_TK_KEYWORD) ){` |
|     23067 |  1752 | `			sxu32 nKw = (sxu32)SX_PTR_TO_INT(pCur->pUserData);` |
|     23067 |  1753 | `			SyToken *pFn = pCur;` |
|     23062 |  1754 | `			if( nKw == PH7_TKWRD_STATIC && &pCur[1] < pEnd` |
|       ! 0 |  1755 | `				&& (pCur[1].nType & PH7_TK_KEYWORD)` |
|         5 |  1756 | `				&& SX_PTR_TO_INT(pCur[1].pUserData) == PH7_TKWRD_FN ){` |
|       ! 0 |  1757 | `				pFn = &pCur[1];` |
|       ! 0 |  1758 | `				nKw = PH7_TKWRD_FN;` |
|       ! 0 |  1759 | `			}` |
|     23067 |  1760 | `			if( nKw == PH7_TKWRD_FN ){` |
...
|     23063 |  1791 | `			if( nKw == PH7_TKWRD_MATCH ){` |
...
|         - |  1810 | `			}` |
|     11528 |  1811 | `		}` |
|   2185265 |  1812 | `		if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|     54145 |  1813 | `			iNest++;` |
|   2158195 |  1814 | `		}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}'*/) ){` |
...
|         - |  1827 | ` */` |
|    624006 |  1828 | `static sxi32 GenStateCompileArrayBody(ph7_gen_state *pGen)` |
|         5 |  1829 | `{` |
|         - |  1830 | `	sxi32 (*xValidator)(ph7_gen_state *,ph7_expr_node *); /* Expression tree validator callback */` |
|         - |  1831 | `	SyToken *pKey,*pCur;` |
|    624011 |  1832 | `	sxi32 iEmitRef = 0;` |
|    624011 |  1833 | `	sxi32 iSpread = 0;` |
|    624011 |  1834 | `	sxi32 nPair = 0;` |
|         - |  1835 | `	sxi32 rc;` |
|    624011 |  1836 | `	xValidator = 0;` |
|    847378 |  1837 | `	for(;;){` |
...
|    535375 |  1842 | `		{` |
|   1694761 |  1843 | `			int nSkip = 0;` |
|   2517191 |  1844 | `			while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA) ){` |
|    822435 |  1845 | `				nSkip++;` |
|    822435 |  1846 | `				pGen->pIn++;` |
|         5 |  1847 | `			}` |
|   1694761 |  1848 | `			if( nSkip > 1 \|\| (nSkip > 0 && nPair < 1) ){` |
...
|         - |  1855 | `			}` |
|         - |  1856 | `		}` |
|   1694761 |  1857 | `		pCur = pGen->pIn;` |
|   1694761 |  1858 | `		if( SXRET_OK != PH7_GetNextExpr(pGen->pIn,pGen->pEnd,&pGen->pIn) ){` |
|         - |  1859 | `			/* No more entry to process */` |
|    623993 |  1860 | `			break;` |
|         - |  1861 | `		}` |
|   1070773 |  1862 | `		if( pCur >= pGen->pIn ){` |
|       ! 0 |  1863 | `			continue;` |
|         - |  1864 | `		}` |
|         - |  1865 | `		/* Compile the key if available */` |
|   1070773 |  1866 | `		pKey = pCur;` |
|   1070773 |  1867 | `		pCur = GenStateFindTopLevelArrow(pCur,pGen->pIn);` |
|   1070773 |  1868 | `		rc = SXERR_EMPTY;` |
|   1070773 |  1869 | `		if( pCur < pGen->pIn ){` |
|    369401 |  1870 | `			if( pKey == pCur ){` |
...
|         - |  1883 | `			}` |
|    369399 |  1884 | `			if( &pCur[1] >= pGen->pIn ){` |
...
|    369389 |  1895 | `			rc = GenStateCompileArrayEntry(&(*pGen),pKey,pCur,` |
|         - |  1896 | `				EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,0);` |
|    369389 |  1897 | `			if( rc == SXERR_ABORT ){` |
|       ! 0 |  1898 | `				return SXERR_ABORT;` |
|         - |  1899 | `			}` |
|    369389 |  1900 | `			pCur++; /* Jump the '=>' operator */` |
|    184697 |  1901 | `		}else{` |
|         - |  1902 | `			/* Reset back the cursor and point to the entry value */` |
|    701377 |  1903 | `			pCur = pKey;` |
|         - |  1904 | `		}` |
|   1070761 |  1905 | `		if( rc == SXERR_EMPTY ){` |
...
|    701377 |  1908 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,PH7_LOADC_NOKEY,0 /* nil index */,0,0);` |
|    350686 |  1909 | `		}` |
|   1070761 |  1910 | `		if( pCur->nType & PH7_TK_AMPER /*'&'*/){` |
...
|   1070759 |  1929 | `		iSpread = (pCur < pGen->pIn && (pCur->nType & PH7_TK_ELLIPSIS)) ? 1 : 0;` |
|   1070759 |  1930 | `		if( iSpread && (rc != SXERR_EMPTY \|\| iEmitRef) ){` |
...
|   1606130 |  1947 | `		rc = GenStateCompileArrayEntry(&(*pGen),pCur,pGen->pIn,` |
|    535375 |  1948 | `			iEmitRef ? EXPR_FLAG_LOAD_IDX_STORE` |
|         - |  1949 | `			         : EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,` |
|    535375 |  1950 | `			xValidator);` |
|   1070755 |  1951 | `		if( rc == SXERR_ABORT ){` |
|       ! 0 |  1952 | `			return SXERR_ABORT;` |
|         - |  1953 | `		}` |
|   1070755 |  1954 | `		if( iSpread ){` |
...
|   1070720 |  1957 | `		}else if( iEmitRef ){` |
|         - |  1958 | `			/* Emit the load reference instruction */` |
|        40 |  1959 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_REF,0,0,0,0);` |
|        18 |  1960 | `		}` |
|   1070755 |  1961 | `		xValidator = 0;` |
|   1070755 |  1962 | `		iEmitRef = 0;` |
|   1070755 |  1963 | `		iSpread = 0;` |
|   1070755 |  1964 | `		nPair++;` |
|         5 |  1965 | `	}` |
|         - |  1966 | `	/* Emit the load map instruction */` |
|    623993 |  1967 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_MAP,nPair * 2,0,0,0);` |
|         - |  1968 | `	/* Node successfully compiled */` |
|    623993 |  1969 | `	return SXRET_OK;` |
|    312008 |  1970 | `}` |
|         - |  1971 | `/*` |
...
|         - |  1979 | ` */` |
|    407412 |  1980 | `PH7_PRIVATE sxi32 PH7_CompileArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|         5 |  1981 | `{` |
|         - |  1982 | `	/* Jump the 'array' keyword and the leading '(', exclude trailing ')'. */` |
|    407417 |  1983 | `	pGen->pIn += 2;` |
|    407417 |  1984 | `	pGen->pEnd--;` |
|    203706 |  1985 | `	SXUNUSED(iCompileFlag);` |
|    407417 |  1986 | `	return GenStateCompileArrayBody(pGen);` |
|         5 |  1987 | `}` |
|         - |  1988 | `/*` |
...
|         - |  2084 | ` */` |
|    216594 |  2085 | `PH7_PRIVATE sxi32 PH7_CompileShortArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|         5 |  2086 | `{` |
|         - |  2087 | `	/* Jump the leading '[', exclude trailing ']'. */` |
|    216599 |  2088 | `	pGen->pIn++;` |
|    216599 |  2089 | `	pGen->pEnd--;` |
|    108297 |  2090 | `	SXUNUSED(iCompileFlag);` |
|    216599 |  2091 | `	return GenStateCompileArrayBody(pGen);` |
|         5 |  2092 | `}` |
|         - |  2093 | `/*` |
...
|         - |  3390 | ` */` |
|  19892286 |  3391 | `PH7_PRIVATE sxi32 PH7_CompileVariable(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|         5 |  3392 | `{` |
|  19892291 |  3393 | `	sxu32 nLineLocal = pGen->pIn->nLine;` |
|         - |  3394 | `	sxi32 iVv;` |
|         - |  3395 | `	sxi32 iP1;` |
|         - |  3396 | `	void *p3;` |
|         - |  3397 | `	sxi32 rc;` |
|  19892291 |  3398 | `	iVv = -1; /* Variable variable counter */` |
|  39784589 |  3399 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) ){` |
|  19892303 |  3400 | `		pGen->pIn++;` |
|  19892303 |  3401 | `		iVv++;` |
|         5 |  3402 | `	}` |
|  19892291 |  3403 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_OCB/*'{'*/)) == 0 ){` |
...
|         - |  3411 | `	}` |
|  19892291 |  3412 | `	p3  = 0;` |
|  19892291 |  3413 | `	if( pGen->pIn->nType & PH7_TK_OCB/*'{'*/ ){` |
...
|         - |  3438 | `		SyString *pName;` |
|  19892275 |  3439 | `		char *zName = 0;` |
|         - |  3440 | `		/* Extract variable name */` |
|  19892275 |  3441 | `		pName = &pGen->pIn->sData;` |
|         - |  3442 | `		/* Advance the stream cursor */` |
|  19892275 |  3443 | `		pGen->pIn++;` |
|  19892275 |  3444 | `		pEntry = SyHashGet(&pGen->hVar,(const void *)pName->zString,pName->nByte);` |
|  19892275 |  3445 | `		if( pEntry == 0 ){` |
|         - |  3446 | `			/* Duplicate name */` |
|   1181309 |  3447 | `			zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|   1181309 |  3448 | `			if( zName == 0 ){` |
...
|   1181309 |  3453 | `			SyHashInsert(&pGen->hVar,zName,pName->nByte,zName);` |
|    590657 |  3454 | `		}else{` |
|         - |  3455 | `			/* Name already available */` |
|  18710971 |  3456 | `			zName = (char *)pEntry->pUserData;` |
|         - |  3457 | `		}` |
|  19892275 |  3458 | `		p3 = (void *)zName;` |
|         - |  3459 | `	}` |
|  19892287 |  3460 | `	iP1 = 0;` |
|  19892287 |  3461 | `	if( iCompileFlag & EXPR_FLAG_RDONLY_LOAD ){` |
|   5878695 |  3462 | `		if( (iCompileFlag & EXPR_FLAG_LOAD_IDX_STORE) == 0 ){` |
|         - |  3463 | `			/* Read-only load.In other words do not create the variable if inexistant */` |
|   5874845 |  3464 | `			iP1 = 1;` |
|   2937420 |  3465 | `		}` |
|   2939345 |  3466 | `	}` |
|         - |  3467 | `	/* Emit the load instruction */` |
|  19892287 |  3468 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,0,p3,0);` |
|  19892299 |  3469 | `	while( iVv > 0 ){` |
|        13 |  3470 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,0,0,0);` |
|        13 |  3471 | `		iVv--;` |
|         1 |  3472 | `	}` |
|         - |  3473 | `	/* Node successfully compiled */` |
|  19892287 |  3474 | `	return SXRET_OK;` |
|   9946148 |  3475 | `}` |
|         - |  3476 | `/*` |
|         - |  3477 | ` * Load a literal.` |
|         - |  3478 | ` */` |
|  12486368 |  3479 | `static sxi32 GenStateLoadLiteral(ph7_gen_state *pGen)` |
|         5 |  3480 | `{` |
|  12486373 |  3481 | `	SyToken *pToken = pGen->pIn;` |
|         - |  3482 | `	ph7_value *pObj;` |
|         - |  3483 | `	SyString *pStr;` |
|         - |  3484 | `	sxu32 nIdx;` |
|         - |  3485 | `	/* Extract token value */` |
|  12486373 |  3486 | `	pStr = &pToken->sData;` |
...
|  12486373 |  3491 | `	if( pToken->nType & PH7_TK_MEMBER_NAME ){` |
|         - |  3492 | `		/* fall through to the plain-string literal path */` |
|   9957594 |  3493 | `	}else if( pStr->nByte == sizeof("NULL") - 1 ){` |
|   1480441 |  3494 | `		if( SyStrnicmp(pStr->zString,"null",sizeof("NULL")-1) == 0 ){` |
|         - |  3495 | `			/* NULL constant are always indexed at 0 */` |
|    984267 |  3496 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,0,0,0);` |
|    984267 |  3497 | `			return SXRET_OK;` |
|    496179 |  3498 | `		}else if( SyStrnicmp(pStr->zString,"true",sizeof("TRUE")-1) == 0 ){` |
|         - |  3499 | `			/* TRUE constant are always indexed at 1 */` |
|    326505 |  3500 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,1,0,0);` |
|    326505 |  3501 | `			return SXRET_OK;` |
|         5 |  3502 | `		}` |
|   6783046 |  3503 | `	}else if (pStr->nByte == sizeof("FALSE") - 1 &&` |
|   1499660 |  3504 | `		SyStrnicmp(pStr->zString,"false",sizeof("FALSE")-1) == 0 ){` |
|         - |  3505 | `			/* FALSE constant are always indexed at 2 */` |
|    731439 |  3506 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,2,0,0);` |
|    731439 |  3507 | `			return SXRET_OK;` |
|   5357514 |  3508 | `	}else if(pStr->nByte == sizeof("__LINE__") - 1 &&` |
|    281138 |  3509 | `		SyMemcmp(pStr->zString,"__LINE__",sizeof("__LINE__")-1) == 0 ){` |
|         - |  3510 | `			/* TICKET 1433-004: __LINE__ constant must be resolved at compile time,not run time */` |
|      3839 |  3511 | `			pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|      3839 |  3512 | `			if( pObj == 0 ){` |
|       ! 0 |  3513 | `				PH7_GenCompileError(pGen,E_ERROR,pToken->nLine,"Fatal, PH7 engine is running out of memory");` |
|       ! 0 |  3514 | `				return SXERR_ABORT;` |
|         - |  3515 | `			}` |
|      3839 |  3516 | `			PH7_MemObjInitFromInt(pGen->pVm,pObj,pToken->nLine);` |
|         - |  3517 | `			/* Emit the load constant instruction */` |
|      3839 |  3518 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|      3839 |  3519 | `			return SXRET_OK;` |
|   5351758 |  3520 | `	}else if( (pStr->nByte == sizeof("__FILE__") - 1 &&` |
|    493190 |  3521 | `		SyMemcmp(pStr->zString,"__FILE__",sizeof("__FILE__")-1) == 0) \|\|` |
|   5425093 |  3522 | `		(pStr->nByte == sizeof("__DIR__") - 1 &&` |
|    431762 |  3523 | `		SyMemcmp(pStr->zString,"__DIR__",sizeof("__DIR__")-1) == 0) ){` |
...
|      3921 |  3530 | `			int bDir = (pStr->zString[2] == 'D'); /* __DIR__ vs __FILE__ */` |
|      3921 |  3531 | `			SyString *pFile = (SyString *)SySetPeek(&pGen->pVm->aFiles);` |
|      3921 |  3532 | `			pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|      3921 |  3533 | `			if( pObj == 0 ){` |
|       ! 0 |  3534 | `				PH7_GenCompileError(pGen,E_ERROR,pToken->nLine,"Fatal, PH7 engine is running out of memory");` |
|       ! 0 |  3535 | `				return SXERR_ABORT;` |
|         - |  3536 | `			}` |
|      3921 |  3537 | `			if( pFile && pFile->nByte > 0 ){` |
|        95 |  3538 | `				if( bDir ){` |
...
|        50 |  3548 | `			}else{` |
|         - |  3549 | `				SyString sMem;` |
|      3831 |  3550 | `				SyStringInitFromBuf(&sMem,":MEMORY:",sizeof(":MEMORY:")-1);` |
|      3831 |  3551 | `				PH7_MemObjInitFromString(pGen->pVm,pObj,&sMem);` |
|         - |  3552 | `			}` |
|      3921 |  3553 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|      3921 |  3554 | `			return SXRET_OK;` |
|   5310930 |  3555 | `	}else if( pStr->nByte == sizeof("__NAMESPACE__") - 1 &&` |
|    203470 |  3556 | `		SyMemcmp(pStr->zString,"__NAMESPACE__",sizeof("__NAMESPACE__")-1) == 0 ){` |
...
|   5322625 |  3572 | `	}else if( (pStr->nByte == sizeof("__FUNCTION__") - 1 &&` |
|    377099 |  3573 | `		SyMemcmp(pStr->zString,"__FUNCTION__",sizeof("__FUNCTION__")-1) == 0) \|\|` |
|   5359389 |  3574 | `		(pStr->nByte == sizeof("__METHOD__") - 1 &&` |
|    300424 |  3575 | `		SyMemcmp(pStr->zString,"__METHOD__",sizeof("__METHOD__")-1) == 0) ){` |
...
|  10436411 |  3618 | `	if( SXRET_OK != GenStateFindLiteral(&(*pGen),&pToken->sData,&nIdx) ){` |
|         - |  3619 | `		ph7_value *pLitObj;` |
|         - |  3620 | `		/* Unknown literal,install it in the literal table */` |
|   2011379 |  3621 | `		pLitObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   2011379 |  3622 | `		if( pLitObj == 0 ){` |
|       ! 0 |  3623 | `			PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|       ! 0 |  3624 | `			return SXERR_ABORT;` |
|         - |  3625 | `		}` |
|   2011379 |  3626 | `		PH7_MemObjInitFromString(pGen->pVm,pLitObj,&pToken->sData);` |
|   2011379 |  3627 | `		GenStateInstallLiteral(&(*pGen),pLitObj,nIdx);` |
|   1005687 |  3628 | `	}` |
|         - |  3629 | `	/* Emit the load constant instruction */` |
|  10436411 |  3630 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,1,nIdx,0,0);` |
|  10436411 |  3631 | `	return SXRET_OK;` |
|   6243189 |  3632 | `}` |
|         - |  3633 | `/*` |
...
|         - |  3638 | ` */` |
|  12490278 |  3639 | `static sxi32 GenStateResolveNamespaceLiteral(ph7_gen_state *pGen)` |
|         5 |  3640 | `{` |
|         - |  3641 | `	sxi32 rc;` |
|  12490283 |  3642 | `	if( pGen->pIn >= pGen->pEnd ){` |
|       ! 0 |  3643 | `		return SXRET_OK;` |
|         - |  3644 | `	}` |
|         - |  3645 | `	/* Check if this is a multi-token namespace path */` |
|  12490283 |  3646 | `	if( pGen->pIn < &pGen->pEnd[-1] ){` |
|         - |  3647 | `		/* Multiple tokens: assemble the full path into sWorker */` |
|      3915 |  3648 | `		SyBlob *pWorker = &pGen->sWorker;` |
|      3915 |  3649 | `		int isAbsolute = 0;` |
|      3915 |  3650 | `		SyBlobReset(pWorker);` |
|         - |  3651 | `		/* Check for leading backslash (absolute path) */` |
|      3915 |  3652 | `		if( pGen->pIn->nType & PH7_TK_NSSEP ){` |
|      3899 |  3653 | `			isAbsolute = 1;` |
|      3899 |  3654 | `			pGen->pIn++; /* Skip leading backslash */` |
|      1947 |  3655 | `		}` |
...
|         - |  3661 | `		{` |
|         - |  3662 | `			SyBlob sRaw;` |
|      3915 |  3663 | `			SyBlobInit(&sRaw,&pGen->pVm->sAllocator);` |
|      4067 |  3664 | `			while( pGen->pIn <= &pGen->pEnd[-1] ){` |
|      4067 |  3665 | `				if( pGen->pIn->nType & PH7_TK_NSSEP ){` |
|        81 |  3666 | `					SyBlobAppend(&sRaw,"\\",1);` |
|        43 |  3667 | `				}else{` |
|      3991 |  3668 | `					SyBlobAppend(&sRaw,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|         - |  3669 | `				}` |
|      4067 |  3670 | `				if( pGen->pIn == &pGen->pEnd[-1] ){` |
|      3915 |  3671 | `					pGen->pIn++;` |
|      3915 |  3672 | `					break;` |
|         - |  3673 | `				}` |
|       157 |  3674 | `				pGen->pIn++;` |
|         5 |  3675 | `			}` |
|      3915 |  3676 | `			if( isAbsolute ){` |
|      3899 |  3677 | `				SyBlobAppend(pWorker,SyBlobData(&sRaw),SyBlobLength(&sRaw)); /* FQN as written */` |
|      1952 |  3678 | `			}else{` |
...
|         - |  3696 | `				}` |
|         - |  3697 | `			}` |
|      3915 |  3698 | `			SyBlobRelease(&sRaw);` |
|         - |  3699 | `		}` |
|      3915 |  3700 | `		if( SyBlobLength(pWorker) > 0 ){` |
|         - |  3701 | `			ph7_value *pObj;` |
|         - |  3702 | `			SyString sPath;` |
|         - |  3703 | `			sxu32 nIdx;` |
|      3915 |  3704 | `			SyStringInitFromBuf(&sPath,(const char *)SyBlobData(pWorker),SyBlobLength(pWorker));` |
|         - |  3705 | `			/* Install in the literal table */` |
|      3915 |  3706 | `			if( SXRET_OK != GenStateFindLiteral(&(*pGen),&sPath,&nIdx) ){` |
|      3863 |  3707 | `				pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|      3863 |  3708 | `				if( pObj == 0 ){` |
|       ! 0 |  3709 | `					PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|       ! 0 |  3710 | `					return SXERR_ABORT;` |
|         - |  3711 | `				}` |
|      3863 |  3712 | `				PH7_MemObjInitFromString(pGen->pVm,pObj,&sPath);` |
|      3863 |  3713 | `				GenStateInstallLiteral(&(*pGen),pObj,nIdx);` |
|      1929 |  3714 | `			}` |
...
|      5870 |  3718 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,` |
|      1955 |  3719 | `				isAbsolute ? (PH7_LOADC_EXPAND\|PH7_LOADC_ABSOLUTE) : PH7_LOADC_EXPAND,` |
|      1955 |  3720 | `				nIdx,0,0);` |
|      3915 |  3721 | `			return SXRET_OK;` |
|         - |  3722 | `		}` |
|       ! 0 |  3723 | `	}` |
|         - |  3724 | `	/* Single-token literal: load directly */` |
|  12486373 |  3725 | `	rc = GenStateLoadLiteral(&(*pGen));` |
|  12486373 |  3726 | `	return rc;` |
|   6245144 |  3727 | `}` |
|         - |  3728 | `/*` |
...
|       ! 0 |  3743 | `}` |
|  12490278 |  3744 | `PH7_PRIVATE sxi32 PH7_CompileLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|         5 |  3745 | `{` |
|         - |  3746 | `	sxi32 rc;` |
|  12490283 |  3747 | `	rc = GenStateResolveNamespaceLiteral(&(*pGen));` |
|  12490283 |  3748 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  3749 | `		SXUNUSED(iCompileFlag); /* cc warning */` |
|       ! 0 |  3750 | `		return rc;` |
|         - |  3751 | `	}` |
|         - |  3752 | `	/* Node successfully compiled */` |
|  12490283 |  3753 | `	return SXRET_OK;` |
|   6245144 |  3754 | `}` |
|         - |  3755 | `/*` |
...
|         - |  3770 | ` */` |
|    336920 |  3771 | `static int GenStateIsReservedConstant(SyString *pName)` |
|         5 |  3772 | `{` |
|    336925 |  3773 | `	if( pName->nByte == sizeof("null") - 1 ){` |
|      3875 |  3774 | `		if( SyStrnicmp(pName->zString,"null",sizeof("null")-1) == 0 ){` |
|         3 |  3775 | `			return TRUE;` |
|      3873 |  3776 | `		}else if( SyStrnicmp(pName->zString,"true",sizeof("true")-1) == 0 ){` |
|         6 |  3777 | `			return TRUE;` |
|         5 |  3778 | `		}` |
|    334987 |  3779 | `	}else if( pName->nByte == sizeof("false") - 1 ){` |
|      7677 |  3780 | `		if( SyStrnicmp(pName->zString,"false",sizeof("false")-1) == 0 ){` |
|         3 |  3781 | `			return TRUE;` |
|         - |  3782 | `		}` |
|      3835 |  3783 | `	}` |
|         - |  3784 | `	/* Not a reserved constant */` |
|    336917 |  3785 | `	return FALSE;` |
|    168465 |  3786 | `}` |
|         - |  3787 | `/*` |
...
|         - |  3927 | ` */` |
|    153194 |  3928 | `static int GenStateEmitExceptionPopForBreak(ph7_gen_state *pGen,GenBlock *pTarget)` |
|         5 |  3929 | `{` |
|    153199 |  3930 | `	GenBlock *pBlock = pGen->pCurrent;` |
|    153199 |  3931 | `	int nInlineTry = 0;` |
|    689085 |  3932 | `	while( pBlock && pBlock != pTarget ){` |
|    535891 |  3933 | `		if( pBlock->iFlags & GEN_BLOCK_EXCEPTION ){` |
...
|         - |  3948 | `			}` |
|         2 |  3949 | `		}` |
|    535891 |  3950 | `		pBlock = pBlock->pParent;` |
|         5 |  3951 | `	}` |
|    153199 |  3952 | `	return nInlineTry;` |
|         5 |  3953 | `}` |
|     88048 |  3954 | `static sxi32 PH7_CompileContinue(ph7_gen_state *pGen)` |
|         5 |  3955 | `{` |
|         - |  3956 | `	GenBlock *pLoop; /* Target loop */` |
|         - |  3957 | `	sxi32 iLevel;    /* How many nesting loop to skip */` |
|         - |  3958 | `	sxu32 nLineLocal;` |
|         - |  3959 | `	sxi32 rc;` |
|     88053 |  3960 | `	nLineLocal = pGen->pIn->nLine;` |
|     88053 |  3961 | `	iLevel = 0;` |
|         - |  3962 | `	/* Jump the 'continue' keyword */` |
|     88053 |  3963 | `	pGen->pIn++;` |
|     88053 |  3964 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NUM) ){` |
...
|     88053 |  3990 | `	pLoop = GenStateFetchBlock(pGen->pCurrent,GEN_BLOCK_LOOP,iLevel);` |
|     88053 |  3991 | `	if( pLoop == 0 ){` |
...
|         - |  3997 | `		}` |
|         8 |  3998 | `	}else{` |
|     88043 |  3999 | `		sxu32 nInstrIdx = 0;` |
|         - |  4000 | `		/* Emit POP_EXCEPTION (legacy) for crossed try blocks, or count them (generator). */` |
|     88043 |  4001 | `		int nCross = GenStateEmitExceptionPopForBreak(&(*pGen),pLoop);` |
...
|     88043 |  4004 | `		sxi32 iJmpOp = nCross > 0 ? PH7_OP_SET_FINALLY_JMP : PH7_OP_JMP;` |
|     88043 |  4005 | `		if( pLoop->iFlags & GEN_BLOCK_SWITCH ){` |
...
|     88039 |  4021 | `			PH7_VmEmitInstr(pGen->pVm,iJmpOp,nCross,pLoop->nFirstInstr,0,&nInstrIdx);` |
|     88039 |  4022 | `			if( pLoop->bPostContinue == TRUE ){` |
|         - |  4023 | `				JumpFixup sJumpFix;` |
|         - |  4024 | `				/* Post-continue */` |
|     26799 |  4025 | `				sJumpFix.nJumpType = PH7_OP_JMP;` |
|     26799 |  4026 | `				sJumpFix.nInstrIdx = nInstrIdx;` |
|     26799 |  4027 | `				SySetPut(&pLoop->aPostContFix,(const void *)&sJumpFix);` |
|     13397 |  4028 | `			}` |
|         - |  4029 | `		}` |
|         - |  4030 | `	}` |
|     88053 |  4031 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
...
|         - |  4045 | ` */` |
|     65172 |  4046 | `static sxi32 PH7_CompileBreak(ph7_gen_state *pGen)` |
|         5 |  4047 | `{` |
...
|     65177 |  4053 | `	pGen->pIn++;` |
|     65177 |  4054 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NUM) ){` |
...
|     65177 |  4080 | `	pLoop = GenStateFetchBlock(pGen->pCurrent,GEN_BLOCK_LOOP,iLevel);` |
|     65177 |  4081 | `	if( pLoop == 0 ){` |
|         - |  4082 | `		/* Illegal break */` |
...
|     65161 |  4091 | `		int nCross = GenStateEmitExceptionPopForBreak(&(*pGen),pLoop);` |
|         - |  4092 | `		/* ROOT C: OP_SET_FINALLY_JMP runs the crossed inline finallys before the break jump. */` |
|     65161 |  4093 | `		rc = PH7_VmEmitInstr(pGen->pVm,nCross > 0 ? PH7_OP_SET_FINALLY_JMP : PH7_OP_JMP,nCross,0,0,&nInstrIdx);` |
|     65161 |  4094 | `		if( rc == SXRET_OK ){` |
|         - |  4095 | `			/* Fix the jump later when the jump destination is resolved */` |
|     65161 |  4096 | `			GenStateNewJumpFixup(pLoop,PH7_OP_JMP,nInstrIdx);` |
|     32578 |  4097 | `		}` |
|         - |  4098 | `	}` |
|     65177 |  4099 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
...
|         - |  4307 | ` * message.` |
|         - |  4308 | ` */` |
|   6274500 |  4309 | `static sxi32 PH7_CompileBlock(` |
...
|         - |  4314 | `	sxi32 rc;` |
|         - |  4315 | `	sxu32 nLine;` |
|   6274505 |  4316 | `	if( pGen->pIn->nType & PH7_TK_OCB /* '{' */ ){` |
|   6250459 |  4317 | `		nLine = pGen->pIn->nLine;` |
|   6250459 |  4318 | `		rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_STD,PH7_VmInstrLength(pGen->pVm),0,0);` |
|   6250459 |  4319 | `		if( rc != SXRET_OK ){` |
|       ! 0 |  4320 | `			return SXERR_ABORT;` |
|         - |  4321 | `		}` |
|   6250459 |  4322 | `		pGen->pIn++;` |
|         - |  4323 | `		/* Compile until we hit the closing braces '}' */` |
|   9201588 |  4324 | `		for(;;){` |
|  18403181 |  4325 | `			if( pGen->pIn >= pGen->pEnd ){` |
...
|         - |  4335 | `				}` |
|       ! 0 |  4336 | `			}` |
|  18403161 |  4337 | `			if( pGen->pIn->nType & PH7_TK_CCB/*'}'*/ ){` |
|         - |  4338 | `				/* Closing braces found,break immediately*/` |
|   6250439 |  4339 | `				pGen->pIn++;` |
|   6250439 |  4340 | `				break;` |
|         - |  4341 | `			}` |
|         - |  4342 | `			/* Compile a single statement */` |
|  12152727 |  4343 | `			rc = GenStateCompileChunk(&(*pGen),PH7_COMPILE_SINGLE_STMT);` |
|  12152727 |  4344 | `			if( rc == SXERR_ABORT ){` |
|       ! 0 |  4345 | `				return SXERR_ABORT;` |
|         - |  4346 | `			}` |
|         5 |  4347 | `		}` |
|   6250459 |  4348 | `		GenStateLeaveBlock(&(*pGen),0);` |
|   3149278 |  4349 | `	}else if( (pGen->pIn->nType & PH7_TK_COLON /* ':' */) && nKeywordEnd > 0 ){` |
|       ! 0 |  4350 | `		pGen->pIn++;` |
...
|     24051 |  4393 | `		rc = GenStateCompileChunk(&(*pGen),PH7_COMPILE_SINGLE_STMT);` |
|     24051 |  4394 | `		if( rc == SXERR_ABORT ){` |
|       ! 0 |  4395 | `			return SXERR_ABORT;` |
|         - |  4396 | `		}` |
|         - |  4397 | `	}` |
|         - |  4398 | `	/* Jump trailing semi-colons ';' */` |
|   6274505 |  4399 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|       ! 0 |  4400 | `		pGen->pIn++;` |
|       ! 0 |  4401 | `	}` |
|   6274505 |  4402 | `	return SXRET_OK;` |
|   3137255 |  4403 | `}` |
|         - |  4404 | `/*` |
...
|         - |  4421 | ` *   endwhile;` |
|         - |  4422 | ` */` |
|     72840 |  4423 | `static sxi32 PH7_CompileWhile(ph7_gen_state *pGen)` |
|         5 |  4424 | `{` |
|     72845 |  4425 | `	GenBlock *pWhileBlock = 0;` |
|     72845 |  4426 | `	SyToken *pTmp,*pEnd = 0;` |
|         - |  4427 | `	sxu32 nFalseJump;` |
|         - |  4428 | `	sxu32 nLine;` |
|         - |  4429 | `	sxi32 rc;` |
|     72845 |  4430 | `	nLine = pGen->pIn->nLine;` |
|         - |  4431 | `	/* Jump the 'while' keyword */` |
|     72845 |  4432 | `	pGen->pIn++;` |
|     72845 |  4433 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|         - |  4434 | `		/* Syntax error */` |
...
|     72845 |  4445 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pWhileBlock);` |
|     72845 |  4446 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  4447 | `		return SXERR_ABORT;` |
|         - |  4448 | `	}` |
|         - |  4449 | `	/* Delimit the condition */` |
|     72845 |  4450 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|     72845 |  4451 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|     72845 |  4460 | `	pTmp = pGen->pEnd;` |
|     72845 |  4461 | `	pGen->pEnd = pEnd;` |
|         - |  4462 | `	/* Compile the expression */` |
|     72845 |  4463 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|     72845 |  4464 | `	if( rc == SXERR_ABORT ){` |
|         - |  4465 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|       ! 0 |  4466 | `		return SXERR_ABORT;` |
|         - |  4467 | `	}` |
|         - |  4468 | `	/* Update token stream */` |
|     72845 |  4469 | `	while(pGen->pIn < pEnd ){` |
...
|     72845 |  4477 | `	pGen->pIn  = &pEnd[1];` |
|     72845 |  4478 | `	pGen->pEnd = pTmp;` |
|         - |  4479 | `	/* Emit the false jump */` |
|     72845 |  4480 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nFalseJump);` |
|         - |  4481 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|     72845 |  4482 | `	GenStateNewJumpFixup(pWhileBlock,PH7_OP_JZ,nFalseJump);` |
|         - |  4483 | `	/* Compile the loop body */` |
|     72845 |  4484 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDWHILE);` |
|     72845 |  4485 | `	if( rc == SXERR_ABORT ){` |
|       ! 0 |  4486 | `		return SXERR_ABORT;` |
|         - |  4487 | `	}` |
|         - |  4488 | `	/* Emit the unconditional jump to the start of the loop */` |
|     72845 |  4489 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pWhileBlock->nFirstInstr,0,0);` |
|         - |  4490 | `	/* Fix all jumps now the destination is resolved */` |
|     72845 |  4491 | `	GenStateFixJumps(pWhileBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|         - |  4492 | `	/* Release the loop block */` |
|     72845 |  4493 | `	GenStateLeaveBlock(pGen,0);` |
|         - |  4494 | `	/* Statement successfully compiled */` |
|     72845 |  4495 | `	return SXRET_OK;` |
|       ! 0 |  4496 | `Synchronize:` |
...
|         - |  4651 | ` */` |
|    122580 |  4652 | `static sxi32 PH7_CompileFor(ph7_gen_state *pGen)` |
|         5 |  4653 | `{` |
|    122585 |  4654 | `	SyToken *pTmp,*pPostStart,*pEnd = 0;` |
|    122585 |  4655 | `	GenBlock *pForBlock = 0;` |
|         - |  4656 | `	sxu32 nFalseJump;` |
|         - |  4657 | `	sxu32 nLine;` |
|         - |  4658 | `	sxi32 rc;` |
|    122585 |  4659 | `	nLine = pGen->pIn->nLine;` |
|         - |  4660 | `	/* Jump the 'for' keyword */` |
|    122585 |  4661 | `	pGen->pIn++;` |
|    122585 |  4662 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|         - |  4663 | `		/* Syntax error */` |
...
|    122585 |  4672 | `	pGen->pIn++;` |
|         - |  4673 | `	/* Delimit the init-expr;condition;post-expr */` |
|    122585 |  4674 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|    122585 |  4675 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|    122585 |  4690 | `	pTmp = pGen->pEnd;` |
|    122585 |  4691 | `	pGen->pEnd = pEnd;` |
...
|    122585 |  4696 | `	pGen->nCommaExprOk++;` |
|         - |  4697 | `	/* Compile initialization expressions if available */` |
|    122585 |  4698 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|         - |  4699 | `	/* Pop operand lvalues */` |
|    122585 |  4700 | `	if( rc == SXERR_ABORT ){` |
|         - |  4701 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|       ! 0 |  4702 | `		return SXERR_ABORT;` |
|    122585 |  4703 | `	}else if( rc != SXERR_EMPTY ){` |
|    111105 |  4704 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|     55550 |  4705 | `	}` |
|    122585 |  4706 | `	if( (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|         - |  4707 | `		/* Syntax error */` |
...
|    122585 |  4716 | `	pGen->pIn++;` |
|         - |  4717 | `	/* Create the loop block */` |
|    122585 |  4718 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pForBlock);` |
|    122585 |  4719 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  4720 | `		return SXERR_ABORT;` |
|         - |  4721 | `	}` |
|         - |  4722 | `	/* Deffer continue jumps */` |
|    122585 |  4723 | `	pForBlock->bPostContinue = TRUE;` |
|         - |  4724 | `	/* Compile the condition */` |
|    122585 |  4725 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|    122585 |  4726 | `	if( rc == SXERR_ABORT ){` |
|         - |  4727 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|       ! 0 |  4728 | `		return SXERR_ABORT;` |
|    122585 |  4729 | `	}else if( rc != SXERR_EMPTY ){` |
|         - |  4730 | `		/* Emit the false jump */` |
|    111105 |  4731 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nFalseJump);` |
|         - |  4732 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|    111105 |  4733 | `		GenStateNewJumpFixup(pForBlock,PH7_OP_JZ,nFalseJump);` |
|     55550 |  4734 | `	}` |
|    122585 |  4735 | `	if( (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|         - |  4736 | `		/* Syntax error */` |
...
|    122581 |  4745 | `	pGen->pIn++;` |
|         - |  4746 | `	/* Save the post condition stream */` |
|    122581 |  4747 | `	pPostStart = pGen->pIn;` |
...
|    122581 |  4750 | `	pGen->nCommaExprOk--;` |
|    122581 |  4751 | `	pGen->pIn  = &pEnd[1]; /* Jump the trailing parenthesis ')' */` |
|    122581 |  4752 | `	pGen->pEnd = pTmp;` |
|    122581 |  4753 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDFOR);` |
|    122581 |  4754 | `	if( rc == SXERR_ABORT ){` |
|       ! 0 |  4755 | `		return SXERR_ABORT;` |
|         - |  4756 | `	}` |
|         - |  4757 | `	/* Fix post-continue jumps */` |
|    122581 |  4758 | `	if( SySetUsed(&pForBlock->aPostContFix) > 0 ){` |
|         - |  4759 | `		JumpFixup *aPost;` |
|         - |  4760 | `		VmInstr *pInstr;` |
|         - |  4761 | `		sxu32 nJumpDest;` |
|         - |  4762 | `		sxu32 n;` |
|     11495 |  4763 | `		aPost = (JumpFixup *)SySetBasePtr(&pForBlock->aPostContFix);` |
|     11495 |  4764 | `		nJumpDest = PH7_VmInstrLength(pGen->pVm);` |
|     38289 |  4765 | `		for( n = 0 ; n < SySetUsed(&pForBlock->aPostContFix) ; ++n ){` |
|     26799 |  4766 | `			pInstr = PH7_VmGetInstr(pGen->pVm,aPost[n].nInstrIdx);` |
|     26799 |  4767 | `			if( pInstr ){` |
|         - |  4768 | `				/* Fix jump */` |
|     26799 |  4769 | `				pInstr->iP2 = nJumpDest;` |
|     13397 |  4770 | `			}` |
|     13402 |  4771 | `		}` |
|      5745 |  4772 | `	}` |
|         - |  4773 | `	/* compile the post-expressions if available */` |
|    122581 |  4774 | `	while( pPostStart < pEnd && (pPostStart->nType & PH7_TK_SEMI) ){` |
|       ! 0 |  4775 | `		pPostStart++;` |
|       ! 0 |  4776 | `	}` |
|    122581 |  4777 | `	if( pPostStart < pEnd ){` |
|         - |  4778 | `		SyToken *pTmpIn,*pTmpEnd;` |
|    111103 |  4779 | `		SWAP_DELIMITER(pGen,pPostStart,pEnd);` |
|    111103 |  4780 | `		pGen->nCommaExprOk++; /* post-expressions are a clause list again */` |
|    111103 |  4781 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|    111103 |  4782 | `		pGen->nCommaExprOk--;` |
|    111103 |  4783 | `		if( pGen->pIn < pGen->pEnd ){` |
|         - |  4784 | `			/* Syntax error */` |
...
|         - |  4791 | `		}` |
|    111103 |  4792 | `		RE_SWAP_DELIMITER(pGen);` |
|    111103 |  4793 | `		if( rc == SXERR_ABORT ){` |
|         - |  4794 | `			/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|       ! 0 |  4795 | `			return SXERR_ABORT;` |
|    111103 |  4796 | `		}else if( rc != SXERR_EMPTY){` |
|         - |  4797 | `			/* Pop operand lvalue */` |
|    111103 |  4798 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|     55549 |  4799 | `		}` |
|     55549 |  4800 | `	}` |
|         - |  4801 | `	/* Emit the unconditional jump to the start of the loop */` |
|    122581 |  4802 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pForBlock->nFirstInstr,0,0);` |
|         - |  4803 | `	/* Fix all jumps now the destination is resolved */` |
|    122581 |  4804 | `	GenStateFixJumps(pForBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|         - |  4805 | `	/* Release the loop block */` |
|    122581 |  4806 | `	GenStateLeaveBlock(pGen,0);` |
|         - |  4807 | `	/* Statement successfully compiled */` |
|    122581 |  4808 | `	return SXRET_OK;` |
|     61295 |  4809 | `}` |
...
|         - |  4812 | ` * are allowed.` |
|         - |  4813 | ` */` |
|    444876 |  4814 | `static sxi32 GenStateForEachNodeValidator(ph7_gen_state *pGen,ph7_expr_node *pRoot)` |
|         5 |  4815 | `{` |
|    444881 |  4816 | `	sxi32 rc = SXRET_OK; /* Assume a valid expression tree */` |
|    444881 |  4817 | `	if( pRoot->xCode != PH7_CompileVariable ){` |
...
|         - |  4852 | ` */` |
|    310684 |  4853 | `static sxi32 PH7_CompileForeach(ph7_gen_state *pGen)` |
|         5 |  4854 | `{` |
|    310689 |  4855 | `	SyToken *pCur,*pTmp,*pEnd = 0;` |
|    310689 |  4856 | `	SyToken *pListStart = 0,*pListEnd = 0;` |
|    310689 |  4857 | `	GenBlock *pForeachBlock = 0;` |
|         - |  4858 | `	ph7_foreach_info *pInfo;` |
|         - |  4859 | `	sxu32 nFalseJump;` |
|         - |  4860 | `	VmInstr *pInstr;` |
|         - |  4861 | `	sxu32 nLine;` |
|         - |  4862 | `	sxi32 rc;` |
|    310689 |  4863 | `	nLine = pGen->pIn->nLine;` |
|         - |  4864 | `	/* Jump the 'foreach' keyword */` |
|    310689 |  4865 | `	pGen->pIn++;` |
|    310689 |  4866 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|         - |  4867 | `		/* Syntax error */` |
...
|    310689 |  4876 | `	pGen->pIn++;` |
|         - |  4877 | `	/* Create the loop block */` |
|    310689 |  4878 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pForeachBlock);` |
|    310689 |  4879 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  4880 | `		return SXERR_ABORT;` |
|         - |  4881 | `	}` |
|         - |  4882 | `	/* Delimit the expression */` |
|    310689 |  4883 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|    310689 |  4884 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|    310689 |  4899 | `	pCur = pGen->pIn;` |
|   1787413 |  4900 | `	while( pCur < pEnd ){` |
|   1787413 |  4901 | `		if( pCur->nType & PH7_TK_KEYWORD ){` |
|    341311 |  4902 | `			sxi32 nKeywrd = SX_PTR_TO_INT(pCur->pUserData);` |
|    341311 |  4903 | `			if( nKeywrd == PH7_TKWRD_AS ){` |
...
|    310689 |  4921 | `	pTmp = pGen->pEnd;` |
|    310689 |  4922 | `	pGen->pEnd = pCur;` |
|    310689 |  4923 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|    310689 |  4924 | `	if( rc == SXERR_ABORT ){` |
|         - |  4925 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|       ! 0 |  4926 | `		return SXERR_ABORT;` |
|         - |  4927 | `	}` |
|         - |  4928 | `	/* Update token stream */` |
|    310689 |  4929 | `	while(pGen->pIn < pCur ){` |
...
|       ! 0 |  4935 | `		pGen->pIn++;` |
|       ! 0 |  4936 | `	}` |
|    310689 |  4937 | `	pCur++; /* Jump the 'as' keyword */` |
|    310689 |  4938 | `	pGen->pIn = pCur;` |
|    310689 |  4939 | `	if( pGen->pIn >= pEnd ){` |
...
|    310689 |  4946 | `	pInfo = (ph7_foreach_info *)SyMemBackendAlloc(&pGen->pVm->sAllocator,sizeof(ph7_foreach_info));` |
|    310689 |  4947 | `	if( pInfo == 0 ){` |
...
|    310689 |  4952 | `	SyZero(pInfo,sizeof(ph7_foreach_info));` |
|         - |  4953 | `	/* Initialize structure fields */` |
|    310689 |  4954 | `	SySetInit(&pInfo->aStep,&pGen->pVm->sAllocator,sizeof(ph7_foreach_step *));` |
...
|         - |  4957 | `	 * '=>'. */` |
|    310689 |  4958 | `	pCur = GenStateFindTopLevelArrow(pCur,pEnd);` |
|    310689 |  4959 | `	if( pCur < pEnd ){` |
|         - |  4960 | `		/* Compile the expression holding the key name */` |
|    134219 |  4961 | `		if( pGen->pIn >= pCur ){` |
...
|         - |  4966 | `			}` |
|       ! 0 |  4967 | `		}else{` |
|    134219 |  4968 | `			pGen->pEnd = pCur;` |
|    134219 |  4969 | `			rc = PH7_CompileExpr(&(*pGen),0,GenStateForEachNodeValidator);` |
|    134219 |  4970 | `			if( rc == SXERR_ABORT ){` |
|         - |  4971 | `				/* Don't worry about freeing memory, everything will be released shortly */` |
|       ! 0 |  4972 | `				return SXERR_ABORT;` |
|         - |  4973 | `			}` |
|    134219 |  4974 | `			pInstr = PH7_VmPopInstr(pGen->pVm);` |
|    134219 |  4975 | `			if( pInstr->p3 ){` |
|         - |  4976 | `				/* Record key name */` |
|    134219 |  4977 | `				SyStringInitFromBuf(&pInfo->sKey,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|     67107 |  4978 | `			}` |
|    134219 |  4979 | `			pInfo->iFlags \|= PH7_4EACH_STEP_KEY;` |
|         - |  4980 | `		}` |
|    134219 |  4981 | `		pGen->pIn = &pCur[1]; /* Jump the arrow */` |
|     67107 |  4982 | `	}` |
|    310689 |  4983 | `	pGen->pEnd = pEnd;` |
|    310689 |  4984 | `	if( pGen->pIn >= pEnd ){` |
...
|    310684 |  5039 | `	}else if( pGen->pIn->nType & PH7_TK_OSB ){` |
...
|    310667 |  5072 | `		rc = PH7_CompileExpr(&(*pGen),0,GenStateForEachNodeValidator);` |
|    310667 |  5073 | `		if( rc == SXERR_ABORT ){` |
|         - |  5074 | `			/* Don't worry about freeing memory, everything will be released shortly */` |
|       ! 0 |  5075 | `			return SXERR_ABORT;` |
|         - |  5076 | `		}` |
|    310667 |  5077 | `		pInstr = PH7_VmPopInstr(pGen->pVm);` |
|    310667 |  5078 | `		if( pInstr->p3 ){` |
|         - |  5079 | `			/* Record value name */` |
|    310667 |  5080 | `			SyStringInitFromBuf(&pInfo->sValue,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|    155331 |  5081 | `		}` |
|         - |  5082 | `	}` |
|         - |  5083 | `	/* Emit the 'FOREACH_INIT' instruction */` |
|    310687 |  5084 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_FOREACH_INIT,0,0,pInfo,&nFalseJump);` |
|         - |  5085 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|    310687 |  5086 | `	GenStateNewJumpFixup(pForeachBlock,PH7_OP_FOREACH_INIT,nFalseJump);` |
|         - |  5087 | `	/* Record the first instruction to execute */` |
|    310687 |  5088 | `	pForeachBlock->nFirstInstr = PH7_VmInstrLength(pGen->pVm);` |
|         - |  5089 | `	/* Emit the FOREACH_STEP instruction */` |
|    310687 |  5090 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_FOREACH_STEP,0,0,pInfo,&nFalseJump);` |
|         - |  5091 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|    310687 |  5092 | `	GenStateNewJumpFixup(pForeachBlock,PH7_OP_FOREACH_STEP,nFalseJump);` |
|         - |  5093 | `	/* If list() unpacking, emit bytecode to destructure the temp variable */` |
|    310687 |  5094 | `	if( (pInfo->iFlags & PH7_4EACH_STEP_LIST) && pListStart && pListEnd ){` |
...
|    310687 |  5122 | `	pGen->pIn = &pEnd[1];` |
|    310687 |  5123 | `	pGen->pEnd = pTmp;` |
|    310687 |  5124 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_END4EACH);` |
|    310687 |  5125 | `	if( rc == SXERR_ABORT ){` |
...
|    310687 |  5130 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pForeachBlock->nFirstInstr,0,0);` |
|         - |  5131 | `	/* Fix all jumps now the destination is resolved */` |
|    310687 |  5132 | `	GenStateFixJumps(pForeachBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|         - |  5133 | `	/* Release the loop block */` |
|    310687 |  5134 | `	GenStateLeaveBlock(pGen,0);` |
|         - |  5135 | `	/* Statement successfully compiled */` |
|    310687 |  5136 | `	return SXRET_OK;` |
|         1 |  5137 | `Synchronize:` |
...
|         - |  5176 | ` *    ?>` |
|         - |  5177 | ` */` |
|   2259338 |  5178 | `static sxi32 PH7_CompileIf(ph7_gen_state *pGen)` |
|         5 |  5179 | `{` |
|   2259343 |  5180 | `	SyToken *pToken,*pTmp,*pEnd = 0;` |
|   2259343 |  5181 | `	GenBlock *pCondBlock = 0;` |
|         - |  5182 | `	sxu32 nJumpIdx;` |
|         - |  5183 | `	sxu32 nKeyID;` |
|         - |  5184 | `	sxi32 rc;` |
|         - |  5185 | `	/* Jump the 'if' keyword */` |
|   2259343 |  5186 | `	pGen->pIn++;` |
|   2259343 |  5187 | `	pToken = pGen->pIn;` |
|         - |  5188 | `	/* Create the conditional block */` |
|   2259343 |  5189 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_COND,PH7_VmInstrLength(pGen->pVm),0,&pCondBlock);` |
|   2259343 |  5190 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  5191 | `		return SXERR_ABORT;` |
|         - |  5192 | `	}` |
|         - |  5193 | `	/* Process as many [if/else if/elseif/else] blocks as we can */` |
|   1269379 |  5194 | `	for(;;){` |
|   2538763 |  5195 | `		if( pToken >= pGen->pEnd \|\| (pToken->nType & PH7_TK_LPAREN) == 0 ){` |
|         - |  5196 | `			/* Syntax error */` |
...
|   2538763 |  5210 | `		PH7_DelimitNestedTokens(pToken,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   2538763 |  5211 | `		if( pToken >= pEnd \|\| (pEnd->nType & PH7_TK_RPAREN) == 0 ){` |
|         - |  5212 | `			/* Syntax error */` |
...
|   2538755 |  5224 | `		SWAP_TOKEN_STREAM(pGen,pToken,pEnd);` |
|         - |  5225 | `		/* Compile the condition */` |
|   2538755 |  5226 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|         - |  5227 | `		/* Update token stream */` |
|   2538755 |  5228 | `		while(pGen->pIn < pEnd ){` |
|       ! 0 |  5229 | `			PH7_GenSyntaxError(&(*pGen),pGen->pIn,0);` |
|       ! 0 |  5230 | `			pGen->pIn++;` |
|       ! 0 |  5231 | `		}` |
|   2538755 |  5232 | `		pGen->pIn  = &pEnd[1];` |
|   2538755 |  5233 | `		pGen->pEnd = pTmp;` |
|   2538755 |  5234 | `		if( rc == SXERR_ABORT ){` |
|         - |  5235 | `			/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|       ! 0 |  5236 | `			return SXERR_ABORT;` |
|         - |  5237 | `		}` |
|         - |  5238 | `		/* Emit the false jump */` |
|   2538755 |  5239 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nJumpIdx);` |
|         - |  5240 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   2538755 |  5241 | `		GenStateNewJumpFixup(pCondBlock,PH7_OP_JZ,nJumpIdx);` |
|         - |  5242 | `		/* Compile the body */` |
|   2538755 |  5243 | `		rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDIF);` |
|   2538755 |  5244 | `		if( rc == SXERR_ABORT ){` |
|       ! 0 |  5245 | `			return SXERR_ABORT;` |
|         - |  5246 | `		}` |
|   2538755 |  5247 | `		if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
|    501828 |  5248 | `			break;` |
|         - |  5249 | `		}` |
|         - |  5250 | `		/* Ensure that the keyword ID is 'else if' or 'else' */` |
|   1535109 |  5251 | `		nKeyID = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   1535109 |  5252 | `		if( (nKeyID & (PH7_TKWRD_ELSE\|PH7_TKWRD_ELIF)) == 0 ){` |
|   1040979 |  5253 | `			break;` |
|         - |  5254 | `		}` |
|         - |  5255 | `		/* Emit the unconditional jump */` |
|    494135 |  5256 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,0,0,&nJumpIdx);` |
|         - |  5257 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|    494135 |  5258 | `		GenStateNewJumpFixup(pCondBlock,PH7_OP_JMP,nJumpIdx);` |
|    494135 |  5259 | `		if( nKeyID & PH7_TKWRD_ELSE ){` |
|    298887 |  5260 | `			pToken = &pGen->pIn[1];` |
|    298887 |  5261 | `			if( pToken >= pGen->pEnd \|\| (pToken->nType & PH7_TK_KEYWORD) == 0 \|\|` |
|     84210 |  5262 | `				SX_PTR_TO_INT(pToken->pUserData) != PH7_TKWRD_IF ){` |
|    107360 |  5263 | `					break;` |
|         - |  5264 | `			}` |
|     84177 |  5265 | `			pGen->pIn++; /* Jump the 'else' keyword */` |
|     42086 |  5266 | `		}` |
|    279425 |  5267 | `		pGen->pIn++; /* Jump the 'elseif/if' keyword */` |
|         - |  5268 | `		/* Synchronize cursors */` |
|    279425 |  5269 | `		pToken = pGen->pIn;` |
|         - |  5270 | `		/* Fix the false jump */` |
|    279425 |  5271 | `		GenStateFixJumps(pCondBlock,PH7_OP_JZ,PH7_VmInstrLength(pGen->pVm));` |
|         5 |  5272 | `	} /* For(;;) */` |
|         - |  5273 | `	/* Fix the false jump */` |
|   2259335 |  5274 | `	GenStateFixJumps(pCondBlock,PH7_OP_JZ,PH7_VmInstrLength(pGen->pVm));` |
|   2259335 |  5275 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|   1255684 |  5276 | `		(SX_PTR_TO_INT(pGen->pIn->pUserData) & PH7_TKWRD_ELSE) ){` |
|         - |  5277 | `			/* Compile the else block */` |
|    214715 |  5278 | `			pGen->pIn++;` |
|    214715 |  5279 | `			rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDIF);` |
|    214715 |  5280 | `			if( rc == SXERR_ABORT ){` |
|         - |  5281 |  |
|       ! 0 |  5282 | `				return SXERR_ABORT;` |
|         - |  5283 | `			}` |
|    107355 |  5284 | `	}` |
|   2259335 |  5285 | `	nJumpIdx = PH7_VmInstrLength(pGen->pVm);` |
|         - |  5286 | `	/* Fix all unconditional jumps now the destination is resolved */` |
|   2259335 |  5287 | `	GenStateFixJumps(pCondBlock,PH7_OP_JMP,nJumpIdx);` |
|         - |  5288 | `	/* Release the conditional block */` |
|   2259335 |  5289 | `	GenStateLeaveBlock(pGen,0);` |
|         - |  5290 | `	/* Statement successfully compiled */` |
|   2259335 |  5291 | `	return SXRET_OK;` |
|         4 |  5292 | `Synchronize:` |
...
|         - |  5392 | ` */` |
|   3155014 |  5393 | `static sxi32 PH7_CompileReturn(ph7_gen_state *pGen)` |
|         5 |  5394 | `{` |
|   3155019 |  5395 | `	sxi32 nRet = 0; /* TRUE if there is a return value */` |
|         - |  5396 | `	sxi32 rc;` |
|   3155019 |  5397 | `	sxu32 nLine = pGen->pIn->nLine;` |
|   3155019 |  5398 | `	GenBlock *pFuncBlock = pGen->pCurrent;` |
...
|   8254459 |  5404 | `	while( pFuncBlock && (pFuncBlock->iFlags & GEN_BLOCK_FUNC) == 0 ){` |
|   5099445 |  5405 | `		pFuncBlock = pFuncBlock->pParent;` |
|         5 |  5406 | `	}` |
|   3155014 |  5407 | `	if( pFuncBlock && pFuncBlock->pUserData` |
|   3154985 |  5408 | `	 && ((ph7_vm_func *)pFuncBlock->pUserData)->nReturnType == MEMOBJ_NEVER ){` |
...
|   3155019 |  5416 | `	pGen->pIn++;` |
|   3155019 |  5417 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|         - |  5418 | `		/* Compile the expression */` |
|   3059339 |  5419 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   3059339 |  5420 | `		if( rc == SXERR_ABORT ){` |
|       ! 0 |  5421 | `			return SXERR_ABORT;` |
|   3059339 |  5422 | `		}else if(rc != SXERR_EMPTY ){` |
|   3059339 |  5423 | `			nRet = 1;` |
|   1529667 |  5424 | `		}` |
|   1529667 |  5425 | `	}` |
...
|   3155019 |  5430 | `	if( pGen->bInGenerator ){` |
|      3859 |  5431 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_SET_FINALLY_RET,nRet,0,0,0);` |
|      3859 |  5432 | `		return SXRET_OK;` |
|         - |  5433 | `	}` |
...
|   3151165 |  5439 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,nRet,1,0,0);` |
|   3151165 |  5440 | `	return SXRET_OK;` |
|   1577512 |  5441 | `}` |
|         - |  5442 | `/*` |
...
|         - |  5447 | ` */` |
|     15690 |  5448 | `PH7_PRIVATE sxi32 PH7_CompileYield(ph7_gen_state *pGen, sxi32 iCompileFlag)` |
|         5 |  5449 | `{` |
|         - |  5450 | `	SyToken *pTmp, *pSplit;` |
|     15695 |  5451 | `	sxi32 iP1 = 0; /* 1 if value present */` |
|     15695 |  5452 | `	sxi32 iP2 = 0; /* 1 if key => value */` |
|         - |  5453 | `	sxi32 rc;` |
|      7845 |  5454 | `	(void)iCompileFlag;` |
...
|     15690 |  5462 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_ID)` |
|      7880 |  5463 | `		&& pGen->pIn->sData.nByte == 4` |
...
|         - |  5480 | `	}` |
|     15633 |  5481 | `	if( pGen->pIn >= pGen->pEnd ){` |
...
|     15631 |  5487 | `	pSplit = 0;` |
|         - |  5488 | `	{` |
|     15631 |  5489 | `		SyToken *pCur = pGen->pIn;` |
|     15631 |  5490 | `		sxi32 nNest = 0;` |
|     46697 |  5491 | `		while( pCur < pGen->pEnd ){` |
|     46389 |  5492 | `			if( pCur->nType & (PH7_TK_LPAREN\|PH7_TK_OSB\|PH7_TK_OCB) ){` |
|        18 |  5493 | `				nNest++;` |
|     46381 |  5494 | `			}else if( pCur->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB) ){` |
|        18 |  5495 | `				nNest--;` |
|     46365 |  5496 | `			}else if( nNest == 0 && (pCur->nType & PH7_TK_ARRAY_OP) ){` |
|     15323 |  5497 | `				pSplit = pCur;` |
|     15323 |  5498 | `				break;` |
|         - |  5499 | `			}` |
|     31071 |  5500 | `			pCur++;` |
|         5 |  5501 | `		}` |
|         - |  5502 | `	}` |
|     15631 |  5503 | `	pTmp = pGen->pEnd;` |
|     15631 |  5504 | `	if( pSplit ){` |
|         - |  5505 | `		/* yield $key => $value */` |
|     15323 |  5506 | `		pGen->pEnd = pSplit;` |
|     15323 |  5507 | `		rc = PH7_CompileExpr(pGen, 0, 0);` |
|     15323 |  5508 | `		if( rc == SXERR_ABORT ) return SXERR_ABORT;` |
|     15323 |  5509 | `		pGen->pIn = pSplit + 1; /* Skip '=>' */` |
|     15323 |  5510 | `		pGen->pEnd = pTmp;` |
|     15323 |  5511 | `		rc = PH7_CompileExpr(pGen, 0, 0);` |
|     15323 |  5512 | `		if( rc == SXERR_ABORT ) return SXERR_ABORT;` |
|     15323 |  5513 | `		iP1 = 1;` |
|     15323 |  5514 | `		iP2 = 1;` |
|      7664 |  5515 | `	}else{` |
|         - |  5516 | `		/* yield $value */` |
...
|       154 |  5521 | `		}` |
|         - |  5522 | `	}` |
|     15631 |  5523 | `	pGen->pEnd = pTmp;` |
|     15631 |  5524 | `	PH7_VmEmitInstr(pGen->pVm, PH7_OP_YIELD, iP1, iP2, 0, 0);` |
|     15631 |  5525 | `	return SXRET_OK;` |
|      7850 |  5526 | `}` |
|         - |  5527 | `/*` |
...
|         - |  5553 | ` */` |
|     18086 |  5554 | `static sxi32 PH7_CompileEcho(ph7_gen_state *pGen)` |
|         5 |  5555 | `{` |
|     18091 |  5556 | `	SyToken *pTmp,*pNext = 0;` |
|     18091 |  5557 | `	sxu32 nLine = pGen->pIn->nLine;` |
|     18091 |  5558 | `	int nExpr = 0;      /* expressions actually compiled */` |
|     18091 |  5559 | `	int bExpectMore = 1;/* after 'echo' or a comma an expression is REQUIRED */` |
|         - |  5560 | `	sxi32 rc;` |
|         - |  5561 | `	/* Jump the 'echo' keyword */` |
|     18091 |  5562 | `	pGen->pIn++;` |
|         - |  5563 | `	/* Compile arguments one after one */` |
|     18091 |  5564 | `	pTmp = pGen->pEnd;` |
|     45929 |  5565 | `	while( SXRET_OK == PH7_GetNextExpr(pGen->pIn,pTmp,&pNext) ){` |
|     27845 |  5566 | `		if( pGen->pIn < pNext ){` |
|     27845 |  5567 | `			pGen->pEnd = pNext;` |
|     27845 |  5568 | `			rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_RDONLY_LOAD/* Do not create variable if inexistant */,0);` |
|     27845 |  5569 | `			if( rc == SXERR_ABORT ){` |
|       ! 0 |  5570 | `				return SXERR_ABORT;` |
|     27845 |  5571 | `			}else if( rc != SXERR_EMPTY ){` |
|         - |  5572 | `				/* Emit the consume instruction */` |
|     27819 |  5573 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_CONSUME,1,0,0,0);` |
|     27819 |  5574 | `				nExpr++;` |
|     27819 |  5575 | `				bExpectMore = 0;` |
|     13907 |  5576 | `			}` |
|     13920 |  5577 | `		}` |
...
|     37605 |  5580 | `		while( pNext < pTmp && (pNext->nType & PH7_TK_COMMA) ){` |
|      9767 |  5581 | `			if( bExpectMore ){` |
...
|         - |  5586 | `			}` |
|      9765 |  5587 | `			bExpectMore = 1;` |
|      9765 |  5588 | `			pNext++;` |
|         5 |  5589 | `		}` |
|     27843 |  5590 | `		pGen->pIn = pNext;` |
|         5 |  5591 | `	}` |
|         - |  5592 | `	/* Restore token stream */` |
|     18089 |  5593 | `	pGen->pEnd = pTmp;` |
|     18089 |  5594 | `	if( nExpr == 0 \|\| bExpectMore ){` |
...
|         - |  5615 | ` */` |
|     11490 |  5616 | `static sxi32 PH7_CompileStatic(ph7_gen_state *pGen)` |
|         5 |  5617 | `{` |
...
|     11490 |  5628 | `	if( &pGen->pIn[1] < pGen->pEnd && (pGen->pIn[1].nType & PH7_TK_KEYWORD)` |
|      5751 |  5629 | `	 && (SX_PTR_TO_INT(pGen->pIn[1].pUserData) == PH7_TKWRD_FUNCTION` |
...
|     11493 |  5640 | `	nLine = pGen->pIn->nLine;` |
|     11493 |  5641 | `	pGen->pIn++;` |
|         - |  5642 | `	/* Extract the enclosing function if any */` |
|     11493 |  5643 | `	pBlock = pGen->pCurrent;` |
|     22981 |  5644 | `	while( pBlock ){` |
|     22981 |  5645 | `		if( pBlock->iFlags & GEN_BLOCK_FUNC){` |
|     11493 |  5646 | `			break;` |
|         - |  5647 | `		}` |
|         - |  5648 | `		/* Point to the upper block */` |
|     11493 |  5649 | `		pBlock = pBlock->pParent;` |
|         5 |  5650 | `	}` |
|     11493 |  5651 | `	if( pBlock == 0 ){` |
...
|         - |  5669 | `	}` |
|     11493 |  5670 | `	pFunc = (ph7_vm_func *)pBlock->pUserData;` |
|         - |  5671 | `	/* Make sure we are dealing with a valid statement */` |
|     11493 |  5672 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 \|\| &pGen->pIn[1] >= pGen->pEnd \|\|` |
|     11486 |  5673 | `		(pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|     11491 |  5682 | `	pName = &pGen->pIn->sData;` |
|     11491 |  5683 | `	pGen->pIn++; /* Jump the var name */` |
|     11491 |  5684 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & (PH7_TK_SEMI/*';'*/\|PH7_TK_EQUAL/*'='*/)) == 0 ){` |
...
|     11491 |  5689 | `	SySetInit(&sStatic.aByteCode,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|     11491 |  5690 | `	sStatic.nIdx = SXU32_HIGH; /* Not yet created */` |
|         - |  5691 | `	/* Duplicate variable name */` |
|     11491 |  5692 | `	zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|     11491 |  5693 | `	if( zDup == 0 ){` |
|       ! 0 |  5694 | `		PH7_GenCompileError(&(*pGen),E_ERROR,nLine,"Fatal, PH7 engine is running out of memory");` |
|       ! 0 |  5695 | `		return SXERR_ABORT;` |
|         - |  5696 | `	}` |
|     11491 |  5697 | `	SyStringInitFromBuf(&sStatic.sName,zDup,pName->nByte);` |
|         - |  5698 | `	/* Check if we have an expression to compile */` |
|     11491 |  5699 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_EQUAL) ){` |
...
|         - |  5706 | `		 */` |
|     11491 |  5707 | `		pGen->pIn++; /* Jump the equal '=' sign */` |
|         - |  5708 | `		/* Swap bytecode container */` |
|     11491 |  5709 | `		pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|     11491 |  5710 | `		PH7_VmSetByteCodeContainer(pGen->pVm,&sStatic.aByteCode);` |
|         - |  5711 | `		/* Compile the expression */` |
|     11491 |  5712 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|         - |  5713 | `		/* Emit the done instruction */` |
|     11491 |  5714 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,(rc != SXERR_EMPTY ? 1 : 0),0,0,0);` |
|         - |  5715 | `		/* Restore default bytecode container */` |
|     11491 |  5716 | `		PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|      5743 |  5717 | `	}` |
|         - |  5718 | `	/* Finally save the compiled static variable in the appropriate container */` |
|     11491 |  5719 | `	SySetPut(&pFunc->aStatic,(const void *)&sStatic);` |
|     11491 |  5720 | `	return SXRET_OK;` |
|         1 |  5721 | `Synchronize:` |
...
|         - |  5781 | ` */` |
|   5784346 |  5782 | `static sxu32 GenStateNsQualifyName(ph7_gen_state *pGen,sxu32 nOrigIdx,SyHash *pImports,int *pFromImport)` |
|         5 |  5783 | `{` |
|         - |  5784 | `	ph7_value *pLit;` |
...
|         - |  5792 | `	ph7_value *pNew;` |
|   5784351 |  5793 | `	if( pFromImport ){` |
|   4693723 |  5794 | `		*pFromImport = 0;` |
|   2346859 |  5795 | `	}` |
|   5784351 |  5796 | `	pLit = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,nOrigIdx);` |
|   5784351 |  5797 | `	if( !pLit \|\| !(pLit->iFlags & MEMOBJ_STRING) \|\| SyBlobLength(&pLit->sBlob) == 0 ){` |
|       ! 0 |  5798 | `		return nOrigIdx;` |
|         - |  5799 | `	}` |
|   5784351 |  5800 | `	zLit = (const char *)SyBlobData(&pLit->sBlob);` |
|   5784351 |  5801 | `	nLit = (sxu32)SyBlobLength(&pLit->sBlob);` |
|         - |  5802 | `	/* Skip if already qualified (contains backslash) */` |
|   5784351 |  5803 | `	hasNsSep = 0;` |
|  68061091 |  5804 | `	for( k = 0; k < nLit; k++ ){` |
|  62276763 |  5805 | `		if( zLit[k] == '\\' ){ hasNsSep = 1; break; }` |
|  31138375 |  5806 | `	}` |
|   5784351 |  5807 | `	if( hasNsSep ){` |
|        20 |  5808 | `		return nOrigIdx;` |
|         - |  5809 | `	}` |
|         - |  5810 | `	/* Check use imports first (works even outside namespaces) */` |
|   5784333 |  5811 | `	SyBlobReset(&pGen->sWorker);` |
|   5784333 |  5812 | `	pImport = SyHashGet(pImports,(const void *)zLit,nLit);` |
|   5784333 |  5813 | `	if( pImport ){` |
...
|         8 |  5818 | `		}` |
|        23 |  5819 | `	}else{` |
|   5784297 |  5820 | `		if( SyBlobLength(&pGen->sNamespace) == 0 ){` |
|   5784167 |  5821 | `			return nOrigIdx; /* Not in a namespace and no import match */` |
|         - |  5822 | `		}` |
...
|         - |  5844 | ` */` |
|    487748 |  5845 | `static void GenStateResolveName(ph7_gen_state *pGen,const SyString *pName,SyBlob *pOut)` |
|         5 |  5846 | `{` |
|         - |  5847 | `	SyHashEntry *pImport;` |
|         - |  5848 | `	/* Check use imports first */` |
|    487753 |  5849 | `	pImport = SyHashGet(&pGen->hUseImports,(const void *)pName->zString,pName->nByte);` |
|    487753 |  5850 | `	if( pImport ){` |
...
|         - |  5866 | ` */` |
|    453572 |  5867 | `static void GenStateBuildFQN(ph7_gen_state *pGen,const SyString *pName,SyBlob *pOut)` |
|         5 |  5868 | `{` |
|    453577 |  5869 | `	if( SyBlobLength(&pGen->sNamespace) > 0 ){` |
|      3911 |  5870 | `		SyBlobAppend(pOut,SyBlobData(&pGen->sNamespace),SyBlobLength(&pGen->sNamespace));` |
|      3911 |  5871 | `		SyBlobAppend(pOut,"\\",1);` |
|      1953 |  5872 | `	}` |
|    453577 |  5873 | `	SyBlobAppend(pOut,pName->zString,pName->nByte);` |
|    453577 |  5874 | `}` |
|         - |  5875 | `/*` |
...
|         3 |  5919 | `	return "token";` |
|        11 |  5920 | `}` |
|      3954 |  5921 | `static sxi32 PH7_CompileNamespace(ph7_gen_state *pGen)` |
|         5 |  5922 | `{` |
|         - |  5923 | `	sxu32 nLine;` |
|         - |  5924 | `	sxi32 rc;` |
|      3959 |  5925 | `	nLine = pGen->pIn->nLine;` |
|      3959 |  5926 | `	pGen->pIn++; /* Jump the 'namespace' keyword */` |
|         - |  5927 | `	/* Reset namespace and clear previous use imports */` |
|      3959 |  5928 | `	SyBlobReset(&pGen->sNamespace);` |
|      3959 |  5929 | `	SyHashRelease(&pGen->hUseImports);` |
|      3959 |  5930 | `	SyHashInit(&pGen->hUseImports,&pGen->pVm->sAllocator,0,0);` |
|      3959 |  5931 | `	SyHashRelease(&pGen->hUseFuncImports);` |
|      3959 |  5932 | `	SyHashInit(&pGen->hUseFuncImports,&pGen->pVm->sAllocator,0,0);` |
|      3959 |  5933 | `	SyHashRelease(&pGen->hUseConstImports);` |
|      3959 |  5934 | `	SyHashInit(&pGen->hUseConstImports,&pGen->pVm->sAllocator,0,0);` |
|      3959 |  5935 | `	if( pGen->pIn >= pGen->pEnd ){` |
|         - |  5936 | `		/* Global namespace (bare "namespace;") */` |
|       ! 0 |  5937 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_NSSWITCH,0,0,0,0);` |
|       ! 0 |  5938 | `		return SXRET_OK;` |
|         - |  5939 | `	}` |
|      3959 |  5940 | `	if( pGen->pIn->nType & PH7_TK_SEMI ){` |
|         - |  5941 | `		/* namespace; — switch to global namespace */` |
|       ! 0 |  5942 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_NSSWITCH,0,0,0,0);` |
|       ! 0 |  5943 | `		return SXRET_OK;` |
|         - |  5944 | `	}` |
|      3959 |  5945 | `	if( pGen->pIn->nType & PH7_TK_OCB ){` |
...
|      7979 |  5951 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & (PH7_TK_NSSEP\|PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|      4029 |  5952 | `		if( pGen->pIn->nType & PH7_TK_NSSEP ){` |
...
|      3991 |  5959 | `			SyBlobAppend(&pGen->sNamespace,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|         - |  5960 | `		}` |
|      4029 |  5961 | `		pGen->pIn++;` |
|         5 |  5962 | `	}` |
...
|         - |  5965 | `	{` |
|      3955 |  5966 | `		char *zNsDup = 0;` |
|      3955 |  5967 | `		if( SyBlobLength(&pGen->sNamespace) > 0 ){` |
|      5927 |  5968 | `			zNsDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|      3948 |  5969 | `				(const char *)SyBlobData(&pGen->sNamespace),SyBlobLength(&pGen->sNamespace));` |
|      1974 |  5970 | `		}` |
|      3955 |  5971 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_NSSWITCH,0,0,zNsDup,0);` |
|         - |  5972 | `	}` |
|      3955 |  5973 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & (PH7_TK_SEMI\|PH7_TK_OCB)) == 0 ){` |
...
|         - |  6371 | ` */` |
|    574062 |  6372 | `static sxi32 GenStateProcessArgValue(ph7_gen_state *pGen,ph7_vm_func_arg *pArg,SyToken *pIn,SyToken *pEnd)` |
|         5 |  6373 | `{` |
|         - |  6374 | `	SyToken *pTmpIn,*pTmpEnd;` |
|         - |  6375 | `	SySet *pInstrContainer;` |
|         - |  6376 | `	sxi32 rc;` |
|         - |  6377 | `	/* Swap token stream */` |
|    574067 |  6378 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|    574067 |  6379 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|    574067 |  6380 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pArg->aByteCode);` |
|         - |  6381 | `	/* Compile the expression holding the argument value */` |
|    574067 |  6382 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|         - |  6383 | `	/* Emit the done instruction */` |
|    574067 |  6384 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,(rc != SXERR_EMPTY ? 1 : 0),0,0,0);` |
|    574067 |  6385 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|    574067 |  6386 | `	RE_SWAP_DELIMITER(pGen);` |
|    574067 |  6387 | `	if( rc == SXERR_ABORT ){` |
|       ! 0 |  6388 | `		return SXERR_ABORT;` |
|         - |  6389 | `	}` |
|    574067 |  6390 | `	return SXRET_OK;` |
|    287036 |  6391 | `}` |
|         - |  6392 | `/*` |
...
|         - |  6428 | ` */` |
|   1321998 |  6429 | `static sxi32 GenStateCollectFuncArgs(ph7_vm_func *pFunc,ph7_gen_state *pGen,SyToken *pEnd,int bCtorCtx,int bAbstractCtx)` |
|         5 |  6430 | `{` |
...
|         - |  6435 | `	sxi32 rc;` |
|         - |  6436 |  |
|   1322003 |  6437 | `	pIn = pGen->pIn;` |
|   1322003 |  6438 | `	SyBlobInit(&sSig,&pGen->pVm->sAllocator);` |
|         - |  6439 | `	/* Process arguments one after one */` |
|   1707007 |  6440 | `	for(;;){` |
|   3414019 |  6441 | `		if( pIn >= pEnd ){` |
|         - |  6442 | `			/* No more arguments to process */` |
|   1321987 |  6443 | `			break;` |
|         - |  6444 | `		}` |
|   2092037 |  6445 | `		SyZero(&sArg,sizeof(ph7_vm_func_arg));` |
|   2092037 |  6446 | `		SySetInit(&sArg.aByteCode,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|   2092037 |  6447 | `		SySetInit(&sArg.aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|   2092037 |  6448 | `		SySetInit(&sArg.aAttrs,&pGen->pVm->sAllocator,sizeof(ph7_attribute));` |
|   2092037 |  6449 | `		SyStringInitFromBuf(&sArg.sTypeName,0,0);` |
|         - |  6450 | `		/* Parameter #[...] attributes: the group precedes the parameter's` |
|         - |  6451 | `		 * first token inside the main token stream */` |
|   2092037 |  6452 | `		if( GenStateCollectParamAttrs(&(*pGen),pIn,&sArg.aAttrs) == SXERR_ABORT ){` |
...
|         - |  6460 | `		{` |
|   2092037 |  6461 | `			int bReadonly = 0, bVisSeen = 0;` |
|   2092037 |  6462 | `			sxi32 iVis = PH7_CLASS_PROT_PUBLIC;` |
|   2092037 |  6463 | `			sxi32 iSetVisFlag = 0;` |
|         - |  6464 | `			int nSetTok;` |
|         - |  6465 | `			sxi32 nSetVis;` |
|   2092037 |  6466 | `			if( pIn < pEnd && GenStateIsReadonly(pIn) ){` |
|         3 |  6467 | `				bReadonly = 1;` |
|         3 |  6468 | `				pIn++;` |
|         1 |  6469 | `			}` |
|   2092037 |  6470 | `			nSetVis = GenStatePeekSetVisibility(pIn,pEnd,&nSetTok);` |
|   2092037 |  6471 | `			if( nSetVis ){` |
...
|       ! 0 |  6478 | `					pIn++;` |
|         1 |  6479 | `				}` |
|   2092036 |  6480 | `			}else if( pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD) ){` |
|     88423 |  6481 | `				sxu32 nKw = (sxu32)SX_PTR_TO_INT(pIn->pUserData);` |
|     88423 |  6482 | `				if( nKw == PH7_TKWRD_PUBLIC \|\| nKw == PH7_TKWRD_PROTECTED \|\| nKw == PH7_TKWRD_PRIVATE ){` |
|        91 |  6483 | `					bVisSeen = 1;` |
...
|        43 |  6498 | `				}` |
|     44209 |  6499 | `			}` |
|   2092037 |  6500 | `			if( iSetVisFlag == PH7_CLASS_ATTR_PRIVATE_SET ){` |
|         5 |  6501 | `				sArg.iFlags \|= VM_FUNC_ARG_PRIV_SET;` |
|   2092035 |  6502 | `			}else if( iSetVisFlag == PH7_CLASS_ATTR_PROTECTED_SET ){` |
|       ! 0 |  6503 | `				sArg.iFlags \|= VM_FUNC_ARG_PROT_SET;` |
|       ! 0 |  6504 | `			}` |
|   2092037 |  6505 | `			if( bVisSeen \|\| bReadonly ){` |
|        95 |  6506 | `				if( !bCtorCtx ){` |
...
|   2092028 |  6527 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_DOLLAR) == 0` |
|   1128609 |  6528 | `			&& (pIn->nType & PH7_TK_AMPER) == 0` |
|    153700 |  6529 | `			&& (pIn->nType & PH7_TK_ELLIPSIS) == 0 ){` |
|    119167 |  6530 | `			sxu32 nLineLocal = pIn->nLine;` |
|    119167 |  6531 | `			sxi32 iTFlags = 0;` |
|    119167 |  6532 | `			pGen->pIn = pIn;` |
|    119167 |  6533 | `			rc = GenStateParseUnionTypeDecl(` |
|     59581 |  6534 | `				pGen, &sArg.nType, &sArg.sClass, &sArg.aUnionAlts,` |
|     59581 |  6535 | `				&iTFlags, &sArg.sTypeName,` |
|         - |  6536 | `				VM_FUNC_ARG_NULLABLE, VM_FUNC_ARG_UNION,` |
|         - |  6537 | `				/* bAllowVoid */ 0,` |
|     59581 |  6538 | `						nLineLocal);` |
|    119167 |  6539 | `			pIn = pGen->pIn;` |
|    119167 |  6540 | `			if( rc == SXERR_ABORT ){` |
|       ! 0 |  6541 | `				return SXERR_ABORT;` |
|    119167 |  6542 | `			}else if( rc == SXERR_CORRUPT ){` |
|         - |  6543 | `				/* Error already reported by GenStateParseUnionTypeDecl */` |
|         3 |  6544 | `				return SXERR_SYNTAX;` |
|    119165 |  6545 | `			}else if( rc == SXERR_SYNTAX ){` |
|        10 |  6546 | `				if( pIn < pEnd ){` |
...
|         - |  6555 | `			}` |
|    119157 |  6556 | `			sArg.iFlags \|= iTFlags;` |
|     59576 |  6557 | `		}` |
|   2092023 |  6558 | `		if( pIn >= pEnd ){` |
|       ! 0 |  6559 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Missing argument name");` |
|       ! 0 |  6560 | `			return rc;` |
|         - |  6561 | `		}` |
|   2092023 |  6562 | `		if( pIn->nType & PH7_TK_AMPER ){` |
|         - |  6563 | `			/* Pass by reference,record that */` |
|     23003 |  6564 | `			sArg.iFlags \|= VM_FUNC_ARG_BY_REF;` |
|     23003 |  6565 | `			pIn++;` |
|     11499 |  6566 | `		}` |
|   2092023 |  6567 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_ELLIPSIS) ){` |
|         - |  6568 | `			/* Variadic parameter: ...$args */` |
|     23065 |  6569 | `			sArg.iFlags \|= VM_FUNC_ARG_VARIADIC;` |
|     23065 |  6570 | `			pIn++;` |
|     11530 |  6571 | `		}` |
|   2092023 |  6572 | `		if( pIn >= pEnd \|\| (pIn->nType & PH7_TK_DOLLAR) == 0 \|\| &pIn[1] >= pEnd \|\| (pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|         - |  6573 | `			/* Invalid argument */` |
|       ! 0 |  6574 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Invalid argument name");` |
|       ! 0 |  6575 | `			return rc;` |
|         - |  6576 | `		}` |
|   2092023 |  6577 | `		pIn++; /* Jump the dollar sign */` |
|         - |  6578 | `		/* Copy argument name */` |
|   2092023 |  6579 | `		zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,SyStringData(&pIn->sData),SyStringLength(&pIn->sData));` |
|   2092023 |  6580 | `		if( zDup == 0 ){` |
|       ! 0 |  6581 | `			PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"PH7 engine is running out of memory");` |
|       ! 0 |  6582 | `			return SXERR_ABORT;` |
|         - |  6583 | `		}` |
|   2092023 |  6584 | `		SyStringInitFromBuf(&sArg.sName,zDup,SyStringLength(&pIn->sData));` |
|   2092023 |  6585 | `		pIn++;` |
|   2092023 |  6586 | `		if( pIn < pEnd ){` |
|   1156581 |  6587 | `			if( pIn->nType & PH7_TK_EQUAL ){` |
|         - |  6588 | `				SyToken *pDefend;` |
|    574069 |  6589 | `				sxi32 iNest = 0;` |
|    574069 |  6590 | `				pIn++; /* Jump the equal sign */` |
|    574069 |  6591 | `				pDefend = pIn;` |
|         - |  6592 | `				/* Process the default value associated with this argument */` |
|   1205557 |  6593 | `				while( pDefend < pEnd ){` |
|    819021 |  6594 | `					if( (pDefend->nType & PH7_TK_COMMA) && iNest <= 0 ){` |
|    187533 |  6595 | `						break;` |
|         - |  6596 | `					}` |
|    631493 |  6597 | `					if( pDefend->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*[*/) ){` |
|         - |  6598 | `						/* Increment nesting level */` |
|     26799 |  6599 | `						iNest++;` |
|    618096 |  6600 | `					}else if( pDefend->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CCB/*'}'*/\|PH7_TK_CSB/*]*/) ){` |
|         - |  6601 | `						/* Decrement nesting level */` |
|     26799 |  6602 | `						iNest--;` |
|     13397 |  6603 | `					}` |
|    631493 |  6604 | `					pDefend++;` |
|         5 |  6605 | `				}` |
|    574069 |  6606 | `				if( pIn >= pDefend ){` |
|         3 |  6607 | `					rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Missing argument default value");` |
|         3 |  6608 | `					return rc;` |
|         - |  6609 | `				}` |
|         - |  6610 | `				/* Process default value */` |
|    574067 |  6611 | `				rc = GenStateProcessArgValue(&(*pGen),&sArg,pIn,pDefend);` |
|    574067 |  6612 | `				if( rc != SXRET_OK ){` |
|       ! 0 |  6613 | `					return rc;` |
|         - |  6614 | `				}` |
...
|    574062 |  6620 | `				if( (sArg.nType > 0 \|\| (sArg.iFlags & VM_FUNC_ARG_UNION))` |
|    311923 |  6621 | `					&& (sArg.iFlags & VM_FUNC_ARG_NULLABLE) == 0` |
|    311920 |  6622 | `					&& &pIn[1] == pDefend` |
|     45951 |  6623 | `					&& pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)` |
|     34456 |  6624 | `					&& pIn->sData.nByte == sizeof("null")-1` |
|     21054 |  6625 | `					&& SyStrnicmp(SyStringData(&pIn->sData),"null",sizeof("null")-1) == 0 ){` |
|     15315 |  6626 | `					sArg.iFlags \|= VM_FUNC_ARG_NULLABLE;` |
...
|         - |  6631 | `					{` |
|     15315 |  6632 | `						const char *zSep = "";` |
|     15315 |  6633 | `						SyString sCls = { "", 0 };` |
|     15315 |  6634 | `						if( (pFunc->iFlags & VM_FUNC_CLASS_METHOD) && pFunc->pUserData ){` |
|     15309 |  6635 | `							sCls = ((ph7_class *)pFunc->pUserData)->sName;` |
|     15309 |  6636 | `							zSep = "::";` |
|      7652 |  6637 | `						}` |
|     22970 |  6638 | `						PH7_GenCompileError(&(*pGen),8192 /* E_DEPRECATED */,pIn->nLine,` |
|         - |  6639 | `							"%z%s%z(): Implicitly marking parameter $%z as nullable is deprecated, the explicit nullable type must be used instead",` |
|      7655 |  6640 | `							&sCls,zSep,&pFunc->sName,&sArg.sName);` |
|         - |  6641 | `					}` |
|      7655 |  6642 | `				}` |
|         - |  6643 | `				/* Point beyond the default value */` |
|    574067 |  6644 | `				pIn = pDefend;` |
|    287031 |  6645 | `			}` |
|   1156579 |  6646 | `			if( pIn < pEnd && (pIn->nType & PH7_TK_COMMA) == 0 ){` |
|       ! 0 |  6647 | `				rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Unexpected token '%z'",&pIn->sData);` |
|       ! 0 |  6648 | `				return rc;` |
|         - |  6649 | `			}` |
|   1156579 |  6650 | `			pIn++; /* Jump the trailing comma */` |
|    578287 |  6651 | `		}` |
|         - |  6652 | `		/* Append argument signature */` |
|   2092021 |  6653 | `		if( sArg.nType > 0 ){` |
|    119095 |  6654 | `			if( SyStringLength(&sArg.sClass) > 0 ){` |
|         - |  6655 | `				/* Class name — prefix with 'o' so generic object hint is a prefix match */` |
|     30713 |  6656 | `				int marker = 'o';` |
|     30713 |  6657 | `				SyBlobAppend(&sSig,(const void *)&marker,sizeof(char));` |
|     30713 |  6658 | `				SyBlobAppend(&sSig,SyStringData(&sArg.sClass),SyStringLength(&sArg.sClass));` |
|     15359 |  6659 | `			}else{` |
|         - |  6660 | `				int c;` |
|     88387 |  6661 | `				c = 'n'; /* cc warning */` |
|         - |  6662 | `				/* Type leading character */` |
|     88387 |  6663 | `				switch(sArg.nType){` |
|      5746 |  6664 | `				case MEMOBJ_HASHMAP:` |
|         - |  6665 | `					/* Hashmap aka 'array' */` |
|     11497 |  6666 | `					c = 'h';` |
|     11497 |  6667 | `					break;` |
|      9693 |  6668 | `				case MEMOBJ_INT:` |
|         - |  6669 | `					/* Integer */` |
|     19391 |  6670 | `					c = 'i';` |
|     19391 |  6671 | `					break;` |
...
|         2 |  6689 | `					break;` |
|         - |  6690 | `				}` |
|     88387 |  6691 | `				SyBlobAppend(&sSig,(const void *)&c,sizeof(char));` |
|         - |  6692 | `			}` |
|     59550 |  6693 | `		}else{` |
|         - |  6694 | `			/* No type is associated with this parameter which mean` |
|         - |  6695 | `			 * that this function is not condidate for overloading.` |
|         - |  6696 | `			 */` |
|   1972931 |  6697 | `			SyBlobRelease(&sSig);` |
|         - |  6698 | `		}` |
|         - |  6699 | `		/* Save in the argument set */` |
|   2092021 |  6700 | `		SySetPut(&pFunc->aArgs,(const void *)&sArg);` |
|         5 |  6701 | `	}` |
|   1321987 |  6702 | `	if( SyBlobLength(&sSig) > 0 ){` |
|         - |  6703 | `		/* Save function signature */` |
|     88409 |  6704 | `		SyStringInitFromBuf(&pFunc->sSignature,SyBlobData(&sSig),SyBlobLength(&sSig));` |
|     44202 |  6705 | `	}` |
|   1321987 |  6706 | `	return SXRET_OK;` |
|    661004 |  6707 | `}` |
|         - |  6708 | `/*` |
...
|         - |  6712 | ` */` |
|     34480 |  6713 | `static SyToken * GenStateSkipNestedFunc(SyToken *pIn, SyToken *pEnd)` |
|         5 |  6714 | `{` |
|     34485 |  6715 | `	sxi32 iParen = 0;` |
|     34485 |  6716 | `	pIn++; /* past 'function'/'fn' */` |
...
|    153295 |  6720 | `	while( pIn < pEnd ){` |
|    153295 |  6721 | `		sxu32 t = pIn->nType;` |
|    153295 |  6722 | `		if( t & PH7_TK_LPAREN ){ iParen++; }` |
|    149411 |  6723 | `		else if( t & PH7_TK_RPAREN ){ iParen--; }` |
|    103441 |  6724 | `		else if( (t & PH7_TK_OCB) && iParen <= 0 ){ break; }` |
|     84265 |  6725 | `		else if( (t & PH7_TK_SEMI) && iParen <= 0 ){ return pIn; }` |
|    118815 |  6726 | `		pIn++;` |
|         5 |  6727 | `	}` |
|     19181 |  6728 | `	if( pIn >= pEnd ){ return pIn; }` |
|         - |  6729 | `	/* pIn at the body '{' — skip the balanced brace block. */` |
|         - |  6730 | `	{` |
|     19181 |  6731 | `		sxi32 d = 0;` |
|    761895 |  6732 | `		while( pIn < pEnd ){` |
|    761895 |  6733 | `			sxu32 t = pIn->nType;` |
|    761895 |  6734 | `			if( t & PH7_TK_OCB ){ d++; }` |
|    731233 |  6735 | `			else if( t & PH7_TK_CCB ){ d--; if( d <= 0 ){ pIn++; break; } }` |
|    742719 |  6736 | `			pIn++;` |
|         5 |  6737 | `		}` |
|         - |  6738 | `	}` |
|     19181 |  6739 | `	return pIn;` |
|     17245 |  6740 | `}` |
|         - |  6741 | `/*` |
...
|         - |  6752 | ` * mixed, object.` |
|         - |  6753 | ` */` |
|     11502 |  6754 | `static int GenStateGenRetNameOk(const char *zName,sxu32 nName)` |
|         5 |  6755 | `{` |
...
|         - |  6759 | `	};` |
|         - |  6760 | `	sxu32 i;` |
|     11507 |  6761 | `	if( nName > 0 && zName[0] == '\\' ){` |
|       ! 0 |  6762 | `		zName++;` |
|       ! 0 |  6763 | `		nName--;` |
|       ! 0 |  6764 | `	}` |
|     11515 |  6765 | `	for( i = 0; i < SX_ARRAYSIZE(aOk); i++ ){` |
|     11515 |  6766 | `		if( nName == aOk[i].nLen && SyStrnicmp(zName,aOk[i].zName,nName) == 0 ){` |
|     11507 |  6767 | `			return 1;` |
|         - |  6768 | `		}` |
|         5 |  6769 | `	}` |
|       ! 0 |  6770 | `	return 0;` |
...
|         - |  6783 | ` */` |
|     11504 |  6784 | `static int GenStateGenRetAtomOk(ph7_gen_state *pGen,sxu32 nType,const SyString *pName)` |
|         5 |  6785 | `{` |
|     11509 |  6786 | `	if( nType == MEMOBJ_OBJ ){` |
|       ! 0 |  6787 | ``		return 1; /* bare `object` */`` |
|         - |  6788 | `	}` |
|     11509 |  6789 | `	if( nType != SXU32_HIGH ){` |
|         3 |  6790 | `		return 0; /* scalar/array/void/never/null/... */` |
|         - |  6791 | `	}` |
|     11507 |  6792 | `	if( GenStateGenRetNameOk(pName->zString,pName->nByte) ){` |
|     11507 |  6793 | `		return 1;` |
|         - |  6794 | `	}` |
...
|         - |  6818 | ` */` |
|     11744 |  6819 | `static sxi32 GenStateValidateGeneratorReturnType(ph7_gen_state *pGen,ph7_vm_func *pFunc)` |
|         5 |  6820 | `{` |
|     11749 |  6821 | `	int bOk = 0;` |
|         - |  6822 | `	sxu32 nLine;` |
|         - |  6823 | `	sxi32 rc;` |
|     11749 |  6824 | `	if( pFunc->nReturnType < 1 && SySetUsed(&pFunc->aReturnUnion) < 1 ){` |
|       245 |  6825 | `		return SXRET_OK; /* untyped: nothing to validate */` |
|         - |  6826 | `	}` |
|     11509 |  6827 | `	if( SySetUsed(&pFunc->aReturnUnion) > 0 ){` |
...
|       ! 0 |  6844 | `		}` |
|       ! 0 |  6845 | `	}else{` |
|     11509 |  6846 | `		bOk = GenStateGenRetAtomOk(&(*pGen),pFunc->nReturnType,&pFunc->sReturnClass);` |
|         - |  6847 | `	}` |
|     11509 |  6848 | `	if( bOk ){` |
|     11507 |  6849 | `		return SXRET_OK;` |
|         - |  6850 | `	}` |
...
|      5877 |  6875 | `}` |
|   2938440 |  6876 | `static int GenStateFuncBodyHasYield(ph7_gen_state *pGen)` |
|         5 |  6877 | `{` |
|   2938445 |  6878 | `	SyToken *pIn = pGen->pIn;   /* expected at the body's opening '{' */` |
|   2938445 |  6879 | `	SyToken *pEnd = pGen->pEnd;` |
|   2938445 |  6880 | `	sxi32 iDepth = 0;` |
|   2938445 |  6881 | `	int bStarted = 0;` |
| 137590445 |  6882 | `	while( pIn < pEnd ){` |
| 137590445 |  6883 | `		sxu32 t = pIn->nType;` |
| 137590445 |  6884 | `		if( t & PH7_TK_OCB ){ iDepth++; bStarted = 1; pIn++; continue; }` |
| 131379743 |  6885 | `		if( t & PH7_TK_CCB ){ iDepth--; pIn++; if( bStarted && iDepth <= 0 ){ break; } continue; }` |
| 125203857 |  6886 | `		if( t & PH7_TK_KEYWORD ){` |
|   9299189 |  6887 | `			int kw = SX_PTR_TO_INT(pIn->pUserData);` |
|   9299189 |  6888 | `			if( kw == PH7_TKWRD_YIELD ){ return TRUE; }` |
|   9287445 |  6889 | `			if( kw == PH7_TKWRD_FUNCTION ){ pIn = GenStateSkipNestedFunc(pIn,pEnd); continue; }` |
|         - |  6890 | ``			/* `fn` arrow bodies are single expressions and cannot contain a valid yield. */`` |
|   4626480 |  6891 | `		}` |
| 125157633 |  6892 | `		pIn++;` |
|         5 |  6893 | `	}` |
|   2926701 |  6894 | `	return FALSE;` |
|   1469225 |  6895 | `}` |
|         - |  6896 | `/*` |
...
|         - |  6900 | ` */` |
|   2938440 |  6901 | `static sxi32 GenStateCompileFuncBody(` |
...
|   2938445 |  6911 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC,PH7_VmInstrLength(pGen->pVm),pFunc,&pBlock);` |
|   2938445 |  6912 | `	if( rc != SXRET_OK ){` |
...
|         - |  6916 | `	}` |
|   2938445 |  6917 | `	nGotoOfft = SySetUsed(&pGen->aGoto);` |
|         - |  6918 | `	/* Swap bytecode containers */` |
|   2938445 |  6919 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   2938445 |  6920 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pFunc->aByteCode);` |
...
|         - |  6925 | `	{` |
|   2938445 |  6926 | `		sxu32 nArg = SySetUsed(&pFunc->aArgs);` |
|         - |  6927 | `		sxu32 i;` |
|   4976745 |  6928 | `		for( i = 0; i < nArg; i++ ){` |
|   2038305 |  6929 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pFunc->aArgs,i);` |
|         - |  6930 | `			char *zSrc;` |
|         - |  6931 | `			sxu32 nSrc,nName;` |
|         - |  6932 | `			SySet sToken;` |
|         - |  6933 | `			SyToken *pTmpIn,*pTmpEnd;` |
|         - |  6934 | `			sxi32 rcPromote;` |
|   2038305 |  6935 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|   2038229 |  6936 | `				continue;` |
|         - |  6937 | `			}` |
...
|         - |  6987 | `	{` |
|   2938445 |  6988 | `		sxi8 bSavedGen = pGen->bInGenerator;` |
|   2938445 |  6989 | `		pGen->bInGenerator = (sxi8)GenStateFuncBodyHasYield(&(*pGen));` |
|         - |  6990 | `		/* Compile the body */` |
|   2938445 |  6991 | `		PH7_CompileBlock(&(*pGen),0);` |
|   2938445 |  6992 | `		pGen->bInGenerator = bSavedGen;` |
|         - |  6993 | `	}` |
|         - |  6994 | `	/* Fix exception jumps now the destination is resolved */` |
|   2938445 |  6995 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|         - |  6996 | `	/* Emit the final return if not yet done */` |
|   2938445 |  6997 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|         - |  6998 | `	/* Fix gotos jumps now the destination is resolved */` |
|   2938445 |  6999 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),nGotoOfft) ){` |
|       ! 0 |  7000 | `		rc = SXERR_ABORT;` |
|       ! 0 |  7001 | `	}` |
|   2938445 |  7002 | `	SySetTruncate(&pGen->aGoto,nGotoOfft);` |
|         - |  7003 | `	/* Restore the default container */` |
|   2938445 |  7004 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|         - |  7005 | `	/* Leave function block */` |
|   2938445 |  7006 | `	GenStateLeaveBlock(&(*pGen),0);` |
|   2938445 |  7007 | `	if( rc == SXERR_ABORT ){` |
...
|         - |  7012 | `	{` |
|   2938445 |  7013 | `		VmInstr *aInstr = (VmInstr *)SySetBasePtr(&pFunc->aByteCode);` |
|         - |  7014 | `		sxu32 i;` |
|  84288665 |  7015 | `		for( i = 0; i < SySetUsed(&pFunc->aByteCode); i++ ){` |
|  81361969 |  7016 | `			if( aInstr[i].iOp == PH7_OP_YIELD \|\| aInstr[i].iOp == PH7_OP_YIELD_FROM ){` |
|     11749 |  7017 | `				pFunc->iFlags \|= VM_FUNC_GENERATOR;` |
|     11749 |  7018 | `				break;` |
|         - |  7019 | `			}` |
|  40675115 |  7020 | `		}` |
|         - |  7021 | `	}` |
|   2938445 |  7022 | `	if( pFunc->iFlags & VM_FUNC_GENERATOR ){` |
|         - |  7023 | `		/* php-exact definition-time check; see the helper's block comment. */` |
|     11749 |  7024 | `		if( SXERR_ABORT == GenStateValidateGeneratorReturnType(&(*pGen),pFunc) ){` |
|       ! 0 |  7025 | `			return SXERR_ABORT;` |
|         - |  7026 | `		}` |
|      5872 |  7027 | `	}` |
|         - |  7028 | `	/* All done, function body compiled */` |
|   2938445 |  7029 | `	return SXRET_OK;` |
|   1469225 |  7030 | `}` |
|         - |  7031 | `/*` |
...
|         - |  7100 | ` */` |
|     42422 |  7101 | `static int GenStateIsReservedTypeWord(const SyString *pName)` |
|         5 |  7102 | `{` |
...
|         - |  7107 | `	};` |
|         - |  7108 | `	sxu32 i;` |
|    888961 |  7109 | `	for( i = 0 ; i < SX_ARRAYSIZE(azWords) ; i++ ){` |
|    846647 |  7110 | `		sxu32 n = (sxu32)SyStrlen(azWords[i]);` |
|    846647 |  7111 | `		if( pName->nByte == n && SyStrnicmp(pName->zString,azWords[i],n) == 0 ){` |
|       113 |  7112 | `			return 1;` |
|         - |  7113 | `		}` |
|    423272 |  7114 | `	}` |
|     42319 |  7115 | `	return 0;` |
|     21216 |  7116 | `}` |
|    132006 |  7117 | `static sxi32 GenStateParseOneTypeAtom(ph7_gen_state *pGen, PhlTypeAtom *pOut)` |
|         5 |  7118 | `{` |
|    132011 |  7119 | `	SyToken *pIn = pGen->pIn;` |
|    132011 |  7120 | `	int bAbsolute = 0;` |
|    132011 |  7121 | `	SyZero(pOut, sizeof(*pOut));` |
|    132011 |  7122 | `	SyStringInitFromBuf(&pOut->sClass, 0, 0);` |
|    132011 |  7123 | `	if( pIn >= pGen->pEnd ){` |
|       ! 0 |  7124 | `		return SXERR_SYNTAX;` |
|         - |  7125 | `	}` |
|         - |  7126 | `	/* Optional leading namespace separator '\' on FQN class types */` |
|    132011 |  7127 | `	if( pIn->nType & PH7_TK_NSSEP ){` |
...
|         - |  7132 | `		}` |
|         4 |  7133 | `	}` |
|    132011 |  7134 | `	if( (pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|       ! 0 |  7135 | `		return SXERR_SYNTAX;` |
|         - |  7136 | `	}` |
|    132011 |  7137 | `	if( pIn->nType & PH7_TK_KEYWORD ){` |
|     89351 |  7138 | `		sxu32 nKey = (sxu32)(SX_PTR_TO_INT(pIn->pUserData));` |
|     89351 |  7139 | `		if( nKey & PH7_TKWRD_ARRAY ){` |
|     11559 |  7140 | `			pOut->nType = MEMOBJ_HASHMAP; pOut->zCanon = "array"; pOut->nCanon = 5;` |
|     83574 |  7141 | `		}else if( nKey & PH7_TKWRD_BOOL ){` |
|        87 |  7142 | `			pOut->nType = MEMOBJ_BOOL; pOut->zCanon = "bool"; pOut->nCanon = 4;` |
|     77756 |  7143 | `		}else if( nKey & PH7_TKWRD_INT ){` |
|     19811 |  7144 | `			pOut->nType = MEMOBJ_INT; pOut->zCanon = "int"; pOut->nCanon = 3;` |
|     67812 |  7145 | `		}else if( nKey & PH7_TKWRD_STRING ){` |
|     57815 |  7146 | `			pOut->nType = MEMOBJ_STRING; pOut->zCanon = "string"; pOut->nCanon = 6;` |
|     29004 |  7147 | `		}else if( nKey & PH7_TKWRD_FLOAT ){` |
...
|     42665 |  7162 | `		SyString *pT = &pIn->sData;` |
|     42665 |  7163 | `		if( pT->nByte == 4 && SyMemcmpNoCase(pT->zString, "null", 4) == 0 ){` |
|        34 |  7164 | `			pOut->nType = UTA_NULL_FLAG; pOut->zCanon = "null"; pOut->nCanon = 4;` |
|        34 |  7165 | `			pIn++;` |
|     42650 |  7166 | `		}else if( pT->nByte == 4 && SyMemcmpNoCase(pT->zString, "void", 4) == 0 ){` |
|       183 |  7167 | `			pOut->nType = UTA_VOID_FLAG; pOut->zCanon = "void"; pOut->nCanon = 4;` |
|       183 |  7168 | `			pIn++;` |
|     42546 |  7169 | `		}else if( pT->nByte == 5 && SyMemcmpNoCase(pT->zString, "never", 5) == 0 ){` |
|        27 |  7170 | `			pOut->nType = UTA_NEVER_FLAG; pOut->zCanon = "never"; pOut->nCanon = 5;` |
|        27 |  7171 | `			pIn++;` |
|        16 |  7172 | `		}else{` |
|         - |  7173 | `			/* Class / interface name; consume namespace path a\b\c */` |
|     42435 |  7174 | `			SyToken *pFirst = pIn;` |
|     42435 |  7175 | `			SyToken *pLast = pIn;` |
|     42435 |  7176 | `			pOut->nType = SXU32_HIGH;` |
|     42435 |  7177 | `			pOut->sClass = pIn->sData;` |
|     42435 |  7178 | `			pIn++;` |
|     63648 |  7179 | `			while( pIn + 1 < pGen->pEnd && (pIn->nType & PH7_TK_NSSEP)` |
|     42438 |  7180 | `				&& (pIn[1].nType & PH7_TK_ID) ){` |
|         3 |  7181 | `				pLast = &pIn[1];` |
|         3 |  7182 | `				pIn += 2;` |
|         1 |  7183 | `			}` |
|     42435 |  7184 | `			if( pLast != pFirst ){` |
...
|     42435 |  7198 | `			if( !bAbsolute && pLast == pFirst && !GenStateIsReservedTypeWord(&pOut->sClass) ){` |
|         - |  7199 | `				SyBlob sFqn;` |
|     42319 |  7200 | `				SyBlobInit(&sFqn,&pGen->pVm->sAllocator);` |
|     42319 |  7201 | `				GenStateResolveName(pGen,&pOut->sClass,&sFqn);` |
|     42314 |  7202 | `				if( SyBlobLength(&sFqn) != pOut->sClass.nByte` |
|     42314 |  7203 | `				 \|\| SyMemcmp(SyBlobData(&sFqn),(const void *)pOut->sClass.zString,pOut->sClass.nByte) != 0 ){` |
...
|         5 |  7208 | `					}` |
|         5 |  7209 | `				}` |
|     42319 |  7210 | `				SyBlobRelease(&sFqn);` |
|     21157 |  7211 | `			}` |
|         - |  7212 | `		}` |
|         - |  7213 | `	}` |
|    132009 |  7214 | `	pGen->pIn = pIn;` |
|    132009 |  7215 | `	return SXRET_OK;` |
|     66008 |  7216 | `}` |
|         - |  7217 |  |
|         - |  7218 | `/*` |
...
|         - |  7224 | ` */` |
|    131828 |  7225 | `static void GenBuildUnionTypeText(SyBlob *pBlob, PhlTypeAtom *aAtoms, int nAtoms, int bNullable)` |
|         5 |  7226 | `{` |
|         - |  7227 | `	int i;` |
|    131833 |  7228 | `	int nNonNull = 0;` |
|    131833 |  7229 | `	int bAnyIntersection = 0;` |
|         - |  7230 | `	sxu32 aGroupCount[PHL_UNION_MAX_ALTS];` |
|    131833 |  7231 | `	sxu32 nMaxGroup = 0;` |
|   4350329 |  7232 | `	for( i = 0; i < PHL_UNION_MAX_ALTS; i++ ) aGroupCount[i] = 0;` |
|    263813 |  7233 | `	for( i = 0; i < nAtoms; i++ ){` |
|    131985 |  7234 | `		if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|    131955 |  7235 | `			nNonNull++;` |
|    131955 |  7236 | `			if( aAtoms[i].nGroup < PHL_UNION_MAX_ALTS ){` |
|    131955 |  7237 | `				aGroupCount[aAtoms[i].nGroup]++;` |
|    131955 |  7238 | `				if( aAtoms[i].nGroup > nMaxGroup ) nMaxGroup = aAtoms[i].nGroup;` |
|     65975 |  7239 | `			}` |
|     65975 |  7240 | `		}` |
|     65995 |  7241 | `	}` |
|    263761 |  7242 | `	for( i = 0; i < nAtoms; i++ ){` |
|    131957 |  7243 | `		if( aAtoms[i].nType != UTA_NULL_FLAG && aGroupCount[aAtoms[i].nGroup] >= 2 ){` |
|        29 |  7244 | `			bAnyIntersection = 1;` |
|        29 |  7245 | `			break;` |
|         - |  7246 | `		}` |
|     65969 |  7247 | `	}` |
|    131833 |  7248 | `	if( bAnyIntersection ){` |
...
|        85 |  7283 | `		return;` |
|         - |  7284 | `	}` |
|    131809 |  7285 | `	if( nNonNull == 1 && bNullable ){` |
|         - |  7286 | `		/* Shorthand: ?T */` |
...
|       ! 0 |  7297 | `	}` |
|         - |  7298 | `	{` |
|    131697 |  7299 | `		int bFirst = 1;` |
|         - |  7300 | `		/* 1) Classes in declaration order */` |
|    263497 |  7301 | `		for( i = 0; i < nAtoms; i++ ){` |
|    131805 |  7302 | `			if( aAtoms[i].nType == SXU32_HIGH ){` |
|     42395 |  7303 | `				if( !bFirst ) SyBlobAppend(pBlob, "\|", 1);` |
|     42395 |  7304 | `				SyBlobAppend(pBlob, aAtoms[i].sClass.zString, aAtoms[i].sClass.nByte);` |
|     42395 |  7305 | `				bFirst = 0;` |
|     21195 |  7306 | `			}` |
|     65905 |  7307 | `		}` |
...
|         - |  7312 | `			int k;` |
|    921849 |  7313 | `			for( k = 0; k < (int)(sizeof(aOrder)/sizeof(aOrder[0])); k++ ){` |
|   1491643 |  7314 | `				for( i = 0; i < nAtoms; i++ ){` |
|    790693 |  7315 | `					if( aAtoms[i].nType == aOrder[k] ){` |
|     89207 |  7316 | `						if( !bFirst ) SyBlobAppend(pBlob, "\|", 1);` |
|     89207 |  7317 | `						SyBlobAppend(pBlob, aAtoms[i].zCanon, aAtoms[i].nCanon);` |
|     89207 |  7318 | `						bFirst = 0;` |
|     89207 |  7319 | `						break;` |
|         - |  7320 | `					}` |
|    350748 |  7321 | `				}` |
...
|         - |  7345 | ` */` |
|    131980 |  7346 | `static sxi32 GenStateParsePart(` |
|         - |  7347 | `	ph7_gen_state *pGen, PhlTypeAtom *aAtoms, int *pnAtoms, sxu32 iGroup,` |
|         - |  7348 | `	int *pnMembers, int *pbParen, sxu32 nLine)` |
|         5 |  7349 | `{` |
|         - |  7350 | `	sxi32 rc;` |
|    131985 |  7351 | `	int nMembers = 0;` |
|    131985 |  7352 | `	int bParen = 0;` |
|    131985 |  7353 | `	*pnMembers = 0;` |
|    131985 |  7354 | `	*pbParen = 0;` |
|    131985 |  7355 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_LPAREN) ){` |
|         9 |  7356 | `		bParen = 1;` |
|         9 |  7357 | `		pGen->pIn++; /* skip '(' */` |
|         3 |  7358 | `	}` |
|     65990 |  7359 | `	for(;;){` |
|    132011 |  7360 | `		if( *pnAtoms >= PHL_UNION_MAX_ALTS ){` |
...
|         - |  7364 | `		}` |
|    132011 |  7365 | `		rc = GenStateParseOneTypeAtom(pGen, &aAtoms[*pnAtoms]);` |
|    132011 |  7366 | `		if( rc != SXRET_OK ){` |
|         3 |  7367 | `			return rc;` |
|         - |  7368 | `		}` |
|    132009 |  7369 | `		aAtoms[*pnAtoms].nGroup = iGroup;` |
|    132009 |  7370 | `		(*pnAtoms)++;` |
|    132009 |  7371 | `		nMembers++;` |
|         - |  7372 | ``		/* Continue the intersection while `&` is followed by another type atom. */`` |
|    132009 |  7373 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
...
|         - |  7394 | `		}` |
|         3 |  7395 | `	}` |
|    131983 |  7396 | `	*pnMembers = nMembers;` |
|    131983 |  7397 | `	*pbParen = bParen;` |
|    131983 |  7398 | `	return SXRET_OK;` |
|     65995 |  7399 | `}` |
|         - |  7400 |  |
|         - |  7401 | `/*` |
...
|         - |  7418 | ` */` |
|    131844 |  7419 | `static sxi32 GenStateParseUnionTypeDecl(` |
...
|    131849 |  7432 | `	int nAtoms = 0;` |
|    131849 |  7433 | `	int bShortNullable = 0;` |
|    131849 |  7434 | `	int bExplicitNull = 0;` |
|         - |  7435 | `	sxi32 rc;` |
|    131849 |  7436 | `	*pnType = 0;` |
|    131849 |  7437 | `	if( pClass ) SyStringInitFromBuf(pClass, 0, 0);` |
|    131849 |  7438 | `	*piTypeFlags = 0;` |
|    131849 |  7439 | `	if( pTypeText ) SyStringInitFromBuf(pTypeText, 0, 0);` |
|         - |  7440 |  |
|    131849 |  7441 | `	if( pGen->pIn >= pGen->pEnd ){` |
|       ! 0 |  7442 | `		return SXRET_OK;` |
|         - |  7443 | `	}` |
|         - |  7444 | ``	/* Optional `?` shorthand prefix */`` |
|    131844 |  7445 | `	if( (pGen->pIn->nType & PH7_TK_OP) && pGen->pIn->sData.nByte == 1` |
...
|    131849 |  7458 | `		sxu32 iGroup = 0;` |
|    131849 |  7459 | `		rc = GenStateParsePart(pGen, aAtoms, &nAtoms, iGroup, &nMembers, &bParen, nLine);` |
|    131849 |  7460 | `		if( rc != SXRET_OK ){` |
|         4 |  7461 | `			return rc;` |
|         - |  7462 | `		}` |
...
|    197972 |  7468 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OP)` |
|    132056 |  7469 | `			&& pGen->pIn->sData.nByte == 1 && pGen->pIn->sData.zString[0] == '\|' ){` |
...
|         - |  7487 | `			}` |
|         5 |  7488 | `		}` |
|    131845 |  7489 | `		if( iGroup > 0 && nMembers >= 2 && !bParen ){` |
...
|         - |  7501 | `	{` |
|         - |  7502 | `		int i, j;` |
|    131845 |  7503 | `		int bHasNonNull = 0;` |
|    131845 |  7504 | `		int bAnyIntersection = 0;` |
...
|   4350725 |  7508 | `		for( i = 0; i < PHL_UNION_MAX_ALTS; i++ ) aGroupCount[i] = 0;` |
|    263847 |  7509 | `		for( i = 0; i < nAtoms; i++ ){` |
|    132007 |  7510 | `			if( aAtoms[i].nGroup < PHL_UNION_MAX_ALTS ) aGroupCount[aAtoms[i].nGroup]++;` |
|     66006 |  7511 | `		}` |
|    263791 |  7512 | `		for( i = 0; i < nAtoms; i++ ){` |
|    131977 |  7513 | `			if( aGroupCount[aAtoms[i].nGroup] >= 2 ){ bAnyIntersection = 1; break; }` |
|     65978 |  7514 | `		}` |
...
|    131845 |  7517 | `		if( bShortNullable && bAnyIntersection ){` |
...
|         - |  7521 | `		}` |
|    263833 |  7522 | `		for( i = 0; i < nAtoms; i++ ){` |
...
|    132005 |  7526 | `			if( aGroupCount[aAtoms[i].nGroup] >= 2 ){` |
...
|         - |  7548 | `				}` |
|        24 |  7549 | `			}` |
|    132003 |  7550 | `			if( aAtoms[i].nType == UTA_VOID_FLAG ){` |
...
|         - |  7565 | `				}` |
|        88 |  7566 | `			}` |
|    132001 |  7567 | `			if( aAtoms[i].nType == UTA_NEVER_FLAG ){` |
...
|         - |  7584 | `				}` |
|         8 |  7585 | `			}` |
|    131995 |  7586 | `			if( aAtoms[i].nType == UTA_NULL_FLAG ){` |
|        34 |  7587 | `				bExplicitNull = 1;` |
|        19 |  7588 | `			}else{` |
|    131965 |  7589 | `				bHasNonNull = 1;` |
|         - |  7590 | `			}` |
...
|        99 |  7628 | `			}` |
|     65999 |  7629 | `		}` |
|    131833 |  7630 | `		if( !bHasNonNull && bExplicitNull ){` |
...
|    131833 |  7645 | `	if( bShortNullable \|\| bExplicitNull ){` |
|       133 |  7646 | `		*piTypeFlags \|= iNullableFlag;` |
|        64 |  7647 | `	}` |
|         - |  7648 | `	/* Build canonical type text */` |
|    131833 |  7649 | `	if( pTypeText ){` |
|         - |  7650 | `		SyBlob sBlob;` |
|    131833 |  7651 | `		SyBlobInit(&sBlob, &pGen->pVm->sAllocator);` |
|    197698 |  7652 | `		GenBuildUnionTypeText(&sBlob, aAtoms, nAtoms,` |
|     65914 |  7653 | `			(bShortNullable \|\| bExplicitNull) ? 1 : 0);` |
|    131833 |  7654 | `		if( SyBlobLength(&sBlob) > 0 ){` |
|    197459 |  7655 | `			char *zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|    131636 |  7656 | `				(const char *)SyBlobData(&sBlob), SyBlobLength(&sBlob));` |
|    131641 |  7657 | `			if( zDup ){` |
|    131641 |  7658 | `				SyStringInitFromBuf(pTypeText, zDup, SyBlobLength(&sBlob));` |
|     65818 |  7659 | `			}` |
|     65818 |  7660 | `		}` |
|    131833 |  7661 | `		SyBlobRelease(&sBlob);` |
|     65914 |  7662 | `	}` |
...
|         - |  7666 | `	{` |
|    131833 |  7667 | `		int nNonNull = 0;` |
|    131833 |  7668 | `		int iNonNullIdx = -1;` |
|         - |  7669 | `		int i;` |
|    263813 |  7670 | `		for( i = 0; i < nAtoms; i++ ){` |
|    131985 |  7671 | `			if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|    131955 |  7672 | `				nNonNull++;` |
|    131955 |  7673 | `				iNonNullIdx = i;` |
|     65975 |  7674 | `			}` |
|     65995 |  7675 | `		}` |
|    131833 |  7676 | `		if( nNonNull <= 1 ){` |
|         - |  7677 | `			/* Fast path: store as single type. */` |
|    131727 |  7678 | `			if( iNonNullIdx >= 0 ){` |
|    131721 |  7679 | `				PhlTypeAtom *pA = &aAtoms[iNonNullIdx];` |
|    131721 |  7680 | `				if( pA->nType == SXU32_HIGH ){` |
|     63557 |  7681 | `					char *zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|     21184 |  7682 | `						pA->sClass.zString, pA->sClass.nByte);` |
|     42373 |  7683 | `					if( zDup == 0 ) return SXERR_ABORT;` |
|     42373 |  7684 | `					*pnType = SXU32_HIGH;` |
|     42373 |  7685 | `					if( pClass ) SyStringInitFromBuf(pClass, zDup, pA->sClass.nByte);` |
|    110537 |  7686 | `				}else if( pA->nType == UTA_VOID_FLAG ){` |
|       181 |  7687 | `					*pnType = MEMOBJ_VOID;` |
|     89265 |  7688 | `				}else if( pA->nType == UTA_NEVER_FLAG ){` |
|        18 |  7689 | `					*pnType = MEMOBJ_NEVER;` |
|        10 |  7690 | `				}else{` |
|     89161 |  7691 | `					*pnType = pA->nType;` |
|         - |  7692 | `				}` |
|     65858 |  7693 | `			}` |
|     65866 |  7694 | `		}else{` |
...
|         - |  7726 | ` */` |
|   3076696 |  7727 | `static sxi32 GenStateParseReturnType(ph7_gen_state *pGen, ph7_vm_func *pFunc)` |
|         5 |  7728 | `{` |
|   3076701 |  7729 | `	sxi32 iFlags = 0;` |
|         - |  7730 | `	sxi32 rc;` |
|         - |  7731 | `	sxu32 nLine;` |
|   3076701 |  7732 | `	pFunc->nReturnType = 0;` |
|   3076701 |  7733 | `	SyStringInitFromBuf(&pFunc->sReturnClass, 0, 0);` |
|   3076701 |  7734 | `	SyStringInitFromBuf(&pFunc->sReturnTypeName, 0, 0);` |
...
|   3076701 |  7740 | `	SySetReset(&pFunc->aReturnUnion);` |
|   3076701 |  7741 | `	pFunc->iFlags &= ~VM_FUNC_RETURN_NULLABLE;` |
|   3076701 |  7742 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COLON) == 0 ){` |
|   3064401 |  7743 | `		return SXRET_OK;` |
|         - |  7744 | `	}` |
|     12305 |  7745 | `	pGen->pIn++; /* Skip ':' */` |
|     12305 |  7746 | `	if( pGen->pIn >= pGen->pEnd ){` |
|       ! 0 |  7747 | `		return SXRET_OK;` |
|         - |  7748 | `	}` |
|     12305 |  7749 | `	nLine = pGen->pIn->nLine;` |
|     12305 |  7750 | `	rc = GenStateParseUnionTypeDecl(` |
|      6150 |  7751 | `		pGen,` |
|      6150 |  7752 | `		&pFunc->nReturnType,` |
|      6150 |  7753 | `		&pFunc->sReturnClass,` |
|      6150 |  7754 | `		&pFunc->aReturnUnion,` |
|         - |  7755 | `		&iFlags,` |
|      6150 |  7756 | `		&pFunc->sReturnTypeName,` |
...
|         - |  7760 | `		/* bAllowVoid */ 1,` |
|      6150 |  7761 | `		nLine);` |
|     12305 |  7762 | `	if( rc == SXERR_ABORT ){` |
|       ! 0 |  7763 | `		return SXERR_ABORT;` |
|         - |  7764 | `	}` |
|     12305 |  7765 | `	if( rc == SXERR_CORRUPT ){` |
|         - |  7766 | `		/* Error already reported */` |
|       ! 0 |  7767 | `		return SXERR_SYNTAX;` |
|         - |  7768 | `	}` |
|     12305 |  7769 | `	if( rc == SXERR_SYNTAX ){` |
...
|         - |  7779 | `	}` |
|     12299 |  7780 | `	pFunc->iFlags \|= (iFlags & VM_FUNC_RETURN_NULLABLE);` |
|     12299 |  7781 | `	return SXRET_OK;` |
|   1538353 |  7782 | `}` |
|         - |  7783 |  |
|    491850 |  7784 | `static sxi32 GenStateCompileFunc(` |
...
|    491855 |  7798 | `	nLine = pGen->pIn->nLine;` |
|         - |  7799 | `	/* Jump the left parenthesis '(' */` |
|    491855 |  7800 | `	pGen->pIn++;` |
|         - |  7801 | `	/* Delimit the function signature */` |
|    491855 |  7802 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|    491855 |  7803 | `	if( pEnd >= pGen->pEnd ){` |
|         - |  7804 | `		/* Syntax error */` |
...
|    491849 |  7815 | `	pFunc = (ph7_vm_func *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_vm_func));` |
|    491849 |  7816 | `	if( pFunc == 0 ){` |
|       ! 0 |  7817 | `		goto OutOfMem;` |
|         - |  7818 | `	}` |
|         - |  7819 | `	/* Build the function name, prepending namespace if active */` |
|    491857 |  7820 | `	if( SyBlobLength(&pGen->sNamespace) > 0 && !bHandleClosure ){` |
|         - |  7821 | `		SyBlob sFQN;` |
|         - |  7822 | `		sxu32 nLen;` |
...
|        10 |  7834 | `	}else{` |
|    491833 |  7835 | `		zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|    491833 |  7836 | `		if( zName == 0 ){` |
|       ! 0 |  7837 | `			goto OutOfMem;` |
|         - |  7838 | `		}` |
|    491833 |  7839 | `		PH7_VmInitFuncState(pGen->pVm,pFunc,zName,pName->nByte,iFlags,0);` |
|         - |  7840 | `	}` |
...
|    491849 |  7843 | `	pFunc->nLine = nLine;` |
|    491849 |  7844 | `	GenStateConsumeDoc(&(*pGen),&pFunc->sDoc);` |
|    491849 |  7845 | `	if( GenStateConsumeAttrs(&(*pGen),&pFunc->aAttrs) == SXERR_ABORT ){` |
|       ! 0 |  7846 | `		return SXERR_ABORT;` |
|         - |  7847 | `	}` |
|    491849 |  7848 | `	if( pGen->pIn < pEnd ){` |
|         - |  7849 | `		/* Collect function arguments */` |
|    425843 |  7850 | `		rc = GenStateCollectFuncArgs(pFunc,&(*pGen),pEnd,0,0);` |
|    425843 |  7851 | `		if( rc == SXERR_ABORT ){` |
...
|    491849 |  7857 | `	pGen->pIn = &pEnd[1];` |
|         - |  7858 | `	{` |
|    491849 |  7859 | `		sxi32 rcRt = GenStateParseReturnType(pGen, pFunc);` |
|    491849 |  7860 | `		if( rcRt == SXERR_ABORT ){` |
|       ! 0 |  7861 | `			return SXERR_ABORT;` |
|    491849 |  7862 | `		}else if( rcRt == SXERR_SYNTAX ){` |
|         9 |  7863 | `			return SXERR_SYNTAX;` |
|         - |  7864 | `		}` |
|         - |  7865 | `	}` |
|    491843 |  7866 | `	if( bHandleClosure ){` |
...
|    491843 |  7976 | `	rc = GenStateCompileFuncBody(&(*pGen),pFunc);` |
|    491843 |  7977 | `	if( rc == SXERR_ABORT ){` |
|       ! 0 |  7978 | `		return SXERR_ABORT;` |
|         - |  7979 | `	}` |
|         - |  7980 | `	/* The cursor sits just past the body's closing brace */` |
|    491843 |  7981 | `	pFunc->nEndLine = pGen->pIn[-1].nLine;` |
|    491843 |  7982 | `	if( ppFunc ){` |
|    491843 |  7983 | `		*ppFunc = pFunc;` |
|    245919 |  7984 | `	}` |
|    491843 |  7985 | `	rc = SXRET_OK;` |
|    491843 |  7986 | `	if( (pFunc->iFlags & VM_FUNC_CLOSURE) == 0 ){` |
|         - |  7987 | `		/* Finally register the function */` |
|    491271 |  7988 | `		rc = PH7_VmInstallUserFunction(pGen->pVm,pFunc,0);` |
|    245633 |  7989 | `	}` |
|    491843 |  7990 | `	if( rc == SXRET_OK ){` |
|    491843 |  7991 | `		return SXRET_OK;` |
|         - |  7992 | `	}` |
...
|         - |  8004 | ` */` |
|    491278 |  8005 | `static sxi32 PH7_CompileFunction(ph7_gen_state *pGen)` |
|         5 |  8006 | `{` |
|         - |  8007 | `	SyString *pName;` |
|         - |  8008 | `	sxi32 iFlags;` |
|         - |  8009 | `	sxu32 nKwLine;` |
...
|         - |  8011 | `	sxi32 rc;` |
|         - |  8012 |  |
|    491283 |  8013 | `	nLine = pGen->pIn->nLine;` |
|    491283 |  8014 | `	nKwLine = nLine; /* Line of the 'function' keyword (Reflection getStartLine) */` |
|    491283 |  8015 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|    491283 |  8016 | `	iFlags = 0;` |
|    491283 |  8017 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|         - |  8018 | `		/* Return by reference,remember that */` |
|        12 |  8019 | `		iFlags \|= VM_FUNC_REF_RETURN;` |
|         - |  8020 | `		/* Jump the '&' token */` |
|        12 |  8021 | `		pGen->pIn++;` |
|         5 |  8022 | `	}` |
|    491283 |  8023 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|         - |  8034 | `	}` |
|    491277 |  8035 | `	pName = &pGen->pIn->sData;` |
|    491277 |  8036 | `	nLine = pGen->pIn->nLine;` |
|         - |  8037 | `	/* Jump the function name */` |
|    491277 |  8038 | `	pGen->pIn++;` |
|    491277 |  8039 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|         - |  8040 | `		/* Syntax error */` |
...
|         - |  8053 | `	{` |
|    491275 |  8054 | `		ph7_vm_func *pFuncState = 0;` |
|    491275 |  8055 | `		rc = GenStateCompileFunc(&(*pGen),pName,iFlags,FALSE,&pFuncState);` |
|    491275 |  8056 | `		if( pFuncState ){` |
|         - |  8057 | `			/* Reflection getStartLine(): line of the 'function' keyword */` |
|    491263 |  8058 | `			pFuncState->nLine = nKwLine;` |
|    245629 |  8059 | `		}` |
|         - |  8060 | `	}` |
|    491275 |  8061 | `	return rc;` |
|    245644 |  8062 | `}` |
|         - |  8063 | `/*` |
...
|         - |  8073 | ` */` |
|   3404334 |  8074 | `static sxi32 GetProtectionLevel(sxi32 nKeyword)` |
|         5 |  8075 | `{` |
|   3404339 |  8076 | `	if( nKeyword == PH7_TKWRD_PRIVATE ){` |
|    256557 |  8077 | `		return PH7_CLASS_PROT_PRIVATE;` |
|   3147787 |  8078 | `	}else if( nKeyword == PH7_TKWRD_PROTECTED ){` |
|    229661 |  8079 | `		return PH7_CLASS_PROT_PROTECTED;` |
|         - |  8080 | `	}` |
|         - |  8081 | `	/* Assume public by default */` |
|   2918131 |  8082 | `	return PH7_CLASS_PROT_PUBLIC;` |
|   1702172 |  8083 | `}` |
|         - |  8084 | `/*` |
...
|         - |  8112 | ` */` |
|    336874 |  8113 | `static int GenStateClassConstHasType(ph7_gen_state *pGen)` |
|         5 |  8114 | `{` |
|         - |  8115 | `	SyToken *p0, *p1;` |
|    336879 |  8116 | `	if( pGen->pIn >= pGen->pEnd ){` |
|       ! 0 |  8117 | `		return 0;` |
|         - |  8118 | `	}` |
|    336879 |  8119 | `	p0 = pGen->pIn;` |
|         - |  8120 | `	/* A leading '\' (namespaced class type) or '?' (nullable) always starts a type */` |
|    336879 |  8121 | `	if( p0->nType & PH7_TK_NSSEP ){` |
|       ! 0 |  8122 | `		return 1;` |
|         - |  8123 | `	}` |
|    336879 |  8124 | `	if( (p0->nType & PH7_TK_OP) && p0->sData.nByte == 1 && p0->sData.zString[0] == '?' ){` |
|         5 |  8125 | `		return 1;` |
|         - |  8126 | `	}` |
...
|    336875 |  8130 | `	if( p0->nType & (PH7_TK_ID\|PH7_TK_KEYWORD) ){` |
|    336875 |  8131 | `		p1 = (pGen->pIn + 1 < pGen->pEnd) ? (pGen->pIn + 1) : 0;` |
|    336875 |  8132 | `		if( p1 ){` |
|    336875 |  8133 | `			if( p1->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_NSSEP) ){` |
|        34 |  8134 | `				return 1;` |
|         - |  8135 | `			}` |
|    336845 |  8136 | `			if( (p1->nType & PH7_TK_OP) && p1->sData.nByte == 1 && p1->sData.zString[0] == '\|' ){` |
|         5 |  8137 | `				return 1;` |
|         - |  8138 | `			}` |
|    168418 |  8139 | `		}` |
|    168418 |  8140 | `	}` |
|    336841 |  8141 | `	return 0;` |
|    168442 |  8142 | `}` |
|         - |  8143 | `/*` |
...
|         - |  8196 | ` */` |
|    697236 |  8197 | `static int GenStateInitHasNewExpr(ph7_gen_state *pGen)` |
|         5 |  8198 | `{` |
|    697241 |  8199 | `	SyToken *p = pGen->pIn;` |
|    697241 |  8200 | `	int iDepth = 0;` |
|   1828483 |  8201 | `	while( p < pGen->pEnd ){` |
|   1828483 |  8202 | `		if( iDepth == 0 && (p->nType & (PH7_TK_SEMI\|PH7_TK_COMMA)) ){` |
|    697189 |  8203 | `			break; /* end of this initializer */` |
|         - |  8204 | `		}` |
|   1131294 |  8205 | `		if( (p->nType & PH7_TK_KEYWORD)` |
|    571408 |  8206 | `			&& ( SX_PTR_TO_INT(p->pUserData) == PH7_TKWRD_FUNCTION` |
|     11512 |  8207 | `				\|\| SX_PTR_TO_INT(p->pUserData) == PH7_TKWRD_FN ) ){` |
...
|         3 |  8265 | `			continue;` |
|         - |  8266 | `		}` |
|   1131297 |  8267 | `		if( p->nType & PH7_TK_OCB ){` |
|        45 |  8268 | `			if( iDepth == 0 ){` |
...
|         - |  8274 | `			}` |
|       ! 0 |  8275 | `			iDepth++;` |
|   1131253 |  8276 | `		}else if( p->nType & (PH7_TK_LPAREN\|PH7_TK_OSB) ){` |
|     46009 |  8277 | `			iDepth++;` |
|   1108251 |  8278 | `		}else if( p->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB) ){` |
|     46007 |  8279 | `			if( iDepth > 0 ){` |
|     46007 |  8280 | `				iDepth--;` |
|     23001 |  8281 | `			}` |
|   1062248 |  8282 | `		}else if( (p->nType & PH7_TK_OP) && p->pUserData` |
|    370295 |  8283 | `			&& ((const ph7_expr_op *)p->pUserData)->iOp == EXPR_OP_NEW ){` |
...
|        11 |  8315 | `	}` |
|       377 |  8316 | `}` |
|    336874 |  8317 | `static sxi32 GenStateCompileClassConstant(ph7_gen_state *pGen,sxi32 iProtection,sxi32 iFlags,ph7_class *pClass)` |
|         5 |  8318 | `{` |
|    336879 |  8319 | `	sxu32 nLine = pGen->pIn->nLine;` |
|         - |  8320 | `	SySet *pInstrContainer;` |
|         - |  8321 | `	ph7_class_attr *pCons;` |
|         - |  8322 | `	SyString *pName;` |
|         - |  8323 | `	sxi32 rc;` |
|    336879 |  8324 | `	sxu32 nType = 0;` |
|         - |  8325 | `	SyString sTypeClass;` |
|         - |  8326 | `	SyString sTypeText;` |
|         - |  8327 | `	SySet aUnionAlts;` |
|    336879 |  8328 | `	sxi32 iTypeFlags = 0;` |
|    336879 |  8329 | `	SyStringInitFromBuf(&sTypeClass,0,0);` |
|    336879 |  8330 | `	SyStringInitFromBuf(&sTypeText,0,0);` |
|    336879 |  8331 | `	SySetInit(&aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|         - |  8332 | `	/* Extract visibility level */` |
|    336879 |  8333 | `	iProtection = GetProtectionLevel(iProtection);` |
|         - |  8334 | `	/* Mark as constant */` |
|    336879 |  8335 | `	iFlags \|= PH7_CLASS_ATTR_CONSTANT;` |
|    336879 |  8336 | `	pGen->pIn++; /* Jump the 'const' keyword */` |
...
|    336898 |  8339 | `	if( GenStateClassConstHasType(pGen) ){` |
...
|        19 |  8360 | `	}` |
|    168437 |  8361 | `loop:` |
|    336881 |  8362 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
...
|    336881 |  8372 | `	pName = &pGen->pIn->sData;` |
|         - |  8373 | `	/* Make sure the constant name isn't reserved */` |
|    336881 |  8374 | `	if( GenStateIsReservedConstant(pName) ){` |
...
|    336881 |  8384 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
...
|    336879 |  8395 | `	pGen->pIn++;` |
|    336879 |  8396 | `	if(pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_EQUAL /* '=' */) == 0 ){` |
...
|         - |  8404 | `	}` |
|    336879 |  8405 | `	pGen->pIn++; /* Jump the equal sign */` |
...
|    336874 |  8410 | `	if( (iTypeFlags & PH7_CLASS_ATTR_TYPED) && !(iTypeFlags & PH7_CLASS_ATTR_UNION)` |
...
|    336875 |  8423 | `	if( GenStateInitHasNewExpr(pGen) ){` |
...
|    336871 |  8432 | `	pCons = PH7_NewClassAttr(pGen->pVm,pName,nLine,iProtection,iFlags\|iTypeFlags);` |
|    336871 |  8433 | `	if( pCons ){` |
|    336871 |  8434 | `		GenStateConsumeDoc(&(*pGen),&pCons->sDoc);` |
|    336871 |  8435 | `		if( GenStateConsumeAttrs(&(*pGen),&pCons->aAttrs) == SXERR_ABORT ){` |
|       ! 0 |  8436 | `			return SXERR_ABORT;` |
|         - |  8437 | `		}` |
|    168433 |  8438 | `	}` |
|    336871 |  8439 | `	if( pCons == 0 ){` |
|       ! 0 |  8440 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|       ! 0 |  8441 | `		return SXERR_ABORT;` |
|         - |  8442 | `	}` |
|    336871 |  8443 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|        35 |  8444 | `		GenStateCopyTypeToAttr(pCons,nType,&sTypeClass,&sTypeText,iTypeFlags,&aUnionAlts);` |
|        16 |  8445 | `	}` |
|         - |  8446 | `	/* Swap bytecode container */` |
|    336871 |  8447 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|    336871 |  8448 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pCons->aByteCode);` |
|         - |  8449 | `	/* Compile constant value.` |
|         - |  8450 | `	 */` |
|    336871 |  8451 | `	rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|    336871 |  8452 | `	if( rc == SXERR_EMPTY ){` |
...
|    336871 |  8459 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|    336871 |  8460 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|    336871 |  8461 | `	if( rc == SXERR_ABORT ){` |
...
|    336871 |  8466 | `	rc = PH7_ClassInstallAttr(pClass,pCons);` |
|    336871 |  8467 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  8468 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|       ! 0 |  8469 | `		return SXERR_ABORT;` |
|         - |  8470 | `	}` |
|    336871 |  8471 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA /*','*/) ){` |
...
|         - |  8489 | `		}` |
|       ! 0 |  8490 | `	}` |
|    336869 |  8491 | `	SySetRelease(&aUnionAlts);` |
|    336869 |  8492 | `	return SXRET_OK;` |
|         5 |  8493 | `Synchronize:` |
...
|         - |  8529 | ` */` |
|   2538526 |  8530 | `static int GenStateLooksLikeTypedProperty(SyToken *pStart,SyToken *pEnd)` |
|         5 |  8531 | `{` |
|   2538531 |  8532 | `	SyToken *p = pStart;` |
|   2538531 |  8533 | `	int bFirst = 1;` |
|   2538531 |  8534 | `	if( p >= pEnd ) return 0;` |
|         - |  8535 | ``	/* Optional nullable `?` shorthand. */`` |
|   2538531 |  8536 | `	if( (p->nType & PH7_TK_OP) && p->sData.nByte == 1 && p->sData.zString[0] == '?' ){` |
|        39 |  8537 | `		p++;` |
...
|   1269263 |  8544 | `	for(;;){` |
|   2538551 |  8545 | `		if( p < pEnd && (p->nType & PH7_TK_LPAREN) ){` |
...
|   2538549 |  8554 | `			if( p < pEnd && (p->nType & PH7_TK_NSSEP) ){ p++; }` |
|   2538549 |  8555 | `			if( p >= pEnd \|\| (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|       ! 0 |  8556 | `				return 0;` |
|         - |  8557 | `			}` |
...
|   2538549 |  8561 | `			if( bFirst && (p->nType & PH7_TK_KEYWORD) ){` |
|   2538499 |  8562 | `				sxu32 k = (sxu32)(SX_PTR_TO_INT(p->pUserData));` |
|   2538494 |  8563 | `				if( k == PH7_TKWRD_FUNCTION \|\| k == PH7_TKWRD_VAR \|\| k == PH7_TKWRD_CONST` |
|    103776 |  8564 | `				 \|\| k == PH7_TKWRD_STATIC \|\| k == PH7_TKWRD_FINAL \|\| k == PH7_TKWRD_ABSTRACT ){` |
|   2538197 |  8565 | `					return 0;` |
|         - |  8566 | `				}` |
|       151 |  8567 | `			}` |
|       357 |  8568 | `			p++;` |
...
|         - |  8745 | ` */` |
|  21413948 |  8746 | `static int GenStateIsReadonly(SyToken *pTok)` |
|         5 |  8747 | `{` |
|  21636669 |  8748 | `	return (pTok->nType & PH7_TK_ID)` |
|  10929690 |  8749 | `		&& pTok->sData.nByte == sizeof("readonly")-1` |
|  21636664 |  8750 | `		&& SyStrnicmp(pTok->sData.zString,"readonly",sizeof("readonly")-1) == 0;` |
|         5 |  8751 | `}` |
|         - |  8752 | `/*` |
...
|         - |  8757 | ` */` |
|   7743992 |  8758 | `static sxi32 GenStatePeekSetVisibility(SyToken *pTok,SyToken *pEnd,int *pnTok)` |
|         5 |  8759 | `{` |
|   7743997 |  8760 | `	*pnTok = 0;` |
|   7743992 |  8761 | `	if( &pTok[3] < pEnd` |
|   7276304 |  8762 | `	 && (pTok->nType & PH7_TK_KEYWORD)` |
|   6036799 |  8763 | `	 && (pTok[1].nType & PH7_TK_LPAREN)` |
|   2632499 |  8764 | `	 && (pTok[2].nType & (PH7_TK_ID\|PH7_TK_KEYWORD))` |
...
|         9 |  8786 | `}` |
|    483102 |  8787 | `static sxi32 GenStateCompileClassAttr(ph7_gen_state *pGen,sxi32 iProtection,sxi32 iFlags,ph7_class *pClass)` |
|         5 |  8788 | `{` |
|    483107 |  8789 | `	sxu32 nLine = pGen->pIn->nLine;` |
|         - |  8790 | `	ph7_class_attr *pAttr;` |
|         - |  8791 | `	SyString *pName;` |
|         - |  8792 | `	sxi32 rc;` |
|    483107 |  8793 | `	sxu32 nType = 0;` |
|         - |  8794 | `	SyString sTypeClass;` |
|         - |  8795 | `	SyString sTypeText;` |
|         - |  8796 | `	SySet aUnionAlts;` |
|    483107 |  8797 | `	sxi32 iTypeFlags = 0;` |
|    483107 |  8798 | `	SyStringInitFromBuf(&sTypeClass,0,0);` |
|    483107 |  8799 | `	SyStringInitFromBuf(&sTypeText,0,0);` |
|    483107 |  8800 | `	SySetInit(&aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
...
|    483107 |  8804 | `	if( pClass->iFlags & PH7_CLASS_READONLY ){` |
|        21 |  8805 | `		iFlags \|= PH7_CLASS_ATTR_READONLY;` |
|         9 |  8806 | `	}` |
|         - |  8807 | `	/* Extract visibility level */` |
|    483107 |  8808 | `	iProtection = GetProtectionLevel(iProtection);` |
|         - |  8809 | `	/* Parse optional type hint (typed properties, PHP 7.4+) */` |
|    483279 |  8810 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
...
|       172 |  8826 | `	}` |
|       ! 0 |  8827 | `loop:` |
|    483111 |  8828 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
...
|         - |  8834 | `	}` |
|    483111 |  8835 | `	pGen->pIn++; /* Jump the dollar sign */` |
|    483111 |  8836 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_ID)) == 0 ){` |
...
|    483111 |  8846 | `	pName = &pGen->pIn->sData;` |
|         - |  8847 | `	/* Advance the stream cursor */` |
|    483111 |  8848 | `	pGen->pIn++;` |
|    483111 |  8849 | `	if(pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_EQUAL/*'='*/\|PH7_TK_SEMI/*';'*/\|PH7_TK_COMMA/*','*/\|PH7_TK_OCB/*'{' hooks*/)) == 0 ){` |
...
|    483109 |  8860 | `	if( iFlags & (PH7_CLASS_ATTR_PRIVATE_SET\|PH7_CLASS_ATTR_PROTECTED_SET\|PH7_CLASS_ATTR_PUBLIC_SET) ){` |
...
|    483109 |  8880 | `	if( iFlags & PH7_CLASS_ATTR_READONLY ){` |
...
|    483099 |  8900 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
...
|    483099 |  8912 | `	if( PH7_ClassExtractAttribute(pClass,pName->zString,pName->nByte) != 0 ){` |
...
|    483097 |  8926 | `	if( (pGen->pIn->nType & PH7_TK_EQUAL /*'='*/) && GenStateInitHasNewExpr(pGen) ){` |
...
|    483093 |  8935 | `	pAttr = PH7_NewClassAttr(pGen->pVm,pName,nLine,iProtection,iFlags\|iTypeFlags);` |
|    483093 |  8936 | `	if( pAttr ){` |
|    483093 |  8937 | `		GenStateConsumeDoc(&(*pGen),&pAttr->sDoc);` |
|    483093 |  8938 | `		if( GenStateConsumeAttrs(&(*pGen),&pAttr->aAttrs) == SXERR_ABORT ){` |
|       ! 0 |  8939 | `			return SXERR_ABORT;` |
|         - |  8940 | `		}` |
|    241544 |  8941 | `	}` |
|    483093 |  8942 | `	if( pAttr == 0 ){` |
|       ! 0 |  8943 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 engine is running out of memory");` |
|       ! 0 |  8944 | `		return SXERR_ABORT;` |
|         - |  8945 | `	}` |
|    483093 |  8946 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|       345 |  8947 | `		GenStateCopyTypeToAttr(pAttr,nType,&sTypeClass,&sTypeText,iTypeFlags,&aUnionAlts);` |
|       170 |  8948 | `	}` |
|    483093 |  8949 | `	if( pGen->pIn->nType & PH7_TK_EQUAL /*'='*/ ){` |
|         - |  8950 | `		SySet *pInstrContainer;` |
|    360367 |  8951 | `		SyToken *pSavedDefEnd = pGen->pEnd;` |
|    360367 |  8952 | `		pGen->pIn++; /*Jump the equal sign */` |
|         - |  8953 | `		{` |
...
|    360367 |  8958 | `			SyToken *pScan = pGen->pIn;` |
|    360367 |  8959 | `			sxi32 iNest = 0;` |
|    790291 |  8960 | `			while( pScan < pGen->pEnd ){` |
|    790291 |  8961 | `				if( pScan->nType & (PH7_TK_LPAREN\|PH7_TK_OSB) ){` |
|     46003 |  8962 | `					iNest++;` |
|    767292 |  8963 | `				}else if( pScan->nType & (PH7_TK_RPAREN\|PH7_TK_CSB) ){` |
|     46003 |  8964 | `					iNest--;` |
|    721294 |  8965 | `				}else if( iNest <= 0 && (pScan->nType & (PH7_TK_SEMI\|PH7_TK_COMMA\|PH7_TK_OCB)) ){` |
|    360367 |  8966 | `					break;` |
|         - |  8967 | `				}` |
|    429929 |  8968 | `				pScan++;` |
|         5 |  8969 | `			}` |
|    360367 |  8970 | `			pGen->pEnd = pScan;` |
|         - |  8971 | `		}` |
|         - |  8972 | `		/* Swap bytecode container */` |
|    360367 |  8973 | `		pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|    360367 |  8974 | `		PH7_VmSetByteCodeContainer(pGen->pVm,&pAttr->aByteCode);` |
|         - |  8975 | `		/* Compile attribute value.` |
|         - |  8976 | `		 */` |
|    360367 |  8977 | `		rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|    360367 |  8978 | `		if( rc == SXERR_EMPTY ){` |
...
|    360367 |  8985 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|    360367 |  8986 | `		PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|    360367 |  8987 | `		pGen->pIn = pGen->pEnd;   /* land exactly on the delimiter */` |
|    360367 |  8988 | `		pGen->pEnd = pSavedDefEnd;` |
|    180181 |  8989 | `	}` |
|         - |  8990 | `	/* All done,install the attribute */` |
|    483093 |  8991 | `	rc = PH7_ClassInstallAttr(pClass,pAttr);` |
|    483093 |  8992 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  8993 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|       ! 0 |  8994 | `		return SXERR_ABORT;` |
|         - |  8995 | `	}` |
|    483093 |  8996 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) ){` |
...
|         - |  9008 | `	}` |
|    482999 |  9009 | `	if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
...
|         - |  9020 | `	}` |
|    482999 |  9021 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA /*','*/) ){` |
...
|         - |  9039 | `		}` |
|       ! 0 |  9040 | `	}` |
|    482995 |  9041 | `	SySetRelease(&aUnionAlts);` |
|    482995 |  9042 | `	return SXRET_OK;` |
|         9 |  9043 | `Synchronize:` |
...
|         - |  9058 | ` */` |
|   2584358 |  9059 | `static sxi32 GenStateCompileClassMethod(` |
...
|         - |  9065 | `	)` |
|         5 |  9066 | `{` |
|   2584363 |  9067 | `	sxu32 nLine = pGen->pIn->nLine;` |
|   2584363 |  9068 | `	sxu32 nKwLine = nLine; /* Line of the 'function' keyword (Reflection getStartLine) */` |
...
|   2584363 |  9075 | `	iProtection = GetProtectionLevel(iProtection);` |
|   2584363 |  9076 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|   2584363 |  9077 | `	iFuncFlags = 0;` |
|   2584363 |  9078 | `	if( pGen->pIn >= pGen->pEnd ){` |
...
|         - |  9086 | `	}` |
|   2584363 |  9087 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|         - |  9088 | `		/* Return by reference,remember that */` |
|       ! 0 |  9089 | `		iFuncFlags \|= VM_FUNC_REF_RETURN;` |
|         - |  9090 | `		/* Jump the '&' token */` |
|       ! 0 |  9091 | `		pGen->pIn++;` |
|       ! 0 |  9092 | `	}` |
|   2584363 |  9093 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|   2584363 |  9102 | `	pName = &pGen->pIn->sData;` |
|   2584363 |  9103 | `	nLine = pGen->pIn->nLine;` |
|         - |  9104 | `	/* Jump the method name */` |
|   2584363 |  9105 | `	pGen->pIn++;` |
|   2584363 |  9106 | `	if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|         - |  9107 | `		/* Abstract method */` |
|    137817 |  9108 | `		if( iProtection == PH7_CLASS_PROT_PRIVATE ){` |
...
|    137817 |  9117 | `		doBody = FALSE;` |
|     68906 |  9118 | `	}` |
|   2584363 |  9119 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|         - |  9120 | `		/* Syntax error */` |
...
|   2584363 |  9129 | `	pMeth = PH7_NewClassMethod(pGen->pVm,pClass,pName,nLine,iProtection,iFlags,iFuncFlags);` |
|   2584363 |  9130 | `	if( pMeth == 0 ){` |
|       ! 0 |  9131 | `		PH7_GenCompileError(&(*pGen),E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|       ! 0 |  9132 | `		return SXERR_ABORT;` |
|         - |  9133 | `	}` |
|   2584363 |  9134 | `	pMeth->sFunc.nLine = nKwLine;` |
|   2584363 |  9135 | `	GenStateConsumeDoc(&(*pGen),&pMeth->sFunc.sDoc);` |
|   2584363 |  9136 | `	if( GenStateConsumeAttrs(&(*pGen),&pMeth->sFunc.aAttrs) == SXERR_ABORT ){` |
|       ! 0 |  9137 | `		return SXERR_ABORT;` |
|         - |  9138 | `	}` |
|         - |  9139 | `	/* Jump the left parenthesis '(' */` |
|   2584363 |  9140 | `	pGen->pIn++;` |
|   2584363 |  9141 | `	pEnd = 0; /* cc warning */` |
|         - |  9142 | `	/* Delimit the method signature */` |
|   2584363 |  9143 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   2584363 |  9144 | `	if( pEnd >= pGen->pEnd ){` |
|         - |  9145 | `		/* Syntax error */` |
...
|         - |  9152 | `	}` |
|         - |  9153 | `	{` |
|   2584361 |  9154 | `		int bIsCtor = 0;` |
|   2584361 |  9155 | `		int bAbstractCtor = 0;` |
|   2584356 |  9156 | `		if( (pName->nByte == sizeof("__construct") - 1` |
|   1521902 |  9157 | `				&& SyMemcmp(pName->zString,"__construct",sizeof("__construct") - 1) == 0)` |
|   2494341 |  9158 | `		 \|\| SyStringCmp(pName,&pClass->sName,SyMemcmp) == 0 ){` |
|    180045 |  9159 | `			if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|         3 |  9160 | `				bAbstractCtor = 1;` |
|         2 |  9161 | `			}else{` |
|    180043 |  9162 | `				bIsCtor = 1;` |
|         - |  9163 | `			}` |
|     90020 |  9164 | `		}` |
|   2584361 |  9165 | `		if( pGen->pIn < pEnd ){` |
|         - |  9166 | `			/* Collect method arguments */` |
|    896013 |  9167 | `			rc = GenStateCollectFuncArgs(&pMeth->sFunc,&(*pGen),pEnd,bIsCtor,bAbstractCtor);` |
|    896013 |  9168 | `			if( rc == SXERR_ABORT ){` |
|       ! 0 |  9169 | `				return SXERR_ABORT;` |
|         - |  9170 | `			}` |
|    448004 |  9171 | `		}` |
|         - |  9172 | `	}` |
|         - |  9173 | `	/* Point past ')' and parse optional return type ': type' */` |
|   2584361 |  9174 | `	pGen->pIn = &pEnd[1];` |
|         - |  9175 | `	{` |
|   2584361 |  9176 | `		sxi32 rcRt = GenStateParseReturnType(pGen, &pMeth->sFunc);` |
|   2584361 |  9177 | `		if( rcRt == SXERR_ABORT ){` |
|       ! 0 |  9178 | `			return SXERR_ABORT;` |
|   2584361 |  9179 | `		}else if( rcRt == SXERR_SYNTAX ){` |
...
|         - |  9186 | `	{` |
|   2584361 |  9187 | `		sxu32 nArg = SySetUsed(&pMeth->sFunc.aArgs);` |
|         - |  9188 | `		sxu32 i;` |
|   3912889 |  9189 | `		for( i = 0; i < nArg; i++ ){` |
|   1328543 |  9190 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pMeth->sFunc.aArgs,i);` |
|         - |  9191 | `			ph7_class_attr *pAttr;` |
|   1328543 |  9192 | `			sxi32 iAttrFlags = 0;` |
|         - |  9193 | `			int bArgTyped;` |
|   1328543 |  9194 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|   1328457 |  9195 | `				continue;` |
|         - |  9196 | `			}` |
...
|        43 |  9291 | `		}` |
|         - |  9292 | `	}` |
|   2584351 |  9293 | `	if( doBody ){` |
|         - |  9294 | `		/* Compile method body */` |
|   2446539 |  9295 | `		rc = GenStateCompileFuncBody(&(*pGen),&pMeth->sFunc);` |
|   2446539 |  9296 | `		if( rc == SXERR_ABORT ){` |
|       ! 0 |  9297 | `			return SXERR_ABORT;` |
|         - |  9298 | `		}` |
|         - |  9299 | `		/* The cursor sits just past the body's closing brace */` |
|   2446539 |  9300 | `		pMeth->sFunc.nEndLine = pGen->pIn[-1].nLine;` |
|   1223272 |  9301 | `	}else{` |
|         - |  9302 | `		/* Abstract/interface method: declaration ends at the ';' */` |
|    137817 |  9303 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI /* ';'*/) ){` |
|    137817 |  9304 | `			pMeth->sFunc.nEndLine = pGen->pIn->nLine;` |
|     68906 |  9305 | `		}` |
|         - |  9306 | `		/* Only method signature is allowed */` |
|    137817 |  9307 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI /* ';'*/) == 0 ){` |
...
|   2584351 |  9318 | `	rc = PH7_ClassInstallMethod(pClass,pMeth);` |
|   2584351 |  9319 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  9320 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|       ! 0 |  9321 | `		return SXERR_ABORT;` |
|         - |  9322 | `	}` |
|   2584351 |  9323 | `	return SXRET_OK;` |
|         6 |  9324 | `Synchronize:` |
...
|         - |  9779 | ` */` |
|     68986 |  9780 | `static sxi32 PH7_CompileClassInterface(ph7_gen_state *pGen)` |
|         5 |  9781 | `{` |
|     68991 |  9782 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|     68991 |  9791 | `	pName = &pGen->pIn->sData;` |
|         - |  9792 | `	/* Advance the stream cursor */` |
|     68991 |  9793 | `	pGen->pIn++;` |
|         - |  9794 | `	/* Build FQN and obtain a raw class */ {` |
|         - |  9795 | `		SyBlob sFQN;` |
|         - |  9796 | `		SyString sFQNStr;` |
|     68991 |  9797 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|     68991 |  9798 | `		GenStateBuildFQN(pGen,pName,&sFQN);` |
|     68991 |  9799 | `		SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|     68991 |  9800 | `		pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|     68991 |  9801 | `		SyBlobRelease(&sFQN);` |
|         - |  9802 | `	}` |
|     68991 |  9803 | `	if( pClass == 0 ){` |
|       ! 0 |  9804 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|       ! 0 |  9805 | `		return SXERR_ABORT;` |
|         - |  9806 | `	}` |
|     68991 |  9807 | `	GenStateConsumeDoc(&(*pGen),&pClass->sDoc);` |
|     68991 |  9808 | `	if( GenStateConsumeAttrs(&(*pGen),&pClass->aAttrs) == SXERR_ABORT ){` |
|       ! 0 |  9809 | `		return SXERR_ABORT;` |
|         - |  9810 | `	}` |
|         - |  9811 | `	/* Mark as an interface (PH7_NewRawClass may have set INTERNAL) */` |
|     68991 |  9812 | `	pClass->iFlags \|= PH7_CLASS_INTERFACE;` |
|         - |  9813 | `	/* Assume no base class is given */` |
|     68991 |  9814 | `	pBase = 0;` |
|     68991 |  9815 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|     26799 |  9816 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|     26799 |  9817 | `		if( nKwrd == PH7_TKWRD_EXTENDS /* interface b extends a, c, … */ ){` |
...
|     26801 |  9828 | `				nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|     26801 |  9829 | `				SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|     26801 |  9830 | `				if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|         - |  9840 | `				}` |
|     40199 |  9841 | `				pParent = PH7_VmExtractClass(pGen->pVm,` |
|     26796 |  9842 | `					(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|     26801 |  9843 | `				SyStringInitFromBuf(&sBaseName,` |
|         - |  9844 | `					(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|         - |  9845 | `				/* Only interfaces is allowed */` |
|     26801 |  9846 | `				while( pParent && (pParent->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|       ! 0 |  9847 | `					pParent = pParent->pNextName;` |
|       ! 0 |  9848 | `				}` |
|     26801 |  9849 | `				if( pParent == 0 ){` |
...
|       ! 0 |  9855 | `					}` |
|     26801 |  9856 | `				}else if( pBase == 0 ){` |
|         - |  9857 | `					/* First parent → single-inheritance base */` |
|     26799 |  9858 | `					pBase = pParent;` |
|     13402 |  9859 | `				}else{` |
...
|         - |  9863 | `				}` |
|     26801 |  9864 | `				SyBlobRelease(&sResolved);` |
|         - |  9865 | `				/* Continue on a comma-separated list */` |
|     26801 |  9866 | `				if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA) ){` |
|         3 |  9867 | `					pGen->pIn++;` |
|         3 |  9868 | `					continue;` |
|         - |  9869 | `				}` |
|     26799 |  9870 | `				break;` |
...
|     13397 |  9872 | `		}` |
|     13397 |  9873 | `	}` |
|     68991 |  9874 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|         - |  9875 | `		/* Syntax error */` |
...
|         - |  9883 | `	}` |
|     68991 |  9884 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|     68991 |  9885 | `	pEnd = 0; /* cc warning */` |
|         - |  9886 | `	/* Delimit the interface body */` |
|     68991 |  9887 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|     68991 |  9888 | `	if( pEnd >= pGen->pEnd ){` |
|         - |  9889 | `		/* Syntax error */` |
...
|     68991 |  9899 | `	pClass->nEndLine = pEnd->nLine;` |
|         - |  9900 | `	/* Swap token stream */` |
|     68991 |  9901 | `	pTmp = pGen->pEnd;` |
|     68991 |  9902 | `	pGen->pEnd = pEnd;` |
...
|    436423 |  9910 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|    183719 |  9911 | `			pGen->pIn++;` |
|         5 |  9912 | `		}` |
|    252709 |  9913 | `		if( pGen->pIn >= pGen->pEnd ){` |
|         - |  9914 | `			/* End of interface body */` |
|     68987 |  9915 | `			break;` |
|         - |  9916 | `		}` |
|         - |  9917 | `		/* Bind a directly-preceding docblock to this member */` |
|    183727 |  9918 | `		GenStateSetPendingDoc(&(*pGen));` |
|    183727 |  9919 | `		if( (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|    183727 |  9930 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    183727 |  9931 | `		if( nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
...
|         3 |  9960 | `			goto done;` |
|         - |  9961 | `		}` |
|    183725 |  9962 | `		if( nKwrd != PH7_TKWRD_PUBLIC && nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|       ! 0 |  9969 | `			goto done;` |
|         - |  9970 | `		}` |
|    183725 |  9971 | `		if( nKwrd == PH7_TKWRD_PUBLIC ){` |
|         - |  9972 | `			/* Advance the stream cursor */` |
|    130143 |  9973 | `			pGen->pIn++;` |
|    130138 |  9974 | `			if( pGen->pIn < pGen->pEnd` |
|    130143 |  9975 | `			 && ((pGen->pIn->nType & PH7_TK_DOLLAR) != 0` |
|    130138 |  9976 | `			  \|\| (pGen->pIn->sData.nByte == 1 && pGen->pIn->sData.zString[0] == '?')) ){` |
...
|       ! 0 |  9990 | `				continue;` |
|         - |  9991 | `			}` |
|    130143 |  9992 | `			if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|       ! 0 | 10014 | `				goto done;` |
|         - | 10015 | `			}` |
|    130143 | 10016 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    130143 | 10017 | `			if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|         - | 10039 | `			}` |
|     65067 | 10040 | `		}` |
|    183721 | 10041 | `		if( nKwrd == PH7_TKWRD_CONST ){` |
|         - | 10042 | `			/* Parse constant */` |
|     53583 | 10043 | `			rc = GenStateCompileClassConstant(&(*pGen),0,0,pClass);` |
|     53583 | 10044 | `			if( rc != SXRET_OK ){` |
...
|         - | 10049 | `			}` |
|     26793 | 10050 | `		}else{` |
|    130143 | 10051 | `			sxi32 iFlags = PH7_CLASS_ATTR_ABSTRACT; /* Interface methods are implicitly abstract */` |
|    130143 | 10052 | `			if( nKwrd == PH7_TKWRD_STATIC ){` |
|         - | 10053 | `				/* Static method,record that */` |
|     11483 | 10054 | `				iFlags \|= PH7_CLASS_ATTR_STATIC;` |
|         - | 10055 | `				/* Advance the stream cursor */` |
|     11483 | 10056 | `				pGen->pIn++;` |
|     11478 | 10057 | `				if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0` |
|     11483 | 10058 | `					\|\| SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_FUNCTION ){` |
...
|    130143 | 10069 | `			rc = GenStateCompileClassMethod(&(*pGen),0,iFlags,FALSE,pClass);` |
|    130143 | 10070 | `			if( rc != SXRET_OK ){` |
...
|     68987 | 10079 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|     68987 | 10080 | `	if( rc == SXRET_OK && pBase ){` |
|         - | 10081 | `		/* Inherit from the base interface */` |
|     26799 | 10082 | `		rc = PH7_ClassInterfaceInherit(pClass,pBase);` |
|     13397 | 10083 | `	}` |
|     68987 | 10084 | `	if( rc != SXRET_OK ){` |
...
|     68991 | 10090 | `	pGen->pIn  = &pEnd[1];` |
|     68991 | 10091 | `	pGen->pEnd = pTmp;` |
|     68991 | 10092 | `	return PH7_OK;` |
|     34498 | 10093 | `}` |
|         - | 10094 | `/*` |
...
|         - | 10118 | ` */` |
|    376798 | 10119 | `static sxi32 GenStateCheckInterfaceSignatures(ph7_gen_state *pGen,ph7_class *pClass)` |
|         5 | 10120 | `{` |
|         - | 10121 | `	ph7_class **apIface;` |
|         - | 10122 | `	sxu32 nIface,i;` |
|         - | 10123 | `	sxi32 rc;` |
|    376803 | 10124 | `	if( pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|       ! 0 | 10125 | `		return SXRET_OK;` |
|         - | 10126 | `	}` |
|    376803 | 10127 | `	apIface = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|    376803 | 10128 | `	nIface = SySetUsed(&pClass->aInterface);` |
|    763577 | 10129 | `	for(i = 0; i < nIface; i++){` |
|    386779 | 10130 | `		ph7_class *pIface = apIface[i];` |
|         - | 10131 | `		SyHashEntry *pEntry;` |
|    386779 | 10132 | `		SyHashResetLoopCursor(&pIface->hMethod);` |
|   1152581 | 10133 | `		while((pEntry = SyHashGetNextEntry(&pIface->hMethod)) != 0 ){` |
|    765807 | 10134 | `			ph7_class_method *pIfaceMeth = (ph7_class_method *)pEntry->pUserData;` |
|         - | 10135 | `			ph7_class_method *pImplMeth;` |
|    765807 | 10136 | `			SyString *pMName = &pIfaceMeth->sFunc.sName;` |
|         - | 10137 | `			/* Find the implementing method in the class */` |
|    765807 | 10138 | `			pImplMeth = PH7_ClassExtractMethod(pClass,pMName->zString,pMName->nByte);` |
|    765807 | 10139 | `			if( pImplMeth == 0 \|\| (pImplMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT) ){` |
...
|    765789 | 10143 | `			if( pImplMeth->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|         - | 10153 | `			 */` |
|         - | 10154 | `			{` |
|    765789 | 10155 | `				sxu32 nIfaceArgs = SySetUsed(&pIfaceMeth->sFunc.aArgs);` |
|    765789 | 10156 | `				sxu32 nImplArgs = SySetUsed(&pImplMeth->sFunc.aArgs);` |
|    765789 | 10157 | `				int sigError = 0;` |
|    765789 | 10158 | `				if( nImplArgs < nIfaceArgs ){` |
|         3 | 10159 | `					sigError = 1;` |
|    765788 | 10160 | `				}else if( nImplArgs > nIfaceArgs ){` |
|         - | 10161 | `					/* Extra parameters must all have default values */` |
|      3835 | 10162 | `					ph7_vm_func_arg *aImplArgs = (ph7_vm_func_arg *)SySetBasePtr(&pImplMeth->sFunc.aArgs);` |
|         - | 10163 | `					sxu32 k;` |
|      7663 | 10164 | `					for(k = nIfaceArgs; k < nImplArgs; k++){` |
|      3835 | 10165 | `						if( SySetUsed(&aImplArgs[k].aByteCode) == 0 ){` |
|         3 | 10166 | `							sigError = 1;` |
|         3 | 10167 | `							break;` |
|         - | 10168 | `						}` |
|      1919 | 10169 | `					}` |
|      1915 | 10170 | `				}` |
|    765789 | 10171 | `				if( sigError ){` |
...
|         - | 10251 | ` */` |
|    376798 | 10252 | `static sxi32 GenStateCheckAbstractMethods(ph7_gen_state *pGen,ph7_class *pClass)` |
|         5 | 10253 | `{` |
...
|    376803 | 10260 | `	if( pClass->iFlags & (PH7_CLASS_ABSTRACT\|PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|     19189 | 10261 | `		return SXRET_OK;` |
|         - | 10262 | `	}` |
|         - | 10263 | `	/* Count abstract methods */` |
|    357619 | 10264 | `	nAbstract = 0;` |
|    357619 | 10265 | `	SyHashResetLoopCursor(&pClass->hMethod);` |
|   5535908 | 10266 | `	while((pEntry = SyHashGetNextEntry(&pClass->hMethod)) != 0 ){` |
|   4999487 | 10267 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|   4999487 | 10268 | `		if( pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
...
|         8 | 10273 | `		}` |
|         5 | 10274 | `	}` |
|    357619 | 10275 | `	if( nAbstract == 0 ){` |
|    357605 | 10276 | `		return SXRET_OK;` |
|         - | 10277 | `	}` |
...
|         - | 10414 | ` */` |
|    449864 | 10415 | `static sxi32 GenStateParseClassReference(ph7_gen_state *pGen,SyBlob *pFqn)` |
|         5 | 10416 | `{` |
|    449869 | 10417 | `	int isAbsolute = 0;` |
|    449869 | 10418 | `	SyToken *pStart = pGen->pIn;` |
|         - | 10419 | `	SyBlob sName;` |
|    449869 | 10420 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) ){` |
|      4435 | 10421 | `		isAbsolute = 1;` |
|      4435 | 10422 | `		pGen->pIn++;` |
|      2215 | 10423 | `	}` |
|    449869 | 10424 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|         9 | 10425 | `		pGen->pIn = pStart;` |
|         9 | 10426 | `		return SXERR_INVALID;` |
|         - | 10427 | `	}` |
|    449863 | 10428 | `	SyBlobInit(&sName,&pGen->pVm->sAllocator);` |
|    449863 | 10429 | `	SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|    449863 | 10430 | `	pGen->pIn++;` |
|    674820 | 10431 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) &&` |
|    224967 | 10432 | `		&pGen->pIn[1] < pGen->pEnd && (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|        24 | 10433 | `		SyBlobAppend(&sName,"\\",1);` |
|        24 | 10434 | `		pGen->pIn++;` |
|        24 | 10435 | `		SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|        24 | 10436 | `		pGen->pIn++;` |
|         2 | 10437 | `	}` |
|    449863 | 10438 | `	if( isAbsolute ){` |
|      4433 | 10439 | `		SyBlobAppend(pFqn,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|      2219 | 10440 | `	}else{` |
|         - | 10441 | `		SyString sRaw;` |
|    445435 | 10442 | `		SyStringInitFromBuf(&sRaw,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|    445435 | 10443 | `		GenStateResolveName(pGen,&sRaw,pFqn);` |
|         - | 10444 | `	}` |
|    449863 | 10445 | `	SyBlobRelease(&sName);` |
|    449863 | 10446 | `	return SXRET_OK;` |
|    224937 | 10447 | `}` |
|         - | 10448 | `/*` |
...
|    180032 | 10456 | `static int GenStateInterfaceIsThrowableAt(ph7_class *pInterface,int iDepth)` |
|         5 | 10457 | `{` |
|         - | 10458 | `	ph7_class **apParent;` |
|         - | 10459 | `	sxu32 n;` |
|    482541 | 10460 | `	while( pInterface ){` |
|    310171 | 10461 | `		if( iDepth > PH7_THROWABLE_WALK_MAX_DEPTH ){` |
|       ! 0 | 10462 | `			return FALSE;` |
|         - | 10463 | `		}` |
|    344625 | 10464 | `		if( pInterface->sName.nByte == sizeof("Throwable")-1 &&` |
|     68908 | 10465 | `			SyMemcmp(pInterface->sName.zString,"Throwable",sizeof("Throwable")-1) == 0 ){` |
|      7667 | 10466 | `			return TRUE;` |
|         - | 10467 | `		}` |
|    302509 | 10468 | `		apParent = (ph7_class **)SySetBasePtr(&pInterface->aInterface);` |
|    302511 | 10469 | `		for( n = 0 ; n < SySetUsed(&pInterface->aInterface) ; ++n ){` |
|         3 | 10470 | `			if( GenStateInterfaceIsThrowableAt(apParent[n],iDepth+1) ){` |
|       ! 0 | 10471 | `				return TRUE;` |
|         - | 10472 | `			}` |
|         2 | 10473 | `		}` |
|    302509 | 10474 | `		pInterface = pInterface->pBase;` |
|    302509 | 10475 | `		iDepth++;` |
|         5 | 10476 | `	}` |
|    172375 | 10477 | `	return FALSE;` |
|     90021 | 10478 | `}` |
|    180030 | 10479 | `static int GenStateInterfaceIsThrowable(ph7_class *pInterface)` |
|         5 | 10480 | `{` |
|    180035 | 10481 | `	return GenStateInterfaceIsThrowableAt(pInterface,0);` |
|         5 | 10482 | `}` |
|         - | 10483 | `/*` |
...
|         - | 10487 | ` */` |
|      7662 | 10488 | `static int GenStateClassIsExceptionOrError(ph7_class *pBase)` |
|         5 | 10489 | `{` |
|      7671 | 10490 | `	while( pBase ){` |
...
|         - | 10511 | ` */` |
|      7706 | 10512 | `static sxi32 GenStateCompileEnumCase(ph7_gen_state *pGen,ph7_class *pClass)` |
|         5 | 10513 | `{` |
|      7711 | 10514 | `	sxu32 nLine = pGen->pIn->nLine;` |
|         - | 10515 | `	SySet *pInstrContainer;` |
|         - | 10516 | `	ph7_class_attr *pCase;` |
|         - | 10517 | `	SyString *pName;` |
|         - | 10518 | `	sxi32 rc;` |
|      7711 | 10519 | `	pGen->pIn++; /* Jump the 'case' keyword */` |
|      7711 | 10520 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|         - | 10527 | `	}` |
|      7711 | 10528 | `	pName = &pGen->pIn->sData;` |
|         - | 10529 | `	/* Cases share the class-constant namespace (php: "Cannot redefine class constant") */` |
|      7711 | 10530 | `	if( SyHashGet(&pClass->hAttr,(const void *)pName->zString,pName->nByte) != 0 ){` |
...
|         - | 10537 | `	}` |
|      7711 | 10538 | `	pCase = PH7_NewClassAttr(pGen->pVm,pName,pGen->pIn->nLine,PH7_CLASS_PROT_PUBLIC,` |
|         - | 10539 | `		PH7_CLASS_ATTR_CONSTANT\|PH7_CLASS_ATTR_ENUMCASE);` |
|      7711 | 10540 | `	if( pCase == 0 ){` |
|       ! 0 | 10541 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|       ! 0 | 10542 | `		return SXERR_ABORT;` |
|         - | 10543 | `	}` |
|      7711 | 10544 | `	GenStateConsumeDoc(&(*pGen),&pCase->sDoc);` |
|      7711 | 10545 | `	if( GenStateConsumeAttrs(&(*pGen),&pCase->aAttrs) == SXERR_ABORT ){` |
|       ! 0 | 10546 | `		return SXERR_ABORT;` |
|         - | 10547 | `	}` |
|      7711 | 10548 | `	pGen->pIn++; /* Jump the case name */` |
|      7711 | 10549 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_EQUAL /* '=' */) ){` |
|      7697 | 10550 | `		if( pClass->nEnumBacking == 0 ){` |
...
|         - | 10557 | `		}` |
|      7693 | 10558 | `		pGen->pIn++; /* Jump the equal sign */` |
|         - | 10559 | `		/* Compile the backing value expression into the case's own container` |
|         - | 10560 | `		 * (same technique as class constants). */` |
|      7693 | 10561 | `		pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|      7693 | 10562 | `		PH7_VmSetByteCodeContainer(pGen->pVm,&pCase->aByteCode);` |
|      7693 | 10563 | `		rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|      7693 | 10564 | `		if( rc == SXERR_EMPTY ){` |
|       ! 0 | 10565 | `			rc = PH7_GenCompileError(pGen,E_ERROR,nLine,` |
|       ! 0 | 10566 | `				"Empty value for enum case %z::%z",&pClass->sName,pName);` |
|       ! 0 | 10567 | `		}` |
|      7693 | 10568 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|      7693 | 10569 | `		PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|      7693 | 10570 | `		if( rc == SXERR_ABORT ){` |
...
|         - | 10581 | `		}` |
|         - | 10582 | `	}` |
|      7707 | 10583 | `	rc = PH7_ClassInstallAttr(pClass,pCase);` |
|      7707 | 10584 | `	if( rc != SXRET_OK ){` |
|       ! 0 | 10585 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|       ! 0 | 10586 | `		return SXERR_ABORT;` |
|         - | 10587 | `	}` |
|      7707 | 10588 | `	SySetPut(&pClass->aEnumCases,(const void *)&pCase);` |
|      7707 | 10589 | `	return SXRET_OK;` |
|         2 | 10590 | `Synchronize:` |
...
|         - | 10605 | ` */` |
|      3854 | 10606 | `static sxi32 GenStateCompileEnumMethods(ph7_gen_state *pGen,ph7_class *pClass)` |
|         5 | 10607 | `{` |
...
|      3859 | 10613 | `	sxi32 rc = SXRET_OK;` |
|      3859 | 10614 | `	nMax = 3*(sxu32)sizeof("function tryFrom(string $value){return __phl_enum_tryfrom('',$value);}")` |
|      3854 | 10615 | `		+ 3*SyStringLength(&pClass->sName) + 64;` |
|      3859 | 10616 | `	zSrc = (char *)SyMemBackendAlloc(&pGen->pVm->sAllocator,nMax);` |
|      3859 | 10617 | `	if( zSrc == 0 ){` |
|       ! 0 | 10618 | `		PH7_GenCompileError(pGen,E_ERROR,pClass->nLine,"Fatal, PH7 is running out of memory");` |
|       ! 0 | 10619 | `		return SXERR_ABORT;` |
|         - | 10620 | `	}` |
|      3859 | 10621 | `	zBack = (pClass->nEnumBacking == MEMOBJ_INT) ? "int" : "string";` |
|      3859 | 10622 | `	if( pClass->nEnumBacking != 0 ){` |
|      5765 | 10623 | `		nSrc = SyBufferFormat(zSrc,nMax,` |
...
|      1920 | 10627 | `			&pClass->sName,zBack,&pClass->sName,zBack,&pClass->sName);` |
|      1925 | 10628 | `	}else{` |
|        24 | 10629 | `		nSrc = SyBufferFormat(zSrc,nMax,` |
|         7 | 10630 | `			"function cases(){return __phl_enum_cases('%z');}",&pClass->sName);` |
|         - | 10631 | `	}` |
|      3859 | 10632 | `	SySetInit(&sToken,&pGen->pVm->sAllocator,sizeof(SyToken));` |
|      3859 | 10633 | `	PH7_TokenizePHP(zSrc,nSrc,pClass->nLine,&sToken,0);` |
|      3859 | 10634 | `	pSaveIn = pGen->pIn;` |
|      3859 | 10635 | `	pSaveEnd = pGen->pEnd;` |
|      3859 | 10636 | `	pGen->pIn = (SyToken *)SySetBasePtr(&sToken);` |
|      3859 | 10637 | `	pGen->pEnd = &pGen->pIn[SySetUsed(&sToken)];` |
|     15393 | 10638 | `	while( pGen->pIn < pGen->pEnd && rc != SXERR_ABORT ){` |
|     11539 | 10639 | `		rc = GenStateCompileClassMethod(&(*pGen),PH7_TKWRD_PUBLIC,PH7_CLASS_ATTR_STATIC,TRUE,pClass);` |
|         5 | 10640 | `	}` |
|      3859 | 10641 | `	pGen->pIn = pSaveIn;` |
|      3859 | 10642 | `	pGen->pEnd = pSaveEnd;` |
|      3859 | 10643 | `	SySetRelease(&sToken);` |
|      3859 | 10644 | `	return (rc == SXERR_ABORT) ? SXERR_ABORT : SXRET_OK;` |
|      1932 | 10645 | `}` |
|         - | 10646 | `/*` |
...
|         - | 10660 | ` */` |
|      3854 | 10661 | `static sxi32 GenStateEnumFinalize(ph7_gen_state *pGen,ph7_class *pClass,sxu32 nLine)` |
|         5 | 10662 | `{` |
|         - | 10663 | `	SyHashEntry *pEntry;` |
|         - | 10664 | `	sxi32 rc;` |
|         - | 10665 | `	sxu32 n;` |
|         - | 10666 | `	/* php: "Enum %s cannot include properties" */` |
|      3859 | 10667 | `	SyHashResetLoopCursor(&pClass->hAttr);` |
|     11565 | 10668 | `	while( (pEntry = SyHashGetNextEntry(&pClass->hAttr)) != 0 ){` |
|      7713 | 10669 | `		ph7_class_attr *pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|      7713 | 10670 | `		if( (pAttr->iFlags & PH7_CLASS_ATTR_CONSTANT) == 0 ){` |
...
|     53961 | 10680 | `	for( n = 0 ; n < SX_ARRAYSIZE(azEnumBannedMagic) ; n++ ){` |
|     75153 | 10681 | `		if( SyHashGet(&pClass->hMethod,(const void *)azEnumBannedMagic[n],` |
|     50107 | 10682 | `			SyStrlen(azEnumBannedMagic[n])) != 0 ){` |
...
|      3859 | 10698 | `		pAttr = PH7_NewClassAttr(pGen->pVm,&sNameProp,nLine,PH7_CLASS_PROT_PUBLIC,` |
|         - | 10699 | `			PH7_CLASS_ATTR_READONLY\|PH7_CLASS_ATTR_TYPED);` |
|      3859 | 10700 | `		if( pAttr == 0 ){` |
|       ! 0 | 10701 | `			PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|       ! 0 | 10702 | `			return SXERR_ABORT;` |
|         - | 10703 | `		}` |
|      3859 | 10704 | `		pAttr->nType = MEMOBJ_STRING;` |
|      3859 | 10705 | `		SyStringInitFromBuf(&pAttr->sTypeName,"string",sizeof("string")-1);` |
|      3859 | 10706 | `		PH7_ClassInstallAttr(pClass,pAttr);` |
|      3859 | 10707 | `		if( pClass->nEnumBacking != 0 ){` |
|      3845 | 10708 | `			pAttr = PH7_NewClassAttr(pGen->pVm,&sValueProp,nLine,PH7_CLASS_PROT_PUBLIC,` |
|         - | 10709 | `				PH7_CLASS_ATTR_READONLY\|PH7_CLASS_ATTR_TYPED);` |
|      3845 | 10710 | `			if( pAttr == 0 ){` |
|       ! 0 | 10711 | `				PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|       ! 0 | 10712 | `				return SXERR_ABORT;` |
|         - | 10713 | `			}` |
|      3845 | 10714 | `			pAttr->nType = pClass->nEnumBacking;` |
|      3845 | 10715 | `			if( pClass->nEnumBacking == MEMOBJ_INT ){` |
|         7 | 10716 | `				SyStringInitFromBuf(&pAttr->sTypeName,"int",sizeof("int")-1);` |
|         4 | 10717 | `			}else{` |
|      3839 | 10718 | `				SyStringInitFromBuf(&pAttr->sTypeName,"string",sizeof("string")-1);` |
|         - | 10719 | `			}` |
|      3845 | 10720 | `			PH7_ClassInstallAttr(pClass,pAttr);` |
|      1920 | 10721 | `		}` |
|         - | 10722 | `	}` |
|      3859 | 10723 | `	return GenStateCompileEnumMethods(&(*pGen),pClass);` |
|      1932 | 10724 | `}` |
|         - | 10725 | `/*` |
...
|         - | 10734 | ` */` |
|    376842 | 10735 | `static sxi32 GenStateCompileClassEx(ph7_gen_state *pGen,sxi32 iFlags,` |
|         - | 10736 | `	SyString *pAnonName,SyToken **ppArgStart,SyToken **ppArgEnd)` |
|         5 | 10737 | `{` |
|    376847 | 10738 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|    376847 | 10749 | `	pGen->pIn++;` |
|    376847 | 10750 | `	if( pAnonName ){` |
...
|        18 | 10765 | `	}else{` |
|    376819 | 10766 | `		if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
|         - | 10767 | `			/* Syntax error */` |
...
|    376819 | 10780 | `		pName = &pGen->pIn->sData;` |
|         - | 10781 | `		/* Advance the stream cursor */` |
|    376819 | 10782 | `		pGen->pIn++;` |
|         - | 10783 | `		/* Build FQN and obtain a raw class */ {` |
|         - | 10784 | `			SyBlob sFQN;` |
|         - | 10785 | `			SyString sFQNStr;` |
|    376819 | 10786 | `			SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|    376819 | 10787 | `			GenStateBuildFQN(pGen,pName,&sFQN);` |
|    376819 | 10788 | `			SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|    376819 | 10789 | `			pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|    376819 | 10790 | `			SyBlobRelease(&sFQN);` |
|         - | 10791 | `		}` |
|         - | 10792 | `	}` |
|    376847 | 10793 | `	if( pClass == 0 ){` |
|       ! 0 | 10794 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|       ! 0 | 10795 | `		return SXERR_ABORT;` |
|         - | 10796 | `	}` |
|    376842 | 10797 | `	if( (iFlags & PH7_CLASS_ENUM) && pGen->pIn < pGen->pEnd` |
|      3863 | 10798 | `		&& (pGen->pIn->nType & PH7_TK_COLON /* ':' */) ){` |
|         - | 10799 | ``		/* Backed enum: `enum Name: int\|string` (PHP 8.1) */`` |
|      3847 | 10800 | `		pGen->pIn++; /* Jump ':' */` |
|      3842 | 10801 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD)` |
|      3847 | 10802 | `			&& SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_INT ){` |
|         7 | 10803 | `			pClass->nEnumBacking = MEMOBJ_INT;` |
|         7 | 10804 | `			pGen->pIn++;` |
|      3840 | 10805 | `		}else if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD)` |
|      3841 | 10806 | `			&& SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_STRING ){` |
|      3839 | 10807 | `			pClass->nEnumBacking = MEMOBJ_STRING;` |
|      3839 | 10808 | `			pGen->pIn++;` |
|      1922 | 10809 | `		}else{` |
...
|         - | 10820 | `		}` |
|      1921 | 10821 | `	}` |
|    376847 | 10822 | `	GenStateConsumeDoc(&(*pGen),&pClass->sDoc);` |
|    376847 | 10823 | `	if( GenStateConsumeAttrs(&(*pGen),&pClass->aAttrs) == SXERR_ABORT ){` |
|       ! 0 | 10824 | `		return SXERR_ABORT;` |
|         - | 10825 | `	}` |
|         - | 10826 | `	/* implemented interfaces and per-use-statement trait containers */` |
|    376847 | 10827 | `	SySetInit(&aInterfaces,&pGen->pVm->sAllocator,sizeof(ph7_class *));` |
|    376847 | 10828 | `	SySetInit(&aUseEntries,&pGen->pVm->sAllocator,sizeof(TraitUseEntry));` |
|         - | 10829 | `	/* Assume a standalone class */` |
|    376847 | 10830 | `	pBase = 0;` |
|    376847 | 10831 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|    310373 | 10832 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    310373 | 10833 | `		if( nKwrd == PH7_TKWRD_EXTENDS /* class b extends a */ ){` |
|         - | 10834 | `			SyBlob sResolved;` |
|         - | 10835 | `			SyString sBaseName;` |
|         - | 10836 | `			sxu32 nRefLine;` |
|    203065 | 10837 | `			if( iFlags & PH7_CLASS_ENUM ){` |
...
|         - | 10843 | `				}` |
|       ! 0 | 10844 | `			}` |
|    203065 | 10845 | `			pGen->pIn++; /* Advance past 'extends' */` |
|    203065 | 10846 | `			nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|    203065 | 10847 | `			SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|    203065 | 10848 | `			if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|         - | 10858 | `			}` |
|    304592 | 10859 | `			pBase = PH7_VmExtractClass(pGen->pVm,` |
|    203058 | 10860 | `				(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|    203063 | 10861 | `			SyStringInitFromBuf(&sBaseName,` |
|         - | 10862 | `				(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|         - | 10863 | `			/* Interfaces are not allowed */` |
|    203063 | 10864 | `			while( pBase && (pBase->iFlags & PH7_CLASS_INTERFACE) ){` |
|       ! 0 | 10865 | `				pBase = pBase->pNextName;` |
|       ! 0 | 10866 | `			}` |
|    203063 | 10867 | `			if( pBase == 0 ){` |
...
|         - | 10873 | `				}` |
|       ! 0 | 10874 | `			}else{` |
|    203063 | 10875 | `				if( pBase->iFlags & PH7_CLASS_ENUM ){` |
...
|    203062 | 10883 | `				}else if( pBase->iFlags & PH7_CLASS_FINAL ){` |
...
|       ! 0 | 10890 | `				}` |
|         - | 10891 | `			}` |
|    203063 | 10892 | `			SyBlobRelease(&sResolved);` |
|    203063 | 10893 | `			if( iFlags & PH7_CLASS_ENUM ){` |
|       ! 0 | 10894 | `				pBase = 0; /* Error already reported: enums have no base class */` |
|       ! 0 | 10895 | `			}` |
|    101529 | 10896 | `		}` |
|    310371 | 10897 | `		if (pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) && SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_IMPLEMENTS ){` |
|         - | 10898 | `			ph7_class *pInterface;` |
|         - | 10899 | `			/* Interface implementation */` |
|    122631 | 10900 | `			pGen->pIn++; /* Advance the stream cursor */` |
|    118717 | 10901 | `			for(;;){` |
|         - | 10902 | `				SyBlob sResolved;` |
|         - | 10903 | `				SyString sIntName;` |
|         - | 10904 | `				sxu32 nRefLine;` |
|    180035 | 10905 | `				nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|    180035 | 10906 | `				SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|    180035 | 10907 | `				if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|       ! 0 | 10915 | `					break;` |
|         - | 10916 | `				}` |
|    360065 | 10917 | `				pInterface = PH7_VmExtractClass(pGen->pVm,` |
|    180030 | 10918 | `					(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|    180035 | 10919 | `				SyStringInitFromBuf(&sIntName,` |
|         - | 10920 | `					(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|         - | 10921 | `				/* Only interfaces are allowed */` |
|    180035 | 10922 | `				while( pInterface && (pInterface->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|       ! 0 | 10923 | `					pInterface = pInterface->pNextName;` |
|       ! 0 | 10924 | `				}` |
|    180035 | 10925 | `				if( pInterface == 0 ){` |
...
|    180035 | 10939 | `					SyString *pFqn = &pClass->sName;` |
|    180035 | 10940 | `					int bIsExceptionOrError =` |
|     93845 | 10941 | `						(pFqn->nByte == sizeof("Exception")-1 &&` |
|    271962 | 10942 | `						 SyMemcmp(pFqn->zString,"Exception",sizeof("Exception")-1) == 0) \|\|` |
|    178124 | 10943 | `						(pFqn->nByte == sizeof("Error")-1 &&` |
|      3840 | 10944 | `						 SyMemcmp(pFqn->zString,"Error",sizeof("Error")-1) == 0);` |
|    183861 | 10945 | `					if( GenStateInterfaceIsThrowable(pInterface) &&` |
|     11496 | 10946 | `						!GenStateClassIsExceptionOrError(pBase) &&` |
|      3829 | 10947 | `						!bIsExceptionOrError ){` |
...
|         6 | 10957 | `					}else{` |
|    180029 | 10958 | `						SySetPut(&aInterfaces,(const void *)&pInterface);` |
|         - | 10959 | `					}` |
|         - | 10960 | `				}` |
|    180035 | 10961 | `				SyBlobRelease(&sResolved);` |
|    180035 | 10962 | `				if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COMMA) == 0 ){` |
|     61318 | 10963 | `					break;` |
|         - | 10964 | `				}` |
|     57409 | 10965 | `				pGen->pIn++;/* Jump the comma */` |
|         5 | 10966 | `			}` |
|     61313 | 10967 | `		}` |
|    155183 | 10968 | `	}` |
|    376845 | 10969 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|         - | 10970 | `		/* Syntax error */` |
...
|         - | 10978 | `	}` |
|    376845 | 10979 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|    376845 | 10980 | `	pEnd = 0; /* cc warning */` |
|         - | 10981 | `	/* Delimit the class body */` |
|    376845 | 10982 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|    376845 | 10983 | `	if( pEnd >= pGen->pEnd ){` |
|         - | 10984 | `		/* Syntax error */` |
...
|    376845 | 10994 | `	pClass->nEndLine = pEnd->nLine;` |
|         - | 10995 | `	/* Swap token stream */` |
|    376845 | 10996 | `	pTmp = pGen->pEnd;` |
|    376845 | 10997 | `	pGen->pEnd = pEnd;` |
|         - | 10998 | `	/* Merge the inherited flags (PH7_NewRawClass may have set INTERNAL) */` |
|    376845 | 10999 | `	pClass->iFlags \|= iFlags;` |
|         - | 11000 | `	/* Start the parse process */` |
|   1499701 | 11001 | `	for(;;){` |
|         - | 11002 | `		/* Jump leading/trailing semi-colons */` |
|   4256649 | 11003 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|    774051 | 11004 | `			pGen->pIn++;` |
|         5 | 11005 | `		}` |
|   3482603 | 11006 | `		if( pGen->pIn >= pGen->pEnd ){` |
|         - | 11007 | `			/* End of class body */` |
|    376803 | 11008 | `			break;` |
|         - | 11009 | `		}` |
|         - | 11010 | `		/* Bind a directly-preceding docblock to this member */` |
|   3105805 | 11011 | `		GenStateSetPendingDoc(&(*pGen));` |
|   3105800 | 11012 | `		if( (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR)) == 0` |
|   1552905 | 11013 | ``			&& !GenStateIsReadonly(pGen->pIn) /* allow a leading `readonly` modifier */ ){`` |
...
|   3105805 | 11024 | `		iProtection = PH7_TKWRD_PUBLIC;` |
|   3105805 | 11025 | `		iAttrflags = 0;` |
...
|   3105805 | 11030 | `		if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|       ! 0 | 11031 | `			int bMod = 0;` |
...
|         - | 11052 | `			}` |
|       ! 0 | 11053 | `		}` |
|   3105805 | 11054 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|         - | 11055 | `			/* Extract the current keyword */` |
|   3105805 | 11056 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   3105805 | 11057 | `			if( nKwrd == PH7_TKWRD_CASE && (pClass->iFlags & PH7_CLASS_ENUM) ){` |
|         - | 11058 | ``				/* Enum case declaration: `case NAME [= value];` */`` |
|      7711 | 11059 | `				rc = GenStateCompileEnumCase(&(*pGen),pClass);` |
|      7711 | 11060 | `				if( rc != SXRET_OK ){` |
...
|      7707 | 11066 | `				continue;` |
|         - | 11067 | `			}` |
|   3098099 | 11068 | `			if( nKwrd == PH7_TKWRD_USE ){` |
|         - | 11069 | `				/* Trait use: use TraitA, TraitB [{ ... }]; */` |
|         - | 11070 | `				TraitUseEntry sUse;` |
|     15389 | 11071 | `				SySetInit(&sUse.aTraits,&pGen->pVm->sAllocator,sizeof(ph7_class *));` |
|     15389 | 11072 | `				sUse.pResolvStart = sUse.pResolvEnd = 0;` |
|     15389 | 11073 | `				pGen->pIn++; /* Jump the 'use' keyword */` |
|      7700 | 11074 | `				for(;;){` |
|         - | 11075 | `					ph7_class *pTrait;` |
|         - | 11076 | `					SyBlob sResolved;` |
|         - | 11077 | `					SyString sTraitName;` |
|     15397 | 11078 | `					sxu32 nUseLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
...
|     15397 | 11085 | `					SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|     15397 | 11086 | `					if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|       ! 0 | 11093 | `						break;` |
|         - | 11094 | `					}` |
|     30789 | 11095 | `					pTrait = PH7_VmExtractClass(pGen->pVm,` |
|     15392 | 11096 | `						(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|     15397 | 11097 | `					SyStringInitFromBuf(&sTraitName,` |
|         - | 11098 | `						(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|         - | 11099 | `					/* Only traits are allowed */` |
|     15397 | 11100 | `					while( pTrait && (pTrait->iFlags & PH7_CLASS_TRAIT) == 0 ){` |
|       ! 0 | 11101 | `						pTrait = pTrait->pNextName;` |
|       ! 0 | 11102 | `					}` |
|     15397 | 11103 | `					if( pTrait == 0 ){` |
...
|         - | 11109 | `						}` |
|       ! 0 | 11110 | `					}else{` |
|     15397 | 11111 | `						SySetPut(&sUse.aTraits,(const void *)&pTrait);` |
|         - | 11112 | `					}` |
|     15397 | 11113 | `					SyBlobRelease(&sResolved);` |
...
|     15397 | 11116 | `					if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COMMA) == 0 ){` |
|      7697 | 11117 | `						break;` |
|         - | 11118 | `					}` |
|        10 | 11119 | `					pGen->pIn++; /* Jump the comma */` |
|         2 | 11120 | `				}` |
|         - | 11121 | `				/* Expect semicolon or opening brace (for conflict resolution) */` |
|     15389 | 11122 | `				if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OCB) ){` |
...
|         - | 11132 | `					}` |
|         5 | 11133 | `				}` |
|     15389 | 11134 | `				SySetPut(&aUseEntries,(const void *)&sUse);` |
|         - | 11135 | `				/* The semicolon will be consumed by the outer loop */` |
|     15389 | 11136 | `				continue;` |
|         - | 11137 | `			}` |
|   3082715 | 11138 | `			if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|         - | 11139 | `				int nSetTok;` |
|   2791437 | 11140 | `				sxi32 nSetVis = GenStatePeekSetVisibility(pGen->pIn,pGen->pEnd,&nSetTok);` |
|   2791437 | 11141 | `				if( nSetVis ){` |
...
|         2 | 11146 | `				}else{` |
|   2791435 | 11147 | `					iProtection = nKwrd;` |
|   2791435 | 11148 | `					pGen->pIn++; /* Jump the visibility token */` |
|         - | 11149 | `					/* Optional asymmetric set-visibility after the read` |
|         - | 11150 | ``					 * visibility: `public private(set) int $x`. */`` |
|   2791435 | 11151 | `					nSetVis = GenStatePeekSetVisibility(pGen->pIn,pGen->pEnd,&nSetTok);` |
|   2791435 | 11152 | `					if( nSetVis ){` |
...
|   2791437 | 11159 | `				if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|        26 | 11160 | `					iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|        26 | 11161 | `					pGen->pIn++; /* Jump the 'readonly' modifier */` |
|        11 | 11162 | `				}` |
|   2791432 | 11163 | `				if( pGen->pIn >= pGen->pEnd` |
|   2791437 | 11164 | `					\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|       ! 0 | 11172 | `					goto done;` |
|         - | 11173 | `				}` |
|   2791437 | 11174 | `				if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|         - | 11175 | `					/* Attribute declaration (untyped) */` |
|    432971 | 11176 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|    432971 | 11177 | `					if( rc != SXRET_OK ){` |
|        11 | 11178 | `						if( rc == SXERR_ABORT ){` |
|       ! 0 | 11179 | `							return SXERR_ABORT;` |
|         - | 11180 | `						}` |
|        11 | 11181 | `						goto done;` |
|         - | 11182 | `					}` |
|    433116 | 11183 | `					continue;` |
|         - | 11184 | `				}` |
|   2358471 | 11185 | `				if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|   2358159 | 11197 | `				nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   1179077 | 11198 | `			}` |
|   2649437 | 11199 | `			if( nKwrd == PH7_TKWRD_CONST ){` |
|         - | 11200 | `				/* Process constant declaration */` |
|    283289 | 11201 | `				rc = GenStateCompileClassConstant(&(*pGen),iProtection,iAttrflags,pClass);` |
|    283289 | 11202 | `				if( rc != SXRET_OK ){` |
...
|         - | 11207 | `				}` |
|    141643 | 11208 | `			}else{` |
|   2366153 | 11209 | `				if( nKwrd == PH7_TKWRD_STATIC ){` |
|         - | 11210 | `					/* Static method or attribute,record that */` |
|     95837 | 11211 | `					iAttrflags \|= PH7_CLASS_ATTR_STATIC;` |
|     95837 | 11212 | `					pGen->pIn++; /* Jump the static keyword */` |
|     95837 | 11213 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|         - | 11214 | `						int nSetTok;` |
|     69017 | 11215 | `						sxi32 nSetVis = GenStatePeekSetVisibility(pGen->pIn,pGen->pEnd,&nSetTok);` |
|     69017 | 11216 | `						if( nSetVis ){` |
...
|     69015 | 11222 | `							nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|     69015 | 11223 | `							if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
...
|     95837 | 11237 | `					if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|       ! 0 | 11238 | `						iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|       ! 0 | 11239 | `						pGen->pIn++; /* Jump the 'readonly' modifier */` |
|       ! 0 | 11240 | `					}` |
|     95832 | 11241 | `					if( pGen->pIn >= pGen->pEnd` |
|     95837 | 11242 | `						\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|       ! 0 | 11250 | `						goto done;` |
|         - | 11251 | `					}` |
|     95837 | 11252 | `					if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|         - | 11253 | `						/* Attribute declaration */` |
|     26821 | 11254 | `						rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|     26821 | 11255 | `						if( rc != SXRET_OK ){` |
|         3 | 11256 | `							if( rc == SXERR_ABORT ){` |
|       ! 0 | 11257 | `								return SXERR_ABORT;` |
|         - | 11258 | `							}` |
|         3 | 11259 | `							goto done;` |
|         - | 11260 | `						}` |
|     26819 | 11261 | `						continue;` |
|         - | 11262 | `					}` |
|     69021 | 11263 | `					if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|     69005 | 11275 | `					nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   2304821 | 11276 | `				}else if( nKwrd == PH7_TKWRD_ABSTRACT ){` |
|         - | 11277 | `					/* Abstract method,record that */` |
|      7679 | 11278 | `					iAttrflags \|= PH7_CLASS_ATTR_ABSTRACT;` |
|         - | 11279 | `					/* Mark the whole class as abstract */` |
|      7679 | 11280 | `					pClass->iFlags \|= PH7_CLASS_ABSTRACT;` |
|         - | 11281 | `					/* Advance the stream cursor */` |
|      7679 | 11282 | `					pGen->pIn++;` |
|      7679 | 11283 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|      7679 | 11284 | `						nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|      7679 | 11285 | `						if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|      7677 | 11286 | `							iProtection = nKwrd;` |
|      7677 | 11287 | `							pGen->pIn++; /* Jump the visibility token */` |
|      3836 | 11288 | `						}` |
|      3837 | 11289 | `					}` |
|      7679 | 11290 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|      7674 | 11291 | `						SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_STATIC ){` |
|         - | 11292 | `							/* Static method */` |
|       ! 0 | 11293 | `							iAttrflags \|= PH7_CLASS_ATTR_STATIC;` |
|       ! 0 | 11294 | `							pGen->pIn++; /* Jump the static keyword */` |
|       ! 0 | 11295 | `					}` |
|      7679 | 11296 | `					if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 \|\|` |
|      7674 | 11297 | `						SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_FUNCTION ){` |
...
|       ! 0 | 11322 | `							goto done;` |
|         - | 11323 | `					}` |
|      7673 | 11324 | `					nKwrd = PH7_TKWRD_FUNCTION;` |
|   2266481 | 11325 | `				}else if( nKwrd == PH7_TKWRD_FINAL ){` |
...
|         3 | 11369 | `				}` |
|   2339303 | 11370 | `				if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_VAR ){` |
...
|       ! 0 | 11378 | `						goto done;` |
|         - | 11379 | `				}` |
|   2339303 | 11380 | `				if( nKwrd == PH7_TKWRD_VAR ){` |
...
|   2339297 | 11395 | `					rc = GenStateCompileClassMethod(&(*pGen),iProtection,iAttrflags,TRUE,pClass);` |
|         - | 11396 | `				}` |
|   2339303 | 11397 | `				if( rc != SXRET_OK ){` |
...
|         - | 11420 | `		sxu32 nU;` |
|    376803 | 11421 | `		apUse = (TraitUseEntry *)SySetBasePtr(&aUseEntries);` |
|    392187 | 11422 | `		for( nU = 0 ; nU < SySetUsed(&aUseEntries) ; nU++ ){` |
|     15389 | 11423 | `			TraitUseEntry *pUse = &apUse[nU];` |
|     15389 | 11424 | `			ph7_class **apTrait = (ph7_class **)SySetBasePtr(&pUse->aTraits);` |
|     15389 | 11425 | `			sxu32 nTraits = SySetUsed(&pUse->aTraits);` |
|     15389 | 11426 | `			int hasResolution = (pUse->pResolvStart && pUse->pResolvStart < pUse->pResolvEnd) ? 1 : 0;` |
|         - | 11427 | `			sxu32 nT;` |
|     15389 | 11428 | `			if( !hasResolution ){` |
|         - | 11429 | `				/* No conflict resolution block: use standard trait application */` |
|     30759 | 11430 | `				for( nT = 0 ; nT < nTraits ; nT++ ){` |
|     15385 | 11431 | `					rc = PH7_ClassUseTrait(&(*pGen),pClass,apTrait[nT]);` |
|     15385 | 11432 | `					if( rc != SXRET_OK ){` |
|       ! 0 | 11433 | `						break;` |
|         - | 11434 | `					}` |
|      7695 | 11435 | `				}` |
|      7692 | 11436 | `			}else{` |
...
|         3 | 11624 | `				}` |
|         - | 11625 | `			}` |
|     15389 | 11626 | `			SySetRelease(&pUse->aTraits);` |
|      7697 | 11627 | `		}` |
|         - | 11628 | `	}` |
|    376803 | 11629 | `	if( pClass->iFlags & PH7_CLASS_ENUM ){` |
...
|      3859 | 11632 | `		rc = GenStateEnumFinalize(&(*pGen),pClass,nLine);` |
|      3859 | 11633 | `		if( rc == SXERR_ABORT ){` |
...
|    376803 | 11640 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|    376803 | 11641 | `	if( rc == SXRET_OK ){` |
|         - | 11642 | `		ph7_class **apInterface;` |
|         - | 11643 | `		sxu32 n;` |
|    376803 | 11644 | `		if( pBase ){` |
|         - | 11645 | `			/* Inherit from base class and mark as a subclass */` |
|    203061 | 11646 | `			rc = PH7_ClassInherit(&(*pGen),pClass,pBase);` |
|    101528 | 11647 | `		}` |
|    376803 | 11648 | `		apInterface = (ph7_class **)SySetBasePtr(&aInterfaces);` |
|    556827 | 11649 | `		for( n = 0 ; n < SySetUsed(&aInterfaces) ; n++ ){` |
|         - | 11650 | `			/* Implements one or more interface */` |
|    180029 | 11651 | `			rc = PH7_ClassImplement(pClass,apInterface[n]);` |
|    180029 | 11652 | `			if( rc != SXRET_OK ){` |
|       ! 0 | 11653 | `				break;` |
|         - | 11654 | `			}` |
|     90017 | 11655 | `		}` |
...
|    376803 | 11658 | `		if( rc == SXRET_OK && (pClass->iFlags & PH7_CLASS_ENUM) ){` |
|      3859 | 11659 | `			ph7_class *pIntf = PH7_VmExtractClass(pGen->pVm,"UnitEnum",sizeof("UnitEnum")-1,FALSE,0);` |
|      3859 | 11660 | `			while( pIntf && (pIntf->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|       ! 0 | 11661 | `				pIntf = pIntf->pNextName;` |
|       ! 0 | 11662 | `			}` |
|      3859 | 11663 | `			if( pIntf ){` |
|      3859 | 11664 | `				PH7_ClassImplement(pClass,pIntf);` |
|      1927 | 11665 | `			}` |
|      3859 | 11666 | `			if( pClass->nEnumBacking != 0 ){` |
|      3845 | 11667 | `				pIntf = PH7_VmExtractClass(pGen->pVm,"BackedEnum",sizeof("BackedEnum")-1,FALSE,0);` |
|      3845 | 11668 | `				while( pIntf && (pIntf->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|       ! 0 | 11669 | `					pIntf = pIntf->pNextName;` |
|       ! 0 | 11670 | `				}` |
|      3845 | 11671 | `				if( pIntf ){` |
|      3845 | 11672 | `					PH7_ClassImplement(pClass,pIntf);` |
|      1920 | 11673 | `				}` |
|      1920 | 11674 | `			}` |
|      1927 | 11675 | `		}` |
...
|    376798 | 11678 | `		if( rc == SXRET_OK` |
|    376798 | 11679 | `		 && (pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT)) == 0` |
|    376803 | 11680 | `		 && SyHashGet(&pClass->hMethod,"__toString",sizeof("__toString")-1) != 0 ){` |
|    206715 | 11681 | `			ph7_class *pStringable = PH7_VmExtractClass(pGen->pVm,` |
|         - | 11682 | `				"Stringable",sizeof("Stringable")-1,FALSE,0);` |
|    206715 | 11683 | `			if( pStringable ){` |
|    206715 | 11684 | `				ph7_class **apImpl = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|    206715 | 11685 | `				sxu32 nImpl = SySetUsed(&pClass->aInterface);` |
|         - | 11686 | `				sxu32 i;` |
|    206715 | 11687 | `				int bAlready = 0;` |
|    252631 | 11688 | `				for( i = 0 ; i < nImpl ; i++ ){` |
|     53575 | 11689 | `					if( apImpl[i] == pStringable ){` |
|      7659 | 11690 | `						bAlready = 1;` |
|      7659 | 11691 | `						break;` |
|         - | 11692 | `					}` |
|     22963 | 11693 | `				}` |
|    206715 | 11694 | `				if( !bAlready ){` |
|    199061 | 11695 | `					PH7_ClassImplement(pClass,pStringable);` |
|     99528 | 11696 | `				}` |
|    103355 | 11697 | `			}` |
|    103355 | 11698 | `		}` |
|         - | 11699 | `		/* Validate interface method signatures (visibility and parameter count) */` |
|    376803 | 11700 | `		if( rc == SXRET_OK ){` |
|    376803 | 11701 | `			sxi32 rcCheck = GenStateCheckInterfaceSignatures(&(*pGen),pClass);` |
|    376803 | 11702 | `			if( rcCheck == SXERR_ABORT ){` |
...
|    376803 | 11709 | `		if( rc == SXRET_OK ){` |
|    376803 | 11710 | `			sxi32 rcCheck = GenStateCheckAbstractMethods(&(*pGen),pClass);` |
|    376803 | 11711 | `			if( rcCheck == SXERR_ABORT ){` |
...
|    188399 | 11716 | `		}` |
|    188399 | 11717 | `	}` |
|    376803 | 11718 | `	SySetRelease(&aUseEntries);` |
|    376803 | 11719 | `	SySetRelease(&aInterfaces);` |
|    376803 | 11720 | `	if( rc != SXRET_OK ){` |
...
|    376845 | 11726 | `	pGen->pIn = &pEnd[1];` |
|    376845 | 11727 | `	pGen->pEnd = pTmp;` |
|    376845 | 11728 | `	return PH7_OK;` |
|    188426 | 11729 | `}` |
|         - | 11730 | `/* Compile a named class declaration (the common case). */` |
|    376814 | 11731 | `static sxi32 GenStateCompileClass(ph7_gen_state *pGen,sxi32 iFlags)` |
|         5 | 11732 | `{` |
|    376819 | 11733 | `	return GenStateCompileClassEx(pGen,iFlags,0,0,0);` |
|         5 | 11734 | `}` |
|         - | 11735 | `/*` |
...
|         - | 11834 | ` */` |
|  13286728 | 11835 | `static int GenStateTokenIsClassModifier(SyToken *pTok,sxi32 *piFlag)` |
|         5 | 11836 | `{` |
|  13286733 | 11837 | `	if( pTok->nType & PH7_TK_KEYWORD ){` |
|   7792951 | 11838 | `		sxu32 nKw = (sxu32)SX_PTR_TO_INT(pTok->pUserData);` |
|   7792951 | 11839 | `		if( nKw == PH7_TKWRD_FINAL ){ *piFlag = PH7_CLASS_FINAL; return TRUE; }` |
|   7747001 | 11840 | `		if( nKw == PH7_TKWRD_ABSTRACT ){ *piFlag = PH7_CLASS_ABSTRACT; return TRUE; }` |
|   3854315 | 11841 | `	}` |
|  13202417 | 11842 | `	if( GenStateIsReadonly(pTok) ){ *piFlag = PH7_CLASS_READONLY; return TRUE; }` |
|  13202357 | 11843 | `	return FALSE;` |
|   6643369 | 11844 | `}` |
|         - | 11845 | `/*` |
...
|         - | 11850 | ` */` |
|  13202352 | 11851 | `static sxi32 GenStateScanClassModifiers(SyToken **ppIn,SyToken *pEnd,SyToken **ppDup)` |
|         5 | 11852 | `{` |
|  13202357 | 11853 | `	SyToken *pIn = *ppIn,*pDup = 0;` |
|  13202357 | 11854 | `	sxi32 iFlags = 0,iFlag;` |
|  13286733 | 11855 | `	while( pIn < pEnd && GenStateTokenIsClassModifier(pIn,&iFlag) ){` |
|     84381 | 11856 | `		if( (iFlags & iFlag) && pDup == 0 ){` |
|         5 | 11857 | `			pDup = pIn;` |
|         2 | 11858 | `		}` |
|     84381 | 11859 | `		iFlags \|= iFlag;` |
|     84381 | 11860 | `		pIn++;` |
|         5 | 11861 | `	}` |
|  13202357 | 11862 | `	*ppIn = pIn;` |
|  13202357 | 11863 | `	if( ppDup ){ *ppDup = pDup; }` |
|  13202357 | 11864 | `	return iFlags;` |
|         5 | 11865 | `}` |
|         - | 11866 | `/*` |
...
|         - | 11872 | ` */` |
|  13164000 | 11873 | `static int GenStateStartsModifiedClass(SyToken *pIn,SyToken *pEnd)` |
|         5 | 11874 | `{` |
|  13164005 | 11875 | `	sxi32 iFlags = GenStateScanClassModifiers(&pIn,pEnd,0);` |
|   6628011 | 11876 | `	return iFlags != 0 && pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD)` |
|  13187004 | 11877 | `		&& (sxu32)SX_PTR_TO_INT(pIn->pUserData) == PH7_TKWRD_CLASS;` |
|         5 | 11878 | `}` |
|         - | 11879 | `/*` |
...
|         - | 11885 | ` */` |
|     38352 | 11886 | `static sxi32 PH7_CompileClassModifiers(ph7_gen_state *pGen)` |
|         5 | 11887 | `{` |
|         - | 11888 | `	SyToken *pDup;` |
|     38357 | 11889 | `	sxi32 iFlags = GenStateScanClassModifiers(&pGen->pIn,pGen->pEnd,&pDup);` |
|         - | 11890 | `	sxi32 rc;` |
|     38357 | 11891 | `	if( pDup ){` |
...
|         - | 11896 | `		}` |
|         1 | 11897 | `	}` |
|     38352 | 11898 | `	if( (iFlags & (PH7_CLASS_FINAL\|PH7_CLASS_ABSTRACT))` |
|     19181 | 11899 | `		== (PH7_CLASS_FINAL\|PH7_CLASS_ABSTRACT) ){` |
...
|         - | 11904 | `		}` |
|         1 | 11905 | `	}` |
|     38357 | 11906 | `	return GenStateCompileClass(&(*pGen),iFlags);` |
|     19181 | 11907 | `}` |
|         - | 11908 | `/*` |
...
|         - | 11913 | ` */` |
|      7740 | 11914 | `static sxi32 PH7_CompileTrait(ph7_gen_state *pGen)` |
|         5 | 11915 | `{` |
|      7745 | 11916 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|      7745 | 11925 | `	pGen->pIn++;` |
|      7745 | 11926 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
...
|      7745 | 11937 | `	pName = &pGen->pIn->sData;` |
|      7745 | 11938 | `	pGen->pIn++;` |
|         - | 11939 | `	/* Build FQN and obtain a raw class */ {` |
|         - | 11940 | `		SyBlob sFQN;` |
|         - | 11941 | `		SyString sFQNStr;` |
|      7745 | 11942 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|      7745 | 11943 | `		GenStateBuildFQN(pGen,pName,&sFQN);` |
|      7745 | 11944 | `		SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|      7745 | 11945 | `		pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|      7745 | 11946 | `		SyBlobRelease(&sFQN);` |
|         - | 11947 | `	}` |
|      7745 | 11948 | `	if( pClass == 0 ){` |
|       ! 0 | 11949 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|       ! 0 | 11950 | `		return SXERR_ABORT;` |
|         - | 11951 | `	}` |
|      7745 | 11952 | `	GenStateConsumeDoc(&(*pGen),&pClass->sDoc);` |
|      7745 | 11953 | `	if( GenStateConsumeAttrs(&(*pGen),&pClass->aAttrs) == SXERR_ABORT ){` |
|       ! 0 | 11954 | `		return SXERR_ABORT;` |
|         - | 11955 | `	}` |
|         - | 11956 | `	/* Traits cannot extend or implement; expect opening brace directly */` |
|      7745 | 11957 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_OCB) == 0 ){` |
...
|         - | 11964 | `	}` |
|      7745 | 11965 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|      7745 | 11966 | `	pEnd = 0;` |
|      7745 | 11967 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB,PH7_TK_CCB,&pEnd);` |
|      7745 | 11968 | `	if( pEnd >= pGen->pEnd ){` |
...
|      7745 | 11977 | `	pClass->nEndLine = pEnd->nLine;` |
|         - | 11978 | `	/* Swap token stream */` |
|      7745 | 11979 | `	pTmp = pGen->pEnd;` |
|      7745 | 11980 | `	pGen->pEnd = pEnd;` |
|         - | 11981 | `	/* Mark as trait (PH7_NewRawClass may have set INTERNAL) */` |
|      7745 | 11982 | `	pClass->iFlags \|= PH7_CLASS_TRAIT;` |
|         - | 11983 | `	/* Parse the body: same as a normal class (methods, attributes, visibility modifiers) */` |
|     55567 | 11984 | `	for(;;){` |
|    157105 | 11985 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|     22991 | 11986 | `			pGen->pIn++;` |
|         5 | 11987 | `		}` |
|    134119 | 11988 | `		if( pGen->pIn >= pGen->pEnd ){` |
|      7745 | 11989 | `			break;` |
|         - | 11990 | `		}` |
|         - | 11991 | `		/* Bind a directly-preceding docblock to this member */` |
|    126379 | 11992 | `		GenStateSetPendingDoc(&(*pGen));` |
|    126379 | 11993 | `		if( (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR)) == 0 ){` |
...
|       ! 0 | 12000 | `			goto done;` |
|         - | 12001 | `		}` |
|    126379 | 12002 | `		iProtection = PH7_TKWRD_PUBLIC;` |
|    126379 | 12003 | `		iAttrflags = 0;` |
|    126379 | 12004 | `		if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|    126379 | 12005 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    126379 | 12006 | `			if( nKwrd == PH7_TKWRD_USE ){` |
...
|         5 | 12047 | `				continue;` |
|         - | 12048 | `			}` |
|    126375 | 12049 | `			if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|    126357 | 12050 | `				iProtection = nKwrd;` |
|    126357 | 12051 | `				pGen->pIn++;` |
...
|    126357 | 12055 | `				if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|         3 | 12056 | `					iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|         3 | 12057 | `					pGen->pIn++; /* Jump the 'readonly' modifier */` |
|         1 | 12058 | `				}` |
|    126352 | 12059 | `				if( pGen->pIn >= pGen->pEnd` |
|    126357 | 12060 | `					\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|       ! 0 | 12067 | `					goto done;` |
|         - | 12068 | `				}` |
|    126357 | 12069 | `				if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|     22973 | 12070 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|     22973 | 12071 | `					if( rc != SXRET_OK ){` |
|       ! 0 | 12072 | `						if( rc == SXERR_ABORT ){` |
|       ! 0 | 12073 | `							return SXERR_ABORT;` |
|         - | 12074 | `						}` |
|       ! 0 | 12075 | `						goto done;` |
|         - | 12076 | `					}` |
|     22973 | 12077 | `					continue;` |
|         - | 12078 | `				}` |
|    103389 | 12079 | `				if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|         7 | 12087 | `					continue;` |
|         - | 12088 | `				}` |
|    103383 | 12089 | `				nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|     51689 | 12090 | `			}` |
|    103401 | 12091 | `			if( nKwrd == PH7_TKWRD_CONST ){` |
...
|       ! 0 | 12097 | `				goto done;` |
|       ! 0 | 12098 | `			}else{` |
|    103401 | 12099 | `				if( nKwrd == PH7_TKWRD_STATIC ){` |
|      7667 | 12100 | `					iAttrflags \|= PH7_CLASS_ATTR_STATIC;` |
|      7667 | 12101 | `					pGen->pIn++;` |
|      7667 | 12102 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|      7665 | 12103 | `						nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|      7665 | 12104 | `						if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|       ! 0 | 12105 | `							iProtection = nKwrd;` |
|       ! 0 | 12106 | `							pGen->pIn++;` |
|       ! 0 | 12107 | `						}` |
|      3830 | 12108 | `					}` |
|      7662 | 12109 | `					if( pGen->pIn >= pGen->pEnd` |
|      7667 | 12110 | `						\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|       ! 0 | 12117 | `						goto done;` |
|         - | 12118 | `					}` |
|      7667 | 12119 | `					if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
...
|         3 | 12127 | `						continue;` |
|         - | 12128 | `					}` |
|      7665 | 12129 | `					if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|       ! 0 | 12137 | `						continue;` |
|         - | 12138 | `					}` |
|      7665 | 12139 | `					nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|     99569 | 12140 | `				}else if( nKwrd == PH7_TKWRD_ABSTRACT ){` |
...
|         3 | 12161 | `				}` |
|    103399 | 12162 | `				if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_VAR ){` |
...
|       ! 0 | 12169 | `					goto done;` |
|         - | 12170 | `				}` |
|    103399 | 12171 | `				if( nKwrd == PH7_TKWRD_VAR ){` |
|       ! 0 | 12172 | `					pGen->pIn++;` |
...
|       ! 0 | 12182 | `				}else{` |
|    103399 | 12183 | `					rc = GenStateCompileClassMethod(&(*pGen),iProtection,iAttrflags,TRUE,pClass);` |
|         - | 12184 | `				}` |
|    103399 | 12185 | `				if( rc != SXRET_OK ){` |
...
|      7745 | 12203 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|      7745 | 12204 | `	if( rc != SXRET_OK ){` |
...
|      7745 | 12210 | `	pGen->pIn = &pEnd[1];` |
|      7745 | 12211 | `	pGen->pEnd = pTmp;` |
|      7745 | 12212 | `	return PH7_OK;` |
|      3875 | 12213 | `}` |
|         - | 12214 | `/*` |
...
|         - | 12222 | ` */` |
|    334604 | 12223 | `static sxi32 PH7_CompileClass(ph7_gen_state *pGen)` |
|         5 | 12224 | `{` |
|         - | 12225 | `	sxi32 rc;` |
|    334609 | 12226 | `	rc = GenStateCompileClass(&(*pGen),0);` |
|    334609 | 12227 | `	return rc;` |
|         5 | 12228 | `}` |
|         - | 12229 | `/*` |
...
|         - | 12235 | ` */` |
|  13117996 | 12236 | `static int GenStateStartsEnumDecl(SyToken *pIn,SyToken *pEnd)` |
|         5 | 12237 | `{` |
|  13325300 | 12238 | `	return (pIn->nType & PH7_TK_ID)` |
|   6766297 | 12239 | `		&& pIn->sData.nByte == sizeof("enum")-1` |
|    217002 | 12240 | `		&& SyStrnicmp(pIn->sData.zString,"enum",sizeof("enum")-1) == 0` |
|  13325295 | 12241 | `		&& &pIn[1] < pEnd && (pIn[1].nType & PH7_TK_ID);` |
|         5 | 12242 | `}` |
|         - | 12243 | `/*` |
...
|         - | 12248 | ` */` |
|      3858 | 12249 | `static sxi32 PH7_CompileEnum(ph7_gen_state *pGen)` |
|         5 | 12250 | `{` |
|      3863 | 12251 | `	return GenStateCompileClass(&(*pGen),PH7_CLASS_ENUM\|PH7_CLASS_FINAL);` |
|         5 | 12252 | `}` |
|         - | 12253 | `/*` |
...
|         - | 12274 | ` */` |
|    509282 | 12275 | `static sxi32 GenStateThrowNodeValidator(ph7_gen_state *pGen,ph7_expr_node *pRoot)` |
|         5 | 12276 | `{` |
|    509287 | 12277 | `	sxi32 rc = SXRET_OK;` |
|    509287 | 12278 | `	if( pRoot->pOp ){` |
|    509275 | 12279 | `		switch( pRoot->pOp->iOp ){` |
|    254635 | 12280 | `		case EXPR_OP_NEW:            /* new Exception() */` |
...
|       ! 0 | 12296 | `			break;` |
|         - | 12297 | `		}` |
|    254652 | 12298 | `	}else if( pRoot->xCode != PH7_CompileVariable ){` |
...
|         - | 12312 | ` */` |
|    509246 | 12313 | `static sxi32 PH7_CompileThrow(ph7_gen_state *pGen)` |
|         5 | 12314 | `{` |
|    509251 | 12315 | `	sxu32 nLine = pGen->pIn->nLine;` |
|         - | 12316 | `	GenBlock *pBlock;` |
|         - | 12317 | `	sxu32 nIdx;` |
|         - | 12318 | `	sxi32 rc;` |
|    509251 | 12319 | `	pGen->pIn++; /* Jump the 'throw' keyword */` |
|         - | 12320 | `	/* Compile the expression */` |
|    509251 | 12321 | `	rc = PH7_CompileExpr(&(*pGen),0,GenStateThrowNodeValidator);` |
|    509251 | 12322 | `	if( rc == SXERR_EMPTY ){` |
...
|         - | 12328 | `	}` |
|    509251 | 12329 | `	pBlock = pGen->pCurrent;` |
|         - | 12330 | `	/* Point to the top most function or try block and emit the forward jump */` |
|   2028581 | 12331 | `	while(pBlock->pParent){` |
|   2028577 | 12332 | `		if( pBlock->iFlags & (GEN_BLOCK_EXCEPTION\|GEN_BLOCK_FUNC) ){` |
|    509247 | 12333 | `			break;` |
|         - | 12334 | `		}` |
|         - | 12335 | `		/* Point to the parent block */` |
|   1519335 | 12336 | `		pBlock = pBlock->pParent;` |
|         5 | 12337 | `	}` |
|         - | 12338 | `	/* Emit the throw instruction */` |
|    509251 | 12339 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_THROW,0,0,0,&nIdx);` |
|         - | 12340 | `	/* Emit the jump */` |
|    509251 | 12341 | `	GenStateNewJumpFixup(pBlock,PH7_OP_THROW,nIdx);` |
|    509251 | 12342 | `	return SXRET_OK;` |
|    254628 | 12343 | `}` |
|         - | 12344 | `/*` |
...
|         - | 12588 | ` */` |
|     24500 | 12589 | `static sxi32 PH7_CompileCatch(ph7_gen_state *pGen,ph7_exception *pException)` |
|         5 | 12590 | `{` |
|     24505 | 12591 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|         - | 12598 | `	char *zDup;` |
|         - | 12599 | `	sxi32 rc;` |
|     24505 | 12600 | `	pGen->pIn++; /* Jump the 'catch' keyword */` |
|         - | 12601 | `	/* Zero the structure */` |
|     24505 | 12602 | `	SyZero(&sCatch,sizeof(ph7_exception_block));` |
|         - | 12603 | `	/* Initialize fields */` |
|     24505 | 12604 | `	SySetInit(&sCatch.aClasses,&pException->pVm->sAllocator,sizeof(SyString));` |
|     24505 | 12605 | `	SySetInit(&sCatch.sByteCode,&pException->pVm->sAllocator,sizeof(VmInstr));` |
|     24505 | 12606 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 /*(*/ ){` |
...
|     24505 | 12621 | `	pGen->pIn++; /* Jump the left parenthesis '(' */` |
|     12265 | 12622 | `	for(;;){` |
|         - | 12623 | `		SyBlob sResolved;` |
|     24535 | 12624 | `		SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|     24535 | 12625 | `		if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|     36794 | 12641 | `		zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|     24526 | 12642 | `			(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|     24531 | 12643 | `		SyStringInitFromBuf(&sClassName,zDup,SyBlobLength(&sResolved));` |
|     24531 | 12644 | `		SyBlobRelease(&sResolved);` |
|     24531 | 12645 | `		if( zDup == 0 ){` |
|       ! 0 | 12646 | `			goto Mem;` |
|         - | 12647 | `		}` |
|     24531 | 12648 | `		rc = SySetPut(&sCatch.aClasses,(const void *)&sClassName);` |
|     24531 | 12649 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 12650 | `			goto Mem;` |
|         - | 12651 | `		}` |
|         - | 12652 | `		/* Check for '\|' (multi-catch separator) */` |
|     24526 | 12653 | `		if( pGen->pIn < pGen->pEnd &&` |
|     24526 | 12654 | `			(pGen->pIn->nType & PH7_TK_OP) &&` |
...
|     24501 | 12665 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_RPAREN) /*)*/ ){` |
|         5 | 12666 | `		goto CatchBody;` |
|         - | 12667 | `	}` |
|     24492 | 12668 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 /*$*/ \|\|` |
|     24497 | 12669 | `		&pGen->pIn[1] >= pGen->pEnd \|\| (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|         - | 12682 | `	}` |
|     24497 | 12683 | `	pGen->pIn++; /* Jump the dollar sign */` |
|         - | 12684 | `	/* Duplicate instance name */` |
|     24497 | 12685 | `	pName = &pGen->pIn->sData;` |
|     24497 | 12686 | `	zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|     24497 | 12687 | `	if( zDup == 0 ){` |
|       ! 0 | 12688 | `		goto Mem;` |
|         - | 12689 | `	}` |
|     24497 | 12690 | `	SyStringInitFromBuf(&sCatch.sThis,zDup,pName->nByte);` |
|     24497 | 12691 | `	pGen->pIn++;` |
|     12248 | 12692 | `CatchBody:` |
|     24501 | 12693 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_RPAREN) == 0 /*)*/ ){` |
...
|     24501 | 12708 | `	pGen->pIn++; /* Jump the right parenthesis */` |
|         - | 12709 | `	/* Create the catch block */` |
|     24501 | 12710 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_EXCEPTION,PH7_VmInstrLength(pGen->pVm),0,&pCatch);` |
|     24501 | 12711 | `	if( rc != SXRET_OK ){` |
|       ! 0 | 12712 | `		return SXERR_ABORT;` |
|         - | 12713 | `	}` |
|         - | 12714 | `	/* Swap bytecode container */` |
|     24501 | 12715 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|     24501 | 12716 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&sCatch.sByteCode);` |
|         - | 12717 | `	/* Compile the block */` |
|     24501 | 12718 | `	PH7_CompileBlock(&(*pGen),0);` |
|         - | 12719 | `	/* Fix forward jumps now the destination is resolved  */` |
|     24501 | 12720 | `	GenStateFixJumps(pCatch,-1,PH7_VmInstrLength(pGen->pVm));` |
|         - | 12721 | `	/* Emit the DONE instruction */` |
|     24501 | 12722 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|         - | 12723 | `	/* Leave the block */` |
|     24501 | 12724 | `	GenStateLeaveBlock(&(*pGen),0);` |
|         - | 12725 | `	/* Restore the default container */` |
|     24501 | 12726 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|         - | 12727 | `	/* Install the catch block */` |
|     24501 | 12728 | `	rc = SySetPut(&pException->sEntry,(const void *)&sCatch);` |
|     24501 | 12729 | `	if( rc != SXRET_OK ){` |
|       ! 0 | 12730 | `		goto Mem;` |
|         - | 12731 | `	}` |
|     24501 | 12732 | `	return SXRET_OK;` |
|       ! 0 | 12733 | `Mem:` |
...
|         - | 12742 | ` * is "thrown".` |
|         - | 12743 | ` */` |
|     24658 | 12744 | `static sxi32 PH7_CompileTry(ph7_gen_state *pGen)` |
|         5 | 12745 | `{` |
|         - | 12746 | `	ph7_exception *pException;` |
|     24663 | 12747 | `	sxu32 nLine = pGen->pIn->nLine;` |
|         - | 12748 | `	GenBlock *pTry;` |
|         - | 12749 | `	sxu32 nJmpIdx;` |
|         - | 12750 | `	sxi32 rc;` |
|         - | 12751 | `	/* Create the exception container */` |
|     24663 | 12752 | `	pException = (ph7_exception *)SyMemBackendAlloc(&pGen->pVm->sAllocator,sizeof(ph7_exception));` |
|     24663 | 12753 | `	if( pException == 0 ){` |
...
|     24663 | 12759 | `	SyZero(pException,sizeof(ph7_exception));` |
|         - | 12760 | `	/* Initialize fields */` |
|     24663 | 12761 | `	SySetInit(&pException->sEntry,&pGen->pVm->sAllocator,sizeof(ph7_exception_block));` |
|     24663 | 12762 | `	SySetInit(&pException->sFinally,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|     24663 | 12763 | `	pException->iHasFinally = 0;` |
|     24663 | 12764 | `	pException->iFinallyDone = 0;` |
|     24663 | 12765 | `	pException->pVm = pGen->pVm;` |
...
|     24663 | 12772 | `	if( pGen->bInGenerator && pGen->pVm->bInlineTryCatch ){` |
|       105 | 12773 | `		return PH7_CompileTryInline(&(*pGen),pException);` |
|         - | 12774 | `	}` |
|         - | 12775 | `	/* Create the try block */` |
|     24563 | 12776 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_EXCEPTION,PH7_VmInstrLength(pGen->pVm),0,&pTry);` |
|     24563 | 12777 | `	if( rc != SXRET_OK ){` |
|       ! 0 | 12778 | `		return SXERR_ABORT;` |
|         - | 12779 | `	}` |
|         - | 12780 | `	/* Store exception pointer so break/continue can emit POP_EXCEPTION */` |
|     24563 | 12781 | `	pTry->pUserData = pException;` |
|         - | 12782 | `	/* Emit the 'LOAD_EXCEPTION' instruction */` |
|     24563 | 12783 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_EXCEPTION,0,0,pException,&nJmpIdx);` |
|         - | 12784 | `	/* Fix the jump later when the destination is resolved */` |
|     24563 | 12785 | `	GenStateNewJumpFixup(pTry,PH7_OP_LOAD_EXCEPTION,nJmpIdx);` |
|     24563 | 12786 | `	pGen->pIn++; /* Jump the 'try' keyword */` |
|         - | 12787 | `	/* Compile the block */` |
|     24563 | 12788 | `	rc = PH7_CompileBlock(&(*pGen),0);` |
|     24563 | 12789 | `	if( rc == SXERR_ABORT ){` |
|       ! 0 | 12790 | `		return SXERR_ABORT;` |
|         - | 12791 | `	}` |
|         - | 12792 | `	/* Fix forward jumps now the destination is resolved */` |
|     24563 | 12793 | `	GenStateFixJumps(pTry,-1,PH7_VmInstrLength(pGen->pVm));` |
|         - | 12794 | `	/* Emit the 'POP_EXCEPTION' instruction */` |
|     24563 | 12795 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP_EXCEPTION,0,0,pException,0);` |
|         - | 12796 | `	/* Leave the block */` |
|     24563 | 12797 | `	GenStateLeaveBlock(&(*pGen),0);` |
|         - | 12798 | `	/* Compile catch block(s) — at least one catch or finally is required */` |
|     24563 | 12799 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|     24556 | 12800 | `		SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_CATCH ){` |
|         - | 12801 | `		/* Compile one or more catch blocks */` |
|     24496 | 12802 | `		for(;;){` |
|     48992 | 12803 | `			if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0` |
|     36801 | 12804 | `				\|\| SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_CATCH ){` |
|     12251 | 12805 | `					break;` |
|         - | 12806 | `			}` |
|     24505 | 12807 | `			rc = PH7_CompileCatch(&(*pGen),pException);` |
|     24505 | 12808 | `			if( rc == SXERR_ABORT ){` |
|       ! 0 | 12809 | `				return SXERR_ABORT;` |
|         - | 12810 | `			}` |
|         5 | 12811 | `		}` |
|     12246 | 12812 | `	}` |
|         - | 12813 | `	/* Compile optional finally block */` |
|     24563 | 12814 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
...
|     24563 | 12844 | `	if( SySetUsed(&pException->sEntry) == 0 && !pException->iHasFinally ){` |
...
|         - | 12849 | `		}` |
|         3 | 12850 | `	}` |
|     24563 | 12851 | `	return SXRET_OK;` |
|     12334 | 12852 | `}` |
|         - | 12853 | `/*` |
|         - | 12854 | ` * Compile a switch block.` |
|         - | 12855 | ` *  (See block-comment below for more information)` |
|         - | 12856 | ` */` |
|     53676 | 12857 | `static sxi32 GenStateCompileSwitchBlock(ph7_gen_state *pGen,sxu32 iTokenDelim,sxu32 *pBlockStart)` |
|         5 | 12858 | `{` |
|     53681 | 12859 | `	sxi32 rc = SXRET_OK;` |
|     53681 | 12860 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & (PH7_TK_SEMI/*';'*/\|PH7_TK_COLON/*':'*/)) == 0 ){` |
...
|       ! 0 | 12866 | `		pGen->pIn++;` |
|       ! 0 | 12867 | `	}` |
|     53681 | 12868 | `	pGen->pIn++;` |
|         - | 12869 | `	/* First instruction to execute in this block. */` |
|     53681 | 12870 | `	*pBlockStart = PH7_VmInstrLength(pGen->pVm);` |
|         - | 12871 | `	/* Compile the block until we hit a case/default/endswitch keyword` |
|         - | 12872 | `	 * or the '}' token */` |
|     38466 | 12873 | `	for(;;){` |
|     76937 | 12874 | `		if( pGen->pIn >= pGen->pEnd ){` |
|         - | 12875 | `			/* No more input to process */` |
|       ! 0 | 12876 | `			break;` |
|         - | 12877 | `		}` |
|     76937 | 12878 | `		rc = SXRET_OK;` |
|     76937 | 12879 | `		if( (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
|      3911 | 12880 | `			if( pGen->pIn->nType & PH7_TK_CCB /*'}' */ ){` |
|      3857 | 12881 | `				if( iTokenDelim != PH7_TK_CCB ){` |
...
|         - | 12888 | `					/* FALL THROUGH */` |
|       ! 0 | 12889 | `				}` |
|      3857 | 12890 | `				rc = SXERR_EOF;` |
|      3857 | 12891 | `				break;` |
|         - | 12892 | `			}` |
|        32 | 12893 | `		}else{` |
|         - | 12894 | `			sxi32 nKwrd;` |
|         - | 12895 | `			/* Extract the keyword */` |
|     73031 | 12896 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|     73031 | 12897 | `			if( nKwrd == PH7_TKWRD_CASE \|\| nKwrd == PH7_TKWRD_DEFAULT ){` |
|     24916 | 12898 | `				break;` |
|         - | 12899 | `			}` |
|     23209 | 12900 | `			if( nKwrd == PH7_TKWRD_ENDSWITCH /* endswitch; */){` |
...
|         - | 12913 | `		}` |
|         - | 12914 | `		/* Compile block */` |
|     23261 | 12915 | `		rc = PH7_CompileBlock(&(*pGen),0);` |
|     23261 | 12916 | `		if( rc == SXERR_ABORT ){` |
|       ! 0 | 12917 | `			return SXERR_ABORT;` |
|         - | 12918 | `		}` |
|         5 | 12919 | `	}` |
|     53681 | 12920 | `	return rc;` |
|     26843 | 12921 | `}` |
|         - | 12922 | `/*` |
|         - | 12923 | ` * Compile a case eXpression.` |
|         - | 12924 | ` *  (See block-comment below for more information)` |
|         - | 12925 | ` */` |
|     53656 | 12926 | `static sxi32 GenStateCompileCaseExpr(ph7_gen_state *pGen,ph7_case_expr *pExpr)` |
|         5 | 12927 | `{` |
|         - | 12928 | `	SySet *pInstrContainer;` |
|         - | 12929 | `	SyToken *pEnd,*pTmp;` |
|     53661 | 12930 | `	sxi32 iNest = 0;` |
|         - | 12931 | `	sxi32 rc;` |
|         - | 12932 | `	/* Delimit the expression */` |
|     53661 | 12933 | `	pEnd = pGen->pIn;` |
|    107325 | 12934 | `	while( pEnd < pGen->pEnd ){` |
|    107325 | 12935 | `		if( pEnd->nType & PH7_TK_LPAREN /*(*/ ){` |
|         - | 12936 | `			/* Increment nesting level */` |
|         3 | 12937 | `			iNest++;` |
|    107324 | 12938 | `		}else if( pEnd->nType & PH7_TK_RPAREN /*)*/ ){` |
|         - | 12939 | `			/* Decrement nesting level */` |
|         3 | 12940 | `			iNest--;` |
|    107322 | 12941 | `		}else if( pEnd->nType & (PH7_TK_SEMI/*';'*/\|PH7_TK_COLON/*;'*/) && iNest < 1 ){` |
|     53661 | 12942 | `			break;` |
|         - | 12943 | `		}` |
|     53669 | 12944 | `		pEnd++;` |
|         5 | 12945 | `	}` |
|     53661 | 12946 | `	if( pGen->pIn >= pEnd ){` |
...
|     53661 | 12954 | `	pTmp = pGen->pEnd;` |
|     53661 | 12955 | `	pGen->pEnd = pEnd;` |
|     53661 | 12956 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|     53661 | 12957 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pExpr->aByteCode);` |
|     53661 | 12958 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|         - | 12959 | `	/* Emit the done instruction */` |
|     53661 | 12960 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,(rc != SXERR_EMPTY ? 1 : 0),0,0,0);` |
|     53661 | 12961 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|         - | 12962 | `	/* Update token stream */` |
|     53661 | 12963 | `	pGen->pIn  = pEnd;` |
|     53661 | 12964 | `	pGen->pEnd = pTmp;` |
|     53661 | 12965 | `	if( rc == SXERR_ABORT ){` |
|       ! 0 | 12966 | `		return SXERR_ABORT;` |
|         - | 12967 | `	}` |
|     53661 | 12968 | `	return SXRET_OK;` |
|     26833 | 12969 | `}` |
|         - | 12970 | `/*` |
...
|         - | 12994 | ` */` |
|      3854 | 12995 | `static sxi32 PH7_CompileSwitch(ph7_gen_state *pGen)` |
|         5 | 12996 | `{` |
...
|         - | 13001 | `	sxu32 nLine;` |
|         - | 13002 | `	sxi32 rc;` |
|      3859 | 13003 | `	nLine = pGen->pIn->nLine;` |
|         - | 13004 | `	/* Jump the 'switch' keyword */` |
|      3859 | 13005 | `	pGen->pIn++;` |
|      3859 | 13006 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|         - | 13007 | `		/* Syntax error */` |
...
|      3859 | 13016 | `	pGen->pIn++;` |
|      3859 | 13017 | `	pEnd = 0; /* cc warning */` |
|         - | 13018 | `	/* Create the loop block */` |
|      5786 | 13019 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP\|GEN_BLOCK_SWITCH,` |
|      1927 | 13020 | `		PH7_VmInstrLength(pGen->pVm),0,&pSwitchBlock);` |
|      3859 | 13021 | `	if( rc != SXRET_OK ){` |
|       ! 0 | 13022 | `		return SXERR_ABORT;` |
|         - | 13023 | `	}` |
|         - | 13024 | `	/* Delimit the condition */` |
|      3859 | 13025 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|      3859 | 13026 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|       ! 0 | 13050 | `		pGen->pIn++;` |
|       ! 0 | 13051 | `	}` |
|      3859 | 13052 | `	pGen->pIn  = &pEnd[1];` |
|      3859 | 13053 | `	pGen->pEnd = pTmp;` |
|      3859 | 13054 | `	if( pGen->pIn >= pGen->pEnd \|\| &pGen->pIn[1] >= pGen->pEnd \|\|` |
|      3854 | 13055 | `		(pGen->pIn->nType & (PH7_TK_OCB/*'{'*/\|PH7_TK_COLON/*:*/)) == 0 ){` |
...
|      3859 | 13068 | `	if( pGen->pIn->nType & PH7_TK_COLON ){` |
|         3 | 13069 | `		nToken = PH7_TK_KEYWORD;` |
|         - | 13070 | `		/* Stop compilation when the 'endswitch;' keyword is seen */` |
|         2 | 13071 | `	}else{` |
|      3857 | 13072 | `		nToken = PH7_TK_CCB; /* '}' */` |
|         - | 13073 | `	}` |
|      3859 | 13074 | `	pGen->pIn++; /* Jump the leading curly braces/colons */` |
|         - | 13075 | `	/* Create the switch blocks container */` |
|      3859 | 13076 | `	pSwitch = (ph7_switch *)SyMemBackendAlloc(&pGen->pVm->sAllocator,sizeof(ph7_switch));` |
|      3859 | 13077 | `	if( pSwitch == 0 ){` |
...
|      3859 | 13083 | `	SyZero(pSwitch,sizeof(ph7_switch));` |
|         - | 13084 | `	/* Initialize fields */` |
|      3859 | 13085 | `	SySetInit(&pSwitch->aCaseExpr,&pGen->pVm->sAllocator,sizeof(ph7_case_expr));` |
|         - | 13086 | `	/* Emit the switch instruction */` |
|      3859 | 13087 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_SWITCH,0,0,pSwitch,0);` |
|         - | 13088 | `	/* Compile case blocks */` |
|     51751 | 13089 | `	for(;;){` |
|         - | 13090 | `		sxu32 nKwrd;` |
|     53683 | 13091 | `		if( pGen->pIn >= pGen->pEnd ){` |
|         - | 13092 | `			/* No more input to process */` |
|       ! 0 | 13093 | `			break;` |
|         - | 13094 | `		}` |
|     53683 | 13095 | `		if( (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|     53683 | 13109 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|     53683 | 13110 | `		if( nKwrd == PH7_TKWRD_ENDSWITCH /* endswitch; */){` |
...
|         3 | 13121 | `			break;` |
|         - | 13122 | `		}` |
|     53681 | 13123 | `		if( nKwrd == PH7_TKWRD_DEFAULT ){` |
|         - | 13124 | `			/*` |
...
|        23 | 13142 | `				break;` |
|         1 | 13143 | `			}` |
|     53662 | 13144 | `		}else if( nKwrd == PH7_TKWRD_CASE ){` |
|         - | 13145 | `			ph7_case_expr sCase;` |
|         - | 13146 | `			/* Standard case block */` |
|     53661 | 13147 | `			pGen->pIn++; /* Jump the 'case' keyword */` |
|         - | 13148 | `			/* initialize the structure */` |
|     53661 | 13149 | `			SySetInit(&sCase.aByteCode,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|         - | 13150 | `			/* Compile the case expression */` |
|     53661 | 13151 | `			rc = GenStateCompileCaseExpr(pGen,&sCase);` |
|     53661 | 13152 | `			if( rc == SXERR_ABORT ){` |
|       ! 0 | 13153 | `				return SXERR_ABORT;` |
|         - | 13154 | `			}` |
|         - | 13155 | `			/* Compile the case block */` |
|     53661 | 13156 | `			rc = GenStateCompileSwitchBlock(pGen,nToken,&sCase.nStart);` |
|         - | 13157 | `			/* Insert in the switch container */` |
|     53661 | 13158 | `			SySetPut(&pSwitch->aCaseExpr,(const void *)&sCase);` |
|     53661 | 13159 | `			if( rc == SXERR_ABORT){` |
|       ! 0 | 13160 | `				return SXERR_ABORT;` |
|     53661 | 13161 | `			}else if( rc == SXERR_EOF ){` |
|      3839 | 13162 | `				break;` |
|         - | 13163 | `			}` |
|     24916 | 13164 | `		}else{` |
...
|      3859 | 13175 | `	pSwitch->nOut = PH7_VmInstrLength(pGen->pVm);` |
|      3859 | 13176 | `	GenStateFixJumps(pSwitchBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|         - | 13177 | `	/* Release the loop block */` |
|      3859 | 13178 | `	GenStateLeaveBlock(pGen,0);` |
|      3859 | 13179 | `	if( pGen->pIn < pGen->pEnd ){` |
|         - | 13180 | `		/* Jump the trailing curly braces or the endswitch keyword*/` |
|      3859 | 13181 | `		pGen->pIn++;` |
|      1927 | 13182 | `	}` |
|         - | 13183 | `	/* Statement successfully compiled */` |
|      3859 | 13184 | `	return SXRET_OK;` |
|       ! 0 | 13185 | `Synchronize:` |
...
|         - | 13207 | ` */` |
|  49802040 | 13208 | `static void GenStatePatchNullsafeJumps(ph7_gen_state *pGen, sxu32 nBaseline)` |
|         5 | 13209 | `{` |
|  49802045 | 13210 | `	sxu32 nCur = SySetUsed(&pGen->aNullsafeJmp);` |
|         - | 13211 | `	sxu32 nTarget;` |
|         - | 13212 | `	sxu32 *aIdx;` |
|         - | 13213 | `	sxu32 i;` |
|  49802045 | 13214 | `	if( nCur <= nBaseline ){` |
|  49801949 | 13215 | `		return;` |
|         - | 13216 | `	}` |
...
|         - | 13244 | ` */` |
|   6423986 | 13245 | `static sxu32 GenStateByRefBuiltinMask(SyString *pName)` |
|         5 | 13246 | `{` |
...
|         - | 13261 | `	};` |
|         - | 13262 | `	sxu32 i;` |
|   6423991 | 13263 | `	if( pName == 0 \|\| pName->zString == 0 \|\| pName->nByte == 0 ){` |
|   1726701 | 13264 | `		return 0;` |
|         - | 13265 | `	}` |
|  46554901 | 13266 | `	for( i = 0 ; i < SX_ARRAYSIZE(aByRef) ; ++i ){` |
|  41915148 | 13267 | `		if( pName->nByte == aByRef[i].nByte` |
|  22085362 | 13268 | `		 && SyStrnicmp(pName->zString, aByRef[i].zName, pName->nByte) == 0 ){` |
|     57547 | 13269 | `			return aByRef[i].mask;` |
|         - | 13270 | `		}` |
|  20928808 | 13271 | `	}` |
|   4639753 | 13272 | `	return 0;` |
|   3211998 | 13273 | `}` |
|         - | 13274 | `/*` |
...
|         - | 13283 | ` */` |
|   6423986 | 13284 | `static void GenStateCallBuiltinName(ph7_expr_node *pLeft, SyString *pOut)` |
|         5 | 13285 | `{` |
|         - | 13286 | `	SyToken *p, *pEnd;` |
|   6423991 | 13287 | `	pOut->zString = 0;` |
|   6423991 | 13288 | `	pOut->nByte = 0;` |
|   6423991 | 13289 | `	if( pLeft == 0 \|\| pLeft->pStart == 0 \|\| pLeft->pEnd == 0 ){` |
|       ! 0 | 13290 | `		return;` |
|         - | 13291 | `	}` |
|   6423991 | 13292 | `	p = pLeft->pStart;` |
|   6423991 | 13293 | `	pEnd = pLeft->pEnd;` |
|         - | 13294 | `	/* Optional single leading namespace separator (absolute path). */` |
|   6423991 | 13295 | `	if( p < pEnd && (p->nType & PH7_TK_NSSEP) ){` |
|      3869 | 13296 | `		p++;` |
|      1932 | 13297 | `	}` |
|   6423991 | 13298 | `	if( p >= pEnd \|\| (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|   1726657 | 13299 | `		return;` |
|         - | 13300 | `	}` |
|         - | 13301 | `	/* Must be a single component: nothing follows the name token. */` |
|   4697339 | 13302 | `	if( p + 1 != pEnd ){` |
|        49 | 13303 | `		return;` |
|         - | 13304 | `	}` |
|   4697295 | 13305 | `	*pOut = p->sData;` |
|   3211998 | 13306 | `}` |
|         - | 13307 | `/*` |
...
|         - | 13312 | ` * error message.` |
|         - | 13313 | ` */` |
|  69742532 | 13314 | `static sxi32 GenStateEmitExprCode(` |
...
|         - | 13321 | `	sxu32 nJmpIdx;` |
|  69742537 | 13322 | `	sxi32 iP1 = 0;` |
|  69742537 | 13323 | `	sxu32 iP2 = 0;` |
|  69742537 | 13324 | `	void *p3  = 0;` |
|         - | 13325 | `	sxi32 iVmOp;` |
|         - | 13326 | `	sxi32 rc;` |
|  69742537 | 13327 | `	int bIsChainOp = 0; /* Set below once we know pNode->pOp */` |
|  69742537 | 13328 | ``	int bFcc = 0;       /* First-class callable `f(...)`: emit OP_LOAD_FCC, not OP_CALL */`` |
|  69742537 | 13329 | `	sxu32 nRhsNsBase = 0;` |
|  69742537 | 13330 | `	if( pNode->xCode ){` |
|         - | 13331 | `		SyToken *pTmpIn,*pTmpEnd;` |
|         - | 13332 | `		/* Compile node */` |
|  42007045 | 13333 | `		SWAP_DELIMITER(pGen,pNode->pStart,pNode->pEnd);` |
|  42007045 | 13334 | `		rc = pNode->xCode(&(*pGen),iFlags);` |
|  42007045 | 13335 | `		RE_SWAP_DELIMITER(pGen);` |
|  42007045 | 13336 | `		return rc;` |
|         - | 13337 | `	}` |
|  27735497 | 13338 | `	if( pNode->pOp == 0 ){` |
...
|         - | 13342 | `	}` |
|  27735497 | 13343 | `	iVmOp = pNode->pOp->iVmOp;` |
|  27735497 | 13344 | `	if( iVmOp == PH7_OP_CVT_NULL ){` |
...
|         - | 13352 | `		}` |
|         1 | 13353 | `	}` |
|  27735497 | 13354 | `	if( pNode->pOp->iOp == EXPR_OP_NULLC_ASSIGN ){` |
...
|         - | 13403 | `	}` |
|  27735407 | 13404 | `	if( pNode->pOp->iOp == EXPR_OP_QUESTY ){` |
...
|    462507 | 13409 | `		nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|    462507 | 13410 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pCond,iFlags);` |
|    462507 | 13411 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 13412 | `			return rc;` |
|         - | 13413 | `		}` |
...
|    462507 | 13417 | `		GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|    462507 | 13418 | `		nJz = nJmp = 0; /* cc -O6 warning */` |
|    462507 | 13419 | `		if( pNode->pLeft ){` |
|         - | 13420 | `			/* Standard ternary: (expr) ? (then) : (else) */` |
|         - | 13421 | `			/* Phase#2: Emit the false jump (pops condition) */` |
|    458611 | 13422 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nJz);` |
|         - | 13423 | `			/* Phase#3: Compile the 'then' expression  */` |
|    458611 | 13424 | `			nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|    458611 | 13425 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pLeft,iFlags);` |
|    458611 | 13426 | `			if( rc != SXRET_OK ){` |
|       ! 0 | 13427 | `				return rc;` |
|         - | 13428 | `			}` |
|    458611 | 13429 | `			GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|    229308 | 13430 | `		}else{` |
...
|      3901 | 13434 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_DUP,0,0,0,0);` |
|      3901 | 13435 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nJz);` |
|         - | 13436 | `		}` |
|         - | 13437 | `		/* Phase#4: Emit the unconditional jump */` |
|    462507 | 13438 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,0,0,&nJmp);` |
|         - | 13439 | `		/* Phase#5: Fix the false jump now the jump destination is resolved. */` |
|    462507 | 13440 | `		pInstr = PH7_VmGetInstr(pGen->pVm,nJz);` |
|    462507 | 13441 | `		if( pInstr ){` |
|    462507 | 13442 | `			pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    231251 | 13443 | `		}` |
|    462507 | 13444 | `		if( !pNode->pLeft ){` |
|         - | 13445 | `			/* Elvis operator: discard the falsy condition value before evaluating 'else' */` |
|      3901 | 13446 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|      1948 | 13447 | `		}` |
|         - | 13448 | `		/* Phase#6: Compile the 'else' expression */` |
|    462507 | 13449 | `		if( pNode->pRight ){` |
|    462507 | 13450 | `			nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|    462507 | 13451 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pRight,iFlags);` |
|    462507 | 13452 | `			if( rc != SXRET_OK ){` |
|       ! 0 | 13453 | `				return rc;` |
|         - | 13454 | `			}` |
|    462507 | 13455 | `			GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|    231251 | 13456 | `		}` |
|    462507 | 13457 | `		if( nJmp > 0 ){` |
|         - | 13458 | `			/* Phase#7: Fix the unconditional jump */` |
|    462507 | 13459 | `			pInstr = PH7_VmGetInstr(pGen->pVm,nJmp);` |
|    462507 | 13460 | `			if( pInstr ){` |
|    462507 | 13461 | `				pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    231251 | 13462 | `			}` |
|    231251 | 13463 | `		}` |
|         - | 13464 | `		/* All done */` |
|    462507 | 13465 | `		return SXRET_OK;` |
|         - | 13466 | `	}` |
|  27272905 | 13467 | `	if( pNode->pOp->iOp == EXPR_OP_PIPE ){` |
...
|         - | 13499 | `	}` |
|  27272879 | 13500 | `	bIsChainOp = GEN_IS_CHAIN_OP(pNode->pOp->iOp);` |
|         - | 13501 | `	/* Generate code for the left tree */` |
|  27272879 | 13502 | `	if( pNode->pLeft ){` |
|  27234825 | 13503 | `		sxu32 nLhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  27234825 | 13504 | `		if( iVmOp == PH7_OP_CALL ){` |
|         - | 13505 | `			ph7_expr_node **apNode;` |
|   6428143 | 13506 | `			int hasSpread = 0;` |
|   6428143 | 13507 | `			int hasNamed = 0;` |
|   6428143 | 13508 | `			int bAnySpread = 0;` |
|   6428143 | 13509 | `			sxu32 byRefMask = 0;` |
|         - | 13510 | `			sxi32 nArgs;` |
|         - | 13511 | `			sxi32 n;` |
|         - | 13512 | `			/* Recurse and generate bytecodes for function arguments */` |
|   6428143 | 13513 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|   6428143 | 13514 | `			nArgs = (sxi32)SySetUsed(&pNode->aNodeArgs);` |
...
|   6428143 | 13518 | `			if( nArgs == 1 && apNode[0] && (apNode[0]->iFlags & EXPR_NODE_FCC) ){` |
|        81 | 13519 | `				bFcc = 1;` |
|        81 | 13520 | `				nArgs = 0;` |
|        40 | 13521 | `			}` |
...
|         - | 13524 | `			{` |
|   6428143 | 13525 | `				int seenNamed = 0;` |
|   6428143 | 13526 | `				int seenSpread = 0;` |
|  13448175 | 13527 | `				for( n = 0; n < nArgs; ++n ){` |
|   7020039 | 13528 | `					if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
|      4025 | 13529 | `						bAnySpread = 1;` |
|      4025 | 13530 | `						seenSpread = 1;` |
|      4025 | 13531 | `						if( apNode[n]->iFlags & EXPR_NODE_NAMED_ARG ){` |
...
|         5 | 13535 | `						}` |
|   7018029 | 13536 | `					}else if( apNode[n]->iFlags & EXPR_NODE_NAMED_ARG ){` |
|       289 | 13537 | `						seenNamed = 1;` |
|       289 | 13538 | `						hasNamed = 1;` |
|   7015877 | 13539 | `					}else if( seenNamed ){` |
...
|   7015733 | 13543 | `					}else if( seenSpread ){` |
...
|   6428141 | 13551 | `			iFlags \|= EXPR_FLAG_RDONLY_LOAD;` |
...
|   6428141 | 13556 | `			if( pNode->pLeft && pNode->pLeft->pStart ){` |
|   6428141 | 13557 | `				SyString *pCallName = &pNode->pLeft->pStart->sData;` |
|   6428136 | 13558 | `				if( pCallName->nByte == 5` |
|   3596200 | 13559 | `				 && SyStrnicmp(pCallName->zString,"isset",5) == 0 ){` |
|    314123 | 13560 | `					iFlags \|= EXPR_FLAG_LOAD_IDX_ISSET;` |
|   6271082 | 13561 | `				}else if( pCallName->nByte == 5` |
|   3282082 | 13562 | `				 && SyStrnicmp(pCallName->zString,"empty",5) == 0 ){` |
...
|   6428141 | 13571 | `				if( !bAnySpread && !hasNamed ){` |
|         - | 13572 | `					SyString sBuiltin;` |
|   6423991 | 13573 | `					GenStateCallBuiltinName(pNode->pLeft, &sBuiltin);` |
|   6423991 | 13574 | `					byRefMask = GenStateByRefBuiltinMask(&sBuiltin);` |
|   3211993 | 13575 | `				}` |
|   3214068 | 13576 | `			}` |
|  13448171 | 13577 | `			for( n = 0 ; n < nArgs ; ++n ){` |
|   7020035 | 13578 | `				sxu32 nArgNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|   7020035 | 13579 | `				sxi32 iArgFlags = iFlags & ~(EXPR_FLAG_LOAD_IDX_STORE\|EXPR_FLAG_MEMBER_WRITE);` |
...
|   7020035 | 13586 | `				if( n < 31 && (byRefMask & (1u<<n)) ){` |
|     38349 | 13587 | `					iArgFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|     38349 | 13588 | `					iArgFlags \|= EXPR_FLAG_LOAD_IDX_STORE;` |
|     19172 | 13589 | `				}` |
|   7020035 | 13590 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iArgFlags);` |
|   7020035 | 13591 | `				if( rc != SXRET_OK ){` |
|       ! 0 | 13592 | `					return rc;` |
|         - | 13593 | `				}` |
|         - | 13594 | `				/* Each argument is an independent nullsafe scope. */` |
|   7020035 | 13595 | `				GenStatePatchNullsafeJumps(pGen, nArgNsBase);` |
|   7020035 | 13596 | `				if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
|         - | 13597 | `					/* Emit spread opcode to unpack this array argument */` |
|      4025 | 13598 | `					PH7_VmEmitInstr(pGen->pVm, PH7_OP_SPREAD, 0, 0, 0, 0);` |
|      4025 | 13599 | `					hasSpread = 1;` |
|      2010 | 13600 | `				}` |
|   3510020 | 13601 | `			}` |
|         - | 13602 | `			/* Total number of given arguments */` |
|   6428141 | 13603 | `			iP1 = nArgs;` |
|   6428141 | 13604 | `			iP2 = hasSpread;` |
|         - | 13605 | `			/* Build VmCallArgMap if named arguments are present.` |
|         - | 13606 | `			 * Deep-copy name strings so they survive token stream cleanup. */` |
|   6428141 | 13607 | `			if( hasNamed ){` |
...
|   6428141 | 13639 | `			iFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|   3214068 | 13640 | `		}` |
|         - | 13641 | `		{` |
...
|  27234823 | 13650 | `			sxi32 iLeftFlags = iFlags;` |
|  27234818 | 13651 | `			if( pNode->pLeft && pNode->pLeft->pOp` |
|  22342823 | 13652 | `				&& (pNode->pLeft->pOp->iOp == EXPR_OP_ARROW` |
|   8725440 | 13653 | `					\|\| pNode->pLeft->pOp->iOp == EXPR_OP_NULLSAFE_ARROW` |
|   7529501 | 13654 | `					\|\| pNode->pLeft->pOp->iOp == EXPR_OP_DC) ){` |
|   2583761 | 13655 | `				iLeftFlags &= ~EXPR_FLAG_LOAD_IDX_UNSET;` |
|   1291878 | 13656 | `			}` |
...
|  27234818 | 13664 | `			if( pNode->pOp` |
|  38406116 | 13665 | `				&& (pNode->pOp->iOp == EXPR_OP_ARROW` |
|  24788754 | 13666 | `					\|\| pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW` |
|  22342638 | 13667 | `					\|\| pNode->pOp->iOp == EXPR_OP_DC) ){` |
|   5291135 | 13668 | `				iLeftFlags &= ~EXPR_FLAG_MEMBER_WRITE;` |
|   2645565 | 13669 | `			}` |
...
|  27234818 | 13676 | `			if( pNode->pOp` |
|  27234823 | 13677 | `				&& (pNode->pOp->iVmOp == PH7_OP_INCR \|\| pNode->pOp->iVmOp == PH7_OP_DECR) ){` |
|    207109 | 13678 | `				iLeftFlags \|= EXPR_FLAG_LOAD_IDX_STORE \| EXPR_FLAG_MEMBER_WRITE;` |
|    103552 | 13679 | `			}` |
...
|  27234818 | 13687 | `			if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLC` |
|  13646186 | 13688 | `				&& pNode->pLeft && pNode->pLeft->pOp` |
|     86268 | 13689 | `				&& (pNode->pLeft->pOp->iOp == EXPR_OP_ARROW` |
|     57497 | 13690 | `					\|\| pNode->pLeft->pOp->iOp == EXPR_OP_NULLSAFE_ARROW` |
|     57479 | 13691 | `					\|\| pNode->pLeft->pOp->iOp == EXPR_OP_DC) ){` |
|        39 | 13692 | `				iLeftFlags \|= EXPR_FLAG_LOAD_IDX_ISSET;` |
|        19 | 13693 | `			}` |
|  27234823 | 13694 | `			if( iVmOp == PH7_OP_ERR_CTRL ){` |
...
|     15547 | 13697 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_ERR_CTRL,1,0,0,0);` |
|      7771 | 13698 | `			}` |
|  27234823 | 13699 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pLeft,iLeftFlags);` |
|         - | 13700 | `		}` |
|  27234823 | 13701 | `		if( rc != SXRET_OK ){` |
|        34 | 13702 | `			return rc;` |
|         - | 13703 | `		}` |
|  27234793 | 13704 | `		if( !bIsChainOp ){` |
...
|  12623449 | 13707 | `			GenStatePatchNullsafeJumps(pGen, nLhsNsBase);` |
|   6311722 | 13708 | `		}` |
|  27234793 | 13709 | `		if( iVmOp == PH7_OP_CALL ){` |
|   6428141 | 13710 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|   6428141 | 13711 | `			if( pInstr ){` |
|   6428141 | 13712 | `				if ( pInstr->iOp == PH7_OP_LOADC ){` |
|   4697587 | 13713 | `					sxu32 nOrig = (sxu32)pInstr->iP2;` |
|         - | 13714 | `					sxu32 nQual;` |
|   4697587 | 13715 | `					int bAbsolute = (pInstr->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|         - | 13716 | `					/* Prevent constant expansion but preserve the absolute flag` |
|         - | 13717 | `					 * so the later NEW handler (if any) can see it. */` |
|   4697587 | 13718 | `					pInstr->iP1 &= ~PH7_LOADC_EXPAND;` |
...
|   4697587 | 13726 | `					if( bAbsolute ){` |
|      3869 | 13727 | `						pInstr->iP2 = (sxi32)nOrig;` |
|      1937 | 13728 | `					}else{` |
|   4693723 | 13729 | `						int fromImport = 0;` |
|   4693723 | 13730 | `						nQual = GenStateNsQualifyName(pGen,nOrig,&pGen->hUseFuncImports,&fromImport);` |
|   4693723 | 13731 | `						pInstr->iP2 = (sxi32)nQual;` |
|   4693723 | 13732 | `						if( nQual != nOrig ){` |
...
|        46 | 13753 | `						}` |
|         - | 13754 | `					}` |
|   4079350 | 13755 | `				}else if( (pInstr->iOp == PH7_OP_MEMBER /* $a->b(1,2,3) */` |
|   1720648 | 13756 | `						&& !(pNode->pLeft && (pNode->pLeft->iFlags & EXPR_NODE_PARENS)))` |
|    875190 | 13757 | `					\|\| pInstr->iOp == PH7_OP_NEW ){` |
...
|   1710749 | 13773 | `					if( pInstr->iOp == PH7_OP_MEMBER && pInstr->iP1 == 1 && pInstr->p3 ){` |
...
|    855372 | 13779 | `				}` |
|   3214073 | 13780 | `			}` |
|  24020725 | 13781 | `		}else if( iVmOp == PH7_OP_LOAD_IDX ){` |
|         - | 13782 | `			ph7_expr_node **apNode;` |
|         - | 13783 | `			sxi32 n;` |
|   2892083 | 13784 | `			sxi32 iChildMask = ~(EXPR_FLAG_LOAD_IDX_STORE` |
...
|   2892083 | 13788 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|   5558007 | 13789 | `			for( n = 0 ; n < (sxi32)SySetUsed(&pNode->aNodeArgs) ; ++n ){` |
|   2665929 | 13790 | `				sxu32 nIdxNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|   2665929 | 13791 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iFlags&iChildMask);` |
|   2665929 | 13792 | `				if( rc != SXRET_OK ){` |
|       ! 0 | 13793 | `					return rc;` |
|         - | 13794 | `				}` |
|         - | 13795 | `				/* Each subscript index is an independent nullsafe scope. */` |
|   2665929 | 13796 | `				GenStatePatchNullsafeJumps(pGen, nIdxNsBase);` |
|   1332967 | 13797 | `			}` |
|   2892083 | 13798 | `			if( SySetUsed(&pNode->aNodeArgs) > 0 ){` |
|   2665929 | 13799 | `				iP1 = 1; /* Node have an index associated with it */` |
|   1332962 | 13800 | `			}` |
|   2892083 | 13801 | `			if( iFlags & EXPR_FLAG_LOAD_IDX_ISSET ){` |
|         - | 13802 | `				/* offsetExists for ArrayAccess; peek-only for arrays */` |
|    352275 | 13803 | `				iP2 = 4;` |
|   2715948 | 13804 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_UNSET ){` |
|         - | 13805 | `				/* offsetUnset for ArrayAccess; auto-vivify+load for arrays` |
|         - | 13806 | `				 * so the trailing unset() builtin can drop the slot. */` |
|     23037 | 13807 | `				iP2 = 5;` |
|   2528297 | 13808 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_EMPTY ){` |
...
|        31 | 13812 | `				iP2 = 6;` |
|   2516768 | 13813 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_STORE ){` |
|         - | 13814 | `				/* Create an empty entry when the desired index is not found */` |
|    536607 | 13815 | `				iP2 = 1;` |
|    268306 | 13816 | `			}` |
|  19360618 | 13817 | `		}else if( pNode->pOp->iOp == EXPR_OP_COMMA ){` |
|         - | 13818 | `			/* POP the left node */` |
|         5 | 13819 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|         2 | 13820 | `		}` |
|  13617394 | 13821 | `	}` |
|  27272847 | 13822 | `	rc = SXRET_OK;` |
|  27272847 | 13823 | `	nJmpIdx = 0;` |
...
|  27272847 | 13827 | `	if( iVmOp == PH7_OP_MEMBER && pNode->pOp->iOp == EXPR_OP_DC ){` |
|    433325 | 13828 | `		pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|    433325 | 13829 | `		if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|    433325 | 13830 | `			ph7_value *pLitCheck = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,(sxu32)pInstr->iP2);` |
|    433325 | 13831 | `			int isSpecial = 0;` |
|    433325 | 13832 | `			if( pLitCheck && (pLitCheck->iFlags & MEMOBJ_STRING) ){` |
|    364445 | 13833 | `				const char *z = (const char *)SyBlobData(&pLitCheck->sBlob);` |
|    364445 | 13834 | `				sxu32 n = (sxu32)SyBlobLength(&pLitCheck->sBlob);` |
|    364440 | 13835 | `				if( (n == 4 && SyMemcmp(z,"self",4) == 0) \|\|` |
|    326092 | 13836 | `					(n == 6 && SyMemcmp(z,"static",6) == 0) \|\|` |
|    176438 | 13837 | `					(n == 6 && SyMemcmp(z,"parent",6) == 0) ){` |
|    134081 | 13838 | `					isSpecial = 1;` |
|     67038 | 13839 | `				}` |
|    199440 | 13840 | `			}` |
|    467765 | 13841 | `			pInstr->iP1 = 0;` |
...
|         - | 13847 | `			{` |
|    667205 | 13848 | `				int bAbsolute = (pNode->pLeft && pNode->pLeft->pStart` |
|    598320 | 13849 | `					&& (pNode->pLeft->pStart->nType & PH7_TK_NSSEP));` |
|    398885 | 13850 | `				if( !isSpecial && !bAbsolute ){` |
|    264791 | 13851 | `					pInstr->iP2 = (sxi32)GenStateNsQualifyName(pGen,(sxu32)pInstr->iP2,&pGen->hUseImports,0);` |
|    132393 | 13852 | `				}` |
|         - | 13853 | `			}` |
...
|    398885 | 13856 | `			if( !isSpecial && pNode->pRight && pNode->pRight->pStart ){` |
|    264809 | 13857 | `				SyToken *pRightTok = pNode->pRight->pStart;` |
|    264809 | 13858 | `				if( (pRightTok->nType & PH7_TK_KEYWORD) &&` |
...
|  27238359 | 13866 | `	if( pNode->pRight ){` |
|  15708989 | 13867 | `		if( iVmOp == PH7_OP_LAND ){` |
|         - | 13868 | `			/* Emit the false jump so we can short-circuit the logical and */` |
|    436697 | 13869 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,1/* Keep the value on the stack */,0,0,&nJmpIdx);` |
|  15490643 | 13870 | `		}else if (iVmOp == PH7_OP_LOR ){` |
|         - | 13871 | `			/* Emit the true jump so we can short-circuit the logical or*/` |
|    302425 | 13872 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JNZ,1/* Keep the value on the stack */,0,0,&nJmpIdx);` |
|  15121087 | 13873 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLC ){` |
|         - | 13874 | `			/* Null coalescing: if LHS is not null, jump past RHS */` |
|     57559 | 13875 | `			iVmOp = 0; /* No binary operator to emit */` |
|     57559 | 13876 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_NULLC,0,0,0,&nJmpIdx);` |
|  14941152 | 13877 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW ){` |
...
|  14912271 | 13887 | `		}else if( pNode->pOp->iPrec == 18 /* Combined binary operators [i.e: =,'.=','+=',*=' ...] precedence */ ){` |
...
|   4928759 | 13891 | `			iFlags \|= EXPR_FLAG_LOAD_IDX_STORE \| EXPR_FLAG_MEMBER_WRITE;` |
|   2464377 | 13892 | `		}` |
|  15708989 | 13893 | `		nRhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  15708989 | 13894 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pRight,iFlags);` |
|  15708989 | 13895 | `		if( !bIsChainOp ){` |
|         - | 13896 | `			/* Non-chain parent: RHS nullsafe chain ends here, before the` |
|         - | 13897 | `			 * operator instruction is emitted. */` |
|  10417925 | 13898 | `			GenStatePatchNullsafeJumps(pGen, nRhsNsBase);` |
|   5208960 | 13899 | `		}` |
|  15708989 | 13900 | `		if( iVmOp == PH7_OP_STORE ){` |
|   4492253 | 13901 | `			if( pNode->pRight && (pNode->pRight->xCode == PH7_CompileList \|\|` |
|   4492216 | 13902 | `				pNode->pRight->xCode == PH7_CompileShortList) ){` |
...
|         - | 13908 | `				 */` |
|        91 | 13909 | `				iVmOp = 0;` |
|   4492210 | 13910 | `			}else if( (pInstr = PH7_VmPeekInstr(pGen->pVm)) != 0 ){` |
|   4492167 | 13911 | `				if(pInstr->iOp == PH7_OP_MEMBER ){` |
|         - | 13912 | `					/* Perform a member store operation [i.e: $this->x = 50] */` |
|    827141 | 13913 | `					iP2 = 1;` |
|    413573 | 13914 | `				}else{` |
|   3665031 | 13915 | `					if( pInstr->iOp == PH7_OP_LOAD_IDX ){` |
|         - | 13916 | `						/* Transform the STORE instruction to STORE_IDX instruction */` |
|    517379 | 13917 | `						iVmOp = PH7_OP_STORE_IDX;` |
|    517379 | 13918 | `						iP1 = pInstr->iP1;` |
|    258692 | 13919 | `					}else{` |
|   3147657 | 13920 | `						p3 = pInstr->p3;` |
|         - | 13921 | `					}` |
|         - | 13922 | `					/* POP the last dynamic load instruction */` |
|   3665031 | 13923 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|         - | 13924 | `				}` |
|   2246086 | 13925 | `			}` |
|  13462865 | 13926 | `		}else if( iVmOp == PH7_OP_STORE_REF ){` |
...
|        30 | 13941 | `		}` |
|   7854492 | 13942 | `	}` |
|  27238354 | 13943 | `	if( iVmOp == PH7_OP_NEW && pNode->pLeft && pNode->pLeft->pOp == 0` |
|    386231 | 13944 | `		&& pNode->pLeft->xCode == PH7_CompileAnnonClass ){` |
...
|        32 | 13947 | `		iVmOp = 0;` |
|        14 | 13948 | `	}` |
|  27238359 | 13949 | `	if( iVmOp > 0 ){` |
|  27180687 | 13950 | `		if( iVmOp == PH7_OP_INCR \|\| iVmOp == PH7_OP_DECR ){` |
|    207109 | 13951 | `			if( pNode->iFlags & EXPR_NODE_PRE_INCR ){` |
|         - | 13952 | `				/* Pre-increment/decrement operator [i.e: ++$i,--$j ] */` |
|     15341 | 13953 | `				iP1 = 1;` |
|      7673 | 13954 | `			}` |
|  27077135 | 13955 | `		}else if( iVmOp == PH7_OP_NEW ){` |
|         - | 13956 | `			/* Namespace-qualify the class name for NEW */ {` |
|    775715 | 13957 | `				VmInstr *pPeek = PH7_VmPeekInstr(pGen->pVm);` |
|    775715 | 13958 | `				VmInstr *pCallInstr = 0;` |
|    775715 | 13959 | `				if( pPeek && pPeek->iOp == PH7_OP_CALL ){` |
|    771765 | 13960 | `					pCallInstr = pPeek;` |
|    771765 | 13961 | `					pPeek = PH7_VmPeekNextInstr(pGen->pVm);` |
|    385880 | 13962 | `				}` |
|    775715 | 13963 | `				if( pPeek && pPeek->iOp == PH7_OP_LOADC ){` |
|    760405 | 13964 | `					int bAbsolute = (pPeek->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|         - | 13965 | `					sxu32 nLitForClass;` |
|    760405 | 13966 | `					VmCallArgMap *pCallNsMap = pCallInstr ? (VmCallArgMap *)pCallInstr->p3 : 0;` |
...
|    760405 | 13973 | `					if( pCallNsMap && pCallNsMap->nOrigNameLit > 0 ){` |
|        53 | 13974 | `						nLitForClass = pCallNsMap->nOrigNameLit - 1;` |
|        29 | 13975 | `					}else{` |
|    760357 | 13976 | `						nLitForClass = (sxu32)pPeek->iP2;` |
|         - | 13977 | `					}` |
|    760405 | 13978 | `					pPeek->iP1 = 0;` |
|    760405 | 13979 | `					if( !bAbsolute ){` |
...
|    756551 | 13984 | `						ph7_value *pLitChk = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,nLitForClass);` |
|    756551 | 13985 | `						int isSpecialNew = 0;` |
|    756551 | 13986 | `						if( pLitChk && (pLitChk->iFlags & MEMOBJ_STRING) ){` |
|    749287 | 13987 | `							const char *z = (const char *)SyBlobData(&pLitChk->sBlob);` |
|    749287 | 13988 | `							sxu32 n = (sxu32)SyBlobLength(&pLitChk->sBlob);` |
|    749282 | 13989 | `							if( (n == 4 && SyMemcmp(z,"self",4) == 0) \|\|` |
|    751045 | 13990 | `								(n == 6 && SyMemcmp(z,"static",6) == 0) \|\|` |
|    374589 | 13991 | `								(n == 6 && SyMemcmp(z,"parent",6) == 0) ){` |
|      3863 | 13992 | `								isSpecialNew = 1;` |
|      1929 | 13993 | `							}` |
|    376457 | 13994 | `						}` |
|    760183 | 13995 | `						if( isSpecialNew ){` |
|      3863 | 13996 | `							pPeek->iP2 = (sxi32)nLitForClass;` |
|      1934 | 13997 | `						}else{` |
|    749061 | 13998 | `							pPeek->iP2 = (sxi32)GenStateNsQualifyName(pGen,nLitForClass,&pGen->hUseImports,0);` |
|         - | 13999 | `						}` |
|    376462 | 14000 | `					}else{` |
|      3859 | 14001 | `						pPeek->iP2 = (sxi32)nLitForClass;` |
|         - | 14002 | `					}` |
|    378384 | 14003 | `				}` |
|         - | 14004 | `			}` |
|    772083 | 14005 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|    772083 | 14006 | `			if( pInstr && pInstr->iOp == PH7_OP_CALL ){` |
|         - | 14007 | `				VmInstr *pPrev;` |
|    771765 | 14008 | `				pPrev = PH7_VmPeekNextInstr(pGen->pVm);` |
|    771765 | 14009 | `				if( pPrev == 0 \|\| pPrev->iOp != PH7_OP_MEMBER ){` |
...
|    771765 | 14013 | `					iP1 = pInstr->iP1;` |
|    771765 | 14014 | `					iP2 = pInstr->iP2;` |
|    771765 | 14015 | `					if( pInstr->p3 ){` |
|        63 | 14016 | `						p3 = pInstr->p3; /* Transfer VmCallArgMap to NEW */` |
|        29 | 14017 | `					}` |
|    771765 | 14018 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|    385880 | 14019 | `				}` |
|    385885 | 14020 | `			}` |
|  26583912 | 14021 | `		}else if( iVmOp == PH7_OP_IS_A ){` |
...
|     76811 | 14024 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|     76811 | 14025 | `			if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|     76811 | 14026 | `				ph7_value *pLitChk = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,(sxu32)pInstr->iP2);` |
|     76811 | 14027 | `				int bAbsolute = (pInstr->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|     76811 | 14028 | `				int isSpecialIs = 0;` |
|     76811 | 14029 | `				if( pLitChk && (pLitChk->iFlags & MEMOBJ_STRING) ){` |
|     76811 | 14030 | `					const char *z = (const char *)SyBlobData(&pLitChk->sBlob);` |
|     76811 | 14031 | `					sxu32 n = (sxu32)SyBlobLength(&pLitChk->sBlob);` |
|     76806 | 14032 | `					if( (n == 4 && SyMemcmp(z,"self",4) == 0) \|\|` |
|     76809 | 14033 | `						(n == 6 && SyMemcmp(z,"static",6) == 0) \|\|` |
|     38403 | 14034 | `						(n == 6 && SyMemcmp(z,"parent",6) == 0) ){` |
|        12 | 14035 | `						isSpecialIs = 1;` |
|         5 | 14036 | `					}` |
|     38403 | 14037 | `				}` |
|     76811 | 14038 | `				pInstr->iP1 = 0;` |
|     76811 | 14039 | `				if( !isSpecialIs && !bAbsolute ){` |
|     76791 | 14040 | `					pInstr->iP2 = (sxi32)GenStateNsQualifyName(pGen,(sxu32)pInstr->iP2,&pGen->hUseImports,0);` |
|     38393 | 14041 | `				}` |
|     38408 | 14042 | `			}` |
|  26159470 | 14043 | `		}else if( iVmOp == PH7_OP_MEMBER){` |
...
|   5291069 | 14047 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|   5291069 | 14048 | `			if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|   5057587 | 14049 | `				pInstr->iP1 = 0;` |
|   2528791 | 14050 | `			}` |
|   5291069 | 14051 | `			if( pNode->pOp->iOp == EXPR_OP_DC /* '::' */){` |
|         - | 14052 | `				/* Static member access,remember that */` |
|    398837 | 14053 | `				iP1 = 1;` |
|    398837 | 14054 | `				pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|    398837 | 14055 | `				if( pInstr && pInstr->iOp == PH7_OP_LOAD ){` |
|    229645 | 14056 | `					p3 = pInstr->p3;` |
|    229645 | 14057 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|    114820 | 14058 | `				}` |
|    199416 | 14059 | `			}` |
...
|   5291069 | 14064 | `			if( iP2 == PH7_MEMBER_READ ){` |
|   5291069 | 14065 | `				if( iFlags & EXPR_FLAG_LOAD_IDX_UNSET ){` |
|        42 | 14066 | `					iP2 = PH7_MEMBER_UNSET;` |
|   5291049 | 14067 | `				}else if( iFlags & EXPR_FLAG_LOAD_IDX_ISSET ){` |
|     61359 | 14068 | `					iP2 = PH7_MEMBER_ISSET;` |
|   5260352 | 14069 | `				}else if( iFlags & EXPR_FLAG_LOAD_IDX_EMPTY ){` |
|        17 | 14070 | `					iP2 = PH7_MEMBER_EMPTY;` |
|   5229667 | 14071 | `				}else if( iFlags & EXPR_FLAG_MEMBER_WRITE ){` |
|         - | 14072 | `					/* Write-lvalue base ($o->arr[$k]=v, $o->p ??= v): auto-create a missing prop. */` |
|   1010975 | 14073 | `					iP2 = PH7_MEMBER_WRITE;` |
|    505485 | 14074 | `				}` |
|   2645532 | 14075 | `			}` |
|   2645532 | 14076 | `		}` |
...
|  27177055 | 14104 | `		if( iVmOp == PH7_OP_CALL \|\| iVmOp == PH7_OP_NEW ){` |
|   7200139 | 14105 | `			p3 = GenStateAttachStrictFlag(pGen,p3);` |
|   3600067 | 14106 | `		}` |
|         - | 14107 | `		/* Finally,emit the VM instruction associated with this operator */` |
|  27177055 | 14108 | `		PH7_VmEmitInstr(pGen->pVm,iVmOp,iP1,iP2,p3,0);` |
|  13588525 | 14109 | `	}` |
|  27234727 | 14110 | `	if( nJmpIdx > 0 ){` |
|         - | 14111 | `		/* Fix short-circuited jumps now the destination is resolved */` |
|    796671 | 14112 | `		pInstr = PH7_VmGetInstr(pGen->pVm,nJmpIdx);` |
|    796671 | 14113 | `		if( pInstr ){` |
|    796671 | 14114 | `			pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    398333 | 14115 | `		}` |
|    398333 | 14116 | `	}` |
|  27234727 | 14117 | `	return rc;` |
|  34852244 | 14118 | `}` |
|         - | 14119 | `/*` |
...
|         - | 14140 | ` */` |
| 231031958 | 14141 | `static int GenStateTreeHasComma(ph7_expr_node *pNode)` |
|         5 | 14142 | `{` |
|         - | 14143 | `	ph7_expr_node **apArg;` |
|         - | 14144 | `	sxu32 n;` |
| 231031963 | 14145 | `	if( pNode == 0 ){` |
| 162361525 | 14146 | `		return 0;` |
|         - | 14147 | `	}` |
|  68670443 | 14148 | `	if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_COMMA ){` |
|         6 | 14149 | `		return 1;` |
|         - | 14150 | `	}` |
|  68670434 | 14151 | `	if( GenStateTreeHasComma(pNode->pLeft) \|\| GenStateTreeHasComma(pNode->pRight)` |
|  68670435 | 14152 | `	 \|\| GenStateTreeHasComma(pNode->pCond) ){` |
|         6 | 14153 | `		return 1;` |
|         - | 14154 | `	}` |
|  68670435 | 14155 | `	apArg = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  78333513 | 14156 | `	for( n = 0 ; n < SySetUsed(&pNode->aNodeArgs) ; n++ ){` |
|   9663083 | 14157 | `		if( GenStateTreeHasComma(apArg[n]) ){` |
|       ! 0 | 14158 | `			return 1;` |
|         - | 14159 | `		}` |
|   4831544 | 14160 | `	}` |
|  68670435 | 14161 | `	return 0;` |
| 115515984 | 14162 | `}` |
|  15714032 | 14163 | `static sxi32 PH7_CompileExpr(` |
...
|  15714037 | 14177 | `	nExpr = 0;` |
|  15714037 | 14178 | `	pRoot = 0;` |
...
|  15714037 | 14181 | `	nNullsafeBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  15714037 | 14182 | `	SySetInit(&sExprNode,&pGen->pVm->sAllocator,sizeof(ph7_expr_node *));` |
|  15714037 | 14183 | `	SySetAlloc(&sExprNode,0x10);` |
|  15714037 | 14184 | `	rc = SXRET_OK;` |
|         - | 14185 | `	/* Delimit the expression */` |
|  15714037 | 14186 | `	pEnd = pGen->pIn;` |
|  15714037 | 14187 | `	iNest = 0;` |
| 122932671 | 14188 | `	while( pEnd < pGen->pEnd ){` |
| 116928595 | 14189 | `		if( pEnd->nType & PH7_TK_OCB /* '{' */ ){` |
|         - | 14190 | `			/* Ticket 1433-30: Annonymous/Closure functions body */` |
|      4667 | 14191 | `			iNest++;` |
| 116926264 | 14192 | `		}else if(pEnd->nType & PH7_TK_CCB /* '}' */ ){` |
|      4675 | 14193 | `			iNest--;` |
| 116921598 | 14194 | `		}else if( pEnd->nType & PH7_TK_SEMI /* ';' */ ){` |
|   9710833 | 14195 | `			if( iNest <= 0 ){` |
|   9709961 | 14196 | `				break;` |
|         - | 14197 | `			}` |
|       436 | 14198 | `		}` |
| 107218639 | 14199 | `		pEnd++;` |
|         5 | 14200 | `	}` |
|  15714037 | 14201 | `	if( iFlags & EXPR_FLAG_COMMA_STATEMENT ){` |
|    712703 | 14202 | `		SyToken *pEnd2 = pGen->pIn;` |
|    712703 | 14203 | `		iNest = 0;` |
|         - | 14204 | `		/* Stop at the first comma */` |
|   1560577 | 14205 | `		while( pEnd2 < pEnd ){` |
|    847881 | 14206 | `			if( pEnd2->nType & (PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*'['*/\|PH7_TK_LPAREN/*'('*/) ){` |
|     46029 | 14207 | `				iNest++;` |
|    824869 | 14208 | `			}else if(pEnd2->nType & (PH7_TK_CCB/*'}'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_RPAREN/*')'*/)){` |
|     46029 | 14209 | `				iNest--;` |
|    778845 | 14210 | `			}else if( pEnd2->nType & PH7_TK_COMMA /*','*/ ){` |
...
|    847879 | 14215 | `			pEnd2++;` |
|         5 | 14216 | `		}` |
|    712703 | 14217 | `		if( pEnd2 <pEnd ){` |
|         3 | 14218 | `			pEnd = pEnd2;` |
|         1 | 14219 | `		}` |
|    356349 | 14220 | `	}` |
|  15714037 | 14221 | `	if( pEnd > pGen->pIn ){` |
|  15691073 | 14222 | `		SyToken *pTmp = pGen->pEnd;` |
|         - | 14223 | `		/* Swap delimiter */` |
|  15691073 | 14224 | `		pGen->pEnd = pEnd;` |
|         - | 14225 | `		/* Try to get an expression tree */` |
|  15691073 | 14226 | `		rc = PH7_ExprMakeTree(&(*pGen),&sExprNode,&pRoot);` |
|  15691068 | 14227 | `		if( rc == SXRET_OK && pRoot && pGen->nCommaExprOk < 1` |
|  15524240 | 14228 | `		 && GenStateTreeHasComma(pRoot) ){` |
...
|         - | 14241 | `		}` |
|  15691069 | 14242 | `		if( rc == SXRET_OK && pRoot ){` |
|  15690885 | 14243 | `			rc = SXRET_OK;` |
|  15690885 | 14244 | `			if( xTreeValidator ){` |
|         - | 14245 | `				/* Call the upper layer validator callback */` |
|    977487 | 14246 | `				rc = xTreeValidator(&(*pGen),pRoot);` |
|    488741 | 14247 | `			}` |
|  15690885 | 14248 | `			if( rc != SXERR_ABORT ){` |
|         - | 14249 | `				/* Generate code for the given tree */` |
|  15690885 | 14250 | `				rc = GenStateEmitExprCode(&(*pGen),pRoot,iFlags);` |
|         - | 14251 | `				/* Patch any unresolved nullsafe jumps emitted by this` |
|         - | 14252 | `				 * expression so they short-circuit to its end. */` |
|  15690885 | 14253 | `				GenStatePatchNullsafeJumps(pGen, nNullsafeBase);` |
|   7845440 | 14254 | `			}` |
|  15690885 | 14255 | `			nExpr = 1;` |
|   7845440 | 14256 | `		}` |
|         - | 14257 | `		/* Release the whole tree */` |
|  15691069 | 14258 | `		PH7_ExprFreeTree(&(*pGen),&sExprNode);` |
|         - | 14259 | `		/* Synchronize token stream */` |
|  15691069 | 14260 | `		pGen->pEnd = pTmp;` |
|  15691069 | 14261 | `		pGen->pIn  = pEnd;` |
|  15691069 | 14262 | `		if( rc == SXERR_ABORT ){` |
|        12 | 14263 | `			SySetRelease(&sExprNode);` |
|        12 | 14264 | `			return SXERR_ABORT;` |
|         - | 14265 | `		}` |
|   7845527 | 14266 | `	}` |
|  15714023 | 14267 | `	SySetRelease(&sExprNode);` |
|  15714023 | 14268 | `	return nExpr > 0 ? SXRET_OK : SXERR_EMPTY;` |
|   7857021 | 14269 | `}` |
|         - | 14270 | `/*` |
|         - | 14271 | ` * Return a pointer to the node construct handler associated` |
|         - | 14272 | ` * with a given node type [i.e: string,integer,float,...].` |
|         - | 14273 | ` */` |
|   8983496 | 14274 | `PH7_PRIVATE ProcNodeConstruct PH7_GetNodeHandler(sxu32 nNodeType)` |
|         5 | 14275 | `{` |
|   8983501 | 14276 | `	if( nNodeType & PH7_TK_NUM ){` |
|         - | 14277 | `		/* Numeric literal: Either real or integer */` |
|   3680467 | 14278 | `		return PH7_CompileNumLiteral;` |
|   5303039 | 14279 | `	}else if( nNodeType & PH7_TK_DSTR ){` |
|         - | 14280 | `		/* Double quoted string */` |
|    120757 | 14281 | `		return PH7_CompileString;` |
|   5182287 | 14282 | `	}else if( nNodeType & PH7_TK_SSTR ){` |
|         - | 14283 | `		/* Single quoted string */` |
|   5182167 | 14284 | `		return PH7_CompileSimpleString;` |
...
|         - | 14301 | ` */` |
|     23074 | 14302 | `static sxi32 GenStateUnsetValidator(ph7_gen_state *pGen, ph7_expr_node *pNode)` |
|         5 | 14303 | `{` |
|         - | 14304 | `	sxi32 rc;` |
|     23079 | 14305 | `	if( !PH7_ExprContainsNullsafe(pNode) ){` |
|     23077 | 14306 | `		return SXRET_OK;` |
|         - | 14307 | `	}` |
...
|         - | 14319 | ` */` |
|     25928 | 14320 | `static sxi32 PH7_CompileUnset(ph7_gen_state *pGen)` |
|         5 | 14321 | `{` |
|     25933 | 14322 | `	SyToken *pTmp,*pEnd,*pNext = 0;` |
|     25933 | 14323 | `	sxu32 nIdx = 0;` |
|         - | 14324 | `	SyString sName;` |
|         - | 14325 | `	sxi32 rc;` |
|         - | 14326 | `	/* Jump the 'unset' keyword */` |
|     25933 | 14327 | `	pGen->pIn++;` |
|         - | 14328 | `	/* Save delimiter */` |
|     25933 | 14329 | `	pTmp = pGen->pEnd;` |
|         - | 14330 | `	/* Skip optional opening parenthesis and find the matching close */` |
|     25933 | 14331 | `	pEnd = pTmp; /* Default: scan to statement end */` |
|     25933 | 14332 | `	if( pGen->pIn < pTmp && (pGen->pIn->nType & PH7_TK_LPAREN) ){` |
|         - | 14333 | `		/* Find matching ')' — start scanning AFTER the '(' */` |
|         - | 14334 | `		SyToken *pClose;` |
|     25933 | 14335 | `		pGen->pIn++;   /* Skip '(' */` |
|     25933 | 14336 | `		PH7_DelimitNestedTokens(pGen->pIn,pTmp,PH7_TK_LPAREN,PH7_TK_RPAREN,&pClose);` |
|     25933 | 14337 | `		pEnd = pClose; /* Stop at ')' */` |
|     12964 | 14338 | `	}` |
|     25933 | 14339 | `	SyStringInitFromBuf(&sName,"unset",sizeof("unset")-1);` |
|         - | 14340 | `	/* Resolve the 'unset' builtin name once */` |
|     25933 | 14341 | `	if( SXRET_OK != GenStateFindLiteral(&(*pGen),&sName,&nIdx) ){` |
|      3831 | 14342 | `		ph7_value *pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|      3831 | 14343 | `		if( pObj == 0 ){` |
|       ! 0 | 14344 | `			return SXERR_ABORT;` |
|         - | 14345 | `		}` |
|      3831 | 14346 | `		PH7_MemObjInitFromString(pGen->pVm,pObj,&sName);` |
|      3831 | 14347 | `		GenStateInstallLiteral(&(*pGen),pObj,nIdx);` |
|      1913 | 14348 | `	}` |
|         - | 14349 | `	/* Compile each comma-separated argument */` |
|     56087 | 14350 | `	while( SXRET_OK == PH7_GetNextExpr(pGen->pIn,pEnd,&pNext) ){` |
|     30159 | 14351 | `		if( pGen->pIn < pNext ){` |
|         - | 14352 | `			/*` |
...
|         - | 14359 | `			 */` |
|     30154 | 14360 | `			if( &pGen->pIn[2] == pNext` |
|     18617 | 14361 | `				&& (pGen->pIn[0].nType & PH7_TK_DOLLAR)` |
...
|      7083 | 14378 | `				continue;` |
|         - | 14379 | `			}` |
|     23081 | 14380 | `			pGen->pEnd = pNext;` |
|     23081 | 14381 | `			rc = PH7_CompileExpr(&(*pGen),` |
|         - | 14382 | `				EXPR_FLAG_RDONLY_LOAD\|EXPR_FLAG_LOAD_IDX_UNSET,` |
|         - | 14383 | `				GenStateUnsetValidator);` |
|     23081 | 14384 | `			if( rc == SXERR_ABORT ){` |
|       ! 0 | 14385 | `				return SXERR_ABORT;` |
|         - | 14386 | `			}` |
|     23081 | 14387 | `			if( rc != SXERR_EMPTY ){` |
|         - | 14388 | `				/* Emit call for this single argument */` |
|     23079 | 14389 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|     23079 | 14390 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_CALL,1,0,GenStateAttachStrictFlag(pGen,0),0);` |
|     23079 | 14391 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|     11537 | 14392 | `			}` |
|     11538 | 14393 | `		}` |
|         - | 14394 | `		/* Jump trailing commas */` |
|     23087 | 14395 | `		while( pNext < pEnd && (pNext->nType & PH7_TK_COMMA) ){` |
|         7 | 14396 | `			pNext++;` |
|         1 | 14397 | `		}` |
|     23081 | 14398 | `		pGen->pIn = pNext;` |
|         5 | 14399 | `	}` |
|         - | 14400 | `	/* Skip past the closing ')' if present */` |
|     25933 | 14401 | `	if( pGen->pIn < pTmp && (pGen->pIn->nType & PH7_TK_RPAREN) ){` |
|     25933 | 14402 | `		pGen->pIn++;` |
|     12964 | 14403 | `	}` |
|         - | 14404 | `	/* Restore token stream */` |
|     25933 | 14405 | `	pGen->pEnd = pTmp;` |
|     25933 | 14406 | `	return SXRET_OK;` |
|     12969 | 14407 | `}` |
|         - | 14408 | `/*` |
...
|         - | 14440 | ` */` |
|   7624220 | 14441 | `static ProcLangConstruct GenStateGetStatementHandler(` |
|         - | 14442 | `	sxu32 nKeywordID,   /* Keyword  ID*/` |
|         - | 14443 | `	SyToken *pLookahed  /* Look-ahead token */` |
|         - | 14444 | `	)` |
|         5 | 14445 | `{` |
|   7624225 | 14446 | `	sxu32 n = 0;` |
|  30361187 | 14447 | `	for(;;){` |
|  60722379 | 14448 | `		if( n >= SX_ARRAYSIZE(aLangConstruct) ){` |
|    461557 | 14449 | `			break;` |
|         - | 14450 | `		}` |
|  60260827 | 14451 | `		if( aLangConstruct[n].nID == nKeywordID ){` |
|   7162673 | 14452 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed && (pLookahed->nType & PH7_TK_OP)){` |
...
|         - | 14457 | `				}` |
|       ! 0 | 14458 | `			}` |
|   7162668 | 14459 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed` |
|     11492 | 14460 | `				&& (pLookahed->nType & PH7_TK_KEYWORD)` |
|      5753 | 14461 | `				&& SX_PTR_TO_INT(pLookahed->pUserData) == PH7_TKWRD_FN ){` |
|         - | 14462 | `				/* 'static fn(...)' arrow function — compile as expression */` |
|         3 | 14463 | `				return 0;` |
|         - | 14464 | `			}` |
|         - | 14465 | `			/* Return a pointer to the handler.` |
|         - | 14466 | `			*/` |
|   7162671 | 14467 | `			return aLangConstruct[n].xConstruct;` |
|         - | 14468 | `		}` |
|  53098159 | 14469 | `		n++;` |
|         5 | 14470 | `	}` |
|    461557 | 14471 | `	if( pLookahed ){` |
|    461557 | 14472 | `		if(nKeywordID == PH7_TKWRD_INTERFACE && (pLookahed->nType & PH7_TK_ID) ){` |
|     68991 | 14473 | `			return PH7_CompileClassInterface;` |
|    392571 | 14474 | `		}else if(nKeywordID == PH7_TKWRD_CLASS && (pLookahed->nType & PH7_TK_ID) ){` |
|    334609 | 14475 | `			return PH7_CompileClass;` |
|     57967 | 14476 | `		}else if(nKeywordID == PH7_TKWRD_TRAIT && (pLookahed->nType & PH7_TK_ID) ){` |
|      7745 | 14477 | `			return PH7_CompileTrait;` |
|         - | 14478 | `		}` |
...
|     50227 | 14485 | `	return 0;` |
|   3812115 | 14486 | `}` |
|         - | 14487 | `/*` |
|         - | 14488 | ` * Check if the given keyword is in fact a PHP language construct.` |
|         - | 14489 | ` * Return TRUE on success. FALSE otheriwse.` |
|         - | 14490 | ` */` |
|     50224 | 14491 | `static int GenStateisLangConstruct(sxu32 nKeyword)` |
|         5 | 14492 | `{` |
|         - | 14493 | `	int rc;` |
|     50229 | 14494 | `	rc = PH7_IsLangConstruct(nKeyword,TRUE);` |
|     50229 | 14495 | `	if( rc == FALSE ){` |
|     50116 | 14496 | `		if( nKeyword == PH7_TKWRD_SELF \|\| nKeyword == PH7_TKWRD_PARENT \|\| nKeyword == PH7_TKWRD_STATIC` |
|     15672 | 14497 | `			\|\| nKeyword == PH7_TKWRD_YIELD` |
...
|         - | 14521 | ` */` |
|  16576048 | 14522 | `static void GenStateSetPendingDoc(ph7_gen_state *pGen)` |
|         5 | 14523 | `{` |
|  16576053 | 14524 | `	SyToken *pBase = (SyToken *)SySetBasePtr(pGen->pTokenSet);` |
|  16576053 | 14525 | `	ph7_trivia *aT = (ph7_trivia *)SySetBasePtr(&pGen->aTrivia);` |
|  16576053 | 14526 | `	sxu32 nT = SySetUsed(&pGen->aTrivia);` |
|         - | 14527 | `	sxu32 nIdx, n;` |
|  16576048 | 14528 | `	if( nT < 1 \|\| pGen->pTokenSet == 0` |
|   3388959 | 14529 | `	 \|\| pGen->pIn < pBase \|\| pGen->pIn >= &pBase[SySetUsed(pGen->pTokenSet)] ){` |
|         - | 14530 | `		/* Re-tokenized substream (string interpolation, synthesized code):` |
|         - | 14531 | `		 * indexes do not map to the sidecar */` |
|  13187101 | 14532 | `		return;` |
|         - | 14533 | `	}` |
|   3388957 | 14534 | `	nIdx = (sxu32)(pGen->pIn - pBase);` |
...
|   3388957 | 14537 | `	SySetReset(&pGen->aPendingAttrs);` |
|  10168355 | 14538 | `	for( n = 0 ; n < nT ; n++ ){` |
|   6779403 | 14539 | `		if( aT[n].nTokIdx != nIdx ){` |
|   6771587 | 14540 | `			continue;` |
|         - | 14541 | `		}` |
|      7821 | 14542 | `		if( aT[n].iKind == PH7_TRIVIA_DOC ){` |
|        29 | 14543 | `			pGen->sPendingDoc = aT[n].sText;` |
|      7809 | 14544 | `		}else if( aT[n].iKind == PH7_TRIVIA_ATTR ){` |
|      7797 | 14545 | `			SySetPut(&pGen->aPendingAttrs,(const void *)&aT[n]);` |
|      3896 | 14546 | `		}` |
|      3913 | 14547 | `	}` |
|   8288029 | 14548 | `}` |
|         - | 14549 | `/*` |
...
|         - | 14553 | ` */` |
|   4357430 | 14554 | `static void GenStateConsumeDoc(ph7_gen_state *pGen,SyString *pOut)` |
|         5 | 14555 | `{` |
|         - | 14556 | `	char *zDup;` |
|   4357435 | 14557 | `	if( SyStringLength(&pGen->sPendingDoc) < 1 ){` |
|   4357415 | 14558 | `		return;` |
|         - | 14559 | `	}` |
...
|         - | 14575 | ` */` |
|      7804 | 14576 | `static sxi32 GenStateCompileAttrSpan(ph7_gen_state *pGen,ph7_trivia *pTrivia,SySet *pOut)` |
|         5 | 14577 | `{` |
|         - | 14578 | `	SySet *pToken;` |
|         - | 14579 | `	SyToken *pIn, *pEnd, *pSavedIn, *pSavedEnd;` |
|         - | 14580 | `	char *zSpan;` |
|      7809 | 14581 | `	sxi32 rc = SXRET_OK;` |
|      7809 | 14582 | `	if( SyStringLength(&pTrivia->sText) < 1 ){` |
|       ! 0 | 14583 | `		return SXRET_OK;` |
|         - | 14584 | `	}` |
|     11711 | 14585 | `	zSpan = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|      3902 | 14586 | `		SyStringData(&pTrivia->sText),SyStringLength(&pTrivia->sText));` |
|      7809 | 14587 | `	if( zSpan == 0 ){` |
...
|      7809 | 14593 | `	pToken = (SySet *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(SySet));` |
|      7809 | 14594 | `	if( pToken == 0 ){` |
|       ! 0 | 14595 | `		return SXRET_OK;` |
|         - | 14596 | `	}` |
|      7809 | 14597 | `	SySetInit(pToken,&pGen->pVm->sAllocator,sizeof(SyToken));` |
|      7809 | 14598 | `	PH7_TokenizePHP(zSpan,SyStringLength(&pTrivia->sText),pTrivia->nLine,pToken,0);` |
|      7809 | 14599 | `	pIn = (SyToken *)SySetBasePtr(pToken);` |
|      7809 | 14600 | `	pEnd = &pIn[SySetUsed(pToken)];` |
|      7809 | 14601 | `	pSavedIn = pGen->pIn;` |
|      7809 | 14602 | `	pSavedEnd = pGen->pEnd;` |
|      7813 | 14603 | `	while( pIn < pEnd ){` |
|         - | 14604 | `		ph7_attribute sAttr;` |
|         - | 14605 | `		SyBlob sFQN;` |
|      7813 | 14606 | `		int bAbsolute = 0;` |
|      7813 | 14607 | `		SyZero(&sAttr,sizeof(sAttr));` |
|      7813 | 14608 | `		SySetInit(&sAttr.aArgs,&pGen->pVm->sAllocator,sizeof(ph7_attr_arg));` |
|      7813 | 14609 | `		sAttr.nLine = pIn->nLine;` |
|      7813 | 14610 | `		if( pIn->nType & PH7_TK_NSSEP ){` |
|        75 | 14611 | `			bAbsolute = 1;` |
|        75 | 14612 | `			pIn++;` |
|        35 | 14613 | `		}` |
|      7813 | 14614 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|      7813 | 14615 | `		while( pIn < pEnd && (pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|      7813 | 14616 | `			SyBlobAppend(&sFQN,pIn->sData.zString,pIn->sData.nByte);` |
|      7813 | 14617 | `			pIn++;` |
|      7813 | 14618 | `			if( pIn < pEnd && (pIn->nType & PH7_TK_NSSEP) ){` |
...
|      7813 | 14623 | `			break;` |
|       ! 0 | 14624 | `		}` |
|      7813 | 14625 | `		if( SyBlobLength(&sFQN) < 1 ){` |
...
|         - | 14633 | `		{` |
|      7813 | 14634 | `			const char *zName = (const char *)SyBlobData(&sFQN);` |
|      7813 | 14635 | `			sxu32 nName = SyBlobLength(&sFQN);` |
|      7813 | 14636 | `			char *zDup = 0;` |
|      7813 | 14637 | `			if( !bAbsolute ){` |
|      7743 | 14638 | `				SyHashEntry *pImp = SyHashGet(&pGen->hUseImports,(const void *)zName,nName);` |
|      7743 | 14639 | `				if( pImp ){` |
...
|       ! 0 | 14644 | `					}` |
|      7743 | 14645 | `				}else if( SyBlobLength(&pGen->sNamespace) > 0 ){` |
|         - | 14646 | `					SyBlob sTmp;` |
...
|       ! 0 | 14657 | `				}` |
|      3869 | 14658 | `			}` |
|      7813 | 14659 | `			if( SyStringLength(&sAttr.sName) < 1 ){` |
|      7813 | 14660 | `				zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,zName,nName);` |
|      7813 | 14661 | `				if( zDup ){` |
|      7813 | 14662 | `					SyStringInitFromBuf(&sAttr.sName,zDup,nName);` |
|      3904 | 14663 | `				}` |
|      3904 | 14664 | `			}` |
|         - | 14665 | `		}` |
|      7813 | 14666 | `		SyBlobRelease(&sFQN);` |
|      7813 | 14667 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_LPAREN) ){` |
|         - | 14668 | `			SyToken *pArgsEnd;` |
|      7711 | 14669 | `			pIn++;` |
|      7711 | 14670 | `			PH7_DelimitNestedTokens(pIn,pEnd,PH7_TK_LPAREN,PH7_TK_RPAREN,&pArgsEnd);` |
|     15431 | 14671 | `			while( pIn < pArgsEnd ){` |
|      7725 | 14672 | `				SyToken *pArgStart = pIn, *pArgStop = pIn;` |
|      7725 | 14673 | `				sxi32 iDepth = 0;` |
|         - | 14674 | `				ph7_attr_arg sArgRec;` |
|     76765 | 14675 | `				while( pArgStop < pArgsEnd ){` |
|     69061 | 14676 | `					if( pArgStop->nType & (PH7_TK_LPAREN\|PH7_TK_OSB\|PH7_TK_OCB) ){` |
|        11 | 14677 | `						iDepth++;` |
|     69056 | 14678 | `					}else if( pArgStop->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB) ){` |
|        11 | 14679 | `						iDepth--;` |
|     69046 | 14680 | `					}else if( (pArgStop->nType & PH7_TK_COMMA) && iDepth == 0 ){` |
|        17 | 14681 | `						break;` |
|         - | 14682 | `					}` |
|     69045 | 14683 | `					pArgStop++;` |
|         5 | 14684 | `				}` |
|      7725 | 14685 | `				SyZero(&sArgRec,sizeof(sArgRec));` |
|      7725 | 14686 | `				SySetInit(&sArgRec.aByteCode,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|      7720 | 14687 | `				if( pArgStart < pArgStop && (pArgStart->nType & (PH7_TK_ID\|PH7_TK_KEYWORD))` |
|      7704 | 14688 | `				 && &pArgStart[1] < pArgStop && (pArgStart[1].nType & PH7_TK_COLON) ){` |
...
|         9 | 14695 | `				}` |
|      7725 | 14696 | `				if( pArgStart < pArgStop ){` |
|         - | 14697 | `					SySet *pInstrContainer;` |
|      7725 | 14698 | `					pGen->pIn = pArgStart;` |
|      7725 | 14699 | `					pGen->pEnd = pArgStop;` |
|      7725 | 14700 | `					pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|      7725 | 14701 | `					PH7_VmSetByteCodeContainer(pGen->pVm,&sArgRec.aByteCode);` |
|      7725 | 14702 | `					rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|      7725 | 14703 | `					PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|      7725 | 14704 | `					PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|      7725 | 14705 | `					if( rc == SXERR_ABORT ){` |
|       ! 0 | 14706 | `						pGen->pIn = pSavedIn;` |
|       ! 0 | 14707 | `						pGen->pEnd = pSavedEnd;` |
|       ! 0 | 14708 | `						return SXERR_ABORT;` |
|         - | 14709 | `					}` |
|      7725 | 14710 | `					SySetPut(&sAttr.aArgs,(const void *)&sArgRec);` |
|      3860 | 14711 | `				}` |
|      7725 | 14712 | `				pIn = pArgStop;` |
|      7725 | 14713 | `				if( pIn < pArgsEnd && (pIn->nType & PH7_TK_COMMA) ){` |
|        17 | 14714 | `					pIn++;` |
|         8 | 14715 | `				}` |
|         5 | 14716 | `			}` |
|      7711 | 14717 | `			pIn = (pArgsEnd < pEnd) ? &pArgsEnd[1] : pEnd;` |
|      3853 | 14718 | `		}` |
|      7813 | 14719 | `		SySetPut(pOut,(const void *)&sAttr);` |
|      7813 | 14720 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_COMMA) ){` |
|         5 | 14721 | `			pIn++;` |
|         5 | 14722 | `			continue;` |
|         - | 14723 | `		}` |
|      7809 | 14724 | `		break;` |
|       ! 0 | 14725 | `	}` |
|      7809 | 14726 | `	pGen->pIn = pSavedIn;` |
|      7809 | 14727 | `	pGen->pEnd = pSavedEnd;` |
|      7809 | 14728 | `	return SXRET_OK;` |
|      3907 | 14729 | `}` |
|         - | 14730 | `/*` |
...
|         - | 14733 | ` */` |
|   4357434 | 14734 | `static sxi32 GenStateConsumeAttrs(ph7_gen_state *pGen,SySet *pOut)` |
|         5 | 14735 | `{` |
|   4357439 | 14736 | `	ph7_trivia *aT = (ph7_trivia *)SySetBasePtr(&pGen->aPendingAttrs);` |
|         - | 14737 | `	sxu32 n;` |
|         - | 14738 | `	sxi32 rc;` |
|   4365231 | 14739 | `	for( n = 0 ; n < SySetUsed(&pGen->aPendingAttrs) ; n++ ){` |
|      7797 | 14740 | `		rc = GenStateCompileAttrSpan(&(*pGen),&aT[n],pOut);` |
|      7797 | 14741 | `		if( rc == SXERR_ABORT ){` |
|       ! 0 | 14742 | `			return SXERR_ABORT;` |
|         - | 14743 | `		}` |
|      3901 | 14744 | `	}` |
|   4357439 | 14745 | `	SySetReset(&pGen->aPendingAttrs);` |
|   4357439 | 14746 | `	return SXRET_OK;` |
|   2178722 | 14747 | `}` |
|         - | 14748 | `/*` |
...
|         - | 14752 | ` */` |
|   2093130 | 14753 | `static sxi32 GenStateCollectParamAttrs(ph7_gen_state *pGen,SyToken *pTok,SySet *pOut)` |
|         5 | 14754 | `{` |
|   2093135 | 14755 | `	SyToken *pBase = (SyToken *)SySetBasePtr(pGen->pTokenSet);` |
|   2093135 | 14756 | `	ph7_trivia *aT = (ph7_trivia *)SySetBasePtr(&pGen->aTrivia);` |
|   2093135 | 14757 | `	sxu32 nT = SySetUsed(&pGen->aTrivia);` |
|         - | 14758 | `	sxu32 nIdx, n;` |
|         - | 14759 | `	sxi32 rc;` |
|   2093130 | 14760 | `	if( nT < 1 \|\| pGen->pTokenSet == 0` |
|    547457 | 14761 | `	 \|\| pTok < pBase \|\| pTok >= &pBase[SySetUsed(pGen->pTokenSet)] ){` |
|   1545683 | 14762 | `		return SXRET_OK;` |
|         - | 14763 | `	}` |
|    547457 | 14764 | `	nIdx = (sxu32)(pTok - pBase);` |
|   1642359 | 14765 | `	for( n = 0 ; n < nT ; n++ ){` |
|   1094907 | 14766 | `		if( aT[n].nTokIdx == nIdx && aT[n].iKind == PH7_TRIVIA_ATTR ){` |
...
|         6 | 14771 | `		}` |
|    547456 | 14772 | `	}` |
|    547457 | 14773 | `	return SXRET_OK;` |
|   1046570 | 14774 | `}` |
|  12244514 | 14775 | `static sxi32 GenStateCompileChunk(` |
...
|         - | 14781 | `	sxi32 rc;` |
|  12244519 | 14782 | `	rc = SXRET_OK; /* Prevent compiler warning */` |
|   7105631 | 14783 | `	for(;;){` |
|  13227893 | 14784 | `		int bStmtIsDeclare = 0;` |
|  13227893 | 14785 | `		if( pGen->pIn >= pGen->pEnd ){` |
|         - | 14786 | `			/* No more input to process */` |
|     67741 | 14787 | `			break;` |
|         - | 14788 | `		}` |
|         - | 14789 | `		/* Bind a directly-preceding docblock to this statement */` |
|  13160157 | 14790 | `		GenStateSetPendingDoc(&(*pGen));` |
|  13160157 | 14791 | `		if( SySetUsed(&pGen->aPendingAttrs) > 0 ){` |
...
|      7715 | 14797 | `			int bAttrTarget = 0;` |
|      7710 | 14798 | `			if( GenStateStartsModifiedClass(pGen->pIn,pGen->pEnd)` |
|      3889 | 14799 | `			 \|\| GenStateStartsEnumDecl(pGen->pIn,pGen->pEnd) ){` |
|      7657 | 14800 | `				bAttrTarget = 1;` |
|      3885 | 14801 | `			}else if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
...
|  13160157 | 14823 | `		if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|   7662551 | 14824 | `			sxu32 nPeek = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   7662551 | 14825 | `			if( nPeek == PH7_TKWRD_DECLARE ){` |
|        47 | 14826 | `				bStmtIsDeclare = 1;` |
|        21 | 14827 | `			}` |
|   3831273 | 14828 | `		}` |
|  13160157 | 14829 | `		if( !bStmtIsDeclare && pGen->pCurrent == &pGen->sGlobal ){` |
...
|    983347 | 14832 | `			pGen->bStrictTypesLocked = 1;` |
|    491671 | 14833 | `		}` |
|  13160157 | 14834 | `		if( pGen->pIn->nType & PH7_TK_OCB /* '{' */ ){` |
|         - | 14835 | `			/* Compile block */` |
|      3867 | 14836 | `			rc = PH7_CompileBlock(&(*pGen),0);` |
|      3867 | 14837 | `			if( rc == SXERR_ABORT ){` |
|       ! 0 | 14838 | `				break;` |
|         - | 14839 | `			}` |
|      1936 | 14840 | `		}else{` |
|  13156295 | 14841 | `			xCons = 0;` |
|  13156295 | 14842 | `			if( GenStateStartsModifiedClass(pGen->pIn,pGen->pEnd) ){` |
...
|     38357 | 14846 | `				xCons = PH7_CompileClassModifiers;` |
|  13137119 | 14847 | `			}else if( GenStateStartsEnumDecl(pGen->pIn,pGen->pEnd) ){` |
|         - | 14848 | ``				/* `enum Name …` (PHP 8.1) — `enum` is a context-sensitive ID,`` |
|         - | 14849 | `				 * so it is detected here rather than the keyword dispatcher. */` |
|      3863 | 14850 | `				xCons = PH7_CompileEnum;` |
|  13116014 | 14851 | `			}else if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|   7624225 | 14852 | `				sxu32 nKeyword = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|         - | 14853 | `				/* Try to extract a language construct handler */` |
|   7624225 | 14854 | `				xCons = GenStateGetStatementHandler(nKeyword,(&pGen->pIn[1] < pGen->pEnd) ? &pGen->pIn[1] : 0);` |
|   7624225 | 14855 | `				if( xCons == 0 && GenStateisLangConstruct(nKeyword) == FALSE ){` |
...
|         4 | 14866 | `				}` |
|   9301975 | 14867 | `			}else if( (pGen->pIn->nType & PH7_TK_ID) && (&pGen->pIn[1] < pGen->pEnd)` |
|    410745 | 14868 | `				&& (pGen->pIn[1].nType & PH7_TK_COLON /*':'*/) ){` |
|         - | 14869 | `				/* Label found [i.e: Out: ],point to the routine responsible of compiling it */` |
|       117 | 14870 | `				xCons = PH7_CompileLabel;` |
|        56 | 14871 | `			}` |
|  13156295 | 14872 | `			if( xCons == 0 ){` |
|         - | 14873 | `				/* Assume an expression an try to compile it */` |
|   5539969 | 14874 | `				rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   5539969 | 14875 | `				if(  rc != SXERR_EMPTY ){` |
|         - | 14876 | `					/* Pop l-value */` |
|   5539819 | 14877 | `					PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|   2769907 | 14878 | `				}` |
|   2769987 | 14879 | `			}else{` |
|         - | 14880 | `				/* Go compile the sucker */` |
|   7616331 | 14881 | `				rc = xCons(&(*pGen));` |
|         - | 14882 | `			}` |
|  13156295 | 14883 | `			if( rc == SXERR_ABORT ){` |
|         - | 14884 | `				/* Request to abort compilation */` |
|        12 | 14885 | `				break;` |
|         - | 14886 | `			}` |
|         - | 14887 | `		}` |
|         - | 14888 | `		/* Ignore trailing semi-colons ';' */` |
|  22573663 | 14889 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|   9413521 | 14890 | `			pGen->pIn++;` |
|         5 | 14891 | `		}` |
|  13160147 | 14892 | `		if( iFlags & PH7_COMPILE_SINGLE_STMT ){` |
|         - | 14893 | `			/* Compile a single statement and return */` |
|  12176773 | 14894 | `			break;` |
|         - | 14895 | `		}` |
|         - | 14896 | `		/* LOOP ONE */` |
|         - | 14897 | `		/* LOOP TWO */` |
|         - | 14898 | `		/* LOOP THREE */` |
...
|         - | 14908 | ` */` |
|     67748 | 14909 | `static sxi32 PH7_CompilePHP(` |
...
|         - | 14913 | `	)` |
|         5 | 14914 | `{` |
|     67753 | 14915 | `	SyToken *pScript = pGen->pRawIn; /* Script to compile */` |
|         - | 14916 | `	sxi32 rc;` |
|         - | 14917 | `	/* Reset the token set (and its trivia sidecar) */` |
|     67753 | 14918 | `	SySetReset(&(*pTokenSet));` |
|     67753 | 14919 | `	SySetReset(&pGen->aTrivia);` |
|         - | 14920 | `	/* Mark as the default token set */` |
|     67753 | 14921 | `	pGen->pTokenSet = &(*pTokenSet);` |
|         - | 14922 | `	/* Advance the stream cursor */` |
|     67753 | 14923 | `	pGen->pRawIn++;` |
|         - | 14924 | `	/* Tokenize the PHP chunk first */` |
|     67753 | 14925 | `	PH7_TokenizePHP(SyStringData(&pScript->sData),SyStringLength(&pScript->sData),pScript->nLine,&(*pTokenSet),&pGen->aTrivia);` |
|         - | 14926 | `	/* Point to the head and tail of the token stream. */` |
|     67753 | 14927 | `	pGen->pIn  = (SyToken *)SySetBasePtr(pTokenSet);` |
|     67753 | 14928 | `	pGen->pEnd = &pGen->pIn[SySetUsed(pTokenSet)];` |
|     67753 | 14929 | `	if( is_expr ){` |
...
|         - | 14938 | `	}` |
|     67753 | 14939 | `	if( pGen->pIn < pGen->pEnd && ( pGen->pIn->nType & PH7_TK_EQUAL ) ){` |
...
|     67751 | 14964 | `	rc = GenStateCompileChunk(pGen,0);` |
|         - | 14965 | `	/* Fix exceptions jumps */` |
|     67751 | 14966 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|         - | 14967 | `	/* Fix gotos now, the jump destination is resolved */` |
|     67751 | 14968 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),0) ){` |
|         3 | 14969 | `		rc = SXERR_ABORT;` |
|         1 | 14970 | `	}` |
|         - | 14971 | `	/* Reset container */` |
|     67751 | 14972 | `	SySetReset(&pGen->aGoto);` |
|     67751 | 14973 | `	SySetReset(&pGen->aLabel);` |
|     67751 | 14974 | `	SySetReset(&pGen->aNullsafeJmp);` |
|         - | 14975 | `	/* Compilation result */` |
|     67751 | 14976 | `	return rc;` |
|     33879 | 14977 | `}` |
|         - | 14978 | `/*` |
...
|         - | 14982 | ` */` |
|     70974 | 14983 | `PH7_PRIVATE sxi32 PH7_CompileScript(` |
...
|         - | 14998 | `	sxi32 rc;` |
|     70979 | 14999 | `	sxu32 nBaseLine = 1;` |
|     70979 | 15000 | `	if( pScript->nByte < 1 ){` |
...
|     70979 | 15007 | `	if( pScript->nByte >= 2 && pScript->zString[0]=='#' && pScript->zString[1]=='!' ){` |
...
|     70979 | 15021 | `	pCodeGen = &pVm->sCodeGen;` |
...
|     70979 | 15028 | `	pSavedIn = pCodeGen->pIn;` |
|     70979 | 15029 | `	pSavedEnd = pCodeGen->pEnd;` |
|     70979 | 15030 | `	bSavedStrict = pCodeGen->bStrictTypes;` |
|     70979 | 15031 | `	bSavedStrictLocked = pCodeGen->bStrictTypesLocked;` |
|     70979 | 15032 | `	pCodeGen->bStrictTypes = 0;` |
|     70979 | 15033 | `	pCodeGen->bStrictTypesLocked = 0;` |
|         - | 15034 | `	/* Initialize the tokens containers */` |
|     70979 | 15035 | `	SySetInit(&aRawToken,&pVm->sAllocator,sizeof(SyToken));` |
|     70979 | 15036 | `	SySetInit(&aPhpToken,&pVm->sAllocator,sizeof(SyToken));` |
|     70979 | 15037 | `	SySetAlloc(&aPhpToken,0xc0);` |
|     70979 | 15038 | `	is_expr = 0;` |
|     70979 | 15039 | `	if( iFlags & PH7_PHP_ONLY ){` |
|         - | 15040 | `		SyToken sTmp;` |
|         - | 15041 | `		/* PHP only: -*/` |
|     57515 | 15042 | `		sTmp.nLine = 1;` |
|     57515 | 15043 | `		sTmp.nType = PH7_TOKEN_PHP;` |
|     57515 | 15044 | `		sTmp.pUserData = 0;` |
|     57515 | 15045 | `		SyStringDupPtr(&sTmp.sData,pScript);` |
|     57515 | 15046 | `		SySetPut(&aRawToken,(const void *)&sTmp);` |
|     57515 | 15047 | `		if( iFlags & PH7_PHP_EXPR ){` |
|         - | 15048 | `			/* A simple PHP expression */` |
|       ! 0 | 15049 | `			is_expr = 1;` |
|       ! 0 | 15050 | `		}` |
|     28760 | 15051 | `	}else{` |
|         - | 15052 | `		/* Tokenize raw text */` |
|     13469 | 15053 | `		SySetAlloc(&aRawToken,32);` |
|     13469 | 15054 | `		PH7_TokenizeRawText(pScript->zString,pScript->nByte,&aRawToken,nBaseLine);` |
|         - | 15055 | `	}` |
|         - | 15056 | `	/* Process high-level tokens */` |
|     70979 | 15057 | `	pCodeGen->pRawIn = (SyToken *)SySetBasePtr(&aRawToken);` |
|     70979 | 15058 | `	pCodeGen->pRawEnd = &pCodeGen->pRawIn[SySetUsed(&aRawToken)];` |
|     70979 | 15059 | `	rc = PH7_OK;` |
|     70979 | 15060 | `	if( is_expr ){` |
|         - | 15061 | `		/* Compile the expression */` |
|       ! 0 | 15062 | `		rc = PH7_CompilePHP(pCodeGen,&aPhpToken,TRUE);` |
|       ! 0 | 15063 | `		goto cleanup;` |
|         - | 15064 | `	}` |
|     70979 | 15065 | `	nObjIdx = 0;` |
...
|     70979 | 15069 | `	PH7_VmEmitInstr(pVm,PH7_OP_NSSWITCH,0,0,0,0);` |
|         - | 15070 | `	/* Start the compilation process */` |
|     42224 | 15071 | `	for(;;){` |
|    152189 | 15072 | `		if( pCodeGen->pRawIn >= pCodeGen->pRawEnd ){` |
|     70967 | 15073 | `			break; /* No more tokens to process */` |
|         - | 15074 | `		}` |
|     81227 | 15075 | `		if( pCodeGen->pRawIn->nType & PH7_TOKEN_PHP ){` |
|         - | 15076 | `			/* Compile the PHP chunk */` |
|     67753 | 15077 | `			rc = PH7_CompilePHP(pCodeGen,&aPhpToken,FALSE);` |
|     67753 | 15078 | `			if( rc == SXERR_ABORT ){` |
|        15 | 15079 | `				break;` |
|         - | 15080 | `			}` |
|     67741 | 15081 | `			continue;` |
|         - | 15082 | `		}` |
|         - | 15083 | `		/* Raw chunk: [i.e: HTML, XML, etc.] */` |
|     13479 | 15084 | `		nRawObj = 0;` |
|     26953 | 15085 | `		while( (pCodeGen->pRawIn < pCodeGen->pRawEnd) && (pCodeGen->pRawIn->nType != PH7_TOKEN_PHP) ){` |
|         - | 15086 | `			/* Consume the raw chunk without any processing */` |
|     13479 | 15087 | `			pRawObj = PH7_ReserveConstObj(&(*pVm),&nObjIdx);` |
|     13479 | 15088 | `			if( pRawObj == 0 ){` |
|       ! 0 | 15089 | `				rc = SXERR_MEM;` |
|       ! 0 | 15090 | `				break;` |
|         - | 15091 | `			}` |
|         - | 15092 | `			/* Mark as constant and emit the load constant instruction */` |
|     13479 | 15093 | `			PH7_MemObjInitFromString(pVm,pRawObj,&pCodeGen->pRawIn->sData);` |
|     13479 | 15094 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_LOADC,0,nObjIdx,0,0);` |
|     13479 | 15095 | `			++nRawObj;` |
|     13479 | 15096 | `			pCodeGen->pRawIn++; /* Next chunk */` |
|         5 | 15097 | `		}` |
|     13479 | 15098 | `		if( nRawObj > 0 ){` |
|         - | 15099 | `			/* Emit the consume instruction */` |
|     13479 | 15100 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_CONSUME,nRawObj,0,0,0);` |
|      6737 | 15101 | `		}` |
|     35492 | 15102 | `	}` |
|     35487 | 15103 | `cleanup:` |
|         - | 15104 | `	/* Drop the cursor into the token set BEFORE the set is freed (see above). */` |
|     70979 | 15105 | `	pCodeGen->pIn = pSavedIn;` |
|     70979 | 15106 | `	pCodeGen->pEnd = pSavedEnd;` |
|     70979 | 15107 | `	SySetRelease(&aRawToken);` |
|     70979 | 15108 | `	SySetRelease(&aPhpToken);` |
|         - | 15109 | `	/* Restore outer file's strict_types scope */` |
|     70979 | 15110 | `	pCodeGen->bStrictTypes = bSavedStrict;` |
|     70979 | 15111 | `	pCodeGen->bStrictTypesLocked = bSavedStrictLocked;` |
|     70979 | 15112 | `	return rc;` |
|     35492 | 15113 | `}` |
|         - | 15114 | `/*` |
|         - | 15115 | ` * Utility routines.Initialize the code generator.` |
|         - | 15116 | ` */` |
|      3826 | 15117 | `PH7_PRIVATE sxi32 PH7_InitCodeGenerator(` |
|         - | 15118 | `	ph7_vm *pVm,       /* Target VM */` |
|         - | 15119 | `	ProcConsumer xErr, /* Error log consumer callabck  */` |
|         - | 15120 | `	void *pErrData     /* Last argument to xErr() */` |
|         - | 15121 | `	)` |
|         5 | 15122 | `{` |
|      3831 | 15123 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|         - | 15124 | `	/* Zero the structure */` |
|      3831 | 15125 | `	SyZero(pGen,sizeof(ph7_gen_state));` |
|         - | 15126 | `	/* Initial state */` |
|      3831 | 15127 | `	pGen->pVm  = &(*pVm);` |
|      3831 | 15128 | `	pGen->xErr = xErr;` |
|      3831 | 15129 | `	pGen->pErrData = pErrData;` |
|      3831 | 15130 | `	SySetInit(&pGen->aLabel,&pVm->sAllocator,sizeof(Label));` |
|      3831 | 15131 | `	SySetInit(&pGen->aGoto,&pVm->sAllocator,sizeof(JumpFixup));` |
|      3831 | 15132 | `	SySetInit(&pGen->aLoopParent,&pVm->sAllocator,sizeof(sxu32));` |
|      3831 | 15133 | `	pGen->nLoopId = pGen->nCurLoopId = 0;` |
|      3831 | 15134 | `	SySetInit(&pGen->aNullsafeJmp,&pVm->sAllocator,sizeof(sxu32));` |
|      3831 | 15135 | `	SySetInit(&pGen->aTrivia,&pVm->sAllocator,sizeof(ph7_trivia));` |
|      3831 | 15136 | `	SySetInit(&pGen->aPendingAttrs,&pVm->sAllocator,sizeof(ph7_trivia));` |
|      3831 | 15137 | `	SyHashInit(&pGen->hLiteral,&pVm->sAllocator,0,0);` |
|      3831 | 15138 | `	SyHashInit(&pGen->hVar,&pVm->sAllocator,0,0);` |
|         - | 15139 | `	/* Error log buffer */` |
|      3831 | 15140 | `	SyBlobInit(&pGen->sErrBuf,&pVm->sAllocator);` |
|         - | 15141 | `	/* General purpose working buffer */` |
|      3831 | 15142 | `	SyBlobInit(&pGen->sWorker,&pVm->sAllocator);` |
|         - | 15143 | `	/* Namespace state */` |
|      3831 | 15144 | `	SyBlobInit(&pGen->sNamespace,&pVm->sAllocator);` |
|      3831 | 15145 | `	SyHashInit(&pGen->hUseImports,&pVm->sAllocator,0,0);` |
|      3831 | 15146 | `	SyHashInit(&pGen->hUseFuncImports,&pVm->sAllocator,0,0);` |
|      3831 | 15147 | `	SyHashInit(&pGen->hUseConstImports,&pVm->sAllocator,0,0);` |
|         - | 15148 | `	/* Create the global scope */` |
|      3831 | 15149 | `	GenStateInitBlock(pGen,&pGen->sGlobal,GEN_BLOCK_GLOBAL,PH7_VmInstrLength(&(*pVm)),0);` |
|         - | 15150 | `	/* Point to the global scope */` |
|      3831 | 15151 | `	pGen->pCurrent = &pGen->sGlobal;` |
|      3831 | 15152 | `	return SXRET_OK;` |
|         5 | 15153 | `}` |
|         - | 15154 | `/*` |
|         - | 15155 | ` * Utility routines. Reset the code generator to it's initial state.` |
|         - | 15156 | ` */` |
|     74340 | 15157 | `PH7_PRIVATE sxi32 PH7_ResetCodeGenerator(` |
|         - | 15158 | `	ph7_vm *pVm,       /* Target VM */` |
|         - | 15159 | `	ProcConsumer xErr, /* Error log consumer callabck  */` |
|         - | 15160 | `	void *pErrData     /* Last argument to xErr() */` |
|         - | 15161 | `	)` |
|         5 | 15162 | `{` |
|     74345 | 15163 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|         - | 15164 | `	GenBlock *pBlock,*pParent;` |
|         - | 15165 | `	/* Reset state */` |
|     74345 | 15166 | `	SySetReset(&pGen->aLabel);` |
|     74345 | 15167 | `	SySetReset(&pGen->aGoto);` |
|     74345 | 15168 | `	SySetReset(&pGen->aNullsafeJmp);` |
|     74345 | 15169 | `	SySetReset(&pGen->aTrivia);` |
|     74345 | 15170 | `	SySetReset(&pGen->aPendingAttrs);` |
|     74345 | 15171 | `	SyStringInitFromBuf(&pGen->sPendingDoc,0,0);` |
|     74345 | 15172 | `	SyBlobRelease(&pGen->sErrBuf);` |
|     74345 | 15173 | `	SyBlobRelease(&pGen->sWorker);` |
|     74345 | 15174 | `	SyBlobRelease(&pGen->sNamespace);` |
|     74345 | 15175 | `	SyBlobInit(&pGen->sNamespace,&pVm->sAllocator);` |
|     74345 | 15176 | `	SyHashRelease(&pGen->hUseImports);` |
|     74345 | 15177 | `	SyHashInit(&pGen->hUseImports,&pVm->sAllocator,0,0);` |
|     74345 | 15178 | `	SyHashRelease(&pGen->hUseFuncImports);` |
|     74345 | 15179 | `	SyHashInit(&pGen->hUseFuncImports,&pVm->sAllocator,0,0);` |
|     74345 | 15180 | `	SyHashRelease(&pGen->hUseConstImports);` |
|     74345 | 15181 | `	SyHashInit(&pGen->hUseConstImports,&pVm->sAllocator,0,0);` |
...
|     74345 | 15189 | `	pBlock = pGen->pCurrent;` |
|     74345 | 15190 | `	while( pBlock->pParent != 0 ){` |
|       ! 0 | 15191 | `		pParent = pBlock->pParent;` |
|       ! 0 | 15192 | `		GenStateFreeBlock(pBlock);` |
|       ! 0 | 15193 | `		pBlock = pParent;` |
|       ! 0 | 15194 | `	}` |
|     74345 | 15195 | `	pGen->xErr = xErr;` |
|     74345 | 15196 | `	pGen->pErrData = pErrData;` |
|     74345 | 15197 | `	pGen->pCurrent = &pGen->sGlobal;` |
|     74345 | 15198 | `	pGen->pRawIn = pGen->pRawEnd = 0;` |
|     74345 | 15199 | `	pGen->pIn = pGen->pEnd = 0;` |
|     74345 | 15200 | `	pGen->nErr = 0;` |
|     74345 | 15201 | `	return SXRET_OK;` |
|         5 | 15202 | `}` |
|         - | 15203 | `/*` |
...
|         - | 15367 | ` */` |
|     15980 | 15368 | `PH7_PRIVATE sxi32 PH7_GenCompileError(ph7_gen_state *pGen,sxi32 nErrType,sxu32 nLine,const char *zFormat,...)` |
|         5 | 15369 | `{` |
|     15985 | 15370 | `	SyBlob *pWorker = &pGen->sErrBuf;` |
|     15985 | 15371 | `	const char *zErr = "Error";` |
|         - | 15372 | `	SyString *pFile;` |
|         - | 15373 | `	va_list ap;` |
|         - | 15374 | `	sxi32 rc;` |
|         - | 15375 | `	/* Reset the working buffer */` |
|     15985 | 15376 | `	SyBlobReset(pWorker);` |
|         - | 15377 | `	/* Peek the processed file path if available */` |
|     15985 | 15378 | `	pFile = (SyString *)SySetPeek(&pGen->pVm->aFiles);` |
|     15985 | 15379 | `	if( nErrType == E_ERROR \|\| nErrType == E_PARSE ){` |
...
|         - | 15400 | `		}` |
|       325 | 15401 | `	}` |
|     15981 | 15402 | `	if( pGen->xErr == 0 ){` |
|         - | 15403 | `		/* No available error consumer,return immediately */` |
|     15311 | 15404 | `		return SXRET_OK;` |
|         - | 15405 | `	}` |
