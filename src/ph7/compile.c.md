...
|         - |   162 | ` */` |
|  11228132 |   163 | `static void GenStateInitBlock(` |
...
|  11228137 |   172 | `	pBlock->nFirstInstr = nFirstInstr;` |
|  11228137 |   173 | `	pBlock->pUserData   = pUserData;` |
|  11228137 |   174 | `	pBlock->pGen        = pGen;` |
|  11228137 |   175 | `	pBlock->iFlags      = iType;` |
|  11228137 |   176 | `	pBlock->pParent     = 0;` |
|  11228137 |   177 | `	SySetInit(&pBlock->aJumpFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  11228137 |   178 | `	SySetInit(&pBlock->aPostContFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  11228137 |   179 | `}` |
|         - |   180 | `/*` |
...
|         - |   185 | ` */` |
|  11224320 |   186 | `static sxi32 GenStateEnterBlock(` |
...
|  11224325 |   196 | `	pBlock = (GenBlock *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(GenBlock));` |
|  11224325 |   197 | `	if( pBlock == 0 ){` |
...
|  11224325 |   206 | `	SyZero(pBlock,sizeof(GenBlock));` |
|  11224325 |   207 | `	GenStateInitBlock(&(*pGen),pBlock,iType,nFirstInstr,pUserData);` |
|         - |   208 | `	/* Link to the parent block */` |
|  11224325 |   209 | `	pBlock->pParent = pGen->pCurrent;` |
...
|  11224325 |   212 | `	if( iType & (GEN_BLOCK_LOOP\|GEN_BLOCK_SWITCH) ){` |
|    477559 |   213 | `		sxu32 nParent = pGen->nCurLoopId;` |
|    477559 |   214 | `		pGen->nLoopId++;` |
|    477559 |   215 | `		SySetPut(&pGen->aLoopParent,(const void *)&nParent);` |
|    477559 |   216 | `		pBlock->nLoopId = pGen->nLoopId;` |
|    477559 |   217 | `		pBlock->nOuterLoopId = nParent;` |
|    477559 |   218 | `		pGen->nCurLoopId = pGen->nLoopId;` |
|    238777 |   219 | `	}` |
|         - |   220 | `	/* Mark as the current block */` |
|  11224325 |   221 | `	pGen->pCurrent = pBlock;` |
|  11224325 |   222 | `	if( ppBlock ){` |
|         - |   223 | `		/* Write a pointer to the new instance */` |
|   5374463 |   224 | `		*ppBlock = pBlock;` |
|   2687229 |   225 | `	}` |
|  11224325 |   226 | `	return SXRET_OK;` |
|   5612165 |   227 | `}` |
|         - |   228 | `/*` |
|         - |   229 | ` * Release block fields without freeing the whole instance.` |
|         - |   230 | ` */` |
|  11224304 |   231 | `static void GenStateReleaseBlock(GenBlock *pBlock)` |
|         5 |   232 | `{` |
|  11224309 |   233 | `	SySetRelease(&pBlock->aPostContFix);` |
|  11224309 |   234 | `	SySetRelease(&pBlock->aJumpFix);` |
|  11224309 |   235 | `}` |
|         - |   236 | `/*` |
|         - |   237 | ` * Release a block.` |
|         - |   238 | ` */` |
|  11224304 |   239 | `static void GenStateFreeBlock(GenBlock *pBlock)` |
|         5 |   240 | `{` |
|  11224309 |   241 | `	ph7_gen_state *pGen = pBlock->pGen;` |
|  11224309 |   242 | `	GenStateReleaseBlock(&(*pBlock));` |
|         - |   243 | `	/* Free the instance */` |
|  11224309 |   244 | `	SyMemBackendPoolFree(&pGen->pVm->sAllocator,pBlock);` |
|  11224309 |   245 | `}` |
|         - |   246 | `/*` |
|         - |   247 | ` * POP and release a block from the stack of compiled blocks.` |
|         - |   248 | ` */` |
|  11224304 |   249 | `static sxi32 GenStateLeaveBlock(ph7_gen_state *pGen,GenBlock **ppBlock)` |
|         5 |   250 | `{` |
|  11224309 |   251 | `	GenBlock *pBlock = pGen->pCurrent;` |
|  11224309 |   252 | `	if( pBlock == 0 ){` |
|         - |   253 | `		/* No more block to pop */` |
|       ! 0 |   254 | `		return SXERR_EMPTY;` |
|         - |   255 | `	}` |
|  11224309 |   256 | `	if( pBlock->iFlags & (GEN_BLOCK_LOOP\|GEN_BLOCK_SWITCH) ){` |
|    477551 |   257 | `		pGen->nCurLoopId = pBlock->nOuterLoopId;` |
|    238773 |   258 | `	}` |
|         - |   259 | `	/* Point to the upper block */` |
|  11224309 |   260 | `	pGen->pCurrent = pBlock->pParent;` |
|  11224309 |   261 | `	if( ppBlock ){` |
|         - |   262 | `		/* Write a pointer to the popped block */` |
|       ! 0 |   263 | `		*ppBlock = pBlock;` |
|       ! 0 |   264 | `	}else{` |
|         - |   265 | `		/* Safely release the block */` |
|  11224309 |   266 | `		GenStateFreeBlock(&(*pBlock));` |
|         - |   267 | `	}` |
|  11224309 |   268 | `	return SXRET_OK;` |
|   5612157 |   269 | `}` |
|         - |   270 | `/*` |
...
|         - |   279 | ` */` |
|   4253110 |   280 | `static sxi32 GenStateNewJumpFixup(GenBlock *pBlock,sxi32 nJumpType,sxu32 nInstrIdx)` |
|         5 |   281 | `{` |
|         - |   282 | `	JumpFixup sJumpFix;` |
|         - |   283 | `	sxi32 rc;` |
|         - |   284 | `	/* Init the JumpFixup structure */` |
|   4253115 |   285 | `	sJumpFix.nJumpType = nJumpType;` |
|   4253115 |   286 | `	sJumpFix.nInstrIdx = nInstrIdx;` |
|         - |   287 | `	/* Insert in the jump fixup table */` |
|   4253115 |   288 | `	rc = SySetPut(&pBlock->aJumpFix,(const void *)&sJumpFix);` |
|   4253115 |   289 | `	return rc;` |
|         5 |   290 | `}` |
|         - |   291 | `/*` |
...
|         - |   301 | ` */` |
|   7864564 |   302 | `static sxu32 GenStateFixJumps(GenBlock *pBlock,sxi32 nJumpType,sxu32 nJumpDest)` |
|         5 |   303 | `{` |
|         - |   304 | `	JumpFixup *aFix;` |
|         - |   305 | `	VmInstr *pInstr;` |
|         - |   306 | `	sxu32 nFixed;` |
...
|   7864569 |   309 | `	aFix = (JumpFixup *)SySetBasePtr(&pBlock->aJumpFix);` |
|         - |   310 | `	/* Fix the desired jumps */` |
|  16948165 |   311 | `	for( nFixed = n = 0 ; n < SySetUsed(&pBlock->aJumpFix) ; ++n ){` |
|   9083601 |   312 | `		if( aFix[n].nJumpType < 0 ){` |
|         - |   313 | `			/* Already fixed */` |
|   3392525 |   314 | `			continue;` |
|         - |   315 | `		}` |
|   5691081 |   316 | `		if( nJumpType > 0 && aFix[n].nJumpType != nJumpType ){` |
|         - |   317 | `			/* Not of our interest */` |
|   1437973 |   318 | `			continue;` |
|         - |   319 | `		}` |
|         - |   320 | `		/* Point to the instruction to fix */` |
|   4253113 |   321 | `		pInstr = PH7_VmGetInstr(pBlock->pGen->pVm,aFix[n].nInstrIdx);` |
|   4253113 |   322 | `		if( pInstr ){` |
|   4253113 |   323 | `			pInstr->iP2 = nJumpDest;` |
|   4253113 |   324 | `			nFixed++;` |
|         - |   325 | `			/* Mark as fixed */` |
|   4253113 |   326 | `			aFix[n].nJumpType = -1;` |
|   2126554 |   327 | `		}` |
|   2126559 |   328 | `	}` |
|         - |   329 | `	/* Total number of fixed jumps */` |
|   7864569 |   330 | `	return nFixed;` |
|         5 |   331 | `}` |
|         - |   332 | `/*` |
...
|         - |   338 | ` */` |
|   2762334 |   339 | `static sxi32 GenStateFixGoto(ph7_gen_state *pGen,sxu32 nOfft)` |
|         5 |   340 | `{` |
...
|   2762339 |   347 | `	aJumps = (JumpFixup *)SySetBasePtr(&pGen->aGoto);` |
|         - |   348 | `	/* Fix */` |
|   2762485 |   349 | `	for( n = nOfft ; n < SySetUsed(&pGen->aGoto) ; ++n ){` |
...
|   2762337 |   400 | `	return SXRET_OK;` |
|   1381172 |   401 | `}` |
|         - |   402 | `/*` |
|         - |   403 | ` * Check if a given token value is installed in the literal table.` |
|         - |   404 | ` */` |
|  14216902 |   405 | `static sxi32 GenStateFindLiteral(ph7_gen_state *pGen,const SyString *pValue,sxu32 *pIdx)` |
|         5 |   406 | `{` |
|         - |   407 | `	SyHashEntry *pEntry;` |
|  14216907 |   408 | `	pEntry = SyHashGet(&pGen->hLiteral,(const void *)pValue->zString,pValue->nByte);` |
|  14216907 |   409 | `	if( pEntry == 0 ){` |
|   3674085 |   410 | `		return SXERR_NOTFOUND;` |
|         - |   411 | `	}` |
|  10542827 |   412 | `	*pIdx = (sxu32)SX_PTR_TO_INT(pEntry->pUserData);` |
|  10542827 |   413 | `	return SXRET_OK;` |
|   7108456 |   414 | `}` |
|         - |   415 | `/*` |
...
|         - |   424 | ` */` |
|   3674080 |   425 | `static sxi32 GenStateInstallLiteral(ph7_gen_state *pGen,ph7_value *pObj,sxu32 nIdx)` |
|         5 |   426 | `{` |
|   3674085 |   427 | `	if( SyBlobLength(&pObj->sBlob) > 0 ){` |
|   3674085 |   428 | `		SyHashInsert(&pGen->hLiteral,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob),SX_INT_TO_PTR(nIdx));` |
|   1837040 |   429 | `	}` |
|   3674085 |   430 | `	return SXRET_OK;` |
|         5 |   431 | `}` |
|         - |   432 | `/*` |
|         - |   433 | ` * Reserve a room for a numeric constant [i.e: 64-bit integer or real number]` |
|         - |   434 | ` * in the constant table.` |
|         - |   435 | ` */` |
|   3343128 |   436 | `static ph7_value * GenStateInstallNumLiteral(ph7_gen_state *pGen,sxu32 *pIdx)` |
|         5 |   437 | `{` |
|         - |   438 | `	ph7_value *pObj;` |
|   3343133 |   439 | `	sxu32 nIdx = 0; /* cc warning */` |
|         - |   440 | `	/* Reserve a new constant */` |
|   3343133 |   441 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   3343133 |   442 | `	if( pObj == 0 ){` |
|       ! 0 |   443 | `		PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|       ! 0 |   444 | `		return 0;` |
|         - |   445 | `	}` |
|   3343133 |   446 | `	*pIdx = nIdx;` |
|         - |   447 | `	/* TODO(chems): Create a numeric table (64bit int keys) same as` |
|         - |   448 | `	 * the constant string iterals table [optimization purposes].` |
|         - |   449 | `	 */` |
|   3343133 |   450 | `	return pObj;` |
|   1671569 |   451 | `}` |
|         - |   452 | `/*` |
...
|         - |   465 | ` */` |
|   6791426 |   466 | `static void *GenStateAttachStrictFlag(ph7_gen_state *pGen, void *p3)` |
|         5 |   467 | `{` |
|         - |   468 | `	VmCallArgMap *pMap;` |
|   6791431 |   469 | `	if( !pGen->bStrictTypes ) return p3;` |
|        39 |   470 | `	if( p3 == 0 ){` |
...
|         - |   541 | ` */` |
|   3351772 |   542 | `static int GenStateFindBadNumericSeparator(` |
|         - |   543 | `	const SyString *pRaw, const char **pBadStart, sxu32 *pBadLen)` |
|         5 |   544 | `{` |
|   3351777 |   545 | `	const char *z = pRaw->zString;` |
|   3351777 |   546 | `	sxu32 n = pRaw->nByte;` |
|   3351777 |   547 | `	int base = 10;` |
|         - |   548 | `	sxu32 i, start;` |
|   3351777 |   549 | `	if( n < 2 ) return 0;` |
|    736263 |   550 | `	if( z[0] == '0' && (z[1] == 'x' \|\| z[1] == 'X') ){` |
|    103019 |   551 | `		base = 16;` |
|    684756 |   552 | `	}else if( z[0] == '0' && (z[1] == 'b' \|\| z[1] == 'B') ){` |
|       284 |   553 | `		base = 2;` |
|       141 |   554 | `	}` |
|   2774447 |   555 | `	for( i = 0; i < n; ++i ){` |
|   2038203 |   556 | `		if( z[i] != '_' ) continue;` |
...
|         - |   582 | ` */` |
|   3351772 |   583 | `static sxi32 GenStateValidateNumericSeparator(ph7_gen_state *pGen, SyToken *pToken)` |
|         5 |   584 | `{` |
|   3351777 |   585 | `	const char *zBad = 0;` |
|   3351777 |   586 | `	sxu32 nBad = 0;` |
|         - |   587 | `	SyString sBad;` |
|         - |   588 | `	sxi32 rc;` |
|   3351777 |   589 | `	if( !GenStateFindBadNumericSeparator(&pToken->sData, &zBad, &nBad) ){` |
|   3351763 |   590 | `		return SXRET_OK;` |
|         - |   591 | `	}` |
...
|         - |   615 | ` */` |
|   3351758 |   616 | `static sxi32 GenStateStripNumericSeparators(` |
...
|         5 |   621 | `{` |
|         - |   622 | `	sxu32 i, j;` |
|   3351763 |   623 | `	int hasUnderscore = 0;` |
|         - |   624 | `	char *zBuf;` |
|   3351763 |   625 | `	*pzAlloc = 0;` |
|   8003395 |   626 | `	for( i = 0; i < pToken->nByte; ++i ){` |
|   4651889 |   627 | `		if( pToken->zString[i] == '_' ){ hasUnderscore = 1; break; }` |
|   2325821 |   628 | `	}` |
|   3351763 |   629 | `	if( !hasUnderscore ){` |
|   3351511 |   630 | `		SyStringDupPtr(pOut, pToken);` |
|   3351511 |   631 | `		return SXRET_OK;` |
|         - |   632 | `	}` |
...
|         - |   683 | ` */` |
|   3343162 |   684 | `static int GenStateIntLiteralOverflows(const SyString *pNum, ph7_real *pReal, int *pbDecimal)` |
|         5 |   685 | `{` |
|   3343167 |   686 | `	const char *z = pNum->zString;` |
|   3343167 |   687 | `	const char *zEnd = z + pNum->nByte;` |
|         - |   688 | `	const char *p, *q;` |
|         - |   689 | `	int n;` |
|   3343167 |   690 | `	*pbDecimal = FALSE;` |
|   3343167 |   691 | `	if( z >= zEnd ){` |
|       ! 0 |   692 | `		return FALSE;` |
|         - |   693 | `	}` |
|   3343167 |   694 | `	if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'x' \|\| z[1] == 'X') ){` |
...
|         - |   707 | `		}` |
|         7 |   708 | `		return TRUE;` |
|   3240155 |   709 | `	}else if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'b' \|\| z[1] == 'B') ){` |
...
|   1206921 |   728 | `		p = z;` |
|   2413839 |   729 | `		while( p < zEnd && p[0] == '0' ){ p++; }` |
|   1218609 |   730 | `		for( q = p, n = 0; q < zEnd && q[0] >= '0' && q[0] <= '7'; q++ ){ n++; }` |
|   1206921 |   731 | `		if( n <= 21 ){` |
|   1206919 |   732 | `			return FALSE;` |
|         - |   733 | `		}` |
|         3 |   734 | `		{ ph7_real dv = 0;` |
...
|   2032959 |   745 | `	p = z;` |
|   2032959 |   746 | `	while( p < zEnd && p[0] == '0' ){ p++; }` |
|   4887719 |   747 | `	for( q = p, n = 0; q < zEnd && (unsigned char)q[0] < 0xc0 && SyisDigit(q[0]); q++ ){ n++; }` |
|   2032959 |   748 | `	if( n > 19 \|\| (n == 19 && SyMemcmp(p, "9223372036854775807", 19) > 0) ){` |
|        25 |   749 | `		*pbDecimal = TRUE;` |
|        25 |   750 | `		return TRUE;` |
|         - |   751 | `	}` |
|   2032935 |   752 | `	return FALSE;` |
|   1671586 |   753 | `}` |
|   3351744 |   754 | `static sxi32 PH7_CompileNumLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|         5 |   755 | `{` |
|   3351749 |   756 | `	SyToken *pToken = pGen->pIn; /* Raw token */` |
|   3351749 |   757 | `	sxu32 nIdx = 0;` |
|         - |   758 | `	char zScratch[GEN_NUM_SCRATCH];` |
|   3351749 |   759 | `	char *zAlloc = 0;` |
|         - |   760 | `	SyString sNum;` |
|         - |   761 | `	sxi32 rc;` |
|   1675872 |   762 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|   3351749 |   763 | `	rc = GenStateValidateNumericSeparator(pGen, pToken);` |
|   3351749 |   764 | `	if( rc != SXRET_OK ){` |
|        14 |   765 | `		return rc;` |
|         - |   766 | `	}` |
|   5027606 |   767 | `	rc = GenStateStripNumericSeparators(&pGen->pVm->sAllocator, &pToken->sData,` |
|   1675867 |   768 | `		zScratch, sizeof(zScratch), &sNum, &zAlloc);` |
|   3351739 |   769 | `	if( rc != SXRET_OK ){` |
|       ! 0 |   770 | `		return SXERR_ABORT;` |
|         - |   771 | `	}` |
|   3351739 |   772 | `	if( pToken->nType & PH7_TK_INTEGER ){` |
|         - |   773 | `		ph7_value *pObj;` |
|         - |   774 | `		sxi64 iValue;` |
|   3343167 |   775 | `		ph7_real rOverflow = 0;` |
|   3343167 |   776 | `		int bDecimalOverflow = 0;` |
|   3343167 |   777 | `		if( GenStateIntLiteralOverflows(&sNum,&rOverflow,&bDecimalOverflow) ){` |
...
|         - |   792 | `			}` |
|        18 |   793 | `		}else{` |
|   3343133 |   794 | `			iValue = PH7_TokenValueToInt64(&sNum);` |
|   3343133 |   795 | `			pObj = GenStateInstallNumLiteral(&(*pGen),&nIdx);` |
|   3343133 |   796 | `			if( pObj == 0 ){` |
|       ! 0 |   797 | `				if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|       ! 0 |   798 | `				return SXERR_ABORT;` |
|         - |   799 | `			}` |
|   3343133 |   800 | `			PH7_MemObjInitFromInt(pGen->pVm,pObj,iValue);` |
|         - |   801 | `		}` |
|   1671586 |   802 | `	}else{` |
|         - |   803 | `		/* Real number */` |
|         - |   804 | `		ph7_value *pObj;` |
|         - |   805 | `		/* Reserve a new constant */` |
|      8577 |   806 | `		pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|      8577 |   807 | `		if( pObj == 0 ){` |
...
|         - |   811 | `		}` |
|      8577 |   812 | `		PH7_MemObjInitFromString(pGen->pVm,pObj,&sNum);` |
|      8577 |   813 | `		PH7_MemObjToReal(pObj);` |
|         - |   814 | `	}` |
|   3351739 |   815 | `	if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|         - |   816 | `	/* Emit the load constant instruction */` |
|   3351739 |   817 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|         - |   818 | `	/* Node successfully compiled */` |
|   3351739 |   819 | `	return SXRET_OK;` |
|   1675877 |   820 | `}` |
|         - |   821 | `/*` |
...
|         - |   830 | ` *` |
|         - |   831 | ` */` |
|   4789148 |   832 | `PH7_PRIVATE sxi32 PH7_CompileSimpleString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|         5 |   833 | `{` |
|   4789153 |   834 | `	SyString *pStr = &pGen->pIn->sData; /* Constant string literal */` |
|         - |   835 | `	const char *zIn,*zCur,*zEnd;` |
|         - |   836 | `	ph7_value *pObj;` |
|         - |   837 | `	sxu32 nIdx;` |
|   4789153 |   838 | `	nIdx = 0; /* Prevent compiler warning */` |
|         - |   839 | `	/* Delimit the string */` |
|   4789153 |   840 | `	zIn  = pStr->zString;` |
|   4789153 |   841 | `	zEnd = &zIn[pStr->nByte];` |
|   4789153 |   842 | `	if( zIn >= zEnd ){` |
|         - |   843 | `		/* Empty string constant: just use the pre‑allocated index from the VM` |
|         - |   844 | `		 * rather than reserving a new object each time. */` |
|    301367 |   845 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,pGen->pVm->nEmptyStringIdx,0,0);` |
|    301367 |   846 | `		return SXRET_OK;` |
|         - |   847 | `	}` |
|   4487791 |   848 | `	if( SXRET_OK == GenStateFindLiteral(&(*pGen),pStr,&nIdx) ){` |
|         - |   849 | `		/* Already processed,emit the load constant instruction` |
|         - |   850 | `		 * and return.` |
|         - |   851 | `		 */` |
|   2680455 |   852 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   2680455 |   853 | `		return SXRET_OK;` |
|         - |   854 | `	}` |
...
|  39725871 |   870 | `		while( zIn < zEnd && zIn[0] != '\\' ){` |
|  37823111 |   871 | `			zIn++;` |
|         5 |   872 | `		}` |
...
|         - |  1103 | ` */` |
|    120660 |  1104 | `static ph7_value * GenStateNewStrObj(ph7_gen_state *pGen,sxi32 *pCount)` |
|         5 |  1105 | `{` |
|         - |  1106 | `	ph7_value *pConstObj;` |
|    120665 |  1107 | `	sxu32 nIdx = 0;` |
|         - |  1108 | `	/* Reserve a new constant */` |
|    120665 |  1109 | `	pConstObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|    120665 |  1110 | `	if( pConstObj == 0 ){` |
|       ! 0 |  1111 | `		PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"PH7 engine is running out of memory");` |
|       ! 0 |  1112 | `		return 0;` |
|         - |  1113 | `	}` |
|    120665 |  1114 | `	(*pCount)++;` |
|    120665 |  1115 | `	PH7_MemObjInitFromString(pGen->pVm,pConstObj,0);` |
|         - |  1116 | `	/* Emit the load constant instruction */` |
|    120665 |  1117 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|    120665 |  1118 | `	return pConstObj;` |
|     60335 |  1119 | `}` |
|         - |  1120 | `/*` |
...
|    119106 |  1182 | `static sxi32 GenStateCompileString(ph7_gen_state *pGen,int bHeredoc)` |
|         5 |  1183 | `{` |
|    119111 |  1184 | `	SyString *pStr = &pGen->pIn->sData; /* Raw token value */` |
|         - |  1185 | `	const char *zIn,*zCur,*zEnd;` |
|    119111 |  1186 | `	ph7_value *pObj = 0;` |
|         - |  1187 | `	sxi32 iCons;` |
|         - |  1188 | `	sxi32 rc;` |
|         - |  1189 | `	/* Delimit the string */` |
|    119111 |  1190 | `	zIn  = pStr->zString;` |
|    119111 |  1191 | `	zEnd = &zIn[pStr->nByte];` |
|    119111 |  1192 | `	if( zIn >= zEnd ){` |
...
|    118707 |  1202 | `	iCons = 0;` |
|     60646 |  1203 | `	for(;;){` |
|    161473 |  1204 | `		zCur = zIn;` |
|   1648831 |  1205 | `		while( zIn < zEnd && zIn[0] != '\\'  ){` |
|   1489957 |  1206 | `			if( zIn[0] == '{' && &zIn[1] < zEnd && zIn[1] == '$' ){` |
|        68 |  1207 | `				break;` |
|   1489832 |  1208 | `			}else if(zIn[0] == '$' && &zIn[1] < zEnd &&` |
|      2474 |  1209 | `				(((unsigned char)zIn[1] >= 0xc0 \|\| SyisAlpha(zIn[1]) \|\| zIn[1] == '{' \|\| zIn[1] == '_')) ){` |
|      1237 |  1210 | `					break;` |
|         - |  1211 | `			}` |
|   1487363 |  1212 | `			zIn++;` |
|         5 |  1213 | `		}` |
|    161473 |  1214 | `		if( zIn > zCur ){` |
|     94137 |  1215 | `			if( pObj == 0 ){` |
|     93527 |  1216 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|     93527 |  1217 | `				if( pObj == 0 ){` |
|       ! 0 |  1218 | `					return SXERR_ABORT;` |
|         - |  1219 | `				}` |
|     46761 |  1220 | `			}` |
|     94137 |  1221 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|     47066 |  1222 | `		}` |
|    161473 |  1223 | `		if( zIn >= zEnd ){` |
|    118705 |  1224 | `			break;` |
|         - |  1225 | `		}` |
|     42773 |  1226 | `		if( zIn[0] == '\\' ){` |
|     40179 |  1227 | `			const char *zPtr = 0;` |
|         - |  1228 | `			sxu32 n;` |
|     40179 |  1229 | `			zIn++;` |
|     40179 |  1230 | `			if( pObj == 0 ){` |
|     27143 |  1231 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|     27143 |  1232 | `				if( pObj == 0 ){` |
|       ! 0 |  1233 | `					return SXERR_ABORT;` |
|         - |  1234 | `				}` |
|     13569 |  1235 | `			}` |
|     40179 |  1236 | `			if( zIn >= zEnd ){` |
|         - |  1237 | `				/* Lone backslash at the very end of the body: php keeps it */` |
|         3 |  1238 | `				PH7_MemObjStringAppend(pObj,"\\",sizeof(char));` |
|         3 |  1239 | `				break;` |
|         - |  1240 | `			}` |
|     40177 |  1241 | `			n = sizeof(char); /* size of conversion */` |
|     40177 |  1242 | `			switch( zIn[0] ){` |
|        13 |  1243 | `			case '$':` |
|         - |  1244 | `				/* Dollar sign */` |
...
|     35023 |  1261 | `				PH7_MemObjStringAppend(pObj,"\n",sizeof(char));` |
|     35023 |  1262 | `				break;` |
|        27 |  1263 | `			case 'r':` |
...
|    118707 |  1598 | `	return SXRET_OK;` |
|     59558 |  1599 | `}` |
|         - |  1600 | `/*` |
|         - |  1601 | ` * Compile a double quoted string.` |
|         - |  1602 | ` *  See the block-comment above for more information.` |
|         - |  1603 | ` */` |
|    119044 |  1604 | `PH7_PRIVATE sxi32 PH7_CompileString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|         5 |  1605 | `{` |
|         - |  1606 | `	sxi32 rc;` |
|    119049 |  1607 | `	rc = GenStateCompileString(&(*pGen),0/*bHeredoc*/);` |
|     59522 |  1608 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|         - |  1609 | `	/* Compilation result */` |
|    119049 |  1610 | `	return rc;` |
|         5 |  1611 | `}` |
|         - |  1612 | `/*` |
...
|         - |  1653 | ` */` |
|   1199648 |  1654 | `static sxi32 GenStateCompileArrayEntry(` |
...
|   1199653 |  1665 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|         - |  1666 | `	/* Compile the expression*/` |
|   1199653 |  1667 | `	rc = PH7_CompileExpr(&(*pGen),iFlags,xValidator);` |
|         - |  1668 | `	/* Restore token stream */` |
|   1199653 |  1669 | `	RE_SWAP_DELIMITER(pGen);` |
|   1199653 |  1670 | `	return rc;` |
|         5 |  1671 | `}` |
|         - |  1672 | `/*` |
...
|         - |  1708 | ` */` |
|   1217438 |  1709 | `static SyToken * GenStateFindTopLevelArrow(SyToken *pStart,SyToken *pEnd)` |
|         5 |  1710 | `{` |
|   1217443 |  1711 | `	SyToken *pCur = pStart;` |
|   1217443 |  1712 | `	sxi32 iNest = 0;` |
|   3223819 |  1713 | `	while( pCur < pEnd ){` |
|   2416637 |  1714 | `		if( (pCur->nType & PH7_TK_ARRAY_OP) && iNest <= 0 ){` |
|    410257 |  1715 | `			return pCur;` |
|         - |  1716 | `		}` |
...
|         - |  1720 | `		 */` |
|   2006385 |  1721 | `		if( iNest == 0 && (pCur->nType & PH7_TK_KEYWORD) ){` |
...
|         - |  1780 | `			}` |
|     11484 |  1781 | `		}` |
|   2006379 |  1782 | `		if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|     53899 |  1783 | `			iNest++;` |
|   1979432 |  1784 | `		}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}'*/) ){` |
...
|         - |  1797 | ` */` |
|    587168 |  1798 | `static sxi32 GenStateCompileArrayBody(ph7_gen_state *pGen)` |
|         5 |  1799 | `{` |
|         - |  1800 | `	sxi32 (*xValidator)(ph7_gen_state *,ph7_expr_node *); /* Expression tree validator callback */` |
|         - |  1801 | `	SyToken *pKey,*pCur;` |
|    587173 |  1802 | `	sxi32 iEmitRef = 0;` |
|    587173 |  1803 | `	sxi32 iSpread = 0;` |
|    587173 |  1804 | `	sxi32 nPair = 0;` |
|         - |  1805 | `	sxi32 rc;` |
|    587173 |  1806 | `	xValidator = 0;` |
|    753128 |  1807 | `	for(;;){` |
...
|    459544 |  1812 | `		{` |
|   1506261 |  1813 | `			int nSkip = 0;` |
|   2189535 |  1814 | `			while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA) ){` |
|    683279 |  1815 | `				nSkip++;` |
|    683279 |  1816 | `				pGen->pIn++;` |
|         5 |  1817 | `			}` |
|   1506261 |  1818 | `			if( nSkip > 1 \|\| (nSkip > 0 && nPair < 1) ){` |
...
|         - |  1825 | `			}` |
|         - |  1826 | `		}` |
|   1506261 |  1827 | `		pCur = pGen->pIn;` |
|   1506261 |  1828 | `		if( SXRET_OK != PH7_GetNextExpr(pGen->pIn,pGen->pEnd,&pGen->pIn) ){` |
|         - |  1829 | `			/* No more entry to process */` |
|    587155 |  1830 | `			break;` |
|         - |  1831 | `		}` |
|    919111 |  1832 | `		if( pCur >= pGen->pIn ){` |
|       ! 0 |  1833 | `			continue;` |
|         - |  1834 | `		}` |
|         - |  1835 | `		/* Compile the key if available */` |
|    919111 |  1836 | `		pKey = pCur;` |
|    919111 |  1837 | `		pCur = GenStateFindTopLevelArrow(pCur,pGen->pIn);` |
|    919111 |  1838 | `		rc = SXERR_EMPTY;` |
|    919111 |  1839 | `		if( pCur < pGen->pIn ){` |
|    280293 |  1840 | `			if( pKey == pCur ){` |
...
|         - |  1853 | `			}` |
|    280291 |  1854 | `			if( &pCur[1] >= pGen->pIn ){` |
...
|    280281 |  1865 | `			rc = GenStateCompileArrayEntry(&(*pGen),pKey,pCur,` |
|         - |  1866 | `				EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,0);` |
|    280281 |  1867 | `			if( rc == SXERR_ABORT ){` |
|       ! 0 |  1868 | `				return SXERR_ABORT;` |
|         - |  1869 | `			}` |
|    280281 |  1870 | `			pCur++; /* Jump the '=>' operator */` |
|    140143 |  1871 | `		}else{` |
|         - |  1872 | `			/* Reset back the cursor and point to the entry value */` |
|    638823 |  1873 | `			pCur = pKey;` |
|         - |  1874 | `		}` |
|    919099 |  1875 | `		if( rc == SXERR_EMPTY ){` |
...
|    638823 |  1878 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,PH7_LOADC_NOKEY,0 /* nil index */,0,0);` |
|    319409 |  1879 | `		}` |
|    919099 |  1880 | `		if( pCur->nType & PH7_TK_AMPER /*'&'*/){` |
...
|    919097 |  1899 | `		iSpread = (pCur < pGen->pIn && (pCur->nType & PH7_TK_ELLIPSIS)) ? 1 : 0;` |
|    919097 |  1900 | `		if( iSpread && (rc != SXERR_EMPTY \|\| iEmitRef) ){` |
...
|   1378637 |  1917 | `		rc = GenStateCompileArrayEntry(&(*pGen),pCur,pGen->pIn,` |
|    459544 |  1918 | `			iEmitRef ? EXPR_FLAG_LOAD_IDX_STORE` |
|         - |  1919 | `			         : EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,` |
|    459544 |  1920 | `			xValidator);` |
|    919093 |  1921 | `		if( rc == SXERR_ABORT ){` |
|       ! 0 |  1922 | `			return SXERR_ABORT;` |
|         - |  1923 | `		}` |
|    919093 |  1924 | `		if( iSpread ){` |
...
|    919060 |  1927 | `		}else if( iEmitRef ){` |
|         - |  1928 | `			/* Emit the load reference instruction */` |
|        41 |  1929 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_REF,0,0,0,0);` |
|        18 |  1930 | `		}` |
|    919093 |  1931 | `		xValidator = 0;` |
|    919093 |  1932 | `		iEmitRef = 0;` |
|    919093 |  1933 | `		iSpread = 0;` |
|    919093 |  1934 | `		nPair++;` |
|         5 |  1935 | `	}` |
|         - |  1936 | `	/* Emit the load map instruction */` |
|    587155 |  1937 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_MAP,nPair * 2,0,0,0);` |
|         - |  1938 | `	/* Node successfully compiled */` |
|    587155 |  1939 | `	return SXRET_OK;` |
|    293589 |  1940 | `}` |
|         - |  1941 | `/*` |
...
|         - |  1949 | ` */` |
|    371612 |  1950 | `PH7_PRIVATE sxi32 PH7_CompileArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|         5 |  1951 | `{` |
|         - |  1952 | `	/* Jump the 'array' keyword and the leading '(', exclude trailing ')'. */` |
|    371617 |  1953 | `	pGen->pIn += 2;` |
|    371617 |  1954 | `	pGen->pEnd--;` |
|    185806 |  1955 | `	SXUNUSED(iCompileFlag);` |
|    371617 |  1956 | `	return GenStateCompileArrayBody(pGen);` |
|         5 |  1957 | `}` |
|         - |  1958 | `/*` |
...
|         - |  2054 | ` */` |
|    215556 |  2055 | `PH7_PRIVATE sxi32 PH7_CompileShortArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|         5 |  2056 | `{` |
|         - |  2057 | `	/* Jump the leading '[', exclude trailing ']'. */` |
|    215561 |  2058 | `	pGen->pIn++;` |
|    215561 |  2059 | `	pGen->pEnd--;` |
|    107778 |  2060 | `	SXUNUSED(iCompileFlag);` |
|    215561 |  2061 | `	return GenStateCompileArrayBody(pGen);` |
|         5 |  2062 | `}` |
|         - |  2063 | `/*` |
...
|         - |  2401 | ` */` |
|       564 |  2402 | `PH7_PRIVATE sxi32 PH7_CompileAnnonFunc(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|         5 |  2403 | `{` |
|       569 |  2404 | `	ph7_vm_func *pAnnonFunc = 0; /* Annonymous function body */` |
...
|         - |  2408 | `						      */` |
|         - |  2409 | `	SyString sName;` |
|       569 |  2410 | ``	SyToken *pTokKw = pGen->pIn; /* Attribute-sidecar key: `$f = #[A] function…` trivia`` |
|         - |  2411 | `	                              * is keyed to this ['static'] 'function' token */` |
|         - |  2412 | `	sxu32 nKwLine;` |
|       569 |  2413 | `	sxi32 iFlags = 0;` |
|         - |  2414 | `	sxu32 nLen;` |
|         - |  2415 | `	sxi32 rc;` |
|       282 |  2416 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|         - |  2417 |  |
|       569 |  2418 | `	nKwLine = pGen->pIn->nLine; /* Line of the 'function' keyword (Reflection getStartLine) */` |
|       564 |  2419 | `	if( (pGen->pIn->nType & PH7_TK_KEYWORD)` |
|       569 |  2420 | `		&& SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_STATIC ){` |
...
|         4 |  2424 | `	}` |
|       569 |  2425 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|       569 |  2426 | `	if( pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD) ){` |
|       ! 0 |  2427 | `		pGen->pIn++;` |
|       ! 0 |  2428 | `	}` |
|         - |  2429 | `	/* Generate a unique name */` |
|       569 |  2430 | `	nLen = SyBufferFormat(zName,sizeof(zName),"[lambda_%d]",iCnt++);` |
|         - |  2431 | `	/* Make sure the generated name is unique */` |
|       569 |  2432 | `	while( SyHashGet(&pGen->pVm->hFunction,zName,nLen) != 0 && nLen < sizeof(zName) - 2 ){` |
|       ! 0 |  2433 | `		nLen = SyBufferFormat(zName,sizeof(zName),"[lambda_%d]",iCnt++);` |
|       ! 0 |  2434 | `	}` |
|       569 |  2435 | `	SyStringInitFromBuf(&sName,zName,nLen);` |
|         - |  2436 | `	/* Compile the lambda body */` |
|       569 |  2437 | `	rc = GenStateCompileFunc(&(*pGen),&sName,iFlags,TRUE,&pAnnonFunc);` |
|       569 |  2438 | `	if( rc == SXERR_ABORT ){` |
|       ! 0 |  2439 | `		return SXERR_ABORT;` |
|         - |  2440 | `	}` |
|       569 |  2441 | `	if( pAnnonFunc ){` |
|       569 |  2442 | `		pAnnonFunc->nLine = nKwLine;` |
|         - |  2443 | ``		/* Expression-position attributes (`$f = #[A] function () {}`): the trivia`` |
|         - |  2444 | `		 * sidecar keys them to the closure's first keyword token. */` |
|       569 |  2445 | `		if( GenStateCollectParamAttrs(&(*pGen),pTokKw,&pAnnonFunc->aAttrs) == SXERR_ABORT ){` |
...
|       569 |  2452 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_CLOSURE,0,0,pAnnonFunc,0);` |
|         - |  2453 | `	/* Node successfully compiled */` |
|       569 |  2454 | `	return SXRET_OK;` |
|       287 |  2455 | `}` |
|         - |  2456 | `/*` |
...
|         - |  3360 | ` */` |
|  18544924 |  3361 | `PH7_PRIVATE sxi32 PH7_CompileVariable(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|         5 |  3362 | `{` |
|  18544929 |  3363 | `	sxu32 nLineLocal = pGen->pIn->nLine;` |
|         - |  3364 | `	sxi32 iVv;` |
|         - |  3365 | `	sxi32 iP1;` |
|         - |  3366 | `	void *p3;` |
|         - |  3367 | `	sxi32 rc;` |
|  18544929 |  3368 | `	iVv = -1; /* Variable variable counter */` |
|  37089865 |  3369 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) ){` |
|  18544941 |  3370 | `		pGen->pIn++;` |
|  18544941 |  3371 | `		iVv++;` |
|         5 |  3372 | `	}` |
|  18544929 |  3373 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_OCB/*'{'*/)) == 0 ){` |
...
|         - |  3381 | `	}` |
|  18544929 |  3382 | `	p3  = 0;` |
|  18544929 |  3383 | `	if( pGen->pIn->nType & PH7_TK_OCB/*'{'*/ ){` |
...
|         - |  3408 | `		SyString *pName;` |
|  18544913 |  3409 | `		char *zName = 0;` |
|         - |  3410 | `		/* Extract variable name */` |
|  18544913 |  3411 | `		pName = &pGen->pIn->sData;` |
|         - |  3412 | `		/* Advance the stream cursor */` |
|  18544913 |  3413 | `		pGen->pIn++;` |
|  18544913 |  3414 | `		pEntry = SyHashGet(&pGen->hVar,(const void *)pName->zString,pName->nByte);` |
|  18544913 |  3415 | `		if( pEntry == 0 ){` |
|         - |  3416 | `			/* Duplicate name */` |
|   1085417 |  3417 | `			zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|   1085417 |  3418 | `			if( zName == 0 ){` |
...
|   1085417 |  3423 | `			SyHashInsert(&pGen->hVar,zName,pName->nByte,zName);` |
|    542711 |  3424 | `		}else{` |
|         - |  3425 | `			/* Name already available */` |
|  17459501 |  3426 | `			zName = (char *)pEntry->pUserData;` |
|         - |  3427 | `		}` |
|  18544913 |  3428 | `		p3 = (void *)zName;` |
|         - |  3429 | `	}` |
|  18544925 |  3430 | `	iP1 = 0;` |
|  18544925 |  3431 | `	if( iCompileFlag & EXPR_FLAG_RDONLY_LOAD ){` |
|   5536567 |  3432 | `		if( (iCompileFlag & EXPR_FLAG_LOAD_IDX_STORE) == 0 ){` |
|         - |  3433 | `			/* Read-only load.In other words do not create the variable if inexistant */` |
|   5532731 |  3434 | `			iP1 = 1;` |
|   2766363 |  3435 | `		}` |
|   2768281 |  3436 | `	}` |
|         - |  3437 | `	/* Emit the load instruction */` |
|  18544925 |  3438 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,0,p3,0);` |
|  18544937 |  3439 | `	while( iVv > 0 ){` |
|        13 |  3440 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,0,0,0);` |
|        13 |  3441 | `		iVv--;` |
|         1 |  3442 | `	}` |
|         - |  3443 | `	/* Node successfully compiled */` |
|  18544925 |  3444 | `	return SXRET_OK;` |
|   9272467 |  3445 | `}` |
|         - |  3446 | `/*` |
|         - |  3447 | ` * Load a literal.` |
|         - |  3448 | ` */` |
|  11657590 |  3449 | `static sxi32 GenStateLoadLiteral(ph7_gen_state *pGen)` |
|         5 |  3450 | `{` |
|  11657595 |  3451 | `	SyToken *pToken = pGen->pIn;` |
|         - |  3452 | `	ph7_value *pObj;` |
|         - |  3453 | `	SyString *pStr;` |
|         - |  3454 | `	sxu32 nIdx;` |
|         - |  3455 | `	/* Extract token value */` |
|  11657595 |  3456 | `	pStr = &pToken->sData;` |
|         - |  3457 | `	/* Deal with the reserved literals [i.e: null,false,true,...] first */` |
|  11657595 |  3458 | `	if( pStr->nByte == sizeof("NULL") - 1 ){` |
|   2188325 |  3459 | `		if( SyStrnicmp(pStr->zString,"null",sizeof("NULL")-1) == 0 ){` |
|         - |  3460 | `			/* NULL constant are always indexed at 0 */` |
|    934899 |  3461 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,0,0,0);` |
|    934899 |  3462 | `			return SXRET_OK;` |
|   1253431 |  3463 | `		}else if( SyStrnicmp(pStr->zString,"true",sizeof("TRUE")-1) == 0 ){` |
|         - |  3464 | `			/* TRUE constant are always indexed at 1 */` |
|    321393 |  3465 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,1,0,0);` |
|    321393 |  3466 | `			return SXRET_OK;` |
|         5 |  3467 | `		}` |
|  10911327 |  3468 | `	}else if (pStr->nByte == sizeof("FALSE") - 1 &&` |
|   1952066 |  3469 | `		SyStrnicmp(pStr->zString,"false",sizeof("FALSE")-1) == 0 ){` |
|         - |  3470 | `			/* FALSE constant are always indexed at 2 */` |
|    698251 |  3471 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,2,0,0);` |
|    698251 |  3472 | `			return SXRET_OK;` |
|   9177912 |  3473 | `	}else if(pStr->nByte == sizeof("__LINE__") - 1 &&` |
|    813766 |  3474 | `		SyMemcmp(pStr->zString,"__LINE__",sizeof("__LINE__")-1) == 0 ){` |
...
|   8883902 |  3485 | `	}else if( pStr->nByte == sizeof("__NAMESPACE__") - 1 &&` |
|    233382 |  3486 | `		SyMemcmp(pStr->zString,"__NAMESPACE__",sizeof("__NAMESPACE__")-1) == 0 ){` |
...
|   8880281 |  3502 | `	}else if( (pStr->nByte == sizeof("__FUNCTION__") - 1 &&` |
|    435573 |  3503 | `		SyMemcmp(pStr->zString,"__FUNCTION__",sizeof("__FUNCTION__")-1) == 0) \|\|` |
|   8976599 |  3504 | `		(pStr->nByte == sizeof("__METHOD__") - 1 &&` |
|    418812 |  3505 | `		SyMemcmp(pStr->zString,"__METHOD__",sizeof("__METHOD__")-1) == 0) ){` |
...
|   9699233 |  3548 | `	if( SXRET_OK != GenStateFindLiteral(&(*pGen),&pToken->sData,&nIdx) ){` |
|         - |  3549 | `		ph7_value *pLitObj;` |
|         - |  3550 | `		/* Unknown literal,install it in the literal table */` |
|   1859003 |  3551 | `		pLitObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   1859003 |  3552 | `		if( pLitObj == 0 ){` |
|       ! 0 |  3553 | `			PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|       ! 0 |  3554 | `			return SXERR_ABORT;` |
|         - |  3555 | `		}` |
|   1859003 |  3556 | `		PH7_MemObjInitFromString(pGen->pVm,pLitObj,&pToken->sData);` |
|   1859003 |  3557 | `		GenStateInstallLiteral(&(*pGen),pLitObj,nIdx);` |
|    929499 |  3558 | `	}` |
|         - |  3559 | `	/* Emit the load constant instruction */` |
|   9699233 |  3560 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,1,nIdx,0,0);` |
|   9699233 |  3561 | `	return SXRET_OK;` |
|   5828800 |  3562 | `}` |
|         - |  3563 | `/*` |
...
|         - |  3568 | ` */` |
|  11661450 |  3569 | `static sxi32 GenStateResolveNamespaceLiteral(ph7_gen_state *pGen)` |
|         5 |  3570 | `{` |
|         - |  3571 | `	sxi32 rc;` |
|  11661455 |  3572 | `	if( pGen->pIn >= pGen->pEnd ){` |
|       ! 0 |  3573 | `		return SXRET_OK;` |
|         - |  3574 | `	}` |
|         - |  3575 | `	/* Check if this is a multi-token namespace path */` |
|  11661455 |  3576 | `	if( pGen->pIn < &pGen->pEnd[-1] ){` |
...
|  11657595 |  3629 | `	rc = GenStateLoadLiteral(&(*pGen));` |
|  11657595 |  3630 | `	return rc;` |
|   5830730 |  3631 | `}` |
|         - |  3632 | `/*` |
...
|       ! 0 |  3647 | `}` |
|  11661450 |  3648 | `PH7_PRIVATE sxi32 PH7_CompileLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|         5 |  3649 | `{` |
|         - |  3650 | `	sxi32 rc;` |
|  11661455 |  3651 | `	rc = GenStateResolveNamespaceLiteral(&(*pGen));` |
|  11661455 |  3652 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  3653 | `		SXUNUSED(iCompileFlag); /* cc warning */` |
|       ! 0 |  3654 | `		return rc;` |
|         - |  3655 | `	}` |
|         - |  3656 | `	/* Node successfully compiled */` |
|  11661455 |  3657 | `	return SXRET_OK;` |
|   5830730 |  3658 | `}` |
|         - |  3659 | `/*` |
...
|         - |  4211 | ` * message.` |
|         - |  4212 | ` */` |
|   5850954 |  4213 | `static sxi32 PH7_CompileBlock(` |
...
|         - |  4218 | `	sxi32 rc;` |
|         - |  4219 | `	sxu32 nLine;` |
|   5850959 |  4220 | `	if( pGen->pIn->nType & PH7_TK_OCB /* '{' */ ){` |
|   5849867 |  4221 | `		nLine = pGen->pIn->nLine;` |
|   5849867 |  4222 | `		rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_STD,PH7_VmInstrLength(pGen->pVm),0,0);` |
|   5849867 |  4223 | `		if( rc != SXRET_OK ){` |
|       ! 0 |  4224 | `			return SXERR_ABORT;` |
|         - |  4225 | `		}` |
|   5849867 |  4226 | `		pGen->pIn++;` |
|         - |  4227 | `		/* Compile until we hit the closing braces '}' */` |
|   8610850 |  4228 | `		for(;;){` |
|  17221705 |  4229 | `			if( pGen->pIn >= pGen->pEnd ){` |
...
|         - |  4239 | `				}` |
|       ! 0 |  4240 | `			}` |
|  17221685 |  4241 | `			if( pGen->pIn->nType & PH7_TK_CCB/*'}'*/ ){` |
|         - |  4242 | `				/* Closing braces found,break immediately*/` |
|   5849847 |  4243 | `				pGen->pIn++;` |
|   5849847 |  4244 | `				break;` |
|         - |  4245 | `			}` |
|         - |  4246 | `			/* Compile a single statement */` |
|  11371843 |  4247 | `			rc = GenStateCompileChunk(&(*pGen),PH7_COMPILE_SINGLE_STMT);` |
|  11371843 |  4248 | `			if( rc == SXERR_ABORT ){` |
|       ! 0 |  4249 | `				return SXERR_ABORT;` |
|         - |  4250 | `			}` |
|         5 |  4251 | `		}` |
|   5849867 |  4252 | `		GenStateLeaveBlock(&(*pGen),0);` |
|   2926028 |  4253 | `	}else if( (pGen->pIn->nType & PH7_TK_COLON /* ':' */) && nKeywordEnd > 0 ){` |
|       ! 0 |  4254 | `		pGen->pIn++;` |
...
|   5850959 |  4303 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|       ! 0 |  4304 | `		pGen->pIn++;` |
|       ! 0 |  4305 | `	}` |
|   5850959 |  4306 | `	return SXRET_OK;` |
|   2925482 |  4307 | `}` |
|         - |  4308 | `/*` |
...
|         - |  4716 | ` * are allowed.` |
|         - |  4717 | ` */` |
|    427958 |  4718 | `static sxi32 GenStateForEachNodeValidator(ph7_gen_state *pGen,ph7_expr_node *pRoot)` |
|         5 |  4719 | `{` |
|    427963 |  4720 | `	sxi32 rc = SXRET_OK; /* Assume a valid expression tree */` |
|    427963 |  4721 | `	if( pRoot->xCode != PH7_CompileVariable ){` |
...
|         - |  4756 | ` */` |
|    298074 |  4757 | `static sxi32 PH7_CompileForeach(ph7_gen_state *pGen)` |
|         5 |  4758 | `{` |
|    298079 |  4759 | `	SyToken *pCur,*pTmp,*pEnd = 0;` |
|    298079 |  4760 | `	SyToken *pListStart = 0,*pListEnd = 0;` |
|    298079 |  4761 | `	GenBlock *pForeachBlock = 0;` |
|         - |  4762 | `	ph7_foreach_info *pInfo;` |
|         - |  4763 | `	sxu32 nFalseJump;` |
|         - |  4764 | `	VmInstr *pInstr;` |
|         - |  4765 | `	sxu32 nLine;` |
|         - |  4766 | `	sxi32 rc;` |
|    298079 |  4767 | `	nLine = pGen->pIn->nLine;` |
|         - |  4768 | `	/* Jump the 'foreach' keyword */` |
|    298079 |  4769 | `	pGen->pIn++;` |
|    298079 |  4770 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|         - |  4771 | `		/* Syntax error */` |
...
|    298079 |  4780 | `	pGen->pIn++;` |
|         - |  4781 | `	/* Create the loop block */` |
|    298079 |  4782 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pForeachBlock);` |
|    298079 |  4783 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  4784 | `		return SXERR_ABORT;` |
|         - |  4785 | `	}` |
|         - |  4786 | `	/* Delimit the expression */` |
|    298079 |  4787 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|    298079 |  4788 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|    298079 |  4803 | `	pCur = pGen->pIn;` |
|   1719703 |  4804 | `	while( pCur < pEnd ){` |
|   1719703 |  4805 | `		if( pCur->nType & PH7_TK_KEYWORD ){` |
|    328589 |  4806 | `			sxi32 nKeywrd = SX_PTR_TO_INT(pCur->pUserData);` |
|    328589 |  4807 | `			if( nKeywrd == PH7_TKWRD_AS ){` |
...
|    298079 |  4825 | `	pTmp = pGen->pEnd;` |
|    298079 |  4826 | `	pGen->pEnd = pCur;` |
|    298079 |  4827 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|    298079 |  4828 | `	if( rc == SXERR_ABORT ){` |
|         - |  4829 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|       ! 0 |  4830 | `		return SXERR_ABORT;` |
|         - |  4831 | `	}` |
|         - |  4832 | `	/* Update token stream */` |
|    298079 |  4833 | `	while(pGen->pIn < pCur ){` |
...
|       ! 0 |  4839 | `		pGen->pIn++;` |
|       ! 0 |  4840 | `	}` |
|    298079 |  4841 | `	pCur++; /* Jump the 'as' keyword */` |
|    298079 |  4842 | `	pGen->pIn = pCur;` |
|    298079 |  4843 | `	if( pGen->pIn >= pEnd ){` |
...
|    298079 |  4850 | `	pInfo = (ph7_foreach_info *)SyMemBackendAlloc(&pGen->pVm->sAllocator,sizeof(ph7_foreach_info));` |
|    298079 |  4851 | `	if( pInfo == 0 ){` |
...
|    298079 |  4856 | `	SyZero(pInfo,sizeof(ph7_foreach_info));` |
|         - |  4857 | `	/* Initialize structure fields */` |
|    298079 |  4858 | `	SySetInit(&pInfo->aStep,&pGen->pVm->sAllocator,sizeof(ph7_foreach_step *));` |
...
|         - |  4861 | `	 * '=>'. */` |
|    298079 |  4862 | `	pCur = GenStateFindTopLevelArrow(pCur,pEnd);` |
|    298079 |  4863 | `	if( pCur < pEnd ){` |
...
|     64952 |  4886 | `	}` |
|    298079 |  4887 | `	pGen->pEnd = pEnd;` |
|    298079 |  4888 | `	if( pGen->pIn >= pEnd ){` |
...
|    298074 |  4943 | `	}else if( pGen->pIn->nType & PH7_TK_OSB ){` |
...
|    298059 |  4976 | `		rc = PH7_CompileExpr(&(*pGen),0,GenStateForEachNodeValidator);` |
|    298059 |  4977 | `		if( rc == SXERR_ABORT ){` |
|         - |  4978 | `			/* Don't worry about freeing memory, everything will be released shortly */` |
|       ! 0 |  4979 | `			return SXERR_ABORT;` |
|         - |  4980 | `		}` |
|    298059 |  4981 | `		pInstr = PH7_VmPopInstr(pGen->pVm);` |
|    298059 |  4982 | `		if( pInstr->p3 ){` |
|         - |  4983 | `			/* Record value name */` |
|    298059 |  4984 | `			SyStringInitFromBuf(&pInfo->sValue,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|    149027 |  4985 | `		}` |
|         - |  4986 | `	}` |
|         - |  4987 | `	/* Emit the 'FOREACH_INIT' instruction */` |
|    298077 |  4988 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_FOREACH_INIT,0,0,pInfo,&nFalseJump);` |
|         - |  4989 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|    298077 |  4990 | `	GenStateNewJumpFixup(pForeachBlock,PH7_OP_FOREACH_INIT,nFalseJump);` |
|         - |  4991 | `	/* Record the first instruction to execute */` |
|    298077 |  4992 | `	pForeachBlock->nFirstInstr = PH7_VmInstrLength(pGen->pVm);` |
|         - |  4993 | `	/* Emit the FOREACH_STEP instruction */` |
|    298077 |  4994 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_FOREACH_STEP,0,0,pInfo,&nFalseJump);` |
|         - |  4995 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|    298077 |  4996 | `	GenStateNewJumpFixup(pForeachBlock,PH7_OP_FOREACH_STEP,nFalseJump);` |
|         - |  4997 | `	/* If list() unpacking, emit bytecode to destructure the temp variable */` |
|    298077 |  4998 | `	if( (pInfo->iFlags & PH7_4EACH_STEP_LIST) && pListStart && pListEnd ){` |
...
|    298077 |  5026 | `	pGen->pIn = &pEnd[1];` |
|    298077 |  5027 | `	pGen->pEnd = pTmp;` |
|    298077 |  5028 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_END4EACH);` |
|    298077 |  5029 | `	if( rc == SXERR_ABORT ){` |
...
|    298077 |  5034 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pForeachBlock->nFirstInstr,0,0);` |
|         - |  5035 | `	/* Fix all jumps now the destination is resolved */` |
|    298077 |  5036 | `	GenStateFixJumps(pForeachBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|         - |  5037 | `	/* Release the loop block */` |
|    298077 |  5038 | `	GenStateLeaveBlock(pGen,0);` |
|         - |  5039 | `	/* Statement successfully compiled */` |
|    298077 |  5040 | `	return SXRET_OK;` |
|         1 |  5041 | `Synchronize:` |
...
|         - |  5080 | ` *    ?>` |
|         - |  5081 | ` */` |
|   2151962 |  5082 | `static sxi32 PH7_CompileIf(ph7_gen_state *pGen)` |
|         5 |  5083 | `{` |
|   2151967 |  5084 | `	SyToken *pToken,*pTmp,*pEnd = 0;` |
|   2151967 |  5085 | `	GenBlock *pCondBlock = 0;` |
|         - |  5086 | `	sxu32 nJumpIdx;` |
|         - |  5087 | `	sxu32 nKeyID;` |
|         - |  5088 | `	sxi32 rc;` |
|         - |  5089 | `	/* Jump the 'if' keyword */` |
|   2151967 |  5090 | `	pGen->pIn++;` |
|   2151967 |  5091 | `	pToken = pGen->pIn;` |
|         - |  5092 | `	/* Create the conditional block */` |
|   2151967 |  5093 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_COND,PH7_VmInstrLength(pGen->pVm),0,&pCondBlock);` |
|   2151967 |  5094 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  5095 | `		return SXERR_ABORT;` |
|         - |  5096 | `	}` |
|         - |  5097 | `	/* Process as many [if/else if/elseif/else] blocks as we can */` |
|   1211366 |  5098 | `	for(;;){` |
|   2422737 |  5099 | `		if( pToken >= pGen->pEnd \|\| (pToken->nType & PH7_TK_LPAREN) == 0 ){` |
|         - |  5100 | `			/* Syntax error */` |
...
|   2422737 |  5114 | `		PH7_DelimitNestedTokens(pToken,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   2422737 |  5115 | `		if( pToken >= pEnd \|\| (pEnd->nType & PH7_TK_RPAREN) == 0 ){` |
|         - |  5116 | `			/* Syntax error */` |
...
|   2422729 |  5128 | `		SWAP_TOKEN_STREAM(pGen,pToken,pEnd);` |
|         - |  5129 | `		/* Compile the condition */` |
|   2422729 |  5130 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|         - |  5131 | `		/* Update token stream */` |
|   2422729 |  5132 | `		while(pGen->pIn < pEnd ){` |
|       ! 0 |  5133 | `			PH7_GenSyntaxError(&(*pGen),pGen->pIn,0);` |
|       ! 0 |  5134 | `			pGen->pIn++;` |
|       ! 0 |  5135 | `		}` |
|   2422729 |  5136 | `		pGen->pIn  = &pEnd[1];` |
|   2422729 |  5137 | `		pGen->pEnd = pTmp;` |
|   2422729 |  5138 | `		if( rc == SXERR_ABORT ){` |
|         - |  5139 | `			/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|       ! 0 |  5140 | `			return SXERR_ABORT;` |
|         - |  5141 | `		}` |
|         - |  5142 | `		/* Emit the false jump */` |
|   2422729 |  5143 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nJumpIdx);` |
|         - |  5144 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   2422729 |  5145 | `		GenStateNewJumpFixup(pCondBlock,PH7_OP_JZ,nJumpIdx);` |
|         - |  5146 | `		/* Compile the body */` |
|   2422729 |  5147 | `		rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDIF);` |
|   2422729 |  5148 | `		if( rc == SXERR_ABORT ){` |
|       ! 0 |  5149 | `			return SXERR_ABORT;` |
|         - |  5150 | `		}` |
|   2422729 |  5151 | `		if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
|    471399 |  5152 | `			break;` |
|         - |  5153 | `		}` |
|         - |  5154 | `		/* Ensure that the keyword ID is 'else if' or 'else' */` |
|   1479941 |  5155 | `		nKeyID = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   1479941 |  5156 | `		if( (nKeyID & (PH7_TKWRD_ELSE\|PH7_TKWRD_ELIF)) == 0 ){` |
|   1006673 |  5157 | `			break;` |
|         - |  5158 | `		}` |
|         - |  5159 | `		/* Emit the unconditional jump */` |
|    473273 |  5160 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,0,0,&nJumpIdx);` |
|         - |  5161 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|    473273 |  5162 | `		GenStateNewJumpFixup(pCondBlock,PH7_OP_JMP,nJumpIdx);` |
|    473273 |  5163 | `		if( nKeyID & PH7_TKWRD_ELSE ){` |
|    286367 |  5164 | `			pToken = &pGen->pIn[1];` |
|    286367 |  5165 | `			if( pToken >= pGen->pEnd \|\| (pToken->nType & PH7_TK_KEYWORD) == 0 \|\|` |
...
|   2151959 |  5178 | `	GenStateFixJumps(pCondBlock,PH7_OP_JZ,PH7_VmInstrLength(pGen->pVm));` |
|   2151959 |  5179 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|   1209166 |  5180 | `		(SX_PTR_TO_INT(pGen->pIn->pUserData) & PH7_TKWRD_ELSE) ){` |
|         - |  5181 | `			/* Compile the else block */` |
|    202503 |  5182 | `			pGen->pIn++;` |
|    202503 |  5183 | `			rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDIF);` |
|    202503 |  5184 | `			if( rc == SXERR_ABORT ){` |
|         - |  5185 |  |
|       ! 0 |  5186 | `				return SXERR_ABORT;` |
|         - |  5187 | `			}` |
|    101249 |  5188 | `	}` |
|   2151959 |  5189 | `	nJumpIdx = PH7_VmInstrLength(pGen->pVm);` |
|         - |  5190 | `	/* Fix all unconditional jumps now the destination is resolved */` |
|   2151959 |  5191 | `	GenStateFixJumps(pCondBlock,PH7_OP_JMP,nJumpIdx);` |
|         - |  5192 | `	/* Release the conditional block */` |
|   2151959 |  5193 | `	GenStateLeaveBlock(pGen,0);` |
|         - |  5194 | `	/* Statement successfully compiled */` |
|   2151959 |  5195 | `	return SXRET_OK;` |
|         4 |  5196 | `Synchronize:` |
...
|         - |  5296 | ` */` |
|   2887864 |  5297 | `static sxi32 PH7_CompileReturn(ph7_gen_state *pGen)` |
|         5 |  5298 | `{` |
|   2887869 |  5299 | `	sxi32 nRet = 0; /* TRUE if there is a return value */` |
|         - |  5300 | `	sxi32 rc;` |
|   2887869 |  5301 | `	sxu32 nLine = pGen->pIn->nLine;` |
|   2887869 |  5302 | `	GenBlock *pFuncBlock = pGen->pCurrent;` |
...
|   7583419 |  5308 | `	while( pFuncBlock && (pFuncBlock->iFlags & GEN_BLOCK_FUNC) == 0 ){` |
|   4695555 |  5309 | `		pFuncBlock = pFuncBlock->pParent;` |
|         5 |  5310 | `	}` |
|   2887864 |  5311 | `	if( pFuncBlock && pFuncBlock->pUserData` |
|   2887837 |  5312 | `	 && ((ph7_vm_func *)pFuncBlock->pUserData)->nReturnType == MEMOBJ_NEVER ){` |
...
|   2887869 |  5320 | `	pGen->pIn++;` |
|   2887869 |  5321 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|         - |  5322 | `		/* Compile the expression */` |
|   2792539 |  5323 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   2792539 |  5324 | `		if( rc == SXERR_ABORT ){` |
|       ! 0 |  5325 | `			return SXERR_ABORT;` |
|   2792539 |  5326 | `		}else if(rc != SXERR_EMPTY ){` |
|   2792539 |  5327 | `			nRet = 1;` |
|   1396267 |  5328 | `		}` |
|   1396267 |  5329 | `	}` |
...
|   2887869 |  5334 | `	if( pGen->bInGenerator ){` |
...
|   2884029 |  5343 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,nRet,1,0,0);` |
|   2884029 |  5344 | `	return SXRET_OK;` |
|   1443937 |  5345 | `}` |
|         - |  5346 | `/*` |
...
|         - |  5457 | ` */` |
|     17678 |  5458 | `static sxi32 PH7_CompileEcho(ph7_gen_state *pGen)` |
|         5 |  5459 | `{` |
|     17683 |  5460 | `	SyToken *pTmp,*pNext = 0;` |
|     17683 |  5461 | `	sxu32 nLine = pGen->pIn->nLine;` |
|     17683 |  5462 | `	int nExpr = 0;      /* expressions actually compiled */` |
|     17683 |  5463 | `	int bExpectMore = 1;/* after 'echo' or a comma an expression is REQUIRED */` |
|         - |  5464 | `	sxi32 rc;` |
|         - |  5465 | `	/* Jump the 'echo' keyword */` |
|     17683 |  5466 | `	pGen->pIn++;` |
|         - |  5467 | `	/* Compile arguments one after one */` |
|     17683 |  5468 | `	pTmp = pGen->pEnd;` |
|     44599 |  5469 | `	while( SXRET_OK == PH7_GetNextExpr(pGen->pIn,pTmp,&pNext) ){` |
|     26923 |  5470 | `		if( pGen->pIn < pNext ){` |
|     26923 |  5471 | `			pGen->pEnd = pNext;` |
|     26923 |  5472 | `			rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_RDONLY_LOAD/* Do not create variable if inexistant */,0);` |
|     26923 |  5473 | `			if( rc == SXERR_ABORT ){` |
|       ! 0 |  5474 | `				return SXERR_ABORT;` |
|     26923 |  5475 | `			}else if( rc != SXERR_EMPTY ){` |
|         - |  5476 | `				/* Emit the consume instruction */` |
|     26897 |  5477 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_CONSUME,1,0,0,0);` |
|     26897 |  5478 | `				nExpr++;` |
|     26897 |  5479 | `				bExpectMore = 0;` |
|     13446 |  5480 | `			}` |
|     13459 |  5481 | `		}` |
...
|     36169 |  5484 | `		while( pNext < pTmp && (pNext->nType & PH7_TK_COMMA) ){` |
|      9253 |  5485 | `			if( bExpectMore ){` |
...
|         - |  5490 | `			}` |
|      9251 |  5491 | `			bExpectMore = 1;` |
|      9251 |  5492 | `			pNext++;` |
|         5 |  5493 | `		}` |
|     26921 |  5494 | `		pGen->pIn = pNext;` |
|         5 |  5495 | `	}` |
|         - |  5496 | `	/* Restore token stream */` |
|     17681 |  5497 | `	pGen->pEnd = pTmp;` |
|     17681 |  5498 | `	if( nExpr == 0 \|\| bExpectMore ){` |
...
|         - |  5685 | ` */` |
|   5468516 |  5686 | `static sxu32 GenStateNsQualifyName(ph7_gen_state *pGen,sxu32 nOrigIdx,SyHash *pImports,int *pFromImport)` |
|         5 |  5687 | `{` |
|         - |  5688 | `	ph7_value *pLit;` |
...
|         - |  5696 | `	ph7_value *pNew;` |
|   5468521 |  5697 | `	if( pFromImport ){` |
|   4404957 |  5698 | `		*pFromImport = 0;` |
|   2202476 |  5699 | `	}` |
|   5468521 |  5700 | `	pLit = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,nOrigIdx);` |
|   5468521 |  5701 | `	if( !pLit \|\| !(pLit->iFlags & MEMOBJ_STRING) \|\| SyBlobLength(&pLit->sBlob) == 0 ){` |
|       ! 0 |  5702 | `		return nOrigIdx;` |
|         - |  5703 | `	}` |
|   5468521 |  5704 | `	zLit = (const char *)SyBlobData(&pLit->sBlob);` |
|   5468521 |  5705 | `	nLit = (sxu32)SyBlobLength(&pLit->sBlob);` |
|         - |  5706 | `	/* Skip if already qualified (contains backslash) */` |
|   5468521 |  5707 | `	hasNsSep = 0;` |
|  65382533 |  5708 | `	for( k = 0; k < nLit; k++ ){` |
|  59914025 |  5709 | `		if( zLit[k] == '\\' ){ hasNsSep = 1; break; }` |
|  29957011 |  5710 | `	}` |
|   5468521 |  5711 | `	if( hasNsSep ){` |
|        10 |  5712 | `		return nOrigIdx;` |
|         - |  5713 | `	}` |
|         - |  5714 | `	/* Check use imports first (works even outside namespaces) */` |
|   5468513 |  5715 | `	SyBlobReset(&pGen->sWorker);` |
|   5468513 |  5716 | `	pImport = SyHashGet(pImports,(const void *)zLit,nLit);` |
|   5468513 |  5717 | `	if( pImport ){` |
...
|         8 |  5722 | `		}` |
|        23 |  5723 | `	}else{` |
|   5468477 |  5724 | `		if( SyBlobLength(&pGen->sNamespace) == 0 ){` |
|   5468387 |  5725 | `			return nOrigIdx; /* Not in a namespace and no import match */` |
|         - |  5726 | `		}` |
...
|         - |  6275 | ` */` |
|    545274 |  6276 | `static sxi32 GenStateProcessArgValue(ph7_gen_state *pGen,ph7_vm_func_arg *pArg,SyToken *pIn,SyToken *pEnd)` |
|         5 |  6277 | `{` |
|         - |  6278 | `	SyToken *pTmpIn,*pTmpEnd;` |
|         - |  6279 | `	SySet *pInstrContainer;` |
|         - |  6280 | `	sxi32 rc;` |
|         - |  6281 | `	/* Swap token stream */` |
|    545279 |  6282 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|    545279 |  6283 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|    545279 |  6284 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pArg->aByteCode);` |
|         - |  6285 | `	/* Compile the expression holding the argument value */` |
|    545279 |  6286 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|         - |  6287 | `	/* Emit the done instruction */` |
|    545279 |  6288 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,(rc != SXERR_EMPTY ? 1 : 0),0,0,0);` |
|    545279 |  6289 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|    545279 |  6290 | `	RE_SWAP_DELIMITER(pGen);` |
|    545279 |  6291 | `	if( rc == SXERR_ABORT ){` |
|       ! 0 |  6292 | `		return SXERR_ABORT;` |
|         - |  6293 | `	}` |
|    545279 |  6294 | `	return SXRET_OK;` |
|    272642 |  6295 | `}` |
|         - |  6296 | `/*` |
...
|         - |  6332 | ` */` |
|   1244666 |  6333 | `static sxi32 GenStateCollectFuncArgs(ph7_vm_func *pFunc,ph7_gen_state *pGen,SyToken *pEnd,int bCtorCtx,int bAbstractCtx)` |
|         5 |  6334 | `{` |
...
|         - |  6339 | `	sxi32 rc;` |
|         - |  6340 |  |
|   1244671 |  6341 | `	pIn = pGen->pIn;` |
|   1244671 |  6342 | `	SyBlobInit(&sSig,&pGen->pVm->sAllocator);` |
|         - |  6343 | `	/* Process arguments one after one */` |
|   1613013 |  6344 | `	for(;;){` |
|   3226031 |  6345 | `		if( pIn >= pEnd ){` |
|         - |  6346 | `			/* No more arguments to process */` |
|   1244655 |  6347 | `			break;` |
|         - |  6348 | `		}` |
|   1981381 |  6349 | `		SyZero(&sArg,sizeof(ph7_vm_func_arg));` |
|   1981381 |  6350 | `		SySetInit(&sArg.aByteCode,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|   1981381 |  6351 | `		SySetInit(&sArg.aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|   1981381 |  6352 | `		SySetInit(&sArg.aAttrs,&pGen->pVm->sAllocator,sizeof(ph7_attribute));` |
|   1981381 |  6353 | `		SyStringInitFromBuf(&sArg.sTypeName,0,0);` |
|         - |  6354 | `		/* Parameter #[...] attributes: the group precedes the parameter's` |
|         - |  6355 | `		 * first token inside the main token stream */` |
|   1981381 |  6356 | `		if( GenStateCollectParamAttrs(&(*pGen),pIn,&sArg.aAttrs) == SXERR_ABORT ){` |
...
|         - |  6364 | `		{` |
|   1981381 |  6365 | `			int bReadonly = 0, bVisSeen = 0;` |
|   1981381 |  6366 | `			sxi32 iVis = PH7_CLASS_PROT_PUBLIC;` |
|   1981381 |  6367 | `			sxi32 iSetVisFlag = 0;` |
|         - |  6368 | `			int nSetTok;` |
|         - |  6369 | `			sxi32 nSetVis;` |
|   1981381 |  6370 | `			if( pIn < pEnd && GenStateIsReadonly(pIn) ){` |
|         3 |  6371 | `				bReadonly = 1;` |
|         3 |  6372 | `				pIn++;` |
|         1 |  6373 | `			}` |
|   1981381 |  6374 | `			nSetVis = GenStatePeekSetVisibility(pIn,pEnd,&nSetTok);` |
|   1981381 |  6375 | `			if( nSetVis ){` |
...
|       ! 0 |  6382 | `					pIn++;` |
|         1 |  6383 | `				}` |
|   1981380 |  6384 | `			}else if( pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD) ){` |
...
|        42 |  6402 | `				}` |
|     44035 |  6403 | `			}` |
|   1981381 |  6404 | `			if( iSetVisFlag == PH7_CLASS_ATTR_PRIVATE_SET ){` |
|         5 |  6405 | `				sArg.iFlags \|= VM_FUNC_ARG_PRIV_SET;` |
|   1981379 |  6406 | `			}else if( iSetVisFlag == PH7_CLASS_ATTR_PROTECTED_SET ){` |
|       ! 0 |  6407 | `				sArg.iFlags \|= VM_FUNC_ARG_PROT_SET;` |
|       ! 0 |  6408 | `			}` |
|   1981381 |  6409 | `			if( bVisSeen \|\| bReadonly ){` |
|        93 |  6410 | `				if( !bCtorCtx ){` |
...
|   1981372 |  6431 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_DOLLAR) == 0` |
|   1071052 |  6432 | `			&& (pIn->nType & PH7_TK_AMPER) == 0` |
|    149284 |  6433 | `			&& (pIn->nType & PH7_TK_ELLIPSIS) == 0 ){` |
|    114877 |  6434 | `			sxu32 nLineLocal = pIn->nLine;` |
|    114877 |  6435 | `			sxi32 iTFlags = 0;` |
|    114877 |  6436 | `			pGen->pIn = pIn;` |
|    114877 |  6437 | `			rc = GenStateParseUnionTypeDecl(` |
|     57436 |  6438 | `				pGen, &sArg.nType, &sArg.sClass, &sArg.aUnionAlts,` |
|     57436 |  6439 | `				&iTFlags, &sArg.sTypeName,` |
|         - |  6440 | `				VM_FUNC_ARG_NULLABLE, VM_FUNC_ARG_UNION,` |
|         - |  6441 | `				/* bAllowVoid */ 0,` |
|     57436 |  6442 | `						nLineLocal);` |
|    114877 |  6443 | `			pIn = pGen->pIn;` |
|    114877 |  6444 | `			if( rc == SXERR_ABORT ){` |
|       ! 0 |  6445 | `				return SXERR_ABORT;` |
|    114877 |  6446 | `			}else if( rc == SXERR_CORRUPT ){` |
|         - |  6447 | `				/* Error already reported by GenStateParseUnionTypeDecl */` |
|         3 |  6448 | `				return SXERR_SYNTAX;` |
|    114875 |  6449 | `			}else if( rc == SXERR_SYNTAX ){` |
|        11 |  6450 | `				if( pIn < pEnd ){` |
...
|         - |  6459 | `			}` |
|    114867 |  6460 | `			sArg.iFlags \|= iTFlags;` |
|     57431 |  6461 | `		}` |
|   1981367 |  6462 | `		if( pIn >= pEnd ){` |
|       ! 0 |  6463 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Missing argument name");` |
|       ! 0 |  6464 | `			return rc;` |
|         - |  6465 | `		}` |
|   1981367 |  6466 | `		if( pIn->nType & PH7_TK_AMPER ){` |
|         - |  6467 | `			/* Pass by reference,record that */` |
|     22919 |  6468 | `			sArg.iFlags \|= VM_FUNC_ARG_BY_REF;` |
|     22919 |  6469 | `			pIn++;` |
|     11457 |  6470 | `		}` |
|   1981367 |  6471 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_ELLIPSIS) ){` |
|         - |  6472 | `			/* Variadic parameter: ...$args */` |
|     22981 |  6473 | `			sArg.iFlags \|= VM_FUNC_ARG_VARIADIC;` |
|     22981 |  6474 | `			pIn++;` |
|     11488 |  6475 | `		}` |
|   1981367 |  6476 | `		if( pIn >= pEnd \|\| (pIn->nType & PH7_TK_DOLLAR) == 0 \|\| &pIn[1] >= pEnd \|\| (pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|         - |  6477 | `			/* Invalid argument */` |
|       ! 0 |  6478 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Invalid argument name");` |
|       ! 0 |  6479 | `			return rc;` |
|         - |  6480 | `		}` |
|   1981367 |  6481 | `		pIn++; /* Jump the dollar sign */` |
|         - |  6482 | `		/* Copy argument name */` |
|   1981367 |  6483 | `		zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,SyStringData(&pIn->sData),SyStringLength(&pIn->sData));` |
|   1981367 |  6484 | `		if( zDup == 0 ){` |
|       ! 0 |  6485 | `			PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"PH7 engine is running out of memory");` |
|       ! 0 |  6486 | `			return SXERR_ABORT;` |
|         - |  6487 | `		}` |
|   1981367 |  6488 | `		SyStringInitFromBuf(&sArg.sName,zDup,SyStringLength(&pIn->sData));` |
|   1981367 |  6489 | `		pIn++;` |
|   1981367 |  6490 | `		if( pIn < pEnd ){` |
|   1095159 |  6491 | `			if( pIn->nType & PH7_TK_EQUAL ){` |
|         - |  6492 | `				SyToken *pDefend;` |
|    545281 |  6493 | `				sxi32 iNest = 0;` |
|    545281 |  6494 | `				pIn++; /* Jump the equal sign */` |
|    545281 |  6495 | `				pDefend = pIn;` |
|         - |  6496 | `				/* Process the default value associated with this argument */` |
|   1147763 |  6497 | `				while( pDefend < pEnd ){` |
|    789325 |  6498 | `					if( (pDefend->nType & PH7_TK_COMMA) && iNest <= 0 ){` |
|    186843 |  6499 | `						break;` |
|         - |  6500 | `					}` |
|    602487 |  6501 | `					if( pDefend->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*[*/) ){` |
|         - |  6502 | `						/* Increment nesting level */` |
|     26697 |  6503 | `						iNest++;` |
|    589141 |  6504 | `					}else if( pDefend->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CCB/*'}'*/\|PH7_TK_CSB/*]*/) ){` |
|         - |  6505 | `						/* Decrement nesting level */` |
|     26697 |  6506 | `						iNest--;` |
|     13346 |  6507 | `					}` |
|    602487 |  6508 | `					pDefend++;` |
|         5 |  6509 | `				}` |
|    545281 |  6510 | `				if( pIn >= pDefend ){` |
|         3 |  6511 | `					rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Missing argument default value");` |
|         3 |  6512 | `					return rc;` |
|         - |  6513 | `				}` |
|         - |  6514 | `				/* Process default value */` |
|    545279 |  6515 | `				rc = GenStateProcessArgValue(&(*pGen),&sArg,pIn,pDefend);` |
|    545279 |  6516 | `				if( rc != SXRET_OK ){` |
|       ! 0 |  6517 | `					return rc;` |
|         - |  6518 | `				}` |
...
|    545274 |  6524 | `				if( (sArg.nType > 0 \|\| (sArg.iFlags & VM_FUNC_ARG_UNION))` |
|    297438 |  6525 | `					&& (sArg.iFlags & VM_FUNC_ARG_NULLABLE) == 0` |
|    297435 |  6526 | `					&& &pIn[1] == pDefend` |
...
|    545279 |  6548 | `				pIn = pDefend;` |
|    272637 |  6549 | `			}` |
|   1095157 |  6550 | `			if( pIn < pEnd && (pIn->nType & PH7_TK_COMMA) == 0 ){` |
|       ! 0 |  6551 | `				rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Unexpected token '%z'",&pIn->sData);` |
|       ! 0 |  6552 | `				return rc;` |
|         - |  6553 | `			}` |
|   1095157 |  6554 | `			pIn++; /* Jump the trailing comma */` |
|    547576 |  6555 | `		}` |
|         - |  6556 | `		/* Append argument signature */` |
|   1981365 |  6557 | `		if( sArg.nType > 0 ){` |
|    114805 |  6558 | `			if( SyStringLength(&sArg.sClass) > 0 ){` |
|         - |  6559 | `				/* Class name — prefix with 'o' so generic object hint is a prefix match */` |
|     26769 |  6560 | `				int marker = 'o';` |
|     26769 |  6561 | `				SyBlobAppend(&sSig,(const void *)&marker,sizeof(char));` |
|     26769 |  6562 | `				SyBlobAppend(&sSig,SyStringData(&sArg.sClass),SyStringLength(&sArg.sClass));` |
|     13387 |  6563 | `			}else{` |
|         - |  6564 | `				int c;` |
...
|         - |  6600 | `			 */` |
|   1866565 |  6601 | `			SyBlobRelease(&sSig);` |
|         - |  6602 | `		}` |
|         - |  6603 | `		/* Save in the argument set */` |
|   1981365 |  6604 | `		SySetPut(&pFunc->aArgs,(const void *)&sArg);` |
|         5 |  6605 | `	}` |
|   1244655 |  6606 | `	if( SyBlobLength(&sSig) > 0 ){` |
|         - |  6607 | `		/* Save function signature */` |
|     84237 |  6608 | `		SyStringInitFromBuf(&pFunc->sSignature,SyBlobData(&sSig),SyBlobLength(&sSig));` |
|     42116 |  6609 | `	}` |
|   1244655 |  6610 | `	return SXRET_OK;` |
|    622338 |  6611 | `}` |
|         - |  6612 | `/*` |
...
|         - |  6616 | ` */` |
|     34350 |  6617 | `static SyToken * GenStateSkipNestedFunc(SyToken *pIn, SyToken *pEnd)` |
|         5 |  6618 | `{` |
|     34355 |  6619 | `	sxi32 iParen = 0;` |
|     34355 |  6620 | `	pIn++; /* past 'function'/'fn' */` |
...
|    152713 |  6624 | `	while( pIn < pEnd ){` |
|    152713 |  6625 | `		sxu32 t = pIn->nType;` |
|    152713 |  6626 | `		if( t & PH7_TK_LPAREN ){ iParen++; }` |
|    148847 |  6627 | `		else if( t & PH7_TK_RPAREN ){ iParen--; }` |
|    103049 |  6628 | `		else if( (t & PH7_TK_OCB) && iParen <= 0 ){ break; }` |
|     83947 |  6629 | `		else if( (t & PH7_TK_SEMI) && iParen <= 0 ){ return pIn; }` |
|    118363 |  6630 | `		pIn++;` |
|         5 |  6631 | `	}` |
|     19107 |  6632 | `	if( pIn >= pEnd ){ return pIn; }` |
|         - |  6633 | `	/* pIn at the body '{' — skip the balanced brace block. */` |
|         - |  6634 | `	{` |
|     19107 |  6635 | `		sxi32 d = 0;` |
|    759013 |  6636 | `		while( pIn < pEnd ){` |
|    759013 |  6637 | `			sxu32 t = pIn->nType;` |
|    759013 |  6638 | `			if( t & PH7_TK_OCB ){ d++; }` |
|    728471 |  6639 | `			else if( t & PH7_TK_CCB ){ d--; if( d <= 0 ){ pIn++; break; } }` |
|    739911 |  6640 | `			pIn++;` |
|         5 |  6641 | `		}` |
|         - |  6642 | `	}` |
|     19107 |  6643 | `	return pIn;` |
|     17180 |  6644 | `}` |
|         - |  6645 | `/*` |
...
|      5855 |  6779 | `}` |
|   2694936 |  6780 | `static int GenStateFuncBodyHasYield(ph7_gen_state *pGen)` |
|         5 |  6781 | `{` |
|   2694941 |  6782 | `	SyToken *pIn = pGen->pIn;   /* expected at the body's opening '{' */` |
|   2694941 |  6783 | `	SyToken *pEnd = pGen->pEnd;` |
|   2694941 |  6784 | `	sxi32 iDepth = 0;` |
|   2694941 |  6785 | `	int bStarted = 0;` |
| 128205943 |  6786 | `	while( pIn < pEnd ){` |
| 128205943 |  6787 | `		sxu32 t = pIn->nType;` |
| 128205943 |  6788 | `		if( t & PH7_TK_OCB ){ iDepth++; bStarted = 1; pIn++; continue; }` |
| 122399435 |  6789 | `		if( t & PH7_TK_CCB ){ iDepth--; pIn++; if( bStarted && iDepth <= 0 ){ break; } continue; }` |
| 116627613 |  6790 | `		if( t & PH7_TK_KEYWORD ){` |
|   8700617 |  6791 | `			int kw = SX_PTR_TO_INT(pIn->pUserData);` |
|   8700617 |  6792 | `			if( kw == PH7_TKWRD_YIELD ){ return TRUE; }` |
|   8688917 |  6793 | `			if( kw == PH7_TKWRD_FUNCTION ){ pIn = GenStateSkipNestedFunc(pIn,pEnd); continue; }` |
|         - |  6794 | ``			/* `fn` arrow bodies are single expressions and cannot contain a valid yield. */`` |
|   4327281 |  6795 | `		}` |
| 116581563 |  6796 | `		pIn++;` |
|         5 |  6797 | `	}` |
|   2683241 |  6798 | `	return FALSE;` |
|   1347473 |  6799 | `}` |
|         - |  6800 | `/*` |
...
|         - |  6804 | ` */` |
|   2694936 |  6805 | `static sxi32 GenStateCompileFuncBody(` |
...
|   2694941 |  6815 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC,PH7_VmInstrLength(pGen->pVm),pFunc,&pBlock);` |
|   2694941 |  6816 | `	if( rc != SXRET_OK ){` |
...
|         - |  6820 | `	}` |
|   2694941 |  6821 | `	nGotoOfft = SySetUsed(&pGen->aGoto);` |
|         - |  6822 | `	/* Swap bytecode containers */` |
|   2694941 |  6823 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   2694941 |  6824 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pFunc->aByteCode);` |
...
|         - |  6829 | `	{` |
|   2694941 |  6830 | `		sxu32 nArg = SySetUsed(&pFunc->aArgs);` |
|         - |  6831 | `		sxu32 i;` |
|   4622797 |  6832 | `		for( i = 0; i < nArg; i++ ){` |
|   1927861 |  6833 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pFunc->aArgs,i);` |
|         - |  6834 | `			char *zSrc;` |
|         - |  6835 | `			sxu32 nSrc,nName;` |
|         - |  6836 | `			SySet sToken;` |
|         - |  6837 | `			SyToken *pTmpIn,*pTmpEnd;` |
|         - |  6838 | `			sxi32 rcPromote;` |
|   1927861 |  6839 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|   1927787 |  6840 | `				continue;` |
|         - |  6841 | `			}` |
...
|         - |  6891 | `	{` |
|   2694941 |  6892 | `		sxi8 bSavedGen = pGen->bInGenerator;` |
|   2694941 |  6893 | `		pGen->bInGenerator = (sxi8)GenStateFuncBodyHasYield(&(*pGen));` |
|         - |  6894 | `		/* Compile the body */` |
|   2694941 |  6895 | `		PH7_CompileBlock(&(*pGen),0);` |
|   2694941 |  6896 | `		pGen->bInGenerator = bSavedGen;` |
|         - |  6897 | `	}` |
|         - |  6898 | `	/* Fix exception jumps now the destination is resolved */` |
|   2694941 |  6899 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|         - |  6900 | `	/* Emit the final return if not yet done */` |
|   2694941 |  6901 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|         - |  6902 | `	/* Fix gotos jumps now the destination is resolved */` |
|   2694941 |  6903 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),nGotoOfft) ){` |
|       ! 0 |  6904 | `		rc = SXERR_ABORT;` |
|       ! 0 |  6905 | `	}` |
|   2694941 |  6906 | `	SySetTruncate(&pGen->aGoto,nGotoOfft);` |
|         - |  6907 | `	/* Restore the default container */` |
|   2694941 |  6908 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|         - |  6909 | `	/* Leave function block */` |
|   2694941 |  6910 | `	GenStateLeaveBlock(&(*pGen),0);` |
|   2694941 |  6911 | `	if( rc == SXERR_ABORT ){` |
...
|         - |  6916 | `	{` |
|   2694941 |  6917 | `		VmInstr *aInstr = (VmInstr *)SySetBasePtr(&pFunc->aByteCode);` |
|         - |  6918 | `		sxu32 i;` |
|  78509583 |  6919 | `		for( i = 0; i < SySetUsed(&pFunc->aByteCode); i++ ){` |
|  75826347 |  6920 | `			if( aInstr[i].iOp == PH7_OP_YIELD \|\| aInstr[i].iOp == PH7_OP_YIELD_FROM ){` |
|     11705 |  6921 | `				pFunc->iFlags \|= VM_FUNC_GENERATOR;` |
|     11705 |  6922 | `				break;` |
|         - |  6923 | `			}` |
|  37907326 |  6924 | `		}` |
|         - |  6925 | `	}` |
|   2694941 |  6926 | `	if( pFunc->iFlags & VM_FUNC_GENERATOR ){` |
...
|         - |  6996 | ` */` |
|    127490 |  6997 | `static sxi32 GenStateParseOneTypeAtom(ph7_gen_state *pGen, PhlTypeAtom *pOut)` |
|         5 |  6998 | `{` |
|    127495 |  6999 | `	SyToken *pIn = pGen->pIn;` |
|    127495 |  7000 | `	SyZero(pOut, sizeof(*pOut));` |
|    127495 |  7001 | `	SyStringInitFromBuf(&pOut->sClass, 0, 0);` |
|    127495 |  7002 | `	if( pIn >= pGen->pEnd ){` |
|       ! 0 |  7003 | `		return SXERR_SYNTAX;` |
|         - |  7004 | `	}` |
|         - |  7005 | `	/* Optional leading namespace separator '\' on FQN class types */` |
|    127495 |  7006 | `	if( pIn->nType & PH7_TK_NSSEP ){` |
|         8 |  7007 | `		pIn++;` |
|         8 |  7008 | `		if( pIn >= pGen->pEnd ){` |
|       ! 0 |  7009 | `			return SXERR_SYNTAX;` |
|         - |  7010 | `		}` |
|         3 |  7011 | `	}` |
|    127495 |  7012 | `	if( (pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|       ! 0 |  7013 | `		return SXERR_SYNTAX;` |
|         - |  7014 | `	}` |
|    127495 |  7015 | `	if( pIn->nType & PH7_TK_KEYWORD ){` |
|     88835 |  7016 | `		sxu32 nKey = (sxu32)(SX_PTR_TO_INT(pIn->pUserData));` |
|     88835 |  7017 | `		if( nKey & PH7_TKWRD_ARRAY ){` |
|     11487 |  7018 | `			pOut->nType = MEMOBJ_HASHMAP; pOut->zCanon = "array"; pOut->nCanon = 5;` |
|     83094 |  7019 | `		}else if( nKey & PH7_TKWRD_BOOL ){` |
|        81 |  7020 | `			pOut->nType = MEMOBJ_BOOL; pOut->zCanon = "bool"; pOut->nCanon = 4;` |
|     77315 |  7021 | `		}else if( nKey & PH7_TKWRD_INT ){` |
|     19711 |  7022 | `			pOut->nType = MEMOBJ_INT; pOut->zCanon = "int"; pOut->nCanon = 3;` |
|     67424 |  7023 | `		}else if( nKey & PH7_TKWRD_STRING ){` |
|     57489 |  7024 | `			pOut->nType = MEMOBJ_STRING; pOut->zCanon = "string"; pOut->nCanon = 6;` |
|     28829 |  7025 | `		}else if( nKey & PH7_TKWRD_FLOAT ){` |
...
|     38665 |  7040 | `		SyString *pT = &pIn->sData;` |
|     38665 |  7041 | `		if( pT->nByte == 4 && SyMemcmpNoCase(pT->zString, "null", 4) == 0 ){` |
|        34 |  7042 | `			pOut->nType = UTA_NULL_FLAG; pOut->zCanon = "null"; pOut->nCanon = 4;` |
|        34 |  7043 | `			pIn++;` |
|     38650 |  7044 | `		}else if( pT->nByte == 4 && SyMemcmpNoCase(pT->zString, "void", 4) == 0 ){` |
|       177 |  7045 | `			pOut->nType = UTA_VOID_FLAG; pOut->zCanon = "void"; pOut->nCanon = 4;` |
|       177 |  7046 | `			pIn++;` |
|     38549 |  7047 | `		}else if( pT->nByte == 5 && SyMemcmpNoCase(pT->zString, "never", 5) == 0 ){` |
|        26 |  7048 | `			pOut->nType = UTA_NEVER_FLAG; pOut->zCanon = "never"; pOut->nCanon = 5;` |
|        26 |  7049 | `			pIn++;` |
|        15 |  7050 | `		}else{` |
|         - |  7051 | `			/* Class / interface name; consume namespace path a\b\c */` |
|     38441 |  7052 | `			SyToken *pFirst = pIn;` |
|     38441 |  7053 | `			SyToken *pLast = pIn;` |
|     38441 |  7054 | `			pOut->nType = SXU32_HIGH;` |
|     38441 |  7055 | `			pOut->sClass = pIn->sData;` |
|     38441 |  7056 | `			pIn++;` |
|     57657 |  7057 | `			while( pIn + 1 < pGen->pEnd && (pIn->nType & PH7_TK_NSSEP)` |
|     38444 |  7058 | `				&& (pIn[1].nType & PH7_TK_ID) ){` |
|         3 |  7059 | `				pLast = &pIn[1];` |
|         3 |  7060 | `				pIn += 2;` |
|         1 |  7061 | `			}` |
|     38441 |  7062 | `			if( pLast != pFirst ){` |
...
|         - |  7068 | `		}` |
|         - |  7069 | `	}` |
|    127493 |  7070 | `	pGen->pIn = pIn;` |
|    127493 |  7071 | `	return SXRET_OK;` |
|     63750 |  7072 | `}` |
|         - |  7073 |  |
|         - |  7074 | `/*` |
...
|         - |  7080 | ` */` |
|    127312 |  7081 | `static void GenBuildUnionTypeText(SyBlob *pBlob, PhlTypeAtom *aAtoms, int nAtoms, int bNullable)` |
|         5 |  7082 | `{` |
|         - |  7083 | `	int i;` |
|    127317 |  7084 | `	int nNonNull = 0;` |
|    127317 |  7085 | `	int bAnyIntersection = 0;` |
|         - |  7086 | `	sxu32 aGroupCount[PHL_UNION_MAX_ALTS];` |
|    127317 |  7087 | `	sxu32 nMaxGroup = 0;` |
|   4201301 |  7088 | `	for( i = 0; i < PHL_UNION_MAX_ALTS; i++ ) aGroupCount[i] = 0;` |
|    254781 |  7089 | `	for( i = 0; i < nAtoms; i++ ){` |
|    127469 |  7090 | `		if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|    127439 |  7091 | `			nNonNull++;` |
|    127439 |  7092 | `			if( aAtoms[i].nGroup < PHL_UNION_MAX_ALTS ){` |
|    127439 |  7093 | `				aGroupCount[aAtoms[i].nGroup]++;` |
|    127439 |  7094 | `				if( aAtoms[i].nGroup > nMaxGroup ) nMaxGroup = aAtoms[i].nGroup;` |
|     63717 |  7095 | `			}` |
|     63717 |  7096 | `		}` |
|     63737 |  7097 | `	}` |
|    254729 |  7098 | `	for( i = 0; i < nAtoms; i++ ){` |
|    127441 |  7099 | `		if( aAtoms[i].nType != UTA_NULL_FLAG && aGroupCount[aAtoms[i].nGroup] >= 2 ){` |
|        29 |  7100 | `			bAnyIntersection = 1;` |
|        29 |  7101 | `			break;` |
|         - |  7102 | `		}` |
|     63711 |  7103 | `	}` |
|    127317 |  7104 | `	if( bAnyIntersection ){` |
...
|        83 |  7139 | `		return;` |
|         - |  7140 | `	}` |
|    127293 |  7141 | `	if( nNonNull == 1 && bNullable ){` |
|         - |  7142 | `		/* Shorthand: ?T */` |
...
|       ! 0 |  7153 | `	}` |
|         - |  7154 | `	{` |
|    127185 |  7155 | `		int bFirst = 1;` |
|         - |  7156 | `		/* 1) Classes in declaration order */` |
|    254473 |  7157 | `		for( i = 0; i < nAtoms; i++ ){` |
|    127293 |  7158 | `			if( aAtoms[i].nType == SXU32_HIGH ){` |
|     38391 |  7159 | `				if( !bFirst ) SyBlobAppend(pBlob, "\|", 1);` |
|     38391 |  7160 | `				SyBlobAppend(pBlob, aAtoms[i].sClass.zString, aAtoms[i].sClass.nByte);` |
|     38391 |  7161 | `				bFirst = 0;` |
|     19193 |  7162 | `			}` |
|     63649 |  7163 | `		}` |
...
|         - |  7168 | `			int k;` |
|    890265 |  7169 | `			for( k = 0; k < (int)(sizeof(aOrder)/sizeof(aOrder[0])); k++ ){` |
|   1438001 |  7170 | `				for( i = 0; i < nAtoms; i++ ){` |
|    763621 |  7171 | `					if( aAtoms[i].nType == aOrder[k] ){` |
|     88705 |  7172 | `						if( !bFirst ) SyBlobAppend(pBlob, "\|", 1);` |
|     88705 |  7173 | `						SyBlobAppend(pBlob, aAtoms[i].zCanon, aAtoms[i].nCanon);` |
|     88705 |  7174 | `						bFirst = 0;` |
|     88705 |  7175 | `						break;` |
|         - |  7176 | `					}` |
|    337463 |  7177 | `				}` |
...
|         - |  7201 | ` */` |
|    127464 |  7202 | `static sxi32 GenStateParsePart(` |
|         - |  7203 | `	ph7_gen_state *pGen, PhlTypeAtom *aAtoms, int *pnAtoms, sxu32 iGroup,` |
|         - |  7204 | `	int *pnMembers, int *pbParen, sxu32 nLine)` |
|         5 |  7205 | `{` |
|         - |  7206 | `	sxi32 rc;` |
|    127469 |  7207 | `	int nMembers = 0;` |
|    127469 |  7208 | `	int bParen = 0;` |
|    127469 |  7209 | `	*pnMembers = 0;` |
|    127469 |  7210 | `	*pbParen = 0;` |
|    127469 |  7211 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_LPAREN) ){` |
|         9 |  7212 | `		bParen = 1;` |
|         9 |  7213 | `		pGen->pIn++; /* skip '(' */` |
|         3 |  7214 | `	}` |
|     63732 |  7215 | `	for(;;){` |
|    127495 |  7216 | `		if( *pnAtoms >= PHL_UNION_MAX_ALTS ){` |
...
|         - |  7220 | `		}` |
|    127495 |  7221 | `		rc = GenStateParseOneTypeAtom(pGen, &aAtoms[*pnAtoms]);` |
|    127495 |  7222 | `		if( rc != SXRET_OK ){` |
|         3 |  7223 | `			return rc;` |
|         - |  7224 | `		}` |
|    127493 |  7225 | `		aAtoms[*pnAtoms].nGroup = iGroup;` |
|    127493 |  7226 | `		(*pnAtoms)++;` |
|    127493 |  7227 | `		nMembers++;` |
|         - |  7228 | ``		/* Continue the intersection while `&` is followed by another type atom. */`` |
|    127493 |  7229 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
...
|         - |  7250 | `		}` |
|         3 |  7251 | `	}` |
|    127467 |  7252 | `	*pnMembers = nMembers;` |
|    127467 |  7253 | `	*pbParen = bParen;` |
|    127467 |  7254 | `	return SXRET_OK;` |
|     63737 |  7255 | `}` |
|         - |  7256 |  |
|         - |  7257 | `/*` |
...
|         - |  7274 | ` */` |
|    127328 |  7275 | `static sxi32 GenStateParseUnionTypeDecl(` |
...
|    127333 |  7288 | `	int nAtoms = 0;` |
|    127333 |  7289 | `	int bShortNullable = 0;` |
|    127333 |  7290 | `	int bExplicitNull = 0;` |
|         - |  7291 | `	sxi32 rc;` |
|    127333 |  7292 | `	*pnType = 0;` |
|    127333 |  7293 | `	if( pClass ) SyStringInitFromBuf(pClass, 0, 0);` |
|    127333 |  7294 | `	*piTypeFlags = 0;` |
|    127333 |  7295 | `	if( pTypeText ) SyStringInitFromBuf(pTypeText, 0, 0);` |
|         - |  7296 |  |
|    127333 |  7297 | `	if( pGen->pIn >= pGen->pEnd ){` |
|       ! 0 |  7298 | `		return SXRET_OK;` |
|         - |  7299 | `	}` |
|         - |  7300 | ``	/* Optional `?` shorthand prefix */`` |
|    127328 |  7301 | `	if( (pGen->pIn->nType & PH7_TK_OP) && pGen->pIn->sData.nByte == 1` |
...
|    127333 |  7314 | `		sxu32 iGroup = 0;` |
|    127333 |  7315 | `		rc = GenStateParsePart(pGen, aAtoms, &nAtoms, iGroup, &nMembers, &bParen, nLine);` |
|    127333 |  7316 | `		if( rc != SXRET_OK ){` |
|         4 |  7317 | `			return rc;` |
|         - |  7318 | `		}` |
...
|    191198 |  7324 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OP)` |
|    127540 |  7325 | `			&& pGen->pIn->sData.nByte == 1 && pGen->pIn->sData.zString[0] == '\|' ){` |
...
|         - |  7343 | `			}` |
|         5 |  7344 | `		}` |
|    127329 |  7345 | `		if( iGroup > 0 && nMembers >= 2 && !bParen ){` |
...
|         - |  7357 | `	{` |
|         - |  7358 | `		int i, j;` |
|    127329 |  7359 | `		int bHasNonNull = 0;` |
|    127329 |  7360 | `		int bAnyIntersection = 0;` |
...
|   4201697 |  7364 | `		for( i = 0; i < PHL_UNION_MAX_ALTS; i++ ) aGroupCount[i] = 0;` |
|    254815 |  7365 | `		for( i = 0; i < nAtoms; i++ ){` |
|    127491 |  7366 | `			if( aAtoms[i].nGroup < PHL_UNION_MAX_ALTS ) aGroupCount[aAtoms[i].nGroup]++;` |
|     63748 |  7367 | `		}` |
|    254759 |  7368 | `		for( i = 0; i < nAtoms; i++ ){` |
|    127461 |  7369 | `			if( aGroupCount[aAtoms[i].nGroup] >= 2 ){ bAnyIntersection = 1; break; }` |
|     63720 |  7370 | `		}` |
...
|    127329 |  7373 | `		if( bShortNullable && bAnyIntersection ){` |
...
|         - |  7377 | `		}` |
|    254801 |  7378 | `		for( i = 0; i < nAtoms; i++ ){` |
...
|    127489 |  7382 | `			if( aGroupCount[aAtoms[i].nGroup] >= 2 ){` |
...
|         - |  7404 | `				}` |
|        24 |  7405 | `			}` |
|    127487 |  7406 | `			if( aAtoms[i].nType == UTA_VOID_FLAG ){` |
...
|         - |  7421 | `				}` |
|        85 |  7422 | `			}` |
|    127485 |  7423 | `			if( aAtoms[i].nType == UTA_NEVER_FLAG ){` |
...
|         - |  7440 | `				}` |
|         8 |  7441 | `			}` |
|    127479 |  7442 | `			if( aAtoms[i].nType == UTA_NULL_FLAG ){` |
|        34 |  7443 | `				bExplicitNull = 1;` |
|        19 |  7444 | `			}else{` |
|    127449 |  7445 | `				bHasNonNull = 1;` |
|         - |  7446 | `			}` |
...
|        99 |  7484 | `			}` |
|     63741 |  7485 | `		}` |
|    127317 |  7486 | `		if( !bHasNonNull && bExplicitNull ){` |
...
|    127317 |  7501 | `	if( bShortNullable \|\| bExplicitNull ){` |
|       129 |  7502 | `		*piTypeFlags \|= iNullableFlag;` |
|        62 |  7503 | `	}` |
|         - |  7504 | `	/* Build canonical type text */` |
|    127317 |  7505 | `	if( pTypeText ){` |
|         - |  7506 | `		SyBlob sBlob;` |
|    127317 |  7507 | `		SyBlobInit(&sBlob, &pGen->pVm->sAllocator);` |
|    190926 |  7508 | `		GenBuildUnionTypeText(&sBlob, aAtoms, nAtoms,` |
|     63656 |  7509 | `			(bShortNullable \|\| bExplicitNull) ? 1 : 0);` |
|    127317 |  7510 | `		if( SyBlobLength(&sBlob) > 0 ){` |
|    190694 |  7511 | `			char *zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|    127126 |  7512 | `				(const char *)SyBlobData(&sBlob), SyBlobLength(&sBlob));` |
|    127131 |  7513 | `			if( zDup ){` |
|    127131 |  7514 | `				SyStringInitFromBuf(pTypeText, zDup, SyBlobLength(&sBlob));` |
|     63563 |  7515 | `			}` |
|     63563 |  7516 | `		}` |
|    127317 |  7517 | `		SyBlobRelease(&sBlob);` |
|     63656 |  7518 | `	}` |
...
|         - |  7522 | `	{` |
|    127317 |  7523 | `		int nNonNull = 0;` |
|    127317 |  7524 | `		int iNonNullIdx = -1;` |
|         - |  7525 | `		int i;` |
|    254781 |  7526 | `		for( i = 0; i < nAtoms; i++ ){` |
|    127469 |  7527 | `			if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|    127439 |  7528 | `				nNonNull++;` |
|    127439 |  7529 | `				iNonNullIdx = i;` |
|     63717 |  7530 | `			}` |
|     63737 |  7531 | `		}` |
|    127317 |  7532 | `		if( nNonNull <= 1 ){` |
|         - |  7533 | `			/* Fast path: store as single type. */` |
|    127211 |  7534 | `			if( iNonNullIdx >= 0 ){` |
|    127205 |  7535 | `				PhlTypeAtom *pA = &aAtoms[iNonNullIdx];` |
|    127205 |  7536 | `				if( pA->nType == SXU32_HIGH ){` |
|     57548 |  7537 | `					char *zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|     19181 |  7538 | `						pA->sClass.zString, pA->sClass.nByte);` |
|     38367 |  7539 | `					if( zDup == 0 ) return SXERR_ABORT;` |
|     38367 |  7540 | `					*pnType = SXU32_HIGH;` |
|     38367 |  7541 | `					if( pClass ) SyStringInitFromBuf(pClass, zDup, pA->sClass.nByte);` |
|    108024 |  7542 | `				}else if( pA->nType == UTA_VOID_FLAG ){` |
|       175 |  7543 | `					*pnType = MEMOBJ_VOID;` |
|     88758 |  7544 | `				}else if( pA->nType == UTA_NEVER_FLAG ){` |
|        18 |  7545 | `					*pnType = MEMOBJ_NEVER;` |
|        10 |  7546 | `				}else{` |
|     88657 |  7547 | `					*pnType = pA->nType;` |
|         - |  7548 | `				}` |
|     63600 |  7549 | `			}` |
|     63608 |  7550 | `		}else{` |
...
|         - |  7582 | ` */` |
|   2832632 |  7583 | `static sxi32 GenStateParseReturnType(ph7_gen_state *pGen, ph7_vm_func *pFunc)` |
|         5 |  7584 | `{` |
|   2832637 |  7585 | `	sxi32 iFlags = 0;` |
|         - |  7586 | `	sxi32 rc;` |
|         - |  7587 | `	sxu32 nLine;` |
|   2832637 |  7588 | `	pFunc->nReturnType = 0;` |
|   2832637 |  7589 | `	SyStringInitFromBuf(&pFunc->sReturnClass, 0, 0);` |
|   2832637 |  7590 | `	SyStringInitFromBuf(&pFunc->sReturnTypeName, 0, 0);` |
...
|   2832637 |  7596 | `	SySetReset(&pFunc->aReturnUnion);` |
|   2832637 |  7597 | `	pFunc->iFlags &= ~VM_FUNC_RETURN_NULLABLE;` |
|   2832637 |  7598 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COLON) == 0 ){` |
|   2820541 |  7599 | `		return SXRET_OK;` |
|         - |  7600 | `	}` |
|     12101 |  7601 | `	pGen->pIn++; /* Skip ':' */` |
|     12101 |  7602 | `	if( pGen->pIn >= pGen->pEnd ){` |
|       ! 0 |  7603 | `		return SXRET_OK;` |
|         - |  7604 | `	}` |
|     12101 |  7605 | `	nLine = pGen->pIn->nLine;` |
|     12101 |  7606 | `	rc = GenStateParseUnionTypeDecl(` |
|      6048 |  7607 | `		pGen,` |
|      6048 |  7608 | `		&pFunc->nReturnType,` |
|      6048 |  7609 | `		&pFunc->sReturnClass,` |
|      6048 |  7610 | `		&pFunc->aReturnUnion,` |
|         - |  7611 | `		&iFlags,` |
|      6048 |  7612 | `		&pFunc->sReturnTypeName,` |
...
|         - |  7616 | `		/* bAllowVoid */ 1,` |
|      6048 |  7617 | `		nLine);` |
|     12101 |  7618 | `	if( rc == SXERR_ABORT ){` |
|       ! 0 |  7619 | `		return SXERR_ABORT;` |
|         - |  7620 | `	}` |
|     12101 |  7621 | `	if( rc == SXERR_CORRUPT ){` |
|         - |  7622 | `		/* Error already reported */` |
|       ! 0 |  7623 | `		return SXERR_SYNTAX;` |
|         - |  7624 | `	}` |
|     12101 |  7625 | `	if( rc == SXERR_SYNTAX ){` |
...
|         - |  7635 | `	}` |
|     12095 |  7636 | `	pFunc->iFlags \|= (iFlags & VM_FUNC_RETURN_NULLABLE);` |
|     12095 |  7637 | `	return SXRET_OK;` |
|   1416321 |  7638 | `}` |
|         - |  7639 |  |
|    451878 |  7640 | `static sxi32 GenStateCompileFunc(` |
...
|    451883 |  7654 | `	nLine = pGen->pIn->nLine;` |
|         - |  7655 | `	/* Jump the left parenthesis '(' */` |
|    451883 |  7656 | `	pGen->pIn++;` |
|         - |  7657 | `	/* Delimit the function signature */` |
|    451883 |  7658 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|    451883 |  7659 | `	if( pEnd >= pGen->pEnd ){` |
|         - |  7660 | `		/* Syntax error */` |
...
|    451877 |  7671 | `	pFunc = (ph7_vm_func *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_vm_func));` |
|    451877 |  7672 | `	if( pFunc == 0 ){` |
|       ! 0 |  7673 | `		goto OutOfMem;` |
|         - |  7674 | `	}` |
|         - |  7675 | `	/* Build the function name, prepending namespace if active */` |
|    451884 |  7676 | `	if( SyBlobLength(&pGen->sNamespace) > 0 && !bHandleClosure ){` |
|         - |  7677 | `		SyBlob sFQN;` |
|         - |  7678 | `		sxu32 nLen;` |
...
|         9 |  7690 | `	}else{` |
|    451863 |  7691 | `		zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|    451863 |  7692 | `		if( zName == 0 ){` |
|       ! 0 |  7693 | `			goto OutOfMem;` |
|         - |  7694 | `		}` |
|    451863 |  7695 | `		PH7_VmInitFuncState(pGen->pVm,pFunc,zName,pName->nByte,iFlags,0);` |
|         - |  7696 | `	}` |
...
|    451877 |  7699 | `	pFunc->nLine = nLine;` |
|    451877 |  7700 | `	GenStateConsumeDoc(&(*pGen),&pFunc->sDoc);` |
|    451877 |  7701 | `	if( GenStateConsumeAttrs(&(*pGen),&pFunc->aAttrs) == SXERR_ABORT ){` |
|       ! 0 |  7702 | `		return SXERR_ABORT;` |
|         - |  7703 | `	}` |
|    451877 |  7704 | `	if( pGen->pIn < pEnd ){` |
|         - |  7705 | `		/* Collect function arguments */` |
|    389969 |  7706 | `		rc = GenStateCollectFuncArgs(pFunc,&(*pGen),pEnd,0,0);` |
|    389969 |  7707 | `		if( rc == SXERR_ABORT ){` |
...
|    451877 |  7713 | `	pGen->pIn = &pEnd[1];` |
|         - |  7714 | `	{` |
|    451877 |  7715 | `		sxi32 rcRt = GenStateParseReturnType(pGen, pFunc);` |
|    451877 |  7716 | `		if( rcRt == SXERR_ABORT ){` |
|       ! 0 |  7717 | `			return SXERR_ABORT;` |
|    451877 |  7718 | `		}else if( rcRt == SXERR_SYNTAX ){` |
|         9 |  7719 | `			return SXERR_SYNTAX;` |
|         - |  7720 | `		}` |
|         - |  7721 | `	}` |
|    451871 |  7722 | `	if( bHandleClosure ){` |
|         - |  7723 | `		ph7_vm_func_closure_env sEnv;` |
|       569 |  7724 | `		int got_this = 0; /* TRUE if $this have been seen */` |
|       564 |  7725 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD)` |
|       330 |  7726 | `			&& SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_USE ){` |
...
|         3 |  7809 | `				}` |
|        43 |  7810 | `		}` |
|       569 |  7811 | `		if( !got_this && (iFlags & VM_FUNC_STATIC_CL) == 0 ){` |
...
|       561 |  7819 | `			SyZero(&sEnv,sizeof(ph7_vm_func_closure_env));` |
|       561 |  7820 | `			sEnv.iFlags = VM_FUNC_ARG_IGNORE; /* Do not install if NULL */` |
|       561 |  7821 | `			sEnv.nIdx = SXU32_HIGH;` |
|       561 |  7822 | `			PH7_MemObjInit(pGen->pVm,&sEnv.sValue);` |
|       561 |  7823 | `			SyStringInitFromBuf(&sEnv.sName,"this",sizeof("this")-1);` |
|       561 |  7824 | `			SySetPut(&pFunc->aClosureEnv,(const void *)&sEnv);` |
|       278 |  7825 | `		}` |
|       569 |  7826 | `		if( SySetUsed(&pFunc->aClosureEnv) > 0 ){` |
|         - |  7827 | `			/* Mark as closure */` |
|       563 |  7828 | `			pFunc->iFlags \|= VM_FUNC_CLOSURE;` |
|       279 |  7829 | `		}` |
|       282 |  7830 | `	}` |
|         - |  7831 | `	/* Compile the body */` |
|    451871 |  7832 | `	rc = GenStateCompileFuncBody(&(*pGen),pFunc);` |
|    451871 |  7833 | `	if( rc == SXERR_ABORT ){` |
|       ! 0 |  7834 | `		return SXERR_ABORT;` |
|         - |  7835 | `	}` |
|         - |  7836 | `	/* The cursor sits just past the body's closing brace */` |
|    451871 |  7837 | `	pFunc->nEndLine = pGen->pIn[-1].nLine;` |
|    451871 |  7838 | `	if( ppFunc ){` |
|    451871 |  7839 | `		*ppFunc = pFunc;` |
|    225933 |  7840 | `	}` |
|    451871 |  7841 | `	rc = SXRET_OK;` |
|    451871 |  7842 | `	if( (pFunc->iFlags & VM_FUNC_CLOSURE) == 0 ){` |
|         - |  7843 | `		/* Finally register the function */` |
|    451313 |  7844 | `		rc = PH7_VmInstallUserFunction(pGen->pVm,pFunc,0);` |
|    225654 |  7845 | `	}` |
|    451871 |  7846 | `	if( rc == SXRET_OK ){` |
|    451871 |  7847 | `		return SXRET_OK;` |
|         - |  7848 | `	}` |
...
|         - |  7860 | ` */` |
|    451322 |  7861 | `static sxi32 PH7_CompileFunction(ph7_gen_state *pGen)` |
|         5 |  7862 | `{` |
|         - |  7863 | `	SyString *pName;` |
|         - |  7864 | `	sxi32 iFlags;` |
|         - |  7865 | `	sxu32 nKwLine;` |
...
|         - |  7867 | `	sxi32 rc;` |
|         - |  7868 |  |
|    451327 |  7869 | `	nLine = pGen->pIn->nLine;` |
|    451327 |  7870 | `	nKwLine = nLine; /* Line of the 'function' keyword (Reflection getStartLine) */` |
|    451327 |  7871 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|    451327 |  7872 | `	iFlags = 0;` |
|    451327 |  7873 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|         - |  7874 | `		/* Return by reference,remember that */` |
|        12 |  7875 | `		iFlags \|= VM_FUNC_REF_RETURN;` |
|         - |  7876 | `		/* Jump the '&' token */` |
|        12 |  7877 | `		pGen->pIn++;` |
|         5 |  7878 | `	}` |
|    451327 |  7879 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|         - |  7890 | `	}` |
|    451321 |  7891 | `	pName = &pGen->pIn->sData;` |
|    451321 |  7892 | `	nLine = pGen->pIn->nLine;` |
|         - |  7893 | `	/* Jump the function name */` |
|    451321 |  7894 | `	pGen->pIn++;` |
|    451321 |  7895 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|         - |  7896 | `		/* Syntax error */` |
...
|         - |  7909 | `	{` |
|    451319 |  7910 | `		ph7_vm_func *pFuncState = 0;` |
|    451319 |  7911 | `		rc = GenStateCompileFunc(&(*pGen),pName,iFlags,FALSE,&pFuncState);` |
|    451319 |  7912 | `		if( pFuncState ){` |
|         - |  7913 | `			/* Reflection getStartLine(): line of the 'function' keyword */` |
|    451307 |  7914 | `			pFuncState->nLine = nKwLine;` |
|    225651 |  7915 | `		}` |
|         - |  7916 | `	}` |
|    451319 |  7917 | `	return rc;` |
|    225666 |  7918 | `}` |
|         - |  7919 | `/*` |
...
|         - |  8601 | ` */` |
|  19808644 |  8602 | `static int GenStateIsReadonly(SyToken *pTok)` |
|         5 |  8603 | `{` |
|  20026644 |  8604 | `	return (pTok->nType & PH7_TK_ID)` |
|  10122317 |  8605 | `		&& pTok->sData.nByte == sizeof("readonly")-1` |
|  20026639 |  8606 | `		&& SyStrnicmp(pTok->sData.zString,"readonly",sizeof("readonly")-1) == 0;` |
|         5 |  8607 | `}` |
|         - |  8608 | `/*` |
...
|         - |  8613 | ` */` |
|   7185302 |  8614 | `static sxi32 GenStatePeekSetVisibility(SyToken *pTok,SyToken *pEnd,int *pnTok)` |
|         5 |  8615 | `{` |
|   7185307 |  8616 | `	*pnTok = 0;` |
|   7185302 |  8617 | `	if( &pTok[3] < pEnd` |
|   6742230 |  8618 | `	 && (pTok->nType & PH7_TK_KEYWORD)` |
|   5570200 |  8619 | `	 && (pTok[1].nType & PH7_TK_LPAREN)` |
...
|         - | 10251 | ` */` |
|    398512 | 10252 | `static sxi32 GenStateParseClassReference(ph7_gen_state *pGen,SyBlob *pFqn)` |
|         5 | 10253 | `{` |
|    398517 | 10254 | `	int isAbsolute = 0;` |
|    398517 | 10255 | `	SyToken *pStart = pGen->pIn;` |
|         - | 10256 | `	SyBlob sName;` |
|    398517 | 10257 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) ){` |
|      4407 | 10258 | `		isAbsolute = 1;` |
|      4407 | 10259 | `		pGen->pIn++;` |
|      2201 | 10260 | `	}` |
|    398517 | 10261 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|         9 | 10262 | `		pGen->pIn = pStart;` |
|         9 | 10263 | `		return SXERR_INVALID;` |
|         - | 10264 | `	}` |
|    398511 | 10265 | `	SyBlobInit(&sName,&pGen->pVm->sAllocator);` |
|    398511 | 10266 | `	SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|    398511 | 10267 | `	pGen->pIn++;` |
|    597780 | 10268 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) &&` |
|    199279 | 10269 | `		&pGen->pIn[1] < pGen->pEnd && (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|        16 | 10270 | `		SyBlobAppend(&sName,"\\",1);` |
|        16 | 10271 | `		pGen->pIn++;` |
|        16 | 10272 | `		SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|        16 | 10273 | `		pGen->pIn++;` |
|         2 | 10274 | `	}` |
|    398511 | 10275 | `	if( isAbsolute ){` |
|      4405 | 10276 | `		SyBlobAppend(pFqn,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|      2205 | 10277 | `	}else{` |
|         - | 10278 | `		SyString sRaw;` |
...
|         - | 10281 | `	}` |
|    398511 | 10282 | `	SyBlobRelease(&sName);` |
|    398511 | 10283 | `	return SXRET_OK;` |
|    199261 | 10284 | `}` |
|         - | 10285 | `/*` |
...
|         - | 11663 | ` */` |
|  12405540 | 11664 | `static int GenStateTokenIsClassModifier(SyToken *pTok,sxi32 *piFlag)` |
|         5 | 11665 | `{` |
|  12405545 | 11666 | `	if( pTok->nType & PH7_TK_KEYWORD ){` |
|   7279463 | 11667 | `		sxu32 nKw = (sxu32)SX_PTR_TO_INT(pTok->pUserData);` |
|   7279463 | 11668 | `		if( nKw == PH7_TKWRD_FINAL ){ *piFlag = PH7_CLASS_FINAL; return TRUE; }` |
|   7233693 | 11669 | `		if( nKw == PH7_TKWRD_ABSTRACT ){ *piFlag = PH7_CLASS_ABSTRACT; return TRUE; }` |
|   3601551 | 11670 | `	}` |
|  12329189 | 11671 | `	if( GenStateIsReadonly(pTok) ){ *piFlag = PH7_CLASS_READONLY; return TRUE; }` |
|  12329129 | 11672 | `	return FALSE;` |
|   6202775 | 11673 | `}` |
|         - | 11674 | `/*` |
...
|         - | 11679 | ` */` |
|  12329124 | 11680 | `static sxi32 GenStateScanClassModifiers(SyToken **ppIn,SyToken *pEnd,SyToken **ppDup)` |
|         5 | 11681 | `{` |
|  12329129 | 11682 | `	SyToken *pIn = *ppIn,*pDup = 0;` |
|  12329129 | 11683 | `	sxi32 iFlags = 0,iFlag;` |
|  12405545 | 11684 | `	while( pIn < pEnd && GenStateTokenIsClassModifier(pIn,&iFlag) ){` |
...
|     76421 | 11689 | `		pIn++;` |
|         5 | 11690 | `	}` |
|  12329129 | 11691 | `	*ppIn = pIn;` |
|  12329129 | 11692 | `	if( ppDup ){ *ppDup = pDup; }` |
|  12329129 | 11693 | `	return iFlags;` |
|         5 | 11694 | `}` |
|         - | 11695 | `/*` |
...
|         - | 11701 | ` */` |
|  12294738 | 11702 | `static int GenStateStartsModifiedClass(SyToken *pIn,SyToken *pEnd)` |
|         5 | 11703 | `{` |
|  12294743 | 11704 | `	sxi32 iFlags = GenStateScanClassModifiers(&pIn,pEnd,0);` |
|   6189386 | 11705 | `	return iFlags != 0 && pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD)` |
|  12315745 | 11706 | `		&& (sxu32)SX_PTR_TO_INT(pIn->pUserData) == PH7_TKWRD_CLASS;` |
|         5 | 11707 | `}` |
|         - | 11708 | `/*` |
...
|         - | 12057 | ` */` |
|  12252728 | 12058 | `static int GenStateStartsEnumDecl(SyToken *pIn,SyToken *pEnd)` |
|         5 | 12059 | `{` |
|  12457284 | 12060 | `	return (pIn->nType & PH7_TK_ID)` |
|   6330915 | 12061 | `		&& pIn->sData.nByte == sizeof("enum")-1` |
|    214209 | 12062 | `		&& SyStrnicmp(pIn->sData.zString,"enum",sizeof("enum")-1) == 0` |
|  12457279 | 12063 | `		&& &pIn[1] < pEnd && (pIn[1].nType & PH7_TK_ID);` |
|         5 | 12064 | `}` |
|         - | 12065 | `/*` |
...
|         - | 12404 | ` */` |
|     24384 | 12405 | `static sxi32 PH7_CompileCatch(ph7_gen_state *pGen,ph7_exception *pException)` |
|         5 | 12406 | `{` |
|     24389 | 12407 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|         - | 12414 | `	char *zDup;` |
|         - | 12415 | `	sxi32 rc;` |
|     24389 | 12416 | `	pGen->pIn++; /* Jump the 'catch' keyword */` |
|         - | 12417 | `	/* Zero the structure */` |
|     24389 | 12418 | `	SyZero(&sCatch,sizeof(ph7_exception_block));` |
|         - | 12419 | `	/* Initialize fields */` |
|     24389 | 12420 | `	SySetInit(&sCatch.aClasses,&pException->pVm->sAllocator,sizeof(SyString));` |
|     24389 | 12421 | `	SySetInit(&sCatch.sByteCode,&pException->pVm->sAllocator,sizeof(VmInstr));` |
|     24389 | 12422 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 /*(*/ ){` |
...
|     24389 | 12437 | `	pGen->pIn++; /* Jump the left parenthesis '(' */` |
|     12206 | 12438 | `	for(;;){` |
|         - | 12439 | `		SyBlob sResolved;` |
|     24417 | 12440 | `		SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|     24417 | 12441 | `		if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|     36617 | 12457 | `		zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|     24408 | 12458 | `			(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|     24413 | 12459 | `		SyStringInitFromBuf(&sClassName,zDup,SyBlobLength(&sResolved));` |
|     24413 | 12460 | `		SyBlobRelease(&sResolved);` |
|     24413 | 12461 | `		if( zDup == 0 ){` |
|       ! 0 | 12462 | `			goto Mem;` |
|         - | 12463 | `		}` |
|     24413 | 12464 | `		rc = SySetPut(&sCatch.aClasses,(const void *)&sClassName);` |
|     24413 | 12465 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 12466 | `			goto Mem;` |
|         - | 12467 | `		}` |
|         - | 12468 | `		/* Check for '\|' (multi-catch separator) */` |
|     24408 | 12469 | `		if( pGen->pIn < pGen->pEnd &&` |
|     24408 | 12470 | `			(pGen->pIn->nType & PH7_TK_OP) &&` |
...
|     24385 | 12476 | `		break;` |
|       ! 0 | 12477 | `	}` |
|     24380 | 12478 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 /*$*/ \|\|` |
|     24385 | 12479 | `		&pGen->pIn[1] >= pGen->pEnd \|\| (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|         - | 12492 | `	}` |
|     24385 | 12493 | `	pGen->pIn++; /* Jump the dollar sign */` |
|         - | 12494 | `	/* Duplicate instance name */` |
|     24385 | 12495 | `	pName = &pGen->pIn->sData;` |
|     24385 | 12496 | `	zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|     24385 | 12497 | `	if( zDup == 0 ){` |
|       ! 0 | 12498 | `		goto Mem;` |
|         - | 12499 | `	}` |
|     24385 | 12500 | `	SyStringInitFromBuf(&sCatch.sThis,zDup,pName->nByte);` |
|     24385 | 12501 | `	pGen->pIn++;` |
|     24385 | 12502 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_RPAREN) == 0 /*)*/ ){` |
...
|     24385 | 12517 | `	pGen->pIn++; /* Jump the right parenthesis */` |
|         - | 12518 | `	/* Create the catch block */` |
|     24385 | 12519 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_EXCEPTION,PH7_VmInstrLength(pGen->pVm),0,&pCatch);` |
|     24385 | 12520 | `	if( rc != SXRET_OK ){` |
|       ! 0 | 12521 | `		return SXERR_ABORT;` |
|         - | 12522 | `	}` |
|         - | 12523 | `	/* Swap bytecode container */` |
|     24385 | 12524 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|     24385 | 12525 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&sCatch.sByteCode);` |
|         - | 12526 | `	/* Compile the block */` |
|     24385 | 12527 | `	PH7_CompileBlock(&(*pGen),0);` |
|         - | 12528 | `	/* Fix forward jumps now the destination is resolved  */` |
|     24385 | 12529 | `	GenStateFixJumps(pCatch,-1,PH7_VmInstrLength(pGen->pVm));` |
|         - | 12530 | `	/* Emit the DONE instruction */` |
|     24385 | 12531 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|         - | 12532 | `	/* Leave the block */` |
|     24385 | 12533 | `	GenStateLeaveBlock(&(*pGen),0);` |
|         - | 12534 | `	/* Restore the default container */` |
|     24385 | 12535 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|         - | 12536 | `	/* Install the catch block */` |
|     24385 | 12537 | `	rc = SySetPut(&pException->sEntry,(const void *)&sCatch);` |
|     24385 | 12538 | `	if( rc != SXRET_OK ){` |
|       ! 0 | 12539 | `		goto Mem;` |
|         - | 12540 | `	}` |
|     24385 | 12541 | `	return SXRET_OK;` |
|       ! 0 | 12542 | `Mem:` |
...
|         - | 12551 | ` * is "thrown".` |
|         - | 12552 | ` */` |
|     24540 | 12553 | `static sxi32 PH7_CompileTry(ph7_gen_state *pGen)` |
|         5 | 12554 | `{` |
|         - | 12555 | `	ph7_exception *pException;` |
|     24545 | 12556 | `	sxu32 nLine = pGen->pIn->nLine;` |
|         - | 12557 | `	GenBlock *pTry;` |
|         - | 12558 | `	sxu32 nJmpIdx;` |
|         - | 12559 | `	sxi32 rc;` |
|         - | 12560 | `	/* Create the exception container */` |
|     24545 | 12561 | `	pException = (ph7_exception *)SyMemBackendAlloc(&pGen->pVm->sAllocator,sizeof(ph7_exception));` |
|     24545 | 12562 | `	if( pException == 0 ){` |
...
|     24545 | 12568 | `	SyZero(pException,sizeof(ph7_exception));` |
|         - | 12569 | `	/* Initialize fields */` |
|     24545 | 12570 | `	SySetInit(&pException->sEntry,&pGen->pVm->sAllocator,sizeof(ph7_exception_block));` |
|     24545 | 12571 | `	SySetInit(&pException->sFinally,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|     24545 | 12572 | `	pException->iHasFinally = 0;` |
|     24545 | 12573 | `	pException->iFinallyDone = 0;` |
|     24545 | 12574 | `	pException->pVm = pGen->pVm;` |
...
|     24545 | 12581 | `	if( pGen->bInGenerator && pGen->pVm->bInlineTryCatch ){` |
|       103 | 12582 | `		return PH7_CompileTryInline(&(*pGen),pException);` |
|         - | 12583 | `	}` |
|         - | 12584 | `	/* Create the try block */` |
|     24447 | 12585 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_EXCEPTION,PH7_VmInstrLength(pGen->pVm),0,&pTry);` |
|     24447 | 12586 | `	if( rc != SXRET_OK ){` |
|       ! 0 | 12587 | `		return SXERR_ABORT;` |
|         - | 12588 | `	}` |
|         - | 12589 | `	/* Store exception pointer so break/continue can emit POP_EXCEPTION */` |
|     24447 | 12590 | `	pTry->pUserData = pException;` |
|         - | 12591 | `	/* Emit the 'LOAD_EXCEPTION' instruction */` |
|     24447 | 12592 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_EXCEPTION,0,0,pException,&nJmpIdx);` |
|         - | 12593 | `	/* Fix the jump later when the destination is resolved */` |
|     24447 | 12594 | `	GenStateNewJumpFixup(pTry,PH7_OP_LOAD_EXCEPTION,nJmpIdx);` |
|     24447 | 12595 | `	pGen->pIn++; /* Jump the 'try' keyword */` |
|         - | 12596 | `	/* Compile the block */` |
|     24447 | 12597 | `	rc = PH7_CompileBlock(&(*pGen),0);` |
|     24447 | 12598 | `	if( rc == SXERR_ABORT ){` |
|       ! 0 | 12599 | `		return SXERR_ABORT;` |
|         - | 12600 | `	}` |
|         - | 12601 | `	/* Fix forward jumps now the destination is resolved */` |
|     24447 | 12602 | `	GenStateFixJumps(pTry,-1,PH7_VmInstrLength(pGen->pVm));` |
|         - | 12603 | `	/* Emit the 'POP_EXCEPTION' instruction */` |
|     24447 | 12604 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP_EXCEPTION,0,0,pException,0);` |
|         - | 12605 | `	/* Leave the block */` |
|     24447 | 12606 | `	GenStateLeaveBlock(&(*pGen),0);` |
|         - | 12607 | `	/* Compile catch block(s) — at least one catch or finally is required */` |
|     24447 | 12608 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|     24440 | 12609 | `		SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_CATCH ){` |
|         - | 12610 | `		/* Compile one or more catch blocks */` |
|     24380 | 12611 | `		for(;;){` |
|     48760 | 12612 | `			if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0` |
|     36626 | 12613 | `				\|\| SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_CATCH ){` |
|     12193 | 12614 | `					break;` |
|         - | 12615 | `			}` |
|     24389 | 12616 | `			rc = PH7_CompileCatch(&(*pGen),pException);` |
|     24389 | 12617 | `			if( rc == SXERR_ABORT ){` |
|       ! 0 | 12618 | `				return SXERR_ABORT;` |
|         - | 12619 | `			}` |
|         5 | 12620 | `		}` |
|     12188 | 12621 | `	}` |
|         - | 12622 | `	/* Compile optional finally block */` |
|     24447 | 12623 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
...
|     24447 | 12653 | `	if( SySetUsed(&pException->sEntry) == 0 && !pException->iHasFinally ){` |
...
|         - | 13016 | ` */` |
|  46344584 | 13017 | `static void GenStatePatchNullsafeJumps(ph7_gen_state *pGen, sxu32 nBaseline)` |
|         5 | 13018 | `{` |
|  46344589 | 13019 | `	sxu32 nCur = SySetUsed(&pGen->aNullsafeJmp);` |
|         - | 13020 | `	sxu32 nTarget;` |
|         - | 13021 | `	sxu32 *aIdx;` |
|         - | 13022 | `	sxu32 i;` |
|  46344589 | 13023 | `	if( nCur <= nBaseline ){` |
|  46344493 | 13024 | `		return;` |
|         - | 13025 | `	}` |
...
|         - | 13053 | ` */` |
|   6014228 | 13054 | `static sxu32 GenStateByRefBuiltinMask(SyString *pName)` |
|         5 | 13055 | `{` |
...
|         - | 13070 | `	};` |
|         - | 13071 | `	sxu32 i;` |
|   6014233 | 13072 | `	if( pName == 0 \|\| pName->zString == 0 \|\| pName->nByte == 0 ){` |
|   1605717 | 13073 | `		return 0;` |
|         - | 13074 | `	}` |
|  43668747 | 13075 | `	for( i = 0 ; i < SX_ARRAYSIZE(aByRef) ; ++i ){` |
|  39317550 | 13076 | `		if( pName->nByte == aByRef[i].nByte` |
|  20711712 | 13077 | `		 && SyStrnicmp(pName->zString, aByRef[i].zName, pName->nByte) == 0 ){` |
|     57329 | 13078 | `			return aByRef[i].mask;` |
|         - | 13079 | `		}` |
|  19630118 | 13080 | `	}` |
|   4351197 | 13081 | `	return 0;` |
|   3007119 | 13082 | `}` |
|         - | 13083 | `/*` |
...
|         - | 13092 | ` */` |
|   6014228 | 13093 | `static void GenStateCallBuiltinName(ph7_expr_node *pLeft, SyString *pOut)` |
|         5 | 13094 | `{` |
|         - | 13095 | `	SyToken *p, *pEnd;` |
|   6014233 | 13096 | `	pOut->zString = 0;` |
|   6014233 | 13097 | `	pOut->nByte = 0;` |
|   6014233 | 13098 | `	if( pLeft == 0 \|\| pLeft->pStart == 0 \|\| pLeft->pEnd == 0 ){` |
|       ! 0 | 13099 | `		return;` |
|         - | 13100 | `	}` |
|   6014233 | 13101 | `	p = pLeft->pStart;` |
|   6014233 | 13102 | `	pEnd = pLeft->pEnd;` |
|         - | 13103 | `	/* Optional single leading namespace separator (absolute path). */` |
|   6014233 | 13104 | `	if( p < pEnd && (p->nType & PH7_TK_NSSEP) ){` |
|      3845 | 13105 | `		p++;` |
|      1920 | 13106 | `	}` |
|   6014233 | 13107 | `	if( p >= pEnd \|\| (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|   1605681 | 13108 | `		return;` |
|         - | 13109 | `	}` |
|         - | 13110 | `	/* Must be a single component: nothing follows the name token. */` |
|   4408557 | 13111 | `	if( p + 1 != pEnd ){` |
|        40 | 13112 | `		return;` |
|         - | 13113 | `	}` |
|   4408521 | 13114 | `	*pOut = p->sData;` |
|   3007119 | 13115 | `}` |
|         - | 13116 | `/*` |
...
|         - | 13121 | ` * error message.` |
|         - | 13122 | ` */` |
|  64963580 | 13123 | `static sxi32 GenStateEmitExprCode(` |
...
|         - | 13130 | `	sxu32 nJmpIdx;` |
|  64963585 | 13131 | `	sxi32 iP1 = 0;` |
|  64963585 | 13132 | `	sxu32 iP2 = 0;` |
|  64963585 | 13133 | `	void *p3  = 0;` |
|         - | 13134 | `	sxi32 iVmOp;` |
|         - | 13135 | `	sxi32 rc;` |
|  64963585 | 13136 | `	int bIsChainOp = 0; /* Set below once we know pNode->pOp */` |
|  64963585 | 13137 | ``	int bFcc = 0;       /* First-class callable `f(...)`: emit OP_LOAD_FCC, not OP_CALL */`` |
|  64963585 | 13138 | `	sxu32 nRhsNsBase = 0;` |
|  64963585 | 13139 | `	if( pNode->xCode ){` |
|         - | 13140 | `		SyToken *pTmpIn,*pTmpEnd;` |
|         - | 13141 | `		/* Compile node */` |
|  39070551 | 13142 | `		SWAP_DELIMITER(pGen,pNode->pStart,pNode->pEnd);` |
|  39070551 | 13143 | `		rc = pNode->xCode(&(*pGen),iFlags);` |
|  39070551 | 13144 | `		RE_SWAP_DELIMITER(pGen);` |
|  39070551 | 13145 | `		return rc;` |
|         - | 13146 | `	}` |
|  25893039 | 13147 | `	if( pNode->pOp == 0 ){` |
...
|         - | 13151 | `	}` |
|  25893039 | 13152 | `	iVmOp = pNode->pOp->iVmOp;` |
|  25893039 | 13153 | `	if( iVmOp == PH7_OP_CVT_NULL ){` |
...
|         - | 13161 | `		}` |
|         1 | 13162 | `	}` |
|  25893039 | 13163 | `	if( pNode->pOp->iOp == EXPR_OP_NULLC_ASSIGN ){` |
...
|         - | 13212 | `	}` |
|  25892951 | 13213 | `	if( pNode->pOp->iOp == EXPR_OP_QUESTY ){` |
...
|    422633 | 13218 | `		nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|    422633 | 13219 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pCond,iFlags);` |
|    422633 | 13220 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 13221 | `			return rc;` |
|         - | 13222 | `		}` |
...
|    422633 | 13226 | `		GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|    422633 | 13227 | `		nJz = nJmp = 0; /* cc -O6 warning */` |
|    422633 | 13228 | `		if( pNode->pLeft ){` |
|         - | 13229 | `			/* Standard ternary: (expr) ? (then) : (else) */` |
|         - | 13230 | `			/* Phase#2: Emit the false jump (pops condition) */` |
|    418753 | 13231 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nJz);` |
|         - | 13232 | `			/* Phase#3: Compile the 'then' expression  */` |
|    418753 | 13233 | `			nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|    418753 | 13234 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pLeft,iFlags);` |
|    418753 | 13235 | `			if( rc != SXRET_OK ){` |
|       ! 0 | 13236 | `				return rc;` |
|         - | 13237 | `			}` |
|    418753 | 13238 | `			GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|    209379 | 13239 | `		}else{` |
...
|    422633 | 13247 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,0,0,&nJmp);` |
|         - | 13248 | `		/* Phase#5: Fix the false jump now the jump destination is resolved. */` |
|    422633 | 13249 | `		pInstr = PH7_VmGetInstr(pGen->pVm,nJz);` |
|    422633 | 13250 | `		if( pInstr ){` |
|    422633 | 13251 | `			pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    211314 | 13252 | `		}` |
|    422633 | 13253 | `		if( !pNode->pLeft ){` |
...
|    422633 | 13258 | `		if( pNode->pRight ){` |
|    422633 | 13259 | `			nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|    422633 | 13260 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pRight,iFlags);` |
|    422633 | 13261 | `			if( rc != SXRET_OK ){` |
|       ! 0 | 13262 | `				return rc;` |
|         - | 13263 | `			}` |
|    422633 | 13264 | `			GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|    211314 | 13265 | `		}` |
|    422633 | 13266 | `		if( nJmp > 0 ){` |
|         - | 13267 | `			/* Phase#7: Fix the unconditional jump */` |
|    422633 | 13268 | `			pInstr = PH7_VmGetInstr(pGen->pVm,nJmp);` |
|    422633 | 13269 | `			if( pInstr ){` |
|    422633 | 13270 | `				pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    211314 | 13271 | `			}` |
|    211314 | 13272 | `		}` |
|         - | 13273 | `		/* All done */` |
|    422633 | 13274 | `		return SXRET_OK;` |
|         - | 13275 | `	}` |
|  25470323 | 13276 | `	if( pNode->pOp->iOp == EXPR_OP_PIPE ){` |
...
|         - | 13308 | `	}` |
|  25470297 | 13309 | `	bIsChainOp = GEN_IS_CHAIN_OP(pNode->pOp->iOp);` |
|         - | 13310 | `	/* Generate code for the left tree */` |
|  25470297 | 13311 | `	if( pNode->pLeft ){` |
|  25447427 | 13312 | `		sxu32 nLhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  25447427 | 13313 | `		if( iVmOp == PH7_OP_CALL ){` |
|         - | 13314 | `			ph7_expr_node **apNode;` |
|   6018361 | 13315 | `			int hasSpread = 0;` |
|   6018361 | 13316 | `			int hasNamed = 0;` |
|   6018361 | 13317 | `			int bAnySpread = 0;` |
|   6018361 | 13318 | `			sxu32 byRefMask = 0;` |
|         - | 13319 | `			sxi32 nArgs;` |
|         - | 13320 | `			sxi32 n;` |
|         - | 13321 | `			/* Recurse and generate bytecodes for function arguments */` |
|   6018361 | 13322 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|   6018361 | 13323 | `			nArgs = (sxi32)SySetUsed(&pNode->aNodeArgs);` |
...
|   6018361 | 13327 | `			if( nArgs == 1 && apNode[0] && (apNode[0]->iFlags & EXPR_NODE_FCC) ){` |
|        81 | 13328 | `				bFcc = 1;` |
|        81 | 13329 | `				nArgs = 0;` |
|        40 | 13330 | `			}` |
...
|         - | 13333 | `			{` |
|   6018361 | 13334 | `				int seenNamed = 0;` |
|   6018361 | 13335 | `				int seenSpread = 0;` |
|  12637757 | 13336 | `				for( n = 0; n < nArgs; ++n ){` |
|   6619403 | 13337 | `					if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
...
|         5 | 13344 | `						}` |
|   6617405 | 13345 | `					}else if( apNode[n]->iFlags & EXPR_NODE_NAMED_ARG ){` |
|       289 | 13346 | `						seenNamed = 1;` |
|       289 | 13347 | `						hasNamed = 1;` |
|   6615265 | 13348 | `					}else if( seenNamed ){` |
...
|   6615121 | 13352 | `					}else if( seenSpread ){` |
...
|   6018359 | 13360 | `			iFlags \|= EXPR_FLAG_RDONLY_LOAD;` |
...
|   6018359 | 13365 | `			if( pNode->pLeft && pNode->pLeft->pStart ){` |
|   6018359 | 13366 | `				SyString *pCallName = &pNode->pLeft->pStart->sData;` |
|   6018354 | 13367 | `				if( pCallName->nByte == 5` |
|   3374627 | 13368 | `				 && SyStrnicmp(pCallName->zString,"isset",5) == 0 ){` |
|    301525 | 13369 | `					iFlags \|= EXPR_FLAG_LOAD_IDX_ISSET;` |
|   5867599 | 13370 | `				}else if( pCallName->nByte == 5` |
|   3073107 | 13371 | `				 && SyStrnicmp(pCallName->zString,"empty",5) == 0 ){` |
...
|   6018359 | 13380 | `				if( !bAnySpread && !hasNamed ){` |
|         - | 13381 | `					SyString sBuiltin;` |
|   6014233 | 13382 | `					GenStateCallBuiltinName(pNode->pLeft, &sBuiltin);` |
|   6014233 | 13383 | `					byRefMask = GenStateByRefBuiltinMask(&sBuiltin);` |
|   3007114 | 13384 | `				}` |
|   3009177 | 13385 | `			}` |
|  12637753 | 13386 | `			for( n = 0 ; n < nArgs ; ++n ){` |
|   6619399 | 13387 | `				sxu32 nArgNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|   6619399 | 13388 | `				sxi32 iArgFlags = iFlags & ~(EXPR_FLAG_LOAD_IDX_STORE\|EXPR_FLAG_MEMBER_WRITE);` |
...
|   6619399 | 13395 | `				if( n < 31 && (byRefMask & (1u<<n)) ){` |
|     38205 | 13396 | `					iArgFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|     38205 | 13397 | `					iArgFlags \|= EXPR_FLAG_LOAD_IDX_STORE;` |
|     19100 | 13398 | `				}` |
|   6619399 | 13399 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iArgFlags);` |
|   6619399 | 13400 | `				if( rc != SXRET_OK ){` |
|       ! 0 | 13401 | `					return rc;` |
|         - | 13402 | `				}` |
|         - | 13403 | `				/* Each argument is an independent nullsafe scope. */` |
|   6619399 | 13404 | `				GenStatePatchNullsafeJumps(pGen, nArgNsBase);` |
|   6619399 | 13405 | `				if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
...
|   6018359 | 13448 | `			iFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|   3009177 | 13449 | `		}` |
|         - | 13450 | `		{` |
...
|  25447425 | 13459 | `			sxi32 iLeftFlags = iFlags;` |
|  25447420 | 13460 | `			if( pNode->pLeft && pNode->pLeft->pOp` |
|  20934100 | 13461 | `				&& (pNode->pLeft->pOp->iOp == EXPR_OP_ARROW` |
|   8210416 | 13462 | `					\|\| pNode->pLeft->pOp->iOp == EXPR_OP_NULLSAFE_ARROW` |
|   7093295 | 13463 | `					\|\| pNode->pLeft->pOp->iOp == EXPR_OP_DC) ){` |
|   2406287 | 13464 | `				iLeftFlags &= ~EXPR_FLAG_LOAD_IDX_UNSET;` |
|   1203141 | 13465 | `			}` |
...
|  25447420 | 13473 | `			if( pNode->pOp` |
|  35909445 | 13474 | `				&& (pNode->pOp->iOp == EXPR_OP_ARROW` |
|  23185782 | 13475 | `					\|\| pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW` |
|  20924092 | 13476 | `					\|\| pNode->pOp->iOp == EXPR_OP_DC) ){` |
|   4882599 | 13477 | `				iLeftFlags &= ~EXPR_FLAG_MEMBER_WRITE;` |
|   2441297 | 13478 | `			}` |
...
|  25447420 | 13485 | `			if( pNode->pOp` |
|  25447425 | 13486 | `				&& (pNode->pOp->iVmOp == PH7_OP_INCR \|\| pNode->pOp->iVmOp == PH7_OP_DECR) ){` |
|    187287 | 13487 | `				iLeftFlags \|= EXPR_FLAG_LOAD_IDX_STORE \| EXPR_FLAG_MEMBER_WRITE;` |
|     93641 | 13488 | `			}` |
|  25447425 | 13489 | `			if( iVmOp == PH7_OP_ERR_CTRL ){` |
...
|      5822 | 13493 | `			}` |
|  25447425 | 13494 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pLeft,iLeftFlags);` |
|         - | 13495 | `		}` |
|  25447425 | 13496 | `		if( rc != SXRET_OK ){` |
|        34 | 13497 | `			return rc;` |
|         - | 13498 | `		}` |
|  25447395 | 13499 | `		if( !bIsChainOp ){` |
...
|  11733835 | 13502 | `			GenStatePatchNullsafeJumps(pGen, nLhsNsBase);` |
|   5866915 | 13503 | `		}` |
|  25447395 | 13504 | `		if( iVmOp == PH7_OP_CALL ){` |
|   6018359 | 13505 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|   6018359 | 13506 | `			if( pInstr ){` |
|   6018359 | 13507 | `				if ( pInstr->iOp == PH7_OP_LOADC ){` |
|   4408797 | 13508 | `					sxu32 nOrig = (sxu32)pInstr->iP2;` |
|         - | 13509 | `					sxu32 nQual;` |
|   4408797 | 13510 | `					int bAbsolute = (pInstr->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|         - | 13511 | `					/* Prevent constant expansion but preserve the absolute flag` |
|         - | 13512 | `					 * so the later NEW handler (if any) can see it. */` |
|   4408797 | 13513 | `					pInstr->iP1 &= ~PH7_LOADC_EXPAND;` |
...
|   4408797 | 13521 | `					if( bAbsolute ){` |
|      3845 | 13522 | `						pInstr->iP2 = (sxi32)nOrig;` |
|      1925 | 13523 | `					}else{` |
|   4404957 | 13524 | `						int fromImport = 0;` |
|   4404957 | 13525 | `						nQual = GenStateNsQualifyName(pGen,nOrig,&pGen->hUseFuncImports,&fromImport);` |
|   4404957 | 13526 | `						pInstr->iP2 = (sxi32)nQual;` |
|   4404957 | 13527 | `						if( nQual != nOrig ){` |
...
|        36 | 13548 | `						}` |
|         5 | 13549 | `					}` |
|   3813963 | 13550 | `				}else if( pInstr->iOp == PH7_OP_MEMBER /* $a->b(1,2,3) */ \|\| pInstr->iOp == PH7_OP_NEW ){` |
|         - | 13551 | `					/* Method call,flag that */` |
|   1589873 | 13552 | `					pInstr->iP2 = 1;` |
|    794934 | 13553 | `				}` |
|   3009182 | 13554 | `			}` |
|  22438218 | 13555 | `		}else if( iVmOp == PH7_OP_LOAD_IDX ){` |
|         - | 13556 | `			ph7_expr_node **apNode;` |
|         - | 13557 | `			sxi32 n;` |
|   2812617 | 13558 | `			sxi32 iChildMask = ~(EXPR_FLAG_LOAD_IDX_STORE` |
...
|   2812617 | 13562 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|   5407707 | 13563 | `			for( n = 0 ; n < (sxi32)SySetUsed(&pNode->aNodeArgs) ; ++n ){` |
|   2595095 | 13564 | `				sxu32 nIdxNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|   2595095 | 13565 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iFlags&iChildMask);` |
|   2595095 | 13566 | `				if( rc != SXRET_OK ){` |
|       ! 0 | 13567 | `					return rc;` |
|         - | 13568 | `				}` |
|         - | 13569 | `				/* Each subscript index is an independent nullsafe scope. */` |
|   2595095 | 13570 | `				GenStatePatchNullsafeJumps(pGen, nIdxNsBase);` |
|   1297550 | 13571 | `			}` |
|   2812617 | 13572 | `			if( SySetUsed(&pNode->aNodeArgs) > 0 ){` |
|   2595095 | 13573 | `				iP1 = 1; /* Node have an index associated with it */` |
|   1297545 | 13574 | `			}` |
|   2812617 | 13575 | `			if( iFlags & EXPR_FLAG_LOAD_IDX_ISSET ){` |
|         - | 13576 | `				/* offsetExists for ArrayAccess; peek-only for arrays */` |
|    339529 | 13577 | `				iP2 = 4;` |
|   2642855 | 13578 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_UNSET ){` |
|         - | 13579 | `				/* offsetUnset for ArrayAccess; auto-vivify+load for arrays` |
|         - | 13580 | `				 * so the trailing unset() builtin can drop the slot. */` |
|     22953 | 13581 | `				iP2 = 5;` |
|   2461619 | 13582 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_EMPTY ){` |
...
|        31 | 13586 | `				iP2 = 6;` |
|   2450132 | 13587 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_STORE ){` |
|         - | 13588 | `				/* Create an empty entry when the desired index is not found */` |
|    519215 | 13589 | `				iP2 = 1;` |
|    259610 | 13590 | `			}` |
|  18022735 | 13591 | `		}else if( pNode->pOp->iOp == EXPR_OP_COMMA ){` |
|         - | 13592 | `			/* POP the left node */` |
|         5 | 13593 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|         2 | 13594 | `		}` |
|  12723695 | 13595 | `	}` |
|  25470265 | 13596 | `	rc = SXRET_OK;` |
|  25470265 | 13597 | `	nJmpIdx = 0;` |
...
|  25470265 | 13601 | `	if( iVmOp == PH7_OP_MEMBER && pNode->pOp->iOp == EXPR_OP_DC ){` |
...
|  25447337 | 13631 | `	if( pNode->pRight ){` |
|  14560169 | 13632 | `		if( iVmOp == PH7_OP_LAND ){` |
...
|  14373120 | 13635 | `		}else if (iVmOp == PH7_OP_LOR ){` |
...
|  14052568 | 13638 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLC ){` |
...
|  13892355 | 13642 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW ){` |
...
|  13865489 | 13652 | `		}else if( pNode->pOp->iPrec == 18 /* Combined binary operators [i.e: =,'.=','+=',*=' ...] precedence */ ){` |
...
|   4605243 | 13656 | `			iFlags \|= EXPR_FLAG_LOAD_IDX_STORE \| EXPR_FLAG_MEMBER_WRITE;` |
|   2302619 | 13657 | `		}` |
|  14560169 | 13658 | `		nRhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  14560169 | 13659 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pRight,iFlags);` |
|  14560169 | 13660 | `		if( !bIsChainOp ){` |
|         - | 13661 | `			/* Non-chain parent: RHS nullsafe chain ends here, before the` |
|         - | 13662 | `			 * operator instruction is emitted. */` |
|   9677633 | 13663 | `			GenStatePatchNullsafeJumps(pGen, nRhsNsBase);` |
|   4838814 | 13664 | `		}` |
|  14560169 | 13665 | `		if( iVmOp == PH7_OP_STORE ){` |
|   4181781 | 13666 | `			if( pNode->pRight && (pNode->pRight->xCode == PH7_CompileList \|\|` |
|   4181744 | 13667 | `				pNode->pRight->xCode == PH7_CompileShortList) ){` |
...
|         - | 13673 | `				 */` |
|        91 | 13674 | `				iVmOp = 0;` |
|   4181738 | 13675 | `			}else if( (pInstr = PH7_VmPeekInstr(pGen->pVm)) != 0 ){` |
|   4181695 | 13676 | `				if(pInstr->iOp == PH7_OP_MEMBER ){` |
|         - | 13677 | `					/* Perform a member store operation [i.e: $this->x = 50] */` |
|    744053 | 13678 | `					iP2 = 1;` |
|    372029 | 13679 | `				}else{` |
|   3437647 | 13680 | `					if( pInstr->iOp == PH7_OP_LOAD_IDX ){` |
|         - | 13681 | `						/* Transform the STORE instruction to STORE_IDX instruction */` |
|    500057 | 13682 | `						iVmOp = PH7_OP_STORE_IDX;` |
|    500057 | 13683 | `						iP1 = pInstr->iP1;` |
|    250031 | 13684 | `					}else{` |
|   2937595 | 13685 | `						p3 = pInstr->p3;` |
|         - | 13686 | `					}` |
|         - | 13687 | `					/* POP the last dynamic load instruction */` |
|   3437647 | 13688 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|         - | 13689 | `				}` |
|   2090850 | 13690 | `			}` |
|  12469281 | 13691 | `		}else if( iVmOp == PH7_OP_STORE_REF ){` |
...
|        30 | 13706 | `		}` |
|   7280082 | 13707 | `	}` |
|  25447332 | 13708 | `	if( iVmOp == PH7_OP_NEW && pNode->pLeft && pNode->pLeft->pOp == 0` |
|    375212 | 13709 | `		&& pNode->pLeft->xCode == PH7_CompileAnnonClass ){` |
...
|        32 | 13712 | `		iVmOp = 0;` |
|        14 | 13713 | `	}` |
|  25447337 | 13714 | `	if( iVmOp > 0 ){` |
|  25393695 | 13715 | `		if( iVmOp == PH7_OP_INCR \|\| iVmOp == PH7_OP_DECR ){` |
|    187287 | 13716 | `			if( pNode->iFlags & EXPR_NODE_PRE_INCR ){` |
|         - | 13717 | `				/* Pre-increment/decrement operator [i.e: ++$i,--$j ] */` |
|     15285 | 13718 | `				iP1 = 1;` |
|      7645 | 13719 | `			}` |
|  25300054 | 13720 | `		}else if( iVmOp == PH7_OP_NEW ){` |
|         - | 13721 | `			/* Namespace-qualify the class name for NEW */ {` |
|    750053 | 13722 | `				VmInstr *pPeek = PH7_VmPeekInstr(pGen->pVm);` |
|    750053 | 13723 | `				VmInstr *pCallInstr = 0;` |
|    750053 | 13724 | `				if( pPeek && pPeek->iOp == PH7_OP_CALL ){` |
|    749743 | 13725 | `					pCallInstr = pPeek;` |
|    749743 | 13726 | `					pPeek = PH7_VmPeekNextInstr(pGen->pVm);` |
|    374869 | 13727 | `				}` |
|    750053 | 13728 | `				if( pPeek && pPeek->iOp == PH7_OP_LOADC ){` |
|    734801 | 13729 | `					int bAbsolute = (pPeek->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|         - | 13730 | `					sxu32 nLitForClass;` |
|    734801 | 13731 | `					VmCallArgMap *pCallNsMap = pCallInstr ? (VmCallArgMap *)pCallInstr->p3 : 0;` |
...
|    734801 | 13738 | `					if( pCallNsMap && pCallNsMap->nOrigNameLit > 0 ){` |
|        37 | 13739 | `						nLitForClass = pCallNsMap->nOrigNameLit - 1;` |
|        21 | 13740 | `					}else{` |
|    734769 | 13741 | `						nLitForClass = (sxu32)pPeek->iP2;` |
|         - | 13742 | `					}` |
|    734801 | 13743 | `					pPeek->iP1 = 0;` |
|    734801 | 13744 | `					if( !bAbsolute ){` |
|    730965 | 13745 | `						pPeek->iP2 = (sxi32)GenStateNsQualifyName(pGen,nLitForClass,&pGen->hUseImports,0);` |
|    365485 | 13746 | `					}else{` |
|      3841 | 13747 | `						pPeek->iP2 = (sxi32)nLitForClass;` |
|         - | 13748 | `					}` |
|    367398 | 13749 | `				}` |
|         - | 13750 | `			}` |
|    750053 | 13751 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|    750053 | 13752 | `			if( pInstr && pInstr->iOp == PH7_OP_CALL ){` |
|         - | 13753 | `				VmInstr *pPrev;` |
|    749743 | 13754 | `				pPrev = PH7_VmPeekNextInstr(pGen->pVm);` |
|    749743 | 13755 | `				if( pPrev == 0 \|\| pPrev->iOp != PH7_OP_MEMBER ){` |
...
|    749743 | 13759 | `					iP1 = pInstr->iP1;` |
|    749743 | 13760 | `					iP2 = pInstr->iP2;` |
|    749743 | 13761 | `					if( pInstr->p3 ){` |
|        47 | 13762 | `						p3 = pInstr->p3; /* Transfer VmCallArgMap to NEW */` |
|        21 | 13763 | `					}` |
|    749743 | 13764 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|    374869 | 13765 | `				}` |
|    374874 | 13766 | `			}` |
|  24831389 | 13767 | `		}else if( iVmOp == PH7_OP_IS_A ){` |
...
|     38236 | 13787 | `				}` |
|     38251 | 13788 | `			}` |
|  24418119 | 13789 | `		}else if( iVmOp == PH7_OP_MEMBER){` |
...
|   4882541 | 13793 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|   4882541 | 13794 | `			if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|   4649931 | 13795 | `				pInstr->iP1 = 0;` |
|   2324963 | 13796 | `			}` |
|   4882541 | 13797 | `			if( pNode->pOp->iOp == EXPR_OP_DC /* '::' */){` |
...
|   4882541 | 13810 | `			if( iP2 == PH7_MEMBER_READ ){` |
|   4882541 | 13811 | `				if( iFlags & EXPR_FLAG_LOAD_IDX_UNSET ){` |
|        42 | 13812 | `					iP2 = PH7_MEMBER_UNSET;` |
|   4882521 | 13813 | `				}else if( iFlags & EXPR_FLAG_LOAD_IDX_ISSET ){` |
|     61095 | 13814 | `					iP2 = PH7_MEMBER_ISSET;` |
|   4851956 | 13815 | `				}else if( iFlags & EXPR_FLAG_LOAD_IDX_EMPTY ){` |
|        17 | 13816 | `					iP2 = PH7_MEMBER_EMPTY;` |
|   4821403 | 13817 | `				}else if( iFlags & EXPR_FLAG_MEMBER_WRITE ){` |
...
|  25393695 | 13850 | `		if( iVmOp == PH7_OP_CALL \|\| iVmOp == PH7_OP_NEW ){` |
|   6768327 | 13851 | `			p3 = GenStateAttachStrictFlag(pGen,p3);` |
|   3384161 | 13852 | `		}` |
|         - | 13853 | `		/* Finally,emit the VM instruction associated with this operator */` |
|  25393695 | 13854 | `		PH7_VmEmitInstr(pGen->pVm,iVmOp,iP1,iP2,p3,0);` |
|  12696845 | 13855 | `	}` |
|  25447337 | 13856 | `	if( nJmpIdx > 0 ){` |
...
|         - | 13886 | ` */` |
| 215251288 | 13887 | `static int GenStateTreeHasComma(ph7_expr_node *pNode)` |
|         5 | 13888 | `{` |
|         - | 13889 | `	ph7_expr_node **apArg;` |
|         - | 13890 | `	sxu32 n;` |
| 215251293 | 13891 | `	if( pNode == 0 ){` |
| 151279827 | 13892 | `		return 0;` |
|         - | 13893 | `	}` |
|  63971471 | 13894 | `	if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_COMMA ){` |
|         6 | 13895 | `		return 1;` |
|         - | 13896 | `	}` |
|  63971462 | 13897 | `	if( GenStateTreeHasComma(pNode->pLeft) \|\| GenStateTreeHasComma(pNode->pRight)` |
|  63971463 | 13898 | `	 \|\| GenStateTreeHasComma(pNode->pCond) ){` |
|         6 | 13899 | `		return 1;` |
|         - | 13900 | `	}` |
|  63971463 | 13901 | `	apArg = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  73163155 | 13902 | `	for( n = 0 ; n < SySetUsed(&pNode->aNodeArgs) ; n++ ){` |
|   9191697 | 13903 | `		if( GenStateTreeHasComma(apArg[n]) ){` |
|       ! 0 | 13904 | `			return 1;` |
|         - | 13905 | `		}` |
|   4595851 | 13906 | `	}` |
|  63971463 | 13907 | `	return 0;` |
| 107625649 | 13908 | `}` |
|  14477478 | 13909 | `static sxi32 PH7_CompileExpr(` |
...
|  14477483 | 13923 | `	nExpr = 0;` |
|  14477483 | 13924 | `	pRoot = 0;` |
...
|  14477483 | 13927 | `	nNullsafeBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  14477483 | 13928 | `	SySetInit(&sExprNode,&pGen->pVm->sAllocator,sizeof(ph7_expr_node *));` |
|  14477483 | 13929 | `	SySetAlloc(&sExprNode,0x10);` |
|  14477483 | 13930 | `	rc = SXRET_OK;` |
|         - | 13931 | `	/* Delimit the expression */` |
|  14477483 | 13932 | `	pEnd = pGen->pIn;` |
|  14477483 | 13933 | `	iNest = 0;` |
| 114306471 | 13934 | `	while( pEnd < pGen->pEnd ){` |
| 108820115 | 13935 | `		if( pEnd->nType & PH7_TK_OCB /* '{' */ ){` |
|         - | 13936 | `			/* Ticket 1433-30: Annonymous/Closure functions body */` |
|      4625 | 13937 | `			iNest++;` |
| 108817805 | 13938 | `		}else if(pEnd->nType & PH7_TK_CCB /* '}' */ ){` |
|      4633 | 13939 | `			iNest--;` |
| 108813181 | 13940 | `		}else if( pEnd->nType & PH7_TK_SEMI /* ';' */ ){` |
|   8991973 | 13941 | `			if( iNest <= 0 ){` |
|   8991127 | 13942 | `				break;` |
|         - | 13943 | `			}` |
|       423 | 13944 | `		}` |
|  99828993 | 13945 | `		pEnd++;` |
|         5 | 13946 | `	}` |
|  14477483 | 13947 | `	if( iFlags & EXPR_FLAG_COMMA_STATEMENT ){` |
...
|         1 | 13965 | `		}` |
|    318808 | 13966 | `	}` |
|  14477483 | 13967 | `	if( pEnd > pGen->pIn ){` |
|  14454603 | 13968 | `		SyToken *pTmp = pGen->pEnd;` |
|         - | 13969 | `		/* Swap delimiter */` |
|  14454603 | 13970 | `		pGen->pEnd = pEnd;` |
|         - | 13971 | `		/* Try to get an expression tree */` |
|  14454603 | 13972 | `		rc = PH7_ExprMakeTree(&(*pGen),&sExprNode,&pRoot);` |
|  14454598 | 13973 | `		if( rc == SXRET_OK && pRoot && pGen->nCommaExprOk < 1` |
|  14299821 | 13974 | `		 && GenStateTreeHasComma(pRoot) ){` |
...
|         - | 13987 | `		}` |
|  14454599 | 13988 | `		if( rc == SXRET_OK && pRoot ){` |
|  14454415 | 13989 | `			rc = SXRET_OK;` |
|  14454415 | 13990 | `			if( xTreeValidator ){` |
|         - | 13991 | `				/* Call the upper layer validator callback */` |
|    958609 | 13992 | `				rc = xTreeValidator(&(*pGen),pRoot);` |
|    479302 | 13993 | `			}` |
|  14454415 | 13994 | `			if( rc != SXERR_ABORT ){` |
|         - | 13995 | `				/* Generate code for the given tree */` |
|  14454415 | 13996 | `				rc = GenStateEmitExprCode(&(*pGen),pRoot,iFlags);` |
|         - | 13997 | `				/* Patch any unresolved nullsafe jumps emitted by this` |
|         - | 13998 | `				 * expression so they short-circuit to its end. */` |
|  14454415 | 13999 | `				GenStatePatchNullsafeJumps(pGen, nNullsafeBase);` |
|   7227205 | 14000 | `			}` |
|  14454415 | 14001 | `			nExpr = 1;` |
|   7227205 | 14002 | `		}` |
|         - | 14003 | `		/* Release the whole tree */` |
|  14454599 | 14004 | `		PH7_ExprFreeTree(&(*pGen),&sExprNode);` |
|         - | 14005 | `		/* Synchronize token stream */` |
|  14454599 | 14006 | `		pGen->pEnd = pTmp;` |
|  14454599 | 14007 | `		pGen->pIn  = pEnd;` |
|  14454599 | 14008 | `		if( rc == SXERR_ABORT ){` |
|        13 | 14009 | `			SySetRelease(&sExprNode);` |
|        13 | 14010 | `			return SXERR_ABORT;` |
|         - | 14011 | `		}` |
|   7227292 | 14012 | `	}` |
|  14477469 | 14013 | `	SySetRelease(&sExprNode);` |
|  14477469 | 14014 | `	return nExpr > 0 ? SXRET_OK : SXERR_EMPTY;` |
|   7238744 | 14015 | `}` |
|         - | 14016 | `/*` |
|         - | 14017 | ` * Return a pointer to the node construct handler associated` |
|         - | 14018 | ` * with a given node type [i.e: string,integer,float,...].` |
|         - | 14019 | ` */` |
|   8260154 | 14020 | `PH7_PRIVATE ProcNodeConstruct PH7_GetNodeHandler(sxu32 nNodeType)` |
|         5 | 14021 | `{` |
|   8260159 | 14022 | `	if( nNodeType & PH7_TK_NUM ){` |
|         - | 14023 | `		/* Numeric literal: Either real or integer */` |
|   3351845 | 14024 | `		return PH7_CompileNumLiteral;` |
|   4908319 | 14025 | `	}else if( nNodeType & PH7_TK_DSTR ){` |
|         - | 14026 | `		/* Double quoted string */` |
|    119051 | 14027 | `		return PH7_CompileString;` |
|   4789273 | 14028 | `	}else if( nNodeType & PH7_TK_SSTR ){` |
|         - | 14029 | `		/* Single quoted string */` |
|   4789153 | 14030 | `		return PH7_CompileSimpleString;` |
...
|         - | 14065 | ` */` |
|     25842 | 14066 | `static sxi32 PH7_CompileUnset(ph7_gen_state *pGen)` |
|         5 | 14067 | `{` |
|     25847 | 14068 | `	SyToken *pTmp,*pEnd,*pNext = 0;` |
|     25847 | 14069 | `	sxu32 nIdx = 0;` |
|         - | 14070 | `	SyString sName;` |
|         - | 14071 | `	sxi32 rc;` |
|         - | 14072 | `	/* Jump the 'unset' keyword */` |
|     25847 | 14073 | `	pGen->pIn++;` |
|         - | 14074 | `	/* Save delimiter */` |
|     25847 | 14075 | `	pTmp = pGen->pEnd;` |
|         - | 14076 | `	/* Skip optional opening parenthesis and find the matching close */` |
|     25847 | 14077 | `	pEnd = pTmp; /* Default: scan to statement end */` |
|     25847 | 14078 | `	if( pGen->pIn < pTmp && (pGen->pIn->nType & PH7_TK_LPAREN) ){` |
|         - | 14079 | `		/* Find matching ')' — start scanning AFTER the '(' */` |
|         - | 14080 | `		SyToken *pClose;` |
|     25847 | 14081 | `		pGen->pIn++;   /* Skip '(' */` |
|     25847 | 14082 | `		PH7_DelimitNestedTokens(pGen->pIn,pTmp,PH7_TK_LPAREN,PH7_TK_RPAREN,&pClose);` |
|     25847 | 14083 | `		pEnd = pClose; /* Stop at ')' */` |
|     12921 | 14084 | `	}` |
|     25847 | 14085 | `	SyStringInitFromBuf(&sName,"unset",sizeof("unset")-1);` |
|         - | 14086 | `	/* Resolve the 'unset' builtin name once */` |
|     25847 | 14087 | `	if( SXRET_OK != GenStateFindLiteral(&(*pGen),&sName,&nIdx) ){` |
...
|     55913 | 14096 | `	while( SXRET_OK == PH7_GetNextExpr(pGen->pIn,pEnd,&pNext) ){` |
|     30071 | 14097 | `		if( pGen->pIn < pNext ){` |
|         - | 14098 | `			/*` |
...
|         - | 14105 | `			 */` |
|     30066 | 14106 | `			if( &pGen->pIn[2] == pNext` |
|     18571 | 14107 | `				&& (pGen->pIn[0].nType & PH7_TK_DOLLAR)` |
...
|     25847 | 14147 | `	if( pGen->pIn < pTmp && (pGen->pIn->nType & PH7_TK_RPAREN) ){` |
|     25847 | 14148 | `		pGen->pIn++;` |
|     12921 | 14149 | `	}` |
|         - | 14150 | `	/* Restore token stream */` |
|     25847 | 14151 | `	pGen->pEnd = pTmp;` |
|     25847 | 14152 | `	return SXRET_OK;` |
|     12926 | 14153 | `}` |
|         - | 14154 | `/*` |
...
|         - | 14186 | ` */` |
|   7126652 | 14187 | `static ProcLangConstruct GenStateGetStatementHandler(` |
|         - | 14188 | `	sxu32 nKeywordID,   /* Keyword  ID*/` |
|         - | 14189 | `	SyToken *pLookahed  /* Look-ahead token */` |
|         - | 14190 | `	)` |
|         5 | 14191 | `{` |
|   7126657 | 14192 | `	sxu32 n = 0;` |
|  28350393 | 14193 | `	for(;;){` |
|  56700791 | 14194 | `		if( n >= SX_ARRAYSIZE(aLangConstruct) ){` |
|    429257 | 14195 | `			break;` |
|         - | 14196 | `		}` |
|  56271539 | 14197 | `		if( aLangConstruct[n].nID == nKeywordID ){` |
|   6697405 | 14198 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed && (pLookahed->nType & PH7_TK_OP)){` |
...
|         - | 14203 | `				}` |
|       ! 0 | 14204 | `			}` |
|   6697400 | 14205 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed` |
...
|         - | 14212 | `			*/` |
|   6697403 | 14213 | `			return aLangConstruct[n].xConstruct;` |
|         - | 14214 | `		}` |
|  49574139 | 14215 | `		n++;` |
|         5 | 14216 | `	}` |
...
|         - | 14267 | ` */` |
|  15427200 | 14268 | `static void GenStateSetPendingDoc(ph7_gen_state *pGen)` |
|         5 | 14269 | `{` |
|  15427205 | 14270 | `	SyToken *pBase = (SyToken *)SySetBasePtr(pGen->pTokenSet);` |
|  15427205 | 14271 | `	ph7_trivia *aT = (ph7_trivia *)SySetBasePtr(&pGen->aTrivia);` |
|  15427205 | 14272 | `	sxu32 nT = SySetUsed(&pGen->aTrivia);` |
|         - | 14273 | `	sxu32 nIdx, n;` |
|  15427200 | 14274 | `	if( nT < 1 \|\| pGen->pTokenSet == 0` |
...
|         - | 14299 | ` */` |
|   4013246 | 14300 | `static void GenStateConsumeDoc(ph7_gen_state *pGen,SyString *pOut)` |
|         5 | 14301 | `{` |
|         - | 14302 | `	char *zDup;` |
|   4013251 | 14303 | `	if( SyStringLength(&pGen->sPendingDoc) < 1 ){` |
|   4013231 | 14304 | `		return;` |
|         - | 14305 | `	}` |
...
|         - | 14479 | ` */` |
|   4013250 | 14480 | `static sxi32 GenStateConsumeAttrs(ph7_gen_state *pGen,SySet *pOut)` |
|         5 | 14481 | `{` |
|   4013255 | 14482 | `	ph7_trivia *aT = (ph7_trivia *)SySetBasePtr(&pGen->aPendingAttrs);` |
|         - | 14483 | `	sxu32 n;` |
|         - | 14484 | `	sxi32 rc;` |
|   4021019 | 14485 | `	for( n = 0 ; n < SySetUsed(&pGen->aPendingAttrs) ; n++ ){` |
|      7769 | 14486 | `		rc = GenStateCompileAttrSpan(&(*pGen),&aT[n],pOut);` |
|      7769 | 14487 | `		if( rc == SXERR_ABORT ){` |
|       ! 0 | 14488 | `			return SXERR_ABORT;` |
|         - | 14489 | `		}` |
|      3887 | 14490 | `	}` |
|   4013255 | 14491 | `	SySetReset(&pGen->aPendingAttrs);` |
|   4013255 | 14492 | `	return SXRET_OK;` |
|   2006630 | 14493 | `}` |
|         - | 14494 | `/*` |
...
|         - | 14498 | ` */` |
|   1982414 | 14499 | `static sxi32 GenStateCollectParamAttrs(ph7_gen_state *pGen,SyToken *pTok,SySet *pOut)` |
|         5 | 14500 | `{` |
|   1982419 | 14501 | `	SyToken *pBase = (SyToken *)SySetBasePtr(pGen->pTokenSet);` |
|   1982419 | 14502 | `	ph7_trivia *aT = (ph7_trivia *)SySetBasePtr(&pGen->aTrivia);` |
|   1982419 | 14503 | `	sxu32 nT = SySetUsed(&pGen->aTrivia);` |
|         - | 14504 | `	sxu32 nIdx, n;` |
|         - | 14505 | `	sxi32 rc;` |
|   1982414 | 14506 | `	if( nT < 1 \|\| pGen->pTokenSet == 0` |
|    518767 | 14507 | `	 \|\| pTok < pBase \|\| pTok >= &pBase[SySetUsed(pGen->pTokenSet)] ){` |
|   1463657 | 14508 | `		return SXRET_OK;` |
|         - | 14509 | `	}` |
...
|    991212 | 14520 | `}` |
|  11440328 | 14521 | `static sxi32 GenStateCompileChunk(` |
...
|         - | 14527 | `	sxi32 rc;` |
|  11440333 | 14528 | `	rc = SXRET_OK; /* Prevent compiler warning */` |
|   6638110 | 14529 | `	for(;;){` |
|  12358279 | 14530 | `		int bStmtIsDeclare = 0;` |
|  12358279 | 14531 | `		if( pGen->pIn >= pGen->pEnd ){` |
|         - | 14532 | `			/* No more input to process */` |
|     67393 | 14533 | `			break;` |
|         - | 14534 | `		}` |
|         - | 14535 | `		/* Bind a directly-preceding docblock to this statement */` |
|  12290891 | 14536 | `		GenStateSetPendingDoc(&(*pGen));` |
|  12290891 | 14537 | `		if( SySetUsed(&pGen->aPendingAttrs) > 0 ){` |
...
|  12290891 | 14569 | `		if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|   7161017 | 14570 | `			sxu32 nPeek = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   7161017 | 14571 | `			if( nPeek == PH7_TKWRD_DECLARE ){` |
|        47 | 14572 | `				bStmtIsDeclare = 1;` |
|        21 | 14573 | `			}` |
|   3580506 | 14574 | `		}` |
|  12290891 | 14575 | `		if( !bStmtIsDeclare && pGen->pCurrent == &pGen->sGlobal ){` |
...
|    917919 | 14578 | `			pGen->bStrictTypesLocked = 1;` |
|    458957 | 14579 | `		}` |
|  12290891 | 14580 | `		if( pGen->pIn->nType & PH7_TK_OCB /* '{' */ ){` |
|         - | 14581 | `			/* Compile block */` |
...
|         - | 14585 | `			}` |
|      1920 | 14586 | `		}else{` |
|  12287061 | 14587 | `			xCons = 0;` |
|  12287061 | 14588 | `			if( GenStateStartsModifiedClass(pGen->pIn,pGen->pEnd) ){` |
...
|  12269868 | 14593 | `			}else if( GenStateStartsEnumDecl(pGen->pIn,pGen->pEnd) ){` |
...
|  12250755 | 14597 | `			}else if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|   7126657 | 14598 | `				sxu32 nKeyword = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|         - | 14599 | `				/* Try to extract a language construct handler */` |
|   7126657 | 14600 | `				xCons = GenStateGetStatementHandler(nKeyword,(&pGen->pIn[1] < pGen->pEnd) ? &pGen->pIn[1] : 0);` |
|   7126657 | 14601 | `				if( xCons == 0 && GenStateisLangConstruct(nKeyword) == FALSE ){` |
...
|         4 | 14612 | `				}` |
|   8685509 | 14613 | `			}else if( (pGen->pIn->nType & PH7_TK_ID) && (&pGen->pIn[1] < pGen->pEnd)` |
|    405267 | 14614 | `				&& (pGen->pIn[1].nType & PH7_TK_COLON /*':'*/) ){` |
|         - | 14615 | `				/* Label found [i.e: Out: ],point to the routine responsible of compiling it */` |
|       117 | 14616 | `				xCons = PH7_CompileLabel;` |
|        56 | 14617 | `			}` |
|  12287061 | 14618 | `			if( xCons == 0 ){` |
|         - | 14619 | `				/* Assume an expression an try to compile it */` |
|   5160655 | 14620 | `				rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   5160655 | 14621 | `				if(  rc != SXERR_EMPTY ){` |
|         - | 14622 | `					/* Pop l-value */` |
|   5160505 | 14623 | `					PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|   2580250 | 14624 | `				}` |
|   2580330 | 14625 | `			}else{` |
|         - | 14626 | `				/* Go compile the sucker */` |
|   7126411 | 14627 | `				rc = xCons(&(*pGen));` |
|         - | 14628 | `			}` |
|  12287061 | 14629 | `			if( rc == SXERR_ABORT ){` |
|         - | 14630 | `				/* Request to abort compilation */` |
|        13 | 14631 | `				break;` |
|         - | 14632 | `			}` |
|         - | 14633 | `		}` |
|         - | 14634 | `		/* Ignore trailing semi-colons ';' */` |
|  21039703 | 14635 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|   8748827 | 14636 | `			pGen->pIn++;` |
|         5 | 14637 | `		}` |
|  12290881 | 14638 | `		if( iFlags & PH7_COMPILE_SINGLE_STMT ){` |
|         - | 14639 | `			/* Compile a single statement and return */` |
|  11372935 | 14640 | `			break;` |
|         - | 14641 | `		}` |
|         - | 14642 | `		/* LOOP ONE */` |
|         - | 14643 | `		/* LOOP TWO */` |
|         - | 14644 | `		/* LOOP THREE */` |
...
|         - | 14654 | ` */` |
|     67400 | 14655 | `static sxi32 PH7_CompilePHP(` |
...
|         - | 14659 | `	)` |
|         5 | 14660 | `{` |
|     67405 | 14661 | `	SyToken *pScript = pGen->pRawIn; /* Script to compile */` |
|         - | 14662 | `	sxi32 rc;` |
|         - | 14663 | `	/* Reset the token set (and its trivia sidecar) */` |
|     67405 | 14664 | `	SySetReset(&(*pTokenSet));` |
|     67405 | 14665 | `	SySetReset(&pGen->aTrivia);` |
|         - | 14666 | `	/* Mark as the default token set */` |
|     67405 | 14667 | `	pGen->pTokenSet = &(*pTokenSet);` |
|         - | 14668 | `	/* Advance the stream cursor */` |
|     67405 | 14669 | `	pGen->pRawIn++;` |
|         - | 14670 | `	/* Tokenize the PHP chunk first */` |
|     67405 | 14671 | `	PH7_TokenizePHP(SyStringData(&pScript->sData),SyStringLength(&pScript->sData),pScript->nLine,&(*pTokenSet),&pGen->aTrivia);` |
|         - | 14672 | `	/* Point to the head and tail of the token stream. */` |
|     67405 | 14673 | `	pGen->pIn  = (SyToken *)SySetBasePtr(pTokenSet);` |
|     67405 | 14674 | `	pGen->pEnd = &pGen->pIn[SySetUsed(pTokenSet)];` |
|     67405 | 14675 | `	if( is_expr ){` |
...
|         - | 14684 | `	}` |
|     67405 | 14685 | `	if( pGen->pIn < pGen->pEnd && ( pGen->pIn->nType & PH7_TK_EQUAL ) ){` |
...
|     67403 | 14710 | `	rc = GenStateCompileChunk(pGen,0);` |
|         - | 14711 | `	/* Fix exceptions jumps */` |
|     67403 | 14712 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|         - | 14713 | `	/* Fix gotos now, the jump destination is resolved */` |
|     67403 | 14714 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),0) ){` |
|         3 | 14715 | `		rc = SXERR_ABORT;` |
|         1 | 14716 | `	}` |
|         - | 14717 | `	/* Reset container */` |
|     67403 | 14718 | `	SySetReset(&pGen->aGoto);` |
|     67403 | 14719 | `	SySetReset(&pGen->aLabel);` |
|     67403 | 14720 | `	SySetReset(&pGen->aNullsafeJmp);` |
|         - | 14721 | `	/* Compilation result */` |
|     67403 | 14722 | `	return rc;` |
|     33705 | 14723 | `}` |
|         - | 14724 | `/*` |
...
|         - | 14728 | ` */` |
|     70534 | 14729 | `PH7_PRIVATE sxi32 PH7_CompileScript(` |
...
|         - | 14744 | `	sxi32 rc;` |
|     70539 | 14745 | `	if( pScript->nByte < 1 ){` |
...
|     70539 | 14751 | `	pCodeGen = &pVm->sCodeGen;` |
...
|     70539 | 14758 | `	pSavedIn = pCodeGen->pIn;` |
|     70539 | 14759 | `	pSavedEnd = pCodeGen->pEnd;` |
|     70539 | 14760 | `	bSavedStrict = pCodeGen->bStrictTypes;` |
|     70539 | 14761 | `	bSavedStrictLocked = pCodeGen->bStrictTypesLocked;` |
|     70539 | 14762 | `	pCodeGen->bStrictTypes = 0;` |
|     70539 | 14763 | `	pCodeGen->bStrictTypesLocked = 0;` |
|         - | 14764 | `	/* Initialize the tokens containers */` |
|     70539 | 14765 | `	SySetInit(&aRawToken,&pVm->sAllocator,sizeof(SyToken));` |
|     70539 | 14766 | `	SySetInit(&aPhpToken,&pVm->sAllocator,sizeof(SyToken));` |
|     70539 | 14767 | `	SySetAlloc(&aPhpToken,0xc0);` |
|     70539 | 14768 | `	is_expr = 0;` |
|     70539 | 14769 | `	if( iFlags & PH7_PHP_ONLY ){` |
|         - | 14770 | `		SyToken sTmp;` |
|         - | 14771 | `		/* PHP only: -*/` |
...
|     13247 | 14783 | `		SySetAlloc(&aRawToken,32);` |
|     13247 | 14784 | `		PH7_TokenizeRawText(pScript->zString,pScript->nByte,&aRawToken);` |
|         - | 14785 | `	}` |
|         - | 14786 | `	/* Process high-level tokens */` |
|     70539 | 14787 | `	pCodeGen->pRawIn = (SyToken *)SySetBasePtr(&aRawToken);` |
|     70539 | 14788 | `	pCodeGen->pRawEnd = &pCodeGen->pRawIn[SySetUsed(&aRawToken)];` |
|     70539 | 14789 | `	rc = PH7_OK;` |
|     70539 | 14790 | `	if( is_expr ){` |
|         - | 14791 | `		/* Compile the expression */` |
|       ! 0 | 14792 | `		rc = PH7_CompilePHP(pCodeGen,&aPhpToken,TRUE);` |
|       ! 0 | 14793 | `		goto cleanup;` |
|         - | 14794 | `	}` |
|     70539 | 14795 | `	nObjIdx = 0;` |
...
|     70539 | 14799 | `	PH7_VmEmitInstr(pVm,PH7_OP_NSSWITCH,0,0,0,0);` |
|         - | 14800 | `	/* Start the compilation process */` |
|     41893 | 14801 | `	for(;;){` |
|    151179 | 14802 | `		if( pCodeGen->pRawIn >= pCodeGen->pRawEnd ){` |
|     70527 | 14803 | `			break; /* No more tokens to process */` |
|         - | 14804 | `		}` |
|     80657 | 14805 | `		if( pCodeGen->pRawIn->nType & PH7_TOKEN_PHP ){` |
|         - | 14806 | `			/* Compile the PHP chunk */` |
|     67405 | 14807 | `			rc = PH7_CompilePHP(pCodeGen,&aPhpToken,FALSE);` |
|     67405 | 14808 | `			if( rc == SXERR_ABORT ){` |
|        15 | 14809 | `				break;` |
|         - | 14810 | `			}` |
|     67393 | 14811 | `			continue;` |
|         - | 14812 | `		}` |
|         - | 14813 | `		/* Raw chunk: [i.e: HTML, XML, etc.] */` |
|     13257 | 14814 | `		nRawObj = 0;` |
|     26509 | 14815 | `		while( (pCodeGen->pRawIn < pCodeGen->pRawEnd) && (pCodeGen->pRawIn->nType != PH7_TOKEN_PHP) ){` |
|         - | 14816 | `			/* Consume the raw chunk without any processing */` |
|     13257 | 14817 | `			pRawObj = PH7_ReserveConstObj(&(*pVm),&nObjIdx);` |
|     13257 | 14818 | `			if( pRawObj == 0 ){` |
|       ! 0 | 14819 | `				rc = SXERR_MEM;` |
|       ! 0 | 14820 | `				break;` |
|         - | 14821 | `			}` |
|         - | 14822 | `			/* Mark as constant and emit the load constant instruction */` |
|     13257 | 14823 | `			PH7_MemObjInitFromString(pVm,pRawObj,&pCodeGen->pRawIn->sData);` |
|     13257 | 14824 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_LOADC,0,nObjIdx,0,0);` |
|     13257 | 14825 | `			++nRawObj;` |
|     13257 | 14826 | `			pCodeGen->pRawIn++; /* Next chunk */` |
|         5 | 14827 | `		}` |
|     13257 | 14828 | `		if( nRawObj > 0 ){` |
|         - | 14829 | `			/* Emit the consume instruction */` |
|     13257 | 14830 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_CONSUME,nRawObj,0,0,0);` |
|      6626 | 14831 | `		}` |
|     35272 | 14832 | `	}` |
|     35267 | 14833 | `cleanup:` |
|         - | 14834 | `	/* Drop the cursor into the token set BEFORE the set is freed (see above). */` |
|     70539 | 14835 | `	pCodeGen->pIn = pSavedIn;` |
|     70539 | 14836 | `	pCodeGen->pEnd = pSavedEnd;` |
|     70539 | 14837 | `	SySetRelease(&aRawToken);` |
|     70539 | 14838 | `	SySetRelease(&aPhpToken);` |
|         - | 14839 | `	/* Restore outer file's strict_types scope */` |
|     70539 | 14840 | `	pCodeGen->bStrictTypes = bSavedStrict;` |
|     70539 | 14841 | `	pCodeGen->bStrictTypesLocked = bSavedStrictLocked;` |
|     70539 | 14842 | `	return rc;` |
|     35272 | 14843 | `}` |
|         - | 14844 | `/*` |
...
|         - | 14886 | ` */` |
|     73890 | 14887 | `PH7_PRIVATE sxi32 PH7_ResetCodeGenerator(` |
|         - | 14888 | `	ph7_vm *pVm,       /* Target VM */` |
|         - | 14889 | `	ProcConsumer xErr, /* Error log consumer callabck  */` |
|         - | 14890 | `	void *pErrData     /* Last argument to xErr() */` |
|         - | 14891 | `	)` |
|         5 | 14892 | `{` |
|     73895 | 14893 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|         - | 14894 | `	GenBlock *pBlock,*pParent;` |
|         - | 14895 | `	/* Reset state */` |
|     73895 | 14896 | `	SySetReset(&pGen->aLabel);` |
|     73895 | 14897 | `	SySetReset(&pGen->aGoto);` |
|     73895 | 14898 | `	SySetReset(&pGen->aNullsafeJmp);` |
|     73895 | 14899 | `	SySetReset(&pGen->aTrivia);` |
|     73895 | 14900 | `	SySetReset(&pGen->aPendingAttrs);` |
|     73895 | 14901 | `	SyStringInitFromBuf(&pGen->sPendingDoc,0,0);` |
|     73895 | 14902 | `	SyBlobRelease(&pGen->sErrBuf);` |
|     73895 | 14903 | `	SyBlobRelease(&pGen->sWorker);` |
|     73895 | 14904 | `	SyBlobRelease(&pGen->sNamespace);` |
|     73895 | 14905 | `	SyBlobInit(&pGen->sNamespace,&pVm->sAllocator);` |
|     73895 | 14906 | `	SyHashRelease(&pGen->hUseImports);` |
|     73895 | 14907 | `	SyHashInit(&pGen->hUseImports,&pVm->sAllocator,0,0);` |
|     73895 | 14908 | `	SyHashRelease(&pGen->hUseFuncImports);` |
|     73895 | 14909 | `	SyHashInit(&pGen->hUseFuncImports,&pVm->sAllocator,0,0);` |
|     73895 | 14910 | `	SyHashRelease(&pGen->hUseConstImports);` |
|     73895 | 14911 | `	SyHashInit(&pGen->hUseConstImports,&pVm->sAllocator,0,0);` |
...
|     73895 | 14919 | `	pBlock = pGen->pCurrent;` |
|     73895 | 14920 | `	while( pBlock->pParent != 0 ){` |
|       ! 0 | 14921 | `		pParent = pBlock->pParent;` |
|       ! 0 | 14922 | `		GenStateFreeBlock(pBlock);` |
|       ! 0 | 14923 | `		pBlock = pParent;` |
|       ! 0 | 14924 | `	}` |
|     73895 | 14925 | `	pGen->xErr = xErr;` |
|     73895 | 14926 | `	pGen->pErrData = pErrData;` |
|     73895 | 14927 | `	pGen->pCurrent = &pGen->sGlobal;` |
|     73895 | 14928 | `	pGen->pRawIn = pGen->pRawEnd = 0;` |
|     73895 | 14929 | `	pGen->pIn = pGen->pEnd = 0;` |
|     73895 | 14930 | `	pGen->nErr = 0;` |
|     73895 | 14931 | `	return SXRET_OK;` |
|         5 | 14932 | `}` |
|         - | 14933 | `/*` |
