...
|         - |   69 | ` */` |
|  13083564 |   70 | `static void GenStateInitBlock(` |
...
|  13083569 |   79 | `	pBlock->nFirstInstr = nFirstInstr;` |
|  13083569 |   80 | `	pBlock->pUserData   = pUserData;` |
|  13083569 |   81 | `	pBlock->pGen        = pGen;` |
|  13083569 |   82 | `	pBlock->iFlags      = iType;` |
|  13083569 |   83 | `	pBlock->pParent     = 0;` |
|  13083569 |   84 | `	SySetInit(&pBlock->aJumpFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  13083569 |   85 | `	SySetInit(&pBlock->aPostContFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  13083569 |   86 | `}` |
|         - |   87 | `/*` |
...
|         - |   92 | ` */` |
|  13079684 |   93 | `PH7_PRIVATE sxi32 GenStateEnterBlock(` |
...
|  13079689 |  103 | `	pBlock = (GenBlock *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(GenBlock));` |
|  13079689 |  104 | `	if( pBlock == 0 ){` |
...
|  13079689 |  113 | `	SyZero(pBlock,sizeof(GenBlock));` |
|  13079689 |  114 | `	GenStateInitBlock(&(*pGen),pBlock,iType,nFirstInstr,pUserData);` |
|         - |  115 | `	/* Link to the parent block */` |
|  13079689 |  116 | `	pBlock->pParent = pGen->pCurrent;` |
...
|  13079689 |  119 | `	if( iType & (GEN_BLOCK_LOOP\|GEN_BLOCK_SWITCH) ){` |
...
|  13079689 |  128 | `	pGen->pCurrent = pBlock;` |
|  13079689 |  129 | `	if( ppBlock ){` |
|         - |  130 | `		/* Write a pointer to the new instance */` |
|   6290429 |  131 | `		*ppBlock = pBlock;` |
|   3145212 |  132 | `	}` |
|  13079689 |  133 | `	return SXRET_OK;` |
|   6539847 |  134 | `}` |
|         - |  135 | `/*` |
|         - |  136 | ` * Release block fields without freeing the whole instance.` |
|         - |  137 | ` */` |
|  13079676 |  138 | `static void GenStateReleaseBlock(GenBlock *pBlock)` |
|         5 |  139 | `{` |
|  13079681 |  140 | `	SySetRelease(&pBlock->aPostContFix);` |
|  13079681 |  141 | `	SySetRelease(&pBlock->aJumpFix);` |
|  13079681 |  142 | `}` |
|         - |  143 | `/*` |
|         - |  144 | ` * Release a block.` |
|         - |  145 | ` */` |
|  13079672 |  146 | `static void GenStateFreeBlock(GenBlock *pBlock)` |
|         5 |  147 | `{` |
|  13079677 |  148 | `	ph7_gen_state *pGen = pBlock->pGen;` |
|  13079677 |  149 | `	GenStateReleaseBlock(&(*pBlock));` |
|         - |  150 | `	/* Free the instance */` |
|  13079677 |  151 | `	SyMemBackendPoolFree(&pGen->pVm->sAllocator,pBlock);` |
|  13079677 |  152 | `}` |
|         - |  153 | `/*` |
|         - |  154 | ` * POP and release a block from the stack of compiled blocks.` |
|         - |  155 | ` */` |
|  13079672 |  156 | `PH7_PRIVATE sxi32 GenStateLeaveBlock(ph7_gen_state *pGen,GenBlock **ppBlock)` |
|         5 |  157 | `{` |
|  13079677 |  158 | `	GenBlock *pBlock = pGen->pCurrent;` |
|  13079677 |  159 | `	if( pBlock == 0 ){` |
|         - |  160 | `		/* No more block to pop */` |
|       ! 0 |  161 | `		return SXERR_EMPTY;` |
|         - |  162 | `	}` |
|  13079677 |  163 | `	if( pBlock->iFlags & (GEN_BLOCK_LOOP\|GEN_BLOCK_SWITCH) ){` |
|    539915 |  164 | `		pGen->nCurLoopId = pBlock->nOuterLoopId;` |
|    269955 |  165 | `	}` |
|         - |  166 | `	/* Point to the upper block */` |
|  13079677 |  167 | `	pGen->pCurrent = pBlock->pParent;` |
|  13079677 |  168 | `	if( ppBlock ){` |
|         - |  169 | `		/* Write a pointer to the popped block */` |
|       ! 0 |  170 | `		*ppBlock = pBlock;` |
|       ! 0 |  171 | `	}else{` |
|         - |  172 | `		/* Safely release the block */` |
|  13079677 |  173 | `		GenStateFreeBlock(&(*pBlock));` |
|         - |  174 | `	}` |
|  13079677 |  175 | `	return SXRET_OK;` |
|   6539841 |  176 | `}` |
|         - |  177 | `/*` |
...
|         - |  257 | ` */` |
|   4723680 |  258 | `PH7_PRIVATE sxi32 GenStateNewJumpFixup(GenBlock *pBlock,sxi32 nJumpType,sxu32 nInstrIdx)` |
|         5 |  259 | `{` |
|         - |  260 | `	JumpFixup sJumpFix;` |
|         - |  261 | `	sxi32 rc;` |
|         - |  262 | `	/* Init the JumpFixup structure */` |
|   4723685 |  263 | `	sJumpFix.nJumpType = nJumpType;` |
|   4723685 |  264 | `	sJumpFix.nInstrIdx = nInstrIdx;` |
|         - |  265 | `	/* Insert in the jump fixup table */` |
|   4723685 |  266 | `	rc = SySetPut(&pBlock->aJumpFix,(const void *)&sJumpFix);` |
|   4723685 |  267 | `	return rc;` |
|         5 |  268 | `}` |
|         - |  269 | `/*` |
...
|         - |  279 | ` */` |
|   9092960 |  280 | `PH7_PRIVATE sxu32 GenStateFixJumps(GenBlock *pBlock,sxi32 nJumpType,sxu32 nJumpDest)` |
|         5 |  281 | `{` |
|         - |  282 | `	JumpFixup *aFix;` |
|         - |  283 | `	VmInstr *pInstr;` |
|         - |  284 | `	sxu32 nFixed;` |
...
|   9092965 |  287 | `	aFix = (JumpFixup *)SySetBasePtr(&pBlock->aJumpFix);` |
|         - |  288 | `	/* Fix the desired jumps */` |
|  19032965 |  289 | `	for( nFixed = n = 0 ; n < SySetUsed(&pBlock->aJumpFix) ; ++n ){` |
|   9940005 |  290 | `		if( aFix[n].nJumpType < 0 ){` |
|         - |  291 | `			/* Already fixed */` |
|   3711619 |  292 | `			continue;` |
|         - |  293 | `		}` |
|   6228391 |  294 | `		if( nJumpType > 0 && aFix[n].nJumpType != nJumpType ){` |
|         - |  295 | `			/* Not of our interest */` |
|   1504713 |  296 | `			continue;` |
|         - |  297 | `		}` |
|         - |  298 | `		/* Point to the instruction to fix */` |
|   4723683 |  299 | `		pInstr = PH7_VmGetInstr(pBlock->pGen->pVm,aFix[n].nInstrIdx);` |
|   4723683 |  300 | `		if( pInstr ){` |
|   4723683 |  301 | `			pInstr->iP2 = nJumpDest;` |
|   4723683 |  302 | `			nFixed++;` |
|         - |  303 | `			/* Mark as fixed */` |
|   4723683 |  304 | `			aFix[n].nJumpType = -1;` |
|   2361839 |  305 | `		}` |
|   2361844 |  306 | `	}` |
|         - |  307 | `	/* Total number of fixed jumps */` |
|   9092965 |  308 | `	return nFixed;` |
|         5 |  309 | `}` |
|         - |  310 | `/*` |
...
|         - |  316 | ` */` |
|   3366532 |  317 | `PH7_PRIVATE sxi32 GenStateFixGoto(ph7_gen_state *pGen,sxu32 nOfft)` |
|         5 |  318 | `{` |
...
|   3366537 |  325 | `	aJumps = (JumpFixup *)SySetBasePtr(&pGen->aGoto);` |
|         - |  326 | `	/* Fix */` |
|   3366683 |  327 | `	for( n = nOfft ; n < SySetUsed(&pGen->aGoto) ; ++n ){` |
...
|   3366535 |  378 | `	return SXRET_OK;` |
|   1683271 |  379 | `}` |
|         - |  380 | `/*` |
|         - |  381 | ` * Check if a given token value is installed in the literal table.` |
|         - |  382 | ` */` |
|  16863810 |  383 | `PH7_PRIVATE sxi32 GenStateFindLiteral(ph7_gen_state *pGen,const SyString *pValue,sxu32 *pIdx)` |
|         5 |  384 | `{` |
|         - |  385 | `	SyHashEntry *pEntry;` |
|  16863815 |  386 | `	pEntry = SyHashGet(&pGen->hLiteral,(const void *)pValue->zString,pValue->nByte);` |
|  16863815 |  387 | `	if( pEntry == 0 ){` |
|   4495783 |  388 | `		return SXERR_NOTFOUND;` |
|         - |  389 | `	}` |
|  12368037 |  390 | `	*pIdx = (sxu32)SX_PTR_TO_INT(pEntry->pUserData);` |
|  12368037 |  391 | `	return SXRET_OK;` |
|   8431910 |  392 | `}` |
|         - |  393 | `/*` |
...
|         - |  402 | ` */` |
|   4495778 |  403 | `PH7_PRIVATE sxi32 GenStateInstallLiteral(ph7_gen_state *pGen,ph7_value *pObj,sxu32 nIdx)` |
|         5 |  404 | `{` |
|   4495783 |  405 | `	if( SyBlobLength(&pObj->sBlob) > 0 ){` |
|   4495783 |  406 | `		SyHashInsert(&pGen->hLiteral,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob),SX_INT_TO_PTR(nIdx));` |
|   2247889 |  407 | `	}` |
|   4495783 |  408 | `	return SXRET_OK;` |
|         5 |  409 | `}` |
|         - |  410 | `/*` |
...
|         - |  443 | ` */` |
|   7933746 |  444 | `PH7_PRIVATE void *GenStateAttachStrictFlag(ph7_gen_state *pGen, void *p3)` |
|         5 |  445 | `{` |
|         - |  446 | `	VmCallArgMap *pMap;` |
|   7933751 |  447 | `	if( !pGen->bStrictTypes ) return p3;` |
|        58 |  448 | `	if( p3 == 0 ){` |
...
|         - |  507 | ` */` |
|  53897576 |  508 | `static void GenStatePatchNullsafeJumps(ph7_gen_state *pGen, sxu32 nBaseline)` |
|         5 |  509 | `{` |
|  53897581 |  510 | `	sxu32 nCur = SySetUsed(&pGen->aNullsafeJmp);` |
|         - |  511 | `	sxu32 nTarget;` |
|         - |  512 | `	sxu32 *aIdx;` |
|         - |  513 | `	sxu32 i;` |
|  53897581 |  514 | `	if( nCur <= nBaseline ){` |
|  53897485 |  515 | `		return;` |
|         - |  516 | `	}` |
...
|         - |  544 | ` */` |
|   7046338 |  545 | `static sxu32 GenStateByRefBuiltinMask(SyString *pName)` |
|         5 |  546 | `{` |
...
|         - |  562 | `	};` |
|         - |  563 | `	sxu32 i;` |
|   7046343 |  564 | `	if( pName == 0 \|\| pName->zString == 0 \|\| pName->nByte == 0 ){` |
|   1803953 |  565 | `		return 0;` |
|         - |  566 | `	}` |
|  57184459 |  567 | `	for( i = 0 ; i < SX_ARRAYSIZE(aByRef) ; ++i ){` |
|  52000370 |  568 | `		if( pName->nByte == aByRef[i].nByte` |
|  27513576 |  569 | `		 && SyStrnicmp(pName->zString, aByRef[i].zName, pName->nByte) == 0 ){` |
|     58311 |  570 | `			return aByRef[i].mask;` |
|         - |  571 | `		}` |
|  25971037 |  572 | `	}` |
|   5184089 |  573 | `	return 0;` |
|   3523174 |  574 | `}` |
|         - |  575 | `/*` |
...
|         - |  584 | ` */` |
|   7046338 |  585 | `static void GenStateCallBuiltinName(ph7_expr_node *pLeft, SyString *pOut)` |
|         5 |  586 | `{` |
|         - |  587 | `	SyToken *p, *pEnd;` |
|   7046343 |  588 | `	pOut->zString = 0;` |
|   7046343 |  589 | `	pOut->nByte = 0;` |
|   7046343 |  590 | `	if( pLeft == 0 \|\| pLeft->pStart == 0 \|\| pLeft->pEnd == 0 ){` |
|       ! 0 |  591 | `		return;` |
|         - |  592 | `	}` |
|   7046343 |  593 | `	p = pLeft->pStart;` |
|   7046343 |  594 | `	pEnd = pLeft->pEnd;` |
|         - |  595 | `	/* Optional single leading namespace separator (absolute path). */` |
|   7046343 |  596 | `	if( p < pEnd && (p->nType & PH7_TK_NSSEP) ){` |
|      3919 |  597 | `		p++;` |
|      1957 |  598 | `	}` |
|   7046343 |  599 | `	if( p >= pEnd \|\| (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|   1803907 |  600 | `		return;` |
|         - |  601 | `	}` |
|         - |  602 | `	/* Must be a single component: nothing follows the name token. */` |
|   5242441 |  603 | `	if( p + 1 != pEnd ){` |
|        51 |  604 | `		return;` |
|         - |  605 | `	}` |
|   5242395 |  606 | `	*pOut = p->sData;` |
|   3523174 |  607 | `}` |
|         - |  608 | `/*` |
...
|         - |  613 | ` * error message.` |
|         - |  614 | ` */` |
|  75995138 |  615 | `static sxi32 GenStateEmitExprCode(` |
...
|         - |  621 | `	VmInstr *pInstr;` |
|         - |  622 | `	sxu32 nJmpIdx;` |
|  75995143 |  623 | `	sxi32 iP1 = 0;` |
|  75995143 |  624 | `	sxu32 iP2 = 0;` |
|  75995143 |  625 | `	void *p3  = 0;` |
|         - |  626 | `	sxi32 iVmOp;` |
|         - |  627 | `	sxi32 rc;` |
|  75995143 |  628 | `	int bIsChainOp = 0; /* Set below once we know pNode->pOp */` |
|  75995143 |  629 | ``	int bFcc = 0;       /* First-class callable `f(...)`: emit OP_LOAD_FCC, not OP_CALL */`` |
|  75995143 |  630 | `	sxu32 nRhsNsBase = 0;` |
|  75995143 |  631 | `	if( pNode->xCode ){` |
|         - |  632 | `		SyToken *pTmpIn,*pTmpEnd;` |
|         - |  633 | `		/* Compile node */` |
|  45867139 |  634 | `		SWAP_DELIMITER(pGen,pNode->pStart,pNode->pEnd);` |
|  45867139 |  635 | `		rc = pNode->xCode(&(*pGen),iFlags);` |
|  45867139 |  636 | `		RE_SWAP_DELIMITER(pGen);` |
|  45867139 |  637 | `		return rc;` |
|         - |  638 | `	}` |
|  30128009 |  639 | `	if( pNode->pOp == 0 ){` |
...
|         - |  643 | `	}` |
|  30128009 |  644 | `	iVmOp = pNode->pOp->iVmOp;` |
|  30128009 |  645 | `	if( iVmOp == PH7_OP_CVT_NULL ){` |
...
|         - |  653 | `		}` |
|         1 |  654 | `	}` |
|  30128009 |  655 | `	if( pNode->pOp->iOp == EXPR_OP_NULLC_ASSIGN ){` |
|        93 |  656 | `		sxu32 nJmp = 0;` |
|         - |  657 | `		sxu32 nNcNsBase;` |
...
|         - |  704 | `	}` |
|  30127919 |  705 | `	if( pNode->pOp->iOp == EXPR_OP_QUESTY ){` |
|         - |  706 | `		sxu32 nJz,nJmp;` |
...
|         - |  767 | `	}` |
|  29624615 |  768 | `	if( pNode->pOp->iOp == EXPR_OP_PIPE ){` |
...
|         - |  800 | `	}` |
|  29624589 |  801 | `	bIsChainOp = GEN_IS_CHAIN_OP(pNode->pOp->iOp);` |
|         - |  802 | `	/* Generate code for the left tree */` |
|  29624589 |  803 | `	if( pNode->pLeft ){` |
|  29570513 |  804 | `		sxu32 nLhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  29570513 |  805 | `		if( iVmOp == PH7_OP_CALL ){` |
|         - |  806 | `			ph7_expr_node **apNode;` |
|   7050559 |  807 | `			int hasSpread = 0;` |
|   7050559 |  808 | `			int hasNamed = 0;` |
|   7050559 |  809 | `			int bAnySpread = 0;` |
|   7050559 |  810 | `			sxu32 byRefMask = 0;` |
|         - |  811 | `			sxi32 nArgs;` |
|         - |  812 | `			sxi32 n;` |
|         - |  813 | `			/* Recurse and generate bytecodes for function arguments */` |
|   7050559 |  814 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|   7050559 |  815 | `			nArgs = (sxi32)SySetUsed(&pNode->aNodeArgs);` |
...
|   7050559 |  819 | `			if( nArgs == 1 && apNode[0] && (apNode[0]->iFlags & EXPR_NODE_FCC) ){` |
|        81 |  820 | `				bFcc = 1;` |
|        81 |  821 | `				nArgs = 0;` |
|        40 |  822 | `			}` |
...
|         - |  825 | `			{` |
|   7050559 |  826 | `				int seenNamed = 0;` |
|   7050559 |  827 | `				int seenSpread = 0;` |
|  15056789 |  828 | `				for( n = 0; n < nArgs; ++n ){` |
|   8006237 |  829 | `					if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
...
|         5 |  836 | `						}` |
|   8004201 |  837 | `					}else if( apNode[n]->iFlags & EXPR_NODE_NAMED_ARG ){` |
|       300 |  838 | `						seenNamed = 1;` |
|       300 |  839 | `						hasNamed = 1;` |
|   8002017 |  840 | `					}else if( seenNamed ){` |
...
|   8001867 |  844 | `					}else if( seenSpread ){` |
...
|         - |  850 | `			}` |
|         - |  851 | `			/* Read-only load */` |
|   7050557 |  852 | `			iFlags \|= EXPR_FLAG_RDONLY_LOAD;` |
...
|   7050557 |  857 | `			if( pNode->pLeft && pNode->pLeft->pStart ){` |
|   7050557 |  858 | `				SyString *pCallName = &pNode->pLeft->pStart->sData;` |
|   7050552 |  859 | `				if( pCallName->nByte == 5` |
|   3918204 |  860 | `				 && SyStrnicmp(pCallName->zString,"isset",5) == 0 ){` |
|    325993 |  861 | `					iFlags \|= EXPR_FLAG_LOAD_IDX_ISSET;` |
|   6887563 |  862 | `				}else if( pCallName->nByte == 5` |
|   3592216 |  863 | `				 && SyStrnicmp(pCallName->zString,"empty",5) == 0 ){` |
...
|   7050557 |  872 | `				if( !bAnySpread && !hasNamed ){` |
|         - |  873 | `					SyString sBuiltin;` |
|   7046343 |  874 | `					GenStateCallBuiltinName(pNode->pLeft, &sBuiltin);` |
|   7046343 |  875 | `					byRefMask = GenStateByRefBuiltinMask(&sBuiltin);` |
|   3523169 |  876 | `				}` |
|   3525276 |  877 | `			}` |
|  15056785 |  878 | `			for( n = 0 ; n < nArgs ; ++n ){` |
|   8006233 |  879 | `				sxu32 nArgNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|   8006233 |  880 | `				sxi32 iArgFlags = iFlags & ~(EXPR_FLAG_LOAD_IDX_STORE\|EXPR_FLAG_MEMBER_WRITE);` |
...
|   8006233 |  887 | `				if( n < 31 && (byRefMask & (1u<<n)) ){` |
...
|   8006228 |  901 | `				if( (iFlags & (EXPR_FLAG_LOAD_IDX_ISSET\|EXPR_FLAG_LOAD_IDX_EMPTY\|EXPR_FLAG_LOAD_IDX_UNSET)) == 0` |
|   7843166 |  902 | `				 && apNode[n]->pOp == 0 && apNode[n]->xCode == PH7_CompileVariable` |
|   4110461 |  903 | `				 && (apNode[n]->iFlags & (EXPR_NODE_NAMED_ARG\|EXPR_NODE_SPREAD)) == 0 ){` |
|   3359267 |  904 | `					iArgFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|   1679631 |  905 | `				}` |
|   8006233 |  906 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iArgFlags);` |
|   8006233 |  907 | `				if( rc != SXRET_OK ){` |
|       ! 0 |  908 | `					return rc;` |
|         - |  909 | `				}` |
|         - |  910 | `				/* Each argument is an independent nullsafe scope. */` |
|   8006233 |  911 | `				GenStatePatchNullsafeJumps(pGen, nArgNsBase);` |
|   8006233 |  912 | `				if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
...
|   7050557 |  955 | `			iFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|   3525276 |  956 | `		}` |
|         - |  957 | `		{` |
...
|  29570511 |  966 | `			sxi32 iLeftFlags = iFlags;` |
|  29570511 |  967 | `			sxu32 nNullcLhsFirst = PH7_VmInstrLength(pGen->pVm);` |
|  29570511 |  968 | `			int bNullcLhs = 0;` |
|  29570506 |  969 | `			if( pNode->pLeft && pNode->pLeft->pOp` |
|  24009952 |  970 | `				&& (pNode->pLeft->pOp->iOp == EXPR_OP_ARROW` |
|   9224725 |  971 | `					\|\| pNode->pLeft->pOp->iOp == EXPR_OP_NULLSAFE_ARROW` |
|   7941211 |  972 | `					\|\| pNode->pLeft->pOp->iOp == EXPR_OP_DC) ){` |
|   2776943 |  973 | `				iLeftFlags &= ~EXPR_FLAG_LOAD_IDX_UNSET;` |
|   1388469 |  974 | `			}` |
...
|  29570506 |  982 | `			if( pNode->pOp` |
|  41573064 |  983 | `				&& (pNode->pOp->iOp == EXPR_OP_ARROW` |
|  26787858 |  984 | `					\|\| pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW` |
|  24005158 |  985 | `					\|\| pNode->pOp->iOp == EXPR_OP_DC) ){` |
|   5985065 |  986 | `				iLeftFlags &= ~EXPR_FLAG_MEMBER_WRITE;` |
|   2992530 |  987 | `			}` |
...
|  29570506 |  994 | `			if( pNode->pOp` |
|  29570511 |  995 | `				&& (pNode->pOp->iVmOp == PH7_OP_INCR \|\| pNode->pOp->iVmOp == PH7_OP_DECR) ){` |
...
|  29570511 | 1006 | `			if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLC && pNode->pLeft ){` |
...
|        18 | 1024 | `				}` |
|     29162 | 1025 | `			}` |
|  29570511 | 1026 | `			if( iVmOp == PH7_OP_ERR_CTRL ){` |
...
|      7870 | 1030 | `			}` |
|  29570511 | 1031 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pLeft,iLeftFlags\|EXPR_FLAG_RDONLY_LOAD);` |
|  29570511 | 1032 | `			if( rc == SXRET_OK && bNullcLhs ){` |
...
|     29162 | 1049 | `			}` |
|         - | 1050 | `		}` |
|  29570511 | 1051 | `		if( rc != SXRET_OK ){` |
|        34 | 1052 | `			return rc;` |
|         - | 1053 | `		}` |
|  29570481 | 1054 | `		if( !bIsChainOp ){` |
...
|  13512011 | 1057 | `			GenStatePatchNullsafeJumps(pGen, nLhsNsBase);` |
|   6756003 | 1058 | `		}` |
|  29570481 | 1059 | `		if( iVmOp == PH7_OP_CALL ){` |
|   7050557 | 1060 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|   7050557 | 1061 | `			if( pInstr ){` |
|   7050557 | 1062 | `				if ( pInstr->iOp == PH7_OP_LOADC ){` |
|   5242703 | 1063 | `					sxu32 nOrig = (sxu32)pInstr->iP2;` |
|         - | 1064 | `					sxu32 nQual;` |
|   5242703 | 1065 | `					int bAbsolute = (pInstr->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|         - | 1066 | `					/* Prevent constant expansion but preserve the absolute flag` |
|         - | 1067 | `					 * so the later NEW handler (if any) can see it. */` |
|   5242703 | 1068 | `					pInstr->iP1 &= ~PH7_LOADC_EXPAND;` |
...
|   5242703 | 1076 | `					if( bAbsolute ){` |
|      3919 | 1077 | `						pInstr->iP2 = (sxi32)nOrig;` |
|      1962 | 1078 | `					}else{` |
|   5238789 | 1079 | `						int fromImport = 0;` |
|   5238789 | 1080 | `						nQual = GenStateNsQualifyName(pGen,nOrig,&pGen->hUseFuncImports,&fromImport);` |
|   5238789 | 1081 | `						pInstr->iP2 = (sxi32)nQual;` |
|   5238789 | 1082 | `						if( nQual != nOrig ){` |
...
|        49 | 1103 | `						}` |
|         - | 1104 | `					}` |
|   4429208 | 1105 | `				}else if( (pInstr->iOp == PH7_OP_MEMBER /* $a->b(1,2,3) */` |
|   1797810 | 1106 | `						&& !(pNode->pLeft && (pNode->pLeft->iFlags & EXPR_NODE_PARENS)))` |
|    913978 | 1107 | `					\|\| pInstr->iOp == PH7_OP_NEW ){` |
...
|   1787773 | 1123 | `					if( pInstr->iOp == PH7_OP_MEMBER && pInstr->iP1 == 1 && pInstr->p3 ){` |
...
|    893884 | 1129 | `				}` |
|   3525281 | 1130 | `			}` |
|  26045205 | 1131 | `		}else if( iVmOp == PH7_OP_LOAD_IDX ){` |
...
|    555187 | 1166 | `				iP2 = 1;` |
|    277596 | 1167 | `			}` |
|  21008500 | 1168 | `		}else if( pNode->pOp->iOp == EXPR_OP_COMMA ){` |
|         - | 1169 | `			/* POP the left node */` |
|         5 | 1170 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|         2 | 1171 | `		}` |
|  14785238 | 1172 | `	}` |
|  29624557 | 1173 | `	rc = SXRET_OK;` |
|  29624557 | 1174 | `	nJmpIdx = 0;` |
...
|  29624557 | 1178 | `	if( iVmOp == PH7_OP_MEMBER && pNode->pOp->iOp == EXPR_OP_DC ){` |
...
|  29577963 | 1217 | `	if( pNode->pRight ){` |
|  16987511 | 1218 | `		if( iVmOp == PH7_OP_LAND ){` |
...
|  16762452 | 1221 | `		}else if (iVmOp == PH7_OP_LOR ){` |
...
|  16374522 | 1224 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLC ){` |
...
|  16182541 | 1228 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW ){` |
...
|  16153275 | 1238 | `		}else if( pNode->pOp->iPrec == 18 /* Combined binary operators [i.e: =,'.=','+=',*=' ...] precedence */ ){` |
...
|   5209841 | 1242 | `			iFlags \|= EXPR_FLAG_LOAD_IDX_STORE \| EXPR_FLAG_MEMBER_WRITE;` |
|   5209841 | 1243 | `			if( iVmOp != PH7_OP_STORE ){` |
...
|    224983 | 1248 | `			}` |
|   2604918 | 1249 | `		}` |
|  16987511 | 1250 | `		nRhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  16987511 | 1251 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pRight,iFlags\|EXPR_FLAG_RDONLY_LOAD);` |
|  16987511 | 1252 | `		if( !bIsChainOp ){` |
|         - | 1253 | `			/* Non-chain parent: RHS nullsafe chain ends here, before the` |
|         - | 1254 | `			 * operator instruction is emitted. */` |
|  11002525 | 1255 | `			GenStatePatchNullsafeJumps(pGen, nRhsNsBase);` |
|   5501260 | 1256 | `		}` |
|  16987511 | 1257 | `		if( iVmOp == PH7_OP_STORE ){` |
|   4759875 | 1258 | `			if( pNode->pRight && (pNode->pRight->xCode == PH7_CompileList \|\|` |
|   4759838 | 1259 | `				pNode->pRight->xCode == PH7_CompileShortList) ){` |
...
|         - | 1265 | `				 */` |
|        91 | 1266 | `				iVmOp = 0;` |
|   4759832 | 1267 | `			}else if( (pInstr = PH7_VmPeekInstr(pGen->pVm)) != 0 ){` |
|   4759789 | 1268 | `				if(pInstr->iOp == PH7_OP_MEMBER ){` |
|         - | 1269 | `					/* Perform a member store operation [i.e: $this->x = 50] */` |
|    919387 | 1270 | `					iP2 = 1;` |
|    459696 | 1271 | `				}else{` |
|   3840407 | 1272 | `					if( pInstr->iOp == PH7_OP_LOAD_IDX ){` |
...
|    267856 | 1276 | `					}else{` |
|   3304705 | 1277 | `						p3 = pInstr->p3;` |
|         - | 1278 | `					}` |
|         - | 1279 | `					/* POP the last dynamic load instruction */` |
|   3840407 | 1280 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|         - | 1281 | `				}` |
|   2379897 | 1282 | `			}` |
|  14607576 | 1283 | `		}else if( iVmOp == PH7_OP_STORE_REF ){` |
...
|        35 | 1310 | `		}` |
|   8493753 | 1311 | `	}` |
|  29577958 | 1312 | `	if( iVmOp == PH7_OP_NEW && pNode->pLeft && pNode->pLeft->pOp == 0` |
...
|        34 | 1316 | `		iVmOp = 0;` |
|        15 | 1317 | `	}` |
|  29577963 | 1318 | `	if( iVmOp > 0 ){` |
|  29519519 | 1319 | `		if( iVmOp == PH7_OP_INCR \|\| iVmOp == PH7_OP_DECR ){` |
|    217501 | 1320 | `			if( pNode->iFlags & EXPR_NODE_PRE_INCR ){` |
|         - | 1321 | `				/* Pre-increment/decrement operator [i.e: ++$i,--$j ] */` |
|     15537 | 1322 | `				iP1 = 1;` |
|      7771 | 1323 | `			}` |
|  29410771 | 1324 | `		}else if( iVmOp == PH7_OP_NEW ){` |
...
|    427757 | 1388 | `				}` |
|    427762 | 1389 | `			}` |
|  28864574 | 1390 | `		}else if( iVmOp == PH7_OP_IS_A ){` |
...
|     40842 | 1410 | `				}` |
|     40857 | 1411 | `			}` |
|  28393829 | 1412 | `		}else if( iVmOp == PH7_OP_MEMBER){` |
...
|   5984991 | 1416 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|   5984991 | 1417 | `			if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|   5744577 | 1418 | `				pInstr->iP1 = 0;` |
|   2872286 | 1419 | `			}` |
|   5984991 | 1420 | `			if( pNode->pOp->iOp == EXPR_OP_DC /* '::' */){` |
...
|   5984991 | 1433 | `			if( iP2 == PH7_MEMBER_READ ){` |
|   5984991 | 1434 | `				if( iFlags & EXPR_FLAG_LOAD_IDX_UNSET ){` |
|        42 | 1435 | `					iP2 = PH7_MEMBER_UNSET;` |
|   5984971 | 1436 | `				}else if( iFlags & EXPR_FLAG_LOAD_IDX_ISSET ){` |
|     69911 | 1437 | `					iP2 = PH7_MEMBER_ISSET;` |
|   5949998 | 1438 | `				}else if( iFlags & EXPR_FLAG_LOAD_IDX_EMPTY ){` |
|        17 | 1439 | `					iP2 = PH7_MEMBER_EMPTY;` |
|   5915037 | 1440 | `				}else if( iFlags & EXPR_FLAG_MEMBER_WRITE ){` |
...
|  29511963 | 1473 | `		if( iVmOp == PH7_OP_CALL \|\| iVmOp == PH7_OP_NEW ){` |
|   7910263 | 1474 | `			p3 = GenStateAttachStrictFlag(pGen,p3);` |
|   3955129 | 1475 | `		}` |
|         - | 1476 | `		/* Finally,emit the VM instruction associated with this operator */` |
|  29511963 | 1477 | `		PH7_VmEmitInstr(pGen->pVm,iVmOp,iP1,iP2,p3,0);` |
|  14755979 | 1478 | `	}` |
|  29570407 | 1479 | `	if( nJmpIdx > 0 ){` |
...
|         - | 1509 | ` */` |
| 252091818 | 1510 | `static int GenStateTreeHasComma(ph7_expr_node *pNode)` |
|         5 | 1511 | `{` |
|         - | 1512 | `	ph7_expr_node **apArg;` |
|         - | 1513 | `	sxu32 n;` |
| 252091823 | 1514 | `	if( pNode == 0 ){` |
| 177229341 | 1515 | `		return 0;` |
|         - | 1516 | `	}` |
|  74862487 | 1517 | `	if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_COMMA ){` |
|         6 | 1518 | `		return 1;` |
|         - | 1519 | `	}` |
|  74862478 | 1520 | `	if( GenStateTreeHasComma(pNode->pLeft) \|\| GenStateTreeHasComma(pNode->pRight)` |
|  74862479 | 1521 | `	 \|\| GenStateTreeHasComma(pNode->pCond) ){` |
|         6 | 1522 | `		return 1;` |
|         - | 1523 | `	}` |
|  74862479 | 1524 | `	apArg = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  85631515 | 1525 | `	for( n = 0 ; n < SySetUsed(&pNode->aNodeArgs) ; n++ ){` |
|  10769041 | 1526 | `		if( GenStateTreeHasComma(apArg[n]) ){` |
|       ! 0 | 1527 | `			return 1;` |
|         - | 1528 | `		}` |
|   5384523 | 1529 | `	}` |
|  74862479 | 1530 | `	return 0;` |
| 126045914 | 1531 | `}` |
...
| 133928049 | 1557 | `	while( pEnd < pGen->pEnd ){` |
| 127350201 | 1558 | `		if( pEnd->nType & PH7_TK_OCB /* '{' */ ){` |
|         - | 1559 | `			/* Ticket 1433-30: Annonymous/Closure functions body */` |
|      4723 | 1560 | `			iNest++;` |
| 127347842 | 1561 | `		}else if(pEnd->nType & PH7_TK_CCB /* '}' */ ){` |
|      4733 | 1562 | `			iNest--;` |
| 127343119 | 1563 | `		}else if( pEnd->nType & PH7_TK_SEMI /* ';' */ ){` |
|  10531123 | 1564 | `			if( iNest <= 0 ){` |
|  10530245 | 1565 | `				break;` |
|         - | 1566 | `			}` |
|       439 | 1567 | `		}` |
| 116819961 | 1568 | `		pEnd++;` |
...
|         - | 1642 | ` */` |
|   9502256 | 1643 | `PH7_PRIVATE ProcNodeConstruct PH7_GetNodeHandler(sxu32 nNodeType)` |
|         5 | 1644 | `{` |
|   9502261 | 1645 | `	if( nNodeType & PH7_TK_NUM ){` |
|         - | 1646 | `		/* Numeric literal: Either real or integer */` |
|   3821439 | 1647 | `		return PH7_CompileNumLiteral;` |
|   5680827 | 1648 | `	}else if( nNodeType & PH7_TK_DSTR ){` |
|         - | 1649 | `		/* Double quoted string */` |
|    124909 | 1650 | `		return PH7_CompileString;` |
|   5555923 | 1651 | `	}else if( nNodeType & PH7_TK_SSTR ){` |
|         - | 1652 | `		/* Single quoted string */` |
|   5555799 | 1653 | `		return PH7_CompileSimpleString;` |
...
|         - | 1688 | ` */` |
|     26078 | 1689 | `static sxi32 PH7_CompileUnset(ph7_gen_state *pGen)` |
|         5 | 1690 | `{` |
|     26083 | 1691 | `	SyToken *pTmp,*pEnd,*pNext = 0;` |
|     26083 | 1692 | `	sxu32 nIdx = 0;` |
|         - | 1693 | `	SyString sName;` |
|         - | 1694 | `	sxi32 rc;` |
|         - | 1695 | `	/* Jump the 'unset' keyword */` |
|     26083 | 1696 | `	pGen->pIn++;` |
|         - | 1697 | `	/* Save delimiter */` |
|     26083 | 1698 | `	pTmp = pGen->pEnd;` |
|         - | 1699 | `	/* Skip optional opening parenthesis and find the matching close */` |
|     26083 | 1700 | `	pEnd = pTmp; /* Default: scan to statement end */` |
|     26083 | 1701 | `	if( pGen->pIn < pTmp && (pGen->pIn->nType & PH7_TK_LPAREN) ){` |
|         - | 1702 | `		/* Find matching ')' — start scanning AFTER the '(' */` |
|         - | 1703 | `		SyToken *pClose;` |
|     26083 | 1704 | `		pGen->pIn++;   /* Skip '(' */` |
|     26083 | 1705 | `		PH7_DelimitNestedTokens(pGen->pIn,pTmp,PH7_TK_LPAREN,PH7_TK_RPAREN,&pClose);` |
|     26083 | 1706 | `		pEnd = pClose; /* Stop at ')' */` |
|     13039 | 1707 | `	}` |
|     26083 | 1708 | `	SyStringInitFromBuf(&sName,"unset",sizeof("unset")-1);` |
|         - | 1709 | `	/* Resolve the 'unset' builtin name once */` |
|     26083 | 1710 | `	if( SXRET_OK != GenStateFindLiteral(&(*pGen),&sName,&nIdx) ){` |
...
|     56039 | 1719 | `	while( SXRET_OK == PH7_GetNextExpr(pGen->pIn,pEnd,&pNext) ){` |
|     29961 | 1720 | `		if( pGen->pIn < pNext ){` |
|         - | 1721 | `			/*` |
...
|         - | 1728 | `			 */` |
|     29956 | 1729 | `			if( &pGen->pIn[2] == pNext` |
|     18269 | 1730 | `				&& (pGen->pIn[0].nType & PH7_TK_DOLLAR)` |
|      6587 | 1731 | `				&& (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|         - | 1732 | `				SyString *pVarName;` |
|      9875 | 1733 | `				char *zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|      6580 | 1734 | `					pGen->pIn[1].sData.zString,pGen->pIn[1].sData.nByte);` |
|      6585 | 1735 | `				pVarName = (SyString *)SyMemBackendAlloc(&pGen->pVm->sAllocator,sizeof(SyString));` |
|      6585 | 1736 | `				if( zDup == 0 \|\| pVarName == 0 ){` |
|       ! 0 | 1737 | `					PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,` |
|         - | 1738 | `						"Fatal, PH7 is running out of memory");` |
|       ! 0 | 1739 | `					return SXERR_ABORT;` |
|         - | 1740 | `				}` |
|      6585 | 1741 | `				SyStringInitFromBuf(pVarName,zDup,pGen->pIn[1].sData.nByte);` |
|      6585 | 1742 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_UNSET_VAR,0,0,pVarName,0);` |
|      6585 | 1743 | `				pGen->pIn = pNext;` |
|      6585 | 1744 | `				if( pGen->pIn < pEnd ){` |
...
|     26083 | 1770 | `	if( pGen->pIn < pTmp && (pGen->pIn->nType & PH7_TK_RPAREN) ){` |
|     26083 | 1771 | `		pGen->pIn++;` |
|     13039 | 1772 | `	}` |
|         - | 1773 | `	/* Restore token stream */` |
|     26083 | 1774 | `	pGen->pEnd = pTmp;` |
|     26083 | 1775 | `	return SXRET_OK;` |
|     13044 | 1776 | `}` |
|         - | 1777 | `/*` |
...
|         - | 1809 | ` */` |
|   8451354 | 1810 | `static ProcLangConstruct GenStateGetStatementHandler(` |
|         - | 1811 | `	sxu32 nKeywordID,   /* Keyword  ID*/` |
|         - | 1812 | `	SyToken *pLookahed  /* Look-ahead token */` |
|         - | 1813 | `	)` |
|         5 | 1814 | `{` |
|   8451359 | 1815 | `	sxu32 n = 0;` |
|  34195880 | 1816 | `	for(;;){` |
|  68391765 | 1817 | `		if( n >= SX_ARRAYSIZE(aLangConstruct) ){` |
|    541299 | 1818 | `			break;` |
|         - | 1819 | `		}` |
|  67850471 | 1820 | `		if( aLangConstruct[n].nID == nKeywordID ){` |
|   7910065 | 1821 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed && (pLookahed->nType & PH7_TK_OP)){` |
...
|         - | 1826 | `				}` |
|       ! 0 | 1827 | `			}` |
|   7910060 | 1828 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed` |
...
|         - | 1835 | `			*/` |
|   7910063 | 1836 | `			return aLangConstruct[n].xConstruct;` |
|         - | 1837 | `		}` |
|  59940411 | 1838 | `		n++;` |
|         5 | 1839 | `	}` |
...
|         - | 1890 | ` */` |
|  18128386 | 1891 | `PH7_PRIVATE void GenStateSetPendingDoc(ph7_gen_state *pGen)` |
|         5 | 1892 | `{` |
|  18128391 | 1893 | `	SyToken *pBase = (SyToken *)SySetBasePtr(pGen->pTokenSet);` |
|  18128391 | 1894 | `	ph7_trivia *aT = (ph7_trivia *)SySetBasePtr(&pGen->aTrivia);` |
|  18128391 | 1895 | `	sxu32 nT = SySetUsed(&pGen->aTrivia);` |
|         - | 1896 | `	sxu32 nIdx, n;` |
|  18128386 | 1897 | `	if( nT < 1 \|\| pGen->pTokenSet == 0` |
...
|   1226717 | 2143 | `}` |
|  13295176 | 2144 | `PH7_PRIVATE sxi32 GenStateCompileChunk(` |
...
|         - | 2150 | `	sxi32 rc;` |
|  13295181 | 2151 | `	rc = SXRET_OK; /* Prevent compiler warning */` |
|   7735486 | 2152 | `	for(;;){` |
|  14383079 | 2153 | `		int bStmtIsDeclare = 0;` |
|  14383079 | 2154 | `		if( pGen->pIn >= pGen->pEnd ){` |
|         - | 2155 | `			/* No more input to process */` |
|     91329 | 2156 | `			break;` |
|         - | 2157 | `		}` |
|         - | 2158 | `		/* Bind a directly-preceding docblock to this statement */` |
|  14291755 | 2159 | `		GenStateSetPendingDoc(&(*pGen));` |
|  14291755 | 2160 | `		if( SySetUsed(&pGen->aPendingAttrs) > 0 ){` |
...
|  14291755 | 2192 | `		if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|   8494065 | 2193 | `			sxu32 nPeek = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   8494065 | 2194 | `			if( nPeek == PH7_TKWRD_DECLARE ){` |
|        49 | 2195 | `				bStmtIsDeclare = 1;` |
|        22 | 2196 | `			}` |
|   4247030 | 2197 | `		}` |
|  14291755 | 2198 | `		if( !bStmtIsDeclare && pGen->pCurrent == &pGen->sGlobal ){` |
...
|   1087889 | 2201 | `			pGen->bStrictTypesLocked = 1;` |
|    543942 | 2202 | `		}` |
|  14291755 | 2203 | `		if( pGen->pIn->nType & PH7_TK_OCB /* '{' */ ){` |
|         - | 2204 | `			/* Compile block */` |
...
|         - | 2208 | `			}` |
|      1963 | 2209 | `		}else{` |
|  14287839 | 2210 | `			xCons = 0;` |
|  14287839 | 2211 | `			if( GenStateStartsModifiedClass(pGen->pIn,pGen->pEnd) ){` |
...
|  14266473 | 2216 | `			}else if( GenStateStartsEnumDecl(pGen->pIn,pGen->pEnd) ){` |
...
|  14243151 | 2220 | `			}else if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|   8451359 | 2221 | `				sxu32 nKeyword = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|         - | 2222 | `				/* Try to extract a language construct handler */` |
|   8451359 | 2223 | `				xCons = GenStateGetStatementHandler(nKeyword,(&pGen->pIn[1] < pGen->pEnd) ? &pGen->pIn[1] : 0);` |
|   8451359 | 2224 | `				if( xCons == 0 && GenStateisLangConstruct(nKeyword) == FALSE ){` |
...
|         4 | 2235 | `				}` |
|  10015518 | 2236 | `			}else if( (pGen->pIn->nType & PH7_TK_ID) && (&pGen->pIn[1] < pGen->pEnd)` |
|    427591 | 2237 | `				&& (pGen->pIn[1].nType & PH7_TK_COLON /*':'*/) ){` |
|         - | 2238 | `				/* Label found [i.e: Out: ],point to the routine responsible of compiling it */` |
|       117 | 2239 | `				xCons = PH7_CompileLabel;` |
|        56 | 2240 | `			}` |
|  14287839 | 2241 | `			if( xCons == 0 ){` |
|         - | 2242 | `				/* Assume an expression an try to compile it */` |
|   5848351 | 2243 | `				rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   5848351 | 2244 | `				if(  rc != SXERR_EMPTY ){` |
|         - | 2245 | `					/* Pop l-value */` |
|   5848201 | 2246 | `					PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|   2924098 | 2247 | `				}` |
|   2924178 | 2248 | `			}else{` |
|         - | 2249 | `				/* Go compile the sucker */` |
|   8439493 | 2250 | `				rc = xCons(&(*pGen));` |
|         - | 2251 | `			}` |
|  14287839 | 2252 | `			if( rc == SXERR_ABORT ){` |
|         - | 2253 | `				/* Request to abort compilation */` |
|        34 | 2254 | `				break;` |
|         - | 2255 | `			}` |
|         - | 2256 | `		}` |
|         - | 2257 | `		/* Ignore trailing semi-colons ';' */` |
|  24536199 | 2258 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|  10244479 | 2259 | `			pGen->pIn++;` |
|         5 | 2260 | `		}` |
|  14291725 | 2261 | `		if( iFlags & PH7_COMPILE_SINGLE_STMT ){` |
...
|         - | 2277 | ` */` |
|     91356 | 2278 | `static sxi32 PH7_CompilePHP(` |
...
|         - | 2282 | `	)` |
|         5 | 2283 | `{` |
|     91361 | 2284 | `	SyToken *pScript = pGen->pRawIn; /* Script to compile */` |
|         - | 2285 | `	sxi32 rc;` |
|         - | 2286 | `	/* Reset the token set (and its trivia sidecar) */` |
|     91361 | 2287 | `	SySetReset(&(*pTokenSet));` |
|     91361 | 2288 | `	SySetReset(&pGen->aTrivia);` |
|         - | 2289 | `	/* Mark as the default token set */` |
|     91361 | 2290 | `	pGen->pTokenSet = &(*pTokenSet);` |
|         - | 2291 | `	/* Advance the stream cursor */` |
|     91361 | 2292 | `	pGen->pRawIn++;` |
|         - | 2293 | `	/* Tokenize the PHP chunk first */` |
|     91361 | 2294 | `	PH7_TokenizePHP(SyStringData(&pScript->sData),SyStringLength(&pScript->sData),pScript->nLine,&(*pTokenSet),&pGen->aTrivia);` |
|         - | 2295 | `	/* Point to the head and tail of the token stream. */` |
|     91361 | 2296 | `	pGen->pIn  = (SyToken *)SySetBasePtr(pTokenSet);` |
|     91361 | 2297 | `	pGen->pEnd = &pGen->pIn[SySetUsed(pTokenSet)];` |
|     91361 | 2298 | `	if( is_expr ){` |
...
|         - | 2307 | `	}` |
|     91361 | 2308 | `	if( pGen->pIn < pGen->pEnd && ( pGen->pIn->nType & PH7_TK_EQUAL ) ){` |
...
|     91359 | 2333 | `	rc = GenStateCompileChunk(pGen,0);` |
|         - | 2334 | `	/* Fix exceptions jumps */` |
|     91359 | 2335 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|         - | 2336 | `	/* Fix gotos now, the jump destination is resolved */` |
|     91359 | 2337 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),0) ){` |
|         3 | 2338 | `		rc = SXERR_ABORT;` |
|         1 | 2339 | `	}` |
|         - | 2340 | `	/* Reset container */` |
|     91359 | 2341 | `	SySetReset(&pGen->aGoto);` |
|     91359 | 2342 | `	SySetReset(&pGen->aLabel);` |
|     91359 | 2343 | `	SySetReset(&pGen->aNullsafeJmp);` |
|         - | 2344 | `	/* Compilation result */` |
|     91359 | 2345 | `	return rc;` |
|     45683 | 2346 | `}` |
|         - | 2347 | `/*` |
...
|         - | 2351 | ` */` |
|     94500 | 2352 | `PH7_PRIVATE sxi32 PH7_CompileScript(` |
...
|         - | 2367 | `	sxi32 rc;` |
|     94505 | 2368 | `	sxu32 nBaseLine = 1;` |
|     94505 | 2369 | `	if( pScript->nByte < 1 ){` |
...
|     94505 | 2376 | `	if( pScript->nByte >= 2 && pScript->zString[0]=='#' && pScript->zString[1]=='!' ){` |
...
|     94505 | 2390 | `	pCodeGen = &pVm->sCodeGen;` |
...
|     94505 | 2397 | `	pSavedIn = pCodeGen->pIn;` |
|     94505 | 2398 | `	pSavedEnd = pCodeGen->pEnd;` |
|     94505 | 2399 | `	bSavedStrict = pCodeGen->bStrictTypes;` |
|     94505 | 2400 | `	bSavedStrictLocked = pCodeGen->bStrictTypesLocked;` |
|     94505 | 2401 | `	pCodeGen->bStrictTypes = 0;` |
|     94505 | 2402 | `	pCodeGen->bStrictTypesLocked = 0;` |
|         - | 2403 | `	/* Initialize the tokens containers */` |
|     94505 | 2404 | `	SySetInit(&aRawToken,&pVm->sAllocator,sizeof(SyToken));` |
|     94505 | 2405 | `	SySetInit(&aPhpToken,&pVm->sAllocator,sizeof(SyToken));` |
|     94505 | 2406 | `	SySetAlloc(&aPhpToken,0xc0);` |
|     94505 | 2407 | `	is_expr = 0;` |
|     94505 | 2408 | `	if( iFlags & PH7_PHP_ONLY ){` |
|         - | 2409 | `		SyToken sTmp;` |
|         - | 2410 | `		/* PHP only: -*/` |
...
|     12983 | 2422 | `		SySetAlloc(&aRawToken,32);` |
|     12983 | 2423 | `		PH7_TokenizeRawText(pScript->zString,pScript->nByte,&aRawToken,nBaseLine);` |
|         - | 2424 | `	}` |
|         - | 2425 | `	/* Process high-level tokens */` |
|     94505 | 2426 | `	pCodeGen->pRawIn = (SyToken *)SySetBasePtr(&aRawToken);` |
|     94505 | 2427 | `	pCodeGen->pRawEnd = &pCodeGen->pRawIn[SySetUsed(&aRawToken)];` |
|     94505 | 2428 | `	rc = PH7_OK;` |
|     94505 | 2429 | `	if( is_expr ){` |
|         - | 2430 | `		/* Compile the expression */` |
|       ! 0 | 2431 | `		rc = PH7_CompilePHP(pCodeGen,&aPhpToken,TRUE);` |
|       ! 0 | 2432 | `		goto cleanup;` |
|         - | 2433 | `	}` |
|     94505 | 2434 | `	nObjIdx = 0;` |
...
|     94505 | 2438 | `	PH7_VmEmitInstr(pVm,PH7_OP_NSSWITCH,0,0,0,0);` |
|         - | 2439 | `	/* Start the compilation process */` |
|     53744 | 2440 | `	for(;;){` |
|    198817 | 2441 | `		if( pCodeGen->pRawIn >= pCodeGen->pRawEnd ){` |
|     94473 | 2442 | `			break; /* No more tokens to process */` |
|         - | 2443 | `		}` |
|    104349 | 2444 | `		if( pCodeGen->pRawIn->nType & PH7_TOKEN_PHP ){` |
|         - | 2445 | `			/* Compile the PHP chunk */` |
|     91361 | 2446 | `			rc = PH7_CompilePHP(pCodeGen,&aPhpToken,FALSE);` |
|     91361 | 2447 | `			if( rc == SXERR_ABORT ){` |
|        36 | 2448 | `				break;` |
|         - | 2449 | `			}` |
|     91329 | 2450 | `			continue;` |
|         - | 2451 | `		}` |
|         - | 2452 | `		/* Raw chunk: [i.e: HTML, XML, etc.] */` |
|     12993 | 2453 | `		nRawObj = 0;` |
|     25981 | 2454 | `		while( (pCodeGen->pRawIn < pCodeGen->pRawEnd) && (pCodeGen->pRawIn->nType != PH7_TOKEN_PHP) ){` |
|         - | 2455 | `			/* Consume the raw chunk without any processing */` |
|     12993 | 2456 | `			pRawObj = PH7_ReserveConstObj(&(*pVm),&nObjIdx);` |
|     12993 | 2457 | `			if( pRawObj == 0 ){` |
|       ! 0 | 2458 | `				rc = SXERR_MEM;` |
|       ! 0 | 2459 | `				break;` |
|         - | 2460 | `			}` |
|         - | 2461 | `			/* Mark as constant and emit the load constant instruction */` |
|     12993 | 2462 | `			PH7_MemObjInitFromString(pVm,pRawObj,&pCodeGen->pRawIn->sData);` |
|     12993 | 2463 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_LOADC,0,nObjIdx,0,0);` |
|     12993 | 2464 | `			++nRawObj;` |
|     12993 | 2465 | `			pCodeGen->pRawIn++; /* Next chunk */` |
|         5 | 2466 | `		}` |
|     12993 | 2467 | `		if( nRawObj > 0 ){` |
|         - | 2468 | `			/* Emit the consume instruction */` |
|     12993 | 2469 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_CONSUME,nRawObj,0,0,0);` |
|      6494 | 2470 | `		}` |
|     47255 | 2471 | `	}` |
|     47250 | 2472 | `cleanup:` |
|         - | 2473 | `	/* Drop the cursor into the token set BEFORE the set is freed (see above). */` |
|     94505 | 2474 | `	pCodeGen->pIn = pSavedIn;` |
|     94505 | 2475 | `	pCodeGen->pEnd = pSavedEnd;` |
|     94505 | 2476 | `	SySetRelease(&aRawToken);` |
|     94505 | 2477 | `	SySetRelease(&aPhpToken);` |
|         - | 2478 | `	/* Restore outer file's strict_types scope */` |
|     94505 | 2479 | `	pCodeGen->bStrictTypes = bSavedStrict;` |
|     94505 | 2480 | `	pCodeGen->bStrictTypesLocked = bSavedStrictLocked;` |
|     94505 | 2481 | `	return rc;` |
|     47255 | 2482 | `}` |
|         - | 2483 | `/*` |
...
|         - | 2525 | ` */` |
|     97904 | 2526 | `PH7_PRIVATE sxi32 PH7_ResetCodeGenerator(` |
|         - | 2527 | `	ph7_vm *pVm,       /* Target VM */` |
|         - | 2528 | `	ProcConsumer xErr, /* Error log consumer callabck  */` |
|         - | 2529 | `	void *pErrData     /* Last argument to xErr() */` |
|         - | 2530 | `	)` |
|         5 | 2531 | `{` |
|     97909 | 2532 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|         - | 2533 | `	GenBlock *pBlock,*pParent;` |
|         - | 2534 | `	/* Reset state */` |
|     97909 | 2535 | `	SySetReset(&pGen->aLabel);` |
|     97909 | 2536 | `	SySetReset(&pGen->aGoto);` |
|     97909 | 2537 | `	SySetReset(&pGen->aNullsafeJmp);` |
|     97909 | 2538 | `	SySetReset(&pGen->aTrivia);` |
|     97909 | 2539 | `	SySetReset(&pGen->aPendingAttrs);` |
|     97909 | 2540 | `	SyStringInitFromBuf(&pGen->sPendingDoc,0,0);` |
|     97909 | 2541 | `	SyBlobRelease(&pGen->sErrBuf);` |
|     97909 | 2542 | `	SyBlobRelease(&pGen->sWorker);` |
|     97909 | 2543 | `	SyBlobRelease(&pGen->sNamespace);` |
|     97909 | 2544 | `	SyBlobInit(&pGen->sNamespace,&pVm->sAllocator);` |
|     97909 | 2545 | `	SyHashRelease(&pGen->hUseImports);` |
|     97909 | 2546 | `	SyHashInit(&pGen->hUseImports,&pVm->sAllocator,0,0);` |
|     97909 | 2547 | `	SyHashRelease(&pGen->hUseFuncImports);` |
|     97909 | 2548 | `	SyHashInit(&pGen->hUseFuncImports,&pVm->sAllocator,0,0);` |
|     97909 | 2549 | `	SyHashRelease(&pGen->hUseConstImports);` |
|     97909 | 2550 | `	SyHashInit(&pGen->hUseConstImports,&pVm->sAllocator,0,0);` |
...
|     97909 | 2558 | `	pBlock = pGen->pCurrent;` |
|     97909 | 2559 | `	while( pBlock->pParent != 0 ){` |
|       ! 0 | 2560 | `		pParent = pBlock->pParent;` |
|       ! 0 | 2561 | `		GenStateFreeBlock(pBlock);` |
|       ! 0 | 2562 | `		pBlock = pParent;` |
|       ! 0 | 2563 | `	}` |
|     97909 | 2564 | `	pGen->xErr = xErr;` |
|     97909 | 2565 | `	pGen->pErrData = pErrData;` |
|     97909 | 2566 | `	pGen->pCurrent = &pGen->sGlobal;` |
|     97909 | 2567 | `	pGen->pRawIn = pGen->pRawEnd = 0;` |
|     97909 | 2568 | `	pGen->pIn = pGen->pEnd = 0;` |
|     97909 | 2569 | `	pGen->nErr = 0;` |
|     97909 | 2570 | `	return SXRET_OK;` |
|         5 | 2571 | `}` |
|         - | 2572 | `/*` |
