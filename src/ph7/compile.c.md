...
|         - |   69 | ` */` |
|  13130710 |   70 | `static void GenStateInitBlock(` |
...
|  13130715 |   79 | `	pBlock->nFirstInstr = nFirstInstr;` |
|  13130715 |   80 | `	pBlock->pUserData   = pUserData;` |
|  13130715 |   81 | `	pBlock->pGen        = pGen;` |
|  13130715 |   82 | `	pBlock->iFlags      = iType;` |
|  13130715 |   83 | `	pBlock->pParent     = 0;` |
|  13130715 |   84 | `	SySetInit(&pBlock->aJumpFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  13130715 |   85 | `	SySetInit(&pBlock->aPostContFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  13130715 |   86 | `}` |
|         - |   87 | `/*` |
...
|         - |   92 | ` */` |
|  13126816 |   93 | `PH7_PRIVATE sxi32 GenStateEnterBlock(` |
...
|  13126821 |  103 | `	pBlock = (GenBlock *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(GenBlock));` |
|  13126821 |  104 | `	if( pBlock == 0 ){` |
...
|  13126821 |  113 | `	SyZero(pBlock,sizeof(GenBlock));` |
|  13126821 |  114 | `	GenStateInitBlock(&(*pGen),pBlock,iType,nFirstInstr,pUserData);` |
|         - |  115 | `	/* Link to the parent block */` |
|  13126821 |  116 | `	pBlock->pParent = pGen->pCurrent;` |
...
|  13126821 |  119 | `	if( iType & (GEN_BLOCK_LOOP\|GEN_BLOCK_SWITCH) ){` |
|    541869 |  120 | `		sxu32 nParent = pGen->nCurLoopId;` |
|    541869 |  121 | `		pGen->nLoopId++;` |
|    541869 |  122 | `		SySetPut(&pGen->aLoopParent,(const void *)&nParent);` |
|    541869 |  123 | `		pBlock->nLoopId = pGen->nLoopId;` |
|    541869 |  124 | `		pBlock->nOuterLoopId = nParent;` |
|    541869 |  125 | `		pGen->nCurLoopId = pGen->nLoopId;` |
|    270932 |  126 | `	}` |
|         - |  127 | `	/* Mark as the current block */` |
|  13126821 |  128 | `	pGen->pCurrent = pBlock;` |
|  13126821 |  129 | `	if( ppBlock ){` |
|         - |  130 | `		/* Write a pointer to the new instance */` |
|   6313093 |  131 | `		*ppBlock = pBlock;` |
|   3156544 |  132 | `	}` |
|  13126821 |  133 | `	return SXRET_OK;` |
|   6563413 |  134 | `}` |
|         - |  135 | `/*` |
|         - |  136 | ` * Release block fields without freeing the whole instance.` |
|         - |  137 | ` */` |
|  13126808 |  138 | `static void GenStateReleaseBlock(GenBlock *pBlock)` |
|         5 |  139 | `{` |
|  13126813 |  140 | `	SySetRelease(&pBlock->aPostContFix);` |
|  13126813 |  141 | `	SySetRelease(&pBlock->aJumpFix);` |
|  13126813 |  142 | `}` |
|         - |  143 | `/*` |
|         - |  144 | ` * Release a block.` |
|         - |  145 | ` */` |
|  13126804 |  146 | `static void GenStateFreeBlock(GenBlock *pBlock)` |
|         5 |  147 | `{` |
|  13126809 |  148 | `	ph7_gen_state *pGen = pBlock->pGen;` |
|  13126809 |  149 | `	GenStateReleaseBlock(&(*pBlock));` |
|         - |  150 | `	/* Free the instance */` |
|  13126809 |  151 | `	SyMemBackendPoolFree(&pGen->pVm->sAllocator,pBlock);` |
|  13126809 |  152 | `}` |
|         - |  153 | `/*` |
|         - |  154 | ` * POP and release a block from the stack of compiled blocks.` |
|         - |  155 | ` */` |
|  13126804 |  156 | `PH7_PRIVATE sxi32 GenStateLeaveBlock(ph7_gen_state *pGen,GenBlock **ppBlock)` |
|         5 |  157 | `{` |
|  13126809 |  158 | `	GenBlock *pBlock = pGen->pCurrent;` |
|  13126809 |  159 | `	if( pBlock == 0 ){` |
|         - |  160 | `		/* No more block to pop */` |
|       ! 0 |  161 | `		return SXERR_EMPTY;` |
|         - |  162 | `	}` |
|  13126809 |  163 | `	if( pBlock->iFlags & (GEN_BLOCK_LOOP\|GEN_BLOCK_SWITCH) ){` |
|    541861 |  164 | `		pGen->nCurLoopId = pBlock->nOuterLoopId;` |
|    270928 |  165 | `	}` |
|         - |  166 | `	/* Point to the upper block */` |
|  13126809 |  167 | `	pGen->pCurrent = pBlock->pParent;` |
|  13126809 |  168 | `	if( ppBlock ){` |
|         - |  169 | `		/* Write a pointer to the popped block */` |
|       ! 0 |  170 | `		*ppBlock = pBlock;` |
|       ! 0 |  171 | `	}else{` |
|         - |  172 | `		/* Safely release the block */` |
|  13126809 |  173 | `		GenStateFreeBlock(&(*pBlock));` |
|         - |  174 | `	}` |
|  13126809 |  175 | `	return SXRET_OK;` |
|   6563407 |  176 | `}` |
|         - |  177 | `/*` |
...
|         - |  194 | ` */` |
|   1046082 |  195 | `PH7_PRIVATE int GenStateUnconditionalTopLevel(ph7_gen_state *pGen)` |
|         5 |  196 | `{` |
|   1046087 |  197 | `	GenBlock *pBlock = pGen->pCurrent;` |
|   1050081 |  198 | `	while( pBlock ){` |
|   1050081 |  199 | `		if( pBlock->iFlags & (GEN_BLOCK_COND\|GEN_BLOCK_LOOP\|GEN_BLOCK_FUNC\|GEN_BLOCK_SWITCH\|GEN_BLOCK_EXCEPTION) ){` |
|        77 |  200 | `			return 0; /* conditional / nested */` |
|         - |  201 | `		}` |
|   1050009 |  202 | `		if( pBlock->iFlags & GEN_BLOCK_GLOBAL ){` |
|   1046015 |  203 | `			return 1; /* reached the global block with no conditional ancestor */` |
|         - |  204 | `		}` |
...
|         - |  279 | ` */` |
|   9125748 |  280 | `PH7_PRIVATE sxu32 GenStateFixJumps(GenBlock *pBlock,sxi32 nJumpType,sxu32 nJumpDest)` |
|         5 |  281 | `{` |
|         - |  282 | `	JumpFixup *aFix;` |
|         - |  283 | `	VmInstr *pInstr;` |
|         - |  284 | `	sxu32 nFixed;` |
...
|   9125753 |  287 | `	aFix = (JumpFixup *)SySetBasePtr(&pBlock->aJumpFix);` |
|         - |  288 | `	/* Fix the desired jumps */` |
|  19101649 |  289 | `	for( nFixed = n = 0 ; n < SySetUsed(&pBlock->aJumpFix) ; ++n ){` |
|   9975901 |  290 | `		if( aFix[n].nJumpType < 0 ){` |
|         - |  291 | `			/* Already fixed */` |
|   3725027 |  292 | `			continue;` |
|         - |  293 | `		}` |
...
|         - |  316 | ` */` |
|   3378658 |  317 | `PH7_PRIVATE sxi32 GenStateFixGoto(ph7_gen_state *pGen,sxu32 nOfft)` |
|         5 |  318 | `{` |
...
|   3378663 |  325 | `	aJumps = (JumpFixup *)SySetBasePtr(&pGen->aGoto);` |
|         - |  326 | `	/* Fix */` |
|   3378809 |  327 | `	for( n = nOfft ; n < SySetUsed(&pGen->aGoto) ; ++n ){` |
...
|   3378661 |  378 | `	return SXRET_OK;` |
|   1689334 |  379 | `}` |
|         - |  380 | `/*` |
|         - |  381 | ` * Check if a given token value is installed in the literal table.` |
|         - |  382 | ` */` |
|  16924496 |  383 | `PH7_PRIVATE sxi32 GenStateFindLiteral(ph7_gen_state *pGen,const SyString *pValue,sxu32 *pIdx)` |
|         5 |  384 | `{` |
|         - |  385 | `	SyHashEntry *pEntry;` |
|  16924501 |  386 | `	pEntry = SyHashGet(&pGen->hLiteral,(const void *)pValue->zString,pValue->nByte);` |
|  16924501 |  387 | `	if( pEntry == 0 ){` |
|   4511981 |  388 | `		return SXERR_NOTFOUND;` |
|         - |  389 | `	}` |
|  12412525 |  390 | `	*pIdx = (sxu32)SX_PTR_TO_INT(pEntry->pUserData);` |
|  12412525 |  391 | `	return SXRET_OK;` |
|   8462253 |  392 | `}` |
|         - |  393 | `/*` |
...
|         - |  402 | ` */` |
|   4511976 |  403 | `PH7_PRIVATE sxi32 GenStateInstallLiteral(ph7_gen_state *pGen,ph7_value *pObj,sxu32 nIdx)` |
|         5 |  404 | `{` |
|   4511981 |  405 | `	if( SyBlobLength(&pObj->sBlob) > 0 ){` |
|   4511981 |  406 | `		SyHashInsert(&pGen->hLiteral,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob),SX_INT_TO_PTR(nIdx));` |
|   2255988 |  407 | `	}` |
|   4511981 |  408 | `	return SXRET_OK;` |
|         5 |  409 | `}` |
|         - |  410 | `/*` |
|         - |  411 | ` * Reserve a room for a numeric constant [i.e: 64-bit integer or real number]` |
|         - |  412 | ` * in the constant table.` |
|         - |  413 | ` */` |
|   3826270 |  414 | `PH7_PRIVATE ph7_value * GenStateInstallNumLiteral(ph7_gen_state *pGen,sxu32 *pIdx)` |
|         5 |  415 | `{` |
|         - |  416 | `	ph7_value *pObj;` |
|   3826275 |  417 | `	sxu32 nIdx = 0; /* cc warning */` |
|         - |  418 | `	/* Reserve a new constant */` |
|   3826275 |  419 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   3826275 |  420 | `	if( pObj == 0 ){` |
|       ! 0 |  421 | `		PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|       ! 0 |  422 | `		return 0;` |
|         - |  423 | `	}` |
|   3826275 |  424 | `	*pIdx = nIdx;` |
|         - |  425 | `	/* TODO(chems): Create a numeric table (64bit int keys) same as` |
|         - |  426 | `	 * the constant string iterals table [optimization purposes].` |
|         - |  427 | `	 */` |
|   3826275 |  428 | `	return pObj;` |
|   1913140 |  429 | `}` |
|         - |  430 | `/*` |
...
|         - |  443 | ` */` |
|   7962238 |  444 | `PH7_PRIVATE void *GenStateAttachStrictFlag(ph7_gen_state *pGen, void *p3)` |
|         5 |  445 | `{` |
|         - |  446 | `	VmCallArgMap *pMap;` |
|   7962243 |  447 | `	if( !pGen->bStrictTypes ) return p3;` |
|        58 |  448 | `	if( p3 == 0 ){` |
...
|         - |  507 | ` */` |
|  54091568 |  508 | `static void GenStatePatchNullsafeJumps(ph7_gen_state *pGen, sxu32 nBaseline)` |
|         5 |  509 | `{` |
|  54091573 |  510 | `	sxu32 nCur = SySetUsed(&pGen->aNullsafeJmp);` |
|         - |  511 | `	sxu32 nTarget;` |
|         - |  512 | `	sxu32 *aIdx;` |
|         - |  513 | `	sxu32 i;` |
|  54091573 |  514 | `	if( nCur <= nBaseline ){` |
|  54091477 |  515 | `		return;` |
|         - |  516 | `	}` |
...
|         - |  544 | ` */` |
|   7071638 |  545 | `static sxu32 GenStateByRefBuiltinMask(SyString *pName)` |
|         5 |  546 | `{` |
...
|         - |  562 | `	};` |
|         - |  563 | `	sxu32 i;` |
|   7071643 |  564 | `	if( pName == 0 \|\| pName->zString == 0 \|\| pName->nByte == 0 ){` |
|   1810433 |  565 | `		return 0;` |
|         - |  566 | `	}` |
|  57389743 |  567 | `	for( i = 0 ; i < SX_ARRAYSIZE(aByRef) ; ++i ){` |
|  52187044 |  568 | `		if( pName->nByte == aByRef[i].nByte` |
|  27612329 |  569 | `		 && SyStrnicmp(pName->zString, aByRef[i].zName, pName->nByte) == 0 ){` |
|     58521 |  570 | `			return aByRef[i].mask;` |
|         - |  571 | `		}` |
|  26064269 |  572 | `	}` |
|   5202699 |  573 | `	return 0;` |
|   3535824 |  574 | `}` |
|         - |  575 | `/*` |
...
|         - |  584 | ` */` |
|   7071638 |  585 | `static void GenStateCallBuiltinName(ph7_expr_node *pLeft, SyString *pOut)` |
|         5 |  586 | `{` |
|         - |  587 | `	SyToken *p, *pEnd;` |
|   7071643 |  588 | `	pOut->zString = 0;` |
|   7071643 |  589 | `	pOut->nByte = 0;` |
|   7071643 |  590 | `	if( pLeft == 0 \|\| pLeft->pStart == 0 \|\| pLeft->pEnd == 0 ){` |
|       ! 0 |  591 | `		return;` |
|         - |  592 | `	}` |
|   7071643 |  593 | `	p = pLeft->pStart;` |
|   7071643 |  594 | `	pEnd = pLeft->pEnd;` |
|         - |  595 | `	/* Optional single leading namespace separator (absolute path). */` |
|   7071643 |  596 | `	if( p < pEnd && (p->nType & PH7_TK_NSSEP) ){` |
|      3933 |  597 | `		p++;` |
|      1964 |  598 | `	}` |
|   7071643 |  599 | `	if( p >= pEnd \|\| (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|   1810387 |  600 | `		return;` |
|         - |  601 | `	}` |
|         - |  602 | `	/* Must be a single component: nothing follows the name token. */` |
|   5261261 |  603 | `	if( p + 1 != pEnd ){` |
|        51 |  604 | `		return;` |
|         - |  605 | `	}` |
|   5261215 |  606 | `	*pOut = p->sData;` |
|   3535824 |  607 | `}` |
|         - |  608 | `/*` |
...
|         - |  613 | ` * error message.` |
|         - |  614 | ` */` |
|  76268690 |  615 | `static sxi32 GenStateEmitExprCode(` |
...
|         - |  621 | `	VmInstr *pInstr;` |
|         - |  622 | `	sxu32 nJmpIdx;` |
|  76268695 |  623 | `	sxi32 iP1 = 0;` |
|  76268695 |  624 | `	sxu32 iP2 = 0;` |
|  76268695 |  625 | `	void *p3  = 0;` |
|         - |  626 | `	sxi32 iVmOp;` |
|         - |  627 | `	sxi32 rc;` |
|  76268695 |  628 | `	int bIsChainOp = 0; /* Set below once we know pNode->pOp */` |
|  76268695 |  629 | ``	int bFcc = 0;       /* First-class callable `f(...)`: emit OP_LOAD_FCC, not OP_CALL */`` |
|  76268695 |  630 | `	sxu32 nRhsNsBase = 0;` |
|  76268695 |  631 | `	if( pNode->xCode ){` |
|         - |  632 | `		SyToken *pTmpIn,*pTmpEnd;` |
|         - |  633 | `		/* Compile node */` |
|  46032187 |  634 | `		SWAP_DELIMITER(pGen,pNode->pStart,pNode->pEnd);` |
|  46032187 |  635 | `		rc = pNode->xCode(&(*pGen),iFlags);` |
|  46032187 |  636 | `		RE_SWAP_DELIMITER(pGen);` |
|  46032187 |  637 | `		return rc;` |
|         - |  638 | `	}` |
|  30236513 |  639 | `	if( pNode->pOp == 0 ){` |
...
|         - |  643 | `	}` |
|  30236513 |  644 | `	iVmOp = pNode->pOp->iVmOp;` |
|  30236513 |  645 | `	if( iVmOp == PH7_OP_CVT_NULL ){` |
...
|         - |  653 | `		}` |
|         1 |  654 | `	}` |
|  30236513 |  655 | `	if( pNode->pOp->iOp == EXPR_OP_NULLC_ASSIGN ){` |
|        93 |  656 | `		sxu32 nJmp = 0;` |
|         - |  657 | `		sxu32 nNcNsBase;` |
...
|         - |  704 | `	}` |
|  30236423 |  705 | `	if( pNode->pOp->iOp == EXPR_OP_QUESTY ){` |
|         - |  706 | `		sxu32 nJz,nJmp;` |
...
|         - |  767 | `	}` |
|  29731313 |  768 | `	if( pNode->pOp->iOp == EXPR_OP_PIPE ){` |
...
|         - |  800 | `	}` |
|  29731287 |  801 | `	bIsChainOp = GEN_IS_CHAIN_OP(pNode->pOp->iOp);` |
|         - |  802 | `	/* Generate code for the left tree */` |
|  29731287 |  803 | `	if( pNode->pLeft ){` |
|  29677015 |  804 | `		sxu32 nLhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  29677015 |  805 | `		if( iVmOp == PH7_OP_CALL ){` |
|         - |  806 | `			ph7_expr_node **apNode;` |
|   7075873 |  807 | `			int hasSpread = 0;` |
|   7075873 |  808 | `			int hasNamed = 0;` |
|   7075873 |  809 | `			int bAnySpread = 0;` |
|   7075873 |  810 | `			sxu32 byRefMask = 0;` |
|         - |  811 | `			sxi32 nArgs;` |
|         - |  812 | `			sxi32 n;` |
|         - |  813 | `			/* Recurse and generate bytecodes for function arguments */` |
|   7075873 |  814 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|   7075873 |  815 | `			nArgs = (sxi32)SySetUsed(&pNode->aNodeArgs);` |
...
|   7075873 |  819 | `			if( nArgs == 1 && apNode[0] && (apNode[0]->iFlags & EXPR_NODE_FCC) ){` |
|        81 |  820 | `				bFcc = 1;` |
|        81 |  821 | `				nArgs = 0;` |
|        40 |  822 | `			}` |
...
|         - |  825 | `			{` |
|   7075873 |  826 | `				int seenNamed = 0;` |
|   7075873 |  827 | `				int seenSpread = 0;` |
|  15110879 |  828 | `				for( n = 0; n < nArgs; ++n ){` |
|   8035013 |  829 | `					if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
...
|         5 |  836 | `						}` |
|   8032970 |  837 | `					}else if( apNode[n]->iFlags & EXPR_NODE_NAMED_ARG ){` |
|       300 |  838 | `						seenNamed = 1;` |
|       300 |  839 | `						hasNamed = 1;` |
|   8030779 |  840 | `					}else if( seenNamed ){` |
...
|   8030629 |  844 | `					}else if( seenSpread ){` |
...
|         - |  850 | `			}` |
|         - |  851 | `			/* Read-only load */` |
|   7075871 |  852 | `			iFlags \|= EXPR_FLAG_RDONLY_LOAD;` |
...
|   7075871 |  857 | `			if( pNode->pLeft && pNode->pLeft->pStart ){` |
|   7075871 |  858 | `				SyString *pCallName = &pNode->pLeft->pStart->sData;` |
|   7075866 |  859 | `				if( pCallName->nByte == 5` |
|   3932274 |  860 | `				 && SyStrnicmp(pCallName->zString,"isset",5) == 0 ){` |
|    327169 |  861 | `					iFlags \|= EXPR_FLAG_LOAD_IDX_ISSET;` |
|   6912289 |  862 | `				}else if( pCallName->nByte == 5` |
|   3605110 |  863 | `				 && SyStrnicmp(pCallName->zString,"empty",5) == 0 ){` |
...
|   7075871 |  872 | `				if( !bAnySpread && !hasNamed ){` |
|         - |  873 | `					SyString sBuiltin;` |
|   7071643 |  874 | `					GenStateCallBuiltinName(pNode->pLeft, &sBuiltin);` |
|   7071643 |  875 | `					byRefMask = GenStateByRefBuiltinMask(&sBuiltin);` |
|   3535819 |  876 | `				}` |
|   3537933 |  877 | `			}` |
|  15110875 |  878 | `			for( n = 0 ; n < nArgs ; ++n ){` |
|   8035009 |  879 | `				sxu32 nArgNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|   8035009 |  880 | `				sxi32 iArgFlags = iFlags & ~(EXPR_FLAG_LOAD_IDX_STORE\|EXPR_FLAG_MEMBER_WRITE);` |
...
|   8035009 |  887 | `				if( n < 31 && (byRefMask & (1u<<n)) ){` |
...
|   8035004 |  901 | `				if( (iFlags & (EXPR_FLAG_LOAD_IDX_ISSET\|EXPR_FLAG_LOAD_IDX_EMPTY\|EXPR_FLAG_LOAD_IDX_UNSET)) == 0` |
|   7871354 |  902 | `				 && apNode[n]->pOp == 0 && apNode[n]->xCode == PH7_CompileVariable` |
|   4125235 |  903 | `				 && (apNode[n]->iFlags & (EXPR_NODE_NAMED_ARG\|EXPR_NODE_SPREAD)) == 0 ){` |
|   3371363 |  904 | `					iArgFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|   1685679 |  905 | `				}` |
|   8035009 |  906 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iArgFlags);` |
|   8035009 |  907 | `				if( rc != SXRET_OK ){` |
|       ! 0 |  908 | `					return rc;` |
|         - |  909 | `				}` |
|         - |  910 | `				/* Each argument is an independent nullsafe scope. */` |
|   8035009 |  911 | `				GenStatePatchNullsafeJumps(pGen, nArgNsBase);` |
|   8035009 |  912 | `				if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
...
|   7075871 |  955 | `			iFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|   3537933 |  956 | `		}` |
|         - |  957 | `		{` |
...
|  29677013 |  966 | `			sxi32 iLeftFlags = iFlags;` |
|  29677013 |  967 | `			sxu32 nNullcLhsFirst = PH7_VmInstrLength(pGen->pVm);` |
|  29677013 |  968 | `			int bNullcLhs = 0;` |
|  29677008 |  969 | `			if( pNode->pLeft && pNode->pLeft->pOp` |
|  24096446 |  970 | `				&& (pNode->pLeft->pOp->iOp == EXPR_OP_ARROW` |
|   9257968 |  971 | `					\|\| pNode->pLeft->pOp->iOp == EXPR_OP_NULLSAFE_ARROW` |
|   7969835 |  972 | `					\|\| pNode->pLeft->pOp->iOp == EXPR_OP_DC) ){` |
|   2786937 |  973 | `				iLeftFlags &= ~EXPR_FLAG_LOAD_IDX_UNSET;` |
|   1393466 |  974 | `			}` |
...
|  29677008 |  982 | `			if( pNode->pOp` |
|  41722787 |  983 | `				&& (pNode->pOp->iOp == EXPR_OP_ARROW` |
|  26884330 |  984 | `					\|\| pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW` |
|  24091600 |  985 | `					\|\| pNode->pOp->iOp == EXPR_OP_DC) ){` |
|   6006637 |  986 | `				iLeftFlags &= ~EXPR_FLAG_MEMBER_WRITE;` |
|   3003316 |  987 | `			}` |
...
|  29677008 |  994 | `			if( pNode->pOp` |
|  29677013 |  995 | `				&& (pNode->pOp->iVmOp == PH7_OP_INCR \|\| pNode->pOp->iVmOp == PH7_OP_DECR) ){` |
|    218285 |  996 | `				iLeftFlags \|= EXPR_FLAG_LOAD_IDX_STORE \| EXPR_FLAG_MEMBER_WRITE` |
...
|  29677013 | 1006 | `			if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLC && pNode->pLeft ){` |
...
|     58539 | 1011 | `				iLeftFlags \|= EXPR_FLAG_QUIET_VAR;` |
|     58539 | 1012 | `				bNullcLhs = 1;` |
|     58534 | 1013 | `				if( pNode->pLeft->pOp` |
|     87737 | 1014 | `					&& (pNode->pLeft->pOp->iOp == EXPR_OP_ARROW` |
|     58476 | 1015 | `						\|\| pNode->pLeft->pOp->iOp == EXPR_OP_NULLSAFE_ARROW` |
|     58459 | 1016 | `						\|\| pNode->pLeft->pOp->iOp == EXPR_OP_DC) ){` |
...
|        18 | 1024 | `				}` |
|     29267 | 1025 | `			}` |
|  29677013 | 1026 | `			if( iVmOp == PH7_OP_ERR_CTRL ){` |
...
|     15801 | 1029 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_ERR_CTRL,1,0,0,0);` |
|      7898 | 1030 | `			}` |
|  29677013 | 1031 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pLeft,iLeftFlags\|EXPR_FLAG_RDONLY_LOAD);` |
|  29677013 | 1032 | `			if( rc == SXRET_OK && bNullcLhs ){` |
...
|     58539 | 1041 | `				sxu32 nEnd = PH7_VmInstrLength(pGen->pVm);` |
|         - | 1042 | `				sxu32 nAt;` |
|    327507 | 1043 | `				for( nAt = nNullcLhsFirst ; nAt < nEnd ; ++nAt ){` |
|    268973 | 1044 | `					VmInstr *pFix = PH7_VmGetInstr(pGen->pVm,nAt);` |
|    268973 | 1045 | `					if( pFix && pFix->iOp == PH7_OP_LOAD_IDX && pFix->iP2 == 0 ){` |
|     58441 | 1046 | `						pFix->iP2 = 8;` |
|     29218 | 1047 | `					}` |
|    134489 | 1048 | `				}` |
|     29267 | 1049 | `			}` |
|         - | 1050 | `		}` |
|  29677013 | 1051 | `		if( rc != SXRET_OK ){` |
|        34 | 1052 | `			return rc;` |
|         - | 1053 | `		}` |
|  29676983 | 1054 | `		if( !bIsChainOp ){` |
...
|  13560721 | 1057 | `			GenStatePatchNullsafeJumps(pGen, nLhsNsBase);` |
|   6780358 | 1058 | `		}` |
|  29676983 | 1059 | `		if( iVmOp == PH7_OP_CALL ){` |
|   7075871 | 1060 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|   7075871 | 1061 | `			if( pInstr ){` |
|   7075871 | 1062 | `				if ( pInstr->iOp == PH7_OP_LOADC ){` |
|   5261523 | 1063 | `					sxu32 nOrig = (sxu32)pInstr->iP2;` |
|         - | 1064 | `					sxu32 nQual;` |
|   5261523 | 1065 | `					int bAbsolute = (pInstr->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|         - | 1066 | `					/* Prevent constant expansion but preserve the absolute flag` |
|         - | 1067 | `					 * so the later NEW handler (if any) can see it. */` |
|   5261523 | 1068 | `					pInstr->iP1 &= ~PH7_LOADC_EXPAND;` |
...
|   5261523 | 1076 | `					if( bAbsolute ){` |
|      3933 | 1077 | `						pInstr->iP2 = (sxi32)nOrig;` |
|      1969 | 1078 | `					}else{` |
|   5257595 | 1079 | `						int fromImport = 0;` |
|   5257595 | 1080 | `						nQual = GenStateNsQualifyName(pGen,nOrig,&pGen->hUseFuncImports,&fromImport);` |
|   5257595 | 1081 | `						pInstr->iP2 = (sxi32)nQual;` |
|   5257595 | 1082 | `						if( nQual != nOrig ){` |
...
|        49 | 1103 | `						}` |
|         - | 1104 | `					}` |
|   4445112 | 1105 | `				}else if( (pInstr->iOp == PH7_OP_MEMBER /* $a->b(1,2,3) */` |
|   1804269 | 1106 | `						&& !(pNode->pLeft && (pNode->pLeft->iFlags & EXPR_NODE_PARENS)))` |
|    917260 | 1107 | `					\|\| pInstr->iOp == PH7_OP_NEW ){` |
...
|   1794197 | 1123 | `					if( pInstr->iOp == PH7_OP_MEMBER && pInstr->iP1 == 1 && pInstr->p3 ){` |
...
|    897096 | 1129 | `				}` |
|   3537938 | 1130 | `			}` |
|  26139050 | 1131 | `		}else if( iVmOp == PH7_OP_LOAD_IDX ){` |
|         - | 1132 | `			ph7_expr_node **apNode;` |
|         - | 1133 | `			sxi32 n;` |
|   3033769 | 1134 | `			sxi32 iChildMask = ~(EXPR_FLAG_LOAD_IDX_STORE` |
...
|   3033769 | 1139 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|   5829805 | 1140 | `			for( n = 0 ; n < (sxi32)SySetUsed(&pNode->aNodeArgs) ; ++n ){` |
|   2796041 | 1141 | `				sxu32 nIdxNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|   2796041 | 1142 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iFlags&iChildMask);` |
|   2796041 | 1143 | `				if( rc != SXRET_OK ){` |
|       ! 0 | 1144 | `					return rc;` |
|         - | 1145 | `				}` |
|         - | 1146 | `				/* Each subscript index is an independent nullsafe scope. */` |
|   2796041 | 1147 | `				GenStatePatchNullsafeJumps(pGen, nIdxNsBase);` |
|   1398023 | 1148 | `			}` |
|   3033769 | 1149 | `			if( SySetUsed(&pNode->aNodeArgs) > 0 ){` |
|   2796041 | 1150 | `				iP1 = 1; /* Node have an index associated with it */` |
|   1398018 | 1151 | `			}` |
|   3033769 | 1152 | `			if( iFlags & EXPR_FLAG_LOAD_IDX_ISSET ){` |
|         - | 1153 | `				/* offsetExists for ArrayAccess; peek-only for arrays */` |
|    373725 | 1154 | `				iP2 = 4;` |
|   2846909 | 1155 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_UNSET ){` |
|         - | 1156 | `				/* offsetUnset for ArrayAccess; auto-vivify+load for arrays` |
|         - | 1157 | `				 * so the trailing unset() builtin can drop the slot. */` |
|     23421 | 1158 | `				iP2 = 5;` |
|   2648341 | 1159 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_EMPTY ){` |
...
|        29 | 1163 | `				iP2 = 6;` |
|   2636621 | 1164 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_STORE ){` |
|         - | 1165 | `				/* Create an empty entry when the desired index is not found */` |
|    557189 | 1166 | `				iP2 = 1;` |
|    278597 | 1167 | `			}` |
|  21084235 | 1168 | `		}else if( pNode->pOp->iOp == EXPR_OP_COMMA ){` |
|         - | 1169 | `			/* POP the left node */` |
|         5 | 1170 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|         2 | 1171 | `		}` |
|  14838489 | 1172 | `	}` |
|  29731255 | 1173 | `	rc = SXRET_OK;` |
|  29731255 | 1174 | `	nJmpIdx = 0;` |
...
|  29731255 | 1178 | `	if( iVmOp == PH7_OP_MEMBER && pNode->pOp->iOp == EXPR_OP_DC ){` |
|    467865 | 1179 | `		pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|    467865 | 1180 | `		if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|    467865 | 1181 | `			ph7_value *pLitCheck = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,(sxu32)pInstr->iP2);` |
|    467865 | 1182 | `			int isSpecial = 0;` |
|    467865 | 1183 | `			if( pLitCheck && (pLitCheck->iFlags & MEMOBJ_STRING) ){` |
|    374453 | 1184 | `				const char *z = (const char *)SyBlobData(&pLitCheck->sBlob);` |
|    374453 | 1185 | `				sxu32 n = (sxu32)SyBlobLength(&pLitCheck->sBlob);` |
|    374448 | 1186 | `				if( (n == 4 && SyMemcmp(z,"self",4) == 0) \|\|` |
|    349081 | 1187 | `					(n == 6 && SyMemcmp(z,"static",6) == 0) \|\|` |
|    189126 | 1188 | `					(n == 6 && SyMemcmp(z,"parent",6) == 0) ){` |
|    148019 | 1189 | `					isSpecial = 1;` |
|     74007 | 1190 | `				}` |
|    210577 | 1191 | `			}` |
|    514571 | 1192 | `			pInstr->iP1 = 0;` |
...
|         - | 1198 | `			{` |
|    725148 | 1199 | `				int bAbsolute = (pNode->pLeft && pNode->pLeft->pStart` |
|    631731 | 1200 | `					&& (pNode->pLeft->pStart->nType & PH7_TK_NSSEP));` |
|    421159 | 1201 | `				if( !isSpecial && !bAbsolute ){` |
|    273127 | 1202 | `					pInstr->iP2 = (sxi32)GenStateNsQualifyName(pGen,(sxu32)pInstr->iP2,&pGen->hUseImports,0);` |
|    136561 | 1203 | `				}` |
|         - | 1204 | `			}` |
...
|    421159 | 1207 | `			if( !isSpecial && pNode->pRight && pNode->pRight->pStart ){` |
|    273145 | 1208 | `				SyToken *pRightTok = pNode->pRight->pStart;` |
|    273145 | 1209 | `				if( (pRightTok->nType & PH7_TK_KEYWORD) &&` |
...
|  29684493 | 1217 | `	if( pNode->pRight ){` |
|  17048745 | 1218 | `		if( iVmOp == PH7_OP_LAND ){` |
|         - | 1219 | `			/* Emit the false jump so we can short-circuit the logical and */` |
|    451747 | 1220 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,1/* Keep the value on the stack */,0,0,&nJmpIdx);` |
|  16822874 | 1221 | `		}else if (iVmOp == PH7_OP_LOR ){` |
|         - | 1222 | `			/* Emit the true jump so we can short-circuit the logical or*/` |
|    326923 | 1223 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JNZ,1/* Keep the value on the stack */,0,0,&nJmpIdx);` |
|  16433544 | 1224 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLC ){` |
|         - | 1225 | `			/* Null coalescing: if LHS is not null, jump past RHS */` |
|     58539 | 1226 | `			iVmOp = 0; /* No binary operator to emit */` |
|     58539 | 1227 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_NULLC,0,0,0,&nJmpIdx);` |
|  16240870 | 1228 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW ){` |
...
|  16211499 | 1238 | `		}else if( pNode->pOp->iPrec == 18 /* Combined binary operators [i.e: =,'.=','+=',*=' ...] precedence */ ){` |
...
|   5228623 | 1242 | `			iFlags \|= EXPR_FLAG_LOAD_IDX_STORE \| EXPR_FLAG_MEMBER_WRITE;` |
|   5228623 | 1243 | `			if( iVmOp != PH7_OP_STORE ){` |
...
|    451595 | 1247 | `				iFlags \|= EXPR_FLAG_RMW_LOAD;` |
|    225795 | 1248 | `			}` |
|   2614309 | 1249 | `		}` |
|  17048745 | 1250 | `		nRhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  17048745 | 1251 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pRight,iFlags\|EXPR_FLAG_RDONLY_LOAD);` |
|  17048745 | 1252 | `		if( !bIsChainOp ){` |
|         - | 1253 | `			/* Non-chain parent: RHS nullsafe chain ends here, before the` |
|         - | 1254 | `			 * operator instruction is emitted. */` |
|  11042187 | 1255 | `			GenStatePatchNullsafeJumps(pGen, nRhsNsBase);` |
|   5521091 | 1256 | `		}` |
|  17048745 | 1257 | `		if( iVmOp == PH7_OP_STORE ){` |
|   4777033 | 1258 | `			if( pNode->pRight && (pNode->pRight->xCode == PH7_CompileList \|\|` |
|   4776996 | 1259 | `				pNode->pRight->xCode == PH7_CompileShortList) ){` |
...
|         - | 1265 | `				 */` |
|        91 | 1266 | `				iVmOp = 0;` |
|   4776990 | 1267 | `			}else if( (pInstr = PH7_VmPeekInstr(pGen->pVm)) != 0 ){` |
|   4776947 | 1268 | `				if(pInstr->iOp == PH7_OP_MEMBER ){` |
|         - | 1269 | `					/* Perform a member store operation [i.e: $this->x = 50] */` |
|    922705 | 1270 | `					iP2 = 1;` |
|    461355 | 1271 | `				}else{` |
|   3854247 | 1272 | `					if( pInstr->iOp == PH7_OP_LOAD_IDX ){` |
|         - | 1273 | `						/* Transform the STORE instruction to STORE_IDX instruction */` |
|    537639 | 1274 | `						iVmOp = PH7_OP_STORE_IDX;` |
|    537639 | 1275 | `						iP1 = pInstr->iP1;` |
|    268822 | 1276 | `					}else{` |
|   3316613 | 1277 | `						p3 = pInstr->p3;` |
|         - | 1278 | `					}` |
|         - | 1279 | `					/* POP the last dynamic load instruction */` |
|   3854247 | 1280 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|         - | 1281 | `				}` |
|   2388476 | 1282 | `			}` |
|  14660231 | 1283 | `		}else if( iVmOp == PH7_OP_STORE_REF ){` |
...
|        35 | 1310 | `		}` |
|   8524370 | 1311 | `	}` |
|  29684488 | 1312 | `	if( iVmOp == PH7_OP_NEW && pNode->pLeft && pNode->pLeft->pOp == 0` |
|    433618 | 1313 | `		&& pNode->pLeft->xCode == PH7_CompileAnnonClass ){` |
...
|        34 | 1316 | `		iVmOp = 0;` |
|        15 | 1317 | `	}` |
|  29684493 | 1318 | `	if( iVmOp > 0 ){` |
|  29625839 | 1319 | `		if( iVmOp == PH7_OP_INCR \|\| iVmOp == PH7_OP_DECR ){` |
|    218285 | 1320 | `			if( pNode->iFlags & EXPR_NODE_PRE_INCR ){` |
|         - | 1321 | `				/* Pre-increment/decrement operator [i.e: ++$i,--$j ] */` |
|     15593 | 1322 | `				iP1 = 1;` |
|      7799 | 1323 | `			}` |
|  29516699 | 1324 | `		}else if( iVmOp == PH7_OP_NEW ){` |
|         - | 1325 | `			/* Namespace-qualify the class name for NEW */ {` |
|    870469 | 1326 | `				VmInstr *pPeek = PH7_VmPeekInstr(pGen->pVm);` |
|    870469 | 1327 | `				VmInstr *pCallInstr = 0;` |
|    870469 | 1328 | `				if( pPeek && pPeek->iOp == PH7_OP_CALL ){` |
|    858599 | 1329 | `					pCallInstr = pPeek;` |
|    858599 | 1330 | `					pPeek = PH7_VmPeekNextInstr(pGen->pVm);` |
|    429297 | 1331 | `				}` |
|    870469 | 1332 | `				if( pPeek && pPeek->iOp == PH7_OP_LOADC ){` |
|    854901 | 1333 | `					int bAbsolute = (pPeek->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|         - | 1334 | `					sxu32 nLitForClass;` |
|    854901 | 1335 | `					VmCallArgMap *pCallNsMap = pCallInstr ? (VmCallArgMap *)pCallInstr->p3 : 0;` |
...
|    854901 | 1342 | `					if( pCallNsMap && pCallNsMap->nOrigNameLit > 0 ){` |
|        55 | 1343 | `						nLitForClass = pCallNsMap->nOrigNameLit - 1;` |
|        30 | 1344 | `					}else{` |
|    854851 | 1345 | `						nLitForClass = (sxu32)pPeek->iP2;` |
|         - | 1346 | `					}` |
|    854901 | 1347 | `					pPeek->iP1 = 0;` |
|    854901 | 1348 | `					if( !bAbsolute ){` |
...
|    850983 | 1353 | `						ph7_value *pLitChk = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,nLitForClass);` |
|    850983 | 1354 | `						int isSpecialNew = 0;` |
|    850983 | 1355 | `						if( pLitChk && (pLitChk->iFlags & MEMOBJ_STRING) ){` |
|    835815 | 1356 | `							const char *z = (const char *)SyBlobData(&pLitChk->sBlob);` |
|    835815 | 1357 | `							sxu32 n = (sxu32)SyBlobLength(&pLitChk->sBlob);` |
|    835810 | 1358 | `							if( (n == 4 && SyMemcmp(z,"self",4) == 0) \|\|` |
|    839549 | 1359 | `								(n == 6 && SyMemcmp(z,"static",6) == 0) \|\|` |
|    417853 | 1360 | `								(n == 6 && SyMemcmp(z,"parent",6) == 0) ){` |
|      7819 | 1361 | `								isSpecialNew = 1;` |
|      3907 | 1362 | `							}` |
|    421697 | 1363 | `						}` |
|    858567 | 1364 | `						if( isSpecialNew ){` |
|      7819 | 1365 | `							pPeek->iP2 = (sxi32)nLitForClass;` |
|      3912 | 1366 | `						}else{` |
|    835585 | 1367 | `							pPeek->iP2 = (sxi32)GenStateNsQualifyName(pGen,nLitForClass,&pGen->hUseImports,0);` |
|         - | 1368 | `						}` |
|    421702 | 1369 | `					}else{` |
|      3923 | 1370 | `						pPeek->iP2 = (sxi32)nLitForClass;` |
|         - | 1371 | `					}` |
|    423656 | 1372 | `				}` |
|         - | 1373 | `			}` |
|    862885 | 1374 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|    862885 | 1375 | `			if( pInstr && pInstr->iOp == PH7_OP_CALL ){` |
|         - | 1376 | `				VmInstr *pPrev;` |
|    858599 | 1377 | `				pPrev = PH7_VmPeekNextInstr(pGen->pVm);` |
|    858599 | 1378 | `				if( pPrev == 0 \|\| pPrev->iOp != PH7_OP_MEMBER ){` |
...
|    858599 | 1382 | `					iP1 = pInstr->iP1;` |
|    858599 | 1383 | `					iP2 = pInstr->iP2;` |
|    858599 | 1384 | `					if( pInstr->p3 ){` |
|        65 | 1385 | `						p3 = pInstr->p3; /* Transfer VmCallArgMap to NEW */` |
|        30 | 1386 | `					}` |
|    858599 | 1387 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|    429297 | 1388 | `				}` |
|    429302 | 1389 | `			}` |
|  28968535 | 1390 | `		}else if( iVmOp == PH7_OP_IS_A ){` |
...
|     82003 | 1393 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|     82003 | 1394 | `			if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|     82003 | 1395 | `				ph7_value *pLitChk = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,(sxu32)pInstr->iP2);` |
|     82003 | 1396 | `				int bAbsolute = (pInstr->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|     82003 | 1397 | `				int isSpecialIs = 0;` |
|     82003 | 1398 | `				if( pLitChk && (pLitChk->iFlags & MEMOBJ_STRING) ){` |
|     82003 | 1399 | `					const char *z = (const char *)SyBlobData(&pLitChk->sBlob);` |
|     82003 | 1400 | `					sxu32 n = (sxu32)SyBlobLength(&pLitChk->sBlob);` |
|     81998 | 1401 | `					if( (n == 4 && SyMemcmp(z,"self",4) == 0) \|\|` |
|     82001 | 1402 | `						(n == 6 && SyMemcmp(z,"static",6) == 0) \|\|` |
|     40999 | 1403 | `						(n == 6 && SyMemcmp(z,"parent",6) == 0) ){` |
|        12 | 1404 | `						isSpecialIs = 1;` |
|         5 | 1405 | `					}` |
|     40999 | 1406 | `				}` |
|     82003 | 1407 | `				pInstr->iP1 = 0;` |
|     82003 | 1408 | `				if( !isSpecialIs && !bAbsolute ){` |
|     81983 | 1409 | `					pInstr->iP2 = (sxi32)GenStateNsQualifyName(pGen,(sxu32)pInstr->iP2,&pGen->hUseImports,0);` |
|     40989 | 1410 | `				}` |
|     41004 | 1411 | `			}` |
|  28496096 | 1412 | `		}else if( iVmOp == PH7_OP_MEMBER){` |
...
|   6006563 | 1416 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|   6006563 | 1417 | `			if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|   5765281 | 1418 | `				pInstr->iP1 = 0;` |
|   2882638 | 1419 | `			}` |
|   6006563 | 1420 | `			if( pNode->pOp->iOp == EXPR_OP_DC /* '::' */){` |
|         - | 1421 | `				/* Static member access,remember that */` |
|    421103 | 1422 | `				iP1 = 1;` |
|    421103 | 1423 | `				pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|    421103 | 1424 | `				if( pInstr && pInstr->iOp == PH7_OP_LOAD ){` |
|    237383 | 1425 | `					p3 = pInstr->p3;` |
|    237383 | 1426 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|    118689 | 1427 | `				}` |
|    210549 | 1428 | `			}` |
...
|   6006563 | 1433 | `			if( iP2 == PH7_MEMBER_READ ){` |
|   6006563 | 1434 | `				if( iFlags & EXPR_FLAG_LOAD_IDX_UNSET ){` |
|        42 | 1435 | `					iP2 = PH7_MEMBER_UNSET;` |
|   6006543 | 1436 | `				}else if( iFlags & EXPR_FLAG_LOAD_IDX_ISSET ){` |
|     70163 | 1437 | `					iP2 = PH7_MEMBER_ISSET;` |
|   5971444 | 1438 | `				}else if( iFlags & EXPR_FLAG_LOAD_IDX_EMPTY ){` |
|        17 | 1439 | `					iP2 = PH7_MEMBER_EMPTY;` |
|   5936357 | 1440 | `				}else if( iFlags & EXPR_FLAG_MEMBER_WRITE ){` |
|         - | 1441 | `					/* Write-lvalue base ($o->arr[$k]=v, $o->p ??= v): auto-create a missing prop. */` |
|   1117391 | 1442 | `					iP2 = PH7_MEMBER_WRITE;` |
|    558693 | 1443 | `				}` |
|   3003279 | 1444 | `			}` |
|   3003279 | 1445 | `		}` |
...
|  29618255 | 1473 | `		if( iVmOp == PH7_OP_CALL \|\| iVmOp == PH7_OP_NEW ){` |
|   7938671 | 1474 | `			p3 = GenStateAttachStrictFlag(pGen,p3);` |
|   3969333 | 1475 | `		}` |
|         - | 1476 | `		/* Finally,emit the VM instruction associated with this operator */` |
|  29618255 | 1477 | `		PH7_VmEmitInstr(pGen->pVm,iVmOp,iP1,iP2,p3,0);` |
|  14809125 | 1478 | `	}` |
|  29676909 | 1479 | `	if( nJmpIdx > 0 ){` |
|         - | 1480 | `		/* Fix short-circuited jumps now the destination is resolved */` |
|    837199 | 1481 | `		pInstr = PH7_VmGetInstr(pGen->pVm,nJmpIdx);` |
|    837199 | 1482 | `		if( pInstr ){` |
|    837199 | 1483 | `			pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    418597 | 1484 | `		}` |
|    418597 | 1485 | `	}` |
|  29676909 | 1486 | `	return rc;` |
|  38107214 | 1487 | `}` |
|         - | 1488 | `/*` |
...
|         - | 1509 | ` */` |
| 252999082 | 1510 | `static int GenStateTreeHasComma(ph7_expr_node *pNode)` |
|         5 | 1511 | `{` |
|         - | 1512 | `	ph7_expr_node **apArg;` |
|         - | 1513 | `	sxu32 n;` |
| 252999087 | 1514 | `	if( pNode == 0 ){` |
| 177867141 | 1515 | `		return 0;` |
|         - | 1516 | `	}` |
|  75131951 | 1517 | `	if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_COMMA ){` |
|         6 | 1518 | `		return 1;` |
|         - | 1519 | `	}` |
|  75131942 | 1520 | `	if( GenStateTreeHasComma(pNode->pLeft) \|\| GenStateTreeHasComma(pNode->pRight)` |
|  75131943 | 1521 | `	 \|\| GenStateTreeHasComma(pNode->pCond) ){` |
|         6 | 1522 | `		return 1;` |
|         - | 1523 | `	}` |
|  75131943 | 1524 | `	apArg = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  85939723 | 1525 | `	for( n = 0 ; n < SySetUsed(&pNode->aNodeArgs) ; n++ ){` |
|  10807785 | 1526 | `		if( GenStateTreeHasComma(apArg[n]) ){` |
|       ! 0 | 1527 | `			return 1;` |
|         - | 1528 | `		}` |
|   5403895 | 1529 | `	}` |
|  75131943 | 1530 | `	return 0;` |
| 126499546 | 1531 | `}` |
|  17169560 | 1532 | `PH7_PRIVATE sxi32 PH7_CompileExpr(` |
...
|  17169565 | 1546 | `	nExpr = 0;` |
|  17169565 | 1547 | `	pRoot = 0;` |
...
|  17169565 | 1550 | `	nNullsafeBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  17169565 | 1551 | `	SySetInit(&sExprNode,&pGen->pVm->sAllocator,sizeof(ph7_expr_node *));` |
|  17169565 | 1552 | `	SySetAlloc(&sExprNode,0x10);` |
|  17169565 | 1553 | `	rc = SXRET_OK;` |
|         - | 1554 | `	/* Delimit the expression */` |
|  17169565 | 1555 | `	pEnd = pGen->pIn;` |
|  17169565 | 1556 | `	iNest = 0;` |
| 134409911 | 1557 | `	while( pEnd < pGen->pEnd ){` |
| 127808523 | 1558 | `		if( pEnd->nType & PH7_TK_OCB /* '{' */ ){` |
|         - | 1559 | `			/* Ticket 1433-30: Annonymous/Closure functions body */` |
|      4737 | 1560 | `			iNest++;` |
| 127806157 | 1561 | `		}else if(pEnd->nType & PH7_TK_CCB /* '}' */ ){` |
|      4747 | 1562 | `			iNest--;` |
| 127801420 | 1563 | `		}else if( pEnd->nType & PH7_TK_SEMI /* ';' */ ){` |
|  10569055 | 1564 | `			if( iNest <= 0 ){` |
|  10568177 | 1565 | `				break;` |
|         - | 1566 | `			}` |
|       439 | 1567 | `		}` |
| 117240351 | 1568 | `		pEnd++;` |
|         5 | 1569 | `	}` |
|  17169565 | 1570 | `	if( iFlags & EXPR_FLAG_COMMA_STATEMENT ){` |
|    740237 | 1571 | `		SyToken *pEnd2 = pGen->pIn;` |
|    740237 | 1572 | `		iNest = 0;` |
|         - | 1573 | `		/* Stop at the first comma */` |
|   1625485 | 1574 | `		while( pEnd2 < pEnd ){` |
|    885255 | 1575 | `			if( pEnd2->nType & (PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*'['*/\|PH7_TK_LPAREN/*'('*/) ){` |
|     50687 | 1576 | `				iNest++;` |
|    859914 | 1577 | `			}else if(pEnd2->nType & (PH7_TK_CCB/*'}'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_RPAREN/*')'*/)){` |
|     50687 | 1578 | `				iNest--;` |
|    809232 | 1579 | `			}else if( pEnd2->nType & PH7_TK_COMMA /*','*/ ){` |
...
|    885253 | 1584 | `			pEnd2++;` |
|         5 | 1585 | `		}` |
|    740237 | 1586 | `		if( pEnd2 <pEnd ){` |
|         3 | 1587 | `			pEnd = pEnd2;` |
|         1 | 1588 | `		}` |
|    370116 | 1589 | `	}` |
|  17169565 | 1590 | `	if( pEnd > pGen->pIn ){` |
|  17146217 | 1591 | `		SyToken *pTmp = pGen->pEnd;` |
|         - | 1592 | `		/* Swap delimiter */` |
|  17146217 | 1593 | `		pGen->pEnd = pEnd;` |
|         - | 1594 | `		/* Try to get an expression tree */` |
|  17146217 | 1595 | `		rc = PH7_ExprMakeTree(&(*pGen),&sExprNode,&pRoot);` |
|  17146212 | 1596 | `		if( rc == SXRET_OK && pRoot && pGen->nCommaExprOk < 1` |
|  16970763 | 1597 | `		 && GenStateTreeHasComma(pRoot) ){` |
...
|         - | 1610 | `		}` |
|  17146213 | 1611 | `		if( rc == SXRET_OK && pRoot ){` |
|  17146033 | 1612 | `			rc = SXRET_OK;` |
|  17146033 | 1613 | `			if( xTreeValidator ){` |
|         - | 1614 | `				/* Call the upper layer validator callback */` |
|   1036677 | 1615 | `				rc = xTreeValidator(&(*pGen),pRoot);` |
|    518336 | 1616 | `			}` |
|  17146033 | 1617 | `			if( rc != SXERR_ABORT ){` |
|         - | 1618 | `				/* Generate code for the given tree */` |
|  17146033 | 1619 | `				rc = GenStateEmitExprCode(&(*pGen),pRoot,iFlags);` |
|         - | 1620 | `				/* Patch any unresolved nullsafe jumps emitted by this` |
|         - | 1621 | `				 * expression so they short-circuit to its end. */` |
|  17146033 | 1622 | `				GenStatePatchNullsafeJumps(pGen, nNullsafeBase);` |
|   8573014 | 1623 | `			}` |
|  17146033 | 1624 | `			nExpr = 1;` |
|   8573014 | 1625 | `		}` |
|         - | 1626 | `		/* Release the whole tree */` |
|  17146213 | 1627 | `		PH7_ExprFreeTree(&(*pGen),&sExprNode);` |
|         - | 1628 | `		/* Synchronize token stream */` |
|  17146213 | 1629 | `		pGen->pEnd = pTmp;` |
|  17146213 | 1630 | `		pGen->pIn  = pEnd;` |
|  17146213 | 1631 | `		if( rc == SXERR_ABORT ){` |
|        18 | 1632 | `			SySetRelease(&sExprNode);` |
|        18 | 1633 | `			return SXERR_ABORT;` |
|         - | 1634 | `		}` |
|   8573097 | 1635 | `	}` |
|  17169547 | 1636 | `	SySetRelease(&sExprNode);` |
|  17169547 | 1637 | `	return nExpr > 0 ? SXRET_OK : SXERR_EMPTY;` |
|   8584785 | 1638 | `}` |
|         - | 1639 | `/*` |
|         - | 1640 | ` * Return a pointer to the node construct handler associated` |
|         - | 1641 | ` * with a given node type [i.e: string,integer,float,...].` |
|         - | 1642 | ` */` |
|   9536316 | 1643 | `PH7_PRIVATE ProcNodeConstruct PH7_GetNodeHandler(sxu32 nNodeType)` |
|         5 | 1644 | `{` |
|   9536321 | 1645 | `	if( nNodeType & PH7_TK_NUM ){` |
|         - | 1646 | `		/* Numeric literal: Either real or integer */` |
|   3835149 | 1647 | `		return PH7_CompileNumLiteral;` |
|   5701177 | 1648 | `	}else if( nNodeType & PH7_TK_DSTR ){` |
|         - | 1649 | `		/* Double quoted string */` |
|    125239 | 1650 | `		return PH7_CompileString;` |
|   5575943 | 1651 | `	}else if( nNodeType & PH7_TK_SSTR ){` |
|         - | 1652 | `		/* Single quoted string */` |
|   5575819 | 1653 | `		return PH7_CompileSimpleString;` |
...
|         - | 1670 | ` */` |
|     23458 | 1671 | `static sxi32 GenStateUnsetValidator(ph7_gen_state *pGen, ph7_expr_node *pNode)` |
|         5 | 1672 | `{` |
|         - | 1673 | `	sxi32 rc;` |
|     23463 | 1674 | `	if( !PH7_ExprContainsNullsafe(pNode) ){` |
|     23461 | 1675 | `		return SXRET_OK;` |
|         - | 1676 | `	}` |
...
|         - | 1688 | ` */` |
|     26170 | 1689 | `static sxi32 PH7_CompileUnset(ph7_gen_state *pGen)` |
|         5 | 1690 | `{` |
|     26175 | 1691 | `	SyToken *pTmp,*pEnd,*pNext = 0;` |
|     26175 | 1692 | `	sxu32 nIdx = 0;` |
|         - | 1693 | `	SyString sName;` |
|         - | 1694 | `	sxi32 rc;` |
|         - | 1695 | `	/* Jump the 'unset' keyword */` |
|     26175 | 1696 | `	pGen->pIn++;` |
|         - | 1697 | `	/* Save delimiter */` |
|     26175 | 1698 | `	pTmp = pGen->pEnd;` |
|         - | 1699 | `	/* Skip optional opening parenthesis and find the matching close */` |
|     26175 | 1700 | `	pEnd = pTmp; /* Default: scan to statement end */` |
|     26175 | 1701 | `	if( pGen->pIn < pTmp && (pGen->pIn->nType & PH7_TK_LPAREN) ){` |
|         - | 1702 | `		/* Find matching ')' — start scanning AFTER the '(' */` |
|         - | 1703 | `		SyToken *pClose;` |
|     26175 | 1704 | `		pGen->pIn++;   /* Skip '(' */` |
|     26175 | 1705 | `		PH7_DelimitNestedTokens(pGen->pIn,pTmp,PH7_TK_LPAREN,PH7_TK_RPAREN,&pClose);` |
|     26175 | 1706 | `		pEnd = pClose; /* Stop at ')' */` |
|     13085 | 1707 | `	}` |
|     26175 | 1708 | `	SyStringInitFromBuf(&sName,"unset",sizeof("unset")-1);` |
|         - | 1709 | `	/* Resolve the 'unset' builtin name once */` |
|     26175 | 1710 | `	if( SXRET_OK != GenStateFindLiteral(&(*pGen),&sName,&nIdx) ){` |
|      3895 | 1711 | `		ph7_value *pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|      3895 | 1712 | `		if( pObj == 0 ){` |
|       ! 0 | 1713 | `			return SXERR_ABORT;` |
|         - | 1714 | `		}` |
|      3895 | 1715 | `		PH7_MemObjInitFromString(pGen->pVm,pObj,&sName);` |
|      3895 | 1716 | `		GenStateInstallLiteral(&(*pGen),pObj,nIdx);` |
|      1945 | 1717 | `	}` |
|         - | 1718 | `	/* Compile each comma-separated argument */` |
|     56225 | 1719 | `	while( SXRET_OK == PH7_GetNextExpr(pGen->pIn,pEnd,&pNext) ){` |
|     30055 | 1720 | `		if( pGen->pIn < pNext ){` |
|         - | 1721 | `			/*` |
...
|         - | 1728 | `			 */` |
|     30050 | 1729 | `			if( &pGen->pIn[2] == pNext` |
|     18321 | 1730 | `				&& (pGen->pIn[0].nType & PH7_TK_DOLLAR)` |
...
|      6595 | 1747 | `				continue;` |
|         - | 1748 | `			}` |
|     23465 | 1749 | `			pGen->pEnd = pNext;` |
|     23465 | 1750 | `			rc = PH7_CompileExpr(&(*pGen),` |
|         - | 1751 | `				EXPR_FLAG_RDONLY_LOAD\|EXPR_FLAG_LOAD_IDX_UNSET,` |
|         - | 1752 | `				GenStateUnsetValidator);` |
|     23465 | 1753 | `			if( rc == SXERR_ABORT ){` |
|       ! 0 | 1754 | `				return SXERR_ABORT;` |
|         - | 1755 | `			}` |
|     23465 | 1756 | `			if( rc != SXERR_EMPTY ){` |
|         - | 1757 | `				/* Emit call for this single argument */` |
|     23463 | 1758 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|     23463 | 1759 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_CALL,1,0,GenStateAttachStrictFlag(pGen,0),0);` |
|     23463 | 1760 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|     11729 | 1761 | `			}` |
|     11730 | 1762 | `		}` |
|         - | 1763 | `		/* Jump trailing commas */` |
|     23471 | 1764 | `		while( pNext < pEnd && (pNext->nType & PH7_TK_COMMA) ){` |
|         7 | 1765 | `			pNext++;` |
|         1 | 1766 | `		}` |
|     23465 | 1767 | `		pGen->pIn = pNext;` |
|         5 | 1768 | `	}` |
|         - | 1769 | `	/* Skip past the closing ')' if present */` |
|     26175 | 1770 | `	if( pGen->pIn < pTmp && (pGen->pIn->nType & PH7_TK_RPAREN) ){` |
|     26175 | 1771 | `		pGen->pIn++;` |
|     13085 | 1772 | `	}` |
|         - | 1773 | `	/* Restore token stream */` |
|     26175 | 1774 | `	pGen->pEnd = pTmp;` |
|     26175 | 1775 | `	return SXRET_OK;` |
|     13090 | 1776 | `}` |
|         - | 1777 | `/*` |
...
|         - | 1809 | ` */` |
|   8473988 | 1810 | `static ProcLangConstruct GenStateGetStatementHandler(` |
|         - | 1811 | `	sxu32 nKeywordID,   /* Keyword  ID*/` |
|         - | 1812 | `	SyToken *pLookahed  /* Look-ahead token */` |
|         - | 1813 | `	)` |
|         5 | 1814 | `{` |
|   8473993 | 1815 | `	sxu32 n = 0;` |
|  34221603 | 1816 | `	for(;;){` |
|  68443211 | 1817 | `		if( n >= SX_ARRAYSIZE(aLangConstruct) ){` |
|    535461 | 1818 | `			break;` |
|         - | 1819 | `		}` |
|  67907755 | 1820 | `		if( aLangConstruct[n].nID == nKeywordID ){` |
|   7938537 | 1821 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed && (pLookahed->nType & PH7_TK_OP)){` |
...
|         - | 1826 | `				}` |
|       ! 0 | 1827 | `			}` |
|   7938532 | 1828 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed` |
|     11684 | 1829 | `				&& (pLookahed->nType & PH7_TK_KEYWORD)` |
|      5849 | 1830 | `				&& SX_PTR_TO_INT(pLookahed->pUserData) == PH7_TKWRD_FN ){` |
|         - | 1831 | `				/* 'static fn(...)' arrow function — compile as expression */` |
|         3 | 1832 | `				return 0;` |
|         - | 1833 | `			}` |
|         - | 1834 | `			/* Return a pointer to the handler.` |
|         - | 1835 | `			*/` |
|   7938535 | 1836 | `			return aLangConstruct[n].xConstruct;` |
|         - | 1837 | `		}` |
|  59969223 | 1838 | `		n++;` |
|         5 | 1839 | `	}` |
|    535461 | 1840 | `	if( pLookahed ){` |
|    535461 | 1841 | `		if(nKeywordID == PH7_TKWRD_INTERFACE && (pLookahed->nType & PH7_TK_ID) ){` |
|     70149 | 1842 | `			return PH7_CompileClassInterface;` |
|    465317 | 1843 | `		}else if(nKeywordID == PH7_TKWRD_CLASS && (pLookahed->nType & PH7_TK_ID) ){` |
|    398603 | 1844 | `			return PH7_CompileClass;` |
|     66719 | 1845 | `		}else if(nKeywordID == PH7_TKWRD_TRAIT && (pLookahed->nType & PH7_TK_ID) ){` |
|      7885 | 1846 | `			return PH7_CompileTrait;` |
|         - | 1847 | `		}` |
...
|         - | 1859 | ` */` |
|     58836 | 1860 | `static int GenStateisLangConstruct(sxu32 nKeyword)` |
|         5 | 1861 | `{` |
|         - | 1862 | `	int rc;` |
|     58841 | 1863 | `	rc = PH7_IsLangConstruct(nKeyword,TRUE);` |
|     58841 | 1864 | `	if( rc == FALSE ){` |
|     58734 | 1865 | `		if( nKeyword == PH7_TKWRD_SELF \|\| nKeyword == PH7_TKWRD_PARENT \|\| nKeyword == PH7_TKWRD_STATIC` |
|     15930 | 1866 | `			\|\| nKeyword == PH7_TKWRD_YIELD` |
...
|         - | 1890 | ` */` |
|  18185882 | 1891 | `PH7_PRIVATE void GenStateSetPendingDoc(ph7_gen_state *pGen)` |
|         5 | 1892 | `{` |
|  18185887 | 1893 | `	SyToken *pBase = (SyToken *)SySetBasePtr(pGen->pTokenSet);` |
|  18185887 | 1894 | `	ph7_trivia *aT = (ph7_trivia *)SySetBasePtr(&pGen->aTrivia);` |
|  18185887 | 1895 | `	sxu32 nT = SySetUsed(&pGen->aTrivia);` |
|         - | 1896 | `	sxu32 nIdx, n;` |
|  18185882 | 1897 | `	if( nT < 1 \|\| pGen->pTokenSet == 0` |
|   3429901 | 1898 | `	 \|\| pGen->pIn < pBase \|\| pGen->pIn >= &pBase[SySetUsed(pGen->pTokenSet)] ){` |
|         - | 1899 | `		/* Re-tokenized substream (string interpolation, synthesized code):` |
|         - | 1900 | `		 * indexes do not map to the sidecar */` |
|  14755993 | 1901 | `		return;` |
|         - | 1902 | `	}` |
|   3429899 | 1903 | `	nIdx = (sxu32)(pGen->pIn - pBase);` |
...
|   3429899 | 1906 | `	SySetReset(&pGen->aPendingAttrs);` |
|  10291447 | 1907 | `	for( n = 0 ; n < nT ; n++ ){` |
|   6861553 | 1908 | `		if( aT[n].nTokIdx != nIdx ){` |
|   6853601 | 1909 | `			continue;` |
|         - | 1910 | `		}` |
|      7957 | 1911 | `		if( aT[n].iKind == PH7_TRIVIA_DOC ){` |
|        29 | 1912 | `			pGen->sPendingDoc = aT[n].sText;` |
|      7945 | 1913 | `		}else if( aT[n].iKind == PH7_TRIVIA_ATTR ){` |
|      7933 | 1914 | `			SySetPut(&pGen->aPendingAttrs,(const void *)&aT[n]);` |
|      3964 | 1915 | `		}` |
|      3981 | 1916 | `	}` |
|   9092946 | 1917 | `}` |
|         - | 1918 | `/*` |
...
|         - | 1922 | ` */` |
|   4893236 | 1923 | `PH7_PRIVATE void GenStateConsumeDoc(ph7_gen_state *pGen,SyString *pOut)` |
|         5 | 1924 | `{` |
|         - | 1925 | `	char *zDup;` |
|   4893241 | 1926 | `	if( SyStringLength(&pGen->sPendingDoc) < 1 ){` |
|   4893221 | 1927 | `		return;` |
|         - | 1928 | `	}` |
...
|         - | 1944 | ` */` |
|      7942 | 1945 | `static sxi32 GenStateCompileAttrSpan(ph7_gen_state *pGen,ph7_trivia *pTrivia,SySet *pOut)` |
|         5 | 1946 | `{` |
|         - | 1947 | `	SySet *pToken;` |
|         - | 1948 | `	SyToken *pIn, *pEnd, *pSavedIn, *pSavedEnd;` |
|         - | 1949 | `	char *zSpan;` |
|      7947 | 1950 | `	sxi32 rc = SXRET_OK;` |
|      7947 | 1951 | `	if( SyStringLength(&pTrivia->sText) < 1 ){` |
|       ! 0 | 1952 | `		return SXRET_OK;` |
|         - | 1953 | `	}` |
|     11918 | 1954 | `	zSpan = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|      3971 | 1955 | `		SyStringData(&pTrivia->sText),SyStringLength(&pTrivia->sText));` |
|      7947 | 1956 | `	if( zSpan == 0 ){` |
...
|      7947 | 1962 | `	pToken = (SySet *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(SySet));` |
|      7947 | 1963 | `	if( pToken == 0 ){` |
|       ! 0 | 1964 | `		return SXRET_OK;` |
|         - | 1965 | `	}` |
|      7947 | 1966 | `	SySetInit(pToken,&pGen->pVm->sAllocator,sizeof(SyToken));` |
|      7947 | 1967 | `	PH7_TokenizePHP(zSpan,SyStringLength(&pTrivia->sText),pTrivia->nLine,pToken,0);` |
|      7947 | 1968 | `	pIn = (SyToken *)SySetBasePtr(pToken);` |
|      7947 | 1969 | `	pEnd = &pIn[SySetUsed(pToken)];` |
|      7947 | 1970 | `	pSavedIn = pGen->pIn;` |
|      7947 | 1971 | `	pSavedEnd = pGen->pEnd;` |
|      7951 | 1972 | `	while( pIn < pEnd ){` |
|         - | 1973 | `		ph7_attribute sAttr;` |
|         - | 1974 | `		SyBlob sFQN;` |
|      7951 | 1975 | `		int bAbsolute = 0;` |
|      7951 | 1976 | `		SyZero(&sAttr,sizeof(sAttr));` |
|      7951 | 1977 | `		SySetInit(&sAttr.aArgs,&pGen->pVm->sAllocator,sizeof(ph7_attr_arg));` |
|      7951 | 1978 | `		sAttr.nLine = pIn->nLine;` |
|      7951 | 1979 | `		if( pIn->nType & PH7_TK_NSSEP ){` |
|        75 | 1980 | `			bAbsolute = 1;` |
|        75 | 1981 | `			pIn++;` |
|        35 | 1982 | `		}` |
|      7951 | 1983 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|      7951 | 1984 | `		while( pIn < pEnd && (pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|      7951 | 1985 | `			SyBlobAppend(&sFQN,pIn->sData.zString,pIn->sData.nByte);` |
|      7951 | 1986 | `			pIn++;` |
|      7951 | 1987 | `			if( pIn < pEnd && (pIn->nType & PH7_TK_NSSEP) ){` |
...
|      7951 | 1992 | `			break;` |
|       ! 0 | 1993 | `		}` |
|      7951 | 1994 | `		if( SyBlobLength(&sFQN) < 1 ){` |
...
|         - | 2002 | `		{` |
|      7951 | 2003 | `			const char *zName = (const char *)SyBlobData(&sFQN);` |
|      7951 | 2004 | `			sxu32 nName = SyBlobLength(&sFQN);` |
|      7951 | 2005 | `			char *zDup = 0;` |
|      7951 | 2006 | `			if( !bAbsolute ){` |
|      7881 | 2007 | `				SyHashEntry *pImp = SyHashGet(&pGen->hUseImports,(const void *)zName,nName);` |
|      7881 | 2008 | `				if( pImp ){` |
...
|       ! 0 | 2013 | `					}` |
|      7881 | 2014 | `				}else if( SyBlobLength(&pGen->sNamespace) > 0 ){` |
|         - | 2015 | `					SyBlob sTmp;` |
...
|       ! 0 | 2026 | `				}` |
|      3938 | 2027 | `			}` |
|      7951 | 2028 | `			if( SyStringLength(&sAttr.sName) < 1 ){` |
|      7951 | 2029 | `				zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,zName,nName);` |
|      7951 | 2030 | `				if( zDup ){` |
|      7951 | 2031 | `					SyStringInitFromBuf(&sAttr.sName,zDup,nName);` |
|      3973 | 2032 | `				}` |
|      3973 | 2033 | `			}` |
|         - | 2034 | `		}` |
|      7951 | 2035 | `		SyBlobRelease(&sFQN);` |
|      7951 | 2036 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_LPAREN) ){` |
|         - | 2037 | `			SyToken *pArgsEnd;` |
|      7849 | 2038 | `			pIn++;` |
|      7849 | 2039 | `			PH7_DelimitNestedTokens(pIn,pEnd,PH7_TK_LPAREN,PH7_TK_RPAREN,&pArgsEnd);` |
|     15707 | 2040 | `			while( pIn < pArgsEnd ){` |
|      7863 | 2041 | `				SyToken *pArgStart = pIn, *pArgStop = pIn;` |
|      7863 | 2042 | `				sxi32 iDepth = 0;` |
|         - | 2043 | `				ph7_attr_arg sArgRec;` |
|     78077 | 2044 | `				while( pArgStop < pArgsEnd ){` |
|     70235 | 2045 | `					if( pArgStop->nType & (PH7_TK_LPAREN\|PH7_TK_OSB\|PH7_TK_OCB) ){` |
|        11 | 2046 | `						iDepth++;` |
|     70230 | 2047 | `					}else if( pArgStop->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB) ){` |
|        11 | 2048 | `						iDepth--;` |
|     70220 | 2049 | `					}else if( (pArgStop->nType & PH7_TK_COMMA) && iDepth == 0 ){` |
|        17 | 2050 | `						break;` |
|         - | 2051 | `					}` |
|     70219 | 2052 | `					pArgStop++;` |
|         5 | 2053 | `				}` |
|      7863 | 2054 | `				SyZero(&sArgRec,sizeof(sArgRec));` |
|      7863 | 2055 | `				SySetInit(&sArgRec.aByteCode,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|      7858 | 2056 | `				if( pArgStart < pArgStop && (pArgStart->nType & (PH7_TK_ID\|PH7_TK_KEYWORD))` |
|      7840 | 2057 | `				 && &pArgStart[1] < pArgStop && (pArgStart[1].nType & PH7_TK_COLON) ){` |
...
|        19 | 2063 | `					pArgStart += 2;` |
|         9 | 2064 | `				}` |
|      7863 | 2065 | `				if( pArgStart < pArgStop ){` |
|         - | 2066 | `					SySet *pInstrContainer;` |
|      7863 | 2067 | `					pGen->pIn = pArgStart;` |
|      7863 | 2068 | `					pGen->pEnd = pArgStop;` |
|      7863 | 2069 | `					pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|      7863 | 2070 | `					PH7_VmSetByteCodeContainer(pGen->pVm,&sArgRec.aByteCode);` |
|      7863 | 2071 | `					rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|      7863 | 2072 | `					PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|      7863 | 2073 | `					PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|      7863 | 2074 | `					if( rc == SXERR_ABORT ){` |
|       ! 0 | 2075 | `						pGen->pIn = pSavedIn;` |
|       ! 0 | 2076 | `						pGen->pEnd = pSavedEnd;` |
|       ! 0 | 2077 | `						return SXERR_ABORT;` |
|         - | 2078 | `					}` |
|      7863 | 2079 | `					SySetPut(&sAttr.aArgs,(const void *)&sArgRec);` |
|      3929 | 2080 | `				}` |
|      7863 | 2081 | `				pIn = pArgStop;` |
|      7863 | 2082 | `				if( pIn < pArgsEnd && (pIn->nType & PH7_TK_COMMA) ){` |
|        17 | 2083 | `					pIn++;` |
|         8 | 2084 | `				}` |
|         5 | 2085 | `			}` |
|      7849 | 2086 | `			pIn = (pArgsEnd < pEnd) ? &pArgsEnd[1] : pEnd;` |
|      3922 | 2087 | `		}` |
|      7951 | 2088 | `		SySetPut(pOut,(const void *)&sAttr);` |
|      7951 | 2089 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_COMMA) ){` |
|         5 | 2090 | `			pIn++;` |
|         5 | 2091 | `			continue;` |
|         - | 2092 | `		}` |
|      7947 | 2093 | `		break;` |
|       ! 0 | 2094 | `	}` |
|      7947 | 2095 | `	pGen->pIn = pSavedIn;` |
|      7947 | 2096 | `	pGen->pEnd = pSavedEnd;` |
|      7947 | 2097 | `	return SXRET_OK;` |
|      3976 | 2098 | `}` |
|         - | 2099 | `/*` |
...
|         - | 2102 | ` */` |
|   4893240 | 2103 | `PH7_PRIVATE sxi32 GenStateConsumeAttrs(ph7_gen_state *pGen,SySet *pOut)` |
|         5 | 2104 | `{` |
|   4893245 | 2105 | `	ph7_trivia *aT = (ph7_trivia *)SySetBasePtr(&pGen->aPendingAttrs);` |
|         - | 2106 | `	sxu32 n;` |
|         - | 2107 | `	sxi32 rc;` |
|   4901173 | 2108 | `	for( n = 0 ; n < SySetUsed(&pGen->aPendingAttrs) ; n++ ){` |
|      7933 | 2109 | `		rc = GenStateCompileAttrSpan(&(*pGen),&aT[n],pOut);` |
|      7933 | 2110 | `		if( rc == SXERR_ABORT ){` |
|       ! 0 | 2111 | `			return SXERR_ABORT;` |
|         - | 2112 | `		}` |
|      3969 | 2113 | `	}` |
|   4893245 | 2114 | `	SySetReset(&pGen->aPendingAttrs);` |
|   4893245 | 2115 | `	return SXRET_OK;` |
|   2446625 | 2116 | `}` |
|         - | 2117 | `/*` |
...
|         - | 2121 | ` */` |
|   2462268 | 2122 | `PH7_PRIVATE sxi32 GenStateCollectParamAttrs(ph7_gen_state *pGen,SyToken *pTok,SySet *pOut)` |
|         5 | 2123 | `{` |
|   2462273 | 2124 | `	SyToken *pBase = (SyToken *)SySetBasePtr(pGen->pTokenSet);` |
|   2462273 | 2125 | `	ph7_trivia *aT = (ph7_trivia *)SySetBasePtr(&pGen->aTrivia);` |
|   2462273 | 2126 | `	sxu32 nT = SySetUsed(&pGen->aTrivia);` |
|         - | 2127 | `	sxu32 nIdx, n;` |
|         - | 2128 | `	sxi32 rc;` |
|   2462268 | 2129 | `	if( nT < 1 \|\| pGen->pTokenSet == 0` |
|    556571 | 2130 | `	 \|\| pTok < pBase \|\| pTok >= &pBase[SySetUsed(pGen->pTokenSet)] ){` |
|   1905707 | 2131 | `		return SXRET_OK;` |
|         - | 2132 | `	}` |
|    556571 | 2133 | `	nIdx = (sxu32)(pTok - pBase);` |
|   1669747 | 2134 | `	for( n = 0 ; n < nT ; n++ ){` |
|   1113181 | 2135 | `		if( aT[n].nTokIdx == nIdx && aT[n].iKind == PH7_TRIVIA_ATTR ){` |
...
|         7 | 2140 | `		}` |
|    556593 | 2141 | `	}` |
|    556571 | 2142 | `	return SXRET_OK;` |
|   1231139 | 2143 | `}` |
|  13343120 | 2144 | `PH7_PRIVATE sxi32 GenStateCompileChunk(` |
...
|         - | 2150 | `	sxi32 rc;` |
|  13343125 | 2151 | `	rc = SXRET_OK; /* Prevent compiler warning */` |
|   7755478 | 2152 | `	for(;;){` |
|  14427043 | 2153 | `		int bStmtIsDeclare = 0;` |
|  14427043 | 2154 | `		if( pGen->pIn >= pGen->pEnd ){` |
|         - | 2155 | `			/* No more input to process */` |
|     91643 | 2156 | `			break;` |
|         - | 2157 | `		}` |
|         - | 2158 | `		/* Bind a directly-preceding docblock to this statement */` |
|  14335405 | 2159 | `		GenStateSetPendingDoc(&(*pGen));` |
|  14335405 | 2160 | `		if( SySetUsed(&pGen->aPendingAttrs) > 0 ){` |
...
|      7845 | 2166 | `			int bAttrTarget = 0;` |
|      7840 | 2167 | `			if( GenStateStartsModifiedClass(pGen->pIn,pGen->pEnd)` |
|      3955 | 2168 | `			 \|\| GenStateStartsEnumDecl(pGen->pIn,pGen->pEnd) ){` |
|      7785 | 2169 | `				bAttrTarget = 1;` |
|      3951 | 2170 | `			}else if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
...
|  14335405 | 2192 | `		if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|   8516853 | 2193 | `			sxu32 nPeek = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   8516853 | 2194 | `			if( nPeek == PH7_TKWRD_DECLARE ){` |
|        49 | 2195 | `				bStmtIsDeclare = 1;` |
|        22 | 2196 | `			}` |
|   4258424 | 2197 | `		}` |
|  14335405 | 2198 | `		if( !bStmtIsDeclare && pGen->pCurrent == &pGen->sGlobal ){` |
...
|   1083909 | 2201 | `			pGen->bStrictTypesLocked = 1;` |
|    541952 | 2202 | `		}` |
|  14335405 | 2203 | `		if( pGen->pIn->nType & PH7_TK_OCB /* '{' */ ){` |
|         - | 2204 | `			/* Compile block */` |
|      3935 | 2205 | `			rc = PH7_CompileBlock(&(*pGen),0);` |
|      3935 | 2206 | `			if( rc == SXERR_ABORT ){` |
|       ! 0 | 2207 | `				break;` |
|         - | 2208 | `			}` |
|      1970 | 2209 | `		}else{` |
|  14331475 | 2210 | `			xCons = 0;` |
|  14331475 | 2211 | `			if( GenStateStartsModifiedClass(pGen->pIn,pGen->pEnd) ){` |
...
|     42891 | 2215 | `				xCons = PH7_CompileClassModifiers;` |
|  14310032 | 2216 | `			}else if( GenStateStartsEnumDecl(pGen->pIn,pGen->pEnd) ){` |
|         - | 2217 | ``				/* `enum Name …` (PHP 8.1) — `enum` is a context-sensitive ID,`` |
|         - | 2218 | `				 * so it is detected here rather than the keyword dispatcher. */` |
|      3931 | 2219 | `				xCons = PH7_CompileEnum;` |
|  14286626 | 2220 | `			}else if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|   8473993 | 2221 | `				sxu32 nKeyword = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|         - | 2222 | `				/* Try to extract a language construct handler */` |
|   8473993 | 2223 | `				xCons = GenStateGetStatementHandler(nKeyword,(&pGen->pIn[1] < pGen->pEnd) ? &pGen->pIn[1] : 0);` |
|   8473993 | 2224 | `				if( xCons == 0 && GenStateisLangConstruct(nKeyword) == FALSE ){` |
...
|         4 | 2235 | `				}` |
|  10047669 | 2236 | `			}else if( (pGen->pIn->nType & PH7_TK_ID) && (&pGen->pIn[1] < pGen->pEnd)` |
|    429097 | 2237 | `				&& (pGen->pIn[1].nType & PH7_TK_COLON /*':'*/) ){` |
|         - | 2238 | `				/* Label found [i.e: Out: ],point to the routine responsible of compiling it */` |
|       117 | 2239 | `				xCons = PH7_CompileLabel;` |
|        56 | 2240 | `			}` |
|  14331475 | 2241 | `			if( xCons == 0 ){` |
|         - | 2242 | `				/* Assume an expression an try to compile it */` |
|   5869391 | 2243 | `				rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   5869391 | 2244 | `				if(  rc != SXERR_EMPTY ){` |
|         - | 2245 | `					/* Pop l-value */` |
|   5869241 | 2246 | `					PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|   2934618 | 2247 | `				}` |
|   2934698 | 2248 | `			}else{` |
|         - | 2249 | `				/* Go compile the sucker */` |
|   8462089 | 2250 | `				rc = xCons(&(*pGen));` |
|         - | 2251 | `			}` |
|  14331475 | 2252 | `			if( rc == SXERR_ABORT ){` |
|         - | 2253 | `				/* Request to abort compilation */` |
|        34 | 2254 | `				break;` |
|         - | 2255 | `			}` |
|         - | 2256 | `		}` |
|         - | 2257 | `		/* Ignore trailing semi-colons ';' */` |
|  24616691 | 2258 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|  10281321 | 2259 | `			pGen->pIn++;` |
|         5 | 2260 | `		}` |
|  14335375 | 2261 | `		if( iFlags & PH7_COMPILE_SINGLE_STMT ){` |
...
|         - | 2277 | ` */` |
|     91670 | 2278 | `static sxi32 PH7_CompilePHP(` |
...
|         - | 2282 | `	)` |
|         5 | 2283 | `{` |
|     91675 | 2284 | `	SyToken *pScript = pGen->pRawIn; /* Script to compile */` |
|         - | 2285 | `	sxi32 rc;` |
|         - | 2286 | `	/* Reset the token set (and its trivia sidecar) */` |
|     91675 | 2287 | `	SySetReset(&(*pTokenSet));` |
|     91675 | 2288 | `	SySetReset(&pGen->aTrivia);` |
|         - | 2289 | `	/* Mark as the default token set */` |
|     91675 | 2290 | `	pGen->pTokenSet = &(*pTokenSet);` |
|         - | 2291 | `	/* Advance the stream cursor */` |
|     91675 | 2292 | `	pGen->pRawIn++;` |
|         - | 2293 | `	/* Tokenize the PHP chunk first */` |
|     91675 | 2294 | `	PH7_TokenizePHP(SyStringData(&pScript->sData),SyStringLength(&pScript->sData),pScript->nLine,&(*pTokenSet),&pGen->aTrivia);` |
|         - | 2295 | `	/* Point to the head and tail of the token stream. */` |
|     91675 | 2296 | `	pGen->pIn  = (SyToken *)SySetBasePtr(pTokenSet);` |
|     91675 | 2297 | `	pGen->pEnd = &pGen->pIn[SySetUsed(pTokenSet)];` |
|     91675 | 2298 | `	if( is_expr ){` |
...
|         - | 2307 | `	}` |
|     91675 | 2308 | `	if( pGen->pIn < pGen->pEnd && ( pGen->pIn->nType & PH7_TK_EQUAL ) ){` |
...
|     91673 | 2333 | `	rc = GenStateCompileChunk(pGen,0);` |
|         - | 2334 | `	/* Fix exceptions jumps */` |
|     91673 | 2335 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|         - | 2336 | `	/* Fix gotos now, the jump destination is resolved */` |
|     91673 | 2337 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),0) ){` |
|         3 | 2338 | `		rc = SXERR_ABORT;` |
|         1 | 2339 | `	}` |
|         - | 2340 | `	/* Reset container */` |
|     91673 | 2341 | `	SySetReset(&pGen->aGoto);` |
|     91673 | 2342 | `	SySetReset(&pGen->aLabel);` |
|     91673 | 2343 | `	SySetReset(&pGen->aNullsafeJmp);` |
|         - | 2344 | `	/* Compilation result */` |
|     91673 | 2345 | `	return rc;` |
|     45840 | 2346 | `}` |
|         - | 2347 | `/*` |
...
|         - | 2351 | ` */` |
|     94820 | 2352 | `PH7_PRIVATE sxi32 PH7_CompileScript(` |
...
|         - | 2367 | `	sxi32 rc;` |
|     94825 | 2368 | `	sxu32 nBaseLine = 1;` |
|     94825 | 2369 | `	if( pScript->nByte < 1 ){` |
...
|     94825 | 2376 | `	if( pScript->nByte >= 2 && pScript->zString[0]=='#' && pScript->zString[1]=='!' ){` |
...
|     94825 | 2390 | `	pCodeGen = &pVm->sCodeGen;` |
...
|     94825 | 2397 | `	pSavedIn = pCodeGen->pIn;` |
|     94825 | 2398 | `	pSavedEnd = pCodeGen->pEnd;` |
|     94825 | 2399 | `	bSavedStrict = pCodeGen->bStrictTypes;` |
|     94825 | 2400 | `	bSavedStrictLocked = pCodeGen->bStrictTypesLocked;` |
|     94825 | 2401 | `	pCodeGen->bStrictTypes = 0;` |
|     94825 | 2402 | `	pCodeGen->bStrictTypesLocked = 0;` |
|         - | 2403 | `	/* Initialize the tokens containers */` |
|     94825 | 2404 | `	SySetInit(&aRawToken,&pVm->sAllocator,sizeof(SyToken));` |
|     94825 | 2405 | `	SySetInit(&aPhpToken,&pVm->sAllocator,sizeof(SyToken));` |
|     94825 | 2406 | `	SySetAlloc(&aPhpToken,0xc0);` |
|     94825 | 2407 | `	is_expr = 0;` |
|     94825 | 2408 | `	if( iFlags & PH7_PHP_ONLY ){` |
|         - | 2409 | `		SyToken sTmp;` |
|         - | 2410 | `		/* PHP only: -*/` |
|     81815 | 2411 | `		sTmp.nLine = 1;` |
|     81815 | 2412 | `		sTmp.nType = PH7_TOKEN_PHP;` |
|     81815 | 2413 | `		sTmp.pUserData = 0;` |
|     81815 | 2414 | `		SyStringDupPtr(&sTmp.sData,pScript);` |
|     81815 | 2415 | `		SySetPut(&aRawToken,(const void *)&sTmp);` |
|     81815 | 2416 | `		if( iFlags & PH7_PHP_EXPR ){` |
|         - | 2417 | `			/* A simple PHP expression */` |
|       ! 0 | 2418 | `			is_expr = 1;` |
|       ! 0 | 2419 | `		}` |
|     40910 | 2420 | `	}else{` |
|         - | 2421 | `		/* Tokenize raw text */` |
|     13015 | 2422 | `		SySetAlloc(&aRawToken,32);` |
|     13015 | 2423 | `		PH7_TokenizeRawText(pScript->zString,pScript->nByte,&aRawToken,nBaseLine);` |
|         - | 2424 | `	}` |
|         - | 2425 | `	/* Process high-level tokens */` |
|     94825 | 2426 | `	pCodeGen->pRawIn = (SyToken *)SySetBasePtr(&aRawToken);` |
|     94825 | 2427 | `	pCodeGen->pRawEnd = &pCodeGen->pRawIn[SySetUsed(&aRawToken)];` |
|     94825 | 2428 | `	rc = PH7_OK;` |
|     94825 | 2429 | `	if( is_expr ){` |
|         - | 2430 | `		/* Compile the expression */` |
|       ! 0 | 2431 | `		rc = PH7_CompilePHP(pCodeGen,&aPhpToken,TRUE);` |
|       ! 0 | 2432 | `		goto cleanup;` |
|         - | 2433 | `	}` |
|     94825 | 2434 | `	nObjIdx = 0;` |
...
|     94825 | 2438 | `	PH7_VmEmitInstr(pVm,PH7_OP_NSSWITCH,0,0,0,0);` |
|         - | 2439 | `	/* Start the compilation process */` |
|     53920 | 2440 | `	for(;;){` |
|    199483 | 2441 | `		if( pCodeGen->pRawIn >= pCodeGen->pRawEnd ){` |
|     94793 | 2442 | `			break; /* No more tokens to process */` |
|         - | 2443 | `		}` |
|    104695 | 2444 | `		if( pCodeGen->pRawIn->nType & PH7_TOKEN_PHP ){` |
|         - | 2445 | `			/* Compile the PHP chunk */` |
|     91675 | 2446 | `			rc = PH7_CompilePHP(pCodeGen,&aPhpToken,FALSE);` |
|     91675 | 2447 | `			if( rc == SXERR_ABORT ){` |
|        36 | 2448 | `				break;` |
|         - | 2449 | `			}` |
|     91643 | 2450 | `			continue;` |
|         - | 2451 | `		}` |
|         - | 2452 | `		/* Raw chunk: [i.e: HTML, XML, etc.] */` |
|     13025 | 2453 | `		nRawObj = 0;` |
|     26045 | 2454 | `		while( (pCodeGen->pRawIn < pCodeGen->pRawEnd) && (pCodeGen->pRawIn->nType != PH7_TOKEN_PHP) ){` |
|         - | 2455 | `			/* Consume the raw chunk without any processing */` |
|     13025 | 2456 | `			pRawObj = PH7_ReserveConstObj(&(*pVm),&nObjIdx);` |
|     13025 | 2457 | `			if( pRawObj == 0 ){` |
|       ! 0 | 2458 | `				rc = SXERR_MEM;` |
|       ! 0 | 2459 | `				break;` |
|         - | 2460 | `			}` |
|         - | 2461 | `			/* Mark as constant and emit the load constant instruction */` |
|     13025 | 2462 | `			PH7_MemObjInitFromString(pVm,pRawObj,&pCodeGen->pRawIn->sData);` |
|     13025 | 2463 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_LOADC,0,nObjIdx,0,0);` |
|     13025 | 2464 | `			++nRawObj;` |
|     13025 | 2465 | `			pCodeGen->pRawIn++; /* Next chunk */` |
|         5 | 2466 | `		}` |
|     13025 | 2467 | `		if( nRawObj > 0 ){` |
|         - | 2468 | `			/* Emit the consume instruction */` |
|     13025 | 2469 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_CONSUME,nRawObj,0,0,0);` |
|      6510 | 2470 | `		}` |
|     47415 | 2471 | `	}` |
|     47410 | 2472 | `cleanup:` |
|         - | 2473 | `	/* Drop the cursor into the token set BEFORE the set is freed (see above). */` |
|     94825 | 2474 | `	pCodeGen->pIn = pSavedIn;` |
|     94825 | 2475 | `	pCodeGen->pEnd = pSavedEnd;` |
|     94825 | 2476 | `	SySetRelease(&aRawToken);` |
|     94825 | 2477 | `	SySetRelease(&aPhpToken);` |
|         - | 2478 | `	/* Restore outer file's strict_types scope */` |
|     94825 | 2479 | `	pCodeGen->bStrictTypes = bSavedStrict;` |
|     94825 | 2480 | `	pCodeGen->bStrictTypesLocked = bSavedStrictLocked;` |
|     94825 | 2481 | `	return rc;` |
|     47415 | 2482 | `}` |
|         - | 2483 | `/*` |
|         - | 2484 | ` * Utility routines.Initialize the code generator.` |
|         - | 2485 | ` */` |
|      3890 | 2486 | `PH7_PRIVATE sxi32 PH7_InitCodeGenerator(` |
|         - | 2487 | `	ph7_vm *pVm,       /* Target VM */` |
|         - | 2488 | `	ProcConsumer xErr, /* Error log consumer callabck  */` |
|         - | 2489 | `	void *pErrData     /* Last argument to xErr() */` |
|         - | 2490 | `	)` |
|         5 | 2491 | `{` |
|      3895 | 2492 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|         - | 2493 | `	/* Zero the structure */` |
|      3895 | 2494 | `	SyZero(pGen,sizeof(ph7_gen_state));` |
|         - | 2495 | `	/* Initial state */` |
|      3895 | 2496 | `	pGen->pVm  = &(*pVm);` |
|      3895 | 2497 | `	pGen->xErr = xErr;` |
|      3895 | 2498 | `	pGen->pErrData = pErrData;` |
|      3895 | 2499 | `	SySetInit(&pGen->aLabel,&pVm->sAllocator,sizeof(Label));` |
|      3895 | 2500 | `	SySetInit(&pGen->aGoto,&pVm->sAllocator,sizeof(JumpFixup));` |
|      3895 | 2501 | `	SySetInit(&pGen->aLoopParent,&pVm->sAllocator,sizeof(sxu32));` |
|      3895 | 2502 | `	pGen->nLoopId = pGen->nCurLoopId = 0;` |
|      3895 | 2503 | `	SySetInit(&pGen->aNullsafeJmp,&pVm->sAllocator,sizeof(sxu32));` |
|      3895 | 2504 | `	SySetInit(&pGen->aTrivia,&pVm->sAllocator,sizeof(ph7_trivia));` |
|      3895 | 2505 | `	SySetInit(&pGen->aPendingAttrs,&pVm->sAllocator,sizeof(ph7_trivia));` |
|      3895 | 2506 | `	SyHashInit(&pGen->hLiteral,&pVm->sAllocator,0,0);` |
|      3895 | 2507 | `	SyHashInit(&pGen->hVar,&pVm->sAllocator,0,0);` |
|         - | 2508 | `	/* Error log buffer */` |
|      3895 | 2509 | `	SyBlobInit(&pGen->sErrBuf,&pVm->sAllocator);` |
|         - | 2510 | `	/* General purpose working buffer */` |
|      3895 | 2511 | `	SyBlobInit(&pGen->sWorker,&pVm->sAllocator);` |
|         - | 2512 | `	/* Namespace state */` |
|      3895 | 2513 | `	SyBlobInit(&pGen->sNamespace,&pVm->sAllocator);` |
|      3895 | 2514 | `	SyHashInit(&pGen->hUseImports,&pVm->sAllocator,0,0);` |
|      3895 | 2515 | `	SyHashInit(&pGen->hUseFuncImports,&pVm->sAllocator,0,0);` |
|      3895 | 2516 | `	SyHashInit(&pGen->hUseConstImports,&pVm->sAllocator,0,0);` |
|         - | 2517 | `	/* Create the global scope */` |
|      3895 | 2518 | `	GenStateInitBlock(pGen,&pGen->sGlobal,GEN_BLOCK_GLOBAL,PH7_VmInstrLength(&(*pVm)),0);` |
|         - | 2519 | `	/* Point to the global scope */` |
|      3895 | 2520 | `	pGen->pCurrent = &pGen->sGlobal;` |
|      3895 | 2521 | `	return SXRET_OK;` |
|         5 | 2522 | `}` |
|         - | 2523 | `/*` |
|         - | 2524 | ` * Utility routines. Reset the code generator to it's initial state.` |
|         - | 2525 | ` */` |
|     98238 | 2526 | `PH7_PRIVATE sxi32 PH7_ResetCodeGenerator(` |
|         - | 2527 | `	ph7_vm *pVm,       /* Target VM */` |
|         - | 2528 | `	ProcConsumer xErr, /* Error log consumer callabck  */` |
|         - | 2529 | `	void *pErrData     /* Last argument to xErr() */` |
|         - | 2530 | `	)` |
|         5 | 2531 | `{` |
|     98243 | 2532 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|         - | 2533 | `	GenBlock *pBlock,*pParent;` |
|         - | 2534 | `	/* Reset state */` |
|     98243 | 2535 | `	SySetReset(&pGen->aLabel);` |
|     98243 | 2536 | `	SySetReset(&pGen->aGoto);` |
|     98243 | 2537 | `	SySetReset(&pGen->aNullsafeJmp);` |
|     98243 | 2538 | `	SySetReset(&pGen->aTrivia);` |
|     98243 | 2539 | `	SySetReset(&pGen->aPendingAttrs);` |
|     98243 | 2540 | `	SyStringInitFromBuf(&pGen->sPendingDoc,0,0);` |
|     98243 | 2541 | `	SyBlobRelease(&pGen->sErrBuf);` |
|     98243 | 2542 | `	SyBlobRelease(&pGen->sWorker);` |
|     98243 | 2543 | `	SyBlobRelease(&pGen->sNamespace);` |
|     98243 | 2544 | `	SyBlobInit(&pGen->sNamespace,&pVm->sAllocator);` |
|     98243 | 2545 | `	SyHashRelease(&pGen->hUseImports);` |
|     98243 | 2546 | `	SyHashInit(&pGen->hUseImports,&pVm->sAllocator,0,0);` |
|     98243 | 2547 | `	SyHashRelease(&pGen->hUseFuncImports);` |
|     98243 | 2548 | `	SyHashInit(&pGen->hUseFuncImports,&pVm->sAllocator,0,0);` |
|     98243 | 2549 | `	SyHashRelease(&pGen->hUseConstImports);` |
|     98243 | 2550 | `	SyHashInit(&pGen->hUseConstImports,&pVm->sAllocator,0,0);` |
...
|     98243 | 2558 | `	pBlock = pGen->pCurrent;` |
|     98243 | 2559 | `	while( pBlock->pParent != 0 ){` |
|       ! 0 | 2560 | `		pParent = pBlock->pParent;` |
|       ! 0 | 2561 | `		GenStateFreeBlock(pBlock);` |
|       ! 0 | 2562 | `		pBlock = pParent;` |
|       ! 0 | 2563 | `	}` |
|     98243 | 2564 | `	pGen->xErr = xErr;` |
|     98243 | 2565 | `	pGen->pErrData = pErrData;` |
|     98243 | 2566 | `	pGen->pCurrent = &pGen->sGlobal;` |
|     98243 | 2567 | `	pGen->pRawIn = pGen->pRawEnd = 0;` |
|     98243 | 2568 | `	pGen->pIn = pGen->pEnd = 0;` |
|     98243 | 2569 | `	pGen->nErr = 0;` |
|     98243 | 2570 | `	return SXRET_OK;` |
|         5 | 2571 | `}` |
|         - | 2572 | `/*` |
