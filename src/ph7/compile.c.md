...
|        - |   136 | ` */` |
|    70058 |   137 | `static GenBlock * GenStateFetchBlock(GenBlock *pCurrent,sxi32 iBlockType,sxi32 iCount)` |
|        5 |   138 | `{` |
|    70063 |   139 | `	GenBlock *pBlock = pCurrent;` |
|   159190 |   140 | `	for(;;){` |
|   318385 |   141 | `		if( pBlock->iFlags & iBlockType ){` |
|    69955 |   142 | `			iCount--; /* Decrement nesting level */` |
|    69955 |   143 | `			if( iCount < 1 ){` |
|        - |   144 | `				/* Block meet with the desired criteria */` |
|    69929 |   145 | `				return pBlock;` |
|        - |   146 | `			}` |
|       13 |   147 | `		}` |
|        - |   148 | `		/* Point to the upper block */` |
|   248461 |   149 | `		pBlock = pBlock->pParent;` |
|   248461 |   150 | `		if( pBlock == 0 \|\| (pBlock->iFlags & (GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC)) ){` |
|        - |   151 | `			/* Forbidden */` |
|       72 |   152 | `			break;` |
|        - |   153 | `		}` |
|        5 |   154 | `	}` |
...
|        - |   160 | ` */` |
|  6888744 |   161 | `static void GenStateInitBlock(` |
...
|  6888749 |   170 | `	pBlock->nFirstInstr = nFirstInstr;` |
|  6888749 |   171 | `	pBlock->pUserData   = pUserData;` |
|  6888749 |   172 | `	pBlock->pGen        = pGen;` |
|  6888749 |   173 | `	pBlock->iFlags      = iType;` |
|  6888749 |   174 | `	pBlock->pParent     = 0;` |
|  6888749 |   175 | `	SySetInit(&pBlock->aJumpFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  6888749 |   176 | `	SySetInit(&pBlock->aPostContFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  6888749 |   177 | `}` |
|        - |   178 | `/*` |
...
|        - |   183 | ` */` |
|  6884868 |   184 | `static sxi32 GenStateEnterBlock(` |
...
|  6884873 |   194 | `	pBlock = (GenBlock *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(GenBlock));` |
|  6884873 |   195 | `	if( pBlock == 0 ){` |
...
|  6884873 |   204 | `	SyZero(pBlock,sizeof(GenBlock));` |
|  6884873 |   205 | `	GenStateInitBlock(&(*pGen),pBlock,iType,nFirstInstr,pUserData);` |
|        - |   206 | `	/* Link to the parent block */` |
|  6884873 |   207 | `	pBlock->pParent = pGen->pCurrent;` |
|        - |   208 | `	/* Mark as the current block */` |
|  6884873 |   209 | `	pGen->pCurrent = pBlock;` |
|  6884873 |   210 | `	if( ppBlock ){` |
|        - |   211 | `		/* Write a pointer to the new instance */` |
|  3289959 |   212 | `		*ppBlock = pBlock;` |
|  1644977 |   213 | `	}` |
|  6884873 |   214 | `	return SXRET_OK;` |
|  3442439 |   215 | `}` |
|        - |   216 | `/*` |
|        - |   217 | ` * Release block fields without freeing the whole instance.` |
|        - |   218 | ` */` |
|  6884852 |   219 | `static void GenStateReleaseBlock(GenBlock *pBlock)` |
|        5 |   220 | `{` |
|  6884857 |   221 | `	SySetRelease(&pBlock->aPostContFix);` |
|  6884857 |   222 | `	SySetRelease(&pBlock->aJumpFix);` |
|  6884857 |   223 | `}` |
|        - |   224 | `/*` |
|        - |   225 | ` * Release a block.` |
|        - |   226 | ` */` |
|  6884852 |   227 | `static void GenStateFreeBlock(GenBlock *pBlock)` |
|        5 |   228 | `{` |
|  6884857 |   229 | `	ph7_gen_state *pGen = pBlock->pGen;` |
|  6884857 |   230 | `	GenStateReleaseBlock(&(*pBlock));` |
|        - |   231 | `	/* Free the instance */` |
|  6884857 |   232 | `	SyMemBackendPoolFree(&pGen->pVm->sAllocator,pBlock);` |
|  6884857 |   233 | `}` |
|        - |   234 | `/*` |
|        - |   235 | ` * POP and release a block from the stack of compiled blocks.` |
|        - |   236 | ` */` |
|  6884852 |   237 | `static sxi32 GenStateLeaveBlock(ph7_gen_state *pGen,GenBlock **ppBlock)` |
|        5 |   238 | `{` |
|  6884857 |   239 | `	GenBlock *pBlock = pGen->pCurrent;` |
|  6884857 |   240 | `	if( pBlock == 0 ){` |
|        - |   241 | `		/* No more block to pop */` |
|      ! 0 |   242 | `		return SXERR_EMPTY;` |
|        - |   243 | `	}` |
|        - |   244 | `	/* Point to the upper block */` |
|  6884857 |   245 | `	pGen->pCurrent = pBlock->pParent;` |
|  6884857 |   246 | `	if( ppBlock ){` |
|        - |   247 | `		/* Write a pointer to the popped block */` |
|      ! 0 |   248 | `		*ppBlock = pBlock;` |
|      ! 0 |   249 | `	}else{` |
|        - |   250 | `		/* Safely release the block */` |
|  6884857 |   251 | `		GenStateFreeBlock(&(*pBlock));` |
|        - |   252 | `	}` |
|  6884857 |   253 | `	return SXRET_OK;` |
|  3442431 |   254 | `}` |
|        - |   255 | `/*` |
...
|        - |   264 | ` */` |
|  2634710 |   265 | `static sxi32 GenStateNewJumpFixup(GenBlock *pBlock,sxi32 nJumpType,sxu32 nInstrIdx)` |
|        5 |   266 | `{` |
|        - |   267 | `	JumpFixup sJumpFix;` |
|        - |   268 | `	sxi32 rc;` |
|        - |   269 | `	/* Init the JumpFixup structure */` |
|  2634715 |   270 | `	sJumpFix.nJumpType = nJumpType;` |
|  2634715 |   271 | `	sJumpFix.nInstrIdx = nInstrIdx;` |
|        - |   272 | `	/* Insert in the jump fixup table */` |
|  2634715 |   273 | `	rc = SySetPut(&pBlock->aJumpFix,(const void *)&sJumpFix);` |
|  2634715 |   274 | `	return rc;` |
|        5 |   275 | `}` |
|        - |   276 | `/*` |
...
|        - |   286 | ` */` |
|  4845930 |   287 | `static sxu32 GenStateFixJumps(GenBlock *pBlock,sxi32 nJumpType,sxu32 nJumpDest)` |
|        5 |   288 | `{` |
|        - |   289 | `	JumpFixup *aFix;` |
|        - |   290 | `	VmInstr *pInstr;` |
|        - |   291 | `	sxu32 nFixed;` |
...
|  4845935 |   294 | `	aFix = (JumpFixup *)SySetBasePtr(&pBlock->aJumpFix);` |
|        - |   295 | `	/* Fix the desired jumps */` |
| 10923859 |   296 | `	for( nFixed = n = 0 ; n < SySetUsed(&pBlock->aJumpFix) ; ++n ){` |
|  6077929 |   297 | `		if( aFix[n].nJumpType < 0 ){` |
|        - |   298 | `			/* Already fixed */` |
|  2322203 |   299 | `			continue;` |
|        - |   300 | `		}` |
|  3755731 |   301 | `		if( nJumpType > 0 && aFix[n].nJumpType != nJumpType ){` |
|        - |   302 | `			/* Not of our interest */` |
|  1121023 |   303 | `			continue;` |
|        - |   304 | `		}` |
|        - |   305 | `		/* Point to the instruction to fix */` |
|  2634713 |   306 | `		pInstr = PH7_VmGetInstr(pBlock->pGen->pVm,aFix[n].nInstrIdx);` |
|  2634713 |   307 | `		if( pInstr ){` |
|  2634713 |   308 | `			pInstr->iP2 = nJumpDest;` |
|  2634713 |   309 | `			nFixed++;` |
|        - |   310 | `			/* Mark as fixed */` |
|  2634713 |   311 | `			aFix[n].nJumpType = -1;` |
|  1317354 |   312 | `		}` |
|  1317359 |   313 | `	}` |
|        - |   314 | `	/* Total number of fixed jumps */` |
|  4845935 |   315 | `	return nFixed;` |
|        5 |   316 | `}` |
|        - |   317 | `/*` |
...
|        - |   323 | ` */` |
|  1742836 |   324 | `static sxi32 GenStateFixGoto(ph7_gen_state *pGen,sxu32 nOfft)` |
|        5 |   325 | `{` |
...
|  1742841 |   332 | `	aJumps = (JumpFixup *)SySetBasePtr(&pGen->aGoto);` |
|        - |   333 | `	/* Fix */` |
|  1742987 |   334 | `	for( n = nOfft ; n < SySetUsed(&pGen->aGoto) ; ++n ){` |
...
|       46 |   357 | `		}` |
|       50 |   358 | `	}` |
|  1742839 |   359 | `	aLabel = (Label *)SySetBasePtr(&pGen->aLabel);` |
|  1742971 |   360 | `	for( n = 0 ; n < SySetUsed(&pGen->aLabel) ; ++n ){` |
...
|       12 |   365 | `		}` |
|       71 |   366 | `	}` |
|  1742839 |   367 | `	return SXRET_OK;` |
|   871423 |   368 | `}` |
|        - |   369 | `/*` |
|        - |   370 | ` * Check if a given token value is installed in the literal table.` |
|        - |   371 | ` */` |
|  9166186 |   372 | `static sxi32 GenStateFindLiteral(ph7_gen_state *pGen,const SyString *pValue,sxu32 *pIdx)` |
|        5 |   373 | `{` |
|        - |   374 | `	SyHashEntry *pEntry;` |
|  9166191 |   375 | `	pEntry = SyHashGet(&pGen->hLiteral,(const void *)pValue->zString,pValue->nByte);` |
|  9166191 |   376 | `	if( pEntry == 0 ){` |
|  2492561 |   377 | `		return SXERR_NOTFOUND;` |
|        - |   378 | `	}` |
|  6673635 |   379 | `	*pIdx = (sxu32)SX_PTR_TO_INT(pEntry->pUserData);` |
|  6673635 |   380 | `	return SXRET_OK;` |
|  4583098 |   381 | `}` |
|        - |   382 | `/*` |
...
|        - |   391 | ` */` |
|  2492556 |   392 | `static sxi32 GenStateInstallLiteral(ph7_gen_state *pGen,ph7_value *pObj,sxu32 nIdx)` |
|        5 |   393 | `{` |
|  2492561 |   394 | `	if( SyBlobLength(&pObj->sBlob) > 0 ){` |
|  2492561 |   395 | `		SyHashInsert(&pGen->hLiteral,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob),SX_INT_TO_PTR(nIdx));` |
|  1246278 |   396 | `	}` |
|  2492561 |   397 | `	return SXRET_OK;` |
|        5 |   398 | `}` |
|        - |   399 | `/*` |
|        - |   400 | ` * Reserve a room for a numeric constant [i.e: 64-bit integer or real number]` |
|        - |   401 | ` * in the constant table.` |
|        - |   402 | ` */` |
|  1793596 |   403 | `static ph7_value * GenStateInstallNumLiteral(ph7_gen_state *pGen,sxu32 *pIdx)` |
|        5 |   404 | `{` |
|        - |   405 | `	ph7_value *pObj;` |
|  1793601 |   406 | `	sxu32 nIdx = 0; /* cc warning */` |
|        - |   407 | `	/* Reserve a new constant */` |
|  1793601 |   408 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  1793601 |   409 | `	if( pObj == 0 ){` |
|      ! 0 |   410 | `		PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|      ! 0 |   411 | `		return 0;` |
|        - |   412 | `	}` |
|  1793601 |   413 | `	*pIdx = nIdx;` |
|        - |   414 | `	/* TODO(chems): Create a numeric table (64bit int keys) same as` |
|        - |   415 | `	 * the constant string iterals table [optimization purposes].` |
|        - |   416 | `	 */` |
|  1793601 |   417 | `	return pObj;` |
|   896803 |   418 | `}` |
|        - |   419 | `/*` |
...
|        - |   432 | ` */` |
|  4382730 |   433 | `static void *GenStateAttachStrictFlag(ph7_gen_state *pGen, void *p3)` |
|        5 |   434 | `{` |
|        - |   435 | `	VmCallArgMap *pMap;` |
|  4382735 |   436 | `	if( !pGen->bStrictTypes ) return p3;` |
|       39 |   437 | `	if( p3 == 0 ){` |
...
|        - |   508 | ` */` |
|  1794590 |   509 | `static int GenStateFindBadNumericSeparator(` |
|        - |   510 | `	const SyString *pRaw, const char **pBadStart, sxu32 *pBadLen)` |
|        5 |   511 | `{` |
|  1794595 |   512 | `	const char *z = pRaw->zString;` |
|  1794595 |   513 | `	sxu32 n = pRaw->nByte;` |
|  1794595 |   514 | `	int base = 10;` |
|        - |   515 | `	sxu32 i, start;` |
|  1794595 |   516 | `	if( n < 2 ) return 0;` |
|   434481 |   517 | `	if( z[0] == '0' && (z[1] == 'x' \|\| z[1] == 'X') ){` |
|       80 |   518 | `		base = 16;` |
|   434442 |   519 | `	}else if( z[0] == '0' && (z[1] == 'b' \|\| z[1] == 'B') ){` |
|      284 |   520 | `		base = 2;` |
|      141 |   521 | `	}` |
|  1459583 |   522 | `	for( i = 0; i < n; ++i ){` |
|  1025121 |   523 | `		if( z[i] != '_' ) continue;` |
...
|        - |   549 | ` */` |
|  1794590 |   550 | `static sxi32 GenStateValidateNumericSeparator(ph7_gen_state *pGen, SyToken *pToken)` |
|        5 |   551 | `{` |
|  1794595 |   552 | `	const char *zBad = 0;` |
|  1794595 |   553 | `	sxu32 nBad = 0;` |
|        - |   554 | `	SyString sBad;` |
|        - |   555 | `	sxi32 rc;` |
|  1794595 |   556 | `	if( !GenStateFindBadNumericSeparator(&pToken->sData, &zBad, &nBad) ){` |
|  1794581 |   557 | `		return SXRET_OK;` |
|        - |   558 | `	}` |
...
|        - |   582 | ` */` |
|  1794576 |   583 | `static sxi32 GenStateStripNumericSeparators(` |
...
|        5 |   588 | `{` |
|        - |   589 | `	sxu32 i, j;` |
|  1794581 |   590 | `	int hasUnderscore = 0;` |
|        - |   591 | `	char *zBuf;` |
|  1794581 |   592 | `	*pzAlloc = 0;` |
|  4177731 |   593 | `	for( i = 0; i < pToken->nByte; ++i ){` |
|  2383407 |   594 | `		if( pToken->zString[i] == '_' ){ hasUnderscore = 1; break; }` |
|  1191580 |   595 | `	}` |
|  1794581 |   596 | `	if( !hasUnderscore ){` |
|  1794329 |   597 | `		SyStringDupPtr(pOut, pToken);` |
|  1794329 |   598 | `		return SXRET_OK;` |
|        - |   599 | `	}` |
...
|        - |   650 | ` */` |
|  1793630 |   651 | `static int GenStateIntLiteralOverflows(const SyString *pNum, ph7_real *pReal, int *pbDecimal)` |
|        5 |   652 | `{` |
|  1793635 |   653 | `	const char *z = pNum->zString;` |
|  1793635 |   654 | `	const char *zEnd = z + pNum->nByte;` |
|        - |   655 | `	const char *p, *q;` |
|        - |   656 | `	int n;` |
|  1793635 |   657 | `	*pbDecimal = FALSE;` |
|  1793635 |   658 | `	if( z >= zEnd ){` |
|      ! 0 |   659 | `		return FALSE;` |
|        - |   660 | `	}` |
|  1793635 |   661 | `	if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'x' \|\| z[1] == 'X') ){` |
...
|        - |   674 | `		}` |
|        7 |   675 | `		return TRUE;` |
|  1793559 |   676 | `	}else if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'b' \|\| z[1] == 'B') ){` |
...
|   575873 |   695 | `		p = z;` |
|  1151743 |   696 | `		while( p < zEnd && p[0] == '0' ){ p++; }` |
|   576101 |   697 | `		for( q = p, n = 0; q < zEnd && q[0] >= '0' && q[0] <= '7'; q++ ){ n++; }` |
|   575873 |   698 | `		if( n <= 21 ){` |
|   575871 |   699 | `			return FALSE;` |
|        - |   700 | `		}` |
|        3 |   701 | `		{ ph7_real dv = 0;` |
...
|  1217411 |   712 | `	p = z;` |
|  1217411 |   713 | `	while( p < zEnd && p[0] == '0' ){ p++; }` |
|  3018211 |   714 | `	for( q = p, n = 0; q < zEnd && (unsigned char)q[0] < 0xc0 && SyisDigit(q[0]); q++ ){ n++; }` |
|  1217411 |   715 | `	if( n > 19 \|\| (n == 19 && SyMemcmp(p, "9223372036854775807", 19) > 0) ){` |
|       25 |   716 | `		*pbDecimal = TRUE;` |
|       25 |   717 | `		return TRUE;` |
|        - |   718 | `	}` |
|  1217387 |   719 | `	return FALSE;` |
|   896820 |   720 | `}` |
|  1794562 |   721 | `static sxi32 PH7_CompileNumLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |   722 | `{` |
|  1794567 |   723 | `	SyToken *pToken = pGen->pIn; /* Raw token */` |
|  1794567 |   724 | `	sxu32 nIdx = 0;` |
|        - |   725 | `	char zScratch[GEN_NUM_SCRATCH];` |
|  1794567 |   726 | `	char *zAlloc = 0;` |
|        - |   727 | `	SyString sNum;` |
|        - |   728 | `	sxi32 rc;` |
|   897281 |   729 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|  1794567 |   730 | `	rc = GenStateValidateNumericSeparator(pGen, pToken);` |
|  1794567 |   731 | `	if( rc != SXRET_OK ){` |
|       14 |   732 | `		return rc;` |
|        - |   733 | `	}` |
|  2691833 |   734 | `	rc = GenStateStripNumericSeparators(&pGen->pVm->sAllocator, &pToken->sData,` |
|   897276 |   735 | `		zScratch, sizeof(zScratch), &sNum, &zAlloc);` |
|  1794557 |   736 | `	if( rc != SXRET_OK ){` |
|      ! 0 |   737 | `		return SXERR_ABORT;` |
|        - |   738 | `	}` |
|  1794557 |   739 | `	if( pToken->nType & PH7_TK_INTEGER ){` |
|        - |   740 | `		ph7_value *pObj;` |
|        - |   741 | `		sxi64 iValue;` |
|  1793635 |   742 | `		ph7_real rOverflow = 0;` |
|  1793635 |   743 | `		int bDecimalOverflow = 0;` |
|  1793635 |   744 | `		if( GenStateIntLiteralOverflows(&sNum,&rOverflow,&bDecimalOverflow) ){` |
...
|        - |   759 | `			}` |
|       18 |   760 | `		}else{` |
|  1793601 |   761 | `			iValue = PH7_TokenValueToInt64(&sNum);` |
|  1793601 |   762 | `			pObj = GenStateInstallNumLiteral(&(*pGen),&nIdx);` |
|  1793601 |   763 | `			if( pObj == 0 ){` |
|      ! 0 |   764 | `				if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|      ! 0 |   765 | `				return SXERR_ABORT;` |
|        - |   766 | `			}` |
|  1793601 |   767 | `			PH7_MemObjInitFromInt(pGen->pVm,pObj,iValue);` |
|        - |   768 | `		}` |
|   896820 |   769 | `	}else{` |
|        - |   770 | `		/* Real number */` |
|        - |   771 | `		ph7_value *pObj;` |
...
|        - |   781 | `	}` |
|  1794557 |   782 | `	if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|        - |   783 | `	/* Emit the load constant instruction */` |
|  1794557 |   784 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|        - |   785 | `	/* Node successfully compiled */` |
|  1794557 |   786 | `	return SXRET_OK;` |
|   897286 |   787 | `}` |
|        - |   788 | `/*` |
...
|        - |   797 | ` *` |
|        - |   798 | ` */` |
|  3617632 |   799 | `PH7_PRIVATE sxi32 PH7_CompileSimpleString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |   800 | `{` |
|  3617637 |   801 | `	SyString *pStr = &pGen->pIn->sData; /* Constant string literal */` |
|        - |   802 | `	const char *zIn,*zCur,*zEnd;` |
|        - |   803 | `	ph7_value *pObj;` |
|        - |   804 | `	sxu32 nIdx;` |
|  3617637 |   805 | `	nIdx = 0; /* Prevent compiler warning */` |
|        - |   806 | `	/* Delimit the string */` |
|  3617637 |   807 | `	zIn  = pStr->zString;` |
|  3617637 |   808 | `	zEnd = &zIn[pStr->nByte];` |
|  3617637 |   809 | `	if( zIn >= zEnd ){` |
|        - |   810 | `		/* Empty string constant: just use the pre‑allocated index from the VM` |
|        - |   811 | `		 * rather than reserving a new object each time. */` |
|   147489 |   812 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,pGen->pVm->nEmptyStringIdx,0,0);` |
|   147489 |   813 | `		return SXRET_OK;` |
|        - |   814 | `	}` |
|  3470153 |   815 | `	if( SXRET_OK == GenStateFindLiteral(&(*pGen),pStr,&nIdx) ){` |
|        - |   816 | `		/* Already processed,emit the load constant instruction` |
|        - |   817 | `		 * and return.` |
|        - |   818 | `		 */` |
|  2159635 |   819 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|  2159635 |   820 | `		return SXRET_OK;` |
|        - |   821 | `	}` |
|        - |   822 | `	/* Reserve a new constant */` |
|  1310523 |   823 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  1310523 |   824 | `	if( pObj == 0 ){` |
...
|        - |   828 | `	}` |
|  1310523 |   829 | `	PH7_MemObjInitFromString(pGen->pVm,pObj,0);` |
|        - |   830 | `	/* Compile the node */` |
|  1353214 |   831 | `	for(;;){` |
|  2706433 |   832 | `		if( zIn >= zEnd ){` |
|        - |   833 | `			/* End of input */` |
|  1310523 |   834 | `			break;` |
|        - |   835 | `		}` |
|  1395915 |   836 | `		zCur = zIn;` |
| 23680679 |   837 | `		while( zIn < zEnd && zIn[0] != '\\' ){` |
| 22284769 |   838 | `			zIn++;` |
|        5 |   839 | `		}` |
|  1395915 |   840 | `		if( zIn > zCur ){` |
|        - |   841 | `			/* Append raw contents*/` |
|  1357129 |   842 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|   678562 |   843 | `		}` |
|  1395915 |   844 | `		zIn++;` |
|  1395915 |   845 | `		if( zIn < zEnd ){` |
|   120303 |   846 | `			if( zIn[0] == '\\' ){` |
...
|  1310523 |   863 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|  1310523 |   864 | `	if( pStr->nByte < 1024 ){` |
|        - |   865 | `		/* Install in the literal table */` |
|  1310523 |   866 | `		GenStateInstallLiteral(pGen,pObj,nIdx);` |
|   655259 |   867 | `	}` |
|        - |   868 | `	/* Node successfully compiled */` |
|  1310523 |   869 | `	return SXRET_OK;` |
|  1808821 |   870 | `}` |
|        - |   871 | `/*` |
...
|        - |  1035 | ` */` |
|     2486 |  1036 | `static sxi32 GenStateProcessStringExpression(` |
...
|     2491 |  1047 | `	SySetInit(&sToken,&pGen->pVm->sAllocator,sizeof(SyToken));` |
|        - |  1048 | `	/* Preallocate some slots */` |
|     2491 |  1049 | `	SySetAlloc(&sToken,0x08);` |
|        - |  1050 | `	/* Tokenize the text */` |
|     2491 |  1051 | `	PH7_TokenizePHP(zIn,(sxu32)(zEnd-zIn),nLine,&sToken,0);` |
|        - |  1052 | `	/* Swap delimiter */` |
|     2491 |  1053 | `	pTmpIn  = pGen->pIn;` |
|     2491 |  1054 | `	pTmpEnd = pGen->pEnd;` |
|     2491 |  1055 | `	pGen->pIn = (SyToken *)SySetBasePtr(&sToken);` |
|     2491 |  1056 | `	pGen->pEnd = &pGen->pIn[SySetUsed(&sToken)];` |
|        - |  1057 | `	/* Compile the expression */` |
|     2491 |  1058 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|        - |  1059 | `	/* Restore token stream */` |
|     2491 |  1060 | `	pGen->pIn  = pTmpIn;` |
|     2491 |  1061 | `	pGen->pEnd = pTmpEnd;` |
|        - |  1062 | `	/* Release the token set */` |
|     2491 |  1063 | `	SySetRelease(&sToken);` |
...
|        - |  1069 | ` */` |
|    46962 |  1070 | `static ph7_value * GenStateNewStrObj(ph7_gen_state *pGen,sxi32 *pCount)` |
|        5 |  1071 | `{` |
|        - |  1072 | `	ph7_value *pConstObj;` |
|    46967 |  1073 | `	sxu32 nIdx = 0;` |
|        - |  1074 | `	/* Reserve a new constant */` |
|    46967 |  1075 | `	pConstObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|    46967 |  1076 | `	if( pConstObj == 0 ){` |
|      ! 0 |  1077 | `		PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"PH7 engine is running out of memory");` |
|      ! 0 |  1078 | `		return 0;` |
|        - |  1079 | `	}` |
|    46967 |  1080 | `	(*pCount)++;` |
|    46967 |  1081 | `	PH7_MemObjInitFromString(pGen->pVm,pConstObj,0);` |
|        - |  1082 | `	/* Emit the load constant instruction */` |
|    46967 |  1083 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|    46967 |  1084 | `	return pConstObj;` |
|    23486 |  1085 | `}` |
|        - |  1086 | `/*` |
...
|    45430 |  1148 | `static sxi32 GenStateCompileString(ph7_gen_state *pGen,int bHeredoc)` |
|        5 |  1149 | `{` |
|    45435 |  1150 | `	SyString *pStr = &pGen->pIn->sData; /* Raw token value */` |
|        - |  1151 | `	const char *zIn,*zCur,*zEnd;` |
|    45435 |  1152 | `	ph7_value *pObj = 0;` |
|        - |  1153 | `	sxi32 iCons;` |
|        - |  1154 | `	sxi32 rc;` |
|        - |  1155 | `	/* Delimit the string */` |
|    45435 |  1156 | `	zIn  = pStr->zString;` |
|    45435 |  1157 | `	zEnd = &zIn[pStr->nByte];` |
|    45435 |  1158 | `	if( zIn >= zEnd ){` |
...
|    23772 |  1169 | `	for(;;){` |
|    79567 |  1170 | `		zCur = zIn;` |
|   233107 |  1171 | `		while( zIn < zEnd && zIn[0] != '\\'  ){` |
|   156031 |  1172 | `			if( zIn[0] == '{' && &zIn[1] < zEnd && zIn[1] == '$' ){` |
|       72 |  1173 | `				break;` |
|   155897 |  1174 | `			}else if(zIn[0] == '$' && &zIn[1] < zEnd &&` |
|     2356 |  1175 | `				(((unsigned char)zIn[1] >= 0xc0 \|\| SyisAlpha(zIn[1]) \|\| zIn[1] == '{' \|\| zIn[1] == '_')) ){` |
|     1179 |  1176 | `					break;` |
|        - |  1177 | `			}` |
|   153545 |  1178 | `			zIn++;` |
|        5 |  1179 | `		}` |
|    79567 |  1180 | `		if( zIn > zCur ){` |
|    20729 |  1181 | `			if( pObj == 0 ){` |
|    20205 |  1182 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|    20205 |  1183 | `				if( pObj == 0 ){` |
|      ! 0 |  1184 | `					return SXERR_ABORT;` |
|        - |  1185 | `				}` |
|    10100 |  1186 | `			}` |
|    20729 |  1187 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|    10362 |  1188 | `		}` |
|    79567 |  1189 | `		if( zIn >= zEnd ){` |
|    45061 |  1190 | `			break;` |
|        - |  1191 | `		}` |
|    34511 |  1192 | `		if( zIn[0] == '\\' ){` |
|    32025 |  1193 | `			const char *zPtr = 0;` |
|        - |  1194 | `			sxu32 n;` |
|    32025 |  1195 | `			zIn++;` |
|    32025 |  1196 | `			if( pObj == 0 ){` |
|    26767 |  1197 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|    26767 |  1198 | `				if( pObj == 0 ){` |
|      ! 0 |  1199 | `					return SXERR_ABORT;` |
|        - |  1200 | `				}` |
|    13381 |  1201 | `			}` |
|    32025 |  1202 | `			if( zIn >= zEnd ){` |
|        - |  1203 | `				/* Lone backslash at the very end of the body: php keeps it */` |
|        3 |  1204 | `				PH7_MemObjStringAppend(pObj,"\\",sizeof(char));` |
|        3 |  1205 | `				break;` |
|        - |  1206 | `			}` |
|    32023 |  1207 | `			n = sizeof(char); /* size of conversion */` |
|    32023 |  1208 | `			switch( zIn[0] ){` |
|       11 |  1209 | `			case '$':` |
|        - |  1210 | `				/* Dollar sign */` |
...
|    27053 |  1227 | `				PH7_MemObjStringAppend(pObj,"\n",sizeof(char));` |
|    27053 |  1228 | `				break;` |
|       21 |  1229 | `			case 'r':` |
...
|       72 |  1386 | `		}else{` |
|        - |  1387 | `			/* Simple syntax */` |
|     2353 |  1388 | `			const char *zExpr = zIn;` |
|        - |  1389 | `			/* Assemble variable name */` |
|     1199 |  1390 | `			for(;;){` |
|        - |  1391 | `				/* Jump leading dollars */` |
|     4751 |  1392 | `				while( zIn < zEnd && zIn[0] == '$' ){` |
|     2353 |  1393 | `					zIn++;` |
|        5 |  1394 | `				}` |
|     1199 |  1395 | `				for(;;){` |
|    12622 |  1396 | `					while( zIn < zEnd && (unsigned char)zIn[0] < 0xc0 && (SyisAlphaNum(zIn[0]) \|\| zIn[0] == '_' ) ){` |
|     9025 |  1397 | `						zIn++;` |
|        5 |  1398 | `					}` |
|     2403 |  1399 | `					if((unsigned char)zIn[0] >= 0xc0 ){` |
|        - |  1400 | `						/* UTF-8 stream */` |
|      ! 0 |  1401 | `						zIn++;` |
...
|        1 |  1446 | `					}` |
|        6 |  1447 | `					break;` |
|     2141 |  1448 | `				}else if( zIn[0] == '-' && &zIn[1] < zEnd && zIn[1] == '>' ){` |
|        - |  1449 | `					/* Member access operator '->' */` |
|       53 |  1450 | `					zIn += 2;` |
|     2116 |  1451 | `				}else if(zIn[0] == ':' && &zIn[1] < zEnd && zIn[1] == ':'){` |
...
|     2353 |  1459 | `			rc = GenStateProcessStringExpression(&(*pGen),pGen->pIn->nLine,zExpr,zIn);` |
|     2353 |  1460 | `			if( rc == SXERR_ABORT ){` |
|      ! 0 |  1461 | `				return SXERR_ABORT;` |
|        - |  1462 | `			}` |
|     2353 |  1463 | `			if( rc != SXERR_EMPTY ){` |
|     2351 |  1464 | `				++iCons;` |
|     1173 |  1465 | `			}` |
|        - |  1466 | `		}` |
...
|     2491 |  1468 | `		pObj = 0;` |
|        5 |  1469 | `	}/*for(;;)*/` |
|    45063 |  1470 | `	if( iCons > 1 ){` |
|        - |  1471 | `		/* Concatenate all compiled constants */` |
|     1815 |  1472 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_CAT,iCons,0,0,0);` |
|      905 |  1473 | `	}` |
|        - |  1474 | `	/* Node successfully compiled */` |
|    45063 |  1475 | `	return SXRET_OK;` |
|    22720 |  1476 | `}` |
|        - |  1477 | `/*` |
|        - |  1478 | ` * Compile a double quoted string.` |
|        - |  1479 | ` *  See the block-comment above for more information.` |
|        - |  1480 | ` */` |
|    45368 |  1481 | `PH7_PRIVATE sxi32 PH7_CompileString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |  1482 | `{` |
|        - |  1483 | `	sxi32 rc;` |
|    45373 |  1484 | `	rc = GenStateCompileString(&(*pGen),0/*bHeredoc*/);` |
|    22684 |  1485 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|        - |  1486 | `	/* Compilation result */` |
|    45373 |  1487 | `	return rc;` |
|        5 |  1488 | `}` |
|        - |  1489 | `/*` |
...
|        - |  1530 | ` */` |
|   590874 |  1531 | `static sxi32 GenStateCompileArrayEntry(` |
...
|   590879 |  1542 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|        - |  1543 | `	/* Compile the expression*/` |
|   590879 |  1544 | `	rc = PH7_CompileExpr(&(*pGen),iFlags,xValidator);` |
|        - |  1545 | `	/* Restore token stream */` |
|   590879 |  1546 | `	RE_SWAP_DELIMITER(pGen);` |
|   590879 |  1547 | `	return rc;` |
|        5 |  1548 | `}` |
|        - |  1549 | `/*` |
...
|        - |  1587 | ` */` |
|   597400 |  1588 | `static SyToken * GenStateFindTopLevelArrow(SyToken *pStart,SyToken *pEnd)` |
|        5 |  1589 | `{` |
|   597405 |  1590 | `	SyToken *pCur = pStart;` |
|   597405 |  1591 | `	sxi32 iNest = 0;` |
|  1779377 |  1592 | `	while( pCur < pEnd ){` |
|  1416695 |  1593 | `		if( (pCur->nType & PH7_TK_ARRAY_OP) && iNest <= 0 ){` |
|   234719 |  1594 | `			return pCur;` |
|        - |  1595 | `		}` |
...
|        - |  1599 | `		 */` |
|  1181981 |  1600 | `		if( iNest == 0 && (pCur->nType & PH7_TK_KEYWORD) ){` |
...
|        - |  1659 | `			}` |
|     9738 |  1660 | `		}` |
|  1181975 |  1661 | `		if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|    50839 |  1662 | `			iNest++;` |
|  1156558 |  1663 | `		}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}'*/) ){` |
...
|        - |  1676 | ` */` |
|   313686 |  1677 | `static sxi32 GenStateCompileArrayBody(ph7_gen_state *pGen)` |
|        5 |  1678 | `{` |
|        - |  1679 | `	sxi32 (*xValidator)(ph7_gen_state *,ph7_expr_node *); /* Expression tree validator callback */` |
|        - |  1680 | `	SyToken *pKey,*pCur;` |
|   313691 |  1681 | `	sxi32 iEmitRef = 0;` |
|   313691 |  1682 | `	sxi32 iSpread = 0;` |
|   313691 |  1683 | `	sxi32 nPair = 0;` |
|        - |  1684 | `	sxi32 rc;` |
|   313691 |  1685 | `	xValidator = 0;` |
|   367886 |  1686 | `	for(;;){` |
|        - |  1687 | `		/* Jump leading commas */` |
|  1050191 |  1688 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA) ){` |
|   314419 |  1689 | `			pGen->pIn++;` |
|        5 |  1690 | `		}` |
|   735777 |  1691 | `		pCur = pGen->pIn;` |
|   735777 |  1692 | `		if( SXRET_OK != PH7_GetNextExpr(pGen->pIn,pGen->pEnd,&pGen->pIn) ){` |
|        - |  1693 | `			/* No more entry to process */` |
|   313675 |  1694 | `			break;` |
|        - |  1695 | `		}` |
|   422107 |  1696 | `		if( pCur >= pGen->pIn ){` |
|      ! 0 |  1697 | `			continue;` |
|        - |  1698 | `		}` |
|        - |  1699 | `		/* Compile the key if available */` |
|   422107 |  1700 | `		pKey = pCur;` |
|   422107 |  1701 | `		pCur = GenStateFindTopLevelArrow(pCur,pGen->pIn);` |
|   422107 |  1702 | `		rc = SXERR_EMPTY;` |
|   422107 |  1703 | `		if( pCur < pGen->pIn ){` |
|   168523 |  1704 | `			if( &pCur[1] >= pGen->pIn ){` |
|        - |  1705 | `				/* Missing value */` |
...
|   168513 |  1713 | `			rc = GenStateCompileArrayEntry(&(*pGen),pKey,pCur,` |
|        - |  1714 | `				EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,0);` |
|   168513 |  1715 | `			if( rc == SXERR_ABORT ){` |
|      ! 0 |  1716 | `				return SXERR_ABORT;` |
|        - |  1717 | `			}` |
|   168513 |  1718 | `			pCur++; /* Jump the '=>' operator */` |
|   337843 |  1719 | `		}else if( pKey == pCur ){` |
...
|   253589 |  1725 | `			pCur = pKey;` |
|        - |  1726 | `		}` |
|   422097 |  1727 | `		if( rc == SXERR_EMPTY ){` |
|        - |  1728 | `			/* No available key,load NULL */` |
|   253591 |  1729 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,0 /* nil index */,0,0);` |
|   126793 |  1730 | `		}` |
|   422097 |  1731 | `		if( pCur->nType & PH7_TK_AMPER /*'&'*/){` |
...
|   422095 |  1750 | `		iSpread = (pCur < pGen->pIn && (pCur->nType & PH7_TK_ELLIPSIS)) ? 1 : 0;` |
|   422095 |  1751 | `		if( iSpread && (rc != SXERR_EMPTY \|\| iEmitRef) ){` |
...
|   422091 |  1764 | `		rc = GenStateCompileArrayEntry(&(*pGen),pCur,pGen->pIn,EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,xValidator);` |
|   422091 |  1765 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 |  1766 | `			return SXERR_ABORT;` |
|        - |  1767 | `		}` |
|   422091 |  1768 | `		if( iSpread ){` |
...
|   422058 |  1771 | `		}else if( iEmitRef ){` |
|        - |  1772 | `			/* Emit the load reference instruction */` |
|       41 |  1773 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_REF,0,0,0,0);` |
|       18 |  1774 | `		}` |
|   422091 |  1775 | `		xValidator = 0;` |
|   422091 |  1776 | `		iEmitRef = 0;` |
|   422091 |  1777 | `		iSpread = 0;` |
|   422091 |  1778 | `		nPair++;` |
|        5 |  1779 | `	}` |
|        - |  1780 | `	/* Emit the load map instruction */` |
|   313675 |  1781 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_MAP,nPair * 2,0,0,0);` |
|        - |  1782 | `	/* Node successfully compiled */` |
|   313675 |  1783 | `	return SXRET_OK;` |
|   156848 |  1784 | `}` |
|        - |  1785 | `/*` |
...
|        - |  1898 | ` */` |
|    25006 |  1899 | `PH7_PRIVATE sxi32 PH7_CompileShortArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |  1900 | `{` |
|        - |  1901 | `	/* Jump the leading '[', exclude trailing ']'. */` |
|    25011 |  1902 | `	pGen->pIn++;` |
|    25011 |  1903 | `	pGen->pEnd--;` |
|    12503 |  1904 | `	SXUNUSED(iCompileFlag);` |
|    25011 |  1905 | `	return GenStateCompileArrayBody(pGen);` |
|        5 |  1906 | `}` |
|        - |  1907 | `/*` |
...
|        - |  3185 | ` */` |
| 11360386 |  3186 | `PH7_PRIVATE sxi32 PH7_CompileVariable(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |  3187 | `{` |
| 11360391 |  3188 | `	sxu32 nLineLocal = pGen->pIn->nLine;` |
|        - |  3189 | `	sxi32 iVv;` |
|        - |  3190 | `	sxi32 iP1;` |
|        - |  3191 | `	void *p3;` |
|        - |  3192 | `	sxi32 rc;` |
| 11360391 |  3193 | `	iVv = -1; /* Variable variable counter */` |
| 22720789 |  3194 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) ){` |
| 11360403 |  3195 | `		pGen->pIn++;` |
| 11360403 |  3196 | `		iVv++;` |
|        5 |  3197 | `	}` |
| 11360391 |  3198 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_OCB/*'{'*/)) == 0 ){` |
...
|        - |  3206 | `	}` |
| 11360391 |  3207 | `	p3  = 0;` |
| 11360391 |  3208 | `	if( pGen->pIn->nType & PH7_TK_OCB/*'{'*/ ){` |
...
|        - |  3227 | `		SyString *pName;` |
| 11360373 |  3228 | `		char *zName = 0;` |
|        - |  3229 | `		/* Extract variable name */` |
| 11360373 |  3230 | `		pName = &pGen->pIn->sData;` |
|        - |  3231 | `		/* Advance the stream cursor */` |
| 11360373 |  3232 | `		pGen->pIn++;` |
| 11360373 |  3233 | `		pEntry = SyHashGet(&pGen->hVar,(const void *)pName->zString,pName->nByte);` |
| 11360373 |  3234 | `		if( pEntry == 0 ){` |
|        - |  3235 | `			/* Duplicate name */` |
|   728459 |  3236 | `			zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|   728459 |  3237 | `			if( zName == 0 ){` |
...
|   728459 |  3242 | `			SyHashInsert(&pGen->hVar,zName,pName->nByte,zName);` |
|   364232 |  3243 | `		}else{` |
|        - |  3244 | `			/* Name already available */` |
| 10631919 |  3245 | `			zName = (char *)pEntry->pUserData;` |
|        - |  3246 | `		}` |
| 11360373 |  3247 | `		p3 = (void *)zName;` |
|        - |  3248 | `	}` |
| 11360387 |  3249 | `	iP1 = 0;` |
| 11360387 |  3250 | `	if( iCompileFlag & EXPR_FLAG_RDONLY_LOAD ){` |
|  3360323 |  3251 | `		if( (iCompileFlag & EXPR_FLAG_LOAD_IDX_STORE) == 0 ){` |
|        - |  3252 | `			/* Read-only load.In other words do not create the variable if inexistant */` |
|  3360293 |  3253 | `			iP1 = 1;` |
|  1680144 |  3254 | `		}` |
|  1680159 |  3255 | `	}` |
|        - |  3256 | `	/* Emit the load instruction */` |
| 11360387 |  3257 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,0,p3,0);` |
| 11360399 |  3258 | `	while( iVv > 0 ){` |
|       13 |  3259 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,0,0,0);` |
|       13 |  3260 | `		iVv--;` |
|        1 |  3261 | `	}` |
|        - |  3262 | `	/* Node successfully compiled */` |
| 11360387 |  3263 | `	return SXRET_OK;` |
|  5680198 |  3264 | `}` |
|        - |  3265 | `/*` |
|        - |  3266 | ` * Load a literal.` |
|        - |  3267 | ` */` |
|  6970648 |  3268 | `static sxi32 GenStateLoadLiteral(ph7_gen_state *pGen)` |
|        5 |  3269 | `{` |
|  6970653 |  3270 | `	SyToken *pToken = pGen->pIn;` |
|        - |  3271 | `	ph7_value *pObj;` |
|        - |  3272 | `	SyString *pStr;` |
|        - |  3273 | `	sxu32 nIdx;` |
|        - |  3274 | `	/* Extract token value */` |
|  6970653 |  3275 | `	pStr = &pToken->sData;` |
|        - |  3276 | `	/* Deal with the reserved literals [i.e: null,false,true,...] first */` |
|  6970653 |  3277 | `	if( pStr->nByte == sizeof("NULL") - 1 ){` |
|  1519255 |  3278 | `		if( SyStrnicmp(pStr->zString,"null",sizeof("NULL")-1) == 0 ){` |
|        - |  3279 | `			/* NULL constant are always indexed at 0 */` |
|   652099 |  3280 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,0,0,0);` |
|   652099 |  3281 | `			return SXRET_OK;` |
|   867161 |  3282 | `		}else if( SyStrnicmp(pStr->zString,"true",sizeof("TRUE")-1) == 0 ){` |
|        - |  3283 | `			/* TRUE constant are always indexed at 1 */` |
|   163801 |  3284 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,1,0,0);` |
|   163801 |  3285 | `			return SXRET_OK;` |
|        5 |  3286 | `		}` |
|  6355378 |  3287 | `	}else if (pStr->nByte == sizeof("FALSE") - 1 &&` |
|  1104590 |  3288 | `		SyStrnicmp(pStr->zString,"false",sizeof("FALSE")-1) == 0 ){` |
|        - |  3289 | `			/* FALSE constant are always indexed at 2 */` |
|   454139 |  3290 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,2,0,0);` |
|   454139 |  3291 | `			return SXRET_OK;` |
|  5352793 |  3292 | `	}else if(pStr->nByte == sizeof("__LINE__") - 1 &&` |
|   711048 |  3293 | `		SyMemcmp(pStr->zString,"__LINE__",sizeof("__LINE__")-1) == 0 ){` |
...
|  5016950 |  3304 | `	}else if( pStr->nByte == sizeof("__NAMESPACE__") - 1 &&` |
|    62630 |  3305 | `		SyMemcmp(pStr->zString,"__NAMESPACE__",sizeof("__NAMESPACE__")-1) == 0 ){` |
...
|  5034656 |  3321 | `	}else if( (pStr->nByte == sizeof("__FUNCTION__") - 1 &&` |
|   237137 |  3322 | `		SyMemcmp(pStr->zString,"__FUNCTION__",sizeof("__FUNCTION__")-1) == 0) \|\|` |
|  5124685 |  3323 | `		(pStr->nByte == sizeof("__METHOD__") - 1 &&` |
|   278136 |  3324 | `		SyMemcmp(pStr->zString,"__METHOD__",sizeof("__METHOD__")-1) == 0) ){` |
...
|  5688979 |  3354 | `	if( SXRET_OK != GenStateFindLiteral(&(*pGen),&pToken->sData,&nIdx) ){` |
|        - |  3355 | `		ph7_value *pLitObj;` |
|        - |  3356 | `		/* Unknown literal,install it in the literal table */` |
|  1177677 |  3357 | `		pLitObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  1177677 |  3358 | `		if( pLitObj == 0 ){` |
|      ! 0 |  3359 | `			PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|      ! 0 |  3360 | `			return SXERR_ABORT;` |
|        - |  3361 | `		}` |
|  1177677 |  3362 | `		PH7_MemObjInitFromString(pGen->pVm,pLitObj,&pToken->sData);` |
|  1177677 |  3363 | `		GenStateInstallLiteral(&(*pGen),pLitObj,nIdx);` |
|   588836 |  3364 | `	}` |
|        - |  3365 | `	/* Emit the load constant instruction */` |
|  5688979 |  3366 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,1,nIdx,0,0);` |
|  5688979 |  3367 | `	return SXRET_OK;` |
|  3485329 |  3368 | `}` |
|        - |  3369 | `/*` |
...
|        - |  3374 | ` */` |
|  6974572 |  3375 | `static sxi32 GenStateResolveNamespaceLiteral(ph7_gen_state *pGen)` |
|        5 |  3376 | `{` |
|        - |  3377 | `	sxi32 rc;` |
|  6974577 |  3378 | `	if( pGen->pIn >= pGen->pEnd ){` |
|      ! 0 |  3379 | `		return SXRET_OK;` |
|        - |  3380 | `	}` |
|        - |  3381 | `	/* Check if this is a multi-token namespace path */` |
|  6974577 |  3382 | `	if( pGen->pIn < &pGen->pEnd[-1] ){` |
...
|  6970653 |  3435 | `	rc = GenStateLoadLiteral(&(*pGen));` |
|  6970653 |  3436 | `	return rc;` |
|  3487291 |  3437 | `}` |
|        - |  3438 | `/*` |
...
|      ! 0 |  3453 | `}` |
|  6974572 |  3454 | `PH7_PRIVATE sxi32 PH7_CompileLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |  3455 | `{` |
|        - |  3456 | `	sxi32 rc;` |
|  6974577 |  3457 | `	rc = GenStateResolveNamespaceLiteral(&(*pGen));` |
|  6974577 |  3458 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  3459 | `		SXUNUSED(iCompileFlag); /* cc warning */` |
|      ! 0 |  3460 | `		return rc;` |
|        - |  3461 | `	}` |
|        - |  3462 | `	/* Node successfully compiled */` |
|  6974577 |  3463 | `	return SXRET_OK;` |
|  3487291 |  3464 | `}` |
|        - |  3465 | `/*` |
...
|        - |  3480 | ` */` |
|   205648 |  3481 | `static int GenStateIsReservedConstant(SyString *pName)` |
|        5 |  3482 | `{` |
|   205653 |  3483 | `	if( pName->nByte == sizeof("null") - 1 ){` |
...
|        - |  3637 | ` */` |
|    69920 |  3638 | `static int GenStateEmitExceptionPopForBreak(ph7_gen_state *pGen,GenBlock *pTarget)` |
|        5 |  3639 | `{` |
|    69925 |  3640 | `	GenBlock *pBlock = pGen->pCurrent;` |
|    69925 |  3641 | `	int nInlineTry = 0;` |
|   318231 |  3642 | `	while( pBlock && pBlock != pTarget ){` |
|   248311 |  3643 | `		if( pBlock->iFlags & GEN_BLOCK_EXCEPTION ){` |
...
|        - |  3658 | `			}` |
|        2 |  3659 | `		}` |
|   248311 |  3660 | `		pBlock = pBlock->pParent;` |
|        5 |  3661 | `	}` |
|    69925 |  3662 | `	return nInlineTry;` |
|        5 |  3663 | `}` |
...
|        - |  3751 | ` */` |
|    38888 |  3752 | `static sxi32 PH7_CompileBreak(ph7_gen_state *pGen)` |
|        5 |  3753 | `{` |
...
|    38893 |  3759 | `	pGen->pIn++;` |
|    38893 |  3760 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NUM) ){` |
...
|    38893 |  3786 | `	pLoop = GenStateFetchBlock(pGen->pCurrent,GEN_BLOCK_LOOP,iLevel);` |
|    38893 |  3787 | `	if( pLoop == 0 ){` |
|        - |  3788 | `		/* Illegal break */` |
...
|    38877 |  3797 | `		int nCross = GenStateEmitExceptionPopForBreak(&(*pGen),pLoop);` |
|        - |  3798 | `		/* ROOT C: OP_SET_FINALLY_JMP runs the crossed inline finallys before the break jump. */` |
|    38877 |  3799 | `		rc = PH7_VmEmitInstr(pGen->pVm,nCross > 0 ? PH7_OP_SET_FINALLY_JMP : PH7_OP_JMP,nCross,0,0,&nInstrIdx);` |
|    38877 |  3800 | `		if( rc == SXRET_OK ){` |
|        - |  3801 | `			/* Fix the jump later when the jump destination is resolved */` |
|    38877 |  3802 | `			GenStateNewJumpFixup(pLoop,PH7_OP_JMP,nInstrIdx);` |
|    19436 |  3803 | `		}` |
|        - |  3804 | `	}` |
|    38893 |  3805 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
...
|        - |  4020 | ` * message.` |
|        - |  4021 | ` */` |
|  3596336 |  4022 | `static sxi32 PH7_CompileBlock(` |
...
|        - |  4027 | `	sxi32 rc;` |
|        - |  4028 | `	sxu32 nLine;` |
|  3596341 |  4029 | `	if( pGen->pIn->nType & PH7_TK_OCB /* '{' */ ){` |
|  3594919 |  4030 | `		nLine = pGen->pIn->nLine;` |
|  3594919 |  4031 | `		rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_STD,PH7_VmInstrLength(pGen->pVm),0,0);` |
|  3594919 |  4032 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  4033 | `			return SXERR_ABORT;` |
|        - |  4034 | `		}` |
|  3594919 |  4035 | `		pGen->pIn++;` |
|        - |  4036 | `		/* Compile until we hit the closing braces '}' */` |
|  5316880 |  4037 | `		for(;;){` |
| 10633765 |  4038 | `			if( pGen->pIn >= pGen->pEnd ){` |
...
|        - |  4047 | `				}` |
|      ! 0 |  4048 | `			}` |
| 10633745 |  4049 | `			if( pGen->pIn->nType & PH7_TK_CCB/*'}'*/ ){` |
|        - |  4050 | `				/* Closing braces found,break immediately*/` |
|  3594899 |  4051 | `				pGen->pIn++;` |
|  3594899 |  4052 | `				break;` |
|        - |  4053 | `			}` |
|        - |  4054 | `			/* Compile a single statement */` |
|  7038851 |  4055 | `			rc = GenStateCompileChunk(&(*pGen),PH7_COMPILE_SINGLE_STMT);` |
|  7038851 |  4056 | `			if( rc == SXERR_ABORT ){` |
|      ! 0 |  4057 | `				return SXERR_ABORT;` |
|        - |  4058 | `			}` |
|        5 |  4059 | `		}` |
|  3594919 |  4060 | `		GenStateLeaveBlock(&(*pGen),0);` |
|  1798884 |  4061 | `	}else if( (pGen->pIn->nType & PH7_TK_COLON /* ':' */) && nKeywordEnd > 0 ){` |
|      ! 0 |  4062 | `		pGen->pIn++;` |
...
|  3596341 |  4111 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|      ! 0 |  4112 | `		pGen->pIn++;` |
|      ! 0 |  4113 | `	}` |
|  3596341 |  4114 | `	return SXRET_OK;` |
|  1798173 |  4115 | `}` |
|        - |  4116 | `/*` |
...
|        - |  4133 | ` *   endwhile;` |
|        - |  4134 | ` */` |
|    23392 |  4135 | `static sxi32 PH7_CompileWhile(ph7_gen_state *pGen)` |
|        5 |  4136 | `{` |
|    23397 |  4137 | `	GenBlock *pWhileBlock = 0;` |
|    23397 |  4138 | `	SyToken *pTmp,*pEnd = 0;` |
|        - |  4139 | `	sxu32 nFalseJump;` |
|        - |  4140 | `	sxu32 nLine;` |
|        - |  4141 | `	sxi32 rc;` |
|    23397 |  4142 | `	nLine = pGen->pIn->nLine;` |
|        - |  4143 | `	/* Jump the 'while' keyword */` |
|    23397 |  4144 | `	pGen->pIn++;` |
|    23397 |  4145 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|        - |  4146 | `		/* Syntax error */` |
...
|    23397 |  4157 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pWhileBlock);` |
|    23397 |  4158 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  4159 | `		return SXERR_ABORT;` |
|        - |  4160 | `	}` |
|        - |  4161 | `	/* Delimit the condition */` |
|    23397 |  4162 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|    23397 |  4163 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|    23397 |  4172 | `	pTmp = pGen->pEnd;` |
|    23397 |  4173 | `	pGen->pEnd = pEnd;` |
|        - |  4174 | `	/* Compile the expression */` |
|    23397 |  4175 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|    23397 |  4176 | `	if( rc == SXERR_ABORT ){` |
|        - |  4177 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|      ! 0 |  4178 | `		return SXERR_ABORT;` |
|        - |  4179 | `	}` |
|        - |  4180 | `	/* Update token stream */` |
|    23397 |  4181 | `	while(pGen->pIn < pEnd ){` |
...
|    23397 |  4189 | `	pGen->pIn  = &pEnd[1];` |
|    23397 |  4190 | `	pGen->pEnd = pTmp;` |
|        - |  4191 | `	/* Emit the false jump */` |
|    23397 |  4192 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nFalseJump);` |
|        - |  4193 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|    23397 |  4194 | `	GenStateNewJumpFixup(pWhileBlock,PH7_OP_JZ,nFalseJump);` |
|        - |  4195 | `	/* Compile the loop body */` |
|    23397 |  4196 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDWHILE);` |
|    23397 |  4197 | `	if( rc == SXERR_ABORT ){` |
|      ! 0 |  4198 | `		return SXERR_ABORT;` |
|        - |  4199 | `	}` |
|        - |  4200 | `	/* Emit the unconditional jump to the start of the loop */` |
|    23397 |  4201 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pWhileBlock->nFirstInstr,0,0);` |
|        - |  4202 | `	/* Fix all jumps now the destination is resolved */` |
|    23397 |  4203 | `	GenStateFixJumps(pWhileBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|        - |  4204 | `	/* Release the loop block */` |
|    23397 |  4205 | `	GenStateLeaveBlock(pGen,0);` |
|        - |  4206 | `	/* Statement successfully compiled */` |
|    23397 |  4207 | `	return SXRET_OK;` |
|      ! 0 |  4208 | `Synchronize:` |
...
|        - |  4363 | ` */` |
|    54404 |  4364 | `static sxi32 PH7_CompileFor(ph7_gen_state *pGen)` |
|        5 |  4365 | `{` |
|    54409 |  4366 | `	SyToken *pTmp,*pPostStart,*pEnd = 0;` |
|    54409 |  4367 | `	GenBlock *pForBlock = 0;` |
|        - |  4368 | `	sxu32 nFalseJump;` |
|        - |  4369 | `	sxu32 nLine;` |
|        - |  4370 | `	sxi32 rc;` |
|    54409 |  4371 | `	nLine = pGen->pIn->nLine;` |
|        - |  4372 | `	/* Jump the 'for' keyword */` |
|    54409 |  4373 | `	pGen->pIn++;` |
|    54409 |  4374 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|        - |  4375 | `		/* Syntax error */` |
...
|    54409 |  4386 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|    54409 |  4387 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|    54409 |  4402 | `	pTmp = pGen->pEnd;` |
|    54409 |  4403 | `	pGen->pEnd = pEnd;` |
|        - |  4404 | `	/* Compile initialization expressions if available */` |
|    54409 |  4405 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|        - |  4406 | `	/* Pop operand lvalues */` |
|    54409 |  4407 | `	if( rc == SXERR_ABORT ){` |
|        - |  4408 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|      ! 0 |  4409 | `		return SXERR_ABORT;` |
|    54409 |  4410 | `	}else if( rc != SXERR_EMPTY ){` |
|    54407 |  4411 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|    27201 |  4412 | `	}` |
|    54409 |  4413 | `	if( (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|        - |  4414 | `		/* Syntax error */` |
...
|    54409 |  4426 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pForBlock);` |
|    54409 |  4427 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  4428 | `		return SXERR_ABORT;` |
|        - |  4429 | `	}` |
|        - |  4430 | `	/* Deffer continue jumps */` |
|    54409 |  4431 | `	pForBlock->bPostContinue = TRUE;` |
|        - |  4432 | `	/* Compile the condition */` |
|    54409 |  4433 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|    54409 |  4434 | `	if( rc == SXERR_ABORT ){` |
|        - |  4435 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|      ! 0 |  4436 | `		return SXERR_ABORT;` |
|    54409 |  4437 | `	}else if( rc != SXERR_EMPTY ){` |
|        - |  4438 | `		/* Emit the false jump */` |
|    54407 |  4439 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nFalseJump);` |
|        - |  4440 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|    54407 |  4441 | `		GenStateNewJumpFixup(pForBlock,PH7_OP_JZ,nFalseJump);` |
|    27201 |  4442 | `	}` |
|    54409 |  4443 | `	if( (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|        - |  4444 | `		/* Syntax error */` |
...
|    54405 |  4456 | `	pPostStart = pGen->pIn;` |
|        - |  4457 | `	/* Compile the loop body */` |
|    54405 |  4458 | `	pGen->pIn  = &pEnd[1]; /* Jump the trailing parenthesis ')' */` |
|    54405 |  4459 | `	pGen->pEnd = pTmp;` |
|    54405 |  4460 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDFOR);` |
|    54405 |  4461 | `	if( rc == SXERR_ABORT ){` |
|      ! 0 |  4462 | `		return SXERR_ABORT;` |
|        - |  4463 | `	}` |
|        - |  4464 | `	/* Fix post-continue jumps */` |
|    54405 |  4465 | `	if( SySetUsed(&pForBlock->aPostContFix) > 0 ){` |
...
|    54405 |  4481 | `	while( pPostStart < pEnd && (pPostStart->nType & PH7_TK_SEMI) ){` |
|      ! 0 |  4482 | `		pPostStart++;` |
|      ! 0 |  4483 | `	}` |
|    54405 |  4484 | `	if( pPostStart < pEnd ){` |
|        - |  4485 | `		SyToken *pTmpIn,*pTmpEnd;` |
|    54405 |  4486 | `		SWAP_DELIMITER(pGen,pPostStart,pEnd);` |
|    54405 |  4487 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|    54405 |  4488 | `		if( pGen->pIn < pGen->pEnd ){` |
|        - |  4489 | `			/* Syntax error */` |
...
|        - |  4496 | `		}` |
|    54405 |  4497 | `		RE_SWAP_DELIMITER(pGen);` |
|    54405 |  4498 | `		if( rc == SXERR_ABORT ){` |
|        - |  4499 | `			/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|      ! 0 |  4500 | `			return SXERR_ABORT;` |
|    54405 |  4501 | `		}else if( rc != SXERR_EMPTY){` |
|        - |  4502 | `			/* Pop operand lvalue */` |
|    54405 |  4503 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|    27200 |  4504 | `		}` |
|    27200 |  4505 | `	}` |
|        - |  4506 | `	/* Emit the unconditional jump to the start of the loop */` |
|    54405 |  4507 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pForBlock->nFirstInstr,0,0);` |
|        - |  4508 | `	/* Fix all jumps now the destination is resolved */` |
|    54405 |  4509 | `	GenStateFixJumps(pForBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|        - |  4510 | `	/* Release the loop block */` |
|    54405 |  4511 | `	GenStateLeaveBlock(pGen,0);` |
|        - |  4512 | `	/* Statement successfully compiled */` |
|    54405 |  4513 | `	return SXRET_OK;` |
|    27207 |  4514 | `}` |
...
|        - |  4517 | ` * are allowed.` |
|        - |  4518 | ` */` |
|   241160 |  4519 | `static sxi32 GenStateForEachNodeValidator(ph7_gen_state *pGen,ph7_expr_node *pRoot)` |
|        5 |  4520 | `{` |
|   241165 |  4521 | `	sxi32 rc = SXRET_OK; /* Assume a valid expression tree */` |
|   241165 |  4522 | `	if( pRoot->xCode != PH7_CompileVariable ){` |
...
|        - |  4557 | ` */` |
|   175044 |  4558 | `static sxi32 PH7_CompileForeach(ph7_gen_state *pGen)` |
|        5 |  4559 | `{` |
|   175049 |  4560 | `	SyToken *pCur,*pTmp,*pEnd = 0;` |
|   175049 |  4561 | `	SyToken *pListStart = 0,*pListEnd = 0;` |
|   175049 |  4562 | `	GenBlock *pForeachBlock = 0;` |
|        - |  4563 | `	ph7_foreach_info *pInfo;` |
|        - |  4564 | `	sxu32 nFalseJump;` |
|        - |  4565 | `	VmInstr *pInstr;` |
|        - |  4566 | `	sxu32 nLine;` |
|        - |  4567 | `	sxi32 rc;` |
|   175049 |  4568 | `	nLine = pGen->pIn->nLine;` |
|        - |  4569 | `	/* Jump the 'foreach' keyword */` |
|   175049 |  4570 | `	pGen->pIn++;` |
|   175049 |  4571 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|        - |  4572 | `		/* Syntax error */` |
...
|   175049 |  4581 | `	pGen->pIn++;` |
|        - |  4582 | `	/* Create the loop block */` |
|   175049 |  4583 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pForeachBlock);` |
|   175049 |  4584 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  4585 | `		return SXERR_ABORT;` |
|        - |  4586 | `	}` |
|        - |  4587 | `	/* Delimit the expression */` |
|   175049 |  4588 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   175049 |  4589 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|   175049 |  4604 | `	pCur = pGen->pIn;` |
|  1022991 |  4605 | `	while( pCur < pEnd ){` |
|  1022991 |  4606 | `		if( pCur->nType & PH7_TK_KEYWORD ){` |
|   178939 |  4607 | `			sxi32 nKeywrd = SX_PTR_TO_INT(pCur->pUserData);` |
|   178939 |  4608 | `			if( nKeywrd == PH7_TKWRD_AS ){` |
...
|   175049 |  4626 | `	pTmp = pGen->pEnd;` |
|   175049 |  4627 | `	pGen->pEnd = pCur;` |
|   175049 |  4628 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   175049 |  4629 | `	if( rc == SXERR_ABORT ){` |
|        - |  4630 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|      ! 0 |  4631 | `		return SXERR_ABORT;` |
|        - |  4632 | `	}` |
|        - |  4633 | `	/* Update token stream */` |
|   175049 |  4634 | `	while(pGen->pIn < pCur ){` |
...
|      ! 0 |  4640 | `		pGen->pIn++;` |
|      ! 0 |  4641 | `	}` |
|   175049 |  4642 | `	pCur++; /* Jump the 'as' keyword */` |
|   175049 |  4643 | `	pGen->pIn = pCur;` |
|   175049 |  4644 | `	if( pGen->pIn >= pEnd ){` |
...
|   175049 |  4651 | `	pInfo = (ph7_foreach_info *)SyMemBackendAlloc(&pGen->pVm->sAllocator,sizeof(ph7_foreach_info));` |
|   175049 |  4652 | `	if( pInfo == 0 ){` |
...
|   175049 |  4657 | `	SyZero(pInfo,sizeof(ph7_foreach_info));` |
|        - |  4658 | `	/* Initialize structure fields */` |
|   175049 |  4659 | `	SySetInit(&pInfo->aStep,&pGen->pVm->sAllocator,sizeof(ph7_foreach_step *));` |
...
|        - |  4662 | `	 * '=>'. */` |
|   175049 |  4663 | `	pCur = GenStateFindTopLevelArrow(pCur,pEnd);` |
|   175049 |  4664 | `	if( pCur < pEnd ){` |
|        - |  4665 | `		/* Compile the expression holding the key name */` |
|    66141 |  4666 | `		if( pGen->pIn >= pCur ){` |
...
|        - |  4671 | `			}` |
|      ! 0 |  4672 | `		}else{` |
|    66141 |  4673 | `			pGen->pEnd = pCur;` |
|    66141 |  4674 | `			rc = PH7_CompileExpr(&(*pGen),0,GenStateForEachNodeValidator);` |
|    66141 |  4675 | `			if( rc == SXERR_ABORT ){` |
|        - |  4676 | `				/* Don't worry about freeing memory, everything will be released shortly */` |
|      ! 0 |  4677 | `				return SXERR_ABORT;` |
|        - |  4678 | `			}` |
|    66141 |  4679 | `			pInstr = PH7_VmPopInstr(pGen->pVm);` |
|    66141 |  4680 | `			if( pInstr->p3 ){` |
|        - |  4681 | `				/* Record key name */` |
|    66141 |  4682 | `				SyStringInitFromBuf(&pInfo->sKey,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|    33068 |  4683 | `			}` |
|    66141 |  4684 | `			pInfo->iFlags \|= PH7_4EACH_STEP_KEY;` |
|        - |  4685 | `		}` |
|    66141 |  4686 | `		pGen->pIn = &pCur[1]; /* Jump the arrow */` |
|    33068 |  4687 | `	}` |
|   175049 |  4688 | `	pGen->pEnd = pEnd;` |
|   175049 |  4689 | `	if( pGen->pIn >= pEnd ){` |
...
|   175044 |  4744 | `	}else if( pGen->pIn->nType & PH7_TK_OSB ){` |
...
|   175029 |  4777 | `		rc = PH7_CompileExpr(&(*pGen),0,GenStateForEachNodeValidator);` |
|   175029 |  4778 | `		if( rc == SXERR_ABORT ){` |
|        - |  4779 | `			/* Don't worry about freeing memory, everything will be released shortly */` |
|      ! 0 |  4780 | `			return SXERR_ABORT;` |
|        - |  4781 | `		}` |
|   175029 |  4782 | `		pInstr = PH7_VmPopInstr(pGen->pVm);` |
|   175029 |  4783 | `		if( pInstr->p3 ){` |
|        - |  4784 | `			/* Record value name */` |
|   175029 |  4785 | `			SyStringInitFromBuf(&pInfo->sValue,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|    87512 |  4786 | `		}` |
|        - |  4787 | `	}` |
|        - |  4788 | `	/* Emit the 'FOREACH_INIT' instruction */` |
|   175047 |  4789 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_FOREACH_INIT,0,0,pInfo,&nFalseJump);` |
|        - |  4790 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   175047 |  4791 | `	GenStateNewJumpFixup(pForeachBlock,PH7_OP_FOREACH_INIT,nFalseJump);` |
|        - |  4792 | `	/* Record the first instruction to execute */` |
|   175047 |  4793 | `	pForeachBlock->nFirstInstr = PH7_VmInstrLength(pGen->pVm);` |
|        - |  4794 | `	/* Emit the FOREACH_STEP instruction */` |
|   175047 |  4795 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_FOREACH_STEP,0,0,pInfo,&nFalseJump);` |
|        - |  4796 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   175047 |  4797 | `	GenStateNewJumpFixup(pForeachBlock,PH7_OP_FOREACH_STEP,nFalseJump);` |
|        - |  4798 | `	/* If list() unpacking, emit bytecode to destructure the temp variable */` |
|   175047 |  4799 | `	if( (pInfo->iFlags & PH7_4EACH_STEP_LIST) && pListStart && pListEnd ){` |
...
|   175047 |  4827 | `	pGen->pIn = &pEnd[1];` |
|   175047 |  4828 | `	pGen->pEnd = pTmp;` |
|   175047 |  4829 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_END4EACH);` |
|   175047 |  4830 | `	if( rc == SXERR_ABORT ){` |
...
|   175047 |  4835 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pForeachBlock->nFirstInstr,0,0);` |
|        - |  4836 | `	/* Fix all jumps now the destination is resolved */` |
|   175047 |  4837 | `	GenStateFixJumps(pForeachBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|        - |  4838 | `	/* Release the loop block */` |
|   175047 |  4839 | `	GenStateLeaveBlock(pGen,0);` |
|        - |  4840 | `	/* Statement successfully compiled */` |
|   175047 |  4841 | `	return SXRET_OK;` |
|        1 |  4842 | `Synchronize:` |
...
|        - |  4881 | ` *    ?>` |
|        - |  4882 | ` */` |
|  1308800 |  4883 | `static sxi32 PH7_CompileIf(ph7_gen_state *pGen)` |
|        5 |  4884 | `{` |
|  1308805 |  4885 | `	SyToken *pToken,*pTmp,*pEnd = 0;` |
|  1308805 |  4886 | `	GenBlock *pCondBlock = 0;` |
|        - |  4887 | `	sxu32 nJumpIdx;` |
|        - |  4888 | `	sxu32 nKeyID;` |
|        - |  4889 | `	sxi32 rc;` |
|        - |  4890 | `	/* Jump the 'if' keyword */` |
|  1308805 |  4891 | `	pGen->pIn++;` |
|  1308805 |  4892 | `	pToken = pGen->pIn;` |
|        - |  4893 | `	/* Create the conditional block */` |
|  1308805 |  4894 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_COND,PH7_VmInstrLength(pGen->pVm),0,&pCondBlock);` |
|  1308805 |  4895 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  4896 | `		return SXERR_ABORT;` |
|        - |  4897 | `	}` |
|        - |  4898 | `	/* Process as many [if/else if/elseif/else] blocks as we can */` |
|   749421 |  4899 | `	for(;;){` |
|  1498847 |  4900 | `		if( pToken >= pGen->pEnd \|\| (pToken->nType & PH7_TK_LPAREN) == 0 ){` |
|        - |  4901 | `			/* Syntax error */` |
...
|  1498847 |  4915 | `		PH7_DelimitNestedTokens(pToken,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|  1498847 |  4916 | `		if( pToken >= pEnd \|\| (pEnd->nType & PH7_TK_RPAREN) == 0 ){` |
|        - |  4917 | `			/* Syntax error */` |
...
|  1498839 |  4929 | `		SWAP_TOKEN_STREAM(pGen,pToken,pEnd);` |
|        - |  4930 | `		/* Compile the condition */` |
|  1498839 |  4931 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|        - |  4932 | `		/* Update token stream */` |
|  1498839 |  4933 | `		while(pGen->pIn < pEnd ){` |
|      ! 0 |  4934 | `			PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Unexpected token '%z'",&pGen->pIn->sData);` |
|      ! 0 |  4935 | `			pGen->pIn++;` |
|      ! 0 |  4936 | `		}` |
|  1498839 |  4937 | `		pGen->pIn  = &pEnd[1];` |
|  1498839 |  4938 | `		pGen->pEnd = pTmp;` |
|  1498839 |  4939 | `		if( rc == SXERR_ABORT ){` |
|        - |  4940 | `			/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|      ! 0 |  4941 | `			return SXERR_ABORT;` |
|        - |  4942 | `		}` |
|        - |  4943 | `		/* Emit the false jump */` |
|  1498839 |  4944 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nJumpIdx);` |
|        - |  4945 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|  1498839 |  4946 | `		GenStateNewJumpFixup(pCondBlock,PH7_OP_JZ,nJumpIdx);` |
|        - |  4947 | `		/* Compile the body */` |
|  1498839 |  4948 | `		rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDIF);` |
|  1498839 |  4949 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 |  4950 | `			return SXERR_ABORT;` |
|        - |  4951 | `		}` |
|  1498839 |  4952 | `		if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
|   268326 |  4953 | `			break;` |
|        - |  4954 | `		}` |
|        - |  4955 | `		/* Ensure that the keyword ID is 'else if' or 'else' */` |
|   962197 |  4956 | `		nKeyID = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   962197 |  4957 | `		if( (nKeyID & (PH7_TKWRD_ELSE\|PH7_TKWRD_ELIF)) == 0 ){` |
|   659279 |  4958 | `			break;` |
|        - |  4959 | `		}` |
|        - |  4960 | `		/* Emit the unconditional jump */` |
|   302923 |  4961 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,0,0,&nJumpIdx);` |
|        - |  4962 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   302923 |  4963 | `		GenStateNewJumpFixup(pCondBlock,PH7_OP_JMP,nJumpIdx);` |
|   302923 |  4964 | `		if( nKeyID & PH7_TKWRD_ELSE ){` |
|   198153 |  4965 | `			pToken = &pGen->pIn[1];` |
|   198153 |  4966 | `			if( pToken >= pGen->pEnd \|\| (pToken->nType & PH7_TK_KEYWORD) == 0 \|\|` |
|    85310 |  4967 | `				SX_PTR_TO_INT(pToken->pUserData) != PH7_TKWRD_IF ){` |
|    56443 |  4968 | `					break;` |
|        - |  4969 | `			}` |
|    85277 |  4970 | `			pGen->pIn++; /* Jump the 'else' keyword */` |
|    42636 |  4971 | `		}` |
|   190047 |  4972 | `		pGen->pIn++; /* Jump the 'elseif/if' keyword */` |
|        - |  4973 | `		/* Synchronize cursors */` |
|   190047 |  4974 | `		pToken = pGen->pIn;` |
|        - |  4975 | `		/* Fix the false jump */` |
|   190047 |  4976 | `		GenStateFixJumps(pCondBlock,PH7_OP_JZ,PH7_VmInstrLength(pGen->pVm));` |
|        5 |  4977 | `	} /* For(;;) */` |
|        - |  4978 | `	/* Fix the false jump */` |
|  1308797 |  4979 | `	GenStateFixJumps(pCondBlock,PH7_OP_JZ,PH7_VmInstrLength(pGen->pVm));` |
|  1308797 |  4980 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|   772150 |  4981 | `		(SX_PTR_TO_INT(pGen->pIn->pUserData) & PH7_TKWRD_ELSE) ){` |
|        - |  4982 | `			/* Compile the else block */` |
|   112881 |  4983 | `			pGen->pIn++;` |
|   112881 |  4984 | `			rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDIF);` |
|   112881 |  4985 | `			if( rc == SXERR_ABORT ){` |
|        - |  4986 |  |
|      ! 0 |  4987 | `				return SXERR_ABORT;` |
|        - |  4988 | `			}` |
|    56438 |  4989 | `	}` |
|  1308797 |  4990 | `	nJumpIdx = PH7_VmInstrLength(pGen->pVm);` |
|        - |  4991 | `	/* Fix all unconditional jumps now the destination is resolved */` |
|  1308797 |  4992 | `	GenStateFixJumps(pCondBlock,PH7_OP_JMP,nJumpIdx);` |
|        - |  4993 | `	/* Release the conditional block */` |
|  1308797 |  4994 | `	GenStateLeaveBlock(pGen,0);` |
|        - |  4995 | `	/* Statement successfully compiled */` |
|  1308797 |  4996 | `	return SXRET_OK;` |
|        4 |  4997 | `Synchronize:` |
...
|        - |  5097 | ` */` |
|  1924528 |  5098 | `static sxi32 PH7_CompileReturn(ph7_gen_state *pGen)` |
|        5 |  5099 | `{` |
|  1924533 |  5100 | `	sxi32 nRet = 0; /* TRUE if there is a return value */` |
|        - |  5101 | `	sxi32 rc;` |
|  1924533 |  5102 | `	sxu32 nLine = pGen->pIn->nLine;` |
|  1924533 |  5103 | `	GenBlock *pFuncBlock = pGen->pCurrent;` |
...
|  4958395 |  5109 | `	while( pFuncBlock && (pFuncBlock->iFlags & GEN_BLOCK_FUNC) == 0 ){` |
|  3033867 |  5110 | `		pFuncBlock = pFuncBlock->pParent;` |
|        5 |  5111 | `	}` |
|  1924528 |  5112 | `	if( pFuncBlock && pFuncBlock->pUserData` |
|  1924501 |  5113 | `	 && ((ph7_vm_func *)pFuncBlock->pUserData)->nReturnType == MEMOBJ_NEVER ){` |
...
|  1924533 |  5121 | `	pGen->pIn++;` |
|  1924533 |  5122 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|        - |  5123 | `		/* Compile the expression */` |
|  1889619 |  5124 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|  1889619 |  5125 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 |  5126 | `			return SXERR_ABORT;` |
|  1889619 |  5127 | `		}else if(rc != SXERR_EMPTY ){` |
|  1889619 |  5128 | `			nRet = 1;` |
|   944807 |  5129 | `		}` |
|   944807 |  5130 | `	}` |
...
|  1924533 |  5135 | `	if( pGen->bInGenerator ){` |
...
|  1920629 |  5144 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,nRet,1,0,0);` |
|  1920629 |  5145 | `	return SXRET_OK;` |
|   962269 |  5146 | `}` |
|        - |  5147 | `/*` |
...
|        - |  5258 | ` */` |
|    17536 |  5259 | `static sxi32 PH7_CompileEcho(ph7_gen_state *pGen)` |
|        5 |  5260 | `{` |
|    17541 |  5261 | `	SyToken *pTmp,*pNext = 0;` |
|        - |  5262 | `	sxi32 rc;` |
|        - |  5263 | `	/* Jump the 'echo' keyword */` |
|    17541 |  5264 | `	pGen->pIn++;` |
|        - |  5265 | `	/* Compile arguments one after one */` |
|    17541 |  5266 | `	pTmp = pGen->pEnd;` |
|    43325 |  5267 | `	while( SXRET_OK == PH7_GetNextExpr(pGen->pIn,pTmp,&pNext) ){` |
|    25789 |  5268 | `		if( pGen->pIn < pNext ){` |
|    25789 |  5269 | `			pGen->pEnd = pNext;` |
|    25789 |  5270 | `			rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_RDONLY_LOAD/* Do not create variable if inexistant */,0);` |
|    25789 |  5271 | `			if( rc == SXERR_ABORT ){` |
|      ! 0 |  5272 | `				return SXERR_ABORT;` |
|    25789 |  5273 | `			}else if( rc != SXERR_EMPTY ){` |
|        - |  5274 | `				/* Emit the consume instruction */` |
|    25765 |  5275 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_CONSUME,1,0,0,0);` |
|    12880 |  5276 | `			}` |
|    12892 |  5277 | `		}` |
|        - |  5278 | `		/* Jump trailing commas */` |
|    34037 |  5279 | `		while( pNext < pTmp && (pNext->nType & PH7_TK_COMMA) ){` |
|     8253 |  5280 | `			pNext++;` |
|        5 |  5281 | `		}` |
|    25789 |  5282 | `		pGen->pIn = pNext;` |
|        5 |  5283 | `	}` |
|        - |  5284 | `	/* Restore token stream */` |
|    17541 |  5285 | `	pGen->pEnd = pTmp;` |
|    17541 |  5286 | `	return SXRET_OK;` |
|     8773 |  5287 | `}` |
|        - |  5288 | `/*` |
...
|        - |  5467 | ` */` |
|  3333510 |  5468 | `static sxu32 GenStateNsQualifyName(ph7_gen_state *pGen,sxu32 nOrigIdx,SyHash *pImports,int *pFromImport)` |
|        5 |  5469 | `{` |
|        - |  5470 | `	ph7_value *pLit;` |
...
|        - |  5478 | `	ph7_value *pNew;` |
|  3333515 |  5479 | `	if( pFromImport ){` |
|  2694437 |  5480 | `		*pFromImport = 0;` |
|  1347216 |  5481 | `	}` |
|  3333515 |  5482 | `	pLit = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,nOrigIdx);` |
|  3333515 |  5483 | `	if( !pLit \|\| !(pLit->iFlags & MEMOBJ_STRING) \|\| SyBlobLength(&pLit->sBlob) == 0 ){` |
|      ! 0 |  5484 | `		return nOrigIdx;` |
|        - |  5485 | `	}` |
|  3333515 |  5486 | `	zLit = (const char *)SyBlobData(&pLit->sBlob);` |
|  3333515 |  5487 | `	nLit = (sxu32)SyBlobLength(&pLit->sBlob);` |
|        - |  5488 | `	/* Skip if already qualified (contains backslash) */` |
|  3333515 |  5489 | `	hasNsSep = 0;` |
| 43293527 |  5490 | `	for( k = 0; k < nLit; k++ ){` |
| 39960025 |  5491 | `		if( zLit[k] == '\\' ){ hasNsSep = 1; break; }` |
| 19980011 |  5492 | `	}` |
|  3333515 |  5493 | `	if( hasNsSep ){` |
|       11 |  5494 | `		return nOrigIdx;` |
|        - |  5495 | `	}` |
|        - |  5496 | `	/* Check use imports first (works even outside namespaces) */` |
|  3333507 |  5497 | `	SyBlobReset(&pGen->sWorker);` |
|  3333507 |  5498 | `	pImport = SyHashGet(pImports,(const void *)zLit,nLit);` |
|  3333507 |  5499 | `	if( pImport ){` |
...
|        8 |  5504 | `		}` |
|       23 |  5505 | `	}else{` |
|  3333471 |  5506 | `		if( SyBlobLength(&pGen->sNamespace) == 0 ){` |
|  3333381 |  5507 | `			return nOrigIdx; /* Not in a namespace and no import match */` |
|        - |  5508 | `		}` |
...
|        - |  5530 | ` */` |
|   241726 |  5531 | `static void GenStateResolveName(ph7_gen_state *pGen,const SyString *pName,SyBlob *pOut)` |
|        5 |  5532 | `{` |
|        - |  5533 | `	SyHashEntry *pImport;` |
|        - |  5534 | `	/* Check use imports first */` |
|   241731 |  5535 | `	pImport = SyHashGet(&pGen->hUseImports,(const void *)pName->zString,pName->nByte);` |
|   241731 |  5536 | `	if( pImport ){` |
...
|        - |  5552 | ` */` |
|   312010 |  5553 | `static void GenStateBuildFQN(ph7_gen_state *pGen,const SyString *pName,SyBlob *pOut)` |
|        5 |  5554 | `{` |
|   312015 |  5555 | `	if( SyBlobLength(&pGen->sNamespace) > 0 ){` |
|     3939 |  5556 | `		SyBlobAppend(pOut,SyBlobData(&pGen->sNamespace),SyBlobLength(&pGen->sNamespace));` |
|     3939 |  5557 | `		SyBlobAppend(pOut,"\\",1);` |
|     1967 |  5558 | `	}` |
|   312015 |  5559 | `	SyBlobAppend(pOut,pName->zString,pName->nByte);` |
|   312015 |  5560 | `}` |
|        - |  5561 | `/*` |
...
|        - |  6057 | ` */` |
|   348998 |  6058 | `static sxi32 GenStateProcessArgValue(ph7_gen_state *pGen,ph7_vm_func_arg *pArg,SyToken *pIn,SyToken *pEnd)` |
|        5 |  6059 | `{` |
|        - |  6060 | `	SyToken *pTmpIn,*pTmpEnd;` |
|        - |  6061 | `	SySet *pInstrContainer;` |
|        - |  6062 | `	sxi32 rc;` |
|        - |  6063 | `	/* Swap token stream */` |
|   349003 |  6064 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|   349003 |  6065 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   349003 |  6066 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pArg->aByteCode);` |
|        - |  6067 | `	/* Compile the expression holding the argument value */` |
|   349003 |  6068 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|        - |  6069 | `	/* Emit the done instruction */` |
|   349003 |  6070 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,(rc != SXERR_EMPTY ? 1 : 0),0,0,0);` |
|   349003 |  6071 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|   349003 |  6072 | `	RE_SWAP_DELIMITER(pGen);` |
|   349003 |  6073 | `	if( rc == SXERR_ABORT ){` |
|      ! 0 |  6074 | `		return SXERR_ABORT;` |
|        - |  6075 | `	}` |
|   349003 |  6076 | `	return SXRET_OK;` |
|   174504 |  6077 | `}` |
|        - |  6078 | `/*` |
...
|        - |  6114 | ` */` |
|   722822 |  6115 | `static sxi32 GenStateCollectFuncArgs(ph7_vm_func *pFunc,ph7_gen_state *pGen,SyToken *pEnd,int bCtorCtx,int bAbstractCtx)` |
|        5 |  6116 | `{` |
...
|        - |  6121 | `	sxi32 rc;` |
|        - |  6122 |  |
|   722827 |  6123 | `	pIn = pGen->pIn;` |
|   722827 |  6124 | `	SyBlobInit(&sSig,&pGen->pVm->sAllocator);` |
|        - |  6125 | `	/* Process arguments one after one */` |
|   938402 |  6126 | `	for(;;){` |
|  1876809 |  6127 | `		if( pIn >= pEnd ){` |
|        - |  6128 | `			/* No more arguments to process */` |
|   722811 |  6129 | `			break;` |
|        - |  6130 | `		}` |
|  1154003 |  6131 | `		SyZero(&sArg,sizeof(ph7_vm_func_arg));` |
|  1154003 |  6132 | `		SySetInit(&sArg.aByteCode,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|  1154003 |  6133 | `		SySetInit(&sArg.aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|  1154003 |  6134 | `		SySetInit(&sArg.aAttrs,&pGen->pVm->sAllocator,sizeof(ph7_attribute));` |
|  1154003 |  6135 | `		SyStringInitFromBuf(&sArg.sTypeName,0,0);` |
|        - |  6136 | `		/* Parameter #[...] attributes: the group precedes the parameter's` |
|        - |  6137 | `		 * first token inside the main token stream */` |
|  1154003 |  6138 | `		if( GenStateCollectParamAttrs(&(*pGen),pIn,&sArg.aAttrs) == SXERR_ABORT ){` |
...
|        - |  6146 | `		{` |
|  1154003 |  6147 | `			int bReadonly = 0, bVisSeen = 0;` |
|  1154003 |  6148 | `			sxi32 iVis = PH7_CLASS_PROT_PUBLIC;` |
|  1154003 |  6149 | `			sxi32 iSetVisFlag = 0;` |
|        - |  6150 | `			int nSetTok;` |
|        - |  6151 | `			sxi32 nSetVis;` |
|  1154003 |  6152 | `			if( pIn < pEnd && GenStateIsReadonly(pIn) ){` |
|        3 |  6153 | `				bReadonly = 1;` |
|        3 |  6154 | `				pIn++;` |
|        1 |  6155 | `			}` |
|  1154003 |  6156 | `			nSetVis = GenStatePeekSetVisibility(pIn,pEnd,&nSetTok);` |
|  1154003 |  6157 | `			if( nSetVis ){` |
...
|      ! 0 |  6164 | `					pIn++;` |
|        1 |  6165 | `				}` |
|  1154002 |  6166 | `			}else if( pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD) ){` |
...
|       42 |  6184 | `				}` |
|    44771 |  6185 | `			}` |
|  1154003 |  6186 | `			if( iSetVisFlag == PH7_CLASS_ATTR_PRIVATE_SET ){` |
|        5 |  6187 | `				sArg.iFlags \|= VM_FUNC_ARG_PRIV_SET;` |
|  1154001 |  6188 | `			}else if( iSetVisFlag == PH7_CLASS_ATTR_PROTECTED_SET ){` |
|      ! 0 |  6189 | `				sArg.iFlags \|= VM_FUNC_ARG_PROT_SET;` |
|      ! 0 |  6190 | `			}` |
|  1154003 |  6191 | `			if( bVisSeen \|\| bReadonly ){` |
|       93 |  6192 | `				if( !bCtorCtx ){` |
...
|  1153994 |  6213 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_DOLLAR) == 0` |
|   641264 |  6214 | `			&& (pIn->nType & PH7_TK_AMPER) == 0` |
|   126585 |  6215 | `			&& (pIn->nType & PH7_TK_ELLIPSIS) == 0 ){` |
...
|    52577 |  6243 | `		}` |
|  1153989 |  6244 | `		if( pIn >= pEnd ){` |
|      ! 0 |  6245 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Missing argument name");` |
|      ! 0 |  6246 | `			return rc;` |
|        - |  6247 | `		}` |
|  1153989 |  6248 | `		if( pIn->nType & PH7_TK_AMPER ){` |
|        - |  6249 | `			/* Pass by reference,record that */` |
|     3921 |  6250 | `			sArg.iFlags \|= VM_FUNC_ARG_BY_REF;` |
|     3921 |  6251 | `			pIn++;` |
|     1958 |  6252 | `		}` |
|  1153989 |  6253 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_ELLIPSIS) ){` |
|        - |  6254 | `			/* Variadic parameter: ...$args */` |
|    19489 |  6255 | `			sArg.iFlags \|= VM_FUNC_ARG_VARIADIC;` |
|    19489 |  6256 | `			pIn++;` |
|     9742 |  6257 | `		}` |
|  1153989 |  6258 | `		if( pIn >= pEnd \|\| (pIn->nType & PH7_TK_DOLLAR) == 0 \|\| &pIn[1] >= pEnd \|\| (pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|        - |  6259 | `			/* Invalid argument */` |
|      ! 0 |  6260 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Invalid argument name");` |
|      ! 0 |  6261 | `			return rc;` |
|        - |  6262 | `		}` |
|  1153989 |  6263 | `		pIn++; /* Jump the dollar sign */` |
|        - |  6264 | `		/* Copy argument name */` |
|  1153989 |  6265 | `		zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,SyStringData(&pIn->sData),SyStringLength(&pIn->sData));` |
|  1153989 |  6266 | `		if( zDup == 0 ){` |
|      ! 0 |  6267 | `			PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"PH7 engine is running out of memory");` |
|      ! 0 |  6268 | `			return SXERR_ABORT;` |
|        - |  6269 | `		}` |
|  1153989 |  6270 | `		SyStringInitFromBuf(&sArg.sName,zDup,SyStringLength(&pIn->sData));` |
|  1153989 |  6271 | `		pIn++;` |
|  1153989 |  6272 | `		if( pIn < pEnd ){` |
|   652229 |  6273 | `			if( pIn->nType & PH7_TK_EQUAL ){` |
|        - |  6274 | `				SyToken *pDefend;` |
|   349005 |  6275 | `				sxi32 iNest = 0;` |
|   349005 |  6276 | `				pIn++; /* Jump the equal sign */` |
|   349005 |  6277 | `				pDefend = pIn;` |
|        - |  6278 | `				/* Process the default value associated with this argument */` |
|   729039 |  6279 | `				while( pDefend < pEnd ){` |
|   507997 |  6280 | `					if( (pDefend->nType & PH7_TK_COMMA) && iNest <= 0 ){` |
|   127963 |  6281 | `						break;` |
|        - |  6282 | `					}` |
|   380039 |  6283 | `					if( pDefend->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*[*/) ){` |
|        - |  6284 | `						/* Increment nesting level */` |
|    15517 |  6285 | `						iNest++;` |
|   372283 |  6286 | `					}else if( pDefend->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CCB/*'}'*/\|PH7_TK_CSB/*]*/) ){` |
|        - |  6287 | `						/* Decrement nesting level */` |
|    15517 |  6288 | `						iNest--;` |
|     7756 |  6289 | `					}` |
|   380039 |  6290 | `					pDefend++;` |
|        5 |  6291 | `				}` |
|   349005 |  6292 | `				if( pIn >= pDefend ){` |
|        3 |  6293 | `					rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Missing argument default value");` |
|        3 |  6294 | `					return rc;` |
|        - |  6295 | `				}` |
|        - |  6296 | `				/* Process default value */` |
|   349003 |  6297 | `				rc = GenStateProcessArgValue(&(*pGen),&sArg,pIn,pDefend);` |
|   349003 |  6298 | `				if( rc != SXRET_OK ){` |
|      ! 0 |  6299 | `					return rc;` |
|        - |  6300 | `				}` |
...
|   348998 |  6306 | `				if( (sArg.nType > 0 \|\| (sArg.iFlags & VM_FUNC_ARG_UNION))` |
|   199716 |  6307 | `					&& (sArg.iFlags & VM_FUNC_ARG_NULLABLE) == 0` |
|   199713 |  6308 | `					&& &pIn[1] == pDefend` |
...
|   349003 |  6330 | `				pIn = pDefend;` |
|   174499 |  6331 | `			}` |
|   652227 |  6332 | `			if( pIn < pEnd && (pIn->nType & PH7_TK_COMMA) == 0 ){` |
|      ! 0 |  6333 | `				rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Unexpected token '%z'",&pIn->sData);` |
|      ! 0 |  6334 | `				return rc;` |
|        - |  6335 | `			}` |
|   652227 |  6336 | `			pIn++; /* Jump the trailing comma */` |
|   326111 |  6337 | `		}` |
|        - |  6338 | `		/* Append argument signature */` |
|  1153987 |  6339 | `		if( sArg.nType > 0 ){` |
...
|        - |  6382 | `			 */` |
|  1048895 |  6383 | `			SyBlobRelease(&sSig);` |
|        - |  6384 | `		}` |
|        - |  6385 | `		/* Save in the argument set */` |
|  1153987 |  6386 | `		SySetPut(&pFunc->aArgs,(const void *)&sArg);` |
|        5 |  6387 | `	}` |
|   722811 |  6388 | `	if( SyBlobLength(&sSig) > 0 ){` |
|        - |  6389 | `		/* Save function signature */` |
|    74017 |  6390 | `		SyStringInitFromBuf(&pFunc->sSignature,SyBlobData(&sSig),SyBlobLength(&sSig));` |
|    37006 |  6391 | `	}` |
|   722811 |  6392 | `	return SXRET_OK;` |
|   361416 |  6393 | `}` |
|        - |  6394 | `/*` |
...
|     2075 |  6561 | `}` |
|  1685678 |  6562 | `static int GenStateFuncBodyHasYield(ph7_gen_state *pGen)` |
|        5 |  6563 | `{` |
|  1685683 |  6564 | `	SyToken *pIn = pGen->pIn;   /* expected at the body's opening '{' */` |
|  1685683 |  6565 | `	SyToken *pEnd = pGen->pEnd;` |
|  1685683 |  6566 | `	sxi32 iDepth = 0;` |
|  1685683 |  6567 | `	int bStarted = 0;` |
| 78695285 |  6568 | `	while( pIn < pEnd ){` |
| 78695285 |  6569 | `		sxu32 t = pIn->nType;` |
| 78695285 |  6570 | `		if( t & PH7_TK_OCB ){ iDepth++; bStarted = 1; pIn++; continue; }` |
| 75148167 |  6571 | `		if( t & PH7_TK_CCB ){ iDepth--; pIn++; if( bStarted && iDepth <= 0 ){ break; } continue; }` |
| 71616931 |  6572 | `		if( t & PH7_TK_KEYWORD ){` |
|  5447131 |  6573 | `			int kw = SX_PTR_TO_INT(pIn->pUserData);` |
|  5447131 |  6574 | `			if( kw == PH7_TKWRD_YIELD ){ return TRUE; }` |
|  5442991 |  6575 | `			if( kw == PH7_TKWRD_FUNCTION ){ pIn = GenStateSkipNestedFunc(pIn,pEnd); continue; }` |
|        - |  6576 | ``			/* `fn` arrow bodies are single expressions and cannot contain a valid yield. */`` |
|  2704030 |  6577 | `		}` |
| 71577865 |  6578 | `		pIn++;` |
|        5 |  6579 | `	}` |
|  1681543 |  6580 | `	return FALSE;` |
|   842844 |  6581 | `}` |
|        - |  6582 | `/*` |
...
|        - |  6586 | ` */` |
|  1685678 |  6587 | `static sxi32 GenStateCompileFuncBody(` |
...
|  1685683 |  6597 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC,PH7_VmInstrLength(pGen->pVm),pFunc,&pBlock);` |
|  1685683 |  6598 | `	if( rc != SXRET_OK ){` |
...
|        - |  6602 | `	}` |
|  1685683 |  6603 | `	nGotoOfft = SySetUsed(&pGen->aGoto);` |
|        - |  6604 | `	/* Swap bytecode containers */` |
|  1685683 |  6605 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|  1685683 |  6606 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pFunc->aByteCode);` |
...
|        - |  6611 | `	{` |
|  1685683 |  6612 | `		sxu32 nArg = SySetUsed(&pFunc->aArgs);` |
|        - |  6613 | `		sxu32 i;` |
|  2808543 |  6614 | `		for( i = 0; i < nArg; i++ ){` |
|  1122865 |  6615 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pFunc->aArgs,i);` |
|        - |  6616 | `			char *zSrc;` |
|        - |  6617 | `			sxu32 nSrc,nName;` |
|        - |  6618 | `			SySet sToken;` |
|        - |  6619 | `			SyToken *pTmpIn,*pTmpEnd;` |
|        - |  6620 | `			sxi32 rcPromote;` |
|  1122865 |  6621 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|  1122791 |  6622 | `				continue;` |
|        - |  6623 | `			}` |
...
|        - |  6673 | `	{` |
|  1685683 |  6674 | `		sxi8 bSavedGen = pGen->bInGenerator;` |
|  1685683 |  6675 | `		pGen->bInGenerator = (sxi8)GenStateFuncBodyHasYield(&(*pGen));` |
|        - |  6676 | `		/* Compile the body */` |
|  1685683 |  6677 | `		PH7_CompileBlock(&(*pGen),0);` |
|  1685683 |  6678 | `		pGen->bInGenerator = bSavedGen;` |
|        - |  6679 | `	}` |
|        - |  6680 | `	/* Fix exception jumps now the destination is resolved */` |
|  1685683 |  6681 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|        - |  6682 | `	/* Emit the final return if not yet done */` |
|  1685683 |  6683 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|        - |  6684 | `	/* Fix gotos jumps now the destination is resolved */` |
|  1685683 |  6685 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),nGotoOfft) ){` |
|      ! 0 |  6686 | `		rc = SXERR_ABORT;` |
|      ! 0 |  6687 | `	}` |
|  1685683 |  6688 | `	SySetTruncate(&pGen->aGoto,nGotoOfft);` |
|        - |  6689 | `	/* Restore the default container */` |
|  1685683 |  6690 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|        - |  6691 | `	/* Leave function block */` |
|  1685683 |  6692 | `	GenStateLeaveBlock(&(*pGen),0);` |
|  1685683 |  6693 | `	if( rc == SXERR_ABORT ){` |
...
|        - |  6698 | `	{` |
|  1685683 |  6699 | `		VmInstr *aInstr = (VmInstr *)SySetBasePtr(&pFunc->aByteCode);` |
|        - |  6700 | `		sxu32 i;` |
| 48169997 |  6701 | `		for( i = 0; i < SySetUsed(&pFunc->aByteCode); i++ ){` |
| 46488459 |  6702 | `			if( aInstr[i].iOp == PH7_OP_YIELD \|\| aInstr[i].iOp == PH7_OP_YIELD_FROM ){` |
|     4145 |  6703 | `				pFunc->iFlags \|= VM_FUNC_GENERATOR;` |
|     4145 |  6704 | `				break;` |
|        - |  6705 | `			}` |
| 23242162 |  6706 | `		}` |
|        - |  6707 | `	}` |
|  1685683 |  6708 | `	if( pFunc->iFlags & VM_FUNC_GENERATOR ){` |
...
|        - |  7364 | ` */` |
|  1786744 |  7365 | `static sxi32 GenStateParseReturnType(ph7_gen_state *pGen, ph7_vm_func *pFunc)` |
|        5 |  7366 | `{` |
|  1786749 |  7367 | `	sxi32 iFlags = 0;` |
|        - |  7368 | `	sxi32 rc;` |
|        - |  7369 | `	sxu32 nLine;` |
|  1786749 |  7370 | `	pFunc->nReturnType = 0;` |
|  1786749 |  7371 | `	SyStringInitFromBuf(&pFunc->sReturnClass, 0, 0);` |
|  1786749 |  7372 | `	SyStringInitFromBuf(&pFunc->sReturnTypeName, 0, 0);` |
...
|  1786749 |  7378 | `	SySetReset(&pFunc->aReturnUnion);` |
|  1786749 |  7379 | `	pFunc->iFlags &= ~VM_FUNC_RETURN_NULLABLE;` |
|  1786749 |  7380 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COLON) == 0 ){` |
|  1782217 |  7381 | `		return SXRET_OK;` |
|        - |  7382 | `	}` |
...
|   893377 |  7420 | `}` |
|        - |  7421 |  |
|   199616 |  7422 | `static sxi32 GenStateCompileFunc(` |
...
|   199621 |  7436 | `	nLine = pGen->pIn->nLine;` |
|        - |  7437 | `	/* Jump the left parenthesis '(' */` |
|   199621 |  7438 | `	pGen->pIn++;` |
|        - |  7439 | `	/* Delimit the function signature */` |
|   199621 |  7440 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   199621 |  7441 | `	if( pEnd >= pGen->pEnd ){` |
|        - |  7442 | `		/* Syntax error */` |
...
|   199615 |  7452 | `	pFunc = (ph7_vm_func *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_vm_func));` |
|   199615 |  7453 | `	if( pFunc == 0 ){` |
|      ! 0 |  7454 | `		goto OutOfMem;` |
|        - |  7455 | `	}` |
|        - |  7456 | `	/* Build the function name, prepending namespace if active */` |
|   199622 |  7457 | `	if( SyBlobLength(&pGen->sNamespace) > 0 && !bHandleClosure ){` |
|        - |  7458 | `		SyBlob sFQN;` |
|        - |  7459 | `		sxu32 nLen;` |
...
|        9 |  7471 | `	}else{` |
|   199601 |  7472 | `		zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|   199601 |  7473 | `		if( zName == 0 ){` |
|      ! 0 |  7474 | `			goto OutOfMem;` |
|        - |  7475 | `		}` |
|   199601 |  7476 | `		PH7_VmInitFuncState(pGen->pVm,pFunc,zName,pName->nByte,iFlags,0);` |
|        - |  7477 | `	}` |
...
|   199615 |  7480 | `	pFunc->nLine = nLine;` |
|   199615 |  7481 | `	GenStateConsumeDoc(&(*pGen),&pFunc->sDoc);` |
|   199615 |  7482 | `	if( GenStateConsumeAttrs(&(*pGen),&pFunc->aAttrs) == SXERR_ABORT ){` |
|      ! 0 |  7483 | `		return SXERR_ABORT;` |
|        - |  7484 | `	}` |
|   199615 |  7485 | `	if( pGen->pIn < pEnd ){` |
|        - |  7486 | `		/* Collect function arguments */` |
|   179397 |  7487 | `		rc = GenStateCollectFuncArgs(pFunc,&(*pGen),pEnd,0,0);` |
|   179397 |  7488 | `		if( rc == SXERR_ABORT ){` |
...
|   199615 |  7494 | `	pGen->pIn = &pEnd[1];` |
|        - |  7495 | `	{` |
|   199615 |  7496 | `		sxi32 rcRt = GenStateParseReturnType(pGen, pFunc);` |
|   199615 |  7497 | `		if( rcRt == SXERR_ABORT ){` |
|      ! 0 |  7498 | `			return SXERR_ABORT;` |
|   199615 |  7499 | `		}else if( rcRt == SXERR_SYNTAX ){` |
|        8 |  7500 | `			return SXERR_SYNTAX;` |
|        - |  7501 | `		}` |
|        - |  7502 | `	}` |
|   199609 |  7503 | `	if( bHandleClosure ){` |
...
|   199609 |  7613 | `	rc = GenStateCompileFuncBody(&(*pGen),pFunc);` |
|   199609 |  7614 | `	if( rc == SXERR_ABORT ){` |
|      ! 0 |  7615 | `		return SXERR_ABORT;` |
|        - |  7616 | `	}` |
|        - |  7617 | `	/* The cursor sits just past the body's closing brace */` |
|   199609 |  7618 | `	pFunc->nEndLine = pGen->pIn[-1].nLine;` |
|   199609 |  7619 | `	if( ppFunc ){` |
|   199609 |  7620 | `		*ppFunc = pFunc;` |
|    99802 |  7621 | `	}` |
|   199609 |  7622 | `	rc = SXRET_OK;` |
|   199609 |  7623 | `	if( (pFunc->iFlags & VM_FUNC_CLOSURE) == 0 ){` |
|        - |  7624 | `		/* Finally register the function */` |
|   199151 |  7625 | `		rc = PH7_VmInstallUserFunction(pGen->pVm,pFunc,0);` |
|    99573 |  7626 | `	}` |
|   199609 |  7627 | `	if( rc == SXRET_OK ){` |
|   199609 |  7628 | `		return SXRET_OK;` |
|        - |  7629 | `	}` |
...
|        - |  7641 | ` */` |
|   199160 |  7642 | `static sxi32 PH7_CompileFunction(ph7_gen_state *pGen)` |
|        5 |  7643 | `{` |
|        - |  7644 | `	SyString *pName;` |
|        - |  7645 | `	sxi32 iFlags;` |
|        - |  7646 | `	sxu32 nKwLine;` |
...
|        - |  7648 | `	sxi32 rc;` |
|        - |  7649 |  |
|   199165 |  7650 | `	nLine = pGen->pIn->nLine;` |
|   199165 |  7651 | `	nKwLine = nLine; /* Line of the 'function' keyword (Reflection getStartLine) */` |
|   199165 |  7652 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|   199165 |  7653 | `	iFlags = 0;` |
|   199165 |  7654 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|        - |  7655 | `		/* Return by reference,remember that */` |
|       12 |  7656 | `		iFlags \|= VM_FUNC_REF_RETURN;` |
|        - |  7657 | `		/* Jump the '&' token */` |
|       12 |  7658 | `		pGen->pIn++;` |
|        5 |  7659 | `	}` |
|   199165 |  7660 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|        - |  7671 | `	}` |
|   199159 |  7672 | `	pName = &pGen->pIn->sData;` |
|   199159 |  7673 | `	nLine = pGen->pIn->nLine;` |
|        - |  7674 | `	/* Jump the function name */` |
|   199159 |  7675 | `	pGen->pIn++;` |
|   199159 |  7676 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|        - |  7677 | `		/* Syntax error */` |
...
|        - |  7690 | `	{` |
|   199157 |  7691 | `		ph7_vm_func *pFuncState = 0;` |
|   199157 |  7692 | `		rc = GenStateCompileFunc(&(*pGen),pName,iFlags,FALSE,&pFuncState);` |
|   199157 |  7693 | `		if( pFuncState ){` |
|        - |  7694 | `			/* Reflection getStartLine(): line of the 'function' keyword */` |
|   199145 |  7695 | `			pFuncState->nLine = nKwLine;` |
|    99570 |  7696 | `		}` |
|        - |  7697 | `	}` |
|   199157 |  7698 | `	return rc;` |
|    99585 |  7699 | `}` |
|        - |  7700 | `/*` |
...
|        - |  7710 | ` */` |
|  2095756 |  7711 | `static sxi32 GetProtectionLevel(sxi32 nKeyword)` |
|        5 |  7712 | `{` |
|  2095761 |  7713 | `	if( nKeyword == PH7_TKWRD_PRIVATE ){` |
|    66073 |  7714 | `		return PH7_CLASS_PROT_PRIVATE;` |
|  2029693 |  7715 | `	}else if( nKeyword == PH7_TKWRD_PROTECTED ){` |
|   182255 |  7716 | `		return PH7_CLASS_PROT_PROTECTED;` |
|        - |  7717 | `	}` |
|        - |  7718 | `	/* Assume public by default */` |
|  1847443 |  7719 | `	return PH7_CLASS_PROT_PUBLIC;` |
|  1047883 |  7720 | `}` |
|        - |  7721 | `/*` |
...
|        - |  7749 | ` */` |
|   205604 |  7750 | `static int GenStateClassConstHasType(ph7_gen_state *pGen)` |
|        5 |  7751 | `{` |
|        - |  7752 | `	SyToken *p0, *p1;` |
|   205609 |  7753 | `	if( pGen->pIn >= pGen->pEnd ){` |
|      ! 0 |  7754 | `		return 0;` |
|        - |  7755 | `	}` |
|   205609 |  7756 | `	p0 = pGen->pIn;` |
|        - |  7757 | `	/* A leading '\' (namespaced class type) or '?' (nullable) always starts a type */` |
|   205609 |  7758 | `	if( p0->nType & PH7_TK_NSSEP ){` |
|      ! 0 |  7759 | `		return 1;` |
|        - |  7760 | `	}` |
|   205609 |  7761 | `	if( (p0->nType & PH7_TK_OP) && p0->sData.nByte == 1 && p0->sData.zString[0] == '?' ){` |
|        5 |  7762 | `		return 1;` |
|        - |  7763 | `	}` |
...
|   205605 |  7767 | `	if( p0->nType & (PH7_TK_ID\|PH7_TK_KEYWORD) ){` |
|   205605 |  7768 | `		p1 = (pGen->pIn + 1 < pGen->pEnd) ? (pGen->pIn + 1) : 0;` |
|   205605 |  7769 | `		if( p1 ){` |
|   205605 |  7770 | `			if( p1->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_NSSEP) ){` |
|       34 |  7771 | `				return 1;` |
|        - |  7772 | `			}` |
|   205575 |  7773 | `			if( (p1->nType & PH7_TK_OP) && p1->sData.nByte == 1 && p1->sData.zString[0] == '\|' ){` |
|        5 |  7774 | `				return 1;` |
|        - |  7775 | `			}` |
|   102783 |  7776 | `		}` |
|   102783 |  7777 | `	}` |
|   205571 |  7778 | `	return 0;` |
|   102807 |  7779 | `}` |
|        - |  7780 | `/*` |
...
|        - |  7833 | ` */` |
|   384574 |  7834 | `static int GenStateInitHasNewExpr(ph7_gen_state *pGen)` |
|        5 |  7835 | `{` |
|   384579 |  7836 | `	SyToken *p = pGen->pIn;` |
|   384579 |  7837 | `	int iDepth = 0;` |
|   964037 |  7838 | `	while( p < pGen->pEnd ){` |
|   964037 |  7839 | `		if( iDepth == 0 && (p->nType & (PH7_TK_SEMI\|PH7_TK_COMMA)) ){` |
|   384527 |  7840 | `			break; /* end of this initializer */` |
|        - |  7841 | `		}` |
|   579510 |  7842 | `		if( (p->nType & PH7_TK_KEYWORD)` |
|   293652 |  7843 | `			&& ( SX_PTR_TO_INT(p->pUserData) == PH7_TKWRD_FUNCTION` |
...
|        3 |  7902 | `			continue;` |
|        - |  7903 | `		}` |
|   579513 |  7904 | `		if( p->nType & PH7_TK_OCB ){` |
|       45 |  7905 | `			if( iDepth == 0 ){` |
...
|        - |  7911 | `			}` |
|      ! 0 |  7912 | `			iDepth++;` |
|   579469 |  7913 | `		}else if( p->nType & (PH7_TK_LPAREN\|PH7_TK_OSB) ){` |
|     7839 |  7914 | `			iDepth++;` |
|   575552 |  7915 | `		}else if( p->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB) ){` |
|     7837 |  7916 | `			if( iDepth > 0 ){` |
|     7837 |  7917 | `				iDepth--;` |
|     3916 |  7918 | `			}` |
|   567719 |  7919 | `		}else if( (p->nType & PH7_TK_OP) && p->pUserData` |
|   179077 |  7920 | `			&& ((const ph7_expr_op *)p->pUserData)->iOp == EXPR_OP_NEW ){` |
...
|       11 |  7952 | `	}` |
|      355 |  7953 | `}` |
|   205604 |  7954 | `static sxi32 GenStateCompileClassConstant(ph7_gen_state *pGen,sxi32 iProtection,sxi32 iFlags,ph7_class *pClass)` |
|        5 |  7955 | `{` |
|   205609 |  7956 | `	sxu32 nLine = pGen->pIn->nLine;` |
|        - |  7957 | `	SySet *pInstrContainer;` |
|        - |  7958 | `	ph7_class_attr *pCons;` |
|        - |  7959 | `	SyString *pName;` |
|        - |  7960 | `	sxi32 rc;` |
|   205609 |  7961 | `	sxu32 nType = 0;` |
|        - |  7962 | `	SyString sTypeClass;` |
|        - |  7963 | `	SyString sTypeText;` |
|        - |  7964 | `	SySet aUnionAlts;` |
|   205609 |  7965 | `	sxi32 iTypeFlags = 0;` |
|   205609 |  7966 | `	SyStringInitFromBuf(&sTypeClass,0,0);` |
|   205609 |  7967 | `	SyStringInitFromBuf(&sTypeText,0,0);` |
|   205609 |  7968 | `	SySetInit(&aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|        - |  7969 | `	/* Extract visibility level */` |
|   205609 |  7970 | `	iProtection = GetProtectionLevel(iProtection);` |
|        - |  7971 | `	/* Mark as constant */` |
|   205609 |  7972 | `	iFlags \|= PH7_CLASS_ATTR_CONSTANT;` |
|   205609 |  7973 | `	pGen->pIn++; /* Jump the 'const' keyword */` |
...
|   205628 |  7976 | `	if( GenStateClassConstHasType(pGen) ){` |
...
|       19 |  7997 | `	}` |
|   102802 |  7998 | `loop:` |
|   205611 |  7999 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
...
|   205611 |  8009 | `	pName = &pGen->pIn->sData;` |
|        - |  8010 | `	/* Make sure the constant name isn't reserved */` |
|   205611 |  8011 | `	if( GenStateIsReservedConstant(pName) ){` |
...
|   205611 |  8021 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
...
|   205609 |  8032 | `	pGen->pIn++;` |
|   205609 |  8033 | `	if(pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_EQUAL /* '=' */) == 0 ){` |
...
|        - |  8041 | `	}` |
|   205609 |  8042 | `	pGen->pIn++; /* Jump the equal sign */` |
...
|   205604 |  8047 | `	if( (iTypeFlags & PH7_CLASS_ATTR_TYPED) && !(iTypeFlags & PH7_CLASS_ATTR_UNION)` |
...
|   205605 |  8060 | `	if( GenStateInitHasNewExpr(pGen) ){` |
...
|   205601 |  8069 | `	pCons = PH7_NewClassAttr(pGen->pVm,pName,nLine,iProtection,iFlags\|iTypeFlags);` |
|   205601 |  8070 | `	if( pCons ){` |
|   205601 |  8071 | `		GenStateConsumeDoc(&(*pGen),&pCons->sDoc);` |
|   205601 |  8072 | `		if( GenStateConsumeAttrs(&(*pGen),&pCons->aAttrs) == SXERR_ABORT ){` |
|      ! 0 |  8073 | `			return SXERR_ABORT;` |
|        - |  8074 | `		}` |
|   102798 |  8075 | `	}` |
|   205601 |  8076 | `	if( pCons == 0 ){` |
|      ! 0 |  8077 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 |  8078 | `		return SXERR_ABORT;` |
|        - |  8079 | `	}` |
|   205601 |  8080 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|       35 |  8081 | `		GenStateCopyTypeToAttr(pCons,nType,&sTypeClass,&sTypeText,iTypeFlags,&aUnionAlts);` |
|       16 |  8082 | `	}` |
|        - |  8083 | `	/* Swap bytecode container */` |
|   205601 |  8084 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   205601 |  8085 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pCons->aByteCode);` |
|        - |  8086 | `	/* Compile constant value.` |
|        - |  8087 | `	 */` |
|   205601 |  8088 | `	rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|   205601 |  8089 | `	if( rc == SXERR_EMPTY ){` |
...
|   205601 |  8096 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|   205601 |  8097 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|   205601 |  8098 | `	if( rc == SXERR_ABORT ){` |
...
|   205601 |  8103 | `	rc = PH7_ClassInstallAttr(pClass,pCons);` |
|   205601 |  8104 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  8105 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 |  8106 | `		return SXERR_ABORT;` |
|        - |  8107 | `	}` |
|   205601 |  8108 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA /*','*/) ){` |
...
|        - |  8126 | `		}` |
|      ! 0 |  8127 | `	}` |
|   205599 |  8128 | `	SySetRelease(&aUnionAlts);` |
|   205599 |  8129 | `	return SXRET_OK;` |
|        5 |  8130 | `Synchronize:` |
...
|        - |  8166 | ` */` |
|  1548128 |  8167 | `static int GenStateLooksLikeTypedProperty(SyToken *pStart,SyToken *pEnd)` |
|        5 |  8168 | `{` |
|  1548133 |  8169 | `	SyToken *p = pStart;` |
|  1548133 |  8170 | `	int bFirst = 1;` |
|  1548133 |  8171 | `	if( p >= pEnd ) return 0;` |
|        - |  8172 | ``	/* Optional nullable `?` shorthand. */`` |
|  1548133 |  8173 | `	if( (p->nType & PH7_TK_OP) && p->sData.nByte == 1 && p->sData.zString[0] == '?' ){` |
|       35 |  8174 | `		p++;` |
...
|   774064 |  8181 | `	for(;;){` |
|  1548153 |  8182 | `		if( p < pEnd && (p->nType & PH7_TK_LPAREN) ){` |
...
|  1548151 |  8191 | `			if( p < pEnd && (p->nType & PH7_TK_NSSEP) ){ p++; }` |
|  1548151 |  8192 | `			if( p >= pEnd \|\| (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|      ! 0 |  8193 | `				return 0;` |
|        - |  8194 | `			}` |
...
|  1548151 |  8198 | `			if( bFirst && (p->nType & PH7_TK_KEYWORD) ){` |
|  1548103 |  8199 | `				sxu32 k = (sxu32)(SX_PTR_TO_INT(p->pUserData));` |
|  1548098 |  8200 | `				if( k == PH7_TKWRD_FUNCTION \|\| k == PH7_TKWRD_VAR \|\| k == PH7_TKWRD_CONST` |
|    74052 |  8201 | `				 \|\| k == PH7_TKWRD_STATIC \|\| k == PH7_TKWRD_FINAL \|\| k == PH7_TKWRD_ABSTRACT ){` |
|  1547821 |  8202 | `					return 0;` |
|        - |  8203 | `				}` |
|      141 |  8204 | `			}` |
|      335 |  8205 | `			p++;` |
...
|        - |  8382 | ` */` |
| 12460358 |  8383 | `static int GenStateIsReadonly(SyToken *pTok)` |
|        5 |  8384 | `{` |
| 12509208 |  8385 | `	return (pTok->nType & PH7_TK_ID)` |
|  6279024 |  8386 | `		&& pTok->sData.nByte == sizeof("readonly")-1` |
| 12509203 |  8387 | `		&& SyStrnicmp(pTok->sData.zString,"readonly",sizeof("readonly")-1) == 0;` |
|        5 |  8388 | `}` |
|        - |  8389 | `/*` |
...
|        - |  8394 | ` */` |
|  4669878 |  8395 | `static sxi32 GenStatePeekSetVisibility(SyToken *pTok,SyToken *pEnd,int *pnTok)` |
|        5 |  8396 | `{` |
|  4669883 |  8397 | `	*pnTok = 0;` |
|  4669878 |  8398 | `	if( &pTok[3] < pEnd` |
|  4419031 |  8399 | `	 && (pTok->nType & PH7_TK_KEYWORD)` |
|  3721613 |  8400 | `	 && (pTok[1].nType & PH7_TK_LPAREN)` |
|  1637529 |  8401 | `	 && (pTok[2].nType & (PH7_TK_ID\|PH7_TK_KEYWORD))` |
...
|        9 |  8423 | `}` |
|   303296 |  8424 | `static sxi32 GenStateCompileClassAttr(ph7_gen_state *pGen,sxi32 iProtection,sxi32 iFlags,ph7_class *pClass)` |
|        5 |  8425 | `{` |
|   303301 |  8426 | `	sxu32 nLine = pGen->pIn->nLine;` |
|        - |  8427 | `	ph7_class_attr *pAttr;` |
|        - |  8428 | `	SyString *pName;` |
|        - |  8429 | `	sxi32 rc;` |
|   303301 |  8430 | `	sxu32 nType = 0;` |
|        - |  8431 | `	SyString sTypeClass;` |
|        - |  8432 | `	SyString sTypeText;` |
|        - |  8433 | `	SySet aUnionAlts;` |
|   303301 |  8434 | `	sxi32 iTypeFlags = 0;` |
|   303301 |  8435 | `	SyStringInitFromBuf(&sTypeClass,0,0);` |
|   303301 |  8436 | `	SyStringInitFromBuf(&sTypeText,0,0);` |
|   303301 |  8437 | `	SySetInit(&aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
...
|   303301 |  8441 | `	if( pClass->iFlags & PH7_CLASS_READONLY ){` |
|       21 |  8442 | `		iFlags \|= PH7_CLASS_ATTR_READONLY;` |
|        9 |  8443 | `	}` |
|        - |  8444 | `	/* Extract visibility level */` |
|   303301 |  8445 | `	iProtection = GetProtectionLevel(iProtection);` |
|        - |  8446 | `	/* Parse optional type hint (typed properties, PHP 7.4+) */` |
|   303462 |  8447 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
...
|      161 |  8463 | `	}` |
|      ! 0 |  8464 | `loop:` |
|   303305 |  8465 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
...
|        - |  8471 | `	}` |
|   303305 |  8472 | `	pGen->pIn++; /* Jump the dollar sign */` |
|   303305 |  8473 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_ID)) == 0 ){` |
...
|   303305 |  8483 | `	pName = &pGen->pIn->sData;` |
|        - |  8484 | `	/* Advance the stream cursor */` |
|   303305 |  8485 | `	pGen->pIn++;` |
|   303305 |  8486 | `	if(pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_EQUAL/*'='*/\|PH7_TK_SEMI/*';'*/\|PH7_TK_COMMA/*','*/\|PH7_TK_OCB/*'{' hooks*/)) == 0 ){` |
...
|   303303 |  8497 | `	if( iFlags & (PH7_CLASS_ATTR_PRIVATE_SET\|PH7_CLASS_ATTR_PROTECTED_SET\|PH7_CLASS_ATTR_PUBLIC_SET) ){` |
...
|   303303 |  8517 | `	if( iFlags & PH7_CLASS_ATTR_READONLY ){` |
...
|   303293 |  8537 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
...
|   303293 |  8549 | `	if( PH7_ClassExtractAttribute(pClass,pName->zString,pName->nByte) != 0 ){` |
...
|   303291 |  8563 | `	if( (pGen->pIn->nType & PH7_TK_EQUAL /*'='*/) && GenStateInitHasNewExpr(pGen) ){` |
...
|   303287 |  8572 | `	pAttr = PH7_NewClassAttr(pGen->pVm,pName,nLine,iProtection,iFlags\|iTypeFlags);` |
|   303287 |  8573 | `	if( pAttr ){` |
|   303287 |  8574 | `		GenStateConsumeDoc(&(*pGen),&pAttr->sDoc);` |
|   303287 |  8575 | `		if( GenStateConsumeAttrs(&(*pGen),&pAttr->aAttrs) == SXERR_ABORT ){` |
|      ! 0 |  8576 | `			return SXERR_ABORT;` |
|        - |  8577 | `		}` |
|   151641 |  8578 | `	}` |
|   303287 |  8579 | `	if( pAttr == 0 ){` |
|      ! 0 |  8580 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 engine is running out of memory");` |
|      ! 0 |  8581 | `		return SXERR_ABORT;` |
|        - |  8582 | `	}` |
|   303287 |  8583 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|      323 |  8584 | `		GenStateCopyTypeToAttr(pAttr,nType,&sTypeClass,&sTypeText,iTypeFlags,&aUnionAlts);` |
|      159 |  8585 | `	}` |
|   303287 |  8586 | `	if( pGen->pIn->nType & PH7_TK_EQUAL /*'='*/ ){` |
|        - |  8587 | `		SySet *pInstrContainer;` |
|   178975 |  8588 | `		SyToken *pSavedDefEnd = pGen->pEnd;` |
|   178975 |  8589 | `		pGen->pIn++; /*Jump the equal sign */` |
|        - |  8590 | `		{` |
...
|   178975 |  8595 | `			SyToken *pScan = pGen->pIn;` |
|   178975 |  8596 | `			sxi32 iNest = 0;` |
|   373793 |  8597 | `			while( pScan < pGen->pEnd ){` |
|   373793 |  8598 | `				if( pScan->nType & (PH7_TK_LPAREN\|PH7_TK_OSB) ){` |
|     7837 |  8599 | `					iNest++;` |
|   369877 |  8600 | `				}else if( pScan->nType & (PH7_TK_RPAREN\|PH7_TK_CSB) ){` |
|     7837 |  8601 | `					iNest--;` |
|   362045 |  8602 | `				}else if( iNest <= 0 && (pScan->nType & (PH7_TK_SEMI\|PH7_TK_COMMA\|PH7_TK_OCB)) ){` |
|   178975 |  8603 | `					break;` |
|        - |  8604 | `				}` |
|   194823 |  8605 | `				pScan++;` |
|        5 |  8606 | `			}` |
|   178975 |  8607 | `			pGen->pEnd = pScan;` |
|        - |  8608 | `		}` |
|        - |  8609 | `		/* Swap bytecode container */` |
|   178975 |  8610 | `		pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   178975 |  8611 | `		PH7_VmSetByteCodeContainer(pGen->pVm,&pAttr->aByteCode);` |
|        - |  8612 | `		/* Compile attribute value.` |
|        - |  8613 | `		 */` |
|   178975 |  8614 | `		rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|   178975 |  8615 | `		if( rc == SXERR_EMPTY ){` |
...
|   178975 |  8622 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|   178975 |  8623 | `		PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|   178975 |  8624 | `		pGen->pIn = pGen->pEnd;   /* land exactly on the delimiter */` |
|   178975 |  8625 | `		pGen->pEnd = pSavedDefEnd;` |
|    89485 |  8626 | `	}` |
|        - |  8627 | `	/* All done,install the attribute */` |
|   303287 |  8628 | `	rc = PH7_ClassInstallAttr(pClass,pAttr);` |
|   303287 |  8629 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  8630 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 |  8631 | `		return SXERR_ABORT;` |
|        - |  8632 | `	}` |
|   303287 |  8633 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) ){` |
...
|        - |  8645 | `	}` |
|   303193 |  8646 | `	if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
...
|        - |  8657 | `	}` |
|   303193 |  8658 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA /*','*/) ){` |
...
|        - |  8676 | `		}` |
|      ! 0 |  8677 | `	}` |
|   303189 |  8678 | `	SySetRelease(&aUnionAlts);` |
|   303189 |  8679 | `	return SXRET_OK;` |
|        9 |  8680 | `Synchronize:` |
...
|        - |  8695 | ` */` |
|  1586856 |  8696 | `static sxi32 GenStateCompileClassMethod(` |
...
|        - |  8702 | `	)` |
|        5 |  8703 | `{` |
|  1586861 |  8704 | `	sxu32 nLine = pGen->pIn->nLine;` |
|  1586861 |  8705 | `	sxu32 nKwLine = nLine; /* Line of the 'function' keyword (Reflection getStartLine) */` |
...
|  1586861 |  8712 | `	iProtection = GetProtectionLevel(iProtection);` |
|  1586861 |  8713 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|  1586861 |  8714 | `	iFuncFlags = 0;` |
|  1586861 |  8715 | `	if( pGen->pIn >= pGen->pEnd ){` |
...
|        - |  8723 | `	}` |
|  1586861 |  8724 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|        - |  8725 | `		/* Return by reference,remember that */` |
|      ! 0 |  8726 | `		iFuncFlags \|= VM_FUNC_REF_RETURN;` |
|        - |  8727 | `		/* Jump the '&' token */` |
|      ! 0 |  8728 | `		pGen->pIn++;` |
|      ! 0 |  8729 | `	}` |
|  1586861 |  8730 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|  1586861 |  8739 | `	pName = &pGen->pIn->sData;` |
|  1586861 |  8740 | `	nLine = pGen->pIn->nLine;` |
|        - |  8741 | `	/* Jump the method name */` |
|  1586861 |  8742 | `	pGen->pIn++;` |
|  1586861 |  8743 | `	if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|        - |  8744 | `		/* Abstract method */` |
|   100843 |  8745 | `		if( iProtection == PH7_CLASS_PROT_PRIVATE ){` |
...
|   100843 |  8754 | `		doBody = FALSE;` |
|    50419 |  8755 | `	}` |
|  1586861 |  8756 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|        - |  8757 | `		/* Syntax error */` |
...
|  1586861 |  8766 | `	pMeth = PH7_NewClassMethod(pGen->pVm,pClass,pName,nLine,iProtection,iFlags,iFuncFlags);` |
|  1586861 |  8767 | `	if( pMeth == 0 ){` |
|      ! 0 |  8768 | `		PH7_GenCompileError(&(*pGen),E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 |  8769 | `		return SXERR_ABORT;` |
|        - |  8770 | `	}` |
|  1586861 |  8771 | `	pMeth->sFunc.nLine = nKwLine;` |
|  1586861 |  8772 | `	GenStateConsumeDoc(&(*pGen),&pMeth->sFunc.sDoc);` |
|  1586861 |  8773 | `	if( GenStateConsumeAttrs(&(*pGen),&pMeth->sFunc.aAttrs) == SXERR_ABORT ){` |
|      ! 0 |  8774 | `		return SXERR_ABORT;` |
|        - |  8775 | `	}` |
|        - |  8776 | `	/* Jump the left parenthesis '(' */` |
|  1586861 |  8777 | `	pGen->pIn++;` |
|  1586861 |  8778 | `	pEnd = 0; /* cc warning */` |
|        - |  8779 | `	/* Delimit the method signature */` |
|  1586861 |  8780 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|  1586861 |  8781 | `	if( pEnd >= pGen->pEnd ){` |
|        - |  8782 | `		/* Syntax error */` |
...
|        - |  8789 | `	}` |
|        - |  8790 | `	{` |
|  1586859 |  8791 | `		int bIsCtor = 0;` |
|  1586859 |  8792 | `		int bAbstractCtor = 0;` |
|  1586854 |  8793 | `		if( (pName->nByte == sizeof("__construct") - 1` |
|   929242 |  8794 | `				&& SyMemcmp(pName->zString,"__construct",sizeof("__construct") - 1) == 0)` |
|  1524739 |  8795 | `		 \|\| SyStringCmp(pName,&pClass->sName,SyMemcmp) == 0 ){` |
|   124245 |  8796 | `			if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|        3 |  8797 | `				bAbstractCtor = 1;` |
|        2 |  8798 | `			}else{` |
|   124243 |  8799 | `				bIsCtor = 1;` |
|        - |  8800 | `			}` |
|    62120 |  8801 | `		}` |
|  1586859 |  8802 | `		if( pGen->pIn < pEnd ){` |
|        - |  8803 | `			/* Collect method arguments */` |
|   543313 |  8804 | `			rc = GenStateCollectFuncArgs(&pMeth->sFunc,&(*pGen),pEnd,bIsCtor,bAbstractCtor);` |
|   543313 |  8805 | `			if( rc == SXERR_ABORT ){` |
|      ! 0 |  8806 | `				return SXERR_ABORT;` |
|        - |  8807 | `			}` |
|   271654 |  8808 | `		}` |
|        - |  8809 | `	}` |
|        - |  8810 | `	/* Point past ')' and parse optional return type ': type' */` |
|  1586859 |  8811 | `	pGen->pIn = &pEnd[1];` |
|        - |  8812 | `	{` |
|  1586859 |  8813 | `		sxi32 rcRt = GenStateParseReturnType(pGen, &pMeth->sFunc);` |
|  1586859 |  8814 | `		if( rcRt == SXERR_ABORT ){` |
|      ! 0 |  8815 | `			return SXERR_ABORT;` |
|  1586859 |  8816 | `		}else if( rcRt == SXERR_SYNTAX ){` |
...
|        - |  8823 | `	{` |
|  1586859 |  8824 | `		sxu32 nArg = SySetUsed(&pMeth->sFunc.aArgs);` |
|        - |  8825 | `		sxu32 i;` |
|  2444291 |  8826 | `		for( i = 0; i < nArg; i++ ){` |
|   857447 |  8827 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pMeth->sFunc.aArgs,i);` |
|        - |  8828 | `			ph7_class_attr *pAttr;` |
|   857447 |  8829 | `			sxi32 iAttrFlags = 0;` |
|        - |  8830 | `			int bArgTyped;` |
|   857447 |  8831 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|   857363 |  8832 | `				continue;` |
|        - |  8833 | `			}` |
...
|       42 |  8928 | `		}` |
|        - |  8929 | `	}` |
|  1586849 |  8930 | `	if( doBody ){` |
|        - |  8931 | `		/* Compile method body */` |
|  1486011 |  8932 | `		rc = GenStateCompileFuncBody(&(*pGen),&pMeth->sFunc);` |
|  1486011 |  8933 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 |  8934 | `			return SXERR_ABORT;` |
|        - |  8935 | `		}` |
|        - |  8936 | `		/* The cursor sits just past the body's closing brace */` |
|  1486011 |  8937 | `		pMeth->sFunc.nEndLine = pGen->pIn[-1].nLine;` |
|   743008 |  8938 | `	}else{` |
|        - |  8939 | `		/* Abstract/interface method: declaration ends at the ';' */` |
|   100843 |  8940 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI /* ';'*/) ){` |
|   100843 |  8941 | `			pMeth->sFunc.nEndLine = pGen->pIn->nLine;` |
|    50419 |  8942 | `		}` |
|        - |  8943 | `		/* Only method signature is allowed */` |
|   100843 |  8944 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI /* ';'*/) == 0 ){` |
...
|  1586849 |  8955 | `	rc = PH7_ClassInstallMethod(pClass,pMeth);` |
|  1586849 |  8956 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  8957 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 |  8958 | `		return SXERR_ABORT;` |
|        - |  8959 | `	}` |
|  1586849 |  8960 | `	return SXRET_OK;` |
|        6 |  8961 | `Synchronize:` |
...
|        - |  9416 | ` */` |
|    50492 |  9417 | `static sxi32 PH7_CompileClassInterface(ph7_gen_state *pGen)` |
|        5 |  9418 | `{` |
|    50497 |  9419 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|    50497 |  9428 | `	pName = &pGen->pIn->sData;` |
|        - |  9429 | `	/* Advance the stream cursor */` |
|    50497 |  9430 | `	pGen->pIn++;` |
|        - |  9431 | `	/* Build FQN and obtain a raw class */ {` |
|        - |  9432 | `		SyBlob sFQN;` |
|        - |  9433 | `		SyString sFQNStr;` |
|    50497 |  9434 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|    50497 |  9435 | `		GenStateBuildFQN(pGen,pName,&sFQN);` |
|    50497 |  9436 | `		SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|    50497 |  9437 | `		pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|    50497 |  9438 | `		SyBlobRelease(&sFQN);` |
|        - |  9439 | `	}` |
|    50497 |  9440 | `	if( pClass == 0 ){` |
|      ! 0 |  9441 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 |  9442 | `		return SXERR_ABORT;` |
|        - |  9443 | `	}` |
|    50497 |  9444 | `	GenStateConsumeDoc(&(*pGen),&pClass->sDoc);` |
|    50497 |  9445 | `	if( GenStateConsumeAttrs(&(*pGen),&pClass->aAttrs) == SXERR_ABORT ){` |
|      ! 0 |  9446 | `		return SXERR_ABORT;` |
|        - |  9447 | `	}` |
|        - |  9448 | `	/* Mark as an interface (PH7_NewRawClass may have set INTERNAL) */` |
|    50497 |  9449 | `	pClass->iFlags \|= PH7_CLASS_INTERFACE;` |
|        - |  9450 | `	/* Assume no base class is given */` |
|    50497 |  9451 | `	pBase = 0;` |
|    50497 |  9452 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|    15519 |  9453 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    15519 |  9454 | `		if( nKwrd == PH7_TKWRD_EXTENDS /* interface b extends a */ ){` |
|        - |  9455 | `			SyBlob sResolved;` |
|        - |  9456 | `			SyString sBaseName;` |
|        - |  9457 | `			sxu32 nRefLine;` |
|        - |  9458 | `			/* Extract base interface */` |
|    15519 |  9459 | `			pGen->pIn++;` |
|    15519 |  9460 | `			nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|    15519 |  9461 | `			SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|    15519 |  9462 | `			if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|        - |  9472 | `			}` |
|    23276 |  9473 | `			pBase = PH7_VmExtractClass(pGen->pVm,` |
|    15514 |  9474 | `				(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|    15519 |  9475 | `			SyStringInitFromBuf(&sBaseName,` |
|        - |  9476 | `				(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|        - |  9477 | `			/* Only interfaces is allowed */` |
|    15519 |  9478 | `			while( pBase && (pBase->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|      ! 0 |  9479 | `				pBase = pBase->pNextName;` |
|      ! 0 |  9480 | `			}` |
|    15519 |  9481 | `			if( pBase == 0 ){` |
...
|        - |  9487 | `				}` |
|      ! 0 |  9488 | `			}` |
|    15519 |  9489 | `			SyBlobRelease(&sResolved);` |
|     7757 |  9490 | `		}` |
|     7757 |  9491 | `	}` |
|    50497 |  9492 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|        - |  9493 | `		/* Syntax error */` |
...
|        - |  9501 | `	}` |
|    50497 |  9502 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|    50497 |  9503 | `	pEnd = 0; /* cc warning */` |
|        - |  9504 | `	/* Delimit the interface body */` |
|    50497 |  9505 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|    50497 |  9506 | `	if( pEnd >= pGen->pEnd ){` |
|        - |  9507 | `		/* Syntax error */` |
...
|    50497 |  9517 | `	pClass->nEndLine = pEnd->nLine;` |
|        - |  9518 | `	/* Swap token stream */` |
|    50497 |  9519 | `	pTmp = pGen->pEnd;` |
|    50497 |  9520 | `	pGen->pEnd = pEnd;` |
...
|   360697 |  9528 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|   155103 |  9529 | `			pGen->pIn++;` |
|        5 |  9530 | `		}` |
|   205599 |  9531 | `		if( pGen->pIn >= pGen->pEnd ){` |
|        - |  9532 | `			/* End of interface body */` |
|    50493 |  9533 | `			break;` |
|        - |  9534 | `		}` |
|        - |  9535 | `		/* Bind a directly-preceding docblock to this member */` |
|   155111 |  9536 | `		GenStateSetPendingDoc(&(*pGen));` |
|   155111 |  9537 | `		if( (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|   155111 |  9548 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   155111 |  9549 | `		if( nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
...
|        3 |  9578 | `			goto done;` |
|        - |  9579 | `		}` |
|   155109 |  9580 | `		if( nKwrd != PH7_TKWRD_PUBLIC && nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|      ! 0 |  9587 | `			goto done;` |
|        - |  9588 | `		}` |
|   155109 |  9589 | `		if( nKwrd == PH7_TKWRD_PUBLIC ){` |
|        - |  9590 | `			/* Advance the stream cursor */` |
|   100827 |  9591 | `			pGen->pIn++;` |
|   100822 |  9592 | `			if( pGen->pIn < pGen->pEnd` |
|   100827 |  9593 | `			 && ((pGen->pIn->nType & PH7_TK_DOLLAR) != 0` |
|   100822 |  9594 | `			  \|\| (pGen->pIn->sData.nByte == 1 && pGen->pIn->sData.zString[0] == '?')) ){` |
...
|      ! 0 |  9608 | `				continue;` |
|        - |  9609 | `			}` |
|   100827 |  9610 | `			if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|      ! 0 |  9632 | `				goto done;` |
|        - |  9633 | `			}` |
|   100827 |  9634 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   100827 |  9635 | `			if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|        - |  9657 | `			}` |
|    50409 |  9658 | `		}` |
|   155105 |  9659 | `		if( nKwrd == PH7_TKWRD_CONST ){` |
|        - |  9660 | `			/* Parse constant */` |
...
|        - |  9667 | `			}` |
|    27143 |  9668 | `		}else{` |
|   100827 |  9669 | `			sxi32 iFlags = PH7_CLASS_ATTR_ABSTRACT; /* Interface methods are implicitly abstract */` |
|   100827 |  9670 | `			if( nKwrd == PH7_TKWRD_STATIC ){` |
...
|   100827 |  9687 | `			rc = GenStateCompileClassMethod(&(*pGen),0,iFlags,FALSE,pClass);` |
|   100827 |  9688 | `			if( rc != SXRET_OK ){` |
...
|    50493 |  9697 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|    50493 |  9698 | `	if( rc == SXRET_OK && pBase ){` |
|        - |  9699 | `		/* Inherit from the base interface */` |
|    15519 |  9700 | `		rc = PH7_ClassInterfaceInherit(pClass,pBase);` |
|     7757 |  9701 | `	}` |
|    50493 |  9702 | `	if( rc != SXRET_OK ){` |
...
|    50497 |  9708 | `	pGen->pIn  = &pEnd[1];` |
|    50497 |  9709 | `	pGen->pEnd = pTmp;` |
|    50497 |  9710 | `	return PH7_OK;` |
|    25251 |  9711 | `}` |
|        - |  9712 | `/*` |
...
|        - |  9736 | ` */` |
|   257520 |  9737 | `static sxi32 GenStateCheckInterfaceSignatures(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 |  9738 | `{` |
|        - |  9739 | `	ph7_class **apIface;` |
|        - |  9740 | `	sxu32 nIface,i;` |
|        - |  9741 | `	sxi32 rc;` |
|   257525 |  9742 | `	if( pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|      ! 0 |  9743 | `		return SXRET_OK;` |
|        - |  9744 | `	}` |
|   257525 |  9745 | `	apIface = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|   257525 |  9746 | `	nIface = SySetUsed(&pClass->aInterface);` |
|   509797 |  9747 | `	for(i = 0; i < nIface; i++){` |
|   252277 |  9748 | `		ph7_class *pIface = apIface[i];` |
|        - |  9749 | `		SyHashEntry *pEntry;` |
|   252277 |  9750 | `		SyHashResetLoopCursor(&pIface->hMethod);` |
|   574565 |  9751 | `		while((pEntry = SyHashGetNextEntry(&pIface->hMethod)) != 0 ){` |
|   322293 |  9752 | `			ph7_class_method *pIfaceMeth = (ph7_class_method *)pEntry->pUserData;` |
|        - |  9753 | `			ph7_class_method *pImplMeth;` |
|   322293 |  9754 | `			SyString *pMName = &pIfaceMeth->sFunc.sName;` |
|        - |  9755 | `			/* Find the implementing method in the class */` |
|   322293 |  9756 | `			pImplMeth = PH7_ClassExtractMethod(pClass,pMName->zString,pMName->nByte);` |
|   322293 |  9757 | `			if( pImplMeth == 0 \|\| (pImplMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT) ){` |
...
|   322275 |  9761 | `			if( pImplMeth->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|        - |  9771 | `			 */` |
|        - |  9772 | `			{` |
|   322275 |  9773 | `				sxu32 nIfaceArgs = SySetUsed(&pIfaceMeth->sFunc.aArgs);` |
|   322275 |  9774 | `				sxu32 nImplArgs = SySetUsed(&pImplMeth->sFunc.aArgs);` |
|   322275 |  9775 | `				int sigError = 0;` |
|   322275 |  9776 | `				if( nImplArgs < nIfaceArgs ){` |
|        3 |  9777 | `					sigError = 1;` |
|   322274 |  9778 | `				}else if( nImplArgs > nIfaceArgs ){` |
...
|        - |  9869 | ` */` |
|   257520 |  9870 | `static sxi32 GenStateCheckAbstractMethods(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 |  9871 | `{` |
...
|   257525 |  9878 | `	if( pClass->iFlags & (PH7_CLASS_ABSTRACT\|PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|     7801 |  9879 | `		return SXRET_OK;` |
|        - |  9880 | `	}` |
|        - |  9881 | `	/* Count abstract methods */` |
|   249729 |  9882 | `	nAbstract = 0;` |
|   249729 |  9883 | `	SyHashResetLoopCursor(&pClass->hMethod);` |
|  3644405 |  9884 | `	while((pEntry = SyHashGetNextEntry(&pClass->hMethod)) != 0 ){` |
|  3269819 |  9885 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|  3269819 |  9886 | `		if( pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
...
|        8 |  9891 | `		}` |
|        5 |  9892 | `	}` |
|   249729 |  9893 | `	if( nAbstract == 0 ){` |
|   249715 |  9894 | `		return SXRET_OK;` |
|        - |  9895 | `	}` |
...
|        - | 10032 | ` */` |
|   238360 | 10033 | `static sxi32 GenStateParseClassReference(ph7_gen_state *pGen,SyBlob *pFqn)` |
|        5 | 10034 | `{` |
|   238365 | 10035 | `	int isAbsolute = 0;` |
|   238365 | 10036 | `	SyToken *pStart = pGen->pIn;` |
|        - | 10037 | `	SyBlob sName;` |
|   238365 | 10038 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) ){` |
|     4465 | 10039 | `		isAbsolute = 1;` |
|     4465 | 10040 | `		pGen->pIn++;` |
|     2230 | 10041 | `	}` |
|   238365 | 10042 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|        8 | 10043 | `		pGen->pIn = pStart;` |
|        8 | 10044 | `		return SXERR_INVALID;` |
|        - | 10045 | `	}` |
|   238359 | 10046 | `	SyBlobInit(&sName,&pGen->pVm->sAllocator);` |
|   238359 | 10047 | `	SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|   238359 | 10048 | `	pGen->pIn++;` |
|   357552 | 10049 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) &&` |
|   119203 | 10050 | `		&pGen->pIn[1] < pGen->pEnd && (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|       16 | 10051 | `		SyBlobAppend(&sName,"\\",1);` |
|       16 | 10052 | `		pGen->pIn++;` |
|       16 | 10053 | `		SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|       16 | 10054 | `		pGen->pIn++;` |
|        2 | 10055 | `	}` |
|   238359 | 10056 | `	if( isAbsolute ){` |
|     4463 | 10057 | `		SyBlobAppend(pFqn,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|     2234 | 10058 | `	}else{` |
|        - | 10059 | `		SyString sRaw;` |
|   233901 | 10060 | `		SyStringInitFromBuf(&sRaw,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|   233901 | 10061 | `		GenStateResolveName(pGen,&sRaw,pFqn);` |
|        - | 10062 | `	}` |
|   238359 | 10063 | `	SyBlobRelease(&sName);` |
|   238359 | 10064 | `	return SXRET_OK;` |
|   119185 | 10065 | `}` |
|        - | 10066 | `/*` |
...
|    58340 | 10074 | `static int GenStateInterfaceIsThrowableAt(ph7_class *pInterface,int iDepth)` |
|        5 | 10075 | `{` |
|        - | 10076 | `	ph7_class **apParent;` |
|        - | 10077 | `	sxu32 n;` |
|   147731 | 10078 | `	while( pInterface ){` |
|    97153 | 10079 | `		if( iDepth > PH7_THROWABLE_WALK_MAX_DEPTH ){` |
|      ! 0 | 10080 | `			return FALSE;` |
|        - | 10081 | `		}` |
|   116552 | 10082 | `		if( pInterface->sName.nByte == sizeof("Throwable")-1 &&` |
|    38798 | 10083 | `			SyMemcmp(pInterface->sName.zString,"Throwable",sizeof("Throwable")-1) == 0 ){` |
|     7767 | 10084 | `			return TRUE;` |
|        - | 10085 | `		}` |
|    89391 | 10086 | `		apParent = (ph7_class **)SySetBasePtr(&pInterface->aInterface);` |
|    89391 | 10087 | `		for( n = 0 ; n < SySetUsed(&pInterface->aInterface) ; ++n ){` |
|      ! 0 | 10088 | `			if( GenStateInterfaceIsThrowableAt(apParent[n],iDepth+1) ){` |
|      ! 0 | 10089 | `				return TRUE;` |
|        - | 10090 | `			}` |
|      ! 0 | 10091 | `		}` |
|    89391 | 10092 | `		pInterface = pInterface->pBase;` |
|    89391 | 10093 | `		iDepth++;` |
|        5 | 10094 | `	}` |
|    50583 | 10095 | `	return FALSE;` |
|    29175 | 10096 | `}` |
|    58340 | 10097 | `static int GenStateInterfaceIsThrowable(ph7_class *pInterface)` |
|        5 | 10098 | `{` |
|    58345 | 10099 | `	return GenStateInterfaceIsThrowableAt(pInterface,0);` |
|        5 | 10100 | `}` |
|        - | 10101 | `/*` |
...
|        - | 10352 | ` */` |
|   257564 | 10353 | `static sxi32 GenStateCompileClassEx(ph7_gen_state *pGen,sxi32 iFlags,` |
|        - | 10354 | `	SyString *pAnonName,SyToken **ppArgStart,SyToken **ppArgEnd)` |
|        5 | 10355 | `{` |
|   257569 | 10356 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|   257569 | 10367 | `	pGen->pIn++;` |
|   257569 | 10368 | `	if( pAnonName ){` |
...
|       18 | 10383 | `	}else{` |
|   257541 | 10384 | `		if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
|        - | 10385 | `			/* Syntax error */` |
...
|   257541 | 10398 | `		pName = &pGen->pIn->sData;` |
|        - | 10399 | `		/* Advance the stream cursor */` |
|   257541 | 10400 | `		pGen->pIn++;` |
|        - | 10401 | `		/* Build FQN and obtain a raw class */ {` |
|        - | 10402 | `			SyBlob sFQN;` |
|        - | 10403 | `			SyString sFQNStr;` |
|   257541 | 10404 | `			SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|   257541 | 10405 | `			GenStateBuildFQN(pGen,pName,&sFQN);` |
|   257541 | 10406 | `			SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|   257541 | 10407 | `			pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|   257541 | 10408 | `			SyBlobRelease(&sFQN);` |
|        - | 10409 | `		}` |
|        - | 10410 | `	}` |
|   257569 | 10411 | `	if( pClass == 0 ){` |
|      ! 0 | 10412 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 10413 | `		return SXERR_ABORT;` |
|        - | 10414 | `	}` |
|   257564 | 10415 | `	if( (iFlags & PH7_CLASS_ENUM) && pGen->pIn < pGen->pEnd` |
...
|        - | 10438 | `		}` |
|     1945 | 10439 | `	}` |
|   257569 | 10440 | `	GenStateConsumeDoc(&(*pGen),&pClass->sDoc);` |
|   257569 | 10441 | `	if( GenStateConsumeAttrs(&(*pGen),&pClass->aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 10442 | `		return SXERR_ABORT;` |
|        - | 10443 | `	}` |
|        - | 10444 | `	/* implemented interfaces and per-use-statement trait containers */` |
|   257569 | 10445 | `	SySetInit(&aInterfaces,&pGen->pVm->sAllocator,sizeof(ph7_class *));` |
|   257569 | 10446 | `	SySetInit(&aUseEntries,&pGen->pVm->sAllocator,sizeof(TraitUseEntry));` |
|        - | 10447 | `	/* Assume a standalone class */` |
|   257569 | 10448 | `	pBase = 0;` |
|   257569 | 10449 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|   201975 | 10450 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   201975 | 10451 | `		if( nKwrd == PH7_TKWRD_EXTENDS /* class b extends a */ ){` |
|        - | 10452 | `			SyBlob sResolved;` |
|        - | 10453 | `			SyString sBaseName;` |
|        - | 10454 | `			sxu32 nRefLine;` |
|   143659 | 10455 | `			if( iFlags & PH7_CLASS_ENUM ){` |
...
|        - | 10461 | `				}` |
|      ! 0 | 10462 | `			}` |
|   143659 | 10463 | `			pGen->pIn++; /* Advance past 'extends' */` |
|   143659 | 10464 | `			nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|   143659 | 10465 | `			SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|   143659 | 10466 | `			if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|        - | 10476 | `			}` |
|   215483 | 10477 | `			pBase = PH7_VmExtractClass(pGen->pVm,` |
|   143652 | 10478 | `				(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|   143657 | 10479 | `			SyStringInitFromBuf(&sBaseName,` |
|        - | 10480 | `				(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|        - | 10481 | `			/* Interfaces are not allowed */` |
|   143657 | 10482 | `			while( pBase && (pBase->iFlags & PH7_CLASS_INTERFACE) ){` |
|      ! 0 | 10483 | `				pBase = pBase->pNextName;` |
|      ! 0 | 10484 | `			}` |
|   143657 | 10485 | `			if( pBase == 0 ){` |
...
|        - | 10491 | `				}` |
|      ! 0 | 10492 | `			}else{` |
|   143657 | 10493 | `				if( pBase->iFlags & PH7_CLASS_ENUM ){` |
...
|   143656 | 10501 | `				}else if( pBase->iFlags & PH7_CLASS_FINAL ){` |
...
|      ! 0 | 10508 | `				}` |
|        - | 10509 | `			}` |
|   143657 | 10510 | `			SyBlobRelease(&sResolved);` |
|   143657 | 10511 | `			if( iFlags & PH7_CLASS_ENUM ){` |
|      ! 0 | 10512 | `				pBase = 0; /* Error already reported: enums have no base class */` |
|      ! 0 | 10513 | `			}` |
|    71826 | 10514 | `		}` |
|   201973 | 10515 | `		if (pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) && SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_IMPLEMENTS ){` |
|        - | 10516 | `			ph7_class *pInterface;` |
|        - | 10517 | `			/* Interface implementation */` |
|    58333 | 10518 | `			pGen->pIn++; /* Advance the stream cursor */` |
|    29176 | 10519 | `			for(;;){` |
|        - | 10520 | `				SyBlob sResolved;` |
|        - | 10521 | `				SyString sIntName;` |
|        - | 10522 | `				sxu32 nRefLine;` |
|    58345 | 10523 | `				nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|    58345 | 10524 | `				SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|    58345 | 10525 | `				if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|      ! 0 | 10533 | `					break;` |
|        - | 10534 | `				}` |
|   116685 | 10535 | `				pInterface = PH7_VmExtractClass(pGen->pVm,` |
|    58340 | 10536 | `					(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|    58345 | 10537 | `				SyStringInitFromBuf(&sIntName,` |
|        - | 10538 | `					(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|        - | 10539 | `				/* Only interfaces are allowed */` |
|    58345 | 10540 | `				while( pInterface && (pInterface->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|      ! 0 | 10541 | `					pInterface = pInterface->pNextName;` |
|      ! 0 | 10542 | `				}` |
|    58345 | 10543 | `				if( pInterface == 0 ){` |
...
|    58345 | 10557 | `					SyString *pFqn = &pClass->sName;` |
|    58345 | 10558 | `					int bIsExceptionOrError =` |
|    33050 | 10559 | `						(pFqn->nByte == sizeof("Exception")-1 &&` |
|    89452 | 10560 | `						 SyMemcmp(pFqn->zString,"Exception",sizeof("Exception")-1) == 0) \|\|` |
|    56409 | 10561 | `						(pFqn->nByte == sizeof("Error")-1 &&` |
|     3890 | 10562 | `						 SyMemcmp(pFqn->zString,"Error",sizeof("Error")-1) == 0);` |
|    62221 | 10563 | `					if( GenStateInterfaceIsThrowable(pInterface) &&` |
...
|        6 | 10575 | `					}else{` |
|    58339 | 10576 | `						SySetPut(&aInterfaces,(const void *)&pInterface);` |
|        - | 10577 | `					}` |
|        - | 10578 | `				}` |
|    58345 | 10579 | `				SyBlobRelease(&sResolved);` |
|    58345 | 10580 | `				if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COMMA) == 0 ){` |
|    29169 | 10581 | `					break;` |
|        - | 10582 | `				}` |
...
|    29164 | 10585 | `		}` |
|   100984 | 10586 | `	}` |
|   257567 | 10587 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|        - | 10588 | `		/* Syntax error */` |
...
|        - | 10596 | `	}` |
|   257567 | 10597 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|   257567 | 10598 | `	pEnd = 0; /* cc warning */` |
|        - | 10599 | `	/* Delimit the class body */` |
|   257567 | 10600 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|   257567 | 10601 | `	if( pEnd >= pGen->pEnd ){` |
|        - | 10602 | `		/* Syntax error */` |
...
|   257567 | 10612 | `	pClass->nEndLine = pEnd->nLine;` |
|        - | 10613 | `	/* Swap token stream */` |
|   257567 | 10614 | `	pTmp = pGen->pEnd;` |
|   257567 | 10615 | `	pGen->pEnd = pEnd;` |
|        - | 10616 | `	/* Merge the inherited flags (PH7_NewRawClass may have set INTERNAL) */` |
|   257567 | 10617 | `	pClass->iFlags \|= iFlags;` |
|        - | 10618 | `	/* Start the parse process */` |
|   922191 | 10619 | `	for(;;){` |
|        - | 10620 | `		/* Jump leading/trailing semi-colons */` |
|  2610087 | 10621 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|   458467 | 10622 | `			pGen->pIn++;` |
|        5 | 10623 | `		}` |
|  2151625 | 10624 | `		if( pGen->pIn >= pGen->pEnd ){` |
|        - | 10625 | `			/* End of class body */` |
|   257525 | 10626 | `			break;` |
|        - | 10627 | `		}` |
|        - | 10628 | `		/* Bind a directly-preceding docblock to this member */` |
|  1894105 | 10629 | `		GenStateSetPendingDoc(&(*pGen));` |
|  1894100 | 10630 | `		if( (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR)) == 0` |
|   947055 | 10631 | ``			&& !GenStateIsReadonly(pGen->pIn) /* allow a leading `readonly` modifier */ ){`` |
...
|  1894105 | 10642 | `		iProtection = PH7_TKWRD_PUBLIC;` |
|  1894105 | 10643 | `		iAttrflags = 0;` |
...
|  1894105 | 10648 | `		if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|      ! 0 | 10649 | `			int bMod = 0;` |
...
|        - | 10670 | `			}` |
|      ! 0 | 10671 | `		}` |
|  1894105 | 10672 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|        - | 10673 | `			/* Extract the current keyword */` |
|  1894105 | 10674 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  1894105 | 10675 | `			if( nKwrd == PH7_TKWRD_CASE && (pClass->iFlags & PH7_CLASS_ENUM) ){` |
...
|     7795 | 10684 | `				continue;` |
|        - | 10685 | `			}` |
|  1886311 | 10686 | `			if( nKwrd == PH7_TKWRD_USE ){` |
|        - | 10687 | `				/* Trait use: use TraitA, TraitB [{ ... }]; */` |
|        - | 10688 | `				TraitUseEntry sUse;` |
|     7819 | 10689 | `				SySetInit(&sUse.aTraits,&pGen->pVm->sAllocator,sizeof(ph7_class *));` |
|     7819 | 10690 | `				sUse.pResolvStart = sUse.pResolvEnd = 0;` |
|     7819 | 10691 | `				pGen->pIn++; /* Jump the 'use' keyword */` |
|     3915 | 10692 | `				for(;;){` |
|        - | 10693 | `					ph7_class *pTrait;` |
|        - | 10694 | `					SyString *pTraitName;` |
|     7827 | 10695 | `					if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
...
|      ! 0 | 10701 | `						break;` |
|        - | 10702 | `					}` |
|     7827 | 10703 | `					pTraitName = &pGen->pIn->sData;` |
|        - | 10704 | `					/* Resolve trait name through namespace/imports */ {` |
|        - | 10705 | `						SyBlob sResolved;` |
|     7827 | 10706 | `						SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|     7827 | 10707 | `						GenStateResolveName(pGen,pTraitName,&sResolved);` |
|    15649 | 10708 | `						pTrait = PH7_VmExtractClass(pGen->pVm,` |
|     7822 | 10709 | `							(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|     7827 | 10710 | `						SyBlobRelease(&sResolved);` |
|        - | 10711 | `					}` |
|        - | 10712 | `					/* Only traits are allowed */` |
|     7827 | 10713 | `					while( pTrait && (pTrait->iFlags & PH7_CLASS_TRAIT) == 0 ){` |
|      ! 0 | 10714 | `						pTrait = pTrait->pNextName;` |
|      ! 0 | 10715 | `					}` |
|     7827 | 10716 | `					if( pTrait == 0 ){` |
...
|        - | 10721 | `						}` |
|      ! 0 | 10722 | `					}else{` |
|     7827 | 10723 | `						SySetPut(&sUse.aTraits,(const void *)&pTrait);` |
|        - | 10724 | `					}` |
|     7827 | 10725 | `					pGen->pIn++; /* Advance past trait name */` |
|     7827 | 10726 | `					if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COMMA) == 0 ){` |
|     3912 | 10727 | `						break;` |
|        - | 10728 | `					}` |
|       10 | 10729 | `					pGen->pIn++; /* Jump the comma */` |
|        2 | 10730 | `				}` |
|        - | 10731 | `				/* Expect semicolon or opening brace (for conflict resolution) */` |
|     7819 | 10732 | `				if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OCB) ){` |
...
|        - | 10742 | `					}` |
|        5 | 10743 | `				}` |
|     7819 | 10744 | `				SySetPut(&aUseEntries,(const void *)&sUse);` |
|        - | 10745 | `				/* The semicolon will be consumed by the outer loop */` |
|     7819 | 10746 | `				continue;` |
|        - | 10747 | `			}` |
|  1878497 | 10748 | `			if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|        - | 10749 | `				int nSetTok;` |
|  1726841 | 10750 | `				sxi32 nSetVis = GenStatePeekSetVisibility(pGen->pIn,pGen->pEnd,&nSetTok);` |
|  1726841 | 10751 | `				if( nSetVis ){` |
...
|        2 | 10756 | `				}else{` |
|  1726839 | 10757 | `					iProtection = nKwrd;` |
|  1726839 | 10758 | `					pGen->pIn++; /* Jump the visibility token */` |
|        - | 10759 | `					/* Optional asymmetric set-visibility after the read` |
|        - | 10760 | ``					 * visibility: `public private(set) int $x`. */`` |
|  1726839 | 10761 | `					nSetVis = GenStatePeekSetVisibility(pGen->pIn,pGen->pEnd,&nSetTok);` |
|  1726839 | 10762 | `					if( nSetVis ){` |
...
|  1726841 | 10769 | `				if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|       24 | 10770 | `					iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|       24 | 10771 | `					pGen->pIn++; /* Jump the 'readonly' modifier */` |
|       10 | 10772 | `				}` |
|  1726836 | 10773 | `				if( pGen->pIn >= pGen->pEnd` |
|  1726841 | 10774 | `					\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|      ! 0 | 10782 | `					goto done;` |
|        - | 10783 | `				}` |
|  1726841 | 10784 | `				if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|        - | 10785 | `					/* Attribute declaration (untyped) */` |
|   287429 | 10786 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|   287429 | 10787 | `					if( rc != SXRET_OK ){` |
|       11 | 10788 | `						if( rc == SXERR_ABORT ){` |
|      ! 0 | 10789 | `							return SXERR_ABORT;` |
|        - | 10790 | `						}` |
|       11 | 10791 | `						goto done;` |
|        - | 10792 | `					}` |
|   287565 | 10793 | `					continue;` |
|        - | 10794 | `				}` |
|  1439417 | 10795 | `				if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|  1439123 | 10807 | `				nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   719559 | 10808 | `			}` |
|  1590779 | 10809 | `			if( nKwrd == PH7_TKWRD_CONST ){` |
|        - | 10810 | `				/* Process constant declaration */` |
|   151319 | 10811 | `				rc = GenStateCompileClassConstant(&(*pGen),iProtection,iAttrflags,pClass);` |
|   151319 | 10812 | `				if( rc != SXRET_OK ){` |
...
|        - | 10817 | `				}` |
|    75658 | 10818 | `			}else{` |
|  1439465 | 10819 | `				if( nKwrd == PH7_TKWRD_STATIC ){` |
...
|  1404492 | 10886 | `				}else if( nKwrd == PH7_TKWRD_ABSTRACT ){` |
...
|  1373423 | 10935 | `				}else if( nKwrd == PH7_TKWRD_FINAL ){` |
...
|        3 | 10979 | `				}` |
|  1435531 | 10980 | `				if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_VAR ){` |
...
|      ! 0 | 10988 | `						goto done;` |
|        - | 10989 | `				}` |
|  1435531 | 10990 | `				if( nKwrd == PH7_TKWRD_VAR ){` |
...
|  1435525 | 11005 | `					rc = GenStateCompileClassMethod(&(*pGen),iProtection,iAttrflags,TRUE,pClass);` |
|        - | 11006 | `				}` |
|  1435531 | 11007 | `				if( rc != SXRET_OK ){` |
...
|        - | 11030 | `		sxu32 nU;` |
|   257525 | 11031 | `		apUse = (TraitUseEntry *)SySetBasePtr(&aUseEntries);` |
|   265339 | 11032 | `		for( nU = 0 ; nU < SySetUsed(&aUseEntries) ; nU++ ){` |
|     7819 | 11033 | `			TraitUseEntry *pUse = &apUse[nU];` |
|     7819 | 11034 | `			ph7_class **apTrait = (ph7_class **)SySetBasePtr(&pUse->aTraits);` |
|     7819 | 11035 | `			sxu32 nTraits = SySetUsed(&pUse->aTraits);` |
|     7819 | 11036 | `			int hasResolution = (pUse->pResolvStart && pUse->pResolvStart < pUse->pResolvEnd) ? 1 : 0;` |
|        - | 11037 | `			sxu32 nT;` |
|     7819 | 11038 | `			if( !hasResolution ){` |
|        - | 11039 | `				/* No conflict resolution block: use standard trait application */` |
|    15619 | 11040 | `				for( nT = 0 ; nT < nTraits ; nT++ ){` |
|     7815 | 11041 | `					rc = PH7_ClassUseTrait(&(*pGen),pClass,apTrait[nT]);` |
|     7815 | 11042 | `					if( rc != SXRET_OK ){` |
|      ! 0 | 11043 | `						break;` |
|        - | 11044 | `					}` |
|     3910 | 11045 | `				}` |
|     3907 | 11046 | `			}else{` |
...
|        3 | 11234 | `				}` |
|        - | 11235 | `			}` |
|     7819 | 11236 | `			SySetRelease(&pUse->aTraits);` |
|     3912 | 11237 | `		}` |
|        - | 11238 | `	}` |
|   257525 | 11239 | `	if( pClass->iFlags & PH7_CLASS_ENUM ){` |
...
|   257525 | 11250 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|   257525 | 11251 | `	if( rc == SXRET_OK ){` |
|        - | 11252 | `		ph7_class **apInterface;` |
|        - | 11253 | `		sxu32 n;` |
|   257525 | 11254 | `		if( pBase ){` |
|        - | 11255 | `			/* Inherit from base class and mark as a subclass */` |
|   143655 | 11256 | `			rc = PH7_ClassInherit(&(*pGen),pClass,pBase);` |
|    71825 | 11257 | `		}` |
|   257525 | 11258 | `		apInterface = (ph7_class **)SySetBasePtr(&aInterfaces);` |
|   315859 | 11259 | `		for( n = 0 ; n < SySetUsed(&aInterfaces) ; n++ ){` |
|        - | 11260 | `			/* Implements one or more interface */` |
|    58339 | 11261 | `			rc = PH7_ClassImplement(pClass,apInterface[n]);` |
|    58339 | 11262 | `			if( rc != SXRET_OK ){` |
|      ! 0 | 11263 | `				break;` |
|        - | 11264 | `			}` |
|    29172 | 11265 | `		}` |
...
|   257525 | 11268 | `		if( rc == SXRET_OK && (pClass->iFlags & PH7_CLASS_ENUM) ){` |
...
|   257520 | 11288 | `		if( rc == SXRET_OK` |
|   257520 | 11289 | `		 && (pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT)) == 0` |
|   257525 | 11290 | `		 && SyHashGet(&pClass->hMethod,"__toString",sizeof("__toString")-1) != 0 ){` |
...
|   257525 | 11310 | `		if( rc == SXRET_OK ){` |
|   257525 | 11311 | `			sxi32 rcCheck = GenStateCheckInterfaceSignatures(&(*pGen),pClass);` |
|   257525 | 11312 | `			if( rcCheck == SXERR_ABORT ){` |
...
|   257525 | 11319 | `		if( rc == SXRET_OK ){` |
|   257525 | 11320 | `			sxi32 rcCheck = GenStateCheckAbstractMethods(&(*pGen),pClass);` |
|   257525 | 11321 | `			if( rcCheck == SXERR_ABORT ){` |
...
|   128760 | 11326 | `		}` |
|   128760 | 11327 | `	}` |
|   257525 | 11328 | `	SySetRelease(&aUseEntries);` |
|   257525 | 11329 | `	SySetRelease(&aInterfaces);` |
|   257525 | 11330 | `	if( rc != SXRET_OK ){` |
...
|   257567 | 11336 | `	pGen->pIn = &pEnd[1];` |
|   257567 | 11337 | `	pGen->pEnd = pTmp;` |
|   257567 | 11338 | `	return PH7_OK;` |
|   128787 | 11339 | `}` |
|        - | 11340 | `/* Compile a named class declaration (the common case). */` |
|   257536 | 11341 | `static sxi32 GenStateCompileClass(ph7_gen_state *pGen,sxi32 iFlags)` |
|        5 | 11342 | `{` |
|   257541 | 11343 | `	return GenStateCompileClassEx(pGen,iFlags,0,0,0);` |
|        5 | 11344 | `}` |
|        - | 11345 | `/*` |
...
|        - | 11444 | ` */` |
|  7681436 | 11445 | `static int GenStateTokenIsClassModifier(SyToken *pTok,sxi32 *piFlag)` |
|        5 | 11446 | `{` |
|  7681441 | 11447 | `	if( pTok->nType & PH7_TK_KEYWORD ){` |
|  4571613 | 11448 | `		sxu32 nKw = (sxu32)SX_PTR_TO_INT(pTok->pUserData);` |
|  4571613 | 11449 | `		if( nKw == PH7_TKWRD_FINAL ){ *piFlag = PH7_CLASS_FINAL; return TRUE; }` |
|  4525075 | 11450 | `		if( nKw == PH7_TKWRD_ABSTRACT ){ *piFlag = PH7_CLASS_ABSTRACT; return TRUE; }` |
|  2254740 | 11451 | `	}` |
|  7619313 | 11452 | `	if( GenStateIsReadonly(pTok) ){ *piFlag = PH7_CLASS_READONLY; return TRUE; }` |
|  7619253 | 11453 | `	return FALSE;` |
|  3840723 | 11454 | `}` |
|        - | 11455 | `/*` |
...
|        - | 11460 | ` */` |
|  7619248 | 11461 | `static sxi32 GenStateScanClassModifiers(SyToken **ppIn,SyToken *pEnd,SyToken **ppDup)` |
|        5 | 11462 | `{` |
|  7619253 | 11463 | `	SyToken *pIn = *ppIn,*pDup = 0;` |
|  7619253 | 11464 | `	sxi32 iFlags = 0,iFlag;` |
|  7681441 | 11465 | `	while( pIn < pEnd && GenStateTokenIsClassModifier(pIn,&iFlag) ){` |
|    62193 | 11466 | `		if( (iFlags & iFlag) && pDup == 0 ){` |
|        5 | 11467 | `			pDup = pIn;` |
|        2 | 11468 | `		}` |
|    62193 | 11469 | `		iFlags \|= iFlag;` |
|    62193 | 11470 | `		pIn++;` |
|        5 | 11471 | `	}` |
|  7619253 | 11472 | `	*ppIn = pIn;` |
|  7619253 | 11473 | `	if( ppDup ){ *ppDup = pDup; }` |
|  7619253 | 11474 | `	return iFlags;` |
|        5 | 11475 | `}` |
|        - | 11476 | `/*` |
...
|        - | 11482 | ` */` |
|  7592040 | 11483 | `static int GenStateStartsModifiedClass(SyToken *pIn,SyToken *pEnd)` |
|        5 | 11484 | `{` |
|  7592045 | 11485 | `	sxi32 iFlags = GenStateScanClassModifiers(&pIn,pEnd,0);` |
|  3830987 | 11486 | `	return iFlags != 0 && pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD)` |
|  7609522 | 11487 | `		&& (sxu32)SX_PTR_TO_INT(pIn->pUserData) == PH7_TKWRD_CLASS;` |
|        5 | 11488 | `}` |
|        - | 11489 | `/*` |
...
|        - | 11495 | ` */` |
|    27208 | 11496 | `static sxi32 PH7_CompileClassModifiers(ph7_gen_state *pGen)` |
|        5 | 11497 | `{` |
|        - | 11498 | `	SyToken *pDup;` |
|    27213 | 11499 | `	sxi32 iFlags = GenStateScanClassModifiers(&pGen->pIn,pGen->pEnd,&pDup);` |
|        - | 11500 | `	sxi32 rc;` |
|    27213 | 11501 | `	if( pDup ){` |
...
|        - | 11506 | `		}` |
|        1 | 11507 | `	}` |
|    27208 | 11508 | `	if( (iFlags & (PH7_CLASS_FINAL\|PH7_CLASS_ABSTRACT))` |
|    13609 | 11509 | `		== (PH7_CLASS_FINAL\|PH7_CLASS_ABSTRACT) ){` |
...
|        - | 11514 | `		}` |
|        1 | 11515 | `	}` |
|    27213 | 11516 | `	return GenStateCompileClass(&(*pGen),iFlags);` |
|    13609 | 11517 | `}` |
|        - | 11518 | `/*` |
...
|        - | 11523 | ` */` |
|     3952 | 11524 | `static sxi32 PH7_CompileTrait(ph7_gen_state *pGen)` |
|        5 | 11525 | `{` |
|     3957 | 11526 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|     3957 | 11535 | `	pGen->pIn++;` |
|     3957 | 11536 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
...
|     3957 | 11547 | `	pName = &pGen->pIn->sData;` |
|     3957 | 11548 | `	pGen->pIn++;` |
|        - | 11549 | `	/* Build FQN and obtain a raw class */ {` |
|        - | 11550 | `		SyBlob sFQN;` |
|        - | 11551 | `		SyString sFQNStr;` |
|     3957 | 11552 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|     3957 | 11553 | `		GenStateBuildFQN(pGen,pName,&sFQN);` |
|     3957 | 11554 | `		SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|     3957 | 11555 | `		pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|     3957 | 11556 | `		SyBlobRelease(&sFQN);` |
|        - | 11557 | `	}` |
|     3957 | 11558 | `	if( pClass == 0 ){` |
|      ! 0 | 11559 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 11560 | `		return SXERR_ABORT;` |
|        - | 11561 | `	}` |
|     3957 | 11562 | `	GenStateConsumeDoc(&(*pGen),&pClass->sDoc);` |
|     3957 | 11563 | `	if( GenStateConsumeAttrs(&(*pGen),&pClass->aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 11564 | `		return SXERR_ABORT;` |
|        - | 11565 | `	}` |
|        - | 11566 | `	/* Traits cannot extend or implement; expect opening brace directly */` |
|     3957 | 11567 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_OCB) == 0 ){` |
...
|        - | 11574 | `	}` |
|     3957 | 11575 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|     3957 | 11576 | `	pEnd = 0;` |
|     3957 | 11577 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB,PH7_TK_CCB,&pEnd);` |
|     3957 | 11578 | `	if( pEnd >= pGen->pEnd ){` |
...
|     3957 | 11587 | `	pClass->nEndLine = pEnd->nLine;` |
|        - | 11588 | `	/* Swap token stream */` |
|     3957 | 11589 | `	pTmp = pGen->pEnd;` |
|     3957 | 11590 | `	pGen->pEnd = pEnd;` |
|        - | 11591 | `	/* Mark as trait (PH7_NewRawClass may have set INTERNAL) */` |
|     3957 | 11592 | `	pClass->iFlags \|= PH7_CLASS_TRAIT;` |
|        - | 11593 | `	/* Parse the body: same as a normal class (methods, attributes, visibility modifiers) */` |
|    21395 | 11594 | `	for(;;){` |
|    66099 | 11595 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|    11659 | 11596 | `			pGen->pIn++;` |
|        5 | 11597 | `		}` |
|    54445 | 11598 | `		if( pGen->pIn >= pGen->pEnd ){` |
|     3957 | 11599 | `			break;` |
|        - | 11600 | `		}` |
|        - | 11601 | `		/* Bind a directly-preceding docblock to this member */` |
|    50493 | 11602 | `		GenStateSetPendingDoc(&(*pGen));` |
|    50493 | 11603 | `		if( (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR)) == 0 ){` |
...
|      ! 0 | 11610 | `			goto done;` |
|        - | 11611 | `		}` |
|    50493 | 11612 | `		iProtection = PH7_TKWRD_PUBLIC;` |
|    50493 | 11613 | `		iAttrflags = 0;` |
|    50493 | 11614 | `		if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|    50493 | 11615 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    50493 | 11616 | `			if( nKwrd == PH7_TKWRD_USE ){` |
...
|        5 | 11657 | `				continue;` |
|        - | 11658 | `			}` |
|    50489 | 11659 | `			if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|    50473 | 11660 | `				iProtection = nKwrd;` |
|    50473 | 11661 | `				pGen->pIn++;` |
|    50468 | 11662 | `				if( pGen->pIn >= pGen->pEnd` |
|    50473 | 11663 | `					\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|      ! 0 | 11670 | `					goto done;` |
|        - | 11671 | `				}` |
|    50473 | 11672 | `				if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|    11645 | 11673 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|    11645 | 11674 | `					if( rc != SXRET_OK ){` |
|      ! 0 | 11675 | `						if( rc == SXERR_ABORT ){` |
|      ! 0 | 11676 | `							return SXERR_ABORT;` |
|        - | 11677 | `						}` |
|      ! 0 | 11678 | `						goto done;` |
|        - | 11679 | `					}` |
|    11645 | 11680 | `					continue;` |
|        - | 11681 | `				}` |
|    38833 | 11682 | `				if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|        5 | 11690 | `					continue;` |
|        - | 11691 | `				}` |
|    38829 | 11692 | `				nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    19412 | 11693 | `			}` |
|    38845 | 11694 | `			if( nKwrd == PH7_TKWRD_CONST ){` |
...
|      ! 0 | 11700 | `				goto done;` |
|      ! 0 | 11701 | `			}else{` |
|    38845 | 11702 | `				if( nKwrd == PH7_TKWRD_STATIC ){` |
...
|    34963 | 11743 | `				}else if( nKwrd == PH7_TKWRD_ABSTRACT ){` |
...
|        2 | 11764 | `				}` |
|    38843 | 11765 | `				if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_VAR ){` |
...
|      ! 0 | 11772 | `					goto done;` |
|        - | 11773 | `				}` |
|    38843 | 11774 | `				if( nKwrd == PH7_TKWRD_VAR ){` |
|      ! 0 | 11775 | `					pGen->pIn++;` |
...
|      ! 0 | 11785 | `				}else{` |
|    38843 | 11786 | `					rc = GenStateCompileClassMethod(&(*pGen),iProtection,iAttrflags,TRUE,pClass);` |
|        - | 11787 | `				}` |
|    38843 | 11788 | `				if( rc != SXRET_OK ){` |
...
|     3957 | 11806 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|     3957 | 11807 | `	if( rc != SXRET_OK ){` |
...
|     3957 | 11813 | `	pGen->pIn = &pEnd[1];` |
|     3957 | 11814 | `	pGen->pEnd = pTmp;` |
|     3957 | 11815 | `	return PH7_OK;` |
|     1981 | 11816 | `}` |
|        - | 11817 | `/*` |
...
|        - | 11825 | ` */` |
|   226424 | 11826 | `static sxi32 PH7_CompileClass(ph7_gen_state *pGen)` |
|        5 | 11827 | `{` |
|        - | 11828 | `	sxi32 rc;` |
|   226429 | 11829 | `	rc = GenStateCompileClass(&(*pGen),0);` |
|   226429 | 11830 | `	return rc;` |
|        5 | 11831 | `}` |
|        - | 11832 | `/*` |
...
|        - | 11838 | ` */` |
|  7557080 | 11839 | `static int GenStateStartsEnumDecl(SyToken *pIn,SyToken *pEnd)` |
|        5 | 11840 | `{` |
|  7598076 | 11841 | `	return (pIn->nType & PH7_TK_ID)` |
|  3819531 | 11842 | `		&& pIn->sData.nByte == sizeof("enum")-1` |
|    46928 | 11843 | `		&& SyStrnicmp(pIn->sData.zString,"enum",sizeof("enum")-1) == 0` |
|  7598071 | 11844 | `		&& &pIn[1] < pEnd && (pIn[1].nType & PH7_TK_ID);` |
|        5 | 11845 | `}` |
|        - | 11846 | `/*` |
...
|        - | 11877 | ` */` |
|   345376 | 11878 | `static sxi32 GenStateThrowNodeValidator(ph7_gen_state *pGen,ph7_expr_node *pRoot)` |
|        5 | 11879 | `{` |
|   345381 | 11880 | `	sxi32 rc = SXRET_OK;` |
|   345381 | 11881 | `	if( pRoot->pOp ){` |
|   345369 | 11882 | `		switch( pRoot->pOp->iOp ){` |
|   172682 | 11883 | `		case EXPR_OP_NEW:            /* new Exception() */` |
...
|      ! 0 | 11899 | `			break;` |
|        - | 11900 | `		}` |
|   172699 | 11901 | `	}else if( pRoot->xCode != PH7_CompileVariable ){` |
...
|        - | 11915 | ` */` |
|   345340 | 11916 | `static sxi32 PH7_CompileThrow(ph7_gen_state *pGen)` |
|        5 | 11917 | `{` |
|   345345 | 11918 | `	sxu32 nLine = pGen->pIn->nLine;` |
|        - | 11919 | `	GenBlock *pBlock;` |
|        - | 11920 | `	sxu32 nIdx;` |
|        - | 11921 | `	sxi32 rc;` |
|   345345 | 11922 | `	pGen->pIn++; /* Jump the 'throw' keyword */` |
|        - | 11923 | `	/* Compile the expression */` |
|   345345 | 11924 | `	rc = PH7_CompileExpr(&(*pGen),0,GenStateThrowNodeValidator);` |
|   345345 | 11925 | `	if( rc == SXERR_EMPTY ){` |
...
|        - | 11931 | `	}` |
|   345345 | 11932 | `	pBlock = pGen->pCurrent;` |
|        - | 11933 | `	/* Point to the top most function or try block and emit the forward jump */` |
|  1357377 | 11934 | `	while(pBlock->pParent){` |
|  1357373 | 11935 | `		if( pBlock->iFlags & (GEN_BLOCK_EXCEPTION\|GEN_BLOCK_FUNC) ){` |
|   345341 | 11936 | `			break;` |
|        - | 11937 | `		}` |
|        - | 11938 | `		/* Point to the parent block */` |
|  1012037 | 11939 | `		pBlock = pBlock->pParent;` |
|        5 | 11940 | `	}` |
|        - | 11941 | `	/* Emit the throw instruction */` |
|   345345 | 11942 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_THROW,0,0,0,&nIdx);` |
|        - | 11943 | `	/* Emit the jump */` |
|   345345 | 11944 | `	GenStateNewJumpFixup(pBlock,PH7_OP_THROW,nIdx);` |
|   345345 | 11945 | `	return SXRET_OK;` |
|   172675 | 11946 | `}` |
|        - | 11947 | `/*` |
...
|        - | 12185 | ` */` |
|    20770 | 12186 | `static sxi32 PH7_CompileCatch(ph7_gen_state *pGen,ph7_exception *pException)` |
|        5 | 12187 | `{` |
|    20775 | 12188 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|        - | 12195 | `	char *zDup;` |
|        - | 12196 | `	sxi32 rc;` |
|    20775 | 12197 | `	pGen->pIn++; /* Jump the 'catch' keyword */` |
|        - | 12198 | `	/* Zero the structure */` |
|    20775 | 12199 | `	SyZero(&sCatch,sizeof(ph7_exception_block));` |
|        - | 12200 | `	/* Initialize fields */` |
|    20775 | 12201 | `	SySetInit(&sCatch.aClasses,&pException->pVm->sAllocator,sizeof(SyString));` |
|    20775 | 12202 | `	SySetInit(&sCatch.sByteCode,&pException->pVm->sAllocator,sizeof(VmInstr));` |
|    20775 | 12203 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 /*(*/ ){` |
...
|    20775 | 12218 | `	pGen->pIn++; /* Jump the left parenthesis '(' */` |
|    10399 | 12219 | `	for(;;){` |
|        - | 12220 | `		SyBlob sResolved;` |
|    20803 | 12221 | `		SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|    20803 | 12222 | `		if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|    31196 | 12238 | `		zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|    20794 | 12239 | `			(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|    20799 | 12240 | `		SyStringInitFromBuf(&sClassName,zDup,SyBlobLength(&sResolved));` |
|    20799 | 12241 | `		SyBlobRelease(&sResolved);` |
|    20799 | 12242 | `		if( zDup == 0 ){` |
|      ! 0 | 12243 | `			goto Mem;` |
|        - | 12244 | `		}` |
|    20799 | 12245 | `		rc = SySetPut(&sCatch.aClasses,(const void *)&sClassName);` |
|    20799 | 12246 | `		if( rc != SXRET_OK ){` |
|      ! 0 | 12247 | `			goto Mem;` |
|        - | 12248 | `		}` |
|        - | 12249 | `		/* Check for '\|' (multi-catch separator) */` |
|    20794 | 12250 | `		if( pGen->pIn < pGen->pEnd &&` |
|    20794 | 12251 | `			(pGen->pIn->nType & PH7_TK_OP) &&` |
...
|    20771 | 12257 | `		break;` |
|      ! 0 | 12258 | `	}` |
|    20766 | 12259 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 /*$*/ \|\|` |
|    20771 | 12260 | `		&pGen->pIn[1] >= pGen->pEnd \|\| (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|        - | 12273 | `	}` |
|    20771 | 12274 | `	pGen->pIn++; /* Jump the dollar sign */` |
|        - | 12275 | `	/* Duplicate instance name */` |
|    20771 | 12276 | `	pName = &pGen->pIn->sData;` |
|    20771 | 12277 | `	zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|    20771 | 12278 | `	if( zDup == 0 ){` |
|      ! 0 | 12279 | `		goto Mem;` |
|        - | 12280 | `	}` |
|    20771 | 12281 | `	SyStringInitFromBuf(&sCatch.sThis,zDup,pName->nByte);` |
|    20771 | 12282 | `	pGen->pIn++;` |
|    20771 | 12283 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_RPAREN) == 0 /*)*/ ){` |
...
|    20771 | 12298 | `	pGen->pIn++; /* Jump the right parenthesis */` |
|        - | 12299 | `	/* Create the catch block */` |
|    20771 | 12300 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_EXCEPTION,PH7_VmInstrLength(pGen->pVm),0,&pCatch);` |
|    20771 | 12301 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 12302 | `		return SXERR_ABORT;` |
|        - | 12303 | `	}` |
|        - | 12304 | `	/* Swap bytecode container */` |
|    20771 | 12305 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|    20771 | 12306 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&sCatch.sByteCode);` |
|        - | 12307 | `	/* Compile the block */` |
|    20771 | 12308 | `	PH7_CompileBlock(&(*pGen),0);` |
|        - | 12309 | `	/* Fix forward jumps now the destination is resolved  */` |
|    20771 | 12310 | `	GenStateFixJumps(pCatch,-1,PH7_VmInstrLength(pGen->pVm));` |
|        - | 12311 | `	/* Emit the DONE instruction */` |
|    20771 | 12312 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|        - | 12313 | `	/* Leave the block */` |
|    20771 | 12314 | `	GenStateLeaveBlock(&(*pGen),0);` |
|        - | 12315 | `	/* Restore the default container */` |
|    20771 | 12316 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|        - | 12317 | `	/* Install the catch block */` |
|    20771 | 12318 | `	rc = SySetPut(&pException->sEntry,(const void *)&sCatch);` |
|    20771 | 12319 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 12320 | `		goto Mem;` |
|        - | 12321 | `	}` |
|    20771 | 12322 | `	return SXRET_OK;` |
|      ! 0 | 12323 | `Mem:` |
...
|        - | 12332 | ` * is "thrown".` |
|        - | 12333 | ` */` |
|    20926 | 12334 | `static sxi32 PH7_CompileTry(ph7_gen_state *pGen)` |
|        5 | 12335 | `{` |
|        - | 12336 | `	ph7_exception *pException;` |
|    20931 | 12337 | `	sxu32 nLine = pGen->pIn->nLine;` |
|        - | 12338 | `	GenBlock *pTry;` |
|        - | 12339 | `	sxu32 nJmpIdx;` |
|        - | 12340 | `	sxi32 rc;` |
|        - | 12341 | `	/* Create the exception container */` |
|    20931 | 12342 | `	pException = (ph7_exception *)SyMemBackendAlloc(&pGen->pVm->sAllocator,sizeof(ph7_exception));` |
|    20931 | 12343 | `	if( pException == 0 ){` |
...
|    20931 | 12349 | `	SyZero(pException,sizeof(ph7_exception));` |
|        - | 12350 | `	/* Initialize fields */` |
|    20931 | 12351 | `	SySetInit(&pException->sEntry,&pGen->pVm->sAllocator,sizeof(ph7_exception_block));` |
|    20931 | 12352 | `	SySetInit(&pException->sFinally,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|    20931 | 12353 | `	pException->iHasFinally = 0;` |
|    20931 | 12354 | `	pException->iFinallyDone = 0;` |
|    20931 | 12355 | `	pException->pVm = pGen->pVm;` |
...
|    20931 | 12362 | `	if( pGen->bInGenerator && pGen->pVm->bInlineTryCatch ){` |
|      103 | 12363 | `		return PH7_CompileTryInline(&(*pGen),pException);` |
|        - | 12364 | `	}` |
|        - | 12365 | `	/* Create the try block */` |
|    20833 | 12366 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_EXCEPTION,PH7_VmInstrLength(pGen->pVm),0,&pTry);` |
|    20833 | 12367 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 12368 | `		return SXERR_ABORT;` |
|        - | 12369 | `	}` |
|        - | 12370 | `	/* Store exception pointer so break/continue can emit POP_EXCEPTION */` |
|    20833 | 12371 | `	pTry->pUserData = pException;` |
|        - | 12372 | `	/* Emit the 'LOAD_EXCEPTION' instruction */` |
|    20833 | 12373 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_EXCEPTION,0,0,pException,&nJmpIdx);` |
|        - | 12374 | `	/* Fix the jump later when the destination is resolved */` |
|    20833 | 12375 | `	GenStateNewJumpFixup(pTry,PH7_OP_LOAD_EXCEPTION,nJmpIdx);` |
|    20833 | 12376 | `	pGen->pIn++; /* Jump the 'try' keyword */` |
|        - | 12377 | `	/* Compile the block */` |
|    20833 | 12378 | `	rc = PH7_CompileBlock(&(*pGen),0);` |
|    20833 | 12379 | `	if( rc == SXERR_ABORT ){` |
|      ! 0 | 12380 | `		return SXERR_ABORT;` |
|        - | 12381 | `	}` |
|        - | 12382 | `	/* Fix forward jumps now the destination is resolved */` |
|    20833 | 12383 | `	GenStateFixJumps(pTry,-1,PH7_VmInstrLength(pGen->pVm));` |
|        - | 12384 | `	/* Emit the 'POP_EXCEPTION' instruction */` |
|    20833 | 12385 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP_EXCEPTION,0,0,pException,0);` |
|        - | 12386 | `	/* Leave the block */` |
|    20833 | 12387 | `	GenStateLeaveBlock(&(*pGen),0);` |
|        - | 12388 | `	/* Compile catch block(s) — at least one catch or finally is required */` |
|    20833 | 12389 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|    20826 | 12390 | `		SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_CATCH ){` |
|        - | 12391 | `		/* Compile one or more catch blocks */` |
|    20766 | 12392 | `		for(;;){` |
|    41532 | 12393 | `			if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0` |
|    31204 | 12394 | `				\|\| SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_CATCH ){` |
|    10386 | 12395 | `					break;` |
|        - | 12396 | `			}` |
|    20775 | 12397 | `			rc = PH7_CompileCatch(&(*pGen),pException);` |
|    20775 | 12398 | `			if( rc == SXERR_ABORT ){` |
|      ! 0 | 12399 | `				return SXERR_ABORT;` |
|        - | 12400 | `			}` |
|        5 | 12401 | `		}` |
|    10381 | 12402 | `	}` |
|        - | 12403 | `	/* Compile optional finally block */` |
|    20833 | 12404 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
...
|    20833 | 12434 | `	if( SySetUsed(&pException->sEntry) == 0 && !pException->iHasFinally ){` |
...
|        - | 12797 | ` */` |
| 28766584 | 12798 | `static void GenStatePatchNullsafeJumps(ph7_gen_state *pGen, sxu32 nBaseline)` |
|        5 | 12799 | `{` |
| 28766589 | 12800 | `	sxu32 nCur = SySetUsed(&pGen->aNullsafeJmp);` |
|        - | 12801 | `	sxu32 nTarget;` |
|        - | 12802 | `	sxu32 *aIdx;` |
|        - | 12803 | `	sxu32 i;` |
| 28766589 | 12804 | `	if( nCur <= nBaseline ){` |
| 28766493 | 12805 | `		return;` |
|        - | 12806 | `	}` |
...
|        - | 12834 | ` */` |
|  3806922 | 12835 | `static sxu32 GenStateByRefBuiltinMask(SyString *pName)` |
|        5 | 12836 | `{` |
...
|        - | 12847 | `	};` |
|        - | 12848 | `	sxu32 i;` |
|  3806927 | 12849 | `	if( pName == 0 \|\| pName->zString == 0 \|\| pName->nByte == 0 ){` |
|  1108867 | 12850 | `		return 0;` |
|        - | 12851 | `	}` |
| 16110451 | 12852 | `	for( i = 0 ; i < SX_ARRAYSIZE(aByRef) ; ++i ){` |
| 13428012 | 12853 | `		if( pName->nByte == aByRef[i].nByte` |
|  6909632 | 12854 | `		 && SyStrnicmp(pName->zString, aByRef[i].zName, pName->nByte) == 0 ){` |
|    15631 | 12855 | `			return aByRef[i].mask;` |
|        - | 12856 | `		}` |
|  6706198 | 12857 | `	}` |
|  2682439 | 12858 | `	return 0;` |
|  1903466 | 12859 | `}` |
|        - | 12860 | `/*` |
...
|        - | 12869 | ` */` |
|  3806922 | 12870 | `static void GenStateCallBuiltinName(ph7_expr_node *pLeft, SyString *pOut)` |
|        5 | 12871 | `{` |
|        - | 12872 | `	SyToken *p, *pEnd;` |
|  3806927 | 12873 | `	pOut->zString = 0;` |
|  3806927 | 12874 | `	pOut->nByte = 0;` |
|  3806927 | 12875 | `	if( pLeft == 0 \|\| pLeft->pStart == 0 \|\| pLeft->pEnd == 0 ){` |
|      ! 0 | 12876 | `		return;` |
|        - | 12877 | `	}` |
|  3806927 | 12878 | `	p = pLeft->pStart;` |
|  3806927 | 12879 | `	pEnd = pLeft->pEnd;` |
|        - | 12880 | `	/* Optional single leading namespace separator (absolute path). */` |
|  3806927 | 12881 | `	if( p < pEnd && (p->nType & PH7_TK_NSSEP) ){` |
|     3909 | 12882 | `		p++;` |
|     1952 | 12883 | `	}` |
|  3806927 | 12884 | `	if( p >= pEnd \|\| (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|  1108831 | 12885 | `		return;` |
|        - | 12886 | `	}` |
|        - | 12887 | `	/* Must be a single component: nothing follows the name token. */` |
|  2698101 | 12888 | `	if( p + 1 != pEnd ){` |
|       41 | 12889 | `		return;` |
|        - | 12890 | `	}` |
|  2698065 | 12891 | `	*pOut = p->sData;` |
|  1903466 | 12892 | `}` |
|        - | 12893 | `/*` |
...
|        - | 12898 | ` * error message.` |
|        - | 12899 | ` */` |
| 40159480 | 12900 | `static sxi32 GenStateEmitExprCode(` |
...
|        - | 12907 | `	sxu32 nJmpIdx;` |
| 40159485 | 12908 | `	sxi32 iP1 = 0;` |
| 40159485 | 12909 | `	sxu32 iP2 = 0;` |
| 40159485 | 12910 | `	void *p3  = 0;` |
|        - | 12911 | `	sxi32 iVmOp;` |
|        - | 12912 | `	sxi32 rc;` |
| 40159485 | 12913 | `	int bIsChainOp = 0; /* Set below once we know pNode->pOp */` |
| 40159485 | 12914 | ``	int bFcc = 0;       /* First-class callable `f(...)`: emit OP_LOAD_FCC, not OP_CALL */`` |
| 40159485 | 12915 | `	sxu32 nRhsNsBase = 0;` |
| 40159485 | 12916 | `	if( pNode->xCode ){` |
|        - | 12917 | `		SyToken *pTmpIn,*pTmpEnd;` |
|        - | 12918 | `		/* Compile node */` |
| 24115531 | 12919 | `		SWAP_DELIMITER(pGen,pNode->pStart,pNode->pEnd);` |
| 24115531 | 12920 | `		rc = pNode->xCode(&(*pGen),iFlags);` |
| 24115531 | 12921 | `		RE_SWAP_DELIMITER(pGen);` |
| 24115531 | 12922 | `		return rc;` |
|        - | 12923 | `	}` |
| 16043959 | 12924 | `	if( pNode->pOp == 0 ){` |
...
|        - | 12928 | `	}` |
| 16043959 | 12929 | `	iVmOp = pNode->pOp->iVmOp;` |
| 16043959 | 12930 | `	if( iVmOp == PH7_OP_CVT_NULL ){` |
...
|        - | 12938 | `		}` |
|        1 | 12939 | `	}` |
| 16043959 | 12940 | `	if( pNode->pOp->iOp == EXPR_OP_NULLC_ASSIGN ){` |
...
|        - | 12989 | `	}` |
| 16043871 | 12990 | `	if( pNode->pOp->iOp == EXPR_OP_QUESTY ){` |
...
|   270661 | 12995 | `		nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|   270661 | 12996 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pCond,iFlags);` |
|   270661 | 12997 | `		if( rc != SXRET_OK ){` |
|      ! 0 | 12998 | `			return rc;` |
|        - | 12999 | `		}` |
...
|   270661 | 13003 | `		GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|   270661 | 13004 | `		nJz = nJmp = 0; /* cc -O6 warning */` |
|   270661 | 13005 | `		if( pNode->pLeft ){` |
|        - | 13006 | `			/* Standard ternary: (expr) ? (then) : (else) */` |
|        - | 13007 | `			/* Phase#2: Emit the false jump (pops condition) */` |
|   270593 | 13008 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nJz);` |
|        - | 13009 | `			/* Phase#3: Compile the 'then' expression  */` |
|   270593 | 13010 | `			nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|   270593 | 13011 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pLeft,iFlags);` |
|   270593 | 13012 | `			if( rc != SXRET_OK ){` |
|      ! 0 | 13013 | `				return rc;` |
|        - | 13014 | `			}` |
|   270593 | 13015 | `			GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|   135299 | 13016 | `		}else{` |
...
|   270661 | 13024 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,0,0,&nJmp);` |
|        - | 13025 | `		/* Phase#5: Fix the false jump now the jump destination is resolved. */` |
|   270661 | 13026 | `		pInstr = PH7_VmGetInstr(pGen->pVm,nJz);` |
|   270661 | 13027 | `		if( pInstr ){` |
|   270661 | 13028 | `			pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|   135328 | 13029 | `		}` |
|   270661 | 13030 | `		if( !pNode->pLeft ){` |
...
|   270661 | 13035 | `		if( pNode->pRight ){` |
|   270661 | 13036 | `			nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|   270661 | 13037 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pRight,iFlags);` |
|   270661 | 13038 | `			if( rc != SXRET_OK ){` |
|      ! 0 | 13039 | `				return rc;` |
|        - | 13040 | `			}` |
|   270661 | 13041 | `			GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|   135328 | 13042 | `		}` |
|   270661 | 13043 | `		if( nJmp > 0 ){` |
|        - | 13044 | `			/* Phase#7: Fix the unconditional jump */` |
|   270661 | 13045 | `			pInstr = PH7_VmGetInstr(pGen->pVm,nJmp);` |
|   270661 | 13046 | `			if( pInstr ){` |
|   270661 | 13047 | `				pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|   135328 | 13048 | `			}` |
|   135328 | 13049 | `		}` |
|        - | 13050 | `		/* All done */` |
|   270661 | 13051 | `		return SXRET_OK;` |
|        - | 13052 | `	}` |
| 15773215 | 13053 | `	if( pNode->pOp->iOp == EXPR_OP_PIPE ){` |
...
|        - | 13085 | `	}` |
| 15773189 | 13086 | `	bIsChainOp = GEN_IS_CHAIN_OP(pNode->pOp->iOp);` |
|        - | 13087 | `	/* Generate code for the left tree */` |
| 15773189 | 13088 | `	if( pNode->pLeft ){` |
| 15761559 | 13089 | `		sxu32 nLhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
| 15761559 | 13090 | `		if( iVmOp == PH7_OP_CALL ){` |
|        - | 13091 | `			ph7_expr_node **apNode;` |
|  3811119 | 13092 | `			int hasSpread = 0;` |
|  3811119 | 13093 | `			int hasNamed = 0;` |
|  3811119 | 13094 | `			int bAnySpread = 0;` |
|  3811119 | 13095 | `			sxu32 byRefMask = 0;` |
|        - | 13096 | `			sxi32 nArgs;` |
|        - | 13097 | `			sxi32 n;` |
|        - | 13098 | `			/* Recurse and generate bytecodes for function arguments */` |
|  3811119 | 13099 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  3811119 | 13100 | `			nArgs = (sxi32)SySetUsed(&pNode->aNodeArgs);` |
...
|  3811119 | 13104 | `			if( nArgs == 1 && apNode[0] && (apNode[0]->iFlags & EXPR_NODE_FCC) ){` |
|       81 | 13105 | `				bFcc = 1;` |
|       81 | 13106 | `				nArgs = 0;` |
|       40 | 13107 | `			}` |
...
|        - | 13110 | `			{` |
|  3811119 | 13111 | `				int seenNamed = 0;` |
|  3811119 | 13112 | `				int seenSpread = 0;` |
|  7922891 | 13113 | `				for( n = 0; n < nArgs; ++n ){` |
|  4111779 | 13114 | `					if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
...
|        5 | 13121 | `						}` |
|  4109749 | 13122 | `					}else if( apNode[n]->iFlags & EXPR_NODE_NAMED_ARG ){` |
|      289 | 13123 | `						seenNamed = 1;` |
|      289 | 13124 | `						hasNamed = 1;` |
|  4107577 | 13125 | `					}else if( seenNamed ){` |
...
|  4107433 | 13129 | `					}else if( seenSpread ){` |
...
|  3811117 | 13137 | `			iFlags \|= EXPR_FLAG_RDONLY_LOAD;` |
...
|  3811117 | 13142 | `			if( pNode->pLeft && pNode->pLeft->pStart ){` |
|  3811117 | 13143 | `				SyString *pCallName = &pNode->pLeft->pStart->sData;` |
|  3811112 | 13144 | `				if( pCallName->nByte == 5` |
|  2094802 | 13145 | `				 && SyStrnicmp(pCallName->zString,"isset",5) == 0 ){` |
|   201913 | 13146 | `					iFlags \|= EXPR_FLAG_LOAD_IDX_ISSET;` |
|  3710163 | 13147 | `				}else if( pCallName->nByte == 5` |
|  1892894 | 13148 | `				 && SyStrnicmp(pCallName->zString,"empty",5) == 0 ){` |
...
|  3811117 | 13157 | `				if( !bAnySpread && !hasNamed ){` |
|        - | 13158 | `					SyString sBuiltin;` |
|  3806927 | 13159 | `					GenStateCallBuiltinName(pNode->pLeft, &sBuiltin);` |
|  3806927 | 13160 | `					byRefMask = GenStateByRefBuiltinMask(&sBuiltin);` |
|  1903461 | 13161 | `				}` |
|  1905556 | 13162 | `			}` |
|  7922887 | 13163 | `			for( n = 0 ; n < nArgs ; ++n ){` |
|  4111775 | 13164 | `				sxu32 nArgNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  4111775 | 13165 | `				sxi32 iArgFlags = iFlags & ~(EXPR_FLAG_LOAD_IDX_STORE\|EXPR_FLAG_MEMBER_WRITE);` |
...
|  4111775 | 13172 | `				if( n < 31 && (byRefMask & (1u<<n)) ){` |
|    15565 | 13173 | `					iArgFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|    15565 | 13174 | `					iArgFlags \|= EXPR_FLAG_LOAD_IDX_STORE;` |
|     7780 | 13175 | `				}` |
|  4111775 | 13176 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iArgFlags);` |
|  4111775 | 13177 | `				if( rc != SXRET_OK ){` |
|      ! 0 | 13178 | `					return rc;` |
|        - | 13179 | `				}` |
|        - | 13180 | `				/* Each argument is an independent nullsafe scope. */` |
|  4111775 | 13181 | `				GenStatePatchNullsafeJumps(pGen, nArgNsBase);` |
|  4111775 | 13182 | `				if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
...
|  3811117 | 13225 | `			iFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|  1905556 | 13226 | `		}` |
|        - | 13227 | `		{` |
...
| 15761557 | 13236 | `			sxi32 iLeftFlags = iFlags;` |
| 15761552 | 13237 | `			if( pNode->pLeft && pNode->pLeft->pOp` |
| 13115409 | 13238 | `				&& (pNode->pLeft->pOp->iOp == EXPR_OP_ARROW` |
|  5234659 | 13239 | `					\|\| pNode->pLeft->pOp->iOp == EXPR_OP_NULLSAFE_ARROW` |
|  4626171 | 13240 | `					\|\| pNode->pLeft->pOp->iOp == EXPR_OP_DC) ){` |
|  1263967 | 13241 | `				iLeftFlags &= ~EXPR_FLAG_LOAD_IDX_UNSET;` |
|   631981 | 13242 | `			}` |
...
| 15761552 | 13250 | `			if( pNode->pOp` |
| 22263513 | 13251 | `				&& (pNode->pOp->iOp == EXPR_OP_ARROW` |
| 14382784 | 13252 | `					\|\| pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW` |
| 13003964 | 13253 | `					\|\| pNode->pOp->iOp == EXPR_OP_DC) ){` |
|  2839821 | 13254 | `				iLeftFlags &= ~EXPR_FLAG_MEMBER_WRITE;` |
|  1419908 | 13255 | `			}` |
...
| 15761552 | 13262 | `			if( pNode->pOp` |
| 15761557 | 13263 | `				&& (pNode->pOp->iVmOp == PH7_OP_INCR \|\| pNode->pOp->iVmOp == PH7_OP_DECR) ){` |
|    97387 | 13264 | `				iLeftFlags \|= EXPR_FLAG_LOAD_IDX_STORE \| EXPR_FLAG_MEMBER_WRITE;` |
|    48691 | 13265 | `			}` |
| 15761557 | 13266 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pLeft,iLeftFlags);` |
|        - | 13267 | `		}` |
| 15761557 | 13268 | `		if( rc != SXRET_OK ){` |
|       34 | 13269 | `			return rc;` |
|        - | 13270 | `		}` |
| 15761527 | 13271 | `		if( !bIsChainOp ){` |
...
|  7220049 | 13274 | `			GenStatePatchNullsafeJumps(pGen, nLhsNsBase);` |
|  3610022 | 13275 | `		}` |
| 15761527 | 13276 | `		if( iVmOp == PH7_OP_CALL ){` |
|  3811117 | 13277 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|  3811117 | 13278 | `			if( pInstr ){` |
|  3811117 | 13279 | `				if ( pInstr->iOp == PH7_OP_LOADC ){` |
|  2698341 | 13280 | `					sxu32 nOrig = (sxu32)pInstr->iP2;` |
|        - | 13281 | `					sxu32 nQual;` |
|  2698341 | 13282 | `					int bAbsolute = (pInstr->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|        - | 13283 | `					/* Prevent constant expansion but preserve the absolute flag` |
|        - | 13284 | `					 * so the later NEW handler (if any) can see it. */` |
|  2698341 | 13285 | `					pInstr->iP1 &= ~PH7_LOADC_EXPAND;` |
...
|  2698341 | 13293 | `					if( bAbsolute ){` |
|     3909 | 13294 | `						pInstr->iP2 = (sxi32)nOrig;` |
|     1957 | 13295 | `					}else{` |
|  2694437 | 13296 | `						int fromImport = 0;` |
|  2694437 | 13297 | `						nQual = GenStateNsQualifyName(pGen,nOrig,&pGen->hUseFuncImports,&fromImport);` |
|  2694437 | 13298 | `						pInstr->iP2 = (sxi32)nQual;` |
|  2694437 | 13299 | `						if( nQual != nOrig ){` |
...
|       36 | 13320 | `						}` |
|        5 | 13321 | `					}` |
|  2461949 | 13322 | `				}else if( pInstr->iOp == PH7_OP_MEMBER /* $a->b(1,2,3) */ \|\| pInstr->iOp == PH7_OP_NEW ){` |
|        - | 13323 | `					/* Method call,flag that */` |
|  1100541 | 13324 | `					pInstr->iP2 = 1;` |
|   550268 | 13325 | `				}` |
|  1905561 | 13326 | `			}` |
| 13855971 | 13327 | `		}else if( iVmOp == PH7_OP_LOAD_IDX ){` |
|        - | 13328 | `			ph7_expr_node **apNode;` |
|        - | 13329 | `			sxi32 n;` |
|  1890555 | 13330 | `			sxi32 iChildMask = ~(EXPR_FLAG_LOAD_IDX_STORE` |
...
|  1890555 | 13334 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  3653053 | 13335 | `			for( n = 0 ; n < (sxi32)SySetUsed(&pNode->aNodeArgs) ; ++n ){` |
|  1762503 | 13336 | `				sxu32 nIdxNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  1762503 | 13337 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iFlags&iChildMask);` |
|  1762503 | 13338 | `				if( rc != SXRET_OK ){` |
|      ! 0 | 13339 | `					return rc;` |
|        - | 13340 | `				}` |
|        - | 13341 | `				/* Each subscript index is an independent nullsafe scope. */` |
|  1762503 | 13342 | `				GenStatePatchNullsafeJumps(pGen, nIdxNsBase);` |
|   881254 | 13343 | `			}` |
|  1890555 | 13344 | `			if( SySetUsed(&pNode->aNodeArgs) > 0 ){` |
|  1762503 | 13345 | `				iP1 = 1; /* Node have an index associated with it */` |
|   881249 | 13346 | `			}` |
|  1890555 | 13347 | `			if( iFlags & EXPR_FLAG_LOAD_IDX_ISSET ){` |
|        - | 13348 | `				/* offsetExists for ArrayAccess; peek-only for arrays */` |
|   240563 | 13349 | `				iP2 = 4;` |
|  1770276 | 13350 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_UNSET ){` |
|        - | 13351 | `				/* offsetUnset for ArrayAccess; auto-vivify+load for arrays` |
|        - | 13352 | `				 * so the trailing unset() builtin can drop the slot. */` |
|       72 | 13353 | `				iP2 = 5;` |
|  1649963 | 13354 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_EMPTY ){` |
...
|       29 | 13358 | `				iP2 = 6;` |
|  1649917 | 13359 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_STORE ){` |
|        - | 13360 | `				/* Create an empty entry when the desired index is not found */` |
|   206051 | 13361 | `				iP2 = 1;` |
|   103028 | 13362 | `			}` |
| 11005140 | 13363 | `		}else if( pNode->pOp->iOp == EXPR_OP_COMMA ){` |
|        - | 13364 | `			/* POP the left node */` |
|       32 | 13365 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|       15 | 13366 | `		}` |
|  7880761 | 13367 | `	}` |
| 15773157 | 13368 | `	rc = SXRET_OK;` |
| 15773157 | 13369 | `	nJmpIdx = 0;` |
...
| 15773157 | 13373 | `	if( iVmOp == PH7_OP_MEMBER && pNode->pOp->iOp == EXPR_OP_DC ){` |
|    93811 | 13374 | `		pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|    93811 | 13375 | `		if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|    93811 | 13376 | `			ph7_value *pLitCheck = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,(sxu32)pInstr->iP2);` |
|    93811 | 13377 | `			int isSpecial = 0;` |
|    93811 | 13378 | `			if( pLitCheck && (pLitCheck->iFlags & MEMOBJ_STRING) ){` |
|    70523 | 13379 | `				const char *z = (const char *)SyBlobData(&pLitCheck->sBlob);` |
|    70523 | 13380 | `				sxu32 n = (sxu32)SyBlobLength(&pLitCheck->sBlob);` |
|    70518 | 13381 | `				if( (n == 4 && SyMemcmp(z,"self",4) == 0) \|\|` |
|    58834 | 13382 | `					(n == 6 && SyMemcmp(z,"static",6) == 0) \|\|` |
|    29419 | 13383 | `					(n == 6 && SyMemcmp(z,"parent",6) == 0) ){` |
|    35029 | 13384 | `					isSpecial = 1;` |
|    17512 | 13385 | `				}` |
|    41081 | 13386 | `			}` |
|   105455 | 13387 | `			pInstr->iP1 = 0;` |
|   105455 | 13388 | `			if( !isSpecial ){` |
|    47143 | 13389 | `				pInstr->iP2 = (sxi32)GenStateNsQualifyName(pGen,(sxu32)pInstr->iP2,&pGen->hUseImports,0);` |
|    23569 | 13390 | `			}` |
...
|    82167 | 13393 | `			if( !isSpecial && pNode->pRight && pNode->pRight->pStart ){` |
|    47143 | 13394 | `				SyToken *pRightTok = pNode->pRight->pStart;` |
|    47143 | 13395 | `				if( (pRightTok->nType & PH7_TK_KEYWORD) &&` |
...
| 15761469 | 13403 | `	if( pNode->pRight ){` |
|  8845445 | 13404 | `		if( iVmOp == PH7_OP_LAND ){` |
|        - | 13405 | `			/* Emit the false jump so we can short-circuit the logical and */` |
|   159445 | 13406 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,1/* Keep the value on the stack */,0,0,&nJmpIdx);` |
|  8765725 | 13407 | `		}else if (iVmOp == PH7_OP_LOR ){` |
|        - | 13408 | `			/* Emit the true jump so we can short-circuit the logical or*/` |
|   155223 | 13409 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JNZ,1/* Keep the value on the stack */,0,0,&nJmpIdx);` |
|  8608396 | 13410 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLC ){` |
|        - | 13411 | `			/* Null coalescing: if LHS is not null, jump past RHS */` |
|    27281 | 13412 | `			iVmOp = 0; /* No binary operator to emit */` |
|    27281 | 13413 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_NULLC,0,0,0,&nJmpIdx);` |
|  8517201 | 13414 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW ){` |
...
|  8503459 | 13424 | `		}else if( pNode->pOp->iPrec == 18 /* Combined binary operators [i.e: =,'.=','+=',*=' ...] precedence */ ){` |
...
|  3030695 | 13428 | `			iFlags \|= EXPR_FLAG_LOAD_IDX_STORE \| EXPR_FLAG_MEMBER_WRITE;` |
|  1515345 | 13429 | `		}` |
|  8845445 | 13430 | `		nRhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  8845445 | 13431 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pRight,iFlags);` |
|  8845445 | 13432 | `		if( !bIsChainOp ){` |
|        - | 13433 | `			/* Non-chain parent: RHS nullsafe chain ends here, before the` |
|        - | 13434 | `			 * operator instruction is emitted. */` |
|  6005687 | 13435 | `			GenStatePatchNullsafeJumps(pGen, nRhsNsBase);` |
|  3002841 | 13436 | `		}` |
|  8845445 | 13437 | `		if( iVmOp == PH7_OP_STORE ){` |
|  2627271 | 13438 | `			if( pNode->pRight && (pNode->pRight->xCode == PH7_CompileList \|\|` |
|  2627236 | 13439 | `				pNode->pRight->xCode == PH7_CompileShortList) ){` |
...
|        - | 13445 | `				 */` |
|       89 | 13446 | `				iVmOp = 0;` |
|  2627229 | 13447 | `			}else if( (pInstr = PH7_VmPeekInstr(pGen->pVm)) != 0 ){` |
|  2627187 | 13448 | `				if(pInstr->iOp == PH7_OP_MEMBER ){` |
|        - | 13449 | `					/* Perform a member store operation [i.e: $this->x = 50] */` |
|   523953 | 13450 | `					iP2 = 1;` |
|   261979 | 13451 | `				}else{` |
|  2103239 | 13452 | `					if( pInstr->iOp == PH7_OP_LOAD_IDX ){` |
|        - | 13453 | `						/* Transform the STORE instruction to STORE_IDX instruction */` |
|   205955 | 13454 | `						iVmOp = PH7_OP_STORE_IDX;` |
|   205955 | 13455 | `						iP1 = pInstr->iP1;` |
|   102980 | 13456 | `					}else{` |
|  1897289 | 13457 | `						p3 = pInstr->p3;` |
|        - | 13458 | `					}` |
|        - | 13459 | `					/* POP the last dynamic load instruction */` |
|  2103239 | 13460 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|        - | 13461 | `				}` |
|  1313596 | 13462 | `			}` |
|  7531812 | 13463 | `		}else if( iVmOp == PH7_OP_STORE_REF ){` |
...
|       30 | 13478 | `		}` |
|  4422720 | 13479 | `	}` |
| 15761464 | 13480 | `	if( iVmOp == PH7_OP_NEW && pNode->pLeft && pNode->pLeft->pOp == 0` |
|   282473 | 13481 | `		&& pNode->pLeft->xCode == PH7_CompileAnnonClass ){` |
...
|       32 | 13484 | `		iVmOp = 0;` |
|       14 | 13485 | `	}` |
| 15761469 | 13486 | `	if( iVmOp > 0 ){` |
| 15734051 | 13487 | `		if( iVmOp == PH7_OP_INCR \|\| iVmOp == PH7_OP_DECR ){` |
|    97387 | 13488 | `			if( pNode->iFlags & EXPR_NODE_PRE_INCR ){` |
|        - | 13489 | `				/* Pre-increment/decrement operator [i.e: ++$i,--$j ] */` |
|    11663 | 13490 | `				iP1 = 1;` |
|     5834 | 13491 | `			}` |
| 15685360 | 13492 | `		}else if( iVmOp == PH7_OP_NEW ){` |
|        - | 13493 | `			/* Namespace-qualify the class name for NEW */ {` |
|   564635 | 13494 | `				VmInstr *pPeek = PH7_VmPeekInstr(pGen->pVm);` |
|   564635 | 13495 | `				VmInstr *pCallInstr = 0;` |
|   564635 | 13496 | `				if( pPeek && pPeek->iOp == PH7_OP_CALL ){` |
|   564385 | 13497 | `					pCallInstr = pPeek;` |
|   564385 | 13498 | `					pPeek = PH7_VmPeekNextInstr(pGen->pVm);` |
|   282190 | 13499 | `				}` |
|   564635 | 13500 | `				if( pPeek && pPeek->iOp == PH7_OP_LOADC ){` |
|   556879 | 13501 | `					int bAbsolute = (pPeek->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|        - | 13502 | `					sxu32 nLitForClass;` |
|   556879 | 13503 | `					VmCallArgMap *pCallNsMap = pCallInstr ? (VmCallArgMap *)pCallInstr->p3 : 0;` |
...
|   556879 | 13510 | `					if( pCallNsMap && pCallNsMap->nOrigNameLit > 0 ){` |
|       37 | 13511 | `						nLitForClass = pCallNsMap->nOrigNameLit - 1;` |
|       21 | 13512 | `					}else{` |
|   556847 | 13513 | `						nLitForClass = (sxu32)pPeek->iP2;` |
|        - | 13514 | `					}` |
|   556879 | 13515 | `					pPeek->iP1 = 0;` |
|   556879 | 13516 | `					if( !bAbsolute ){` |
|   552979 | 13517 | `						pPeek->iP2 = (sxi32)GenStateNsQualifyName(pGen,nLitForClass,&pGen->hUseImports,0);` |
|   276492 | 13518 | `					}else{` |
|     3905 | 13519 | `						pPeek->iP2 = (sxi32)nLitForClass;` |
|        - | 13520 | `					}` |
|   278437 | 13521 | `				}` |
|        - | 13522 | `			}` |
|   564635 | 13523 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|   564635 | 13524 | `			if( pInstr && pInstr->iOp == PH7_OP_CALL ){` |
|        - | 13525 | `				VmInstr *pPrev;` |
|   564385 | 13526 | `				pPrev = PH7_VmPeekNextInstr(pGen->pVm);` |
|   564385 | 13527 | `				if( pPrev == 0 \|\| pPrev->iOp != PH7_OP_MEMBER ){` |
...
|   564385 | 13531 | `					iP1 = pInstr->iP1;` |
|   564385 | 13532 | `					iP2 = pInstr->iP2;` |
|   564385 | 13533 | `					if( pInstr->p3 ){` |
|       47 | 13534 | `						p3 = pInstr->p3; /* Transfer VmCallArgMap to NEW */` |
|       21 | 13535 | `					}` |
|   564385 | 13536 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|   282190 | 13537 | `				}` |
|   282195 | 13538 | `			}` |
| 15354354 | 13539 | `		}else if( iVmOp == PH7_OP_IS_A ){` |
...
|    38991 | 13542 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|    38991 | 13543 | `			if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|    38991 | 13544 | `				ph7_value *pLitChk = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,(sxu32)pInstr->iP2);` |
|    38991 | 13545 | `				int bAbsolute = (pInstr->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|    38991 | 13546 | `				int isSpecialIs = 0;` |
|    38991 | 13547 | `				if( pLitChk && (pLitChk->iFlags & MEMOBJ_STRING) ){` |
|    38991 | 13548 | `					const char *z = (const char *)SyBlobData(&pLitChk->sBlob);` |
|    38991 | 13549 | `					sxu32 n = (sxu32)SyBlobLength(&pLitChk->sBlob);` |
|    38986 | 13550 | `					if( (n == 4 && SyMemcmp(z,"self",4) == 0) \|\|` |
|    38989 | 13551 | `						(n == 6 && SyMemcmp(z,"static",6) == 0) \|\|` |
|    19493 | 13552 | `						(n == 6 && SyMemcmp(z,"parent",6) == 0) ){` |
|       12 | 13553 | `						isSpecialIs = 1;` |
|        5 | 13554 | `					}` |
|    19493 | 13555 | `				}` |
|    38991 | 13556 | `				pInstr->iP1 = 0;` |
|    38991 | 13557 | `				if( !isSpecialIs && !bAbsolute ){` |
|    38971 | 13558 | `					pInstr->iP2 = (sxi32)GenStateNsQualifyName(pGen,(sxu32)pInstr->iP2,&pGen->hUseImports,0);` |
|    19483 | 13559 | `				}` |
|    19498 | 13560 | `			}` |
| 15052546 | 13561 | `		}else if( iVmOp == PH7_OP_MEMBER){` |
...
|  2839763 | 13565 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|  2839763 | 13566 | `			if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|  2820311 | 13567 | `				pInstr->iP1 = 0;` |
|  1410153 | 13568 | `			}` |
|  2839763 | 13569 | `			if( pNode->pOp->iOp == EXPR_OP_DC /* '::' */){` |
|        - | 13570 | `				/* Static member access,remember that */` |
|    82123 | 13571 | `				iP1 = 1;` |
|    82123 | 13572 | `				pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|    82123 | 13573 | `				if( pInstr && pInstr->iOp == PH7_OP_LOAD ){` |
...
|  2839763 | 13582 | `			if( iP2 == PH7_MEMBER_READ ){` |
|  2839763 | 13583 | `				if( iFlags & EXPR_FLAG_LOAD_IDX_UNSET ){` |
|       40 | 13584 | `					iP2 = PH7_MEMBER_UNSET;` |
|  2839744 | 13585 | `				}else if( iFlags & EXPR_FLAG_LOAD_IDX_ISSET ){` |
|       99 | 13586 | `					iP2 = PH7_MEMBER_ISSET;` |
|  2839678 | 13587 | `				}else if( iFlags & EXPR_FLAG_LOAD_IDX_EMPTY ){` |
|       17 | 13588 | `					iP2 = PH7_MEMBER_EMPTY;` |
|  2839623 | 13589 | `				}else if( iFlags & EXPR_FLAG_MEMBER_WRITE ){` |
|        - | 13590 | `					/* Write-lvalue base ($o->arr[$k]=v, $o->p ??= v): auto-create a missing prop. */` |
|   555139 | 13591 | `					iP2 = PH7_MEMBER_WRITE;` |
|   277567 | 13592 | `				}` |
|  1419879 | 13593 | `			}` |
|  1419879 | 13594 | `		}` |
...
| 15734051 | 13622 | `		if( iVmOp == PH7_OP_CALL \|\| iVmOp == PH7_OP_NEW ){` |
|  4375667 | 13623 | `			p3 = GenStateAttachStrictFlag(pGen,p3);` |
|  2187831 | 13624 | `		}` |
|        - | 13625 | `		/* Finally,emit the VM instruction associated with this operator */` |
| 15734051 | 13626 | `		PH7_VmEmitInstr(pGen->pVm,iVmOp,iP1,iP2,p3,0);` |
|  7867023 | 13627 | `	}` |
| 15761469 | 13628 | `	if( nJmpIdx > 0 ){` |
|        - | 13629 | `		/* Fix short-circuited jumps now the destination is resolved */` |
|   341939 | 13630 | `		pInstr = PH7_VmGetInstr(pGen->pVm,nJmpIdx);` |
|   341939 | 13631 | `		if( pInstr ){` |
|   341939 | 13632 | `			pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|   170967 | 13633 | `		}` |
|   170967 | 13634 | `	}` |
| 15761469 | 13635 | `	return rc;` |
| 20073930 | 13636 | `}` |
|        - | 13637 | `/*` |
...
|        - | 13646 | ` * message.` |
|        - | 13647 | ` */` |
|  8854654 | 13648 | `static sxi32 PH7_CompileExpr(` |
...
|  8854659 | 13662 | `	nExpr = 0;` |
|  8854659 | 13663 | `	pRoot = 0;` |
...
|  8854659 | 13666 | `	nNullsafeBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  8854659 | 13667 | `	SySetInit(&sExprNode,&pGen->pVm->sAllocator,sizeof(ph7_expr_node *));` |
|  8854659 | 13668 | `	SySetAlloc(&sExprNode,0x10);` |
|  8854659 | 13669 | `	rc = SXRET_OK;` |
|        - | 13670 | `	/* Delimit the expression */` |
|  8854659 | 13671 | `	pEnd = pGen->pIn;` |
|  8854659 | 13672 | `	iNest = 0;` |
| 70380855 | 13673 | `	while( pEnd < pGen->pEnd ){` |
| 67209157 | 13674 | `		if( pEnd->nType & PH7_TK_OCB /* '{' */ ){` |
|        - | 13675 | `			/* Ticket 1433-30: Annonymous/Closure functions body */` |
|      719 | 13676 | `			iNest++;` |
| 67208800 | 13677 | `		}else if(pEnd->nType & PH7_TK_CCB /* '}' */ ){` |
|      727 | 13678 | `			iNest--;` |
| 67208082 | 13679 | `		}else if( pEnd->nType & PH7_TK_SEMI /* ';' */ ){` |
|  5683575 | 13680 | `			if( iNest <= 0 ){` |
|  5682961 | 13681 | `				break;` |
|        - | 13682 | `			}` |
|      307 | 13683 | `		}` |
| 61526201 | 13684 | `		pEnd++;` |
|        5 | 13685 | `	}` |
|  8854659 | 13686 | `	if( iFlags & EXPR_FLAG_COMMA_STATEMENT ){` |
|   400229 | 13687 | `		SyToken *pEnd2 = pGen->pIn;` |
|   400229 | 13688 | `		iNest = 0;` |
|        - | 13689 | `		/* Stop at the first comma */` |
|   878699 | 13690 | `		while( pEnd2 < pEnd ){` |
|   478477 | 13691 | `			if( pEnd2->nType & (PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*'['*/\|PH7_TK_LPAREN/*'('*/) ){` |
|     7859 | 13692 | `				iNest++;` |
|   474550 | 13693 | `			}else if(pEnd2->nType & (PH7_TK_CCB/*'}'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_RPAREN/*')'*/)){` |
|     7859 | 13694 | `				iNest--;` |
|   466696 | 13695 | `			}else if( pEnd2->nType & PH7_TK_COMMA /*','*/ ){` |
|       63 | 13696 | `				if( iNest <= 0 ){` |
|        3 | 13697 | `					break;` |
|        - | 13698 | `				}` |
|       28 | 13699 | `			}` |
|   478475 | 13700 | `			pEnd2++;` |
|        5 | 13701 | `		}` |
|   400229 | 13702 | `		if( pEnd2 <pEnd ){` |
|        3 | 13703 | `			pEnd = pEnd2;` |
|        1 | 13704 | `		}` |
|   200112 | 13705 | `	}` |
|  8854659 | 13706 | `	if( pEnd > pGen->pIn ){` |
|  8854649 | 13707 | `		SyToken *pTmp = pGen->pEnd;` |
|        - | 13708 | `		/* Swap delimiter */` |
|  8854649 | 13709 | `		pGen->pEnd = pEnd;` |
|        - | 13710 | `		/* Try to get an expression tree */` |
|  8854649 | 13711 | `		rc = PH7_ExprMakeTree(&(*pGen),&sExprNode,&pRoot);` |
|  8854649 | 13712 | `		if( rc == SXRET_OK && pRoot ){` |
|  8854467 | 13713 | `			rc = SXRET_OK;` |
|  8854467 | 13714 | `			if( xTreeValidator ){` |
|        - | 13715 | `				/* Call the upper layer validator callback */` |
|   593723 | 13716 | `				rc = xTreeValidator(&(*pGen),pRoot);` |
|   296859 | 13717 | `			}` |
|  8854467 | 13718 | `			if( rc != SXERR_ABORT ){` |
|        - | 13719 | `				/* Generate code for the given tree */` |
|  8854467 | 13720 | `				rc = GenStateEmitExprCode(&(*pGen),pRoot,iFlags);` |
|        - | 13721 | `				/* Patch any unresolved nullsafe jumps emitted by this` |
|        - | 13722 | `				 * expression so they short-circuit to its end. */` |
|  8854467 | 13723 | `				GenStatePatchNullsafeJumps(pGen, nNullsafeBase);` |
|  4427231 | 13724 | `			}` |
|  8854467 | 13725 | `			nExpr = 1;` |
|  4427231 | 13726 | `		}` |
|        - | 13727 | `		/* Release the whole tree */` |
|  8854649 | 13728 | `		PH7_ExprFreeTree(&(*pGen),&sExprNode);` |
|        - | 13729 | `		/* Synchronize token stream */` |
|  8854649 | 13730 | `		pGen->pEnd = pTmp;` |
|  8854649 | 13731 | `		pGen->pIn  = pEnd;` |
|  8854649 | 13732 | `		if( rc == SXERR_ABORT ){` |
|       13 | 13733 | `			SySetRelease(&sExprNode);` |
|       13 | 13734 | `			return SXERR_ABORT;` |
|        - | 13735 | `		}` |
|  4427317 | 13736 | `	}` |
|  8854649 | 13737 | `	SySetRelease(&sExprNode);` |
|  8854649 | 13738 | `	return nExpr > 0 ? SXRET_OK : SXERR_EMPTY;` |
|  4427332 | 13739 | `}` |
|        - | 13740 | `/*` |
|        - | 13741 | ` * Return a pointer to the node construct handler associated` |
|        - | 13742 | ` * with a given node type [i.e: string,integer,float,...].` |
|        - | 13743 | ` */` |
|  5457778 | 13744 | `PH7_PRIVATE ProcNodeConstruct PH7_GetNodeHandler(sxu32 nNodeType)` |
|        5 | 13745 | `{` |
|  5457783 | 13746 | `	if( nNodeType & PH7_TK_NUM ){` |
|        - | 13747 | `		/* Numeric literal: Either real or integer */` |
|  1794657 | 13748 | `		return PH7_CompileNumLiteral;` |
|  3663131 | 13749 | `	}else if( nNodeType & PH7_TK_DSTR ){` |
|        - | 13750 | `		/* Double quoted string */` |
|    45379 | 13751 | `		return PH7_CompileString;` |
|  3617757 | 13752 | `	}else if( nNodeType & PH7_TK_SSTR ){` |
|        - | 13753 | `		/* Single quoted string */` |
|  3617637 | 13754 | `		return PH7_CompileSimpleString;` |
...
|        - | 13771 | ` */` |
|     6940 | 13772 | `static sxi32 GenStateUnsetValidator(ph7_gen_state *pGen, ph7_expr_node *pNode)` |
|        5 | 13773 | `{` |
|        - | 13774 | `	sxi32 rc;` |
|     6945 | 13775 | `	if( !PH7_ExprContainsNullsafe(pNode) ){` |
|     6943 | 13776 | `		return SXRET_OK;` |
|        - | 13777 | `	}` |
...
|        - | 13789 | ` */` |
|     2940 | 13790 | `static sxi32 PH7_CompileUnset(ph7_gen_state *pGen)` |
|        5 | 13791 | `{` |
|     2945 | 13792 | `	SyToken *pTmp,*pEnd,*pNext = 0;` |
|     2945 | 13793 | `	sxu32 nIdx = 0;` |
|        - | 13794 | `	SyString sName;` |
|        - | 13795 | `	sxi32 rc;` |
|        - | 13796 | `	/* Jump the 'unset' keyword */` |
|     2945 | 13797 | `	pGen->pIn++;` |
|        - | 13798 | `	/* Save delimiter */` |
|     2945 | 13799 | `	pTmp = pGen->pEnd;` |
|        - | 13800 | `	/* Skip optional opening parenthesis and find the matching close */` |
|     2945 | 13801 | `	pEnd = pTmp; /* Default: scan to statement end */` |
|     2945 | 13802 | `	if( pGen->pIn < pTmp && (pGen->pIn->nType & PH7_TK_LPAREN) ){` |
|        - | 13803 | `		/* Find matching ')' — start scanning AFTER the '(' */` |
|        - | 13804 | `		SyToken *pClose;` |
|     2945 | 13805 | `		pGen->pIn++;   /* Skip '(' */` |
|     2945 | 13806 | `		PH7_DelimitNestedTokens(pGen->pIn,pTmp,PH7_TK_LPAREN,PH7_TK_RPAREN,&pClose);` |
|     2945 | 13807 | `		pEnd = pClose; /* Stop at ')' */` |
|     1470 | 13808 | `	}` |
|     2945 | 13809 | `	SyStringInitFromBuf(&sName,"unset",sizeof("unset")-1);` |
|        - | 13810 | `	/* Resolve the 'unset' builtin name once */` |
|     2945 | 13811 | `	if( SXRET_OK != GenStateFindLiteral(&(*pGen),&sName,&nIdx) ){` |
...
|     9887 | 13820 | `	while( SXRET_OK == PH7_GetNextExpr(pGen->pIn,pEnd,&pNext) ){` |
|     6947 | 13821 | `		if( pGen->pIn < pNext ){` |
|     6947 | 13822 | `			pGen->pEnd = pNext;` |
|     6947 | 13823 | `			rc = PH7_CompileExpr(&(*pGen),` |
|        - | 13824 | `				EXPR_FLAG_RDONLY_LOAD\|EXPR_FLAG_LOAD_IDX_UNSET,` |
|        - | 13825 | `				GenStateUnsetValidator);` |
|     6947 | 13826 | `			if( rc == SXERR_ABORT ){` |
|      ! 0 | 13827 | `				return SXERR_ABORT;` |
|        - | 13828 | `			}` |
|     6947 | 13829 | `			if( rc != SXERR_EMPTY ){` |
|        - | 13830 | `				/* Emit call for this single argument */` |
|     6945 | 13831 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|     6945 | 13832 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_CALL,1,0,GenStateAttachStrictFlag(pGen,0),0);` |
|     6945 | 13833 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|     3470 | 13834 | `			}` |
|     3471 | 13835 | `		}` |
|        - | 13836 | `		/* Jump trailing commas */` |
|    10951 | 13837 | `		while( pNext < pEnd && (pNext->nType & PH7_TK_COMMA) ){` |
|     4009 | 13838 | `			pNext++;` |
|        5 | 13839 | `		}` |
|     6947 | 13840 | `		pGen->pIn = pNext;` |
|        5 | 13841 | `	}` |
|        - | 13842 | `	/* Skip past the closing ')' if present */` |
|     2945 | 13843 | `	if( pGen->pIn < pTmp && (pGen->pIn->nType & PH7_TK_RPAREN) ){` |
|     2945 | 13844 | `		pGen->pIn++;` |
|     1470 | 13845 | `	}` |
|        - | 13846 | `	/* Restore token stream */` |
|     2945 | 13847 | `	pGen->pEnd = pTmp;` |
|     2945 | 13848 | `	return SXRET_OK;` |
|     1475 | 13849 | `}` |
|        - | 13850 | `/*` |
...
|        - | 13882 | ` */` |
|  4447258 | 13883 | `static ProcLangConstruct GenStateGetStatementHandler(` |
|        - | 13884 | `	sxu32 nKeywordID,   /* Keyword  ID*/` |
|        - | 13885 | `	SyToken *pLookahed  /* Look-ahead token */` |
|        - | 13886 | `	)` |
|        5 | 13887 | `{` |
|  4447263 | 13888 | `	sxu32 n = 0;` |
| 18349266 | 13889 | `	for(;;){` |
| 36698537 | 13890 | `		if( n >= SX_ARRAYSIZE(aLangConstruct) ){` |
|   300737 | 13891 | `			break;` |
|        - | 13892 | `		}` |
| 36397805 | 13893 | `		if( aLangConstruct[n].nID == nKeywordID ){` |
|  4146531 | 13894 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed && (pLookahed->nType & PH7_TK_OP)){` |
...
|        - | 13899 | `				}` |
|      ! 0 | 13900 | `			}` |
|  4146526 | 13901 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed` |
...
|        - | 13908 | `			*/` |
|  4146529 | 13909 | `			return aLangConstruct[n].xConstruct;` |
|        - | 13910 | `		}` |
| 32251279 | 13911 | `		n++;` |
|        5 | 13912 | `	}` |
|   300737 | 13913 | `	if( pLookahed ){` |
|   300737 | 13914 | `		if(nKeywordID == PH7_TKWRD_INTERFACE && (pLookahed->nType & PH7_TK_ID) ){` |
|    50497 | 13915 | `			return PH7_CompileClassInterface;` |
|   250245 | 13916 | `		}else if(nKeywordID == PH7_TKWRD_CLASS && (pLookahed->nType & PH7_TK_ID) ){` |
|   226429 | 13917 | `			return PH7_CompileClass;` |
|    23821 | 13918 | `		}else if(nKeywordID == PH7_TKWRD_TRAIT && (pLookahed->nType & PH7_TK_ID) ){` |
|     3957 | 13919 | `			return PH7_CompileTrait;` |
|        - | 13920 | `		}` |
...
|    19869 | 13927 | `	return 0;` |
|  2223634 | 13928 | `}` |
|        - | 13929 | `/*` |
|        - | 13930 | ` * Check if the given keyword is in fact a PHP language construct.` |
|        - | 13931 | ` * Return TRUE on success. FALSE otheriwse.` |
|        - | 13932 | ` */` |
|    19866 | 13933 | `static int GenStateisLangConstruct(sxu32 nKeyword)` |
|        5 | 13934 | `{` |
|        - | 13935 | `	int rc;` |
|    19871 | 13936 | `	rc = PH7_IsLangConstruct(nKeyword,TRUE);` |
|    19871 | 13937 | `	if( rc == FALSE ){` |
|    19752 | 13938 | `		if( nKeyword == PH7_TKWRD_SELF \|\| nKeyword == PH7_TKWRD_PARENT \|\| nKeyword == PH7_TKWRD_STATIC` |
...
|        - | 13963 | ` */` |
|  9687818 | 13964 | `static void GenStateSetPendingDoc(ph7_gen_state *pGen)` |
|        5 | 13965 | `{` |
|  9687823 | 13966 | `	SyToken *pBase = (SyToken *)SySetBasePtr(pGen->pTokenSet);` |
|  9687823 | 13967 | `	ph7_trivia *aT = (ph7_trivia *)SySetBasePtr(&pGen->aTrivia);` |
|  9687823 | 13968 | `	sxu32 nT = SySetUsed(&pGen->aTrivia);` |
|        - | 13969 | `	sxu32 nIdx, n;` |
|  9687818 | 13970 | `	if( nT < 1 \|\| pGen->pTokenSet == 0` |
...
|        - | 13995 | ` */` |
|  2615146 | 13996 | `static void GenStateConsumeDoc(ph7_gen_state *pGen,SyString *pOut)` |
|        5 | 13997 | `{` |
|        - | 13998 | `	char *zDup;` |
|  2615151 | 13999 | `	if( SyStringLength(&pGen->sPendingDoc) < 1 ){` |
|  2615131 | 14000 | `		return;` |
|        - | 14001 | `	}` |
...
|        - | 14175 | ` */` |
|  2615150 | 14176 | `static sxi32 GenStateConsumeAttrs(ph7_gen_state *pGen,SySet *pOut)` |
|        5 | 14177 | `{` |
|  2615155 | 14178 | `	ph7_trivia *aT = (ph7_trivia *)SySetBasePtr(&pGen->aPendingAttrs);` |
|        - | 14179 | `	sxu32 n;` |
|        - | 14180 | `	sxi32 rc;` |
|  2623047 | 14181 | `	for( n = 0 ; n < SySetUsed(&pGen->aPendingAttrs) ; n++ ){` |
|     7897 | 14182 | `		rc = GenStateCompileAttrSpan(&(*pGen),&aT[n],pOut);` |
|     7897 | 14183 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 | 14184 | `			return SXERR_ABORT;` |
|        - | 14185 | `		}` |
|     3951 | 14186 | `	}` |
|  2615155 | 14187 | `	SySetReset(&pGen->aPendingAttrs);` |
|  2615155 | 14188 | `	return SXRET_OK;` |
|  1307580 | 14189 | `}` |
|        - | 14190 | `/*` |
...
|        - | 14194 | ` */` |
|  1154764 | 14195 | `static sxi32 GenStateCollectParamAttrs(ph7_gen_state *pGen,SyToken *pTok,SySet *pOut)` |
|        5 | 14196 | `{` |
|  1154769 | 14197 | `	SyToken *pBase = (SyToken *)SySetBasePtr(pGen->pTokenSet);` |
|  1154769 | 14198 | `	ph7_trivia *aT = (ph7_trivia *)SySetBasePtr(&pGen->aTrivia);` |
|  1154769 | 14199 | `	sxu32 nT = SySetUsed(&pGen->aTrivia);` |
|        - | 14200 | `	sxu32 nIdx, n;` |
|        - | 14201 | `	sxi32 rc;` |
|  1154764 | 14202 | `	if( nT < 1 \|\| pGen->pTokenSet == 0` |
|   194135 | 14203 | `	 \|\| pTok < pBase \|\| pTok >= &pBase[SySetUsed(pGen->pTokenSet)] ){` |
|   960639 | 14204 | `		return SXRET_OK;` |
|        - | 14205 | `	}` |
...
|   577387 | 14216 | `}` |
|  7097426 | 14217 | `static sxi32 GenStateCompileChunk(` |
...
|        - | 14223 | `	sxi32 rc;` |
|  7097431 | 14224 | `	rc = SXRET_OK; /* Prevent compiler warning */` |
|  4096559 | 14225 | `	for(;;){` |
|  7645277 | 14226 | `		int bStmtIsDeclare = 0;` |
|  7645277 | 14227 | `		if( pGen->pIn >= pGen->pEnd ){` |
|        - | 14228 | `			/* No more input to process */` |
|    57153 | 14229 | `			break;` |
|        - | 14230 | `		}` |
|        - | 14231 | `		/* Bind a directly-preceding docblock to this statement */` |
|  7588129 | 14232 | `		GenStateSetPendingDoc(&(*pGen));` |
|  7588129 | 14233 | `		if( SySetUsed(&pGen->aPendingAttrs) > 0 ){` |
...
|  7588129 | 14265 | `		if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|  4474445 | 14266 | `			sxu32 nPeek = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  4474445 | 14267 | `			if( nPeek == PH7_TKWRD_DECLARE ){` |
|       47 | 14268 | `				bStmtIsDeclare = 1;` |
|       21 | 14269 | `			}` |
|  2237220 | 14270 | `		}` |
|  7588129 | 14271 | `		if( !bStmtIsDeclare && pGen->pCurrent == &pGen->sGlobal ){` |
...
|   547819 | 14274 | `			pGen->bStrictTypesLocked = 1;` |
|   273907 | 14275 | `		}` |
|  7588129 | 14276 | `		if( pGen->pIn->nType & PH7_TK_OCB /* '{' */ ){` |
|        - | 14277 | `			/* Compile block */` |
...
|        - | 14281 | `			}` |
|     1952 | 14282 | `		}else{` |
|  7584235 | 14283 | `			xCons = 0;` |
|  7584235 | 14284 | `			if( GenStateStartsModifiedClass(pGen->pIn,pGen->pEnd) ){` |
...
|    27213 | 14288 | `				xCons = PH7_CompileClassModifiers;` |
|  7570631 | 14289 | `			}else if( GenStateStartsEnumDecl(pGen->pIn,pGen->pEnd) ){` |
...
|  7555075 | 14293 | `			}else if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|  4447263 | 14294 | `				sxu32 nKeyword = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|        - | 14295 | `				/* Try to extract a language construct handler */` |
|  4447263 | 14296 | `				xCons = GenStateGetStatementHandler(nKeyword,(&pGen->pIn[1] < pGen->pEnd) ? &pGen->pIn[1] : 0);` |
|  4447263 | 14297 | `				if( xCons == 0 && GenStateisLangConstruct(nKeyword) == FALSE ){` |
...
|        4 | 14308 | `				}` |
|  5329494 | 14309 | `			}else if( (pGen->pIn->nType & PH7_TK_ID) && (&pGen->pIn[1] < pGen->pEnd)` |
|    78083 | 14310 | `				&& (pGen->pIn[1].nType & PH7_TK_COLON /*':'*/) ){` |
|        - | 14311 | `				/* Label found [i.e: Out: ],point to the routine responsible of compiling it */` |
|      117 | 14312 | `				xCons = PH7_CompileLabel;` |
|       56 | 14313 | `			}` |
|  7584235 | 14314 | `			if( xCons == 0 ){` |
|        - | 14315 | `				/* Assume an expression an try to compile it */` |
|  3125611 | 14316 | `				rc = PH7_CompileExpr(&(*pGen),0,0);` |
|  3125611 | 14317 | `				if(  rc != SXERR_EMPTY ){` |
|        - | 14318 | `					/* Pop l-value */` |
|  3125461 | 14319 | `					PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|  1562728 | 14320 | `				}` |
|  1562808 | 14321 | `			}else{` |
|        - | 14322 | `				/* Go compile the sucker */` |
|  4458629 | 14323 | `				rc = xCons(&(*pGen));` |
|        - | 14324 | `			}` |
|  7584235 | 14325 | `			if( rc == SXERR_ABORT ){` |
|        - | 14326 | `				/* Request to abort compilation */` |
|       13 | 14327 | `				break;` |
|        - | 14328 | `			}` |
|        - | 14329 | `		}` |
|        - | 14330 | `		/* Ignore trailing semi-colons ';' */` |
| 13074583 | 14331 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|  5486469 | 14332 | `			pGen->pIn++;` |
|        5 | 14333 | `		}` |
|  7588119 | 14334 | `		if( iFlags & PH7_COMPILE_SINGLE_STMT ){` |
...
|        - | 14350 | ` */` |
|    57160 | 14351 | `static sxi32 PH7_CompilePHP(` |
...
|        - | 14355 | `	)` |
|        5 | 14356 | `{` |
|    57165 | 14357 | `	SyToken *pScript = pGen->pRawIn; /* Script to compile */` |
|        - | 14358 | `	sxi32 rc;` |
|        - | 14359 | `	/* Reset the token set (and its trivia sidecar) */` |
|    57165 | 14360 | `	SySetReset(&(*pTokenSet));` |
|    57165 | 14361 | `	SySetReset(&pGen->aTrivia);` |
|        - | 14362 | `	/* Mark as the default token set */` |
|    57165 | 14363 | `	pGen->pTokenSet = &(*pTokenSet);` |
|        - | 14364 | `	/* Advance the stream cursor */` |
|    57165 | 14365 | `	pGen->pRawIn++;` |
|        - | 14366 | `	/* Tokenize the PHP chunk first */` |
|    57165 | 14367 | `	PH7_TokenizePHP(SyStringData(&pScript->sData),SyStringLength(&pScript->sData),pScript->nLine,&(*pTokenSet),&pGen->aTrivia);` |
|        - | 14368 | `	/* Point to the head and tail of the token stream. */` |
|    57165 | 14369 | `	pGen->pIn  = (SyToken *)SySetBasePtr(pTokenSet);` |
|    57165 | 14370 | `	pGen->pEnd = &pGen->pIn[SySetUsed(pTokenSet)];` |
|    57165 | 14371 | `	if( is_expr ){` |
...
|        - | 14380 | `	}` |
|    57165 | 14381 | `	if( pGen->pIn < pGen->pEnd && ( pGen->pIn->nType & PH7_TK_EQUAL ) ){` |
...
|    57163 | 14406 | `	rc = GenStateCompileChunk(pGen,0);` |
|        - | 14407 | `	/* Fix exceptions jumps */` |
|    57163 | 14408 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|        - | 14409 | `	/* Fix gotos now, the jump destination is resolved */` |
|    57163 | 14410 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),0) ){` |
|        3 | 14411 | `		rc = SXERR_ABORT;` |
|        1 | 14412 | `	}` |
|        - | 14413 | `	/* Reset container */` |
|    57163 | 14414 | `	SySetReset(&pGen->aGoto);` |
|    57163 | 14415 | `	SySetReset(&pGen->aLabel);` |
|    57163 | 14416 | `	SySetReset(&pGen->aNullsafeJmp);` |
|        - | 14417 | `	/* Compilation result */` |
|    57163 | 14418 | `	return rc;` |
|    28585 | 14419 | `}` |
|        - | 14420 | `/*` |
...
|        - | 14424 | ` */` |
|    60218 | 14425 | `PH7_PRIVATE sxi32 PH7_CompileScript(` |
...
|        - | 14439 | `	sxi32 rc;` |
|    60223 | 14440 | `	if( pScript->nByte < 1 ){` |
...
|    60223 | 14446 | `	pCodeGen = &pVm->sCodeGen;` |
|    60223 | 14447 | `	bSavedStrict = pCodeGen->bStrictTypes;` |
|    60223 | 14448 | `	bSavedStrictLocked = pCodeGen->bStrictTypesLocked;` |
|    60223 | 14449 | `	pCodeGen->bStrictTypes = 0;` |
|    60223 | 14450 | `	pCodeGen->bStrictTypesLocked = 0;` |
|        - | 14451 | `	/* Initialize the tokens containers */` |
|    60223 | 14452 | `	SySetInit(&aRawToken,&pVm->sAllocator,sizeof(SyToken));` |
|    60223 | 14453 | `	SySetInit(&aPhpToken,&pVm->sAllocator,sizeof(SyToken));` |
|    60223 | 14454 | `	SySetAlloc(&aPhpToken,0xc0);` |
|    60223 | 14455 | `	is_expr = 0;` |
|    60223 | 14456 | `	if( iFlags & PH7_PHP_ONLY ){` |
|        - | 14457 | `		SyToken sTmp;` |
|        - | 14458 | `		/* PHP only: -*/` |
|    46619 | 14459 | `		sTmp.nLine = 1;` |
|    46619 | 14460 | `		sTmp.nType = PH7_TOKEN_PHP;` |
|    46619 | 14461 | `		sTmp.pUserData = 0;` |
|    46619 | 14462 | `		SyStringDupPtr(&sTmp.sData,pScript);` |
|    46619 | 14463 | `		SySetPut(&aRawToken,(const void *)&sTmp);` |
|    46619 | 14464 | `		if( iFlags & PH7_PHP_EXPR ){` |
|        - | 14465 | `			/* A simple PHP expression */` |
|      ! 0 | 14466 | `			is_expr = 1;` |
|      ! 0 | 14467 | `		}` |
|    23312 | 14468 | `	}else{` |
|        - | 14469 | `		/* Tokenize raw text */` |
|    13609 | 14470 | `		SySetAlloc(&aRawToken,32);` |
|    13609 | 14471 | `		PH7_TokenizeRawText(pScript->zString,pScript->nByte,&aRawToken);` |
|        - | 14472 | `	}` |
|        - | 14473 | `	/* Process high-level tokens */` |
|    60223 | 14474 | `	pCodeGen->pRawIn = (SyToken *)SySetBasePtr(&aRawToken);` |
|    60223 | 14475 | `	pCodeGen->pRawEnd = &pCodeGen->pRawIn[SySetUsed(&aRawToken)];` |
|    60223 | 14476 | `	rc = PH7_OK;` |
|    60223 | 14477 | `	if( is_expr ){` |
|        - | 14478 | `		/* Compile the expression */` |
|      ! 0 | 14479 | `		rc = PH7_CompilePHP(pCodeGen,&aPhpToken,TRUE);` |
|      ! 0 | 14480 | `		goto cleanup;` |
|        - | 14481 | `	}` |
|    60223 | 14482 | `	nObjIdx = 0;` |
...
|    60223 | 14486 | `	PH7_VmEmitInstr(pVm,PH7_OP_NSSWITCH,0,0,0,0);` |
|        - | 14487 | `	/* Start the compilation process */` |
|    36916 | 14488 | `	for(;;){` |
|   130985 | 14489 | `		if( pCodeGen->pRawIn >= pCodeGen->pRawEnd ){` |
|    60211 | 14490 | `			break; /* No more tokens to process */` |
|        - | 14491 | `		}` |
|    70779 | 14492 | `		if( pCodeGen->pRawIn->nType & PH7_TOKEN_PHP ){` |
|        - | 14493 | `			/* Compile the PHP chunk */` |
|    57165 | 14494 | `			rc = PH7_CompilePHP(pCodeGen,&aPhpToken,FALSE);` |
|    57165 | 14495 | `			if( rc == SXERR_ABORT ){` |
|       16 | 14496 | `				break;` |
|        - | 14497 | `			}` |
|    57153 | 14498 | `			continue;` |
|        - | 14499 | `		}` |
|        - | 14500 | `		/* Raw chunk: [i.e: HTML, XML, etc.] */` |
|    13619 | 14501 | `		nRawObj = 0;` |
|    27233 | 14502 | `		while( (pCodeGen->pRawIn < pCodeGen->pRawEnd) && (pCodeGen->pRawIn->nType != PH7_TOKEN_PHP) ){` |
|        - | 14503 | `			/* Consume the raw chunk without any processing */` |
|    13619 | 14504 | `			pRawObj = PH7_ReserveConstObj(&(*pVm),&nObjIdx);` |
|    13619 | 14505 | `			if( pRawObj == 0 ){` |
|      ! 0 | 14506 | `				rc = SXERR_MEM;` |
|      ! 0 | 14507 | `				break;` |
|        - | 14508 | `			}` |
|        - | 14509 | `			/* Mark as constant and emit the load constant instruction */` |
|    13619 | 14510 | `			PH7_MemObjInitFromString(pVm,pRawObj,&pCodeGen->pRawIn->sData);` |
|    13619 | 14511 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_LOADC,0,nObjIdx,0,0);` |
|    13619 | 14512 | `			++nRawObj;` |
|    13619 | 14513 | `			pCodeGen->pRawIn++; /* Next chunk */` |
|        5 | 14514 | `		}` |
|    13619 | 14515 | `		if( nRawObj > 0 ){` |
|        - | 14516 | `			/* Emit the consume instruction */` |
|    13619 | 14517 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_CONSUME,nRawObj,0,0,0);` |
|     6807 | 14518 | `		}` |
|    30114 | 14519 | `	}` |
|    30109 | 14520 | `cleanup:` |
|    60223 | 14521 | `	SySetRelease(&aRawToken);` |
|    60223 | 14522 | `	SySetRelease(&aPhpToken);` |
|        - | 14523 | `	/* Restore outer file's strict_types scope */` |
|    60223 | 14524 | `	pCodeGen->bStrictTypes = bSavedStrict;` |
|    60223 | 14525 | `	pCodeGen->bStrictTypesLocked = bSavedStrictLocked;` |
|    60223 | 14526 | `	return rc;` |
|    30114 | 14527 | `}` |
|        - | 14528 | `/*` |
...
|        - | 14568 | ` */` |
|    63706 | 14569 | `PH7_PRIVATE sxi32 PH7_ResetCodeGenerator(` |
|        - | 14570 | `	ph7_vm *pVm,       /* Target VM */` |
|        - | 14571 | `	ProcConsumer xErr, /* Error log consumer callabck  */` |
|        - | 14572 | `	void *pErrData     /* Last argument to xErr() */` |
|        - | 14573 | `	)` |
|        5 | 14574 | `{` |
|    63711 | 14575 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|        - | 14576 | `	GenBlock *pBlock,*pParent;` |
|        - | 14577 | `	/* Reset state */` |
|    63711 | 14578 | `	SySetReset(&pGen->aLabel);` |
|    63711 | 14579 | `	SySetReset(&pGen->aGoto);` |
|    63711 | 14580 | `	SySetReset(&pGen->aNullsafeJmp);` |
|    63711 | 14581 | `	SySetReset(&pGen->aTrivia);` |
|    63711 | 14582 | `	SySetReset(&pGen->aPendingAttrs);` |
|    63711 | 14583 | `	SyStringInitFromBuf(&pGen->sPendingDoc,0,0);` |
|    63711 | 14584 | `	SyBlobRelease(&pGen->sErrBuf);` |
|    63711 | 14585 | `	SyBlobRelease(&pGen->sWorker);` |
|    63711 | 14586 | `	SyBlobRelease(&pGen->sNamespace);` |
|    63711 | 14587 | `	SyBlobInit(&pGen->sNamespace,&pVm->sAllocator);` |
|    63711 | 14588 | `	SyHashRelease(&pGen->hUseImports);` |
|    63711 | 14589 | `	SyHashInit(&pGen->hUseImports,&pVm->sAllocator,0,0);` |
|    63711 | 14590 | `	SyHashRelease(&pGen->hUseFuncImports);` |
|    63711 | 14591 | `	SyHashInit(&pGen->hUseFuncImports,&pVm->sAllocator,0,0);` |
|    63711 | 14592 | `	SyHashRelease(&pGen->hUseConstImports);` |
|    63711 | 14593 | `	SyHashInit(&pGen->hUseConstImports,&pVm->sAllocator,0,0);` |
...
|    63711 | 14601 | `	pBlock = pGen->pCurrent;` |
|    63711 | 14602 | `	while( pBlock->pParent != 0 ){` |
|      ! 0 | 14603 | `		pParent = pBlock->pParent;` |
|      ! 0 | 14604 | `		GenStateFreeBlock(pBlock);` |
|      ! 0 | 14605 | `		pBlock = pParent;` |
|      ! 0 | 14606 | `	}` |
|    63711 | 14607 | `	pGen->xErr = xErr;` |
|    63711 | 14608 | `	pGen->pErrData = pErrData;` |
|    63711 | 14609 | `	pGen->pCurrent = &pGen->sGlobal;` |
|    63711 | 14610 | `	pGen->pRawIn = pGen->pRawEnd = 0;` |
|    63711 | 14611 | `	pGen->pIn = pGen->pEnd = 0;` |
|    63711 | 14612 | `	pGen->nErr = 0;` |
|    63711 | 14613 | `	return SXRET_OK;` |
|        5 | 14614 | `}` |
|        - | 14615 | `/*` |
