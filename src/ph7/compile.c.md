...
|       - |   130 | ` */` |
|    3582 |   131 | `static GenBlock * GenStateFetchBlock(GenBlock *pCurrent,sxi32 iBlockType,sxi32 iCount)` |
|       5 |   132 |  |
|    3587 |   133 | `	GenBlock *pBlock = pCurrent;` |
|   10163 |   134 | `	for(;;){` |
|   20331 |   135 | `		if( pBlock->iFlags & iBlockType ){` |
|    3479 |   136 | `			iCount--; /* Decrement nesting level */` |
|    3479 |   137 | `			if( iCount < 1 ){` |
|       - |   138 | `				/* Block meet with the desired criteria */` |
|    3453 |   139 | `				return pBlock;` |
|       - |   140 | `			}` |
|      13 |   141 | `		}` |
|       - |   142 | `		/* Point to the upper block */` |
|   16883 |   143 | `		pBlock = pBlock->pParent;` |
|   16883 |   144 | `		if( pBlock == 0 \|\| (pBlock->iFlags & (GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC)) ){` |
|       - |   145 | `			/* Forbidden */` |
|      72 |   146 | `			break;` |
|       - |   147 | `		}` |
|       5 |   148 | `	}` |
...
|       - |   154 | ` */` |
|  779758 |   155 | `static void GenStateInitBlock(` |
...
|  779763 |   164 | `	pBlock->nFirstInstr = nFirstInstr;` |
|  779763 |   165 | `	pBlock->pUserData   = pUserData;` |
|  779763 |   166 | `	pBlock->pGen        = pGen;` |
|  779763 |   167 | `	pBlock->iFlags      = iType;` |
|  779763 |   168 | `	pBlock->pParent     = 0;` |
|  779763 |   169 | `	SySetInit(&pBlock->aJumpFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  779763 |   170 | `	SySetInit(&pBlock->aPostContFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  779763 |   171 |  |
|       - |   172 | `/*` |
...
|       - |   177 | ` */` |
|  776454 |   178 | `static sxi32 GenStateEnterBlock(` |
...
|  776459 |   188 | `	pBlock = (GenBlock *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(GenBlock));` |
|  776459 |   189 | `	if( pBlock == 0 ){` |
...
|  776459 |   198 | `	SyZero(pBlock,sizeof(GenBlock));` |
|  776459 |   199 | `	GenStateInitBlock(&(*pGen),pBlock,iType,nFirstInstr,pUserData);` |
|       - |   200 | `	/* Link to the parent block */` |
|  776459 |   201 | `	pBlock->pParent = pGen->pCurrent;` |
|       - |   202 | `	/* Mark as the current block */` |
|  776459 |   203 | `	pGen->pCurrent = pBlock;` |
|  776459 |   204 | `	if( ppBlock ){` |
|       - |   205 | `		/* Write a pointer to the new instance */` |
|  377115 |   206 | `		*ppBlock = pBlock;` |
|  188555 |   207 | `	}` |
|  776459 |   208 | `	return SXRET_OK;` |
|  388232 |   209 |  |
|       - |   210 | `/*` |
|       - |   211 | ` * Release block fields without freeing the whole instance.` |
|       - |   212 | ` */` |
|  776446 |   213 | `static void GenStateReleaseBlock(GenBlock *pBlock)` |
|       5 |   214 |  |
|  776451 |   215 | `	SySetRelease(&pBlock->aPostContFix);` |
|  776451 |   216 | `	SySetRelease(&pBlock->aJumpFix);` |
|  776451 |   217 |  |
|       - |   218 | `/*` |
|       - |   219 | ` * Release a block.` |
|       - |   220 | ` */` |
|  776446 |   221 | `static void GenStateFreeBlock(GenBlock *pBlock)` |
|       5 |   222 |  |
|  776451 |   223 | `	ph7_gen_state *pGen = pBlock->pGen;` |
|  776451 |   224 | `	GenStateReleaseBlock(&(*pBlock));` |
|       - |   225 | `	/* Free the instance */` |
|  776451 |   226 | `	SyMemBackendPoolFree(&pGen->pVm->sAllocator,pBlock);` |
|  776451 |   227 |  |
|       - |   228 | `/*` |
|       - |   229 | ` * POP and release a block from the stack of compiled blocks.` |
|       - |   230 | ` */` |
|  776446 |   231 | `static sxi32 GenStateLeaveBlock(ph7_gen_state *pGen,GenBlock **ppBlock)` |
|       5 |   232 |  |
|  776451 |   233 | `	GenBlock *pBlock = pGen->pCurrent;` |
|  776451 |   234 | `	if( pBlock == 0 ){` |
|       - |   235 | `		/* No more block to pop */` |
|     ! 0 |   236 | `		return SXERR_EMPTY;` |
|       - |   237 | `	}` |
|       - |   238 | `	/* Point to the upper block */` |
|  776451 |   239 | `	pGen->pCurrent = pBlock->pParent;` |
|  776451 |   240 | `	if( ppBlock ){` |
|       - |   241 | `		/* Write a pointer to the popped block */` |
|     ! 0 |   242 | `		*ppBlock = pBlock;` |
|     ! 0 |   243 | `	}else{` |
|       - |   244 | `		/* Safely release the block */` |
|  776451 |   245 | `		GenStateFreeBlock(&(*pBlock));` |
|       - |   246 | `	}` |
|  776451 |   247 | `	return SXRET_OK;` |
|  388228 |   248 |  |
|       - |   249 | `/*` |
...
|       - |   258 | ` */` |
|  220386 |   259 | `static sxi32 GenStateNewJumpFixup(GenBlock *pBlock,sxi32 nJumpType,sxu32 nInstrIdx)` |
|       5 |   260 |  |
|       - |   261 | `	JumpFixup sJumpFix;` |
|       - |   262 | `	sxi32 rc;` |
|       - |   263 | `	/* Init the JumpFixup structure */` |
|  220391 |   264 | `	sJumpFix.nJumpType = nJumpType;` |
|  220391 |   265 | `	sJumpFix.nInstrIdx = nInstrIdx;` |
|       - |   266 | `	/* Insert in the jump fixup table */` |
|  220391 |   267 | `	rc = SySetPut(&pBlock->aJumpFix,(const void *)&sJumpFix);` |
|  220391 |   268 | `	return rc;` |
|       5 |   269 |  |
|       - |   270 | `/*` |
...
|       - |   280 | ` */` |
|  542668 |   281 | `static sxu32 GenStateFixJumps(GenBlock *pBlock,sxi32 nJumpType,sxu32 nJumpDest)` |
|       5 |   282 |  |
|       - |   283 | `	JumpFixup *aFix;` |
|       - |   284 | `	VmInstr *pInstr;` |
|       - |   285 | `	sxu32 nFixed;` |
...
|  542673 |   288 | `	aFix = (JumpFixup *)SySetBasePtr(&pBlock->aJumpFix);` |
|       - |   289 | `	/* Fix the desired jumps */` |
|  976729 |   290 | `	for( nFixed = n = 0 ; n < SySetUsed(&pBlock->aJumpFix) ; ++n ){` |
|  434061 |   291 | `		if( aFix[n].nJumpType < 0 ){` |
|       - |   292 | `			/* Already fixed */` |
|  173221 |   293 | `			continue;` |
|       - |   294 | `		}` |
|  260845 |   295 | `		if( nJumpType > 0 && aFix[n].nJumpType != nJumpType ){` |
|       - |   296 | `			/* Not of our interest */` |
|   40461 |   297 | `			continue;` |
|       - |   298 | `		}` |
|       - |   299 | `		/* Point to the instruction to fix */` |
|  220389 |   300 | `		pInstr = PH7_VmGetInstr(pBlock->pGen->pVm,aFix[n].nInstrIdx);` |
|  220389 |   301 | `		if( pInstr ){` |
|  220389 |   302 | `			pInstr->iP2 = nJumpDest;` |
|  220389 |   303 | `			nFixed++;` |
|       - |   304 | `			/* Mark as fixed */` |
|  220389 |   305 | `			aFix[n].nJumpType = -1;` |
|  110192 |   306 | `		}` |
|  110197 |   307 | `	}` |
|       - |   308 | `	/* Total number of fixed jumps */` |
|  542673 |   309 | `	return nFixed;` |
|       5 |   310 |  |
|       - |   311 | `/*` |
...
|       - |   317 | ` */` |
|  220428 |   318 | `static sxi32 GenStateFixGoto(ph7_gen_state *pGen,sxu32 nOfft)` |
|       5 |   319 |  |
...
|  220433 |   326 | `	aJumps = (JumpFixup *)SySetBasePtr(&pGen->aGoto);` |
|       - |   327 | `	/* Fix */` |
|  220579 |   328 | `	for( n = nOfft ; n < SySetUsed(&pGen->aGoto) ; ++n ){` |
...
|      12 |   342 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pJump->nLine,"Label '%z' is unreachable",&pJump->sLabel);` |
|      12 |   343 | `			if( rc == SXERR_ABORT ){` |
...
|      46 |   351 | `		}` |
|      51 |   352 | `	}` |
|  220431 |   353 | `	aLabel = (Label *)SySetBasePtr(&pGen->aLabel);` |
|  220563 |   354 | `	for( n = 0 ; n < SySetUsed(&pGen->aLabel) ; ++n ){` |
...
|      12 |   359 | `		}` |
|      71 |   360 | `	}` |
|  220431 |   361 | `	return SXRET_OK;` |
|  110219 |   362 |  |
|       - |   363 | `/*` |
|       - |   364 | ` * Check if a given token value is installed in the literal table.` |
|       - |   365 | ` */` |
|  697146 |   366 | `static sxi32 GenStateFindLiteral(ph7_gen_state *pGen,const SyString *pValue,sxu32 *pIdx)` |
|       5 |   367 |  |
|       - |   368 | `	SyHashEntry *pEntry;` |
|  697151 |   369 | `	pEntry = SyHashGet(&pGen->hLiteral,(const void *)pValue->zString,pValue->nByte);` |
|  697151 |   370 | `	if( pEntry == 0 ){` |
|  303223 |   371 | `		return SXERR_NOTFOUND;` |
|       - |   372 | `	}` |
|  393933 |   373 | `	*pIdx = (sxu32)SX_PTR_TO_INT(pEntry->pUserData);` |
|  393933 |   374 | `	return SXRET_OK;` |
|  348578 |   375 |  |
|       - |   376 | `/*` |
...
|       - |   385 | ` */` |
|  303218 |   386 | `static sxi32 GenStateInstallLiteral(ph7_gen_state *pGen,ph7_value *pObj,sxu32 nIdx)` |
|       5 |   387 |  |
|  303223 |   388 | `	if( SyBlobLength(&pObj->sBlob) > 0 ){` |
|  303223 |   389 | `		SyHashInsert(&pGen->hLiteral,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob),SX_INT_TO_PTR(nIdx));` |
|  151609 |   390 | `	}` |
|  303223 |   391 | `	return SXRET_OK;` |
|       5 |   392 |  |
|       - |   393 | `/*` |
|       - |   394 | ` * Reserve a room for a numeric constant [i.e: 64-bit integer or real number]` |
|       - |   395 | ` * in the constant table.` |
|       - |   396 | ` */` |
|  116054 |   397 | `static ph7_value * GenStateInstallNumLiteral(ph7_gen_state *pGen,sxu32 *pIdx)` |
|       5 |   398 |  |
|       - |   399 | `	ph7_value *pObj;` |
|  116059 |   400 | `	sxu32 nIdx = 0; /* cc warning */` |
|       - |   401 | `	/* Reserve a new constant */` |
|  116059 |   402 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  116059 |   403 | `	if( pObj == 0 ){` |
|     ! 0 |   404 | `		PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|     ! 0 |   405 | `		return 0;` |
|       - |   406 | `	}` |
|  116059 |   407 | `	*pIdx = nIdx;` |
|       - |   408 | `	/* TODO(chems): Create a numeric table (64bit int keys) same as` |
|       - |   409 | `	 * the constant string iterals table [optimization purposes].` |
|       - |   410 | `	 */` |
|  116059 |   411 | `	return pObj;` |
|   58032 |   412 |  |
|       - |   413 | `/*` |
...
|       - |   426 | ` */` |
|  416798 |   427 | `static void *GenStateAttachStrictFlag(ph7_gen_state *pGen, void *p3)` |
|       5 |   428 |  |
|       - |   429 | `	VmCallArgMap *pMap;` |
|  416803 |   430 | `	if( !pGen->bStrictTypes ) return p3;` |
|      33 |   431 | `	if( p3 == 0 ){` |
...
|       - |   497 | ` */` |
|  116646 |   498 | `static int GenStateFindBadNumericSeparator(` |
|       - |   499 | `	const SyString *pRaw, const char **pBadStart, sxu32 *pBadLen)` |
|       5 |   500 |  |
|  116651 |   501 | `	const char *z = pRaw->zString;` |
|  116651 |   502 | `	sxu32 n = pRaw->nByte;` |
|  116651 |   503 | `	int base = 10;` |
|       - |   504 | `	sxu32 i, start;` |
|  116651 |   505 | `	if( n < 2 ) return 0;` |
|    9747 |   506 | `	if( z[0] == '0' && (z[1] == 'x' \|\| z[1] == 'X') ){` |
|      72 |   507 | `		base = 16;` |
|    9712 |   508 | `	}else if( z[0] == '0' && (z[1] == 'b' \|\| z[1] == 'B') ){` |
|     280 |   509 | `		base = 2;` |
|     139 |   510 | `	}` |
|   35415 |   511 | `	for( i = 0; i < n; ++i ){` |
|   25687 |   512 | `		if( z[i] != '_' ) continue;` |
...
|       - |   538 | ` */` |
|  116646 |   539 | `static sxi32 GenStateValidateNumericSeparator(ph7_gen_state *pGen, SyToken *pToken)` |
|       5 |   540 |  |
|  116651 |   541 | `	const char *zBad = 0;` |
|  116651 |   542 | `	sxu32 nBad = 0;` |
|       - |   543 | `	SyString sBad;` |
|       - |   544 | `	sxi32 rc;` |
|  116651 |   545 | `	if( !GenStateFindBadNumericSeparator(&pToken->sData, &zBad, &nBad) ){` |
|  116637 |   546 | `		return SXRET_OK;` |
|       - |   547 | `	}` |
...
|       - |   571 | ` */` |
|  116632 |   572 | `static sxi32 GenStateStripNumericSeparators(` |
...
|       5 |   577 |  |
|       - |   578 | `	sxu32 i, j;` |
|  116637 |   579 | `	int hasUnderscore = 0;` |
|       - |   580 | `	char *zBuf;` |
|  116637 |   581 | `	*pzAlloc = 0;` |
|  247143 |   582 | `	for( i = 0; i < pToken->nByte; ++i ){` |
|  130763 |   583 | `		if( pToken->zString[i] == '_' ){ hasUnderscore = 1; break; }` |
|   65258 |   584 | `	}` |
|  116637 |   585 | `	if( !hasUnderscore ){` |
|  116385 |   586 | `		SyStringDupPtr(pOut, pToken);` |
|  116385 |   587 | `		return SXRET_OK;` |
|       - |   588 | `	}` |
...
|       - |   619 | ` *  documentation.` |
|       - |   620 | ` */` |
|  116618 |   621 | `static sxi32 PH7_CompileNumLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |   622 |  |
|  116623 |   623 | `	SyToken *pToken = pGen->pIn; /* Raw token */` |
|  116623 |   624 | `	sxu32 nIdx = 0;` |
|       - |   625 | `	char zScratch[GEN_NUM_SCRATCH];` |
|  116623 |   626 | `	char *zAlloc = 0;` |
|       - |   627 | `	SyString sNum;` |
|       - |   628 | `	sxi32 rc;` |
|   58309 |   629 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|  116623 |   630 | `	rc = GenStateValidateNumericSeparator(pGen, pToken);` |
|  116623 |   631 | `	if( rc != SXRET_OK ){` |
|      14 |   632 | `		return rc;` |
|       - |   633 | `	}` |
|  174917 |   634 | `	rc = GenStateStripNumericSeparators(&pGen->pVm->sAllocator, &pToken->sData,` |
|   58304 |   635 | `		zScratch, sizeof(zScratch), &sNum, &zAlloc);` |
|  116613 |   636 | `	if( rc != SXRET_OK ){` |
|     ! 0 |   637 | `		return SXERR_ABORT;` |
|       - |   638 | `	}` |
|  116613 |   639 | `	if( pToken->nType & PH7_TK_INTEGER ){` |
|       - |   640 | `		ph7_value *pObj;` |
|       - |   641 | `		sxi64 iValue;` |
|  116059 |   642 | `		iValue = PH7_TokenValueToInt64(&sNum);` |
|  116059 |   643 | `		pObj = GenStateInstallNumLiteral(&(*pGen),&nIdx);` |
|  116059 |   644 | `		if( pObj == 0 ){` |
|     ! 0 |   645 | `			if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|     ! 0 |   646 | `			return SXERR_ABORT;` |
|       - |   647 | `		}` |
|  116059 |   648 | `		PH7_MemObjInitFromInt(pGen->pVm,pObj,iValue);` |
|   58032 |   649 | `	}else{` |
|       - |   650 | `		/* Real number */` |
|       - |   651 | `		ph7_value *pObj;` |
|       - |   652 | `		/* Reserve a new constant */` |
|     558 |   653 | `		pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|     558 |   654 | `		if( pObj == 0 ){` |
...
|       - |   658 | `		}` |
|     558 |   659 | `		PH7_MemObjInitFromString(pGen->pVm,pObj,&sNum);` |
|     558 |   660 | `		PH7_MemObjToReal(pObj);` |
|       - |   661 | `	}` |
|  116613 |   662 | `	if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|       - |   663 | `	/* Emit the load constant instruction */` |
|  116613 |   664 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|       - |   665 | `	/* Node successfully compiled */` |
|  116613 |   666 | `	return SXRET_OK;` |
|   58314 |   667 |  |
|       - |   668 | `/*` |
...
|       - |   677 | ` *` |
|       - |   678 | ` */` |
|   83764 |   679 | `PH7_PRIVATE sxi32 PH7_CompileSimpleString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |   680 |  |
|   83769 |   681 | `	SyString *pStr = &pGen->pIn->sData; /* Constant string literal */` |
|       - |   682 | `	const char *zIn,*zCur,*zEnd;` |
|       - |   683 | `	ph7_value *pObj;` |
|       - |   684 | `	sxu32 nIdx;` |
|   83769 |   685 | `	nIdx = 0; /* Prevent compiler warning */` |
|       - |   686 | `	/* Delimit the string */` |
|   83769 |   687 | `	zIn  = pStr->zString;` |
|   83769 |   688 | `	zEnd = &zIn[pStr->nByte];` |
|   83769 |   689 | `	if( zIn >= zEnd ){` |
|       - |   690 | `		/* Empty string constant: just use the pre‑allocated index from the VM` |
|       - |   691 | `		 * rather than reserving a new object each time. */` |
|    6779 |   692 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,pGen->pVm->nEmptyStringIdx,0,0);` |
|    6779 |   693 | `		return SXRET_OK;` |
|       - |   694 | `	}` |
|   76995 |   695 | `	if( SXRET_OK == GenStateFindLiteral(&(*pGen),pStr,&nIdx) ){` |
|       - |   696 | `		/* Already processed,emit the load constant instruction` |
|       - |   697 | `		 * and return.` |
|       - |   698 | `		 */` |
|   30521 |   699 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   30521 |   700 | `		return SXRET_OK;` |
|       - |   701 | `	}` |
|       - |   702 | `	/* Reserve a new constant */` |
|   46479 |   703 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   46479 |   704 | `	if( pObj == 0 ){` |
...
|       - |   708 | `	}` |
|   46479 |   709 | `	PH7_MemObjInitFromString(pGen->pVm,pObj,0);` |
|       - |   710 | `	/* Compile the node */` |
|   46526 |   711 | `	for(;;){` |
|   93057 |   712 | `		if( zIn >= zEnd ){` |
|       - |   713 | `			/* End of input */` |
|   46479 |   714 | `			break;` |
|       - |   715 | `		}` |
|   46583 |   716 | `		zCur = zIn;` |
|  733635 |   717 | `		while( zIn < zEnd && zIn[0] != '\\' ){` |
|  687057 |   718 | `			zIn++;` |
|       5 |   719 | `		}` |
|   46583 |   720 | `		if( zIn > zCur ){` |
|       - |   721 | `			/* Append raw contents*/` |
|   46559 |   722 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|   23277 |   723 | `		}` |
|   46583 |   724 | `		zIn++;` |
|   46583 |   725 | `		if( zIn < zEnd ){` |
|     126 |   726 | `			if( zIn[0] == '\\' ){` |
...
|   46479 |   743 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   46479 |   744 | `	if( pStr->nByte < 1024 ){` |
|       - |   745 | `		/* Install in the literal table */` |
|   46479 |   746 | `		GenStateInstallLiteral(pGen,pObj,nIdx);` |
|   23237 |   747 | `	}` |
|       - |   748 | `	/* Node successfully compiled */` |
|   46479 |   749 | `	return SXRET_OK;` |
|   41887 |   750 |  |
|       - |   751 | `/*` |
...
|       - |   949 | ` */` |
|   22832 |   950 | `static ph7_value * GenStateNewStrObj(ph7_gen_state *pGen,sxi32 *pCount)` |
|       5 |   951 |  |
|       - |   952 | `	ph7_value *pConstObj;` |
|   22837 |   953 | `	sxu32 nIdx = 0;` |
|       - |   954 | `	/* Reserve a new constant */` |
|   22837 |   955 | `	pConstObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   22837 |   956 | `	if( pConstObj == 0 ){` |
|     ! 0 |   957 | `		PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"PH7 engine is running out of memory");` |
|     ! 0 |   958 | `		return 0;` |
|       - |   959 | `	}` |
|   22837 |   960 | `	(*pCount)++;` |
|   22837 |   961 | `	PH7_MemObjInitFromString(pGen->pVm,pConstObj,0);` |
|       - |   962 | `	/* Emit the load constant instruction */` |
|   22837 |   963 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   22837 |   964 | `	return pConstObj;` |
|   11421 |   965 |  |
|       - |   966 | `/*` |
...
|       - |  1003 | ` */` |
|   21392 |  1004 | `static sxi32 GenStateCompileString(ph7_gen_state *pGen)` |
|       5 |  1005 |  |
|   21397 |  1006 | `	SyString *pStr = &pGen->pIn->sData; /* Raw token value */` |
|       - |  1007 | `	const char *zIn,*zCur,*zEnd;` |
|   21397 |  1008 | `	ph7_value *pObj = 0;` |
|       - |  1009 | `	sxi32 iCons;` |
|       - |  1010 | `	sxi32 rc;` |
|       - |  1011 | `	/* Delimit the string */` |
|   21397 |  1012 | `	zIn  = pStr->zString;` |
|   21397 |  1013 | `	zEnd = &zIn[pStr->nByte];` |
|   21397 |  1014 | `	if( zIn >= zEnd ){` |
...
|       - |  1018 | `		 */` |
|     303 |  1019 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,pGen->pVm->nEmptyStringIdx,0,0);` |
|     303 |  1020 | `		return SXRET_OK;` |
|       - |  1021 | `	}` |
|   21099 |  1022 | `	zCur = 0;` |
...
|   11586 |  1025 | `	for(;;){` |
|   34925 |  1026 | `		zCur = zIn;` |
|  169395 |  1027 | `		while( zIn < zEnd && zIn[0] != '\\'  ){` |
|  136553 |  1028 | `			if( zIn[0] == '{' && &zIn[1] < zEnd && zIn[1] == '$' ){` |
|      67 |  1029 | `				break;` |
|  136427 |  1030 | `			}else if(zIn[0] == '$' && &zIn[1] < zEnd &&` |
|    1954 |  1031 | `				(((unsigned char)zIn[1] >= 0xc0 \|\| SyisAlpha(zIn[1]) \|\| zIn[1] == '{' \|\| zIn[1] == '_')) ){` |
|     980 |  1032 | `					break;` |
|       - |  1033 | `			}` |
|  134475 |  1034 | `			zIn++;` |
|       5 |  1035 | `		}` |
|   34925 |  1036 | `		if( zIn > zCur ){` |
|   16193 |  1037 | `			if( pObj == 0 ){` |
|   15755 |  1038 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|   15755 |  1039 | `				if( pObj == 0 ){` |
|     ! 0 |  1040 | `					return SXERR_ABORT;` |
|       - |  1041 | `				}` |
|    7875 |  1042 | `			}` |
|   16193 |  1043 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|    8094 |  1044 | `		}` |
|   34925 |  1045 | `		if( zIn >= zEnd ){` |
|   21099 |  1046 | `			break;` |
|       - |  1047 | `		}` |
|   13831 |  1048 | `		if( zIn[0] == '\\' ){` |
|   11753 |  1049 | `			const char *zPtr = 0;` |
|       - |  1050 | `			sxu32 n;` |
|   11753 |  1051 | `			zIn++;` |
|   11753 |  1052 | `			if( zIn >= zEnd ){` |
|     ! 0 |  1053 | `				break;` |
|       - |  1054 | `			}` |
|   11753 |  1055 | `			if( pObj == 0 ){` |
|    7087 |  1056 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|    7087 |  1057 | `				if( pObj == 0 ){` |
|     ! 0 |  1058 | `					return SXERR_ABORT;` |
|       - |  1059 | `				}` |
|    3541 |  1060 | `			}` |
|   11753 |  1061 | `			n = sizeof(char); /* size of conversion */` |
|   11753 |  1062 | `			switch( zIn[0] ){` |
|       7 |  1063 | `			case '$':` |
|       - |  1064 | `				/* Dollar sign */` |
...
|   10821 |  1085 | `				PH7_MemObjStringAppend(pObj,"\n",sizeof(char));` |
|   10821 |  1086 | `				break;` |
|      19 |  1087 | `			case 'r':` |
...
|   21099 |  1278 | `	return SXRET_OK;` |
|   10701 |  1279 |  |
|       - |  1280 | `/*` |
|       - |  1281 | ` * Compile a double quoted string.` |
|       - |  1282 | ` *  See the block-comment above for more information.` |
|       - |  1283 | ` */` |
|   21332 |  1284 | `PH7_PRIVATE sxi32 PH7_CompileString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  1285 |  |
|       - |  1286 | `	sxi32 rc;` |
|   21337 |  1287 | `	rc = GenStateCompileString(&(*pGen));` |
|   10666 |  1288 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|       - |  1289 | `	/* Compilation result */` |
|   21337 |  1290 | `	return rc;` |
|       5 |  1291 |  |
|       - |  1292 | `/*` |
...
|       - |  1333 | ` */` |
|   19790 |  1334 | `static sxi32 GenStateCompileArrayEntry(` |
...
|   19795 |  1345 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|       - |  1346 | `	/* Compile the expression*/` |
|   19795 |  1347 | `	rc = PH7_CompileExpr(&(*pGen),iFlags,xValidator);` |
|       - |  1348 | `	/* Restore token stream */` |
|   19795 |  1349 | `	RE_SWAP_DELIMITER(pGen);` |
|   19795 |  1350 | `	return rc;` |
|       5 |  1351 |  |
|       - |  1352 | `/*` |
...
|       - |  1388 | ` */` |
|   29000 |  1389 | `static sxi32 GenStateCompileArrayBody(ph7_gen_state *pGen)` |
|       5 |  1390 |  |
|       - |  1391 | `	sxi32 (*xValidator)(ph7_gen_state *,ph7_expr_node *); /* Expression tree validator callback */` |
|       - |  1392 | `	SyToken *pKey,*pCur;` |
|   29005 |  1393 | `	sxi32 iEmitRef = 0;` |
|   29005 |  1394 | `	sxi32 iSpread = 0;` |
|   29005 |  1395 | `	sxi32 nPair = 0;` |
|       - |  1396 | `	sxi32 iNest;` |
|       - |  1397 | `	sxi32 rc;` |
|   29005 |  1398 | `	xValidator = 0;` |
|   23598 |  1399 | `	for(;;){` |
|       - |  1400 | `		/* Jump leading commas */` |
|   53339 |  1401 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA) ){` |
|    6143 |  1402 | `			pGen->pIn++;` |
|       5 |  1403 | `		}` |
|   47201 |  1404 | `		pCur = pGen->pIn;` |
|   47201 |  1405 | `		if( SXRET_OK != PH7_GetNextExpr(pGen->pIn,pGen->pEnd,&pGen->pIn) ){` |
|       - |  1406 | `			/* No more entry to process */` |
|   28989 |  1407 | `			break;` |
|       - |  1408 | `		}` |
|   18217 |  1409 | `		if( pCur >= pGen->pIn ){` |
|     ! 0 |  1410 | `			continue;` |
|       - |  1411 | `		}` |
|       - |  1412 | `		/* Compile the key if available */` |
|   18217 |  1413 | `		pKey = pCur;` |
|   18217 |  1414 | `		iNest = 0;` |
|   51027 |  1415 | `		while( pCur < pGen->pIn ){` |
|   34295 |  1416 | `			if( (pCur->nType & PH7_TK_ARRAY_OP) && iNest <= 0 ){` |
|    1481 |  1417 | `				break;` |
|       - |  1418 | `			}` |
...
|       - |  1423 | `			 */` |
|   32819 |  1424 | `			if( iNest == 0 && (pCur->nType & PH7_TK_KEYWORD) ){` |
...
|       - |  1486 | `				}` |
|      38 |  1487 | `			}` |
|   32813 |  1488 | `			if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|     270 |  1489 | `				iNest++;` |
|   32680 |  1490 | `			}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}'*/) ){` |
...
|   32813 |  1496 | `			pCur++;` |
|       5 |  1497 | `		}` |
|   18217 |  1498 | `		rc = SXERR_EMPTY;` |
|   18217 |  1499 | `		if( pCur < pGen->pIn ){` |
|    1481 |  1500 | `			if( &pCur[1] >= pGen->pIn ){` |
|       - |  1501 | `				/* Missing value */` |
...
|    1471 |  1509 | `			rc = GenStateCompileArrayEntry(&(*pGen),pKey,pCur,` |
|       - |  1510 | `				EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,0);` |
|    1471 |  1511 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  1512 | `				return SXERR_ABORT;` |
|       - |  1513 | `			}` |
|    1471 |  1514 | `			pCur++; /* Jump the '=>' operator */` |
|   17474 |  1515 | `		}else if( pKey == pCur ){` |
...
|   16741 |  1521 | `			pCur = pKey;` |
|       - |  1522 | `		}` |
|   18207 |  1523 | `		if( rc == SXERR_EMPTY ){` |
|       - |  1524 | `			/* No available key,load NULL */` |
|   16743 |  1525 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,0 /* nil index */,0,0);` |
|    8369 |  1526 | `		}` |
|   18207 |  1527 | `		if( pCur->nType & PH7_TK_AMPER /*'&'*/){` |
...
|   18205 |  1546 | `		iSpread = (pCur < pGen->pIn && (pCur->nType & PH7_TK_ELLIPSIS)) ? 1 : 0;` |
|   18205 |  1547 | `		if( iSpread && (rc != SXERR_EMPTY \|\| iEmitRef) ){` |
...
|   18201 |  1560 | `		rc = GenStateCompileArrayEntry(&(*pGen),pCur,pGen->pIn,EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,xValidator);` |
|   18201 |  1561 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  1562 | `			return SXERR_ABORT;` |
|       - |  1563 | `		}` |
|   18201 |  1564 | `		if( iSpread ){` |
...
|   18170 |  1567 | `		}else if( iEmitRef ){` |
|       - |  1568 | `			/* Emit the load reference instruction */` |
|      40 |  1569 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_REF,0,0,0,0);` |
|      18 |  1570 | `		}` |
|   18201 |  1571 | `		xValidator = 0;` |
|   18201 |  1572 | `		iEmitRef = 0;` |
|   18201 |  1573 | `		iSpread = 0;` |
|   18201 |  1574 | `		nPair++;` |
|       5 |  1575 | `	}` |
|       - |  1576 | `	/* Emit the load map instruction */` |
|   28989 |  1577 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_MAP,nPair * 2,0,0,0);` |
|       - |  1578 | `	/* Node successfully compiled */` |
|   28989 |  1579 | `	return SXRET_OK;` |
|   14505 |  1580 |  |
|       - |  1581 | `/*` |
...
|       - |  1589 | ` */` |
|   28236 |  1590 | `PH7_PRIVATE sxi32 PH7_CompileArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  1591 |  |
|       - |  1592 | `	/* Jump the 'array' keyword and the leading '(', exclude trailing ')'. */` |
|   28241 |  1593 | `	pGen->pIn += 2;` |
|   28241 |  1594 | `	pGen->pEnd--;` |
|   14118 |  1595 | `	SXUNUSED(iCompileFlag);` |
|   28241 |  1596 | `	return GenStateCompileArrayBody(pGen);` |
|       5 |  1597 |  |
|       - |  1598 | `/*` |
...
|       - |  1602 | ` */` |
|     764 |  1603 | `PH7_PRIVATE sxi32 PH7_CompileShortArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  1604 |  |
|       - |  1605 | `	/* Jump the leading '[', exclude trailing ']'. */` |
|     769 |  1606 | `	pGen->pIn++;` |
|     769 |  1607 | `	pGen->pEnd--;` |
|     382 |  1608 | `	SXUNUSED(iCompileFlag);` |
|     769 |  1609 | `	return GenStateCompileArrayBody(pGen);` |
|       5 |  1610 |  |
|       - |  1611 | `/*` |
...
|       - |  2739 | ` */` |
| 1034898 |  2740 | `PH7_PRIVATE sxi32 PH7_CompileVariable(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  2741 |  |
| 1034903 |  2742 | `	sxu32 nLineLocal = pGen->pIn->nLine;` |
|       - |  2743 | `	sxi32 iVv;` |
|       - |  2744 | `	sxi32 iP1;` |
|       - |  2745 | `	void *p3;` |
|       - |  2746 | `	sxi32 rc;` |
| 1034903 |  2747 | `	iVv = -1; /* Variable variable counter */` |
| 2069813 |  2748 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) ){` |
| 1034915 |  2749 | `		pGen->pIn++;` |
| 1034915 |  2750 | `		iVv++;` |
|       5 |  2751 | `	}` |
| 1034903 |  2752 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_OCB/*'{'*/)) == 0 ){` |
...
|       - |  2760 | `	}` |
| 1034903 |  2761 | `	p3  = 0;` |
| 1034903 |  2762 | `	if( pGen->pIn->nType & PH7_TK_OCB/*'{'*/ ){` |
...
|       - |  2781 | `		SyString *pName;` |
| 1034887 |  2782 | `		char *zName = 0;` |
|       - |  2783 | `		/* Extract variable name */` |
| 1034887 |  2784 | `		pName = &pGen->pIn->sData;` |
|       - |  2785 | `		/* Advance the stream cursor */` |
| 1034887 |  2786 | `		pGen->pIn++;` |
| 1034887 |  2787 | `		pEntry = SyHashGet(&pGen->hVar,(const void *)pName->zString,pName->nByte);` |
| 1034887 |  2788 | `		if( pEntry == 0 ){` |
|       - |  2789 | `			/* Duplicate name */` |
|  138937 |  2790 | `			zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|  138937 |  2791 | `			if( zName == 0 ){` |
...
|  138937 |  2796 | `			SyHashInsert(&pGen->hVar,zName,pName->nByte,zName);` |
|   69471 |  2797 | `		}else{` |
|       - |  2798 | `			/* Name already available */` |
|  895955 |  2799 | `			zName = (char *)pEntry->pUserData;` |
|       - |  2800 | `		}` |
| 1034887 |  2801 | `		p3 = (void *)zName;` |
|       - |  2802 | `	}` |
| 1034899 |  2803 | `	iP1 = 0;` |
| 1034899 |  2804 | `	if( iCompileFlag & EXPR_FLAG_RDONLY_LOAD ){` |
|  376973 |  2805 | `		if( (iCompileFlag & EXPR_FLAG_LOAD_IDX_STORE) == 0 ){` |
|       - |  2806 | `			/* Read-only load.In other words do not create the variable if inexistant */` |
|  376955 |  2807 | `			iP1 = 1;` |
|  188475 |  2808 | `		}` |
|  188484 |  2809 | `	}` |
|       - |  2810 | `	/* Emit the load instruction */` |
| 1034899 |  2811 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,0,p3,0);` |
| 1034911 |  2812 | `	while( iVv > 0 ){` |
|      13 |  2813 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,0,0,0);` |
|      13 |  2814 | `		iVv--;` |
|       1 |  2815 | `	}` |
|       - |  2816 | `	/* Node successfully compiled */` |
| 1034899 |  2817 | `	return SXRET_OK;` |
|  517454 |  2818 |  |
|       - |  2819 | `/*` |
|       - |  2820 | ` * Load a literal.` |
|       - |  2821 | ` */` |
|  727996 |  2822 | `static sxi32 GenStateLoadLiteral(ph7_gen_state *pGen)` |
|       5 |  2823 |  |
|  728001 |  2824 | `	SyToken *pToken = pGen->pIn;` |
|       - |  2825 | `	ph7_value *pObj;` |
|       - |  2826 | `	SyString *pStr;` |
|       - |  2827 | `	sxu32 nIdx;` |
|       - |  2828 | `	/* Extract token value */` |
|  728001 |  2829 | `	pStr = &pToken->sData;` |
|       - |  2830 | `	/* Deal with the reserved literals [i.e: null,false,true,...] first */` |
|  728001 |  2831 | `	if( pStr->nByte == sizeof("NULL") - 1 ){` |
|  154353 |  2832 | `		if( SyStrnicmp(pStr->zString,"null",sizeof("NULL")-1) == 0 ){` |
|       - |  2833 | `			/* NULL constant are always indexed at 0 */` |
|   56859 |  2834 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,0,0,0);` |
|   56859 |  2835 | `			return SXRET_OK;` |
|   97499 |  2836 | `		}else if( SyStrnicmp(pStr->zString,"true",sizeof("TRUE")-1) == 0 ){` |
|       - |  2837 | `			/* TRUE constant are always indexed at 1 */` |
|     615 |  2838 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,1,0,0);` |
|     615 |  2839 | `			return SXRET_OK;` |
|       5 |  2840 | `		}` |
|  679767 |  2841 | `	}else if (pStr->nByte == sizeof("FALSE") - 1 &&` |
|  115344 |  2842 | `		SyStrnicmp(pStr->zString,"false",sizeof("FALSE")-1) == 0 ){` |
|       - |  2843 | `			/* FALSE constant are always indexed at 2 */` |
|   43593 |  2844 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,2,0,0);` |
|   43593 |  2845 | `			return SXRET_OK;` |
|  581809 |  2846 | `	}else if(pStr->nByte == sizeof("__LINE__") - 1 &&` |
|  103488 |  2847 | `		SyMemcmp(pStr->zString,"__LINE__",sizeof("__LINE__")-1) == 0 ){` |
|       - |  2848 | `			/* TICKET 1433-004: __LINE__ constant must be resolved at compile time,not run time */` |
|    9923 |  2849 | `			pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|    9923 |  2850 | `			if( pObj == 0 ){` |
|     ! 0 |  2851 | `				PH7_GenCompileError(pGen,E_ERROR,pToken->nLine,"Fatal, PH7 engine is running out of memory");` |
|     ! 0 |  2852 | `				return SXERR_ABORT;` |
|       - |  2853 | `			}` |
|    9923 |  2854 | `			PH7_MemObjInitFromInt(pGen->pVm,pObj,pToken->nLine);` |
|       - |  2855 | `			/* Emit the load constant instruction */` |
|    9923 |  2856 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|    9923 |  2857 | `			return SXRET_OK;` |
|  536871 |  2858 | `	}else if( pStr->nByte == sizeof("__NAMESPACE__") - 1 &&` |
|   33448 |  2859 | `		SyMemcmp(pStr->zString,"__NAMESPACE__",sizeof("__NAMESPACE__")-1) == 0 ){` |
...
|  535932 |  2875 | `	}else if( (pStr->nByte == sizeof("__FUNCTION__") - 1 &&` |
|   13975 |  2876 | `		SyMemcmp(pStr->zString,"__FUNCTION__",sizeof("__FUNCTION__")-1) == 0) \|\|` |
|  528940 |  2877 | `		(pStr->nByte == sizeof("__METHOD__") - 1 &&` |
|   17622 |  2878 | `		SyMemcmp(pStr->zString,"__METHOD__",sizeof("__METHOD__")-1) == 0) ){` |
...
|  617015 |  2908 | `	if( SXRET_OK != GenStateFindLiteral(&(*pGen),&pToken->sData,&nIdx) ){` |
|       - |  2909 | `		ph7_value *pLitObj;` |
|       - |  2910 | `		/* Unknown literal,install it in the literal table */` |
|  256277 |  2911 | `		pLitObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  256277 |  2912 | `		if( pLitObj == 0 ){` |
|     ! 0 |  2913 | `			PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|     ! 0 |  2914 | `			return SXERR_ABORT;` |
|       - |  2915 | `		}` |
|  256277 |  2916 | `		PH7_MemObjInitFromString(pGen->pVm,pLitObj,&pToken->sData);` |
|  256277 |  2917 | `		GenStateInstallLiteral(&(*pGen),pLitObj,nIdx);` |
|  128136 |  2918 | `	}` |
|       - |  2919 | `	/* Emit the load constant instruction */` |
|  617015 |  2920 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,1,nIdx,0,0);` |
|  617015 |  2921 | `	return SXRET_OK;` |
|  364003 |  2922 |  |
|       - |  2923 | `/*` |
...
|       - |  2928 | ` */` |
|  728032 |  2929 | `static sxi32 GenStateResolveNamespaceLiteral(ph7_gen_state *pGen)` |
|       5 |  2930 |  |
|       - |  2931 | `	sxi32 rc;` |
|  728037 |  2932 | `	if( pGen->pIn >= pGen->pEnd ){` |
|     ! 0 |  2933 | `		return SXRET_OK;` |
|       - |  2934 | `	}` |
|       - |  2935 | `	/* Check if this is a multi-token namespace path */` |
|  728037 |  2936 | `	if( pGen->pIn < &pGen->pEnd[-1] ){` |
...
|  728001 |  2989 | `	rc = GenStateLoadLiteral(&(*pGen));` |
|  728001 |  2990 | `	return rc;` |
|  364021 |  2991 |  |
|       - |  2992 | `/*` |
|       - |  2993 | ` * Compile a literal which is an identifier(name) for a simple value.` |
|       - |  2994 | ` */` |
|  728032 |  2995 | `PH7_PRIVATE sxi32 PH7_CompileLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  2996 |  |
|       - |  2997 | `	sxi32 rc;` |
|  728037 |  2998 | `	rc = GenStateResolveNamespaceLiteral(&(*pGen));` |
|  728037 |  2999 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  3000 | `		SXUNUSED(iCompileFlag); /* cc warning */` |
|     ! 0 |  3001 | `		return rc;` |
|       - |  3002 | `	}` |
|       - |  3003 | `	/* Node successfully compiled */` |
|  728037 |  3004 | `	return SXRET_OK;` |
|  364021 |  3005 |  |
|       - |  3006 | `/*` |
...
|       - |  3164 | ` */` |
|    3444 |  3165 | `static void GenStateEmitExceptionPopForBreak(ph7_gen_state *pGen,GenBlock *pTarget)` |
|       5 |  3166 |  |
|    3449 |  3167 | `	GenBlock *pBlock = pGen->pCurrent;` |
|   20177 |  3168 | `	while( pBlock && pBlock != pTarget ){` |
|   16733 |  3169 | `		if( pBlock->iFlags & GEN_BLOCK_EXCEPTION ){` |
...
|       - |  3179 | `			}` |
|       1 |  3180 | `		}` |
|   16733 |  3181 | `		pBlock = pBlock->pParent;` |
|       5 |  3182 | `	}` |
|    3449 |  3183 |  |
|    3348 |  3184 | `static sxi32 PH7_CompileContinue(ph7_gen_state *pGen)` |
|       5 |  3185 |  |
|       - |  3186 | `	GenBlock *pLoop; /* Target loop */` |
|       - |  3187 | `	sxi32 iLevel;    /* How many nesting loop to skip */` |
|       - |  3188 | `	sxu32 nLineLocal;` |
|       - |  3189 | `	sxi32 rc;` |
|    3353 |  3190 | `	nLineLocal = pGen->pIn->nLine;` |
|    3353 |  3191 | `	iLevel = 0;` |
|       - |  3192 | `	/* Jump the 'continue' keyword */` |
|    3353 |  3193 | `	pGen->pIn++;` |
|    3353 |  3194 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NUM) ){` |
...
|    3353 |  3220 | `	pLoop = GenStateFetchBlock(pGen->pCurrent,GEN_BLOCK_LOOP,iLevel);` |
|    3353 |  3221 | `	if( pLoop == 0 ){` |
...
|       - |  3227 | `		}` |
|       7 |  3228 | `	}else{` |
|    3343 |  3229 | `		sxu32 nInstrIdx = 0;` |
|       - |  3230 | `		/* Emit POP_EXCEPTION for any try blocks between here and the loop */` |
|    3343 |  3231 | `		GenStateEmitExceptionPopForBreak(&(*pGen),pLoop);` |
|    3343 |  3232 | `		if( pLoop->iFlags & GEN_BLOCK_SWITCH ){` |
...
|    3339 |  3244 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pLoop->nFirstInstr,0,&nInstrIdx);` |
|    3339 |  3245 | `			if( pLoop->bPostContinue == TRUE ){` |
...
|       - |  3252 | `		}` |
|       - |  3253 | `	}` |
|    3353 |  3254 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
...
|       8 |  3440 | `			rc = PH7_GenCompileError(pGen,E_ERROR,pGen->pIn->nLine,"goto inside try/catch block is disallowed");` |
|       8 |  3441 | `			if( rc == SXERR_ABORT ){` |
...
|       - |  3535 | ` * message.` |
|       - |  3536 | ` */` |
|  400830 |  3537 | `static sxi32 PH7_CompileBlock(` |
...
|       - |  3542 | `	sxi32 rc;` |
|       - |  3543 | `	sxu32 nLine;` |
|  400835 |  3544 | `	if( pGen->pIn->nType & PH7_TK_OCB /* '{' */ ){` |
|  399349 |  3545 | `		nLine = pGen->pIn->nLine;` |
|  399349 |  3546 | `		rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_STD,PH7_VmInstrLength(pGen->pVm),0,0);` |
|  399349 |  3547 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  3548 | `			return SXERR_ABORT;` |
|       - |  3549 | `		}` |
|  399349 |  3550 | `		pGen->pIn++;` |
|       - |  3551 | `		/* Compile until we hit the closing braces '}' */` |
|  545438 |  3552 | `		for(;;){` |
| 1090881 |  3553 | `			if( pGen->pIn >= pGen->pEnd ){` |
...
|       - |  3562 | `				}` |
|     ! 0 |  3563 | `			}` |
| 1090861 |  3564 | `			if( pGen->pIn->nType & PH7_TK_CCB/*'}'*/ ){` |
|       - |  3565 | `				/* Closing braces found,break immediately*/` |
|  399329 |  3566 | `				pGen->pIn++;` |
|  399329 |  3567 | `				break;` |
|       - |  3568 | `			}` |
|       - |  3569 | `			/* Compile a single statement */` |
|  691537 |  3570 | `			rc = GenStateCompileChunk(&(*pGen),PH7_COMPILE_SINGLE_STMT);` |
|  691537 |  3571 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  3572 | `				return SXERR_ABORT;` |
|       - |  3573 | `			}` |
|       5 |  3574 | `		}` |
|  399349 |  3575 | `		GenStateLeaveBlock(&(*pGen),0);` |
|  201163 |  3576 | `	}else if( (pGen->pIn->nType & PH7_TK_COLON /* ':' */) && nKeywordEnd > 0 ){` |
|     ! 0 |  3577 | `		pGen->pIn++;` |
...
|  400835 |  3626 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|     ! 0 |  3627 | `		pGen->pIn++;` |
|     ! 0 |  3628 | `	}` |
|  400835 |  3629 | `	return SXRET_OK;` |
|  200420 |  3630 |  |
|       - |  3631 | `/*` |
...
|       - |  3648 | ` *   endwhile;` |
|       - |  3649 | ` */` |
|   13336 |  3650 | `static sxi32 PH7_CompileWhile(ph7_gen_state *pGen)` |
|       5 |  3651 |  |
|   13341 |  3652 | `	GenBlock *pWhileBlock = 0;` |
|   13341 |  3653 | `	SyToken *pTmp,*pEnd = 0;` |
|       - |  3654 | `	sxu32 nFalseJump;` |
|       - |  3655 | `	sxu32 nLine;` |
|       - |  3656 | `	sxi32 rc;` |
|   13341 |  3657 | `	nLine = pGen->pIn->nLine;` |
|       - |  3658 | `	/* Jump the 'while' keyword */` |
|   13341 |  3659 | `	pGen->pIn++;` |
|   13341 |  3660 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  3661 | `		/* Syntax error */` |
...
|   13341 |  3672 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pWhileBlock);` |
|   13341 |  3673 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  3674 | `		return SXERR_ABORT;` |
|       - |  3675 | `	}` |
|       - |  3676 | `	/* Delimit the condition */` |
|   13341 |  3677 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   13341 |  3678 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|   13341 |  3687 | `	pTmp = pGen->pEnd;` |
|   13341 |  3688 | `	pGen->pEnd = pEnd;` |
|       - |  3689 | `	/* Compile the expression */` |
|   13341 |  3690 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   13341 |  3691 | `	if( rc == SXERR_ABORT ){` |
|       - |  3692 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  3693 | `		return SXERR_ABORT;` |
|       - |  3694 | `	}` |
|       - |  3695 | `	/* Update token stream */` |
|   13341 |  3696 | `	while(pGen->pIn < pEnd ){` |
...
|   13341 |  3704 | `	pGen->pIn  = &pEnd[1];` |
|   13341 |  3705 | `	pGen->pEnd = pTmp;` |
|       - |  3706 | `	/* Emit the false jump */` |
|   13341 |  3707 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nFalseJump);` |
|       - |  3708 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   13341 |  3709 | `	GenStateNewJumpFixup(pWhileBlock,PH7_OP_JZ,nFalseJump);` |
|       - |  3710 | `	/* Compile the loop body */` |
|   13341 |  3711 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDWHILE);` |
|   13341 |  3712 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  3713 | `		return SXERR_ABORT;` |
|       - |  3714 | `	}` |
|       - |  3715 | `	/* Emit the unconditional jump to the start of the loop */` |
|   13341 |  3716 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pWhileBlock->nFirstInstr,0,0);` |
|       - |  3717 | `	/* Fix all jumps now the destination is resolved */` |
|   13341 |  3718 | `	GenStateFixJumps(pWhileBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - |  3719 | `	/* Release the loop block */` |
|   13341 |  3720 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  3721 | `	/* Statement successfully compiled */` |
|   13341 |  3722 | `	return SXRET_OK;` |
|     ! 0 |  3723 | `Synchronize:` |
...
|       - |  3878 | ` */` |
|   13336 |  3879 | `static sxi32 PH7_CompileFor(ph7_gen_state *pGen)` |
|       5 |  3880 |  |
|   13341 |  3881 | `	SyToken *pTmp,*pPostStart,*pEnd = 0;` |
|   13341 |  3882 | `	GenBlock *pForBlock = 0;` |
|       - |  3883 | `	sxu32 nFalseJump;` |
|       - |  3884 | `	sxu32 nLine;` |
|       - |  3885 | `	sxi32 rc;` |
|   13341 |  3886 | `	nLine = pGen->pIn->nLine;` |
|       - |  3887 | `	/* Jump the 'for' keyword */` |
|   13341 |  3888 | `	pGen->pIn++;` |
|   13341 |  3889 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  3890 | `		/* Syntax error */` |
...
|   13341 |  3901 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   13341 |  3902 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|   13341 |  3917 | `	pTmp = pGen->pEnd;` |
|   13341 |  3918 | `	pGen->pEnd = pEnd;` |
|       - |  3919 | `	/* Compile initialization expressions if available */` |
|   13341 |  3920 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|       - |  3921 | `	/* Pop operand lvalues */` |
|   13341 |  3922 | `	if( rc == SXERR_ABORT ){` |
|       - |  3923 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  3924 | `		return SXERR_ABORT;` |
|   13341 |  3925 | `	}else if( rc != SXERR_EMPTY ){` |
|   13339 |  3926 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|    6667 |  3927 | `	}` |
|   13341 |  3928 | `	if( (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|       - |  3929 | `		/* Syntax error */` |
...
|   13341 |  3941 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pForBlock);` |
|   13341 |  3942 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  3943 | `		return SXERR_ABORT;` |
|       - |  3944 | `	}` |
|       - |  3945 | `	/* Deffer continue jumps */` |
|   13341 |  3946 | `	pForBlock->bPostContinue = TRUE;` |
|       - |  3947 | `	/* Compile the condition */` |
|   13341 |  3948 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   13341 |  3949 | `	if( rc == SXERR_ABORT ){` |
|       - |  3950 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  3951 | `		return SXERR_ABORT;` |
|   13341 |  3952 | `	}else if( rc != SXERR_EMPTY ){` |
|       - |  3953 | `		/* Emit the false jump */` |
|   13339 |  3954 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nFalseJump);` |
|       - |  3955 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   13339 |  3956 | `		GenStateNewJumpFixup(pForBlock,PH7_OP_JZ,nFalseJump);` |
|    6667 |  3957 | `	}` |
|   13341 |  3958 | `	if( (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|       - |  3959 | `		/* Syntax error */` |
...
|   13337 |  3971 | `	pPostStart = pGen->pIn;` |
|       - |  3972 | `	/* Compile the loop body */` |
|   13337 |  3973 | `	pGen->pIn  = &pEnd[1]; /* Jump the trailing parenthesis ')' */` |
|   13337 |  3974 | `	pGen->pEnd = pTmp;` |
|   13337 |  3975 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDFOR);` |
|   13337 |  3976 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  3977 | `		return SXERR_ABORT;` |
|       - |  3978 | `	}` |
|       - |  3979 | `	/* Fix post-continue jumps */` |
|   13337 |  3980 | `	if( SySetUsed(&pForBlock->aPostContFix) > 0 ){` |
...
|   13337 |  3996 | `	while( pPostStart < pEnd && (pPostStart->nType & PH7_TK_SEMI) ){` |
|     ! 0 |  3997 | `		pPostStart++;` |
|     ! 0 |  3998 | `	}` |
|   13337 |  3999 | `	if( pPostStart < pEnd ){` |
|       - |  4000 | `		SyToken *pTmpIn,*pTmpEnd;` |
|   13337 |  4001 | `		SWAP_DELIMITER(pGen,pPostStart,pEnd);` |
|   13337 |  4002 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   13337 |  4003 | `		if( pGen->pIn < pGen->pEnd ){` |
|       - |  4004 | `			/* Syntax error */` |
...
|       - |  4011 | `		}` |
|   13337 |  4012 | `		RE_SWAP_DELIMITER(pGen);` |
|   13337 |  4013 | `		if( rc == SXERR_ABORT ){` |
|       - |  4014 | `			/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4015 | `			return SXERR_ABORT;` |
|   13337 |  4016 | `		}else if( rc != SXERR_EMPTY){` |
|       - |  4017 | `			/* Pop operand lvalue */` |
|   13337 |  4018 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|    6666 |  4019 | `		}` |
|    6666 |  4020 | `	}` |
|       - |  4021 | `	/* Emit the unconditional jump to the start of the loop */` |
|   13337 |  4022 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pForBlock->nFirstInstr,0,0);` |
|       - |  4023 | `	/* Fix all jumps now the destination is resolved */` |
|   13337 |  4024 | `	GenStateFixJumps(pForBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - |  4025 | `	/* Release the loop block */` |
|   13337 |  4026 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  4027 | `	/* Statement successfully compiled */` |
|   13337 |  4028 | `	return SXRET_OK;` |
|    6673 |  4029 |  |
...
|       - |  4032 | ` * are allowed.` |
|       - |  4033 | ` */` |
|    7118 |  4034 | `static sxi32 GenStateForEachNodeValidator(ph7_gen_state *pGen,ph7_expr_node *pRoot)` |
|       5 |  4035 |  |
|    7123 |  4036 | `	sxi32 rc = SXRET_OK; /* Assume a valid expression tree */` |
|    7123 |  4037 | `	if( pRoot->xCode != PH7_CompileVariable ){` |
...
|       - |  4072 | ` */` |
|    3628 |  4073 | `static sxi32 PH7_CompileForeach(ph7_gen_state *pGen)` |
|       5 |  4074 |  |
|    3633 |  4075 | `	SyToken *pCur,*pTmp,*pEnd = 0;` |
|    3633 |  4076 | `	SyToken *pListStart = 0,*pListEnd = 0;` |
|    3633 |  4077 | `	GenBlock *pForeachBlock = 0;` |
|       - |  4078 | `	ph7_foreach_info *pInfo;` |
|       - |  4079 | `	sxu32 nFalseJump;` |
|       - |  4080 | `	VmInstr *pInstr;` |
|       - |  4081 | `	sxu32 nLine;` |
|       - |  4082 | `	sxi32 rc;` |
|    3633 |  4083 | `	nLine = pGen->pIn->nLine;` |
|       - |  4084 | `	/* Jump the 'foreach' keyword */` |
|    3633 |  4085 | `	pGen->pIn++;` |
|    3633 |  4086 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  4087 | `		/* Syntax error */` |
...
|    3633 |  4098 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pForeachBlock);` |
|    3633 |  4099 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  4100 | `		return SXERR_ABORT;` |
|       - |  4101 | `	}` |
|       - |  4102 | `	/* Delimit the expression */` |
|    3633 |  4103 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|    3633 |  4104 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|    3633 |  4119 | `	pCur = pGen->pIn;` |
|   24421 |  4120 | `	while( pCur < pEnd ){` |
|   24421 |  4121 | `		if( pCur->nType & PH7_TK_KEYWORD ){` |
|    3647 |  4122 | `			sxi32 nKeywrd = SX_PTR_TO_INT(pCur->pUserData);` |
|    3647 |  4123 | `			if( nKeywrd == PH7_TKWRD_AS ){` |
...
|    3633 |  4141 | `	pTmp = pGen->pEnd;` |
|    3633 |  4142 | `	pGen->pEnd = pCur;` |
|    3633 |  4143 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|    3633 |  4144 | `	if( rc == SXERR_ABORT ){` |
|       - |  4145 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4146 | `		return SXERR_ABORT;` |
|       - |  4147 | `	}` |
|       - |  4148 | `	/* Update token stream */` |
|    3633 |  4149 | `	while(pGen->pIn < pCur ){` |
...
|     ! 0 |  4155 | `		pGen->pIn++;` |
|     ! 0 |  4156 | `	}` |
|    3633 |  4157 | `	pCur++; /* Jump the 'as' keyword */` |
|    3633 |  4158 | `	pGen->pIn = pCur;` |
|    3633 |  4159 | `	if( pGen->pIn >= pEnd ){` |
...
|    3633 |  4166 | `	pInfo = (ph7_foreach_info *)SyMemBackendAlloc(&pGen->pVm->sAllocator,sizeof(ph7_foreach_info));` |
|    3633 |  4167 | `	if( pInfo == 0 ){` |
...
|    3633 |  4172 | `	SyZero(pInfo,sizeof(ph7_foreach_info));` |
|       - |  4173 | `	/* Initialize structure fields */` |
|    3633 |  4174 | `	SySetInit(&pInfo->aStep,&pGen->pVm->sAllocator,sizeof(ph7_foreach_step *));` |
|       - |  4175 | `	/* Check if we have a key field */` |
|   10939 |  4176 | `	while( pCur < pEnd && (pCur->nType & PH7_TK_ARRAY_OP) == 0 ){` |
|    7311 |  4177 | `		pCur++;` |
|       5 |  4178 | `	}` |
|    3633 |  4179 | `	if( pCur < pEnd ){` |
|       - |  4180 | `		/* Compile the expression holding the key name */` |
|    3505 |  4181 | `		if( pGen->pIn >= pCur ){` |
...
|       - |  4186 | `			}` |
|     ! 0 |  4187 | `		}else{` |
|    3505 |  4188 | `			pGen->pEnd = pCur;` |
|    3505 |  4189 | `			rc = PH7_CompileExpr(&(*pGen),0,GenStateForEachNodeValidator);` |
|    3505 |  4190 | `			if( rc == SXERR_ABORT ){` |
|       - |  4191 | `				/* Don't worry about freeing memory, everything will be released shortly */` |
|     ! 0 |  4192 | `				return SXERR_ABORT;` |
|       - |  4193 | `			}` |
|    3505 |  4194 | `			pInstr = PH7_VmPopInstr(pGen->pVm);` |
|    3505 |  4195 | `			if( pInstr->p3 ){` |
|       - |  4196 | `				/* Record key name */` |
|    3505 |  4197 | `				SyStringInitFromBuf(&pInfo->sKey,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|    1750 |  4198 | `			}` |
|    3505 |  4199 | `			pInfo->iFlags \|= PH7_4EACH_STEP_KEY;` |
|       - |  4200 | `		}` |
|    3505 |  4201 | `		pGen->pIn = &pCur[1]; /* Jump the arrow */` |
|    1750 |  4202 | `	}` |
|    3633 |  4203 | `	pGen->pEnd = pEnd;` |
|    3633 |  4204 | `	if( pGen->pIn >= pEnd ){` |
...
|    3628 |  4259 | `	}else if( pGen->pIn->nType & PH7_TK_OSB ){` |
...
|    3623 |  4292 | `		rc = PH7_CompileExpr(&(*pGen),0,GenStateForEachNodeValidator);` |
|    3623 |  4293 | `		if( rc == SXERR_ABORT ){` |
|       - |  4294 | `			/* Don't worry about freeing memory, everything will be released shortly */` |
|     ! 0 |  4295 | `			return SXERR_ABORT;` |
|       - |  4296 | `		}` |
|    3623 |  4297 | `		pInstr = PH7_VmPopInstr(pGen->pVm);` |
|    3623 |  4298 | `		if( pInstr->p3 ){` |
|       - |  4299 | `			/* Record value name */` |
|    3623 |  4300 | `			SyStringInitFromBuf(&pInfo->sValue,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|    1809 |  4301 | `		}` |
|       - |  4302 | `	}` |
|       - |  4303 | `	/* Emit the 'FOREACH_INIT' instruction */` |
|    3631 |  4304 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_FOREACH_INIT,0,0,pInfo,&nFalseJump);` |
|       - |  4305 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|    3631 |  4306 | `	GenStateNewJumpFixup(pForeachBlock,PH7_OP_FOREACH_INIT,nFalseJump);` |
|       - |  4307 | `	/* Record the first instruction to execute */` |
|    3631 |  4308 | `	pForeachBlock->nFirstInstr = PH7_VmInstrLength(pGen->pVm);` |
|       - |  4309 | `	/* Emit the FOREACH_STEP instruction */` |
|    3631 |  4310 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_FOREACH_STEP,0,0,pInfo,&nFalseJump);` |
|       - |  4311 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|    3631 |  4312 | `	GenStateNewJumpFixup(pForeachBlock,PH7_OP_FOREACH_STEP,nFalseJump);` |
|       - |  4313 | `	/* If list() unpacking, emit bytecode to destructure the temp variable */` |
|    3631 |  4314 | `	if( (pInfo->iFlags & PH7_4EACH_STEP_LIST) && pListStart && pListEnd ){` |
...
|    3631 |  4342 | `	pGen->pIn = &pEnd[1];` |
|    3631 |  4343 | `	pGen->pEnd = pTmp;` |
|    3631 |  4344 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_END4EACH);` |
|    3631 |  4345 | `	if( rc == SXERR_ABORT ){` |
...
|    3631 |  4350 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pForeachBlock->nFirstInstr,0,0);` |
|       - |  4351 | `	/* Fix all jumps now the destination is resolved */` |
|    3631 |  4352 | `	GenStateFixJumps(pForeachBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - |  4353 | `	/* Release the loop block */` |
|    3631 |  4354 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  4355 | `	/* Statement successfully compiled */` |
|    3631 |  4356 | `	return SXRET_OK;` |
|       1 |  4357 | `Synchronize:` |
...
|       - |  4396 | ` *    ?>` |
|       - |  4397 | ` */` |
|  138662 |  4398 | `static sxi32 PH7_CompileIf(ph7_gen_state *pGen)` |
|       5 |  4399 |  |
|  138667 |  4400 | `	SyToken *pToken,*pTmp,*pEnd = 0;` |
|  138667 |  4401 | `	GenBlock *pCondBlock = 0;` |
|       - |  4402 | `	sxu32 nJumpIdx;` |
|       - |  4403 | `	sxu32 nKeyID;` |
|       - |  4404 | `	sxi32 rc;` |
|       - |  4405 | `	/* Jump the 'if' keyword */` |
|  138667 |  4406 | `	pGen->pIn++;` |
|  138667 |  4407 | `	pToken = pGen->pIn;` |
|       - |  4408 | `	/* Create the conditional block */` |
|  138667 |  4409 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_COND,PH7_VmInstrLength(pGen->pVm),0,&pCondBlock);` |
|  138667 |  4410 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  4411 | `		return SXERR_ABORT;` |
|       - |  4412 | `	}` |
|       - |  4413 | `	/* Process as many [if/else if/elseif/else] blocks as we can */` |
|   75952 |  4414 | `	for(;;){` |
|  151909 |  4415 | `		if( pToken >= pGen->pEnd \|\| (pToken->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  4416 | `			/* Syntax error */` |
...
|  151909 |  4430 | `		PH7_DelimitNestedTokens(pToken,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|  151909 |  4431 | `		if( pToken >= pEnd \|\| (pEnd->nType & PH7_TK_RPAREN) == 0 ){` |
|       - |  4432 | `			/* Syntax error */` |
...
|  151909 |  4444 | `		SWAP_TOKEN_STREAM(pGen,pToken,pEnd);` |
|       - |  4445 | `		/* Compile the condition */` |
|  151909 |  4446 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|       - |  4447 | `		/* Update token stream */` |
|  151909 |  4448 | `		while(pGen->pIn < pEnd ){` |
|     ! 0 |  4449 | `			PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Unexpected token '%z'",&pGen->pIn->sData);` |
|     ! 0 |  4450 | `			pGen->pIn++;` |
|     ! 0 |  4451 | `		}` |
|  151909 |  4452 | `		pGen->pIn  = &pEnd[1];` |
|  151909 |  4453 | `		pGen->pEnd = pTmp;` |
|  151909 |  4454 | `		if( rc == SXERR_ABORT ){` |
|       - |  4455 | `			/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4456 | `			return SXERR_ABORT;` |
|       - |  4457 | `		}` |
|       - |  4458 | `		/* Emit the false jump */` |
|  151909 |  4459 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nJumpIdx);` |
|       - |  4460 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|  151909 |  4461 | `		GenStateNewJumpFixup(pCondBlock,PH7_OP_JZ,nJumpIdx);` |
|       - |  4462 | `		/* Compile the body */` |
|  151909 |  4463 | `		rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDIF);` |
|  151909 |  4464 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  4465 | `			return SXERR_ABORT;` |
|       - |  4466 | `		}` |
|  151909 |  4467 | `		if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
|   42382 |  4468 | `			break;` |
|       - |  4469 | `		}` |
|       - |  4470 | `		/* Ensure that the keyword ID is 'else if' or 'else' */` |
|   67155 |  4471 | `		nKeyID = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   67155 |  4472 | `		if( (nKeyID & (PH7_TKWRD_ELSE\|PH7_TKWRD_ELIF)) == 0 ){` |
|   43259 |  4473 | `			break;` |
|       - |  4474 | `		}` |
|       - |  4475 | `		/* Emit the unconditional jump */` |
|   23901 |  4476 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,0,0,&nJumpIdx);` |
|       - |  4477 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   23901 |  4478 | `		GenStateNewJumpFixup(pCondBlock,PH7_OP_JMP,nJumpIdx);` |
|   23901 |  4479 | `		if( nKeyID & PH7_TKWRD_ELSE ){` |
|   17267 |  4480 | `			pToken = &pGen->pIn[1];` |
|   17267 |  4481 | `			if( pToken >= pGen->pEnd \|\| (pToken->nType & PH7_TK_KEYWORD) == 0 \|\|` |
|    6638 |  4482 | `				SX_PTR_TO_INT(pToken->pUserData) != PH7_TKWRD_IF ){` |
|    5332 |  4483 | `					break;` |
|       - |  4484 | `			}` |
|    6613 |  4485 | `			pGen->pIn++; /* Jump the 'else' keyword */` |
|    3304 |  4486 | `		}` |
|   13247 |  4487 | `		pGen->pIn++; /* Jump the 'elseif/if' keyword */` |
|       - |  4488 | `		/* Synchronize cursors */` |
|   13247 |  4489 | `		pToken = pGen->pIn;` |
|       - |  4490 | `		/* Fix the false jump */` |
|   13247 |  4491 | `		GenStateFixJumps(pCondBlock,PH7_OP_JZ,PH7_VmInstrLength(pGen->pVm));` |
|       5 |  4492 | `	} /* For(;;) */` |
|       - |  4493 | `	/* Fix the false jump */` |
|  138667 |  4494 | `	GenStateFixJumps(pCondBlock,PH7_OP_JZ,PH7_VmInstrLength(pGen->pVm));` |
|  138667 |  4495 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|   53908 |  4496 | `		(SX_PTR_TO_INT(pGen->pIn->pUserData) & PH7_TKWRD_ELSE) ){` |
|       - |  4497 | `			/* Compile the else block */` |
|   10659 |  4498 | `			pGen->pIn++;` |
|   10659 |  4499 | `			rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDIF);` |
|   10659 |  4500 | `			if( rc == SXERR_ABORT ){` |
|       - |  4501 |  |
|     ! 0 |  4502 | `				return SXERR_ABORT;` |
|       - |  4503 | `			}` |
|    5327 |  4504 | `	}` |
|  138667 |  4505 | `	nJumpIdx = PH7_VmInstrLength(pGen->pVm);` |
|       - |  4506 | `	/* Fix all unconditional jumps now the destination is resolved */` |
|  138667 |  4507 | `	GenStateFixJumps(pCondBlock,PH7_OP_JMP,nJumpIdx);` |
|       - |  4508 | `	/* Release the conditional block */` |
|  138667 |  4509 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  4510 | `	/* Statement successfully compiled */` |
|  138667 |  4511 | `	return SXRET_OK;` |
|     ! 0 |  4512 | `Synchronize:` |
...
|       - |  4612 | ` */` |
|  219168 |  4613 | `static sxi32 PH7_CompileReturn(ph7_gen_state *pGen)` |
|       5 |  4614 |  |
|  219173 |  4615 | `	sxi32 nRet = 0; /* TRUE if there is a return value */` |
|       - |  4616 | `	sxi32 rc;` |
|       - |  4617 | `	/* Jump the 'return' keyword */` |
|  219173 |  4618 | `	pGen->pIn++;` |
|  219173 |  4619 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|       - |  4620 | `		/* Compile the expression */` |
|  219147 |  4621 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|  219147 |  4622 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  4623 | `			return SXERR_ABORT;` |
|  219147 |  4624 | `		}else if(rc != SXERR_EMPTY ){` |
|  219147 |  4625 | `			nRet = 1;` |
|  109571 |  4626 | `		}` |
|  109571 |  4627 | `	}` |
...
|  219173 |  4633 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,nRet,1,0,0);` |
|  219173 |  4634 | `	return SXRET_OK;` |
|  109589 |  4635 |  |
|       - |  4636 | `/*` |
...
|       - |  4725 | ` */` |
|   13640 |  4726 | `static sxi32 PH7_CompileEcho(ph7_gen_state *pGen)` |
|       5 |  4727 |  |
|   13645 |  4728 | `	SyToken *pTmp,*pNext = 0;` |
|       - |  4729 | `	sxi32 rc;` |
|       - |  4730 | `	/* Jump the 'echo' keyword */` |
|   13645 |  4731 | `	pGen->pIn++;` |
|       - |  4732 | `	/* Compile arguments one after one */` |
|   13645 |  4733 | `	pTmp = pGen->pEnd;` |
|   29639 |  4734 | `	while( SXRET_OK == PH7_GetNextExpr(pGen->pIn,pTmp,&pNext) ){` |
|   15999 |  4735 | `		if( pGen->pIn < pNext ){` |
|   15999 |  4736 | `			pGen->pEnd = pNext;` |
|   15999 |  4737 | `			rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_RDONLY_LOAD/* Do not create variable if inexistant */,0);` |
|   15999 |  4738 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  4739 | `				return SXERR_ABORT;` |
|   15999 |  4740 | `			}else if( rc != SXERR_EMPTY ){` |
|       - |  4741 | `				/* Emit the consume instruction */` |
|   15975 |  4742 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_CONSUME,1,0,0,0);` |
|    7985 |  4743 | `			}` |
|    7997 |  4744 | `		}` |
|       - |  4745 | `		/* Jump trailing commas */` |
|   18353 |  4746 | `		while( pNext < pTmp && (pNext->nType & PH7_TK_COMMA) ){` |
|    2359 |  4747 | `			pNext++;` |
|       5 |  4748 | `		}` |
|   15999 |  4749 | `		pGen->pIn = pNext;` |
|       5 |  4750 | `	}` |
|       - |  4751 | `	/* Restore token stream */` |
|   13645 |  4752 | `	pGen->pEnd = pTmp;` |
|   13645 |  4753 | `	return SXRET_OK;` |
|    6825 |  4754 |  |
|       - |  4755 | `/*` |
...
|       - |  4920 | ` */` |
|  409068 |  4921 | `static sxu32 GenStateNsQualifyName(ph7_gen_state *pGen,sxu32 nOrigIdx,SyHash *pImports,int *pFromImport)` |
|       5 |  4922 |  |
|       - |  4923 | `	ph7_value *pLit;` |
...
|       - |  4931 | `	ph7_value *pNew;` |
|  409073 |  4932 | `	if( pFromImport ){` |
|  391077 |  4933 | `		*pFromImport = 0;` |
|  195536 |  4934 | `	}` |
|  409073 |  4935 | `	pLit = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,nOrigIdx);` |
|  409073 |  4936 | `	if( !pLit \|\| !(pLit->iFlags & MEMOBJ_STRING) \|\| SyBlobLength(&pLit->sBlob) == 0 ){` |
|     ! 0 |  4937 | `		return nOrigIdx;` |
|       - |  4938 | `	}` |
|  409073 |  4939 | `	zLit = (const char *)SyBlobData(&pLit->sBlob);` |
|  409073 |  4940 | `	nLit = (sxu32)SyBlobLength(&pLit->sBlob);` |
|       - |  4941 | `	/* Skip if already qualified (contains backslash) */` |
|  409073 |  4942 | `	hasNsSep = 0;` |
| 4425851 |  4943 | `	for( k = 0; k < nLit; k++ ){` |
| 4016791 |  4944 | `		if( zLit[k] == '\\' ){ hasNsSep = 1; break; }` |
| 2008394 |  4945 | `	}` |
|  409073 |  4946 | `	if( hasNsSep ){` |
|      11 |  4947 | `		return nOrigIdx;` |
|       - |  4948 | `	}` |
|       - |  4949 | `	/* Check use imports first (works even outside namespaces) */` |
|  409065 |  4950 | `	SyBlobReset(&pGen->sWorker);` |
|  409065 |  4951 | `	pImport = SyHashGet(pImports,(const void *)zLit,nLit);` |
|  409065 |  4952 | `	if( pImport ){` |
...
|       8 |  4957 | `		}` |
|      23 |  4958 | `	}else{` |
|  409029 |  4959 | `		if( SyBlobLength(&pGen->sNamespace) == 0 ){` |
|  408939 |  4960 | `			return nOrigIdx; /* Not in a namespace and no import match */` |
|       - |  4961 | `		}` |
...
|       - |  4983 | ` */` |
|   89946 |  4984 | `static void GenStateResolveName(ph7_gen_state *pGen,const SyString *pName,SyBlob *pOut)` |
|       5 |  4985 |  |
|       - |  4986 | `	SyHashEntry *pImport;` |
|       - |  4987 | `	/* Check use imports first */` |
|   89951 |  4988 | `	pImport = SyHashGet(&pGen->hUseImports,(const void *)pName->zString,pName->nByte);` |
|   89951 |  4989 | `	if( pImport ){` |
...
|       - |  5005 | ` */` |
|  126706 |  5006 | `static void GenStateBuildFQN(ph7_gen_state *pGen,const SyString *pName,SyBlob *pOut)` |
|       5 |  5007 |  |
|  126711 |  5008 | `	if( SyBlobLength(&pGen->sNamespace) > 0 ){` |
|      63 |  5009 | `		SyBlobAppend(pOut,SyBlobData(&pGen->sNamespace),SyBlobLength(&pGen->sNamespace));` |
|      63 |  5010 | `		SyBlobAppend(pOut,"\\",1);` |
|      29 |  5011 | `	}` |
|  126711 |  5012 | `	SyBlobAppend(pOut,pName->zString,pName->nByte);` |
|  126711 |  5013 |  |
|       - |  5014 | `/*` |
...
|       5 |  5318 | `		rc = PH7_GenCompileError(pGen,E_ERROR,nLine,"declare: Expecting opening parenthesis '('");` |
|       5 |  5319 | `		if( rc == SXERR_ABORT ){` |
...
|      15 |  5454 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & (PH7_TK_SEMI/*';'*/\|PH7_TK_OCB/*'{'*/)) == 0 ){` |
|      11 |  5455 | `		pGen->pIn++;` |
|       1 |  5456 | `	}` |
|       5 |  5457 | `	return SXRET_OK;` |
|      25 |  5458 |  |
|       - |  5459 | `/*` |
...
|       - |  5510 | ` */` |
|   62810 |  5511 | `static sxi32 GenStateProcessArgValue(ph7_gen_state *pGen,ph7_vm_func_arg *pArg,SyToken *pIn,SyToken *pEnd)` |
|       5 |  5512 |  |
|       - |  5513 | `	SyToken *pTmpIn,*pTmpEnd;` |
|       - |  5514 | `	SySet *pInstrContainer;` |
|       - |  5515 | `	sxi32 rc;` |
|       - |  5516 | `	/* Swap token stream */` |
|   62815 |  5517 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|   62815 |  5518 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   62815 |  5519 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pArg->aByteCode);` |
|       - |  5520 | `	/* Compile the expression holding the argument value */` |
|   62815 |  5521 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|       - |  5522 | `	/* Emit the done instruction */` |
|   62815 |  5523 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,(rc != SXERR_EMPTY ? 1 : 0),0,0,0);` |
|   62815 |  5524 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|   62815 |  5525 | `	RE_SWAP_DELIMITER(pGen);` |
|   62815 |  5526 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  5527 | `		return SXERR_ABORT;` |
|       - |  5528 | `	}` |
|   62815 |  5529 | `	return SXRET_OK;` |
|   31410 |  5530 |  |
|       - |  5531 | `/*` |
...
|       - |  5567 | ` */` |
|   87078 |  5568 | `static sxi32 GenStateCollectFuncArgs(ph7_vm_func *pFunc,ph7_gen_state *pGen,SyToken *pEnd,int bCtorCtx,int bAbstractCtx)` |
|       5 |  5569 |  |
...
|       - |  5574 | `	sxi32 rc;` |
|       - |  5575 |  |
|   87083 |  5576 | `	pIn = pGen->pIn;` |
|   87083 |  5577 | `	SyBlobInit(&sSig,&pGen->pVm->sAllocator);` |
|       - |  5578 | `	/* Process arguments one after one */` |
|  108909 |  5579 | `	for(;;){` |
|  217823 |  5580 | `		if( pIn >= pEnd ){` |
|       - |  5581 | `			/* No more arguments to process */` |
|   87071 |  5582 | `			break;` |
|       - |  5583 | `		}` |
|  130757 |  5584 | `		SyZero(&sArg,sizeof(ph7_vm_func_arg));` |
|  130757 |  5585 | `		SySetInit(&sArg.aByteCode,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|  130757 |  5586 | `		SySetInit(&sArg.aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|  130757 |  5587 | `		SyStringInitFromBuf(&sArg.sTypeName,0,0);` |
...
|       - |  5593 | `		{` |
|  130757 |  5594 | `			int bReadonly = 0, bVisSeen = 0;` |
|  130757 |  5595 | `			sxi32 iVis = PH7_CLASS_PROT_PUBLIC;` |
|  130757 |  5596 | `			if( pIn < pEnd && GenStateIsReadonly(pIn) ){` |
|       3 |  5597 | `				bReadonly = 1;` |
|       3 |  5598 | `				pIn++;` |
|       1 |  5599 | `			}` |
|  130757 |  5600 | `			if( pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD) ){` |
|   59665 |  5601 | `				sxu32 nKw = (sxu32)SX_PTR_TO_INT(pIn->pUserData);` |
|   59665 |  5602 | `				if( nKw == PH7_TKWRD_PUBLIC \|\| nKw == PH7_TKWRD_PROTECTED \|\| nKw == PH7_TKWRD_PRIVATE ){` |
|      65 |  5603 | `					bVisSeen = 1;` |
...
|      30 |  5612 | `				}` |
|   29830 |  5613 | `			}` |
|  130757 |  5614 | `			if( bVisSeen \|\| bReadonly ){` |
|      67 |  5615 | `				if( !bCtorCtx ){` |
...
|  165566 |  5636 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_DOLLAR) == 0` |
|  101857 |  5637 | `			&& (pIn->nType & PH7_TK_AMPER) == 0` |
|   71306 |  5638 | `			&& (pIn->nType & PH7_TK_ELLIPSIS) == 0 ){` |
|   69619 |  5639 | `			sxu32 nLineLocal = pIn->nLine;` |
|   69619 |  5640 | `			sxi32 iTFlags = 0;` |
|   69619 |  5641 | `			pGen->pIn = pIn;` |
|   69619 |  5642 | `			rc = GenStateParseUnionTypeDecl(` |
|   34807 |  5643 | `				pGen, &sArg.nType, &sArg.sClass, &sArg.aUnionAlts,` |
|   34807 |  5644 | `				&iTFlags, &sArg.sTypeName,` |
|       - |  5645 | `				VM_FUNC_ARG_NULLABLE, VM_FUNC_ARG_UNION,` |
|       - |  5646 | `				/* bAllowVoid */ 0,` |
|   34807 |  5647 | `						nLineLocal);` |
|   69619 |  5648 | `			pIn = pGen->pIn;` |
|   69619 |  5649 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  5650 | `				return SXERR_ABORT;` |
|   69619 |  5651 | `			}else if( rc == SXERR_CORRUPT ){` |
|       - |  5652 | `				/* Error already reported by GenStateParseUnionTypeDecl */` |
|       3 |  5653 | `				return SXERR_SYNTAX;` |
|   69617 |  5654 | `			}else if( rc == SXERR_SYNTAX ){` |
|       6 |  5655 | `				if( pIn < pEnd ){` |
...
|       - |  5664 | `			}` |
|   69613 |  5665 | `			sArg.iFlags \|= iTFlags;` |
|   34804 |  5666 | `		}` |
|  130747 |  5667 | `		if( pIn >= pEnd ){` |
|     ! 0 |  5668 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Missing argument name");` |
|     ! 0 |  5669 | `			return rc;` |
|       - |  5670 | `		}` |
|  130747 |  5671 | `		if( pIn->nType & PH7_TK_AMPER ){` |
|       - |  5672 | `			/* Pass by reference,record that */` |
|    3337 |  5673 | `			sArg.iFlags \|= VM_FUNC_ARG_BY_REF;` |
|    3337 |  5674 | `			pIn++;` |
|    1666 |  5675 | `		}` |
|  130747 |  5676 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_ELLIPSIS) ){` |
|       - |  5677 | `			/* Variadic parameter: ...$args */` |
|      47 |  5678 | `			sArg.iFlags \|= VM_FUNC_ARG_VARIADIC;` |
|      47 |  5679 | `			pIn++;` |
|      21 |  5680 | `		}` |
|  130747 |  5681 | `		if( pIn >= pEnd \|\| (pIn->nType & PH7_TK_DOLLAR) == 0 \|\| &pIn[1] >= pEnd \|\| (pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|       - |  5682 | `			/* Invalid argument */` |
|     ! 0 |  5683 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Invalid argument name");` |
|     ! 0 |  5684 | `			return rc;` |
|       - |  5685 | `		}` |
|  130747 |  5686 | `		pIn++; /* Jump the dollar sign */` |
|       - |  5687 | `		/* Copy argument name */` |
|  130747 |  5688 | `		zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,SyStringData(&pIn->sData),SyStringLength(&pIn->sData));` |
|  130747 |  5689 | `		if( zDup == 0 ){` |
|     ! 0 |  5690 | `			PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"PH7 engine is running out of memory");` |
|     ! 0 |  5691 | `			return SXERR_ABORT;` |
|       - |  5692 | `		}` |
|  130747 |  5693 | `		SyStringInitFromBuf(&sArg.sName,zDup,SyStringLength(&pIn->sData));` |
|  130747 |  5694 | `		pIn++;` |
|  130747 |  5695 | `		if( pIn < pEnd ){` |
|   73449 |  5696 | `			if( pIn->nType & PH7_TK_EQUAL ){` |
|       - |  5697 | `				SyToken *pDefend;` |
|   62817 |  5698 | `				sxi32 iNest = 0;` |
|   62817 |  5699 | `				pIn++; /* Jump the equal sign */` |
|   62817 |  5700 | `				pDefend = pIn;` |
|       - |  5701 | `				/* Process the default value associated with this argument */` |
|  132235 |  5702 | `				while( pDefend < pEnd ){` |
|  102471 |  5703 | `					if( (pDefend->nType & PH7_TK_COMMA) && iNest <= 0 ){` |
|   33053 |  5704 | `						break;` |
|       - |  5705 | `					}` |
|   69423 |  5706 | `					if( pDefend->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*[*/) ){` |
|       - |  5707 | `						/* Increment nesting level */` |
|    3309 |  5708 | `						iNest++;` |
|   67771 |  5709 | `					}else if( pDefend->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CCB/*'}'*/\|PH7_TK_CSB/*]*/) ){` |
|       - |  5710 | `						/* Decrement nesting level */` |
|    3309 |  5711 | `						iNest--;` |
|    1652 |  5712 | `					}` |
|   69423 |  5713 | `					pDefend++;` |
|       5 |  5714 | `				}` |
|   62817 |  5715 | `				if( pIn >= pDefend ){` |
|       3 |  5716 | `					rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Missing argument default value");` |
|       3 |  5717 | `					return rc;` |
|       - |  5718 | `				}` |
|       - |  5719 | `				/* Process default value */` |
|   62815 |  5720 | `				rc = GenStateProcessArgValue(&(*pGen),&sArg,pIn,pDefend);` |
|   62815 |  5721 | `				if( rc != SXRET_OK ){` |
|     ! 0 |  5722 | `					return rc;` |
|       - |  5723 | `				}` |
|       - |  5724 | `				/* Point beyond the default value */` |
|   62815 |  5725 | `				pIn = pDefend;` |
|   31405 |  5726 | `			}` |
|   73447 |  5727 | `			if( pIn < pEnd && (pIn->nType & PH7_TK_COMMA) == 0 ){` |
|     ! 0 |  5728 | `				rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Unexpected token '%z'",&pIn->sData);` |
|     ! 0 |  5729 | `				return rc;` |
|       - |  5730 | `			}` |
|   73447 |  5731 | `			pIn++; /* Jump the trailing comma */` |
|   36721 |  5732 | `		}` |
|       - |  5733 | `		/* Append argument signature */` |
|  130745 |  5734 | `		if( sArg.nType > 0 ){` |
|   69569 |  5735 | `			if( SyStringLength(&sArg.sClass) > 0 ){` |
|       - |  5736 | `				/* Class name — prefix with 'o' so generic object hint is a prefix match */` |
|    9939 |  5737 | `				int marker = 'o';` |
|    9939 |  5738 | `				SyBlobAppend(&sSig,(const void *)&marker,sizeof(char));` |
|    9939 |  5739 | `				SyBlobAppend(&sSig,SyStringData(&sArg.sClass),SyStringLength(&sArg.sClass));` |
|    4972 |  5740 | `			}else{` |
|       - |  5741 | `				int c;` |
|   59635 |  5742 | `				c = 'n'; /* cc warning */` |
|       - |  5743 | `				/* Type leading character */` |
|   59635 |  5744 | `				switch(sArg.nType){` |
|     ! 0 |  5745 | `				case MEMOBJ_HASHMAP:` |
|       - |  5746 | `					/* Hashmap aka 'array' */` |
|     ! 0 |  5747 | `					c = 'h';` |
|     ! 0 |  5748 | `					break;` |
|    8305 |  5749 | `				case MEMOBJ_INT:` |
|       - |  5750 | `					/* Integer */` |
|   16615 |  5751 | `					c = 'i';` |
|   16615 |  5752 | `					break;` |
...
|       2 |  5770 | `					break;` |
|       - |  5771 | `				}` |
|   59635 |  5772 | `				SyBlobAppend(&sSig,(const void *)&c,sizeof(char));` |
|       - |  5773 | `			}` |
|   34787 |  5774 | `		}else{` |
|       - |  5775 | `			/* No type is associated with this parameter which mean` |
|       - |  5776 | `			 * that this function is not condidate for overloading.` |
|       - |  5777 | `			 */` |
|   61181 |  5778 | `			SyBlobRelease(&sSig);` |
|       - |  5779 | `		}` |
|       - |  5780 | `		/* Save in the argument set */` |
|  130745 |  5781 | `		SySetPut(&pFunc->aArgs,(const void *)&sArg);` |
|       5 |  5782 | `	}` |
|   87071 |  5783 | `	if( SyBlobLength(&sSig) > 0 ){` |
|       - |  5784 | `		/* Save function signature */` |
|   43105 |  5785 | `		SyStringInitFromBuf(&pFunc->sSignature,SyBlobData(&sSig),SyBlobLength(&sSig));` |
|   21550 |  5786 | `	}` |
|   87071 |  5787 | `	return SXRET_OK;` |
|   43544 |  5788 |  |
|       - |  5789 | `/*` |
...
|       - |  5793 | ` */` |
|  206766 |  5794 | `static sxi32 GenStateCompileFuncBody(` |
...
|  206771 |  5804 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC,PH7_VmInstrLength(pGen->pVm),pFunc,&pBlock);` |
|  206771 |  5805 | `	if( rc != SXRET_OK ){` |
...
|       - |  5809 | `	}` |
|  206771 |  5810 | `	nGotoOfft = SySetUsed(&pGen->aGoto);` |
|       - |  5811 | `	/* Swap bytecode containers */` |
|  206771 |  5812 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|  206771 |  5813 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pFunc->aByteCode);` |
...
|       - |  5818 | `	{` |
|  206771 |  5819 | `		sxu32 nArg = SySetUsed(&pFunc->aArgs);` |
|       - |  5820 | `		sxu32 i;` |
|  310955 |  5821 | `		for( i = 0; i < nArg; i++ ){` |
|  104189 |  5822 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pFunc->aArgs,i);` |
|       - |  5823 | `			char *zSrc;` |
|       - |  5824 | `			sxu32 nSrc,nName;` |
|       - |  5825 | `			SySet sToken;` |
|       - |  5826 | `			SyToken *pTmpIn,*pTmpEnd;` |
|       - |  5827 | `			sxi32 rcPromote;` |
|  104189 |  5828 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|  104141 |  5829 | `				continue;` |
|       - |  5830 | `			}` |
...
|  206771 |  5877 | `	PH7_CompileBlock(&(*pGen),0);` |
|       - |  5878 | `	/* Fix exception jumps now the destination is resolved */` |
|  206771 |  5879 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|       - |  5880 | `	/* Emit the final return if not yet done */` |
|  206771 |  5881 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|       - |  5882 | `	/* Fix gotos jumps now the destination is resolved */` |
|  206771 |  5883 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),nGotoOfft) ){` |
|     ! 0 |  5884 | `		rc = SXERR_ABORT;` |
|     ! 0 |  5885 | `	}` |
|  206771 |  5886 | `	SySetTruncate(&pGen->aGoto,nGotoOfft);` |
|       - |  5887 | `	/* Restore the default container */` |
|  206771 |  5888 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|       - |  5889 | `	/* Leave function block */` |
|  206771 |  5890 | `	GenStateLeaveBlock(&(*pGen),0);` |
|  206771 |  5891 | `	if( rc == SXERR_ABORT ){` |
...
|       - |  5896 | `	{` |
|  206771 |  5897 | `		VmInstr *aInstr = (VmInstr *)SySetBasePtr(&pFunc->aByteCode);` |
|       - |  5898 | `		sxu32 i;` |
| 4038601 |  5899 | `		for( i = 0; i < SySetUsed(&pFunc->aByteCode); i++ ){` |
| 3831871 |  5900 | `			if( aInstr[i].iOp == PH7_OP_YIELD ){` |
...
|       - |  5971 | ` */` |
|   70254 |  5972 | `static sxi32 GenStateParseOneTypeAtom(ph7_gen_state *pGen, PhlTypeAtom *pOut)` |
|       5 |  5973 |  |
|   70259 |  5974 | `	SyToken *pIn = pGen->pIn;` |
|   70259 |  5975 | `	SyZero(pOut, sizeof(*pOut));` |
|   70259 |  5976 | `	SyStringInitFromBuf(&pOut->sClass, 0, 0);` |
|   70259 |  5977 | `	if( pIn >= pGen->pEnd ){` |
|     ! 0 |  5978 | `		return SXERR_SYNTAX;` |
|       - |  5979 | `	}` |
|       - |  5980 | `	/* Optional leading namespace separator '\' on FQN class types */` |
|   70259 |  5981 | `	if( pIn->nType & PH7_TK_NSSEP ){` |
|       8 |  5982 | `		pIn++;` |
|       8 |  5983 | `		if( pIn >= pGen->pEnd ){` |
|     ! 0 |  5984 | `			return SXERR_SYNTAX;` |
|       - |  5985 | `		}` |
|       3 |  5986 | `	}` |
|   70259 |  5987 | `	if( (pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|     ! 0 |  5988 | `		return SXERR_SYNTAX;` |
|       - |  5989 | `	}` |
|   70259 |  5990 | `	if( pIn->nType & PH7_TK_KEYWORD ){` |
|   60099 |  5991 | `		sxu32 nKey = (sxu32)(SX_PTR_TO_INT(pIn->pUserData));` |
|   60099 |  5992 | `		if( nKey & PH7_TKWRD_ARRAY ){` |
|      20 |  5993 | `			pOut->nType = MEMOBJ_HASHMAP; pOut->zCanon = "array"; pOut->nCanon = 5;` |
|   60091 |  5994 | `		}else if( nKey & PH7_TKWRD_BOOL ){` |
|      61 |  5995 | `			pOut->nType = MEMOBJ_BOOL; pOut->zCanon = "bool"; pOut->nCanon = 4;` |
|   60055 |  5996 | `		}else if( nKey & PH7_TKWRD_INT ){` |
|   16837 |  5997 | `			pOut->nType = MEMOBJ_INT; pOut->zCanon = "int"; pOut->nCanon = 3;` |
|   51611 |  5998 | `		}else if( nKey & PH7_TKWRD_STRING ){` |
|   43137 |  5999 | `			pOut->nType = MEMOBJ_STRING; pOut->zCanon = "string"; pOut->nCanon = 6;` |
|   21629 |  6000 | `		}else if( nKey & PH7_TKWRD_FLOAT ){` |
...
|   10165 |  6015 | `		SyString *pT = &pIn->sData;` |
|   10165 |  6016 | `		if( pT->nByte == 4 && SyMemcmpNoCase(pT->zString, "null", 4) == 0 ){` |
|      18 |  6017 | `			pOut->nType = UTA_NULL_FLAG; pOut->zCanon = "null"; pOut->nCanon = 4;` |
|      18 |  6018 | `			pIn++;` |
|   10157 |  6019 | `		}else if( pT->nByte == 4 && SyMemcmpNoCase(pT->zString, "void", 4) == 0 ){` |
|     117 |  6020 | `			pOut->nType = UTA_VOID_FLAG; pOut->zCanon = "void"; pOut->nCanon = 4;` |
|     117 |  6021 | `			pIn++;` |
|   10093 |  6022 | `		}else if( pT->nByte == 5 && SyMemcmpNoCase(pT->zString, "never", 5) == 0 ){` |
|       3 |  6023 | `			pOut->nType = UTA_NEVER_FLAG; pOut->zCanon = "never"; pOut->nCanon = 5;` |
|       3 |  6024 | `			pIn++;` |
|       2 |  6025 | `		}else{` |
|       - |  6026 | `			/* Class / interface name; consume namespace path a\b\c */` |
|   10035 |  6027 | `			SyToken *pFirst = pIn;` |
|   10035 |  6028 | `			SyToken *pLast = pIn;` |
|   10035 |  6029 | `			pOut->nType = SXU32_HIGH;` |
|   10035 |  6030 | `			pOut->sClass = pIn->sData;` |
|   10035 |  6031 | `			pIn++;` |
|   15048 |  6032 | `			while( pIn + 1 < pGen->pEnd && (pIn->nType & PH7_TK_NSSEP)` |
|   10038 |  6033 | `				&& (pIn[1].nType & PH7_TK_ID) ){` |
|       3 |  6034 | `				pLast = &pIn[1];` |
|       3 |  6035 | `				pIn += 2;` |
|       1 |  6036 | `			}` |
|   10035 |  6037 | `			if( pLast != pFirst ){` |
...
|       - |  6043 | `		}` |
|       - |  6044 | `	}` |
|   70257 |  6045 | `	pGen->pIn = pIn;` |
|   70257 |  6046 | `	return SXRET_OK;` |
|   35132 |  6047 |  |
|       - |  6048 |  |
|       - |  6049 | `/*` |
...
|       - |  6055 | ` */` |
|   70150 |  6056 | `static void GenBuildUnionTypeText(SyBlob *pBlob, PhlTypeAtom *aAtoms, int nAtoms, int bNullable)` |
|       5 |  6057 |  |
|       - |  6058 | `	int i;` |
|   70155 |  6059 | `	int nNonNull = 0;` |
|  140393 |  6060 | `	for( i = 0; i < nAtoms; i++ ){` |
|   70243 |  6061 | `		if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|   70227 |  6062 | `			nNonNull++;` |
|   35111 |  6063 | `		}` |
|   35124 |  6064 | `	}` |
|   70155 |  6065 | `	if( nNonNull == 1 && bNullable ){` |
|       - |  6066 | `		/* Shorthand: ?T */` |
...
|     ! 0 |  6077 | `	}` |
|       - |  6078 | `	{` |
|   70093 |  6079 | `		int bFirst = 1;` |
|       - |  6080 | `		/* 1) Classes in declaration order */` |
|  140263 |  6081 | `		for( i = 0; i < nAtoms; i++ ){` |
|   70175 |  6082 | `			if( aAtoms[i].nType == SXU32_HIGH ){` |
|   10027 |  6083 | `				if( !bFirst ) SyBlobAppend(pBlob, "\|", 1);` |
|   10027 |  6084 | `				SyBlobAppend(pBlob, aAtoms[i].sClass.zString, aAtoms[i].sClass.nByte);` |
|   10027 |  6085 | `				bFirst = 0;` |
|    5011 |  6086 | `			}` |
|   35090 |  6087 | `		}` |
...
|       - |  6092 | `			int k;` |
|  490621 |  6093 | `			for( k = 0; k < (int)(sizeof(aOrder)/sizeof(aOrder[0])); k++ ){` |
|  781429 |  6094 | `				for( i = 0; i < nAtoms; i++ ){` |
|  420929 |  6095 | `					if( aAtoms[i].nType == aOrder[k] ){` |
|   60033 |  6096 | `						if( !bFirst ) SyBlobAppend(pBlob, "\|", 1);` |
|   60033 |  6097 | `						SyBlobAppend(pBlob, aAtoms[i].zCanon, aAtoms[i].nCanon);` |
|   60033 |  6098 | `						bFirst = 0;` |
|   60033 |  6099 | `						break;` |
|       - |  6100 | `					}` |
|  180453 |  6101 | `				}` |
...
|       - |  6129 | ` */` |
|   70160 |  6130 | `static sxi32 GenStateParseUnionTypeDecl(` |
...
|   70165 |  6143 | `	int nAtoms = 0;` |
|   70165 |  6144 | `	int bShortNullable = 0;` |
|   70165 |  6145 | `	int bExplicitNull = 0;` |
|       - |  6146 | `	sxi32 rc;` |
|   70165 |  6147 | `	*pnType = 0;` |
|   70165 |  6148 | `	if( pClass ) SyStringInitFromBuf(pClass, 0, 0);` |
|   70165 |  6149 | `	*piTypeFlags = 0;` |
|   70165 |  6150 | `	if( pTypeText ) SyStringInitFromBuf(pTypeText, 0, 0);` |
|       - |  6151 |  |
|   70165 |  6152 | `	if( pGen->pIn >= pGen->pEnd ){` |
|     ! 0 |  6153 | `		return SXRET_OK;` |
|       - |  6154 | `	}` |
|       - |  6155 | ``	/* Optional `?` shorthand prefix */`` |
|   70160 |  6156 | `	if( (pGen->pIn->nType & PH7_TK_OP) && pGen->pIn->sData.nByte == 1` |
...
|   70165 |  6165 | `	rc = GenStateParseOneTypeAtom(pGen, &aAtoms[0]);` |
|   70165 |  6166 | `	if( rc != SXRET_OK ){` |
|       3 |  6167 | `		return rc;` |
|       - |  6168 | `	}` |
|   70163 |  6169 | `	nAtoms = 1;` |
|       - |  6170 | ``	/* Subsequent atoms separated by `\|` */`` |
|  105380 |  6171 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OP)` |
|   70306 |  6172 | `		&& pGen->pIn->sData.nByte == 1 && pGen->pIn->sData.zString[0] == '\|' ){` |
...
|       - |  6199 | `	{` |
|       - |  6200 | `		int i, j;` |
|   70161 |  6201 | `		int bHasNonNull = 0;` |
|  140405 |  6202 | `		for( i = 0; i < nAtoms; i++ ){` |
|   70255 |  6203 | `			if( aAtoms[i].nType == UTA_VOID_FLAG ){` |
...
|       - |  6218 | `				}` |
|      55 |  6219 | `			}` |
|   70253 |  6220 | `			if( aAtoms[i].nType == UTA_NEVER_FLAG ){` |
...
|       - |  6234 | `			}` |
|   70251 |  6235 | `			if( aAtoms[i].nType == UTA_NULL_FLAG ){` |
|      18 |  6236 | `				bExplicitNull = 1;` |
|      10 |  6237 | `			}else{` |
|   70235 |  6238 | `				bHasNonNull = 1;` |
|       - |  6239 | `			}` |
|       - |  6240 | `			/* Duplicate detection */` |
|   70375 |  6241 | `			for( j = 0; j < i; j++ ){` |
|     131 |  6242 | `				int bDup = 0;` |
...
|      67 |  6269 | `			}` |
|   35127 |  6270 | `		}` |
|   70155 |  6271 | `		if( !bHasNonNull && bExplicitNull ){` |
...
|   70155 |  6286 | `	if( bShortNullable \|\| bExplicitNull ){` |
|      76 |  6287 | `		*piTypeFlags \|= iNullableFlag;` |
|      36 |  6288 | `	}` |
|       - |  6289 | `	/* Build canonical type text */` |
|   70155 |  6290 | `	if( pTypeText ){` |
|       - |  6291 | `		SyBlob sBlob;` |
|   70155 |  6292 | `		SyBlobInit(&sBlob, &pGen->pVm->sAllocator);` |
|  105202 |  6293 | `		GenBuildUnionTypeText(&sBlob, aAtoms, nAtoms,` |
|   35075 |  6294 | `			(bShortNullable \|\| bExplicitNull) ? 1 : 0);` |
|   70155 |  6295 | `		if( SyBlobLength(&sBlob) > 0 ){` |
|  105065 |  6296 | `			char *zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|   70040 |  6297 | `				(const char *)SyBlobData(&sBlob), SyBlobLength(&sBlob));` |
|   70045 |  6298 | `			if( zDup ){` |
|   70045 |  6299 | `				SyStringInitFromBuf(pTypeText, zDup, SyBlobLength(&sBlob));` |
|   35020 |  6300 | `			}` |
|   35020 |  6301 | `		}` |
|   70155 |  6302 | `		SyBlobRelease(&sBlob);` |
|   35075 |  6303 | `	}` |
...
|       - |  6307 | `	{` |
|   70155 |  6308 | `		int nNonNull = 0;` |
|   70155 |  6309 | `		int iNonNullIdx = -1;` |
|       - |  6310 | `		int i;` |
|  140393 |  6311 | `		for( i = 0; i < nAtoms; i++ ){` |
|   70243 |  6312 | `			if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|   70227 |  6313 | `				nNonNull++;` |
|   70227 |  6314 | `				iNonNullIdx = i;` |
|   35111 |  6315 | `			}` |
|   35124 |  6316 | `		}` |
|   70155 |  6317 | `		if( nNonNull <= 1 ){` |
|       - |  6318 | `			/* Fast path: store as single type. */` |
|   70093 |  6319 | `			if( iNonNullIdx >= 0 ){` |
|   70087 |  6320 | `				PhlTypeAtom *pA = &aAtoms[iNonNullIdx];` |
|   70087 |  6321 | `				if( pA->nType == SXU32_HIGH ){` |
|   15014 |  6322 | `					char *zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|    5003 |  6323 | `						pA->sClass.zString, pA->sClass.nByte);` |
|   10011 |  6324 | `					if( zDup == 0 ) return SXERR_ABORT;` |
|   10011 |  6325 | `					*pnType = SXU32_HIGH;` |
|   10011 |  6326 | `					if( pClass ) SyStringInitFromBuf(pClass, zDup, pA->sClass.nByte);` |
|   65084 |  6327 | `				}else if( pA->nType == UTA_VOID_FLAG ){` |
...
|       - |  6366 | ` */` |
|  292850 |  6367 | `static sxi32 GenStateParseReturnType(ph7_gen_state *pGen, ph7_vm_func *pFunc)` |
|       5 |  6368 |  |
|  292855 |  6369 | `	sxi32 iFlags = 0;` |
|       - |  6370 | `	sxi32 rc;` |
|       - |  6371 | `	sxu32 nLine;` |
|  292855 |  6372 | `	pFunc->nReturnType = 0;` |
|  292855 |  6373 | `	SyStringInitFromBuf(&pFunc->sReturnClass, 0, 0);` |
|  292855 |  6374 | `	SyStringInitFromBuf(&pFunc->sReturnTypeName, 0, 0);` |
|  292855 |  6375 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COLON) == 0 ){` |
|  292507 |  6376 | `		return SXRET_OK;` |
|       - |  6377 | `	}` |
...
|  146430 |  6414 |  |
|       - |  6415 |  |
|   44030 |  6416 | `static sxi32 GenStateCompileFunc(` |
...
|   44035 |  6430 | `	nLine = pGen->pIn->nLine;` |
|       - |  6431 | `	/* Jump the left parenthesis '(' */` |
|   44035 |  6432 | `	pGen->pIn++;` |
|       - |  6433 | `	/* Delimit the function signature */` |
|   44035 |  6434 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   44035 |  6435 | `	if( pEnd >= pGen->pEnd ){` |
|       - |  6436 | `		/* Syntax error */` |
...
|   44029 |  6446 | `	pFunc = (ph7_vm_func *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_vm_func));` |
|   44029 |  6447 | `	if( pFunc == 0 ){` |
|     ! 0 |  6448 | `		goto OutOfMem;` |
|       - |  6449 | `	}` |
|       - |  6450 | `	/* Build the function name, prepending namespace if active */` |
|   44036 |  6451 | `	if( SyBlobLength(&pGen->sNamespace) > 0 && !bHandleClosure ){` |
|       - |  6452 | `		SyBlob sFQN;` |
|       - |  6453 | `		sxu32 nLen;` |
...
|       9 |  6465 | `	}else{` |
|   44015 |  6466 | `		zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|   44015 |  6467 | `		if( zName == 0 ){` |
|     ! 0 |  6468 | `			goto OutOfMem;` |
|       - |  6469 | `		}` |
|   44015 |  6470 | `		PH7_VmInitFuncState(pGen->pVm,pFunc,zName,pName->nByte,iFlags,0);` |
|       - |  6471 | `	}` |
|   44029 |  6472 | `	if( pGen->pIn < pEnd ){` |
|       - |  6473 | `		/* Collect function arguments */` |
|   30475 |  6474 | `		rc = GenStateCollectFuncArgs(pFunc,&(*pGen),pEnd,0,0);` |
|   30475 |  6475 | `		if( rc == SXERR_ABORT ){` |
...
|   44029 |  6481 | `	pGen->pIn = &pEnd[1];` |
|       - |  6482 | `	{` |
|   44029 |  6483 | `		sxi32 rcRt = GenStateParseReturnType(pGen, pFunc);` |
|   44029 |  6484 | `		if( rcRt == SXERR_ABORT ){` |
|     ! 0 |  6485 | `			return SXERR_ABORT;` |
|   44029 |  6486 | `		}else if( rcRt == SXERR_SYNTAX ){` |
|       5 |  6487 | `			return SXERR_SYNTAX;` |
|       - |  6488 | `		}` |
|       - |  6489 | `	}` |
|   44025 |  6490 | `	if( bHandleClosure ){` |
...
|   44025 |  6583 | `	rc = GenStateCompileFuncBody(&(*pGen),pFunc);` |
|   44025 |  6584 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  6585 | `		return SXERR_ABORT;` |
|       - |  6586 | `	}` |
|   44025 |  6587 | `	if( ppFunc ){` |
|     251 |  6588 | `		*ppFunc = pFunc;` |
|     123 |  6589 | `	}` |
|   44025 |  6590 | `	rc = SXRET_OK;` |
|   44025 |  6591 | `	if( (pFunc->iFlags & VM_FUNC_CLOSURE) == 0 ){` |
|       - |  6592 | `		/* Finally register the function */` |
|   44009 |  6593 | `		rc = PH7_VmInstallUserFunction(pGen->pVm,pFunc,0);` |
|   22002 |  6594 | `	}` |
|   44025 |  6595 | `	if( rc == SXRET_OK ){` |
|   44025 |  6596 | `		return SXRET_OK;` |
|       - |  6597 | `	}` |
...
|       - |  6609 | ` */` |
|   43792 |  6610 | `static sxi32 PH7_CompileFunction(ph7_gen_state *pGen)` |
|       5 |  6611 |  |
|       - |  6612 | `	SyString *pName;` |
|       - |  6613 | `	sxi32 iFlags;` |
|       - |  6614 | `	sxu32 nLine;` |
|       - |  6615 | `	sxi32 rc;` |
|       - |  6616 |  |
|   43797 |  6617 | `	nLine = pGen->pIn->nLine;` |
|   43797 |  6618 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|   43797 |  6619 | `	iFlags = 0;` |
|   43797 |  6620 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|       - |  6621 | `		/* Return by reference,remember that */` |
|       7 |  6622 | `		iFlags \|= VM_FUNC_REF_RETURN;` |
|       - |  6623 | `		/* Jump the '&' token */` |
|       7 |  6624 | `		pGen->pIn++;` |
|       3 |  6625 | `	}` |
|   43797 |  6626 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|       - |  6637 | `	}` |
|   43791 |  6638 | `	pName = &pGen->pIn->sData;` |
|   43791 |  6639 | `	nLine = pGen->pIn->nLine;` |
|       - |  6640 | `	/* Jump the function name */` |
|   43791 |  6641 | `	pGen->pIn++;` |
|   43791 |  6642 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  6643 | `		/* Syntax error */` |
...
|   43789 |  6656 | `	rc = GenStateCompileFunc(&(*pGen),pName,iFlags,FALSE,0);` |
|   43789 |  6657 | `	return rc;` |
|   21901 |  6658 |  |
|       - |  6659 | `/*` |
...
|       - |  6669 | ` */` |
|  312116 |  6670 | `static sxi32 GetProtectionLevel(sxi32 nKeyword)` |
|       5 |  6671 |  |
|  312121 |  6672 | `	if( nKeyword == PH7_TKWRD_PRIVATE ){` |
|   10001 |  6673 | `		return PH7_CLASS_PROT_PRIVATE;` |
|  302125 |  6674 | `	}else if( nKeyword == PH7_TKWRD_PROTECTED ){` |
|   43001 |  6675 | `		return PH7_CLASS_PROT_PROTECTED;` |
|       - |  6676 | `	}` |
|       - |  6677 | `	/* Assume public by default */` |
|  259129 |  6678 | `	return PH7_CLASS_PROT_PUBLIC;` |
|  156063 |  6679 |  |
|       - |  6680 | `/*` |
...
|       - |  6942 | ` */` |
|  162898 |  6943 | `static int GenStateLooksLikeTypedProperty(SyToken *pStart,SyToken *pEnd)` |
|       5 |  6944 |  |
|  162903 |  6945 | `	SyToken *p = pStart;` |
|  162903 |  6946 | `	if( p >= pEnd ) return 0;` |
|  162903 |  6947 | `	if( (p->nType & PH7_TK_OP) && p->sData.nByte == 1 && p->sData.zString[0] == '?' ){` |
|      18 |  6948 | `		p++;` |
|      18 |  6949 | `		if( p >= pEnd ) return 0;` |
|       8 |  6950 | `	}` |
|  162903 |  6951 | `	if( p->nType & PH7_TK_NSSEP ){` |
|       3 |  6952 | `		p++;` |
|       3 |  6953 | `		if( p >= pEnd ) return 0;` |
|       1 |  6954 | `	}` |
|  162903 |  6955 | `	if( (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|     ! 0 |  6956 | `		return 0;` |
|       - |  6957 | `	}` |
...
|       - |  6961 | `	 * dispatch site. */` |
|  162903 |  6962 | `	if( p->nType & PH7_TK_KEYWORD ){` |
|  162881 |  6963 | `		sxu32 k = (sxu32)(SX_PTR_TO_INT(p->pUserData));` |
|  162950 |  6964 | `		if( k == PH7_TKWRD_FUNCTION \|\| k == PH7_TKWRD_VAR \|\| k == PH7_TKWRD_CONST` |
|    3514 |  6965 | `		 \|\| k == PH7_TKWRD_STATIC \|\| k == PH7_TKWRD_FINAL \|\| k == PH7_TKWRD_ABSTRACT ){` |
|  162733 |  6966 | `			return 0;` |
|       - |  6967 | `		}` |
|      74 |  6968 | `	}` |
|     175 |  6969 | `	p++;` |
...
|       - |  7139 | ` */` |
| 1473232 |  7140 | `static int GenStateIsReadonly(SyToken *pTok)` |
|       5 |  7141 |  |
| 1502828 |  7142 | `	return (pTok->nType & PH7_TK_ID)` |
|  766207 |  7143 | `		&& pTok->sData.nByte == sizeof("readonly")-1` |
| 1502823 |  7144 | `		&& SyStrnicmp(pTok->sData.zString,"readonly",sizeof("readonly")-1) == 0;` |
|       5 |  7145 |  |
|   63326 |  7146 | `static sxi32 GenStateCompileClassAttr(ph7_gen_state *pGen,sxi32 iProtection,sxi32 iFlags,ph7_class *pClass)` |
|       5 |  7147 |  |
|   63331 |  7148 | `	sxu32 nLine = pGen->pIn->nLine;` |
|       - |  7149 | `	ph7_class_attr *pAttr;` |
|       - |  7150 | `	SyString *pName;` |
|       - |  7151 | `	sxi32 rc;` |
|   63331 |  7152 | `	sxu32 nType = 0;` |
|       - |  7153 | `	SyString sTypeClass;` |
|       - |  7154 | `	SyString sTypeText;` |
|       - |  7155 | `	SySet aUnionAlts;` |
|   63331 |  7156 | `	sxi32 iTypeFlags = 0;` |
|   63331 |  7157 | `	SyStringInitFromBuf(&sTypeClass,0,0);` |
|   63331 |  7158 | `	SyStringInitFromBuf(&sTypeText,0,0);` |
|   63331 |  7159 | `	SySetInit(&aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
...
|   63331 |  7163 | `	if( pClass->iFlags & PH7_CLASS_READONLY ){` |
|      21 |  7164 | `		iFlags \|= PH7_CLASS_ATTR_READONLY;` |
|       9 |  7165 | `	}` |
|       - |  7166 | `	/* Extract visibility level */` |
|   63331 |  7167 | `	iProtection = GetProtectionLevel(iProtection);` |
|       - |  7168 | `	/* Parse optional type hint (typed properties, PHP 7.4+) */` |
|   63416 |  7169 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
...
|      85 |  7185 | `	}` |
|     ! 0 |  7186 | `loop:` |
|   63335 |  7187 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
...
|       - |  7193 | `	}` |
|   63335 |  7194 | `	pGen->pIn++; /* Jump the dollar sign */` |
|   63335 |  7195 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_ID)) == 0 ){` |
...
|   63335 |  7205 | `	pName = &pGen->pIn->sData;` |
|       - |  7206 | `	/* Advance the stream cursor */` |
|   63335 |  7207 | `	pGen->pIn++;` |
|   63335 |  7208 | `	if(pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_EQUAL/*'='*/\|PH7_TK_SEMI/*';'*/\|PH7_TK_COMMA/*','*/)) == 0 ){` |
...
|   63333 |  7219 | `	if( iFlags & PH7_CLASS_ATTR_READONLY ){` |
...
|   63323 |  7239 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
...
|   63323 |  7251 | `	if( PH7_ClassExtractAttribute(pClass,pName->zString,pName->nByte) != 0 ){` |
...
|   63321 |  7260 | `	pAttr = PH7_NewClassAttr(pGen->pVm,pName,nLine,iProtection,iFlags\|iTypeFlags);` |
|   63321 |  7261 | `	if( pAttr == 0 ){` |
|     ! 0 |  7262 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 engine is running out of memory");` |
|     ! 0 |  7263 | `		return SXERR_ABORT;` |
|       - |  7264 | `	}` |
|   63321 |  7265 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|     171 |  7266 | `		GenStateCopyTypeToAttr(pAttr,nType,&sTypeClass,&sTypeText,iTypeFlags,&aUnionAlts);` |
|      83 |  7267 | `	}` |
|   63321 |  7268 | `	if( pGen->pIn->nType & PH7_TK_EQUAL /*'='*/ ){` |
|       - |  7269 | `		SySet *pInstrContainer;` |
|   20225 |  7270 | `		pGen->pIn++; /*Jump the equal sign */` |
|       - |  7271 | `		/* Swap bytecode container */` |
|   20225 |  7272 | `		pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   20225 |  7273 | `		PH7_VmSetByteCodeContainer(pGen->pVm,&pAttr->aByteCode);` |
|       - |  7274 | `		/* Compile attribute value.` |
|       - |  7275 | `		 */` |
|   20225 |  7276 | `		rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|   20225 |  7277 | `		if( rc == SXERR_EMPTY ){` |
...
|   20225 |  7284 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|   20225 |  7285 | `		PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|   10110 |  7286 | `	}` |
|       - |  7287 | `	/* All done,install the attribute */` |
|   63321 |  7288 | `	rc = PH7_ClassInstallAttr(pClass,pAttr);` |
|   63321 |  7289 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  7290 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|     ! 0 |  7291 | `		return SXERR_ABORT;` |
|       - |  7292 | `	}` |
|   63321 |  7293 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA /*','*/) ){` |
...
|       - |  7311 | `		}` |
|     ! 0 |  7312 | `	}` |
|   63317 |  7313 | `	SySetRelease(&aUnionAlts);` |
|   63317 |  7314 | `	return SXRET_OK;` |
|       7 |  7315 | `Synchronize:` |
...
|       - |  7330 | ` */` |
|  248714 |  7331 | `static sxi32 GenStateCompileClassMethod(` |
...
|       - |  7337 | `	)` |
|       5 |  7338 |  |
|  248719 |  7339 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|  248719 |  7346 | `	iProtection = GetProtectionLevel(iProtection);` |
|  248719 |  7347 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|  248719 |  7348 | `	iFuncFlags = 0;` |
|  248719 |  7349 | `	if( pGen->pIn >= pGen->pEnd ){` |
...
|       - |  7357 | `	}` |
|  248719 |  7358 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|       - |  7359 | `		/* Return by reference,remember that */` |
|     ! 0 |  7360 | `		iFuncFlags \|= VM_FUNC_REF_RETURN;` |
|       - |  7361 | `		/* Jump the '&' token */` |
|     ! 0 |  7362 | `		pGen->pIn++;` |
|     ! 0 |  7363 | `	}` |
|  248719 |  7364 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|  248719 |  7373 | `	pName = &pGen->pIn->sData;` |
|  248719 |  7374 | `	nLine = pGen->pIn->nLine;` |
|       - |  7375 | `	/* Jump the method name */` |
|  248719 |  7376 | `	pGen->pIn++;` |
|  248719 |  7377 | `	if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|       - |  7378 | `		/* Abstract method */` |
|   85961 |  7379 | `		if( iProtection == PH7_CLASS_PROT_PRIVATE ){` |
...
|   85961 |  7388 | `		doBody = FALSE;` |
|   42978 |  7389 | `	}` |
|  248719 |  7390 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  7391 | `		/* Syntax error */` |
...
|  248719 |  7400 | `	pMeth = PH7_NewClassMethod(pGen->pVm,pClass,pName,nLine,iProtection,iFlags,iFuncFlags);` |
|  248719 |  7401 | `	if( pMeth == 0 ){` |
...
|  248719 |  7406 | `	pGen->pIn++;` |
|  248719 |  7407 | `	pEnd = 0; /* cc warning */` |
|       - |  7408 | `	/* Delimit the method signature */` |
|  248719 |  7409 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|  248719 |  7410 | `	if( pEnd >= pGen->pEnd ){` |
|       - |  7411 | `		/* Syntax error */` |
...
|       - |  7418 | `	}` |
|       - |  7419 | `	{` |
|  248717 |  7420 | `		int bIsCtor = 0;` |
|  248717 |  7421 | `		int bAbstractCtor = 0;` |
|  363087 |  7422 | `		if( (pName->nByte == sizeof("__construct") - 1` |
|  147587 |  7423 | `				&& SyMemcmp(pName->zString,"__construct",sizeof("__construct") - 1) == 0)` |
|  238736 |  7424 | `		 \|\| SyStringCmp(pName,&pClass->sName,SyMemcmp) == 0 ){` |
|   19967 |  7425 | `			if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|       3 |  7426 | `				bAbstractCtor = 1;` |
|       2 |  7427 | `			}else{` |
|   19965 |  7428 | `				bIsCtor = 1;` |
|       - |  7429 | `			}` |
|    9981 |  7430 | `		}` |
|  248717 |  7431 | `		if( pGen->pIn < pEnd ){` |
|       - |  7432 | `			/* Collect method arguments */` |
|   56529 |  7433 | `			rc = GenStateCollectFuncArgs(&pMeth->sFunc,&(*pGen),pEnd,bIsCtor,bAbstractCtor);` |
|   56529 |  7434 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  7435 | `				return SXERR_ABORT;` |
|       - |  7436 | `			}` |
|   28262 |  7437 | `		}` |
|       - |  7438 | `	}` |
|       - |  7439 | `	/* Point past ')' and parse optional return type ': type' */` |
|  248717 |  7440 | `	pGen->pIn = &pEnd[1];` |
|       - |  7441 | `	{` |
|  248717 |  7442 | `		sxi32 rcRt = GenStateParseReturnType(pGen, &pMeth->sFunc);` |
|  248717 |  7443 | `		if( rcRt == SXERR_ABORT ){` |
|     ! 0 |  7444 | `			return SXERR_ABORT;` |
|  248717 |  7445 | `		}else if( rcRt == SXERR_SYNTAX ){` |
...
|       - |  7452 | `	{` |
|  248717 |  7453 | `		sxu32 nArg = SySetUsed(&pMeth->sFunc.aArgs);` |
|       - |  7454 | `		sxu32 i;` |
|  338379 |  7455 | `		for( i = 0; i < nArg; i++ ){` |
|   89677 |  7456 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pMeth->sFunc.aArgs,i);` |
|       - |  7457 | `			ph7_class_attr *pAttr;` |
|   89677 |  7458 | `			sxi32 iAttrFlags = 0;` |
|   89677 |  7459 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|   89619 |  7460 | `				continue;` |
|       - |  7461 | `			}` |
...
|      29 |  7538 | `		}` |
|       - |  7539 | `	}` |
|  248707 |  7540 | `	if( doBody ){` |
|       - |  7541 | `		/* Compile method body */` |
|  162751 |  7542 | `		rc = GenStateCompileFuncBody(&(*pGen),&pMeth->sFunc);` |
|  162751 |  7543 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  7544 | `			return SXERR_ABORT;` |
|       - |  7545 | `		}` |
|   81378 |  7546 | `	}else{` |
|       - |  7547 | `		/* Only method signature is allowed */` |
|   85961 |  7548 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI /* ';'*/) == 0 ){` |
...
|       - |  7581 | ` */` |
|   36392 |  7582 | `static sxi32 PH7_CompileClassInterface(ph7_gen_state *pGen)` |
|       5 |  7583 |  |
|   36397 |  7584 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|   36397 |  7593 | `	pName = &pGen->pIn->sData;` |
|       - |  7594 | `	/* Advance the stream cursor */` |
|   36397 |  7595 | `	pGen->pIn++;` |
|       - |  7596 | `	/* Build FQN and obtain a raw class */ {` |
|       - |  7597 | `		SyBlob sFQN;` |
|       - |  7598 | `		SyString sFQNStr;` |
|   36397 |  7599 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|   36397 |  7600 | `		GenStateBuildFQN(pGen,pName,&sFQN);` |
|   36397 |  7601 | `		SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|   36397 |  7602 | `		pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|   36397 |  7603 | `		SyBlobRelease(&sFQN);` |
|       - |  7604 | `	}` |
|   36397 |  7605 | `	if( pClass == 0 ){` |
...
|   36397 |  7610 | `	pClass->iFlags = PH7_CLASS_INTERFACE;` |
|       - |  7611 | `	/* Assume no base class is given */` |
|   36397 |  7612 | `	pBase = 0;` |
|   36397 |  7613 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|    9925 |  7614 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    9925 |  7615 | `		if( nKwrd == PH7_TKWRD_EXTENDS /* interface b extends a */ ){` |
|       - |  7616 | `			SyBlob sResolved;` |
|       - |  7617 | `			SyString sBaseName;` |
|       - |  7618 | `			sxu32 nRefLine;` |
|       - |  7619 | `			/* Extract base interface */` |
|    9925 |  7620 | `			pGen->pIn++;` |
|    9925 |  7621 | `			nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|    9925 |  7622 | `			SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|    9925 |  7623 | `			if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|       - |  7633 | `			}` |
|   14885 |  7634 | `			pBase = PH7_VmExtractClass(pGen->pVm,` |
|    9920 |  7635 | `				(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|    9925 |  7636 | `			SyStringInitFromBuf(&sBaseName,` |
|       - |  7637 | `				(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|       - |  7638 | `			/* Only interfaces is allowed */` |
|    9925 |  7639 | `			while( pBase && (pBase->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|     ! 0 |  7640 | `				pBase = pBase->pNextName;` |
|     ! 0 |  7641 | `			}` |
|    9925 |  7642 | `			if( pBase == 0 ){` |
...
|       - |  7648 | `				}` |
|     ! 0 |  7649 | `			}` |
|    9925 |  7650 | `			SyBlobRelease(&sResolved);` |
|    4960 |  7651 | `		}` |
|    4960 |  7652 | `	}` |
|   36397 |  7653 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|       - |  7654 | `		/* Syntax error */` |
...
|       - |  7662 | `	}` |
|   36397 |  7663 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|   36397 |  7664 | `	pEnd = 0; /* cc warning */` |
|       - |  7665 | `	/* Delimit the interface body */` |
|   36397 |  7666 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|   36397 |  7667 | `	if( pEnd >= pGen->pEnd ){` |
|       - |  7668 | `		/* Syntax error */` |
...
|   36397 |  7678 | `	pTmp = pGen->pEnd;` |
|   36397 |  7679 | `	pGen->pEnd = pEnd;` |
...
|  208293 |  7687 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|   85953 |  7688 | `			pGen->pIn++;` |
|       5 |  7689 | `		}` |
|  122345 |  7690 | `		if( pGen->pIn >= pGen->pEnd ){` |
|       - |  7691 | `			/* End of interface body */` |
|   36395 |  7692 | `			break;` |
|       - |  7693 | `		}` |
|   85955 |  7694 | `		if( (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|   85955 |  7705 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   85955 |  7706 | `		if( nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
...
|       3 |  7735 | `			goto done;` |
|       - |  7736 | `		}` |
|   85953 |  7737 | `		if( nKwrd != PH7_TKWRD_PUBLIC && nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|     ! 0 |  7744 | `			goto done;` |
|       - |  7745 | `		}` |
|   85953 |  7746 | `		if( nKwrd == PH7_TKWRD_PUBLIC ){` |
|       - |  7747 | `			/* Advance the stream cursor */` |
|   85945 |  7748 | `			pGen->pIn++;` |
|   85945 |  7749 | `			if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|     ! 0 |  7756 | `				goto done;` |
|       - |  7757 | `			}` |
|   85945 |  7758 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   85945 |  7759 | `			if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|       - |  7767 | `			}` |
|   42970 |  7768 | `		}` |
|   85953 |  7769 | `		if( nKwrd == PH7_TKWRD_CONST ){` |
|       - |  7770 | `			/* Parse constant */` |
...
|       - |  7777 | `			}` |
|       4 |  7778 | `		}else{` |
|   85947 |  7779 | `			sxi32 iFlags = PH7_CLASS_ATTR_ABSTRACT; /* Interface methods are implicitly abstract */` |
|   85947 |  7780 | `			if( nKwrd == PH7_TKWRD_STATIC ){` |
|       - |  7781 | `				/* Static method,record that */` |
|    9917 |  7782 | `				iFlags \|= PH7_CLASS_ATTR_STATIC;` |
|       - |  7783 | `				/* Advance the stream cursor */` |
|    9917 |  7784 | `				pGen->pIn++;` |
|    9912 |  7785 | `				if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0` |
|    9917 |  7786 | `					\|\| SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_FUNCTION ){` |
...
|   85947 |  7797 | `			rc = GenStateCompileClassMethod(&(*pGen),0,iFlags,FALSE,pClass);` |
|   85947 |  7798 | `			if( rc != SXRET_OK ){` |
...
|   36395 |  7807 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|   36395 |  7808 | `	if( rc == SXRET_OK && pBase ){` |
|       - |  7809 | `		/* Inherit from the base interface */` |
|    9925 |  7810 | `		rc = PH7_ClassInterfaceInherit(pClass,pBase);` |
|    4960 |  7811 | `	}` |
|   36395 |  7812 | `	if( rc != SXRET_OK ){` |
...
|   36397 |  7818 | `	pGen->pIn  = &pEnd[1];` |
|   36397 |  7819 | `	pGen->pEnd = pTmp;` |
|   36397 |  7820 | `	return PH7_OK;` |
|   18201 |  7821 |  |
|       - |  7822 | `/*` |
...
|       - |  7846 | ` */` |
|   90214 |  7847 | `static sxi32 GenStateCheckInterfaceSignatures(ph7_gen_state *pGen,ph7_class *pClass)` |
|       5 |  7848 |  |
|       - |  7849 | `	ph7_class **apIface;` |
|       - |  7850 | `	sxu32 nIface,i;` |
|       - |  7851 | `	sxi32 rc;` |
|   90219 |  7852 | `	if( pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|     ! 0 |  7853 | `		return SXRET_OK;` |
|       - |  7854 | `	}` |
|   90219 |  7855 | `	apIface = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|   90219 |  7856 | `	nIface = SySetUsed(&pClass->aInterface);` |
|  179623 |  7857 | `	for(i = 0; i < nIface; i++){` |
|   89409 |  7858 | `		ph7_class *pIface = apIface[i];` |
|       - |  7859 | `		SyHashEntry *pEntry;` |
|   89409 |  7860 | `		SyHashResetLoopCursor(&pIface->hMethod);` |
|  238491 |  7861 | `		while((pEntry = SyHashGetNextEntry(&pIface->hMethod)) != 0 ){` |
|  149087 |  7862 | `			ph7_class_method *pIfaceMeth = (ph7_class_method *)pEntry->pUserData;` |
|       - |  7863 | `			ph7_class_method *pImplMeth;` |
|  149087 |  7864 | `			SyString *pMName = &pIfaceMeth->sFunc.sName;` |
|       - |  7865 | `			/* Find the implementing method in the class */` |
|  149087 |  7866 | `			pImplMeth = PH7_ClassExtractMethod(pClass,pMName->zString,pMName->nByte);` |
|  149087 |  7867 | `			if( pImplMeth == 0 \|\| (pImplMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT) ){` |
...
|  149073 |  7871 | `			if( pImplMeth->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|       - |  7881 | `			 */` |
|       - |  7882 | `			{` |
|  149073 |  7883 | `				sxu32 nIfaceArgs = SySetUsed(&pIfaceMeth->sFunc.aArgs);` |
|  149073 |  7884 | `				sxu32 nImplArgs = SySetUsed(&pImplMeth->sFunc.aArgs);` |
|  149073 |  7885 | `				int sigError = 0;` |
|  149073 |  7886 | `				if( nImplArgs < nIfaceArgs ){` |
|       3 |  7887 | `					sigError = 1;` |
|  149072 |  7888 | `				}else if( nImplArgs > nIfaceArgs ){` |
...
|       - |  7939 | ` */` |
|   90214 |  7940 | `static sxi32 GenStateCheckAbstractMethods(ph7_gen_state *pGen,ph7_class *pClass)` |
|       5 |  7941 |  |
...
|   90219 |  7948 | `	if( pClass->iFlags & (PH7_CLASS_ABSTRACT\|PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|      29 |  7949 | `		return SXRET_OK;` |
|       - |  7950 | `	}` |
|       - |  7951 | `	/* Count abstract methods */` |
|   90195 |  7952 | `	nAbstract = 0;` |
|   90195 |  7953 | `	SyHashResetLoopCursor(&pClass->hMethod);` |
|  874671 |  7954 | `	while((pEntry = SyHashGetNextEntry(&pClass->hMethod)) != 0 ){` |
|  784481 |  7955 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|  784481 |  7956 | `		if( pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|      20 |  7957 | `			nAbstract++;` |
|       8 |  7958 | `		}` |
|       5 |  7959 | `	}` |
|   90195 |  7960 | `	if( nAbstract == 0 ){` |
|   90181 |  7961 | `		return SXRET_OK;` |
|       - |  7962 | `	}` |
...
|       - |  8095 | ` */` |
|   89934 |  8096 | `static sxi32 GenStateParseClassReference(ph7_gen_state *pGen,SyBlob *pFqn)` |
|       5 |  8097 |  |
|   89939 |  8098 | `	int isAbsolute = 0;` |
|   89939 |  8099 | `	SyToken *pStart = pGen->pIn;` |
|       - |  8100 | `	SyBlob sName;` |
|   89939 |  8101 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) ){` |
|      44 |  8102 | `		isAbsolute = 1;` |
|      44 |  8103 | `		pGen->pIn++;` |
|      20 |  8104 | `	}` |
|   89939 |  8105 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|       9 |  8106 | `		pGen->pIn = pStart;` |
|       9 |  8107 | `		return SXERR_INVALID;` |
|       - |  8108 | `	}` |
|   89933 |  8109 | `	SyBlobInit(&sName,&pGen->pVm->sAllocator);` |
|   89933 |  8110 | `	SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|   89933 |  8111 | `	pGen->pIn++;` |
|  134910 |  8112 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) &&` |
|   44987 |  8113 | `		&pGen->pIn[1] < pGen->pEnd && (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|      13 |  8114 | `		SyBlobAppend(&sName,"\\",1);` |
|      13 |  8115 | `		pGen->pIn++;` |
|      13 |  8116 | `		SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|      13 |  8117 | `		pGen->pIn++;` |
|       1 |  8118 | `	}` |
|   89933 |  8119 | `	if( isAbsolute ){` |
|      42 |  8120 | `		SyBlobAppend(pFqn,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|      23 |  8121 | `	}else{` |
|       - |  8122 | `		SyString sRaw;` |
|   89895 |  8123 | `		SyStringInitFromBuf(&sRaw,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|   89895 |  8124 | `		GenStateResolveName(pGen,&sRaw,pFqn);` |
|       - |  8125 | `	}` |
|   89933 |  8126 | `	SyBlobRelease(&sName);` |
|   89933 |  8127 | `	return SXRET_OK;` |
|   44972 |  8128 |  |
|       - |  8129 | `/*` |
...
|   10034 |  8137 | `static int GenStateInterfaceIsThrowableAt(ph7_class *pInterface,int iDepth)` |
|       5 |  8138 |  |
|       - |  8139 | `	ph7_class **apParent;` |
|       - |  8140 | `	sxu32 n;` |
|   16791 |  8141 | `	while( pInterface ){` |
|   13375 |  8142 | `		if( iDepth > PH7_THROWABLE_WALK_MAX_DEPTH ){` |
|     ! 0 |  8143 | `			return FALSE;` |
|       - |  8144 | `		}` |
|   16691 |  8145 | `		if( pInterface->sName.nByte == sizeof("Throwable")-1 &&` |
|    6632 |  8146 | `			SyMemcmp(pInterface->sName.zString,"Throwable",sizeof("Throwable")-1) == 0 ){` |
|    6623 |  8147 | `			return TRUE;` |
|       - |  8148 | `		}` |
|    6757 |  8149 | `		apParent = (ph7_class **)SySetBasePtr(&pInterface->aInterface);` |
|    6757 |  8150 | `		for( n = 0 ; n < SySetUsed(&pInterface->aInterface) ; ++n ){` |
|     ! 0 |  8151 | `			if( GenStateInterfaceIsThrowableAt(apParent[n],iDepth+1) ){` |
|     ! 0 |  8152 | `				return TRUE;` |
|       - |  8153 | `			}` |
|     ! 0 |  8154 | `		}` |
|    6757 |  8155 | `		pInterface = pInterface->pBase;` |
|    6757 |  8156 | `		iDepth++;` |
|       5 |  8157 | `	}` |
|    3421 |  8158 | `	return FALSE;` |
|    5022 |  8159 |  |
|   10034 |  8160 | `static int GenStateInterfaceIsThrowable(ph7_class *pInterface)` |
|       5 |  8161 |  |
|   10039 |  8162 | `	return GenStateInterfaceIsThrowableAt(pInterface,0);` |
|       5 |  8163 |  |
|       - |  8164 | `/*` |
...
|       - |  8168 | ` */` |
|    6618 |  8169 | `static int GenStateClassIsExceptionOrError(ph7_class *pBase)` |
|       5 |  8170 |  |
|    6627 |  8171 | `	while( pBase ){` |
...
|       1 |  8181 | `	}` |
|    6619 |  8182 | `	return FALSE;` |
|    3314 |  8183 |  |
|   90244 |  8184 | `static sxi32 GenStateCompileClass(ph7_gen_state *pGen,sxi32 iFlags)` |
|       5 |  8185 |  |
|   90249 |  8186 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|   90249 |  8197 | `	pGen->pIn++;` |
|   90249 |  8198 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
|       - |  8199 | `		/* Syntax error */` |
...
|   90249 |  8212 | `	pName = &pGen->pIn->sData;` |
|       - |  8213 | `	/* Advance the stream cursor */` |
|   90249 |  8214 | `	pGen->pIn++;` |
|       - |  8215 | `	/* Build FQN and obtain a raw class */ {` |
|       - |  8216 | `		SyBlob sFQN;` |
|       - |  8217 | `		SyString sFQNStr;` |
|   90249 |  8218 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|   90249 |  8219 | `		GenStateBuildFQN(pGen,pName,&sFQN);` |
|   90249 |  8220 | `		SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|   90249 |  8221 | `		pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|   90249 |  8222 | `		SyBlobRelease(&sFQN);` |
|       - |  8223 | `	}` |
|   90249 |  8224 | `	if( pClass == 0 ){` |
...
|   90249 |  8229 | `	SySetInit(&aInterfaces,&pGen->pVm->sAllocator,sizeof(ph7_class *));` |
|   90249 |  8230 | `	SySetInit(&aUseEntries,&pGen->pVm->sAllocator,sizeof(TraitUseEntry));` |
|       - |  8231 | `	/* Assume a standalone class */` |
|   90249 |  8232 | `	pBase = 0;` |
|   90249 |  8233 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|   79569 |  8234 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   79569 |  8235 | `		if( nKwrd == PH7_TKWRD_EXTENDS /* class b extends a */ ){` |
|       - |  8236 | `			SyBlob sResolved;` |
|       - |  8237 | `			SyString sBaseName;` |
|       - |  8238 | `			sxu32 nRefLine;` |
|   69541 |  8239 | `			pGen->pIn++; /* Advance past 'extends' */` |
|   69541 |  8240 | `			nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|   69541 |  8241 | `			SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|   69541 |  8242 | `			if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|       - |  8252 | `			}` |
|  104306 |  8253 | `			pBase = PH7_VmExtractClass(pGen->pVm,` |
|   69534 |  8254 | `				(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|   69539 |  8255 | `			SyStringInitFromBuf(&sBaseName,` |
|       - |  8256 | `				(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|       - |  8257 | `			/* Interfaces are not allowed */` |
|   69539 |  8258 | `			while( pBase && (pBase->iFlags & PH7_CLASS_INTERFACE) ){` |
|     ! 0 |  8259 | `				pBase = pBase->pNextName;` |
|     ! 0 |  8260 | `			}` |
|   69539 |  8261 | `			if( pBase == 0 ){` |
...
|       - |  8267 | `				}` |
|     ! 0 |  8268 | `			}else{` |
|   69539 |  8269 | `				if( pBase->iFlags & PH7_CLASS_FINAL ){` |
...
|     ! 0 |  8276 | `				}` |
|       - |  8277 | `			}` |
|   69539 |  8278 | `			SyBlobRelease(&sResolved);` |
|   34767 |  8279 | `		}` |
|   79567 |  8280 | `		if (pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) && SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_IMPLEMENTS ){` |
|       - |  8281 | `			ph7_class *pInterface;` |
|       - |  8282 | `			/* Interface implementation */` |
|   10039 |  8283 | `			pGen->pIn++; /* Advance the stream cursor */` |
|    5017 |  8284 | `			for(;;){` |
|       - |  8285 | `				SyBlob sResolved;` |
|       - |  8286 | `				SyString sIntName;` |
|       - |  8287 | `				sxu32 nRefLine;` |
|   10039 |  8288 | `				nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|   10039 |  8289 | `				SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|   10039 |  8290 | `				if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|     ! 0 |  8298 | `					break;` |
|       - |  8299 | `				}` |
|   20073 |  8300 | `				pInterface = PH7_VmExtractClass(pGen->pVm,` |
|   10034 |  8301 | `					(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|   10039 |  8302 | `				SyStringInitFromBuf(&sIntName,` |
|       - |  8303 | `					(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|       - |  8304 | `				/* Only interfaces are allowed */` |
|   10039 |  8305 | `				while( pInterface && (pInterface->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|     ! 0 |  8306 | `					pInterface = pInterface->pNextName;` |
|     ! 0 |  8307 | `				}` |
|   10039 |  8308 | `				if( pInterface == 0 ){` |
...
|   10039 |  8322 | `					SyString *pFqn = &pClass->sName;` |
|   10039 |  8323 | `					int bIsExceptionOrError =` |
|    8323 |  8324 | `						(pFqn->nByte == sizeof("Exception")-1 &&` |
|   16705 |  8325 | `						 SyMemcmp(pFqn->zString,"Exception",sizeof("Exception")-1) == 0) \|\|` |
|    8387 |  8326 | `						(pFqn->nByte == sizeof("Error")-1 &&` |
|    3314 |  8327 | `						 SyMemcmp(pFqn->zString,"Error",sizeof("Error")-1) == 0);` |
|   16650 |  8328 | `					if( GenStateInterfaceIsThrowable(pInterface) &&` |
|    9930 |  8329 | `						!GenStateClassIsExceptionOrError(pBase) &&` |
|    3307 |  8330 | `						!bIsExceptionOrError ){` |
...
|       6 |  8340 | `					}else{` |
|   10033 |  8341 | `						SySetPut(&aInterfaces,(const void *)&pInterface);` |
|       - |  8342 | `					}` |
|       - |  8343 | `				}` |
|   10039 |  8344 | `				SyBlobRelease(&sResolved);` |
|   10039 |  8345 | `				if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COMMA) == 0 ){` |
|    5022 |  8346 | `					break;` |
|       - |  8347 | `				}` |
...
|    5017 |  8350 | `		}` |
|   39781 |  8351 | `	}` |
|   90247 |  8352 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|       - |  8353 | `		/* Syntax error */` |
...
|       - |  8361 | `	}` |
|   90247 |  8362 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|   90247 |  8363 | `	pEnd = 0; /* cc warning */` |
|       - |  8364 | `	/* Delimit the class body */` |
|   90247 |  8365 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|   90247 |  8366 | `	if( pEnd >= pGen->pEnd ){` |
|       - |  8367 | `		/* Syntax error */` |
...
|   90247 |  8377 | `	pTmp = pGen->pEnd;` |
|   90247 |  8378 | `	pGen->pEnd = pEnd;` |
|       - |  8379 | `	/* Set the inherited flags */` |
|   90247 |  8380 | `	pClass->iFlags = iFlags;` |
|       - |  8381 | `	/* Start the parse process */` |
|  126505 |  8382 | `	for(;;){` |
|       - |  8383 | `		/* Jump leading/trailing semi-colons */` |
|  379769 |  8384 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|   63415 |  8385 | `			pGen->pIn++;` |
|       5 |  8386 | `		}` |
|  316359 |  8387 | `		if( pGen->pIn >= pGen->pEnd ){` |
|       - |  8388 | `			/* End of class body */` |
|   90219 |  8389 | `			break;` |
|       - |  8390 | `		}` |
|  226140 |  8391 | `		if( (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR)) == 0` |
|  113075 |  8392 | ``			&& !GenStateIsReadonly(pGen->pIn) /* allow a leading `readonly` modifier */ ){`` |
...
|  226145 |  8403 | `		iProtection = PH7_TKWRD_PUBLIC;` |
|  226145 |  8404 | `		iAttrflags = 0;` |
...
|  226145 |  8409 | `		if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|     ! 0 |  8410 | `			int bMod = 0;` |
...
|       - |  8431 | `			}` |
|     ! 0 |  8432 | `		}` |
|  226145 |  8433 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|       - |  8434 | `			/* Extract the current keyword */` |
|  226145 |  8435 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  226145 |  8436 | `			if( nKwrd == PH7_TKWRD_USE ){` |
...
|      49 |  8496 | `				continue;` |
|       - |  8497 | `			}` |
|  226101 |  8498 | `			if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|  222635 |  8499 | `				iProtection = nKwrd;` |
|  222635 |  8500 | `				pGen->pIn++; /* Jump the visibility token */` |
|       - |  8501 | ``				/* Optional `readonly` after the visibility: `public readonly int $x`. */`` |
|  222635 |  8502 | `				if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|      20 |  8503 | `					iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|      20 |  8504 | `					pGen->pIn++; /* Jump the 'readonly' modifier */` |
|       8 |  8505 | `				}` |
|  222630 |  8506 | `				if( pGen->pIn >= pGen->pEnd` |
|  222635 |  8507 | `					\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP)) == 0 ){` |
...
|     ! 0 |  8515 | `					goto done;` |
|       - |  8516 | `				}` |
|  222635 |  8517 | `				if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|       - |  8518 | `					/* Attribute declaration (untyped) */` |
|   63139 |  8519 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|   63139 |  8520 | `					if( rc != SXRET_OK ){` |
...
|   63133 |  8526 | `					continue;` |
|       - |  8527 | `				}` |
|  159501 |  8528 | `				if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|  159347 |  8540 | `				nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   79671 |  8541 | `			}` |
|  162813 |  8542 | `			if( nKwrd == PH7_TKWRD_CONST ){` |
...
|       - |  8550 | `				}` |
|      34 |  8551 | `			}else{` |
|  162753 |  8552 | `				if( nKwrd == PH7_TKWRD_STATIC ){` |
|       - |  8553 | `					/* Static method or attribute,record that */` |
|    3351 |  8554 | `					iAttrflags \|= PH7_CLASS_ATTR_STATIC;` |
|    3351 |  8555 | `					pGen->pIn++; /* Jump the static keyword */` |
|    3351 |  8556 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|       - |  8557 | `						/* Extract the keyword */` |
|    3345 |  8558 | `						nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|    3345 |  8559 | `						if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
...
|    3351 |  8567 | `					if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|     ! 0 |  8568 | `						iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|     ! 0 |  8569 | `						pGen->pIn++; /* Jump the 'readonly' modifier */` |
|     ! 0 |  8570 | `					}` |
|    3346 |  8571 | `					if( pGen->pIn >= pGen->pEnd` |
|    3351 |  8572 | `						\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP)) == 0 ){` |
...
|     ! 0 |  8580 | `						goto done;` |
|       - |  8581 | `					}` |
|    3351 |  8582 | `					if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
...
|       5 |  8591 | `						continue;` |
|       - |  8592 | `					}` |
|    3347 |  8593 | `					if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|    3335 |  8605 | `					nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  161072 |  8606 | `				}else if( nKwrd == PH7_TKWRD_ABSTRACT ){` |
...
|  159402 |  8638 | `				}else if( nKwrd == PH7_TKWRD_FINAL ){` |
...
|       8 |  8646 | `							iProtection = nKwrd;` |
|       8 |  8647 | `							pGen->pIn++; /* Jump the visibility token */` |
|       3 |  8648 | `						}` |
|       7 |  8649 | `					}` |
...
|      12 |  8662 | `							continue;` |
|       - |  8663 | `					}` |
|       5 |  8664 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
...
|     ! 0 |  8669 | `					}` |
|       5 |  8670 | `					if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 \|\|` |
...
|     ! 0 |  8679 | `							goto done;` |
|       - |  8680 | `					}` |
|       5 |  8681 | `					nKwrd = PH7_TKWRD_FUNCTION;` |
|       2 |  8682 | `				}` |
|  162727 |  8683 | `				if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_VAR ){` |
...
|     ! 0 |  8691 | `						goto done;` |
|       - |  8692 | `				}` |
|  162727 |  8693 | `				if( nKwrd == PH7_TKWRD_VAR ){` |
...
|  162721 |  8708 | `					rc = GenStateCompileClassMethod(&(*pGen),iProtection,iAttrflags,TRUE,pClass);` |
|       - |  8709 | `				}` |
|  162727 |  8710 | `				if( rc != SXRET_OK ){` |
...
|       - |  8733 | `		sxu32 nU;` |
|   90219 |  8734 | `		apUse = (TraitUseEntry *)SySetBasePtr(&aUseEntries);` |
|   90263 |  8735 | `		for( nU = 0 ; nU < SySetUsed(&aUseEntries) ; nU++ ){` |
...
|   90219 |  8943 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|   90219 |  8944 | `	if( rc == SXRET_OK ){` |
|       - |  8945 | `		ph7_class **apInterface;` |
|       - |  8946 | `		sxu32 n;` |
|   90219 |  8947 | `		if( pBase ){` |
|       - |  8948 | `			/* Inherit from base class and mark as a subclass */` |
|   69539 |  8949 | `			rc = PH7_ClassInherit(&(*pGen),pClass,pBase);` |
|   34767 |  8950 | `		}` |
|   90219 |  8951 | `		apInterface = (ph7_class **)SySetBasePtr(&aInterfaces);` |
|  100247 |  8952 | `		for( n = 0 ; n < SySetUsed(&aInterfaces) ; n++ ){` |
|       - |  8953 | `			/* Implements one or more interface */` |
|   10033 |  8954 | `			rc = PH7_ClassImplement(pClass,apInterface[n]);` |
|   10033 |  8955 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  8956 | `				break;` |
|       - |  8957 | `			}` |
|    5019 |  8958 | `		}` |
...
|  135321 |  8961 | `		if( rc == SXRET_OK` |
|   90214 |  8962 | `		 && (pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT)) == 0` |
|   90219 |  8963 | `		 && SyHashGet(&pClass->hMethod,"__toString",sizeof("__toString")-1) != 0 ){` |
|   79383 |  8964 | `			ph7_class *pStringable = PH7_VmExtractClass(pGen->pVm,` |
|       - |  8965 | `				"Stringable",sizeof("Stringable")-1,FALSE,0);` |
|   79383 |  8966 | `			if( pStringable ){` |
|   79383 |  8967 | `				ph7_class **apImpl = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|   79383 |  8968 | `				sxu32 nImpl = SySetUsed(&pClass->aInterface);` |
|       - |  8969 | `				sxu32 i;` |
|   79383 |  8970 | `				int bAlready = 0;` |
|   85995 |  8971 | `				for( i = 0 ; i < nImpl ; i++ ){` |
|    6619 |  8972 | `					if( apImpl[i] == pStringable ){` |
|       3 |  8973 | `						bAlready = 1;` |
|       3 |  8974 | `						break;` |
|       - |  8975 | `					}` |
|    3311 |  8976 | `				}` |
|   79383 |  8977 | `				if( !bAlready ){` |
|   79381 |  8978 | `					PH7_ClassImplement(pClass,pStringable);` |
|   39688 |  8979 | `				}` |
|   39689 |  8980 | `			}` |
|   39689 |  8981 | `		}` |
|       - |  8982 | `		/* Validate interface method signatures (visibility and parameter count) */` |
|   90219 |  8983 | `		if( rc == SXRET_OK ){` |
|   90219 |  8984 | `			sxi32 rcCheck = GenStateCheckInterfaceSignatures(&(*pGen),pClass);` |
|   90219 |  8985 | `			if( rcCheck == SXERR_ABORT ){` |
...
|   90219 |  8992 | `		if( rc == SXRET_OK ){` |
|   90219 |  8993 | `			sxi32 rcCheck = GenStateCheckAbstractMethods(&(*pGen),pClass);` |
|   90219 |  8994 | `			if( rcCheck == SXERR_ABORT ){` |
...
|   45107 |  8999 | `		}` |
|   45107 |  9000 | `	}` |
|   90219 |  9001 | `	SySetRelease(&aUseEntries);` |
|   90219 |  9002 | `	SySetRelease(&aInterfaces);` |
|   90219 |  9003 | `	if( rc != SXRET_OK ){` |
...
|   90247 |  9009 | `	pGen->pIn = &pEnd[1];` |
|   90247 |  9010 | `	pGen->pEnd = pTmp;` |
|   90247 |  9011 | `	return PH7_OK;` |
|   45127 |  9012 |  |
|       - |  9013 | `/*` |
...
|       - |  9033 | ` */` |
|  890368 |  9034 | `static int GenStateTokenIsClassModifier(SyToken *pTok,sxi32 *piFlag)` |
|       5 |  9035 |  |
|  890373 |  9036 | `	if( pTok->nType & PH7_TK_KEYWORD ){` |
|  590055 |  9037 | `		sxu32 nKw = (sxu32)SX_PTR_TO_INT(pTok->pUserData);` |
|  590055 |  9038 | `		if( nKw == PH7_TKWRD_FINAL ){ *piFlag = PH7_CLASS_FINAL; return TRUE; }` |
|  590037 |  9039 | `		if( nKw == PH7_TKWRD_ABSTRACT ){ *piFlag = PH7_CLASS_ABSTRACT; return TRUE; }` |
|  294993 |  9040 | `	}` |
|  890309 |  9041 | `	if( GenStateIsReadonly(pTok) ){ *piFlag = PH7_CLASS_READONLY; return TRUE; }` |
|  890249 |  9042 | `	return FALSE;` |
|  445189 |  9043 |  |
|       - |  9044 | `/*` |
...
|       - |  9049 | ` */` |
|  890244 |  9050 | `static sxi32 GenStateScanClassModifiers(SyToken **ppIn,SyToken *pEnd,SyToken **ppDup)` |
|       5 |  9051 |  |
|  890249 |  9052 | `	SyToken *pIn = *ppIn,*pDup = 0;` |
|  890249 |  9053 | `	sxi32 iFlags = 0,iFlag;` |
|  890373 |  9054 | `	while( pIn < pEnd && GenStateTokenIsClassModifier(pIn,&iFlag) ){` |
...
|     129 |  9059 | `		pIn++;` |
|       5 |  9060 | `	}` |
|  890249 |  9061 | `	*ppIn = pIn;` |
|  890249 |  9062 | `	if( ppDup ){ *ppDup = pDup; }` |
|  890249 |  9063 | `	return iFlags;` |
|       5 |  9064 |  |
|       - |  9065 | `/*` |
...
|       - |  9071 | ` */` |
|  890192 |  9072 | `static int GenStateStartsModifiedClass(SyToken *pIn,SyToken *pEnd)` |
|       5 |  9073 |  |
|  890197 |  9074 | `	sxi32 iFlags = GenStateScanClassModifiers(&pIn,pEnd,0);` |
|  445155 |  9075 | `	return iFlags != 0 && pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD)` |
|  890220 |  9076 | `		&& (sxu32)SX_PTR_TO_INT(pIn->pUserData) == PH7_TKWRD_CLASS;` |
|       5 |  9077 |  |
|       - |  9078 | `/*` |
...
|       - |  9406 | ` */` |
|   90192 |  9407 | `static sxi32 PH7_CompileClass(ph7_gen_state *pGen)` |
|       5 |  9408 |  |
|       - |  9409 | `	sxi32 rc;` |
|   90197 |  9410 | `	rc = GenStateCompileClass(&(*pGen),0);` |
|   90197 |  9411 | `	return rc;` |
|       5 |  9412 |  |
|       - |  9413 | `/*` |
...
|       - |  9434 | ` */` |
|   10122 |  9435 | `static sxi32 GenStateThrowNodeValidator(ph7_gen_state *pGen,ph7_expr_node *pRoot)` |
|       5 |  9436 |  |
|   10127 |  9437 | `	sxi32 rc = SXRET_OK;` |
|   10127 |  9438 | `	if( pRoot->pOp ){` |
|   10119 |  9439 | `		switch( pRoot->pOp->iOp ){` |
|    5057 |  9440 | `		case EXPR_OP_NEW:            /* new Exception() */` |
...
|     ! 0 |  9456 | `			break;` |
|       - |  9457 | `		}` |
|    5070 |  9458 | `	}else if( pRoot->xCode != PH7_CompileVariable ){` |
...
|       - |  9472 | ` */` |
|   10086 |  9473 | `static sxi32 PH7_CompileThrow(ph7_gen_state *pGen)` |
|       5 |  9474 |  |
|   10091 |  9475 | `	sxu32 nLine = pGen->pIn->nLine;` |
|       - |  9476 | `	GenBlock *pBlock;` |
|       - |  9477 | `	sxu32 nIdx;` |
|       - |  9478 | `	sxi32 rc;` |
|   10091 |  9479 | `	pGen->pIn++; /* Jump the 'throw' keyword */` |
|       - |  9480 | `	/* Compile the expression */` |
|   10091 |  9481 | `	rc = PH7_CompileExpr(&(*pGen),0,GenStateThrowNodeValidator);` |
|   10091 |  9482 | `	if( rc == SXERR_EMPTY ){` |
...
|       - |  9488 | `	}` |
|   10091 |  9489 | `	pBlock = pGen->pCurrent;` |
|       - |  9490 | `	/* Point to the top most function or try block and emit the forward jump */` |
|   46609 |  9491 | `	while(pBlock->pParent){` |
|   46605 |  9492 | `		if( pBlock->iFlags & (GEN_BLOCK_EXCEPTION\|GEN_BLOCK_FUNC) ){` |
|   10087 |  9493 | `			break;` |
|       - |  9494 | `		}` |
|       - |  9495 | `		/* Point to the parent block */` |
|   36523 |  9496 | `		pBlock = pBlock->pParent;` |
|       5 |  9497 | `	}` |
|       - |  9498 | `	/* Emit the throw instruction */` |
|   10091 |  9499 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_THROW,0,0,0,&nIdx);` |
|       - |  9500 | `	/* Emit the jump */` |
|   10091 |  9501 | `	GenStateNewJumpFixup(pBlock,PH7_OP_THROW,nIdx);` |
|   10091 |  9502 | `	return SXRET_OK;` |
|    5048 |  9503 |  |
|       - |  9504 | `/*` |
...
|       - | 10158 | ` */` |
| 2413470 | 10159 | `static void GenStatePatchNullsafeJumps(ph7_gen_state *pGen, sxu32 nBaseline)` |
|       5 | 10160 |  |
| 2413475 | 10161 | `	sxu32 nCur = SySetUsed(&pGen->aNullsafeJmp);` |
|       - | 10162 | `	sxu32 nTarget;` |
|       - | 10163 | `	sxu32 *aIdx;` |
|       - | 10164 | `	sxu32 i;` |
| 2413475 | 10165 | `	if( nCur <= nBaseline ){` |
| 2413385 | 10166 | `		return;` |
|       - | 10167 | `	}` |
...
|       - | 10195 | ` */` |
|  392142 | 10196 | `static sxu32 GenStateByRefBuiltinMask(SyString *pName)` |
|       5 | 10197 |  |
...
|       - | 10207 | `	};` |
|       - | 10208 | `	sxu32 i;` |
|  392147 | 10209 | `	if( pName == 0 \|\| pName->zString == 0 \|\| pName->nByte == 0 ){` |
|    1175 | 10210 | `		return 0;` |
|       - | 10211 | `	}` |
| 1954721 | 10212 | `	for( i = 0 ; i < SX_ARRAYSIZE(aByRef) ; ++i ){` |
| 1563790 | 10213 | `		if( pName->nByte == aByRef[i].nByte` |
|  802510 | 10214 | `		 && SyStrnicmp(pName->zString, aByRef[i].zName, pName->nByte) == 0 ){` |
|      51 | 10215 | `			return aByRef[i].mask;` |
|       - | 10216 | `		}` |
|  781877 | 10217 | `	}` |
|  390931 | 10218 | `	return 0;` |
|  196076 | 10219 |  |
|       - | 10220 | `/*` |
...
|       - | 10229 | ` */` |
|  392142 | 10230 | `static void GenStateCallBuiltinName(ph7_expr_node *pLeft, SyString *pOut)` |
|       5 | 10231 |  |
|       - | 10232 | `	SyToken *p, *pEnd;` |
|  392147 | 10233 | `	pOut->zString = 0;` |
|  392147 | 10234 | `	pOut->nByte = 0;` |
|  392147 | 10235 | `	if( pLeft == 0 \|\| pLeft->pStart == 0 \|\| pLeft->pEnd == 0 ){` |
|     ! 0 | 10236 | `		return;` |
|       - | 10237 | `	}` |
|  392147 | 10238 | `	p = pLeft->pStart;` |
|  392147 | 10239 | `	pEnd = pLeft->pEnd;` |
|       - | 10240 | `	/* Optional single leading namespace separator (absolute path). */` |
|  392147 | 10241 | `	if( p < pEnd && (p->nType & PH7_TK_NSSEP) ){` |
|      24 | 10242 | `		p++;` |
|      10 | 10243 | `	}` |
|  392147 | 10244 | `	if( p >= pEnd \|\| (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|    1149 | 10245 | `		return;` |
|       - | 10246 | `	}` |
|       - | 10247 | `	/* Must be a single component: nothing follows the name token. */` |
|  391003 | 10248 | `	if( p + 1 != pEnd ){` |
|      30 | 10249 | `		return;` |
|       - | 10250 | `	}` |
|  390977 | 10251 | `	*pOut = p->sData;` |
|  196076 | 10252 |  |
|       - | 10253 | `/*` |
...
|       - | 10258 | ` * error message.` |
|       - | 10259 | ` */` |
| 3252338 | 10260 | `static sxi32 GenStateEmitExprCode(` |
...
|       - | 10267 | `	sxu32 nJmpIdx;` |
| 3252343 | 10268 | `	sxi32 iP1 = 0;` |
| 3252343 | 10269 | `	sxu32 iP2 = 0;` |
| 3252343 | 10270 | `	void *p3  = 0;` |
|       - | 10271 | `	sxi32 iVmOp;` |
|       - | 10272 | `	sxi32 rc;` |
| 3252343 | 10273 | `	int bIsChainOp = 0; /* Set below once we know pNode->pOp */` |
| 3252343 | 10274 | `	sxu32 nRhsNsBase = 0;` |
| 3252343 | 10275 | `	if( pNode->xCode ){` |
|       - | 10276 | `		SyToken *pTmpIn,*pTmpEnd;` |
|       - | 10277 | `		/* Compile node */` |
| 2014437 | 10278 | `		SWAP_DELIMITER(pGen,pNode->pStart,pNode->pEnd);` |
| 2014437 | 10279 | `		rc = pNode->xCode(&(*pGen),iFlags);` |
| 2014437 | 10280 | `		RE_SWAP_DELIMITER(pGen);` |
| 2014437 | 10281 | `		return rc;` |
|       - | 10282 | `	}` |
| 1237911 | 10283 | `	if( pNode->pOp == 0 ){` |
...
|       - | 10287 | `	}` |
| 1237911 | 10288 | `	iVmOp = pNode->pOp->iVmOp;` |
| 1237911 | 10289 | `	if( pNode->pOp->iOp == EXPR_OP_NULLC_ASSIGN ){` |
...
|       - | 10338 | `	}` |
| 1237855 | 10339 | `	if( pNode->pOp->iOp == EXPR_OP_QUESTY ){` |
...
|    2621 | 10344 | `		nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|    2621 | 10345 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pCond,iFlags);` |
|    2621 | 10346 | `		if( rc != SXRET_OK ){` |
|     ! 0 | 10347 | `			return rc;` |
|       - | 10348 | `		}` |
...
|    2621 | 10352 | `		GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|    2621 | 10353 | `		nJz = nJmp = 0; /* cc -O6 warning */` |
|    2621 | 10354 | `		if( pNode->pLeft ){` |
|       - | 10355 | `			/* Standard ternary: (expr) ? (then) : (else) */` |
|       - | 10356 | `			/* Phase#2: Emit the false jump (pops condition) */` |
|    2553 | 10357 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nJz);` |
|       - | 10358 | `			/* Phase#3: Compile the 'then' expression  */` |
|    2553 | 10359 | `			nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|    2553 | 10360 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pLeft,iFlags);` |
|    2553 | 10361 | `			if( rc != SXRET_OK ){` |
|     ! 0 | 10362 | `				return rc;` |
|       - | 10363 | `			}` |
|    2553 | 10364 | `			GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|    1279 | 10365 | `		}else{` |
...
|    2621 | 10373 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,0,0,&nJmp);` |
|       - | 10374 | `		/* Phase#5: Fix the false jump now the jump destination is resolved. */` |
|    2621 | 10375 | `		pInstr = PH7_VmGetInstr(pGen->pVm,nJz);` |
|    2621 | 10376 | `		if( pInstr ){` |
|    2621 | 10377 | `			pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    1308 | 10378 | `		}` |
|    2621 | 10379 | `		if( !pNode->pLeft ){` |
...
|    2621 | 10384 | `		if( pNode->pRight ){` |
|    2621 | 10385 | `			nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|    2621 | 10386 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pRight,iFlags);` |
|    2621 | 10387 | `			if( rc != SXRET_OK ){` |
|     ! 0 | 10388 | `				return rc;` |
|       - | 10389 | `			}` |
|    2621 | 10390 | `			GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|    1308 | 10391 | `		}` |
|    2621 | 10392 | `		if( nJmp > 0 ){` |
|       - | 10393 | `			/* Phase#7: Fix the unconditional jump */` |
|    2621 | 10394 | `			pInstr = PH7_VmGetInstr(pGen->pVm,nJmp);` |
|    2621 | 10395 | `			if( pInstr ){` |
|    2621 | 10396 | `				pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    1308 | 10397 | `			}` |
|    1308 | 10398 | `		}` |
|       - | 10399 | `		/* All done */` |
|    2621 | 10400 | `		return SXRET_OK;` |
|       - | 10401 | `	}` |
| 1235239 | 10402 | `	bIsChainOp = GEN_IS_CHAIN_OP(pNode->pOp->iOp);` |
|       - | 10403 | `	/* Generate code for the left tree */` |
| 1235239 | 10404 | `	if( pNode->pLeft ){` |
| 1235201 | 10405 | `		sxu32 nLhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
| 1235201 | 10406 | `		if( iVmOp == PH7_OP_CALL ){` |
|       - | 10407 | `			ph7_expr_node **apNode;` |
|  392267 | 10408 | `			int hasSpread = 0;` |
|  392267 | 10409 | `			int hasNamed = 0;` |
|  392267 | 10410 | `			int bAnySpread = 0;` |
|  392267 | 10411 | `			sxu32 byRefMask = 0;` |
|       - | 10412 | `			sxi32 nArgs;` |
|       - | 10413 | `			sxi32 n;` |
|       - | 10414 | `			/* Recurse and generate bytecodes for function arguments */` |
|  392267 | 10415 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  392267 | 10416 | `			nArgs = (sxi32)SySetUsed(&pNode->aNodeArgs);` |
|       - | 10417 | `			/* Validate: no positional arguments after named arguments */` |
|       - | 10418 | `			{` |
|  392267 | 10419 | `				int seenNamed = 0;` |
|  776807 | 10420 | `				for( n = 0; n < nArgs; ++n ){` |
|  384547 | 10421 | `					if( apNode[n]->iFlags & EXPR_NODE_NAMED_ARG ){` |
|     188 | 10422 | `						seenNamed = 1;` |
|     188 | 10423 | `						hasNamed = 1;` |
|  384455 | 10424 | `					}else if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
|      23 | 10425 | `						bAnySpread = 1;` |
|  384353 | 10426 | `					}else if( seenNamed ){` |
...
|  392265 | 10434 | `			iFlags \|= EXPR_FLAG_RDONLY_LOAD;` |
...
|  392265 | 10439 | `			if( pNode->pLeft && pNode->pLeft->pStart ){` |
|  392265 | 10440 | `				SyString *pCallName = &pNode->pLeft->pStart->sData;` |
|  392260 | 10441 | `				if( pCallName->nByte == 5` |
|  215289 | 10442 | `				 && SyStrnicmp(pCallName->zString,"isset",5) == 0 ){` |
|   20127 | 10443 | `					iFlags \|= EXPR_FLAG_LOAD_IDX_ISSET;` |
|  382204 | 10444 | `				}else if( pCallName->nByte == 5` |
|  195167 | 10445 | `				 && SyStrnicmp(pCallName->zString,"empty",5) == 0 ){` |
...
|  392265 | 10454 | `				if( !bAnySpread && !hasNamed ){` |
|       - | 10455 | `					SyString sBuiltin;` |
|  392147 | 10456 | `					GenStateCallBuiltinName(pNode->pLeft, &sBuiltin);` |
|  392147 | 10457 | `					byRefMask = GenStateByRefBuiltinMask(&sBuiltin);` |
|  196071 | 10458 | `				}` |
|  196130 | 10459 | `			}` |
|  776803 | 10460 | `			for( n = 0 ; n < nArgs ; ++n ){` |
|  384543 | 10461 | `				sxu32 nArgNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  384543 | 10462 | `				sxi32 iArgFlags = iFlags & ~EXPR_FLAG_LOAD_IDX_STORE;` |
...
|  384543 | 10465 | `				if( n < 31 && (byRefMask & (1u<<n)) ){` |
|      31 | 10466 | `					iArgFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|      13 | 10467 | `				}` |
|  384543 | 10468 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iArgFlags);` |
|  384543 | 10469 | `				if( rc != SXRET_OK ){` |
|     ! 0 | 10470 | `					return rc;` |
|       - | 10471 | `				}` |
|       - | 10472 | `				/* Each argument is an independent nullsafe scope. */` |
|  384543 | 10473 | `				GenStatePatchNullsafeJumps(pGen, nArgNsBase);` |
|  384543 | 10474 | `				if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
...
|  392265 | 10517 | `			iFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|  196130 | 10518 | `		}` |
| 1235199 | 10519 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pLeft,iFlags);` |
| 1235199 | 10520 | `		if( rc != SXRET_OK ){` |
|      34 | 10521 | `			return rc;` |
|       - | 10522 | `		}` |
| 1235169 | 10523 | `		if( !bIsChainOp ){` |
...
|  577085 | 10526 | `			GenStatePatchNullsafeJumps(pGen, nLhsNsBase);` |
|  288540 | 10527 | `		}` |
| 1235169 | 10528 | `		if( iVmOp == PH7_OP_CALL ){` |
|  392265 | 10529 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|  392265 | 10530 | `			if( pInstr ){` |
|  392265 | 10531 | `				if ( pInstr->iOp == PH7_OP_LOADC ){` |
|  391097 | 10532 | `					sxu32 nOrig = (sxu32)pInstr->iP2;` |
|       - | 10533 | `					sxu32 nQual;` |
|  391097 | 10534 | `					int bAbsolute = (pInstr->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|       - | 10535 | `					/* Prevent constant expansion but preserve the absolute flag` |
|       - | 10536 | `					 * so the later NEW handler (if any) can see it. */` |
|  391097 | 10537 | `					pInstr->iP1 &= ~PH7_LOADC_EXPAND;` |
...
|  391097 | 10545 | `					if( bAbsolute ){` |
|      24 | 10546 | `						pInstr->iP2 = (sxi32)nOrig;` |
|      14 | 10547 | `					}else{` |
|  391077 | 10548 | `						int fromImport = 0;` |
|  391077 | 10549 | `						nQual = GenStateNsQualifyName(pGen,nOrig,&pGen->hUseFuncImports,&fromImport);` |
|  391077 | 10550 | `						pInstr->iP2 = (sxi32)nQual;` |
|  391077 | 10551 | `						if( nQual != nOrig ){` |
...
|      36 | 10569 | `						}` |
|       5 | 10570 | `					}` |
|  196719 | 10571 | `				}else if( pInstr->iOp == PH7_OP_MEMBER /* $a->b(1,2,3) */ \|\| pInstr->iOp == PH7_OP_NEW ){` |
|       - | 10572 | `					/* Method call,flag that */` |
|     893 | 10573 | `					pInstr->iP2 = 1;` |
|     444 | 10574 | `				}` |
|  196135 | 10575 | `			}` |
| 1039039 | 10576 | `		}else if( iVmOp == PH7_OP_LOAD_IDX ){` |
|       - | 10577 | `			ph7_expr_node **apNode;` |
|       - | 10578 | `			sxi32 n;` |
|   85071 | 10579 | `			sxi32 iChildMask = ~(EXPR_FLAG_LOAD_IDX_STORE` |
...
|   85071 | 10583 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  153523 | 10584 | `			for( n = 0 ; n < (sxi32)SySetUsed(&pNode->aNodeArgs) ; ++n ){` |
|   68457 | 10585 | `				sxu32 nIdxNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|   68457 | 10586 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iFlags&iChildMask);` |
|   68457 | 10587 | `				if( rc != SXRET_OK ){` |
|     ! 0 | 10588 | `					return rc;` |
|       - | 10589 | `				}` |
|       - | 10590 | `				/* Each subscript index is an independent nullsafe scope. */` |
|   68457 | 10591 | `				GenStatePatchNullsafeJumps(pGen, nIdxNsBase);` |
|   34231 | 10592 | `			}` |
|   85071 | 10593 | `			if( SySetUsed(&pNode->aNodeArgs) > 0 ){` |
|   68457 | 10594 | `				iP1 = 1; /* Node have an index associated with it */` |
|   34226 | 10595 | `			}` |
|   85071 | 10596 | `			if( iFlags & EXPR_FLAG_LOAD_IDX_ISSET ){` |
|       - | 10597 | `				/* offsetExists for ArrayAccess; peek-only for arrays */` |
|     243 | 10598 | `				iP2 = 4;` |
|   84952 | 10599 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_UNSET ){` |
|       - | 10600 | `				/* offsetUnset for ArrayAccess; auto-vivify+load for arrays` |
|       - | 10601 | `				 * so the trailing unset() builtin can drop the slot. */` |
|      54 | 10602 | `				iP2 = 5;` |
|   84808 | 10603 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_EMPTY ){` |
...
|      29 | 10607 | `				iP2 = 6;` |
|   84771 | 10608 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_STORE ){` |
|       - | 10609 | `				/* Create an empty entry when the desired index is not found */` |
|   33503 | 10610 | `				iP2 = 1;` |
|   16754 | 10611 | `			}` |
|  800376 | 10612 | `		}else if( pNode->pOp->iOp == EXPR_OP_COMMA ){` |
|       - | 10613 | `			/* POP the left node */` |
|      32 | 10614 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|      15 | 10615 | `		}` |
|  617582 | 10616 | `	}` |
| 1235207 | 10617 | `	rc = SXRET_OK;` |
| 1235207 | 10618 | `	nJmpIdx = 0;` |
...
| 1235207 | 10622 | `	if( iVmOp == PH7_OP_MEMBER && pNode->pOp->iOp == EXPR_OP_DC ){` |
...
| 1235129 | 10652 | `	if( pNode->pRight ){` |
|  682031 | 10653 | `		if( iVmOp == PH7_OP_LAND ){` |
|       - | 10654 | `			/* Emit the false jump so we can short-circuit the logical and */` |
|   10377 | 10655 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,1/* Keep the value on the stack */,0,0,&nJmpIdx);` |
|  676845 | 10656 | `		}else if (iVmOp == PH7_OP_LOR ){` |
|       - | 10657 | `			/* Emit the true jump so we can short-circuit the logical or*/` |
|    3487 | 10658 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JNZ,1/* Keep the value on the stack */,0,0,&nJmpIdx);` |
|  669918 | 10659 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLC ){` |
...
|  668164 | 10663 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW ){` |
...
|  668004 | 10673 | `		}else if( pNode->pOp->iPrec == 18 /* Combined binary operators [i.e: =,'.=','+=',*=' ...] precedence */ ){` |
|  276939 | 10674 | `			iFlags \|= EXPR_FLAG_LOAD_IDX_STORE;` |
|  138467 | 10675 | `		}` |
|  682031 | 10676 | `		nRhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  682031 | 10677 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pRight,iFlags);` |
|  682031 | 10678 | `		if( !bIsChainOp ){` |
|       - | 10679 | `			/* Non-chain parent: RHS nullsafe chain ends here, before the` |
|       - | 10680 | `			 * operator instruction is emitted. */` |
|  501315 | 10681 | `			GenStatePatchNullsafeJumps(pGen, nRhsNsBase);` |
|  250655 | 10682 | `		}` |
|  682031 | 10683 | `		if( iVmOp == PH7_OP_STORE ){` |
|  273377 | 10684 | `			if( pNode->pRight && (pNode->pRight->xCode == PH7_CompileList \|\|` |
|  273348 | 10685 | `				pNode->pRight->xCode == PH7_CompileShortList) ){` |
...
|       - | 10691 | `				 */` |
|      56 | 10692 | `				iVmOp = 0;` |
|  273351 | 10693 | `			}else if( (pInstr = PH7_VmPeekInstr(pGen->pVm)) != 0 ){` |
|  273325 | 10694 | `				if(pInstr->iOp == PH7_OP_MEMBER ){` |
|       - | 10695 | `					/* Perform a member store operation [i.e: $this->x = 50] */` |
|   76383 | 10696 | `					iP2 = 1;` |
|   38194 | 10697 | `				}else{` |
|  196947 | 10698 | `					if( pInstr->iOp == PH7_OP_LOAD_IDX ){` |
|       - | 10699 | `						/* Transform the STORE instruction to STORE_IDX instruction */` |
|   33457 | 10700 | `						iVmOp = PH7_OP_STORE_IDX;` |
|   33457 | 10701 | `						iP1 = pInstr->iP1;` |
|   16731 | 10702 | `					}else{` |
|  163495 | 10703 | `						p3 = pInstr->p3;` |
|       - | 10704 | `					}` |
|       - | 10705 | `					/* POP the last dynamic load instruction */` |
|  196947 | 10706 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|       - | 10707 | `				}` |
|  136665 | 10708 | `			}` |
|  545345 | 10709 | `		}else if( iVmOp == PH7_OP_STORE_REF ){` |
...
|      25 | 10724 | `		}` |
|  341013 | 10725 | `	}` |
| 1235129 | 10726 | `	if( iVmOp > 0 ){` |
| 1234923 | 10727 | `		if( iVmOp == PH7_OP_INCR \|\| iVmOp == PH7_OP_DECR ){` |
|   13609 | 10728 | `			if( pNode->iFlags & EXPR_NODE_PRE_INCR ){` |
|       - | 10729 | `				/* Pre-increment/decrement operator [i.e: ++$i,--$j ] */` |
|    9937 | 10730 | `				iP1 = 1;` |
|    4971 | 10731 | `			}` |
| 1228121 | 10732 | `		}else if( iVmOp == PH7_OP_NEW ){` |
|       - | 10733 | `			/* Namespace-qualify the class name for NEW */ {` |
|   17695 | 10734 | `				VmInstr *pPeek = PH7_VmPeekInstr(pGen->pVm);` |
|   17695 | 10735 | `				VmInstr *pCallInstr = 0;` |
|   17695 | 10736 | `				if( pPeek && pPeek->iOp == PH7_OP_CALL ){` |
|   17657 | 10737 | `					pCallInstr = pPeek;` |
|   17657 | 10738 | `					pPeek = PH7_VmPeekNextInstr(pGen->pVm);` |
|    8826 | 10739 | `				}` |
|   17695 | 10740 | `				if( pPeek && pPeek->iOp == PH7_OP_LOADC ){` |
|   17693 | 10741 | `					int bAbsolute = (pPeek->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
...
|   17693 | 10746 | `					if( pCallInstr && pCallInstr->iP2 > 0 ){` |
|      37 | 10747 | `						nLitForClass = (sxu32)(pCallInstr->iP2 - 1); /* undo +1 encoding */` |
|      21 | 10748 | `					}else{` |
|   17661 | 10749 | `						nLitForClass = (sxu32)pPeek->iP2;` |
|       - | 10750 | `					}` |
|   17693 | 10751 | `					pPeek->iP1 = 0;` |
|   17693 | 10752 | `					if( !bAbsolute ){` |
|   17677 | 10753 | `						pPeek->iP2 = (sxi32)GenStateNsQualifyName(pGen,nLitForClass,&pGen->hUseImports,0);` |
|    8841 | 10754 | `					}else{` |
|      20 | 10755 | `						pPeek->iP2 = (sxi32)nLitForClass;` |
|       - | 10756 | `					}` |
|    8844 | 10757 | `				}` |
|       - | 10758 | `			}` |
|   17695 | 10759 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|   17695 | 10760 | `			if( pInstr && pInstr->iOp == PH7_OP_CALL ){` |
|       - | 10761 | `				VmInstr *pPrev;` |
|   17657 | 10762 | `				pPrev = PH7_VmPeekNextInstr(pGen->pVm);` |
|   17657 | 10763 | `				if( pPrev == 0 \|\| pPrev->iOp != PH7_OP_MEMBER ){` |
|       - | 10764 | `					/* Pop the call instruction, preserve named-arg map */` |
|   17657 | 10765 | `					iP1 = pInstr->iP1;` |
|   17657 | 10766 | `					if( pInstr->p3 ){` |
|      43 | 10767 | `						p3 = pInstr->p3; /* Transfer VmCallArgMap to NEW */` |
|      19 | 10768 | `					}` |
|   17657 | 10769 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|    8826 | 10770 | `				}` |
|    8831 | 10771 | `			}` |
| 1212474 | 10772 | `		}else if( iVmOp == PH7_OP_IS_A ){` |
...
|      68 | 10792 | `				}` |
|      82 | 10793 | `			}` |
| 1203554 | 10794 | `		}else if( iVmOp == PH7_OP_MEMBER){` |
...
|  180721 | 10798 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|  180721 | 10799 | `			if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|  180679 | 10800 | `				pInstr->iP1 = 0;` |
|   90337 | 10801 | `			}` |
|  180721 | 10802 | `			if( pNode->pOp->iOp == EXPR_OP_DC /* '::' */){` |
...
| 1234921 | 10814 | `		if( iVmOp == PH7_OP_CALL \|\| iVmOp == PH7_OP_NEW ){` |
|  409955 | 10815 | `			p3 = GenStateAttachStrictFlag(pGen,p3);` |
|  204975 | 10816 | `		}` |
|       - | 10817 | `		/* Finally,emit the VM instruction associated with this operator */` |
| 1234921 | 10818 | `		PH7_VmEmitInstr(pGen->pVm,iVmOp,iP1,iP2,p3,0);` |
|  617458 | 10819 | `	}` |
| 1235127 | 10820 | `	if( nJmpIdx > 0 ){` |
|       - | 10821 | `		/* Fix short-circuited jumps now the destination is resolved */` |
|   13983 | 10822 | `		pInstr = PH7_VmGetInstr(pGen->pVm,nJmpIdx);` |
|   13983 | 10823 | `		if( pInstr ){` |
|   13983 | 10824 | `			pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    6989 | 10825 | `		}` |
|    6989 | 10826 | `	}` |
| 1235127 | 10827 | `	return rc;` |
| 1626155 | 10828 |  |
|       - | 10829 | `/*` |
...
|       - | 10838 | ` * message.` |
|       - | 10839 | ` */` |
|  874390 | 10840 | `static sxi32 PH7_CompileExpr(` |
...
|  874395 | 10854 | `	nExpr = 0;` |
|  874395 | 10855 | `	pRoot = 0;` |
...
|  874395 | 10858 | `	nNullsafeBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  874395 | 10859 | `	SySetInit(&sExprNode,&pGen->pVm->sAllocator,sizeof(ph7_expr_node *));` |
|  874395 | 10860 | `	SySetAlloc(&sExprNode,0x10);` |
|  874395 | 10861 | `	rc = SXRET_OK;` |
|       - | 10862 | `	/* Delimit the expression */` |
|  874395 | 10863 | `	pEnd = pGen->pIn;` |
|  874395 | 10864 | `	iNest = 0;` |
| 5852253 | 10865 | `	while( pEnd < pGen->pEnd ){` |
| 5554509 | 10866 | `		if( pEnd->nType & PH7_TK_OCB /* '{' */ ){` |
|       - | 10867 | `			/* Ticket 1433-30: Annonymous/Closure functions body */` |
|     411 | 10868 | `			iNest++;` |
| 5554306 | 10869 | `		}else if(pEnd->nType & PH7_TK_CCB /* '}' */ ){` |
|     419 | 10870 | `			iNest--;` |
| 5553896 | 10871 | `		}else if( pEnd->nType & PH7_TK_SEMI /* ';' */ ){` |
|  576949 | 10872 | `			if( iNest <= 0 ){` |
|  576651 | 10873 | `				break;` |
|       - | 10874 | `			}` |
|     149 | 10875 | `		}` |
| 4977863 | 10876 | `		pEnd++;` |
|       5 | 10877 | `	}` |
|  874395 | 10878 | `	if( iFlags & EXPR_FLAG_COMMA_STATEMENT ){` |
|   20301 | 10879 | `		SyToken *pEnd2 = pGen->pIn;` |
|   20301 | 10880 | `		iNest = 0;` |
|       - | 10881 | `		/* Stop at the first comma */` |
|   40873 | 10882 | `		while( pEnd2 < pEnd ){` |
|   20583 | 10883 | `			if( pEnd2->nType & (PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*'['*/\|PH7_TK_LPAREN/*'('*/) ){` |
|      61 | 10884 | `				iNest++;` |
|   20555 | 10885 | `			}else if(pEnd2->nType & (PH7_TK_CCB/*'}'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_RPAREN/*')'*/)){` |
|      61 | 10886 | `				iNest--;` |
|   20499 | 10887 | `			}else if( pEnd2->nType & PH7_TK_COMMA /*','*/ ){` |
|      53 | 10888 | `				if( iNest <= 0 ){` |
|       7 | 10889 | `					break;` |
|       - | 10890 | `				}` |
|      21 | 10891 | `			}` |
|   20577 | 10892 | `			pEnd2++;` |
|       5 | 10893 | `		}` |
|   20301 | 10894 | `		if( pEnd2 <pEnd ){` |
|       7 | 10895 | `			pEnd = pEnd2;` |
|       3 | 10896 | `		}` |
|   10148 | 10897 | `	}` |
|  874395 | 10898 | `	if( pEnd > pGen->pIn ){` |
|  874385 | 10899 | `		SyToken *pTmp = pGen->pEnd;` |
|       - | 10900 | `		/* Swap delimiter */` |
|  874385 | 10901 | `		pGen->pEnd = pEnd;` |
|       - | 10902 | `		/* Try to get an expression tree */` |
|  874385 | 10903 | `		rc = PH7_ExprMakeTree(&(*pGen),&sExprNode,&pRoot);` |
|  874385 | 10904 | `		if( rc == SXRET_OK && pRoot ){` |
|  874203 | 10905 | `			rc = SXRET_OK;` |
|  874203 | 10906 | `			if( xTreeValidator ){` |
|       - | 10907 | `				/* Call the upper layer validator callback */` |
|   24185 | 10908 | `				rc = xTreeValidator(&(*pGen),pRoot);` |
|   12090 | 10909 | `			}` |
|  874203 | 10910 | `			if( rc != SXERR_ABORT ){` |
|       - | 10911 | `				/* Generate code for the given tree */` |
|  874203 | 10912 | `				rc = GenStateEmitExprCode(&(*pGen),pRoot,iFlags);` |
|       - | 10913 | `				/* Patch any unresolved nullsafe jumps emitted by this` |
|       - | 10914 | `				 * expression so they short-circuit to its end. */` |
|  874203 | 10915 | `				GenStatePatchNullsafeJumps(pGen, nNullsafeBase);` |
|  437099 | 10916 | `			}` |
|  874203 | 10917 | `			nExpr = 1;` |
|  437099 | 10918 | `		}` |
|       - | 10919 | `		/* Release the whole tree */` |
|  874385 | 10920 | `		PH7_ExprFreeTree(&(*pGen),&sExprNode);` |
|       - | 10921 | `		/* Synchronize token stream */` |
|  874385 | 10922 | `		pGen->pEnd = pTmp;` |
|  874385 | 10923 | `		pGen->pIn  = pEnd;` |
|  874385 | 10924 | `		if( rc == SXERR_ABORT ){` |
|      14 | 10925 | `			SySetRelease(&sExprNode);` |
|      14 | 10926 | `			return SXERR_ABORT;` |
|       - | 10927 | `		}` |
|  437185 | 10928 | `	}` |
|  874385 | 10929 | `	SySetRelease(&sExprNode);` |
|  874385 | 10930 | `	return nExpr > 0 ? SXRET_OK : SXERR_EMPTY;` |
|  437200 | 10931 |  |
|       - | 10932 | `/*` |
|       - | 10933 | ` * Return a pointer to the node construct handler associated` |
|       - | 10934 | ` * with a given node type [i.e: string,integer,float,...].` |
|       - | 10935 | ` */` |
|  221926 | 10936 | `PH7_PRIVATE ProcNodeConstruct PH7_GetNodeHandler(sxu32 nNodeType)` |
|       5 | 10937 |  |
|  221931 | 10938 | `	if( nNodeType & PH7_TK_NUM ){` |
|       - | 10939 | `		/* Numeric literal: Either real or integer */` |
|  116713 | 10940 | `		return PH7_CompileNumLiteral;` |
|  105223 | 10941 | `	}else if( nNodeType & PH7_TK_DSTR ){` |
|       - | 10942 | `		/* Double quoted string */` |
|   21343 | 10943 | `		return PH7_CompileString;` |
|   83885 | 10944 | `	}else if( nNodeType & PH7_TK_SSTR ){` |
|       - | 10945 | `		/* Single quoted string */` |
|   83769 | 10946 | `		return PH7_CompileSimpleString;` |
...
|       - | 11074 | ` */` |
|  589886 | 11075 | `static ProcLangConstruct GenStateGetStatementHandler(` |
|       - | 11076 | `	sxu32 nKeywordID,   /* Keyword  ID*/` |
|       - | 11077 | `	SyToken *pLookahed  /* Look-ahead token */` |
|       - | 11078 | `	)` |
|       5 | 11079 |  |
|  589891 | 11080 | `	sxu32 n = 0;` |
| 3045890 | 11081 | `	for(;;){` |
| 6091785 | 11082 | `		if( n >= SX_ARRAYSIZE(aLangConstruct) ){` |
|  126835 | 11083 | `			break;` |
|       - | 11084 | `		}` |
| 5964955 | 11085 | `		if( aLangConstruct[n].nID == nKeywordID ){` |
|  463061 | 11086 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed && (pLookahed->nType & PH7_TK_OP)){` |
...
|       - | 11091 | `				}` |
|     ! 0 | 11092 | `			}` |
|  463056 | 11093 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed` |
...
|       - | 11100 | `			*/` |
|  463061 | 11101 | `			return aLangConstruct[n].xConstruct;` |
|       - | 11102 | `		}` |
| 5501899 | 11103 | `		n++;` |
|       5 | 11104 | `	}` |
|  126835 | 11105 | `	if( pLookahed ){` |
|  126835 | 11106 | `		if(nKeywordID == PH7_TKWRD_INTERFACE && (pLookahed->nType & PH7_TK_ID) ){` |
|   36397 | 11107 | `			return PH7_CompileClassInterface;` |
|   90443 | 11108 | `		}else if(nKeywordID == PH7_TKWRD_CLASS && (pLookahed->nType & PH7_TK_ID) ){` |
|   90197 | 11109 | `			return PH7_CompileClass;` |
...
|       - | 11147 | ` */` |
|  706680 | 11148 | `static sxi32 GenStateCompileChunk(` |
...
|       - | 11154 | `	sxi32 rc;` |
|  706685 | 11155 | `	rc = SXRET_OK; /* Prevent compiler warning */` |
|  550520 | 11156 | `	for(;;){` |
|  903865 | 11157 | `		int bStmtIsDeclare = 0;` |
|  903865 | 11158 | `		if( pGen->pIn >= pGen->pEnd ){` |
...
|  890213 | 11164 | `		if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|  589917 | 11165 | `			sxu32 nPeek = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  589917 | 11166 | `			if( nPeek == PH7_TKWRD_DECLARE ){` |
|      45 | 11167 | `				bStmtIsDeclare = 1;` |
|      20 | 11168 | `			}` |
|  294956 | 11169 | `		}` |
|  890213 | 11170 | `		if( !bStmtIsDeclare && pGen->pCurrent == &pGen->sGlobal ){` |
...
|  197155 | 11173 | `			pGen->bStrictTypesLocked = 1;` |
|   98575 | 11174 | `		}` |
|  890213 | 11175 | `		if( pGen->pIn->nType & PH7_TK_OCB /* '{' */ ){` |
|       - | 11176 | `			/* Compile block */` |
...
|       - | 11180 | `			}` |
|      13 | 11181 | `		}else{` |
|  890197 | 11182 | `			xCons = 0;` |
|  890197 | 11183 | `			if( GenStateStartsModifiedClass(pGen->pIn,pGen->pEnd) ){` |
...
|  890171 | 11188 | `			}else if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|  589891 | 11189 | `				sxu32 nKeyword = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|       - | 11190 | `				/* Try to extract a language construct handler */` |
|  589891 | 11191 | `				xCons = GenStateGetStatementHandler(nKeyword,(&pGen->pIn[1] < pGen->pEnd) ? &pGen->pIn[1] : 0);` |
|  589891 | 11192 | `				if( xCons == 0 && GenStateisLangConstruct(nKeyword) == FALSE ){` |
...
|       4 | 11203 | `				}` |
|  595202 | 11204 | `			}else if( (pGen->pIn->nType & PH7_TK_ID) && (&pGen->pIn[1] < pGen->pEnd)` |
|   49143 | 11205 | `				&& (pGen->pIn[1].nType & PH7_TK_COLON /*':'*/) ){` |
|       - | 11206 | `				/* Label found [i.e: Out: ],point to the routine responsible of compiling it */` |
|     117 | 11207 | `				xCons = PH7_CompileLabel;` |
|      56 | 11208 | `			}` |
|  890197 | 11209 | `			if( xCons == 0 ){` |
|       - | 11210 | `				/* Assume an expression an try to compile it */` |
|  300329 | 11211 | `				rc = PH7_CompileExpr(&(*pGen),0,0);` |
|  300329 | 11212 | `				if(  rc != SXERR_EMPTY ){` |
|       - | 11213 | `					/* Pop l-value */` |
|  300179 | 11214 | `					PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|  150087 | 11215 | `				}` |
|  150167 | 11216 | `			}else{` |
|       - | 11217 | `				/* Go compile the sucker */` |
|  589873 | 11218 | `				rc = xCons(&(*pGen));` |
|       - | 11219 | `			}` |
|  890197 | 11220 | `			if( rc == SXERR_ABORT ){` |
|       - | 11221 | `				/* Request to abort compilation */` |
|      14 | 11222 | `				break;` |
|       - | 11223 | `			}` |
|       - | 11224 | `		}` |
|       - | 11225 | `		/* Ignore trailing semi-colons ';' */` |
| 1440325 | 11226 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|  550127 | 11227 | `			pGen->pIn++;` |
|       5 | 11228 | `		}` |
|  890203 | 11229 | `		if( iFlags & PH7_COMPILE_SINGLE_STMT ){` |
...
|       - | 11245 | ` */` |
|   13664 | 11246 | `static sxi32 PH7_CompilePHP(` |
...
|       - | 11250 | `	)` |
|       5 | 11251 |  |
|   13669 | 11252 | `	SyToken *pScript = pGen->pRawIn; /* Script to compile */` |
|       - | 11253 | `	sxi32 rc;` |
|       - | 11254 | `	/* Reset the token set */` |
|   13669 | 11255 | `	SySetReset(&(*pTokenSet));` |
|       - | 11256 | `	/* Mark as the default token set */` |
|   13669 | 11257 | `	pGen->pTokenSet = &(*pTokenSet);` |
|       - | 11258 | `	/* Advance the stream cursor */` |
|   13669 | 11259 | `	pGen->pRawIn++;` |
|       - | 11260 | `	/* Tokenize the PHP chunk first */` |
|   13669 | 11261 | `	PH7_TokenizePHP(SyStringData(&pScript->sData),SyStringLength(&pScript->sData),pScript->nLine,&(*pTokenSet));` |
|       - | 11262 | `	/* Point to the head and tail of the token stream. */` |
|   13669 | 11263 | `	pGen->pIn  = (SyToken *)SySetBasePtr(pTokenSet);` |
|   13669 | 11264 | `	pGen->pEnd = &pGen->pIn[SySetUsed(pTokenSet)];` |
|   13669 | 11265 | `	if( is_expr ){` |
...
|       - | 11274 | `	}` |
|   13669 | 11275 | `	if( pGen->pIn < pGen->pEnd && ( pGen->pIn->nType & PH7_TK_EQUAL ) ){` |
...
|   13667 | 11300 | `	rc = GenStateCompileChunk(pGen,0);` |
|       - | 11301 | `	/* Fix exceptions jumps */` |
|   13667 | 11302 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|       - | 11303 | `	/* Fix gotos now, the jump destination is resolved */` |
|   13667 | 11304 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),0) ){` |
|       3 | 11305 | `		rc = SXERR_ABORT;` |
|       1 | 11306 | `	}` |
|       - | 11307 | `	/* Reset container */` |
|   13667 | 11308 | `	SySetReset(&pGen->aGoto);` |
|   13667 | 11309 | `	SySetReset(&pGen->aLabel);` |
|   13667 | 11310 | `	SySetReset(&pGen->aNullsafeJmp);` |
|       - | 11311 | `	/* Compilation result */` |
|   13667 | 11312 | `	return rc;` |
|    6837 | 11313 |  |
|       - | 11314 | `/*` |
...
|       - | 11318 | ` */` |
|   16456 | 11319 | `PH7_PRIVATE sxi32 PH7_CompileScript(` |
...
|       - | 11333 | `	sxi32 rc;` |
|   16461 | 11334 | `	if( pScript->nByte < 1 ){` |
...
|   16461 | 11340 | `	pCodeGen = &pVm->sCodeGen;` |
|   16461 | 11341 | `	bSavedStrict = pCodeGen->bStrictTypes;` |
|   16461 | 11342 | `	bSavedStrictLocked = pCodeGen->bStrictTypesLocked;` |
|   16461 | 11343 | `	pCodeGen->bStrictTypes = 0;` |
|   16461 | 11344 | `	pCodeGen->bStrictTypesLocked = 0;` |
|       - | 11345 | `	/* Initialize the tokens containers */` |
|   16461 | 11346 | `	SySetInit(&aRawToken,&pVm->sAllocator,sizeof(SyToken));` |
|   16461 | 11347 | `	SySetInit(&aPhpToken,&pVm->sAllocator,sizeof(SyToken));` |
|   16461 | 11348 | `	SySetAlloc(&aPhpToken,0xc0);` |
|   16461 | 11349 | `	is_expr = 0;` |
|   16461 | 11350 | `	if( iFlags & PH7_PHP_ONLY ){` |
|       - | 11351 | `		SyToken sTmp;` |
|       - | 11352 | `		/* PHP only: -*/` |
|    3375 | 11353 | `		sTmp.nLine = 1;` |
|    3375 | 11354 | `		sTmp.nType = PH7_TOKEN_PHP;` |
|    3375 | 11355 | `		sTmp.pUserData = 0;` |
|    3375 | 11356 | `		SyStringDupPtr(&sTmp.sData,pScript);` |
|    3375 | 11357 | `		SySetPut(&aRawToken,(const void *)&sTmp);` |
|    3375 | 11358 | `		if( iFlags & PH7_PHP_EXPR ){` |
|       - | 11359 | `			/* A simple PHP expression */` |
|     ! 0 | 11360 | `			is_expr = 1;` |
|     ! 0 | 11361 | `		}` |
|    1690 | 11362 | `	}else{` |
|       - | 11363 | `		/* Tokenize raw text */` |
|   13091 | 11364 | `		SySetAlloc(&aRawToken,32);` |
|   13091 | 11365 | `		PH7_TokenizeRawText(pScript->zString,pScript->nByte,&aRawToken);` |
|       - | 11366 | `	}` |
|       - | 11367 | `	/* Process high-level tokens */` |
|   16461 | 11368 | `	pCodeGen->pRawIn = (SyToken *)SySetBasePtr(&aRawToken);` |
|   16461 | 11369 | `	pCodeGen->pRawEnd = &pCodeGen->pRawIn[SySetUsed(&aRawToken)];` |
|   16461 | 11370 | `	rc = PH7_OK;` |
|   16461 | 11371 | `	if( is_expr ){` |
|       - | 11372 | `		/* Compile the expression */` |
|     ! 0 | 11373 | `		rc = PH7_CompilePHP(pCodeGen,&aPhpToken,TRUE);` |
|     ! 0 | 11374 | `		goto cleanup;` |
|       - | 11375 | `	}` |
|   16461 | 11376 | `	nObjIdx = 0;` |
...
|   16461 | 11380 | `	PH7_VmEmitInstr(pVm,PH7_OP_NSSWITCH,0,0,0,0);` |
|       - | 11381 | `	/* Start the compilation process */` |
|   14777 | 11382 | `	for(;;){` |
|   43211 | 11383 | `		if( pCodeGen->pRawIn >= pCodeGen->pRawEnd ){` |
|   16449 | 11384 | `			break; /* No more tokens to process */` |
|       - | 11385 | `		}` |
|   26767 | 11386 | `		if( pCodeGen->pRawIn->nType & PH7_TOKEN_PHP ){` |
|       - | 11387 | `			/* Compile the PHP chunk */` |
|   13669 | 11388 | `			rc = PH7_CompilePHP(pCodeGen,&aPhpToken,FALSE);` |
|   13669 | 11389 | `			if( rc == SXERR_ABORT ){` |
|      16 | 11390 | `				break;` |
|       - | 11391 | `			}` |
|   13657 | 11392 | `			continue;` |
|       - | 11393 | `		}` |
|       - | 11394 | `		/* Raw chunk: [i.e: HTML, XML, etc.] */` |
|   13103 | 11395 | `		nRawObj = 0;` |
|   26243 | 11396 | `		while( (pCodeGen->pRawIn < pCodeGen->pRawEnd) && (pCodeGen->pRawIn->nType != PH7_TOKEN_PHP) ){` |
|       - | 11397 | `			/* Consume the raw chunk without any processing */` |
|   13145 | 11398 | `			pRawObj = PH7_ReserveConstObj(&(*pVm),&nObjIdx);` |
|   13145 | 11399 | `			if( pRawObj == 0 ){` |
|     ! 0 | 11400 | `				rc = SXERR_MEM;` |
|     ! 0 | 11401 | `				break;` |
|       - | 11402 | `			}` |
|       - | 11403 | `			/* Mark as constant and emit the load constant instruction */` |
|   13145 | 11404 | `			PH7_MemObjInitFromString(pVm,pRawObj,&pCodeGen->pRawIn->sData);` |
|   13145 | 11405 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_LOADC,0,nObjIdx,0,0);` |
|   13145 | 11406 | `			++nRawObj;` |
|   13145 | 11407 | `			pCodeGen->pRawIn++; /* Next chunk */` |
|       5 | 11408 | `		}` |
|   13103 | 11409 | `		if( nRawObj > 0 ){` |
|       - | 11410 | `			/* Emit the consume instruction */` |
|   13103 | 11411 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_CONSUME,nRawObj,0,0,0);` |
|    6549 | 11412 | `		}` |
|    8233 | 11413 | `	}` |
|    8228 | 11414 | `cleanup:` |
|   16461 | 11415 | `	SySetRelease(&aRawToken);` |
|   16461 | 11416 | `	SySetRelease(&aPhpToken);` |
|       - | 11417 | `	/* Restore outer file's strict_types scope */` |
|   16461 | 11418 | `	pCodeGen->bStrictTypes = bSavedStrict;` |
|   16461 | 11419 | `	pCodeGen->bStrictTypesLocked = bSavedStrictLocked;` |
|   16461 | 11420 | `	return rc;` |
|    8233 | 11421 |  |
|       - | 11422 | `/*` |
|       - | 11423 | ` * Utility routines.Initialize the code generator.` |
|       - | 11424 | ` */` |
|    3304 | 11425 | `PH7_PRIVATE sxi32 PH7_InitCodeGenerator(` |
|       - | 11426 | `	ph7_vm *pVm,       /* Target VM */` |
|       - | 11427 | `	ProcConsumer xErr, /* Error log consumer callabck  */` |
|       - | 11428 | `	void *pErrData     /* Last argument to xErr() */` |
|       - | 11429 | `	)` |
|       5 | 11430 |  |
|    3309 | 11431 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|       - | 11432 | `	/* Zero the structure */` |
|    3309 | 11433 | `	SyZero(pGen,sizeof(ph7_gen_state));` |
|       - | 11434 | `	/* Initial state */` |
|    3309 | 11435 | `	pGen->pVm  = &(*pVm);` |
|    3309 | 11436 | `	pGen->xErr = xErr;` |
|    3309 | 11437 | `	pGen->pErrData = pErrData;` |
|    3309 | 11438 | `	SySetInit(&pGen->aLabel,&pVm->sAllocator,sizeof(Label));` |
|    3309 | 11439 | `	SySetInit(&pGen->aGoto,&pVm->sAllocator,sizeof(JumpFixup));` |
|    3309 | 11440 | `	SySetInit(&pGen->aNullsafeJmp,&pVm->sAllocator,sizeof(sxu32));` |
|    3309 | 11441 | `	SyHashInit(&pGen->hLiteral,&pVm->sAllocator,0,0);` |
|    3309 | 11442 | `	SyHashInit(&pGen->hVar,&pVm->sAllocator,0,0);` |
|       - | 11443 | `	/* Error log buffer */` |
|    3309 | 11444 | `	SyBlobInit(&pGen->sErrBuf,&pVm->sAllocator);` |
|       - | 11445 | `	/* General purpose working buffer */` |
|    3309 | 11446 | `	SyBlobInit(&pGen->sWorker,&pVm->sAllocator);` |
|       - | 11447 | `	/* Namespace state */` |
|    3309 | 11448 | `	SyBlobInit(&pGen->sNamespace,&pVm->sAllocator);` |
|    3309 | 11449 | `	SyHashInit(&pGen->hUseImports,&pVm->sAllocator,0,0);` |
|    3309 | 11450 | `	SyHashInit(&pGen->hUseFuncImports,&pVm->sAllocator,0,0);` |
|    3309 | 11451 | `	SyHashInit(&pGen->hUseConstImports,&pVm->sAllocator,0,0);` |
|       - | 11452 | `	/* Create the global scope */` |
|    3309 | 11453 | `	GenStateInitBlock(pGen,&pGen->sGlobal,GEN_BLOCK_GLOBAL,PH7_VmInstrLength(&(*pVm)),0);` |
|       - | 11454 | `	/* Point to the global scope */` |
|    3309 | 11455 | `	pGen->pCurrent = &pGen->sGlobal;` |
|    3309 | 11456 | `	return SXRET_OK;` |
|       5 | 11457 |  |
|       - | 11458 | `/*` |
|       - | 11459 | ` * Utility routines. Reset the code generator to it's initial state.` |
|       - | 11460 | ` */` |
|   19420 | 11461 | `PH7_PRIVATE sxi32 PH7_ResetCodeGenerator(` |
|       - | 11462 | `	ph7_vm *pVm,       /* Target VM */` |
|       - | 11463 | `	ProcConsumer xErr, /* Error log consumer callabck  */` |
|       - | 11464 | `	void *pErrData     /* Last argument to xErr() */` |
|       - | 11465 | `	)` |
|       5 | 11466 |  |
|   19425 | 11467 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|       - | 11468 | `	GenBlock *pBlock,*pParent;` |
|       - | 11469 | `	/* Reset state */` |
|   19425 | 11470 | `	SySetReset(&pGen->aLabel);` |
|   19425 | 11471 | `	SySetReset(&pGen->aGoto);` |
|   19425 | 11472 | `	SySetReset(&pGen->aNullsafeJmp);` |
|   19425 | 11473 | `	SyBlobRelease(&pGen->sErrBuf);` |
|   19425 | 11474 | `	SyBlobRelease(&pGen->sWorker);` |
|   19425 | 11475 | `	SyBlobRelease(&pGen->sNamespace);` |
|   19425 | 11476 | `	SyBlobInit(&pGen->sNamespace,&pVm->sAllocator);` |
|   19425 | 11477 | `	SyHashRelease(&pGen->hUseImports);` |
|   19425 | 11478 | `	SyHashInit(&pGen->hUseImports,&pVm->sAllocator,0,0);` |
|   19425 | 11479 | `	SyHashRelease(&pGen->hUseFuncImports);` |
|   19425 | 11480 | `	SyHashInit(&pGen->hUseFuncImports,&pVm->sAllocator,0,0);` |
|   19425 | 11481 | `	SyHashRelease(&pGen->hUseConstImports);` |
|   19425 | 11482 | `	SyHashInit(&pGen->hUseConstImports,&pVm->sAllocator,0,0);` |
...
|   19425 | 11490 | `	pBlock = pGen->pCurrent;` |
|   19425 | 11491 | `	while( pBlock->pParent != 0 ){` |
|     ! 0 | 11492 | `		pParent = pBlock->pParent;` |
|     ! 0 | 11493 | `		GenStateFreeBlock(pBlock);` |
|     ! 0 | 11494 | `		pBlock = pParent;` |
|     ! 0 | 11495 | `	}` |
|   19425 | 11496 | `	pGen->xErr = xErr;` |
|   19425 | 11497 | `	pGen->pErrData = pErrData;` |
|   19425 | 11498 | `	pGen->pCurrent = &pGen->sGlobal;` |
|   19425 | 11499 | `	pGen->pRawIn = pGen->pRawEnd = 0;` |
|   19425 | 11500 | `	pGen->pIn = pGen->pEnd = 0;` |
|   19425 | 11501 | `	pGen->nErr = 0;` |
|   19425 | 11502 | `	return SXRET_OK;` |
|       5 | 11503 |  |
|       - | 11504 | `/*` |
