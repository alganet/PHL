...
|        - |   160 | ` */` |
|  5882592 |   161 | `static void GenStateInitBlock(` |
...
|  5882597 |   170 | `	pBlock->nFirstInstr = nFirstInstr;` |
|  5882597 |   171 | `	pBlock->pUserData   = pUserData;` |
|  5882597 |   172 | `	pBlock->pGen        = pGen;` |
|  5882597 |   173 | `	pBlock->iFlags      = iType;` |
|  5882597 |   174 | `	pBlock->pParent     = 0;` |
|  5882597 |   175 | `	SySetInit(&pBlock->aJumpFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  5882597 |   176 | `	SySetInit(&pBlock->aPostContFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  5882597 |   177 | `}` |
|        - |   178 | `/*` |
...
|        - |   183 | ` */` |
|  5878720 |   184 | `static sxi32 GenStateEnterBlock(` |
...
|  5878725 |   194 | `	pBlock = (GenBlock *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(GenBlock));` |
|  5878725 |   195 | `	if( pBlock == 0 ){` |
...
|  5878725 |   204 | `	SyZero(pBlock,sizeof(GenBlock));` |
|  5878725 |   205 | `	GenStateInitBlock(&(*pGen),pBlock,iType,nFirstInstr,pUserData);` |
|        - |   206 | `	/* Link to the parent block */` |
|  5878725 |   207 | `	pBlock->pParent = pGen->pCurrent;` |
|        - |   208 | `	/* Mark as the current block */` |
|  5878725 |   209 | `	pGen->pCurrent = pBlock;` |
|  5878725 |   210 | `	if( ppBlock ){` |
|        - |   211 | `		/* Write a pointer to the new instance */` |
|  2848995 |   212 | `		*ppBlock = pBlock;` |
|  1424495 |   213 | `	}` |
|  5878725 |   214 | `	return SXRET_OK;` |
|  2939365 |   215 | `}` |
|        - |   216 | `/*` |
|        - |   217 | ` * Release block fields without freeing the whole instance.` |
|        - |   218 | ` */` |
|  5878704 |   219 | `static void GenStateReleaseBlock(GenBlock *pBlock)` |
|        5 |   220 | `{` |
|  5878709 |   221 | `	SySetRelease(&pBlock->aPostContFix);` |
|  5878709 |   222 | `	SySetRelease(&pBlock->aJumpFix);` |
|  5878709 |   223 | `}` |
|        - |   224 | `/*` |
|        - |   225 | ` * Release a block.` |
|        - |   226 | ` */` |
|  5878704 |   227 | `static void GenStateFreeBlock(GenBlock *pBlock)` |
|        5 |   228 | `{` |
|  5878709 |   229 | `	ph7_gen_state *pGen = pBlock->pGen;` |
|  5878709 |   230 | `	GenStateReleaseBlock(&(*pBlock));` |
|        - |   231 | `	/* Free the instance */` |
|  5878709 |   232 | `	SyMemBackendPoolFree(&pGen->pVm->sAllocator,pBlock);` |
|  5878709 |   233 | `}` |
|        - |   234 | `/*` |
|        - |   235 | ` * POP and release a block from the stack of compiled blocks.` |
|        - |   236 | ` */` |
|  5878704 |   237 | `static sxi32 GenStateLeaveBlock(ph7_gen_state *pGen,GenBlock **ppBlock)` |
|        5 |   238 | `{` |
|  5878709 |   239 | `	GenBlock *pBlock = pGen->pCurrent;` |
|  5878709 |   240 | `	if( pBlock == 0 ){` |
|        - |   241 | `		/* No more block to pop */` |
|      ! 0 |   242 | `		return SXERR_EMPTY;` |
|        - |   243 | `	}` |
|        - |   244 | `	/* Point to the upper block */` |
|  5878709 |   245 | `	pGen->pCurrent = pBlock->pParent;` |
|  5878709 |   246 | `	if( ppBlock ){` |
|        - |   247 | `		/* Write a pointer to the popped block */` |
|      ! 0 |   248 | `		*ppBlock = pBlock;` |
|      ! 0 |   249 | `	}else{` |
|        - |   250 | `		/* Safely release the block */` |
|  5878709 |   251 | `		GenStateFreeBlock(&(*pBlock));` |
|        - |   252 | `	}` |
|  5878709 |   253 | `	return SXRET_OK;` |
|  2939357 |   254 | `}` |
|        - |   255 | `/*` |
...
|        - |   264 | ` */` |
|  2221526 |   265 | `static sxi32 GenStateNewJumpFixup(GenBlock *pBlock,sxi32 nJumpType,sxu32 nInstrIdx)` |
|        5 |   266 | `{` |
|        - |   267 | `	JumpFixup sJumpFix;` |
|        - |   268 | `	sxi32 rc;` |
|        - |   269 | `	/* Init the JumpFixup structure */` |
|  2221531 |   270 | `	sJumpFix.nJumpType = nJumpType;` |
|  2221531 |   271 | `	sJumpFix.nInstrIdx = nInstrIdx;` |
|        - |   272 | `	/* Insert in the jump fixup table */` |
|  2221531 |   273 | `	rc = SySetPut(&pBlock->aJumpFix,(const void *)&sJumpFix);` |
|  2221531 |   274 | `	return rc;` |
|        5 |   275 | `}` |
|        - |   276 | `/*` |
...
|        - |   286 | ` */` |
|  4190384 |   287 | `static sxu32 GenStateFixJumps(GenBlock *pBlock,sxi32 nJumpType,sxu32 nJumpDest)` |
|        5 |   288 | `{` |
|        - |   289 | `	JumpFixup *aFix;` |
|        - |   290 | `	VmInstr *pInstr;` |
|        - |   291 | `	sxu32 nFixed;` |
...
|  4190389 |   294 | `	aFix = (JumpFixup *)SySetBasePtr(&pBlock->aJumpFix);` |
|        - |   295 | `	/* Fix the desired jumps */` |
|  8147899 |   296 | `	for( nFixed = n = 0 ; n < SySetUsed(&pBlock->aJumpFix) ; ++n ){` |
|  3957515 |   297 | `		if( aFix[n].nJumpType < 0 ){` |
|        - |   298 | `			/* Already fixed */` |
|  1425377 |   299 | `			continue;` |
|        - |   300 | `		}` |
|  2532143 |   301 | `		if( nJumpType > 0 && aFix[n].nJumpType != nJumpType ){` |
|        - |   302 | `			/* Not of our interest */` |
|   310619 |   303 | `			continue;` |
|        - |   304 | `		}` |
|        - |   305 | `		/* Point to the instruction to fix */` |
|  2221529 |   306 | `		pInstr = PH7_VmGetInstr(pBlock->pGen->pVm,aFix[n].nInstrIdx);` |
|  2221529 |   307 | `		if( pInstr ){` |
|  2221529 |   308 | `			pInstr->iP2 = nJumpDest;` |
|  2221529 |   309 | `			nFixed++;` |
|        - |   310 | `			/* Mark as fixed */` |
|  2221529 |   311 | `			aFix[n].nJumpType = -1;` |
|  1110762 |   312 | `		}` |
|  1110767 |   313 | `	}` |
|        - |   314 | `	/* Total number of fixed jumps */` |
|  4190389 |   315 | `	return nFixed;` |
|        5 |   316 | `}` |
|        - |   317 | `/*` |
...
|        - |   323 | ` */` |
|  1466098 |   324 | `static sxi32 GenStateFixGoto(ph7_gen_state *pGen,sxu32 nOfft)` |
|        5 |   325 | `{` |
...
|  1466103 |   332 | `	aJumps = (JumpFixup *)SySetBasePtr(&pGen->aGoto);` |
|        - |   333 | `	/* Fix */` |
|  1466249 |   334 | `	for( n = nOfft ; n < SySetUsed(&pGen->aGoto) ; ++n ){` |
...
|       46 |   357 | `		}` |
|       51 |   358 | `	}` |
|  1466101 |   359 | `	aLabel = (Label *)SySetBasePtr(&pGen->aLabel);` |
|  1466233 |   360 | `	for( n = 0 ; n < SySetUsed(&pGen->aLabel) ; ++n ){` |
...
|       12 |   365 | `		}` |
|       71 |   366 | `	}` |
|  1466101 |   367 | `	return SXRET_OK;` |
|   733054 |   368 | `}` |
|        - |   369 | `/*` |
|        - |   370 | ` * Check if a given token value is installed in the literal table.` |
|        - |   371 | ` */` |
|  7533184 |   372 | `static sxi32 GenStateFindLiteral(ph7_gen_state *pGen,const SyString *pValue,sxu32 *pIdx)` |
|        5 |   373 | `{` |
|        - |   374 | `	SyHashEntry *pEntry;` |
|  7533189 |   375 | `	pEntry = SyHashGet(&pGen->hLiteral,(const void *)pValue->zString,pValue->nByte);` |
|  7533189 |   376 | `	if( pEntry == 0 ){` |
|  1978967 |   377 | `		return SXERR_NOTFOUND;` |
|        - |   378 | `	}` |
|  5554227 |   379 | `	*pIdx = (sxu32)SX_PTR_TO_INT(pEntry->pUserData);` |
|  5554227 |   380 | `	return SXRET_OK;` |
|  3766597 |   381 | `}` |
|        - |   382 | `/*` |
...
|        - |   391 | ` */` |
|  1978962 |   392 | `static sxi32 GenStateInstallLiteral(ph7_gen_state *pGen,ph7_value *pObj,sxu32 nIdx)` |
|        5 |   393 | `{` |
|  1978967 |   394 | `	if( SyBlobLength(&pObj->sBlob) > 0 ){` |
|  1978967 |   395 | `		SyHashInsert(&pGen->hLiteral,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob),SX_INT_TO_PTR(nIdx));` |
|   989481 |   396 | `	}` |
|  1978967 |   397 | `	return SXRET_OK;` |
|        5 |   398 | `}` |
|        - |   399 | `/*` |
|        - |   400 | ` * Reserve a room for a numeric constant [i.e: 64-bit integer or real number]` |
|        - |   401 | ` * in the constant table.` |
|        - |   402 | ` */` |
|  1292112 |   403 | `static ph7_value * GenStateInstallNumLiteral(ph7_gen_state *pGen,sxu32 *pIdx)` |
|        5 |   404 | `{` |
|        - |   405 | `	ph7_value *pObj;` |
|  1292117 |   406 | `	sxu32 nIdx = 0; /* cc warning */` |
|        - |   407 | `	/* Reserve a new constant */` |
|  1292117 |   408 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  1292117 |   409 | `	if( pObj == 0 ){` |
|      ! 0 |   410 | `		PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|      ! 0 |   411 | `		return 0;` |
|        - |   412 | `	}` |
|  1292117 |   413 | `	*pIdx = nIdx;` |
|        - |   414 | `	/* TODO(chems): Create a numeric table (64bit int keys) same as` |
|        - |   415 | `	 * the constant string iterals table [optimization purposes].` |
|        - |   416 | `	 */` |
|  1292117 |   417 | `	return pObj;` |
|   646061 |   418 | `}` |
|        - |   419 | `/*` |
...
|        - |   432 | ` */` |
|  3773422 |   433 | `static void *GenStateAttachStrictFlag(ph7_gen_state *pGen, void *p3)` |
|        5 |   434 | `{` |
|        - |   435 | `	VmCallArgMap *pMap;` |
|  3773427 |   436 | `	if( !pGen->bStrictTypes ) return p3;` |
|       39 |   437 | `	if( p3 == 0 ){` |
...
|        - |   508 | ` */` |
|  1293106 |   509 | `static int GenStateFindBadNumericSeparator(` |
|        - |   510 | `	const SyString *pRaw, const char **pBadStart, sxu32 *pBadLen)` |
|        5 |   511 | `{` |
|  1293111 |   512 | `	const char *z = pRaw->zString;` |
|  1293111 |   513 | `	sxu32 n = pRaw->nByte;` |
|  1293111 |   514 | `	int base = 10;` |
|        - |   515 | `	sxu32 i, start;` |
|  1293111 |   516 | `	if( n < 2 ) return 0;` |
|   403019 |   517 | `	if( z[0] == '0' && (z[1] == 'x' \|\| z[1] == 'X') ){` |
|       80 |   518 | `		base = 16;` |
|   402980 |   519 | `	}else if( z[0] == '0' && (z[1] == 'b' \|\| z[1] == 'B') ){` |
|      284 |   520 | `		base = 2;` |
|      141 |   521 | `	}` |
|  1302985 |   522 | `	for( i = 0; i < n; ++i ){` |
|   899985 |   523 | `		if( z[i] != '_' ) continue;` |
...
|        - |   549 | ` */` |
|  1293106 |   550 | `static sxi32 GenStateValidateNumericSeparator(ph7_gen_state *pGen, SyToken *pToken)` |
|        5 |   551 | `{` |
|  1293111 |   552 | `	const char *zBad = 0;` |
|  1293111 |   553 | `	sxu32 nBad = 0;` |
|        - |   554 | `	SyString sBad;` |
|        - |   555 | `	sxi32 rc;` |
|  1293111 |   556 | `	if( !GenStateFindBadNumericSeparator(&pToken->sData, &zBad, &nBad) ){` |
|  1293097 |   557 | `		return SXRET_OK;` |
|        - |   558 | `	}` |
...
|        - |   582 | ` */` |
|  1293092 |   583 | `static sxi32 GenStateStripNumericSeparators(` |
...
|        5 |   588 | `{` |
|        - |   589 | `	sxu32 i, j;` |
|  1293097 |   590 | `	int hasUnderscore = 0;` |
|        - |   591 | `	char *zBuf;` |
|  1293097 |   592 | `	*pzAlloc = 0;` |
|  3081089 |   593 | `	for( i = 0; i < pToken->nByte; ++i ){` |
|  1788249 |   594 | `		if( pToken->zString[i] == '_' ){ hasUnderscore = 1; break; }` |
|   894001 |   595 | `	}` |
|  1293097 |   596 | `	if( !hasUnderscore ){` |
|  1292845 |   597 | `		SyStringDupPtr(pOut, pToken);` |
|  1292845 |   598 | `		return SXRET_OK;` |
|        - |   599 | `	}` |
...
|        - |   650 | ` */` |
|  1292146 |   651 | `static int GenStateIntLiteralOverflows(const SyString *pNum, ph7_real *pReal, int *pbDecimal)` |
|        5 |   652 | `{` |
|  1292151 |   653 | `	const char *z = pNum->zString;` |
|  1292151 |   654 | `	const char *zEnd = z + pNum->nByte;` |
|        - |   655 | `	const char *p, *q;` |
|        - |   656 | `	int n;` |
|  1292151 |   657 | `	*pbDecimal = FALSE;` |
|  1292151 |   658 | `	if( z >= zEnd ){` |
|      ! 0 |   659 | `		return FALSE;` |
|        - |   660 | `	}` |
|  1292151 |   661 | `	if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'x' \|\| z[1] == 'X') ){` |
...
|        - |   674 | `		}` |
|        7 |   675 | `		return TRUE;` |
|  1292075 |   676 | `	}else if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'b' \|\| z[1] == 'B') ){` |
...
|   358405 |   695 | `		p = z;` |
|   716807 |   696 | `		while( p < zEnd && p[0] == '0' ){ p++; }` |
|   358633 |   697 | `		for( q = p, n = 0; q < zEnd && q[0] >= '0' && q[0] <= '7'; q++ ){ n++; }` |
|   358405 |   698 | `		if( n <= 21 ){` |
|   358403 |   699 | `			return FALSE;` |
|        - |   700 | `		}` |
|        3 |   701 | `		{ ph7_real dv = 0;` |
...
|   933395 |   712 | `	p = z;` |
|   933395 |   713 | `	while( p < zEnd && p[0] == '0' ){ p++; }` |
|  2356505 |   714 | `	for( q = p, n = 0; q < zEnd && (unsigned char)q[0] < 0xc0 && SyisDigit(q[0]); q++ ){ n++; }` |
|   933395 |   715 | `	if( n > 19 \|\| (n == 19 && SyMemcmp(p, "9223372036854775807", 19) > 0) ){` |
|       25 |   716 | `		*pbDecimal = TRUE;` |
|       25 |   717 | `		return TRUE;` |
|        - |   718 | `	}` |
|   933371 |   719 | `	return FALSE;` |
|   646078 |   720 | `}` |
|  1293078 |   721 | `static sxi32 PH7_CompileNumLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |   722 | `{` |
|  1293083 |   723 | `	SyToken *pToken = pGen->pIn; /* Raw token */` |
|  1293083 |   724 | `	sxu32 nIdx = 0;` |
|        - |   725 | `	char zScratch[GEN_NUM_SCRATCH];` |
|  1293083 |   726 | `	char *zAlloc = 0;` |
|        - |   727 | `	SyString sNum;` |
|        - |   728 | `	sxi32 rc;` |
|   646539 |   729 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|  1293083 |   730 | `	rc = GenStateValidateNumericSeparator(pGen, pToken);` |
|  1293083 |   731 | `	if( rc != SXRET_OK ){` |
|       14 |   732 | `		return rc;` |
|        - |   733 | `	}` |
|  1939607 |   734 | `	rc = GenStateStripNumericSeparators(&pGen->pVm->sAllocator, &pToken->sData,` |
|   646534 |   735 | `		zScratch, sizeof(zScratch), &sNum, &zAlloc);` |
|  1293073 |   736 | `	if( rc != SXRET_OK ){` |
|      ! 0 |   737 | `		return SXERR_ABORT;` |
|        - |   738 | `	}` |
|  1293073 |   739 | `	if( pToken->nType & PH7_TK_INTEGER ){` |
|        - |   740 | `		ph7_value *pObj;` |
|        - |   741 | `		sxi64 iValue;` |
|  1292151 |   742 | `		ph7_real rOverflow = 0;` |
|  1292151 |   743 | `		int bDecimalOverflow = 0;` |
|  1292151 |   744 | `		if( GenStateIntLiteralOverflows(&sNum,&rOverflow,&bDecimalOverflow) ){` |
...
|        - |   759 | `			}` |
|       18 |   760 | `		}else{` |
|  1292117 |   761 | `			iValue = PH7_TokenValueToInt64(&sNum);` |
|  1292117 |   762 | `			pObj = GenStateInstallNumLiteral(&(*pGen),&nIdx);` |
|  1292117 |   763 | `			if( pObj == 0 ){` |
|      ! 0 |   764 | `				if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|      ! 0 |   765 | `				return SXERR_ABORT;` |
|        - |   766 | `			}` |
|  1292117 |   767 | `			PH7_MemObjInitFromInt(pGen->pVm,pObj,iValue);` |
|        - |   768 | `		}` |
|   646078 |   769 | `	}else{` |
|        - |   770 | `		/* Real number */` |
|        - |   771 | `		ph7_value *pObj;` |
...
|        - |   781 | `	}` |
|  1293073 |   782 | `	if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|        - |   783 | `	/* Emit the load constant instruction */` |
|  1293073 |   784 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|        - |   785 | `	/* Node successfully compiled */` |
|  1293073 |   786 | `	return SXRET_OK;` |
|   646544 |   787 | `}` |
|        - |   788 | `/*` |
...
|        - |   797 | ` *` |
|        - |   798 | ` */` |
|  3090664 |   799 | `PH7_PRIVATE sxi32 PH7_CompileSimpleString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |   800 | `{` |
|  3090669 |   801 | `	SyString *pStr = &pGen->pIn->sData; /* Constant string literal */` |
|        - |   802 | `	const char *zIn,*zCur,*zEnd;` |
|        - |   803 | `	ph7_value *pObj;` |
|        - |   804 | `	sxu32 nIdx;` |
|  3090669 |   805 | `	nIdx = 0; /* Prevent compiler warning */` |
|        - |   806 | `	/* Delimit the string */` |
|  3090669 |   807 | `	zIn  = pStr->zString;` |
|  3090669 |   808 | `	zEnd = &zIn[pStr->nByte];` |
|  3090669 |   809 | `	if( zIn >= zEnd ){` |
...
|        - |   814 | `	}` |
|  2954953 |   815 | `	if( SXRET_OK == GenStateFindLiteral(&(*pGen),pStr,&nIdx) ){` |
|        - |   816 | `		/* Already processed,emit the load constant instruction` |
|        - |   817 | `		 * and return.` |
|        - |   818 | `		 */` |
|  1905289 |   819 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|  1905289 |   820 | `		return SXRET_OK;` |
|        - |   821 | `	}` |
|        - |   822 | `	/* Reserve a new constant */` |
|  1049669 |   823 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  1049669 |   824 | `	if( pObj == 0 ){` |
...
|        - |   828 | `	}` |
|  1049669 |   829 | `	PH7_MemObjInitFromString(pGen->pVm,pObj,0);` |
|        - |   830 | `	/* Compile the node */` |
|  1049723 |   831 | `	for(;;){` |
|  2099451 |   832 | `		if( zIn >= zEnd ){` |
|        - |   833 | `			/* End of input */` |
|  1049669 |   834 | `			break;` |
|        - |   835 | `		}` |
|  1049787 |   836 | `		zCur = zIn;` |
| 20130577 |   837 | `		while( zIn < zEnd && zIn[0] != '\\' ){` |
| 19080795 |   838 | `			zIn++;` |
|        5 |   839 | `		}` |
|  1049787 |   840 | `		if( zIn > zCur ){` |
|        - |   841 | `			/* Append raw contents*/` |
|  1018785 |   842 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|   509390 |   843 | `		}` |
|  1049787 |   844 | `		zIn++;` |
|  1049787 |   845 | `		if( zIn < zEnd ){` |
|    31121 |   846 | `			if( zIn[0] == '\\' ){` |
|        - |   847 | `				/* A literal backslash */` |
|    31009 |   848 | `				PH7_MemObjStringAppend(pObj,"\\",sizeof(char));` |
|    15616 |   849 | `			}else if( zIn[0] == '\'' ){` |
|        - |   850 | `				/* A single quote */` |
...
|  1049669 |   863 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|  1049669 |   864 | `	if( pStr->nByte < 1024 ){` |
|        - |   865 | `		/* Install in the literal table */` |
|  1049669 |   866 | `		GenStateInstallLiteral(pGen,pObj,nIdx);` |
|   524832 |   867 | `	}` |
|        - |   868 | `	/* Node successfully compiled */` |
|  1049669 |   869 | `	return SXRET_OK;` |
|  1545337 |   870 | `}` |
|        - |   871 | `/*` |
...
|        - |  1035 | ` */` |
|     2482 |  1036 | `static sxi32 GenStateProcessStringExpression(` |
...
|     2487 |  1047 | `	SySetInit(&sToken,&pGen->pVm->sAllocator,sizeof(SyToken));` |
|        - |  1048 | `	/* Preallocate some slots */` |
|     2487 |  1049 | `	SySetAlloc(&sToken,0x08);` |
|        - |  1050 | `	/* Tokenize the text */` |
|     2487 |  1051 | `	PH7_TokenizePHP(zIn,(sxu32)(zEnd-zIn),nLine,&sToken,0);` |
|        - |  1052 | `	/* Swap delimiter */` |
|     2487 |  1053 | `	pTmpIn  = pGen->pIn;` |
|     2487 |  1054 | `	pTmpEnd = pGen->pEnd;` |
|     2487 |  1055 | `	pGen->pIn = (SyToken *)SySetBasePtr(&sToken);` |
|     2487 |  1056 | `	pGen->pEnd = &pGen->pIn[SySetUsed(&sToken)];` |
|        - |  1057 | `	/* Compile the expression */` |
|     2487 |  1058 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|        - |  1059 | `	/* Restore token stream */` |
|     2487 |  1060 | `	pGen->pIn  = pTmpIn;` |
|     2487 |  1061 | `	pGen->pEnd = pTmpEnd;` |
|        - |  1062 | `	/* Release the token set */` |
|     2487 |  1063 | `	SySetRelease(&sToken);` |
...
|        - |  1069 | ` */` |
|    38994 |  1070 | `static ph7_value * GenStateNewStrObj(ph7_gen_state *pGen,sxi32 *pCount)` |
|        5 |  1071 | `{` |
|        - |  1072 | `	ph7_value *pConstObj;` |
|    38999 |  1073 | `	sxu32 nIdx = 0;` |
|        - |  1074 | `	/* Reserve a new constant */` |
|    38999 |  1075 | `	pConstObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|    38999 |  1076 | `	if( pConstObj == 0 ){` |
|      ! 0 |  1077 | `		PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"PH7 engine is running out of memory");` |
|      ! 0 |  1078 | `		return 0;` |
|        - |  1079 | `	}` |
|    38999 |  1080 | `	(*pCount)++;` |
|    38999 |  1081 | `	PH7_MemObjInitFromString(pGen->pVm,pConstObj,0);` |
|        - |  1082 | `	/* Emit the load constant instruction */` |
|    38999 |  1083 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|    38999 |  1084 | `	return pConstObj;` |
|    19502 |  1085 | `}` |
|        - |  1086 | `/*` |
...
|    37466 |  1148 | `static sxi32 GenStateCompileString(ph7_gen_state *pGen,int bHeredoc)` |
|        5 |  1149 | `{` |
|    37471 |  1150 | `	SyString *pStr = &pGen->pIn->sData; /* Raw token value */` |
|        - |  1151 | `	const char *zIn,*zCur,*zEnd;` |
|    37471 |  1152 | `	ph7_value *pObj = 0;` |
|        - |  1153 | `	sxi32 iCons;` |
|        - |  1154 | `	sxi32 rc;` |
|        - |  1155 | `	/* Delimit the string */` |
|    37471 |  1156 | `	zIn  = pStr->zString;` |
|    37471 |  1157 | `	zEnd = &zIn[pStr->nByte];` |
|    37471 |  1158 | `	if( zIn >= zEnd ){` |
...
|    19788 |  1169 | `	for(;;){` |
|    63641 |  1170 | `		zCur = zIn;` |
|   217157 |  1171 | `		while( zIn < zEnd && zIn[0] != '\\'  ){` |
|   156003 |  1172 | `			if( zIn[0] == '{' && &zIn[1] < zEnd && zIn[1] == '$' ){` |
|       72 |  1173 | `				break;` |
|   155869 |  1174 | `			}else if(zIn[0] == '$' && &zIn[1] < zEnd &&` |
|     2352 |  1175 | `				(((unsigned char)zIn[1] >= 0xc0 \|\| SyisAlpha(zIn[1]) \|\| zIn[1] == '{' \|\| zIn[1] == '_')) ){` |
|     1177 |  1176 | `					break;` |
|        - |  1177 | `			}` |
|   153521 |  1178 | `			zIn++;` |
|        5 |  1179 | `		}` |
|    63641 |  1180 | `		if( zIn > zCur ){` |
|    20713 |  1181 | `			if( pObj == 0 ){` |
|    20189 |  1182 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|    20189 |  1183 | `				if( pObj == 0 ){` |
|      ! 0 |  1184 | `					return SXERR_ABORT;` |
|        - |  1185 | `				}` |
|    10092 |  1186 | `			}` |
|    20713 |  1187 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|    10354 |  1188 | `		}` |
|    63641 |  1189 | `		if( zIn >= zEnd ){` |
|    37097 |  1190 | `			break;` |
|        - |  1191 | `		}` |
|    26549 |  1192 | `		if( zIn[0] == '\\' ){` |
|    24067 |  1193 | `			const char *zPtr = 0;` |
|        - |  1194 | `			sxu32 n;` |
|    24067 |  1195 | `			zIn++;` |
|    24067 |  1196 | `			if( pObj == 0 ){` |
|    18815 |  1197 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|    18815 |  1198 | `				if( pObj == 0 ){` |
|      ! 0 |  1199 | `					return SXERR_ABORT;` |
|        - |  1200 | `				}` |
|     9405 |  1201 | `			}` |
|    24067 |  1202 | `			if( zIn >= zEnd ){` |
|        - |  1203 | `				/* Lone backslash at the very end of the body: php keeps it */` |
|        3 |  1204 | `				PH7_MemObjStringAppend(pObj,"\\",sizeof(char));` |
|        3 |  1205 | `				break;` |
|        - |  1206 | `			}` |
|    24065 |  1207 | `			n = sizeof(char); /* size of conversion */` |
|    24065 |  1208 | `			switch( zIn[0] ){` |
|       11 |  1209 | `			case '$':` |
|        - |  1210 | `				/* Dollar sign */` |
...
|    22971 |  1227 | `				PH7_MemObjStringAppend(pObj,"\n",sizeof(char));` |
|    22971 |  1228 | `				break;` |
|       21 |  1229 | `			case 'r':` |
...
|       72 |  1386 | `		}else{` |
|        - |  1387 | `			/* Simple syntax */` |
|     2349 |  1388 | `			const char *zExpr = zIn;` |
|        - |  1389 | `			/* Assemble variable name */` |
|     1197 |  1390 | `			for(;;){` |
|        - |  1391 | `				/* Jump leading dollars */` |
|     4743 |  1392 | `				while( zIn < zEnd && zIn[0] == '$' ){` |
|     2349 |  1393 | `					zIn++;` |
|        5 |  1394 | `				}` |
|     1197 |  1395 | `				for(;;){` |
|    12608 |  1396 | `					while( zIn < zEnd && (unsigned char)zIn[0] < 0xc0 && (SyisAlphaNum(zIn[0]) \|\| zIn[0] == '_' ) ){` |
|     9017 |  1397 | `						zIn++;` |
|        5 |  1398 | `					}` |
|     2399 |  1399 | `					if((unsigned char)zIn[0] >= 0xc0 ){` |
|        - |  1400 | `						/* UTF-8 stream */` |
|      ! 0 |  1401 | `						zIn++;` |
...
|        1 |  1446 | `					}` |
|        6 |  1447 | `					break;` |
|     2137 |  1448 | `				}else if( zIn[0] == '-' && &zIn[1] < zEnd && zIn[1] == '>' ){` |
|        - |  1449 | `					/* Member access operator '->' */` |
|       53 |  1450 | `					zIn += 2;` |
|     2112 |  1451 | `				}else if(zIn[0] == ':' && &zIn[1] < zEnd && zIn[1] == ':'){` |
...
|     2349 |  1459 | `			rc = GenStateProcessStringExpression(&(*pGen),pGen->pIn->nLine,zExpr,zIn);` |
|     2349 |  1460 | `			if( rc == SXERR_ABORT ){` |
|      ! 0 |  1461 | `				return SXERR_ABORT;` |
|        - |  1462 | `			}` |
|     2349 |  1463 | `			if( rc != SXERR_EMPTY ){` |
|     2347 |  1464 | `				++iCons;` |
|     1171 |  1465 | `			}` |
|        - |  1466 | `		}` |
...
|     2487 |  1468 | `		pObj = 0;` |
|        5 |  1469 | `	}/*for(;;)*/` |
|    37099 |  1470 | `	if( iCons > 1 ){` |
|        - |  1471 | `		/* Concatenate all compiled constants */` |
|     1811 |  1472 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_CAT,iCons,0,0,0);` |
|      903 |  1473 | `	}` |
|        - |  1474 | `	/* Node successfully compiled */` |
|    37099 |  1475 | `	return SXRET_OK;` |
|    18738 |  1476 | `}` |
|        - |  1477 | `/*` |
|        - |  1478 | ` * Compile a double quoted string.` |
|        - |  1479 | ` *  See the block-comment above for more information.` |
|        - |  1480 | ` */` |
|    37404 |  1481 | `PH7_PRIVATE sxi32 PH7_CompileString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |  1482 | `{` |
|        - |  1483 | `	sxi32 rc;` |
|    37409 |  1484 | `	rc = GenStateCompileString(&(*pGen),0/*bHeredoc*/);` |
|    18702 |  1485 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|        - |  1486 | `	/* Compilation result */` |
|    37409 |  1487 | `	return rc;` |
|        5 |  1488 | `}` |
|        - |  1489 | `/*` |
...
|        - |  1530 | ` */` |
|   528288 |  1531 | `static sxi32 GenStateCompileArrayEntry(` |
...
|   528293 |  1542 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|        - |  1543 | `	/* Compile the expression*/` |
|   528293 |  1544 | `	rc = PH7_CompileExpr(&(*pGen),iFlags,xValidator);` |
|        - |  1545 | `	/* Restore token stream */` |
|   528293 |  1546 | `	RE_SWAP_DELIMITER(pGen);` |
|   528293 |  1547 | `	return rc;` |
|        5 |  1548 | `}` |
|        - |  1549 | `/*` |
...
|        - |  1587 | ` */` |
|   565766 |  1588 | `static SyToken * GenStateFindTopLevelArrow(SyToken *pStart,SyToken *pEnd)` |
|        5 |  1589 | `{` |
|   565771 |  1590 | `	SyToken *pCur = pStart;` |
|   565771 |  1591 | `	sxi32 iNest = 0;` |
|  1715493 |  1592 | `	while( pCur < pEnd ){` |
|  1353225 |  1593 | `		if( (pCur->nType & PH7_TK_ARRAY_OP) && iNest <= 0 ){` |
...
|        - |  1599 | `		 */` |
|  1149731 |  1600 | `		if( iNest == 0 && (pCur->nType & PH7_TK_KEYWORD) ){` |
...
|        - |  1659 | `			}` |
|     9728 |  1660 | `		}` |
|  1149725 |  1661 | `		if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|    50787 |  1662 | `			iNest++;` |
|  1124334 |  1663 | `		}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}'*/) ){` |
...
|        - |  1676 | ` */` |
|   290118 |  1677 | `static sxi32 GenStateCompileArrayBody(ph7_gen_state *pGen)` |
|        5 |  1678 | `{` |
|        - |  1679 | `	sxi32 (*xValidator)(ph7_gen_state *,ph7_expr_node *); /* Expression tree validator callback */` |
|        - |  1680 | `	SyToken *pKey,*pCur;` |
|   290123 |  1681 | `	sxi32 iEmitRef = 0;` |
|   290123 |  1682 | `	sxi32 iSpread = 0;` |
|   290123 |  1683 | `	sxi32 nPair = 0;` |
|        - |  1684 | `	sxi32 rc;` |
|   290123 |  1685 | `	xValidator = 0;` |
|   340383 |  1686 | `	for(;;){` |
|        - |  1687 | `		/* Jump leading commas */` |
|   971601 |  1688 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA) ){` |
|   290835 |  1689 | `			pGen->pIn++;` |
|        5 |  1690 | `		}` |
|   680771 |  1691 | `		pCur = pGen->pIn;` |
|   680771 |  1692 | `		if( SXRET_OK != PH7_GetNextExpr(pGen->pIn,pGen->pEnd,&pGen->pIn) ){` |
|        - |  1693 | `			/* No more entry to process */` |
|   290107 |  1694 | `			break;` |
|        - |  1695 | `		}` |
|   390669 |  1696 | `		if( pCur >= pGen->pIn ){` |
|      ! 0 |  1697 | `			continue;` |
|        - |  1698 | `		}` |
|        - |  1699 | `		/* Compile the key if available */` |
|   390669 |  1700 | `		pKey = pCur;` |
|   390669 |  1701 | `		pCur = GenStateFindTopLevelArrow(pCur,pGen->pIn);` |
|   390669 |  1702 | `		rc = SXERR_EMPTY;` |
|   390669 |  1703 | `		if( pCur < pGen->pIn ){` |
...
|   253299 |  1725 | `			pCur = pKey;` |
|        - |  1726 | `		}` |
|   390659 |  1727 | `		if( rc == SXERR_EMPTY ){` |
|        - |  1728 | `			/* No available key,load NULL */` |
|   253301 |  1729 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,0 /* nil index */,0,0);` |
|   126648 |  1730 | `		}` |
|   390659 |  1731 | `		if( pCur->nType & PH7_TK_AMPER /*'&'*/){` |
...
|   390657 |  1750 | `		iSpread = (pCur < pGen->pIn && (pCur->nType & PH7_TK_ELLIPSIS)) ? 1 : 0;` |
|   390657 |  1751 | `		if( iSpread && (rc != SXERR_EMPTY \|\| iEmitRef) ){` |
...
|   390653 |  1764 | `		rc = GenStateCompileArrayEntry(&(*pGen),pCur,pGen->pIn,EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,xValidator);` |
|   390653 |  1765 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 |  1766 | `			return SXERR_ABORT;` |
|        - |  1767 | `		}` |
|   390653 |  1768 | `		if( iSpread ){` |
...
|   390620 |  1771 | `		}else if( iEmitRef ){` |
|        - |  1772 | `			/* Emit the load reference instruction */` |
|       41 |  1773 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_REF,0,0,0,0);` |
|       18 |  1774 | `		}` |
|   390653 |  1775 | `		xValidator = 0;` |
|   390653 |  1776 | `		iEmitRef = 0;` |
|   390653 |  1777 | `		iSpread = 0;` |
|   390653 |  1778 | `		nPair++;` |
|        5 |  1779 | `	}` |
|        - |  1780 | `	/* Emit the load map instruction */` |
|   290107 |  1781 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_MAP,nPair * 2,0,0,0);` |
|        - |  1782 | `	/* Node successfully compiled */` |
|   290107 |  1783 | `	return SXRET_OK;` |
|   145064 |  1784 | `}` |
|        - |  1785 | `/*` |
...
|        - |  1898 | ` */` |
|     1734 |  1899 | `PH7_PRIVATE sxi32 PH7_CompileShortArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |  1900 | `{` |
|        - |  1901 | `	/* Jump the leading '[', exclude trailing ']'. */` |
|     1739 |  1902 | `	pGen->pIn++;` |
|     1739 |  1903 | `	pGen->pEnd--;` |
|      867 |  1904 | `	SXUNUSED(iCompileFlag);` |
|     1739 |  1905 | `	return GenStateCompileArrayBody(pGen);` |
|        5 |  1906 | `}` |
|        - |  1907 | `/*` |
...
|        - |  3185 | ` */` |
|  9005656 |  3186 | `PH7_PRIVATE sxi32 PH7_CompileVariable(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |  3187 | `{` |
|  9005661 |  3188 | `	sxu32 nLineLocal = pGen->pIn->nLine;` |
|        - |  3189 | `	sxi32 iVv;` |
|        - |  3190 | `	sxi32 iP1;` |
|        - |  3191 | `	void *p3;` |
|        - |  3192 | `	sxi32 rc;` |
|  9005661 |  3193 | `	iVv = -1; /* Variable variable counter */` |
| 18011329 |  3194 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) ){` |
|  9005673 |  3195 | `		pGen->pIn++;` |
|  9005673 |  3196 | `		iVv++;` |
|        5 |  3197 | `	}` |
|  9005661 |  3198 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_OCB/*'{'*/)) == 0 ){` |
...
|        - |  3206 | `	}` |
|  9005661 |  3207 | `	p3  = 0;` |
|  9005661 |  3208 | `	if( pGen->pIn->nType & PH7_TK_OCB/*'{'*/ ){` |
...
|        - |  3227 | `		SyString *pName;` |
|  9005643 |  3228 | `		char *zName = 0;` |
|        - |  3229 | `		/* Extract variable name */` |
|  9005643 |  3230 | `		pName = &pGen->pIn->sData;` |
|        - |  3231 | `		/* Advance the stream cursor */` |
|  9005643 |  3232 | `		pGen->pIn++;` |
|  9005643 |  3233 | `		pEntry = SyHashGet(&pGen->hVar,(const void *)pName->zString,pName->nByte);` |
|  9005643 |  3234 | `		if( pEntry == 0 ){` |
|        - |  3235 | `			/* Duplicate name */` |
|   568997 |  3236 | `			zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|   568997 |  3237 | `			if( zName == 0 ){` |
...
|   568997 |  3242 | `			SyHashInsert(&pGen->hVar,zName,pName->nByte,zName);` |
|   284501 |  3243 | `		}else{` |
|        - |  3244 | `			/* Name already available */` |
|  8436651 |  3245 | `			zName = (char *)pEntry->pUserData;` |
|        - |  3246 | `		}` |
|  9005643 |  3247 | `		p3 = (void *)zName;` |
|        - |  3248 | `	}` |
|  9005657 |  3249 | `	iP1 = 0;` |
|  9005657 |  3250 | `	if( iCompileFlag & EXPR_FLAG_RDONLY_LOAD ){` |
|  2725511 |  3251 | `		if( (iCompileFlag & EXPR_FLAG_LOAD_IDX_STORE) == 0 ){` |
|        - |  3252 | `			/* Read-only load.In other words do not create the variable if inexistant */` |
|  2725481 |  3253 | `			iP1 = 1;` |
|  1362738 |  3254 | `		}` |
|  1362753 |  3255 | `	}` |
|        - |  3256 | `	/* Emit the load instruction */` |
|  9005657 |  3257 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,0,p3,0);` |
|  9005669 |  3258 | `	while( iVv > 0 ){` |
|       13 |  3259 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,0,0,0);` |
|       13 |  3260 | `		iVv--;` |
|        1 |  3261 | `	}` |
|        - |  3262 | `	/* Node successfully compiled */` |
|  9005657 |  3263 | `	return SXRET_OK;` |
|  4502833 |  3264 | `}` |
|        - |  3265 | `/*` |
|        - |  3266 | ` * Load a literal.` |
|        - |  3267 | ` */` |
|  5685034 |  3268 | `static sxi32 GenStateLoadLiteral(ph7_gen_state *pGen)` |
|        5 |  3269 | `{` |
|  5685039 |  3270 | `	SyToken *pToken = pGen->pIn;` |
|        - |  3271 | `	ph7_value *pObj;` |
|        - |  3272 | `	SyString *pStr;` |
|        - |  3273 | `	sxu32 nIdx;` |
|        - |  3274 | `	/* Extract token value */` |
|  5685039 |  3275 | `	pStr = &pToken->sData;` |
|        - |  3276 | `	/* Deal with the reserved literals [i.e: null,false,true,...] first */` |
|  5685039 |  3277 | `	if( pStr->nByte == sizeof("NULL") - 1 ){` |
|  1366653 |  3278 | `		if( SyStrnicmp(pStr->zString,"null",sizeof("NULL")-1) == 0 ){` |
|        - |  3279 | `			/* NULL constant are always indexed at 0 */` |
|   558499 |  3280 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,0,0,0);` |
|   558499 |  3281 | `			return SXRET_OK;` |
|   808159 |  3282 | `		}else if( SyStrnicmp(pStr->zString,"true",sizeof("TRUE")-1) == 0 ){` |
...
|        5 |  3286 | `		}` |
|  5142044 |  3287 | `	}else if (pStr->nByte == sizeof("FALSE") - 1 &&` |
|   987286 |  3288 | `		SyStrnicmp(pStr->zString,"false",sizeof("FALSE")-1) == 0 ){` |
|        - |  3289 | `			/* FALSE constant are always indexed at 2 */` |
|   395587 |  3290 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,2,0,0);` |
|   395587 |  3291 | `			return SXRET_OK;` |
|  4217892 |  3292 | `	}else if(pStr->nByte == sizeof("__LINE__") - 1 &&` |
|   590166 |  3293 | `		SyMemcmp(pStr->zString,"__LINE__",sizeof("__LINE__")-1) == 0 ){` |
...
|  3940525 |  3304 | `	}else if( pStr->nByte == sizeof("__NAMESPACE__") - 1 &&` |
...
|  3932999 |  3321 | `	}else if( (pStr->nByte == sizeof("__FUNCTION__") - 1 &&` |
|   151577 |  3322 | `		SyMemcmp(pStr->zString,"__FUNCTION__",sizeof("__FUNCTION__")-1) == 0) \|\|` |
|  4019095 |  3323 | `		(pStr->nByte == sizeof("__METHOD__") - 1 &&` |
|   215852 |  3324 | `		SyMemcmp(pStr->zString,"__METHOD__",sizeof("__METHOD__")-1) == 0) ){` |
...
|  4571191 |  3354 | `	if( SXRET_OK != GenStateFindLiteral(&(*pGen),&pToken->sData,&nIdx) ){` |
|        - |  3355 | `		ph7_value *pLitObj;` |
|        - |  3356 | `		/* Unknown literal,install it in the literal table */` |
|   924941 |  3357 | `		pLitObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   924941 |  3358 | `		if( pLitObj == 0 ){` |
|      ! 0 |  3359 | `			PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|      ! 0 |  3360 | `			return SXERR_ABORT;` |
|        - |  3361 | `		}` |
|   924941 |  3362 | `		PH7_MemObjInitFromString(pGen->pVm,pLitObj,&pToken->sData);` |
|   924941 |  3363 | `		GenStateInstallLiteral(&(*pGen),pLitObj,nIdx);` |
|   462468 |  3364 | `	}` |
|        - |  3365 | `	/* Emit the load constant instruction */` |
|  4571191 |  3366 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,1,nIdx,0,0);` |
|  4571191 |  3367 | `	return SXRET_OK;` |
|  2842522 |  3368 | `}` |
|        - |  3369 | `/*` |
...
|        - |  3374 | ` */` |
|  5688954 |  3375 | `static sxi32 GenStateResolveNamespaceLiteral(ph7_gen_state *pGen)` |
|        5 |  3376 | `{` |
|        - |  3377 | `	sxi32 rc;` |
|  5688959 |  3378 | `	if( pGen->pIn >= pGen->pEnd ){` |
|      ! 0 |  3379 | `		return SXRET_OK;` |
|        - |  3380 | `	}` |
|        - |  3381 | `	/* Check if this is a multi-token namespace path */` |
|  5688959 |  3382 | `	if( pGen->pIn < &pGen->pEnd[-1] ){` |
...
|  5685039 |  3435 | `	rc = GenStateLoadLiteral(&(*pGen));` |
|  5685039 |  3436 | `	return rc;` |
|  2844482 |  3437 | `}` |
|        - |  3438 | `/*` |
...
|      ! 0 |  3453 | `}` |
|  5688954 |  3454 | `PH7_PRIVATE sxi32 PH7_CompileLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |  3455 | `{` |
|        - |  3456 | `	sxi32 rc;` |
|  5688959 |  3457 | `	rc = GenStateResolveNamespaceLiteral(&(*pGen));` |
|  5688959 |  3458 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  3459 | `		SXUNUSED(iCompileFlag); /* cc warning */` |
|      ! 0 |  3460 | `		return rc;` |
|        - |  3461 | `	}` |
|        - |  3462 | `	/* Node successfully compiled */` |
|  5688959 |  3463 | `	return SXRET_OK;` |
|  2844482 |  3464 | `}` |
|        - |  3465 | `/*` |
...
|        - |  3480 | ` */` |
|   143484 |  3481 | `static int GenStateIsReservedConstant(SyString *pName)` |
|        5 |  3482 | `{` |
|   143489 |  3483 | `	if( pName->nByte == sizeof("null") - 1 ){` |
|       47 |  3484 | `		if( SyStrnicmp(pName->zString,"null",sizeof("null")-1) == 0 ){` |
|        3 |  3485 | `			return TRUE;` |
|       45 |  3486 | `		}else if( SyStrnicmp(pName->zString,"true",sizeof("true")-1) == 0 ){` |
|        6 |  3487 | `			return TRUE;` |
|        2 |  3488 | `		}` |
|   143464 |  3489 | `	}else if( pName->nByte == sizeof("false") - 1 ){` |
|       22 |  3490 | `		if( SyStrnicmp(pName->zString,"false",sizeof("false")-1) == 0 ){` |
|        3 |  3491 | `			return TRUE;` |
|        - |  3492 | `		}` |
|        9 |  3493 | `	}` |
|        - |  3494 | `	/* Not a reserved constant */` |
|   143481 |  3495 | `	return FALSE;` |
|    71747 |  3496 | `}` |
|        - |  3497 | `/*` |
...
|        - |  4020 | ` * message.` |
|        - |  4021 | ` */` |
|  3031152 |  4022 | `static sxi32 PH7_CompileBlock(` |
...
|        - |  4027 | `	sxi32 rc;` |
|        - |  4028 | `	sxu32 nLine;` |
|  3031157 |  4029 | `	if( pGen->pIn->nType & PH7_TK_OCB /* '{' */ ){` |
|  3029735 |  4030 | `		nLine = pGen->pIn->nLine;` |
|  3029735 |  4031 | `		rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_STD,PH7_VmInstrLength(pGen->pVm),0,0);` |
|  3029735 |  4032 | `		if( rc != SXRET_OK ){` |
|      ! 0 |  4033 | `			return SXERR_ABORT;` |
|        - |  4034 | `		}` |
|  3029735 |  4035 | `		pGen->pIn++;` |
|        - |  4036 | `		/* Compile until we hit the closing braces '}' */` |
|  4449838 |  4037 | `		for(;;){` |
|  8899681 |  4038 | `			if( pGen->pIn >= pGen->pEnd ){` |
...
|        - |  4047 | `				}` |
|      ! 0 |  4048 | `			}` |
|  8899661 |  4049 | `			if( pGen->pIn->nType & PH7_TK_CCB/*'}'*/ ){` |
|        - |  4050 | `				/* Closing braces found,break immediately*/` |
|  3029715 |  4051 | `				pGen->pIn++;` |
|  3029715 |  4052 | `				break;` |
|        - |  4053 | `			}` |
|        - |  4054 | `			/* Compile a single statement */` |
|  5869951 |  4055 | `			rc = GenStateCompileChunk(&(*pGen),PH7_COMPILE_SINGLE_STMT);` |
|  5869951 |  4056 | `			if( rc == SXERR_ABORT ){` |
|      ! 0 |  4057 | `				return SXERR_ABORT;` |
|        - |  4058 | `			}` |
|        5 |  4059 | `		}` |
|  3029735 |  4060 | `		GenStateLeaveBlock(&(*pGen),0);` |
|  1516292 |  4061 | `	}else if( (pGen->pIn->nType & PH7_TK_COLON /* ':' */) && nKeywordEnd > 0 ){` |
|      ! 0 |  4062 | `		pGen->pIn++;` |
...
|  3031157 |  4111 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|      ! 0 |  4112 | `		pGen->pIn++;` |
|      ! 0 |  4113 | `	}` |
|  3031157 |  4114 | `	return SXRET_OK;` |
|  1515581 |  4115 | `}` |
|        - |  4116 | `/*` |
...
|        - |  4517 | ` * are allowed.` |
|        - |  4518 | ` */` |
|   240892 |  4519 | `static sxi32 GenStateForEachNodeValidator(ph7_gen_state *pGen,ph7_expr_node *pRoot)` |
|        5 |  4520 | `{` |
|   240897 |  4521 | `	sxi32 rc = SXRET_OK; /* Assume a valid expression tree */` |
|   240897 |  4522 | `	if( pRoot->xCode != PH7_CompileVariable ){` |
...
|        - |  4557 | ` */` |
|   174848 |  4558 | `static sxi32 PH7_CompileForeach(ph7_gen_state *pGen)` |
|        5 |  4559 | `{` |
|   174853 |  4560 | `	SyToken *pCur,*pTmp,*pEnd = 0;` |
|   174853 |  4561 | `	SyToken *pListStart = 0,*pListEnd = 0;` |
|   174853 |  4562 | `	GenBlock *pForeachBlock = 0;` |
|        - |  4563 | `	ph7_foreach_info *pInfo;` |
|        - |  4564 | `	sxu32 nFalseJump;` |
|        - |  4565 | `	VmInstr *pInstr;` |
|        - |  4566 | `	sxu32 nLine;` |
|        - |  4567 | `	sxi32 rc;` |
|   174853 |  4568 | `	nLine = pGen->pIn->nLine;` |
|        - |  4569 | `	/* Jump the 'foreach' keyword */` |
|   174853 |  4570 | `	pGen->pIn++;` |
|   174853 |  4571 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|        - |  4572 | `		/* Syntax error */` |
...
|   174853 |  4581 | `	pGen->pIn++;` |
|        - |  4582 | `	/* Create the loop block */` |
|   174853 |  4583 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pForeachBlock);` |
|   174853 |  4584 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  4585 | `		return SXERR_ABORT;` |
|        - |  4586 | `	}` |
|        - |  4587 | `	/* Delimit the expression */` |
|   174853 |  4588 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   174853 |  4589 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|   174853 |  4604 | `	pCur = pGen->pIn;` |
|  1021873 |  4605 | `	while( pCur < pEnd ){` |
|  1021873 |  4606 | `		if( pCur->nType & PH7_TK_KEYWORD ){` |
|   178739 |  4607 | `			sxi32 nKeywrd = SX_PTR_TO_INT(pCur->pUserData);` |
|   178739 |  4608 | `			if( nKeywrd == PH7_TKWRD_AS ){` |
...
|   174853 |  4626 | `	pTmp = pGen->pEnd;` |
|   174853 |  4627 | `	pGen->pEnd = pCur;` |
|   174853 |  4628 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   174853 |  4629 | `	if( rc == SXERR_ABORT ){` |
|        - |  4630 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|      ! 0 |  4631 | `		return SXERR_ABORT;` |
|        - |  4632 | `	}` |
|        - |  4633 | `	/* Update token stream */` |
|   174853 |  4634 | `	while(pGen->pIn < pCur ){` |
...
|      ! 0 |  4640 | `		pGen->pIn++;` |
|      ! 0 |  4641 | `	}` |
|   174853 |  4642 | `	pCur++; /* Jump the 'as' keyword */` |
|   174853 |  4643 | `	pGen->pIn = pCur;` |
|   174853 |  4644 | `	if( pGen->pIn >= pEnd ){` |
...
|   174853 |  4651 | `	pInfo = (ph7_foreach_info *)SyMemBackendAlloc(&pGen->pVm->sAllocator,sizeof(ph7_foreach_info));` |
|   174853 |  4652 | `	if( pInfo == 0 ){` |
...
|   174853 |  4657 | `	SyZero(pInfo,sizeof(ph7_foreach_info));` |
|        - |  4658 | `	/* Initialize structure fields */` |
|   174853 |  4659 | `	SySetInit(&pInfo->aStep,&pGen->pVm->sAllocator,sizeof(ph7_foreach_step *));` |
...
|        - |  4662 | `	 * '=>'. */` |
|   174853 |  4663 | `	pCur = GenStateFindTopLevelArrow(pCur,pEnd);` |
|   174853 |  4664 | `	if( pCur < pEnd ){` |
...
|    33032 |  4687 | `	}` |
|   174853 |  4688 | `	pGen->pEnd = pEnd;` |
|   174853 |  4689 | `	if( pGen->pIn >= pEnd ){` |
...
|   174848 |  4744 | `	}else if( pGen->pIn->nType & PH7_TK_OSB ){` |
...
|   174833 |  4777 | `		rc = PH7_CompileExpr(&(*pGen),0,GenStateForEachNodeValidator);` |
|   174833 |  4778 | `		if( rc == SXERR_ABORT ){` |
|        - |  4779 | `			/* Don't worry about freeing memory, everything will be released shortly */` |
|      ! 0 |  4780 | `			return SXERR_ABORT;` |
|        - |  4781 | `		}` |
|   174833 |  4782 | `		pInstr = PH7_VmPopInstr(pGen->pVm);` |
|   174833 |  4783 | `		if( pInstr->p3 ){` |
|        - |  4784 | `			/* Record value name */` |
|   174833 |  4785 | `			SyStringInitFromBuf(&pInfo->sValue,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|    87414 |  4786 | `		}` |
|        - |  4787 | `	}` |
|        - |  4788 | `	/* Emit the 'FOREACH_INIT' instruction */` |
|   174851 |  4789 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_FOREACH_INIT,0,0,pInfo,&nFalseJump);` |
|        - |  4790 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   174851 |  4791 | `	GenStateNewJumpFixup(pForeachBlock,PH7_OP_FOREACH_INIT,nFalseJump);` |
|        - |  4792 | `	/* Record the first instruction to execute */` |
|   174851 |  4793 | `	pForeachBlock->nFirstInstr = PH7_VmInstrLength(pGen->pVm);` |
|        - |  4794 | `	/* Emit the FOREACH_STEP instruction */` |
|   174851 |  4795 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_FOREACH_STEP,0,0,pInfo,&nFalseJump);` |
|        - |  4796 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   174851 |  4797 | `	GenStateNewJumpFixup(pForeachBlock,PH7_OP_FOREACH_STEP,nFalseJump);` |
|        - |  4798 | `	/* If list() unpacking, emit bytecode to destructure the temp variable */` |
|   174851 |  4799 | `	if( (pInfo->iFlags & PH7_4EACH_STEP_LIST) && pListStart && pListEnd ){` |
...
|   174851 |  4827 | `	pGen->pIn = &pEnd[1];` |
|   174851 |  4828 | `	pGen->pEnd = pTmp;` |
|   174851 |  4829 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_END4EACH);` |
|   174851 |  4830 | `	if( rc == SXERR_ABORT ){` |
...
|   174851 |  4835 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pForeachBlock->nFirstInstr,0,0);` |
|        - |  4836 | `	/* Fix all jumps now the destination is resolved */` |
|   174851 |  4837 | `	GenStateFixJumps(pForeachBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|        - |  4838 | `	/* Release the loop block */` |
|   174851 |  4839 | `	GenStateLeaveBlock(pGen,0);` |
|        - |  4840 | `	/* Statement successfully compiled */` |
|   174851 |  4841 | `	return SXRET_OK;` |
|        1 |  4842 | `Synchronize:` |
...
|        - |  4881 | ` *    ?>` |
|        - |  4882 | ` */` |
|  1195166 |  4883 | `static sxi32 PH7_CompileIf(ph7_gen_state *pGen)` |
|        5 |  4884 | `{` |
|  1195171 |  4885 | `	SyToken *pToken,*pTmp,*pEnd = 0;` |
|  1195171 |  4886 | `	GenBlock *pCondBlock = 0;` |
|        - |  4887 | `	sxu32 nJumpIdx;` |
|        - |  4888 | `	sxu32 nKeyID;` |
|        - |  4889 | `	sxi32 rc;` |
|        - |  4890 | `	/* Jump the 'if' keyword */` |
|  1195171 |  4891 | `	pGen->pIn++;` |
|  1195171 |  4892 | `	pToken = pGen->pIn;` |
|        - |  4893 | `	/* Create the conditional block */` |
|  1195171 |  4894 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_COND,PH7_VmInstrLength(pGen->pVm),0,&pCondBlock);` |
|  1195171 |  4895 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  4896 | `		return SXERR_ABORT;` |
|        - |  4897 | `	}` |
|        - |  4898 | `	/* Process as many [if/else if/elseif/else] blocks as we can */` |
|   644106 |  4899 | `	for(;;){` |
|  1288217 |  4900 | `		if( pToken >= pGen->pEnd \|\| (pToken->nType & PH7_TK_LPAREN) == 0 ){` |
|        - |  4901 | `			/* Syntax error */` |
...
|  1288217 |  4915 | `		PH7_DelimitNestedTokens(pToken,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|  1288217 |  4916 | `		if( pToken >= pEnd \|\| (pEnd->nType & PH7_TK_RPAREN) == 0 ){` |
|        - |  4917 | `			/* Syntax error */` |
...
|  1288209 |  4929 | `		SWAP_TOKEN_STREAM(pGen,pToken,pEnd);` |
|        - |  4930 | `		/* Compile the condition */` |
|  1288209 |  4931 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|        - |  4932 | `		/* Update token stream */` |
|  1288209 |  4933 | `		while(pGen->pIn < pEnd ){` |
|      ! 0 |  4934 | `			PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Unexpected token '%z'",&pGen->pIn->sData);` |
|      ! 0 |  4935 | `			pGen->pIn++;` |
|      ! 0 |  4936 | `		}` |
|  1288209 |  4937 | `		pGen->pIn  = &pEnd[1];` |
|  1288209 |  4938 | `		pGen->pEnd = pTmp;` |
|  1288209 |  4939 | `		if( rc == SXERR_ABORT ){` |
|        - |  4940 | `			/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|      ! 0 |  4941 | `			return SXERR_ABORT;` |
|        - |  4942 | `		}` |
|        - |  4943 | `		/* Emit the false jump */` |
|  1288209 |  4944 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nJumpIdx);` |
|        - |  4945 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|  1288209 |  4946 | `		GenStateNewJumpFixup(pCondBlock,PH7_OP_JZ,nJumpIdx);` |
|        - |  4947 | `		/* Compile the body */` |
|  1288209 |  4948 | `		rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDIF);` |
|  1288209 |  4949 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 |  4950 | `			return SXERR_ABORT;` |
|        - |  4951 | `		}` |
|  1288209 |  4952 | `		if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
|   239011 |  4953 | `			break;` |
|        - |  4954 | `		}` |
|        - |  4955 | `		/* Ensure that the keyword ID is 'else if' or 'else' */` |
|   810197 |  4956 | `		nKeyID = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   810197 |  4957 | `		if( (nKeyID & (PH7_TKWRD_ELSE\|PH7_TKWRD_ELIF)) == 0 ){` |
|   631495 |  4958 | `			break;` |
|        - |  4959 | `		}` |
|        - |  4960 | `		/* Emit the unconditional jump */` |
|   178707 |  4961 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,0,0,&nJumpIdx);` |
|        - |  4962 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   178707 |  4963 | `		GenStateNewJumpFixup(pCondBlock,PH7_OP_JMP,nJumpIdx);` |
|   178707 |  4964 | `		if( nKeyID & PH7_TKWRD_ELSE ){` |
|   170845 |  4965 | `			pToken = &pGen->pIn[1];` |
|   170845 |  4966 | `			if( pToken >= pGen->pEnd \|\| (pToken->nType & PH7_TK_KEYWORD) == 0 \|\|` |
...
|  1195163 |  4979 | `	GenStateFixJumps(pCondBlock,PH7_OP_JZ,PH7_VmInstrLength(pGen->pVm));` |
|  1195163 |  4980 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|   717146 |  4981 | `		(SX_PTR_TO_INT(pGen->pIn->pUserData) & PH7_TKWRD_ELSE) ){` |
|        - |  4982 | `			/* Compile the else block */` |
|    85661 |  4983 | `			pGen->pIn++;` |
|    85661 |  4984 | `			rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDIF);` |
|    85661 |  4985 | `			if( rc == SXERR_ABORT ){` |
|        - |  4986 |  |
|      ! 0 |  4987 | `				return SXERR_ABORT;` |
|        - |  4988 | `			}` |
|    42828 |  4989 | `	}` |
|  1195163 |  4990 | `	nJumpIdx = PH7_VmInstrLength(pGen->pVm);` |
|        - |  4991 | `	/* Fix all unconditional jumps now the destination is resolved */` |
|  1195163 |  4992 | `	GenStateFixJumps(pCondBlock,PH7_OP_JMP,nJumpIdx);` |
|        - |  4993 | `	/* Release the conditional block */` |
|  1195163 |  4994 | `	GenStateLeaveBlock(pGen,0);` |
|        - |  4995 | `	/* Statement successfully compiled */` |
|  1195163 |  4996 | `	return SXRET_OK;` |
|        4 |  4997 | `Synchronize:` |
...
|        - |  5097 | ` */` |
|  1639878 |  5098 | `static sxi32 PH7_CompileReturn(ph7_gen_state *pGen)` |
|        5 |  5099 | `{` |
|  1639883 |  5100 | `	sxi32 nRet = 0; /* TRUE if there is a return value */` |
|        - |  5101 | `	sxi32 rc;` |
|  1639883 |  5102 | `	sxu32 nLine = pGen->pIn->nLine;` |
|  1639883 |  5103 | `	GenBlock *pFuncBlock = pGen->pCurrent;` |
...
|  4279535 |  5109 | `	while( pFuncBlock && (pFuncBlock->iFlags & GEN_BLOCK_FUNC) == 0 ){` |
|  2639657 |  5110 | `		pFuncBlock = pFuncBlock->pParent;` |
|        5 |  5111 | `	}` |
|  1639878 |  5112 | `	if( pFuncBlock && pFuncBlock->pUserData` |
|  1639851 |  5113 | `	 && ((ph7_vm_func *)pFuncBlock->pUserData)->nReturnType == MEMOBJ_NEVER ){` |
...
|  1639883 |  5121 | `	pGen->pIn++;` |
|  1639883 |  5122 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|        - |  5123 | `		/* Compile the expression */` |
|  1624365 |  5124 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|  1624365 |  5125 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 |  5126 | `			return SXERR_ABORT;` |
|  1624365 |  5127 | `		}else if(rc != SXERR_EMPTY ){` |
|  1624365 |  5128 | `			nRet = 1;` |
|   812180 |  5129 | `		}` |
|   812180 |  5130 | `	}` |
...
|  1639883 |  5135 | `	if( pGen->bInGenerator ){` |
...
|  1639855 |  5144 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,nRet,1,0,0);` |
|  1639855 |  5145 | `	return SXRET_OK;` |
|   819944 |  5146 | `}` |
|        - |  5147 | `/*` |
...
|        - |  5258 | ` */` |
|    17334 |  5259 | `static sxi32 PH7_CompileEcho(ph7_gen_state *pGen)` |
|        5 |  5260 | `{` |
|    17339 |  5261 | `	SyToken *pTmp,*pNext = 0;` |
|        - |  5262 | `	sxi32 rc;` |
|        - |  5263 | `	/* Jump the 'echo' keyword */` |
|    17339 |  5264 | `	pGen->pIn++;` |
|        - |  5265 | `	/* Compile arguments one after one */` |
|    17339 |  5266 | `	pTmp = pGen->pEnd;` |
|    42601 |  5267 | `	while( SXRET_OK == PH7_GetNextExpr(pGen->pIn,pTmp,&pNext) ){` |
|    25267 |  5268 | `		if( pGen->pIn < pNext ){` |
|    25267 |  5269 | `			pGen->pEnd = pNext;` |
|    25267 |  5270 | `			rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_RDONLY_LOAD/* Do not create variable if inexistant */,0);` |
|    25267 |  5271 | `			if( rc == SXERR_ABORT ){` |
|      ! 0 |  5272 | `				return SXERR_ABORT;` |
|    25267 |  5273 | `			}else if( rc != SXERR_EMPTY ){` |
|        - |  5274 | `				/* Emit the consume instruction */` |
|    25243 |  5275 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_CONSUME,1,0,0,0);` |
|    12619 |  5276 | `			}` |
|    12631 |  5277 | `		}` |
|        - |  5278 | `		/* Jump trailing commas */` |
|    33195 |  5279 | `		while( pNext < pTmp && (pNext->nType & PH7_TK_COMMA) ){` |
|     7933 |  5280 | `			pNext++;` |
|        5 |  5281 | `		}` |
|    25267 |  5282 | `		pGen->pIn = pNext;` |
|        5 |  5283 | `	}` |
|        - |  5284 | `	/* Restore token stream */` |
|    17339 |  5285 | `	pGen->pEnd = pTmp;` |
|    17339 |  5286 | `	return SXRET_OK;` |
|     8672 |  5287 | `}` |
|        - |  5288 | `/*` |
...
|        - |  5467 | ` */` |
|  2950112 |  5468 | `static sxu32 GenStateNsQualifyName(ph7_gen_state *pGen,sxu32 nOrigIdx,SyHash *pImports,int *pFromImport)` |
|        5 |  5469 | `{` |
|        - |  5470 | `	ph7_value *pLit;` |
...
|        - |  5478 | `	ph7_value *pNew;` |
|  2950117 |  5479 | `	if( pFromImport ){` |
|  2404863 |  5480 | `		*pFromImport = 0;` |
|  1202429 |  5481 | `	}` |
|  2950117 |  5482 | `	pLit = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,nOrigIdx);` |
|  2950117 |  5483 | `	if( !pLit \|\| !(pLit->iFlags & MEMOBJ_STRING) \|\| SyBlobLength(&pLit->sBlob) == 0 ){` |
|      ! 0 |  5484 | `		return nOrigIdx;` |
|        - |  5485 | `	}` |
|  2950117 |  5486 | `	zLit = (const char *)SyBlobData(&pLit->sBlob);` |
|  2950117 |  5487 | `	nLit = (sxu32)SyBlobLength(&pLit->sBlob);` |
|        - |  5488 | `	/* Skip if already qualified (contains backslash) */` |
|  2950117 |  5489 | `	hasNsSep = 0;` |
| 37953785 |  5490 | `	for( k = 0; k < nLit; k++ ){` |
| 35003681 |  5491 | `		if( zLit[k] == '\\' ){ hasNsSep = 1; break; }` |
| 17501839 |  5492 | `	}` |
|  2950117 |  5493 | `	if( hasNsSep ){` |
|       11 |  5494 | `		return nOrigIdx;` |
|        - |  5495 | `	}` |
|        - |  5496 | `	/* Check use imports first (works even outside namespaces) */` |
|  2950109 |  5497 | `	SyBlobReset(&pGen->sWorker);` |
|  2950109 |  5498 | `	pImport = SyHashGet(pImports,(const void *)zLit,nLit);` |
|  2950109 |  5499 | `	if( pImport ){` |
...
|        8 |  5504 | `		}` |
|       23 |  5505 | `	}else{` |
|  2950073 |  5506 | `		if( SyBlobLength(&pGen->sNamespace) == 0 ){` |
|  2949983 |  5507 | `			return nOrigIdx; /* Not in a namespace and no import match */` |
|        - |  5508 | `		}` |
...
|        - |  5530 | ` */` |
|   187258 |  5531 | `static void GenStateResolveName(ph7_gen_state *pGen,const SyString *pName,SyBlob *pOut)` |
|        5 |  5532 | `{` |
|        - |  5533 | `	SyHashEntry *pImport;` |
|        - |  5534 | `	/* Check use imports first */` |
|   187263 |  5535 | `	pImport = SyHashGet(&pGen->hUseImports,(const void *)pName->zString,pName->nByte);` |
|   187263 |  5536 | `	if( pImport ){` |
...
|        - |  5552 | ` */` |
|   265222 |  5553 | `static void GenStateBuildFQN(ph7_gen_state *pGen,const SyString *pName,SyBlob *pOut)` |
|        5 |  5554 | `{` |
|   265227 |  5555 | `	if( SyBlobLength(&pGen->sNamespace) > 0 ){` |
|     3935 |  5556 | `		SyBlobAppend(pOut,SyBlobData(&pGen->sNamespace),SyBlobLength(&pGen->sNamespace));` |
|     3935 |  5557 | `		SyBlobAppend(pOut,"\\",1);` |
|     1965 |  5558 | `	}` |
|   265227 |  5559 | `	SyBlobAppend(pOut,pName->zString,pName->nByte);` |
|   265227 |  5560 | `}` |
|        - |  5561 | `/*` |
...
|        - |  6057 | ` */` |
|   240222 |  6058 | `static sxi32 GenStateProcessArgValue(ph7_gen_state *pGen,ph7_vm_func_arg *pArg,SyToken *pIn,SyToken *pEnd)` |
|        5 |  6059 | `{` |
|        - |  6060 | `	SyToken *pTmpIn,*pTmpEnd;` |
|        - |  6061 | `	SySet *pInstrContainer;` |
|        - |  6062 | `	sxi32 rc;` |
|        - |  6063 | `	/* Swap token stream */` |
|   240227 |  6064 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|   240227 |  6065 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   240227 |  6066 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pArg->aByteCode);` |
|        - |  6067 | `	/* Compile the expression holding the argument value */` |
|   240227 |  6068 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|        - |  6069 | `	/* Emit the done instruction */` |
|   240227 |  6070 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,(rc != SXERR_EMPTY ? 1 : 0),0,0,0);` |
|   240227 |  6071 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|   240227 |  6072 | `	RE_SWAP_DELIMITER(pGen);` |
|   240227 |  6073 | `	if( rc == SXERR_ABORT ){` |
|      ! 0 |  6074 | `		return SXERR_ABORT;` |
|        - |  6075 | `	}` |
|   240227 |  6076 | `	return SXRET_OK;` |
|   120116 |  6077 | `}` |
|        - |  6078 | `/*` |
...
|        - |  6114 | ` */` |
|   497502 |  6115 | `static sxi32 GenStateCollectFuncArgs(ph7_vm_func *pFunc,ph7_gen_state *pGen,SyToken *pEnd,int bCtorCtx,int bAbstractCtx)` |
|        5 |  6116 | `{` |
...
|        - |  6121 | `	sxi32 rc;` |
|        - |  6122 |  |
|   497507 |  6123 | `	pIn = pGen->pIn;` |
|   497507 |  6124 | `	SyBlobInit(&sSig,&pGen->pVm->sAllocator);` |
|        - |  6125 | `	/* Process arguments one after one */` |
|   610252 |  6126 | `	for(;;){` |
|  1220509 |  6127 | `		if( pIn >= pEnd ){` |
|        - |  6128 | `			/* No more arguments to process */` |
|   497491 |  6129 | `			break;` |
|        - |  6130 | `		}` |
|   723023 |  6131 | `		SyZero(&sArg,sizeof(ph7_vm_func_arg));` |
|   723023 |  6132 | `		SySetInit(&sArg.aByteCode,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|   723023 |  6133 | `		SySetInit(&sArg.aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|   723023 |  6134 | `		SySetInit(&sArg.aAttrs,&pGen->pVm->sAllocator,sizeof(ph7_attribute));` |
|   723023 |  6135 | `		SyStringInitFromBuf(&sArg.sTypeName,0,0);` |
|        - |  6136 | `		/* Parameter #[...] attributes: the group precedes the parameter's` |
|        - |  6137 | `		 * first token inside the main token stream */` |
|   723023 |  6138 | `		if( GenStateCollectParamAttrs(&(*pGen),pIn,&sArg.aAttrs) == SXERR_ABORT ){` |
...
|        - |  6146 | `		{` |
|   723023 |  6147 | `			int bReadonly = 0, bVisSeen = 0;` |
|   723023 |  6148 | `			sxi32 iVis = PH7_CLASS_PROT_PUBLIC;` |
|   723023 |  6149 | `			sxi32 iSetVisFlag = 0;` |
|        - |  6150 | `			int nSetTok;` |
|        - |  6151 | `			sxi32 nSetVis;` |
|   723023 |  6152 | `			if( pIn < pEnd && GenStateIsReadonly(pIn) ){` |
|        3 |  6153 | `				bReadonly = 1;` |
|        3 |  6154 | `				pIn++;` |
|        1 |  6155 | `			}` |
|   723023 |  6156 | `			nSetVis = GenStatePeekSetVisibility(pIn,pEnd,&nSetTok);` |
|   723023 |  6157 | `			if( nSetVis ){` |
...
|      ! 0 |  6164 | `					pIn++;` |
|        1 |  6165 | `				}` |
|   723022 |  6166 | `			}else if( pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD) ){` |
...
|       42 |  6184 | `				}` |
|    44725 |  6185 | `			}` |
|   723023 |  6186 | `			if( iSetVisFlag == PH7_CLASS_ATTR_PRIVATE_SET ){` |
|        5 |  6187 | `				sArg.iFlags \|= VM_FUNC_ARG_PRIV_SET;` |
|   723021 |  6188 | `			}else if( iSetVisFlag == PH7_CLASS_ATTR_PROTECTED_SET ){` |
|      ! 0 |  6189 | `				sArg.iFlags \|= VM_FUNC_ARG_PROT_SET;` |
|      ! 0 |  6190 | `			}` |
|   723023 |  6191 | `			if( bVisSeen \|\| bReadonly ){` |
|       93 |  6192 | `				if( !bCtorCtx ){` |
...
|   723014 |  6213 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_DOLLAR) == 0` |
|   425708 |  6214 | `			&& (pIn->nType & PH7_TK_AMPER) == 0` |
...
|    52523 |  6243 | `		}` |
|   723009 |  6244 | `		if( pIn >= pEnd ){` |
|      ! 0 |  6245 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Missing argument name");` |
|      ! 0 |  6246 | `			return rc;` |
|        - |  6247 | `		}` |
|   723009 |  6248 | `		if( pIn->nType & PH7_TK_AMPER ){` |
|        - |  6249 | `			/* Pass by reference,record that */` |
|     3917 |  6250 | `			sArg.iFlags \|= VM_FUNC_ARG_BY_REF;` |
|     3917 |  6251 | `			pIn++;` |
|     1956 |  6252 | `		}` |
|   723009 |  6253 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_ELLIPSIS) ){` |
|        - |  6254 | `			/* Variadic parameter: ...$args */` |
|    19469 |  6255 | `			sArg.iFlags \|= VM_FUNC_ARG_VARIADIC;` |
|    19469 |  6256 | `			pIn++;` |
|     9732 |  6257 | `		}` |
|   723009 |  6258 | `		if( pIn >= pEnd \|\| (pIn->nType & PH7_TK_DOLLAR) == 0 \|\| &pIn[1] >= pEnd \|\| (pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|        - |  6259 | `			/* Invalid argument */` |
|      ! 0 |  6260 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Invalid argument name");` |
|      ! 0 |  6261 | `			return rc;` |
|        - |  6262 | `		}` |
|   723009 |  6263 | `		pIn++; /* Jump the dollar sign */` |
|        - |  6264 | `		/* Copy argument name */` |
|   723009 |  6265 | `		zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,SyStringData(&pIn->sData),SyStringLength(&pIn->sData));` |
|   723009 |  6266 | `		if( zDup == 0 ){` |
|      ! 0 |  6267 | `			PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"PH7 engine is running out of memory");` |
|      ! 0 |  6268 | `			return SXERR_ABORT;` |
|        - |  6269 | `		}` |
|   723009 |  6270 | `		SyStringInitFromBuf(&sArg.sName,zDup,SyStringLength(&pIn->sData));` |
|   723009 |  6271 | `		pIn++;` |
|   723009 |  6272 | `		if( pIn < pEnd ){` |
|   372773 |  6273 | `			if( pIn->nType & PH7_TK_EQUAL ){` |
|        - |  6274 | `				SyToken *pDefend;` |
|   240229 |  6275 | `				sxi32 iNest = 0;` |
|   240229 |  6276 | `				pIn++; /* Jump the equal sign */` |
|   240229 |  6277 | `				pDefend = pIn;` |
|        - |  6278 | `				/* Process the default value associated with this argument */` |
|   511455 |  6279 | `				while( pDefend < pEnd ){` |
|   364209 |  6280 | `					if( (pDefend->nType & PH7_TK_COMMA) && iNest <= 0 ){` |
|    92983 |  6281 | `						break;` |
|        - |  6282 | `					}` |
|   271231 |  6283 | `					if( pDefend->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*[*/) ){` |
|        - |  6284 | `						/* Increment nesting level */` |
|    15501 |  6285 | `						iNest++;` |
|   263483 |  6286 | `					}else if( pDefend->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CCB/*'}'*/\|PH7_TK_CSB/*]*/) ){` |
|        - |  6287 | `						/* Decrement nesting level */` |
|    15501 |  6288 | `						iNest--;` |
|     7748 |  6289 | `					}` |
|   271231 |  6290 | `					pDefend++;` |
|        5 |  6291 | `				}` |
|   240229 |  6292 | `				if( pIn >= pDefend ){` |
|        3 |  6293 | `					rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Missing argument default value");` |
|        3 |  6294 | `					return rc;` |
|        - |  6295 | `				}` |
|        - |  6296 | `				/* Process default value */` |
|   240227 |  6297 | `				rc = GenStateProcessArgValue(&(*pGen),&sArg,pIn,pDefend);` |
|   240227 |  6298 | `				if( rc != SXRET_OK ){` |
|      ! 0 |  6299 | `					return rc;` |
|        - |  6300 | `				}` |
...
|   240222 |  6306 | `				if( (sArg.nType > 0 \|\| (sArg.iFlags & VM_FUNC_ARG_UNION))` |
|   145302 |  6307 | `					&& (sArg.iFlags & VM_FUNC_ARG_NULLABLE) == 0` |
|   145299 |  6308 | `					&& &pIn[1] == pDefend` |
...
|   240227 |  6330 | `				pIn = pDefend;` |
|   120111 |  6331 | `			}` |
|   372771 |  6332 | `			if( pIn < pEnd && (pIn->nType & PH7_TK_COMMA) == 0 ){` |
|      ! 0 |  6333 | `				rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Unexpected token '%z'",&pIn->sData);` |
|      ! 0 |  6334 | `				return rc;` |
|        - |  6335 | `			}` |
|   372771 |  6336 | `			pIn++; /* Jump the trailing comma */` |
|   186383 |  6337 | `		}` |
|        - |  6338 | `		/* Append argument signature */` |
|   723007 |  6339 | `		if( sArg.nType > 0 ){` |
...
|        - |  6382 | `			 */` |
|   618023 |  6383 | `			SyBlobRelease(&sSig);` |
|        - |  6384 | `		}` |
|        - |  6385 | `		/* Save in the argument set */` |
|   723007 |  6386 | `		SySetPut(&pFunc->aArgs,(const void *)&sArg);` |
|        5 |  6387 | `	}` |
|   497491 |  6388 | `	if( SyBlobLength(&sSig) > 0 ){` |
|        - |  6389 | `		/* Save function signature */` |
|    73941 |  6390 | `		SyStringInitFromBuf(&pFunc->sSignature,SyBlobData(&sSig),SyBlobLength(&sSig));` |
|    36968 |  6391 | `	}` |
|   497491 |  6392 | `	return SXRET_OK;` |
|   248756 |  6393 | `}` |
|        - |  6394 | `/*` |
...
|      137 |  6561 | `}` |
|  1412892 |  6562 | `static int GenStateFuncBodyHasYield(ph7_gen_state *pGen)` |
|        5 |  6563 | `{` |
|  1412897 |  6564 | `	SyToken *pIn = pGen->pIn;   /* expected at the body's opening '{' */` |
|  1412897 |  6565 | `	SyToken *pEnd = pGen->pEnd;` |
|  1412897 |  6566 | `	sxi32 iDepth = 0;` |
|  1412897 |  6567 | `	int bStarted = 0;` |
| 64535441 |  6568 | `	while( pIn < pEnd ){` |
| 64535441 |  6569 | `		sxu32 t = pIn->nType;` |
| 64535441 |  6570 | `		if( t & PH7_TK_OCB ){ iDepth++; bStarted = 1; pIn++; continue; }` |
| 61545685 |  6571 | `		if( t & PH7_TK_CCB ){ iDepth--; pIn++; if( bStarted && iDepth <= 0 ){ break; } continue; }` |
| 58556307 |  6572 | `		if( t & PH7_TK_KEYWORD ){` |
|  4709693 |  6573 | `			int kw = SX_PTR_TO_INT(pIn->pUserData);` |
|  4709693 |  6574 | `			if( kw == PH7_TKWRD_YIELD ){ return TRUE; }` |
|  4709429 |  6575 | `			if( kw == PH7_TKWRD_FUNCTION ){ pIn = GenStateSkipNestedFunc(pIn,pEnd); continue; }` |
|        - |  6576 | ``			/* `fn` arrow bodies are single expressions and cannot contain a valid yield. */`` |
|  2337267 |  6577 | `		}` |
| 58521153 |  6578 | `		pIn++;` |
|        5 |  6579 | `	}` |
|  1412633 |  6580 | `	return FALSE;` |
|   706451 |  6581 | `}` |
|        - |  6582 | `/*` |
...
|        - |  6586 | ` */` |
|  1412892 |  6587 | `static sxi32 GenStateCompileFuncBody(` |
...
|  1412897 |  6597 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC,PH7_VmInstrLength(pGen->pVm),pFunc,&pBlock);` |
|  1412897 |  6598 | `	if( rc != SXRET_OK ){` |
...
|        - |  6602 | `	}` |
|  1412897 |  6603 | `	nGotoOfft = SySetUsed(&pGen->aGoto);` |
|        - |  6604 | `	/* Swap bytecode containers */` |
|  1412897 |  6605 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|  1412897 |  6606 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pFunc->aByteCode);` |
...
|        - |  6611 | `	{` |
|  1412897 |  6612 | `		sxu32 nArg = SySetUsed(&pFunc->aArgs);` |
|        - |  6613 | `		sxu32 i;` |
|  2104809 |  6614 | `		for( i = 0; i < nArg; i++ ){` |
|   691917 |  6615 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pFunc->aArgs,i);` |
|        - |  6616 | `			char *zSrc;` |
|        - |  6617 | `			sxu32 nSrc,nName;` |
|        - |  6618 | `			SySet sToken;` |
|        - |  6619 | `			SyToken *pTmpIn,*pTmpEnd;` |
|        - |  6620 | `			sxi32 rcPromote;` |
|   691917 |  6621 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|   691843 |  6622 | `				continue;` |
|        - |  6623 | `			}` |
...
|        - |  6673 | `	{` |
|  1412897 |  6674 | `		sxi8 bSavedGen = pGen->bInGenerator;` |
|  1412897 |  6675 | `		pGen->bInGenerator = (sxi8)GenStateFuncBodyHasYield(&(*pGen));` |
|        - |  6676 | `		/* Compile the body */` |
|  1412897 |  6677 | `		PH7_CompileBlock(&(*pGen),0);` |
|  1412897 |  6678 | `		pGen->bInGenerator = bSavedGen;` |
|        - |  6679 | `	}` |
|        - |  6680 | `	/* Fix exception jumps now the destination is resolved */` |
|  1412897 |  6681 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|        - |  6682 | `	/* Emit the final return if not yet done */` |
|  1412897 |  6683 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|        - |  6684 | `	/* Fix gotos jumps now the destination is resolved */` |
|  1412897 |  6685 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),nGotoOfft) ){` |
|      ! 0 |  6686 | `		rc = SXERR_ABORT;` |
|      ! 0 |  6687 | `	}` |
|  1412897 |  6688 | `	SySetTruncate(&pGen->aGoto,nGotoOfft);` |
|        - |  6689 | `	/* Restore the default container */` |
|  1412897 |  6690 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|        - |  6691 | `	/* Leave function block */` |
|  1412897 |  6692 | `	GenStateLeaveBlock(&(*pGen),0);` |
|  1412897 |  6693 | `	if( rc == SXERR_ABORT ){` |
...
|        - |  6698 | `	{` |
|  1412897 |  6699 | `		VmInstr *aInstr = (VmInstr *)SySetBasePtr(&pFunc->aByteCode);` |
|        - |  6700 | `		sxu32 i;` |
| 39230139 |  6701 | `		for( i = 0; i < SySetUsed(&pFunc->aByteCode); i++ ){` |
| 37817511 |  6702 | `			if( aInstr[i].iOp == PH7_OP_YIELD \|\| aInstr[i].iOp == PH7_OP_YIELD_FROM ){` |
|      269 |  6703 | `				pFunc->iFlags \|= VM_FUNC_GENERATOR;` |
|      269 |  6704 | `				break;` |
|        - |  6705 | `			}` |
| 18908626 |  6706 | `		}` |
|        - |  6707 | `	}` |
|  1412897 |  6708 | `	if( pFunc->iFlags & VM_FUNC_GENERATOR ){` |
...
|        - |  7364 | ` */` |
|  1513854 |  7365 | `static sxi32 GenStateParseReturnType(ph7_gen_state *pGen, ph7_vm_func *pFunc)` |
|        5 |  7366 | `{` |
|  1513859 |  7367 | `	sxi32 iFlags = 0;` |
|        - |  7368 | `	sxi32 rc;` |
|        - |  7369 | `	sxu32 nLine;` |
|  1513859 |  7370 | `	pFunc->nReturnType = 0;` |
|  1513859 |  7371 | `	SyStringInitFromBuf(&pFunc->sReturnClass, 0, 0);` |
|  1513859 |  7372 | `	SyStringInitFromBuf(&pFunc->sReturnTypeName, 0, 0);` |
...
|  1513859 |  7378 | `	SySetReset(&pFunc->aReturnUnion);` |
|  1513859 |  7379 | `	pFunc->iFlags &= ~VM_FUNC_RETURN_NULLABLE;` |
|  1513859 |  7380 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COLON) == 0 ){` |
|  1513203 |  7381 | `		return SXRET_OK;` |
|        - |  7382 | `	}` |
...
|   756932 |  7420 | `}` |
|        - |  7421 |  |
|   118100 |  7422 | `static sxi32 GenStateCompileFunc(` |
...
|   118105 |  7436 | `	nLine = pGen->pIn->nLine;` |
|        - |  7437 | `	/* Jump the left parenthesis '(' */` |
|   118105 |  7438 | `	pGen->pIn++;` |
|        - |  7439 | `	/* Delimit the function signature */` |
|   118105 |  7440 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   118105 |  7441 | `	if( pEnd >= pGen->pEnd ){` |
|        - |  7442 | `		/* Syntax error */` |
...
|   118099 |  7452 | `	pFunc = (ph7_vm_func *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_vm_func));` |
|   118099 |  7453 | `	if( pFunc == 0 ){` |
|      ! 0 |  7454 | `		goto OutOfMem;` |
|        - |  7455 | `	}` |
|        - |  7456 | `	/* Build the function name, prepending namespace if active */` |
|   118106 |  7457 | `	if( SyBlobLength(&pGen->sNamespace) > 0 && !bHandleClosure ){` |
|        - |  7458 | `		SyBlob sFQN;` |
|        - |  7459 | `		sxu32 nLen;` |
...
|        9 |  7471 | `	}else{` |
|   118085 |  7472 | `		zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|   118085 |  7473 | `		if( zName == 0 ){` |
|      ! 0 |  7474 | `			goto OutOfMem;` |
|        - |  7475 | `		}` |
|   118085 |  7476 | `		PH7_VmInitFuncState(pGen->pVm,pFunc,zName,pName->nByte,iFlags,0);` |
|        - |  7477 | `	}` |
...
|   118099 |  7480 | `	pFunc->nLine = nLine;` |
|   118099 |  7481 | `	GenStateConsumeDoc(&(*pGen),&pFunc->sDoc);` |
|   118099 |  7482 | `	if( GenStateConsumeAttrs(&(*pGen),&pFunc->aAttrs) == SXERR_ABORT ){` |
|      ! 0 |  7483 | `		return SXERR_ABORT;` |
|        - |  7484 | `	}` |
|   118099 |  7485 | `	if( pGen->pIn < pEnd ){` |
|        - |  7486 | `		/* Collect function arguments */` |
|   101773 |  7487 | `		rc = GenStateCollectFuncArgs(pFunc,&(*pGen),pEnd,0,0);` |
|   101773 |  7488 | `		if( rc == SXERR_ABORT ){` |
...
|   118099 |  7494 | `	pGen->pIn = &pEnd[1];` |
|        - |  7495 | `	{` |
|   118099 |  7496 | `		sxi32 rcRt = GenStateParseReturnType(pGen, pFunc);` |
|   118099 |  7497 | `		if( rcRt == SXERR_ABORT ){` |
|      ! 0 |  7498 | `			return SXERR_ABORT;` |
|   118099 |  7499 | `		}else if( rcRt == SXERR_SYNTAX ){` |
|        8 |  7500 | `			return SXERR_SYNTAX;` |
|        - |  7501 | `		}` |
|        - |  7502 | `	}` |
|   118093 |  7503 | `	if( bHandleClosure ){` |
...
|   118093 |  7613 | `	rc = GenStateCompileFuncBody(&(*pGen),pFunc);` |
|   118093 |  7614 | `	if( rc == SXERR_ABORT ){` |
|      ! 0 |  7615 | `		return SXERR_ABORT;` |
|        - |  7616 | `	}` |
|        - |  7617 | `	/* The cursor sits just past the body's closing brace */` |
|   118093 |  7618 | `	pFunc->nEndLine = pGen->pIn[-1].nLine;` |
|   118093 |  7619 | `	if( ppFunc ){` |
|   118093 |  7620 | `		*ppFunc = pFunc;` |
|    59044 |  7621 | `	}` |
|   118093 |  7622 | `	rc = SXRET_OK;` |
|   118093 |  7623 | `	if( (pFunc->iFlags & VM_FUNC_CLOSURE) == 0 ){` |
|        - |  7624 | `		/* Finally register the function */` |
|   117635 |  7625 | `		rc = PH7_VmInstallUserFunction(pGen->pVm,pFunc,0);` |
|    58815 |  7626 | `	}` |
|   118093 |  7627 | `	if( rc == SXRET_OK ){` |
|   118093 |  7628 | `		return SXRET_OK;` |
|        - |  7629 | `	}` |
...
|        - |  7641 | ` */` |
|   117644 |  7642 | `static sxi32 PH7_CompileFunction(ph7_gen_state *pGen)` |
|        5 |  7643 | `{` |
|        - |  7644 | `	SyString *pName;` |
|        - |  7645 | `	sxi32 iFlags;` |
|        - |  7646 | `	sxu32 nKwLine;` |
...
|        - |  7648 | `	sxi32 rc;` |
|        - |  7649 |  |
|   117649 |  7650 | `	nLine = pGen->pIn->nLine;` |
|   117649 |  7651 | `	nKwLine = nLine; /* Line of the 'function' keyword (Reflection getStartLine) */` |
|   117649 |  7652 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|   117649 |  7653 | `	iFlags = 0;` |
|   117649 |  7654 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|        - |  7655 | `		/* Return by reference,remember that */` |
|       12 |  7656 | `		iFlags \|= VM_FUNC_REF_RETURN;` |
|        - |  7657 | `		/* Jump the '&' token */` |
|       12 |  7658 | `		pGen->pIn++;` |
|        5 |  7659 | `	}` |
|   117649 |  7660 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|        - |  7671 | `	}` |
|   117643 |  7672 | `	pName = &pGen->pIn->sData;` |
|   117643 |  7673 | `	nLine = pGen->pIn->nLine;` |
|        - |  7674 | `	/* Jump the function name */` |
|   117643 |  7675 | `	pGen->pIn++;` |
|   117643 |  7676 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|        - |  7677 | `		/* Syntax error */` |
...
|        - |  7690 | `	{` |
|   117641 |  7691 | `		ph7_vm_func *pFuncState = 0;` |
|   117641 |  7692 | `		rc = GenStateCompileFunc(&(*pGen),pName,iFlags,FALSE,&pFuncState);` |
|   117641 |  7693 | `		if( pFuncState ){` |
|        - |  7694 | `			/* Reflection getStartLine(): line of the 'function' keyword */` |
|   117629 |  7695 | `			pFuncState->nLine = nKwLine;` |
|    58812 |  7696 | `		}` |
|        - |  7697 | `	}` |
|   117641 |  7698 | `	return rc;` |
|    58827 |  7699 | `}` |
|        - |  7700 | `/*` |
...
|        - |  7710 | ` */` |
|  1748978 |  7711 | `static sxi32 GetProtectionLevel(sxi32 nKeyword)` |
|        5 |  7712 | `{` |
|  1748983 |  7713 | `	if( nKeyword == PH7_TKWRD_PRIVATE ){` |
|    23409 |  7714 | `		return PH7_CLASS_PROT_PRIVATE;` |
|  1725579 |  7715 | `	}else if( nKeyword == PH7_TKWRD_PROTECTED ){` |
|   182065 |  7716 | `		return PH7_CLASS_PROT_PROTECTED;` |
|        - |  7717 | `	}` |
|        - |  7718 | `	/* Assume public by default */` |
|  1543519 |  7719 | `	return PH7_CLASS_PROT_PUBLIC;` |
|   874494 |  7720 | `}` |
|        - |  7721 | `/*` |
...
|        - |  7749 | ` */` |
|   143440 |  7750 | `static int GenStateClassConstHasType(ph7_gen_state *pGen)` |
|        5 |  7751 | `{` |
|        - |  7752 | `	SyToken *p0, *p1;` |
|   143445 |  7753 | `	if( pGen->pIn >= pGen->pEnd ){` |
|      ! 0 |  7754 | `		return 0;` |
|        - |  7755 | `	}` |
|   143445 |  7756 | `	p0 = pGen->pIn;` |
|        - |  7757 | `	/* A leading '\' (namespaced class type) or '?' (nullable) always starts a type */` |
|   143445 |  7758 | `	if( p0->nType & PH7_TK_NSSEP ){` |
|      ! 0 |  7759 | `		return 1;` |
|        - |  7760 | `	}` |
|   143445 |  7761 | `	if( (p0->nType & PH7_TK_OP) && p0->sData.nByte == 1 && p0->sData.zString[0] == '?' ){` |
|        5 |  7762 | `		return 1;` |
|        - |  7763 | `	}` |
...
|   143441 |  7767 | `	if( p0->nType & (PH7_TK_ID\|PH7_TK_KEYWORD) ){` |
|   143441 |  7768 | `		p1 = (pGen->pIn + 1 < pGen->pEnd) ? (pGen->pIn + 1) : 0;` |
|   143441 |  7769 | `		if( p1 ){` |
|   143441 |  7770 | `			if( p1->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_NSSEP) ){` |
|       34 |  7771 | `				return 1;` |
|        - |  7772 | `			}` |
|   143411 |  7773 | `			if( (p1->nType & PH7_TK_OP) && p1->sData.nByte == 1 && p1->sData.zString[0] == '\|' ){` |
|        5 |  7774 | `				return 1;` |
|        - |  7775 | `			}` |
|    71701 |  7776 | `		}` |
|    71701 |  7777 | `	}` |
|   143407 |  7778 | `	return 0;` |
|    71725 |  7779 | `}` |
|        - |  7780 | `/*` |
...
|        - |  7833 | ` */` |
|   229298 |  7834 | `static int GenStateInitHasNewExpr(ph7_gen_state *pGen)` |
|        5 |  7835 | `{` |
|   229303 |  7836 | `	SyToken *p = pGen->pIn;` |
|   229303 |  7837 | `	int iDepth = 0;` |
|   560357 |  7838 | `	while( p < pGen->pEnd ){` |
|   560357 |  7839 | `		if( iDepth == 0 && (p->nType & (PH7_TK_SEMI\|PH7_TK_COMMA)) ){` |
|   229251 |  7840 | `			break; /* end of this initializer */` |
|        - |  7841 | `		}` |
|   331106 |  7842 | `		if( (p->nType & PH7_TK_KEYWORD)` |
|   169446 |  7843 | `			&& ( SX_PTR_TO_INT(p->pUserData) == PH7_TKWRD_FUNCTION` |
...
|        3 |  7902 | `			continue;` |
|        - |  7903 | `		}` |
|   331109 |  7904 | `		if( p->nType & PH7_TK_OCB ){` |
|       45 |  7905 | `			if( iDepth == 0 ){` |
...
|        - |  7911 | `			}` |
|      ! 0 |  7912 | `			iDepth++;` |
|   331065 |  7913 | `		}else if( p->nType & (PH7_TK_LPAREN\|PH7_TK_OSB) ){` |
|     7831 |  7914 | `			iDepth++;` |
|   327152 |  7915 | `		}else if( p->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB) ){` |
|     7829 |  7916 | `			if( iDepth > 0 ){` |
|     7829 |  7917 | `				iDepth--;` |
|     3912 |  7918 | `			}` |
|   319327 |  7919 | `		}else if( (p->nType & PH7_TK_OP) && p->pUserData` |
|    85965 |  7920 | `			&& ((const ph7_expr_op *)p->pUserData)->iOp == EXPR_OP_NEW ){` |
...
|       11 |  7952 | `	}` |
|      355 |  7953 | `}` |
|   143440 |  7954 | `static sxi32 GenStateCompileClassConstant(ph7_gen_state *pGen,sxi32 iProtection,sxi32 iFlags,ph7_class *pClass)` |
|        5 |  7955 | `{` |
|   143445 |  7956 | `	sxu32 nLine = pGen->pIn->nLine;` |
|        - |  7957 | `	SySet *pInstrContainer;` |
|        - |  7958 | `	ph7_class_attr *pCons;` |
|        - |  7959 | `	SyString *pName;` |
|        - |  7960 | `	sxi32 rc;` |
|   143445 |  7961 | `	sxu32 nType = 0;` |
|        - |  7962 | `	SyString sTypeClass;` |
|        - |  7963 | `	SyString sTypeText;` |
|        - |  7964 | `	SySet aUnionAlts;` |
|   143445 |  7965 | `	sxi32 iTypeFlags = 0;` |
|   143445 |  7966 | `	SyStringInitFromBuf(&sTypeClass,0,0);` |
|   143445 |  7967 | `	SyStringInitFromBuf(&sTypeText,0,0);` |
|   143445 |  7968 | `	SySetInit(&aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|        - |  7969 | `	/* Extract visibility level */` |
|   143445 |  7970 | `	iProtection = GetProtectionLevel(iProtection);` |
|        - |  7971 | `	/* Mark as constant */` |
|   143445 |  7972 | `	iFlags \|= PH7_CLASS_ATTR_CONSTANT;` |
|   143445 |  7973 | `	pGen->pIn++; /* Jump the 'const' keyword */` |
...
|   143464 |  7976 | `	if( GenStateClassConstHasType(pGen) ){` |
...
|       19 |  7997 | `	}` |
|    71720 |  7998 | `loop:` |
|   143447 |  7999 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
...
|   143447 |  8009 | `	pName = &pGen->pIn->sData;` |
|        - |  8010 | `	/* Make sure the constant name isn't reserved */` |
|   143447 |  8011 | `	if( GenStateIsReservedConstant(pName) ){` |
...
|   143447 |  8021 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
...
|   143445 |  8032 | `	pGen->pIn++;` |
|   143445 |  8033 | `	if(pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_EQUAL /* '=' */) == 0 ){` |
...
|        - |  8041 | `	}` |
|   143445 |  8042 | `	pGen->pIn++; /* Jump the equal sign */` |
...
|   143440 |  8047 | `	if( (iTypeFlags & PH7_CLASS_ATTR_TYPED) && !(iTypeFlags & PH7_CLASS_ATTR_UNION)` |
...
|   143441 |  8060 | `	if( GenStateInitHasNewExpr(pGen) ){` |
...
|   143437 |  8069 | `	pCons = PH7_NewClassAttr(pGen->pVm,pName,nLine,iProtection,iFlags\|iTypeFlags);` |
|   143437 |  8070 | `	if( pCons ){` |
|   143437 |  8071 | `		GenStateConsumeDoc(&(*pGen),&pCons->sDoc);` |
|   143437 |  8072 | `		if( GenStateConsumeAttrs(&(*pGen),&pCons->aAttrs) == SXERR_ABORT ){` |
|      ! 0 |  8073 | `			return SXERR_ABORT;` |
|        - |  8074 | `		}` |
|    71716 |  8075 | `	}` |
|   143437 |  8076 | `	if( pCons == 0 ){` |
|      ! 0 |  8077 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 |  8078 | `		return SXERR_ABORT;` |
|        - |  8079 | `	}` |
|   143437 |  8080 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|       35 |  8081 | `		GenStateCopyTypeToAttr(pCons,nType,&sTypeClass,&sTypeText,iTypeFlags,&aUnionAlts);` |
|       16 |  8082 | `	}` |
|        - |  8083 | `	/* Swap bytecode container */` |
|   143437 |  8084 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   143437 |  8085 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pCons->aByteCode);` |
|        - |  8086 | `	/* Compile constant value.` |
|        - |  8087 | `	 */` |
|   143437 |  8088 | `	rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|   143437 |  8089 | `	if( rc == SXERR_EMPTY ){` |
...
|   143437 |  8096 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|   143437 |  8097 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|   143437 |  8098 | `	if( rc == SXERR_ABORT ){` |
...
|   143437 |  8103 | `	rc = PH7_ClassInstallAttr(pClass,pCons);` |
|   143437 |  8104 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  8105 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 |  8106 | `		return SXERR_ABORT;` |
|        - |  8107 | `	}` |
|   143437 |  8108 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA /*','*/) ){` |
...
|        - |  8126 | `		}` |
|      ! 0 |  8127 | `	}` |
|   143435 |  8128 | `	SySetRelease(&aUnionAlts);` |
|   143435 |  8129 | `	return SXRET_OK;` |
|        5 |  8130 | `Synchronize:` |
...
|        - |  8166 | ` */` |
|  1306452 |  8167 | `static int GenStateLooksLikeTypedProperty(SyToken *pStart,SyToken *pEnd)` |
|        5 |  8168 | `{` |
|  1306457 |  8169 | `	SyToken *p = pStart;` |
|  1306457 |  8170 | `	int bFirst = 1;` |
|  1306457 |  8171 | `	if( p >= pEnd ) return 0;` |
|        - |  8172 | ``	/* Optional nullable `?` shorthand. */`` |
|  1306457 |  8173 | `	if( (p->nType & PH7_TK_OP) && p->sData.nByte == 1 && p->sData.zString[0] == '?' ){` |
|       35 |  8174 | `		p++;` |
...
|   653226 |  8181 | `	for(;;){` |
|  1306477 |  8182 | `		if( p < pEnd && (p->nType & PH7_TK_LPAREN) ){` |
...
|  1306475 |  8191 | `			if( p < pEnd && (p->nType & PH7_TK_NSSEP) ){ p++; }` |
|  1306475 |  8192 | `			if( p >= pEnd \|\| (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|      ! 0 |  8193 | `				return 0;` |
|        - |  8194 | `			}` |
...
|  1306475 |  8198 | `			if( bFirst && (p->nType & PH7_TK_KEYWORD) ){` |
|  1306427 |  8199 | `				sxu32 k = (sxu32)(SX_PTR_TO_INT(p->pUserData));` |
|  1306422 |  8200 | `				if( k == PH7_TKWRD_FUNCTION \|\| k == PH7_TKWRD_VAR \|\| k == PH7_TKWRD_CONST` |
|    23634 |  8201 | `				 \|\| k == PH7_TKWRD_STATIC \|\| k == PH7_TKWRD_FINAL \|\| k == PH7_TKWRD_ABSTRACT ){` |
|  1306145 |  8202 | `					return 0;` |
|        - |  8203 | `				}` |
|      141 |  8204 | `			}` |
|      335 |  8205 | `			p++;` |
...
|        - |  8382 | ` */` |
| 10205250 |  8383 | `static int GenStateIsReadonly(SyToken *pTok)` |
|        5 |  8384 | `{` |
| 10248224 |  8385 | `	return (pTok->nType & PH7_TK_ID)` |
|  5145594 |  8386 | `		&& pTok->sData.nByte == sizeof("readonly")-1` |
| 10248219 |  8387 | `		&& SyStrnicmp(pTok->sData.zString,"readonly",sizeof("readonly")-1) == 0;` |
|        5 |  8388 | `}` |
|        - |  8389 | `/*` |
...
|        - |  8394 | ` */` |
|  3731904 |  8395 | `static sxi32 GenStatePeekSetVisibility(SyToken *pTok,SyToken *pEnd,int *pnTok)` |
|        5 |  8396 | `{` |
|  3731909 |  8397 | `	*pnTok = 0;` |
|  3731904 |  8398 | `	if( &pTok[3] < pEnd` |
|  3556819 |  8399 | `	 && (pTok->nType & PH7_TK_KEYWORD)` |
|  3113735 |  8400 | `	 && (pTok[1].nType & PH7_TK_LPAREN)` |
|  1422876 |  8401 | `	 && (pTok[2].nType & (PH7_TK_ID\|PH7_TK_KEYWORD))` |
...
|        9 |  8423 | `}` |
|   210056 |  8424 | `static sxi32 GenStateCompileClassAttr(ph7_gen_state *pGen,sxi32 iProtection,sxi32 iFlags,ph7_class *pClass)` |
|        5 |  8425 | `{` |
|   210061 |  8426 | `	sxu32 nLine = pGen->pIn->nLine;` |
|        - |  8427 | `	ph7_class_attr *pAttr;` |
|        - |  8428 | `	SyString *pName;` |
|        - |  8429 | `	sxi32 rc;` |
|   210061 |  8430 | `	sxu32 nType = 0;` |
|        - |  8431 | `	SyString sTypeClass;` |
|        - |  8432 | `	SyString sTypeText;` |
|        - |  8433 | `	SySet aUnionAlts;` |
|   210061 |  8434 | `	sxi32 iTypeFlags = 0;` |
|   210061 |  8435 | `	SyStringInitFromBuf(&sTypeClass,0,0);` |
|   210061 |  8436 | `	SyStringInitFromBuf(&sTypeText,0,0);` |
|   210061 |  8437 | `	SySetInit(&aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
...
|   210061 |  8441 | `	if( pClass->iFlags & PH7_CLASS_READONLY ){` |
|       21 |  8442 | `		iFlags \|= PH7_CLASS_ATTR_READONLY;` |
|        9 |  8443 | `	}` |
|        - |  8444 | `	/* Extract visibility level */` |
|   210061 |  8445 | `	iProtection = GetProtectionLevel(iProtection);` |
|        - |  8446 | `	/* Parse optional type hint (typed properties, PHP 7.4+) */` |
|   210222 |  8447 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
...
|      161 |  8463 | `	}` |
|      ! 0 |  8464 | `loop:` |
|   210065 |  8465 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
...
|        - |  8471 | `	}` |
|   210065 |  8472 | `	pGen->pIn++; /* Jump the dollar sign */` |
|   210065 |  8473 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_ID)) == 0 ){` |
...
|   210065 |  8483 | `	pName = &pGen->pIn->sData;` |
|        - |  8484 | `	/* Advance the stream cursor */` |
|   210065 |  8485 | `	pGen->pIn++;` |
|   210065 |  8486 | `	if(pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_EQUAL/*'='*/\|PH7_TK_SEMI/*';'*/\|PH7_TK_COMMA/*','*/\|PH7_TK_OCB/*'{' hooks*/)) == 0 ){` |
...
|   210063 |  8497 | `	if( iFlags & (PH7_CLASS_ATTR_PRIVATE_SET\|PH7_CLASS_ATTR_PROTECTED_SET\|PH7_CLASS_ATTR_PUBLIC_SET) ){` |
...
|   210063 |  8517 | `	if( iFlags & PH7_CLASS_ATTR_READONLY ){` |
...
|   210053 |  8537 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
...
|   210053 |  8549 | `	if( PH7_ClassExtractAttribute(pClass,pName->zString,pName->nByte) != 0 ){` |
...
|   210051 |  8563 | `	if( (pGen->pIn->nType & PH7_TK_EQUAL /*'='*/) && GenStateInitHasNewExpr(pGen) ){` |
...
|   210047 |  8572 | `	pAttr = PH7_NewClassAttr(pGen->pVm,pName,nLine,iProtection,iFlags\|iTypeFlags);` |
|   210047 |  8573 | `	if( pAttr ){` |
|   210047 |  8574 | `		GenStateConsumeDoc(&(*pGen),&pAttr->sDoc);` |
|   210047 |  8575 | `		if( GenStateConsumeAttrs(&(*pGen),&pAttr->aAttrs) == SXERR_ABORT ){` |
|      ! 0 |  8576 | `			return SXERR_ABORT;` |
|        - |  8577 | `		}` |
|   105021 |  8578 | `	}` |
|   210047 |  8579 | `	if( pAttr == 0 ){` |
|      ! 0 |  8580 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 engine is running out of memory");` |
|      ! 0 |  8581 | `		return SXERR_ABORT;` |
|        - |  8582 | `	}` |
|   210047 |  8583 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|      323 |  8584 | `		GenStateCopyTypeToAttr(pAttr,nType,&sTypeClass,&sTypeText,iTypeFlags,&aUnionAlts);` |
|      159 |  8585 | `	}` |
|   210047 |  8586 | `	if( pGen->pIn->nType & PH7_TK_EQUAL /*'='*/ ){` |
|        - |  8587 | `		SySet *pInstrContainer;` |
|    85863 |  8588 | `		SyToken *pSavedDefEnd = pGen->pEnd;` |
|    85863 |  8589 | `		pGen->pIn++; /*Jump the equal sign */` |
|        - |  8590 | `		{` |
...
|    85863 |  8595 | `			SyToken *pScan = pGen->pIn;` |
|    85863 |  8596 | `			sxi32 iNest = 0;` |
|   187553 |  8597 | `			while( pScan < pGen->pEnd ){` |
|   187553 |  8598 | `				if( pScan->nType & (PH7_TK_LPAREN\|PH7_TK_OSB) ){` |
|     7829 |  8599 | `					iNest++;` |
|   183641 |  8600 | `				}else if( pScan->nType & (PH7_TK_RPAREN\|PH7_TK_CSB) ){` |
|     7829 |  8601 | `					iNest--;` |
|   175817 |  8602 | `				}else if( iNest <= 0 && (pScan->nType & (PH7_TK_SEMI\|PH7_TK_COMMA\|PH7_TK_OCB)) ){` |
|    85863 |  8603 | `					break;` |
|        - |  8604 | `				}` |
|   101695 |  8605 | `				pScan++;` |
|        5 |  8606 | `			}` |
|    85863 |  8607 | `			pGen->pEnd = pScan;` |
|        - |  8608 | `		}` |
|        - |  8609 | `		/* Swap bytecode container */` |
|    85863 |  8610 | `		pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|    85863 |  8611 | `		PH7_VmSetByteCodeContainer(pGen->pVm,&pAttr->aByteCode);` |
|        - |  8612 | `		/* Compile attribute value.` |
|        - |  8613 | `		 */` |
|    85863 |  8614 | `		rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|    85863 |  8615 | `		if( rc == SXERR_EMPTY ){` |
...
|    85863 |  8622 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|    85863 |  8623 | `		PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|    85863 |  8624 | `		pGen->pIn = pGen->pEnd;   /* land exactly on the delimiter */` |
|    85863 |  8625 | `		pGen->pEnd = pSavedDefEnd;` |
|    42929 |  8626 | `	}` |
|        - |  8627 | `	/* All done,install the attribute */` |
|   210047 |  8628 | `	rc = PH7_ClassInstallAttr(pClass,pAttr);` |
|   210047 |  8629 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  8630 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 |  8631 | `		return SXERR_ABORT;` |
|        - |  8632 | `	}` |
|   210047 |  8633 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) ){` |
...
|        - |  8645 | `	}` |
|   209953 |  8646 | `	if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
...
|        - |  8657 | `	}` |
|   209953 |  8658 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA /*','*/) ){` |
...
|        - |  8676 | `		}` |
|      ! 0 |  8677 | `	}` |
|   209949 |  8678 | `	SySetRelease(&aUnionAlts);` |
|   209949 |  8679 | `	return SXRET_OK;` |
|        9 |  8680 | `Synchronize:` |
...
|        - |  8695 | ` */` |
|  1395482 |  8696 | `static sxi32 GenStateCompileClassMethod(` |
...
|        - |  8702 | `	)` |
|        5 |  8703 | `{` |
|  1395487 |  8704 | `	sxu32 nLine = pGen->pIn->nLine;` |
|  1395487 |  8705 | `	sxu32 nKwLine = nLine; /* Line of the 'function' keyword (Reflection getStartLine) */` |
...
|  1395487 |  8712 | `	iProtection = GetProtectionLevel(iProtection);` |
|  1395487 |  8713 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|  1395487 |  8714 | `	iFuncFlags = 0;` |
|  1395487 |  8715 | `	if( pGen->pIn >= pGen->pEnd ){` |
...
|        - |  8723 | `	}` |
|  1395487 |  8724 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|        - |  8725 | `		/* Return by reference,remember that */` |
|      ! 0 |  8726 | `		iFuncFlags \|= VM_FUNC_REF_RETURN;` |
|        - |  8727 | `		/* Jump the '&' token */` |
|      ! 0 |  8728 | `		pGen->pIn++;` |
|      ! 0 |  8729 | `	}` |
|  1395487 |  8730 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|  1395487 |  8739 | `	pName = &pGen->pIn->sData;` |
|  1395487 |  8740 | `	nLine = pGen->pIn->nLine;` |
|        - |  8741 | `	/* Jump the method name */` |
|  1395487 |  8742 | `	pGen->pIn++;` |
|  1395487 |  8743 | `	if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
...
|    50367 |  8755 | `	}` |
|  1395487 |  8756 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|        - |  8757 | `		/* Syntax error */` |
...
|  1395487 |  8766 | `	pMeth = PH7_NewClassMethod(pGen->pVm,pClass,pName,nLine,iProtection,iFlags,iFuncFlags);` |
|  1395487 |  8767 | `	if( pMeth == 0 ){` |
|      ! 0 |  8768 | `		PH7_GenCompileError(&(*pGen),E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 |  8769 | `		return SXERR_ABORT;` |
|        - |  8770 | `	}` |
|  1395487 |  8771 | `	pMeth->sFunc.nLine = nKwLine;` |
|  1395487 |  8772 | `	GenStateConsumeDoc(&(*pGen),&pMeth->sFunc.sDoc);` |
|  1395487 |  8773 | `	if( GenStateConsumeAttrs(&(*pGen),&pMeth->sFunc.aAttrs) == SXERR_ABORT ){` |
|      ! 0 |  8774 | `		return SXERR_ABORT;` |
|        - |  8775 | `	}` |
|        - |  8776 | `	/* Jump the left parenthesis '(' */` |
|  1395487 |  8777 | `	pGen->pIn++;` |
|  1395487 |  8778 | `	pEnd = 0; /* cc warning */` |
|        - |  8779 | `	/* Delimit the method signature */` |
|  1395487 |  8780 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|  1395487 |  8781 | `	if( pEnd >= pGen->pEnd ){` |
|        - |  8782 | `		/* Syntax error */` |
...
|        - |  8789 | `	}` |
|        - |  8790 | `	{` |
|  1395485 |  8791 | `		int bIsCtor = 0;` |
|  1395485 |  8792 | `		int bAbstractCtor = 0;` |
|  1395480 |  8793 | `		if( (pName->nByte == sizeof("__construct") - 1` |
|   814053 |  8794 | `				&& SyMemcmp(pName->zString,"__construct",sizeof("__construct") - 1) == 0)` |
|  1343109 |  8795 | `		 \|\| SyStringCmp(pName,&pClass->sName,SyMemcmp) == 0 ){` |
|   104757 |  8796 | `			if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|        3 |  8797 | `				bAbstractCtor = 1;` |
|        2 |  8798 | `			}else{` |
|   104755 |  8799 | `				bIsCtor = 1;` |
|        - |  8800 | `			}` |
|    52376 |  8801 | `		}` |
|  1395485 |  8802 | `		if( pGen->pIn < pEnd ){` |
|        - |  8803 | `			/* Collect method arguments */` |
|   395617 |  8804 | `			rc = GenStateCollectFuncArgs(&pMeth->sFunc,&(*pGen),pEnd,bIsCtor,bAbstractCtor);` |
|   395617 |  8805 | `			if( rc == SXERR_ABORT ){` |
|      ! 0 |  8806 | `				return SXERR_ABORT;` |
|        - |  8807 | `			}` |
|   197806 |  8808 | `		}` |
|        - |  8809 | `	}` |
|        - |  8810 | `	/* Point past ')' and parse optional return type ': type' */` |
|  1395485 |  8811 | `	pGen->pIn = &pEnd[1];` |
|        - |  8812 | `	{` |
|  1395485 |  8813 | `		sxi32 rcRt = GenStateParseReturnType(pGen, &pMeth->sFunc);` |
|  1395485 |  8814 | `		if( rcRt == SXERR_ABORT ){` |
|      ! 0 |  8815 | `			return SXERR_ABORT;` |
|  1395485 |  8816 | `		}else if( rcRt == SXERR_SYNTAX ){` |
...
|        - |  8823 | `	{` |
|  1395485 |  8824 | `		sxu32 nArg = SySetUsed(&pMeth->sFunc.aArgs);` |
|        - |  8825 | `		sxu32 i;` |
|  1984865 |  8826 | `		for( i = 0; i < nArg; i++ ){` |
|   589395 |  8827 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pMeth->sFunc.aArgs,i);` |
|        - |  8828 | `			ph7_class_attr *pAttr;` |
|   589395 |  8829 | `			sxi32 iAttrFlags = 0;` |
|        - |  8830 | `			int bArgTyped;` |
|   589395 |  8831 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|   589311 |  8832 | `				continue;` |
|        - |  8833 | `			}` |
...
|       42 |  8928 | `		}` |
|        - |  8929 | `	}` |
|  1395475 |  8930 | `	if( doBody ){` |
|        - |  8931 | `		/* Compile method body */` |
|  1294741 |  8932 | `		rc = GenStateCompileFuncBody(&(*pGen),&pMeth->sFunc);` |
|  1294741 |  8933 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 |  8934 | `			return SXERR_ABORT;` |
|        - |  8935 | `		}` |
|        - |  8936 | `		/* The cursor sits just past the body's closing brace */` |
|  1294741 |  8937 | `		pMeth->sFunc.nEndLine = pGen->pIn[-1].nLine;` |
|   647373 |  8938 | `	}else{` |
...
|  1395475 |  8955 | `	rc = PH7_ClassInstallMethod(pClass,pMeth);` |
|  1395475 |  8956 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  8957 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 |  8958 | `		return SXERR_ABORT;` |
|        - |  8959 | `	}` |
|  1395475 |  8960 | `	return SXRET_OK;` |
|        6 |  8961 | `Synchronize:` |
...
|        - |  9416 | ` */` |
|    46568 |  9417 | `static sxi32 PH7_CompileClassInterface(ph7_gen_state *pGen)` |
|        5 |  9418 | `{` |
|    46573 |  9419 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|    46573 |  9428 | `	pName = &pGen->pIn->sData;` |
|        - |  9429 | `	/* Advance the stream cursor */` |
|    46573 |  9430 | `	pGen->pIn++;` |
|        - |  9431 | `	/* Build FQN and obtain a raw class */ {` |
|        - |  9432 | `		SyBlob sFQN;` |
|        - |  9433 | `		SyString sFQNStr;` |
|    46573 |  9434 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|    46573 |  9435 | `		GenStateBuildFQN(pGen,pName,&sFQN);` |
|    46573 |  9436 | `		SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|    46573 |  9437 | `		pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|    46573 |  9438 | `		SyBlobRelease(&sFQN);` |
|        - |  9439 | `	}` |
|    46573 |  9440 | `	if( pClass == 0 ){` |
|      ! 0 |  9441 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 |  9442 | `		return SXERR_ABORT;` |
|        - |  9443 | `	}` |
|    46573 |  9444 | `	GenStateConsumeDoc(&(*pGen),&pClass->sDoc);` |
|    46573 |  9445 | `	if( GenStateConsumeAttrs(&(*pGen),&pClass->aAttrs) == SXERR_ABORT ){` |
|      ! 0 |  9446 | `		return SXERR_ABORT;` |
|        - |  9447 | `	}` |
|        - |  9448 | `	/* Mark as an interface (PH7_NewRawClass may have set INTERNAL) */` |
|    46573 |  9449 | `	pClass->iFlags \|= PH7_CLASS_INTERFACE;` |
|        - |  9450 | `	/* Assume no base class is given */` |
|    46573 |  9451 | `	pBase = 0;` |
|    46573 |  9452 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
...
|     7749 |  9490 | `		}` |
|     7749 |  9491 | `	}` |
|    46573 |  9492 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|        - |  9493 | `		/* Syntax error */` |
...
|        - |  9501 | `	}` |
|    46573 |  9502 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|    46573 |  9503 | `	pEnd = 0; /* cc warning */` |
|        - |  9504 | `	/* Delimit the interface body */` |
|    46573 |  9505 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|    46573 |  9506 | `	if( pEnd >= pGen->pEnd ){` |
|        - |  9507 | `		/* Syntax error */` |
...
|    46573 |  9517 | `	pClass->nEndLine = pEnd->nLine;` |
|        - |  9518 | `	/* Swap token stream */` |
|    46573 |  9519 | `	pTmp = pGen->pEnd;` |
|    46573 |  9520 | `	pGen->pEnd = pEnd;` |
...
|   248037 |  9528 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|   100735 |  9529 | `			pGen->pIn++;` |
|        5 |  9530 | `		}` |
|   147307 |  9531 | `		if( pGen->pIn >= pGen->pEnd ){` |
|        - |  9532 | `			/* End of interface body */` |
|    46569 |  9533 | `			break;` |
|        - |  9534 | `		}` |
|        - |  9535 | `		/* Bind a directly-preceding docblock to this member */` |
|   100743 |  9536 | `		GenStateSetPendingDoc(&(*pGen));` |
|   100743 |  9537 | `		if( (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|   100743 |  9548 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   100743 |  9549 | `		if( nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
...
|        3 |  9578 | `			goto done;` |
|        - |  9579 | `		}` |
|   100741 |  9580 | `		if( nKwrd != PH7_TKWRD_PUBLIC && nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|      ! 0 |  9587 | `			goto done;` |
|        - |  9588 | `		}` |
|   100741 |  9589 | `		if( nKwrd == PH7_TKWRD_PUBLIC ){` |
...
|        - |  9657 | `			}` |
|    50357 |  9658 | `		}` |
|   100737 |  9659 | `		if( nKwrd == PH7_TKWRD_CONST ){` |
|        - |  9660 | `			/* Parse constant */` |
|       16 |  9661 | `			rc = GenStateCompileClassConstant(&(*pGen),0,0,pClass);` |
|       16 |  9662 | `			if( rc != SXRET_OK ){` |
...
|    46569 |  9697 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|    46569 |  9698 | `	if( rc == SXRET_OK && pBase ){` |
|        - |  9699 | `		/* Inherit from the base interface */` |
|    15503 |  9700 | `		rc = PH7_ClassInterfaceInherit(pClass,pBase);` |
|     7749 |  9701 | `	}` |
|    46569 |  9702 | `	if( rc != SXRET_OK ){` |
...
|    46573 |  9708 | `	pGen->pIn  = &pEnd[1];` |
|    46573 |  9709 | `	pGen->pEnd = pTmp;` |
|    46573 |  9710 | `	return PH7_OK;` |
|    23289 |  9711 | `}` |
|        - |  9712 | `/*` |
...
|        - |  9736 | ` */` |
|   218534 |  9737 | `static sxi32 GenStateCheckInterfaceSignatures(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 |  9738 | `{` |
|        - |  9739 | `	ph7_class **apIface;` |
|        - |  9740 | `	sxu32 nIface,i;` |
|        - |  9741 | `	sxi32 rc;` |
|   218539 |  9742 | `	if( pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|      ! 0 |  9743 | `		return SXRET_OK;` |
|        - |  9744 | `	}` |
|   218539 |  9745 | `	apIface = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|   218539 |  9746 | `	nIface = SySetUsed(&pClass->aInterface);` |
|   439575 |  9747 | `	for(i = 0; i < nIface; i++){` |
|   221041 |  9748 | `		ph7_class *pIface = apIface[i];` |
|        - |  9749 | `		SyHashEntry *pEntry;` |
|   221041 |  9750 | `		SyHashResetLoopCursor(&pIface->hMethod);` |
|   519765 |  9751 | `		while((pEntry = SyHashGetNextEntry(&pIface->hMethod)) != 0 ){` |
|   298729 |  9752 | `			ph7_class_method *pIfaceMeth = (ph7_class_method *)pEntry->pUserData;` |
|        - |  9753 | `			ph7_class_method *pImplMeth;` |
|   298729 |  9754 | `			SyString *pMName = &pIfaceMeth->sFunc.sName;` |
|        - |  9755 | `			/* Find the implementing method in the class */` |
|   298729 |  9756 | `			pImplMeth = PH7_ClassExtractMethod(pClass,pMName->zString,pMName->nByte);` |
|   298729 |  9757 | `			if( pImplMeth == 0 \|\| (pImplMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT) ){` |
...
|   298711 |  9761 | `			if( pImplMeth->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|        - |  9771 | `			 */` |
|        - |  9772 | `			{` |
|   298711 |  9773 | `				sxu32 nIfaceArgs = SySetUsed(&pIfaceMeth->sFunc.aArgs);` |
|   298711 |  9774 | `				sxu32 nImplArgs = SySetUsed(&pImplMeth->sFunc.aArgs);` |
|   298711 |  9775 | `				int sigError = 0;` |
|   298711 |  9776 | `				if( nImplArgs < nIfaceArgs ){` |
|        3 |  9777 | `					sigError = 1;` |
|   298710 |  9778 | `				}else if( nImplArgs > nIfaceArgs ){` |
...
|        - |  9869 | ` */` |
|   218534 |  9870 | `static sxi32 GenStateCheckAbstractMethods(ph7_gen_state *pGen,ph7_class *pClass)` |
|        5 |  9871 | `{` |
...
|   218539 |  9878 | `	if( pClass->iFlags & (PH7_CLASS_ABSTRACT\|PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|     7793 |  9879 | `		return SXRET_OK;` |
|        - |  9880 | `	}` |
|        - |  9881 | `	/* Count abstract methods */` |
|   210751 |  9882 | `	nAbstract = 0;` |
|   210751 |  9883 | `	SyHashResetLoopCursor(&pClass->hMethod);` |
|  3179868 |  9884 | `	while((pEntry = SyHashGetNextEntry(&pClass->hMethod)) != 0 ){` |
|  2863749 |  9885 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|  2863749 |  9886 | `		if( pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
...
|        8 |  9891 | `		}` |
|        5 |  9892 | `	}` |
|   210751 |  9893 | `	if( nAbstract == 0 ){` |
|   210737 |  9894 | `		return SXRET_OK;` |
|        - |  9895 | `	}` |
...
|        - | 10032 | ` */` |
|   191642 | 10033 | `static sxi32 GenStateParseClassReference(ph7_gen_state *pGen,SyBlob *pFqn)` |
|        5 | 10034 | `{` |
|   191647 | 10035 | `	int isAbsolute = 0;` |
|   191647 | 10036 | `	SyToken *pStart = pGen->pIn;` |
|        - | 10037 | `	SyBlob sName;` |
|   191647 | 10038 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) ){` |
|     4461 | 10039 | `		isAbsolute = 1;` |
|     4461 | 10040 | `		pGen->pIn++;` |
|     2228 | 10041 | `	}` |
|   191647 | 10042 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|        8 | 10043 | `		pGen->pIn = pStart;` |
|        8 | 10044 | `		return SXERR_INVALID;` |
|        - | 10045 | `	}` |
|   191641 | 10046 | `	SyBlobInit(&sName,&pGen->pVm->sAllocator);` |
|   191641 | 10047 | `	SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|   191641 | 10048 | `	pGen->pIn++;` |
|   287475 | 10049 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) &&` |
|    95844 | 10050 | `		&pGen->pIn[1] < pGen->pEnd && (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|       16 | 10051 | `		SyBlobAppend(&sName,"\\",1);` |
|       16 | 10052 | `		pGen->pIn++;` |
|       16 | 10053 | `		SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|       16 | 10054 | `		pGen->pIn++;` |
|        2 | 10055 | `	}` |
|   191641 | 10056 | `	if( isAbsolute ){` |
|     4459 | 10057 | `		SyBlobAppend(pFqn,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|     2232 | 10058 | `	}else{` |
|        - | 10059 | `		SyString sRaw;` |
|   187187 | 10060 | `		SyStringInitFromBuf(&sRaw,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|   187187 | 10061 | `		GenStateResolveName(pGen,&sRaw,pFqn);` |
|        - | 10062 | `	}` |
|   191641 | 10063 | `	SyBlobRelease(&sName);` |
|   191641 | 10064 | `	return SXRET_OK;` |
|    95826 | 10065 | `}` |
|        - | 10066 | `/*` |
...
|    46664 | 10074 | `static int GenStateInterfaceIsThrowableAt(ph7_class *pInterface,int iDepth)` |
|        5 | 10075 | `{` |
|        - | 10076 | `	ph7_class **apParent;` |
|        - | 10077 | `	sxu32 n;` |
|   120475 | 10078 | `	while( pInterface ){` |
|    81565 | 10079 | `		if( iDepth > PH7_THROWABLE_WALK_MAX_DEPTH ){` |
|      ! 0 | 10080 | `			return FALSE;` |
|        - | 10081 | `		}` |
|   100944 | 10082 | `		if( pInterface->sName.nByte == sizeof("Throwable")-1 &&` |
|    38758 | 10083 | `			SyMemcmp(pInterface->sName.zString,"Throwable",sizeof("Throwable")-1) == 0 ){` |
|     7759 | 10084 | `			return TRUE;` |
|        - | 10085 | `		}` |
|    73811 | 10086 | `		apParent = (ph7_class **)SySetBasePtr(&pInterface->aInterface);` |
|    73811 | 10087 | `		for( n = 0 ; n < SySetUsed(&pInterface->aInterface) ; ++n ){` |
|      ! 0 | 10088 | `			if( GenStateInterfaceIsThrowableAt(apParent[n],iDepth+1) ){` |
|      ! 0 | 10089 | `				return TRUE;` |
|        - | 10090 | `			}` |
|      ! 0 | 10091 | `		}` |
|    73811 | 10092 | `		pInterface = pInterface->pBase;` |
|    73811 | 10093 | `		iDepth++;` |
|        5 | 10094 | `	}` |
|    38915 | 10095 | `	return FALSE;` |
|    23337 | 10096 | `}` |
|    46664 | 10097 | `static int GenStateInterfaceIsThrowable(ph7_class *pInterface)` |
|        5 | 10098 | `{` |
|    46669 | 10099 | `	return GenStateInterfaceIsThrowableAt(pInterface,0);` |
|        5 | 10100 | `}` |
|        - | 10101 | `/*` |
...
|        - | 10352 | ` */` |
|   218578 | 10353 | `static sxi32 GenStateCompileClassEx(ph7_gen_state *pGen,sxi32 iFlags,` |
|        - | 10354 | `	SyString *pAnonName,SyToken **ppArgStart,SyToken **ppArgEnd)` |
|        5 | 10355 | `{` |
|   218583 | 10356 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|   218583 | 10367 | `	pGen->pIn++;` |
|   218583 | 10368 | `	if( pAnonName ){` |
...
|       18 | 10383 | `	}else{` |
|   218555 | 10384 | `		if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
|        - | 10385 | `			/* Syntax error */` |
...
|   218555 | 10398 | `		pName = &pGen->pIn->sData;` |
|        - | 10399 | `		/* Advance the stream cursor */` |
|   218555 | 10400 | `		pGen->pIn++;` |
|        - | 10401 | `		/* Build FQN and obtain a raw class */ {` |
|        - | 10402 | `			SyBlob sFQN;` |
|        - | 10403 | `			SyString sFQNStr;` |
|   218555 | 10404 | `			SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|   218555 | 10405 | `			GenStateBuildFQN(pGen,pName,&sFQN);` |
|   218555 | 10406 | `			SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|   218555 | 10407 | `			pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|   218555 | 10408 | `			SyBlobRelease(&sFQN);` |
|        - | 10409 | `		}` |
|        - | 10410 | `	}` |
|   218583 | 10411 | `	if( pClass == 0 ){` |
|      ! 0 | 10412 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 10413 | `		return SXERR_ABORT;` |
|        - | 10414 | `	}` |
|   218578 | 10415 | `	if( (iFlags & PH7_CLASS_ENUM) && pGen->pIn < pGen->pEnd` |
...
|        - | 10438 | `		}` |
|     1943 | 10439 | `	}` |
|   218583 | 10440 | `	GenStateConsumeDoc(&(*pGen),&pClass->sDoc);` |
|   218583 | 10441 | `	if( GenStateConsumeAttrs(&(*pGen),&pClass->aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 10442 | `		return SXERR_ABORT;` |
|        - | 10443 | `	}` |
|        - | 10444 | `	/* implemented interfaces and per-use-statement trait containers */` |
|   218583 | 10445 | `	SySetInit(&aInterfaces,&pGen->pVm->sAllocator,sizeof(ph7_class *));` |
|   218583 | 10446 | `	SySetInit(&aUseEntries,&pGen->pVm->sAllocator,sizeof(TraitUseEntry));` |
|        - | 10447 | `	/* Assume a standalone class */` |
|   218583 | 10448 | `	pBase = 0;` |
|   218583 | 10449 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|   170791 | 10450 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   170791 | 10451 | `		if( nKwrd == PH7_TKWRD_EXTENDS /* class b extends a */ ){` |
|        - | 10452 | `			SyBlob sResolved;` |
|        - | 10453 | `			SyString sBaseName;` |
|        - | 10454 | `			sxu32 nRefLine;` |
|   124151 | 10455 | `			if( iFlags & PH7_CLASS_ENUM ){` |
...
|        - | 10461 | `				}` |
|      ! 0 | 10462 | `			}` |
|   124151 | 10463 | `			pGen->pIn++; /* Advance past 'extends' */` |
|   124151 | 10464 | `			nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|   124151 | 10465 | `			SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|   124151 | 10466 | `			if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|        - | 10476 | `			}` |
|   186221 | 10477 | `			pBase = PH7_VmExtractClass(pGen->pVm,` |
|   124144 | 10478 | `				(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|   124149 | 10479 | `			SyStringInitFromBuf(&sBaseName,` |
|        - | 10480 | `				(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|        - | 10481 | `			/* Interfaces are not allowed */` |
|   124149 | 10482 | `			while( pBase && (pBase->iFlags & PH7_CLASS_INTERFACE) ){` |
|      ! 0 | 10483 | `				pBase = pBase->pNextName;` |
|      ! 0 | 10484 | `			}` |
|   124149 | 10485 | `			if( pBase == 0 ){` |
...
|        - | 10491 | `				}` |
|      ! 0 | 10492 | `			}else{` |
|   124149 | 10493 | `				if( pBase->iFlags & PH7_CLASS_ENUM ){` |
...
|   124148 | 10501 | `				}else if( pBase->iFlags & PH7_CLASS_FINAL ){` |
...
|      ! 0 | 10508 | `				}` |
|        - | 10509 | `			}` |
|   124149 | 10510 | `			SyBlobRelease(&sResolved);` |
|   124149 | 10511 | `			if( iFlags & PH7_CLASS_ENUM ){` |
|      ! 0 | 10512 | `				pBase = 0; /* Error already reported: enums have no base class */` |
|      ! 0 | 10513 | `			}` |
|    62072 | 10514 | `		}` |
|   170789 | 10515 | `		if (pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) && SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_IMPLEMENTS ){` |
|        - | 10516 | `			ph7_class *pInterface;` |
|        - | 10517 | `			/* Interface implementation */` |
|    46657 | 10518 | `			pGen->pIn++; /* Advance the stream cursor */` |
|    23338 | 10519 | `			for(;;){` |
|        - | 10520 | `				SyBlob sResolved;` |
|        - | 10521 | `				SyString sIntName;` |
|        - | 10522 | `				sxu32 nRefLine;` |
|    46669 | 10523 | `				nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|    46669 | 10524 | `				SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|    46669 | 10525 | `				if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|      ! 0 | 10533 | `					break;` |
|        - | 10534 | `				}` |
|    93333 | 10535 | `				pInterface = PH7_VmExtractClass(pGen->pVm,` |
|    46664 | 10536 | `					(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|    46669 | 10537 | `				SyStringInitFromBuf(&sIntName,` |
|        - | 10538 | `					(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|        - | 10539 | `				/* Only interfaces are allowed */` |
|    46669 | 10540 | `				while( pInterface && (pInterface->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|      ! 0 | 10541 | `					pInterface = pInterface->pNextName;` |
|      ! 0 | 10542 | `				}` |
|    46669 | 10543 | `				if( pInterface == 0 ){` |
...
|    46669 | 10557 | `					SyString *pFqn = &pClass->sName;` |
|    46669 | 10558 | `					int bIsExceptionOrError =` |
|    27208 | 10559 | `						(pFqn->nByte == sizeof("Exception")-1 &&` |
|    71936 | 10560 | `						 SyMemcmp(pFqn->zString,"Exception",sizeof("Exception")-1) == 0) \|\|` |
|    44735 | 10561 | `						(pFqn->nByte == sizeof("Error")-1 &&` |
|     3886 | 10562 | `						 SyMemcmp(pFqn->zString,"Error",sizeof("Error")-1) == 0);` |
|    50541 | 10563 | `					if( GenStateInterfaceIsThrowable(pInterface) &&` |
...
|        6 | 10575 | `					}else{` |
|    46663 | 10576 | `						SySetPut(&aInterfaces,(const void *)&pInterface);` |
|        - | 10577 | `					}` |
|        - | 10578 | `				}` |
|    46669 | 10579 | `				SyBlobRelease(&sResolved);` |
|    46669 | 10580 | `				if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COMMA) == 0 ){` |
|    23331 | 10581 | `					break;` |
|        - | 10582 | `				}` |
...
|    23326 | 10585 | `		}` |
|    85392 | 10586 | `	}` |
|   218581 | 10587 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|        - | 10588 | `		/* Syntax error */` |
...
|        - | 10596 | `	}` |
|   218581 | 10597 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|   218581 | 10598 | `	pEnd = 0; /* cc warning */` |
|        - | 10599 | `	/* Delimit the class body */` |
|   218581 | 10600 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|   218581 | 10601 | `	if( pEnd >= pGen->pEnd ){` |
|        - | 10602 | `		/* Syntax error */` |
...
|   218581 | 10612 | `	pClass->nEndLine = pEnd->nLine;` |
|        - | 10613 | `	/* Swap token stream */` |
|   218581 | 10614 | `	pTmp = pGen->pEnd;` |
|   218581 | 10615 | `	pGen->pEnd = pEnd;` |
|        - | 10616 | `	/* Merge the inherited flags (PH7_NewRawClass may have set INTERNAL) */` |
|   218581 | 10617 | `	pClass->iFlags \|= iFlags;` |
|        - | 10618 | `	/* Start the parse process */` |
|   822502 | 10619 | `	for(;;){` |
|        - | 10620 | `		/* Jump leading/trailing semi-colons */` |
|  2224061 | 10621 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|   361193 | 10622 | `			pGen->pIn++;` |
|        5 | 10623 | `		}` |
|  1862873 | 10624 | `		if( pGen->pIn >= pGen->pEnd ){` |
|        - | 10625 | `			/* End of class body */` |
|   218539 | 10626 | `			break;` |
|        - | 10627 | `		}` |
|        - | 10628 | `		/* Bind a directly-preceding docblock to this member */` |
|  1644339 | 10629 | `		GenStateSetPendingDoc(&(*pGen));` |
|  1644334 | 10630 | `		if( (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR)) == 0` |
|   822172 | 10631 | ``			&& !GenStateIsReadonly(pGen->pIn) /* allow a leading `readonly` modifier */ ){`` |
...
|  1644339 | 10642 | `		iProtection = PH7_TKWRD_PUBLIC;` |
|  1644339 | 10643 | `		iAttrflags = 0;` |
...
|  1644339 | 10648 | `		if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|      ! 0 | 10649 | `			int bMod = 0;` |
...
|        - | 10670 | `			}` |
|      ! 0 | 10671 | `		}` |
|  1644339 | 10672 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|        - | 10673 | `			/* Extract the current keyword */` |
|  1644339 | 10674 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  1644339 | 10675 | `			if( nKwrd == PH7_TKWRD_CASE && (pClass->iFlags & PH7_CLASS_ENUM) ){` |
...
|     7787 | 10684 | `				continue;` |
|        - | 10685 | `			}` |
|  1636553 | 10686 | `			if( nKwrd == PH7_TKWRD_USE ){` |
|        - | 10687 | `				/* Trait use: use TraitA, TraitB [{ ... }]; */` |
|        - | 10688 | `				TraitUseEntry sUse;` |
|       65 | 10689 | `				SySetInit(&sUse.aTraits,&pGen->pVm->sAllocator,sizeof(ph7_class *));` |
|       65 | 10690 | `				sUse.pResolvStart = sUse.pResolvEnd = 0;` |
|       65 | 10691 | `				pGen->pIn++; /* Jump the 'use' keyword */` |
|       38 | 10692 | `				for(;;){` |
|        - | 10693 | `					ph7_class *pTrait;` |
|        - | 10694 | `					SyString *pTraitName;` |
|       73 | 10695 | `					if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
...
|      ! 0 | 10701 | `						break;` |
|        - | 10702 | `					}` |
|       73 | 10703 | `					pTraitName = &pGen->pIn->sData;` |
|        - | 10704 | `					/* Resolve trait name through namespace/imports */ {` |
|        - | 10705 | `						SyBlob sResolved;` |
|       73 | 10706 | `						SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|       73 | 10707 | `						GenStateResolveName(pGen,pTraitName,&sResolved);` |
|      141 | 10708 | `						pTrait = PH7_VmExtractClass(pGen->pVm,` |
|       68 | 10709 | `							(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|       73 | 10710 | `						SyBlobRelease(&sResolved);` |
|        - | 10711 | `					}` |
|        - | 10712 | `					/* Only traits are allowed */` |
|       73 | 10713 | `					while( pTrait && (pTrait->iFlags & PH7_CLASS_TRAIT) == 0 ){` |
|      ! 0 | 10714 | `						pTrait = pTrait->pNextName;` |
|      ! 0 | 10715 | `					}` |
|       73 | 10716 | `					if( pTrait == 0 ){` |
...
|        - | 10721 | `						}` |
|      ! 0 | 10722 | `					}else{` |
|       73 | 10723 | `						SySetPut(&sUse.aTraits,(const void *)&pTrait);` |
|        - | 10724 | `					}` |
|       73 | 10725 | `					pGen->pIn++; /* Advance past trait name */` |
|       73 | 10726 | `					if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COMMA) == 0 ){` |
|       35 | 10727 | `						break;` |
|        - | 10728 | `					}` |
|       10 | 10729 | `					pGen->pIn++; /* Jump the comma */` |
|        2 | 10730 | `				}` |
|        - | 10731 | `				/* Expect semicolon or opening brace (for conflict resolution) */` |
|       65 | 10732 | `				if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OCB) ){` |
...
|        - | 10742 | `					}` |
|        5 | 10743 | `				}` |
|       65 | 10744 | `				SySetPut(&aUseEntries,(const void *)&sUse);` |
|        - | 10745 | `				/* The semicolon will be consumed by the outer loop */` |
|       65 | 10746 | `				continue;` |
|        - | 10747 | `			}` |
|  1636493 | 10748 | `			if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|        - | 10749 | `				int nSetTok;` |
|  1492737 | 10750 | `				sxi32 nSetVis = GenStatePeekSetVisibility(pGen->pIn,pGen->pEnd,&nSetTok);` |
|  1492737 | 10751 | `				if( nSetVis ){` |
...
|        2 | 10756 | `				}else{` |
|  1492735 | 10757 | `					iProtection = nKwrd;` |
|  1492735 | 10758 | `					pGen->pIn++; /* Jump the visibility token */` |
|        - | 10759 | `					/* Optional asymmetric set-visibility after the read` |
|        - | 10760 | ``					 * visibility: `public private(set) int $x`. */`` |
|  1492735 | 10761 | `					nSetVis = GenStatePeekSetVisibility(pGen->pIn,pGen->pEnd,&nSetTok);` |
|  1492735 | 10762 | `					if( nSetVis ){` |
...
|  1492737 | 10769 | `				if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|       24 | 10770 | `					iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|       24 | 10771 | `					pGen->pIn++; /* Jump the 'readonly' modifier */` |
|       10 | 10772 | `				}` |
|  1492732 | 10773 | `				if( pGen->pIn >= pGen->pEnd` |
|  1492737 | 10774 | `					\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|      ! 0 | 10782 | `					goto done;` |
|        - | 10783 | `				}` |
|  1492737 | 10784 | `				if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|        - | 10785 | `					/* Attribute declaration (untyped) */` |
|   209693 | 10786 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|   209693 | 10787 | `					if( rc != SXRET_OK ){` |
|       11 | 10788 | `						if( rc == SXERR_ABORT ){` |
|      ! 0 | 10789 | `							return SXERR_ABORT;` |
|        - | 10790 | `						}` |
|       11 | 10791 | `						goto done;` |
|        - | 10792 | `					}` |
|   209829 | 10793 | `					continue;` |
|        - | 10794 | `				}` |
|  1283049 | 10795 | `				if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|  1282755 | 10807 | `				nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   641375 | 10808 | `			}` |
|  1426511 | 10809 | `			if( nKwrd == PH7_TKWRD_CONST ){` |
...
|        - | 10817 | `				}` |
|    71708 | 10818 | `			}else{` |
|  1283097 | 10819 | `				if( nKwrd == PH7_TKWRD_STATIC ){` |
...
|  1271393 | 10886 | `				}else if( nKwrd == PH7_TKWRD_ABSTRACT ){` |
...
|  1259717 | 10935 | `				}else if( nKwrd == PH7_TKWRD_FINAL ){` |
...
|        3 | 10979 | `				}` |
|  1283039 | 10980 | `				if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_VAR ){` |
...
|      ! 0 | 10988 | `						goto done;` |
|        - | 10989 | `				}` |
|  1283039 | 10990 | `				if( nKwrd == PH7_TKWRD_VAR ){` |
...
|  1283033 | 11005 | `					rc = GenStateCompileClassMethod(&(*pGen),iProtection,iAttrflags,TRUE,pClass);` |
|        - | 11006 | `				}` |
|  1283039 | 11007 | `				if( rc != SXRET_OK ){` |
...
|        - | 11030 | `		sxu32 nU;` |
|   218539 | 11031 | `		apUse = (TraitUseEntry *)SySetBasePtr(&aUseEntries);` |
|   218599 | 11032 | `		for( nU = 0 ; nU < SySetUsed(&aUseEntries) ; nU++ ){` |
|       65 | 11033 | `			TraitUseEntry *pUse = &apUse[nU];` |
|       65 | 11034 | `			ph7_class **apTrait = (ph7_class **)SySetBasePtr(&pUse->aTraits);` |
|       65 | 11035 | `			sxu32 nTraits = SySetUsed(&pUse->aTraits);` |
|       65 | 11036 | `			int hasResolution = (pUse->pResolvStart && pUse->pResolvStart < pUse->pResolvEnd) ? 1 : 0;` |
|        - | 11037 | `			sxu32 nT;` |
|       65 | 11038 | `			if( !hasResolution ){` |
|        - | 11039 | `				/* No conflict resolution block: use standard trait application */` |
|      111 | 11040 | `				for( nT = 0 ; nT < nTraits ; nT++ ){` |
|       61 | 11041 | `					rc = PH7_ClassUseTrait(&(*pGen),pClass,apTrait[nT]);` |
|       61 | 11042 | `					if( rc != SXRET_OK ){` |
|      ! 0 | 11043 | `						break;` |
|        - | 11044 | `					}` |
|       33 | 11045 | `				}` |
|       30 | 11046 | `			}else{` |
...
|        3 | 11234 | `				}` |
|        - | 11235 | `			}` |
|       65 | 11236 | `			SySetRelease(&pUse->aTraits);` |
|       35 | 11237 | `		}` |
|        - | 11238 | `	}` |
|   218539 | 11239 | `	if( pClass->iFlags & PH7_CLASS_ENUM ){` |
...
|   218539 | 11250 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|   218539 | 11251 | `	if( rc == SXRET_OK ){` |
|        - | 11252 | `		ph7_class **apInterface;` |
|        - | 11253 | `		sxu32 n;` |
|   218539 | 11254 | `		if( pBase ){` |
|        - | 11255 | `			/* Inherit from base class and mark as a subclass */` |
|   124147 | 11256 | `			rc = PH7_ClassInherit(&(*pGen),pClass,pBase);` |
|    62071 | 11257 | `		}` |
|   218539 | 11258 | `		apInterface = (ph7_class **)SySetBasePtr(&aInterfaces);` |
|   265197 | 11259 | `		for( n = 0 ; n < SySetUsed(&aInterfaces) ; n++ ){` |
|        - | 11260 | `			/* Implements one or more interface */` |
|    46663 | 11261 | `			rc = PH7_ClassImplement(pClass,apInterface[n]);` |
|    46663 | 11262 | `			if( rc != SXRET_OK ){` |
|      ! 0 | 11263 | `				break;` |
|        - | 11264 | `			}` |
|    23334 | 11265 | `		}` |
...
|   218539 | 11268 | `		if( rc == SXRET_OK && (pClass->iFlags & PH7_CLASS_ENUM) ){` |
...
|   218534 | 11288 | `		if( rc == SXRET_OK` |
|   218534 | 11289 | `		 && (pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT)) == 0` |
|   218539 | 11290 | `		 && SyHashGet(&pClass->hMethod,"__toString",sizeof("__toString")-1) != 0 ){` |
|   170477 | 11291 | `			ph7_class *pStringable = PH7_VmExtractClass(pGen->pVm,` |
|        - | 11292 | `				"Stringable",sizeof("Stringable")-1,FALSE,0);` |
|   170477 | 11293 | `			if( pStringable ){` |
|   170477 | 11294 | `				ph7_class **apImpl = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|   170477 | 11295 | `				sxu32 nImpl = SySetUsed(&pClass->aInterface);` |
|        - | 11296 | `				sxu32 i;` |
|   170477 | 11297 | `				int bAlready = 0;` |
|   209201 | 11298 | `				for( i = 0 ; i < nImpl ; i++ ){` |
|    42603 | 11299 | `					if( apImpl[i] == pStringable ){` |
|     3879 | 11300 | `						bAlready = 1;` |
|     3879 | 11301 | `						break;` |
|        - | 11302 | `					}` |
|    19367 | 11303 | `				}` |
|   170477 | 11304 | `				if( !bAlready ){` |
|   166603 | 11305 | `					PH7_ClassImplement(pClass,pStringable);` |
|    83299 | 11306 | `				}` |
|    85236 | 11307 | `			}` |
|    85236 | 11308 | `		}` |
|        - | 11309 | `		/* Validate interface method signatures (visibility and parameter count) */` |
|   218539 | 11310 | `		if( rc == SXRET_OK ){` |
|   218539 | 11311 | `			sxi32 rcCheck = GenStateCheckInterfaceSignatures(&(*pGen),pClass);` |
|   218539 | 11312 | `			if( rcCheck == SXERR_ABORT ){` |
...
|   218539 | 11319 | `		if( rc == SXRET_OK ){` |
|   218539 | 11320 | `			sxi32 rcCheck = GenStateCheckAbstractMethods(&(*pGen),pClass);` |
|   218539 | 11321 | `			if( rcCheck == SXERR_ABORT ){` |
...
|   109267 | 11326 | `		}` |
|   109267 | 11327 | `	}` |
|   218539 | 11328 | `	SySetRelease(&aUseEntries);` |
|   218539 | 11329 | `	SySetRelease(&aInterfaces);` |
|   218539 | 11330 | `	if( rc != SXRET_OK ){` |
...
|   218581 | 11336 | `	pGen->pIn = &pEnd[1];` |
|   218581 | 11337 | `	pGen->pEnd = pTmp;` |
|   218581 | 11338 | `	return PH7_OK;` |
|   109294 | 11339 | `}` |
|        - | 11340 | `/* Compile a named class declaration (the common case). */` |
|   218550 | 11341 | `static sxi32 GenStateCompileClass(ph7_gen_state *pGen,sxi32 iFlags)` |
|        5 | 11342 | `{` |
|   218555 | 11343 | `	return GenStateCompileClassEx(pGen,iFlags,0,0,0);` |
|        5 | 11344 | `}` |
|        - | 11345 | `/*` |
...
|        - | 11444 | ` */` |
|  6383776 | 11445 | `static int GenStateTokenIsClassModifier(SyToken *pTok,sxi32 *piFlag)` |
|        5 | 11446 | `{` |
|  6383781 | 11447 | `	if( pTok->nType & PH7_TK_KEYWORD ){` |
|  3954903 | 11448 | `		sxu32 nKw = (sxu32)SX_PTR_TO_INT(pTok->pUserData);` |
|  3954903 | 11449 | `		if( nKw == PH7_TKWRD_FINAL ){ *piFlag = PH7_CLASS_FINAL; return TRUE; }` |
|  3908413 | 11450 | `		if( nKw == PH7_TKWRD_ABSTRACT ){ *piFlag = PH7_CLASS_ABSTRACT; return TRUE; }` |
|  1946417 | 11451 | `	}` |
|  6321717 | 11452 | `	if( GenStateIsReadonly(pTok) ){ *piFlag = PH7_CLASS_READONLY; return TRUE; }` |
|  6321657 | 11453 | `	return FALSE;` |
|  3191893 | 11454 | `}` |
|        - | 11455 | `/*` |
...
|        - | 11460 | ` */` |
|  6321652 | 11461 | `static sxi32 GenStateScanClassModifiers(SyToken **ppIn,SyToken *pEnd,SyToken **ppDup)` |
|        5 | 11462 | `{` |
|  6321657 | 11463 | `	SyToken *pIn = *ppIn,*pDup = 0;` |
|  6321657 | 11464 | `	sxi32 iFlags = 0,iFlag;` |
|  6383781 | 11465 | `	while( pIn < pEnd && GenStateTokenIsClassModifier(pIn,&iFlag) ){` |
...
|    62129 | 11470 | `		pIn++;` |
|        5 | 11471 | `	}` |
|  6321657 | 11472 | `	*ppIn = pIn;` |
|  6321657 | 11473 | `	if( ppDup ){ *ppDup = pDup; }` |
|  6321657 | 11474 | `	return iFlags;` |
|        5 | 11475 | `}` |
|        - | 11476 | `/*` |
...
|        - | 11482 | ` */` |
|  6294472 | 11483 | `static int GenStateStartsModifiedClass(SyToken *pIn,SyToken *pEnd)` |
|        5 | 11484 | `{` |
|  6294477 | 11485 | `	sxi32 iFlags = GenStateScanClassModifiers(&pIn,pEnd,0);` |
|  3182167 | 11486 | `	return iFlags != 0 && pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD)` |
|  6311936 | 11487 | `		&& (sxu32)SX_PTR_TO_INT(pIn->pUserData) == PH7_TKWRD_CLASS;` |
|        5 | 11488 | `}` |
|        - | 11489 | `/*` |
...
|        - | 11523 | ` */` |
|       74 | 11524 | `static sxi32 PH7_CompileTrait(ph7_gen_state *pGen)` |
|        5 | 11525 | `{` |
|       79 | 11526 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|       79 | 11535 | `	pGen->pIn++;` |
|       79 | 11536 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
...
|       79 | 11547 | `	pName = &pGen->pIn->sData;` |
|       79 | 11548 | `	pGen->pIn++;` |
|        - | 11549 | `	/* Build FQN and obtain a raw class */ {` |
|        - | 11550 | `		SyBlob sFQN;` |
|        - | 11551 | `		SyString sFQNStr;` |
|       79 | 11552 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|       79 | 11553 | `		GenStateBuildFQN(pGen,pName,&sFQN);` |
|       79 | 11554 | `		SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|       79 | 11555 | `		pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|       79 | 11556 | `		SyBlobRelease(&sFQN);` |
|        - | 11557 | `	}` |
|       79 | 11558 | `	if( pClass == 0 ){` |
|      ! 0 | 11559 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|      ! 0 | 11560 | `		return SXERR_ABORT;` |
|        - | 11561 | `	}` |
|       79 | 11562 | `	GenStateConsumeDoc(&(*pGen),&pClass->sDoc);` |
|       79 | 11563 | `	if( GenStateConsumeAttrs(&(*pGen),&pClass->aAttrs) == SXERR_ABORT ){` |
|      ! 0 | 11564 | `		return SXERR_ABORT;` |
|        - | 11565 | `	}` |
|        - | 11566 | `	/* Traits cannot extend or implement; expect opening brace directly */` |
|       79 | 11567 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_OCB) == 0 ){` |
...
|        - | 11574 | `	}` |
|       79 | 11575 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|       79 | 11576 | `	pEnd = 0;` |
|       79 | 11577 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB,PH7_TK_CCB,&pEnd);` |
|       79 | 11578 | `	if( pEnd >= pGen->pEnd ){` |
...
|       79 | 11587 | `	pClass->nEndLine = pEnd->nLine;` |
|        - | 11588 | `	/* Swap token stream */` |
|       79 | 11589 | `	pTmp = pGen->pEnd;` |
|       79 | 11590 | `	pGen->pEnd = pEnd;` |
|        - | 11591 | `	/* Mark as trait (PH7_NewRawClass may have set INTERNAL) */` |
|       79 | 11592 | `	pClass->iFlags \|= PH7_CLASS_TRAIT;` |
|        - | 11593 | `	/* Parse the body: same as a normal class (methods, attributes, visibility modifiers) */` |
|       73 | 11594 | `	for(;;){` |
|      199 | 11595 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|       30 | 11596 | `			pGen->pIn++;` |
|        4 | 11597 | `		}` |
|      173 | 11598 | `		if( pGen->pIn >= pGen->pEnd ){` |
|       79 | 11599 | `			break;` |
|        - | 11600 | `		}` |
|        - | 11601 | `		/* Bind a directly-preceding docblock to this member */` |
|       99 | 11602 | `		GenStateSetPendingDoc(&(*pGen));` |
|       99 | 11603 | `		if( (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR)) == 0 ){` |
...
|      ! 0 | 11610 | `			goto done;` |
|        - | 11611 | `		}` |
|       99 | 11612 | `		iProtection = PH7_TKWRD_PUBLIC;` |
|       99 | 11613 | `		iAttrflags = 0;` |
|       99 | 11614 | `		if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|       99 | 11615 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|       99 | 11616 | `			if( nKwrd == PH7_TKWRD_USE ){` |
...
|        5 | 11657 | `				continue;` |
|        - | 11658 | `			}` |
|       95 | 11659 | `			if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|       79 | 11660 | `				iProtection = nKwrd;` |
|       79 | 11661 | `				pGen->pIn++;` |
|       74 | 11662 | `				if( pGen->pIn >= pGen->pEnd` |
|       79 | 11663 | `					\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|      ! 0 | 11670 | `					goto done;` |
|        - | 11671 | `				}` |
|       79 | 11672 | `				if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|       15 | 11673 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|       15 | 11674 | `					if( rc != SXRET_OK ){` |
...
|       15 | 11680 | `					continue;` |
|        - | 11681 | `				}` |
|       67 | 11682 | `				if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|        5 | 11690 | `					continue;` |
|        - | 11691 | `				}` |
|       63 | 11692 | `				nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|       29 | 11693 | `			}` |
|       79 | 11694 | `			if( nKwrd == PH7_TKWRD_CONST ){` |
...
|      ! 0 | 11700 | `				goto done;` |
|      ! 0 | 11701 | `			}else{` |
|       79 | 11702 | `				if( nKwrd == PH7_TKWRD_STATIC ){` |
...
|       75 | 11743 | `				}else if( nKwrd == PH7_TKWRD_ABSTRACT ){` |
...
|        2 | 11764 | `				}` |
|       77 | 11765 | `				if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_VAR ){` |
...
|      ! 0 | 11772 | `					goto done;` |
|        - | 11773 | `				}` |
|       77 | 11774 | `				if( nKwrd == PH7_TKWRD_VAR ){` |
|      ! 0 | 11775 | `					pGen->pIn++;` |
...
|      ! 0 | 11785 | `				}else{` |
|       77 | 11786 | `					rc = GenStateCompileClassMethod(&(*pGen),iProtection,iAttrflags,TRUE,pClass);` |
|        - | 11787 | `				}` |
|       77 | 11788 | `				if( rc != SXRET_OK ){` |
...
|       79 | 11806 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|       79 | 11807 | `	if( rc != SXRET_OK ){` |
...
|       79 | 11813 | `	pGen->pIn = &pEnd[1];` |
|       79 | 11814 | `	pGen->pEnd = pTmp;` |
|       79 | 11815 | `	return PH7_OK;` |
|       42 | 11816 | `}` |
|        - | 11817 | `/*` |
...
|        - | 11825 | ` */` |
|   187470 | 11826 | `static sxi32 PH7_CompileClass(ph7_gen_state *pGen)` |
|        5 | 11827 | `{` |
|        - | 11828 | `	sxi32 rc;` |
|   187475 | 11829 | `	rc = GenStateCompileClass(&(*pGen),0);` |
|   187475 | 11830 | `	return rc;` |
|        5 | 11831 | `}` |
|        - | 11832 | `/*` |
...
|        - | 11838 | ` */` |
|  6259548 | 11839 | `static int GenStateStartsEnumDecl(SyToken *pIn,SyToken *pEnd)` |
|        5 | 11840 | `{` |
|  6294676 | 11841 | `	return (pIn->nType & PH7_TK_ID)` |
|  3164897 | 11842 | `		&& pIn->sData.nByte == sizeof("enum")-1` |
|    41054 | 11843 | `		&& SyStrnicmp(pIn->sData.zString,"enum",sizeof("enum")-1) == 0` |
|  6294671 | 11844 | `		&& &pIn[1] < pEnd && (pIn[1].nType & PH7_TK_ID);` |
|        5 | 11845 | `}` |
|        - | 11846 | `/*` |
...
|        - | 11877 | ` */` |
|   314044 | 11878 | `static sxi32 GenStateThrowNodeValidator(ph7_gen_state *pGen,ph7_expr_node *pRoot)` |
|        5 | 11879 | `{` |
|   314049 | 11880 | `	sxi32 rc = SXRET_OK;` |
|   314049 | 11881 | `	if( pRoot->pOp ){` |
|   314037 | 11882 | `		switch( pRoot->pOp->iOp ){` |
|   157016 | 11883 | `		case EXPR_OP_NEW:            /* new Exception() */` |
...
|      ! 0 | 11899 | `			break;` |
|        - | 11900 | `		}` |
|   157033 | 11901 | `	}else if( pRoot->xCode != PH7_CompileVariable ){` |
...
|        - | 11915 | ` */` |
|   314008 | 11916 | `static sxi32 PH7_CompileThrow(ph7_gen_state *pGen)` |
|        5 | 11917 | `{` |
|   314013 | 11918 | `	sxu32 nLine = pGen->pIn->nLine;` |
|        - | 11919 | `	GenBlock *pBlock;` |
|        - | 11920 | `	sxu32 nIdx;` |
|        - | 11921 | `	sxi32 rc;` |
|   314013 | 11922 | `	pGen->pIn++; /* Jump the 'throw' keyword */` |
|        - | 11923 | `	/* Compile the expression */` |
|   314013 | 11924 | `	rc = PH7_CompileExpr(&(*pGen),0,GenStateThrowNodeValidator);` |
|   314013 | 11925 | `	if( rc == SXERR_EMPTY ){` |
...
|        - | 11931 | `	}` |
|   314013 | 11932 | `	pBlock = pGen->pCurrent;` |
|        - | 11933 | `	/* Point to the top most function or try block and emit the forward jump */` |
|  1224329 | 11934 | `	while(pBlock->pParent){` |
|  1224325 | 11935 | `		if( pBlock->iFlags & (GEN_BLOCK_EXCEPTION\|GEN_BLOCK_FUNC) ){` |
|   314009 | 11936 | `			break;` |
|        - | 11937 | `		}` |
|        - | 11938 | `		/* Point to the parent block */` |
|   910321 | 11939 | `		pBlock = pBlock->pParent;` |
|        5 | 11940 | `	}` |
|        - | 11941 | `	/* Emit the throw instruction */` |
|   314013 | 11942 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_THROW,0,0,0,&nIdx);` |
|        - | 11943 | `	/* Emit the jump */` |
|   314013 | 11944 | `	GenStateNewJumpFixup(pBlock,PH7_OP_THROW,nIdx);` |
|   314013 | 11945 | `	return SXRET_OK;` |
|   157009 | 11946 | `}` |
|        - | 11947 | `/*` |
...
|        - | 12185 | ` */` |
|     5252 | 12186 | `static sxi32 PH7_CompileCatch(ph7_gen_state *pGen,ph7_exception *pException)` |
|        5 | 12187 | `{` |
|     5257 | 12188 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|        - | 12195 | `	char *zDup;` |
|        - | 12196 | `	sxi32 rc;` |
|     5257 | 12197 | `	pGen->pIn++; /* Jump the 'catch' keyword */` |
|        - | 12198 | `	/* Zero the structure */` |
|     5257 | 12199 | `	SyZero(&sCatch,sizeof(ph7_exception_block));` |
|        - | 12200 | `	/* Initialize fields */` |
|     5257 | 12201 | `	SySetInit(&sCatch.aClasses,&pException->pVm->sAllocator,sizeof(SyString));` |
|     5257 | 12202 | `	SySetInit(&sCatch.sByteCode,&pException->pVm->sAllocator,sizeof(VmInstr));` |
|     5257 | 12203 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 /*(*/ ){` |
...
|     5257 | 12218 | `	pGen->pIn++; /* Jump the left parenthesis '(' */` |
|     2640 | 12219 | `	for(;;){` |
|        - | 12220 | `		SyBlob sResolved;` |
|     5285 | 12221 | `		SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|     5285 | 12222 | `		if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|     7919 | 12238 | `		zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|     5276 | 12239 | `			(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|     5281 | 12240 | `		SyStringInitFromBuf(&sClassName,zDup,SyBlobLength(&sResolved));` |
|     5281 | 12241 | `		SyBlobRelease(&sResolved);` |
|     5281 | 12242 | `		if( zDup == 0 ){` |
|      ! 0 | 12243 | `			goto Mem;` |
|        - | 12244 | `		}` |
|     5281 | 12245 | `		rc = SySetPut(&sCatch.aClasses,(const void *)&sClassName);` |
|     5281 | 12246 | `		if( rc != SXRET_OK ){` |
|      ! 0 | 12247 | `			goto Mem;` |
|        - | 12248 | `		}` |
|        - | 12249 | `		/* Check for '\|' (multi-catch separator) */` |
|     5276 | 12250 | `		if( pGen->pIn < pGen->pEnd &&` |
|     5276 | 12251 | `			(pGen->pIn->nType & PH7_TK_OP) &&` |
...
|     5253 | 12257 | `		break;` |
|      ! 0 | 12258 | `	}` |
|     5248 | 12259 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 /*$*/ \|\|` |
|     5253 | 12260 | `		&pGen->pIn[1] >= pGen->pEnd \|\| (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|        - | 12273 | `	}` |
|     5253 | 12274 | `	pGen->pIn++; /* Jump the dollar sign */` |
|        - | 12275 | `	/* Duplicate instance name */` |
|     5253 | 12276 | `	pName = &pGen->pIn->sData;` |
|     5253 | 12277 | `	zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|     5253 | 12278 | `	if( zDup == 0 ){` |
|      ! 0 | 12279 | `		goto Mem;` |
|        - | 12280 | `	}` |
|     5253 | 12281 | `	SyStringInitFromBuf(&sCatch.sThis,zDup,pName->nByte);` |
|     5253 | 12282 | `	pGen->pIn++;` |
|     5253 | 12283 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_RPAREN) == 0 /*)*/ ){` |
...
|     5253 | 12298 | `	pGen->pIn++; /* Jump the right parenthesis */` |
|        - | 12299 | `	/* Create the catch block */` |
|     5253 | 12300 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_EXCEPTION,PH7_VmInstrLength(pGen->pVm),0,&pCatch);` |
|     5253 | 12301 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 12302 | `		return SXERR_ABORT;` |
|        - | 12303 | `	}` |
|        - | 12304 | `	/* Swap bytecode container */` |
|     5253 | 12305 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|     5253 | 12306 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&sCatch.sByteCode);` |
|        - | 12307 | `	/* Compile the block */` |
|     5253 | 12308 | `	PH7_CompileBlock(&(*pGen),0);` |
|        - | 12309 | `	/* Fix forward jumps now the destination is resolved  */` |
|     5253 | 12310 | `	GenStateFixJumps(pCatch,-1,PH7_VmInstrLength(pGen->pVm));` |
|        - | 12311 | `	/* Emit the DONE instruction */` |
|     5253 | 12312 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|        - | 12313 | `	/* Leave the block */` |
|     5253 | 12314 | `	GenStateLeaveBlock(&(*pGen),0);` |
|        - | 12315 | `	/* Restore the default container */` |
|     5253 | 12316 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|        - | 12317 | `	/* Install the catch block */` |
|     5253 | 12318 | `	rc = SySetPut(&pException->sEntry,(const void *)&sCatch);` |
|     5253 | 12319 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 12320 | `		goto Mem;` |
|        - | 12321 | `	}` |
|     5253 | 12322 | `	return SXRET_OK;` |
|      ! 0 | 12323 | `Mem:` |
...
|        - | 12332 | ` * is "thrown".` |
|        - | 12333 | ` */` |
|     5408 | 12334 | `static sxi32 PH7_CompileTry(ph7_gen_state *pGen)` |
|        5 | 12335 | `{` |
|        - | 12336 | `	ph7_exception *pException;` |
|     5413 | 12337 | `	sxu32 nLine = pGen->pIn->nLine;` |
|        - | 12338 | `	GenBlock *pTry;` |
|        - | 12339 | `	sxu32 nJmpIdx;` |
|        - | 12340 | `	sxi32 rc;` |
|        - | 12341 | `	/* Create the exception container */` |
|     5413 | 12342 | `	pException = (ph7_exception *)SyMemBackendAlloc(&pGen->pVm->sAllocator,sizeof(ph7_exception));` |
|     5413 | 12343 | `	if( pException == 0 ){` |
...
|     5413 | 12349 | `	SyZero(pException,sizeof(ph7_exception));` |
|        - | 12350 | `	/* Initialize fields */` |
|     5413 | 12351 | `	SySetInit(&pException->sEntry,&pGen->pVm->sAllocator,sizeof(ph7_exception_block));` |
|     5413 | 12352 | `	SySetInit(&pException->sFinally,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|     5413 | 12353 | `	pException->iHasFinally = 0;` |
|     5413 | 12354 | `	pException->iFinallyDone = 0;` |
|     5413 | 12355 | `	pException->pVm = pGen->pVm;` |
...
|     5413 | 12362 | `	if( pGen->bInGenerator && pGen->pVm->bInlineTryCatch ){` |
|      103 | 12363 | `		return PH7_CompileTryInline(&(*pGen),pException);` |
|        - | 12364 | `	}` |
|        - | 12365 | `	/* Create the try block */` |
|     5315 | 12366 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_EXCEPTION,PH7_VmInstrLength(pGen->pVm),0,&pTry);` |
|     5315 | 12367 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 12368 | `		return SXERR_ABORT;` |
|        - | 12369 | `	}` |
|        - | 12370 | `	/* Store exception pointer so break/continue can emit POP_EXCEPTION */` |
|     5315 | 12371 | `	pTry->pUserData = pException;` |
|        - | 12372 | `	/* Emit the 'LOAD_EXCEPTION' instruction */` |
|     5315 | 12373 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_EXCEPTION,0,0,pException,&nJmpIdx);` |
|        - | 12374 | `	/* Fix the jump later when the destination is resolved */` |
|     5315 | 12375 | `	GenStateNewJumpFixup(pTry,PH7_OP_LOAD_EXCEPTION,nJmpIdx);` |
|     5315 | 12376 | `	pGen->pIn++; /* Jump the 'try' keyword */` |
|        - | 12377 | `	/* Compile the block */` |
|     5315 | 12378 | `	rc = PH7_CompileBlock(&(*pGen),0);` |
|     5315 | 12379 | `	if( rc == SXERR_ABORT ){` |
|      ! 0 | 12380 | `		return SXERR_ABORT;` |
|        - | 12381 | `	}` |
|        - | 12382 | `	/* Fix forward jumps now the destination is resolved */` |
|     5315 | 12383 | `	GenStateFixJumps(pTry,-1,PH7_VmInstrLength(pGen->pVm));` |
|        - | 12384 | `	/* Emit the 'POP_EXCEPTION' instruction */` |
|     5315 | 12385 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP_EXCEPTION,0,0,pException,0);` |
|        - | 12386 | `	/* Leave the block */` |
|     5315 | 12387 | `	GenStateLeaveBlock(&(*pGen),0);` |
|        - | 12388 | `	/* Compile catch block(s) — at least one catch or finally is required */` |
|     5315 | 12389 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|     5308 | 12390 | `		SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_CATCH ){` |
|        - | 12391 | `		/* Compile one or more catch blocks */` |
|     5248 | 12392 | `		for(;;){` |
|    10496 | 12393 | `			if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0` |
|     7926 | 12394 | `				\|\| SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_CATCH ){` |
|     2627 | 12395 | `					break;` |
|        - | 12396 | `			}` |
|     5257 | 12397 | `			rc = PH7_CompileCatch(&(*pGen),pException);` |
|     5257 | 12398 | `			if( rc == SXERR_ABORT ){` |
|      ! 0 | 12399 | `				return SXERR_ABORT;` |
|        - | 12400 | `			}` |
|        5 | 12401 | `		}` |
|     2622 | 12402 | `	}` |
|        - | 12403 | `	/* Compile optional finally block */` |
|     5315 | 12404 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|      688 | 12405 | `		SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_FINALLY ){` |
...
|     5315 | 12434 | `	if( SySetUsed(&pException->sEntry) == 0 && !pException->iHasFinally ){` |
...
|        - | 12797 | ` */` |
| 23302580 | 12798 | `static void GenStatePatchNullsafeJumps(ph7_gen_state *pGen, sxu32 nBaseline)` |
|        5 | 12799 | `{` |
| 23302585 | 12800 | `	sxu32 nCur = SySetUsed(&pGen->aNullsafeJmp);` |
|        - | 12801 | `	sxu32 nTarget;` |
|        - | 12802 | `	sxu32 *aIdx;` |
|        - | 12803 | `	sxu32 i;` |
| 23302585 | 12804 | `	if( nCur <= nBaseline ){` |
| 23302489 | 12805 | `		return;` |
|        - | 12806 | `	}` |
...
|        - | 12834 | ` */` |
|  3272010 | 12835 | `static sxu32 GenStateByRefBuiltinMask(SyString *pName)` |
|        5 | 12836 | `{` |
...
|        - | 12847 | `	};` |
|        - | 12848 | `	sxu32 i;` |
|  3272015 | 12849 | `	if( pName == 0 \|\| pName->zString == 0 \|\| pName->nByte == 0 ){` |
|   863533 | 12850 | `		return 0;` |
|        - | 12851 | `	}` |
| 14450503 | 12852 | `	for( i = 0 ; i < SX_ARRAYSIZE(aByRef) ; ++i ){` |
| 12042138 | 12853 | `		if( pName->nByte == aByRef[i].nByte` |
|  6166053 | 12854 | `		 && SyStrnicmp(pName->zString, aByRef[i].zName, pName->nByte) == 0 ){` |
|      127 | 12855 | `			return aByRef[i].mask;` |
|        - | 12856 | `		}` |
|  6021013 | 12857 | `	}` |
|  2408365 | 12858 | `	return 0;` |
|  1636010 | 12859 | `}` |
|        - | 12860 | `/*` |
...
|        - | 12869 | ` */` |
|  3272010 | 12870 | `static void GenStateCallBuiltinName(ph7_expr_node *pLeft, SyString *pOut)` |
|        5 | 12871 | `{` |
|        - | 12872 | `	SyToken *p, *pEnd;` |
|  3272015 | 12873 | `	pOut->zString = 0;` |
|  3272015 | 12874 | `	pOut->nByte = 0;` |
|  3272015 | 12875 | `	if( pLeft == 0 \|\| pLeft->pStart == 0 \|\| pLeft->pEnd == 0 ){` |
|      ! 0 | 12876 | `		return;` |
|        - | 12877 | `	}` |
|  3272015 | 12878 | `	p = pLeft->pStart;` |
|  3272015 | 12879 | `	pEnd = pLeft->pEnd;` |
|        - | 12880 | `	/* Optional single leading namespace separator (absolute path). */` |
|  3272015 | 12881 | `	if( p < pEnd && (p->nType & PH7_TK_NSSEP) ){` |
|     3905 | 12882 | `		p++;` |
|     1950 | 12883 | `	}` |
|  3272015 | 12884 | `	if( p >= pEnd \|\| (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|   863497 | 12885 | `		return;` |
|        - | 12886 | `	}` |
|        - | 12887 | `	/* Must be a single component: nothing follows the name token. */` |
|  2408523 | 12888 | `	if( p + 1 != pEnd ){` |
|       40 | 12889 | `		return;` |
|        - | 12890 | `	}` |
|  2408487 | 12891 | `	*pOut = p->sData;` |
|  1636010 | 12892 | `}` |
|        - | 12893 | `/*` |
...
|        - | 12898 | ` * error message.` |
|        - | 12899 | ` */` |
| 32355504 | 12900 | `static sxi32 GenStateEmitExprCode(` |
...
|        - | 12907 | `	sxu32 nJmpIdx;` |
| 32355509 | 12908 | `	sxi32 iP1 = 0;` |
| 32355509 | 12909 | `	sxu32 iP2 = 0;` |
| 32355509 | 12910 | `	void *p3  = 0;` |
|        - | 12911 | `	sxi32 iVmOp;` |
|        - | 12912 | `	sxi32 rc;` |
| 32355509 | 12913 | `	int bIsChainOp = 0; /* Set below once we know pNode->pOp */` |
| 32355509 | 12914 | ``	int bFcc = 0;       /* First-class callable `f(...)`: emit OP_LOAD_FCC, not OP_CALL */`` |
| 32355509 | 12915 | `	sxu32 nRhsNsBase = 0;` |
| 32355509 | 12916 | `	if( pNode->xCode ){` |
|        - | 12917 | `		SyToken *pTmpIn,*pTmpEnd;` |
|        - | 12918 | `		/* Compile node */` |
| 19407447 | 12919 | `		SWAP_DELIMITER(pGen,pNode->pStart,pNode->pEnd);` |
| 19407447 | 12920 | `		rc = pNode->xCode(&(*pGen),iFlags);` |
| 19407447 | 12921 | `		RE_SWAP_DELIMITER(pGen);` |
| 19407447 | 12922 | `		return rc;` |
|        - | 12923 | `	}` |
| 12948067 | 12924 | `	if( pNode->pOp == 0 ){` |
...
|        - | 12928 | `	}` |
| 12948067 | 12929 | `	iVmOp = pNode->pOp->iVmOp;` |
| 12948067 | 12930 | `	if( iVmOp == PH7_OP_CVT_NULL ){` |
...
|        - | 12938 | `		}` |
|        1 | 12939 | `	}` |
| 12948067 | 12940 | `	if( pNode->pOp->iOp == EXPR_OP_NULLC_ASSIGN ){` |
...
|        - | 12989 | `	}` |
| 12947979 | 12990 | `	if( pNode->pOp->iOp == EXPR_OP_QUESTY ){` |
...
|   227781 | 12995 | `		nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|   227781 | 12996 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pCond,iFlags);` |
|   227781 | 12997 | `		if( rc != SXRET_OK ){` |
|      ! 0 | 12998 | `			return rc;` |
|        - | 12999 | `		}` |
...
|   227781 | 13003 | `		GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|   227781 | 13004 | `		nJz = nJmp = 0; /* cc -O6 warning */` |
|   227781 | 13005 | `		if( pNode->pLeft ){` |
|        - | 13006 | `			/* Standard ternary: (expr) ? (then) : (else) */` |
|        - | 13007 | `			/* Phase#2: Emit the false jump (pops condition) */` |
|   227713 | 13008 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nJz);` |
|        - | 13009 | `			/* Phase#3: Compile the 'then' expression  */` |
|   227713 | 13010 | `			nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|   227713 | 13011 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pLeft,iFlags);` |
|   227713 | 13012 | `			if( rc != SXRET_OK ){` |
|      ! 0 | 13013 | `				return rc;` |
|        - | 13014 | `			}` |
|   227713 | 13015 | `			GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|   113859 | 13016 | `		}else{` |
...
|   227781 | 13024 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,0,0,&nJmp);` |
|        - | 13025 | `		/* Phase#5: Fix the false jump now the jump destination is resolved. */` |
|   227781 | 13026 | `		pInstr = PH7_VmGetInstr(pGen->pVm,nJz);` |
|   227781 | 13027 | `		if( pInstr ){` |
|   227781 | 13028 | `			pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|   113888 | 13029 | `		}` |
|   227781 | 13030 | `		if( !pNode->pLeft ){` |
...
|   227781 | 13035 | `		if( pNode->pRight ){` |
|   227781 | 13036 | `			nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|   227781 | 13037 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pRight,iFlags);` |
|   227781 | 13038 | `			if( rc != SXRET_OK ){` |
|      ! 0 | 13039 | `				return rc;` |
|        - | 13040 | `			}` |
|   227781 | 13041 | `			GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|   113888 | 13042 | `		}` |
|   227781 | 13043 | `		if( nJmp > 0 ){` |
|        - | 13044 | `			/* Phase#7: Fix the unconditional jump */` |
|   227781 | 13045 | `			pInstr = PH7_VmGetInstr(pGen->pVm,nJmp);` |
|   227781 | 13046 | `			if( pInstr ){` |
|   227781 | 13047 | `				pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|   113888 | 13048 | `			}` |
|   113888 | 13049 | `		}` |
|        - | 13050 | `		/* All done */` |
|   227781 | 13051 | `		return SXRET_OK;` |
|        - | 13052 | `	}` |
| 12720203 | 13053 | `	if( pNode->pOp->iOp == EXPR_OP_PIPE ){` |
...
|        - | 13085 | `	}` |
| 12720177 | 13086 | `	bIsChainOp = GEN_IS_CHAIN_OP(pNode->pOp->iOp);` |
|        - | 13087 | `	/* Generate code for the left tree */` |
| 12720177 | 13088 | `	if( pNode->pLeft ){` |
| 12708559 | 13089 | `		sxu32 nLhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
| 12708559 | 13090 | `		if( iVmOp == PH7_OP_CALL ){` |
|        - | 13091 | `			ph7_expr_node **apNode;` |
|  3276203 | 13092 | `			int hasSpread = 0;` |
|  3276203 | 13093 | `			int hasNamed = 0;` |
|  3276203 | 13094 | `			int bAnySpread = 0;` |
|  3276203 | 13095 | `			sxu32 byRefMask = 0;` |
|        - | 13096 | `			sxi32 nArgs;` |
|        - | 13097 | `			sxi32 n;` |
|        - | 13098 | `			/* Recurse and generate bytecodes for function arguments */` |
|  3276203 | 13099 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  3276203 | 13100 | `			nArgs = (sxi32)SySetUsed(&pNode->aNodeArgs);` |
...
|  3276203 | 13104 | `			if( nArgs == 1 && apNode[0] && (apNode[0]->iFlags & EXPR_NODE_FCC) ){` |
|       81 | 13105 | `				bFcc = 1;` |
|       81 | 13106 | `				nArgs = 0;` |
|       40 | 13107 | `			}` |
...
|        - | 13110 | `			{` |
|  3276203 | 13111 | `				int seenNamed = 0;` |
|  3276203 | 13112 | `				int seenSpread = 0;` |
|  6507895 | 13113 | `				for( n = 0; n < nArgs; ++n ){` |
|  3231699 | 13114 | `					if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
...
|        5 | 13121 | `						}` |
|  3229671 | 13122 | `					}else if( apNode[n]->iFlags & EXPR_NODE_NAMED_ARG ){` |
|      289 | 13123 | `						seenNamed = 1;` |
|      289 | 13124 | `						hasNamed = 1;` |
|  3227501 | 13125 | `					}else if( seenNamed ){` |
...
|  3227357 | 13129 | `					}else if( seenSpread ){` |
...
|  3276201 | 13137 | `			iFlags \|= EXPR_FLAG_RDONLY_LOAD;` |
...
|  3276201 | 13142 | `			if( pNode->pLeft && pNode->pLeft->pStart ){` |
|  3276201 | 13143 | `				SyString *pCallName = &pNode->pLeft->pStart->sData;` |
|  3276196 | 13144 | `				if( pCallName->nByte == 5` |
|  1815534 | 13145 | `				 && SyStrnicmp(pCallName->zString,"isset",5) == 0 ){` |
|   193961 | 13146 | `					iFlags \|= EXPR_FLAG_LOAD_IDX_ISSET;` |
|  3179223 | 13147 | `				}else if( pCallName->nByte == 5` |
|  1621578 | 13148 | `				 && SyStrnicmp(pCallName->zString,"empty",5) == 0 ){` |
...
|  3276201 | 13157 | `				if( !bAnySpread && !hasNamed ){` |
|        - | 13158 | `					SyString sBuiltin;` |
|  3272015 | 13159 | `					GenStateCallBuiltinName(pNode->pLeft, &sBuiltin);` |
|  3272015 | 13160 | `					byRefMask = GenStateByRefBuiltinMask(&sBuiltin);` |
|  1636005 | 13161 | `				}` |
|  1638098 | 13162 | `			}` |
|  6507891 | 13163 | `			for( n = 0 ; n < nArgs ; ++n ){` |
|  3231695 | 13164 | `				sxu32 nArgNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  3231695 | 13165 | `				sxi32 iArgFlags = iFlags & ~(EXPR_FLAG_LOAD_IDX_STORE\|EXPR_FLAG_MEMBER_WRITE);` |
...
|  3231695 | 13172 | `				if( n < 31 && (byRefMask & (1u<<n)) ){` |
|       61 | 13173 | `					iArgFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|       61 | 13174 | `					iArgFlags \|= EXPR_FLAG_LOAD_IDX_STORE;` |
|       28 | 13175 | `				}` |
|  3231695 | 13176 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iArgFlags);` |
|  3231695 | 13177 | `				if( rc != SXRET_OK ){` |
|      ! 0 | 13178 | `					return rc;` |
|        - | 13179 | `				}` |
|        - | 13180 | `				/* Each argument is an independent nullsafe scope. */` |
|  3231695 | 13181 | `				GenStatePatchNullsafeJumps(pGen, nArgNsBase);` |
|  3231695 | 13182 | `				if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
...
|  3276201 | 13225 | `			iFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|  1638098 | 13226 | `		}` |
|        - | 13227 | `		{` |
...
| 12708557 | 13236 | `			sxi32 iLeftFlags = iFlags;` |
| 12708552 | 13237 | `			if( pNode->pLeft && pNode->pLeft->pOp` |
| 10587934 | 13238 | `				&& (pNode->pLeft->pOp->iOp == EXPR_OP_ARROW` |
|  4233684 | 13239 | `					\|\| pNode->pLeft->pOp->iOp == EXPR_OP_NULLSAFE_ARROW` |
|  3757561 | 13240 | `					\|\| pNode->pLeft->pOp->iOp == EXPR_OP_DC) ){` |
|   968137 | 13241 | `				iLeftFlags &= ~EXPR_FLAG_LOAD_IDX_UNSET;` |
|   484066 | 13242 | `			}` |
...
| 12708552 | 13250 | `			if( pNode->pOp` |
| 18057262 | 13251 | `				&& (pNode->pOp->iOp == EXPR_OP_ARROW` |
| 11703033 | 13252 | `					\|\| pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW` |
| 10697462 | 13253 | `					\|\| pNode->pOp->iOp == EXPR_OP_DC) ){` |
|  2042823 | 13254 | `				iLeftFlags &= ~EXPR_FLAG_MEMBER_WRITE;` |
|  1021409 | 13255 | `			}` |
...
| 12708552 | 13262 | `			if( pNode->pOp` |
| 12708557 | 13263 | `				&& (pNode->pOp->iVmOp == PH7_OP_INCR \|\| pNode->pOp->iVmOp == PH7_OP_DECR) ){` |
|    70183 | 13264 | `				iLeftFlags \|= EXPR_FLAG_LOAD_IDX_STORE \| EXPR_FLAG_MEMBER_WRITE;` |
|    35089 | 13265 | `			}` |
| 12708557 | 13266 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pLeft,iLeftFlags);` |
|        - | 13267 | `		}` |
| 12708557 | 13268 | `		if( rc != SXRET_OK ){` |
|       34 | 13269 | `			return rc;` |
|        - | 13270 | `		}` |
| 12708527 | 13271 | `		if( !bIsChainOp ){` |
...
|  5710011 | 13274 | `			GenStatePatchNullsafeJumps(pGen, nLhsNsBase);` |
|  2855003 | 13275 | `		}` |
| 12708527 | 13276 | `		if( iVmOp == PH7_OP_CALL ){` |
|  3276201 | 13277 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|  3276201 | 13278 | `			if( pInstr ){` |
|  3276201 | 13279 | `				if ( pInstr->iOp == PH7_OP_LOADC ){` |
|  2408763 | 13280 | `					sxu32 nOrig = (sxu32)pInstr->iP2;` |
|        - | 13281 | `					sxu32 nQual;` |
|  2408763 | 13282 | `					int bAbsolute = (pInstr->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|        - | 13283 | `					/* Prevent constant expansion but preserve the absolute flag` |
|        - | 13284 | `					 * so the later NEW handler (if any) can see it. */` |
|  2408763 | 13285 | `					pInstr->iP1 &= ~PH7_LOADC_EXPAND;` |
...
|  2408763 | 13293 | `					if( bAbsolute ){` |
|     3905 | 13294 | `						pInstr->iP2 = (sxi32)nOrig;` |
|     1955 | 13295 | `					}else{` |
|  2404863 | 13296 | `						int fromImport = 0;` |
|  2404863 | 13297 | `						nQual = GenStateNsQualifyName(pGen,nOrig,&pGen->hUseFuncImports,&fromImport);` |
|  2404863 | 13298 | `						pInstr->iP2 = (sxi32)nQual;` |
|  2404863 | 13299 | `						if( nQual != nOrig ){` |
...
|       36 | 13320 | `						}` |
|        5 | 13321 | `					}` |
|  2071822 | 13322 | `				}else if( pInstr->iOp == PH7_OP_MEMBER /* $a->b(1,2,3) */ \|\| pInstr->iOp == PH7_OP_NEW ){` |
|        - | 13323 | `					/* Method call,flag that */` |
|   862959 | 13324 | `					pInstr->iP2 = 1;` |
|   431477 | 13325 | `				}` |
|  1638103 | 13326 | `			}` |
| 11070429 | 13327 | `		}else if( iVmOp == PH7_OP_LOAD_IDX ){` |
|        - | 13328 | `			ph7_expr_node **apNode;` |
|        - | 13329 | `			sxi32 n;` |
|  1679507 | 13330 | `			sxi32 iChildMask = ~(EXPR_FLAG_LOAD_IDX_STORE` |
...
|  1679507 | 13334 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  3231101 | 13335 | `			for( n = 0 ; n < (sxi32)SySetUsed(&pNode->aNodeArgs) ; ++n ){` |
|  1551599 | 13336 | `				sxu32 nIdxNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  1551599 | 13337 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iFlags&iChildMask);` |
|  1551599 | 13338 | `				if( rc != SXRET_OK ){` |
|      ! 0 | 13339 | `					return rc;` |
|        - | 13340 | `				}` |
|        - | 13341 | `				/* Each subscript index is an independent nullsafe scope. */` |
|  1551599 | 13342 | `				GenStatePatchNullsafeJumps(pGen, nIdxNsBase);` |
|   775802 | 13343 | `			}` |
|  1679507 | 13344 | `			if( SySetUsed(&pNode->aNodeArgs) > 0 ){` |
|  1551599 | 13345 | `				iP1 = 1; /* Node have an index associated with it */` |
|   775797 | 13346 | `			}` |
|  1679507 | 13347 | `			if( iFlags & EXPR_FLAG_LOAD_IDX_ISSET ){` |
|        - | 13348 | `				/* offsetExists for ArrayAccess; peek-only for arrays */` |
|   232571 | 13349 | `				iP2 = 4;` |
|  1563224 | 13350 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_UNSET ){` |
|        - | 13351 | `				/* offsetUnset for ArrayAccess; auto-vivify+load for arrays` |
|        - | 13352 | `				 * so the trailing unset() builtin can drop the slot. */` |
|       72 | 13353 | `				iP2 = 5;` |
|  1446907 | 13354 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_EMPTY ){` |
...
|       29 | 13358 | `				iP2 = 6;` |
|  1446861 | 13359 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_STORE ){` |
|        - | 13360 | `				/* Create an empty entry when the desired index is not found */` |
|   198083 | 13361 | `				iP2 = 1;` |
|    99044 | 13362 | `			}` |
|  8592580 | 13363 | `		}else if( pNode->pOp->iOp == EXPR_OP_COMMA ){` |
|        - | 13364 | `			/* POP the left node */` |
|       32 | 13365 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|       15 | 13366 | `		}` |
|  6354261 | 13367 | `	}` |
| 12720145 | 13368 | `	rc = SXRET_OK;` |
| 12720145 | 13369 | `	nJmpIdx = 0;` |
...
| 12720145 | 13373 | `	if( iVmOp == PH7_OP_MEMBER && pNode->pOp->iOp == EXPR_OP_DC ){` |
...
| 12708469 | 13403 | `	if( pNode->pRight ){` |
|  6907661 | 13404 | `		if( iVmOp == PH7_OP_LAND ){` |
...
|  6828023 | 13407 | `		}else if (iVmOp == PH7_OP_LOR ){` |
...
|  6699896 | 13410 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLC ){` |
...
|  6651387 | 13414 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW ){` |
...
|  6651211 | 13424 | `		}else if( pNode->pOp->iPrec == 18 /* Combined binary operators [i.e: =,'.=','+=',*=' ...] precedence */ ){` |
...
|  2353755 | 13428 | `			iFlags \|= EXPR_FLAG_LOAD_IDX_STORE \| EXPR_FLAG_MEMBER_WRITE;` |
|  1176875 | 13429 | `		}` |
|  6907661 | 13430 | `		nRhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  6907661 | 13431 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pRight,iFlags);` |
|  6907661 | 13432 | `		if( !bIsChainOp ){` |
|        - | 13433 | `			/* Non-chain parent: RHS nullsafe chain ends here, before the` |
|        - | 13434 | `			 * operator instruction is emitted. */` |
|  4864901 | 13435 | `			GenStatePatchNullsafeJumps(pGen, nRhsNsBase);` |
|  2432448 | 13436 | `		}` |
|  6907661 | 13437 | `		if( iVmOp == PH7_OP_STORE ){` |
|  2066907 | 13438 | `			if( pNode->pRight && (pNode->pRight->xCode == PH7_CompileList \|\|` |
|  2066872 | 13439 | `				pNode->pRight->xCode == PH7_CompileShortList) ){` |
...
|        - | 13445 | `				 */` |
|       89 | 13446 | `				iVmOp = 0;` |
|  2066865 | 13447 | `			}else if( (pInstr = PH7_VmPeekInstr(pGen->pVm)) != 0 ){` |
|  2066823 | 13448 | `				if(pInstr->iOp == PH7_OP_MEMBER ){` |
|        - | 13449 | `					/* Perform a member store operation [i.e: $this->x = 50] */` |
|   248501 | 13450 | `					iP2 = 1;` |
|   124253 | 13451 | `				}else{` |
|  1818327 | 13452 | `					if( pInstr->iOp == PH7_OP_LOAD_IDX ){` |
...
|    98996 | 13456 | `					}else{` |
|  1620345 | 13457 | `						p3 = pInstr->p3;` |
|        - | 13458 | `					}` |
|        - | 13459 | `					/* POP the last dynamic load instruction */` |
|  1818327 | 13460 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|        - | 13461 | `				}` |
|  1033414 | 13462 | `			}` |
|  5874210 | 13463 | `		}else if( iVmOp == PH7_OP_STORE_REF ){` |
...
|       30 | 13478 | `		}` |
|  3453828 | 13479 | `	}` |
| 12708464 | 13480 | `	if( iVmOp == PH7_OP_NEW && pNode->pLeft && pNode->pLeft->pOp == 0` |
|   245317 | 13481 | `		&& pNode->pLeft->xCode == PH7_CompileAnnonClass ){` |
...
|       32 | 13484 | `		iVmOp = 0;` |
|       14 | 13485 | `	}` |
| 12708469 | 13486 | `	if( iVmOp > 0 ){` |
| 12708183 | 13487 | `		if( iVmOp == PH7_OP_INCR \|\| iVmOp == PH7_OP_DECR ){` |
|    70183 | 13488 | `			if( pNode->iFlags & EXPR_NODE_PRE_INCR ){` |
|        - | 13489 | `				/* Pre-increment/decrement operator [i.e: ++$i,--$j ] */` |
|    11651 | 13490 | `				iP1 = 1;` |
|     5828 | 13491 | `			}` |
| 12673094 | 13492 | `		}else if( iVmOp == PH7_OP_NEW ){` |
|        - | 13493 | `			/* Namespace-qualify the class name for NEW */ {` |
|   490325 | 13494 | `				VmInstr *pPeek = PH7_VmPeekInstr(pGen->pVm);` |
|   490325 | 13495 | `				VmInstr *pCallInstr = 0;` |
|   490325 | 13496 | `				if( pPeek && pPeek->iOp == PH7_OP_CALL ){` |
|   490077 | 13497 | `					pCallInstr = pPeek;` |
|   490077 | 13498 | `					pPeek = PH7_VmPeekNextInstr(pGen->pVm);` |
|   245036 | 13499 | `				}` |
|   490325 | 13500 | `				if( pPeek && pPeek->iOp == PH7_OP_LOADC ){` |
|   490321 | 13501 | `					int bAbsolute = (pPeek->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|        - | 13502 | `					sxu32 nLitForClass;` |
|   490321 | 13503 | `					VmCallArgMap *pCallNsMap = pCallInstr ? (VmCallArgMap *)pCallInstr->p3 : 0;` |
...
|   490321 | 13510 | `					if( pCallNsMap && pCallNsMap->nOrigNameLit > 0 ){` |
|       37 | 13511 | `						nLitForClass = pCallNsMap->nOrigNameLit - 1;` |
|       21 | 13512 | `					}else{` |
|   490289 | 13513 | `						nLitForClass = (sxu32)pPeek->iP2;` |
|        - | 13514 | `					}` |
|   490321 | 13515 | `					pPeek->iP1 = 0;` |
|   490321 | 13516 | `					if( !bAbsolute ){` |
|   486425 | 13517 | `						pPeek->iP2 = (sxi32)GenStateNsQualifyName(pGen,nLitForClass,&pGen->hUseImports,0);` |
|   243215 | 13518 | `					}else{` |
|     3901 | 13519 | `						pPeek->iP2 = (sxi32)nLitForClass;` |
|        - | 13520 | `					}` |
|   245158 | 13521 | `				}` |
|        - | 13522 | `			}` |
|   490325 | 13523 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|   490325 | 13524 | `			if( pInstr && pInstr->iOp == PH7_OP_CALL ){` |
|        - | 13525 | `				VmInstr *pPrev;` |
|   490077 | 13526 | `				pPrev = PH7_VmPeekNextInstr(pGen->pVm);` |
|   490077 | 13527 | `				if( pPrev == 0 \|\| pPrev->iOp != PH7_OP_MEMBER ){` |
...
|   490077 | 13531 | `					iP1 = pInstr->iP1;` |
|   490077 | 13532 | `					iP2 = pInstr->iP2;` |
|   490077 | 13533 | `					if( pInstr->p3 ){` |
|       47 | 13534 | `						p3 = pInstr->p3; /* Transfer VmCallArgMap to NEW */` |
|       21 | 13535 | `					}` |
|   490077 | 13536 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|   245036 | 13537 | `				}` |
|   245041 | 13538 | `			}` |
| 12392845 | 13539 | `		}else if( iVmOp == PH7_OP_IS_A ){` |
...
|    38949 | 13542 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|    38949 | 13543 | `			if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|    38949 | 13544 | `				ph7_value *pLitChk = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,(sxu32)pInstr->iP2);` |
|    38949 | 13545 | `				int bAbsolute = (pInstr->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|    38949 | 13546 | `				int isSpecialIs = 0;` |
|    38949 | 13547 | `				if( pLitChk && (pLitChk->iFlags & MEMOBJ_STRING) ){` |
|    38949 | 13548 | `					const char *z = (const char *)SyBlobData(&pLitChk->sBlob);` |
|    38949 | 13549 | `					sxu32 n = (sxu32)SyBlobLength(&pLitChk->sBlob);` |
|    38944 | 13550 | `					if( (n == 4 && SyMemcmp(z,"self",4) == 0) \|\|` |
|    38947 | 13551 | `						(n == 6 && SyMemcmp(z,"static",6) == 0) \|\|` |
|    19472 | 13552 | `						(n == 6 && SyMemcmp(z,"parent",6) == 0) ){` |
|       12 | 13553 | `						isSpecialIs = 1;` |
|        5 | 13554 | `					}` |
|    19472 | 13555 | `				}` |
|    38949 | 13556 | `				pInstr->iP1 = 0;` |
|    38949 | 13557 | `				if( !isSpecialIs && !bAbsolute ){` |
|    38929 | 13558 | `					pInstr->iP2 = (sxi32)GenStateNsQualifyName(pGen,(sxu32)pInstr->iP2,&pGen->hUseImports,0);` |
|    19462 | 13559 | `				}` |
|    19477 | 13560 | `			}` |
| 12128213 | 13561 | `		}else if( iVmOp == PH7_OP_MEMBER){` |
...
|  2042765 | 13565 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|  2042765 | 13566 | `			if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|  2042693 | 13567 | `				pInstr->iP1 = 0;` |
|  1021344 | 13568 | `			}` |
|  2042765 | 13569 | `			if( pNode->pOp->iOp == EXPR_OP_DC /* '::' */){` |
...
|  2042765 | 13582 | `			if( iP2 == PH7_MEMBER_READ ){` |
|  2042765 | 13583 | `				if( iFlags & EXPR_FLAG_LOAD_IDX_UNSET ){` |
|       40 | 13584 | `					iP2 = PH7_MEMBER_UNSET;` |
|  2042746 | 13585 | `				}else if( iFlags & EXPR_FLAG_LOAD_IDX_ISSET ){` |
|       99 | 13586 | `					iP2 = PH7_MEMBER_ISSET;` |
|  2042680 | 13587 | `				}else if( iFlags & EXPR_FLAG_LOAD_IDX_EMPTY ){` |
|       17 | 13588 | `					iP2 = PH7_MEMBER_EMPTY;` |
|  2042625 | 13589 | `				}else if( iFlags & EXPR_FLAG_MEMBER_WRITE ){` |
|        - | 13590 | `					/* Write-lvalue base ($o->arr[$k]=v, $o->p ??= v): auto-create a missing prop. */` |
|   248679 | 13591 | `					iP2 = PH7_MEMBER_WRITE;` |
|   124337 | 13592 | `				}` |
|  1021380 | 13593 | `			}` |
|  1021380 | 13594 | `		}` |
...
| 12708183 | 13622 | `		if( iVmOp == PH7_OP_CALL \|\| iVmOp == PH7_OP_NEW ){` |
|  3766441 | 13623 | `			p3 = GenStateAttachStrictFlag(pGen,p3);` |
|  1883218 | 13624 | `		}` |
|        - | 13625 | `		/* Finally,emit the VM instruction associated with this operator */` |
| 12708183 | 13626 | `		PH7_VmEmitInstr(pGen->pVm,iVmOp,iP1,iP2,p3,0);` |
|  6354089 | 13627 | `	}` |
| 12708469 | 13628 | `	if( nJmpIdx > 0 ){` |
...
|        - | 13646 | ` * message.` |
|        - | 13647 | ` */` |
|  7261098 | 13648 | `static sxi32 PH7_CompileExpr(` |
...
|  7261103 | 13662 | `	nExpr = 0;` |
|  7261103 | 13663 | `	pRoot = 0;` |
...
|  7261103 | 13666 | `	nNullsafeBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  7261103 | 13667 | `	SySetInit(&sExprNode,&pGen->pVm->sAllocator,sizeof(ph7_expr_node *));` |
|  7261103 | 13668 | `	SySetAlloc(&sExprNode,0x10);` |
|  7261103 | 13669 | `	rc = SXRET_OK;` |
|        - | 13670 | `	/* Delimit the expression */` |
|  7261103 | 13671 | `	pEnd = pGen->pIn;` |
|  7261103 | 13672 | `	iNest = 0;` |
| 57041443 | 13673 | `	while( pEnd < pGen->pEnd ){` |
| 54384745 | 13674 | `		if( pEnd->nType & PH7_TK_OCB /* '{' */ ){` |
|        - | 13675 | `			/* Ticket 1433-30: Annonymous/Closure functions body */` |
|      719 | 13676 | `			iNest++;` |
| 54384388 | 13677 | `		}else if(pEnd->nType & PH7_TK_CCB /* '}' */ ){` |
|      727 | 13678 | `			iNest--;` |
| 54383670 | 13679 | `		}else if( pEnd->nType & PH7_TK_SEMI /* ';' */ ){` |
|  4605019 | 13680 | `			if( iNest <= 0 ){` |
|  4604405 | 13681 | `				break;` |
|        - | 13682 | `			}` |
|      307 | 13683 | `		}` |
| 49780345 | 13684 | `		pEnd++;` |
|        5 | 13685 | `	}` |
|  7261103 | 13686 | `	if( iFlags & EXPR_FLAG_COMMA_STATEMENT ){` |
|   244937 | 13687 | `		SyToken *pEnd2 = pGen->pIn;` |
|   244937 | 13688 | `		iNest = 0;` |
|        - | 13689 | `		/* Stop at the first comma */` |
|   568035 | 13690 | `		while( pEnd2 < pEnd ){` |
|   323105 | 13691 | `			if( pEnd2->nType & (PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*'['*/\|PH7_TK_LPAREN/*'('*/) ){` |
|     7851 | 13692 | `				iNest++;` |
|   319182 | 13693 | `			}else if(pEnd2->nType & (PH7_TK_CCB/*'}'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_RPAREN/*')'*/)){` |
|     7851 | 13694 | `				iNest--;` |
|   311336 | 13695 | `			}else if( pEnd2->nType & PH7_TK_COMMA /*','*/ ){` |
|       63 | 13696 | `				if( iNest <= 0 ){` |
|        3 | 13697 | `					break;` |
|        - | 13698 | `				}` |
|       28 | 13699 | `			}` |
|   323103 | 13700 | `			pEnd2++;` |
|        5 | 13701 | `		}` |
|   244937 | 13702 | `		if( pEnd2 <pEnd ){` |
|        3 | 13703 | `			pEnd = pEnd2;` |
|        1 | 13704 | `		}` |
|   122466 | 13705 | `	}` |
|  7261103 | 13706 | `	if( pEnd > pGen->pIn ){` |
|  7261093 | 13707 | `		SyToken *pTmp = pGen->pEnd;` |
|        - | 13708 | `		/* Swap delimiter */` |
|  7261093 | 13709 | `		pGen->pEnd = pEnd;` |
|        - | 13710 | `		/* Try to get an expression tree */` |
|  7261093 | 13711 | `		rc = PH7_ExprMakeTree(&(*pGen),&sExprNode,&pRoot);` |
|  7261093 | 13712 | `		if( rc == SXRET_OK && pRoot ){` |
|  7260911 | 13713 | `			rc = SXRET_OK;` |
|  7260911 | 13714 | `			if( xTreeValidator ){` |
|        - | 13715 | `				/* Call the upper layer validator callback */` |
|   562041 | 13716 | `				rc = xTreeValidator(&(*pGen),pRoot);` |
|   281018 | 13717 | `			}` |
|  7260911 | 13718 | `			if( rc != SXERR_ABORT ){` |
|        - | 13719 | `				/* Generate code for the given tree */` |
|  7260911 | 13720 | `				rc = GenStateEmitExprCode(&(*pGen),pRoot,iFlags);` |
|        - | 13721 | `				/* Patch any unresolved nullsafe jumps emitted by this` |
|        - | 13722 | `				 * expression so they short-circuit to its end. */` |
|  7260911 | 13723 | `				GenStatePatchNullsafeJumps(pGen, nNullsafeBase);` |
|  3630453 | 13724 | `			}` |
|  7260911 | 13725 | `			nExpr = 1;` |
|  3630453 | 13726 | `		}` |
|        - | 13727 | `		/* Release the whole tree */` |
|  7261093 | 13728 | `		PH7_ExprFreeTree(&(*pGen),&sExprNode);` |
|        - | 13729 | `		/* Synchronize token stream */` |
|  7261093 | 13730 | `		pGen->pEnd = pTmp;` |
|  7261093 | 13731 | `		pGen->pIn  = pEnd;` |
|  7261093 | 13732 | `		if( rc == SXERR_ABORT ){` |
|       13 | 13733 | `			SySetRelease(&sExprNode);` |
|       13 | 13734 | `			return SXERR_ABORT;` |
|        - | 13735 | `		}` |
|  3630539 | 13736 | `	}` |
|  7261093 | 13737 | `	SySetRelease(&sExprNode);` |
|  7261093 | 13738 | `	return nExpr > 0 ? SXRET_OK : SXERR_EMPTY;` |
|  3630554 | 13739 | `}` |
|        - | 13740 | `/*` |
|        - | 13741 | ` * Return a pointer to the node construct handler associated` |
|        - | 13742 | ` * with a given node type [i.e: string,integer,float,...].` |
|        - | 13743 | ` */` |
|  4421362 | 13744 | `PH7_PRIVATE ProcNodeConstruct PH7_GetNodeHandler(sxu32 nNodeType)` |
|        5 | 13745 | `{` |
|  4421367 | 13746 | `	if( nNodeType & PH7_TK_NUM ){` |
|        - | 13747 | `		/* Numeric literal: Either real or integer */` |
|  1293173 | 13748 | `		return PH7_CompileNumLiteral;` |
|  3128199 | 13749 | `	}else if( nNodeType & PH7_TK_DSTR ){` |
|        - | 13750 | `		/* Double quoted string */` |
|    37415 | 13751 | `		return PH7_CompileString;` |
|  3090789 | 13752 | `	}else if( nNodeType & PH7_TK_SSTR ){` |
|        - | 13753 | `		/* Single quoted string */` |
|  3090669 | 13754 | `		return PH7_CompileSimpleString;` |
...
|        - | 13771 | ` */` |
|     6858 | 13772 | `static sxi32 GenStateUnsetValidator(ph7_gen_state *pGen, ph7_expr_node *pNode)` |
|        5 | 13773 | `{` |
|        - | 13774 | `	sxi32 rc;` |
|     6863 | 13775 | `	if( !PH7_ExprContainsNullsafe(pNode) ){` |
|     6861 | 13776 | `		return SXRET_OK;` |
|        - | 13777 | `	}` |
...
|        - | 13789 | ` */` |
|     2930 | 13790 | `static sxi32 PH7_CompileUnset(ph7_gen_state *pGen)` |
|        5 | 13791 | `{` |
|     2935 | 13792 | `	SyToken *pTmp,*pEnd,*pNext = 0;` |
|     2935 | 13793 | `	sxu32 nIdx = 0;` |
|        - | 13794 | `	SyString sName;` |
|        - | 13795 | `	sxi32 rc;` |
|        - | 13796 | `	/* Jump the 'unset' keyword */` |
|     2935 | 13797 | `	pGen->pIn++;` |
|        - | 13798 | `	/* Save delimiter */` |
|     2935 | 13799 | `	pTmp = pGen->pEnd;` |
|        - | 13800 | `	/* Skip optional opening parenthesis and find the matching close */` |
|     2935 | 13801 | `	pEnd = pTmp; /* Default: scan to statement end */` |
|     2935 | 13802 | `	if( pGen->pIn < pTmp && (pGen->pIn->nType & PH7_TK_LPAREN) ){` |
|        - | 13803 | `		/* Find matching ')' — start scanning AFTER the '(' */` |
|        - | 13804 | `		SyToken *pClose;` |
|     2935 | 13805 | `		pGen->pIn++;   /* Skip '(' */` |
|     2935 | 13806 | `		PH7_DelimitNestedTokens(pGen->pIn,pTmp,PH7_TK_LPAREN,PH7_TK_RPAREN,&pClose);` |
|     2935 | 13807 | `		pEnd = pClose; /* Stop at ')' */` |
|     1465 | 13808 | `	}` |
|     2935 | 13809 | `	SyStringInitFromBuf(&sName,"unset",sizeof("unset")-1);` |
|        - | 13810 | `	/* Resolve the 'unset' builtin name once */` |
|     2935 | 13811 | `	if( SXRET_OK != GenStateFindLiteral(&(*pGen),&sName,&nIdx) ){` |
...
|     9795 | 13820 | `	while( SXRET_OK == PH7_GetNextExpr(pGen->pIn,pEnd,&pNext) ){` |
|     6865 | 13821 | `		if( pGen->pIn < pNext ){` |
|     6865 | 13822 | `			pGen->pEnd = pNext;` |
|     6865 | 13823 | `			rc = PH7_CompileExpr(&(*pGen),` |
|        - | 13824 | `				EXPR_FLAG_RDONLY_LOAD\|EXPR_FLAG_LOAD_IDX_UNSET,` |
|        - | 13825 | `				GenStateUnsetValidator);` |
|     6865 | 13826 | `			if( rc == SXERR_ABORT ){` |
|      ! 0 | 13827 | `				return SXERR_ABORT;` |
|        - | 13828 | `			}` |
|     6865 | 13829 | `			if( rc != SXERR_EMPTY ){` |
|        - | 13830 | `				/* Emit call for this single argument */` |
|     6863 | 13831 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|     6863 | 13832 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_CALL,1,0,GenStateAttachStrictFlag(pGen,0),0);` |
|     6863 | 13833 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|     3429 | 13834 | `			}` |
|     3430 | 13835 | `		}` |
|        - | 13836 | `		/* Jump trailing commas */` |
|    10797 | 13837 | `		while( pNext < pEnd && (pNext->nType & PH7_TK_COMMA) ){` |
|     3937 | 13838 | `			pNext++;` |
|        5 | 13839 | `		}` |
|     6865 | 13840 | `		pGen->pIn = pNext;` |
|        5 | 13841 | `	}` |
|        - | 13842 | `	/* Skip past the closing ')' if present */` |
|     2935 | 13843 | `	if( pGen->pIn < pTmp && (pGen->pIn->nType & PH7_TK_RPAREN) ){` |
|     2935 | 13844 | `		pGen->pIn++;` |
|     1465 | 13845 | `	}` |
|        - | 13846 | `	/* Restore token stream */` |
|     2935 | 13847 | `	pGen->pEnd = pTmp;` |
|     2935 | 13848 | `	return SXRET_OK;` |
|     1470 | 13849 | `}` |
|        - | 13850 | `/*` |
...
|        - | 13882 | ` */` |
|  3830676 | 13883 | `static ProcLangConstruct GenStateGetStatementHandler(` |
|        - | 13884 | `	sxu32 nKeywordID,   /* Keyword  ID*/` |
|        - | 13885 | `	SyToken *pLookahed  /* Look-ahead token */` |
|        - | 13886 | `	)` |
|        5 | 13887 | `{` |
|  3830681 | 13888 | `	sxu32 n = 0;` |
| 15553788 | 13889 | `	for(;;){` |
| 31107581 | 13890 | `		if( n >= SX_ARRAYSIZE(aLangConstruct) ){` |
|   246217 | 13891 | `			break;` |
|        - | 13892 | `		}` |
| 30861369 | 13893 | `		if( aLangConstruct[n].nID == nKeywordID ){` |
|  3584469 | 13894 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed && (pLookahed->nType & PH7_TK_OP)){` |
...
|        - | 13899 | `				}` |
|      ! 0 | 13900 | `			}` |
|  3584464 | 13901 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed` |
...
|        - | 13908 | `			*/` |
|  3584467 | 13909 | `			return aLangConstruct[n].xConstruct;` |
|        - | 13910 | `		}` |
| 27276905 | 13911 | `		n++;` |
|        5 | 13912 | `	}` |
|   246217 | 13913 | `	if( pLookahed ){` |
|   246217 | 13914 | `		if(nKeywordID == PH7_TKWRD_INTERFACE && (pLookahed->nType & PH7_TK_ID) ){` |
|    46573 | 13915 | `			return PH7_CompileClassInterface;` |
|   199649 | 13916 | `		}else if(nKeywordID == PH7_TKWRD_CLASS && (pLookahed->nType & PH7_TK_ID) ){` |
|   187475 | 13917 | `			return PH7_CompileClass;` |
|    12179 | 13918 | `		}else if(nKeywordID == PH7_TKWRD_TRAIT && (pLookahed->nType & PH7_TK_ID) ){` |
|       79 | 13919 | `			return PH7_CompileTrait;` |
|        - | 13920 | `		}` |
...
|        - | 13963 | ` */` |
|  8035726 | 13964 | `static void GenStateSetPendingDoc(ph7_gen_state *pGen)` |
|        5 | 13965 | `{` |
|  8035731 | 13966 | `	SyToken *pBase = (SyToken *)SySetBasePtr(pGen->pTokenSet);` |
|  8035731 | 13967 | `	ph7_trivia *aT = (ph7_trivia *)SySetBasePtr(&pGen->aTrivia);` |
|  8035731 | 13968 | `	sxu32 nT = SySetUsed(&pGen->aTrivia);` |
|        - | 13969 | `	sxu32 nIdx, n;` |
|  8035726 | 13970 | `	if( nT < 1 \|\| pGen->pTokenSet == 0` |
...
|        - | 13995 | ` */` |
|  2140056 | 13996 | `static void GenStateConsumeDoc(ph7_gen_state *pGen,SyString *pOut)` |
|        5 | 13997 | `{` |
|        - | 13998 | `	char *zDup;` |
|  2140061 | 13999 | `	if( SyStringLength(&pGen->sPendingDoc) < 1 ){` |
|  2140041 | 14000 | `		return;` |
|        - | 14001 | `	}` |
...
|        - | 14175 | ` */` |
|  2140060 | 14176 | `static sxi32 GenStateConsumeAttrs(ph7_gen_state *pGen,SySet *pOut)` |
|        5 | 14177 | `{` |
|  2140065 | 14178 | `	ph7_trivia *aT = (ph7_trivia *)SySetBasePtr(&pGen->aPendingAttrs);` |
|        - | 14179 | `	sxu32 n;` |
|        - | 14180 | `	sxi32 rc;` |
|  2147949 | 14181 | `	for( n = 0 ; n < SySetUsed(&pGen->aPendingAttrs) ; n++ ){` |
|     7889 | 14182 | `		rc = GenStateCompileAttrSpan(&(*pGen),&aT[n],pOut);` |
|     7889 | 14183 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 | 14184 | `			return SXERR_ABORT;` |
|        - | 14185 | `		}` |
|     3947 | 14186 | `	}` |
|  2140065 | 14187 | `	SySetReset(&pGen->aPendingAttrs);` |
|  2140065 | 14188 | `	return SXRET_OK;` |
|  1070035 | 14189 | `}` |
|        - | 14190 | `/*` |
...
|        - | 14194 | ` */` |
|   723784 | 14195 | `static sxi32 GenStateCollectParamAttrs(ph7_gen_state *pGen,SyToken *pTok,SySet *pOut)` |
|        5 | 14196 | `{` |
|   723789 | 14197 | `	SyToken *pBase = (SyToken *)SySetBasePtr(pGen->pTokenSet);` |
|   723789 | 14198 | `	ph7_trivia *aT = (ph7_trivia *)SySetBasePtr(&pGen->aTrivia);` |
|   723789 | 14199 | `	sxu32 nT = SySetUsed(&pGen->aTrivia);` |
|        - | 14200 | `	sxu32 nIdx, n;` |
|        - | 14201 | `	sxi32 rc;` |
|   723784 | 14202 | `	if( nT < 1 \|\| pGen->pTokenSet == 0` |
|   193935 | 14203 | `	 \|\| pTok < pBase \|\| pTok >= &pBase[SySetUsed(pGen->pTokenSet)] ){` |
|   529859 | 14204 | `		return SXRET_OK;` |
|        - | 14205 | `	}` |
...
|   361897 | 14216 | `}` |
|  5924574 | 14217 | `static sxi32 GenStateCompileChunk(` |
...
|        - | 14223 | `	sxi32 rc;` |
|  5924579 | 14224 | `	rc = SXRET_OK; /* Prevent compiler warning */` |
|  3381469 | 14225 | `	for(;;){` |
|  6343761 | 14226 | `		int bStmtIsDeclare = 0;` |
|  6343761 | 14227 | `		if( pGen->pIn >= pGen->pEnd ){` |
|        - | 14228 | `			/* No more input to process */` |
|    53201 | 14229 | `			break;` |
|        - | 14230 | `		}` |
|        - | 14231 | `		/* Bind a directly-preceding docblock to this statement */` |
|  6290565 | 14232 | `		GenStateSetPendingDoc(&(*pGen));` |
|  6290565 | 14233 | `		if( SySetUsed(&pGen->aPendingAttrs) > 0 ){` |
...
|  6290565 | 14265 | `		if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|  3857835 | 14266 | `			sxu32 nPeek = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  3857835 | 14267 | `			if( nPeek == PH7_TKWRD_DECLARE ){` |
|       47 | 14268 | `				bStmtIsDeclare = 1;` |
|       21 | 14269 | `			}` |
|  1928915 | 14270 | `		}` |
|  6290565 | 14271 | `		if( !bStmtIsDeclare && pGen->pCurrent == &pGen->sGlobal ){` |
...
|   419155 | 14274 | `			pGen->bStrictTypesLocked = 1;` |
|   209575 | 14275 | `		}` |
|  6290565 | 14276 | `		if( pGen->pIn->nType & PH7_TK_OCB /* '{' */ ){` |
|        - | 14277 | `			/* Compile block */` |
...
|        - | 14281 | `			}` |
|     1950 | 14282 | `		}else{` |
|  6286675 | 14283 | `			xCons = 0;` |
|  6286675 | 14284 | `			if( GenStateStartsModifiedClass(pGen->pIn,pGen->pEnd) ){` |
...
|  6273085 | 14289 | `			}else if( GenStateStartsEnumDecl(pGen->pIn,pGen->pEnd) ){` |
...
|  6257545 | 14293 | `			}else if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|  3830681 | 14294 | `				sxu32 nKeyword = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|        - | 14295 | `				/* Try to extract a language construct handler */` |
|  3830681 | 14296 | `				xCons = GenStateGetStatementHandler(nKeyword,(&pGen->pIn[1] < pGen->pEnd) ? &pGen->pIn[1] : 0);` |
|  3830681 | 14297 | `				if( xCons == 0 && GenStateisLangConstruct(nKeyword) == FALSE ){` |
...
|        4 | 14308 | `				}` |
|  4340257 | 14309 | `			}else if( (pGen->pIn->nType & PH7_TK_ID) && (&pGen->pIn[1] < pGen->pEnd)` |
|    66351 | 14310 | `				&& (pGen->pIn[1].nType & PH7_TK_COLON /*':'*/) ){` |
|        - | 14311 | `				/* Label found [i.e: Out: ],point to the routine responsible of compiling it */` |
|      117 | 14312 | `				xCons = PH7_CompileLabel;` |
|       56 | 14313 | `			}` |
|  6286675 | 14314 | `			if( xCons == 0 ){` |
|        - | 14315 | `				/* Assume an expression an try to compile it */` |
|  2436901 | 14316 | `				rc = PH7_CompileExpr(&(*pGen),0,0);` |
|  2436901 | 14317 | `				if(  rc != SXERR_EMPTY ){` |
|        - | 14318 | `					/* Pop l-value */` |
|  2436751 | 14319 | `					PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|  1218373 | 14320 | `				}` |
|  1218453 | 14321 | `			}else{` |
|        - | 14322 | `				/* Go compile the sucker */` |
|  3849779 | 14323 | `				rc = xCons(&(*pGen));` |
|        - | 14324 | `			}` |
|  6286675 | 14325 | `			if( rc == SXERR_ABORT ){` |
|        - | 14326 | `				/* Request to abort compilation */` |
|       13 | 14327 | `				break;` |
|        - | 14328 | `			}` |
|        - | 14329 | `		}` |
|        - | 14330 | `		/* Ignore trailing semi-colons ';' */` |
| 10760427 | 14331 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|  4469877 | 14332 | `			pGen->pIn++;` |
|        5 | 14333 | `		}` |
|  6290555 | 14334 | `		if( iFlags & PH7_COMPILE_SINGLE_STMT ){` |
...
|        - | 14350 | ` */` |
|    53208 | 14351 | `static sxi32 PH7_CompilePHP(` |
...
|        - | 14355 | `	)` |
|        5 | 14356 | `{` |
|    53213 | 14357 | `	SyToken *pScript = pGen->pRawIn; /* Script to compile */` |
|        - | 14358 | `	sxi32 rc;` |
|        - | 14359 | `	/* Reset the token set (and its trivia sidecar) */` |
|    53213 | 14360 | `	SySetReset(&(*pTokenSet));` |
|    53213 | 14361 | `	SySetReset(&pGen->aTrivia);` |
|        - | 14362 | `	/* Mark as the default token set */` |
|    53213 | 14363 | `	pGen->pTokenSet = &(*pTokenSet);` |
|        - | 14364 | `	/* Advance the stream cursor */` |
|    53213 | 14365 | `	pGen->pRawIn++;` |
|        - | 14366 | `	/* Tokenize the PHP chunk first */` |
|    53213 | 14367 | `	PH7_TokenizePHP(SyStringData(&pScript->sData),SyStringLength(&pScript->sData),pScript->nLine,&(*pTokenSet),&pGen->aTrivia);` |
|        - | 14368 | `	/* Point to the head and tail of the token stream. */` |
|    53213 | 14369 | `	pGen->pIn  = (SyToken *)SySetBasePtr(pTokenSet);` |
|    53213 | 14370 | `	pGen->pEnd = &pGen->pIn[SySetUsed(pTokenSet)];` |
|    53213 | 14371 | `	if( is_expr ){` |
...
|        - | 14380 | `	}` |
|    53213 | 14381 | `	if( pGen->pIn < pGen->pEnd && ( pGen->pIn->nType & PH7_TK_EQUAL ) ){` |
...
|    53211 | 14406 | `	rc = GenStateCompileChunk(pGen,0);` |
|        - | 14407 | `	/* Fix exceptions jumps */` |
|    53211 | 14408 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|        - | 14409 | `	/* Fix gotos now, the jump destination is resolved */` |
|    53211 | 14410 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),0) ){` |
|        3 | 14411 | `		rc = SXERR_ABORT;` |
|        1 | 14412 | `	}` |
|        - | 14413 | `	/* Reset container */` |
|    53211 | 14414 | `	SySetReset(&pGen->aGoto);` |
|    53211 | 14415 | `	SySetReset(&pGen->aLabel);` |
|    53211 | 14416 | `	SySetReset(&pGen->aNullsafeJmp);` |
|        - | 14417 | `	/* Compilation result */` |
|    53211 | 14418 | `	return rc;` |
|    26609 | 14419 | `}` |
|        - | 14420 | `/*` |
...
|        - | 14424 | ` */` |
|    56268 | 14425 | `PH7_PRIVATE sxi32 PH7_CompileScript(` |
...
|        - | 14439 | `	sxi32 rc;` |
|    56273 | 14440 | `	if( pScript->nByte < 1 ){` |
...
|    56273 | 14446 | `	pCodeGen = &pVm->sCodeGen;` |
|    56273 | 14447 | `	bSavedStrict = pCodeGen->bStrictTypes;` |
|    56273 | 14448 | `	bSavedStrictLocked = pCodeGen->bStrictTypesLocked;` |
|    56273 | 14449 | `	pCodeGen->bStrictTypes = 0;` |
|    56273 | 14450 | `	pCodeGen->bStrictTypesLocked = 0;` |
|        - | 14451 | `	/* Initialize the tokens containers */` |
|    56273 | 14452 | `	SySetInit(&aRawToken,&pVm->sAllocator,sizeof(SyToken));` |
|    56273 | 14453 | `	SySetInit(&aPhpToken,&pVm->sAllocator,sizeof(SyToken));` |
|    56273 | 14454 | `	SySetAlloc(&aPhpToken,0xc0);` |
|    56273 | 14455 | `	is_expr = 0;` |
|    56273 | 14456 | `	if( iFlags & PH7_PHP_ONLY ){` |
|        - | 14457 | `		SyToken sTmp;` |
|        - | 14458 | `		/* PHP only: -*/` |
|    42699 | 14459 | `		sTmp.nLine = 1;` |
|    42699 | 14460 | `		sTmp.nType = PH7_TOKEN_PHP;` |
|    42699 | 14461 | `		sTmp.pUserData = 0;` |
|    42699 | 14462 | `		SyStringDupPtr(&sTmp.sData,pScript);` |
|    42699 | 14463 | `		SySetPut(&aRawToken,(const void *)&sTmp);` |
|    42699 | 14464 | `		if( iFlags & PH7_PHP_EXPR ){` |
|        - | 14465 | `			/* A simple PHP expression */` |
|      ! 0 | 14466 | `			is_expr = 1;` |
|      ! 0 | 14467 | `		}` |
|    21352 | 14468 | `	}else{` |
|        - | 14469 | `		/* Tokenize raw text */` |
|    13579 | 14470 | `		SySetAlloc(&aRawToken,32);` |
|    13579 | 14471 | `		PH7_TokenizeRawText(pScript->zString,pScript->nByte,&aRawToken);` |
|        - | 14472 | `	}` |
|        - | 14473 | `	/* Process high-level tokens */` |
|    56273 | 14474 | `	pCodeGen->pRawIn = (SyToken *)SySetBasePtr(&aRawToken);` |
|    56273 | 14475 | `	pCodeGen->pRawEnd = &pCodeGen->pRawIn[SySetUsed(&aRawToken)];` |
|    56273 | 14476 | `	rc = PH7_OK;` |
|    56273 | 14477 | `	if( is_expr ){` |
|        - | 14478 | `		/* Compile the expression */` |
|      ! 0 | 14479 | `		rc = PH7_CompilePHP(pCodeGen,&aPhpToken,TRUE);` |
|      ! 0 | 14480 | `		goto cleanup;` |
|        - | 14481 | `	}` |
|    56273 | 14482 | `	nObjIdx = 0;` |
...
|    56273 | 14486 | `	PH7_VmEmitInstr(pVm,PH7_OP_NSSWITCH,0,0,0,0);` |
|        - | 14487 | `	/* Start the compilation process */` |
|    34927 | 14488 | `	for(;;){` |
|   123055 | 14489 | `		if( pCodeGen->pRawIn >= pCodeGen->pRawEnd ){` |
|    56261 | 14490 | `			break; /* No more tokens to process */` |
|        - | 14491 | `		}` |
|    66799 | 14492 | `		if( pCodeGen->pRawIn->nType & PH7_TOKEN_PHP ){` |
|        - | 14493 | `			/* Compile the PHP chunk */` |
|    53213 | 14494 | `			rc = PH7_CompilePHP(pCodeGen,&aPhpToken,FALSE);` |
|    53213 | 14495 | `			if( rc == SXERR_ABORT ){` |
|       16 | 14496 | `				break;` |
|        - | 14497 | `			}` |
|    53201 | 14498 | `			continue;` |
|        - | 14499 | `		}` |
|        - | 14500 | `		/* Raw chunk: [i.e: HTML, XML, etc.] */` |
|    13591 | 14501 | `		nRawObj = 0;` |
|    27219 | 14502 | `		while( (pCodeGen->pRawIn < pCodeGen->pRawEnd) && (pCodeGen->pRawIn->nType != PH7_TOKEN_PHP) ){` |
|        - | 14503 | `			/* Consume the raw chunk without any processing */` |
|    13633 | 14504 | `			pRawObj = PH7_ReserveConstObj(&(*pVm),&nObjIdx);` |
|    13633 | 14505 | `			if( pRawObj == 0 ){` |
|      ! 0 | 14506 | `				rc = SXERR_MEM;` |
|      ! 0 | 14507 | `				break;` |
|        - | 14508 | `			}` |
|        - | 14509 | `			/* Mark as constant and emit the load constant instruction */` |
|    13633 | 14510 | `			PH7_MemObjInitFromString(pVm,pRawObj,&pCodeGen->pRawIn->sData);` |
|    13633 | 14511 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_LOADC,0,nObjIdx,0,0);` |
|    13633 | 14512 | `			++nRawObj;` |
|    13633 | 14513 | `			pCodeGen->pRawIn++; /* Next chunk */` |
|        5 | 14514 | `		}` |
|    13591 | 14515 | `		if( nRawObj > 0 ){` |
|        - | 14516 | `			/* Emit the consume instruction */` |
|    13591 | 14517 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_CONSUME,nRawObj,0,0,0);` |
|     6793 | 14518 | `		}` |
|    28139 | 14519 | `	}` |
|    28134 | 14520 | `cleanup:` |
|    56273 | 14521 | `	SySetRelease(&aRawToken);` |
|    56273 | 14522 | `	SySetRelease(&aPhpToken);` |
|        - | 14523 | `	/* Restore outer file's strict_types scope */` |
|    56273 | 14524 | `	pCodeGen->bStrictTypes = bSavedStrict;` |
|    56273 | 14525 | `	pCodeGen->bStrictTypesLocked = bSavedStrictLocked;` |
|    56273 | 14526 | `	return rc;` |
|    28139 | 14527 | `}` |
|        - | 14528 | `/*` |
...
|        - | 14568 | ` */` |
|    59752 | 14569 | `PH7_PRIVATE sxi32 PH7_ResetCodeGenerator(` |
|        - | 14570 | `	ph7_vm *pVm,       /* Target VM */` |
|        - | 14571 | `	ProcConsumer xErr, /* Error log consumer callabck  */` |
|        - | 14572 | `	void *pErrData     /* Last argument to xErr() */` |
|        - | 14573 | `	)` |
|        5 | 14574 | `{` |
|    59757 | 14575 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|        - | 14576 | `	GenBlock *pBlock,*pParent;` |
|        - | 14577 | `	/* Reset state */` |
|    59757 | 14578 | `	SySetReset(&pGen->aLabel);` |
|    59757 | 14579 | `	SySetReset(&pGen->aGoto);` |
|    59757 | 14580 | `	SySetReset(&pGen->aNullsafeJmp);` |
|    59757 | 14581 | `	SySetReset(&pGen->aTrivia);` |
|    59757 | 14582 | `	SySetReset(&pGen->aPendingAttrs);` |
|    59757 | 14583 | `	SyStringInitFromBuf(&pGen->sPendingDoc,0,0);` |
|    59757 | 14584 | `	SyBlobRelease(&pGen->sErrBuf);` |
|    59757 | 14585 | `	SyBlobRelease(&pGen->sWorker);` |
|    59757 | 14586 | `	SyBlobRelease(&pGen->sNamespace);` |
|    59757 | 14587 | `	SyBlobInit(&pGen->sNamespace,&pVm->sAllocator);` |
|    59757 | 14588 | `	SyHashRelease(&pGen->hUseImports);` |
|    59757 | 14589 | `	SyHashInit(&pGen->hUseImports,&pVm->sAllocator,0,0);` |
|    59757 | 14590 | `	SyHashRelease(&pGen->hUseFuncImports);` |
|    59757 | 14591 | `	SyHashInit(&pGen->hUseFuncImports,&pVm->sAllocator,0,0);` |
|    59757 | 14592 | `	SyHashRelease(&pGen->hUseConstImports);` |
|    59757 | 14593 | `	SyHashInit(&pGen->hUseConstImports,&pVm->sAllocator,0,0);` |
...
|    59757 | 14601 | `	pBlock = pGen->pCurrent;` |
|    59757 | 14602 | `	while( pBlock->pParent != 0 ){` |
|      ! 0 | 14603 | `		pParent = pBlock->pParent;` |
|      ! 0 | 14604 | `		GenStateFreeBlock(pBlock);` |
|      ! 0 | 14605 | `		pBlock = pParent;` |
|      ! 0 | 14606 | `	}` |
|    59757 | 14607 | `	pGen->xErr = xErr;` |
|    59757 | 14608 | `	pGen->pErrData = pErrData;` |
|    59757 | 14609 | `	pGen->pCurrent = &pGen->sGlobal;` |
|    59757 | 14610 | `	pGen->pRawIn = pGen->pRawEnd = 0;` |
|    59757 | 14611 | `	pGen->pIn = pGen->pEnd = 0;` |
|    59757 | 14612 | `	pGen->nErr = 0;` |
|    59757 | 14613 | `	return SXRET_OK;` |
|        5 | 14614 | `}` |
|        - | 14615 | `/*` |
